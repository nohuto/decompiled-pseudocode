/*
 * XREFs of NdisOpenProtocolConfiguration @ 0x1C00A1290
 * Callers:
...
void __fastcall NdisOpenProtocolConfiguration(NTSTATUS *a1, _QWORD *a2, unsigned __int16 *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_Z(0x28u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, (__int64 *)a3);
  ...
  *a1 = PoolWithTag == 0LL ? 0xC000009A : 0;
  ...
  if ( KeyHandle )
    ZwClose(KeyHandle);
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_(0x29u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids);
}
