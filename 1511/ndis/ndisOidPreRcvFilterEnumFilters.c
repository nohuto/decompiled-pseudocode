/*
 * XREFs of ndisOidPreRcvFilterEnumFilters @ 0x1C0039600
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumFilters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083720 >= 4u )
    WPP_SF_q(0x1Eu, &WPP_5bdf5f30a197d5f3fc0ac0df652068c7_Traceguids, a1);
  v6 = *(_DWORD **)(a1 + 32);
  v7 = 20;
  if ( v6[1] == 12 )
  {
...
LABEL_43:
  if ( (unsigned __int8)byte_1C0083720 >= 4u )
    WPP_SF_qD(0x1Fu, &WPP_5bdf5f30a197d5f3fc0ac0df652068c7_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v5;
}
