/*
 * XREFs of ?NdisPDAllocateBufferSet@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KGPEAKKPEAPEAUPD_BUFFER_SET_HANDLE__@@@Z @ 0x1C00D7B10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisPDInitializePDBuffers@@YAXPEAPEAU_PD_BUFFER@@KT_LARGE_INTEGER@@PEAEKKG@Z @ 0x1C00DAA30 (-ndisPDInitializePDBuffers@@YAXPEAPEAU_PD_BUFFER@@KT_LARGE_INTEGER@@PEAEKKG@Z.c)
 */
...
LABEL_5:
  ...
  v41 = *(struct PD_BUFFER_SET_HANDLE__ ***)(*(_QWORD *)(v10 + 5488) + 72LL);
...
LABEL_24:
    ...
    *v34 = v21;
    ...
    {
      v32[0] = v33;
      WPP_SF_qqqL(0x50u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, a1, v35, v21, *(_QWORD *)v32);
    }
  }
  while ( v26 < v6 );
  v17 = 0;
  v18 = (int *)a4;
  v29 = (struct KPushLockBase *)(qword_1C00837E0 + 8);
  *a4 = v26;
