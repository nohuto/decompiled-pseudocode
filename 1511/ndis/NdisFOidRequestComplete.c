/*
 * XREFs of NdisFOidRequestComplete @ 0x1C000EF40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  if ( v9 )
  {
    *((_QWORD *)NdisReserved + 3) = 0LL;
    ...
    if ( (unsigned __int8)byte_1C0083712 >= 4u )
      WPP_SF_qq(175LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, OidRequest->RequestHandle, OidRequest);
    if ( v13 )
    {
    ...
    if ( (unsigned __int8)byte_1C0083712 >= 4u )
      WPP_SF_qq(176LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, RequestHandle, 0LL);
    NdisReserved = (UCHAR *)(v9 + 72);
    goto LABEL_20;
  }
  if ( (unsigned __int8)byte_1C0083712 >= 2u )
    WPP_SF_(41LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, *(_QWORD *)&Status);
}
