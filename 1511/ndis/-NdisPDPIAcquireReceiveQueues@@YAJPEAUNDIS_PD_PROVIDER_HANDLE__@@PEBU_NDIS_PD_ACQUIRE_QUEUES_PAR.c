/*
 * XREFs of ?NdisPDPIAcquireReceiveQueues@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_ACQUIRE_QUEUES_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@PEAKPEAU_NDIS_PD_QUEUE_PARAMETERS@@33@Z @ 0x1C00D8850
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a7)
{
  ...
  struct _LIST_ENTRY v35; // [rsp+50h] [rbp-41h] BYREF
  unsigned int v36; // [rsp+60h] [rbp-31h]
  KLockHolder v37; // [rsp+68h] [rbp-29h] BYREF
  KLockHolder v38; // [rsp+80h] [rbp-11h] BYREF
  ...
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v37, (struct KPushLockBase *)(qword_1C00837E0 + 8));
  v18 = &v37;
  if ( !*((_BYTE *)a1 + 97) )
  {
    *((_BYTE *)a1 + 97) = 1;
        ...
        if ( v20 <= 0xFFFFFFFF && (unsigned int)v20 <= *a6 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( !v24 )
              goto LABEL_42;
            *((_DWORD *)v24 + 18) = v32;
            *((_DWORD *)v24 + 19) = ndisGetNextPDCounterId();
            v16 = ndisPcwSetRssInstanceSuffix((struct NDIS_PD_COUNTER *)v24);
            if ( v16 < 0 )
            {
              NDIS_PD_COUNTER::`scalar deleting destructor'((char *)v24);
LABEL_41:
              v8 = 1;
              goto LABEL_46;
            }
            LOBYTE(v29) = 1;
            ndisSetupPDCounter(v24, *((_QWORD *)v22 + 6), 1LL, a1, (_DWORD)v29);
            *((_QWORD *)v22 + 6) = v24;
            v26 = (NDIS_PD_QUEUE_TRACKER *)ExAllocatePoolWithTag(NonPagedPoolNx, 0x140uLL, 0x7441444Eu);
            v27 = v26 ? NDIS_PD_QUEUE_TRACKER::NDIS_PD_QUEUE_TRACKER(v26) : 0LL;
            if ( !v27 )
            {
LABEL_42:
              v16 = -1073741670;
            ...
            ndisSetupPDQTracker(
              v27,
              (struct _NDIS_PD_QUEUE *)v35.Flink,
...
LABEL_48:
    ...
    *(_QWORD *)&v37.m_State = &v37;
    v35.Blink = &v35;
    v35.Flink = &v35;
    ndisCleanupPDRSSObjects(a1, (struct _LIST_ENTRY *)&v37, &v35);
    (*(void (__fastcall **)(_QWORD))(*((_QWORD *)a1 + 11) + 32LL))(*((_QWORD *)a1 + 10));
    ndisFreePDRSSObjects((struct _LIST_ENTRY *)&v37, &v35);
    goto LABEL_49;
  }
  v16 = -1073741808;
LABEL_51:
