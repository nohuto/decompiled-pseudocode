/*
 * XREFs of ndisPnPPortDeactivation @ 0x1C003B718
 * Callers:
      ...
      while ( *v15 )
      {
        ...
        if ( !PortByPortNumber )
        {
          ...
          if ( (unsigned __int8)byte_1C008371E >= 2u )
            WPP_SF_qD(0x1Eu, &WPP_19165d00fb3b32ae989335dc29d87a5c_Traceguids, (__int64)a1, v5[v14]);
        ...
        if ( *((_DWORD *)PortByPortNumber + 4) != 4 )
        {
          ...
          v19 = 0;
          if ( (unsigned __int8)byte_1C008371E >= 2u )
            WPP_SF_qD(0x1Fu, &WPP_19165d00fb3b32ae989335dc29d87a5c_Traceguids, (__int64)a1, v5[v14]);
          if ( (Microsoft_Windows_NDISEnableBits & 0x4000000000LL) != 0 )
            Template_jqxqq(
              v5[v14],
              &PnPPortDeactivationFailed,
        ...
        *((_DWORD *)PortByPortNumber + 4) = 2;
        if ( (unsigned __int8)byte_1C008371E >= 5u )
          WPP_SF_qD(0x20u, &WPP_19165d00fb3b32ae989335dc29d87a5c_Traceguids, (__int64)a1, *v15);
        ++v14;
        ++v15;
        if ( v14 >= v6 )
          goto LABEL_42;
