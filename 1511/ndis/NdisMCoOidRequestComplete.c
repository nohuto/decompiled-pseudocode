/*
 * XREFs of NdisMCoOidRequestComplete @ 0x1C004D030
 * Callers:
        ...
        NDIS_STATUS Status)
{
  ...
  if ( (v4 & 0x220) != 0 )
  {
    ...
    if ( (v6 & 0x2000) != 0 )
    {
      NdisMOidRequestComplete(MiniportAdapterHandle, *((PNDIS_OID_REQUEST *)MiniportAdapterHandle + 277), Status);
    }
    else
    {
      if ( (v6 & 0x200) != 0 )
      ...
      {
        (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, PNDIS_OID_REQUEST, NDIS_STATUS))(v5 + 1136))(
          *(_QWORD *)(v5 + 32),
      ...
      ndisMDereferenceOpenUnlocked(v5, 6u);
    }
  }
  else if ( (v4 & 8) != 0 )
  {
