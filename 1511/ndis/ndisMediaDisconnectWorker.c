/*
 * XREFs of ndisMediaDisconnectWorker @ 0x1C00CE7D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMediaDisconnectWorker(PVOID P, struct _TlgProvider_t *Context)
{
  ...
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_q(0x15u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)Context);
  ...
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_q(0x16u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)Context);
}
