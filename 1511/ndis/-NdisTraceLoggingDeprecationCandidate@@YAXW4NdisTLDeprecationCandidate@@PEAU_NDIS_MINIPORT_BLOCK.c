/*
 * XREFs of ?NdisTraceLoggingDeprecationCandidate@@YAXW4NdisTLDeprecationCandidate@@PEAU_NDIS_MINIPORT_BLOCK@@H@Z @ 0x1C006D9E8
 * Callers:
 *     NdisMCreateLog @ 0x1C00552E0 (NdisMCreateLog.c)
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1C0082040 > 5 )
  {
    ...
    v5 = (int)a3;
    v13 = 4LL;
    return TlgWrite(a1, &unk_1C0072C8F, a3, a4, 5u, &pData);
  }
  return result;
}
