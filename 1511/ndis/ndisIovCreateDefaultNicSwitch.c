/*
 * XREFs of ndisIovCreateDefaultNicSwitch @ 0x1C00AB088
 * Callers:
...
__int64 __fastcall ndisIovCreateDefaultNicSwitch(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  PVOID v18; // [rsp+38h] [rbp-C8h] BYREF
  PVOID v19; // [rsp+40h] [rbp-C0h] BYREF
  PVOID ConfigurationHandle; // [rsp+48h] [rbp-B8h] BYREF
  PVOID SubKeyHandle; // [rsp+50h] [rbp-B0h] BYREF
  struct _NDIS_CONFIGURATION_OBJECT ConfigObject; // [rsp+58h] [rbp-A8h] BYREF
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0xAu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1);
    ...
    if ( SriovCurrentCapabilities )
    {
      if ( (SriovCurrentCapabilities->SriovCapabilities & 3) == 3 )
      {
          ...
          && NicSwitchCurrentCapabilities->Header.Size >= 0x74u )
        {
          ...
          SwitchConfiguration = ndisIovInitializeNicSwitch(v6, (__int64)v26, &v19, &v18, P);
          ...
          *(_DWORD *)&v24[48] = 552;
          ...
          if ( SwitchConfiguration )
            goto LABEL_30;
          v5 = 1;
          SwitchConfiguration = ndisIovFinalizeNicSwitch((__int64)a1, v26, (__int64)v19, (__int64)v18, (_QWORD *)P[0]);
        }
        else
        {
          SwitchConfiguration = -1073741637;
...
LABEL_5:
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0xBu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1, SwitchConfiguration);
