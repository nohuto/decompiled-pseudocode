/*
 * XREFs of ndisMFakeSendPackets @ 0x1C0059850
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMFakeSendPackets(__int64 a1, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_qq(0x52u, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, v3);
  v7 = -1073741823;
  if ( v3 )
    v7 = *(_DWORD *)(v3 + 540);
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_qq(0x53u, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, v3);
}
