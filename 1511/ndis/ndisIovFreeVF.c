/*
 * XREFs of ndisIovFreeVF @ 0x1C0064390
 * Callers:
 *     ndisOidPostIovFreeVF @ 0x1C0064EB0 (ndisOidPostIovFreeVF.c)
 * Callees:
...
__int64 __fastcall ndisIovFreeVF(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qq(0x25u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, 0LL, P);
  if ( *((_DWORD *)v2 + 19) )
  {
    v1 = -1073741811;
  }
  ...
  {
    v14 = v1;
    WPP_SF_qqd(0x26u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v2, v14);
  }
  return v1;
}
