/*
 * XREFs of NdisNblTrackerTransferOwnership @ 0x1C00601A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z @ 0x1C005FE28 (-ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z.c)
 */
        ...
        unsigned int a5)
{
  ...
  struct NDIS_NBL_TRACKER_HANDLE__ *v7; // r8
  unsigned int v8; // r9d
  ...
  if ( ndisNblTrackerMode )
  {
    ...
    ndisNblTrackerTransferOwnershipInternal(v9, v6, v7, v8, a5);
  }
}
