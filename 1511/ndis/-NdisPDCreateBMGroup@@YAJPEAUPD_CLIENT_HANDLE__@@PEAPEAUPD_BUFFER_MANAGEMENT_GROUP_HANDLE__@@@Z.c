/*
 * XREFs of ?NdisPDCreateBMGroup@@YAJPEAUPD_CLIENT_HANDLE__@@PEAPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@@Z @ 0x1C00D8300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisPDCreateBMGroup(struct PD_CLIENT_HANDLE__ *a1, struct PD_BUFFER_MANAGEMENT_GROUP_HANDLE__ **a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083724 >= 4u )
    WPP_SF_q(0x46u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, (__int64)a1);
  v4 = 0;
  *a2 = 0LL;
  ...
  if ( v6 )
  {
    v8 = (struct KPushLockBase *)(qword_1C00837E0 + 8);
    v6[3] = a1;
  ...
  if ( (unsigned __int8)byte_1C0083724 >= 4u )
    WPP_SF_qqd(0x47u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, a1, *a2, v4);
  return v4;
}
