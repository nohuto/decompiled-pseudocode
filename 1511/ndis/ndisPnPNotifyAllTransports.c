/*
 * XREFs of ndisPnPNotifyAllTransports @ 0x1C00E0B98
 * Callers:
 ...
 *     ndisReceiveQueueingPaused @ 0x1C004AD58 (ndisReceiveQueueingPaused.c)
 *     ndisReceiveQueueingRestart @ 0x1C004AD74 (ndisReceiveQueueingRestart.c)
...
__int64 __fastcall ndisPnPNotifyAllTransports(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2, __int64 a3)
{
  ...
  struct _KEVENT v22; // [rsp+50h] [rbp-E8h] BYREF
  _QWORD v23[20]; // [rsp+70h] [rbp-C8h] BYREF
  ...
  ndisAcquireMiniportPnPEventLock((__int64)a1, &v22);
  if ( (unsigned int)(v3 - 13) > 1 || (v7 = ndisMHandleNDKPnPEvents(a1)) == 0 )
  {
    while ( 1 )
    {
      ...
      if ( v10 )
      {
        ...
        {
          LODWORD(v21) = v10;
          WPP_SF_ZLqL(v12, v11, (__int64 *)(*(_QWORD *)(v9 + 24) + 72LL), v3, a1, v21);
        }
  ...
  if ( !v3 && *v5 == 1 )
  {
    ...
    for ( i = 0LL; (_DWORD)i != m_numElements; i = (unsigned int)(i + 1) )
    {
      ...
      {
        ndisGetBindLinkNameForTracing(p[i]._p, (struct NDIS_PNPTRACE_LOCALS *)v23);
        WPP_SF_Zq(0x12u, &WPP_8f6d621b9670942a7823ab6ddc5f2e50_Traceguids, (__int64 *)v23[1], v23[0]);
      }
    }
    Ndis::BindEngine::EndPolicyUpdates(&a1->BindEngine, v17);
  }
