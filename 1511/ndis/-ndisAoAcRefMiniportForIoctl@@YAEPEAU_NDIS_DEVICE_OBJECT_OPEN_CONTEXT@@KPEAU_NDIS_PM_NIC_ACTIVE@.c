/*
 * XREFs of ?ndisAoAcRefMiniportForIoctl@@YAEPEAU_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@KPEAU_NDIS_PM_NIC_ACTIVE@@EW4_NDIS_MP_REFTAG@@PEAJPEAPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0004BA0
 * Callers:
...
LABEL_29:
      LOBYTE(v17) = a5;
      ndisDereferenceMiniport(v11, v17);
      v11 = 0LL;
      goto LABEL_6;
    }
    v19 = KeAcquireSpinLockRaiseToDpc(&v16->AoAc->Lock);
    if ( *((_DWORD *)a1 + 6) || !a4 )
    {
      if ( *((struct _NDIS_MINIPORT_BLOCK **)a1 + 4) != v11 )
      {
        KeReleaseSpinLock(&AoAc->Lock, v19);
        *a6 = -1073741816;
        goto LABEL_29;
      }
    }
    else
    {
      ...
      *((_QWORD *)a1 + 4) = v11;
      v20 = (_LIST_ENTRY *)((char *)a1 + 8);
      Blink = AoAc->HandleList.Blink;
      v20->Flink = &AoAc->HandleList;
      v20->Blink = Blink;
      if ( Blink->Flink != &AoAc->HandleList )
        __fastfail(3u);
      Blink->Flink = v20;
      AoAc->HandleList.Blink = v20;
