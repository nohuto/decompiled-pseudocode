/*
 * XREFs of ndisPreProcessOid @ 0x1C0008850
 * Callers:
...
__int64 __fastcall ndisPreProcessOid(__int64 a1, __int64 a2, unsigned int a3, unsigned int *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qLqL(34LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a3, a2, *(_DWORD *)(a2 + 32));
  if ( a3 == 17 )
  {
    v23 = *(_DWORD *)(a2 + 12);
    if ( v23 < 0x3C )
  ...
  *(_DWORD *)(a2 + 88) &= ~4u;
  ...
  if ( !*(_DWORD *)(a2 + 8) || (*(_DWORD *)(v12 + 1872) & 0x200) == 0 )
  {
    ...
    while ( v11 >= v10 )
    {
      v15 = *((_DWORD *)&unk_1C0070CD0 + 6 * v11);
      if ( v15 > v13 )
      {
        if ( !v11 )
          break;
      ...
      else
      {
        if ( v15 == v13 )
        {
          ...
          *(_DWORD *)(a2 + 88) |= 4u;
          ...
          {
            v18 = (__int64 (__fastcall *)(_QWORD *))*((_QWORD *)&unk_1C0070CD0 + 3 * v17 + 1);
            if ( v18 )
            {
              v4 = v18(v25);
              if ( v4 == 1 )
              {
                ndisOidRequestComplete((__int64)v25, v19, v20, v21);
                v9 = 259;
              }
              else
              {
  ...
  *a4 = v9;
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qdD(35LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a2, v9, v4);
  return v4;
}
