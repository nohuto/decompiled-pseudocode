/*
 * XREFs of NdisMRegisterInterruptEx @ 0x1C00E5130
 * Callers:
 *     <none>
 * Callees:
 *     ?GetMsgDpc@@YAPEAU_KDPC@@PEAU_NDIS_INTERRUPT_BLOCK@@KK@Z @ 0x1C00103CC (-GetMsgDpc@@YAPEAU_KDPC@@PEAU_NDIS_INTERRUPT_BLOCK@@KK@Z.c)
        ...
        PNDIS_HANDLE NdisInterruptHandle)
{
  ...
  $F102F55EE36202CEC5F6E4D6C08ADA64 *v32; // r15
  bool v33; // zf
