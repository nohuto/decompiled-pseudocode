/*
 * XREFs of ?GetIdealWindowRepresentation@CWindowData@@QEAAX_NPEAVCWindowRepresentation@@@Z @ 0x18001D370
 * Callers:
...
void __fastcall CWindowData::GetIdealWindowRepresentation(CWindowData *this, char a2, struct CWindowRepresentation *a3)
{
  ...
  *(_QWORD *)a3 = this;
  ...
  if ( !*((_DWORD *)a3 + 2) )
  {
    if ( !a2 && (*((_BYTE *)this + 572) & 8) == 0 && !CWindowData::IsImmersiveWindow(this) )
    {
      v7 = 0LL;
      if ( *((_DWORD *)this + 138) )
      {
        while ( 1 )
        {
          ...
          *((_DWORD *)a3 + 2) = IdealWindowRepresentationType;
          ...
          if ( (unsigned int)v7 >= *((_DWORD *)this + 138) )
            goto LABEL_13;
        }
        *(_QWORD *)a3 = v8;
      }
