/*
 * XREFs of ?_WindowEnumCallback@CFadeIn@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180002700
 * Callers:
...
char __fastcall CFadeIn::_WindowEnumCallback(CFade *a1, struct CWindowData *a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    v6 = *((_DWORD *)a2 + 144) & 0xFFF;
    if ( v6 == 25 || v6 == 27 )
    {
      v7 = CFade::_FadeWindow(a1, a2, 1);
      v4 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v7, 0x1314u);
    }
  }
  *a4 = v4;
  return 1;
