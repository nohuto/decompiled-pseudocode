/*
 * XREFs of ?StartStationaryAnimationWithDelay@CContactManager@@AEAAJIW4STATIONARY_ANIMATION_TYPE@CContactStationaryVisual@@PEBUtagPOINT@@PEBUtagRECT@@_K_N@Z @ 0x1800707DC
 * Callers:
        ...
        char a7)
{
  ...
  *(_QWORD *)((char *)&v21 + 4) = v7;
  ...
  if ( Touch < 0 )
  {
    v19 = 2081;
LABEL_6:
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, Touch, v19);
    goto LABEL_13;
  }
  if ( (int)CContactManager::AddToTouchNode(v12, a6, v22) >= 0 )
  {
    Touch = CContactStationaryVisual::Start(v22, a3, a4, a5, a7);
    v13 = Touch;
    if ( Touch >= 0 )
    {
      ...
      Touch = DynArrayImpl<0>::AddMultipleAndSet(a1 + 120, 0x18u, 1, &v21);
      if ( Touch >= 0 )
        goto LABEL_13;
      v19 = 192;
    }
