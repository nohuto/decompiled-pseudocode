/*
 * XREFs of ?Initialize@CSecondaryWindowRepresentation@@IEAAJU?$TMILFlagsEnum@W4FlagsEnum@SWRUsage@@@@PEAUISecondaryWindowRepresentationChangedListener@@PEAVCWindowData@@HW4DEVICE_SCALE_FACTOR@@@Z @ 0x180017A18
 * Callers:
...
LABEL_19:
  ...
  if ( v10 > *(_DWORD *)(v8 + 436) )
  {
    v14 = DynArrayImpl<0>::AddMultipleAndSet(v8 + 416, 8LL, 1LL, &v24);
    v15 = v14;
    if ( v14 < 0 )
...
LABEL_17:
  ...
  *(_QWORD *)(*(_QWORD *)(v8 + 416) + 8LL * v9) = v24;
  *(_DWORD *)(v8 + 440) = v10;
LABEL_5:
