/*
 * XREFs of ?UpdatePinnedParts@CTopLevelWindow@@AEAAJXZ @ 0x1800273A0
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdatePinnedParts(CTopLevelWindow *this)
{
  ...
  if ( v7 )
  {
    ...
    v8 = (int)((double)(*(_DWORD *)(*((_QWORD *)v7 + 186) + 24LL) - 1) * v10);
    v9 = (int)((double)(*(_DWORD *)(*((_QWORD *)v7 + 204) + 24LL) - 1) * v10);
  }
