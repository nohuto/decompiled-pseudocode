/*
 * XREFs of ?ZOrder@CWindowList@@UEAAJPEAUIDwmWindow@@0@Z @ 0x1800305E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v42, 0x5FCu);
    v9 = v57;
  }
  v10 = v8;
  if ( v8 < 0 )
...
LABEL_74:
  ...
  {
    v10 = -2147024890;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024890, 0x97Au);
    goto LABEL_19;
  }
  v11 = *((_QWORD *)v9 + 15);
  v51 = 0LL;
...
LABEL_60:
  ...
  {
    v10 = -2147024890;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024890, 0x988u);
    goto LABEL_19;
  }
LABEL_13:
  ...
  *(_QWORD *)v14 = v20;
  v21 = v57;
  v22 = (struct CVisual *)*((_QWORD *)v57 + 48);
  if ( v22 )
  {
    ...
    if ( v36 )
    {
      ...
      if ( v37 )
      {
        ...
        {
          v35 = (struct CVisual *)*((_QWORD *)v14 + 48);
          if ( v35 )
            break;
        }
        ...
        if ( inserted < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x9ADu);
          goto LABEL_19;
        }
        v39 = CTopLevelWindow3D::OnZOrderUpdated(*((CTopLevelWindow3D **)v57 + 49), 0);
        v10 = v39;
        if ( v39 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v39, 0x9AEu);
          goto LABEL_19;
        }
...
LABEL_18:
  ...
  if ( !v25 || (v26 = (struct CWindowData *)(v25 + 64)) == 0LL )
  {
    v27 = v57;
LABEL_26:
    if ( *(struct CWindowData **)(*(_QWORD *)(v23 + 528) + 8LL * (unsigned int)(*(_DWORD *)(v23 + 552) - 1)) != v27 )
    {
      DynArray<CWindowData *,0>::Remove(v23 + 528, &v57);
      v29 = *(_DWORD *)(v23 + 552);
      v30 = v29 + 1;
      if ( v29 + 1 < v29 )
      {
      ...
      else if ( v30 > *(_DWORD *)(v23 + 548) )
      {
        v48 = DynArrayImpl<0>::AddMultipleAndSet(v23 + 528, 8u, 1, &v57);
        if ( v48 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v48, 0xC0u);
      }
      else
      {
        *(_QWORD *)(*(_QWORD *)(v23 + 528) + 8LL * v29) = v57;
        *(_DWORD *)(v23 + 552) = v30;
      }
    }
    goto LABEL_19;
  ...
  DynArray<CWindowData *,0>::Remove(v23 + 528, &v57);
  v31 = *(_DWORD *)(v23 + 552);
  v32 = *(struct CWindowData ***)(v23 + 528);
  if ( v31 )
  {
    do
    {
  ...
  DynArray<CWindowData *,0>::InsertAt(v23 + 528, &v57, v7);
LABEL_19:
