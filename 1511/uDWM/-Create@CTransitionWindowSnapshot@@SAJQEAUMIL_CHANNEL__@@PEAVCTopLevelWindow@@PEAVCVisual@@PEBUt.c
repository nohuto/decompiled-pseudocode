/*
 * XREFs of ?Create@CTransitionWindowSnapshot@@SAJQEAUMIL_CHANNEL__@@PEAVCTopLevelWindow@@PEAVCVisual@@PEBUtagRECT@@PEAPEAV1@@Z @ 0x180012C38
 * Callers:
        ...
        struct CTransitionWindowSnapshot **a5)
{
  ...
  if ( (dword_1800BE5B0 & 1) == 0 )
  {
    dword_1800BBCF4 = -2147023434;
    dword_1800BE5B0 |= 1u;
  }
  *a5 = 0LL;
  ...
  if ( v10 )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800BBCF4, 1LL, v12, 0x30u);
    }
    else
    {
  ...
  {
    v13 = -2147024882;
    MilInstrumentationCheckHR(0x14u, &dword_1800BBCF4, 1LL, -2147024882, 0x22u);
  }
  return v13;
}
