/*
 * XREFs of ?ProcessPenContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x18003F33C
 * Callers:
...
LABEL_5:
  ...
  if ( a5 == 3 )
  {
    v15 = *(unsigned __int64 **)(v13 + 40 * v11 + 8);
    if ( v15 )
    {
      (*(void (__fastcall **)(_QWORD))(*v15 + 184))(*(_QWORD *)(v13 + 40 * v11 + 8));
