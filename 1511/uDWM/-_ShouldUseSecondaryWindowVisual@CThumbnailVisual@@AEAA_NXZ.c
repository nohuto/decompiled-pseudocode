/*
 * XREFs of ?_ShouldUseSecondaryWindowVisual@CThumbnailVisual@@AEAA_NXZ @ 0x180019C9C
 * Callers:
...
char __fastcall CThumbnailVisual::_ShouldUseSecondaryWindowVisual(CThumbnailVisual *this)
{
  ...
  if ( v6
    ...
    && (v7 = *((_DWORD *)this + 127)) != 0
    && (v8 = *((_DWORD *)this + 128)) != 0 )
  {
    if ( (float)((float)*((int *)this + 123) / (float)v7) < 0.5
      || (float)((float)*((int *)this + 124) / (float)v8) < 0.5 )
    {
      return 0;
    }
  }
