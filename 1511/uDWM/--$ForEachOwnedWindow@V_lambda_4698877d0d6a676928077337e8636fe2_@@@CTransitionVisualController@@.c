/*
 * XREFs of ??$ForEachOwnedWindow@V_lambda_4698877d0d6a676928077337e8636fe2_@@@CTransitionVisualController@@KAJPEBVCWindowData@@AEBV_lambda_4698877d0d6a676928077337e8636fe2_@@_N@Z @ 0x18001145C
 * Callers:
  ...
  if ( !a3 || (*(_DWORD *)(a1 + 576) & 0x10000000) != 0 )
  {
    ...
    if ( !v6 || (*(_BYTE *)(v6 + 264) & 0x18) == 0 )
    {
      for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 552); i = (unsigned int)(i + 1) )
      {
        ...
        {
          v3 = sub_1800113BC(a2, *(_QWORD *)(*(_QWORD *)(a1 + 528) + 8 * i));
          if ( v3 >= 0 )
