/*
 * XREFs of ?OnVisibilityUpdated@CWindowData@@QEAAJXZ @ 0x18001E5E8
 * Callers:
...
__int64 __fastcall CWindowData::OnVisibilityUpdated(CWindowData **this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v2, 0x1BC3u);
  }
  else
  {
    v4 = this[65];
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x1BC6u);
    }
