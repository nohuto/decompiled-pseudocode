/*
 * XREFs of ?ScreenDuplicationInvalidMonitor@WindowFrameLoggingTelemetry@@SAXXZ @ 0x18007BEE4
 * Callers:
...
void WindowFrameLoggingTelemetry::ScreenDuplicationInvalidMonitor(void)
{
  ...
  {
    TlgWrite(v0, &unk_1800A9A25, 0LL, 0LL, 2u, &pData);
  }
}
