/*
 * XREFs of ?CleanupTransition@CTransitionVisualController@@QEAAJXZ @ 0x18000A8F0
 * Callers:
    ...
    if ( (int)v7 >= 0 )
    {
      ...
      do
      {
        ...
        if ( *(_BYTE *)(v27 + v28 + 16) )
        {
          ...
          DynArray<CTransitionVisualController::TlwPair,0>::RemoveAt((char *)this + 24, (unsigned int)v7);
        }
        v27 -= 24LL;
