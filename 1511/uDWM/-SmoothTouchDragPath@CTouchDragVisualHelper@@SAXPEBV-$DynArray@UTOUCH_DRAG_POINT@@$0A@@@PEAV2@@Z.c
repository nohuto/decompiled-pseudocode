/*
 * XREFs of ?SmoothTouchDragPath@CTouchDragVisualHelper@@SAXPEBV?$DynArray@UTOUCH_DRAG_POINT@@$0A@@@PEAV2@@Z @ 0x18004CD8C
 * Callers:
 ...
 *     ?GetMidPoint@CTouchDragVisualHelper@@CA?AUTOUCH_DRAG_POINT@@PEBU2@0@Z @ 0x180089808 (-GetMidPoint@CTouchDragVisualHelper@@CA-AUTOUCH_DRAG_POINT@@PEBU2@0@Z.c)
  ...
  *(_DWORD *)(a2 + 24) = 0;
  ...
  for ( i = 0; i < v2; i += 2 )
  {
    if ( i + 4 <= v2 )
    {
      ...
      v74 = v30;
      v76 = v28;
      v38 = CTouchDragVisualHelper::GetMidPoint(v64, v24, v31);
      v39 = *(_OWORD *)v38;
      v40 = *(_QWORD *)(v38 + 16);
    ...
    else
    {
      if ( i )
      {
        v9 = CTouchDragVisualHelper::GetMidPoint(v64, *(_QWORD *)a1 + 28LL * i, *(_QWORD *)a1 + 28LL * (i + 1));
        v10 = *(_OWORD *)v9;
        v11 = *(_QWORD *)(v9 + 16);
        v80 = *(_DWORD *)(v9 + 24);
        v8 = &v78;
      ...
      v70 = v19;
      v69 = v18;
      v20 = CTouchDragVisualHelper::GetMidPoint(v64, &v71, &v68);
      i = v2;
      v21 = *(_OWORD *)v20;
      v22 = *(_QWORD *)(v20 + 16);
