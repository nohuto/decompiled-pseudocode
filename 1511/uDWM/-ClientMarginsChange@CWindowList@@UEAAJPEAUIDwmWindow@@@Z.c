/*
 * XREFs of ?ClientMarginsChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180030950
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v26, 0x5FCu);
  if ( v6 < 0 )
  {
LABEL_34:
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0x943u);
    goto LABEL_10;
  }
  if ( v5 )
  {
    ...
    *((_DWORD *)v5 + 67) = v8;
      ...
      || *((_DWORD *)v5 + 24) != v16 )
    {
      ...
      *((_OWORD *)v5 + 4) = v27;
      ...
      v19 = (CWindowIconic *)*((_QWORD *)v5 + 51);
      if ( v19 )
        CWindowIconic::UpdateSizeOrMargins(v19, 0);
      for ( i = 0; i < *((_DWORD *)v5 + 128); ++i )
      {
        v22 = *(CThumbnailVisual **)(*(_QWORD *)(*((_QWORD *)v5 + 61) + 8LL * i) + 88LL);
        if ( v22 )
        {
          v23 = *((_QWORD *)v22 + 44);
          if ( v23 )
      ...
      if ( *((_DWORD *)v5 + 120) )
      {
        do
        {
          v21 = *(CThumbnailVisual **)(*(_QWORD *)(*((_QWORD *)v5 + 57) + 8LL * v4) + 88LL);
          if ( v21 )
