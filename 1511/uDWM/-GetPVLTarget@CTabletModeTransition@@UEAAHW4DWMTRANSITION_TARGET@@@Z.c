/*
 * XREFs of ?GetPVLTarget@CTabletModeTransition@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x180001F70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CTabletModeTransition::GetPVLTarget(__int64 a1, __int16 a2)
{
  unsigned int v2; // r8d
  int v3; // ecx
  int v4; // edx
