/*
 * XREFs of ?ChildContentChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18002E7B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ChildContentChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0x11EBu);
  }
  else
  {
    v7 = v12;
    if ( v12 )
    {
      ...
      if ( ((*((_BYTE *)v7 + 569) & 0x10) != 0) == v8
        || (*((_BYTE *)v7 + 569) ^= (*((_BYTE *)v7 + 569) ^ (16 * v8)) & 0x10,
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0x11F5u);
      }
    }
  }
