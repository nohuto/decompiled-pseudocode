/*
 * XREFs of ?_SlideWindowVertically@CSlide@@IEAAJPEAVCWindowData@@AEBUtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x18009601C
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  v5 = *(_QWORD *)this;
  v22 = 0LL;
  v10 = (*(__int64 (__fastcall **)(CSlide *, _QWORD))(v5 + 88))(this, *((unsigned int *)a2 + 144));
  ...
  if ( v11 >= 0 )
  {
    ...
    v18 = *((_DWORD *)a2 + 144);
    if ( (v18 & 0x1000000) != 0 )
      v24 = *(struct tagRECT *)((char *)a2 + 596);
    if ( (v18 & 0x800000) != 0 )
      rc = *(struct tagRECT *)((char *)a2 + 628);
  ...
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v11, 0x181u);
  }
  if ( v13 < 0 && v12 )
