/*
 * XREFs of ?UpdateThumbnailProperties@CWindowList@@AEAAJKPEAUMILCMD_DWM_REDIRECTION_UPDATETHUMBNAILPROPERTIES@@@Z @ 0x180040C20
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_UPDATETHUMBNAILPROPERTIES *a3)
{
     ...
     || (*((_DWORD *)a3 + 3) & 0x3EFFFFF) != 0x3EFFFFF && (*((_DWORD *)a3 + 3) & 0xFC100000) != 0) )
  {
    ...
    v8 = updated;
    if ( updated < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0xDDBu);
  }
  else
  {
    v8 = -2147024809;
