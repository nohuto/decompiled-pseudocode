/*
 * XREFs of ?_RestoreWindowVisual@CTransitionVisualController@@IEAAJPEAVCWindowData@@@Z @ 0x180090A14
 * Callers:
        ...
        struct CWindowData *a2)
{
  ...
  if ( *((_QWORD *)a2 + 48) )
  {
    ...
    if ( v4 >= 0 )
      ...
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v4, 0xC38u);
  }
  return v2;
}
