/*
 * XREFs of ?StopActivity@IconicBitmapReceived@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x180077F90
 * Callers:
 *     <none>
 * Callees:
        ...
        WindowFrameLoggingTelemetry::IconicBitmapReceived *this)
{
  ...
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v5 + 24) & 0x200000000000LL) == *(_QWORD *)(v5 + 24) )
    {
      ...
      TlgWrite(v17, &unk_1800A96D7, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v19 + 3) & 0x200000000000LL) == *((_QWORD *)v19 + 3) )
    {
      ...
      v32 = 4;
      v31 = &v22;
      TlgWrite(v19, &unk_1800A97E3, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v27);
    }
  }
