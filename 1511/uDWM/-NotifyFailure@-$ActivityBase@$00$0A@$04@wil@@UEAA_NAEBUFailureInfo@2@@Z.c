/*
 * XREFs of ?NotifyFailure@?$ActivityBase@$00$0A@$04@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x18007DD60
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<1,0,5>::NotifyFailure(_QWORD *a1, int *a2)
{
  ...
  if ( v4 )
  {
    if ( *(_DWORD *)v5 > 5u )
    {
      ...
      v56 = 4LL;
      TlgCreateSz(&v57, v20);
      TlgWrite(v21, &unk_1800A9BED, (LPCGUID)(a1[6] + 8LL), 0LL, 0x13u, &pData);
    }
  }
         ...
         && (*(_QWORD *)(v5 + 24) & 0x200000000000LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    TlgCreateSz(&v51, v11);
    TlgCreateWsz(&v52, *((LPCWSTR *)a2 + 14));
    TlgWrite(v12, &unk_1800A9AE8, (LPCGUID)(a1[6] + 8LL), 0LL, 0x10u, &pData);
  }
