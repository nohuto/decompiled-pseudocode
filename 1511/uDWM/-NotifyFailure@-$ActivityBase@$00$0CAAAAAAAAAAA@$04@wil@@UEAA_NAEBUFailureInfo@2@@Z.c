/*
 * XREFs of ?NotifyFailure@?$ActivityBase@$00$0CAAAAAAAAAAA@$04@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180076E90
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<1,35184372088832,5>::NotifyFailure(_QWORD *a1, int *a2)
{
  char v4; // al
  __int64 v5; // r10
  const CHAR *v6; // rdx
  ...
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v5 + 24) & 0x200000000000LL) == *(_QWORD *)(v5 + 24) )
    {
      ...
      v56 = 4LL;
      TlgCreateSz(&v57, v20);
      TlgWrite(v21, &unk_1800A95AF, (LPCGUID)(a1[6] + 8LL), 0LL, 0x13u, &pData);
    }
  }
  ...
  wil::ActivityBase<1,35184372088832,5>::LockExclusive((__int64)a1, &SRWLock);
  v22 = (_DWORD *)a1[6];
  v23 = a2[1];
