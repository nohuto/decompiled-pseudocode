/*
 * XREFs of ?GetPerspectiveValue@CTransitionVisualController@@SAJHHPEAM@Z @ 0x180012FAC
 * Callers:
...
__int64 __fastcall CTransitionVisualController::GetPerspectiveValue(unsigned int a1, unsigned int a2, float *a3)
{
  ...
  else if ( (v13 & 0x10) != 0 )
  {
    ...
    v9 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v11, 0xB49u);
  }
  else
  {
