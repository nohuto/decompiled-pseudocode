/*
 * XREFs of ?OnEndTransitionRequest@CLauncherDismiss@@UEAAJXZ @ 0x180004820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLauncherDismiss::OnEndTransitionRequest(CLauncherDismiss *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v2, 0xCDDu);
  }
  else
  {
    ...
    v3 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v4, 0xCDEu);
  }
  return v3;
}
