/*
 * XREFs of ?_FadeOutToGlass@CLivePreview@@AEAAJPEBVCWindowData@@@Z @ 0x18004E044
 * Callers:
...
__int64 __fastcall CLivePreview::_FadeOutToGlass(CLivePreview *this, const struct CWindowData *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v4, 0x59Eu);
    return v5;
  }
  ...
  if ( inserted >= 0 )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x5A9u);
      return v5;
    }
    ...
    if ( v14 >= 0 )
    {
      ...
      do
      {
        ...
        if ( *(char *)(v17 + 570) >= 0 && (!a2 || *(_QWORD *)(v17 + 40) != *((_QWORD *)a2 + 5)) )
        {
          v18 = *(CTopLevelWindow **)(v17 + 384);
          v57 = 0LL;
          v19 = CTopLevelWindow::CloneVisualTreeForLivePreview(v18, 0, 1, v13, &v57);
          v5 = v19;
          if ( v19 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v19, 0x5B4u);
            return v5;
          }
          ...
          if ( v20 )
          {
            ...
            if ( v22 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v22, 0x5B8u);
              return v5;
            }
          }
          else
          {
            ...
            if ( v23 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v23, 0x5BCu);
              return v5;
            }
          }
    ...
    for ( i = WindowListForDesktop->Blink; i != WindowListForDesktop; i = i->Blink )
    {
      ...
      if ( Flink && LODWORD(i[7].Flink) == 12 )
      {
        ...
        v32 = (CTopLevelWindow *)i[24].Flink;
        v57 = 0LL;
        v33 = CTopLevelWindow::CloneVisualTreeForLivePreview(v32, 0, 1, (__int64)v27, &v57);
        v5 = v33;
        if ( v33 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v33, 0x5D9u);
          goto LABEL_61;
        }
        v34 = v57;
        ...
        if ( v30 )
        {
          v35 = (CTopLevelWindow *)i[24].Flink;
        ...
        if ( v36 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v36, 0x5E6u);
LABEL_61:
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x5F8u);
      goto LABEL_61;
    }
    ...
    if ( v46 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v46, 0x5F9u);
      goto LABEL_61;
    }
    ...
    if ( v47 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v47, 0x5FAu);
      goto LABEL_61;
    }
    ...
    if ( v48 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v48, 0x5FCu);
      goto LABEL_61;
    }
    ...
    if ( v49 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v49, 0x5FDu);
      goto LABEL_61;
    }
    ...
    if ( v50 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v50, 0x5FEu);
      goto LABEL_61;
    }
    DynArrayImpl<0>::~DynArrayImpl<0>((void **)&v53);
LABEL_75:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x5A3u);
  return v5;
}
