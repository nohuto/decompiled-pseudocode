/*
 * XREFs of ?_SetupOwneePreview@CLivePreview@@AEAAJPEBVCWindowData@@PEAUHWND__@@W4Enum@LivePreviewWindowState@@@Z @ 0x1800729A4
 * Callers:
...
__int64 __fastcall CLivePreview::_SetupOwneePreview(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(a2 + 552) )
  {
    while ( 1 )
    {
      v10 = *(_QWORD *)(*(_QWORD *)(a2 + 528) + 8 * v5);
      if ( (*(_BYTE *)(v10 + 570) & 0x20) == 0 && ((*(_BYTE *)(v10 + 568) & 1) != 0 || *(_QWORD *)(v10 + 400)) )
      {
        LOBYTE(v13) = 1;
        LOBYTE(a4) = 1;
      ...
      if ( (unsigned int)v5 >= *(_DWORD *)(a2 + 552) )
        return v4;
    }
