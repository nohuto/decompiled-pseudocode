/*
 * XREFs of ?Initialize@CTetherVisual@@MEAAJQEAUMIL_CHANNEL__@@@Z @ 0x18008A870
 * Callers:
...
__int64 __fastcall CTetherVisual::Initialize(struct CBitmapSource **this, struct MIL_CHANNEL__ *const a2)
{
  int BitmapFromAtlas; // eax
  unsigned int v4; // ebx
  void *Theme; // rax
  __int128 v6; // xmm0
  struct CBitmapSource *v7; // rax
  unsigned int v9; // [rsp+20h] [rbp-18h]

  BitmapFromAtlas = CVisual::Initialize((CVisual *)this, a2);
  v4 = BitmapFromAtlas;
...
LABEL_12:
  ...
  *((_OWORD *)this + 21) = v6;
  ...
  {
    v7 = (struct CBitmapSource *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                            + 16LL))(
                                   WPF::g_pProcessHeap,
                                   80LL);
    if ( v7 )
      v7 = (struct CBitmapSource *)CTimeline<float>::CTimeline<float>((__int64)v7, *((float *)this + 99), 1.0, 0.0, 0);
    this[48] = v7;
    if ( v7 )
    {
