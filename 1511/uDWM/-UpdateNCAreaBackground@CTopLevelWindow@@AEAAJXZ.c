/*
 * XREFs of ?UpdateNCAreaBackground@CTopLevelWindow@@AEAAJXZ @ 0x180026C90
 * Callers:
    ...
    && (*((_DWORD *)this + 157) || *((_DWORD *)this + 159) || *((_DWORD *)this + 158) || *((_DWORD *)this + 160)) )
  {
    ...
    if ( updated >= 0 )
    {
      ...
      if ( !*((_QWORD *)this + 38) )
      {
        ...
        if ( v6 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0xE49u);
          return v3;
        }
        ...
        if ( inserted < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0xE4Cu);
          return v3;
        }
        v8 = *v5;
        v30 = 0LL;
      ...
      if ( !*((_QWORD *)this + 96) )
        CResource::Create(0x47u, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (CBaseObject **)this + 96);
      ...
      if ( v9 >= 0 )
      {
        ...
        *(float *)&v26 = v11[8] * v11[4];
        ...
        if ( !*((_QWORD *)this + 97) )
          CResource::Create(0x47u, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (CBaseObject **)this + 97);
          ...
          if ( v18 >= 0 )
          {
            ...
            if ( v20 >= 0 )
            {
              ...
              if ( v21 >= 0 )
              {
                ...
                v3 = v22;
                if ( v22 < 0 )
                  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v22, 0xEA2u);
              }
              else
              {
                MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v21, 0xEA1u);
              }
            }
            else
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v20, 0xE9Eu);
            }
          }
          else
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v18, 0xE98u);
          }
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0xE5Du);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0xE42u);
    }
  }
  else
  {
    ...
    if ( v23 )
    {
      ...
      v3 = v24;
      if ( v24 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v24, 0xEACu);
    }
  }
  return v3;
}
