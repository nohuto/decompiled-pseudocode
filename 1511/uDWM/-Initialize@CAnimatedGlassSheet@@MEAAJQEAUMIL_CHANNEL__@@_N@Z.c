/*
 * XREFs of ?Initialize@CAnimatedGlassSheet@@MEAAJQEAUMIL_CHANNEL__@@_N@Z @ 0x180083050
 * Callers:
 ...
 *     ?GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z @ 0x18007DBF0 (-GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z.c)
 */
  ...
  if ( v5 >= 0 )
  {
    ...
    *(double *)v18.m128i_i64 = _mm_cvtepi32_pd(v18).m128d_f64[0] * *(double *)(v19 + 1320);
    ...
    while ( 1 )
    {
      ...
      if ( v25 < 0 )
        break;
      CAtlasedRectsVisual::InsertAtlasImageAtIndex(this, *v21, *((_DWORD *)this + 72));
