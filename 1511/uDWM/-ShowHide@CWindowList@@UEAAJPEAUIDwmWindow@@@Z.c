/*
 * XREFs of ?ShowHide@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180031780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ShowHide(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0x800u);
  }
  else
  {
    v6 = v10;
    if ( v10 )
    {
      ...
      if ( v7 != (*((_BYTE *)v6 + 568) & 1) )
      {
        *((_BYTE *)v6 + 568) ^= (v7 ^ *((_BYTE *)v6 + 568)) & 1;
        v8 = CWindowList::ShowHide(this, v6, 1);
        v5 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0x80Cu);
      }
    }
  }
