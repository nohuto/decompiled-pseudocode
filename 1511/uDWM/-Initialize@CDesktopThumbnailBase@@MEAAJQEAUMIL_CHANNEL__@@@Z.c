/*
 * XREFs of ?Initialize@CDesktopThumbnailBase@@MEAAJQEAUMIL_CHANNEL__@@@Z @ 0x18009A4E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDesktopThumbnailBase::Initialize(CDesktopThumbnailBase *this, struct MIL_CHANNEL__ *const a2)
{
  int v3; // eax
  unsigned int v4; // edi
