/*
 * XREFs of ?RecordMinimizedWndRatio@CDwmWinSqm@@QEAAXXZ @ 0x1800828C0
 * Callers:
...
void __fastcall CDwmWinSqm::RecordMinimizedWndRatio(CDwmWinSqm *this)
{
  ...
  TickCountDifference = CDwmWinSqm::GetTickCountDifference(v2, TickCount, dword_1800BF1FC);
  if ( TickCountDifference )
  {
    v9 = 0;
    v5 = 1;
    v7 = 1LL;
    v4 = *(double *)&xmmword_1800BF208 / (double)TickCountDifference;
    v6 = (unsigned int)(int)(float)(v4 + 0.5);
    v8 = (int)(float)((float)(*((double *)&xmmword_1800BF208 + 1) / (double)TickCountDifference) + 0.5);
    WinSqmAddToStream(0LL, 3332LL, 2LL, &v5);
  }
  dword_1800BF1FC = TickCount;
  xmmword_1800BF208 = 0LL;
}
