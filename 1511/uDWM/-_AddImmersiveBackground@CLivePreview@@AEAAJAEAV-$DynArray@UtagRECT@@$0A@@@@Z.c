/*
 * XREFs of ?_AddImmersiveBackground@CLivePreview@@AEAAJAEAV?$DynArray@UtagRECT@@$0A@@@@Z @ 0x18006EE8C
 * Callers:
...
__int64 __fastcall CLivePreview::_AddImmersiveBackground(__int64 a1, __int64 a2)
{
  ...
  CAccent *v24; // [rsp+40h] [rbp-49h] BYREF
...
LABEL_8:
    ...
    v14 = CVisual::Create(*(struct MIL_CHANNEL__ *const *)(*(_QWORD *)(a1 + 16) + 16LL), &v23);
    v5 = v14;
    if ( v14 < 0 )
    {
