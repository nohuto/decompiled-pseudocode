/*
 * XREFs of ?GetScenarioGuid@CTopLevelWindow3D@@AEAAXW4WindowAnimationType@1@PEAU_GUID@@@Z @ 0x1800348C0
 * Callers:
    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( v6 )
        {
          ...
          {
            if ( v7 == 1 )
              v8 = (GUID)xmmword_1800A6758;
            else
              v8 = GUID_NULL;
          }
          else
          {
            v8 = (GUID)xmmword_1800A6778;
          }
        }
        else
        {
          v8 = (GUID)xmmword_1800A67D8;
        }
      }
      else
      {
        v8 = (GUID)xmmword_1800A6748;
      }
    }
    else
    {
      v8 = (GUID)xmmword_1800A67E8;
    }
  }
  else
  {
    v8 = (GUID)xmmword_1800A6738;
  }
  *a3 = v8;
}
