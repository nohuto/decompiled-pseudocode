/*
 * XREFs of ?GetRootVisualForWindow@CWindowList@@UEAAJ_NPEAUIDwmWindow@@PEAPEAUMIL_CHANNEL__@@PEAI@Z @ 0x180080550
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a5)
{
  ...
  *v9 = 0;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0x1384u);
  }
