/*
 * XREFs of ?Create@CAnimationClockFactory@@SAJU_GUID@@PEAPEAVCAnimationClock@@@Z @ 0x180004BF0
 * Callers:
 ...
 * Callees:
 *     ??0CAnimationClock@@QEAA@XZ @ 0x1800055B0 (--0CAnimationClock@@QEAA@XZ.c)
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *a2 = v5;
    ...
    {
      v2 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x27Eu);
      if ( *a2 )
      {
