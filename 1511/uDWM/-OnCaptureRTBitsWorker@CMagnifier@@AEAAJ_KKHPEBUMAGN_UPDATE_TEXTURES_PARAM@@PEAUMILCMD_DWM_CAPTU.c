/*
 * XREFs of ?OnCaptureRTBitsWorker@CMagnifier@@AEAAJ_KKHPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY@@@Z @ 0x18007A2B0
 * Callers:
        ...
        struct MILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY *a6)
{
  ...
  *(_QWORD *)&v10 = *((_QWORD *)a5 + 4);
  ...
  if ( v13 >= 0 )
  {
    ...
    MilInstrumentationCheckHR(0x14u, &dword_1800ACD30, 8LL, v14, v18);
    goto LABEL_14;
  }
  MilInstrumentationCheckHR(0x14u, &dword_1800ACD30, 8LL, v13, 0x218u);
LABEL_14:
