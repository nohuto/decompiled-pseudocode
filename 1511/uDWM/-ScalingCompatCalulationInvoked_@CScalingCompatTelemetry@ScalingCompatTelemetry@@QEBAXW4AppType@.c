/*
 * XREFs of ?ScalingCompatCalulationInvoked_@CScalingCompatTelemetry@ScalingCompatTelemetry@@QEBAXW4AppType@2@II@Z @ 0x180041054
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
    ...
    v13 = 4LL;
    v15 = 4LL;
    LODWORD(v5) = TlgWrite(v6, &unk_1800AA015, 0LL, 0LL, 5u, &pData);
  }
  return (int)v5;
}
