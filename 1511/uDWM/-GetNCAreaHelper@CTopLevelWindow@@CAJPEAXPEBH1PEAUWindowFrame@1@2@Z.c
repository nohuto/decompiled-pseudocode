/*
 * XREFs of ?GetNCAreaHelper@CTopLevelWindow@@CAJPEAXPEBH1PEAUWindowFrame@1@2@Z @ 0x180047A4C
 * Callers:
 ...
 *     ?SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z @ 0x18004821C (-SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z.c)
        ...
        struct CTopLevelWindow::WindowFrame *a5)
{
  ...
  v42 = a1;
  v8 = a1;
  if ( (dword_1800BE764 & 1) == 0 )
  {
    dword_1800BE71C = -2147023728;
    dword_1800BE764 |= 1u;
  }
  ...
  if ( ThemeMargins < 0 )
  {
    iPropId = 911;
LABEL_61:
    MilInstrumentationCheckHR(0x14u, &dword_1800BE71C, 1LL, ThemeMargins, iPropId);
    return v10;
  }
  ...
  *(_QWORD *)&v40.cxLeftWidth = __PAIR64__(pMargins.cxRightWidth, v14);
  ...
  ThemeMargins = GetThemePercentage(v8, a2[1], *a3, 2430, (float *)a4 + 464);
  v10 = ThemeMargins;
  if ( ThemeMargins < 0 )
  {
    iPropId = 953;
  ...
  ThemeMargins = GetThemePercentage(v8, a2[1], a3[1], 2430, (float *)a5 + 464);
  v10 = ThemeMargins;
  if ( ThemeMargins < 0 )
  {
    iPropId = 954;
  ...
  ThemeMargins = GetThemePercentage(v8, a2[1], *a3, 2432, (float *)a4 + 468);
  v10 = ThemeMargins;
  if ( ThemeMargins < 0 )
  {
    iPropId = 957;
  ...
  ThemeMargins = GetThemePercentage(v8, a2[1], a3[1], 2432, (float *)a5 + 468);
  v10 = ThemeMargins;
  if ( ThemeMargins < 0 )
  {
    iPropId = 958;
  ...
  *((_QWORD *)a5 + 220) = v24;
  ...
  v39 = 18;
  v27 = a2 + 18;
  v28 = (CBaseObject **)((char *)a5 + 1776);
  *(_QWORD *)&v38.cxLeftWidth = v27;
  v29 = (_QWORD *)((char *)a5 + 1776);
...
LABEL_27:
  ...
  ThemeMargins = CTopLevelWindow::CreateBitmapsFromAtlasImageStrip(v8, *v27, 2u, &pMargins, (struct tagRECT **)&v35);
  v10 = ThemeMargins;
