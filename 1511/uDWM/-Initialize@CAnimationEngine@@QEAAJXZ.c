/*
 * XREFs of ?Initialize@CAnimationEngine@@QEAAJXZ @ 0x180044284
 * Callers:
...
__int64 __fastcall CAnimationEngine::Initialize(LPVOID *this)
{
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, Instance, ppv);
LABEL_5:
  if ( v4 < 0 )
  {
    if ( *v1 )
    ...
    if ( v6 )
    {
      (*(void (__fastcall **)(LPVOID))(*(_QWORD *)v6 + 16LL))(this[2]);
      this[2] = 0LL;
    }
    v7 = this[3];
    if ( v7 )
    {
      (*(void (__fastcall **)(LPVOID))(*(_QWORD *)v7 + 16LL))(this[3]);
      this[3] = 0LL;
    }
  }
