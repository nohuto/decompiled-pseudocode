/*
 * XREFs of ?Initialize@CDesktopManager@@AEAAJPEBUStartupInfo@@PEAUCompositionInfo@@@Z @ 0x180044F5C
 * Callers:
 ...
 *     ??0CTransitionVisualController@@QEAA@XZ @ 0x1800435AC (--0CTransitionVisualController@@QEAA@XZ.c)
 ...
 *     ?_InitializeWnf@CDesktopManager@@AEAAJXZ @ 0x180044518 (-_InitializeWnf@CDesktopManager@@AEAAJXZ.c)
 *     ??0CWindowList@@QEAA@XZ @ 0x18004601C (--0CWindowList@@QEAA@XZ.c)
 *     ?CreateRootVisual@CWindowList@@QEAAJXZ @ 0x180046118 (-CreateRootVisual@CWindowList@@QEAAJXZ.c)
 *     ??0CContactManager@@QEAA@XZ @ 0x18004721C (--0CContactManager@@QEAA@XZ.c)
...
LABEL_6:
    v9 = -2147024882;
    MilInstrumentationCheckHR(0x14u, &dword_1800A54C0, 1LL, -2147024882, dwCreationFlags);
  ...
  *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 21) = v16;
  ...
  if ( v20 >= 0 )
  {
    ...
    v24 = (CTextCache *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                   + 16LL))(
                          WPF::g_pProcessHeap,
                          128LL);
    if ( v24 )
          ...
          *((_QWORD *)this + 171) = v28;
          if ( *((_QWORD *)v30 + 171) )
          {
            ...
            if ( Channel >= 0 )
            {
              ...
              dwCreationFlagsa = 385;
            }
            else
            {
              dwCreationFlagsa = 362;
            }
LABEL_39:
            v21 = Channel;
            goto LABEL_32;
        ...
        {
          dwCreationFlagsb = 332;
        }
      }
      else
      {
        dwCreationFlagsb = 328;
      }
    }
    else
    {
      dwCreationFlagsb = 324;
    }
    v9 = -2147024882;
    MilInstrumentationCheckHR(0x14u, &dword_1800A54C0, 1LL, -2147024882, dwCreationFlagsb);
LABEL_99:
    CDesktopManager::NotifyRedirectionShutdown(this);
    DwmRedirectionManagerShutdown();
    goto LABEL_100;
  }
  dwCreationFlagsa = 295;
LABEL_31:
  v21 = v20;
LABEL_32:
  MilInstrumentationCheckHR(0x14u, &dword_1800A54C0, 1LL, v21, dwCreationFlagsa);
LABEL_97:
  if ( v9 < 0 && v6 )
    goto LABEL_99;
LABEL_100:
