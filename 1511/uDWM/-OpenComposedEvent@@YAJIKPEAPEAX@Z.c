/*
 * XREFs of ?OpenComposedEvent@@YAJIKPEAPEAX@Z @ 0x1800440D8
 * Callers:
 ...
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x18004415C (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
...
__int64 __fastcall OpenComposedEvent(int a1, __int64 a2, void **a3)
{
  ...
  if ( (int)StringCchPrintfW(Name, 0x1AuLL, L"%s%x", L"DwmComposedEvent_", a1) >= 0 )
  {
    ...
    *a3 = v5;
    ...
    {
      v4 = -2144980991;
      MilInstrumentationCheckHR(0x14u, &dword_1800A5AE4, 1LL, -2144980991, 0x2Eu);
    }
  }
  return v4;
}
