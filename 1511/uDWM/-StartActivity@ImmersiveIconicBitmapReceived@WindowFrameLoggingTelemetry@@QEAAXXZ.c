/*
 * XREFs of ?StartActivity@ImmersiveIconicBitmapReceived@WindowFrameLoggingTelemetry@@QEAAXXZ @ 0x180078DA4
 * Callers:
        ...
        WindowFrameLoggingTelemetry::ImmersiveIconicBitmapReceived *this)
{
    ...
    && (*((_QWORD *)v5 + 3) & 0x200000000000LL) == *((_QWORD *)v5 + 3) )
  {
    ...
    TlgWrite(v5, &unk_1800A9854, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v6, 3u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
