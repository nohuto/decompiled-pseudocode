/*
 * XREFs of ?ApplyMaximizedClip@CTopLevelWindow@@AEAAJPEAUHRGN__@@@Z @ 0x18002508C
 * Callers:
 *     ?UpdateNCAreaGeometry@CTopLevelWindow@@AEAAJXZ @ 0x180024B70 (-UpdateNCAreaGeometry@CTopLevelWindow@@AEAAJXZ.c)
 * Callees:
 *     ?CreateRectRgnCoerceInvalid@@YAPEAUHRGN__@@PEBUtagRECT@@@Z @ 0x180011870 (-CreateRectRgnCoerceInvalid@@YAPEAUHRGN__@@PEBUtagRECT@@@Z.c)
  ...
  if ( (*((_BYTE *)this + 264) & 4) != 0 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( !CombineRgn(a2, a2, v8, 1) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR(0x14u, &dword_1800A54D0, 11LL, v2, 0x135Du);
      }
      DeleteObject(v8);
    }
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, &dword_1800A54D0, 11LL, v2, 0x135Bu);
    }
  }
