/*
 * XREFs of ?StopActivity@ImmersiveIconicBitmapReceived@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x180078E80
 * Callers:
 *     <none>
 * Callees:
        ...
        WindowFrameLoggingTelemetry::ImmersiveIconicBitmapReceived *this)
{
  ...
  if ( v3 < 0 && v3 == v1[23] )
    ...
    v4 = 0LL;
  wil::ActivityBase<1,35184372088832,5>::zInternalStop((__int64)this);
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v5 + 24) & 0x200000000000LL) == *(_QWORD *)(v5 + 24) )
    {
      ...
      TlgWrite(v17, &unk_1800A9899, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v19 + 3) & 0x200000000000LL) == *((_QWORD *)v19 + 3) )
    {
      ...
      v32 = 4;
      v31 = &v22;
      TlgWrite(v19, &unk_1800A99AE, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v27);
    }
  }
