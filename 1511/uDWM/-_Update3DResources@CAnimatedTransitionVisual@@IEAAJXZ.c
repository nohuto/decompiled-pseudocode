/*
 * XREFs of ?_Update3DResources@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18008D930
 * Callers:
 ...
 *     ??DMatrix4x4F@D2D1@@QEBA?AV01@AEBV01@@Z @ 0x18008CACC (--DMatrix4x4F@D2D1@@QEBA-AV01@AEBV01@@Z.c)
 *     ?PerspectiveProjection@Matrix4x4F@D2D1@@SA?AV12@M@Z @ 0x18008CEC4 (-PerspectiveProjection@Matrix4x4F@D2D1@@SA-AV12@M@Z.c)
 */
      ...
      *(double *)&v50[8] = v26;
      ...
      if ( v28 >= 0 )
      {
        ...
        *(_QWORD *)&v49.top = 0LL;
        ...
        v21 = v31;
        if ( v31 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v31, 0x763u);
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v28, 0x75Fu);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v25, 0x757u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v20, 0x745u);
  }
  return v21;
}
