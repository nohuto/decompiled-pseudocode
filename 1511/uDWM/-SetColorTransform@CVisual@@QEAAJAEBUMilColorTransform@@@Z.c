/*
 * XREFs of ?SetColorTransform@CVisual@@QEAAJAEBUMilColorTransform@@@Z @ 0x18007E738
 * Callers:
...
__int64 __fastcall CVisual::SetColorTransform(CVisual *this, const struct MilColorTransform *a2)
{
  ...
  *(_QWORD *)v18 = 0LL;
  if ( !memcmp_0(&gMilColorTransfIdentity, a2, 0x64uLL) )
    goto LABEL_6;
  v5 = CResource::Create(0x34u, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (CBaseObject **)v18);
  v6 = v5;
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x30Du);
    v2 = *(CBaseObject **)v18;
    goto LABEL_10;
  }
  v19 = 38;
...
LABEL_6:
    ...
    *(_DWORD *)&v18[8] = v14;
    ...
    v6 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0x31Eu);
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x313u);
  }
LABEL_10:
  if ( v2 )
