/*
 * XREFs of ?EnsureThumbnailVisual@CDCompThumbnailData@@UEAAJXZ @ 0x18003FFD0
 * Callers:
...
__int64 __fastcall CDCompThumbnailData::EnsureThumbnailVisual(CDCompThumbnailData *this)
{
  ...
  if ( !v4 )
  {
    if ( !*((_DWORD *)this + 28) )
    {
      ...
      v1 = v5;
      if ( v5 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x2122u);
    }
    return v1;
  }
  ...
  {
    v1 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x210Au);
    return v1;
  }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, DesktopThumbnail, 0x210Du);
LABEL_20:
    v8 = v16;
    goto LABEL_21;
  }
      ...
      if ( !*((_QWORD *)this + 13) )
      {
        ...
        if ( v11 >= 0 )
        {
          ...
          *((_BYTE *)v13 + 321) = 1;
          ...
          if ( v14 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0x211Au);
            goto LABEL_21;
          }
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0x2114u);
        v2 = (volatile signed __int32 *)v17;
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, PerMonitorDesktopThumbnail, 0x210Fu);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x210Eu);
  }
LABEL_21:
  if ( v8 )
