/*
 * XREFs of ?_UpdateGlassVisual@CLivePreview@@AEAAJXZ @ 0x18006EA08
 * Callers:
    ...
    do
    {
      ...
      if ( (*(_BYTE *)(v10 + 570) & 0x40) == 0 )
      {
        ...
        else if ( !*(_QWORD *)(v9 + v8 + 16) )
        {
          ...
          if ( v12 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x619u);
            return v4;
          }
          v13 = v18;
          ...
          if ( inserted < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x61Au);
            return v4;
          }
