/*
 * XREFs of ?TriangulatePathGeometry@CTouchDragVisualHelper@@SAJMPEBV?$DynArray@UTOUCH_DRAG_POINT@@$0A@@@PEBUtagRECT@@PEAV?$DynArray@UMilPoint3F@@$0A@@@PEAV?$DynArray@UMilPoint2D@@$0A@@@PEAV?$DynArray@I$0A@@@PEAV?$DynArray@K$0A@@@@Z @ 0x18004D2CC
 * Callers:
        ...
        __int64 a7)
{
  ...
  int v118; // [rsp+3Ch] [rbp-CCh] BYREF
...
LABEL_109:
    ...
    v118 = 255;
    v42 = DynArray<unsigned long,0>::AddAndSet(v133, 2LL, &v118);
    v9 = v42;
    if ( v42 < 0 )
    {
