/*
 * XREFs of ?ForceConnectClientNode@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18000B2A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ForceConnectClientNode(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, 0x1478u);
  }
  else
  {
    v6 = v11;
    if ( v11 )
    {
            ...
            v7 >= 0) )
      {
        ...
        if ( v8 )
        {
          ...
          v5 = v9;
          if ( v9 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x1483u);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x147Eu);
      }
    }
  }
