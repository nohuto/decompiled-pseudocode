/*
 * XREFs of ?_EnsureCVIResource@CTransitionWindowSnapshot@@AEAAJPEBUtagRECT@@@Z @ 0x18003D448
 * Callers:
        ...
        const struct tagRECT *a2)
{
  ...
  if ( v6 != 1.0 )
  {
    ...
    CVisual::SetInterpolationMode(v25, 1);
  }
  ...
  if ( !*((_QWORD *)this + 34) )
  {
    ...
    {
      v10 = CResource::Create(0x38u, *(_QWORD *)(*((_QWORD *)this + 2) + 16LL), (CBaseObject **)this + 34);
      v11 = v10;
      if ( v10 < 0 )
      {
