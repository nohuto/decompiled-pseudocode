/*
 * XREFs of ?_IsEligibleForLivePreview@CLivePreview@@AEAA_NPEBVCWindowData@@@Z @ 0x180072504
 * Callers:
 ...
 *     ?GetLivePreviewWindowRect@CTopLevelWindow@@QEBA?AUtagRECT@@_N@Z @ 0x18007DA90 (-GetLivePreviewWindowRect@CTopLevelWindow@@QEBA-AUtagRECT@@_N@Z.c)
 */
...
char __fastcall CLivePreview::_IsEligibleForLivePreview(CLivePreview *this, const struct CWindowData *a2)
{
  ...
  if ( (*((_BYTE *)a2 + 570) & 0x20) == 0 )
  {
    ...
    {
      v4 = *((_BYTE *)a2 + 568);
      if ( (v4 & 1) != 0 && (*((_BYTE *)a2 + 572) & 1) == 0 && (v4 & 4) == 0 && (*((_DWORD *)a2 + 25) & 0x20000000) == 0 )
      {
        if ( *((_QWORD *)a2 + 5) )
        {
          v5 = (HWND)*((_QWORD *)a2 + 5);
