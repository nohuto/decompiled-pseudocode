/*
 * XREFs of ?EnsureWindowFrames@CTopLevelWindow@@CAJXZ @ 0x18003EE34
 * Callers:
 ...
 *     ??0WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x180045CC4 (--0WindowFrame@CTopLevelWindow@@QEAA@XZ.c)
...
__int64 CTopLevelWindow::EnsureWindowFrames(void)
{
  unsigned int v0; // ebx
  int v2; // edi
  void *(__fastcall *v3)(WPF::ProcessHeapImpl *, size_t); // rbp
  ...
  if ( !dword_1800BE698 )
  {
    ...
    while ( 1 )
    {
      ...
      v4 = v3 == WPF::ProcessHeapImpl::AllocClear
         ? (CTopLevelWindow::WindowFrame *)WPF::ProcessHeapImpl::AllocClear(WPF::g_pProcessHeap, 0x758uLL)
         : (CTopLevelWindow::WindowFrame *)v3(WPF::g_pProcessHeap, 1880LL);
      if ( v4 )
      {
      ...
      if ( !v5 )
        break;
      v6 = dword_1800BE698 + 1;
      if ( dword_1800BE698 + 1 < (unsigned int)dword_1800BE698 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024362, 0xB5u);
      }
      else if ( v6 > dword_1800BE694 )
      {
      ...
      {
        *(_QWORD *)(CTopLevelWindow::s_rgpwfWindowFrames + 8LL * (unsigned int)dword_1800BE698) = v8;
        dword_1800BE698 = v6;
      }
    ...
    v0 = -2147024882;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024882, 0x1EFu);
  }
  return v0;
}
