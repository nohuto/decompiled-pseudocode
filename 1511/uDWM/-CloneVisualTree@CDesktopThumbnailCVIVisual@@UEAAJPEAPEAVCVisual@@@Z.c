/*
 * XREFs of ?CloneVisualTree@CDesktopThumbnailCVIVisual@@UEAAJPEAPEAVCVisual@@@Z @ 0x180099AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDesktopThumbnailCVIVisual::CloneVisualTree(CDesktopThumbnailCVIVisual *this, struct CVisual **a2)
{
  ...
  v2 = *((_QWORD *)this + 2);
  v13 = 0LL;
  v5 = CDesktopThumbnailCVIVisual::Create(*(struct MIL_CHANNEL__ *const *)(v2 + 16), &v13);
  v6 = v5;
  if ( v5 >= 0 )
  {
    v7 = v13;
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0x203u);
      goto LABEL_13;
    }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x200u);
  }
  v7 = v13;
LABEL_13:
  if ( v7 )
