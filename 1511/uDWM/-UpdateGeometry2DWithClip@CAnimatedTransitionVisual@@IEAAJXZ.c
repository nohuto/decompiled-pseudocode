/*
 * XREFs of ?UpdateGeometry2DWithClip@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18008D3B8
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::UpdateGeometry2DWithClip(CAnimatedTransitionVisual *this)
{
    ...
    if ( v10 >= 0 )
    {
      ...
      if ( v11 >= 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          ...
          v8 = v15;
          if ( v15 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v15, 0x4ADu);
        }
        else
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x4A6u);
        }
        if ( v13 )
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0x49Cu);
      }
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x499u);
  }
  if ( v17 )
