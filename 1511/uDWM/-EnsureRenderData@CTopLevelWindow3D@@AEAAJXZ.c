/*
 * XREFs of ?EnsureRenderData@CTopLevelWindow3D@@AEAAJXZ @ 0x180035160
 * Callers:
 ...
 *     ?ShouldFreezeAnimationCVI@CTopLevelWindow3D@@AEBA_NXZ @ 0x1800339A0 (-ShouldFreezeAnimationCVI@CTopLevelWindow3D@@AEBA_NXZ.c)
...
__int64 __fastcall CTopLevelWindow3D::EnsureRenderData(CSecondaryWindowRepresentation **this)
{
  ...
  if ( !*((_DWORD *)this + 64) )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x274u);
    }
    else
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x275u);
      }
      else
      {
        v37 = 247;
        ...
        if ( v19 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v19, 0x27Fu);
        }
        else
        {
          ...
          if ( v20 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v20, 0x280u);
          }
          else
          {
            ...
            if ( v21 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v21, 0x281u);
            }
            else
            {
              ...
              if ( v23 < 0 )
              {
                MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v23, 0x286u);
              }
              else
              {
                ...
                if ( v25 < 0 )
                {
                  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v25, 0x287u);
                }
                else
                {
                  ...
                  if ( v26 < 0 )
                  {
                    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v26, 0x28Au);
                    v3 = v33;
                  }
                  else
                  {
                    ...
                    if ( v27 < 0 )
                    {
                      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v27, 0x28Bu);
                    }
                    else if ( v32 )
                    {
                      v30 = 0LL;
                      ...
                      if ( v28 < 0 )
                      {
                        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v28, 0x290u);
                      }
                      else
                      {
                        ...
                        v2 = v29;
                        if ( v29 < 0 )
                          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v29, 0x291u);
                      }
                    }
                  }
                }
