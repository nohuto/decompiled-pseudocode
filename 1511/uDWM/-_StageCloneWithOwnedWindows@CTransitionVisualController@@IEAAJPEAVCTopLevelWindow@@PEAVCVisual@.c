/*
 * XREFs of ?_StageCloneWithOwnedWindows@CTransitionVisualController@@IEAAJPEAVCTopLevelWindow@@PEAVCVisual@@H_NW4StagedBackgroundPolicy@1@@Z @ 0x18000AA64
 * Callers:
        ...
        int a6)
{
  ...
  else
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v12, 0x101u);
LABEL_5:
      if ( v13 >= 0 )
        goto LABEL_6;
      goto LABEL_11;
    ...
    if ( *((_DWORD *)v30 + 18) )
    {
      if ( a6 == 1 )
      {
        v7 = (v9[36].left & 0x1000000) == 0;
        rc = v9[3];
        if ( !v7 )
        {
          v15 = v9[36].bottom - v9[36].top;
          if ( v15 < 0 )
            v15 = 0;
          ...
          if ( v15 > v16 )
          {
            v17 = v9[36].bottom - v9[36].top;
            if ( v17 < 0 )
              v17 = 0;
            rc.right = rc.left + v17;
          }
          v18 = v9[37].left - v9[36].right;
          if ( v18 < 0 )
            v18 = 0;
          ...
          if ( v18 > v19 )
          {
            v20 = v9[37].left - v9[36].right;
            if ( v20 < 0 )
              v20 = 0;
            rc.bottom = rc.top + v20;
          }
          OffsetRect(&rc, v9[36].top, v9[36].right);
        }
        if ( (v9[36].left & 0x800000) != 0 )
        {
          v21 = v9[38].bottom - v9[38].top;
          if ( v21 < 0 )
            v21 = 0;
          ...
          if ( v21 > v22 )
          {
            v23 = v9[38].bottom - v9[38].top;
            if ( v23 < 0 )
              v23 = 0;
            rc.right = rc.left + v23;
          }
          v24 = v9[39].left - v9[38].right;
          if ( v24 < 0 )
            v24 = 0;
        ...
        {
          MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v27, 0x127u);
          v11 = v31;
        }
      }
      goto LABEL_5;
