/*
 * XREFs of ?_EnsureBorderShadowAtlas@CAccent@@IEAAJXZ @ 0x180014318
 * Callers:
...
__int64 __fastcall CAccent::_EnsureBorderShadowAtlas(CAccent *this)
{
  ...
  CBaseObject *v11; // [rsp+60h] [rbp+20h] BYREF
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x42Du);
  }
  else
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v6, 0x42Eu);
    }
    else
    {
      v7 = (volatile signed __int32 *)v11;
      v2 = (volatile signed __int32 *)v12;
      inserted = VisualCollection::InsertRelative((CBaseObject *)((char *)v11 + 32), v12, 0LL, 0, 1);
      v1 = inserted;
      if ( inserted < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x42Fu);
        goto LABEL_13;
      }
      ...
      *(_QWORD *)&v10.cyTopHeight = 0LL;
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x433u);
        goto LABEL_13;
      }
      *((_QWORD *)this + 48) = v7;
      if ( v7 )
