/*
 * XREFs of ?OnTransitionWindow@CVirtualDesktopSwitch@@EEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@@Z @ 0x180094870
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( *(_DWORD *)(a1 + 176) )
      {
        while ( 1 )
        {
          ...
          if ( v9 + 1 < v9 )
          {
            ...
            v3 = -2147024362;
LABEL_30:
            MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v12, 0x140Au);
            goto LABEL_22;
          }
...
LABEL_22:
  ...
  if ( v3 >= 0 )
    v3 = -2003304445;
  MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v3, 0x1401u);
LABEL_24:
  if ( v17 )
