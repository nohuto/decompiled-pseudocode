/*
 * XREFs of ?Instance@WindowFrameLogging@@KAPEAV1@XZ @ 0x1800112F4
 * Callers:
...
struct WindowFrameLogging *WindowFrameLogging::Instance(void)
{
  ...
  if ( fPending )
  {
    Context = &qword_1800BBCA8;
    qword_1800BBCA8 = &WindowFrameLogging::`vftable';
    qword_1800BBCC0 = (__int64)&`WindowFrameLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    wil::TraceLoggingProvider::Register(
      (wil::TraceLoggingProvider *)&qword_1800BBCA8,
      (const struct _TlgProvider_t *const)&`WindowFrameLogging::StaticHandle::StaticHandle'::`2'::__hInner);
    InitOnceComplete(&`WindowFrameLogging::Instance'::`2'::wrapper, 0, &qword_1800BBCA8);
  }
