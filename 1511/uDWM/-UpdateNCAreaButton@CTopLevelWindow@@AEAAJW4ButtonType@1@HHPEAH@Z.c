/*
 * XREFs of ?UpdateNCAreaButton@CTopLevelWindow@@AEAAJW4ButtonType@1@HHPEAH@Z @ 0x180027C14
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateNCAreaButton(__int64 a1, int a2, int a3, int a4, _DWORD *a5)
{
  ...
  if ( (v12 & 2) == 0 )
  {
    v15 = (int)floor_0((float)((float)*(int *)(v13 + 680) * 0.95454544) + 0.5);
    if ( (_DWORD)v5 == 3 )
    {
      if ( (v12 & 0xB00) == 0 )
      {
...
LABEL_12:
  ...
  v14 = (int)floor_0((float)((float)*(int *)(v13 + 780) * 0.95454544) + 0.5);
  a3 = v14;
LABEL_13:
  if ( *((_DWORD *)v11 + 32) != a4 )
  {
  ...
  if ( v21 >= 0 )
    *v18 += *(_DWORD *)(*(_QWORD *)(a1 + 8 * v10 + 504) + 112LL);
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v21, 0xD15u);
  return v6;
}
