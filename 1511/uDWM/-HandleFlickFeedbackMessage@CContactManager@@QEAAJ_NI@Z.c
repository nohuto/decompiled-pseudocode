/*
 * XREFs of ?HandleFlickFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x180085AFC
 * Callers:
  ...
  if ( v3 )
  {
    ...
    if ( (int)v6 >= 0 )
    {
      if ( a2 )
      {
        ...
        v5 = CContactManager::LoadFeedbackString(v13, ModuleHandleW, dword_1800ACE30[v11], &v26);
        if ( !v5 )
        {
          v25 = 1772;
LABEL_17:
        ...
        v14 = (_BYTE *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                         WPF::g_pProcessHeap,
                         112LL);
        v15 = v14;
        if ( v14 )
          *v14 = 0;
          ...
          v15 = 0LL;
        *(_QWORD *)(*((_QWORD *)this + 23) + 8 * v9 + 16) = v15;
        v16 = *((_QWORD *)this + 23);
        ...
        v4 = CTrackingTooltip::Initialize(
               *(CTrackingTooltip **)(v16 + 8 * v9 + 16),
               (const struct tagPOINT *)(v16 + 8 + 8 * v9),
               v5);
        if ( v4 < 0 )
        {
          v17 = *(CTrackingTooltip **)(*((_QWORD *)this + 23) + 8 * v9 + 16);
          if ( v17 )
            CTrackingTooltip::`scalar deleting destructor'(v17);
          *(_QWORD *)(*((_QWORD *)this + 23) + 8 * v9 + 16) = 0LL;
        }
      }
      else
      {
        v18 = *(CTrackingTooltip **)(v8 + 24 * v6 + 16);
        if ( v18 )
