/*
 * XREFs of ?NotifyRedirectionShutdown@CDesktopManager@@QEAAJXZ @ 0x180074CFC
 * Callers:
...
__int64 __fastcall CDesktopManager::NotifyRedirectionShutdown(CDesktopManager *this)
{
  ...
  *((_BYTE *)this + 19) = 1;
  if ( *((_QWORD *)v1 + 8) )
  {
    ...
    v3 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x40Du);
    if ( v3 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0x1C9u);
  }
  else
  {
    v3 = 0;
  ...
  if ( *((_QWORD *)this + 190) )
  {
    ...
    if ( !PostThreadMessageW(*((_DWORD *)this + 378), 0x12u, 0LL, 0LL) )
    {
      ...
      if ( v3 >= 0 )
        v3 = -2003304445;
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0x1D5u);
    }
    if ( v3 >= 0 )
    {
      ...
      if ( WaitForSingleObject(*((HANDLE *)this + 190), 0xFFFFFFFF) )
      {
        ...
        if ( v3 >= 0 )
          v3 = -2003304445;
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0x1DDu);
      }
