/*
 * XREFs of ?RegisterThumbnail@CWindowList@@AEAAJKPEAUMILCMD_DWM_REDIRECTION_REGISTERTHUMBNAIL@@@Z @ 0x180040CA8
 * Callers:
...
LABEL_41:
  ...
  if ( v20 <= *((_DWORD *)v10 + 119) )
  {
    *(_QWORD *)(*((_QWORD *)v10 + 57) + 8LL * *((unsigned int *)v10 + 120)) = v32;
    *((_DWORD *)v10 + 120) = v20;
    goto LABEL_23;
  }
  v21 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v10 + 456, 8u, 1, &v32);
  v18 = v21;
  if ( v21 < 0 )
...
LABEL_44:
  ...
  v8 = 0;
  if ( v23 <= *((_DWORD *)v11 + 127) )
  {
    *(_QWORD *)(*((_QWORD *)v11 + 61) + 8LL * *((unsigned int *)v11 + 128)) = v32;
    *((_DWORD *)v11 + 128) = v23;
    goto LABEL_28;
  }
  v24 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v11 + 488, 8u, 1, &v32);
  v18 = v24;
  if ( v24 < 0 )
