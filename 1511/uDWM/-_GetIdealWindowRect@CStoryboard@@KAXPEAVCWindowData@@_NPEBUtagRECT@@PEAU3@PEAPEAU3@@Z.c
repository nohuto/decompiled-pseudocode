/*
 * XREFs of ?_GetIdealWindowRect@CStoryboard@@KAXPEAVCWindowData@@_NPEBUtagRECT@@PEAU3@PEAPEAU3@@Z @ 0x180002598
 * Callers:
        ...
        struct tagRECT **a5)
{
  ...
  v8 = (const RECT *)((char *)a1 + 596);
  if ( a2 )
  {
    v10 = (struct tagRECT *)((char *)a1 + 580);
  }
  else
  {
    v8 = (const RECT *)((char *)a1 + 628);
    v10 = (struct tagRECT *)((char *)a1 + 612);
  }
  v9 = a2 != 0 ? 0x1000000 : 0x800000;
  if ( (v9 & *((_DWORD *)a1 + 144)) != v9 || IsRectEmpty(v8) )
  {
    if ( a3 )
      v11 = *a3;
    else
