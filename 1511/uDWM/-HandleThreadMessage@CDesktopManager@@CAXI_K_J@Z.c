/*
 * XREFs of ?HandleThreadMessage@CDesktopManager@@CAXI_K_J@Z @ 0x180039324
 * Callers:
  ...
  if ( a1 != 1027 )
  {
    switch ( a1 )
    {
      ...
      case 1025:
        ...
        *((_BYTE *)CDesktopManager::s_pDesktopManagerInstance + 1408) = (_DWORD)LastActivePopup != 0;
        CWindowList::UpdateShellWindowFrameColorization(*((CWindowList **)v4 + 167));
        break;
      default:
        return;
    }
