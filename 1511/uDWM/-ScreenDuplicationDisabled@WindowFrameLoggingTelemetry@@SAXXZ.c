/*
 * XREFs of ?ScreenDuplicationDisabled@WindowFrameLoggingTelemetry@@SAXXZ @ 0x18007BB54
 * Callers:
...
void WindowFrameLoggingTelemetry::ScreenDuplicationDisabled(void)
{
  ...
  {
    TlgWrite(v0, &unk_1800A99FC, 0LL, 0LL, 2u, &pData);
  }
}
