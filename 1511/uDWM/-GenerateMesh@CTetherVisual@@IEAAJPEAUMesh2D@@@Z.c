/*
 * XREFs of ?GenerateMesh@CTetherVisual@@IEAAJPEAUMesh2D@@@Z @ 0x18008A398
 * Callers:
...
__int64 __fastcall CTetherVisual::GenerateMesh(CTetherVisual *this, struct Mesh2D *a2)
{
  ...
  if ( v13 )
  {
    ...
    v17 = *((_DWORD *)this + 73) + (int)(float)((float)(*((_DWORD *)this + 71) - *((_DWORD *)this + 73)) * v15);
  }
  else
  {
    v17 = HIDWORD(v44);
  ...
  *((_DWORD *)this + 74) = v16 - v7;
  *((_DWORD *)this + 76) = v14 - v7;
  *((_DWORD *)this + 79) = v17 + v8;
  *((_DWORD *)this + 81) = HIDWORD(v14) + v8;
  *((_DWORD *)this + 75) = v17 - v8;
  *((_DWORD *)this + 80) = v14 + v7;
  *((_DWORD *)this + 77) = HIDWORD(v14) - v8;
  v48[1] = 1;
  v48[3] = 1;
  v48[5] = 3;
  v18 = _mm_cvtsi32_si128(*((_DWORD *)this + 85));
  v19 = _mm_cvtsi32_si128(*((_DWORD *)this + 87));
  ...
  *((float *)&v46 + 3) = (float)(v17 + v8);
  ...
  v23 = v22 + 4;
  *((float *)&v47 + 1) = v21;
  v24 = _mm_cvtsi32_si128(*((_DWORD *)this + 84));
  DWORD2(v47) = _mm_cvtepi32_ps(v20).m128_u32[0];
  v25 = _mm_cvtsi32_si128(*((_DWORD *)this + 86));
...
LABEL_37:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v35, 0xD7u);
  return v27;
}
