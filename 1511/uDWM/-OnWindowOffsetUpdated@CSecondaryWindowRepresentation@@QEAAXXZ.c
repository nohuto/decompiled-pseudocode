/*
 * XREFs of ?OnWindowOffsetUpdated@CSecondaryWindowRepresentation@@QEAAXXZ @ 0x18001717C
 * Callers:
 ...
 *     ?GetOffsetToOwner@CWindowData@@QEAA?AUtagPOINT@@XZ @ 0x18001D584 (-GetOffsetToOwner@CWindowData@@QEAA-AUtagPOINT@@XZ.c)
