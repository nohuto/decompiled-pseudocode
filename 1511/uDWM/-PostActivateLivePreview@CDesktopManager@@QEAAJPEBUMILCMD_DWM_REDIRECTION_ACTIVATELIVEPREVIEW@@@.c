/*
 * XREFs of ?PostActivateLivePreview@CDesktopManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_ACTIVATELIVEPREVIEW@@@Z @ 0x1800212C0
 * Callers:
    ...
    if ( v6 )
    {
      ...
      *(_OWORD *)(v6 + 36) = *((_OWORD *)a2 + 2);
      ...
      else
      {
        ...
        v2 = LastError;
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, LastError, 0x866u);
      }
    }
    else
    {
      v2 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024882, 0x857u);
    }
  }
  else
  {
    v2 = -2147467259;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147467259, 0x84Eu);
  }
