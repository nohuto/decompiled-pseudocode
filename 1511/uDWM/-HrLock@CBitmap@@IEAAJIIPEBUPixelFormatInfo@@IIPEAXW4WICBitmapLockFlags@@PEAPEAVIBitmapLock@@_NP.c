/*
 * XREFs of ?HrLock@CBitmap@@IEAAJIIPEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@_NPEAUIUnknown@@@Z @ 0x180042494
 * Callers:
 ...
 *     ??0CBitmapLock@@QEAA@XZ @ 0x1800419FC (--0CBitmapLock@@QEAA@XZ.c)
