/*
 * XREFs of ?UpdateTransition@CIndirectTouchVisual@@MEAAJXZ @ 0x180092EA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StopOpacityTimeline@CIndirectTouchVisual@@IEAAXXZ @ 0x180092DBC (-StopOpacityTimeline@CIndirectTouchVisual@@IEAAXXZ.c)
