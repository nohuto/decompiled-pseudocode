/*
 * XREFs of ?RegisterWindowClass@CDesktopManager@@SAJPEBGP6A_JPEAUHWND__@@I_K_J@ZPEAG@Z @ 0x180043BD8
 * Callers:
        ...
        unsigned __int16 *a3)
{
  ...
  if ( (dword_1800BE750 & 1) == 0 )
  {
    dword_1800BE660 = -2147023486;
    dword_1800BE750 |= 1u;
  }
  v4 = 0;
  WndClass.style = 0;
  ...
  *a3 = v5;
  if ( !v5 )
  {
    ...
    if ( v8 >= 0 )
      v8 = -2003304445;
    MilInstrumentationCheckHR(0x14u, &dword_1800BE660, 1LL, v8, 0x5C8u);
    if ( v8 == -2147023486 )
      return 0;
