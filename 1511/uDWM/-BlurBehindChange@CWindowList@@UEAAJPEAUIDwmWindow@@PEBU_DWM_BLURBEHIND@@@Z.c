/*
 * XREFs of ?BlurBehindChange@CWindowList@@UEAAJPEAUIDwmWindow@@PEBU_DWM_BLURBEHIND@@@Z @ 0x18002EA30
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DWM_BLURBEHIND *a3)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0x118Du);
  }
  else
  {
    v8 = v14;
    if ( v14 )
    {
      if ( (a3->dwFlags & 1) != 0 )
      {
        fEnable = a3->fEnable;
        *((_BYTE *)v14 + 569) &= ~4u;
        *((_BYTE *)v8 + 569) |= 4 * fEnable;
      }
      if ( (a3->dwFlags & 4) != 0 )
      {
        fTransitionOnMaximized = a3->fTransitionOnMaximized;
        *((_BYTE *)v8 + 569) &= ~8u;
        *((_BYTE *)v8 + 569) |= 8 * fTransitionOnMaximized;
      }
