/*
 * XREFs of ?_IsAnimationComponentVisible@CTransitionVisualController@@IEAA_NPEAVCAnimationComponent@@@Z @ 0x180070450
 * Callers:
        ...
        struct CAnimationComponent *a2)
{
  ...
  if ( !*((_BYTE *)a2 + 65)
    ...
    && (*((_BYTE *)a2 + 67) || (unsigned __int8)CTransitionVisualController::HasVisibleStyle(*((HWND *)a2 + 2))) )
  {
    return 1;
  }
  return v2;
