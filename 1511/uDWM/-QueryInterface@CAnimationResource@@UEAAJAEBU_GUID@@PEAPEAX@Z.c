/*
 * XREFs of ?QueryInterface@CAnimationResource@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009D870
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAnimationResource::QueryInterface(CAnimationResource *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( !v5 )
    goto LABEL_15;
  v6 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_cadfc221_2187_4f55_b289_01544817b158.Data1;
  if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_cadfc221_2187_4f55_b289_01544817b158.Data1 )
    v6 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_cadfc221_2187_4f55_b289_01544817b158.Data4;
  if ( !v6 )
    goto LABEL_15;
