/*
 * XREFs of ?EnsureAnimationObjects@CWindowArrangementTransition@@AEAAJXZ @ 0x180084420
 * Callers:
...
__int64 __fastcall CWindowArrangementTransition::EnsureAnimationObjects(struct CAnimatedGlassSheet **this)
{
  ...
  if ( (dword_1800BF418 & 1) == 0 )
  {
    dword_1800BF36C = -2147023728;
    dword_1800BF418 |= 1u;
  }
  v2 = 0;
        ...
        v4 >= 0) )
  {
    if ( !this[1] )
    {
      ...
      if ( BitmapsFromAtlasImageStrip >= 0 )
      {
        ...
        v2 = v7;
        if ( v7 < 0 )
          MilInstrumentationCheckHR(0x14u, &dword_1800BF36C, 1LL, v7, 0x46u);
      }
      ...
      {
        MilInstrumentationCheckHR(0x14u, &dword_1800BF36C, 1LL, BitmapsFromAtlasImageStrip, 0x40u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, &dword_1800BF36C, 1LL, v4, 0x2Eu);
  }
  return v2;
}
