/*
 * XREFs of ?CreateBrush@CDesktopThumbnailCVI@@QEAAJPEAPEAVCCachedVisualImageBrushResource@@PEAPEAVCResource@@1AEBUtagRECT@@@Z @ 0x180099D90
 * Callers:
        ...
        const struct tagRECT *a5)
{
  ...
  if ( a4 )
  {
    v10 = CResource::Create(0x31u, *((_QWORD *)this + 2), &v27);
    v11 = v10;
    if ( v10 < 0 )
    {
