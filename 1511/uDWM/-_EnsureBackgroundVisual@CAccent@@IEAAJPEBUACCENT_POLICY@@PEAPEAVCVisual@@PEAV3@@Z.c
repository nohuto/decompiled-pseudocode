/*
 * XREFs of ?_EnsureBackgroundVisual@CAccent@@IEAAJPEBUACCENT_POLICY@@PEAPEAVCVisual@@PEAV3@@Z @ 0x180010C90
 * Callers:
        ...
        struct CVisual *a4)
{
  ...
  if ( (*(_DWORD *)a2 & 0xFFFFFFFB) != 0 && !*a3 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x2D1u);
    }
    else
    {
      ...
      if ( inserted >= 0 )
        return v4;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, inserted, 0x2D2u);
    }
    if ( *a3 )
    {
