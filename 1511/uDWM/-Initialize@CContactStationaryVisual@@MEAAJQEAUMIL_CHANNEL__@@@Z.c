/*
 * XREFs of ?Initialize@CContactStationaryVisual@@MEAAJQEAUMIL_CHANNEL__@@@Z @ 0x1800880C0
 * Callers:
...
__int64 __fastcall CContactStationaryVisual::Initialize(struct CImage **this, struct MIL_CHANNEL__ *const a2)
{
  int v4; // eax
  unsigned int v5; // ebx
  int v6; // eax
