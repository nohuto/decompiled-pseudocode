/*
 * XREFs of ?OnWindowSizeUpdated@CTopLevelWindow3D@@QEAAXXZ @ 0x180035C44
 * Callers:
...
void __fastcall CTopLevelWindow3D::OnWindowSizeUpdated(CTopLevelWindow3D *this)
{
  ...
  else if ( !EqualRect((const RECT *)(*((_QWORD *)this + 39) + 48LL), (const RECT *)((char *)this + 292)) )
  {
    ...
    if ( started < 0 )
      wil::details::in1diag3::_Log_Hr(retaddr, (void *)0x14F, v6, (const char *)(unsigned int)started, v7);
  }
}
