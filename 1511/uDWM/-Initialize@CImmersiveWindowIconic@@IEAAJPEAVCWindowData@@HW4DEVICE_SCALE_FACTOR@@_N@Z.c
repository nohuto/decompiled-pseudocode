/*
 * XREFs of ?Initialize@CImmersiveWindowIconic@@IEAAJPEAVCWindowData@@HW4DEVICE_SCALE_FACTOR@@_N@Z @ 0x180079784
 * Callers:
        ...
        unsigned int a5)
{
  ...
  *((_DWORD *)this + 75) = a4;
  ...
  v12 = CVisual::Initialize(this, *((struct MIL_CHANNEL__ *const *)v8 + 4));
  v13 = v12;
  if ( v12 >= 0 )
  {
    v14 = CImage::Create(
