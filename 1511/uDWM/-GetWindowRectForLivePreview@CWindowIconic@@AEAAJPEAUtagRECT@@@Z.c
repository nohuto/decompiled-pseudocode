/*
 * XREFs of ?GetWindowRectForLivePreview@CWindowIconic@@AEAAJPEAUtagRECT@@@Z @ 0x180082378
 * Callers:
...
__int64 __fastcall CWindowIconic::GetWindowRectForLivePreview(CWindowIconic *this, struct tagRECT *a2)
{
  ...
  v3 = 0;
  v4 = *((_QWORD *)this + 9);
  if ( (*(_BYTE *)(v4 + 570) & 1) == 0 || (MDIOwner = CWindowData::GetMDIOwner((HWND *)v4)) == 0LL )
    MDIOwner = (struct CWindowData *)*((_QWORD *)this + 9);
  v7 = *((_QWORD *)MDIOwner + 50);
  if ( v7 )
  {
