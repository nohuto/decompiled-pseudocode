/*
 * XREFs of ?Activate@CLivePreview@@QEAAJ_NPEAUHWND__@@1W4LIVEPREVIEW_TRIGGER@@I0PEAUtagRECT@@@Z @ 0x180039DEC
 * Callers:
...
LABEL_32:
        ...
        if ( a2 )
        {
          if ( TabWindowData && (*((_BYTE *)TabWindowData + 568) & 4) != 0 )
            return v12;
          ...
          *(_DWORD *)(a1 + 544) = a5;
          ...
          if ( !*(_QWORD *)(a1 + 536) )
          {
            ...
            if ( v27 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v27, 0x37Bu);
              goto LABEL_89;
            }
          }
          v28 = *(_QWORD *)(a1 + 528);
          ...
          *(_BYTE *)(a1 + 266) = a5 == 4;
          ...
          else
          {
            if ( !*(_DWORD *)(a1 + 312) )
            {
              ...
              if ( v29 < 0 )
              {
                MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v29, 0x390u);
                goto LABEL_89;
              }
            }
...
LABEL_90:
  while ( 1 )
  {
    ...
    if ( v38 >= 0 )
      break;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v38, 0x3DBu);
  }
