/*
 * XREFs of ?LookupAndValidateMagnifier@CMagnifierControl@@AEAAJ_KPEAPEAVCMagnifier@@@Z @ 0x18007B05C
 * Callers:
        ...
        struct CMagnifier **a3)
{
  ...
  v3 = 0;
  if ( (dword_1800BF408 & 1) == 0 )
  {
    dword_1800BF340 = -2147023728;
    dword_1800BF408 |= 1u;
  }
  ...
  {
    v3 = -2147023728;
    MilInstrumentationCheckHR(0x14u, &dword_1800BF340, 1LL, -2147023728, 0x1B6u);
  }
  return v3;
}
