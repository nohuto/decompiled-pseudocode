/*
 * XREFs of ?SetVisual@CAnimatedTransitionVisual@@QEAAJPEAVCVisual@@_NPEBUtagRECT@@@Z @ 0x18000D970
 * Callers:
        ...
        const struct tagRECT *a4)
{
  ...
  else
  {
    ...
    if ( v29 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v29, 0x2F4u);
    }
    else if ( a3
           && (v30 = this[71], *(_QWORD *)&v38.left = 163LL, v31 = CResource::Send(v30, &v38, 8u), v9 = v31, v31 < 0) )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v31, 0x2FBu);
    }
    else
    {
      ...
      v9 = updated;
      if ( updated < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, updated, 0x2FFu);
    }
  }
  return v9;
}
