/*
 * XREFs of ?SetSwapchainTargetForWindow@CWindowList@@UEAAJPEAUIDwmWindow@@_NPEAUMIL_CHANNEL__@@I@Z @ 0x180081A80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v15, 0x13B2u);
    v9 = v19;
    goto LABEL_14;
  }
  v9 = v19;
