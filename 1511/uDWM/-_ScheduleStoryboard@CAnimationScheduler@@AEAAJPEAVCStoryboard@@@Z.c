/*
 * XREFs of ?_ScheduleStoryboard@CAnimationScheduler@@AEAAJPEAVCStoryboard@@@Z @ 0x180005D30
 * Callers:
...
__int64 __fastcall CAnimationScheduler::_ScheduleStoryboard(CAnimationScheduler *this, struct CStoryboard *a2)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_1800ACEA8, 1u, v3, 0x3A1u);
  }
  else
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800ACEA8, 1u, v5, 0x3A4u);
    }
