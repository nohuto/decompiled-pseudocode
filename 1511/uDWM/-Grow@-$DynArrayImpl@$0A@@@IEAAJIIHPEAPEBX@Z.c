/*
 * XREFs of ?Grow@?$DynArrayImpl@$0A@@@IEAAJIIHPEAPEBX@Z @ 0x18002B0D0
 * Callers:
...
__int64 __fastcall DynArrayImpl<0>::Grow(__int64 a1, unsigned int a2, int a3, int a4, unsigned __int64 *a5)
{
  ...
  void *(__fastcall *v18)(WPF::ProcessHeapImpl *__hidden, unsigned __int64); // r14
  void *v19; // rax
  int v20; // eax
  int (*v22)(WPF::ProcessHeapImpl *__hidden, void **, unsigned __int64); // rbp
  int v23; // eax
  const void *v24; // rdx
  ...
  if ( v5 + a3 < v5 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024362, 0xE7u);
    return 2147942934LL;
  }
  v10 = *(_DWORD *)(a1 + 20);
  if ( v9 <= v10 )
  ...
  if ( v11 > 0xFFFFFFFF )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024362, 0xF0u);
    return 2147942934LL;
  }
  if ( a4 )
    goto LABEL_40;
...
LABEL_13:
  ...
  if ( v15 <= v16 )
  {
    if ( *(_QWORD *)a1 == *(_QWORD *)(a1 + 8) )
    {
      ...
      if ( (v17 & 0x80000000) != 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v17, 0x111u);
        return v17;
      }
      v20 = *(_DWORD *)(a1 + 24);
      if ( v20 )
    ...
    else
    {
      ...
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v23, 0x12Au);
        return v17;
      }
      v24 = *(const void **)a1;
      v6 = v26;
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024362, 0x10Au);
  return 2147942934LL;
}
