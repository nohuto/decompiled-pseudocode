/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x18007FB70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0xFABu);
    goto LABEL_35;
  }
  v13 = v31;
  if ( !v31 )
  ...
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0xFB5u);
    goto LABEL_35;
  }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, DesktopThumbnail, 0xFB9u);
LABEL_27:
    v16 = v29;
    goto LABEL_28;
  }
  ...
  *((_QWORD *)v29 + 37) = *((_QWORD *)v13 + 15);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0xFBAu);
    goto LABEL_28;
  }
  v34 = *a4;
  ...
  if ( PerMonitorDesktopThumbnail >= 0 )
  {
    ...
    if ( v20 )
    {
      if ( (a6 & 0x200000) != 0 )
      {
        VisualCollection::Remove((VisualCollection *)(*(_QWORD *)(v20 + 24) + 32LL), *((struct CVisual **)v13 + 70));
        v21 = (CBaseObject *)*((_QWORD *)v13 + 70);
        if ( v21 )
        {
      ...
      {
        *(_DWORD *)(v20 + 324) = a6;
        CDesktopThumbnailCVIVisual::Update(*((CDesktopThumbnailCVIVisual **)v13 + 70), a3, (double)a5 / 255.0);
      }
      goto LABEL_28;
    }
    if ( (a6 & 0x200000) == 0 )
      ...
      if ( v22 >= 0 )
      {
        ...
        *((_BYTE *)v24 + 321) = 0;
        ...
        if ( v25 >= 0 )
        {
          ...
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v26, 0xFDBu);
        }
        else
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v25, 0xFD8u);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v22, 0xFD2u);
        v11 = (volatile signed __int32 *)v28;
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, PerMonitorDesktopThumbnail, 0xFBBu);
  }
LABEL_28:
  if ( v16 )
