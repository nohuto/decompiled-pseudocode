/*
 * XREFs of ?OnWindowShowHide@CLivePreview@@QEAAJPEAVCWindowData@@PEA_N_N@Z @ 0x180039D68
 * Callers:
...
__int64 __fastcall CLivePreview::OnWindowShowHide(CLivePreview *this, struct CWindowData *a2, bool *a3, char a4)
{
  ...
  char v30; // al
  struct CTopLevelWindow *v31; // r14
  struct CTopLevelWindow *v32; // rsi
  __int64 v33; // r14
  __int64 v34; // rdx
  ...
  struct CTopLevelWindow *v67; // [rsp+38h] [rbp-C8h] BYREF
  CTopLevelWindow *v68; // [rsp+40h] [rbp-C0h]
  bool *v69; // [rsp+48h] [rbp-B8h]
  struct CWindowData *v70; // [rsp+50h] [rbp-B0h] BYREF
  __int128 v71; // [rsp+58h] [rbp-A8h]
  bool v72; // [rsp+68h] [rbp-98h]
  struct CTopLevelWindow *v73; // [rsp+70h] [rbp-90h]
...
LABEL_70:
    ...
    if ( (int)v43 >= 0 )
    {
      ...
      v49 = (CTopLevelWindow *)*((_QWORD *)a2 + 48);
      if ( v49 )
...
LABEL_93:
    ...
    if ( v57 >= 0 )
    {
      ...
      do
      {
        v68 = *(CTopLevelWindow **)(v58 + *((_QWORD *)this + 48));
  ...
  {
    v68 = (CTopLevelWindow *)*((_QWORD *)a2 + 48);
    v12 = v68;
...
LABEL_30:
    ...
    {
      v28 = *((_BYTE *)a2 + 570) ^ (*((_BYTE *)a2 + 570) ^ ((*((_QWORD *)a2 + 44) != 0LL) << 6)) & 0x40;
      *((_BYTE *)a2 + 570) = v28;
      v29 = *((_DWORD *)this + 139);
      if ( v29 >= 0xA )
        *((_BYTE *)a2 + 570) = v28 | 0x80;
      else
