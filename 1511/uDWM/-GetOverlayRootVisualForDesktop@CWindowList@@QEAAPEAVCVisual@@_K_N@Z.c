/*
 * XREFs of ?GetOverlayRootVisualForDesktop@CWindowList@@QEAAPEAVCVisual@@_K_N@Z @ 0x18002C4B4
 * Callers:
...
struct CVisual *__fastcall CWindowList::GetOverlayRootVisualForDesktop(CWindowList *this, unsigned __int64 a2, char a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      v9 = CVisual::Create(*((struct MIL_CHANNEL__ *const *)CDesktopManager::s_pDesktopManagerInstance + 4), &v15);
      v10 = v9;
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x4BDu);
      }
      else
      {
        ...
        if ( inserted < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x4BEu);
          goto LABEL_12;
        }
        *(_QWORD *)(v7 + 40) = v11;
        if ( !v11 )
