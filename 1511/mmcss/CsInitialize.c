/*
 * XREFs of CsInitialize @ 0x1C000D030
 * Callers:
 *     GsDriverEntry @ 0x1C000D000 (GsDriverEntry.c)
 * Callees:
 *     WPP_SF_D @ 0x1C0003DB0 (WPP_SF_D.c)
 *     WPP_SF_d @ 0x1C0004254 (WPP_SF_d.c)
 *     WppInitKm @ 0x1C000B690 (WppInitKm.c)
 *     WppLoadTracingSupport @ 0x1C000B700 (WppLoadTracingSupport.c)
