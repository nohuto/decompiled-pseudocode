/*
 * XREFs of CiLogThreadJoin @ 0x1C0003B88
 * Callers:
...
NTSTATUS __fastcall CiLogThreadJoin(__int64 a1)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v18 = 1LL;
  v4 = -1LL;
  while ( *(_WORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 96) + 24LL) + 2 * v4++ + 2) != 0 )
    ;
  v19 = *(_QWORD *)(*(_QWORD *)(v3 + 96) + 24LL);
  v20 = 2 * v4 + 2;
  v21 = 0;
  v22 = v3 + 104;
  v23 = 4LL;
  v6 = (*(_BYTE *)(*(_QWORD *)(v3 + 96) + 3LL) >> 4) & 7;
  v24 = &v10;
  v10 = v6;
  v25 = 1LL;
  v7 = *(_BYTE *)(*(_QWORD *)(v3 + 96) + 3LL) & 0x1F;
  v26 = &v9;
  v9 = v7;
  v27 = 1LL;
