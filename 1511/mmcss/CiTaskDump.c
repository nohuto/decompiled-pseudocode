/*
 * XREFs of CiTaskDump @ 0x1C000D8A0
 * Callers:
 *     CiConfigInitializeFromRegistry @ 0x1C000D640 (CiConfigInitializeFromRegistry.c)
 * Callees:
 *     WPP_SF_P @ 0x1C0004170 (WPP_SF_P.c)
 *     WPP_SF_S @ 0x1C00041C0 (WPP_SF_S.c)
...
__int64 __fastcall CiTaskDump(unsigned __int8 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (HIDWORD(v4->Timer) & 1) != 0 && BYTE1(v4->Timer) >= 5u )
  {
    WPP_SF_d(
      ...
      0xCu,
      (__int64)&WPP_e1de190dcddd688b0bae7d2e89c8ef5d_Traceguids,
      *((_DWORD *)a1 + 1));
    v4 = WPP_GLOBAL_Control;
  }
  if ( (HIDWORD(v4->Timer) & 1) != 0 && BYTE1(v4->Timer) >= 5u )
  {
    WPP_SF_d((__int64)v4->AttachedDevice, 0xDu, (__int64)&WPP_e1de190dcddd688b0bae7d2e89c8ef5d_Traceguids, *a1);
    v4 = WPP_GLOBAL_Control;
  }
  if ( (HIDWORD(v4->Timer) & 1) != 0 && BYTE1(v4->Timer) >= 5u )
  {
    WPP_SF_d((__int64)v4->AttachedDevice, 0xEu, (__int64)&WPP_e1de190dcddd688b0bae7d2e89c8ef5d_Traceguids, a1[1]);
    v4 = WPP_GLOBAL_Control;
  }
  if ( (HIDWORD(v4->Timer) & 1) != 0 && BYTE1(v4->Timer) >= 5u )
  {
