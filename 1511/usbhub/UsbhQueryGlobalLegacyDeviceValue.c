/*
 * XREFs of UsbhQueryGlobalLegacyDeviceValue @ 0x1C00268C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( LOWORD(v11->DeviceType) )
    WPP_RECORDER_SF_q(v11->DeviceExtension, a2, 1, 71, (__int64)&WPP_d60ab5880563f7a022b5a2715e337d91_Traceguids, a6);
  v12 = a2 - 1;
  if ( v12 )
  {
    if ( v12 == 2 )
