/*
 * XREFs of UsbhFdoPnp_QueryDeviceRelations @ 0x1C0024E10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhFdoPnp_QueryDeviceRelations(__int64 a1, KSPIN_LOCK *a2)
{
  __int64 v2; // r8
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  v7 = *(_DWORD *)(v2 + 8);
  if ( !v7 )
    return UsbhQueryBusRelations(a1, a2, v2, (__int64)a2);
  v9 = 1363431999;
  if ( v7 == 4 )
    v9 = 1363432052;
