/*
 * XREFs of UsbhCreateDevice @ 0x1C0009880
 * Callers:
...
__int64 __fastcall UsbhCreateDevice(__int64 a1, __int64 a2, unsigned __int16 a3, unsigned __int16 a4)
{
  ...
  if ( (*(_DWORD *)(v8 + 2560) & 0x40) != 0 )
  {
    ...
    if ( !DeviceHandle )
    {
      LOBYTE(v21) = 0;
      v16 = -1073741823;
      UsbhException(a1, (unsigned __int16)v5, 5, 0, 0, -1073741823, -1, usbfile_bus_c, 6191, v21);
...
LABEL_3:
    if ( *(_QWORD *)(v8 + 4256) )
    {
      ...
      if ( (v16 & 0xC0000000) == 0xC0000000 )
      {
        ...
        LOBYTE(v21) = 0;
        UsbhException(a1, (unsigned __int16)v5, 4, (int)v28, 84, v16, -1, usbfile_bus_c, 6311, v21);
  ...
  LOBYTE(v21) = 0;
  UsbhException(a1, (unsigned __int16)v5, 104, 0, 0, TtDeviceHandle, -1, usbfile_bus_c, 6210, v21);
