/*
 * XREFs of UsbhAcquirePowerContext @ 0x1C0024BFC
 * Callers:
...
char *__fastcall UsbhAcquirePowerContext(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6, char a7)
{
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(a2 + 136) = 1;
    ...
    v14 = (__int64 **)qword_1C0067620;
    *((_QWORD *)v13 + 2) = qword_1C0067620;
    *((_QWORD *)v13 + 1) = &qword_1C0067618;
    if ( *v14 != &qword_1C0067618 )
      __fastfail(3u);
    *v14 = (__int64 *)(v13 + 8);
    qword_1C0067620 = (__int64)(v13 + 8);
    *(_DWORD *)(a2 + 136) = 0;
