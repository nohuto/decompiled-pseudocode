/*
 * XREFs of Usbh_PCE_psPAUSED_Action @ 0x1C0020810
 * Callers:
  ...
  if ( v21 == 12 || v21 >= 5 && (v21 <= 6 || v21 == 16) )
  {
    *(_DWORD *)(32LL * *(unsigned int *)(a2 + 2400) + a2 + 1384) = v21;
    ...
    while ( *v30 != (__int64 *)v30 )
    {
      v58 = *v30;
      v59 = **v30;
      if ( (__int64 **)(*v30)[1] != v30 || *(__int64 **)(v59 + 8) != v58 )
        __fastfail(3u);
      *v30 = (__int64 *)v59;
      *(_QWORD *)(v59 + 8) = v30;
      UsbhFreePortChangeQueueObject(a1, a2, (__int64)(v58 - 2), 1);
    }
    ...
    *(_DWORD *)(v36 + a2 + 1384) = v35;
    ...
    if ( v38 )
    {
      v60 = (KSPIN_LOCK *)(v6 + 5168);
      *(_DWORD *)(a2 + 416) = 1;
      v61 = KeAcquireSpinLockRaiseToDpc(v60);
      if ( *((_QWORD *)PdoExt(v38, v62, v63, v64) + 108) )
      {
      ...
      UsbhBusUnlatchPdo(a1, v38, a2, v65, 0LL);
    }
  }
  else
  {
    ...
    else
    {
      ...
      *(_DWORD *)(a2 + 12) = 8;
      *(_DWORD *)(v57 + a2 + 1384) = 8;
    }
    UsbhSignalPauseEvent(a1, a2, v51, v52);
