/*
 * XREFs of UsbhBusConnectPdo @ 0x1C0008C4C
 * Callers:
  ...
  *(_QWORD *)(v2 + 24) = KeGetCurrentThread();
  ...
  if ( v5 )
  {
    ...
    if ( (_DWORD)v6 != 3 )
    {
      ...
      *(_QWORD *)(v7 + 4816) = v12;
      LOBYTE(v11) = 1;
      UsbhEtwLogDeviceInformation(v8, &USBHUB_ETW_EVENT_DEVICE_ADD, v11);
      ...
      *(_DWORD *)(v2 + 88) = 1734964085;
      ...
      if ( (*(_DWORD *)(v8 + 1412) & 0x100) != 0 )
      {
        if ( !LOWORD(v14->DeviceType) )
          goto LABEL_10;
        WPP_RECORDER_SF_(v14->DeviceExtension, 0, 1, 44, (__int64)&WPP_023598a80677ca4034006684006c4b8e_Traceguids);
        v14 = WPP_GLOBAL_Control;
      }
      if ( LOWORD(v14->DeviceType) )
      {
        WPP_RECORDER_SF_(v14->DeviceExtension, 0, 1, 45, (__int64)&WPP_023598a80677ca4034006684006c4b8e_Traceguids);
        v14 = WPP_GLOBAL_Control;
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
        {
          WPP_RECORDER_SF_d(
...
LABEL_10:
      if ( *(_QWORD *)(v8 + 2080) && LOWORD(v14->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v14->DeviceExtension,
          0,
      ...
      if ( *(_QWORD *)(v8 + 2096) && LOWORD(v14->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v14->DeviceExtension,
          0,
      ...
      if ( *(_QWORD *)(v8 + 2112) && LOWORD(v14->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v14->DeviceExtension,
          0,
      ...
      if ( *(_QWORD *)(v8 + 2144) && LOWORD(v14->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v14->DeviceExtension,
          0,
      ...
      if ( *(_QWORD *)(v8 + 2128) && LOWORD(v14->DeviceType) )
      {
        WPP_RECORDER_SF_S(
          v14->DeviceExtension,
          0,
...
LABEL_25:
      ...
      if ( LOWORD(v14->DeviceType) )
      {
        WPP_RECORDER_SF_(v14->DeviceExtension, 0, 1, 67, (__int64)&WPP_023598a80677ca4034006684006c4b8e_Traceguids);
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
          WPP_RECORDER_SF_(
            WPP_GLOBAL_Control->DeviceExtension,
            0,
    ...
    *(_DWORD *)(v2 + 88) = 1734964085;
    KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels, *(_BYTE *)(v2 + 132));
    UsbhSignalSyncDeviceReset(a1, v5, a2, 0);
  }
  else
  {
    *(_DWORD *)(v2 + 136) = 0;
