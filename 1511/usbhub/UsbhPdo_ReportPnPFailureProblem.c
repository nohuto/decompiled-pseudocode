/*
 * XREFs of UsbhPdo_ReportPnPFailureProblem @ 0x1C0054A28
 * Callers:
 ...
 *     RtlUnalignedStringCbLengthW @ 0x1C0053528 (RtlUnalignedStringCbLengthW.c)
 */
...
void __fastcall UsbhPdo_ReportPnPFailureProblem(PDEVICE_OBJECT DeviceObject, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v8[699] )
  {
    ...
    if ( RtlFindMessage(WPP_MAIN_CB.Queue.ListEntry.Flink[1].Blink, 0xBu, 0, v8[699], &v14) >= 0
