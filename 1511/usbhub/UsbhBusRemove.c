/*
 * XREFs of UsbhBusRemove @ 0x1C0042B90
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall UsbhBusRemove(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  _DWORD *v6; // rdi
  __int64 v7; // r9
  __int64 v8; // rdx
  ...
  if ( v12 )
  {
    ...
    while ( v13 < *((unsigned __int8 *)FdoExt(a1, v8, v9, v10) + 2938) )
    {
      if ( *v14 )
      {
        IoFreeWorkItem(*v14);
