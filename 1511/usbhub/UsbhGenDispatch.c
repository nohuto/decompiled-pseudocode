/*
 * XREFs of UsbhGenDispatch @ 0x1C0022300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhGenDispatch(ULONG_PTR a1, IRP *a2)
{
  ...
  if ( v3 == 1329877064 )
  {
    ...
    return (unsigned int)off_1C005AB48[2 * CurrentStackLocation->MajorFunction](a1, (ULONG_PTR)a2);
  }
  else
  {
    if ( v3 != 541218120 )
    ...
    if ( CurrentStackLocation->MajorFunction > 0x1Bu )
      UsbhTrapBadIrp(a1, (ULONG_PTR)a2);
    return ((unsigned int (__fastcall *)(ULONG_PTR, IRP *))off_1C005A988[2 * CurrentStackLocation->MajorFunction])(
             a1,
             a2);
  }
}
