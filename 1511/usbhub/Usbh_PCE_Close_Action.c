/*
 * XREFs of Usbh_PCE_Close_Action @ 0x1C0041D2C
 * Callers:
 ...
 *     UsbhHubDereferenceProcessChangeWorkItem @ 0x1C004090C (UsbhHubDereferenceProcessChangeWorkItem.c)
 *     UsbhPCE_Close @ 0x1C0040D84 (UsbhPCE_Close.c)
 */

void __fastcall Usbh_PCE_Close_Action(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v7; // rdx
  __int64 v8; // r8
  int v9; // eax
  ...
  v9 = UsbhLockPcqWithTag(a1, a2, 22, &v22, 0);
  _InterlockedIncrement((volatile signed __int32 *)(a3 + 140));
  v10 = v9;
  Log(a1, 512, 842166320, v9, *(unsigned __int16 *)(a2 + 4));
  if ( v12 == 1 || v12 == 6 || v12 == 15 )
  {
    Log(a1, 512, 842166321, v11, *(unsigned __int16 *)(a2 + 4));
  ...
  else
  {
    ...
    UsbhUnlockPcqWithTag(a1, a2, v22, 0);
    Log(a1, 512, 842166322, v10, *(unsigned __int16 *)(a2 + 4));
