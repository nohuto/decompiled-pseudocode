/*
 * XREFs of UsbhWaitEventWithTimeoutEx @ 0x1C00138F0
 * Callers:
                ...
                *(_DWORD *)(a6 + 2844) = a5;
                ...
                if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
                  WPP_RECORDER_SF_d(
                    ...
                    *(_WORD *)(a6 + 4));
                LODWORD(v50) = 0;
                UsbhDispatch_PortChangeQueueEventEx(a1, a6, 5, a6 + 24, (__int64)v50, 0, 0LL, 0LL);
...
LABEL_49:
  ...
  if ( v21 == 258 )
  {
    if ( v39 < v11 )
    {
      Log(a1, 8, 1465135393, SHIDWORD(v39), (unsigned int)v39);
