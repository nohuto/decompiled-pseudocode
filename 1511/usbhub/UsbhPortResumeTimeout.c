/*
 * XREFs of UsbhPortResumeTimeout @ 0x1C0044014
 * Callers:
...
__int64 __fastcall UsbhPortResumeTimeout(PDEVICE_OBJECT DeviceObject, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v8 = UsbhQueryPortState((__int64)DeviceObject, *(_WORD *)(a3 + 4), &v35, &v34);
  v9 = 0;
  Log((__int64)DeviceObject, 16, 1920233265, v8, 0LL);
  if ( Usb_Disconnected(v10) )
    return v11;
  LOBYTE(v32) = 0;
  UsbhException((int)DeviceObject, *(unsigned __int16 *)(a3 + 4), 124, 0, 0, v11, v34, usbfile_bus_c, 7325, v32);
  ...
  if ( v13 )
  {
    PortStatusBits = UsbhGetPortStatusBits(v15, v14, (__int16 *)&v35, (__int64)v13);
    ...
    else
    {
      ...
      if ( (v19 & 0xC0000000) == 0xC0000000 )
      {
        ...
        UsbhQueueSoftConnectChange((__int64)DeviceObject, v4, a2, 1);
        v27 = PdoExt((__int64)v13, v24, v25, v26);
        LOBYTE(v33) = 0;
        v27[353] &= ~0x4000u;
        UsbhException((int)DeviceObject, 0, 125, 0, 0, v23, 0, usbfile_bus_c, 7385, v33);
      }
      else
      {
