/*
 * XREFs of UsbhGetMsOsContainerID @ 0x1C0028B78
 * Callers:
...
__int64 __fastcall UsbhGetMsOsContainerID(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)v18 = 0LL;
  ...
  {
    LOBYTE(v16) = 0;
    UsbhException(a1, *((unsigned __int16 *)v6 + 710), 135, (int)v18, 24, 0, 0, usbfile_msos_c, 706, v16);
    return 3221225659LL;
  }
  ...
  if ( (v12 & 0xC0000000) != 0xC0000000 )
  {
    ...
    {
      LOBYTE(v16) = 0;
      UsbhException(a1, *((unsigned __int16 *)v6 + 710), 135, (int)v18, 24, 0, 0, usbfile_msos_c, 740, v16);
      return 3221225659LL;
    }
    ...
    {
      LOBYTE(v16) = 0;
      UsbhException(a1, *((unsigned __int16 *)v6 + 710), 135, (int)v18, 24, 0, 0, usbfile_msos_c, 749, v16);
      return 3221225659LL;
    }
    v15 = v19;
    *((_BYTE *)v6 + 2708) = 1;
  ...
  if ( v13 )
  {
    ...
    v6[356] |= 0x8000u;
    LOBYTE(v16) = 0;
    UsbhException(a1, *((unsigned __int16 *)v6 + 710), 135, (int)v18, 24, v12, 0, usbfile_msos_c, 733, v16);
  }
  return v12;
}
