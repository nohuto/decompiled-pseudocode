/*
 * XREFs of UsbhDispatch_PortChangeQueueEventEx @ 0x1C00170F0
 * Callers:
 ...
 *     UsbhDispatch_PortChangeQueueNullEventEx @ 0x1C0016A50 (UsbhDispatch_PortChangeQueueNullEventEx.c)
        ...
        int *a8)
{
  ...
  switch ( (_DWORD)v9 )
  {
    ...
    default:
      ...
      {
        case 1:
          Usbh_PCE_Enable_Action(a1, a2, a3, a4);
          break;
        case 2:
