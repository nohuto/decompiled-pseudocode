/*
 * XREFs of UsbhPdoPnp_QueryInterface @ 0x1C0011200
 * Callers:
 *     <none>
 * Callees:
...
LABEL_206:
  ...
  {
LABEL_204:
    Log(v33, 256, 1902522657, (_DWORD)a2, a1);
  ...
  if ( RtlCompareMemory(
         ...
         0x10uLL) == 16 )
  {
    Log(*(_QWORD *)(v6 + 1176), 256, 1902728019, (_DWORD)a2, a1);
...
LABEL_76:
        ...
        if ( !v65 )
        {
          ...
          Log(*(_QWORD *)(v6 + 1176), 256, 1902732882, (_DWORD)a2, v128);
...
LABEL_200:
  ...
  if ( v41 != 16 )
  {
    Log(v42, 256, 1902732852, (_DWORD)a2, a1);
    UsbhUnlatchPdo(*(_QWORD *)(v6 + 1176), v14, a2, 1364543814LL);
    SSHub = v135;
    a2->IoStatus.Status = v135;
    IofCompleteRequest(a2, 0);
  ...
  Log(v42, 256, 1902732853, (_DWORD)a2, a1);
