/*
 * XREFs of Usbh_HRS_Queued @ 0x1C0046F6C
 * Callers:
...
LABEL_27:
    ...
    v22 = *(_QWORD *)(a1 + 8);
    FdoExt(v22, v11, 3LL, v12);
    UsbhSyncBusPause(v22, a1, 6);
...
LABEL_12:
  ...
  v28 = UsbhHardReset_Action(*(struct _DEVICE_OBJECT **)(a1 + 8), a1, v26, v27);
  if ( *((_BYTE *)v6 + 5268) && _InterlockedExchange(v6 + 1315, 0) )
  {
    do
    {
      UsbhResetNotifyDownstreamHub(*(_QWORD *)(a1 + 8));
      v28 = UsbhHardReset_Action(*(struct _DEVICE_OBJECT **)(a1 + 8), a1, v29, v30);
  ...
  {
    UsbhResetNotifyDownstreamHub(*(_QWORD *)(a1 + 8));
    UsbhHardReset_Action(*(struct _DEVICE_OBJECT **)(a1 + 8), a1, v35, v36);
