/*
 * XREFs of UsbhValidateStringDescriptor @ 0x1C0027E94
 * Callers:
...
char __fastcall UsbhValidateStringDescriptor(__int64 a1, unsigned __int8 *a2, unsigned int a3, _DWORD *a4)
{
  ...
  if ( v4 > a3 )
  {
    ...
    v7 = 10;
LABEL_10:
    WPP_RECORDER_SF_(v6->DeviceExtension, 0, 1, v7, (__int64)&WPP_0af1e93f8161eccc1c336cf322e20086_Traceguids);
    return 0;
  }
  ...
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_d(
      ...
      1,
      13,
      (__int64)&WPP_0af1e93f8161eccc1c336cf322e20086_Traceguids,
      v4 % 2);
  return 0;
}
