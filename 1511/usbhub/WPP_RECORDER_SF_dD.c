/*
 * XREFs of WPP_RECORDER_SF_DD @ 0x1C0051DF8
 * Callers:
...
__int64 WPP_RECORDER_SF_DD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_ddb07952c6cd0379ee9386e940421eb8_Traceguids,
      12LL,
      (__int64 *)va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 12;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_ddb07952c6cd0379ee9386e940421eb8_Traceguids, v7, (__int64 *)va);
}
