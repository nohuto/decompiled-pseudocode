/*
 * XREFs of UsbhPCE_BusDisconnect @ 0x1C0040C00
 * Callers:
...
int *__fastcall UsbhPCE_BusDisconnect(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
