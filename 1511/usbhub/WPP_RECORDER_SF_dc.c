/*
 * XREFs of WPP_RECORDER_SF_dc @ 0x1C0042A70
 * Callers:
...
__int64 WPP_RECORDER_SF_dc(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids,
      a4,
      (__int64 *)va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, v8, (__int64 *)va);
}
