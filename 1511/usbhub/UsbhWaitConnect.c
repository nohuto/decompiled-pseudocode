/*
 * XREFs of UsbhWaitConnect @ 0x1C001A510
 * Callers:
...
__int64 __fastcall UsbhWaitConnect(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( a2 == 0x80000 )
  {
    ...
    {
      v46 = *(_QWORD *)(a4 + 376);
      UsbhAcquirePdoStateLock((__int64)v10, v46, 19);
    ...
    if ( a2 > 0x10 )
    {
      switch ( a2 )
      {
        case 0x20000u:
          ...
          v37 = (__int64 (__fastcall *)())qword_1C005B108[2 * v42];
          break;
        case 0x10000u:
          Log(a1, 4, 1129270900, v7, 0LL);
          v37 = off_1C005C6D8[2 * v45];
          break;
        case 0x40000u:
    ...
    else
    {
      ...
      if ( v39 )
      {
        ...
        if ( !v40 )
        {
          ...
          v37 = (__int64 (__fastcall *)())qword_1C005AF08[2 * v41];
          goto LABEL_46;
        }
        if ( v40 == 4 )
        {
