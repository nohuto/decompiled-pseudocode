/*
 * XREFs of Usbh_PCE_Resume_Action @ 0x1C0014370
 * Callers:
...
LONG __fastcall Usbh_PCE_Resume_Action(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  _DWORD *v6; // rdx
  int v7; // esi
  _QWORD *v8; // r15
  ...
  v7 = 0;
  v8 = (_QWORD *)UsbhIncHubBusy(a1, a3, a1, 1383162736LL, 0);
  ...
  *(_DWORD *)(v20 + 28) = 0;
  ...
  if ( (_DWORD)v22 == 1 )
  {
    ...
    if ( *(_DWORD *)v29 != 541218120 )
      UsbhTrapFatal_Dbg(a1, *(_QWORD *)(a1 + 64), v26, v16);
    ...
    *(_DWORD *)(v42 + a2 + 1384) = v41;
    ...
    v45 = *(struct _KEVENT **)(a1 + 64);
    if ( !v45 )
      UsbhTrapFatal_Dbg(a1, 0LL, v43, v44);
    if ( v45->Header.LockNV != 541218120 )
      UsbhTrapFatal_Dbg(a1, *(_QWORD *)(a1 + 64), v43, v44);
...
LABEL_39:
  ...
  if ( (_DWORD)v22 == 6 )
  {
    ...
    if ( *(_DWORD *)v56 != 541218120 )
      UsbhTrapFatal_Dbg(a1, *(_QWORD *)(a1 + 64), v53, v16);
    ...
    *(_DWORD *)(32 * (*(unsigned int *)(a2 + 2400) + 43LL) + a2 + 20) = 10;
    v60 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v56 + 4944));
    *(_BYTE *)(a2 + 2838) = 0;
    v61 = v60;
    *(_DWORD *)(a2 + 696) = 3;
    KeResetEvent((PRKEVENT)(a2 + 712));
    KeReleaseSpinLock((PKSPIN_LOCK)(v56 + 4944), v61);
    ...
    *(_DWORD *)(32 * (*(unsigned int *)(a2 + 2400) + 43LL) + a2 + 24) = 10;
    ...
    UsbhInsertQueuePortChangeObject(a1, *(unsigned __int16 *)(a2 + 4), (unsigned int)v99, 0, 0LL);
    ...
    *(_DWORD *)(v76 + a2 + 12) = 0x100000;
    ...
    if ( v45->Header.LockNV != 541218120 )
      UsbhTrapFatal_Dbg(a1, *(_QWORD *)(a1 + 64), v77, v78);
    v45[142].Header.Type = 1;
    KeWaitForSingleObject(&v45[139], Executive, 0, 0, 0LL);
...
LABEL_100:
  ...
  switch ( (int)v22 )
  {
    ...
    case 10:
      ...
      Log(a1, 512, 1597206580, v88, *(unsigned __int16 *)(a2 + 4));
      if ( *(_DWORD *)(a2 + 400) == 5 )
      {
        Timeouta = *(unsigned __int16 *)(a2 + 4);
        v99[0] = 0x100000;
        Log(a1, 512, 1597206610, v22, Timeouta);
        UsbhSetResumePending(a1, a2);
        UsbhInsertQueuePortChangeObject(a1, *(unsigned __int16 *)(a2 + 4), (unsigned int)v99, 0, 0LL);
      }
    ...
    case 18:
      v86 = 1597206584;
LABEL_74:
      Log(a1, 512, v86, v22, *(unsigned __int16 *)(a2 + 4));
...
LABEL_72:
      ...
      result = UsbhDecHubBusy(a1, v84, v8, v85);
      break;
    default:
      Log(a1, 512, 1597206616, v22, *(unsigned __int16 *)(a2 + 4));
      v92 = 32LL * *(unsigned int *)(a2 + 2400);
      *(_DWORD *)(a2 + 12) = 19;
      *(_DWORD *)(v92 + a2 + 1384) = 19;
      UsbhUnlockPcqWithTag(a1, a2, v12, 0LL);
      result = UsbhDecHubBusy(a1, v93, v8, v94);
      break;
  }
  return result;
}
