/*
 * XREFs of UsbhHubIsr @ 0x1C0021DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhHubIsr(PDEVICE_OBJECT DeviceObject, __int64 Irp, _QWORD *Context, __int64 a4)
{
  ...
  if ( (Status & 0xC0000000) != 0xC0000000 && *(int *)(v8 + 4) >= 0 && v10 != -1 )
  {
    *(_DWORD *)(v7 + 2656) = 0;
    ...
    v20[384] = 1;
    v22 = (__int64 *)(v20 + 386);
    v23 = (__int64 **)qword_1C0067668;
    *v22 = (__int64)&qword_1C0067660;
    v22[1] = (__int64)v23;
    if ( *v23 != &qword_1C0067660 )
      __fastfail(3u);
    *v23 = v22;
    qword_1C0067668 = (__int64)v22;
    v24 = FdoExt((__int64)Context, (__int64)&qword_1C0067660, v18, v19);
...
LABEL_40:
      ...
      else if ( *(_DWORD *)(v33 + 696) == 3 )
      {
        ...
        UsbhSignalResumeEvent((__int64)Context, v33);
      }
      else
      {
        KeReleaseSpinLock(v36, v37);
