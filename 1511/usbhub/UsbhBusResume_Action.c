/*
 * XREFs of UsbhBusResume_Action @ 0x1C0016350
 * Callers:
...
LONG __fastcall UsbhBusResume_Action(PDEVICE_OBJECT DeviceObject, int a2, __int64 a3, __int64 a4)
{
  ...
  for ( i = 1; ; ++i )
  {
    ...
    v10 = &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids;
    if ( !v9 )
      UsbhTrapFatal_Dbg(DeviceObject, 0LL, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, v7);
    if ( *(_DWORD *)v9 != 541218120 )
      UsbhTrapFatal_Dbg(DeviceObject, v9, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, v7);
    if ( i > v9[2938] )
      break;
    if ( *(_DWORD *)v9 != 541218120 )
      UsbhTrapFatal_Dbg(DeviceObject, v9, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, v7);
    ...
    if ( i )
    {
      ...
      if ( *(_DWORD *)v15 != 541218120 )
        UsbhTrapFatal_Dbg(DeviceObject, v15, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, v7);
      if ( i <= v15[2938] )
      {
        v16 = *((_QWORD *)v15 + 382);
        if ( v16 )
    ...
    if ( !v19 )
      UsbhTrapFatal_Dbg(DeviceObject, 0LL, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, v7);
    if ( *v19 != 541218120 )
      UsbhTrapFatal_Dbg(DeviceObject, v19, &WPP_7c8008b9a24e5d7244c8b992653290aa_Traceguids, v7);
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_d(
        WPP_GLOBAL_Control->DeviceExtension,
        0,
    ...
    if ( v28 )
    {
      v48 = PdoExt(v28, v39, v40, v7);
      KeWaitForSingleObject(v48 + 716, Executive, 0, 0, 0LL);
      v48[353] &= ~0x10000000u;
      KeSetEvent((PRKEVENT)(v48 + 716), 0, 0);
      UsbhUnlatchPdo(DeviceObject, v28, 0LL, 1382380368LL);
    }
  }
  UsbhPostInterrupt(DeviceObject);
  v44 = (_QWORD *)_InterlockedExchange64((volatile __int64 *)FdoExt((__int64)DeviceObject, v41, v42, v43) + 411, 0LL);
  Log((__int64)DeviceObject, 2048, 1114863917, 0LL, (__int64)v44);
  return UsbhDecHubBusy((__int64)DeviceObject, v45, v44, v46);
}
