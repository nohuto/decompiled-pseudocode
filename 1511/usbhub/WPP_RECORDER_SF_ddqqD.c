/*
 * XREFs of WPP_RECORDER_SF_ddqqD @ 0x1C0046654
 * Callers:
...
__int64 WPP_RECORDER_SF_ddqqD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_37c6835c01158ea489aacca15d43b0a5_Traceguids,
      23LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 23;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_37c6835c01158ea489aacca15d43b0a5_Traceguids, v7, (__int64 *)va);
}
