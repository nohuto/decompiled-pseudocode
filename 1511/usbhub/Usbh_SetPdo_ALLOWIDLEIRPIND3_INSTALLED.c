/*
 * XREFs of Usbh_SetPdo_ALLOWIDLEIRPIND3_INSTALLED @ 0x1C004C910
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_SetPdo_ALLOWIDLEIRPIND3_INSTALLED(__int64 a1, const wchar_t *a2, _DWORD *a3, __int64 a4)
{
  _UNKNOWN **result; // rax
  int v5; // ebx
