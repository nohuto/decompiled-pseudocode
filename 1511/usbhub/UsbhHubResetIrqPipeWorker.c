/*
 * XREFs of UsbhHubResetIrqPipeWorker @ 0x1C0043C60
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall UsbhHubResetIrqPipeWorker(PDEVICE_OBJECT DeviceObject, unsigned int a2, __int64 a3)
{
  ...
  v10 = (_QWORD *)UsbhIncHubBusy((__int64)DeviceObject, a3, (__int64)DeviceObject, 1380086643LL, 0);
  ...
  if ( (result & 0x1000) != 0 )
  {
    ...
    if ( (v12 & 0xC0000000) == 0xC0000000 )
    {
      ...
      else
      {
        ...
        {
          LOBYTE(v25) = 1;
          UsbhException((int)DeviceObject, 0, 7, 0, 0, v12, 0, usbfile_bus_c, 2745, v25);
        }
        v19 = WPP_GLOBAL_Control;
        if ( !LOWORD(WPP_GLOBAL_Control->DeviceType) )
          return UsbhDecHubBusy((__int64)DeviceObject, v17, v10, v18);
