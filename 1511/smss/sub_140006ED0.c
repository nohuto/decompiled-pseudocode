...
__int64 __fastcall sub_140006ED0(__int64 a1, void *a2, int a3, int a4)
{
  ...
  v6 = a4;
  v7 = 0;
  v8 = sub_140007340(&qword_140020110, &BaseAddress, &v32);
  if ( v8 >= 0 )
  {
...
LABEL_27:
      ...
      if ( !v19 )
        return 0;
      v25 = sub_140007340(&v33, &BaseAddress, &v32);
      v26 = v33;
      v8 = v25;
      v27 = v34;
      ...
      *v34 = v33;
      v26[1] = v27;
      v28 = qword_140020118;
      if ( *((PVOID **)qword_140020110 + 1) != &qword_140020110 || *(PVOID **)qword_140020118 != &qword_140020110 )
        __fastfail(3u);
      if ( *(_QWORD **)(*v26 + 8LL) != v26 || *(_QWORD **)v26[1] != v26 )
        __fastfail(3u);
      *(_QWORD *)qword_140020118 = v26;
      qword_140020118 = v26[1];
      *(_QWORD *)v26[1] = &qword_140020110;
      v26[1] = v28;
      if ( v8 < 0 )
    ...
    while ( 1 )
    {
      ...
      if ( (__int64 *)qword_140020120 != &qword_140020120 )
      {
        while ( RtlCompareUnicodeString((PCUNICODE_STRING)(v12 + 16), v13 + 1, 1u) )
        {
          v12 = *(_QWORD *)v12;
          if ( (__int64 *)v12 == &qword_140020120 )
            goto LABEL_52;
        }
        if ( v12 )
        {
...
LABEL_52:
      ...
      if ( (__int64 *)qword_140020120 != &qword_140020120 )
      {
        ...
        {
          v14 = *(_QWORD *)v14;
          if ( (__int64 *)v14 == &qword_140020120 )
            goto LABEL_57;
        }
        if ( v14 )
          goto LABEL_64;
...
LABEL_66:
        ...
        sub_140012B6C(Parameters, 5u, 3u);
        __debugbreak();
      }
      NtClose(Handle);
      goto LABEL_17;
