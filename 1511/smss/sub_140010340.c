/*
 * XREFs of sub_140010340 @ 0x140010340
 * Callers:
...
__int64 __fastcall sub_140010340(HANDLE FileHandle, struct _UNICODE_STRING *a2)
{
  NTSTATUS v4; // ebx
  ...
  if ( v4 >= 0 )
  {
    v4 = sub_140010A74(FileHandle, &v13);
    if ( v4 >= 0 )
    {
      v5 = v13;
      if ( !v13.QuadPart || v13.QuadPart % (unsigned __int64)(unsigned int)dword_140020188 )
      {
        v4 = -1073741672;
      }
      else
