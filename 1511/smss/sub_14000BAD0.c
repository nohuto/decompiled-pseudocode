/*
 * XREFs of sub_14000BAD0 @ 0x14000BAD0
 * Callers:
...
__int64 __fastcall sub_14000BAD0(__int64 a1, __int64 a2)
{
  int v4; // edi
  NTSTATUS v5; // ebx
  void *TokenHandle; // [rsp+30h] [rbp-78h] BYREF
  __int64 ThreadInformation; // [rsp+38h] [rbp-70h] BYREF
  ULONG ReturnLength; // [rsp+40h] [rbp-68h] BYREF
