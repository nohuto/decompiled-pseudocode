/*
 * XREFs of sub_14000F578 @ 0x14000F578
 * Callers:
...
__int64 sub_14000F578()
{
  ...
  *(_DWORD *)&ValueName.Length = 1572886;
  if ( NtQueryValueKey(
         ::KeyHandle,
         (PUNICODE_STRING)&stru_14001ABE8,
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (unsigned int)Data < v14 )
    return qword_140020490;
  v18 = 240;
  if ( (unsigned int)Data < 0xF0 )
    v18 = Data;
  if ( v18 )
    memcpy(Base, &unk_1400204D4, 4LL * v18);
  qsort(Base, v18, 4uLL, sub_140010000);
  v19 = (unsigned int)dword_140020188 * (unsigned __int64)(unsigned int)Base[9 * v18 / 0xA];
  return v19 + (v19 >> 4);
}
