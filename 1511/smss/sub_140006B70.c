...
PVOID __fastcall sub_140006B70(unsigned __int16 **a1, int a2, int a3, int a4, __int64 *a5, void **a6)
{
  int v6; // eax
  ...
  if ( *a1 != (unsigned __int16 *)a1 )
  {
    do
    {
      ...
      v13 = 2LL * v9;
      *(_QWORD *)(v10 + 8 * v13) = v11 - (_BYTE *)BaseAddress;
      *(_WORD *)(v10 + 8 * v13 + 8) = v12[8];
      memcpy(v11, *((const void **)v12 + 3), v12[8]);
      v14 = &v11[v12[8]];
      ++v9;
      *v14 = 0;
      v11 = v14 + 1;
      ...
      {
        v15 = 2LL * v9;
        *(_QWORD *)(v10 + 8 * v15) = v11 - (_BYTE *)BaseAddress;
        *(_WORD *)(v10 + 8 * v15 + 8) = v12[16];
        memcpy(v11, *((const void **)v12 + 5), v12[16]);
        v16 = &v11[v12[16]];
        *v16 = 0;
        v11 = v16 + 1;
        ++v9;
  ...
  v17 = 2LL * v6;
  *((_QWORD *)BaseAddress + v17 + 7) = v10 - (_QWORD)BaseAddress;
  *((_DWORD *)BaseAddress + 4 * v6 + 16) = v9;
  result = BaseAddress;
  *((_DWORD *)BaseAddress + 2 * v17 + 17) = a2;
  if ( v9 )
  {
