/*
 * XREFs of sub_140003408 @ 0x140003408
 * Callers:
...
PVOID sub_140003408()
{
  ...
  v0 = 0LL;
  SectionHandle = 0LL;
  Heap = RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), Flags + 0x80000, 0x80uLL);
  if ( !Heap )
    goto LABEL_11;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (unsigned int)sub_14000455C(Heap, SectionHandle) )
  {
    v0 = Heap;
    Heap = 0LL;
    v2 = 0LL;
