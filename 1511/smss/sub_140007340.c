/*
 * XREFs of sub_140007340 @ 0x140007340
 * Callers:
...
NTSTATUS __fastcall sub_140007340(_QWORD *a1, _QWORD *a2, unsigned int *a3)
{
  unsigned int v6; // ecx
  rsize_t v7; // r14
  PVOID Heap; // rax
  ...
  v7 = v6;
  Heap = RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), Flags, 16LL * v6);
  v9 = Heap;
  if ( !Heap )
    return -1073741670;
  v10 = (_QWORD *)*a1;
  ...
  qsort_s(v9, v7, 0x10uLL, PtFuncCompare, 0LL);
  result = 0;
  *a2 = v9;
  return result;
}
