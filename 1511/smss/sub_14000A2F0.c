/*
 * XREFs of sub_14000A2F0 @ 0x14000A2F0
 * Callers:
 *     sub_140009D20 @ 0x140009D20 (sub_140009D20.c)
 *     sub_14000A2C0 @ 0x14000A2C0 (sub_14000A2C0.c)
 * Callees:
 *     __security_check_cookie @ 0x14000BFC0 (__security_check_cookie.c)
 */

__int64 __fastcall sub_14000A2F0(char a1)
{
  char v1; // si
  NTSTATUS v3; // ebx
  ULONG v4; // ebx
  ...
  struct _SID_IDENTIFIER_AUTHORITY IdentifierAuthority; // [rsp+D0h] [rbp+37h] BYREF
  ...
  *(_WORD *)&v45.Value[4] = 4864;
  if ( a1 )
  {
    SecurityDescriptor = &unk_14001FD60;
    RtlCreateSecurityDescriptor(&unk_14001FD60, 1u);
    RtlSetDaclSecurityDescriptor(SecurityDescriptor, 1u, 0LL, 0);
    qword_14001FD88 = &unk_14001FDA0;
    RtlCreateSecurityDescriptor(&unk_14001FDA0, 1u);
    RtlSetDaclSecurityDescriptor(qword_14001FD88, 1u, 0LL, 0);
    qword_14001FDC8 = &unk_14001FDE0;
    RtlCreateSecurityDescriptor(&unk_14001FDE0, 1u);
    RtlSetDaclSecurityDescriptor(qword_14001FDC8, 1u, 0LL, 0);
    qword_14001FE08 = &unk_14001FE20;
    RtlCreateSecurityDescriptor(&unk_14001FE20, 1u);
    RtlSetDaclSecurityDescriptor(qword_14001FE08, 1u, 0LL, 0);
  }
  if ( (dword_14001F02C & 1) != 0 )
    v1 = 1;
  if ( !a1 && !v1 )
    return 0LL;
  v3 = 0;
...
LABEL_34:
  ...
  if ( v3 >= 0 )
  {
    if ( a1 )
    {
      ...
      Heap = (struct _ACL *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), Flags, v5);
      v7 = Heap;
      if ( Heap )
      {
        ...
        v3 = RtlSetDaclSecurityDescriptor(qword_14001FE08, 1u, v7, 0);
      }
      else
      {
        v3 = -1073741801;
      ...
      v12 = (struct _ACL *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), Flags, v11);
      if ( !v12 )
        v3 = -1073741801;
      v13 = RtlLengthSid(BaseAddress);
      v14 = v13 + RtlLengthSid(v37) + 32;
      v15 = (struct _ACL *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), Flags, v14);
      if ( v15 )
      {
        if ( v3 >= 0 )
        {
          ...
          RtlSetDaclSecurityDescriptor(qword_14001FDC8, 1u, v12, 0);
          v3 = RtlSetSaclSecurityDescriptor(qword_14001FDC8, 1u, v15, 0);
        }
      }
      else
      {
    ...
    if ( (dword_14001F02C & 1) != 0 )
    {
      ...
      v20 = (struct _ACL *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), Flags, v19);
      v21 = v20;
      if ( v20 )
      {
        if ( v3 >= 0 )
      ...
      v27 = (struct _ACL *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), Flags, v26);
      if ( !v27 )
        v3 = -1073741801;
      v28 = RtlLengthSid(v37) + 20;
      v29 = (struct _ACL *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), Flags, v28);
      if ( v29 )
      {
        if ( v3 >= 0 )
        {
          ...
          *((_BYTE *)Ace + 1) = 11;
          ...
          RtlSetDaclSecurityDescriptor(qword_14001FD88, 1u, v27, 0);
          v3 = RtlSetSaclSecurityDescriptor(qword_14001FD88, 1u, v29, 0);
        }
      }
      else
      {
