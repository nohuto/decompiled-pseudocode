/*
 * XREFs of sub_140009134 @ 0x140009134
 * Callers:
...
__int64 __fastcall sub_140009134(void *a1, __int64 a2, _QWORD *a3)
{
  NTSTATUS v5; // r8d
  __int64 v7; // rcx
  ...
  if ( v5 < 0 )
  {
    v7 = 2LL * (_InterlockedIncrement(&dword_140020420) % 32);
    *((_DWORD *)&unk_140020220 + 2 * v7) = 3844;
    *((_DWORD *)&unk_140020220 + 2 * v7 + 1) = v5;
    *((_QWORD *)&unk_140020220 + v7 + 1) = a2;
