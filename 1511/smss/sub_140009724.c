/*
 * XREFs of sub_140009724 @ 0x140009724
 * Callers:
...
__int64 __fastcall sub_140009724(PCUNICODE_STRING String, PULONG Value, PULONG a3)
{
  PWSTR Buffer; // r10
  USHORT Length; // r9
  ...
  *a3 = 0;
  ...
  if ( v9 < 0 )
  {
    ...
    v17 = 2LL * v16;
    *((_DWORD *)&unk_140020220 + 4 * v16) = 4664;
  }
  else
  {
    v10 = String->Buffer;
    ...
    if ( v13 >= 0 )
      return 0LL;
    v18 = _InterlockedIncrement(&dword_140020420) % 32;
    v17 = 2LL * v18;
    *((_DWORD *)&unk_140020220 + 4 * v18) = 4686;
  }
  *((_DWORD *)&unk_140020220 + 2 * v17 + 1) = v9;
  *((_QWORD *)&unk_140020220 + v17 + 1) = 0LL;
