/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C007D178
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C001C650 (VidMmCreateCompanionContext.c)
 * Callees:
