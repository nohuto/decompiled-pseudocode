/*
 * XREFs of VidSchiCompleteRewindPacket @ 0x1C000E330
 * Callers:
      ...
      do
      {
        ...
        if ( (v14 & 0x10) != 0 )
        {
          *(_DWORD *)(v11 + 76) = v14 & 0xFFFFFFEF;
          v9 = *(unsigned int *)(v2 + 2952);
          if ( (_DWORD)v9 != -1 )
          {
            v18 = *(void (__fastcall **)(_QWORD))(v6 + 2488);
            if ( v18 )
              v18(*(_QWORD *)(v6 + 2520));
          }
        }
        ...
        if ( v4 )
        {
          ...
          {
            _InterlockedIncrement((volatile signed __int32 *)(v2 + 2704));
            *(_QWORD *)(v6 + 360) |= 1LL << *(_WORD *)(v2 + 4);
          }
        }
        v10 = *(_QWORD *)(v11 + 32);
        v11 = v10 - 32;
    ...
    *(_QWORD *)(a1 + 656) = 0LL;
    if ( (v16 & 0x200) != 0 )
    {
      if ( (((unsigned __int8)(*(_DWORD *)(a1 + 176) >> 9) | *(_BYTE *)(a1 + 176)) & 2) == 0 )
        VidSchiUpdateContextStatus(a1, (_QWORD *)0xA, (__int64 *)0x2DC0);
    }
    ...
    {
      return (unsigned int)VidSchiUpdateContextStatus(a1, (_QWORD *)5, (__int64 *)0x2DCD);
    }
  }
  return v3;
}
