/*
 * XREFs of ?MapCpuVA@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_MONITORED_FENCE_STORAGE@@PEAPEAX@Z @ 0x1C0052520
 * Callers:
 *     ?VidMmMapCpuVA@@YAJPEAVVIDMM_GLOBAL@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@PEAPEAX@Z @ 0x1C00143C0 (-VidMmMapCpuVA@@YAJPEAVVIDMM_GLOBAL@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::MapCpuVA(VIDMM_GLOBAL *this, VIDMM_FENCE_STORAGE_PAGE **a2, void **a3)
{
  ...
  return VIDMM_FENCE_STORAGE_PAGE::MapCpuVA(
           *a2,
           ...
           (*((_BYTE *)this + 40608) & 2) != 0,
           (*((_BYTE *)this + 40608) & 4) != 0,
           (unsigned __int64)a3);
}
