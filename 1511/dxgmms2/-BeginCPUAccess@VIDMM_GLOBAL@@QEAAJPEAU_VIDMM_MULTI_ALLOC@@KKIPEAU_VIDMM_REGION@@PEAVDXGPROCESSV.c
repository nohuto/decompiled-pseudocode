/*
 * XREFs of ?BeginCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKIPEAU_VIDMM_REGION@@PEAVDXGPROCESSVIDMMLOCK@@PEAPEAX@Z @ 0x1C004FE00
 * Callers:
 *     ?VidMmBeginCPUAccess@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@KKIPEAU_VIDMM_REGION@@PEAVDXGPROCESSVIDMMLOCK@@PEAPEAX@Z @ 0x1C0013E20 (-VidMmBeginCPUAccess@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@KKIPEAU_VIDMM_REGION@@PEAVDXG.c)
 * Callees:
 ...
 *     ?IsCurrentProcess@VIDMM_PROCESS@@QEAAEXZ @ 0x1C0011C90 (-IsCurrentProcess@VIDMM_PROCESS@@QEAAEXZ.c)
...
LABEL_4:
  ...
  *a8 = 0LL;
  ...
  if ( (*(_DWORD *)(v19 + 76) & 0x80u) != 0 )
    goto LABEL_46;
  DXGFASTMUTEX::Acquire(*(union _LARGE_INTEGER **)(v19 + 312));
  if ( (*(_DWORD *)(v19 + 76) & 0x100000) != 0 )
  {
  ...
  {
    if ( (VIDMM_GLOBAL::_Config & 0x40) != 0 || *((_BYTE *)this + 6464) )
    {
      v11 = -1073741823;
      goto LABEL_58;
    }
    ...
    if ( !v42 )
      goto LABEL_58;
    if ( (*(_DWORD *)(v42 + 56) & 0x1001) != 0 )
      goto LABEL_58;
    v11 = VIDMM_GLOBAL::SetupAllocationForCPUAccess((VIDMM_GLOBAL *)this, a2, v39, v40, v48);
    if ( v11 >= 0 )
      goto LABEL_58;
...
LABEL_58:
  DXGFASTMUTEX::Release(*(DXGFASTMUTEX **)(v19 + 312), v37, v39, v40);
  if ( v11 < 0 )
  {
