/*
 * XREFs of Template_pqtt @ 0x1C001D3B4
 * Callers:
...
NTSTATUS Template_pqtt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v9, va3);
  v10 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventResetBackingStore, 0LL, 4u, &UserData);
}
