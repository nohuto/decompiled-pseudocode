/*
 * XREFs of ?BuildMdlFromRange@VIDMM_CPU_HOST_APERTURE@@QEBAPEAU_MDL@@PEAXPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@_K2@Z @ 0x1C0013B5C
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( Mdl )
  {
    ...
    if ( v8 == 4096 )
    {
      v20 = *(unsigned int *)a3;
      v21 = *((_QWORD *)this + 4);
      if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 6) + 8LL) + 24LL) + 284LL) & 8) != 0 )
      {
