/*
 * XREFs of ?GetPinnedAllocationInfo@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAIPEAT_LARGE_INTEGER@@@Z @ 0x1C004FD38
 * Callers:
 *     VidMmGetPinnedAllocationInfo @ 0x1C0011920 (VidMmGetPinnedAllocationInfo.c)
 * Callees:
 *     <none>
 */
