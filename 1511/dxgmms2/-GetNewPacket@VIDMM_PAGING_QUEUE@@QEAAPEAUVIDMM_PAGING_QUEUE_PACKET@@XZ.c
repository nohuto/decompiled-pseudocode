/*
 * XREFs of ?GetNewPacket@VIDMM_PAGING_QUEUE@@QEAAPEAUVIDMM_PAGING_QUEUE_PACKET@@XZ @ 0x1C003AFF4
 * Callers:
...
struct VIDMM_PAGING_QUEUE_PACKET *__fastcall VIDMM_PAGING_QUEUE::GetNewPacket(VIDMM_PAGING_QUEUE *this)
{
  ...
  *(_QWORD *)(v7 + 112) = 0LL;
  ...
  if ( v5 != v3
    || (result = (struct VIDMM_PAGING_QUEUE_PACKET *)operator new(0x98uLL, 0x38346956u, PagedPool), (v5 = result) != 0LL) )
  {
    memset(v5, 0, 0x98uLL);
    result = v5;
    *((_QWORD *)v5 + 5) = v4;
