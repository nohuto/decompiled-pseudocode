/*
 * XREFs of ?Init@VIDMM_MEMORY_SEGMENT@@UEAAJPEAVVIDMM_GLOBAL@@P6AXPEAX@ZKKPEAUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@PEAT_LARGE_INTEGER@@@Z @ 0x1C006A320
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0VIDMM_CPU_HOST_APERTURE@@QEAA@XZ @ 0x1C00150F4 (--0VIDMM_CPU_HOST_APERTURE@@QEAA@XZ.c)
        ...
        struct DXGK_SEGMENTDESCRIPTOR_INTERNAL *a6)
{
  ...
  *((_QWORD *)this + 55) = v15;
  if ( !v15 )
  {
    _InterlockedIncrement(&dword_1C002F5F0);
