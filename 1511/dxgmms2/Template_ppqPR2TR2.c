/*
 * XREFs of Template_ppqPR2TR2 @ 0x1C001D0EC
 * Callers:
...
NTSTATUS Template_ppqPR2TR2(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v11 = 0;
  v14 = 0;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventReferenceAllocations, 0LL, 5u, &UserData);
}
