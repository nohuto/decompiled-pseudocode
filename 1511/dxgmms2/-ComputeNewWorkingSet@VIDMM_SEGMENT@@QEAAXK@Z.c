/*
 * XREFs of ?ComputeNewWorkingSet@VIDMM_SEGMENT@@QEAAXK@Z @ 0x1C00563F8
 * Callers:
...
void __fastcall VIDMM_SEGMENT::ComputeNewWorkingSet(VIDMM_SEGMENT *this, unsigned int a2)
{
  ...
  if ( a2 )
  {
    ...
    *((_QWORD *)this + 12) = v2 * (unsigned __int64)(unsigned int)dword_1C002F238 / 0x64 / a2;
    *((_QWORD *)this + 13) = v2 * (unsigned __int64)(unsigned int)dword_1C002F23C / 0x64 / a2;
  }
}
