/*
 * XREFs of ?ValidateSegmentForAcquisitionOfResource@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@IW4_VIDMM_PLACEMENT_RESTRICTION@@E@Z @ 0x1C0049964
 * Callers:
 ...
 * Callees:
 *     ?IsSoftGPU@DXGADAPTER@@QEBAEXZ @ 0x1C0011820 (-IsSoftGPU@DXGADAPTER@@QEBAEXZ.c)
 */
        ...
        char a5)
{
  ...
  if ( !_bittest(
          &v11,
          (unsigned __int8)(v5 - *(_BYTE *)(456LL * (*(_DWORD *)(a2 + 76) & 0x3F) + *(_QWORD *)(v6 + 40048) + 4))) )
