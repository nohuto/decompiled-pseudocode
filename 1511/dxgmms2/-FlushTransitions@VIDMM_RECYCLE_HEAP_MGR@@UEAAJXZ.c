/*
 * XREFs of ?FlushTransitions@VIDMM_RECYCLE_HEAP_MGR@@UEAAJXZ @ 0x1C005A2D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VIDMM_RECYCLE_HEAP_MGR::FlushTransitions(
        ...
        __int64 a4)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v12, (VIDMM_RECYCLE_HEAP_MGR *)((char *)this + 416), a3, a4);
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v12, v5, v6, v7);
