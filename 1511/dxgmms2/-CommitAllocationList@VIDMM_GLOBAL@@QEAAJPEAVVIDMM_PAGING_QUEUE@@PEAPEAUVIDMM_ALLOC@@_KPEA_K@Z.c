/*
 * XREFs of ?CommitAllocationList@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PAGING_QUEUE@@PEAPEAUVIDMM_ALLOC@@_KPEA_K@Z @ 0x1C0043A78
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  for ( i = a3; i != v6; ++i )
  {
      ...
      || VIDMM_GLOBAL::IsPagingOperationPending(this, **(struct _VIDMM_GLOBAL_ALLOC ***)v10, 1) )
    {
      ...
      LODWORD(v15[0]) = 206;
      v15[2] = v10;
      v5 = VIDMM_GLOBAL::QueueDeferredCommand(this, a2, (struct _VIDMM_DEFERRED_COMMAND *)v15, dword_1C002F310 == 0, a5);
    }
