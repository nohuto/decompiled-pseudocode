/*
 * XREFs of ?VidMmiQuerySegmentInfo4@@YAJPEAVDXGADAPTER@@IPEAU_DXGK_QUERYSEGMENTOUT4@@@Z @ 0x1C0063B64
 * Callers:
...
__int64 __fastcall VidMmiQuerySegmentInfo4(struct DXGADAPTER *this, int a2, struct _DXGK_QUERYSEGMENTOUT4 *a3)
{
  ...
  *(_QWORD *)&v28[8] = 0LL;
  ...
  if ( v5 < 0 )
  {
    v24 = WdLogNewEntry5_WdWarning(v7);
    *(_QWORD *)(v24 + 24) = v10;
  ...
  _InterlockedIncrement(&dword_1C002F524);
