/*
 * XREFs of ?UnpinOneAllocation@VIDMM_GLOBAL@@QEAA_NPEAUVIDMM_ALLOC@@W4VIDMM_UNPIN_ACTION@@_N@Z @ 0x1C004C664
 * Callers:
 ...
 *     ?UnpinAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00612F4 (-UnpinAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@@Z.c)
...
bool __fastcall VIDMM_GLOBAL::UnpinOneAllocation(VIDMM_GLOBAL *a1, struct VIDMM_ALLOC *a2, __int64 a3, char a4)
{
  ...
  {
    v7 = WdLogNewEntry5_WdWarning(a1);
        ...
        else
        {
          ...
          VIDMM_GLOBAL::QueueDeferredCommand(
            ...
            (struct VIDMM_PAGING_QUEUE *)(*(_QWORD *)(*((_QWORD *)a2 + 1) + 64LL)
                                        + 160LL * (*(_DWORD *)(*(_QWORD *)v14 + 76LL) & 0x3F)),
