/*
 * XREFs of ?MapPagesIntoAperture@VIDMM_APERTURE_SEGMENT@@UEAAJKPEAU_MDL@@HPEAPEAXPEA_K@Z @ 0x1C0083510
 * Callers:
 *     <none>
 * Callees:
        ...
        union _LARGE_INTEGER *a6)
{
  ...
  if ( v7 > 0xFFFFFFFF )
    return 3221225621LL;
  v10 = VIDMM_LINEAR_POOL::Allocate(this[18], (unsigned int)v7, 0, 1, 0LL, 0LL, 0, 0, 0LL, &v11, a5);
  if ( v10 >= 0 )
  {
    *a6 = v11;
    (*((void (__fastcall **)(VIDMM_LINEAR_POOL **, _QWORD, __int64))*this + 25))(this, 0LL, v8);
  }
