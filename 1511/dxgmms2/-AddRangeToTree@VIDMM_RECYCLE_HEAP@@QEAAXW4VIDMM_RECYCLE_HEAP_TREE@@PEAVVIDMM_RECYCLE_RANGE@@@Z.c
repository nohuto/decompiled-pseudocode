/*
 * XREFs of ?AddRangeToTree@VIDMM_RECYCLE_HEAP@@QEAAXW4VIDMM_RECYCLE_HEAP_TREE@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C0081D50
 * Callers:
...
__int64 __fastcall VIDMM_RECYCLE_HEAP::AddRangeToTree(_QWORD *a1, int a2, __int64 a3)
{
  ...
  ULONG_PTR v19[5]; // [rsp+20h] [rbp-28h] BYREF
  ...
  *(_QWORD *)(v6 + 32) = v4;
  ...
  switch ( (_DWORD)v4 )
  {
    case 0:
      v14 = a1 + 5;
      v15 = (struct _RTL_BALANCED_NODE *)a1[5];
      if ( v15 )
      {
        while ( 1 )
        {
