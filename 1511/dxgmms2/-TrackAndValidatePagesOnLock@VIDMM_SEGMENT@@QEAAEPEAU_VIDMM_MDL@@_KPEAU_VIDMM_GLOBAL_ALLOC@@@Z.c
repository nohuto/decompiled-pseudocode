/*
 * XREFs of ?TrackAndValidatePagesOnLock@VIDMM_SEGMENT@@QEAAEPEAU_VIDMM_MDL@@_KPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0056380
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a4)
{
  ...
  v12 = WdLogNewEntry5_WdAssertion(this, v9, v5, a4);
  *(_QWORD *)(v12 + 24) = v6;
