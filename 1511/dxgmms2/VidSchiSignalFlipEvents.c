/*
 * XREFs of VidSchiSignalFlipEvents @ 0x1C000FED8
 * Callers:
...
void __fastcall VidSchiSignalFlipEvents(__int64 a1, int a2)
{
  ...
  if ( v2 )
  {
    ...
    VidSchiSignalRegisteredEvent(v5, (struct _KEVENT **)(v5 + 1784));
    VidSchiSignalRegisteredEvent(v5, (struct _KEVENT **)(v5 + 1768));
    *(_QWORD *)(v5 + 1616) = MEMORY[0xFFFFF78000000320];
    KeSetEvent((PRKEVENT)(v5 + 1584), 0, 0);
    *(_QWORD *)(v5 + 1728) = MEMORY[0xFFFFF78000000320];
    KeSetEvent((PRKEVENT)(v5 + 1696), 0, 0);
    if ( a2 )
    {
