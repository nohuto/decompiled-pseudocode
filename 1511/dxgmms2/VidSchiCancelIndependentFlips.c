/*
 * XREFs of VidSchiCancelIndependentFlips @ 0x1C0001B68
 * Callers:
...
__int64 __fastcall VidSchiCancelIndependentFlips(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 result; // rax
  __int64 v7; // rsi
  ...
  if ( v8 )
  {
    ...
    if ( (_DWORD)result )
    {
      v10 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 40LL) + 24LL)
                      ...
                      + 8 * v4
                      + 520);
      _InterlockedExchangeAdd((volatile signed __int32 *)(*(_QWORD *)(a1 + 8 * v4 + 5128) + 8LL), -(int)result);
      result = *(_QWORD *)(a1 + 8 * v4 + 5128);
      *(_DWORD *)(result + 4) += v9;
      *(_DWORD *)(v10 + 4) += v9;
    }
  }
