/*
 * XREFs of ?RemoveDmaBufferFromPool@VIDMM_DMA_POOL@@IEAAXPEAU_VIDMM_DMA_BUFFER@@@Z @ 0x1C006025C
 * Callers:
...
void __fastcall VIDMM_DMA_POOL::RemoveDmaBufferFromPool(VIDMM_DMA_POOL *this, struct _VIDMM_DMA_BUFFER *a2)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x80u) != 0 )
    Template_pppxxxp(
      ...
      *((unsigned int *)a2 + 13),
      *((_QWORD *)a2 + 7));
  if ( *((_BYTE *)a2 + 24) && (v13 = 0, VIDMM_DMA_POOL::WaitDmaBufferNotBusy(this, a2, 1, &v13), v13) )
  {
