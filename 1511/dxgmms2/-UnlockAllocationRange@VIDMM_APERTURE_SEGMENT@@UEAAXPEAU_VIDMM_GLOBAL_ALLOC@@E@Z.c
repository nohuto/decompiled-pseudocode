/*
 * XREFs of ?UnlockAllocationRange@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C0083A30
 * Callers:
 *     <none>
 * Callees:
        ...
        char a3)
{
  ...
  if ( *((_BYTE *)a2 + 280) )
  {
    ...
    if ( v7 )
    {
      ...
      VidMmUnmapViewOfAllocation((struct _VIDMM_LOCAL_ALLOC **)a2, v8[0], 0LL);
    }
    else
    {
