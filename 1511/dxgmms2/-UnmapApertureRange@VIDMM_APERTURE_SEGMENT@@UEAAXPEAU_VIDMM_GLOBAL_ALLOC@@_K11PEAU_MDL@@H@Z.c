/*
 * XREFs of ?UnmapApertureRange@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@_K11PEAU_MDL@@H@Z @ 0x1C0083BD0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a7)
{
  ...
  v12 = *(unsigned int *)(*((_QWORD *)v11 + 3) + 284LL);
  if ( (v12 & 4) == 0 )
  {
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
    Template_ppxt(v12, &EventApertureUnmapping, a3, a4, (char)a2, 0, a7);
  *(_QWORD *)(*((_QWORD *)this + 1) + 7520LL) += a3 << 12;
  *(_QWORD *)(*((_QWORD *)this + 1) + 40024LL) -= a3;
}
