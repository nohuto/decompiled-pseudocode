/*
 * XREFs of ?RecordPagingOperation@VIDMM_GLOBAL@@QEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_DXGKARG_BUILDPAGINGBUFFER@@J_KHPEAX@Z @ 0x1C00426EC
 * Callers:
        ...
        if ( (_DWORD)v27 )
        {
          ...
          if ( v28 )
          {
            ...
            if ( (_DWORD)v29 )
            {
              ...
              if ( (_DWORD)v30 )
              {
                if ( (_DWORD)v30 == 2 && (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
                  Template_pptpqxq(
                    v30,
                    a2,
                    v17,
      ...
      if ( (_DWORD)v21 )
      {
        ...
        if ( (_DWORD)v22 )
        {
          ...
          if ( (_DWORD)v22 )
          {
            ...
            if ( (_DWORD)v23 )
            {
              if ( (_DWORD)v23 == 1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
                Template_pptpqxxt(
                  v23,
                  a2,
                  v17,
          ...
          if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) == 0 )
            goto LABEL_2;
          v24 = (const EVENT_DESCRIPTOR *)&EventPagingOpWritePhysical;
        }
        else
        {
          if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) == 0 )
            goto LABEL_2;
          v24 = (const EVENT_DESCRIPTOR *)&EventPagingOpReadPhysical;
        }
...
LABEL_2:
  ...
  if ( v13 )
  {
    v14 = 360LL * *((unsigned int *)this + 1946);
    if ( a3 )
    {
      *(_QWORD *)(v14 + v13 + 8) = a3;
    ...
    *(_DWORD *)(360LL * *((unsigned int *)this + 1946) + *((_QWORD *)this + 972)) = v10;
    v15 = (_OWORD *)(360LL * *((unsigned int *)this + 1946) + *((_QWORD *)this + 972) + 24LL);
    do
    {
