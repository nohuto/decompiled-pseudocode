/*
 * XREFs of VidSchiRundownMonitoredFenceCpuWaiters @ 0x1C000FDC8
 * Callers:
 *     VidSchDestroyDeviceSyncObject @ 0x1C000FE40 (VidSchDestroyDeviceSyncObject.c)
 * Callees:
 *     <none>
 */
