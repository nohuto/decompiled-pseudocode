/*
 * XREFs of ?SuspendCpuAccess@VIDMM_SEGMENT@@QEAAJXZ @ 0x1C0085344
 * Callers:
    ...
    while ( v13 != (VIDMM_SEGMENT *)((char *)this + 152) )
    {
      ...
      if ( v15 && (*(_BYTE *)(v15 + 32) & 1) != 0 )
      {
        ...
        *(_BYTE *)(*((_QWORD *)v14 + 12) + 32LL) &= ~1u;
        ...
        DXGFASTMUTEX::Release(*((DXGFASTMUTEX **)v14 + 39), v22, v23, v24);
      }
    }
    if ( (int)v5 >= 0 )
    {
      ...
      while ( v25 != (VIDMM_SEGMENT *)((char *)this + 168) )
      {
        ...
        if ( *((_DWORD *)v26 + 84) )
        {
          LOBYTE(a3) = 1;
          LOBYTE(v38) = 0;
          (*(void (__fastcall **)(_QWORD, char *, __int64, _QWORD, int, _QWORD))(**((_QWORD **)v26 + 16) + 48LL))(
            *((_QWORD *)v26 + 16),
            v26,
            a3,
            0LL,
        ...
        else
        {
          ...
          {
            DXGFASTMUTEX::Acquire(*((union _LARGE_INTEGER **)v26 + 39));
            KeStackAttachProcess(**(PRKPROCESS **)(*((_QWORD *)v26 + 12) + 8LL), &v40);
            v28 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, _QWORD, _QWORD, _QWORD, _QWORD, int, char *))(**(_QWORD **)(*(_QWORD *)(*((_QWORD *)v26 + 12) + 8LL) + 24LL) + 48LL))(
                    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v26 + 12) + 8LL) + 24LL),
                    *((_QWORD *)this + 1),
                    *(_QWORD *)(*((_QWORD *)v26 + 12) + 24LL),
                    3LL,
                    0LL,
                    0LL,
                    0LL,
            ...
            *(_BYTE *)(*((_QWORD *)v26 + 12) + 32LL) &= ~1u;
            KeUnstackDetachProcess(&v40);
            DXGFASTMUTEX::Release(*((DXGFASTMUTEX **)v26 + 39), v34, v35, v36);
          }
        }
      }
    }
