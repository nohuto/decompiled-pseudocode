/*
 * XREFs of ?CanBePromoted@VIDMM_PROCESS_BUDGET_STATE@@QEAA_NXZ @ 0x1C007F3D4
 * Callers:
...
bool __fastcall VIDMM_PROCESS_BUDGET_STATE::CanBePromoted(VIDMM_PROCESS_BUDGET_STATE *this)
{
  ...
  if ( *((_QWORD *)this + 29) || *((_QWORD *)this + 28) )
    return 1;
  if ( *((_QWORD *)this + 25) || *((_QWORD *)this + 26) || *((_QWORD *)this + 27) )
    return *((_QWORD *)this + 22) < *((_QWORD *)this + 3);
  return result;
}
