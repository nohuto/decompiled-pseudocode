/*
 * XREFs of ?TrimAllocation@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@U_VIDMM_TRIM_PROCESS_FLAGS@@_K2@Z @ 0x1C00856A4
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  v12 = 0LL;
  v13 = 0LL;
  VIDMM_GLOBAL::MarkGlobalAllocation(a1[1], (union _LARGE_INTEGER **)a2, &v12, &v13);
  v8 = *(_QWORD *)(a2 + 128);
  *(_DWORD *)(a2 + 80) |= 0x40u;
