/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C007B194
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C001C6D0 (VidMmIsAllocationTerminated.c)
 * Callees:
