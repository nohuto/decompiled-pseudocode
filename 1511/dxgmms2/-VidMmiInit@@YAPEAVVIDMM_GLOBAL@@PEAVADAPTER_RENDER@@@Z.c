/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@@Z @ 0x1C00647D4
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C0014F60 (VidMmInitializeAdapter.c)
 * Callees:
...
struct VIDMM_GLOBAL *__fastcall VidMmiInit(struct ADAPTER_RENDER *a1)
{
  ...
  if ( ZwQuerySystemInformation(SystemBasicInformation, v33, 0x40u, 0LL) < 0
    || *(_QWORD *)(v1 + 1320) < (unsigned __int64)v33[5] << 12 )
  {
...
LABEL_10:
  v18 = (VIDMM_GLOBAL *)operator new(0xA188uLL, 0x35316956u, v12, (POOL_TYPE)512);
  if ( v18 )
...
LABEL_18:
  ...
  if ( v23 < 0 )
  {
    _InterlockedIncrement(&dword_1C002F52C);
