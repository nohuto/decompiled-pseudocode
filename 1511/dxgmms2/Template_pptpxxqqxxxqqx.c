/*
 * XREFs of Template_pptpxxqqxxxqqx @ 0x1C0016480
 * Callers:
...
NTSTATUS Template_pptpxxqqxxxqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v28 = 4LL;
  v30 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpVirtualTransfer, 0LL, 0xEu, &UserData);
}
