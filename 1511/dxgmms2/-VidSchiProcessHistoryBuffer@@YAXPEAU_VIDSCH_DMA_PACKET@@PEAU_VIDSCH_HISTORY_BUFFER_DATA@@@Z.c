/*
 * XREFs of ?VidSchiProcessHistoryBuffer@@YAXPEAU_VIDSCH_DMA_PACKET@@PEAU_VIDSCH_HISTORY_BUFFER_DATA@@@Z @ 0x1C001F14C
 * Callers:
...
void __fastcall VidSchiProcessHistoryBuffer(struct _VIDSCH_DMA_PACKET *a1, struct _VIDSCH_HISTORY_BUFFER_DATA *a2)
{
  ...
  v2 = a1;
  if ( (qword_1C002F070 & 0x188ED7) != 0
    && (qword_1C002F078 & 0xFFFFFFFFFFE77128uLL) == 0
    && (qword_1C002F070 & 0x4000) != 0 )
  {
    v3 = *(_QWORD *)a2;
    ...
    {
      v19 = (_QWORD *)WdLogNewEntry5_WdAssertion(v5, a2, qword_1C002F070, v2);
      v19[3] = v8;
LABEL_38:
    ...
    v10 = *(_QWORD *)(v7 + 8);
    v11 = *(_QWORD *)(v7 + 8LL * *(unsigned __int16 *)(v5 + 4) + 376);
    v12 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 16) + 1904LL)
    ...
    KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v10 + 896), &LockHandle);
    v20 = *(_QWORD *)(*(_QWORD *)(v7 + 8) + 888LL);
    if ( v20 )
    {
      v41 = 0;
      while ( 1 )
