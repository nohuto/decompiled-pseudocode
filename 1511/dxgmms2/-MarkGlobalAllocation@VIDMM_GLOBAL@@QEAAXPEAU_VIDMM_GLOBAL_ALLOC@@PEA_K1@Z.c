/*
 * XREFs of ?MarkGlobalAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEA_K1@Z @ 0x1C0042F20
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  v11 = (struct _VIDMM_GLOBAL_ALLOC *)a2[36];
  ...
  DXGFASTMUTEX::Release((DXGFASTMUTEX *)a2[39], (__int64)v8, v9, v10);
}
