/*
 * XREFs of VidSchCreateSystemDevices @ 0x1C0069E2C
 * Callers:
...
__int64 __fastcall VidSchCreateSystemDevices(__int64 a1)
{
  ...
  v18 = 1LL;
  v19[0] = 0LL;
  v5 = VidSchiCreateDeviceInternal(a1, &v18, 0LL, (__int64 *)(a1 + 184));
  if ( v5 < 0
    || (v18 = 17LL, v19[0] = 0LL, v5 = VidSchiCreateDeviceInternal(a1, &v18, 0LL, (__int64 *)(a1 + 192)), v5 < 0) )
  {
    ...
    if ( *(_DWORD *)(a1 + 56) )
    {
      while ( 1 )
      {
        ...
        *(_QWORD *)((char *)v19 + 4) = 7LL;
        ...
        LODWORD(v19[0]) = v9;
        v11 = v8;
        *(_QWORD *)(*(_QWORD *)(a1 + 8 * v8 + 376) + 32LL) = VidSchiCreateContextInternal(
                                                               v10,
                                                               (unsigned int *)&v18,
                                                               0LL);
        if ( !*(_QWORD *)(*(_QWORD *)(a1 + 8 * v8 + 376) + 32LL) )
          break;
        v8 = (unsigned int)(v8 + 1);
        *(_QWORD *)(a1 + 360) |= 1LL << v11;
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)((char *)v19 + 4) = 7LL;
        ...
        HIDWORD(v18) = *(unsigned __int8 *)(v12 + a1 + 60)
                     + *(unsigned __int16 *)(*(_QWORD *)(v13 + 1904) + 48 * v12 + 2);
        *(_QWORD *)(*(_QWORD *)(a1 + 200) + 8 * v12) = VidSchiCreateContextInternal(v14, (unsigned int *)&v18, 0LL);
        v15 = *(_QWORD *)(*(_QWORD *)(a1 + 200) + 8 * v12);
        if ( !v15 )
          break;
