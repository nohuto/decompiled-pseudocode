/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C0080C84
 * Callers:
 *     VidMmReportContextAllocList @ 0x1C0081130 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiGlobalAlloc @ 0x1C0081360 (VidMmReportMultiGlobalAlloc.c)
 * Callees:
