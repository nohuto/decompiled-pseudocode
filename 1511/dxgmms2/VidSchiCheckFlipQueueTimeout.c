/*
 * XREFs of VidSchiCheckFlipQueueTimeout @ 0x1C000B6B0
 * Callers:
...
__int64 __fastcall VidSchiCheckFlipQueueTimeout(__int64 a1, _QWORD *a2, _DWORD *a3)
{
  ...
  {
    v9 = a1 + 2592;
    while ( !*(_QWORD *)v9 || !*(_DWORD *)(*(_QWORD *)v9 + 2340LL) )
    {
      ++v8;
      v9 += 8LL;
      if ( v8 >= v7 )
...
LABEL_20:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v15 + 8) = MEMORY[0xFFFFF78000000320];
    if ( *(_DWORD *)(v12 + 2328) )
    {
      v17 = 1160LL * *(unsigned int *)(v15 + 44) + v15 + 56;
      v33 = v17;
      if ( *(_DWORD *)(v17 + 1044) == 5
        || (v17 = 1160LL * *(unsigned int *)(v15 + 40) + v15 + 56,
            v33 = v17,
            (unsigned int)(*(_DWORD *)(v17 + 1044) - 3) <= 1) )
      {
        ...
        v24 = *((unsigned int *)KeGetCurrentPrcb() + 381);
        v25 = 10 * (v22 - v23) / v24;
        v26 = (_QWORD *)WdLogNewEntry5_WdPresentTokenEvent(v24, 10 * (v22 - v23) % v24, v20, v21);
        v26[3] = v23;
        v26[4] = v22;
        v26[5] = v25;
        WdLogEvent5_WdPresentTokenEvent(v26);
        v4 = a2;
        if ( v25 <= 10000000 * (unsigned __int64)g_TdrConfig[1] )
        {
LABEL_16:
          v12 = v30;
        }
...
LABEL_18:
    ...
    if ( (unsigned int)v14 >= *(_DWORD *)(a1 + 124) )
      goto LABEL_19;
  }
  if ( v4 )
    *v4 = *(_QWORD *)(v15 + 24);
