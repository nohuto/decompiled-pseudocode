/*
 * XREFs of ?NotifyDeferredDestructionComplete@ADAPTER_RENDER@@QEAAXPEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C00115A8
 * Callers:
...
{
  ((void (__fastcall **)(ADAPTER_RENDER *, struct DXGALLOCATION *))DxgCoreInterface)[43](this, a2);
}
