/*
 * XREFs of ?VidSchiUnreferencePrimaryAllocations@@YAXPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_MULTIPLANE_OVERLAY2@@IIIH@Z @ 0x1C00016E8
 * Callers:
  ...
  for ( i = 0; a4; a4 >>= 1 )
  {
    if ( (a4 & 1) != 0 )
    {
      if ( (a5 & 1) != 0 )
      {
        for ( j = 0; j < a3; ++j )
        {
          v10 = *((_QWORD *)a2 + 8 * (unsigned __int64)(j + i * *((_DWORD *)a2 + 1)) + 2);
          v11 = *(_QWORD *)(v10 + 96);
