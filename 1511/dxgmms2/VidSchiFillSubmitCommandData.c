/*
 * XREFs of VidSchiFillSubmitCommandData @ 0x1C0014048
 * Callers:
...
LABEL_12:
  ...
  *((_DWORD *)a2 + 18) = v9;
  ...
  else
  {
    *a2 = *(_QWORD *)(v2 + 64);
    ...
    {
      *((_DWORD *)a2 + 18) |= 0x10u;
      *((_DWORD *)a2 + 18) ^= (*((_DWORD *)a2 + 18) ^ (32 * (*(_DWORD *)(*(_QWORD *)(a1 + 56) + 376LL) != 2))) & 0x20;
      *((_DWORD *)a2 + 17) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 380LL);
      *((_DWORD *)a2 + 16) = *(_DWORD *)(*(_QWORD *)(a1 + 56) + 144LL);
    }
  ...
  *((_DWORD *)a2 + 19) = *(unsigned __int16 *)(*(_QWORD *)(v6 + 8LL * *(unsigned __int16 *)(v5 + 4) + 376) + 6LL);
