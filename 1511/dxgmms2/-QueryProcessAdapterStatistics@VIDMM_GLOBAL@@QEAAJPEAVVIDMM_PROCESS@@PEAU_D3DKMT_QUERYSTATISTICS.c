/*
 * XREFs of ?QueryProcessAdapterStatistics@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION@@@Z @ 0x1C001D79C
 * Callers:
 *     ?VidMmQueryProcessAdapterStatistics@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION@@@Z @ 0x1C001C540 (-VidMmQueryProcessAdapterStatistics@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYST.c)
 * Callees:
        ...
        struct _D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION *a3)
{
  ...
  if ( !v10 )
    return 3221225485LL;
  *(_DWORD *)a3 = *(_DWORD *)(*(_QWORD *)(v7 + 40048) + 8LL);
  *((_QWORD *)a3 + 3) = *(_QWORD *)(v10 + 368);
  *((_DWORD *)a3 + 4) = *(_DWORD *)(v10 + 360);
  *((_DWORD *)a3 + 8) = *(_DWORD *)(v10 + 376);
  *((_DWORD *)a3 + 9) = *(_DWORD *)(v10 + 380);
  *((_QWORD *)a3 + 23) = *(int *)(v10 + 400);
  *((_QWORD *)a3 + 22) = *(int *)(v10 + 396);
  *((_QWORD *)a3 + 21) = (int)VIDMM_POLICY::IsActive((VIDMM_POLICY *)(v10 + 384));
