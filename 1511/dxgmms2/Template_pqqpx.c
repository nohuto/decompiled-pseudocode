/*
 * XREFs of Template_pqqpx @ 0x1C001FFA0
 * Callers:
...
NTSTATUS Template_pqqpx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v10 = 8LL;
  v12 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventWaitQueueSubmit, 0LL, 5u, &UserData);
}
