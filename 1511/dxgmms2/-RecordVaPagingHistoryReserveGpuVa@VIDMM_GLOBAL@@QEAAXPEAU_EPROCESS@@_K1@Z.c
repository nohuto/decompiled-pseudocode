/*
 * XREFs of ?RecordVaPagingHistoryReserveGpuVa@VIDMM_GLOBAL@@QEAAXPEAU_EPROCESS@@_K1@Z @ 0x1C0042B70
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *((_QWORD *)this + 5082) )
  {
    ...
    if ( v8 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5082) + 24LL * (unsigned int)(*((_DWORD *)this + 10166))++ + 8) = 16;
