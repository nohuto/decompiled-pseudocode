/*
 * XREFs of ?RecordVaPagingHistoryUpdateGpuVa@VIDMM_GLOBAL@@QEAAXPEAU_EPROCESS@@IPEAU_VIDSCH_SYNC_OBJECT@@_K@Z @ 0x1C0081784
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( *((_QWORD *)this + 5082) )
  {
    ...
    if ( v9 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5082) + 24LL * (unsigned int)(*((_DWORD *)this + 10166))++ + 8) = 17;
