/*
 * XREFs of ?RecordVaPagingHistoryUpdateGpuVaOp@VIDMM_GLOBAL@@QEAAXPEAU_EPROCESS@@PEAUVIDMM_ALLOC@@PEAU_D3DDDI_UPDATEGPUVIRTUALADDRESS_OPERATION@@@Z @ 0x1C00818CC
 * Callers:
        ...
        struct _D3DDDI_UPDATEGPUVIRTUALADDRESS_OPERATION *a4)
{
  ...
  if ( *((_QWORD *)this + 5082) )
  {
    ...
    if ( v8 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5082) + 24LL * (unsigned int)(*((_DWORD *)this + 10166))++ + 8) = 18;
