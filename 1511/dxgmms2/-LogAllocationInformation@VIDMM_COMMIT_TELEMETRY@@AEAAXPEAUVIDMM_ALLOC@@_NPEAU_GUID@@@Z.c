/*
 * XREFs of ?LogAllocationInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_ALLOC@@_NPEAU_GUID@@@Z @ 0x1C0086B2C
 * Callers:
        ...
        struct _GUID *a4)
{
  ...
  {
    if ( a3 )
      this = *(VIDMM_COMMIT_TELEMETRY **)(*(_QWORD *)this + 40888LL);
    if ( (unsigned int)dword_1C002F020 > 5 )
    {
      if ( TlgKeywordOn(this, 0x400000000000uLL) )
      {
        v8 = *(unsigned __int16 **)(*(_QWORD *)(*(_QWORD *)&v5->Data1 + 24LL) + 984LL);
        v19 = v22;
        v20 = 2LL;
        v9 = *v8;
        v21 = *((_QWORD *)v8 + 1);
        ...
        v16 = (int)v11;
        v36 = 4LL;
        TlgWrite(v11, &unk_1C0025A95, v7, v5, 0xBu, &pData);
      }
    }
  }
}
