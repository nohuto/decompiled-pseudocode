/*
 * XREFs of ?GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z @ 0x1C007FD78
 * Callers:
 *     VidMmGetNextBuffersContractedSize @ 0x1C001C6A0 (VidMmGetNextBuffersContractedSize.c)
 * Callees:
