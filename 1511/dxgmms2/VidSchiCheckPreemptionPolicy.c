/*
 * XREFs of VidSchiCheckPreemptionPolicy @ 0x1C000BFF0
 * Callers:
...
_BOOL8 __fastcall VidSchiCheckPreemptionPolicy(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  int v5; // eax
  int v8; // esi
  ...
  *a2 = -1LL;
  ...
  if ( (v5 & 2) != 0 )
  {
    if ( a1 == *(_QWORD *)(v4 + 8LL * *(unsigned int *)(v4 + 1512) + 1520) )
    {
      v8 = 15;
      goto LABEL_4;
    }
  ...
  if ( (*(_DWORD *)(v9 + 2096) & 1) == 0 )
  {
    v8 = 3;
    goto LABEL_4;
  }
  _InterlockedIncrement((volatile signed __int32 *)(v9 + 912));
  if ( _InterlockedIncrement((volatile signed __int32 *)(v4 + 2728)) != 1 )
  {
    v8 = 13;
    goto LABEL_19;
  }
  ...
  MostSignificantBit = RtlFindMostSignificantBit(*(unsigned int *)(v4 + 1652));
  v15 = *(_DWORD *)(a1 + 396);
  if ( MostSignificantBit <= v15 )
  {
    if ( MostSignificantBit != v15 )
    {
      if ( *(_BYTE *)(v4 + 1896) )
      {
        _InterlockedDecrement((volatile signed __int32 *)(v4 + 2728));
        v8 = 11;
        _InterlockedDecrement((volatile signed __int32 *)(v9 + 912));
        goto LABEL_4;
      }
      goto LABEL_35;
    }
    v16 = *(_QWORD *)(v4 + 8LL * *(unsigned int *)(v4 + 1512) + 1520);
...
LABEL_35:
  if ( !v8 )
    v8 = 1;
LABEL_4:
  VidSchiProfilePerformanceTick(1LL, v9, v4, a4, a1, 0LL, 0LL, v8);
