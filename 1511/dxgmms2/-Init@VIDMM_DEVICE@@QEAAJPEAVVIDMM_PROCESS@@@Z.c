/*
 * XREFs of ?Init@VIDMM_DEVICE@@QEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1C0053828
 * Callers:
 *     VidMmInitDevice @ 0x1C0014580 (VidMmInitDevice.c)
...
__int64 __fastcall VIDMM_DEVICE::Init(VIDMM_DEVICE *this, struct VIDMM_PROCESS *a2, __int64 a3, __int64 a4)
{
  ...
  {
    v6 = *(VIDMM_PROCESS **)(*(_QWORD *)this + 40056LL);
  }
  *((_QWORD *)this + 1) = v6;
  if ( !v6 )
  {
  ...
  if ( *((_QWORD *)this + 3) )
  {
    ...
    if ( v11 < 0 )
    {
      _InterlockedAdd(&dword_1C002F4F8, 1u);
  ...
  *((_QWORD *)this + 5) = v14;
  if ( !v14 )
  {
    _InterlockedAdd(&dword_1C002F4FC, 1u);
  ...
  *((_QWORD *)this + 9) = v38;
  ...
  if ( *((_DWORD *)this + 15) )
  {
    while ( 1 )
    {
      ...
      if ( (unsigned int)v48 >= *((_DWORD *)this + 15) )
        goto LABEL_59;
    }
  }
  else
...
LABEL_59:
    ...
    *((_QWORD *)this + 24) = qword_1C002F398 + v50 * KeQueryTimeIncrement();
    return 0LL;
  }
  return result;
}
