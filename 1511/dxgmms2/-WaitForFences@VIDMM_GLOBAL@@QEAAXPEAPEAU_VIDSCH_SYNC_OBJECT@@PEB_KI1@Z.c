/*
 * XREFs of ?WaitForFences@VIDMM_GLOBAL@@QEAAXPEAPEAU_VIDSCH_SYNC_OBJECT@@PEB_KI1@Z @ 0x1C0051B80
 * Callers:
 *     ?VidMmWaitForFences@@YAXPEAVVIDMM_GLOBAL@@PEAPEAU_VIDSCH_SYNC_OBJECT@@PEB_KI@Z @ 0x1C00153B0 (-VidMmWaitForFences@@YAXPEAVVIDMM_GLOBAL@@PEAPEAU_VIDSCH_SYNC_OBJECT@@PEB_KI@Z.c)
...
LABEL_21:
  ...
  if ( (int)ObCreateObject(0LL, ExEventObjectType, &v27, 0LL, 0LL, 24, 0, 0, &Event) >= 0 )
  {
    ...
    if ( (int)VidSchSubmitWaitFromCpu(
                ...
                0,
                1,
                *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 408LL) + 192LL)) < 0 )
