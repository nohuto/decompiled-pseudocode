/*
 * XREFs of VidSchFlushQueuePackets @ 0x1C0010DB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchiIsFlipQueuePacket @ 0x1C00153C4 (VidSchiIsFlipQueuePacket.c)
...
void __fastcall VidSchFlushQueuePackets(struct _VIDSCH_GLOBAL *a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( *((_DWORD *)a1 + 56) == 1 )
  {
    if ( a2 == 1 )
    {
      ...
      {
        _m_prefetchw(i - 8);
        v10 = (signed __int64)*(i - 8);
        while ( v10 )
        {
          v11 = v10;
          v10 = _InterlockedCompareExchange64((volatile signed __int64 *)i - 8, v10 + 1, v10);
          if ( v11 == v10 )
          {
            v50 = ++v6;
            goto LABEL_10;
...
LABEL_18:
          v22 = (__int64 *)(v18 + 9);
          for ( j = v18[9]; j != v22; j = (__int64 *)*j )
          {
            v24 = j + 80;
            for ( k = (_QWORD *)j[80]; k != v24; k = *(_QWORD **)(v36 + 32) )
            {
          ...
          if ( v51 )
          {
            if ( v3 == -1 )
              ...
              VidSchiSetFlipDevice(a1, v3, v18, 0, 6, 0);
          }
    ...
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)a1 + 228, &v49);
      v31 = (char *)a1 + 208;
      for ( n = (char *)*((_QWORD *)a1 + 26); n != v31; n = *(char **)n )
      {
        for ( ii = (char *)*((_QWORD *)n - 2); ii != n - 16; ii = *(char **)ii )
        {
          ...
          {
            v44 = jj - 32;
            VidSchiFlushQueuePacket(v30, jj - 32, a2);
          }
          for ( kk = (char *)*((_QWORD *)ii + 82); kk != ii + 656; kk = (char *)*((_QWORD *)v45 + 4) )
          {
            v45 = kk - 32;
            VidSchiFlushQueuePacket(v30, kk - 32, a2);
          }
        }
      }
      p_LockHandle = &v49;
