/*
 * XREFs of ?AcquireGPUResourcesFromPreferredSegmentSet@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@KK@Z @ 0x1C0049794
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( !*(_BYTE *)(a1 + 7064) || v9 )
    ...
    v10 = 0;
  v11 = *(_QWORD *)(a1 + 40048) + 456LL * (*(_DWORD *)(a2 + 76) & 0x3F);
LABEL_33:
  if ( v10 <= 2 )
  {
    v12 = 0;
    ...
    while ( 1 )
    {
      ...
      v7 = VIDMM_GLOBAL::ValidateSegmentForAcquisitionOfResource(a1, a2, (unsigned int)v17, a3, v23);
      if ( v7 >= 0 )
        break;
LABEL_30:
      a3 = v24;
