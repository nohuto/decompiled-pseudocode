/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C007F6CC
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C001C790 (VidMmSetWorkingSetInformation.c)
 * Callees:
