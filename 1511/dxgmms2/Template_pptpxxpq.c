/*
 * XREFs of Template_pptpxxpq @ 0x1C00162CC
 * Callers:
...
NTSTATUS Template_pptpxxpq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v19; // [rsp+E8h] [rbp+47h] BYREF
  va_list va; // [rsp+E8h] [rbp+47h]
  __int64 v21; // [rsp+F0h] [rbp+4Fh] BYREF
  va_list va1; // [rsp+F0h] [rbp+4Fh]
  __int64 v23; // [rsp+F8h] [rbp+57h] BYREF
  va_list va2; // [rsp+F8h] [rbp+57h]
  __int64 v25; // [rsp+100h] [rbp+5Fh] BYREF
  va_list va3; // [rsp+100h] [rbp+5Fh]
  __int64 v27; // [rsp+108h] [rbp+67h] BYREF
  va_list va4; // [rsp+108h] [rbp+67h]
  __int64 v29; // [rsp+110h] [rbp+6Fh] BYREF
  va_list va5; // [rsp+110h] [rbp+6Fh]
  __int64 v31; // [rsp+118h] [rbp+77h] BYREF
  va_list va6; // [rsp+118h] [rbp+77h]
  va_list va7; // [rsp+120h] [rbp+7Fh] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v16 = 8LL;
  v18 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpUpdateContextAllocation, 0LL, 8u, &UserData);
}
