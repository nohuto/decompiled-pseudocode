/*
 * XREFs of ?TrimPool@VIDMM_DMA_POOL@@QEAAXE@Z @ 0x1C0080458
 * Callers:
 *     VidMmTrimDmaPoolToMinimum @ 0x1C001C7E0 (VidMmTrimDmaPoolToMinimum.c)
 *     ?GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z @ 0x1C007FD78 (-GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z.c)
 * Callees:
 ...
 *     ?NeedToBeTrimmed@VIDMM_DMA_POOL@@IEAAHXZ @ 0x1C007FDEC (-NeedToBeTrimmed@VIDMM_DMA_POOL@@IEAAHXZ.c)
 */
  ...
  *(_QWORD *)(v5 + 24) = this[2];
       ...
       && v8 != (VIDMM_DMA_POOL *)(this + 12) )
  {
    ...
    if ( v4 >= 2 || *((_BYTE *)v9 + 25) )
    {
      ...
      VIDMM_DMA_POOL::RemoveDmaBufferFromPool((VIDMM_DMA_POOL *)this, v9);
    }
    else
    {
      ++v4;
