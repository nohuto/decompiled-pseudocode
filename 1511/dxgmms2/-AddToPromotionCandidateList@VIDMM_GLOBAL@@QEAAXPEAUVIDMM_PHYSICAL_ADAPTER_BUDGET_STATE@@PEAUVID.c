/*
 * XREFs of ?AddToPromotionCandidateList@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PHYSICAL_ADAPTER_BUDGET_STATE@@PEAUVIDMM_PROCESS_BUDGET_STATE@@_N@Z @ 0x1C00860B8
 * Callers:
 ...
 *     ?AssignProcessBudget@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEAUVIDMM_PROCESS_ADAPTER_INFO@@_K@Z @ 0x1C00866D8 (-AssignProcessBudget@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@.c)
 * Callees:
 *     <none>
 */
        ...
        char a4)
{
  ...
  if ( !*(_QWORD *)a3 )
  {
    if ( a4 )
    {
      ...
      *(_QWORD *)a3 = *(_QWORD *)a2;
      *((_QWORD *)a3 + 1) = a2;
      if ( *(struct VIDMM_PHYSICAL_ADAPTER_BUDGET_STATE **)(v4 + 8) != a2 )
        __fastfail(3u);
      *(_QWORD *)(v4 + 8) = a3;
      *(_QWORD *)a2 = a3;
    }
    ...
    {
      v5 = (struct VIDMM_PHYSICAL_ADAPTER_BUDGET_STATE **)*((_QWORD *)a2 + 1);
      *(_QWORD *)a3 = a2;
      *((_QWORD *)a3 + 1) = v5;
      if ( *v5 != a2 )
        __fastfail(3u);
