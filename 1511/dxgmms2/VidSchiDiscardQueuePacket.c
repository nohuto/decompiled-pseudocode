/*
 * XREFs of VidSchiDiscardQueuePacket @ 0x1C008A4A8
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( *(_BYTE *)(v7 + 46) )
  {
    ...
    if ( v8 )
    {
      ...
      v14 = *(void **)(v13 + 360);
      LODWORD(v13) = *((_DWORD *)a1 + 77);
      v19.DmaBufferSubmissionStartOffset = 0;
      v19.DmaBufferSubmissionEndOffset = v13;
      v19.DmaBufferPrivateDataSubmissionStartOffset = *((_DWORD *)a1 + 82);
      ...
      v19.AllocationListSize = *((_DWORD *)a1 + 79);
    ...
    {
      v9 = *((_DWORD *)a1 + 77);
      v19.DmaBufferVirtualAddress = *((_QWORD *)a1 + 37);
      v10 = *((_DWORD *)a1 + 84);
      v19.DmaBufferSize = v9;
      v19.DmaBufferSubmissionEndOffset = v9;
      v11 = (UINT *)*((_QWORD *)a1 + 34);
      v19.DmaBufferUmdPrivateDataSize = v10;
      v19.DmaBufferPrivateDataSubmissionEndOffset = *((_DWORD *)a1 + 83);
      if ( v11 )
      {
    ...
    if ( v16 )
    {
      v17 = (_QWORD *)WdLogNewEntry5_WdCriticalError(a1, a2, a3, v15);
      v17[5] = v16;
      v17[6] = &v19;
      v17[3] = 281LL;
      v17[4] = 9LL;
  ...
  if ( v5 && !*((_DWORD *)a1 + 12) )
    VIDMM_GLOBAL::UnreferenceDmaBuffer(
      *(VIDMM_GLOBAL **)(*(_QWORD *)(v7 + 8) + 432LL),
      (struct _VIDMM_DMA_BUFFER *)v5,
      0);
LABEL_16:
  if ( (*((_DWORD *)a1 + 18) & 0x100) != 0 )
  {
    VIDMM_DMA_POOL::ReleaseBuffer(a1, (struct _VIDMM_DMA_BUFFER *)v5, *((_DWORD *)a1 + 12) == 8);
    VidSchiSignalRegisteredEvent(v7, (struct _KEVENT **)(v3 + 368));
    VidSchiSignalRegisteredEvent(v7, (struct _KEVENT **)(v6 + 368));
    VidSchiSignalRegisteredEvent(v7, (struct _KEVENT **)(v7 + 1752));
    *(_QWORD *)(v3 + 344) = MEMORY[0xFFFFF78000000320];
    KeSetEvent((PRKEVENT)(v3 + 312), 0, 0);
    *(_QWORD *)(v6 + 232) = MEMORY[0xFFFFF78000000320];
    KeSetEvent((PRKEVENT)(v6 + 200), 0, 0);
    *(_QWORD *)(v7 + 1560) = MEMORY[0xFFFFF78000000320];
    KeSetEvent((PRKEVENT)(v7 + 1528), 0, 0);
