/*
 * XREFs of VidSchSetNodePowerState @ 0x1C00153E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VidSchSetNodePowerState(__int64 a1, unsigned int a2, int a3, char a4)
{
  ...
  v5 = *(_QWORD *)(a1 + 8LL * (a3 + (unsigned int)*(unsigned __int8 *)(a2 + a1 + 60)) + 376);
  if ( a4 )
  {
    if ( KeGetCurrentThread() == *(struct _KTHREAD **)(a1 + 128) )
    {
      v6 = 1;
    }
    else
    ...
    *(_BYTE *)(v5 + 2956) = 1;
    ...
    while ( (__int64 *)*v8 != v8 )
    {
      ...
      *(_DWORD *)(*v8 + 168) &= ~0x80u;
      v7 = 1;
      VidSchiUpdateContextStatus(v9 - 8, (_QWORD *)5, (__int64 *)0x2652);
    }
    if ( !v6 )
