/*
 * XREFs of ?Lock@VIDMM_RECYCLE_RANGE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_LOCK_OPERATION@@PEAVVIDMM_SEGMENT@@@Z @ 0x1C005D9B4
 * Callers:
        ...
        struct VIDMM_SEGMENT *a4)
{
  ...
  if ( (_DWORD)v8 )
  {
    ...
    if ( (_DWORD)v14 )
    {
      if ( (_DWORD)v14 != 1 )
      {
        v15 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v14, a2, a3, a4);
        v15[7] = 0LL;
        v15[3] = 270LL;
        v15[4] = 52LL;
        v15[5] = 2LL;
  ...
  if ( (qword_1C002F070 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v11, &EventProfilerExit, v12, 8000);
