/*
 * XREFs of Template_pppxxq @ 0x1C001CFB4
 * Callers:
...
NTSTATUS Template_pppxxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 8LL;
  v14 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventMemoryTransfer, 0LL, 6u, &UserData);
}
