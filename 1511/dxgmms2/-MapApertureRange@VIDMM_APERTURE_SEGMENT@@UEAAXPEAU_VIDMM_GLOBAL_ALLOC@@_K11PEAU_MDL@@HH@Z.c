/*
 * XREFs of ?MapApertureRange@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@_K11PEAU_MDL@@HH@Z @ 0x1C0066890
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  v11 = (char)a2;
  if ( (*(_DWORD *)(*((_QWORD *)v9 + 3) + 284LL) & 4) == 0 )
  {
  ...
  *(_QWORD *)(*((_QWORD *)this + 1) + 40024LL) += a3;
  v12 = *((_QWORD *)this + 1);
  v13 = *(_QWORD *)(*(_QWORD *)(v12 + 24) + 3152LL);
  v14 = *(_QWORD *)(v12 + 40024);
