/*
 * XREFs of ?TrimResidentBytes@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00558B0
 * Callers:
 ...
 *     ?VerifyResidentLimit@VIDMM_SEGMENT@@IEAA_NXZ @ 0x1C00559A8 (-VerifyResidentLimit@VIDMM_SEGMENT@@IEAA_NXZ.c)
