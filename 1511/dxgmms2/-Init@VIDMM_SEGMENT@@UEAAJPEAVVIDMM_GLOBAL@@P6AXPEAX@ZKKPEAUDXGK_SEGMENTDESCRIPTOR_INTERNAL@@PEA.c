/*
 * XREFs of ?Init@VIDMM_SEGMENT@@UEAAJPEAVVIDMM_GLOBAL@@P6AXPEAX@ZKKPEAUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@PEAT_LARGE_INTEGER@@@Z @ 0x1C0069AC0
 * Callers:
 *     ?Init@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAVVIDMM_GLOBAL@@P6AXPEAX@ZKKPEAUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@PEAT_LARGE_INTEGER@@@Z @ 0x1C0066800 (-Init@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAVVIDMM_GLOBAL@@P6AXPEAX@ZKKPEAUDXGK_SEGMENTDESCRIPTOR_INTERN.c)
  ...
  *((_QWORD *)this + 15) = *((_QWORD *)a6 + 4);
  if ( (v11 & 0x1000) == 0 )
  {
    ...
    *((_QWORD *)this + 18) = v12;
    if ( !v12 )
    {
      _InterlockedIncrement(&dword_1C002F4F0);
    ...
    if ( v14 < 0 )
    {
      _InterlockedIncrement(&dword_1C002F4F4);
...
LABEL_9:
  if ( a7 )
    ...
    QuadPart = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 24LL) + 1320LL);
  ...
  *((_DWORD *)this + 92) = (*(_DWORD *)a6 & 0x800) != 0 ? 0x10000 : 4096;
  ...
  if ( (int)result >= 0 )
  {
    ...
    *((_QWORD *)this + 33) = PagesForMdl;
    if ( PagesForMdl )
    {
      v24 = (unsigned int)dword_1C002F13C;
      *((_QWORD *)this + 29) = (unsigned int)dword_1C002F13C;
      if ( (_DWORD)v24 )
      {
        v51 = 16 * v24;
        ...
        *((_QWORD *)this + 30) = v52;
        ...
        {
          *((_DWORD *)this + 58) = 0;
          _InterlockedIncrement(&dword_1C002F5C0);
    ...
    _InterlockedIncrement(&dword_1C002F584);
