/*
 * XREFs of ?DestroyPagingProcess@VIDMM_PAGING_PROCESS@@QEAAXXZ @ 0x1C0081524
 * Callers:
  ...
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)(v4 + 6416) )
    {
      do
      {
        ...
        if ( v7 )
        {
          for ( i = 0; i < *(_DWORD *)(*((_QWORD *)v7 + 8) + 6416LL); ++i )
          {
            v9 = (VIDMM_PAGE_DIRECTORY **)(*((_QWORD *)v7 + 12) + 32LL * i);
            if ( *v9 )
            {
          ...
          CVirtualAddressAllocator::DestroyVaAllocator(*((CVirtualAddressAllocator **)this + v6 + 4), a2, a3, a4);
