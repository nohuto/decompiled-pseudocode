/*
 * XREFs of Template_pptpqxqqppqqxxpqx @ 0x1C0015C4C
 * Callers:
...
NTSTATUS Template_pptpqxqqppqqxxpqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v67; // [rsp+1F0h] [rbp+F0h] BYREF
  va_list va15; // [rsp+1F0h] [rbp+F0h]
  va_list va16; // [rsp+1F8h] [rbp+F8h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v34 = 4LL;
  v36 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpUpdatePageTable, 0LL, 0x11u, &UserData);
}
