/*
 * XREFs of VidSchiMarkDevicesInError @ 0x1C008A758
 * Callers:
...
_UNKNOWN **__fastcall VidSchiMarkDevicesInError(__int64 *a1, _BYTE *a2, __int64 *a3)
{
  ...
  v6 = *((_DWORD *)a1 + 8);
  *a2 = 0;
  for ( i = *(_QWORD *)(v4 + 24); v6 != *((_DWORD *)a1 + 9); v6 = ((_BYTE)v6 + 1) & 0xF )
  {
    result = (_UNKNOWN **)v6;
    v10 = *(_QWORD *)(v4 + 8LL * v6 + 1376);
    v11 = *(_DWORD *)(v10 + 88);
    if ( v11 != 3 )
    {
      result = (_UNKNOWN **)a1[3];
