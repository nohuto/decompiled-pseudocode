/*
 * XREFs of ?ReAllocateOldResource@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C0084DAC
 * Callers:
...
void __fastcall VIDMM_SEGMENT::ReAllocateOldResource(VIDMM_SEGMENT *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  v2 = *((_QWORD *)a2 + 2);
  *((_QWORD *)this + 26) += v2;
  v5 = *(_QWORD *)(*((_QWORD *)this + 1) + 40888LL) + 264LL * *((unsigned int *)this + 93);
  ...
  *((_QWORD *)this + 27) += *((_QWORD *)a2 + 2);
  if ( *((_DWORD *)this + 90) != -1 && (*((_DWORD *)a2 + 19) & 0x200) == 0 )
  {
    ...
    v7 = v6 + *((_QWORD *)a2 + 2);
    *((_QWORD *)this + 28) = v7;
    if ( v6 <= qword_1C002F3E0 && v7 > qword_1C002F3E0 )
      (*(void (__fastcall **)(_QWORD))(*((_QWORD *)this + 1) + 39936LL))(*(_QWORD *)(*((_QWORD *)this + 1) + 39984LL));
    if ( !v6 )
