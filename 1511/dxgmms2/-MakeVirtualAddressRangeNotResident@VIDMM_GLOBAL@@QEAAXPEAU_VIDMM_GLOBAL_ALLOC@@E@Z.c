/*
 * XREFs of ?MakeVirtualAddressRangeNotResident@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C0043D9C
 * Callers:
  ...
  if ( (*((_BYTE *)this + 40608) & 1) != 0 )
  {
    ...
    if ( a3 )
    {
      for ( k = 0; k < *((_DWORD *)this + 1604); ++k )
        VIDMM_GLOBAL::FlushPagingBufferInternal(this, k, 0, 0LL, 0LL, 0);
