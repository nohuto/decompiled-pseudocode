/*
 * XREFs of ?AddSidMappingToLsa@@YAJPEAU_UNICODE_STRING@@0PEAXPEAW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z @ 0x180001B0C
 * Callers:
        ...
        enum _LSA_SID_NAME_MAPPING_OPERATION_ERROR *a4)
{
  ...
  if ( v11 < 0 )
  {
    v9 = v11 | 0x10000000;
    if ( &dword_180008EA8 )
      MilInstrumentationCheckHR(4u, &dword_180008EA8, 2u, v9, 0x1F2u);
    else
      DoStackCapture(v9, 0x1F2u);
  }
  v12 = Buffer;
  if ( Buffer )
  {
