/*
 * XREFs of DllMain @ 0x1800016A4
 * Callers:
 *     __DllMainCRTStartup @ 0x18000767C (__DllMainCRTStartup.c)
 * Callees:
...
BOOL __stdcall DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved)
{
  ...
  WCHAR ValueName; // [rsp+F8h] [rbp-10h] BYREF
  _BYTE v27[78]; // [rsp+FAh] [rbp-Eh] BYREF
  ...
  if ( fdwReason )
  {
    if ( fdwReason == 1 )
    {
      ...
      LOWORD(Data[0].Ptr) = 0;
      memset_0((char *)&Data[0].Ptr + 2, 0, 0x48uLL);
      ...
      v8 = (GUID)*((_OWORD *)off_18000C028 - 1);
      qword_18000C048 = 0LL;
      qword_18000C050 = 0LL;
      hKey_8 = v8;
        ...
        && (qword_18000C038 & 0x400000000000LL) == qword_18000C038 )
      {
        ...
        v23 = 2LL;
        v25 = 2LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180009873, v9, v10, 6u, Data);
      }
      if ( byte_18000C078 )
      {
        if ( qword_18000C070 )
