/*
 * XREFs of ?ReportRestart@CDwmInitEventManager@DwmInitAsimov@@QEAAXU_GUID@@KH0GG@Z @ 0x180005C48
 * Callers:
...
void __fastcall DwmInitAsimov::CDwmInitEventManager::ReportRestart(
        ...
        struct _GUID *a5)
{
  ...
  if ( v5 )
  {
    v6 = (__int128)*a2;
    v9 = 0;
    v8 = &DwmInitAsimov::RestartEventData::`vftable';
