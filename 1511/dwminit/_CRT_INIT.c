/*
 * XREFs of _CRT_INIT @ 0x1800073DC
 * Callers:
 *     __DllMainCRTStartup @ 0x18000767C (__DllMainCRTStartup.c)
 * Callees:
 *     _guard_check_icall_nop @ 0x180003620 (_guard_check_icall_nop.c)
 *     _amsg_exit_0 @ 0x1800078E8 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x180007950 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x180007ABA (_initterm_0.c)
 */
