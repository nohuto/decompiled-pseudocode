/*
 * XREFs of DwmpTerminateSessionProcess @ 0x180003350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DwmpTerminateSessionProcess(int a1)
{
  ...
  if ( ghDwmProcess )
  {
    ...
    {
      if ( &dword_180008EB0 )
        MilInstrumentationCheckHR(4u, &dword_180008EB0, 1u, v1, 0x67Au);
      else
        DoStackCapture(v1, 0x67Au);
    }
  ...
  else if ( &dword_180008EB0 )
  {
    MilInstrumentationCheckHR(4u, &dword_180008EB0, 1u, v2, 0x67Fu);
  }
  else
  {
    DoStackCapture(v2, 0x67Fu);
  }
    ...
    && (qword_18000C038 & 0x400000000000LL) == qword_18000C038 )
  {
    ...
    v22 = 2LL;
    v24 = 2LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1800098CB, v3, v4, 9u, &pData);
  }
