/*
 * XREFs of ?SendSimpleAsyncRequestWow64@CPortClient@@AEAAJK@Z @ 0x180005280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPortClient::SendSimpleAsyncRequestWow64(CPortClient *this, int a2)
{
  ...
  {
    v4 = v7 | 0x10000000;
    MilInstrumentationCheckHR(1u, &CPortClient::MILINSTRUMENTATIONHRESULTLIST, 8LL, v7 | 0x10000000, 0x31u);
  }
  return v4;
}
