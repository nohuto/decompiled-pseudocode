/*
 * XREFs of ?SendComplexSyncRequestNative@CPortClient@@AEAAJKPEBXFPEAXFPEAJ@Z @ 0x180005470
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CheckStatus@CPortClient@@AEAAJJ@Z @ 0x1800050C8 (-CheckStatus@CPortClient@@AEAAJJ@Z.c)
 *     memcpy_0 @ 0x180007B7A (memcpy_0.c)
 */
        ...
        int *a7)
{
  ...
  if ( v14 )
  {
    ...
    if ( v17 >= 0 )
    {
      if ( (v15[1].u2.ZeroInit & 0x80000000) == 0 && a5 && a6 )
      {
        ...
        {
          v8 = -2147024872;
          MilInstrumentationCheckHR(1u, &CPortClient::MILINSTRUMENTATIONHRESULTLIST, 8LL, 0x80070018, 0xBAu);
        }
      }
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR(1u, &CPortClient::MILINSTRUMENTATIONHRESULTLIST, 8LL, 0x8007000E, 0xA8u);
  }
  return v8;
}
