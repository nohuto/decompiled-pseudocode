/*
 * XREFs of ?MilInstrumentationCheckHR@@YAXKQEBJIJI@Z @ 0x180003DE4
 * Callers:
 ...
 *     ?IsHRInList@@YA_NJQEBJI@Z @ 0x180003DC0 (-IsHRInList@@YA_NJQEBJI@Z.c)
 *     ?IsOOM@@YA_NJ@Z @ 0x180003E80 (-IsOOM@@YA_NJ@Z.c)
 */

void __fastcall MilInstrumentationCheckHR(unsigned int a1, const int *const a2, __int64 a3, UINT a4, unsigned int a5)
{
  bool v7; // al
  __int64 v8; // rcx
  const int *v9; // r10
