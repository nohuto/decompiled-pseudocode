/*
 * XREFs of ??1?$CAggregateTelemetry@VCDwmInitTelemetryAggregator@@W4DwmInitTelemetryAggregateType@@I$0A@$0A@@@UEAA@XZ @ 0x1800038D0
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__gDwmInitTelemetryAggregator__ @ 0x180007EF0 (_dynamic_atexit_destructor_for__gDwmInitTelemetryAggregator__.c)
 * Callees:
