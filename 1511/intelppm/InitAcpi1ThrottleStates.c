...
__int64 __fastcall InitAcpi1ThrottleStates(__int64 a1)
{
  ...
  v1 = 0;
  if ( ((unsigned int)dword_1C000DD04 <= 1 || (*(_DWORD *)(a1 + 248) & 0x200000) != 0)
    && (*(_DWORD *)(a1 + 248) & 0x100000LL) != 0
    && (v3 = a1 + 168, (unsigned __int8)IsValidAcpiGenericAddress(a1 + 168))
    && (unsigned __int8)(byte_1C000E426 - 1) <= 3u
    && (unsigned __int8)byte_1C000E426 + (unsigned __int8)byte_1C000E427 <= 32 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1032), 4u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1036), 4u);
    v5 = 1 << byte_1C000E426;
    v6 = (unsigned int)(20 * ((1 << byte_1C000E426) - 1) + 24);
      ...
      **(_DWORD **)(a1 + 440) = v5;
      if ( v5 > 1 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)(v10 + v9 - 4) = (v11 << byte_1C000E427) | 0x10;
        }
        while ( v8 < v5 );
      }
