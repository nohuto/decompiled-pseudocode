/*
 * XREFs of EnumerateControlMethods @ 0x1C0014D24
 * Callers:
 ...
 *     GetPackedName @ 0x1C0014F6C (GetPackedName.c)
 */
...
__int64 __fastcall EnumerateControlMethods(__int64 a1, _DWORD *a2)
{
  ...
  _DWORD *v26; // [rsp+80h] [rbp-19h]
  __int64 v27; // [rsp+88h] [rbp-11h] BYREF
  ...
  if ( v12 < 0 )
    goto LABEL_16;
  if ( *(_DWORD *)v5 == 1198089537 && (v13 = *((_DWORD *)v5 + 1)) != 0 && v27 == v9 )
  {
    v14 = v5 + 1;
    if ( v13 > 1 )
    {
