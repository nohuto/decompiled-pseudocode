...
__int64 __fastcall InitAcpiPerfStates(__int64 a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    *(_QWORD *)(a1 + 192),
    0LL);
  v2 = AcpiEval_PCT_PTC(a1, 1413697631LL, a1 + 360);
  v3 = 0;
  if ( v2 < 0 )
    v3 = v2;
  v4 = v2;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v3 >= 0 )
    {
      if ( (*(_DWORD *)(a1 + 248) & 0x40000000) != 0 )
      {
        v8 = *(_QWORD *)(a1 + 392);
        v9 = 0;
        v4 = ValidateXPssPStates(a1 + 360, v8, &v9);
        if ( v4 < 0 )
        {
          _InterlockedOr((volatile signed __int32 *)(a1 + 1040), v9);
          *(_QWORD *)(a1 + 248) &= ~0x40000000uLL;
        }
      }
      if ( (*(_DWORD *)(a1 + 248) & 0x30000000) != 0 )
      {
        v5 = *(_QWORD *)(a1 + 384);
        v9 = 0;
        v4 = ValidateAcpi2PStates(a1 + 360, v5, &v9);
        if ( v4 < 0 )
        {
          _InterlockedOr((volatile signed __int32 *)(a1 + 1040), v9);
          *(_QWORD *)(a1 + 248) &= 0xFFFFFFFFCFFFFFFFuLL;
