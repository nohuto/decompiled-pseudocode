/*
 * XREFs of InitializeEnergyEstimationForEfficiencyClass @ 0x1C00221F4
 * Callers:
...
__int64 __fastcall InitializeEnergyEstimationForEfficiencyClass(int a1)
{
  ...
  v2 = &dword_1C000E210[54 * a1];
  InitializeEnumerationContext((__int64)&qword_1C000DD18, 32, (__int64)v11);
  ResetEnumerationContext(v11);
  result = EnumerateNextDevice((__int64)v11, &v12);
  if ( !(_DWORD)result )
  {
    while ( *(unsigned __int8 *)(v12 + 320) != a1 || (int)EnableEnergyEstimation(v12) >= 0 )
    {
      result = EnumerateNextDevice((__int64)v11, &v12);
      if ( (_DWORD)result )
      {
...
LABEL_24:
      ...
      {
        while ( *(unsigned __int8 *)(v12 + 320) != a1 || (int)EnablePerformanceMonitoringCounters(v12) >= 0 )
        {
          result = EnumerateNextDevice((__int64)v11, &v12);
          if ( (_DWORD)result )
          {
