/*
 * XREFs of ProcLibTracePccSummary @ 0x1C001A334
 * Callers:
...
BOOLEAN ProcLibTracePccSummary()
{
  ...
  if ( result )
  {
    if ( qword_1C000E170 )
    {
      v3 = (unsigned int)(100 * *(_DWORD *)(qword_1C000E170 + 36)) / *(_DWORD *)(qword_1C000E170 + 28);
      v1 = (unsigned int)(100 * *(_DWORD *)(qword_1C000E170 + 32)) / *(_DWORD *)(qword_1C000E170 + 28);
      *(_QWORD *)&UserData.Size = 1LL;
      v2 = v1;
      UserData.Ptr = qword_1C000E170 + 6;
      v5 = qword_1C000E170 + 7;
      v7 = &v3;
      v9 = &v2;
      v6 = 1LL;
      v8 = 1LL;
