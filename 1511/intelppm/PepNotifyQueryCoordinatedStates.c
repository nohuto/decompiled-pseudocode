/*
 * XREFs of PepNotifyQueryCoordinatedStates @ 0x1C0020C0C
 * Callers:
...
__int64 __fastcall PepNotifyQueryCoordinatedStates(__int64 a1, PVOID **a2)
{
  ...
  v2 = (unsigned int)dword_1C000E1D8;
  v4 = 0LL;
  v5 = 0LL;
  v6 = (unsigned int)(16 * dword_1C000E1D8 + 4);
  ...
  if ( PoolWithTag )
  {
    ...
    *v8 = v2;
    v9 = PoFxProcessorNotification(*(_QWORD *)(a1 + 1048), 29LL, v8);
    if ( v9 >= 0 )
    {
      v10 = 0;
      v11 = 0;
      ...
      if ( (_DWORD)v2 )
      {
        ...
        do
        {
          KeInitializeAffinityEx(v26 - 184);
          v27 = 0;
          *(_DWORD *)v26 = *(v24 - 2);
          *((_DWORD *)v26 + 1) = *(v24 - 1);
          *((_DWORD *)v26 + 3) = *v24;
          ...
          *((_QWORD *)v26 + 3) = v25;
          ...
          PepQueryName(a1, v21++, 27LL, v26 - 16);
          v26 += 216;
          v24 += 4;
        }
...
LABEL_27:
          ...
          while ( 1 )
          {
            ...
            *v5 = v30;
            v5[1] = v32;
            v5[2] = *(_DWORD *)v31;
            v9 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C000DF88)(*(_QWORD *)(a1 + 1048), v5);
            if ( v9 < 0 )
              break;
            v9 = ValidateCoordinatedDependencyOptions((__int64)v4, v30, v33, *(_DWORD *)v31, (__int64)v5);
            if ( v9 < 0 )
              break;
            v34 = *((_QWORD *)v5 + 2);
            v35 = *((_QWORD *)v31 + 2) + 16LL * v32;
            if ( v34 )
              *(_DWORD *)v35 = *(_DWORD *)(v34 + 56);
            else
              *(_DWORD *)v35 = -1;
            v36 = v5[3];
            *(_DWORD *)(v35 + 4) = v36;
            memmove(*(void **)(v35 + 8), v5 + 6, 4LL * v36);
            v29 = v42;
            if ( ++v32 >= *((_DWORD *)v31 + 1) )
              goto LABEL_27;
          }
