/*
 * XREFs of ?FxStubUnbindClasses@@YAXPEAU_WDF_BIND_INFO@@@Z @ 0x1C0002750
 * Callers:
 *     ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C0002470 (-FxStubDriverUnloadCommon@@YAXXZ.c)
 * Callees:
 *     WdfVersionUnbindClass_0 @ 0x1C0002800 (WdfVersionUnbindClass_0.c)
 */
