/*
 * XREFs of RegisterHvFeedbackCountersCallback @ 0x1C001C270
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00029B0 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C0002D00 (memset.c)
 *     DecodeGenAddressToHvPerfReg @ 0x1C001BC4C (DecodeGenAddressToHvPerfReg.c)
 */
...
__int64 __fastcall RegisterHvFeedbackCountersCallback(__int64 a1)
{
  ...
  v3 = *(_DWORD *)(a1 + 32);
  if ( !v3 )
    return (unsigned int)((__int64 (__fastcall *)(__int64))qword_1C000DEE8)(a1);
  v4 = v3;
