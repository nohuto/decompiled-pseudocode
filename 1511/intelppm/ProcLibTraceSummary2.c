/*
 * XREFs of ProcLibTraceSummary2 @ 0x1C00129BC
 * Callers:
    ...
    if ( ProcessorNumber >= 0 )
    {
      ...
      else
      {
        if ( (v5 & 0x8000000) == 0 )
        {
          ...
          {
            v21 = 2;
            v10 = *(_DWORD *)(qword_1C000E170 + 28);
            v18 = v10;
            v19 = 100 * *(_DWORD *)(qword_1C000E170 + 36) / v10;
            v20 = 100 * *(_DWORD *)(qword_1C000E170 + 32) / v10;
          }
          else
          {
            if ( (v5 & 0x73300000) == 0 )
...
LABEL_36:
        ...
        if ( !v13 )
        {
          ...
          GetRegistryDwordValue(
            ...
            &v18);
          v14 = *(_QWORD *)(a1 + 336);
          v23 = 100LL * *(_QWORD *)(a1 + 328) / v14;
          v15 = 100LL * *(_QWORD *)(a1 + 344) / v14;
          v19 = v15;
          v16 = 100LL * *(_QWORD *)(a1 + 352) / v14;
          v10 = v18;
          if ( !(_DWORD)v16 )
            LODWORD(v16) = 1;
          v20 = v16;
