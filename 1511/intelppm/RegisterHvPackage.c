/*
 * XREFs of RegisterHvPackage @ 0x1C001C890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterHvPackage(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    while ( (__int64 *)v3 != &qword_1C000DD38 );
    if ( !HvPackage )
    {
LABEL_6:
...
LABEL_13:
      ...
      *(_QWORD *)HvPackage = &qword_1C000DD38;
      *((_QWORD *)HvPackage + 1) = v5;
      if ( *v5 != &qword_1C000DD38 )
        __fastfail(3u);
      *v5 = (__int64 *)HvPackage;
      qword_1C000DD40 = (__int64)HvPackage;
    }
    *(_QWORD *)(a1 + 1008) = HvPackage;
    ++HvPackage[51];
    v6 = a1 + 1016;
    v7 = (_QWORD *)*((_QWORD *)HvPackage + 3);
    *(_QWORD *)(a1 + 1016) = HvPackage + 4;
    *(_QWORD *)(a1 + 1024) = v7;
