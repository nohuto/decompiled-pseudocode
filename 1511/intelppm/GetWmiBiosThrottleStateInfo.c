/*
 * XREFs of GetWmiBiosThrottleStateInfo @ 0x1C0004ED0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  *(_BYTE *)a3 = byte_1C000E426;
  *(_BYTE *)(a3 + 1) = byte_1C000E427;
  *(_DWORD *)(a3 + 4) = *(_DWORD *)(v10 + 56);
  *(_DWORD *)(a3 + 8) = *(_DWORD *)(v10 + 448);
  v12 = *(_QWORD *)(v10 + 248);
  if ( (v12 & 0x3000000) != 0 )
    v13 = 3;
  else
  ...
  *(_DWORD *)(a3 + 4) = *(_DWORD *)(v11 + 56);
  do
  {
    v16 = *(unsigned __int8 *)(v11 + v15++ + 416);
    *v14++ = v16;
  }
  while ( v15 < 4 );
  v17 = (_DWORD *)(a3 + 56);
  *(_QWORD *)(a3 + 48) = *(_QWORD *)(v11 + 420);
  for ( i = 0LL; i < 4; ++i )
  {
    v19 = *(unsigned __int8 *)(v11 + i + 428);
    *v17++ = v19;
  }
  *(_QWORD *)(a3 + 72) = *(_QWORD *)(v11 + 432);
  v20 = *(unsigned int **)(v11 + 440);
  if ( !v20 )
  {
