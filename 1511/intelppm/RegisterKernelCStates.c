/*
 * XREFs of RegisterKernelCStates @ 0x1C0015B6C
 * Callers:
...
__int64 __fastcall RegisterKernelCStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v3 && *(_DWORD *)v3 )
  {
    ...
    *(_QWORD *)(a2 + 24) = AcpiCStateIdlePrepare;
    v8 = 1;
    *(_QWORD *)(a2 + 104) = 0LL;
    *(_QWORD *)(a2 + 72) = AcpiCStateIdleExecute;
    *(_QWORD *)(a2 + 80) = AcpiCStateIdleCancel;
    ...
    *(_DWORD *)(a3 + 56) = 0;
    ...
    if ( *(_BYTE *)(v3 + 16) != 1 )
    {
      ...
      v8 = 2;
      *(_DWORD *)(a2 + 112) = *(_DWORD *)(a2 + 112) & 0x7FFFFF80 | (v22 << 31) | 0xF;
      *(_DWORD *)(a2 + 108) = 1;
      *(_DWORD *)(a3 + 56) = 1;
    }
    v9 = *(_DWORD *)v3;
    for ( i = 0; i < *(_DWORD *)v3; ++v8 )
    {
      ...
      if ( v11 == v8 )
      {
        ...
        v14 = *(unsigned int *)(a2 + 108);
        v23 = 32 * v14;
        v21 = (_QWORD *)(a3 + 8 * (9 * v14 + 8));
        *v21 = v3 + 4 * (i + 4LL * i + 1);
        v24 = v3 + 4 * (i + 4LL * i + 1);
        if ( (int)DecodeAcpi2CState(v7, (unsigned int)v3 + 4 * (i + 4 * i + 1), 0, (unsigned int)&v22, (__int64)v21) < 0 )
        {
          _InterlockedOr((volatile signed __int32 *)(v7 + 1040), 8u);
        }
        else
        {
          v15 = v23;
          v16 = v24;
          v17 = *(_DWORD *)(v23 + a2 + 112) ^ (*(_DWORD *)(v23 + a2 + 112) ^ (8 * v8)) & 0x78 | 7;
          *(_DWORD *)(v23 + a2 + 112) = v17;
          *(_DWORD *)(v15 + a2 + 112) = v17 & 0x7FFFFFFF | (v22 << 31);
          *(_DWORD *)(v15 + a2 + 116) = 10 * *(unsigned __int16 *)(v16 + 14);
          *(_DWORD *)(v15 + a2 + 124) = *(_DWORD *)(v16 + 16);
          ++*(_DWORD *)(a2 + 108);
          ++*(_DWORD *)(a3 + 56);
        }
      }
