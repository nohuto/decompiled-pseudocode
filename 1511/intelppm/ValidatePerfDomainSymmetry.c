...
LABEL_16:
      ...
      if ( (v9 & 0x70000000) != 0 )
      {
        if ( (int)ValidatePctPtcSymmetry(v10, v1 + 45, v5, v1 + 45) < 0 )
        {
          v3 |= 0x70000000uLL;
          v25 = v3;
        }
        v9 = v1[31];
        if ( (v9 & 0x40000000) != 0 && (int)ValidatePssSymmetry(v10, v1[49], v5, v8[49]) < 0 )
        {
          v3 |= 0x40000000uLL;
          v25 = v3;
        }
        if ( (v9 & 0x30000000) != 0 && (int)ValidatePssSymmetry(v10, v1[48], v5, v8[48]) < 0 )
        {
          v3 |= 0x30000000uLL;
          v25 = v3;
        }
...
LABEL_14:
      ...
      if ( (int)ValidatePctPtcSymmetry(v10, v1 + 52, v5, v1 + 52) < 0 )
      {
        v3 |= 0x3300000uLL;
        v25 = v3;
      }
