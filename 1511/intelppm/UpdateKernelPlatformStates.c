/*
 * XREFs of UpdateKernelPlatformStates @ 0x1C00055E8
 * Callers:
...
LABEL_26:
    ...
    v3[48] = 1;
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(v28 + 2504))(v29, qword_1C000DD08, 0LL);
    ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_BYTE *))qword_1C000DF10)(v3);
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      do
      {
        ...
        *v4 = v21;
        v4[8] = v5;
        if ( (int)((__int64 (__fastcall *)(_QWORD, _DWORD *, __int64))qword_1C000DF80)(*(_QWORD *)(a1 + 1048), v4, v23) >= 0 )
        {
