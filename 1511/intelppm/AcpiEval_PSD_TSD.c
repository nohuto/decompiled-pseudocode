/*
 * XREFs of AcpiEval_PSD_TSD @ 0x1C0013644
 * Callers:
 *     InitAcpiPerfDomain @ 0x1C001301C (InitAcpiPerfDomain.c)
 *     InitAcpiThrottleDomain @ 0x1C001DF50 (InitAcpiThrottleDomain.c)
 * Callees:
...
__int64 __fastcall AcpiEval_PSD_TSD(__int64 a1, int a2, _QWORD *a3)
{
  ...
  P = 0LL;
  if ( a2 == 1146310751 )
    _InterlockedOr((volatile signed __int32 *)(a1 + 1036), 0x200u);
  else
    _InterlockedOr((volatile signed __int32 *)(a1 + 1036), 0x2000u);
...
LABEL_23:
  if ( a2 == 1146310751 )
    _InterlockedOr((volatile signed __int32 *)(a1 + 1040), 0x200u);
  else
    _InterlockedOr((volatile signed __int32 *)(a1 + 1040), 0x2000u);
  if ( v6 )
