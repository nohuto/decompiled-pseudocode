/*
 * XREFs of AcpiEval_PDC @ 0x1C001D640
 * Callers:
...
__int64 __fastcall AcpiEval_PDC(__int64 a1, const void *a2, unsigned __int16 a3)
{
  ...
  if ( !PoolWithTag )
  {
    v9 = -1073741670;
LABEL_6:
    _InterlockedOr((volatile signed __int32 *)(a1 + 1040), 0x20000u);
  ...
  *((_WORD *)PoolWithTag + 9) = a3;
  memmove(PoolWithTag + 5, a2, a3);
  _InterlockedOr((volatile signed __int32 *)(a1 + 1036), 0x20000u);
