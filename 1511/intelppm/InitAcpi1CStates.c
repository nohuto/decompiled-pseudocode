/*
 * XREFs of InitAcpi1CStates @ 0x1C00207EC
 * Callers:
...
__int64 __fastcall InitAcpi1CStates(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 240) |= v1 & 7;
  ...
  if ( (v1 & 2) != 0
    ...
    && IsValidAcpiGenericAddress((unsigned __int8 *)(a1 + 168))
    && dword_1C000DD04 == v6 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1032), v6);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1036), v6);
    v6 = 2;
    v4 = 1;
  }
  if ( (*(_BYTE *)(a1 + 248) & 4) != 0
    && (unsigned __int16)word_1C000E3E2 <= 0x3E8u
  ...
  if ( PoolWithTag )
  {
    ...
    *((_WORD *)v9 + 9) = 0;
    ...
    {
      LOBYTE(v9[5 * v10 + 4]) = 3;
      HIWORD(v9[5 * *v9 + 4]) = word_1C000E3E2;
      v9[5 * *v9 + 5] = 0;
      if ( *(_DWORD *)(a1 + 172) != -5 )
      {
        LOBYTE(v9[5 * *v9 + 1]) = 1;
