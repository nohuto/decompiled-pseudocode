/*
 * XREFs of PepNotifyReportCStates @ 0x1C00212EC
 * Callers:
 ...
 *     PepTranslateCstState @ 0x1C0021554 (PepTranslateCstState.c)
 */
...
__int64 __fastcall PepNotifyReportCStates(__int64 a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    v12 = P;
    v8 = PoFxProcessorNotification(*(_QWORD *)(a1 + 1048), 15LL, &v14);
    if ( v12 )
