/*
 * XREFs of CapLogWorker @ 0x1C001DD60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CapLogWorker(PDEVICE_OBJECT DeviceObject, char *Context)
{
  ...
  v7 = *(_DWORD *)(v2 + 688) - *(_DWORD *)(v3 + 136);
  v8 = *(_DWORD *)(v2 + 692) - *(_DWORD *)(v3 + 140);
  v9 = *(_DWORD *)(v2 + 696) - *(_DWORD *)(v3 + 144);
  if ( v6 != *(_QWORD *)(v3 + 128) || v7 || v8 || v9 )
  {
    ProcLibTraceCap(v2, (v6 - *(_QWORD *)(v3 + 128)) / 10000000, v7, v8, v9, *((PCEVENT_DESCRIPTOR *)Context + 2));
    *(_QWORD *)(v3 + 128) = v6;
    *(_DWORD *)(v3 + 136) = *(_DWORD *)(v2 + 688);
    *(_DWORD *)(v3 + 140) = *(_DWORD *)(v2 + 692);
    *(_DWORD *)(v3 + 144) = *(_DWORD *)(v2 + 696);
  }
  else
  {
