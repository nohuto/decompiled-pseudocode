/*
 * XREFs of DecodeAcpiPStates @ 0x1C001E014
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  *a6 = 0;
  ...
  {
    if ( (v14 & 0x40000000) != 0 && *(_DWORD *)(a1 + 364) )
    {
      *a2 = *a2 & 0xFFFFFFFFFFFFFLL | 0x10000000000000LL;
      *(_DWORD *)a2 = *(_DWORD *)(a1 + 364);
      if ( *(_BYTE *)(a1 + 372) == 127 && *(_DWORD *)(a1 + 376) )
      {
        *a3 = *a3 & 0xFFFFFFFFFFFFFLL | 0x10000000000000LL;
        *(_DWORD *)a3 = *(_DWORD *)(a1 + 376);
      }
    }
    else if ( (v14 & 0x20000000) != 0 && dword_1C000DEC0 )
    {
      *a2 = *a2 & 0xFFFFFFFFFFFFFLL | 0x10000000000000LL;
      *(_DWORD *)a2 = dword_1C000DEC0;
      *a4 = qword_1C000DEC8;
    }
  }
  else if ( v13 == 1 && (*(_DWORD *)(a1 + 248) & 0x10000000) != 0 )
  {
    if ( *(_DWORD *)(a1 + 364) )
    {
      ...
      {
        if ( *(_DWORD *)(a1 + 376) )
          DecodeControlStatusRegisterIo(a1 + 372, 0, v8, (_DWORD)a5, (__int64)a7);
      }
    }
  }
  if ( *a2 )
