/*
 * XREFs of CpcNotifyWorker @ 0x1C001B308
 * Callers:
 *     AcpiCPCNotifyWorker @ 0x1C001B300 (AcpiCPCNotifyWorker.c)
 * Callees:
    ...
    if ( v5 )
    {
      ...
      if ( *(_BYTE *)(v5 + 85) )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
          ...
          0LL);
        if ( !*(_BYTE *)(v5 + 87)
          || (*(int (__fastcall **)(_QWORD))(qword_1C000E1A8 + 88))(*(_QWORD *)(qword_1C000E1A8 + 56)) >= 0
          && (*(int (__fastcall **)(_QWORD, _QWORD))(qword_1C000E1A8 + 104))(*(_QWORD *)(qword_1C000E1A8 + 56), 0LL) >= 0 )
        {
          ...
          *(_DWORD *)(v5 + 72) = v10;
          if ( (_DWORD)v10 != *(_DWORD *)(v3 + 668) )
          {
            ...
            ((void (__fastcall *)(__int64))qword_1C000E050)(v3);
          }
