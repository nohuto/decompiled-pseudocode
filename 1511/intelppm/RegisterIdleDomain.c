/*
 * XREFs of RegisterIdleDomain @ 0x1C001F51C
 * Callers:
...
bool __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  v5 = 3LL * a2;
  v6 = qword_1C000DD48;
  if ( (__int64 *)qword_1C000DD48 == &qword_1C000DD48 )
    goto LABEL_5;
  do
  {
    v7 = v6;
  ...
  while ( (__int64 *)v6 != &qword_1C000DD48 );
  if ( !v7 )
  {
LABEL_5:
    ...
    *(_QWORD *)(v7 + 24) = v7 + 16;
    *(_QWORD *)(v7 + 16) = v7 + 16;
    v9 = (__int64 **)qword_1C000DD50;
    *(_QWORD *)v7 = &qword_1C000DD48;
    *(_QWORD *)(v7 + 8) = v9;
    if ( *v9 != &qword_1C000DD48 )
      __fastfail(3u);
    *v9 = (__int64 *)v7;
    qword_1C000DD50 = v7;
