 ...
 *     ?FxStubDriverEntryFailure@@YAXXZ @ 0x1C0020260 (-FxStubDriverEntryFailure@@YAXXZ.c)
 *     ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C0052990 (-FxStubDriverUnloadCommon@@YAXXZ.c)
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_1C0064BD0;
