/*
 * XREFs of Crashdump_Command_SendCommand @ 0x1C004EBCC
 * Callers:
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C004EF34 (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x1C004F888 (Crashdump_Endpoint_SetDequeuePointer.c)
 *     Crashdump_Endpoint_StopEndpoint @ 0x1C004F954 (Crashdump_Endpoint_StopEndpoint.c)
 *     Crashdump_UsbDevice_ConfigureEndpoints @ 0x1C004FF34 (Crashdump_UsbDevice_ConfigureEndpoints.c)
 *     Crashdump_UsbDevice_ConfigureEndpointsForSaveState @ 0x1C00501A0 (Crashdump_UsbDevice_ConfigureEndpointsForSaveState.c)
 *     Crashdump_UsbDevice_SendAddressDeviceCommand @ 0x1C0050C80 (Crashdump_UsbDevice_SendAddressDeviceCommand.c)
 *     Crashdump_UsbDevice_SendEnableSlotCommand @ 0x1C0050EFC (Crashdump_UsbDevice_SendEnableSlotCommand.c)
 *     Crashdump_UsbDevice_SendResetDeviceCommand @ 0x1C0050FB8 (Crashdump_UsbDevice_SendResetDeviceCommand.c)
 * Callees:
 *     Crashdump_EventRing_Poll @ 0x1C004E540 (Crashdump_EventRing_Poll.c)
 */
