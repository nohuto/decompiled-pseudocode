/*
 * XREFs of Crashdump_Endpoint_SendControlTransfer @ 0x1C004F564
 * Callers:
 *     Crashdump_SendUrb @ 0x1C004CF00 (Crashdump_SendUrb.c)
 *     Crashdump_SendUrbAsync @ 0x1C004CFF0 (Crashdump_SendUrbAsync.c)
 *     Crashdump_UsbDevice_ChangePortFeature @ 0x1C004FAA8 (Crashdump_UsbDevice_ChangePortFeature.c)
 *     Crashdump_UsbDevice_Configure @ 0x1C004FC74 (Crashdump_UsbDevice_Configure.c)
 ...
 *     Crashdump_UsbDevice_SuspendPort @ 0x1C0051138 (Crashdump_UsbDevice_SuspendPort.c)
 * Callees:
 *     Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x1C004F748 (Crashdump_Endpoint_SendTransferAndPollForCompletion.c)
 */
