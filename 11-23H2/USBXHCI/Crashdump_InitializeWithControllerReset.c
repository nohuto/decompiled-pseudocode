/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x1C004C8A8
 * Callers:
 *     Crashdump_Initialize @ 0x1C004C390 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_LogRHPortInfo @ 0x1C004D904 (Crashdump_Register_LogRHPortInfo.c)
 *     Crashdump_Register_ResetController @ 0x1C004DAE0 (Crashdump_Register_ResetController.c)
 *     Crashdump_Register_ResetPort @ 0x1C004DBB0 (Crashdump_Register_ResetPort.c)
 *     Crashdump_Register_StartController @ 0x1C004DF94 (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x1C004E128 (Crashdump_Register_UpdateDeviceSlotInfo.c)
