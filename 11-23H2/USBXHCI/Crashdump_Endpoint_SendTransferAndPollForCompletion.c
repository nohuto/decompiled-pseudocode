/*
 * XREFs of Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x1C004F748
 * Callers:
 *     Crashdump_Endpoint_SendBulkTransfer @ 0x1C004F258 (Crashdump_Endpoint_SendBulkTransfer.c)
