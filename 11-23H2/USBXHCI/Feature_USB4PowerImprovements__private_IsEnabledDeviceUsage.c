/*
 * XREFs of Feature_USB4PowerImprovements__private_IsEnabledDeviceUsage @ 0x1C001F77C
 * Callers:
 *     UsbDevice_UpdateUsbDevice @ 0x1C001D43C (UsbDevice_UpdateUsbDevice.c)
 *     RootHub_IsDeviceNative @ 0x1C001F7D0 (RootHub_IsDeviceNative.c)
 *     RootHub_PrepareHardware @ 0x1C00706C0 (RootHub_PrepareHardware.c)
 * Callees:
 *     Feature_USB4PowerImprovements__private_IsEnabledFallback @ 0x1C001F7B4 (Feature_USB4PowerImprovements__private_IsEnabledFallback.c)
 */
