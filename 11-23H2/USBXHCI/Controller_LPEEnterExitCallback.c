/*
 * XREFs of Controller_LPEEnterExitCallback @ 0x1C0034300
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_q @ 0x1C00142CC (WPP_RECORDER_SF_q.c)
 *     Controller_InUseByDebugger @ 0x1C001C410 (Controller_InUseByDebugger.c)
 *     Controller_AcquireWdfPowerReferenceForDebugger @ 0x1C0032570 (Controller_AcquireWdfPowerReferenceForDebugger.c)
