/*
 * XREFs of TR_EnableForwardProgress_Internal @ 0x1C0041644
 * Callers:
 *     Endpoint_UcxEvtEndpointEnableForwardProgress @ 0x1C003C760 (Endpoint_UcxEvtEndpointEnableForwardProgress.c)
 * Callees:
