/*
 * XREFs of UsbDevice_EvtUsbDeviceCleanupCallback @ 0x1C0048CF0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00203A0 (_guard_dispatch_icall_nop.c)
 *     Controller_RemoveDeviceFromControllerDeviceList @ 0x1C00346C0 (Controller_RemoveDeviceFromControllerDeviceList.c)
 *     XilUsbDevice_DestroySecureObject @ 0x1C0048108 (XilUsbDevice_DestroySecureObject.c)
 *     XilUsbDevice_FreeResources @ 0x1C004818C (XilUsbDevice_FreeResources.c)
 *     WPP_RECORDER_SF_dqqq @ 0x1C004A790 (WPP_RECORDER_SF_dqqq.c)
