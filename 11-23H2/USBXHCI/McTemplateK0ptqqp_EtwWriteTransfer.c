/*
 * XREFs of McTemplateK0ptqqp_EtwWriteTransfer @ 0x1C00370D8
 * Callers:
...
NTSTATUS McTemplateK0ptqqp_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &USBXHCI_ETW_EVENT_START_TRACKING_FOR_TIME_SYNC, 0LL, 6u, &v4);
}
