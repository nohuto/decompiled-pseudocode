/*
 * XREFs of Crashdump_ResetDevice @ 0x1C004CD80
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_Register_ResetPort @ 0x1C004DBB0 (Crashdump_Register_ResetPort.c)
 *     Crashdump_UsbDevice_GetPortType @ 0x1C00505C4 (Crashdump_UsbDevice_GetPortType.c)
