/*
 * XREFs of Controller_RemoveControllerFromGlobalControllerList @ 0x1C00345F4
 * Callers:
 *     Controller_WdfEvtCleanupCallback @ 0x1C0036660 (Controller_WdfEvtCleanupCallback.c)
 * Callees:
