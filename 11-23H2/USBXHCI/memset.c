 ...
 *     CommonBuffer_AcquireSecureBuffer @ 0x1C00321F8 (CommonBuffer_AcquireSecureBuffer.c)
 *     DeviceSlot_ControllerResetPostReset @ 0x1C0037C10 (DeviceSlot_ControllerResetPostReset.c)
 ...
 *     Endpoint_OnResetSetDequeuePointer @ 0x1C003B68C (Endpoint_OnResetSetDequeuePointer.c)
 *     Endpoint_SM_ResetControlEndpoint @ 0x1C003BB2C (Endpoint_SM_ResetControlEndpoint.c)
 *     Endpoint_SM_ResetEndpoint @ 0x1C003BBD8 (Endpoint_SM_ResetEndpoint.c)
 *     Endpoint_SendClearStallTransfer @ 0x1C003BEAC (Endpoint_SendClearStallTransfer.c)
 *     Endpoint_SetUpConfigureEndpointCommand @ 0x1C003C1A8 (Endpoint_SetUpConfigureEndpointCommand.c)
 ...
 *     UsbDevice_ReconfigureEndpoint @ 0x1C004962C (UsbDevice_ReconfigureEndpoint.c)
 *     UsbDevice_SendStopEndpointToOffloadedEndpoint @ 0x1C0049A54 (UsbDevice_SendStopEndpointToOffloadedEndpoint.c)
 *     UsbDevice_SetResourceAssignment @ 0x1C0049AFC (UsbDevice_SetResourceAssignment.c)
 *     UsbDevice_UcxEvtDisable @ 0x1C0049DC0 (UsbDevice_UcxEvtDisable.c)
 *     Crashdump_Initialize @ 0x1C004C390 (Crashdump_Initialize.c)
 *     Crashdump_EventRing_PrepareForDump @ 0x1C004E830 (Crashdump_EventRing_PrepareForDump.c)
 *     Crashdump_Command_PrepareForDump @ 0x1C004EAB8 (Crashdump_Command_PrepareForDump.c)
 *     Crashdump_Endpoint_PrepareForHibernate @ 0x1C004F190 (Crashdump_Endpoint_PrepareForHibernate.c)
 *     Crashdump_UsbDevice_Cleanup @ 0x1C004FB60 (Crashdump_UsbDevice_Cleanup.c)
 *     Crashdump_UsbDevice_ConfigureEndpoints @ 0x1C004FF34 (Crashdump_UsbDevice_ConfigureEndpoints.c)
 *     Crashdump_UsbDevice_GetDeviceDescriptor @ 0x1C0050294 (Crashdump_UsbDevice_GetDeviceDescriptor.c)
 *     Crashdump_UsbDevice_GetPortStatus @ 0x1C0050428 (Crashdump_UsbDevice_GetPortStatus.c)
 *     Crashdump_UsbDevice_PrepareForHibernate @ 0x1C0050720 (Crashdump_UsbDevice_PrepareForHibernate.c)
 *     Crashdump_UsbDevice_SendAddressDeviceCommand @ 0x1C0050C80 (Crashdump_UsbDevice_SendAddressDeviceCommand.c)
 *     TelemetryData_CreateReport @ 0x1C00530AC (TelemetryData_CreateReport.c)
 *     WerKernelSubmitReport @ 0x1C0054120 (WerKernelSubmitReport.c)
