/*
 * XREFs of Endpoint_EvtEndpointCleanupCallback @ 0x1C003A560
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00203A0 (_guard_dispatch_icall_nop.c)
 *     XilEndpoint_DestroySecureObject @ 0x1C00390A8 (XilEndpoint_DestroySecureObject.c)
 *     XilEndpoint_FreeResources @ 0x1C0039184 (XilEndpoint_FreeResources.c)
 *     XilEndpoint_ReleaseBuffer @ 0x1C0039274 (XilEndpoint_ReleaseBuffer.c)
 *     WPP_RECORDER_SF_ddqqq @ 0x1C003DB84 (WPP_RECORDER_SF_ddqqq.c)
 *     UsbDevice_RemoveEndpointFromDeviceEndpointList @ 0x1C0049964 (UsbDevice_RemoveEndpointFromDeviceEndpointList.c)
 *     Etw_EndpointDelete @ 0x1C004ACC0 (Etw_EndpointDelete.c)
 */
