 ...
 *     Feature_SecureUSBDeviceFirmwareHashCheck__private_ReportDeviceUsage @ 0x1C001F92C (Feature_SecureUSBDeviceFirmwareHashCheck__private_ReportDeviceUsage.c)
 *     _guard_dispatch_icall_nop @ 0x1C00203A0 (_guard_dispatch_icall_nop.c)
 *     WPP_RECORDER_SF_DDi @ 0x1C00420BC (WPP_RECORDER_SF_DDi.c)
 *     Isoch_GetPacketLength @ 0x1C00445F8 (Isoch_GetPacketLength.c)
 *     Isoch_Stage_Acquire @ 0x1C0045248 (Isoch_Stage_Acquire.c)
 *     Isoch_TransferUrb_MarkLatePackets @ 0x1C0045404 (Isoch_TransferUrb_MarkLatePackets.c)
