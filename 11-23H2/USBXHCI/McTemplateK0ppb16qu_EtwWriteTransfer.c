/*
 * XREFs of McTemplateK0ppb16qu_EtwWriteTransfer @ 0x1C004AF0C
 * Callers:
 *     Command_HandleCommandCompletionEvent @ 0x1C000A2B4 (Command_HandleCommandCompletionEvent.c)
 *     Etw_CommandCompleteError @ 0x1C004A8A8 (Etw_CommandCompleteError.c)
 * Callees:
...
NTSTATUS McTemplateK0ppb16qu_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 1LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, 0LL, 6u, &v4);
}
