/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C001F398
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C001F4EC (wil_details_GetCurrentFeatureEnabledState.c)
