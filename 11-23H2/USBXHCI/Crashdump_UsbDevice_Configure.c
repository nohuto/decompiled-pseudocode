/*
 * XREFs of Crashdump_UsbDevice_Configure @ 0x1C004FC74
 * Callers:
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C005082C (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C0050980 (Crashdump_UsbDevice_ReConfigureOnPortReset.c)
 * Callees:
 *     Crashdump_Endpoint_SendControlTransfer @ 0x1C004F564 (Crashdump_Endpoint_SendControlTransfer.c)
