/*
 * XREFs of Controller_IsHandlePresentInCollection @ 0x1C0034170
 * Callers:
 ...
 *     Controller_IsHandlePresentInCollectionLocked @ 0x1C00341C0 (Controller_IsHandlePresentInCollectionLocked.c)
 */
