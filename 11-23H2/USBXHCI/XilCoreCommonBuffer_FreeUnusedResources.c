/*
 * XREFs of XilCoreCommonBuffer_FreeUnusedResources @ 0x1C0052DA8
 * Callers:
 *     Controller_WdfEvtWatchdogTimerFunc @ 0x1C0004FE0 (Controller_WdfEvtWatchdogTimerFunc.c)
 *     CommonBuffer_RebalanceResourcesWorkItem @ 0x1C0032360 (CommonBuffer_RebalanceResourcesWorkItem.c)
 * Callees:
