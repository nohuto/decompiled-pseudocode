/*
 * XREFs of wil_details_EvaluateFeatureDependencies @ 0x1C006D0A8
 * Callers:
 *     wil_details_ReevaluateOnFeatureConfigurationChange @ 0x1C006D260 (wil_details_ReevaluateOnFeatureConfigurationChange.c)
 *     wil_InitializeFeatureStaging @ 0x1C007E03C (wil_InitializeFeatureStaging.c)
 * Callees:
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x1C001EDD0 (wil_details_FeatureDescriptors_SkipPadding.c)
 *     wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState @ 0x1C006D15C (wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState.c)
 */
