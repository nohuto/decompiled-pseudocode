/*
 * XREFs of Crashdump_EventRing_AsyncPoll @ 0x1C004E1D0
 * Callers:
 *     Crashdump_PollForCompletion @ 0x1C004CCD0 (Crashdump_PollForCompletion.c)
 * Callees:
 *     Crashdump_EventRing_UpdateDequeuePointer @ 0x1C004EA3C (Crashdump_EventRing_UpdateDequeuePointer.c)
 */
