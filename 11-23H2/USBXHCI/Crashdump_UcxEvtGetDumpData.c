/*
 * XREFs of Crashdump_UcxEvtGetDumpData @ 0x1C004D240
 * Callers:
 *     <none>
 * Callees:
 ...
 *     memmove @ 0x1C0020440 (memmove.c)
 *     Crashdump_CommonBufferAcquire @ 0x1C004C0F8 (Crashdump_CommonBufferAcquire.c)
 *     Crashdump_FreeDeviceContext @ 0x1C004C340 (Crashdump_FreeDeviceContext.c)
 *     Crashdump_InitializeDeviceContext @ 0x1C004C6C4 (Crashdump_InitializeDeviceContext.c)
 *     Crashdump_Register_Initialize @ 0x1C004D898 (Crashdump_Register_Initialize.c)
 *     Crashdump_EventRing_InitializeForDump @ 0x1C004E4AC (Crashdump_EventRing_InitializeForDump.c)
 */
