/*
 * XREFs of UsbDevice_HandleSendStopEndpointToOffloadedEndpointsState @ 0x1C00492C4
 * Callers:
 ...
 *     UsbDevice_NumberOfOffloadedEndpointsInDropEndpointsList @ 0x1C0049598 (UsbDevice_NumberOfOffloadedEndpointsInDropEndpointsList.c)
