/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x1C004CACC
 * Callers:
 *     Crashdump_Initialize @ 0x1C004C390 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_PrepareForHibernate @ 0x1C004DA54 (Crashdump_Register_PrepareForHibernate.c)
 *     Crashdump_EventRing_PrepareForHibernate @ 0x1C004E94C (Crashdump_EventRing_PrepareForHibernate.c)
