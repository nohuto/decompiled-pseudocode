/*
 * XREFs of XilRegister_ReadUlong64 @ 0x1C003F378
 * Callers:
 *     Interrupter_DeInitializeAfterOffload @ 0x1C003DD2C (Interrupter_DeInitializeAfterOffload.c)
 *     XilCoreCommand_AbortCommandRing @ 0x1C0052AC0 (XilCoreCommand_AbortCommandRing.c)
 *     XilCoreCommand_QueryIsRingRunning @ 0x1C0052B5C (XilCoreCommand_QueryIsRingRunning.c)
 * Callees:
