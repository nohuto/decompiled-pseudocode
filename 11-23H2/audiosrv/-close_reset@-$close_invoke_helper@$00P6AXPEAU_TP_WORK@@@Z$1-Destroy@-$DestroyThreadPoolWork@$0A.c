/*
 * XREFs of ?close_reset@?$close_invoke_helper@$00P6AXPEAU_TP_WORK@@@Z$1?Destroy@?$DestroyThreadPoolWork@$0A@@details@wil@@SAX0@ZPEAU1@@details@wil@@SAXPEAU_TP_WORK@@@Z @ 0x18010E7EC
 * Callers:
