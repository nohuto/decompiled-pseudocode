/*
 * XREFs of ?GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ @ 0x180166A04
 * Callers:
 ...
 * Callees:
 *     ?GetSupportedVolumeSteppingForKsTopology@@YAJAEBU_GUID@@KPEAUIKsControl@@PEAUKSPROPERTY_STEPPING_LONG@@@Z @ 0x180166A4C (-GetSupportedVolumeSteppingForKsTopology@@YAJAEBU_GUID@@KPEAUIKsControl@@PEAUKSPROPERTY_STEPPING.c)
 */
