/*
 * XREFs of ?OnSaDeviceDestroyed@CBtAudioResourceManagerBase@@UEAAXW4AUDIO_DIRECTION@@PEAUSaDeviceParams@@@Z @ 0x1800F9990
 * Callers:
 *     ?OnSaDeviceDestroyed@CBtLeAudioResourceManager@@UEAAXW4AUDIO_DIRECTION@@PEAUSaDeviceParams@@@Z @ 0x1800FBA50 (-OnSaDeviceDestroyed@CBtLeAudioResourceManager@@UEAAXW4AUDIO_DIRECTION@@PEAUSaDeviceParams@@@Z.c)
 * Callees:
