/*
 * XREFs of ?CreateInstance@TelephonyControllerCallInstance@@SAJPEA_KPEAUIKsControl@@PEAU_TelephonyInstanceData@@PEAPEAUITelephonyControllerCallInstance@@@Z @ 0x18016802C
 * Callers:
 ...
 *     ?ResetState@TelephonyControllerCallInstance@@AEAAJXZ @ 0x18016852C (-ResetState@TelephonyControllerCallInstance@@AEAAJXZ.c)
