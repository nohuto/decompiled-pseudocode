/*
 * XREFs of std::_Func_impl_no_alloc__lambda_a94dfcfc08a8b17bb98eae0a275e2f1b__void_::_Copy @ 0x180083AA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc__lambda_a94dfcfc08a8b17bb98eae0a275e2f1b__void_::_Copy(
        __int64 a1,
        _QWORD *a2)
{
  __int64 v2; // r8
