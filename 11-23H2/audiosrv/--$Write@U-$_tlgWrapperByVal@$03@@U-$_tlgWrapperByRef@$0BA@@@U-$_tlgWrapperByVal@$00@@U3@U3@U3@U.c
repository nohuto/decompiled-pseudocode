        ...
        const WCHAR **a18)
{
  ...
  const WCHAR *v53; // [rsp+120h] [rbp+20h]
  ...
  v32 = 1LL;
  v28 = 4LL;
  return tlgWriteTransfer_EtwEventWriteTransfer(a1, a2, 0LL, 0LL, 16, (__int64)v26);
}
