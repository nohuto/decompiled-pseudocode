/*
 * XREFs of AudioServerTelephonyControlGetMaxCallInstanceCount @ 0x180125990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlGetMaxCallInstanceCount(__int64 a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    pftDueTime);
  LODWORD(pftDueTime) = ((__int64 (__fastcall *)(struct IUnknown *, __int64))g_TelephonyControl->lpVtbl[5].AddRef)(
                          g_TelephonyControl,
                          a2);
