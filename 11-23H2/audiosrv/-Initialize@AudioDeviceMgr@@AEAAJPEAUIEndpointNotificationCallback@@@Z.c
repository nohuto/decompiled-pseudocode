/*
 * XREFs of ?Initialize@AudioDeviceMgr@@AEAAJPEAUIEndpointNotificationCallback@@@Z @ 0x18005AB64
 * Callers:
 ...
 *     ?CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ @ 0x18005B404 (-CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ.c)
