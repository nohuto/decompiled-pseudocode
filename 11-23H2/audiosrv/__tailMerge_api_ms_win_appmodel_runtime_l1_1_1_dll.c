/*
 * XREFs of __tailMerge_api_ms_win_appmodel_runtime_l1_1_1_dll @ 0x18006A831
 * Callers:
 *     __imp_load_GetStagedPackageOrigin @ 0x18006A825 (__imp_load_GetStagedPackageOrigin.c)
 * Callees:
