/*
 * XREFs of ?LogExclusiveModeListenerUpdateSessionState@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@HH@Z @ 0x18013A1D8
 * Callers:
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_1801CD178 > 5 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_1801950B2,
      0LL,
      0LL,
      5u,
      &v6);
