/*
 * XREFs of ??1?$ComPtr@UIPackageCatalog@ApplicationModel@Windows@@@WRL@Microsoft@@QEAA@XZ @ 0x180159E0C
 * Callers:
 *     _AtmosCheck::AtmosCheck_::_1_::dtor$1 @ 0x18007D492 (_AtmosCheck--AtmosCheck_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
