/*
 * XREFs of ??$MakeAndInitialize@VAvoidEndpointPolicyRule@@UIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Details@WRL@Microsoft@@YAJPEAPEAUIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Z @ 0x18013DD7C
 * Callers:
        ...
        struct _DynamicRoutingRule **a3)
{
  ...
  AvoidEndpointPolicyRule *v7; // rdi
  int v8; // ebx
  AvoidEndpointPolicyRule *v10; // [rsp+40h] [rbp+8h] BYREF
  AvoidEndpointPolicyRule *v11; // [rsp+58h] [rbp+20h] BYREF
