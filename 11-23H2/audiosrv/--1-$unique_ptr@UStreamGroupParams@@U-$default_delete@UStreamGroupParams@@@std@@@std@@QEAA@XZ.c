/*
 * XREFs of ??1?$unique_ptr@UStreamGroupParams@@U?$default_delete@UStreamGroupParams@@@std@@@std@@QEAA@XZ @ 0x1800D8694
 * Callers:
 ...
 *     _DeriveStreamGroupParametersForStream_::_1_::dtor$4 @ 0x18007905D (_DeriveStreamGroupParametersForStream_--_1_--dtor$4.c)
 *     _StreamGroupParams::Clone_::_1_::dtor$3 @ 0x180079082 (_StreamGroupParams--Clone_--_1_--dtor$3.c)
 *     _BuildDeviceGraphForStream_::_1_::dtor$0 @ 0x18007C31A (_BuildDeviceGraphForStream_--_1_--dtor$0.c)
 ...
 *     _CAudioResourceManager::CreateInternalLoopbackStream_::_1_::dtor$10 @ 0x1800DA8C6 (_CAudioResourceManager--CreateInternalLoopbackStream_--_1_--dtor$10.c)
 * Callees:
