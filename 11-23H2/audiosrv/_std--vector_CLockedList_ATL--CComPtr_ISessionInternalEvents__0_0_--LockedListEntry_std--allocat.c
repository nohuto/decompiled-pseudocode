/*
 * XREFs of _std::vector_CLockedList_ATL::CComPtr_ISessionInternalEvents__0_0_::LockedListEntry_std::allocator_CLockedList_ATL::CComPtr_ISessionInternalEvents__0_0_::LockedListEntry___::_Emplace_reallocate_ATL::CComPtr_ISessionInternalEvents__&_int__::_1_::catch$0 @ 0x18007BFBF
 * Callers:
 *     <none>
 * Callees:
