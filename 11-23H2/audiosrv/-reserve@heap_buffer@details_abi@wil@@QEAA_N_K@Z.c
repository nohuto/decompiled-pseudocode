/*
 * XREFs of ?reserve@heap_buffer@details_abi@wil@@QEAA_N_K@Z @ 0x18005FB48
 * Callers:
 ...
 *     ??0last_error_context@wil@@QEAA@XZ @ 0x1800CC4BC (--0last_error_context@wil@@QEAA@XZ.c)
 *     ??1last_error_context@wil@@QEAA@XZ @ 0x1800CC6CC (--1last_error_context@wil@@QEAA@XZ.c)
 */
