/*
 * XREFs of ?InitializePnpInfo@@YAHXZ @ 0x180056F04
 * Callers:
...
__int64 InitializePnpInfo(void)
{
  ...
  _SECURITY_ATTRIBUTES FileMappingAttributes; // [rsp+38h] [rbp-40h] BYREF
        ...
        if ( v9 )
        {
          ...
          *v9 = 12;
            ...
            && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
          {
            v13 = 20LL;
LABEL_38:
            WPP_SF_(*((_QWORD *)v12 + 2), v13, &WPP_ea4dc79131a5388790567eb319c308bd_Traceguids);
          }
        }
        else
        {
