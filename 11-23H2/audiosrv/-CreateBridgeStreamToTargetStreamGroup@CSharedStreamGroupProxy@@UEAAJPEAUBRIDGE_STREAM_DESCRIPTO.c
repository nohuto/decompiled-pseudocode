/*
 * XREFs of ?CreateBridgeStreamToTargetStreamGroup@CSharedStreamGroupProxy@@UEAAJPEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIStreamGroupProxy@@PEAUSystemAudioStream@@@Z @ 0x1801062E0
 * Callers:
 *     <none>
 * Callees:
