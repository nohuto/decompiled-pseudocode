/*
 * XREFs of ??1?$forward_list@V?$com_ptr_t@VCEndpointStore@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCEndpointStore@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x18010EEE0
 * Callers:
 ...
 *     _CEndpointStoreCache::ForEachEndpoint_::_1_::dtor$0 @ 0x18007A4C3 (_CEndpointStoreCache--ForEachEndpoint_--_1_--dtor$0.c)
 *     _CEndpointStoreCache::FindFirstEndpoint_::_1_::dtor$0 @ 0x18010F4AD (_CEndpointStoreCache--FindFirstEndpoint_--_1_--dtor$0.c)
 * Callees:
