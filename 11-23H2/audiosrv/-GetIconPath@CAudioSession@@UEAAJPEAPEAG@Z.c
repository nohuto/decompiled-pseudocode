/*
 * XREFs of ?GetIconPath@CAudioSession@@UEAAJPEAPEAG@Z @ 0x1800E0000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetIconPath(CAudioSession *this, unsigned __int16 **a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_bb8c20e8cc9f3f3c48250634c7540f80_Traceguids, v5);
  }
