/*
 * XREFs of ?ProcessAwayModeStateChange@CAudioSrv@@AEAAKE@Z @ 0x1800EFDFC
 * Callers:
          ...
          else
          {
            ...
            if ( (*(int (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v19 + 32LL))(v19, 2LL, &v11) >= 0 )
            {
              *(_OWORD *)pvar = 0LL;
              ...
              else if ( (*(int (__fastcall **)(__int64, int *))(*(_QWORD *)v12 + 152LL))(v12, &v17) >= 0 )
              {
                ...
                if ( (_BYTE)v2 )
                {
                  ...
                  v8 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v11 + 48LL))(
                         ...
                         pvar);
                  if ( v8 < 0 )
                    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessAwayModeStateChange", 1401, v8);
                }
                else
                {
                ...
                if ( v17 != v6 )
                {
                  v9 = (*(__int64 (__fastcall **)(__int64, _QWORD, void *, _QWORD))(*(_QWORD *)v12 + 144LL))(
                         ...
                         0LL);
                  if ( v9 < 0 )
                    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessAwayModeStateChange", 1424, v9);
                }
              }
            }
          }
