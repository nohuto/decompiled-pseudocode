/*
 * XREFs of ??0CExclusiveModeListener@@QEAA@XZ @ 0x180133420
 * Callers:
 ...
 *     ??0CSpatialAudioResourceManagerTraceLogger@@QEAA@XZ @ 0x180062A98 (--0CSpatialAudioResourceManagerTraceLogger@@QEAA@XZ.c)
