/*
 * XREFs of ?PersistMuteState@CMuteSoftware@@AEAAXXZ @ 0x18011112C
 * Callers:
 *     ?ProviderFinalRelease@CMuteSoftware@@UEAAXXZ @ 0x1801113B0 (-ProviderFinalRelease@CMuteSoftware@@UEAAXXZ.c)
 *     std::_Func_impl_no_alloc__lambda_9b74c3d0faed76deb923d29084677877__void_::_Do_call @ 0x1801118D0 (std--_Func_impl_no_alloc__lambda_9b74c3d0faed76deb923d29084677877__void_--_Do_call.c)
 * Callees:
 *     ??1?$com_ptr_t@UIAudioChannelConfig@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x180005738 (--1-$com_ptr_t@UIAudioChannelConfig@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ.c)
 *     ?_Log_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180009588 (-_Log_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x1800759F0 (_guard_xfg_dispatch_icall_nop.c)
 *     WPP_SF_S @ 0x1800DDDDC (WPP_SF_S.c)
 *     WPP_SF_Sl @ 0x1801118E0 (WPP_SF_Sl.c)
 */
