/*
 * XREFs of _CAudioSession::Disconnect_::_1_::catch$48 @ 0x18007C99F
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::Disconnect_::_1_::catch_48(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
