/*
 * XREFs of ?TraceResult@AtmosCheck@@AEAAXJ_N@Z @ 0x18015DA34
 * Callers:
...
void __fastcall AtmosCheck::TraceResult(AtmosCheck *this, int a2, __int64 a3)
{
  ...
  const CHAR *v16[2]; // [rsp+60h] [rbp-10h] BYREF
  int v17; // [rsp+80h] [rbp+10h] BYREF
  int v18; // [rsp+98h] [rbp+28h] BYREF

  v3 = "None";
  v6 = "None";
  v7 = (unsigned int)(*((_DWORD *)this + 46) - 1);
  if ( *((_DWORD *)this + 46) == 1 )
  {
    v3 = "Initialization";
  }
  ...
  {
    v7 = (unsigned int)(*((_DWORD *)this + 46) - 2);
    if ( *((_DWORD *)this + 46) == 2 )
    {
      v3 = "AppInstallation";
    }
    ...
    {
      v7 = (unsigned int)(*((_DWORD *)this + 46) - 3);
      if ( *((_DWORD *)this + 46) == 3 )
      {
      ...
      {
        v7 = (unsigned int)(*((_DWORD *)this + 46) - 4);
        if ( *((_DWORD *)this + 46) == 4 )
        {
          v3 = "AppUpdating";
        }
        ...
        {
          v7 = (unsigned int)(*((_DWORD *)this + 46) - 5);
          if ( *((_DWORD *)this + 46) == 5 )
          {
            v3 = "TimerCallback";
          }
          ...
          {
            v7 = (unsigned int)(*((_DWORD *)this + 46) - 6);
            if ( *((_DWORD *)this + 46) == 6 )
            {
            ...
            {
              v7 = (unsigned int)(*((_DWORD *)this + 46) - 7);
              if ( *((_DWORD *)this + 46) == 7 )
              {
