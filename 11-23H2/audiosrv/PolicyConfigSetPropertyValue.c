/*
 * XREFs of PolicyConfigSetPropertyValue @ 0x180053480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigSetPropertyValue(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, __int64 a5)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v7,
    (struct _TP_TIMER *)L"PolicyConfigSetPropertyValue",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(CPolicyConfig *, __int64, _QWORD, __int64, __int64))(*(_QWORD *)g_PolicyConfig + 96LL))(
                          g_PolicyConfig,
                          a2,
                          a3,
                          a4,
