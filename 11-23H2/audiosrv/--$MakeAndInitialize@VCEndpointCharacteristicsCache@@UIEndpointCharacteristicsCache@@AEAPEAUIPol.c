 ...
 * Callees:
 *     ??0CEndpointCharacteristicsCache@@QEAA@XZ @ 0x18006406C (--0CEndpointCharacteristicsCache@@QEAA@XZ.c)
 *     ?RuntimeClassInitialize@CEndpointCharacteristicsCache@@QEAAJPEAUIPolicyConfigInternal@@PEAVEffectPackConfigurationManager@@PEAUIEndpointResourceManagerProvider@@PEBU_tlgProvider_t@@@Z @ 0x180064144 (-RuntimeClassInitialize@CEndpointCharacteristicsCache@@QEAAJPEAUIPolicyConfigInternal@@PEAVEffec.c)
