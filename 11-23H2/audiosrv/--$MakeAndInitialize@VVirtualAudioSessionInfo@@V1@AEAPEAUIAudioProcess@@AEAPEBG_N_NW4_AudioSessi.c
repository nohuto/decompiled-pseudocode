/*
 * XREFs of ??$MakeAndInitialize@VVirtualAudioSessionInfo@@V1@AEAPEAUIAudioProcess@@AEAPEBG_N_NW4_AudioSessionState@@@Details@WRL@Microsoft@@YAJPEAPEAVVirtualAudioSessionInfo@@AEAPEAUIAudioProcess@@AEAPEBG$$QEA_N3$$QEAW4_AudioSessionState@@@Z @ 0x180126394
 * Callers:
 ...
 *     ??0VirtualAudioSessionInfo@@QEAA@XZ @ 0x1801264B8 (--0VirtualAudioSessionInfo@@QEAA@XZ.c)
