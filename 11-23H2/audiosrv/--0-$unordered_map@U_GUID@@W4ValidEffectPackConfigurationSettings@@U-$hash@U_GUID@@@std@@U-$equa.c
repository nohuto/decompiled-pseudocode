/*
 * XREFs of ??0?$unordered_map@U_GUID@@W4ValidEffectPackConfigurationSettings@@U?$hash@U_GUID@@@std@@U?$equal_to@U_GUID@@@4@V?$allocator@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@@4@@std@@QEAA@V?$initializer_list@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@@1@@Z @ 0x1800538D8
 * Callers:
