/*
 * XREFs of ??1?$com_ptr_t@VCVADServer@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x18011C5D8
 * Callers:
 ...
 *     _AudioServerInitialize_Internal_::_1_::dtor$4 @ 0x18007C030 (_AudioServerInitialize_Internal_--_1_--dtor$4.c)
 * Callees:
