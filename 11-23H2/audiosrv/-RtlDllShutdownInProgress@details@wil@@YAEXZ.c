/*
 * XREFs of ?RtlDllShutdownInProgress@details@wil@@YAEXZ @ 0x18006AA30
 * Callers:
 *     <none>
 * Callees:
 *     ?wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ @ 0x18006AAFC (-wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ.c)
