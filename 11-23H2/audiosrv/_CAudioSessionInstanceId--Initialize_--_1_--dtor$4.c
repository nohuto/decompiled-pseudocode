/*
 * XREFs of _CAudioSessionInstanceId::Initialize_::_1_::dtor$4 @ 0x18007C70F
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionInstanceId::Initialize_::_1_::dtor_4(__int64 a1, __int64 a2)
{
