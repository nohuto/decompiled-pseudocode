/*
 * XREFs of ?AddSaDevice@CDeviceGraphObjectsStore@@UEAAJPEBUSaDeviceParams@@AEAVWeakRef@WRL@Microsoft@@@Z @ 0x1800498F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::WRL::WeakRef *a3)
{
  ...
  {
    std::vector<Microsoft::WRL::WeakRef>::_Emplace_reallocate<Microsoft::WRL::WeakRef const &>(v8, *v8, (__int64 *)a3);
  }
  else
  {
    v11 = *(_QWORD *)a3;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 15LL, &WPP_cde6b4e0c3b236ab5d448129360c4228_Traceguids, 0LL);
  }
  if ( v6 )
