/*
 * XREFs of ?AddStream@CBaseStreamGroupProxy@@IEAAJPEAUIAudioStreamInfo@@@Z @ 0x1801056AC
 * Callers:
...
__int64 __fastcall CBaseStreamGroupProxy::AddStream(CBaseStreamGroupProxy *this, struct IAudioStreamInfo *a2)
{
  ...
  try
  {
    ...
    if ( v5 == *((_BYTE **)this + 26) )
    {
      std::vector<IAudioStreamInfo *>::_Emplace_reallocate<IAudioStreamInfo * const &>((_QWORD *)this + 24, v5, &v16);
      v2 = v16;
    }
    else
    {
    ...
    v6 = *(_QWORD *)this;
    v15 = 0LL;
    (*(void (__fastcall **)(CBaseStreamGroupProxy *, __int64 *))(v6 + 80))(this, &v15);
    v7 = v15;
    v8 = *(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v15 + 240LL);
