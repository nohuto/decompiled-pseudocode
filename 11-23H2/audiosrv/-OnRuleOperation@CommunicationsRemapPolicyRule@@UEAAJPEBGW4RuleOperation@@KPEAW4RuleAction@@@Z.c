/*
 * XREFs of ?OnRuleOperation@CommunicationsRemapPolicyRule@@UEAAJPEBGW4RuleOperation@@KPEAW4RuleAction@@@Z @ 0x180142030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CommunicationsRemapPolicyRule::OnRuleOperation(__int64 a1, __int64 a2, int a3, int a4, _DWORD *a5)
{
  ...
  __int64 v10; // rdx
  LPVOID v11; // rbx
  __int64 (__fastcall *v12)(LPVOID, __int64, _DWORD **); // r14
  __int64 v14; // rcx
  __int64 v15; // rcx
...
LABEL_14:
    ...
    v11 = v25[0];
    v12 = *(__int64 (__fastcall **)(LPVOID, __int64, _DWORD **))(*(_QWORD *)v25[0] + 40LL);
    if ( a5 )
    ...
    if ( v17 )
    {
      (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v17 + 16LL))(v17, v27);
      v16 = v27;
    }
    if ( (int)CDefaultDeviceManager::GetDefaultEndpoint(v17, v16, *(_DWORD *)(a1 + 64), 0LL, &a5) >= 0
