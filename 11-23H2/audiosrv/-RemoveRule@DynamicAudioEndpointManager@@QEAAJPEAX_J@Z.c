/*
 * XREFs of ?RemoveRule@DynamicAudioEndpointManager@@QEAAJPEAX_J@Z @ 0x180140294
 * Callers:
 *     PolicyConfigRemoveDynamicRoutingRule @ 0x180118020 (PolicyConfigRemoveDynamicRoutingRule.c)
 * Callees:
