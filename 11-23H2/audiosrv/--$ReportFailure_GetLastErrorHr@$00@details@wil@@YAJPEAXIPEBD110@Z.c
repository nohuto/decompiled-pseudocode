/*
 * XREFs of ??$ReportFailure_GetLastErrorHr@$00@details@wil@@YAJPEAXIPEBD110@Z @ 0x1800CBE90
 * Callers:
        ...
        const char *a6)
{
  ...
  v19 = v17;
  v18 = v16;
  wil::details::ReportFailure_Base<1,0>(v8, v7, a3, v11, v14, (__int64)a6, (int)&v18, 0LL);
  return v10;
}
