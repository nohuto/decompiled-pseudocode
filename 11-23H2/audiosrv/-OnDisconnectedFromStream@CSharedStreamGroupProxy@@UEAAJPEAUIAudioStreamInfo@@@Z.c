/*
 * XREFs of ?OnDisconnectedFromStream@CSharedStreamGroupProxy@@UEAAJPEAUIAudioStreamInfo@@@Z @ 0x180108DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSharedStreamGroupProxy::OnDisconnectedFromStream(
        ...
        struct IAudioStreamInfo *a2)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v9 >= 0 )
    {
      v10 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(this + 80) + 104LL))(*(_QWORD *)(this + 80), v18);
      if ( v10 < 0 )
