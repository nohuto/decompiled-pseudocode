/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U?$_tlgWrapperByVal@$07@@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@AEBU?$_tlgWrapperByVal@$07@@44@Z @ 0x1800D7D48
 * Callers:
 *     ?CreateBridgeSourceStreamForMicInjection@CBridgeStreamInstanceProxy@@UEAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIStreamInstanceProxy@@PEAUSystemAudioStream@@@Z @ 0x180073700 (-CreateBridgeSourceStreamForMicInjection@CBridgeStreamInstanceProxy@@UEAAJPEAUSYSTEM_AUDIO_STREA.c)
        ...
        __int64 a8)
{
  ...
  v13 = 8LL;
  v11 = 4LL;
  return tlgWriteTransfer_EtwEventWriteTransfer(a1, a2, 0LL, 0LL, 6, (__int64)v9);
}
