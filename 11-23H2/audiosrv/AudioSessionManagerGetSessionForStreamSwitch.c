/*
 * XREFs of AudioSessionManagerGetSessionForStreamSwitch @ 0x1800E9980
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetDuckingOptOutPreference@CAudioSession@@QEAAJ_N@Z @ 0x1800E5314 (-SetDuckingOptOutPreference@CAudioSession@@QEAAJ_N@Z.c)
 */
