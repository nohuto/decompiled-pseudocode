/*
 * XREFs of ?NewNode@?$CAtlList@V?$CAutoPtr@VPhoneTopologyWorkItem@@@ATL@@V?$CAutoPtrElementTraits@VPhoneTopologyWorkItem@@@2@@ATL@@AEAAPEAVCNode@12@AEAV?$CAutoPtr@VPhoneTopologyWorkItem@@@2@PEAV312@1@Z @ 0x180165248
 * Callers:
