/*
 * XREFs of ?Continue@CMonitorManager@@QEAAXXZ @ 0x18012C474
 * Callers:
 *     ?ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18012EF20 (-ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
