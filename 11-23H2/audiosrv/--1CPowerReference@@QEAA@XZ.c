/*
 * XREFs of ??1CPowerReference@@QEAA@XZ @ 0x1800473CC
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCPowerReference@@@std@@EEAAXXZ @ 0x18004BB60 (-_Destroy@-$_Ref_count_obj2@VCPowerReference@@@std@@EEAAXXZ.c)
 * Callees:
...
void __fastcall CPowerReference::~CPowerReference(CPowerReference *this)
{
  ...
  if ( *((_QWORD *)this + 8) )
  {
    std::shared_ptr<std::wstring>::shared_ptr<std::wstring>(v10, (_QWORD *)this + 8);
    v11[0] = off_180170830;
    v11[1] = v10[0];
    v11[2] = v10[1];
    v11[7] = v11;
    CSerialWorkQueue::QueueWorkItem(v9 + 440, (__int64)v11);
  }
