/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDolbyStereo@@UEBA_NPEAVEffectPack@@PEBUtWAVEFORMATEX@@1KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x18001F750
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall CSpatialAudioDolbyStereo::IsTechnologySupported(
