/*
 * XREFs of ?GetCellularTxMuteSync@PhoneTopology@@UEAAJPEAU_TelephonyInstanceData@@PEAH@Z @ 0x180164E20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
    ...
    v7 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v12 + 56LL))(v12, a3);
    v6 = 0;
    if ( v7 < 0 )
      v6 = v7;
  }
