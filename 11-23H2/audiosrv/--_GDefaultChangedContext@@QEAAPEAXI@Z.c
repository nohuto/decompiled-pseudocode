/*
 * XREFs of ??_GDefaultChangedContext@@QEAAPEAXI@Z @ 0x1800843EC
 * Callers:
 ...
 *     sub_1800851C8 @ 0x1800851C8 (sub_1800851C8.c)
 *     ??1?$CAutoPtr@UDefaultChangedContext@@@ATL@@QEAA@XZ @ 0x18012BA40 (--1-$CAutoPtr@UDefaultChangedContext@@@ATL@@QEAA@XZ.c)
 * Callees:
