/*
 * XREFs of ??1?$vector@V?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAGP6AXPEAX@Z$1?CoTaskMemFree@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAGPEAG$0A@$$T@details@wil@@@details@wil@@@wil@@V?$allocator@V?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAGP6AXPEAX@Z$1?CoTaskMemFree@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAGPEAG$0A@$$T@details@wil@@@details@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x180154588
 * Callers:
 *     _EffectPackConfiguration::EffectPackConfiguration_::_1_::dtor$5 @ 0x18007A34E (_EffectPackConfiguration--EffectPackConfiguration_--_1_--dtor$5.c)
 * Callees:
