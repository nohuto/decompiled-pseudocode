/*
 * XREFs of ?RuntimeClassInitialize@?$BluetoothControl@VIVolumeControlHandler@@VBluetoothVolume@BluetoothControls@@@BluetoothControls@@QEAAJPEBGPEAVBluetoothVolume@2@PEAUIControlChangeNotify@@@Z @ 0x1800F38A4
 * Callers:
 ...
 *     ??4?$com_ptr_t@UIControlChangeNotify@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@PEAUIControlChangeNotify@@@Z @ 0x1800F1DEC (--4-$com_ptr_t@UIControlChangeNotify@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@PEAUIControlCh.c)
 *     ??4?$com_ptr_t@VIVolumeControlHandler@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@PEAVIVolumeControlHandler@@@Z @ 0x1800F1EBC (--4-$com_ptr_t@VIVolumeControlHandler@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@PEAVIVolumeCo.c)
