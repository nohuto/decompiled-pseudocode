/*
 * XREFs of ??1CPdcActivationClient@@QEAA@XZ @ 0x180111A28
 * Callers:
 *     _CPowerReferenceManager::CPowerReferenceManager_::_1_::dtor$0 @ 0x18007CDAC (_CPowerReferenceManager--CPowerReferenceManager_--_1_--dtor$0.c)
