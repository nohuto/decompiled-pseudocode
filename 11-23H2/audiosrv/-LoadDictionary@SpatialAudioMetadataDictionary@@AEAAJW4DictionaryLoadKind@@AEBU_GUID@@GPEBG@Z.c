/*
 * XREFs of ?LoadDictionary@SpatialAudioMetadataDictionary@@AEAAJW4DictionaryLoadKind@@AEBU_GUID@@GPEBG@Z @ 0x180147B50
 * Callers:
...
LABEL_25:
  ...
  *(_QWORD *)(a1 + 128) = v20;
  ...
  v15 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v22 + 48LL))(v22, v20, v27);
  v12 = v15;
  if ( v15 < 0 && (unsigned int)dword_1801CD1E8 > 2 )
  {
    v25 = 224;
    v13 = &dword_1801953CC;
    goto LABEL_25;
