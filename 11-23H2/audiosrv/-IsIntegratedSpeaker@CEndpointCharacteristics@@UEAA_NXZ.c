/*
 * XREFs of ?IsIntegratedSpeaker@CEndpointCharacteristics@@UEAA_NXZ @ 0x18014E090
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_OWORD *)pvar = 0LL;
           ...
           v7) >= 0 )
    {
      ...
      if ( LOWORD(v7[0]) == 72 )
      {
        ...
        if ( !v4 )
        {
          v5 = *((_QWORD *)this + 48) - *(_QWORD *)&GUID_dff21ce1_f70f_11d0_b917_00a0c9223196.Data1;
          if ( !v5 )
            v5 = *((_QWORD *)this + 49) - *(_QWORD *)GUID_dff21ce1_f70f_11d0_b917_00a0c9223196.Data4;
          if ( !v5 )
            *v1 = 1;
        }
      }
