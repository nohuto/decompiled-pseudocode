/*
 * XREFs of ?AddStream@CSpatialAudioResourceManager@Sarm@@AEAAJPEAUIAudioStreamInfo@@KPEBU_GUID@@PEBUSPATIAL_STREAM_PROPERTIES@@PEAVCEndpointResourcePool@2@@Z @ 0x180133DE4
 * Callers:
        ...
        struct Sarm::CEndpointResourcePool *a6)
{
  ...
  SarmTraceLoggingTracer("Sarm::CSpatialAudioResourceManager::AddStream", 103);
