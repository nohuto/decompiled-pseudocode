/*
 * XREFs of ?ReleasePowerReference@CXvmPowerReferenceManager@@QEAAXXZ @ 0x18011A614
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCXvmPowerReference@@@std@@EEAAXXZ @ 0x18011A850 (-_Destroy@-$_Ref_count_obj2@VCXvmPowerReference@@@std@@EEAAXXZ.c)
 * Callees:
 *     <none>
 */
