/*
 * XREFs of _lambda_508286948f9241bf53db8f8ecb0f45ed_::operator() @ 0x180074498
 * Callers:
...
__int64 __fastcall lambda_508286948f9241bf53db8f8ecb0f45ed_::operator()(
        _DWORD *a1,
        ...
        _QWORD *a5)
{
  ...
  if ( DefaultEffectChainClsids < 0
    || !v29
    || (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find(&v25, a3) == -1 )
  {
    goto LABEL_14;
  }
  v21 = 0LL;
  v23 = v10;
  LODWORD(a5) = v11;
  *(_QWORD *)&v24 = *(_QWORD *)(*(_QWORD *)a1 + 1752LL);
  v29 = 0;
  v19 = 0;
  v20 = 1;
  ...
  if ( v12 >= 0 )
  {
    v15 = *v21;
    v16 = a1[2];
    v17 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 1288LL) + 40LL);
    v24 = *(_OWORD *)a3;
