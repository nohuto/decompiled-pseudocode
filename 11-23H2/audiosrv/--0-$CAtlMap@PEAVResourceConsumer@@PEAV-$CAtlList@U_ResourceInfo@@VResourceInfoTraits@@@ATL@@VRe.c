/*
 * XREFs of ??0?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@QEAA@IMMMI@Z @ 0x180026A68
 * Callers:
 *     ??0PhoneTopology@@IEAA@XZ @ 0x180026820 (--0PhoneTopology@@IEAA@XZ.c)
 *     ??0CConstraintModel@@QEAA@XZ @ 0x18005BF64 (--0CConstraintModel@@QEAA@XZ.c)
