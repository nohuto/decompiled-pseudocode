/*
 * XREFs of dllmain_crt_process_detach @ 0x180066770
 * Callers:
 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x180066DDC (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x180066F7C (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x180066FA8 (__scrt_uninitialize_crt.c)
 *     ?__scrt_uninitialize_type_info@@YAXXZ @ 0x1800674B8 (-__scrt_uninitialize_type_info@@YAXXZ.c)
 *     __scrt_fastfail @ 0x180067510 (__scrt_fastfail.c)
 *     _RTC_Terminate @ 0x1800676B0 (_RTC_Terminate.c)
 */
