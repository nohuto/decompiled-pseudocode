/*
 * XREFs of _CAudioSessionInstanceId::Initialize_::_1_::dtor$0 @ 0x18007C6EB
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionInstanceId::Initialize_::_1_::dtor_0(__int64 a1, __int64 a2)
{
