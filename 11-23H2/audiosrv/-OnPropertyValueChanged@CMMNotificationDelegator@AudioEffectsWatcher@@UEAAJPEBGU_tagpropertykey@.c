/*
 * XREFs of ?OnPropertyValueChanged@CMMNotificationDelegator@AudioEffectsWatcher@@UEAAJPEBGU_tagpropertykey@@@Z @ 0x1800D60F0
 * Callers:
 *     <none>
 * Callees:
 *     ?SetEvent@details@wil@@YAXPEAX@Z @ 0x180017654 (-SetEvent@details@wil@@YAXPEAX@Z.c)
 *     ??8@YAHAEBU_tagpropertykey@@0@Z @ 0x1800D5950 (--8@YAHAEBU_tagpropertykey@@0@Z.c)
 */
