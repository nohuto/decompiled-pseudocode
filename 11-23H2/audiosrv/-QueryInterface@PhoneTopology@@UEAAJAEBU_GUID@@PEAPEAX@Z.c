/*
 * XREFs of ?QueryInterface@PhoneTopology@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801654C0
 * Callers:
 *     ?QueryInterface@PhoneTopology@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180077F70 (-QueryInterface@PhoneTopology@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
