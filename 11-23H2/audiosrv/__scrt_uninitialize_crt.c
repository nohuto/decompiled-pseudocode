/*
 * XREFs of __scrt_uninitialize_crt @ 0x180066FA8
 * Callers:
 *     dllmain_crt_process_detach @ 0x180066770 (dllmain_crt_process_detach.c)
 * Callees:
 *     __scrt_stub_for_acrt_uninitialize_critical @ 0x18006A990 (__scrt_stub_for_acrt_uninitialize_critical.c)
 */
