/*
 * XREFs of ??1?$vector@V?$com_ptr_t@UIAudioClient@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIAudioClient@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x180073AB4
 * Callers:
...
void __fastcall std::vector<wil::com_ptr_t<IAudioClient,wil::err_returncode_policy>>::~vector<wil::com_ptr_t<IAudioClient,wil::err_returncode_policy>>(
        __int64 a1)
{
  void *v2; // rcx
