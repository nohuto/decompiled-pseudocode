/*
 * XREFs of ?LogError@@YAXPEBGZZ @ 0x180100DC4
 * Callers:
 ...
 *     ?FindStartOrEndElement@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEBG1HPEAH@Z @ 0x180160F14 (-FindStartOrEndElement@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEBG1HPEAH@Z.c)
 *     ?FindXmlFileEOF@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@@Z @ 0x180160FF4 (-FindXmlFileEOF@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@@Z.c)
...
void LogError(STRSAFE_LPCWSTR pszFormat, ...)
{
  size_t *v2; // r8
  wchar_t pszDest[1024]; // [rsp+30h] [rbp-818h] BYREF
  __int64 argList; // [rsp+858h] [rbp+10h] BYREF
  va_list va; // [rsp+858h] [rbp+10h]
  __int64 v6; // [rsp+860h] [rbp+18h]
  ...
  StringVPrintfWorkerW(pszDest, 0x400uLL, v2, pszFormat, va);
