/*
 * XREFs of ??$?0AEAY0BK@$$CBGW4AEC_LOOPBACK_SELECTION_MODE@@$0A@@?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@W4AEC_LOOPBACK_SELECTION_MODE@@@std@@QEAA@AEAY0BK@$$CBG$$QEAW4AEC_LOOPBACK_SELECTION_MODE@@@Z @ 0x180055A00
 * Callers:
...
__int64 __fastcall std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>(
        ...
        _DWORD *a3)
{
  std::wstring::wstring((_QWORD *)a1, L"ACTIVE_OR_DEFAULT_CONSOLE");
  *(_DWORD *)(a1 + 32) = *a3;
  return a1;
}
