/*
 * XREFs of ?MakeUpper@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAAAEAV12@XZ @ 0x18001C7D4
 * Callers:
...
_QWORD *__fastcall ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::MakeUpper(
        _QWORD *a1)
{
  unsigned int v2; // edi
  unsigned int v3; // eax
  ...
  v2 = *(_DWORD *)(*a1 - 16LL);
  v3 = *(_DWORD *)(*a1 - 12LL) - v2;
  v4 = v3 | (1 - *(_DWORD *)(*a1 - 8LL));
  if ( ((v3 | (1 - *(_DWORD *)(*a1 - 8LL))) & 0x80000000) != 0 )
    ATL::CSimpleStringT<unsigned short,0>::PrepareWrite2(a1, v2);
  _o__wcsupr_s(*a1, (int)(v2 + 1), v4);
  ATL::CSimpleStringT<unsigned short,0>::SetLength(a1, v2);
  return a1;
}
