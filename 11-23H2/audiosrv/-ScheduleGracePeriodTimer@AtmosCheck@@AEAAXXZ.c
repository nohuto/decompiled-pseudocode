/*
 * XREFs of ?ScheduleGracePeriodTimer@AtmosCheck@@AEAAXXZ @ 0x18015D5A0
 * Callers:
 *     _lambda_2d0fc716a24758c5659c2630b6d3cdc8_::operator() @ 0x18015A254 (_lambda_2d0fc716a24758c5659c2630b6d3cdc8_--operator().c)
 *     _lambda_aaa9b3e3e77bc6900f26072d6eeeed96_::operator() @ 0x18015A5C4 (_lambda_aaa9b3e3e77bc6900f26072d6eeeed96_--operator().c)
 * Callees:
 ...
 *     ?GetSpatialAudioLicenseGracePeriodInMs@AtmosCheck@@CAHXZ @ 0x18015BC2C (-GetSpatialAudioLicenseGracePeriodInMs@AtmosCheck@@CAHXZ.c)
 */
