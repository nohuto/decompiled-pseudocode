/*
 * XREFs of ??1?$unique_ptr@UAuxiliaryInputDescriptor@@U?$default_delete@UAuxiliaryInputDescriptor@@@std@@@std@@QEAA@XZ @ 0x180104838
 * Callers:
 ...
 *     _CSharedStreamGroupProxy::ConfigureAuxiliaryInputStream_::_1_::dtor$0 @ 0x180078D1C (_CSharedStreamGroupProxy--ConfigureAuxiliaryInputStream_--_1_--dtor$0.c)
 * Callees:
