/*
 * XREFs of ??I?$com_ptr_t@UIMMDevice@@Uerr_returncode_policy@wil@@@wil@@QEAAPEAPEAUIMMDevice@@XZ @ 0x1800D891C
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<IMMDevice,wil::err_returncode_policy>::operator&(__int64 *a1)
{
  __int64 v2; // rcx
