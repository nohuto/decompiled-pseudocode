/*
 * XREFs of AudioServerGetChannelVolume @ 0x180120F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetChannelVolume(CVADServer *this, unsigned int a2, float *a3)
{
  ...
  v11 = ChannelVolume;
  if ( ChannelVolume < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetChannelVolume", 3242, ChannelVolume);
