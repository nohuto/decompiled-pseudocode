/*
 * XREFs of ?UpdateRenderingEndpointsSpatialSettingsAsync@CPolicyConfig@@SAXXZ @ 0x180065590
 * Callers:
 *     <none>
 * Callees:
...
void CPolicyConfig::UpdateRenderingEndpointsSpatialSettingsAsync(void)
{
  ...
  v0 = (*(__int64 (__fastcall **)(struct IAudioService *))(*(_QWORD *)g_AudioService + 136LL))(g_AudioService);
  *(_QWORD *)v2 = &off_18017AF60;
  v3 = v2;
