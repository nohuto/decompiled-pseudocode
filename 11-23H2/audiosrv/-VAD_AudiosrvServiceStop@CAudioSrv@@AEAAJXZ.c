/*
 * XREFs of ?VAD_AudiosrvServiceStop@CAudioSrv@@AEAAJXZ @ 0x1800F0C74
 * Callers:
 ...
 *     ?DestroyDeviceGraphManager@@YAXXZ @ 0x180106A48 (-DestroyDeviceGraphManager@@YAXXZ.c)
 *     ?Shutdown@EffectPackConfigurationManager@@QEAAXXZ @ 0x18010E3E8 (-Shutdown@EffectPackConfigurationManager@@QEAAXXZ.c)
 *     ?DestroySpatialAudioResourceManager@@YAXXZ @ 0x1801341D8 (-DestroySpatialAudioResourceManager@@YAXXZ.c)
 *     ?UninitializeEndpointCharacteristicsCache@@YAJXZ @ 0x180150368 (-UninitializeEndpointCharacteristicsCache@@YAJXZ.c)
 */
