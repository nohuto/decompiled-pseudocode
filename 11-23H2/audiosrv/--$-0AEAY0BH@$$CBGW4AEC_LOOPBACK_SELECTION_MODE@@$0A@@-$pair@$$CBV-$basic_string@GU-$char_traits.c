/*
 * XREFs of ??$?0AEAY0BH@$$CBGW4AEC_LOOPBACK_SELECTION_MODE@@$0A@@?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@W4AEC_LOOPBACK_SELECTION_MODE@@@std@@QEAA@AEAY0BH@$$CBG$$QEAW4AEC_LOOPBACK_SELECTION_MODE@@@Z @ 0x180055A38
 * Callers:
...
__int64 __fastcall std::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>::pair<std::wstring const,enum AEC_LOOPBACK_SELECTION_MODE>(
        ...
        _DWORD *a3)
{
  std::wstring::wstring((_QWORD *)a1, L"DEFAULT_COMMUNICATIONS");
  *(_DWORD *)(a1 + 32) = *a3;
  return a1;
}
