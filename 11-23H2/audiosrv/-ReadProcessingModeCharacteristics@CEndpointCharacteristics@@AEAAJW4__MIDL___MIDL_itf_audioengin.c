...
__int64 __fastcall CEndpointCharacteristics::ReadProcessingModeCharacteristics(__int64 a1, int a2, __int64 a3)
{
  ...
  *(_OWORD *)pvar = 0LL;
  ...
  {
    if ( LOWORD(pvar[0]) == 65 )
      v5 = DeserializeProcessingModeCharacteristics((unsigned int)pvar[1], v8, a3);
    else
      v5 = -2147023728;
  }
