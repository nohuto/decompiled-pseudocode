/*
 * XREFs of ??$MakeAndInitialize@VCSpatialAudioResourceManager@Sarm@@UISpatialAudioResourceManager@@AEAPEAUIAudioPolicyManager@@@Details@WRL@Microsoft@@YAJPEAPEAUISpatialAudioResourceManager@@AEAPEAUIAudioPolicyManager@@@Z @ 0x18006282C
 * Callers:
 ...
 *     ??0CSpatialAudioResourceManager@Sarm@@QEAA@XZ @ 0x180062918 (--0CSpatialAudioResourceManager@Sarm@@QEAA@XZ.c)
 ...
 *     ??1?$ComPtr@VCSpatialAudioResourceManager@Sarm@@@WRL@Microsoft@@QEAA@XZ @ 0x1801335EC (--1-$ComPtr@VCSpatialAudioResourceManager@Sarm@@@WRL@Microsoft@@QEAA@XZ.c)
 */
