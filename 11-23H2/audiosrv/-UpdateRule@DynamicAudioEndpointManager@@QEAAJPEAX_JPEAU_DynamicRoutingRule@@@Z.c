/*
 * XREFs of ?UpdateRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x18014090C
 * Callers:
 *     PolicyConfigUpdateDynamicRoutingRule @ 0x180118DE0 (PolicyConfigUpdateDynamicRoutingRule.c)
 * Callees:
