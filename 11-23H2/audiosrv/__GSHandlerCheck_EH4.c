/*
 * XREFs of __GSHandlerCheck_EH4 @ 0x1800758A4
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler4_0 @ 0x1800678EE (__CxxFrameHandler4_0.c)
 *     __GSHandlerCheckCommon @ 0x18006A7AC (__GSHandlerCheckCommon.c)
 */
