...
_QWORD *__fastcall std::vector<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>::_Emplace_reallocate<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>(
        __int64 *a1,
        __int64 a2,
        __int64 *a3)
{
  ...
  *v12 = v13;
  ...
  std::_Uninitialized_move<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>>(
    ...
    v14,
    v15);
  std::vector<wil::com_ptr_t<CAudioStream,wil::err_returncode_policy>>::_Change_array(a1, v11, v8, v9, v11);
  return v12;
}
