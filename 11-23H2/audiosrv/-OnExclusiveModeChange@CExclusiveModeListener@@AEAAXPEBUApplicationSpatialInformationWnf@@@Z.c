/*
 * XREFs of ?OnExclusiveModeChange@CExclusiveModeListener@@AEAAXPEBUApplicationSpatialInformationWnf@@@Z @ 0x18013A4F4
 * Callers:
 *     ?SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x18013BA30 (-SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYP.c)
 * Callees:
  ...
  else
  {
    if ( (unsigned int)dword_1801CD178 > 4 )
    {
      ...
      tlgWriteTransfer_EventWriteTransfer(
        ...
        (unsigned __int8 *)dword_18019500C,
        0LL,
        0LL,
        3u,
        &v14);
