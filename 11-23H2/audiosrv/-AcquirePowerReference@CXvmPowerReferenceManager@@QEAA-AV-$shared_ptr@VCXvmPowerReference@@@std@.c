/*
 * XREFs of ?AcquirePowerReference@CXvmPowerReferenceManager@@QEAA?AV?$shared_ptr@VCXvmPowerReference@@@std@@XZ @ 0x18011A000
 * Callers:
 ...
 *     ??$make_shared@VCXvmPowerReference@@PEAVCXvmPowerReferenceManager@@@std@@YA?AV?$shared_ptr@VCXvmPowerReference@@@0@$$QEAPEAVCXvmPowerReferenceManager@@@Z @ 0x180119704 (--$make_shared@VCXvmPowerReference@@PEAVCXvmPowerReferenceManager@@@std@@YA-AV-$shared_ptr@VCXvm.c)
 *     ?CancelDeferredPowerReferenceRelease@CXvmPowerReferenceManager@@AEAAXXZ @ 0x18011A39C (-CancelDeferredPowerReferenceRelease@CXvmPowerReferenceManager@@AEAAXXZ.c)
 */
