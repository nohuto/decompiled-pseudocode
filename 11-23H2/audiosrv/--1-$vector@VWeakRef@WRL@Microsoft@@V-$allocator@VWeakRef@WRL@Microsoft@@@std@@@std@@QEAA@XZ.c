/*
 * XREFs of ??1?$vector@VWeakRef@WRL@Microsoft@@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@QEAA@XZ @ 0x1800E7890
 * Callers:
 *     _CDeviceGraphObjectsStore::CDeviceGraphObjectsStore_::_1_::dtor$3 @ 0x18007AD50 (_CDeviceGraphObjectsStore--CDeviceGraphObjectsStore_--_1_--dtor$3.c)
 * Callees:
