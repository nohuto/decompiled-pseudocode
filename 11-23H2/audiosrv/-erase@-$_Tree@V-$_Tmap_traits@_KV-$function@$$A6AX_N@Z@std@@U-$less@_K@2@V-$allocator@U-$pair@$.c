/*
 * XREFs of ?erase@?$_Tree@V?$_Tmap_traits@_KV?$function@$$A6AX_N@Z@std@@U?$less@_K@2@V?$allocator@U?$pair@$$CB_KV?$function@$$A6AX_N@Z@std@@@std@@@2@$0A@@std@@@std@@QEAA_KAEB_K@Z @ 0x1800FB580
 * Callers:
 *     ?UnregisterCallback@CBtAudioResourceManagerBase@@UEAAJI@Z @ 0x1800FADF0 (-UnregisterCallback@CBtAudioResourceManagerBase@@UEAAJI@Z.c)
 * Callees:
        ...
        unsigned __int64 *a2)
{
  ...
  std::_Tree<std::_Tmap_traits<unsigned __int64,std::function<void (bool)>,std::less<unsigned __int64>,std::allocator<std::pair<unsigned __int64 const,std::function<void (bool)>>>,0>>::_Erase_unchecked(
    a1,
    v2,
    v5);
  return v3;
