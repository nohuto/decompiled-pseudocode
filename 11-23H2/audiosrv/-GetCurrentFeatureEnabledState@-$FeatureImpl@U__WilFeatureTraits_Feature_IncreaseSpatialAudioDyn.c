/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_IncreaseSpatialAudioDynamicObjectCountV1@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180061AC8
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_IncreaseSpatialAudioDynamicObjectCountV1>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        ...
        int *a4)
{
  ...
  FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0x27BD9EC, 0, a3, a4);
  *a2 = 0LL;
  ...
  *(_DWORD *)a2 = v9;
  ...
  {
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_MTestUx14>::ReportUsage(
