/*
 * XREFs of ?_Calculate_growth@?$vector@V?$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@AEBA_K_K@Z @ 0x18000A328
 * Callers:
 ...
 *     ?_Clear_and_reserve_geometric@?$vector@ULockedListEntry@?$CLockedList@VCMasterVolumeNotificationProcess@@$00$0A@@@V?$allocator@ULockedListEntry@?$CLockedList@VCMasterVolumeNotificationProcess@@$00$0A@@@@std@@@std@@AEAAX_K@Z @ 0x18008400E (-_Clear_and_reserve_geometric@-$vector@ULockedListEntry@-$CLockedList@VCMasterVolumeNotification.c)
 ...
 *     ?_Clear_and_reserve_geometric@?$vector@V?$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@AEAAX_K@Z @ 0x1800E397C (-_Clear_and_reserve_geometric@-$vector@V-$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@.c)
 * Callees:
 *     <none>
 */
