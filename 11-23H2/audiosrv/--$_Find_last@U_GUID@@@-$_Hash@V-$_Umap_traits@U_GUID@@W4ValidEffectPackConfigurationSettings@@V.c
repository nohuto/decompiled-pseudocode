        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD **)(qword_1801D0178 + 16 * (a4 & qword_1801D0190) + 8);
  if ( v4 == (_QWORD *)qword_1801D0168 )
  {
    *a2 = qword_1801D0168;
LABEL_7:
    a2[1] = 0LL;
  ...
  else
  {
    while ( 1 )
    {
      ...
      if ( !v5 )
        break;
      if ( v4 == *(_QWORD **)(qword_1801D0178 + 16 * (a4 & qword_1801D0190)) )
      {
        *a2 = v4;
        goto LABEL_7;
      }
