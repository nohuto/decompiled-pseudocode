/*
 * XREFs of ?AddRule@DynamicAudioEndpointManager@@QEAAJPEAXPEAU_DynamicRoutingRule@@PEA_J@Z @ 0x18013ECE4
 * Callers:
 *     PolicyConfigAddDynamicRoutingRule @ 0x180117590 (PolicyConfigAddDynamicRoutingRule.c)
 * Callees:
