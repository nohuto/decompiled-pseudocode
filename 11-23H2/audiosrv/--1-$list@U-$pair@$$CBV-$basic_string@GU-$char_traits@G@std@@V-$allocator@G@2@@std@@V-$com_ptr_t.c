/*
 * XREFs of ??1?$list@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$com_ptr_t@VCEndpointCharacteristics@@Uerr_returncode_policy@wil@@@wil@@@std@@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$com_ptr_t@VCEndpointCharacteristics@@Uerr_returncode_policy@wil@@@wil@@@std@@@2@@std@@QEAA@XZ @ 0x18014A6F4
 * Callers:
 *     _CEndpointCharacteristicsCache::CEndpointCharacteristicsCache_::_1_::dtor$10 @ 0x18007DC77 (_CEndpointCharacteristicsCache--CEndpointCharacteristicsCache_--_1_--dtor$10.c)
 * Callees:
