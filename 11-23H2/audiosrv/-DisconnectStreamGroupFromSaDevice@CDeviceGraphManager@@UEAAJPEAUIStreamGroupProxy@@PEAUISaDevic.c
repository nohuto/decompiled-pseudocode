/*
 * XREFs of ?DisconnectStreamGroupFromSaDevice@CDeviceGraphManager@@UEAAJPEAUIStreamGroupProxy@@PEAUISaDeviceProxy@@@Z @ 0x1801070B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISaDeviceProxy *a3)
{
  ...
  v5 = (*(__int64 (__fastcall **)(struct IStreamGroupProxy *))(*(_QWORD *)a2 + 224LL))(a2);
  v7 = v5;
  if ( v5 >= 0 )
  {
