/*
 * XREFs of _CBtAudioResourceManagerBase::GetSaDeviceForExclusiveStream_::_1_::catch$0 @ 0x1800F8F36
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBtAudioResourceManagerBase::GetSaDeviceForExclusiveStream_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
