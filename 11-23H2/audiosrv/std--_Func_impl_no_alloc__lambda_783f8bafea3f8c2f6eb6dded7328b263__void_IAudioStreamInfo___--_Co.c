/*
 * XREFs of std::_Func_impl_no_alloc__lambda_783f8bafea3f8c2f6eb6dded7328b263__void_IAudioStreamInfo___::_Copy @ 0x1800DD9B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a1)
{
  ...
  *v3 = off_180170040;
  std::function<void (bool)>::function<void (bool)>((__int64)(v3 + 1), a1 + 8);
  return v3;
}
