/*
 * XREFs of ?ConnectToSaDevice@CExclusiveStreamGroupProxy@@UEAAJPEAUISaDeviceProxy@@W4SUBMIX_CONNECT_OPTIONS@@PEAUSystemAudioStream@@@Z @ 0x180105FC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0SystemAudioStream@@QEAA@$$QEAU0@@Z @ 0x180104454 (--0SystemAudioStream@@QEAA@$$QEAU0@@Z.c)
 */
