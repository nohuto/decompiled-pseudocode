/*
 * XREFs of _CAudioSessionInstanceId::Initialize_::_1_::dtor$5 @ 0x18007C721
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionInstanceId::Initialize_::_1_::dtor_5(__int64 a1, __int64 a2)
{
