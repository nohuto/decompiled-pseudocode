/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DtsxHdmiEnabled@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180061C20
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_DtsxHdmiEnabled@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180061D4C (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_DtsxHdmiEnabled@@@detai.c)
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_DtsxHdmiEnabled>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_DtsxHdmiEnabled>::GetCurrentFeatureEnabledState(a1, &v14, &v13);
    v7 = v6 != 0 ? v13 : 0;
    v13 = v7;
    v8 = *a2;
    while ( 1 )
