/*
 * XREFs of ?OnVolumeLimitCapsChange@CKsSoftwareNotificationsMonitor@@AEAAJXZ @ 0x18011B704
 * Callers:
 *     ?OnNotify@CKsSoftwareNotificationsMonitor@@UEAAJKPEBU_GUID@@@Z @ 0x18011B6E0 (-OnNotify@CKsSoftwareNotificationsMonitor@@UEAAJKPEBU_GUID@@@Z.c)
 * Callees:
...
__int64 __fastcall CKsSoftwareNotificationsMonitor::OnVolumeLimitCapsChange(CKsSoftwareNotificationsMonitor *this)
{
  ...
  __int64 v12[2]; // [rsp+48h] [rbp-C0h] BYREF
  ...
  if ( v4 >= 0 )
  {
    ...
    else
    {
      ...
      if ( v4 >= 0 )
      {
        v4 = (*(__int64 (__fastcall **)(_QWORD, __int64 *))(**((_QWORD **)this + 4) + 96LL))(*((_QWORD *)this + 4), v12);
        if ( v4 >= 0 )
        {
          v4 = (*(__int64 (__fastcall **)(__int64, LPVOID *))(*(_QWORD *)v12[0] + 64LL))(v12[0], &pv);
          if ( v4 >= 0 )
          {
            v5 = -1LL;
            do
