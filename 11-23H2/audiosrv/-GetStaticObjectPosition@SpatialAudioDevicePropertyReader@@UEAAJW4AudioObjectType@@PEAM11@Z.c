/*
 * XREFs of ?GetStaticObjectPosition@SpatialAudioDevicePropertyReader@@UEAAJW4AudioObjectType@@PEAM11@Z @ 0x180144870
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  if ( a3 && a4 && (v14 = a5) != 0LL && (unsigned int)(a2 - 2) <= 0x1FFFE )
  {
    ...
    *a4 = *(float *)(v15 + 8 * v16 + 4);
    *v14 = *(float *)(v15 + 8 * v16 + 8);
  }
  else
  {
    v10 = -2147024809;
    if ( (unsigned int)dword_1801CD1E8 > 2 )
    {
      ...
      v18 = "SpatialAudioDevicePropertyReader::GetStaticObjectPosition";
      v20 = 640;
