/*
 * XREFs of ?ReconnectStreamGroupsToNewSaDevices@CBtLeAudioResourceManager@@IEAAJPEAUEndpointCharacteristicsDescriptor@@AEAV?$forward_list@UDisplacedStreamGroup@@V?$allocator@UDisplacedStreamGroup@@@std@@@std@@W4ReconnectSaDeviceOptions@1@@Z @ 0x1800FBD34
 * Callers:
