/*
 * XREFs of ??1CEndpointStoreCache@@QEAA@XZ @ 0x180065FE0
 * Callers:
 *     _dynamic_atexit_destructor_for__g_endpointStoreCache__ @ 0x18007E130 (_dynamic_atexit_destructor_for__g_endpointStoreCache__.c)
 * Callees:
