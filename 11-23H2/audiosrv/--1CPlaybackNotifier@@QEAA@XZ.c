/*
 * XREFs of ??1CPlaybackNotifier@@QEAA@XZ @ 0x1801199C8
 * Callers:
 *     _CPowerReferenceManager::CPowerReferenceManager_::_1_::dtor$2 @ 0x18007CDD4 (_CPowerReferenceManager--CPowerReferenceManager_--_1_--dtor$2.c)
