/*
 * XREFs of ??1?$com_ptr_t@VCPBMStreamClassVolumeGainStage@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800DEA6C
 * Callers:
 *     _CAudioSession::AddDuckingManagerGainStage_::_1_::dtor$1 @ 0x1800DF076 (_CAudioSession--AddDuckingManagerGainStage_--_1_--dtor$1.c)
 * Callees:
