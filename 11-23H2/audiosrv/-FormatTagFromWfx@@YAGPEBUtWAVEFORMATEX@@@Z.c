/*
 * XREFs of ?FormatTagFromWfx@@YAGPEBUtWAVEFORMATEX@@@Z @ 0x180069150
 * Callers:
 *     ?ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x180069814 (-ValidateWaveFormat@@YAHPEBUtWAVEFORMATEX@@@Z.c)
 * Callees:
 *     <none>
 */
