/*
 * XREFs of ?SimpleWildcardStringCompare@@YAHQEBG_K01@Z @ 0x1801023B8
 * Callers:
 ...
 *     ??8StreamResourceConsumer@@QEAA_NAEBV0@@Z @ 0x18015F5F4 (--8StreamResourceConsumer@@QEAA_NAEBV0@@Z.c)
 * Callees:
 *     <none>
 */
