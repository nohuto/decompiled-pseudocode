/*
 * XREFs of ?CreateInstance@EndpointCollection@@SAJPEAPEAUIEndpointCollection@@@Z @ 0x18005AC78
 * Callers:
 ...
 *     ??0EndpointCollection@@IEAA@XZ @ 0x18005AD90 (--0EndpointCollection@@IEAA@XZ.c)
