/*
 * XREFs of ?OnConnectedToBridgeStream@CSharedStreamGroupProxy@@UEAAJPEAUIBridgeStreamInstanceProxy@@@Z @ 0x180108810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSharedStreamGroupProxy::OnConnectedToBridgeStream(
...
LABEL_5:
  ...
  v6 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(this + 80) + 96LL))(*(_QWORD *)(this + 80), v15);
  v7 = v6;
  if ( v6 < 0 )
  {
    v8 = 1594LL;
