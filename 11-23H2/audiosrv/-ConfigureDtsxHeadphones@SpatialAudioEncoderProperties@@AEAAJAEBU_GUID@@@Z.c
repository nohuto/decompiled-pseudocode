/*
 * XREFs of ?ConfigureDtsxHeadphones@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x180145DE4
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  *(_DWORD *)((char *)this + 238) = 0;
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    v15 = 0;
    v14 = 0;
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(&DTSX_HEADPHONES_SPATIAL_ENCODER, &v15, &v14) >= 0 )
    {
      *((_DWORD *)this + 29) = v15;
      *((_WORD *)this + 62) = v14;
    }
