/*
 * XREFs of ??1?$CAutoPtr@UAuxiliaryInputDescriptor@@@ATL@@QEAA@XZ @ 0x1800D8510
 * Callers:
 *     _CAudioResourceManager::UpdateAuxiliaryInputForStreamGroup_::_1_::dtor$8 @ 0x1800DD848 (_CAudioResourceManager--UpdateAuxiliaryInputForStreamGroup_--_1_--dtor$8.c)
 * Callees:
