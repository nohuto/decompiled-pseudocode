/*
 * XREFs of ?OnStreamStateChanged@?$BluetoothControl@VIVolumeControlHandler@@VBluetoothVolume@BluetoothControls@@@BluetoothControls@@AEAAX_N@Z @ 0x1800F2C04
 * Callers:
        ...
        char a2)
{
  ...
  *(_BYTE *)(a1 + 113) = a2;
  if ( v3 != a2 )
  {
    ...
    v7[0] = &std::_Func_impl_no_alloc<_lambda_aa1b3fa86fd9c3b2e39deb1768528b72_,void,>::`vftable';
    v7[1] = a1;
    v7[3] = v6[1];
    v7[2] = v6[0];
    v7[7] = v7;
