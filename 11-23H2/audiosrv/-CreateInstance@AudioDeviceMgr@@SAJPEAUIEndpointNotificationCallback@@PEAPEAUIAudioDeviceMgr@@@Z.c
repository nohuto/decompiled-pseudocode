/*
 * XREFs of ?CreateInstance@AudioDeviceMgr@@SAJPEAUIEndpointNotificationCallback@@PEAPEAUIAudioDeviceMgr@@@Z @ 0x180059180
 * Callers:
 ...
 *     ??0AudioDeviceMgr@@IEAA@XZ @ 0x1800592A4 (--0AudioDeviceMgr@@IEAA@XZ.c)
