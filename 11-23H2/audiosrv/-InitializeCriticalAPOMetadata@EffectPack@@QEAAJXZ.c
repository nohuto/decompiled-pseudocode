/*
 * XREFs of ?InitializeCriticalAPOMetadata@EffectPack@@QEAAJXZ @ 0x18014CFC8
 * Callers:
 ...
 *     ?FindCriticalAPO@EffectPack@@AEAAHPEAUIAudioSystemEffects2@@@Z @ 0x18014BEFC (-FindCriticalAPO@EffectPack@@AEAAHPEAUIAudioSystemEffects2@@@Z.c)
 */
