/*
 * XREFs of ??0AudioEffectsWatcher@@QEAA@XZ @ 0x1800D54B0
 * Callers:
...
AudioEffectsWatcher *__fastcall AudioEffectsWatcher::AudioEffectsWatcher(AudioEffectsWatcher *this)
{
  ...
  *(_OWORD *)((char *)this + 104) = xmmword_1801CEAC0;
  *(_OWORD *)((char *)this + 120) = xmmword_1801CEAD0;
  *(_OWORD *)((char *)this + 136) = xmmword_1801CEAE0;
  return this;
}
