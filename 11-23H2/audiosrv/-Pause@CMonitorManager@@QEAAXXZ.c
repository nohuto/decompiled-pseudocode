/*
 * XREFs of ?Pause@CMonitorManager@@QEAAXXZ @ 0x18012E538
 * Callers:
 *     ?PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18012E630 (-PauseAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
