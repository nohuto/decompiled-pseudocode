/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x180069074
 * Callers:
 ...
 *     ?QueryInterface@CAudioMediaType@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069610 (-QueryInterface@CAudioMediaType@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
