/*
 * XREFs of ?StartRpcServer@@YAJPEAG0PEAX1@Z @ 0x180059CCC
 * Callers:
...
__int64 __fastcall StartRpcServer(unsigned __int16 *a1, unsigned __int16 *a2, void *a3, void *a4)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 22LL, &WPP_621167bef4003aa6e08b5688b5cb64cc_Traceguids, a2);
  }
  if ( ServerEndpointIsStarted(a2) )
  {
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 24LL, &WPP_621167bef4003aa6e08b5688b5cb64cc_Traceguids);
    }
    goto LABEL_7;
  }
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 23LL, &WPP_621167bef4003aa6e08b5688b5cb64cc_Traceguids, v7);
  }
  if ( !v8 )
  {
LABEL_7:
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 25LL, &WPP_621167bef4003aa6e08b5688b5cb64cc_Traceguids, v9);
    }
  }
  return v8;
}
