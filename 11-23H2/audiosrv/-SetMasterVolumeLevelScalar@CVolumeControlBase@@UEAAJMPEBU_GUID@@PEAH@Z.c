/*
 * XREFs of ?SetMasterVolumeLevelScalar@CVolumeControlBase@@UEAAJMPEBU_GUID@@PEAH@Z @ 0x180129340
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qg_guid_ @ 0x18012A074 (WPP_SF_qg_guid_.c)
 *     WPP_SF_qggg @ 0x18012A144 (WPP_SF_qggg.c)
 */
