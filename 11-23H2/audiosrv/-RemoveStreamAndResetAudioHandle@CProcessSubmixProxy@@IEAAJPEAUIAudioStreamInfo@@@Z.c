/*
 * XREFs of ?RemoveStreamAndResetAudioHandle@CProcessSubmixProxy@@IEAAJPEAUIAudioStreamInfo@@@Z @ 0x1801099F4
 * Callers:
...
__int64 __fastcall CProcessSubmixProxy::RemoveStreamAndResetAudioHandle(
        ...
        struct IAudioStreamInfo *a2)
{
  ...
  v3 = CProcessSubmixProxy::RemoveStream(this, a2);
  if ( v3 >= 0 )
  {
    v6 = 0LL;
    v7 = 0;
