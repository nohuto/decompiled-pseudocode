/*
 * XREFs of AudioEncoderIdToRenderingMode @ 0x1801437F0
 * Callers:
 *     ?GetCurrentSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z @ 0x180143EF0 (-GetCurrentSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z.c)
 *     ?GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z @ 0x180144B90 (-GetUserSelectedSpatialAudioRenderingMode@SpatialAudioDevicePropertyReader@@UEAAJPEAI@Z.c)
 * Callees:
            ...
            if ( v10 )
            {
              ...
              if ( v11 )
              {
                ...
                if ( v12 )
                {
                  ...
                  if ( v13 && (unsigned int)dword_1801CD1E8 > 2 )
                  {
                    v15 = -2147418113;
