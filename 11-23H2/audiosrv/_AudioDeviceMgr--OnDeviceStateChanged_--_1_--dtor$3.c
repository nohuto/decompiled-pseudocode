/*
 * XREFs of _AudioDeviceMgr::OnDeviceStateChanged_::_1_::dtor$3 @ 0x180078060
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall AudioDeviceMgr::OnDeviceStateChanged_::_1_::dtor_3(__int64 a1, __int64 a2)
{
