/*
 * XREFs of _AudioSessionManagerProvider::Initialize_::_1_::dtor$1 @ 0x18007CCF9
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall AudioSessionManagerProvider::Initialize_::_1_::dtor_1(__int64 a1, __int64 a2)
{
