/*
 * XREFs of _CPowerReferenceManager::EnsureCamMicUsageInitialized_::_1_::catch$8 @ 0x18011A584
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPowerReferenceManager::EnsureCamMicUsageInitialized_::_1_::catch_8(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
