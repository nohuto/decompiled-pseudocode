/*
 * XREFs of _DeviceGraphStore::GetSubmixesForApplication_::_1_::catch$4 @ 0x18010C912
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DeviceGraphStore::GetSubmixesForApplication_::_1_::catch_4(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
