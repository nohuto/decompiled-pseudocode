/*
 * XREFs of ??1?$vector@V?$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCAudioStream@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x1800DEBB4
 * Callers:
 *     _CAudioSession::Disconnect_::_1_::dtor$1 @ 0x18007C98D (_CAudioSession--Disconnect_--_1_--dtor$1.c)
 *     _CAudioSession::DisconnectStreamList_::_1_::dtor$0 @ 0x18007C9E1 (_CAudioSession--DisconnectStreamList_--_1_--dtor$0.c)
 * Callees:
