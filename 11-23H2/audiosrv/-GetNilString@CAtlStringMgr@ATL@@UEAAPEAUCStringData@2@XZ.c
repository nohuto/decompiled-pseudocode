/*
 * XREFs of ?GetNilString@CAtlStringMgr@ATL@@UEAAPEAUCStringData@2@XZ @ 0x18004F7A0
 * Callers:
 *     <none>
 * Callees:
 *     ?AddRef@CStringData@ATL@@QEAAXXZ @ 0x180080EB0 (-AddRef@CStringData@ATL@@QEAAXXZ.c)
 */
