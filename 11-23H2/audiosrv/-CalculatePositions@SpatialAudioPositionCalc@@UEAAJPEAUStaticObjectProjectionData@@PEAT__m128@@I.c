/*
 * XREFs of ?CalculatePositions@SpatialAudioPositionCalc@@UEAAJPEAUStaticObjectProjectionData@@PEAT__m128@@I@Z @ 0x18001B330
 * Callers:
 *     <none>
 * Callees:
 *     ??$Write@U?$_tlgWrapSz@D@@U?$_tlgWrapperByVal@$03@@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@D@@AEBU?$_tlgWrapperByVal@$03@@4@Z @ 0x180005388 (--$Write@U-$_tlgWrapSz@D@@U-$_tlgWrapperByVal@$03@@U2@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvide.c)
 *     _o_sinf_0 @ 0x180067A1C (_o_sinf_0.c)
 *     ?ComputeRadialProjectionOffsets@SpatialAudioPositionCalc@@AEAAXPEAUSpatialAudioProjectionOffsets@@PEAUStaticObjectProjectionData@@@Z @ 0x1801452BC (-ComputeRadialProjectionOffsets@SpatialAudioPositionCalc@@AEAAXPEAUSpatialAudioProjectionOffsets.c)
 */
        ...
        __int64 a4)
{
  ...
  unsigned int v76; // [rsp+148h] [rbp+10h] BYREF
  float v77; // [rsp+150h] [rbp+18h] BYREF
  ...
  if ( a2 && a3 && (_DWORD)a4 == 272 )
  {
    ...
    else
    {
      ...
      v61 = v9;
      v11 = o_sinf_0(v8 * 0.017453292) * v10.m128_f32[0];
      v12 = o_sinf_0((float)(90.0 - v8) * 0.017453292);
      v13 = *((float *)a2 + 6);
      v14 = v11 / v12;
      v62 = v9;
      v63 = LODWORD(v9) ^ _xmm;
      v15 = o_sinf_0(v13 * 0.017453292) * v7;
      v16 = o_sinf_0((float)(90.0 - v13) * 0.017453292);
      v17 = 90.0 - *((float *)a2 + 7);
      *(float *)&v76 = v15 / v16;
      v18 = o_sinf_0(v17 * 0.017453292) * v9;
      v60 = v18 / o_sinf_0((float)(90.0 - v17) * 0.017453292);
      v19 = (__m128)LODWORD(FLOAT_180_0);
      v20 = 180.0 - *((float *)a2 + 8);
      v21 = o_sinf_0(v20 * 0.017453292) * v7;
      v22 = o_sinf_0((float)(90.0 - v20) * 0.017453292);
      v23 = *((float *)a2 + 10);
      v24 = v21 / v22;
      v25 = (__m128)LODWORD(v23);
      *(float *)&v64 = v24;
      v25.m128_f32[0] = o_sinf_0(v23 * 0.017453292);
      v27 = v25;
      v26 = (__m128)LODWORD(FLOAT_90_0);
      v27.m128_f32[0] = v27.m128_f32[0] * v14;
      v26.m128_f32[0] = o_sinf_0((float)(90.0 - v23) * 0.017453292);
      v28 = (__m128)*((unsigned int *)a2 + 11);
      v29 = v26;
      v29.m128_f32[0] = v26.m128_f32[0] * v14;
      v19.m128_f32[0] = (float)(180.0 - v28.m128_f32[0]) * 0.017453292;
      v30 = v19;
      v30.m128_f32[0] = o_sinf_0(v19.m128_f32[0]);
      v31 = v30;
      v31.m128_f32[0] = v30.m128_f32[0] * v14;
      v28.m128_f32[0] = (float)(v28.m128_f32[0] - 90.0) * 0.017453292;
      v32 = v28;
      v32.m128_f32[0] = o_sinf_0(v28.m128_f32[0]);
...
LABEL_53:
        ...
        else
        {
          switch ( v4[1] )
          {
            ...
            case 6u:
              ...
              goto LABEL_53;
            case 7u:
              v59 = (__m128)LODWORD(v77);
              goto LABEL_53;
            case 8u:
              v45 = (__m128)LODWORD(v77);
              break;
            case 9u:
              v59 = v36;
              goto LABEL_53;
      ...
      switch ( v46 )
      {
        ...
        default:
          ...
          {
            case 1u:
              v47 = _mm_xor_ps((__m128)v76, (__m128)(unsigned int)_xmm);
              break;
            case 2u:
              v47 = (__m128)v76;
              break;
            ...
            case 4u:
              ...
              break;
            case 7u:
              v47 = _mm_xor_ps((__m128)LODWORD(v77), (__m128)(unsigned int)_xmm);
              break;
            case 8u:
              v47 = (__m128)LODWORD(v77);
              break;
            case 9u:
...
LABEL_37:
      v48 = _mm_movelh_ps(_mm_unpacklo_ps(v42, v45), _mm_unpacklo_ps(v47, (__m128)0LL));
      *v5 = v48;
      v49 = v48;
      if ( !*((_DWORD *)a2 + 27) )
      {
        ...
        {
          v49 = _mm_mul_ps(_mm_movelh_ps(_mm_unpacklo_ps(v50, v50), _mm_unpacklo_ps(v50, (__m128)0LL)), v48);
          *v5 = v49;
        }
      }
  ...
  {
    v76 = -2147024809;
    v64 = "SpatialAudioPositionCalc::CalculatePositions";
    LODWORD(v77) = 263;
