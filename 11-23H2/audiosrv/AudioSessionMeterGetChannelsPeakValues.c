/*
 * XREFs of AudioSessionMeterGetChannelsPeakValues @ 0x1800E5F20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionMeterGetChannelsPeakValues(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    pftDueTime);
  v9 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v3 + 248LL))(v3, a2, a3);
  v10 = v9;
  if ( v9 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionMeterGetChannelsPeakValues", 2394, v9);
