/*
 * XREFs of ?UpdateCountOfPeriodicitySensitiveClients@CProcessSubmixProxy@@IEAAXH@Z @ 0x18010A6E4
 * Callers:
...
void __fastcall CProcessSubmixProxy::UpdateCountOfPeriodicitySensitiveClients(__int64 this, int a2)
{
  ...
  *(_DWORD *)(this + 96) = v3 + a2;
  if ( v3 != v3 + a2 && (!v3 || !(v3 + a2)) )
    (*(void (__fastcall **)(_QWORD, __int64, _QWORD, __int64))(**(_QWORD **)(this + 200) + 344LL))(
      *(_QWORD *)(this + 200),
