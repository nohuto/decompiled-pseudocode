/*
 * XREFs of ?FindMeterControlForEndpoint@CMeterHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18001D608
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_1be253ce3db13df32524f90bb61ab315_Traceguids, this);
  }
  if ( !a2 )
  {
    v6 = -2147467261;
    ...
    if ( v6 >= 0 )
    {
      ...
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control )
      {
        if ( (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x10000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_qS(
            *((_QWORD *)WPP_GLOBAL_Control + 2),
            14,
            (unsigned int)&WPP_1be253ce3db13df32524f90bb61ab315_Traceguids,
            (_DWORD)this,
            (__int64)pv);
          v7 = WPP_GLOBAL_Control;
        }
        if ( v7 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v7 + 25) >= 4u )
        {
          WPP_SF_q(*((_QWORD *)v7 + 2), 15LL, &WPP_1be253ce3db13df32524f90bb61ab315_Traceguids, this);
          v7 = WPP_GLOBAL_Control;
        }
      }
      v8 = v14;
...
LABEL_15:
        if ( v16 )
        {
          ...
          if ( v6 < 0 )
            goto LABEL_18;
          v10 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, int *))(*(_QWORD *)v15 + 104LL))(
                  v15,
                  0LL,
                  0LL,
                  &v17);
        ...
        if ( v7 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v7 + 25) >= 4u )
        {
          WPP_SF_q(*((_QWORD *)v7 + 2), 16LL, &WPP_1be253ce3db13df32524f90bb61ab315_Traceguids, this);
        }
...
LABEL_18:
  ...
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("CMeterHardware::FindMeterControlForEndpoint", 0x161u, v6);
