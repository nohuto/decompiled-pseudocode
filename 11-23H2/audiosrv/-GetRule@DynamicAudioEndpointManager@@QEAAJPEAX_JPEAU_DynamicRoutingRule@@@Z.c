/*
 * XREFs of ?GetRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x18013F44C
 * Callers:
 *     PolicyConfigGetDynamicRoutingRule @ 0x180117C60 (PolicyConfigGetDynamicRoutingRule.c)
 * Callees:
