/*
 * XREFs of ?Initialize@TelephonyController@@IEAAJXZ @ 0x180166C98
 * Callers:
 ...
 *     ?GetProviderId@TelephonyController@@AEAAJPEAUIKsControl@@PEAI@Z @ 0x1801666F4 (-GetProviderId@TelephonyController@@AEAAJPEAUIKsControl@@PEAI@Z.c)
 *     ?NewNode@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z @ 0x180167634 (-NewNode@-$CAtlList@IV-$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z.c)
...
__int64 __fastcall TelephonyController::Initialize(struct IUnknown **this)
{
  ...
  LPVOID v12; // [rsp+40h] [rbp-81h] BYREF
  __int64 v13; // [rsp+48h] [rbp-79h] BYREF
  struct IKsControl *v14; // [rsp+50h] [rbp-71h] BYREF
  __int64 v15; // [rsp+58h] [rbp-69h] BYREF
  __int64 (__fastcall ***v16)(_QWORD, GUID *, __int64 *); // [rsp+60h] [rbp-61h] BYREF
  __int64 v17; // [rsp+68h] [rbp-59h] BYREF
  __int64 (__fastcall ***v18)(_QWORD, GUID *, __int64 *); // [rsp+70h] [rbp-51h] BYREF
  __int64 v19; // [rsp+78h] [rbp-49h] BYREF
  __int64 v20; // [rsp+80h] [rbp-41h] BYREF
  __int64 v21; // [rsp+88h] [rbp-39h] BYREF
  __int64 v22; // [rsp+90h] [rbp-31h] BYREF
  __int64 v23; // [rsp+98h] [rbp-29h] BYREF
  __int64 (__fastcall ***v24)(_QWORD, GUID *, __int64 *); // [rsp+A0h] [rbp-21h] BYREF
  __int64 v25; // [rsp+A8h] [rbp-19h] BYREF
  __int64 v26; // [rsp+B0h] [rbp-11h] BYREF
  __int64 v27; // [rsp+B8h] [rbp-9h] BYREF
  unsigned int v28; // [rsp+C0h] [rbp-1h] BYREF
  LPVOID ppv; // [rsp+C8h] [rbp+7h] BYREF
  unsigned int v30; // [rsp+D0h] [rbp+Fh] BYREF
  __int64 v31; // [rsp+D8h] [rbp+17h] BYREF
  GUID v32; // [rsp+E0h] [rbp+1Fh] BYREF

  ppv = 0LL;
  v31 = 0LL;
  v28 = 0;
  v2 = 0;
  ProviderId = CoCreateInstance(
                 ...
                 &ppv);
  if ( ProviderId < 0
    || (ProviderId = (*(__int64 (__fastcall **)(LPVOID, __int64, __int64, __int64 *))(*(_QWORD *)ppv + 24LL))(
                       ppv,
                       2LL,
                       9LL,
                       &v31),
        ProviderId < 0)
    || (ProviderId = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v31 + 24LL))(v31, &v28),
        ProviderId < 0) )
  {
LABEL_41:
    ...
    return (unsigned int)ProviderId;
  }
  else
  {
    v4 = 0;
    if ( v28 )
    {
      do
      {
        ...
        ProviderId = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)v31 + 32LL))(v31, v4, &v27);
        if ( ProviderId < 0 )
          goto LABEL_40;
        v5 = (*(__int64 (__fastcall **)(__int64, GUID *, __int64))(*(_QWORD *)v27 + 24LL))(
               v27,
        ...
        if ( v5 >= 0 )
        {
          ...
          if ( ProviderId < 0 )
            goto LABEL_40;
          ProviderId = (**v18)(v18, &GUID_ae2de0e4_5bca_4f2d_aa46_5d13f8fdb3a9, &v13);
          if ( ProviderId < 0 )
            goto LABEL_40;
...
LABEL_40:
            ...
            ProviderId = TelephonyController::GetProviderId(v7, v14, &v30);
            if ( ProviderId < 0 )
              goto LABEL_40;
            ATL::CAtlMap<unsigned int,ATL::CComPtr<ITelephonyControllerCallInstance>,ATL::CElementTraits<unsigned int>,ATL::CElementTraits<ATL::CComPtr<ITelephonyControllerCallInstance>>>::SetAt(
              ...
              v30,
              (struct IUnknown **)&v14);
            v8 = ATL::CAtlList<unsigned int,ATL::CElementTraits<unsigned int>>::NewNode(this + 3, v30, this[4]);
            v9 = (__int64 *)this[4];
            if ( v9 )
              *v9 = v8;
            else
