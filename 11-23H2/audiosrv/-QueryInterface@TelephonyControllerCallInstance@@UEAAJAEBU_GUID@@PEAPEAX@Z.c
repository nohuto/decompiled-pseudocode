/*
 * XREFs of ?QueryInterface@TelephonyControllerCallInstance@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180168450
 * Callers:
 *     ?QueryInterface@TelephonyControllerCallInstance@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180077FF0 (-QueryInterface@TelephonyControllerCallInstance@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
