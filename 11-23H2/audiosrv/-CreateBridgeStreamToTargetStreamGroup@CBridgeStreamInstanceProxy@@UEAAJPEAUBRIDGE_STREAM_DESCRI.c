/*
 * XREFs of ?CreateBridgeStreamToTargetStreamGroup@CBridgeStreamInstanceProxy@@UEAAJPEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIStreamGroupProxy@@PEAUSystemAudioStream@@@Z @ 0x180106220
 * Callers:
 *     <none>
 * Callees:
