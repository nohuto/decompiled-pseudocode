/*
 * XREFs of _CDeviceGraphObjectsStore::GetStreamGroupsConnectedToSaDevice_::_1_::catch$16 @ 0x18010C6F1
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphObjectsStore::GetStreamGroupsConnectedToSaDevice_::_1_::catch_16(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
