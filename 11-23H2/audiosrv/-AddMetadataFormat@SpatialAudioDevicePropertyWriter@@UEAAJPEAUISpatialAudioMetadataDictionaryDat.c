/*
 * XREFs of ?AddMetadataFormat@SpatialAudioDevicePropertyWriter@@UEAAJPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x1801427E0
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( v10 >= 0 )
          {
            ...
            *(_OWORD *)&v23[1] = 0LL;
            ...
            if ( v10 >= 0 )
            {
              ...
              v10 = SpatialAudioDevicePropertyWriter::SetPropertyValue(this, &v24, (struct tagPROPVARIANT *)&v23[1]);
              v9 = v10;
              if ( v10 >= 0 || (unsigned int)dword_1801CD1E8 <= 2 )
                goto LABEL_38;
              v19 = 314;
              v14 = &dword_1801953CC;
            }
