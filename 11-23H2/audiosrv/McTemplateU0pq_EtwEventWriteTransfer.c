/*
 * XREFs of McTemplateU0pq_EtwEventWriteTransfer @ 0x18011BA8C
 * Callers:
...
__int64 __fastcall McTemplateU0pq_EtwEventWriteTransfer(int a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v10 = 0;
  v9 = 4;
  return McGenEventWrite_EtwEventWriteTransfer(a1, (unsigned int)&EVT_VOLUME_LIMIT_CHANGED_EXIT, a3, 3, (__int64)v5);
}
