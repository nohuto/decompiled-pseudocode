/*
 * XREFs of ?_Decwref@_Ref_count_base@std@@QEAAXXZ @ 0x1800C05B8
 * Callers:
 ...
 *     ??1?$enable_shared_from_this@VGestureHandler@@@std@@IEAA@XZ @ 0x1800601C8 (--1-$enable_shared_from_this@VGestureHandler@@@std@@IEAA@XZ.c)
 ...
 *     ??1CustomCursorApplication2@@QEAA@XZ @ 0x180100F64 (--1CustomCursorApplication2@@QEAA@XZ.c)
