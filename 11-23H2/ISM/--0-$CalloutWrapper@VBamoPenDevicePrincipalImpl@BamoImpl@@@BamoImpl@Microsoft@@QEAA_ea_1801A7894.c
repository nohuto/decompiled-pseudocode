/*
 * XREFs of ??0?$CalloutWrapper@VBamoPenDevicePrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoPenDevicePrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1801A7894
 * Callers:
