/*
 * XREFs of ?GetInputInjectionClient@BamoInputSiteElementProxy@@UEAAPEAVBamoInputInjectionClientProxy@@XZ @ 0x1800115F0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoInputInjectionClientProxy *)*((_QWORD *)this + 27);
}
