/*
 * XREFs of ?ClearInputTargets@MPCInputProviderBase@@IEAAXXZ @ 0x1800C5610
 * Callers:
 ...
 *     ?Uninitialize3DComponents@MPCInputProviderBase@@UEAAXXZ @ 0x1800C8370 (-Uninitialize3DComponents@MPCInputProviderBase@@UEAAXXZ.c)
