/*
 * XREFs of ?CreateServerPort@AlpcPort@@SAJAEBU_GUID@@W4SIPC_SERVICE_BOUNDARY@@PEAXAEAPEAVSipcPort@@@Z @ 0x180034F38
 * Callers:
...
LABEL_16:
  ...
  AlpcPortString::AlpcPortString((__int64)v19, (unsigned int *)&xmmword_1802165F0, 1);
