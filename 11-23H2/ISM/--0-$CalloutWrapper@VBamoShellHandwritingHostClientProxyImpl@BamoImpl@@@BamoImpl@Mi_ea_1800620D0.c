/*
 * XREFs of ??0?$CalloutWrapper@VBamoShellHandwritingHostClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoShellHandwritingHostClientProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1800620D0
 * Callers:
