/*
 * XREFs of _std::vector_wil::com_ptr_t_AsyncHRESULTPrincipal_wil::err_exception_policy__std::allocator_wil::com_ptr_t_AsyncHRESULTPrincipal_wil::err_exception_policy_____::_Emplace_reallocate_AsyncHRESULTPrincipal____::_1_::catch$0 @ 0x180181F9B
 * Callers:
 *     <none>
 * Callees:
