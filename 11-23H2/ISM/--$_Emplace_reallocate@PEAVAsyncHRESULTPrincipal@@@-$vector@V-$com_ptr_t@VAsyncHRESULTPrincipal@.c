...
char *__fastcall std::vector<wil::com_ptr_t<AsyncHRESULTPrincipal,wil::err_exception_policy>>::_Emplace_reallocate<AsyncHRESULTPrincipal *>(
        __int64 **a1,
        __int64 *a2,
        _QWORD *a3)
{
