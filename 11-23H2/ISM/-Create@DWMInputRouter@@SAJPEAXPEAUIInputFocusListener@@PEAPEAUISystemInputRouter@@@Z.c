/*
 * XREFs of ?Create@DWMInputRouter@@SAJPEAXPEAUIInputFocusListener@@PEAPEAUISystemInputRouter@@@Z @ 0x1801B8650
 * Callers:
        ...
        struct ISystemInputRouter **a3)
{
  ...
  if ( a1 && a3 )
  {
    v6 = (DWMInputRouter *)RefCountedObject::operator new(0x300uLL);
    v15 = v6;
    if ( v6 )
