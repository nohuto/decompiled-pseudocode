/*
 * XREFs of ?UpdateCursorSuppressionPolicyObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010130
 * Callers:
 *     ?Thunk_UpdateCursorSuppressionPolicyObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019C50 (-Thunk_UpdateCursorSuppressionPolicyObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElem.c)
