/*
 * XREFs of ?DispatchNextCallback@SipcEndpoint@@QEAAJPEAX@Z @ 0x180119C60
 * Callers:
 ...
 *     ?GetNextSectionEvent@SipcPort@@QEAAJAEAUSipcPortEvent@@@Z @ 0x18011A7EC (-GetNextSectionEvent@SipcPort@@QEAAJAEAUSipcPortEvent@@@Z.c)
 */
