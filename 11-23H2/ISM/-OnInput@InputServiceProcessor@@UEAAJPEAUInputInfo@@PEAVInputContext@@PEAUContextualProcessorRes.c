/*
 * XREFs of ?OnInput@InputServiceProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x180170E60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_KeyboardInputVirtualization@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801711D8 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_KeyboardInputVirtualization@@@details@wil.c)
 */
      ...
      *((_QWORD *)v9 + 4) = *((_QWORD *)KeyboardEvent + 4);
      ...
      if ( IsEdition(8778LL) )
      {
        ...
        *(_QWORD *)&v16.UnitId = 0LL;
        v12 = (__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))((char *)a3 + 16);
        if ( *v12 )
        {
          if ( (int)Microsoft::WRL::ComPtr<IInputTarget>::As<IFocusInputTarget>(v12, (__int64 *)&v16) >= 0 )
          {
            v13 = (*(__int64 (__fastcall **)(_QWORD, int *))(**(_QWORD **)&v16.UnitId + 40LL))(
                    *(_QWORD *)&v16.UnitId,
                    &v17);
            if ( v13 < 0 )
