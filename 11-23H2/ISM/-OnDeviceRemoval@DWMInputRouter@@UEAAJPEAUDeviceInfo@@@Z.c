/*
 * XREFs of ?OnDeviceRemoval@DWMInputRouter@@UEAAJPEAUDeviceInfo@@@Z @ 0x1801B99F0
 * Callers:
 *     <none>
 * Callees:
 *     ??R?$_Func_class@XPEAUDeviceInfo@@@std@@QEBAXPEAUDeviceInfo@@@Z @ 0x1801B8430 (--R-$_Func_class@XPEAUDeviceInfo@@@std@@QEBAXPEAUDeviceInfo@@@Z.c)
 */
