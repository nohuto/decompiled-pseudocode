/*
 * XREFs of ?SetAllConstantsForInputTypeToDefault@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x1800AC7D4
 * Callers:
 *     ?Thunk_SetAllConstantsForInputTypeToDefault_21@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800AD200 (-Thunk_SetAllConstantsForInputTypeToDefault_21@-$IMPCConstantManagerClientPrincipal_Receive@VBam.c)
 * Callees:
