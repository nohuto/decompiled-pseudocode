/*
 * XREFs of ?CreateCUIComponentInputObjectProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x180123138
 * Callers:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *(_QWORD *)a3 = 0LL;
  ...
  v9[1] = &BamoCUIComponentInputObjectProxy::`vftable'{for `ICUIComponentInputObjectProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
