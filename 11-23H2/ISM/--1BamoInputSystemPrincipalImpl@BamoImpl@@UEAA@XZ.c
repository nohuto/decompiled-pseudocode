/*
 * XREFs of ??1BamoInputSystemPrincipalImpl@BamoImpl@@UEAA@XZ @ 0x18013C60C
 * Callers:
 *     ??1BamoInputSystemPrincipal@@MEAA@XZ @ 0x18013C5FC (--1BamoInputSystemPrincipal@@MEAA@XZ.c)
 ...
 *     ??1?$com_ptr_t@VBamoShellHandwritingHostServerPrincipal@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x18005E828 (--1-$com_ptr_t@VBamoShellHandwritingHostServerPrincipal@@Uerr_returncode_policy@wil@@@wil@@QEAA@.c)
