/*
 * XREFs of ?Materialize_BamoAsyncResult_string_Proxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800B00DC
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncResult_string_Proxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B2490 (-Thunk_Materialize_BamoAsyncResult_string_Proxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@.c)
 * Callees:
