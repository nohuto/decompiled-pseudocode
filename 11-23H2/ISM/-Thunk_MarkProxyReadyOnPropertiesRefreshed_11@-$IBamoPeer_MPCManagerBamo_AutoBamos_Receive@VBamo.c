/*
 * XREFs of ?Thunk_MarkProxyReadyOnPropertiesRefreshed_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B22F0
 * Callers:
 *     <none>
 * Callees:
