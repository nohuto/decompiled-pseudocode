/*
 * XREFs of ?UpdateActivationConfigurationInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180027450
 * Callers:
 *     ?Thunk_UpdateActivationConfigurationInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019950 (-Thunk_UpdateActivationConfigurationInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSit.c)
      ...
      if ( *((_BYTE *)this + 28) )
      {
        Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
          ...
          *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
          ...
          1);
        v15 = (*(__int64 (__fastcall **)(char *, void (__fastcall ***)(_QWORD)))(*((_QWORD *)this - 2) + 136LL))(
                (char *)this - 16,
                v7);
        if ( v15 < 0 )
          wil::details::in1diag3::FailFast_Hr(
      ...
      if ( *((_BYTE *)this + 28) )
      {
        Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
          ...
          *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
          (void (__fastcall ***)(_QWORD))this,
          2);
        v16 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 144LL))((char *)this - 16);
        if ( v16 < 0 )
          wil::details::in1diag3::FailFast_Hr(
            retaddr,
            (void *)0xB86A,
