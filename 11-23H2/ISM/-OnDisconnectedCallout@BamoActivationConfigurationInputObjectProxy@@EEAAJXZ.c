/*
 * XREFs of ?OnDisconnectedCallout@BamoActivationConfigurationInputObjectProxy@@EEAAJXZ @ 0x18012A030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoActivationConfigurationInputObjectProxy::OnDisconnectedCallout(
        BamoActivationConfigurationInputObjectProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoActivationConfigurationInputObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoActivationConfigurationInputObjectProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoActivationConfigurationInputObjectProxy *))(*(_QWORD *)v1 + 40LL))(v1);
