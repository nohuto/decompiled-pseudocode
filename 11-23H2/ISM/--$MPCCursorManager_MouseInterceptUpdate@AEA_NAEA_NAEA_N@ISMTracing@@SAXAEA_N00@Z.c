/*
 * XREFs of ??$MPCCursorManager_MouseInterceptUpdate@AEA_NAEA_NAEA_N@ISMTracing@@SAXAEA_N00@Z @ 0x1800BCA2C
 * Callers:
...
void __fastcall ISMTracing::MPCCursorManager_MouseInterceptUpdate<bool &,bool &,bool &>(
        const bool *a1,
        const bool *a2,
        const bool *a3)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCCursorManager_MouseInterceptUpdate_(v6, a1, a2, a3);
  }
}
