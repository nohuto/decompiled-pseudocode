/*
 * XREFs of ?NotifyWindowOfInputDisabledStateChange@CUIHierarchy@@AEAAX_KW4InputDisabledState@@1@Z @ 0x18009C6D8
 * Callers:
...
char __fastcall CUIHierarchy::NotifyWindowOfInputDisabledStateChange(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( v5 != result )
  {
    ...
    InputSiteManager::GetInputSiteFromId((__int64)InputSiteManager, (__int64)&v15, 1, a2);
    v9 = v15;
    if ( !v15 )
