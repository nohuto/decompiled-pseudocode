/*
 * XREFs of ?ResizeInProgress@Resize@InputETW@@SAXKPEAUtagPOINT@@0@Z @ 0x180165288
 * Callers:
...
void __fastcall InputETW::Resize::ResizeInProgress(__int64 a1, struct tagPOINT *a2, struct tagPOINT *a3)
{
  __int64 v4; // rsi
  __int64 v6; // rcx
  __int64 v7; // rcx
