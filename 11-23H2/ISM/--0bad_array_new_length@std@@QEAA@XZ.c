/*
 * XREFs of ??0bad_array_new_length@std@@QEAA@XZ @ 0x180097D3C
 * Callers:
 *     ?__scrt_throw_std_bad_array_new_length@@YAXXZ @ 0x180056D88 (-__scrt_throw_std_bad_array_new_length@@YAXXZ.c)
 * Callees:
 *     <none>
 */
