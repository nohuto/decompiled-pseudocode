/*
 * XREFs of _SystemCursorController2::CreateCursorForDevice_::_1_::catch$1 @ 0x180101743
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SystemCursorController2::CreateCursorForDevice_::_1_::catch_1(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
