/*
 * XREFs of ??$_Find_hint@G@?$_Tree@V?$_Tmap_traits@GIU?$less@G@std@@V?$allocator@U?$pair@$$CBGI@std@@@2@$0A@@std@@@std@@IEBA?AU?$_Tree_find_hint_result@PEAU?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@std@@@1@QEAU?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@1@AEBG@Z @ 0x18005AA44
 * Callers:
 ...
 *     ??F?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBGI@std@@@std@@@std@@U_Iterator_base0@2@@std@@QEAAAEAV01@XZ @ 0x18005AC88 (--F-$_Tree_unchecked_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@U-$pair@$$CBGI@std@@@std@.c)
 */
        ...
        unsigned __int16 *a4)
{
  ...
  {
    a1 = qword_180268CA0;
    if ( *(_BYTE *)(*(_QWORD *)(qword_180268CA0 + 8) + 25LL)
      || (v7 = *a4, *(_WORD *)(*(_QWORD *)(qword_180268CA0 + 16) + 28LL) < *a4) )
    {
      *(_QWORD *)a2 = *(_QWORD *)(qword_180268CA0 + 16);
      *(_BYTE *)(a2 + 16) = 0;
LABEL_34:
      *(_DWORD *)(a2 + 8) = 0;
      return a2;
