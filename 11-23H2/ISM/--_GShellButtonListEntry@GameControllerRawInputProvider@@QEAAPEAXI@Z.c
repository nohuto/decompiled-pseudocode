/*
 * XREFs of ??_GShellButtonListEntry@GameControllerRawInputProvider@@QEAAPEAXI@Z @ 0x1800CC9E8
 * Callers:
 *     ??1GameControllerRawInputProvider@@UEAA@XZ @ 0x1800CC844 (--1GameControllerRawInputProvider@@UEAA@XZ.c)
 *     ?ShellButtonListEntryDeletionCallback@GameControllerRawInputProvider@@CAJPEAX@Z @ 0x1800CD8C0 (-ShellButtonListEntryDeletionCallback@GameControllerRawInputProvider@@CAJPEAX@Z.c)
 * Callees:
