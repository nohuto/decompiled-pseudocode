/*
 * XREFs of ?ReadFeatureReport@SpatialRimDevice@SpatialInteractions@Internal@Windows@@UEAAJEPEAEK@Z @ 0x1800E5B30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReadFeatureReport_@RawInputProvidersTracing@@QEAAXJKE@Z @ 0x1800E5BCC (-ReadFeatureReport_@RawInputProvidersTracing@@QEAAXJKE@Z.c)
 */
