/*
 * XREFs of ?EnsureInterfaceAttached@PenDeviceManager@@QEAAXV?$com_ptr_t@VPenInterface@@Uerr_exception_policy@wil@@@wil@@AEBU_GUID@@@Z @ 0x1801A52C4
 * Callers:
 ...
 *     ??0?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@QEAA@PEAVPenDevice@@@Z @ 0x1801A496C (--0-$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@QEAA@PEAVPenDevice@@@Z.c)
 ...
 *     ??0PenDevice@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@AEBU_GUID@@@Z @ 0x1801A7964 (--0PenDevice@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@AEBU_GUID@@@Z.c)
