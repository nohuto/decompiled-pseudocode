/*
 * XREFs of ?UpdateCUIHostInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1800103A0
 * Callers:
 *     ?Thunk_UpdateCUIHostInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019CB0 (-Thunk_UpdateCUIHostInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImp.c)
