/*
 * XREFs of ?OnDisconnectedThunk@BamoMPCManagerClientStubImpl@BamoImpl@@UEAAJXZ @ 0x18017EE00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCManagerClientStubImpl::OnDisconnectedThunk(
