/*
 * XREFs of ?WithinAngle@EdgyRecognizer@@AEAA_NUtagPOINT@@0UVector2@Numerics@Foundation@Windows@@M@Z @ 0x18016A578
 * Callers:
 ...
 *     ?NormalizedDotProduct@MathHelper@@SANUVector2@Numerics@Foundation@Windows@@0@Z @ 0x1801BB58C (-NormalizedDotProduct@MathHelper@@SANUVector2@Numerics@Foundation@Windows@@0@Z.c)
 */
