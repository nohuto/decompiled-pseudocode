/*
 * XREFs of ?OnActivationControllerChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18001E040
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$?RUAttachedInputObjectEntry@InputSite@@@_lambda_04d0ae44debf7fa40e3352da6740393b_@@QEBA?A_PAEBUAttachedInputObjectEntry@InputSite@@@Z @ 0x18001E220 (--$-RUAttachedInputObjectEntry@InputSite@@@_lambda_04d0ae44debf7fa40e3352da6740393b_@@QEBA-A_PAE.c)
        ...
        const char *a4)
{
  ...
  {
    if ( (unsigned __int8)_lambda_04d0ae44debf7fa40e3352da6740393b_::operator()<InputSite::AttachedInputObjectEntry>(
                            &v22,
                            v7) )
      break;
  }
  ...
  v9 = *((_QWORD *)this + 41);
  v10 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 48LL))((char *)this + 8);
  if ( v10 )
  {
    v12 = (__int64 *)(v10 + 8);
    v21[0] = v10 + 8;
