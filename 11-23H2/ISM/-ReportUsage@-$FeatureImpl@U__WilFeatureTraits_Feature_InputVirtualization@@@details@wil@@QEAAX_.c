/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_InputVirtualization@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18017115C
 * Callers:
        ...
        __int64 a4)
{
  ...
  unsigned __int8 v6; // [rsp+38h] [rbp-20h]
  ...
  if ( (*a1 & 2) == 0 )
  {
    v10 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_InputVirtualization>::GetCachedFeatureEnabledState(
                       a1,
                       v7);
    v4 = v10;
  }
  v9 = 3;
  v8 = 0;
  wil::details::ReportUsageToService(a1 + 2, 0xF89686u, (v4 >> 8) & 1, (v4 >> 9) & 1, (__int64)&v8, 1, 0, v6);
}
