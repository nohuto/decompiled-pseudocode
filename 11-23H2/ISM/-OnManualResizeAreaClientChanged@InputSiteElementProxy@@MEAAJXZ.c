/*
 * XREFs of ?OnManualResizeAreaClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000C8F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InputSiteElementProxy::OnManualResizeAreaClientChanged(
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    if ( v24 )
    {
      ...
      v12 = v26(v9, &GUID_cae9ba0c_34ca_09ed_6155_b69e3ed14be6, &v24);
    }
    else
    {
      v12 = v10(v9, &GUID_cae9ba0c_34ca_09ed_6155_b69e3ed14be6, &v24);
    }
    v13 = v12 >= 0;
    if ( v8 == this && v13 )
      break;
  ...
  v15 = *((_QWORD *)this + 41);
  v16 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 232LL))((char *)this + 8);
  if ( v16 )
  {
    v18 = v16 + 8;
    v24 = v16 + 8;
