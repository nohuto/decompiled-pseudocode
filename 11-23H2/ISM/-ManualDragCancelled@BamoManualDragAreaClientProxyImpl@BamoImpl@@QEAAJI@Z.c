/*
 * XREFs of ?ManualDragCancelled@BamoManualDragAreaClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18015998C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoManualDragAreaClientProxyImpl::ManualDragCancelled(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v11[0] = v13;
      v11[1] = v14;
      return CoreUICallSend(v9, v11, 2LL, 66LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
