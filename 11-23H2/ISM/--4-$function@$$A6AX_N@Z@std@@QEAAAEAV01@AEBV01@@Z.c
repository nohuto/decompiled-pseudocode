/*
 * XREFs of ??4?$function@$$A6AX_N@Z@std@@QEAAAEAV01@AEBV01@@Z @ 0x18003415C
 * Callers:
...
__int64 __fastcall std::function<void (bool)>::operator=(__int64 a1)
{
  ...
  if ( v3 == v2 || (v5 = *(_QWORD *)(a1 + 56), v5 == a1) )
  {
    ...
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Tidy(v6);
  }
  else
  {
    *(_QWORD *)(v2 + 56) = v5;
  ...
  std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Tidy(v8);
  return a1;
}
