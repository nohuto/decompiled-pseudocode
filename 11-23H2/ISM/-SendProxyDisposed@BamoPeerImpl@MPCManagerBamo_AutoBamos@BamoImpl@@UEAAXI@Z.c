/*
 * XREFs of ?SendProxyDisposed@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x1800B1A70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::MPCManagerBamo_AutoBamos::BamoPeerImpl::SendProxyDisposed(
