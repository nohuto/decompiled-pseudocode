/*
 * XREFs of ?Initialize@RawButtonProcessor@@AEAAJXZ @ 0x1801D2D2C
 * Callers:
 ...
 *     ?Initialize@PrivateMessageSession@RawButtonProcessor@@QEAAXPEAV2@@Z @ 0x1801D2C54 (-Initialize@PrivateMessageSession@RawButtonProcessor@@QEAAXPEAV2@@Z.c)
 */
