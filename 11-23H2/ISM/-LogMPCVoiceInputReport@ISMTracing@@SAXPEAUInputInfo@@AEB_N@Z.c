/*
 * XREFs of ?LogMPCVoiceInputReport@ISMTracing@@SAXPEAUInputInfo@@AEB_N@Z @ 0x1800C740C
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$00@@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$00@@3333@Z @ 0x1800C4950 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$00@@U1@U1@U1@U1@@-$_tlgWriteTemplat.c)
 */
...
void __fastcall ISMTracing::LogMPCVoiceInputReport(struct InputInfo *a1, const bool *a2)
{
  ...
  int v8; // [rsp+64h] [rbp+1Bh] BYREF
  int v9; // [rsp+68h] [rbp+1Fh] BYREF
  int v10; // [rsp+6Ch] [rbp+23h] BYREF
  int v11; // [rsp+70h] [rbp+27h] BYREF
  int v12; // [rsp+74h] [rbp+2Bh] BYREF
  LPVOID Context; // [rsp+78h] [rbp+2Fh] BYREF
  union _RTL_RUN_ONCE *v14; // [rsp+80h] [rbp+37h] BYREF
