/*
 * XREFs of ?SetOutcome@BamoAsyncHRESULTProxyImpl@BamoImpl@@QEAAJH@Z @ 0x18017DD0C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoAsyncHRESULTProxyImpl::SetOutcome(
        BamoImpl::BamoAsyncHRESULTProxyImpl *this,
        __int64 a2,
        __int64 a3,
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v11[0] = v13;
      v11[1] = v14;
      return CoreUICallSend(v9, v11, 2LL, 0LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
