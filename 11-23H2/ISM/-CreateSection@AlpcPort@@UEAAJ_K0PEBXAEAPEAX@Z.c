/*
 * XREFs of ?CreateSection@AlpcPort@@UEAAJ_K0PEBXAEAPEAX@Z @ 0x1801195E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z @ 0x18011942C (-ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z.c)
