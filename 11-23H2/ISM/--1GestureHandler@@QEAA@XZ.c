/*
 * XREFs of ??1GestureHandler@@QEAA@XZ @ 0x180152C90
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VGestureHandler@@@std@@EEAAXXZ @ 0x180154070 (-_Destroy@-$_Ref_count_obj2@VGestureHandler@@@std@@EEAAXXZ.c)
 * Callees:
