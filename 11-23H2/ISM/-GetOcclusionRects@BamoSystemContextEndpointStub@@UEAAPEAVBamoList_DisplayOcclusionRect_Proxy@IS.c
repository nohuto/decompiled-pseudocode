/*
 * XREFs of ?GetOcclusionRects@BamoSystemContextEndpointStub@@UEAAPEAVBamoList_DisplayOcclusionRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@XZ @ 0x18009EE10
 * Callers:
 *     <none>
 * Callees:
