/*
 * XREFs of ?GetBounds@BamoControllerNavigationOverrideProxy@@UEAAAEBUtagRECT@@XZ @ 0x180192F30
 * Callers:
 *     <none>
 * Callees:
...
const struct tagRECT *__fastcall BamoControllerNavigationOverrideProxy::GetBounds(
