/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x180092990
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  else
  {
    ...
    if ( v35 < 0 )
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x89, (__int64)"wil", (const char *)(unsigned int)v35);
      return v36;
    }
  }
  return 0LL;
