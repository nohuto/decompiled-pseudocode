/*
 * XREFs of ?Close@RIMDeviceCollection@@IEAAXXZ @ 0x1800D4E1C
 * Callers:
 *     ?OnFinalRelease@RIMDeviceCollection@@MEAAXXZ @ 0x1800D4550 (-OnFinalRelease@RIMDeviceCollection@@MEAAXXZ.c)
