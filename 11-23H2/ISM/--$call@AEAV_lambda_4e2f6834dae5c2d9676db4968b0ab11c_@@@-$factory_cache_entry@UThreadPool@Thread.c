/*
 * XREFs of ??$call@AEAV_lambda_4e2f6834dae5c2d9676db4968b0ab11c_@@@?$factory_cache_entry@UThreadPool@Threading@System@Windows@winrt@@UIThreadPoolStatics@2345@@impl@winrt@@QEAA?A_PAEAV_lambda_4e2f6834dae5c2d9676db4968b0ab11c_@@@Z @ 0x1800E2D24
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  if ( v12 && (v13 = 0LL, (**v12)(v12, &winrt::impl::guid_v<winrt::impl::IAgileObject>, &v13), (v8[0] = v13) != 0) )
  {
    ...
    v8[1] = (__int64)&qword_1802695A8;
    _InterlockedIncrement64(&qword_1802695A8);
    ...
    {
      v12 = 0LL;
      WINRT_IMPL_InterlockedPushEntrySList(&`winrt::impl::get_factory_cache'::`2'::cache, &stru_1802695B0);
    }
    winrt::impl::consume_Windows_System_Threading_IThreadPoolStatics<winrt::Windows::System::Threading::IThreadPoolStatics>::RunAsync(
      ...
      a2,
      *a3);
    _InterlockedDecrement64(&qword_1802695A8);
    v6 = v12 == 0LL;
  }
  else
  {
