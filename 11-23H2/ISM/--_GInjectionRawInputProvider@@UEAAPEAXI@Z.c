/*
 * XREFs of ??_GInjectionRawInputProvider@@UEAAPEAXI@Z @ 0x1800E7EC0
 * Callers:
 *     ??_EInjectionRawInputProvider@@W7EAAPEAXI@Z @ 0x180066410 (--_EInjectionRawInputProvider@@W7EAAPEAXI@Z.c)
 * Callees:
