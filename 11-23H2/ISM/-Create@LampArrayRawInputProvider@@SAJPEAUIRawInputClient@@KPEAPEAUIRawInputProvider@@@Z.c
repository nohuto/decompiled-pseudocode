/*
 * XREFs of ?Create@LampArrayRawInputProvider@@SAJPEAUIRawInputClient@@KPEAPEAUIRawInputProvider@@@Z @ 0x18004A570
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IRawInputProvider **a3)
{
  ...
  if ( (unsigned int)dword_180266498 > 5 )
  {
    ...
    v13 = 102;
    v14 = 0;
    tlgWriteTransfer_EventWriteTransfer((int)&dword_180266498, (int)&dword_180224336, 0, 0, 3u, &v11);
  }
  if ( !a3 )
  {
    v10 = -2147024809;
