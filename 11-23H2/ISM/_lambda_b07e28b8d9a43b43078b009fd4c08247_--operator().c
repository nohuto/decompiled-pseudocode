/*
 * XREFs of _lambda_b07e28b8d9a43b43078b009fd4c08247_::operator() @ 0x180184F28
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_b07e28b8d9a43b43078b009fd4c08247__Windows::Internal::CMarshaledInterfaceResult_Windows::Foundation::Collections::IVector_HSTRING_________::Run @ 0x18018B490 (Windows--Internal--COperationLambdaVar_0__lambda_b07e28b8d9a43b43078b009fd4c08247___ea_18018B490.c)
 * Callees:
 ...
 *     ??$GetDeferral@V?$CMarshaledInterfaceResult@U?$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@@Internal@Windows@@@CResultBase@Internal@Windows@@QEAA?AV?$AsyncDeferral@V?$CMarshaledInterfaceResult@U?$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@@Internal@Windows@@@12@AEAV?$CMarshaledInterfaceResult@U?$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@@12@@Z @ 0x180180D44 (--$GetDeferral@V-$CMarshaledInterfaceResult@U-$IVector@PEAUHSTRING__@@@Collections@Foundation@Wi.c)
...
__int64 __fastcall lambda_b07e28b8d9a43b43078b009fd4c08247_::operator()(unsigned int *a1, __int64 a2)
{
  ...
  v5 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 32LL) + 248LL);
