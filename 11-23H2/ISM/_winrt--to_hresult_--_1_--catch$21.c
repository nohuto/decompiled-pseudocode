/*
 * XREFs of _winrt::to_hresult_::_1_::catch$21 @ 0x18009AB31
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0hresult_error@winrt@@QEAA@Uhresult@1@AEBUhstring@param@1@@Z @ 0x18009888C (--0hresult_error@winrt@@QEAA@Uhresult@1@AEBUhstring@param@1@@Z.c)
...
__int64 __fastcall winrt::to_hresult_::_1_::catch_21(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 88) = *winrt::to_hstring<char const *,0>(
                            ...
                            (const CHAR **)(a2 + 152));
  winrt::hresult_error::hresult_error(a2 + 64, winrt::impl::error_out_of_bounds, (_QWORD *)(a2 + 88));
