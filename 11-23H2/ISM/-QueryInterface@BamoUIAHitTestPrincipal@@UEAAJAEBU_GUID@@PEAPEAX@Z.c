/*
 * XREFs of ?QueryInterface@BamoUIAHitTestPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801D78E0
 * Callers:
 *     ?QueryInterface@BamoUIAHitTestPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006AE30 (-QueryInterface@BamoUIAHitTestPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
