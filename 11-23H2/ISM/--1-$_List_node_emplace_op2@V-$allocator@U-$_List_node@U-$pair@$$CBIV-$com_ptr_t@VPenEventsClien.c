/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBIV?$com_ptr_t@VPenEventsClientCustomProxy@@Uerr_exception_policy@wil@@@wil@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800549BC
 * Callers:
        ...
        __int64 a1)
{
  ...
  v2 = *(_QWORD *)(a1 + 8);
  if ( v2 )
    wil::com_ptr_t<BamoSimpleHapticsControllerProxy,wil::err_returncode_policy>::~com_ptr_t<BamoSimpleHapticsControllerProxy,wil::err_returncode_policy>(v2 + 24);
  v3 = *(void **)(a1 + 8);
  if ( v3 )
