/*
 * XREFs of ?get_marshaler@marshaler@?1??make_marshaler@impl@winrt@@YAHPEAUtype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@34@PEAPEAX@Z@CA?AU?$com_ptr@UIMarshal@impl@winrt@@@4@XZ @ 0x18009A3C0
 * Callers:
 ...
 *     WINRT_IMPL_CoCreateFreeThreadedMarshaler @ 0x1800571AE (WINRT_IMPL_CoCreateFreeThreadedMarshaler.c)
