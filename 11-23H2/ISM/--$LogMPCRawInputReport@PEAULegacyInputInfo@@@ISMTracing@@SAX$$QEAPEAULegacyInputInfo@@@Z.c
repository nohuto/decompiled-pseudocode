/*
 * XREFs of ??$LogMPCRawInputReport@PEAULegacyInputInfo@@@ISMTracing@@SAX$$QEAPEAULegacyInputInfo@@@Z @ 0x1800CE188
 * Callers:
...
void __fastcall ISMTracing::LogMPCRawInputReport<LegacyInputInfo *>(struct LegacyInputInfo **a1)
{
  ISMTracing *v2; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::LogMPCRawInputReport_(v2, *a1);
  }
}
