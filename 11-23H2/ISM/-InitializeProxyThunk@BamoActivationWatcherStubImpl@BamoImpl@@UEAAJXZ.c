/*
 * XREFs of ?InitializeProxyThunk@BamoActivationWatcherStubImpl@BamoImpl@@UEAAJXZ @ 0x1800193C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoActivationWatcherStubImpl::InitializeProxyThunk(
