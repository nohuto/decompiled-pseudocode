/*
 * XREFs of ?GetDeliveryMode@BamoManualDragAreaClientProxy@@UEAA?AW4InputDeliveryMode@Input@Internal@UI@Windows@@XZ @ 0x1801598C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoManualDragAreaClientProxy::GetDeliveryMode(__int64 a1)
{
  __int64 v1; // rbx
  __int64 v2; // rdx
  __int64 v3; // r8
