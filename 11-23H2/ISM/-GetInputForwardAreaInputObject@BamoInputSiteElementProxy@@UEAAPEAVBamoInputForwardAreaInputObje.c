/*
 * XREFs of ?GetInputForwardAreaInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoInputForwardAreaInputObjectProxy@@XZ @ 0x1800116D0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoInputForwardAreaInputObjectProxy *)*((_QWORD *)this + 25);
}
