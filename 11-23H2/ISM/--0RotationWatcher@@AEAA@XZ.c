/*
 * XREFs of ??0RotationWatcher@@AEAA@XZ @ 0x180116E88
 * Callers:
...
RotationWatcher *__fastcall RotationWatcher::RotationWatcher(RotationWatcher *this)
{
  ...
  v6 = v4;
  if ( &qword_180268E88 != v4 )
  {
    v7 = *v4;
    v8 = (wil::details *)qword_180268E88;
    if ( qword_180268E88 )
    {
  ...
  return (RotationWatcher *)&qword_180268E88;
}
