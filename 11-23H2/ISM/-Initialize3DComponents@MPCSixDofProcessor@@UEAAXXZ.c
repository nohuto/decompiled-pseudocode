/*
 * XREFs of ?Initialize3DComponents@MPCSixDofProcessor@@UEAAXXZ @ 0x1801DE030
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$make_unique@VMPCSlateDeadzoneHelper@@MM$0A@@std@@YA?AV?$unique_ptr@VMPCSlateDeadzoneHelper@@U?$default_delete@VMPCSlateDeadzoneHelper@@@std@@@0@$$QEAM0@Z @ 0x1800BDF08 (--$make_unique@VMPCSlateDeadzoneHelper@@MM$0A@@std@@YA-AV-$unique_ptr@VMPCSlateDeadzoneHelper@@U.c)
 ...
 *     ??$make_unique@VMPCButtonHoldHelper@@AEBM$0A@@std@@YA?AV?$unique_ptr@VMPCButtonHoldHelper@@U?$default_delete@VMPCButtonHoldHelper@@@std@@@0@AEBM@Z @ 0x1801DC2D4 (--$make_unique@VMPCButtonHoldHelper@@AEBM$0A@@std@@YA-AV-$unique_ptr@VMPCButtonHoldHelper@@U-$de.c)
...
void __fastcall MPCSixDofProcessor::Initialize3DComponents(MPCSixDofProcessor *this)
{
  ...
  __int64 (__fastcall ***v38)(_QWORD, __int64); // [rsp+68h] [rbp+38h] BYREF
  void *v39; // [rsp+70h] [rbp+40h] BYREF
  void *v40; // [rsp+78h] [rbp+48h] BYREF

  v2 = (char *)this - 24;
  v38 = (__int64 (__fastcall ***)(_QWORD, __int64))((char *)this - 24);
  ...
  v8 = (__int64 *)std::make_unique<MPCButtonHoldHelper,float const &,0>(&fPending, &flt_180231A40);
  std::unique_ptr<MPCButtonHoldHelper>::operator=<std::default_delete<MPCButtonHoldHelper>,0>((__int64 *)this + 510, v8);
  if ( fPending )
    std::default_delete<MPCButtonHoldHelper>::operator()(v9, (__int64 (__fastcall ***)(_QWORD, __int64))fPending);
  ...
  *((_QWORD *)&v35 + 1) = 30LL;
  ...
  std::unique_ptr<MPCButtonHoldHelper>::operator=<std::default_delete<MPCButtonHoldHelper>,0>(
    ...
    v17);
  if ( v39 )
    std::default_delete<MPCButtonHoldHelper>::operator()(v18, (__int64 (__fastcall ***)(_QWORD, __int64))v39);
  if ( !MPCConstantManager::s_instance )
    wil::details::in1diag3::_FailFast_Unexpected(
      retaddr,
      (void *)0x29,
  ...
  *((_QWORD *)&v35 + 1) = 32LL;
  ...
  std::unique_ptr<MPCButtonHoldHelper>::operator=<std::default_delete<MPCButtonHoldHelper>,0>(
    ...
    v23);
  if ( v39 )
    std::default_delete<MPCButtonHoldHelper>::operator()(v24, (__int64 (__fastcall ***)(_QWORD, __int64))v39);
  if ( !MPCConstantManager::s_instance )
    wil::details::in1diag3::_FailFast_Unexpected(
      retaddr,
      (void *)0x29,
