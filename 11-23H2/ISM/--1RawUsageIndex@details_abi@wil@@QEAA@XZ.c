/*
 * XREFs of ??1RawUsageIndex@details_abi@wil@@QEAA@XZ @ 0x180092514
 * Callers:
 *     _wil::details_abi::RecordWnfUsageIndex_::_1_::dtor$0 @ 0x18009487D (_wil--details_abi--RecordWnfUsageIndex_--_1_--dtor$0.c)
 * Callees:
