/*
 * XREFs of ?OnForegroundTransferFromComponent@BamoCUIHostInputObjectProxyImpl@BamoImpl@@QEAAJAEBUTransferForegroundInfo@@@Z @ 0x18014117C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v15 = v12;
      v16 = v13;
      return CoreUICallSend(v10, v14, 2LL, 13LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
