/*
 * XREFs of ?_Move@?$_Func_impl_no_alloc@V?$_Binder@U_Unforced@std@@P8MPCHolographicInputManager@@EAAX_N@ZPEAV3@AEBU?$_Ph@$00@2@@std@@X_N@std@@EEAAPEAV?$_Func_base@X_N@2@PEAX@Z @ 0x18002AD30
 * Callers:
 *     <none>
 * Callees:
 *     <none>
