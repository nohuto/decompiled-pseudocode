/*
 * XREFs of ??$_Construct_in_place@VCustomCursorApplication2@@V?$shared_ptr@VSystemCursorService2@@@std@@AEAIAEAPEAVBamoCustomCursorControllerClient2Proxy@@@std@@YAXAEAVCustomCursorApplication2@@$$QEAV?$shared_ptr@VSystemCursorService2@@@0@AEAIAEAPEAVBamoCustomCursorControllerClient2Proxy@@@Z @ 0x180100AE8
 * Callers:
