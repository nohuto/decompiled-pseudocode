/*
 * XREFs of ?OnInput@TapProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801D22A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ResetAndInitializeInteractionContext@TapProcessor@@AEAAJXZ @ 0x1801D2470 (-ResetAndInitializeInteractionContext@TapProcessor@@AEAAJXZ.c)
 */
