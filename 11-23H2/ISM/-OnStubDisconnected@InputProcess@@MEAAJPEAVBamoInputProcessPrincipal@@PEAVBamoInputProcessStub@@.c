/*
 * XREFs of ?OnStubDisconnected@InputProcess@@MEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoInputProcessStub@@@Z @ 0x1800CB040
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoInputProcessStub *a3)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v6, (unsigned __int8 *)dword_180222F30, 0LL, 0LL, 2u, &v8);
  }
