/*
 * XREFs of ??_GLampArrayRawInputProvider@@EEAAPEAXI@Z @ 0x1800E8F20
 * Callers:
 *     ??_ELampArrayRawInputProvider@@GBI@EAAPEAXI@Z @ 0x180066450 (--_ELampArrayRawInputProvider@@GBI@EAAPEAXI@Z.c)
 * Callees:
