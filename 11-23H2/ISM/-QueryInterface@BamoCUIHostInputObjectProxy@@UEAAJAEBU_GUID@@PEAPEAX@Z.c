/*
 * XREFs of ?QueryInterface@BamoCUIHostInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180141460
 * Callers:
 *     ?QueryInterface@BamoCUIHostInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180067950 (-QueryInterface@BamoCUIHostInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
