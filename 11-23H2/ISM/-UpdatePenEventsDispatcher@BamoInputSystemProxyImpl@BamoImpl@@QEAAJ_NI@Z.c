/*
 * XREFs of ?UpdatePenEventsDispatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180139048
 * Callers:
 *     ?Thunk_UpdatePenEventsDispatcher_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134140 (-Thunk_UpdatePenEventsDispatcher_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
