/*
 * XREFs of ?Initialize@PointerFrame@PointerInputMediator@@QEAAXPEBUtagMANIPULATION_INPUT_INFO@@@Z @ 0x18005B088
 * Callers:
 ...
 *     ??1ContactData@PointerInputMediator@@QEAA@XZ @ 0x1800FCCD4 (--1ContactData@PointerInputMediator@@QEAA@XZ.c)
