/*
 * XREFs of ?QueryInterface@BamoSystemContextEndpointPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18009F5C0
 * Callers:
 *     ?QueryInterface@BamoSystemContextEndpointPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180065B90 (-QueryInterface@BamoSystemContextEndpointPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
