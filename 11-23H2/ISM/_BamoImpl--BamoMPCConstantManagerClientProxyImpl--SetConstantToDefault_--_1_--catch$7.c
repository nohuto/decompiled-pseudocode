/*
 * XREFs of _BamoImpl::BamoMPCConstantManagerClientProxyImpl::SetConstantToDefault_::_1_::catch$7 @ 0x18017D570
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn BamoImpl::BamoMPCConstantManagerClientProxyImpl::SetConstantToDefault_::_1_::catch_7(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
