/*
 * XREFs of ??1DeviceAttached@RawInputProvidersTracing@@QEAA@XZ @ 0x1800D7B48
 * Callers:
 ...
 *     _SpatialRimDeviceCollection::DoDeviceAttach_::_1_::dtor$0 @ 0x1800D8890 (_SpatialRimDeviceCollection--DoDeviceAttach_--_1_--dtor$0.c)
 * Callees:
