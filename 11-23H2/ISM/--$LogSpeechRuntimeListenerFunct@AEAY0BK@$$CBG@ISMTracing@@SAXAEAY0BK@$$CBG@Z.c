/*
 * XREFs of ??$LogSpeechRuntimeListenerFunct@AEAY0BK@$$CBG@ISMTracing@@SAXAEAY0BK@$$CBG@Z @ 0x1800D3070
 * Callers:
...
void __fastcall ISMTracing::LogSpeechRuntimeListenerFunct<unsigned short const (&)[26]>(__int64 a1)
{
  ISMTracing *v1; // rcx
  ...
  if ( ISMTracing::IsEnabled(a1) )
  {
    ...
    ISMTracing::LogSpeechRuntimeListenerFunct_(v1, L"InitializingCoreMessaging");
  }
}
