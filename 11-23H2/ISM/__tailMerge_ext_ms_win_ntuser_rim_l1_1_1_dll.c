/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_rim_l1_1_1_dll @ 0x180057D3C
 * Callers:
 *     __imp_load_InitializePointerDeviceInjectionEx @ 0x180057D30 (__imp_load_InitializePointerDeviceInjectionEx.c)
 * Callees:
