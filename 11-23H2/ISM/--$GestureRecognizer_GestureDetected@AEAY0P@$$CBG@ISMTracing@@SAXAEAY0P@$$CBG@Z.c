/*
 * XREFs of ??$GestureRecognizer_GestureDetected@AEAY0P@$$CBG@ISMTracing@@SAXAEAY0P@$$CBG@Z @ 0x1800C104C
 * Callers:
...
void __fastcall ISMTracing::GestureRecognizer_GestureDetected<unsigned short const (&)[15]>(__int64 a1)
{
  ISMTracing *v1; // rcx
  ...
  if ( ISMTracing::IsEnabled(a1) )
  {
    ...
    ISMTracing::GestureRecognizer_GestureDetected_(v1, L"ScrollCanceled");
  }
}
