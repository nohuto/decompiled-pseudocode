/*
 * XREFs of _BamoImpl::BamoInputSiteManagerProxyImpl::RegisterInputSiteElementWithHint_::_1_::catch$7 @ 0x180130B1F
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn BamoImpl::BamoInputSiteManagerProxyImpl::RegisterInputSiteElementWithHint_::_1_::catch_7(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
