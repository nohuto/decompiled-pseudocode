/*
 * XREFs of ?SetSuppressionState@SystemCursor2@@QEAAJ_N@Z @ 0x180106C54
 * Callers:
 ...
 *     ?GetEffectiveVisibiltyState@SystemCursor2@@AEBA_NXZ @ 0x180105840 (-GetEffectiveVisibiltyState@SystemCursor2@@AEBA_NXZ.c)
