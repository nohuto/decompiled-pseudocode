/*
 * XREFs of ?_Incref_nz@_Ref_count_base@std@@QEAA_NXZ @ 0x180106E14
 * Callers:
 ...
 *     ?CustomCursor@SystemCursorService2@@UEAA?AV?$shared_ptr@VSystemCursor2@@@std@@XZ @ 0x180105560 (-CustomCursor@SystemCursorService2@@UEAA-AV-$shared_ptr@VSystemCursor2@@@std@@XZ.c)
 * Callees:
 *     <none>
 */
