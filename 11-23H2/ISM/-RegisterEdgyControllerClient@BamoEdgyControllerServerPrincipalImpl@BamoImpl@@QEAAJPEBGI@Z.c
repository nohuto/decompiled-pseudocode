/*
 * XREFs of ?RegisterEdgyControllerClient@BamoEdgyControllerServerPrincipalImpl@BamoImpl@@QEAAJPEBGI@Z @ 0x18016BDF0
 * Callers:
 *     ?Thunk_RegisterEdgyControllerClient_175@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016C010 (-Thunk_RegisterEdgyControllerClient_175@-$IEdgyControllerServerPrincipal_Receive@VBamoEdgyContro.c)
 * Callees:
