/*
 * XREFs of ?ReadFeatureReport_@RawInputProvidersTracing@@QEAAXJKE@Z @ 0x1800E5BCC
 * Callers:
...
void __fastcall RawInputProvidersTracing::ReadFeatureReport_(RawInputProvidersTracing *this, int a2, int a3, char a4)
{
  ...
  if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 2) != 0 && (*(_QWORD *)(v7 + 24) & 2LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    v10 = a2;
    v17 = 1LL;
    tlgWriteTransfer_EventWriteTransfer(v7, (unsigned __int8 *)dword_180224296, 0LL, 0LL, 5u, &v11);
  }
}
