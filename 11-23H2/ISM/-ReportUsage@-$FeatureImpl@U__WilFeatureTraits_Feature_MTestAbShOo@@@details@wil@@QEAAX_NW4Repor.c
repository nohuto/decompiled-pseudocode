/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_MTestAbShOo@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800646BC
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_MTestAbShOo>::ReportUsage(
        ...
        __int64 a4)
{
  ...
  if ( (*a1 & 2) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_MTestAbShOo>::GetCachedFeatureEnabledState(
                      a1,
                      v8);
    v11 = v4;
  }
