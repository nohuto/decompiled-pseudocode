/*
 * XREFs of ?ProcessResult@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJIPEBUDragOperationResult@Input@Internal@UI@Windows@@I@Z @ 0x180153484
 * Callers:
 *     ?Thunk_ProcessResult_212@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800611E0 (-Thunk_ProcessResult_212@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@B.c)
 * Callees:
...
LABEL_18:
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    v19 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, const struct Windows::UI::Internal::Input::DragOperationResult *))(*((_QWORD *)this - 2) + 120LL))(
            (char *)this - 16,
            v23,
            a2,
            a3);
