/*
 * XREFs of ??1?$list@U?$pair@$$CB_KUInputObserverClient@?$CBaseInputObserverServer@$0L@@@@std@@V?$allocator@U?$pair@$$CB_KUInputObserverClient@?$CBaseInputObserverServer@$0L@@@@std@@@2@@std@@QEAA@XZ @ 0x1801487F4
 * Callers:
 *     _CBaseInputObserverServer_11_::CBaseInputObserverServer_11__::_1_::dtor$12 @ 0x18006DD68 (_CBaseInputObserverServer_11_--CBaseInputObserverServer_11__--_1_--dtor$12.c)
 * Callees:
