/*
 * XREFs of ??0?$CalloutWrapper@VBamoInputDeliveryServerProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputDeliveryServerProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18011F20C
 * Callers:
