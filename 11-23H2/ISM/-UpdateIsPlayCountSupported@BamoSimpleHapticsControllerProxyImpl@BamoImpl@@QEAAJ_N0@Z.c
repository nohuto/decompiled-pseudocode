/*
 * XREFs of ?UpdateIsPlayCountSupported@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180138610
 * Callers:
 *     ?Thunk_UpdateIsPlayCountSupported_11@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134060 (-Thunk_UpdateIsPlayCountSupported_11@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsC.c)
