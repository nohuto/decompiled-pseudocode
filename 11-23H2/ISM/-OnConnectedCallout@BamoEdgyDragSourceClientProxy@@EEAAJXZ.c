/*
 * XREFs of ?OnConnectedCallout@BamoEdgyDragSourceClientProxy@@EEAAJXZ @ 0x1801295B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoEdgyDragSourceClientProxy::OnConnectedCallout(BamoEdgyDragSourceClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoEdgyDragSourceClientProxyImpl>::CalloutWrapper<BamoImpl::BamoEdgyDragSourceClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoEdgyDragSourceClientProxy *))(*(_QWORD *)v1 + 32LL))(v1);
