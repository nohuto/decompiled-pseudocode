/*
 * XREFs of ?RuntimeClassInitialize@MPCManagerClient@@QEAAJXZ @ 0x18017CAEC
 * Callers:
 ...
 *     ??0MPCManagerClientPrincipal@@QEAA@PEAVMPCManagerClientConnection@@PEAVMPCManagerClient@@@Z @ 0x18017E9D4 (--0MPCManagerClientPrincipal@@QEAA@PEAVMPCManagerClientConnection@@PEAVMPCManagerClient@@@Z.c)
 */
...
__int64 __fastcall MPCManagerClient::RuntimeClassInitialize(MPCManagerClient *this)
{
  ...
  const char *v4; // r9
  __int64 *v5; // rcx
  struct MPCManagerClientConnection **v6; // rdi
  ...
  if ( !v18 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\inputhost\\components\\mpcmanager\\lib\\mpcmanagerclient.cpp",
      v4);
  v6 = (struct MPCManagerClientConnection **)((char *)this + 1624);
  ...
  *((_QWORD *)this + 203) = 0LL;
  ...
  v16[2] = 1;
  *(_QWORD *)v16 = 0LL;
  v8 = Microsoft::Bamo::BaseBamoConnection::CreateClient<MPCManagerClientConnection>(v5, v16, v3, (_QWORD *)this + 203);
  if ( v8 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x21,
  ...
  v9 = MPCManagerClientPrincipal::MPCManagerClientPrincipal(v19, *v6, this);
  v11 = *((_QWORD *)this + 202);
  *((_QWORD *)this + 202) = v9;
  if ( v11 )
