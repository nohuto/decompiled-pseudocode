/*
 * XREFs of ?RegisterInputAttemptedClient@BamoInputDeliveryServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18017343C
 * Callers:
 *     ?Thunk_RegisterInputAttemptedClient_8@?$IInputDeliveryServerPrincipal_Receive@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180173690 (-Thunk_RegisterInputAttemptedClient_8@-$IInputDeliveryServerPrincipal_Receive@VBamoInputDelivery.c)
 * Callees:
