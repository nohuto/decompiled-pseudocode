/*
 * XREFs of ??0?$CalloutWrapper@VBamoDropTargetClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoDropTargetClientProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18004D208
 * Callers:
