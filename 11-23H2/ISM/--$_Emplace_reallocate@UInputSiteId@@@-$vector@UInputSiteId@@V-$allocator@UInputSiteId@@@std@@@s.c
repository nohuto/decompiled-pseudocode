/*
 * XREFs of ??$_Emplace_reallocate@UInputSiteId@@@?$vector@UInputSiteId@@V?$allocator@UInputSiteId@@@std@@@std@@QEAAPEAUInputSiteId@@QEAU2@$$QEAU2@@Z @ 0x180002970
 * Callers:
 ...
 * Callees:
 *     ?_Change_array@?$vector@UInputSiteId@@V?$allocator@UInputSiteId@@@std@@@std@@AEAAXQEAUInputSiteId@@_K1@Z @ 0x180002A5C (-_Change_array@-$vector@UInputSiteId@@V-$allocator@UInputSiteId@@@std@@@std@@AEAAXQEAUInputSiteI.c)
