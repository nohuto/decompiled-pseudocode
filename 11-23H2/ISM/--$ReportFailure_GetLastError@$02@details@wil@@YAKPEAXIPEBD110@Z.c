/*
 * XREFs of ??$ReportFailure_GetLastError@$02@details@wil@@YAKPEAXIPEBD110@Z @ 0x180090CEC
 * Callers:
 ...
 *     ?_FailFast_GetLastError@in1diag0@details@wil@@YAXXZ @ 0x18011B5B4 (-_FailFast_GetLastError@in1diag0@details@wil@@YAXXZ.c)
 * Callees:
 ...
 *     ?GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z @ 0x180093170 (-GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z.c)
 */
