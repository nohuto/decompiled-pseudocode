/*
 * XREFs of ?UpdateWindowsMessageDelivery@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000EEB0
 * Callers:
 *     ?Thunk_UpdateWindowsMessageDelivery_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019970 (-Thunk_UpdateWindowsMessageDelivery_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
