/*
 * XREFs of ?GetTailButtonDoubleClickedEventsRequired@BamoPenEventsClientProxy@@UEAA_NXZ @ 0x1801AEB00
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoPenEventsClientProxy::GetTailButtonDoubleClickedEventsRequired(BamoPenEventsClientProxy *this)
{
