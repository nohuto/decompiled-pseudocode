/*
 * XREFs of ??1?$out_param_t@V?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?DestroyPrivateObjectSecurity@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@@wil@@@details@wil@@QEAA@XZ @ 0x18005C4A0
 * Callers:
 ...
 * Callees:
 *     ??1last_error_context@wil@@QEAA@XZ @ 0x18009266C (--1last_error_context@wil@@QEAA@XZ.c)
 */
