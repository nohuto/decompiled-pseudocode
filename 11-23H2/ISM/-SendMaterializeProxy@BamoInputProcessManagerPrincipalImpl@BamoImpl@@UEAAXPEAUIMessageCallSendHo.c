/*
 * XREFs of ?SendMaterializeProxy@BamoInputProcessManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801B4700
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoInputProcessManagerPrincipalImpl::SendMaterializeProxy(
