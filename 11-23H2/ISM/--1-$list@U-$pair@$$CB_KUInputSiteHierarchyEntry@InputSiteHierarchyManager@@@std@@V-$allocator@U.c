/*
 * XREFs of ??1?$list@U?$pair@$$CB_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@@std@@V?$allocator@U?$pair@$$CB_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@@std@@@2@@std@@QEAA@XZ @ 0x18013E290
 * Callers:
 *     _InputSiteHierarchyManager::InputSiteHierarchyManager_::_1_::dtor$11 @ 0x18006DBCD (_InputSiteHierarchyManager--InputSiteHierarchyManager_--_1_--dtor$11.c)
 * Callees:
