/*
 * XREFs of ?OnDisconnectedCallout@BamoEdgyControllerClientProxy@@EEAAJXZ @ 0x18016AF00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoEdgyControllerClientProxy::OnDisconnectedCallout(BamoEdgyControllerClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoEdgyControllerClientProxyImpl>::CalloutWrapper<BamoImpl::BamoEdgyControllerClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoEdgyControllerClientProxy *))(*(_QWORD *)v1 + 40LL))(v1);
