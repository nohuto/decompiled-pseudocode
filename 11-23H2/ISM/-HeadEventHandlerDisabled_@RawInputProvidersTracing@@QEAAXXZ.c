/*
 * XREFs of ?HeadEventHandlerDisabled_@RawInputProvidersTracing@@QEAAXXZ @ 0x1800D921C
 * Callers:
...
void __fastcall RawInputProvidersTracing::HeadEventHandlerDisabled_(RawInputProvidersTracing *this)
{
  ...
  if ( *(_DWORD *)v1 > 4u && (*(_BYTE *)(v1 + 16) & 2) != 0 && (*(_QWORD *)(v1 + 24) & 2LL) == *(_QWORD *)(v1 + 24) )
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_180223B86, 0LL, 0LL, 2u, &v2);
}
