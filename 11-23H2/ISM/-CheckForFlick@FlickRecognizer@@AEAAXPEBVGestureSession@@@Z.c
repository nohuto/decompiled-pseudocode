/*
 * XREFs of ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x1801D4464
 * Callers:
 ...
 * Callees:
 *     ?FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ @ 0x1801D4598 (-FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ.c)
 */
