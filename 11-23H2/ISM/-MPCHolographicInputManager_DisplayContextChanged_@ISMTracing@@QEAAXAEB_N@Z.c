/*
 * XREFs of ?MPCHolographicInputManager_DisplayContextChanged_@ISMTracing@@QEAAXAEB_N@Z @ 0x1800B59C0
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_DisplayContextChanged_(ISMTracing *this, const bool *a2)
{
  ...
  if ( ISMTracing::IsEnabled((char)this) )
  {
    ...
    if ( *(_DWORD *)v3 > 4u && (*(_BYTE *)(v3 + 16) & 1) != 0 && (*(_QWORD *)(v3 + 24) & 1LL) == *(_QWORD *)(v3 + 24) )
    {
      ...
      v12 = 1;
      v11 = &v5;
      tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_18022173C, 0LL, 0LL, 3u, &v10);
    }
  }
}
