/*
 * XREFs of ?QueryInterface@BamoShellHandwritingHostClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180062610
 * Callers:
 *     ?QueryInterface@BamoShellHandwritingHostClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180068290 (-QueryInterface@BamoShellHandwritingHostClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
