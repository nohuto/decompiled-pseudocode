 ...
 *     ?_Forced_rehash@?$_Hash@V?$_Umap_traits@PEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@V?$_Uhash_compare@PEAVVirtualTouchpadControllerProxy@@U?$hash@PEAVVirtualTouchpadControllerProxy@@@std@@U?$equal_to@PEAVVirtualTouchpadControllerProxy@@@3@@std@@V?$allocator@U?$pair@QEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@@std@@@4@$0A@@std@@@std@@IEAAX_K@Z @ 0x180146CBC (-_Forced_rehash@-$_Hash@V-$_Umap_traits@PEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@V-$_Uhash_.c)
 *     ?_Insert_new_node_before@?$_Hash@V?$_Umap_traits@PEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@V?$_Uhash_compare@PEAVVirtualTouchpadControllerProxy@@U?$hash@PEAVVirtualTouchpadControllerProxy@@@std@@U?$equal_to@PEAVVirtualTouchpadControllerProxy@@@3@@std@@V?$allocator@U?$pair@QEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@@std@@@4@$0A@@std@@@std@@IEAAPEAU?$_List_node@U?$pair@QEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@@std@@PEAX@2@_KQEAU32@1@Z @ 0x180146E40 (-_Insert_new_node_before@-$_Hash@V-$_Umap_traits@PEAVVirtualTouchpadControllerProxy@@UVPTP_ID@@V.c)
 */
        ...
        unsigned __int8 *a3)
{
  ...
  {
    if ( qword_180269120 == 0x7FFFFFFFFFFFFFFLL )
    ...
    v7[2] = *(_QWORD *)a3;
    *((_DWORD *)v7 + 6) = 0;
    v8 = qword_180269120 + 1;
    if ( qword_180269120 + 1 < 0 )
      v9 = (float)(int)(v8 & 1 | (v8 >> 1)) + (float)(int)(v8 & 1 | (v8 >> 1));
    else
      v9 = (float)(int)v8;
    v10 = qword_180269148;
    if ( qword_180269148 < 0 )
    {
      v10 = qword_180269148 & 1;
      v11 = (float)(int)(v10 | ((unsigned __int64)qword_180269148 >> 1))
          + (float)(int)(v10 | ((unsigned __int64)qword_180269148 >> 1));
    }
    else
    {
      v11 = (float)(int)qword_180269148;
    }
