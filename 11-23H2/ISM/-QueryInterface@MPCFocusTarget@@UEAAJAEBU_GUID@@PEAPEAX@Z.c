/*
 * XREFs of ?QueryInterface@MPCFocusTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010C360
 * Callers:
 *     ?QueryInterface@MPCFocusTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180066FD0 (-QueryInterface@MPCFocusTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCFocusTarget@@WFA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180066FF0 (-QueryInterface@MPCFocusTarget@@WFA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
