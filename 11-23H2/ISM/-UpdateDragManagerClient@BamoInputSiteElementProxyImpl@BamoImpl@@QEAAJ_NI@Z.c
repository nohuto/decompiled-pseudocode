/*
 * XREFs of ?UpdateDragManagerClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180026D90
 * Callers:
 *     ?Thunk_UpdateDragManagerClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019910 (-Thunk_UpdateDragManagerClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl.c)
    ...
    if ( *((_BYTE *)this + 28) )
    {
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1LL);
      v8 = (char *)this - 16;
      v12 = (*(__int64 (__fastcall **)(char *, void (__fastcall ***)(_QWORD)))(*((_QWORD *)this - 2) + 328LL))(
              (char *)this - 16,
              v7);
      if ( v12 < 0 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        this,
        2LL);
      v13 = (*(__int64 (__fastcall **)(char *))(*(_QWORD *)v8 + 336LL))(v8);
      if ( v13 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0xBB8E,
