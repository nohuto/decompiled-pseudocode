/*
 * XREFs of ?RevokeProcessesForAnimation@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJPEBIII@Z @ 0x180153760
 * Callers:
 *     ?Thunk_RevokeProcessesForAnimation_229@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180061240 (-Thunk_RevokeProcessesForAnimation_229@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesP.c)
 * Callees:
