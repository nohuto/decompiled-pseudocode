/*
 * XREFs of ?QueryInterface@BamoSystemContextManagerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012F430
 * Callers:
 *     ?QueryInterface@BamoSystemContextManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800677D0 (-QueryInterface@BamoSystemContextManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
