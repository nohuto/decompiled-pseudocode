/*
 * XREFs of ?UpdateDisplayOcclusionSupported@BamoDockDeviceProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180135E40
 * Callers:
 *     ?Thunk_UpdateDisplayOcclusionSupported_11@?$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133D60 (-Thunk_UpdateDisplayOcclusionSupported_11@-$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl@Ba.c)
