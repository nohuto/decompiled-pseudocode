/*
 * XREFs of ?RemoveDataSource@BamoDataProviderStubImpl@BamoImpl@@QEAAJPEAVBamoDataSourcePrincipal@@@Z @ 0x18011276C
 * Callers:
        ...
        const char *a4)
{
  ...
  struct IMessageCallSendHost *v13; // [rsp+78h] [rbp+20h] BYREF
