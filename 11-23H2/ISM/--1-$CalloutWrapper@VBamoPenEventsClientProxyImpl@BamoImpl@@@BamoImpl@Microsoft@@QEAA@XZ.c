/*
 * XREFs of ??1?$CalloutWrapper@VBamoPenEventsClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x18004FFD4
 * Callers:
 *     ?OnConnectedCallout@BamoPenEventsClientProxy@@EEAAJXZ @ 0x18004FEA0 (-OnConnectedCallout@BamoPenEventsClientProxy@@EEAAJXZ.c)
 ...
 *     _BamoImpl::BamoPenEventsClientProxyImpl::UpdateUndockedEventsRequired_::_1_::dtor$1 @ 0x18006FA9C (_BamoImpl--BamoPenEventsClientProxyImpl--UpdateUndockedEventsRequired_--_1_--dtor$1.c)
 *     ?OnDisconnectedCallout@BamoPenEventsClientProxy@@EEAAJXZ @ 0x1801AF030 (-OnDisconnectedCallout@BamoPenEventsClientProxy@@EEAAJXZ.c)
 *     _BamoPenEventsClientProxy::OnDisconnectedCallout_::_1_::dtor$0 @ 0x1801AF083 (_BamoPenEventsClientProxy--OnDisconnectedCallout_--_1_--dtor$0.c)
 *     ?OnPropertiesRefreshedCallout@BamoPenEventsClientProxy@@EEAAJXZ @ 0x1801AF430 (-OnPropertiesRefreshedCallout@BamoPenEventsClientProxy@@EEAAJXZ.c)
 *     _BamoPenEventsClientProxy::OnPropertiesRefreshedCallout_::_1_::dtor$0 @ 0x1801AF483 (_BamoPenEventsClientProxy--OnPropertiesRefreshedCallout_--_1_--dtor$0.c)
 * Callees:
