/*
 * XREFs of ?OnMessage@BamoAsyncResult_string_ProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18017B740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_string_ProxyImpl::OnMessage(
