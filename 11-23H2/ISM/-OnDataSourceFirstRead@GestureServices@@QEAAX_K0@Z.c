/*
 * XREFs of ?OnDataSourceFirstRead@GestureServices@@QEAAX_K0@Z @ 0x180060BFC
 * Callers:
 *     ?OnFirstDataRead@DataSourcePrincipal@@UEAAJPEAVBamoDataSourceStub@@_K@Z @ 0x1801148F0 (-OnFirstDataRead@DataSourcePrincipal@@UEAAJPEAVBamoDataSourceStub@@_K@Z.c)
 * Callees:
