/*
 * XREFs of ?EnableGamepadExclusivityForProcess@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800AF02C
 * Callers:
 *     ?Thunk_EnableGamepadExclusivityForProcess_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B2270 (-Thunk_EnableGamepadExclusivityForProcess_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrinc.c)
 * Callees:
