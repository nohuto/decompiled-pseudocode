/*
 * XREFs of ?SendProxyDisposed@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x180030450
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl::SendProxyDisposed(
