/*
 * XREFs of ?OnFirstDataRead@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x180110FF0
 * Callers:
 *     ?Thunk_OnFirstDataRead_0@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801140A0 (-Thunk_OnFirstDataRead_0@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@.c)
 * Callees:
  ...
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
      ...
      *(_QWORD *)(v9 + 32),
      v7,
      0LL);
    v11 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 80LL))(
            (char *)this - 16,
            v8,
            a2);
    v4 = v11;
