/*
 * XREFs of ?GetIsPlayCountSupported@BamoSimpleHapticsControllerPrincipal@@UEAA_NXZ @ 0x1801AB500
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoSimpleHapticsControllerPrincipal::GetIsPlayCountSupported(
