/*
 * XREFs of ?AllocateStub@BamoInputSystemInternalPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputSystemInternalStub@@@Z @ 0x18013D150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputSystemInternalPrincipal::AllocateStub(
