/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_Tree_node@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800A6F38
 * Callers:
 *     _NonBamoInputDeliveryServer::OnAppThreadMessage_::_1_::dtor$0 @ 0x18006BF9D (_NonBamoInputDeliveryServer--OnAppThreadMessage_--_1_--dtor$0.c)
 *     _std::map_unsigned_int_std::function_void___cdecl(bool)__std::less_unsigned_int__std::allocator_std::pair_unsigned_int_const__std::function_void___cdecl(bool)_______::_Try_emplace_unsigned_int_const_&__::_1_::dtor$6 @ 0x18006F8BF (_std--map_unsigned_int_std--function_void___cdecl(bool)__std--less_unsigned_int__std--allocator_.c)
 * Callees:
