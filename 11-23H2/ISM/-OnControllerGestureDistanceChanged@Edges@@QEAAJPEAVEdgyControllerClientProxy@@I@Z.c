/*
 * XREFs of ?OnControllerGestureDistanceChanged@Edges@@QEAAJPEAVEdgyControllerClientProxy@@I@Z @ 0x1801CA03C
 * Callers:
 *     ?OnGestureDistanceChanged@EdgyControllerClientProxy@@MEAAJXZ @ 0x18016AFB0 (-OnGestureDistanceChanged@EdgyControllerClientProxy@@MEAAJXZ.c)
