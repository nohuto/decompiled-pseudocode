/*
 * XREFs of ??0?$CalloutWrapper@VBamoCUIHostInputObjectProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoCUIHostInputObjectProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180140C3C
 * Callers:
