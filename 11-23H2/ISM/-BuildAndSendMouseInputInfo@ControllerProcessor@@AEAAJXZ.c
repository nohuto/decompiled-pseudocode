/*
 * XREFs of ?BuildAndSendMouseInputInfo@ControllerProcessor@@AEAAJXZ @ 0x1801958EC
 * Callers:
    ...
    do
    {
      ...
      if ( (v5 != 0) != ((*(v4 - 1) & *((_DWORD *)this + 68)) != 0) )
      {
        ...
        *((_DWORD *)this + v7 + 1881) = v5 != 0;
        if ( v5 )
          v9 = *((_DWORD *)&unk_18021EED0 + 3 * v7 + 2);
        else
          v9 = *((_DWORD *)&unk_18021EED0 + 3 * v7 + 1);
        v3 |= v9;
      }
LABEL_12:
      ++v2;
    ...
    do
    {
      ...
      if ( (v11 != 0) != ((*(v10 - 1) & *((_DWORD *)this + 61)) != 0) )
      {
        ...
        *((_DWORD *)this + v13 + 1881) = v11 != 0;
        if ( v11 )
          v15 = *((_DWORD *)&unk_18021EED0 + 3 * v13 + 2);
        else
          v15 = *((_DWORD *)&unk_18021EED0 + 3 * v13 + 1);
        v3 |= v15;
      }
LABEL_24:
      ++v2;
