/*
 * XREFs of ??$_Emplace_reallocate@AEAW4_Button@@@?$vector@W4_Button@@V?$allocator@W4_Button@@@std@@@std@@QEAAPEAW4_Button@@QEAW42@AEAW42@@Z @ 0x1801C4B50
 * Callers:
 ...
 *     ?_Change_array@?$vector@W4_Button@@V?$allocator@W4_Button@@@std@@@std@@AEAAXQEAW4_Button@@_K1@Z @ 0x1801C67FC (-_Change_array@-$vector@W4_Button@@V-$allocator@W4_Button@@@std@@@std@@AEAAXQEAW4_Button@@_K1@Z.c)
 */

char *__fastcall std::vector<enum _Button>::_Emplace_reallocate<enum _Button &>(const void **a1, _BYTE *a2, _DWORD *a3)
{
  __int64 v6; // rsi
  __int64 v7; // rax
  __int64 v8; // r12
  ...
  try
  {
    ...
    *(_DWORD *)v13 = *a3;
    ...
    std::vector<enum _Button>::_Change_array(a1, v12, v8, v9);
    result = v13;
  }
  catch ( ... )
  {
