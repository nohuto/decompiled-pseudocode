        ...
        const unsigned __int8 *a2)
{
  ...
  v5 = (_QWORD *)std::_Hash<std::_Uset_traits<IHeatSystemContextClient *,std::_Uhash_compare<IHeatSystemContextClient *,std::hash<IHeatSystemContextClient *>,std::equal_to<IHeatSystemContextClient *>>,std::allocator<IHeatSystemContextClient *>,0>>::_Find_last<IHeatSystemContextClient *>(
                   a1,
                   v11,
                   v4,
                   appended)[1];
