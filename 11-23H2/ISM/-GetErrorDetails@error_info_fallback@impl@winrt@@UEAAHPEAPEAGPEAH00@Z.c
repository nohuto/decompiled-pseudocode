/*
 * XREFs of ?GetErrorDetails@error_info_fallback@impl@winrt@@UEAAHPEAPEAGPEAH00@Z @ 0x180098F30
 * Callers:
 *     <none>
 * Callees:
 *     WINRT_IMPL_SysAllocString @ 0x180057989 (WINRT_IMPL_SysAllocString.c)
 *     ?c_str@hstring@winrt@@QEBAPEBGXZ @ 0x180099EBC (-c_str@hstring@winrt@@QEBAPEBGXZ.c)
 */
