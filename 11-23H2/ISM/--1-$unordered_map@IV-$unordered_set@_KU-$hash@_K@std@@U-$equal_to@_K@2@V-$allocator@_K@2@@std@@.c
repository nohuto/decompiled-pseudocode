/*
 * XREFs of ??1?$unordered_map@IV?$unordered_set@_KU?$hash@_K@std@@U?$equal_to@_K@2@V?$allocator@_K@2@@std@@U?$hash@I@2@U?$equal_to@I@2@V?$allocator@U?$pair@$$CBIV?$unordered_set@_KU?$hash@_K@std@@U?$equal_to@_K@2@V?$allocator@_K@2@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800A10C4
 * Callers:
 *     _ForegroundManager::ForegroundManager_::_1_::dtor$1 @ 0x18006E698 (_ForegroundManager--ForegroundManager_--_1_--dtor$1.c)
 ...
 *     _ContextualProcessorBuffer::DeliverInputToTarget_::_1_::dtor$1 @ 0x1801C0F1A (_ContextualProcessorBuffer--DeliverInputToTarget_--_1_--dtor$1.c)
 * Callees:
