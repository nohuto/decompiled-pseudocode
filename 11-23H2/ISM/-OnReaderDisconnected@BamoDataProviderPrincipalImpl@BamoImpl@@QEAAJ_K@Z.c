/*
 * XREFs of ?OnReaderDisconnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x180111884
 * Callers:
 *     ?Thunk_OnReaderDisconnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180114100 (-Thunk_OnReaderDisconnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@Ba.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDataProviderPrincipalImpl::OnReaderDisconnected(
  ...
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
      ...
      *(_QWORD *)(v9 + 32),
      v7,
      0LL);
    v11 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 104LL))(
            (char *)this - 16,
            v8,
            a2);
    v4 = v11;
