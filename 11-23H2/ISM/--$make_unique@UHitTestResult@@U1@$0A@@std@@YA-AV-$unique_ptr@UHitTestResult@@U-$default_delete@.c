/*
 * XREFs of ??$make_unique@UHitTestResult@@U1@$0A@@std@@YA?AV?$unique_ptr@UHitTestResult@@U?$default_delete@UHitTestResult@@@std@@@0@$$QEAUHitTestResult@@@Z @ 0x1801B7C3C
 * Callers:
 ...
 *     ??0HitTestResult@@QEAA@$$QEAU0@@Z @ 0x1801B6D9C (--0HitTestResult@@QEAA@$$QEAU0@@Z.c)
 */
