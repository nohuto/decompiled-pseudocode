/*
 * XREFs of ?QueryInterface@MouseProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800384C0
 * Callers:
 *     ?QueryInterface@MouseProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069F10 (-QueryInterface@MouseProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069F30 (-QueryInterface@MouseProcessor@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069F50 (-QueryInterface@MouseProcessor@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069F70 (-QueryInterface@MouseProcessor@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
