/*
 * XREFs of ?UpdateVisualReferenceId@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x180194424
 * Callers:
 *     ?Thunk_UpdateVisualReferenceId_0@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180193890 (-Thunk_UpdateVisualReferenceId_0@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavig.c)
