/*
 * XREFs of ?UpdateSize@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_NPEBUVirtualTouchpadSize@Input@Internal@UI@Windows@@@Z @ 0x180146304
 * Callers:
 *     ?Thunk_UpdateSize_399@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005FBB0 (-Thunk_UpdateSize_399@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerPr.c)
