/*
 * XREFs of ??1TextInputStateAdapter@@EEAA@XZ @ 0x1801F3A38
 * Callers:
 ...
 *     ?Release@?$RefPtr@UIRemoteTextInputState@@@@QEAAXXZ @ 0x1801F558C (-Release@-$RefPtr@UIRemoteTextInputState@@@@QEAAXXZ.c)
 */
