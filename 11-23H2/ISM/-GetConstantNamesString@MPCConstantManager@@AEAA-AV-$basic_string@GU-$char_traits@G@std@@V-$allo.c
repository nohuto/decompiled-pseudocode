/*
 * XREFs of ?GetConstantNamesString@MPCConstantManager@@AEAA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@W4InputType@@@Z @ 0x1800AB950
 * Callers:
...
void **__fastcall MPCConstantManager::GetConstantNamesString(__int64 a1, void **a2, int a3)
{
  __int64 *v5; // rbx
  __int64 v6; // rcx
  __int64 v7; // rax
  ...
  int v14[4]; // [rsp+20h] [rbp-60h] BYREF
  ...
  if ( !*(_BYTE *)(v6 + 25)
    ...
    && *(_QWORD *)(*(_QWORD *)std::map<enum InputType,std::map<std::wstring,std::variant<unsigned long,bool,float>>>::_Try_emplace<enum InputType const &,>(
                 ...
                 + 48LL) )
  {
    v7 = **(_QWORD **)(*(_QWORD *)std::map<enum InputType,std::map<std::wstring,std::variant<unsigned long,bool,float>>>::_Try_emplace<enum InputType const &,>(
                                    v5,
                                    (__int64)v15,
                                    (__int64)v14)
                     + 40LL);
    ...
    while ( !*(_BYTE *)(v7 + 25) )
    {
      ...
      if ( a2[2] )
      {
        v11 = std::operator+<unsigned short>(v16, v8, v9);
        v12 = v11[2];
        if ( v11[3] >= 8uLL )
          v11 = (_QWORD *)*v11;
        std::wstring::append(a2, v11, v12);
      ...
      else if ( a2 != v9 )
      {
        ...
        if ( (unsigned __int64)v9[3] >= 8 )
          v9 = (void **)*v9;
        std::wstring::assign(a2, v9, v10);
      }
      std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<DockInputIdentity const,DockInputInfo>>>,std::_Iterator_base0>::operator++(v15);
      v7 = v15[0];
    }
  }
  return a2;
