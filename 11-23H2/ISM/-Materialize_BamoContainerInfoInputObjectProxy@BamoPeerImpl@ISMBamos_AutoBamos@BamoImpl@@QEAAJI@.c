/*
 * XREFs of ?Materialize_BamoContainerInfoInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180126028
 * Callers:
 *     ?Thunk_Materialize_BamoContainerInfoInputObjectProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133360 (-Thunk_Materialize_BamoContainerInfoInputObjectProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VB.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v10 = &BamoContainerInfoInputObjectProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v10[1] = &BamoContainerInfoInputObjectProxy::`vftable'{for `IContainerInfoInputObjectProxy'};
  *((_DWORD *)v10 + 6) = 0;
  v10[4] = 0LL;
  *((_DWORD *)v10 + 10) = 0;
  *((_DWORD *)v10 + 11) = 0;
  v10[2] = &BamoImpl::BamoContainerInfoInputObjectProxyImpl::`vftable';
  *((_OWORD *)v10 + 3) = 0LL;
  *((_DWORD *)v10 + 16) = 0;
