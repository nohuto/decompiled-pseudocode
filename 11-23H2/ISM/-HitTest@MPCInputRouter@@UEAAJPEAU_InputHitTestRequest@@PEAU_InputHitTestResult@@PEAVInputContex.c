/*
 * XREFs of ?HitTest@MPCInputRouter@@UEAAJPEAU_InputHitTestRequest@@PEAU_InputHitTestResult@@PEAVInputContext@@PEAUIInputBuffer@@PEAPEAUIInputTarget@@@Z @ 0x18001F410
 * Callers:
 *     <none>
 * Callees:
    ...
    && !*((_BYTE *)MPCHolographicInputManager::GetInstance() + 3365) )
  {
    ...
    if ( v12 )
    {
      if ( (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v12 + 112LL))(v12) )
      {
        ...
        {
          v16 = (void *)(*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 99) + 120LL))(*((_QWORD *)this + 99));
          if ( v16 )
          {
