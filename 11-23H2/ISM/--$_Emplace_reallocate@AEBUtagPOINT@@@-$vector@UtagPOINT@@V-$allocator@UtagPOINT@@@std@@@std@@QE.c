/*
 * XREFs of ??$_Emplace_reallocate@AEBUtagPOINT@@@?$vector@UtagPOINT@@V?$allocator@UtagPOINT@@@std@@@std@@QEAAPEAUtagPOINT@@QEAU2@AEBU2@@Z @ 0x18015ACA0
 * Callers:
 ...
 *     ?_Change_array@?$vector@UtagPOINT@@V?$allocator@UtagPOINT@@@std@@@std@@AEAAXQEAUtagPOINT@@_K1@Z @ 0x180160F20 (-_Change_array@-$vector@UtagPOINT@@V-$allocator@UtagPOINT@@@std@@@std@@AEAAXQEAUtagPOINT@@_K1@Z.c)
 */

char *__fastcall std::vector<tagPOINT>::_Emplace_reallocate<tagPOINT const &>(const void **a1, _BYTE *a2, _QWORD *a3)
{
  __int64 v6; // r14
  __int64 v7; // rax
  ...
  try
  {
    ...
    *(_QWORD *)v15 = *a3;
    ...
    std::vector<tagPOINT>::_Change_array(a1, v14, v9, v8);
    result = v15;
  }
  catch ( ... )
  {
