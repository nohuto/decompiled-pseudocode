/*
 * XREFs of ?FindClosestShapeBitmap@SystemCursorShape2@@QEAA?AV?$shared_ptr@VSystemCursorShapeBitmap2@@@std@@I@Z @ 0x180105690
 * Callers:
...
_QWORD *__fastcall SystemCursorShape2::FindClosestShapeBitmap(__int64 a1, _QWORD *a2, unsigned int a3)
{
  ...
  if ( v12 )
  {
    std::_Sort_unchecked<unsigned int *,std::less<void>>((char *)v18, v9, (__int64)((__int64)v9 - v18) >> 2, 0);
    v13 = -1LL;
    v14 = 1LL;
    if ( v12 <= 1 )
      goto LABEL_16;
