/*
 * XREFs of ?OnDockDeviceAdded@BamoDeviceDockClientProxyImpl@BamoImpl@@QEAAJIPEAVBamoDockDevicePrincipal@@@Z @ 0x18019FABC
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      return CoreUICallSend(v11, v16, 2LL, 25LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
