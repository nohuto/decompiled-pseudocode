/*
 * XREFs of ?OnDisconnectedCallout@BamoInputProcessProxy@@EEAAJXZ @ 0x1801B34F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputProcessProxy::OnDisconnectedCallout(BamoInputProcessProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputProcessProxyImpl>::CalloutWrapper<BamoImpl::BamoInputProcessProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoInputProcessProxy *))(*(_QWORD *)v1 + 40LL))(v1);
