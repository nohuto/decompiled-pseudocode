/*
 * XREFs of ??1?$ComPtr@VInputConfigContextProvider@@@WRL@Microsoft@@QEAA@XZ @ 0x1800601A0
 * Callers:
 *     _GestureServices::GestureServices_::_1_::dtor$6 @ 0x18006E4BD (_GestureServices--GestureServices_--_1_--dtor$6.c)
