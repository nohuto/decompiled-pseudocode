/*
 * XREFs of ??$emplace@AEB_KAEBUtagRECT@@@?$_Hash@V?$_Umap_traits@_KUtagRECT@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUtagRECT@@@std@@@3@$0A@@std@@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KUtagRECT@@@std@@@std@@@std@@@std@@_N@1@AEB_KAEBUtagRECT@@@Z @ 0x1801A2824
 * Callers:
 ...
 *     ??$?0AEB_KAEBUtagRECT@@@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CB_KUtagRECT@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@U?$pair@$$CB_KUtagRECT@@@std@@PEAX@std@@@1@AEB_KAEBUtagRECT@@@Z @ 0x1801A1CEC (--$-0AEB_KAEBUtagRECT@@@-$_List_node_emplace_op2@V-$allocator@U-$_List_node@U-$pair@$$CB_KUtagRE.c)
 */

__int64 __fastcall std::_Hash<std::_Umap_traits<unsigned __int64,tagRECT,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,tagRECT>>,0>>::emplace<unsigned __int64 const &,tagRECT const &>(
        float *a1,
        __int64 a2,
        unsigned __int8 *a3,
        _OWORD *a4)
{
  ...
  else
  {
    ...
    std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned __int64 const,tagRECT>,void *>>>::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned __int64 const,tagRECT>,void *>>>(
      &v18,
      (__int64)(a1 + 2),
      v9,
      a4);
