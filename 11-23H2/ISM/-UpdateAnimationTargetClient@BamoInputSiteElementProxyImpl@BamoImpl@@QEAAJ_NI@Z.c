/*
 * XREFs of ?UpdateAnimationTargetClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180027280
 * Callers:
 *     ?Thunk_UpdateAnimationTargetClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019930 (-Thunk_UpdateAnimationTargetClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxy.c)
