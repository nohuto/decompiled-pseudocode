/*
 * XREFs of ?OnConnectedThunk@BamoActivationWatcherStubImpl@BamoImpl@@UEAAJXZ @ 0x1800189A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoActivationWatcherStubImpl::OnConnectedThunk(
