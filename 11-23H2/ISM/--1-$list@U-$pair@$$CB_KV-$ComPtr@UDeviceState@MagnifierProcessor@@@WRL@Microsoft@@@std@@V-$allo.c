/*
 * XREFs of ??1?$list@U?$pair@$$CB_KV?$ComPtr@UDeviceState@MagnifierProcessor@@@WRL@Microsoft@@@std@@V?$allocator@U?$pair@$$CB_KV?$ComPtr@UDeviceState@MagnifierProcessor@@@WRL@Microsoft@@@std@@@2@@std@@QEAA@XZ @ 0x1801CD9B8
 * Callers:
 *     _MagnifierProcessor::MagnifierProcessor_::_1_::dtor$11 @ 0x1801CD956 (_MagnifierProcessor--MagnifierProcessor_--_1_--dtor$11.c)
 * Callees:
