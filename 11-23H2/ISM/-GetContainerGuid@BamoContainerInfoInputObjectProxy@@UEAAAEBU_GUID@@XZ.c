/*
 * XREFs of ?GetContainerGuid@BamoContainerInfoInputObjectProxy@@UEAAAEBU_GUID@@XZ @ 0x180124C70
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoContainerInfoInputObjectProxy::GetContainerGuid(
