/*
 * XREFs of ?Materialize_BamoDragManagerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18003DB60
 * Callers:
 *     ?Thunk_Materialize_BamoDragManagerClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18003DB50 (-Thunk_Materialize_BamoDragManagerClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeer.c)
 * Callees:
 ...
 *     ??0DragManagerClientProxy@@QEAA@XZ @ 0x18003DC48 (--0DragManagerClientProxy@@QEAA@XZ.c)
