/*
 * XREFs of ??1InputSinkDataCache@@QEAA@XZ @ 0x1800551A0
 * Callers:
 *     _InputSinkDataCache::GetInstance_::_2_::_dynamic_atexit_destructor_for__instance__ @ 0x18006FED0 (_InputSinkDataCache--GetInstance_--_2_--_dynamic_atexit_destructor_for__instance__.c)
 * Callees:
