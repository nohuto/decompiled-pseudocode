/*
 * XREFs of ?QueryInterface@BamoSimpleHapticsControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012F3A0
 * Callers:
 *     ?QueryInterface@BamoSimpleHapticsControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800677B0 (-QueryInterface@BamoSimpleHapticsControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
