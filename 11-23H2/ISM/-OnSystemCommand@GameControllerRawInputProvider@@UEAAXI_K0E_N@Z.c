/*
 * XREFs of ?OnSystemCommand@GameControllerRawInputProvider@@UEAAXI_K0E_N@Z @ 0x1800CD290
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Log_NullAlloc@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x1800CD998 (-_Log_NullAlloc@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
        ...
        bool a6)
{
  ...
  {
    v11 = (char *)this + 88;
    for ( i = (char *)*((_QWORD *)this + 11); i != v11; i = *(char **)i )
    {
      if ( *((_DWORD *)i + 8) == v10 )
      {
        v13 = *((_QWORD *)i + 3);
        ...
        *((_QWORD *)v14 + 1) = v15;
        --*((_QWORD *)this + 13);
        v16 = (*(__int64 (__fastcall **)(_QWORD, __int64 (__fastcall *)(void *), char *, __int64))(**((_QWORD **)this + 4)
                                                                                                 + 152LL))(
                *((_QWORD *)this + 4),
...
LABEL_17:
  ...
  *((_BYTE *)v20 + 68) = a6;
  ...
  v23 = (*(__int64 (__fastcall **)(_QWORD, __int64 (__fastcall *)(void *), _DWORD *, __int64))(**((_QWORD **)this + 4)
                                                                                             + 152LL))(
          *((_QWORD *)this + 4),
  ...
  if ( a6 )
  {
    ...
    *((_DWORD *)v25 + 9) = a2;
    ...
    if ( v31 >= 0 )
    {
      ...
      {
LABEL_37:
        v33 = (GameControllerRawInputProvider **)*((_QWORD *)this + 12);
        if ( *v33 != (GameControllerRawInputProvider *)((char *)this + 88) )
LABEL_38:
          __fastfail(3u);
        *v25 = (char *)this + 88;
        v25[1] = v33;
