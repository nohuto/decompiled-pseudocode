/*
 * XREFs of ?OnDisconnectedThunk@BamoSimpleHapticsControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x1801ABB30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSimpleHapticsControllerStubImpl::OnDisconnectedThunk(
