/*
 * XREFs of ?UpdateInputDeliveryServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801379B0
 * Callers:
 *     ?Thunk_UpdateInputDeliveryServer_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133FA0 (-Thunk_UpdateInputDeliveryServer_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImp.c)
