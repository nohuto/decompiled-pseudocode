/*
 * XREFs of ?Initialize@RotationWatcher@@SAJXZ @ 0x1801171A8
 * Callers:
...
__int64 RotationWatcher::Initialize(void)
{
  ...
  if ( dword_180269888 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 16LL) )
  {
    Init_thread_header(&dword_180269888);
    if ( dword_180269888 == -1 )
    {
      try
      {
        ...
        Init_thread_footer(&dword_180269888);
      }
      catch ( ... )
      {
