/*
 * XREFs of ??$MPCHolographicInputManager_PrepAndStabilizeTargetingRay_PostStabilization@AEAPEAULegacyInputInfo@@@ISMTracing@@SAXAEAPEAULegacyInputInfo@@@Z @ 0x1800B3224
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_PrepAndStabilizeTargetingRay_PostStabilization<LegacyInputInfo * &>(
        struct LegacyInputInfo **a1)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCHolographicInputManager_PrepAndStabilizeTargetingRay_PostStabilization_(v2, *a1);
  }
}
