/*
 * XREFs of ??1?$list@V?$shared_ptr@UHotKeyInfo@@@std@@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@QEAA@XZ @ 0x1801F0DA0
 * Callers:
 *     _HotKeyProcessor::RegisterHotKey_::_1_::dtor$1 @ 0x1801F241D (_HotKeyProcessor--RegisterHotKey_--_1_--dtor$1.c)
 * Callees:
