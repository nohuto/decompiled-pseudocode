/*
 * XREFs of ?UpdateResumePosition@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@@Z @ 0x1801940A4
 * Callers:
 *     ?Thunk_UpdateResumePosition_23@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180193850 (-Thunk_UpdateResumePosition_23@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavig.c)
