/*
 * XREFs of ?RecordCachedUsageUnderLock@EnabledStateManager@details@wil@@AEAAXXZ @ 0x180093FF4
 * Callers:
 ...
 *     ?OnTimer@EnabledStateManager@details@wil@@QEAAXXZ @ 0x180096B88 (-OnTimer@EnabledStateManager@details@wil@@QEAAXXZ.c)
 * Callees:
 *     ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x180095C68 (-WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z.c)
