/*
 * XREFs of ?Connected@InputProcessProxy@InputTraceLogging@@SAXXZ @ 0x1801B3284
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessProxy::Connected(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802286D1, 0LL, 0LL, 2u, &v2);
  }
}
