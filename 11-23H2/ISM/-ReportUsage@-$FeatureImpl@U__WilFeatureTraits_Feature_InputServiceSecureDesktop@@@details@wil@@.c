/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_InputServiceSecureDesktop@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180053E08
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_InputServiceSecureDesktop>::ReportUsage(
        ...
        __int64 a4)
{
  ...
  if ( (*a1 & 2) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_InputServiceSecureDesktop>::GetCachedFeatureEnabledState(
                      a1,
                      v8);
    v11 = v4;
  }
