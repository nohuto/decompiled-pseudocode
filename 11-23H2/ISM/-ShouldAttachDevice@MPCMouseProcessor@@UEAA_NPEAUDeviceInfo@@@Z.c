/*
 * XREFs of ?ShouldAttachDevice@MPCMouseProcessor@@UEAA_NPEAUDeviceInfo@@@Z @ 0x18003BF80
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall MPCMouseProcessor::ShouldAttachDevice(MPCMouseProcessor *this, struct DeviceInfo *a2)
{
  ...
  if ( (*((_BYTE *)a2 + 4) & 2) == 0 || !(unsigned __int8)IsGetMPCInputPostProcessorPresent(this) )
    return 0;
