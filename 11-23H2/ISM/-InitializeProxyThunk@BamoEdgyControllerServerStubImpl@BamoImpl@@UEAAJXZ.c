/*
 * XREFs of ?InitializeProxyThunk@BamoEdgyControllerServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180019210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoEdgyControllerServerStubImpl::InitializeProxyThunk(
