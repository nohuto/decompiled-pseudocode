/*
 * XREFs of ?GetEnabled@BamoAttachableInputObjectSampleProxy@@UEAA_NXZ @ 0x180124F20
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoAttachableInputObjectSampleProxy::GetEnabled(BamoAttachableInputObjectSampleProxy *this)
{
