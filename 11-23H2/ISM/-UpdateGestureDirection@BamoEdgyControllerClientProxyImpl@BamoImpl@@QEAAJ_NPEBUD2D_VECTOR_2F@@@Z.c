/*
 * XREFs of ?UpdateGestureDirection@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NPEBUD2D_VECTOR_2F@@@Z @ 0x18016B330
 * Callers:
 *     ?Thunk_UpdateGestureDirection_170@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016B280 (-Thunk_UpdateGestureDirection_170@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClient.c)
