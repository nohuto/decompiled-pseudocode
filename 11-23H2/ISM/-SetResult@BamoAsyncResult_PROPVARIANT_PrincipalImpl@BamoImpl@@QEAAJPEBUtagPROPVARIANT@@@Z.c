/*
 * XREFs of ?SetResult@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@QEAAJPEBUtagPROPVARIANT@@@Z @ 0x18018E58C
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018E6F0 (-Thunk_SetResult_0@-$IAsyncResult_PROPVARIANT_Principal_Receive@VBamoAsyncResult_PROPVARIANT_Pri.c)
 * Callees:
