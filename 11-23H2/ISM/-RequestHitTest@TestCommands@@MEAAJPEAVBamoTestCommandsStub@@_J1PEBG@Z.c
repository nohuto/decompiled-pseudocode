/*
 * XREFs of ?RequestHitTest@TestCommands@@MEAAJPEAVBamoTestCommandsStub@@_J1PEBG@Z @ 0x1801BDA10
 * Callers:
 *     <none>
 * Callees:
        ...
        const unsigned __int16 *a5)
{
  ...
  if ( v22[0] )
  {
    ...
    while ( v9 != v10 )
    {
      InputSite::GetAllAttachedObjectsByType<IAttachableInputObjectSampleProxy>(*v9, &v19);
      v11 = v20;
      v12 = v19;
      if ( v19 != v20 )
      {
      ...
      if ( v12 )
      {
        std::_Destroy_range<std::allocator<Microsoft::WRL::ComPtr<CUIWindow>>>(v12, v11);
  ...
  if ( (unsigned __int64)(v23 - 1) <= 0xFFFFFFFFFFFFFFFDuLL )
    NtCloseCompositionInputSink(v23, v13, v14, v15);
