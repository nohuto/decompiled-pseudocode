/*
 * XREFs of ?CursorProcessorCreateCursorForPen@Cursor@InputTraceLogging@@SAXXZ @ 0x180158BBC
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::CursorProcessorCreateCursorForPen(__int64 a1)
{
  ...
  if ( *(_DWORD *)v1 > 4u && (*(_BYTE *)(v1 + 16) & 8) != 0 && (*(_QWORD *)(v1 + 24) & 8LL) == *(_QWORD *)(v1 + 24) )
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_180226868, 0LL, 0LL, 2u, &v2);
}
