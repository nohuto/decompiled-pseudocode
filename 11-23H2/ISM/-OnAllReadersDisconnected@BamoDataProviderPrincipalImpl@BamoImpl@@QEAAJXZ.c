/*
 * XREFs of ?OnAllReadersDisconnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x180110C50
 * Callers:
 *     ?Thunk_OnAllReadersDisconnected_3@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180114090 (-Thunk_OnAllReadersDisconnected_3@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImp.c)
 * Callees:
