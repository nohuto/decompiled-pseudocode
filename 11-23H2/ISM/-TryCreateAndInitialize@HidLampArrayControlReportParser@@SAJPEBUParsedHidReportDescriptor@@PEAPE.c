/*
 * XREFs of ?TryCreateAndInitialize@HidLampArrayControlReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800F66B0
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    if ( *(_DWORD *)a1 == 2 )
    {
      ...
      {
        v9 = *((_QWORD *)a1 + 2);
        if ( *(_WORD *)(v9 + 72LL * i + 18) == 112
          && *(_WORD *)(v9 + 72LL * i + 16) == 89
          && *(_WORD *)(v9 + 72LL * i + 10) == 113
          && *(_WORD *)(v9 + 72LL * i + 8) == 89 )
        {
          v10 = *(_OWORD *)(v9 + 72LL * i + 16);
          v11 = *(_OWORD *)(v9 + 72LL * i + 32);
          v12 = *(_OWORD *)(v9 + 72LL * i + 48);
          v13 = *(_QWORD *)(v9 + 72LL * i + 64);
          *(_OWORD *)(v5 + 24) = *(_OWORD *)(v9 + 72LL * i);
          *(_OWORD *)(v5 + 40) = v10;
          *(_OWORD *)(v5 + 56) = v11;
          *(_OWORD *)(v5 + 72) = v12;
          *((_QWORD *)v5 + 11) = v13;
    ...
    v14 = 9LL * (unsigned int)(*((_DWORD *)a1 + 2) - 1);
    *((_DWORD *)v5 + 5) = (unsigned int)(*(_DWORD *)(*((_QWORD *)a1 + 2)
                                       ...
                                       + 7) >> 3;
    if ( v5[17] == 2 && HidChannelValueInfo::IsValid((HidChannelValueInfo *)(v5 + 24), v14, 1LL) )
    {
      v6 = 0LL;
