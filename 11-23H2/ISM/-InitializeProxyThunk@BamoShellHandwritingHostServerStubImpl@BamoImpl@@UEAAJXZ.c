/*
 * XREFs of ?InitializeProxyThunk@BamoShellHandwritingHostServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180062D00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoShellHandwritingHostServerStubImpl::InitializeProxyThunk(
