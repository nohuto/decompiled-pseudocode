/*
 * XREFs of ??$MPCInputRouter_Set3DFocusTarget@PEAUIMPCFocusTarget@@PEAU1@@ISMTracing@@SAX$$QEAPEAUIMPCFocusTarget@@0@Z @ 0x180107B60
 * Callers:
...
void __fastcall ISMTracing::MPCInputRouter_Set3DFocusTarget<IMPCFocusTarget *,IMPCFocusTarget *>(
        struct IMPCFocusTarget **a1,
        struct IMPCFocusTarget **a2)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCInputRouter_Set3DFocusTarget_(v4, *a1, *a2);
  }
}
