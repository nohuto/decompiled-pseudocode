/*
 * XREFs of ?UnsuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x18014825C
 * Callers:
 *     ?Thunk_UnsuppressInputOfType_254@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005FC30 (-Thunk_UnsuppressInputOfType_254@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverMana.c)
 * Callees:
