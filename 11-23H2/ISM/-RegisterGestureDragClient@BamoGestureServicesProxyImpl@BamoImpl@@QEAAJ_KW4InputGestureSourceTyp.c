/*
 * XREFs of ?RegisterGestureDragClient@BamoGestureServicesProxyImpl@BamoImpl@@QEAAJ_KW4InputGestureSourceType@Input@Internal@UI@Windows@@W4InputType@4567@PEAVBamoDragManagerClientPrincipal@@@Z @ 0x18012FF14
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a5)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      return CoreUICallSend(v12, v17, 2LL, 41LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
