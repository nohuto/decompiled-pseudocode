/*
 * XREFs of ?OnDragManagerClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180022DB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    if ( v25 )
    {
      ...
      v12 = v27(v9, &GUID_d8ee5460_afea_3fed_055d_ce0c55999832, &v25);
    }
    else
    {
      v12 = v10(v9, &GUID_d8ee5460_afea_3fed_055d_ce0c55999832, &v25);
    }
    v13 = v12 >= 0;
    if ( v8 == this && v13 )
      break;
  ...
  v15 = *((_QWORD *)this + 41);
  v16 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 136LL))((char *)this + 8);
  if ( v16 )
  {
