/*
 * XREFs of ?CreateCursorShape@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0PEBUCursorBitmapDataHeader@@IPEBEI@Z @ 0x180101780
 * Callers:
 *     ?Thunk_CreateCursorShape_380@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005BC10 (-Thunk_CreateCursorShape_380@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControl.c)
 * Callees:
