/*
 * XREFs of ?GetIsReplayPauseIntervalSupported@BamoSimpleHapticsControllerPrincipal@@UEAA_NXZ @ 0x1801AB580
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoSimpleHapticsControllerPrincipal::GetIsReplayPauseIntervalSupported(
