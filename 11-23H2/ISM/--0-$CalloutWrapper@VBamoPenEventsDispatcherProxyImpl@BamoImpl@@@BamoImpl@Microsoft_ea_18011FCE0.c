/*
 * XREFs of ??0?$CalloutWrapper@VBamoPenEventsDispatcherProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoPenEventsDispatcherProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18011FCE0
 * Callers:
