/*
 * XREFs of ?GetDriverProperty@DevicePropertyHelper@DevicePropertyHelpers@@QEBAJAEBU_DEVPROPKEY@@KPEAEPEAK@Z @ 0x1800D8C38
 * Callers:
 ...
 *     DevicePropertyHelpers::MapCrToHResult @ 0x1800D9864 (DevicePropertyHelpers--MapCrToHResult.c)
 */
