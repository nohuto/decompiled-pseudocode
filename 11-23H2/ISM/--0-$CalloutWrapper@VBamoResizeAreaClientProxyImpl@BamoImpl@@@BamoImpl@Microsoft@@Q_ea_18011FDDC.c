/*
 * XREFs of ??0?$CalloutWrapper@VBamoResizeAreaClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoResizeAreaClientProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18011FDDC
 * Callers:
