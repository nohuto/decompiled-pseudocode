/*
 * XREFs of ??$emplace_back@AEAUINPUT_SPACE_REGION@@@?$vector@UINPUT_SPACE_REGION@@V?$allocator@UINPUT_SPACE_REGION@@@std@@@std@@QEAA?A_TAEAUINPUT_SPACE_REGION@@@Z @ 0x1801A2B18
 * Callers:
...
char *__fastcall std::vector<INPUT_SPACE_REGION>::emplace_back<INPUT_SPACE_REGION &>(__int64 a1, _OWORD *a2)
{
  __int64 v3; // rdx
  __int64 v4; // rdx
  __int128 v5; // xmm0
