/*
 * XREFs of ?Initialize3DComponents@MPCHandProcessor@@UEAAXXZ @ 0x1800BEDC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCHandProcessor::Initialize3DComponents(unsigned __int64 this)
{
  ...
  if ( !__std_init_once_begin_initialize(&stru_180268B58, 0, &fPending, 0LL) )
    abort();
  if ( fPending )
  {
    *(_QWORD *)&v18 = &stru_180268B58;
