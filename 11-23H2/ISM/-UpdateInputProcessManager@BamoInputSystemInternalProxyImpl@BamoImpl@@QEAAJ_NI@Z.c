/*
 * XREFs of ?UpdateInputProcessManager@BamoInputSystemInternalProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180137DC8
 * Callers:
 *     ?Thunk_UpdateInputProcessManager_8@?$IInputSystemInternalProxy_Receive@VBamoInputSystemInternalProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133FE0 (-Thunk_UpdateInputProcessManager_8@-$IInputSystemInternalProxy_Receive@VBamoInputSystemInternalP.c)
