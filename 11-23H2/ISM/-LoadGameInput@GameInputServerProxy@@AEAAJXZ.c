/*
 * XREFs of ?LoadGameInput@GameInputServerProxy@@AEAAJXZ @ 0x18004AE7C
 * Callers:
 ...
 *     ?OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z @ 0x180118140 (-OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z.c)
 * Callees:
