/*
 * XREFs of ?RegisterClient@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180191A3C
 * Callers:
 *     ?Thunk_RegisterClient_8@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180192610 (-Thunk_RegisterClient_8@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigatio.c)
 * Callees:
