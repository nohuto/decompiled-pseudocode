/*
 * XREFs of ?UpdateEdgyControllerServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180135F90
 * Callers:
 *     ?Thunk_UpdateEdgyControllerServer_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133D80 (-Thunk_UpdateEdgyControllerServer_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
