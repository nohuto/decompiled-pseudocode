/*
 * XREFs of ?OpenConfigRegKey@GestureSession@@SAJPEAPEAUHKEY__@@@Z @ 0x1801D38CC
 * Callers:
 *     ?StaticInitConfig@GestureRecognizer@@KAXXZ @ 0x1801D64E8 (-StaticInitConfig@GestureRecognizer@@KAXXZ.c)
 * Callees:
 *     memset_0 @ 0x180056688 (memset_0.c)
 *     __security_check_cookie @ 0x180056730 (__security_check_cookie.c)
 *     ?RefreshScreenSize@GestureSession@@SAJXZ @ 0x1801D3CD0 (-RefreshScreenSize@GestureSession@@SAJXZ.c)
 */
