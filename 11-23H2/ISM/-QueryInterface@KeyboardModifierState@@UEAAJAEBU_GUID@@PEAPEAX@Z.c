/*
 * XREFs of ?QueryInterface@KeyboardModifierState@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B2FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KeyboardModifierState::QueryInterface(KeyboardModifierState *this, struct _GUID *a2, void **a3)
{
  __int64 result; // rax
