/*
 * XREFs of ?Materialize_BamoMPCManagerClientProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800B041C
 * Callers:
 *     ?Thunk_Materialize_BamoMPCManagerClientProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B24F0 (-Thunk_Materialize_BamoMPCManagerClientProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBa.c)
 * Callees:
