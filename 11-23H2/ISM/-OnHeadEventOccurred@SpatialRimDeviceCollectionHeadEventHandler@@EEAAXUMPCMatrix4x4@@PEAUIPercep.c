/*
 * XREFs of ?OnHeadEventOccurred@SpatialRimDeviceCollectionHeadEventHandler@@EEAAXUMPCMatrix4x4@@PEAUIPerceptionTimestamp@Perception@Windows@@1@Z @ 0x1800DA6F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$ComPtr@UIPerceptionTimestamp@Perception@Windows@@@WRL@Microsoft@@QEAAAEAV012@PEAUIPerceptionTimestamp@Perception@Windows@@@Z @ 0x1800D7EE8 (--4-$ComPtr@UIPerceptionTimestamp@Perception@Windows@@@WRL@Microsoft@@QEAAAEAV012@PEAUIPerceptio.c)
 */
