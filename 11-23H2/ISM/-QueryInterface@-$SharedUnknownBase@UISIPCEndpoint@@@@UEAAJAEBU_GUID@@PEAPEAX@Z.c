/*
 * XREFs of ?QueryInterface@?$SharedUnknownBase@UISIPCEndpoint@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011AFC0
 * Callers:
 *     <none>
 * Callees:
 *     ?AddPublicReference@SharedObjectBase@@IEAAIXZ @ 0x18001AF40 (-AddPublicReference@SharedObjectBase@@IEAAIXZ.c)
 */
...
__int64 __fastcall SharedUnknownBase<ISIPCEndpoint>::QueryInterface(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  ...
  if ( v5 )
  {
    v6 = *a2 - *(_QWORD *)&GUID_660f874e_2d32_4a14_b690_0abd14d5c4fb.Data1;
    if ( *a2 == *(_QWORD *)&GUID_660f874e_2d32_4a14_b690_0abd14d5c4fb.Data1 )
      v6 = a2[1] - *(_QWORD *)GUID_660f874e_2d32_4a14_b690_0abd14d5c4fb.Data4;
    if ( v6 )
      goto LABEL_11;
  }
