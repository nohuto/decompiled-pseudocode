/*
 * XREFs of ?GetVelocities@MPCSpatialGestureRecognizerHandler@@AEAA?AUVector3@Numerics@Foundation@Windows@@PEAUISpatialNavigationUpdatedEventArgs@Spatial@Input@UI@5@@Z @ 0x1800C2994
 * Callers:
