/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoPenDeviceStubImpl@BamoImpl@@UEAAJXZ @ 0x1801A80F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenDeviceStubImpl::OnPropertiesRefreshedThunk(BamoImpl::BamoPenDeviceStubImpl *this)
{
  unsigned int v2; // ebx
  __int64 v3; // r8
  __int64 v4; // rbx
