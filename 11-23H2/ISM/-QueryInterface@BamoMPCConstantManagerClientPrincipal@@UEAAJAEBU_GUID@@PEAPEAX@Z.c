/*
 * XREFs of ?QueryInterface@BamoMPCConstantManagerClientPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AC520
 * Callers:
 *     ?QueryInterface@BamoMPCConstantManagerClientPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180065D70 (-QueryInterface@BamoMPCConstantManagerClientPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
