/*
 * XREFs of ?Create@NonBamoInputDeliveryServer@@SAJPEAUIInputDeliveryServerHost@@PEBGW4TestMode@1@PEAPEAUIInputDeliveryServer@@@Z @ 0x1800340CC
 * Callers:
...
{
  NonBamoInputDeliveryServer *v5; // rcx
