/*
 * XREFs of ?DockableDeviceAttached@DeviceDock@InputTraceLogging@@SAXKAEBUDockableDeviceInfo@@@Z @ 0x1800E3444
 * Callers:
...
void __fastcall InputTraceLogging::DeviceDock::DockableDeviceAttached(__int64 a1, const struct DockableDeviceInfo *a2)
{
    ...
    && (*(_QWORD *)(v4 + 24) & 0x200LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v14 = 8LL;
    v12 = 4LL;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_18022411C, 0LL, 0LL, 7u, &v10);
  }
}
