/*
 * XREFs of ??1?$deque@UPointerFrame@PointerInputMediator@@V?$allocator@UPointerFrame@PointerInputMediator@@@std@@@std@@QEAA@XZ @ 0x180055064
 * Callers:
 *     _dynamic_atexit_destructor_for__PointerInputMediator::s_frameLookaside__ @ 0x18006FFD0 (_dynamic_atexit_destructor_for__PointerInputMediator--s_frameLookaside__.c)
 *     _dynamic_atexit_destructor_for__PointerInputMediator::s_frameQueue__ @ 0x18006FFF0 (_dynamic_atexit_destructor_for__PointerInputMediator--s_frameQueue__.c)
 * Callees:
