/*
 * XREFs of ?Initialize@EdgyProcessorTarget@@IEAAJAEBUEdgyPointerInfo@@UtagMsgRoutingInfo@@PEAX@Z @ 0x1801CB304
 * Callers:
 ...
 *     ??4?$ComPtr@VSessionBasedPointerDeviceArbitration@@@WRL@Microsoft@@QEAAAEAV012@PEAVSessionBasedPointerDeviceArbitration@@@Z @ 0x1801CAD50 (--4-$ComPtr@VSessionBasedPointerDeviceArbitration@@@WRL@Microsoft@@QEAAAEAV012@PEAVSessionBasedP.c)
 *     ??4?$ComPtr@VTouchInfoAdapter@@@WRL@Microsoft@@QEAAAEAV012@PEAVTouchInfoAdapter@@@Z @ 0x1801CADC0 (--4-$ComPtr@VTouchInfoAdapter@@@WRL@Microsoft@@QEAAAEAV012@PEAVTouchInfoAdapter@@@Z.c)
