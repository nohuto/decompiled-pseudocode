/*
 * XREFs of ?AttachClient@BamoPenEventsDispatcherProxyImpl@BamoImpl@@QEAAJPEAVBamoPenEventsClientPrincipal@@@Z @ 0x180122A1C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoPenEventsDispatcherProxyImpl::AttachClient(
        BamoImpl::BamoPenEventsDispatcherProxyImpl *this,
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *(_QWORD *)&v16 = v19;
      *((_QWORD *)&v16 + 1) = v20;
      return CoreUICallSend(v11, &v16, 2LL, 74LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
