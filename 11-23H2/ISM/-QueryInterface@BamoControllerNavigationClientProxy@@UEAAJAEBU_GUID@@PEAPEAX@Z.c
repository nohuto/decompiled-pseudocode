/*
 * XREFs of ?QueryInterface@BamoControllerNavigationClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180193670
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069A10 (-QueryInterface@BamoControllerNavigationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
