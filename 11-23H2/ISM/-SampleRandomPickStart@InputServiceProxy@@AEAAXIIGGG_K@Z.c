/*
 * XREFs of ?SampleRandomPickStart@InputServiceProxy@@AEAAXIIGGG_K@Z @ 0x180174670
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  if ( LatencySampleStartData::MeasureDurationinMS(*((LatencySampleStartData **)this + 7), v23.QuadPart) > 60000.0 )
  {
    if ( (unsigned int)dword_180266508 > 5
      && (qword_180266518 & 0x400000000001LL) != 0
      && (qword_180266520 & 0x400000000001LL) == qword_180266520 )
    {
      v17 = *((_QWORD *)this + 7);
      v24 = *(_QWORD *)(v17 + 40);
