/*
 * XREFs of ??1?$map@IV?$function@$$A6AX_N@Z@std@@U?$less@I@2@V?$allocator@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800A6F68
 * Callers:
 *     _MPC3DStateHelper::MPC3DStateHelper_::_1_::dtor$2 @ 0x18006C2AD (_MPC3DStateHelper--MPC3DStateHelper_--_1_--dtor$2.c)
 *     _MPC3DStateHelper::MPC3DStateHelper_::_1_::dtor$3 @ 0x18006C2C3 (_MPC3DStateHelper--MPC3DStateHelper_--_1_--dtor$3.c)
 * Callees:
