/*
 * XREFs of ?GetVector3AsString@ISMTracing@@SA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAUVector3@Numerics@Foundation@Windows@@@Z @ 0x1800C5748
 * Callers:
...
char **__fastcall ISMTracing::GetVector3AsString(char **a1)
{
  ...
  std::to_string(v11);
  std::to_string(v9);
  v2 = std::operator+<char>(v15, v9);
  std::string::string(v7, v3, v2, v11);
  v4 = std::operator+<char>(v13, v7);
