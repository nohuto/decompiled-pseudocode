/*
 * XREFs of ?_Change_array@?$vector@UInputSiteId@@V?$allocator@UInputSiteId@@@std@@@std@@AEAAXQEAUInputSiteId@@_K1@Z @ 0x180002A5C
 * Callers:
...
__int64 __fastcall std::vector<InputSiteId>::_Change_array(__int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v6; // rcx
  __int64 result; // rax
