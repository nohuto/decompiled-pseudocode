/*
 * XREFs of ?UpdateActivationWatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180134BA0
 * Callers:
 *     ?Thunk_UpdateActivationWatcher_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133BE0 (-Thunk_UpdateActivationWatcher_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@.c)
