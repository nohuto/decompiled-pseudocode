/*
 * XREFs of ?OnMessage@BamoInputSystemInternalPrincipalImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18013D4F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSystemInternalPrincipalImpl::OnMessage(
