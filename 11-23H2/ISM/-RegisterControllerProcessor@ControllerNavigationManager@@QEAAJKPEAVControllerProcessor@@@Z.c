/*
 * XREFs of ?RegisterControllerProcessor@ControllerNavigationManager@@QEAAJKPEAVControllerProcessor@@@Z @ 0x180191E40
 * Callers:
 ...
 *     ?NavigationResume@ControllerProcessor@@QEAAJIUtagRECT@@UtagPOINT@@@Z @ 0x180196D8C (-NavigationResume@ControllerProcessor@@QEAAJIUtagRECT@@UtagPOINT@@@Z.c)
        ...
        struct ControllerProcessor *a3)
{
  ...
  if ( v7 )
  {
    ...
    {
      ControllerProcessor::UpdateNavigationState(v21, 1LL, 0LL);
    }
    else
    {
  ...
  if ( v19 != *((__int64 (__fastcall ****)(_QWORD))this + 17) )
  {
    ...
    {
      ControllerProcessor::UpdateNavigationState(v21, 2LL, 0LL);
    }
    if ( v11 )
      (*v11)[1](v11);
  }
