/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoEdgyNotificationSourceClientProxy@@EEAAJXZ @ 0x18012D310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoEdgyNotificationSourceClientProxy::OnPropertiesRefreshedCallout(
        BamoEdgyNotificationSourceClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoEdgyNotificationSourceClientProxyImpl>::CalloutWrapper<BamoImpl::BamoEdgyNotificationSourceClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoEdgyNotificationSourceClientProxy *))(*(_QWORD *)v1 + 48LL))(v1);
