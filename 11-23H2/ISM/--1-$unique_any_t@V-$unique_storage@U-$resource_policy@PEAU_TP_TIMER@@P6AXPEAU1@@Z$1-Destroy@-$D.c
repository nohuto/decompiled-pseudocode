/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAU_TP_TIMER@@P6AXPEAU1@@Z$1?Destroy@?$DestroyThreadPoolTimer@USystemThreadPoolMethods@details@wil@@$0A@@details@wil@@SAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x180092240
 * Callers:
 *     _MPCHeadMovementDetector::MPCHeadMovementDetector_::_1_::dtor$1 @ 0x1800D0D13 (_MPCHeadMovementDetector--MPCHeadMovementDetector_--_1_--dtor$1.c)
 * Callees:
