/*
 * XREFs of ?UpdateResizeControllerClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000F5D0
 * Callers:
 *     ?Thunk_UpdateResizeControllerClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019A10 (-Thunk_UpdateResizeControllerClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
