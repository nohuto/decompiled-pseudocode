/*
 * XREFs of ?QueryInterface@BamoInputObserverManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180147B40
 * Callers:
 *     ?QueryInterface@BamoInputObserverManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180067C50 (-QueryInterface@BamoInputObserverManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
