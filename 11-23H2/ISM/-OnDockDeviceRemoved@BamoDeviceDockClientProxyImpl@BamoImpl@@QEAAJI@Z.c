/*
 * XREFs of ?OnDockDeviceRemoved@BamoDeviceDockClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18019FD3C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoDeviceDockClientProxyImpl::OnDockDeviceRemoved(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v11[0] = v13;
      v11[1] = v14;
      return CoreUICallSend(v10, v11, 2LL, 25LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
