/*
 * XREFs of ??1?$set@V?$shared_ptr@UHotKeyInfo@@@std@@U?$less@V?$shared_ptr@UHotKeyInfo@@@std@@@2@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@QEAA@XZ @ 0x1801F0E98
 * Callers:
 ...
 *     _HotKeyProcessor::DetectAndProcessHotKey_::_1_::dtor$4 @ 0x18006577E (_HotKeyProcessor--DetectAndProcessHotKey_--_1_--dtor$4.c)
 * Callees:
