/*
 * XREFs of ?CancelOperationReceived@InputGesture@InputETW@@SAXPEBGK@Z @ 0x1800603FC
 * Callers:
...
void __fastcall InputETW::InputGesture::CancelOperationReceived(const unsigned __int16 *a1, unsigned __int64 a2)
{
  __int64 v2; // rbx
  __int64 v4; // rcx
