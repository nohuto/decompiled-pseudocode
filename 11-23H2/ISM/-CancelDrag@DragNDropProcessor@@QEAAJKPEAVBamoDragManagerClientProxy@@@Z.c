/*
 * XREFs of ?CancelDrag@DragNDropProcessor@@QEAAJKPEAVBamoDragManagerClientProxy@@@Z @ 0x18015CDA0
 * Callers:
 ...
 *     ?OnManualDragEnded@ManualDragAreaClientProxy@@QEAAXI@Z @ 0x180159D38 (-OnManualDragEnded@ManualDragAreaClientProxy@@QEAAXI@Z.c)
