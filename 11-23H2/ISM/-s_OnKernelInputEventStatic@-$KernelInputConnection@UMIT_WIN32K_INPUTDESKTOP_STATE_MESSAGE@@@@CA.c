/*
 * XREFs of ?s_OnKernelInputEventStatic@?$KernelInputConnection@UMIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE@@@@CAJPEAX0H@Z @ 0x180014DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KernelInputConnection<MIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE>::s_OnKernelInputEventStatic(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        const char *a4)
{
  ...
  __int64 v13; // rcx
  int v14; // r10d
  LPVOID v15; // [rsp+30h] [rbp-29h] BYREF
  WINBOOL v16; // [rsp+38h] [rbp-21h] BYREF
  __int64 v17; // [rsp+40h] [rbp-19h] BYREF
  int v18; // [rsp+48h] [rbp-11h]
  WINBOOL fPending; // [rsp+50h] [rbp-9h] BYREF
  LPVOID Context; // [rsp+58h] [rbp-1h] BYREF
  void *v21; // [rsp+60h] [rbp+7h]
  GUID ActivityId; // [rsp+68h] [rbp+Fh] BYREF
  ...
  if ( *v6 )
  {
    if ( (unsigned __int8)tlgKeywordOn(v6, 1LL) )
    {
