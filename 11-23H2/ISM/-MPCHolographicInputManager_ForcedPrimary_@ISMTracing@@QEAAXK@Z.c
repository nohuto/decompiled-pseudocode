/*
 * XREFs of ?MPCHolographicInputManager_ForcedPrimary_@ISMTracing@@QEAAXK@Z @ 0x1800B5D2C
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_ForcedPrimary_(ISMTracing *this, int a2)
{
  ...
  if ( ISMTracing::IsEnabled((char)this) )
  {
    ...
    if ( *(_DWORD *)v3 > 4u && (*(_BYTE *)(v3 + 16) & 1) != 0 && (*(_QWORD *)(v3 + 24) & 1LL) == *(_QWORD *)(v3 + 24) )
    {
      ...
      v5 = a2;
      v11 = 4;
      tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1802218A0, 0LL, 0LL, 3u, &v9);
    }
  }
}
