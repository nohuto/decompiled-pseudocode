/*
 * XREFs of ??0GameControllerRawInputProvider@@AEAA@PEAUIRawInputClient@@@Z @ 0x18004A82C
 * Callers:
        ...
        struct IRawInputClient *a2)
{
  ...
  DWORD CurrentProcessId; // [rsp+80h] [rbp+8h] BYREF
  ...
  *((_DWORD *)this + 40) = 0;
  ...
  if ( IsEdition(6176LL) )
  {
    ...
    v6 = NtQueryLicenseValue(&DestinationString, 0LL, &v19, 4LL);
    if ( v6 < 0 )
