/*
 * XREFs of ?OnConnectedThunk@BamoInputSiteManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180018520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSiteManagerStubImpl::OnConnectedThunk(
