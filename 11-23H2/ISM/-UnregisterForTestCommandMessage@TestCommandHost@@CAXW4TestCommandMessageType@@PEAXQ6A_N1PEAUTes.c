/*
 * XREFs of ?UnregisterForTestCommandMessage@TestCommandHost@@CAXW4TestCommandMessageType@@PEAXQ6A_N1PEAUTestCommandMessageDataHeader@@@Z@Z @ 0x180116AB8
 * Callers:
 *     ??1CommandRegistrationToken@TestCommandHost@@QEAA@XZ @ 0x18011686C (--1CommandRegistrationToken@TestCommandHost@@QEAA@XZ.c)
 * Callees:
