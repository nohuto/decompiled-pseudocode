/*
 * XREFs of ??0GestureTracker@@QEAA@IUtagPOINT@@_N1@Z @ 0x1801C3C40
 * Callers:
 ...
 *     ?ResetAndInitializeInteractionContext@GestureTracker@@AEAAJXZ @ 0x1801C3DEC (-ResetAndInitializeInteractionContext@GestureTracker@@AEAAJXZ.c)
 *     ?reset@?$unique_storage@U?$resource_policy@PEAUHINTERACTIONCONTEXT__@@P6AJPEAU1@@Z$1?DestroyInteractionContext@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUHINTERACTIONCONTEXT__@@@Z @ 0x1801C3F40 (-reset@-$unique_storage@U-$resource_policy@PEAUHINTERACTIONCONTEXT__@@P6AJPEAU1@@Z$1-DestroyInte.c)
 */
