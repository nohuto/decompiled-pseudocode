/*
 * XREFs of ?RefreshCursorSpeedRegistrySettings@ControllerProcessor@@AEAAXXZ @ 0x1801975C8
 * Callers:
 *     _lambda_b12fa00c1928b9bf49ed577602750a33_::_lambda_invoker_cdecl_ @ 0x180194760 (_lambda_b12fa00c1928b9bf49ed577602750a33_--_lambda_invoker_cdecl_.c)
 *     ?Initialize@ControllerProcessor@@IEAAJXZ @ 0x180196490 (-Initialize@ControllerProcessor@@IEAAJXZ.c)
 * Callees:
 *     _lambda_b80ed414f8f7ae3fe1ffd6fe9e067963_::operator() @ 0x180195014 (_lambda_b80ed414f8f7ae3fe1ffd6fe9e067963_--operator().c)
 *     _lambda_c6487e696fe1a4f0096835366e69d3e1_::operator() @ 0x180195084 (_lambda_c6487e696fe1a4f0096835366e69d3e1_--operator().c)
 */
