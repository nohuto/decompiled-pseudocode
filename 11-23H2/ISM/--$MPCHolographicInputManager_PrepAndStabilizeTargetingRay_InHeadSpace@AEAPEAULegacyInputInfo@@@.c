/*
 * XREFs of ??$MPCHolographicInputManager_PrepAndStabilizeTargetingRay_InHeadSpace@AEAPEAULegacyInputInfo@@@ISMTracing@@SAXAEAPEAULegacyInputInfo@@@Z @ 0x1800B3174
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_PrepAndStabilizeTargetingRay_InHeadSpace<LegacyInputInfo * &>(
        struct LegacyInputInfo **a1)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCHolographicInputManager_PrepAndStabilizeTargetingRay_InHeadSpace_(v2, *a1);
  }
}
