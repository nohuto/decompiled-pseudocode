/*
 * XREFs of ??1?$unordered_map@GV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@U?$hash@G@2@U?$equal_to@G@2@V?$allocator@U?$pair@$$CBGV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1801A9258
 * Callers:
 *     _HapticInterface::HapticInterface_::_1_::dtor$2 @ 0x1801A91AD (_HapticInterface--HapticInterface_--_1_--dtor$2.c)
 * Callees:
