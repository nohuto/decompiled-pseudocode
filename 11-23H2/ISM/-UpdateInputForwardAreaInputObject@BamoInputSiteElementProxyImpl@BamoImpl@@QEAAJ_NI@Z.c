/*
 * XREFs of ?UpdateInputForwardAreaInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000FD20
 * Callers:
 *     ?Thunk_UpdateInputForwardAreaInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019B70 (-Thunk_UpdateInputForwardAreaInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElemen.c)
