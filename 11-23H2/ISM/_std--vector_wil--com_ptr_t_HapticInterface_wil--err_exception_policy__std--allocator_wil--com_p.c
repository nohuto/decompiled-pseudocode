/*
 * XREFs of _std::vector_wil::com_ptr_t_HapticInterface_wil::err_exception_policy__std::allocator_wil::com_ptr_t_HapticInterface_wil::err_exception_policy_____::_Emplace_reallocate_wil::com_ptr_t_HapticInterface_wil::err_exception_policy__const_&__::_1_::catch$2 @ 0x1800A7F0B
 * Callers:
 *     <none>
 * Callees:
