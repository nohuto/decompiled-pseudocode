/*
 * XREFs of ?UpdateTransducerProperties@PenInterface@@AEAAXAEBUTransducerPropertiesReport@1@@Z @ 0x1801A7474
 * Callers:
...
void __fastcall PenInterface::UpdateTransducerProperties(PenInterface *this, struct _GUID *a2)
{
  ...
  if ( LOBYTE(a2[1].Data1) )
  {
    ...
    v6 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*((_QWORD *)BamoServerConnection + 31) + 8LL) + 168LL))(*((_QWORD *)BamoServerConnection + 31) + 8LL);
