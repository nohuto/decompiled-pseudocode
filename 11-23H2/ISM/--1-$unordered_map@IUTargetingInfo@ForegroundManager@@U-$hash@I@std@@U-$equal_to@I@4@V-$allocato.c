/*
 * XREFs of ??1?$unordered_map@IUTargetingInfo@ForegroundManager@@U?$hash@I@std@@U?$equal_to@I@4@V?$allocator@U?$pair@$$CBIUTargetingInfo@ForegroundManager@@@std@@@4@@std@@QEAA@XZ @ 0x1800A1074
 * Callers:
 *     _ForegroundManager::ForegroundManager_::_1_::dtor$2 @ 0x18006E6AE (_ForegroundManager--ForegroundManager_--_1_--dtor$2.c)
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$4 @ 0x18015C43B (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$4.c)
 *     _ResizeProcessor::ResizeProcessor_::_1_::dtor$2 @ 0x1801634CA (_ResizeProcessor--ResizeProcessor_--_1_--dtor$2.c)
 * Callees:
