/*
 * XREFs of ??$MPCEyeGazeProcessor_UnexpectedSecondEyeGazeProcessor@AEAKK@ISMTracing@@SAXAEAK$$QEAK@Z @ 0x1801E925C
 * Callers:
 *     ?ShouldAttachDevice@MPCEyeGazeProcessor@@UEAA_NPEAUDeviceInfo@@@Z @ 0x1801E9890 (-ShouldAttachDevice@MPCEyeGazeProcessor@@UEAA_NPEAUDeviceInfo@@@Z.c)
 * Callees:
...
void __fastcall ISMTracing::MPCEyeGazeProcessor_UnexpectedSecondEyeGazeProcessor<unsigned long &,unsigned long>(
        unsigned int *a1,
        unsigned int *a2)
{
  ISMTracing *v4; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCEyeGazeProcessor_UnexpectedSecondEyeGazeProcessor_(v4, *a1, *a2);
  }
}
