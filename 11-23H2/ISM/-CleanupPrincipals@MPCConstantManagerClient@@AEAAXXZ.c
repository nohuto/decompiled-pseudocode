/*
 * XREFs of ?CleanupPrincipals@MPCConstantManagerClient@@AEAAXXZ @ 0x18018605C
 * Callers:
 ...
 *     ??$_Move_unchecked@PEAV?$com_ptr_t@VAsyncHRESULTPrincipal@@Uerr_exception_policy@wil@@@wil@@PEAV12@@std@@YAPEAV?$com_ptr_t@VAsyncHRESULTPrincipal@@Uerr_exception_policy@wil@@@wil@@PEAV12@00@Z @ 0x180182374 (--$_Move_unchecked@PEAV-$com_ptr_t@VAsyncHRESULTPrincipal@@Uerr_exception_policy@wil@@@wil@@PEAV.c)
 *     std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_wil::com_ptr_t_AsyncPVPrincipal_wil::err_exception_policy_________lambda_c91dbc00eed29fc6671fbd913f651dd6___ @ 0x18018270C (std--remove_if_std--_Vector_iterator_std--_Vector_val_std--_Simple_types_wil--com_ptr_t_AsyncPVP.c)
 *     std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_wil::com_ptr_t_AsyncStringPrincipal_wil::err_exception_policy_________lambda_63372103619f2071dae56b01713f6f7a___ @ 0x1801827B4 (std--remove_if_std--_Vector_iterator_std--_Vector_val_std--_Simple_types_wil--com_ptr_t_AsyncStr.c)
 */
