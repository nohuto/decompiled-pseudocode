/*
 * XREFs of ?SendMaterializeProxy@BamoSystemContextEndpointPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18009F800
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoSystemContextEndpointPrincipalImpl::SendMaterializeProxy(
