/*
 * XREFs of ??$?4U?$default_delete@PEAVSessionMonitor@@@std@@$0A@@?$unique_ptr@PEAVSessionMonitor@@U?$default_delete@PEAVSessionMonitor@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800581E8
 * Callers:
