/*
 * XREFs of ??$MPCInputProviderBase_Create@AEAPEAUDeviceInfo@@@ISMTracing@@SAXAEAPEAUDeviceInfo@@@Z @ 0x180041018
 * Callers:
...
void __fastcall ISMTracing::MPCInputProviderBase_Create<DeviceInfo * &>(const struct DeviceInfo **a1)
{
  ISMTracing *v2; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCInputProviderBase_Create_(v2, *a1);
  }
}
