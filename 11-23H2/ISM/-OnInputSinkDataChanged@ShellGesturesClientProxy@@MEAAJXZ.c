/*
 * XREFs of ?OnInputSinkDataChanged@ShellGesturesClientProxy@@MEAAJXZ @ 0x18004C3C0
 * Callers:
 ...
 *     ?GetInputSinkData@BamoShellGesturesClientProxy@@UEAAAEBUInputSinkData@@XZ @ 0x18004C5F0 (-GetInputSinkData@BamoShellGesturesClientProxy@@UEAAAEBUInputSinkData@@XZ.c)
 *     __security_check_cookie @ 0x180056730 (__security_check_cookie.c)
 *     IsGetRoutingInfoForWindowHandlePresent @ 0x180057DD0 (IsGetRoutingInfoForWindowHandlePresent.c)
