/*
 * XREFs of ?GetId@BamoEdgyDragSourceClientProxy@@UEAA_KXZ @ 0x1801252B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall BamoEdgyDragSourceClientProxy::GetId(BamoEdgyDragSourceClientProxy *this)
{
  __int64 v2; // rbx
  __int64 v3; // rdx
  __int64 v4; // r8
