/*
 * XREFs of ?SendMaterializeProxy@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801ACD70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoSimpleHapticsControllerPrincipalImpl::SendMaterializeProxy(
