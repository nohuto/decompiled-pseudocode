/*
 * XREFs of ?QueryInterface@BamoGestureServicesProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012EB30
 * Callers:
 *     ?QueryInterface@BamoGestureServicesProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800675B0 (-QueryInterface@BamoGestureServicesProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
