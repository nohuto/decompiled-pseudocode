/*
 * XREFs of ??$GetAttachedObject@UICUIComponentInputObjectProxy@@VCUIComponentInputObjectProxy@@@InputSite@@QEAA?AV?$ComPtr@VCUIComponentInputObjectProxy@@@WRL@Microsoft@@XZ @ 0x18009AF44
 * Callers:
 ...
 *     ??$As@UICUIComponentInputObjectProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UICUIComponentInputObjectProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18009AE8C (--$As@UICUIComponentInputObjectProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$.c)
 */
