/*
 * XREFs of ?QueryInterface@BamoShellHandwritingHostServerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18005DF80
 * Callers:
 *     ?QueryInterface@BamoShellHandwritingHostServerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180067790 (-QueryInterface@BamoShellHandwritingHostServerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
