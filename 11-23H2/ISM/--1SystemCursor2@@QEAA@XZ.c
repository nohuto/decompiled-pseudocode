/*
 * XREFs of ??1SystemCursor2@@QEAA@XZ @ 0x180104360
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VSystemCursor2@@@std@@EEAAXXZ @ 0x180106D60 (-_Destroy@-$_Ref_count_obj2@VSystemCursor2@@@std@@EEAAXXZ.c)
 * Callees:
