/*
 * XREFs of ?QueryInterface@BamoControllerNavigationManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801919B0
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800699F0 (-QueryInterface@BamoControllerNavigationManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
