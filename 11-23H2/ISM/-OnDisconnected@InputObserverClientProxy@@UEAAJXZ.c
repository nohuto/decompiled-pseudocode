/*
 * XREFs of ?OnDisconnected@InputObserverClientProxy@@UEAAJXZ @ 0x180147590
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UnregisterObserverClientOfType@CInputObserverManager@@UEAAJPEAVBamoInputObserverManagerStub@@W4InputObserverType@InputObservation@@PEAVBamoInputObserverClientProxy@@@Z @ 0x180148220 (-UnregisterObserverClientOfType@CInputObserverManager@@UEAAJPEAVBamoInputObserverManagerStub@@W4.c)
 */
