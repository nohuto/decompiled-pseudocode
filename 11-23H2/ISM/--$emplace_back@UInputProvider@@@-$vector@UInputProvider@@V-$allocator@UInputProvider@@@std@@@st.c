/*
 * XREFs of ??$emplace_back@UInputProvider@@@?$vector@UInputProvider@@V?$allocator@UInputProvider@@@std@@@std@@QEAA?A_T$$QEAUInputProvider@@@Z @ 0x1800CDA70
 * Callers:
...
char *__fastcall std::vector<InputProvider>::emplace_back<InputProvider>(_QWORD *a1, _OWORD *a2)
{
  ...
  v4 = (_OWORD *)a1[1];
  if ( v4 == (_OWORD *)a1[2] )
    return std::vector<InputProvider>::_Emplace_reallocate<InputProvider>(a1, v4, a2);
  v5 = a2 + 1;
  *v4 = *a2;
  v6 = v4 + 1;
  *v6 = 0LL;
