/*
 * XREFs of ?OnDisconnectedCallout@BamoAttachableInputObjectSampleProxy@@EEAAJXZ @ 0x18012A180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoAttachableInputObjectSampleProxy::OnDisconnectedCallout(
        BamoAttachableInputObjectSampleProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoAttachableInputObjectSampleProxyImpl>::CalloutWrapper<BamoImpl::BamoAttachableInputObjectSampleProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoAttachableInputObjectSampleProxy *))(*(_QWORD *)v1 + 40LL))(v1);
