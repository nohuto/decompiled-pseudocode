/*
 * XREFs of ?ProtectSectionMemory@SipcPort@@CAJPEAX_KK@Z @ 0x18011AF10
 * Callers:
 *     ?ProtectSection@SipcPort@@QEAAJPEAX_K1@Z @ 0x18011AEB0 (-ProtectSection@SipcPort@@QEAAJPEAX_K1@Z.c)
 *     ?ProtectUnusedSectionMemory@SipcPort@@KAJPEAUSectionListEntry@1@@Z @ 0x18011AF58 (-ProtectUnusedSectionMemory@SipcPort@@KAJPEAUSectionListEntry@1@@Z.c)
 * Callees:
 *     <none>
 */
