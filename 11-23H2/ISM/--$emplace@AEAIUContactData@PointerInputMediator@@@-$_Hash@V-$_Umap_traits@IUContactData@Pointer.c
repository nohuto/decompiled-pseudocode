 ...
 *     ??$?0AEAIUContactData@PointerInputMediator@@@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBIUContactData@PointerInputMediator@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@U?$pair@$$CBIUContactData@PointerInputMediator@@@std@@PEAX@std@@@1@AEAI$$QEAUContactData@PointerInputMediator@@@Z @ 0x1800FC1E0 (--$-0AEAIUContactData@PointerInputMediator@@@-$_List_node_emplace_op2@V-$allocator@U-$_List_node.c)
 *     ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBIUContactData@PointerInputMediator@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800FCBE4 (--1-$_List_node_emplace_op2@V-$allocator@U-$_List_node@U-$pair@$$CBIUContactData@PointerInputMed.c)
