/*
 * XREFs of ?OnConnectedCallout@BamoActivationConfigurationInputObjectProxy@@EEAAJXZ @ 0x180012970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoActivationConfigurationInputObjectProxy::OnConnectedCallout(
        BamoActivationConfigurationInputObjectProxy *this)
{
  ...
  v3 = (char *)this + 16;
  v4 = (BamoActivationConfigurationInputObjectProxy *)((char *)this + 16) != 0LL ? 3 : 0;
  if ( this != (BamoActivationConfigurationInputObjectProxy *)-16LL )
  ...
  v8 = (*(__int64 (__fastcall **)(BamoActivationConfigurationInputObjectProxy *))(*(_QWORD *)this + 32LL))(this);
  if ( v3 )
  {
    if ( (v4 & 2) != 0 )
    {
