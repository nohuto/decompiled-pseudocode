/*
 * XREFs of ?UpdateUseInputSiteCoordinateSpace@BamoMagnifierControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x18016CD24
 * Callers:
 *     ?Thunk_UpdateUseInputSiteCoordinateSpace_11@?$IMagnifierControllerProxy_Receive@VBamoMagnifierControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016C870 (-Thunk_UpdateUseInputSiteCoordinateSpace_11@-$IMagnifierControllerProxy_Receive@VBamoMagnifierCo.c)
