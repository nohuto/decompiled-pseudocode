/*
 * XREFs of ??0?$CalloutWrapper@VBamoInputProcessProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputProcessProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1801B3138
 * Callers:
