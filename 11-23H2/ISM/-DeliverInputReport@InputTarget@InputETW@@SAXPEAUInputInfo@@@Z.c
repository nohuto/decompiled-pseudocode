/*
 * XREFs of ?DeliverInputReport@InputTarget@InputETW@@SAXPEAUInputInfo@@@Z @ 0x1801003F8
 * Callers:
  ...
  if ( InputETW::IsVerboseEnabled(1LL) )
  {
    ...
    if ( InputETW::IsVerboseEnabled(2LL) )
    {
      ...
      if ( *(_DWORD *)v7 > 5u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
      {
        ...
        v16 = 8;
        v15 = &v11;
        tlgWriteTransfer_EventWriteTransfer(v7, (unsigned __int8 *)dword_180224F7A, 0LL, 0LL, 3u, &v14);
      }
    }
  }
}
