/*
 * XREFs of ?InternalRelease@?$ComPtr@UIWindowsMessageDeliveryProxy@@@WRL@Microsoft@@IEAAKXZ @ 0x18000E740
 * Callers:
 ...
 *     ??1?$ComPtr@UIWindowsMessageDeliveryProxy@@@WRL@Microsoft@@QEAA@XZ @ 0x1800A0E84 (--1-$ComPtr@UIWindowsMessageDeliveryProxy@@@WRL@Microsoft@@QEAA@XZ.c)
 * Callees:
