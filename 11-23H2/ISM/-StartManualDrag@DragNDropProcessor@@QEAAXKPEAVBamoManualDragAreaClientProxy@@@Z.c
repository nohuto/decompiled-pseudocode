/*
 * XREFs of ?StartManualDrag@DragNDropProcessor@@QEAAXKPEAVBamoManualDragAreaClientProxy@@@Z @ 0x1801609D0
 * Callers:
 *     ?StartManualDrag@ManualDragAreaClientProxy@@MEAAJI@Z @ 0x180159F20 (-StartManualDrag@ManualDragAreaClientProxy@@MEAAJI@Z.c)
 * Callees:
 ...
 *     ??1?$ComPtr@VInputInjectionClientProxy@@@WRL@Microsoft@@QEAA@XZ @ 0x18009B8C8 (--1-$ComPtr@VInputInjectionClientProxy@@@WRL@Microsoft@@QEAA@XZ.c)
 ...
 *     ??4?$ComPtr@VManualDragAreaClientProxy@@@WRL@Microsoft@@QEAAAEAV012@PEAVManualDragAreaClientProxy@@@Z @ 0x18015CC34 (--4-$ComPtr@VManualDragAreaClientProxy@@@WRL@Microsoft@@QEAAAEAV012@PEAVManualDragAreaClientProx.c)
