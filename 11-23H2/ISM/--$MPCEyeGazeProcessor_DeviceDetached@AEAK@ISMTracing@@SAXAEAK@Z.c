/*
 * XREFs of ??$MPCEyeGazeProcessor_DeviceDetached@AEAK@ISMTracing@@SAXAEAK@Z @ 0x1800C4448
 * Callers:
...
void __fastcall ISMTracing::MPCEyeGazeProcessor_DeviceDetached<unsigned long &>(unsigned int *a1)
{
  ISMTracing *v2; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCEyeGazeProcessor_DeviceDetached_(v2, *a1);
  }
}
