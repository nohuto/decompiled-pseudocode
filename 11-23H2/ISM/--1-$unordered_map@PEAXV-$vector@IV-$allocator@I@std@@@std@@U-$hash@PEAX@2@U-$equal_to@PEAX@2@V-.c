/*
 * XREFs of ??1?$unordered_map@PEAXV?$vector@IV?$allocator@I@std@@@std@@U?$hash@PEAX@2@U?$equal_to@PEAX@2@V?$allocator@U?$pair@QEAXV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800F8240
 * Callers:
 *     _Win32kInterop::DeliverInputToAllTargets_::_1_::dtor$0 @ 0x1800F91CE (_Win32kInterop--DeliverInputToAllTargets_--_1_--dtor$0.c)
 * Callees:
