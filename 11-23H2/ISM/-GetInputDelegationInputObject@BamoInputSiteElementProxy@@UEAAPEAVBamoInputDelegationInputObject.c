/*
 * XREFs of ?GetInputDelegationInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoInputDelegationInputObjectProxy@@XZ @ 0x180011740
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoInputDelegationInputObjectProxy *)*((_QWORD *)this + 24);
}
