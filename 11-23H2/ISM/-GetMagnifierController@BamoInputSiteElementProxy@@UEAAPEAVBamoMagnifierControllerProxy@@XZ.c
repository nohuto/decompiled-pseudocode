/*
 * XREFs of ?GetMagnifierController@BamoInputSiteElementProxy@@UEAAPEAVBamoMagnifierControllerProxy@@XZ @ 0x1800114A0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoMagnifierControllerProxy *)*((_QWORD *)this + 29);
}
