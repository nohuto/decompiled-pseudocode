/*
 * XREFs of ?Thunk_RevokeProcessesForAnimation_229@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180061240
 * Callers:
 *     <none>
 * Callees:
 *     <none>
