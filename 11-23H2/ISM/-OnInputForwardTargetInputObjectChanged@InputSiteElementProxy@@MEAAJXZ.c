/*
 * XREFs of ?OnInputForwardTargetInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000D0D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$As@UIInputSiteTransformClientPrivate@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIInputSiteTransformClientPrivate@@@WRL@Microsoft@@@Details@12@@Z @ 0x180051C08 (--$As@UIInputSiteTransformClientPrivate@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@.c)
...
__int64 __fastcall InputSiteElementProxy::OnInputForwardTargetInputObjectChanged(
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    if ( v24 )
    {
      ...
      v12 = v26(v9, &GUID_d4ef4959_f5fd_4cf7_9e90_49eefb52f5a4, &v24);
    }
    else
    {
      v12 = v10(v9, &GUID_d4ef4959_f5fd_4cf7_9e90_49eefb52f5a4, &v24);
    }
    v13 = v12 >= 0;
    if ( v8 == this && v13 )
      break;
  ...
  v15 = *((_QWORD *)this + 41);
  v16 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 192LL))((char *)this + 8);
  if ( v16 )
  {
    v18 = v16 + 8;
    v24 = v16 + 8;
