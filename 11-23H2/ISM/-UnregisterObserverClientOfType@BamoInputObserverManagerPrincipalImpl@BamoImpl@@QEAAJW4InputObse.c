/*
 * XREFs of ?UnregisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x18014805C
 * Callers:
 *     ?Thunk_UnregisterObserverClientOfType_254@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005FC10 (-Thunk_UnregisterObserverClientOfType_254@-$IInputObserverManagerPrincipal_Receive@VBamoInputObs.c)
 * Callees:
