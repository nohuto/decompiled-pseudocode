/*
 * XREFs of ?UnregisterGestureDragClient@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJ_KI@Z @ 0x18002606C
 * Callers:
 *     ?Thunk_UnregisterGestureDragClient_225@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800612A0 (-Thunk_UnregisterGestureDragClient_225@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesP.c)
 * Callees:
