/*
 * XREFs of ?RegisterFor3DCompositorRunningChanged@MPC3DStateHelper@@QEAAXV?$function@$$A6AX_N@Z@std@@PEAI@Z @ 0x18004BD44
 * Callers:
...
__int64 __fastcall MPC3DStateHelper::RegisterFor3DCompositorRunningChanged(PSRWLOCK SRWLock, __int64 a2, _DWORD *a3)
{
  ...
  *a3 = Ptr;
  ...
  if ( v8 == v13 || *(_QWORD *)(v7 + 56) == v7 )
  {
    ...
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Tidy(v15);
  }
  else
  {
    v14 = *(_BYTE **)(v7 + 56);
  ...
  std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Tidy(v13);
