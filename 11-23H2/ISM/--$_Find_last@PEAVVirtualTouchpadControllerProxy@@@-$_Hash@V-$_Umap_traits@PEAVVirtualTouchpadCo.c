        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD **)(qword_180269128 + 16 * (a4 & qword_180269140) + 8);
  if ( v4 == (_QWORD *)qword_180269118 )
  {
    *a2 = qword_180269118;
LABEL_3:
    a2[1] = 0LL;
  ...
  else
  {
    while ( *a3 != v4[2] )
    {
      if ( v4 == *(_QWORD **)(qword_180269128 + 16 * (a4 & qword_180269140)) )
      {
        *a2 = v4;
        goto LABEL_3;
      }
