/*
 * XREFs of ?UpdateFocusedInputTarget3D@MPCInputRouter@@AEAAXPEAUIInputTarget@@@Z @ 0x18010B428
 * Callers:
        ...
        int (__fastcall ***a2)(struct IInputTarget *, GUID *, struct IInputTarget **))
{
  int v4; // edi
  __int64 v5; // r13
  int (__fastcall *v6)(struct IInputTarget *, GUID *, struct IInputTarget **); // rbx
  int v7; // eax
  int v8; // eax
  int v9; // eax
  ...
  if ( a2 )
  {
    v4 = 0;
    v39 = 0;
    if ( MPCInputRouter::IsTargetHolographic(this, (struct IInputTarget *)a2) )
    {
      ...
      if ( v6((struct IInputTarget *)a2, &GUID_a4e70d2d_6b93_4143_b95b_67efd0ccda59, &v32) >= 0 )
      {
      ...
      LOBYTE(v39) = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 99) + 32LL))(*((_QWORD *)this + 99));
      v36[0] = *((struct IMPCTarget **)this + 99);
