/*
 * XREFs of ?RestartProcess@InputProcessManager@InputTraceLogging@@SAXK@Z @ 0x1801B4654
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessManager::RestartProcess(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = v1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_1802287C1, 0LL, 0LL, 3u, &v4);
  }
}
