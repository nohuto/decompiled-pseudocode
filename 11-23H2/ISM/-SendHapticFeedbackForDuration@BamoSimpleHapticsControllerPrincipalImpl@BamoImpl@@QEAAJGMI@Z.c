/*
 * XREFs of ?SendHapticFeedbackForDuration@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAJGMI@Z @ 0x1801AC798
 * Callers:
 *     ?Thunk_SendHapticFeedbackForDuration_352@?$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800635B0 (-Thunk_SendHapticFeedbackForDuration_352@-$ISimpleHapticsControllerPrincipal_Receive@VBamoSimple.c)
 * Callees:
