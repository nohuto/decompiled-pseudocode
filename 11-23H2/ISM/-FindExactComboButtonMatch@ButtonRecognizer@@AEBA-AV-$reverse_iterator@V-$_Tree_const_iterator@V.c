/*
 * XREFs of ?FindExactComboButtonMatch@ButtonRecognizer@@AEBA?AV?$reverse_iterator@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBIUComboButtonRegistration@@@std@@@std@@@std@@@std@@@std@@AEAV?$vector@W4_Button@@V?$allocator@W4_Button@@@std@@@3@@Z @ 0x1801C5CCC
 * Callers:
 ...
 *     ??C?$reverse_iterator@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBIUComboButtonRegistration@@@std@@@std@@@std@@@std@@@std@@QEBAPEBU?$pair@$$CBIUComboButtonRegistration@@@1@XZ @ 0x1801C56F8 (--C-$reverse_iterator@V-$_Tree_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@U-$pair@$$CBIUC.c)
 */
...
__int64 *__fastcall ButtonRecognizer::FindExactComboButtonMatch(__int64 a1, __int64 *a2, _QWORD *a3)
{
  ...
  std::_Sort_unchecked<enum _Button *,std::less<void>>(v13, v14, ((char *)v14 - v13) >> 2, 0);
  v6 = *(_QWORD *)(a1 + 32);
  v7 = *(_QWORD *)v6;
  *a2 = *(_QWORD *)v6;
LABEL_2:
