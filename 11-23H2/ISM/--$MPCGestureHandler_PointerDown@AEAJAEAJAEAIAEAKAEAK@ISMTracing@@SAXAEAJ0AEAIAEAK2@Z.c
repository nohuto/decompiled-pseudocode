/*
 * XREFs of ??$MPCGestureHandler_PointerDown@AEAJAEAJAEAIAEAKAEAK@ISMTracing@@SAXAEAJ0AEAIAEAK2@Z @ 0x1800B9C0C
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCGestureHandler_PointerDown_((ISMTracing *)*a5, *a1, *a2, *a3, *a4, *a5);
  }
}
