/*
 * XREFs of ?UpdateTailButtonClickedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1800545A0
 * Callers:
 *     ?Thunk_UpdateTailButtonClickedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180054EC0 (-Thunk_UpdateTailButtonClickedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsCl.c)
