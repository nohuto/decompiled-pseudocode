/*
 * XREFs of std::find_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IMPCInputProviderBase_________lambda_a8bd3f77500581b3abf4cbfc08695dab___ @ 0x1800B40FC
 * Callers:
        ...
        __int64 a4)
{
  ...
  for ( i = a2; i != a3; ++i )
  {
    ...
    Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease(&v10);
    if ( *(_QWORD *)(a4 + 8) == v8 )
      break;
  }
  result = a1;
