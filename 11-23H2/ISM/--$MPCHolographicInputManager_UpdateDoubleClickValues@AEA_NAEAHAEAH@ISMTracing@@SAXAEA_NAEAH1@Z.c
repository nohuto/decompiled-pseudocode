/*
 * XREFs of ??$MPCHolographicInputManager_UpdateDoubleClickValues@AEA_NAEAHAEAH@ISMTracing@@SAXAEA_NAEAH1@Z @ 0x1800B35E8
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_UpdateDoubleClickValues<bool &,int &,int &>(
        const bool *a1,
        int *a2,
        int *a3)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCHolographicInputManager_UpdateDoubleClickValues_(v6, a1, a2, a3);
  }
}
