/*
 * XREFs of ?QueryInterface@BamoInputProcessManagerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012EE00
 * Callers:
 *     ?QueryInterface@BamoInputProcessManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180067650 (-QueryInterface@BamoInputProcessManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
