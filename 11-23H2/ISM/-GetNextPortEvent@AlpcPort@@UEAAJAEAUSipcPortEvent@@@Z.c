/*
 * XREFs of ?GetNextPortEvent@AlpcPort@@UEAAJAEAUSipcPortEvent@@@Z @ 0x18011A340
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DiscardAttributes@AlpcMessage@@QEAAJPEAX@Z @ 0x180119A24 (-DiscardAttributes@AlpcMessage@@QEAAJPEAX@Z.c)
 ...
 *     ?PopFront@?$NtList@UAlpcSectionListEntry@AlpcPort@@@@QEAAPEAUAlpcSectionListEntry@AlpcPort@@XZ @ 0x18011AE2C (-PopFront@-$NtList@UAlpcSectionListEntry@AlpcPort@@@@QEAAPEAUAlpcSectionListEntry@AlpcPort@@XZ.c)
