/*
 * XREFs of ?OnMessage@BamoMPCConstantManagerClientCallbacksProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18017B7B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCConstantManagerClientCallbacksProxyImpl::OnMessage(
