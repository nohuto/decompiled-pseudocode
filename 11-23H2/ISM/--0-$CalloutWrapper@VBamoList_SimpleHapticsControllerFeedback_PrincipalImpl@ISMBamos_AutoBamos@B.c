/*
 * XREFs of ??0?$CalloutWrapper@VBamoList_SimpleHapticsControllerFeedback_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoList_SimpleHapticsControllerFeedback_PrincipalImpl@ISMBamos_AutoBamos@1Lib@Bamo@2@@Z @ 0x1801AA52C
 * Callers:
 ...
 * Callees:
 *     ??0?$CalloutWrapper@VBamoList_SimpleHapticsControllerFeedback_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoList_SimpleHapticsControllerFeedback_PrincipalImpl@ISMBamos_AutoBamos@1Lib@Bamo@2@W4PrologEpilogConfig@12@@Z @ 0x1801AA558 (--0-$CalloutWrapper@VBamoList_SimpleHapticsControllerFeedback_PrincipalImpl@ISMBamo_ea_1801AA558.c)
 */
