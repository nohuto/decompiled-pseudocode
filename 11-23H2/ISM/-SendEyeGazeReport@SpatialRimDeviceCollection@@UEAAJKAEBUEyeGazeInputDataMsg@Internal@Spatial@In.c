/*
 * XREFs of ?SendEyeGazeReport@SpatialRimDeviceCollection@@UEAAJKAEBUEyeGazeInputDataMsg@Internal@Spatial@Input@UI@Windows@@@Z @ 0x1800DB040
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct Windows::UI::Input::Spatial::Internal::EyeGazeInputDataMsg *a3)
{
  ...
  __int64 v10; // rcx
  __int128 v11; // xmm1
  int v12[12]; // [rsp+30h] [rbp-BE8h] BYREF
  char v13; // [rsp+60h] [rbp-BB8h]
  __int128 v14; // [rsp+BC0h] [rbp-58h]
  __int128 v15; // [rsp+BD0h] [rbp-48h]
  __int64 v16; // [rsp+BE0h] [rbp-38h]
