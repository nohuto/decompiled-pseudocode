/*
 * XREFs of ?OnInputReport@ButtonProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x1801D8670
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z @ 0x1801D81E4 (-ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z.c)
