/*
 * XREFs of ?UpdateOcclusionRects@BamoSystemContextEndpointPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18009FB8C
 * Callers:
 *     ?Thunk_UpdateOcclusionRects_8@?$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpointPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18009F9A0 (-Thunk_UpdateOcclusionRects_8@-$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpoi.c)
 * Callees:
