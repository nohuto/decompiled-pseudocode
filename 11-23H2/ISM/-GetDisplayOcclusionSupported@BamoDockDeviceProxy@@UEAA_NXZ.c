/*
 * XREFs of ?GetDisplayOcclusionSupported@BamoDockDeviceProxy@@UEAA_NXZ @ 0x180124E70
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoDockDeviceProxy::GetDisplayOcclusionSupported(BamoDockDeviceProxy *this)
{
