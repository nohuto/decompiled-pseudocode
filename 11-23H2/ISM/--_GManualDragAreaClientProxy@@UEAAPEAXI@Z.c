/*
 * XREFs of ??_GManualDragAreaClientProxy@@UEAAPEAXI@Z @ 0x1800A58D0
 * Callers:
 *     <none>
 * Callees:
...
ManualDragAreaClientProxy *__fastcall ManualDragAreaClientProxy::`scalar deleting destructor'(
        ManualDragAreaClientProxy *this,
        char a2)
{
