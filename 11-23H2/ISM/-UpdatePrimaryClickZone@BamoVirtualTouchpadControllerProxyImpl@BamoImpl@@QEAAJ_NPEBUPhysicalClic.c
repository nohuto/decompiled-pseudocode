/*
 * XREFs of ?UpdatePrimaryClickZone@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_NPEBUPhysicalClickZone@Input@Internal@UI@Windows@@@Z @ 0x18014604C
 * Callers:
 *     ?Thunk_UpdatePrimaryClickZone_404@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005FB70 (-Thunk_UpdatePrimaryClickZone_404@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpad.c)
