/*
 * XREFs of ?Thunk_DisposeProxy_14@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800B2240
 * Callers:
 *     <none>
 * Callees:
 *     <none>
