/*
 * XREFs of ?Create@EdgyProcessorTarget@@SAJPEAVEdgyLegacyProcessor@@AEBUEdgyPointerInfo@@UtagMsgRoutingInfo@@PEAXPEAPEAV1@@Z @ 0x1801CB1E0
 * Callers:
 ...
 *     ??0EdgyProcessorTarget@@IEAA@PEAVEdgyLegacyProcessor@@@Z @ 0x1801CABB0 (--0EdgyProcessorTarget@@IEAA@PEAVEdgyLegacyProcessor@@@Z.c)
