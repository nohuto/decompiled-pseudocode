/*
 * XREFs of ?UpdatePrimaryUsageId@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NG@Z @ 0x180139254
 * Callers:
 *     ?Thunk_UpdatePrimaryUsageId_80@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134160 (-Thunk_UpdatePrimaryUsageId_80@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoI.c)
