...
void __fastcall std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>,void *>>>::~_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>,void *>>>(
        __int64 a1)
{
  __int64 v1; // rbx
  void *v3; // rcx
  ...
  if ( v1 )
  {
    std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>,void *>>>(
      v1 + 40,
      v1 + 40,
      *(__int64 **)(*(_QWORD *)(v1 + 40) + 8LL));
    std::_Deallocate<16,0>(*(void **)(v1 + 40), 0x48uLL);
  }
  v3 = *(void **)(a1 + 8);
  if ( v3 )
