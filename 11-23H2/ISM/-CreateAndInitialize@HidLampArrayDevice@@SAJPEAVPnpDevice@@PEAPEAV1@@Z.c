/*
 * XREFs of ?CreateAndInitialize@HidLampArrayDevice@@SAJPEAVPnpDevice@@PEAPEAV1@@Z @ 0x1800F0448
 * Callers:
 ...
 *     ??0HidLampArrayDevice@@AEAA@XZ @ 0x1800EFF14 (--0HidLampArrayDevice@@AEAA@XZ.c)
