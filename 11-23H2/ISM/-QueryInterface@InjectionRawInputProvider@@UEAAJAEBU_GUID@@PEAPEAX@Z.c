/*
 * XREFs of ?QueryInterface@InjectionRawInputProvider@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800E89B0
 * Callers:
 *     ?QueryInterface@InjectionRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180066430 (-QueryInterface@InjectionRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
