/*
 * XREFs of ?CreateChildInputProcessor@@YAJW4InputType@@PEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180038090
 * Callers:
 ...
 *     ?ValidateParams@@YAJPEBUInputProcessorCreateParams@@_N@Z @ 0x18005493C (-ValidateParams@@YAJPEBUInputProcessorCreateParams@@_N@Z.c)
 *     ?IsSingleBit@@YAHJ@Z @ 0x1800549EC (-IsSingleBit@@YAHJ@Z.c)
...
LABEL_20:
  ...
  {
    v9 = 48LL * v8;
    v10 = *(_QWORD *)v15 - *(_QWORD *)((char *)&unk_180266000 + v9);
    if ( *(_QWORD *)v15 == *(_QWORD *)((char *)&unk_180266000 + v9) )
      v10 = *(_QWORD *)&v15[2] - *(_QWORD *)((char *)&unk_180266000 + v9 + 8);
    if ( !v10 )
      break;
  ...
  if ( *(_DWORD *)((char *)&unk_180266000 + v9 + 16) != a1 )
    v11 = 0LL;
