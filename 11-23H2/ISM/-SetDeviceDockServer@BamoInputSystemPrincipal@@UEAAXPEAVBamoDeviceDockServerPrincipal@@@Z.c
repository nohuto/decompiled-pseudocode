/*
 * XREFs of ?SetDeviceDockServer@BamoInputSystemPrincipal@@UEAAXPEAVBamoDeviceDockServerPrincipal@@@Z @ 0x180053270
 * Callers:
 ...
 *     ?UpdateDeviceDockServerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x18013CCBC (-UpdateDeviceDockServerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubI.c)
 */

// Hidden C++ exception states: #wind=2
void __fastcall BamoInputSystemPrincipal::SetDeviceDockServer(
