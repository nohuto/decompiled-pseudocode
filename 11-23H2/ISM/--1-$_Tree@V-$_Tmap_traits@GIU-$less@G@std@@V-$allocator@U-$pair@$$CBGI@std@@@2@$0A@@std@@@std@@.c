/*
 * XREFs of ??1?$_Tree@V?$_Tmap_traits@GIU?$less@G@std@@V?$allocator@U?$pair@$$CBGI@std@@@2@$0A@@std@@@std@@QEAA@XZ @ 0x18005569C
 * Callers:
 *     _std::map_unsigned_short_unsigned_int_std::less_unsigned_short__std::allocator_std::pair_unsigned_short_const__unsigned_int_____::map_unsigned_short_unsigned_int_std::less_unsigned_short__std::allocator_std::pair_unsigned_short_const__unsigned_int______::_1_::dtor$0 @ 0x18005518C (_std--map_unsigned_short_unsigned_int_std--less_unsigned_short__std--allocator_std--pair_unsigne.c)
 *     _dynamic_atexit_destructor_for__c_handedModifierMapping__ @ 0x18006FF80 (_dynamic_atexit_destructor_for__c_handedModifierMapping__.c)
 * Callees:
