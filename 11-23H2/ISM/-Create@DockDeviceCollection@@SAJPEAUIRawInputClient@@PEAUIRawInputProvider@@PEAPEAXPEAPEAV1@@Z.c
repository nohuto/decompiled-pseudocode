/*
 * XREFs of ?Create@DockDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x1800E1EC0
 * Callers:
 ...
 *     ??1?$unique_ptr@VDockDeviceCollection@@U?$default_delete@VDockDeviceCollection@@@std@@@std@@QEAA@XZ @ 0x1800E1D80 (--1-$unique_ptr@VDockDeviceCollection@@U-$default_delete@VDockDeviceCollection@@@std@@@std@@QEAA.c)
