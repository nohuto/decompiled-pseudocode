/*
 * XREFs of ?UpdateUIAHitTestInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000F500
 * Callers:
 *     ?Thunk_UpdateUIAHitTestInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800199B0 (-Thunk_UpdateUIAHitTestInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxy.c)
