/*
 * XREFs of ??1RawButtonProcessor@@UEAA@XZ @ 0x1801D27D4
 * Callers:
 ...
 *     ??1PrivateMessageSession@RawButtonProcessor@@QEAA@XZ @ 0x1801D2718 (--1PrivateMessageSession@RawButtonProcessor@@QEAA@XZ.c)
 */
