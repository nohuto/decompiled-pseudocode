/*
 * XREFs of ?QueryInterface@BamoMPCConstantManagerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017C030
 * Callers:
 *     ?QueryInterface@BamoMPCConstantManagerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180068A70 (-QueryInterface@BamoMPCConstantManagerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
