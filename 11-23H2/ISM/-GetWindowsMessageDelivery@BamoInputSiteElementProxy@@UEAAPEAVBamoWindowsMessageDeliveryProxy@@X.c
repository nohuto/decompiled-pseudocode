/*
 * XREFs of ?GetWindowsMessageDelivery@BamoInputSiteElementProxy@@UEAAPEAVBamoWindowsMessageDeliveryProxy@@XZ @ 0x1800110B0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoWindowsMessageDeliveryProxy *)*((_QWORD *)this + 39);
}
