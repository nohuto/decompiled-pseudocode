/*
 * XREFs of ??$MPCGestureHandler_InjectPress@AEAJAEAJAEBKK@ISMTracing@@SAXAEAJ0AEBK$$QEAK@Z @ 0x1800B9A44
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCGestureHandler_InjectPress_(v8, *a1, *a2, *a3, *a4);
  }
}
