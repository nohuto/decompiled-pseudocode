/*
 * XREFs of ?UpdateDeviceType@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NW4DockableDeviceObjectType@@@Z @ 0x180135B98
 * Callers:
 *     ?Thunk_UpdateDeviceType_16@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133D20 (-Thunk_UpdateDeviceType_16@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@.c)
