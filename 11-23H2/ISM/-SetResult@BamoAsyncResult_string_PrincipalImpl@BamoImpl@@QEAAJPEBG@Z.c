/*
 * XREFs of ?SetResult@BamoAsyncResult_string_PrincipalImpl@BamoImpl@@QEAAJPEBG@Z @ 0x18018F020
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018F180 (-Thunk_SetResult_0@-$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_string_PrincipalImpl::SetResult(
  ...
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
      ...
      *(_QWORD *)(v9 + 32),
      v7,
      0LL);
    v11 = (*(__int64 (__fastcall **)(char *, __int64, const unsigned __int16 *))(*((_QWORD *)this - 2) + 80LL))(
            (char *)this - 16,
            v8,
            a2);
    v4 = v11;
