/*
 * XREFs of ?InsertValue@HidChannelValueInfo@@QEAAJE_KPEAE@Z @ 0x1800F6870
 * Callers:
 ...
 * Callees:
 *     ?InternalInsertValue@HidChannelValueInfo@@AEAAXI_KPEAE@Z @ 0x1800F68FC (-InternalInsertValue@HidChannelValueInfo@@AEAAXI_KPEAE@Z.c)
 */
