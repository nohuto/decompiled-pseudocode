/*
 * XREFs of ??$MPCEyeGazeProcessor_DeviceAttached@AEAK@ISMTracing@@SAXAEAK@Z @ 0x1800C4398
 * Callers:
...
void __fastcall ISMTracing::MPCEyeGazeProcessor_DeviceAttached<unsigned long &>(unsigned int *a1)
{
  ISMTracing *v2; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCEyeGazeProcessor_DeviceAttached_(v2, *a1);
  }
}
