/*
 * XREFs of ?Thunk_RegisterSystemContextEndpoint_8@?$ISystemContextManagerPrincipal_Receive@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801514F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
