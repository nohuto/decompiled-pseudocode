/*
 * XREFs of ?OnSpatialManipulationStarted@MPCSpatialGestureRecognizerHandler@@AEAAJPEAUISpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAUISpatialManipulationStartedEventArgs@3456@@Z @ 0x1800C2D80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  *((_DWORD *)this + 49) = (int)v25;
  ISMTracing::GestureRecognizer_GestureDetected<unsigned short const (&)[12]>(L"PathStarted");
  return 0LL;
}
