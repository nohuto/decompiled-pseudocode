/*
 * XREFs of ?OnConnectedThunk@BamoControllerNavigationManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180018910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoControllerNavigationManagerStubImpl::OnConnectedThunk(
