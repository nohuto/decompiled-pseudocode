/*
 * XREFs of ??0?$CalloutWrapper@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoEdgyControllerClientProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18016A658
 * Callers:
