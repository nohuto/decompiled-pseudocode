/*
 * XREFs of ?SendMaterializeProxy@BamoList_uint_PrincipalImpl@dataprovider_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@36@@Z @ 0x180112AB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  LOWORD(v12) = 4;
  v9 = CoreUICallSend(a2, &v13, 2LL, 7LL);
  if ( v9 < 0 )
  ...
  v14 = *(unsigned int *)(v3 + 40);
  LOWORD(v12) = 5;
  v11 = CoreUICallSend(a2, &v13, 2LL, 7LL);
  if ( v11 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x3901,
