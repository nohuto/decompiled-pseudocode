/*
 * XREFs of ?OnSpatialManipulationCanceled@MPCSpatialGestureRecognizerHandler@@AEAAJPEAUISpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAUISpatialManipulationCanceledEventArgs@3456@@Z @ 0x1800C2D00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::UI::Input::Spatial::ISpatialManipulationCanceledEventArgs *a3)
{
  ...
  if ( v3 )
    *(_DWORD *)(v3 + 856) = 2;
  ISMTracing::GestureRecognizer_GestureDetected<unsigned short const (&)[13]>(L"PathCanceled");
  result = 0LL;
  *((_BYTE *)this + 172) = 0;
  return result;
}
