/*
 * XREFs of ?TryCreateAndInitialize@HidLampArrayAttributesReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800F3ED0
 * Callers:
 ...
 *     ??0HidLampArrayAttributesReportParser@@AEAA@XZ @ 0x1800F3B14 (--0HidLampArrayAttributesReportParser@@AEAA@XZ.c)
