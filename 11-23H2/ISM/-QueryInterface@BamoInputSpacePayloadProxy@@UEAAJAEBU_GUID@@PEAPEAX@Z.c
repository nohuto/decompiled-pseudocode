/*
 * XREFs of ?QueryInterface@BamoInputSpacePayloadProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012EF20
 * Callers:
 *     ?QueryInterface@BamoInputSpacePayloadProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180067690 (-QueryInterface@BamoInputSpacePayloadProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
