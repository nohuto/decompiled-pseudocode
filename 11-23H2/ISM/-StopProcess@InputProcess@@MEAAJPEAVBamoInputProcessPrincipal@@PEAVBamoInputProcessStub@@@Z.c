/*
 * XREFs of ?StopProcess@InputProcess@@MEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoInputProcessStub@@@Z @ 0x1800CB530
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoInputProcessStub *a3)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_180222F7D, 0LL, 0LL, 2u, &v7);
  }
