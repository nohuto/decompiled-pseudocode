/*
 * XREFs of ?RemoteClear@?$ListProxyCommon@VBamoList_DisplayOcclusionRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UDisplayOcclusionRect@@@Bamo@Microsoft@@MEAAJXZ @ 0x180149BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::Bamo::ListProxyCommon<Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_DisplayOcclusionRect_Proxy,DisplayOcclusionRect>::RemoteClear(
        _QWORD *a1)
{
  __int64 v2; // rax
