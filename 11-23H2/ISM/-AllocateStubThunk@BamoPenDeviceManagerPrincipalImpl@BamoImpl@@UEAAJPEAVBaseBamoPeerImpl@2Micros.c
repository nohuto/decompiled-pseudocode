/*
 * XREFs of ?AllocateStubThunk@BamoPenDeviceManagerPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x180015F60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v5 = (*(__int64 (__fastcall **)(BamoImpl::BamoPenDeviceManagerPrincipalImpl *))(*(_QWORD *)this + 56LL))(this);
  v6 = *((_QWORD *)a2 + 2);
  v7 = v5;
