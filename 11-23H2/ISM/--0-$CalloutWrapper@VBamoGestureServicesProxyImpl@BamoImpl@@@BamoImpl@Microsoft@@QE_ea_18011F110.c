/*
 * XREFs of ??0?$CalloutWrapper@VBamoGestureServicesProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoGestureServicesProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18011F110
 * Callers:
