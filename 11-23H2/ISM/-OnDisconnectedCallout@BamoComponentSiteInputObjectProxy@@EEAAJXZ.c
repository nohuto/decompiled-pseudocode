/*
 * XREFs of ?OnDisconnectedCallout@BamoComponentSiteInputObjectProxy@@EEAAJXZ @ 0x18012A1F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoComponentSiteInputObjectProxy::OnDisconnectedCallout(BamoComponentSiteInputObjectProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoComponentSiteInputObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoComponentSiteInputObjectProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoComponentSiteInputObjectProxy *))(*(_QWORD *)v1 + 40LL))(v1);
