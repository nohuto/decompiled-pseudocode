/*
 * XREFs of ?_Reallocate_exactly@?$vector@IV?$allocator@I@std@@@std@@AEAAX_K@Z @ 0x1800FD2FC
 * Callers:
 *     ?reserve@?$vector@IV?$allocator@I@std@@@std@@QEAAX_K@Z @ 0x1800FD88C (-reserve@-$vector@IV-$allocator@I@std@@@std@@QEAAX_K@Z.c)
 * Callees:
...
__int64 __fastcall std::vector<unsigned int>::_Reallocate_exactly(__int64 a1, unsigned __int64 a2)
{
  __int64 v4; // rdi
  size_t size_of; // rax
  void *v6; // rax
