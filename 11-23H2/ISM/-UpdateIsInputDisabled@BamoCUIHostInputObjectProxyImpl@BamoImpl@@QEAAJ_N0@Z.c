/*
 * XREFs of ?UpdateIsInputDisabled@BamoCUIHostInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180141830
 * Callers:
 *     ?Thunk_UpdateIsInputDisabled_11@?$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801415A0 (-Thunk_UpdateIsInputDisabled_11@-$ICUIHostInputObjectProxy_Receive@VBamoCUIHostInputObjectProxyI.c)
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v11[0]);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoCUIHostInputObjectProxyImpl>::~CalloutWrapper<BamoImpl::BamoCUIHostInputObjectProxyImpl>((__int64)v11);
  }
  else
  {
    v6 = (char *)this - 16;
