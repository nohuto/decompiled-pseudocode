/*
 * XREFs of ?MPCEyeGazeProcessor_DeviceDetached_@ISMTracing@@QEAAXK@Z @ 0x1800C7670
 * Callers:
...
void __fastcall ISMTracing::MPCEyeGazeProcessor_DeviceDetached_(ISMTracing *this, int a2)
{
  ...
  if ( *v3 > 4u )
  {
    ...
    v5 = a2;
    v11 = 4;
    tlgWriteTransfer_EventWriteTransfer((__int64)v3, (unsigned __int8 *)dword_180222256, 0LL, 0LL, 3u, &v9);
  }
}
