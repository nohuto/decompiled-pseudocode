/*
 * XREFs of ?RecognizeTwoFingerTap@Magnifier@InputTraceLogging@@SAXXZ @ 0x1801CE438
 * Callers:
...
void __fastcall InputTraceLogging::Magnifier::RecognizeTwoFingerTap(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_180228C48, 0LL, 0LL, 2u, &v2);
  }
}
