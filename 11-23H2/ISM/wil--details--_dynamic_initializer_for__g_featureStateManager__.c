/*
 * XREFs of wil::details::_dynamic_initializer_for__g_featureStateManager__ @ 0x1800018C0
 * Callers:
 *     <none>
 * Callees:
 *     ??0FeatureStateManager@details@wil@@QEAA@XZ @ 0x18004E8D0 (--0FeatureStateManager@details@wil@@QEAA@XZ.c)
 */
