/*
 * XREFs of ??1heap_buffer@details_abi@wil@@QEAA@XZ @ 0x180092644
 * Callers:
 *     _wil::details_abi::RawUsageIndex::RecordUsage_::_1_::dtor$0 @ 0x180094483 (_wil--details_abi--RawUsageIndex--RecordUsage_--_1_--dtor$0.c)
 * Callees:
