/*
 * XREFs of ?Thunk_CancelResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180162870
 * Callers:
 *     <none>
 * Callees:
 *     <none>
