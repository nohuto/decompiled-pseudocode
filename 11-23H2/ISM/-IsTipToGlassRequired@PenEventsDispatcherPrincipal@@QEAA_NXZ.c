/*
 * XREFs of ?IsTipToGlassRequired@PenEventsDispatcherPrincipal@@QEAA_NXZ @ 0x1801AEBF8
 * Callers:
 *     ?IsTipToGlassRequired@PenEventsTipToGlassAdapter@@SA_NXZ @ 0x1801DA8DC (-IsTipToGlassRequired@PenEventsTipToGlassAdapter@@SA_NXZ.c)
 * Callees:
