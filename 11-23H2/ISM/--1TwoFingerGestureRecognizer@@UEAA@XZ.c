/*
 * XREFs of ??1TwoFingerGestureRecognizer@@UEAA@XZ @ 0x1801D345C
 * Callers:
 *     _GestureSession::GestureSession_::_1_::dtor$4 @ 0x1801D3440 (_GestureSession--GestureSession_--_1_--dtor$4.c)
 * Callees:
 *     <none>
 */
