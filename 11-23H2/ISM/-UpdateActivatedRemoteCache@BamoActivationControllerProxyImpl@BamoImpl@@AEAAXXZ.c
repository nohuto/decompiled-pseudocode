/*
 * XREFs of ?UpdateActivatedRemoteCache@BamoActivationControllerProxyImpl@BamoImpl@@AEAAXXZ @ 0x1800A5D1C
 * Callers:
 *     ?PushStateToPrincipal@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXXZ @ 0x1800A5AC0 (-PushStateToPrincipal@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXXZ.c)
