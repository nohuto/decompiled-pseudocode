/*
 * XREFs of ??1_Clear_guard@?$_Hash@V?$_Umap_traits@KW4ContextualProcessorDecision@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@@3@$0A@@std@@@std@@QEAA@XZ @ 0x18015CB08
 * Callers:
 ...
 *     _ContextualProcessorBuffer::EventStreamEndedAndProcessFinalDecision_::_1_::dtor$9 @ 0x180063B2D (_ContextualProcessorBuffer--EventStreamEndedAndProcessFinalDecision_--_1_--dtor$9.c)
 *     _ContextualProcessorBuffer::MakeContextualProcessorDecision_::_1_::dtor$3 @ 0x1801C1A1D (_ContextualProcessorBuffer--MakeContextualProcessorDecision_--_1_--dtor$3.c)
 * Callees:
