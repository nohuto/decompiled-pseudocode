/*
 * XREFs of ??1BamoMPCManagerPrincipal@@MEAA@XZ @ 0x1800AE548
 * Callers:
 *     _PenDeviceManager::PenDeviceManager_::_1_::dtor$0 @ 0x18006E27A (_PenDeviceManager--PenDeviceManager_--_1_--dtor$0.c)
 *     _HapticsDevice::HapticsDevice_::_1_::dtor$0 @ 0x1801AA859 (_HapticsDevice--HapticsDevice_--_1_--dtor$0.c)
 * Callees:
