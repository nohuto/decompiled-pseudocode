/*
 * XREFs of ?RuntimeClassInitialize@ForegroundManager@@UEAAJXZ @ 0x180040BC0
 * Callers:
 ...
 *     ??0?$ListPrincipal@VBamoActivatableEntityPrincipal@@@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@QEAA@PEAVBamoConnection@1@@Z @ 0x180040DAC (--0-$ListPrincipal@VBamoActivatableEntityPrincipal@@@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@QEAA.c)
...
__int64 __fastcall ForegroundManager::RuntimeClassInitialize(ForegroundManager *this)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v2, (int)&dword_1802210B5, 0, 0, 2u, &v20);
  }
  ...
  if ( v3 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v18);
  v20.Ptr = (ULONGLONG)off_1802035F0;
  *(_QWORD *)&v20.Size = this;
  ...
  {
    v20.Ptr = (ULONGLONG)off_180203620;
    *(_QWORD *)&v20.Size = this;
    v21 = &v20;
