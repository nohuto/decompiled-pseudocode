/*
 * XREFs of ??$GetAttachedObject@UIAnimationTargetClientProxy@@VAnimationTargetClientProxy@@@InputSite@@QEAA?AV?$ComPtr@VAnimationTargetClientProxy@@@WRL@Microsoft@@XZ @ 0x18016DD74
 * Callers:
 ...
 *     ??$As@UIAnimationTargetClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIAnimationTargetClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18013F8A4 (--$As@UIAnimationTargetClientProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$Co.c)
 */
