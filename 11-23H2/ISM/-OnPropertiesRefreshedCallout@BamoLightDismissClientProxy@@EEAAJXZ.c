/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoLightDismissClientProxy@@EEAAJXZ @ 0x180172140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoLightDismissClientProxy::OnPropertiesRefreshedCallout(BamoLightDismissClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoLightDismissClientProxyImpl>::CalloutWrapper<BamoImpl::BamoLightDismissClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoLightDismissClientProxy *))(*(_QWORD *)v1 + 48LL))(v1);
