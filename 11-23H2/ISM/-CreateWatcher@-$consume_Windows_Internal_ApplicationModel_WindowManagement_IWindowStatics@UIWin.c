/*
 * XREFs of ?CreateWatcher@?$consume_Windows_Internal_ApplicationModel_WindowManagement_IWindowStatics@UIWindowStatics@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@impl@winrt@@QEBA@XZ @ 0x1800529B8
 * Callers:
 *     ??0ViewHierarchyWithWindowManager@@QEAA@XZ @ 0x180048354 (--0ViewHierarchyWithWindowManager@@QEAA@XZ.c)
 *     ?_lambda_invoker_cdecl_@_lambda_ae55d4909240e1fdeaaab3ab1260b561_@@CA@AEBUIWindowStatics@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@Z @ 0x180052990 (-_lambda_invoker_cdecl_@_lambda_ae55d4909240e1fdeaaab3ab1260b561_@@CA@AEBUIWindowStatics@WindowM.c)
