/*
 * XREFs of ?OnWindowsMessageDeliveryChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18001EC00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$?RUAttachedInputObjectEntry@InputSite@@@_lambda_9c87987138ffa5ecb6aee109509755f0_@@QEBA?A_PAEBUAttachedInputObjectEntry@InputSite@@@Z @ 0x18001EDF0 (--$-RUAttachedInputObjectEntry@InputSite@@@_lambda_9c87987138ffa5ecb6aee109509755f0_@@QEBA-A_PAE.c)
        ...
        const char *a4)
{
  ...
  v7 = *(_QWORD *)(v5 + 488);
  v22 = v21;
  for ( i = &v20; v7 != v6; v7 += 16LL )
  {
    if ( (unsigned __int8)_lambda_9c87987138ffa5ecb6aee109509755f0_::operator()<InputSite::AttachedInputObjectEntry>(
                            &v22,
                            v7) )
      break;
  }
  ...
  {
    v19 = 0LL;
    if ( (int)Microsoft::WRL::ComPtr<IUnknown>::As<IInputSiteClientPrivate>(v7 + 8, &v19) >= 0 )
      (*(void (__fastcall **)(__int64))(*(_QWORD *)v19 + 32LL))(v19);
    std::vector<InputSite::AttachedInputObjectEntry>::erase(v5 + 488, &v22, v7);
  ...
  v9 = *((_QWORD *)this + 41);
  v10 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 296LL))((char *)this + 8);
  if ( v10 )
  {
    v12 = (__int64 *)(v10 + 8);
    v21[0] = v10 + 8;
    ...
    v20 = 0LL;
    if ( (int)Microsoft::WRL::ComPtr<IUnknown>::As<IInputSiteClientPrivate>(v21, &v20) >= 0 )
      (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v20 + 24LL))(v20, v9);
    v19 = 0LL;
    v14 = *(int (__fastcall **)(__int64 *, GUID *, __int64 *))*v12;
    Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease(&v19);
    if ( v14(v12, &GUID_ae83b6cb_def2_49fe_9564_e870d32281a5, &v19) >= 0 && *(_BYTE *)(v9 + 480) )
    {
      v16 = v19;
      v17 = *(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v19 + 24LL);
      Transform = LegacyInputSinkData::GetTransform(v9 + 48, v24);
      v17(v16, Transform);
    }
    Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease(&v19);
