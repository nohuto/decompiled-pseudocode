/*
 * XREFs of ?UpdateVisualReferenceId@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x180194578
 * Callers:
 *     ?Thunk_UpdateVisualReferenceId_0@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801938B0 (-Thunk_UpdateVisualReferenceId_0@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNav.c)
