/*
 * XREFs of ?OnDisconnectedThunk@BamoControllerNavigationManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180028590
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$CalloutWrapper@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoControllerNavigationManagerPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180028610 (--0-$CalloutWrapper@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@.c)
