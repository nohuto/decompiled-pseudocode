/*
 * XREFs of ?GetType@BamoEdgyDragSourceClientProxy@@UEAAAEBU_GUID@@XZ @ 0x1801259E0
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoEdgyDragSourceClientProxy::GetType(BamoEdgyDragSourceClientProxy *this)
{
