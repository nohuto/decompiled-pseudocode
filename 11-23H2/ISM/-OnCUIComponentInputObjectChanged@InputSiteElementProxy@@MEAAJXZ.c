/*
 * XREFs of ?OnCUIComponentInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000DDF0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    if ( v24 )
    {
      ...
      v12 = v26(v9, &GUID_ef2daa6b_70a1_714f_af3c_a61437d80866, &v24);
    }
    else
    {
      v12 = v10(v9, &GUID_ef2daa6b_70a1_714f_af3c_a61437d80866, &v24);
    }
    v13 = v12 >= 0;
    if ( v8 == this && v13 )
      break;
  ...
  v15 = *((_QWORD *)this + 41);
  v16 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 104LL))((char *)this + 8);
  if ( v16 )
  {
    v18 = v16 + 8;
    v24 = v16 + 8;
