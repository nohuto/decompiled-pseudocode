/*
 * XREFs of ?SetThreadId@BamoActivatableEntityPrincipal@@UEAAXI@Z @ 0x180017920
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoActivatableEntityPrincipal::SetThreadId(BamoActivatableEntityPrincipal *this, int a2)
{
  __int64 v4; // rdi
