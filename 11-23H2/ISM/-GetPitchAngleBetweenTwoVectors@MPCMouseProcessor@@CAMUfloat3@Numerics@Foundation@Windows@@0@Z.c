/*
 * XREFs of ?GetPitchAngleBetweenTwoVectors@MPCMouseProcessor@@CAMUfloat3@Numerics@Foundation@Windows@@0@Z @ 0x1801E7338
 * Callers:
...
__m128 __fastcall MPCMouseProcessor::GetPitchAngleBetweenTwoVectors(unsigned __int64 *a1, unsigned __int64 *a2)
{
  ...
  *a1 = v6.m128_u64[0];
  v14 = _mm_shuffle_ps(v6, v6, 170).m128_u32[0];
  ...
  *(float *)&v11 = o_asinf_0(*(float *)&v11);
  v12 = v11;
  *(float *)&v12 = *(float *)&v11 - o_asinf_0(*((float *)a1 + 1));
  return (__m128)v12;
}
