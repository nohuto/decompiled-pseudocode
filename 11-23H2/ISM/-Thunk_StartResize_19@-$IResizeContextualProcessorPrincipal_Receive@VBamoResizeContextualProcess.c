/*
 * XREFs of ?Thunk_StartResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801628B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
