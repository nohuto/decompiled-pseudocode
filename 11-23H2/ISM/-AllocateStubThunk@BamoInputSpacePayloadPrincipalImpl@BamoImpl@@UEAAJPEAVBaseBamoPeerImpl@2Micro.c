/*
 * XREFs of ?AllocateStubThunk@BamoInputSpacePayloadPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x18014C770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSpacePayloadPrincipalImpl::AllocateStubThunk(
