/*
 * XREFs of ?Thunk_Materialize_BamoWindowsMessageDeliveryProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000B440
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreateWindowsMessageDeliveryProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoWindowsMessageDeliveryProxy@@@Z @ 0x18000B8BC (-CreateWindowsMessageDeliveryProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoWindowsMessag.c)
