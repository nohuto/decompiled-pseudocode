/*
 * XREFs of ?QueryInterface@ButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801D89C0
 * Callers:
 *     ?QueryInterface@ButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006AE90 (-QueryInterface@ButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
