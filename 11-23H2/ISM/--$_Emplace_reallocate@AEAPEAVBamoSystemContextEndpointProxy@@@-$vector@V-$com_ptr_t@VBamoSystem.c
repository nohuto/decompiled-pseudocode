/*
 * XREFs of ??$_Emplace_reallocate@AEAPEAVBamoSystemContextEndpointProxy@@@?$vector@V?$com_ptr_t@VBamoSystemContextEndpointProxy@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VBamoSystemContextEndpointProxy@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@QEAAPEAV?$com_ptr_t@VBamoSystemContextEndpointProxy@@Uerr_exception_policy@wil@@@wil@@QEAV23@AEAPEAVBamoSystemContextEndpointProxy@@@Z @ 0x18014B600
 * Callers:
...
__int64 *__fastcall std::vector<wil::com_ptr_t<BamoSystemContextEndpointProxy,wil::err_exception_policy>>::_Emplace_reallocate<BamoSystemContextEndpointProxy * &>(
        __int64 *a1,
        __int64 a2,
        __int64 *a3)
{
