/*
 * XREFs of ?SetAllConstantsForInputTypeToDefault@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@QEAAJW4InputType@@PEAVBamoAsyncHRESULTPrincipal@@@Z @ 0x18017CD0C
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a3)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      return CoreUICallSend(v12, v16, 2LL, 1LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
