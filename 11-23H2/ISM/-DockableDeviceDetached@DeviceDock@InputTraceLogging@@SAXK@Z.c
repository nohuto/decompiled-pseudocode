/*
 * XREFs of ?DockableDeviceDetached@DeviceDock@InputTraceLogging@@SAXK@Z @ 0x1800E3574
 * Callers:
...
void __fastcall InputTraceLogging::DeviceDock::DockableDeviceDetached(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = v1;
    v6 = 4;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180224199, 0LL, 0LL, 3u, &v4);
  }
}
