/*
 * XREFs of ?OnDisconnectedCallout@BamoInputProcessManagerProxy@@EEAAJXZ @ 0x18012AAB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputProcessManagerProxy::OnDisconnectedCallout(BamoInputProcessManagerProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputProcessManagerProxyImpl>::CalloutWrapper<BamoImpl::BamoInputProcessManagerProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoInputProcessManagerProxy *))(*(_QWORD *)v1 + 40LL))(v1);
