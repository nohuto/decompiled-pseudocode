/*
 * XREFs of ?UpdatePaused@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180193F58
 * Callers:
 *     ?Thunk_UpdatePaused_11@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180193830 (-Thunk_UpdatePaused_11@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOve.c)
