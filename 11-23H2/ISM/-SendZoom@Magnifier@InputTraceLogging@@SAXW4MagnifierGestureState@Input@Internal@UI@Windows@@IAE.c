/*
 * XREFs of ?SendZoom@Magnifier@InputTraceLogging@@SAXW4MagnifierGestureState@Input@Internal@UI@Windows@@IAEBUPoint@Foundation@7@@Z @ 0x1801CF31C
 * Callers:
...
int __fastcall InputTraceLogging::Magnifier::SendZoom(__int64 a1, int a2, int *a3)
{
  int v5; // esi
  __int64 v6; // rax
  __int64 v7; // r9
