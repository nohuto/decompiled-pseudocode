/*
 * XREFs of ??$MPCHolographicInputManager_ForcedPrimary@AEAW4InputType@@@ISMTracing@@SAXAEAW4InputType@@@Z @ 0x1800B2F20
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_ForcedPrimary<enum InputType &>(unsigned int *a1)
{
  ISMTracing *v2; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCHolographicInputManager_ForcedPrimary_(v2, *a1);
  }
}
