/*
 * XREFs of ?CheckOverlap@ManipulationInjector@@AEAA_NI@Z @ 0x18011B8C0
 * Callers:
 *     ?CheckOverlapAndEvent@ManipulationInjector@@AEAA_NXZ @ 0x18011BA58 (-CheckOverlapAndEvent@ManipulationInjector@@AEAA_NXZ.c)
        ...
        const char *a4)
{
  ...
  if ( *((_DWORD *)this + 22) == 16 )
  {
    ...
    if ( *(_DWORD *)this == 2 )
    {
      ...
      v17 = __OFSUB__(v15, *((_DWORD *)this + 188));
      v16 = v15 - *((_DWORD *)this + 188) < 0;
    }
    else
    {
  ...
  else
  {
    ...
    if ( *(_DWORD *)this == 2 )
    {
      ...
      v24 = __OFSUB__(v21, *((_DWORD *)this + 189));
      v22 = v21 == *((_DWORD *)this + 189);
      v23 = v21 - *((_DWORD *)this + 189) < 0;
    }
    else
    {
