/*
 * XREFs of ??0MPCTarget@@QEAA@PEAVInputSite@@W4FrameworkViewType@@K@Z @ 0x18010CBA8
 * Callers:
...
LABEL_19:
  ...
  if ( *(_DWORD *)(v7 + 44) == 6 )
  {
    try
    {
      v24[1] = (void (__fastcall *)(__int64, __int64 *))&qword_1802692D8;
      _InterlockedAdd64(&qword_1802692D8, 1uLL);
      ...
      {
        _InterlockedDecrement64(&qword_1802692D8);
        v24[0] = (void (__fastcall *)(__int64, __int64 *))_lambda_ae55d4909240e1fdeaaab3ab1260b561_::_lambda_invoker_cdecl_;
      ...
      if ( *v9 )
      {
        ...
        *(_QWORD *)&v28 = &MPCTarget::OnUniversalPropertyChanged;
        DWORD2(v28) = 0;
        *(_QWORD *)v29 = v7;
        *(_OWORD *)&v29[8] = v28;
        v19 = (char *)operator new(0x28uLL);
        *(_OWORD *)(v19 + 8) = *(_OWORD *)v29;
        *((_QWORD *)v19 + 3) = *(_QWORD *)&v29[16];
        _InterlockedExchangeAdd(&`winrt::get_module_lock'::`2'::s_lock, 1u);
        *((_DWORD *)v19 + 8) = 1;
        *(_QWORD *)v19 = &winrt::impl::delegate<winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Internal::ApplicationModel::WindowManagement::IUniversalAppModelWatcher,winrt::Windows::Internal::ApplicationModel::WindowManagement::UniversalPropertyChangedEventArgs>,_lambda_f7189cc794088eeaf33bed95e453010f_>::`vftable';
        v22 = (struct IMPCTarget *)v19;
  ...
  v22 = (struct IMPCTarget *)v7;
  ISMTracing::MPCTarget_Create<MPCTarget *>(&v22);
  return v7;
}
