/*
 * XREFs of ?InitializeProxyThunk@BamoInputSiteManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180018F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSiteManagerStubImpl::InitializeProxyThunk(
