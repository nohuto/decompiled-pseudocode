/*
 * XREFs of _std::vector_wil::com_ptr_t_BamoDeviceDockClientProxy_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_BamoDeviceDockClientProxy_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_BamoDeviceDockClientProxy_wil::err_returncode_policy____::_1_::catch$4 @ 0x18019B46E
 * Callers:
 *     <none>
 * Callees:
