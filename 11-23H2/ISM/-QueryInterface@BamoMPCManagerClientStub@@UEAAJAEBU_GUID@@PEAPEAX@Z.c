/*
 * XREFs of ?QueryInterface@BamoMPCManagerClientStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017FC40
 * Callers:
 *     ?QueryInterface@BamoMPCManagerClientStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180068DD0 (-QueryInterface@BamoMPCManagerClientStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
