...
_QWORD *__fastcall std::deque<ShellGesturesClientProxy *>::erase(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  ...
  v5 = *(__int64 **)(a3 + 16);
  v6 = *(__int64 **)(a4 + 16);
  v7 = (unsigned __int64)v5 - *((_QWORD *)&xmmword_180269160 + 1);
  ...
  else
  {
    ...
    if ( v7 >= *((_QWORD *)&xmmword_180269160 + 1) + qword_180269170 - (__int64)v6 )
    {
      v18 = v5;
      v16 = *((_QWORD *)&xmmword_180269160 + 1) + qword_180269170;
      std::move<std::_Deque_iterator<std::_Deque_val<std::_Deque_simple_types<ShellGesturesClientProxy *>>>,std::_Deque_iterator<std::_Deque_val<std::_Deque_simple_types<ShellGesturesClientProxy *>>>>(
        ...
        (__int64)v17);
      v11 = qword_180269170;
      v10 = *((_QWORD *)&xmmword_180269160 + 1);
      do
      {
      ...
      while ( v8 );
      *((_QWORD *)&xmmword_180269160 + 1) = v12;
      qword_180269170 = v11;
    }
    else
    {
      v16 = (__int64)v5;
      v18 = (__int64 *)*((_QWORD *)&xmmword_180269160 + 1);
      ...
      do
      {
        if ( --v9 )
          ...
          v10 = 0LL;
        *((_QWORD *)&xmmword_180269160 + 1) = v10;
        --v8;
      }
      while ( v8 );
      qword_180269170 = v9;
