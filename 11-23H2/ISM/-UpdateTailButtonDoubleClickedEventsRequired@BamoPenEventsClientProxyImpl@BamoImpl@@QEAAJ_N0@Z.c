/*
 * XREFs of ?UpdateTailButtonDoubleClickedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180054530
 * Callers:
 *     ?Thunk_UpdateTailButtonDoubleClickedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180054EA0 (-Thunk_UpdateTailButtonDoubleClickedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEv.c)
