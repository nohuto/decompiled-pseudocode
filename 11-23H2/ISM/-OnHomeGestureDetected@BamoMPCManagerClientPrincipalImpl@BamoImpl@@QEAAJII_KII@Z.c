/*
 * XREFs of ?OnHomeGestureDetected@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJII_KII@Z @ 0x18017F2CC
 * Callers:
 *     ?Thunk_OnHomeGestureDetected_53@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18017FF10 (-Thunk_OnHomeGestureDetected_53@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrinci.c)
 * Callees:
