/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoDataProviderStubImpl@BamoImpl@@UEAAJXZ @ 0x1801115B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDataProviderStubImpl::OnPropertiesRefreshedThunk(
