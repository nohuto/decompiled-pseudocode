/*
 * XREFs of ?SetCursorShellVisibility@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K_N@Z @ 0x180102BD0
 * Callers:
 *     ?Thunk_SetCursorShellVisibility_372@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005BCA0 (-Thunk_SetCursorShellVisibility_372@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursor.c)
 * Callees:
