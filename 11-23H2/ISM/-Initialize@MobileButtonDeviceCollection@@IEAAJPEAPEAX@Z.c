/*
 * XREFs of ?Initialize@MobileButtonDeviceCollection@@IEAAJPEAPEAX@Z @ 0x1800DDA0C
 * Callers:
...
__int64 __fastcall MobileButtonDeviceCollection::Initialize(HANDLE *this, void **a2, __int64 a3, __int64 a4)
{
  int v4; // eax
  unsigned int v5; // ebx
