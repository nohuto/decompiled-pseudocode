/*
 * XREFs of ?OnActivationListenerInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x1800231E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InputSiteElementProxy::OnActivationListenerInputObjectChanged(
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    if ( v25 )
    {
      ...
      v12 = v27(v9, &GUID_a1cdc933_ea3a_72de_bea8_f0397564bae3, &v25);
    }
    else
    {
      v12 = v10(v9, &GUID_a1cdc933_ea3a_72de_bea8_f0397564bae3, &v25);
    }
    v13 = v12 >= 0;
    if ( v8 == this && v13 )
      break;
  ...
  {
    v26 = 0LL;
    if ( (int)Microsoft::WRL::ComPtr<IUnknown>::As<IInputSiteClientPrivate>(i + 8, &v26) >= 0 )
  ...
  v15 = *((_QWORD *)this + 41);
  v16 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 56LL))((char *)this + 8);
  if ( v16 )
  {
    v18 = (int (__fastcall ***)(_QWORD, GUID *, __int64 *))(v16 + 8);
    v27 = (__int64 (__fastcall *)(_QWORD, GUID *, __int64 *))(v16 + 8);
    ...
    if ( (int)Microsoft::WRL::ComPtr<IUnknown>::As<IInputSiteClientPrivate>(&v27, &v26) >= 0 )
      (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v26 + 24LL))(v26, v15);
    v25 = 0LL;
    v20 = **v18;
    Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease(&v25);
    if ( v20(v18, &GUID_ae83b6cb_def2_49fe_9564_e870d32281a5, &v25) >= 0 && *(_BYTE *)(v15 + 480) )
    {
      v22 = v25;
      v23 = *(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v25 + 24LL);
      Transform = LegacyInputSinkData::GetTransform(v15 + 48, v30);
      v23(v22, Transform);
    }
    Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease(&v25);
    Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::InternalRelease(&v26);
