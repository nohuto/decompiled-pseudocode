/*
 * XREFs of ??$_Emplace_reallocate@AEAV?$function@$$A6AX_N@Z@std@@@?$vector@V?$function@$$A6AX_N@Z@std@@V?$allocator@V?$function@$$A6AX_N@Z@std@@@2@@std@@QEAAPEAV?$function@$$A6AX_N@Z@1@QEAV21@AEAV21@@Z @ 0x1800A6CB0
 * Callers:
        ...
        __int64 a3)
{
  ...
  std::vector<std::function<void (bool)>>::_Change_array(a1, v12, v8, v7, v12);
  return v13;
}
