/*
 * XREFs of ?GetDesktopUniqueName@@YAXPEB_WPEA_WK@Z @ 0x180033838
 * Callers:
 ...
 * Callees:
 *     ?GetSessionID@@YAKXZ @ 0x1800338DC (-GetSessionID@@YAKXZ.c)
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x180033928 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
 *     ?GetThreadDesktopName@@YAHPEA_WK@Z @ 0x1800339CC (-GetThreadDesktopName@@YAHPEA_WK@Z.c)
 *     ?StringCchCopyW@@YAJPEA_W_KPEB_W@Z @ 0x180033A80 (-StringCchCopyW@@YAJPEA_W_KPEB_W@Z.c)
