/*
 * XREFs of ?UpdateCalledGetDetectedSourcesAtTimestampRecently@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180134DA4
 * Callers:
 *     ?Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_11@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133C00 (-Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_11@-$IMPCInputObjectProxy_Receive@VBamo.c)
