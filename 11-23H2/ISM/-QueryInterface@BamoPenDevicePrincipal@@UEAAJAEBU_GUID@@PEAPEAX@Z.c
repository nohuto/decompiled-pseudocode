/*
 * XREFs of ?QueryInterface@BamoPenDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A82B0
 * Callers:
 *     ?QueryInterface@BamoPenDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069D10 (-QueryInterface@BamoPenDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
