/*
 * XREFs of ?QueryInterface@?$implements_delegate@U?$TypedEventHandler@UWindowWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UIInspectable@Foundation@56@@Foundation@Windows@winrt@@V_lambda_1fc43c971fd1247187255afbf1b5936c_@@@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800488B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
