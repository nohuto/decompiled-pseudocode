/*
 * XREFs of ?_Change_array@?$vector@USimpleHapticsControllerFeedback@@V?$allocator@USimpleHapticsControllerFeedback@@@std@@@std@@AEAAXQEAUSimpleHapticsControllerFeedback@@_K1@Z @ 0x1801ADBF4
 * Callers:
