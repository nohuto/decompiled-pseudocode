/*
 * XREFs of ?OnDisconnectedCallout@BamoDeviceDockServerProxy@@EEAAJXZ @ 0x18012A420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDeviceDockServerProxy::OnDisconnectedCallout(BamoDeviceDockServerProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoDeviceDockServerProxyImpl>::CalloutWrapper<BamoImpl::BamoDeviceDockServerProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoDeviceDockServerProxy *))(*(_QWORD *)v1 + 40LL))(v1);
