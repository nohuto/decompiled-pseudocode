/*
 * XREFs of ??$emplace_back@AEA_KAEBUtagINPUT_TRANSFORM@@@?$vector@VNotificationData@@V?$allocator@VNotificationData@@@std@@@std@@QEAA?A_TAEA_KAEBUtagINPUT_TRANSFORM@@@Z @ 0x180009AE4
 * Callers:
