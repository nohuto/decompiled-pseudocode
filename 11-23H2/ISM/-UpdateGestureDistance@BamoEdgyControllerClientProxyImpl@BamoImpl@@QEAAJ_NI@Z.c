/*
 * XREFs of ?UpdateGestureDistance@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18016B488
 * Callers:
 *     ?Thunk_UpdateGestureDistance_8@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016B2A0 (-Thunk_UpdateGestureDistance_8@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientPro.c)
