/*
 * XREFs of ?GetDragAreaClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragAreaClientProxy@@XZ @ 0x180011970
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoDragAreaClientProxy *)*((_QWORD *)this + 18);
}
