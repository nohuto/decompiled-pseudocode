/*
 * XREFs of ?GetInputInfoForReport@DockDevice@@QEAAJPEADGPEAUDockInputInfo@@@Z @ 0x1800E6AA0
 * Callers:
        ...
        LARGE_INTEGER *a4)
{
  ...
  ULONG v31; // [rsp+C8h] [rbp+58h] BYREF
  ...
  {
    UsageValueArray = HidP_GetUsageValue(HidP_Input, 1u, 0, 0xD0u, &v31, PreparsedData, a2, ReportLength);
    if ( UsageValueArray < 0 )
    {
      v11 = 216LL;
      return wil::details::in1diag3::Return_NtStatus(
  ...
  a4[5] = v13;
  UsageValueArray = HidP_GetUsageValue(HidP_Input, 1u, 0, 0xD1u, &v31, PreparsedData, a2, ReportLength);
  if ( UsageValueArray < 0 )
  {
    v11 = 229LL;
    return wil::details::in1diag3::Return_NtStatus(
  ...
  if ( *(_BYTE *)(v8 + 1663) )
  {
    ...
    {
      v14 = v31;
      if ( (signed int)v31 < *(_DWORD *)(v8 + 1668) )
        v14 = *(_DWORD *)(v8 + 1668);
    }
    a4[8].HighPart = v14;
    UsageValueArray = HidP_GetUsageValue(
    ...
    {
      v15 = v31;
      if ( (signed int)v31 < *(_DWORD *)(v8 + 1672) )
        v15 = *(_DWORD *)(v8 + 1672);
    }
    a4[9].LowPart = v15;
    UsageValueArray = HidP_GetUsageValue(
    ...
    v16 = v31 + a4[8].HighPart;
    v17 = *(_DWORD *)(v8 + 1676);
    if ( v17 >= v16 )
    {
      v17 = v31 + a4[8].HighPart;
    ...
    v18 = v31 + a4[9].LowPart;
    v19 = *(_DWORD *)(v8 + 1680);
    if ( v19 >= v18 )
    {
      v19 = v31 + a4[9].LowPart;
  ...
  v20 = 0;
  v21 = a4 + 7;
  if ( HidP_GetUsageValue(HidP_Input, 1u, 0, 0xD6u, &v31, PreparsedData, a2, ReportLength) < 0
    || (v22 = v31, v20 = 1, v21->LowPart = v31, v22 == 1) )
  {
    if ( HidP_GetUsageValue(HidP_Input, 1u, 0, 0xD2u, &v31, PreparsedData, a2, ReportLength) >= 0 )
      WORD2(a4[7].QuadPart) = v31;
    if ( HidP_GetUsageValue(HidP_Input, 1u, 0, 0xD3u, &v31, PreparsedData, a2, ReportLength) >= 0 )
      HIWORD(a4[7].QuadPart) = v31;
  }
  if ( v21->LowPart == 1 )
  {
    if ( !WORD2(a4[7].QuadPart) )
    {
      v23 = "Invalid Dockable Device Primary Usage Page.";
      v24 = 364LL;
LABEL_44:
    ...
    {
      v23 = "Invalid Dockable Device Primary Usage ID.";
      v24 = 365LL;
      goto LABEL_44;
    }
  }
