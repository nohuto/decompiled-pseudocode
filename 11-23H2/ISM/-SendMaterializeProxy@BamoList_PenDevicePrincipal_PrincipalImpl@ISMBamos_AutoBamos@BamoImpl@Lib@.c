/*
 * XREFs of ?SendMaterializeProxy@BamoList_PenDevicePrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@36@@Z @ 0x1800057C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  if ( !*((_DWORD *)this + 6) && *((int *)this + 2) > 0 )
  {
    ...
    if ( v12 )
    {
      v13 = (*(__int64 (__fastcall **)(__int64, _QWORD, Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_PenDevicePrincipal_PrincipalImpl *, _DWORD *))(*(_QWORD *)v12 + 24LL))(
              v12,
              *(unsigned int *)(v11 + 28),
              this,
              v7);
  ...
  if ( !*v7 && *((int *)this + 2) > 0 )
  {
    ...
    if ( v17 )
    {
      v18 = (*(__int64 (__fastcall **)(__int64, _QWORD, Microsoft::Bamo::Lib::BamoImpl::ISMBamos_AutoBamos::BamoList_PenDevicePrincipal_PrincipalImpl *, _DWORD *))(*(_QWORD *)v17 + 24LL))(
              v17,
              *(unsigned int *)(v16 + 28),
              this,
              v7);
