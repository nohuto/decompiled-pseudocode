/*
 * XREFs of ??1?$unordered_map@KPEAVInputInfoValidator@@U?$hash@K@std@@U?$equal_to@K@3@V?$allocator@U?$pair@$$CBKPEAVInputInfoValidator@@@std@@@3@@std@@QEAA@XZ @ 0x1800F8060
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$5 @ 0x18006CE54 (_Win32kInterop--Win32kInterop_--_1_--dtor$5.c)
 * Callees:
