/*
 * XREFs of _lambda_c0e0b7aaf59f49f216d7dff859f9f140_::operator() @ 0x180064B40
 * Callers:
 ...
 *     ??$?0$$V@?$_Ref_count_obj2@UHotKeyInfo@@@std@@QEAA@XZ @ 0x1801EEE58 (--$-0$$V@-$_Ref_count_obj2@UHotKeyInfo@@@std@@QEAA@XZ.c)
 */
