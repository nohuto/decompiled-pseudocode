/*
 * XREFs of ?AllocateStub@BamoInputProcessManagerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputProcessManagerStub@@@Z @ 0x1801B3BC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputProcessManagerPrincipal::AllocateStub(
