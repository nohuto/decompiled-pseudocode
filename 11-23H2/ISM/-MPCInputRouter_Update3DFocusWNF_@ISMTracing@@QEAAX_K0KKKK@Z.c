/*
 * XREFs of ?MPCInputRouter_Update3DFocusWNF_@ISMTracing@@QEAAX_K0KKKK@Z @ 0x18010A7D8
 * Callers:
        ...
        unsigned int a7)
{
  ...
  unsigned int v14; // [rsp+54h] [rbp-2Ch] BYREF
  ...
  union _RTL_RUN_ONCE *v19; // [rsp+70h] [rbp-10h] BYREF
