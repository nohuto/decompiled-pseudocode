/*
 * XREFs of ?TryCreateAndInitialize@HidLampMultiUpdateReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800F5AA0
 * Callers:
 ...
 *     ??0HidLampMultiUpdateReportParser@@AEAA@XZ @ 0x1800F523C (--0HidLampMultiUpdateReportParser@@AEAA@XZ.c)
