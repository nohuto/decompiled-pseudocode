/*
 * XREFs of ?UpdateUndockedEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180054370
 * Callers:
 *     ?Thunk_UpdateUndockedEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180054E20 (-Thunk_UpdateUndockedEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxy.c)
