/*
 * XREFs of ?InitializeProxyThunk@BamoPenEventsDispatcherStubImpl@BamoImpl@@UEAAJXZ @ 0x180018C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenEventsDispatcherStubImpl::InitializeProxyThunk(
