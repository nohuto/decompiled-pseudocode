/*
 * XREFs of ??$MPC3DStateHelper_FireEventsOnInputThread@AEA_NAEA_N@ISMTracing@@SAXAEA_N0@Z @ 0x1800A6B38
 * Callers:
...
void __fastcall ISMTracing::MPC3DStateHelper_FireEventsOnInputThread<bool &,bool &>(bool *a1, bool *a2)
{
  ISMTracing *v4; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPC3DStateHelper_FireEventsOnInputThread_(v4, *a1, *a2);
  }
}
