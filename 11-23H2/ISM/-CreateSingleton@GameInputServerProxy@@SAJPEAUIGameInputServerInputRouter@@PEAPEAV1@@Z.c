/*
 * XREFs of ?CreateSingleton@GameInputServerProxy@@SAJPEAUIGameInputServerInputRouter@@PEAPEAV1@@Z @ 0x18004ACB4
 * Callers:
 *     GameInputServerCreate @ 0x18004ABC4 (GameInputServerCreate.c)
 * Callees:
 *     ??0GameInputServerProxy@@AEAA@PEAUIGameInputServerInputRouter@@@Z @ 0x18004AD90 (--0GameInputServerProxy@@AEAA@PEAUIGameInputServerInputRouter@@@Z.c)
 ...
 *     ?InitPublicReferenceCount@?$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@IEAAXXZ @ 0x18005BE20 (-InitPublicReferenceCount@-$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@I.c)
 ...
 *     ??1ExclusiveSrwLock@@QEAA@XZ @ 0x180117DE0 (--1ExclusiveSrwLock@@QEAA@XZ.c)
