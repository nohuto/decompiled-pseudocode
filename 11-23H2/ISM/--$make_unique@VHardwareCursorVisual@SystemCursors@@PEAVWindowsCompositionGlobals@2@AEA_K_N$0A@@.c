/*
 * XREFs of ??$make_unique@VHardwareCursorVisual@SystemCursors@@PEAVWindowsCompositionGlobals@2@AEA_K_N$0A@@std@@YA?AV?$unique_ptr@VHardwareCursorVisual@SystemCursors@@U?$default_delete@VHardwareCursorVisual@SystemCursors@@@std@@@0@$$QEAPEAVWindowsCompositionGlobals@SystemCursors@@AEA_K$$QEA_N@Z @ 0x180103E5C
 * Callers:
