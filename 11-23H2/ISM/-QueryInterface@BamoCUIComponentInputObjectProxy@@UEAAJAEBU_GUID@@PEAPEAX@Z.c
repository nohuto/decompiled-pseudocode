/*
 * XREFs of ?QueryInterface@BamoCUIComponentInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801423B8
 * Callers:
 *     ?QueryInterface@BamoCUIComponentInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180067990 (-QueryInterface@BamoCUIComponentInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
