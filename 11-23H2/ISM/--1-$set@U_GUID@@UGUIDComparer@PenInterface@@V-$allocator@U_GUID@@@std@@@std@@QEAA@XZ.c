/*
 * XREFs of ??1?$set@U_GUID@@UGUIDComparer@PenInterface@@V?$allocator@U_GUID@@@std@@@std@@QEAA@XZ @ 0x1801A69A4
 * Callers:
 *     _PenInterface::PenInterface_::_1_::dtor$6 @ 0x1801A6970 (_PenInterface--PenInterface_--_1_--dtor$6.c)
 * Callees:
