/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoPenDeviceProxy@@EEAAJXZ @ 0x18012D850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoPenDeviceProxy::OnPropertiesRefreshedCallout(BamoPenDeviceProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoPenDeviceProxyImpl>::CalloutWrapper<BamoImpl::BamoPenDeviceProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoPenDeviceProxy *))(*(_QWORD *)v1 + 48LL))(v1);
