/*
 * XREFs of ?GetTypingDefensesEnabled@BamoVirtualTouchpadControllerProxy@@UEAA_NXZ @ 0x1801447C0
 * Callers:
...
bool __fastcall BamoVirtualTouchpadControllerProxy::GetTypingDefensesEnabled(BamoVirtualTouchpadControllerProxy *this)
{
