/*
 * XREFs of ?GetMany@?$SimpleVectorIterator@PEAUHSTRING__@@V?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$DefaultVectorOptions@PEAUHSTRING__@@@3456@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@UIntVersionTag@XWinRT@@$0A@@Internal@Collections@Foundation@Windows@@UEAAJIPEAPEAUHSTRING__@@PEAI@Z @ 0x180188930
 * Callers:
 *     <none>
 * Callees:
 *     ??R_lambda_7348b8e2dde413155d0bc74652a90ac5_@@QEBA@XZ @ 0x180184AF0 (--R_lambda_7348b8e2dde413155d0bc74652a90ac5_@@QEBA@XZ.c)
 *     ??R_lambda_7642901e62d777eca27bf09ee4162e23_@@QEBAJIPEAI@Z @ 0x180184B68 (--R_lambda_7642901e62d777eca27bf09ee4162e23_@@QEBAJIPEAI@Z.c)
 */
  ...
  *v17 = 0;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v6 )
    {
      while ( 1 )
      {
        v4 = _lambda_7642901e62d777eca27bf09ee4162e23_::operator()((__int64)v12, v7, &v13);
        if ( v4 < 0 )
          break;
    ...
    {
      v4 = _lambda_7642901e62d777eca27bf09ee4162e23_::operator()((__int64)v12, v7, (_DWORD *)(a1 + 40));
    }
