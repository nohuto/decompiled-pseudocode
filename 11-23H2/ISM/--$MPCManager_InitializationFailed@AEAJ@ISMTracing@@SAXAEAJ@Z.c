/*
 * XREFs of ??$MPCManager_InitializationFailed@AEAJ@ISMTracing@@SAXAEAJ@Z @ 0x1800ADB4C
 * Callers:
...
void __fastcall ISMTracing::MPCManager_InitializationFailed<long &>(int *a1)
{
  ISMTracing *v2; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCManager_InitializationFailed_(v2, *a1);
  }
}
