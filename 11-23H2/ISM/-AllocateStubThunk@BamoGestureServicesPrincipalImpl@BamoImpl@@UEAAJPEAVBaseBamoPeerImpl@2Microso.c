/*
 * XREFs of ?AllocateStubThunk@BamoGestureServicesPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x1800165E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoGestureServicesPrincipalImpl::AllocateStubThunk(
