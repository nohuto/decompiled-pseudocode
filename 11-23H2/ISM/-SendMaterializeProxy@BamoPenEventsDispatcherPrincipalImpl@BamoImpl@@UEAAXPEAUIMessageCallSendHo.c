/*
 * XREFs of ?SendMaterializeProxy@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180005D60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  if ( !*((_DWORD *)this + 6) && *((int *)this + 2) > 0 )
  {
    ...
    if ( v12 )
    {
      v13 = (*(__int64 (__fastcall **)(__int64, _QWORD, BamoImpl::BamoPenEventsDispatcherPrincipalImpl *, _DWORD *))(*(_QWORD *)v12 + 24LL))(
              v12,
              *(unsigned int *)(v11 + 28),
              this,
              v7);
  ...
  if ( !*v7 && *((int *)this + 2) > 0 )
  {
    ...
    if ( v17 )
    {
      v18 = (*(__int64 (__fastcall **)(__int64, _QWORD, BamoImpl::BamoPenEventsDispatcherPrincipalImpl *, _DWORD *))(*(_QWORD *)v17 + 24LL))(
              v17,
              *(unsigned int *)(v16 + 28),
              this,
              v7);
