/*
 * XREFs of ??$GetAttachedObject@UIInputInjectionClientProxy@@VInputInjectionClientProxy@@@InputSite@@QEAA?AV?$ComPtr@VInputInjectionClientProxy@@@WRL@Microsoft@@XZ @ 0x1800E74D0
 * Callers:
 ...
 *     ??$As@UIInputInjectionClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIInputInjectionClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800E7418 (--$As@UIInputInjectionClientProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$Com.c)
 */
