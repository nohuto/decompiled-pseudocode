/*
 * XREFs of ?QueryInterface@BamoInputProcessManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B42A0
 * Callers:
 *     ?QueryInterface@BamoInputProcessManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006A090 (-QueryInterface@BamoInputProcessManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
