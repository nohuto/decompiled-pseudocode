/*
 * XREFs of ?GetFeatures@BamoControllerNavigationClientProxy@@UEAAIXZ @ 0x180192FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoControllerNavigationClientProxy::GetFeatures(BamoControllerNavigationClientProxy *this)
{
