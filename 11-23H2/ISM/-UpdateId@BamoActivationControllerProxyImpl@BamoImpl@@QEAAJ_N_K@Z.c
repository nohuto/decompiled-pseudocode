/*
 * XREFs of ?UpdateId@BamoActivationControllerProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x18001A570
 * Callers:
 *     ?Thunk_UpdateId_0@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001AE40 (-Thunk_UpdateId_0@-$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoIm.c)
