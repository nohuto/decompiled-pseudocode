/*
 * XREFs of ??0SystemCursor2@@QEAA@V?$shared_ptr@VSystemCursorService2@@@std@@PEBUCursorDeviceInfo@@@Z @ 0x180103F88
 * Callers:
 *     ??$?0V?$shared_ptr@VSystemCursorService2@@@std@@PEAUCursorDeviceInfo@@@?$_Ref_count_obj2@VSystemCursor2@@@std@@QEAA@$$QEAV?$shared_ptr@VSystemCursorService2@@@1@$$QEAPEAUCursorDeviceInfo@@@Z @ 0x1801033A0 (--$-0V-$shared_ptr@VSystemCursorService2@@@std@@PEAUCursorDeviceInfo@@@-$_Ref_count_obj2@VSystem.c)
 * Callees:
 *     ?_Decref@_Ref_count_base@std@@QEAAXXZ @ 0x180045DDC (-_Decref@_Ref_count_base@std@@QEAAXXZ.c)
 *     ??0?$_Hash@V?$_Umap_traits@_KV?$shared_ptr@VSystemCursorShape2@@@std@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@2@V?$allocator@U?$pair@$$CB_KV?$shared_ptr@VSystemCursorShape2@@@std@@@std@@@2@$0A@@std@@@std@@IEAA@AEBV?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@1@AEBV?$allocator@U?$pair@$$CB_KV?$shared_ptr@VSystemCursorShape2@@@std@@@std@@@1@@Z @ 0x180103EE8 (--0-$_Hash@V-$_Umap_traits@_KV-$shared_ptr@VSystemCursorShape2@@@std@@V-$_Uhash_compare@_KU-$has.c)
 */
