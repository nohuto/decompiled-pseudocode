        ...
        unsigned __int64 a2)
{
  ...
  result = (unsigned __int64)std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,std::unordered_map<unsigned long,Win32kInterop::TargetingInfo>>>>>>>::_Assign_grow(
                               (__int64)&qword_180269128,
                               2 * v5,
                               qword_180269118);
  v8 = v5 - 1;
  qword_180269148 = v5;
  qword_180269140 = v5 - 1;
  v9 = *(const unsigned __int8 **)qword_180269118;
  v10 = *(const unsigned __int8 **)qword_180269118;
  while ( v9 != (const unsigned __int8 *)v3 )
  {
    ...
    v13 = qword_180269128;
    v14 = 2 * (v8 & result);
    if ( *(_QWORD *)(qword_180269128 + 16 * (v8 & result)) == v3 )
    {
      *(_QWORD *)(qword_180269128 + 16 * (v8 & result)) = v12;
LABEL_7:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v12;
      goto LABEL_15;
    }
    result = *(_QWORD *)(qword_180269128 + 16 * (v8 & result) + 8);
    v7 = *v11;
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(qword_180269128 + 8 * v14) == result )
        break;
      result = *v17;
