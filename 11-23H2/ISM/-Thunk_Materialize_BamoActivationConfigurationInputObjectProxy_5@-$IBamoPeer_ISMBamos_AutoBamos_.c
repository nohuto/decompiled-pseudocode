/*
 * XREFs of ?Thunk_Materialize_BamoActivationConfigurationInputObjectProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180014490
 * Callers:
 *     <none>
 * Callees:
