/*
 * XREFs of ?RelativePointToScreen@CInputTransform@@SA?AUTransformedPoint@@AEBU2@AEBUtagINPUT_TRANSFORM@@@Z @ 0x1800E8AC0
 * Callers:
 ...
 * Callees:
 *     ?RelativePointToScreen@CInputTransform@@QEBA?AUTransformedPoint@@AEBU2@@Z @ 0x1800E8A54 (-RelativePointToScreen@CInputTransform@@QEBA-AUTransformedPoint@@AEBU2@@Z.c)
 */
