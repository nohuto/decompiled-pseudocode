/*
 * XREFs of ?GetEnabled@BamoControllerNavigationClientProxy@@UEAA_NXZ @ 0x180192F5C
 * Callers:
 *     ?GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ @ 0x180192FA0 (-GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ.c)
 * Callees:
