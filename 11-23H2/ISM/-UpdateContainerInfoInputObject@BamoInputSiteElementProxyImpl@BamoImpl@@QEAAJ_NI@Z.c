/*
 * XREFs of ?UpdateContainerInfoInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010200
 * Callers:
 *     ?Thunk_UpdateContainerInfoInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019C70 (-Thunk_UpdateContainerInfoInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementPr.c)
