/*
 * XREFs of ?GetEventSubscriptions@BamoMPCInputObjectProxy@@UEAAIXZ @ 0x180124FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCInputObjectProxy::GetEventSubscriptions(BamoMPCInputObjectProxy *this)
{
