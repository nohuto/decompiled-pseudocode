/*
 * XREFs of ?OrientToGravity@MPCMath@@YA?AUfloat4x4@Numerics@Foundation@Windows@@AEBU2345@M@Z @ 0x1801E49C8
 * Callers:
 ...
 *     ?XMMatrixMultiply@DirectX@@YQ?AUXMMATRIX@1@U21@AEBU21@@Z @ 0x1801E5FA0 (-XMMatrixMultiply@DirectX@@YQ-AUXMMATRIX@1@U21@AEBU21@@Z.c)
 */
...
__int128 *__fastcall MPCMath::OrientToGravity(__int128 *a1, float *a2, float a3)
{
  ...
  __int128 v42; // xmm0
  __int128 *result; // rax
  float v44; // [rsp+28h] [rbp-89h]
  float v45; // [rsp+40h] [rbp-71h]
  _BYTE v46[64]; // [rsp+48h] [rbp-69h]
  _OWORD v47[8]; // [rsp+88h] [rbp-29h] BYREF
  ...
  *a1 = *(_OWORD *)a2;
  ...
  v45 = a2[10];
  v8 = o_sqrtf_0((float)((float)(v6.m128_f32[0] * v6.m128_f32[0]) + (float)(a2[8] * a2[8])) + (float)(v45 * v45));
  v9 = 0LL;
  v9.m128_u64[0] = _mm_unpacklo_ps((__m128)*((unsigned int *)a2 + 8), v6).m128_u64[0];
  v10 = _mm_movelh_ps(v9, (__m128)LODWORD(v45));
  ...
  if ( COERCE_FLOAT(COERCE_UNSIGNED_INT((float)(v16 + v15.m128_f32[0]) + (float)(v17.m128_f32[0] * 0.0)) & _xmm) <= a3 )
  {
    ...
    v35 = _mm_movelh_ps(v34, (__m128)COERCE_UNSIGNED_INT(v33 - v44));
