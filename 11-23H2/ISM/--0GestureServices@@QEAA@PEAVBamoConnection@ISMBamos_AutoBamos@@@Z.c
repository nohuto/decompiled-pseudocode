/*
 * XREFs of ??0GestureServices@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z @ 0x18003CC50
 * Callers:
 ...
 *     ??$?0Umonostate@std@@$0A@@?$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusionContextMessage@@UVirtualTouchpadContextMessage@@UMIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE@@@std@@QEAA@XZ @ 0x1801431E0 (--$-0Umonostate@std@@$0A@@-$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusio.c)
 */
        ...
        struct ISMBamos_AutoBamos::BamoConnection *a2)
{
  ...
  struct InputConfigContextProvider *v6; // rax
  int v7; // eax
  int v8; // eax
  ...
  *((_QWORD *)this + 15) = 0LL;
  *((_QWORD *)this + 16) = 0LL;
  std::unordered_set<unsigned int>::unordered_set<unsigned int>((char *)this + 136);
  v12 = (char *)this + 200;
  *((_DWORD *)this + 50) = 0;
  *((_QWORD *)this + 26) = 0LL;
  *((_QWORD *)this + 27) = 0LL;
  ...
  *((_DWORD *)this + 50) = 1065353216;
  std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,std::unordered_map<unsigned long,Win32kInterop::TargetingInfo>>>>>>>::_Assign_grow(
    ...
    0x10uLL,
    *((_QWORD *)this + 26));
  HIDWORD(v12) = ((unsigned __int64)this + 264) >> 32;
  LODWORD(v12) = 0;
  ...
  Microsoft::WRL::ComPtr<KernelContextProvider>::operator=((char *)this + 96, Instance);
  v6 = InputConfigContextProvider::GetInstance();
  Microsoft::WRL::ComPtr<InputConfigContextProvider>::operator=((char *)this + 104, v6);
  v7 = SystemContextProvider::RegisterSystemContextObserver(
  ...
  if ( v7 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v10[0]);
  std::variant<std::monostate,InputConfigContextMessage,DisplayOcclusionContextMessage,VirtualTouchpadContextMessage,MIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE>::variant<std::monostate,InputConfigContextMessage,DisplayOcclusionContextMessage,VirtualTouchpadContextMessage,MIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE>(v10);
  if ( (int)InputConfigContextProvider::GetCurrentContext(*((_QWORD *)this + 13), (__int64)v10) >= 0 )
  {
    v8 = GestureServices::OnSystemContextNotification((char *)this + 56, v10);
    if ( v8 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x22,
