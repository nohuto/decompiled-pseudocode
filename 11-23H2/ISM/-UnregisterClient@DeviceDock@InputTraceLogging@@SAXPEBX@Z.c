/*
 * XREFs of ?UnregisterClient@DeviceDock@InputTraceLogging@@SAXPEBX@Z @ 0x18019ED58
 * Callers:
...
void __fastcall InputTraceLogging::DeviceDock::UnregisterClient(__int64 a1)
{
  __int64 v2; // rcx
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = a1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_1802284B0, 0LL, 0LL, 3u, &v4);
  }
}
