/*
 * XREFs of ??$MPCHolographicInputManager_Process3DInput_HitTestResult@AEAPEAULegacyInputInfo@@@ISMTracing@@SAXAEAPEAULegacyInputInfo@@@Z @ 0x1800B3384
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_Process3DInput_HitTestResult<LegacyInputInfo * &>(
        struct LegacyInputInfo **a1)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCHolographicInputManager_Process3DInput_HitTestResult_(v2, *a1);
  }
}
