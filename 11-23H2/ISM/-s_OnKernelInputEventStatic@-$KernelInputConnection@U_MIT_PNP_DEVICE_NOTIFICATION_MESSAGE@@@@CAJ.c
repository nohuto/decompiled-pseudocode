/*
 * XREFs of ?s_OnKernelInputEventStatic@?$KernelInputConnection@U_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@@@CAJPEAX0H@Z @ 0x18004D8F0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  v14 = 0LL;
  v15 = 0LL;
  v6 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<InputTraceLogging>::get(
                               (__int64)retaddr,
                               _lambda_a8e7baa2fca040c17c3e795f3590cb07_::_lambda_invoker_cdecl_)
                 + 1);
  if ( *v6 )
  {
    if ( tlgKeywordOn((__int64)v6, 1LL) )
    {
