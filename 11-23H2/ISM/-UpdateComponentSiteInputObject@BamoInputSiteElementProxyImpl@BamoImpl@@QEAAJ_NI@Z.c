/*
 * XREFs of ?UpdateComponentSiteInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1800102D0
 * Callers:
 *     ?Thunk_UpdateComponentSiteInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019C90 (-Thunk_UpdateComponentSiteInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementPr.c)
