/*
 * XREFs of ??$MPCInputRouter_OnExclusiveModeStateChangedInputThread@AEA_NAEAKAEA_K@ISMTracing@@SAXAEA_NAEAKAEA_K@Z @ 0x180107A90
 * Callers:
...
void __fastcall ISMTracing::MPCInputRouter_OnExclusiveModeStateChangedInputThread<bool &,unsigned long &,unsigned __int64 &>(
        bool *a1,
        unsigned int *a2,
        unsigned __int64 *a3)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCInputRouter_OnExclusiveModeStateChangedInputThread_(v6, *a1, *a2, *a3);
  }
}
