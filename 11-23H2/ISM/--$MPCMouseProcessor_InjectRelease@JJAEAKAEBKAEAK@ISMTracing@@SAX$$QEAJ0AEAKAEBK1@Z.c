/*
 * XREFs of ??$MPCMouseProcessor_InjectRelease@JJAEAKAEBKAEAK@ISMTracing@@SAX$$QEAJ0AEAKAEBK1@Z @ 0x1801E61A4
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCMouseProcessor_InjectRelease_((ISMTracing *)*a5, *a1, *a2, *a3, *a4, *a5);
  }
}
