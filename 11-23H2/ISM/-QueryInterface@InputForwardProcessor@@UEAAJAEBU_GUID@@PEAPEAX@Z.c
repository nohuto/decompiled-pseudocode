/*
 * XREFs of ?QueryInterface@InputForwardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801C7620
 * Callers:
 *     ?QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006AA70 (-QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
