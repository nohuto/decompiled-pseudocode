/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoSystemCursorControllerClientProxy@@EEAAJXZ @ 0x18012DAF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoSystemCursorControllerClientProxy::OnPropertiesRefreshedCallout(
        BamoSystemCursorControllerClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSystemCursorControllerClientProxyImpl>::CalloutWrapper<BamoImpl::BamoSystemCursorControllerClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoSystemCursorControllerClientProxy *))(*(_QWORD *)v1 + 48LL))(v1);
