/*
 * XREFs of ?PopulateDeviceInfo@DockableDeviceCollection@@AEAAJPEAVHIDDevice@@PEAUDockableDeviceInfo@@@Z @ 0x1800E3B44
 * Callers:
...
LABEL_8:
  ...
  else
  {
    ...
    winrt::impl::factory_cache_entry<winrt::Windows::System::Threading::ThreadPool,winrt::Windows::System::Threading::IThreadPoolStatics>::call<_lambda_4e2f6834dae5c2d9676db4968b0ab11c_ &>(
      (void (__fastcall ***)(_QWORD, __int64 *, __int64 *))&qword_1802695A8,
      (__int64)&v16,
      &v20);
  }
  if ( v16 )
