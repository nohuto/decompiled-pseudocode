/*
 * XREFs of ?GetManualResizeAreaClient@BamoInputSiteElementProxy@@UEAAPEAVBamoManualResizeAreaClientProxy@@XZ @ 0x1800113C0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoManualResizeAreaClientProxy *)*((_QWORD *)this + 31);
}
