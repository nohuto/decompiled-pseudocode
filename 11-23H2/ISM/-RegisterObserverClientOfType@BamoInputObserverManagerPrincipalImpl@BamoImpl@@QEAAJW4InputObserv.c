/*
 * XREFs of ?RegisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180147C5C
 * Callers:
 *     ?Thunk_RegisterObserverClientOfType_254@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005FBD0 (-Thunk_RegisterObserverClientOfType_254@-$IInputObserverManagerPrincipal_Receive@VBamoInputObser.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( *(int *)(a1 + 8) > 0 )
  {
    ...
    v20 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, char *))(*(_QWORD *)(a1 - 16) + 96LL))(
            a1 - 16,
            v24,
            a2,
            v15);
