/*
 * XREFs of ??$MPCHolographicInputManager_FocusedAppDisabled3DMouse@AEA_N@ISMTracing@@SAXAEA_N@Z @ 0x1800B2E70
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_FocusedAppDisabled3DMouse<bool &>(const bool *a1)
{
  ISMTracing *v2; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::MPCHolographicInputManager_FocusedAppDisabled3DMouse_(v2, a1);
  }
}
