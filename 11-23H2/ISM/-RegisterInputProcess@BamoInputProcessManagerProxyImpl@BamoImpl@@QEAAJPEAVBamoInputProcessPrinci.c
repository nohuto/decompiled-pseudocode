/*
 * XREFs of ?RegisterInputProcess@BamoInputProcessManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoInputProcessPrincipal@@@Z @ 0x18013042C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *(_QWORD *)&v16 = v19;
      *((_QWORD *)&v16 + 1) = v20;
      return CoreUICallSend(v11, &v16, 2LL, 55LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
