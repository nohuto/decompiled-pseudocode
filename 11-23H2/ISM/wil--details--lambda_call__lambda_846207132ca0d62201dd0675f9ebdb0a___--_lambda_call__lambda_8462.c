/*
 * XREFs of wil::details::lambda_call__lambda_846207132ca0d62201dd0675f9ebdb0a___::_lambda_call__lambda_846207132ca0d62201dd0675f9ebdb0a___ @ 0x180115E7C
 * Callers:
 *     ?Initialize@RegistryWatcher@@IEAAJPEAUHKEY__@@PEBG@Z @ 0x18003FE10 (-Initialize@RegistryWatcher@@IEAAJPEAUHKEY__@@PEBG@Z.c)
 *     _RegistryWatcher::Initialize_::_1_::dtor$0 @ 0x18006ED23 (_RegistryWatcher--Initialize_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
