/*
 * XREFs of ?OnIrButton@GameControllerRawInputProvider@@UEAAXI_K0W4GipIrCode@@W4GipIrStatus@@@Z @ 0x1800CD020
 * Callers:
 *     <none>
 * Callees:
        ...
        int a6)
{
  ...
  if ( a6 == 1 )
  {
    ...
    {
      wil::details::in1diag3::_Log_NullAlloc(retaddr, (void *)0x1E8, v12, v13);
    }
  }
}
