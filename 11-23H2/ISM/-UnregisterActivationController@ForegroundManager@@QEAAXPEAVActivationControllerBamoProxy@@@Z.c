/*
 * XREFs of ?UnregisterActivationController@ForegroundManager@@QEAAXPEAVActivationControllerBamoProxy@@@Z @ 0x1800A36A8
 * Callers:
 ...
 *     ?GetCookie@ActivationControllerBamoProxy@@QEAA_KXZ @ 0x1800A5960 (-GetCookie@ActivationControllerBamoProxy@@QEAA_KXZ.c)
 */
