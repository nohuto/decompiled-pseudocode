/*
 * XREFs of ?OnDisconnectedThunk@BamoSystemCursorControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x180028DD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$CalloutWrapper@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoSystemCursorControllerPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180028E50 (--0-$CalloutWrapper@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA.c)
