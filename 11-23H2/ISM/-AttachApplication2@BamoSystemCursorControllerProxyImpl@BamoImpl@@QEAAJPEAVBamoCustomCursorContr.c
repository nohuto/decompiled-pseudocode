/*
 * XREFs of ?AttachApplication2@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJPEAVBamoCustomCursorControllerClient2Principal@@@Z @ 0x1801227AC
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      *(_QWORD *)&v16 = v19;
      *((_QWORD *)&v16 + 1) = v20;
      return CoreUICallSend(v12, &v16, 2LL, 88LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
