/*
 * XREFs of ?SetCursorShellMagnification@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_KM@Z @ 0x180102974
 * Callers:
 *     ?Thunk_SetCursorShellMagnification_376@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005BC80 (-Thunk_SetCursorShellMagnification_376@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCur.c)
 * Callees:
