/*
 * XREFs of ??_GInputSiteElementProxy@@UEAAPEAXI@Z @ 0x180030CC0
 * Callers:
 *     <none>
 * Callees:
 *     ??1BamoInputSiteElementProxyImpl@BamoImpl@@UEAA@XZ @ 0x180030DA0 (--1BamoInputSiteElementProxyImpl@BamoImpl@@UEAA@XZ.c)
