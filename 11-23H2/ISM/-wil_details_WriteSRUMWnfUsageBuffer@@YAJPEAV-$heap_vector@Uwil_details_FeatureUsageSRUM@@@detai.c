/*
 * XREFs of ?wil_details_WriteSRUMWnfUsageBuffer@@YAJPEAV?$heap_vector@Uwil_details_FeatureUsageSRUM@@@details_abi@wil@@@Z @ 0x180096590
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_5035b992506f4af81a770c5842624510_@@CA@PEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x180090B70 (-_lambda_invoker_cdecl_@_lambda_5035b992506f4af81a770c5842624510_@@CA@PEAU_TP_CALLBACK_INSTANCE@.c)
 * Callees:
        ...
        const void *a3)
{
  ...
  if ( (unsigned __int64)(a1[1] - *a1) >= 0xC )
  {
    ...
    {
      v16 = 4096;
      v4 = wil_details_NtQueryWnfStateData((const struct __WIL__WNF_STATE_NAME *)&unk_18022A6F0, a2, a3, v17, v18, &v16);
      if ( !v4 )
      {
        v7 = v16;
        v8 = *a1;
...
LABEL_11:
        ...
        updated = wil_details_NtUpdateWnfStateData(
                    (const struct __WIL__WNF_STATE_NAME *)&unk_18022A6F0,
                    v18,
                    v7,
