/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@W4GameInputGamepadButtons@@GV?$_Uhash_compare@W4GameInputGamepadButtons@@U?$hash@W4GameInputGamepadButtons@@@std@@U?$equal_to@W4GameInputGamepadButtons@@@3@@std@@V?$allocator@U?$pair@$$CBW4GameInputGamepadButtons@@G@std@@@3@$0A@@std@@@std@@IEAAX_K@Z @ 0x180199BEC
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  v8 = v5 - 1;
  qword_1802691B8 = v5;
  qword_1802691B0 = v5 - 1;
  v9 = *(const unsigned __int8 **)qword_180269188;
  v10 = *(const unsigned __int8 **)qword_180269188;
  while ( v9 != (const unsigned __int8 *)v3 )
  {
    ...
    v13 = qword_180269198;
    v14 = 2 * (v8 & result);
    if ( *(_QWORD *)(qword_180269198 + 16 * (v8 & result)) == v3 )
    {
      *(_QWORD *)(qword_180269198 + 16 * (v8 & result)) = v12;
LABEL_7:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v12;
      goto LABEL_15;
    }
    result = *(_QWORD *)(qword_180269198 + 16 * (v8 & result) + 8);
    v7 = *v11;
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(qword_180269198 + 8 * v14) == result )
        break;
      result = *v17;
