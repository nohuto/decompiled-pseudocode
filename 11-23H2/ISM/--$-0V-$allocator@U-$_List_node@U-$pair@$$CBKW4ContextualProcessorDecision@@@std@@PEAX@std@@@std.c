/*
 * XREFs of ??$?0V?$allocator@U?$_List_node@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@PEAX@std@@@std@@@?$_Hash@V?$_Umap_traits@KW4ContextualProcessorDecision@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@@3@$0A@@std@@@std@@IEAA@AEBV01@AEBV?$allocator@U?$_List_node@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@PEAX@std@@@1@@Z @ 0x180047594
 * Callers:
        ...
        __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 56) = *(_QWORD *)(a2 + 56);
  ...
  else
  {
    ...
    v8 = v6;
    v9 = (unsigned __int64 *)std::_Allocate<16,std::_Default_allocate_traits,0>(8 * v6);
    if ( v7 )
