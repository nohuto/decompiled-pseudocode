/*
 * XREFs of ?UpdateMPCInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000F9E0
 * Callers:
 *     ?Thunk_UpdateMPCInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019AB0 (-Thunk_UpdateMPCInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@Ba.c)
