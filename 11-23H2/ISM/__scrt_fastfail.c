/*
 * XREFs of __scrt_fastfail @ 0x1800560B8
 * Callers:
 *     dllmain_crt_process_attach @ 0x180055828 (dllmain_crt_process_attach.c)
 *     dllmain_crt_process_detach @ 0x180055950 (dllmain_crt_process_detach.c)
 *     __scrt_initialize_onexit_tables @ 0x180055EA8 (__scrt_initialize_onexit_tables.c)
 *     __scrt_initialize_thread_safe_statics @ 0x180056A60 (__scrt_initialize_thread_safe_statics.c)
 * Callees:
 *     __crt_debugger_hook @ 0x1800560A8 (__crt_debugger_hook.c)
