/*
 * XREFs of ?UpdateActivatePolicy@BamoActivationConfigurationInputObjectProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180013BA0
 * Callers:
 *     ?Thunk_UpdateActivatePolicy_8@?$IActivationConfigurationInputObjectProxy_Receive@VBamoActivationConfigurationInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001ABC0 (-Thunk_UpdateActivatePolicy_8@-$IActivationConfigurationInputObjectProxy_Receive@VBamoActivation.c)
