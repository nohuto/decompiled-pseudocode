/*
 * XREFs of ??1?$map@IV?$com_ptr_t@VBamoDockDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@U?$less@I@std@@V?$allocator@U?$pair@$$CBIV?$com_ptr_t@VBamoDockDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@@std@@@4@@std@@QEAA@XZ @ 0x18019BD24
 * Callers:
 *     _DeviceDockServer::DeviceDockServer_::_1_::dtor$3 @ 0x18006E644 (_DeviceDockServer--DeviceDockServer_--_1_--dtor$3.c)
 *     _DeviceDockServer::DeviceDockServer_::_1_::dtor$4 @ 0x18006E65A (_DeviceDockServer--DeviceDockServer_--_1_--dtor$4.c)
 * Callees:
