/*
 * XREFs of ?UpdateManualResizeAreaClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000F770
 * Callers:
 *     ?Thunk_UpdateManualResizeAreaClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019A50 (-Thunk_UpdateManualResizeAreaClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
    ...
    if ( *((_BYTE *)this + 28) )
    {
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1LL);
      v8 = (char *)this - 16;
      v14 = (*(__int64 (__fastcall **)(char *, void (__fastcall ***)(_QWORD)))(*((_QWORD *)this - 2) + 520LL))(
              (char *)this - 16,
              v7);
      if ( v14 < 0 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        this,
        2LL);
      v15 = (*(__int64 (__fastcall **)(char *))(*(_QWORD *)v8 + 528LL))(v8);
      if ( v15 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0xBEB2,
