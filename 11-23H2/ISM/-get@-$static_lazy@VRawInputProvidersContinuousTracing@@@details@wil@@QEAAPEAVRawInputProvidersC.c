/*
 * XREFs of ?get@?$static_lazy@VRawInputProvidersContinuousTracing@@@details@wil@@QEAAPEAVRawInputProvidersContinuousTracing@@P6AXXZ@Z @ 0x1800DCBA0
 * Callers:
 ...
 *     ?InputReportIgnored_@RawInputProvidersContinuousTracing@@QEAAXKPEBG@Z @ 0x1800D9410 (-InputReportIgnored_@RawInputProvidersContinuousTracing@@QEAAXKPEBG@Z.c)
        ...
        void (__cdecl *a2)())
{
    ...
    && (_DWORD)v6 )
  {
    ...
    v7 = &qword_180268E00;
    qword_180268E00 = (__int64)&RawInputProvidersContinuousTracing::`vftable';
    qword_180268E18 = (__int64)&`RawInputProvidersContinuousTracing::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
