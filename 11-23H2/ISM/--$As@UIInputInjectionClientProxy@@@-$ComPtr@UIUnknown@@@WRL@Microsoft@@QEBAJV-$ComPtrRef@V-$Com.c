/*
 * XREFs of ??$As@UIInputInjectionClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIInputInjectionClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800E7418
 * Callers:
