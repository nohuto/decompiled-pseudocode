/*
 * XREFs of ??0?$CalloutWrapper@VBamoLightDismissClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoLightDismissClientProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180171C94
 * Callers:
