/*
 * XREFs of ?Create@InputSiteTarget@@SA?AV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@AEBV?$ComPtr@VInputSite@@@34@@Z @ 0x1801BB314
 * Callers:
 ...
 *     ??0InputSiteTarget@@QEAA@AEBV?$ComPtr@VInputSite@@@WRL@Microsoft@@@Z @ 0x1801BB224 (--0InputSiteTarget@@QEAA@AEBV-$ComPtr@VInputSite@@@WRL@Microsoft@@@Z.c)
 */
