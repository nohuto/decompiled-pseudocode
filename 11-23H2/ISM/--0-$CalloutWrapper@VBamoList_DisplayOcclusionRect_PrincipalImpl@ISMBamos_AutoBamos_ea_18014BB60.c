/*
 * XREFs of ??0?$CalloutWrapper@VBamoList_DisplayOcclusionRect_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoList_DisplayOcclusionRect_PrincipalImpl@ISMBamos_AutoBamos@1Lib@Bamo@2@W4PrologEpilogConfig@12@@Z @ 0x18014BB60
 * Callers:
