/*
 * XREFs of ?DeferredInitializeStatic@OneCoreUAPInputHost@@SAJPEAX_NPEAU_FILETIME@@@Z @ 0x180051F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall OneCoreUAPInputHost::DeferredInitializeStatic(_QWORD *a1, __int64 a2, struct _FILETIME *a3)
{
  ...
  if ( v4 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v8);
  v6 = InputProviderManager::InitializeHelper((__int64)(a1 + 8), a1[7], 1, v5);
  if ( v6 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x96,
