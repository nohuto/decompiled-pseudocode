/*
 * XREFs of ??$emplace@AEBUDisplayOcclusionRect@@@?$vector@UDisplayOcclusionRect@@V?$allocator@UDisplayOcclusionRect@@@std@@@std@@QEAA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@UDisplayOcclusionRect@@@std@@@std@@@1@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UDisplayOcclusionRect@@@std@@@std@@@1@AEBUDisplayOcclusionRect@@@Z @ 0x180149464
 * Callers:
        ...
        _OWORD *a4)
{
  ...
  if ( v6 == *(_OWORD **)(a1 + 16) )
  {
    *a2 = std::vector<DisplayOcclusionRect>::_Emplace_reallocate<DisplayOcclusionRect const &>(
            (const void **)a1,
            (_BYTE *)a3,
            a4);
  }
