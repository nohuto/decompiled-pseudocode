/*
 * XREFs of ?PushStateToProxyOnOutboundMessagesResumed@BamoPenDeviceManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801A57B0
 * Callers:
 *     <none>
 * Callees:
