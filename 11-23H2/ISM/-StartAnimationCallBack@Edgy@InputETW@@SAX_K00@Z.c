/*
 * XREFs of ?StartAnimationCallBack@Edgy@InputETW@@SAX_K00@Z @ 0x180169BE0
 * Callers:
...
void __fastcall InputETW::Edgy::StartAnimationCallBack(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rcx
  __int64 v7; // rcx
  __int64 v8; // r8
