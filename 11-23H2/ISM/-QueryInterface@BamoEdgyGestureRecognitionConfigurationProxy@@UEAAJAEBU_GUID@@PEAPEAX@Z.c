/*
 * XREFs of ?QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012EA10
 * Callers:
 *     ?QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180067570 (-QueryInterface@BamoEdgyGestureRecognitionConfigurationProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
