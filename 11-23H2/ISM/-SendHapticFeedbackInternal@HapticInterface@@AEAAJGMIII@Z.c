/*
 * XREFs of ?SendHapticFeedbackInternal@HapticInterface@@AEAAJGMIII@Z @ 0x1801A9D4C
 * Callers:
 ...
 *     ?IsValidOrdinal@HapticInterface@@AEAA_NG@Z @ 0x1801A9858 (-IsValidOrdinal@HapticInterface@@AEAA_NG@Z.c)
