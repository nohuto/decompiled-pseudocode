/*
 * XREFs of ??0MPCConstantManagerClient@@QEAA@PEAVMPCManagerClientConnection@@@Z @ 0x180183BB4
 * Callers:
        ...
        struct MPCManagerClientConnection *a2)
{
  ...
  *((_QWORD *)this + 4) = a2;
  if ( a2 )
  {
    v4 = (Microsoft::BamoImpl::BaseBamoConnectionImpl *)(*(__int64 (__fastcall **)(struct MPCManagerClientConnection *))(*(_QWORD *)a2 + 56LL))(a2);
