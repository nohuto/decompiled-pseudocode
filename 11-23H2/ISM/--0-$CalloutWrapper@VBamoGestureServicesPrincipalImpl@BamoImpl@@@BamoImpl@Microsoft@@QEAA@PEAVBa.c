/*
 * XREFs of ??0?$CalloutWrapper@VBamoGestureServicesPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoGestureServicesPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180025630
 * Callers:
 ...
 *     ?OnDisconnectedThunk@BamoGestureServicesStubImpl@BamoImpl@@UEAAJXZ @ 0x180027080 (-OnDisconnectedThunk@BamoGestureServicesStubImpl@BamoImpl@@UEAAJXZ.c)
 * Callees:
