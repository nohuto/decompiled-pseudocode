/*
 * XREFs of ?GetUIAHitTestInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoUIAHitTestInputObjectProxy@@XZ @ 0x180011190
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoUIAHitTestInputObjectProxy *)*((_QWORD *)this + 37);
}
