/*
 * XREFs of ?OnInputDelegationInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18001E560
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    if ( v25 )
    {
      ...
      v12 = v27(v9, &GUID_699c674c_1728_3f00_eb37_62deb026b269, &v25);
    }
    else
    {
      v12 = v10(v9, &GUID_699c674c_1728_3f00_eb37_62deb026b269, &v25);
    }
    v13 = v12 >= 0;
    if ( v8 == this && v13 )
      break;
