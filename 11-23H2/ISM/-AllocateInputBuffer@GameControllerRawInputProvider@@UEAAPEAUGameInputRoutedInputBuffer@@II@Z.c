/*
 * XREFs of ?AllocateInputBuffer@GameControllerRawInputProvider@@UEAAPEAUGameInputRoutedInputBuffer@@II@Z @ 0x1800CCA30
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  {
    wil::details::in1diag3::_Log_NullAlloc(retaddr, (void *)0x12D, v7, v8);
    return 0LL;
  }
}
