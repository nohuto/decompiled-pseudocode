/*
 * XREFs of ?QueryInterface@BamoInputDeliveryServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180173320
 * Callers:
 *     ?QueryInterface@BamoInputDeliveryServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800683F0 (-QueryInterface@BamoInputDeliveryServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
