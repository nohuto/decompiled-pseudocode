/*
 * XREFs of _std::vector_Microsoft::WRL::ComPtr_CUIWindow__std::allocator_Microsoft::WRL::ComPtr_CUIWindow_____::_Emplace_reallocate_Microsoft::WRL::ComPtr_CUIWindow__const_&__::_1_::catch$0 @ 0x18009B2BE
 * Callers:
 *     <none>
 * Callees:
