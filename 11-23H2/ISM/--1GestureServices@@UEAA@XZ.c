/*
 * XREFs of ??1GestureServices@@UEAA@XZ @ 0x180152DB0
 * Callers:
 ...
 *     ??1?$vector@UINPUT_SPACE_REGION@@V?$allocator@UINPUT_SPACE_REGION@@@std@@@std@@QEAA@XZ @ 0x180152BB4 (--1-$vector@UINPUT_SPACE_REGION@@V-$allocator@UINPUT_SPACE_REGION@@@std@@@std@@QEAA@XZ.c)
 */
