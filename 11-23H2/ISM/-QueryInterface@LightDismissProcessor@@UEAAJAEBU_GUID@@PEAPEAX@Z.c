/*
 * XREFs of ?QueryInterface@LightDismissProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180038B00
 * Callers:
 *     ?QueryInterface@LightDismissProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180068390 (-QueryInterface@LightDismissProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
