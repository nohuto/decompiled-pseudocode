/*
 * XREFs of ??$As@UICUIComponentInputObjectProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UICUIComponentInputObjectProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18009AE8C
 * Callers:
