/*
 * XREFs of ??1AlpcSectionListEntry@AlpcPort@@UEAA@XZ @ 0x18011883C
 * Callers:
 *     ??_EAlpcSectionListEntry@AlpcPort@@UEAAPEAXI@Z @ 0x180118AF0 (--_EAlpcSectionListEntry@AlpcPort@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?DestroySection@AlpcSectionListEntry@AlpcPort@@UEAAJXZ @ 0x1801198D0 (-DestroySection@AlpcSectionListEntry@AlpcPort@@UEAAJXZ.c)
