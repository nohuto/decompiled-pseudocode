/*
 * XREFs of ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z @ 0x1800F69BC
 * Callers:
 ...
 * Callees:
 *     ?InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z @ 0x1800F6944 (-InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z.c)
 */
