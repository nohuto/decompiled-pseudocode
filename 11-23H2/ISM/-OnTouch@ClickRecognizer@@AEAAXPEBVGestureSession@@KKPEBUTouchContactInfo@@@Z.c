/*
 * XREFs of ?OnTouch@ClickRecognizer@@AEAAXPEBVGestureSession@@KKPEBUTouchContactInfo@@@Z @ 0x1801D5124
 * Callers:
 ...
 * Callees:
 *     ?CancelTapAndHold@ClickRecognizer@@AEAAXXZ @ 0x1801D4E00 (-CancelTapAndHold@ClickRecognizer@@AEAAXXZ.c)
 *     ?ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z @ 0x1801D4E44 (-ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z.c)
