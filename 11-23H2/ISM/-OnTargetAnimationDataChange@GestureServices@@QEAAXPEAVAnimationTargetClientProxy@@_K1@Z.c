/*
 * XREFs of ?OnTargetAnimationDataChange@GestureServices@@QEAAXPEAVAnimationTargetClientProxy@@_K1@Z @ 0x1801533F0
 * Callers:
 *     ?OnConnected@AnimationTargetClientProxy@@MEAAJXZ @ 0x180054DD0 (-OnConnected@AnimationTargetClientProxy@@MEAAJXZ.c)
 *     ?OnDisconnected@AnimationTargetClientProxy@@MEAAJXZ @ 0x180155CD0 (-OnDisconnected@AnimationTargetClientProxy@@MEAAJXZ.c)
