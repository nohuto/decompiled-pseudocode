/*
 * XREFs of _std::vector_std::shared_ptr_LegacyDeviceInfo__std::allocator_std::shared_ptr_LegacyDeviceInfo_____::_Emplace_reallocate_std::shared_ptr_LegacyDeviceInfo__&__::_1_::catch$0 @ 0x1800CE689
 * Callers:
 *     <none>
 * Callees:
