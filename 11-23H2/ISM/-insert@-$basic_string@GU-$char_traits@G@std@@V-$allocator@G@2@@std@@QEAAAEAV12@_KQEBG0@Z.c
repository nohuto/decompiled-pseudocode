/*
 * XREFs of ?insert@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAAEAV12@_KQEBG0@Z @ 0x1800AD9CC
 * Callers:
...
void **__fastcall std::wstring::insert(void **a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( !v7 )
    v8 = (char *)*a1;
  if ( &asc_180219150[a4] <= (wchar_t *)v8 || L"," > (wchar_t *)&v8[2 * v4] )
  {
    v9 = a4;
  }
  else if ( v8 > (char *)L"," )
  ...
  memcpy_0(v8, L",", 2 * v9);
  memcpy_0(&v8[2 * v9], &asc_180219150[v9 + a4], 2 * (a4 - v9));
  return a1;
}
