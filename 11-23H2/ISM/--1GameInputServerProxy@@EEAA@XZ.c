/*
 * XREFs of ??1GameInputServerProxy@@EEAA@XZ @ 0x180117E5C
 * Callers:
...
void __fastcall GameInputServerProxy::~GameInputServerProxy(GameInputServerProxy *this, unsigned int a2)
{
  ...
  *((_QWORD *)this + 4) = &GameInputServerProxy::`vftable'{for `INoMarshal'};
  ...
  GameInputWatcher::~GameInputWatcher((GameInputServerProxy *)((char *)this + 72));
  SharedUnknownBase<IGameInputServer,IAgileObject,INoMarshal>::~SharedUnknownBase<IGameInputServer,IAgileObject,INoMarshal>(this);
}
