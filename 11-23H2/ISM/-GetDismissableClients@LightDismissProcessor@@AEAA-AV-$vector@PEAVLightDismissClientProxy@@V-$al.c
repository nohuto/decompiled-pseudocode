/*
 * XREFs of ?GetDismissableClients@LightDismissProcessor@@AEAA?AV?$vector@PEAVLightDismissClientProxy@@V?$allocator@PEAVLightDismissClientProxy@@@std@@@std@@PEAUHitTestResult@@@Z @ 0x18017246C
 * Callers:
...
char **__fastcall LightDismissProcessor::GetDismissableClients(__int64 a1, char **a2, __int64 a3)
{
  ...
  *(_OWORD *)v16 = 0LL;
  v17 = 0LL;
  v5 = (qword_180268DE0 - (__int64)LightDismissProcessor::s_clients) >> 3;
  if ( v5 )
  {
    std::vector<LightDismissClientProxy *>::_Buy_nonzero(v16, v5);
    v6 = qword_180268DE0 - (_QWORD)LightDismissProcessor::s_clients;
    v7 = (char *)v16[0];
    memmove_0(v16[0], LightDismissProcessor::s_clients, qword_180268DE0 - (_QWORD)LightDismissProcessor::s_clients);
    v8 = &v7[8 * (v6 >> 3)];
    if ( v7 != v8 && a3 )
    {
      v9 = *(_QWORD *)(a3 + 104);
