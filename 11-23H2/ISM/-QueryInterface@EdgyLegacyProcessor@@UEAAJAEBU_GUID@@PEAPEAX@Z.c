/*
 * XREFs of ?QueryInterface@EdgyLegacyProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801C88B0
 * Callers:
 *     ?QueryInterface@EdgyLegacyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006AAB0 (-QueryInterface@EdgyLegacyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
