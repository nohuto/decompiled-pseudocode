/*
 * XREFs of ?UpdateIsPlayCountSupportedRemoteCache@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801AD834
 * Callers:
...
void __fastcall BamoImpl::BamoSimpleHapticsControllerPrincipalImpl::UpdateIsPlayCountSupportedRemoteCache(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 64LL) )
  {
    ...
    if ( v2 < 0 || (v4[0] = v6, v4[1] = v7, LOWORD(v3) = 2, v2 = CoreUICallSend(v8, v4, 2LL, 83LL), v2 < 0) )
    {
      if ( v2 != -2018375675 )
