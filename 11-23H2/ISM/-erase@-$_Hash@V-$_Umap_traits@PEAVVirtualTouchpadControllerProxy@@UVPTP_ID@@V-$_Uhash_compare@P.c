        ...
        const unsigned __int8 *a2)
{
  ...
  if ( !v5 )
    return 0LL;
  v7 = qword_180269128;
  v8 = 2 * (v6 & qword_180269140);
  if ( *(_QWORD **)(qword_180269128 + 16 * (v6 & qword_180269140) + 8) == v5 )
  {
    if ( *(_QWORD **)(qword_180269128 + 16 * (v6 & qword_180269140)) == v5 )
    {
      v9 = qword_180269118;
      *(_QWORD *)(qword_180269128 + 16 * (v6 & qword_180269140)) = qword_180269118;
    }
    else
    {
      v9 = v5[1];
  ...
  else if ( *(_QWORD **)(qword_180269128 + 16 * (v6 & qword_180269140)) == v5 )
  {
    *(_QWORD *)(qword_180269128 + 16 * (v6 & qword_180269140)) = *v5;
  }
  v10 = *v5;
  --qword_180269120;
  *(_QWORD *)v5[1] = v10;
