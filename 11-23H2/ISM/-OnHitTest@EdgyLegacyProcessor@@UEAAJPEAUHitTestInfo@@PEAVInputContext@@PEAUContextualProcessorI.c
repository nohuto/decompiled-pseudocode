/*
 * XREFs of ?OnHitTest@EdgyLegacyProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1801C8560
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?QualifyEdgyHitTestInputReport@EdgyLegacyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@@Z @ 0x1801C8848 (-QualifyEdgyHitTestInputReport@EdgyLegacyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@.c)
