/*
 * XREFs of ?SendHapticFeedbackForPlayCount@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAJGMII@Z @ 0x1801AC9A4
 * Callers:
 *     ?Thunk_SendHapticFeedbackForPlayCount_357@?$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800635E0 (-Thunk_SendHapticFeedbackForPlayCount_357@-$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpl.c)
 * Callees:
        ...
        int a4)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSimpleHapticsControllerPrincipalImpl>::CalloutWrapper<BamoImpl::BamoSimpleHapticsControllerPrincipalImpl>(
      ...
      *(_QWORD *)(v11 + 32),
      (__int64)this);
    v13 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*((_QWORD *)this - 2) + 112LL))(
            (char *)this - 16,
            v10,
            a2);
    v7 = v13;
