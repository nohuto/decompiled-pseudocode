/*
 * XREFs of ?AddEndpoint@DWMCursorBroker@@UEAAJUtagMsgRoutingInfo@@I_N@Z @ 0x1801ECFF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextEndpointIndex@DWMCursorBroker@@AEAAJPEAI@Z @ 0x1801ED9B8 (-GetNextEndpointIndex@DWMCursorBroker@@AEAAJPEAI@Z.c)
 */
