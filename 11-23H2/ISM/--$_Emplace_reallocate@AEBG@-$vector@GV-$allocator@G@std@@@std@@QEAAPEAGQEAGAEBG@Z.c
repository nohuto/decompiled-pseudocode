/*
 * XREFs of ??$_Emplace_reallocate@AEBG@?$vector@GV?$allocator@G@std@@@std@@QEAAPEAGQEAGAEBG@Z @ 0x1800DCDB4
 * Callers:
 ...
 *     ?_Change_array@?$vector@GV?$allocator@G@std@@@std@@AEAAXQEAG_K1@Z @ 0x1800DE80C (-_Change_array@-$vector@GV-$allocator@G@std@@@std@@AEAAXQEAG_K1@Z.c)
 */
        ...
        _WORD *a3)
{
  ...
  try
  {
    ...
    *(_WORD *)v14 = *a3;
    ...
    std::vector<unsigned short>::_Change_array(a1, v13, v8, v11);
    result = v14;
  }
  catch ( ... )
  {
    std::_Deallocate<16,0>(v21, 2 * v20);
    throw;
  }
  return result;
}
