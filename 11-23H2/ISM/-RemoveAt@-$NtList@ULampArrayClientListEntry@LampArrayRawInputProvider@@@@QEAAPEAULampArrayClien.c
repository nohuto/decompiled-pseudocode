/*
 * XREFs of ?RemoveAt@?$NtList@ULampArrayClientListEntry@LampArrayRawInputProvider@@@@QEAAPEAULampArrayClientListEntry@LampArrayRawInputProvider@@PEAU23@@Z @ 0x1800E977C
 * Callers:
