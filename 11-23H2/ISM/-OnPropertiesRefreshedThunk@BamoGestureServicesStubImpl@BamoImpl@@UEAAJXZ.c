/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoGestureServicesStubImpl@BamoImpl@@UEAAJXZ @ 0x180153370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoGestureServicesStubImpl::OnPropertiesRefreshedThunk(
