/*
 * XREFs of ?UpdateDropTargetClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180026C60
 * Callers:
 *     ?Thunk_UpdateDropTargetClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019BF0 (-Thunk_UpdateDropTargetClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@.c)
