/*
 * XREFs of ?AppView@?$consume_Windows_Internal_ApplicationModel_WindowManagement_IAppViewChangedEventArgs@UIAppViewChangedEventArgs@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@impl@winrt@@QEBA@XZ @ 0x180098E24
 * Callers:
