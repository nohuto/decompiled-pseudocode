/*
 * XREFs of ?ProcessInput@ShellEdgyRecognizer@@QEAAXPEBUPointerInputInfo@@AEAV?$optional@ULastUpData@ShellEdgyRecognizer@@@std@@@Z @ 0x18017043C
 * Callers:
 ...
 *     ?EdgyLocationToString@ShellEdgyRecognizer@@AEAAPEBGXZ @ 0x180062028 (-EdgyLocationToString@ShellEdgyRecognizer@@AEAAPEBGXZ.c)
 *     ?FailureReasonToString@ShellEdgyRecognizer@@AEAAPEBGXZ @ 0x180062074 (-FailureReasonToString@ShellEdgyRecognizer@@AEAAPEBGXZ.c)
 *     ?terminate@details@gsl@@YAXXZ @ 0x1800A0290 (-terminate@details@gsl@@YAXXZ.c)
 *     ?GetPointerInfoTimePoint@QpcTimeConverter@@QEBA?AV?$time_point@Usteady_clock@chrono@std@@V?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@23@@chrono@std@@PEBUtagPOINTER_INFO@@@Z @ 0x18016D588 (-GetPointerInfoTimePoint@QpcTimeConverter@@QEBA-AV-$time_point@Usteady_clock@chrono@std@@V-$dura.c)
...
LABEL_23:
  ...
  *(_DWORD *)this = v5;
  ...
  {
    LOBYTE(v5) = tlgKeywordOn((__int64)&dword_180266498, 0x200000000000LL);
    if ( (_BYTE)v5 )
    {
      v31 = (int)v19;
      v25 = SHIDWORD(v19);
