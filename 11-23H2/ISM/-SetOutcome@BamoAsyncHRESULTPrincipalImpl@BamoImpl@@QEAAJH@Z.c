/*
 * XREFs of ?SetOutcome@BamoAsyncHRESULTPrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x18018F924
 * Callers:
 *     ?Thunk_SetOutcome_0@?$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018FA60 (-Thunk_SetOutcome_0@-$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@.c)
 * Callees:
