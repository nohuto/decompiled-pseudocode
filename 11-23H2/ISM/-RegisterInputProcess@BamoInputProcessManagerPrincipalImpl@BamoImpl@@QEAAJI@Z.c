/*
 * XREFs of ?RegisterInputProcess@BamoInputProcessManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1801B43A0
 * Callers:
 *     ?Thunk_RegisterInputProcess_8@?$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801B4BF0 (-Thunk_RegisterInputProcess_8@-$IInputProcessManagerPrincipal_Receive@VBamoInputProcessManagerPr.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputProcessManagerPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoInputProcessManagerPrincipalImpl>((__int64)v20);
  }
  if ( v13 )
