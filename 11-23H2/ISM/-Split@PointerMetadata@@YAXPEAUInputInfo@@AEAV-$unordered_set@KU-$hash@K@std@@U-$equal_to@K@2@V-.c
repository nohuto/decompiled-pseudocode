/*
 * XREFs of ?Split@PointerMetadata@@YAXPEAUInputInfo@@AEAV?$unordered_set@KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@K@2@@std@@0@Z @ 0x1801C3440
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)(a3 + 316) = 0;
  ...
  do
  {
           ...
           (const unsigned __int8 *)&v20) )
    {
      ...
      v12 = (_OWORD *)(144LL * *(unsigned int *)(a3 + 316) + a3 + 320);
      *v12 = *v11;
      v12[1] = v11[1];
      v12[2] = v11[2];
      v12[3] = v11[3];
