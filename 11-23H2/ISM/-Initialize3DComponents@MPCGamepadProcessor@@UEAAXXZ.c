/*
 * XREFs of ?Initialize3DComponents@MPCGamepadProcessor@@UEAAXXZ @ 0x1801E3A70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::Initialize3DComponents(MPCGamepadProcessor *this)
{
  ...
  v6 = (__int64 *)std::make_unique<MPCButtonHoldHelper,float const &,0>(&fPending, flt_180231A44);
  std::unique_ptr<MPCButtonHoldHelper>::operator=<std::default_delete<MPCButtonHoldHelper>,0>((__int64 *)this + 530, v6);
  if ( fPending )
    std::default_delete<MPCButtonHoldHelper>::operator()(v7, (__int64 (__fastcall ***)(_QWORD, __int64))fPending);
  v8 = (__int64 *)std::make_unique<MPCButtonHoldHelper,float const &,0>(&fPending, flt_180231A44);
