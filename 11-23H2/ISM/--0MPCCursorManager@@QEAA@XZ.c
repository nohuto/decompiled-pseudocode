/*
 * XREFs of ??0MPCCursorManager@@QEAA@XZ @ 0x1800BCC44
 * Callers:
 ...
 *     ?IsHyperVGuestOS@@YA_NXZ @ 0x1800BCED8 (-IsHyperVGuestOS@@YA_NXZ.c)
 *     ?reset@?$unique_storage@U?$resource_policy@PEAUHINSTANCE__@@P6AHPEAU1@@Z$1?FreeLibrary@@YAH0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUHINSTANCE__@@@Z @ 0x1800BD63C (-reset@-$unique_storage@U-$resource_policy@PEAUHINSTANCE__@@P6AHPEAU1@@Z$1-FreeLibrary@@YAH0@ZU-.c)
 */
