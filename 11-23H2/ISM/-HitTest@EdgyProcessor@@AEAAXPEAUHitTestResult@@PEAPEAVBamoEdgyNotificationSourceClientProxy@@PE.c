/*
 * XREFs of ?HitTest@EdgyProcessor@@AEAAXPEAUHitTestResult@@PEAPEAVBamoEdgyNotificationSourceClientProxy@@PEAPEAVInputSite@@@Z @ 0x180168674
 * Callers:
 ...
 *     ??$As@UIEdgyNotificationSourceClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIEdgyNotificationSourceClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18013FBE0 (--$As@UIEdgyNotificationSourceClientProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRe.c)
 */
