/*
 * XREFs of ?MPCMouseProcessor_InjectPress_@ISMTracing@@QEAAXJJKKK@Z @ 0x1801E7684
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@3333@Z @ 0x1800BA160 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U1@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEB.c)
 */

void __fastcall ISMTracing::MPCMouseProcessor_InjectPress_(
        ISMTracing *this,
        int a2,
        int a3,
        int a4,
        ...
        unsigned int a6)
{
  ...
  int v15; // [rsp+5Ch] [rbp-24h] BYREF
  int v16; // [rsp+60h] [rbp-20h] BYREF
  LPVOID Context; // [rsp+68h] [rbp-18h] BYREF
  union _RTL_RUN_ONCE *v18; // [rsp+70h] [rbp-10h] BYREF
  ...
  if ( ISMTracing::IsEnabled((char)this) )
  {
    ...
    if ( __std_init_once_begin_initialize(&`ISMTracing::Instance'::`2'::wrapper, 0, (PBOOL)&fPending, &Context)
      && (_DWORD)fPending )
    {
      v18 = &`ISMTracing::Instance'::`2'::wrapper;
