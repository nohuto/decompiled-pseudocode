/*
 * XREFs of ?SetConstantToDefault@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJW4InputType@@PEBGI@Z @ 0x1800ACDD8
 * Callers:
 *     ?Thunk_SetConstantToDefault_16@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800AD220 (-Thunk_SetConstantToDefault_16@-$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantMana.c)
 * Callees:
