/*
 * XREFs of ??0InputSystemInternal@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z @ 0x18003213C
 * Callers:
 ...
 *     ??0InputProcessManager@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z @ 0x180032204 (--0InputProcessManager@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z.c)
 *     ??0SystemContextManager@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z @ 0x18003227C (--0SystemContextManager@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z.c)
        ...
        struct ISMBamos_AutoBamos::BamoConnection *a2)
{
  ...
  *v4 = (struct Microsoft::BamoImpl::ConnectionIndirector *)&BamoInputSystemInternalPrincipal::`vftable'{for `IInputSystemInternalPrincipal'};
  v5 = (InputProcessManager *)operator new(0x50uLL);
