/*
 * XREFs of ?UpdateCallbacksRemoteCache@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@AEAAXXZ @ 0x18017E368
 * Callers:
 *     ?PushStateToPrincipal@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@UEAAXXZ @ 0x18017BBC0 (-PushStateToPrincipal@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@UEAAXXZ.c)
        ...
        BamoImpl::BamoMPCConstantManagerClientProxyImpl *this)
{
  ...
  if ( !Microsoft::BamoImpl::BamoProxyImpl::IsDisconnected(this) )
  {
    ...
    LOWORD(v10) = 6;
    v11[1] = v6;
    v9 = CoreUICallSend(v8, v11, 2LL, 1LL);
