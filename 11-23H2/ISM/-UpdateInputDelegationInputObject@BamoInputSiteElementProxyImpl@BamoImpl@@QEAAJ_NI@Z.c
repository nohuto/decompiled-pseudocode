/*
 * XREFs of ?UpdateInputDelegationInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180026340
 * Callers:
 *     ?Thunk_UpdateInputDelegationInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019B90 (-Thunk_UpdateInputDelegationInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElement.c)
      ...
      if ( *((_BYTE *)this + 28) )
      {
        Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
          ...
          *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
          this,
          1LL);
        v14 = (*(__int64 (__fastcall **)(char *, void (__fastcall ***)(_QWORD)))(*((_QWORD *)this - 2) + 408LL))(
                (char *)this - 16,
                v7);
        if ( v14 < 0 )
      ...
      if ( *((_BYTE *)this + 28) )
      {
        Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
          ...
          *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
          this,
          2LL);
        v15 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 416LL))((char *)this - 16);
        if ( v15 < 0 )
          wil::details::in1diag3::FailFast_Hr(
            retaddr,
            (void *)0xBCDD,
