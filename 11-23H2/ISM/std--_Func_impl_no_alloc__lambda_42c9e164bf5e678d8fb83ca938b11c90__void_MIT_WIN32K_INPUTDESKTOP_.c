/*
 * XREFs of std::_Func_impl_no_alloc__lambda_42c9e164bf5e678d8fb83ca938b11c90__void_MIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE_const___::_Do_call @ 0x18001C2E0
 * Callers:
 *     <none>
 * Callees:
        ...
        _OWORD **a2)
{
  ...
  if ( *v3 )
  {
    if ( (unsigned __int8)tlgKeywordOn(v3, 1LL) )
    {
