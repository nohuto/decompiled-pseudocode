/*
 * XREFs of ?UpdateTipToGlassEventsRequired@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180054450
 * Callers:
 *     ?Thunk_UpdateTipToGlassEventsRequired_11@?$IPenEventsClientProxy_Receive@VBamoPenEventsClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180054E60 (-Thunk_UpdateTipToGlassEventsRequired_11@-$IPenEventsClientProxy_Receive@VBamoPenEventsClientPro.c)
