/*
 * XREFs of ??$LogMPCInputReport@AEAPEAUInputInfo@@AEA_N@ISMTracing@@SAXAEAPEAUInputInfo@@AEA_N@Z @ 0x1800C42D8
 * Callers:
...
void __fastcall ISMTracing::LogMPCInputReport<InputInfo * &,bool &>(struct InputInfo **a1, const bool *a2)
{
  ISMTracing *v4; // rcx
  ...
  if ( ISMTracing::IsEnabled((char)a1) )
  {
    ...
    ISMTracing::LogMPCInputReport_(v4, *a1, a2);
  }
}
