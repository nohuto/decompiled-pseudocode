/*
 * XREFs of ?OnWinKeyAcknowledged@WinKeyScenarioTelemetry@@SAXXZ @ 0x180117708
 * Callers:
 *     ?OnHotKeyAcknowledged@HotKeyProcessor@@UEAAJXZ @ 0x1801F1DA0 (-OnHotKeyAcknowledged@HotKeyProcessor@@UEAAJXZ.c)
 * Callees:
