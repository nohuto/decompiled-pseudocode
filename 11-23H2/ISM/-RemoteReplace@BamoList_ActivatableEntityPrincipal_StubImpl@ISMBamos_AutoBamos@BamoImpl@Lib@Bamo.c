/*
 * XREFs of ?RemoteReplace@BamoList_ActivatableEntityPrincipal_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJIPEAVBamoActivatableEntityPrincipal@@@Z @ 0x1800A2C5C
 * Callers:
 *     ?CallRemoteReplaceOnStub@BamoList_ActivatableEntityPrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@CAJPEAVBamoStubImpl@36@IPEAVBamoActivatableEntityPrincipal@@@Z @ 0x1800A1944 (-CallRemoteReplaceOnStub@BamoList_ActivatableEntityPrincipal_PrincipalImpl@ISMBamos_AutoBamos@Ba.c)
...
LABEL_7:
  ...
  v10[0] = v12;
  v10[1] = v13;
  return CoreUICallSend(v9, v10, 2LL, 99LL);
}
