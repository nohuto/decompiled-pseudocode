/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoVirtualTouchpadControllerProxy@@EEAAJXZ @ 0x180144D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoVirtualTouchpadControllerProxy::OnPropertiesRefreshedCallout(
        BamoVirtualTouchpadControllerProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoVirtualTouchpadControllerProxyImpl>::CalloutWrapper<BamoImpl::BamoVirtualTouchpadControllerProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoVirtualTouchpadControllerProxy *))(*(_QWORD *)v1 + 48LL))(v1);
