/*
 * XREFs of ?ServerIsActiveChanged@VirtualTouchpad@InputTraceLogging@@SAXPEBX_N@Z @ 0x1801459C8
 * Callers:
...
void __fastcall InputTraceLogging::VirtualTouchpad::ServerIsActiveChanged(__int64 a1, char a2)
{
    ...
    && (*(_QWORD *)(v4 + 24) & 0x200LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v12 = 1;
    v9 = 8;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_180225F17, 0LL, 0LL, 4u, &v7);
  }
}
