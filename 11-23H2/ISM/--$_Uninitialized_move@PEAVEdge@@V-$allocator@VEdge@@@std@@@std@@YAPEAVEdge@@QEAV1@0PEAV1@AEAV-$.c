/*
 * XREFs of ??$_Uninitialized_move@PEAVEdge@@V?$allocator@VEdge@@@std@@@std@@YAPEAVEdge@@QEAV1@0PEAV1@AEAV?$allocator@VEdge@@@0@@Z @ 0x1801C8F9C
 * Callers:
 ...
 *     ??0Edge@@QEAA@$$QEAV0@@Z @ 0x1801C90DC (--0Edge@@QEAA@$$QEAV0@@Z.c)
 */
