/*
 * XREFs of ?GetInputSiteListToRoot@InputSiteHierarchyManager@@UEAA?AV?$vector@V?$ComPtr@VInputSite@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VInputSite@@@WRL@Microsoft@@@std@@@std@@_K@Z @ 0x18013E550
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Find_last@_K@?$_Hash@V?$_Umap_traits@_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@@std@@@4@$0A@@std@@@std@@IEBA?AU?$_Hash_find_last_result@PEAU?$_List_node@U?$pair@$$CB_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@@std@@PEAX@std@@@1@AEB_K_K@Z @ 0x18005433C (--$_Find_last@_K@-$_Hash@V-$_Umap_traits@_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@V.c)
 ...
 *     ??0?$vector@V?$ComPtr@VInputSite@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VInputSite@@@WRL@Microsoft@@@std@@@std@@QEAA@AEBV01@@Z @ 0x18013E158 (--0-$vector@V-$ComPtr@VInputSite@@@WRL@Microsoft@@V-$allocator@V-$ComPtr@VInputSite@@@WRL@Micros.c)
 */

// Hidden C++ exception states: #wind=1
_QWORD *__fastcall InputSiteHierarchyManager::GetInputSiteListToRoot(float *a1, _QWORD *a2, __int64 a3)
{
  float *v5; // r15
  __int64 v6; // rcx
  ...
  _QWORD v21[2]; // [rsp+28h] [rbp-38h] BYREF
  _BYTE v22[16]; // [rsp+38h] [rbp-28h] BYREF
  ...
  v27 = a3;
  (*(void (__fastcall **)(float *))(*(_QWORD *)a1 + 40LL))(a1);
  v5 = a1 + 20;
  appended = std::_Fnv1a_append_bytes(v6, (const unsigned __int8 *const)&v27, 8uLL);
  ...
  if ( v8 == *((_QWORD *)a1 + 11) )
  {
    ...
    {
      v10 = a1 + 4;
      v11 = (__int64 *)*((_QWORD *)&v23 + 1);
      do
      {
        v12 = std::_Fnv1a_append_bytes(v8, (const unsigned __int8 *const)&v26, 8uLL);
        if ( !std::_Hash<std::_Umap_traits<unsigned __int64,InputSiteHierarchyManager::InputSiteHierarchyEntry,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,InputSiteHierarchyManager::InputSiteHierarchyEntry>>,0>>::_Find_last<unsigned __int64>(
                v10,
                v21,
                &v26,
                v12)[1] )
          break;
        v13 = std::_Hash<std::_Umap_traits<unsigned __int64,InputSiteHierarchyManager::InputSiteHierarchyEntry,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,InputSiteHierarchyManager::InputSiteHierarchyEntry>>,0>>::_Try_emplace<unsigned __int64 const &,>(
                (__int64)v10,
                (__int64)v22,
                (unsigned __int8 *)&v26);
        v14 = *(_QWORD *)v13;
        v15 = *(_QWORD *)(*(_QWORD *)v13 + 24LL);
        if ( !v15 )
    ...
    v16 = (__int64 *)(*(_QWORD *)std::_Hash<std::_Umap_traits<unsigned __int64,std::vector<Microsoft::WRL::ComPtr<InputSite>>,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,std::vector<Microsoft::WRL::ComPtr<InputSite>>>>,0>>::_Try_emplace<unsigned __int64 const &,>(
                                   v5,
                                   (__int64)v22,
                                   (unsigned __int8 *)&v27)
                    + 24LL);
    v17 = v23;
    if ( v16 != (__int64 *)&v23 )
      std::vector<Microsoft::WRL::ComPtr<InputSite>>::_Assign_range<Microsoft::WRL::ComPtr<InputSite> *>(
        v16,
        v23,
        (__int64)v11);
    v24 = 0LL;
  ...
  {
    v18 = std::_Hash<std::_Umap_traits<unsigned __int64,std::vector<Microsoft::WRL::ComPtr<InputSite>>,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,std::vector<Microsoft::WRL::ComPtr<InputSite>>>>,0>>::_Try_emplace<unsigned __int64 const &,>(
            a1 + 20,
            (__int64)v22,
            (unsigned __int8 *)&v27);
    std::vector<Microsoft::WRL::ComPtr<InputSite>>::vector<Microsoft::WRL::ComPtr<InputSite>>(
      (__int64)a2,
      (__int64 **)(*(_QWORD *)v18 + 24LL));
  }
  return a2;
}
