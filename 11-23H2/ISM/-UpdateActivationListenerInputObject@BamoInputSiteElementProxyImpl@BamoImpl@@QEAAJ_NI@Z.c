/*
 * XREFs of ?UpdateActivationListenerInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180026F60
 * Callers:
 *     ?Thunk_UpdateActivationListenerInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019D30 (-Thunk_UpdateActivationListenerInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElem.c)
