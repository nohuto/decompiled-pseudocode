/*
 * XREFs of ?UpdateActuationClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010610
 * Callers:
 *     ?Thunk_UpdateActuationClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019D10 (-Thunk_UpdateActuationClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@B.c)
    ...
    if ( *((_BYTE *)this + 28) )
    {
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1LL);
      v8 = (char *)this - 16;
      v14 = (*(__int64 (__fastcall **)(char *, void (__fastcall ***)(_QWORD)))(*((_QWORD *)this - 2) + 184LL))(
              (char *)this - 16,
              v7);
      if ( v14 < 0 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        this,
        2LL);
      v15 = (*(__int64 (__fastcall **)(char *))(*(_QWORD *)v8 + 192LL))(v8);
      if ( v15 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0xB933,
