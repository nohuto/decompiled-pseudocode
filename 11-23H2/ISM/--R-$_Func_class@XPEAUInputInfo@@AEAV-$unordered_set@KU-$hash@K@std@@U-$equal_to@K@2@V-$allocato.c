/*
 * XREFs of ??R?$_Func_class@XPEAUInputInfo@@AEAV?$unordered_set@KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@K@2@@std@@@std@@QEBAXPEAUInputInfo@@AEAV?$unordered_set@KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@K@2@@1@@Z @ 0x1801BFF6C
 * Callers:
...
__int64 __fastcall std::_Func_class<void,InputInfo *,std::unordered_set<unsigned long> &>::operator()(
        __int64 a1,
        __int64 a2)
{
  __int64 v2; // rcx
