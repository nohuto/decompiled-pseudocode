/*
 * XREFs of ?StartAnimation@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1801624A0
 * Callers:
 *     ?Thunk_StartAnimation_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180162890 (-Thunk_StartAnimation_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProc.c)
 * Callees:
