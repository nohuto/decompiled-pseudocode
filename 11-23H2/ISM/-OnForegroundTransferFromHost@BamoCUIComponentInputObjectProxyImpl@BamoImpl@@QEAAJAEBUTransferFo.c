/*
 * XREFs of ?OnForegroundTransferFromHost@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@QEAAJAEBUTransferForegroundInfo@@@Z @ 0x180141F3C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoCUIComponentInputObjectProxyImpl::OnForegroundTransferFromHost(
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v15 = v12;
      v16 = v13;
      return CoreUICallSend(v10, v14, 2LL, 11LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
