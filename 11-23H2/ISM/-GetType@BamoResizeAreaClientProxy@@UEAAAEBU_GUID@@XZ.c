/*
 * XREFs of ?GetType@BamoResizeAreaClientProxy@@UEAAAEBU_GUID@@XZ @ 0x180125A70
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoResizeAreaClientProxy::GetType(BamoResizeAreaClientProxy *this)
{
