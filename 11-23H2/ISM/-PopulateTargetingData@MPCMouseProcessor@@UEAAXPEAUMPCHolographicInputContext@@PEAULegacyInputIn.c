/*
 * XREFs of ?PopulateTargetingData@MPCMouseProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAULegacyInputInfo@@@Z @ 0x1801E7E80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPitchAngleBetweenTwoVectors@MPCMouseProcessor@@CAMUfloat3@Numerics@Foundation@Windows@@0@Z @ 0x1801E7338 (-GetPitchAngleBetweenTwoVectors@MPCMouseProcessor@@CAMUfloat3@Numerics@Foundation@Windows@@0@Z.c)
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_HolographicMouseGameMode@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801E8EF4 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_HolographicMouseGameMode@@@details@wil@@Q.c)
 *     ?make_float4x4_from_quaternion@Numerics@Foundation@Windows@@YA?AUfloat4x4@123@AEBUquaternion@123@@Z @ 0x1801E90F8 (-make_float4x4_from_quaternion@Numerics@Foundation@Windows@@YA-AUfloat4x4@123@AEBUquaternion@123.c)
 */
    ...
    || *((float *)a2 + 65) != *((float *)a2 + 44) )
  {
    ...
    *((_QWORD *)&v49 + 1) = 48LL;
    MPCConstantManager::GetConstant<float>(
      ...
      &v49);
    if ( (float)((double)(v19.LowPart - *(_DWORD *)(this + 8416)) / (double)(int)qword_180268898) > (double)COERCE_FLOAT(L"MouseParams_ResetCursorDirectionThresholdSeconds") )
    {
