/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoResizeContextualProcessorStubImpl@BamoImpl@@UEAAJXZ @ 0x180162320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoResizeContextualProcessorStubImpl::OnPropertiesRefreshedThunk(
