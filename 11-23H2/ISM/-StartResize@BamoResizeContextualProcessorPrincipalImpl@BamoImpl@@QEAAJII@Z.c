/*
 * XREFs of ?StartResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x180162684
 * Callers:
 *     ?Thunk_StartResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801628B0 (-Thunk_StartResize_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcess.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoResizeContextualProcessorPrincipalImpl::StartResize(
        ...
        unsigned int a3)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    v20 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, char *))(*((_QWORD *)this - 2) + 96LL))(
            (char *)this - 16,
            v24,
            a2,
            v15);
