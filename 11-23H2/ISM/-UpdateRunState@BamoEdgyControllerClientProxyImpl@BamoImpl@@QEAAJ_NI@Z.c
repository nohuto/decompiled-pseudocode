/*
 * XREFs of ?UpdateRunState@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18016B728
 * Callers:
 *     ?Thunk_UpdateRunState_8@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016B2E0 (-Thunk_UpdateRunState_8@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@.c)
