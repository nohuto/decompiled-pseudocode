/*
 * XREFs of ??$LogSpeechRuntimeListenerFunct@AEAY0BJ@$$CBG@ISMTracing@@SAXAEAY0BJ@$$CBG@Z @ 0x1800D2FC4
 * Callers:
...
void __fastcall ISMTracing::LogSpeechRuntimeListenerFunct<unsigned short const (&)[25]>(__int64 a1)
{
  ISMTracing *v1; // rcx
  ...
  if ( ISMTracing::IsEnabled(a1) )
  {
    ...
    ISMTracing::LogSpeechRuntimeListenerFunct_(v1, L"InitializedCoreMessaging");
  }
}
