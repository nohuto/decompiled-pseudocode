/*
 * XREFs of std::_Func_impl_no_alloc__lambda_2b41a082a50d31d24644deaedcc451d5__void__MIT_PNP_DEVICE_NOTIFICATION_MESSAGE_const___::_Do_call @ 0x18003E9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a2)
{
  ...
  if ( *(_DWORD *)v4 )
  {
    if ( (unsigned __int8)tlgKeywordOn(v4, 1LL) )
    {
