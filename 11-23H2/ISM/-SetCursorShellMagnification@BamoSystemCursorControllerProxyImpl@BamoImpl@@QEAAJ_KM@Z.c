/*
 * XREFs of ?SetCursorShellMagnification@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_KM@Z @ 0x18013263C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerProxyImpl::SetCursorShellMagnification(
        ...
        const char *a4)
{
  ...
  struct IMessageCallSendHost *v11[2]; // [rsp+40h] [rbp-38h] BYREF
  ...
  {
    v8 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(this, v11, &v13, &v14);
    v9 = v8;
    if ( v8 >= 0 )
    {
      v10 = v11[0];
      ...
      return CoreUICallSend(v10, v11, 2LL, 88LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
