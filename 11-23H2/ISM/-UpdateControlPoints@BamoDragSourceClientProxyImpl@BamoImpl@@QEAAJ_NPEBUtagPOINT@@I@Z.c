/*
 * XREFs of ?UpdateControlPoints@BamoDragSourceClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@I@Z @ 0x1801352E0
 * Callers:
 *     ?Thunk_UpdateControlPoints_150@?$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180133C80 (-Thunk_UpdateControlPoints_150@-$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@B.c)
