/*
 * XREFs of ?QueryInterface@HomeGestureReadyChangedEventArgs@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18017BDA0
 * Callers:
 *     ?QueryInterface@HomeGestureReadyChangedEventArgs@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800688F0 (-QueryInterface@HomeGestureReadyChangedEventArgs@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
