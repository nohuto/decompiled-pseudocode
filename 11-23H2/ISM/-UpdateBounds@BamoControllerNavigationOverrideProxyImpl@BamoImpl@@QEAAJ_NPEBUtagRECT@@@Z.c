/*
 * XREFs of ?UpdateBounds@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@@Z @ 0x180193A1C
 * Callers:
 *     ?Thunk_UpdateBounds_57@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801937B0 (-Thunk_UpdateBounds_57@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOve.c)
