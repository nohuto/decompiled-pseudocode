/*
 * XREFs of ?Create@InputStateManager@@SAJPEAUISystemInputRouter@@PEAPEAUIRawInputClient@@@Z @ 0x18003ABFC
 * Callers:
...
LABEL_5:
  v6 = (InputStateManager *)RefCountedObject::operator new(0xC8uLL);
  if ( v6 )
