/*
 * XREFs of ?UpdateAutoForwardId@BamoActivationControllerProxyImpl@BamoImpl@@QEAAJ_N_K@Z @ 0x18001A608
 * Callers:
 *     ?Thunk_UpdateAutoForwardId_0@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001AE60 (-Thunk_UpdateAutoForwardId_0@-$IActivationControllerProxy_Receive@VBamoActivationControllerProxy.c)
