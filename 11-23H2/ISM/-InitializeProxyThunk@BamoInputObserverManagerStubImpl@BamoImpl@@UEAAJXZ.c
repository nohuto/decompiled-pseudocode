/*
 * XREFs of ?InitializeProxyThunk@BamoInputObserverManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180018FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputObserverManagerStubImpl::InitializeProxyThunk(
