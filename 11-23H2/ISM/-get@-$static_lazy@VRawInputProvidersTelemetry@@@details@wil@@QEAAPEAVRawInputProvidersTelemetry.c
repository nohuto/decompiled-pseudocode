/*
 * XREFs of ?get@?$static_lazy@VRawInputProvidersTelemetry@@@details@wil@@QEAAPEAVRawInputProvidersTelemetry@@P6AXXZ@Z @ 0x1800E56C0
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<RawInputProvidersTelemetry>::get(__int64 a1, void (__cdecl *a2)())
{
    ...
    && (_DWORD)v6 )
  {
    ...
    v7 = &qword_180268E50;
    qword_180268E50 = (__int64)&RawInputProvidersContinuousTracing::`vftable';
    qword_180268E68 = (__int64)&`RawInputProvidersTelemetry::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
