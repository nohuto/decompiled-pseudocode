/*
 * XREFs of ?DeliverToInputService@NonBamoInputDeliveryServer@@UEAAJPEBUKeyboardEvent@@@Z @ 0x1801739A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetForegroundThreadId@ForegroundManager@@QEAAIXZ @ 0x1800A1CFC (-GetForegroundThreadId@ForegroundManager@@QEAAIXZ.c)
 */
