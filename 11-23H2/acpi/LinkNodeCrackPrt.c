/*
 * XREFs of LinkNodeCrackPrt @ 0x1C005CEBC
 * Callers:
 ...
 *     LinkNodeFindByNsObj @ 0x1C0099460 (LinkNodeFindByNsObj.c)
 *     LinkNodepAddAttachedDevice @ 0x1C009968C (LinkNodepAddAttachedDevice.c)
