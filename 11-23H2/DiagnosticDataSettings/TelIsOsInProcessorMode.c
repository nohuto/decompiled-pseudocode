/*
 * XREFs of TelIsOsInProcessorMode @ 0x180002C30
 * Callers:
 *     <none>
 * Callees:
 *     ?CloseHeapPointer@@YAXPEAX@Z @ 0x180001474 (-CloseHeapPointer@@YAXPEAX@Z.c)
 *     ?TelpGetTelemetryClientRegPath@@YAPEAGXZ @ 0x180001724 (-TelpGetTelemetryClientRegPath@@YAPEAGXZ.c)
 *     TelIsProcessorModeAllowed @ 0x180002BE0 (TelIsProcessorModeAllowed.c)
          ...
          if ( v17 )
          {
            ...
            if ( v20 >= 0 )
            {
              ...
              else
              {
                *a1 = 0;
                if ( (v13 & 0x80000000) != 0 )
                  wil::details::in1diag3::Return_Hr(retaddr, (void *)0x6BC, v22, (const char *)v13, pdwTypea);
              }
              goto LABEL_40;
            }
