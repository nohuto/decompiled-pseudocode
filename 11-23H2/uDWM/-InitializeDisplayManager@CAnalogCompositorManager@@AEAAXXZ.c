/*
 * XREFs of ?InitializeDisplayManager@CAnalogCompositorManager@@AEAAXXZ @ 0x1800A4E00
 * Callers:
...
void __fastcall CAnalogCompositorManager::InitializeDisplayManager(CAnalogCompositorManager *this)
{
  ...
  int v26; // eax
  __int64 v27[5]; // [rsp+20h] [rbp-50h] BYREF
  ...
  ActivationFactory = RoGetActivationFactory(v2, &GUID_2b6b9446_b999_5535_9d69_53f092c780a1, v27);
  if ( ActivationFactory < 0 )
    wil::details::in1diag3::_FailFast_Hr(
      ...
      v27[0]);
  v4 = v27[0];
  v5 = *(__int64 (__fastcall **)(__int64, _QWORD, char *))(*(_QWORD *)v27[0] + 48LL);
  ...
  if ( !v8 )
    wil::details::in1diag3::_FailFast_NullAlloc(
      ...
      (__int64)"clientcore\\windows\\dwm\\udwm\\analogcompositormanager.cpp",
      v10);
  v11 = (*(__int64 (__fastcall **)(_QWORD, __int64, char *))(*(_QWORD *)*v6 + 152LL))(*v6, v8, (char *)this + 88);
  if ( v11 < 0 )
    wil::details::in1diag3::_FailFast_Hr(
      retaddr,
      (void *)0x10B,
  ...
  if ( !v12 )
    wil::details::in1diag3::_FailFast_NullAlloc(
      ...
      (__int64)"clientcore\\windows\\dwm\\udwm\\analogcompositormanager.cpp",
      v14);
  v15 = (*(__int64 (__fastcall **)(_QWORD, __int64, char *))(*(_QWORD *)*v6 + 120LL))(*v6, v12, (char *)this + 96);
  if ( v15 < 0 )
    wil::details::in1diag3::_FailFast_Hr(
      retaddr,
      (void *)0x113,
  ...
  v17 = (*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
          ...
          72LL);
  if ( v17 )
    v16 = Microsoft::WRL::Details::DelegateArgTraits_long____cdecl_Windows::Foundation::ITypedEventHandler_impl_Windows::Foundation::Internal::AggregateType_Windows::Devices::Display::Core::DisplayManager___Windows::Devices::Display::Core::IDisplayManager____Windows::Foundation::Internal::AggregateType_Windows::Devices::Display::Core::DisplayManagerDisabledEventArgs___Windows::Devices::Display::Core::IDisplayManagerDisabledEventArgs_____::___Windows::Devices::Display::Core::IDisplayManager___Windows::Devices::Display::Core::IDisplayManagerDisabledEventArgs____::DelegateInvokeHelper_Microsoft::WRL::Implements_Microsoft::WRL::RuntimeClassFlags_2__Windows::Foundation::ITypedEventHandler_Windows::Devices::Display::Core::DisplayManager___Windows::Devices::Display::Core::DisplayManagerDisabledEventArgs____Microsoft::WRL::FtmBase___lambda_4f72ee05bd0124e78352738e10539777___1_Windows::Devices::Display::Core::IDisplayManager___Windows::Devices::Display::Core::IDisplayManagerDisabledEventArgs___::DelegateInvokeHelper_Microsoft::WRL::Implements_Microsoft::WRL::RuntimeClassFlags_2__Windows::Foundation::ITypedEventHandler_Windows::Devices::Display::Core::DisplayManager___Windows::Devices::Display::Core::DisplayManagerDisabledEventArgs____Microsoft::WRL::FtmBase___lambda_4f72ee05bd0124e78352738e10539777___1_Windows::Devices::Display::Core::IDisplayManager___Windows::Devices::Display::Core::IDisplayManagerDisabledEventArgs___(v17);
  v27[3] = v16;
  if ( !v16 )
    wil::details::in1diag3::_FailFast_NullAlloc(
      retaddr,
      ...
      (__int64)"clientcore\\windows\\dwm\\udwm\\analogcompositormanager.cpp",
      v18);
  v19 = (*(__int64 (__fastcall **)(_QWORD, __int64, char *))(*(_QWORD *)*v6 + 136LL))(*v6, v16, (char *)this + 104);
  if ( v19 < 0 )
    wil::details::in1diag3::_FailFast_Hr(
      retaddr,
      (void *)0x11B,
  ...
  if ( !v20 )
    wil::details::in1diag3::_FailFast_NullAlloc(
      ...
      (__int64)"clientcore\\windows\\dwm\\udwm\\analogcompositormanager.cpp",
      v22);
  v23 = (*(__int64 (__fastcall **)(_QWORD, __int64, char *))(*(_QWORD *)*v6 + 168LL))(*v6, v20, (char *)this + 112);
  if ( v23 < 0 )
    wil::details::in1diag3::_FailFast_Hr(
      retaddr,
      (void *)0x123,
