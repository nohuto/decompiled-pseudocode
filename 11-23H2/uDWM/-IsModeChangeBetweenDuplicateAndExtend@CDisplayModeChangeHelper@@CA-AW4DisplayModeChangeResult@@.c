/*
 * XREFs of ?IsModeChangeBetweenDuplicateAndExtend@CDisplayModeChangeHelper@@CA?AW4DisplayModeChangeResult@@PEAVCDWMDisplaySet@@0AEAV?$vector@PEBVCDWMDisplay@@V?$allocator@PEBVCDWMDisplay@@@std@@@std@@@Z @ 0x180028538
 * Callers:
...
LABEL_8:
  ...
  if ( (unsigned int)dword_180147058 > 5 && (byte_180147068 & 1) != 0 && (qword_180147070 & 1) == qword_180147070 )
  {
    ...
    v29 = v16;
    v50 = 4;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_180147058, byte_18012613E, 0LL, 0LL, 3, (__int64)v48);
  }
  return 14LL;
}
