/*
 * XREFs of ?GetTrustLevel@?$implements@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@U1345@UITransitionAnimationVisualNative@34@@winrt@@UEAAJPEAW4TrustLevel@@@Z @ 0x1800ED5F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
