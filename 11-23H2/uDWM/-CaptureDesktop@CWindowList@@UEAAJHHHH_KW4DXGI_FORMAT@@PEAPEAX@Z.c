/*
 * XREFs of ?CaptureDesktop@CWindowList@@UEAAJHHHH_KW4DXGI_FORMAT@@PEAPEAX@Z @ 0x180006390
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a8)
{
  ...
  *a8 = 0LL;
  ...
  {
    v15 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x1861u, 0LL);
    goto LABEL_8;
  }
  ...
  {
    v15 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0x1842u, 0LL);
    goto LABEL_8;
  }
  ...
  {
    v15 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0x1846u, 0LL);
    goto LABEL_8;
  }
  ...
  {
    v15 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x1850u, 0LL);
...
LABEL_12:
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x185Cu, 0LL);
    goto LABEL_12;
  }
  *a8 = FileMappingW;
LABEL_8:
