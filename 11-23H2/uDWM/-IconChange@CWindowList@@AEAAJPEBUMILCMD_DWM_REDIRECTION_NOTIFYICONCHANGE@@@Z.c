/*
 * XREFs of ?IconChange@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYICONCHANGE@@@Z @ 0x18004BF24
 * Callers:
  ...
  if ( *(_QWORD *)((char *)a2 + 4) )
  {
    ...
    if ( v6 )
    {
      ...
      if ( !v5 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x805u, 0LL);
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x1188u, 0LL);
        goto LABEL_10;
      }
    }
  }
LABEL_4:
  ...
  if ( v5 )
  {
    ...
    if ( v14 )
    {
      ...
      v8 = v19;
      if ( v19 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x11A3u, 0LL);
    }
  }
LABEL_10:
