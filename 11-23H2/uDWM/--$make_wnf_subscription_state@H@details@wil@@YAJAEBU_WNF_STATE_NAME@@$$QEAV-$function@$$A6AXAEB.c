/*
 * XREFs of ??$make_wnf_subscription_state@H@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXAEBH@Z@wistd@@KPEAPEAU?$wnf_subscription_state@H@01@@Z @ 0x1800201D8
 * Callers:
...
__int64 __fastcall wil::details::make_wnf_subscription_state<int>(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v13 != -1 )
    goto LABEL_4;
  v11 = NtQueryWnfStateData(&WNF_IMSN_TRANSPARENCYPOLICY, 0LL, 0LL, &v13) | 0x10000000;
