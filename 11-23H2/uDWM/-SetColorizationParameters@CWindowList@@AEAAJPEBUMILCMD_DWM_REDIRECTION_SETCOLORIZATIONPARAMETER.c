/*
 * XREFs of ?SetColorizationParameters@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS@@@Z @ 0x1800514F8
 * Callers:
        ...
        *(_BYTE *)(v17 + 465) = v20;
        ...
        if ( v21 < 0 )
        {
          wil::details::in1diag3::Return_Hr(
            ...
            v23);
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x1BFBu, 0LL);
          v4 = v22;
        }
      }
    }
