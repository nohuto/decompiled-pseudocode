/*
 * XREFs of ?UpdateFloatProperties@?$produce@UWindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@@impl@winrt@@UEAAHPEAX@Z @ 0x1800F9D30
 * Callers:
 *     <none>
 * Callees:
