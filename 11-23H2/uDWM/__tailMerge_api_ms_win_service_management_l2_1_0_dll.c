/*
 * XREFs of __tailMerge_api_ms_win_service_management_l2_1_0_dll @ 0x18005D907
 * Callers:
 *     __imp_load_NotifyServiceStatusChangeW @ 0x18005D8FB (__imp_load_NotifyServiceStatusChangeW.c)
 * Callees:
