/*
 * XREFs of ?CreateExpressionAnimationFromHoverPointerSource@CGlobalLightSet@@AEBAJPEAUIHoverPointerSourcePartner@Composition@UI@Windows@@W4LightType@45@PEAPEAUIExpressionAnimation@345@@Z @ 0x18002CE1C
 * Callers:
...
LABEL_18:
      wil::details::in1diag3::Return_Hr(
        ...
        (int)v30);
LABEL_21:
      Microsoft::WRL::ComPtr<Windows::UI::Composition::IExpressionAnimation>::InternalRelease((__int64 *)&v30);
      goto LABEL_9;
    }
    v35 = 0LL;
