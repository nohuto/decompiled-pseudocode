/*
 * XREFs of ??0CTimelineBase@@QEAA@NNNUInterpolationParameters@@N@Z @ 0x1800E4D74
 * Callers:
 *     ??0?$CTimeline@M@@QEAA@NMMUInterpolationParameters@@N@Z @ 0x1800A21D0 (--0-$CTimeline@M@@QEAA@NMMUInterpolationParameters@@N@Z.c)
 * Callees:
