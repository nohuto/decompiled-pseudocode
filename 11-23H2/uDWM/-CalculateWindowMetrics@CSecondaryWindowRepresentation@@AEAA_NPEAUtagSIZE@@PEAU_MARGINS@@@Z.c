/*
 * XREFs of ?CalculateWindowMetrics@CSecondaryWindowRepresentation@@AEAA_NPEAUtagSIZE@@PEAU_MARGINS@@@Z @ 0x1800420C0
 * Callers:
          ...
          if ( v18 )
          {
            if ( v11 == v18[8] )
            {
              ...
              if ( GetMonitorInfoW(v29, &mi) )
              {
                ...
                v7->cy = v4;
                *a3 = (struct _MARGINS)xmmword_180120550;
                return 1;
              }
            }
          }
