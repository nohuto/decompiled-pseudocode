/*
 * XREFs of ?UpdateTransition@CAcrylicSheet@@AEAAJXZ @ 0x1800A394C
 * Callers:
 ...
 *     ?InterpolateValueLinear@CAcrylicSheet@@AEAAJJJM@Z @ 0x18006B76A (-InterpolateValueLinear@CAcrylicSheet@@AEAAJJJM@Z.c)
