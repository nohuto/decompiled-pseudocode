/*
 * XREFs of ?QueryInterface@?$produce_base@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIAnimationsTransitionManager@Private@345@X@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800FE5B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
