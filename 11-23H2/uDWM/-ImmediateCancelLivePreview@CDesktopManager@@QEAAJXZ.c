/*
 * XREFs of ?ImmediateCancelLivePreview@CDesktopManager@@QEAAJXZ @ 0x1800B4B48
 * Callers:
...
__int64 __fastcall CDesktopManager::ImmediateCancelLivePreview(CDesktopManager *this)
{
  ...
  if ( v3 )
  {
    ...
    *(_DWORD *)(v3 + 24) = 1;
    SetLastError(0);
    if ( PostThreadMessageW(*((_DWORD *)this + 150), 0x405u, v4, 0LL) )
    {
      v4 = 0LL;
    }
    else
    {
      ...
      if ( v2 >= 0 )
        v2 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0xB1Au);
    }
  }
  else
  {
    v2 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0xB0Cu);
  }
