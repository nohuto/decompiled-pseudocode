/*
 * XREFs of ??$CreateProxy@VCMatrixTransformProxy@@@CCompositor@@IEAAJPEAPEAVCMatrixTransformProxy@@@Z @ 0x18004FEDC
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CMatrixTransformProxy>(__int64 a1, CBaseObject **a2)
{
  __int64 v4; // rax
  CBaseObject *v5; // rbx
  int v6; // eax
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CCombinedGeometryProxy::`vftable';
    ...
    v6 = CResource::Create(0x16u, *(_QWORD *)(a1 + 24), (CBaseObject **)(v4 + 16));
    v7 = v6;
    if ( v6 < 0 )
    {
