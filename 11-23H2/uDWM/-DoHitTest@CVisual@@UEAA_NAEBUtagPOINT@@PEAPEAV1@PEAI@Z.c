/*
 * XREFs of ?DoHitTest@CVisual@@UEAA_NAEBUtagPOINT@@PEAPEAV1@PEAI@Z @ 0x18006ED10
 * Callers:
 ...
 *     ?MovePrevious@VisualCollectionIterator@@QEAA_NXZ @ 0x180105454 (-MovePrevious@VisualCollectionIterator@@QEAA_NXZ.c)
