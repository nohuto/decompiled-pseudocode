/*
 * XREFs of ?UpdateAngle@TransitionManager@implementation@Transitions@Udwm@winrt@@QEAAXHH@Z @ 0x1800FEE08
 * Callers:
 *     ?UpdateAngle@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotationTransitionManager@Private@345@@impl@winrt@@UEAAHHH@Z @ 0x1800FEDB0 (-UpdateAngle@-$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotationTrans.c)
 * Callees:
 ...
 *     ??0?$map@Uhstring@winrt@@NU?$less@Uhstring@winrt@@@std@@V?$allocator@U?$pair@$$CBUhstring@winrt@@N@std@@@4@@std@@QEAA@V?$initializer_list@U?$pair@$$CBUhstring@winrt@@N@std@@@1@@Z @ 0x1800FC5B0 (--0-$map@Uhstring@winrt@@NU-$less@Uhstring@winrt@@@std@@V-$allocator@U-$pair@$$CBUhstring@winrt@.c)
        ...
        int a3)
{
  ...
  {
    hstring_on_heap = (struct winrt::impl::hstring_header *)qword_180148940;
    if ( qword_180148940 )
    {
      if ( (*(_BYTE *)qword_180148940 & 1) != 0 )
        hstring_on_heap = winrt::impl::create_hstring_on_heap(
                            *(winrt::impl **)(qword_180148940 + 16),
                            (winrt::impl *)*(unsigned int *)(qword_180148940 + 4));
      else
        _InterlockedExchangeAdd((volatile signed __int32 *)(qword_180148940 + 24), 1u);
    }
    v14[0] = hstring_on_heap;
    *(double *)&v14[1] = (float)a2;
    v6 = (struct winrt::impl::hstring_header *)qword_180148948;
    if ( qword_180148948 )
    {
      if ( (*(_BYTE *)qword_180148948 & 1) != 0 )
        v6 = winrt::impl::create_hstring_on_heap(
               *(winrt::impl **)(qword_180148948 + 16),
               (winrt::impl *)*(unsigned int *)(qword_180148948 + 4));
      else
        _InterlockedExchangeAdd((volatile signed __int32 *)(qword_180148948 + 24), 1u);
    }
    v14[2] = v6;
