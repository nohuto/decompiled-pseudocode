/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_AccessViolationAdjustSnapUI@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180065810
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_AccessViolationAdjustSnapUI@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180065924 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_AccessViolati.c)
 */

signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_AccessViolationAdjustSnapUI>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_AccessViolationAdjustSnapUI>::GetCurrentFeatureEnabledState(
      a1,
      &v13,
      &v12);
    for ( i = *a2; ; i = v8 )
