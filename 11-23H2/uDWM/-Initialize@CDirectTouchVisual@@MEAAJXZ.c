/*
 * XREFs of ?Initialize@CDirectTouchVisual@@MEAAJXZ @ 0x180054970
 * Callers:
...
__int64 __fastcall CDirectTouchVisual::Initialize(struct tagSIZE *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0x26u, 0LL);
  }
  else
  {
    ...
    if ( *(_BYTE *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 20) + 324LL) )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, BitmapFromAtlas, 0x2Cu, 0LL);
        return v3;
      }
    }
    else
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x30u, 0LL);
        return v3;
      }
    }
    v7 = (unsigned __int64 *)&this[52];
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x44u, 0LL);
    }
    else
    {
      inserted = VisualCollection::InsertRelative((VisualCollection *)&this[4], *v7, 0LL, 0, v12);
      v3 = inserted;
      if ( inserted < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x45u, 0LL);
      }
      else
      {
        CVisual::SetSize((CVisual *)*v7, this + 41);
        this[48] = 0LL;
        this[49] = 0LL;
        this[50] = 0LL;
        LOBYTE(this[36].cx) = 0;
