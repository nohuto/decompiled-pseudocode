/*
 * XREFs of ?UpdateWindowCapture@CProjectionBorderManager@@UEAAJPEAUHWND__@@AEBUDWM_CAPTURE_TOKEN@@@Z @ 0x1800D32E0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct DWM_CAPTURE_TOKEN *a3)
{
  ...
  CCaptureControllerProxy **v20; // rsi
  int v21; // r14d
  __int64 v22; // rdx
...
LABEL_13:
      ...
      v20 = (CCaptureControllerProxy **)CGenericTableMap<_LARGE_INTEGER,CProjectionBorderManager::CAPTURE_TAB_GROUP_MAP_ENTRY>::FindElement(
                                          this + 6,
                                          *(_QWORD *)a3);
      v21 = CCaptureControllerProxy::SetRootVisual(v20[1], v30);
      if ( v21 < 0 )
      {
        v22 = 423LL;
LABEL_18:
      ...
      v21 = CProjectionBorderManager::_SendBoundsToCaptureControllerFromWindow(
              (CProjectionBorderManager *)this,
              v15,
              v20[1]);
      if ( v21 < 0 )
      ...
      if ( wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_WatsonFailureAccessViolationuDWM>::__private_IsEnabled(`wil::Feature<__WilFeatureTraits_Feature_Servicing_WatsonFailureAccessViolationuDWM>::GetImpl'::`2'::impl) )
      {
        if ( *((_BYTE *)v20 + 32) )
        {
          v21 = CProjectionBorderManager::_SetProjectionBorderForWindow(v23, v15, 1);
          if ( v21 < 0 )
          {
            v22 = 432LL;
            goto LABEL_18;
      ...
      v21 = CProjectionBorderManager::_SetScreenCaptureForWindow(v23, v15, 1);
      if ( v21 < 0 )
      {
        v22 = 439LL;
        goto LABEL_18;
      ...
      if ( v15 != v14 )
      {
        if ( wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_WatsonFailureAccessViolationuDWM>::__private_IsEnabled(`wil::Feature<__WilFeatureTraits_Feature_Servicing_WatsonFailureAccessViolationuDWM>::GetImpl'::`2'::impl) )
        {
          if ( *((_BYTE *)v20 + 32) )
          {
            CapturedItemRootVisual = CProjectionBorderManager::_SetProjectionBorderForWindow(v24, v14, 1);
            if ( CapturedItemRootVisual < 0 )
            {
              v18 = 446LL;
              goto LABEL_13;
...
LABEL_42:
  ...
  Microsoft::WRL::ComPtr<CDrawBitmapInstruction>::~ComPtr<CDrawBitmapInstruction>(&v28);
