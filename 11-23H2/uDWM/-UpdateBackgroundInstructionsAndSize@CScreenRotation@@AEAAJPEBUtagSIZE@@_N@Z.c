/*
 * XREFs of ?UpdateBackgroundInstructionsAndSize@CScreenRotation@@AEAAJPEBUtagSIZE@@_N@Z @ 0x1800D814C
 * Callers:
        ...
        char a3)
{
  ...
  __int64 v16; // r8
  __int64 v17; // r9
  struct CSolidRectangleInstruction *v19; // [rsp+20h] [rbp-30h] BYREF
  CBaseObject *v20; // [rsp+28h] [rbp-28h] BYREF
  struct CRenderDataInstruction *v21; // [rsp+30h] [rbp-20h] BYREF
