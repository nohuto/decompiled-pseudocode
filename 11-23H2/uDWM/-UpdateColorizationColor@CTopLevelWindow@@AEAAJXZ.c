/*
 * XREFs of ?UpdateColorizationColor@CTopLevelWindow@@AEAAJXZ @ 0x18003FB60
 * Callers:
 ...
 *     ?SetColor@CGlassColorizationResources@@QEAAXK@Z @ 0x18006CEE8 (-SetColor@CGlassColorizationResources@@QEAAXK@Z.c)
 */
