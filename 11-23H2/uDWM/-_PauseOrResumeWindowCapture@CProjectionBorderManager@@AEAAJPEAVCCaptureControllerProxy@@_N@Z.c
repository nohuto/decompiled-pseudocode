/*
 * XREFs of ?_PauseOrResumeWindowCapture@CProjectionBorderManager@@AEAAJPEAVCCaptureControllerProxy@@_N@Z @ 0x1800D46FC
 * Callers:
        ...
        char a3)
{
  ...
  if ( a2 )
  {
    ...
    LOBYTE(v5) = a3;
    v6 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**(_QWORD **)(*((_QWORD *)a2 + 2) + 16LL) + 1000LL))(
