/*
 * XREFs of ?GetWindowRectForLivePreview@CWindowIconic@@AEAAJPEAUtagRECT@@@Z @ 0x180106500
 * Callers:
...
__int64 __fastcall CWindowIconic::GetWindowRectForLivePreview(CWindowIconic *this, struct tagRECT *a2)
{
  ...
  if ( (*((_BYTE *)v4 + 674) & 2) == 0 || (MDIOwner = CWindowData::GetMDIOwner(v4)) == 0LL )
  ...
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, WindowRestoreRect, 0x1CEu);
      return v3;
    }
  }
  if ( *((_DWORD *)this + 4) == 2 )
  {
    ...
    {
      v9 = *(_QWORD *)(v8 + 24);
      v10 = _mm_cvtsi32_si128(HIDWORD(*(_QWORD *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 29) + 104LL)));
      ...
      left = a2->left;
      a2->top += (int)(float)((float)(_mm_cvtepi32_ps(v10).m128_f32[0] * *((float *)MDIOwner + 83))
