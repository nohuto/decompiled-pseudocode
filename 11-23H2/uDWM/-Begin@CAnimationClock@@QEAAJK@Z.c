/*
 * XREFs of ?Begin@CAnimationClock@@QEAAJK@Z @ 0x180013B1C
 * Callers:
...
__int64 __fastcall CAnimationClock::Begin(CAnimationClock *this, unsigned int a2)
{
  ...
  __int64 v10[40]; // [rsp+50h] [rbp-168h] BYREF
  ...
  v10[0] = (__int64)&AnimationClockLoggingTelemetry::BeginAnimationClock::`vftable';
