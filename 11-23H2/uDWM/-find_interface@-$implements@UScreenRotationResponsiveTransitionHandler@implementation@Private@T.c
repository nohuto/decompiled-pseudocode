/*
 * XREFs of ?find_interface@?$implements@UScreenRotationResponsiveTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@U13456@UIScreenRotationResponsiveTransitionHandler@3456@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x1800F6950
 * Callers:
 *     <none>
 * Callees:
 *     <none>
