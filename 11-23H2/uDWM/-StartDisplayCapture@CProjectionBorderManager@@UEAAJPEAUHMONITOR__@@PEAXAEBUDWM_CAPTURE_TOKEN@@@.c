/*
 * XREFs of ?StartDisplayCapture@CProjectionBorderManager@@UEAAJPEAUHMONITOR__@@PEAXAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x1800D1190
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct DWM_CAPTURE_TOKEN *a4)
{
  ...
  {
    v11 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147418113, 0x20Eu);
    goto LABEL_13;
  }
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x211u);
LABEL_5:
    v8 = v18;
    goto LABEL_13;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopRootVisual, 0x213u);
    goto LABEL_5;
  }
  v8 = v18;
