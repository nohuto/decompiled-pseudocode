/*
 * XREFs of ?EnsureWorkAreaChangeTransitionRemoved@TransitionManager@implementation@Transitions@Udwm@winrt@@QEAAX_K@Z @ 0x1800FD0E8
 * Callers:
 *     ?EnsureWorkAreaChangeTransitionRemoved@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIAnimationsTransitionManager@Private@345@@impl@winrt@@UEAAH_K@Z @ 0x1800FD090 (-EnsureWorkAreaChangeTransitionRemoved@-$produce@UTransitionManager@implementation@Transitions@U.c)
 ...
 *     ?_Unchecked_erase@?$_Hash@V?$_Umap_traits@PEAUHWND__@@UITransitionHandler@Transitions@Udwm@winrt@@V?$_Uhash_compare@PEAUHWND__@@U?$hash@PEAUHWND__@@@std@@U?$equal_to@PEAUHWND__@@@3@@std@@V?$allocator@U?$pair@QEAUHWND__@@UITransitionHandler@Transitions@Udwm@winrt@@@std@@@7@$0A@@std@@@std@@AEAAPEAU?$_List_node@U?$pair@QEAUHWND__@@UITransitionHandler@Transitions@Udwm@winrt@@@std@@PEAX@2@PEAU32@@Z @ 0x1800FF664 (-_Unchecked_erase@-$_Hash@V-$_Umap_traits@PEAUHWND__@@UITransitionHandler@Transitions@Udwm@winrt.c)
 */
