/*
 * XREFs of ??1Completer@?$static_lazy@VWindowFrameLogging@@@details@wil@@QEAA@XZ @ 0x18000B740
 * Callers:
...
BOOL __fastcall wil::details::static_lazy<WindowFrameLogging>::Completer::~Completer(
        _DWORD *a1,
        __int64 a2,
