/*
 * XREFs of ?Initialize@CImmersiveWindowIconic@@IEAAJPEAVCWindowData@@HW4DEVICE_SCALE_FACTOR@@_N@Z @ 0x1800C4770
 * Callers:
 ...
 *     ?GetBitmapSourceNoRef@CImmersiveIconicResource@CImmersiveIconicBitmapRegistry@@QEAAPEAVCBitmapSource@@H@Z @ 0x1800C3B28 (-GetBitmapSourceNoRef@CImmersiveIconicResource@CImmersiveIconicBitmapRegistry@@QEAAPEAVCBitmapSo.c)
 *     ?GetImmersiveIconContainerSize@CImmersiveIconicBitmapRegistry@@SAHW4DEVICE_SCALE_FACTOR@@W4IconicRepresentationType@@@Z @ 0x1800C3C98 (-GetImmersiveIconContainerSize@CImmersiveIconicBitmapRegistry@@SAHW4DEVICE_SCALE_FACTOR@@W4Iconi.c)
        ...
        unsigned int a5)
{
  ...
  *((_DWORD *)this + 78) = 5;
  *((_DWORD *)this + 81) = a4;
  v10 = (CImmersiveIconicBitmapRegistry *)*((_QWORD *)v7 + 30);
  v11 = CVisual::Initialize(this);
  v12 = v11;
  if ( v11 >= 0 )
  {
    v13 = CImage::Create((struct CImage **)this + 37);
    v12 = v13;
    if ( v13 >= 0 )
    {
      *(_BYTE *)(*((_QWORD *)this + 36) + 674LL) |= 2u;
      if ( a3 )
      {
        LOBYTE(v28) = *((_BYTE *)this + 328);
        ...
        v16 = v31;
        *((_DWORD *)this + 79) = ImmersiveIconContainerSize - 2;
        ...
        *((_DWORD *)this + 80) = v17;
        if ( v18 )
        {
          v29 = v17;
          v30 = v17;
          (*(void (__fastcall **)(CImmersiveWindowIconic *, int *))(*(_QWORD *)this + 104LL))(this, &v29);
        ...
        else
        {
          ...
          *((_DWORD *)this + 80) = *((_DWORD *)BitmapSourceNoRef + 6);
          (*(void (__fastcall **)(CImmersiveWindowIconic *))(*(_QWORD *)this + 104LL))(this);
