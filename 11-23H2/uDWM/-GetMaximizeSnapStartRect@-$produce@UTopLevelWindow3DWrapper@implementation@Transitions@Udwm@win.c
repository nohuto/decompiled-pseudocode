/*
 * XREFs of ?GetMaximizeSnapStartRect@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHPEAURect@Foundation@Windows@3@@Z @ 0x1800FAD70
 * Callers:
 *     <none>
 * Callees:
        ...
        __m128i *a2)
{
  ...
  try
  {
    *a2 = _mm_loadu_si128((const __m128i *)winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper::GetMaximizeSnapStartRect());
    result = 0LL;
  }
  catch ( ... )
  {
