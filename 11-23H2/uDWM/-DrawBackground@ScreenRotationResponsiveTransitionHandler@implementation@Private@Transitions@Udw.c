/*
 * XREFs of ?DrawBackground@ScreenRotationResponsiveTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@AEAAXXZ @ 0x1800F4D40
 * Callers:
        ...
        winrt::Udwm::Transitions::Private::implementation::ScreenRotationResponsiveTransitionHandler *this)
{
  ...
  if ( v7 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      (int)v22);
  v10 = v22;
  *((_OWORD *)v22 + 1) = xmmword_18012A7B8;
