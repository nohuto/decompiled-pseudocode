/*
 * XREFs of ?HasChanged@CDisplayModeChangeHelper@@SA?AW4DisplayModeChangeResult@@PEAVCDWMDisplaySet@@0AEAV?$vector@PEBVCDWMDisplay@@V?$allocator@PEBVCDWMDisplay@@@std@@@std@@@Z @ 0x180028634
 * Callers:
...
LABEL_35:
      ...
      if ( (unsigned int)dword_180147058 > 5 && (byte_180147068 & 1) != 0 && (qword_180147070 & 1) == qword_180147070 )
      {
        ...
        v20 = 4;
        v21 = 0;
        tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_180147058, byte_180126353, 0LL, 0LL, 3, (__int64)v18);
      }
    }
    wil::com_ptr_t<CDWMDisplay const,wil::err_returncode_policy>::~com_ptr_t<CDWMDisplay const,wil::err_returncode_policy>(&v15);
    wil::com_ptr_t<CDWMDisplay const,wil::err_returncode_policy>::~com_ptr_t<CDWMDisplay const,wil::err_returncode_policy>(&v17);
...
LABEL_5:
  v8 = (_DWORD *)((char *)a2 + 64);
LABEL_6:
  v9 = CDisplayModeChangeHelper::IsModeChangeBetweenDuplicateAndExtend(this, (__int64)a2, a3);
  if ( !v9 )
  {
...
LABEL_9:
  if ( (unsigned int)dword_180147058 > 5 && (byte_180147068 & 1) != 0 && (qword_180147070 & 1) == qword_180147070 )
  {
    ...
    v20 = 4;
    v21 = 0;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_180147058, byte_1801263A8, 0LL, 0LL, 3, (__int64)v18);
  }
  return v9;
}
