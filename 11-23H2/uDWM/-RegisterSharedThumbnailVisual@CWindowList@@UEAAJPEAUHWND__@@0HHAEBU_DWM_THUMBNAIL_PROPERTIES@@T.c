/*
 * XREFs of ?RegisterSharedThumbnailVisual@CWindowList@@UEAAJPEAUHWND__@@0HHAEBU_DWM_THUMBNAIL_PROPERTIES@@T_LARGE_INTEGER@@PEAX@Z @ 0x18000E380
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  *((_QWORD *)this + 52) = v57;
  ...
  {
    v15 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x1239u, 0LL);
    goto LABEL_32;
  }
  *(_DWORD *)(v20 + 32) = 0;
  *(_OWORD *)(v20 + 36) = 0LL;
  ...
  *(_DWORD *)(v20 + 120) = a4 != 0;
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x1244u, 0LL);
    v12 = v54;
    goto LABEL_49;
  }
  ...
  if ( v23 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x1245u, 0LL);
    v12 = v54;
    v13 = v56;
    goto LABEL_49;
  }
  ...
  if ( v24 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x1246u, 0LL);
    goto LABEL_49;
  }
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0p_EtwEventWriteTransfer(v25, &CommitChannel_WindowList_Thumbnail, a2);
  v21[12] = v12;
...
LABEL_58:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v39, 0x124Eu, 0LL);
    goto LABEL_49;
  }
LABEL_17:
  v56 = (struct CVisual *)v21;
