/*
 * XREFs of ?InterpolateValue@CCubicBezierInterpolator@@UEAAJNPEANI@Z @ 0x1800B3160
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z @ 0x1800B2E80 (-GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z.c)
 */
        ...
        unsigned int a4)
{
  ...
  if ( v7 < 1.0 )
  {
    ...
    if ( v13 != 0.0 )
      v14 = (float)((float)((float)(v14 - *(float *)(v8 + 8 * v12 + 4)) * (float)(v7 - *(float *)(v8 + 8 * v12))) / v13)
          + *(float *)(v8 + 8 * v12 + 4);
    if ( a4 )
    {
      v15 = a4;
