/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x18009C5AC
 * Callers:
 ...
 *     _wil::details::ResultFromCaughtException_CppWinRt_::_1_::catch$5 @ 0x18009CFE2 (_wil--details--ResultFromCaughtException_CppWinRt_--_1_--catch$5.c)
 * Callees:
