/*
 * XREFs of ?NotifyRedirectionShutdown@CDesktopManager@@QEAAJXZ @ 0x1800B4D00
 * Callers:
...
__int64 __fastcall CDesktopManager::NotifyRedirectionShutdown(CDesktopManager *this)
{
  ...
  *((_BYTE *)this + 20) = 1;
  v2 = CDesktopManager::EnableMonitorRenderTargets((CVisualTargetProxy **)this, 0);
  v3 = v2;
  v4 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x241u);
  ...
  if ( *((_QWORD *)this + 76) )
  {
    ...
    if ( PostThreadMessageW(*((_DWORD *)this + 150), 0x12u, 0LL, 0LL) )
    {
      if ( v4 >= 0 )
      {
        ...
        if ( WaitForSingleObject(*((HANDLE *)this + 76), 0xFFFFFFFF) )
        {
          ...
          if ( v3 >= 0 )
            v3 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x255u);
        }
        else
        {
          v3 = v4;
    ...
    else
    {
      ...
      if ( v3 >= 0 )
        v3 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x24Du);
    }
    *((_DWORD *)this + 150) = 0;
