/*
 * XREFs of ?_FadeWindow@CFade@@IEAAJPEAVCWindowData@@_N@Z @ 0x1800DD49C
 * Callers:
...
LABEL_15:
  if ( (*((_DWORD *)a2 + 170) & 0x20000) == 0 )
  {
    ...
    v17 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v16, 0LL, 0LL, -1, 1, &v28);
    if ( v17 < 0 )
    {
...
LABEL_26:
  ...
  v14 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v13, &rc, 0LL, -1, 1, &v28);
  if ( v14 >= 0 )
  {
    v15 = (struct tagPOINT **)v28;
    goto LABEL_26;
