/*
 * XREFs of ?SkipAnimationDelays@TransitionManager@implementation@Transitions@Udwm@winrt@@QEAAXXZ @ 0x1800FEB88
 * Callers:
 *     ?SkipAnimationDelays@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotationTransitionManager@Private@345@@impl@winrt@@UEAAHXZ @ 0x1800FEB30 (-SkipAnimationDelays@-$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotat.c)
 * Callees:
        ...
        winrt::Udwm::Transitions::implementation::TransitionManager *this)
{
  ...
  {
    hstring_on_heap = (struct winrt::impl::hstring_header *)qword_180148938;
    if ( qword_180148938 )
    {
      if ( (*(_BYTE *)qword_180148938 & 1) != 0 )
        hstring_on_heap = winrt::impl::create_hstring_on_heap(
                            *(winrt::impl **)(qword_180148938 + 16),
                            (winrt::impl *)*(unsigned int *)(qword_180148938 + 4));
      else
        _InterlockedExchangeAdd((volatile signed __int32 *)(qword_180148938 + 24), 1u);
    }
