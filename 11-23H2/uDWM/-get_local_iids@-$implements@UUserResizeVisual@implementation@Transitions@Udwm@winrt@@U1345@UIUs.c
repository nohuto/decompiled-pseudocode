/*
 * XREFs of ?get_local_iids@?$implements@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@U1345@UIUserResizeVisualNative@34@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x180059970
 * Callers:
 *     <none>
 * Callees:
 *     <none>
