/*
 * XREFs of ?BeginDestroySprite@CTopLevelWindow3D@@QEAAJPEA_N@Z @ 0x18004F364
 * Callers:
...
__int64 __fastcall CTopLevelWindow3D::BeginDestroySprite(CTopLevelWindow3D *this, bool *a2)
{
  ...
  if ( CTopLevelWindow3D::ShouldDelayTransition(this, 0) )
  {
    ...
    if ( started < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, started, 0x1A9u, 0LL);
      goto LABEL_3;
    }
    goto LABEL_8;
  }
    ...
    && !CTopLevelWindow3D::IsWindowInSystemArrangementAnimation(this) )
  {
    ...
    {
      v7 = CTopLevelWindow3D::StartAnimation((__int64)this, 6);
      v4 = v7;
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x1B4u, 0LL);
        goto LABEL_3;
      }
    }
LABEL_8:
