/*
 * XREFs of ?InitializeVisualTreeClone@CSystemBackdropVisual@@IEAAJPEAV1@W4CloneOptions@@@Z @ 0x18000706C
 * Callers:
...
__int64 __fastcall CSystemBackdropVisual::InitializeVisualTreeClone(__int64 a1, __int64 a2, __int64 a3)
{
  int v5; // ebx
  __int64 v6; // r8
  __int64 v8; // rdx
