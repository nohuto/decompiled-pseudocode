/*
 * XREFs of ?Create@CMagnifier@@SAJPEAUHWND__@@HPEAVCVisual@@PEAPEAV1@@Z @ 0x1800C9D18
 * Callers:
 ...
 *     ??0CMagnifier@@AEAA@PEAUHWND__@@HPEAVCVisual@@@Z @ 0x1800C9B88 (--0CMagnifier@@AEAA@PEAUHWND__@@HPEAVCVisual@@@Z.c)
