/*
 * XREFs of ?find_interface@?$implements@UTransitionManager@implementation@Transitions@Udwm@winrt@@U1345@UIRotationTransitionManager@Private@345@UIWindowStateTransitionManager@7345@UIAnimationsTransitionManager@7345@UITransitionManagerNativePrivate@34@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x18002E8E0
 * Callers:
 *     <none>
 * Callees:
 *     ??$find@UTransitionManager@implementation@Transitions@Udwm@winrt@@Uiid_finder@impl@5@@?$interface_list@UIAnimationsTransitionManager@Private@Transitions@Udwm@winrt@@UITransitionManagerNativePrivate@34@@impl@winrt@@SAPEAXPEBUTransitionManager@implementation@Transitions@Udwm@2@AEBUiid_finder@12@@Z @ 0x1800FC080 (--$find@UTransitionManager@implementation@Transitions@Udwm@winrt@@Uiid_finder@impl@5@@-$interfac.c)
 */
