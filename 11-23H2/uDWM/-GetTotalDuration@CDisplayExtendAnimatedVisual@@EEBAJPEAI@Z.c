/*
 * XREFs of ?GetTotalDuration@CDisplayExtendAnimatedVisual@@EEBAJPEAI@Z @ 0x1800BA870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDisplayExtendAnimatedVisual::GetTotalDuration(CDisplayExtendAnimatedVisual *this, unsigned int *a2)
{
  int v3; // eax
  int v4; // eax
