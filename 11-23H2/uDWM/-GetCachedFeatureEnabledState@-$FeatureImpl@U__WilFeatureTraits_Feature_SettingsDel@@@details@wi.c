/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SettingsDel@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180060E88
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SettingsDel@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180064E14 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_SettingsDel@@@details@wil@@QEAAX_NW4Repor.c)
 * Callees:
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_SettingsDel>::GetCurrentFeatureEnabledState(a1, &v13, &v12);
    for ( i = *a2; ; i = v8 )
    {
      *a2 = i;
      v7 = i;
