/*
 * XREFs of ?UpdateInfoIfTaskbar@CImmersiveState@@AEAA_NPEBVCWindowData@@@Z @ 0x180004360
 * Callers:
 ...
 *     wcscmp_0 @ 0x1800661F4 (wcscmp_0.c)
 */
...
LABEL_9:
        ...
        if ( GetMonitorInfoW(v6, &mi) )
        {
          ...
          {
            v18 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 16, 24LL, 1LL, &v21);
            if ( v18 < 0 )
