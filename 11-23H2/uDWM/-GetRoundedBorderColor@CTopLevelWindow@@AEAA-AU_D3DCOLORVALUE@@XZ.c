/*
 * XREFs of ?GetRoundedBorderColor@CTopLevelWindow@@AEAA?AU_D3DCOLORVALUE@@XZ @ 0x180034AC0
 * Callers:
 ...
 *     ?HasNonClientArea@CTopLevelWindow@@QEBA_NXZ @ 0x1800E5D80 (-HasNonClientArea@CTopLevelWindow@@QEBA_NXZ.c)
 */
