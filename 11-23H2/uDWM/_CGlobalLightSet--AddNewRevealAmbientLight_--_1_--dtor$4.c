/*
 * XREFs of _CGlobalLightSet::AddNewRevealAmbientLight_::_1_::dtor$4 @ 0x180067162
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
int __fastcall CGlobalLightSet::AddNewRevealAmbientLight_::_1_::dtor_4(__int64 a1, __int64 a2)
{
