/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_NonClientAreaThumbnails@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18006578C
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_NonClientAreaThumbnails>::ReportUsage(
