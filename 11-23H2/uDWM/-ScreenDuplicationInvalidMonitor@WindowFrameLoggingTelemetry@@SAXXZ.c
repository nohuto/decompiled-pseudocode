/*
 * XREFs of ?ScreenDuplicationInvalidMonitor@WindowFrameLoggingTelemetry@@SAXXZ @ 0x1800D0BF8
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationInvalidMonitor(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EtwEventWriteTransfer(v1, byte_1801272D2, 0LL, 0LL, 2, (__int64)v2);
  }
}
