/*
 * XREFs of ?AlphaChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800342D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OnAlphaChange@CLivePreview@@QEAAXPEBVCWindowData@@E@Z @ 0x180034478 (-OnAlphaChange@CLivePreview@@QEAAXPEBVCWindowData@@E@Z.c)
...
LABEL_24:
      v6 = v4;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x165Fu, 0LL);
      goto LABEL_17;
    }
    *((_QWORD *)v18 + 3) = a2;
