/*
 * XREFs of ?_Change_array@?$vector@PEAVCWindowData@@V?$allocator@PEAVCWindowData@@@std@@@std@@AEAAXQEAPEAVCWindowData@@_K1@Z @ 0x1800C73B0
 * Callers:
...
__int64 __fastcall std::vector<CWindowData *>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rcx
  __int64 result; // rax
