/*
 * XREFs of ?CleanupFinishedAnimations@CContactManager@@AEAAXXZ @ 0x1800AF484
 * Callers:
 ...
 *     ?IsOKToCleanup@CFlickVisual@@UEAA_NXZ @ 0x1800AFD60 (-IsOKToCleanup@CFlickVisual@@UEAA_NXZ.c)
 ...
 *     ?IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ @ 0x1800B26E0 (-IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ.c)
 *     ?IsOKToCleanup@CTouchPressHoldVisual@@UEAA_NXZ @ 0x1800E8760 (-IsOKToCleanup@CTouchPressHoldVisual@@UEAA_NXZ.c)
 */
...
LABEL_8:
    ...
    CContactManager::RemoveFromTouchNode(v6, v5[37], (struct CVisual *)v5);
...
LABEL_9:
  ...
  if ( v8 >= 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v11 )
        goto LABEL_15;
      if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v11 + 224LL))(v11) )
        break;
LABEL_16:
      v10 -= 8LL;
      if ( --v8 < 0 )
...
LABEL_24:
    ...
    CContactManager::RemoveFromTouchNode(v18, v17[37], (struct CVisual *)v17);
...
LABEL_25:
  ...
  {
    CContactManager::RemoveFromTouchNode(v21, v20[37], (struct CVisual *)v20);
