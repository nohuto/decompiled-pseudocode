/*
 * XREFs of ?_Create3DComponent@CGroupingStoryboard@@IEAAJPEAVCWindowData@@@Z @ 0x1800DC678
 * Callers:
  ...
  if ( v5 == 1 || (v4 & 0xFFF) == 3 || (v4 & 0xFFF) == 4 )
  {
    ...
    if ( (*((_DWORD *)a2 + 170) & 0x1000000) == 0 || IsRectEmpty((const RECT *)((char *)a2 + 684)) )
    {
      v17 = (*(__int64 (__fastcall **)(CGroupingStoryboard *, _QWORD))(*(_QWORD *)this + 112LL))(
              this,
              *((unsigned int *)a2 + 170));
      v10 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 0, v17, 0LL, 0LL, -1, v6, &v26);
      v6 = v10;
      if ( v10 < 0 )
      {
        v24 = 2110;
