/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCVisualSurfaceProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCVisualSurfaceProxy@@@Z @ 0x18002113C
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v6 = &CCombinedGeometryProxy::`vftable';
    ...
    v11 = 0;
    v8 = CResourceProxy::InitializeFromSharedHandle(v6, 42LL, *(_QWORD *)(a1 + 24), a2, v11);
    v9 = v8;
    if ( v8 < 0 )
    {
