/*
 * XREFs of ??$_Uninitialized_move@PEAVIterator@JSONInputArchive@cereal@@V?$allocator@VIterator@JSONInputArchive@cereal@@@std@@@std@@YAPEAVIterator@JSONInputArchive@cereal@@QEAV123@0PEAV123@AEAV?$allocator@VIterator@JSONInputArchive@cereal@@@0@@Z @ 0x1800EF8D4
 * Callers:
