/*
 * XREFs of ?get_local_iids@?$implements@UWindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@U13456@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x1800597E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
