/*
 * XREFs of ?_SetStoryboardTriggerForAnimationClock@CAnimationScheduler@@AEAAJU_GUID@@@Z @ 0x180007864
 * Callers:
 ...
 * Callees:
 *     ?UseDComposition@CStoryboard@@QEAA_NXZ @ 0x18000795C (-UseDComposition@CStoryboard@@QEAA_NXZ.c)
