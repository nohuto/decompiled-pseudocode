/*
 * XREFs of ?StartTransition@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_STARTTRANSITION@@@Z @ 0x1800147A8
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_STARTTRANSITION *a2)
{
  ...
  if ( v7 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x14ABu, 0LL);
