/*
 * XREFs of ??$_tlgWriteActivityAutoStop@$0CAAAAAAAAAAA@$04@@YAXPEBU_tlgProvider_t@@PEBU_GUID@@@Z @ 0x1800CF788
 * Callers:
 *     ??1?$_TlgActivityBase@V?$ActivityData@VWindowFrameLogging@@U_TlgReflectorTag_Param0IsProviderType@@@?$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@$0CAAAAAAAAAAA@$04@@IEAA@XZ @ 0x1800CF950 (--1-$_TlgActivityBase@V-$ActivityData@VWindowFrameLogging@@U_TlgReflectorTag_Param0_ea_1800CF950.c)
 * Callees:
...
__int64 __fastcall _tlgWriteActivityAutoStop<35184372088832,5>(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)a1 > 5u && (*(_QWORD *)(a1 + 16) & 0x200000000000LL) != 0 )
  {
    ...
    if ( result == *(_QWORD *)(a1 + 24) )
      return tlgWriteTransfer_EtwEventWriteTransfer(a1, byte_180127255, a2, 0LL, 2, (__int64)v3);
  }
  return result;
}
