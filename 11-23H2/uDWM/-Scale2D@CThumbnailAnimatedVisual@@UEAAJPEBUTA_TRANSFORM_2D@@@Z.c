/*
 * XREFs of ?Scale2D@CThumbnailAnimatedVisual@@UEAAJPEBUTA_TRANSFORM_2D@@@Z @ 0x1800E4460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CThumbnailAnimatedVisual::Scale2D(struct tagPOINT *this, const struct TA_TRANSFORM_2D *a2)
{
  ...
  (*(void (__fastcall **)(struct tagPOINT *, int *))(*(_QWORD *)&this[-36] + 104LL))(this - 36, &v12);
  CVisual::SetOffset(this - 36, &v14);
  (*(void (__fastcall **)(struct tagPOINT *, __int64))(*(_QWORD *)&this[-36] + 24LL))(this - 36, 4096LL);
  return 0LL;
}
