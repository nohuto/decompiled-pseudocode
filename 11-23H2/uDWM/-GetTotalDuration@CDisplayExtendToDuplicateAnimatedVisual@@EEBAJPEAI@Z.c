/*
 * XREFs of ?GetTotalDuration@CDisplayExtendToDuplicateAnimatedVisual@@EEBAJPEAI@Z @ 0x1800BAFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDisplayExtendToDuplicateAnimatedVisual::GetTotalDuration(
