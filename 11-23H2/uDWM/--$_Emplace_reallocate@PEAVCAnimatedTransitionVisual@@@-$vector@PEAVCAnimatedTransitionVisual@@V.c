/*
 * XREFs of ??$_Emplace_reallocate@PEAVCAnimatedTransitionVisual@@@?$vector@PEAVCAnimatedTransitionVisual@@V?$allocator@PEAVCAnimatedTransitionVisual@@@std@@@std@@QEAAPEAPEAVCAnimatedTransitionVisual@@QEAPEAV2@$$QEAPEAV2@@Z @ 0x18010027C
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCAnimatedTransitionVisual@@V?$allocator@PEAVCAnimatedTransitionVisual@@@std@@@std@@AEAAXQEAPEAVCAnimatedTransitionVisual@@_K1@Z @ 0x1801037B4 (-_Change_array@-$vector@PEAVCAnimatedTransitionVisual@@V-$allocator@PEAVCAnimatedTransitionVisua.c)
 *     ?_Dwm_Xlength_error@std@@YAXPEBD@Z @ 0x18010DD40 (-_Dwm_Xlength_error@std@@YAXPEBD@Z.c)
 */

char *__fastcall std::vector<CAnimatedTransitionVisual *>::_Emplace_reallocate<CAnimatedTransitionVisual *>(
        __int64 a1,
        _BYTE *a2,
        _QWORD *a3)
{
