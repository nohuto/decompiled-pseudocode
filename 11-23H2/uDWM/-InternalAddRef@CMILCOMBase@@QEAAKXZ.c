/*
 * XREFs of ?InternalAddRef@CMILCOMBase@@QEAAKXZ @ 0x18001EC8C
 * Callers:
 *     ?AddRef@CCompoundBitmapLock@@UEAAKXZ @ 0x18001EC80 (-AddRef@CCompoundBitmapLock@@UEAAKXZ.c)
 ...
 * Callees:
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x18010DDB4 (-IsKernelDebuggerPresent@@YAHXZ.c)
 */
