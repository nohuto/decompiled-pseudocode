/*
 * XREFs of ?Initialize@CWindowSnapshot@@IEAAJPEAVCTopLevelWindow@@@Z @ 0x18000FE38
 * Callers:
 ...
 * Callees:
 *     ?NotifyMouseLeave@CTopLevelWindow@@QEAAXXZ @ 0x180010224 (-NotifyMouseLeave@CTopLevelWindow@@QEAAXXZ.c)
