/*
 * XREFs of ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x18009DCB4
 * Callers:
 *     ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x18009A364 (--0ResultException@wil@@QEAA@AEBV01@@Z.c)
