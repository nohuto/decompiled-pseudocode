/*
 * XREFs of ?CheckDXGIAdapter@CGraphicsDeviceManager@@IEAAJPEA_N@Z @ 0x180028C18
 * Callers:
    ...
    if ( v6 >= 0 )
    {
      ...
      if ( v8 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
          ...
          v17);
        wil::com_ptr_t<Windows::UI::Composition::ICompositor,wil::err_returncode_policy>::~com_ptr_t<Windows::UI::Composition::ICompositor,wil::err_returncode_policy>((__int64 *)&ppFactory);
        goto LABEL_12;
      }
      v20 = 0LL;
      v9 = *(_QWORD *)ppFactory;
