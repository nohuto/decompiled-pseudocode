/*
 * XREFs of ?_RemoveInactiveVisuals@CProjectionBorderManager@@AEAAXXZ @ 0x1800D47B0
 * Callers:
...
void __fastcall CProjectionBorderManager::_RemoveInactiveVisuals(CProjectionBorderManager *this)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( (_BYTE)this )
    {
      ...
      {
        tlgWriteTransfer_EtwEventWriteTransfer(v4, byte_180127281, 0LL, 0LL, 2, (__int64)v5);
      }
    }
  }
}
