/*
 * XREFs of ??1?$deque@W4NodeType@JSONOutputArchive@cereal@@V?$allocator@W4NodeType@JSONOutputArchive@cereal@@@std@@@std@@QEAA@XZ @ 0x1800F0E14
 * Callers:
 *     ??1?$stack@IV?$deque@IV?$allocator@I@std@@@std@@@std@@QEAA@XZ @ 0x1800F0FA0 (--1-$stack@IV-$deque@IV-$allocator@I@std@@@std@@@std@@QEAA@XZ.c)
