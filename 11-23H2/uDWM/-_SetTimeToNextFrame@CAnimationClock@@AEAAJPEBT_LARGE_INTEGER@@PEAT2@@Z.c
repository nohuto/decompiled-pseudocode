/*
 * XREFs of ?_SetTimeToNextFrame@CAnimationClock@@AEAAJPEBT_LARGE_INTEGER@@PEAT2@@Z @ 0x1800137DC
 * Callers:
 ...
 * Callees:
 *     ?ResultFromKnownLastError@@YAJXZ @ 0x1800A9CA4 (-ResultFromKnownLastError@@YAJXZ.c)
 */
