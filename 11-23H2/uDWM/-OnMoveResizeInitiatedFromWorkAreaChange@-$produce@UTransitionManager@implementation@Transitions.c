/*
 * XREFs of ?OnMoveResizeInitiatedFromWorkAreaChange@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIAnimationsTransitionManager@Private@345@@impl@winrt@@UEAAH_K@Z @ 0x1800FDF80
 * Callers:
 *     <none>
 * Callees:
