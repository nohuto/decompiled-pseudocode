/*
 * XREFs of ?RunAcrylicSheetEndArrangementAnimation@CWindowList@@AEAAJXZ @ 0x180065E8C
 * Callers:
...
__int64 __fastcall CWindowList::RunAcrylicSheetEndArrangementAnimation(CWindowList *this, __int64 a2, __int64 a3)
{
  ...
  v4 = *((_QWORD *)this + 88);
  v5 = *((_QWORD *)this + 68);
  v10[0] = xmmword_1801212D8;
  v6 = ~*(_BYTE *)(v4 + 677) & 0x10;
  v11 = 0x3FF0000000000000LL;
  v10[1] = xmmword_1801212E8;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x204Bu, 0LL);
  }
  return v8;
}
