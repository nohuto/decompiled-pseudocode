/*
 * XREFs of __scrt_fastfail @ 0x18005D240
 * Callers:
 *     __scrt_initialize_onexit_tables @ 0x18005C9E8 (__scrt_initialize_onexit_tables.c)
 ...
 * Callees:
 *     __crt_debugger_hook @ 0x18005D230 (__crt_debugger_hook.c)
