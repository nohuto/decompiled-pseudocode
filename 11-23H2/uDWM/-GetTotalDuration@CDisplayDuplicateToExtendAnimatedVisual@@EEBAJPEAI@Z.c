/*
 * XREFs of ?GetTotalDuration@CDisplayDuplicateToExtendAnimatedVisual@@EEBAJPEAI@Z @ 0x1800B9950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDisplayDuplicateToExtendAnimatedVisual::GetTotalDuration(
