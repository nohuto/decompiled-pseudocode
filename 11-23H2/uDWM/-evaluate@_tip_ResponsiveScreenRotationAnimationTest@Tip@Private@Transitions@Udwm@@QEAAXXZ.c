/*
 * XREFs of ?evaluate@_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transitions@Udwm@@QEAAXXZ @ 0x1800F6844
 * Callers:
 *     ?evaluate@?$test_merged_data@U_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transitions@Udwm@@@details@tip@@EEAAXXZ @ 0x1800F6830 (-evaluate@-$test_merged_data@U_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transitions.c)
 * Callees:
 *     ?reason_string@details@tip@@YAPEBDPEBD@Z @ 0x1800F3228 (-reason_string@details@tip@@YAPEBDPEBD@Z.c)
 */
