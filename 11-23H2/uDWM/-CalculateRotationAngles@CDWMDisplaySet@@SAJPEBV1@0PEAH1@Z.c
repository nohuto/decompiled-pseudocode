/*
 * XREFs of ?CalculateRotationAngles@CDWMDisplaySet@@SAJPEBV1@0PEAH1@Z @ 0x1800BF6E0
 * Callers:
 ...
 *     ?DXGIRotationToInt@@YAHW4DXGI_MODE_ROTATION@@@Z @ 0x1800BF7F8 (-DXGIRotationToInt@@YAHW4DXGI_MODE_ROTATION@@@Z.c)
 */
        ...
        int *a4)
{
  ...
  {
    v9 = DXGIRotationToInt((enum DXGI_MODE_ROTATION)*(_DWORD *)(*(_QWORD *)v17 + 232LL));
    v10 = CDWMDisplaySet::GetClonePrimaryDisplaysNoRef((__int64)a2, (__int64)&v13);
    v8 = v10;
    if ( v10 >= 0 )
    {
      v11 = DXGIRotationToInt((enum DXGI_MODE_ROTATION)*(_DWORD *)(*(_QWORD *)v13 + 232LL));
      *a4 = v11;
      *a3 = v11 - v9;
    }
    else
