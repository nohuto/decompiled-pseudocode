/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCAnimationTriggerProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCAnimationTriggerProxy@@@Z @ 0x1800ADD94
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v6 = &CTransform3dGroupProxy::`vftable';
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle(v6, 1u, *(_QWORD *)(a1 + 24), a2, 0);
    v9 = v8;
    if ( v8 >= 0 )
    {
      *a3 = v7;
