/*
 * XREFs of ?ActivateLivePreview@CDesktopManager@@SAJPEAULivePreviewRequest@@@Z @ 0x18001D564
 * Callers:
...
__int64 __fastcall CDesktopManager::ActivateLivePreview(struct LivePreviewRequest *a1)
{
  ...
  if ( *(_DWORD *)a1 )
  {
    ...
    v5 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0xB35u, 0LL);
  }
  else
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0xB39u, 0LL);
  }
