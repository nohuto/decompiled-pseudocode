/*
 * XREFs of ?_Insert_node@?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBUhstring@winrt@@N@std@@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CBUhstring@winrt@@N@std@@PEAX@2@U?$_Tree_id@PEAU?$_Tree_node@U?$pair@$$CBUhstring@winrt@@N@std@@PEAX@std@@@2@QEAU32@@Z @ 0x1800B8554
 * Callers:
...
__int64 __fastcall std::_Tree_val<std::_Tree_simple_types<std::pair<winrt::hstring const,double>>>::_Insert_node(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
