/*
 * XREFs of ??$from_com_ref@AEBUScreenRotationResponsiveTransitionHandler@Private@Transitions@Udwm@winrt@@@?$weak_ref@UScreenRotationResponsiveTransitionHandler@Private@Transitions@Udwm@winrt@@@winrt@@AEAAXAEBUScreenRotationResponsiveTransitionHandler@Private@Transitions@Udwm@1@@Z @ 0x180104D78
 * Callers:
