/*
 * XREFs of ?seekpos@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@MEAA?AV?$fpos@U_Mbstatet@@@2@V32@H@Z @ 0x1800F35A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
unsigned __int64 *__fastcall std::stringbuf::seekpos(__int64 a1, unsigned __int64 *a2, _QWORD *a3, char a4)
{
  ...
  v12 = v11;
  if ( v5 > *(_QWORD *)(a1 + 104) - v11 || v5 && ((a4 & 1) != 0 && !v8 || (a4 & 2) != 0 && !v9) )
  {
    *a2 = -1LL;
  }
  else
