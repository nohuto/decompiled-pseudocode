/*
 * XREFs of ??$UpdateCaptureControllerCaptureState@AEAPEAUHWND__@@AEA_N@WindowFrameLoggingTelemetry@@SAXAEAPEAUHWND__@@AEA_N@Z @ 0x1800CF3C0
 * Callers:
        ...
        char *a2)
{
  ...
  if ( *(_DWORD *)v5 > 5u && (*(_QWORD *)(v5 + 16) & 0x200000000000LL) != 0 )
  {
    ...
    if ( result == *(_QWORD *)(v5 + 24) )
    {
      ...
      v14 = 1;
      v11 = 8;
      return tlgWriteTransfer_EtwEventWriteTransfer(v5, byte_1801267CA, 0LL, 0LL, 4, (__int64)v9);
    }
  }
  return result;
}
