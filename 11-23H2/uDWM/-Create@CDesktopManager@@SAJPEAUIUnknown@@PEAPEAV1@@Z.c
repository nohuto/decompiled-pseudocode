/*
 * XREFs of ?Create@CDesktopManager@@SAJPEAUIUnknown@@PEAPEAV1@@Z @ 0x180025D74
 * Callers:
...
__int64 __fastcall CDesktopManager::Create(struct IUnknown *a1, struct CDesktopManager **a2)
{
  ...
  if ( v4 )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, v5, 0x6BEu, 0LL);
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, -2147024882, 0x6BAu, 0LL);
  }
