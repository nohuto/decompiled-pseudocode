/*
 * XREFs of ?StartVirtualMonitorCapture@CProjectionBorderManager@@UEAAJPEAUHMONITOR__@@PEAXAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x1800D13B0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v19 )
  {
            ...
            *(_QWORD *)a4) )
    {
      ...
      if ( v14 >= 0 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopRootVisual, 0x260u);
      }
      else
      {
