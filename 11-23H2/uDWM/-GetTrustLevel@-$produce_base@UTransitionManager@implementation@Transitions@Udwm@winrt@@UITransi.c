/*
 * XREFs of ?GetTrustLevel@?$produce_base@UTransitionManager@implementation@Transitions@Udwm@winrt@@UITransitionManager@345@X@impl@winrt@@UEAAHPEAW4TrustLevel@Foundation@Windows@3@@Z @ 0x1800FD760
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall winrt::impl::produce_base<winrt::Udwm::Transitions::implementation::TransitionManager,winrt::Udwm::Transitions::ITransitionManager,void>::GetTrustLevel(
        __int64 a1)
{
  __int64 v1; // rax
