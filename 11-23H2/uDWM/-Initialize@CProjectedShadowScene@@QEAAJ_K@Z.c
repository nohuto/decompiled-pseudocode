/*
 * XREFs of ?Initialize@CProjectedShadowScene@@QEAAJ_K@Z @ 0x1800CE898
 * Callers:
 ...
 *     ??0CProjectedShadowSceneInstance@CProjectedShadowScene@@QEAA@XZ @ 0x1800CDC7C (--0CProjectedShadowSceneInstance@CProjectedShadowScene@@QEAA@XZ.c)
