/*
 * XREFs of ?CreateTextLayout@CDWriteText@@AEAAJXZ @ 0x1800312A0
 * Callers:
...
__int64 __fastcall CDWriteText::CreateTextLayout(CDWriteText *this)
{
  ...
  __int64 v20[2]; // [rsp+40h] [rbp-48h] BYREF
...
LABEL_22:
  ...
  v14 = *v13;
  v20[0] = 0LL;
  v15 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, __int64 *))(v14 + 160))(v13, *((_QWORD *)this + 35), v20);
  TextFormat = v15;
  if ( v15 < 0 )
  {
    v18 = 346LL;
  ...
  v21 = 1;
  v22 = 0LL;
  v15 = (*(__int64 (__fastcall **)(_QWORD, int *, __int64))(*(_QWORD *)*v8 + 72LL))(*v8, &v21, v20[0]);
  TextFormat = v15;
  if ( v15 < 0 )
  {
    v18 = 348LL;
