/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_DeviceGenericFailureCDesktopManagerException@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18005EE38
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_DeviceGenericFailureCDesktopManagerException@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18005EF4C (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_DeviceGeneric.c)
 */

// Hidden C++ exception states: #wind=1
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_DeviceGenericFailureCDesktopManagerException>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_DeviceGenericFailureCDesktopManagerException>::GetCurrentFeatureEnabledState(
      a1,
      &v13,
      &v12);
    for ( i = *a2; ; i = v8 )
