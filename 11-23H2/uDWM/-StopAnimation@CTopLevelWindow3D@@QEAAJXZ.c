/*
 * XREFs of ?StopAnimation@CTopLevelWindow3D@@QEAAJXZ @ 0x18004C100
 * Callers:
...
__int64 __fastcall CTopLevelWindow3D::StopAnimation(CTopLevelWindow3D *this, __int64 a2, __int64 a3)
{
  ...
  GUID v55; // [rsp+B0h] [rbp-E8h] BYREF
  ...
  if ( v5 )
  {
    ...
    if ( v43 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v43, 0x848u, 0LL);
  ...
  {
    *((_BYTE *)this + 299) = 0;
    winrt::Udwm::Transitions::implementation::TransitionManager::GetCurrent((winrt::Udwm::Transitions::implementation::TransitionManager *)v48);
    v44 = v48[0];
  ...
  if ( *((_QWORD *)this + 47) )
  {
    ...
    wil::com_ptr_t<IDCompositionAnimationStats,wil::err_returncode_policy>::reset((__int64 *)this + 47);
  }
  v23 = *((_QWORD *)this + 49);
  if ( v23 )
  {
...
LABEL_5:
  ...
  *((_BYTE *)this + 616) = 0;
  ...
  if ( (v12 & 4) != 0 )
  {
    ...
    v6 = v42;
    if ( v42 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v42, 0x8B4u, 0LL);
  }
  else
  {
    v13 = v12 & 1;
      ...
      || !CLivePreview::_IsInLivePreview(v16, (const struct CWindowData *)v11) )
    {
      ...
      if ( v14 )
      {
        ...
        if ( v6 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x8AFu, 0LL);
      }
    }
  }
  return (unsigned int)v6;
