/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCCaptureControllerProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCCaptureControllerProxy@@@Z @ 0x1800ADECC
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v6 = &CTransform3dGroupProxy::`vftable';
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle(v6, 6u, *(_QWORD *)(a1 + 24), a2, 0);
    v9 = v8;
    if ( v8 >= 0 )
    {
      *a3 = v7;
