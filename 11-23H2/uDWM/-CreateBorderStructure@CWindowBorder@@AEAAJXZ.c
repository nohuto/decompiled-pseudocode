/*
 * XREFs of ?CreateBorderStructure@CWindowBorder@@AEAAJXZ @ 0x1800325B4
 * Callers:
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      else
      {
        ...
        Microsoft::WRL::ComPtr<IDCompositionTarget>::InternalRelease((__int64 *)&v52);
        v11 = v13(v12, &v52);
        v3 = v11;
        if ( v11 >= 0 )
        {
...
LABEL_19:
                          ...
                          if ( inserted >= 0 )
                          {
                            ...
                            *((_QWORD *)this + 31) = v30;
                            Microsoft::WRL::ComPtr<CVisualSurfaceProxy>::InternalRelease((CBaseObject **)v55);
