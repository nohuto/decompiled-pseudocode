/*
 * XREFs of ?CreateNCButtons@CTopLevelWindow@@CAJQEAXPEAUWindowFrame@1@1@Z @ 0x1800535B8
 * Callers:
        ...
        struct CTopLevelWindow::WindowFrame *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( ThemeMargins < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ThemeMargins, 0x41Cu, 0LL);
      return v3;
    }
    if ( *(_DWORD *)(v9 + 24) )
    {
...
LABEL_9:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x41Bu, 0LL);
  return v3;
}
