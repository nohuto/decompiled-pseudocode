/*
 * XREFs of ??1CAPTURE_TAB_GROUP_MAP_ENTRY@CProjectionBorderManager@@QEAA@XZ @ 0x1800B3684
 * Callers:
 *     _CProjectionBorderManager::_AddTabGroupCaptureEntry_::_1_::dtor$2 @ 0x1800D3E49 (_CProjectionBorderManager--_AddTabGroupCaptureEntry_--_1_--dtor$2.c)
 * Callees:
