/*
 * XREFs of ?Create@CDWMDXGIEnumeration@@SAJPEAPEAV1@@Z @ 0x1800290F4
 * Callers:
...
__int64 __fastcall CDWMDXGIEnumeration::Create(struct CDWMDXGIEnumeration **a1)
{
  ...
  if ( v2 )
  {
    ...
    *(_DWORD *)(v2 + 80) = 0;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7F0, 1u, inited, 0x3Cu, 0LL);
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7F0, 1u, -2147024882, 0x38u, 0LL);
  }
  return v5;
}
