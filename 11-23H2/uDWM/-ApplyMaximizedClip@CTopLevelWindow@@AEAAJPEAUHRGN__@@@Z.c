/*
 * XREFs of ?ApplyMaximizedClip@CTopLevelWindow@@AEAAJPEAUHRGN__@@@Z @ 0x180034FBC
 * Callers:
...
__int64 __fastcall CTopLevelWindow::ApplyMaximizedClip(CTopLevelWindow *this, HRGN a2)
{
  ...
  if ( (*((_BYTE *)this + 248) & 4) != 0 )
  {
    ...
    v14.left = *((_DWORD *)this + 169);
    v14.top = v5;
    if ( v14.left > left )
      left = v14.left;
    v14.right = left;
    v7 = *((_DWORD *)this + 33) - *((_DWORD *)this + 172);
    if ( v5 > v7 )
      v7 = v5;
    v14.bottom = v7;
    SetLastError(0);
    ...
    if ( v8 )
    {
      ...
      if ( !CombineRgn(a2, a2, v8, 1) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9A8, 0xAu, v2, 0x131Fu, 0LL);
      }
      DeleteObject(v8);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9A8, 0xAu, v2, 0x131Du, 0LL);
    }
  }
