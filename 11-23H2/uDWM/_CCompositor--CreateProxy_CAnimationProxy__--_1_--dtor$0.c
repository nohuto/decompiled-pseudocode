/*
 * XREFs of _CCompositor::CreateProxy_CAnimationProxy__::_1_::dtor$0 @ 0x1800ACF9B
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CCompositor::CreateProxy_CAnimationProxy__::_1_::dtor_0(__int64 a1, __int64 a2)
{
