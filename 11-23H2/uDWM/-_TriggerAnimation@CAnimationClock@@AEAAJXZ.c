/*
 * XREFs of ?_TriggerAnimation@CAnimationClock@@AEAAJXZ @ 0x18001361C
 * Callers:
...
__int64 __fastcall CAnimationClock::_TriggerAnimation(CAnimationClock *this)
{
  ...
  __int64 v9[40]; // [rsp+48h] [rbp-C0h] BYREF
  ...
  v9[0] = (__int64)&AnimationClockLoggingTelemetry::TriggerClock::`vftable';
  *(_OWORD *)&hObject[1] = *(_OWORD *)((char *)this + 120);
  ...
  wil::ActivityBase<AnimationClockLogging,0,0,4,0,_TlgReflectorTag_Param0IsProviderType>::Stop(v9, v2);
LABEL_4:
