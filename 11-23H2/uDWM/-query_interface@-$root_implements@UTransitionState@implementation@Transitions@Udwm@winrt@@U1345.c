/*
 * XREFs of ?query_interface@?$root_implements@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@UITransitionStateNative@34@UITransitionStateNativePrivate@34@@impl@winrt@@AEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800FFC7C
 * Callers:
 *     ?QueryInterface@?$implements@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@UITransitionStateNative@34@UITransitionStateNativePrivate@34@@winrt@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FE570 (-QueryInterface@-$implements@UTransitionState@implementation@Transitions@Udwm@winrt_ea_1800FE570.c)
 * Callees:
...
__int64 __fastcall winrt::impl::root_implements<winrt::Udwm::Transitions::implementation::TransitionState,winrt::Udwm::Transitions::TransitionState,Udwm::Transitions::ITransitionStateNative,Udwm::Transitions::ITransitionStateNativePrivate>::query_interface(
        __int64 a1,
        _QWORD *a2,
        __int64 *a3)
{
  ...
  *a3 = v6;
  ...
  else
  {
    ...
    if ( v10 )
    {
      ...
      if ( !v12 )
      {
        v13 = (*(__int64 (__fastcall **)(volatile signed __int64 *))(*v3 + 24))(v3);
    ...
    else
    {
      *a3 = (*(__int64 (__fastcall **)(volatile signed __int64 *))(*v3 + 24))(v3);
      ...
      while ( v7 >= 0 )
      {
        v11 = _InterlockedCompareExchange64(v3 + 1, v7 + 1, v7);
        v8 = v7 == v11;
        v7 = v11;
        if ( v8 )
          return 0LL;
