/*
 * XREFs of ??1?$set@PEAVCWindowData@@U?$less@PEAVCWindowData@@@std@@V?$allocator@PEAVCWindowData@@@3@@std@@QEAA@XZ @ 0x1800B6FA8
 * Callers:
 *     _CDisplayAnimatedVisual::CDisplayAnimatedVisual_::_1_::dtor$2 @ 0x1800674A3 (_CDisplayAnimatedVisual--CDisplayAnimatedVisual_--_1_--dtor$2.c)
 * Callees:
