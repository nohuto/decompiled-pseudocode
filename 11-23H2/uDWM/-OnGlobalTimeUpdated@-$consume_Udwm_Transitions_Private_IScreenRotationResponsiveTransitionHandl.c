/*
 * XREFs of ?OnGlobalTimeUpdated@?$consume_Udwm_Transitions_Private_IScreenRotationResponsiveTransitionHandler@UScreenRotationResponsiveTransitionHandler@Private@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@XZ @ 0x180104FC4
 * Callers:
