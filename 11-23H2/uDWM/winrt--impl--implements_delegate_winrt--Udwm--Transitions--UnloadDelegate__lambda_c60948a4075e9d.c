/*
 * XREFs of winrt::impl::implements_delegate_winrt::Udwm::Transitions::UnloadDelegate__lambda_c60948a4075e9d25cd4406f3dd63722d___::QueryInterface @ 0x1800F9940
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall winrt::impl::implements_delegate_winrt::Udwm::Transitions::UnloadDelegate__lambda_c60948a4075e9d25cd4406f3dd63722d___::QueryInterface(
        __int64 a1,
        _QWORD *a2,
        __int64 *a3)
{
  ...
  v3 = *a2 - winrt::impl::guid_v<winrt::Udwm::Transitions::UnloadDelegate>;
  if ( *a2 == winrt::impl::guid_v<winrt::Udwm::Transitions::UnloadDelegate> )
    v3 = a2[1] - 0x59100A668649A09ALL;
  if ( !v3 )
    goto LABEL_15;
