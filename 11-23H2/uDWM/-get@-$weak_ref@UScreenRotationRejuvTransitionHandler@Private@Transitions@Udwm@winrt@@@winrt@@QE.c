/*
 * XREFs of ?get@?$weak_ref@UScreenRotationRejuvTransitionHandler@Private@Transitions@Udwm@winrt@@@winrt@@QEBA@XZ @ 0x180105280
 * Callers:
...
_QWORD *__fastcall winrt::weak_ref<winrt::Udwm::Transitions::Private::ScreenRotationRejuvTransitionHandler>::get(
        __int64 *a1,
        _QWORD *a2)
{
  __int64 v2; // rcx
