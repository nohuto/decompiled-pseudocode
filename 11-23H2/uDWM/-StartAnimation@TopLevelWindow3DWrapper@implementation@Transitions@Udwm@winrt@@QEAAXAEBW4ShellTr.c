/*
 * XREFs of ?StartAnimation@TopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@QEAAXAEBW4ShellTransition@345@AEBURect@Foundation@Windows@5@@Z @ 0x1800FB030
 * Callers:
 *     ?StartAnimation@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHHURect@Foundation@Windows@3@@Z @ 0x1800FAFD0 (-StartAnimation@-$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopL.c)
 * Callees:
...
void __fastcall winrt::Udwm::Transitions::implementation::TopLevelWindow3DWrapper::StartAnimation(
        ...
        const enum winrt::Udwm::Transitions::ShellTransition *a2,
        const struct winrt::Windows::Foundation::Rect *a3)
{
  ...
  started = CTopLevelWindow3D::StartAnimationForMaximizeSnapTransition(v5, v10, v12);
  if ( started < 0 )
  ...
  CTopLevelWindow::SetSuppressBorderUpdates(
    *(CTopLevelWindow **)(*(_QWORD *)(*((_QWORD *)this + 4) + 336LL) + 440LL),
    0);
}
