/*
 * XREFs of ?GetCVIFromCache@CDesktopManager@@SAJHHPEAPEAVCCachedVisualImageProxy@@@Z @ 0x180054F98
 * Callers:
...
__int64 __fastcall CDesktopManager::GetCVIFromCache(int a1, int a2, struct CCachedVisualImageProxy **a3)
{
  ...
  v3 = 0LL;
  v4 = (_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 712);
  v6 = -2147467259;
  while ( !*v4 )
  {
  ...
  if ( CDesktopManager::_IsSameAsTargetCachedCVI(a1, a2) )
  {
    ...
    *a3 = (struct CCachedVisualImageProxy *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + v3 + 89);
    *((_QWORD *)v8 + v3 + 89) = 0LL;
    return 0;
  }
  return v6;
