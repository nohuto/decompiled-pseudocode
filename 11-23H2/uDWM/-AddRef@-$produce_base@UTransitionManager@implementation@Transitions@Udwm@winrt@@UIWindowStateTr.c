/*
 * XREFs of ?AddRef@?$produce_base@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIWindowStateTransitionManager@Private@345@X@impl@winrt@@UEAAIXZ @ 0x1800FCEE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
