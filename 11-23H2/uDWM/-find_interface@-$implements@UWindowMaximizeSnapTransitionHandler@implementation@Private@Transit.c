/*
 * XREFs of ?find_interface@?$implements@UWindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@U13456@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x1800F8390
 * Callers:
 *     <none>
 * Callees:
 *     <none>
