/*
 * XREFs of McTemplateU0ddddddddddffffqqq_EtwEventWriteTransfer @ 0x18001F340
 * Callers:
 *     ?_LogVisualBeginAndEndValues@CAnimatedTransitionVisual@@IEAAXI@Z @ 0x18001F250 (-_LogVisualBeginAndEndValues@CAnimatedTransitionVisual@@IEAAXI@Z.c)
 * Callees:
 *     McGenEventWrite_EtwEventWriteTransfer @ 0x18003CC40 (McGenEventWrite_EtwEventWriteTransfer.c)
 *     __security_check_cookie @ 0x18005C640 (__security_check_cookie.c)
 */

__int64 __fastcall McTemplateU0ddddddddddffffqqq_EtwEventWriteTransfer(
        __int64 a1,
        __int64 a2,
        int a3,
        int a4,
        ...
        char a19)
{
  ...
  return McGenEventWrite_EtwEventWriteTransfer(
           ...
           (unsigned int)&UdwmAnimatedTransitionVisual_Info,
           a3,
           18,
           (__int64)v20);
}
