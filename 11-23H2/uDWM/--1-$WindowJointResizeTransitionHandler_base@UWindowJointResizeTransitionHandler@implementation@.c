/*
 * XREFs of ??1?$WindowJointResizeTransitionHandler_base@UWindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UIBitmapManager@45@@implementation@Private@Transitions@Udwm@winrt@@UEAA@XZ @ 0x1800F8B74
 * Callers:
 *     _winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransitionHandler::WindowJointResizeTransitionHandler_::_1_::dtor$0 @ 0x180067362 (_winrt--Udwm--Transitions--Private--implementation--WindowJointResizeTransitionHandler--WindowJo.c)
 * Callees:
