/*
 * XREFs of ?GetSize@CBitmapLock@@UEAAJPEAI0@Z @ 0x18005B970
 * Callers:
 *     ?GetSize@CBitmapLock@@W7EAAJPEAI0@Z @ 0x180066A80 (-GetSize@CBitmapLock@@W7EAAJPEAI0@Z.c)
 * Callees:
...
__int64 __fastcall CBitmapLock::GetSize(CBitmapLock *this, unsigned int *a2, unsigned int *a3)
{
  ...
  if ( a2 )
  {
    if ( a3 )
    {
      ...
      {
        v7 = -2003292412;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292412, 0x7Du, 0LL);
      }
    }
    else
    {
  ...
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x7Au, 0LL);
  }
