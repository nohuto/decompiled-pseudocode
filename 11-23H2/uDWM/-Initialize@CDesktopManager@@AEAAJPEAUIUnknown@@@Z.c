/*
 * XREFs of ?Initialize@CDesktopManager@@AEAAJPEAUIUnknown@@@Z @ 0x1800264FC
 * Callers:
 ...
 *     ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1?RegCloseKey@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x180025D34 (--1-$unique_any_t@V-$unique_storage@U-$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1-RegCloseKey@@Y.c)
 *     ??0CAnimationClockCoordinator@@QEAA@XZ @ 0x180027058 (--0CAnimationClockCoordinator@@QEAA@XZ.c)
 *     ??0CTransitionVisualController@@QEAA@XZ @ 0x1800270A0 (--0CTransitionVisualController@@QEAA@XZ.c)
 *     ??0CProjectionBorderManager@@QEAA@XZ @ 0x18002712C (--0CProjectionBorderManager@@QEAA@XZ.c)
 *     ??0CContactManager@@QEAA@XZ @ 0x1800271D0 (--0CContactManager@@QEAA@XZ.c)
 *     ??0CWindowList@@QEAA@XZ @ 0x1800272D4 (--0CWindowList@@QEAA@XZ.c)
 ...
 *     ?_InitializeWnf@CDesktopManager@@AEAAJXZ @ 0x180027CEC (-_InitializeWnf@CDesktopManager@@AEAAJXZ.c)
...
__int64 __fastcall CDesktopManager::Initialize(CDesktopManager *this, struct IUnknown *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, v4, 0x15Au, 0LL);
    goto LABEL_133;
  }
  *((_BYTE *)this + 20) = 0;
  *((_BYTE *)this + 24) = 0;
      ...
      *((_QWORD *)this + 7) = 0LL;
      ...
      if ( Factory >= 0 )
      {
        ...
        *((_QWORD *)this + 26) = v30;
        ...
        {
          v5 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, -2147024882, 0x1BFu, 0LL);
          goto LABEL_129;
        }
        ...
        if ( Factory >= 0 )
        {
          ...
          *((_QWORD *)this + 29) = v31;
          ...
          {
            v5 = -2147024882;
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, -2147024882, 0x1C3u, 0LL);
            goto LABEL_129;
          }
          ...
          if ( Factory >= 0 )
          {
            ...
            *((_QWORD *)this + 30) = v32;
            ...
            {
              v5 = -2147024882;
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, -2147024882, 0x1C7u, 0LL);
              goto LABEL_129;
            }
                  ...
                  if ( Factory >= 0 )
                  {
                    ...
                    if ( Factory >= 0 )
                    {
                      ...
                      *((_QWORD *)this + 58) = v35;
                      ...
                      {
                        v5 = -2147024882;
                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, -2147024882, 0x1EEu, 0LL);
                        goto LABEL_129;
                      }
...
LABEL_132:
                      ...
                      v39 = v5;
LABEL_128:
                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, v39, phkResulta, 0LL);
LABEL_129:
...
LABEL_20:
  ...
  v5 = -2147024882;
LABEL_21:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7AC, 1u, v14, phkResult, 0LL);
LABEL_133:
  if ( v47 )
  {
