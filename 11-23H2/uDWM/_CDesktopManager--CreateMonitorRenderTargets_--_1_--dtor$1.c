/*
 * XREFs of _CDesktopManager::CreateMonitorRenderTargets_::_1_::dtor$1 @ 0x180067899
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
int __fastcall CDesktopManager::CreateMonitorRenderTargets_::_1_::dtor_1(__int64 a1, __int64 a2)
{
