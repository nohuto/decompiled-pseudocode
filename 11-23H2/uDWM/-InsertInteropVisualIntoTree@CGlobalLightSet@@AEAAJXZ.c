/*
 * XREFs of ?InsertInteropVisualIntoTree@CGlobalLightSet@@AEAAJXZ @ 0x18002D1A0
 * Callers:
...
__int64 __fastcall CGlobalLightSet::InsertInteropVisualIntoTree(CGlobalLightSet *this)
{
  ...
  if ( *((struct CVisual **)v4 + 3) == RenderTargetRootVisualForDesktop )
  {
    ...
    else
    {
      ...
      {
        inserted = VisualCollection::InsertRelative((VisualCollection *)(*((_QWORD *)this + 13) + 32LL), v4, 0LL, 0, v8);
        if ( inserted >= 0 )
          return 0LL;
        v7 = 288LL;
      }
