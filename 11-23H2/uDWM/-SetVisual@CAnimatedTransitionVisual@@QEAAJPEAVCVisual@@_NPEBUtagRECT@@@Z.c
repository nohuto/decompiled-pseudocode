/*
 * XREFs of ?SetVisual@CAnimatedTransitionVisual@@QEAAJPEAVCVisual@@_NPEBUtagRECT@@@Z @ 0x180055AB4
 * Callers:
...
LABEL_8:
  ...
  CTransitionVisualController::GetMonitorRectFromRectImpl(0LL, &v30);
  *(float *)&v27 = (float)v30.left;
  *((float *)&v27 + 1) = (float)v30.top;
  right = (float)v30.right;
  bottom = (float)v30.bottom;
LABEL_9:
  v20 = this[73];
  v30 = 0LL;
  v21 = CCachedVisualImageProxy::Update(v20, &v27, &v30, 0LL);
  v9 = v21;
  if ( v21 < 0 )
  {
