/*
 * XREFs of ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x18001F70C
 * Callers:
 *     ?construct@?$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAAXXZ @ 0x18001F748 (-construct@-$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAA.c)
