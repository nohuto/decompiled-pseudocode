/*
 * XREFs of ??$make@UWindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@$$V@winrt@@YA?A_PXZ @ 0x18001CBE0
 * Callers:
 *     ?Initialize@CWindowList@@QEAAJXZ @ 0x18002E66C (-Initialize@CWindowList@@QEAAJXZ.c)
 * Callees:
 *     ??0WindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@QEAA@XZ @ 0x18001CF38 (--0WindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@QEAA@XZ.c)
