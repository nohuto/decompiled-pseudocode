/*
 * XREFs of ?HasNonTrivialRepresentation@CWindowData@@QEBA_NXZ @ 0x1800360A4
 * Callers:
 ...
 * Callees:
 *     ?IsSplashScreen@CWindowData@@QEBA_NXZ @ 0x18000A6C8 (-IsSplashScreen@CWindowData@@QEBA_NXZ.c)
