/*
 * XREFs of ?ProcessTouchContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x1800B14D4
 * Callers:
 ...
 *     ?CheckShowContact@CContactManager@@AEAA_NW4DWM_SHOWCONTACT@@0@Z @ 0x18006BE96 (-CheckShowContact@CContactManager@@AEAA_NW4DWM_SHOWCONTACT@@0@Z.c)
 *     ?IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ @ 0x18006C86A (-IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ.c)
 *     ?NotifyTouchDrag@CTouchDragVisual@@QEAAJPEBUtagPOINT@@@Z @ 0x18006DE68 (-NotifyTouchDrag@CTouchDragVisual@@QEAAJPEBUtagPOINT@@@Z.c)
 *     ?UpdateShowContact@CTouchDragVisual@@QEAAXW4DWM_SHOWCONTACT@@@Z @ 0x18006E322 (-UpdateShowContact@CTouchDragVisual@@QEAAXW4DWM_SHOWCONTACT@@@Z.c)
 ...
 *     ?IsOKToCleanup@CPressTapVisual@@UEAA_NXZ @ 0x1800AFD80 (-IsOKToCleanup@CPressTapVisual@@UEAA_NXZ.c)
 ...
 *     ?IsHolding@CTouchPressHoldVisual@@QEAA_NXZ @ 0x1800E8734 (-IsHolding@CTouchPressHoldVisual@@QEAA_NXZ.c)
