/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_3_1_dll @ 0x18005DCB5
 * Callers:
 *     __imp_load_GetSystemMetricsForDpi @ 0x18005DCA9 (__imp_load_GetSystemMetricsForDpi.c)
 * Callees:
