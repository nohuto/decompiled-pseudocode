/*
 * XREFs of _winrt::impl::produce_winrt::Udwm::Transitions::Private::implementation::ScreenRotationResponsiveTransitionHandler_winrt::Udwm::Transitions::ITransitionHandler_::Cancel_::_1_::catch$1 @ 0x180067A1C
 * Callers:
 *     <none>
 * Callees:
