/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCWindowData@@@?$vector@PEAVCWindowData@@V?$allocator@PEAVCWindowData@@@std@@@std@@QEAAPEAPEAVCWindowData@@QEAPEAV2@AEBQEAV2@@Z @ 0x1800C5EA4
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCWindowData@@V?$allocator@PEAVCWindowData@@@std@@@std@@AEAAXQEAPEAVCWindowData@@_K1@Z @ 0x1800C73B0 (-_Change_array@-$vector@PEAVCWindowData@@V-$allocator@PEAVCWindowData@@@std@@@std@@AEAAXQEAPEAVC.c)
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<CWindowData *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
