/*
 * XREFs of ?OnSizeChanged@CThumbnailVisual@@UEAAXPEBVCSecondaryWindowRepresentation@@@Z @ 0x18000E0A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CSecondaryWindowRepresentation *a2)
{
  ...
  CThumbnailVisual::SetDirtyFlags((CThumbnailVisual *)((char *)this - 368), 0x4000);
  v3 = *((_QWORD *)this + 1);
