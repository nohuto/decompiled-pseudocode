/*
 * XREFs of ?StartThemeAnimation@CInputView_SizeOrModeChangeBase@@AEAAJPEAVCWindowData@@@Z @ 0x1800DC1CC
 * Callers:
        ...
        struct CWindowData *a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(CInputView_SizeOrModeChangeBase *, _QWORD))(*(_QWORD *)this + 112LL))(
         this,
         *((unsigned int *)a2 + 170));
  v5 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v4, 0LL, 0LL, -1, 1, &v15);
  v6 = v5;
  if ( v5 >= 0 )
  {
