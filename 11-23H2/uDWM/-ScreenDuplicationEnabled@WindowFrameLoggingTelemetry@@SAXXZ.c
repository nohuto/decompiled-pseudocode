/*
 * XREFs of ?ScreenDuplicationEnabled@WindowFrameLoggingTelemetry@@SAXXZ @ 0x1800D0AF0
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationEnabled(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EtwEventWriteTransfer(v1, byte_1801272AA, 0LL, 0LL, 2, (__int64)v2);
  }
}
