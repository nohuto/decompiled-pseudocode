/*
 * XREFs of ?Release@?$implements@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@U1345@UITransitionAnimationVisualNative@34@@winrt@@UEAAKXZ @ 0x1800EDB90
 * Callers:
 *     <none>
 * Callees:
