/*
 * XREFs of ?UpdateTransition@CIndirectTouchVisual@@MEAAJXZ @ 0x1800C5A30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StopOpacityTimeline@CIndirectTouchVisual@@IEAAXXZ @ 0x1800C58EC (-StopOpacityTimeline@CIndirectTouchVisual@@IEAAXXZ.c)
