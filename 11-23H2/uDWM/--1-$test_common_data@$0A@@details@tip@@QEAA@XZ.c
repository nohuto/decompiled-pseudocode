/*
 * XREFs of ??1?$test_common_data@$0A@@details@tip@@QEAA@XZ @ 0x1800F0FAC
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@V?$test_merged_data@U_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transitions@Udwm@@@details@tip@@@std@@EEAAXXZ @ 0x1800F6790 (-_Destroy@-$_Ref_count_obj2@V-$test_merged_data@U_tip_ResponsiveScreenRotationAnimationTest@Tip@.c)
 * Callees:
