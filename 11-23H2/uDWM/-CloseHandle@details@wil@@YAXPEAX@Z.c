/*
 * XREFs of ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x1800219A8
 * Callers:
 ...
 *     ??1?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x18009A504 (--1-$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAA@XZ.c)
