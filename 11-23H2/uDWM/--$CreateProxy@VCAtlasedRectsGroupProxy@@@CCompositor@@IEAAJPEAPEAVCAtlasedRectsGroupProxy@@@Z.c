/*
 * XREFs of ??$CreateProxy@VCAtlasedRectsGroupProxy@@@CCompositor@@IEAAJPEAPEAVCAtlasedRectsGroupProxy@@@Z @ 0x180038B90
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CAtlasedRectsGroupProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  ...
  *(_QWORD *)(v8 + 16) = 0LL;
  *(_QWORD *)(v8 + 16) = v7;
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v7 + 88LL))(v7, 2LL, v8 + 24);
  if ( v10 < 0 )
  {
    v12 = 68;
LABEL_12:
