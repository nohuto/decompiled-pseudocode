/*
 * XREFs of ?find_interface@?$implements@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@U1345@UIUserResizeVisualNative@34@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x180103B00
 * Callers:
 *     <none>
 * Callees:
 *     <none>
