/*
 * XREFs of ?ContentProtectionChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180109350
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v13 )
    {
      ...
      if ( ((v9 & 0x20) != 0) != v7 || ((v9 & 0x40) != 0) != v8 )
      {
        *((_BYTE *)v6 + 675) = v9 ^ (v9 ^ (32 * v7)) & 0x20 ^ (v9 ^ (v9 ^ (32 * v7)) & 0x20 ^ (v8 << 6)) & 0x40;
        ...
        v5 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x1712u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x16FEu);
  }
