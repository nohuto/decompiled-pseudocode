/*
 * XREFs of ?OnGlobalTimeUpdated@?$consume_Udwm_Transitions_Private_IScreenRotationRejuvTransitionHandler@UScreenRotationRejuvTransitionHandler@Private@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@XZ @ 0x180104F30
 * Callers:
...
void __fastcall winrt::impl::consume_Udwm_Transitions_Private_IScreenRotationRejuvTransitionHandler<winrt::Udwm::Transitions::Private::ScreenRotationRejuvTransitionHandler>::OnGlobalTimeUpdated(
        __int64 *a1)
{
  __int64 v1; // rcx
  __int64 v2; // rbx
  ...
  if ( v1 )
  {
    ...
    (**(void (__fastcall ***)(__int64, void *, __int64 *))v1)(
      v1,
      &winrt::impl::guid_v<winrt::Udwm::Transitions::Private::IScreenRotationRejuvTransitionHandler>,
      &v4);
    v1 = v4;
    v2 = v4;
  }
