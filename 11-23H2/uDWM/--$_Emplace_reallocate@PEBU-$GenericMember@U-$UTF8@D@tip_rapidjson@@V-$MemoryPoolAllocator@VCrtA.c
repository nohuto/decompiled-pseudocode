 ...
 *     ??$_Uninitialized_move@PEAVIterator@JSONInputArchive@cereal@@V?$allocator@VIterator@JSONInputArchive@cereal@@@std@@@std@@YAPEAVIterator@JSONInputArchive@cereal@@QEAV123@0PEAV123@AEAV?$allocator@VIterator@JSONInputArchive@cereal@@@0@@Z @ 0x1800EF8D4 (--$_Uninitialized_move@PEAVIterator@JSONInputArchive@cereal@@V-$allocator@VIterator@JSONInputArc.c)
 *     ?_Calculate_growth@?$vector@VIterator@JSONInputArchive@cereal@@V?$allocator@VIterator@JSONInputArchive@cereal@@@std@@@std@@AEBA_K_K@Z @ 0x1800F219C (-_Calculate_growth@-$vector@VIterator@JSONInputArchive@cereal@@V-$allocator@VIterator@JSONInputA.c)
 *     ?_Change_array@?$vector@VIterator@JSONInputArchive@cereal@@V?$allocator@VIterator@JSONInputArchive@cereal@@@std@@@std@@AEAAXQEAVIterator@JSONInputArchive@cereal@@_K1@Z @ 0x1800F22A8 (-_Change_array@-$vector@VIterator@JSONInputArchive@cereal@@V-$allocator@VIterator@JSONInputArchi.c)
