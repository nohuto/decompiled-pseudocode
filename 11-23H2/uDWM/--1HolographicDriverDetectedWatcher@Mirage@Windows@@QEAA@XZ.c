/*
 * XREFs of ??1HolographicDriverDetectedWatcher@Mirage@Windows@@QEAA@XZ @ 0x1800A4644
 * Callers:
 *     ??1CAnalogCompositorManager@@AEAA@XZ @ 0x18005C09C (--1CAnalogCompositorManager@@AEAA@XZ.c)
 *     _CAnalogCompositorManager::CAnalogCompositorManager_::_1_::dtor$1 @ 0x18006753A (_CAnalogCompositorManager--CAnalogCompositorManager_--_1_--dtor$1.c)
 * Callees:
 ...
 *     ?_FailFast_Win32@in1diag3@details@wil@@YAXPEAXIPEBDK@Z @ 0x1800A6088 (-_FailFast_Win32@in1diag3@details@wil@@YAXPEAXIPEBDK@Z.c)
 */
