/*
 * XREFs of ?OnCreateAnimationClock@CAnimationClockCoordinator@@QEAAJU_GUID@@K@Z @ 0x180013164
 * Callers:
 ...
 *     ?Remove@?$DynArray@PEAVCAnimationClock@@$0A@@@QEAAHAEBQEAVCAnimationClock@@@Z @ 0x1800AA358 (-Remove@-$DynArray@PEAVCAnimationClock@@$0A@@@QEAAHAEBQEAVCAnimationClock@@@Z.c)
 */
