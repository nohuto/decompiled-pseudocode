/*
 * XREFs of ?FallbackTelemetryCallback@WindowFrameLoggingTelemetry@@SAX_NAEBUFailureInfo@wil@@@Z @ 0x1800CC910
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall WindowFrameLoggingTelemetry::FallbackTelemetryCallback(char a1, const struct wil::FailureInfo *a2)
{
  ...
  if ( InitOnceBeginInitialize(&`WindowFrameLoggingTelemetry::Instance'::`2'::wrapper, 0, &v6, (LPVOID *)&v7) && v6 )
  {
    ...
    v7 = (wil::TraceLoggingProvider *)&qword_18014BD78;
    qword_18014BD78 = (__int64)&WindowFrameLogging::`vftable';
