/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x1800B4004
 * Callers:
  ...
  if ( CDesktopManager::s_pDesktopManagerInstance )
  {
    if ( a1 )
    {
      ...
      if ( !WindowInBand )
      {
        ...
        v13 = -2147024890;
LABEL_11:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180128C10, 2LL, v13, v12);
