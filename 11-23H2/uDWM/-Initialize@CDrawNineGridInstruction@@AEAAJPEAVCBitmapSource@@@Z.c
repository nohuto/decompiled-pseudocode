/*
 * XREFs of ?Initialize@CDrawNineGridInstruction@@AEAAJPEAVCBitmapSource@@@Z @ 0x1800517C8
 * Callers:
...
__int64 __fastcall CDrawNineGridInstruction::Initialize(struct _MARGINS *this, struct CBitmapSource *a2)
{
  ...
  for ( i = this + 3; ; i = (struct _MARGINS *)((char *)i + 8) )
  {
    ...
    ++this[7].cyTopHeight;
    v13 = CCompositor::CreateProxy<CImageLegacyMilBrushProxy>(*((_QWORD *)v12 + 6), (CBaseObject **)&this[3] + v3);
    v5 = v13;
    if ( v13 < 0 )
      break;
