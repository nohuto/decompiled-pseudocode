/*
 * XREFs of ?RecordUsageInternal@RawUsageIndex@details_abi@wil@@AEAA_NPEAX_K01I@Z @ 0x180002B18
 * Callers:
 ...
 * Callees:
 *     ?FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@PEAEPEAX_KI@Z @ 0x1800028E0 (-FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@.c)
 ...
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x180002F44 (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
...
LABEL_11:
    ...
    *((_QWORD *)&v46 + 1) = v49;
    ...
    v26 = v25 + Size;
    v27 = v23 - v24;
    if ( ((v23 - v24) & -(__int64)(v24 < v23)) >= v26 )
    {
      v28 = &v10[v26];
      v29 = v23 - v26 - (_QWORD)v10;
      v30 = v24 - (_QWORD)v10;
      if ( !v30 )
      {
LABEL_18:
        v31 = (unsigned __int8 *)(v26 + *((_QWORD *)this + 4));
        *((_QWORD *)this + 4) = v31;
        if ( v11 )
        {
          if ( v38 != v22 )
            wil::details_abi::UsageIndexProperty::UpdateCount((wil::details_abi::UsageIndexProperty *)&v37, v20 + 1);
        }
        else
        {
          wil::details_abi::UsageIndexProperty::Write((wil::details_abi::UsageIndexProperty *)&v37, &v36, v31);
        }
      ...
      if ( v28 && v10 )
      {
        if ( v29 >= v30 )
        {
          memmove_0(v28, v10, v30);
LABEL_17:
          v22 = 0;
          goto LABEL_18;
        }
        *(_DWORD *)_o__errno(v28, v27, v30, v29) = 34;
      }
      else
      {
        *(_DWORD *)_o__errno(v28, v27, v30, v29) = 22;
      }
