/*
 * XREFs of ?OnEndTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEAVCStoryboard@@@Z @ 0x180014650
 * Callers:
        ...
        struct CStoryboard *a3)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18012868C, 1u, v12, 0x132u, 0LL);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18012868C, 1u, v14, 0x135u, 0LL);
    }
LABEL_20:
