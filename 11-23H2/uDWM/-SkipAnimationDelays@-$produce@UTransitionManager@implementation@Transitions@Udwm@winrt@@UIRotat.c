/*
 * XREFs of ?SkipAnimationDelays@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotationTransitionManager@Private@345@@impl@winrt@@UEAAHXZ @ 0x1800FEB30
 * Callers:
 *     <none>
 * Callees:
