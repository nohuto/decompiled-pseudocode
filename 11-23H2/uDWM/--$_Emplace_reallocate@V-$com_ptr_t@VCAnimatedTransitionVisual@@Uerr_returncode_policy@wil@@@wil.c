...
_QWORD *__fastcall std::vector<wil::com_ptr_t<CAnimatedTransitionVisual,wil::err_returncode_policy>>::_Emplace_reallocate<wil::com_ptr_t<CAnimatedTransitionVisual,wil::err_returncode_policy>>(
        const char *a1,
        __int64 a2,
        __int64 *a3)
{
  ...
  *v17 = v14;
  ...
  std::_Uninitialized_move<wil::com_ptr_t<CAnimatedTransitionVisual,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<CAnimatedTransitionVisual,wil::err_returncode_policy>>>(
    ...
    v18,
    v16);
  std::vector<wil::com_ptr_t<CAnimatedTransitionVisual,wil::err_returncode_policy>>::_Change_array(a1, v15, v9, v3);
  return v17;
}
