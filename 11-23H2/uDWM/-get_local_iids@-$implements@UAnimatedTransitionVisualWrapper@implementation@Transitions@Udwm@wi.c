/*
 * XREFs of ?get_local_iids@?$implements@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@U1345@UITransitionAnimationVisualNative@34@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x180059760
 * Callers:
 *     <none>
 * Callees:
 *     <none>
