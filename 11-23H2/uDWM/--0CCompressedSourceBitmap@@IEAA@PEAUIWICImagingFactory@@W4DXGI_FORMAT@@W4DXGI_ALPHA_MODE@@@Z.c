/*
 * XREFs of ??0CCompressedSourceBitmap@@IEAA@PEAUIWICImagingFactory@@W4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@@Z @ 0x180022524
 * Callers:
 ...
 *     ??0IBitmapUnlock@@QEAA@XZ @ 0x18002263C (--0IBitmapUnlock@@QEAA@XZ.c)
