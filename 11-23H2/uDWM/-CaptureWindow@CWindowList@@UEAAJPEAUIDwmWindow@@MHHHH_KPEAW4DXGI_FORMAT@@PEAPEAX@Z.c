/*
 * XREFs of ?CaptureWindow@CWindowList@@UEAAJPEAUIDwmWindow@@MHHHH_KPEAW4DXGI_FORMAT@@PEAPEAX@Z @ 0x180109050
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x1880u);
    v5 = v14;
    goto LABEL_13;
  }
  v5 = v14;
