/*
 * XREFs of ?_GetAdapterDisplayRect@CProjectionBorderManager@@AEAAJAEBU_LUID@@IPEAUtagRECT@@@Z @ 0x1800D3FD4
 * Callers:
        ...
        struct tagRECT *a4)
{
  ...
  *a4 = 0LL;
      ...
      if ( modeInfoArray )
      {
        ...
        else
        {
          ...
          if ( (_DWORD)numPathArrayElements )
          {
            ...
            {
              v18 = v17;
              if ( v6[v17].sourceInfo.adapterId.LowPart == a2->LowPart
            ...
            v19 = (unsigned __int64)v6[v17].sourceInfo.modeInfoIdx << 6;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DisplayConfigBufferSizes, 0x17u);
  }
LABEL_25:
