/*
 * XREFs of ??$CreateProxy@VCLinearGradientLegacyMilBrushProxy@@@CCompositor@@IEAAJPEAPEAVCLinearGradientLegacyMilBrushProxy@@@Z @ 0x1800AD454
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CLinearGradientLegacyMilBrushProxy>(__int64 a1, CBaseObject **a2)
{
  __int64 v4; // rax
  CBaseObject *v5; // rbx
  int v6; // eax
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CTransform3dGroupProxy::`vftable';
    ...
    v6 = CResource::Create(0x15u, *(_QWORD *)(a1 + 24), (CBaseObject **)(v4 + 16));
    v7 = v6;
    if ( v6 >= 0 )
    {
      *a2 = v5;
