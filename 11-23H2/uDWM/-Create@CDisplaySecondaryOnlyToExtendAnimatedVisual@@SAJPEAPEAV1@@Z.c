/*
 * XREFs of ?Create@CDisplaySecondaryOnlyToExtendAnimatedVisual@@SAJPEAPEAV1@@Z @ 0x1800BD1AC
 * Callers:
        ...
        struct CDisplaySecondaryOnlyToExtendAnimatedVisual **a1)
{
  ...
  struct CDisplaySecondaryOnlyToExtendAnimatedVisual *v4; // rdi
  int v5; // r10d

  if ( a1 )
  {
    v3 = (CDisplaySecondaryOnlyToExtendAnimatedVisual *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
                                                          WPF::g_pProcessHeap,
                                                          520LL);
    if ( v3 )
