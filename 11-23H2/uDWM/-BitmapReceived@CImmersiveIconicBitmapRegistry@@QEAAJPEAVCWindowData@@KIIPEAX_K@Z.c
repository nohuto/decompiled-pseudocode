/*
 * XREFs of ?BitmapReceived@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_K@Z @ 0x1800C3940
 * Callers:
        ...
        unsigned __int64 a7)
{
    ...
    && v12 )
  {
    ...
    {
      v19 = v22;
      *((_DWORD *)a2 + 50) = *v15 & 0xFF00 | ((unsigned __int8)*v15 << 16) | (unsigned __int8)BYTE2(*v15);
      CImmersiveIconicBitmapRegistry::_AcceptBitmap(this, a2, v19);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129038, 1LL, v16, 0x172u);
    }
    if ( v17 )
  ...
  else
  {
    if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
      McTemplateU0qp_EtwEventWriteTransfer(v11, (__int64)&UdwmManageIconicThumbnail_Info, 1LL, *((_QWORD *)a2 + 5));
    v18 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129038, 1LL, -2147024809, 0x16Eu);
  }
  return v18;
}
