/*
 * XREFs of ?EnsureDCompResources@CDesktopManager@@QEAAJXZ @ 0x180028098
 * Callers:
...
__int64 __fastcall CDesktopManager::EnsureDCompResources(CDesktopManager *this)
{
  ...
  if ( !*((_QWORD *)this + 10) )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x620u, 0LL);
    }
    else
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x623u, 0LL);
      }
      else
      {
        ...
        if ( v9 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x629u, 0LL);
        }
        else
        {
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ProxyFromShared, 0x62Bu, 0LL);
          }
          else
          {
            ...
            v1 = v11;
            if ( v11 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x62Du, 0LL);
            else
              (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*((_QWORD *)this + 6) + 32LL) + 24LL))(*(_QWORD *)(*((_QWORD *)this + 6) + 32LL));
          }
        }
