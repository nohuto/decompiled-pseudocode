/*
 * XREFs of ?GetTrustLevel@?$produce_base@UScreenRotationResponsiveTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@X@impl@winrt@@UEAAHPEAW4TrustLevel@Foundation@Windows@3@@Z @ 0x1800F5290
 * Callers:
 *     <none>
 * Callees:
 *     <none>
