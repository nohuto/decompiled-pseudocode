/*
 * XREFs of ?UDwmHolographicDeviceDriverDetected_@UDwmTrace@@QEAAXXZ @ 0x1800A5DBC
 * Callers:
...
void __fastcall UDwmTrace::UDwmHolographicDeviceDriverDetected_(UDwmTrace *this)
{
    ...
    && (*(_QWORD *)(v1 + 24) & 0x400000000000LL) == *(_QWORD *)(v1 + 24) )
  {
    ...
    v2 = 0x2000000LL;
    v5 = 8;
    tlgWriteTransfer_EtwEventWriteTransfer(v1, byte_180125160, 0LL, 0LL, 3, (__int64)v3);
  }
}
