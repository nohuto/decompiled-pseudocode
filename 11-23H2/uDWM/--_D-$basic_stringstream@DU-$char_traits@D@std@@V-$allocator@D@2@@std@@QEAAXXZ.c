/*
 * XREFs of ??_D?$basic_stringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAXXZ @ 0x1800F1338
 * Callers:
 *     _tip::details::test_common_data_0_::data_::_1_::dtor$0 @ 0x1800F29AA (_tip--details--test_common_data_0_--data_--_1_--dtor$0.c)
 * Callees:
