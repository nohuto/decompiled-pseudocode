/*
 * XREFs of ?Create@CCompressedSourceBitmap@@SAJPEAUIWICImagingFactory@@PEBXKNNW4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@PEAPEAVIBitmapSource@@@Z @ 0x18002243C
 * Callers:
        ...
        struct IBitmapSource **a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( v16 < 0 )
  {
    ...
    v20 = 37;
LABEL_9:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, v20, 0LL);
