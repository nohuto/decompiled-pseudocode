/*
 * XREFs of ?_UpdateBorderShadowParts@CAccent@@IEAAJXZ @ 0x18006B514
 * Callers:
 ...
 *     ?_IsShadowPartApplicableFromFlags@CAccent@@IEAA_NH@Z @ 0x1800A13D4 (-_IsShadowPartApplicableFromFlags@CAccent@@IEAA_NH@Z.c)
