/*
 * XREFs of ?CreateBitmapFromAtlas@CTopLevelWindow@@SAJQEAXHPEAU_MARGINS@@PEAPEAVCBitmapSource@@@Z @ 0x18005296C
 * Callers:
        ...
        struct CBitmapSource **a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D0, 1u, ThemeMargins, 0x23Cu, 0LL);
  }
  else
  {
    ...
    if ( ThemeRect < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D0, 1u, ThemeRect, 0x240u, 0LL);
    }
    else
    {
      ...
      v9 = v12;
      if ( v12 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D0, 1u, v12, 0x248u, 0LL);
    }
  }
  return v9;
}
