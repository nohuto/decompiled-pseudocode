/*
 * XREFs of ?UDwmDisplayIsPhysicalMonitorDevice_@UDwmTrace@@QEAAXXZ @ 0x1800A5D18
 * Callers:
...
void __fastcall UDwmTrace::UDwmDisplayIsPhysicalMonitorDevice_(UDwmTrace *this)
{
    ...
    && (*(_QWORD *)(v1 + 24) & 0x200000000000LL) == *(_QWORD *)(v1 + 24) )
  {
    ...
    v2 = 0x2000000LL;
    v5 = 8;
    tlgWriteTransfer_EtwEventWriteTransfer(v1, byte_1801250A7, 0LL, 0LL, 3, (__int64)v3);
  }
}
