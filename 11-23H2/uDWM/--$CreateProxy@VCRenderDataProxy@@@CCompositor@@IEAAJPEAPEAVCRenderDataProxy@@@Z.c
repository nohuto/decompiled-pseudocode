/*
 * XREFs of ??$CreateProxy@VCRenderDataProxy@@@CCompositor@@IEAAJPEAPEAVCRenderDataProxy@@@Z @ 0x1800397E0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRenderDataProxy>(__int64 a1, __int64 *a2)
{
  ...
  *(_QWORD *)(v8 + 16) = 0LL;
  *(_QWORD *)(v8 + 16) = v7;
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v7 + 88LL))(v7, 30LL, v8 + 24);
  if ( v10 < 0 )
  {
    v12 = 68;
LABEL_12:
