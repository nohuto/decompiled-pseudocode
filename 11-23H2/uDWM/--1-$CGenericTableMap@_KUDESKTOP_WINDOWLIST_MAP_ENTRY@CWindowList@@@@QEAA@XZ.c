/*
 * XREFs of ??1?$CGenericTableMap@_KUDESKTOP_WINDOWLIST_MAP_ENTRY@CWindowList@@@@QEAA@XZ @ 0x1800B3538
 * Callers:
 *     _CWindowList::_CWindowList_::_1_::dtor$0 @ 0x180108965 (_CWindowList--_CWindowList_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
