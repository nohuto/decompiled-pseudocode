/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x180109970
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x1512u);
    goto LABEL_35;
  }
  v12 = v28;
  if ( !v28 )
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopThumbnail, 0x1520u);
LABEL_27:
    v15 = v25;
    goto LABEL_28;
  }
  ...
  *((_QWORD *)v25 + 35) = *((_QWORD *)v12 + 17);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x1521u);
    goto LABEL_28;
  }
  v31 = *a4;
      ...
      if ( v21 >= 0 )
      {
        ...
        *((_BYTE *)v10 + 345) = 0;
        ...
        if ( v22 >= 0 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v23, 0x1542u);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0x153Fu);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x1539u);
        v10 = v26;
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, PerMonitorDesktopThumbnail, 0x1522u);
  }
LABEL_28:
  if ( v15 )
