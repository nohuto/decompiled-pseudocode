/*
 * XREFs of ?Update@CGeometry2dGroupProxy@@QEAAJPEBVCMeshGeometry2dProxy@@@Z @ 0x18006CE9C
 * Callers:
...
__int64 __fastcall CGeometry2dGroupProxy::Update(CGeometry2dGroupProxy *this, const struct CMeshGeometry2dProxy *a2)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, int *, __int64))(**(_QWORD **)(*((_QWORD *)this + 2) + 16LL) + 824LL))(
