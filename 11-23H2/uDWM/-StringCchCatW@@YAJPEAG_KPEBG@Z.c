/*
 * XREFs of ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x18002526C
 * Callers:
 *     ?BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z @ 0x1800AF1C0 (-BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z.c)
 * Callees:
