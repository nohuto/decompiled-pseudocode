/*
 * XREFs of ??0?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIGraphicsEffect@Effects@Graphics@Windows@@UIGraphicsEffectSource@567@UIGraphicsEffectD2D1Interop@567@UIGaussianBlurEffect@5Composition@UI@Internal@3@@Details@WRL@Microsoft@@QEAA@XZ @ 0x180023918
 * Callers:
        ...
        IUnknown *a1)
{
  ...
  IUnknown::IUnknown(a1 + 3);
  IUnknown::IUnknown(a1 + 4);
  result = a1;
  a1[6].lpVtbl = (struct IUnknownVtbl *)1;
  return result;
}
