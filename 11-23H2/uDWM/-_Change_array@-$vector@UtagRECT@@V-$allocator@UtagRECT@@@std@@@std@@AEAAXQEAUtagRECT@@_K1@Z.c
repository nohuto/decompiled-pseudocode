/*
 * XREFs of ?_Change_array@?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@AEAAXQEAUtagRECT@@_K1@Z @ 0x1800BC3BC
 * Callers:
...
__int64 __fastcall std::vector<tagRECT>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = *(void **)a1;
  if ( v6 )
    result = std::_Deallocate<16,0>(v6, (*(_QWORD *)(a1 + 16) - (_QWORD)v6) & 0xFFFFFFFFFFFFFFF0uLL);
  *(_QWORD *)a1 = a2;
