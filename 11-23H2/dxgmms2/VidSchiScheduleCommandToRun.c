/*
 * XREFs of VidSchiScheduleCommandToRun @ 0x1C000A430
 * Callers:
 ...
 *     VidSchiProcessFlipPendingContextList @ 0x1C001BEEA (VidSchiProcessFlipPendingContextList.c)
 *     ?ProcessHwQueue@HwQueueStagingList@@AEAAXPEAUVIDSCH_HW_QUEUE@@@Z @ 0x1C001C558 (-ProcessHwQueue@HwQueueStagingList@@AEAAXPEAUVIDSCH_HW_QUEUE@@@Z.c)
