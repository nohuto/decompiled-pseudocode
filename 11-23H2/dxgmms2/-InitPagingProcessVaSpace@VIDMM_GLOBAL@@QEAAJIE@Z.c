/*
 * XREFs of ?InitPagingProcessVaSpace@VIDMM_GLOBAL@@QEAAJIE@Z @ 0x1C00C23BC
 * Callers:
 *     ?NotifyMemorySegmentActive@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_SEGMENT@@@Z @ 0x1C002DE78 (-NotifyMemorySegmentActive@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_SEGMENT@@@Z.c)
 ...
 *     VidSchRecommitSchedulingLogs @ 0x1C001969C (VidSchRecommitSchedulingLogs.c)
 ...
 *     ?EvictRootPageTable@CVirtualAddressAllocator@@QEAAXIE@Z @ 0x1C002DD70 (-EvictRootPageTable@CVirtualAddressAllocator@@QEAAXIE@Z.c)
 ...
 *     ?MapPagingQueueGpuVAs@VIDMM_DEVICE@@QEAAJI@Z @ 0x1C00EC050 (-MapPagingQueueGpuVAs@VIDMM_DEVICE@@QEAAJI@Z.c)
 *     ?RecommitSystemFenceGpuVA@VIDMM_GLOBAL@@QEAAJI@Z @ 0x1C00F0CD8 (-RecommitSystemFenceGpuVA@VIDMM_GLOBAL@@QEAAJI@Z.c)
 *     VidSchSetHwQueueProgressFenceObject @ 0x1C01091A0 (VidSchSetHwQueueProgressFenceObject.c)
 */
    ...
    *((_BYTE *)this + 40936) |= 0x40u;
    ...
    if ( !(unsigned int)Feature_DxgkGpuVaIoMmu__private_IsEnabledDeviceUsage() || (*(_BYTE *)(v6 + 444) & 1) != 0 )
    {
      ...
      if ( !*((_QWORD *)this + 5119) )
      {
        ...
        {
          *((_BYTE *)this + 40936) &= ~0x40u;
          WdLogSingleEntry2(1LL, v17, 7346LL);
LABEL_38:
...
LABEL_41:
    ...
    if ( !(unsigned int)Feature_DxgkGpuVaIoMmu__private_IsEnabledDeviceUsage() || (*(_BYTE *)(v6 + 444) & 1) != 0 )
    {
      ...
      HwQueue = CVirtualAddressAllocator::CommitVirtualAddressRange(
                  ...
                  -1,
                  0LL,
                  (struct _DXGK_ADL *)&xmmword_1C004F1D0,
                  0,
                  &v47,
                  0LL);
      if ( HwQueue < 0 )
      {
        WdLogSingleEntry1(1LL, 7454LL);
LABEL_93:
