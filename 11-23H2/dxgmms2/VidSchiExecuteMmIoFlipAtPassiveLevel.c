/*
 * XREFs of VidSchiExecuteMmIoFlipAtPassiveLevel @ 0x1C00148F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchiComputeFlipEntryStatusAfterFlip @ 0x1C0014E70 (VidSchiComputeFlipEntryStatusAfterFlip.c)
 *     ?VidSchiUpdateFlipTelemetryStats@@YAXPEAU_VIDSCH_PROCESS@@PEAU_VIDSCH_CALL_EXECUTE_FLIP@@PEAU_VIDSCH_PRESENT_INFO@@@Z @ 0x1C0014EB4 (-VidSchiUpdateFlipTelemetryStats@@YAXPEAU_VIDSCH_PROCESS@@PEAU_VIDSCH_CALL_EXECUTE_FLIP@@PEAU_VI.c)
...
void __fastcall VidSchiExecuteMmIoFlipAtPassiveLevel(__int64 a1)
{
  ...
  if ( v5 )
  {
    ...
    *(_OWORD *)v73 = 0LL;
    v74 = 0LL;
    AcquireSpinLock::Acquire((Acquire *)&v50);
    ...
    else
    {
      ...
      if ( !v10 )
      {
        v71 = 0;
        v70[0] = v1 + 1728;
        AcquireSpinLock::Acquire((Acquire *)v70);
        v58 = 0;
        v57[1] = v57;
        v12 = -1;
        v57[0] = v57;
