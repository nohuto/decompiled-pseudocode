/*
 * XREFs of ?NotifyAllocationReclaimed@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@H@Z @ 0x1C00E6038
 * Callers:
 ...
 *     ?NotifyAllocationReclaimed@@YAXPEAX@Z @ 0x1C00E6010 (-NotifyAllocationReclaimed@@YAXPEAX@Z.c)
 *     ?ReclaimAllocationForVPRCallback@@YAEPEAX0@Z @ 0x1C00FEC6C (-ReclaimAllocationForVPRCallback@@YAEPEAX0@Z.c)
