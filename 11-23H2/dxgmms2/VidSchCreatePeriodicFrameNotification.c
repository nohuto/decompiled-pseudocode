/*
 * XREFs of VidSchCreatePeriodicFrameNotification @ 0x1C003E940
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?VidSchCalculatePeriodicMonitoredFenceTimerDueTime@@YA_J_J00H@Z @ 0x1C003D554 (-VidSchCalculatePeriodicMonitoredFenceTimerDueTime@@YA_J_J00H@Z.c)
        ...
        __int64 **a6)
{
  ...
  if ( (unsigned __int8)VidSchIsVSyncAvailable(a1, a4) && (int)VidSchControlVSyncAdapter(a1) >= 0 )
  {
    ...
    if ( !Pool2 )
    {
      _InterlockedIncrement(&dword_1C00768B8);
      WdLogSingleEntry1(6LL, 13937LL);
    ...
    if ( v31 != 1 )
    {
      ...
      if ( bTracingEnabled )
      {
        if ( (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer(v32, (__int64)&EventPerformanceWarning, v33, 25);
      }
    }
