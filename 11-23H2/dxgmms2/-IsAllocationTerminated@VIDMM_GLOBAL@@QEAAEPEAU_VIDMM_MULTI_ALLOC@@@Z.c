/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00E43BC
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C002D160 (VidMmIsAllocationTerminated.c)
 * Callees:
