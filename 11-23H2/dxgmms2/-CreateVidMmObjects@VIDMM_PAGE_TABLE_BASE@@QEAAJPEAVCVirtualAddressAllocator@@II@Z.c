/*
 * XREFs of ?CreateVidMmObjects@VIDMM_PAGE_TABLE_BASE@@QEAAJPEAVCVirtualAddressAllocator@@II@Z @ 0x1C009AFBC
 * Callers:
        ...
        int a4)
{
  ...
  if ( OneAllocation < 0 )
  {
    _InterlockedIncrement(&dword_1C00767A8);
    WdLogSingleEntry1(6LL, 4151LL);
  ...
  else
  {
    ...
    if ( v20 < 0 )
    {
      _InterlockedIncrement(&dword_1C00767AC);
      WdLogSingleEntry1(6LL, 4181LL);
