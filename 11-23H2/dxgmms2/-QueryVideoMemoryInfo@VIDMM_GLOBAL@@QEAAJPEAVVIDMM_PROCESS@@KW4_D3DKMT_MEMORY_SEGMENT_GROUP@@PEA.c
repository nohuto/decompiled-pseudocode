/*
 * XREFs of ?QueryVideoMemoryInfo@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@KW4_D3DKMT_MEMORY_SEGMENT_GROUP@@PEA_K222@Z @ 0x1C00E6A78
 * Callers:
 *     VidMmQueryVideoMemoryInfo @ 0x1C002D230 (VidMmQueryVideoMemoryInfo.c)
 * Callees:
