/*
 * XREFs of ?CreateSchLog@VIDMM_SCH_LOG@@SAJPEAVVIDMM_GLOBAL@@I_KPEAPEAV1@PEAPEAXPEA_K@Z @ 0x1C004CDCC
 * Callers:
 ...
 *     ??_GVIDMM_SCH_LOG@@AEAAPEAXI@Z @ 0x1C004CD98 (--_GVIDMM_SCH_LOG@@AEAAPEAXI@Z.c)
