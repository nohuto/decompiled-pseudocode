/*
 * XREFs of VidSchiCompleteFlipEntry @ 0x1C0010C40
 * Callers:
 ...
 *     VidSchiCompletePendingFlipOnPlane @ 0x1C00183C4 (VidSchiCompletePendingFlipOnPlane.c)
 *     ?VidSchiSelectPresentAtFlip@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_QUEUE@@PEAKPEAPEAU_VIDSCH_FLIP_QUEUE_ENTRY@@@Z @ 0x1C0036648 (-VidSchiSelectPresentAtFlip@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_QUE.c)
 *     VidSchiCancelIndependentFlips @ 0x1C003A40C (VidSchiCancelIndependentFlips.c)
 *     VidSchiRestartQueuedFlip @ 0x1C003C1A4 (VidSchiRestartQueuedFlip.c)
 *     ?VidSchiCancelIndependentFlipsHwQueue@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_QUEUE@@PEA_NPEAIII@Z @ 0x1C00488D8 (-VidSchiCancelIndependentFlipsHwQueue@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@IPEAUVIDSC.c)
 *     ?VidSchiSubmitNextFlipQueueEntryRange@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@PEA_NIPEAUVIDSCH_FLIP_QUEUE@@@Z @ 0x1C004A720 (-VidSchiSubmitNextFlipQueueEntryRange@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@PEA_NIPEAU.c)
 *     ?VidSchiSynchronouslyCancelPendingFlips@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@IPEAUVIDSCH_FLIP_QUEUE@@I@Z @ 0x1C004AB28 (-VidSchiSynchronouslyCancelPendingFlips@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@IPEAUVID.c)
 * Callees:
 ...
 *     ?RefCountedBufferRelease@CRefCountedBuffer@@QEAAXXZ @ 0x1C001BE1E (-RefCountedBufferRelease@CRefCountedBuffer@@QEAAXXZ.c)
 ...
 *     ?GetFlipManagerAuxiliaryPresentInfo@@YAPEAU_D3DKMT_FLIPMANAGER_AUXILIARYPRESENTINFO@@PEAU_D3DKMT_AUXILIARYPRESENTINFO@@@Z @ 0x1C003468C (-GetFlipManagerAuxiliaryPresentInfo@@YAPEAU_D3DKMT_FLIPMANAGER_AUXILIARYPRESENTINFO@@PEAU_D3DKMT.c)
 *     ?UpdateFlipManagerStatsOnFlipCompletion@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_PRESENT_INFO@@IW4_VIDSCH_FLIP_STATUS@@@Z @ 0x1C0034DA0 (-UpdateFlipManagerStatsOnFlipCompletion@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_FLIP_QUEUE_ENTRY@@PE.c)
 ...
 *     VidSchiTryEnterIndependentFlip @ 0x1C003C7E4 (VidSchiTryEnterIndependentFlip.c)
            ...
            if ( (v18[284] & 0x1000) == 0 )
            {
              ...
              if ( !v20 )
              {
                ...
                `vector constructor iterator'(
                  ...
                  16LL,
                  10LL,
                  (void (__fastcall *)(char *))_MOCKDRIVERSTATE_SET_PLANE::_unnamed_type_PerPlane_::_unnamed_type_PerPlane_);
                v261[0] = v211;
  ...
  *(_DWORD *)(v12 + 3076) -= v74;
  ...
  if ( v79 )
  {
    for ( k = *(_QWORD **)(v79 + 72); k != (_QWORD *)(v79 + 72); v80 |= v83 )
    {
      ...
      if ( (k[20] & 0x10) != 0 )
      {
        *(_DWORD *)(v82 + 184) &= ~0x10u;
        v83 = VidSchiUnwaitContext(v82, 0x59A0u);
      }
      k = (_QWORD *)*k;
    }
    v84 = *(_QWORD *)(v79 + 32);
