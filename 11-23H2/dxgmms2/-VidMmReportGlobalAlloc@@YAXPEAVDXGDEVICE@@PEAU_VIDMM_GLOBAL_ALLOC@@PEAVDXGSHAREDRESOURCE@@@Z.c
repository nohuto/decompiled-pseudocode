/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00C4130
 * Callers:
 *     VidMmReportMultiGlobalAlloc @ 0x1C00C4410 (VidMmReportMultiGlobalAlloc.c)
 *     VidMmReportContextAllocList @ 0x1C00F1810 (VidMmReportContextAllocList.c)
 * Callees:
