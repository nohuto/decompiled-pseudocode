/*
 * XREFs of McTemplateK0ppqqpx_EtwWriteTransfer @ 0x1C002EB30
 * Callers:
 *     VidSchDestroySyncObject @ 0x1C008CB20 (VidSchDestroySyncObject.c)
 *     VidSchCreateSyncObject @ 0x1C008CCC0 (VidSchCreateSyncObject.c)
 *     ?ReportPagingProcessState@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00E6FC4 (-ReportPagingProcessState@VIDMM_GLOBAL@@QEAAXXZ.c)
 *     ?ReportState@VIDMM_DEVICE_PAGING_QUEUE@@QEAAXXZ @ 0x1C00EC2A0 (-ReportState@VIDMM_DEVICE_PAGING_QUEUE@@QEAAXXZ.c)
 * Callees:
