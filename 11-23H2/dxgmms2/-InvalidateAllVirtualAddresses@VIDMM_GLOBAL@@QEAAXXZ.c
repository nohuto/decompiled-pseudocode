/*
 * XREFs of ?InvalidateAllVirtualAddresses@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00E3C50
 * Callers:
 *     VidMmInvalidateAllVirtualAddresses @ 0x1C002D120 (VidMmInvalidateAllVirtualAddresses.c)
 * Callees:
