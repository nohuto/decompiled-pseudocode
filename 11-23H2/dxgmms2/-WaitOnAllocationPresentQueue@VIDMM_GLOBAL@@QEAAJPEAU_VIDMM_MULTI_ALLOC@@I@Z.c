/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00EB8B4
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x1C002D560 (VidMmWaitOnAllocationPresentQueue.c)
