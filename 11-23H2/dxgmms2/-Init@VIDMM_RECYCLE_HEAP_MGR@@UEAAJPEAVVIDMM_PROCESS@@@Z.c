/*
 * XREFs of ?Init@VIDMM_RECYCLE_HEAP_MGR@@UEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1C009B410
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  ...
  else
  {
    ...
    *((_DWORD *)this + 405) = 4;
    ...
    v15 = (_QWORD *)qword_1C0076918;
    v16 = (_QWORD *)((char *)this + 1600);
    v22 = 2;
    if ( *(struct _LIST_ENTRY **)qword_1C0076918 != &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead )
      __fastfail(3u);
    *v16 = &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
    v16[1] = v15;
    *v15 = v16;
    qword_1C0076918 = (__int64)v16;
