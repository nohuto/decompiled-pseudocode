/*
 * XREFs of McTemplateK0ppxxxxxqxx_EtwWriteTransfer @ 0x1C002FE94
 * Callers:
...
NTSTATUS McTemplateK0ppxxxxxqxx_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, a2, a3, 0xBu, &v4);
}
