/*
 * XREFs of ?GetRenderAdapterInfo@DXGPROCESS@@QEBAPEAUDXGPROCESS_RENDER_ADAPTER_INFO@@I@Z @ 0x1C002FE3C
 * Callers:
 ...
 *     VidSchQueryProcessAdapterStatistics @ 0x1C00C4860 (VidSchQueryProcessAdapterStatistics.c)
 * Callees:
