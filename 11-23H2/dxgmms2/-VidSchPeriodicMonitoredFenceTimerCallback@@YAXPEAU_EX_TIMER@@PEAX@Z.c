/*
 * XREFs of ?VidSchPeriodicMonitoredFenceTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C003D600
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchiCalculatePeriodicTargetFrameNumber @ 0x1C003A294 (VidSchiCalculatePeriodicTargetFrameNumber.c)
