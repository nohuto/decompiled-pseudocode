/*
 * XREFs of VidSchiCheckNodeTimeout @ 0x1C00AE620
 * Callers:
 ...
 *     ?DdiQueryEngineStatus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYENGINESTATUS@@@Z @ 0x1C002C7E8 (-DdiQueryEngineStatus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYENGINESTATUS@@@Z.c)
 ...
 *     VidSchiSkipXboxNodeTimeout @ 0x1C003C5B0 (VidSchiSkipXboxNodeTimeout.c)
 */
