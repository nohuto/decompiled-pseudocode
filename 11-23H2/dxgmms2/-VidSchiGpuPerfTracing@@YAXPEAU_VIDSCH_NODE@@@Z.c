/*
 * XREFs of ?VidSchiGpuPerfTracing@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x1C0035A2C
 * Callers:
 *     ?VidSchiNodePerfTracingThread@@YAXPEAX@Z @ 0x1C0035D60 (-VidSchiNodePerfTracingThread@@YAXPEAX@Z.c)
 * Callees:
