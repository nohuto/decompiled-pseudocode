/*
 * XREFs of ?VidMmReserveGpuVirtualAddressRangeCb@VIDMM_GLOBAL@@QEAAJPEAU_DXGKARGCB_RESERVEGPUVIRTUALADDRESSRANGE@@@Z @ 0x1C00EA250
 * Callers:
 *     VidMmReserveGpuVirtualAddressRangeCb @ 0x1C002D330 (VidMmReserveGpuVirtualAddressRangeCb.c)
 * Callees:
        ...
        struct _DXGKARGCB_RESERVEGPUVIRTUALADDRESSRANGE *a2)
{
  ...
  if ( (v4 & 2) == 0 )
  {
    WdLogSingleEntry1(1LL, 22616LL);
    goto LABEL_33;
  }
  Alignment = a2->Alignment;
  if ( !Alignment || ((Alignment - 1) & Alignment) != 0 )
  {
    WdLogSingleEntry1(1LL, 22622LL);
  }
  else
  {
    if ( (a2->Flags & 1) == 0 )
    {
      ...
      {
        WdLogSingleEntry1(1LL, 22631LL);
        goto LABEL_33;
      }
      SizeInBytes = a2->SizeInBytes;
      if ( !SizeInBytes || (SizeInBytes & v8) != 0 )
      {
        WdLogSingleEntry1(1LL, 22637LL);
        goto LABEL_33;
      }
LABEL_17:
      v12 = 0;
