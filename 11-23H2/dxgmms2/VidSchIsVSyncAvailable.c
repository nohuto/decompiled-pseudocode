/*
 * XREFs of VidSchIsVSyncAvailable @ 0x1C00B4710
 * Callers:
 *     VidSchiSetFlipDevice @ 0x1C0006310 (VidSchiSetFlipDevice.c)
 *     VidSchCreatePeriodicFrameNotification @ 0x1C003E940 (VidSchCreatePeriodicFrameNotification.c)
 *     VidSchGetDeviceFlipMode @ 0x1C00B5660 (VidSchGetDeviceFlipMode.c)
 * Callees:
