/*
 * XREFs of ?CommitLocalBackingStore@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_LOCAL_ALLOC@@PEAEPEAX@Z @ 0x1C00AA5B0
 * Callers:
...
LABEL_16:
      ...
      if ( v17 < 0 )
      {
        _InterlockedIncrement(&dword_1C0076818);
    ...
    {
      WdLogSingleEntry1(1LL, 29870LL);
    }
    else
    {
      if ( a4 == (a4 & 0xFFFFFFFFFFFFF000uLL) && *(_QWORD *)v9 == (*(_QWORD *)v9 & 0xFFFFFFFFFFFFF000uLL) )
        goto LABEL_47;
      WdLogSingleEntry1(1LL, 29883LL);
    }
  }
