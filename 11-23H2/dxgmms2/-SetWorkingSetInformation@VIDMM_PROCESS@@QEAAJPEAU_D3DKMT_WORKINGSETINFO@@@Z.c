/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C00EF598
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C002D3E0 (VidMmSetWorkingSetInformation.c)
 * Callees:
