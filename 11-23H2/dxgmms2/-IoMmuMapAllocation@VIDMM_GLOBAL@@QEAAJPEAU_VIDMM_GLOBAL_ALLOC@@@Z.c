/*
 * XREFs of ?IoMmuMapAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00E403C
 * Callers:
 ...
 *     ?MapToIommu@VIDMM_SEGMENT@@QEAAJXZ @ 0x1C00FDA0C (-MapToIommu@VIDMM_SEGMENT@@QEAAJXZ.c)
 * Callees:
