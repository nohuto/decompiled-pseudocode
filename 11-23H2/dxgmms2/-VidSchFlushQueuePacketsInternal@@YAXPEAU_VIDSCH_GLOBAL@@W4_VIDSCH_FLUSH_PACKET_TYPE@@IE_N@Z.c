/*
 * XREFs of ?VidSchFlushQueuePacketsInternal@@YAXPEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_PACKET_TYPE@@IE_N@Z @ 0x1C000294C
 * Callers:
 *     VidSchFlushQueuePackets @ 0x1C0001C10 (VidSchFlushQueuePackets.c)
 *     VidSchFlushPresentReferencesAndDisableOverlays @ 0x1C0087770 (VidSchFlushPresentReferencesAndDisableOverlays.c)
 * Callees:
 ...
 *     VidSchiAcceptsIncomingWork @ 0x1C000A410 (VidSchiAcceptsIncomingWork.c)
 *     VidSchiFlushQueuePacket @ 0x1C003A9B8 (VidSchiFlushQueuePacket.c)
 */
...
LABEL_19:
          ...
          {
            if ( v62 == -1 )
              VidSchiClearFlipDevice((struct _VIDSCH_GLOBAL *)v7, v18, 6, 0xFFFFFFFD, 0);
            else
              VidSchiSetFlipDevice((struct _VIDSCH_GLOBAL *)v7, 6, 0, a5);
          }
