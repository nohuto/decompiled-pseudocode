/*
 * XREFs of ?RestoreFromPurge@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00B5278
 * Callers:
 *     VidMmRestoreFromPurge @ 0x1C0018EB0 (VidMmRestoreFromPurge.c)
 * Callees:
 ...
 *     ?MapAllPagingBuffers@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00B5334 (-MapAllPagingBuffers@VIDMM_GLOBAL@@QEAAXXZ.c)
