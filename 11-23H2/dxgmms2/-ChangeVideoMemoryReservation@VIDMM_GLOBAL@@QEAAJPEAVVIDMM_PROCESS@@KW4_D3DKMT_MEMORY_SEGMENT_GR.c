/*
 * XREFs of ?ChangeVideoMemoryReservation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@KW4_D3DKMT_MEMORY_SEGMENT_GROUP@@_K@Z @ 0x1C00E0BE4
 * Callers:
 *     VidMmChangeVideoMemoryReservation @ 0x1C002D070 (VidMmChangeVideoMemoryReservation.c)
 * Callees:
