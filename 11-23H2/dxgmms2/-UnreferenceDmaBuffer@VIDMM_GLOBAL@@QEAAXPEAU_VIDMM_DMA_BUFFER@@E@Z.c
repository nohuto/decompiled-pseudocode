/*
 * XREFs of ?UnreferenceDmaBuffer@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@E@Z @ 0x1C002E1A0
 * Callers:
 *     VidMmUnreferenceDmaBuffer @ 0x1C002D4A0 (VidMmUnreferenceDmaBuffer.c)
 ...
 *     VidSchUnreferenceDmaBuffer @ 0x1C0108DDC (VidSchUnreferenceDmaBuffer.c)
 * Callees:
