/*
 * XREFs of McTemplateK0pqx_EtwWriteTransfer @ 0x1C002F0E8
 * Callers:
 ...
 *     ?ReportState@VIDMM_DMA_POOL@@QEAAXXZ @ 0x1C00EFBF0 (-ReportState@VIDMM_DMA_POOL@@QEAAXXZ.c)
 ...
 *     ?ReAllocateOldResource@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C00FEA20 (-ReAllocateOldResource@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z.c)
 *     ?ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00FEDBC (-ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ.c)
 * Callees:
