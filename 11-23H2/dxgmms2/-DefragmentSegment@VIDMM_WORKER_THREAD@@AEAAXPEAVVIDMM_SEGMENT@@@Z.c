/*
 * XREFs of ?DefragmentSegment@VIDMM_WORKER_THREAD@@AEAAXPEAVVIDMM_SEGMENT@@@Z @ 0x1C00EC570
 * Callers:
 ...
 *     ?VidMmiTickCountTo100ns@@YA_K_K@Z @ 0x1C00F17F8 (-VidMmiTickCountTo100ns@@YA_K_K@Z.c)
