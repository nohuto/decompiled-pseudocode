/*
 * XREFs of ?VerifyIntegrity@VIDMM_LINEAR_POOL@@QEAAJH@Z @ 0x1C0102B38
 * Callers:
 *     ?VerifyIntegrity@VIDMM_SEGMENT@@UEAAJXZ @ 0x1C0100510 (-VerifyIntegrity@VIDMM_SEGMENT@@UEAAJXZ.c)
 * Callees:
