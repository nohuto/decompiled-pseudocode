 ...
 *     ?VidSchiCallNotifyInterruptAtISR@@YAEPEAX@Z @ 0x1C0046BC0 (-VidSchiCallNotifyInterruptAtISR@@YAEPEAX@Z.c)
 * Callees:
 ...
 *     VidSchiProcessIsrMonitoredFenceSignaled @ 0x1C001DA1A (VidSchiProcessIsrMonitoredFenceSignaled.c)
 *     McTemplateK0qq_EtwWriteTransfer @ 0x1C002F274 (McTemplateK0qq_EtwWriteTransfer.c)
 *     ?MapVidPnTargetToVidPnSource@ADAPTER_DISPLAY@@QEAAII@Z @ 0x1C0034C14 (-MapVidPnTargetToVidPnSource@ADAPTER_DISPLAY@@QEAAII@Z.c)
 ...
 *     VidSchiProcessIsrGpuEngineTimeout @ 0x1C00459A8 (VidSchiProcessIsrGpuEngineTimeout.c)
 *     VidSchiProcessIsrHwQueuePageFaulted @ 0x1C0045A64 (VidSchiProcessIsrHwQueuePageFaulted.c)
 *     VidSchiProcessIsrSchedulingLogFull @ 0x1C0045C04 (VidSchiProcessIsrSchedulingLogFull.c)
 *     VidSchiProcessIsrSuspendContextCompleted @ 0x1C0045CC0 (VidSchiProcessIsrSuspendContextCompleted.c)
 */
