/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@I@Z @ 0x1C00BAADC
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C0019220 (VidMmInitializeAdapter.c)
 * Callees:
 ...
 *     ??_GVIDMM_GLOBAL@@QEAAPEAXI@Z @ 0x1C002C680 (--_GVIDMM_GLOBAL@@QEAAPEAXI@Z.c)
 *     ??0VIDMM_GLOBAL@@QEAA@XZ @ 0x1C00BACC0 (--0VIDMM_GLOBAL@@QEAA@XZ.c)
 ...
 *     ?VidMmiFreeQuerySegmentInfo@@YAXPEAU_DXGK_QUERYSEGMENTOUT4@@@Z @ 0x1C00BD1A8 (-VidMmiFreeQuerySegmentInfo@@YAXPEAU_DXGK_QUERYSEGMENTOUT4@@@Z.c)
 */
...
LABEL_26:
  ...
  if ( v13 < 0 )
  {
    _InterlockedIncrement(&dword_1C00767D0);
