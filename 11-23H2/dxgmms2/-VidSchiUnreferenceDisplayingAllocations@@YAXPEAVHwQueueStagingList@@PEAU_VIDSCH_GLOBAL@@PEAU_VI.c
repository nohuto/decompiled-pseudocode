/*
 * XREFs of ?VidSchiUnreferenceDisplayingAllocations@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@G@Z @ 0x1C0011D00
 * Callers:
        ...
        __int16 a4)
{
  ...
  if ( v20 )
  {
    ...
    for ( i = 0; v21 != (_QWORD *)(v20 + 72); i |= v24 )
    {
      ...
      if ( (v21[20] & 0x10) != 0 )
      {
        *(_DWORD *)(v23 + 184) &= ~0x10u;
        v24 = VidSchiUnwaitContext(v23, 0x59A0u);
      }
      v21 = (_QWORD *)*v21;
    }
    v25 = *(_QWORD *)(v20 + 32);
