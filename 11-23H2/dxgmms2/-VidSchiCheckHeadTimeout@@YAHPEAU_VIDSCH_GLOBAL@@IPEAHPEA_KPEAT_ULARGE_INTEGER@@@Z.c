/*
 * XREFs of ?VidSchiCheckHeadTimeout@@YAHPEAU_VIDSCH_GLOBAL@@IPEAHPEA_KPEAT_ULARGE_INTEGER@@@Z @ 0x1C000C750
 * Callers:
 *     VidSchiCheckFlipQueueTimeout @ 0x1C000B520 (VidSchiCheckFlipQueueTimeout.c)
 * Callees:
 ...
 *     VidSchiSkipXboxVsyncTimeout @ 0x1C003C6CC (VidSchiSkipXboxVsyncTimeout.c)
