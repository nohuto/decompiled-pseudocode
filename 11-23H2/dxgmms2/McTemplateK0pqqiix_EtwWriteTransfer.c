/*
 * XREFs of McTemplateK0pqqiix_EtwWriteTransfer @ 0x1C0038748
 * Callers:
 *     VidSchiProcessPeriodicNotificationCookie @ 0x1C003AFC4 (VidSchiProcessPeriodicNotificationCookie.c)
 *     ?VidSchPeriodicMonitoredFenceTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C003D600 (-VidSchPeriodicMonitoredFenceTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z.c)
 * Callees:
...
NTSTATUS McTemplateK0pqqiix_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPeriodicFrameNotificationTimer, a3, 7u, &v4);
}
