/*
 * XREFs of VidSchiSubmitRenderVirtualCommand @ 0x1C00AD180
 * Callers:
 ...
 * Callees:
 *     ?UpdateHistoryBuffer@_VIDSCH_QUEUE_PACKET@@QEAAXXZ @ 0x1C00068F0 (-UpdateHistoryBuffer@_VIDSCH_QUEUE_PACKET@@QEAAXXZ.c)
...
__int64 __fastcall VidSchiSubmitRenderVirtualCommand(_VIDSCH_QUEUE_PACKET *this)
{
  ...
  else
  {
    ...
    *((_QWORD *)this + 15) = v8;
    ...
    for ( i = *(_QWORD *)(v3 + 24); ; VidSchWaitForCompletionEvent(i, (__int64)v44, 20LL) )
    {
