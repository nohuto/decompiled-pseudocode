/*
 * XREFs of ?ReadPhysicalAdapterConfiguration@VIDMM_GLOBAL@@IEAAXI@Z @ 0x1C00BD3B8
 * Callers:
 ...
 *     ??1?$PagedPoolArray@G$0IA@@@QEAA@XZ @ 0x1C00BD668 (--1-$PagedPoolArray@G$0IA@@@QEAA@XZ.c)
 */
