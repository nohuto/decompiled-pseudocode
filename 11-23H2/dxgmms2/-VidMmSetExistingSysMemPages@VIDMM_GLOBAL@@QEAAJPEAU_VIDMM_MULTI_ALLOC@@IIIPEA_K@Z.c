/*
 * XREFs of ?VidMmSetExistingSysMemPages@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@IIIPEA_K@Z @ 0x1C00EA560
 * Callers:
 *     VidMmSetExistingSysMemPages @ 0x1C002D390 (VidMmSetExistingSysMemPages.c)
 * Callees:
