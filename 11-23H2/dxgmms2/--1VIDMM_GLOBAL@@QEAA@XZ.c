/*
 * XREFs of ??1VIDMM_GLOBAL@@QEAA@XZ @ 0x1C00DFE98
 * Callers:
 ...
 *     ?ResetAdapter@VIDMM_PARTITION@@QEAAXPEAVVIDMM_GLOBAL@@@Z @ 0x1C0030FF0 (-ResetAdapter@VIDMM_PARTITION@@QEAAXPEAVVIDMM_GLOBAL@@@Z.c)
 *     ?VidSchiDestroyNodeSchedulingLog@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x1C004288C (-VidSchiDestroyNodeSchedulingLog@@YAXPEAU_VIDSCH_NODE@@@Z.c)
 *     ??1DXGK_LOG@@QEAA@XZ @ 0x1C004CB88 (--1DXGK_LOG@@QEAA@XZ.c)
 ...
 *     ?RemoveFromAdapterList@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00E6F5C (-RemoveFromAdapterList@VIDMM_GLOBAL@@QEAAXXZ.c)
