/*
 * XREFs of VidSchiSubmitPagingCommand @ 0x1C0106554
 * Callers:
 ...
 *     ?DdiPatch@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_PATCH@@@Z @ 0x1C002C7A0 (-DdiPatch@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_PATCH@@@Z.c)
