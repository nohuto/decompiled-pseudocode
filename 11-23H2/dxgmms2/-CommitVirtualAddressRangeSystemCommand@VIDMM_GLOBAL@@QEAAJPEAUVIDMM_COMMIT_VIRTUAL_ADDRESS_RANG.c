/*
 * XREFs of ?CommitVirtualAddressRangeSystemCommand@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_COMMIT_VIRTUAL_ADDRESS_RANGE@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00AB730
 * Callers:
        ...
        DXGK_MULTIPLANE_OVERLAY_PLANE3 **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v6, 0LL) )
  {
    ...
    {
      v25 = *(_DWORD *)(v6 + 24);
      if ( v25 != -1 && (byte_1C0076981 & 1) != 0 )
        McTemplateK0q_EtwWriteTransfer(v7, (__int64)&EventBlockThread, v8, v25);
    }
