/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C001A100
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C001A254 (wil_details_GetCurrentFeatureEnabledState.c)
