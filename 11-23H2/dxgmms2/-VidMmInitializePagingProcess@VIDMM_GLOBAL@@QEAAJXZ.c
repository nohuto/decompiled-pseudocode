/*
 * XREFs of ?VidMmInitializePagingProcess@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C00C1C64
 * Callers:
 *     VidMmInitializePagingProcess @ 0x1C0019660 (VidMmInitializePagingProcess.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0019900 (__security_check_cookie.c)
 *     DxgkLogInternalTriageEvent @ 0x1C00199AC (DxgkLogInternalTriageEvent.c)
 *     VidSchCreateSchedulingLogs @ 0x1C00C1DA0 (VidSchCreateSchedulingLogs.c)
 *     ?CreatePagingFenceObjects@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C00C1E10 (-CreatePagingFenceObjects@VIDMM_GLOBAL@@QEAAJXZ.c)
...
LABEL_16:
  ...
  if ( inited < 0 )
  {
    WdLogSingleEntry1(1LL, 22748LL);
    goto LABEL_16;
  }
  inited = VIDMM_GLOBAL::InitDmaPools(this);
  if ( inited < 0 )
  {
    WdLogSingleEntry1(1LL, 22760LL);
    goto LABEL_16;
  }
  inited = VIDMM_GLOBAL::CreatePagingFenceObjects(this);
  if ( inited < 0 )
  {
    WdLogSingleEntry1(1LL, 22771LL);
    goto LABEL_16;
  }
  v3 = 0;
  if ( *((_DWORD *)this + 1754) )
