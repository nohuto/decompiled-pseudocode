/*
 * XREFs of ?UnblockUEFIFrameBufferRanges@VIDMM_GLOBAL@@QEAAJPEBU_DXGK_QUERYSEGMENTMEMORYSTATE@@@Z @ 0x1C00E80AC
 * Callers:
 *     VidMmUnblockUEFIFrameBufferRanges @ 0x1C002D480 (VidMmUnblockUEFIFrameBufferRanges.c)
 * Callees:
