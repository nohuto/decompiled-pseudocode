/*
 * XREFs of VidSchDestroySyncObject @ 0x1C008CB20
 * Callers:
 ...
 *     ?DestroyPagingFenceObjects@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00E1778 (-DestroyPagingFenceObjects@VIDMM_GLOBAL@@QEAAXXZ.c)
 * Callees:
