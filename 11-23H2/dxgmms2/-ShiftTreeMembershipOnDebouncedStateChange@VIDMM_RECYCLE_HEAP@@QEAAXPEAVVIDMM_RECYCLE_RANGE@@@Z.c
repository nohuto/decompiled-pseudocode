/*
 * XREFs of ?ShiftTreeMembershipOnDebouncedStateChange@VIDMM_RECYCLE_HEAP@@QEAAXPEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C009FF70
 * Callers:
 ...
 *     ?AddRangeToTree@VIDMM_RECYCLE_HEAP@@QEAAXW4VIDMM_RECYCLE_HEAP_TREE@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C00F5424 (-AddRangeToTree@VIDMM_RECYCLE_HEAP@@QEAAXW4VIDMM_RECYCLE_HEAP_TREE@@PEAVVIDMM_RECYCLE_RANGE@@@Z.c)
 *     ?RemoveRangeFromTree@VIDMM_RECYCLE_HEAP@@QEAAXW4VIDMM_RECYCLE_HEAP_TREE@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C00F6248 (-RemoveRangeFromTree@VIDMM_RECYCLE_HEAP@@QEAAXW4VIDMM_RECYCLE_HEAP_TREE@@PEAVVIDMM_RECYCLE_RANGE.c)
 */
        ...
        struct VIDMM_RECYCLE_RANGE *a2)
{
  ...
  __int64 v15; // r9
  __int64 v16; // r10
  __int64 Multirange; // r14
  int v18; // eax
  int v19; // eax
  __int64 v20; // r8
  void *v21; // rcx
  __int64 v22; // rbx
  VIDMM_RECYCLE_BLOCK *v23; // rcx
  __int64 v24; // rax
  __int64 v25; // rax
...
LABEL_30:
  ...
  VIDMM_RECYCLE_BLOCK::NotifyMultirangeEvent(*(_QWORD *)(v6 + 80), 1, v6);
  v23 = *(VIDMM_RECYCLE_BLOCK **)(v6 + 80);
  v24 = *((_QWORD *)v23 + 1) - 1LL;
  *((_QWORD *)v23 + 1) = v24;
  if ( !*(_QWORD *)v23 && !v24 )
    VIDMM_RECYCLE_BLOCK::`scalar deleting destructor'(v23);
  *(_BYTE *)(v6 + 232) = 1;
  *(_QWORD *)(v6 + 224) = 0LL;
  v25 = *(unsigned int *)(v22 + 1620);
