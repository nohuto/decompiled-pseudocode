/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C00B2B1C
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C0017870 (VidMmDestroyContextAllocation.c)
 * Callees:
 ...
 *     VidSchRemoveContextAllocation @ 0x1C00B2BA0 (VidSchRemoveContextAllocation.c)
 */
