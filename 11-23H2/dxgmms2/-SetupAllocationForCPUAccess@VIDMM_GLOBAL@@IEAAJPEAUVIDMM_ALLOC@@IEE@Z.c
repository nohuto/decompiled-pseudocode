/*
 * XREFs of ?SetupAllocationForCPUAccess@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@IEE@Z @ 0x1C00E7854
 * Callers:
          ...
          if ( v12 < 0 )
          {
            ...
            if ( bTracingEnabled )
            {
              if ( (byte_1C0076981 & 1) != 0 )
                McTemplateK0q_EtwWriteTransfer(v13, (__int64)&EventPerformanceWarning, v14, 7);
            }
