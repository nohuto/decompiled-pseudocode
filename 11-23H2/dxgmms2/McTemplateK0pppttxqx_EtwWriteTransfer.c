/*
 * XREFs of McTemplateK0pppttxqx_EtwWriteTransfer @ 0x1C0032AA8
 * Callers:
...
NTSTATUS McTemplateK0pppttxqx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventReportCommittedAllocation, a3, 9u, &v4);
}
