/*
 * XREFs of McTemplateK0xxpqhuuuuu_EtwWriteTransfer @ 0x1C00339CC
 * Callers:
...
NTSTATUS McTemplateK0xxpqhuuuuu_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v22 = 1LL;
  v24 = 1LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventVidMmProcessBudgetChange, a3, 0xBu, &v4);
}
