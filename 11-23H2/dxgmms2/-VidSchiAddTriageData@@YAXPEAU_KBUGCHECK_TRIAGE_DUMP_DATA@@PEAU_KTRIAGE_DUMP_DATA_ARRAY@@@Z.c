/*
 * XREFs of ?VidSchiAddTriageData@@YAXPEAU_KBUGCHECK_TRIAGE_DUMP_DATA@@PEAU_KTRIAGE_DUMP_DATA_ARRAY@@@Z @ 0x1C0047CA4
 * Callers:
 *     DxgMmsDbgTriageDumpCallback @ 0x1C002D5C0 (DxgMmsDbgTriageDumpCallback.c)
 * Callees:
 *     <none>
 */
