/*
 * XREFs of VidMmCreateProcess @ 0x1C0005530
 * Callers:
 *     <none>
 * Callees:
 *     ??_GVIDMM_PROCESS@@QEAAPEAXI@Z @ 0x1C002C6B4 (--_GVIDMM_PROCESS@@QEAAPEAXI@Z.c)
 *     ??0VIDMM_PROCESS@@QEAA@XZ @ 0x1C009BF5C (--0VIDMM_PROCESS@@QEAA@XZ.c)
