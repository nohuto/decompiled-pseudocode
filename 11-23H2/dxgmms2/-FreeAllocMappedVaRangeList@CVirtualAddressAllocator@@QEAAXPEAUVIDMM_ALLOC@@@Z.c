/*
 * XREFs of ?FreeAllocMappedVaRangeList@CVirtualAddressAllocator@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C008BC90
 * Callers:
...
LABEL_61:
      ...
      if ( _InterlockedExchangeAdd((volatile signed __int32 *)v30 + 32, 0xFFFFFFFF) == 1 )
      {
        ...
        if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v52, 0LL) )
        {
          ...
          {
            v37 = *((_DWORD *)v52 + 6);
            if ( v37 != -1 && (byte_1C0076981 & 1) != 0 )
              McTemplateK0q_EtwWriteTransfer(v35, (__int64)&EventBlockThread, v36, v37);
          }
