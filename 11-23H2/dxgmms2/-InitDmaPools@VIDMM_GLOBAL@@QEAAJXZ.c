/*
 * XREFs of ?InitDmaPools@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C00C1FD8
 * Callers:
 ...
 *     ??_GVIDMM_DMA_POOL@@QEAAPEAXI@Z @ 0x1C00178CC (--_GVIDMM_DMA_POOL@@QEAAPEAXI@Z.c)
 ...
 *     ??0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z @ 0x1C00B4598 (--0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z.c)
 */
  ...
  if ( *((_DWORD *)this + 1754) )
  {
    while ( 1 )
    {
      ...
      *((_QWORD *)this + v3 + 79) = v7;
      ...
      if ( v8 < 0 )
      {
        _InterlockedAdd(&dword_1C0076814, 1u);
    ...
    _InterlockedAdd(&dword_1C0076810, 1u);
    WdLogSingleEntry1(6LL, 2056LL);
