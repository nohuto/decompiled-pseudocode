/*
 * XREFs of ?TransferToSegment@VIDMM_MEMORY_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_MDL@@_N@Z @ 0x1C00FA564
 * Callers:
 ...
 *     ?FillAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@_KIPEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@@Z @ 0x1C00E2980 (-FillAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@_KIPEAVVIDMM_SEGMENT@@PEAT_LARGE_INT.c)
 ...
 *     ?VidMmiRemoveProbeAndLockReference@@YAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00F17B8 (-VidMmiRemoveProbeAndLockReference@@YAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z.c)
 ...
 *     ?ReclaimScrubRegionResources@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00FECDC (-ReclaimScrubRegionResources@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z.c)
 */
...
LABEL_14:
    ...
    if ( (int)v9 < 0 )
    {
      ...
      if ( (int)v9 < 0 )
      {
        ...
        if ( bTracingEnabled && (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer(v19, (__int64)&EventPerformanceWarning, v20, 2);
        v48 = (SIZE_T)a2 + 536;
        if ( (**((_DWORD **)a2 + 67) & 8) == 0 )
    ...
    if ( *((_DWORD *)this + 103) )
    {
      ...
      if ( v34 < *((_QWORD *)this + 52) )
      {
        ...
        {
          if ( bTracingEnabled && (byte_1C0076981 & 1) != 0 )
            McTemplateK0q_EtwWriteTransfer(v35, (__int64)&EventPerformanceWarning, v36, 24);
...
LABEL_87:
    ...
    else
    {
      ...
      {
        if ( bTracingEnabled && (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer(v30, (__int64)&EventPerformanceWarning, v31, 24);
        KeWaitForSingleObject((char *)*v6 + 41184, Executive, 0, 0, 0LL);
      }
      VIDMM_GLOBAL::EvictAllReclaimedAllocation(*v6, 0LL);
      VIDMM_GLOBAL::WaitForAllPagingEnginesIdle(*v6, *((_DWORD *)this + 95));
