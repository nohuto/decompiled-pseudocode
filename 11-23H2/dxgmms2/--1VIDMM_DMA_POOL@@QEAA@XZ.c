/*
 * XREFs of ??1VIDMM_DMA_POOL@@QEAA@XZ @ 0x1C00B2DFC
 * Callers:
 ...
 *     ?UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ @ 0x1C00B3970 (-UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ.c)
 */
