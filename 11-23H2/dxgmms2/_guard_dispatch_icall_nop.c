/*
 * XREFs of _guard_dispatch_icall_nop @ 0x1C001A870
 * Callers:
 ...
 *     _guard_xfg_dispatch_icall_nop @ 0x1C001A890 (_guard_xfg_dispatch_icall_nop.c)
 ...
 *     ?DeferredWorkQueueCallback@DXG_DEFERRED_WORK_QUEUE@@SAXPEAX@Z @ 0x1C002DC00 (-DeferredWorkQueueCallback@DXG_DEFERRED_WORK_QUEUE@@SAXPEAX@Z.c)
 ...
 *     ?VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR2@@YAEPEAX@Z @ 0x1C0035930 (-VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR2@@YAEPEAX@Z.c)
 *     ?VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR@@YAEPEAX@Z @ 0x1C0035980 (-VidSchiExecuteMmIoFlipMultiPlaneOverlayAtISR@@YAEPEAX@Z.c)
 ...
 *     VidSchIsSyncObjectSignaled @ 0x1C003FF40 (VidSchIsSyncObjectSignaled.c)
 ...
 *     VidSchQueryLastCompletedPresentId @ 0x1C00403C0 (VidSchQueryLastCompletedPresentId.c)
 ...
 *     ?VidSchiSetInterruptTargetPresentIdAtISR@@YAEPEAX@Z @ 0x1C004A600 (-VidSchiSetInterruptTargetPresentIdAtISR@@YAEPEAX@Z.c)
 *     ?VidSchiUpdateFlipQueueLogAtISR@@YAEPEAX@Z @ 0x1C004ADF0 (-VidSchiUpdateFlipQueueLogAtISR@@YAEPEAX@Z.c)
 ...
 *     _tlgEnableCallback @ 0x1C00C3080 (_tlgEnableCallback.c)
 ...
 *     ?ReserveTemporaryResource@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00F7880 (-ReserveTemporaryResource@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z.c)
