/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00E9804
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C002D540 (VidMmValidateHistoryBuffers.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::ValidateHistoryBuffers(VIDMM_GLOBAL *this, struct _VIDMM_MULTI_ALLOC **a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( v4[38] < 2 )
    {
      ...
      VidSchMarkDeviceAsError(*(_QWORD *)(*((_QWORD *)v4 + 1) + 32LL), 17, 0LL);
      return 3221225473LL;
    }
  }
