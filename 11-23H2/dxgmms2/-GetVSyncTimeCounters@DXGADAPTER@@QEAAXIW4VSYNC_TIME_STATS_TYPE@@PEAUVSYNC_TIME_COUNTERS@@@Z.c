/*
 * XREFs of ?GetVSyncTimeCounters@DXGADAPTER@@QEAAXIW4VSYNC_TIME_STATS_TYPE@@PEAUVSYNC_TIME_COUNTERS@@@Z @ 0x1C0034A54
 * Callers:
 ...
 *     VidSchQueryVidPnSourceStatistics @ 0x1C0040660 (VidSchQueryVidPnSourceStatistics.c)
 * Callees:
