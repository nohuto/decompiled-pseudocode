/*
 * XREFs of ?VidMmMapViewOfAllocation@@YAPEAXPEAU_VIDMM_LOCAL_ALLOC@@_K1PEAPEAXH@Z @ 0x1C009D56C
 * Callers:
  ...
  if ( ((unsigned __int8)a1 & (*(_BYTE *)v10 >= 0)) != 0 )
  {
    if ( (v11 & 0x20000000) == 0 )
    {
      ...
      if ( (qword_1C0076010 & 2) != 0 )
      {
        ...
        v30 = 8002;
        if ( byte_1C0076981 < 0 )
          McTemplateK0q_EtwWriteTransfer((__int64)a1, (__int64)&EventProfilerEnter, v9, 8002);
      }
      else
      {
        v32 = 0;
