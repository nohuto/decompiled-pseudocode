/*
 * XREFs of VidSchSignalSyncObjectsFromGpu @ 0x1C0007CC0
 * Callers:
...
LABEL_160:
  ...
  while ( 2 )
  {
    ...
    if ( v23 < v9 )
    {
      ...
      AcquireSpinLock::Acquire((Acquire *)v136);
        ...
        do
        {
          ...
          if ( *Pool2 )
          {
            if ( *((_QWORD *)v84 + 12) )
              ...
              VidSchiFreeQueuePacket(v107, (__int64)v84);
          }
          ++Pool2;
          --v83;
        }
...
LABEL_197:
            v131 = 0;
            v130[0] = v68 + 2464;
            AcquireSpinLock::Acquire((Acquire *)v130);
            v81 = Priorityc;
            while ( 1 )
            {
              v82 = *(_DWORD *)(v62 + 780);
