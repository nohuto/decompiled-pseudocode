/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00E9C6C
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C002D090 (VidMmCreateCompanionContext.c)
 * Callees:
