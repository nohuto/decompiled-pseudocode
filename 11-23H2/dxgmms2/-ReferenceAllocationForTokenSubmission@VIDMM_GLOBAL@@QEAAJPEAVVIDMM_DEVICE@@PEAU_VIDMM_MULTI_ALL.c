/*
 * XREFs of ?ReferenceAllocationForTokenSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00E6D04
 * Callers:
 *     VidMmReferenceAllocationForTokenSubmission @ 0x1C002D280 (VidMmReferenceAllocationForTokenSubmission.c)
 * Callees:
