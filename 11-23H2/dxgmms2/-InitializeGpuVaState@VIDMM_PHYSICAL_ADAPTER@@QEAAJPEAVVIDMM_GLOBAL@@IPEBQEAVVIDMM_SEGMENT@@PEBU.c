/*
 * XREFs of ?InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBUDXGADAPTER_GPUMMUCAPS@@PEBUDXGK_PHYSICALADAPTERINFO@@I@Z @ 0x1C00BD78C
 * Callers:
 ...
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1C004C5C4 (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 */
