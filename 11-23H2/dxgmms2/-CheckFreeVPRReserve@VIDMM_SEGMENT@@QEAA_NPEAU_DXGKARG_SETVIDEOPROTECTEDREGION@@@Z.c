/*
 * XREFs of ?CheckFreeVPRReserve@VIDMM_SEGMENT@@QEAA_NPEAU_DXGKARG_SETVIDEOPROTECTEDREGION@@@Z @ 0x1C00FC66C
 * Callers:
 ...
 *     ?FreeVPRReserve@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00FD158 (-FreeVPRReserve@VIDMM_SEGMENT@@QEAAXXZ.c)
 */
