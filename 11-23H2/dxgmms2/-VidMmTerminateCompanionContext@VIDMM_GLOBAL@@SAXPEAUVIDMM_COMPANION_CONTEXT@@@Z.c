/*
 * XREFs of ?VidMmTerminateCompanionContext@VIDMM_GLOBAL@@SAXPEAUVIDMM_COMPANION_CONTEXT@@@Z @ 0x1C00EA7BC
 * Callers:
 *     VidMmTerminateCompanionContext @ 0x1C002D440 (VidMmTerminateCompanionContext.c)
 * Callees:
