/*
 * XREFs of McTemplateK0pqqtq_EtwWriteTransfer @ 0x1C0038D98
 * Callers:
...
NTSTATUS McTemplateK0pqqtq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &MmIoFlipRetry, a3, 6u, &v4);
}
