/*
 * XREFs of VidSchiSendToExecutionQueue @ 0x1C000C930
 * Callers:
 ...
 *     VidSchiFillSubmitCommandDataVirtual @ 0x1C000E830 (VidSchiFillSubmitCommandDataVirtual.c)
 *     VidSchiFillSubmitCommandData @ 0x1C0018178 (VidSchiFillSubmitCommandData.c)
...
LABEL_47:
  ...
  if ( !v38 || (*(_DWORD *)(v38 + 76) & 0x80u) == 0 )
  {
    *(_DWORD *)(a1 + 92) |= 0x20u;
    ...
    if ( v70 )
    {
      VidSchMarkDeviceAsError(v2, 19, 0LL);
      LOBYTE(v67) = 1;
