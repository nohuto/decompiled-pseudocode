/*
 * XREFs of ?Init@VIDMM_GLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAU_DXGK_QUERYSEGMENTOUT4@@KI@Z @ 0x1C00BB4C0
 * Callers:
 ...
 *     ??0DXGAUTOEXPUSHLOCKEXCLUSIVE@@QEAA@QEAU_EX_PUSH_LOCK@@@Z @ 0x1C002D630 (--0DXGAUTOEXPUSHLOCKEXCLUSIVE@@QEAA@QEAU_EX_PUSH_LOCK@@@Z.c)
 *     ??1DXGAUTOEXPUSHLOCKEXCLUSIVE@@QEAA@XZ @ 0x1C002D6F0 (--1DXGAUTOEXPUSHLOCKEXCLUSIVE@@QEAA@XZ.c)
 *     ??0VIDMM_WORKER_THREAD@@QEAA@PEAVVIDMM_GLOBAL@@@Z @ 0x1C00BC2FC (--0VIDMM_WORKER_THREAD@@QEAA@PEAVVIDMM_GLOBAL@@@Z.c)
 *     ?Init@VIDMM_WORKER_THREAD@@QEAAJPEAPEAU_KEVENT@@@Z @ 0x1C00BC494 (-Init@VIDMM_WORKER_THREAD@@QEAAJPEAPEAU_KEVENT@@@Z.c)
...
LABEL_7:
  ...
  *((_QWORD *)this + 5028) = v19;
  if ( !v19 )
  {
    _InterlockedIncrement(&dword_1C00767CC);
    WdLogSingleEntry1(6LL, 1577LL);
      ...
      if ( v81 )
      {
        ...
        if ( VaAllocator >= 0 )
        {
          ...
          *((_QWORD *)this + 990) = MEMORY[0xFFFFF78000000014];
          ...
          v88 = (_QWORD *)qword_1C0076938;
          v89 = (_QWORD *)((char *)this + 44768);
          if ( *(PVOID **)qword_1C0076938 != &VIDMM_GLOBAL::_AdapterListHead )
            __fastfail(3u);
          *v89 = &VIDMM_GLOBAL::_AdapterListHead;
          v89[1] = v88;
          *v88 = v89;
          qword_1C0076938 = (__int64)v89;
...
LABEL_142:
  ...
  _InterlockedIncrement(&dword_1C0076804);
  WdLogSingleEntry1(6LL, 1764LL);
