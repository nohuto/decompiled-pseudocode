/*
 * XREFs of ?DelayExecution@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@IPEAVVIDMM_PAGING_QUEUE@@KPEA_K@Z @ 0x1C00E1670
 * Callers:
 *     ?VidMmDelayExecution@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@IPEAVVIDMM_PAGING_QUEUE@@KPEA_K@Z @ 0x1C002C9E0 (-VidMmDelayExecution@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@IPEAVVIDMM_PAGING_QUEUE@@KPEA_K@Z.c)
 * Callees:
