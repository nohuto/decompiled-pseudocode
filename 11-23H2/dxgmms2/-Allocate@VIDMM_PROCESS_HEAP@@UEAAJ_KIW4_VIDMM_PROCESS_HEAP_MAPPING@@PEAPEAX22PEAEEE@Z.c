/*
 * XREFs of ?Allocate@VIDMM_PROCESS_HEAP@@UEAAJ_KIW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAX22PEAEEE@Z @ 0x1C0102F60
 * Callers:
 *     <none>
 * Callees:
        ...
        char a9)
{
  ...
  *v17 = 0LL;
  ...
  if ( v19 < (unsigned int)dword_1C00763E8 )
  {
    ...
    {
      if ( byte_1C0076981 < 0 )
        McTemplateK0q_EtwWriteTransfer(v21, (__int64)&EventProfilerExit, v22, v62);
    }
...
LABEL_54:
            ...
            DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v62);
            if ( v64 && byte_1C0076981 < 0 )
              McTemplateK0q_EtwWriteTransfer(v41, (__int64)&EventProfilerExit, v42, v62);
...
LABEL_60:
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 8) + 144LL) += Size;
  ...
  DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v62);
  if ( v64 && byte_1C0076981 < 0 )
    McTemplateK0q_EtwWriteTransfer(v50, (__int64)&EventProfilerExit, v51, v62);
  return 0LL;
}
