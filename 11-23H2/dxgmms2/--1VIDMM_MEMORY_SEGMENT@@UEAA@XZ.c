/*
 * XREFs of ??1VIDMM_MEMORY_SEGMENT@@UEAA@XZ @ 0x1C00F8BD8
 * Callers:
 *     ??_EVIDMM_MEMORY_SEGMENT@@UEAAPEAXI@Z @ 0x1C0032680 (--_EVIDMM_MEMORY_SEGMENT@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1VIDMM_CPU_HOST_APERTURE@@QEAA@XZ @ 0x1C0032ECC (--1VIDMM_CPU_HOST_APERTURE@@QEAA@XZ.c)
