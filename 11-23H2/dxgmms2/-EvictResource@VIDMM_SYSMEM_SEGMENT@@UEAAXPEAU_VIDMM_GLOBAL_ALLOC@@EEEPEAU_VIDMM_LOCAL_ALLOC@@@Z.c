/*
 * XREFs of ?EvictResource@VIDMM_SYSMEM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@EEEPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C0094EB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     UnlockChildPages @ 0x1C002CFDC (UnlockChildPages.c)
 *     UnmapGpadl @ 0x1C002D028 (UnmapGpadl.c)
 ...
 *     ?IoMmuUnmapAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C00E40E4 (-IoMmuUnmapAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_VIDMM_LOCAL_ALLOC@@@Z.c)
        ...
        struct _VIDMM_LOCAL_ALLOC *a6)
{
  ...
  else
  {
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)a2 + 304, 0LL) )
    {
      ...
      {
        v85 = *((_DWORD *)a2 + 83);
        if ( v85 != -1 && (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer(v16, (__int64)&EventBlockThread, v15, v85);
      }
...
LABEL_67:
    if ( bTracingEnabled && (byte_1C0076981 & 0x10) != 0 )
