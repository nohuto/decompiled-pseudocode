/*
 * XREFs of ?BeginCPUAccess@VIDMM_DMA_POOL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@PEAPEAX@Z @ 0x1C009208C
 * Callers:
 *     VidMmBeginDmaBufferCPUAccess @ 0x1C0004EC0 (VidMmBeginDmaBufferCPUAccess.c)
