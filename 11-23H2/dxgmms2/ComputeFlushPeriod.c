/*
 * XREFs of ComputeFlushPeriod @ 0x1C00BE194
 * Callers:
 *     TlgRegisterAggregateProviderEx @ 0x1C00BDEA4 (TlgRegisterAggregateProviderEx.c)
 * Callees:
 *     FinishHash @ 0x1C0018938 (FinishHash.c)
 *     RunningHash @ 0x1C0019624 (RunningHash.c)
