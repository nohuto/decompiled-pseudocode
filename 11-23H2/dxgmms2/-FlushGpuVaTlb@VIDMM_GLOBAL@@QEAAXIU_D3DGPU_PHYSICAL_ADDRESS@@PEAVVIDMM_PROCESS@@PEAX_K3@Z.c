/*
 * XREFs of ?FlushGpuVaTlb@VIDMM_GLOBAL@@QEAAXIU_D3DGPU_PHYSICAL_ADDRESS@@PEAVVIDMM_PROCESS@@PEAX_K3@Z @ 0x1C00983F0
 * Callers:
    ...
    if ( (*v35 & 0x20) != 0 )
    {
      ...
      if ( (*((_DWORD *)v61 + 24) & 2) == 0 )
      {
        if ( bTracingEnabled && (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer((__int64)v35, (__int64)&EventPerformanceWarning, v27, 23);
        v56 = -1;
        v57 = 0LL;
        if ( (qword_1C0076010 & 2) != 0 )
        {
          ...
          v56 = 8010;
          if ( byte_1C0076981 < 0 )
            McTemplateK0q_EtwWriteTransfer((__int64)v35, (__int64)&EventProfilerEnter, v27, 8010);
        }
        else
        {
          v58 = 0;
