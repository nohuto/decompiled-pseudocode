/*
 * XREFs of ?QueryAdapterStatistics@VIDMM_GLOBAL@@QEAAJGPEAU_D3DKMT_QUERYSTATISTICS_ADAPTER_INFORMATION@@@Z @ 0x1C00EDE0C
 * Callers:
 *     VidMmQueryAdapterStatistics @ 0x1C002D1F0 (VidMmQueryAdapterStatistics.c)
 * Callees:
 *     <none>
 */
