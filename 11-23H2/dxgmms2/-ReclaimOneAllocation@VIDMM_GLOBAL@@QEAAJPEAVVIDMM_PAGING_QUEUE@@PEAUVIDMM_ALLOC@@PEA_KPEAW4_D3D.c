/*
 * XREFs of ?ReclaimOneAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PAGING_QUEUE@@PEAUVIDMM_ALLOC@@PEA_KPEAW4_D3DDDI_RECLAIM_RESULT@@@Z @ 0x1C00AF740
 * Callers:
 ...
 *     ?ForceDecommitOffer@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C00E3420 (-ForceDecommitOffer@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z.c)
        ...
        enum _D3DDDI_RECLAIM_RESULT *a5)
{
  ...
  if ( (v8 & 0x40) != 0 && !a5 )
  {
    ...
    VidSchMarkDeviceAsError(a3[1][4], 20, 0LL);
    return 3221225485LL;
  }
  v9 = *((_DWORD *)this + 1764);
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)this + 39976, 0LL) )
  {
    if ( bTracingEnabled )
    {
      ...
      if ( v38 != -1 && (byte_1C0076981 & 1) != 0 )
        McTemplateK0q_EtwWriteTransfer(v12, (__int64)&EventBlockThread, v13, v38);
    }
  ...
  *((_QWORD *)this + 4998) = 0LL;
  ...
  else
  {
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v7 + 304, 0LL) )
    {
      ...
      {
        v41 = *(_DWORD *)(v7 + 332);
        if ( v41 != -1 && (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer(v19, (__int64)&EventBlockThread, v18, v41);
      }
