/*
 * XREFs of McTemplateK0pqqqqXR4XR4_EtwWriteTransfer @ 0x1C0038CC4
 * Callers:
...
NTSTATUS McTemplateK0pqqqqXR4XR4_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8 * v29;
  v19 = 8 * v29;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventVSyncHwFlipQueueLogUpdate, a3, 8u, &v4);
}
