/*
 * XREFs of McTemplateK0xqxxxxqxqxx_EtwWriteTransfer @ 0x1C0039E40
 * Callers:
...
NTSTATUS McTemplateK0xqxxxxqxqxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v24 = 8LL;
  v26 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &GpuPerfTracing, a3, 0xCu, &v4);
}
