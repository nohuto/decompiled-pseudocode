/*
 * XREFs of wil_details_IsEnabledFallback @ 0x1C000CD20
 * Callers:
 ...
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x1C000CDB4 (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
