/*
 * XREFs of HUBUCX_StartDeviceIoUsingUCXIoctl @ 0x1C00291FC
 * Callers:
 *     HUBDSM_StartingDeviceIoOnDeviceResumeOnHwWake @ 0x1C00205C0 (HUBDSM_StartingDeviceIoOnDeviceResumeOnHwWake.c)
 * Callees:
