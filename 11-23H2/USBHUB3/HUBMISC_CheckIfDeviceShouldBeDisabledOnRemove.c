/*
 * XREFs of HUBMISC_CheckIfDeviceShouldBeDisabledOnRemove @ 0x1C00305B4
 * Callers:
 *     HUBDSM_CheckingIfDeviceShouldBeDisabled @ 0x1C001F180 (HUBDSM_CheckingIfDeviceShouldBeDisabled.c)
 * Callees:
