/*
 * XREFs of HUBPARENT_GetInfoFromParentUsingParentIoctl @ 0x1C00081CC
 * Callers:
 *     HUBHSM_GettingAdditionalInfoFromParent @ 0x1C0009CF0 (HUBHSM_GettingAdditionalInfoFromParent.c)
 * Callees:
