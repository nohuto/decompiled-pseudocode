/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSExtendedConfigDescriptor @ 0x1C002C988
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedConfigDescriptor @ 0x1C0022010 (HUBDSM_ValidatingMSOSExtendedConfigDescriptor.c)
 * Callees:
