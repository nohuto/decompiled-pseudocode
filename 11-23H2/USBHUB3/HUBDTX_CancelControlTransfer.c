/*
 * XREFs of HUBDTX_CancelControlTransfer @ 0x1C002A950
 * Callers:
 *     HUBDSM_CancellingControlTransferOnHubStopInRemainingDescriptors @ 0x1C00210C0 (HUBDSM_CancellingControlTransferOnHubStopInRemainingDescriptors.c)
 * Callees:
