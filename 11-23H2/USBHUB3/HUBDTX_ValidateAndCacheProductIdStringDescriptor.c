/*
 * XREFs of HUBDTX_ValidateAndCacheProductIdStringDescriptor @ 0x1C002CB34
 * Callers:
 *     HUBDSM_ValidatingLanguageSpecificProductIdString @ 0x1C0020850 (HUBDSM_ValidatingLanguageSpecificProductIdString.c)
 * Callees:
