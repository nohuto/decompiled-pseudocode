/*
 * XREFs of HUBUCX_EnableDisableEndpointsUsingUCXIoctl @ 0x1C00268F8
 * Callers:
 ...
 *     HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency @ 0x1C0023D70 (HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency.c)
