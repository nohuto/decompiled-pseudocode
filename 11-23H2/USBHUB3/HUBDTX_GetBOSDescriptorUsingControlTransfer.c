/*
 * XREFs of HUBDTX_GetBOSDescriptorUsingControlTransfer @ 0x1C002AD8C
 * Callers:
 *     HUBDSM_GettingAlternateBOSDescriptor @ 0x1C0022650 (HUBDSM_GettingAlternateBOSDescriptor.c)
 * Callees:
