/*
 * XREFs of HUBDTX_ValidateAndCacheDeviceDescriptor @ 0x1C002BF64
 * Callers:
 *     HUBDSM_ValidatingAlternateDeviceDescriptor @ 0x1C00214E0 (HUBDSM_ValidatingAlternateDeviceDescriptor.c)
 * Callees:
