/*
 * XREFs of FWUPDATE_ReenumerateFirmwareUpdateDevice @ 0x1C00407DC
 * Callers:
 ...
 *     HUBHSM_WaitingForPortsToAcquireReferenceOnStart @ 0x1C0009450 (HUBHSM_WaitingForPortsToAcquireReferenceOnStart.c)
 * Callees:
