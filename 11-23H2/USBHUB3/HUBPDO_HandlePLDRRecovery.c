/*
 * XREFs of HUBPDO_HandlePLDRRecovery @ 0x1C001A08C
 * Callers:
...
__int64 __fastcall HUBPDO_HandlePLDRRecovery(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    LODWORD(Lock) = WPP_MAIN_CB.DeviceLock.Header.LockNV | 1;
    wil_details_FeatureReporting_ReportUsageToService((__int64)&Feature_PLDRRecovery__private_descriptor, Lock, 3);
