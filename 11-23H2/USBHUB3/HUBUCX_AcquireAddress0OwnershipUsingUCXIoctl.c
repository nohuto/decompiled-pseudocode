/*
 * XREFs of HUBUCX_AcquireAddress0OwnershipUsingUCXIoctl @ 0x1C0026674
 * Callers:
 *     HUBDSM_AcquiringAddressZeroOwnershipOnRenum @ 0x1C0020870 (HUBDSM_AcquiringAddressZeroOwnershipOnRenum.c)
 * Callees:
