/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x1C0044228
 * Callers:
 *     _tlgWriteAgg @ 0x1C00447DC (_tlgWriteAgg.c)
 * Callees:
 *     EnableFlushTimer @ 0x1C0043EF8 (EnableFlushTimer.c)
 *     CreateNewEventEntry @ 0x1C0043FA4 (CreateNewEventEntry.c)
 *     memcmp @ 0x1C0044B90 (memcmp.c)
 */
