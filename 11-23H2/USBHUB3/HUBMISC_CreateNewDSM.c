/*
 * XREFs of HUBMISC_CreateNewDSM @ 0x1C0031328
 * Callers:
 *     HUBPSM30_CreatingDeviceInConnectedWithResetInProgress @ 0x1C0011C30 (HUBPSM30_CreatingDeviceInConnectedWithResetInProgress.c)
 * Callees:
