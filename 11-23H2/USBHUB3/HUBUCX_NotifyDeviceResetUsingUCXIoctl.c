/*
 * XREFs of HUBUCX_NotifyDeviceResetUsingUCXIoctl @ 0x1C0026728
 * Callers:
 *     HUBDSM_NotifyingDeviceResetToUCXAfterReset2 @ 0x1C0020CA0 (HUBDSM_NotifyingDeviceResetToUCXAfterReset2.c)
 * Callees:
