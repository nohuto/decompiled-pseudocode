/*
 * XREFs of HUBPDO_FindAndStoreMatchingInternalPipeHandle @ 0x1C001731C
 * Callers:
 *     HUBDSM_GettingMatchingPipeHandleOnClientResetPipe @ 0x1C001F940 (HUBDSM_GettingMatchingPipeHandleOnClientResetPipe.c)
 * Callees:
