/*
 * XREFs of HUBDTX_GetDeviceDescriptorUsingControlTransfer @ 0x1C002AB88
 * Callers:
 *     HUBDSM_GettingAlternateDeviceDescriptor @ 0x1C0021370 (HUBDSM_GettingAlternateDeviceDescriptor.c)
 * Callees:
