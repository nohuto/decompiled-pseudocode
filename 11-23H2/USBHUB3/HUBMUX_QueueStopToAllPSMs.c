/*
 * XREFs of HUBMUX_QueueStopToAllPSMs @ 0x1C0010AC4
 * Callers:
 *     HUBHSM_NotifyingHubStopToPortsOnReset @ 0x1C0008C20 (HUBHSM_NotifyingHubStopToPortsOnReset.c)
 *     HUBHSM_WaitingForPortsToReleaseReferenceOnResetOnResume @ 0x1C0008C50 (HUBHSM_WaitingForPortsToReleaseReferenceOnResetOnResume.c)
 * Callees:
