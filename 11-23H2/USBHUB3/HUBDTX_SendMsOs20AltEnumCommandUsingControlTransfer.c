/*
 * XREFs of HUBDTX_SendMsOs20AltEnumCommandUsingControlTransfer @ 0x1C002ACA8
 * Callers:
 *     HUBDSM_SendingMsOs20AltEnumCmdOnReenum @ 0x1C00213C0 (HUBDSM_SendingMsOs20AltEnumCmdOnReenum.c)
 * Callees:
