/*
 * XREFs of HUBPSM20_Suspending @ 0x1C00127D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM20_Suspending(__int64 a1)
{
  __int64 v1; // rbx
  char v2; // al
  __int64 *v3; // rdi
  ...
  *(_DWORD *)(v1 + 172) = *(unsigned __int16 *)(v1 + 200);
  v3 = (__int64 *)(v1 + 1432);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v6 = *(unsigned __int16 *)(v1 + 200);
    WPP_RECORDER_SF_d(*v3, 4u, 4u, 0x42u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v6);
  }
  ...
  if ( v4 < 0 )
  {
    ...
    {
      LODWORD(v7) = v4;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x43u, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v7);
    }
