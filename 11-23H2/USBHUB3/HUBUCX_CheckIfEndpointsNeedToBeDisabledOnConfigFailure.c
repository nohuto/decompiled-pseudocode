/*
 * XREFs of HUBUCX_CheckIfEndpointsNeedToBeDisabledOnConfigFailure @ 0x1C0029558
 * Callers:
 *     HUBDSM_CheckingIfEndpointsToBeDisabledOnDetach @ 0x1C0024FB0 (HUBDSM_CheckingIfEndpointsToBeDisabledOnDetach.c)
 * Callees:
