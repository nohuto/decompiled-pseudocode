/*
 * XREFs of HUBDTX_GetInitialDeviceDescriptorUsingControlTransfer @ 0x1C002AC18
 * Callers:
 *     HUBDSM_GettingDeviceDescriptorInReEnumAtZero @ 0x1C0020C40 (HUBDSM_GettingDeviceDescriptorInReEnumAtZero.c)
 * Callees:
