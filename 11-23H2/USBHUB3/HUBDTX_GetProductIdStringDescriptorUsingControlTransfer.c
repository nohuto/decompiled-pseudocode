/*
 * XREFs of HUBDTX_GetProductIdStringDescriptorUsingControlTransfer @ 0x1C002B658
 * Callers:
 *     HUBDSM_QueryingLanguageSpecificProductIdString @ 0x1C00207D0 (HUBDSM_QueryingLanguageSpecificProductIdString.c)
 * Callees:
