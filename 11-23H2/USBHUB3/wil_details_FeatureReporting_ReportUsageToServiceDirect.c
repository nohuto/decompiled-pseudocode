/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x1C000C778
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x1C000C99C (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_IncrementUsageInCache @ 0x1C000C58C (wil_details_FeatureReporting_IncrementUsageInCache.c)
 *     wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x1C000C684 (wil_details_FeatureReporting_IncrementOpportunityInCache.c)
