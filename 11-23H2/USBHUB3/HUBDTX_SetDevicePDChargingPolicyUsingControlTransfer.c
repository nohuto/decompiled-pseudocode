/*
 * XREFs of HUBDTX_SetDevicePDChargingPolicyUsingControlTransfer @ 0x1C002D7FC
 * Callers:
 *     HUBDSM_SettingDevicePDChargingPolicy @ 0x1C0020A10 (HUBDSM_SettingDevicePDChargingPolicy.c)
 * Callees:
