/*
 * XREFs of HUBPSM30_SettingU1TImeOut @ 0x1C00136A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM30_SettingU1TImeOut(__int64 a1)
{
  ...
  *(_WORD *)(v1 + 174) = 0;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_SF_DD(*v3, 4u, 4u, 0x3Cu, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v6, v8);
  }
  ...
  if ( v4 < 0 )
  {
    ...
    {
      LODWORD(v7) = v4;
      WPP_RECORDER_SF_d(*v3, 2u, 4u, 0x3Du, (__int64)&WPP_65667e477e4f3bda131abce8e5de791a_Traceguids, v7);
    }
