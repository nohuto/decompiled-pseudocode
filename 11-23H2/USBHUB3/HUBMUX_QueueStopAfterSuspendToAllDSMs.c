/*
 * XREFs of HUBMUX_QueueStopAfterSuspendToAllDSMs @ 0x1C00112D8
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove @ 0x1C0008BF0 (HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove.c)
 * Callees:
