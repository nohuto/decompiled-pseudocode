/*
 * XREFs of EnableFlushTimer @ 0x1C0043EF8
 * Callers:
 *     ?TlgAggregateInternalFlushTimerCallbackKernelMode@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C0043F60 (-TlgAggregateInternalFlushTimerCallbackKernelMode@@YAXPEAU_EX_TIMER@@PEAX@Z.c)
 *     InsertEventEntryInLookUpTable @ 0x1C0044228 (InsertEventEntryInLookUpTable.c)
