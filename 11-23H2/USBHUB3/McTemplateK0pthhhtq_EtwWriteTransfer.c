/*
 * XREFs of McTemplateK0pthhhtq_EtwWriteTransfer @ 0x1C00148D8
 * Callers:
...
NTSTATUS McTemplateK0pthhhtq_EtwWriteTransfer(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &USBHUB3_ETW_EVENT_DEVICE_REENUMERATIONCALLBACK_PUBLISH_INFO, a3, 8u, &v4);
}
