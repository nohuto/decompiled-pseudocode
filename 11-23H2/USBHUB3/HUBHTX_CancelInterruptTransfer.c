/*
 * XREFs of HUBHTX_CancelInterruptTransfer @ 0x1C0003E2C
 * Callers:
 *     HUBHSM_CancellingInterruptTransferOnSuspend @ 0x1C00084B0 (HUBHSM_CancellingInterruptTransferOnSuspend.c)
 * Callees:
