/*
 * XREFs of HUBDTX_ValidateFirstDeviceDescriptorFor20 @ 0x1C002C23C
 * Callers:
 *     HUBDSM_ValidatingDeviceDescriptorInReEnumAtZero @ 0x1C0020EF0 (HUBDSM_ValidatingDeviceDescriptorInReEnumAtZero.c)
 * Callees:
