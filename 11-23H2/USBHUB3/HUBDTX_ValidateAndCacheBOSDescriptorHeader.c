/*
 * XREFs of HUBDTX_ValidateAndCacheBOSDescriptorHeader @ 0x1C002B340
 * Callers:
 *     HUBDSM_ValidatingAlternateBOSDescriptorHeader @ 0x1C0022B30 (HUBDSM_ValidatingAlternateBOSDescriptorHeader.c)
 * Callees:
