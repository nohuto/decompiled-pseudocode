/*
 * XREFs of InitializeTelemetryAssertsKMByDriverObject @ 0x1C004153C
 * Callers:
 *     DriverEntry @ 0x1C0093240 (DriverEntry.c)
 * Callees:
 *     InitializeTelemetryAssertsKMWorkerInternal @ 0x1C0041468 (InitializeTelemetryAssertsKMWorkerInternal.c)
 */
