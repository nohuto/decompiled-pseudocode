/*
 * XREFs of HUBMISC_CheckIfU2ShouldBeSetForEnumeratedDevice @ 0x1C003077C
 * Callers:
 *     HUBDSM_ComputingLPMTimeoutValuesInUnconfigured @ 0x1C00256D0 (HUBDSM_ComputingLPMTimeoutValuesInUnconfigured.c)
