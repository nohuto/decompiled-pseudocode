/*
 * XREFs of HUBDTX_ValidateAndCacheLanguageIdStringDescriptor @ 0x1C002C434
 * Callers:
 *     HUBDSM_ValidatingLanguageIdStringDescriptor @ 0x1C0021690 (HUBDSM_ValidatingLanguageIdStringDescriptor.c)
 * Callees:
