/*
 * XREFs of HUBMUX_AcquireInterruptReference @ 0x1C0010F5C
 * Callers:
 *     HUBPSM30_AcquiringInterruptReferenceOnHSMInEnabled @ 0x1C0011A90 (HUBPSM30_AcquiringInterruptReferenceOnHSMInEnabled.c)
 * Callees:
 *     <none>
 */
