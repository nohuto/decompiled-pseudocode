/*
 * XREFs of FxDriverEntryWorker @ 0x1C0041084
 * Callers:
 *     FxDriverEntry @ 0x1C0041050 (FxDriverEntry.c)
 * Callees:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_1C006DA10;
...
LABEL_10:
    ...
    {
      DriverUnload = qword_1C006DC18;
      if ( DriverObject->DriverUnload )
        DriverUnload = (__int64 (*)(void))DriverObject->DriverUnload;
      qword_1C006DC18 = DriverUnload;
