/*
 * XREFs of HUBPDO_CompleteClientSerialRequestWithStatusFailed @ 0x1C0015900
 * Callers:
 *     HUBDSM_CompletingClientRequestOnFailureInDisabled @ 0x1C001F3D0 (HUBDSM_CompletingClientRequestOnFailureInDisabled.c)
