/*
 * XREFs of USBD_CreateHandle @ 0x1C004249C
 * Callers:
 *     HUBFDO_SetupHubPostErrataQuery @ 0x1C000F088 (HUBFDO_SetupHubPostErrataQuery.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C0041CD8 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
