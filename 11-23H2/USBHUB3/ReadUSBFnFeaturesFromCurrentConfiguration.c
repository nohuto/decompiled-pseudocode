/*
 * XREFs of ReadUSBFnFeaturesFromCurrentConfiguration @ 0x1C004355C
 * Callers:
 ...
 *     MyRegOpenKeyForRead @ 0x1C0043A5C (MyRegOpenKeyForRead.c)
 *     MyRegQueryString @ 0x1C0043ADC (MyRegQueryString.c)
 */
