/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSContainerIdDescriptorHeader @ 0x1C002C610
 * Callers:
 *     HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor @ 0x1C0021EF0 (HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor.c)
 * Callees:
