/*
 * XREFs of HUBPDO_ReleaseWdfPowerReferenceOnHub @ 0x1C001B500
 * Callers:
 *     HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure @ 0x1C001FD70 (HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure.c)
 * Callees:
