/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1C0041468
 * Callers:
 *     InitializeTelemetryAssertsKMByDriverObject @ 0x1C004153C (InitializeTelemetryAssertsKMByDriverObject.c)
 * Callees:
