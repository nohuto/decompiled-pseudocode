/*
 * XREFs of HUBDTX_GetBOSDescriptorHeaderUsingControlTransfer @ 0x1C002B554
 * Callers:
 *     HUBDSM_GettingBOSDescriptorHeader @ 0x1C0022680 (HUBDSM_GettingBOSDescriptorHeader.c)
 * Callees:
