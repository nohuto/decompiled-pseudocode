/*
 * XREFs of HUBMISC_CheckIfDeviceProgrammingWasLost @ 0x1C0031084
 * Callers:
 *     HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum @ 0x1C0020940 (HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum.c)
 * Callees:
 *     <none>
 */
