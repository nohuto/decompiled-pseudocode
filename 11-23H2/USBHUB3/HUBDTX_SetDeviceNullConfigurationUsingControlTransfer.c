/*
 * XREFs of HUBDTX_SetDeviceNullConfigurationUsingControlTransfer @ 0x1C002B8E4
 * Callers:
 *     HUBDSM_DeConfiguringDeviceOnClientRequest @ 0x1C001F610 (HUBDSM_DeConfiguringDeviceOnClientRequest.c)
 * Callees:
