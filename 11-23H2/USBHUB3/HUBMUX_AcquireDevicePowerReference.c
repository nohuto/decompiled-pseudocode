/*
 * XREFs of HUBMUX_AcquireDevicePowerReference @ 0x1C00118D4
 * Callers:
 *     HUBDSM_AcquiringPowerReferenceOnHubResume @ 0x1C001F130 (HUBDSM_AcquiringPowerReferenceOnHubResume.c)
 * Callees:
