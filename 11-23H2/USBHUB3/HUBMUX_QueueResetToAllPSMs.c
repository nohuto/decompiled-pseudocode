/*
 * XREFs of HUBMUX_QueueResetToAllPSMs @ 0x1C0010D10
 * Callers:
 *     HUBHSM_NotifyingHubResetToPortsOnResetOnResume @ 0x1C0008A90 (HUBHSM_NotifyingHubResetToPortsOnResetOnResume.c)
 * Callees:
