/*
 * XREFs of HUBDTX_ClearEndpointHaltUsingControlTransfer @ 0x1C002C818
 * Callers:
 *     HUBDSM_ClearingEndpointHaltOnClientResetPipe @ 0x1C001F310 (HUBDSM_ClearingEndpointHaltOnClientResetPipe.c)
 * Callees:
