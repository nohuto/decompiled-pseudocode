/*
 * XREFs of HUBDTX_ValidateAndCacheConfigDescriptor @ 0x1C002B9AC
 * Callers:
 *     HUBDSM_ValidatingAlternateConfigurationDescriptor @ 0x1C00214C0 (HUBDSM_ValidatingAlternateConfigurationDescriptor.c)
 * Callees:
