/*
 * XREFs of HUBHTX_ValidateAndCacheHubConfigDescriptor @ 0x1C00036A4
 * Callers:
 *     HUBHSM_ValidatingHubConfigurationDescriptor @ 0x1C0009C00 (HUBHSM_ValidatingHubConfigurationDescriptor.c)
 * Callees:
