/*
 * XREFs of HUBPDO_CompleteClientSerialRequestWithStatusSuccess @ 0x1C0015728
 * Callers:
 *     HUBDSM_CompletingClientRequestInConfiguredWithSpecialFile @ 0x1C001F370 (HUBDSM_CompletingClientRequestInConfiguredWithSpecialFile.c)
