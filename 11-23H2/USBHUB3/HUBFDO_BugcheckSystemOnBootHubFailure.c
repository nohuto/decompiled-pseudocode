/*
 * XREFs of HUBFDO_BugcheckSystemOnBootHubFailure @ 0x1C000EF18
 * Callers:
 *     HUBHSM_BugcheckingSystemOnExcessiveResetsForHubInBootPath @ 0x1C0008490 (HUBHSM_BugcheckingSystemOnExcessiveResetsForHubInBootPath.c)
 * Callees:
