/*
 * XREFs of HUBDTX_LogBillboardEvent @ 0x1C002D040
 * Callers:
 *     HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried @ 0x1C0022400 (HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried.c)
