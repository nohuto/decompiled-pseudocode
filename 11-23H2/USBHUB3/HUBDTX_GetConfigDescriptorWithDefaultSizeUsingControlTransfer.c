/*
 * XREFs of HUBDTX_GetConfigDescriptorWithDefaultSizeUsingControlTransfer @ 0x1C002A9C4
 * Callers:
 *     HUBDSM_GettingConfigDescriptorWhileRenuemrating @ 0x1C0021310 (HUBDSM_GettingConfigDescriptorWhileRenuemrating.c)
 * Callees:
