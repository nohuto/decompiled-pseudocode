/*
 * XREFs of AcpiEval_CSD @ 0x1C002A368
 * Callers:
...
__int64 __fastcall AcpiEval_CSD(__int64 a1, _QWORD *a2)
{
  ...
  unsigned __int8 v16[2]; // [rsp+50h] [rbp-79h] BYREF
  ...
  v6 = AcpiEvaluateMethod(a1, 1146307423, 0LL, (unsigned int **)&P, &v14);
  if ( v6 < 0 )
    goto LABEL_2;
  if ( !v14 )
  {
...
LABEL_11:
  ...
  if ( Pool2 )
  {
    ...
    *Pool2 = *((unsigned __int8 *)v7 + 8);
    while ( 1 )
    {
      if ( v11 >= (_WORD *)((char *)v7 + *((unsigned int *)v7 + 1)) )
      {
        *a2 = Pool2;
        goto LABEL_5;
      }
