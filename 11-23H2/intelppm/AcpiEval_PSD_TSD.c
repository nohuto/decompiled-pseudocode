/*
 * XREFs of AcpiEval_PSD_TSD @ 0x1C002A118
 * Callers:
...
__int64 __fastcall AcpiEval_PSD_TSD(__int64 a1, int a2, _QWORD *a3)
{
  ...
  unsigned __int8 v21[2]; // [rsp+60h] [rbp-69h] BYREF
  ...
  v8 = AcpiEvaluateMethod(a1, v17, 0LL, (unsigned int **)&P, &v18);
  if ( v8 >= 0 )
  {
    if ( v18 )
    {
      ...
      if ( v10 )
      {
        ...
        if ( Pool2 )
        {
          ...
          *Pool2 = *((unsigned __int8 *)v9 + 8);
          while ( 1 )
          {
            if ( v11 >= (_WORD *)((char *)v9 + *((unsigned int *)v9 + 1)) )
            {
              *a3 = Pool2;
              goto LABEL_15;
            }
            ...
            if ( (unsigned __int16)v14 < 4u )
              v14 = 4LL;
            v11 = (_WORD *)((char *)v11 + v14 + 4);
            ++v3;
          }
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_sd((__int64)WPP_GLOBAL_Control->DeviceExtension, v12, v13, 0x16u, v16, (const char *)&v41);
        }
        else
        {
          v8 = -1073741670;
