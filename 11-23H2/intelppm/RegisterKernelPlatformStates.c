/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C004049C
 * Callers:
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = a1;
  v2 = dword_1C001F014;
  if ( byte_1C001F900 && dword_1C001F8FC > (unsigned int)dword_1C001F014 )
    v2 = dword_1C001F8FC;
  v3 = (unsigned int)dword_1C001F68C;
  if ( !dword_1C001F68C )
    return 0;
  v5 = (48 * dword_1C001F68C + 59) & 0xFFFFFFFC;
  Pool2 = (char *)ExAllocatePool2(256LL, v5 + 8 * dword_1C001F68C * v2, 1919119952LL);
  if ( !Pool2 )
  {
  ...
  if ( v7 )
  {
    ...
    if ( (_DWORD)v3 )
    {
      ...
      while ( 1 )
      {
        ...
        *v7 = v8;
        v7[8] = v2;
        ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, unsigned int *, _QWORD))qword_1C001F398)(
                                     *(_QWORD *)(v1 + 1120),
                                     v7,
                                     0LL);
...
LABEL_24:
      *(_DWORD *)Pool2 = 72;
      *((_DWORD *)Pool2 + 1) = dword_1C001F68C;
      *((_DWORD *)Pool2 + 2) = dword_1C001F68C;
      ...
      *((_QWORD *)Pool2 + 4) = PepIdleComplete;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C001F338)(Pool2);
      if ( ProcessorNumberFromIndex < 0 )
      {
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          goto LABEL_33;
