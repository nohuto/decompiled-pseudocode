/*
 * XREFs of GetWmiBiosThrottleStateInfo @ 0x1C000B290
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  *(_BYTE *)a3 = byte_1C001FA06;
  *(_BYTE *)(a3 + 1) = byte_1C001FA07;
  ...
  *(_DWORD *)(a3 + 80) = v21;
  if ( (_DWORD)v21 )
  {
    ...
    do
    {
      v25 = *(_QWORD *)(v11 + 504);
      v22 += 20LL;
      *(v24 - 2) = *(_DWORD *)(v25 + v22 - 16);
      *(v24 - 1) = *(_DWORD *)(v25 + v22 - 12);
      *v24 = *(_DWORD *)(v25 + v22 - 8);
      v24 += 10;
      *(v24 - 9) = *(_DWORD *)(v25 + v22 - 4);
      v26 = *(_DWORD *)(v25 + v22);
      *((_QWORD *)v24 - 3) = 0LL;
      *((_QWORD *)v24 - 2) = 0LL;
      *(v24 - 8) = v26;
