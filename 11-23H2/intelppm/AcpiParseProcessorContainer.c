/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C003CEB8
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C003C07C (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x1C00088A4 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C000B488 (RtlUnicodeStringCopyString.c)
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)(a3 + 32) = v16;
      ...
      for ( j = (char *)a1 + (unsigned int)a1[2 * v5 + 7]; v17 < a1[2 * v5 + 6]; v17 = v20 + 1 )
      {
        ...
        {
          if ( dword_1C001F8FC <= (unsigned int)dword_1C001F014 )
            return -1073741275;
