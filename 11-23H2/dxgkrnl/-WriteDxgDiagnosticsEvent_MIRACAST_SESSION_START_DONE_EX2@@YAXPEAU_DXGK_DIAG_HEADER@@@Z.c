/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START_DONE_EX2@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C00516B4
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START_DONE_EX2(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C013F8E0 > 4 && tlgKeywordOn((__int64)&dword_1C013F8E0, 0x200000000400LL) )
  {
    if ( tlgKeywordOn((__int64)&dword_1C013F8E0, v1) )
    {
      v6 = *(_WORD *)(v4 + 4);
      v7 = *(_DWORD *)(v4 + 40);
      v5 = v4;
