/*
 * XREFs of ?Clear@?$DoublyLinkedList@VDXGTARGETENTRY@@U?$DoubleLinkedListElementDeleter@VDXGTARGETENTRY@@@@@@QEAAXXZ @ 0x1C001536C
 * Callers:
 *     ??1?$Set@VDXGTARGETENTRY@@@@UEAA@XZ @ 0x1C0006194 (--1-$Set@VDXGTARGETENTRY@@@@UEAA@XZ.c)
 *     ?Clear@?$Set@VDXGTARGETENTRY@@@@UEAAXXZ @ 0x1C0015350 (-Clear@-$Set@VDXGTARGETENTRY@@@@UEAAXXZ.c)
 *     ??_E?$DoublyLinkedList@VDXGTARGETENTRY@@U?$DoubleLinkedListElementDeleter@VDXGTARGETENTRY@@@@@@UEAAPEAXI@Z @ 0x1C004C480 (--_E-$DoublyLinkedList@VDXGTARGETENTRY@@U-$DoubleLinkedListElementDeleter@VDXGTARGETENTRY@@@@@@U.c)
 * Callees:
