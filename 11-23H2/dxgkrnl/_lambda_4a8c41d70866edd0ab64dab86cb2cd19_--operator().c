/*
 * XREFs of _lambda_4a8c41d70866edd0ab64dab86cb2cd19_::operator() @ 0x1C03C9E10
 * Callers:
...
void __fastcall lambda_4a8c41d70866edd0ab64dab86cb2cd19_::operator()(__int64 *a1)
{
  ...
  if ( (unsigned int)dword_1C013F8A8 > 5 && tlgKeywordOn((__int64)&dword_1C013F8A8, 0x400000008000LL) )
  {
    v4 = a1[3];
    v16 = v3;
    v15 = v4 + 20;
