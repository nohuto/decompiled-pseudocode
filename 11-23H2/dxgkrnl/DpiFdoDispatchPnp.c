/*
 * XREFs of DpiFdoDispatchPnp @ 0x1C0229300
 * Callers:
 *     <none>
 * Callees:
  ...
  switch ( MinorFunction )
  {
    ...
    case 1u:
      ...
      if ( *(_BYTE *)(DeviceExtension + 484) )
        DpiCheckForOutstandingD3Requests(DeviceExtension);
      ExAcquireResourceExclusiveLite(*(PERESOURCE *)(DeviceExtension + 168), 1u);
      if ( byte_1C0140491 && !*(_BYTE *)(DeviceExtension + 481) || *(_BYTE *)(DeviceExtension + 480) )
      {
        v4 = 1;
        Status = -1073741823;
        WdLogSingleEntry3(2LL, a1, (unsigned __int8)byte_1C0140491, *(unsigned __int8 *)(DeviceExtension + 480));
      }
