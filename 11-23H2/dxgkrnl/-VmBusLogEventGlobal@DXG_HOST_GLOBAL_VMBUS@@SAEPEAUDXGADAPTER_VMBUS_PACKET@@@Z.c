/*
 * XREFs of ?VmBusLogEventGlobal@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0380BB0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_GLOBAL_VMBUS::VmBusLogEventGlobal(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v1 )
  {
    ...
    if ( *(_DWORD *)(v2 + 24) == 1 && !_InterlockedCompareExchange(&dword_1C0142448, 1, 0) )
