/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C005C580
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNumWorkItems@DXG_DEFERRED_WORK_QUEUE_DPC@@QEAAJXZ @ 0x1C005BEE0 (-GetNumWorkItems@DXG_DEFERRED_WORK_QUEUE_DPC@@QEAAJXZ.c)
 *     ?QueueWorkItem@DXG_DEFERRED_WORK_QUEUE_DPC@@QEAAXPEAUDXG_DEFERRED_QUEUE_WORK_ITEM@@@Z @ 0x1C005C14C (-QueueWorkItem@DXG_DEFERRED_WORK_QUEUE_DPC@@QEAAXPEAUDXG_DEFERRED_QUEUE_WORK_ITEM@@@Z.c)
 */
        ...
        unsigned int a5)
{
  ...
  v9 = ((__int64 (*)(void))qword_1C0141F08)();
  v50 = 0LL;
  v10 = 0;
  v11 = 1;
  v52 = 1;
...
LABEL_11:
    ...
    if ( v22 == 1 )
    {
      ...
      if ( v26 - 1000 > 0x15 )
      {
        WdLogSingleEntry2(2LL, *((int *)v21 + 4), 7056LL);
        if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x80000000LL) != 0 )
          McTemplateK0zqqzxxxxx_EtwWriteTransfer(
            v30,
            v29,
