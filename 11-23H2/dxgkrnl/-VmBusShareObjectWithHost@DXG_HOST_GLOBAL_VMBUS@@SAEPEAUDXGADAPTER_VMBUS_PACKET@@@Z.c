/*
 * XREFs of ?VmBusShareObjectWithHost@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C03928A0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_GLOBAL_VMBUS::VmBusShareObjectWithHost(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  struct FlipManagerObject *v18; // r14
...
LABEL_21:
                ...
                if ( v16 == 3 )
                {
                  if ( *(_QWORD *)(*(_QWORD *)v8 + 16LL * v15) )
                  {
                    ...
                    if ( v17 )
                    {
                      ...
                      DXGAUTOPUSHLOCK::Release((DXGAUTOPUSHLOCK *)v23);
                      FlipManagerDwmReleaseFlipManagerObject(v18);
                      goto LABEL_41;
                    }
                    WdLogSingleEntry1(2LL, 8261LL);
                    DxgkLogInternalTriageEvent(
                      0LL,
                      0x40000,
                      -1,
            ...
            WdLogSingleEntry2(2LL, *(unsigned int *)(v3 + 24), 8250LL);
            DxgkLogInternalTriageEvent(
              0LL,
              0x40000,
              -1,
