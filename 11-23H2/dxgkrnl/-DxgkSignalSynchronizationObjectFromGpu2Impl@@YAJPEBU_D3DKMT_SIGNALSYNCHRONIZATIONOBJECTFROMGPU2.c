/*
 * XREFs of ?DxgkSignalSynchronizationObjectFromGpu2Impl@@YAJPEBU_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2@@PEAX@Z @ 0x1C01C8CE0
 * Callers:
 *     DxgkSignalSynchronizationObjectFromGpu2 @ 0x1C01C8CC0 (DxgkSignalSynchronizationObjectFromGpu2.c)
 *     DxgkWslSignalSynchronizationObjectFromGpu2 @ 0x1C0354950 (DxgkWslSignalSynchronizationObjectFromGpu2.c)
 * Callees:
