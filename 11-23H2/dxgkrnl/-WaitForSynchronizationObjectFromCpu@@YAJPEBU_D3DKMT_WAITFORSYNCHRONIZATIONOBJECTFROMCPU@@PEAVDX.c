/*
 * XREFs of ?WaitForSynchronizationObjectFromCpu@@YAJPEBU_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMCPU@@PEAVDXGPROCESS@@PEAVDXGDEVICE@@PEAX@Z @ 0x1C01D5F80
 * Callers:
        ...
        void *a4)
{
  ...
  if ( a3 )
  {
    ...
    if ( !ExAcquireResourceSharedLite(a3[17], 0) )
    {
      ...
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
        McTemplateK0q_EtwWriteTransfer(v53, &EventBlockThread, v54, 40);
  ...
  if ( KeGetCurrentThread() != *((struct _KTHREAD **)v97 + 23) )
  {
    ...
    {
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
        McTemplateK0q_EtwWriteTransfer(v12, &EventBlockThread, v13, 72);
...
LABEL_189:
  ...
  if ( Object )
  {
    ...
    if ( Object == Event )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"Failed to wait for event!", 5115LL, 0LL, 0LL, 0LL, 0LL);
LABEL_190:
      KeSetEvent(v45, 0, 0);
