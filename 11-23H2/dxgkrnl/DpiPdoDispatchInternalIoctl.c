/*
 * XREFs of DpiPdoDispatchInternalIoctl @ 0x1C01DCED0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( UserBuffer )
        {
          if ( (unsigned int)Length >= 0x28 )
          {
            ...
            if ( (int)VideoOutputTechnology < 0 )
              goto LABEL_38;
            *UserBuffer = DeviceExtension[489];
        ...
        if ( p_NamedPipeType )
        {
          if ( Options >= 0x10 )
          {
            if ( p_NamedPipeType[1] - 1 <= 0x3F )
            {
              ...
              if ( (int)VideoOutputTechnology < 0 )
                goto LABEL_38;
              DxgkAcquireAdapterOpmI2CSync(DeviceExtension[489]);
              KeWaitForSingleObject(*(PVOID *)(*(_QWORD *)(v4 + 936) + 72LL), Executive, 0, 0, 0LL);
              DxgkAcquireAdapterDdiSync(DeviceExtension[489], 1LL);
              VideoOutputTechnology = ((int (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD))DeviceExtension[377])(
                                        *(_QWORD *)(v4 + 48),
                                        *(unsigned int *)(v4 + 504),
                                        *p_NamedPipeType,
                                        p_NamedPipeType[1],
                                        *((_QWORD *)p_NamedPipeType + 1));
              DxgkReleaseAdapterDdiSync(DeviceExtension[489]);
              KeReleaseMutex(*(PRKMUTEX *)(*(_QWORD *)(v4 + 936) + 72LL), 0);
              DxgkReleaseAdapterOpmI2CSync(DeviceExtension[489]);
              DpiReleaseCoreSyncAccessSafe(a1, 0);
              if ( (int)VideoOutputTechnology >= 0 )
                goto LABEL_38;
LABEL_50:
        ...
        if ( p_NamedPipeType )
        {
          if ( Options >= 8 )
          {
            if ( UserBuffer && (unsigned int)(Length - 1) <= 0x3F )
            {
              ...
              v26 = UserBuffer;
              v22 = v29;
              VideoOutputTechnology = ((int (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, enum _D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY, void *))DeviceExtension[378])(
                                        *(_QWORD *)(v4 + 48),
                                        *(unsigned int *)(v4 + 504),
                                        *p_NamedPipeType,
                                        p_NamedPipeType[1],
...
LABEL_11:
  ...
  if ( (int)VideoOutputTechnology < 0 )
    goto LABEL_38;
  v15 = (DXGADAPTER *)DeviceExtension[489];
  v16 = *(_DWORD *)(v4 + 504);
  LODWORD(v30) = v16;
  if ( !v15 || v16 == -1 )
    goto LABEL_76;
...
LABEL_76:
  ...
  v27 = 0LL;
  LODWORD(VideoOutputTechnology) = MONITOR_MGR::_GetMonitorInstance(v17, v30, 1, &v27);
  if ( (int)VideoOutputTechnology < 0 )
  {
