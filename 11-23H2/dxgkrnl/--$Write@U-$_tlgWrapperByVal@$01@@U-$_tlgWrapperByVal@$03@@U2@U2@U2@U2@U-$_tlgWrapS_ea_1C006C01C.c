        ...
        __int64 a63)
{
  ...
  int v69; // ecx
  struct _EVENT_DATA_DESCRIPTOR v71; // [rsp+30h] [rbp-D0h] BYREF
  ...
  _DWORD *v147; // [rsp+2B0h] [rbp+1B0h]
  __int64 v148; // [rsp+2B8h] [rbp+1B8h]
  __int64 v149; // [rsp+2C0h] [rbp+1C0h]
  _DWORD v150[2]; // [rsp+2C8h] [rbp+1C8h] BYREF
  __int64 v151; // [rsp+2D0h] [rbp+1D0h]
  __int64 v152; // [rsp+2D8h] [rbp+1D8h]
  _BYTE v153[16]; // [rsp+2E0h] [rbp+1E0h] BYREF
  _BYTE v154[16]; // [rsp+2F0h] [rbp+1F0h] BYREF
  ...
  __int64 v175; // [rsp+3A0h] [rbp+2A0h]
  __int64 v176; // [rsp+3A8h] [rbp+2A8h]
  __int64 v177; // [rsp+3B0h] [rbp+2B0h]
  __int64 v178; // [rsp+3B8h] [rbp+2B8h]
  _DWORD *v179; // [rsp+3C0h] [rbp+2C0h]
  __int64 v180; // [rsp+3C8h] [rbp+2C8h]
  __int64 v181; // [rsp+3D0h] [rbp+2D0h]
  _DWORD v182[2]; // [rsp+3D8h] [rbp+2D8h] BYREF
  __int64 v183; // [rsp+3E0h] [rbp+2E0h]
  __int64 v184; // [rsp+3E8h] [rbp+2E8h]
  _DWORD *v185; // [rsp+3F0h] [rbp+2F0h]
  __int64 v186; // [rsp+3F8h] [rbp+2F8h]
  __int64 v187; // [rsp+400h] [rbp+300h]
  _DWORD v188[2]; // [rsp+408h] [rbp+308h] BYREF
  __int64 v189; // [rsp+410h] [rbp+310h]
  __int64 v190; // [rsp+418h] [rbp+318h]
  __int64 v191; // [rsp+420h] [rbp+320h]
  __int64 v192; // [rsp+428h] [rbp+328h]
  __int64 v193; // [rsp+430h] [rbp+330h]
  __int64 v194; // [rsp+438h] [rbp+338h]
  __int64 v195; // [rsp+440h] [rbp+340h]
  __int64 v196; // [rsp+448h] [rbp+348h]
  _DWORD *v197; // [rsp+450h] [rbp+350h]
  __int64 v198; // [rsp+458h] [rbp+358h]
  __int64 v199; // [rsp+460h] [rbp+360h]
  _DWORD v200[2]; // [rsp+468h] [rbp+368h] BYREF
  __int64 v201; // [rsp+470h] [rbp+370h]
  ...
  v185 = v188;
  v187 = *a57;
  v188[0] = *((unsigned __int16 *)a57 + 4);
  v183 = a56;
  v179 = v182;
  v181 = *a55;
  v182[0] = *((unsigned __int16 *)a55 + 4);
  v177 = a54;
  v175 = a53;
  v173 = a52;
  v171 = a51;
  ...
  v158 = 2LL;
  v156 = 1LL;
  _tlgCreate1Sz<unsigned short>((__int64)v154, v66);
  _tlgCreate1Sz<unsigned short>((__int64)v153, *a41);
  v151 = a40;
  v147 = v150;
  v152 = 4LL;
  v149 = *a39;
  v150[0] = *((unsigned __int16 *)a39 + 4);
  v145 = a38;
  v143 = a37;
  v141 = a36;
  v139 = a35;
  ...
  v88 = 4LL;
  v86 = 4LL;
  _tlgCreate1Sz<unsigned short>((__int64)v84, v67);
  v82 = a10;
  v80 = a9;
  v78 = a8;
  v76 = a7;
  ...
  v75 = 4LL;
  v73 = 2LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C013F918, a2, a3, 0LL, 0x46u, &v71);
}
