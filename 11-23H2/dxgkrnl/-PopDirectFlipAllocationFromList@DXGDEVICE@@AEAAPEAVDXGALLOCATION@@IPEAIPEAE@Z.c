/*
 * XREFs of ?PopDirectFlipAllocationFromList@DXGDEVICE@@AEAAPEAVDXGALLOCATION@@IPEAIPEAE@Z @ 0x1C02EC370
 * Callers:
        ...
        unsigned __int8 *a4)
{
  ...
  if ( *a4 )
  {
    WdLogSingleEntry1(1LL, 9263LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"FALSE == *ReachedEnd", 9263LL, 0LL, 0LL, 0LL, 0LL);
  }
  v8 = *a3;
  v9 = v4;
  ...
  else
  {
    ...
    if ( !v15 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NULL != pAllocation", 9277LL, 0LL, 0LL, 0LL, 0LL);
    }
