        ...
        struct DISPLAY_DVLL_CAPS *a3)
{
  ...
  if ( (unsigned __int8)v29 == 2 )
  {
    ...
    *(_BYTE *)a3 = 1;
    *((double *)a3 + 1) = dword_1C009FDA0[v18];
    *((double *)a3 + 2) = dword_1C009FE20[(unsigned __int64)v16 >> 3];
  ...
  if ( (BYTE1(v29) & 3) == 1 )
  {
    v6 = dword_1C009FEA0[((unsigned __int64)BYTE3(v29) >> 4) | (unsigned __int16)(16 * BYTE4(v29))];
    v7 = dword_1C009FEA0[BYTE3(v29) & 0xF | (unsigned __int64)(unsigned __int16)(16 * BYTE5(v29))];
