/*
 * XREFs of ?FindMode@MODE_UNION_LIST@@QEAAPEAU_D3DKMT_DISPLAYMODE@@AEBU2@@Z @ 0x1C0300958
 * Callers:
 ...
 * Callees:
 *     ??8@YA_NAEBU_D3DKMT_DISPLAYMODE@@0@Z @ 0x1C02FEEF8 (--8@YA_NAEBU_D3DKMT_DISPLAYMODE@@0@Z.c)
 */
