/*
 * XREFs of ?GetByHandle@DXGPROCESS@@KAJPEAXK_NPEA_N2PEAU_KAPC_STATE@@PEAPEAV1@@Z @ 0x1C01DF790
 * Callers:
...
LABEL_9:
  ...
  if ( ProcessSessionId != (unsigned int)PsGetCurrentProcessSessionId(v18) )
  {
    if ( a3 )
    {
