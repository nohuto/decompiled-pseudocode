/*
 * XREFs of ?AddDisableScanoutToken@CTokenManager@@UEAAJAEAPEAVCDisableScanoutToken@@@Z @ 0x1C0076F70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SignalStartNowEvent@CTokenManager@@IEAAJXZ @ 0x1C0077F70 (-SignalStartNowEvent@CTokenManager@@IEAAJXZ.c)
 */
