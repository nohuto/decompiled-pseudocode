/*
 * XREFs of ??1DXGSESSIONDATA@@QEAA@XZ @ 0x1C01E64A0
 * Callers:
 ...
 *     ?CleanupForSession@DXGVALIDATION@@QEAAXPEAVDXGSESSIONDATA@@@Z @ 0x1C001630C (-CleanupForSession@DXGVALIDATION@@QEAAXPEAVDXGSESSIONDATA@@@Z.c)
