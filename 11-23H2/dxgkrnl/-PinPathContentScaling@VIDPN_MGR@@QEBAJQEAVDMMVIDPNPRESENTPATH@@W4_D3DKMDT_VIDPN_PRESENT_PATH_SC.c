/*
 * XREFs of ?PinPathContentScaling@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C03AF778
 * Callers:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING a3)
{
  ...
  v13 = VIDPN_MGR::FormalizeVidPnChange((__int64)this, (D3DKMDT_HVIDPN)(v11 & -(__int64)(v11 != -88)), 7LL, 1, &v14);
  v7 = v13;
  if ( v13 < 0 )
  {
    v8 = v3;
