...
LABEL_17:
    ...
    RegistryValues = CcdReadRegistryValues(Handle, 0LL, &unk_1C013F6A0, 8LL, v19);
    v21 = RegistryValues;
    if ( RegistryValues < 0 )
      break;
    *((_QWORD *)v19 + 13) = *((_QWORD *)v19 + 12);
    v22 = CcdReadRegistryValues(Handle, 0LL, &unk_1C013F630, 2LL, &v41);
    v21 = v22;
    if ( v22 == -1073741772 )
    {
      v41 = 0;
...
LABEL_28:
    ...
    {
      v25 = CcdReadRegistryValues(Handle, &v47, &unk_1C013F400, 4LL, v19);
      if ( v25 < 0 )
      {
