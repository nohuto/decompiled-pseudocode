/*
 * XREFs of DxgkPresent @ 0x1C01BED90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0DXGPRESENT@@QEAA@I@Z @ 0x1C01E98EC (--0DXGPRESENT@@QEAA@I@Z.c)
...
LABEL_23:
        ...
        if ( !ExAcquireResourceExclusiveLite(*(PERESOURCE *)(v17 + 136), 0) )
        {
          ...
          if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
            McTemplateK0q_EtwWriteTransfer(v87, &EventBlockThread, v88, 40);
      ...
      if ( !v99 || (*(_DWORD *)(v99 + 404) & 8) != 0 || (v100 = *((_QWORD *)v16 + 2), *(_QWORD *)(v99 + 16) != v100) )
      {
        ...
        DxgkLogInternalTriageEvent(
          ...
          *((unsigned int *)v5 + v134 + 24),
          ...
          0LL);
LABEL_215:
        DXGPROCESSDDILOCK::~DXGPROCESSDDILOCK((DXGPROCESSDDILOCK *)v142);
LABEL_218:
        if ( P != v122 && P )
          ExFreePoolWithTag(P, 0);
        P = 0LL;
