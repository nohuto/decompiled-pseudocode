/*
 * XREFs of ?DestroyAllHwQueues@DXGCONTEXT@@QEAAXPEAVDXGDEVICEACCESSLOCKEXCLUSIVE@@@Z @ 0x1C0317278
 * Callers:
...
void __fastcall DXGCONTEXT::DestroyAllHwQueues(DXGCONTEXT *this, struct DXGDEVICEACCESSLOCKEXCLUSIVE *a2)
{
  ...
  PERESOURCE *v37; // [rsp+160h] [rbp+60h] BYREF
...
LABEL_5:
  ...
  for ( i = (volatile signed __int64 *)*v6; ; i = (volatile signed __int64 *)*i )
  {
    v9 = i;
                ...
                if ( v15 >= 0 )
                {
                  if ( !v15 )
                  {
                    ...
                    if ( *(_DWORD *)(*(_QWORD *)(*((_QWORD *)v17 + 2) + 16LL) + 200LL) != 4 )
                      DXGCONTEXT::DestroyHwQueue((DXGCONTEXT *)v16, (PVOID)i, (struct COREDEVICEACCESS *)v34);
                    ...
                    if ( _InterlockedExchangeAdd64((volatile signed __int64 *)(v16 + 32), 0xFFFFFFFFFFFFFFFFuLL) == 1 )
                    {
                      ...
                      if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 16LL) + 200LL) != 4 )
                        DXGDEVICE::DestroyContext((DXGDEVICE *)v21, (struct DXGCONTEXT *)v16, &v37);
