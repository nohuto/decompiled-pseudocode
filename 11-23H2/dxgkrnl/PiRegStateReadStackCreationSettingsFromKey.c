/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C0397C84
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C0398110 (SeUtilSecurityInfoFromSecurityDescriptor.c)
