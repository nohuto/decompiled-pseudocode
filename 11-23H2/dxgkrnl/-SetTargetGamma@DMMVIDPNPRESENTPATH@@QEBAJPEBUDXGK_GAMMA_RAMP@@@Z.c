/*
 * XREFs of ?SetTargetGamma@DMMVIDPNPRESENTPATH@@QEBAJPEBUDXGK_GAMMA_RAMP@@@Z @ 0x1C0198F20
 * Callers:
 ...
 * Callees:
 *     ?IsTargetCurrentActive@DMMVIDEOPRESENTTARGET@@QEBAEXZ @ 0x1C0005E44 (-IsTargetCurrentActive@DMMVIDEOPRESENTTARGET@@QEBAEXZ.c)
...
__int64 __fastcall DMMVIDPNPRESENTPATH::SetTargetGamma(DMMVIDPNPRESENTPATH *this, const struct DXGK_GAMMA_RAMP *a2)
{
  ...
  *(_OWORD *)&v13.GammaRamp.Type = v9;
  v10 = ADAPTER_DISPLAY::DdiSetTargetGamma((ADAPTER_DISPLAY *)v6, &v13, v7);
  v11 = v10;
  if ( v10 == -1073741637 )
  {
