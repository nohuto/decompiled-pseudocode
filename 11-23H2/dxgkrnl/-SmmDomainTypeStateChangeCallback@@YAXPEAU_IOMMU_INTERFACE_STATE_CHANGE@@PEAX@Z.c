/*
 * XREFs of ?SmmDomainTypeStateChangeCallback@@YAXPEAU_IOMMU_INTERFACE_STATE_CHANGE@@PEAX@Z @ 0x1C03D5810
 * Callers:
 *     <none>
 * Callees:
 *     DxgkLogInternalTriageEvent @ 0x1C0004FC0 (DxgkLogInternalTriageEvent.c)
 *     ??$SmmAcquirePushLockExclusive@$0EC@@@YAXPEAU?$SYSMM_PUSHLOCK@$0EC@@@@Z @ 0x1C006E954 (--$SmmAcquirePushLockExclusive@$0EC@@@YAXPEAU-$SYSMM_PUSHLOCK@$0EC@@@@Z.c)
 *     ??$SmmReleasePushLockExclusive@$0EC@@@YAXPEAU?$SYSMM_PUSHLOCK@$0EC@@@@Z @ 0x1C006E99C (--$SmmReleasePushLockExclusive@$0EC@@@YAXPEAU-$SYSMM_PUSHLOCK@$0EC@@@@Z.c)
