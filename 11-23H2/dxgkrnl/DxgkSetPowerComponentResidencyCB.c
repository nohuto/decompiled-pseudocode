/*
 * XREFs of DxgkSetPowerComponentResidencyCB @ 0x1C0049720
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPowerComponentResidencyCB@DXGADAPTER@@QEAAXI_K@Z @ 0x1C001D204 (-SetPowerComponentResidencyCB@DXGADAPTER@@QEAAXI_K@Z.c)
