/*
 * XREFs of ?Open@DXGKEYEDMUTEX@@QEAAJPEAIPEAXI_N@Z @ 0x1C0350488
 * Callers:
...
LABEL_17:
  ...
  if ( *((_QWORD *)this + 20) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"m_pPrivateRuntimeData == NULL", 3866LL, 0LL, 0LL, 0LL, 0LL);
  }
  v14 = v5;
...
LABEL_29:
  ...
  if ( *((_BYTE *)this + 176) )
  {
    if ( !a5 )
    {
      WdLogSingleEntry1(1LL, 3943LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"OpenForUserMode == true", 3943LL, 0LL, 0LL, 0LL, 0LL);
    }
