/*
 * XREFs of ?OpenSyncObject@DXGGLOBAL@@QEAAJIPEAPEAVDXGSYNCOBJECT@@PEAIPEAPEAVDXGADAPTERSYNCOBJECT@@@Z @ 0x1C016C28C
 * Callers:
        ...
        struct DXGADAPTERSYNCOBJECT **a5)
{
  ...
  if ( !a3 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"ppSyncObject", 2858LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a4 )
  {
    WdLogSingleEntry1(1LL, 2859LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"phSyncObject", 2859LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !DXGGLOBAL::IsSyncObjectLockSharedOwner(this) )
  {
    WdLogSingleEntry1(1LL, 2860LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsSyncObjectLockSharedOwner()", 2860LL, 0LL, 0LL, 0LL, 0LL);
  }
  *a3 = 0LL;
  *a4 = 0;
