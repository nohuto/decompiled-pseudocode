/*
 * XREFs of DxgkAdjustFullscreenGamma @ 0x1C02D08B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkAdjustFullscreenGamma(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !Current )
  {
    WdLogSingleEntry1(2LL, 10598LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Invalid process context", 10598LL, 0LL, 0LL, 0LL, 0LL);
LABEL_7:
