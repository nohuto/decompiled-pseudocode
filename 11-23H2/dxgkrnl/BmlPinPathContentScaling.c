/*
 * XREFs of BmlPinPathContentScaling @ 0x1C016F7A4
 * Callers:
...
__int64 __fastcall BmlPinPathContentScaling(__int64 a1, __int64 a2, unsigned __int16 a3)
{
  ...
  else
  {
    ...
    {
      if ( (dword_1C0142520 & 1) == 0 )
      {
        v12 = *(VIDPN_MGR **)(a2 + 48);
        dword_1C0142520 |= 1u;
        dword_1C01424C8[0] = VIDPN_MGR::GetAdapterDefaultScaling(v12);
        dword_1C01424CC = 3;
        dword_1C01424D0 = 4;
        dword_1C01424D4 = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v13 >= 4 )
          break;
        v14 = (unsigned int)dword_1C01424C8[v13];
