/*
 * XREFs of ?UpdateAttributes@CFlipExBuffer@@IEAA_NAEBVCFlipToken@@@Z @ 0x1C007EB14
 * Callers:
 ...
 *     ?GetTransform@CFlipToken@@QEBAXPEAM@Z @ 0x1C007E3BC (-GetTransform@CFlipToken@@QEBAXPEAM@Z.c)
 */
