/*
 * XREFs of McTemplateK0xq_EtwWriteTransfer @ 0x1C00634F4
 * Callers:
 *     DpiMiracastEtwLogStartMiracastSessionStage @ 0x1C005FF5C (DpiMiracastEtwLogStartMiracastSessionStage.c)
