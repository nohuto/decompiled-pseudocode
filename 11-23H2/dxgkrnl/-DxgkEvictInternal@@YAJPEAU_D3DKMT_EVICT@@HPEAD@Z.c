/*
 * XREFs of ?DxgkEvictInternal@@YAJPEAU_D3DKMT_EVICT@@HPEAD@Z @ 0x1C01A2B9C
 * Callers:
 *     DxgkEvict @ 0x1C01A2130 (DxgkEvict.c)
...
LABEL_63:
        ...
        DXGPROCESSDDILOCK::~DXGPROCESSDDILOCK((DXGPROCESSDDILOCK *)v61);
