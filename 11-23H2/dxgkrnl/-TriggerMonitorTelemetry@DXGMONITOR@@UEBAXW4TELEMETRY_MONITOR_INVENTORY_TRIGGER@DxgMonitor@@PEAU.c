/*
 * XREFs of ?TriggerMonitorTelemetry@DXGMONITOR@@UEBAXW4TELEMETRY_MONITOR_INVENTORY_TRIGGER@DxgMonitor@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C021F3E0
 * Callers:
 ...
 *     ?GetAddress@MonitorDisplayPortState@DxgMonitor@@QEBA?AU_DXGKARG_GETDPADDRESS@@XZ @ 0x1C0017248 (-GetAddress@MonitorDisplayPortState@DxgMonitor@@QEBA-AU_DXGKARG_GETDPADDRESS@@XZ.c)
 *     ?IsAddressValid@MonitorDisplayPortState@DxgMonitor@@QEBA_NXZ @ 0x1C00172E4 (-IsAddressValid@MonitorDisplayPortState@DxgMonitor@@QEBA_NXZ.c)
 ...
 *     ?ConvertMonitorCapablitiesOrigin@@YAJW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@PEAW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@@Z @ 0x1C006CC74 (-ConvertMonitorCapablitiesOrigin@@YAJW4_D3DKMDT_MONITOR_CAPABILITIES_ORIGIN@@PEAW4__WMI_MONITOR_.c)
 ...
 *     ?_SupportSyncLockIdentical@DXGMONITOR@@QEBA_NXZ @ 0x1C0220694 (-_SupportSyncLockIdentical@DXGMONITOR@@QEBA_NXZ.c)
 */
...
LABEL_17:
  ...
  {
    if ( (unsigned int)dword_1C013F918 > 5 && tlgKeywordOn((__int64)&dword_1C013F918, 0x800000000020LL) )
    {
      ...
      v122 = v98;
      v88 = (unsigned int)dword_1C013F918;
      ...
      *(_QWORD *)&v174 = &v180;
      ...
      v105 = *(_DWORD *)(v3 + 184);
      v104 = v156;
      if ( !dword_1C013F918 || (v72 = tlgKeywordOn((__int64)&dword_1C013F918, 0x200000000000LL) == 0, v91 = 1, v72) )
        v91 = 0;
      v103 = v91;
      if ( !(_DWORD)v88 || !tlgKeywordOn((__int64)&dword_1C013F918, 0x400000000000LL) )
        v6 = 0;
      v92 = (unsigned int)dword_1C0140BD8;
      v101 = v6;
      LODWORD(v109) = dword_1C0140BD8++;
      v96 = 17;
  ...
  else if ( (unsigned int)dword_1C013F918 > 5 && tlgKeywordOn((__int64)&dword_1C013F918, 0x800000000020LL) )
  {
    v57 = v56;
    LOBYTE(v57) = v101 != v56;
    v108 = v57;
    ...
    v141 = v98;
    v69 = (unsigned int)dword_1C013F918;
    ...
    v150 = *(_DWORD *)(v3 + 184);
    LODWORD(v157) = v156;
    if ( !dword_1C013F918 || (v72 = tlgKeywordOn((__int64)&dword_1C013F918, 0x200000000000LL) == 0, v73 = 1, v72) )
      v73 = 0;
    LODWORD(v155) = v73;
    if ( !(_DWORD)v69 || !tlgKeywordOn((__int64)&dword_1C013F918, 0x400000000000LL) )
      v6 = 0;
    v74 = (unsigned int)dword_1C0140BD8;
    LODWORD(v154) = v6;
    LODWORD(v113) = dword_1C0140BD8++;
    v96 = 16;
