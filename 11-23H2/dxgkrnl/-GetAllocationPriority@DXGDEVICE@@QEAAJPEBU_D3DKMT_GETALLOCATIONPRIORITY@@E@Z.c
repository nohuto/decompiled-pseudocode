/*
 * XREFs of ?GetAllocationPriority@DXGDEVICE@@QEAAJPEBU_D3DKMT_GETALLOCATIONPRIORITY@@E@Z @ 0x1C02D79A4
 * Callers:
  ...
  for ( j = v19[3].Count; j; j = *(_QWORD *)(j + 64) )
  {
    ...
    if ( !v11 )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0LL,
        0LL);
      DXGSYNCOBJECTMUTEX::~DXGSYNCOBJECTMUTEX((DXGSYNCOBJECTMUTEX *)v20);
      goto LABEL_25;
    }
