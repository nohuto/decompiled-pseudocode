/*
 * XREFs of ?DxgkpDuplicateHandleToVm@@YAJPEAU_D3DKMT_DUPLICATEHANDLE@@@Z @ 0x1C0326D24
 * Callers:
 ...
 *     ??0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z @ 0x1C037205C (--0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z.c)
...
LABEL_18:
  ...
  else
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v12 >= 0 )
        goto LABEL_18;
      WdLogSingleEntry2(3LL, v12, 3137LL);
    }
    else
    {
      WdLogSingleEntry2(3LL, v11, 3127LL);
