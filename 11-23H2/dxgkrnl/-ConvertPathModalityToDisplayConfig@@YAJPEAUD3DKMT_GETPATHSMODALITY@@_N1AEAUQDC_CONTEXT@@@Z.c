/*
 * XREFs of ?ConvertPathModalityToDisplayConfig@@YAJPEAUD3DKMT_GETPATHSMODALITY@@_N1AEAUQDC_CONTEXT@@@Z @ 0x1C017C618
 * Callers:
  ...
  do
  {
    ...
    *(_BYTE *)(v4 + 101) = *((_BYTE *)a1 + v18 + 185);
    if ( (*(_QWORD *)((_BYTE *)a1 + v18 + 56) & 0x87) != 0 )
    {
      *(_QWORD *)v4 = v20 | *(_QWORD *)((_BYTE *)a1 + v18 + 56) & 0x87LL;
      DMMVideoSignalInfoToDisplayConfigVideoSignalInfo((__int64)a1 + v18 + 88, v4 + 32);
      v20 = *(_QWORD *)v4;
    }
    ...
    if ( (*(_DWORD *)((_BYTE *)a1 + v18 + 56) & 0x10000) != 0 )
    {
    ...
    *(_QWORD *)v4 = v22;
    ...
    if ( (*((_BYTE *)a1 + v18 + 56) & 8) != 0 )
    {
      ...
      *(_DWORD *)(v4 + 176) = ConvertDmmToDisplayConfigColorEncoding(*(_DWORD *)((char *)a1 + v18 + 260));
      v14 = 0LL;
