/*
 * XREFs of ??1COMMITVIDPNREQUEST@VIDPN_MGR@@UEAA@XZ @ 0x1C0067DC4
 * Callers:
 *     ??_GCOMMITVIDPNREQUEST@VIDPN_MGR@@UEAAPEAXI@Z @ 0x1C0068A60 (--_GCOMMITVIDPNREQUEST@VIDPN_MGR@@UEAAPEAXI@Z.c)
 * Callees:
