/*
 * XREFs of ?VmBusSendQueryAllocationResidency@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGDEVICE@@EPEAU_D3DKMT_QUERYALLOCATIONRESIDENCY@@@Z @ 0x1C038C788
 * Callers:
  ...
  *(_DWORD *)(v13 + 40) = a5->AllocationCount;
  ...
  if ( v16 )
  {
    ...
    if ( hResource )
    {
      ...
      {
        WdLogSingleEntry1(2LL, 11377LL);
        DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Invalid resource handle", 11377LL, 0LL, 0LL, 0LL, 0LL);
