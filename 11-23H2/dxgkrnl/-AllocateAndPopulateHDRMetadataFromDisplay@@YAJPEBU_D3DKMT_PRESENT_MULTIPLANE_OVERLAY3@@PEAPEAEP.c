/*
 * XREFs of ?AllocateAndPopulateHDRMetadataFromDisplay@@YAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY3@@PEAPEAEPEAW4_D3DDDI_HDR_METADATA_TYPE@@PEAI@Z @ 0x1C01BB2E0
 * Callers:
 ...
 *     DXGKCALLONEXIT__lambda_897d21a97c0cf1b919de605caa0104f9___ @ 0x1C000AA4C (DXGKCALLONEXIT__lambda_897d21a97c0cf1b919de605caa0104f9___.c)
        ...
        unsigned int *a4)
{
  ...
  __int64 v68; // r9
  char *v69; // rdx
  DXGFASTMUTEX *v70; // [rsp+58h] [rbp-B0h] BYREF
  _QWORD *v71; // [rsp+68h] [rbp-A0h] BYREF
  __int64 v72; // [rsp+70h] [rbp-98h] BYREF
  _QWORD v73[2]; // [rsp+78h] [rbp-90h] BYREF
  _QWORD *v74; // [rsp+88h] [rbp-80h] BYREF
  __int64 *v75; // [rsp+90h] [rbp-78h]
  char v76; // [rsp+98h] [rbp-70h]
  __int64 v77; // [rsp+A0h] [rbp-68h] BYREF
  struct DXGADAPTER *v78; // [rsp+A8h] [rbp-60h]
  char v79; // [rsp+B0h] [rbp-58h]
  enum _D3DDDI_HDR_METADATA_TYPE *v80; // [rsp+B8h] [rbp-50h]
  unsigned int *v81; // [rsp+C0h] [rbp-48h]
  _BYTE v82[8]; // [rsp+C8h] [rbp-40h] BYREF
  __int64 v83; // [rsp+D0h] [rbp-38h]
  char v84; // [rsp+D8h] [rbp-30h]
  __int128 v85; // [rsp+E8h] [rbp-20h] BYREF
  PERESOURCE *v86; // [rsp+F8h] [rbp-10h] BYREF
  _BYTE v87[64]; // [rsp+100h] [rbp-8h] BYREF
  _BYTE v88[88]; // [rsp+140h] [rbp+38h] BYREF
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx((char *)v8 + 248, 0LL) )
  {
    if ( bTracingEnabled )
    {
      ...
      if ( v55 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
        McTemplateK0q_EtwWriteTransfer(v10, &EventBlockThread, v11, v55);
    }
...
LABEL_70:
  ...
  v78 = *(struct DXGADAPTER **)(*(_QWORD *)(v71[2] + 16LL) + 16LL);
  _InterlockedIncrement64((volatile signed __int64 *)v78 + 3);
  v77 = -1LL;
  KeEnterCriticalRegion();
  ExAcquirePushLockSharedEx((char *)v78 + 136, 0LL);
  _InterlockedIncrement((volatile signed __int32 *)v78 + 38);
  v72 = 0LL;
  v79 = 1;
  v22 = 4000LL * a1->VidPnSourceId;
  v23 = *(_QWORD *)(v71[2] + 1880LL);
    ...
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v30 + 88, 0LL) )
    {
      if ( bTracingEnabled )
      {
        ...
        if ( v57 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
          McTemplateK0q_EtwWriteTransfer(v34, &EventBlockThread, v32, v57);
      }
      _InterlockedIncrement64((volatile signed __int64 *)v70 + 2);
...
LABEL_102:
  ...
  v39 = v70;
  if ( *(struct _KTHREAD **)(v30 + 104) != KeGetCurrentThread() )
    WdLogSingleEntry5(0LL, 275LL, 4LL, v70, 0LL, 0LL);
  if ( *((int *)v70 + 8) <= 0 )
  {
  ...
  *(_QWORD *)&v85 = &v71;
  *((_QWORD *)&v85 + 1) = &v72;
  DXGKCALLONEXIT__lambda_897d21a97c0cf1b919de605caa0104f9_((__int64)&v74, &v85);
  KeEnterCriticalRegion();
  ...
  if ( v60 )
  {
    AdvancedColorMetadataOverride = MonitorGetAdvancedColorMetadataOverride(v72, v60);
    v49 = AdvancedColorMetadataOverride;
    if ( AdvancedColorMetadataOverride >= 0 )
    {
      *v80 = D3DDDI_HDR_METADATA_TYPE_HDR10;
      *v81 = 28;
      *(_QWORD *)v73[0] = v50;
LABEL_61:
      if ( v76 )
      {
        v45 = *v75;
        v46 = *(_QWORD *)(*(_QWORD *)(*v74 + 16LL) + 1880LL);
        v47 = WdLogNewEntry5_WdTrace(*v74, v42, v43, v44);
        *(_QWORD *)(v47 + 24) = v45;
        *(_QWORD *)(v47 + 32) = v46;
        if ( v46 )
        {
      ...
      v48 = (char *)v78 + 136;
      _InterlockedDecrement((volatile signed __int32 *)v78 + 38);
...
LABEL_71:
  if ( v15 && _InterlockedExchangeAdd64(v15 + 4, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
  {
    ...
    v67 = v15[2];
    v84 = 0;
    v83 = *(_QWORD *)(*(_QWORD *)(v67 + 16) + 16LL);
    DXGADAPTERSTOPRESETLOCKSHARED::Acquire((DXGADAPTERSTOPRESETLOCKSHARED *)v82);
    COREDEVICEACCESS::COREDEVICEACCESS((__int64)&v86, v66, 2, v68, 0);
    COREDEVICEACCESS::AcquireSharedUncheck((COREDEVICEACCESS *)&v86, v69);
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v66 + 16) + 16LL) + 200LL) != 4 )
      DXGDEVICE::DestroyContext((DXGDEVICE *)v66, (struct DXGCONTEXT *)v15, &v86);
