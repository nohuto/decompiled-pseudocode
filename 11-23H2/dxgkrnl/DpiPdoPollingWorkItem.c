/*
 * XREFs of DpiPdoPollingWorkItem @ 0x1C03A9990
 * Callers:
 ...
 *     DpiFdoInvalidateChildStatus @ 0x1C039C740 (DpiFdoInvalidateChildStatus.c)
 */
...
void __fastcall DpiPdoPollingWorkItem(PDEVICE_OBJECT DeviceObject, PVOID Context)
{
  ...
  while ( 1 )
  {
    ...
    v4 = qword_1C0140728;
    if ( (__int64 *)qword_1C0140728 == &qword_1C0140728 )
    {
      v4 = 0LL;
      _InterlockedExchange(&dword_1C0140720, 0);
    }
    else
    {
      if ( *(__int64 **)(qword_1C0140728 + 8) != &qword_1C0140728
        || (v5 = *(_QWORD *)qword_1C0140728, *(_QWORD *)(*(_QWORD *)qword_1C0140728 + 8LL) != qword_1C0140728) )
      {
        __fastfail(3u);
      }
      qword_1C0140728 = *(_QWORD *)qword_1C0140728;
      *(_QWORD *)(v5 + 8) = &qword_1C0140728;
    }
...
LABEL_21:
    ...
    ExFreeToNPagedLookasideList(&stru_1C0140580, (PVOID)v4);
    if ( v3 == 259 )
    {
      _InterlockedExchange(&dword_1C0140720, 0);
      KeSetTimer(&stru_1C0140698, (LARGE_INTEGER)-3000000LL, &stru_1C01406D8);
      return;
    }
  }
}
