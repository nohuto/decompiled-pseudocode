/*
 * XREFs of ?DdiControlInterrupt@DXGADAPTER@@QEAAJW4_DXGK_INTERRUPT_TYPE@@EI@Z @ 0x1C01974CC
 * Callers:
 *     DXGADAPTER_DdiControlInterrupt @ 0x1C0005500 (DXGADAPTER_DdiControlInterrupt.c)
