/*
 * XREFs of ?CreateSharedSyncNtObject@@YAJDW4_HMGRENTRY_TYPE@@IPEAXPEAU_OBJECT_ATTRIBUTES@@DPEAPEAX@Z @ 0x1C01EE324
 * Callers:
...
LABEL_40:
    if ( Object )
    {
      WdLogSingleEntry1(1LL, 441LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pObject == NULL", 441LL, 0LL, 0LL, 0LL, 0LL);
    }
