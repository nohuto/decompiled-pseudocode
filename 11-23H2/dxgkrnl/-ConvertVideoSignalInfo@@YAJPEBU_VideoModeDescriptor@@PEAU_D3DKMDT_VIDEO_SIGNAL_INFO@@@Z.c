/*
 * XREFs of ?ConvertVideoSignalInfo@@YAJPEBU_VideoModeDescriptor@@PEAU_D3DKMDT_VIDEO_SIGNAL_INFO@@@Z @ 0x1C001F7AC
 * Callers:
 ...
 *     ConvertVideoStandardType @ 0x1C001F87C (ConvertVideoStandardType.c)
 */
