/*
 * XREFs of ?Initialize@ADAPTER_RENDER@@QEAAJXZ @ 0x1C0211D70
 * Callers:
 ...
 *     ?InitializeDisplayUserModeDriverNames@ADAPTER_RENDER@@AEAAJPEAU_UNICODE_STRING@@0@Z @ 0x1C0213470 (-InitializeDisplayUserModeDriverNames@ADAPTER_RENDER@@AEAAJPEAU_UNICODE_STRING@@0@Z.c)
 *     ?InitializeUserModeDriverNames@ADAPTER_RENDER@@AEAAJPEAU_UNICODE_STRING@@0@Z @ 0x1C0213AAC (-InitializeUserModeDriverNames@ADAPTER_RENDER@@AEAAJPEAU_UNICODE_STRING@@0@Z.c)
  ...
  do
  {
    ...
    if ( *(_DWORD *)(v61 + 2096) >= 0x9000u )
    {
      if ( (*v59 & 1) != 0 )
      {
        ...
        {
          WdLogSingleEntry3(2LL, v1, v48, 1248LL);
          DxgkLogInternalTriageEvent(
            0LL,
            0x40000,
            -1,
        ...
        {
          WdLogSingleEntry3(2LL, v1, v48, 1254LL);
          DxgkLogInternalTriageEvent(
            0LL,
            0x40000,
            -1,
      ...
      if ( (v60 & 8) != 0 )
      {
        ...
        {
          WdLogSingleEntry2(2LL, v1, 1266LL);
          DxgkLogInternalTriageEvent(
            0LL,
            0x40000,
            -1,
        ...
        if ( (v60 & 1) == 0 )
        {
          WdLogSingleEntry3(2LL, v1, v48, 1272LL);
          DxgkLogInternalTriageEvent(
            0LL,
            0x40000,
            -1,
        ...
        {
          WdLogSingleEntry3(2LL, v1, v48, 1278LL);
          DxgkLogInternalTriageEvent(
            0LL,
            0x40000,
            -1,
      ...
      if ( (v60 & 0xFFF0) != 0 )
      {
        WdLogSingleEntry3(2LL, v1, v48, 1300LL);
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
    ...
    if ( v59[4] )
    {
      ...
      {
        WdLogSingleEntry3(2LL, v1, v48, 1309LL);
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
    ...
    if ( v59[5] )
    {
      ...
      {
        WdLogSingleEntry3(2LL, v1, v48, 1331LL);
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
