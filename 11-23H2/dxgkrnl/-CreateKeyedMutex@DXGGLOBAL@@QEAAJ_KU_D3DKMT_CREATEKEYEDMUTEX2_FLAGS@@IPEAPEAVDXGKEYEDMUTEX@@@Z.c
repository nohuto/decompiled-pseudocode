/*
 * XREFs of ?CreateKeyedMutex@DXGGLOBAL@@QEAAJ_KU_D3DKMT_CREATEKEYEDMUTEX2_FLAGS@@IPEAPEAVDXGKEYEDMUTEX@@@Z @ 0x1C034F010
 * Callers:
        ...
        struct DXGKEYEDMUTEX **a5)
{
  ...
  if ( !a5 )
  {
    WdLogSingleEntry1(1LL, 4513LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"ppKeyedMutex != NULL", 4513LL, 0LL, 0LL, 0LL, 0LL);
  }
  *a5 = 0LL;
