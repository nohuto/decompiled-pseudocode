/*
 * XREFs of McTemplateK0pqq_EtwWriteTransfer @ 0x1C0040FDC
 * Callers:
 ...
 *     ?DxgkPowerRuntimeComponentActiveCallback@@YAXPEAXK@Z @ 0x1C000C3F0 (-DxgkPowerRuntimeComponentActiveCallback@@YAXPEAXK@Z.c)
 *     ?DxgkPowerRuntimeComponentIdleCallback@@YAXPEAXK@Z @ 0x1C000C440 (-DxgkPowerRuntimeComponentIdleCallback@@YAXPEAXK@Z.c)
 ...
 *     ?HandleAdapterMultiPlaneDisableEvent@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C01D2590 (-HandleAdapterMultiPlaneDisableEvent@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z.c)
 ...
 *     ?ReportPowerComponentActive@DXGMONITOR@@UEBAXI@Z @ 0x1C03C90A0 (-ReportPowerComponentActive@DXGMONITOR@@UEBAXI@Z.c)
 *     ?ReportPowerComponentIdle@DXGMONITOR@@UEBAXI@Z @ 0x1C03C9120 (-ReportPowerComponentIdle@DXGMONITOR@@UEBAXI@Z.c)
 ...
 *     ?RemoveQueueHead@BLTQUEUE@@AEAAPEAVBLTENTRY@@PEAU_LIST_ENTRY@@@Z @ 0x1C03D3730 (-RemoveQueueHead@BLTQUEUE@@AEAAPEAVBLTENTRY@@PEAU_LIST_ENTRY@@@Z.c)
 * Callees:
