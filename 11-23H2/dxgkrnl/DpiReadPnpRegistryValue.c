/*
 * XREFs of DpiReadPnpRegistryValue @ 0x1C01FFF2C
 * Callers:
 ...
 *     DpiFdoIsCompatibleWithHighResolutionBoot @ 0x1C0228C24 (DpiFdoIsCompatibleWithHighResolutionBoot.c)
 *     ?OemSpecifiedViewDist@@YAIQEAX@Z @ 0x1C0302CAC (-OemSpecifiedViewDist@@YAIQEAX@Z.c)
 *     ?OemSpecifiedViewDist@Win81@@YAIQEAX@Z @ 0x1C03215B4 (-OemSpecifiedViewDist@Win81@@YAIQEAX@Z.c)
