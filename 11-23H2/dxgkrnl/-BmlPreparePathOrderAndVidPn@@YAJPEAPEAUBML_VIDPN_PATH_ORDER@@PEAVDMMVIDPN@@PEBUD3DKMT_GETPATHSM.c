/*
 * XREFs of ?BmlPreparePathOrderAndVidPn@@YAJPEAPEAUBML_VIDPN_PATH_ORDER@@PEAVDMMVIDPN@@PEBUD3DKMT_GETPATHSMODALITY@@GGW4DXGK_DIAG_CCD_BML_ORIGIN@@I@Z @ 0x1C0178EE0
 * Callers:
 ...
 *     ?D3DKMDT_VPPR_CONVERT_ROTATION_GIVEN_OFFSET@@YA?AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W41@0@Z @ 0x1C006B604 (-D3DKMDT_VPPR_CONVERT_ROTATION_GIVEN_OFFSET@@YA-AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W41@0@Z.c)
        ...
        int a7)
{
  ...
  *(_DWORD *)(v19 + 8) = *(_DWORD *)(v19 + 8) & 0xFFFFFFFD | (v18 != 0 ? 2 : 0);
  PreferredHdrPixelFormat = ADAPTER_DISPLAY::GetPreferredHdrPixelFormat((__int64)v14);
  v22 = (_DWORD *)*a1;
  v23 = v21;
...
LABEL_94:
    ...
    v86 = (int)v85[33];
    v87 = D3DKMDT_VPPR_GET_CONTENT_ROTATION((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)v85[33]) - 1;
    if ( v87 )
    {
      v88 = v87 - 1;
      if ( v88 )
...
LABEL_124:
    ...
    else
    {
      ...
      *(_DWORD *)&v33[v50 + 28] = D3DKMDT_VPPR_GET_CONTENT_ROTATION((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)*(_DWORD *)(*(_QWORD *)&v33[v50 + 16] + 132LL));
    }
LABEL_125:
    ...
    {
      if ( (((unsigned int)D3DKMDT_VPPR_GET_CONTENT_ROTATION((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)*(_DWORD *)&v33[v50 + 28])
           - 2) & 0xFFFFFFFD) != 0 )
      {
