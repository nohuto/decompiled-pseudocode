/*
 * XREFs of MonitorSetSDRWhiteLevelOverride @ 0x1C03C51F0
 * Callers:
...
__int64 __fastcall MonitorSetSDRWhiteLevelOverride(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)(v7 + 32) = a1;
  ...
  if ( v13 )
  {
    if ( DxgMonitor::MonitorColorState::EdidSupportsHDR(*((DxgMonitor::MonitorColorState **)v13 + 28))
      || (*((_BYTE *)v8 + 177) & 0x40) != 0 && !DXGMONITOR::HasDescriptor(v8) )
    {
      ...
      if ( v10 >= 0 )
      {
        TriggerSDRWhiteLevelChangedWnf(v11);
        LODWORD(v9) = 0;
        goto LABEL_12;
      }
    }
