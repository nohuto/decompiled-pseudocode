/*
 * XREFs of ?SaveTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEBVCCD_TOPOLOGY@@_N@Z @ 0x1C03C3130
 * Callers:
 *     _anonymous_namespace_::_SaveTopologySetCallback @ 0x1C03BC630 (_anonymous_namespace_--_SaveTopologySetCallback.c)
 * Callees:
 *     ?GetBitsPerPixel@@YAIW4_D3DDDIFORMAT@@@Z @ 0x1C0001EF8 (-GetBitsPerPixel@@YAIW4_D3DDDIFORMAT@@@Z.c)
 ...
 *     ?MapModalitySetIdPath@CCD_TOPOLOGY@@QEBAJIPEAG@Z @ 0x1C03BC56C (-MapModalitySetIdPath@CCD_TOPOLOGY@@QEBAJIPEAG@Z.c)
...
LABEL_32:
        ...
        if ( !v34 )
        {
          ...
          *(_DWORD *)(v14 + 112) = v20 * (BitsPerPixel >> 3);
          v21 = CcdWriteRegistryValues((_DWORD)Handle, 0, (unsigned int)&unk_1C013F6A0, 8, v14);
          ...
          if ( v21 < 0
            || (*(_DWORD *)(v14 + 100) = v35,
                ...
                *(_DWORD *)(v14 + 96) = v16,
                v39 = 4,
                v22 = CcdWriteRegistryValues((_DWORD)Handle, 0, (unsigned int)&unk_1C013F630, 2, (__int64)&v39),
