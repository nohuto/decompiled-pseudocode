/*
 * XREFs of ?VmBusSendAsyncPacket@@YAJPEAUVMBPACKET__@@PEAUDXGKVMB_COMMAND_BASE@@I@Z @ 0x1C005D23C
 * Callers:
...
__int64 __fastcall VmBusSendAsyncPacket(struct VMBPACKET__ *a1, struct DXGKVMB_COMMAND_BASE *a2, __int64 a3)
{
  ...
  v7 = _InterlockedIncrement64(&qword_1C0142458);
...
LABEL_15:
  ...
  v11 = ((__int64 (__fastcall *)(struct VMBPACKET__ *, struct DXGKVMB_COMMAND_BASE *, _QWORD, _QWORD, int))qword_1C0141FE0)(
          a1,
          a2,
          v3,
          0LL,
