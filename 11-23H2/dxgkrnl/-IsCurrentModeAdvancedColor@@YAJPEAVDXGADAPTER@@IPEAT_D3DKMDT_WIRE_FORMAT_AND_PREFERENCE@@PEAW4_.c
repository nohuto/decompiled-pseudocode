/*
 * XREFs of ?IsCurrentModeAdvancedColor@@YAJPEAVDXGADAPTER@@IPEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@PEAW4_D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE@@PEA_N@Z @ 0x1C019D520
 * Callers:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  ...
  CurrentWireFormatAndColorSpace = DmmGetCurrentWireFormatAndColorSpace(a1, (unsigned int)a5, v8, &v18, v19);
