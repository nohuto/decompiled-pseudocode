/*
 * XREFs of ?VmBusSendSyncMessage@DXG_VMBUS_CHANNEL_BASE@@QEAAJPEAEPEAUDXGKVMB_COMMAND_BASE@@IPEAXPEAIPEAU_MDL@@@Z @ 0x1C038FC58
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  if ( v31 - 24 <= 0x1FFE7 && v12 < 0x20000 )
  {
    ...
    v15 = _InterlockedIncrement64(&qword_1C0142458);
...
LABEL_29:
    v13 = (int)((__int64 (__fastcall *)(struct _KTHREAD *, unsigned __int8 *, _QWORD, _QWORD, int, char *, unsigned int *, _QWORD))qword_1C0141F70)(
                 this[1],
                 v35,
                 v31,
                 0LL,
