/*
 * XREFs of _lambda_d553670f9cadd4da475e2936e6caa2f6_::operator() @ 0x1C02F46AC
 * Callers:
 *     _lambda_2b831a354495e24a997c7e563732c286_::operator() @ 0x1C02F3C54 (_lambda_2b831a354495e24a997c7e563732c286_--operator().c)
 * Callees:
  ...
  *(_DWORD *)(a3 + 28) = *(_DWORD *)(a4 + 12);
  if ( (*(_DWORD *)a4 & 1) != 0 )
  {
    ...
    *(_DWORD *)(a3 + 72) ^= (*(_DWORD *)(a3 + 72) ^ (*(_DWORD *)(a4 + 44) << 16)) & 0x3F0000;
    v6 = ConvertDmmToDisplayConfigRotation((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)*(_DWORD *)(a4 + 32));
    v5[26] = v6;
    v5[29] = v7[4];
    v5[30] = v7[5];
