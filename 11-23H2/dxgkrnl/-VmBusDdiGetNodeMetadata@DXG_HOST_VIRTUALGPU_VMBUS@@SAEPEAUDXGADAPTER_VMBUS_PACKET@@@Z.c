/*
 * XREFs of ?VmBusDdiGetNodeMetadata@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C037C080
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_BYTE *)(v2 + 173) )
  {
    ...
    if ( v17[4] >= 0 )
    {
      ...
      if ( v8 < v9 )
      {
        ...
        WdLogSingleEntry1(3LL, 4811LL);
      }
      else
      {
        WdLogSingleEntry1(3LL, 4803LL);
      }
