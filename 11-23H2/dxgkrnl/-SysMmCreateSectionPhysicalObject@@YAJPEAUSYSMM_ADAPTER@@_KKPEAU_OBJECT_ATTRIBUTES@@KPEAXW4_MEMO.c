/*
 * XREFs of ?SysMmCreateSectionPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KKPEAU_OBJECT_ATTRIBUTES@@KPEAXW4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x1C03D6974
 * Callers:
 *     DxgkCreatePhysicalMemoryObjectCB @ 0x1C0052FA0 (DxgkCreatePhysicalMemoryObjectCB.c)
 *     SysMmTestCreateSectionPhysicalObject @ 0x1C00724C0 (SysMmTestCreateSectionPhysicalObject.c)
 * Callees:
        ...
        __int64 a11)
{
  ...
  {
    _InterlockedIncrement(&dword_1C0140D0C);
