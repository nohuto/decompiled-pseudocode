/*
 * XREFs of SmmQueryRegistry @ 0x1C021B7B0
 * Callers:
...
__int64 SmmQueryRegistry()
{
  ...
  if ( v5 >= 3 )
    v1 = v6;
  result = v10 & 1;
  dword_1C0140CD0 = (v7 != 0 ? 4 : 0) | (dword_1C0140CD0 ^ ((unsigned __int8)dword_1C0140CD0 ^ v1) & 3) & 0xFFFFFF03 | (8 * (v0 & 3 | (4 * (result | (2 * (v9 & 1 | (2 * (v8 & 1))))))));
  return result;
}
