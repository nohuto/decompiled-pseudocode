/*
 * XREFs of ?Initialize@DXGPROCESS_RENDER_ADAPTER_INFO@@QEAAJPEAVDXGPROCESS@@PEAVADAPTER_RENDER@@@Z @ 0x1C018F4E4
 * Callers:
...
LABEL_29:
    ...
    if ( DXGADAPTER::IsGpuVaIoMmuSupported((DXGADAPTER *)v8) )
    {
      ...
      {
        LODWORD(v6) = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD))qword_1C0140BF0)(3LL, 0LL, 0LL);
        if ( (int)v6 >= 0 )
          goto LABEL_42;
      }
      else
