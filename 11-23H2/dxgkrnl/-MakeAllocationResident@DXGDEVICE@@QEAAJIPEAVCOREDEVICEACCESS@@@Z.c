/*
 * XREFs of ?MakeAllocationResident@DXGDEVICE@@QEAAJIPEAVCOREDEVICEACCESS@@@Z @ 0x1C02EB9E4
 * Callers:
...
LABEL_10:
  ...
  if ( !v21 )
  {
    WdLogSingleEntry1(1LL, 8705LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"AllocRef.m_pAllocation != NULL", 8705LL, 0LL, 0LL, 0LL, 0LL);
  }
