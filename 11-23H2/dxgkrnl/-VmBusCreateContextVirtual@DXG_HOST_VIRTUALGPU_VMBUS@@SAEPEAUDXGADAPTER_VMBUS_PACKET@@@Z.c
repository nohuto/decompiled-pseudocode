/*
 * XREFs of ?VmBusCreateContextVirtual@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C037A690
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( v10 - 55 < v9 )
  {
    WdLogSingleEntry2(2LL, v10, 1134LL);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
  ...
  *(_DWORD *)(v6 + 24) = 0;
  ...
  {
    v13 = v12;
    WdLogSingleEntry2(2LL, v12, 1161LL);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
