/*
 * XREFs of Feature_OnlyHandlingLidSwitchInBroker__private_ReportDeviceUsage @ 0x1C0026FD4
 * Callers:
...
void Feature_OnlyHandlingLidSwitchInBroker__private_ReportDeviceUsage()
{
  __int64 v0; // [rsp+30h] [rbp+8h]

  v0 = (unsigned int)Feature_OnlyHandlingLidSwitchInBroker__private_featureState;
  if ( (Feature_OnlyHandlingLidSwitchInBroker__private_featureState & 0x10) == 0 )
  {
    LODWORD(v0) = Feature_OnlyHandlingLidSwitchInBroker__private_featureState | 1;
