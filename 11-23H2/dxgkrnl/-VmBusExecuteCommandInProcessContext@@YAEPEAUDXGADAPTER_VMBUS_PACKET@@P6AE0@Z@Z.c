/*
 * XREFs of ?VmBusExecuteCommandInProcessContext@@YAEPEAUDXGADAPTER_VMBUS_PACKET@@P6AE0@Z@Z @ 0x1C037E25C
 * Callers:
        ...
        && (*(_DWORD *)(v9 + 16LL * v8 + 8) & 0x2000) == 0 )
      {
        ...
        if ( v10 )
        {
          if ( v10 == 12 )
          {
            ...
            if ( v7 )
              goto LABEL_12;
            WdLogSingleEntry2(2LL, *(unsigned int *)(v3 + 8), 314LL);
