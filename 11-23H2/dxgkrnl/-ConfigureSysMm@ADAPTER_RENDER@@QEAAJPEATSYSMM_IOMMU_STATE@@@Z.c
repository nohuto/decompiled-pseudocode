/*
 * XREFs of ?ConfigureSysMm@ADAPTER_RENDER@@QEAAJPEATSYSMM_IOMMU_STATE@@@Z @ 0x1C0213CD4
 * Callers:
  ...
  if ( (_DWORD)v22 )
  {
    ...
    if ( v10 )
    {
      ...
      *((_QWORD *)&v22 + 1) = v10;
      ...
      {
        WdLogSingleEntry1(1LL, 4389LL);
        DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NT_SUCCESS(Status)", 4389LL, 0LL, 0LL, 0LL, 0LL);
      }
      goto LABEL_8;
    }
