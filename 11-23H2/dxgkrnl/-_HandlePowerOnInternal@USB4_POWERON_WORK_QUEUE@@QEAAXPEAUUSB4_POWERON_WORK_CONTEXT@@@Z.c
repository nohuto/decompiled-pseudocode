/*
 * XREFs of ?_HandlePowerOnInternal@USB4_POWERON_WORK_QUEUE@@QEAAXPEAUUSB4_POWERON_WORK_CONTEXT@@@Z @ 0x1C03CADB0
 * Callers:
 ...
 *     DXGKCALLONEXIT__lambda_d7f36fd7568915a231f5d0e0139551af___ @ 0x1C006C764 (DXGKCALLONEXIT__lambda_d7f36fd7568915a231f5d0e0139551af___.c)
 ...
 *     ?AddUsb4HRPowerRef@Usb4HostRouterPoFxRef@DxgMonitor@@QEAAJPEAUUSB4_POFXREF_CONTEXT@@@Z @ 0x1C03CA31C (-AddUsb4HRPowerRef@Usb4HostRouterPoFxRef@DxgMonitor@@QEAAJPEAUUSB4_POFXREF_CONTEXT@@@Z.c)
        ...
        struct USB4_POWERON_WORK_CONTEXT *a2)
{
  ...
  struct FlipManagerObject *v26; // [rsp+68h] [rbp-98h] BYREF
    ...
    *((struct DXGADAPTER **)&v27 + 1) = v29[0];
    ...
    if ( *((_DWORD *)v3 + 50) == 1 )
    {
      ...
      if ( v16 >= 0 )
      {
        ...
        {
          v22[0] = 0;
          v18 = DmmPowerOnOffTargetsFromSourceIfNecessary((PERESOURCE *)v4, 0LL, (struct _DMM_SET_TIMING_RESULT *)v22);
          v21 = v18;
          if ( v18 >= 0 )
          {
