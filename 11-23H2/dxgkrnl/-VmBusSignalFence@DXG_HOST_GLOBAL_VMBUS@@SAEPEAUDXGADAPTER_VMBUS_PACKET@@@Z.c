/*
 * XREFs of ?VmBusSignalFence@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0392D80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_24:
    ...
    if ( !v10 || *(_DWORD *)v10 != 11 && *(_DWORD *)v10 != 8 )
      goto LABEL_9;
    v11 = *(DXGSYNCOBJECT **)(v10 + 8);
    if ( !v11 )
    {
      WdLogSingleEntry1(1LL, 7614LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pSyncObject", 7614LL, 0LL, 0LL, 0LL, 0LL);
    }
LABEL_31:
  ...
  if ( v4 == 1 )
  {
    ...
    if ( v13 < *((_DWORD *)v12 + 74) )
    {
        ...
        && (*(_DWORD *)(v14 + 16LL * v13 + 8) & 0x2000) == 0 )
      {
        ...
        if ( v15 )
        {
          if ( v15 == 8 )
          {
            v11 = *(DXGSYNCOBJECT **)(v14 + 16LL * v13);
            if ( v11 )
              goto LABEL_31;
          }
          else
    ...
    WdLogSingleEntry2(2LL, *(unsigned int *)(v3 + 24), 7609LL);
