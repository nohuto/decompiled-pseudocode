/*
 * XREFs of ?DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C000D210
 * Callers:
 *     <none>
 * Callees:
 *     ?ScheduleComponentIdleListTimer@DXGADAPTER@@QEAAX_J@Z @ 0x1C000D404 (-ScheduleComponentIdleListTimer@DXGADAPTER@@QEAAX_J@Z.c)
