/*
 * XREFs of ?LogDisplayTelemetrySourceInfo@DISPLAYSTATECHECKER@@AEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@PEBUDXG_BLACKBOX_DISPLAY_SOURCE_INFO@@@Z @ 0x1C02F9494
 * Callers:
        ...
        const struct DXG_BLACKBOX_DISPLAY_SOURCE_INFO *a3)
{
  ...
  if ( a3 && a2 )
  {
    ...
    {
      if ( tlgKeywordOn((__int64)&dword_1C013F918, 0x400000000400LL) )
      {
        LOBYTE(v25) = v8;
