/*
 * XREFs of ?_PrepareMonitorCCDName@DXGMONITOR@@AEAAJXZ @ 0x1C0208CEC
 * Callers:
...
LABEL_48:
          ...
          *(_WORD *)(v17 + 2 * v15 + 24) = 0;
          v19 = (__int64 *)qword_1C0141C60;
          if ( *(struct _LIST_ENTRY **)qword_1C0141C60 != &DXGMONITOR::_UniqueEntryList )
            __fastfail(3u);
