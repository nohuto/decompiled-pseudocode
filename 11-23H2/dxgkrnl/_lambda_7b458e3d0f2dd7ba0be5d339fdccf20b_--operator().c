/*
 * XREFs of _lambda_7b458e3d0f2dd7ba0be5d339fdccf20b_::operator() @ 0x1C0167720
 * Callers:
...
__int64 __fastcall lambda_7b458e3d0f2dd7ba0be5d339fdccf20b_::operator()(__int64 **a1)
{
  __int64 v2; // rsi
  __int64 *v4; // rax
  ...
  if ( *(_DWORD *)(v2 + 392) >= 0x23u )
  {
    ...
    {
      WdLogSingleEntry1(2LL, 8365LL);
      DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Shared page is not enabled", 8365LL, 0LL, 0LL, 0LL, 0LL);
      return 3221225485LL;
    }
  }
  else
  {
    WdLogSingleEntry1(2LL, 8352LL);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
