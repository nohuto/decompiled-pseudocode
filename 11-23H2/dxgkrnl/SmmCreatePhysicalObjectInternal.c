/*
 * XREFs of SmmCreatePhysicalObjectInternal @ 0x1C0012990
 * Callers:
 *     SmmCreatePhysicalObject @ 0x1C00128DC (SmmCreatePhysicalObject.c)
 * Callees:
 *     ??_U@YAPEAX_KIW4DXGK_POOL_FLAGS@@@Z @ 0x1C000A400 (--_U@YAPEAX_KIW4DXGK_POOL_FLAGS@@@Z.c)
 *     SmmInitializePhysicalObject @ 0x1C0012BD8 (SmmInitializePhysicalObject.c)
...
_QWORD *__fastcall SmmCreatePhysicalObjectInternal(int a1, int a2, int a3, int a4, char a5, __int64 a6, int a7)
{
  ...
  if ( !Pool2 )
  {
    _InterlockedIncrement(&dword_1C0140D1C);
  ...
  if ( (dword_1C0140CD0 & 0x20) != 0 )
  {
    v11 = operator new[](0x90uLL, 0x31737844u, 64LL);
    if ( !v11 )
    {
      _InterlockedIncrement(&dword_1C0140D20);
  ...
  _InterlockedExchangeAdd64(&qword_1C0140CD8, *Pool2);
  v14 = (volatile signed __int64 *)&unk_1C0140CE8;
  if ( (*((_DWORD *)Pool2 + 11) & 1) == 0 )
    v14 = (volatile signed __int64 *)&unk_1C0140CE0;
