/*
 * XREFs of ?PresentMultiPlaneOverlay2@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY2@@PEAVCOREDEVICEACCESS@@PEAPEAV1@@Z @ 0x1C0324750
 * Callers:
        ...
        struct DXGCONTEXT **a4)
{
  ...
  *(_QWORD *)&v19[32] = v20;
  return DXGCONTEXT::PresentMultiPlaneOverlay3(this, (struct _D3DKMT_PRESENT_MULTIPLANE_OVERLAY3 *)v19, a3, a4);
}
