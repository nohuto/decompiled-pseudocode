/*
 * XREFs of ??ROBTAIN_MODES_ON_SOURCE@@QEBAJPEAPEAU_D3DKMT_DISPLAYMODE@@PEAI01@Z @ 0x1C01F7020
 * Callers:
 ...
 *     _UpgradeDispModeFlags @ 0x1C01F8108 (_UpgradeDispModeFlags.c)
 *     ?AddUniqueMode@MODE_UNION_LIST@@QEAAJAEBU_D3DKMT_DISPLAYMODE@@@Z @ 0x1C01F816C (-AddUniqueMode@MODE_UNION_LIST@@QEAAJAEBU_D3DKMT_DISPLAYMODE@@@Z.c)
 ...
 *     ?FindMode@MODE_UNION_LIST@@QEAAPEAU_D3DKMT_DISPLAYMODE@@AEBU2@@Z @ 0x1C0300958 (-FindMode@MODE_UNION_LIST@@QEAAPEAU_D3DKMT_DISPLAYMODE@@AEBU2@@Z.c)
 *     ?_AddMode@OBTAIN_MODES_ON_SOURCE@@AEBAJAEAU_D3DKMT_DISPLAYMODE@@_N1@Z @ 0x1C0301000 (-_AddMode@OBTAIN_MODES_ON_SOURCE@@AEBAJAEAU_D3DKMT_DISPLAYMODE@@_N1@Z.c)
 */
...
LABEL_234:
      ...
      *((_DWORD *)&v191.Flags + 1) = v76;
      ...
      v83 = 0;
      v84 = (unsigned int *)&unk_1C00903A8;
      while ( 1 )
      {
        if ( Denominator )
        {
...
LABEL_118:
      ...
      for ( i = 0; i < 7; ++i )
      {
        if ( DMMVIDEOSIGNALMODE::IsFreqWithinToleranceRange(
               &v196,
               (const struct _D3DDDI_RATIONAL *)&unk_1C00D79D8 + i,
               0) )
        {
          goto LABEL_267;
        }
