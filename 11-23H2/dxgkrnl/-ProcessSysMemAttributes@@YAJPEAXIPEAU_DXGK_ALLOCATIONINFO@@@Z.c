/*
 * XREFs of ?ProcessSysMemAttributes@@YAJPEAXIPEAU_DXGK_ALLOCATIONINFO@@@Z @ 0x1C02D8274
 * Callers:
...
__int64 __fastcall ProcessSysMemAttributes(PVOID BaseAddress, unsigned int a2, struct _DXGK_ALLOCATIONINFO *a3)
{
  ...
  if ( v8 )
  {
    ...
    if ( v11 >= 0 )
    {
      if ( *((_QWORD *)v9 + 3) >= v3 )
      {
        if ( (v9[10] & 0x800000) != 0 )
        {
          ...
          WdLogSingleEntry2(2LL, -1073741811LL, 3905LL);
      ...
      {
        LODWORD(v10) = -1073741811;
        WdLogSingleEntry2(2LL, -1073741811LL, 3893LL);
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
    ...
    {
      WdLogSingleEntry2(2LL, v11, 3886LL);
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        -1,
