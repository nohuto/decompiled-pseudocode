/*
 * XREFs of DxgkSetDodIndirectSwapchain @ 0x1C02D5720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetDodIndirectSwapchain(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !Current )
  {
    WdLogSingleEntry1(2LL, 9594LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Invalid process context", 9594LL, 0LL, 0LL, 0LL, 0LL);
LABEL_53:
