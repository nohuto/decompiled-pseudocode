/*
 * XREFs of ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C02143F8
 * Callers:
...
__int64 __fastcall DXGGLOBAL::Initialize(DXGGLOBAL *this)
{
  ...
  *(_QWORD *)(v1 + 144) = v4;
  ...
  qword_1C0140AF0 = ZwAllocateVirtualMemoryEx;
  qword_1C0140AF8 = (__int64)ZwFreeVirtualMemory;
  qword_1C0140B00 = (__int64)MmMapViewOfSection;
  qword_1C0140B08 = (__int64)MmUnmapViewOfSection;
  qword_1C0140B10 = (__int64)MmMapLockedPagesSpecifyCache;
  qword_1C0140B18 = (__int64)MmUnmapLockedPages;
  g_WslSubsystem = ZwAllocateVirtualMemory;
  qword_1C0140AB8 = ZwAllocateVirtualMemoryEx;
  qword_1C0140AC0 = (__int64)ZwFreeVirtualMemory;
  qword_1C0140AC8 = (__int64)MmMapViewOfSection;
  qword_1C0140AD0 = (__int64)MmUnmapViewOfSection;
  qword_1C0140AD8 = (__int64)MmMapLockedPagesSpecifyCache;
  qword_1C0140AE0 = (__int64)MmUnmapLockedPages;
...
LABEL_65:
  ...
  *(_QWORD *)(v1 + 1496) = v43;
  if ( !v43 )
  {
    WdLogSingleEntry1(6LL, 2055LL);
    DxgkLogInternalTriageEvent(0LL, 262145, -1, (__int64)L"Failed to Qdc cache.", 2055LL, 0LL, 0LL, 0LL, 0LL);
    return 3221225495LL;
  }
  KeInitializeSpinLock(&qword_1C0140A68);
