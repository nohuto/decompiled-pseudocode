/*
 * XREFs of SmmAcquireBlock @ 0x1C00708BC
 * Callers:
 ...
 *     SmmGetFreeBlockFromPool @ 0x1C007101C (SmmGetFreeBlockFromPool.c)
 *     SmmReleaseBlock @ 0x1C007113C (SmmReleaseBlock.c)
 */
...
__int64 __fastcall SmmAcquireBlock(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( !(_BYTE)a3 || (result = SmmGetFreeBlockFromPool(a1 + 24LL * (unsigned __int8)a2, a2, a4)) == 0 )
  {
    ...
    if ( !v14 )
    {
      _InterlockedIncrement(&dword_1C0140D3C);
