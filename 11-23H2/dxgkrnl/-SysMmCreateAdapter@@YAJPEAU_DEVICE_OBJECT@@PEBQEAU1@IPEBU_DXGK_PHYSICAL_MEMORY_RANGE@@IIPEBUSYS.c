/*
 * XREFs of ?SysMmCreateAdapter@@YAJPEAU_DEVICE_OBJECT@@PEBQEAU1@IPEBU_DXGK_PHYSICAL_MEMORY_RANGE@@IIPEBUSYSMM_ADAPTER_CREATE_PARAMS@@PEAPEAUSYSMM_ADAPTER@@@Z @ 0x1C0218E00
 * Callers:
        ...
        struct SYSMM_ADAPTER **a8)
{
  ...
  if ( !v14 )
  {
    _InterlockedIncrement(&dword_1C0140CF8);
...
LABEL_22:
        ...
        if ( (dword_1C0140CD0 & 3) != 0 )
        {
          v25 = SysMmEnableIommu(v15, 8LL);
          LODWORD(v19) = v25;
          if ( v25 < 0 )
          {
            if ( (dword_1C0140CD0 & 3) != 2 )
              goto LABEL_9;
        ...
        if ( v12 )
        {
          if ( (dword_1C0140CD0 & 0x80u) == 0 || (*((_DWORD *)a7 + 4) & 4) == 0 )
            goto LABEL_46;
        }
