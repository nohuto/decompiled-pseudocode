/*
 * XREFs of ?GetRequestedPathsModality@@YAJI_NAEAUQDC_CONTEXT@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x1C017D2A4
 * Callers:
        ...
        enum DISPLAYCONFIG_TOPOLOGY_ID *a4)
{
  ...
  if ( (a1 & 0x200000) != 0 )
  {
    ...
    DisplayConfigBufferSizes = DxgkGetDisplayConfigBufferSizes(v13, &v18);
