/*
 * XREFs of DpiInitializeGlobalState @ 0x1C03DE1F8
 * Callers:
...
__int64 DpiInitializeGlobalState()
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  v2 = ZwQueryLicenseValue(v35, &v29, &dword_1C0140A00, 4LL, &v28);
  if ( v2 < 0 )
  {
  ...
  v3 = ZwQueryLicenseValue(v36, &v29, &dword_1C0140A04, 4LL, &v28);
  if ( v3 < 0 )
  {
  ...
  *((_QWORD *)&v49 + 1) = &v25;
  ...
  if ( (v4 < 0 || !dword_1C01408C4) && (dword_1C01408C4 = 7236, v4 < 0) || (byte_1C0140496 = 1, !v25) )
    byte_1C0140496 = 0;
  v5 = -v24;
  v24 = 0;
  DueTime.QuadPart = v5;
  ...
  v48 = 0LL;
  v49 = 0LL;
  byte_1C0140498 = (int)RtlQueryRegistryValuesEx(2LL, L"GraphicsDrivers", &v39, 0LL, 0LL) >= 0 && v24 != 0;
  v24 = 0;
  v43 = 67108868;
  LODWORD(v49) = 67108868;
  v41 = L"HwSchMode";
...
LABEL_57:
  ...
  word_1C01404E0 = 0;
  qword_1C01404D0 = (__int64)&qword_1C01404C8;
  qword_1C01404C8 = (__int64)&qword_1C01404C8;
  KeInitializeEvent(&stru_1C01404E8, NotificationEvent, 0);
  byte_1C01404E2 = 0;
  ...
  if ( !v19
    || (KeInitializeMutex(v19, 0),
        dword_1C0140720 = 0,
        qword_1C0140730 = (__int64)&qword_1C0140728,
        qword_1C0140728 = (__int64)&qword_1C0140728,
        KeInitializeTimerEx(&stru_1C0140698, SynchronizationTimer),
        KeInitializeDpc(&stru_1C01406D8, (PKDEFERRED_ROUTINE)DpiPdoPollingDpc, 0LL),
        (qword_1C0140718 = IoAllocateWorkItem((PDEVICE_OBJECT)g_pDriverObject)) == 0LL) )
  {
LABEL_56:
    v22 = -1073741801LL;
  ...
  ExInitializeNPagedLookasideList(&stru_1C0140580, 0LL, 0LL, 0x200u, 0x30uLL, 0x74727044u, 0);
  byte_1C0140840 = 0;
  KeInitializeMutex(&stru_1C0140848, 0);
  v32 = 2;
  qword_1C0140888 = (__int64)&qword_1C0140880;
  qword_1C0140880 = (__int64)&qword_1C0140880;
  v34 = 4;
  ...
  qword_1C01408A8 = (__int64)&qword_1C01408A0;
  qword_1C01408A0 = (__int64)&qword_1C01408A0;
  dword_1C01408C0 = 0;
  qword_1C01408B8 = (__int64)&qword_1C01408B0;
  qword_1C01408B0 = (__int64)&qword_1C01408B0;
  ...
  {
    IoWorkItem = 0LL;
    qword_1C0140668 = (__int64)&qword_1C0140660;
    qword_1C0140660 = (__int64)&qword_1C0140660;
    dword_1C0140670 = 0;
    qword_1C0140658 = 0LL;
    dword_1C0140620 = 1;
    qword_1C0140628 = 0LL;
    dword_1C0140630 = 0;
    KeInitializeEvent(&stru_1C0140638, SynchronizationEvent, 0);
    KeInitializeEvent(&Event, NotificationEvent, 1u);
    byte_1C01409B0 = 0;
    KeInitializeMutex(&stru_1C01409B8, 0);
    byte_1C014049B = 0;
    qword_1C01409F8 = (__int64)&qword_1C01409F0;
    qword_1C01409F0 = &qword_1C01409F0;
    qword_1C0140988 = 1LL;
    dword_1C014083C = 0;
    goto LABEL_42;
  }
