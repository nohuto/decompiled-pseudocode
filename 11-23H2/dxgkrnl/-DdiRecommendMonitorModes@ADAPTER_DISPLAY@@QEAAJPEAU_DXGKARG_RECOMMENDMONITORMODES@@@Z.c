/*
 * XREFs of ?DdiRecommendMonitorModes@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDMONITORMODES@@@Z @ 0x1C0225C64
 * Callers:
 *     ?QueryDriverRecommendedMonitorModes@KernelDriver@@UEBAJXZ @ 0x1C0225C00 (-QueryDriverRecommendedMonitorModes@KernelDriver@@UEBAJXZ.c)
 * Callees:
