/*
 * XREFs of ?CreateModeList@ADAPTER_DISPLAY@@QEAAJEPEAU_D3DKMT_GETDISPLAYMODELIST@@@Z @ 0x1C021D070
 * Callers:
        ...
        struct _D3DKMT_GETDISPLAYMODELIST *a3)
{
  ...
  if ( !a3 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pDisplayModeList != NULL", 6583LL, 0LL, 0LL, 0LL, 0LL);
  }
