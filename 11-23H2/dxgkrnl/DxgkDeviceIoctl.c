/*
 * XREFs of DxgkDeviceIoctl @ 0x1C004DE30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_43:
      ...
      if ( !v9 )
      {
        ...
        WdLogSingleEntry2(1LL, -1073741275LL, 1069LL);
        if ( bTracingEnabled )
        {
          if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x80000000LL) != 0 )
            McTemplateK0zqqzxxxxx_EtwWriteTransfer(
      ...
      DXGPROCESSDDILOCK::~DXGPROCESSDDILOCK((DXGPROCESSDDILOCK *)&v42);
      if ( (int)v7 >= 0 )
      {
