/*
 * XREFs of ??$FindProperty@UBatchSyncInfo@@@CFlipPropertySetBase@@QEAAXPEAPEAUBatchSyncInfo@@@Z @ 0x1C0081B18
 * Callers:
...
void __fastcall CFlipPropertySetBase::FindProperty<BatchSyncInfo>(__int64 a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v3 )
  {
    ...
    {
      v6 = 32LL * v2;
      v7 = *(_QWORD *)(v6 + v5) - *(_QWORD *)&GUID_7d0dcf87_222e_4d05_b402_3bfa5181ec53.Data1;
      if ( !v7 )
        v7 = *(_QWORD *)(v6 + v5 + 8) - *(_QWORD *)GUID_7d0dcf87_222e_4d05_b402_3bfa5181ec53.Data4;
