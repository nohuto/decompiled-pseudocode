/*
 * XREFs of ??ROBTAIN_PREFERRED_MODES_ON_PATH@@QEBAJPEAPEAU_D3DKMT_DISPLAYMODE@@PEAI@Z @ 0x1C02FF050
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION v44; // eax
  int v45; // eax
