/*
 * XREFs of ?DxgkCddOpenResource@@YAJPEAU_D3DKMT_OPENRESOURCE@@IPEAU_EPROCESS@@PEAIPEAPEAXPEA_K@Z @ 0x1C016B460
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a6)
{
  ...
  if ( v27 )
  {
    ...
    if ( v16 < 0
      || (v16 = DXGDEVICE::OpenResource<_D3DKMT_OPENRESOURCE>(v13, a2, (__int64)&v37, 0, (__int64)a3, (__int64)a4, v29),
          v16 < 0) )
    {
      v21 = v16;
LABEL_16:
