/*
 * XREFs of ?CreateDriverAllocations@DXGDEVICE@@QEAAJPEAU_D3DKMT_CREATEALLOCATION@@PEAU_D3DDDI_ALLOCATIONINFO2@@PEAU_DXGK_ALLOCATIONINFO@@PEAVDXGALLOCATION@@PEAVDXGRESOURCE@@PEAPEAX5PEAXPEBU_D3DKM_CREATESTANDARDALLOCATION@@HPEAU_D3DKMT_CREATESTANDARDALLOCATION@@@Z @ 0x1C01C19B0
 * Callers:
      ...
      if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)v33 + 152, 0LL) )
      {
        if ( bTracingEnabled )
        {
          ...
          if ( v88 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
            McTemplateK0q_EtwWriteTransfer(v36, &EventBlockThread, v37, v88);
        }
...
LABEL_74:
  ...
  DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Flags2.Reserved is not zero", 3243LL, 0LL, 0LL, 0LL, 0LL);
LABEL_222:
  v69 = -1073741811;
LABEL_82:
