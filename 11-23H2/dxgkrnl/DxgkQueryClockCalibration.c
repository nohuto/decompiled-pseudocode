/*
 * XREFs of DxgkQueryClockCalibration @ 0x1C02D4240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkQueryClockCalibration(__int64 a1)
{
  ...
  {
    WdLogSingleEntry1(2LL, 10055LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Invalid process context", 10055LL, 0LL, 0LL, 0LL, 0LL);
    return 3221225485LL;
  }
}
