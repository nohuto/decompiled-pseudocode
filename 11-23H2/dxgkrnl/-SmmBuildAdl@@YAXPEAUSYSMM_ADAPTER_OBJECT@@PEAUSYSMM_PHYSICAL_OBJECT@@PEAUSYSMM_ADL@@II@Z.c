/*
 * XREFs of ?SmmBuildAdl@@YAXPEAUSYSMM_ADAPTER_OBJECT@@PEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADL@@II@Z @ 0x1C00701B4
 * Callers:
 ...
 *     SmmBuildAdlFromAddress @ 0x1C007024C (SmmBuildAdlFromAddress.c)
 *     SmmBuildAdlFromMdl @ 0x1C0070284 (SmmBuildAdlFromMdl.c)
 */
