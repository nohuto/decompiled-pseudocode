/*
 * XREFs of _lambda_aacb25400ded284731246042636418dc_::operator() @ 0x1C016725C
 * Callers:
...
char __fastcall lambda_aacb25400ded284731246042636418dc_::operator()(__int64 **a1)
{
  __int64 *v1; // rdx
  __int64 *v3; // rax
  int v4; // r9d
  ...
  if ( *(_BYTE *)v10 )
  {
    ...
    {
      LOBYTE(v10) = tlgKeywordOn((__int64)&dword_1C013F918, 0x800000000004LL);
      if ( (_BYTE)v10 )
      {
        v11 = *a1;
        v42 = 0;
        ...
        LOBYTE(v10) = tlgWriteTransfer_EtwWriteTransfer(
                        ...
                        (unsigned __int8 *)dword_1C00A719C,
                        0LL,
                        0LL,
                        6u,
                        &v30);
