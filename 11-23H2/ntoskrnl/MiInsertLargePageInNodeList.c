/*
 * XREFs of MiInsertLargePageInNodeList @ 0x1402D6BE0
 * Callers:
 ...
 *     MiAnyPagesRemovalPending @ 0x14064EA54 (MiAnyPagesRemovalPending.c)
...
unsigned __int64 __fastcall MiInsertLargePageInNodeList(__int64 a1)
{
  ...
  *(_QWORD *)(v5 + 40) = v6 & 0x7FFFFFFFFFFFFFFFLL;
  if ( v1 != 1 && (MiFlags & 0x80u) != 0LL && (++dword_140C67F60 & MmPageValidationFrequency) == 0 )
  ...
  v12 = v2 / MiLargePageSizes[v79] % (unsigned int)dword_140C65B80[v79];
  v74 = v11 + 1072LL * v79;
  ...
  if ( (v65 & 2) == 0 )
  {
    ...
    else
    {
      ...
      if ( _interlockedbittestandset(v14, 0x1Fu) )
        v67 = ExpWaitForSpinLockExclusiveAndAcquire((int *)(v11 + 23104), 0xFFu);
  ...
  *(_QWORD *)(v18 + 8) = v5;
  ...
  v26 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v5 + 40) >> 43) & 0x3FFLL));
  if ( !*(_BYTE *)(v26 + 15782) )
    goto LABEL_49;
  if ( v16 != 2 )
  {
