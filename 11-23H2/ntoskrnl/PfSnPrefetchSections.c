...
__int64 __fastcall PfSnPrefetchSections(_QWORD *a1, WORK_QUEUE_TYPE a2, int a3, __int64 a4, __int64 a5)
{
  ...
  *(_OWORD *)&RunRef_8[0].Count = 0LL;
  v33 = 0LL;
  v34 = 0LL;
  if ( v5 && qword_140C6A708 && EtwEventEnabled(qword_140C6A708, &PfSnEvt_PrefetchSections_Start) )
  {
    v23 = -1LL;
    do
      ++v23;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v46 = 4LL;
    v48 = 1LL;
    EtwWrite(qword_140C6A708, &PfSnEvt_PrefetchSections_Start, 0LL, 7u, &UserData);
  }
...
LABEL_8:
  ...
  *(_QWORD *)&v33 = RunRef;
  ...
  else
  {
    ...
    if ( DWORD1(v34) )
    {
      v20 = MmPrefetchPagesEx(DWORD2(v33), (__int64)v29, v9 + 13);
      v8 = v27;
      v19 = v20;
      if ( v20 >= 0 && !v9[13] )
        v19 = -2147483622;
...
LABEL_23:
  ...
  LOBYTE(v24) = 0;
  LODWORD(v29) = v8;
  if ( v5 && qword_140C6A708 && EtwEventEnabled(qword_140C6A708, &PfSnEvt_PrefetchSections_Stop) )
  {
    do
      ++v7;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v50 = 8LL;
    v52 = 4LL;
    EtwWrite(qword_140C6A708, &PfSnEvt_PrefetchSections_Stop, 0LL, 9u, &UserData);
  }
  return v19;
}
