/*
 * XREFs of PopS0LowPowerIdleInfo @ 0x140984530
 * Callers:
...
__int64 __fastcall PopS0LowPowerIdleInfo(__int64 a1)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  else
  {
    ...
    *(_BYTE *)(a1 + 4) = v7;
    LOBYTE(v7) = (dword_140D1BE14 != 1 ? 0 : 2) | v7 & 0xFD;
    *(_BYTE *)(a1 + 4) = v7;
    LOBYTE(v7) = (dword_140D1BE18 != 1 ? 0 : 4) | v7 & 0xFB;
    *(_BYTE *)(a1 + 4) = v7;
    *(_BYTE *)(a1 + 4) = (dword_140D1BE20 != 1 ? 0 : 8) | v7 & 0xF7;
