...
_WORD *__fastcall XmShldOp(__int64 a1)
{
  ...
  if ( v1 )
  {
    ...
    {
      if ( v1 == 1 )
        *(_DWORD *)(a1 + 16) ^= (*(_DWORD *)(a1 + 16) ^ ((v4 ^ (v4 >> 1)) >> 19)) & 0x800;
      v5 = v4 >> (32 - v1);
      v4 = (v4 << v1) | (v3 >> (32 - v1));
      v6 = v4 >> 31;
    }
    ...
    {
      if ( v1 == 1 )
        *(_DWORD *)(a1 + 16) ^= (*(_DWORD *)(a1 + 16) ^ ((v4 ^ (v4 >> 1)) >> 3)) & 0x800;
      ...
      if ( v1 <= 0x10u )
        v2 = v3;
      v4 = (unsigned __int16)(((_WORD)v7 << v8) | (v2 >> (16 - v8)));
      v6 = v4 >> 15;
    }
