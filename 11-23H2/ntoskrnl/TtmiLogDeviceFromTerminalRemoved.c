/*
 * XREFs of TtmiLogDeviceFromTerminalRemoved @ 0x1409A7B8C
 * Callers:
 *     TtmiEvacuateDevices @ 0x1409A2E14 (TtmiEvacuateDevices.c)
 * Callees:
...
char __fastcall TtmiLogDeviceFromTerminalRemoved(int a1, int a2, __int64 a3, int a4)
{
  ...
  {
    LOBYTE(v4) = tlgKeywordOn((__int64)&dword_140D53918, 1LL);
    if ( (_BYTE)v4 )
    {
      ...
      LOBYTE(v4) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)&word_1400338DE,
                     0LL,
                     0LL,
                     7u,
                     &v16);
