...
__int64 __fastcall HvlGetPpmStatsForProcessor(struct _KPRCB *a1, _QWORD *a2, _QWORD *a3)
{
  ...
  {
    v6 = HIDWORD(xmmword_140D17978);
    StatisticsPage = a1->StatisticsPage;
    do
    {
      v8 = StatisticsPage[v6];
      *a3 = a1->StatisticsPage[(unsigned int)xmmword_140D17988];
    }
    while ( v8 != StatisticsPage[v6] );
    v9 = DWORD1(xmmword_140D17988);
  ...
  else
  {
    ...
    v14 = (unsigned int)xmmword_140D17988;
    *a2 = v12 - a1->StatisticsPage[DWORD1(xmmword_140D17978)];
