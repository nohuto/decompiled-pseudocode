/*
 * XREFs of sub_140764690 @ 0x140764690
 * Callers:
...
__int64 __fastcall sub_140764690(__int64 *a1, int a2, _DWORD *a3)
{
  void *v6; // rbp
  int v7; // ebx
  char *v8; // r15
  ...
  else
  {
    ...
    v7 = sub_140763BF4(v6, a3[2] & 0xFFFFFFF, (*a3 & 2) == 0);
    if ( v7 >= 0 )
    {
      v7 = sub_140764960((_DWORD)v6, a3[2] & 0xFFFFFFF, (*a3 & 2) == 0, (unsigned int)&Mdl, (__int64)&v13);
      if ( v7 >= 0 )
      {
        v8 = v13;
        if ( !a2
