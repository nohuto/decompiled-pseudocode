/*
 * XREFs of MiDeleteClusterPage @ 0x1402D64B0
 * Callers:
...
__int64 __fastcall MiDeleteClusterPage(ULONG_PTR BugCheckParameter2, unsigned __int8 *a2)
{
  ...
  v66 = 0LL;
  v58 = *(_QWORD *)(qword_140C673C8 + 8 * v6);
  ...
  v59 = v8;
  v9 = v2;
  v63 = ((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v59) >> 12) & 0xFFFFFFFFFFLL;
  for ( i = 0LL; i < 0x10; ++i )
  {
    v11 = *(_QWORD *)v9;
    ...
    v12 = ((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v60) >> 12) & 0xFFFFFFFFFFLL;
    if ( i )
    {
      if ( v12 != v5 )
        return 0LL;
    }
    if ( (unsigned int)MiCheckSlabPfnBitmap(48 * v12 - 0x220000000000LL, 1LL) )
      return 0LL;
    v13 = *(_QWORD *)(48 * v12 - 0x220000000000LL + 40);
    if ( v13 < 0 || *(_QWORD *)(qword_140C673C8 + 8 * (((unsigned __int64)v13 >> 43) & 0x3FF)) != v58 )
      return 0LL;
    v5 = v12 + 1;
    v9 += 8LL;
  }
  ...
  do
  {
    ...
    *((_WORD *)v27 - 4) = 2;
    ...
    if ( (v55 & 0x400) == 0 )
    {
      if ( (v55 & 4) != 0 || (v55 & 2) != 0 )
      {
        v45 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v55);
        v55 = v45;
        if ( v45 )
    ...
    *((_QWORD *)v27 - 3) = ZeroPte;
    if ( *((unsigned __int8 *)v27 - 6) >> 6 != v26 )
      MiChangePageAttribute(v24, v26, 1LL);
    v29 = *((_BYTE *)v27 - 5);
    if ( (v29 & 0x10) != 0 )
    {
