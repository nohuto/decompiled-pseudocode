...
__int64 __fastcall HalpInterruptRegisterController(__int64 a1)
{
  ...
  if ( HalpInterruptRegistrationAllowed )
  {
      ...
      && ((v6 & 0x400) == 0 || *(_QWORD *)(a1 + 176)) )
    {
      ...
      if ( (*(_DWORD *)(a1 + 236) & 0x100) != 0 && HalpIsPartitionCpuManager(v8, v7) && qword_140C624C8 )
      ...
      if ( MemoryInternal )
      {
        ...
        *(_WORD *)(v12 + 354) = Length + 2;
        ...
        v17 = (__int64 *)qword_140C63EF8;
        if ( *(ULONG_PTR **)qword_140C63EF8 != &HalpRegisteredInterruptControllers )
          __fastfail(3u);
