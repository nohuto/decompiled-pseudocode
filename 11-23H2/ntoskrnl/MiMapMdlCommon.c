...
__int64 __fastcall MiMapMdlCommon(__int64 a1, unsigned __int64 a2, __int64 a3, char a4, int a5)
{
  ...
  if ( v13 )
  {
    ...
    while ( 1 )
    {
      v20 = *(_QWORD *)(v10 + 8);
      v101 = (_QWORD *)(v10 + 8);
      if ( v20 > qword_140C65BA0 || !_bittest64((const signed __int64 *)(48 * v20 - 0x21FFFFFFFFD8LL), 0x36u) )
        break;
      v21 = 48 * v20 - 0x220000000000LL;
      if ( !*(_WORD *)(v21 + 32) && !dword_140C67E4C )
...
LABEL_10:
      ...
      if ( v13 - v17 > 1 )
      {
        ...
        if ( v42 != 1 )
        {
          do
          {
            ...
            if ( *v44 != *(v44 - 1) + 1
              || (v45 & 0x1FF) == 0
              || v45 <= qword_140C65BA0 && _bittest64((const signed __int64 *)(48 * v45 - 0x21FFFFFFFFD8LL), 0x36u) )
            {
              break;
            }
            ++v16;
    ...
    v46 = (v20 & ((1LL << ((unsigned __int8)dword_140C65AE0 - 12)) - 1)) - *(_QWORD *)(v9 + 24);
...
LABEL_95:
    ...
    do
    {
      v66 = *v65;
      v67 = 0;
      if ( *v65 <= qword_140C65BA0 && _bittest64((const signed __int64 *)(48 * v66 - 0x21FFFFFFFFD8LL), 0x36u) )
      {
...
LABEL_147:
  ...
  v79 = ExAcquireSpinLockExclusive(&dword_140C684C0);
  *v49 = qword_140C684D0;
  qword_140C684D0 = v48;
