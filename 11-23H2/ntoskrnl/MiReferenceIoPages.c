...
__int64 __fastcall MiReferenceIoPages(int a1, __int64 a2, unsigned __int64 a3, int a4, _DWORD *a5, __int64 *a6)
{
  ...
  P = 0LL;
  v77 = 3;
  v12 = ((1LL << ((unsigned __int8)dword_140C65AE0 - 12)) - 1) & a2;
  v88 = -1LL;
  v80 = 0LL;
  v89 = 8 * v9;
...
LABEL_53:
  ...
  if ( !P )
  {
    ...
    *((_DWORD *)PoolMm + 8) = 1;
    do
    {
      v37 = v35++ & ((1LL << ((unsigned __int8)dword_140C65AE0 - 12)) - 1);
      v38 = 2 * (v37 - v34[6]);
...
LABEL_38:
    ...
    if ( v74 )
    {
      ...
      if ( (unsigned int)MiIsPageInIoHugeRangeTransition(*(_QWORD *)(i + 24), v21) )
        _InterlockedDecrement64(&qword_140C695A0);
      v74 = 0;
    }
  ...
  while ( 2 )
  {
    ...
    v24 = (v12 & ((1LL << ((unsigned __int8)dword_140C65AE0 - 12)) - 1)) - *(_QWORD *)(i + 24);
...
LABEL_134:
          ...
          LOBYTE(v26) = a4;
          v28 = 2 * ((v12 & ((1 << (dword_140C65AE0 - 12)) - 1)) - *(_DWORD *)(i + 24));
