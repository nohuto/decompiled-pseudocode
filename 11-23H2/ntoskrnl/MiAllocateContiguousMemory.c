/*
 * XREFs of MiAllocateContiguousMemory @ 0x1403B9EB4
 * Callers:
...
LABEL_9:
  v25 = (_DWORD *)(qword_140C65A98 + 4LL * v24 * (unsigned __int16)KeNumberNodes);
...
LABEL_22:
  ...
  v30 = v20;
  v31 = v19;
  v32 = (_DWORD *)(qword_140C65A98 + 4LL * v24 * (unsigned __int16)KeNumberNodes);
  ...
  do
  {
    ...
    *(_QWORD *)(v35 + 8) = v36;
    ...
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && CurrentIrql <= 0xFu && v38 <= 0xFu && CurrentIrql >= 2u )
      {
...
LABEL_38:
  if ( !v39 && v56 == (unsigned __int16 *)&MiSystemPartition )
    _InterlockedExchangeAdd64(&qword_140C699B8, v16);
  v40 = a1;
  *a1 = v28;
  v11 = a3;
LABEL_42:
