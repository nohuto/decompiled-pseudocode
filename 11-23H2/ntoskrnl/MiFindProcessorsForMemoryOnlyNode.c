/*
 * XREFs of MiFindProcessorsForMemoryOnlyNode @ 0x140B9A10C
 * Callers:
...
__int64 __fastcall MiFindProcessorsForMemoryOnlyNode(unsigned int a1, unsigned int a2)
{
  ...
  v2 = *(_DWORD **)(376LL * a1 + qword_140C65AA0 + 368);
  v3 = qword_140C65A98 + 4LL * (unsigned __int16)KeNumberNodes * a1;
  ...
  if ( (unsigned __int64)v5 < v4 )
  {
    ...
    while ( 2 )
    {
      ...
      v8 = *v5;
      v37 = v6;
      v9 = *(_QWORD *)(376LL * *v5 + qword_140C65AA0 + 368);
      v10 = v6;
      v30 = v6;
      v11 = (_WORD *)(v9 + 16);
      do
