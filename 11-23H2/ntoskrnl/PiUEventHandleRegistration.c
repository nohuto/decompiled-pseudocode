/*
 * XREFs of PiUEventHandleRegistration @ 0x14077F69C
 * Callers:
 ...
 *     PiUEventHashGuidIntoBucket @ 0x14031CF10 (PiUEventHashGuidIntoBucket.c)
...
LABEL_51:
  ...
  if ( (int)PiUEventGetDeviceInstanceIdFromUserHandle(*v13, &v34, v35) < 0 )
    goto LABEL_51;
  v10 = PiDmGetObject(1LL, *(_QWORD *)(v34 + 8), (_QWORD *)(inited + 24));
  if ( v10 < 0 )
    goto LABEL_52;
