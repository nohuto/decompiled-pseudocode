/*
 * XREFs of HvlPhase2Initialize @ 0x1403B4CA0
 * Callers:
 ...
 *     HvlpRegisterPowerPolicyCallbacks @ 0x1405471F4 (HvlpRegisterPowerPolicyCallbacks.c)
...
LABEL_21:
      ...
      qword_140C5F450 = IoCreateNotificationEvent(&EventName, &EventHandle);
      if ( *(_DWORD *)(*(_QWORD *)(v5 + 240) + 2552LL) )
      {
        byte_140C5F448 = 1;
        qword_140C5F460 = (PVOID)ExAllocatePool2(
                                   256LL,
        ...
        *(_DWORD *)qword_140C5F460 = v41;
        memmove((char *)qword_140C5F460 + 8, *(const void **)(*(_QWORD *)(v5 + 240) + 2544LL), 8LL * v41);
        KeResetEvent(qword_140C5F450);
      }
      return 0;
    }
  }
