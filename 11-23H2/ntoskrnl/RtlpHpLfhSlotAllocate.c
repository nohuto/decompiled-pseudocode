/*
 * XREFs of RtlpHpLfhSlotAllocate @ 0x1402ADCC0
 * Callers:
 ...
 *     RtlpLfhBlockBitmapAllocate @ 0x1402AED60 (RtlpLfhBlockBitmapAllocate.c)
      ...
      while ( 1 )
      {
        ...
        if ( (v14 & 0xFFF) != 0 )
        {
          ...
          if ( v16 )
          {
            ...
            v20 = qword_140C6B2C8 ^ *(_DWORD *)(v16 + 40) ^ ((unsigned int)v16 >> 12);
            ...
            *(_WORD *)(v16 + 36) = v28;
            ...
            v34 = (unsigned __int16)qword_140C6B2C8 ^ *(unsigned __int16 *)(v16 + 40) ^ (unsigned __int16)v202;
            v208 = 0;
            v206 = v34;
            v195 = -1;
...
LABEL_25:
              ...
              if ( (unsigned int)v6 < v21 )
              {
                ...
                if ( v156 == 1 )
                  ...
                  v157 = v156 & 0x3FFF;
                *(_WORD *)(((unsigned __int16)qword_140C6B2C8 ^ *(unsigned __int16 *)(v16 + 40) ^ (unsigned __int64)(unsigned __int16)v202)
                         + v46
                         - 2) = v157;
              }
              v47 = v205;
...
LABEL_20:
              ...
              if ( v32 )
              {
                if ( *(_BYTE *)v205 )
                {
                  ...
                  if ( KiIrqlFlags )
                  {
                    ...
                    if ( (KiIrqlFlags & 1) != 0 && v116 <= 0xFu && v192 <= 0xFu && v116 >= 2u )
                    {
            ...
            if ( *(_BYTE *)v205 )
            {
              ...
              if ( KiIrqlFlags )
              {
                ...
                if ( (KiIrqlFlags & 1) != 0 && v166 <= 0xFu && v192 <= 0xFu && v166 >= 2u )
                {
...
LABEL_270:
            ...
            if ( KiIrqlFlags )
            {
              ...
              if ( (KiIrqlFlags & 1) != 0 && v176 <= 0xFu && v189 <= 0xFu && v176 >= 2u )
              {
...
LABEL_62:
    ...
    if ( v198 )
    {
      ...
      v67 = (unsigned __int16)(*(_WORD *)(v198 + 40) ^ qword_140C6B2C8 ^ ((unsigned int)v198 >> 12));
      v68 = (*(_DWORD *)(v198 + 40) ^ (unsigned int)qword_140C6B2C8 ^ ((unsigned int)v198 >> 12)) >> 16;
      v69 = (*(_DWORD *)(v198 + 40) ^ (unsigned int)qword_140C6B2C8 ^ ((unsigned int)v198 >> 12)) >> 16;
      v70 = v69;
      v71 = 3LL;
      v194 = v67;
      ...
      *(_WORD *)(v198 + 36) = v74;
      ...
      v196[0] = -1;
      v190 = -1;
      LODWORD(SpinLock) = (unsigned __int16)*v207 ^ (unsigned __int16)v202 ^ (unsigned __int16)qword_140C6B2C8;
      v81 = 2 * v75;
...
LABEL_77:
      ...
      if ( v86 == -1 )
      {
        ...
        if ( *(_BYTE *)v205 )
        {
          ...
          if ( KiIrqlFlags && (v153 = KeGetCurrentIrql(), (KiIrqlFlags & 1) != 0) && v153 <= 0xFu )
          {
            v138 = v190;
...
LABEL_82:
        ...
        if ( (unsigned int)v6 < v76 )
        {
          ...
          if ( v89 == 1 )
            ...
            v90 = v89 & 0x3FFF;
          *(_WORD *)(((unsigned __int16)*v207 ^ (unsigned __int16)v202 ^ (unsigned __int64)(unsigned __int16)qword_140C6B2C8)
                   + v46
                   - 2) = v90;
        }
LABEL_92:
      ...
      else
      {
        ...
        if ( *(_BYTE *)v205 )
        {
          ...
          if ( KiIrqlFlags )
          {
            ...
            if ( (KiIrqlFlags & 1) != 0 && v185 <= 0xFu && v190 <= 0xFu && v185 >= 2u )
            {
