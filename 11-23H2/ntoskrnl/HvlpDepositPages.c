/*
 * XREFs of HvlpDepositPages @ 0x140541254
 * Callers:
...
__int64 __fastcall HvlpDepositPages(unsigned __int16 a1, __int64 a2, char a3, char a4)
{
  ...
  while ( 1 )
  {
    ...
    PartitionNodePagesForMdl = MmAllocatePartitionNodePagesForMdlEx(0, -1, v8, v11 << 12, 1, v9, v7, 0LL);
    v13 = (char *)PartitionNodePagesForMdl;
    if ( PartitionNodePagesForMdl )
    {
      v15 = (*(_DWORD *)(PartitionNodePagesForMdl + 40) >> 12)
