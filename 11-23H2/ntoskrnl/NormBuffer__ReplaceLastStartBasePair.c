/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x1405B0A20
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x1409C0A20 (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
