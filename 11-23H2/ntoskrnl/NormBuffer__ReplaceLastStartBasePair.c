/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x1405B0F90
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x1409C0C20 (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
