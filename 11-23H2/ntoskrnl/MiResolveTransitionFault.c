  ...
  *v79 = 0LL;
  ...
  if ( !v4 )
  {
    while ( 1 )
    {
      ...
      if ( (v47 & 0x800) == 0 )
        return 3221226548LL;
      if ( (v47 & 1) == 0 && (!v47 || !qword_140C65B40 || (qword_140C65B40 & v47) != 0) )
      {
        if ( qword_140C65B40 )
        {
          if ( (v47 & 0x10) != 0 )
        ...
        if ( v49 <= qword_140C65BA0 )
        {
          if ( _bittest64((const signed __int64 *)(48 * v49 - 0x21FFFFFFFFD8LL), 0x36u) )
          {
            ...
            {
              if ( (*(_DWORD *)(*(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v12 + 40) >> 43) & 0x3FFLL)) + 4LL) & 0x80u) != 0 )
              {
...
LABEL_10:
      ...
      if ( a2 >= 0xFFFFF6FB40000000uLL && a2 <= 0xFFFFF6FB7FFFFFFFuLL )
      {
        ...
        if ( (unsigned int)MiUserPdeOrAbove(a2, qword_140C65B40, v17) )
          v21 |= 4uLL;
      }
...
LABEL_24:
      ...
      v24 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v12 + 40) >> 43) & 0x3FFLL));
      v25 = *(_QWORD *)(v12 + 16);
      v73 = v24;
...
LABEL_210:
          ...
          v41 = *(_QWORD *)(qword_140C673C8 + 8 * (((unsigned __int64)v34 >> 43) & 0x3FF));
          ...
          {
            MiReturnCommit(*(_QWORD *)(qword_140C673C8 + 8 * (((unsigned __int64)v34 >> 43) & 0x3FF)), 1LL);
          }
          v42 = 1LL;
