/*
 * XREFs of ?SmPageWrite@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAT_SM_PAGE_KEY@@T_SM_PAGE_ADD_PARAM@@PEAU_MDL@@PEAXPEAU_IO_STATUS_BLOCK@@K@Z @ 0x14046561C
 * Callers:
        ...
        int a7)
{
  ...
  *((_QWORD *)&a6->Next + 1) = 0LL;
  ...
  if ( (_DWORD)v10 != 1024 )
  {
    v15 = SmKmStoreReferenceEx(a1, v10, a3);
    v16 = (_DWORD *)v15;
    if ( v15 )
    {
      LODWORD(a6) = 0;
      v17 = (unsigned __int16)v12 >> 13;
      ...
      if ( (v12 & 0x40000) != 0 && (unsigned int)(v17 - 5) <= 1 )
      {
        LODWORD(v17) = 6;
      }
