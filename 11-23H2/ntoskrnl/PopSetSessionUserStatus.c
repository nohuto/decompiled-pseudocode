/*
 * XREFs of PopSetSessionUserStatus @ 0x1407A5DBC
 * Callers:
 ...
 *     PopAdaptiveGetRemoteSessionState @ 0x140860A10 (PopAdaptiveGetRemoteSessionState.c)
 * Callees:
 *     PopPrintEx @ 0x14032A6AC (PopPrintEx.c)
 *     PopSetPowerSettingValue @ 0x1407829F8 (PopSetPowerSettingValue.c)
 *     PopPrintUserActivityPresence @ 0x1407A5EB0 (PopPrintUserActivityPresence.c)
