...
LABEL_14:
  ...
  if ( v24 <= (((*((unsigned int *)v21 + 7) | ((unsigned __int64)*((unsigned __int8 *)v21 + 33) << 32)) << 12) | 0xFFF)
    && (!a8
     || (v39 = 0LL, (v21[6] & 0x200000) == 0)
     && *(_QWORD *)v21[9] == MiSectionControlArea(a8)
     && (v30 = *(unsigned int *)(v23 + 24), (v30 | ((unsigned __int64)*(unsigned __int8 *)(v23 + 32) << 32)) << 12 == a2)
     && (MiGetProtoPteAddress(v23, v30 | ((unsigned __int64)*(unsigned __int8 *)(v23 + 32) << 32), 0, (__int64 *)&v39),
