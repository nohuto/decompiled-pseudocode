/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x14032A7B0
 * Callers:
 *     PopPrintEx @ 0x14032A6AC (PopPrintEx.c)
 *     DbgPrint @ 0x14032A6F0 (DbgPrint.c)
 *     DbgPrintEx @ 0x14032A740 (DbgPrintEx.c)
 *     vDbgPrintEx @ 0x14032A780 (vDbgPrintEx.c)
 *     vDbgPrintExWithPrefix @ 0x140463BA0 (vDbgPrintExWithPrefix.c)
 *     IopDebugPrint @ 0x14056103C (IopDebugPrint.c)
 *     KsepDebugPrint @ 0x140580CD4 (KsepDebugPrint.c)
 *     DbgPrintReturnControlC @ 0x1405A7720 (DbgPrintReturnControlC.c)
 ...
 *     DebugPrint @ 0x140428E40 (DebugPrint.c)
