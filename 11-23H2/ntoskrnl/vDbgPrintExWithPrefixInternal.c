/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x14032AA40
 * Callers:
 *     PopPrintEx @ 0x14032A93C (PopPrintEx.c)
 *     DbgPrint @ 0x14032A980 (DbgPrint.c)
 *     DbgPrintEx @ 0x14032A9D0 (DbgPrintEx.c)
 *     vDbgPrintEx @ 0x14032AA10 (vDbgPrintEx.c)
 *     vDbgPrintExWithPrefix @ 0x140463FA0 (vDbgPrintExWithPrefix.c)
 *     IopDebugPrint @ 0x1405616FC (IopDebugPrint.c)
 *     KsepDebugPrint @ 0x1405811C4 (KsepDebugPrint.c)
 *     DbgPrintReturnControlC @ 0x1405A7C90 (DbgPrintReturnControlC.c)
 ...
 *     DebugPrint @ 0x1404291D0 (DebugPrint.c)
