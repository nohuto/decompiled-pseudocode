/*
 * XREFs of MiDereferenceIoPages @ 0x140336384
 * Callers:
...
__int64 __fastcall MiDereferenceIoPages(int a1, __int64 a2, ULONG_PTR a3)
{
  ...
  v41 = a1;
  v48 = 1;
  v5 = ((1LL << ((unsigned __int8)dword_140C65AE0 - 12)) - 1) & a2;
  v6 = a3;
  v39 = 0;
  ...
  if ( a3 )
  {
    do
    {
      ...
      while ( 1 )
      {
        ...
        v19 = *(_QWORD *)(v3 + 24);
        v20 = (BugCheckParameter4 & ((1LL << ((unsigned __int8)dword_140C65AE0 - 12)) - 1)) - v19;
            ...
            if ( !v23 )
            {
              ...
              *(_DWORD *)(v3 + 32) = v25 - 1;
              if ( v25 == 1 )
              {
                ...
                {
                  _InterlockedAdd64(&qword_140C695A0, 1uLL);
                  v42 = 1LL;
                }
                v27 = v39;
                if ( v26 >= v42 )
...
LABEL_34:
  ...
  if ( v39 )
  {
    ExAcquireSpinLockExclusive(&dword_140C695E0);
    if ( !stru_140C695F8.Parameter )
    {
      stru_140C695F8.List.Flink = 0LL;
      stru_140C695F8.WorkerRoutine = (void (__fastcall *)(void *))MiDeleteStaleCacheMaps;
      stru_140C695F8.Parameter = &stru_140C695F8;
      ExQueueWorkItem(&stru_140C695F8, DelayedWorkQueue);
    }
