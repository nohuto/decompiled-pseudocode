/*
 * XREFs of HalpMap @ 0x14037E228
 * Callers:
 *     HalpAcpiCheckAndMapTable @ 0x1403357EC (HalpAcpiCheckAndMapTable.c)
 *     HalpAcpiGetRsdt @ 0x140336DC8 (HalpAcpiGetRsdt.c)
 *     HalpPciMapMmConfigPhysicalAddress @ 0x14033F6B8 (HalpPciMapMmConfigPhysicalAddress.c)
 ...
 *     HalpMapPhysicalMemoryWriteThrough64 @ 0x14037F830 (HalpMapPhysicalMemoryWriteThrough64.c)
 *     HalpMapPhysicalMemory64 @ 0x14040F750 (HalpMapPhysicalMemory64.c)
 *     HalpAllocateEarlyPages @ 0x140505550 (HalpAllocateEarlyPages.c)
 *     HalpMapEarlyPages @ 0x140505630 (HalpMapEarlyPages.c)
 ...
 *     HalpIsHeap64KRegionExecutable @ 0x1405055C0 (HalpIsHeap64KRegionExecutable.c)
 */
