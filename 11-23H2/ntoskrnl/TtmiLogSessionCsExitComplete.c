/*
 * XREFs of TtmiLogSessionCsExitComplete @ 0x1409A9224
 * Callers:
...
void TtmiLogSessionCsExitComplete()
{
  ...
  if ( (unsigned int)dword_140D53918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53918, 1LL) )
    {
      ...
      v1 = v0;
      v4 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53918, (unsigned __int8 *)word_140033182, 0LL, 0LL, 3u, &v2);
    }
  }
}
