/*
 * XREFs of AuthzBasepCompareFQBNOperands @ 0x14066F260
 * Callers:
 ...
 *     AuthzBasepGetConstantOperand @ 0x140355770 (AuthzBasepGetConstantOperand.c)
 *     AuthzBasepCompareUnsigned @ 0x14066F750 (AuthzBasepCompareUnsigned.c)
