        ...
        char a9)
{
  ...
  if ( !DWORD1(xmmword_140C64CD8) || byte_140C64CD4 )
  {
    v49 = a4;
    v50 = a5;
    v47 = v11;
...
LABEL_16:
    ...
    ((void (__fastcall *)(__int64, _QWORD, _QWORD))qword_140C6AC70)(1LL, 0LL, v13);
    ...
    LOBYTE(v18) = 1;
    ViVerifyDma = 0;
    v21 = ((__int64 (__fastcall *)(__int64))qword_140C6ACA0)(v18);
...
LABEL_57:
            if ( v14 >= 0 )
              v14 = ((__int64 (__fastcall *)(__int64, __int64))qword_140C6AC78)(CrashdmpDumpBlock, a8);
            if ( v14 != -1073741267 )
              goto LABEL_67;
            if ( (*(_DWORD *)(CrashdmpDumpBlock + 1368) & 4) != 0 )
            {
              ...
              *(_DWORD *)(CrashdmpDumpBlock + 1368) |= 8u;
              ...
              if ( v14 < 0 )
                goto LABEL_67;
              v38 = ((__int64 (__fastcall *)(__int64, __int64))qword_140C6AC78)(CrashdmpDumpBlock, a8);
              v39 = 38;
            }
            else
            {
