/*
 * XREFs of PspInitializeSiloStructures @ 0x140B49810
 * Callers:
 ...
 *     PspSiloInitializeSharedUserSessionId @ 0x1407EB290 (PspSiloInitializeSharedUserSessionId.c)
...
LABEL_13:
  ...
  qword_140C38148 = (__int64)&PspSiloMonitorList;
