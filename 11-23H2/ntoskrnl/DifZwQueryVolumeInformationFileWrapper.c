/*
 * XREFs of DifZwQueryVolumeInformationFileWrapper @ 0x1405F6140
 * Callers:
 *     <none>
 * Callees:
        ...
        FS_INFORMATION_CLASS FsInformationClass)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(613);
...
LABEL_17:
  result = ZwQueryVolumeInformationFile(FileHandle, IoStatusBlock, FsInformation, Length, FsInformationClass);
  DWORD2(v23) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
