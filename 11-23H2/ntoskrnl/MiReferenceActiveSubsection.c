/*
 * XREFs of MiReferenceActiveSubsection @ 0x140289030
 * Callers:
    ...
    if ( v12 > 1 )
    {
      ...
      if ( v12 == 2 && (a2 & 0x20) != 0 && v41 )
      {
        ...
        MiReturnCrossPartitionSectionCharges(
          *(_QWORD *)(qword_140C673C8 + 8LL * (*(_WORD *)(v3 + 60) & 0x3FF)),
          v42,
          v41);
        if ( !v5 )
      ...
      else if ( v5 )
      {
        ...
        if ( (_DWORD)KiIrqlFlags )
        {
          ...
          if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v33 <= 0xFu && v6 <= 0xFu && v33 >= 2u )
          {
...
LABEL_17:
    if ( (a2 & 0x20) != 0 )
    {
      ...
      if ( (_DWORD)KiIrqlFlags )
      {
        ...
        if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v37 <= 0xFu && v6 <= 0xFu && v37 >= 2u )
        {
      ...
      __writecr8(v6);
      MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140C673C8 + 8LL * (*(_WORD *)(v3 + 60) & 0x3FF)), v9, v4);
      if ( !v5 )
        ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(v3 + 72));
      return 3221225773LL;
    }
    ...
    if ( v41 )
    {
      ...
      if ( (_DWORD)KiIrqlFlags )
      {
        ...
        if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v14 <= 0xFu && v6 <= 0xFu && v14 >= 2u )
        {
...
LABEL_32:
            ...
            if ( (_DWORD)KiIrqlFlags )
            {
              ...
              if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v21 <= 0xFu && v6 <= 0xFu && v21 >= 2u )
              {
  ...
  if ( v5 )
  {
    ...
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v25 <= 0xFu && v6 <= 0xFu && v25 >= 2u )
      {
