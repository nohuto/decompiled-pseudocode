  ...
  *a3 = 0;
  ...
  if ( (__int64 *)VfSuspectDriversList != &VfSuspectDriversList )
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)(v6 + 40) = dword_140C13924;
      *(_DWORD *)(v6 + 44) = dword_140C13928;
      *(_DWORD *)(v6 + 92) = dword_140C1395C;
      *(_DWORD *)(v6 + 48) = dword_140C1392C;
      *(_DWORD *)(v6 + 52) = dword_140C13930;
      *(_DWORD *)(v6 + 56) = dword_140C13934;
      *(_DWORD *)(v6 + 60) = dword_140C13938;
      *(_DWORD *)(v6 + 64) = dword_140C1393C;
      *(_DWORD *)(v6 + 68) = dword_140C13940;
      *(_DWORD *)(v6 + 72) = dword_140C13944;
      *(_DWORD *)(v6 + 76) = dword_140C13948;
      *(_DWORD *)(v6 + 80) = dword_140C1394C;
