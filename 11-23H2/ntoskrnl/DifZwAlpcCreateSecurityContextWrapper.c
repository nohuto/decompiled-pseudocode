/*
 * XREFs of DifZwAlpcCreateSecurityContextWrapper @ 0x1405EDAF0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwAlpcCreateSecurityContextWrapper(
        HANDLE PortHandle,
        ULONG Flags,
        PALPC_SECURITY_ATTR SecurityAttribute)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(502);
