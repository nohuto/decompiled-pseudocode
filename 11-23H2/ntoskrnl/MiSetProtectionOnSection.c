/*
 * XREFs of MiSetProtectionOnSection @ 0x140277C80
 * Callers:
 ...
 *     MiPteNeedsCommitCharge @ 0x140346140 (MiPteNeedsCommitCharge.c)
 ...
 *     MiGetImageHotPatchTableAddress @ 0x140A37260 (MiGetImageHotPatchTableAddress.c)
 */
