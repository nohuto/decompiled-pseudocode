/*
 * XREFs of ?BTreeMergeNodes@?$B_TREE@KU_ST_HASH_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_HASH_ENTRY_COMPARATOR@2@@@SAXPEAU1@PEAUSEARCH_RESULT@1@PEAUNODE@?$B_TREE_HEADER@KU_ST_HASH_ENTRY@?$ST_STORE@USM_TRAITS@@@@@@@Z @ 0x1405BC32C
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  if ( *(_BYTE *)(v9 + 3) )
  {
    ...
    v12 = (void *)(v9 + 16 + 4 * v11);
    v13 = 4LL * (unsigned __int16)*(_DWORD *)v5;
  }
  else
  {
