...
LABEL_19:
    memset(&qword_140D18CB0, 0, 0x30uLL);
    return v4;
  }
  if ( *(_DWORD *)v2 != 256 )
    goto LABEL_6;
  ...
  if ( !v6 )
    goto LABEL_4;
  qword_140D18CB0 = v6;
  dword_140D18CC0 = *(_DWORD *)(v6 + 48);
  qword_140D18CB8 = (*(_QWORD *)(v6 + 8) - (unsigned __int64)*(unsigned int *)(v6 + 4)) >> 3;
  if ( qword_140D18CB8 < (unsigned __int64)(unsigned int)dword_140D18CC0 )
  {
LABEL_6:
    v4 = -1073741637;
LABEL_13:
    HalpMcaExtendedLoggingSupported = 0;
    if ( qword_140D18CD0 )
      MmUnmapIoSpace(qword_140D18CD0, *(_QWORD *)(v3 + 24));
    MmUnmapIoSpace((PVOID)v3, v0);
    goto LABEL_19;
  }
  qword_140D18CD0 = (PVOID)MmMapIoSpaceEx(*(_QWORD *)(v6 + 16), *(_QWORD *)(v6 + 24), 0x204u);
  if ( !qword_140D18CD0 )
  {
    v4 = -1073741670;
    goto LABEL_13;
  }
  qword_140D18CC8 = *(_QWORD *)(v3 + 16);
  qword_140D18CD8 = *(_QWORD *)(v3 + 24);
  *(_DWORD *)(v3 + 32) |= 1u;
  return 0;
}
