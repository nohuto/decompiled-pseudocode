/*
 * XREFs of CcGetDirtyPagesHelper @ 0x140338AD0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CcGetDirtyPagesHelper(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  unsigned __int64 v34; // [rsp+90h] [rbp-78h]
  void (__fastcall *v35)(unsigned __int64, __int64 *, __int64, __int64 *, __int64 *, __int64, __int64); // [rsp+98h] [rbp-70h]
  ...
  v4 = *a3;
  v40 = *a3;
  v35 = (void (__fastcall *)(unsigned __int64, __int64 *, __int64, __int64 *, __int64 *, __int64, __int64))a3[1];
  ...
  while ( 1 )
  {
    ...
    if ( (v8 & 0x2000000) != 0 && *(_QWORD *)(v6 + 248) == v4 || (v8 & 0x1000000) != 0 && **(_QWORD **)(v6 + 248) == v4 )
    {
      ...
      ExReleaseFastMutex((PFAST_MUTEX)(v6 + 288));
      ObFastDereferenceObjectDeferDelete((signed __int64 *)(v6 + 96), v10, 0x63536343u);
      if ( P )
      {
        CcUnpinFileDataEx(P, 1, 1);
        P = 0LL;
