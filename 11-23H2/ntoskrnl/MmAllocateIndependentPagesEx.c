/*
 * XREFs of MmAllocateIndependentPagesEx @ 0x14086C47C
 * Callers:
...
__int64 __fastcall MmAllocateIndependentPagesEx(unsigned __int64 a1, int a2, _QWORD *a3, unsigned int a4)
{
  ...
  v30 = 0LL;
  v27 = 0LL;
  v7 = MiReservePtes((__int64)&qword_140C69940, v6);
  if ( !v7 )
    return 0LL;
  if ( !(unsigned int)MiObtainPoolCharges(v6, 1) )
  {
    MiReleasePtes((__int64)&qword_140C69940, (__int64 *)v7, v6);
    return 0LL;
  }
  v31 = a3 && (dword_140C6B444 & 8) != 0 && ((MiFlags & 0x100000000LL) == 0 || (MiFlags & 0x200000000LL) != 0);
