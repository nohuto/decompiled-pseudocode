 ...
 *     IvtInitializeMTRR @ 0x1403AC158 (IvtInitializeMTRR.c)
 *     IvtFlushTbInternal @ 0x1403B0E40 (IvtFlushTbInternal.c)
 *     IvtBuildContextEntry @ 0x1403B5B6C (IvtBuildContextEntry.c)
 *     IvtInvalidateAllContextEntries @ 0x1403B5D50 (IvtInvalidateAllContextEntries.c)
 *     IvtGetContextEntryType @ 0x1403B6974 (IvtGetContextEntryType.c)
 ...
 *     IvtGetIdentityMappedDomain @ 0x14052CA8C (IvtGetIdentityMappedDomain.c)
 ...
 *     IvtSetScalableModeContextEntry @ 0x14052D890 (IvtSetScalableModeContextEntry.c)
