/*
 * XREFs of IovpCallDriver1 @ 0x140ACC190
 * Callers:
 ...
 *     VfPendingStartLogging @ 0x140AD1BB8 (VfPendingStartLogging.c)
 ...
 *     IovpSessionDataReference @ 0x140ADE03C (IovpSessionDataReference.c)
