...
__int64 __fastcall MiFinishCreateSection(int *a1)
{
  ...
  *((_QWORD *)a1 + 15) = v1;
  ...
  v19 = MEMORY[0x30];
  if ( MEMORY[0x30] > (unsigned __int64)qword_140C65568 )
  {
  ...
  v21 = KeAbPreAcquire((__int64)&qword_140C65550, 0LL);
  v22 = v21;
  if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65550, 0LL) )
    ExfAcquirePushLockExclusiveEx(&qword_140C65550, v21, (__int64)&qword_140C65550);
  if ( v22 )
    *(_BYTE *)(v22 + 18) = 1;
  EmptyAddressRangeDownTree = MiFindEmptyAddressRangeDownTree(
                                (unsigned int)&qword_140C65548,
                                v19,
                                0x10000,
                                0,
                                0x10000LL,
...
LABEL_69:
  ...
  v24 = 1;
LABEL_61:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C65548, v25, v24, 0LL);
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C65550, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
    ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C65550);
  KeAbPostRelease((ULONG_PTR)&qword_140C65550);
  v5 = CurrentThread->SpecialApcDisable++ == -1;
