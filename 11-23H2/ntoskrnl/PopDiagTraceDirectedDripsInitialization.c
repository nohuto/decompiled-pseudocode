/*
 * XREFs of PopDiagTraceDirectedDripsInitialization @ 0x140859A58
 * Callers:
...
void __fastcall PopDiagTraceDirectedDripsInitialization(int a1)
{
    ...
    && tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL) )
  {
    ...
    v3 = v1;
    v11 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03950, (unsigned __int8 *)&dword_14002E60C, 0LL, 0LL, 3u, &v9);
  }
