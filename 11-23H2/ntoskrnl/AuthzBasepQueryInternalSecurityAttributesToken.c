/*
 * XREFs of AuthzBasepQueryInternalSecurityAttributesToken @ 0x1407F436C
 * Callers:
 ...
 * Callees:
 *     AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize @ 0x1407F43F8 (AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize.c)
