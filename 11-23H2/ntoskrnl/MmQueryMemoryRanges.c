/*
 * XREFs of MmQueryMemoryRanges @ 0x14085D7C0
 * Callers:
...
LABEL_10:
  ...
  if ( qword_140C67DF0 )
  {
    while ( 1 )
    {
      SetBits = RtlFindSetBitsEx(&stru_140C67DE0, 1uLL, (ULONG64)v3);
      v13 = SetBits;
...
LABEL_25:
      ...
      NextForwardRunClear = RtlFindNextForwardRunClearEx(&stru_140C67DE0.SizeOfBitMap, SetBits, &v21);
      SizeOfBitMap = v21;
      v19 = NextForwardRunClear;
      if ( !NextForwardRunClear )
        SizeOfBitMap = stru_140C67DE0.SizeOfBitMap;
      ...
      if ( (unsigned __int64)v3 >= stru_140C67DE0.SizeOfBitMap )
        goto LABEL_25;
    }
    v3 = P;
    if ( P )
