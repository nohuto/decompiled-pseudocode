/*
 * XREFs of MmQueryMemoryRanges @ 0x14085D580
 * Callers:
...
LABEL_10:
  ...
  if ( qword_140C67DF0 )
  {
    while ( 1 )
    {
      SetBits = RtlFindSetBitsEx((unsigned __int64 *)&qword_140C67DE0, 1uLL, (unsigned __int64)v3);
      v13 = SetBits;
...
LABEL_25:
      ...
      NextForwardRunClear = RtlFindNextForwardRunClearEx(
                              (unsigned __int64 *)&qword_140C67DE0,
                              SetBits,
      ...
      if ( (unsigned __int64)v3 >= qword_140C67DE0 )
        goto LABEL_25;
    }
    v3 = P;
    if ( P )
