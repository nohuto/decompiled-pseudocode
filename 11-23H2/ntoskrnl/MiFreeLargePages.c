/*
 * XREFs of MiFreeLargePages @ 0x1406687A0
 * Callers:
...
__int64 __fastcall MiFreeLargePages(__int64 a1, __int64 a2, _QWORD *a3, _QWORD *a4, char a5)
{
  ...
  v39 = *(_QWORD *)(qword_140C673C8 + 8LL * Process[1].IdealProcessor[25]);
  v32 = *(unsigned __int8 *)(a2 + 34) >> 6;
  v31 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(a2 + 40) >> 43) & 0x3FFLL));
...
LABEL_2:
  ...
  v35 = v12;
  v37 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(a2 + 40) >> 43) & 0x3FFLL));
