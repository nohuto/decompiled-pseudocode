/*
 * XREFs of MiDeleteNonPagedPoolPte @ 0x1402126F0
 * Callers:
    ...
    if ( (v3 & 0x80u) == 0LL )
    {
      ...
      if ( a3 == 1 )
      {
        if ( (*(_QWORD *)(v11 + 24) & 0x3FFFFFFFFFFFFFFFLL) != 1
          || !(unsigned int)MiEvictPageTableLock(&unk_140C6A040, a2, ZeroPte, 2LL) )
        {
          return 0LL;
        }
        v13 = (_DWORD *)(v10 + 204);
...
LABEL_24:
        v20 = v28;
        if ( qword_140C65B40 && (v28 & 0x10) == 0 )
          v20 = v28 & ~qword_140C65B40;
      ...
      if ( v7 )
      {
        ...
        {
          if ( !HIBYTE(word_140C66CFC) && (v14 & 1) != 0 )
            v14 |= v12;
          *a2 = v14;
