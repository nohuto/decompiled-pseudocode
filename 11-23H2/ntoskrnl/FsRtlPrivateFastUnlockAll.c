/*
 * XREFs of FsRtlPrivateFastUnlockAll @ 0x140326A34
 * Callers:
 *     FsRtlFastUnlockAll @ 0x140326A10 (FsRtlFastUnlockAll.c)
 *     FsRtlFastUnlockAllByKey @ 0x14053D3B0 (FsRtlFastUnlockAllByKey.c)
