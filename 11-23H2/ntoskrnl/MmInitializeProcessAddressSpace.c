 ...
 *     MiInitializeProcessPageTableCommitmentBitMaps @ 0x1402233C0 (MiInitializeProcessPageTableCommitmentBitMaps.c)
 ...
 *     MiAllocateProcessVads @ 0x1407CFB30 (MiAllocateProcessVads.c)
