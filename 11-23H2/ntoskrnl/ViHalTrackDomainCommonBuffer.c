/*
 * XREFs of ViHalTrackDomainCommonBuffer @ 0x140AC9418
 * Callers:
...
__int64 __fastcall ViHalTrackDomainCommonBuffer(__int64 *a1)
{
  ...
  v2 = KeAcquireSpinLockRaiseToDpc(&qword_140C369F0);
  ...
  *(_QWORD *)(v3 + 8) = a1;
  ...
  result = KxReleaseSpinLock((volatile signed __int64 *)&qword_140C369F0);
  if ( KiIrqlFlags )
  {
