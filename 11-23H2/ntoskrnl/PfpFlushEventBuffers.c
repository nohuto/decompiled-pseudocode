/*
 * XREFs of PfpFlushEventBuffers @ 0x14074AECC
 * Callers:
...
__int64 PfpFlushEventBuffers()
{
  ...
  v0 = 0LL;
  v1 = 0;
  PfFbBufferListFlushStandby((_SLIST_ENTRY *)&stru_140C652A0);
  v2 = RtlpInterlockedFlushSList(&stru_140C65320);
  if ( v2 )
  {
    do
    {
