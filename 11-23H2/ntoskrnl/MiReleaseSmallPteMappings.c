...
LABEL_57:
                      if ( v46 && (unsigned int)RtlInterlockedSetClearRunEx((__int64)v39, v37 + v36, v35) )
...
LABEL_63:
    ...
    MiInsertTbFlushEntry((__int64)v81, (__int64)(v19 << 25) >> 16, v9, 0);
    ...
    _InterlockedOr(v72, 0);
    MayNeedFlush = MiTbFlushTimeStampMayNeedFlush(v76, KiTbFlushTimeStamp, -1);
    v8 = v74;
    if ( MayNeedFlush )
      goto LABEL_62;
    v10 = v73;
