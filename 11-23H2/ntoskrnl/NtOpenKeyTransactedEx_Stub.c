/*
 * XREFs of NtOpenKeyTransactedEx_Stub @ 0x140A6ADE8
 * Callers:
...
__int64 __fastcall NtOpenKeyTransactedEx_Stub(__int64 a1)
{
  ...
  if ( byte_140D1C240 )
  {
    v1 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, HANDLE))qword_140D1C238;
  }
  else
  {
    v1 = ZwOpenKeyTransactedEx;
    byte_140D1C240 = 1;
    qword_140D1C238 = (__int64)ZwOpenKeyTransactedEx;
  }
  if ( v1 )
