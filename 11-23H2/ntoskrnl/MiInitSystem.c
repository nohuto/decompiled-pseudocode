 ...
 *     MiInitializeBootKernelShadowStacks @ 0x1403B5FEC (MiInitializeBootKernelShadowStacks.c)
 ...
 *     MmConfigurePrefetchSeekThreshold @ 0x1407EAFF8 (MmConfigurePrefetchSeekThreshold.c)
