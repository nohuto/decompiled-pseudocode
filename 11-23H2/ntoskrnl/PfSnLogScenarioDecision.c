/*
 * XREFs of PfSnLogScenarioDecision @ 0x140752BE4
 * Callers:
        ...
        __int64 a8)
{
  ...
  v20 = 0;
  v26 = 0;
  if ( qword_140C6A708 && EtwEventEnabled(qword_140C6A708, &PfSnEvt_ScenarioDecision_Info) )
  {
    v16 = -1LL;
    do
      ++v16;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v26 = v17;
    v50 = 4LL;
    EtwWrite(qword_140C6A708, &PfSnEvt_ScenarioDecision_Info, 0LL, 9u, &UserData);
  }
  ...
  if ( (unsigned int)dword_140C03008 > 4 )
  {
    ...
    if ( (_BYTE)ProcessTelemetryInfo )
    {
      ...
      LOBYTE(ProcessTelemetryInfo) = tlgWriteTransfer_EtwWriteTransfer(
                                       ...
                                       (unsigned __int8 *)byte_14002DA47,
                                       0LL,
                                       0LL,
                                       0xBu,
                                       &v51);
