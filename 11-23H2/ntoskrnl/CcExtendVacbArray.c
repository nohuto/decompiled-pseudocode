...
LABEL_46:
    ...
    if ( (unsigned __int8)CcAllocateVacbLevels(v23 - v21, 0LL, v35) )
    {
      CcAcquireBcbLockAndVacbLock(v2, a1);
      if ( v21 == 1 )
        CcCalculateVacbLevelLockCount(a1, *(_QWORD *)(a1 + 88));
      v28 = *(_QWORD **)(a1 + 88);
      if ( *(_QWORD *)VacbLevelReference(a1, v28, v21 - 1, v27) )
      {
        do
        {
          ++v21;
          ...
          *VacbLevel = *(_QWORD *)(a1 + 88);
          v33 = (_DWORD *)VacbLevelReference(a1, VacbLevel, v21, v32);
          ++*v33;
          *(_QWORD *)(a1 + 88) = v34;
        }
        while ( v21 < v23 );
