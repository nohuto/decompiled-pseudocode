/*
 * XREFs of MiTryUnlinkNodeLargePages @ 0x1403A0D5C
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  while ( 1 )
  {
    ...
    {
      if ( BugCheckParameter2 > qword_140C65BA0
    ...
    if ( *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v11 + 40) >> 43) & 0x3FFLL)) != a1 )
      break;
    if ( !v64 )
    {
      v64 = 1;
      ...
      if ( v20 <= 1u )
      {
        if ( a7 )
        {
          if ( (v19 & 8) == 0 )
          {
            ...
            v42 = *(_BYTE *)(v11 + 34) & 7;
            v43 = BugCheckParameter2 / MiLargePageSizes[v74] % (unsigned int)dword_140C65B80[v74];
            v83 = v41;
...
LABEL_94:
        ...
        if ( !(unsigned int)MiUnlinkNodeLargePageHelper((_QWORD *)v14, (unsigned __int64 *)v11, a3, v65, a5) )
        {
          if ( !v8 )
            *a6 = 0;
          goto LABEL_26;
...
LABEL_24:
    ...
    else
    {
      ...
      *(_QWORD *)(v14 + 23008) = &v75;
      ...
      __writecr8(CurrentIrql);
      KeWaitForGate((__int64)v76, 18, 0);
    }
    v13 = 0;
    v66 = 0;
    v64 = 0;
...
LABEL_28:
  ...
  if ( v66 )
  {
    ...
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v60 <= 0xFu && CurrentIrql <= 0xFu && v60 >= 2u )
      {
