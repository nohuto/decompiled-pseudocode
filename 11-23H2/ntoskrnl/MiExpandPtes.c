/*
 * XREFs of MiExpandPtes @ 0x140210C78
 * Callers:
...
__int64 __fastcall MiExpandPtes(__int64 *a1, unsigned __int64 a2)
{
  ...
  {
LABEL_8:
    if ( !(unsigned int)MiMakeZeroedPageTablesEx(v10, (int)v10 + 8 * ((int)v7 - 1), 16, v4, 0) )
    {
      if ( v5 )
        v4 = 13;
      goto LABEL_44;
    ...
    if ( (dword_140D1D1CC & 2) != 0 && a1 == &qword_140C69940 )
    {
      v29 = 2 * v11;
      v30 = qword_140C683A0 + (v29 >> 3);
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)a1 + 5, &LockHandle);
