/*
 * XREFs of HvpRemapAndEnlistHiveBins @ 0x14074F984
 * Callers:
 ...
 *     HvpValidateLoadedBin @ 0x14074FC20 (HvpValidateLoadedBin.c)
    ...
    if ( *(_DWORD *)(BugCheckParameter2 + 232) != 4096 )
    {
      do
      {
        ...
        if ( !(unsigned __int8)HvpValidateLoadedBin(BinAddress, v11, v13) )
        {
          ...
          v24 = HvpMarkDirty(BugCheckParameter2, v11, 4096, 0);
          v20 = v24;
          if ( v24 < 0 )
          {
            v43 = 48;
        ...
        if ( BinAddress[2] != 4096 )
        {
          ...
          HvpPointMapEntriesToBuffer(BugCheckParameter2, v7, v7 & v44);
...
LABEL_33:
    ...
    if ( v28[2] != 4096 )
    {
      ...
      HvpGetBinContextInitialize(&v53);
      Bin = HvpAllocateBin(BugCheckParameter2, v9, 0, 825445699, (__int64)&v47);
      v20 = Bin;
      if ( Bin < 0 )
      {
