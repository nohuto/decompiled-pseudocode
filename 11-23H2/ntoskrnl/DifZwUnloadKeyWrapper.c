/*
 * XREFs of DifZwUnloadKeyWrapper @ 0x1405F8640
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwUnloadKeyWrapper(POBJECT_ATTRIBUTES TargetKey)
{
