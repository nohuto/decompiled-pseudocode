/*
 * XREFs of MiMigratePfn @ 0x1402630E0
 * Callers:
 ...
 *     MiNodeFromFaultPacket @ 0x140261160 (MiNodeFromFaultPacket.c)
...
LABEL_61:
  ...
  {
    v43 = (unsigned int *)(qword_140C65A98 + 4LL * v26 * (unsigned __int16)KeNumberNodes);
    if ( v43 < v31 )
    {
...
LABEL_69:
  ...
  *(_BYTE *)(a2 + 34) = *(_BYTE *)(a2 + 34) & 0xF8 | 5;
  ...
  if ( (unsigned int)MiPteInShadowRange(v47) )
  {
    ...
    {
      if ( !HIBYTE(word_140C66CFC) && (updated & 1) != 0 )
