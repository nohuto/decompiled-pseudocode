        ...
        _DWORD *a7)
{
  ...
  *a7 = 0;
  ...
  v162 = *(_QWORD *)(v8 >> 16);
  v165 = v162;
  v9 = *(_QWORD *)(qword_140C673C8 + 8LL * (*(_WORD *)(v162 + 60) & 0x3FF));
  v168 = (_DWORD *)(v162 + 56);
  if ( ((*(_DWORD *)(v162 + 56) >> 20) & 0x7F) != 0 )
  {
    CurrentPrcb = KeGetCurrentPrcb();
    NodeShiftedColor = (((*(_DWORD *)(v162 + 56) >> 20) & 0x7F) - 1) << byte_140C65A8D;
  }
  else
  {
  ...
  *(_QWORD *)&Size[1] = 48 * Page;
  ...
  v24 = MiReservePtes((__int64)&qword_140C69940, 1u);
  v167 = v24;
  if ( v24 )
  {
    v25 = 4;
    if ( v156 <= qword_140C65BA0 )
    {
    ...
    {
      v30 = HIBYTE(word_140C66CFC);
    }
    else
    {
      if ( byte_140C6A3D8[((v29 >> 39) & 0x1FF) - 256] == 1
        || v29 >= 0xFFFFF68000000000uLL && v29 <= 0xFFFFF6FFFFFFFFFFuLL )
      {
        goto LABEL_41;
      }
      v30 = v29 > qword_140C67070 || v29 < qword_140C6A558 ? (unsigned __int8)word_140C66CFC : HIBYTE(word_140C66CFC);
    }
    if ( v30 )
LABEL_221:
      v28 |= 0x100uLL;
LABEL_41:
    *(_QWORD *)v24 = ((((unsigned __int16)v28 | 0x42) ^ (unsigned __int16)((unsigned __int8)word_140C66CFC << 8)) & 0x100 ^ (v28 | 0x42)) & 0xF0FFFFFFFFFFFFFFuLL | 0xA00000000000000LL;
    ...
    v154 = 0;
    memmove(v32, Src, a4);
    MiReleasePtes((__int64)&qword_140C69940, (__int64 *)v24, 1u);
    goto LABEL_43;
  }
  if ( (a5 & 1) == 0 )
  {
    ...
    if ( (*v33 & 1) == 0 || (v39 & 0x200) != 0 )
    {
      ...
      if ( CurrentIrql != 17 )
      {
        if ( KiIrqlFlags )
        {
          ...
          if ( (KiIrqlFlags & 1) != 0 && v143 <= 0xFu && CurrentIrql <= 0xFu && v143 >= 2u )
          {
...
LABEL_355:
    ...
    if ( CurrentIrql != 17 )
    {
      if ( KiIrqlFlags )
      {
        ...
        if ( (KiIrqlFlags & 1) != 0 && v118 <= 0xFu && CurrentIrql <= 0xFu && v118 >= 2u )
        {
...
LABEL_58:
  ...
  v47 = *(void **)(qword_140C673C8 + 8 * v46);
  if ( !v42 || (unsigned int)MiChargeCommit(*(_QWORD *)(qword_140C673C8 + 8 * v46), 1uLL, 4uLL) )
  {
...
LABEL_64:
  ...
  *v66 |= 0x10u;
  ...
  if ( KiIrqlFlags )
  {
    ...
    if ( (KiIrqlFlags & 1) != 0 && v132 <= 0xFu && v69 <= 0xFu && v132 >= 2u )
    {
    ...
    if ( *(_WORD *)(v90 - 0x21FFFFFFFFE0LL) )
    {
      ...
      *v74 = v137;
      if ( (*(_DWORD *)v56 & 0x400LL) == 0 && (unsigned int)MiGetPagingFileOffset(v56, v77, v76, v74) )
        *(_BYTE *)(*(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v78 + 40) >> 43) & 0x3FFLL)) + 715LL) = 1;
    }
    else if ( (_DWORD)v91 )
    {
      ...
      MiReleasePageFileSpace(*(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v78 + 40) >> 43) & 0x3FFLL)), *v56, 1);
      *(_QWORD *)&Size[1] = v90 >> 4;
...
LABEL_140:
    ...
    v104 = *(_QWORD *)(qword_140C673C8 + 8 * v103);
    ...
    {
      MiReturnCommit(*(_QWORD *)(qword_140C673C8 + 8 * v103), 1LL);
    }
    v105 = 1LL;
...
LABEL_152:
  ...
  if ( KiIrqlFlags )
  {
    ...
    if ( (KiIrqlFlags & 1) != 0 && v139 <= 0xFu && v147 <= 0xFu && v139 >= 2u )
    {
