/*
 * XREFs of RtlAddAtomToAtomTableEx @ 0x140297A20
 * Callers:
 *     NtAddAtomEx @ 0x1407D1A90 (NtAddAtomEx.c)
 *     RtlAddAtomToAtomTable @ 0x1407E4500 (RtlAddAtomToAtomTable.c)
 * Callees:
 *     RtlpReferenceAtom @ 0x1402979C4 (RtlpReferenceAtom.c)
