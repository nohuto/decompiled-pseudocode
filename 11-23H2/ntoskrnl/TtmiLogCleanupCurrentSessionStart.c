/*
 * XREFs of TtmiLogCleanupCurrentSessionStart @ 0x1409A70D0
 * Callers:
...
void TtmiLogCleanupCurrentSessionStart()
{
  ...
  if ( (unsigned int)dword_140D53918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53918, 1LL) )
    {
      ...
      v4 = 4;
      v3 = &v1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53918, (unsigned __int8 *)byte_1400335AD, 0LL, 0LL, 3u, &v2);
    }
  }
}
