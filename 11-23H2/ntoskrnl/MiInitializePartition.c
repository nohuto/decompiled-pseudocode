/*
 * XREFs of MiInitializePartition @ 0x1408375A0
 * Callers:
 ...
 *     MiInitializePfnListHead @ 0x14036D940 (MiInitializePfnListHead.c)
 *     MiInitializeCommitment @ 0x140395D74 (MiInitializeCommitment.c)
 *     MiInitializeCombining @ 0x140397E3C (MiInitializeCombining.c)
...
char __fastcall MiInitializePartition(unsigned __int64 a1, __int16 a2)
{
  ...
  *(_DWORD *)(a1 + 4) = 0;
  ...
  {
    qword_140C67300 = 0LL;
    qword_140C67328 = (__int64)&qword_140C67320;
    qword_140C67320 = &qword_140C67320;
    qword_140C67360 = 0LL;
  }
  else
  {
  ...
  *(_QWORD *)(a1 + 16088) = a1 + 16088;
  ...
  v22 = dword_140C65AFC;
  v23 = 0;
  for ( i = *(_QWORD *)(a1 + 6808); v23 < 2 * dword_140C65AFC; ++v23 )
  {
  ...
  *(_DWORD *)(a1 + 16512) = v25;
  if ( (unsigned __int16 *)a1 == MiSystemPartition )
    MiInitializePfnListHead((__int64)&qword_140C65688, 5);
  ...
  *(_QWORD *)(a1 + 1432) = 1LL;
  ...
  v41 = KeAbPreAcquire((__int64)&qword_140C67388, 0LL);
  v18 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C67388, 0LL);
  v42 = v41;
  if ( v18 )
    ExfAcquirePushLockExclusiveEx(&qword_140C67388, v41, (__int64)&qword_140C67388);
  if ( v42 )
    *(_BYTE *)(v42 + 18) = 1;
  *(_DWORD *)(a1 + 4) |= 2u;
  v43 = _InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C67388, 0xFFFFFFFFFFFFFFFFuLL);
  if ( (v43 & 2) != 0 && (v43 & 4) == 0 )
    ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C67388);
  LOBYTE(v44) = KeAbPostRelease((ULONG_PTR)&qword_140C67388);
