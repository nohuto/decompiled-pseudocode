/*
 * XREFs of MiInitializePartition @ 0x1408372A0
 * Callers:
 ...
 *     MiInitializePfnListHead @ 0x14036D7A0 (MiInitializePfnListHead.c)
 *     MiInitializeCommitment @ 0x140395B94 (MiInitializeCommitment.c)
 *     MiInitializeCombining @ 0x140397C5C (MiInitializeCombining.c)
