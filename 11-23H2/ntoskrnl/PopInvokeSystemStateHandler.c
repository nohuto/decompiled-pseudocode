...
__int64 __fastcall PopInvokeSystemStateHandler(int a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    qword_140D18528 = DeferredContext[1];
    qword_140D18530 = DeferredContext[2];
    qword_140D18538 = DeferredContext[3];
    qword_140D18540 = DeferredContext[4];
    dword_140D18548 = DeferredContext[5];
    byte_140D1854C = BYTE4(DeferredContext[5]);
    dword_140D18550 = DeferredContext[6];
    qword_140D18558 = DeferredContext[7];
    RtlpInterlockedPushEntrySList(&stru_140D18560, &v36[9]);
  }
  else
  {
