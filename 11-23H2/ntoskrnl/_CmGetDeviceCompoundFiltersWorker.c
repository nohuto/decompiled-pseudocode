/*
 * XREFs of _CmGetDeviceCompoundFiltersWorker @ 0x140A680BC
 * Callers:
        ...
        __int64 a10)
{
  ...
  v14 = 0LL;
  v28 = 0;
  if ( (int)PnpCtxRegQueryInfoKey(a1, a4, &v30, 0LL, 0LL, 0LL, 0LL) < 0 || !(_DWORD)v30 )
...
LABEL_53:
  ...
  {
LABEL_29:
    DeclarativeFilterList = CmGetDeclarativeFilterList(a1, (__int64)a4, (const wchar_t *)v31, v13, v19, 0LL, 0, &v28);
...
LABEL_44:
    ...
    if ( !v14 )
      goto LABEL_33;
    ObjectProperty = CmGetDeclarativeFilterList(a1, (__int64)a4, (const wchar_t *)v31, v13, v19, v14, v28, &v28);
    if ( ObjectProperty < 0 )
      goto LABEL_44;
    v22 = a3;
