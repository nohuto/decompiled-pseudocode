/*
 * XREFs of PpmWmiGetAllData @ 0x1409963AC
 * Callers:
    ...
    *(_DWORD *)(a4 + 60) = v17;
    ...
    if ( v26 || !v15 )
    {
      ...
      if ( v27 || !*a1 )
      {
        ...
        if ( !v33 && v15 )
          PpmPerfGetCurrentState((__int64)(a1 - 4200), v23, 0LL, v23 + 2, v23 + 1, 0LL);
      }
      else
      {
        ...
        *((_QWORD *)v23 + 2) = *(a1 - 4175);
        ...
        if ( v29 )
        {
          ...
          {
            v30 += 344LL;
            *(v31 - 2) = *(_DWORD *)(v30 + *a1 + 1048) / 0xAu;
            *(v31 - 1) = *(_DWORD *)(v30 + *a1 + 1056);
            *v31 = *(_DWORD *)(v28 + 732);
            v31 += 8;
            *((_BYTE *)v31 - 28) = *(_BYTE *)(v28 + 736);
            *((_BYTE *)v31 - 27) = *(_BYTE *)(v28 + 737);
            *((_BYTE *)v31 - 26) = *(_BYTE *)(v30 + *a1 + 1104);
            *((_QWORD *)v31 - 3) = *(unsigned int *)(v30 + *a1 + 1060);
            *(v31 - 4) = 1;
            --v32;
          }
          while ( v32 );
    ...
    {
      *v23 = 0;
      v23[1] = *(_DWORD *)(v15 + 440);
      *((_QWORD *)v23 + 1) = 0LL;
      *((_QWORD *)v23 + 2) = 0LL;
      *((_BYTE *)v23 + 28) = 100;
      *((_BYTE *)v23 + 29) = *(_BYTE *)(v15 + 481);
      v23[8] = HIDWORD(PpmCurrentProfile[55 * dword_140C3D96C + 7]);
