    ...
    if ( v31 != 10 )
    {
      if ( v31 != 59 )
      {
        if ( v31 == 76 )
        {
          ...
          v66 = 1;
          v71 = 1;
          v30 = (unsigned __int64)qword_140C427A8;
          KiBugCheckData = (unsigned int)a2;
          v42 = a3 - (_QWORD)&qword_140C42788;
          v86 = (PCSTR)a5;
          do
          {
          ...
          while ( (__int64)v41 < (__int64)qword_140C427A8 );
          v32 = v70;
          v35 = 1;
          goto LABEL_93;
        }
...
LABEL_66:
              if ( v31 != 142 )
              {
                ...
                if ( KeGetCurrentThread()->ApcStateIndex == 1
                  && (unsigned __int64)(v33 - qword_140C659E8) < 0x8000000000LL
...
LABEL_86:
            if ( v76 != a2
              || (unsigned __int64)(a2 - qword_140C659E8) >= 0x8000000000LL
        ...
        if ( KeGetCurrentThread()->ApcStateIndex == 1 )
        {
          v38 = (unsigned __int64)(v37 - qword_140C659E8) < 0x8000000000LL;
          v24 = (__int64)CurrentPrcb;
          if ( v38 )
          {
...
LABEL_94:
  ...
  if ( v69 && (PartialDumpControl & 4) != 0 )
  {
    ...
    qword_140C427C8 = (__int64)CurrentThread;
    qword_140C427D0 = (__int64)v83;
    byte_140C427E0 = v34;
    byte_140C427E1 = v21;
  ...
  if ( CrashdmpDumpBlock )
    v47 = !v35;
  HvlLogGuestCrashInformation(KiBugCheckData, qword_140C42788, qword_140C42790, qword_140C42798, qword_140C427A0, v47);
  if ( !KdPitchDebugger )
  ...
  if ( (unsigned __int8)KiBugCheckShouldEnterPostBugCheckDebugger(v75, 0LL) )
  {
    if ( !*(_BYTE *)(v24 + 32422) )
    {
      DbgPrintEx(
        ...
        KiBugCheckData,
        (const void *)qword_140C42788,
        (const void *)qword_140C42790,
        (const void *)qword_140C42798,
        (const void *)qword_140C427A0);
      if ( KiBugCheckDriver )
...
LABEL_166:
  ...
  if ( v29 )
  {
    ...
    IoSaveInitialBugCheckProgress(KiBugCheckData, qword_140C42788);
