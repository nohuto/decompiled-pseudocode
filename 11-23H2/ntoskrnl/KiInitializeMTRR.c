/*
 * XREFs of KiInitializeMTRR @ 0x140B5F650
 * Callers:
...
void __fastcall KiInitializeMTRR(char a1)
{
  ...
  {
    qword_140C418E8 = __readmsr(0xFEu);
    ...
    if ( CurrentPrcb->CpuVendor == 1 )
    {
      ...
      byte_140C418F1 = (v13 & 0x1040000) == 0x40000;
    }
    if ( (((_BYTE)qword_140C418E8 != 0) & _bittest64(&KiMtrrInfo, 0xBu)) != 0 )
    {
      if ( (KeFeatureBits & 0x40) == 0 && (qword_140C418E8 & 0x400) != 0 )
        qword_140C418E8 &= ~0x400uLL;
      if ( !qword_140C418F8 )
        qword_140C418F8 = (PVOID)ExAllocatePool2(64LL, 16 * (unsigned int)(unsigned __int8)qword_140C418E8, 0x2020654Bu);
      if ( !qword_140C41900 && _bittest64(&qword_140C418E8, 8u) )
        qword_140C41900 = (PVOID)ExAllocatePool2(64LL, 0x58uLL, 0x2020654Bu);
    }
    else
    {
      if ( (KeFeatureBits & 0x40) != 0
        && (qword_140C418E8 & 0x1FF) != 0
        && (KiMtrrInfo & 0x800) == 0
  ...
  if ( !qword_140C418F8 || !qword_140C41900 && _bittest64(&qword_140C418E8, 8u) )
    goto LABEL_44;
  v2 = __readmsr(0xFEu);
  if ( (KeFeatureBits & 0x40) == 0 && (v2 & 0x400) != 0 )
    v2 &= ~0x400uLL;
  if ( v2 != qword_140C418E8 )
  ...
  if ( KeGetPcr()->Prcb.Number )
    goto LABEL_18;
  if ( qword_140C41900 )
    KiReadFixedMtrr(qword_140C41900);
  ...
  do
  {
    ...
    if ( (v8 & 0x800) != 0 )
    {
      ...
      v11 = 2 * v5;
      *((_QWORD *)qword_140C418F8 + v11) = v7;
      *((_QWORD *)qword_140C418F8 + v11 + 1) = v10;
    }
    ++v4;
    v6 += 2;
    v5 = v4;
...
LABEL_44:
    if ( qword_140C418F8 )
    {
      ExFreePoolWithTag(qword_140C418F8, 0);
      qword_140C418F8 = 0LL;
    }
    if ( qword_140C41900 )
    {
      ExFreePoolWithTag(qword_140C41900, 0);
      qword_140C41900 = 0LL;
    }
  }
}
