...
__int64 __fastcall MiCheckProcessorPteCache(unsigned __int64 a1)
{
  ...
  {
    v20 = qword_140C69980;
    v21 = (unsigned __int64 *)&qword_140C69940;
    v64 = qword_140C69980;
    if ( qword_140C69980 )
    {
      while ( qword_140C69940 < v20 )
      {
      ...
      *(_QWORD *)&v63 = qword_140C69940 - v20;
      *((_QWORD *)&v63 + 1) = qword_140C69948 + 8 * (v20 >> 6);
      if ( v19 )
        v19 -= v20;
    }
LABEL_29:
...
LABEL_36:
    if ( v29 )
    {
      if ( (unsigned int)MiEmptyPteBins((__int64)&qword_140C69940) )
      {
        v19 = 0LL;
        continue;
      }
    ...
    else
    {
      ...
      v31 = *(_QWORD *)(qword_140C69948 + 8 * (v30 >> 6));
      v32 = (volatile signed __int64 *)(qword_140C69948 + 8 * (v30 >> 6));
      if ( v31 == -1LL )
      {
LABEL_108:
        v19 = v30 + 64;
