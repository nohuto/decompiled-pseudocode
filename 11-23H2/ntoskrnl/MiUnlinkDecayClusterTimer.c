...
__int64 __fastcall MiUnlinkDecayClusterTimer(__int64 a1)
{
  ...
  v3 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL));
  v4 = *(_QWORD *)(a1 + 8);
  ...
  {
    *(_QWORD *)(48 * (qword_140C68160 + v5) - 0x220000000000LL + 8) = v4 ^ (*(_QWORD *)(48 * (qword_140C68160 + v5)
                                                                                      - 0x220000000000LL
                                                                                      + 8) ^ v4) & 0x1FFFFFFFFLL;
  }
  if ( v6 == 0x7FFFFFFF )
  ...
  {
    v7 = 48 * (v6 + qword_140C68160) - 0x220000000000LL;
