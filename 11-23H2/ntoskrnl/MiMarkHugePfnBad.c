...
__int64 __fastcall MiMarkHugePfnBad(ULONG_PTR a1, int a2)
{
  ...
  if ( v7 )
    *(_BYTE *)(v7 + 18) = 1;
  v17 = (_QWORD *)(qword_140C67DF0 + 8 * v3);
  v66 = v17;
  while ( 1 )
  {
    ...
    if ( v21->AbEntrySummary || (v23 = KiAbTryReclaimOrphanedEntries(v19, (__int64)v21)) != 0 )
    {
      ...
      if ( v20 - qword_140C659E8 >= 0x8000000000LL )
        v29 = -1;
      else
  ...
  else
  {
    ...
    while ( 1 )
    {
      v34 = (__int64 *)(qword_140C67DF0 + 8 * v3);
        ...
        while ( 1 )
        {
          if ( v3 >= (v44[3] & 0x3FFFFFuLL) )
          {
            ...
            if ( !v46 )
            {
              v45 = 1;
LABEL_66:
              RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C67360, (unsigned __int64)v44, v45, v2);
              *v34 = v36 | 8;
              goto LABEL_75;
            }
          }
