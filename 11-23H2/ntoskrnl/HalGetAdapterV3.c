/*
 * XREFs of HalGetAdapterV3 @ 0x140827530
 * Callers:
 ...
 *     HalpDmaIsAutomaticDomain @ 0x140390DC0 (HalpDmaIsAutomaticDomain.c)
 ...
 *     HalpFindDmaControllerByRequestLine @ 0x140517230 (HalpFindDmaControllerByRequestLine.c)
