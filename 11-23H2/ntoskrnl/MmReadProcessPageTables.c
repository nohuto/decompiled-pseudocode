/*
 * XREFs of MmReadProcessPageTables @ 0x140645D60
 * Callers:
...
__int64 __fastcall MmReadProcessPageTables(__int64 a1)
{
  ...
  v3 = ValidPte;
  __wbinvd();
  result = ExTryAcquireSpinLockSharedAtDpcLevel(&dword_140C6B520);
  v5 = 0;
  if ( (_DWORD)result )
  {
...
LABEL_18:
    ...
    KeFlushSingleCurrentTb((__int64)((_QWORD)v6 << 25) >> 16, 0);
    ExReleaseSpinLockSharedFromDpcLevel(&dword_140C6B520);
    return 1LL;
  }
  return result;
}
