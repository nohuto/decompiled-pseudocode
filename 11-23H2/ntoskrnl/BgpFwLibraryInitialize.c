/*
 * XREFs of BgpFwLibraryInitialize @ 0x140AEDC78
 * Callers:
 ...
 *     BgpFwInitializeLock @ 0x140B9D294 (BgpFwInitializeLock.c)
 */
...
__int64 __fastcall BgpFwLibraryInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( (dword_140C0E4B0 & 1) != 0 && (dword_140C0E4B0 & 4) == 0 && (*(_DWORD *)(a1 + 120) & 0x100000) == 0 )
    return 3221225485LL;
  if ( (*(_DWORD *)(a1 + 120) & 0x100000) == 0 )
  {
    if ( a2 == -1 )
    {
      dword_140C0E4B0 = BgpFwInitializeLock() | 0xC04;
      qword_140C0E588 = (__int64)&qword_140C0E580;
      qword_140C0E580 = (__int64)&qword_140C0E580;
      v6 = *(_QWORD *)(v5 + 240);
      if ( !v6 || !*(_DWORD *)(a1 + 248) )
        return 3221225626LL;
      ...
      if ( v7 < 0 )
        goto LABEL_9;
      xmmword_140C0E4E8 = *(_OWORD *)(a1 + 100);
      if ( !*(_QWORD *)(a1 + 88) )
      {
LABEL_67:
        if ( *(_DWORD *)(a1 + 116) >= 3u )
        {
          qword_140C0E630 = *(_QWORD *)(a1 + 404);
          dword_140C0E638 = *(_DWORD *)(a1 + 412);
        }
        dword_140C0E618 = *(_DWORD *)(a1 + 400);
...
LABEL_76:
    ...
    *(PHYSICAL_ADDRESS *)&xmmword_140C0E490 = MmGetPhysicalAddress(qword_140C0E460);
    DWORD2(xmmword_140C0E490) = DWORD2(BgInternal);
    HIDWORD(xmmword_140C0E490) = DWORD1(BgInternal);
    LODWORD(xmmword_140C0E4A0) = HIDWORD(BgInternal);
    if ( (_DWORD)xmmword_140C0E450 == 4 )
    {
      DWORD2(xmmword_140C0E4A0) = 3;
    }
    else if ( (_DWORD)xmmword_140C0E450 == 5 )
    {
      DWORD2(xmmword_140C0E4A0) = 4;
    }
    else
    {
      DWORD2(xmmword_140C0E4A0) = 0;
    }
    v9 = 0;
    v10 = 432;
    v45 = 0;
    xmmword_140C0E590 = *(_OWORD *)(a1 + 272);
    v11 = 0;
    v12 = 0;
    xmmword_140C0E5A0 = *(_OWORD *)(a1 + 288);
    xmmword_140C0E5B0 = *(_OWORD *)(a1 + 304);
    xmmword_140C0E5C0 = *(_OWORD *)(a1 + 320);
    xmmword_140C0E5D0 = *(_OWORD *)(a1 + 336);
    xmmword_140C0E5E0 = *(_OWORD *)(a1 + 352);
    xmmword_140C0E5F0 = *(_OWORD *)(a1 + 368);
    xmmword_140C0E600 = *(_OWORD *)(a1 + 384);
    if ( *(_QWORD *)(a1 + 72) )
    {
      v9 = 32;
      v12 = *(_DWORD *)(a1 + 84);
    ...
    *(_QWORD *)(v19 + 448) = v24;
    dword_140C0E4B0 |= 0x800u;
    v25 = BgpFoInitialize(v19 + 432, 1LL);
    dword_140C0E4B0 &= ~0x800u;
    if ( v25 >= 0 )
      qword_140C0E560 = v19 + 432;
    if ( !qword_140C0E560 )
LABEL_77:
    ...
    memset(&qword_140C0E4F8, 0, 0x58uLL);
    if ( *(_QWORD *)(a1 + 144) )
    {
      ...
      if ( v28 )
      {
        ...
        qword_140C0E50C = *(_QWORD *)(a1 + 164);
      }
    }
    v29 = *(_QWORD *)(a1 + 184);
    if ( v29 && (int)BgpGxProcessQrCodeBitmap(v29, &qword_140C0E538) < 0 )
      qword_140C0E538 = 0LL;
    v30 = *(_QWORD *)(a1 + 216);
    if ( v30 )
    {
...
LABEL_41:
    ...
    dword_140C0E618 = *(_DWORD *)(a1 + 400);
    if ( *(_DWORD *)(a1 + 116) >= 5u )
      dword_140C0E63C = *(_DWORD *)(a1 + 416);
    dword_140C0E4B0 |= 0x8000u;
    BgpBcInitializeCriticalMode(a1, a2);
    dword_140C0E4B0 = dword_140C0E4B0 & 0xFFFF77FF | 0x800;
    ...
    qword_140C0E578 = ResFwConfigureDisplayStringResources(*(_QWORD *)(a1 + 256));
    qword_140C0E570 = AnFwConfigureProgressResources(*(_QWORD *)(a1 + 264));
    v39 = *(_DWORD *)(a1 + 124);
    dword_140C0E4B0 |= v4 | 0x80;
    dword_140C0E4B4 = v39;
    BgpFwReleaseLock();
    qword_140C0E550 = *(_QWORD *)(a1 + 232);
    goto LABEL_51;
  }
  BgpFwAcquireLock();
  if ( a2 != -1 )
  {
    dword_140C0E4B0 &= ~0x1000u;
...
LABEL_51:
  ...
  qword_140C0E460 = 0LL;
  dword_140C0E4B0 = dword_140C0E4B0 & 0xFFEFE7FD | 0x101800;
  BgInternal = 0LL;
