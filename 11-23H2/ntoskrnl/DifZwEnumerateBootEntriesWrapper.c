/*
 * XREFs of DifZwEnumerateBootEntriesWrapper @ 0x1405F0380
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwEnumerateBootEntriesWrapper(PVOID Buffer, PULONG BufferLength)
{
...
LABEL_17:
  result = ZwEnumerateBootEntries(Buffer, BufferLength);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
