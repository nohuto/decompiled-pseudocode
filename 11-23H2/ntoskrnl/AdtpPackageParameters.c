/*
 * XREFs of AdtpPackageParameters @ 0x140399604
 * Callers:
 *     AdtpWriteToEtwEx @ 0x14066FB40 (AdtpWriteToEtwEx.c)
 *     AdtpWriteToEtw @ 0x14083CD50 (AdtpWriteToEtw.c)
 * Callees:
 *     AdtpIsCorrectlyFormedUnicodeString @ 0x140399B30 (AdtpIsCorrectlyFormedUnicodeString.c)
...
LABEL_34:
        ...
        if ( v21 != 5 )
        {
          if ( v21 == 6 )
          {
            v54 = 2LL * v10;
            v55 = v18 + v10;
            v56 = 4 * (unsigned __int8)byte_140D54DB9 + 8;
