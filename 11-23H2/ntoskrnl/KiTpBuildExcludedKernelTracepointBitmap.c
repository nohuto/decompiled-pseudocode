/*
 * XREFs of KiTpBuildExcludedKernelTracepointBitmap @ 0x140976520
 * Callers:
 ...
 *     KeReadStateSemaphore @ 0x1402F89C0 (KeReadStateSemaphore.c)
 *     RtlIsSpecialUnwind @ 0x1405B1EBC (RtlIsSpecialUnwind.c)
 *     RtlLookupPrimaryFunctionEntry @ 0x1405B1F14 (RtlLookupPrimaryFunctionEntry.c)
