...
__int64 __fastcall MmCommitSessionMappedView(unsigned __int64 a1, __int64 a2)
{
  ...
  v9 = KeAbPreAcquire((__int64)&qword_140C68540, 0LL);
  v10 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C68540, 0LL);
  v11 = v9;
  if ( v10 )
    ExfAcquirePushLockExclusiveEx(&qword_140C68540, v9, (__int64)&qword_140C68540);
  if ( v11 )
    *(_BYTE *)(v11 + 18) = 1;
  v12 = P;
  while ( v12 )
  ...
  if ( *(_QWORD *)(*(_QWORD *)v14 + 64LL) )
  {
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C68540, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C68540);
