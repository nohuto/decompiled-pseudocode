/*
 * XREFs of MiInitializeAllResidentPageBasePfns @ 0x140219FF4
 * Callers:
        ...
        int a7)
{
  ...
  v7 = *a1;
  v29 = xmmword_140C672B0;
  v9 = MiLargePageSizes[a4];
  v31.m128i_i64[0] = xmmword_140C672D0;
  v10 = _mm_srli_si128((__m128i)xmmword_140C672D0, 8).m128i_u64[0];
  v31.m128i_i64[1] = (v10 ^ (v7 << 43)) & 0x1FF80000000000LL ^ v10;
  v31.m128i_i8[4] = (BYTE4(xmmword_140C672D0) ^ ~(_BYTE)a4) & 3 ^ BYTE4(xmmword_140C672D0);
  v30 = xmmword_140C672C0;
