/*
 * XREFs of MiAllocateMdlPagesByLists @ 0x14023B9E0
 * Callers:
...
LABEL_10:
    ...
    if ( dword_140C65A84 > (unsigned int)dword_140C65A88
      || (v25 = (char *)qword_140C65AC8 + 16 * dword_140C65A84, v23 < *(_QWORD *)v25)
      || dword_140C65A84 != dword_140C65A88 && v23 >= *((_QWORD *)v25 + 2) )
    {
      v32 = 0;
...
LABEL_84:
      ...
      {
        v33 = (v32 + v24) >> 1;
        v25 = (char *)qword_140C65AC8 + 16 * v33;
        if ( v23 < *(_QWORD *)v25 )
        {
          if ( !v33 )
        ...
        {
          if ( v33 == dword_140C65A88 || v23 < *((_QWORD *)v25 + 2) )
          {
            dword_140C65A84 = (v32 + v24) >> 1;
            break;
          }
          v32 = v33 + 1;
        }
    ...
    if ( (_DWORD)v26 != v16 >> byte_140C65A8D )
    {
      v42 = v46;
      v20 |= 2u;
      ...
      {
        v46 |= 1LL << v26;
        v16 = ((_DWORD)v26 << byte_140C65A8D) & ~dword_140C65A80 | dword_140C65A80 & (((_DWORD)v26 << byte_140C65A8D) + 1);
        MiReleaseFreshPage(48 * SlabPage - 0x220000000000LL);
        goto LABEL_25;
      }
    }
...
LABEL_18:
    *v18 = SlabPage;
    ...
    if ( dword_140C65A84 <= (unsigned int)dword_140C65A88 )
    {
      v28 = (char *)qword_140C65AC8 + 16 * dword_140C65A84;
      if ( v23 >= *(_QWORD *)v28 && (dword_140C65A84 == dword_140C65A88 || v23 < *((_QWORD *)v28 + 2)) )
        goto LABEL_22;
    }
    v34 = 0;
    if ( dword_140C65A88 < 0 )
LABEL_83:
    ...
    {
      v35 = (v34 + v27) >> 1;
      v28 = (char *)qword_140C65AC8 + 16 * v35;
      if ( v23 < *(_QWORD *)v28 )
      {
        if ( !v35 )
      ...
      if ( v35 == dword_140C65A88 || v23 < *((_QWORD *)v28 + 2) )
        break;
      v34 = v35 + 1;
LABEL_40:
      if ( v27 < v34 )
...
LABEL_22:
    ...
    if ( qword_140C65AD0 )
      ...
      v30 = 0;
    v31 = dword_140C65AF8 & SlabPage | (v29 << byte_140C65A8D) | (v30 << byte_140C65A8E);
    v16 = v31 & ~dword_140C65A80 | dword_140C65A80 & (v31 + 1);
LABEL_25:
    if ( v8 < a6 )
    {
      v9 = a1;
