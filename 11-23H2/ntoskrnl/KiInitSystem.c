/*
 * XREFs of KiInitSystem @ 0x140B5E764
 * Callers:
...
__int64 __fastcall KiInitSystem(__int64 a1)
{
  ...
  qword_140C42718 = (__int64)&KeBugCheckCallbackListHead;
  KeBugCheckCallbackListHead = (__int64)&KeBugCheckCallbackListHead;
  qword_140C421B8 = (__int64)&KeBugCheckReasonCallbackListHead;
  KeBugCheckReasonCallbackListHead = &KeBugCheckReasonCallbackListHead;
  qword_140C421A8 = (__int64)&KeBugCheckAddRemovePagesCallbackListHead;
  ...
  qword_140C42568 = (__int64)&KiProfileListHead;
  KiProfileListHead = (__int64)&KiProfileListHead;
  qword_140C425A8 = (__int64)&KiProfileSourceListHead;
  ...
  *((_QWORD *)&xmmword_140E018D0 + 1) = &KiArgumentTable;
  ...
  qword_140C426E0 = (__int64)&KiBalanceSetManagerPeriodicEvent;
  qword_140C42630 = (__int64)&qword_140C42628;
  qword_140C42628 = (__int64)&qword_140C42628;
  ...
  qword_140C425F8 = (__int64)KiSetVirtualHeteroClockIntervalRequestDpcRoutine;
  qword_140C42648 = (__int64)&KiProcessListHead;
