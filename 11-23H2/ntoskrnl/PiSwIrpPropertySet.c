/*
 * XREFs of PiSwIrpPropertySet @ 0x14079C6F8
 * Callers:
 ...
 *     PiSwValidatePropertyArray @ 0x14079C8F8 (PiSwValidatePropertyArray.c)
...
__int64 __fastcall PiSwIrpPropertySet(PIRP Irp, __int64 a2, __int64 a3)
{
  ...
  if ( updated < 0 )
    goto LABEL_14;
  NdrMesTypeDecode3(v14, "TP 3\a", &off_140A77E38, &off_140C02F50, 1, &v12, FsContext2);
