/*
 * XREFs of MiSynchronizeFastPageInsert @ 0x14026E1A0
 * Callers:
...
void __fastcall MiSynchronizeFastPageInsert(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  v96 = 1;
  v93 = v9;
  if ( (v9 < qword_140C68160 || v9 >= qword_140C68160 + 2048) && (unsigned int)MiCheckSlabPfnBitmap(a3, 1LL) )
    v88 = 1;
  if ( a4 )
  {
    v87 = 1;
  ...
  while ( 1 )
  {
    if ( *v13 < 0x1000uLL )
      goto LABEL_9;
    v79 = (volatile LONG *)(88 * v11 + 2976 + a1);
    if ( *v13 >= 0x2000uLL )
      break;
    if ( (unsigned int)ExTryAcquireSpinLockExclusiveAtDpcLevel(v79) )
      goto LABEL_10;
LABEL_9:
    ++v12;
    v13 += 8;
  ...
  ExAcquireSpinLockExclusiveAtDpcLevel(v79);
LABEL_10:
  if ( v12 != 2 )
  {
    v80 = v11 + 8LL * v12;
...
LABEL_12:
  ...
  v19 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v17 + 40) >> 43) & 0x3FFLL));
  v105 = v17;
  v99 = v17;
  v97 = v19;
...
LABEL_27:
      ...
      if ( _interlockedbittestandset64((volatile signed __int32 *)(v33 + 24), 0x3FuLL) )
        goto LABEL_157;
      if ( v86 != -1LL && !v5 && (*(_BYTE *)(v33 + 35) & 8) == 0 )
      {
      ...
      *((_QWORD *)v39 + 2) = v33;
      if ( !v89 )
      {
        ...
        if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
        {
          ...
          v30 = v90;
          v40 = (volatile signed __int64 *)(v33 + 24);
          v26 = v85;
        ...
        else
        {
          ...
          if ( v82 != v113 )
          {
            ...
            LOBYTE(v29) = -1;
            ExpWaitForSpinLockSharedAndAcquire(a2 + 32, v29);
            v30 = v90;
            v26 = v85;
            v29 = StandbyLookaside;
            v25 = (_BYTE *)a5;
...
LABEL_157:
      ...
      {
        if ( v30 )
          v31 = (8LL * (*(_DWORD *)(v33 + 36) & 0xFFE00000)) | (((*(_QWORD *)v33 >> 20) | *(_QWORD *)(v33 + 40) & 0xF80000000000000uLL) >> 20);
        else
          v31 = *(_QWORD *)v33 & 0xFFFFFFFFFFLL;
      }
      else
      {
LABEL_122:
        v31 = *(_QWORD *)(v33 + 40) & 0xFFFFFFFFFFLL;
      }
      ...
      {
        v41 = 48 * v31 - 0x220000000000LL;
      }
      for ( i = 0LL; i < 4; ++i )
      {
        if ( v34[8] && v41 == *(_QWORD *)v34 )
          goto LABEL_49;
        v34 += 24;
      }
    ...
    for ( j = v48 + 11520; ; v51 = j )
    {
      if ( v44 == -1LL || v50 != 1 )
      {
        ...
        *(_QWORD *)(v53 + 8 * v54) = v93;
        if ( v55 != -1LL && (v55 < qword_140C68160 || v55 >= qword_140C68160 + 2048) )
        {
          v108 = 0LL;
          v110 = 0LL;
          ...
          v107 = *(_QWORD *)(qword_140C673C8 + 8 * ((v56 >> 43) & 0x3FF));
          v62 = dword_140C65A88;
          if ( dword_140C65A84 > (unsigned int)dword_140C65A88
            || (v63 = (char *)qword_140C65AC8 + 16 * dword_140C65A84, v61 < *(_QWORD *)v63)
            || dword_140C65A84 != dword_140C65A88 && v61 >= *((_QWORD *)v63 + 2) )
          {
            v77 = 0;
...
LABEL_176:
            ...
            {
              v78 = (v77 + v62) >> 1;
              v63 = (char *)qword_140C65AC8 + 16 * v78;
              if ( v61 < *(_QWORD *)v63 )
              {
                if ( !v78 )
              ...
              {
                if ( v78 == dword_140C65A88 || v61 < *((_QWORD *)v63 + 2) )
                {
                  dword_140C65A84 = (v77 + v62) >> 1;
                  break;
                }
                v77 = v78 + 1;
              }
...
LABEL_82:
        ...
        if ( v93 != -1LL && (v93 < qword_140C68160 || v93 >= qword_140C68160 + 2048) )
        {
          v75 = 8LL;
          v76 = *(_QWORD *)(v105 + 16);
          if ( (v76 & 0x400) == 0 )
            v75 = v47;
          *(_QWORD *)(v105 + 16) = v76 | v75;
        }
        _InterlockedIncrement64((volatile signed __int64 *)(a1 + 8 * (v106 + 8 * v46) + 15616));
        if ( v50 == 1 && (v88 || (unsigned int)MiIsDecayPfn()) )
          return;
        v45 = v91;
      }
      ++v50;
  ...
  {
    *v25 = 1;
    MiReleasePageListLock(a2, v25, v31);
    v25 = (_BYTE *)a5;
    v26 = v85;
    *(_BYTE *)a5 = 0;
  }
