/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1409BD7CC
 * Callers:
 *     ExpRefreshTimeZoneInformation @ 0x14083EB98 (ExpRefreshTimeZoneInformation.c)
 *     RtlSetDynamicTimeZoneInformation @ 0x1409BD790 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1409BD7B0 (RtlSetTimeZoneInformation.c)
