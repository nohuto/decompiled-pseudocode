/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1409BD9CC
 * Callers:
 *     ExpRefreshTimeZoneInformation @ 0x14083EE98 (ExpRefreshTimeZoneInformation.c)
 *     RtlSetDynamicTimeZoneInformation @ 0x1409BD990 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1409BD9B0 (RtlSetTimeZoneInformation.c)
