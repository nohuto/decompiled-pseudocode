...
__int64 __fastcall MiReleasePartitionHugeIoSpace(ULONG_PTR BugCheckParameter2)
{
  ...
  do
  {
    ...
    v4 = ExAcquireSpinLockShared(&dword_140C67310);
    v5 = (_QWORD *)qword_140C67360;
    v6 = v4;
    v7 = 0LL;
    while ( v5 )
    {
    ...
    while ( v7 )
    {
      ...
      if ( ((*(_QWORD *)(qword_140C67DF0 + 8LL * (v9[3] & 0x3FFFFF)) >> 4) & 0x7FFLL) == *(_WORD *)BugCheckParameter2 )
      {
        ...
        v6 = ExAcquireSpinLockShared(&dword_140C67310);
        v7 = 0LL;
        for ( i = (_QWORD *)qword_140C67360; i; i = (_QWORD *)*i )
          v7 = i;
      }
    }
