...
__int64 __fastcall MiRemoveWsleList(__int64 a1, __int64 a2, _BYTE *a3, unsigned __int64 a4)
{
  ...
  if ( v62 )
    _InterlockedExchangeAdd((volatile signed __int32 *)&xmmword_140C65950, -v62);
  v26 = -v12;
  v75 = v26;
  if ( v63 )
    _InterlockedExchangeAdd((_DWORD *)&xmmword_140C65950 + 1, -v63);
  v27 = 0LL;
  v28 = 0LL;
...
LABEL_26:
      ...
      if ( v34 == 7 )
      {
        ...
        v43 = *(_QWORD *)(qword_140C673C8 + 8 * v42);
