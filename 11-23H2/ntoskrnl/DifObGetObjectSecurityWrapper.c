/*
 * XREFs of DifObGetObjectSecurityWrapper @ 0x1405E8A80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  *((_QWORD *)&v19 + 1) = Object;
  *(_QWORD *)&v19 = SecurityDescriptor;
  *((_QWORD *)&v18 + 1) = MemoryAllocated;
...
LABEL_17:
  result = ObGetObjectSecurity(Object, SecurityDescriptor, MemoryAllocated);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
