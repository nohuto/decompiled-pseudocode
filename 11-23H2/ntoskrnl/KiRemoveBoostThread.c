/*
 * XREFs of KiRemoveBoostThread @ 0x1402BB250
 * Callers:
 ...
 *     KiGetCurrentScheduledThreadProcessor @ 0x140577260 (KiGetCurrentScheduledThreadProcessor.c)
 *     KiGetThreadHeteroRunningType @ 0x140577278 (KiGetThreadHeteroRunningType.c)
 */
