/*
 * XREFs of DifIoGetDeviceToVerifyWrapper @ 0x1405DFDF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoGetDeviceToVerifyWrapper(__int64 a1)
{
  ...
  v15 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(181);
