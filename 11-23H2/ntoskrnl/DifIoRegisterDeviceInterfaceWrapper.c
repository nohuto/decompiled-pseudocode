/*
 * XREFs of DifIoRegisterDeviceInterfaceWrapper @ 0x1405E0F70
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifIoRegisterDeviceInterfaceWrapper(
...
LABEL_8:
  ...
  *(_QWORD *)&v20 = 0LL;
LABEL_10:
  *(_QWORD *)&v22 = PhysicalDeviceObject;
  *((_QWORD *)&v21 + 1) = InterfaceClassGuid;
  *(_QWORD *)&v21 = ReferenceString;
  *((_QWORD *)&v20 + 1) = SymbolicLinkName;
...
LABEL_17:
  result = IoRegisterDeviceInterface(PhysicalDeviceObject, InterfaceClassGuid, ReferenceString, SymbolicLinkName);
  DWORD2(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
