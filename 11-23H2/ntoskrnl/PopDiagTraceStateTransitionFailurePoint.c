/*
 * XREFs of PopDiagTraceStateTransitionFailurePoint @ 0x140991AA4
 * Callers:
    ...
    if ( (_BYTE)v2 )
    {
      if ( v7 > 5 )
      {
        ...
        if ( (_BYTE)v2 )
        {
          ...
          v16 = 0x1000000LL;
          v35 = 8;
          LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(v9, (unsigned __int8 *)&dword_14002DD4C, 0LL, 0LL, 6u, &v24);
        }
      }
    }
  }
