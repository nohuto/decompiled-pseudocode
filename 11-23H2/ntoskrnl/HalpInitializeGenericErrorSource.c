/*
 * XREFs of HalpInitializeGenericErrorSource @ 0x140A8AE9C
 * Callers:
...
__int64 __fastcall HalpInitializeGenericErrorSource(int a1, __int64 a2)
{
  ...
  if ( !*(_BYTE *)(a2 + 64) )
  {
    ...
    *((_QWORD *)P + 2) = MEMORY[0xFFFFF78000000320];
    if ( inited < 0 )
      return v4;
    v12 = (_QWORD *)qword_140C61C28;
    if ( *(__int64 **)qword_140C61C28 == &HalpGenericPolledErrorSourceListHead )
    {
      v13 = HalpGenericPollingInitDone == 0;
      *v11 = &HalpGenericPolledErrorSourceListHead;
      v11[1] = v12;
      *v12 = v11;
      qword_140C61C28 = (__int64)v11;
      if ( v13 )
      {
  ...
  if ( *(_BYTE *)(a2 + 64) != 4 )
  {
    switch ( *(_BYTE *)(a2 + 64) )
    {
      case 8:
        ...
        if ( v20 >= 0 )
        {
          v21 = (_QWORD *)qword_140C61B08;
          if ( *(__int64 **)qword_140C61B08 != &HalpGenericSeaErrorSourceListHead )
            goto LABEL_59;
          v22 = P;
          *(_QWORD *)P = &HalpGenericSeaErrorSourceListHead;
          v22[1] = v21;
          *v21 = v22;
          qword_140C61B08 = (__int64)v22;
        }
      ...
      case 9:
        ...
        if ( v17 >= 0 )
        {
          v18 = (_QWORD *)qword_140C61AF8;
          if ( *(__int64 **)qword_140C61AF8 != &HalpGenericSeiErrorSourceListHead )
            goto LABEL_59;
          v19 = P;
          *(_QWORD *)P = &HalpGenericSeiErrorSourceListHead;
          v19[1] = v18;
          *v18 = v19;
          qword_140C61AF8 = (__int64)v19;
        }
      ...
      case 0xA:
        ...
        if ( (v4 & 0x80000000) != 0 )
          return v4;
        v16 = (_QWORD *)qword_140C61AE8;
        if ( *(__int64 **)qword_140C61AE8 == &HalpGenericPeiErrorSourceListHead )
        {
          *v15 = &HalpGenericPeiErrorSourceListHead;
          v15[1] = v16;
          *v16 = v15;
          qword_140C61AE8 = (__int64)v15;
          goto LABEL_18;
        }
        goto LABEL_59;
      default:
...
LABEL_18:
  ...
  if ( *v6 != -1 )
  {
    ...
    if ( v7 )
    {
      v8 = (_QWORD *)qword_140C61C48;
      if ( *(__int64 **)qword_140C61C48 == &HalpGenericNmiErrorSourceListHead )
      {
        *v5 = &HalpGenericNmiErrorSourceListHead;
        v5[1] = v8;
        *v8 = v5;
        qword_140C61C48 = (__int64)v5;
LABEL_15:
