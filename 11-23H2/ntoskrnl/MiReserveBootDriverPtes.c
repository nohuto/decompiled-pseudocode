/*
 * XREFs of MiReserveBootDriverPtes @ 0x140B5E38C
 * Callers:
...
__int64 __fastcall MiReserveBootDriverPtes(unsigned __int64 a1, int a2)
{
  ...
  if ( qword_140C65940 )
  {
    v8 = *((_QWORD *)qword_140C65940 + 1);
    v9 = v8 + 8LL * *((unsigned int *)qword_140C65940 + 4);
    if ( v6 <= v9 )
    {
      RtlSetBits((PRTL_BITMAP)qword_140C65940 + 1, (__int64)(a1 - v8) >> 3, v3);
      return 1LL;
    }
    if ( a1 >= v9 )
      v5 = 0LL;
    else
      v7 = *((_QWORD *)qword_140C65940 + 1);
  }
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v12->SizeOfBitMap = qword_140C65940;
    qword_140C65940 = v12;
    return 1LL;
  }
  return result;
