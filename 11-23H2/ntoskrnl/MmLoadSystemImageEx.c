/*
 * XREFs of MmLoadSystemImageEx @ 0x140703DC0
 * Callers:
 ...
 *     MiLoadImportDll @ 0x140810DA8 (MiLoadImportDll.c)
 *     IopLoadCrashdmpImage @ 0x1408648C0 (IopLoadCrashdmpImage.c)
 ...
 *     MiValidateStrongCodeDriverImage @ 0x14062C9D0 (MiValidateStrongCodeDriverImage.c)
 ...
 *     MiFinalizeDriverCfgState @ 0x1407E3028 (MiFinalizeDriverCfgState.c)
 *     MiBackSingleImageWithPagefile @ 0x140871C24 (MiBackSingleImageWithPagefile.c)
...
LABEL_12:
    ...
    if ( (v10 & 2) == 0 || dword_140C6987C == v18 )
    {
      v22 = v64;
    }
    else if ( (v10 & 1) != 0 )
    ...
    if ( !v60 )
    {
      _InterlockedExchangeAdd(&dword_140C699D0, v14);
      v17 = (unsigned int *)P;
      v8 = v62;
    }
    v24 = 0LL;
    ...
    if ( (v7 & 0x40000021) == 0 )
    {
      ...
      if ( (unsigned int)MiUseLargeDriverPage(&String1) )
      {
        ...
        if ( v25 )
        {
          _InterlockedExchangeAdd((_DWORD *)&xmmword_140C65950 + 3, -v14);
          v17 = (unsigned int *)P;
          v8 = v62;
...
LABEL_48:
          ...
          if ( v31
            || (v60 = 0,
                VfDriverLoadImage(v17, v34, 0LL),
                v57 |= 2u,
                Image = KseDriverLoadImage((__int64)v17, &v60),
                Image >= 0)
            && (Image = MiApplyImportOptimizationToRuntimeDriver(v17, v32, v7), Image >= 0) )
          {
            ...
            {
              Image = MiHandleDriverNonPagedSections(v17, v7, 1LL);
              if ( Image >= 0 )
              {
                if ( (v10 & 2) != 0 )
                ...
                if ( Image >= 0 )
                {
                  ...
                  if ( v63 )
                  {
                    ...
                    if ( (qword_140C69880 & 1) != 0 && (v17[49] & 0x400) == 0 )
                    {
                      RtlInitUnicodeString(&DestinationString, 0LL);
                      v53 = v17[39];
                      v68 = v17[30];
                      v60 = v53;
                      HotPatchRecord = MiFindHotPatchRecord((int)&xmmword_140C69830, 0, v68, v53, &DestinationString);
                      v55 = HotPatchRecord;
                      if ( HotPatchRecord >= 0 )
                      {
...
LABEL_124:
                  ...
                  {
                    Image = MiApplyRequiredSessionDriverHotPatches((__int64)v17);
                    v43 = Image < 0;
                    goto LABEL_96;
                  }
                  MiDriverLoadSucceeded((__int64)v17, (__int64)Object, a1, (__int64)v72, (__int64)&String1, v35);
                  LOBYTE(v14) = v57 | 8;
LABEL_61:
                  Lock = v59;
...
LABEL_62:
                  ...
                  if ( Image < 0 )
                  {
                    if ( v17 )
                    {
                      ...
                      MiUnloadSystemImage((__int64)v17, v14);
                    }
    ...
    Image = MiConstructLoaderEntry((_DWORD)v17, (unsigned int)&String1, (unsigned int)v72, v7, v8, (__int64)&v70);
    if ( Image >= 0 )
    {
      MiUpdateDriverLoadInProgress((__int64)v17, 1);
      LOBYTE(v10) = v10 & 0xF7;
