/*
 * XREFs of MmLoadSystemImageEx @ 0x140703FD0
 * Callers:
 ...
 *     IopLoadCrashdmpImage @ 0x140864B00 (IopLoadCrashdmpImage.c)
 ...
 *     MiValidateStrongCodeDriverImage @ 0x14062CF20 (MiValidateStrongCodeDriverImage.c)
