/*
 * XREFs of IopInitializePlugPlayServices @ 0x140B3E904
 * Callers:
 ...
 *     PnpInitializeNotification @ 0x140B6DB7C (PnpInitializeNotification.c)
 ...
 *     PpProfileInit @ 0x140B74C3C (PpProfileInit.c)
  ...
  *(_DWORD *)(&GuidString.MaximumLength + 1) = 0;
  ...
  else
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    qword_140C5CA48 = 0LL;
    qword_140C5CA08 = (__int64)&PnpDeviceCompletionQueue;
    *(_QWORD *)&PnpDeviceCompletionQueue = &PnpDeviceCompletionQueue;
    dword_140C5CA10 = 0;
    qword_140C5CA38 = (__int64)&qword_140C5CA30;
    qword_140C5CA30 = (__int64)&qword_140C5CA30;
    qword_140C5CA20 = (__int64)&qword_140C5CA18;
    qword_140C5CA18 = (__int64)&qword_140C5CA18;
    byte_140C5CA28 = 5;
    byte_140C5CA2A = 8;
    dword_140C5CA2C = 0;
    dword_140C5CA40 = 0x7FFFFFFF;
    ...
    if ( result >= 0 )
    {
      ...
      ArbInitializeOsInaccessibleRange((unsigned int)dword_140C65AE0);
      ...
      *(_DWORD *)&v26.Length = 1572886;
      if ( (int)IopCreateRegistryKeyEx(&Handle, v30, &v26, 0xF003Fu, 0, 0LL) >= 0 )
      {
        ...
        qword_140C5D5F0 = (__int64)PipUpdateAsyncOptionsCallback;
        qword_140C5D5F8 = (__int64)Handle;
      ...
      *(_DWORD *)&v26.Length = 4063292;
      ...
      if ( IopOpenRegistryKeyEx(&Handle, 0LL, &v26, 0x20019u) >= 0 )
      {
        ...
        {
          qword_140C5D630 = (__int64)PipUpdateSetupInProgressCallback;
          qword_140C5D638 = (__int64)Handle;
      ...
      CmSetDeviceRegProp(
        *(__int64 *)&PiPnpRtlCtx,
        ...
        0);
      ZwClose(v16);
      qword_140C5CA88 = (__int64)&IopPendingEjects;
      IopPendingEjects = (__int64)&IopPendingEjects;
      qword_140C5CA98 = (__int64)&IopPendingSurpriseRemovals;
      ...
      qword_140C5B3F8 = (__int64)&PnpEnumerationRequestList;
