/*
 * XREFs of ExAllocateHeapPool @ 0x1402AD2E0
 * Callers:
 *     ExpAllocatePoolWithTagFromNode @ 0x1402AD250 (ExpAllocatePoolWithTagFromNode.c)
 * Callees:
 *     RtlpHpVsContextMultiAlloc @ 0x140249DB0 (RtlpHpVsContextMultiAlloc.c)
...
LABEL_156:
  ...
  if ( (unsigned int)v6 >= dword_140C749E0 )
    LODWORD(v6) = (_DWORD)v5;
  v16 = &qword_140C74A00[1048 * (unsigned int)v6];
  if ( v13 < NonPagedPool )
  {
    v18 = v16[3];
  }
...
LABEL_26:
  ...
  v23 = v21;
  if ( (v21 || (v23 = qword_140C6B2E8) != 0) && v20 > v23 )
  {
    v88 = *(_QWORD *)(v18 + 56);
    if ( !v88 )
    {
