/*
 * XREFs of PsCheckProcessFileSigningLevel @ 0x1409B0810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PsCheckProcessFileSigningLevel(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( qword_140C379E0 )
  {
    LOBYTE(v6) = v20;
    LOBYTE(v5) = v2;
    if ( (unsigned int)qword_140C379E0(v6, v5) )
    {
      Section = 0;
      goto LABEL_25;
    }
...
LABEL_2:
  ...
  *((_QWORD *)&v17 + 1) = v2;
  ...
  if ( (int)PsQuerySectionSignatureInformation((_KPROCESS *)a1, &v20) >= 0 )
  {
    if ( qword_140C379E0 && (LOBYTE(v13) = v20, LOBYTE(v12) = v2, (unsigned int)qword_140C379E0(v13, v12)) )
      Section = 0;
    else
      Section = -1073740760;
    goto LABEL_21;
