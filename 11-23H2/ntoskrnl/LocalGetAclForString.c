...
LABEL_61:
          v42 = v96;
LABEL_62:
          v43 = RtlpAddKnownAce((int)*a3, 2, v42, v99, P, v93);
LABEL_63:
          v44 = v43;
LABEL_64:
          if ( v44 < 0 )
        ...
        if ( !v59 )
        {
          v43 = RtlAddAccessAllowedObjectAce((int)*a3, 4, v96, v99, v107[0], v105, P);
          goto LABEL_63;
        }
        v60 = v59 - 1;
        if ( !v60 )
        {
          v43 = RtlAddAccessDeniedObjectAce((int)*a3, 4, v96, v99, *(__int64 *)v107, v105, P);
          goto LABEL_63;
        }
        v61 = v60 - 1;
        if ( !v61 )
        {
          v43 = RtlAddAuditAccessObjectAce((int)*a3, *(__int64 *)v107, v105, P, v96 & 0x40, v96 & 0x80);
          goto LABEL_63;
        }
        if ( v61 != 2 )
          goto LABEL_178;
            ...
            if ( !v70 && *((_BYTE *)P + 1) == 1 && !*((_DWORD *)P + 2) )
            {
              ...
              if ( v71 )
              {
                ...
                *((_WORD *)v71 + 1) = v39;
                ...
                {
LABEL_213:
                  v44 = RtlAddAce(*a3, 2u, 0xFFFFFFFF, v71, v39);
...
LABEL_74:
        ...
        {
          v69 = SddlAddScopedPolicyIDAce((int)*a3, v41, v96, v99, P);
        }
      }
      else
      {
...
LABEL_211:
    ...
    if ( v39 >= 0xFFFF )
      goto LABEL_246;
    v45 = P;
    v44 = RtlAddAccessAllowedObjectAce((int)*a3, 4, v96, v99, v107[0], v105, P);
    if ( v44 < 0 )
      goto LABEL_247;
