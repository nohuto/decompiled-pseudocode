/*
 * XREFs of PopDiagTraceInvalidBootStat @ 0x140B9646C
 * Callers:
...
void __fastcall PopDiagTraceInvalidBootStat(int a1, int a2)
{
  ...
  if ( dword_140C03950 && tlgKeywordOn((__int64)&dword_140C03950, 0x800000000000LL) && v5 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03950, v4) )
    {
      v16 = 0;
      v19 = 0;
      v22 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&word_1400305FE,
        0LL,
        0LL,
        7u,
        &v13);
