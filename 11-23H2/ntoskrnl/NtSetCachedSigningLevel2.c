/*
 * XREFs of NtSetCachedSigningLevel2 @ 0x1407FF5D0
 * Callers:
 *     NtSetCachedSigningLevel @ 0x1407FF5A0 (NtSetCachedSigningLevel.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x140429C20 (_guard_dispatch_icall.c)
 *     memmove @ 0x140435700 (memmove.c)
 *     RtlUnicodeStringValidateEx @ 0x1405A70C8 (RtlUnicodeStringValidateEx.c)
...
LABEL_8:
    ...
    v15 = ((__int64 (__fastcall *)(__int64, __int64, __int64, PVOID))qword_140C37A88)(a1, a5, v14, P);
LABEL_28:
    v12 = v15;
    goto LABEL_76;
  }
    ...
    if ( (a1 & 4) == 0 )
    {
      ...
      if ( !qword_140C379E0
        || (LOBYTE(a2) = (__int64)Process[2].Header.WaitListHead.Flink & 0xF,
            ...
            !(unsigned int)qword_140C379E0(Process, a2)) )
      {
        v10 = v17;
      }
      v7 = (size_t)a3;
...
LABEL_74:
      ...
      v15 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, __int64, UNICODE_STRING *, unsigned int, __int64, PCUNICODE_STRING))qword_140C379A8)(
              v8 & 0x807,
              v23,
              v20,
              v21,
