...
NTSTATUS __fastcall MmDuplicateMemory(__int64 a1)
{
  ...
  *(_QWORD *)&v21 = a1;
  ...
  if ( result >= 0 )
  {
    ...
    v8 = KeAbPreAcquire((__int64)&qword_140C67388, 0LL);
    v9 = v8;
    if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C67388, 0LL) )
      ExfAcquirePushLockExclusiveEx(&qword_140C67388, v8, (__int64)&qword_140C67388);
    if ( v9 )
      *(_BYTE *)(v9 + 18) = 1;
    MiLockDynamicMemoryExclusive((__int64)MiSystemPartition, (__int64)CurrentThread);
    _InterlockedIncrement(&dword_140C698E0);
...
LABEL_60:
      dword_140C67E4C = 0;
      if ( BYTE4(v22) )
        _InterlockedAdd(&dword_140C696DC, 0xFFFFFFFF);
      if ( qword_140C67E88 )
        qword_140C67E88 = 0LL;
      if ( v2 != 17 )
      {
      ...
      if ( v6 )
      {
        stru_140C67E68.Parameter = (void *)HIDWORD(v21);
        ExQueueWorkItem(&stru_140C67E68, HyperCriticalWorkQueue);
      }
      else
      {
        _InterlockedAdd(&dword_140C698E0, 0xFFFFFFFF);
        KeSetEvent(&stru_140C67E50, 0, 0);
      }
    ...
    MiActOnMirrorBitmap((__int64)&xmmword_140C67EA0, 1);
    v11 = 1;
    LODWORD(v22) = 0;
    if ( (BYTE8(v21) & 1) != 0 )
    {
...
LABEL_35:
      ...
      v4 = KeGetCurrentIrql();
      if ( *(_QWORD *)(a1 + 24) )
        MiActOnMirrorBitmap((__int64)xmmword_140C67E90, 1);
      if ( v4 < 2u )
      {
      ...
      qword_140C67E88 = (__int64)CurrentThread;
      if ( BYTE4(v22) )
      {
        _InterlockedAdd(&dword_140C696DC, 0xFFFFFFFF);
        BYTE4(v22) = 0;
      ...
      if ( v10 < 0
        ...
        || (v15 = (*(__int64 (__fastcall **)(__int64))(a1 + 8))(1LL), qword_140C67E88 = 0LL,
                                                                      v10 = v15,
                                                                      v15 != 1073742484)
        || v11 )
      {
