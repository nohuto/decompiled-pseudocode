/*
 * XREFs of MiCopyVirtualMemory @ 0x1406F7910
 * Callers:
 ...
 *     MiGetExceptionInfo @ 0x140626898 (MiGetExceptionInfo.c)
...
LABEL_7:
    ...
    while ( 1 )
    {
      ...
      if ( (v10 & 0xFFFFFFFFFFFFF000uLL) != 0x7FFE0000 && (v40 != qword_140C65A38 || !qword_140C65A38)
        || (v20 = v50, (*(_DWORD *)(v50 + 2172) & 1) != 0) )
      {
        ...
        v19 = (((*((unsigned int *)v41 + 7) | ((unsigned __int64)*((unsigned __int8 *)v41 + 33) << 32)) << 12) | 0xFFF)
            + 1;
        v16 = v45;
        v49 = v45;
        v18 = v47;
...
LABEL_13:
      ...
      v22 = 0;
      if ( v17 && (v17[6] & 0x6200000) == 0x4200000 )
      {
        v42 = *((_DWORD *)v17 + 16);
        if ( (v42 & 4) != 0 )
          v22 = 2 - ((v42 & 1) != 0);
      }
      else if ( (v13 & 0x10) != 0 && v17 && (v17[6] & 0x70) == 0x10 )
      {
...
LABEL_40:
      if ( v17 )
        MiUnlockAndDereferenceVadShared((char *)v17);
      if ( v26 < 0 )
      {
        if ( (v13 & 2) == 0 )
          goto LABEL_123;
...
LABEL_45:
          ...
          if ( ((unsigned __int64)v63 & 0xFFFFFFFFFFFFF000uLL) != 0x7FFE0000
            && (v29 != qword_140C65A38 || !qword_140C65A38)
            || (*(_DWORD *)(v50 + 2172) & 1) != 0 )
          {
...
LABEL_51:
          ...
          if ( v15 > v34 )
            v15 = v34;
          v35 = 0;
          if ( v30 && (v30[6] & 0x6200000) == 0x4200000 )
          {
            v44 = *((_DWORD *)v30 + 16);
            if ( (v44 & 4) != 0 )
              v35 = 2 - ((v44 & 1) != 0);
          }
          else if ( (v13 & 0x10) != 0 && v30 && (v30[6] & 0x70) == 0x10 )
          {
...
LABEL_69:
            if ( (v13 & 2) != 0 )
              MmUnlockPages(p_MemoryDescriptorList);
            if ( v30 )
              MiUnlockAndDereferenceVadShared((char *)v30);
            v12 = a5;
LABEL_116:
            KiUnstackDetachProcess(&v73);
            if ( v59 )
