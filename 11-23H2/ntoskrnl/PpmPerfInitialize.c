/*
 * XREFs of PpmPerfInitialize @ 0x140B64B2C
 * Callers:
...
__int64 PpmPerfInitialize()
{
  ...
  stru_140C3E950.Parameter = 0LL;
  stru_140C3E950.List.Flink = 0LL;
  ...
  stru_140C3E950.WorkerRoutine = (void (__fastcall *)(void *))PpmMediaBufferingWorker;
