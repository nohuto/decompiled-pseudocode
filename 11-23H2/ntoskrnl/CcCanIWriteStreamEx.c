...
LABEL_28:
      ...
      if ( (_BYTE)dword_140D1D1EC )
        v23 = 0x4000LL;
      if ( qword_140C6F780 < v23 )
      {
        v43 = (unsigned __int16 **)&unk_140C6CED8;
        while ( 1 )
        {
          v44 = *v43;
          v45 = 0;
          if ( dword_140C65AFC )
            break;
LABEL_94:
          if ( (__int64)++v43 > (__int64)&qword_140C6CEE0 )
          {
            if ( qword_140C6F900 < (unsigned __int64)(qword_140C6F9E0 + 800) )
