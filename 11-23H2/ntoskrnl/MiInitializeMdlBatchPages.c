...
__int64 __fastcall MiInitializeMdlBatchPages(__int64 a1)
{
  ...
  do
  {
    ...
    if ( dword_140C65A84 > (unsigned int)dword_140C65A88
      || (v12 = (char *)qword_140C65AC8 + 16 * dword_140C65A84, v11 < *(_QWORD *)v12)
      || dword_140C65A84 != dword_140C65A88 && v11 >= *((_QWORD *)v12 + 2) )
    {
      v29 = 0;
...
LABEL_75:
      ...
      {
        v30 = (v29 + v10) >> 1;
        v12 = (char *)qword_140C65AC8 + 16 * v30;
        if ( v11 < *(_QWORD *)v12 )
        {
          if ( !v30 )
        ...
        {
          if ( v30 == dword_140C65A88 || v11 < *((_QWORD *)v12 + 2) )
          {
            dword_140C65A84 = (v29 + v10) >> 1;
            break;
          }
          v29 = v30 + 1;
        }
