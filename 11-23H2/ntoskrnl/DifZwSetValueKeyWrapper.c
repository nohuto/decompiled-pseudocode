/*
 * XREFs of DifZwSetValueKeyWrapper @ 0x1405F8140
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwSetValueKeyWrapper(
        HANDLE KeyHandle,
        ...
        ULONG DataSize)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(648);
...
LABEL_10:
  ...
  *((_QWORD *)&v22 + 1) = __PAIR64__(TitleIndex, Type);
