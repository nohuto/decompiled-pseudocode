/*
 * XREFs of SmKmStoreHelperCommandProcess @ 0x1405CB808
 * Callers:
 ...
 *     ?SmKmProbeAndLockAddress@@YAJPEAX_KPEAU_MDL@@K@Z @ 0x1405CAE3C (-SmKmProbeAndLockAddress@@YAJPEAX_KPEAU_MDL@@K@Z.c)
