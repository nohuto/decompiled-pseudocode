/*
 * XREFs of DifIoCreateNotificationEventWrapper @ 0x1405DECD0
 * Callers:
 *     <none>
 * Callees:
...
PKEVENT __fastcall DifIoCreateNotificationEventWrapper(PUNICODE_STRING EventName, PHANDLE EventHandle)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(156);
...
LABEL_8:
  ...
  *(_QWORD *)&v16 = 0LL;
LABEL_10:
  *(_QWORD *)&v17 = EventName;
  *((_QWORD *)&v16 + 1) = EventHandle;
...
LABEL_17:
  result = IoCreateNotificationEvent(EventName, EventHandle);
  *((_QWORD *)&v17 + 1) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
