/*
 * XREFs of KiSelectIdealProcessorSetForNode @ 0x140224B10
 * Callers:
        ...
        unsigned int *a8)
{
  ...
  for ( i = *(_QWORD *)(a1 + 168);
        v10 < a4;
        v11 = (unsigned int)KiProcessorNumberToIndexMappingTable[64 * v21 + (unsigned int)KiFindBiasedSetMember(i, a5)] )
  {
    Prcb = KeGetPrcb(v11);
