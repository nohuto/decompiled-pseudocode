/*
 * XREFs of SPCallServerHandleRemoveLicense @ 0x140884A7C
 * Callers:
...
__int64 __fastcall SPCallServerHandleRemoveLicense(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 *v7; // rsi
  __int64 v8; // rsi
  unsigned int j; // r8d
  ...
  if ( v19 + 1 >= v19 )
  {
    ...
    if ( *(_DWORD *)a1 > 4u )
    {
      ...
      if ( v12 + 1 >= v12 )
      {
        ...
        if ( v13 )
          v15 = v14;
        v16 = qword_140D533A0 ? qword_140D533A0(v15) : -1073741637;
        v24 = *(_DWORD *)(a2 + 32);
