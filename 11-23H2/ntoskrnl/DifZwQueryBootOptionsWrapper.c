/*
 * XREFs of DifZwQueryBootOptionsWrapper @ 0x1405F3D40
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryBootOptionsWrapper(PBOOT_OPTIONS BootOptions, PULONG BootOptionsLength)
{
...
LABEL_10:
  ...
  *((_QWORD *)&v16 + 1) = BootOptionsLength;
...
LABEL_17:
  result = ZwQueryBootOptions(BootOptions, BootOptionsLength);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
