/*
 * XREFs of MiPerformMemoryChange @ 0x14061C014
 * Callers:
...
void __fastcall MiPerformMemoryChange(__int64 a1, __int64 a2, void **a3, __int64 *a4, int a5, __int64 ***a6)
{
  ...
  v10 = ExAcquireSpinLockExclusive(&dword_140C6B520);
  v11 = *a3;
  v12 = v10;
  v13 = a2 - 1 + a1;
  ...
  *a4 = v18;
  ...
  if ( (a5 & 1) != 0 )
  {
    if ( v13 > qword_140C6F6C8 )
      qword_140C6F6C8 = a2 - 1 + a1;
    if ( (a5 & 0x100008) == 0 )
    {
      qword_140C6F6D0 += a2;
LABEL_14:
