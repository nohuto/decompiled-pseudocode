/*
 * XREFs of MiMapSystemImageWithLargePage @ 0x140A49B64
 * Callers:
 ...
 *     MiRoundUpToPowerOf2SizeT @ 0x1406696B8 (MiRoundUpToPowerOf2SizeT.c)
...
LABEL_13:
  ...
  v18 = v16 + (_DWORD)v14;
  memset(&v14[(unsigned int)v16], 0, (unsigned int)(dword_140C65844 << 12));
