/*
 * XREFs of DifExAcquireResourceExclusiveLiteWrapper @ 0x1405D7620
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall DifExAcquireResourceExclusiveLiteWrapper(PERESOURCE Resource, BOOLEAN a2)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(13);
...
LABEL_17:
  result = ExAcquireResourceExclusiveLite(Resource, a2);
  BYTE8(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
