...
__int64 __fastcall MmGetPageFileForCrashDump(_OWORD *a1)
{
  ...
  v5 = KeAbPreAcquire((__int64)qword_140C6B878, 0LL);
  v6 = _interlockedbittestandset64((volatile signed __int32 *)qword_140C6B878, 0LL);
  v7 = v5;
  if ( v6 )
    ExfAcquirePushLockExclusiveEx(qword_140C6B878, v5, (__int64)qword_140C6B878);
  if ( v7 )
    *(_BYTE *)(v7 + 18) = 1;
  if ( Count )
  {
    v8 = (char *)&unk_140C6F6E0;
    v9 = Count;
    do
    {
      v10 = *(_QWORD *)v8;
