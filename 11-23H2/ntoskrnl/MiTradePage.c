...
LABEL_169:
      ...
      v12 = *(_QWORD *)(v7 + 40);
      if ( *(_QWORD *)(qword_140C673C8 + 8 * ((v12 >> 43) & 0x3FF)) != v4 )
      {
...
LABEL_112:
        ...
        if ( v28 == 3 )
        {
          if ( *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v7 + 40) >> 43) & 0x3FFLL)) == v64 )
          {
            if ( v68 )
...
LABEL_87:
    ...
    if ( v26 != 2 )
    {
      if ( *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v7 + 40) >> 43) & 0x3FFLL)) != v4 )
      {
        ++dword_140C1371C;
        goto LABEL_148;
      }
