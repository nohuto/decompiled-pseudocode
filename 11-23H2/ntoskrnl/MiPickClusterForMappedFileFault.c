...
LABEL_14:
  if ( (v15 & 0x40000000) != 0 )
  {
    ...
    v19 = a3;
    v18 = a4;
    v33 = v23 & (dword_140C696E0 - 1);
    if ( v22 > v12 + 8 * (((unsigned __int64)(unsigned int)(dword_140C696E0 - v33) >> 12) - 1) )
      v22 = v12 + 8 * (((unsigned __int64)(unsigned int)(dword_140C696E0 - v33) >> 12) - 1);
    goto LABEL_16;
  }
LABEL_15:
  v23 = 0;
...
LABEL_16:
  ...
  else
  {
    ...
    {
      v34 = ((unsigned __int64)v23 >> 12) & ((unsigned __int64)(unsigned int)(dword_140C696E0 - 1) >> 12);
      if ( v27 < v12 - 8 * v34 )
        v28 = v12 - 8 * v34;
    }
  }
