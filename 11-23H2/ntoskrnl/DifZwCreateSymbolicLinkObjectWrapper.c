/*
 * XREFs of DifZwCreateSymbolicLinkObjectWrapper @ 0x1405EF430
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwCreateSymbolicLinkObjectWrapper(
        PHANDLE LinkHandle,
        ...
        PUNICODE_STRING LinkTarget)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(523);
...
LABEL_17:
  result = ZwCreateSymbolicLinkObject(LinkHandle, DesiredAccess, ObjectAttributes, LinkTarget);
  DWORD2(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
