  ...
  if ( result >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v1 >= 0 )
    {
      ...
      Data = qword_140CF7B60;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      RtlInitUnicodeString(&DestinationString, L"Height");
      Data = HIDWORD(qword_140CF7B60);
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = 1000000 * qword_140CF7B70 / qword_140C0C9C0;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = 1000000 * qword_140CF7B00 / qword_140C0C9C0;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
      ...
      Data = 1000000 * qword_140CF7B18 / qword_140C0C9C0;
      ZwSetValueKey(Handle, &DestinationString, 0, 4u, &Data, 4u);
