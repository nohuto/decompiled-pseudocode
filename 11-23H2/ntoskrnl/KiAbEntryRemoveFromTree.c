/*
 * XREFs of KiAbEntryRemoveFromTree @ 0x14024B550
 * Callers:
 ...
 *     KiAbTryDecrementIoWaiterCounts @ 0x14033F7F8 (KiAbTryDecrementIoWaiterCounts.c)
 *     RtlRbReplaceNode @ 0x140348C10 (RtlRbReplaceNode.c)
