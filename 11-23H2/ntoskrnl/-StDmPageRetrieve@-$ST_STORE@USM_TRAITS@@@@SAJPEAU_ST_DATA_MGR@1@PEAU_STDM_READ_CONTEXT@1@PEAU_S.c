/*
 * XREFs of ?StDmPageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x1405C6F8C
 * Callers:
 ...
 * Callees:
 *     MmAreMdlPagesCached @ 0x1403D7BC0 (MmAreMdlPagesCached.c)
