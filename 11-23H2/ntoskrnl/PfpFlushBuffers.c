/*
 * XREFs of PfpFlushBuffers @ 0x14074B200
 * Callers:
 ...
 *     PfpLogPageAccess @ 0x14074B510 (PfpLogPageAccess.c)
 *     PfTAcquireLogEntry @ 0x14074BB74 (PfTAcquireLogEntry.c)
 */
...
char PfpFlushBuffers()
{
  ...
  if ( v22[0] < 0 )
    return 0;
  v4 = RtlpInterlockedFlushSList(&stru_140D0C180);
  if ( !v4 )
    return 1;
  do
  {
  ...
  while ( 1 )
  {
    ...
    v27 = HIDWORD(v28);
    v29 = dword_140C64FAC + (((v8 << 8) + v9) >> 10);
    Src = 163851LL;
    PfpCopyEvent(&Src);
    if ( *((int *)&v7->Next + 2) > 1 )
      break;
...
LABEL_16:
  ...
  while ( 1 )
  {
    ...
    v22[0] = 0;
    v19 = PfTAcquireLogEntry(&unk_140C65158, v22, 1LL);
    if ( !v19 )
      break;
