/*
 * XREFs of PfpCopyEvent @ 0x14074AFC0
 * Callers:
...
__int64 __fastcall PfpCopyEvent(__int64 *Src)
{
  ...
  {
    v14 = (v1 >> 2) & 0x3FF;
    v15 = PfTAcquireLogEntry(&unk_140C65158, &v20, v14);
    if ( !v15 )
      return 3221225626LL;
  ...
  *(_QWORD *)&v19 = v6 & 0xFFFFFFFF00FFFFFFuLL | v8 & 0xFFFFFFFFFF000000uLL;
  ...
  if ( !v11 )
    return 3221225864LL;
  v12 = ((qword_140C65198 + 47) & 0xFFFFFFFFFFFFFFF8uLL)
      + 40LL * (*(unsigned __int16 *)(v11 + 10) - (unsigned int)*(unsigned __int16 *)(qword_140C65198 + 36));
