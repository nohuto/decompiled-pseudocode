/*
 * XREFs of MiTrimAllSystemPagableMemory @ 0x140635290
 * Callers:
...
__int64 __fastcall MiTrimAllSystemPagableMemory(int a1, int a2)
{
  ...
  CurrentThread = 0LL;
  v13 = 0;
  if ( _InterlockedIncrement(&dword_140C697C8) <= 1 && KeAreInterruptsEnabled() )
  {
...
LABEL_22:
        ...
        {
          if ( a1 == 1 )
            v15 = *(unsigned __int16 **)(qword_140C673C8 + 8LL * *(unsigned __int16 *)(SessionVm + 174));
          else
...
LABEL_28:
  _InterlockedAdd(&dword_140C697C8, 0xFFFFFFFF);
  if ( v13 )
  {
