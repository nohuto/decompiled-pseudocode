/*
 * XREFs of MiPrefetchVirtualMemory @ 0x1402EE458
 * Callers:
 ...
 *     MiCommitmentAvailable @ 0x1402EEAF8 (MiCommitmentAvailable.c)
...
LABEL_6:
      v14 = *(void **)(qword_140C673C8 + 8 * v13);
      goto LABEL_7;
    }
    return 3221225485LL;
  }
...
LABEL_91:
    ...
    if ( (v19 = *(_QWORD *)v17 + (v43 << 12), LeafVa = v19, v19 >= qword_140C6A558) && v19 <= qword_140C67070
...
LABEL_20:
    v22 = v52;
    if ( (v47 & 0x80u) == 0
      && (!(unsigned int)MiSufficientAvailablePages(v52, 0x120uLL)
       || (unsigned __int64)MiCommitmentAvailable(v52) < 0x1080
       || *(__int64 *)(v52 + 17280) < 288) )
    {
      break;
    }
    if ( (a4 & 0x20000) != 0 )
      MiPrefetchPreallocatePages((unsigned int)v51, (unsigned int)&v37, v52, a3, v17, v19);
    if ( !v8 )
    {
