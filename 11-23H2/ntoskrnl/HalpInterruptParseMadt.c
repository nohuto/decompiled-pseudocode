/*
 * XREFs of HalpInterruptParseMadt @ 0x140379968
 * Callers:
 ...
 *     HalpInterruptSortProcessorTable @ 0x140379ED8 (HalpInterruptSortProcessorTable.c)
    ...
    else if ( v31 == 2 && (_BYTE)v29 == 10 )
    {
      if ( (int)HalpInterruptGsiToLine(*((unsigned int *)v30 + 1), &v92) >= 0 )
      {
        ...
        *(_DWORD *)(v56 + 32) = v62;
        ...
        v63 = (__int64 *)qword_140C60D38;
        if ( *(__int64 **)qword_140C60D38 != &HalpInterruptOverrides )
          __fastfail(3u);
