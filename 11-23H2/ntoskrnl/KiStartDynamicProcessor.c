/*
 * XREFs of KiStartDynamicProcessor @ 0x140973A08
 * Callers:
 ...
 *     KiAllocatePrcbThreads @ 0x140376BB8 (KiAllocatePrcbThreads.c)
 ...
 *     KiUnassignProcessorNumberFromPrcb @ 0x140570F9C (KiUnassignProcessorNumberFromPrcb.c)
