/*
 * XREFs of DifZwAllocateVirtualMemoryWrapper @ 0x1405ED130
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwAllocateVirtualMemoryWrapper(
...
LABEL_8:
  ...
  *(_QWORD *)&v21 = 0LL;
LABEL_10:
  *((_QWORD *)&v21 + 1) = __PAIR64__(AllocationType, Protect);
  *((_QWORD *)&v23 + 1) = ProcessHandle;
  *(_QWORD *)&v23 = BaseAddress;
  *((_QWORD *)&v22 + 1) = ZeroBits;
  *(_QWORD *)&v22 = RegionSize;
