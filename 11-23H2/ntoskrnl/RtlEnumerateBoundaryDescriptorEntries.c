/*
 * XREFs of RtlEnumerateBoundaryDescriptorEntries @ 0x1407C92B8
 * Callers:
 ...
 *     ObpCheckDuplicateEntries @ 0x1407C91FC (ObpCheckDuplicateEntries.c)
 *     ObpCompareEntryLevel1 @ 0x1407C9260 (ObpCompareEntryLevel1.c)
