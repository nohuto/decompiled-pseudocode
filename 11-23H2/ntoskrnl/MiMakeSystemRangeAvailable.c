/*
 * XREFs of MiMakeSystemRangeAvailable @ 0x140212A98
 * Callers:
...
LABEL_34:
    ...
    v13 = (_QWORD *)(qword_140C65AA0 + 104);
    ...
    v8 = (__int64 *)(qword_140C65AA0 + 376LL * v4);
  }
  else
  {
...
LABEL_9:
  ...
  _InterlockedExchangeAdd64(&qword_140C6A348[(int)BugCheckParameter4], -(__int64)v5);
  if ( (_DWORD)BugCheckParameter4 == 8 )
    qword_140C66D08 += BugCheckParameter3;
