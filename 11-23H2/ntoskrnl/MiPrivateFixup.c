...
__int64 __fastcall MiPrivateFixup(unsigned __int64 *a1, __int64 *a2, int a3, __int64 a4, __int64 a5, int a6)
{
  ...
  if ( !v15 || (v12 = *(struct _KTHREAD **)(Process + 1248)) == 0LL )
  {
    ...
    v14 = *(void **)(qword_140C673C8 + 8LL * *(unsigned __int16 *)(v6 + 174));
...
LABEL_6:
    v16 = MiReservePtes((__int64)&qword_140C69940, 1u);
    if ( !v16 )
      return 3221225626LL;
LABEL_7:
    ...
    if ( v16 || v67 < 0xFFFF800000000000uLL )
    {
      ...
      BugCheckParameter3 = MiGetPage(
                             (__int64)v14,
                             (PfnChannel << byte_140C65A8E) | (v19 << byte_140C65A8D) | dword_140C65AF8 & (unsigned int)v17,
                             0);
...
LABEL_56:
        ...
        if ( v16 )
          MiReleasePtes((__int64)&qword_140C69940, (__int64 *)v16, 1u);
        return v44;
      }
    }
