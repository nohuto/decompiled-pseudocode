...
void __fastcall MmLogQueryCombineStats(__int64 a1, unsigned int *a2, _DWORD *a3)
{
  ...
  *((_DWORD *)v6 + 1) = dword_140C6F648;
  *((_QWORD *)v6 + 1) = qword_140C6F630 + qword_140C6F638;
  *((_QWORD *)v6 + 2) = qword_140C6F640;
  v7 = dword_140C6F64C;
  v8 = dword_140C6F64C;
  *((_DWORD *)v6 + 6) = dword_140C6F64C;
  v9 = dword_140C6F650;
  v10 = v7 <= dword_140C6F650;
  *((_DWORD *)v6 + 7) = dword_140C6F650;
  if ( !v10 )
    v8 = v9;
  *((_DWORD *)v6 + 6) = v8;
  if ( v6 == v18 )
