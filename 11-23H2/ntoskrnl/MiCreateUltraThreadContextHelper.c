/*
 * XREFs of MiCreateUltraThreadContextHelper @ 0x1402EC6FC
 * Callers:
...
__int64 __fastcall MiCreateUltraThreadContextHelper(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  v4 = dword_140C6852C;
  if ( dword_140C6852C == dword_140C68528 )
    return 0LL;
  while ( 1 )
  {
    v9 = _InterlockedCompareExchange(&dword_140C6852C, v4 + 1, v4);
    v8 = v4 == v9;
    v4 = v9;
    if ( v8 )
      break;
    if ( v9 == dword_140C68528 )
      return 0LL;
  }
  *(_QWORD *)a1 = 0LL;
  v10 = a2;
  *(__m128i *)(a1 + 8) = _mm_load_si128((const __m128i *)&_xmm_ffffffffffffffffffffffffffffffff);
  ...
  if ( byte_140C65AE9 )
    MiReplenishUltraPageTables((unsigned int)(*(_DWORD *)(a3 + 12) >> byte_140C65A8D));
  v11 = 0LL;
  if ( !v10 )
  {
LABEL_12:
  ...
  if ( v10 )
LABEL_28:
    _InterlockedExchangeAdd64(&qword_140C6F7C0, v10);
  return 0LL;
}
