/*
 * XREFs of MiInitializeBootKernelShadowStacks @ 0x1403B5FEC
 * Callers:
 *     MiInitSystem @ 0x140B44518 (MiInitSystem.c)
 * Callees:
 *     MiInitializeBootKernelShadowStack @ 0x140644900 (MiInitializeBootKernelShadowStack.c)
...
__int64 __fastcall MiInitializeBootKernelShadowStacks(__int64 a1)
{
  ...
  if ( (_BYTE)KiKernelCetEnabled || (result = *(_QWORD *)(a1 + 240), *(_QWORD *)(result + 3728)) )
  {
    ...
    while ( v4 );
    return MiInitializeBootShadowStackPage(
             ((*(_QWORD *)(*(_QWORD *)(a1 + 240) + 3728LL) >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL,
             1LL);
  }
  return result;
}
