/*
 * XREFs of IopSynchronousServiceTail @ 0x1406E3E90
 * Callers:
 *     IopQueueCopyWrite @ 0x14036BC90 (IopQueueCopyWrite.c)
 ...
 *     NtQueryDirectoryFileEx @ 0x1407657E0 (NtQueryDirectoryFileEx.c)
...
LABEL_28:
  ...
  if ( v53 && v18 != 259 )
  {
    ...
    else
    {
      ...
      __writecr8(1uLL);
      IopCompleteRequest((char **)(a2 + 120), (__int64)&v57, &DeviceObject, (ULONG_PTR *)&FileObject, &DeviceObject);
      if ( KiIrqlFlags )
      {
