/*
 * XREFs of MdlInvariantPostProcessing1 @ 0x1405CF494
 * Callers:
 ...
 *     RtlpComputeCrcInternal @ 0x1403BE6A0 (RtlpComputeCrcInternal.c)
 *     MdlInvariantFindMdlInfo @ 0x1405CF32C (MdlInvariantFindMdlInfo.c)
