/*
 * XREFs of MmAccessFault @ 0x140235440
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( FileExtents == -1073741802 )
    {
      ...
      if ( v45[0] < 0xFFFF800000000000uLL
        && P[1] != (PVOID)qword_140C65A28
        && (!qword_140C65A30 || P[1] != (PVOID)qword_140C65A30) )
      {
        v28 = P[0];
        if ( !P[0] )
        {
...
LABEL_18:
    ...
    v21 = *(_QWORD *)(qword_140C673C8 + 8LL * *(unsigned __int16 *)(v20 + 174));
...
LABEL_59:
    ...
    else
    {
      ...
      v37 = *(_QWORD *)(qword_140C673C8 + 8 * v36);
      if ( (BYTE8(v52) & 0x40) != 0
        || !(unsigned int)MiSufficientAvailablePages(*(_QWORD *)(qword_140C673C8 + 8 * v36), 1056LL, v23, v24)
