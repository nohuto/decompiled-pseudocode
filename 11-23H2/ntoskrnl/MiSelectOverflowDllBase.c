...
__int64 __fastcall MiSelectOverflowDllBase(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( (unsigned int)v3 <= v7 )
  {
    ...
    v15 = KeAbPreAcquire((__int64)&qword_140C65740, 0LL);
    v16 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65740, 0LL);
    v17 = v15;
    if ( v16 )
      ExfAcquirePushLockExclusiveEx(&qword_140C65740, v15, (__int64)&qword_140C65740);
    if ( v17 )
      *(_BYTE *)(v17 + 18) = 1;
    v18 = *v12;
    if ( v4 > v14 - *v12 )
