/*
 * XREFs of MiInitializeSystemDefaults @ 0x140B72778
 * Callers:
...
int __fastcall MiInitializeSystemDefaults(__int64 a1)
{
  ...
  byte_140C699D4 = 4;
  byte_140C65AE9 = KeGetCurrentPrcb()->CpuVendor == 1;
  ...
  {
    byte_140C02463 = 4;
    qword_140C65B40 = 1LL << ((unsigned __int8)KiImplementedPhysicalBits - 1);
