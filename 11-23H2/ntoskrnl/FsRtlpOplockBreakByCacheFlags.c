/*
 * XREFs of FsRtlpOplockBreakByCacheFlags @ 0x1402FE830
 * Callers:
 ...
 *     FsRtlpCheckSharingAgainstOplockOwner @ 0x14093E294 (FsRtlpCheckSharingAgainstOplockOwner.c)
 */
        ...
        char *a16)
{
  ...
  int v24; // edi
  int v25; // eax
  struct _EVENT_DATA_DESCRIPTOR *v26; // rax
  ...
  struct _EVENT_DATA_DESCRIPTOR v194[2]; // [rsp+2B0h] [rbp-9E8h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v203[2]; // [rsp+310h] [rbp-988h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v313; // [rsp+770h] [rbp-528h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v322; // [rsp+7D0h] [rbp-4C8h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v331; // [rsp+830h] [rbp-468h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v340; // [rsp+890h] [rbp-408h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v349; // [rsp+8F0h] [rbp-3A8h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v358; // [rsp+950h] [rbp-348h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v367; // [rsp+9B0h] [rbp-2E8h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v376; // [rsp+A10h] [rbp-288h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v385; // [rsp+A70h] [rbp-228h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v394; // [rsp+AD0h] [rbp-1C8h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v403; // [rsp+B30h] [rbp-168h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v412; // [rsp+B90h] [rbp-108h] BYREF
  ...
  struct _EVENT_DATA_DESCRIPTOR v421; // [rsp+BF0h] [rbp-A8h] BYREF
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v201 = &v92;
    v202 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)word_14002AD02, 0LL, 0LL, 6u, v194);
    v18 = v85;
    LOBYTE(a3) = 0;
    v17 = v88;
  }
  ...
  if ( v24 != 0x4000 && v24 != 20480 && v24 != 0x2000 && v24 != 28672 )
  {
    ...
    if ( (unsigned int)dword_140C03768 > 3 )
    {
      v92 = -1073741597;
      v204 = &v92;
      v205 = 4LL;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_14002ADDC,
        0LL,
        0LL,
        7u,
        v203);
  ...
  if ( *v23 == 1 || (v25 & v24) == 0 )
  {
    ...
    v234 = &v85;
    v235 = 4LL;
    v26 = (struct _EVENT_DATA_DESCRIPTOR *)&v225;
    v27 = (unsigned __int8 *)word_14002AD62;
    goto LABEL_253;
  }
  if ( (a4 & 8) == 0 )
  {
    if ( (unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), *(_QWORD *)(a1 + 8), a4) )
    {
      ...
      v245 = &v87;
      v246 = 4LL;
      v26 = (struct _EVENT_DATA_DESCRIPTOR *)&v236;
      v27 = (unsigned __int8 *)&qword_14002ABB8;
LABEL_253:
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, v27, 0LL, 0LL, 7u, v26);
      return v21;
    }
    v18 = v85;
    LOBYTE(a3) = 0;
  ...
  if ( (*v23 & 0x40) != 0 && (a4 & 0x10010000) != 0 )
  {
    if ( (unsigned int)dword_140C03768 > 3 )
    {
      ...
      v256 = &v166;
      v257 = 4LL;
      v38 = (struct _EVENT_DATA_DESCRIPTOR *)&v247;
      v39 = byte_14002AB4D;
      goto LABEL_82;
    }
    ...
    if ( v29 <= 0x803000 )
    {
      if ( v29 == 8400896 )
      {
        if ( (unsigned int)dword_140C03768 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03768,
            (unsigned __int8 *)byte_14002A8C3,
            0LL,
            0LL,
            6u,
            &v394);
        ...
        if ( (a4 & 0x80u) == 0 && (a4 & 0x10010000) != 0 )
        {
          if ( (unsigned int)dword_140C03768 > 3 )
          {
            ...
            v278 = &v148;
            v279 = 4LL;
            v38 = (struct _EVENT_DATA_DESCRIPTOR *)&v269;
            v39 = byte_14002A6AB;
            goto LABEL_82;
          }
          return (unsigned int)-1073739511;
...
LABEL_208:
      ...
      if ( v29 == 1077312 )
      {
        if ( (unsigned int)dword_140C03768 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03768,
            (unsigned __int8 *)&byte_14002A567,
            0LL,
            0LL,
            6u,
            &v385);
      ...
      if ( v29 != 3174464 )
      {
        if ( v29 == 5271616 )
        {
          if ( (unsigned int)dword_140C03768 > 5 )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C03768,
              (unsigned __int8 *)&dword_14002A5D4,
              0LL,
              0LL,
              6u,
              &v358);
...
LABEL_215:
        if ( (v28 & 0x1000000) == 0 )
        {
          if ( (unsigned int)dword_140C03768 > 2 )
          {
            v135 = a4;
            v413 = (int *)&v135;
            v414 = 4LL;
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C03768,
              (unsigned __int8 *)byte_14002A41D,
              0LL,
              0LL,
              6u,
              &v412);
        ...
        if ( (unsigned int)dword_140C03768 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03768,
            (unsigned __int8 *)byte_14002A2C5,
            0LL,
            0LL,
            6u,
            &v403);
      ...
      if ( (unsigned int)dword_140C03768 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03768,
          (unsigned __int8 *)word_14002A48A,
          0LL,
          0LL,
          6u,
          &v421);
...
LABEL_195:
    ...
    if ( v29 != 8409152 )
    {
      ...
      if ( (unsigned int)dword_140C03768 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03768,
          (unsigned __int8 *)byte_14002A338,
          0LL,
          0LL,
          6u,
          &v313);
    ...
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03768,
        (unsigned __int8 *)byte_14002A4F8,
        0LL,
        0LL,
        6u,
        &v322);
...
LABEL_174:
  ...
  if ( v29 == 1069120 )
  {
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03768,
        (unsigned __int8 *)&word_14002A716,
        0LL,
        0LL,
        6u,
        &v349);
  ...
  if ( v29 > 0x7040 )
  {
    ...
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03768,
        (unsigned __int8 *)&dword_14002A7EC,
        0LL,
        0LL,
        6u,
        v194);
        ...
        if ( (a4 & 8) != 0 || (v69 = FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), v68[3], a4), v18 = v85, !v69) )
        {
          ...
          if ( (a4 & 0x10010000) != 0 )
          {
            if ( (unsigned int)dword_140C03768 > 3 )
            {
              ...
              v267 = &v94;
              v268 = 4LL;
              v38 = (struct _EVENT_DATA_DESCRIPTOR *)&v258;
              v39 = (char *)word_14002A932;
              goto LABEL_82;
            }
            return (unsigned int)-1073739511;
          }
...
LABEL_152:
  ...
  if ( v29 == 28736 )
  {
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03768,
        (unsigned __int8 *)word_14002A782,
        0LL,
        0LL,
        6u,
        &v331);
  ...
  if ( v49 )
  {
    ...
    if ( v50 )
    {
      ...
      if ( (unsigned int)dword_140C03768 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03768,
          (unsigned __int8 *)word_14002A642,
          0LL,
          0LL,
          6u,
          &v367);
...
LABEL_153:
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v347 = &v109;
    v348 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)word_14002AC9A, 0LL, 0LL, 6u, &v340);
    v18 = v85;
    LOBYTE(a3) = 0;
  }
  if ( (v24 & 0x1000) != 0 )
        ...
        if ( (a4 & 8) != 0 || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), *(_QWORD *)(v74 + 48), a4) )
        {
          if ( (a4 & 0x10010000) != 0 )
          {
            if ( (unsigned int)dword_140C03768 > 3 )
            {
              ...
              v223 = &v113;
              v224 = 4LL;
              v38 = (struct _EVENT_DATA_DESCRIPTOR *)&v214;
              v39 = &byte_14002AC2F;
              goto LABEL_82;
            }
            return (unsigned int)-1073739511;
...
LABEL_14:
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v383 = &v146;
    v384 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)byte_14002AA08, 0LL, 0LL, 6u, &v376);
    v18 = v85;
    LOBYTE(a3) = 0;
  }
  if ( v24 == 0x2000 )
      ...
      else
      {
        if ( (a4 & 0x10010000) != 0 )
        {
          if ( (unsigned int)dword_140C03768 > 3 )
          {
            ...
            v289 = &v154;
            v290 = 4LL;
            v38 = (struct _EVENT_DATA_DESCRIPTOR *)&v280;
            v39 = byte_14002A99D;
            goto LABEL_82;
          }
          return (unsigned int)-1073739511;
        ...
        if ( v41[7] )
        {
          if ( (unsigned int)dword_140C03768 > 5 )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C03768,
              (unsigned __int8 *)&dword_14002AADC,
              0LL,
              0LL,
              6u,
              v203);
        ...
        if ( (a4 & 8) != 0 || !(unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), v34[3], a4) )
        {
          if ( (a4 & 0x10010000) != 0 )
          {
            if ( (unsigned int)dword_140C03768 > 3 )
            {
              ...
              v311 = &v162;
              v312 = 4LL;
              v38 = (struct _EVENT_DATA_DESCRIPTOR *)&v302;
              v39 = (char *)&unk_14002A858;
LABEL_82:
              tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)v39, 0LL, 0LL, 7u, v38);
            }
            return (unsigned int)-1073739511;
          }
          if ( v34[7] )
...
LABEL_238:
  ...
  if ( (unsigned int)dword_140C03768 > 3 )
  {
    ...
    v300 = &v158;
    v301 = 4LL;
    v38 = (struct _EVENT_DATA_DESCRIPTOR *)&v291;
    v39 = byte_14002AA71;
    goto LABEL_82;
  }
  return (unsigned int)-1073739511;
