/*
 * XREFs of DifZwFlushInstructionCacheWrapper @ 0x1405F0B00
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwFlushInstructionCacheWrapper(HANDLE ProcessHandle, PVOID BaseAddress, SIZE_T Length)
{
...
LABEL_8:
  ...
  *(_QWORD *)&v18 = 0LL;
LABEL_10:
  *((_QWORD *)&v19 + 1) = ProcessHandle;
  *(_QWORD *)&v19 = BaseAddress;
  *((_QWORD *)&v18 + 1) = Length;
...
LABEL_17:
  result = ZwFlushInstructionCache(ProcessHandle, BaseAddress, Length);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
