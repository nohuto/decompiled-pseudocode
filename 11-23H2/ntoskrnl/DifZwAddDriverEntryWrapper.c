/*
 * XREFs of DifZwAddDriverEntryWrapper @ 0x1405ECEB0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwAddDriverEntryWrapper(PEFI_DRIVER_ENTRY DriverEntry, PULONG Id)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(492);
...
LABEL_17:
  result = ZwAddDriverEntry(DriverEntry, Id);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
