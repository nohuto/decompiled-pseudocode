/*
 * XREFs of KiPerformAutomaticGroupConfiguration @ 0x140B95BCC
 * Callers:
 ...
 *     KiAssignAdjustableSubNodes @ 0x140B95954 (KiAssignAdjustableSubNodes.c)
 *     KiAssignFixedSubNodes @ 0x140B959EC (KiAssignFixedSubNodes.c)
 *     KiShuffleAssignedSubNodes @ 0x140B95DAC (KiShuffleAssignedSubNodes.c)
 */
