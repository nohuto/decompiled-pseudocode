/*
 * XREFs of MiProcessWorkingSets @ 0x14021FA10
 * Callers:
...
__int64 __fastcall MiProcessWorkingSets(__int64 a1, __int64 a2)
{
  ...
  if ( (_UNKNOWN *)a1 == &MiSystemPartition )
  {
    ...
    if ( KeNumberNodes )
    {
      ...
      do
      {
        v9 = _mm_loadu_si128((const __m128i *)((char *)&xmmword_140C673D0 + 8 * v6));
        v10 = (unsigned int)(v6 + 2);
        v6 = (unsigned int)(v6 + 4);
        v7 = _mm_add_epi64(v7, v9);
        v11 = _mm_add_epi64(_mm_loadu_si128((const __m128i *)((char *)&xmmword_140C673D0 + 8 * v10)), v8);
        v8 = v11;
      }
      ...
      {
LABEL_7:
        v13 = (_QWORD *)&xmmword_140C673D0 + v6;
  ...
  if ( *(_QWORD *)&qword_140C698E8
    && **(_DWORD **)&qword_140C698E8 > 5u
    && tlgKeywordOn(*(__int64 *)&qword_140C698E8, 1LL) )
  {
    v89 = *(_BYTE *)(a2 + 2);
    v106[4] = (__int64)&v89;
    v94 = *(_WORD *)(v19 + 2346);
...
LABEL_40:
          ...
          if ( v34 )
            *(_BYTE *)(v90 + 4) = 2;
          v24 = 0LL;
          LockHandle.LockQueue.Lock = &qword_140C697C0;
          LockHandle.LockQueue.Next = 0LL;
          ...
          {
            KiAcquireQueuedSpinLockInstrumented(&LockHandle, &qword_140C697C0);
            goto LABEL_85;
          }
          v36 = _InterlockedExchange64((volatile __int64 *)&qword_140C697C0, (__int64)&LockHandle);
          if ( v36 )
          {
            KxWaitForLockOwnerShip(&LockHandle, v36, &qword_140C697C0, 0LL);
LABEL_85:
            v23 = v90;
            v24 = 0LL;
          }
LABEL_46:
          ...
          *(_WORD *)v31 = v88;
          ...
          v39 = *(_QWORD *)(qword_140C673C8 + 8 * v38) + 16928LL;
          v40 = *(__int64 ***)(*(_QWORD *)(qword_140C673C8 + 8 * v38) + 16936LL);
          if ( *v40 != (__int64 *)v39 )
            goto LABEL_102;
          *v28 = v39;
          v28[1] = (__int64)v40;
