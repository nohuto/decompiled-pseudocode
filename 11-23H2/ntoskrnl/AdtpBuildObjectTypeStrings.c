/*
 * XREFs of AdtpBuildObjectTypeStrings @ 0x140A5BD74
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  v23 = 0LL;
  LOBYTE(v26) = 0;
  RtlInitUnicodeString(DestinationString, &word_14001F044);
  v9 = a6;
  *a6 = 0;
  if ( !(_DWORD)v7 )
    return 0LL;
  ...
  do
  {
    ...
    if ( *(_WORD *)v13 >= 4u )
      v17 = 3;
    appended = AdtpAppendZString((__int64)DestinationString, (__int64)v9, off_14000B078[v17], &v22);
    if ( appended < 0 )
      return (unsigned int)appended;
    v21[0] = 0;
