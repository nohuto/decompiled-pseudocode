/*
 * XREFs of MiEnqueuePageList @ 0x1402DACA0
 * Callers:
...
LABEL_37:
  ...
  if ( dword_140C65A84 > (unsigned int)dword_140C65A88
    || (v17 = (char *)qword_140C65AC8 + 16 * dword_140C65A84, v16 < *(_QWORD *)v17)
    || dword_140C65A84 != dword_140C65A88 && v16 >= *((_QWORD *)v17 + 2) )
  {
    v35 = 0;
...
LABEL_55:
    ...
    {
      v36 = (v35 + v15) >> 1;
      v17 = (char *)qword_140C65AC8 + 16 * v36;
      if ( v16 < *(_QWORD *)v17 )
      {
        if ( !v36 )
          KeBugCheckEx(0x1Au, 0x6200uLL, v16, (ULONG_PTR)qword_140C65AC8, 0LL);
        v15 = v36 - 1;
      }
      else
      {
        if ( v36 == dword_140C65A88 || v16 < *((_QWORD *)v17 + 2) )
        {
          dword_140C65A84 = (v35 + v15) >> 1;
          break;
        }
        v35 = v36 + 1;
      }
  ...
  if ( dword_140C65A84 <= (unsigned int)dword_140C65A88 )
  {
    v21 = (char *)qword_140C65AC8 + 16 * dword_140C65A84;
    if ( v20 >= *(_QWORD *)v21 && (dword_140C65A84 == dword_140C65A88 || v20 < *((_QWORD *)v21 + 2)) )
      goto LABEL_23;
  }
  v37 = 0;
  if ( dword_140C65A88 < 0 )
LABEL_60:
  ...
  {
    v38 = (v37 + v18) >> 1;
    v21 = (char *)qword_140C65AC8 + 16 * v38;
    if ( v20 < *(_QWORD *)v21 )
    {
      if ( !v38 )
        KeBugCheckEx(0x1Au, 0x6200uLL, v20, (ULONG_PTR)qword_140C65AC8, 0LL);
      v18 = v38 - 1;
      goto LABEL_59;
    }
    if ( v38 == dword_140C65A88 || v20 < *((_QWORD *)v21 + 2) )
      break;
    v37 = v38 + 1;
LABEL_59:
    if ( v18 < v37 )
...
LABEL_27:
  if ( *(_QWORD *)(a1 + 16) == 0x3FFFFFFFFFLL )
  {
    ...
    *(_QWORD *)(v5 + 24) = *(_QWORD *)(v5 + 24) & 0xFFFFFF0000000000uLL | 0x3FFFFFFFFFLL;
    if ( *(_DWORD *)(a1 + 8) == 2 )
    {
      MiSetNextStandbyPageSameNodeNoLockAsserts(v5, 0x3FFFFFFFFFLL);
      v33 = *(_QWORD *)(v5 + 24);
