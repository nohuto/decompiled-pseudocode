/*
 * XREFs of KiTpParseInstructionPrefix @ 0x140AF447C
 * Callers:
 *     KiTpParseInstruction @ 0x140AF4450 (KiTpParseInstruction.c)
 * Callees:
 *     KiTpFetchInstructionBytes @ 0x140AF43B4 (KiTpFetchInstructionBytes.c)
 */
