/*
 * XREFs of SepRmCommandServerThread @ 0x14082B780
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SepRmProcessCreationCommandLineAuditSettingsWrkr @ 0x140372B50 (SepRmProcessCreationCommandLineAuditSettingsWrkr.c)
 ...
 *     SepRmCreateLogonSessionWrkr @ 0x1407BD480 (SepRmCreateLogonSessionWrkr.c)
 *     SepRmAddLogonSessionInfoWrkr @ 0x1407C7670 (SepRmAddLogonSessionInfoWrkr.c)
 *     PoRequestShutdownEvent @ 0x14082B900 (PoRequestShutdownEvent.c)
 ...
 *     SepRmMakeLogonSessionsSiblingsWrkr @ 0x1409D0450 (SepRmMakeLogonSessionsSiblingsWrkr.c)
 *     SepRmSetSharedUserSessionWrkr @ 0x1409D0490 (SepRmSetSharedUserSessionWrkr.c)
 *     SepRmValidateProcUniqueLuidWrkr @ 0x1409D04C0 (SepRmValidateProcUniqueLuidWrkr.c)
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( PsIsHostSilo((__int64)v4) )
      {
        ...
        ExAcquireResourceExclusiveLite(&stru_140C70FD0, 1u);
        qword_140C71070 = (__int64)&Event.Header.WaitListHead;
        v8 = SepLsaAuditQueueInfo == (_QWORD)&SepLsaAuditQueueInfo;
        ExReleaseResourceLite(&stru_140C70FD0);
        KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
        inited = SepAdtInitLsaDeadEventForNonPagedList((__int64)&Object.Header.WaitListHead);
        v10 = KeGetCurrentThread();
        v11 = inited;
        --v10->KernelApcDisable;
        ExAcquireResourceExclusiveLite(&stru_140C70EB0, 1u);
        qword_140C70F50 = (__int64)&v16.Header.WaitListHead;
        v12 = SepLsaDeletedLogonQueueInfo == (_QWORD)&SepLsaDeletedLogonQueueInfo;
        ExReleaseResourceLite(&stru_140C70EB0);
        KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
        if ( !v8 )
