        ...
        __int64 a5)
{
  ...
  if ( a2 )
  {
    if ( (v9 & 1) != 0 )
    {
      if ( KeGetCurrentPrcb()->MmInternal )
      {
        ...
        if ( (MiFlags & 0x2000000) == 0 && ((unsigned __int8)(1 << a2) & (unsigned __int8)byte_140C65A8F) != 0 )
        {
          v26 = (_QWORD *)v25;
          if ( v25 < v25 + 4096 )
          {
      ...
      else
      {
        MxCopyPage(v11);
         ...
         || (PVOID)(((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v38) >> 12) & 0xFFFFFFFFFFLL) != qword_140C69758 )
  {
  ...
  if ( (unsigned int)MiGetSystemRegionType(LeafVa) == 1 )
  {
    v8 = 1;
         ...
         || LeafVa <= qword_140C67070 && LeafVa >= qword_140C6A558
...
LABEL_29:
  ...
  if ( (v17 & 0x20) != 0 && ((unsigned __int8)(1 << a2) & (unsigned __int8)byte_140C65A8F) != 0 )
