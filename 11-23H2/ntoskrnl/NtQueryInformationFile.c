/*
 * XREFs of NtQueryInformationFile @ 0x140725070
 * Callers:
 ...
 *     RtlIsPartialPlaceholderFileHandle @ 0x1409C0270 (RtlIsPartialPlaceholderFileHandle.c)
 ...
 *     IopGetModeInformation @ 0x140725B7C (IopGetModeInformation.c)
