/*
 * XREFs of NtQueryInformationFile @ 0x140725270
 * Callers:
 ...
 *     RtlIsPartialPlaceholderFileHandle @ 0x1409C0470 (RtlIsPartialPlaceholderFileHandle.c)
 ...
 *     IopGetModeInformation @ 0x140725D7C (IopGetModeInformation.c)
        ...
        FILE_INFORMATION_CLASS FileInformationClass)
{
  ...
  _BYTE Object[15]; // [rsp+39h] [rbp-17Fh] BYREF
  ...
  __int64 v102; // [rsp+D8h] [rbp-E0h] BYREF
  __int128 v103; // [rsp+E0h] [rbp-D8h] BYREF
  void *v104; // [rsp+F0h] [rbp-C8h]
  __int64 v105; // [rsp+F8h] [rbp-C0h]
  __int64 v106; // [rsp+100h] [rbp-B8h]
  __int64 v107; // [rsp+108h] [rbp-B0h]
  __int64 v108; // [rsp+110h] [rbp-A8h]
  unsigned int *v109; // [rsp+118h] [rbp-A0h]
  ULONG_PTR v110; // [rsp+128h] [rbp-90h] BYREF
  __int64 v111; // [rsp+130h] [rbp-88h] BYREF
  __int128 v112; // [rsp+138h] [rbp-80h] BYREF
  struct _KEVENT Event; // [rsp+148h] [rbp-70h] BYREF
  struct _LIST_ENTRY v114; // [rsp+160h] [rbp-58h] BYREF
  ...
  *(_QWORD *)&Object[7] = 0LL;
  v12 = ObReferenceObjectByHandle(
          ...
          (PVOID *)&Object[7],
          &HandleInformation);
  v13 = *(struct _FILE_OBJECT **)&Object[7];
  v110 = *(_QWORD *)&Object[7];
  if ( v12 >= 0 )
  {
    v14 = *(_DWORD **)(*(_QWORD *)&Object[7] + 208LL);
    if ( v14 )
    {
      if ( (*v14 & 4) != 0 )
      {
        ...
        {
          ObfDereferenceObject(*(PVOID *)&Object[7]);
          v12 = -1073739504;
        }
      }
    }
  ...
  v50 = *(_QWORD *)&Object[7];
  v51 = KeAbPreAcquire(*(_QWORD *)&Object[7] + 128LL, 0LL);
  Object[0] = 0;
  if ( _InterlockedExchange((volatile __int32 *)(v50 + 116), 1) )
  {
    v13 = *(struct _FILE_OBJECT **)&Object[7];
    v12 = IopWaitAndAcquireFileObjectLock(*(PVOID *)&Object[7], (__int64)Object);
  }
  else
  {
    if ( v51 )
      *(_BYTE *)(v51 + 18) = 1;
    v13 = *(struct _FILE_OBJECT **)&Object[7];
    ObfReferenceObject(*(PVOID *)&Object[7]);
    v12 = 0;
  }
  if ( Object[0] )
  {
  ...
  *(_QWORD *)(v21 + 24) = Pool2;
  if ( Pool2 )
  {
    *v87 |= 0x870u;
    ...
    {
      v33 = *(_DWORD **)&Object[7];
      ModeInformation = IopGetModeInformation(*(_QWORD *)&Object[7], v27, v28, *(_QWORD *)(v21 + 24));
      *v66 = ModeInformation;
      *(_QWORD *)(v21 + 56) = 4LL;
    }
    ...
    else if ( v8 == FileIoCompletionNotificationInformation )
    {
      ...
      *v67 = 0;
      v33 = *(_DWORD **)&Object[7];
      v68 = 0;
      if ( (*(_DWORD *)(*(_QWORD *)&Object[7] + 80LL) & 0x4000000) != 0 )
      {
        v68 = 2;
        *v67 = 2;
      }
    ...
    {
      v33 = *(_DWORD **)&Object[7];
      v69 = *(_QWORD *)(*(_QWORD *)&Object[7] + 208LL);
    ...
    else
    {
      if ( v8 == FileProcessIdsUsingFileInformation )
      {
        ...
        v33 = *(_DWORD **)&Object[7];
        v85 = *(_DWORD **)&Object[7];
        NumaNodeInformation = IopQueryProcessIdsUsingFile(*(_QWORD *)&Object[7], v72, v84, &v88);
      ...
      else if ( v8 == FileNumaNodeInformation )
      {
        ...
        v33 = *(_DWORD **)&Object[7];
        v85 = *(_DWORD **)&Object[7];
        NumaNodeInformation = IopGetNumaNodeInformation(*(_QWORD *)&Object[7], v73);
        v82 = NumaNodeInformation;
        v30 = 1;
      ...
      if ( !v30 )
      {
        ...
        *v42 = v44;
        ...
        {
          v114 = 0LL;
          v114 = *(struct _LIST_ENTRY *)(*(_QWORD *)(v89 + 200) + 24LL);
          v74 = IoSetActivityIdThread(&v114);
...
LABEL_48:
        if ( NumaNodeInformation == 259 )
        {
          if ( !v18 )
          {
            ...
            NumaNodeInformation = v112;
            *(_OWORD *)&v86->Status = v112;
            goto LABEL_53;
          }
          NumaNodeInformation = IopWaitForSynchronousIo((IRP *)v21, (__int64)v33);
        }
        else
        {
          v111 = 0LL;
          ...
          *p_SizeOfFastIoDispatch = v86;
          ...
          __writecr8(1uLL);
          IopCompleteRequest((char **)(v21 + 120), (__int64)&v111, &v102, &v110, &v102);
