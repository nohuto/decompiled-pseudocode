/*
 * XREFs of HvpGenerateLogEntryChecksums @ 0x140705888
 * Callers:
 ...
 *     SymCryptMarvin32Init @ 0x1403F643C (SymCryptMarvin32Init.c)
 *     SymCryptMarvin32Result @ 0x1403F6458 (SymCryptMarvin32Result.c)
 */
