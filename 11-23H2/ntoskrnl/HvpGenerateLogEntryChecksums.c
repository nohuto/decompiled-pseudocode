/*
 * XREFs of HvpGenerateLogEntryChecksums @ 0x140705678
 * Callers:
 ...
 *     SymCryptMarvin32Init @ 0x1403F625C (SymCryptMarvin32Init.c)
 *     SymCryptMarvin32Result @ 0x1403F6278 (SymCryptMarvin32Result.c)
 */
