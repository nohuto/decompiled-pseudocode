/*
 * XREFs of WheapSetDefaultErrorSourceConfiguration @ 0x140B545DC
 * Callers:
...
__int64 WheapSetDefaultErrorSourceConfiguration()
{
  ...
  do
  {
    ...
    *(_QWORD *)((char *)&unk_140D16D00 + result * 8) = PdcCreateWatchdogAroundClientCall;
    qword_140D16D08[result] = (__int64 (__fastcall *)(_QWORD, int *, _QWORD))xHalPciEarlyRestore;
    qword_140D16D08[result + 1] = (__int64 (__fastcall *)(_QWORD, int *, _QWORD))WheapDefaultErrSrcCreateRecord;
    qword_140D16D08[result + 2] = (__int64 (__fastcall *)(_QWORD, int *, _QWORD))PdcCreateWatchdogAroundClientCall;
    qword_140D16D08[result + 3] = (__int64 (__fastcall *)(_QWORD, int *, _QWORD))xHalTimerWatchdogStop;
    qword_140D16D08[result + 4] = 0LL;
