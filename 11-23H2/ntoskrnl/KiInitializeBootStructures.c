/*
 * XREFs of KiInitializeBootStructures @ 0x140A8B590
 * Callers:
 ...
 *     KasanInitSystem @ 0x1403B6300 (KasanInitSystem.c)
 *     strstr @ 0x1403D93B0 (strstr.c)
 *     atoi @ 0x1403D9440 (atoi.c)
 *     KiSaveInitialProcessorControlState @ 0x14041F010 (KiSaveInitialProcessorControlState.c)
 ...
 *     InitializeBuildStrings @ 0x140B34CFC (InitializeBuildStrings.c)
...
__int64 __fastcall KiInitializeBootStructures(__int64 a1)
{
  ...
  *((_WORD *)Pcr->NtTib.StackBase + 51) = 104;
  ...
  if ( !v17 )
  {
    KiEnableKvaShadowing((__int64)CurrentPrcb, (__int64)&Pcr->NtTib.ExceptionList[-763], 0LL);
    v17 = CurrentPrcb->Number;
  }
  if ( KiKvaShadow )
  {
  ...
  if ( !(_DWORD)Number )
  {
    ...
    memset(&unk_140D1EFF4, 0, 0x104uLL);
