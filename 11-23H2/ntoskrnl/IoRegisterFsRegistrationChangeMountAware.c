...
LABEL_5:
  if ( (__int64 *)IopFsNotifyChangeQueueHead != &IopFsNotifyChangeQueueHead
    && *(PDRIVER_OBJECT *)(qword_140C5DAC8 + 16) == DriverObject
    && *(PDRIVER_FS_NOTIFICATION *)(qword_140C5DAC8 + 24) == DriverNotificationRoutine )
  {
...
LABEL_9:
  ...
  v10 = (_QWORD *)qword_140C5DAC8;
  if ( *(__int64 **)qword_140C5DAC8 != &IopFsNotifyChangeQueueHead )
    __fastfail(3u);
  *Pool2 = &IopFsNotifyChangeQueueHead;
  Pool2[1] = v10;
  *v10 = Pool2;
  qword_140C5DAC8 = (__int64)Pool2;
