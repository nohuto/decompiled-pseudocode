/*
 * XREFs of DifZwQueryInformationJobObjectWrapper @ 0x1405F4BE0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryInformationJobObjectWrapper(
        HANDLE JobHandle,
        ...
        PULONG ReturnLength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(596);
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = JobHandle;
  LODWORD(v23) = JobObjectInformationClass;
  *((_QWORD *)&v22 + 1) = JobObjectInformation;
  LODWORD(v22) = JobObjectInformationLength;
...
LABEL_17:
  result = ZwQueryInformationJobObject(
             JobHandle,
