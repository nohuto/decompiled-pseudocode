/*
 * XREFs of PfpPrefetchRequestPerform @ 0x1406846E8
 * Callers:
 ...
 *     PfpPrefetchRequestPatchOffsets @ 0x140683E1C (PfpPrefetchRequestPatchOffsets.c)
...
__int64 __fastcall PfpPrefetchRequestPerform(__int64 a1)
{
  ...
  *(_QWORD *)(v29[5] + 24LL) = v29;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( *(_BYTE *)(v29[0] + 81LL) )
    {
      _InterlockedAdd(&dword_140D0C198, 1u);
      v4 = PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140C64FB0, 0);
      if ( v4 < 0 )
      {
LABEL_55:
        _InterlockedDecrement(&dword_140D0C198);
        PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140C64FB0, 0);
        goto LABEL_26;
      }
