/*
 * XREFs of ObpIncrementHandleCountEx @ 0x1406E7090
 * Callers:
 ...
 *     OBJECT_HEADER_TO_PROCESS_INFO @ 0x14036C0B0 (OBJECT_HEADER_TO_PROCESS_INFO.c)
        ...
        unsigned __int64 a7)
{
  ...
  $115DCDF994C6370D29323EAB0E0C9502 v62; // [rsp+88h] [rbp-80h] BYREF
  ...
  if ( (a6 & 0x400) == 0 )
    v10 = a5;
  *(_OWORD *)&v62.SavedApcStateFill[32] = 0LL;
...
LABEL_89:
  ...
  v33 = ObTypeIndexTable[(unsigned __int8)ObHeaderCookie ^ *(unsigned __int8 *)(v8 + 24) ^ (unsigned __int64)(unsigned __int8)v57];
  v18 = *(_DWORD *)(v33 + 104);
  v19 = *(_DWORD *)(v33 + 108);
LABEL_9:
  v21 = v19;
