/*
 * XREFs of _CmGetInterfaceClassMappedPropertyKeys @ 0x140A69498
 * Callers:
...
LABEL_24:
  ...
  if ( a4
    || (result = CmGetInterfaceClassMappedPropertyFromComposite(a1, a2, a3, (__int64)&DEVPKEY_NAME, &a7, 0LL, 0, v15),
        (_DWORD)result == -1073741789)
    || !(_DWORD)result )
  {
    if ( a5 )
