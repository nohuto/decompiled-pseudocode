/*
 * XREFs of AlpcpReceiveMessagePort @ 0x14073B680
 * Callers:
...
LABEL_88:
        ...
        if ( v16 == (_QWORD **)80 )
          break;
        if ( (unsigned __int8)AlpcpTryLockForCachedReferenceBlob((ULONG_PTR)(v16 - 10)) )
        {
...
LABEL_54:
      ...
      if ( i )
      {
        ...
        *(_QWORD *)(v5 + 240) = p_WaitListHead;
        ...
        v22 = AlpcpCompleteDeferSignalRequestAndWait(a1, &CurrentThread[1].KernelStack, v21, a2, a3);
        if ( v22 )
        {
          ExAcquirePushLockExclusiveEx(v5 + 224, 0LL);
...
LABEL_53:
    ...
    if ( AlpcpLogEnabled )
      AlpcpLogWaitForNewMessage(v5);
    result = AlpcpCompleteDeferSignalRequestAndWait(a1, *(_QWORD *)(v5 + 248), v31, a2, a3);
  }
  while ( !(_DWORD)result );
  return result;
}
