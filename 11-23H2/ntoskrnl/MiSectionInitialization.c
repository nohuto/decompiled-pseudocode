/*
 * XREFs of MiSectionInitialization @ 0x140B70508
 * Callers:
...
__int64 MiSectionInitialization()
{
  ...
  *(_OWORD *)((char *)&v10[1] + 4) = MiSectionMapping;
  ...
  if ( (int)ObCreateObjectType(&v2, (__int64)v10, 0LL, (__int64)&MmSectionObjectType) >= 0 )
  {
    ...
    if ( Pool )
    {
      memset(&qword_140C65570, 0, 0x118uLL);
      Pool[5] = 0LL;
      dword_140C65640 |= 0x400u;
      v5 = 0LL;
      v6 = v3;
      qword_140C65570 = (__int64)&qword_140C65608;
      qword_140C65608 = (__int64)Pool;
      qword_140C65620 = 1LL;
      *Pool = &qword_140C65608;
      v4[0] = 48;
      v7 = 65552;
      v9 = 0LL;
      ...
      {
        MEMORY[0x28] = &qword_140C65608;
        MEMORY[0x30] = (1LL << dword_140C65AE0) - 1;
        MEMORY[0x38] = 0;
