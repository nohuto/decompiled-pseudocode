/*
 * XREFs of DifExReleaseResourceAndLeaveCriticalRegionWrapper @ 0x1405D9F40
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall DifExReleaseResourceAndLeaveCriticalRegionWrapper(PERESOURCE Resource)
{
