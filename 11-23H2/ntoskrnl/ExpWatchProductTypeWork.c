/*
 * XREFs of ExpWatchProductTypeWork @ 0x1407AC030
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CmSizeOfThreadInfo @ 0x1403380C0 (CmSizeOfThreadInfo.c)
...
LABEL_23:
      ...
      if ( v28 )
      {
        ...
        if ( v29 == -1073741670 )
        {
          ...
          {
            KeDelayExecutionThread(0, 0, &Interval);
            LODWORD(Sizeb) = *((_DWORD *)qword_140C70D48 + 2);
            v29 = NtSetValueKey(
                    (__int64)ExpProductTypeKey,
                    &v45,
                    0,
                    *((_DWORD *)qword_140C70D48 + 1),
                    (struct _PRIVILEGE_SET *)((char *)qword_140C70D48 + 12),
                    Sizeb);
          }
