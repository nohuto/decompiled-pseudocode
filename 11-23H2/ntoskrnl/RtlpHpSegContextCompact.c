/*
 * XREFs of RtlpHpSegContextCompact @ 0x140338030
 * Callers:
 ...
 *     RtlpHpSegFreeRangeInsert @ 0x14024F9C0 (RtlpHpSegFreeRangeInsert.c)
        ...
        if ( v8 < v9 )
        {
          while ( 1 )
          {
            if ( (*(_BYTE *)(v8 + 24) & 1) == 0 && *(_WORD *)(v8 + 28) != 0xFFFF )
            {
              ...
              *(_BYTE *)(v12 + v8 + 24) |= 1u;
              v8 = RtlpHpSegPageRangeCoalesce(a1, v8, a2, 1, (unsigned __int8 *)&v25);
...
LABEL_6:
  ...
  for ( result = &v23; v10 != &v23; result = &v23 )
  {
    v18 = (__int64)v10;
    v10 = (_QWORD *)*v10;
    RtlpHpSegSegmentFree(a1, v18, 0x7FFFFFFFu, 1);
  }
  return result;
}
