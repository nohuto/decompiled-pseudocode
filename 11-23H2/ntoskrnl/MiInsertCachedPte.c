/*
 * XREFs of MiInsertCachedPte @ 0x1402CBDA0
 * Callers:
...
__int64 __fastcall MiInsertCachedPte(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  if ( a3 != 1 )
  {
    ...
    if ( MiPteInShadowRange(a2 + 8) )
    {
      ...
      {
        if ( !HIBYTE(word_140C66CFC) && (v22 & 1) != 0 )
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( v13 )
      {
        if ( qword_140C65B40 )
        {
          if ( (v13 & 0x10) != 0 )
            ...
            LODWORD(v13) = ~(_DWORD)qword_140C65B40 & v13;
        }
      }
      else
      {
      ...
      if ( MiPteInShadowRange(v12) )
      {
        ...
        {
          if ( !HIBYTE(word_140C66CFC) && (v13 & 1) != 0 )
