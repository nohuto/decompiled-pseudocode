/*
 * XREFs of CmpVerifyLogRecord @ 0x140A1F534
 * Callers:
 ...
 *     CmpVerifyRenameKeyLogRecord @ 0x140A1F618 (CmpVerifyRenameKeyLogRecord.c)
 *     CmpVerifySetOrDeleteValueLogRecord @ 0x140A1F660 (CmpVerifySetOrDeleteValueLogRecord.c)
