/*
 * XREFs of KiShouldRearmClockTimer @ 0x140340E3C
 * Callers:
 ...
 *     KiGetClockTimerEarliestDeadline @ 0x140340F1C (KiGetClockTimerEarliestDeadline.c)
...
char __fastcall KiShouldRearmClockTimer(__int64 a1, char a2)
{
  ...
  if ( (unsigned int)dword_140C02F60 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)word_14002D372,
      0LL,
      0LL,
      0xAu,
      &v25);
