/*
 * XREFs of KiShouldRearmClockTimer @ 0x1403410CC
 * Callers:
 ...
 *     KiGetClockTimerEarliestDeadline @ 0x1403411AC (KiGetClockTimerEarliestDeadline.c)
...
char __fastcall KiShouldRearmClockTimer(__int64 a1, char a2)
{
  ...
  if ( (unsigned int)dword_140C02F60 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)word_14002D45A,
      0LL,
      0LL,
      0xAu,
      &v25);
