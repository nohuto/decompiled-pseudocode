/*
 * XREFs of MiRebaseDynamicRelocationRegions @ 0x140B43F64
 * Callers:
...
__int64 __fastcall MiRebaseDynamicRelocationRegions(__int64 a1)
{
  ...
  v4 = qword_140C6A4D8[0];
  v5 = qword_140C6A578;
  v23 = qword_140C6A4D8[0];
  if ( (MiFlags & 0x4000) == 0 && qword_140C6A578 == 0xFFFFF68000000000uLL )
    goto LABEL_18;
  v6 = ((unsigned __int64)qword_140C6A578 >> 39) & 0x1FF;
  v7 = 0;
