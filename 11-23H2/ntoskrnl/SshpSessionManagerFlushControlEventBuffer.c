/*
 * XREFs of SshpSessionManagerFlushControlEventBuffer @ 0x14085B500
 * Callers:
...
LONG __fastcall SshpSessionManagerFlushControlEventBuffer(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v3 = 0;
  for ( i = 0LL; v3 < dword_140C38700; v3 += v5 + 12 )
  {
    v4 = (char *)&unk_140C38704 + v3;
    v5 = *(_DWORD *)v4;
    v6 = *(const EVENT_DESCRIPTOR **)(v4 + 4);
    i.Ptr = (ULONGLONG)(v4 + 12);
    *(_QWORD *)&i.Size = v5;
    SSHSupportEtwWrite((__int64)&unk_140C38704, v6, a3, 1u, &i);
  }
  dword_140C38700 = 0;
  byte_140C386E0 = 0;
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&stru_140C384E8, 0LL);
  if ( !--dword_140C384F8[0] )
  {
    v8[0] = 0LL;
    v8[1] = -1LL;
    KeSetTimer2((__int64)&unk_140C38500, -50000000LL, 0LL, (__int64)v8);
  }
  SSHSupportReleasePushLockExclusive((volatile signed __int64 *)&stru_140C384E8);
  return KeSetEvent(&stru_140C386E8, 0, 0);
}
