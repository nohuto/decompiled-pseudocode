...
__int64 __fastcall MiAddPartitionDataToCrashDump(__int64 a1)
{
  ...
  v1 = 0;
  LODWORD(v3) = MmAddRangeToCrashDump(a1, qword_140C673C8, 8LL);
  if ( (int)v3 < 0 )
    return (unsigned int)v3;
  LODWORD(v3) = MmAddRangeToCrashDump(a1, qword_140C673A8, 16LL);
  if ( (int)v3 < 0 )
    return (unsigned int)v3;
  v4 = MmAddRangeToCrashDump(
         a1,
         qword_140C673A8->Buffer,
         8 * (((unsigned __int64)qword_140C673A8->SizeOfBitMap >> 6) + ((qword_140C673A8->SizeOfBitMap & 0x3F) != 0)));
  v3 = (unsigned int)v4;
  if ( v4 < 0 )
    return (unsigned int)v3;
  do
  {
    v5 = v1 < qword_140C673A8->SizeOfBitMap ? v1 : 0;
...
LABEL_13:
      if ( !v5 )
        goto LABEL_18;
      SizeOfBitMap = v1 + 1;
      if ( v1 + 1 > qword_140C673A8->SizeOfBitMap )
...
LABEL_18:
    ...
    if ( (_DWORD)v10 == -1 )
      break;
    v1 = v10 + 1;
    v15 = MiAddPartitionToCrashDump(a1, *(_QWORD *)(qword_140C673C8 + 8 * v10), v3);
    v3 = (unsigned int)v15;
  }
  while ( v15 >= 0 );
  if ( (int)v3 >= 0 )
  {
    ...
    {
      if ( qword_140C67DF0 )
        LODWORD(v3) = MmAddRangeToCrashDump(a1, qword_140C67DF0, 0x2000000LL);
    }
  }
  return (unsigned int)v3;
}
