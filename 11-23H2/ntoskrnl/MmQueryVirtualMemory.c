/*
 * XREFs of MmQueryVirtualMemory @ 0x1406F8350
 * Callers:
 *     ?SmStCheckResident@?$SMKM_STORE@USM_TRAITS@@@@SA?AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z @ 0x140465552 (-SmStCheckResident@-$SMKM_STORE@USM_TRAITS@@@@SA-AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z.c)
 *     NtQueryVirtualMemory @ 0x1406F8310 (NtQueryVirtualMemory.c)
 ...
 *     MI_GET_GRAPHICS_PROTECTION_FROM_VAD @ 0x140275430 (MI_GET_GRAPHICS_PROTECTION_FROM_VAD.c)
 ...
 *     MiIsSoftwareEnclave @ 0x14033DF60 (MiIsSoftwareEnclave.c)
 *     MiGetWorkingSetInfo @ 0x140363210 (MiGetWorkingSetInfo.c)
 *     MiSetBasicInfoPartitionId @ 0x14036A0FC (MiSetBasicInfoPartitionId.c)
