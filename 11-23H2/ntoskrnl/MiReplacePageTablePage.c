/*
 * XREFs of MiReplacePageTablePage @ 0x14039502C
 * Callers:
  ...
  *(_DWORD *)(a1 + 56) = -1073741823;
  ...
  else
  {
    ...
    if ( LeafVa > 0x7FFFFFFEFFFFLL
      && (LeafVa < qword_140C6A558 || LeafVa > qword_140C67070)
    ...
    if ( v52 )
    {
      ...
      do
      {
        ...
        if ( (v54 & 1) != 0 )
        {
          ...
          if ( v34 <= qword_140C65BA0 && ((*(_QWORD *)(48 * v34 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 && v34 != v5 )
          {
            v53 = 0;
