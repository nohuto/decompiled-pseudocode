/*
 * XREFs of FsRtlLookupPerStreamContextInternal @ 0x140230430
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID InstanceId)
{
  ...
  unsigned __int64 AePushLock; // rdi
...
LABEL_37:
  ...
  AePushLock = (unsigned __int64)StreamContext->AePushLock;
  if ( !AePushLock )
    goto LABEL_36;
  ...
  if ( v9->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(StreamContext, v9)) != 0 )
  {
    ...
    if ( AePushLock - qword_140C659E8 < 0x8000000000LL )
  ...
  else
  {
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)AePushLock, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx(AePushLock, 0LL, v10, AePushLock);
    v17 = AePushLock | 1;
  }
  if ( v10 )
    *(_BYTE *)(v10 + 18) = 1;
...
LABEL_24:
    ...
    {
      if ( _InterlockedCompareExchange64((volatile signed __int64 *)v22, 0LL, 17LL) != 17 )
        ExfReleasePushLockShared(v17 & 0xFFFFFFFFFFFFFFFCuLL);
      v22 = *(_QWORD *)(v22 + 8);
    }
LABEL_26:
    KeAbPostRelease(v22);
