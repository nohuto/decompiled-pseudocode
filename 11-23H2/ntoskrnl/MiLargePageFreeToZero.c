  ...
  *(_QWORD *)(v7 + 16) = MiSwizzleInvalidPte(128LL);
  if ( !a4 )
  {
    ...
    *(_QWORD *)(v13 + 8) = v14;
    ...
    v20 = 24 * (BugCheckParameter2 / *v34 % (unsigned int)dword_140C65B80[v38]);
...
LABEL_43:
    ...
    v39 = v8;
    v29 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67EA0 + 1) + 4 * (BugCheckParameter2 >> 5));
    v33 = v29;
  ...
  v25 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67EA0 + 1) + 4 * (BugCheckParameter2 >> 5));
  if ( v24 + v8 <= 0x20 )
  {
    if ( v8 == 32 )
    {
