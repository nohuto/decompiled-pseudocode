...
LABEL_12:
    ...
    {
      if ( (int)BgpDisplayCharacterEx(0x20u, (__int64 *)qword_140C70BA0, v12, v13, v15, v15, &v20, &v21, v19) < 0 )
        return 0LL;
      v12 += v20;
      LODWORD(v22) = v12;
      if ( v12 > v17 )
