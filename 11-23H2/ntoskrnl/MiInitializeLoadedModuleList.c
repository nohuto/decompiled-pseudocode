/*
 * XREFs of MiInitializeLoadedModuleList @ 0x140B5CCDC
 * Callers:
...
__int64 __fastcall MiInitializeLoadedModuleList(__int64 a1)
{
  ...
  v21 = 0LL;
  qword_140C658C8 = (__int64)&qword_140C658C0;
  qword_140C658C0 = (__int64)&qword_140C658C0;
  ...
  ExpCovPushLock = 0LL;
  qword_140C2CC88 = (__int64)&ExpCovUnloadedModuleList;
