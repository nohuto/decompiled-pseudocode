/*
 * XREFs of EmpEvaluateNodeLink @ 0x14032DE04
 * Callers:
 ...
 *     EmpEvaluateParseNodeMapping @ 0x14032E278 (EmpEvaluateParseNodeMapping.c)
        ...
        unsigned int a11)
{
  ...
  unsigned int ullMultiplicand_4; // [rsp+7Ch] [rbp-2Dh] BYREF
  ...
  if ( v24 && (v40 = *(_QWORD *)(a1 + 24)) != 0 || (v40 = a8, v37 = a9, a8) )
  {
    if ( v23 )
    {
      if ( RtlULongLongMult(v23, 8uLL, &pullResult) < 0 )
        return v17;
      v16 = EmpAllocatePool(pullResult, &v39, &ullMultiplicand_4);
      if ( !v16 )
        return v17;
    }
    if ( ullMultiplicand )
    {
      if ( RtlULongLongMult(ullMultiplicand, 4uLL, &pullResult) < 0 )
        goto LABEL_25;
      v19 = EmpAllocatePool(pullResult, &v39, &ullMultiplicand_4);
      if ( !v19 )
        goto LABEL_25;
    }
    v25 = v45;
    if ( v45 )
    {
      if ( RtlULongLongMult(v45, 8uLL, &pullResult) < 0
        || (v18 = EmpAllocatePool(pullResult, &v39, &ullMultiplicand_4)) == 0 )
      {
        v27 = a11;
LABEL_23:
        if ( v19 )
...
LABEL_25:
                            ...
                            v25) )
    {
      if ( *(_DWORD *)a1 )
        ...
        v26 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64, _QWORD, __int64, unsigned int, _QWORD))(v20 + 16))(
                v18,
                v45,
                v16,
                (unsigned int)v36,
