/*
 * XREFs of EtwpValidateFilterDescriptors @ 0x14077D9E4
 * Callers:
...
__int64 __fastcall EtwpValidateFilterDescriptors(_DWORD *a1, __int64 a2)
{
  ...
  if ( v2 )
  {
    while ( 1 )
    {
      ...
      if ( (v9 & 0x400) != 0 )
      {
        if ( ((v10 + 0x80000000) & 0xFFFFFEFD) == 0 && v10 != -2147483390 )
          return 3221225485LL;
      }
      else if ( v10 == -2147450880 )
      {
        return 3221225485LL;
      }
      ...
      v14 = (__int64)a1 + v8;
      v16 = v10;
      result = EtwpAllocateFilter(v10, &v14, a2, (__int64)(a1 + 10));
      if ( (int)result < 0 )
        return result;
