/*
 * XREFs of KeRemoveQueueDpcEx @ 0x14031F360
 * Callers:
...
char __fastcall KeRemoveQueueDpcEx(__int64 a1, char a2)
{
  ...
  if ( a2 && *(_QWORD *)(a1 + 16) )
  {
    ...
    KiGetDeepIdleProcessors((__int64)v42, (__int64)v41);
    v23 = 0;
    if ( LOWORD(v41[0]) )
    {
      v24 = *(_QWORD *)(a1 + 16);
    ...
    if ( !(unsigned int)KeIsEmptyAffinityEx(v41) )
      KeGenericProcessorCallback(v41, (void (__fastcall *)(struct _KPRCB *, __int64))xHalTimerWatchdogStop, 0LL, 2);
  }
  return v5;
}
