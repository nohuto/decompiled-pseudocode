...
__int64 __fastcall MiCreatePfnBitMaps(__int64 a1, _DWORD *a2)
{
  ...
  for ( i = 0; i < 4; ++i )
  {
    ...
    v31 = v3 / v9 + (v3 % v9 != 0);
    v10 = MiReservePtes((__int64)&qword_140C69940, (((v31 + 7) >> 3) + 4095) >> 12);
    v28[0] = v10;
    if ( !v10 )
      goto LABEL_30;
    if ( !(unsigned int)MiInitializeDynamicBitmap(v29, (__int64)(v10 << 25) >> 16, v31, 2LL) )
    {
      ...
      v26 = (__int64 *)v28[0];
LABEL_29:
      MiReleasePtes((__int64)&qword_140C69940, v26, v27);
LABEL_30:
...
LABEL_7:
  ...
  v11 = (v3 >> 9) + ((v3 & 0x1FF) != 0);
  v12 = (v11 + 4095) >> 12;
  v13 = MiReservePtes((__int64)&qword_140C69940, v12);
  v30 = (__int64 *)v13;
  if ( !v13 )
    goto LABEL_30;
  ...
  *(_QWORD *)(a1 + 16048) = v14;
  ...
  v16 = (((v15 + 7) >> 3) + 4095) >> 12;
  v17 = MiReservePtes((__int64)&qword_140C69940, v16);
  v18 = (__int64 *)v17;
  if ( !v17 )
    goto LABEL_30;
  ...
  *(_QWORD *)(a1 + 16056) = 0LL;
  v19 = 2 * v15;
  v20 = (2 * v15 + 4095) >> 12;
  v21 = MiReservePtes((__int64)&qword_140C69940, v20);
  v22 = (__int64 *)v21;
  if ( !v21 )
    goto LABEL_30;
