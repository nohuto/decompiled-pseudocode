  ...
  *a1 = v2;
  ...
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v10 > *(_DWORD *)(v5 + 120) )
      *(_DWORD *)(v5 + 120) = v10;
    v11 = v6 + _InterlockedExchangeAdd64(&qword_140C13978, v6);
    if ( v11 > qword_140C13988 )
      qword_140C13988 = v11;
    v12 = _InterlockedIncrement(&dword_140C13964);
    if ( v12 > dword_140C1396C )
      dword_140C1396C = v12;
  }
  else
  {
    ...
    if ( v14 > *(_DWORD *)(v5 + 124) )
      *(_DWORD *)(v5 + 124) = v14;
    v15 = v6 + _InterlockedExchangeAdd64(&qword_140C13980, v6);
    if ( v15 > qword_140C13990 )
      qword_140C13990 = v15;
    v16 = _InterlockedIncrement(&dword_140C13968);
    if ( v16 > dword_140C13970 )
      dword_140C13970 = v16;
  }
  result = v2;
  *v7 = a1;
