/*
 * XREFs of DrvDbDeleteObjectSubKey @ 0x140A6B26C
 * Callers:
...
LABEL_7:
  ...
  if ( v13 < 0 )
    goto LABEL_7;
  for ( i = PnpGetGenericStorePropertyKeys(*a1, (int)Handle, 0LL, 0, 0LL, 0, (unsigned int *)&DestinationString.Length);
        ;
  ...
  if ( i == -1073741275 || i >= 0 )
  {
    ...
    if ( v5 )
    {
      do
      {
        v19 = PnpDeletePropertyWorker(*a1, (int)Handle, 0LL, (__int64)Pool2 + 20 * v18, 0, dwFlags, 0);
        inited = v19;
        ...
        if ( v22 )
        {
          ...
          for ( j = Handle; ; j = 0LL )
          {
            if ( !j )
            {
              ...
              inited = PnpCtxRegQueryInfoKey(v27, Handle, &v42, 0LL, &v45, 0LL, 0LL);
              if ( inited < 0 || v42 || v45 )
                goto LABEL_80;
              j = Handle;
            }
            if ( *a1 && (v28 = *(_QWORD *)(*a1 + 224)) != 0 )
              ...
              v29 = 0LL;
            inited = RegRtlDeleteKeyTransacted(j, 0LL, v29);
...
LABEL_39:
      ...
      {
        inited = PnpCtxRegQueryInfoKey(v35, Handle, 0LL, 0LL, &v45, &v43, 0LL);
        if ( inited >= 0 )
        {
          v36 = v43 + 1;
          if ( v45 )
          {
            ...
            if ( v23 )
            {
              ...
              {
                v45 = v36;
                inited = PnpCtxRegEnumValue(v37, Handle, 0, v23, &v45, 0LL, 0LL, 0LL);
                if ( inited < 0 )
                  break;
                v38 = Handle;
                DestinationString = 0LL;
                inited = RtlInitUnicodeStringEx(&DestinationString, v23);
                if ( inited >= 0 )
                  inited = ZwDeleteValueKey(v38, &DestinationString);
                if ( ((inited + 0x80000000) & 0x80000000) == 0 && inited != -1073741772 )
                  goto LABEL_80;
              }
              v31 = inited == -2147483622;
LABEL_78:
              if ( v31 )
                inited = 0;
LABEL_80:
