...
LABEL_4:
  ...
  if ( v4 <= 0xFFFFF6FFFFFFFFFFuLL && v5 >= qword_140C6A558 && v5 <= qword_140C67070 )
    a1[1] |= 2uLL;
LABEL_5:
  v68 = 0;
  ...
  if ( (a1[2] & 1) != 0 && (*v8 == 7 || *v8 == 8) )
  {
    if ( v4 < 0xFFFFF68000000000uLL
      ...
      || v5 > 0x7FFFFFFEFFFFLL && (v5 < qword_140C6A558 || v5 > qword_140C67070) )
    {
      return 3489660934LL;
    }
    return 192LL;
  }
  if ( v5 < 0xFFFF800000000000uLL || v5 >= qword_140C67068 && v5 < qword_140C67068 + MiHyperSpaceSize() )
    return 192LL;
  ...
  if ( dword_140C67244 )
  {
    v38 = ExAcquireSpinLockShared(&dword_140C67240);
    v39 = (_QWORD *)qword_140C67248;
    v40 = v38;
    if ( qword_140C67248 )
    {
      do
...
LABEL_20:
  HIDWORD(v71[0]) = 1;
  v21 = byte_140C6A3D8[((v5 >> 39) & 0x1FF) - 256];
  if ( (a1[10] & 8) != 0 )
  {
    if ( v21 != 6 )
      return 3221225477LL;
