/*
 * XREFs of MiTrimUnusedPageFileRegionsApc @ 0x14063BB40
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall MiTrimUnusedPageFileRegionsApc(PRKEVENT Event)
{
  ...
  if ( FreePageFileSpace >= HIDWORD(Event[1].Header.WaitListHead.Flink) )
  {
    ...
    HIDWORD(Event[1].Header.WaitListHead.Blink) = v7 + MiFindFreePageFileSpace(v1, (__int64 *)&v13, v11, 0x6BuLL);
  }
