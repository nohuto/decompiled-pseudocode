/*
 * XREFs of AlpcpConnectPort @ 0x140717570
 * Callers:
 *     NtAlpcConnectPort @ 0x140715250 (NtAlpcConnectPort.c)
 *     NtAlpcConnectPortEx @ 0x140715880 (NtAlpcConnectPortEx.c)
 * Callees:
...
LABEL_15:
      ...
      {
        v21 = Object[0];
        v22 = AlpcpProcessConnectionRequest((__int64)Object[0], a6 & 0xFFFF0000, a9, v36, v35, v34, v33, PreviousMode);
        ClientPort = v22;
