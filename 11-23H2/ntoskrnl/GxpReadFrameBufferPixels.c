/*
 * XREFs of GxpReadFrameBufferPixels @ 0x140AEC548
 * Callers:
 *     BgpGxReadRectangle @ 0x140AEC4D8 (BgpGxReadRectangle.c)
 * Callees:
 *     BgpGetResolution @ 0x14036E928 (BgpGetResolution.c)
 *     BgpGetBitsPerPixel @ 0x140385500 (BgpGetBitsPerPixel.c)
 *     GxpAdjustRectangleToFrameBuffer @ 0x140385528 (GxpAdjustRectangleToFrameBuffer.c)
 *     _guard_dispatch_icall @ 0x140429C20 (_guard_dispatch_icall.c)
 *     memmove @ 0x140435700 (memmove.c)
 *     GxpGetRotatedPixelOffset @ 0x140671ED8 (GxpGetRotatedPixelOffset.c)
 */
...
LABEL_31:
      ...
      {
        v16 = (char *)qword_140C0E460 + v5 * (*v3 + v3[1] * v22);
        if ( v15 )
        {
          v17 = *(_DWORD *)(a1 + 4) * v5;
          v18 = v5 * v22;
    ...
    else
    {
      ...
      v29[1] = *(_DWORD *)(a1 + 4);
      v29[3] = *(_DWORD *)(a1 + 12);
      v29[2] = xmmword_140C0E450;
      v30 = *(_QWORD *)(a1 + 24);
      if ( qword_140C0E460 )
      {
        LOBYTE(v12) = 1;
        RotatedPixelOffset = ((__int64 (__fastcall *)(_DWORD *, unsigned int *, __int64))qword_140C0E460)(v29, v3, v12);
      }
      else
      {
