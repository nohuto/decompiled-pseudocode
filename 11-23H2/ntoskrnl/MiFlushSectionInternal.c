/*
 * XREFs of MiFlushSectionInternal @ 0x1402759E0
 * Callers:
...
LABEL_33:
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v30 + 40) >> 43) & 0x3FFLL)) + 4LL) & 0x80u) != 0 )
...
LABEL_136:
      ...
      v36 = v31 & 1;
      v37 = *(void **)(qword_140C673C8 + 8 * ((*(_QWORD *)(v30 + 40) >> 43) & 0x3FFLL));
      v38 = *(_DWORD *)(v30 + 16);
      v112 = v37;
      v39 = (v38 & 0x400) != 0LL;
      v40 = v35 & 2;
...
LABEL_154:
  ...
  if ( v103 )
    MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140C673C8 + 8LL * (*(_WORD *)(v12 + 60) & 0x3FF)), 1LL, v103);
  if ( v110 )
