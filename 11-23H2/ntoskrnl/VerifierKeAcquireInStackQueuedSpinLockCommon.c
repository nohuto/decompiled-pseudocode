/*
 * XREFs of VerifierKeAcquireInStackQueuedSpinLockCommon @ 0x140AD5210
 * Callers:
 *     VerifierKeAcquireInStackQueuedSpinLock @ 0x140AC0260 (VerifierKeAcquireInStackQueuedSpinLock.c)
 * Callees:
