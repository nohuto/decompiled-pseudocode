/*
 * XREFs of VerifierKeAcquireInStackQueuedSpinLockCommon @ 0x140AD5200
 * Callers:
 *     VerifierKeAcquireInStackQueuedSpinLock @ 0x140AC0250 (VerifierKeAcquireInStackQueuedSpinLock.c)
 * Callees:
