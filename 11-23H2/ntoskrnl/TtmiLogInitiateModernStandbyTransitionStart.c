/*
 * XREFs of TtmiLogInitiateModernStandbyTransitionStart @ 0x1409A8AC8
 * Callers:
...
void __fastcall TtmiLogInitiateModernStandbyTransitionStart(char a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D53918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53918, 1LL) )
    {
      ...
      v13 = 1;
      v7 = a2;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53918, (unsigned __int8 *)byte_1400333BD, 0LL, 0LL, 5u, &v8);
    }
  }
}
