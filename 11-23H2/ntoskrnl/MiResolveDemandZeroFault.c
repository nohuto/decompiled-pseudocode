/*
 * XREFs of MiResolveDemandZeroFault @ 0x140269FD0
 * Callers:
...
LABEL_34:
      ...
      if ( !v16 && a2 <= 0xFFFFF6BFFFFFFF78uLL && a2 >= 0xFFFFF68000000000uLL )
      {
        ...
        v22 = *(_QWORD *)(qword_140C673C8 + 8LL * *(unsigned __int16 *)(Process + 1838));
        if ( *(_DWORD *)(v22 + 1192) )
        {
          ...
          if ( v31 >= 0 && (v55[0] & 4) == 0 )
          {
            ...
            if ( Process )
            {
              do
              {
                ...
                v37 = v68;
                *(_QWORD *)a1 = v32;
                v38 = MiCompleteProtoPteFault((ULONG_PTR *)a1, v36, v37, 1, v35);
                v32 += 4096LL;
                if ( !v5 && v38 < 0 )
                  v31 = v38;
