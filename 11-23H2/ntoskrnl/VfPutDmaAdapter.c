/*
 * XREFs of VfPutDmaAdapter @ 0x140AC72B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VfPutDmaAdapter(ULONG_PTR a1)
{
  ...
  if ( v3 < 0 )
  {
    ViHalPreprocessOptions(
      ...
      (const void *)0x18);
    VfReportIssueWithOptions(0xE6u, 0x18uLL, a1, v5, 0LL, byte_140C0DE34);
  }
  ...
  if ( *(_DWORD *)(v5 + 192) )
  {
    ViHalPreprocessOptions(
      ...
      (const void *)9,
      a1);
    VfReportIssueWithOptions(0xE6u, 9uLL, a1, *(int *)(v5 + 192), v5, byte_140C0DE30);
  }
  if ( *(_DWORD *)(v5 + 200) )
  {
    ViHalPreprocessOptions(
      ...
      (const void *)0xA,
      a1);
    VfReportIssueWithOptions(0xE6u, 0xAuLL, a1, *(int *)(v5 + 200), v5, byte_140C0DE44);
  }
  v6 = KeAcquireSpinLockRaiseToDpc(&qword_140C369B0);
  if ( !*(_QWORD *)(v5 + 64) )
  {
    v7 = *(_QWORD *)v5;
    v8 = *(_QWORD **)(v5 + 8);
