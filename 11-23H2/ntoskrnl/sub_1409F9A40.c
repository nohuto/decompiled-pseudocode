/*
 * XREFs of sub_1409F9A40 @ 0x1409F9A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1409F9A40(__int64 a1, _DWORD *a2, _DWORD *a3, unsigned int a4, _DWORD *a5, _BYTE *a6)
{
  _DWORD *v8; // rbx
...
LABEL_37:
  ...
  if ( v40 )
  {
    v27 = a5;
    *a6 = 1;
    return (unsigned int)sub_1409F989C(v8, a3, a4, v27, 0);
  }
  else
  {
    v26 = -1073741772;
