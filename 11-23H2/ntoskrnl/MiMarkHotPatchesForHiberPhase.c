/*
 * XREFs of MiMarkHotPatchesForHiberPhase @ 0x140642D80
 * Callers:
...
__int64 __fastcall MiMarkHotPatchesForHiberPhase(__int64 a1)
{
  ...
  if ( qword_140C69870 == v1 )
    return MiMarkNonPagedHiberPhasePages(
             *(_QWORD *)(qword_140C69868 + 48),
             v2 + *(_QWORD *)(qword_140C69868 + 48) + *(unsigned int *)(qword_140C69868 + 64) - 1LL,
             0LL);
  return result;
}
