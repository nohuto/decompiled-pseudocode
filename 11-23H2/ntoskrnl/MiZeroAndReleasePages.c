  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v7 == v8 )
        break;
      v9 = *v7;
      if ( (__int64 *)v7[1] != v8 || *(__int64 **)(v9 + 8) != v7 )
        goto LABEL_113;
      *v8 = v9;
      *(_QWORD *)(v9 + 8) = v8;
      --v8[2];
      ...
      v11 = (__int64)(v7 + 0x44000000000LL);
...
LABEL_12:
      ...
      else
      {
        if ( v4 )
        {
          v44 = *(_QWORD *)(qword_140C673C8 + 8 * (((unsigned __int64)v7[5] >> 43) & 0x3FF));
          v45 = MiSearchNumaNodeTable(0xAAAAAAAAAAAAAAABuLL * (v11 >> 4));
          PageChains = MiCreatePageChains(v44, *((unsigned int *)v45 + 2), 3LL);
          v3 = PageChains;
          if ( PageChains )
          {
        ...
        if ( (_DWORD)v5 == 3 )
          ...
          MiZeroLargePage(v9, v7, (unsigned int)v5, v47);
        v48 = &v66[v6];
        ...
        *(_QWORD *)(v20 + 8) = result;
        ...
        if ( v17 == 3 )
        {
          ...
          *((_BYTE *)v19 + 34) = *((_BYTE *)v19 + 34) & 0xF8 | 6;
          ...
          v28 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v27 + 40) >> 43) & 0x3FFLL));
          v29 = (_QWORD *)qword_140C69888;
          if ( qword_140C69888 )
          {
...
LABEL_116:
              if ( (_UNKNOWN *)v28 != &MiSystemPartition
                || (v32 = KeGetCurrentPrcb(),
                    _m_prefetchw((const void *)&v32->CachedCommit),
                    CachedCommit = v32->CachedCommit,
                    (unsigned __int64)(v31 + CachedCommit) > 0x100) )
              {
LABEL_30:
                v34 = _InterlockedExchangeAdd64((volatile signed __int64 *)(v28 + 17576), -v31);
                v35 = *(_QWORD *)(v28 + 16416);
                if ( v34 >= v35 && v34 - v31 < v35 || (v36 = *(_QWORD *)(v28 + 16408), v34 >= v36) && v34 - v31 < v36 )
                  MiSyncCommitSignals(v28, 0LL);
                goto LABEL_32;
              }
              while ( 1 )
              {
                v43 = _InterlockedCompareExchange(
                        (volatile signed __int32 *)&v32->CachedCommit,
                        CachedCommit + v31,
                        CachedCommit);
                if ( v43 == CachedCommit )
                  break;
                CachedCommit = v43;
                if ( (unsigned __int64)(v43 + v31) > 0x100 )
                  goto LABEL_30;
              }
              v37 = v25;
LABEL_33:
...
LABEL_36:
  ...
  if ( v16 && (v64 & 1) == 0 )
  {
    _InterlockedExchangeAdd64(&qword_140C6F3F8, v16);
    if ( v16 <= 0x40 )
    {
      result = &dword_140C6F400;
      _InterlockedIncrement(&dword_140C6F400);
    }
    else if ( v16 <= 0x80 )
    {
      result = &dword_140C6F404;
      _InterlockedIncrement(&dword_140C6F404);
    }
    else
    {
      result = (volatile signed __int32 *)&unk_140C6F40C;
      if ( v16 <= 0x200 )
        result = (volatile signed __int32 *)&unk_140C6F408;
