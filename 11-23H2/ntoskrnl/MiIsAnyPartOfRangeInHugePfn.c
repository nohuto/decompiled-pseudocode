/*
 * XREFs of MiIsAnyPartOfRangeInHugePfn @ 0x1406212E0
 * Callers:
...
__int64 __fastcall MiIsAnyPartOfRangeInHugePfn(unsigned __int64 a1, __int64 a2)
{
  ...
  v4 = (a1 >> 18) & 0x3FFFFF;
  v5 = v3 - v4 + 1;
  if ( v4 >= qword_140C67DE0 )
    return 1LL;
  if ( v5 <= 1 )
    return v3 != v4 || _bittest64((const signed __int64 *)(qword_140C67DE8 + 8 * (v4 >> 6)), v4 & 0x3F);
  if ( qword_140C67DE0 - v4 < v5 )
    return 1LL;
  v7 = (__int64 *)(qword_140C67DE8 + 8 * (v4 >> 6));
  v8 = *v7;
  v9 = qword_140C67DE8 + 8 * (v3 >> 6);
  if ( v7 != (__int64 *)v9 )
  {
