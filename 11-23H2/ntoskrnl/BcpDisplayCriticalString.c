        ...
        else
        {
          while ( 1 )
          {
            ...
            if ( v8 < v21 + v9 && v15 )
            {
              if ( v9 < v8 )
              {
                StringAdvanceWidth = BcpPrintSpaces(qword_140C70BA0, v9, v8, v10, v28, (__int64)&v34);
                if ( StringAdvanceWidth < 0 )
                  goto LABEL_42;
                if ( v15 < v34 )
                  v15 = v34;
