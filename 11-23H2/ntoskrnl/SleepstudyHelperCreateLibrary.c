/*
 * XREFs of SleepstudyHelperCreateLibrary @ 0x140848930
 * Callers:
 *     SleepstudyHelper_Initialize @ 0x1408488E0 (SleepstudyHelper_Initialize.c)
    ...
    if ( SshpInitialized && SSHSupportQueryIsLibraryEnabled() )
    {
      ...
      if ( NonPaged )
      {
        ...
        *v8 = v8;
        ...
        v9 = (_QWORD *)qword_140C38B78;
        if ( *(__int64 **)qword_140C38B78 != &SshpLibraryList )
          __fastfail(3u);
        *v7 = &SshpLibraryList;
        v7[1] = v9;
        *v9 = v7;
        qword_140C38B78 = (__int64)v7;
