/*
 * XREFs of PnpIsChainDereferenced @ 0x1403D42E0
 * Callers:
 ...
 *     PnpIsAnyDeviceInUse @ 0x1403D43F8 (PnpIsAnyDeviceInUse.c)
 *     PnpUpdateExtensionFlags @ 0x1403D4444 (PnpUpdateExtensionFlags.c)
