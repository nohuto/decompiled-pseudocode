/*
 * XREFs of CmFcManagerUnregisterFeatureConfigurationChangeNotification @ 0x140A271DC
 * Callers:
 *     RtlUnregisterFeatureConfigurationChangeNotification @ 0x1409BD4F0 (RtlUnregisterFeatureConfigurationChangeNotification.c)
 * Callees:
