/*
 * XREFs of WdHwCreateHardwareRegister @ 0x14052A7E8
 * Callers:
 ...
 *     WdHwpGetReadMethod @ 0x14052A91C (WdHwpGetReadMethod.c)
 *     WdHwpGetWriteMethod @ 0x14052A98C (WdHwpGetWriteMethod.c)
 */
