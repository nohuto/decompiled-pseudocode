/*
 * XREFs of WdHwCreateHardwareRegister @ 0x14052A298
 * Callers:
 ...
 *     WdHwpGetReadMethod @ 0x14052A3CC (WdHwpGetReadMethod.c)
 *     WdHwpGetWriteMethod @ 0x14052A43C (WdHwpGetWriteMethod.c)
 */
