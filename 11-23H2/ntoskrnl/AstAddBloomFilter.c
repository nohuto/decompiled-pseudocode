/*
 * XREFs of AstAddBloomFilter @ 0x1407AE2B4
 * Callers:
...
int __fastcall AstAddBloomFilter(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  *(_BYTE *)(qword_140C5D6C8 + ((unsigned __int64)(unsigned int)v6 >> 3)) |= 1 << (v6 & 7);
  v3 = v7;
  *(_BYTE *)(qword_140C5D6C8 + ((unsigned __int64)HIDWORD(v6) >> 3)) |= 1 << (BYTE4(v6) & 7);
  v4 = (_BYTE *)(qword_140C5D6C8 + ((unsigned __int64)v3 >> 3));
