/*
 * XREFs of PnpInitializeBootStartDriver @ 0x140B3DA00
 * Callers:
 ...
 *     VfDriverInitStarting @ 0x140ABD304 (VfDriverInitStarting.c)
 *     VfDriverInitSuccess @ 0x140ABD430 (VfDriverInitSuccess.c)
