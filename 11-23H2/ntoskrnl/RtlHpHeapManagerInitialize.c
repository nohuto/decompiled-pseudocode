/*
 * XREFs of RtlHpHeapManagerInitialize @ 0x1403887E0
 * Callers:
...
void __fastcall RtlHpHeapManagerInitialize(_RTL_RUN_ONCE *a1, _RTL_RUN_ONCE *a2)
{
  ...
  *((_DWORD *)&a1[21].2 + 1) = 2056;
  ...
  qword_140C37CA8 = (__int64)&unk_140C37CB8;
  dword_140C37CA4 = 2048;
  memset64(&unk_140C37CB8, (unsigned __int64)&RtlpHpHeapVaCallbacksRegistrar + 1, 0x40uLL);
  v6 = a1 + 1812;
  a1[1819].Ptr = a2->Ptr;
  v7 = 4LL;
  do
