/*
 * XREFs of MiCommitPagefileBackedSection @ 0x1407DC358
 * Callers:
        ...
        __int64 a9)
{
  ...
  v13 = a3 >> 12;
  v14 = a4 >> 12;
  ProtoPteAddress = (__int64 *)MiGetProtoPteAddress(a2, a3 >> 12, 0, (__int64 *)&v22);
  ...
  if ( v16 )
  {
    ...
    for ( i = (ULONG_PTR)v22; ; i = v19 )
    {
      ...
      if ( v19 == v23[0] )
      {
        if ( !ProtoPteAddress )
        {
          v21 = MiGetProtoPteAddress(a2, v13, 0, (__int64 *)&v22);
          v17 = v22;
          ProtoPteAddress = (__int64 *)v21;
        }
        v11 = a3;
        goto LABEL_3;
      }
