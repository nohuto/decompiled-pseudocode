...
__int64 __fastcall VrpFindOrCreateDiffHiveEntryForMountPoint(PCUNICODE_STRING String1, __int64 a2, __int64 *a3)
{
  ...
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&gLoadedDiffHivesLock, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&gLoadedDiffHivesLock, 0LL, v8, (__int64)&gLoadedDiffHivesLock);
  if ( v8 )
    *(_BYTE *)(v8 + 18) = 1;
...
LABEL_25:
  ...
  {
    v23 = DiffHiveEntry[1] & (-1LL << (dword_140C0E334 & 0x1F));
    v17 = qword_140C0E338;
    v18 = (37
         * (BYTE6(v23)
          + 37
         ...
         + HIBYTE(v23)) & (((unsigned int)dword_140C0E334 >> 5) - 1);
    *DiffHiveEntry = *(_QWORD *)(qword_140C0E338 + 8 * v18);
