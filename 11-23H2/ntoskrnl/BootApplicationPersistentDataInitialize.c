/*
 * XREFs of BootApplicationPersistentDataInitialize @ 0x140B546AC
 * Callers:
...
void __fastcall BootApplicationPersistentDataInitialize(__int64 a1)
{
  ...
  qword_140D160F8 = &qword_140D160F0;
  qword_140D160F0 = (__int64)&qword_140D160F0;
    ...
    if ( *((_DWORD *)v3 + 6) )
    {
      ...
      *((_DWORD *)Pool2 + 6) = *((_DWORD *)v3 + 6);
      ...
      if ( *(__int64 **)qword_140D160F8 != &qword_140D160F0 )
        __fastfail(3u);
      *Pool2 = &qword_140D160F0;
      Pool2[1] = v6;
      *v6 = Pool2;
      qword_140D160F8 = Pool2;
    }
  }
}
