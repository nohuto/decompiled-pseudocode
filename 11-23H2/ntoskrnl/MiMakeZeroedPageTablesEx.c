/*
 * XREFs of MiMakeZeroedPageTablesEx @ 0x140214310
 * Callers:
 ...
 *     MiSetLeafFillToUninitializedWsle @ 0x1406623E8 (MiSetLeafFillToUninitializedWsle.c)
...
LABEL_13:
  v15 = a5;
  v16 = *(_QWORD *)(qword_140C673C8 + 8LL * *((unsigned __int16 *)AnyMultiplexedVm + 87));
  v35[44] = -1LL;
  LODWORD(v35[16]) = a3;
  v35[12] = v16;
  HIDWORD(v35[15]) = a5;
  ...
  else if ( v10 >= 0xFFFFDE0000000000uLL && v10 < 48 * qword_140C65BA0 - 0x21FFFFFFFFD0LL || a4 == 17 )
  {
    v35[44] = 0LL;
  }
  MiInitializeColorBase(v10, v15, (__int64)&v35[42]);
  v17 = HIDWORD(v35[43]) >> byte_140C65A8D;
  if ( (a3 & 0x80u) != 0 )
  {
