/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x1405A8020
 * Callers:
...
__int64 __fastcall RtlFindLongestRunClearCapped(unsigned int *a1, unsigned int a2, unsigned int *a3)
{
  ...
  for ( i = 0; i < v7; ++i )
  {
    ...
    if ( v16 )
    {
      ...
      v13 = 8 * v12 - v11 + 8;
      v20 = *((_BYTE *)qword_140016E90 - v11) | byte_140018F88[v19];
      while ( 1 )
      {
        v16 |= v20;
        if ( v16 == 0xFF )
