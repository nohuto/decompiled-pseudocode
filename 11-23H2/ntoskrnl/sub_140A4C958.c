/*
 * XREFs of sub_140A4C958 @ 0x140A4C958
 * Callers:
...
__int64 __fastcall sub_140A4C958(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v6; // edx
  unsigned int *v7; // rax
  unsigned int i; // ecx
        ...
        if ( v7 )
        {
          if ( *(_DWORD *)a1 > 3u )
          {
            ...
            if ( v7 + 1 >= v7 )
            {
              ...
              {
                if ( stru_140C0EE20.Header.SignalState || !dword_140D53124 )
                {
