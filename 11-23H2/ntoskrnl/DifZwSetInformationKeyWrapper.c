/*
 * XREFs of DifZwSetInformationKeyWrapper @ 0x1405F7610
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG KeySetInformationLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(635);
...
LABEL_8:
  ...
  *(_QWORD *)&v20 = 0LL;
LABEL_10:
  *(_QWORD *)&v22 = KeyHandle;
  DWORD2(v21) = KeySetInformationClass;
  *(_QWORD *)&v21 = KeySetInformation;
  DWORD2(v20) = KeySetInformationLength;
...
LABEL_17:
  result = ZwSetInformationKey(KeyHandle, KeySetInformationClass, KeySetInformation, KeySetInformationLength);
  DWORD2(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
