/*
 * XREFs of MmMarkHiberPhase @ 0x140AACB50
 * Callers:
...
__int64 MmMarkHiberPhase()
{
  ...
  PoSetHiberRange(0LL, 0x14000u, qword_140C69758, 1uLL, 0x61676D4Du);
  ...
  if ( MiIsRetpolineEnabled() )
  {
    PoSetHiberRange(
      ...
      0x10000u,
      qword_140C65858,
      8 * (((unsigned __int64)qword_140C65850 >> 6) + ((qword_140C65850 & 0x3F) != 0)),
      0x62706D4Du);
    PoSetHiberRange(0LL, 0x10000u, Base, (unsigned int)(dword_140C65880 << 12), 0x62706D4Du);
  }
  MiMarkNonPagedHiberPhasePages(qword_140C66F50, qword_140C66F50 + qword_140C66F58 - 1, 0);
  ...
  while ( v3 );
  v5 = (_QWORD *)*((_QWORD *)&xmmword_140C69580 + 1);
  i = 0LL;
  while ( v5 )
  {
    i = v5;
