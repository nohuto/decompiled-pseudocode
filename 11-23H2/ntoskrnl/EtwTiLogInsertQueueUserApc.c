/*
 * XREFs of EtwTiLogInsertQueueUserApc @ 0x140363F94
 * Callers:
...
void EtwTiLogInsertQueueUserApc(char a1, __int64 a2, __int64 a3, ...)
{
  ...
  unsigned __int64 v39; // [rsp+58h] [rbp-28h] BYREF
  unsigned __int64 v40; // [rsp+60h] [rbp-20h] BYREF
  ...
  if ( EtwProviderEnabled(EtwThreatIntProvRegHandle, 0, 0x3000uLL) )
  {
    ...
    v9 = 0;
    v10 = (_BYTE)v48 ? v8 == (_KPROCESS *)v6 : Process == (_KPROCESS *)v6;
    LOBYTE(v9) = !v10;
    if ( v9 )
    {
      ...
      {
        Pool2 = (_QWORD *)ExAllocatePool2(64LL, 672LL, 1853049172LL);
        v13 = Pool2;
        if ( Pool2 )
        {
          v14 = EtwpTiFillProcessIdentity(Pool2, (__int64)Process, &v39);
          ...
          *v20 = a2 + 1232;
          ...
          v20[2] = a2 + 1152;
          v20[3] = 8LL;
          v21 = EtwpTiFillProcessIdentity(&v13[2 * v18], (__int64)v8, &v41);
          ...
          if ( v33 )
            v34 = v42;
          v38 = v34;
          EtwpTiVadQueryEventWrite((_DWORD)v13, 42, v32, v6, (__int64)&v37, 2, (__int64)v11, v33, v36);
