/*
 * XREFs of PiDqObjectManagerEnumerateAndRegisterQuery @ 0x1407FA238
 * Callers:
...
LABEL_2:
    ...
    if ( !v9 )
    {
      ...
      else
      {
        ...
        Object = PiDmGetObject(*((unsigned int *)v17 + 6), (__int64)v6, &P);
        EnumObject = Object;
      ...
      if ( v10 == 1 )
      {
        ...
        while ( 2 )
        {
          if ( *v25 )
          {
            ...
            v29 = PiDmGetObject(*(unsigned int *)&Resource[2].ActiveCount, (__int64)v25, &P);
            EnumObject = v29;
            if ( v29 == -1073741772 )
            {
              EnumObject = 0;
            ...
            else
            {
              ...
              if ( (unsigned __int8)PiDmObjectIsEnumerable((ULONG_PTR)P) )
                EnumObject = PiDqQueryEnumObject((struct _SECURITY_SUBJECT_CONTEXT *)a2, (__int64)v30);
...
LABEL_56:
    ...
    {
      v11 = PiDmGetObject(*(unsigned int *)&Resource[2].ActiveCount, *(_QWORD *)(v8 + 24), &P);
      EnumObject = v11;
      if ( v11 != -1073741772 )
      {
        if ( v11 < 0 )
        ...
        v12 = (char *)P;
        if ( (unsigned __int8)PiDmObjectIsEnumerable((ULONG_PTR)P) )
          EnumObject = PiDqQueryEnumObject((struct _SECURITY_SUBJECT_CONTEXT *)a2, (__int64)v12);
