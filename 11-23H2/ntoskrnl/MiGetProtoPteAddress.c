/*
 * XREFs of MiGetProtoPteAddress @ 0x140272E90
 * Callers:
 ...
 *     MiComputeImageVadCommitCharge @ 0x1406180FC (MiComputeImageVadCommitCharge.c)
 ...
 *     MiGetLargeVadMappingIndex @ 0x140646098 (MiGetLargeVadMappingIndex.c)
