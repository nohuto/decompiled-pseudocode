/*
 * XREFs of MmFlushVirtualMemory @ 0x1407B4258
 * Callers:
...
__int64 __fastcall MmFlushVirtualMemory(_KPROCESS *a1, unsigned __int64 *a2, _QWORD *a3, struct _IO_STATUS_BLOCK *a4)
{
  ...
  _QWORD *v31; // [rsp+60h] [rbp-39h] BYREF
  ...
  *v33 = v9 - v8 + 1;
  ...
  MiGetProtoPteAddress((__int64)v12, v9 >> 12, 0, (__int64 *)&v28);
  ProtoPteAddress = (struct _KTHREAD *)MiGetProtoPteAddress((__int64)v12, v8 >> 12, 0, (__int64 *)&v31);
  LastSubsection = v28;
  v20 = v31;
  CurrentThread = ProtoPteAddress;
  if ( v28 )
  {
    v28 = MiGetProtoPteAddress((__int64)v12, v15, 0, (__int64 *)&v33);
LABEL_16:
