...
LABEL_24:
      ...
      if ( (*(_DWORD *)(v5 + 48) & 0x200000) == 0 && *(__int64 *)(v5 + 120) < 0 )
      {
        ...
        v9 = KeAbPreAcquire((__int64)&qword_140C65550, 0LL);
        v10 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65550, 0LL);
        v11 = v9;
        if ( v10 )
          ExfAcquirePushLockExclusiveEx(&qword_140C65550, v9, (__int64)&qword_140C65550);
        if ( v11 )
          *(_BYTE *)(v11 + 18) = 1;
