/*
 * XREFs of DifIoOpenDeviceRegistryKeyWrapper @ 0x1405E0950
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifIoOpenDeviceRegistryKeyWrapper(
        ...
        PHANDLE DeviceRegKey)
{
  ...
  v20 = 0LL;
  v21 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(195);
...
LABEL_8:
  ...
  *(_QWORD *)&v20 = 0LL;
LABEL_10:
  *((_QWORD *)&v21 + 1) = DeviceObject;
  *(_QWORD *)&v21 = __PAIR64__(DevInstKeyType, DesiredAccess);
  *((_QWORD *)&v20 + 1) = DeviceRegKey;
...
LABEL_17:
  result = IoOpenDeviceRegistryKey(DeviceObject, DevInstKeyType, DesiredAccess, DeviceRegKey);
  LODWORD(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
