/*
 * XREFs of NtCreateWorkerFactory @ 0x140785B90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeDisableQueueingPriorityIncrement @ 0x14031E26C (KeDisableQueueingPriorityIncrement.c)
 *     ExpInitializeThreadHistory @ 0x14031E27C (ExpInitializeThreadHistory.c)
