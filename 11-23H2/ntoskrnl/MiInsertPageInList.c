/*
 * XREFs of MiInsertPageInList @ 0x14026EE90
 * Callers:
...
void __fastcall MiInsertPageInList(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  ...
  while ( 1 )
  {
    ...
    v6 = *(char **)(qword_140C673C8 + 8 * ((v5 >> 43) & 0x3FF));
    ...
    if ( v7 < qword_140C68160 || v7 >= qword_140C68160 + 2048 )
    {
    ...
    if ( (v65 & 1) != 0 && (a2 & 8) != 0 && byte_140C65AE8 )
    {
      a2 = a2 & 0xFFFFFFF3 | 4;
    ...
    {
      v9 = (unsigned int)dword_140C65690;
      v86 = dword_140C65690;
...
LABEL_87:
  ...
  else
  {
    if ( (_DWORD)v9 != 4 )
    {
      if ( v8 != &qword_140C65688 && (*(_BYTE *)(BugCheckParameter2 + 35) & 0x40) != 0 )
