/*
 * XREFs of sub_140762330 @ 0x140762330
 * Callers:
...
__int64 __fastcall sub_140762330(__int64 a1, __int64 a2, void **a3)
{
  int v4; // ebx
  _DWORD *v5; // rbx
  char v6; // r14
  ...
  v32 = 0;
  v33 = 0;
  v38 = (unsigned int)dword_140C70A70;
  v4 = WbAlloc(88LL, &v28);
  if ( v4 >= 0 )
  {
    v5 = v28;
    ...
    *((_QWORD *)v5 + 10) = 1LL;
    ...
    if ( v7 == 1 )
    {
      v4 = sub_140761F18((UCHAR *)(a2 + 16), 0xF8u);
      if ( v4 < 0 )
        goto LABEL_59;
    ...
    else
    {
      ...
      v4 = sub_140761F18((UCHAR *)(a2 + 16), 0xF0u);
      if ( v4 < 0 )
        goto LABEL_59;
