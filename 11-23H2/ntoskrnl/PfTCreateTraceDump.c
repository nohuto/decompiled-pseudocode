...
__int64 __fastcall PfTCreateTraceDump(__int64 *a1)
{
  ...
  v4 = 0;
  v5 = 0;
  for ( i = 0; (__int64 *)v1 != &qword_140C65198; v1 = *(_QWORD *)v1 )
    i += *(_DWORD *)(v1 + 32);
  v7 = 2LL * i;
    ...
    do
    {
      ...
      else
      {
        ...
        if ( v16 < (unsigned __int16)v17 || v16 >= (unsigned int)(v17 + *(_DWORD *)(v2 + 32)) )
        {
          ...
          {
            v66 = *(_QWORD *)(v66 + 8);
            if ( (__int64 *)v66 == &qword_140C65198 )
              v66 = qword_140C651A0;
            if ( v66 == v2 )
              break;
...
LABEL_14:
      ...
      else
      {
        ...
        if ( v15 < (unsigned __int16)v21 || v15 >= (unsigned int)(v21 + *(_DWORD *)(v2 + 32)) )
        {
          ...
          {
            v68 = *(_QWORD *)(v68 + 8);
            if ( (__int64 *)v68 == &qword_140C65198 )
              v68 = qword_140C651A0;
            if ( v68 == v2 )
              break;
...
LABEL_26:
  ...
  while ( v10 != (__int64 *)qword_140C65170 );
  if ( v4 )
  {
    v27 = 16 * v4;
    v28 = 32 * v5;
            ...
            if ( ((unsigned __int8)*(_QWORD *)v38 & 3u) < 2 )
            {
              ...
              else
              {
                ...
                if ( v44 < (unsigned __int16)v45 || v44 >= (unsigned int)(v45 + *(_DWORD *)(v2 + 32)) )
                {
                  ...
                  {
                    v62 = *(_QWORD *)(v62 + 8);
                    if ( (__int64 *)v62 == &qword_140C65198 )
                      v62 = qword_140C651A0;
                    if ( v62 == v2 )
                      break;
...
LABEL_54:
              ...
              else
              {
                ...
                if ( v43 < (unsigned __int16)v49 || v43 >= (unsigned int)(v49 + *(_DWORD *)(v2 + 32)) )
                {
                  ...
                  {
                    v64 = *(_QWORD *)(v64 + 8);
                    if ( (__int64 *)v64 == &qword_140C65198 )
                      v64 = qword_140C651A0;
                    if ( v64 == v2 )
                      break;
...
LABEL_59:
        ...
        if ( v35 == (__int64 *)qword_140C65170 )
          break;
        v3 = 0;
      }
...
LABEL_71:
  PfTFreeBufferList(&unk_140C65158);
  PfTFreeBufferList(&unk_140C65180);
  return v58;
}
