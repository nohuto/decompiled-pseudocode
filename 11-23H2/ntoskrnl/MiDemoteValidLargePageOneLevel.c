/*
 * XREFs of MiDemoteValidLargePageOneLevel @ 0x14038F884
 * Callers:
...
__int64 __fastcall MiDemoteValidLargePageOneLevel(unsigned __int64 a1)
{
  ...
  *v8 = 0LL;
  ...
  v13 = ValidPte;
  v14 = ValidPte;
  if ( ((unsigned __int8)(1 << (v2 - 1)) & (unsigned __int8)byte_140C65A8F) != 0 )
  {
...
LABEL_9:
  ...
  if ( *(_DWORD *)v43 == 1 )
    v20 = -2147483644;
  v22 = v20;
  LODWORD(v22) = v20 | 0x20000000;
  if ( (v45 & 0x100) == 0 )
    v22 = v20;
  LODWORD(v22) = v22 | 0x8000000;
  v23 = MiMakeValidPte(v3, v47, v22);
  v24 = v46;
  v41 = v23;
