/*
 * XREFs of DifPoFxCompleteIdleConditionWrapper @ 0x1405E98D0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall DifPoFxCompleteIdleConditionWrapper(_QWORD *BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  unsigned int v3; // ebp
