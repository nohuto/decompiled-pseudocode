/*
 * XREFs of PnpTraceIommuDeviceProperties @ 0x14096C06C
 * Callers:
...
void PnpTraceIommuDeviceProperties()
{
  ...
  if ( (unsigned int)dword_140C03918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03918, 0x400000000000LL) )
    {
      ...
      v8 = 2LL;
      v12 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03918, (unsigned __int8 *)byte_14002CB08, 0LL, 0LL, 6u, &v4);
    }
  }
}
