/*
 * XREFs of MiGetPartitionNodeInformation @ 0x14065A5F8
 * Callers:
...
void __fastcall MiGetPartitionNodeInformation(__int64 a1, unsigned int a2, _QWORD *a3)
{
  ...
  else
  {
    ...
    if ( v10->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(0LL, (__int64)v10)) != 0 )
    {
      ...
      _enable();
      v9 = (__int64)(&v10[1].Process + 12 * v43);
      if ( (unsigned __int64)(v8 - qword_140C659E8) >= 0x8000000000LL )
        SessionId = -1;
      else
        SessionId = MmGetSessionIdEx((__int64)v10->ApcState.Process);
      *(_DWORD *)(v9 + 8) = SessionId;
      *(_QWORD *)v9 = v8 & 0x7FFFFFFFFFFFFFFCLL;
    }
