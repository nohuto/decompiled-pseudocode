/*
 * XREFs of KiInsertTimer2WithCollectionLockHeld @ 0x14024F5B0
 * Callers:
...
LABEL_51:
  ...
  else
  {
    *(_BYTE *)(a1 + 131) = v17 & 0xEF;
    v18 = (unsigned __int64 *)(0x140000000LL + 24LL * (v17 & 7) + 12853888);
    v19 = *(_QWORD *)(0x140000008LL + 24LL * (v17 & 7) + 12853888);
    v20 = *v18;
    if ( (v19 & 1) == 0 )
      goto LABEL_22;
    if ( v20 )
