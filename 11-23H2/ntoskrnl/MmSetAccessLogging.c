...
__int64 __fastcall MmSetAccessLogging(int a1, int a2)
{
  ...
  {
    if ( stru_140C67FC8.Parameter )
    {
      if ( stru_140C67FC8.Parameter == (void *)2 )
        stru_140C67FC8.Parameter = (void *)3;
    }
    else
    {
      stru_140C67FC8.List.Flink = 0LL;
      stru_140C67FC8.WorkerRoutine = (void (__fastcall *)(void *))MiEmptyAccessLogs;
      stru_140C67FC8.Parameter = (void *)1;
      ExQueueWorkItem(&stru_140C67FC8, DelayedWorkQueue);
    }
