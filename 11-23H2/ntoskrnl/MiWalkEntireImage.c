...
__int64 __fastcall MiWalkEntireImage(ULONG_PTR a1, ULONG_PTR a2, unsigned int a3, unsigned int a4)
{
  ...
  v9 = 0;
  v160 = v4 & 8;
  v10 = *(_QWORD *)(qword_140C673C8 + 8LL * (v8 & 0x3FF));
  v11 = *(_BYTE *)(a1 + 62) & 0xC;
  v188 = v10;
  if ( v11 == 4 && (v4 & 8) == 0 )
  {
...
LABEL_3:
  ...
  if ( (_DWORD)v192 != 2 )
  {
    ...
    if ( (v4 & 0x28) != 0x28 )
    {
            ...
            AbEntrySummary) )
      {
        ...
        *(_QWORD *)v65 = (unsigned __int64)&qword_140C6B518 & 0x7FFFFFFFFFFFFFFCLL;
      }
      if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C6B518, 17LL, 0LL) )
      {
        ExfAcquirePushLockSharedEx(&qword_140C6B518, 0LL, v65, &qword_140C6B518);
        v15 = (_QWORD *)v154;
        v13 = v158;
        CurrentThread = v157;
      }
  ...
  while ( 1 )
  {
    ...
    if ( v73->AbEntrySummary || (v76 = KiAbTryReclaimOrphanedEntries(v20, v73), v15 = (_QWORD *)v154, v76) )
    {
      ...
      if ( v74 - qword_140C659E8 >= 0x8000000000LL )
      {
        v82 = -1;
      }
      else
...
LABEL_28:
    if ( (v9 & 8) != 0 )
    {
      ...
      if ( v127->AbEntrySummary || (v129 = KiAbTryReclaimOrphanedEntries(v20, v127), v15 = (_QWORD *)v154, v129) )
      {
        ...
        if ( v128 - qword_140C659E8 >= 0x8000000000LL )
        {
          v135 = -1;
        }
        else
...
LABEL_15:
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v31 + 40) >> 43) & 0x3FFLL)) + 4LL) & 0x80u) != 0 )
...
LABEL_401:
  ...
  else if ( qword_140C65B40 && (v32 & 0x10) == 0 )
  {
    v32 &= ~qword_140C65B40;
  }
...
LABEL_86:
    ...
    if ( (v9 & 0x10) != 0 && SlabPage == -1 )
    {
      ...
      SlabPage = MiGetSlabPage(
                   v188,
                   v167,
                   (PfnChannel << byte_140C65A8E) | (v108 << byte_140C65A8D) | dword_140C65AF8 & (unsigned int)v34,
                   v110,
    ...
    if ( (v162 & 0x10) != 0 || (v162 & 0x22) == 2 )
    {
      ...
      else
      {
        ...
        v46 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v31 + 40) >> 43) & 0x3FFLL));
        v180 = v46;
      }
      v35 = v168;
    }
...
LABEL_107:
    ...
    if ( v152 < 0 )
    {
      v17 = SlabPage;
      v57 = (__int64 *)P;
      dword_140C65810 = (v152 != -1073741670) + 113;
      goto LABEL_153;
    }
    v19 = v171;
    v4 = v162;
