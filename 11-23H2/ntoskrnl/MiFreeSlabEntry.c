/*
 * XREFs of MiFreeSlabEntry @ 0x1403B88B0
 * Callers:
...
void __fastcall MiFreeSlabEntry(__int64 a1, __int64 a2)
{
  ...
  if ( v6 <= v7 )
  {
    ...
    do
    {
      ...
      if ( v9 != 1 )
      {
        ...
        {
          v18 = (*(_QWORD *)v8 >> 59) & 7LL;
          if ( ((*(_QWORD *)v8 >> 59) & 7) == 0
            || (_InterlockedOr(v26, 0), MiTbFlushTimeStampMayNeedFlush(v18, KiTbFlushTimeStamp, 7)) )
          {
            *(_QWORD *)(v8 - 8) = v5;
            v5 = v6;
          }
          ...
          {
            MiChangePageAttribute(v6, v19 - 6, v19 - 6 + 3);
          }
        }
      }
      v28 = 0;
      ...
      if ( !v4 )
        v4 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v8 + 16) >> 43) & 0x3FFLL));
      v10 = *(_DWORD *)(a1 + 80);
      if ( v10 <= 3 && v10 != 2 )
  ...
  if ( v5 )
    MiChangePageAttributeBatch(v5, 1, ZeroPte);
  LOBYTE(v13) = 1;
  v14 = *(_QWORD *)(v3 + 24) >> 9;
  v15 = v14 & 0x1F;
  v16 = (volatile signed __int32 *)(qword_140C6F370 + 4LL * (*(_QWORD *)(v3 + 24) >> 14));
...
LABEL_14:
  ...
  if ( (v14 & 0x1F) == 0 )
    goto LABEL_33;
  v20 = v14 & 0x1F;
  _InterlockedAnd(v16++, ~(((1 << (32 - v20)) - 1) << v15));
  v13 = 1LL - (unsigned int)(32 - v20);
  if ( v13 >= 0x20 )
  {
    v21 = v13 >> 5;
    v13 += -32LL * (v13 >> 5);
