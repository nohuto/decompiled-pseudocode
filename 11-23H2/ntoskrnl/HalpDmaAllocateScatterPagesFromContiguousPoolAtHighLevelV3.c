/*
 * XREFs of HalpDmaAllocateScatterPagesFromContiguousPoolAtHighLevelV3 @ 0x1404FF720
 * Callers:
 ...
 *     HalpDmaIndexToTranslationEntry @ 0x14045CADE (HalpDmaIndexToTranslationEntry.c)
 */
