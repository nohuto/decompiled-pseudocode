/*
 * XREFs of EtwpEventTracingCounterSetCallback @ 0x140A76B80
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (unsigned int)(a1 - 2) <= 1 )
  {
    ...
    if ( v5 == 1 )
    {
      ...
      *(_DWORD *)&v17[20] = 0;
      ...
      {
        NextGuidEntry = EtwpGetNextGuidEntry(v4, i, 0);
        if ( !NextGuidEntry )
          break;
      ...
      *(_DWORD *)v17 = *(_DWORD *)(v4 + 4132);
      *(_QWORD *)&v17[4] = *(_QWORD *)(v4 + 4124);
      Data.Data = v17;
      Data.Size = 24;
    ...
    {
      v8 = 0;
      for ( j = 0LL; (unsigned int)j < *(_DWORD *)(v4 + 16); j = (unsigned int)(j + 1) )
      {
        v10 = EtwpAcquireLoggerContextByLoggerId(v4, j, 0);
        if ( v10 )
        {
          v18 = 0LL;
          v19 = 0LL;
