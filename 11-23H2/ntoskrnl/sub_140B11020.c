/*
 * XREFs of sub_140B11020 @ 0x140B11020
 * Callers:
...
__int64 __fastcall sub_140B11020(_DWORD *a1, unsigned int a2, int a3)
{
  _DWORD *v4; // rdi
  __int64 v5; // rbx
  int v6; // r10d
  ...
  if ( a3 != 3 )
  {
    ...
    {
      v16 = (*((__int64 (__fastcall **)(unsigned __int64, _QWORD, _QWORD))v4 + 30))(
...
LABEL_11:
  ...
  *(_QWORD *)&v45 = __rdtsc();
  ...
  v51 = (*((__int64 (__fastcall **)(__int64, _QWORD, __int64))v4 + 30))(66LL, (unsigned int)(v49 + 32), v47);
  v102 = v51;
  if ( !v51 )
  {
    ++v4[646];
