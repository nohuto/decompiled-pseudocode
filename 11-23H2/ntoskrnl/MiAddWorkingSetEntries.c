...
char __fastcall MiAddWorkingSetEntries(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, int a4)
{
  ...
  if ( (*(_BYTE *)(a1 + 184) & 7) == 2 )
    _InterlockedExchangeAdd(&dword_140C6A200, a3);
...
LABEL_9:
  ...
  if ( (*(_BYTE *)(a1 + 184) & 7) == 2 )
  {
    _InterlockedExchangeAdd64(&qword_140C6A208, v5);
    if ( v10 )
    {
      v52 = qword_140C6A218;
      v53 = v10 + _InterlockedExchangeAdd64(&qword_140C6A210, v10);
      if ( v53 > qword_140C6A218 )
      {
        do
        {
          v54 = v52;
          v52 = _InterlockedCompareExchange64(&qword_140C6A218, v53, v52);
        }
  ...
  if ( (v16 & 7u) >= 2 )
  {
    v44 = *(_QWORD *)(qword_140C673C8 + 8LL * *(unsigned __int16 *)(a1 + 174));
    v45 = (v16 & 7u) - 2;
    ...
    if ( (*(_BYTE *)(a1 + 184) & 7) == 4 )
    {
      ...
      else if ( (unsigned int)MiGetSystemRegionType(v6) == 12 )
      {
        ...
        if ( !v50 )
          v61 = 0LL;
        if ( v61
          || (v61 = qword_140C65970) == 0
          || (v65 = *(_QWORD *)(qword_140C65970 + 48), v49 >= v65)
          && v49 <= v65 + (unsigned int)(*(_DWORD *)(qword_140C65970 + 64) - 1) )
        {
          MmUnlockLoadedModuleListShared((unsigned __int8)v75[0]);
          if ( v61 )
            _InterlockedExchangeAdd((_DWORD *)&xmmword_140C65950 + 1, v5);
          v9 = 0;
        }
        else
        {
  ...
  if ( (v4 & 1) != 0 )
  {
    ...
    if ( v17 > *(_QWORD *)(a1 + 112) && (*(_DWORD *)(a1 + 188) & 2) == 0 )
    {
      ...
      if ( v18 > v19 )
      {
        v20 = *(_QWORD **)(qword_140C673C8 + 8LL * *(unsigned __int16 *)(a1 + 174));
        v21 = v20[2130];
...
LABEL_130:
  ...
  if ( v23 && v5 )
  {
    while ( 1 )
    {
      ...
      v80 = 0LL;
      v79 = 0LL;
      v33 = *(_QWORD *)(qword_140C673C8 + 8 * v32);
      ...
      if ( *(__int64 **)(v33 + 16928) == v35 )
        goto LABEL_36;
      *((_QWORD *)&v79 + 1) = &qword_140C697C0;
      *(_QWORD *)&v79 = 0LL;
      if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
      {
        KiAcquireQueuedSpinLockInstrumented(&v79, &qword_140C697C0);
      }
      else
      {
        v55 = (signed __int64 *)_InterlockedExchange64((volatile __int64 *)&qword_140C697C0, (__int64)&v79);
        if ( v55 )
