 ...
 *     KeAddGroupAffinityEx @ 0x1403080F0 (KeAddGroupAffinityEx.c)
 ...
 *     PspSetJobSiloThreadImpersonationPolicy @ 0x1409B3168 (PspSetJobSiloThreadImpersonationPolicy.c)
...
LABEL_14:
  ...
  if ( PreviousMode )
  {
    ...
    if ( (_DWORD)v4 )
    {
      if ( ((dword_140A7B0EC[v5] - 1) & (unsigned int)Src) != 0 )
          ...
          while ( v57 )
          {
            ...
            else
            {
              ...
              if ( (unsigned __int16)v61 > v58 )
                goto LABEL_217;
              v150 = qword_140D1EFF8[v61];
              epi16 = v139;
            }
            if ( epi16 > v58 || v200[epi16 + 1] || v150 != (v150 & qword_140D1EFF8[epi16]) )
            {
LABEL_217:
              v13 = -1073741811;
              v134 = -1073741811;
...
LABEL_172:
                  if ( ((__int64)v20[10].Header.WaitListHead.Blink & 1) != 0 && (v200[66] & 1) == 0 )
                  {
                    ...
                    if ( (qword_140D0C2D0 & 1) != 0 )
                      ExfAcquireReleasePushLockExclusive((ULONG_PTR)&qword_140D0C2D0);
                    v13 = v134;
                    v20 = Event;
                  }
                  v158[0] = (__int64)v20;
...
LABEL_241:
                ...
                if ( v199[6] != (qword_140D1EFF8[Group] & v199[6]) )
                {
                  v20 = Event;
                  goto LABEL_154;
                }
