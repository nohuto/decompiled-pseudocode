/*
 * XREFs of IpmiLibWriteOneByte @ 0x1406781FC
 * Callers:
...
unsigned __int8 __fastcall IpmiLibWriteOneByte(__int64 a1, unsigned __int8 a2, unsigned __int8 a3)
{
  ...
  {
    result = a3;
    __outbyte(xmmword_140C2CC40 + a2 * BYTE8(WheaIpmiContext), a3);
  }
  else
  {
    result = xmmword_140C2CC40;
    *(_BYTE *)(BYTE8(WheaIpmiContext) * (unsigned int)a2 + (_QWORD)xmmword_140C2CC40) = a3;
