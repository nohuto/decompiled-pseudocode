/*
 * XREFs of MiZeroLocalPages @ 0x1402CF7D0
 * Callers:
...
LABEL_216:
    ...
    v11 = *(_DWORD *)(v1 + 364) >> byte_140C65A8D;
    *(_QWORD *)(v1 + 32) = 0LL;
    *(_BYTE *)(v1 + 70) = 0;
    if ( v6 < 3 )
    {
...
LABEL_17:
    ...
    v15 = 0;
    LODWORD(v103) = v14;
    v16 = 88LL * (unsigned int)(dword_140C65AFC * (v13 - 1));
    v17 = v14;
...
LABEL_22:
      v1 = a1;
      *(_DWORD *)(a1 + 364) = *(_DWORD *)(a1 + 364) & ~dword_140C65A80 | dword_140C65A80 & (*(_DWORD *)(a1 + 364) + 1);
LABEL_23:
...
LABEL_103:
    ...
    else
    {
      ...
      {
        v72 = HIBYTE(word_140C66CFC);
        goto LABEL_160;
      }
      if ( *(_BYTE *)(((LeafVa >> 39) & 0x1FF) - 256 + v64 + 13018072) != 1
        && (LeafVa < 0xFFFFF68000000000uLL || LeafVa > v67) )
      {
        if ( LeafVa < qword_140C6A558 || (v72 = HIBYTE(word_140C66CFC), LeafVa > qword_140C67070) )
          v72 = (unsigned __int8)word_140C66CFC;
LABEL_160:
        if ( v72 )
          v70 |= 0x100uLL;
      }
    }
    v73 = (((unsigned __int16)v70 | 0x42) ^ (unsigned __int16)((unsigned __int8)word_140C66CFC << 8)) & 0x100 ^ (v70 | 0x42);
    if ( v71 )
      v73 |= 0x80uLL;
    v6 = v116;
    v74 = 0;
