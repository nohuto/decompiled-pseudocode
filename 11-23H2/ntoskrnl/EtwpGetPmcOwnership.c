/*
 * XREFs of EtwpGetPmcOwnership @ 0x1405FC56C
 * Callers:
...
__int64 __fastcall EtwpGetPmcOwnership(_DWORD *a1, unsigned int *a2)
{
  ...
  if ( *a1 > (unsigned int)KeNumberProcessors_0 )
    return 3221225485LL;
  v5 = 16 * *(_DWORD *)((char *)&NlsMbCodePageTag + 6) + 8;
  Pool2 = (_DWORD *)ExAllocatePool2(64LL, v5, 1953985605LL);
  v7 = Pool2;
  if ( Pool2 )
  {
    *Pool2 = *a1;
    v8 = ((__int64 (__fastcall *)(__int64, _QWORD, _DWORD *, int *))off_140C020E8[0])(52LL, v5, Pool2, &v16);
    if ( v8 < 0 )
    {
LABEL_29:
    ...
    v9 = v7[1];
    if ( v9 <= *(_DWORD *)((char *)&NlsMbCodePageTag + 6) )
    {
      v8 = 0;
      a1[1] = v9;
    }
    else
    {
      ...
      v8 = -2147483643;
      v9 = *(_DWORD *)((char *)&NlsMbCodePageTag + 6);
    }
    v10 = 12 * v9 + 8;
    if ( *a2 < v10 )
    {
