/*
 * XREFs of HvpDetermineLogFileApplicationOrder @ 0x1407FE7C4
 * Callers:
...
LABEL_10:
    ...
    else if ( !v9 && (unsigned int)dword_140C04390 > 5 )
    {
      LOBYTE(v7) = tlgKeywordOn((__int64)&dword_140C04390, 0x400000000000LL);
      if ( (_BYTE)v7 )
      {
        v17 = 0;
        v15 = &v13;
        ...
        LOBYTE(v7) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)byte_1400380E1,
                       0LL,
                       0LL,
                       3u,
                       &v14);
