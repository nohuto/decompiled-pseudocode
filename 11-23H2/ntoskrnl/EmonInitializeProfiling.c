/*
 * XREFs of EmonInitializeProfiling @ 0x140A896A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 EmonInitializeProfiling()
{
  ...
  if ( !Number )
  {
    ...
    qword_140C60438 = (__int64)&EmonReservedResourcesList;
    EmonReservedResourcesList = (__int64)&EmonReservedResourcesList;
    qword_140C63128 = (__int64)&HalpProfileSourceDescriptorListHead;
    ...
    if ( HalpCounterStatus && EmonCounterStatus )
    {
      ...
      do
      {
        if ( !*((_BYTE *)&EmonProfileSourceDescriptorTable + 320 * _RCX + 29) )
        {
          ...
          v26 = (_QWORD *)qword_140C63128;
          if ( *(__int64 **)qword_140C63128 != &HalpProfileSourceDescriptorListHead )
            __fastfail(3u);
          ++HalpProfileSourceDescriptorCount;
          *v25 = &HalpProfileSourceDescriptorListHead;
          v25[1] = v26;
          *v26 = v25;
          qword_140C63128 = (__int64)&EmonProfileSourceDescriptorTable + 320 * _RCX + 8;
        }
