/*
 * XREFs of MiAllocatePartitionPhysicalPages @ 0x140A445CC
 * Callers:
 ...
 *     MiHugeRangeIsZeroed @ 0x14062127C (MiHugeRangeIsZeroed.c)
        ...
        unsigned int a6)
{
  ...
  if ( (a5 & 1) != 0 )
  {
    v17 = (unsigned int *)(qword_140C65A98 + 4LL * a4 * (unsigned int)(unsigned __int16)KeNumberNodes);
    v53 = v17;
...
LABEL_36:
    ...
    if ( v6 == MiSystemPartition && (a5 & 0x200) == 0 )
      _InterlockedExchangeAdd64(&qword_140C699B0, v29);
    v30 = a3;
    v12 = v29 + v49;
    v49 = v12;
    if ( v12 == a3 )
  ...
  {
    v32 = qword_140C67DF0;
    v33 = MiLockHugePfn(qword_140C67DF0);
