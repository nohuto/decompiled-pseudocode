/*
 * XREFs of MiProbeAndLockPrepare @ 0x140234E80
 * Callers:
        ...
        char a7)
{
  ...
  *(_QWORD *)(a1 + 40) = 0LL;
  ...
  {
    v26 = byte_140C6A3D8[((v24 >> 39) & 0x1FF) - 256];
  }
  else
  {
    v26 = 0;
  ...
  switch ( v26 )
  {
    case 1:
      *(_DWORD *)(a1 + 72) = *(_DWORD *)(a1 + 72) & 0xFFFFFFF0 | 8;
      ...
      goto LABEL_56;
    case 6:
      AnyMultiplexedVm = (char *)&unk_140C69C80;
      v36 = *(_DWORD *)(a1 + 72) & 0xFFFFFFF3;
      *(_QWORD *)(a1 + 104) = &unk_140C69C80;
      v29 = v36 | 3;
      break;
    case 8:
      AnyMultiplexedVm = (char *)&unk_140C6F800;
      v38 = *(_DWORD *)(a1 + 72) & 0xFFFFFFF2;
      *(_QWORD *)(a1 + 104) = &unk_140C6F800;
      v29 = v38 | 2;
      break;
    case 5:
    case 15:
...
LABEL_18:
  *(_DWORD *)(a1 + 72) = v29 & 0xFFFFFFCF;
  ...
  if ( v30 <= (unsigned __int8)v25 )
  {
    if ( v30 == 2 )
    {
      v31 = (volatile __int32 *)&unk_140C6A180;
LABEL_21:
...
LABEL_27:
  ...
  *(_BYTE *)(a1 + 76) = v33;
  ...
  if ( v26 == 8 )
  {
    ...
    *(_QWORD *)(a1 + 104) = *(_QWORD *)(qword_140C673C8 + 8LL * (*(_WORD *)(*(_QWORD *)v40 + 60LL) & 0x3FF)) + 17344LL;
  }
  return 0LL;
}
