/*
 * XREFs of MiCreateEnclaveRegions @ 0x140B45444
 * Callers:
...
__int64 __fastcall MiCreateEnclaveRegions(__int64 a1)
{
  ...
  v1 = 0;
  qword_140C698B8 = (__int64)&qword_140C698B0;
  qword_140C698B0 = (__int64)&qword_140C698B0;
  v2 = 0LL;
  qword_140C698C0 = 0LL;
  stru_140C698C8.Count = 0LL;
  v3 = *(_QWORD *)(a1 + 360);
  if ( (v3 & 1) == 0 )
  {
    v4 = *(_QWORD *)(a1 + 360);
...
LABEL_26:
      ...
      v12 = 1;
LABEL_22:
      RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C69888, (unsigned __int64)v13, v12, v2);
LABEL_23:
