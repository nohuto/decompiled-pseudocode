/*
 * XREFs of __asan_store2_noabort @ 0x140567210
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall _asan_store2_noabort(ULONG_PTR BugCheckParameter1)
{
  ...
  if ( ((BugCheckParameter1 ^ v3) & 0xFFFFFFFFFFFFFFF8uLL) == 0 )
  {
    ...
    if ( (char)v2 <= v5 )
      return v2;
LABEL_11:
    KeBugCheckEx(0x1F2u, BugCheckParameter1, 2uLL, retaddr, (unsigned __int8)v5 | 0x100LL);
  }
  v5 = *(_BYTE *)(v4 + KasaniShadow);
