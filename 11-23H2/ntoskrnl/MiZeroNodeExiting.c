/*
 * XREFs of MiZeroNodeExiting @ 0x140655C88
 * Callers:
...
void __fastcall MiZeroNodeExiting(__int64 a1)
{
  ...
  v4 = ExAcquireSpinLockExclusive(&dword_140C67270);
...
LABEL_77:
      ...
      *(_QWORD *)(v9 + 8) = v7;
      ...
      ExAcquireSpinLockExclusive(&dword_140C67270);
      v5 = ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(v2 + 23160));
    }
    ++v6;
    v7 += 37;
  ...
  *(_QWORD *)(v2 + 23152) = 0LL;
  ...
  if ( (_DWORD)KiIrqlFlags )
  {
    ...
    if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v21 <= 0xFu && v5 <= 0xFu && v21 >= 2u )
    {
  ...
  if ( (_DWORD)KiIrqlFlags )
  {
    ...
    if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v25 <= 0xFu && (unsigned __int8)v4 <= 0xFu && v25 >= 2u )
    {
  ...
  for ( i = 0LL; i < 3; ++i )
  {
    ...
    if ( !i )
    {
      ...
      if ( (_DWORD)KiIrqlFlags )
      {
        ...
        if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v45 <= 0xFu && v39 <= 0xFu && v45 >= 2u )
        {
