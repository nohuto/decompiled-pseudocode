/*
 * XREFs of DifZwOpenProcessTokenWrapper @ 0x1405F2700
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenProcessTokenWrapper(HANDLE ProcessHandle, ACCESS_MASK DesiredAccess, PHANDLE TokenHandle)
{
...
LABEL_17:
  result = ZwOpenProcessToken(ProcessHandle, DesiredAccess, TokenHandle);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
