/*
 * XREFs of MiDetachProcessFromSession @ 0x14033F2D8
 * Callers:
...
__int64 __fastcall MiDetachProcessFromSession(_DWORD *a1)
{
  ...
  v4 = (unsigned __int64 *)(8 * (((unsigned __int64)qword_140C659E8 >> 39) & 0x1FF) - 0x90482413000LL);
  KeAcquireInStackQueuedSpinLock(&qword_140C697C0, &v18);
  if ( a1 )
  {
    v5 = 0LL;
    v6 = v3 + 104;
