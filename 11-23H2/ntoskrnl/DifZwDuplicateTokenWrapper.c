/*
 * XREFs of DifZwDuplicateTokenWrapper @ 0x1405F0220
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwDuplicateTokenWrapper(
...
LABEL_8:
  ...
  *(_QWORD *)&v21 = 0LL;
LABEL_10:
  LODWORD(v22) = TokenType;
  *((_QWORD *)&v21 + 1) = NewTokenHandle;
  *((_QWORD *)&v23 + 1) = ExistingTokenHandle;
  LODWORD(v23) = DesiredAccess;
  *((_QWORD *)&v22 + 1) = ObjectAttributes;
  BYTE4(v22) = EffectiveOnly;
