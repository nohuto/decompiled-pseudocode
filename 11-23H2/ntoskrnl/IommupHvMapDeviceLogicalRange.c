        ...
        ULONG_PTR a5)
{
  ...
  v15 = a3 >> 12;
  v11 = 1;
  v8 = ((__int64 (__fastcall *)(int *, __int64, ULONG_PTR, unsigned __int64 *, unsigned __int64 *, char))qword_140C62648)(
         &v12,
         a2,
         a5,
         &v15,
  ...
  if ( v8 < 0 )
  {
    v9 = ((__int64 (__fastcall *)(int *, ULONG_PTR, unsigned __int64 *))qword_140C62650)(&v12, BugCheckParameter4, &v14);
    if ( v9 < 0 )
