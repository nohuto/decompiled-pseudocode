/*
 * XREFs of LdrpArmProcessRelocation @ 0x1405B1104
 * Callers:
 *     LdrpThumbProcessRelocation @ 0x1405B128C (LdrpThumbProcessRelocation.c)
 *     LdrProcessRelocationBlockLongLong @ 0x1409C20E8 (LdrProcessRelocationBlockLongLong.c)
 * Callees:
 *     <none>
 */
