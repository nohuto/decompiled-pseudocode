/*
 * XREFs of LdrpArmProcessRelocation @ 0x1405B0B94
 * Callers:
 *     LdrpThumbProcessRelocation @ 0x1405B0D1C (LdrpThumbProcessRelocation.c)
 *     LdrProcessRelocationBlockLongLong @ 0x1409C1EE8 (LdrProcessRelocationBlockLongLong.c)
 * Callees:
 *     <none>
 */
