/*
 * XREFs of KeAccumulateTicks @ 0x1402C7DA0
 * Callers:
 ...
 *     KiResetGlobalDpcWatchdogProfiler @ 0x14056BA50 (KiResetGlobalDpcWatchdogProfiler.c)
 *     KiDeferDpcWatchdogViolation @ 0x14057B284 (KiDeferDpcWatchdogViolation.c)
          ...
          else
          {
            ...
            *(_QWORD *)(v34 + 64) = *(_QWORD *)(v35 + 24);
            KiInsertQueueDpc(
              v34,
              *(_QWORD *)(a1 + 8),
              0x7E35C6C7F3DD7277LL
            * (KiWaitNever ^ __ROR8__(*(_QWORD *)(v35 + 24) ^ _byteswap_uint64(KiWaitAlways ^ v35), KiWaitNever)),
              0LL,
              0);
          }
        }
...
LABEL_27:
    ...
    if ( v21 == (unsigned int)v22 >> 1 )
      KiInsertQueueDpc(a1 + 34264, 0LL, 0LL, 0LL, 0);
...
LABEL_9:
  if ( v12 != *(_QWORD *)(a1 + 24)
    ...
    && (*(char *)(v12 + 195) < 16
     ...
     && (unsigned int)KiGetThreadEffectiveRankNonZero(v12, v37, 0, 0LL)
     || *(char *)(v12 + 195) < 8) )
  {
    *(_DWORD *)(a1 + 33132) += v11;
  }
