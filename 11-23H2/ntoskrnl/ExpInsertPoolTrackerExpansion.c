/*
 * XREFs of ExpInsertPoolTrackerExpansion @ 0x140608088
 * Callers:
    ...
    do
    {
      ...
      if ( !v12 )
      {
        *(_DWORD *)(80 * v7 + PoolTrackTableExpansion) = v4;
        v13 = v4 & (-1LL << (dword_140CF8104 & 0x1F));
        if ( (unsigned int)dword_140CF8104 >> 5 )
        {
          v63 = v4 & (-1LL << (dword_140CF8104 & 0x1F));
          v14 = (char *)qword_140CF8108
              + 8
              * ((37
                * (BYTE6(v13)
                 + 37
                ...
                + HIBYTE(v13)) & (((unsigned int)dword_140CF8104 >> 5) - 1));
          while ( 1 )
          {
            v15 = (_QWORD *)*v14;
            v14 = v15;
            if ( ((unsigned __int8)v15 & 1) != 0 )
              break;
            if ( v13 == ((-1LL << (dword_140CF8104 & 0x1F)) & v15[1]) )
            {
              if ( v15 )
                goto LABEL_13;
              break;
    ...
    else
    {
      ...
      else
      {
        ...
        if ( (_DWORD)KiIrqlFlags )
        {
          ...
          if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v42 <= 0xFu && v62.OldIrql <= 0xFu && v42 >= 2u )
          {
...
LABEL_63:
  ...
  if ( (_DWORD)KiIrqlFlags )
  {
    ...
    if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v48 <= 0xFu && LockHandle.OldIrql <= 0xFu && v48 >= 2u )
    {
