/*
 * XREFs of HvlpDynamicUpdateMicrocode @ 0x140941598
 * Callers:
 *     HvlUpdateMicrocodeDatabase @ 0x140941580 (HvlUpdateMicrocodeDatabase.c)
 * Callees:
 ...
 *     HvcallInitInputControl @ 0x140372BF0 (HvcallInitInputControl.c)
