/*
 * XREFs of PiDqIrpQueryCreate @ 0x1407F9148
 * Callers:
 ...
 *     PiDqQueryGetNextIoctlInfo @ 0x1407FA39C (PiDqQueryGetNextIoctlInfo.c)
 *     PnpConvertDevpropcompkeyArrayToString @ 0x14095882C (PnpConvertDevpropcompkeyArrayToString.c)
 *     PiDqConvertObjectTypeToString @ 0x14095BFEC (PiDqConvertObjectTypeToString.c)
 *     PiDqConvertQueryFlagsToString @ 0x14095C0B4 (PiDqConvertQueryFlagsToString.c)
 *     FilterConvertToString @ 0x140A6ED58 (FilterConvertToString.c)
...
__int64 __fastcall PiDqIrpQueryCreate(_QWORD *a1)
{
  ...
  if ( ValidateQueryData < 0 )
    goto LABEL_13;
  NdrMesTypeDecode3(*(_QWORD *)(v3 + 16), "TP 3\a", &off_140002940, &off_140C02F40, 0, v3 + 24);
