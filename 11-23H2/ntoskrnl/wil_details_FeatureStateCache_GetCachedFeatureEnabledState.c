/*
 * XREFs of wil_details_FeatureStateCache_GetCachedFeatureEnabledState @ 0x1403333D0
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1405083BC (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
