...
char ExpWatchProductTypeInitialization()
{
  ...
  *(_BYTE *)(MmWriteableSharedUserData + 616) = 1;
  ...
  qword_140C31850 = (__int64)ExpWatchProductTypeWork;
  qword_140C31858 = 0LL;
  ...
  else
  {
    ...
    if ( Pool2 )
    {
      ...
      else
      {
        ...
        qword_140C70D48 = (PVOID)ExAllocatePool2(256LL, (unsigned int)BugCheckParameter2, 0x2079654Bu);
        if ( !qword_140C70D48 )
