/*
 * XREFs of MiHotRemoveHugeRange @ 0x140620624
 * Callers:
...
void __fastcall MiHotRemoveHugeRange(ULONG_PTR BugCheckParameter2, ULONG_PTR a2, int a3)
{
  ...
  v7 = a2;
  v8 = (unsigned __int64 *)(8 * v4 + qword_140C67DF0);
  v50 = 8 * v4;
...
LABEL_24:
  ...
  v30 = (_QWORD *)(qword_140C67DF0 + v50);
  v31 = v6 >> 18;
  KeAcquireInStackQueuedSpinLock(&qword_140C67E00, &LockHandle);
  RtlClearBitsEx((__int64)&stru_140C67DE0, BitMapHeader.SizeOfBitMap, v31);
  for ( ; v31; --v31 )
  {
    MiLockHugePfnInternal(v30, 0LL);
    *v30 = 0LL;
    _InterlockedAnd(
      (volatile signed __int32 *)(qword_140C67DF8 + 4 * (((((__int64)v30 - qword_140C67DF0) >> 3) & 0x3FFFFFuLL) >> 5)),
      ~(1 << ((((__int64)v30 - qword_140C67DF0) >> 3) & 0x1F)));
    ++v30;
  }
