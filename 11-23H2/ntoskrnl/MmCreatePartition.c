...
__int64 __fastcall MmCreatePartition(_SLIST_HEADER **a1, char a2)
{
  ...
  v5 = 16LL * (unsigned int)(2 * dword_140C65AFC)
     + ((88LL * (unsigned int)(6 * dword_140C65AFC) + 25408LL * (unsigned __int16)KeNumberNodes + 22031) & 0xFFFFFFFFFFFFFFF0uLL);
  ...
  v15 = v14 + 88LL * (unsigned int)(3 * dword_140C65AFC);
  Pool[156].Region = v15;
  v16 = (v15 + 88LL * (unsigned int)(3 * dword_140C65AFC) + 15) & 0xFFFFFFFFFFFFFFF0uLL;
  Pool[425].Region = v16;
  v17 = v16 + 16LL * (unsigned int)dword_140C65AFC;
  Pool[426].Alignment = v17;
  v18 = v17 + 16LL * (unsigned int)dword_140C65AFC;
