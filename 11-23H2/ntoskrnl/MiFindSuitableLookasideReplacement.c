...
LABEL_24:
  v22 = a2[a3];
  a2[a3] = v18;
  if ( v22 != -1LL && (v22 < qword_140C68160 || v22 >= qword_140C68160 + 2048) )
    MiPurgingPageFromLookaside(3LL, v22);
  if ( v18 < qword_140C68160 || v18 >= qword_140C68160 + 2048 )
