/*
 * XREFs of MiInsertHugeRangeInList @ 0x14062151C
 * Callers:
...
void __fastcall MiInsertHugeRangeInList(__int64 a1, __int64 a2, char a3)
{
  ...
  v3 = a2 & 0x3FFFFF;
  v26 = (__int64 *)(qword_140C67DF0 + 8 * v3);
  if ( a1 )
    v6 = a1;
  else
    v6 = MiHugePfnPartition((_QWORD *)(qword_140C67DF0 + 8 * v3));
  v31 = *(_QWORD *)(v6 + 16208);
  v7 = *((unsigned int *)MiSearchNumaNodeTable(v3 << 18) + 2);
  v8 = MiPageToChannel(v3 << 18);
  v9 = dword_140C65B80[0];
  v29 = v8;
  v10 = *(_QWORD *)(v6 + 16) + 25408 * v7;
  v30 = dword_140C65B80[0];
  if ( (a3 & 1) == 0 )
  {
...
LABEL_16:
  ...
  if ( v21 )
  {
    ...
    if ( (a3 & 0x10) != 0 )
    {
      ...
      *(_QWORD *)(qword_140C67DF0 + 8 * ((v18 >> 37) & 0x3FFFFF)) = v25 | *(_QWORD *)(qword_140C67DF0
    ...
    else
    {
      ...
      *(_QWORD *)(qword_140C67DF0 + 8 * v21) = v24 | *(_QWORD *)(qword_140C67DF0 + 8 * v21) & 0xF800001FFFFFFFFFuLL;
