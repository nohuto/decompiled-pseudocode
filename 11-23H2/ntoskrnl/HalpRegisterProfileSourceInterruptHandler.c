/*
 * XREFs of HalpRegisterProfileSourceInterruptHandler @ 0x140521AD8
 * Callers:
...
__int64 __fastcall HalpRegisterProfileSourceInterruptHandler(__int64 (__fastcall *a1)(_QWORD))
{
  ...
  if ( qword_140D18360 )
  {
    if ( qword_140D18360 == KeGetCurrentThread()[1].CycleTime )
    {
  ...
  else
  {
    HalpPerfInterruptHandler = a1;
    if ( a1 )
      qword_140D18360 = KeGetCurrentThread()[1].CycleTime;
  }
