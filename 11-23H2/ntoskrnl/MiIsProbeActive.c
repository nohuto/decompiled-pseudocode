...
__int64 __fastcall MiIsProbeActive(unsigned __int64 a1, __int64 a2, char a3)
{
  ...
  i = (_QWORD *)xmmword_140C69580;
  v9 = v7;
  if ( !(_QWORD)xmmword_140C69580 )
    goto LABEL_35;
  if ( (a3 & 1) != 0 )
  {
    v19 = -1LL;
    ...
    while ( 1 )
    {
      ...
      if ( v22 <= qword_140C65BA0 && ((*(_QWORD *)(48 * v22 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
      {
...
LABEL_34:
      ...
      else
      {
        ...
        if ( *((_WORD *)v21 + (v22 & ((1LL << ((unsigned __int8)dword_140C65AE0 - 12)) - 1)) - v21[3] + 88) )
          goto LABEL_34;
      }
LABEL_50:
      a1 += 8LL;
