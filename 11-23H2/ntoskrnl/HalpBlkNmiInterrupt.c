/*
 * XREFs of HalpBlkNmiInterrupt @ 0x140B15400
 * Callers:
 *     <none>
 * Callees:
 *     HalpBlkFatalErrorHalt @ 0x140B140B0 (HalpBlkFatalErrorHalt.c)
...
void __fastcall HalpBlkNmiInterrupt(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 (__fastcall *retaddr)(); // [rsp+170h] [rbp+E8h]
  ...
  v28 = v11;
  v29 = v12;
  HalpBlkMceFastForward(v15, 1LL);
  v13 = _bittestandset(MK_FP(__GS__, 2468LL), 0);
  if ( v13
    && (unsigned __int64)HalpBlkNmiInterrupt <= (unsigned __int64)retaddr
    && HalpBlkNmiInterruptEnd > (char *)retaddr )
  {
    HalpBlkFatalErrorHalt(0x12u, (unsigned __int64)v15);
  }
  __writegsbyte(0x9A4u, 0);
  _mm_setcsr(v16);
  __asm { iretq }
}
