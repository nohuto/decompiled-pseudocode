        ...
        unsigned int a7)
{
  ...
  *(_WORD *)(a2 + 368) = 51;
  ...
  if ( result >= qword_140C64C70 )
  {
    ...
    while ( v22 >= 8 )
    {
      v23 = __ROR8__(v23 - *v20++, qword_140C64C68);
      v22 -= 8;
    }
    while ( v22 )
    {
      v23 = __ROR8__(v23 - *(unsigned __int8 *)v20, qword_140C64C68);
      v20 = (_QWORD *)((char *)v20 + 1);
      --v22;
    }
    if ( qword_140C64C78 != v23 )
    {
      if ( qword_140C64C30 )
        goto LABEL_28;
      qword_140C64C30 = (unsigned int)__ROR4__(150994945, 88);
      qword_140C64C38 = 0LL;
      qword_140C64C40 = 0LL;
      qword_140C64C48 = 269LL;
      qword_140C64C50 = v36;
    }
    if ( !qword_140C64C30 )
    {
LABEL_27:
      ...
      qword_140C64C70 = result;
      return result;
    }
LABEL_28:
    if ( (KDEFERRED_ROUTINE *)qword_140C64C08 != KiScanQueues )
    {
      LODWORD(dword_140C64BF0) = 275;
      qword_140C64C08 = (__int64)KiScanQueues;
      qword_140C64C10 = (__int64)&dword_140C64BF0;
      qword_140C64C28 = 0LL;
      qword_140C64C00 = 0LL;
    }
    qword_140C64C58 = 1018368LL;
    KiInsertQueueDpc((ULONG_PTR)&dword_140C64BF0, 0LL, 0LL, 0LL, 0);
    goto LABEL_27;
  }
  return result;
}
