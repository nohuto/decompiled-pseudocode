...
__int64 __fastcall MiObtainSystemCacheView(__int64 a1)
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  v4 = 0;
  v31[0] = v31;
  LockHandle.LockQueue.Lock = qword_140C670B0;
  ...
  {
    KiAcquireQueuedSpinLockInstrumented(&LockHandle, qword_140C670B0);
  }
  else
  {
    v6 = (signed __int64 *)_InterlockedExchange64((volatile __int64 *)qword_140C670B0, (__int64)&LockHandle);
    if ( v6 )
  ...
  if ( !*(_BYTE *)(a1 + 17052) )
  {
    ...
    if ( !(unsigned int)MiLateInitializeSystemCache(a1) )
      return 0LL;
    KeAcquireInStackQueuedSpinLock(qword_140C670B0, &LockHandle);
  }
