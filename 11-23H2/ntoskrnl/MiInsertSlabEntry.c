...
__int64 __fastcall MiInsertSlabEntry(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( (!a4 || !qword_140C67300) && !qword_140C67318 )
    goto LABEL_4;
...
LABEL_47:
  ...
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C67310);
  if ( !qword_140C67318 || (v27 = 48LL * *(_QWORD *)(a3 + 32) - 0x220000000000LL, v24 > v27) )
  {
LABEL_4:
    v11 = *(_QWORD *)(a2 + 8);
    v12 = *(_QWORD *)a2;
        ...
        *(_QWORD *)(a2 + 48) += (unsigned int)*v16;
        ...
        if ( (*(_DWORD *)(a3 + 140) & 2) != 0 )
        {
          *(_QWORD *)(a2 + 64) += 512LL;
          ...
          RtlInterlockedSetClearRunEx((__int64)&unk_140C6F378, v5, 1uLL);
        }
        else
        {
