/*
 * XREFs of MiInitializeDriverImages @ 0x140B460A0
 * Callers:
...
__int64 __fastcall MiInitializeDriverImages(__int64 a1)
{
  ...
  while ( v6 );
  MxMarkActiveDriverBits((unsigned int)&qword_140C66DE8, v1, v4, (unsigned int)&v40, 3);
  v7 = qword_140C66DF0;
  v8 = (_DWORD *)((((unsigned __int64)qword_140C66DF0 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL);
  for ( i = 0LL; i < qword_140C66DE8; i += 0x8000LL )
  {
    if ( (*v8 & 0x800LL) == 0 )
    {
      if ( !(unsigned int)MiSplitBitmapPages(5, v7, 8LL) )
        return 0LL;
      RtlClearBitsEx((__int64)&qword_140C66DE8, i, 0x8000uLL);
    }
    v7 += 4096LL;
    v8 += 2;
  }
  ...
  {
    qword_140C65938 = 0LL;
    qword_140C65900 = (__int64)&qword_140C658F8;
    qword_140C658F8 = (__int64)&qword_140C658F8;
            ...
            *v12 = v15;
            ...
            if ( v13 )
            {
              ...
              MiFreeKernelPadSections(
                *(_QWORD *)(qword_140C65918 + 48),
                *(_QWORD *)(qword_140C65918 + 48) + *(unsigned int *)(qword_140C65918 + 64));
              if ( !(unsigned int)MiReloadBootLoadedDrivers(a1) || !MiCreateInitialSystemWsles() )
                return 0LL;
              v17 = qword_140C65978;
              VfInitBootDriversLoaded(a1);
              if ( v17 != qword_140C65978 )
              {
              ...
              qword_140C65910 = (__int64)&qword_140C65908;
              qword_140C65908 = &qword_140C65908;
              ...
              {
                v30 = qword_140C6A548;
                v31 = MiReservePtes((__int64)&qword_140C69940, 0x20u);
                if ( !v31 )
                  return 0LL;
                if ( (int)VslInitializeSecureKernelCfg(v30, (__int64)(v31 << 25) >> 16) < 0 )
                  return 0LL;
                qword_140C65830 = v30;
                qword_140C65828 = 0x100000000000LL;
...
LABEL_70:
                ...
                guard_icall_bitmap = qword_140C65830 - 0x3FFFE0000000000LL;
              }
              if ( (MiFlags & 0x4000) != 0 )
              {
        ...
        *((_WORD *)v25 + 8) = v26;
        *((_WORD *)v25 + 9) = v26;
        v27 = (_QWORD *)qword_140C65900;
        if ( *(__int64 **)qword_140C65900 != &qword_140C658F8 )
          __fastfail(3u);
        *v25 = &qword_140C658F8;
        v25[1] = v27;
        v21 = 0x100002601LL;
        *v27 = v25;
        qword_140C65900 = (__int64)v25;
      }
      v19 = m + 1;
      if ( m + 1 >= v20 )
        goto LABEL_9;
