/*
 * XREFs of HalStartDynamicProcessor @ 0x140504BF0
 * Callers:
 ...
 *     HalpCheckNumaConfiguration @ 0x14051AB58 (HalpCheckNumaConfiguration.c)
 *     HalpUpdateNumaConfiguration @ 0x14051B214 (HalpUpdateNumaConfiguration.c)
