/*
 * XREFs of HalStartDynamicProcessor @ 0x140505140
 * Callers:
 ...
 *     HalpCheckNumaConfiguration @ 0x14051B0A8 (HalpCheckNumaConfiguration.c)
 *     HalpUpdateNumaConfiguration @ 0x14051B764 (HalpUpdateNumaConfiguration.c)
