...
__int64 __fastcall MiPfPutPagesInTransition(__int64 a1, int a2, int a3, int a4)
{
  ...
  v92 = 0LL;
  v118 = 0LL;
  v96 = *(_QWORD *)(qword_140C673C8 + 8 * v7);
  v8 = *(_DWORD *)(v6 + 56) & 8;
  LOBYTE(v127) = 17;
  v113 = v8;
  v9 = *(_DWORD *)(v4 + 88) + 1;
...
LABEL_15:
          ...
          if ( MiInvalidPteConforms(*(_QWORD *)v29) )
          {
            ...
            if ( qword_140C65B40 && (v30 & 0x10) == 0 )
              v31 = v30 & ~qword_140C65B40;
LABEL_84:
            v56 = (v31 >> 12) & 0xFFFFFFFFFFLL;
            if ( v56 <= qword_140C65BA0 )
            {
              Flink = 6 * v56;
      ...
      Flink = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v32 + 40) >> 43) & 0x3FFLL));
