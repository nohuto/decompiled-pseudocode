/*
 * XREFs of KsepMatchInitBiosInfo @ 0x140B6162C
 * Callers:
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  v12 = 0LL;
  KeyHandle = 0LL;
  xmmword_140C70CD8 = 0LL;
  qword_140C70D08 = 0LL;
  v0 = -1;
  xmmword_140C70CE8 = 0LL;
  xmmword_140C70CF8 = 0LL;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( v3 >= 0 )
    {
      ...
      v3 = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", &unk_140D18D70, 0x208uLL, &v12);
      word_140D18F76 = 0;
      v5 = 0LL;
      v6 = &unk_140D18D70;
      while ( *v6 != 32 )
...
LABEL_16:
  ...
  if ( v3 >= 0 )
  {
    *(_QWORD *)&xmmword_140C70CD8 = &unk_140D18D70;
    DWORD2(xmmword_140C70CF8) = v0;
  }
  else
  {
    DWORD2(xmmword_140C70CF8) = -1;
    *(_QWORD *)&xmmword_140C70CD8 = 0LL;
  }
