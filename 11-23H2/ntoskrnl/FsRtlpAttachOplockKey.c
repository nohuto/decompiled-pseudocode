/*
 * XREFs of FsRtlpAttachOplockKey @ 0x14030287C
 * Callers:
 ...
 *     FsRtlAcknowledgeEcp @ 0x140765320 (FsRtlAcknowledgeEcp.c)
 ...
 *     FsRtlRemoveExtraCreateParameter @ 0x1407653E0 (FsRtlRemoveExtraCreateParameter.c)
 */
