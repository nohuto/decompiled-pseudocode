/*
 * XREFs of RtlFindNextClearRunUlong @ 0x140293E3C
 * Callers:
...
__int64 __fastcall RtlFindNextClearRunUlong(unsigned int *a1, unsigned int a2, __int64 a3, unsigned int a4, _DWORD *a5)
{
  ...
  if ( !v10 )
    v12 = v8 + 4 * v9;
  v13 = *v11 | *((_DWORD *)qword_140016700 + (a2 & 0x1F));
  v14 = 0;
  do
  {
    while ( 1 )
...
LABEL_13:
    v18 = v14 & 0x1F;
    v19 = 0;
    v20 = v13 & ~*((_DWORD *)qword_140016700 + v18);
    v13 = v20;
    if ( (unsigned __int64)v11 > v12 )
    {
      v22 = v11;
LABEL_19:
      ...
      if ( v10 )
      {
        ...
        if ( !v19 )
          v23 = v11;
        v11 = v23;
        v13 |= ~*((_DWORD *)qword_140016700 + (v7 & 0x1F));
LABEL_25:
        v24 = -1;
