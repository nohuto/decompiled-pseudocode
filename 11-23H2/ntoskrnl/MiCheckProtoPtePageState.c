      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( (v9 & 0x400) != 0 || (v9 & 0x800) == 0 )
            goto LABEL_33;
          if ( (unsigned int)MiInvalidPteConforms(*v4, a2, v7, v8) )
          {
            v10 = v9;
            if ( qword_140C65B40 && (v9 & 0x10) == 0 )
              v10 = v9 & ~qword_140C65B40;
            goto LABEL_7;
          }
        }
        if ( (v9 & 0x200) != 0 )
...
LABEL_7:
        ...
        if ( v11 <= qword_140C65BA0 )
        {
          a2 = 6 * v11;
          if ( (v6 & *(_QWORD *)(48 * v11 - 0x21FFFFFFFFD8LL)) != 0 )
            break;
        }
      }
      v12 = v8 + 48 * v11;
      ...
      if ( (_DWORD)KiIrqlFlags && ((unsigned __int8)KiIrqlFlags & 1) != 0 && CurrentIrql <= 0xFu )
      {
        ...
        a2 = (unsigned int)v27 | SchedulerAssist[5];
...
LABEL_33:
  ...
  {
    v17 = 1;
    v18 = *(void **)(qword_140C673C8 + 8 * (((unsigned __int64)v16 >> 43) & 0x3FF));
    if ( (unsigned int)MiChargeCommit((unsigned __int64)v18, 1uLL, 4uLL) )
      goto LABEL_18;
  }
  else
  {
