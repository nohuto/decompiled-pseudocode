/*
 * XREFs of PopTraceThermalZonePassiveHistogram @ 0x140595F20
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x1405919D0 (PopDiagSnapPassiveHistogram.c)
 */
      ...
      && (unsigned int)dword_140C03950 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&dword_14002F004,
          0LL,
          0LL,
          7u,
          &v6);
