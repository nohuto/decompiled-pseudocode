/*
 * XREFs of PiPnpRtlObjectEventWorker @ 0x1407886C0
 * Callers:
 *     PiPnpRtlObjectEventCallback @ 0x140788690 (PiPnpRtlObjectEventCallback.c)
...
void __fastcall PiPnpRtlObjectEventWorker(__int64 a1, int a2, int a3, __int64 a4, unsigned int a5)
{
  ...
  if ( a2 < 7 )
  {
    ...
    else
    {
      ...
      v5 = (char *)P;
      PWSTR = PiPnpRtlObjectEventCreate(a1, (unsigned int)a2, P, &Src);
          ...
          if ( v13 )
          {
            ...
            if ( !v50[0] )
            {
              ...
              *((_QWORD *)&v54 + 1) = v18;
              ...
              PWSTR = PnpAllocatePWSTR(*(NTSTRSAFE_PCWSTR *)(a4 + 8), 0x7FFFFFFFuLL, 0x41706E50u, (PVOID *)&v54 + 1);
              if ( PWSTR >= 0 )
              {
                v22 = (char *)Src;
                v23 = v54;
