/*
 * XREFs of SeMarkLogonSessionForTerminationNotificationEx @ 0x140885680
 * Callers:
 *     SeMarkLogonSessionForTerminationNotification @ 0x140885660 (SeMarkLogonSessionForTerminationNotification.c)
 * Callees:
