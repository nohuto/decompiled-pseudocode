/*
 * XREFs of SeMarkLogonSessionForTerminationNotificationEx @ 0x140885440
 * Callers:
 *     SeMarkLogonSessionForTerminationNotification @ 0x140885420 (SeMarkLogonSessionForTerminationNotification.c)
 * Callees:
