/*
 * XREFs of TtmiLogSessionPowerControlStart @ 0x1409A9970
 * Callers:
...
void __fastcall TtmiLogSessionPowerControlStart(char a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D53918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53918, 1LL) )
    {
      ...
      v13 = 1;
      v7 = a2;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53918, (unsigned __int8 *)byte_140033099, 0LL, 0LL, 5u, &v8);
    }
  }
}
