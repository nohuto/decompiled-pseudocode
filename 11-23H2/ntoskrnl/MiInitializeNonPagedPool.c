/*
 * XREFs of MiInitializeNonPagedPool @ 0x140B5E52C
 * Callers:
...
__int64 MiInitializeNonPagedPool()
{
  ...
  if ( KeNumberNodes )
  {
    do
    {
      ...
      v10 = 376LL * v5;
      v11 = qword_140C65AA0;
      *(_QWORD *)(v10 + qword_140C65AA0 + 96) = v7;
      v7 += v8;
      *(_QWORD *)(v10 + v11 + 104) = v7;
      if ( !(unsigned int)MiBuildDynamicRegion((__int64 *)(v10 + qword_140C65AA0), v9, v8) )
        return 0LL;
    }
