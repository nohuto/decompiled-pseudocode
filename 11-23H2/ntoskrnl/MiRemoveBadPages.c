/*
 * XREFs of MiRemoveBadPages @ 0x14062A990
 * Callers:
...
__int64 __fastcall MiRemoveBadPages(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  if ( v11->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(1LL, (__int64)v11)) != 0 )
  {
    ...
    _enable();
    v10 = (unsigned __int64)(&v11[1].Process + 12 * v44);
    ...
    *(_QWORD *)v10 = (unsigned __int64)&qword_140C6B518 & 0x7FFFFFFFFFFFFFFCLL;
  }
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C6B518, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&qword_140C6B518, 0LL, v10, (__int64)&qword_140C6B518);
  if ( v10 )
    *(_BYTE *)(v10 + 18) = 1;
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      if ( v3 > qword_140C65BA0 || !_bittest64(v19, 0x36u) )
        goto LABEL_63;
...
LABEL_63:
      ...
      if ( *(_QWORD *)(qword_140C673C8 + 8 * ((v22 >> 43) & 0x3FF)) != a1 )
        break;
