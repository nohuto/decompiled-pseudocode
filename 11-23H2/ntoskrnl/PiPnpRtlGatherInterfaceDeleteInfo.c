/*
 * XREFs of PiPnpRtlGatherInterfaceDeleteInfo @ 0x14095A7AC
 * Callers:
...
__int64 __fastcall PiPnpRtlGatherInterfaceDeleteInfo(__int64 a1, char ***a2)
{
  void *v2; // rsi
  char **Pool2; // rax
  int v6; // ebx
  ...
  v14 = 0LL;
  v15 = 0LL;
  Pool2 = (char **)ExAllocatePool2(256LL, 32LL, 1198550608LL);
  *a2 = Pool2;
  if ( !Pool2 )
  {
    v6 = -1073741670;
