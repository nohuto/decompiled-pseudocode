/*
 * XREFs of MiCheckZeroFreeRebalance @ 0x1402D9390
 * Callers:
...
unsigned __int64 __fastcall MiCheckZeroFreeRebalance(__int64 a1, unsigned int a2)
{
  ...
  v19 = a2 >> byte_140C65A8D;
  v3 = (_QWORD *)(*(_QWORD *)(a1 + 16) + 25408LL * (a2 >> byte_140C65A8D));
  v18 = 0;
  if ( (unsigned int)MmNumberOfChannels > 1 )
    v18 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_140C65A8E);
  v4 = v3 + 2844;
  result = 0LL;
  v6 = 0;
  for ( i = 0LL; i <= 1; ++i )
