/*
 * XREFs of PiPnpRtlObjectActionCallback @ 0x1406D64E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiPnpRtlObjectActionCallback(
        __int64 a1,
        const WCHAR *a2,
        unsigned int a3,
        int a4,
  ...
  if ( a4 == 8 )
  {
    if ( a5 == 1 )
    {
      ...
      else
      {
        v10 = 0;
        if ( !*(_QWORD *)(v6 + 16) )
          PiPnpRtlCacheObjectBaseKey(a1, a2, a3, v6 + 16);
      }
      return v10;
    }
...
LABEL_44:
    if ( !*v19 )
      PiPnpRtlCacheObjectBaseKey(a1, a2, a3, v19);
    return v10;
  }
  v17 = *(_DWORD *)(a6 + 56);
  Pool2 = 0LL;
