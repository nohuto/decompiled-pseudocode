/*
 * XREFs of KiCommitThreadWait @ 0x140241F20
 * Callers:
 ...
 *     KiActivateWaiterPriQueue @ 0x14030BC4C (KiActivateWaiterPriQueue.c)
 *     KiIncrementConcurrencyCount @ 0x140361D5C (KiIncrementConcurrencyCount.c)
...
LABEL_16:
      ...
      *(_BYTE *)(a1 + 565) = 0;
      ...
      else if ( !(unsigned int)KiComputeDueTime(v6, v51, 0LL, &v50) )
      {
        goto LABEL_87;
      }
      ...
      *(_WORD *)(v6 + 58) = v49;
      if ( (unsigned __int8)KiInsertTimerTable((_DWORD)CurrentPrcb, v6, 0, v50, 0LL) )
      {
