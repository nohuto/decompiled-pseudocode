/*
 * XREFs of IommupHvAttachPasidDevice @ 0x14052483C
 * Callers:
...
LABEL_27:
    ...
    v9 = 0;
    v8 = v4;
    v1 = ((__int64 (__fastcall *)(__int64 *))qword_140C62628)(&v8);
    if ( v1 >= 0 )
    {
      v7 = 0LL;
      v5 = 0LL;
      ...
      v6 = 0LL;
      LOWORD(v6) = 257;
      v1 = ((__int64 (__fastcall *)(__int64 *, __int128 *))qword_140C62690)(&v4, &v5);
      if ( v1 >= 0 )
        IommupHvPasidInitialDomainCreated = 1;
      else
        ((void (__fastcall *)(__int64 *))qword_140C62640)(&v4);
    }
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&IommupHvGlobalPushLock, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)&IommupHvGlobalPushLock);
    KeAbPostRelease((ULONG_PTR)&IommupHvGlobalPushLock);
    ...
    {
LABEL_28:
      v1 = ((__int64 (__fastcall *)(_QWORD, __int64 *))qword_140C626B8)(*(_QWORD *)(a1 + 32), &v4);
      if ( v1 >= 0 )
      {
        v1 = ((__int64 (__fastcall *)(_QWORD, __int64 *))qword_140C62630)(*(_QWORD *)(a1 + 32), &v4);
        if ( v1 < 0 )
        {
LABEL_23:
          ((void (__fastcall *)(_QWORD))qword_140C626C0)(*(_QWORD *)(a1 + 32));
          return (unsigned int)v1;
        }
        if ( *(_BYTE *)(a1 + 265) )
        {
          v1 = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD))qword_140C625E8)(
                 *(_QWORD *)(a1 + 32),
                 42LL,
          ...
          {
LABEL_22:
            ((void (__fastcall *)(_QWORD))qword_140C62638)(*(_QWORD *)(a1 + 32));
            goto LABEL_23;
          }
          v1 = ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_140C625A0)(*(_QWORD *)(a1 + 32), 0LL);
          if ( v1 < 0 )
          {
            ((void (__fastcall *)(_QWORD, __int64))qword_140C625E8)(*(_QWORD *)(a1 + 32), 33LL);
            goto LABEL_22;
          }
        }
      }
