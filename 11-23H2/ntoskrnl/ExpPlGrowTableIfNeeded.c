...
__int64 ExpPlGrowTableIfNeeded()
{
  ...
  if ( ExPoolLimitState >= 2 * ((unsigned int)dword_140CF8104 >> 5) )
  {
    v0 = 2 * ((unsigned int)dword_140CF8104 >> 5);
    v1 = 1;
  ...
  if ( v1 )
  {
    while ( 1 )
    {
      ...
      if ( ExPoolLimitState < 2 * ((unsigned int)dword_140CF8104 >> 5) )
        break;
      v10 = 2 * ((unsigned int)dword_140CF8104 >> 5);
      if ( v10 < 4 )
        v10 = 4;
      if ( (unsigned int)v0 >= v10 )
      {
        ...
        v18 = dword_140CF8104;
        v19 = 0;
        v20 = -1LL << (dword_140CF8104 & 0x1F);
        if ( (dword_140CF8104 & 0xFFFFFFE0) != 0 )
        {
          do
          {
            v21 = qword_140CF8108;
          ...
          while ( v19 < (unsigned int)dword_140CF8104 >> 5 );
        }
        v24 = (char *)qword_140CF8108;
        qword_140CF8108 = Pool2;
        Pool2 = v24;
