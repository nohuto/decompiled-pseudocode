/*
 * XREFs of KiRemoveThreadFromSchedulingGroup @ 0x140204C14
 * Callers:
...
__int64 __fastcall KiRemoveThreadFromSchedulingGroup(__int64 a1)
{
  ...
  if ( (struct _KTHREAD *)a1 == KeGetCurrentThread() )
  {
    ...
    KiAcquirePrcbLocksForIsolationUnit(CurrentPrcb, 0LL, &v23);
...
LABEL_47:
            ...
            if ( (int)v18 >= 0 )
            {
              ...
              KiAcquirePrcbLocksForIsolationUnit(v10, 0LL, &v23);
              v16 = a1 == *(_QWORD *)(v10 + 8);
              goto LABEL_34;
            }
            break;
...
LABEL_15:
  ...
  {
    KiRemoveThreadFromScbQueue(v10, *(_QWORD *)(a1 + 944), a1, (unsigned int)*(char *)(a1 + 195));
    v7 = 1;
  }
  _interlockedbittestandreset((volatile signed __int32 *)a1, 0x12u);
  *(_QWORD *)(a1 + 104) = 0LL;
