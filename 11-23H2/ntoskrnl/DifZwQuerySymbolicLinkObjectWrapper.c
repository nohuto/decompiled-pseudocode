/*
 * XREFs of DifZwQuerySymbolicLinkObjectWrapper @ 0x1405F5D70
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQuerySymbolicLinkObjectWrapper(
        HANDLE LinkHandle,
        ...
        PULONG ReturnedLength)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(610);
...
LABEL_10:
  ...
  *(_QWORD *)&v19 = LinkTarget;
  *((_QWORD *)&v18 + 1) = ReturnedLength;
