/*
 * XREFs of ?ReadPartitionTable@SC_DISK@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x14067604C
 * Callers:
 ...
 *     ?Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z @ 0x140676624 (-Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z.c)
