/*
 * XREFs of ?ReadPartitionTable@SC_DISK@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x140675AFC
 * Callers:
 ...
 *     ?Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z @ 0x1406760D4 (-Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z.c)
