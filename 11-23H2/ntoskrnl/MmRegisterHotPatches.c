/*
 * XREFs of MmRegisterHotPatches @ 0x140B73D38
 * Callers:
  ...
  if ( (_QWORD *)*v4 != v4 )
  {
    do
    {
      ...
      if ( (v12 & 1) != 0 )
      {
        ...
        if ( !HotPatchRecord )
          goto LABEL_22;
        MiInsertHotPatchRecord((unsigned __int64 *)&xmmword_140C69830, (unsigned __int64)HotPatchRecord, 0);
    ...
    if ( (_QWORD *)*v8 != v8 )
    {
      do
      {
        if ( (v11[5] & 3) == 0 )
        {
          v25[6] = *((_DWORD *)v11 + 8);
          v25[7] = *((_DWORD *)v11 + 9);
          v21 = MiFindHotPatchRecord((__int64 *)&xmmword_140C69830, 0, *((_DWORD *)v11 + 8), *((_DWORD *)v11 + 9), 0LL);
          v27 = *((_DWORD *)v11 + 8);
          v26 = *((_DWORD *)v11 + 9);
          v22 = 9;
          if ( v21 >= 0 )
