/*
 * XREFs of NtCreateThreadEx @ 0x14076F400
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a11)
{
  ...
  unsigned int v31; // [rsp+D0h] [rbp+10h]
        ...
        (int)result >= 0) )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      else
      {
        ...
        v21 = v32;
        PspCreateUserContext((unsigned int)v24, 1, v36, v32, v33);
      }
      ObfDereferenceObjectWithTag(v17, 0x72437350u);
      Thread = PspCreateThread(a1, v31, v37, a4, 0LL, v38, v38[2], v14, v34, a7, v21, v33, v13);
