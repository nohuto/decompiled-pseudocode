/*
 * XREFs of NtSetSystemInformation @ 0x14075EE30
 * Callers:
 ...
 *     ExpSetProcessorMicrocodeUpdateInformation @ 0x1409F75C4 (ExpSetProcessorMicrocodeUpdateInformation.c)
 ...
 *     CmSetRegistryQuotaInformation @ 0x140A0FA58 (CmSetRegistryQuotaInformation.c)
 ...
 *     VfProbeAndCaptureUnicodeString @ 0x140AC2270 (VfProbeAndCaptureUnicodeString.c)
              ...
              if ( v78 )
              {
                if ( v78 == 8 )
                {
                  ...
                  *(UNICODE_STRING *)&CriticalProcessExceptionData = v129;
                  xmmword_140C31B50 = v130;
                  xmmword_140C31B60 = v131;
                  return 0;
                }
...
LABEL_432:
    if ( qword_140C37A40 )
      return (unsigned int)qword_140C37A40((unsigned int)v5, a2, (unsigned int)a3, 1LL);
    return (ULONG)-1073741637;
  }
  if ( v5 == 110 )
