/*
 * XREFs of ExAcquireFastResourceSharedStarveExclusive @ 0x1403C9AC0
 * Callers:
 ...
 *     ExpTryAcquireResourceSharedStarveExclusive @ 0x14035511C (ExpTryAcquireResourceSharedStarveExclusive.c)
