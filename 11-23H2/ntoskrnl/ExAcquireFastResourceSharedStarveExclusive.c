/*
 * XREFs of ExAcquireFastResourceSharedStarveExclusive @ 0x1403C98E0
 * Callers:
 ...
 *     ExpTryAcquireResourceSharedStarveExclusive @ 0x140354F7C (ExpTryAcquireResourceSharedStarveExclusive.c)
