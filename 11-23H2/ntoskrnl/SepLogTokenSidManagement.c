/*
 * XREFs of SepLogTokenSidManagement @ 0x1409C9C10
 * Callers:
 ...
 *     RtlConvertLuidToUlonglong @ 0x1405B83B0 (RtlConvertLuidToUlonglong.c)
 *     SepGetSidValuesDump @ 0x1405B8B48 (SepGetSidValuesDump.c)
 *     SepGetSidManagementActionName @ 0x1409C9B94 (SepGetSidManagementActionName.c)
