/*
 * XREFs of SepLogTokenSidManagement @ 0x1409C9E10
 * Callers:
 ...
 *     RtlConvertLuidToUlonglong @ 0x1405B8920 (RtlConvertLuidToUlonglong.c)
 *     SepGetSidValuesDump @ 0x1405B90B8 (SepGetSidValuesDump.c)
 *     SepGetSidManagementActionName @ 0x1409C9D94 (SepGetSidManagementActionName.c)
