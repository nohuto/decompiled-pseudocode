...
LABEL_33:
        ...
        if ( v28 <= qword_140C65BA0 && _bittest64((const signed __int64 *)(48 * v28 - 0x21FFFFFFFFD8LL), 0x36u) )
        {
          ...
          if ( *(_QWORD *)v17 == v26 )
          {
            if ( (*(_DWORD *)(*(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v29 + 40) >> 43) & 0x3FFLL)) + 4LL) & 0x80u) != 0 )
...
LABEL_52:
  ...
  *(_DWORD *)(v11 + 56) &= ~4u;
  ...
  if ( v37 )
  {
    v50 = *(_QWORD *)(qword_140C673C8 + 8LL * (*(_WORD *)(v11 + 60) & 0x3FF));
