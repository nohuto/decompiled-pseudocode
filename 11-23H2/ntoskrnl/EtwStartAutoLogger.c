/*
 * XREFs of EtwStartAutoLogger @ 0x14083C2A8
 * Callers:
 ...
 *     EtwpParsePoolTagFilter @ 0x1409ED3DC (EtwpParsePoolTagFilter.c)
...
__int64 __fastcall EtwStartAutoLogger(wchar_t *SourceString, __int64 a2, WCHAR *a3)
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  v66 = 100;
  Guid = 0LL;
  *(_QWORD *)&v60.Length = *((_QWORD *)PsGetCurrentServerSiloGlobals() + 108);
...
LABEL_109:
                      if ( !RegistryValues )
                      {
                        ...
                        EtwpUpdateDisallowList(CurrentServerSiloGlobals[108], v29, v44, v45);
                      }
                    }
                  }
                }
              ...
              EtwpEnableKeyProviders(v30[108], v29, v77, (_DWORD)v76, v50);
            }
            goto LABEL_40;
          }
