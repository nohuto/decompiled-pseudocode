/*
 * XREFs of MiUnmapMdlCommon @ 0x14061E728
 * Callers:
...
LABEL_42:
      ...
      v8 += 8 * v57;
      if ( (ValidPte & 0x200) == 0
        && (v15 > qword_140C65BA0 || !_bittest64((const signed __int64 *)(48 * v15 - 0x21FFFFFFFFD8LL), 0x36u)) )
      {
  ...
  if ( v55 )
  {
    v24 = ExAcquireSpinLockExclusive(&dword_140C684C0);
    v25 = 0;
    v26 = (_QWORD *)qword_140C684D0;
    v27 = (_QWORD *)qword_140C684D0;
    v28 = v24;
