/*
 * XREFs of MmManageFaultRange @ 0x140389C08
 * Callers:
...
__int64 __fastcall MmManageFaultRange(ULONG_PTR BugCheckParameter3, ULONG_PTR BugCheckParameter4, __int64 a3, char a4)
{
  ...
  {
    v9 = 0;
    v10 = (volatile signed __int64 *)&unk_140C654D8;
    while ( 1 )
    {
      v11 = v10 - 3;
...
LABEL_6:
  ...
  v12 = ExAcquireSpinLockExclusive(&dword_140C654B0);
  if ( !v8 )
  {
...
LABEL_16:
  ...
  v16 = 0LL;
LABEL_17:
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C654B0);
  ...
  if ( v16 )
  {
    while ( v16 != (unsigned __int64 *)((char *)&unk_140C654C0 + 40 * v5) )
    {
      if ( ++v5 >= 2 )
      {
