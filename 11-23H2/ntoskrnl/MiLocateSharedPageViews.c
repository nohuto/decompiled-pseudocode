/*
 * XREFs of MiLocateSharedPageViews @ 0x140636A30
 * Callers:
...
__int64 __fastcall MiLocateSharedPageViews(unsigned __int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 8) = 0LL;
  ...
  if ( v7->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(0LL, (__int64)v7)) != 0 )
  {
    ...
    _enable();
    v6 = (unsigned __int64)(&v7[1].Process + 12 * v60);
  ...
  {
    v23 = _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C6B518, 0LL, 17LL) == 17;
    goto LABEL_113;
  }
...
LABEL_37:
    ...
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v26 <= 0xFu && (unsigned __int8)v15 <= 0xFu && v26 >= 2u )
      {
  ...
  if ( (v34 & 0x400) != 0 )
  {
    ...
    if ( !v35 )
    {
      ...
      if ( (_DWORD)KiIrqlFlags )
      {
        ...
        if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v36 <= 0xFu && (unsigned __int8)v15 <= 0xFu && v36 >= 2u )
        {
    ...
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v42 <= 0xFu && (unsigned __int8)v15 <= 0xFu && v42 >= 2u )
      {
  ...
  v52 = MiDecrementModifiedWriteCount(v35, 0);
  if ( v52 )
