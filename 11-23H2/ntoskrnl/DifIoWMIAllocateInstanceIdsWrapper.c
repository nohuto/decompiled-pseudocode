/*
 * XREFs of DifIoWMIAllocateInstanceIdsWrapper @ 0x1405E1FA0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifIoWMIAllocateInstanceIdsWrapper(LPCGUID Guid, ULONG InstanceCount, ULONG *FirstInstanceId)
{
...
LABEL_10:
  *((_QWORD *)&v19 + 1) = Guid;
  LODWORD(v19) = InstanceCount;
  *((_QWORD *)&v18 + 1) = FirstInstanceId;
...
LABEL_17:
  result = IoWMIAllocateInstanceIds(Guid, InstanceCount, FirstInstanceId);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
