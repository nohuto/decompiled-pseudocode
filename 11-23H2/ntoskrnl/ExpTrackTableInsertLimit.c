/*
 * XREFs of ExpTrackTableInsertLimit @ 0x1406090EC
 * Callers:
      ...
      if ( *(_DWORD *)(a1 + 4) )
      {
        while ( 1 )
        {
          ...
          *(_QWORD *)&Pool2[v7 + 2] = v6;
          ...
          while ( v10 );
          StateName = 0LL;
          if ( ZwCreateWnfStateName(&StateName, WnfTemporaryStateName, WnfDataScopeSystem, 0, 0LL, 4u, &unk_140CF8110) >= 0 )
            v6[8] = StateName;
          if ( ++v5 >= *(_DWORD *)(a1 + 4) )
            goto LABEL_11;
        }
        ...
        for ( i = 0; i < *Pool2; ++i )
        {
          ...
          v22 = (37
               * (BYTE6(v35)
               ...
               + HIBYTE(v35)) & (v14 - 1);
          *v16 = *((_QWORD *)qword_140CF8108 + v22);
          v21[v22] = v16;
          ++ExPoolLimitState;
LABEL_20:
          ;
