...
__int64 __fastcall MiFindProcessImageHotPatchRecord(__int64 a1, int a2, int a3, int a4, UNICODE_STRING *StringOut)
{
  ...
  if ( !a4 )
  {
    ...
    v11 = KeAbPreAcquire((__int64)&xmmword_140C69848, 0LL);
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&xmmword_140C69848, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)&xmmword_140C69848, 0LL, v11, (__int64)&xmmword_140C69848);
    if ( v11 )
      *(_BYTE *)(v11 + 18) = 1;
  }
  if ( !qword_140C69828
  ...
  {
    HotPatchRecord = MiFindHotPatchRecord((__int64 *)&xmmword_140C69830, 1, a2, a3, StringOut);
  }
  if ( !a4 )
  {
