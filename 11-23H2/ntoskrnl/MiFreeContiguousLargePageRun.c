...
unsigned __int64 __fastcall MiFreeContiguousLargePageRun(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  if ( (*(_DWORD *)(a1 + 8) & 8) == 0 )
  {
    v7 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(48 * a2 - 0x21FFFFFFFFD8LL) >> 43) & 0x3FFLL));
    v31 = v7;
    if ( !a3 )
      return v3;
    while ( 1 )
...
LABEL_43:
      if ( v7 != *(_QWORD *)(qword_140C673C8 + 8LL * KeGetCurrentThread()->ApcState.Process[1].IdealProcessor[25]) )
