/*
 * XREFs of IopLiveDumpTracePopulateBitmapForDumpDuration @ 0x14055BADC
 * Callers:
  ...
  if ( (_BYTE)v4 )
  {
    if ( !v5[106] )
    {
      ...
      if ( (v4 & 1) != 0 )
      {
        ...
        {
          LOBYTE(v4) = tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL);
          if ( (_BYTE)v4 )
          {
            v18 = 0;
            v21 = 0;
            ...
            LOBYTE(v4) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)byte_14002BEFB,
                           (const GUID *)(a1 + 968),
                           (const GUID *)(a1 + 952),
                           5u,
                           &v15);
