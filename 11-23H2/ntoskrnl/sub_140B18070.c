...
__int64 __fastcall sub_140B18070(__int64 a1, ULONG_PTR a2, char a3)
{
  _BYTE *v3; // rbx
  __int64 v5; // r13
  int v6; // esi
...
LABEL_235:
  ...
  if ( v237 )
  {
    ...
    if ( (_DWORD)v204 )
    {
      ...
      {
        v173 = sub_140B11020(v22, v172, *((_DWORD *)v22 + 585));
        if ( !v173 )
          return 3221225626LL;
        v175 = *((_DWORD *)v22 + 612);
        if ( (v175 & 4) == 0 )
