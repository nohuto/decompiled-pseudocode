/*
 * XREFs of HalpDmaAllocateChildAdapterV3 @ 0x140828D90
 * Callers:
 ...
 *     HalpIommuGetSecurityPolicy @ 0x14036F304 (HalpIommuGetSecurityPolicy.c)
 *     HalJoinDmaDomain @ 0x1403907F0 (HalJoinDmaDomain.c)
 *     HalpDmaIsThinDmarCapable @ 0x140391558 (HalpDmaIsThinDmarCapable.c)
 *     HalpDmaIsThinDmaCapable @ 0x140391570 (HalpDmaIsThinDmaCapable.c)
...
LABEL_5:
    ...
    if ( (int)ObCreateObjectEx(0, HalpDmaAdapterObjectType, (__int64)v39, 0, v34, v20, 0, 0, &Object, 0LL) >= 0 )
    {
      ...
      if ( ObReferenceObjectByPointer(v14, 0x20000u, HalpDmaAdapterObjectType, 0) >= 0
        && (int)ObInsertObjectEx((char *)v14, 0LL, 0x20000, 0, 0, 0LL, Handle) >= 0 )
      {
        ZwClose(Handle[0]);
        v14[16] = 0LL;
        v14[17] = 0LL;
