/*
 * XREFs of AlpcpInitSystem @ 0x14085A588
 * Callers:
...
__int64 AlpcpInitSystem()
{
  ...
  if ( Pool2 )
  {
    ...
    qword_140C40658 = (__int64)&AlpcpPortList;
    ...
    *(__int128 *)((char *)v5 + 12) = AlpcpPortMapping;
    ...
    if ( v2 >= 0 )
    {
      ...
      ExInitializePagedLookasideListInternal(
        ...
        32,
        0);
      ExInitializePagedLookasideListInternal((__int64)&stru_140D0BE40, 0LL, 0LL, 0, 128, 1632136257, 32, 0);
      ...
      else
      {
        ...
        qword_140C40628 = (__int64)&AlpcpMessageLogListHead;
        AlpcpMessageLogListHead = (__int64)&AlpcpMessageLogListHead;
        qword_140C405F8 = (__int64)&AlpcpFreeMessageLogListHead;
        AlpcpFreeMessageLogListHead = (__int64)&AlpcpFreeMessageLogListHead;
        qword_140C40608 = (__int64)&AlpcpFreeMessageSnapshotListHead;
        AlpcpFreeMessageSnapshotListHead = (__int64)&AlpcpFreeMessageSnapshotListHead;
      }
      AlpcpCompletionListDatabase = 0LL;
      qword_140C40698 = (__int64)&qword_140C40690;
      qword_140C40690 = (__int64)&qword_140C40690;
    }
  }
  else
  {
