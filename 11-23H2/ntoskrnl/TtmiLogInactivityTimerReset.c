/*
 * XREFs of TtmiLogInactivityTimerReset @ 0x1409A85B0
 * Callers:
...
void __fastcall TtmiLogInactivityTimerReset(int a1)
{
  ...
  if ( (unsigned int)dword_140D53918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53918, 1LL) )
    {
      ...
      v9 = &v4;
      v4 = a1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53918, (unsigned __int8 *)byte_1400340E5, 0LL, 0LL, 4u, &v5);
    }
  }
}
