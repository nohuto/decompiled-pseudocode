...
unsigned __int64 __fastcall MiDbgTranslatePhysicalAddress(unsigned __int64 a1, unsigned __int8 a2, __int64 a3)
{
  ...
  v4 = 0;
  v7 = a1;
  if ( !qword_140C68048 || !(unsigned int)MiCheckPhysicalAddressRange(a1, 1LL) )
    return 0LL;
  *(_DWORD *)a3 = 0;
  v10 = v3 << 25 >> 16;
  v11 = v8 >> 12;
  ...
  *(_BYTE *)(a3 + 4) = CurrentIrql;
  ...
  v22 = 3;
  if ( !*v19
    || (v23 = 2 * (((unsigned int)v33 & ((1 << (dword_140C65AE0 - 12)) - 1)) - *(_DWORD *)(v21 + 24)),
...
LABEL_53:
  v29 = v12 | 0xA0000000;
  v30 = (volatile signed __int64 *)qword_140C68048;
  ValidPte = MiMakeValidPte(qword_140C68048, v18, v29);
  if ( (a2 & 0x41) != 0 )
    byte_140C68040 = 1;
