...
__int64 EtwpInitializeCoverageSampler()
{
  ...
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((char *)&dword_140C06718, 0LL, 0LL);
  EtwpCovSampGlobals = 0LL;
  ExInitializePushLock(&stru_140C31CC0);
  ...
  result = ObCreateObjectType(&DestinationString, (__int64)v2, 0LL, (__int64)&qword_140C31CB0);
  if ( (int)result < 0 )
