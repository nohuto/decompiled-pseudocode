/*
 * XREFs of KiFilterFiberContext @ 0x140B17C30
 * Callers:
...
_BOOL8 __fastcall KiFilterFiberContext(__int64 a1)
{
  ...
  *(_QWORD *)&v7 = __rdtsc();
  ...
  Parameter[1] = v11;
  Parameter[0] = v9 % 0xD;
  v12 = KeExpandKernelStackAndCallout(sub_140B34090, Parameter, 0xC000uLL);
  v13 = v32;
  if ( v12 < 0 )
    v13 = 0;
  v32 = v13;
  if ( v13 )
  {
    ...
    v35 = 0;
    v36 = 0;
    v19 = KeExpandKernelStackAndCallout(sub_140B34090, v33, 0xC000uLL);
    v20 = v36;
    if ( v19 < 0 )
      v20 = 0;
    v36 = v20;
...
LABEL_31:
      ...
      if ( v21 >= 0 )
        v22 = 0;
      v39 = v22;
      v23 = KeExpandKernelStackAndCallout(sub_140B34090, v37, 0xC000uLL);
      v24 = v40;
      if ( v23 < 0 )
        v24 = 0;
      v40 = v24;
