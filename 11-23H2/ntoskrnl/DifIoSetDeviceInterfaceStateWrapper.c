/*
 * XREFs of DifIoSetDeviceInterfaceStateWrapper @ 0x1405E17B0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifIoSetDeviceInterfaceStateWrapper(PUNICODE_STRING SymbolicLinkName, BOOLEAN a2)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(218);
...
LABEL_17:
  result = IoSetDeviceInterfaceState(SymbolicLinkName, a2);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
