...
void *__fastcall HalpAcpiPreSleep(int a1)
{
  ...
  {
    HalpAcpiPmRegisterRead(0, (unsigned __int8)byte_140C62078 >> 1, (__int64)&v10, 2u, 0LL);
    v6 = v10;
    v9 = v10;
    if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
    {
      HalpAcpiPmRegisterRead(3, (unsigned __int8)byte_140C62078 >> 1, (__int64)&v10, 2u, 0LL);
      v6 = v10 | v9;
      v9 |= v10;
    }
    if ( (dword_140C62090 & 0x40) == 0 )
    {
    ...
    HalpAcpiPmRegisterWrite(0, (unsigned __int8)byte_140C62078 >> 1, (__int64)&v9, 2u, 0LL);
    if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
      HalpAcpiPmRegisterWrite(3, (unsigned __int8)byte_140C62078 >> 1, (__int64)&v9, 2u, 0LL);
