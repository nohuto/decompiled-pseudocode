/*
 * XREFs of PopUpdateExternalDisplayState @ 0x1407EA7AC
 * Callers:
...
__int64 __fastcall PopUpdateExternalDisplayState(int a1)
{
  ...
  if ( (unsigned int)dword_140C03950 > 5 )
  {
    ...
    v6 = v1;
    v9 = 1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03950, (unsigned __int8 *)&word_14002EAAE, 0LL, 0LL, 3u, &v7);
  }
