/*
 * XREFs of EmpProviderRegister @ 0x140825020
 * Callers:
 *     EmProviderRegister @ 0x140824FB0 (EmProviderRegister.c)
 ...
 *     EmpSearchCallbackDatabase @ 0x14038B414 (EmpSearchCallbackDatabase.c)
