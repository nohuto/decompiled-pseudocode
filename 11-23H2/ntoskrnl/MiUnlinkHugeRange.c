...
unsigned __int64 __fastcall MiUnlinkHugeRange(__int64 a1, int a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 16208);
  v3 = (unsigned int)dword_140C65B80[0];
  v5 = a2 & 0x3FFFFF;
  v19 = MiPageToChannel(v5 << 18);
  v6 = 0;
  v7 = 1;
  v8 = *((unsigned int *)MiSearchNumaNodeTable(v5 << 18) + 2);
  v9 = (unsigned __int64 *)(qword_140C67DF0 + 8 * v5);
  v10 = *v9;
  v11 = *v9 & 7;
  if ( v11 == 2 )
  {
    ...
    {
      MiPageListCollision(qword_140C67DF0 + 8 * v5, 1, 1u);
      v10 = *v9;
    }
  ...
  if ( ((v10 >> 37) & 0x3FFFFF) != 0 )
    v14 = (_QWORD *)(qword_140C67DF0 + 8 * ((v10 >> 37) & 0x3FFFFF));
  else
    v14 = v13;
  v15 = (v10 >> 15) & 0x3FFFFF;
  *v14 ^= (*v14 ^ v10) & 0x1FFFFF8000LL;
  if ( v15 )
    v13 = (_QWORD *)(qword_140C67DF0 + 8 * v15);
  v16 = *v13 ^ v10;
  v17 = v10 & 0x7FFF;
