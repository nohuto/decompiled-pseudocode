...
LABEL_27:
      ...
      else if ( qword_140C42788 == 4 || qword_140C42788 == 100 )
      {
        goto LABEL_16;
      }
    }
    ...
    {
      KiMarkBugCheckRegions(qword_140C42788, qword_140C42790, qword_140C42798, qword_140C427A0);
      if ( qword_140C427A0 == 47 )
      {
        v10 = qword_140C42798;
        if ( MmIsAddressValidEx(qword_140C42798 + 1928) )
        {
          v8 = *(_QWORD *)(v10 + 1928);
          v9 = 4096LL;
          goto LABEL_27;
