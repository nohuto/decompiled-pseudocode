/*
 * XREFs of MiReclaimUnusedUltraMdlMaps @ 0x14021DA18
 * Callers:
...
__int64 MiReclaimUnusedUltraMdlMaps()
{
  ...
  if ( KeNumberNodes )
  {
    do
    {
      ...
      do
      {
        while ( *(_WORD *)(v4 + qword_140C68538) > 2u )
        {
          v5 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(qword_140C68538 + ((8LL * v2 + v3) << 6)));
          v6 = v5;
          if ( !v5 )
            break;
          ++v1;
