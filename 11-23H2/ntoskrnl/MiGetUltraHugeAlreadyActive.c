/*
 * XREFs of MiGetUltraHugeAlreadyActive @ 0x1403C0A64
 * Callers:
...
LABEL_11:
    ...
    for ( i = *v9; ; i = *(_RTL_BITMAP **)&i->SizeOfBitMap )
    {
      ...
      if ( v11 != -1 )
      {
        ...
        {
          v4 = qword_140C67DF0 + 8 * (*(_QWORD *)&v1[11].SizeOfBitMap & 0x3FFFFFLL);
        ...
        if ( *((_BYTE *)&v1[4].SizeOfBitMap + 4) )
          _InterlockedAnd(
            (volatile signed __int32 *)(qword_140C67DF8 + 4 * ((((v4 - qword_140C67DF0) >> 3) & 0x3FFFFFuLL) >> 5)),
            ~(1 << (((v4 - qword_140C67DF0) >> 3) & 0x1F)));
        else
