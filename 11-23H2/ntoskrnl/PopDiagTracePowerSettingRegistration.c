/*
 * XREFs of PopDiagTracePowerSettingRegistration @ 0x140990F00
 * Callers:
...
char __fastcall PopDiagTracePowerSettingRegistration(__int64 a1, int a2, char a3)
{
  ...
  if ( v7 )
  {
    ...
    {
      LOBYTE(CurrentThreadProcess) = tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL);
      if ( (_BYTE)CurrentThreadProcess )
      {
        ...
        LOBYTE(CurrentThreadProcess) = tlgWriteTransfer_EtwWriteTransfer(
                                         ...
                                         (unsigned __int8 *)byte_14002FA80,
                                         0LL,
                                         0LL,
                                         7u,
                                         &v19);
