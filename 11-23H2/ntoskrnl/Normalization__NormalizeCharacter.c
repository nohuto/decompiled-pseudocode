/*
 * XREFs of Normalization__NormalizeCharacter @ 0x1409C1538
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x1409C0600 (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x1409C137C (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x1405B0920 (ComposeHangulLV.c)
 ...
 *     NormBuffer__AppendEx @ 0x1405B0A9C (NormBuffer__AppendEx.c)
 ...
 *     NormBuffer__LastStartBase @ 0x1405B0D48 (NormBuffer__LastStartBase.c)
 ...
 *     NormBuffer__ReplaceLastStartBase @ 0x1405B0F10 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x1405B0F90 (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x1405B1008 (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1409C0600 (Normalization__AppendDecomposedChar.c)
