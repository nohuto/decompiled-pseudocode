/*
 * XREFs of Normalization__NormalizeCharacter @ 0x1409C1338
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x1409C0400 (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x1409C117C (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x1405B03B0 (ComposeHangulLV.c)
 ...
 *     NormBuffer__AppendEx @ 0x1405B052C (NormBuffer__AppendEx.c)
 ...
 *     NormBuffer__LastStartBase @ 0x1405B07D8 (NormBuffer__LastStartBase.c)
 ...
 *     NormBuffer__ReplaceLastStartBase @ 0x1405B09A0 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x1405B0A20 (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x1405B0A98 (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1409C0400 (Normalization__AppendDecomposedChar.c)
