/*
 * XREFs of DifZwResetEventWrapper @ 0x1405F6910
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwResetEventWrapper(HANDLE EventHandle, PLONG PreviousState)
{
...
LABEL_8:
  ...
  *(_QWORD *)&v16 = 0LL;
LABEL_10:
  *(_QWORD *)&v17 = EventHandle;
  *((_QWORD *)&v16 + 1) = PreviousState;
...
LABEL_17:
  result = ZwResetEvent(EventHandle, PreviousState);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
