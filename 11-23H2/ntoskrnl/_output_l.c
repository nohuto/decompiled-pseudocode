/*
 * XREFs of _output_l @ 0x1403DCFD0
 * Callers:
 ...
 *     wctomb_s @ 0x1403DC204 (wctomb_s.c)
 *     write_char_0 @ 0x1403DD828 (write_char_0.c)
 *     write_multi_char_0 @ 0x1403DD878 (write_multi_char_0.c)
 *     write_string_0 @ 0x1403DD8D0 (write_string_0.c)
 *     _get_printf_count_output @ 0x1403DE02C (_get_printf_count_output.c)
...
LABEL_116:
                  ...
                  {
                    LOBYTE(i) = 32;
                    write_multi_char_0(i, v33, v57, &v47);
                  }
                  write_string_0(v48, v32, v57, &v47);
                  v35 = v57;
                  if ( (v5 & 0xC) == 8 )
                  {
                    LOBYTE(v34) = 48;
                    write_multi_char_0(v34, v33, v57, &v47);
                  }
                  v36 = SizeConverted;
                  if ( v52 && SizeConverted > 0 )
                  {
                    ...
                    while ( 1 )
                    {
                      ...
                      if ( wctomb_s(&v58, v60, 6uLL, v38) || !v58 )
                        break;
                      write_string_0(v60, (unsigned int)v58, v57, &v47);
                      if ( !v36 )
                        goto LABEL_130;
                    }
                    v12 = -1;
                  ...
                  {
                    write_string_0(v8, (unsigned int)SizeConverted, v35, &v47);
LABEL_130:
                    v12 = v47;
                  }
                  if ( v12 >= 0 && (v5 & 4) != 0 )
                  {
                    LOBYTE(v39) = 32;
                    write_multi_char_0(v39, v33, v57, &v47);
                    v6 = v50;
                    goto LABEL_166;
                  }
LABEL_139:
