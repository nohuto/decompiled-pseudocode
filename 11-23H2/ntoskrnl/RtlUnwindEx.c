/*
 * XREFs of RtlUnwindEx @ 0x1402A4D40
 * Callers:
 ...
 *     RtlCaptureContext2 @ 0x140429130 (RtlCaptureContext2.c)
 *     _alloca_probe @ 0x140429B10 (_alloca_probe.c)
 *     RtlpExecuteHandlerForUnwind @ 0x14042A160 (RtlpExecuteHandlerForUnwind.c)
...
__int64 __fastcall RtlUnwindEx(ULONG_PTR a1, __int64 a2, _QWORD *a3, __int64 a4, unsigned int *a5, __int64 a6)
{
  ...
  v10 = v46 == 10;
  if ( !(unsigned __int8)RtlpGetStackLimits((__int64)&v48, (__int64)&v49) )
LABEL_68:
