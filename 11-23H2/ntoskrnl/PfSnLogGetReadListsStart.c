/*
 * XREFs of PfSnLogGetReadListsStart @ 0x14074D19C
 * Callers:
...
void __fastcall PfSnLogGetReadListsStart(__int64 a1, int a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( qword_140C6A708 )
    {
      if ( EtwEventEnabled(qword_140C6A708, &PfSnEvt_GetReadLists_Start) )
      {
        v3 = -1LL;
        do
          ++v3;
        ...
        *(_QWORD *)&UserData.Size = 2LL;
        ...
        v12 = 4LL;
        v14 = 4LL;
        EtwWrite(qword_140C6A708, &PfSnEvt_GetReadLists_Start, 0LL, 5u, &UserData);
      }
    }
  }
}
