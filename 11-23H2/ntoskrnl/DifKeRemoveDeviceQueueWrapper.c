/*
 * XREFs of DifKeRemoveDeviceQueueWrapper @ 0x1405E5880
 * Callers:
 *     <none>
 * Callees:
...
PKDEVICE_QUEUE_ENTRY __fastcall DifKeRemoveDeviceQueueWrapper(PKDEVICE_QUEUE DeviceQueue)
{
  ...
  __int64 *i; // rbx
  PKDEVICE_QUEUE_ENTRY result; // rax
  _QWORD **v12; // rdi
  _QWORD *v13; // rbx
  __int128 v14; // [rsp+20h] [rbp-20h] BYREF
  PKDEVICE_QUEUE_ENTRY v15; // [rsp+30h] [rbp-10h]
  __int64 retaddr; // [rsp+48h] [rbp+8h]

  v15 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(300);
...
LABEL_17:
  result = KeRemoveDeviceQueue(DeviceQueue);
  v15 = result;
  if ( v7 )
  {
    v12 = (_QWORD **)(v7 + 6);
