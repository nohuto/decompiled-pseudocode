/*
 * XREFs of MiWriteAwePtes @ 0x14064C5BC
 * Callers:
 ...
 *     MiGetAweNode @ 0x14064A8A4 (MiGetAweNode.c)
 ...
 *     MiPageSizeToPteLevel @ 0x14064E280 (MiPageSizeToPteLevel.c)
 */
        ...
        char a6)
{
  ...
  while ( 1 )
  {
    ...
    if ( v47 )
    {
      ...
      {
        v50 = v47;
        if ( qword_140C65B40 && (v47 & 0x10) == 0 )
          v50 = v47 & ~qword_140C65B40;
      }
    ...
    if ( (*(_DWORD *)(v90 + 8) & 8) != 0 )
    {
      ...
      v92 = v9;
      v53 = (__int64 *)(qword_140C67DF0 + 8 * (v9 & 0x3FFFFF));
      if ( (((unsigned __int64)*v53 >> 17) & 0x3FFFFF) == 1 )
        goto LABEL_83;
      MiLockHugePfnInternal(qword_140C67DF0 + 8 * (v9 & 0x3FFFFF), 0);
      v54 = *v53;
      ...
      *v53 = v54;
      _InterlockedAnd(
        (volatile signed __int32 *)(qword_140C67DF8 + 4 * (((((__int64)v53 - qword_140C67DF0) >> 3) & 0x3FFFFFuLL) >> 5)),
        ~(1 << ((((__int64)v53 - qword_140C67DF0) >> 3) & 0x1F)));
      if ( v55 == 1 )
LABEL_83:
