/*
 * XREFs of GxpWriteFrameBufferPixels @ 0x1403854BC
 * Callers:
 *     BgpGxDrawRectangle @ 0x14038542C (BgpGxDrawRectangle.c)
 * Callees:
 *     BgpGetBitsPerPixel @ 0x1403856E0 (BgpGetBitsPerPixel.c)
 *     GxpAdjustRectangleToFrameBuffer @ 0x140385708 (GxpAdjustRectangleToFrameBuffer.c)
 ...
 *     GxpGetRotatedPixelOffset @ 0x140672428 (GxpGetRotatedPixelOffset.c)
...
__int64 __fastcall GxpWriteFrameBufferPixels(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( !(_BYTE)BgInternal )
    {
      ...
      RotatedPixelOffset = ((__int64 (__fastcall *)(_DWORD *, unsigned __int64, _QWORD))qword_140C0E460)(v39, v2, 0LL);
      if ( v22 && v22 != v45 )
...
LABEL_47:
            ...
            while ( 1 )
            {
              ...
              if ( RotatedPixelOffset < 0 )
                goto LABEL_19;
              memmove((char *)qword_140C0E460 + v8 * v27, v25, v8);
              v25 += v8;
              v12 = *(_DWORD *)(v3 + 4);
              LODWORD(v26) = v26 + 1;
