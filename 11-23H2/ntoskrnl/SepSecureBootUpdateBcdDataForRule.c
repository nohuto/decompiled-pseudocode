/*
 * XREFs of SepSecureBootUpdateBcdDataForRule @ 0x1409D0DF4
 * Callers:
 ...
 *     SepSecureBootGetPolicyDefaultValue @ 0x1409D0C64 (SepSecureBootGetPolicyDefaultValue.c)
...
__int64 __fastcall SepSecureBootUpdateBcdDataForRule(__int64 a1, void *a2, _BYTE *a3)
{
  ...
  v3 = (_WORD *)(qword_140D1BED8 + *(unsigned int *)(a1 + 8));
  v21 = 0LL;
  v18 = 0LL;
  Pool2 = 0LL;
  v20 = 0;
