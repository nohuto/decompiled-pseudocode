/*
 * XREFs of VfThunkAddSpecialDriverThunks @ 0x140ADB050
 * Callers:
 ...
 *     ViThunkFindNextSpecialTable @ 0x140ADBA98 (ViThunkFindNextSpecialTable.c)
 *     ViThunkRecoverPristines @ 0x140ADBD9C (ViThunkRecoverPristines.c)
 */
