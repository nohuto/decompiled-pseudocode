...
__int64 __fastcall MmWriteTriageInformation(_OWORD *a1)
{
  ...
  *((_QWORD *)&v5 + 1) = qword_140C69930;
  *(_QWORD *)&v6 = qword_140C65488;
  *((_QWORD *)&v6 + 1) = qword_140C69938;
  *(_QWORD *)&v7 = qword_140C69928;
  *((_QWORD *)&v7 + 1) = qword_140C6F8E8;
  *(_QWORD *)&v8 = qword_140C6F440;
  result = qword_140C6F448;
  *a1 = v4;
  *((_QWORD *)&v8 + 1) = result;
  a1[1] = v5;
  a1[2] = v6;
