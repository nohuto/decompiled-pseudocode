/*
 * XREFs of DifZwRequestWaitReplyPortWrapper @ 0x1405F67E0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwRequestWaitReplyPortWrapper(
        HANDLE PortHandle,
...
LABEL_10:
  ...
  *(_QWORD *)&v19 = RequestMessage;
  *((_QWORD *)&v18 + 1) = ReplyMessage;
...
LABEL_17:
  result = ZwRequestWaitReplyPort(PortHandle, RequestMessage, ReplyMessage);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
