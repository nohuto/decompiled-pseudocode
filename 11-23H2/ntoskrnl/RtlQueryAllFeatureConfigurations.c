/*
 * XREFs of RtlQueryAllFeatureConfigurations @ 0x1409BD600
 * Callers:
 *     <none>
 * Callees:
        ...
        PSIZE_T ConfigurationCount)
{
  ...
  RtlpFcBufferManagerReferenceBuffers((__int64)&unk_140C14050, (__int64)v16, &v15);
...
LABEL_8:
  ...
  RtlpFcBufferManagerDereferenceBuffers((__int64)&unk_140C14050, v9);
  return v10;
}
