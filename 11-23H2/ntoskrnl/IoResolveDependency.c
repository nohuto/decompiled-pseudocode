/*
 * XREFs of IoResolveDependency @ 0x140398320
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PipLinkDeviceObjectAndDependencyNode @ 0x1408385F8 (PipLinkDeviceObjectAndDependencyNode.c)
 *     PipIsProviderStarted @ 0x14085F6BC (PipIsProviderStarted.c)
