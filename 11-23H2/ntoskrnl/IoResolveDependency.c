/*
 * XREFs of IoResolveDependency @ 0x140398140
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PipLinkDeviceObjectAndDependencyNode @ 0x1408382F8 (PipLinkDeviceObjectAndDependencyNode.c)
 *     PipIsProviderStarted @ 0x14085F47C (PipIsProviderStarted.c)
