/*
 * XREFs of SpRegOpenRedirectedKey @ 0x14085D9D0
 * Callers:
...
__int64 __fastcall SpRegOpenRedirectedKey(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  PersistedStateLocation = RtlGetPersistedStateLocation(off_140D53660, L"TargetNtPath", 0LL, 0, 0LL, 0, &v13);
  ...
  if ( PersistedStateLocation == -2147483643 )
  {
    ...
    v6 = RtlGetPersistedStateLocation(off_140D53660, L"TargetNtPath", 0LL, 0, Pool2, v10, &v13);
    if ( v6 < 0 )
    {
LABEL_17:
  ...
  else
  {
    ...
    p_DestinationString = (UNICODE_STRING *)&unk_140D53668;
  }
