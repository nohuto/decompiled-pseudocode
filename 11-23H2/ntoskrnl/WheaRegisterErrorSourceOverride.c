/*
 * XREFs of WheaRegisterErrorSourceOverride @ 0x140613A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall WheaRegisterErrorSourceOverride(int *a1, __int64 a2, __int64 a3)
{
         ...
         && *(_QWORD *)(a2 + 40) )
  {
    ...
    if ( v9->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(0LL, (__int64)v9)) != 0 )
    {
      ...
      if ( (unsigned __int64)v6 - qword_140C659E8 < 0x8000000000LL )
