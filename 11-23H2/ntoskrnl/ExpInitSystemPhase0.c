 ...
 *     Feature_FastResource2__private_IsEnabledDeviceUsage @ 0x14041298C (Feature_FastResource2__private_IsEnabledDeviceUsage.c)
...
char ExpInitSystemPhase0()
{
  ...
  *(_WORD *)(MmWriteableSharedUserData + 726) = 10;
  qword_140C2D6A8 = (__int64)&ExpSystemResourcesList;
  ...
  qword_140C2D668 = (__int64)&ExNPagedLookasideListHead;
  ExNPagedLookasideListHead = (__int64)&ExNPagedLookasideListHead;
  qword_140C2D678 = (__int64)&ExPagedLookasideListHead;
  ExPagedLookasideListHead = (__int64)&ExPagedLookasideListHead;
  qword_140C31BF8 = (__int64)&ExpFirmwareTableProviderListHead;
