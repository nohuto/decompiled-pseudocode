/*
 * XREFs of MiMirrorAddPagesToBrownList @ 0x14062705C
 * Callers:
...
void __fastcall MiMirrorAddPagesToBrownList(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  v4 = a1 >> 5;
  v5 = a2;
  v6 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67EA0 + 1) + 4 * v4);
  v7 = a1 & 0x1F;
  if ( v7 + a2 <= 0x20 )
  {
    if ( a2 == 32 )
...
LABEL_13:
  RtlSetBitsEx((__int64)&xmmword_140C67E90, a1, a2);
}
