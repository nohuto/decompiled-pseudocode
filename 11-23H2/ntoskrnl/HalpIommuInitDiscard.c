/*
 * XREFs of HalpIommuInitDiscard @ 0x140B65050
 * Callers:
...
__int64 __fastcall HalpIommuInitDiscard(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  qword_140C600E8 = (__int64)&HalpIommuParaVirtDeviceCache;
  HalpIommuParaVirtDeviceCache = (__int64)&HalpIommuParaVirtDeviceCache;
  qword_140C61E58 = (__int64)&HalpIommuDeviceCreatedList;
  HalpIommuDeviceCreatedList = (__int64)&HalpIommuDeviceCreatedList;
  qword_140C61EB8 = (__int64)&HalpRidAliasList;
  HalpRidAliasList = (__int64)&HalpRidAliasList;
  qword_140C600D8 = (__int64)&IommuInterfaceStateChangeCallbackListHead;
  ...
  *(_QWORD *)(HalIommuDispatch + 8) = IommuGetConfiguration;
  ...
  qword_140C61E88 = (__int64)&HalpIommuAtsDeviceList;
