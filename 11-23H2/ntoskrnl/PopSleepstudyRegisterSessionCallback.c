/*
 * XREFs of PopSleepstudyRegisterSessionCallback @ 0x140848A04
 * Callers:
...
void __fastcall PopSleepstudyRegisterSessionCallback(__int64 a1)
{
  ...
  v2 = (__int64 *)qword_140C3BC08;
  if ( *(__int64 **)qword_140C3BC08 != &PopSleepstudySessionContext )
    __fastfail(3u);
  ...
  *v2 = a1;
  ...
  (*(void (__fastcall **)(_QWORD, _QWORD))(a1 + 16))(
    *((unsigned int *)&unk_140C3BCD0 + 26 * (unsigned int)dword_140C3BCC8),
    *((_QWORD *)&unk_140C3BCD0 + 13 * (unsigned int)dword_140C3BCC8 + 1));
