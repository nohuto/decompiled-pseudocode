/*
 * XREFs of SymCryptInitEnvWindowsKernelmodeWin8_1nLater @ 0x1403F3340
 * Callers:
 *     SymCryptInit @ 0x1403B6B80 (SymCryptInit.c)
 *     KeInitSystem @ 0x140B4DED4 (KeInitSystem.c)
 * Callees:
 *     RtlGetEnabledExtendedFeatures @ 0x1403B46F0 (RtlGetEnabledExtendedFeatures.c)
