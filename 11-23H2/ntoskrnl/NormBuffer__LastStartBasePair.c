/*
 * XREFs of NormBuffer__LastStartBasePair @ 0x1405B0804
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x1409C09AC (Normalization__GetSecondDecomposedCharPlane0.c)
 */
