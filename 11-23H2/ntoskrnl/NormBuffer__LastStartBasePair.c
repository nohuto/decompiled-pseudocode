/*
 * XREFs of NormBuffer__LastStartBasePair @ 0x1405B0D74
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x1409C0BAC (Normalization__GetSecondDecomposedCharPlane0.c)
 */
