...
LABEL_5:
  ...
  while ( 1 )
  {
    v17 = *(unsigned int *)(qword_140C65A98 + 4LL * (v12 + v13 * (unsigned __int16)KeNumberNodes));
    v18 = 25408 * v17 + *v103;
    v99 = v18;
...
LABEL_12:
  ...
  if ( v82 > 1 )
  {
    ...
    if ( (_DWORD)v17 == v13 )
    {
      ...
      {
        v67 = v92;
        v68 = (unsigned __int8)(MiChannelMaximumPowerOf2Mask & (v7 >> byte_140C65A8E));
        v69 = &v96;
        v95 = MiChannelMaximumPowerOf2Mask & (v7 >> byte_140C65A8E);
        do
        {
          v70 = *v67;
          if ( v70 != v68 )
  ...
  {
    v21 = dword_140C65AF8 & v7;
    v92 = 0LL;
    v7 = dword_140C65AF8 & v7 | ((_DWORD)v17 << byte_140C65A8D);
    v22 = 0LL;
    v81 = v21 | ((_DWORD)v17 << byte_140C65A8D);
  }
  ...
  if ( v22 != v106 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v23 = a1;
        v7 = dword_140C65AF8 & v7 | ((_DWORD)v17 << byte_140C65A8D) | (*v22 << byte_140C65A8E);
        v81 = v7;
      }
      v27 = v25 == 0;
      v88 = v27;
      ...
      while ( 1 )
      {
        ...
        if ( LOWORD(v29->Alignment) )
        {
          ...
          if ( PerfectColorHeadPage )
          {
            ...
            if ( !v88 )
            {
              if ( (MiFlags & 0x80u) != 0LL && (++dword_140C67F60 & MmPageValidationFrequency) == 0 )
...
LABEL_35:
  ...
  if ( dword_140C65A84 > (unsigned int)dword_140C65A88
    || (v34 = (char *)qword_140C65AC8 + 16 * dword_140C65A84, v33 < *(_QWORD *)v34)
    || dword_140C65A84 != dword_140C65A88 && v33 >= *((_QWORD *)v34 + 2) )
  {
    v58 = 0;
...
LABEL_208:
    ...
    {
      v59 = (v58 + v32) >> 1;
      v34 = (char *)qword_140C65AC8 + 16 * v59;
      if ( v33 < *(_QWORD *)v34 )
      {
        if ( !v59 )
          KeBugCheckEx(0x1Au, 0x6200uLL, v33, (ULONG_PTR)qword_140C65AC8, 0LL);
        v32 = v59 - 1;
      }
      else
      {
        if ( v59 == dword_140C65A88 || v33 < *((_QWORD *)v34 + 2) )
        {
          dword_140C65A84 = (v58 + v32) >> 1;
          break;
        }
        v58 = v59 + 1;
      }
