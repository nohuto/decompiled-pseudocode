/*
 * XREFs of ViDeadlockRemoveMemoryRangeResources @ 0x1405D1D98
 * Callers:
 ...
 *     VfUtilAddressRangeFit @ 0x140AC23E4 (VfUtilAddressRangeFit.c)
 *     ViDeadlockDatabaseHashIndex @ 0x140AD8D74 (ViDeadlockDatabaseHashIndex.c)
