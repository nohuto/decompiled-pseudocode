/*
 * XREFs of EtwTimLogControlProtectionKernelModeReturnMismatch @ 0x14060034C
 * Callers:
 *     KiLogControlProtectionKernelModeReturnMismatch @ 0x14057C2D0 (KiLogControlProtectionKernelModeReturnMismatch.c)
 * Callees:
...
char __fastcall EtwTimLogControlProtectionKernelModeReturnMismatch(int a1, __int64 a2)
{
  ...
  if ( a1 == 1 )
  {
    ...
    Length = 0;
    if ( (int)RtlPcToFileName((unsigned __int64)v17[2], &v20) >= 0 )
      Length = v20.Length;
    Buffer = v20.Buffer;
    v6 = 6;
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v11 = 0;
    if ( (int)RtlPcToFileName((unsigned __int64)v17[3], &v21) >= 0 )
      v11 = v21.Length;
    v31 = (char *)v17 + 4;
    v32 = 2LL;
    if ( v11 )
    ...
    v36 = &v17[5];
    v37 = 4LL;
    RtlPcToFileHeader(v17[2], &v17[1]);
    if ( v17[1] )
      v12 = (char *)v17[2] - (char *)v17[1];
    else
      v12 = 0LL;
    v18 = v12;
    v38 = &v17[2];
    ...
    {
      Length = 0;
      Buffer = (wchar_t *)&word_14001F0C4;
    }
    if ( !v11 )
      v11 = 0;
    if ( (unsigned int)dword_140C066C0 > 5 )
    {
      LOBYTE(v2) = tlgKeywordOn((__int64)&dword_140C066C0, 0x400000000000LL);
      if ( (_BYTE)v2 )
      {
        v63 = v14;
        v55 = (char *)&v17[6] + 4;
        ...
        LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)byte_140035C5B,
                       0LL,
                       0LL,
                       0xEu,
                       &v54);
