/*
 * XREFs of MiAllocateWsle @ 0x14026BA60
 * Callers:
 ...
 *     MiFillVirtualFaultInfo @ 0x14046CC74 (MiFillVirtualFaultInfo.c)
 *     MiGetVirtualFaultPageInfo @ 0x14046CCEE (MiGetVirtualFaultPageInfo.c)
 *     MiIncrementVmFaultCount @ 0x14061C768 (MiIncrementVmFaultCount.c)
...
LABEL_25:
      ...
      if ( (unsigned int)MiPteInShadowRange(a2) )
      {
        ...
        {
          if ( !HIBYTE(word_140C66CFC) && (v18 & 1) != 0 )
