...
void __fastcall MiDeleteEnclavePages(__int64 a1, __int64 a2)
{
  ...
  if ( (v2 & 1) != 0 )
  {
    ...
    if ( *(_QWORD *)(a2 + 120) )
    {
      ...
      MiReleasePtes((__int64)&qword_140C69940, *(__int64 **)(a2 + 80), 1u);
      v6 = *(void **)(a2 + 88);
      if ( v6 )
      ...
      v8 = KeAbPreAcquire((__int64)&qword_140C698C0, 0LL);
      v9 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C698C0, 0LL);
      v10 = v8;
      if ( v9 )
        ExfAcquirePushLockExclusiveEx(&qword_140C698C0, v8, (__int64)&qword_140C698C0);
      if ( v10 )
        *(_BYTE *)(v10 + 18) = 1;
      v11 = *v4;
