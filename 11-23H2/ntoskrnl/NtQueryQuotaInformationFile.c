/*
 * XREFs of NtQueryQuotaInformationFile @ 0x14094B470
 * Callers:
 *     <none>
 * Callees:
...
LABEL_85:
  ...
  else if ( (Flags & 0x10) != 0 )
  {
    ...
    if ( Length )
    {
      ...
      IopProbeAndLockPages_2((__int64)Mdl, v54, v51, (__int64)v46, CurrentStackLocation[-1].MajorFunction);
    }
    goto LABEL_96;
  }
...
LABEL_96:
  ...
  result = IopSynchronousServiceTail(v46, (__int64)Irp, v31, 0, v54, v53, 2u);
  if ( !v53 )
