/*
 * XREFs of MiHandleBootImage @ 0x140B46AA8
 * Callers:
 ...
 *     MiFindLoaderAppliedHotPatchEntry @ 0x140B99AC8 (MiFindLoaderAppliedHotPatchEntry.c)
...
__int64 __fastcall MiHandleBootImage(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v5 = dword_140C65844;
  v6 = a2;
  v7 = (unsigned int)dword_140C6987C >> 12;
  LODWORD(v58) = (unsigned int)dword_140C6987C >> 12;
  v45 = dword_140C65844;
  v54 = v3;
  ...
  v13 = 4;
  if ( dword_140C6987C && (LoaderAppliedHotPatchEntry = MiFindLoaderAppliedHotPatchEntry(v6, a1)) != 0 )
  {
    ...
    if ( !v29 )
    {
      ...
      _InterlockedExchangeAdd64(&qword_140C65BA8, (unsigned int)v14);
      v44 = *(PVOID *)(v6 + 48);
      if ( v44 == PsNtosImageBase || v44 == PsHalImageBase )
        qword_140C699A8 += v31 - (unsigned int)v14;
      else
        _InterlockedExchangeAdd(&dword_140C699D0, v31 - v14);
      v5 = v45;
      v12 = v47;
      v7 = v58;
    }
