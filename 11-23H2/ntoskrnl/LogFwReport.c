...
void LogFwReport()
{
  ...
  if ( (dword_140C0E4B0 & 0x80u) != 0 )
  {
    ...
    qword_140CF7B60 = v1;
    dword_140CF7B68 = (int)Resolution;
    BitsPerPixel = BgpGetBitsPerPixel();
    stru_140D16A18.Parameter = 0LL;
    stru_140D16A18.List.Flink = 0LL;
    dword_140CF7B08 = BitsPerPixel;
    dword_140CF7B20 = dword_140C0E4B0;
    dword_140CF7B78 = 1000000 * qword_140CF7B48 / qword_140C0C9C0;
    dword_140CF7B28 = 1000000 * qword_140CF7B90 / qword_140C0C9C0;
    dword_140CF7B38 = 1000000 * qword_140CF7B88 / qword_140C0C9C0;
    ...
    if ( (dword_140C0E4B0 & 0x10000) != 0 )
    {
      ...
      DbgPrintEx(0x65u, 0, "|  ProgressHigh:     %8u  |\n", 1000000 * qword_140CF7B00 / qword_140C0C9C0);
      DbgPrintEx(
        0x65u,
        0,
        "|  ProgressManual:   %8u  |\n|  ProgressTotal:    %8u  |\n|                              |\n",
      ...
      DbgPrintEx(0x65u, 0, "|  FadeProlog:       %8u  |\n", 1000000 * qword_140CF7B30 / qword_140C0C9C0);
      ...
      DbgPrintEx(
        ...
        "|  FadeOverlap:      %8u  |\n|  FadeTotal:        %8u  |\n|                              |\n",
        dword_140CF7B78,
        1000000 * qword_140CF7B18 / qword_140C0C9C0);
      DbgPrintEx(
        0x65u,
        0,
        "|  AnimationTotal:   %8u  |\n|                              |",
