/*
 * XREFs of KiDirectSwitchThread @ 0x1402B18A0
 * Callers:
 ...
 *     PpmPerfGetCurrentFrequency @ 0x1402B2AA0 (PpmPerfGetCurrentFrequency.c)
 ...
 *     KiCanThreadBeReadiedImmediately @ 0x140357DFC (KiCanThreadBeReadiedImmediately.c)
