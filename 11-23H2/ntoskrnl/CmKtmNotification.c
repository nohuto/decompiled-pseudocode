/*
 * XREFs of CmKtmNotification @ 0x140697D50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     TmCommitComplete @ 0x1403D85D0 (TmCommitComplete.c)
 *     TmDereferenceEnlistmentKey @ 0x1403D8670 (TmDereferenceEnlistmentKey.c)
 *     TmPrepareComplete @ 0x1403D87B0 (TmPrepareComplete.c)
 *     TmReadOnlyEnlistment @ 0x1403D8830 (TmReadOnlyEnlistment.c)
 *     TmReferenceEnlistmentKey @ 0x1403D88B0 (TmReferenceEnlistmentKey.c)
 *     TmRollbackComplete @ 0x1403D8910 (TmRollbackComplete.c)
  ...
  if ( (unsigned __int8)CmpIsCmRm(RMContext) )
  {
    switch ( TransactionNotification )
    {
      case 2u:
        ...
        break;
      case 4u:
        v21 = CmpTransMgrCommit(v19, Key, &v32);
        v22 = 16LL;
        break;
      case 8u:
