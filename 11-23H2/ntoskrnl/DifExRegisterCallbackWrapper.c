...
LABEL_8:
  ...
  *(_QWORD *)&v18 = 0LL;
LABEL_10:
  *((_QWORD *)&v19 + 1) = CallbackObject;
  *(_QWORD *)&v19 = CallbackFunction;
  *((_QWORD *)&v18 + 1) = CallbackContext;
...
LABEL_17:
  result = ExRegisterCallback(CallbackObject, CallbackFunction, CallbackContext);
  v20 = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
