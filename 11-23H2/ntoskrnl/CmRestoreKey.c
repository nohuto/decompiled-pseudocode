/*
 * XREFs of CmRestoreKey @ 0x140A0AC44
 * Callers:
...
LABEL_23:
  ...
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)(v9 + 72), 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)(v9 + 72), 0LL, v18, v9 + 72);
  if ( v18 )
    *(_BYTE *)(v18 + 18) = 1;
  v84 = 1;
  if ( (*(_BYTE *)(v9 + 140) & 1) != 0 )
  ...
  if ( v10 < 0 )
    goto LABEL_74;
  v22 = v91;
  v10 = HvReallocateCell(v9, v88, (unsigned int)*(unsigned __int16 *)(v91 + 72) + 76, 1, &v93, &v95, (__int64)&v92);
  if ( v10 < 0 )
  {
    v11 = v95;
LABEL_71:
...
LABEL_115:
  ...
  *(_WORD *)(v8 + 8) = 64;
  ...
  CmpReportNotify(v8, 0, 1, (__int64)&v106);
  if ( !CmpProfileLoaded )
  {
