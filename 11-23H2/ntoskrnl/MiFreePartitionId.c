/*
 * XREFs of MiFreePartitionId @ 0x140A2FCA8
 * Callers:
...
char __fastcall MiFreePartitionId(unsigned __int16 a1)
{
  ...
  if ( v5 )
    *(_BYTE *)(v5 + 18) = 1;
  *((_BYTE *)qword_140C673A8->Buffer + (v2 >> 3)) &= ~(1 << (v2 & 7));
  *(_QWORD *)(qword_140C673C8 + 8 * v2) = 0LL;
  ...
  LOBYTE(v6) = KeAbPostRelease((ULONG_PTR)&qword_140C67388);
