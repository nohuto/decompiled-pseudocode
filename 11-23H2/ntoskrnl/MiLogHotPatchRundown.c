...
struct _EX_RUNDOWN_REF *MiLogHotPatchRundown()
{
  ...
  v67 = 0LL;
  if ( *(_QWORD *)&qword_140C698E8 && dword_140C6987C )
  {
    CurrentThread = KeGetCurrentThread();
    --CurrentThread->SpecialApcDisable;
    v2 = KeAbPreAcquire((__int64)&xmmword_140C69848, 0LL);
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&xmmword_140C69848, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)&xmmword_140C69848, 0LL, v2, (__int64)&xmmword_140C69848);
    if ( v2 )
      *(_BYTE *)(v2 + 18) = 1;
    v3 = *(_QWORD **)&xmmword_140C69830;
    i = 0LL;
    while ( v3 )
    {
    ...
    while ( i )
    {
      if ( **(_DWORD **)&qword_140C698E8 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C698E8, 32LL) )
      {
        v46 = *(_DWORD *)(i + 24);
        v134 = 4LL;
        v133 = &v46;
    ...
    for ( n = (PVOID *)PsLoadedModuleList; n != &PsLoadedModuleList; n = (PVOID *)*n )
    {
      ...
      if ( v32 && **(_DWORD **)&qword_140C698E8 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C698E8, 32LL) )
      {
        v55 = *(_DWORD *)(v34 + 120);
        v87 = 4LL;
        v86 = &v55;
