/*
 * XREFs of KeMarkHiberPhase @ 0x140A9E8A8
 * Callers:
...
LABEL_27:
  ...
  if ( qword_140C418F8 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C418F8, 16 * (unsigned int)(unsigned __int8)qword_140C418E8, 0x7272744Du);
  if ( qword_140C41900 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C41900, 0x58uLL, 0x7272744Du);
  v17 = *(_QWORD **)(v1 + 8);
