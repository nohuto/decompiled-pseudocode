/*
 * XREFs of RtlLengthCurrentClearRunForwardEx @ 0x1405A8FB0
 * Callers:
...
__int64 __fastcall RtlLengthCurrentClearRunForwardEx(_QWORD *a1, unsigned __int64 a2)
{
  ...
  v7 = a2 & 0x1F;
  v8 = 0LL;
  v9 = *v3 & ~*((_DWORD *)qword_140016700 + v7);
...
LABEL_4:
  if ( v4 )
  {
    if ( v8 )
      LODWORD(v9) = v3[1];
    v10 = -1;
    v11 = !_BitScanForward64(&v9, (unsigned int)v9 | ~*((_DWORD *)qword_140016700 + v4));
    if ( !v11 )
      v10 = v9;
