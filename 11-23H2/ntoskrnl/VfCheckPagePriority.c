/*
 * XREFs of VfCheckPagePriority @ 0x140AC37D0
 * Callers:
 *     VfCheckNxPagePriority @ 0x1405CE370 (VfCheckNxPagePriority.c)
...
void __fastcall VfCheckPagePriority(int a1, ULONG_PTR a2)
{
  ...
  if ( (MmVerifierData & 0x2000000) != 0 && (a1 & 0x40000000) == 0 )
  {
    ...
    ViCiPreprocessOptions(
      ...
      (const void *)0x2002,
      a2);
    VfReportIssueWithOptions(0xC4u, 0x2002uLL, a2, v3, 0LL, byte_140C0DD94);
