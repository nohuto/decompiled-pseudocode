/*
 * XREFs of PpmEventHiddenProcessorThermalCapChange @ 0x14059ACA0
 * Callers:
...
char __fastcall PpmEventHiddenProcessorThermalCapChange(__int64 a1, int a2, int a3)
{
  ...
  if ( PpmEtwRegistered )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      UserData.Size = 2;
      v11 = 1;
      LOBYTE(v3) = EtwWriteEx(v5, &PPM_ETW_HIDDEN_PROCESSOR_THERMAL_CAP_CHANGE, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v3;
}
