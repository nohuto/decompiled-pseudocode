/*
 * XREFs of WheapLogInitEvent @ 0x14085669C
 * Callers:
...
void WheapLogInitEvent()
{
  ...
  Pool2 = (char *)ExAllocatePool2(66LL, (unsigned int)(1072 * dword_140CF7A5C), 1634035799LL);
  if ( Pool2 )
  {
    v1 = (__int64 *)qword_140CF7A68;
    for ( i = 0; v1 != &qword_140CF7A68; v1 = (__int64 *)*v1 )
    {
      v3 = v1;
      v4 = 8LL;
      v5 = &Pool2[1072 * i];
