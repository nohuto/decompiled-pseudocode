/*
 * XREFs of KiStartReadyQueueEnumeratorForRescheduleContext @ 0x140242980
 * Callers:
    ...
    do
    {
      ...
      if ( v11 )
      {
        ...
        if ( v11 )
        {
          v28 = v11;
          v29 = 0;
          if ( !(unsigned __int8)KiIsThreadConstrainedBySchedulingGroup(v10)
            || (v6[32] & 4) != 0 && (unsigned __int8)KiShouldPreemptionBeDeferred() )
          {
            goto LABEL_32;
          }
          if ( !(unsigned __int8)KiCheckForMaxOverQuotaScb(v11, v8) )
          {
            do
            {
              v29 += *(_DWORD *)(v28 + 116);
