...
LABEL_25:
  v36 = a4 & 2;
  if ( (a4 & 2) == 0 && byte_140C65AE9 != (_BYTE)v36 && a1[1] != -1LL )
    MiReuseUltraPageTable(a1, 0LL);
  _bittestandset64((signed __int64 *)qword_140C68520, v30);
LABEL_28:
  if ( v36 )
  {
    *a1 = 0LL;
  ...
  else
  {
    ...
    if ( a2 )
    {
      ...
      do
      {
        v45 = MiMakeValidPte(v42, *v44, 3087007748LL);
        if ( MiPteInShadowRange(v42) )
        {
          if ( (unsigned int)MiPteHasShadow(v47, v46, v48) )
          {
            if ( !HIBYTE(word_140C66CFC) && (v45 & 1) != 0 )
