/*
 * XREFs of HalpIumSetVariable @ 0x140520C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpIumSetVariable(_WORD *Src, __int128 *a2, int a3, size_t a4, void *Srca)
{
  ...
  if ( !qword_140C62570 || KeGetCurrentIrql() > 2u )
  ...
  *((_OWORD *)v14 + 1) = v16;
  memmove(v15, Srca, a4);
  v14[5] = a4;
  v17 = ((__int64 (__fastcall *)(__int64, _QWORD *, unsigned __int64))qword_140C62570)(5LL, v14, v11);
