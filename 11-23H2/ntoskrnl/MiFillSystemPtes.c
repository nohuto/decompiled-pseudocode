        ...
        _DWORD *a6)
{
  ...
  *a6 = 0;
  ...
  else
  {
    ...
    {
      v17 = HIBYTE(word_140C66CFC);
      goto LABEL_20;
    }
    if ( byte_140C6A3D8[((v15 >> 39) & 0x1FF) - 256] != 1
      && (v15 < 0xFFFFF68000000000uLL || v15 > 0xFFFFF6FFFFFFFFFFuLL) )
    {
      if ( v15 < qword_140C6A558 || v15 > qword_140C67070 )
        v17 = (unsigned __int8)word_140C66CFC;
      else
        v17 = HIBYTE(word_140C66CFC);
LABEL_20:
      if ( v17 )
  ...
  if ( (v12 & 0x40000000) != 0 )
    v18 &= ~4uLL;
  v19 = ((unsigned __int16)v18 ^ (unsigned __int16)((unsigned __int8)word_140C66CFC << 8)) & 0x100 ^ (unsigned __int64)v18;
  if ( (v12 & 0x8000000) != 0 )
    v19 &= ~0x100uLL;
  if ( v16 )
    v19 |= 0x80uLL;
...
LABEL_63:
    if ( v23 )
    {
      v45 = 2 * (((unsigned int)v22 & ((1 << (dword_140C65AE0 - 12)) - 1)) - *(_DWORD *)(v62 + 24));
    ...
    else
    {
      ...
      if ( v26 == 3 )
      {
        if ( v21 )
        {
          ...
          if ( v24 > 1 )
          {
            ...
            do
            {
              ...
              if ( *v47 != *(v47 - 1) + 1
                || (v48 & 0x1FF) == 0
                || v48 <= qword_140C65BA0 && _bittest64((const signed __int64 *)(48 * v48 - 0x21FFFFFFFFD8LL), 0x36u) )
              {
                break;
              }
              ++v36;
        ...
        v38 = v61;
        v10 = ProtectionPfnCompatible;
        v39 = (1LL << ((unsigned __int8)dword_140C65AE0 - 12)) - 1;
        v62 = v61;
        *a6 |= 1u;
