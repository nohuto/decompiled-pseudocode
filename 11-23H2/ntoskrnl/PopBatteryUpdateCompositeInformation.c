/*
 * XREFs of PopBatteryUpdateCompositeInformation @ 0x140995BB8
 * Callers:
...
__int64 PopBatteryUpdateCompositeInformation()
{
  ...
  if ( (__int64 *)qword_140C3D070 != &qword_140C3D070 )
  {
    ...
    while ( (__int64 *)v0 != &qword_140C3D070 );
    v19.m128i_i32[3] = v2;
    v19.m128i_i32[0] = v3;
    v1 = v19;
    v20.m128i_i64[1] = __PAIR64__(v6, v4);
    v20.m128i_i32[1] = v7;
  }
  dword_140C3D0B4 = 0;
  unk_140C3D094 = v1;
  if ( !v5 )
    v5 = v2;
  v20.m128i_i32[0] = v5;
  *(__m128i *)((char *)&qword_140C3D0A0 + 4) = v20;
  DbgPrintEx(
    0x92u,
    2u,
    "\n"
  ...
  return PopReleasePolicyLock(v13, v12, v14, v15, v17, v18);
}
