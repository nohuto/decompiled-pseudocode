/*
 * XREFs of sub_140A4E074 @ 0x140A4E074
 * Callers:
 *     WbDecryptWarbirdEncryptionSegment @ 0x1407D2B10 (WbDecryptWarbirdEncryptionSegment.c)
 * Callees:
 *     ApplyRelocations @ 0x1402FB8E0 (ApplyRelocations.c)
...
__int64 __fastcall sub_140A4E074(__int64 *a1, int a2, _DWORD *a3)
{
  int v6; // ebx
  void *v7; // r14
  _DWORD *v8; // rsi
  ...
  else
  {
    ...
    v6 = sub_140763DE4(v7, a3[2] & 0xFFFFFFF, (*a3 & 2) == 0);
    if ( v6 >= 0 )
    {
      v6 = sub_140764B50(v7, a3[2] & 0xFFFFFFF, (*a3 & 2) == 0, (__int64)Mdl, (__int64)&v13);
      if ( v6 >= 0 )
      {
        v8 = v13;
        if ( !a2
