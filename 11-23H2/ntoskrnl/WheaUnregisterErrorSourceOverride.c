/*
 * XREFs of WheaUnregisterErrorSourceOverride @ 0x140613D10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall WheaUnregisterErrorSourceOverride(__int64 a1, unsigned int a2)
{
  __int64 v2; // r15
  ULONG_PTR v4; // rdi
  ...
  {
    v2 = (int)a1;
    v4 = (ULONG_PTR)&WheapSourceConfigOverride[8 * (__int64)(int)a1];
