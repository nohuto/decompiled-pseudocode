/*
 * XREFs of PnpRemoveDeviceActionRequests @ 0x1403D6720
 * Callers:
    ...
    do
    {
      ...
      if ( *(_QWORD *)(v3 + 16) == a1 )
      {
        ...
        *v7 = v5;
        ...
        v11 = KeAcquireSpinLockRaiseToDpc(&qword_140C3F308);
        v12 = dword_140C3F310-- == 1;
        v13 = v11;
        if ( v12 )
        ...
        __writecr8(v13);
        v18 = KeAcquireSpinLockRaiseToDpc(&qword_140C38FF0);
