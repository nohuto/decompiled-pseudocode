/*
 * XREFs of ExpAllocateAsid @ 0x14060D980
 * Callers:
...
__int64 __fastcall ExpAllocateAsid(__int64 a1, __int64 a2)
{
  ...
  {
    v18 = dword_140C2D424;
    if ( (_DWORD)dword_140C2D424 != dword_140C2D428 )
    {
      v19 = (__int64 *)qword_140C2D430;
      for ( i = 0; i < (unsigned int)dword_140C2D424; ++i )
      {
        if ( !*v19 )
          break;
        v19 += 2;
    ...
    if ( (_DWORD)dword_140C2D424 == ExpSvmAgents )
      break;
    KxReleaseQueuedSpinLock((volatile signed __int64 **)&LockHandle);
    ...
    if ( !result )
      return result;
    KeAcquireInStackQueuedSpinLock(&qword_140C2D438, &LockHandle);
    if ( v18 == (_DWORD)dword_140C2D424 )
    {
      v12 = qword_140C2D430;
      if ( qword_140C2D430 )
        memmove(v11, qword_140C2D430, 16LL * v18);
