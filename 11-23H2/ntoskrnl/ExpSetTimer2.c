/*
 * XREFs of ExpSetTimer2 @ 0x1403396F0
 * Callers:
 *     NtSetIRTimer @ 0x140339680 (NtSetIRTimer.c)
 *     NtCancelTimer2 @ 0x1403396A0 (NtCancelTimer2.c)
 *     NtSetTimer2 @ 0x1403396C0 (NtSetTimer2.c)
 * Callees:
