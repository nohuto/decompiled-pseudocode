/*
 * XREFs of ExpSetTimer2 @ 0x140339980
 * Callers:
 *     NtSetIRTimer @ 0x140339910 (NtSetIRTimer.c)
 *     NtCancelTimer2 @ 0x140339930 (NtCancelTimer2.c)
 *     NtSetTimer2 @ 0x140339950 (NtSetTimer2.c)
 * Callees:
