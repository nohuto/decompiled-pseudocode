/*
 * XREFs of KiTpEmulateGroup11Instruction @ 0x140AF3694
 * Callers:
 *     KiTpEmulateInstruction @ 0x140AF3944 (KiTpEmulateInstruction.c)
 * Callees:
 *     KiTpAccessMemory @ 0x140AF3008 (KiTpAccessMemory.c)
 *     KiTpDecodeModRm @ 0x140AF31F4 (KiTpDecodeModRm.c)
 *     KiTpDecodeModRmOperand @ 0x140AF32E0 (KiTpDecodeModRmOperand.c)
 *     KiTpFetchImmediateOperand @ 0x140AF4338 (KiTpFetchImmediateOperand.c)
 */
