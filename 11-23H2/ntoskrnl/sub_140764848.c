/*
 * XREFs of sub_140764848 @ 0x140764848
 * Callers:
...
__int64 __fastcall sub_140764848(__int64 a1, unsigned int *a2)
{
  unsigned int v2; // esi
  unsigned int v4; // r8d
  unsigned int v5; // edx
  ...
  Mdl = 0LL;
  v8 = sub_140763BF4(v7, v5 & 0xFFFFFFF, (v4 & 2) == 0);
  if ( v8 >= 0 )
  {
    v8 = sub_140764960((_DWORD)v7, a2[2] & 0xFFFFFFF, (*a2 & 2) == 0, (unsigned int)&Mdl, (__int64)&v15);
    if ( v8 >= 0 )
    {
      v9 = *(_QWORD *)(a1 + 56);
      v10 = a2[1] & 0xFFFFFFF;
      v11 = a2[2] & 0xFFFFFFF;
      v14 = 0;
      v8 = sub_140763E74(1, (char *)v7, v15, v11, (__int64 *)(v9 + 72), v10, (__int128 *)(v9 + 80), v13, &v14);
      if ( v8 >= 0 )
