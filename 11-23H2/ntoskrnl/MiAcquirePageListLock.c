...
__int64 __fastcall MiAcquirePageListLock(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  if ( v9 < qword_140C68160 || v9 >= qword_140C68160 + 2048 )
  {
    v10 = 0;
...
LABEL_14:
      *(_BYTE *)(a4 + 48) = v16;
      ...
      {
        v35 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(48 * v9 - 0x220000000000LL + 40) >> 43) & 0x3FFLL));
        v17 = dword_140C65A88;
        v18 = 0xAAAAAAAAAAAAAAABuLL * ((__int64)(48 * v9) >> 4);
        if ( dword_140C65A84 > (unsigned int)dword_140C65A88
          || (v19 = (char *)qword_140C65AC8 + 16 * dword_140C65A84, v18 < *(_QWORD *)v19)
          || dword_140C65A84 != dword_140C65A88 && v18 >= *((_QWORD *)v19 + 2) )
        {
          v32 = 0;
...
LABEL_67:
          ...
          {
            v33 = (v32 + v17) >> 1;
            v19 = (char *)qword_140C65AC8 + 16 * v33;
            if ( v18 < *(_QWORD *)v19 )
            {
              if ( !v33 )
                KeBugCheckEx(0x1Au, 0x6200uLL, v18, (ULONG_PTR)qword_140C65AC8, 0LL);
              v17 = v33 - 1;
            }
            else
            {
              if ( v33 == dword_140C65A88 || v18 < *((_QWORD *)v19 + 2) )
              {
                dword_140C65A84 = (v32 + v17) >> 1;
                break;
              }
              v32 = v33 + 1;
            }
