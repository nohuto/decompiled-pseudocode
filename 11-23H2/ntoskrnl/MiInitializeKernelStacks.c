/*
 * XREFs of MiInitializeKernelStacks @ 0x140B463B4
 * Callers:
...
__int64 MiInitializeKernelStacks()
{
  ...
  v4 = 14;
  v5 = 0x10000000000LL;
  byte_140C684BC = (unsigned int)KeKernelStackSize >> 12;
  v6 = 0;
  v7 = qword_140C683A8 + 216LL * (unsigned __int16)KeNumberNodes;
  v8 = 9LL;
  while ( 1 )
  {
    v9 = qword_140C6A4D8[2 * v8];
    v10 = MiSystemVaToDynamicBitmap(v4);
    if ( !(unsigned int)MiBuildDynamicRegion(v10, v9, v5)
      || !(unsigned int)MiInitializePteInfo((unsigned int)&unk_140C68408 + 88 * v6, v4, 0, 5, v9, v5, 1, v7) )
    {
      break;
    }
    v8 = 13LL;
