...
__int64 __fastcall ExpGetSystemBasicInformation(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 12) = v7;
  v8 = -1;
  if ( *(_QWORD *)(*(_QWORD *)(qword_140C673C8 + 8 * v2) + 17024LL) <= 0xFFFFFFFFuLL )
    v8 = *(_QWORD *)(*(_QWORD *)(qword_140C673C8 + 8 * v2) + 17024LL);
  *(_DWORD *)(a1 + 16) = v8;
  if ( *(_QWORD *)(*(_QWORD *)(qword_140C673C8 + 8 * v2) + 17032LL) <= 0xFFFFFFFFuLL )
    v6 = *(_QWORD *)(*(_QWORD *)(qword_140C673C8 + 8 * v2) + 17032LL);
  *(_DWORD *)(a1 + 20) = v6;
  return 0LL;
}
