/*
 * XREFs of SepLogUnmatchedSessionFlagImpersonationAttempt @ 0x1405B97C8
 * Callers:
...
void __fastcall SepLogUnmatchedSessionFlagImpersonationAttempt(__int64 a1, __int64 a2)
{
  ...
  *(_OWORD *)P = 0LL;
  ...
  if ( (unsigned int)dword_140C06550 > 5 && tlgKeywordOn((__int64)&dword_140C06550, 0x400000000000LL) )
  {
    ...
    v25 = v6;
    v26[1] = 0;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C06550, (unsigned __int8 *)byte_14003445B, 0LL, 0LL, 8u, &v14);
  }
  if ( v6 )
