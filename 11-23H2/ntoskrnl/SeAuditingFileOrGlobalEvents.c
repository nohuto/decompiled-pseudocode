/*
 * XREFs of SeAuditingFileOrGlobalEvents @ 0x1409CD710
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  if ( !v9 )
    return 0;
LABEL_9:
  if ( SepAdtAuditThisEventWithContext(117LL, AccessGranted, AccessGranted == 0, SubjectSecurityContext)
    || SepAdtAuditThisEventWithContext(130LL, AccessGranted, AccessGranted == 0, SubjectSecurityContext)
