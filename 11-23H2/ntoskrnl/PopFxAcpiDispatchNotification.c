/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x1405A0AA4
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x1403A38B0 (PoFxPlatformRequestHandler.c)
 * Callees:
 ...
 *     PopFxAcpiValidateParameters @ 0x1405A108C (PopFxAcpiValidateParameters.c)
