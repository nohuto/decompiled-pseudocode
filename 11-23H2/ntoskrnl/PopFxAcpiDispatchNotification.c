/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x1405A0F94
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x1403A3A90 (PoFxPlatformRequestHandler.c)
 * Callees:
 ...
 *     PopFxAcpiValidateParameters @ 0x1405A157C (PopFxAcpiValidateParameters.c)
