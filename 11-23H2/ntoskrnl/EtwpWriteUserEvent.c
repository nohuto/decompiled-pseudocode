/*
 * XREFs of EtwpWriteUserEvent @ 0x1406F4140
 * Callers:
 ...
 *     DecodeProviderTraits @ 0x1402581AC (DecodeProviderTraits.c)
 *     EtwEventEnabled @ 0x140258420 (EtwEventEnabled.c)
 *     ExReleaseRundownProtectionCacheAwareEx @ 0x140259CD0 (ExReleaseRundownProtectionCacheAwareEx.c)
 *     EtwpIsEventNameFilterEnabled @ 0x140259D50 (EtwpIsEventNameFilterEnabled.c)
 ...
 *     EtwpCreateEventKey @ 0x14034B5A4 (EtwpCreateEventKey.c)
...
LABEL_132:
      ...
      *(_OWORD *)(v21 + 24) = v75;
      *(_DWORD *)v21 = *((_DWORD *)&qword_14001CBF0 + v135) | v50;
      if ( v49 )
      {
        if ( (v49 & 0x100) != 0 )
        {
