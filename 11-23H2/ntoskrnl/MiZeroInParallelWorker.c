...
LABEL_41:
        ...
        if ( v22 < 0 )
          v26 |= 0x42uLL;
        v31 = ((unsigned __int16)v26 ^ (unsigned __int16)((unsigned __int8)word_140C66CFC << 8)) & 0x100 ^ v26;
        v32 = v31 | 0x80;
        if ( !v29 )
          v32 = v31;
        v33 = 0;
        ...
        while ( 1 )
        {
          ...
          if ( MiPteInShadowRange((unsigned __int64)v37) )
          {
            ...
            {
              if ( !HIBYTE(word_140C66CFC) && (v34 & 1) != 0 )
