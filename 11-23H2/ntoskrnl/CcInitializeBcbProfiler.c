/*
 * XREFs of CcInitializeBcbProfiler @ 0x140B17354
 * Callers:
 ...
 *     KeInitializeTimer @ 0x1402BE8C0 (KeInitializeTimer.c)
 ...
 *     KiGetLoadOptions @ 0x140B9593C (KiGetLoadOptions.c)
 */
  ...
  if ( MEMORY[0xFFFFF780000002D4] < 2u )
  {
    ...
    if ( !Pool2 )
    {
      ...
      *((_QWORD *)&v5 + 1) = (((unsigned __int64)v5 ^ *((_QWORD *)&v5 + 1)) * (unsigned __int128)0x47AE147AE147AE15uLL) >> 64;
      ...
      v80 = v7;
      if ( v7 >= 0x32 )
        LODWORD(v4) = (unsigned int)sub_14067E010;
      LOBYTE(v8) = v7 >= 0x32;
      v79 = v8;
