/*
 * XREFs of PopPowerInformationInternal @ 0x1407ED06C
 * Callers:
 ...
 *     SSHSupportQueryIsLibraryEnabled @ 0x1403A3890 (SSHSupportQueryIsLibraryEnabled.c)
 *     PoDirectedDripsSetDeviceFlags @ 0x1403AC350 (PoDirectedDripsSetDeviceFlags.c)
 ...
 *     PopGetEnergyEstimationInfo @ 0x140583A44 (PopGetEnergyEstimationInfo.c)
 *     PpmInternalPlatformIdleVeto @ 0x140585914 (PpmInternalPlatformIdleVeto.c)
 *     PpmInternalProcessorIdleVeto @ 0x140585968 (PpmInternalProcessorIdleVeto.c)
 *     PoDirectedDripsClearDeviceFlags @ 0x140586E40 (PoDirectedDripsClearDeviceFlags.c)
 ...
 *     PopScreenOn @ 0x140998280 (PopScreenOn.c)
...
LABEL_85:
  ...
  if ( v9 == 29 )
  {
    ...
    *v62 = PopFirmwareResetReason;
    v62[1] = xmmword_140C6AEE0;
    v62[2] = xmmword_140C6AEF0;
    *a7 = (__int64)v62;
    *a8 = 48;
    goto LABEL_115;
  }
...
LABEL_180:
  ...
  if ( !v50 )
  {
    ...
    *v59 = PopBsdPhysicalPowerButtonInfoAtBoot;
    v59[1] = xmmword_140C6AE30;
    v59[2] = xmmword_140C6AE40;
    v59[3] = xmmword_140C6AE50;
    *a7 = (__int64)v59;
    *a8 = 64;
    goto LABEL_115;
  }
