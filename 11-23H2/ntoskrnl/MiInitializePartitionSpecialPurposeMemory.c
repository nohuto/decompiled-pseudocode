...
LABEL_25:
  ...
  if ( Pool )
  {
    ...
    v25 = 512;
    v27 = 0LL;
    v11 = PsCreatePartition((ULONG_PTR)v6, &Handle, 2031619, (int)v22, 0, 2);
    if ( v11 < 0 )
      goto LABEL_26;
    v11 = PsReferencePartitionByHandle((ULONG_PTR)Handle, 2031619, 0, 0x4D536D4Du, &v19);
    if ( v11 < 0 )
      goto LABEL_26;
    v14 = *v19;
    ...
    *((_QWORD *)Pool + 2) = _InterlockedIncrement64(&qword_140C66CF0);
    v16 = Handle;
    *(_OWORD *)(Pool + 24) = *a2;
    v17 = a2[1];
    *((_QWORD *)Pool + 7) = v16;
