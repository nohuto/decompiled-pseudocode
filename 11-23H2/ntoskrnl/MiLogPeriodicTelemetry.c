/*
 * XREFs of MiLogPeriodicTelemetry @ 0x14021F654
 * Callers:
...
__int64 __fastcall MiLogPeriodicTelemetry(unsigned __int16 *a1)
{
  ...
  if ( *(_QWORD *)&qword_140C698E8 )
  {
    ...
    if ( (unsigned __int64)(UnbiasedInterruptTime - *((_QWORD *)v2 + 2126)) >= 0x165A0BC00LL )
    {
      ...
      if ( *((_DWORD *)v2 + 4229) )
      {
        v12 = *(_QWORD *)&qword_140C698E8;
        if ( **(_DWORD **)&qword_140C698E8 > 5u )
        {
          if ( tlgKeywordOn(*(__int64 *)&qword_140C698E8, 0x400000000400LL) )
          {
            v34 = v14;
            v54 = &v34;
            v28 = *v2;
      ...
      if ( *((_QWORD *)v2 + 2032) )
      {
        v17 = *(_QWORD *)&qword_140C698E8;
        if ( **(_DWORD **)&qword_140C698E8 > 5u )
        {
          if ( tlgKeywordOn(*(__int64 *)&qword_140C698E8, v5) )
          {
            v36 = v20;
            v64 = &v36;
            v29 = *v2;
