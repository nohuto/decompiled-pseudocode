/*
 * XREFs of MiDeleteVadAwePtes @ 0x140649EB8
 * Callers:
...
__int64 __fastcall MiDeleteVadAwePtes(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3)
{
  ...
  if ( v11 )
  {
    if ( (*(_DWORD *)(v3 + 8) & 8) != 0 )
    {
      ...
      if ( *a3 )
        v12 |= (((__int64)(*a3 - qword_140C67DF0) >> 3) & 0x3FFFFF) << 17;
      *v11 = v12;
      _InterlockedAnd(
        (volatile signed __int32 *)(qword_140C67DF8 + 4 * (((((__int64)v11 - qword_140C67DF0) >> 3) & 0x3FFFFFuLL) >> 5)),
        ~(1 << ((((__int64)v11 - qword_140C67DF0) >> 3) & 0x1F)));
    }
    else if ( v8 == 1 )
    {
