/*
 * XREFs of PspInitPhase0 @ 0x140B4A894
 * Callers:
...
char __fastcall PspInitPhase0(PVOID StartContext)
{
  ...
  if ( (unsigned int)PspSystemMitigationOptionsLength < 0x18 )
    memset(
      (void *)(0x140000000LL + (unsigned int)PspSystemMitigationOptionsLength + 13758416LL),
      0,
  ...
  qword_140C382C8 = (__int64)&PsActiveProcessHead;
                ...
                *(_OWORD *)((char *)&v29[1] + 4) = PspCpuPartitionMapping;
                ...
                if ( (int)ObCreateObjectType(&DestinationString, (__int64)v29, 0LL, (__int64)&PsCpuPartitionType) >= 0 )
                {
                  if ( (unsigned __int8)PspInitializeJobStructures() )
                  {
                    ...
                    {
                      qword_140D0C2D0 = 0LL;
                      qword_140D0C2C8 = (__int64)&PspWorkingSetChangeHead;
                      ...
                      if ( PspCidTable )
                      {
                        ...
                        *(_BYTE *)(PspCidTable + 44) |= 1u;
                        qword_140C382F0 = (__int64)PspReaper;
                        qword_140C38350 = (__int64)PspProcessRundownWorker;
