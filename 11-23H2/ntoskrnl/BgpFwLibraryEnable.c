/*
 * XREFs of BgpFwLibraryEnable @ 0x140388024
 * Callers:
...
__int64 __fastcall BgpFwLibraryEnable(__int64 a1)
{
  ...
  v2 = dword_140C0E4B0 & 0xC00;
  if ( (dword_140C0E4B0 & 2) != 0 && v2 != 3072 )
    return 0LL;
  v3 = 0LL;
  ...
  if ( v2 == 3072 )
  {
    if ( (_BYTE)xmmword_140C0E468
      && BYTE1(xmmword_140C0E468)
      && *(_DWORD *)(a1 + 16) == (_DWORD)xmmword_140C0E478
      && *(_QWORD *)(a1 + 4) == *(_QWORD *)((char *)&xmmword_140C0E468 + 4)
      && *(_DWORD *)(a1 + 12) == HIDWORD(xmmword_140C0E468)
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 32) = v8;
    ...
    {
      *(_BYTE *)(a1 + 1) = 1;
      if ( (_BYTE)xmmword_140C0E468 && BYTE1(xmmword_140C0E468) )
      {
        v11 = DWORD1(xmmword_140C0E468);
        if ( ((BYTE2(xmmword_140C0E468) - 1) & 0xFD) == 0 )
          v11 = DWORD2(xmmword_140C0E468);
        LOBYTE(v3) = (_DWORD)xmmword_140C0E478 != 4;
        MmUnmapIoSpace(BaseAddress, (unsigned int)(HIDWORD(xmmword_140C0E468) * v11) * (v3 + 3));
      }
      xmmword_140C0E468 = *(_OWORD *)a1;
      xmmword_140C0E478 = *(_OWORD *)(a1 + 16);
...
LABEL_13:
      ...
      xmmword_140C0E450 = *(_OWORD *)(a1 + 16);
      qword_140C0E460 = *(PVOID *)(a1 + 32);
      if ( v9 == 1 )
      {
        dword_140C0E4B0 |= 8u;
