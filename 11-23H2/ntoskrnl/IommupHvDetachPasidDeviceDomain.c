/*
 * XREFs of IommupHvDetachPasidDeviceDomain @ 0x140524E34
 * Callers:
...
signed __int32 __fastcall IommupHvDetachPasidDeviceDomain(__int64 a1, int a2)
{
  ...
  if ( a2 )
  {
    if ( *(_DWORD *)(v2 + 8) != 1 )
    {
      ...
      if ( (*(_DWORD *)(v2 + 96))-- == 1 )
      {
        ...
        BYTE4(v6) = 1;
        ((void (__fastcall *)(__int64 *))qword_140C62640)(&v6);
      }
  ...
  else
  {
    ...
    BYTE4(v6) = 1;
    return ((__int64 (__fastcall *)(__int64, __int64 *))qword_140C62630)(v3, &v6);
  }
  return result;
}
