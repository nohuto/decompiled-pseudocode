/*
 * XREFs of SeCheckForCriticalAceRemoval @ 0x14070FBC0
 * Callers:
...
char __fastcall SeCheckForCriticalAceRemoval(__int64 a1, __int64 a2, __int64 *a3, _BYTE *a4)
{
  ...
  if ( v10 )
  {
    if ( !v11[0] )
    {
      ...
      if ( AllocatedFullProcessImageName >= 0 && (unsigned int)dword_140C06590 > 5 )
      {
        LOBYTE(AllocatedFullProcessImageName) = tlgKeywordOn((__int64)&dword_140C06590, 0x200000000000LL);
        if ( (_BYTE)AllocatedFullProcessImageName )
        {
          ...
          LOBYTE(AllocatedFullProcessImageName) = tlgWriteTransfer_EtwWriteTransfer(
                                                    (__int64)&dword_140C06590,
                                                    (unsigned __int8 *)&byte_140034347,
                                                    0LL,
                                                    0LL,
                                                    4u,
                                                    &v13);
