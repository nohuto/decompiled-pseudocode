/*
 * XREFs of PopBatteryApplyCompositeState @ 0x140870480
 * Callers:
 ...
 *     PopSqmCreateDwordStreamEntry @ 0x1405A2320 (PopSqmCreateDwordStreamEntry.c)
 ...
 *     PopBatteryCheckTrigger @ 0x140870730 (PopBatteryCheckTrigger.c)
...
__int64 __fastcall PopBatteryApplyCompositeState(int *a1, int a2)
{
  ...
  if ( byte_140C3CEB8 )
  {
    PopSetPowerSettingValueAcDc(&GUID_BATTERY_COUNT, 4u, &dword_140C3CEB4);
    v32 = qword_140C3CEC0;
    v8 = 0LL;
    v6 = 0LL;
    while ( (__int64 *)v32 != &qword_140C3CEC0 )
    {
      v33 = *(_DWORD *)(v32 + 104);
      if ( v33 == 2 )
      {
    ...
    v7 = (unsigned int)dword_140C3CEB4;
    if ( PopCachedValidBatteryCount == -1 || PopCachedValidBatteryCount != dword_140C3CEB4 )
    {
      PopCachedValidBatteryCount = dword_140C3CEB4;
      PopDiagTraceBatteryCountChange((unsigned int)dword_140C3CEB4, v6, v8, &qword_140C3CEC0);
    }
    v48 = 1;
  }
  PopReleasePolicyLock(v7, v6, v8);
  PopBatteryCheckCompositeCapacity(a1, v5, &v51);
  if ( ((unk_140C3CEE0 ^ *(_BYTE *)a1) & 0xF) != 0 || byte_140C3CEB8 )
  {
    PopSetNotificationWork(8u, v9, v10, v11);
    byte_140C3CEB8 = 0;
  }
  PopAcquireRwLockExclusive((ULONG_PTR)&xmmword_140C3D078);
  v12 = *(__m128i *)a1;
  v13 = 0;
  HIDWORD(qword_140C3CEEC) = a2;
  ...
  BYTE7(xmmword_140C3D088) = dword_140C3CF18;
  xmmword_140C3D098 = 0LL;
  LOBYTE(xmmword_140C3D088) = unk_140C3CEE0 & 1;
  if ( dword_140C3CEB4 )
  {
    BYTE1(xmmword_140C3D088) = 1;
    BYTE2(xmmword_140C3D088) = (unk_140C3CEE0 & 4) != 0;
    DWORD2(xmmword_140C3D088) = HIDWORD(qword_140C3CF00);
    HIDWORD(xmmword_140C3D088) = unk_140C3CEE4;
    *(_QWORD *)&xmmword_140C3D098 = qword_140C3CEEC;
    *((_QWORD *)&xmmword_140C3D098 + 1) = unk_140C3CF08;
    BYTE3(xmmword_140C3D088) = byte_140C3D048 != 0 || (unk_140C3CEE0 & 2) != 0;
  }
  PopAccountCbEnergyChange();
  PopBatteryTraceSystemBatteryStatus(0);
  PopReleaseRwLock((__int64 *)&xmmword_140C3D078);
  if ( HIDWORD(qword_140C3CF00) )
    PopRecalculateCBTriggerLevels();
  if ( qword_140C3CF00
    && (unsigned __int8)PopBatteryCheckTriggerAllBatteries(&unk_140C3CFE8, 1LL)
    && (dword_140C3CFEC[0] & 2) == 0 )
  {
  ...
  LODWORD(v17) = 0;
  v18 = 0;
  v19 = dword_140C3CEB4 != 0 ? 3 : 0;
  do
  {
    v20 = v18;
    v21 = 6LL * v18;
    v54 = (char *)&unk_140C3CFE8 + 24 * (unsigned int)v17;
    v22 = dword_140C3CFEC[v21];
    if ( (unsigned __int8)PopBatteryCheckTrigger(v54) )
    {
      if ( PopBatteryCachedFlags[v20] != v22 )
      {
        ...
        v16 = v49;
        v24 = 3LL * v49;
        if ( dword_140C3CFEC[6 * v49] == 128 )
        {
          PopDiagTraceBatteryTriggerMet((char *)&unk_140C3CFE8 + 24 * v49, (char *)PopPolicy + 24 * v49 + 96, &v49);
          v16 = v49;
        }
      }
      if ( !byte_140C3CFE0 )
        PopExecutePowerAction(
          (unsigned int)&unk_140C3CFE8 + 24 * v16,
          8,
    ...
    else
    {
      ...
      v25 = v54;
      dword_140C3CFEC[v21] = v22 & 0xFFFFFFFC;
  ...
  if ( dword_140C3CF1C != v19 )
  {
    ...
    if ( (unsigned int)dword_140C03950 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_1400313D0,
        0LL,
        0LL,
        4u,
        &v55);
    ...
    if ( (unsigned int)(v19 - 1) <= 1 != (unsigned int)(dword_140C3CF1C - 1) <= 1
      && v36 > 5
      && tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03950,
        (unsigned __int8 *)&dword_140031414,
        0LL,
        0LL,
        4u,
        &v55);
  ...
  if ( v51 )
  {
    v49 = (dword_140C3D04C + 500) / 0x3E8u;
    ...
    if ( dword_140C3D04C != -1 )
      v40 = (MEMORY[0xFFFFF78000000008] - qword_140C3D050 + 5000) / 0x2710uLL;
    if ( PopPlatformAoAc )
    {
