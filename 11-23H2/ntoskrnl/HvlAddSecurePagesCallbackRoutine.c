...
__int64 __fastcall HvlAddSecurePagesCallbackRoutine(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_DWORD *)(a4 + 8) = 0;
  ...
  xmmword_140C5F3F0 = 0LL;
  xmmword_140C5F400 = 0LL;
  result = HvlpStartSecurePageListIteration(1LL, v4, 0LL, 0LL, 0, &v15);
  if ( (int)result < 0 )
    return result;
  *((_QWORD *)&xmmword_140C5F400 + 1) = v15;
  ...
  if ( (_BYTE)HvlpCrashdumpIterationState )
  {
      ...
      || (LOBYTE(v8) = 1, result = HvlpAddCrashdumpAreaPages(a4, v8), !(_BYTE)result) )
    {
      if ( BYTE2(HvlpCrashdumpIterationState) || (result = HvlpAddCrashdumpAreaPages(a4, 0LL), !(_BYTE)result) )
      {
        ...
        {
          while ( (_DWORD)xmmword_140C5F400 )
          {
LABEL_22:
            *(_QWORD *)(a4 + 24) = (**((_QWORD **)&xmmword_140C5F3F0 + 1) >> 40) + 1LL;
            result = 0xFFFFFFFFFFLL;
            *(_QWORD *)(a4 + 16) = **((_QWORD **)&xmmword_140C5F3F0 + 1) & 0xFFFFFFFFFFLL;
            *((_QWORD *)&xmmword_140C5F3F0 + 1) += 8LL;
            LODWORD(xmmword_140C5F400) = xmmword_140C5F400 - 1;
            if ( *(_QWORD *)(a4 + 24) )
            {
          ...
          while ( 1 )
          {
            ...
            if ( (int)VslGetSecurePageList(0LL, 0LL, 0LL, &v14) < 0 )
              break;
            LODWORD(xmmword_140C5F400) = *(unsigned __int16 *)(*((_QWORD *)&xmmword_140C5F400 + 1) + 8LL);
            *((_QWORD *)&xmmword_140C5F3F0 + 1) = *((_QWORD *)&xmmword_140C5F400 + 1) + 16LL;
            if ( (_WORD)xmmword_140C5F400 )
              goto LABEL_22;
          }
        }
