/*
 * XREFs of MiUpdateLastSubsectionSize @ 0x140366034
 * Callers:
...
LABEL_6:
  ...
  *(_WORD *)(a1 + 34) = (16 * *(_WORD *)a2) | v11 & 0xF;
  ...
  if ( (_DWORD)KiIrqlFlags )
  {
    ...
    if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v21 <= 0xFu && (unsigned __int8)v9 <= 0xFu && v21 >= 2u )
    {
  ...
  if ( (_DWORD)v5 )
  {
    ...
    *(_WORD *)(v12 + 12) = v13 ^ (v13 ^ ((v5 + (v14 | ((unsigned __int64)(v13 & 0x3FF) << 32))) >> 32)) & 0x3FF;
    if ( v7 == 2 )
      MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140C673C8 + 8LL * (v3[30] & 0x3FF)), 1LL, v5);
  }
  return 0LL;
}
