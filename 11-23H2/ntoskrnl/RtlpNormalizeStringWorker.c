/*
 * XREFs of RtlpNormalizeStringWorker @ 0x1409C1ED4
 * Callers:
 *     RtlNormalizeString @ 0x1409C1E50 (RtlNormalizeString.c)
 * Callees:
 *     Normalization__GuessCharCountBySize @ 0x1409C0C94 (Normalization__GuessCharCountBySize.c)
