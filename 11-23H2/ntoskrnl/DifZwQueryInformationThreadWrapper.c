/*
 * XREFs of DifZwQueryInformationThreadWrapper @ 0x1405F5000
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryInformationThreadWrapper(
        HANDLE ThreadHandle,
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = ThreadHandle;
  LODWORD(v23) = ThreadInformationClass;
  *((_QWORD *)&v22 + 1) = ThreadInformation;
  LODWORD(v22) = ThreadInformationLength;
