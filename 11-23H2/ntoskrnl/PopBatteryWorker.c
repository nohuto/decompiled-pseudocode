/*
 * XREFs of PopBatteryWorker @ 0x14086FFA0
 * Callers:
 *     <none>
 * Callees:
...
void PopBatteryWorker()
{
  ...
  for ( i = (__int64 *)qword_140C3D070; i != &qword_140C3D070; i = (__int64 *)*i )
    IoCancelIrp((PIRP)*(i - 1));
  for ( j = (__int64 *)qword_140C3D070; j != &qword_140C3D070; j = (__int64 *)*j )
  ...
  while ( 1 )
  {
    ...
    v121 = v12;
    if ( (__int64 *)qword_140C3D070 != &qword_140C3D070 )
    {
      do
      {
        v59 = *(__int64 **)v11;
      ...
      while ( v59 != &qword_140C3D070 );
      v0 = 0;
    }
    for ( k = qword_140C3D060; (__int64 *)k != &qword_140C3D060; k = *(_QWORD *)k )
    {
      if ( *(_DWORD *)(k + 104) == 1 )
      {
    ...
    if ( (__int64 *)qword_140C3D070 != &qword_140C3D070 )
    {
      ...
      while ( (__int64 *)v14 != &qword_140C3D070 );
      LOBYTE(v12) = v121;
    }
    if ( v10 )
    {
    ...
    if ( (v9 & 4) != 0 || v15 )
    {
      if ( PopEstimateSpoilerMask )
      {
        ...
        KeCancelTimer(&stru_140C3A460);
      }
      else
      {
        PopEstimateSpoiledUntilTime = MEMORY[0xFFFFF78000000008] + 300000000LL;
        KiSetTimerEx((__int64)&stru_140C3A460, -300000000LL, 0, 0, (__int64)&PopPostSpoilingRefresh);
      }
    }
    v141 = -1LL;
    v16 = 0xFFFFFFFFLL;
    ...
    if ( dword_140C3D054 )
    {
      ...
      if ( (__int64 *)qword_140C3D070 != &qword_140C3D070 )
      {
        ...
        while ( (__int64 *)v67 != &qword_140C3D070 );
        LOBYTE(v12) = v121;
        v135 = v20;
      }
      if ( (v22 & 2) != 0 )
      ...
      else
      {
        ...
        if ( (__int64 *)qword_140C3D070 != &qword_140C3D070 )
        {
          ...
          while ( (__int64 *)v77 != &qword_140C3D070 );
          if ( v0 )
          {
            v78 = (__int64 *)qword_140C3D070;
            do
            {
    ...
    else
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_140030EC4,
        0LL,
        0LL,
        0xAu,
        &v218);
    ...
    if ( (v22 & 0x20) != 0 )
      ...
      v25 = 0;
    if ( (_DWORD)qword_140C3D1FC != v25 )
    {
      PopAcquireRwLockExclusive((ULONG_PTR)&PopWeakChargerLock);
      LODWORD(qword_140C3D1FC) = v25;
    ...
    qword_140C3D208 = MEMORY[0xFFFFF78000000008];
    _InterlockedOr(v111, 0);
    if ( qword_140C3D210 )
      ExfUnblockPushLock(&qword_140C3D210, 0LL);
    if ( _InterlockedCompareExchange(&PopBatteryWorkRequests, 0, 0x80000000) == 0x80000000 )
      break;
    LOBYTE(v7) = v120;
  }
  for ( m = (__int64 *)qword_140C3D070; m != &qword_140C3D070; m = (__int64 *)*m )
  ...
  {
    v127 = dword_140C3D054;
    v155 = 4LL;
    v154 = &v127;
    v33 = "AC Power";
    if ( (xmmword_140C3D080 & 1) == 0 )
      v33 = "DC Power";
    ...
    if ( (_DWORD)xmmword_140C3D0A4 )
      v52 = (((unsigned int)xmmword_140C3D0A4 >> 1) + 100 * DWORD1(xmmword_140C3D080)) / (unsigned int)xmmword_140C3D0A4;
    else
      v52 = v50;
    v128 = v52;
    v164 = &v128;
    v165 = v51;
    if ( (_DWORD)xmmword_140C3D0A4 )
      v53 = 100000 * (unsigned __int64)DWORD1(xmmword_140C3D080) / (unsigned int)xmmword_140C3D0A4;
    else
      LODWORD(v53) = v50;
    v129 = v53;
    v122 = xmmword_140C3D0A4;
    v166 = &v129;
    v130 = DWORD1(xmmword_140C3D080);
    v168 = &v130;
    v170 = &v122;
    v123 = *((_QWORD *)&xmmword_140C3D080 + 1);
    v172 = &v123;
    v174 = (char *)&v123 + 4;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140C03950,
      (unsigned __int8 *)&byte_1400312AF,
      0LL,
      0LL,
      0x16u,
      &v153);
  ...
  if ( (_BYTE)v120 )
  {
    *(_DWORD *)v151 = dword_140C3D0B4;
    v149 = xmmword_140C3D094;
    v152 = dword_140C3D050;
    *(_OWORD *)&v151[4] = xmmword_140C3D080;
    *(_DWORD *)&v151[20] = dword_140C3D054;
    v150 = xmmword_140C3D0A4;
    ZwUpdateWnfStateData(&WNF_PO_COMPOSITE_BATTERY, &v149, 0x3Cu, 0LL, 0LL, 0, 0);
    if ( (unsigned int)dword_140C03950 > 5 && tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL) )
    {
      v187 = &v126;
      v126 = dword_140C3D054;
      if ( (xmmword_140C3D080 & 1) == 0 )
        v30 = "DC Power";
      v188 = 4LL;
      ...
      if ( (_DWORD)xmmword_140C3D0A4 )
        v105 = (((unsigned int)xmmword_140C3D0A4 >> 1) + 100 * DWORD1(xmmword_140C3D080))
             / (unsigned int)xmmword_140C3D0A4;
      else
        v105 = 0;
      v125 = v105;
      v197 = &v125;
      v198 = v104;
      if ( (_DWORD)xmmword_140C3D0A4 )
        v106 = 100000 * (unsigned __int64)DWORD1(xmmword_140C3D080) / (unsigned int)xmmword_140C3D0A4;
      else
        LODWORD(v106) = 0;
      ...
      v200 = v104;
      v199 = &v124;
      HIDWORD(v123) = DWORD1(xmmword_140C3D080);
      v201 = (char *)&v123 + 4;
      v203 = &v123;
      v122 = DWORD2(xmmword_140C3D080);
      v205 = &v122;
      v130 = HIDWORD(xmmword_140C3D080);
      v207 = &v130;
      v129 = dword_140C3D050;
      v209 = &v129;
      v211 = &v128;
      if ( (xmmword_140C3D094 & 0x40000000) == 0 )
        v107 = "mWh Unit";
      v202 = v104;
      LODWORD(v123) = xmmword_140C3D0A4;
      v204 = v104;
      v206 = v104;
      v208 = v104;
      v210 = v104;
      ...
      v214 = &v127;
      v127 = HIDWORD(xmmword_140C3D094);
      v216 = &v136;
      LODWORD(v136) = v108;
      v215 = v109;
      v217 = v109;
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03950,
        (unsigned __int8 *)&byte_14003107F,
        0LL,
        0LL,
        0x16u,
        &v186);
    ...
    if ( v54 )
    {
      ...
      if ( (unsigned int)dword_140C03950 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03950,
          (unsigned __int8 *)byte_14003127B,
          0LL,
          0LL,
          3u,
          &v231);
