 ...
 *     <none>
 * Callees:
 *     HalpGetPlatformTimerInformation @ 0x140366AA0 (HalpGetPlatformTimerInformation.c)
 *     HalpQueryNumaRangeTableInformation @ 0x1403B52E0 (HalpQueryNumaRangeTableInformation.c)
 *     HalpGetDisplayBiosInformation @ 0x1403B5F78 (HalpGetDisplayBiosInformation.c)
 *     xKdEnumerateDebuggingDevices @ 0x1403B6C80 (xKdEnumerateDebuggingDevices.c)
 *     __security_check_cookie @ 0x1403D7CE0 (__security_check_cookie.c)
 *     memmove @ 0x140435700 (memmove.c)
 *     memset @ 0x140435A00 (memset.c)
 *     HalpTimerQueryWatchdogType @ 0x1404FE800 (HalpTimerQueryWatchdogType.c)
 *     HalpDpQueryMaxHotPlugMemoryAddress @ 0x140506908 (HalpDpQueryMaxHotPlugMemoryAddress.c)
 *     HalpHvQueryHyperlaunchEntrypoint @ 0x14051B358 (HalpHvQueryHyperlaunchEntrypoint.c)
 *     HalpQueryHeterogeneousMemoryAttributesInterface @ 0x1407E13F8 (HalpQueryHeterogeneousMemoryAttributesInterface.c)
 *     HalpQueryPerDeviceMsiLimitInformation @ 0x1407E140C (HalpQueryPerDeviceMsiLimitInformation.c)
 *     xHalAllocatePmcCounterSet @ 0x1407FD5B0 (xHalAllocatePmcCounterSet.c)
 ...
 *     HalpQuerySecondaryInterruptInformation @ 0x140862B40 (HalpQuerySecondaryInterruptInformation.c)
 ...
 *     HalpGetMcaLog @ 0x14093339C (HalpGetMcaLog.c)
 *     HalpQueryAcpiWakeAlarmSystemPowerState @ 0x140934FDC (HalpQueryAcpiWakeAlarmSystemPowerState.c)
 *     HalpAuditQueryResults @ 0x140935354 (HalpAuditQueryResults.c)
