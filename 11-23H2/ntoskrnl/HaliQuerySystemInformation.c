 ...
 *     <none>
 * Callees:
 *     HalpGetPlatformTimerInformation @ 0x140366C40 (HalpGetPlatformTimerInformation.c)
 *     HalpQueryNumaRangeTableInformation @ 0x1403B54C0 (HalpQueryNumaRangeTableInformation.c)
 *     HalpGetDisplayBiosInformation @ 0x1403B6158 (HalpGetDisplayBiosInformation.c)
 *     xKdEnumerateDebuggingDevices @ 0x1403B6E60 (xKdEnumerateDebuggingDevices.c)
 *     __security_check_cookie @ 0x1403D7EC0 (__security_check_cookie.c)
 *     memmove @ 0x140435B00 (memmove.c)
 *     memset @ 0x140435E00 (memset.c)
 *     HalpTimerQueryWatchdogType @ 0x1404FED50 (HalpTimerQueryWatchdogType.c)
 *     HalpDpQueryMaxHotPlugMemoryAddress @ 0x140506E58 (HalpDpQueryMaxHotPlugMemoryAddress.c)
 *     HalpHvQueryHyperlaunchEntrypoint @ 0x14051B8A8 (HalpHvQueryHyperlaunchEntrypoint.c)
 *     HalpQueryHeterogeneousMemoryAttributesInterface @ 0x1407E16C8 (HalpQueryHeterogeneousMemoryAttributesInterface.c)
 *     HalpQueryPerDeviceMsiLimitInformation @ 0x1407E16DC (HalpQueryPerDeviceMsiLimitInformation.c)
 *     xHalAllocatePmcCounterSet @ 0x1407FD880 (xHalAllocatePmcCounterSet.c)
 ...
 *     HalpQuerySecondaryInterruptInformation @ 0x140862D80 (HalpQuerySecondaryInterruptInformation.c)
 ...
 *     HalpGetMcaLog @ 0x14093359C (HalpGetMcaLog.c)
 *     HalpQueryAcpiWakeAlarmSystemPowerState @ 0x1409351DC (HalpQueryAcpiWakeAlarmSystemPowerState.c)
 *     HalpAuditQueryResults @ 0x140935554 (HalpAuditQueryResults.c)
 ...
 *     HalpQueryChannelTopologyInformation @ 0x140B929E8 (HalpQueryChannelTopologyInformation.c)
 */
