/*
 * XREFs of IopXxxControlFile @ 0x1406E54E0
 * Callers:
 ...
 *     NtFsControlFile @ 0x1407BAF30 (NtFsControlFile.c)
 ...
 *     IopIsStandardFsctlIoControlCode @ 0x140555A6C (IopIsStandardFsctlIoControlCode.c)
          ...
          if ( (unsigned int)dword_140C038E0 > 5 )
          {
            if ( tlgKeywordOn((__int64)&dword_140C038E0, 0x200000000000LL) )
            {
              ...
              tlgWriteTransfer_EtwWriteTransfer(
                ...
                (unsigned __int8 *)byte_14002C7CD,
                0LL,
                0LL,
                5u,
                &v108);
