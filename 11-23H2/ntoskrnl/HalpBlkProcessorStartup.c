/*
 * XREFs of HalpBlkProcessorStartup @ 0x140B14010
 * Callers:
 *     <none>
 * Callees:
 *     HalpBlkApicInitializeLocalUnit @ 0x140B15FB0 (HalpBlkApicInitializeLocalUnit.c)
 *     HalpBlkMceInitialize @ 0x140B164F0 (HalpBlkMceInitialize.c)
