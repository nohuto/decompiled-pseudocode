/*
 * XREFs of AlpcpInitializeMessageLog @ 0x14085A640
 * Callers:
...
LABEL_11:
    ...
    if ( a1 )
    {
      ...
      while ( 1 )
      {
        ...
        v13[7] = v13 + 6;
        v13[6] = v13 + 6;
        v14 = (_QWORD *)qword_140C40638;
        if ( *(__int64 **)qword_140C40638 != &AlpcpFreeMessageLogListHead )
          break;
        v13[1] = qword_140C40638;
        ++v11;
        *v13 = &AlpcpFreeMessageLogListHead;
        *v14 = v13;
        v12 = v11;
        qword_140C40638 = (__int64)v13;
        if ( v11 >= a1 )
          goto LABEL_17;
      }
LABEL_22:
