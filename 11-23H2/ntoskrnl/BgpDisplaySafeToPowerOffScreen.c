/*
 * XREFs of BgpDisplaySafeToPowerOffScreen @ 0x140673394
 * Callers:
...
__int64 BgpDisplaySafeToPowerOffScreen()
{
  ...
  if ( (dword_140C0E4B0 & 2) != 0 )
  {
    ...
    *(_DWORD *)(*(_QWORD *)(qword_140C70BA0 + 24) + 40LL) = -16777216;
    ...
    if ( v3 )
      dword_140C64A50 = v4;
    BcpDisplayCriticalString(&stru_140C70B90.Length, dword_140C0B5A0[18 * DisplayType + 2], v2, DisplayType);
  }
  else
  {
