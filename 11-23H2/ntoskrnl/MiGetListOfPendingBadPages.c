...
__int64 __fastcall MiGetListOfPendingBadPages(__int64 a1)
{
  ...
  if ( !qword_140C67308 )
    return 0LL;
  v2 = qword_140C67308 + qword_140C67368;
  if ( qword_140C67308 + qword_140C67368 >= (unsigned __int64)qword_140C67308 )
  {
    while ( 1 )
    {
      if ( !v2 )
      ...
      if ( qword_140C67318 )
        break;
      v7 = ExAcquireSpinLockShared(&dword_140C67310);
      if ( !qword_140C67318 && v2 >= qword_140C67308 + qword_140C67368 )
      {
        v5[2] += MiEnumerateBadHugeRangePages(v6, v2, 2);
        v25 = (_QWORD *)qword_140C67300;
        v26 = 0LL;
        while ( v25 )
        {
          v26 = v25;
