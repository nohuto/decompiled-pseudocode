/*
 * XREFs of HalpBlkIdleLoop @ 0x140B16530
 * Callers:
 *     HalpBlkProcessorStartup @ 0x140B14010 (HalpBlkProcessorStartup.c)
 * Callees:
 *     HalpBlkIdleHalt @ 0x140B14060 (HalpBlkIdleHalt.c)
 *     HalpBlkIdlePortReadHalt @ 0x140B14070 (HalpBlkIdlePortReadHalt.c)
 *     HalpBlkIdlePortRead @ 0x140B14080 (HalpBlkIdlePortRead.c)
 *     HalpBlkIdleMonitorMWait @ 0x140B14090 (HalpBlkIdleMonitorMWait.c)
 */
