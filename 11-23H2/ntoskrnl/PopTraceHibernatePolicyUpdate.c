/*
 * XREFs of PopTraceHibernatePolicyUpdate @ 0x140801414
 * Callers:
...
void PopTraceHibernatePolicyUpdate()
{
  ...
  if ( (unsigned int)dword_140C03950 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL) )
    {
      ...
      v4 = 0x1000000LL;
      v11 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03950, (unsigned __int8 *)byte_14002E651, 0LL, 0LL, 5u, &v5);
    }
  }
}
