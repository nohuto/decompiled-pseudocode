...
__int64 __fastcall MiReplenishPageSlist(__int64 a1, int a2, unsigned int a3, __int64 a4)
{
  ...
  v11 = v10 + 64;
  v42 = *(_QWORD *)(v4 + 16) + 25408 * ((unsigned __int64)a3 >> byte_140C65A8D);
  v36 = (unsigned __int8)(MiChannelMaximumPowerOf2Mask & (a3 >> byte_140C65A8E));
  if ( a2 )
  {
  ...
  v14 = (unsigned __int64 *)(v12 + 88 * ((unsigned int)dword_140C65AFC + v8));
  v38 = v14;
  if ( v10 > *v14 )
    v10 = *(_QWORD *)(88 * ((unsigned int)dword_140C65AFC + v8) + v12);
...
LABEL_18:
      ...
      if ( v22 )
      {
        if ( qword_140C65B40 )
        {
          if ( (v22 & 0x10) != 0 )
            ...
            LODWORD(v22) = ~(_DWORD)qword_140C65B40 & v22;
        }
      }
      else
      {
    ...
    v31 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67EA0 + 1) + 4 * (v29 >> 5));
