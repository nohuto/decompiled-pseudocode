/*
 * XREFs of McTemplateK0xxxqq_EtwWriteTransfer @ 0x14053F7A4
 * Callers:
 *     FsRtlDedupChangeLogWrite @ 0x14093E930 (FsRtlDedupChangeLogWrite.c)
 *     FsRtlHeatLogIo @ 0x14093FBC0 (FsRtlHeatLogIo.c)
 * Callees:
