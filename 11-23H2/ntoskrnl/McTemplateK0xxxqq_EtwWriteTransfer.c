/*
 * XREFs of McTemplateK0xxxqq_EtwWriteTransfer @ 0x14053F0E4
 * Callers:
 *     FsRtlDedupChangeLogWrite @ 0x14093E730 (FsRtlDedupChangeLogWrite.c)
 *     FsRtlHeatLogIo @ 0x14093F9C0 (FsRtlHeatLogIo.c)
 * Callees:
