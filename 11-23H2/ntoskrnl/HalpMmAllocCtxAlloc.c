/*
 * XREFs of HalpMmAllocCtxAlloc @ 0x14039AE20
 * Callers:
 ...
 *     HalpRegisterUsbController @ 0x140520F88 (HalpRegisterUsbController.c)
...
LABEL_37:
    v29 = 0LL;
    LOBYTE(v8) = KeAcquireSpinLockRaiseToDpc(&qword_140C63DD0);
    goto LABEL_22;
  }
  v6 = KeAcquireSpinLockRaiseToDpc(&qword_140C63DD0);
...
LABEL_22:
          ...
          *(_QWORD *)(v32 + 8) = v7;
          ...
          KxReleaseSpinLock((volatile signed __int64 *)&qword_140C63DD0);
          if ( KiIrqlFlags )
          {
