...
_BOOL8 __fastcall MiWritePageFileHash(__int64 a1, _QWORD *a2, int a3, unsigned int a4)
{
  ...
  v7 = 17;
  v37 = 17;
  result = dword_140C69650 != 0;
  v10 = a1;
  v40 = dword_140C69650 != 0;
  v11 = a3;
  v12 = 0;
  while ( 1 )
  {
...
LABEL_22:
    ...
    v20 = 0;
    v21 = *(_QWORD *)(a1 + 216) + (unsigned int)(dword_140C6964C * v11);
    if ( v4 )
    {
      v22 = v40;
      v23 = 1;
      do
      {
        if ( (*(_DWORD *)v21 > v23 || v22 && ((unsigned __int8)v23 & *(_BYTE *)(v21 + 8)) != 0) && !dword_140C67F44 )
          MiPageHashBugCheck(0x60uLL, v11 + v20, (int)&v43[2 * v20 + 2]);
        MiWriteEntirePageHashEntry(v21, &v43[2 * v20 + 2]);
        v20 = v23 + v24;
        v21 = (unsigned int)dword_140C6964C + v25;
      }
      while ( v20 < v4 );
    }
