...
unsigned __int64 __fastcall MiMakeOutswappedPageResident(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  v7 = (_QWORD *)(a1 + 1432);
  v77 = (_QWORD *)(a1 + 1432);
  v73 = *(_QWORD *)(qword_140C673C8 + 8 * v6);
  while ( 1 )
  {
...
LABEL_47:
  ...
  *(_QWORD *)(v33 + 16) = v12;
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)&BugCheckParameter2[192] = v44;
    PagingFileOffset = MiGetPagingFileOffset((unsigned __int64)v38);
    v46 = v41 & 0xF;
  ...
  *(_BYTE *)(v33 + 34) |= 0x10u;
  ...
  v7 = v77;
LABEL_100:
  ValidPte = MiMakeValidPte(0xFFFFF6FB7DBEDF68uLL, v13, 2147483652LL);
  v65 = ValidPte;
  v66 = 0;
  if ( MiPteInShadowRange((unsigned __int64)v7) )
  {
