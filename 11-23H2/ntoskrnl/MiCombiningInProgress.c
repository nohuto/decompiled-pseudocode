/*
 * XREFs of MiCombiningInProgress @ 0x14036F3DC
 * Callers:
...
void __fastcall MiCombiningInProgress(__int64 *a1, unsigned __int64 *a2, int a3)
{
  ...
  v3 = *a1;
  v7 = ExAcquireSpinLockExclusive(&dword_140C67240);
  if ( !a3 )
  {
    v8 = *a2;
    ...
    if ( *(unsigned __int64 **)(*a2 + 8) == a2 && *v9 == a2 )
    {
      ...
      *(_QWORD *)(v8 + 8) = v9;
      RtlAvlRemoveNode((unsigned __int64 *)&qword_140C67248, a2 + 2);
      --*((_DWORD *)a1 + 16);
      if ( dword_140C67244 == 1 )
...
LABEL_25:
  ...
  {
    dword_140C67258 = 1;
    qword_140C67250 = _InterlockedIncrement64(&PsNextSecurityDomain);
  }
...
LABEL_15:
  ...
  v16 = 1;
LABEL_17:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C67248, (unsigned __int64)v17, v16, (unsigned __int64)(a2 + 2));
LABEL_7:
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C67240);
