/*
 * XREFs of PspBuildCreateProcessContext @ 0x140771168
 * Callers:
 ...
 *     IsTrustletCreateAttributeWellFormed @ 0x1405A3F9C (IsTrustletCreateAttributeWellFormed.c)
 ...
 *     RtlValidProcessProtection @ 0x1407E9BC0 (RtlValidProcessProtection.c)
