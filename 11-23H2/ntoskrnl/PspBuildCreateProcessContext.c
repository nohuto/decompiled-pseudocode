/*
 * XREFs of PspBuildCreateProcessContext @ 0x140771358
 * Callers:
 ...
 *     IsTrustletCreateAttributeWellFormed @ 0x1405A450C (IsTrustletCreateAttributeWellFormed.c)
 ...
 *     RtlValidProcessProtection @ 0x1407E9E90 (RtlValidProcessProtection.c)
          ...
          if ( v104 )
          {
            ...
            if ( v105 )
            {
              ...
              if ( !v106 )
              {
                if ( v12[1] != 1LL )
                  goto LABEL_17;
                v108.Level = *((_BYTE *)v12 + 16);
                *(PS_PROTECTION *)(a4 + 360) = v108;
      ...
      else
      {
        ...
        if ( !v70 )
        {
          ...
          *(_QWORD *)(*(_QWORD *)v87 + 24LL) = 0LL;
          ...
          v93 = *(unsigned int *)(*(_QWORD *)v87 + 16LL);
          v94 = *(_QWORD *)v87;
          if ( (_DWORD)v93 )
          {
          ...
          if ( *(_DWORD *)(*(_QWORD *)v87 + 16LL) )
          {
            *(_QWORD *)(*(_QWORD *)v87 + 24LL) = v97;
            memmove(*(void **)(*(_QWORD *)v87 + 24LL), v90, 8LL * *(unsigned int *)(*(_QWORD *)v87 + 16LL));
          }
          goto LABEL_261;
        }
        v71 = v70 - 1;
