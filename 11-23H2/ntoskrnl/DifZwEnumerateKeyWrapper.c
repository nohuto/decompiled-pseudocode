/*
 * XREFs of DifZwEnumerateKeyWrapper @ 0x1405F05C0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwEnumerateKeyWrapper(
        HANDLE KeyHandle,
        ULONG Index,
        unsigned __int32 KeyInformationClass,
...
LABEL_10:
  ...
  *(_QWORD *)&v23 = __PAIR64__(Index, KeyInformationClass);
