/*
 * XREFs of MiInsertPteTracker @ 0x1406618D4
 * Callers:
...
__int64 __fastcall MiInsertPteTracker(__int64 a1, int a2, char a3, char a4)
{
  ...
  if ( LOWORD(stru_140C68380.Alignment) >= 0xAu )
  {
    v10 = RtlpInterlockedFlushSList(&stru_140C68380);
    v8 = v10;
    if ( v10 )
    {
      Next = v10->Next;
  ...
  {
    v8 = RtlpInterlockedPopEntrySList(&stru_140C68380);
    if ( v8 )
      goto LABEL_8;
  }
...
LABEL_14:
  ...
  *((_QWORD *)&v8[3].Next + 1) = *(_QWORD *)(a1 + 48);
  ...
  KeAcquireInStackQueuedSpinLock(&qword_140C68390, &LockHandle);
  v22 = (char *)&unk_140C6A230 + 16 * (((unsigned __int8)v21 ^ BYTE4(v21)) & 0xF);
  v23 = *(_QWORD *)v22;
  ...
  *(_QWORD *)v22 = v8;
  qword_140C6A330 += v19;
  v24 = ++qword_140C6A338;
  if ( qword_140C6A338 > (unsigned __int64)qword_140C6A340 )
    qword_140C6A340 = v24;
