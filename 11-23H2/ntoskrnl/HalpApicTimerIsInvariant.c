/*
 * XREFs of HalpApicTimerIsInvariant @ 0x1403A5178
 * Callers:
...
LABEL_4:
  v7 = 0;
  ((void (__fastcall *)(_QWORD, unsigned int *, int *, int *, int *))qword_140D0E088)(0LL, &v6, &v5, &v5, &v5);
  if ( v6 >= 6 )
    ((void (__fastcall *)(__int64, int *, int *, int *, int *))qword_140D0E088)(6LL, &v7, &v5, &v5, &v5);
  return (v7 & 4) != 0;
}
