/*
 * XREFs of DifKeTryToAcquireSpinLockAtDpcLevelWrapper @ 0x1405E6720
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeTryToAcquireSpinLockAtDpcLevelWrapper(volatile signed __int32 *a1)
{
  ...
  v15 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(318);
...
LABEL_17:
  result = KxTryToAcquireSpinLock(a1);
  LOBYTE(v15) = result;
  if ( v7 )
  {
    v12 = (_QWORD **)(v7 + 6);
