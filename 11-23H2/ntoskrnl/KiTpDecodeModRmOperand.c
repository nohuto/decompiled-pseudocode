/*
 * XREFs of KiTpDecodeModRmOperand @ 0x140AF32E0
 * Callers:
 *     KiTpEmulateGroup0Instruction @ 0x140AF343C (KiTpEmulateGroup0Instruction.c)
 *     KiTpEmulateGroup11Instruction @ 0x140AF3694 (KiTpEmulateGroup11Instruction.c)
 ...
 *     KiTpEmulateMovzx @ 0x140AF415C (KiTpEmulateMovzx.c)
 * Callees:
 *     KiTpGetRegisterAddressByIndex @ 0x140AF43F8 (KiTpGetRegisterAddressByIndex.c)
 */
