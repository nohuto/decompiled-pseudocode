/*
 * XREFs of IopLiveDumpTraceCorralProcessorsDuration @ 0x14055AE78
 * Callers:
    ...
    if ( !v3[106] )
    {
      ...
      if ( (v2 & 1) != 0 )
      {
        *(_QWORD *)&UserData.Size = 8LL;
        ...
        v4 = (const EVENT_DESCRIPTOR *)LIVEDUMP_EVENT_SIZING_WORKFLOW_SYSTEM_QUIESCED_CORRAL_PROCESSORS;
        v13 = 8LL;
        va_copy(v12, va1);
        va_copy(v14, va2);
        va_copy(v16, va3);
        if ( (v3[20] & 1) == 0 )
          v4 = &LIVEDUMP_EVENT_CAPTURE_PAGES_WORKFLOW_SYSTEM_QUIESCED_CORRAL_PROCESSORS;
        v15 = 8LL;
        v17 = 8LL;
        LOBYTE(v2) = EtwWriteEx(IopLiveDumpEtwRegHandle, v4, 0LL, 0, 0LL, 0LL, 4u, &UserData);
        if ( (unsigned int)dword_140C03870 > 5 )
        {
          LOBYTE(v2) = tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL);
          if ( (_BYTE)v2 )
          {
            v6 = 0x1000000LL;
            v19 = &v6;
            ...
            LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)byte_14002BE5B,
                           (const GUID *)(a1 + 968),
                           (const GUID *)(a1 + 952),
                           7u,
                           &v18);
