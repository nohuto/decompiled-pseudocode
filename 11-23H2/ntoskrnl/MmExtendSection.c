/*
 * XREFs of MmExtendSection @ 0x140706714
 * Callers:
...
LABEL_20:
        if ( *(_QWORD *)(v8 + 32) )
        {
          ...
          v20 = KeAbPreAcquire((__int64)&qword_140C65550, 0LL);
          v21 = v20;
          if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65550, 0LL) )
            ExfAcquirePushLockExclusiveEx(&qword_140C65550, v20, (__int64)&qword_140C65550);
          if ( v21 )
            *(_BYTE *)(v21 + 18) = 1;
