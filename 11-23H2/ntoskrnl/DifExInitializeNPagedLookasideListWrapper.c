/*
 * XREFs of DifExInitializeNPagedLookasideListWrapper @ 0x1405D94E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifExInitializeNPagedLookasideListWrapper(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        unsigned int a4,
        ...
        __int64 (__fastcall *a9)(__int64, __int64, __int64, _QWORD, __int64, int, __int16, int))
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(44);
