/*
 * XREFs of MiQueryAddressSpan @ 0x140273FF0
 * Callers:
...
unsigned __int64 __fastcall MiQueryAddressSpan(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, ULONG_PTR a4)
{
  ...
  unsigned int v46; // [rsp+54h] [rbp-24h] BYREF
  int v47; // [rsp+58h] [rbp-20h] BYREF
  int v48; // [rsp+5Ch] [rbp-1Ch] BYREF
  unsigned int v49; // [rsp+60h] [rbp-18h] BYREF
  ...
  if ( a3 > v10 || !a3 )
    v7 = v10;
  v11 = v7 - 1;
  v12 = (volatile signed __int32 *)&unk_140C6A180;
  ...
  if ( v16 <= 4u )
  {
    if ( v16 == 2 )
    {
      v17 = (volatile __int32 *)&unk_140C6A180;
      goto LABEL_7;
    }
LABEL_6:
  ...
  *(_WORD *)(a1 + 20) = v52;
  ...
  if ( v27 <= 4u || (LOBYTE(v28) = v26, v27 == 5) )
  {
    if ( (*(_DWORD *)(v15 + 188) & 3) != 0 || (v28 & 0x10) != 0 )
      MiPreUnlockWorkingSetShared(v15, v20);
    if ( (*(_BYTE *)(v15 + 184) & 7) != 2 )
      v12 = (volatile signed __int32 *)(v15 + 192);
    MiCheckProcessShadow(v15, 1u, v21, v22);
