/*
 * XREFs of DifRtlOemStringToUnicodeStringWrapper @ 0x1405EBCD0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlOemStringToUnicodeStringWrapper(
...
LABEL_17:
  result = RtlOemStringToUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
