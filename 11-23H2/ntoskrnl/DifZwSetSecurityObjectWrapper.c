/*
 * XREFs of DifZwSetSecurityObjectWrapper @ 0x1405F7C50
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwSetSecurityObjectWrapper(
        HANDLE Handle,
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(643);
...
LABEL_10:
  *((_QWORD *)&v19 + 1) = Handle;
  LODWORD(v19) = SecurityInformation;
  *((_QWORD *)&v18 + 1) = SecurityDescriptor;
...
LABEL_17:
  result = ZwSetSecurityObject(Handle, SecurityInformation, SecurityDescriptor);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
