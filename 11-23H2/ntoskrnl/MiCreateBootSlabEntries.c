/*
 * XREFs of MiCreateBootSlabEntries @ 0x140B46868
 * Callers:
...
LABEL_33:
    ...
    qword_140C6FA18 += v13;
LABEL_12:
    if ( _bittest64((const signed __int64 *)qword_140C6F370, v6 >> 9) )
      KeBugCheckEx(0x1Au, 0x3030311uLL, *(_QWORD *)(v10 + 24), *(int *)(a1 + 80), 0LL);
    _bittestandset64((signed __int64 *)qword_140C6F370, v6 >> 9);
