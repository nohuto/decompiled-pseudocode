/*
 * XREFs of MiStoreUpdatePagefileHash @ 0x14065D038
 * Callers:
    ...
    do
    {
      ...
      else
      {
        ...
        if ( (*(_QWORD *)(v15 + 16) & 4) != 0 )
        {
          ...
          PagingFileOffset = MiGetPagingFileOffset(v15 + 16);
          v16 = v26;
        ...
        if ( !v9 )
        {
          result = qword_140C673C8;
          v9 = *(_QWORD *)(qword_140C673C8 + 8 * ((*(_QWORD *)(v15 + 40) >> 43) & 0x3FFLL));
        }
        v6 = v23;
      }
      if ( v12 == v13 && v14 == v8 )
