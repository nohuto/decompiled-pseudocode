/*
 * XREFs of HalpDmaAllocateMappingResources @ 0x140B609CC
 * Callers:
...
__int64 HalpDmaAllocateMappingResources()
{
  ...
  qword_140C70BD0 = HalpMmAllocCtxAlloc(v2, 8 * MaximumProcessorCount);
  if ( !qword_140C70BD0 )
    return 3221225626LL;
...
LABEL_14:
  ...
  {
    qword_140C70BD8 = HalpMmAllocCtxAlloc(v5, 8 * MaximumProcessorCount);
    if ( qword_140C70BD8 )
    {
      v11 = 0;
      if ( !(_DWORD)MaximumProcessorCount )
...
LABEL_12:
      ...
      while ( 1 )
      {
        ...
        v15 = qword_140C70BD8;
        *(_QWORD *)(v12 + qword_140C70BD8) = ReservedMapping;
        if ( !ReservedMapping )
          break;
        ++v11;
        v12 += 8LL;
    ...
    HalpMmAllocCtxFree(v10, qword_140C70BD0);
    v17 = v7;
    goto LABEL_14;
  }
LABEL_21:
  ...
  {
    HalpMmAllocCtxFree(v22, qword_140C70BD0);
