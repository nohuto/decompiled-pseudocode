/*
 * XREFs of IommupHvAttachPasidDeviceDomain @ 0x140524A9C
 * Callers:
...
__int64 __fastcall IommupHvAttachPasidDeviceDomain(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( a4 )
  {
    ...
    return (unsigned int)((__int64 (__fastcall *)(__int64, __int64 *))qword_140C62630)(v10, &v12);
  }
  if ( *(_DWORD *)(a2 + 8) != 1 )
  {
    ...
    BYTE4(v12) = 1;
    v16 = v12;
    v4 = ((__int64 (__fastcall *)(__int64 *))qword_140C62628)(&v16);
    if ( v4 < 0 )
      goto LABEL_10;
    v15 = 0LL;
    *(_QWORD *)&v13 = 1LL;
    ...
    LOBYTE(v14) = 1;
    *((_QWORD *)&v13 + 1) = a3;
    v4 = ((__int64 (__fastcall *)(__int64 *, __int128 *))qword_140C62690)(&v12, &v13);
    if ( v4 >= 0 )
LABEL_9:
      ++*(_DWORD *)(a2 + 96);
    else
      ((void (__fastcall *)(__int64 *))qword_140C62640)(&v12);
LABEL_10:
