/*
 * XREFs of IommupHvInitializeLibrary @ 0x140B92694
 * Callers:
        ...
        if ( (_DWORD)v1 )
        {
          ...
          while ( 1 )
          {
            ...
            *v16 = ContiguousNodeMemory + 4096;
            ...
            v3 = ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD))qword_140C625C8)(
                   v8,
                   128LL,
...
LABEL_32:
          for ( i = 0; i < v0; ++i )
            ((void (__fastcall *)(_QWORD))qword_140C625D0)(i);
          v15 = v2 + 1;
          do
          {
            if ( *v15 )
