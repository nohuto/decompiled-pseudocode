/*
 * XREFs of FsRtlIsFatDbcsLegal @ 0x1407B6B70
 * Callers:
 *     FsRtlIsFatDbcsLegal @ 0x1407B6B70 (FsRtlIsFatDbcsLegal.c)
 * Callees:
 *     FsRtlIsFatDbcsLegal @ 0x1407B6B70 (FsRtlIsFatDbcsLegal.c)
 *     FsRtlDoesDbcsContainWildCards @ 0x1408A4C80 (FsRtlDoesDbcsContainWildCards.c)
...
LABEL_3:
  ...
  if ( WildCardsPermissible && FsRtlDoesDbcsContainWildCards(DbcsName) )
  {
    ...
    if ( DbcsName->Length )
    {
      while ( 1 )
      {
        ...
        else if ( (v19 & 0x80u) == 0LL && (*((_BYTE *)qword_140017410 + v19) & 9) == 0 )
        {
          return 0;
        }
  ...
  if ( DbcsName->Length )
  {
    do
    {
      ...
      {
        if ( (v11 & 0x80u) == 0LL
          && ((WildCardsPermissible != 0 ? 9 : 1) & *((unsigned __int8 *)qword_140017410 + v11)) == 0 )
        {
          return 0;
        }
