/*
 * XREFs of RtlDeleteRange @ 0x140815450
 * Callers:
 *     ArbBacktrackAllocation @ 0x140936100 (ArbBacktrackAllocation.c)
 *     IopPortBacktrackAllocation @ 0x14095A0C0 (IopPortBacktrackAllocation.c)
 * Callees:
