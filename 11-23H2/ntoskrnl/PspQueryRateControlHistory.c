/*
 * XREFs of PspQueryRateControlHistory @ 0x14070705C
 * Callers:
  ...
  *a4 = 0;
  ...
  if ( v11 )
  {
    if ( a5 )
    {
      if ( a5 == 1 )
      {
        result = PspJobIoRateQueryHistory(a1, &v25, &v23, &TargetBit);
        if ( (int)result < 0 )
          return result;
      }
      else
      {
        KeQuerySchedulingGroupHistory(v11 + 128, &v25, &v23, &TargetBit);
      }
      v12 = v23;
      v13 = TargetBit;
      v14 = v25;
