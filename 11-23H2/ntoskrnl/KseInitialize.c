/*
 * XREFs of KseInitialize @ 0x140B495CC
 * Callers:
...
LABEL_12:
  ...
  v14 = _InterlockedCompareExchange(&dword_140C64D34, 1, 0);
  if ( v14 == 2 )
    return 0LL;
  if ( v14 == 1 )
    return 259LL;
...
LABEL_35:
    ...
    if ( qword_140C64D78 )
    {
      KsepCacheUninitialize(qword_140C64D78);
      qword_140C64D78 = 0LL;
    }
    KseEngine |= 3u;
    dword_140C64D38 |= 0x400u;
    v17 = KsepDebugFlag;
