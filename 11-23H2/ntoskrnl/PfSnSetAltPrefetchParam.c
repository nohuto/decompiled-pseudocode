/*
 * XREFs of PfSnSetAltPrefetchParam @ 0x14097F9F8
 * Callers:
    ...
    if ( v10 >= 0 )
    {
      ...
      if ( v10 >= 0 )
      {
        ...
        *(_DWORD *)(v8 + 120) = *(_DWORD *)&Str2[32];
        ...
        v17 = *(_QWORD *)(v8 + 48);
        v38 = v17;
        v18 = (unsigned __int64)qword_140C6A718;
        if ( (xmmword_140C6A720 & 1) != 0 && qword_140C6A718 )
          v18 = (unsigned __int64)&qword_140C6A718 ^ (unsigned __int64)qword_140C6A718;
        v19 = xmmword_140C6A720 & 1;
        while ( v18 )
        {
        ...
        if ( !v18 )
        {
          v22 = *(_QWORD *)(v8 + 48);
          v38 = v22;
          v23 = (unsigned __int64)qword_140C6A718;
          if ( (xmmword_140C6A720 & 1) != 0 && qword_140C6A718 )
            v23 = (unsigned __int64)&qword_140C6A718 ^ (unsigned __int64)qword_140C6A718;
          v24 = xmmword_140C6A720 & 1;
          v25 = 0;
          if ( v23 )
          {
            while ( 1 )
...
LABEL_41:
          ...
          RtlRbInsertNodeEx((unsigned __int64 *)&qword_140C6A718, v23, v25, v8);
          v27 = *((_QWORD *)&xmmword_140C6A720 + 1);
          if ( (qword_140C6A730 & 1) != 0 && *((_QWORD *)&xmmword_140C6A720 + 1) )
            v27 = ((unsigned __int64)&xmmword_140C6A720 + 8) ^ *((_QWORD *)&xmmword_140C6A720 + 1);
          v28 = qword_140C6A730 & 1;
          v29 = 0;
          if ( v27 )
          {
            while ( 1 )
...
LABEL_57:
          ...
          RtlRbInsertNodeEx((unsigned __int64 *)&xmmword_140C6A720 + 1, v27, v29, v8 + 24);
