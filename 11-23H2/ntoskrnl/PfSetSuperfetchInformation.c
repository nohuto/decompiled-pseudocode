/*
 * XREFs of PfSetSuperfetchInformation @ 0x14075F994
 * Callers:
...
LABEL_111:
        ...
        PfpScenCtxServiceThreadSet((ULONG_PTR)&qword_140C64FB0);
        break;
      case 0x13:
        if ( DWORD2(v20) == 12 )
        {
    ...
    switch ( DWORD2(v19) )
    {
      ...
      case 0xD:
        if ( DWORD2(v20) == 8 )
        {
          ...
          {
            v8 = PfpScenCtxPrefetchStateSet((ULONG_PTR)&qword_140C64FB0);
            goto LABEL_11;
          }
          goto LABEL_111;
        }
