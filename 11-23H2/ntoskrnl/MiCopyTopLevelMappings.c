...
struct _KTHREAD *__fastcall MiCopyTopLevelMappings(__int64 a1, __int64 a2)
{
  ...
  memmove(
    ...
    8 * ((((unsigned __int64)qword_140C6A558 >> 39) & 0x1FF) - 256));
  MiShadowTopLevelPxes(a1, 0xFFFFF6FB7DBED800uLL, 256LL);
  memmove(
    (void *)(a2 + 8 * ((((unsigned __int64)qword_140C67070 >> 39) & 0x1FF) + 1)),
    (const void *)(8 * ((((unsigned __int64)qword_140C67070 >> 39) & 0x1FF) + 1) - 0x90482413000LL),
    8 * (511 - (((unsigned __int64)qword_140C67070 >> 39) & 0x1FF)));
  v4 = (_QWORD *)(a2 + 8 * (((unsigned __int64)qword_140C659E8 >> 39) & 0x1FF));
  v5 = 0LL;
  ...
  {
    v12 = 0;
    result = (struct _KTHREAD *)MiPteInShadowRange((unsigned __int64)v4);
    if ( (_DWORD)result )
    {
