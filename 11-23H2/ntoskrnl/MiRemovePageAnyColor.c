/*
 * XREFs of MiRemovePageAnyColor @ 0x1402EBA04
 * Callers:
...
__int64 __fastcall MiRemovePageAnyColor(__int64 a1, unsigned int a2, int a3)
{
  ...
  v5 = a2;
  v6 = *(_QWORD *)(a1 + 16) + 25408 * ((unsigned __int64)a2 >> byte_140C65A8D);
  if ( (a3 & 0x400) != 0 )
    v7 = 0;
  else
    v7 = ((a3 & 0x800) != 0) + 1;
  ...
  if ( (unsigned int)MmNumberOfChannels > 1 )
    v9 = (_QWORD *)(v6 + 8
                       * (v8 + 2LL * (unsigned __int8)(MiChannelMaximumPowerOf2Mask & (v5 >> byte_140C65A8E)) + 2867));
  else
  ...
  if ( *v9 )
  {
    ...
    v12 = v5;
    v30 = 0LL;
    v13 = dword_140C65AF8 + 1;
    v29 = *(_QWORD *)(a1 + 8 * v8 + 2496) + 88LL * dword_140C65AFC * v7;
    v28 = v7;
