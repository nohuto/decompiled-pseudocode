...
__int64 __fastcall PfGetCompletedTrace(_QWORD *a1, unsigned int a2, char a3, unsigned int *a4)
{
  ...
  v7 = dword_140C65358 < (unsigned int)dword_140C6535C;
  v8 = 0;
  while ( 1 )
  {
    v9 = qword_140C65338;
  ...
  *(_QWORD *)(v12 + 8) = v11;
  --*v10;
LABEL_17:
  if ( !v7 && dword_140C65358 < (unsigned int)dword_140C6535C )
  {
  ...
  if ( v4 )
  {
    ...
    *(_OWORD *)a1 = 0LL;
    *(_DWORD *)a1 = 1048577;
    a1[1] = ((MEMORY[0xFFFFF78000000004] * HIDWORD(qword_140C650B8)) << 8)
          + ((MEMORY[0xFFFFF78000000004] * (unsigned __int64)(unsigned int)qword_140C650B8) >> 24);
