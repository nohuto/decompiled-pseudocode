...
__int64 XmInitializeEmulator()
{
  ...
  do
    *v0-- = -1;
  while ( (__int64)v0 >= (__int64)word_140D17744 );
  dword_140D178A0 = 0x8000000;
  dword_140D17728 = 2048;
  word_140D1773C = 0;
  qword_140D178A8 = (__int64)x86BiosReadIoSpace;
  qword_140D178B0 = (__int64)x86BiosWriteIoSpace;
  qword_140D178B8 = (__int64)x86BiosTranslateAddress;
