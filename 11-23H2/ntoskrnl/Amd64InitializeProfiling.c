...
__int64 Amd64InitializeProfiling()
{
  ...
  if ( !Number )
  {
    ...
    if ( (v9 & 0x1000000) != 0 && (v9 & 0x400000) != 0 )
    {
      ...
      qword_140C5FE78 = (__int64)&Amd64DataFabricStatusHead;
    ...
    if ( (v9 & 0x10000000) != 0 && (v9 & 0x400000) != 0 )
    {
      ...
      qword_140C5FF28 = (__int64)&Amd64CacheStatusHead;
    ...
    qword_140C5FF50 = (__int64)&DummyAmd64CounterStatus;
    ...
    do
    {
      ...
      if ( !v50 )
      {
        v52 = (__int64 *)qword_140C63128;
        v53 = (__int64 **)((char *)&unk_140C00328 + v49);
        if ( *(__int64 **)qword_140C63128 != v47 )
          __fastfail(3u);
        ++HalpProfileSourceDescriptorCount;
        *v53 = v47;
        v53[1] = v52;
        *v52 = (__int64)v53;
        qword_140C63128 = (__int64)&unk_140C00328 + v49;
      }
      ++v48;
    }
    while ( v48 < 0x12 );
