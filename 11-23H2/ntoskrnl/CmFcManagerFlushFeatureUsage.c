...
void __fastcall CmFcManagerFlushFeatureUsage(__int64 a1, char a2, __int64 a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v9 >= 2 )
    {
      ...
      _InterlockedOr(&dword_140C14680, 8u);
      CmpWorkItemQueueWork(&stru_140C145C0);
    }
    if ( (a2 & 1) != 0 && v9 )
    {
      v10 = v7 >> 2;
  ...
  {
    v11 = (unsigned int)dword_140C14680 >> 5;
    LOBYTE(a1) = dword_140C14680 & 1;
    LOBYTE(v11) = (dword_140C14680 & 0x20) != 0;
    v12 = CmFcpManagerComputeMinimumFeatureUsageFlushTimestampIncrement(a1, v11);
    if ( v12 >= 2 )
    {
      _InterlockedOr(&dword_140C14680, 0x10u);
      CmpWorkItemQueueWork(&stru_140C145C0);
    }
    if ( (a2 & 2) != 0 && byte_140C146A8 )
    {
      v13 = (v12 + (v3 >> 5)) & 0x7FFFFFF;
      while ( 1 )
      {
        LODWORD(v15) = dword_140C14684;
        if ( ((dword_140C14684 - v13) & 0x7FFFFFFu) < 0x4000000 )
          break;
        ExBlockOnAddressPushLock(&qword_140C14520, &dword_140C14684, &v15, 4uLL, 0LL);
      }
    }
    else if ( (a2 & 1) != 0 && v12 )
    {
      ...
      while ( 1 )
      {
        LODWORD(v15) = dword_140C14680;
        if ( ((((unsigned int)dword_140C14680 >> 5) - v14) & 0x7FFFFFF) >= v12 )
          break;
        ExBlockOnAddressPushLock((volatile __int64 *)&xmmword_140C14510 + 1, &dword_140C14680, &v15, 4uLL, 0LL);
      }
    }
  }
}
