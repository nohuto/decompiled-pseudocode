/*
 * XREFs of RtlpHpSegMgrReserve @ 0x140314E44
 * Callers:
...
LABEL_2:
  ...
  v18 = *(_OWORD *)(a1 + 40);
  v13 = RtlpHpAllocVA((unsigned __int64 *)&v19, v17, v7, 0x2000, v15 ? 64 : 4, &v18);
  if ( v13 >= 0 )
  {
    LODWORD(v7) = v17[0];
    v10 = v19;
    if ( (unsigned __int64)v6 < v17[0] )
...
LABEL_3:
  ...
  {
    v18 = *(_OWORD *)(a1 + 40);
    RtlpHpFreeVA((unsigned __int64 *)&v19, (unsigned __int64 *)v17, 0x8000LL, &v18);
  }
