/*
 * XREFs of TtmiLogTerminalHandleClosed @ 0x1409AA6C4
 * Callers:
...
void __fastcall TtmiLogTerminalHandleClosed(int a1)
{
  ...
  if ( (unsigned int)dword_140D53918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53918, 1LL) )
    {
      ...
      v15 = 8LL;
      v17 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53918, (unsigned __int8 *)byte_140033A63, 0LL, 0LL, 6u, &v9);
    }
  }
}
