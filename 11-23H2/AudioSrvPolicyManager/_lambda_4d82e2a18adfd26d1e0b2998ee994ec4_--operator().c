/*
 * XREFs of _lambda_4d82e2a18adfd26d1e0b2998ee994ec4_::operator() @ 0x180020650
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_4d82e2a18adfd26d1e0b2998ee994ec4__long_IAudioSessionInfo___::_Do_call @ 0x180023070 (std--_Func_impl_no_alloc__lambda_4d82e2a18adfd26d1e0b2998ee994ec4__long_IAudioSessionInfo___--_D.c)
 * Callees:
        ...
        int (__fastcall ***a2)(__int64, GUID *, __int64 *))
{
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    ...
    v29 = v7;
    v30 = 0;
    tlgWriteTransfer_EventWriteTransfer((__int64)v4, (unsigned __int8 *)dword_180055661, 0LL, 0LL, 3u, &v27);
  }
  v8 = *a2;
  v23 = 0LL;
