/*
 * XREFs of ?LoadPropertyStore@CAudioSessionPropertyStore@@AEAAJXZ @ 0x18003D30C
 * Callers:
 ...
 *     ?Create@?$CComSafeArray@M$03@ATL@@QEAAJKJ@Z @ 0x18003C410 (-Create@-$CComSafeArray@M$03@ATL@@QEAAJKJ@Z.c)
