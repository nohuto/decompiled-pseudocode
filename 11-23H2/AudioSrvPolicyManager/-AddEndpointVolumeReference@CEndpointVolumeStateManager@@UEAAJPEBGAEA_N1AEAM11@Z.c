/*
 * XREFs of ?AddEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x18003FAD0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  __int64 v14; // rbx
  __int64 v15; // r8
  CEndpointVolumeState **v16; // rbx
  __int64 v17; // r8
  CEndpointVolumeState *v18; // rax
  __int64 v19; // rax
  unsigned __int16 *v21; // [rsp+20h] [rbp-C8h] BYREF
  CEndpointVolumeState *v22; // [rsp+28h] [rbp-C0h] BYREF
  float *v23; // [rsp+30h] [rbp-B8h]
  bool *v24; // [rsp+38h] [rbp-B0h]
  bool *v25; // [rsp+40h] [rbp-A8h]
  struct IVolumeProvider *v26[3]; // [rsp+48h] [rbp-A0h] BYREF
  __int128 v27; // [rsp+60h] [rbp-88h] BYREF
  __m128i si128; // [rsp+70h] [rbp-78h]
  _OWORD v29[2]; // [rsp+80h] [rbp-68h] BYREF
  CEndpointVolumeState *v30; // [rsp+A0h] [rbp-48h]
  ...
  *a6 = 0;
  ...
  std::wstring::wstring(&v27, a2, v13);
  v14 = std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CEndpointVolumeState>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>,0>>::count<void>(
          (_QWORD *)this + 7,
          &v27);
  std::wstring::~wstring(&v27);
  if ( !v14 )
  {
    v26[0] = *((struct IVolumeProvider **)this + 15);
    v16 = std::make_unique<CEndpointVolumeState,IVolumeProvider *,unsigned short const * &,0>(
            &v22,
            v26,
            (const unsigned __int16 **)&v21);
    std::wstring::wstring(&v27, a2, v17);
    v29[0] = v27;
    v29[1] = si128;
    ...
    *v16 = 0LL;
    ...
    std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CEndpointVolumeState>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>,0>>::emplace<std::pair<std::wstring,std::unique_ptr<CEndpointVolumeState>>>(
      ...
      (__int64)v26,
      (__int64)v29);
    std::pair<std::wstring,std::unique_ptr<CEndpointVolumeState>>::~pair<std::wstring,std::unique_ptr<CEndpointVolumeState>>(v29);
    std::wstring::~wstring(&v27);
    std::unique_ptr<CEndpointVolumeState>::~unique_ptr<CEndpointVolumeState>(&v22);
    *a3 = 1;
    *a4 = 1;
    *v23 = 0.0;
    *v24 = 1;
  ...
  std::wstring::wstring(&v27, a2, v15);
  v19 = std::unordered_map<std::wstring,std::unique_ptr<CEndpointVolumeState>>::at(v12, &v27);
