/*
 * XREFs of ?TsSessionCreate@@YAJKPEAPEAVTSSession@@@Z @ 0x1800376B4
 * Callers:
 ...
 *     ??0CDriverListener@@QEAA@XZ @ 0x18003B0C4 (--0CDriverListener@@QEAA@XZ.c)
