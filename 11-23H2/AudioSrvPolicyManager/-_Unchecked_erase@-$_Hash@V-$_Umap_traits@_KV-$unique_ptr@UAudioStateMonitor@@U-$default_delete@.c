...
LABEL_6:
    ...
    for ( *(_QWORD *)(v7 + 8 * v11 + 8) = v5; ; *(_QWORD *)(v7 + 8 * v11 + 8) = v6 )
    {
      ...
      if ( v23 == a3 )
        break;
      v18 = std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>::operator()<unsigned __int64>(
              v15,
              v23 + 16);
      v11 = 2 * (a1[6] & v18);
