/*
 * XREFs of ?ResetReusedSessionGroupingParams@CProcess@@IEAAXXZ @ 0x1800290DC
 * Callers:
 *     ?SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ @ 0x180029F30 (-SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ.c)
 * Callees:
