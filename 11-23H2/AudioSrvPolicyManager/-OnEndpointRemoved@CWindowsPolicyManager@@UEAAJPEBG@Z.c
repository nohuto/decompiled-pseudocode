/*
 * XREFs of ?OnEndpointRemoved@CWindowsPolicyManager@@UEAAJPEBG@Z @ 0x18001D2E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowsPolicyManager::OnEndpointRemoved(CWindowsPolicyManager *this, const unsigned __int16 *a2)
{
  ...
  CApplicationManager::Lock((__int64)this, &v5);
  CApplicationManager::HandleEndpointRemoved(v3, v2);
