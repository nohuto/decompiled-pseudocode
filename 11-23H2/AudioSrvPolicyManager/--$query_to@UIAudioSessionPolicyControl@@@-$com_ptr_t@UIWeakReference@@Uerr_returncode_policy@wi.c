/*
 * XREFs of ??$query_to@UIAudioSessionPolicyControl@@@?$com_ptr_t@UIWeakReference@@Uerr_returncode_policy@wil@@@wil@@QEBAJPEAPEAUIAudioSessionPolicyControl@@@Z @ 0x1800120E0
 * Callers:
