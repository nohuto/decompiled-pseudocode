/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x180018BD4
 * Callers:
 ...
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x18001A1D4 (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
