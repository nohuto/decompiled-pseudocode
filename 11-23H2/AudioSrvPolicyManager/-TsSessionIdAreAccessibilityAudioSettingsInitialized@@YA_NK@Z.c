/*
 * XREFs of ?TsSessionIdAreAccessibilityAudioSettingsInitialized@@YA_NK@Z @ 0x18000F99C
 * Callers:
...
bool __fastcall TsSessionIdAreAccessibilityAudioSettingsInitialized(DWORD a1)
{
  ...
  v5 = 2 * (qword_180061710 & v3);
  v6 = *(_QWORD *)(qword_1800616F8 + 8 * v5 + 8);
...
LABEL_7:
  ...
  else
  {
    ...
    {
      if ( v6 == *(_QWORD *)(qword_1800616F8 + 8 * v5) )
        goto LABEL_7;
      v6 = *(_QWORD *)(v6 + 8);
    }
  }
