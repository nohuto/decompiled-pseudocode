/*
 * XREFs of ?RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x180036250
 * Callers:
 ...
 *     ??1UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x180034240 (--1UsageIndexes@details_abi@wil@@QEAA@XZ.c)
...
void __fastcall wil::details_abi::FeatureStateData::RecordUsage(RTL_SRWLOCK *this)
{
  ...
  RTL_SRWLOCK *v6; // [rsp+F0h] [rbp+8h] BYREF
