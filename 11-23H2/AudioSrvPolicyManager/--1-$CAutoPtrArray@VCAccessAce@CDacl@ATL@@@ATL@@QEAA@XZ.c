/*
 * XREFs of ??1?$CAutoPtrArray@VCAccessAce@CDacl@ATL@@@ATL@@QEAA@XZ @ 0x180042F78
 * Callers:
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$7 @ 0x18004A1AB (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$7.c)
 * Callees:
 *     <none>
 */
