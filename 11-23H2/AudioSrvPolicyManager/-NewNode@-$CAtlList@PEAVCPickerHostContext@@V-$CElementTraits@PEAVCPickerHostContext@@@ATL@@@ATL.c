/*
 * XREFs of ?NewNode@?$CAtlList@PEAVCPickerHostContext@@V?$CElementTraits@PEAVCPickerHostContext@@@ATL@@@ATL@@AEAAPEAVCNode@12@AEBQEAVCPickerHostContext@@PEAV312@1@Z @ 0x1800304C0
 * Callers:
        ...
        __int64 a4)
{
  ...
  result = (__int64 *)qword_180060C98;
  if ( !qword_180060C98 )
  {
    v7 = ATL::CAtlPlex::Create(&qword_180060C90, (unsigned int)dword_180060CA0, 0x18uLL);
    if ( !v7 )
      ATL::AtlThrowImpl(-2147024882);
    v8 = (unsigned int)(dword_180060CA0 - 1);
    result = (__int64 *)qword_180060C98;
    for ( i = (__int64 *)((char *)v7 + 16 * v8 + 8 * v8 + 8); (int)v8 >= 0; LODWORD(v8) = v8 - 1 )
    {
      *i = (__int64)result;
      result = i;
      qword_180060C98 = (__int64)i;
      i -= 3;
    }
  }
  v10 = *result;
