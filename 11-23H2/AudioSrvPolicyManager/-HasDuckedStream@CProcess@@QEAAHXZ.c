/*
 * XREFs of ?HasDuckedStream@CProcess@@QEAAHXZ @ 0x180027400
 * Callers:
 ...
 *     ?SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ @ 0x18002A650 (-SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ.c)
