/*
 * XREFs of __tailMerge_api_ms_win_appmodel_identity_l1_2_0_dll @ 0x180017C47
 * Callers:
 *     __imp_load_AppContainerDeriveSidFromMoniker @ 0x180017C3B (__imp_load_AppContainerDeriveSidFromMoniker.c)
 * Callees:
