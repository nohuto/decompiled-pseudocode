/*
 * XREFs of ?TsSessionIdIsAudioInStandbyAllowed@@YA_NK@Z @ 0x18000E6C0
 * Callers:
...
LABEL_5:
  ...
  v6 = *(_DWORD **)(v5 + 24);
  LeaveCriticalSection(&stru_180061648);
  wil::init_once_nothrow__lambda_ab72ab04c21953f372991cfef701d912___(v7, 0LL);
