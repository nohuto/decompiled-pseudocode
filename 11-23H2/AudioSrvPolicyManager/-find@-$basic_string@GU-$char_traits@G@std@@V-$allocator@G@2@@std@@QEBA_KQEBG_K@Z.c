/*
 * XREFs of ?find@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEBA_KQEBG_K@Z @ 0x180042C1C
 * Callers:
 ...
 * Callees:
 *     ?compare@?$_WChar_traits@G@std@@SAHQEBG0_K@Z @ 0x180008F90 (-compare@-$_WChar_traits@G@std@@SAHQEBG0_K@Z.c)
 */
