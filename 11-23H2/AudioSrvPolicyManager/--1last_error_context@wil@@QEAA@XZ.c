/*
 * XREFs of ??1last_error_context@wil@@QEAA@XZ @ 0x1800188B4
 * Callers:
 ...
 *     _wil::details_abi::heap_buffer::reserve_::_1_::dtor$0 @ 0x180049BB1 (_wil--details_abi--heap_buffer--reserve_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
