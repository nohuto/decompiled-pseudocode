/*
 * XREFs of ?DestroyPickerHostContext@PickerHostContextManager@@YAXPEAVCPickerHostContext@@@Z @ 0x18003035C
 * Callers:
 *     ?HHOSTEDAPPMANAGERCONTEXTRundown@@YAXPEAX@Z @ 0x180030CC0 (-HHOSTEDAPPMANAGERCONTEXTRundown@@YAXPEAX@Z.c)
 * Callees:
 ...
 *     ?Find@?$CAtlList@PEAVCPickerHostContext@@V?$CElementTraits@PEAVCPickerHostContext@@@ATL@@@ATL@@QEBAPEAU__POSITION@@AEBQEAVCPickerHostContext@@PEAU3@@Z @ 0x180015F90 (-Find@-$CAtlList@PEAVCPickerHostContext@@V-$CElementTraits@PEAVCPickerHostContext@@@ATL@@@ATL@@Q.c)
        ...
        struct CPickerHostContext *a2)
{
  ...
  if ( v4 )
  {
    if ( v4 == (_QWORD *)PickerHostContextManager::s_PickerHostContextList )
      ...
      *(_QWORD *)v4[1] = *v4;
    if ( v4 == (_QWORD *)qword_180060C80 )
      qword_180060C80 = v4[1];
    else
      *(_QWORD *)(*v4 + 8LL) = v4[1];
