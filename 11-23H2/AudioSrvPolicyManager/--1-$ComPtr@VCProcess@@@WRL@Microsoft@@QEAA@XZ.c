/*
 * XREFs of ??1?$ComPtr@VCProcess@@@WRL@Microsoft@@QEAA@XZ @ 0x18002C508
 * Callers:
 *     _CApplicationManager::RpcGetProcess_::_1_::dtor$191 @ 0x180047A80 (_CApplicationManager--RpcGetProcess_--_1_--dtor$191.c)
 * Callees:
