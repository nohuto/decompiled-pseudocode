/*
 * XREFs of ??1CDuckingManager@@UEAA@XZ @ 0x18001BE44
 * Callers:
 ...
 *     ??1CSerialWorkQueue@@QEAA@XZ @ 0x18001BF1C (--1CSerialWorkQueue@@QEAA@XZ.c)
 */
...
void __fastcall CDuckingManager::~CDuckingManager(CDuckingManager *this)
{
  ...
  CLockedList<CDuckingNotification,1,0>::~CLockedList<CDuckingNotification,1,0>((__int64)this + 72);
