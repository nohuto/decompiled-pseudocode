/*
 * XREFs of ?NewNode@?$CAtlList@PEAUIAudioAppVolumePolicyChange@@V?$CElementTraits@PEAUIAudioAppVolumePolicyChange@@@ATL@@@ATL@@AEAAPEAVCNode@12@AEBQEAUIAudioAppVolumePolicyChange@@PEAV312@1@Z @ 0x180027DD0
 * Callers:
