/*
 * XREFs of ?TsSessionIdLogon@@YAJK@Z @ 0x180038954
 * Callers:
 ...
 *     ?RegisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ @ 0x1800367F0 (-RegisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ.c)
