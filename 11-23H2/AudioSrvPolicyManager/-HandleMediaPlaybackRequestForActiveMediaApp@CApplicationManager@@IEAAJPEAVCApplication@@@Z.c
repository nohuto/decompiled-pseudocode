/*
 * XREFs of ?HandleMediaPlaybackRequestForActiveMediaApp@CApplicationManager@@IEAAJPEAVCApplication@@@Z @ 0x18002CD30
 * Callers:
...
LABEL_14:
  ...
  else
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      v9 = 33;
LABEL_18:
      WPP_SF_S(v8[2], v9, &WPP_7bcb4e64156732b2305239eaa24ad5b8_Traceguids, *((const wchar_t **)a2 + 3));
    }
  }
  return 0LL;
}
