/*
 * XREFs of ?GetPropKeyPath@@YAJPEAUIAudioSessionInfo@@PEAG_K@Z @ 0x18003CBFC
 * Callers:
 ...
 *     ?GetThreadUserStringSid@@YAJPEAPEAG@Z @ 0x18003CD6C (-GetThreadUserStringSid@@YAJPEAPEAG@Z.c)
