/*
 * XREFs of ??3@YAXPEAX@Z @ 0x18000D330
 * Callers:
 ...
 *     ??1heap_buffer@details_abi@wil@@QEAA@XZ @ 0x180015D94 (--1heap_buffer@details_abi@wil@@QEAA@XZ.c)
 *     ??3@YAXPEAX_K@Z @ 0x180016C28 (--3@YAXPEAX_K@Z.c)
 *     ??_Gtype_info@@UEAAPEAXI@Z @ 0x180016C40 (--_Gtype_info@@UEAAPEAXI@Z.c)
 *     ??3@YAXPEAXAEBUnothrow_t@std@@@Z @ 0x180016C90 (--3@YAXPEAXAEBUnothrow_t@std@@@Z.c)
 ...
 *     ??1RawUsageIndex@details_abi@wil@@QEAA@XZ @ 0x1800340C4 (--1RawUsageIndex@details_abi@wil@@QEAA@XZ.c)
 ...
 *     wil::details::lambda_call__lambda_936a9f2031d164d79308d1616a702e8e___::_lambda_call__lambda_936a9f2031d164d79308d1616a702e8e___ @ 0x18003BA5C (wil--details--lambda_call__lambda_936a9f2031d164d79308d1616a702e8e___--_lambda_call__lambda_936a.c)
 ...
 *     ?SetRegistryHandleIntegrityLevel@@YAJPEAUHKEY__@@PEAX@Z @ 0x18004510C (-SetRegistryHandleIntegrityLevel@@YAJPEAUHKEY__@@PEAX@Z.c)
 *     ?SetRegistryKeyIntegrityLevel@@YAJPEAUHKEY__@@PEAX@Z @ 0x180045200 (-SetRegistryKeyIntegrityLevel@@YAJPEAUHKEY__@@PEAX@Z.c)
 *     ??_GCAtlStringMgr@ATL@@UEAAPEAXI@Z @ 0x1800453A0 (--_GCAtlStringMgr@ATL@@UEAAPEAXI@Z.c)
 *     ??_ECWin32Heap@ATL@@UEAAPEAXI@Z @ 0x1800453D0 (--_ECWin32Heap@ATL@@UEAAPEAXI@Z.c)
 *     ??_G?$__base@$$A6AJPEAG_KPEA_K@Z@__function@wistd@@UEAAPEAXI@Z @ 0x180045A00 (--_G-$__base@$$A6AJPEAG_KPEA_K@Z@__function@wistd@@UEAAPEAXI@Z.c)
 *     ??_ECThreadPool@@UEAAPEAXI@Z @ 0x180046030 (--_ECThreadPool@@UEAAPEAXI@Z.c)
 *     ??_EAssignedAccessConfigStoreBase@AssignedAccess@Internal@Windows@@UEAAPEAXI@Z @ 0x1800468C0 (--_EAssignedAccessConfigStoreBase@AssignedAccess@Internal@Windows@@UEAAPEAXI@Z.c)
