/*
 * XREFs of ?LowerBound@RawUsageIndex@details_abi@wil@@AEAAPEAEPEAE_KPEAX1@Z @ 0x1800358B4
 * Callers:
 ...
 * Callees:
 *     ?Compare@UsageIndexProperty@details_abi@wil@@QEBAHPEAX_K@Z @ 0x180034C5C (-Compare@UsageIndexProperty@details_abi@wil@@QEBAHPEAX_K@Z.c)
