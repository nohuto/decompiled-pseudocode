        ...
        _QWORD *a3)
{
  ...
  _QWORD *v33; // [rsp+90h] [rbp+8h] BYREF
  ...
  v10 = 2 * v6;
  for ( i = 0LL; i < v10; ++i )
    v9 = 0x100000001B3LL * (*((unsigned __int8 *)v7 + i) ^ (unsigned __int64)v9);
  v12 = *((_QWORD *)a1 + 3);
  v13 = *(_QWORD **)(v12 + 16 * (v9 & *((_QWORD *)a1 + 6)) + 8);
  v14 = (_QWORD *)*((_QWORD *)a1 + 1);
  if ( v13 != v14 )
  {
    v15 = *(_QWORD **)(v12 + 16 * (v9 & *((_QWORD *)a1 + 6)));
    while ( 1 )
    {
      v16 = v13 + 2;
      if ( v13[5] >= 8uLL )
...
LABEL_20:
        ...
        while ( 1 )
        {
          ...
          if ( v20 < *(_WORD *)v16 || v20 > *(_WORD *)v16 )
            break;
          if ( v18 == 1 )
            goto LABEL_20;
          --v18;
  ...
  if ( v23 < 0 )
  {
    v25 = *((_QWORD *)a1 + 7) & 1LL | ((unsigned __int64)v23 >> 1);
  ...
  {
    v26 = std::_Hash<std::_Umap_traits<std::wstring,CRenderEndpointDuckingManagerContext,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,CRenderEndpointDuckingManagerContext>>,0>>::_Desired_grow_bucket_count(a1);
    std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CStreamClassPolicyGains>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CStreamClassPolicyGains>>>,0>>::_Forced_rehash(
      a1,
      v26);
    v31 = *(_OWORD *)std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CEndpointVolumeState>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>,0>>::_Find_last<std::wstring>(
                       a1,
                       &v32,
                       (char *)(v30 + 16),
                       v9);
  ...
  *(_QWORD *)a2 = std::_Hash<std::_Umap_traits<void *,wil::com_ptr_t<IWeakReference,wil::err_returncode_policy>,std::_Uhash_compare<void *,std::hash<void *>,std::equal_to<void *>>,std::allocator<std::pair<void * const,wil::com_ptr_t<IWeakReference,wil::err_returncode_policy>>>,0>>::_Insert_new_node_before(
                    ...
                    v27);
  *(_BYTE *)(a2 + 8) = 1;
  std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<std::wstring const,std::unique_ptr<CStreamClassPolicyGains>>,void *>>>::~_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<std::wstring const,std::unique_ptr<CStreamClassPolicyGains>>,void *>>>(v29);
  return a2;
}
