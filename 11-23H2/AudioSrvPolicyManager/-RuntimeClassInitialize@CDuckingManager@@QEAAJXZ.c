/*
 * XREFs of ?RuntimeClassInitialize@CDuckingManager@@QEAAJXZ @ 0x1800229E0
 * Callers:
...
__int64 __fastcall CDuckingManager::RuntimeClassInitialize(CDuckingManager *this)
{
  ...
  std::shared_ptr<DuckingDescriptor>::operator=<DuckingDescriptor,std::default_delete<DuckingDescriptor>>(
    (_QWORD *)this + 53,
    v2);
