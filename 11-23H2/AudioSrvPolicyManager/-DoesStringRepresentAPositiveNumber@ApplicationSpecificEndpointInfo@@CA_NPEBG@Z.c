/*
 * XREFs of ?DoesStringRepresentAPositiveNumber@ApplicationSpecificEndpointInfo@@CA_NPEBG@Z @ 0x1800416A0
 * Callers:
 ...
 *     ??A?$CSimpleStringT@G$0A@@ATL@@QEBAGH@Z @ 0x180040FD4 (--A-$CSimpleStringT@G$0A@@ATL@@QEBAGH@Z.c)
 */
