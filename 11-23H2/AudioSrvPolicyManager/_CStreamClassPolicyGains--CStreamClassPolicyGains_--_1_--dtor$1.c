/*
 * XREFs of _CStreamClassPolicyGains::CStreamClassPolicyGains_::_1_::dtor$1 @ 0x1800496FC
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CStreamClassPolicyGains::CStreamClassPolicyGains_::_1_::dtor_1(__int64 a1, __int64 a2)
{
