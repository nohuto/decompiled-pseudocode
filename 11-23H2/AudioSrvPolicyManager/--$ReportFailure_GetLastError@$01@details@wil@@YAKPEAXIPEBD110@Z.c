/*
 * XREFs of ??$ReportFailure_GetLastError@$01@details@wil@@YAKPEAXIPEBD110@Z @ 0x18002BD80
 * Callers:
        ...
        const char *a6)
{
  ...
  v18 = v16;
  v17 = v15;
  wil::details::ReportFailure_Base<2,0>(v8, v7, a3, v12, v12, (__int64)a6, (__int64)&v17, v12);
  return v10;
}
