/*
 * XREFs of ?OnScreenReaderStateChanged@CApplicationManager@@QEAAJPEAVCProcess@@HH@Z @ 0x18002DA28
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_450436a14271dedc9936bb949bbf07b2__void_::_Do_call @ 0x180030EB0 (std--_Func_impl_no_alloc__lambda_450436a14271dedc9936bb949bbf07b2__void_--_Do_call.c)
 * Callees:
 ...
 *     ?ApplyStreamClassPolicyGains@CProcess@@UEAAXHPEAH@Z @ 0x180025A60 (-ApplyStreamClassPolicyGains@CProcess@@UEAAXHPEAH@Z.c)
 *     ?ConvertDbToEngineVolume@@YAMM@Z @ 0x18002C8E4 (-ConvertDbToEngineVolume@@YAMM@Z.c)
 *     WPP_SF_Sddd @ 0x18002FE58 (WPP_SF_Sddd.c)
