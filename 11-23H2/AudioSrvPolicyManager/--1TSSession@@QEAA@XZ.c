/*
 * XREFs of ??1TSSession@@QEAA@XZ @ 0x1800340EC
 * Callers:
 ...
 *     ?clear@?$forward_list@V?$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAAXXZ @ 0x18002B774 (-clear@-$forward_list@V-$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil@@V-$allocator@V-$.c)
 *     ??1?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@std@@QEAA@XZ @ 0x180033EC0 (--1-$unique_ptr@$$BY0A@EU-$default_delete@$$BY0A@E@std@@@std@@QEAA@XZ.c)
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1?WTSFreeMemory@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x180034004 (--1-$unique_storage@U-$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1-WTSFreeMemory@@YAX0@ZU-$integ.c)
 *     ??1CStreamClassPolicyGainsWrapper@@QEAA@XZ @ 0x180034034 (--1CStreamClassPolicyGainsWrapper@@QEAA@XZ.c)
 *     ?UnregisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ @ 0x180039840 (-UnregisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ.c)
 */
...
void __fastcall TSSession::~TSSession(TSSession *this)
{
  ...
  *((_QWORD *)this + 133) = 0LL;
  ...
  if ( v4 )
  {
    std::_Deallocate<16,0>(v4, (*((_QWORD *)this + 125) - (_QWORD)v4) & 0xFFFFFFFFFFFFFFFCuLL);
    *((_QWORD *)this + 123) = 0LL;
    *((_QWORD *)this + 124) = 0LL;
    *((_QWORD *)this + 125) = 0LL;
  }
  ...
  if ( v5 )
  {
    std::_Deallocate<16,0>(v5, (*((_QWORD *)this + 8) - (_QWORD)v5) & 0xFFFFFFFFFFFFFFF8uLL);
    *((_QWORD *)this + 6) = 0LL;
    *((_QWORD *)this + 7) = 0LL;
    *((_QWORD *)this + 8) = 0LL;
  }
