/*
 * XREFs of ?erase@?$_Hash@V?$_Umap_traits@KV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@@std@@@2@$0A@@std@@@std@@QEAA_KAEBK@Z @ 0x18003A4CC
 * Callers:
        ...
        const unsigned __int8 *a2)
{
  ...
  if ( !v5 )
    return 0LL;
  v7 = qword_1800616F8;
  v8 = 2 * (v6 & qword_180061710);
  if ( *(__int64 **)(qword_1800616F8 + 16 * (v6 & qword_180061710) + 8) == v5 )
  {
    if ( *(__int64 **)(qword_1800616F8 + 16 * (v6 & qword_180061710)) == v5 )
    {
      v9 = qword_1800616E8;
      *(_QWORD *)(qword_1800616F8 + 16 * (v6 & qword_180061710)) = qword_1800616E8;
    }
    else
    {
      v9 = v5[1];
  ...
  else if ( *(__int64 **)(qword_1800616F8 + 16 * (v6 & qword_180061710)) == v5 )
  {
    *(_QWORD *)(qword_1800616F8 + 16 * (v6 & qword_180061710)) = *v5;
  }
  v10 = *v5;
  --qword_1800616F0;
  *(_QWORD *)v5[1] = v10;
