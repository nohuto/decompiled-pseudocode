/*
 * XREFs of ??0?$unique_ptr@XUprocess_heap_deleter@wil@@@wistd@@QEAA@$$QEAV01@@Z @ 0x180033A04
 * Callers:
 *     ??0heap_buffer@details_abi@wil@@QEAA@$$QEAU012@@Z @ 0x180033CD8 (--0heap_buffer@details_abi@wil@@QEAA@$$QEAU012@@Z.c)
 * Callees:
 *     ??$?0PEAXUprocess_heap_deleter@wil@@@?$__compressed_pair@PEAXUprocess_heap_deleter@wil@@@wistd@@QEAA@$$QEAPEAX$$QEAUprocess_heap_deleter@wil@@@Z @ 0x180032FD0 (--$-0PEAXUprocess_heap_deleter@wil@@@-$__compressed_pair@PEAXUprocess_heap_deleter@wil@@@wistd@@.c)
 */
