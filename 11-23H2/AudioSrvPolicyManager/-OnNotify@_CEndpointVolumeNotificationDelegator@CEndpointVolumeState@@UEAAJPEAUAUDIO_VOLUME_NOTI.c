/*
 * XREFs of ?OnNotify@_CEndpointVolumeNotificationDelegator@CEndpointVolumeState@@UEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x18003FD20
 * Callers:
 *     <none>
 * Callees:
 *     _o_log10_0 @ 0x1800175E8 (_o_log10_0.c)
 */
