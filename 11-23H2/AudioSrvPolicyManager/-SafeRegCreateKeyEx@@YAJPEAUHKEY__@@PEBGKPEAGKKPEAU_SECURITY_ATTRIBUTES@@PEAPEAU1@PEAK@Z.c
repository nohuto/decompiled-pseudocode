/*
 * XREFs of ?SafeRegCreateKeyEx@@YAJPEAUHKEY__@@PEBGKPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAPEAU1@PEAK@Z @ 0x180044BD8
 * Callers:
 ...
 *     _Init_thread_footer @ 0x180016E40 (_Init_thread_footer.c)
...
LABEL_8:
  ...
  if ( dword_180061838 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_180061838);
    if ( dword_180061838 == -1 )
    {
      atexit(SafeRegCreateKeyEx_::_2_::_dynamic_atexit_destructor_for__delKey__);
      Init_thread_footer(&dword_180061838);
    }
  }
  if ( !v13 )
    goto LABEL_33;
  ...
  if ( !v14 )
  {
    if ( hLibModule && (ProcAddress = (FARPROC)qword_180061848) != 0LL
      || (Library = LoadLibraryExW(L"ntdll.dll", 0LL, 0x800u), (hLibModule = Library) != 0LL)
      && (ProcAddress = GetProcAddress(Library, "NtDeleteKey"), (qword_180061848 = (__int64)ProcAddress) != 0) )
    {
