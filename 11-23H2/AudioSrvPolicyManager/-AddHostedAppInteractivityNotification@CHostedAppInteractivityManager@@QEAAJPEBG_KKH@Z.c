/*
 * XREFs of ?AddHostedAppInteractivityNotification@CHostedAppInteractivityManager@@QEAAJPEBG_KKH@Z @ 0x180012F84
 * Callers:
 ...
 *     ?OnInteractivityNotification@CHostedAppInteractivity@@QEAAXHPEAH0@Z @ 0x180030578 (-OnInteractivityNotification@CHostedAppInteractivity@@QEAAXHPEAH0@Z.c)
 */
        ...
        int a5)
{
  ...
  v17 = 0;
  v20 = 0;
  EnterCriticalSection(&stru_180061670);
  v19 = &stru_180061670;
  ...
  {
    for ( i = (_QWORD *)qword_180061698; i; i = (_QWORD *)*i )
    {
      if ( (CHostedAppInteractivity *)i[2] == v10 )
      {
        v14 = (_QWORD **)(i + 1);
        if ( i == (_QWORD *)qword_180061698 )
          qword_180061698 = *i;
        else
          **v14 = *i;
        if ( i == (_QWORD *)xmmword_1800616A0 )
          *(_QWORD *)&xmmword_1800616A0 = *v14;
        else
          *(_QWORD *)(*i + 8LL) = *v14;
        ATL::CAtlList<CHostedAppInteractivity *,ATL::CElementTraits<CHostedAppInteractivity *>>::FreeNode(&qword_180061698);
        if ( v10 )
