/*
 * XREFs of ?reset@?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEAAXPEAX@Z @ 0x18001AA8C
 * Callers:
 ...
 *     ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x180018BA4 (-CloseHandle@details@wil@@YAXPEAX@Z.c)
 */
