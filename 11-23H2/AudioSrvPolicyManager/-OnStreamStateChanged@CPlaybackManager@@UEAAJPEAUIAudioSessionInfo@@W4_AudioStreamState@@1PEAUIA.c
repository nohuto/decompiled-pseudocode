/*
 * XREFs of ?OnStreamStateChanged@CPlaybackManager@@UEAAJPEAUIAudioSessionInfo@@W4_AudioStreamState@@1PEAUIAudioStreamInfo@@@Z @ 0x18000C280
 * Callers:
 ...
 *     ?OnStreamStateChanged@CWindowsPolicyManager@@UEAAJPEAUIAudioSessionInfo@@W4_AudioStreamState@@1PEAUIAudioStreamInfo@@@Z @ 0x18001D490 (-OnStreamStateChanged@CWindowsPolicyManager@@UEAAJPEAUIAudioSessionInfo@@W4_AudioStreamState@@1P.c)
 * Callees:
  ...
  if ( !*((_BYTE *)a1 + 16) )
  {
    ...
    if ( (*(int (__fastcall **)(struct IAudioStreamInfo *, __int64 *))(v14 + 24))(v8, &v21) >= 0 )
    {
      ...
      if ( *v16 > 4u )
      {
        ...
        LODWORD(v27) = a4;
        LODWORD(v20) = a3;
        v23 = (__int64)off_18004F500[(*(unsigned int (__fastcall **)(struct IAudioStreamInfo *))(*(_QWORD *)v8 + 48LL))(v8)];
        ...
        _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<unsigned short>,_tlgWrapSz<unsigned short>,_tlgWrapSz<unsigned short>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<8>>(
          (__int64)v16,
          (unsigned __int8 *)dword_18005586A,
          v17,
          v18,
          (void **)&v25,
          (void **)&v24,
