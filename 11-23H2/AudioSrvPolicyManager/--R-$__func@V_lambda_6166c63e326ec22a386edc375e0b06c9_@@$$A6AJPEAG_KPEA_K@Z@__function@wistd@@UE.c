/*
 * XREFs of ??R?$__func@V_lambda_6166c63e326ec22a386edc375e0b06c9_@@$$A6AJPEAG_KPEA_K@Z@__function@wistd@@UEAAJ$$QEAPEAG$$QEA_K$$QEAPEA_K@Z @ 0x180046840
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 **a4)
{
  ...
  PersistedRegistryLocationW = GetPersistedRegistryLocationW(
                                 ...
                                 *a3,
                                 &v9);
  v6 = 0;
  if ( PersistedRegistryLocationW == 234 || !PersistedRegistryLocationW )
