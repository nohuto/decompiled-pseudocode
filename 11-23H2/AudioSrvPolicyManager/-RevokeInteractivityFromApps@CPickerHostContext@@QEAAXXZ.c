/*
 * XREFs of ?RevokeInteractivityFromApps@CPickerHostContext@@QEAAXXZ @ 0x1800305C0
 * Callers:
 ...
 * Callees:
 *     ?GetNext@?$CAtlList@PEAVCHostedAppInteractivity@@V?$CElementTraits@PEAVCHostedAppInteractivity@@@ATL@@@ATL@@QEAAAEAPEAVCHostedAppInteractivity@@AEAPEAU__POSITION@@@Z @ 0x18000D300 (-GetNext@-$CAtlList@PEAVCHostedAppInteractivity@@V-$CElementTraits@PEAVCHostedAppInteractivity@@.c)
