/*
 * XREFs of ?RevertEndpointVolumeOverride@CApplicationManager@@QEAAJPEBGKAEA_N1AEAM11@Z @ 0x18002F070
 * Callers:
        ...
        bool *a8)
{
  ...
  *a7 = 0;
  ...
  if ( v14 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x32u, &WPP_7bcb4e64156732b2305239eaa24ad5b8_Traceguids, v14);
    }
    AudPolicyLogError("CApplicationManager::RevertEndpointVolumeOverride", 2921, v15);
  }
