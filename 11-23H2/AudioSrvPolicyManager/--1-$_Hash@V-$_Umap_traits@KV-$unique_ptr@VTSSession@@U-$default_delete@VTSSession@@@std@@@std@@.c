/*
 * XREFs of ??1?$_Hash@V?$_Umap_traits@KV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@@std@@@2@$0A@@std@@@std@@QEAA@XZ @ 0x180014E2C
 * Callers:
 *     _dynamic_atexit_destructor_for__TsSessionList__ @ 0x18004A4C0 (_dynamic_atexit_destructor_for__TsSessionList__.c)
 * Callees:
