/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@KV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@@std@@@2@$0A@@std@@@std@@IEAAX_K@Z @ 0x180039EC0
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned long const,std::unique_ptr<TSSession>>>>>>>::_Assign_grow(
    (__int64)&qword_1800616F8,
    2 * v5,
    qword_1800616E8);
  v7 = v5 - 1;
  qword_180061718 = v5;
  qword_180061710 = v5 - 1;
  v8 = *(const unsigned __int8 **)qword_1800616E8;
  v9 = *(const unsigned __int8 **)qword_1800616E8;
  while ( v8 != (const unsigned __int8 *)v3 )
  {
    ...
    v13 = qword_1800616F8;
    v14 = 2 * (v7 & appended);
    if ( *(_QWORD *)(qword_1800616F8 + 16 * (v7 & appended)) == v3 )
    {
      *(_QWORD *)(qword_1800616F8 + 16 * (v7 & appended)) = v12;
LABEL_7:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v12;
      goto LABEL_15;
    }
    v15 = *(__int64 **)(qword_1800616F8 + 16 * (v7 & appended) + 8);
    v6 = *v11;
    ...
    {
      v19 = v15 + 1;
      if ( *(__int64 **)(qword_1800616F8 + 8 * v14) == v15 )
        break;
      v15 = (__int64 *)*v19;
