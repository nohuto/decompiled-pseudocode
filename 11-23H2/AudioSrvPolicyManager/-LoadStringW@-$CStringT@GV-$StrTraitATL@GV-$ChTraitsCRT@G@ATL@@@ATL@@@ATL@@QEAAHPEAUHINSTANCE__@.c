/*
 * XREFs of ?LoadStringW@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAAHPEAUHINSTANCE__@@I@Z @ 0x18003DB90
 * Callers:
 ...
 * Callees:
 *     _o_wmemcpy_s_0 @ 0x18001760C (_o_wmemcpy_s_0.c)
 *     ?AtlCrtErrorCheck@ATL@@YAHH@Z @ 0x180025B2C (-AtlCrtErrorCheck@ATL@@YAHH@Z.c)
