/*
 * XREFs of ?MakeAbsolute@CSecurityDesc@ATL@@QEAAXXZ @ 0x1800447EC
 * Callers:
 ...
 *     ?GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z @ 0x180015DE0 (-GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z.c)
