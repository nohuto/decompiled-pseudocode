/*
 * XREFs of MouseClassEnableGlobalPort @ 0x1C000EFC0
 * Callers:
 *     MouseClassPlugPlayNotification @ 0x1C000F280 (MouseClassPlugPlayNotification.c)
 * Callees:
...
LABEL_6:
    ...
    *((_BYTE *)v6 + 16) = a2;
    ExReleaseFastMutex((PFAST_MUTEX)&WPP_MAIN_CB.Queue.Wcb.DeviceObject);
    if ( a2 != v8 )
      return (unsigned int)MouEnableDisablePort(a2, 0LL, a1, (PFILE_OBJECT *)v6);
  }
  return v4;
}
