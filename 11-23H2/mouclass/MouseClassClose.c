/*
 * XREFs of MouseClassClose @ 0x1C0001B00
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall MouseClassClose(__int64 a1, IRP *a2)
{
  ...
  if ( *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels == v6 )
  {
    ...
    v13 = 0LL;
    for ( i = 0; i < LODWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext); v13 = i )
    {
      v14 = (char *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 24 * v13;
      if ( !v14[19] )
      {
        v15 = v14[16];
        v14[16] = 0;
        ...
        if ( v15 )
        {
          v19 = (void *)_InterlockedExchange64((volatile __int64 *)(*v18 + 312LL), 0LL);
          if ( v19 )
            IoUnregisterPlugPlayNotification(v19);
          v2 = MouEnableDisablePort(0LL, v3, *v18, v14);
        }
        if ( v2 )
        {
