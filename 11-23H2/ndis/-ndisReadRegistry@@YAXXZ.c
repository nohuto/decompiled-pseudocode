/*
 * XREFs of ?ndisReadRegistry@@YAXXZ @ 0x1C0163360
 * Callers:
 *     DriverEntry @ 0x1C01608CC (DriverEntry.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0036080 (__security_check_cookie.c)
 *     Feature_NdisDatapathVerifier__private_ReportDeviceUsage @ 0x1C003627C (Feature_NdisDatapathVerifier__private_ReportDeviceUsage.c)
...
void ndisReadRegistry(void)
{
  ...
  __int64 (__fastcall *v5)(wchar_t *, unsigned int, void *, unsigned int, void *, void *); // [rsp+188h] [rbp+88h]
  int v6; // [rsp+190h] [rbp+90h]
  __int64 v7; // [rsp+198h] [rbp+98h]
  __int64 v8; // [rsp+1A0h] [rbp+A0h]
  int v9; // [rsp+1A8h] [rbp+A8h]
  void *v10; // [rsp+1B0h] [rbp+B0h]
  int v11; // [rsp+1B8h] [rbp+B8h]
  __int128 v12; // [rsp+1C0h] [rbp+C0h]
  ...
  ndisRegisterKnobs(&stru_1C00D56C0, 34LL, v0, 0LL);
  ...
  if ( (unsigned int)(dword_1C00F5208 - 1) > 0x1E )
    dword_1C00F5208 = 8;
