/*
 * XREFs of ??1NdisBindBuilderGlobal@@QEAA@XZ @ 0x1C013B7A8
 * Callers:
 *     ?ndisBindBuilderCleanup@@YAXXZ @ 0x1C013C430 (-ndisBindBuilderCleanup@@YAXXZ.c)
 * Callees:
 ...
 *     ??1?$KStringAtomTableBase@$00@Rtl@@QEAA@XZ @ 0x1C013B620 (--1-$KStringAtomTableBase@$00@Rtl@@QEAA@XZ.c)
 */
