/*
 * XREFs of ?ndisReinitializeHistograms@@YAJXZ @ 0x1C012081C
 * Callers:
 ...
 * Callees:
 *     GetGlobalNamespace @ 0x1C0006D7C (GetGlobalNamespace.c)
 *     __security_check_cookie @ 0x1C0036080 (__security_check_cookie.c)
 *     ??1?$unique_ptr@UNdisHistogramGlobal@@U?$default_delete@UNdisHistogramGlobal@@@wistd@@@wistd@@QEAA@XZ @ 0x1C0074540 (--1-$unique_ptr@UNdisHistogramGlobal@@U-$default_delete@UNdisHistogramGlobal@@@wistd@@@wistd@@QE.c)
...
LABEL_19:
    ...
    v11.m_Lock = (KPushLockBase *)&qword_1C00F5D30;
