/*
 * XREFs of ndisQueryGuidData @ 0x1C0026660
 * Callers:
 ...
 *     ?ndisWmiQueryPMActiveCapabilities@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_WMI_PM_ACTIVE_CAPABILITIES@@@Z @ 0x1C009A514 (-ndisWmiQueryPMActiveCapabilities@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_WMI_PM_ACTIVE_CAPABILI.c)
...
LABEL_76:
  ...
  memset(&v43.NdisReserved[40], 0, 0x88uLL);
  *(_DWORD *)&v43.NdisReserved[16] |= 8u;
  *(_QWORD *)&v43.NdisReserved[32] = &ndisIntReqWmi;
  EtwActivityIdControl(3u, (LPGUID)&v43.NdisReserved[96]);
  v12 = 0;
...
LABEL_90:
  ...
  else
  {
    ...
    else if ( (v34 & 4) != 0 )
    {
      ...
      if ( v12 >= 0 )
      {
        v35 = UnicodeString.Length;
        *(_WORD *)&a1->Header.Type = UnicodeString.Length;
        memmove(p_WakeOnPattern, UnicodeString.Buffer, v35);
