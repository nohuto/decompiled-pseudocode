/*
 * XREFs of ndisValidateNdisVarDataDescInputString @ 0x1C010C4E0
 * Callers:
 ...
 *     ndisValidateAndConvertWcharStringToUnicodeString @ 0x1C010C5F8 (ndisValidateAndConvertWcharStringToUnicodeString.c)
 */
