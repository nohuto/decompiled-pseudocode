/*
 * XREFs of NdisCoCreateVc @ 0x1C00BEFE0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisVcHandle)
{
  ...
  bool v47; // cf
  void (__fastcall *v48)(void *, struct _NET_BUFFER_LIST *, unsigned int, unsigned int); // rcx
  void (__fastcall *v49)(void *, struct _NDIS_PACKET **, unsigned int); // rax
  void (__fastcall *v50)(int, void *, struct _NDIS_PACKET *); // rdx
  void (__fastcall *v51)(_QWORD *, struct _NET_BUFFER_LIST *); // r8
...
LABEL_26:
  ...
  *(_QWORD *)(v14 + 120) = v56;
  if ( !v7 )
  {
    v9 = (*((__int64 (__fastcall **)(LARGE_INTEGER, _DWORD *, _DWORD *))NdisBindingHandle + 129))(v56[3], v10, v10 + 50);
    if ( v9 )
    {
...
LABEL_27:
  ...
  *((_QWORD *)v10 + 1) = v14 + 4;
  if ( !NdisAfHandle )
  {
    ...
    *(_QWORD *)(v14 + 72) = v43;
    *(_QWORD *)(v14 + 56) = v44;
    *((_QWORD *)v10 + 21) = *((_QWORD *)NdisBindingHandle + 133);
    v45 = *((_QWORD *)NdisBindingHandle + 134);
    *((_QWORD *)v10 + 18) = ProtocolVcContext;
    *((_QWORD *)v10 + 22) = v45;
    ExInterlockedInsertHeadList(
      (PLIST_ENTRY)((char *)NdisBindingHandle + 1112),
      (PLIST_ENTRY)v10 + 2,
...
LABEL_57:
  ...
  else
  {
    ...
    *v29 = ProtocolVcContext;
    v9 = ((__int64 (__fastcall **)(__int64, _DWORD *, _DWORD *))v31)[131](v37, v10, v10 + 6);
  }
  if ( !v9 )
  {
    if ( v8 && (!v55 || Increment) )
...
LABEL_75:
  ...
  if ( !v9 )
  {
    ...
    if ( Increment )
    {
      ExInterlockedInsertHeadList((PLIST_ENTRY)((char *)NdisBindingHandle + 1112), (PLIST_ENTRY)v10 + 2, v38);
      v47 = *((_DWORD *)NdisAfHandle + 98) < 6u;
      *((_QWORD *)v10 + 13) = *v29;
      if ( v47 )
      ...
      *((_QWORD *)v10 + 12) = *(_QWORD *)(v39 + 16);
      if ( !v58 )
        ExInterlockedInsertHeadList(
          (PLIST_ENTRY)(*((_QWORD *)NdisAfHandle + 5) + 1112LL),
          (PLIST_ENTRY)(v10 + 38),
    ...
    {
      *((_QWORD *)v10 + 13) = *v30;
      *((_QWORD *)v10 + 12) = *(_QWORD *)(*((_QWORD *)NdisAfHandle + 46) + 1056LL);
      ExInterlockedInsertHeadList((PLIST_ENTRY)((char *)NdisBindingHandle + 1112), (PLIST_ENTRY)(v10 + 38), v38);
      ExInterlockedInsertHeadList(
        (PLIST_ENTRY)(*((_QWORD *)NdisAfHandle + 46) + 1112LL),
        (PLIST_ENTRY)v10 + 2,
...
LABEL_97:
  ...
  if ( v47 )
  {
    ...
    *((_QWORD *)v10 + 34) = ndisMCoSendCompleteToNdisPacket;
    v49 = ndisMCoIndicateReceiveNdisPacketToNdisPacket;
  }
  else
  {
    if ( v46 < 6u )
