/*
 * XREFs of NdisCopySendNetBufferListInfo @ 0x1C0028F20
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisCopySendNetBufferListInfo(PNET_BUFFER_LIST DestNetBufferList, PNET_BUFFER_LIST SrcNetBufferList)
{
  ...
  const struct _GUID *v19; // [rsp+28h] [rbp-50h]
  struct _GUID v20; // [rsp+40h] [rbp-38h] BYREF
  struct _GUID v21; // [rsp+50h] [rbp-28h] BYREF
  ...
  else if ( Microsoft_Windows_Networking_CorrelationEnabled )
  {
    ...
    v15 = (__int64)DestNetBufferList->NetBufferListInfo[13] & 0x7FFFFFFFFFFFFFFFLL;
    *(_QWORD *)v20.Data4 = v16;
    *(_QWORD *)&v20.Data1 = v15;
    v17 = (__int64)SrcNetBufferList->NetBufferListInfo[13] & 0x7FFFFFFFFFFFFFFFLL;
    *(_QWORD *)v21.Data4 = v16;
    *(_QWORD *)&v21.Data1 = v17;
    if ( Microsoft_Windows_Networking_CorrelationEnabled )
      EtwEx_tidActivityInfoTransfer(0x7FFFFFFFFFFFFFFFuLL, v14, &v20, &v21, v18, v19, 4u);
  }
}
