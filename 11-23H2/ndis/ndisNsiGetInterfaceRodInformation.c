/*
 * XREFs of ndisNsiGetInterfaceRodInformation @ 0x1C010D200
 * Callers:
 ...
 *     ?ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z @ 0x1C010D620 (-ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z.c)
