/*
 * XREFs of WdmlibRtlInitUnicodeStringEx @ 0x1C002EAB8
 * Callers:
 ...
 *     PpRegStateReadCreateClassCreationSettings @ 0x1C01431E0 (PpRegStateReadCreateClassCreationSettings.c)
 *     CmRegUtilCreateWstrKey @ 0x1C014361C (CmRegUtilCreateWstrKey.c)
 *     CmRegUtilOpenExistingWstrKey @ 0x1C01436F4 (CmRegUtilOpenExistingWstrKey.c)
 *     CmRegUtilWstrValueGetDword @ 0x1C0143A44 (CmRegUtilWstrValueGetDword.c)
 *     CmRegUtilWstrValueSetFullBuffer @ 0x1C0143A7C (CmRegUtilWstrValueSetFullBuffer.c)
 *     CmRegUtilWstrValueSetWstrString @ 0x1C0143AD8 (CmRegUtilWstrValueSetWstrString.c)
 * Callees:
 *     <none>
 */
