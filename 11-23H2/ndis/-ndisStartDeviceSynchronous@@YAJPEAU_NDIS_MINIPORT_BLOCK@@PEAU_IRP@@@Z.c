/*
 * XREFs of ?ndisStartDeviceSynchronous@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C003418C
 * Callers:
...
__int64 __fastcall ndisStartDeviceSynchronous(
        ...
        const struct _UNICODE_STRING *a3)
{
  ...
  {
    v5 = ndisPnPStartDevice(a1, a2, a3);
    if ( v5 )
    {
      v5 = -1073741823;
    }
  ...
  else
  {
    v11 = 0LL;
    a1->Flags |= 0x8000u;
    if ( ndisIMCheckDeviceInstance(DriverHandle, &a1->MiniportName, &v11) )
    {
      ...
      v5 = ndisIMInitializeDeviceInstanceInternal(a1, v11);
