/*
 * XREFs of ?ndisMSetMiniportReadyForBinding@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_NW4NDIS_DO_NOT_BIND_REASON@@W4CallRunMode@@@Z @ 0x1C01166C0
 * Callers:
 ...
 *     NdisWdfMiniportStarted @ 0x1C0060630 (NdisWdfMiniportStarted.c)
