/*
 * XREFs of ?ndisNsiGetInterfaceInformation@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C000DB10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisIfFindNextInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z @ 0x1C00B7594 (-ndisIfFindNextInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z.c)
...
LABEL_11:
    ...
    {
      v13 = 0;
      v110 = KeAcquireSpinLockRaiseToDpc(&qword_1C00F5D80);
      if ( ThreadSessionId < dword_1C00F7620 )
        v13 = *((_DWORD *)qword_1C00F7628 + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00F5D80, v110);
      if ( !v13 )
        v13 = 1;
    }
    else
  ...
  if ( qword_1C00F5DA8 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
  {
    while ( *((_DWORD *)v16 + 4) != v14 )
    {
      if ( *((_DWORD *)v16 + 4) <= v14 )
      {
        ...
        if ( v16 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
          continue;
      }
      goto LABEL_19;
    }
