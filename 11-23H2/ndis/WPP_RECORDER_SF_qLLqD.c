/*
 * XREFs of WPP_RECORDER_SF_qLLqD @ 0x1C00BE434
 * Callers:
...
__int64 WPP_RECORDER_SF_qLLqD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x40000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_cf4f20c66de63f4841bb36597d808402_Traceguids,
      0xDu,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 13;
  return WppAutoLogTrace(a1, 4LL, 19LL, &WPP_cf4f20c66de63f4841bb36597d808402_Traceguids, v7, (__int64 *)va);
}
