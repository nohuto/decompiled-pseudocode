/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C00D26B8
 * Callers:
 ...
 *     GetImageTuple @ 0x1C00D2638 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C00D2C30 (_tlgCreate1Sz_char.c)
 */
