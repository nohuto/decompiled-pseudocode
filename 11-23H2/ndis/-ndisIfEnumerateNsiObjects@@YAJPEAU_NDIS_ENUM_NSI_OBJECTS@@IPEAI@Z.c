/*
 * XREFs of ?ndisIfEnumerateNsiObjects@@YAJPEAU_NDIS_ENUM_NSI_OBJECTS@@IPEAI@Z @ 0x1C013E92C
 * Callers:
 *     ?ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z @ 0x1C0145008 (-ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z.c)
 * Callees:
 *     memset @ 0x1C0038700 (memset.c)
 *     NdisIfGetNetLuidFromInterfaceIndex @ 0x1C00B7760 (NdisIfGetNetLuidFromInterfaceIndex.c)
 */
