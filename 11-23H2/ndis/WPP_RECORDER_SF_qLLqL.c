/*
 * XREFs of WPP_RECORDER_SF_qLLqL @ 0x1C00C079C
 * Callers:
...
__int64 WPP_RECORDER_SF_qLLqL(__int64 a1, _DWORD a2, __int64 a3, __int64 a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x40000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      ...
      0LL);
  LOWORD(v7) = 19;
  return WppAutoLogTrace(a1, 4LL, 19LL, &WPP_de7b4475eb543019aeb186df8ee4bca2_Traceguids, v7, (__int64 *)va);
}
