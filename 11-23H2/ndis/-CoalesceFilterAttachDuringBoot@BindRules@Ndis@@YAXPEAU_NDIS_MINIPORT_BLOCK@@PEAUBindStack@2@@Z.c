/*
 * XREFs of ?CoalesceFilterAttachDuringBoot@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUBindStack@2@@Z @ 0x1C01149E4
 * Callers:
        ...
        struct Ndis::BindStack *a3)
{
  ...
  if ( *((_BYTE *)this + 1995) )
  {
    ...
    for ( i = 0LL; i != BaseMiniport_high; ++i )
    {
      if ( i >= BaseMiniport_high )
        __fastfail(5u);
      v14 = *((_QWORD *)a2->MiniportAdapterContext + i);
      if ( *(_DWORD *)(v14 + 52) || *(_DWORD *)(v14 + 28) )
      {
        v15 = *(_QWORD *)(v14 + 80);
        if ( (*(_DWORD *)(v15 + 40) & 1) == 0 && !*(_QWORD *)(v15 + 56) && !*(_BYTE *)(v14 + 8) )
        {
          if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED
            && *((_WORD *)WPP_GLOBAL_Control + 36) )
          {
            WPP_RECORDER_SF__guid_D(*((_QWORD *)WPP_GLOBAL_Control + 8), v14, v15 + 24, 0x22u, v21, v15 + 24);
          }
  ...
  v6 = SpinLock & 0xFFFFFEFF;
  v7 = 0;
  v8 = *((_BYTE *)this + 1995) == 0;
  ...
  if ( v8 )
  {
    ...
    LOBYTE(v9) = v6 != 0;
    if ( v7 != v9 || !*(_QWORD *)&a2->Reserved4.Length )
    {
      if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED
        && *((_WORD *)WPP_GLOBAL_Control + 36) )
      {
      ...
      v20 = (unsigned __int8)byte_1C00F5443 < 4u;
  ...
  {
    LOBYTE(v7) = v6 != 0;
    LOBYTE(v9) = SpinLock != 0;
    if ( v9 != v7 || !*(_QWORD *)&a2->Reserved4.Length )
    {
      if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED
        && *((_WORD *)WPP_GLOBAL_Control + 36) )
      {
    ...
    v16 = HIDWORD(a2->ShortRef.SpinLock);
    v11 = v16 & 0xFFFFFFBF;
    HIDWORD(a2->ShortRef.SpinLock) = v16 & 0xFFFFFFBF;
    if ( (v16 != 0) != ((v16 & 0xFFFFFFBF) != 0) || !*(_QWORD *)&a2->Reserved4.Length )
    {
      if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED
        && *((_WORD *)WPP_GLOBAL_Control + 36) )
      {
        *(_DWORD *)v22 = v16 & 0xFFFFFFBF;
        WPP_RECORDER_SF_LL(
          *((_QWORD *)WPP_GLOBAL_Control + 8),
          5u,
          0x1Cu,
