/*
 * XREFs of ?ndisXlatePMParametersToWakeUpEnableOid@@YAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1C009AD64
 * Callers:
 *     ?ndisOidPostEnableWakeUp@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0095440 (-ndisOidPostEnableWakeUp@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
