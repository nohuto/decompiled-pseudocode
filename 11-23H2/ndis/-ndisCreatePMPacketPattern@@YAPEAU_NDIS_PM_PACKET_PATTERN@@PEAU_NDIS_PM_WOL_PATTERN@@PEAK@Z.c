/*
 * XREFs of ?ndisCreatePMPacketPattern@@YAPEAU_NDIS_PM_PACKET_PATTERN@@PEAU_NDIS_PM_WOL_PATTERN@@PEAK@Z @ 0x1C009318C
 * Callers:
...
struct _NDIS_PM_PACKET_PATTERN *__fastcall ndisCreatePMPacketPattern(struct _NDIS_PM_WOL_PATTERN *a1, unsigned int *a2)
{
  ...
  result = (struct _NDIS_PM_PACKET_PATTERN *)ExAllocatePool2(64LL, v3, 1802519630);
  v6 = result;
  if ( result )
  {
