/*
 * XREFs of ?ndisCopyPacketInfoToNBL@@YAXPEAU_NDIS_PACKET@@PEAU_NET_BUFFER_LIST@@W4_NDIS_XLATE_TYPE@@@Z @ 0x1C00730F8
 * Callers:
 ...
 * Callees:
 *     ndisIPsecPktInfoToNBLInfo @ 0x1C007325C (ndisIPsecPktInfoToNBLInfo.c)
 */
