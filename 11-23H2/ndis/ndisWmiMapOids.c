/*
 * XREFs of ndisWmiMapOids @ 0x1C002D834
 * Callers:
 *     ndisQuerySupportedGuidToOidList @ 0x1C002D38C (ndisQuerySupportedGuidToOidList.c)
 *     ?ndisWdfGetGuidToOidList@@YAXPEBKGPEAU_NDIS_GUID@@PEAG@Z @ 0x1C008D72C (-ndisWdfGetGuidToOidList@@YAXPEBKGPEAU_NDIS_GUID@@PEAG@Z.c)
 * Callees:
 *     <none>
 */
