/*
 * XREFs of ?AddAces@@YAJPEAU_ACL@@EEPEAPEAU1@@Z @ 0x1C0161F5C
 * Callers:
 *     ?CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z @ 0x1C0161C68 (-CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z.c)
 * Callees:
...
__int64 __fastcall AddAces(PACL Acl, __int64 a2, char a3, struct _ACL **a4)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  Pool2 = (_DWORD *)ExAllocatePool2(256LL, v10, 1935885390);
  v12 = Pool2;
  if ( !Pool2 )
    return 3221225626LL;
  v13 = RtlInitializeSid(Pool2, &IdentifierAuthority, 2u);
  if ( !v13 )
  {
    v12[2] = 32;
    v12[3] = 556;
    ...
    v17 = (ACL *)ExAllocatePool2(256LL, v16, 1633895502);
    v5 = v17;
    if ( v17 )
    {
