/*
 * XREFs of ndisNsiScheduleCompartmentBlockChangeNotification @ 0x1C0038018
 * Callers:
...
void __fastcall ndisNsiScheduleCompartmentBlockChangeNotification(__int64 a1)
{
  ...
  if ( (_QWORD *)*v1 == v1 )
  {
    ...
    v2 = (_QWORD *)qword_1C00F5C60;
    if ( *(__int64 **)qword_1C00F5C60 != &qword_1C00F5C58 )
      __fastfail(3u);
    v3 = byte_1C00F5184 == 0;
    *v1 = &qword_1C00F5C58;
    v1[1] = v2;
    *v2 = v1;
    qword_1C00F5C60 = (__int64)v1;
    if ( v3 )
    {
