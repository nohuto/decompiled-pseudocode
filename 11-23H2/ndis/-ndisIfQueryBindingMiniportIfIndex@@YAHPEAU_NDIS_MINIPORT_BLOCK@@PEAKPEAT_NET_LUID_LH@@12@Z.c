/*
 * XREFs of ?ndisIfQueryBindingMiniportIfIndex@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAKPEAT_NET_LUID_LH@@12@Z @ 0x1C011346C
 * Callers:
        ...
        union _NET_LUID_LH *a5)
{
  ...
  *a4 = 0;
  ...
  {
    *a4 = a1->BaseMiniport->$742CA02218500B969A49A3880F69062E::IfIndex;
