/*
 * XREFs of ?ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z @ 0x1C00C3F30
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00C4170 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00C4220 (NdisImmediateWriteSharedMemory.c)
 * Callees:
