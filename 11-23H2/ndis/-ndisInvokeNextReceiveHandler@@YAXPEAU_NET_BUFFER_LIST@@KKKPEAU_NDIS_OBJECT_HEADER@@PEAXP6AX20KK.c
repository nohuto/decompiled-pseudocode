/*
 * XREFs of ?ndisInvokeNextReceiveHandler@@YAXPEAU_NET_BUFFER_LIST@@KKKPEAU_NDIS_OBJECT_HEADER@@PEAXP6AX20KKK@Z@Z @ 0x1C0037100
 * Callers:
 ...
 *     ??$ndisExpandDataPathStack@$01$$A6AXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z@@YAJPEAU_NET_BUFFER_LIST@@KKKPEAX1P6AX10KKK@Z@Z @ 0x1C003D95C (--$ndisExpandDataPathStack@$01$$A6AXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z@@YAJPEAU_NET_BUFFER_LIST@@KK.c)
  ...
  else if ( (a4 & 2) == 0 && ((a4 & 1) != 0 || KeGetCurrentIrql() == 2) )
  {
    ndisInvokeIterativeDatapath<2,void (void *,_NET_BUFFER_LIST *,unsigned long,unsigned long,unsigned long)>(
      ...
      (__int64)a7);
                   ...
                   (__int64)a7) < 0 )
  {
    if ( byte_1C00F5390 && (*((_DWORD *)&a5->PktMonComp + 14) & 2) != 0 )
