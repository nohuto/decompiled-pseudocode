/*
 * XREFs of ?ndisNsiGetCompartmentInfo@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0013C80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
          ...
          {
            v13 = 0;
            v35 = KeAcquireSpinLockRaiseToDpc(&qword_1C00F5D80);
            if ( ThreadSessionId < dword_1C00F7620 )
              v13 = *((_DWORD *)qword_1C00F7628 + 6 * ThreadSessionId);
            KeReleaseSpinLock(&qword_1C00F5D80, v35);
            if ( !v13 )
              v13 = 1;
          }
          else
...
LABEL_63:
        ...
        if ( qword_1C00F5DA8 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
        {
          while ( *((_DWORD *)v34 + 4) <= v6 )
          {
            ...
            if ( v34 == (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
              goto LABEL_27;
          }
          v1 = v34;
        }
  ...
  else
  {
    ...
    if ( qword_1C00F5DA8 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
    {
      while ( *((_DWORD *)v22 + 4) != v6 )
      {
        ...
        if ( v22 == (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
          goto LABEL_27;
      }
      v1 = v22;
    }
