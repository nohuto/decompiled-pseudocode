/*
 * XREFs of NdisMCancelTimer @ 0x1C00C4340
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisMCancelTimer(PNDIS_MINIPORT_TIMER Timer, PBOOLEAN TimerCancelled)
{
  ...
  KIRQL v7; // r8
  $8D9684D6D9B0041687A8861C64350A2D *i; // rcx
  ...
  else
  {
    ...
    *TimerCancelled = v5;
    ...
    if ( (v6->DriverHandle->Flags & 2) != 0 && v5 )
    {
      ...
      for ( i = &Timer->Miniport->560; ; i = ($8D9684D6D9B0041687A8861C64350A2D *)&TimerQueue->NextTimer )
      {
