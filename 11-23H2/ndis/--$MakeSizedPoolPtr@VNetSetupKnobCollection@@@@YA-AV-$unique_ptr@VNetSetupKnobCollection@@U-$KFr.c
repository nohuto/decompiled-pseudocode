/*
 * XREFs of ??$MakeSizedPoolPtr@VNetSetupKnobCollection@@@@YA?AV?$unique_ptr@VNetSetupKnobCollection@@U?$KFreePool@VNetSetupKnobCollection@@@@@wistd@@K_K@Z @ 0x1C0140164
 * Callers:
...
__int64 *__fastcall MakeSizedPoolPtr<NetSetupKnobCollection>(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 Pool2; // rax
