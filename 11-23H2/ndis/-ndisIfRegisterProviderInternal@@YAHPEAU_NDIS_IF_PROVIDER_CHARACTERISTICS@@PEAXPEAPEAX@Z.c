/*
 * XREFs of ?ndisIfRegisterProviderInternal@@YAHPEAU_NDIS_IF_PROVIDER_CHARACTERISTICS@@PEAXPEAPEAX@Z @ 0x1C002F844
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v7 >= 0x58u && (Pool2 = (_WORD *)ExAllocatePool2(64LL, v7, 1718174798), (v9 = Pool2) != 0LL) )
  {
    ...
    *v12 = v12;
    ...
    v13 = KeAcquireSpinLockRaiseToDpc(&qword_1C00F7200);
    v14 = qword_1C00F71F0;
    v15 = v9 + 1;
    if ( *(__int64 **)(qword_1C00F71F0 + 8) != &qword_1C00F71F0 )
      __fastfail(3u);
    *v15 = qword_1C00F71F0;
    v9[2] = &qword_1C00F71F0;
    *(_QWORD *)(v14 + 8) = v15;
    qword_1C00F71F0 = (__int64)(v9 + 1);
    KeReleaseSpinLock(&qword_1C00F7200, v13);
    *a3 = v9;
  }
  else
  {
