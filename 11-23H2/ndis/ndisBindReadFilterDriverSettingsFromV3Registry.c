/*
 * XREFs of ndisBindReadFilterDriverSettingsFromV3Registry @ 0x1C011D9E8
 * Callers:
...
bool __fastcall ndisBindReadFilterDriverSettingsFromV3Registry(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 40) = 0;
  v2 = (const struct _NETSETUPPROPKEY *)&unk_1C00D96A0;
  v8 = a2;
  do
  {
    v7 = 0;
  ...
  while ( v2 != (const struct _NETSETUPPROPKEY *)&unk_1C00D9718 );
  v4 = *(void **)(a1 + 48);
  *(_QWORD *)(a1 + 48) = 0LL;
  if ( v4 )
  ...
  String = NetSetupPropertyBag::ReadString(
             ...
             (const struct _NETSETUPPROPKEY *)&unk_1C00DA2D8,
             (void **)(a1 + 48));
