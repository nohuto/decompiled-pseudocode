/*
 * XREFs of ?ndisIfFindCompartmentBlock@@YAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@I@Z @ 0x1C002FB28
 * Callers:
 ...
 *     ndisConvertIdentifierForCompartment @ 0x1C0061118 (ndisConvertIdentifierForCompartment.c)
...
struct _NDIS_IF_COMPARTMENT_BLOCK *__fastcall ndisIfFindCompartmentBlock(unsigned int a1)
{
  ...
  v1 = qword_1C00F5DA8;
  v2 = 0LL;
  while ( v1 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
  {
    if ( *((_DWORD *)v1 + 4) == a1 )
      return v1;
    if ( *((_DWORD *)v1 + 4) > a1 )
