/*
 * XREFs of ?ndisQueryBusInterface@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C005C380
 * Callers:
...
__int64 __fastcall ndisQueryBusInterface(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( Irp )
  {
    v6 = (__int64)&Irp->Tail.Overlay.CurrentStackLocation[-1];
    *(_WORD *)v6 = 2075;
    *(_QWORD *)(v6 + 40) = NextDeviceObject;
    Irp->IoStatus.Status = -1073741637;
    *(_QWORD *)(v6 + 8) = &GUID_BUS_INTERFACE_STANDARD;
    *(_QWORD *)(v6 + 24) = v12;
    *(_DWORD *)(v6 + 16) = 65600;
    ...
    *(_QWORD *)(v6 + 8) = &GUID_MSIX_TABLE_CONFIG_INTERFACE;
    *(_QWORD *)(v6 + 24) = v11;
    *(_DWORD *)(v6 + 16) = 65608;
    ...
    *(_QWORD *)(v6 + 40) = NextDeviceObject;
    v4->IoStatus.Status = -1073741637;
    *(_QWORD *)(v6 + 8) = &GUID_PCI_VIRTUALIZATION_INTERFACE;
    *(_QWORD *)(v6 + 24) = v10;
    *(_DWORD *)(v6 + 16) = 65616;
    if ( (int)IoSynchronousCallDriver(NextDeviceObject, v4) < 0 )
    {
    ...
    *(_QWORD *)(v6 + 40) = NextDeviceObject;
    v4->IoStatus.Status = -1073741637;
    *(_QWORD *)(v6 + 8) = &GUID_VPCI_INTERFACE_STANDARD;
    *(_QWORD *)(v6 + 24) = v8;
    *(_DWORD *)(v6 + 16) = 65592;
    if ( (int)IoSynchronousCallDriver(NextDeviceObject, v4) < 0 )
    {
