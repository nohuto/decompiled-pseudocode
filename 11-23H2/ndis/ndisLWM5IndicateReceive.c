/*
 * XREFs of ndisLWM5IndicateReceive @ 0x1C00CB040
 * Callers:
 *     ?EthIndicateReceive@@YAXPEAU_X_FILTER@@PEAXPEAD1I1II@Z @ 0x1C00CB000 (-EthIndicateReceive@@YAXPEAU_X_FILTER@@PEAXPEAD1I1II@Z.c)
 * Callees:
        ...
        size_t Size)
{
  ...
  if ( (unsigned int)v11 >= 0x64 )
  {
    if ( (unsigned int)v11 >= 0x5EA )
    {
      ...
      if ( v13 < (unsigned int)v11 )
        return;
      Pool2 = ExAllocatePool2(66LL, v13, 1918125134);
      goto LABEL_10;
    }
  ...
  Pool2 = (__int64)ExAllocateFromNPagedLookasideList(v8);
LABEL_10:
