/*
 * XREFs of ?ndisAllocateNumaStripedPages@@YAPEAXXZ @ 0x1C011FCF0
 * Callers:
 *     ndisAllocatePerProcessorPageDescriptor @ 0x1C0032568 (ndisAllocatePerProcessorPageDescriptor.c)
 * Callees:
 *     ??1?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?ndisFreeMappingAddress@@YAX0@ZU?$integral_constant@_K$00@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x1C00325F8 (--1-$unique_storage@U-$resource_policy@PEAXP6AXPEAX@Z$1-ndisFreeMappingAddress@@YAX0@ZU-$integra.c)
 *     ?ndisFreeMappingAddress@@YAXPEAX@Z @ 0x1C0037704 (-ndisFreeMappingAddress@@YAXPEAX@Z.c)
 ...
 *     ??$MakeSizedPoolPtr@U_MDL@@@@YA?AV?$unique_ptr@U_MDL@@U?$KFreePool@U_MDL@@@@@wistd@@K_K@Z @ 0x1C011FFD8 (--$MakeSizedPoolPtr@U_MDL@@@@YA-AV-$unique_ptr@U_MDL@@U-$KFreePool@U_MDL@@@@@wistd@@K_K@Z.c)
