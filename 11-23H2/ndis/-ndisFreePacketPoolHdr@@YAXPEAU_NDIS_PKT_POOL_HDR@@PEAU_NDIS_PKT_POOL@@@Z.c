/*
 * XREFs of ?ndisFreePacketPoolHdr@@YAXPEAU_NDIS_PKT_POOL_HDR@@PEAU_NDIS_PKT_POOL@@@Z @ 0x1C00C58D8
 * Callers:
 *     NdisFreePacket @ 0x1C0031480 (NdisFreePacket.c)
 *     ?ndisFreePacketPoolInternal@@YAXPEAXE@Z @ 0x1C00C5964 (-ndisFreePacketPoolInternal@@YAXPEAXE@Z.c)
 * Callees:
