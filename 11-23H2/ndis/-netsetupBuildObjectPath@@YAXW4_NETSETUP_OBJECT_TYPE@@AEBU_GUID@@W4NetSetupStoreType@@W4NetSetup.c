/*
 * XREFs of ?netsetupBuildObjectPath@@YAXW4_NETSETUP_OBJECT_TYPE@@AEBU_GUID@@W4NetSetupStoreType@@W4NetSetupSubkeyType@@PEA_W@Z @ 0x1C011E0E4
 * Callers:
...
int __fastcall netsetupBuildObjectPath(unsigned int a1, __int64 a2, unsigned int a3, int a4, wchar_t *Dst)
{
  ...
  else
  {
    if ( !a4 )
    {
      v7 = (const wchar_t *)&unk_1C00DA484;
      goto LABEL_5;
    }
    v6 = a4 - 1;
    if ( !v6 )
