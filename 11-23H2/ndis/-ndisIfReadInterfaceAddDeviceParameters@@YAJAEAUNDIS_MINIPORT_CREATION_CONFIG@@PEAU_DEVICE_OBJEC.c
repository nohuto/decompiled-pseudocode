/*
 * XREFs of ?ndisIfReadInterfaceAddDeviceParameters@@YAJAEAUNDIS_MINIPORT_CREATION_CONFIG@@PEAU_DEVICE_OBJECT@@@Z @ 0x1C011C1D0
 * Callers:
        ...
        struct _DEVICE_OBJECT *a2)
{
  ...
  if ( (unsigned int)NetSetupPropertyBag::ReadUint64(
                       ...
                       (const struct _NETSETUPPROPKEY *)&unk_1C00D9510,
                       (unsigned __int64 *)a1 + 2) )
    goto LABEL_18;
  if ( !(unsigned int)NetSetupPropertyBag::ReadUint32(
                        (NetSetupPropertyBag *)&v8,
                        (const struct _NETSETUPPROPKEY *)&unk_1C00D94E0,
                        (unsigned int *)a1 + 11) )
    *((_BYTE *)a1 + 40) = 1;
  v9 = 0;
  if ( (unsigned int)NetSetupPropertyBag::ReadUint32(
                       (NetSetupPropertyBag *)&v8,
                       (const struct _NETSETUPPROPKEY *)&unk_1C00D9528,
                       &v9) )
    goto LABEL_18;
  *((_BYTE *)a1 + 72) = (v9 & 2) != 0;
  if ( (unsigned int)NetSetupPropertyBag::ReadBoolean(
                       (NetSetupPropertyBag *)&v8,
                       (const struct _NETSETUPPROPKEY *)&unk_1C00D94F8,
                       (bool *)a1 + 73)
    || (unsigned int)NetSetupPropertyBag::ReadBoolean(
                       (NetSetupPropertyBag *)&v8,
                       (const struct _NETSETUPPROPKEY *)&unk_1C00D9540,
                       (bool *)a1 + 74)
...
LABEL_19:
  ...
  *((_QWORD *)a1 + 7) = v5;
  ...
  if ( (unsigned int)NetSetupPropertyBag::ReadBoolean(
                       (NetSetupPropertyBag *)&v8,
                       (const struct _NETSETUPPROPKEY *)&unk_1C00D94C8,
                       (bool *)a1 + 89) )
  {
LABEL_18:
    v4 = -1073741491;
