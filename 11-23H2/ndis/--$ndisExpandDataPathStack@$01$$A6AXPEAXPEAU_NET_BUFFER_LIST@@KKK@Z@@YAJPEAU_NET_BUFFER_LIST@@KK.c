/*
 * XREFs of ??$ndisExpandDataPathStack@$01$$A6AXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z@@YAJPEAU_NET_BUFFER_LIST@@KKKPEAX1P6AX10KKK@Z@Z @ 0x1C003D95C
 * Callers:
        ...
        __int64 a7)
{
  ...
  v9 = *(_QWORD *)(v8 + qword_1C00F5720);
  LowLimit = v9;
  v10 = *(_QWORD *)(v8 + qword_1C00F5718);
  HighLimit = v10;
