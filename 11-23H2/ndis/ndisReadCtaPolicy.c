/*
 * XREFs of ndisReadCtaPolicy @ 0x1C0121118
 * Callers:
 *     ndisHiveLoadCallback @ 0x1C0121100 (ndisHiveLoadCallback.c)
 * Callees:
 *     ??$WriteNoFence@EX@mem@@YAXPECEE@Z @ 0x1C0006DD0 (--$WriteNoFence@EX@mem@@YAXPECEE@Z.c)
