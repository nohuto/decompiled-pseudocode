/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEB_W@Z @ 0x1C002888C
 * Callers:
 ...
 * Callees:
 *     RtlWideCharArrayCopyStringWorker @ 0x1C00288F4 (RtlWideCharArrayCopyStringWorker.c)
