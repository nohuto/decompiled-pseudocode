/*
 * XREFs of NdisCmDeregisterSapComplete @ 0x1C00BE770
 * Callers:
 ...
 *     ?ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z @ 0x1C00BE55C (-ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z.c)
 */
