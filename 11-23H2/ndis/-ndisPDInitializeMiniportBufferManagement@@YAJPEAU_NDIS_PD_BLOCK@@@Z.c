/*
 * XREFs of ?ndisPDInitializeMiniportBufferManagement@@YAJPEAU_NDIS_PD_BLOCK@@@Z @ 0x1C01346D8
 * Callers:
 ...
 *     ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x1C01346A4 (-ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z.c)
 *     ?ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z @ 0x1C0134E90 (-ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z.c)
 */
...
LABEL_23:
    ...
    v14 = *(_QWORD *)&qword_1C00F5708 + 8240LL;
    v15 = *(__int64 ***)(*(_QWORD *)&qword_1C00F5708 + 8248LL);
    if ( *v15 != (__int64 *)(*(_QWORD *)&qword_1C00F5708 + 8240LL) )
      goto LABEL_35;
    *v13 = v14;
    *((_QWORD *)v4 + 2) = v15;
    *v15 = v13;
