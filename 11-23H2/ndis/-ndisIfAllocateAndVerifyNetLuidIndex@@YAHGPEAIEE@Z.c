/*
 * XREFs of ?ndisIfAllocateAndVerifyNetLuidIndex@@YAHGPEAIEE@Z @ 0x1C0110F74
 * Callers:
...
LABEL_5:
    ...
    v14 = (PVOID *)qword_1C00F5E90;
    if ( qword_1C00F5E90 == &qword_1C00F5E90 )
    {
LABEL_29:
      v16 = 0LL;
    }
...
LABEL_33:
    ...
    if ( Pool2 )
    {
      ...
      *(_BYTE *)(v26 + Pool2 + 64) = 1;
      ...
      {
        *(_QWORD *)v29 = qword_1C00F5E90;
        v7 = (const void **)v29;
        *(_QWORD *)(v29 + 8) = &qword_1C00F5E90;
        v32[1] = v29;
        qword_1C00F5E90 = (PVOID)v29;
        goto LABEL_33;
      }
LABEL_53:
      __fastfail(3u);
