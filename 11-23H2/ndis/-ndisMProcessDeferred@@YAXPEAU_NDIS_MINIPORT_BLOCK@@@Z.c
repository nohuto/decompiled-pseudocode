/*
 * XREFs of ?ndisMProcessDeferred@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C006C894
 * Callers:
 ...
 *     NdisIMRevertBack @ 0x1C006F3A0 (NdisIMRevertBack.c)
 *     ?ndisMDeferredDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C00B1790 (-ndisMDeferredDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
