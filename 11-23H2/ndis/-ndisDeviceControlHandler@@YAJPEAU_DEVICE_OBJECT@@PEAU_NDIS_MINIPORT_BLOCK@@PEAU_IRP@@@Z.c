/*
 * XREFs of ?ndisDeviceControlHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C000EA30
 * Callers:
 *     ?ndisDeviceControlIrpHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z @ 0x1C000FDC0 (-ndisDeviceControlIrpHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z.c)
 *     NdisWdfDeviceControlIrpHandler @ 0x1C0060380 (NdisWdfDeviceControlIrpHandler.c)
 * Callees:
 ...
 *     ?ndisGetPerformanceCounters@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z @ 0x1C00689FC (-ndisGetPerformanceCounters@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z.c)
 ...
 *     ?ndisIovIoctlAttach@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C00766C0 (-ndisIovIoctlAttach@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z.c)
 *     ?ndisIovIoctlInvalidate@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C0076718 (-ndisIovIoctlInvalidate@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z.c)
 *     ?ndisIovIoctlNotification@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C0076820 (-ndisIovIoctlNotification@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z.c)
 ...
 *     ?ndisGetRdmaCapabilities@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C0137F38 (-ndisGetRdmaCapabilities@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z.c)
 */
        ...
        struct _IRP *a3)
{
  ...
  _BYTE *v56; // rdx
  char v58; // al
  _IO_STACK_LOCATION *v59; // rcx
  __int64 (__fastcall *v60)(struct _DEVICE_OBJECT *, struct _IRP *); // rax
  ...
  struct _NDIS_M_DRIVER_BLOCK *v67; // rsi
  struct _NDIS_M_DRIVER_BLOCK *v68; // rax
  ...
  struct _MDL *v88; // [rsp+30h] [rbp-49h]
  int v89; // [rsp+40h] [rbp-39h] BYREF
  KIRQL v90; // [rsp+44h] [rbp-35h]
  int v91; // [rsp+48h] [rbp-31h]
  unsigned int v92; // [rsp+4Ch] [rbp-2Dh] BYREF
  char v93[8]; // [rsp+50h] [rbp-29h]
  struct _NDIS_MINIPORT_BLOCK *v94; // [rsp+58h] [rbp-21h]
  _IO_STACK_LOCATION *v95; // [rsp+60h] [rbp-19h]
  __int128 v96; // [rsp+68h] [rbp-11h] BYREF
  __int128 v97; // [rsp+78h] [rbp-1h]
  _REFERENCE_EX *v98; // [rsp+88h] [rbp+Fh]
  __int128 *v99; // [rsp+90h] [rbp+17h]
  ULONG_PTR v101; // [rsp+F0h] [rbp+77h]
  char v102; // [rsp+F8h] [rbp+7Fh]
    ...
    if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_qq(
        *((_QWORD *)WPP_GLOBAL_Control + 8),
        ...
        (char)a1,
        v4);
    v59 = v4->Tail.Overlay.CurrentStackLocation;
    if ( v5->Header.Type == 17 )
    {
      v3 = 0;
      if ( v59->MajorFunction != 18 )
        v3 = -1073741637;
    }
    else
    {
      if ( v5->Header.Type == 9 )
      {
        v60 = (__int64 (__fastcall *)(struct _DEVICE_OBJECT *, struct _IRP *))*((_QWORD *)&v5->Reserved28
                                                                              + v59->MajorFunction);
        if ( v60 )
        {
          v3 = v60(a1, v4);
...
LABEL_24:
            if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
            {
              LODWORD(v88) = MiniportQueue->Ref.ReferenceCount;
              WPP_RECORDER_SF_qL(
                *((_QWORD *)WPP_GLOBAL_Control + 8),
                4u,
                0x14u,
          ...
          if ( v94 )
          {
            ndisDereferenceMiniportForNsi(v94, 0, 0x57u);
            v94 = 0LL;
          }
LABEL_30:
        ...
        while ( MiniportQueue );
        p_Ref = v98;
        v13 = *(struct _NDIS_M_DRIVER_BLOCK **)v93;
        v18 = v90;
        v91 = v20;
        v4 = a3;
LABEL_32:
        ...
        if ( v32 - 2 > 1 )
        {
          ...
          if ( *(_BYTE *)(v32 + 1) )
          {
            ...
            if ( (unsigned __int16)v66 >> 1 != 0 || (v66 & 1) != 0 )
            {
...
LABEL_41:
        ...
        if ( v23 )
        {
          ...
          v67 = *(struct _NDIS_M_DRIVER_BLOCK **)v93;
          if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_q(
              *((_QWORD *)WPP_GLOBAL_Control + 8),
              4u,
              ...
              *(_QWORD *)v93);
          v68 = ndisMiniDriverList;
          p_NextDriver = &ndisMiniDriverList;
          if ( ndisMiniDriverList )
          {
            while ( v68 != *(struct _NDIS_M_DRIVER_BLOCK **)v93 )
            {
              p_NextDriver = &v68->NextDriver;
              v68 = v68->NextDriver;
              if ( !v68 )
                goto LABEL_139;
            }
            *p_NextDriver = *(struct _NDIS_M_DRIVER_BLOCK **)(*(_QWORD *)v93 + 8LL);
            ObfDereferenceObject(ndisDriverObject);
          }
LABEL_139:
          Buffer = v67->ImageName.Buffer;
          if ( Buffer )
          {
            ExFreePoolWithTag(Buffer, 0);
            v67->ImageName.Buffer = 0LL;
          }
          NdisDriverInfo = v67->NdisDriverInfo;
          if ( NdisDriverInfo )
          {
            ExFreePoolWithTag(NdisDriverInfo, 0);
            v67->NdisDriverInfo = 0LL;
          }
          if ( (v67->Flags & 1) != 0 )
          {
            PendingDeviceList = v67->PendingDeviceList;
          ...
          KeSetEvent(&v67->MiniportsRemovedEvent, 0, 0);
          if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_q(
              *((_QWORD *)WPP_GLOBAL_Control + 8),
              4u,
...
LABEL_43:
    ...
    if ( v10 )
    {
      ...
      *(_WORD *)((char *)&v97 + 13) = 0;
      HIBYTE(v97) = 0;
      *((_QWORD *)&v96 + 1) = v10;
      *(_QWORD *)&v97 = v10->OidList;
      BYTE8(v97) = *((_BYTE *)FsContext + 24);
      ...
      if ( LowPart != 2252868 )
      {
        switch ( LowPart )
        {
          ...
          case 0x17001Eu:
            ...
            v74 = ndisMGetLogData(v5, v4);
            v3 = v74;
            if ( v74 != 259 )
              v3 = ndisConvertNdisStatusToNtStatusForIoctl(v74, v74, 0);
            break;
          case 0x170068u:
            v89 = 0;
            v76 = ndisSetPerfTrackParameters(v5, v4, &v89);
            v3 = ndisConvertNdisStatusToNtStatusForIoctl(v76, v89, 0);
            goto LABEL_52;
          case 0x17006Cu:
            v89 = 0;
            PerformanceCounters = ndisGetPerformanceCounters(v5, v4, &v89);
            v3 = ndisConvertNdisStatusToNtStatusForIoctl(PerformanceCounters, v89, 0);
            goto LABEL_52;
          case 0x170070u:
            v89 = 0;
            HardwareInfo = ndisGetHardwareInfo(v5, v4, &v89);
            v3 = ndisConvertNdisStatusToNtStatusForIoctl(HardwareInfo, v89, 0);
            goto LABEL_52;
          case 0x170078u:
            v89 = 0;
            PowerInfo = ndisGetPowerInfo(v5, v4, &v89);
            v3 = ndisConvertNdisStatusToNtStatusForIoctl(PowerInfo, v89, 0);
            goto LABEL_52;
          case 0x170090u:
          ...
          case 0x170094u:
            v89 = 0;
            AdapterHardwareInfo = ndisGetAdapterHardwareInfo(v5, v4, &v89);
            v3 = ndisConvertNdisStatusToNtStatusForIoctl(AdapterHardwareInfo, v89, 0);
            goto LABEL_52;
          case 0x170098u:
            v61 = *((_BYTE *)FsContext + 24);
            v89 = 0;
            AdapterRssInfo = ndisGetAdapterRssInfo(v5, v4, v61, &v89);
            v3 = ndisConvertNdisStatusToNtStatusForIoctl(AdapterRssInfo, v89, 0);
            goto LABEL_52;
          case 0x1700A8u:
            ...
            v3 = ndisConvertNdisStatusToNtStatusForIoctl(v81, v81, 0);
            goto LABEL_52;
          case 0x1700B0u:
            RdmaCapabilities = ndisGetPdInfo(v5, v4);
LABEL_164:
            v80 = RdmaCapabilities;
            v89 = RdmaCapabilities;
            goto LABEL_166;
          default:
            goto LABEL_180;
        }
    ...
    else
    {
      v80 = RdmaCapabilities;
LABEL_166:
      v3 = ndisConvertNdisStatusToNtStatusForIoctl(RdmaCapabilities, v80, 0);
    }
  }
LABEL_52:
...
LABEL_54:
  ...
  if ( v42 - 2 > 1 )
  {
    ...
    if ( *(_BYTE *)(v42 + 1) )
    {
      ...
      v82 = *(_DWORD *)(v42 + 64);
      v83 = v42 + 8;
      v84 = (unsigned __int16)v82 >> 1;
      if ( v82 >> 17 < 0x3FFE && v84 == (v82 >> 17) + 1 )
      {
...
LABEL_80:
  ...
  if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    LODWORD(v88) = v10->Ref.ReferenceCount;
    WPP_RECORDER_SF_qL(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      4u,
      0x14u,
