/*
 * XREFs of ?ndisWmiExecuteMethod@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@PEAUtagWNODE_METHOD_ITEM@@KPEAK@Z @ 0x1C008E358
 * Callers:
 *     ndisWMIDispatch @ 0x1C000FB40 (ndisWMIDispatch.c)
 *     NdisWdfExecuteMethod @ 0x1C00603E0 (NdisWdfExecuteMethod.c)
 * Callees:
