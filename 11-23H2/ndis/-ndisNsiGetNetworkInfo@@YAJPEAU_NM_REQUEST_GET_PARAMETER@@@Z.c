/*
 * XREFs of ?ndisNsiGetNetworkInfo@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00BAFC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisCompareGuid @ 0x1C001BFE0 (ndisCompareGuid.c)
  ...
  if ( v6 )
  {
    ...
    else
    {
      *v4 = 0LL;
      ...
      {
LABEL_12:
        v9 = (__int64 *)qword_1C00F5DB8;
        v1 = 0LL;
        if ( (__int64 *)qword_1C00F5DB8 != &qword_1C00F5DB8 )
        {
          while ( (int)ndisCompareGuid((__int64)(v9 + 4), (__int64)v4) <= 0 )
          {
            v9 = (__int64 *)*v9;
            if ( v9 == &qword_1C00F5DB8 )
              goto LABEL_20;
          }
          v1 = (char *)v9;
        }
