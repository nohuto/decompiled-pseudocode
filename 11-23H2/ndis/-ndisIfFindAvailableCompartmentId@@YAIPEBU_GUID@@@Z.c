/*
 * XREFs of ?ndisIfFindAvailableCompartmentId@@YAIPEBU_GUID@@@Z @ 0x1C00B8C74
 * Callers:
 *     ndisIfCreateCompartmentBlock @ 0x1C0033D08 (ndisIfCreateCompartmentBlock.c)
 * Callees:
 *     ?ndisIfFindAvailableCompartmentId_old@@YAIPEBU_GUID@@@Z @ 0x1C0037F98 (-ndisIfFindAvailableCompartmentId_old@@YAIPEBU_GUID@@@Z.c)
 */
...
__int64 __fastcall ndisIfFindAvailableCompartmentId(const struct _GUID *a1)
{
  ...
  if ( (unsigned int)dword_1C00F4950 > *(_DWORD *)(qword_1C00F5DB0 + 16) )
  {
