/*
 * XREFs of ?ndisFIndicateStatusInternal@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_STATUS_INDICATION@@@Z @ 0x1C001DCF0
 * Callers:
 ...
 *     ?ndisFIndicateStatusWrapper@@YAXPEAX@Z @ 0x1C001DCD0 (-ndisFIndicateStatusWrapper@@YAXPEAX@Z.c)
 ...
 *     ?ndisIfUpdateL2MtuSize@@YA_NPEAU_NDIS_IF_BLOCK@@K@Z @ 0x1C00B7680 (-ndisIfUpdateL2MtuSize@@YA_NPEAU_NDIS_IF_BLOCK@@K@Z.c)
 */
