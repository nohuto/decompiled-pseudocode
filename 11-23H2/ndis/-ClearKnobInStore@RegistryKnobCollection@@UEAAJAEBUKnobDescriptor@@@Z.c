/*
 * XREFs of ?ClearKnobInStore@RegistryKnobCollection@@UEAAJAEBUKnobDescriptor@@@Z @ 0x1C0140280
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0038370 (_guard_dispatch_icall_nop.c)
 *     ??1KnobTransaction@@QEAA@XZ @ 0x1C00BC0D4 (--1KnobTransaction@@QEAA@XZ.c)
 *     ?DeleteValue@KRegKey@@QEAAJPEB_W@Z @ 0x1C0139A48 (-DeleteValue@KRegKey@@QEAAJPEB_W@Z.c)
 */
