/*
 * XREFs of ?ndisReleaseReadWriteLockX@@YAXPEAU_NDIS_RW_LOCK@@PEAU_LOCK_STATE@@E@Z @ 0x1C003EE6E
 * Callers:
 *     NdisDprReleaseReadWriteLock @ 0x1C00AC210 (NdisDprReleaseReadWriteLock.c)
 * Callees:
