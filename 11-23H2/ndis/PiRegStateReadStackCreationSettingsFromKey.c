/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C0142FEC
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C0143478 (SeUtilSecurityInfoFromSecurityDescriptor.c)
