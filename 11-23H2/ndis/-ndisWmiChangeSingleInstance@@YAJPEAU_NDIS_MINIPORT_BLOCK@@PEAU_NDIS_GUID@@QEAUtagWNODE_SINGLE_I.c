/*
 * XREFs of ?ndisWmiChangeSingleInstance@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@QEAUtagWNODE_SINGLE_INSTANCE@@@Z @ 0x1C008D894
 * Callers:
 *     ndisWMIDispatch @ 0x1C000FB40 (ndisWMIDispatch.c)
 *     NdisWdfChangeSingleInstance @ 0x1C00602F0 (NdisWdfChangeSingleInstance.c)
 * Callees:
