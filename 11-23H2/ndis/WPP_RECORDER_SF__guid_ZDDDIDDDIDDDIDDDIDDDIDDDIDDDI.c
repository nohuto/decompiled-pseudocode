/*
 * XREFs of WPP_RECORDER_SF__guid_ZDDDIDDDIDDDIDDDIDDDIDDDIDDDI @ 0x1C00B00C4
 * Callers:
...
LABEL_11:
  LOWORD(v40) = 43;
  return WppAutoLogTrace(a1, 4LL, 15LL, &WPP_64b9953f987037c4a892513bd407e9c6_Traceguids, v40, a6);
}
