/*
 * XREFs of ?ndisCancelOidRequestInternal@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_FILTER_BLOCK@@PEAXE@Z @ 0x1C009EECC
 * Callers:
 *     ?ndisFCancelOidRequestInternal@@YAXPEAX@Z @ 0x1C0064CD0 (-ndisFCancelOidRequestInternal@@YAXPEAX@Z.c)
 ...
 *     NdisCancelOidRequest @ 0x1C00A8BC0 (NdisCancelOidRequest.c)
 * Callees:
