/*
 * XREFs of ?ndisReferencePackage@@YAXPEAU_PKG_REF@@@Z @ 0x1C0003060
 * Callers:
 ...
 *     NdisMDeregisterDevice @ 0x1C005F800 (NdisMDeregisterDevice.c)
 ...
 *     ?ndisPnPHandlePagingIrp@@YAXPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C007F074 (-ndisPnPHandlePagingIrp@@YAXPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@E@Z.c)
 *     ?ndisStartDeviceWorkItem@@YAXPEAX@Z @ 0x1C007FB70 (-ndisStartDeviceWorkItem@@YAXPEAX@Z.c)
