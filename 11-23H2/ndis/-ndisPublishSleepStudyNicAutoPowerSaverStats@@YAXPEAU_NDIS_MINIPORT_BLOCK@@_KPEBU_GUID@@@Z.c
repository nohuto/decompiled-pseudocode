/*
 * XREFs of ?ndisPublishSleepStudyNicAutoPowerSaverStats@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_KPEBU_GUID@@@Z @ 0x1C012B10C
 * Callers:
 *     ?ndisCsStateChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E_K@Z @ 0x1C0058C80 (-ndisCsStateChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E_K@Z.c)
 * Callees:
 *     ?ndisGetTimeInterval@@YA_KPEAT_LARGE_INTEGER@@@Z @ 0x1C0018344 (-ndisGetTimeInterval@@YA_KPEAT_LARGE_INTEGER@@@Z.c)
 *     __security_check_cookie @ 0x1C0036080 (__security_check_cookie.c)
 *     ??$ReadAcquire@EX@mem@@YAEPEDE@Z @ 0x1C0057920 (--$ReadAcquire@EX@mem@@YAEPEDE@Z.c)
 ...
 *     ndisPublishSleepStudyNicAutoPowerSaverCustomData @ 0x1C012AFC0 (ndisPublishSleepStudyNicAutoPowerSaverCustomData.c)
 */
