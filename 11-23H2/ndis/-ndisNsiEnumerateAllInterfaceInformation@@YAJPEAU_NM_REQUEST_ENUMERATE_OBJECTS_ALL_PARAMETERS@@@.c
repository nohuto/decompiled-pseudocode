/*
 * XREFs of ?ndisNsiEnumerateAllInterfaceInformation@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C000FE40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    ...
    {
      v9 = 0;
      v144 = KeAcquireSpinLockRaiseToDpc(&qword_1C00F5D80);
      if ( ThreadSessionId < dword_1C00F7620 )
        v9 = *((_DWORD *)qword_1C00F7628 + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00F5D80, v144);
      if ( !v9 )
        v9 = 1;
    }
    LODWORD(v210) = v9;
  ...
  if ( qword_1C00F5DA8 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
  {
    while ( *((_DWORD *)v19 + 4) != v10 )
    {
      if ( *((_DWORD *)v19 + 4) <= v10 )
      {
        ...
        if ( v19 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
          continue;
      }
      goto LABEL_18;
    }
