/*
 * XREFs of ?Open@ExecutionContextKnobCollection@@UEBAJKAEAUKnobTransaction@@@Z @ 0x1C0119850
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  *((_BYTE *)v3 + 16) = 0;
  ...
  KeyHandle = &Handle;
  P = 0LL;
  v10 = NetSetupPropertyBag::ReadString(&KeyHandle, &unk_1C00D8D60, &P);
  if ( v10 < 0 )
  {
    if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
      goto LABEL_41;
...
LABEL_42:
  ...
  v10 = NetSetupPropertyBag::ReadUint32(
          ...
          (const struct _NETSETUPPROPKEY *)&unk_1C00D8D48,
          &v35);
  if ( v10 < 0 )
  {
    if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
