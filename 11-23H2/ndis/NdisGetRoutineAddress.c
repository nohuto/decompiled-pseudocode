/*
 * XREFs of NdisGetRoutineAddress @ 0x1C00B30E0
 * Callers:
 *     ?ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z @ 0x1C00B2D10 (-ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0038370 (_guard_dispatch_icall_nop.c)
 *     FindExportedRoutineByName @ 0x1C00B2FE4 (FindExportedRoutineByName.c)
 */
