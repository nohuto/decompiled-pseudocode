/*
 * XREFs of ?ndisMpHookGetHookAdapterHandle@@YAPEAUNDIS_MINIPORT_HOOK_ADAPTER_HANDLE__@@PEAUNDIS_MINIPORT_ADAPTER_CONTEXT__@@@Z @ 0x1C00B3B10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        struct NDIS_MINIPORT_ADAPTER_CONTEXT__ *a1)
{
  ...
  for ( i = ndisMiniportList; ; i = i->NextGlobalMiniport )
  {
    if ( !i )
    {
