/*
 * XREFs of NdisAllocatePacketPoolEx @ 0x1C00311C0
 * Callers:
 *     ?ndisVerifierAllocatePacketPoolEx@@YAXPEAHPEAPEAXIII@Z @ 0x1C00B2BB0 (-ndisVerifierAllocatePacketPoolEx@@YAXPEAHPEAPEAXIII@Z.c)
 ...
 *     NdisPacketSize @ 0x1C0031430 (NdisPacketSize.c)
 *     NdisFreePacket @ 0x1C0031480 (NdisFreePacket.c)
        ...
        UINT ProtocolReservedLength)
{
  ...
  PVOID v25; // [rsp+30h] [rbp-38h] BYREF
