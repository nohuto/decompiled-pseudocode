/*
 * XREFs of PktMonClientNblDropNdis @ 0x1C00D3238
 * Callers:
 ...
 *     ?ndisFakeFilterSendHandler@@YAXPEAXPEAU_NET_BUFFER_LIST@@KK@Z @ 0x1C0065600 (-ndisFakeFilterSendHandler@@YAXPEAXPEAU_NET_BUFFER_LIST@@KK@Z.c)
 ...
 * Callees:
 *     NdisStatusToDropReason @ 0x1C00D2C64 (NdisStatusToDropReason.c)
