/*
 * XREFs of ?ndisCreateHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C0004DE0
 * Callers:
 *     ?ndisCreateIrpHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z @ 0x1C0004DC0 (-ndisCreateIrpHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z.c)
 *     NdisWdfCreateIrpHandler @ 0x1C0060340 (NdisWdfCreateIrpHandler.c)
 * Callees:
...
LABEL_17:
    ...
    {
      v21 = 0;
      v68 = KeAcquireSpinLockRaiseToDpc(&qword_1C00F5D80);
      if ( ThreadSessionId < dword_1C00F7620 )
        v21 = *((_DWORD *)qword_1C00F7628 + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00F5D80, v68);
      if ( !v21 )
        v21 = 1;
    }
    else
  ...
  if ( qword_1C00F5DA8 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
  {
    while ( *((_DWORD *)v24 + 4) != v22 )
    {
      if ( *((_DWORD *)v24 + 4) <= v22 )
      {
        ...
        if ( v24 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA8 )
          continue;
      }
      goto LABEL_25;
    }
