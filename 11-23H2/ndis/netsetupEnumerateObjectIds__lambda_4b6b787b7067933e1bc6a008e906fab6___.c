/*
 * XREFs of netsetupEnumerateObjectIds__lambda_4b6b787b7067933e1bc6a008e906fab6___ @ 0x1C013AFD8
 * Callers:
...
LABEL_18:
  ...
  for ( i = 0; ; ++i )
  {
    ...
    *(_OWORD *)&GuidString[1] = 0LL;
    ...
    {
      LwfById = ndisReadLwfById(0LL, &GuidString[1]);
      if ( LwfById )
        break;
    }
    if ( v5 )
