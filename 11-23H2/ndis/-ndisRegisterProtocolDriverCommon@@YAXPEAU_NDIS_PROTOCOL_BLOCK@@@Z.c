/*
 * XREFs of ?ndisRegisterProtocolDriverCommon@@YAXPEAU_NDIS_PROTOCOL_BLOCK@@@Z @ 0x1C0030164
 * Callers:
 ...
 *     ?SetDirty@BindEngine@Ndis@@QEAAXXZ @ 0x1C013A2C0 (-SetDirty@BindEngine@Ndis@@QEAAXXZ.c)
 */
