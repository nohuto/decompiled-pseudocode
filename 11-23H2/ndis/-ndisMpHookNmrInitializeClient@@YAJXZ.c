 ...
 *     ??0MINIPORT_HOOK_DRIVER@@QEAA@XZ @ 0x1C0121080 (--0MINIPORT_HOOK_DRIVER@@QEAA@XZ.c)
 *     ??_EMINIPORT_HOOK_DRIVER@@QEAAPEAXI@Z @ 0x1C013DB4C (--_EMINIPORT_HOOK_DRIVER@@QEAAPEAXI@Z.c)
 */
