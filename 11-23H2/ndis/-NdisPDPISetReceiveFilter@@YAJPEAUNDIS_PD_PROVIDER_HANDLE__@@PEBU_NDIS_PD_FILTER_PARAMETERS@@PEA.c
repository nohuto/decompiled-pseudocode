/*
 * XREFs of ?NdisPDPISetReceiveFilter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_FILTER_PARAMETERS@@PEAPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C0132C70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_FILTER@@QEAAPEAXI@Z @ 0x1C013055C (--_GNDIS_PD_FILTER@@QEAAPEAXI@Z.c)
 */
...
LABEL_37:
    ...
    *((_QWORD *)v12 + 12) = a2->RxFilterContext;
    v26.m_Lock = *(KPushLockBase **)&qword_1C00F5708;
