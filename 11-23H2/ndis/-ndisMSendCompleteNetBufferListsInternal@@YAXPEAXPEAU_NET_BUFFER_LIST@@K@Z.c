/*
 * XREFs of ?ndisMSendCompleteNetBufferListsInternal@@YAXPEAXPEAU_NET_BUFFER_LIST@@K@Z @ 0x1C0004050
 * Callers:
 ...
 *     ?NdisNumNbsInNblChain@@YAKPEBU_NET_BUFFER_LIST@@@Z @ 0x1C003FFF6 (-NdisNumNbsInNblChain@@YAKPEBU_NET_BUFFER_LIST@@@Z.c)
