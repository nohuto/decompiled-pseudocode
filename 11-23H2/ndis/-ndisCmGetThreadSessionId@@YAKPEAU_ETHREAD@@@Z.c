/*
 * XREFs of ?ndisCmGetThreadSessionId@@YAKPEAU_ETHREAD@@@Z @ 0x1C002F7C8
 * Callers:
 ...
 *     NdisGetThreadObjectCompartmentScope @ 0x1C00059A0 (NdisGetThreadObjectCompartmentScope.c)
 *     ?ndisNsiGetAllThreadInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C0005B60 (-ndisNsiGetAllThreadInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z.c)
 *     NdisGetThreadObjectCompartmentId @ 0x1C0006050 (NdisGetThreadObjectCompartmentId.c)
