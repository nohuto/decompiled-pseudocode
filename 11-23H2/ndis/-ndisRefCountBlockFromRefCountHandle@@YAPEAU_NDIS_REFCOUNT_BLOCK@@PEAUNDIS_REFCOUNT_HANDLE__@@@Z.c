/*
 * XREFs of ?ndisRefCountBlockFromRefCountHandle@@YAPEAU_NDIS_REFCOUNT_BLOCK@@PEAUNDIS_REFCOUNT_HANDLE__@@@Z @ 0x1C000F8D0
 * Callers:
 ...
 *     NdisGetRefCount @ 0x1C00C4B80 (NdisGetRefCount.c)
 * Callees:
