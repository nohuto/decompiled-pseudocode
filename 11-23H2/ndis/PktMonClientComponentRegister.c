/*
 * XREFs of PktMonClientComponentRegister @ 0x1C001C4E4
 * Callers:
...
__int64 __fastcall PktMonClientComponentRegister(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, unsigned int a5)
{
  unsigned int v9; // ebx
  __int64 v11; // rax
    ...
    if ( (_QWORD)xmmword_1C00F53B0 )
    {
      ...
      else
      {
        ...
        *(_QWORD *)&v14 = a4 | 0x300000000LL;
        ...
        {
          v9 = (*(__int64 (__fastcall **)(_QWORD, __int128 *, __int64))(*((_QWORD *)&xmmword_1C00F53B0 + 1) + 8LL))(
                 xmmword_1C00F53B0,
                 &v12,
                 a1 + 40);
          if ( !v9 )
          {
            *(_DWORD *)(a1 + 48) = a4;
            *(_DWORD *)(a1 + 52) = MediaTypeToPacketType(a5);
            v11 = PktMonCompList;
