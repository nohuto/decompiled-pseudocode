/*
 * XREFs of ndisPktMonComponentNotify @ 0x1C0136F40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisPktMonComponentNotify(__int64 a1)
{
  ...
  {
    if ( !(unsigned int)Feature_Servicing_PktmonDeadlockCausing9F__private_IsEnabledDeviceUsage()
      || (*(_DWORD *)(a1 - 5808 + 120) & 0x80u) == 0 )
    {
