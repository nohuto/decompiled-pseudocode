/*
 * XREFs of ?BuildCollection@KnobNamespace@@AEAAJPEBUKnobDescriptor@@_K_NP6AEPEAX0AEA_K@ZP6AJ301@Z3@Z @ 0x1C011A02C
 * Callers:
 ...
 *     ??1?$unique_ptr@VKnobCollection@@U?$default_delete@VKnobCollection@@@wistd@@@wistd@@QEAA@XZ @ 0x1C00BC0A4 (--1-$unique_ptr@VKnobCollection@@U-$default_delete@VKnobCollection@@@wistd@@@wistd@@QEAA@XZ.c)
