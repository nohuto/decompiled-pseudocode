/*
 * XREFs of ?ndisMSendPackets@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C00C8230
 * Callers:
 *     ?ndisMSend@@YAHPEAXPEAU_NDIS_PACKET@@@Z @ 0x1C00C8060 (-ndisMSend@@YAHPEAXPEAU_NDIS_PACKET@@@Z.c)
 * Callees:
