/*
 * XREFs of LookUpTableFlushComplete @ 0x1C01204E4
 * Callers:
 *     ndisDmaTelemetryUpdateBucketSchema @ 0x1C0032E94 (ndisDmaTelemetryUpdateBucketSchema.c)
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C01217C0 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C0144250 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 ...
 *     UpdateInternalStatsOnFlush @ 0x1C014435C (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C00F4638 > 5 && tlgKeywordOn((__int64)&dword_1C00F4638, 0x200000000000LL) )
      {
        v7 = *(_QWORD *)(a1 + 344);
        v49 = 32;
        v8 = *(_QWORD *)(v7 + 8);
