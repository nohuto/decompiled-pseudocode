/*
 * XREFs of NdisFreeSharedMemory @ 0x1C00CE150
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q(
      *((_QWORD *)WPP_GLOBAL_Control + 8),
      ...
      AllocationHandle);
  _InterlockedIncrement64(&qword_1C00F7918);
  v19 = 6;
      ...
      if ( (v7 & 0x3F) != 1 )
      {
        ...
        MmFreeContiguousMemorySpecifyCache(
          ...
          *((unsigned int *)AllocationHandle + 36),
          MmCached);
LABEL_22:
        _InterlockedExchangeAdd64(&qword_1C00F7928, *((unsigned int *)AllocationHandle + 36));
