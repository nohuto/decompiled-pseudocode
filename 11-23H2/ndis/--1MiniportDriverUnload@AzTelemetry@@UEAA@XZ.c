/*
 * XREFs of ??1MiniportDriverUnload@AzTelemetry@@UEAA@XZ @ 0x1C00D1494
 * Callers:
 *     ??_GMiniportDriverUnload@AzTelemetry@@UEAAPEAXI@Z @ 0x1C0069C00 (--_GMiniportDriverUnload@AzTelemetry@@UEAAPEAXI@Z.c)
