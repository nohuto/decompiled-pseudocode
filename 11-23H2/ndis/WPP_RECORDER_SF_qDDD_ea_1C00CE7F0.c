/*
 * XREFs of WPP_RECORDER_SF_qDDD @ 0x1C00CE7F0
 * Callers:
...
__int64 WPP_RECORDER_SF_qDDD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 1) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_9631851058cb35c6ce0e43959fab5e67_Traceguids,
      0x2Au,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 42;
  return WppAutoLogTrace(a1, 4LL, 1LL, &WPP_9631851058cb35c6ce0e43959fab5e67_Traceguids, v7, (__int64 *)va);
}
