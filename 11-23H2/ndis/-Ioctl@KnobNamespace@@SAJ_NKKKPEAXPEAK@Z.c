/*
 * XREFs of ?Ioctl@KnobNamespace@@SAJ_NKKKPEAXPEAK@Z @ 0x1C013F9A8
 * Callers:
 *     ?ndisKnobIoctl@@YAJ_NKKKPEAXPEAK@Z @ 0x1C0130334 (-ndisKnobIoctl@@YAJ_NKKKPEAXPEAK@Z.c)
 * Callees:
 ...
 *     CopyKnobInformationToIoctl @ 0x1C013F798 (CopyKnobInformationToIoctl.c)
 *     ?EnumerateKnobs@KnobNamespace@@AEAAXP6AXPEAXPEB_W@Z0@Z @ 0x1C013F82C (-EnumerateKnobs@KnobNamespace@@AEAAXP6AXPEAXPEB_W@Z0@Z.c)
 *     ?FindById@KnobNamespace@@CAPEAV1@PEBU_CONFIG_KNOB_NAMESPACE@@@Z @ 0x1C013F8C8 (-FindById@KnobNamespace@@CAPEAV1@PEBU_CONFIG_KNOB_NAMESPACE@@@Z.c)
        ...
        if ( a1 )
        {
          if ( a3 >= 0x2C && a4 >= 8 )
          {
            ...
            if ( *(_DWORD *)a5 == 1 )
            {
              ...
              v32.m_Lock = (KPushLockBase *)&unk_1C00F5DC8;
...
LABEL_32:
  ...
  if ( a3 >= 0x18 && a4 >= 0xC )
  {
    ...
    if ( *(_DWORD *)a5 == 1 )
    {
      ...
      v33.DefaultValue = (unsigned __int64)&unk_1C00F5DC8;
