/*
 * XREFs of ?ndisReferenceMiniport@@YAEPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_MP_REFTAG@@@Z @ 0x1C00113A8
 * Callers:
 ...
 *     NdisWdfMiniportTryReference @ 0x1C003D010 (NdisWdfMiniportTryReference.c)
