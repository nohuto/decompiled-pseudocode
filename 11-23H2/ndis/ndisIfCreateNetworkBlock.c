/*
 * XREFs of ndisIfCreateNetworkBlock @ 0x1C002F4AC
 * Callers:
...
LABEL_36:
  ...
  *v14 = v14;
  ...
  while ( v10 );
  v23 = *a3;
  v24 = (__int64 *)qword_1C00F5DB8;
  *v15 = v23;
  while ( v24 != &qword_1C00F5DB8 )
  {
...
LABEL_33:
    ...
    for ( i = qword_1C00F5DB8; (__int64 *)i != &qword_1C00F5DB8; i = *(_QWORD *)i )
    {
      if ( v33 == *(_DWORD *)(i + 88) )
        goto LABEL_33;
    }
