/*
 * XREFs of ?ndisSetOpenPacketFilter@@YAEPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1C001A45C
 * Callers:
 ...
 *     ?XFilterAdjust@@YAHPEAU_X_FILTER@@PEAU_NDIS_OPEN_BLOCK@@I@Z @ 0x1C001A674 (-XFilterAdjust@@YAHPEAU_X_FILTER@@PEAU_NDIS_OPEN_BLOCK@@I@Z.c)
...
LABEL_11:
            ...
            *p_MiniportThread = 0LL;
            KeReleaseSpinLock(&MiniportHandle->Lock, v16);
