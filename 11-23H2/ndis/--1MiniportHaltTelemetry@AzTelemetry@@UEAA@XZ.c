/*
 * XREFs of ??1MiniportHaltTelemetry@AzTelemetry@@UEAA@XZ @ 0x1C001447C
 * Callers:
 *     ??_EMiniportHaltTelemetry@AzTelemetry@@UEAAPEAXI@Z @ 0x1C00D17E0 (--_EMiniportHaltTelemetry@AzTelemetry@@UEAAPEAXI@Z.c)
