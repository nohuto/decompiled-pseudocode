/*
 * XREFs of ??1MiniportStartDevice@AzTelemetry@@UEAA@XZ @ 0x1C00D16D4
 * Callers:
 ...
 *     ??_GMiniportStartDevice@AzTelemetry@@UEAAPEAXI@Z @ 0x1C0069CF0 (--_GMiniportStartDevice@AzTelemetry@@UEAAPEAXI@Z.c)
 * Callees:
