/*
 * XREFs of ?ndisBuildBindings@@YAJPEBU_GUID@@AEAUBindStack@Ndis@@@Z @ 0x1C013C5A4
 * Callers:
 ...
 *     ??1NetworkInterfaceBindProperties@@QEAA@XZ @ 0x1C00B3604 (--1NetworkInterfaceBindProperties@@QEAA@XZ.c)
 ...
 *     ndisIntersectAtoms @ 0x1C013CA30 (ndisIntersectAtoms.c)
