/*
 * XREFs of ndisIfUpdateIfBlockFromPersistedState @ 0x1C013E4F8
 * Callers:
...
void __fastcall ndisIfUpdateIfBlockFromPersistedState(struct _NDIS_IF_BLOCK *a1, struct KRegKey *this)
{
  ...
  Handle[0] = 0LL;
  Ndis::BindRegistry::ReadNetworkInterfaceV2(this, (struct KRegKey *)Handle, &v26, v4);
  v24 = 0LL;
  v22 = this;
  if ( (int)NetSetupPropertyBag::ReadString(
              (NetSetupPropertyBag *)&v22,
              (const struct _NETSETUPPROPKEY *)&unk_1C00E49C8,
              &v24) >= 0 )
  {
    v19 = 20;
  ...
  if ( (int)NetSetupPropertyBag::ReadString(
              (NetSetupPropertyBag *)&v22,
              (const struct _NETSETUPPROPKEY *)&unk_1C00E49B0,
              &P) >= 0 )
  {
    v19 = 4;
