 ...
 *     ExtractAggregateFieldTypes @ 0x1C00D3DF0 (ExtractAggregateFieldTypes.c)
 *     InsertEventEntryInLookUpTable @ 0x1C00D3FA4 (InsertEventEntryInLookUpTable.c)
 */
