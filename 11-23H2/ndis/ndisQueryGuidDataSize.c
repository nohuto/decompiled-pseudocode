/*
 * XREFs of ndisQueryGuidDataSize @ 0x1C0026910
 * Callers:
        ...
        struct _NDIS_MINIPORT_BLOCK *a6)
{
  ...
  *(_QWORD *)&GuidString.Length = 0LL;
  ...
  v32 = 0;
  if ( (unsigned __int8)byte_1C00F5439 >= 4u )
  {
  ...
  {
    v20 = ndisWmiGetGuid(&v35, v8, Guid, 0);
    v9 = v35;
    v11 = v20;
    if ( !v35 )
    {
  ...
  if ( (Flags & 0x20000000) != 0 )
  {
    ...
    if ( v13 )
    {
      ...
      v22 = *(_QWORD *)&v9->Guid.Data1 - *(_QWORD *)&GUID_NDIS_NDK_CAPABILITIES.Data1;
      if ( *(_QWORD *)&v9->Guid.Data1 == *(_QWORD *)&GUID_NDIS_NDK_CAPABILITIES.Data1 )
        v22 = *(_QWORD *)v9->Guid.Data4 - *(_QWORD *)GUID_NDIS_NDK_CAPABILITIES.Data4;
      if ( !v22 )
      {
        *a1 = 144;
        goto LABEL_24;
      }
      v23 = *(_QWORD *)&v9->Guid.Data1 - *(_QWORD *)&GUID_NDIS_PM_ADMIN_CONFIG.Data1;
      if ( *(_QWORD *)&v9->Guid.Data1 == *(_QWORD *)&GUID_NDIS_PM_ADMIN_CONFIG.Data1 )
        v23 = *(_QWORD *)v9->Guid.Data4 - *(_QWORD *)GUID_NDIS_PM_ADMIN_CONFIG.Data4;
      if ( !v23 )
      {
        *a1 = 28;
        goto LABEL_24;
      }
      v24 = *(_QWORD *)&v9->Guid.Data1 - *(_QWORD *)&GUID_NDIS_PM_ACTIVE_CAPABILITIES.Data1;
      if ( *(_QWORD *)&v9->Guid.Data1 == *(_QWORD *)&GUID_NDIS_PM_ACTIVE_CAPABILITIES.Data1 )
        v24 = *(_QWORD *)v9->Guid.Data4 - *(_QWORD *)GUID_NDIS_PM_ACTIVE_CAPABILITIES.Data4;
      if ( !v24 )
      {
        *a1 = 28;
        goto LABEL_24;
      ...
      if ( v36 )
      {
        v25 = *(_QWORD *)&v9->Guid.Data1 - *(_QWORD *)&GUID_NDIS_ENUMERATE_VC.Data1;
        if ( *(_QWORD *)&v9->Guid.Data1 == *(_QWORD *)&GUID_NDIS_ENUMERATE_VC.Data1 )
          v25 = *(_QWORD *)v9->Guid.Data4 - *(_QWORD *)GUID_NDIS_ENUMERATE_VC.Data4;
        if ( !v25 )
        {
          *a1 = 0;
          goto LABEL_24;
      ...
      v26 = *(_QWORD *)&v9->Guid.Data1 - *(_QWORD *)&GUID_NDIS_ENUMERATE_ADAPTERS_EX.Data1;
      if ( *(_QWORD *)&v9->Guid.Data1 == *(_QWORD *)&GUID_NDIS_ENUMERATE_ADAPTERS_EX.Data1 )
        v26 = *(_QWORD *)v9->Guid.Data4 - *(_QWORD *)GUID_NDIS_ENUMERATE_ADAPTERS_EX.Data4;
      if ( !v26 )
      {
...
LABEL_97:
  ...
  memset(&v37.NdisReserved[40], 0, 0x88uLL);
  *(_DWORD *)&v37.NdisReserved[16] |= 8u;
  *(_QWORD *)&v37.NdisReserved[32] = &ndisIntReqWmi;
  EtwActivityIdControl(3u, (LPGUID)&v37.NdisReserved[96]);
