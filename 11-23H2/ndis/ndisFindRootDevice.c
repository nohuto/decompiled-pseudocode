/*
 * XREFs of ndisFindRootDevice @ 0x1C0156700
 * Callers:
...
{
  const struct _UNICODE_STRING *v6; // r15
  char v7; // r14
  ...
  const struct _UNICODE_STRING *v20; // r12
  int v21; // edx
...
LABEL_8:
          ...
          if ( *(_DWORD *)Buffer < v23 )
            goto LABEL_8;
          v20 = (const struct _UNICODE_STRING *)(Buffer + 4);
