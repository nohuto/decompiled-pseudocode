/*
 * XREFs of ??0KnobNamespace@@QEAA@PEAU_DRIVER_OBJECT@@PEBU_CONFIG_KNOB_NAMESPACE@@@Z @ 0x1C0118D50
 * Callers:
        ...
        const struct _CONFIG_KNOB_NAMESPACE *a3)
{
  ...
  *(_DWORD *)&this->m_id.ObjectId.Data4[4] = v4;
  ...
  v9.m_Lock = (KPushLockBase *)&unk_1C00F5DC8;
  KLockHolder::AcquireExclusive(&v9);
  v7 = (_LIST_ENTRY *)qword_1C00F5DD8;
  if ( *(__int64 **)qword_1C00F5DD8 != &qword_1C00F5DD0 )
    __fastfail(3u);
  p_m_globalLinkage->Flink = (_LIST_ENTRY *)&qword_1C00F5DD0;
  p_m_globalLinkage->Blink = v7;
  v7->Flink = p_m_globalLinkage;
  qword_1C00F5DD8 = (__int64)p_m_globalLinkage;
