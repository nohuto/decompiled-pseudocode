/*
 * XREFs of ?ndisMSendPacketsToNetBufferLists@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C00C9D10
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *(_QWORD *)&v17[4] )
    {
      if ( *(_DWORD *)ndisNblTrackerMode )
        ndisNblTrackerTransferOwnershipInternal(
          ...
          *(struct NDIS_NBL_TRACKER_HANDLE__ **)(v7 + 584),
          a1[320],
          143LL,
          BYTE4(v19) & 1);
      if ( byte_1C00F5390 )
      {
        ...
        if ( v12 )
        {
          if ( (*(_DWORD *)(v12 + 56) & 1) != 0 )
            PktMonClientNblLogNdis(v7 + 984, v10, v9, 2LL);
        }
      }
