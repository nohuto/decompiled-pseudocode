/*
 * XREFs of ?ndisWmiSetPMAdminConfig@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_WMI_PM_ADMIN_CONFIG@@@Z @ 0x1C009A610
 * Callers:
 ...
 *     ?ndisIsValidPMAdminConfigState@@YAHW4_NDIS_PM_ADMIN_CONFIG_STATE@@0@Z @ 0x1C0093C40 (-ndisIsValidPMAdminConfigState@@YAHW4_NDIS_PM_ADMIN_CONFIG_STATE@@0@Z.c)
            ...
            if ( !result )
            {
              ...
              if ( !result )
              {
                ...
                if ( WakeOnPattern )
                {
                  ...
                  a1->PMAdminConfig.Value ^= (a1->PMAdminConfig.Value ^ a2->WakeOnPattern) & 3;
                }
