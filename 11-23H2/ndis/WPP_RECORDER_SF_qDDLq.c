/*
 * XREFs of WPP_RECORDER_SF_qDDLq @ 0x1C00C0548
 * Callers:
...
__int64 WPP_RECORDER_SF_qDDLq(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x80000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_de7b4475eb543019aeb186df8ee4bca2_Traceguids,
      a4,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 4LL, 20LL, &WPP_de7b4475eb543019aeb186df8ee4bca2_Traceguids, v8, (__int64 *)va);
}
