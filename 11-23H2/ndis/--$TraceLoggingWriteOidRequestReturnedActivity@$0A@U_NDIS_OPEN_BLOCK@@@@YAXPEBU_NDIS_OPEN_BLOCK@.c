/*
 * XREFs of ??$TraceLoggingWriteOidRequestReturnedActivity@$0A@U_NDIS_OPEN_BLOCK@@@@YAXPEBU_NDIS_OPEN_BLOCK@@PEBU_NDIS_OID_REQUEST@@@Z @ 0x1C00D0D6C
 * Callers:
...
void TraceLoggingWriteOidRequestReturnedActivity<0,_NDIS_OPEN_BLOCK>()
{
  __int64 v0; // r9
  __int64 v1; // r10
