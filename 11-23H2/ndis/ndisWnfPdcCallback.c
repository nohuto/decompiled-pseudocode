/*
 * XREFs of ndisWnfPdcCallback @ 0x1C005AAE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisNicAutoPowerSaverControlIdleTimer@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00AD2E8 (-ndisNicAutoPowerSaverControlIdleTimer@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
 */
