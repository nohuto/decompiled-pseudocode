/*
 * XREFs of NVMeReservationReportStatusCompletion @ 0x1C00178C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GetScsiReservationType @ 0x1C0012CDC (GetScsiReservationType.c)
