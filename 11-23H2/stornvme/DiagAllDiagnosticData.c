/*
 * XREFs of DiagAllDiagnosticData @ 0x1C0011284
 * Callers:
 *     DiagGeneric @ 0x1C001165C (DiagGeneric.c)
 * Callees:
...
__int64 __fastcall DiagAllDiagnosticData(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v4 >= v7 )
  {
    ...
    *(_QWORD *)(a2 + 8692) = *(_QWORD *)(a1 + 4064);
    *(_QWORD *)(a2 + 8704) = *(_QWORD *)(a1 + 4072);
    *(_DWORD *)(a2 + 8712) = *(_DWORD *)(a1 + 4080);
    *(_WORD *)(a2 + 8720) = *(_WORD *)(a1 + 328);
    *(_WORD *)(a2 + 8722) = *(_WORD *)(a1 + 330);
    *(_WORD *)(a2 + 8724) = *(_WORD *)(a1 + 332);
    *(_WORD *)(a2 + 8726) = *(_WORD *)(a1 + 334);
    *(_WORD *)(a2 + 8728) = *(_WORD *)(a1 + 336);
    *(_WORD *)(a2 + 8730) = *(_WORD *)(a1 + 338);
    *(_WORD *)(a2 + 8732) = *(_WORD *)(a1 + 340);
    *(_WORD *)(a2 + 8734) = *(_WORD *)(a1 + 888);
    *(_WORD *)(a2 + 8736) = *(_WORD *)(a1 + 890);
    *(_WORD *)(a2 + 8738) = *(_WORD *)(a1 + 912);
    *(_WORD *)(a2 + 8740) = *(_WORD *)(a1 + 914);
    *(_WORD *)(a2 + 8742) = *(_WORD *)(a1 + 916);
    *(_WORD *)(a2 + 8744) = *(_WORD *)(a1 + 918);
    v8 = *(unsigned int *)(a1 + 220);
    *(_DWORD *)(a2 + 8748) = v8;
    if ( (_DWORD)v8 )
      memmove((void *)(a2 + 8752), (const void *)(a1 + 1952), 424 * v8);
    *(_DWORD *)(a2 + 32) = v7;
  }
  else
  {
