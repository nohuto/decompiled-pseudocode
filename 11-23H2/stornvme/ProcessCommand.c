/*
 * XREFs of ProcessCommand @ 0x1C00024B0
 * Callers:
 ...
 * Callees:
 *     ProcessCommandInSpecificQueue @ 0x1C0002570 (ProcessCommandInSpecificQueue.c)
...
__int64 __fastcall ProcessCommand(__int64 a1, __int64 a2)
{
  ...
  if ( g_HeteroSystem && (*(_BYTE *)(a1 + 4344) & 0x10) == 0 )
    v7 = v9;
  ...
  if ( v11 > 1 )
  {
    *(_BYTE *)(v4 + 4253) |= 0x10u;
    ...
    while ( v6 < v12 );
    if ( !g_HeteroSystem || (result = *(unsigned int *)(a1 + 4344), (result & 0x10) != 0) )
    {
      if ( v15 )
        return result;
    }
