/*
 * XREFs of wil_details_GetCurrentFeatureEnabledState @ 0x1C000408C
 * Callers:
...
__int64 __fastcall wil_details_GetCurrentFeatureEnabledState(__int64 a1, _DWORD *a2)
{
  ...
  *a2 = 1;
  ...
  HIDWORD(v19) = 0;
  if ( ((((unsigned __int8)v17 & (unsigned __int8)-(FeatureState != 0) & 3) << 7) & 0x180) != 0 )
  {
    v7 = 0;
    if ( (_DWORD)v17 == 2 )
      v7 = 64;
  ...
  v8 = ((_DWORD)v18 != 0 ? 0x400 : 0) | (HIDWORD(v18) != 0 ? 0x800 : 0) | (((unsigned __int8)v17 & (unsigned __int8)-(FeatureState != 0) & 3) << 7) | v7;
  v9 = v8 | (v8 >> 6) & 1;
  LODWORD(v19) = v9;
  if ( v8 & 1 | ((v8 & 0x40) != 0) )
  {
