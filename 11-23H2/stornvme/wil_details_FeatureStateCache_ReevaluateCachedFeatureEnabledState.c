/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C0003F38
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C000408C (wil_details_GetCurrentFeatureEnabledState.c)
 *     wil_details_IsEnabledFallback @ 0x1C00041E8 (wil_details_IsEnabledFallback.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C000408C (wil_details_GetCurrentFeatureEnabledState.c)
