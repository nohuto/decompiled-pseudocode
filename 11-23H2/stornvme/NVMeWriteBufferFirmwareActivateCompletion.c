/*
 * XREFs of NVMeWriteBufferFirmwareActivateCompletion @ 0x1C00183B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsFirmwareActivateWithoutResetEnabled @ 0x1C0014C64 (IsFirmwareActivateWithoutResetEnabled.c)
...
char __fastcall NVMeWriteBufferFirmwareActivateCompletion(__int64 a1, __int64 a2)
{
  ...
  if ( (v9 & 0x1FE) == 0 && (v9 & 0xE00) == 0 )
  {
    ...
    {
      *(_BYTE *)(a2 + 3) = 1;
      if ( (unsigned int)NVMeQueueWorkItem(a1, (__int64)NVMeControllerIdentifyWorkItem) )
        *(_DWORD *)(a1 + 32) |= 0x20u;
      goto LABEL_21;
    }
    *(_DWORD *)(a1 + 32) |= 0x20u;
...
LABEL_11:
  ...
  if ( (unsigned int)(unsigned __int8)v12 - 16 < 2 )
  {
    *(_DWORD *)(a1 + 32) |= 0x20u;
    v11 = v10 == 32;
    goto LABEL_9;
