/*
 * XREFs of ScsiToNVMe @ 0x1C00015C0
 * Callers:
...
__int64 __fastcall ScsiToNVMe(__int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4)
{
  ...
  unsigned __int64 v54; // [rsp+30h] [rbp-88h]
  unsigned __int16 v55; // [rsp+38h] [rbp-80h]
  __int64 *v56; // [rsp+40h] [rbp-78h]
  _DWORD *v57; // [rsp+40h] [rbp-78h]
...
LABEL_21:
  ...
  v52 = v19;
  v56 = (__int64 *)(a1 + 8 * v19 + 1952);
  v20 = *v56;
  v21 = *(_DWORD *)(*v56 + 52);
  if ( !v21
    || !*(_QWORD *)(v20 + 56)
    || ((v55 = *(_WORD *)(v20 + 92), v4 != 40) ? (v22 = *(_DWORD *)(v7 + 12)) : (v22 = *(_DWORD *)(v7 + 24)),
...
LABEL_70:
    *(_BYTE *)(v17 + 4096) = 1;
    if ( (*(_BYTE *)(a1 + 4008) & 3) == 3 && *(_BYTE *)(a1 + 4009) == v24 && *(_WORD *)(a1 + 4012) )
      StorPortExtendedFunction(28LL, a1, v7);
    goto LABEL_41;
  }
  v51 = v45 - 94;
  if ( v51 )
...
LABEL_52:
    ...
    if ( v39 == 256LL )
    {
      v41 = (__int64)(v38 + ((unsigned int)v54 | (v32 << 32)) - 1);
      v42 = (__int64)(v41 + BYTE8(v41)) >> 8;
    }
    else
    {
      v42 = (__int64)(v38 + ((unsigned int)v54 | (v32 << 32)) - 1) / v39;
    }
    v14 = (__int64)((unsigned int)v54 | (v32 << 32)) / v40 != v42;
    goto LABEL_58;
  }
  v37 = v55;
  if ( v55 )
