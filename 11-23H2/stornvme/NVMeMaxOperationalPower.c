/*
 * XREFs of NVMeMaxOperationalPower @ 0x1C000FCE4
 * Callers:
 *     NVMeHwAdapterControl @ 0x1C00036A0 (NVMeHwAdapterControl.c)
 * Callees:
 *     NVMePerfStateTransition @ 0x1C000379C (NVMePerfStateTransition.c)
 *     NVMeGetPowerState @ 0x1C0007E58 (NVMeGetPowerState.c)
 *     NVMePowerStateGetMaxPower @ 0x1C00106EC (NVMePowerStateGetMaxPower.c)
 */
