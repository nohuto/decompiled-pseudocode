/*
 * XREFs of NVMeHwUnitControl @ 0x1C0008740
 * Callers:
 *     <none>
 * Callees:
 *     memset @ 0x1C0004D40 (memset.c)
 *     NVMeLunCompleteAllIORequests @ 0x1C000FC38 (NVMeLunCompleteAllIORequests.c)
...
__int64 __fastcall NVMeHwUnitControl(__int64 a1, int a2, __int64 a3)
{
  ...
  v10 = v9 - 1;
  if ( !v10 )
    return (unsigned int)NVMeGetRichDeviceDescription(a1, (void *)a3) != 0;
  v11 = v10 - 2;
  if ( !v11 )
  {
    v13 = *(_QWORD *)(a1 + 1840);
