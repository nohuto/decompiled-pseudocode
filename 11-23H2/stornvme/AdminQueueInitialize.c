/*
 * XREFs of AdminQueueInitialize @ 0x1C0009394
 * Callers:
 ...
 *     NVMeSubmissionQueueInit @ 0x1C0010A8C (NVMeSubmissionQueueInit.c)
 */
...
char __fastcall AdminQueueInitialize(__int64 a1)
{
  ...
  {
    StorPortExtendedFunction(0LL, a1, (unsigned int)(16 * v1));
    return 0;
  }
  return result;
}
