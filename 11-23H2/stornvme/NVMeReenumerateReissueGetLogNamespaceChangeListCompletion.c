/*
 * XREFs of NVMeReenumerateReissueGetLogNamespaceChangeListCompletion @ 0x1C00232C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NVMeReenumerateMergeNamespaceChangeList @ 0x1C0022058 (NVMeReenumerateMergeNamespaceChangeList.c)
