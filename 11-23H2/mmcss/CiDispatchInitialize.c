/*
 * XREFs of CiDispatchInitialize @ 0x1C000F490
 * Callers:
...
NTSTATUS __fastcall CiDispatchInitialize(struct _DRIVER_OBJECT *a1)
{
  ...
  result = IoCreateDevice(a1, 0, (PUNICODE_STRING)0x1C0011020LL, 0x22u, 0x20000u, 0, &CiDeviceObject);
  v2 = result;
  if ( result >= 0 )
  {
