/*
 * XREFs of CiSchedulerSetMultimediaMode @ 0x1C0003A90
 * Callers:
 *     CiDispatchFastIoDeviceControl @ 0x1C000BB90 (CiDispatchFastIoDeviceControl.c)
 * Callees:
 *     CiSystemAcquireSpinLock @ 0x1C0001010 (CiSystemAcquireSpinLock.c)
 *     CiSchedulerRefreshTaskIndexQosProperties @ 0x1C00039C8 (CiSchedulerRefreshTaskIndexQosProperties.c)
