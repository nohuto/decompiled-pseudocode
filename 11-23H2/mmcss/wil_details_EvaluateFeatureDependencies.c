/*
 * XREFs of wil_details_EvaluateFeatureDependencies @ 0x1C000B0BC
 * Callers:
 *     wil_details_ReevaluateOnFeatureConfigurationChange @ 0x1C000B280 (wil_details_ReevaluateOnFeatureConfigurationChange.c)
 *     wil_InitializeFeatureStaging @ 0x1C000F078 (wil_InitializeFeatureStaging.c)
 * Callees:
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x1C00030B0 (wil_details_FeatureDescriptors_SkipPadding.c)
 *     wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState @ 0x1C000B170 (wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState.c)
 */
