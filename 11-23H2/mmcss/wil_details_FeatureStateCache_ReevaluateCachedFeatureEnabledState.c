/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C00035F8
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C000373C (wil_details_GetCurrentFeatureEnabledState.c)
 *     wil_details_IsEnabledFallback @ 0x1C0003898 (wil_details_IsEnabledFallback.c)
 * Callees:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C000373C (wil_details_GetCurrentFeatureEnabledState.c)
