/*
 * XREFs of wil_details_PopulateInitialConfiguredFeatureStates @ 0x1C000F114
 * Callers:
 ...
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x1C000B054 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
