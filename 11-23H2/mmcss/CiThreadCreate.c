/*
 * XREFs of CiThreadCreate @ 0x1C000C1B0
 * Callers:
 ...
 *     CiProcessAddThread @ 0x1C000C530 (CiProcessAddThread.c)
 *     CiThreadIncrementScheduledCount @ 0x1C000C580 (CiThreadIncrementScheduledCount.c)
 *     CiThreadUpdatePriorities @ 0x1C000C600 (CiThreadUpdatePriorities.c)
  ...
  *(_BYTE *)(v11 + 104) = *(_BYTE *)v3;
  ...
  if ( v21 != v18 )
  {
    ...
    if ( InformationThread < 0 )
    {
      ...
      if ( InformationThread != -1073741811 || (~qword_1C0008270 & v21) != 0 )
        goto LABEL_30;
    }
  }
