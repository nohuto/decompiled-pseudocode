/*
 * XREFs of wil_details_IsEnabledFallback @ 0x1C0003898
 * Callers:
 ...
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x1C00036F8 (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
