/*
 * XREFs of CiConfigInitialize @ 0x1C000F670
 * Callers:
    ...
    else
    {
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          ActiveThreadCount);
      v9 = CiConfigReadDWORD(KeyHandle, 0x1C00110E0LL, 100000LL);
      *(&WPP_MAIN_CB.ActiveThreadCount + 1) = v9;
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          v9);
      v10 = CiConfigReadDWORD(KeyHandle, 0x1C00110F0LL, 32LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_350503daac883abe7be9cf63f89038d9_Traceguids,
          v10);
      v11 = CiConfigReadDWORD(KeyHandle, 0x1C0011100LL, 256LL);
