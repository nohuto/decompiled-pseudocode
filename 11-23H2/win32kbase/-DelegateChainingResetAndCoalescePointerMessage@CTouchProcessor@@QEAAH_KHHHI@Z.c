/*
 * XREFs of ?DelegateChainingResetAndCoalescePointerMessage@CTouchProcessor@@QEAAH_KHHHI@Z @ 0x1C01C0CF0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  CInpLockGuard *v24[8]; // [rsp+20h] [rbp-68h] BYREF
  ...
  if ( *((_DWORD *)v12 + 8) >= *(_DWORD *)(v13 + 48) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5995);
  v15 = *(_QWORD *)(v14 + 240) + 480LL * *((unsigned int *)v12 + 8);
  if ( !(unsigned int)CPointerInfoNode::IsValid((CPointerInfoNode *)v15) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5997);
  if ( *(_WORD *)(v15 + 172) != *((_WORD *)v12 + 8) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5998);
  if ( a5 )
  {
    if ( !a4 )
      goto LABEL_11;
