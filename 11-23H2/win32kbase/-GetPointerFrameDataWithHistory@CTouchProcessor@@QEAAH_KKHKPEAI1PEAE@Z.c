/*
 * XREFs of ?GetPointerFrameDataWithHistory@CTouchProcessor@@QEAAH_KKHKPEAI1PEAE@Z @ 0x1C01C8BB0
 * Callers:
        ...
        unsigned __int8 *a8)
{
  ...
  if ( !FrameById )
  {
    ...
    v20 = 125;
LABEL_22:
    v21 = &WPP_2c5ea56a6e6f31fa38ff36b2483c7d67_Traceguids;
    v39 = v20;
LABEL_49:
    LOBYTE(v21) = v14;
    WPP_RECORDER_AND_TRACE_SF_(
...
LABEL_50:
  ...
  if ( *((_DWORD *)v18 + 8) >= *((_DWORD *)FrameById + 12) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5198);
  v24 = (CPointerInfoNode *)(*((_QWORD *)v23 + 30) + 480LL * *((unsigned int *)v18 + 8));
  if ( !(unsigned int)CPointerInfoNode::IsValid(v24) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5200);
  ...
  if ( PointerFrameData )
  {
    ...
    else
    {
      ...
      if ( a5 >= (unsigned int)v30 )
      {
        if ( !(_DWORD)v30 )
        {
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5234);
          v28 = 0;
        }
        ...
        while ( PreviousFrameByDevice )
        {
          if ( v33 > 1 )
          {
            if ( v32 >= *((_DWORD *)PreviousFrameByDevice + 12) )
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5251);
            v35 = (CPointerInfoNode *)(*((_QWORD *)PreviousFrameByDevice + 30) + 480LL * v32);
            if ( !(unsigned int)CPointerInfoNode::IsValid(v35) )
            {
              v40[1] = 0x20000;
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5253);
            }
            ++v26;
            ...
            {
              v40[2] = 0x20000;
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5273);
            }
...
LABEL_74:
  ...
  if ( (_BYTE)v28 || v14 )
  {
    v37 = &WPP_2c5ea56a6e6f31fa38ff36b2483c7d67_Traceguids;
    LOBYTE(v37) = v14;
    WPP_RECORDER_AND_TRACE_SF_(
      WPP_GLOBAL_Control->AttachedDevice,
      v28,
