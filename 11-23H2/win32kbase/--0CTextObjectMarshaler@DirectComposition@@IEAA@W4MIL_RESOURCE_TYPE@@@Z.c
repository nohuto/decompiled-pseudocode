/*
 * XREFs of ??0CTextObjectMarshaler@DirectComposition@@IEAA@W4MIL_RESOURCE_TYPE@@@Z @ 0x1C020D8DC
 * Callers:
...
_QWORD *__fastcall DirectComposition::CTextObjectMarshaler::CTextObjectMarshaler(_QWORD *a1, int a2)
{
  DirectComposition::CResourceMarshaler::CResourceMarshaler((__int64)a1, a2);
  *a1 = &DirectComposition::CTextObjectMarshaler::`vftable';
  return a1;
}
