/*
 * XREFs of NtUserWin32kSysCallFilterStub @ 0x1C014DA20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_ShouldCaptureWerReport@@YAHK@Z @ 0x1C01407B8 (-_ShouldCaptureWerReport@@YAHK@Z.c)
 *     EtwSyscallFilterMessage @ 0x1C016B630 (EtwSyscallFilterMessage.c)
 */
