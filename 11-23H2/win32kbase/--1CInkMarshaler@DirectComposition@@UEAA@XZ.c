/*
 * XREFs of ??1CInkMarshaler@DirectComposition@@UEAA@XZ @ 0x1C021100C
 * Callers:
 *     ??_ECInkMarshaler@DirectComposition@@UEAAPEAXI@Z @ 0x1C020BED0 (--_ECInkMarshaler@DirectComposition@@UEAAPEAXI@Z.c)
 * Callees:
