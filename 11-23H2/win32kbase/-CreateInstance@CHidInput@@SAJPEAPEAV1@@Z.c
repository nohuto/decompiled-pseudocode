/*
 * XREFs of ?CreateInstance@CHidInput@@SAJPEAPEAV1@@Z @ 0x1C0083080
 * Callers:
 *     CHidInput_CreateInstance @ 0x1C0082FD0 (CHidInput_CreateInstance.c)
 * Callees:
  ...
  *a1 = 0LL;
  ...
  if ( *(_DWORD *)gpLeakTrackingAllocator )
  {
    ...
    if ( !NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(gpLeakTrackingAllocator, 0x70694843u) )
      return 3221225495LL;
    Pool2 = (_QWORD *)ExAllocatePool2(v12 & 0xFFFFFFFFFFFFFFFDuLL, 1464LL, v10);
...
LABEL_5:
    ...
    *(_DWORD *)(UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64 + 1344) = 0;
