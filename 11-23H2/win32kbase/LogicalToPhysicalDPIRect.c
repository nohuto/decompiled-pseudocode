/*
 * XREFs of LogicalToPhysicalDPIRect @ 0x1C0059F20
 * Callers:
...
__int64 __fastcall LogicalToPhysicalDPIRect(__int64 a1, _OWORD *a2, unsigned int a3, _QWORD *a4)
{
  ...
  if ( (CurrentThreadDpiAwarenessContext & 0xF) == 2 || !qword_1C0296048 || (int)qword_1C0296048() < 0 )
  {
    result = 0LL;
    *(_OWORD *)a1 = *v6;
  }
  else
  {
    ...
    v8 = qword_1C0296050;
    if ( qword_1C0296050 )
      v8 = (_QWORD *)qword_1C0296050(v6, 2LL, CurrentThreadDpiAwarenessContext);
    if ( a4 )
LABEL_8:
      *a4 = v8;
    v9 = v8[5];
