/*
 * XREFs of ?MulEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEBGKPEAPEAUHSURF__@@KPEAU_GDIINFO@@KPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1C015E660
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?pRenderAdapter@PDEVOBJ@@QEAAPEAXXZ @ 0x1C015EFE8 (-pRenderAdapter@PDEVOBJ@@QEAAPEAXXZ.c)
 *     bIntersect @ 0x1C015F090 (bIntersect.c)
 */
