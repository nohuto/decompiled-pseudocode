/*
 * XREFs of ??0CTransform3DGroupMarshaler@DirectComposition@@QEAA@XZ @ 0x1C020D974
 * Callers:
...
{
  DirectComposition::CNotificationResourceMarshaler::CNotificationResourceMarshaler(this, 188LL);
