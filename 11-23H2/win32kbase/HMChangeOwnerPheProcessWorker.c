/*
 * XREFs of HMChangeOwnerPheProcessWorker @ 0x1C00A1FE8
 * Callers:
 *     ?DestroyProcessesObjects@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C004F640 (-DestroyProcessesObjects@@YAXPEAUtagPROCESSINFO@@@Z.c)
 *     HMChangeOwnerProcess @ 0x1C00A1FC0 (HMChangeOwnerProcess.c)
 *     HMChangeOwnerPheProcess @ 0x1C012C8E0 (HMChangeOwnerPheProcess.c)
 *     HMChangeOwnerProcessWorker @ 0x1C012C900 (HMChangeOwnerProcessWorker.c)
 * Callees:
...
__int64 __fastcall HMChangeOwnerPheProcessWorker(__int64 a1, __int64 a2)
{
  ...
  v5 = (unsigned int)((a1 - (__int64)qword_1C028FE68) >> 5);
  v6 = 3 * v5;
  ...
  *(_QWORD *)(v8 + 16) = 0LL;
  if ( (*((_BYTE *)&unk_1C024292C + 24 * *(unsigned __int8 *)(a1 + 24)) & 4) != 0 )
