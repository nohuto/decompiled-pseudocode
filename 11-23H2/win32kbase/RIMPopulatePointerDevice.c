/*
 * XREFs of RIMPopulatePointerDevice @ 0x1C01825C0
 * Callers:
 ...
 *     RIMCheckPressureUsageStatus @ 0x1C0187000 (RIMCheckPressureUsageStatus.c)
 ...
 *     RIMComputeSpecificHighMetricValue @ 0x1C01B0D2C (RIMComputeSpecificHighMetricValue.c)
