/*
 * XREFs of ?EmitSetSpreadMethodCommand@CGradientLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021A2DC
 * Callers:
...
char __fastcall DirectComposition::CGradientLegacyMilBrushMarshaler::EmitSetSpreadMethodCommand(
