/*
 * XREFs of ?SetPointerInfoNodeDelegateAction@CTouchProcessor@@AEAAXPEBUCPointerInputFrame@@KIHH@Z @ 0x1C01D5C84
 * Callers:
        ...
        int a6)
{
  ...
  if ( this[5] != KeGetCurrentThread() )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15005);
    ...
    switch ( a4 )
    {
      case 585:
        ...
        if ( (v12 & 0x1000000) == 0 || (v12 & 0x2000000) != 0 || (v12 & 0x4000000) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15018);
      ...
      case 593:
        ...
        if ( (v13 & 1) == 0 || (v13 & 2) != 0 || (v13 & 4) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15032);
        *((_DWORD *)v11 + 1) |= 2u;
        break;
      case 594:
        v14 = *((_DWORD *)v9 + 1);
        if ( (v14 & 0x10) == 0 || (v14 & 0x20) != 0 || (v14 & 0x40) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15039);
        *((_DWORD *)v11 + 1) |= 0x20u;
        break;
      default:
        v15 = *(_DWORD *)v9;
        if ( (v15 & 0x100000) == 0 || (v15 & 0x200000) != 0 || (v15 & 0x400000) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15046);
  ...
  if ( a6 )
  {
    switch ( a4 )
    {
      ...
      case 593:
        ...
        if ( *(int *)v9 >= 0 || (*v20 & 1) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15067);
        *v20 |= 1u;
        break;
      case 594:
        v21 = *((_DWORD *)v9 + 1);
        if ( (v21 & 8) == 0 || (v21 & 0x10) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15072);
        *((_DWORD *)v11 + 1) |= 0x10u;
        break;
      default:
        v17 = 0x100000;
    ...
    switch ( a4 )
    {
      case 585:
        ...
        if ( (v22 & 0x1000000) == 0 || (v22 & 0x2000000) != 0 || (v22 & 0x4000000) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15099);
        *(_DWORD *)v11 |= 0x4000000u;
        break;
      case 586:
        v23 = *(_DWORD *)v9;
        if ( (v23 & 0x10000000) == 0 || (v23 & 0x20000000) != 0 || (v23 & 0x40000000) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15106);
        *(_DWORD *)v11 |= 0x40000000u;
        break;
      case 593:
        v24 = *((_DWORD *)v9 + 1);
        if ( (v24 & 1) == 0 || (v24 & 2) != 0 || (v24 & 4) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15113);
        *((_DWORD *)v11 + 1) |= 4u;
        break;
      case 594:
        v25 = *((_DWORD *)v9 + 1);
        if ( (v25 & 0x10) == 0 || (v25 & 0x20) != 0 || (v25 & 0x40) != 0 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 15120);
        *((_DWORD *)v11 + 1) |= 0x40u;
        break;
      default:
        *(_DWORD *)v9 |= 0x400000u;
