/*
 * XREFs of ?RetrieveAndVerifySignature@@YAHPEAU_DEVICE_OBJECT@@PEAU_FILE_OBJECT@@GPEAU_HIDP_VALUE_CAPS@@PEAU_HIDP_CAPS@@PEAU_HIDP_PREPARSED_DATA@@U_HID_COLLECTION_INFORMATION@@GPEAK@Z @ 0x1C01B2394
 * Callers:
 ...
 *     ?CoreSignatureVerify@@YAHGGPEAEPEAK@Z @ 0x1C01B2318 (-CoreSignatureVerify@@YAHGGPEAEPEAK@Z.c)
