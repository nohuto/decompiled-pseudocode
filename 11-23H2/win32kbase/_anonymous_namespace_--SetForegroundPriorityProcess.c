/*
 * XREFs of _anonymous_namespace_::SetForegroundPriorityProcess @ 0x1C0066368
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::SetProcessPriorityByClass @ 0x1C006640C (_anonymous_namespace_--SetProcessPriorityByClass.c)
