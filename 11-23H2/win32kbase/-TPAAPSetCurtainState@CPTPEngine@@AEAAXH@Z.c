/*
 * XREFs of ?TPAAPSetCurtainState@CPTPEngine@@AEAAXH@Z @ 0x1C02043EC
 * Callers:
 ...
 *     ?ProcessInitialization@CPTPEngine@@MEAAJXZ @ 0x1C0202480 (-ProcessInitialization@CPTPEngine@@MEAAJXZ.c)
