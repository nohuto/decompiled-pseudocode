/*
 * XREFs of NtUserInjectMouseInput @ 0x1C0148320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserInjectMouseInput(char *Src, unsigned int a2)
{
  ...
  if ( *(_QWORD *)(v18 + 920) != -1LL )
  {
LABEL_49:
    v28 = RawInputManagerDeviceObjectResolveHandle(*(char **)(v18 + 920), 3u, 1, &Object);
    if ( v28 < 0 )
    {
      if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        || (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) == 0
...
LABEL_100:
  ...
  {
    v26 = RIMIDECreatePseudoMouseOrKeyboardDevice(0, (__int64 *)(v18 + 920));
    if ( v26 < 0 )
    {
      if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        || (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) == 0
