/*
 * XREFs of RIMPopulateExtendedPointerDeviceProperties @ 0x1C019976C
 * Callers:
 *     RIMCreatePointerDeviceInfo @ 0x1C0187030 (RIMCreatePointerDeviceInfo.c)
 * Callees:
 *     RtlUnicodeStringValidateDestWorker @ 0x1C006D630 (RtlUnicodeStringValidateDestWorker.c)
 *     ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C006D6B4 (-RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z.c)
