/*
 * XREFs of PFTOBJ_bUnloadWorkhorseWrap @ 0x1C02327E0
 * Callers:
        ...
        __int64 a4))(_QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  result = qword_1C0294C00;
  if ( qword_1C0294C00 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))qword_1C0294C00(a1, a2, a3, a4);
  return result;
}
