/*
 * XREFs of ?Initialize@LegacyInputDispatcher@@QEAAJD_NIIPEAULegacyDispatcherObject@@@Z @ 0x1C00B4990
 * Callers:
 *     <none>
 * Callees:
        ...
        struct LegacyDispatcherObject *a6)
{
  ...
  {
    v61 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2925LL);
  }
  if ( *((_QWORD *)this + 3) )
  {
    v61 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2926LL);
  }
  if ( *((_QWORD *)this + 4) )
  {
    v61 = 0x20000;
