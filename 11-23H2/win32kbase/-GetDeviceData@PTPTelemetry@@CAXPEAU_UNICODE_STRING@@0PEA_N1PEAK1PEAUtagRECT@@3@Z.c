/*
 * XREFs of ?GetDeviceData@PTPTelemetry@@CAXPEAU_UNICODE_STRING@@0PEA_N1PEAK1PEAUtagRECT@@3@Z @ 0x1C01DEFF8
 * Callers:
        ...
        struct tagRECT *a8)
{
  ...
  *a3 = 0;
  *a4 = 0;
  v11 = *(_QWORD *)(*(_QWORD *)(SGDGetUserSessionState(0LL, a2, a3, a4) + 16840) + 1256LL);
        ...
        switch ( v23 )
        {
          ...
          case 3:
            *a5 = 3;
            break;
          case 0:
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1899);
            break;
        }
        v24 = *(_QWORD *)(v21 + 472);
