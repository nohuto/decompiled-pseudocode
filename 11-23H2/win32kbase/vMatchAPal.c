/*
 * XREFs of vMatchAPal @ 0x1C0158050
 * Callers:
 *     ?vDynamicSwitchPalettes@@YAXPEAVSURFACE@@PEAVPDEV@@1@Z @ 0x1C016C39C (-vDynamicSwitchPalettes@@YAXPEAVSURFACE@@PEAVPDEV@@1@Z.c)
 * Callees:
 *     ?ulTime@XEPALOBJ@@QEAAKXZ @ 0x1C0150C8C (-ulTime@XEPALOBJ@@QEAAKXZ.c)
 *     ?vUpdateTime@XEPALOBJ@@QEAAXXZ @ 0x1C0157FFC (-vUpdateTime@XEPALOBJ@@QEAAXXZ.c)
 */
