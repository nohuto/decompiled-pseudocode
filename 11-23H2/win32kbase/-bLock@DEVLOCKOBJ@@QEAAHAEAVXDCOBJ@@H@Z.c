/*
 * XREFs of ?bLock@DEVLOCKOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C00397F0
 * Callers:
...
__int64 __fastcall DEVLOCKOBJ::bLock(DEVLOCKOBJ *this, DC **a2, int a3)
{
  ...
  *((_QWORD *)this + 13) = v6;
  ...
  {
    if ( !qword_1C0294C78
      || (int)qword_1C0294C78() < 0
      || !qword_1C0294C80
      || (v7 = qword_1C0294C80(a2, (char *)this + 96, (char *)this + 88, (char *)this + 28), v7 != 1) )
    {
      LOBYTE(v7) = 0;
    }
    if ( !(_BYTE)v7 )
  ...
  *((_DWORD *)this + 6) |= 8u;
  ...
  if ( !v14 || (v15 = *v14) == 0 || !*(_DWORD *)(v15 + 104) )
  {
    ...
    if ( !ExIsResourceAcquiredExclusiveLite(v16) && !ExIsResourceAcquiredSharedLite(v16) )
    {
      v17 = *(_QWORD *)(v9 + 120);
      if ( v17 )
        ExEnterPriorityRegionAndAcquireResourceShared(v17);
      v18 = *(_QWORD *)(v9 + 120);
...
LABEL_38:
  ...
  if ( !v27 || (v28 = *v27) == 0 || !*(_DWORD *)(v28 + 104) )
  {
    *((_DWORD *)this + 6) |= 0x1000u;
    ...
    v33 = *(_QWORD *)(v9 + 88);
    if ( v33 )
      ExEnterPriorityRegionAndAcquireResourceShared(v33);
    v34 = *(_QWORD *)(v9 + 88);
...
LABEL_54:
          ...
          *(_QWORD *)(v44 + 312) = (char *)this + 32;
          if ( (*((_DWORD *)*a2 + 9) & 0x4000) == 0 )
          {
            ...
            *((_QWORD *)*a2 + 247) = 0LL;
            v45 = *(_QWORD *)(v9 + 96);
            if ( v45 )
              ExEnterPriorityRegionAndAcquireResourceShared(v45);
            v46 = *(_QWORD *)(v9 + 96);
  ...
  if ( (*((_DWORD *)this + 6) & 0x20000) != 0 )
    return 1LL;
  if ( qword_1C0294710 && (int)qword_1C0294710() >= 0 )
  {
    if ( qword_1C0294718 )
      v59 = qword_1C0294718(this, a2);
    else
      v59 = 0;
    v60 = *((_DWORD *)this + 6);
    if ( v59 )
