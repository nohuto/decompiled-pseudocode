/*
 * XREFs of ivrLoadImage @ 0x1C01EEE44
 * Callers:
...
LABEL_32:
  ...
  if ( v13 >= 0 )
  {
    ...
    if ( *(_DWORD *)Pool2 )
    {
      ...
      Size[0] = 0;
      *((_QWORD *)&xmmword_1C02975C8 + 1) = RtlImageDirectoryEntryToData(v16, 1u, 0, Size);
      v2 = 1;
      *(_QWORD *)&xmmword_1C02975C8 = &v16[RtlImageNtHeader(v16)->OptionalHeader.AddressOfEntryPoint];
      xmmword_1C02975B8 = (unsigned __int64)v16;
    }
  }
LABEL_40:
  NSInstrumentation::CLeakTrackingAllocator::Free(gpLeakTrackingAllocator, (char *)Pool2);
