/*
 * XREFs of DrvFunctionalizeDisplayConfig @ 0x1C0167204
 * Callers:
        ...
        int a6)
{
  ...
  v11 = *a1;
  v27[0] = (struct D3DKMT_GETPATHSMODALITY *)&off_1C0243008;
  *(_OWORD *)v28 = 0LL;
  if ( (v6 & 1) != 0 )
  {
...
LABEL_21:
  ...
  PathModalityForDisplayConfig = DrvSetDisplayConfigValidateParams((unsigned int)v11, a2, a4 != 0 ? 98400 : 32864, 0, 1);
