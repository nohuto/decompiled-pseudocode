...
LABEL_52:
  ...
  if ( (a3 & 2) == 0 )
  {
    ...
    if ( (i[8] & 0x4000) != 0 )
    {
      ...
      if ( (int)IsGreSelectRedirectionBitmapSupported() >= 0 && qword_1C0294E90 )
        qword_1C0294E90(i[1], 0LL);
    }
    v44 = (_QWORD *)v120;
    if ( i[2] != v120
      || (_QWORD *)i[4] != v115
...
LABEL_73:
    ...
    {
      if ( !qword_1C0294E88
        || (int)qword_1C0294E88() < 0
        || qword_1C0294E90 && (unsigned int)qword_1C0294E90(i[1], v117) )
      {
        v47 = v123;
      }
      else
    ...
    if ( !v114 || !qword_1C0294E98 || (int)qword_1C0294E98() < 0 )
    {
LABEL_136:
      if ( (*(_BYTE *)(v44[5] + 26LL) & 0x40) != 0 && (a3 & 0x40000000) == 0 )
        GreSetLayout((HDC)i[1], -1, 1u);
      GreValidateVisrgn((HDC)i[1]);
      if ( qword_1C0294EA8 && (int)qword_1C0294EA8() >= 0 && qword_1C0294EB0 )
        qword_1C0294EB0(i[1], *v44, 0LL, 0LL, 0);
      if ( v46
        && (*(_BYTE *)(v46[5] + 26LL) & 8) != 0
        && qword_1C0294EA8
        && (int)qword_1C0294EA8() >= 0
        && qword_1C0294EB0 )
      {
        qword_1C0294EB0(
          i[1],
