/*
 * XREFs of ?EmitSetRelativeTransformCommand@CLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0219D98
 * Callers:
...
char __fastcall DirectComposition::CLegacyMilBrushMarshaler::EmitSetRelativeTransformCommand(
