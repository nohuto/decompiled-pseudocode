/*
 * XREFs of ?CitpLastInputUpdate@@YAXGI@Z @ 0x1C0010D88
 * Callers:
...
void __fastcall CitpLastInputUpdate(unsigned __int16 a1, unsigned int a2)
{
  ...
  struct _CIT_INTERACTION_SUMMARY *v14; // rbp
  _WORD *v15; // rbx
  __int64 v16; // rax
  ...
  else
  {
    ...
    {
      RtlSetSystemGlobalData(13LL, &v17, 4LL);
      LODWORD(v3) = v17;
    }
  }
  if ( xmmword_1C0293D20 )
  {
    if ( (unsigned int)v3 < *((_DWORD *)&xmmword_1C0293D20 + 2) )
    {
      v3 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
      v17 = v3;
    }
    v5 = xmmword_1C0293D20;
    *((_DWORD *)&xmmword_1C0293D20 + 2) = v3;
    CIT_USER_ACTIVE_TRACKER::OnUserActiveEvent((struct _CIT_IMPACT_CONTEXT *)((char *)xmmword_1C0293D20 + 228), v3);
    if ( !v4 )
      CIT_USER_ACTIVE_TRACKER::OnUserActiveEvent((struct _CIT_IMPACT_CONTEXT *)((char *)v5 + 204), v17);
    v6 = *((_QWORD *)v5 + 15);
    if ( v6 )
    {
      v7 = *(_QWORD *)(v6 + 944);
        ...
        && v11 != v8 )
      {
        ...
        if ( v12 )
        {
          ...
          v15 = (_WORD *)((char *)v13 + 96);
          if ( v17 - *((_DWORD *)v13 + 23) > 0x3E8 )
          {
            *((_DWORD *)v13 + 23) = v17;
            *v15 = 0;
            if ( v14 )
          ...
          if ( v14 && ((unsigned __int16)v2 & *v15) == 0 )
          {
            if ( v2 > 0x200 )
            {
              switch ( v2 )
            ...
            else
            {
              switch ( v2 )
              {
                ...
                case 0x100u:
                  v16 = 58LL;
LABEL_68:
                  CitpStatIncrement((unsigned __int16 *)((char *)v14 + v16), 1u);
                  *v15 |= v2;
                  break;
              }
            }
