/*
 * XREFs of ?AddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@SAJIIIIHII@Z @ 0x1C0008440
 * Callers:
 *     NtDCompositionAddCrossDeviceVisualChild @ 0x1C0008410 (NtDCompositionAddCrossDeviceVisualChild.c)
 * Callees:
