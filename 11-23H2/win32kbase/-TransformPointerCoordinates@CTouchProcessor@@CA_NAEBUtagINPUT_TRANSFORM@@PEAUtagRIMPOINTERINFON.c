/*
 * XREFs of ?TransformPointerCoordinates@CTouchProcessor@@CA_NAEBUtagINPUT_TRANSFORM@@PEAUtagRIMPOINTERINFONODE@@@Z @ 0x1C01D7D78
 * Callers:
        ...
        struct tagRIMPOINTERINFONODE *a2)
{
  ...
  *((_QWORD *)a2 + 8) = v13;
  ...
  if ( (_BYTE)v8 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_AND_TRACE_SF_dddd(WPP_GLOBAL_Control->AttachedDevice, v8, v9, *((_DWORD *)a2 + 12));
  }
  return 1;
}
