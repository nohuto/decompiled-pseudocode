/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0IAAA@$0IA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1C0078230
 * Callers:
...
LABEL_16:
  ...
  if ( v18 )
  {
    v4 = NSInstrumentation::CSectionBitmapAllocator<32768,128>::Allocate(*((__int64 **)v18 + 4));
    if ( v4 )
    {
      v20 = *(_QWORD *)(a1 + 16);
      KeEnterCriticalRegion();
