...
__int64 __fastcall GdiThreadCallout(__int64 a1, int a2)
{
  ...
  v2 = 0;
  if ( qword_1C0294A78 && (int)qword_1C0294A78() >= 0 && qword_1C0294A80 && (unsigned int)qword_1C0294A80() )
  {
    if ( a2 )
    {
      if ( a2 == 1 && qword_1C0294A98 && (int)qword_1C0294A98() >= 0 && qword_1C0294AA0 )
        qword_1C0294AA0();
    }
    else
    {
  ...
  else if ( a2 )
  {
    if ( a2 == 1 )
    {
      ...
      if ( v10 )
        v9 = *v10;
      if ( qword_1C0294DD8 && (int)qword_1C0294DD8() >= 0 && qword_1C0294DE0 )
        qword_1C0294DE0();
      v11 = *(_QWORD *)(v9 + 24);
      if ( v11 )
        HmgFreeDcAttr(v11);
      ...
      if ( v14 )
      {
        *(_QWORD *)(v9 + 288) = 0LL;
        ...
        if ( qword_1C0294E18 )
        {
          if ( (int)qword_1C0294E18() >= 0 && qword_1C0294E20 )
            qword_1C0294E20(v14);
        }
      }
      if ( *(_QWORD *)(v9 + 80) )
