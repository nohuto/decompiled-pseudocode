/*
 * XREFs of ?RimDevicePointerData@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C0173624
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDevicePointerData(const struct RIMDEV *a1)
{
  ...
  if ( *(_DWORD *)(v3 + 156) && v1 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 256LL) )
  {
    v37 = *(_QWORD *)(v3 + 240);
