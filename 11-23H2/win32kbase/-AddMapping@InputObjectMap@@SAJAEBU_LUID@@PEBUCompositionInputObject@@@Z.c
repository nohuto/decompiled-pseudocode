/*
 * XREFs of ?AddMapping@InputObjectMap@@SAJAEBU_LUID@@PEBUCompositionInputObject@@@Z @ 0x1C0231BE4
 * Callers:
 ...
 *     ?AllocateBucket@InputObjectMap@@CAPEAX_KPEAX@Z @ 0x1C0231FD4 (-AllocateBucket@InputObjectMap@@CAPEAX_KPEAX@Z.c)
