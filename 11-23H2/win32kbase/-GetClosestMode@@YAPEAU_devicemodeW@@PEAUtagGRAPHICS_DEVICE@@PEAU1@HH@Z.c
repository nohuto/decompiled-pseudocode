/*
 * XREFs of ?GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z @ 0x1C00BCAE4
 * Callers:
...
LABEL_32:
    ...
    v56 = v7;
    v51 = dword_1C024D3D0[4 * *(unsigned int *)(v23 + 84) + a2->dmDisplayOrientation];
    v27 = *(_DWORD *)(v23 + 172);
    if ( dmPelsWidth < v27 )
      v9 = v27 - dmPelsWidth;
    else
