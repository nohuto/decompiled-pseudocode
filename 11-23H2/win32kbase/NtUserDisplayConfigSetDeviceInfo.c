/*
 * XREFs of NtUserDisplayConfigSetDeviceInfo @ 0x1C0143850
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetSetterTypeSize@DispConfigTypes@@YAKW4DISPLAYCONFIG_DEVICE_INFO_TYPE@@@Z @ 0x1C0140334 (-GetSetterTypeSize@DispConfigTypes@@YAKW4DISPLAYCONFIG_DEVICE_INFO_TYPE@@@Z.c)
...
LABEL_16:
  ...
  if ( v16 || !CheckAccessEx((int *)(*(_QWORD *)v8 + 896LL), v25, 0LL) )
    goto LABEL_51;
  v8 = Src + 1;
