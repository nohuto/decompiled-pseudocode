/*
 * XREFs of McTemplateK0qxttttt_EtwWriteTransfer @ 0x1C013E7CC
 * Callers:
 *     EtwTraceFlipManagerStartCompleteToken @ 0x1C013A820 (EtwTraceFlipManagerStartCompleteToken.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x1C0073658 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x1C00CDBD0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qxttttt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &FlipManagerStartCompleteToken, &W32kControlGuid, 8u, &v11);
}
