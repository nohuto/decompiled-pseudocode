/*
 * XREFs of ?DisplayPath@InputConfig@InputTraceLogging@@SAXAEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z @ 0x1C00C5014
 * Callers:
 ...
 *     ?OrientationToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C01E4054 (-OrientationToString@InputTraceLogging@@CAPEBDK@Z.c)
 *     ?ScalingToString@InputTraceLogging@@CAPEBDW4DISPLAYCONFIG_SCALING@@@Z @ 0x1C01E409C (-ScalingToString@InputTraceLogging@@CAPEBDW4DISPLAYCONFIG_SCALING@@@Z.c)
 */
