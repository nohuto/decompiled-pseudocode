/*
 * XREFs of ?bCleanDC@XDCOBJ@@QEAAHH@Z @ 0x1C00408D0
 * Callers:
...
LABEL_39:
      if ( (_WORD)v18 == 1 )
      {
        v158 = 0LL;
        v159 = 0;
        HANDLELOCK::bLockHobj((HANDLELOCK *)&v158, v15, 0xAu);
        if ( v159 )
        {
          ...
          if ( ((unsigned __int8)v146 & 2) != 0 && qword_1C0294660 )
            qword_1C0294660(v15, 0LL);
          if ( v159 )
            HANDLELOCK::vUnlock((HANDLELOCK *)&v158);
        }
      }
...
LABEL_55:
  ...
  *(_DWORD *)(*((_QWORD *)*this + 122) + 152LL) |= 0x12001Fu;
  ...
  v103 = *((_QWORD *)*this + 6);
  if ( qword_1C0294AA8 && (int)qword_1C0294AA8() >= 0 && qword_1C0294AB0 )
    qword_1C0294AB0(this, *(_DWORD *)(v103 + 40) & 1);
...
LABEL_114:
  ...
  *(_BYTE *)(v137 + 15) |= 4u;
  ...
  if ( v171 )
  {
    if ( (*(_DWORD *)(v171 + 712) & 0x81) != 0 && (int)IsRFONTOBJ_dtorHelperSupported() >= 0 && qword_1C0294BC0 )
      qword_1C0294BC0(&v171);
