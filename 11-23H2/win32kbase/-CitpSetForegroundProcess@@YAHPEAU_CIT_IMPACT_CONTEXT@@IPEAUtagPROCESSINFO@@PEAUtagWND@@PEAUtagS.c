 ...
 *     ?CitpProcessEnsureProgData@@YAPEAU_CIT_PROG_DATA@@PEAUtagPROCESSINFO@@@Z @ 0x1C0233E90 (-CitpProcessEnsureProgData@@YAPEAU_CIT_PROG_DATA@@PEAUtagPROCESSINFO@@@Z.c)
 *     ?CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z @ 0x1C0234390 (-CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z.c)
 */
        ...
        struct tagSHELL_INPUT_USAGE_DATA_INFO *a5)
{
  ...
  {
    v14 = *(struct tagPROCESSINFO ***)(v13 + 944);
    v15 = a2 - *((_DWORD *)a1 + 34);
    v51 = v14;
      ...
      if ( v44 )
      {
        ...
        *((_DWORD *)v44 + 20) = v47;
        ...
        if ( v50 + v15 >= v50 )
          v49 = v50 + v15;
        *((_DWORD *)v45 + 21) = v49;
        CitpProgDataNotifyUseUpdate(xmmword_1C0293D20, v48);
      }
      v14 = v51;
    }
    if ( (*(&xmmword_1C0293D04 + 8) & 1) != 0 )
    {
      ...
      if ( (*(&xmmword_1C0293D04 + 8) & 1) != 0 && a2 - *((_DWORD *)a1 + 72) > *(&xmmword_1C0293D04 + 3) )
