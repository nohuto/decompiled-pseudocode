/*
 * XREFs of ?EmitSetColorInterpolationModeCommand@CGradientLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021721C
 * Callers:
...
char __fastcall DirectComposition::CGradientLegacyMilBrushMarshaler::EmitSetColorInterpolationModeCommand(
