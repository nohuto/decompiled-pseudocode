/*
 * XREFs of ?DrvValidateAndApplyDevMode@@YAJPEAU_DISPLAYCONFIG_CDS_REQUEST@@PEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C016276C
 * Callers:
        ...
        struct D3DKMT_GETPATHSMODALITY **a2)
{
  ...
  if ( v7 == -1073741266 )
  {
    *((_DWORD *)a1 + 13) = 2;
    *((_DWORD *)a1 + 12) = -2;
    WdLogSingleEntry4(3LL, -1073741266LL, *((_QWORD *)a1 + 4), 2LL, -2LL);
    return 3221226030LL;
  }
  else
  {
...
LABEL_22:
      ...
      if ( v16 >= 0 )
      {
        ...
        else
        {
          *((_DWORD *)a1 + 13) = 8;
          *((_DWORD *)a1 + 12) = -1;
          WdLogSingleEntry4(2LL, v24, v34, 8LL, -1LL);
          return v25;
        }
      }
      else
      {
        ...
        *((_DWORD *)a1 + 12) = -2;
        ...
        WdLogSingleEntry4(2LL, v17, *((_QWORD *)a1 + 4), *((int *)a1 + 13), *((int *)a1 + 12));
    ...
    else
    {
      *((_DWORD *)a1 + 13) = 4;
      *((_DWORD *)a1 + 12) = -2;
      WdLogSingleEntry4(2LL, v8, *((_QWORD *)a1 + 4), 4LL, -2LL);
