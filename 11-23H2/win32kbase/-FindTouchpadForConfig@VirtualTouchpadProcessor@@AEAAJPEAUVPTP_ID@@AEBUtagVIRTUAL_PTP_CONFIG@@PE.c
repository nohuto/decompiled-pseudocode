/*
 * XREFs of ?FindTouchpadForConfig@VirtualTouchpadProcessor@@AEAAJPEAUVPTP_ID@@AEBUtagVIRTUAL_PTP_CONFIG@@PEAPEAVVPTPTouchpad@@@Z @ 0x1C01F11F0
 * Callers:
 ...
 *     ??0VPTPTouchpad@@QEAA@PEAU_LIST_ENTRY@@@Z @ 0x1C01F0490 (--0VPTPTouchpad@@QEAA@PEAU_LIST_ENTRY@@@Z.c)
 */
