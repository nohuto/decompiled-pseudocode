/*
 * XREFs of McTemplateK0qqqtq_EtwWriteTransfer @ 0x1C013DEE0
 * Callers:
 *     EtwTraceTouchPadAAP @ 0x1C00DF200 (EtwTraceTouchPadAAP.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x1C0073658 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x1C00CDBD0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qqqtq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  v18 = &a8;
  v19 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &TouchPadAAP, &W32kControlGuid, 6u, &v9);
}
