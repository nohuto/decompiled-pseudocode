...
__int64 __fastcall hbmCreateClone(struct SURFACE *a1, int a2, int a3)
{
                       ...
                       0) )
  {
    ...
    if ( !qword_1C0294680
      || (int)qword_1C0294680() < 0
      || (v10 = SGDGetSessionState(v9), qword_1C0294688)
      && (unsigned int)((__int64 (__fastcall *)(__int64, unsigned __int64, _QWORD, __int64, __int64 *, __int64 *))qword_1C0294688)(
