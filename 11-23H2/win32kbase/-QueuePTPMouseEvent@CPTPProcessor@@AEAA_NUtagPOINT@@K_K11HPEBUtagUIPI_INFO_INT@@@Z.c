/*
 * XREFs of ?QueuePTPMouseEvent@CPTPProcessor@@AEAA_NUtagPOINT@@K_K11HPEBUtagUIPI_INFO_INT@@@Z @ 0x1C01E0374
 * Callers:
        ...
        const struct tagUIPI_INFO_INT *a8)
{
  ...
  if ( *(_DWORD *)this[312].QuadPart < 0x40u )
  {
    PerformanceCounter = KeQueryPerformanceCounter(0LL);
    QuadPart = (int *)this[311].QuadPart;
    v18 = 1;
    this[308] = PerformanceCounter;
    *QuadPart = ((unsigned __int8)*QuadPart + 1) & 0x3F;
    *(_DWORD *)v28 = 0x800000;
    v24 = SGDGetUserSessionState(QuadPart, v21, v22, v23)
        + 3616
        + ((unsigned __int64)*(unsigned int *)this[311].QuadPart << 7);
    *(LARGE_INTEGER *)v24 = this[67];
    *(_QWORD *)(v24 + 40) = a5;
    *(_QWORD *)(v24 + 48) = a6;
    *(_QWORD *)(v24 + 32) = a4;
    *(_OWORD *)(v24 + 56) = *(_OWORD *)&this[304].LowPart;
    *(_OWORD *)(v24 + 72) = *(_OWORD *)&this[306].LowPart;
    *(_OWORD *)(v24 + 88) = *(_OWORD *)&this[308].LowPart;
    v25 = this[310];
    *(_DWORD *)(v24 + 112) = a7;
    ...
    *(_QWORD *)(v24 + 24) = 0LL;
    ...
    if ( (v9 & 1) != 0 )
    {
      ...
      *(_DWORD *)(v24 + 20) = x;
LABEL_16:
      ++*(_DWORD *)this[312].QuadPart;
      goto LABEL_17;
    }
LABEL_6:
    if ( *(_DWORD *)(v24 + 20) || *(_DWORD *)(v24 + 24) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1313);
    goto LABEL_16;
  }
