/*
 * XREFs of ?StartFrame@RIM@TelemetryDebug@InputTraceLogging@@SAX_K@Z @ 0x1C00E16F2
 * Callers:
...
void __fastcall InputTraceLogging::TelemetryDebug::RIM::StartFrame()
{
  ...
  if ( (unsigned int)dword_1C0289810 > 7 && tlgKeywordOn((__int64)&dword_1C0289810, 0x10000LL) )
  {
    ...
    v1 = v0;
    v4 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0289810, (unsigned __int8 *)dword_1C0259452, 0LL, 0LL, 3u, &v2);
  }
}
