/*
 * XREFs of ?bCopy@RGNCOREOBJ@@QEAA_NAEBV1@@Z @ 0x1C016D620
 * Callers:
 ...
 *     ?bIsResizeRequiredBeforeCopyingRegion@RGNCOREOBJ@@QEBA_NAEBV1@PEAK@Z @ 0x1C007DE98 (-bIsResizeRequiredBeforeCopyingRegion@RGNCOREOBJ@@QEBA_NAEBV1@PEAK@Z.c)
