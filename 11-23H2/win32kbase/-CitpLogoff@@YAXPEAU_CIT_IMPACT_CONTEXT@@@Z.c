/*
 * XREFs of ?CitpLogoff@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C00A3B38
 * Callers:
 *     CitUserChange @ 0x1C00A3B00 (CitUserChange.c)
 *     CitModerncoreShutdown @ 0x1C0234BC0 (CitModerncoreShutdown.c)
 * Callees:
