/*
 * XREFs of ?EmitSetStretchCommand@CImageLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021A438
 * Callers:
...
char __fastcall DirectComposition::CImageLegacyMilBrushMarshaler::EmitSetStretchCommand(
