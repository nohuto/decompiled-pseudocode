/*
 * XREFs of ?ButtonState@Mouse@InputTraceLogging@@SAXK@Z @ 0x1C01F536C
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::ButtonState()
{
  ...
  if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 64LL) )
  {
    ...
    v1 = v0;
    v4 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0289810, (unsigned __int8 *)dword_1C025EB86, 0LL, 0LL, 3u, &v2);
  }
}
