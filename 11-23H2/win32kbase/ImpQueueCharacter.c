/*
 * XREFs of ImpQueueCharacter @ 0x1C0235D58
 * Callers:
 *     ImInspectChar @ 0x1C0235970 (ImInspectChar.c)
 * Callees:
...
__int64 __fastcall ImpQueueCharacter(__int64 a1, __int64 a2, __int64 a3, __int16 a4)
{
  int v5; // edi
  ...
  if ( v9 )
  {
    ...
    *(&ImpRequestListHead + 1) = v10;
    ...
    {
      v12 = (unsigned __int8 *)&dword_1C0261ABF;
      v22 = 0;
      v25 = 0;
      v28 = 0;
      v16 = ImpSessionId;
  ...
  else
  {
    ...
    {
      v12 = (unsigned __int8 *)&unk_1C0261AF6;
      v22 = 0;
      v25 = 0;
      v28 = 0;
...
LABEL_11:
      ...
      v21 = 4;
      v27 = 8;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0288780, v12, 0LL, 0LL, 5u, &v19);
    }
  }
  return v11;
}
