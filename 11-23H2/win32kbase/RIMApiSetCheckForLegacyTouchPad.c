/*
 * XREFs of RIMApiSetCheckForLegacyTouchPad @ 0x1C006D074
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( RIMIsRunningOnDesktop((__int64)a1, (__int64)a2, (__int64)a3, a4) )
  {
    ...
    else if ( !v17 )
    {
      if ( !v7 )
        goto LABEL_8;
      if ( !v4 || (unsigned int)IsHIDMouseDeviceRelative(v18, a3) )
      {
...
LABEL_30:
      if ( !IsMouseDeviceOnWhiteList(a1, v9, v4) )
        goto LABEL_8;
