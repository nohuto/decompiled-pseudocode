/*
 * XREFs of ?Win32kPnpNotify@@YAJPEAU_VIDEO_WIN32K_CALLBACKS_PARAMS@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C013352C
 * Callers:
 ...
 *     DrvDisableGraphicsDevices @ 0x1C016654C (DrvDisableGraphicsDevices.c)
  ...
  if ( a1->Param )
  {
    if ( (unsigned int)UserIsWddmConnectedSession() )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(SGDGetSessionState(v18) + 24) + 1340LL) = 0;
      ...
      if ( qword_1C0295A28 )
      {
        v5 = qword_1C0295A28(grpdeskRitInput, &v24);
        if ( v5 >= 0 )
        {
LABEL_34:
          v5 = xxxUserSetDisplayConfig(0, 0LL, 0x88Fu, 6u, (__int64)grpdeskRitInput, 0, 0LL, 0LL, 0LL, (__int64)a2, 0LL);
          if ( (int)IsxxxRestoreCsrssThreadDesktopSupported() >= 0 && qword_1C0295A38 )
            qword_1C0295A38(&v24, 0LL);
        }
      }
      else
      {
