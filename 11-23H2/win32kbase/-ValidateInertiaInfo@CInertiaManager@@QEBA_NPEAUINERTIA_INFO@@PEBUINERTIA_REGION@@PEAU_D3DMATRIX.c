/*
 * XREFs of ?ValidateInertiaInfo@CInertiaManager@@QEBA_NPEAUINERTIA_INFO@@PEBUINERTIA_REGION@@PEAU_D3DMATRIX@@PEAN@Z @ 0x1C01E2250
 * Callers:
 ...
 *     FloatingPointExceptionFilter @ 0x1C01E23F0 (FloatingPointExceptionFilter.c)
 */
