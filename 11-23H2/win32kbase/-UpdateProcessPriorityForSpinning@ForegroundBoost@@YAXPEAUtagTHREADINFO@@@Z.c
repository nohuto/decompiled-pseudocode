...
void __fastcall ForegroundBoost::UpdateProcessPriorityForSpinning(ForegroundBoost *this, struct tagTHREADINFO *a2)
{
  ...
  CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v12, (struct _EX_PUSH_LOCK *)&unk_1C0291DC0);
  v3 = *((_QWORD *)this + 53);
  if ( _bittest((const signed __int32 *)this + 122, 0xAu) )
  {
    ...
    if ( (v4 & 0x800) == 0 )
    {
      *(_DWORD *)(v3 + 12) = v4 | 0x800;
      if ( (*(_DWORD *)(*((_QWORD *)this + 53) + 824LL) & 0x60000) == 0x20000 )
      {
...
LABEL_10:
  ...
  else
  {
    ...
    if ( (v9 & 0x800) != 0 )
    {
      for ( i = *(_QWORD *)(v3 + 328); i; i = *(_QWORD *)(i + 664) )
      {
        if ( _bittest((const signed __int32 *)(i + 488), 0xAu) )
          goto LABEL_11;
      }
      *(_DWORD *)(v3 + 12) = v9 & 0xFFFFF7FF;
      if ( (*(_DWORD *)(*((_QWORD *)this + 53) + 824LL) & 0x60000) == 0x40000 )
      {
        v7 = 1;
