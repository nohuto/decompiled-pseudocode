/*
 * XREFs of ?SendTelemetryOutput@CBasePTPEngine@@IEAAXW4Action@Telemetry@Payload@PTPTelemetryOutput@@TParameters@345@@Z @ 0x1C0203FB4
 * Callers:
 *     ??1CPTPEngine@@UEAA@XZ @ 0x1C01FECF4 (--1CPTPEngine@@UEAA@XZ.c)
 ...
 *     ?ProcessTimer@CPTPEngine@@MEAAJXZ @ 0x1C0202780 (-ProcessTimer@CPTPEngine@@MEAAJXZ.c)
 ...
 *     ?SendTimedMouseClick@CPTPEngine@@AEAAXIUtagPOINT@@HK@Z @ 0x1C0204014 (-SendTimedMouseClick@CPTPEngine@@AEAAXIUtagPOINT@@HK@Z.c)
 *     ?SendWarpbackTelemetry@CBasePTPEngine@@IEAAXW4tagPTP_ACTION@@UtagPOINT@@1K@Z @ 0x1C0204140 (-SendWarpbackTelemetry@CBasePTPEngine@@IEAAXW4tagPTP_ACTION@@UtagPOINT@@1K@Z.c)
 * Callees:
