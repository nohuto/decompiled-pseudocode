/*
 * XREFs of ?Connect@RegistrarClient@CoreMessagingK@@CAJXZ @ 0x1C00B15D8
 * Callers:
 ...
 *     ?InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z @ 0x1C00B17F8 (-InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z.c)
  ...
  *((_QWORD *)&v5 + 1) = 5374032LL;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( v1 >= 0 )
    {
      ...
      WORD2(v14[0]) = 0x8000;
      *(_OWORD *)&v14[5] = xmmword_1C0262118;
      LODWORD(v14[7]) = 1;
      v7 = 64LL;
  ...
  if ( (unsigned int)dword_1C0288500 > 5 )
  {
    ...
    v17 = &v4;
    v18 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0288500, (unsigned __int8 *)dword_1C02610FB, 0LL, 0LL, 3u, &v16);
  }
