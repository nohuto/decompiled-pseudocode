/*
 * XREFs of DrvNeedToSwitchAdapterForRemoteSession @ 0x1C016779C
 * Callers:
 ...
 *     ?DrvIsUsedByRemoteGraphicsDevices@@YAHPEAX@Z @ 0x1C0161778 (-DrvIsUsedByRemoteGraphicsDevices@@YAHPEAX@Z.c)
 */
