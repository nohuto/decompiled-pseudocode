/*
 * XREFs of ?UpdateStateIndicator@CTouchProcessor@@QEAAXPEAUCInputPointerNode@@I_KUtagPOINT@@@Z @ 0x1C01DA284
 * Callers:
...
LABEL_54:
  ...
  else if ( (v6 & 0x40004) != 0 )
  {
    ...
    if ( (_BYTE)a2 || v9 )
    {
      v12 = &WPP_2c5ea56a6e6f31fa38ff36b2483c7d67_Traceguids;
      v14 = 64;
      goto LABEL_54;
    }
  }
