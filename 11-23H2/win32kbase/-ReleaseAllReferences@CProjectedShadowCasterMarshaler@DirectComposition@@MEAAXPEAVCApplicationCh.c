 ...
 * Callers:
 *     ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCProjectedShadowCasterMarshaler@DirectComposition@@$01@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C020E370 (-ReleaseAllReferences@-$CSharedResourceMarshaler@VCProjectedShadowCasterMarshaler@DirectComposit.c)
 * Callees:
