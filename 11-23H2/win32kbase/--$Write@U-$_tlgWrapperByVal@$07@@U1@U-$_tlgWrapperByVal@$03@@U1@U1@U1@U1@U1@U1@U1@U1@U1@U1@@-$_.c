/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U1@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U1@U1@U1@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@3AEBU?$_tlgWrapperByVal@$03@@3333333333@Z @ 0x1C01FE93C
 * Callers:
        ...
        __int64 a17)
{
  ...
  v22 = 8LL;
  v20 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C02882F8, a2, 0LL, 0LL, 0xFu, &v18);
}
