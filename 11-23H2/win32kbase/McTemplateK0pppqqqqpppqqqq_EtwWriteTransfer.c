/*
 * XREFs of McTemplateK0pppqqqqpppqqqq_EtwWriteTransfer @ 0x1C013CB88
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x1C00BE5A0 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1C016BA50 (EtwWindowRendering.c)
 * Callees:
