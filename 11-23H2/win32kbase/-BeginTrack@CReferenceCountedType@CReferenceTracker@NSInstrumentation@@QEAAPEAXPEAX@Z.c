/*
 * XREFs of ?BeginTrack@CReferenceCountedType@CReferenceTracker@NSInstrumentation@@QEAAPEAXPEAX@Z @ 0x1C016EABC
 * Callers:
 ...
 * Callees:
 *     ?Create@CPlatformSignal@NSInstrumentation@@SAPEAV12@XZ @ 0x1C016D6E0 (-Create@CPlatformSignal@NSInstrumentation@@SAPEAV12@XZ.c)
