/*
 * XREFs of NtDCompositionCommitChannel @ 0x1C00271A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ResolveHandle@SynchronizationObject@DirectComposition@@KAJPEAXKDPEAPEAU12@@Z @ 0x1C020AED4 (-ResolveHandle@SynchronizationObject@DirectComposition@@KAJPEAXKDPEAPEAU12@@Z.c)
        ...
        unsigned int a8)
{
  ...
  if ( a3 )
  {
    if ( a6 || Src || a8 )
    {
      CurrentProcess = PsGetCurrentProcess(a1, 0LL, a3);
