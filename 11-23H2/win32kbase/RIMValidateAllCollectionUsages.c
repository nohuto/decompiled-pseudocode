/*
 * XREFs of RIMValidateAllCollectionUsages @ 0x1C018C4C8
 * Callers:
 *     RIMIsParallelDevice @ 0x1C018AF20 (RIMIsParallelDevice.c)
 * Callees:
 *     ?Free@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAX@Z @ 0x1C008C460 (-Free@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAX@Z.c)
 *     MicrosoftTelemetryAssertTriggeredArgsKM @ 0x1C00D6660 (MicrosoftTelemetryAssertTriggeredArgsKM.c)
 *     RIMIsButtonCapsEqual @ 0x1C018AA04 (RIMIsButtonCapsEqual.c)
 *     RIMIsValueCapsEqual @ 0x1C018B220 (RIMIsValueCapsEqual.c)
