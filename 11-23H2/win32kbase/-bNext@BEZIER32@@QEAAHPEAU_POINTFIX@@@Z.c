/*
 * XREFs of ?bNext@BEZIER32@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C015D4D0
 * Callers:
 *     ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C015DD30 (-pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z.c)
 * Callees:
 *     ?lParentErrorDividedBy4@HFDBASIS32@@QEBAJXZ @ 0x1C015DC3C (-lParentErrorDividedBy4@HFDBASIS32@@QEBAJXZ.c)
 */
