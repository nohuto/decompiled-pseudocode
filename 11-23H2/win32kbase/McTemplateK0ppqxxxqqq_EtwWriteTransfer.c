/*
 * XREFs of McTemplateK0ppqxxxqqq_EtwWriteTransfer @ 0x1C00DF920
 * Callers:
 *     EtwTraceTokenCompositionSurfaceObjectEvent @ 0x1C000CA30 (EtwTraceTokenCompositionSurfaceObjectEvent.c)
 * Callees:
