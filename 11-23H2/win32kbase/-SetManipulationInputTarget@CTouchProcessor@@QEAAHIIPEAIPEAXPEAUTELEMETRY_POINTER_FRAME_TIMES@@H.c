/*
 * XREFs of ?SetManipulationInputTarget@CTouchProcessor@@QEAAHIIPEAIPEAXPEAUTELEMETRY_POINTER_FRAME_TIMES@@H@Z @ 0x1C01D354C
 * Callers:
        ...
        int a7)
{
  ...
  if ( a7 && a5 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3204);
  ...
  *(_OWORD *)(v14 + 200) = *((_OWORD *)a6 + 8);
  if ( !(unsigned int)CTouchProcessor::IsFrameReferenced(v12, v14) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3210);
  if ( !*(_QWORD *)(v14 + 256) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3211);
  ...
  do
  {
      ...
      && (v25 = 0, v70) )
    {
      ...
      if ( NodeById )
      {
        ...
        {
          if ( v36 != 1 )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3320);
          if ( !CInputDest::IsCompositionInput((CInputDest *)&v80) )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3321);
          if ( (*(_DWORD *)v23 & 0x400) == 0 )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3322);
          if ( (*(_DWORD *)v23 & 0x100) == 0 )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3323);
          if ( *(_DWORD *)(v23 + 144) != 1 )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3324);
          *(_DWORD *)(v23 + 4) |= 0x80u;
          v37 = *(_QWORD *)(v23 + 248);
          v74[0] = v80;
          v74[2] = v82;
        ...
        else if ( v36 == 2 )
        {
          if ( (*(_DWORD *)(v23 + 4) & 0x80u) != 0 )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3337);
          if ( (_DWORD)v80 )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3338);
      ...
      if ( (_DWORD)v80 )
      {
        ...
        *(_DWORD *)(v23 + 4) |= 0x200u;
        ...
        if ( v72 )
        {
          if ( *(_DWORD *)(v23 + 8) != *(_DWORD *)v72 )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3473);
          if ( !*((_DWORD *)v47 + 34) )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3474);
        ...
        *(_QWORD *)(v23 + 192) = CInputDest::GetWindowHandle((CInputDest *)&v80);
        ...
        if ( *(_DWORD *)v46 == -1 )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3507);
      }
      else
      {
        v38 = *v31;
          ...
          if ( CPointerInfoNode::IsForManipulationThread(v28) && (*(_DWORD *)(v29 + 4) & 0x200) != 0 )
          {
            ...
            if ( *(_QWORD *)(v30 + 8) != -1LL && (*(_DWORD *)(v30 + 140) & 0x10) == 0 )
            {
              ...
              if ( (*(_DWORD *)(v30 + 140) & 0x10) == 0 )
                MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3535);
            }
          }
        }
        ++v27;
