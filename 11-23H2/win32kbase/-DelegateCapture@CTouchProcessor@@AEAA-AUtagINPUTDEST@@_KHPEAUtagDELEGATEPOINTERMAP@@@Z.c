/*
 * XREFs of ?DelegateCapture@CTouchProcessor@@AEAA?AUtagINPUTDEST@@_KHPEAUtagDELEGATEPOINTERMAP@@@Z @ 0x1C01C0744
 * Callers:
        ...
        __int64 a5)
{
  ...
  {
    v26 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11054);
  }
  ...
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 11062);
    v10 = v27[1];
    *a2 = v27[0];
    v11 = v27[2];
    a2[1] = v10;
