 ...
 * 00000001C00C180E: jnz     loc_1C0128FB2
 ...
 * 00000001C0128FB2: mov     rax, [rbx+10h]
 * 00000001C0128FB6: mov     cs:?gpSharedUserCritDeferredUnlockListHead@@3PEAUtagKERNELHANDLETABLEENTRY@@EA, rax; tagKERNELHANDLETABLEENTRY * gpSharedUserCritDeferredUnlockListHead
 * 00000001C0128FBD: mov     rax, [rbx]
 * 00000001C0128FC0: mov     [rbx+10h], rsi
 * 00000001C0128FC4: cmp     [rax+8], edi
 * 00000001C0128FC7: jnb     short loc_1C0128FE7
 * 00000001C0128FC9: mov     [rsp+28h+arg_8], 20000h
 * 00000001C0128FD1: lea     rcx, aIxptelassert; "IXPTelAssert"
 * 00000001C0128FD8: mov     edx, [rsp+28h+arg_8]
 * 00000001C0128FDC: mov     r8d, 108Dh
 * 00000001C0128FE2: call    MicrosoftTelemetryAssertTriggeredArgsKM
 * 00000001C0128FE7: mov     rcx, [rbx]
 * 00000001C0128FEA: call    HMUnlockObject
 * 00000001C0128FEF: nop
 * 00000001C0128FF0: jmp     loc_1C00C1804
 */
