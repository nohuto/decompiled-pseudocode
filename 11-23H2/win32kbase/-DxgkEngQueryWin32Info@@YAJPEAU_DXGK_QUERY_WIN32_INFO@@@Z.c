/*
 * XREFs of ?DxgkEngQueryWin32Info@@YAJPEAU_DXGK_QUERY_WIN32_INFO@@@Z @ 0x1C001D7F0
 * Callers:
 ...
 * Callees:
 *     UserIsTtmEnabled @ 0x1C00C4DB0 (UserIsTtmEnabled.c)
...
__int64 __fastcall DxgkEngQueryWin32Info(struct _DXGK_QUERY_WIN32_INFO *a1)
{
  ...
  if ( !qword_1C02945C0 )
    return 3221225659LL;
  result = qword_1C02945C0();
  if ( (int)result >= 0 )
  {
    if ( qword_1C02945C8 )
      return qword_1C02945C8(a1);
    return 3221225659LL;
  }
  return result;
}
