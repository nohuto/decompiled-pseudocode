/*
 * XREFs of rimObsDeliverToNonExclusiveObservers @ 0x1C0005B48
 * Callers:
 ...
 *     rimObsIsObserverTarget_0 @ 0x1C01AC8A0 (rimObsIsObserverTarget_0.c)
    ...
    do
    {
      ...
      if ( (unsigned int)rimObsIsObserverTarget_0(v15 - 2, a1) )
      {
        if ( (unsigned int)rimObsIsRegisteredObserverAllowed() )
        {
          ...
          if ( v30[4] != PsGetCurrentProcess(v37, v31, v33) )
          {
            if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
              || (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) == 0
