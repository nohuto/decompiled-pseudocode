/*
 * XREFs of GreAcquireHmgrSemaphore @ 0x1C0042870
 * Callers:
 ...
 *     EngDeleteSafeSemaphore @ 0x1C0169EA0 (EngDeleteSafeSemaphore.c)
...
__int64 __fastcall GreAcquireHmgrSemaphore(__int64 a1)
{
  ...
  if ( *(_DWORD *)(v8 + 180) )
  {
    if ( (Microsoft_Windows_Win32kEnableBits & 0x10) != 0 )
      return McTemplateK0pqz_EtwWriteTransfer(v8, v6, v7, v4, 17, (__int64)L"GreBaseGlobals.hsemHmgr");
  }
  return result;
}
