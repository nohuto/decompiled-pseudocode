/*
 * XREFs of ?RtlStringCchCopyUnicodeStringEx@@YAJPEAG_KPEBU_UNICODE_STRING@@PEAPEAGPEA_KK@Z @ 0x1C016481C
 * Callers:
 *     LogDiagSDCAccessDenied @ 0x1C0168814 (LogDiagSDCAccessDenied.c)
 * Callees:
 *     RtlStringCopyWideCharArrayWorker @ 0x1C0164898 (RtlStringCopyWideCharArrayWorker.c)
 *     RtlUnicodeStringValidateSrcWorker_0 @ 0x1C016490C (RtlUnicodeStringValidateSrcWorker_0.c)
 */
