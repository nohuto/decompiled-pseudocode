/*
 * XREFs of RIMSyncWalkRimObjList @ 0x1C00711B0
 * Callers:
...
void __fastcall RIMSyncWalkRimObjList(__int64 a1, __int64 a2, void (__fastcall *a3)(_QWORD *, __int64), __int64 a4)
{
  ...
  __int64 v7; // r8
  __int64 v8; // r9
  _QWORD *UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64; // rbx
      ...
      switch ( v27 )
      {
        ...
        case 1:
          if ( NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(gpLeakTrackingAllocator, 0x706D7452u)
            && v26 + 16 >= v26 )
          {
            v41 = (_QWORD *)ExAllocatePool2(v46 & 0xFFFFFFFFFFFFFFFDuLL, v26 + 16, v51);
            Pool2 = (__int64)v41;
            UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64 = v41;
            if ( !v41
              || (_InterlockedIncrement64((volatile signed __int64 *)v25 + 14),
                  UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64 = v41 + 2,
                  *v41 = 1886221394LL,
                  Pool2 = (__int64)(v41 + 2),
                  v41 == (_QWORD *)-16LL) )
            {
        ...
        case 2:
          ...
          if ( !NSInstrumentation::CLeakTrackingAllocator::IsTagTracked(gpLeakTrackingAllocator, 0x706D7452u, v45) )
          {
            ...
            UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64 = (_QWORD *)NSInstrumentation::CLeakTrackingAllocator::MakeUntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64___((__int64)v25, (__int64)v45, &v47);
...
LABEL_11:
                      ...
                      i = SGDGetUserSessionState(v22, v21, v23, v24) )
                {
                  ...
                  {
                    v35 = v10++;
                    UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64[v35] = v34;
                  }
                  v28 = (_QWORD *)*v28;
                }
                goto LABEL_18;
...
LABEL_18:
  ...
  *(_QWORD *)(v36 + 248) = 0LL;
  ...
  if ( v10 )
  {
    v37 = (_QWORD **)UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64;
    v38 = v10;
    do
    {
      v39 = *v37;
