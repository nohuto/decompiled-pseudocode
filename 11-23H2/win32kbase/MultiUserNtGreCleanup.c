  ...
  if ( Gre::Base::IsSessionGlobalsAreaAllocated(a1) )
  {
    ...
    if ( *(_BYTE *)v3 )
    {
      *(_DWORD *)(v3 + 3192) = 1;
      ...
      if ( qword_1C0294840 && (int)qword_1C0294840() >= 0 && qword_1C0294848 )
        qword_1C0294848();
      if ( *(_QWORD *)(v3 + 8008) )
        GrepCloseCurrentProcess();
      if ( qword_1C0294850 && (int)qword_1C0294850() >= 0 )
      {
        v4 = qword_1C0294858 ? (char **)qword_1C0294858() : 0LL;
        if ( *v4 )
        {
      ...
      {
        v5 = qword_1C0294868 ? (char **)qword_1C0294868() : 0LL;
        if ( *v5 )
        {
      ...
      {
        v6 = qword_1C0294878 ? (char **)qword_1C0294878() : 0LL;
        if ( *v6 )
        {
      ...
      if ( qword_1C0294890 && (int)qword_1C0294890() >= 0 && qword_1C0294898 )
        qword_1C0294898();
      ...
      if ( qword_1C02948A0 && (int)qword_1C02948A0() >= 0 )
      {
        v16 = qword_1C02948A8 ? (char **)qword_1C02948A8() : 0LL;
        if ( *v16 )
        {
      ...
      {
        v18 = qword_1C02948B8 ? (struct PDEV **)qword_1C02948B8() : 0LL;
        if ( *v18 )
        {
          PDEV::Free(*v18, 0);
          *v18 = 0LL;
      ...
      {
        v19 = qword_1C02948C8 ? (struct PDEV **)qword_1C02948C8() : 0LL;
        if ( *v19 )
        {
          PDEV::Free(*v19, 0);
          *v19 = 0LL;
      ...
      if ( qword_1C02948E0 && (int)qword_1C02948E0() >= 0 && qword_1C02948E8 )
        qword_1C02948E8();
      ...
      *(_QWORD *)(v3 + 144) = 0LL;
      ...
      if ( qword_1C02948F0 && (int)qword_1C02948F0() >= 0 && qword_1C02948F8 )
        qword_1C02948F8();
      if ( qword_1C0294760 && (int)qword_1C0294760() >= 0 && qword_1C0294768 )
        qword_1C0294768();
      if ( qword_1C0294F08 && (int)qword_1C0294F08() >= 0 && qword_1C0294F10 )
        qword_1C0294F10();
    }
