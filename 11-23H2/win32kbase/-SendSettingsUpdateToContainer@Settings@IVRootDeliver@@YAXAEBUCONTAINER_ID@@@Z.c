/*
 * XREFs of ?SendSettingsUpdateToContainer@Settings@IVRootDeliver@@YAXAEBUCONTAINER_ID@@@Z @ 0x1C01E9884
 * Callers:
 ...
 *     PackTouchpadSettings @ 0x1C01E9608 (PackTouchpadSettings.c)
