/*
 * XREFs of ?DwmInputThread@CInputManager@@IEAAJPEAX0H@Z @ 0x1C0230C84
 * Callers:
 ...
 *     ?ValidateUserEvent@CInputManager@@CAJPEAXPEAPEAX@Z @ 0x1C02312E8 (-ValidateUserEvent@CInputManager@@CAJPEAXPEAPEAX@Z.c)
 */
