/*
 * XREFs of ?SetupQFramePostMT@CTouchProcessor@@QEAAPEAUCPointerQFrame@@PEAUCPointerInputFrame@@PEAPEAU2@_KVCInputDest@@H@Z @ 0x1C01D6F38
 * Callers:
...
LABEL_30:
  ...
  *(_QWORD *)(i + 8) = a4;
  ...
  if ( *(_DWORD *)(i + 144) != 22 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3657);
