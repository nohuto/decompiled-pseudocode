 ...
 *     ?Remove@CPointerHashTable@NSInstrumentation@@QEAA_NPEBXPEAPEAX@Z @ 0x1C016F6F4 (-Remove@CPointerHashTable@NSInstrumentation@@QEAA_NPEBXPEAPEAX@Z.c)
 *     ?Remove@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAA_NQEBVCBackTraceStorageUnit@2@@Z @ 0x1C017009C (-Remove@-$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBa.c)
...
LABEL_137:
  ...
  if ( qword_1C0294C88 && (int)qword_1C0294C88() >= 0 && qword_1C0294C90 )
    qword_1C0294C90(v3);
    ...
    else
    {
      ...
      if ( (v118 & 0x40000) != 0 )
      {
        if ( (unsigned int)PDEVOBJ::bAllowDDICall((PDEVOBJ *)&v283)
          ...
          && qword_1C0294CA0 )
        {
          qword_1C0294CA0(*(_QWORD *)(v18 + 1768), v224);
        }
        goto LABEL_144;
      }
    }
...
LABEL_324:
      ...
      else
      {
        if ( !(_DWORD)v296 )
        {
          if ( (int)IsUMPDEngFreeUserMemSupported() >= 0 && qword_1C0294CB0 )
            qword_1C0294CB0(BaseAddress);
          v119 = 0LL;
          goto LABEL_468;
        }
        v247 = HIDWORD(v295);
...
LABEL_163:
  ...
  v125 = v293;
  if ( v293 && (int)IsGreDeleteWndSupported() >= 0 && qword_1C0294CC0 )
    qword_1C0294CC0(v125);
  if ( !v8 )
    goto LABEL_196;
...
LABEL_196:
  ...
  if ( qword_1C0294730 && (int)qword_1C0294730() >= 0 && qword_1C0294738 )
    qword_1C0294738(&v309, &v308, &v307, v305);
  DLODCOBJ::~DLODCOBJ((DLODCOBJ *)v306);
  v156 = v301;
  if ( v301 )
  {
