  ...
  if ( *(_QWORD *)(v1 + 3216) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v3 )
      {
        ...
        else if ( qword_1C0294900 && (int)qword_1C0294900() >= 0 )
        {
          if ( qword_1C0294908 )
            qword_1C0294908(v8 + 4);
        }
      }
      else
      {
  ...
  if ( *(_QWORD *)(v1 + 3240) )
  {
    ...
    while ( *(_QWORD *)v6 != v6 )
    {
      *(_DWORD *)(*(_QWORD *)v6 + 16LL) = 1;
      if ( qword_1C0294910 && (int)qword_1C0294910() >= 0 && qword_1C0294918 )
        qword_1C0294918(*(_QWORD *)v6 + 24LL);
    }
  }
