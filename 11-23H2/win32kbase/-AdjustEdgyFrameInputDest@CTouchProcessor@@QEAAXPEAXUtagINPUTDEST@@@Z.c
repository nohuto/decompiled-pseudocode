/*
 * XREFs of ?AdjustEdgyFrameInputDest@CTouchProcessor@@QEAAXPEAXUtagINPUTDEST@@@Z @ 0x1C01BA470
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagINPUTDEST *a3)
{
  ...
  if ( !LODWORD(v12[0]) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 13059);
