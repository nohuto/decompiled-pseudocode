/*
 * XREFs of ?EmitUpdateCommands@CAtlasedRectsMeshMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021B370
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EmitSetIsHitTestVisibleCommand@CAtlasedRectsMeshMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0218014 (-EmitSetIsHitTestVisibleCommand@CAtlasedRectsMeshMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatc.c)
 *     ?EmitSetOpacityCommand@CAtlasedRectsMeshMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021949C (-EmitSetOpacityCommand@CAtlasedRectsMeshMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z.c)
 */
