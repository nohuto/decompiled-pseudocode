/*
 * XREFs of ?DxgkEngBltViaGDIApiExt@@YAHPEBU_D3DKMT_PRESENT@@PEAUHDC__@@PEBUtagRECT@@2QEAXIIIEEIP6AX22PEAU3@2II@ZP6AH4422@Z@Z @ 0x1C0168B40
 * Callers:
 *     <none>
 * Callees:
        ...
        int (*a13)(struct tagRECT *, struct tagRECT *, const struct tagRECT *, const struct tagRECT *))
{
  ...
  v16 = (int)a2;
  v17 = (int)a1;
  if ( qword_1C0294500 && (int)qword_1C0294500() >= 0 )
