/*
 * XREFs of ?CitpProcessGetProgramId@@YAJPEAUtagPROCESSINFO@@PEAU_CIT_PROGRAM_ID@@@Z @ 0x1C00A45A0
 * Callers:
 ...
 *     ?CitpProgramIdCalculateHash@@YA_KPEBU_CIT_PROGRAM_ID@@@Z @ 0x1C00A4980 (-CitpProgramIdCalculateHash@@YA_KPEBU_CIT_PROGRAM_ID@@@Z.c)
 *     ?CitpStringDuplicate@@YAJPEAPEAGPEBG_K@Z @ 0x1C00A4B34 (-CitpStringDuplicate@@YAJPEAPEAGPEBG_K@Z.c)
 *     __security_check_cookie @ 0x1C00CDBD0 (__security_check_cookie.c)
 *     _wcsupr @ 0x1C00CE690 (_wcsupr.c)
...
__int64 __fastcall CitpProcessGetProgramId(PRKPROCESS *a1, struct _CIT_PROGRAM_ID *a2)
{
  ...
  if ( BaseAddress )
  {
    ...
    if ( v18 < 0 )
    {
      CitpLogFailureWorker(v18, v12, 0x6F3u);
      goto LABEL_7;
    }
    v36 = 1231254357;
    v44 = 260LL;
...
LABEL_80:
  ...
  v13 = -1073741637;
  CitpLogFailureWorker(-1073741637, v7, 0x6BEu);
LABEL_16:
  if ( v6 )
