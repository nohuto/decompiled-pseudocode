...
LABEL_32:
  ...
  qword_1C02936D8 = (__int64)&gtmrListHead;
  gtmrListHead = (__int64)&gtmrListHead;
  qword_1C02936C8 = (__int64)&gtmrAdjustmentListHead;
  ...
  qword_1C02922D0 = (__int64)&gPendingNotifiesList;
  ...
  if ( qword_1C0294F78 )
    qword_1C0294F78(Win32KDriverUnload);
  ...
  UserSessionSwitchLeaveCrit(v87, v86, v88, v89);
  if ( !*(_DWORD *)SGDGetUserSessionState(v91, v90, v92, v93) && qword_1C0294F68 )
    qword_1C0294F68();
