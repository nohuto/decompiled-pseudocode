/*
 * XREFs of GreGetDpiDepDefaultGuiFont @ 0x1C015F510
 * Callers:
 ...
 *     GetDpiDepStockObjectPlateauSlot @ 0x1C015F49C (GetDpiDepStockObjectPlateauSlot.c)
 */
...
LABEL_11:
  ...
  if ( !*(_QWORD *)(v2[398] + 8LL * DpiDepStockObjectPlateauSlot) && qword_1C0294668 )
    qword_1C0294668(v3);
