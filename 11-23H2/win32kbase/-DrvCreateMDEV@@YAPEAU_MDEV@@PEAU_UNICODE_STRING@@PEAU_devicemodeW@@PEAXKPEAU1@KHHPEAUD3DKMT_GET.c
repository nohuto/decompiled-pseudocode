 ...
 *     ?MapMonitorToUnifromSpaceInStripe@@YAXPEAU_MDEV@@KKHK@Z @ 0x1C0163B9C (-MapMonitorToUnifromSpaceInStripe@@YAXPEAU_MDEV@@KKHK@Z.c)
    ...
    *(_DWORD *)(*(_QWORD *)&v63 + 1288LL) = 0;
    if ( ((gProtocolType + 1) & 0xFFFE) == 0 )
    {
      ...
      if ( (int)IsGetWin8StyleDpiSettingFromRegistrySupported() >= 0 )
      {
        ...
        {
          if ( (int)IsGetDpiSettingWithNoDefaultSupported() >= 0 && qword_1C02947E8 )
            qword_1C02947E8(0LL, &v243);
          v173 = v243;
          v207 = (HDEV)v65;
          if ( v243 <= 0x60 )
            v173 = 96;
