/*
 * XREFs of ?FreeToPagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAX0@Z @ 0x1C00946EC
 * Callers:
 ...
 *     NullifyLookasideRef @ 0x1C012D330 (NullifyLookasideRef.c)
