/*
 * XREFs of ?PrepareFallbackKeyboardFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@@Z @ 0x1C01E4434
 * Callers:
...
LABEL_19:
            ...
            *(_OWORD *)(Pool2 + 16) = unk_1C02BD040;
            *(_OWORD *)(Pool2 + 32) = *(_OWORD *)&off_1C02BD050;
            *(_OWORD *)(Pool2 + 48) = *(_OWORD *)&off_1C02BD060;
            *(_OWORD *)(Pool2 + 64) = *(_OWORD *)&off_1C02BD070;
            *(_OWORD *)(Pool2 + 80) = xmmword_1C02BD080;
            *(_QWORD *)(Pool2 + 96) = qword_1C02BD090;
            goto LABEL_22;
          }
        }
