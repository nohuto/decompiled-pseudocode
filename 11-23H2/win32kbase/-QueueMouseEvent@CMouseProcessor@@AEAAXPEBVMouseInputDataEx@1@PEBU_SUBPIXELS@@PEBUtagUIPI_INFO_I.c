/*
 * XREFs of ?QueueMouseEvent@CMouseProcessor@@AEAAXPEBVMouseInputDataEx@1@PEBU_SUBPIXELS@@PEBUtagUIPI_INFO_INT@@PEBUtagPOINT@@@Z @ 0x1C0054818
 * Callers:
        ...
        const struct tagPOINT *a5)
{
  ...
  if ( a4 )
  {
    ...
    {
      v26 = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 3153LL);
    }
    v21 = *((_DWORD *)a4 + 2);
    v33 = *(_QWORD *)a4;
    v34 = v21;
...
LABEL_9:
  ...
  if ( v12 )
  {
    ...
    {
      v26 = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 3182LL);
    }
...
LABEL_20:
    ...
    *((_DWORD *)v16 + 28) = CMouseProcessor::MouseInputDataEx::ComputeRawMouseProcessingOptions(a2);
    if ( v25 )
    {
      ...
      {
        v26 = 0x20000;
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 3252LL);
      }
      *(_QWORD *)&v32 = v33;
      DWORD2(v32) = v34;
      BYTE12(v32) = 1;
    ...
    *((_QWORD *)v30 + 1) = 0LL;
    ...
    if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 64LL) )
    {
      ...
      *(_QWORD *)&v32 = *((_QWORD *)v16 + 11);
      ...
      v39 = 4LL;
      v37 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0289810, (int)&dword_1C025F2A3, 0, 0, 7u, &v35);
    }
    if ( v29 )
    {
