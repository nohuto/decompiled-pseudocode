/*
 * XREFs of _anonymous_namespace_::GetRawMouseInputDestination @ 0x1C01F78C4
 * Callers:
...
_OWORD *__fastcall anonymous_namespace_::GetRawMouseInputDestination(_OWORD *a1)
{
  ...
  if ( PtiFromInputDest && qword_1C0295490 && (unsigned int)qword_1C0295490(PtiFromInputDest) )
  {
    v3 = INPUTDEST_FROM_PWND(v11, *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(PtiFromInputDest + 424) + 856LL) + 64LL));
    v4 = v3[1];
    *a1 = *v3;
    v5 = v3[2];
    a1[1] = v4;
