/*
 * XREFs of ?CleanupManipulationThreadData@CTouchProcessor@@QEAAXXZ @ 0x1C00B9450
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CTouchProcessor::CleanupManipulationThreadData(CTouchProcessor *this)
{
  ...
  do
  {
    ...
    if ( v3 == 8 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 8141LL);
        ...
        && (*(_DWORD *)(v17 + 4) & 0x200) == 0 )
      {
        ...
        if ( (_BYTE)v2 )
        {
          ...
          if ( NodeById )
          {
            ...
            {
              v33[2] = 0x20000;
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 13205LL);
            }
          }
...
LABEL_83:
              v33[3] = 0x20000;
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 13275LL);
            }
            v48 = 0LL;
            v46 = 0LL;
            v44 = 0LL;
            ...
            if ( qword_1C0295450 )
            {
              ...
              if ( qword_1C0295450 )
              {
                qword_1C0295450(v12, &v45, Win32FreePool);
                if ( qword_1C0295450 )
                  qword_1C0295450(v34, &v43, CTouchProcessor::DereferencePointerInputFrame);
              }
            }
        ...
        {
          v33[4] = 0x20000;
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 13304LL);
        }
      }
