/*
 * XREFs of pProcessDfbSurfaces2 @ 0x1C015AA90
 * Callers:
 *     bDynamicProcessAllDriverRealizations @ 0x1C0035B30 (bDynamicProcessAllDriverRealizations.c)
 *     pProcessDfbSurfaces @ 0x1C015AA60 (pProcessDfbSurfaces.c)
 * Callees:
...
__int64 __fastcall pProcessDfbSurfaces2(struct OBJECT *a1, __int64 a2, int a3, int a4, __int64 a5)
{
  ...
  v8 = 0LL;
  if ( a3 && (!qword_1C0294458 || !(unsigned int)qword_1C0294458()) )
    goto LABEL_16;
  if ( (*((_DWORD *)a1 + 29) & 1) == 0 )
    goto LABEL_15;
  v9 = *((_QWORD *)a1 + 6);
    ...
    && _bittest((const signed __int32 *)(a5 + 2096), 0x10u) )
  {
    ...
    {
      if ( qword_1C02946E0 && (int)qword_1C02946E0() >= 0 )
      {
        if ( qword_1C02946E8 )
        {
          v10 = qword_1C02946E8(((unsigned __int64)a1 + 24) & -(__int64)(a1 != 0LL), a5);
LABEL_25:
          LODWORD(v8) = v10;
          goto LABEL_26;
        }
...
LABEL_15:
  ...
  else if ( qword_1C02946D0 && (int)qword_1C02946D0() >= 0 )
  {
    if ( qword_1C02946D8 )
    {
      v10 = qword_1C02946D8(*((_QWORD *)a1 + 18));
      goto LABEL_25;
    }
LABEL_26:
    v8 = (int)v8;
