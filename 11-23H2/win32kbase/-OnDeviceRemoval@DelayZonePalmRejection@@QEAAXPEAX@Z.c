/*
 * XREFs of ?OnDeviceRemoval@DelayZonePalmRejection@@QEAAXPEAX@Z @ 0x1C01E6324
 * Callers:
 ...
 *     ?ClearSession@DelayZoneTelemetry@@QEAAXXZ @ 0x1C01FBDB4 (-ClearSession@DelayZoneTelemetry@@QEAAXXZ.c)
