/*
 * XREFs of ?CompositionRefreshRateBoost@Win32k@InputTraceLogging@@SAXI@Z @ 0x1C01FC71C
 * Callers:
...
void __fastcall InputTraceLogging::Win32k::CompositionRefreshRateBoost()
{
  ...
  if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 512LL) )
  {
    ...
    v1 = v0;
    v4 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0289810, (unsigned __int8 *)dword_1C025F61B, 0LL, 0LL, 3u, &v2);
  }
}
