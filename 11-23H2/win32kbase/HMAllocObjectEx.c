/*
 * XREFs of HMAllocObjectEx @ 0x1C0012A1C
 * Callers:
 ...
 *     SharedAlloc @ 0x1C00BA5B0 (SharedAlloc.c)
...
LABEL_13:
  ...
  if ( (v10 & 0x10) != 0 && a2 )
  {
    if ( qword_1C0295C08 && (int)qword_1C0295C08() >= 0 )
    {
...
LABEL_24:
      ...
      if ( qword_1C0295C10 )
        v17 = qword_1C0295C10(a2, *((unsigned int *)&gahti + 6 * v7 + 4), ((_DWORD)v7 << 16) | 5u);
      else
        v17 = 0LL;
      v14[5] = v17;
      if ( v17 )
...
LABEL_30:
  ...
  v23 = (char *)qword_1C028FE68 + 32 * *v13;
  v24 = 3 * *v13;
  ...
  *v41 = *((_QWORD *)gpKernelHandleTable + v24);
  ...
  v32 = (char *)qword_1C028FE68 + v42 * (unsigned int)dword_1C028FE70;
