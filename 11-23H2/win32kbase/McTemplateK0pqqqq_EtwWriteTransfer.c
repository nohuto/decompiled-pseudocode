/*
 * XREFs of McTemplateK0pqqqq_EtwWriteTransfer @ 0x1C00DFB24
 * Callers:
 *     EtwTraceInternalSetTimer @ 0x1C009D890 (EtwTraceInternalSetTimer.c)
 *     EtwTraceTimerProc @ 0x1C00A2600 (EtwTraceTimerProc.c)
 *     EtwDirtyRectUpdate @ 0x1C00AAF70 (EtwDirtyRectUpdate.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C016B5B0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C016B5F0 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C016B990 (EtwTranslationUpdate.c)
 * Callees:
