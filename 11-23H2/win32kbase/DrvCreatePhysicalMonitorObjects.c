/*
 * XREFs of DrvCreatePhysicalMonitorObjects @ 0x1C0165F40
 * Callers:
        ...
        for ( i = 0LL; (unsigned int)i < v10; i = (unsigned int)(i + 1) )
        {
          ...
          if ( a3 )
          {
            if ( a3 == 1 )
            {
              ...
              {
                if ( qword_1C0294828 )
                  qword_1C0294828(*(_QWORD *)(Pool2 + 8 * i));
              }
            }
          }
          else
...
LABEL_55:
          ...
          if ( qword_1C0294810 )
            NumberOfPhysicalMonitors = qword_1C0294810();
          else
            NumberOfPhysicalMonitors = -1073741637;
          if ( NumberOfPhysicalMonitors < 0 )
            goto LABEL_66;
          NumberOfPhysicalMonitors = qword_1C0294818 ? qword_1C0294818(&v36, v40[1], Pool2 + 8 * v24) : -1073741637;
          if ( NumberOfPhysicalMonitors < 0 )
            goto LABEL_66;
LABEL_53:
