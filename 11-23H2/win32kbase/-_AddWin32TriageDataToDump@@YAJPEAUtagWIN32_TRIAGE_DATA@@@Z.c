/*
 * XREFs of ?_AddWin32TriageDataToDump@@YAJPEAUtagWIN32_TRIAGE_DATA@@@Z @ 0x1C0150604
 * Callers:
...
__int64 __fastcall _AddWin32TriageDataToDump(struct tagWIN32_TRIAGE_DATA *a1)
{
  ...
  for ( i = *(struct tagTHREADINFO **)(*(_QWORD *)a1 + 328LL); i; i = (struct tagTHREADINFO *)*((_QWORD *)i + 83) )
