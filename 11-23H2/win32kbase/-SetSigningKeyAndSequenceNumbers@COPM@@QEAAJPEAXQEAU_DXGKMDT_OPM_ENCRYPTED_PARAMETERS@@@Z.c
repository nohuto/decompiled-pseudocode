/*
 * XREFs of ?SetSigningKeyAndSequenceNumbers@COPM@@QEAAJPEAXQEAU_DXGKMDT_OPM_ENCRYPTED_PARAMETERS@@@Z @ 0x1C015C0B4
 * Callers:
 *     NtGdiSetOPMSigningKeyAndSequenceNumbers @ 0x1C015CC90 (NtGdiSetOPMSigningKeyAndSequenceNumbers.c)
 * Callees:
