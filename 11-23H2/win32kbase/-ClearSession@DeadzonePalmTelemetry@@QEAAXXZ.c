/*
 * XREFs of ?ClearSession@DeadzonePalmTelemetry@@QEAAXXZ @ 0x1C01B10E8
 * Callers:
 *     ?ActivateTelemetrySession@RIMDeadzone@@QEAAXH@Z @ 0x1C019B098 (-ActivateTelemetrySession@RIMDeadzone@@QEAAXH@Z.c)
