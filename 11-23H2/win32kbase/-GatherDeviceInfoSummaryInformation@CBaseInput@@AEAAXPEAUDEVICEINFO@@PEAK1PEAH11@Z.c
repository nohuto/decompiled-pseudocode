/*
 * XREFs of ?GatherDeviceInfoSummaryInformation@CBaseInput@@AEAAXPEAUDEVICEINFO@@PEAK1PEAH11@Z @ 0x1C0077020
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  if ( *((_QWORD *)a2 + 28) )
  {
    if ( (_BYTE)v8 )
    {
      if ( v8 == 1 )
      {
        if ( anonymous_namespace_::GetKeyboardProcessor((unsigned int)(v8 - 1), (__int64)a2, (__int64)a3, (__int64)a4) )
