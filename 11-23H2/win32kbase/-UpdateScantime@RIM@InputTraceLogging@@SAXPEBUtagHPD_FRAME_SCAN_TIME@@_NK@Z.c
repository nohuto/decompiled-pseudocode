/*
 * XREFs of ?UpdateScantime@RIM@InputTraceLogging@@SAXPEBUtagHPD_FRAME_SCAN_TIME@@_NK@Z @ 0x1C00E2A52
 * Callers:
 *     rimSimulatedPointerDeviceScanTime @ 0x1C00E32F4 (rimSimulatedPointerDeviceScanTime.c)
