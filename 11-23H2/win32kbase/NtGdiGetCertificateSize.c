/*
 * XREFs of NtGdiGetCertificateSize @ 0x1C015C990
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SafelyCopyKernelModeDataToUserModeData_unsigned_long_ @ 0x1C015ADE8 (SafelyCopyKernelModeDataToUserModeData_unsigned_long_.c)
 *     GetCertificateLengthAndMonitorPDO @ 0x1C015BA5C (GetCertificateLengthAndMonitorPDO.c)
 */
