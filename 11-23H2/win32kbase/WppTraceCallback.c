/*
 * XREFs of WppTraceCallback @ 0x1C02C0690
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  {
    v12 = *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type == 2;
    v24 = *((_QWORD *)a4 + 1);
    *(_QWORD *)(v10 + 24) = v24;
    if ( v12 )
    {
      if ( !(*(unsigned int (__fastcall **)(__int64, int *, __int64, unsigned int **, unsigned int *))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
              3LL,
              &v25,
              4LL,
              &a6,
              a4) )
        *(_BYTE *)(v10 + 41) = v25;
      return (*(unsigned int (__fastcall **)(__int64, __int64, __int64, unsigned int **, unsigned int *))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
               2LL,
               v10 + 44,
               4LL,
               &a6,
