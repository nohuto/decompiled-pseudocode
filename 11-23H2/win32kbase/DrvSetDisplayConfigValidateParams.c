/*
 * XREFs of DrvSetDisplayConfigValidateParams @ 0x1C00D71B0
 * Callers:
 ...
 *     ?Globals@Base@Gre@@YAAEAUSESSION_GLOBALS@12@XZ @ 0x1C00441B0 (-Globals@Base@Gre@@YAAEAUSESSION_GLOBALS@12@XZ.c)
 *     _stricmp @ 0x1C00CE4F4 (_stricmp.c)
 *     ?DrvIsPermanentSettingChangesDisabled@@YAHXZ @ 0x1C0161628 (-DrvIsPermanentSettingChangesDisabled@@YAHXZ.c)
 *     ?DrvIsTemporarySettingChangeDisabled@@YAHXZ @ 0x1C01616D0 (-DrvIsTemporarySettingChangeDisabled@@YAHXZ.c)
 ...
 *     ?IsPathVirtualFlagCloneCompatible@@YAEEE@Z @ 0x1C0163B8C (-IsPathVirtualFlagCloneCompatible@@YAEEE@Z.c)
 */
        ...
        char a5)
{
  ...
  if ( (v26 & 0xC0000000) == 0 )
  {
    if ( (a4 & 1) != 0 )
    {
      if ( (a4 & 0xFFFFFEBF) == 1 && v26 == 128 && !v24 )
        return 0LL;
LABEL_37:
