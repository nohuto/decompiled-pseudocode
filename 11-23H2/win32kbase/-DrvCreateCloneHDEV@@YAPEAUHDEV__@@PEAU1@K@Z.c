/*
 * XREFs of ?DrvCreateCloneHDEV@@YAPEAUHDEV__@@PEAU1@K@Z @ 0x1C0160E5C
 * Callers:
...
struct PDEV *__fastcall DrvCreateCloneHDEV(struct PDEV *a1)
{
  ...
  if ( v12 )
  {
    ...
    if ( v8 && qword_1C02947B0 && (int)qword_1C02947B0() >= 0 && (unsigned int)bSpEnableSprites((__int64)v7) )
    {
      if ( qword_1C02947C0 && (int)qword_1C02947C0() >= 0 )
