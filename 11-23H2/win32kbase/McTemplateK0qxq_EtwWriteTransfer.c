/*
 * XREFs of McTemplateK0qxq_EtwWriteTransfer @ 0x1C013C5AC
 * Callers:
 ...
 *     EtwTraceFlipManagerCanceledPresentShown @ 0x1C01396F0 (EtwTraceFlipManagerCanceledPresentShown.c)
 *     EtwTraceFlipManagerPresentIFlipSubmitted @ 0x1C0139EF0 (EtwTraceFlipManagerPresentIFlipSubmitted.c)
 *     EtwTraceFlipManagerPresentSignaled @ 0x1C013A450 (EtwTraceFlipManagerPresentSignaled.c)
 *     EtwTraceFlipManagerUpdateExpectedConsumerPresentId @ 0x1C013A910 (EtwTraceFlipManagerUpdateExpectedConsumerPresentId.c)
 * Callees:
