/*
 * XREFs of RIMIDEInjectDeviceInput @ 0x1C0195C58
 * Callers:
 ...
 *     ?RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z @ 0x1C01930B4 (-RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z.c)
