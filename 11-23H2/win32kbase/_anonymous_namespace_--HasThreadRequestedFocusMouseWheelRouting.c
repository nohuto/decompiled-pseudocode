/*
 * XREFs of _anonymous_namespace_::HasThreadRequestedFocusMouseWheelRouting @ 0x1C01F812C
 * Callers:
...
char __fastcall anonymous_namespace_::HasThreadRequestedFocusMouseWheelRouting(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 424) + 824LL) & 0x8000) != 0 )
    return 1;
  v1 = 0;
  if ( qword_1C0295E50 )
  {
    if ( (qword_1C0295E50(a1) & 0x10000000000000LL) != 0 )
      return 1;
  }
  return v1;
}
