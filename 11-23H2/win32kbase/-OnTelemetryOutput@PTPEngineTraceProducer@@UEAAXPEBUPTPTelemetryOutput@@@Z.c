/*
 * XREFs of ?OnTelemetryOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPTelemetryOutput@@@Z @ 0x1C00E7620
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct PTPTelemetryOutput *a2)
{
  ...
  if ( (unsigned int)dword_1C02882F8 > 5 && tlgKeywordOn((__int64)&dword_1C02882F8, 9LL) )
  {
    v8 = a2;
    v9 = v4 + 23;
    v11 = *((_QWORD *)this + 73);
