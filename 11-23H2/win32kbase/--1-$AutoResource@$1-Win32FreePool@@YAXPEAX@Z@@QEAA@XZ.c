/*
 * XREFs of ??1?$AutoResource@$1?Win32FreePool@@YAXPEAX@Z@@QEAA@XZ @ 0x1C016B4EC
 * Callers:
 *     EtwTraceTrappedAppContainerRender @ 0x1C016B7D0 (EtwTraceTrappedAppContainerRender.c)
 * Callees:
