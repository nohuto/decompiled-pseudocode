/*
 * XREFs of ?SetupDCAttributes@@YAXPEAVDC@@PEAU_DC_ATTR@@@Z @ 0x1C003E79C
 * Callers:
...
void __fastcall SetupDCAttributes(struct DC *a1, struct _DC_ATTR *a2)
{
  ...
  EntryFromObject = GdiHandleManager::GetEntryFromObject(*(GdiHandleManager **)(*(_QWORD *)(v4 + 24) + 8008LL), a1);
