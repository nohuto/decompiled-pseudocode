/*
 * XREFs of ?CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z @ 0x1C0233D34
 * Callers:
...
struct _CIT_INTERACTION_SUMMARY *__fastcall CitpInteractionSummaryGetOutstanding(struct _CIT_PROCESS *a1)
{
  ...
  if ( (BYTE8(xmmword_1C0293D04) & 1) == 0 )
    return 0LL;
  if ( (BYTE8(xmmword_1C0293D04) & 2) != 0 )
  {
    v2 = *((_WORD *)a1 + 21);
    if ( !v2 )
      return 0LL;
    v3 = *((unsigned __int16 *)a1 + 20);
    if ( (unsigned int)v3 >= *((_DWORD *)xmmword_1C0293D20 + 14) )
      return 0LL;
    v4 = *(_QWORD *)xmmword_1C0293D20 + 96 * v3;
