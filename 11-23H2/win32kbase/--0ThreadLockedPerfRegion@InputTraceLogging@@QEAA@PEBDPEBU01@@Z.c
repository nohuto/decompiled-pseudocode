 ...
 *     ?OnAsyncPnpWorkNotification@CBaseInput@@AEAAJXZ @ 0x1C01DCD50 (-OnAsyncPnpWorkNotification@CBaseInput@@AEAAJXZ.c)
 ...
 *     ?OnPTPInertiaHandleEvent@CHidInput@@EEAAJXZ @ 0x1C01E2730 (-OnPTPInertiaHandleEvent@CHidInput@@EEAAJXZ.c)
 ...
 *     ?OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ @ 0x1C01E2D10 (-OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ.c)
