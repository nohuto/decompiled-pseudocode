/*
 * XREFs of McTemplateK0p_EtwWriteTransfer @ 0x1C00DF816
 * Callers:
 ...
 *     EtwTraceDCompGetBatchEvent @ 0x1C0138E80 (EtwTraceDCompGetBatchEvent.c)
 *     EtwTraceDITSpeedHitTestFailedRevalidation @ 0x1C0138EB0 (EtwTraceDITSpeedHitTestFailedRevalidation.c)
 *     EtwTraceFlipManagerBindingStart @ 0x1C0139630 (EtwTraceFlipManagerBindingStart.c)
 * Callees:
