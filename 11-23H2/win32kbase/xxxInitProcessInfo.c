...
LABEL_54:
      ...
      *((_DWORD *)a1 + 224) = (_DWORD)TokenInformation;
      *((_DWORD *)a1 + 225) = v13;
    }
    v14 = 1;
    ...
    *((_DWORD *)a1 + 206) ^= (*((_DWORD *)a1 + 206) ^ (a5 << 7)) & 0x80;
    if ( v12 >= 0 )
    {
      ...
      if ( v12 >= 0 )
      {
        ...
        *((_DWORD *)a1 + 206) &= ~0x8000u;
        v18 = *((_DWORD *)a1 + 206) & 0xFFFEFFFF;
        *((_DWORD *)a1 + 206) = v18;
        if ( (v18 & 0x60000) != 0 )
        {
          v24 = 0x20000;
        ...
        v19 = *((_DWORD *)a1 + 206) & 0xFFBFFFFF;
        *((_WORD *)a1 + 142) = 96;
        *((_DWORD *)a1 + 206) = v19;
        *((_DWORD *)a1 + 70) = 24592;
        if ( (v19 & 0x30) == 0x20 )
          *((_DWORD *)a1 + 206) = v19 | 0x100000;
        Win32KFilterSet = PsGetWin32KFilterSet();
        v21 = 0;
        if ( Win32KFilterSet == 5 )
          v21 = 0x1000000;
        *((_DWORD *)a1 + 206) = v21 & 0xF7FFFFFF | *((_DWORD *)a1 + 206) & 0xF6FFFFFF;
        if ( *((_WORD *)gpsi + 3499) )
        {
