/*
 * XREFs of ?DrvUpdateDisplayModeInMdev@@YAHPEAU_MDEV@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0161F38
 * Callers:
...
__int64 __fastcall DrvUpdateDisplayModeInMdev(struct _MDEV *a1, struct D3DKMT_GETPATHSMODALITY *a2)
{
  ...
  if ( !qword_1C0294458 || !(unsigned int)qword_1C0294458() || *((_DWORD *)a1 + 5) != 1 )
  {
