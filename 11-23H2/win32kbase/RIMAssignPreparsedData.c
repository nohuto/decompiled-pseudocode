/*
 * XREFs of RIMAssignPreparsedData @ 0x1C01865BC
 * Callers:
...
__int64 __fastcall RIMAssignPreparsedData(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  {
    v18 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2883);
  }
  if ( !*(_QWORD *)(a1 + 16) )
  {
    v18 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2884);
  }
  if ( !*(_DWORD *)(a1 + 104) )
  {
    v18 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2885);
  }
