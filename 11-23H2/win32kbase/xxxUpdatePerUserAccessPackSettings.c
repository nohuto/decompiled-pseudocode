...
LABEL_22:
  ...
  FastGetProfileIntW((__int64)a1, 19LL, (__int64)L"Flags", 2u, &dword_1C0293954, 0);
  FastGetProfileIntW((__int64)a1, 19LL, (__int64)L"FSTextEffect", 0, &dword_1C0293958, 0);
  FastGetProfileIntW((__int64)a1, 19LL, (__int64)L"WindowsEffect", 0, &dword_1C0293970, 0);
