/*
 * XREFs of ?GetHitTestState@CPTPProcessor@@QEAAPEBUCHitTestState@@PEBUCPointerInputFrame@@@Z @ 0x1C01DF228
 * Callers:
        ...
        const struct CPointerInputFrame *a2)
{
  ...
  if ( (*((_DWORD *)this + 133) & 4) != 0 )
    return (CPTPProcessor *)((char *)this + 408);
  if ( (*((_DWORD *)a2 + 57) & 0x100) != 0 && (int)IsGetPTPShellTargetSupported() >= 0 )
  {
    ...
    if ( v13[0] )
    {
      CHitTestState::Set((CPTPProcessor *)((char *)this + 408), (const struct CInputDest *)v13, 0, 0, 1);
