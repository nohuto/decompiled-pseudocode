/*
 * XREFs of ?SendFrameToContainer@Pointer@InputTraceLogging@@SAXQEAURIMDEV@@PEBUCPointerInputFrame@@@Z @ 0x1C01F2B94
 * Callers:
    ...
    if ( (unsigned int)(v2 - 5) > 1 )
    {
      if ( v2 == 7 )
      {
        if ( (unsigned int)dword_1C0289810 <= 4 || !tlgKeywordOn((__int64)&dword_1C0289810, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C025E9D5;
      }
      else
      {
        if ( (unsigned int)dword_1C0289810 <= 4 || !tlgKeywordOn((__int64)&dword_1C0289810, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C025E909;
      }
    }
    else
    {
      if ( (unsigned int)dword_1C0289810 <= 4 || !tlgKeywordOn((__int64)&dword_1C0289810, 32LL) )
        return;
      v7 = (unsigned __int8 *)&unk_1C025E971;
    }
    v10 = *(_DWORD *)(v5 + 48);
    v11 = *(_DWORD *)(v5 + 40);
    v12 = *(_QWORD *)(v5 + 72);
