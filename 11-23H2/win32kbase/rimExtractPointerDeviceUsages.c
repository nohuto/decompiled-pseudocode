/*
 * XREFs of rimExtractPointerDeviceUsages @ 0x1C01A9788
 * Callers:
 ...
 *     RIMEnsureUsageWithinLogicalBoundary @ 0x1C00E2C9A (RIMEnsureUsageWithinLogicalBoundary.c)
 *     rimExtractData @ 0x1C00E2F72 (rimExtractData.c)
    ...
    else
    {
      if ( v35 != 7 )
      {
        ...
        else
        {
          ...
          LODWORD(a9) = 0x20000;
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 2790);
        }
        goto LABEL_72;
      }
      *(_DWORD *)(v15 + 64) = 5;
