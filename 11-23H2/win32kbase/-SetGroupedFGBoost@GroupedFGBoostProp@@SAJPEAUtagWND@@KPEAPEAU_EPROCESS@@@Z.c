/*
 * XREFs of ?SetGroupedFGBoost@GroupedFGBoostProp@@SAJPEAUtagWND@@KPEAPEAU_EPROCESS@@@Z @ 0x1C0064DF0
 * Callers:
 ...
 *     ?doImmediateBoostAll@GroupedFGBoostProp@@AEAAXW4BoostFlag@@@Z @ 0x1C0064D84 (-doImmediateBoostAll@GroupedFGBoostProp@@AEAAXW4BoostFlag@@@Z.c)
...
LABEL_18:
        ...
        if ( !(unsigned int)CWindowProp::SetProp(v23, v39) )
        {
          (**(void (__fastcall ***)(GroupedFGBoostProp *))v23)(v23);
          return (unsigned int)-1073741811;
        }
        CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v42, (struct _EX_PUSH_LOCK *)&unk_1C0291DC0);
        GroupedFGBoostProp::doImmediateBoostAll((__int64)v23, 1);
        v16 = v42;
        goto LABEL_11;
      }
LABEL_39:
...
LABEL_6:
    CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v42, (struct _EX_PUSH_LOCK *)&unk_1C0291DC0);
    v11 = v31;
    GroupedFGBoostProp::doImmediateBoostAll((__int64)v31, 0);
    ...
    CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v30, (struct _EX_PUSH_LOCK *)&unk_1C0291DC0);
    GroupedFGBoostProp::doImmediateBoostAll((__int64)v11, 1);
    v16 = v30;
LABEL_11:
