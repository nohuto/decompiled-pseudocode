/*
 * XREFs of DCompositionIsVailContainer @ 0x1C0209154
 * Callers:
 *     ?CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEAPEAX@Z @ 0x1C02230D0 (-CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEA.c)
...
__int64 DCompositionIsVailContainer()
{
  ...
  return (unsigned __int8)byte_1C0297628;
}
