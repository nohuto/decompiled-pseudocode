/*
 * XREFs of ?CallInterceptor@Mouse@InputTraceLogging@@SAX_K@Z @ 0x1C01F5400
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::CallInterceptor()
{
  ...
  if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 64LL) )
  {
    ...
    v1 = v0;
    v4 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0289810, (unsigned __int8 *)dword_1C025EF97, 0LL, 0LL, 3u, &v2);
  }
}
