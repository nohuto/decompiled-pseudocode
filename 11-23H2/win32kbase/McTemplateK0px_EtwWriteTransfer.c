/*
 * XREFs of McTemplateK0px_EtwWriteTransfer @ 0x1C013CEA4
 * Callers:
 ...
 *     EtwTraceFlipManagerContentUnbind @ 0x1C01397B0 (EtwTraceFlipManagerContentUnbind.c)
 *     EtwTraceTokenManagerDisableScanoutToken @ 0x1C013B1C0 (EtwTraceTokenManagerDisableScanoutToken.c)
 *     EtwBindLogicalSurfaceRHEvent @ 0x1C016B520 (EtwBindLogicalSurfaceRHEvent.c)
 *     EtwBindSwapChain @ 0x1C016B550 (EtwBindSwapChain.c)
 * Callees:
