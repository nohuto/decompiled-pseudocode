/*
 * XREFs of ?EmitUpdateCommands@CAtlasedRectsGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021B300
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EmitSetImageSourceCommand@CAtlasedRectsGroupMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0217C58 (-EmitSetImageSourceCommand@CAtlasedRectsGroupMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@.c)
 */
