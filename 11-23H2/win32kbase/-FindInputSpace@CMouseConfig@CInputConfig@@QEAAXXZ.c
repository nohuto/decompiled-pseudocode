/*
 * XREFs of ?FindInputSpace@CMouseConfig@CInputConfig@@QEAAXXZ @ 0x1C0063B5C
 * Callers:
 ...
 *     ?BindMouse@CInputConfig@@QEAAJU_LUID@@@Z @ 0x1C01E3A50 (-BindMouse@CInputConfig@@QEAAJU_LUID@@@Z.c)
 * Callees:
