/*
 * XREFs of xxxUserChangeDisplaySettings @ 0x1C01371D0
 * Callers:
  ...
  *(_OWORD *)v48 = 0LL;
  ...
  if ( a1 )
  {
    *(_OWORD *)Src = *a1;
    ...
    if ( qword_1C0295450 )
    {
      qword_1C0295450(QuotaZInit, &v48[1], Win32FreePool);
      QuotaZInit = v48[0];
    }
...
LABEL_25:
    ...
    if ( qword_1C0295450 )
    {
      qword_1C0295450(v16, &v51, Win32FreePool);
      v16 = v50;
    }
    if ( v44 + (_DWORD)v15 )
    {
...
LABEL_47:
  if ( Pool2 )
  {
    ...
    *(_DWORD *)(Pool2 + 52) = v20;
    ...
    v38 = dword_1C0283098;
    if ( (unsigned int)dword_1C0283098 > 5 && tlgKeywordOn((__int64)&dword_1C0283098, 0x200000000004LL) )
    {
      v43[0] = a6;
      v75 = v37;
      v76 = v71;
    ...
    if ( (*(_DWORD *)(Pool2 + 140) & 1) != 0 && v38 > 5 && tlgKeywordOn((__int64)&dword_1C0283098, 0x200000000004LL) )
    {
