/*
 * XREFs of ??1CBatchDeferralMarshaler@DirectComposition@@MEAA@XZ @ 0x1C0230478
 * Callers:
 *     ??_ECBatchDeferralMarshaler@DirectComposition@@MEAAPEAXI@Z @ 0x1C020BA80 (--_ECBatchDeferralMarshaler@DirectComposition@@MEAAPEAXI@Z.c)
 * Callees:
