/*
 * XREFs of UserProcessThawCallout @ 0x1C00681D0
 * Callers:
...
__int64 __fastcall UserProcessThawCallout(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    v13 = ProcessWin32Process[41];
    v14 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    while ( v13 )
    {
      if ( qword_1C02957E0 && (int)qword_1C02957E0() >= 0 )
      {
        if ( qword_1C02957E8 )
          qword_1C02957E8(v13, (unsigned int)v14);
      }
      v13 = *(_QWORD *)(v13 + 664);
    }
    *((_DWORD *)v12 + 206) &= ~0x400u;
