/*
 * XREFs of ?CreateInstance@CKeyboardSensor@@SAJPEAPEAV1@@Z @ 0x1C0083134
 * Callers:
  ...
  *a1 = 0LL;
  ...
  if ( *(_DWORD *)gpLeakTrackingAllocator )
  {
    ...
    if ( !NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(gpLeakTrackingAllocator, 0x70694843u) )
      return 3221225495LL;
    Pool2 = (_QWORD *)ExAllocatePool2(v12 & 0xFFFFFFFFFFFFFFFDuLL, 1368LL, v10);
...
LABEL_5:
    ...
    *(_QWORD *)(UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64 + 1344) = 0LL;
