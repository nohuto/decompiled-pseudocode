/*
 * XREFs of NtGdiSetOPMSigningKeyAndSequenceNumbers @ 0x1C015CC90
 * Callers:
 *     <none>
 * Callees:
 *     SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_ENCRYPTED_PARAMETERS_ @ 0x1C015AF0C (SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_ENCRYPTED_PARAMETERS_.c)
