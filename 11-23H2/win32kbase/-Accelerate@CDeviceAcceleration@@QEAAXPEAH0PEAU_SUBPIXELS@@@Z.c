/*
 * XREFs of ?Accelerate@CDeviceAcceleration@@QEAAXPEAH0PEAU_SUBPIXELS@@@Z @ 0x1C01FCBA8
 * Callers:
  ...
  *((_DWORD *)a4 + 1) = 0;
  if ( v9 )
  {
    ...
    if ( v18 )
    {
      ...
      if ( dword_1C0297618 < (unsigned int)v20 )
        v21 = (*(_QWORD *)(v34 + 8LL * (unsigned int)dword_1C0297618)
             + (*(_QWORD *)(v33 + 8LL * (unsigned int)dword_1C0297618) << 16) / v18
             + v21) >> 1;
      v22 = v21 * ((__int64)*a3 << 16);
      dword_1C0297618 = v20;
      v23 = qword_1C0297610 + ((v21 * v12) >> 16);
      v24 = -v23;
      v25 = qword_1C0297608 + (v22 >> 16);
      if ( v23 < 0 )
      {
        v27 = v23;
