...
void __fastcall vUnreferencePdevWorker(struct tagUNREFDATA *a1)
{
  ...
  *((_DWORD *)a1 + 2) = 0;
  ...
  while ( 1 )
  {
    ...
    v27 = *(_QWORD *)(v1 + 1520);
    v24[0] = *(_QWORD *)(v6 + 128);
    if ( qword_1C0294BC8 && (int)qword_1C0294BC8() >= 0 && qword_1C0294BD0 )
      qword_1C0294BD0(&v27, &v26, v24, v3);
    v27 = 0LL;
  ...
  if ( *(_DWORD *)(v26 + 3568) )
  {
    ...
    if ( qword_1C0294BD8 && (int)qword_1C0294BD8() >= 0 )
    {
      v9 = qword_1C0294BE0;
      if ( qword_1C0294BE0 )
        v9 = (__int64 (*)(void))qword_1C0294BE0();
      v24[0] = *(_QWORD *)v9;
    }
    if ( qword_1C0294BE8 && (int)qword_1C0294BE8() >= 0 && qword_1C0294BF0 )
      v8 = qword_1C0294BF0(v24, v26, &v27);
  ...
  while ( v10 )
  {
    *(_DWORD *)(v10 + 228) = 1;
    v11 = (char *)v10;
    if ( qword_1C0294C08 && (int)qword_1C0294C08() >= 0 && qword_1C0294C10 )
      qword_1C0294C10(v10 + 128);
    v10 = *(_QWORD *)(v10 + 248);
    Win32FreePool(v11);
  }
