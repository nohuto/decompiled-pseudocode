/*
 * XREFs of ?ReadRawMouseThrottlingThresholds@CMouseSensor@@QEAAXPEAU_UNICODE_STRING@@@Z @ 0x1C01E5440
 * Callers:
 *     ReadRawMouseThrottlingThresholds @ 0x1C01E8990 (ReadRawMouseThrottlingThresholds.c)
 * Callees:
