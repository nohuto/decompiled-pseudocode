/*
 * XREFs of ImpWorkerRoutine @ 0x1C007B0F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ImpWorkerRoutine(PVOID StartContext)
{
  ...
  *(_OWORD *)Object_8 = 0LL;
  ...
  if ( ZwSetSystemInformation(SystemThreadPriorityClientIdInformation, SystemInformation, 0x18uLL) < 0
    && (unsigned int)dword_1C0288780 > 2
    && tlgKeywordOn((__int64)&dword_1C0288780, 0x400000000000LL) )
  {
    v17 = v5;
    v35 = &v17;
    v36 = 4LL;
    ...
    v19 = 0x1000000LL;
    v38 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0288780, (unsigned __int8 *)dword_1C0261BF2, 0LL, 0LL, 4u, &v34);
  }
    ...
    && tlgKeywordOn((__int64)&dword_1C0288780, 0x400000000000LL) )
  {
    ...
    v19 = 0x1000000LL;
    v33 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0288780, (unsigned __int8 *)dword_1C0261C31, 0LL, 0LL, 4u, &v29);
  }
...
LABEL_18:
    if ( (unsigned int)Feature_IMRespectWTDToggle__private_IsEnabledDeviceUsage() )
    {
      ...
      if ( v7 < 0 && (unsigned int)dword_1C0288780 > 2 && tlgKeywordOn((__int64)&dword_1C0288780, 0x400000000000LL) )
      {
        v17 = v7;
        v30 = &v17;
        v31 = 4LL;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)dword_1C0261B3C,
          0LL,
          0LL,
          4u,
          &v29);
...
LABEL_49:
        ...
        if ( v9 == 96 )
        {
          if ( (unsigned int)dword_1C0288780 > 2 && tlgKeywordOn((__int64)&dword_1C0288780, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_1C0288780,
              (unsigned __int8 *)dword_1C0261C67,
              0LL,
              0LL,
              4u,
              &v29);
