/*
 * XREFs of ?Create@?$TypeIsolationFactory@V?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@@@SA_NPEAPEAE@Z @ 0x1C008CC50
 * Callers:
...
char __fastcall TypeIsolationFactory<NSInstrumentation::CTypeIsolation<233472,912>>::Create(__int64 a1)
{
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)Pool2 = Pool2;
    ...
    NSInstrumentation::CTypeIsolation<233472,912>::~CTypeIsolation<233472,912>(v3);
