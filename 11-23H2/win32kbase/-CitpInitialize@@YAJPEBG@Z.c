...
__int64 __fastcall CitpInitialize(const unsigned __int16 *a1)
{
  ...
  *(_QWORD *)&qword_1C0293D14 = 1000LL;
  dword_1C0293D1C = 0;
  *(_QWORD *)&xmmword_1C0293D04 = 0xEA6000000040LL;
  *((_QWORD *)&xmmword_1C0293D04 + 1) = 0xEA6000000001LL;
  CitpParametersCompute((struct _CIT_PARAMETERS *)&xmmword_1C0293D04);
  *(_OWORD *)&xmmword_1C0293D20 = 0LL;
  xmmword_1C0293D40 = 0LL;
  xmmword_1C0293D30 = 0LL;
  *(_QWORD *)&xmmword_1C0293D40 = (((unsigned __int64)MEMORY[0xFFFFF78000000004] << 32)
                                 * (unsigned __int128)(unsigned __int64)(MEMORY[0xFFFFF78000000320] << 8)) >> 64;
  LOBYTE(g_CompatImpact) = 1;
  *((_DWORD *)&xmmword_1C0293D20 + 2) = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  CitpParametersLoad((struct _CIT_PARAMETERS *)&xmmword_1C0293D04, v1);
