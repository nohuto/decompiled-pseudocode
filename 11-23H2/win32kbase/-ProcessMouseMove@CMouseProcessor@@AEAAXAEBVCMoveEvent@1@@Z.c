/*
 * XREFs of ?ProcessMouseMove@CMouseProcessor@@AEAAXAEBVCMoveEvent@1@@Z @ 0x1C00557D8
 * Callers:
 ...
 *     ?AnalyzeNewMousePosition@CMouseProcessor@@AEBA?AW4MoveNewPosResult@1@AEBVCMouseEvent@1@@Z @ 0x1C01F5294 (-AnalyzeNewMousePosition@CMouseProcessor@@AEBA-AW4MoveNewPosResult@1@AEBVCMouseEvent@1@@Z.c)
        ...
        __int64 a3)
{
  ...
  v6 = &WPP_f645abfb8f443aa578495af70e8984ab_Traceguids;
...
LABEL_9:
      ...
      && anonymous_namespace_::InMouseRawInputMode(0LL, 1LL, 1) )
    {
      ...
      {
        v21 = &WPP_f645abfb8f443aa578495af70e8984ab_Traceguids;
        LOBYTE(v21) = v5;
        WPP_RECORDER_AND_TRACE_SF_(
          WPP_GLOBAL_Control->AttachedDevice,
          (_DWORD)v21,
    ...
    if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 64LL) )
    {
      ...
      v49 = 4LL;
      v47 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0289810, (int)&dword_1C025F03C, 0, 0, 6u, &v45);
    }
    if ( !v44[0] )
    {
      if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      if ( v5 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        v23 = &WPP_f645abfb8f443aa578495af70e8984ab_Traceguids;
        LOBYTE(v23) = v5;
        WPP_RECORDER_AND_TRACE_SF_(
          WPP_GLOBAL_Control->AttachedDevice,
          (_DWORD)v23,
    ...
    if ( v8 )
    {
      ...
      if ( v34 == v30 )
      {
        ...
        if ( v5 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          v26 = &WPP_f645abfb8f443aa578495af70e8984ab_Traceguids;
          LOBYTE(v26) = v5;
          WPP_RECORDER_AND_TRACE_SF_(
            WPP_GLOBAL_Control->AttachedDevice,
            (_DWORD)v26,
    ...
    *((_DWORD *)this + 17) = v11;
    if ( *((_QWORD *)v3 + 1) == -104LL
      ...
      || (unsigned __int8)anonymous_namespace_::ValidateUIPI(*(_QWORD *)(*((_QWORD *)gptiCurrent + 53) + 896LL), v44) )
    {
    ...
    v29 = &WPP_f645abfb8f443aa578495af70e8984ab_Traceguids;
    LOBYTE(v29) = v5;
    WPP_RECORDER_AND_TRACE_SF_(
      v27->AttachedDevice,
      (_DWORD)v29,
...
LABEL_18:
  ...
  if ( v5 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v15 = &WPP_f645abfb8f443aa578495af70e8984ab_Traceguids;
    LOBYTE(v15) = v5;
    WPP_RECORDER_AND_TRACE_SF_(
      WPP_GLOBAL_Control->AttachedDevice,
      (_DWORD)v15,
