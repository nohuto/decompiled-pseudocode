/*
 * XREFs of NtUserPostKeyboardInputMessage @ 0x1C0149CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserPostKeyboardInputMessage(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ULONG64 v5; // rsi
  ...
  v5 = a2;
  v7 = (struct tagTHREADINFO *)PrivateAPI::_anonymous_namespace_::EnterCritInternal(0LL, a2, a3, a4);
  gptiCurrent = v7;
  if ( v7 )
  {
    *((_DWORD *)v7 + 387) = 1;
    ...
    {
      v9 = (struct tagTHREADINFO *)-*(_QWORD *)CurrentProcessWin32Process;
  ...
  if ( v19 )
  {
    if ( v5 + 20 < v5 || v5 + 20 > MmUserProbeAddress )
      v5 = MmUserProbeAddress;
    v32 = *(_OWORD *)v5;
    v33 = *(_DWORD *)(v5 + 16);
    LOBYTE(v21) = CKeyboardProcessor::HandleLeftRightVKs(*(_QWORD *)(v5 + 8));
