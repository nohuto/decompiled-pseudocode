/*
 * XREFs of ?RemoveEdgeZonesForDevice@DelayZonePalmRejection@@QEAA_NPEAX@Z @ 0x1C01E71AC
 * Callers:
 *     RemoveAllEdgePalmRejectionZonesForDevice @ 0x1C01E7590 (RemoveAllEdgePalmRejectionZonesForDevice.c)
 * Callees:
