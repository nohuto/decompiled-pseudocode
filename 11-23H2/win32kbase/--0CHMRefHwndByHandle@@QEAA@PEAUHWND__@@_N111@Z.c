/*
 * XREFs of ??0CHMRefHwndByHandle@@QEAA@PEAUHWND__@@_N111@Z @ 0x1C00DE4B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HMIsHandleEntrySecure @ 0x1C00DE6F4 (HMIsHandleEntrySecure.c)
 */
  ...
  *((_QWORD *)this + 1) = 0LL;
  if ( (int)HMReferenceObjectByHandle((int)a2, (__int64)a2, this) >= 0 )
  {
    ...
    if ( a6 )
    {
      ...
      {
        LOBYTE(v11) = a4;
        if ( !CheckAccessEx((int *)(*((_QWORD *)v10 + 53) + 896LL), (unsigned int *)v12[53] + 224, v11) )
        {
          v13 = v12[53];
    ...
    if ( a5 )
    {
      ...
      if ( v14 != *(_QWORD *)this )
      {
          ...
          || (v14 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)this + 16LL) + 488LL), (v14 & 0xC) != 0) )
        {
          ...
          v17 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 16LL) + 424LL) + 780LL);
          if ( *(_DWORD *)(v16 + 780) != (_DWORD)v17 )
            goto LABEL_26;
          v18 = PsGetCurrentProcessWin32Process(v17);
          v19 = v18;
          if ( v18 )
            v19 = -(__int64)(*(_QWORD *)v18 != 0LL) & v18;
          if ( *(_DWORD *)(v19 + 784) != *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 16LL) + 424LL) + 784LL) )
          {
LABEL_26:
            UserSetLastError(5);
            return this;
    ...
    if ( (*((_DWORD *)v10 + 122) & 0x20000000) == 0
      || (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)v10 + 53) + 768LL) + 24LL) & 1) == 0
