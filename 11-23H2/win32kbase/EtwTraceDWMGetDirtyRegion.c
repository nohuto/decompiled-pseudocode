/*
 * XREFs of EtwTraceDWMGetDirtyRegion @ 0x1C00C40B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GrepGetRegionPtrData@@YAKPEAVREGION@@KPEAU_RGNDATA@@@Z @ 0x1C00E06FA (-GrepGetRegionPtrData@@YAKPEAVREGION@@KPEAU_RGNDATA@@@Z.c)
