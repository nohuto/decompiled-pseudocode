/*
 * XREFs of ?BuildReportDescriptor@@YAHGGPEAUtagUSAGE_PROPERTIES@@KKPEAU_HIDP_DEVICE_DESC@@@Z @ 0x1C019814C
 * Callers:
 ...
 *     ?BuildDeviceHeader@@YAHPEAEKPEAKGG@Z @ 0x1C0197DA0 (-BuildDeviceHeader@@YAHPEAEKPEAKGG@Z.c)
