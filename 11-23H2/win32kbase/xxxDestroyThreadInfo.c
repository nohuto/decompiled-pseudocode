 ...
 *     ?EtwpGetLastInputProcessTime@@YAXQEAUtagQ@@KPEAK1PEAIPEA_K@Z @ 0x1C01386FC (-EtwpGetLastInputProcessTime@@YAXQEAUtagQ@@KPEAK1PEAIPEA_K@Z.c)
...
void xxxDestroyThreadInfo()
{
  ...
  *((_DWORD *)v2 + 122) |= 0x41u;
  ...
  if ( *v7 )
  {
    ...
    {
      for ( i = *(struct tagTHREADINFO **)(*(_QWORD *)v4 + 328LL);
      ...
      if ( (**(_DWORD **)v134[0] & 1) == 0 )
      {
        ...
        if ( (**(_DWORD **)v134[0] & 0x8000) == 0 )
        {
          ...
          else if ( v45 == (_DWORD *)&gpopupMenu )
          {
            ...
            NullifyLookasideRef(qword_1C0291F78);
          }
          else
          {
            v46 = *(_QWORD *)v134[0];
...
LABEL_166:
  ...
  v51 = v139;
  v52 = *v139;
  if ( *v139 && *((struct tagTHREADINFO **)v52 + 42) == v2 )
    *((_QWORD *)v52 + 42) = 0LL;
  while ( 1 )
  {
    v54 = *((_QWORD *)v2 + 78);
  ...
  v66 = v144;
  if ( !v144 || *((struct tagTHREADINFO **)v144 + 41) != v2 || (v67 = 1, *((_QWORD *)v2 + 83)) )
    v67 = 0;
  v131 = v67;
  if ( v144 )
  {
    ...
    if ( (_WORD)v63 )
    {
      ...
      v63 = (void *)*((unsigned __int16 *)v144 + 408);
      v64 = 0xFFFFLL;
      ...
      else
      {
        ...
        *((_WORD *)v144 + 408) = (_WORD)v63;
      }
    }
    if ( v67 )
    {
      v64 = *((unsigned __int16 *)v66 + 408);
      if ( (_WORD)v64 )
      {
...
LABEL_311:
  ...
  v93 = (_QWORD *)(CurrentProcessWin32Process + 328);
  v94 = *(struct tagTHREADINFO **)(CurrentProcessWin32Process + 328);
  if ( v94 )
  {
    if ( v94 == v2 )
      goto LABEL_320;
...
LABEL_320:
  ...
  {
    v116 = (struct tagTHREADINFO *)*((_QWORD *)*v51 + 41);
    if ( !v116 )
      v116 = gptiForeground;
