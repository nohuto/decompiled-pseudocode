/*
 * XREFs of PostUpdateKeyStateEvent @ 0x1C00897C0
 * Callers:
 *     NtUserGetKeyState @ 0x1C004E960 (NtUserGetKeyState.c)
 *     UpdateAsyncKeyState @ 0x1C0089620 (UpdateAsyncKeyState.c)
 *     ?ApplyFullKeyboardStates@@YAXPEAX0@Z @ 0x1C01ECCC8 (-ApplyFullKeyboardStates@@YAXPEAX0@Z.c)
 * Callees:
...
LABEL_5:
  ...
  if ( *(_DWORD *)(v7 + 96) == 4 )
  {
    ...
    *v16 = *(_OWORD *)(v18 + 13992);
    ...
    while ( v19 < 8 );
    if ( qword_1C0295588 )
      qword_1C0295588(*(_QWORD *)(a1 + 104), 8256LL);
    goto LABEL_5;
  }
