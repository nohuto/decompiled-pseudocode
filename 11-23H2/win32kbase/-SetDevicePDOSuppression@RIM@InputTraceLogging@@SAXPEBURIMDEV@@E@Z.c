/*
 * XREFs of ?SetDevicePDOSuppression@RIM@InputTraceLogging@@SAXPEBURIMDEV@@E@Z @ 0x1C0191D38
 * Callers:
 *     RIMSetDevicePDOSuppression @ 0x1C0191E18 (RIMSetDevicePDOSuppression.c)
 * Callees:
