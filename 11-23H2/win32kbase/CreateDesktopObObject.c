/*
 * XREFs of CreateDesktopObObject @ 0x1C00B43B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreateDesktopObObject(__int64 a1, void *a2, __int64 a3, void **a4)
{
  ...
  *a4 = 0LL;
  ...
  v15[0] = 48;
  v20 = 0LL;
  result = ObCreateObject(0LL, ExDesktopObjectType, v15);
  if ( (int)result >= 0 )
  {
    v8 = *a4;
    memset(*a4, 0, 0x158uLL);
    *v8 = *(_DWORD *)SGDGetUserSessionState(v10, v9, v11, v12);
    ObjectSecurity = ObGetObjectSecurity(a2, &SecurityDescriptor, &MemoryAllocated);
    if ( ObjectSecurity < 0
      || (ObjectSecurity = ObAssignSecurity(a3, SecurityDescriptor, v8, ExDesktopObjectType, 0LL, 344, 0, 0, a4),
