/*
 * XREFs of ?EmitSetStartPointCommand@CLinearGradientLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021A34C
 * Callers:
...
char __fastcall DirectComposition::CLinearGradientLegacyMilBrushMarshaler::EmitSetStartPointCommand(
