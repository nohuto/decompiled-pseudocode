/*
 * XREFs of ?_Dequeue@CMouseQueue@CMouseProcessor@@AEAAXPEAURawMouseEvent@2@@Z @ 0x1C00562D4
 * Callers:
        ...
        struct CMouseProcessor::RawMouseEvent *a2)
{
  ...
  if ( !*((_WORD *)this + 1345) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 6554LL);
