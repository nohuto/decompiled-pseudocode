/*
 * XREFs of ?DrvChangeDisplayFallback@@YAJPEAXEEPEAU_MDEV@@PEAPEAU1@PEAW4_DXGK_DIAG_SDC_STAGE@@PEAEPEAJ@Z @ 0x1C0016214
 * Callers:
        ...
        int *a8)
{
  ...
  v9 = a2;
  v12 = *(_QWORD *)(SGDGetSessionState() + 24);
  if ( *(_DWORD *)(v12 + 1292) )
  ...
  if ( *(_DWORD *)(v12 + 1296) )
    WdLogSingleEntry0(1LL);
  *(_DWORD *)(v12 + 1296) = 1;
  v13 = DrvChangeDisplaySettingsInternal(0LL, 0LL, 0LL, a1, 0, 1, a4, a5, 0, 1, v9, 1, 0);
  *(_DWORD *)(v12 + 1296) = 0;
  v14 = v13;
  switch ( v13 )
  {
