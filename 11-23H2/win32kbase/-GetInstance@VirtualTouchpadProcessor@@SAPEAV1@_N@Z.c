/*
 * XREFs of ?GetInstance@VirtualTouchpadProcessor@@SAPEAV1@_N@Z @ 0x1C01F142C
 * Callers:
...
LABEL_24:
            VirtualTouchpadProcessor::s_instance = (PVOID)UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64;
