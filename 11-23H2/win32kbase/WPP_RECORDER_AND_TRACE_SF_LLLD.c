/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_LLLD @ 0x1C019A160
 * Callers:
 *     RIMGetPnpActionBitsFromGuid @ 0x1C0199D28 (RIMGetPnpActionBitsFromGuid.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00D6930 (_guard_dispatch_icall_nop.c)
 */

__int64 WPP_RECORDER_AND_TRACE_SF_LLLD(
        __int64 a1,
        char a2,
        char a3,
        _DWORD a4,
