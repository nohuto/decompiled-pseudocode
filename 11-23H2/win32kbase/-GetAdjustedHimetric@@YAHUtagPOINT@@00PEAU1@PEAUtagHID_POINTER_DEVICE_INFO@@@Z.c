/*
 * XREFs of ?GetAdjustedHimetric@@YAHUtagPOINT@@00PEAU1@PEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01E7860
 * Callers:
 *     GetAdjustedPointerLocations @ 0x1C00E5870 (GetAdjustedPointerLocations.c)
 * Callees:
