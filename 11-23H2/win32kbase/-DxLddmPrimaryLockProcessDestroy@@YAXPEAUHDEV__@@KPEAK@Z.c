/*
 * XREFs of ?DxLddmPrimaryLockProcessDestroy@@YAXPEAUHDEV__@@KPEAK@Z @ 0x1C00AD65C
 * Callers:
 *     ?DxLddmCleanupAtProcessDestroy@@YAXK@Z @ 0x1C0034BE0 (-DxLddmCleanupAtProcessDestroy@@YAXK@Z.c)
 * Callees:
 *     ?Free@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAX@Z @ 0x1C008C460 (-Free@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAX@Z.c)
 *     DxLddmFindProcessEntry @ 0x1C00AD6B0 (DxLddmFindProcessEntry.c)
  ...
  if ( ProcessEntry )
  {
    ...
    *(_QWORD *)(v7 + 8) = v8;
    ...
    if ( v9 )
    {
      ...
      if ( qword_1C0294440 && (int)qword_1C0294440() >= 0 && qword_1C0294448 )
        qword_1C0294448(a1, (char *)v6 + 28, 1LL);
    }
    v11 = *a3 + *((_DWORD *)v6 + 6);
    if ( v11 < *a3 )
      v11 = -1;
