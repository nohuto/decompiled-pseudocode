/*
 * XREFs of ?DrvCollectColorProfileForUser@@YAJPEAU_D3DKMT_ESCAPE_WIN32K_COLOR_PROFILE@@I@Z @ 0x1C00ACE38
 * Callers:
...
NTSTATUS __fastcall DrvCollectColorProfileForUser(char *Sid, int a2)
{
  ...
  if ( (!qword_1C02945B8 || !(unsigned int)qword_1C02945B8(Sid)) && !gbOSTestSigningEnabled )
    return -1073741790;
