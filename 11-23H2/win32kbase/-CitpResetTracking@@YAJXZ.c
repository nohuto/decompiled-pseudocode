/*
 * XREFs of ?CitpResetTracking@@YAJXZ @ 0x1C02346EC
 * Callers:
...
__int64 CitpResetTracking(void)
{
  ...
  v0 = xmmword_1C0293D20;
  if ( !xmmword_1C0293D20 )
    goto LABEL_2;
  CitpContextFlush(xmmword_1C0293D20, (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24);
  ...
  *((_WORD *)&qword_1C0293D14 + 2) = 0;
  ...
  CitpParametersLoad((struct _CIT_PARAMETERS *)&xmmword_1C0293D04, v4);
