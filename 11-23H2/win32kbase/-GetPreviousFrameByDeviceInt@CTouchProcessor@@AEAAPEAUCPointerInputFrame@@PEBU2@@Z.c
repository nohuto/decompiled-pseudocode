/*
 * XREFs of ?GetPreviousFrameByDeviceInt@CTouchProcessor@@AEAAPEAUCPointerInputFrame@@PEBU2@@Z @ 0x1C00E434E
 * Callers:
        ...
        const struct CPointerInputFrame *a2)
{
  ...
  if ( !(unsigned int)CTouchProcessor::CTouchProcessorLocked(this) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8449);
  ...
  if ( *((_DWORD *)v6 + 13) > *((_DWORD *)v6 + 12) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8471);
  if ( *((_DWORD *)v6 + 13) == *((_DWORD *)v6 + 12) )
    return 0LL;
  if ( *((_QWORD *)v6 + 8) != *((_QWORD *)a2 + 8) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 8479);
