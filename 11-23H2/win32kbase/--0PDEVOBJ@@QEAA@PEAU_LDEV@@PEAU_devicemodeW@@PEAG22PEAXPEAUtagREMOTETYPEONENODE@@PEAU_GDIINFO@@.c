/*
 * XREFs of ??0PDEVOBJ@@QEAA@PEAU_LDEV@@PEAU_devicemodeW@@PEAG22PEAXPEAUtagREMOTETYPEONENODE@@PEAU_GDIINFO@@PEAUtagDEVINFO@@HKK@Z @ 0x1C0154F90
 * Callers:
 ...
 *     ?GeneratePDEVUniqueUMPDHandle@@YAPEAUHDEV__@@XZ @ 0x1C0155BD4 (-GeneratePDEVUniqueUMPDHandle@@YAPEAUHDEV__@@XZ.c)
        ...
        unsigned int a13)
{
  ...
  __int64 (__fastcall *v73)(_QWORD, _QWORD, _QWORD); // rax
  __int64 (__fastcall *v74)(_QWORD, _QWORD, _QWORD); // rax
  __int64 (__fastcall *v75)(_QWORD, _QWORD, _QWORD); // rax
  _QWORD *v76; // rax
  __int64 v77; // rdx
  _QWORD *v78; // rax
  ...
  struct tagDEVINFO *v82; // [rsp+40h] [rbp-C0h]
  HDEV v83; // [rsp+48h] [rbp-B8h]
  unsigned __int16 *v84; // [rsp+60h] [rbp-A0h] BYREF
  unsigned int v85; // [rsp+68h] [rbp-98h] BYREF
  __int64 v86; // [rsp+70h] [rbp-90h] BYREF
  void *v87; // [rsp+78h] [rbp-88h] BYREF
  struct _DRVFN *v88; // [rsp+80h] [rbp-80h] BYREF
  _QWORD v89[4]; // [rsp+88h] [rbp-78h] BYREF
  int v90; // [rsp+A8h] [rbp-58h]
  _BYTE v91[432]; // [rsp+B0h] [rbp-50h] BYREF
  ...
  *(_QWORD *)(v17 + 3560) = 0LL;
  ...
  {
    if ( qword_1C0294B38 && (int)qword_1C0294B38() >= 0 )
    {
      v21 = 0LL;
      v88 = 0LL;
      v22 = 0;
  ...
  *(_QWORD *)(*(_QWORD *)this + 1496LL) = a5;
  if ( Src && a11 )
  {
    ...
    while ( Src[v24] );
    v25 = 2 * v24 + 2;
    *(_QWORD *)(*(_QWORD *)this + 3560LL) = PALLOCMEM(v25, 0x706D7547u);
  ...
  SETFLAG(v23, (volatile unsigned int *)(v17 + 40), 0x8000);
  v36 = *(_QWORD *)(SGDGetSessionState(v35) + 24);
  if ( v23 )
  {
    *(_QWORD *)(*(_QWORD *)this + 1768LL) = *((_QWORD *)a2 + 5);
    EngAcquireSemaphore(*(HSEMAPHORE *)(v36 + 8));
    EtwTraceGreLockAcquireSemaphoreExclusive((__int64)L"GreBaseGlobals.hsemDriverMgmt", *(_QWORD *)(v36 + 8), 16);
    *(_QWORD *)(*(_QWORD *)this + 16LL) = GeneratePDEVUniqueUMPDHandle();
    **(_QWORD **)this = *(_QWORD *)(v36 + 6072);
    v37 = *(_QWORD *)(v36 + 8);
    *(_QWORD *)(v36 + 6072) = *(_QWORD *)this;
    EtwTraceGreLockReleaseSemaphore((__int64)L"GreBaseGlobals.hsemDriverMgmt", v37);
    GreReleaseSemaphoreInternal(*(struct _ERESOURCE **)(v36 + 8));
  }
  v90 = 0;
  PushThreadGuardedObject(v89, (__int64)this, (__int64)lambda_792d576b28627a5f7e8ec309c675ba6b_::_lambda_invoker_cdecl_);
  v38 = v87;
  v83 = *(HDEV *)this;
  v39 = (struct _GDIINFO *)(*(_QWORD *)this + 2104LL);
  v82 = (struct tagDEVINFO *)(*(_QWORD *)this + 1792LL);
  ...
  if ( *(_DWORD *)(*(_QWORD *)(v18 + 1760) + 24LL) != 6 )
  {
    ...
    *v42 = v44;
    ...
    if ( (*(_DWORD *)(v47 + 1792) & 0x80000) == 0 )
      v51 = v50;
    *(_DWORD *)(v47 + 2140) = v51;
    EPALOBJ::EPALOBJ((EPALOBJ *)&v84, *(HPALETTE *)(*(_QWORD *)this + 2088LL));
    v52 = v84;
    if ( !v84 )
      goto LABEL_79;
...
LABEL_74:
      if ( (*(_DWORD *)(*(_QWORD *)this + 2140LL) & 0x100) != 0 )
      {
        ...
        {
LABEL_79:
          EPALOBJ::~EPALOBJ((int **)&v84);
LABEL_80:
          lambda_792d576b28627a5f7e8ec309c675ba6b_::operator()(v18, (struct PDEV **)this);
          return this;
        }
      }
      else
...
LABEL_85:
        ...
        *(_QWORD *)(v63 + 1776) = v52;
          ...
          || v65 == 4 )
        {
          ...
          {
            if ( qword_1C0294B48 && (int)qword_1C0294B48() >= 0 )
            {
              v66 = (unsigned int (__fastcall *)(PDEVOBJ *))qword_1C0294B50;
LABEL_95:
              if ( !v66 || !v66(this) )
                goto LABEL_80;
            }
          }
          else if ( qword_1C0294B58 && (int)qword_1C0294B58() >= 0 )
          {
            v66 = (unsigned int (__fastcall *)(PDEVOBJ *))qword_1C0294B60;
            goto LABEL_95;
          }
        }
        ...
        *(_QWORD *)(*(_QWORD *)this + 1744LL) = *(_QWORD *)(v17 + 3360);
        if ( qword_1C0294B68 && (int)qword_1C0294B68() >= 0 )
        {
          v68 = qword_1C0294B70 ? (_DWORD *)qword_1C0294B70() : 0LL;
          *(_QWORD *)(v36 + 6064) = v68;
          if ( *v68 )
          {
            if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 1760LL) + 24LL) == 1 )
            {
              if ( qword_1C0294B78 && (int)qword_1C0294B78() >= 0 && qword_1C0294B80 )
                qword_1C0294B80(*(unsigned int *)(*(_QWORD *)this + 2148LL));
              **(_DWORD **)(v36 + 6064) = 0;
            }
          }
        }
        ...
        *(_DWORD *)(*(_QWORD *)this + 3568LL) = 0;
        ...
        else if ( qword_1C0294B98 )
        {
          if ( (int)qword_1C0294B98() >= 0 )
          {
            v73 = hfontCreate((__int64)v91, 4LL);
...
LABEL_136:
  ...
  *(_DWORD *)(*(_QWORD *)this + 12LL) = 1;
  ...
  {
    PDEVOBJ::bDisabled((PDEVOBJ *)&v86, 1);
  ...
  *(_QWORD *)(v36 + 6080) = *(_QWORD *)this;
  EtwTraceGreLockReleaseSemaphore((__int64)L"GreBaseGlobals.hsemDriverMgmt", v77);
  GreReleaseSemaphoreInternal(*(struct _ERESOURCE **)(v36 + 8));
  PDEVOBJ::CompletePDEV((PDEVOBJ *)&v86, *(struct DHPDEV__ **)(*(_QWORD *)this + 1768LL), *(HDEV *)this);
