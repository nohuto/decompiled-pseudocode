/*
 * XREFs of NtUserGetExtendedPointerDeviceProperty @ 0x1C0144610
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RIMGetExtendedPointerDeviceProperty @ 0x1C01995B8 (RIMGetExtendedPointerDeviceProperty.c)
 */

__int64 __fastcall NtUserGetExtendedPointerDeviceProperty(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ULONG64 v4; // rdi
  int v6; // ebx
  ULONG v7; // ecx
