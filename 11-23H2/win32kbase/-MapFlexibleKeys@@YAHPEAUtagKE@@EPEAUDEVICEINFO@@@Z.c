/*
 * XREFs of ?MapFlexibleKeys@@YAHPEAUtagKE@@EPEAUDEVICEINFO@@@Z @ 0x1C01E9F38
 * Callers:
 *     ?MapScancode@@YAHPEAUtagKE@@PEAEPEAUDEVICEINFO@@@Z @ 0x1C01EA3DC (-MapScancode@@YAHPEAUtagKE@@PEAEPEAUDEVICEINFO@@@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00CDBD0 (__security_check_cookie.c)
 *     ?IsKeyDownSpecified@@YAHEPEBE@Z @ 0x1C01E9D44 (-IsKeyDownSpecified@@YAHEPEBE@Z.c)
    ...
    do
    {
      ...
      if ( *(_BYTE *)(v11 + v8 + 1) == v5 )
      {
        ...
        if ( *(_BYTE *)(v11 + v8) == *(_BYTE *)v6 )
        {
          ...
          v12 = 0;
          v13 = (unsigned __int8 *)&unk_1C0266878;
          do
          {
            v14 = *v13;
