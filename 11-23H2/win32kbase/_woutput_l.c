/*
 * XREFs of _woutput_l @ 0x1C00CF0DC
 * Callers:
 ...
 *     write_multi_char_0 @ 0x1C00CFA80 (write_multi_char_0.c)
 *     write_string_0 @ 0x1C00CFAD8 (write_string_0.c)
 *     _get_printf_count_output @ 0x1C00CFBF4 (_get_printf_count_output.c)
...
LABEL_116:
                        v31 = v55 - v12 - v30;
                        if ( (v5 & 0xC) == 0 )
                          write_multi_char_0(32LL, v31, v58, &v47);
                        write_string_0(v54, v30, v58, &v47);
                        v32 = v58;
                        if ( (v5 & 0xC) == 8 )
                          write_multi_char_0(48LL, v31, v58, &v47);
                        if ( !v51 && (int)v12 > 0 )
                        {
                          v33 = (const char *)v7;
                          v34 = v12;
                          ...
                          {
                            --v34;
                            v35 = mbtowc(&v50, v33, _mb_cur_max);
                            v36 = v35;
                            if ( v35 == 2 )
                            {
                              --v34;
                        ...
                        write_string_0(v7, (unsigned int)v12, v32, &v47);
LABEL_130:
                        v11 = v47;
LABEL_131:
                        if ( v11 < 0 || (v5 & 4) == 0 )
...
LABEL_143:
                        ...
                        write_multi_char_0(32LL, v31, v32, &v47);
                        v6 = v49;
                        goto LABEL_134;
                      }
                      if ( (v5 & 2) != 0 )
