/*
 * XREFs of rimDispatchCompleteFrames @ 0x1C00E1F5C
 * Callers:
      ...
      if ( (a2[23].LowPart & 0x2000) != 0 )
      {
        if ( !gbIgnoreStressedOutStuff )
        {
          ...
          if ( v12.QuadPart != a2[3].QuadPart && v12.QuadPart != a2[43].QuadPart )
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 583);
        }
        if ( !v11[24].LowPart )
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 584);
      }
