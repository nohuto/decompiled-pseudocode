/*
 * XREFs of EnablePTPDevices @ 0x1C0134C40
 * Callers:
 ...
 *     UpdateInputSettingWnfState @ 0x1C014ED20 (UpdateInputSettingWnfState.c)
...
__int64 __fastcall EnablePTPDevices(int a1)
{
  ...
  v6 = *(_QWORD *)(*(_QWORD *)(SGDGetUserSessionState(v3, v2, v4, v5) + 16840) + 1256LL);
  KeEnterCriticalRegion();
  ExAcquirePushLockSharedEx(v6, 0LL);
  for ( i = **(_QWORD **)(*(_QWORD *)(SGDGetUserSessionState(v8, v7, v9, v10) + 16840) + 1264LL); i; i = *(_QWORD *)(i + 56) )
  {
    if ( *(_BYTE *)(i + 48) == 3
