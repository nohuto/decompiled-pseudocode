/*
 * XREFs of ?CreateInstance@CMouseSensor@@SAJPEAPEAV1@@Z @ 0x1C00C249C
 * Callers:
 *     CMouseSensor_CreateInstance @ 0x1C00C2460 (CMouseSensor_CreateInstance.c)
 * Callees:
...
__int64 __fastcall CMouseSensor::CreateInstance(struct CMouseSensor **a1)
{
  ...
  *a1 = 0LL;
  ...
  {
    Pool2 = ExAllocatePool2(260LL, 1480LL, 1885947971LL);
    if ( Pool2 )
  ...
  if ( v3 == 1 )
  {
    if ( !NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(gpLeakTrackingAllocator, 0x70694843u) )
      return 3221225495LL;
    v7 = (_QWORD *)ExAllocatePool2(v13 & 0xFFFFFFFFFFFFFFFDuLL, 1496LL, v11);
    Pool2 = (__int64)v7;
    if ( !v7
      || (_InterlockedIncrement64((volatile signed __int64 *)v1 + 14),
          *v7 = 1885947971LL,
...
LABEL_4:
  ...
  Pool2 = ExAllocatePool2(v8, 1496LL, 1885947971LL);
  if ( !Pool2 )
    return 3221225495LL;
