/*
 * XREFs of ?UpdatePointerDeviceSystemMetrics@CInputSystemMetrics@@QEAAXPEBUDEVICEINFO@@_N@Z @ 0x1C01FC9C8
 * Callers:
 ...
 *     UpdatePointerDeviceSystemMetrics @ 0x1C01E9340 (UpdatePointerDeviceSystemMetrics.c)
 * Callees:
 ...
 *     IsPublicPointerDevice @ 0x1C01E8620 (IsPublicPointerDevice.c)
  ...
  if ( IsPublicPointerDevice((__int64)a2) )
  {
    ...
    else
    {
      ...
      CInpLockSharedIfNeeded::CInpLockSharedIfNeeded(
        ...
        *(struct CInpPushLock **)(*(_QWORD *)(v13 + 16840) + 1256LL));
