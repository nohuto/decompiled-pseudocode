/*
 * XREFs of ?_UpdateLastInputTime@CInputGlobals@@AEAAX_KW4_LINP_SOURCE@@@Z @ 0x1C0011524
 * Callers:
...
char __fastcall CInputGlobals::_UpdateLastInputTime(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    LOBYTE(v4) = byte_1C0283068 - 1;
    if ( (unsigned __int8)(byte_1C0283068 - 1) > 2u && (qword_1C0283050 & 0x2000000000008000LL) != 0 )
    {
      LOBYTE(v4) = 0;
      if ( (qword_1C0283058 & 0x2000000000008000LL) == qword_1C0283058 )
      {
