/*
 * XREFs of ?ObjectInit@CompositionInputObject@@KAJPEAUCompositionObject@@PEAXPEAPEAVICompositionObject@@@Z @ 0x1C009C4F0
 * Callers:
 *     <none>
 * Callees:
 *     ??0CInputSink@@QEAA@XZ @ 0x1C009C558 (--0CInputSink@@QEAA@XZ.c)
 *     ?Initialize@CInputSink@@IEAAJAEBUCOMPOSITION_INPUT_SINK_V2@@@Z @ 0x1C009C628 (-Initialize@CInputSink@@IEAAJAEBUCOMPOSITION_INPUT_SINK_V2@@@Z.c)
 */
