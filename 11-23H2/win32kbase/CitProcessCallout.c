 ...
 *     ?CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z @ 0x1C0233D34 (-CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z.c)
 */
...
void __fastcall CitProcessCallout(__int64 a1, char a2)
{
  ...
  if ( a2 )
  {
    *(_QWORD *)(a1 + 944) = 52976LL;
    ...
    if ( xmmword_1C0293D20 && !*((_QWORD *)xmmword_1C0293D20 + 12) )
    {
...
LABEL_10:
      v11 = v4;
      if ( v4 )
        CitpContextUserLogon(xmmword_1C0293D20, &v11);
    }
  }
  else
  {
    ...
    {
      v9 = xmmword_1C0293D20;
      if ( xmmword_1C0293D20 )
      {
        if ( a1 == *((_QWORD *)xmmword_1C0293D20 + 15) )
