/*
 * XREFs of McTemplateK0qqxx_EtwWriteTransfer @ 0x1C013E518
 * Callers:
 *     EtwGdiSysMemToken @ 0x1C00C55D0 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x1C00DF1C0 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
