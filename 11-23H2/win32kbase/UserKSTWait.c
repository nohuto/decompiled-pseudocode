/*
 * XREFs of UserKSTWait @ 0x1C0055434
 * Callers:
...
__int64 UserKSTWait()
{
  ...
  if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 2LL) )
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0289810, (int)&dword_1C025E387, 0, 0, 2u, &v19);
  v3 = 0;
  memset(&v18, 0, sizeof(v18));
  v4 = 1;
  while ( 1 )
  {
    v5 = IOCPDispatcher::Wait(*(IOCPDispatcher **)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters, 0LL, 1u, &v18);
    ...
    IOCPDispatcher::Dispatch(
      *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters,
      ApcContext,
      LODWORD(v18.KeyContext));
    if ( ApcContext != 2 )
      goto LABEL_17;
    if ( LODWORD(v18.KeyContext) < *(_DWORD *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 2896LL)
      && (v12 = 32LL * LODWORD(v18.KeyContext),
          *(_QWORD *)(v12 + *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 2584)) )
    {
      v13 = *(_QWORD *)(v12 + *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 2576);
    }
    else
    {
      v13 = 0LL;
