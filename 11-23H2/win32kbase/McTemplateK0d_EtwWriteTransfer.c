/*
 * XREFs of McTemplateK0d_EtwWriteTransfer @ 0x1C013C2AC
 * Callers:
 ...
 *     EtwTraceContactVisualizationInfo @ 0x1C0138CF0 (EtwTraceContactVisualizationInfo.c)
 *     EtwTraceConvertibleState @ 0x1C0138D80 (EtwTraceConvertibleState.c)
 *     EtwTraceDockState @ 0x1C0139090 (EtwTraceDockState.c)
 *     EtwTraceDwmSyncFlushForceRenderAndWaitForBatchBegin @ 0x1C0139120 (EtwTraceDwmSyncFlushForceRenderAndWaitForBatchBegin.c)
 *     EtwTraceDwmSyncFlushForceRenderAndWaitForBatchEnd @ 0x1C0139150 (EtwTraceDwmSyncFlushForceRenderAndWaitForBatchEnd.c)
 *     EtwTraceEdgyDetectionStop @ 0x1C01391B0 (EtwTraceEdgyDetectionStop.c)
 *     EtwTraceFlipManagerCreate @ 0x1C01397E0 (EtwTraceFlipManagerCreate.c)
 *     EtwTraceFlipManagerDestroy @ 0x1C0139810 (EtwTraceFlipManagerDestroy.c)
 *     EtwTraceFlipManagerLost @ 0x1C0139840 (EtwTraceFlipManagerLost.c)
 ...
 *     EtwTracePointerPredictionStart @ 0x1C013AF10 (EtwTracePointerPredictionStart.c)
 *     EtwTracePointerPredictionStop @ 0x1C013AF40 (EtwTracePointerPredictionStop.c)
 *     EtwTraceScreenSaverProcessEvent @ 0x1C013B01C (EtwTraceScreenSaverProcessEvent.c)
 *     EtwTraceTouchPadConfidenceUpped @ 0x1C013B2D0 (EtwTraceTouchPadConfidenceUpped.c)
 *     EtwTraceTouchPadTypeDiscovered @ 0x1C013B4F0 (EtwTraceTouchPadTypeDiscovered.c)
