/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x1C00B7974
 * Callers:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x1C012DA34 (wil_details_FeatureReporting_ReportUsageToService.c)
 * Callees:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x1C00B7A18 (wil_details_FeatureReporting_RecordUsageInCache.c)
