/*
 * XREFs of UserAllocDefaultCompositionSecurityDescriptor @ 0x1C002CAF0
 * Callers:
 ...
 *     DCompositionCreateSynchronizationObject @ 0x1C0208FF0 (DCompositionCreateSynchronizationObject.c)
 * Callees:
