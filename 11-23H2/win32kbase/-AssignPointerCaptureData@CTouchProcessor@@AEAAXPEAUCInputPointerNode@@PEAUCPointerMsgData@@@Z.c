/*
 * XREFs of ?AssignPointerCaptureData@CTouchProcessor@@AEAAXPEAUCInputPointerNode@@PEAUCPointerMsgData@@@Z @ 0x1C01BA848
 * Callers:
        ...
        struct CPointerMsgData *a3)
{
  ...
  {
    LODWORD(v20) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10016);
  }
  if ( *((_QWORD *)a3 + 5) )
  {
    LODWORD(v20) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10017);
  }
  v6 = *((_DWORD *)a3 + 9);
  if ( (v6 & 1) == 0 )
  {
    if ( (v6 & 8) == 0 )
    {
      ...
      if ( (*((_DWORD *)a3 + 9) & 2) == 0 && v5 && (*(_DWORD *)(v5 + 36) & 1) == 0 )
      {
        ...
        {
          LODWORD(v20) = 0x20000;
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10043);
        }
        v8 = *(_QWORD *)(v5 + 40);
        if ( v8 )
          goto LABEL_38;
...
LABEL_38:
            *((_QWORD *)a3 + 5) = v8;
            ...
            {
              LODWORD(v20) = 0x20000;
              MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 10066);
            }
            return;
          }
        }
