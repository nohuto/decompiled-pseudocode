...
__int64 __fastcall NtGdiPolyPolyDraw(__int64 a1, void *a2, void *a3, unsigned int a4, int a5)
{
  ...
  if ( a5 == 2 )
  {
    ...
    v11 = (int)qword_1C0294CF0;
    if ( qword_1C0294CF0 )
      v11 = qword_1C0294CF0(a1, a2, a3, (unsigned int)v5);
    if ( v11 )
      return PolyPolygonRgnInternal;
  }
  else
...
LABEL_37:
      ...
      {
        if ( qword_1C0294CD8 )
          v10 = qword_1C0294CD8(a4, v27);
        if ( v10 < 0 )
          goto LABEL_60;
        v24 = (__int64 (__fastcall *)(__int64, struct _POINTL *, unsigned int *, _QWORD, unsigned int))qword_1C0294CE0;
      }
      else
      {
        if ( a5 != 2 )
        {
          switch ( a5 )
          {
            case 3:
              if ( qword_1C0294CF8 )
                v10 = qword_1C0294CF8(a4, v27);
              if ( v10 < 0 )
                goto LABEL_60;
              v22 = (__int64 (__fastcall *)(__int64, struct _POINTL *, _QWORD))qword_1C0294D00;
              break;
            case 4:
              if ( qword_1C0294D28 )
            ...
            case 5:
              ...
              if ( v10 >= 0 )
              {
                v22 = (__int64 (__fastcall *)(__int64, struct _POINTL *, _QWORD))qword_1C0294D20;
                break;
              }
LABEL_60:
              PolyPolygonRgnInternal = 0LL;
...
LABEL_61:
        ...
        if ( v10 < 0 )
          goto LABEL_60;
        v24 = (__int64 (__fastcall *)(__int64, struct _POINTL *, unsigned int *, _QWORD, unsigned int))qword_1C0294D10;
      }
      if ( v24 )
      {
