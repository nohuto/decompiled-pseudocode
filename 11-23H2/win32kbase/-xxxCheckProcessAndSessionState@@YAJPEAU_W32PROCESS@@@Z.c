...
__int64 __fastcall xxxCheckProcessAndSessionState(struct _W32PROCESS *a1)
{
  ...
  v3 = 0;
  if ( (int)IsGreIsCurrentProcessSystemCriticalSupported() >= 0 && qword_1C0294E50 && (unsigned int)qword_1C0294E50() )
    return 0LL;
  if ( gpepCSRSS && gpidLogon && (gdwHydraHint & 0x40000) != 0 )
  {
    if ( !qword_1C0294E68 || (int)qword_1C0294E68() < 0 || (gdwHydraHint & 0x10000000) != 0 )
      return 0LL;
    v3 = 1;
  }
