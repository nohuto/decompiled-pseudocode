/*
 * XREFs of McTemplateK0qqq_EtwWriteTransfer @ 0x1C00DF728
 * Callers:
 ...
 *     EtwTraceGreMovePointerBegin @ 0x1C00DF0B0 (EtwTraceGreMovePointerBegin.c)
 *     EtwTraceGreMovePointerEnd @ 0x1C00DF0F0 (EtwTraceGreMovePointerEnd.c)
 *     EtwTraceBeginPointerFrameBuildPartial @ 0x1C0138AD0 (EtwTraceBeginPointerFrameBuildPartial.c)
 *     EtwTraceBeginPointerFrameCoalesce @ 0x1C0138B00 (EtwTraceBeginPointerFrameCoalesce.c)
 *     EtwTraceBeginPointerFrameCreation @ 0x1C0138B60 (EtwTraceBeginPointerFrameCreation.c)
 *     EtwTraceBeginPointerFrameMessageGeneration @ 0x1C0138BA0 (EtwTraceBeginPointerFrameMessageGeneration.c)
 *     EtwTraceCursorSize @ 0x1C0138E10 (EtwTraceCursorSize.c)
 *     EtwTraceEndPointerFrameBuildPartial @ 0x1C0139350 (EtwTraceEndPointerFrameBuildPartial.c)
 *     EtwTraceEndPointerFrameCoalesce @ 0x1C0139380 (EtwTraceEndPointerFrameCoalesce.c)
 *     EtwTraceEndPointerFrameCommit @ 0x1C01393E0 (EtwTraceEndPointerFrameCommit.c)
 *     EtwTraceEndPointerFrameCreation @ 0x1C0139420 (EtwTraceEndPointerFrameCreation.c)
