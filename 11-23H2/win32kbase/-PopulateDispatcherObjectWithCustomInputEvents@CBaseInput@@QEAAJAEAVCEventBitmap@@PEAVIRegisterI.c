/*
 * XREFs of ?PopulateDispatcherObjectWithCustomInputEvents@CBaseInput@@QEAAJAEAVCEventBitmap@@PEAVIRegisterInputDispatcherObjects@@@Z @ 0x1C01DD230
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IRegisterInputDispatcherObjects *a3)
{
  ...
  *(_DWORD *)a2 = 0;
  v7 = 0;
  while ( *((_DWORD *)a2 + 1) && (unsigned int)v6 < 0x11 )
  {
