/*
 * XREFs of ?CollectMousePerfTelemetry@MousePerfSummary@@QEAAXAEBU_MousePerf@@@Z @ 0x1C0054E74
 * Callers:
 ...
 *     ?CalculateLatencyInMicroseconds@MousePerfSummary@@AEAA_K_K0@Z @ 0x1C0055110 (-CalculateLatencyInMicroseconds@MousePerfSummary@@AEAA_K_K0@Z.c)
 ...
 *     ?UpdatePerfData@MousePerfStage@@QEAAX_K@Z @ 0x1C00E6FA2 (-UpdatePerfData@MousePerfStage@@QEAAX_K@Z.c)
...
LABEL_4:
  ...
  if ( (unsigned int)dword_1C02882F8 > 5 )
  {
    if ( (byte_1C0288308 & 0x10) != 0 && (qword_1C0288310 & 0x10) == qword_1C0288310 )
    {
      v69 = *v21;
      v54 = *v22;
      v63 = *((_QWORD *)a2 + 4);
...
LABEL_33:
        ...
        v46 = v48;
        if ( tlgKeywordOn((__int64)&dword_1C02882F8, 0x400000000000LL) )
        {
          v56 = v51;
          v61 = *v52;
          v60 = *v53;
