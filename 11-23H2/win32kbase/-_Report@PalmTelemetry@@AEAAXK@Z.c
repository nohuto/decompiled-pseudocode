/*
 * XREFs of ?_Report@PalmTelemetry@@AEAAXK@Z @ 0x1C01B1548
 * Callers:
 ...
 *     ?RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z @ 0x1C01B1138 (-RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z.c)
 *     ?RtlStringCchPrintfA@@YAJPEAD_KPEBDZZ @ 0x1C01B1198 (-RtlStringCchPrintfA@@YAJPEAD_KPEBDZZ.c)
    ...
    if ( *((_DWORD *)this + 3) )
    {
      do
      {
        ...
        if ( v18 + 48 >= 0x800 )
        {
          ...
          if ( (unsigned int)dword_1C02883A0 > 5 && tlgKeywordOn((__int64)&dword_1C02883A0, 0x400000000000LL) )
          {
            v16 = (__int64)this + 28;
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>>(
              (__int64)&dword_1C02883A0,
              byte_1C025AD22,
              0LL,
              0LL,
              (void **)&v16);
