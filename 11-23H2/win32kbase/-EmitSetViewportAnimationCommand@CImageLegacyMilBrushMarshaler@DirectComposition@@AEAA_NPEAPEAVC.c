/*
 * XREFs of ?EmitSetViewportAnimationCommand@CImageLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021B0A4
 * Callers:
...
char __fastcall DirectComposition::CImageLegacyMilBrushMarshaler::EmitSetViewportAnimationCommand(
