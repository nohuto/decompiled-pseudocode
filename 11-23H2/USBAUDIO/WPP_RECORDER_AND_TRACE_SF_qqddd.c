/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qqddd @ 0x1C0009D58
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_qqddd(__int64 a1, char a2, char a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  __int64 result; // rax
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_04fd23808a1e3b5e5b845c20a8f4823b_Traceguids,
               23LL,
               (__int64 *)va,
               8LL,
               (__int64 *)va1,
