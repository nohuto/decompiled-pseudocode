/*
 * XREFs of PropertyAudioSignalProcessingPinValidation @ 0x1C003AA98
 * Callers:
 *     PropertyAudioSignalProcessingBasicSupport @ 0x1C002E390 (PropertyAudioSignalProcessingBasicSupport.c)
