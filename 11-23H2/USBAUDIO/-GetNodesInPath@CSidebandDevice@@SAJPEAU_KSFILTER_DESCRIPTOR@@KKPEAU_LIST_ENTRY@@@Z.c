/*
 * XREFs of ?GetNodesInPath@CSidebandDevice@@SAJPEAU_KSFILTER_DESCRIPTOR@@KKPEAU_LIST_ENTRY@@@Z @ 0x1C000EABC
 * Callers:
...
LABEL_26:
  ...
  if ( (_BYTE)a2 || v9 )
  {
    v15 = &WPP_5cf7f5f4678035f653938f327e8524e9_Traceguids;
    LOBYTE(v15) = v9;
