/*
 * XREFs of IsSidebandSupported @ 0x1C002B038
 * Callers:
...
__int64 __fastcall IsSidebandSupported(__int64 a1, BOOL *a2)
{
  ...
  *a2 = 0;
  v6 = (_DWORD *)(v2 + 860);
  v9 = (*(__int64 (__fastcall **)(__int64, __int64))(v4 + 40))(a1, v2 + 860);
  v10 = 1;
  ...
  v15 = v12;
  v16 = (unsigned int)(*v6 - 1) <= 1 && !*(_DWORD *)(v2 + 1000) && v11 && v12;
  *a2 = v16;
  if ( !v16 )
  {
    if ( *(_DWORD *)(v2 + 1000) )
    ...
    if ( !*v6 )
    {
      ...
      {
        v17 = &WPP_04fd23808a1e3b5e5b845c20a8f4823b_Traceguids;
        LOBYTE(v17) = v10;
        LOBYTE(v14) = *(_QWORD *)&WPP_RECORDER_INITIALIZED != (_QWORD)&WPP_RECORDER_INITIALIZED;
