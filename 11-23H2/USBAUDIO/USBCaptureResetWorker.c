/*
 * XREFs of USBCaptureResetWorker @ 0x1C0004370
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall USBCaptureResetWorker(PDEVICE_OBJECT DeviceObject, struct _KSPIN *Context)
{
  ...
  v7 = KeAcquireSpinLockRaiseToDpc(v2 + 14);
  v8 = 1;
  ...
  if ( (_BYTE)v5 || (_BYTE)v6 )
    WPP_RECORDER_AND_TRACE_SF_qd(WPP_GLOBAL_Control->AttachedDevice, v5, v6, WPP_GLOBAL_Control->DeviceExtension);
  v9 = v2 + 14;
  if ( *(_BYTE *)(v4 + 96) )
  {
