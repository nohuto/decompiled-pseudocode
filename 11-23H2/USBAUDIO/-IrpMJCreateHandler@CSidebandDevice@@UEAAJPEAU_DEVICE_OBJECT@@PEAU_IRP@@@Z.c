/*
 * XREFs of ?IrpMJCreateHandler@CSidebandDevice@@UEAAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z @ 0x1C0010290
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _IRP *a3)
{
  ...
  v8 = CSidebandDevice::AddFileToOpenHandles(this, v3->Tail.Overlay.CurrentStackLocation->FileObject);
  if ( v8 >= 0 )
  {
    ++**((_DWORD **)this + 5);
  ...
  if ( (_BYTE)v7 || v5 )
  {
    v9 = &WPP_5cf7f5f4678035f653938f327e8524e9_Traceguids;
    LOBYTE(v9) = v5;
    WPP_RECORDER_AND_TRACE_SF_d(WPP_GLOBAL_Control->AttachedDevice, v7, (_DWORD)v9, WPP_GLOBAL_Control->DeviceExtension);
  }
