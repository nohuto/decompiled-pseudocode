/*
 * XREFs of ?SidebandApi@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C00082F0
 * Callers:
      ...
      if ( (_BYTE)v13 || *(ULONG **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_AND_TRACE_SF_q(
          ...
          *(_QWORD *)&WPP_RECORDER_INITIALIZED != (_QWORD)&WPP_RECORDER_INITIALIZED,
          WPP_GLOBAL_Control->DeviceExtension);
      KeWaitForSingleObject((PVOID)(v15 + 552), Executive, 0, 0, 0LL);
    }
    ...
    if ( LowPart > 0x220037 )
    {
      if ( LowPart <= 0x22004F )
      {
        ...
        if ( !v27 )
        {
          ...
          SupportedFormats = CSidebandDevice::StreamOpen(this, v3);
          goto LABEL_247;
        }
        v28 = v27 - 4;
        if ( !v28 )
        ...
        if ( !v30 )
        {
          ...
          SupportedFormats = CSidebandDevice::StreamSuspend(this, v3);
          goto LABEL_247;
        }
        if ( v30 == 4 )
        {
      ...
      if ( !v31 )
      {
        ...
        SupportedFormats = CSidebandDevice::GetSiop(this, v3);
        goto LABEL_247;
      }
      v32 = v31 - 12;
      if ( !v32 )
      ...
      if ( (_BYTE)v11 || *(ULONG **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
LABEL_71:
        WPP_RECORDER_AND_TRACE_SF_(v22->AttachedDevice, v11, v12, v22->DeviceExtension);
    }
    else
    {
      if ( LowPart == 2228279 )
...
LABEL_249:
  ...
  if ( (_BYTE)v10 || v5 )
  {
    v36 = &WPP_5cf7f5f4678035f653938f327e8524e9_Traceguids;
    LOBYTE(v36) = v5;
