/*
 * XREFs of DeviceCreate @ 0x1C0006D80
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_AND_TRACE_SF_qd @ 0x1C0005144 (WPP_RECORDER_AND_TRACE_SF_qd.c)
 *     InitializeSidebandContext @ 0x1C000713C (InitializeSidebandContext.c)
 *     McGenEventRegister_EtwRegister @ 0x1C00096B0 (McGenEventRegister_EtwRegister.c)
 ...
 *     WmiRegisterProvider @ 0x1C002A1BC (WmiRegisterProvider.c)
 */
...
__int64 __fastcall DeviceCreate(__int64 a1, __int64 a2, __int16 a3)
{
  ...
  if ( Pool2 )
  {
    ...
    {
      *(_QWORD *)(a1 + 16) = v9;
      InitializeSidebandContext(v9 + 89);
      ...
      *((_BYTE *)v9 + 64) = 1;
      ...
      KeInitializeEvent((PRKEVENT)v9 + 23, NotificationEvent, 1u);
      KeInitializeSpinLock((PKSPIN_LOCK)v9 + 80);
      KeInitializeSemaphore((PRKSEMAPHORE)(v9 + 83), 0, 0x7FFFFFFF);
      v9[82] = (PDRIVER_CONTROL)(v9 + 81);
      v9[81] = (PDRIVER_CONTROL)(v9 + 81);
      v4 = IoCsqInitialize(
             (PIO_CSQ)v9 + 9,
             CsInsertIrp,
