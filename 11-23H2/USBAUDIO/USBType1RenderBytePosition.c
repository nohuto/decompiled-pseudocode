/*
 * XREFs of USBType1RenderBytePosition @ 0x1C0001600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall USBType1RenderBytePosition(__int64 a1, union _LARGE_INTEGER *a2)
{
  ...
  if ( *(_BYTE *)(v5 + 45) )
  {
    ...
    if ( v11 )
    {
      v4 = (*(__int64 (__fastcall **)(_QWORD, union _LARGE_INTEGER *))(v11 + 40))(
             *(_QWORD *)(v11 + 8),
      ...
      if ( v4 >= 0 )
      {
        ...
        while ( v16 != (__int64 *)v17 )
        {
          ...
          {
            v20 = LowPart - v19;
            if ( (unsigned int)v20 < *(_DWORD *)(v18 + 132) )
            {
              v21 = v33;
              a2[2].QuadPart += *(unsigned int *)(v18 + 12 * v20 + 140);
              v34 = *(_QWORD *)(v5 + 152);
              if ( v21 )
              {
                PerformanceFrequency.QuadPart = 0LL;
                ...
                v23 = LowPart - v31;
                v24 = ((10000000 * HIDWORD(v22.QuadPart) / (unsigned __int64)PerformanceFrequency.QuadPart) << 32)
                    + (((10000000 * HIDWORD(v22.QuadPart) % (unsigned __int64)PerformanceFrequency.QuadPart) << 32)
                     + 10000000LL * v22.LowPart)
                    / PerformanceFrequency.QuadPart;
                v25 = v24;
                if ( v24 >= *((_QWORD *)&v31 + 1) + v21 * (unsigned __int64)v23 )
                  v25 = *((_QWORD *)&v31 + 1) + v21 * v23;
                v26 = v24 - v25;
                v17 = v26 * (unsigned int)(*(_DWORD *)(v5 + 104) * *(_DWORD *)(v34 + 8)) % (1000 * v21);
                v2 = v26 * (unsigned int)(*(_DWORD *)(v5 + 104) * *(_DWORD *)(v34 + 8)) / (1000 * v21);
        ...
        v27.QuadPart = a2[2].QuadPart + *(_QWORD *)(v5 + 88);
        a2[2] = v27;
        v28 = *(union _LARGE_INTEGER *)(v5 + 80);
        if ( v27.QuadPart > (unsigned __int64)v28.QuadPart
          || (v28 = *(union _LARGE_INTEGER *)(v5 + 96), v27.QuadPart < (unsigned __int64)v28.QuadPart) )
        {
          a2[2] = v28;
        }
      }
