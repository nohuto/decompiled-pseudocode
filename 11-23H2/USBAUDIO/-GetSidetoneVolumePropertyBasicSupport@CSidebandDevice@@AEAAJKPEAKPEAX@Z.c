/*
 * XREFs of ?GetSidetoneVolumePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000F59C
 * Callers:
 ...
 *     PropertyGetDbBasicSupportSideband @ 0x1C002E7D8 (PropertyGetDbBasicSupportSideband.c)
 */
