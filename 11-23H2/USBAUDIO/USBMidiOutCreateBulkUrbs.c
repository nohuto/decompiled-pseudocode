/*
 * XREFs of USBMidiOutCreateBulkUrbs @ 0x1C00056FC
 * Callers:
 *     USBMidiOutProcessPin @ 0x1C003B000 (USBMidiOutProcessPin.c)
 * Callees:
    ...
    if ( !v4 )
    {
      ...
      if ( Request >= 0 )
      {
        ...
        *(_DWORD *)(*(_QWORD *)(v14 + 24) + 36LL) = 0;
        ...
        {
          v4 = 1;
          v12 = KsPinGetAndGate(Pin);
          KsGateTurnInputOff(v12);
          *((_BYTE *)Context + 44) = 1;
        }
        else
        {
