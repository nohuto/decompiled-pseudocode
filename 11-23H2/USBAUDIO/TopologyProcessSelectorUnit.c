/*
 * XREFs of TopologyProcessSelectorUnit @ 0x1C002E180
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a6)
{
  ...
  Pool2 = (_DWORD *)ExAllocatePool2(256LL, 8LL, 1096972357LL);
  v12 = Pool2;
  if ( Pool2 )
  {
    v8 = KsAddItemToObjectBag(*(KSOBJECT_BAG *)(a1 + 8), Pool2, ExFreePool);
    if ( v8 < 0 )
    {
      ExFreePool(v12);
    }
