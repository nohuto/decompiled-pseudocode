/*
 * XREFs of USBCaptureCreatePin @ 0x1C003B270
 * Callers:
 *     <none>
 * Callees:
 ...
 *     USBCapturePinFormatChange @ 0x1C0036EAC (USBCapturePinFormatChange.c)
 */
...
__int64 __fastcall USBCaptureCreatePin(struct _KSPIN *PointerToPointerToItem)
{
  ...
  *(_DWORD *)(v4 + 108) = *(_DWORD *)(v9 + 208);
  *(_BYTE *)(v4 + 112) = *(_BYTE *)(v9 + 212);
  ...
  {
    v20 = &WPP_5fab551e02ac3a407362f7b09a9004fb_Traceguids;
    LOBYTE(v20) = v12;
