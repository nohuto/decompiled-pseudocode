/*
 * XREFs of sub_18009E540 @ 0x18009E540
 * Callers:
...
__int64 __fastcall sub_18009E540(__int64 a1, __int64 a2)
{
  unsigned int i; // esi
  int v5; // eax
  unsigned int v6; // ebp
    ...
    if ( _bittest(&v5, i) )
    {
      ...
      do
      {
          ...
          || sub_180011DF0((_QWORD *)(16 * (v7 + 16LL * i) + a1 + 1544), (_QWORD *)(16 * (v7 + 16LL * i) + a1 + 8)) )
        {
          ...
          (*(void (__fastcall **)(__int64, _QWORD, __int64, _QWORD))(*(_QWORD *)a2 + 136LL))(a2, i, v9 + 1544, v6);
        }
        ++v6;
        ++v7;
      }
