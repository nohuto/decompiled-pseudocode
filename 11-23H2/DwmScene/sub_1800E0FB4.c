/*
 * XREFs of sub_1800E0FB4 @ 0x1800E0FB4
 * Callers:
...
__int64 __fastcall sub_1800E0FB4(int a1, unsigned int a2, __int64 a3, int a4, int a5, _QWORD *a6, __int64 a7)
{
  __int64 v8; // r9
  int v10; // r11d
  _QWORD *v11; // r10
  ...
  while ( (unsigned int)v14 < v17 )
  {
    ...
    {
      sub_180010DD0(v25, (__int64)"Index out of range while computing normals");
      sub_1800E1AFC(pExceptionObject, v25);
    ...
    v21 = v12 && (v14 & 1) != 0;
    result = sub_1800E1F58(v10, v18, v19, v20, v21, a7);
