/*
 * XREFs of sub_18000F12C @ 0x18000F12C
 * Callers:
...
int __fastcall sub_18000F12C(__int64 a1, __int64 a2, int a3)
{
  _QWORD *v3; // r14
  int v4; // eax
  __int64 v7; // rax
  ...
  *(_QWORD *)(a1 + 56) = 0LL;
  *(_QWORD *)(a1 + 48) = v7;
  v8 = sub_18000EFC4(*(_QWORD *)(a2 + 24));
  v9 = sub_18000EF98(*(_QWORD *)(a2 + 56)) + v8;
  v10 = sub_18000EF98(*(_QWORD *)(a2 + 128));
  v11 = v10 + v9;
  v12 = (SIZE_T *)(a1 + 72);
  if ( !*(_QWORD *)(a1 + 64) || *v12 < v11 )
  {
    v10 = (__int64)sub_18000ED7C(8u, v11);
    v13 = v10;
    if ( v10 )
    {
      v14 = *(void **)(a1 + 64);
  ...
  {
    v17 = v16 + *v12;
    v18 = sub_18000D20C(v16, v17, *(_BYTE **)(a2 + 56), (_QWORD *)(a1 + 16));
    v19 = sub_18000D20C(v18, v17, *(_BYTE **)(a2 + 128), (_QWORD *)(a1 + 32));
    v20 = (void *)sub_18000D280(v19, v17, *(_WORD **)(a2 + 24), v3);
