/*
 * XREFs of sub_1800DF56C @ 0x1800DF56C
 * Callers:
...
__int64 __fastcall sub_1800DF56C(__int64 *a1, int *a2)
{
  __int64 v2; // rdi
  __int64 v4; // r9
  __int64 v5; // rbx
  ...
  {
    sub_18001C9D4((__int64)a1, (__int64)a1, *(__int64 **)(v2 + 8));
    *(_QWORD *)(v2 + 8) = v2;
    *(_QWORD *)v2 = v2;
    *(_QWORD *)(v2 + 16) = v2;
    a1[1] = 0LL;
