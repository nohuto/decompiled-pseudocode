/*
 * XREFs of sub_1800E3554 @ 0x1800E3554
 * Callers:
...
__int64 __fastcall sub_1800E3554(unsigned int a1, int a2)
{
  __int64 result; // rax
  ...
  if ( a2 )
  {
    if ( a2 == 1 && a1 < 3 )
    {
      sub_180010DD0(v3, (__int64)"Number of vertices is less than three");
  ...
  else
  {
    ...
    if ( a1 != (_DWORD)result )
    {
      sub_180010DD0(v3, (__int64)"Number of vertices is not a multiple of three");
      sub_1800E1AFC(pExceptionObject, (const char *)v3);
      throw (Spectre::Framework::GeometryProcessingException *)pExceptionObject;
    }
  }
