/*
 * XREFs of sub_1800214F0 @ 0x1800214F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800214F0(__int64 a1, void *a2, __int64 a3, __int64 a4, void *a5, void *a6, int a7)
{
  __int64 result; // rax
  ...
  if ( (unsigned int)dword_1801C8188 > 5 )
  {
    ...
    v11 = a4;
    v12 = a3;
    return sub_180001010(a1, (int)&unk_1801AAD85, a3, a4, &v13, (__int64)&v12, (__int64)&v11, &v10, &v9, (__int64)&v8);
  }
  return result;
}
