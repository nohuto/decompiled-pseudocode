/*
 * XREFs of sub_1800222F0 @ 0x1800222F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800222F0(__int64 a1, int a2, void *a3)
{
  char result; // al
  __int64 v7; // rax
  ...
  if ( (unsigned int)dword_1801C81C0 > 5 )
  {
    ...
    if ( result )
    {
      ...
      return sub_18000190C(v9, byte_1801ABA5D, v10, v11, (void **)&v16, (__int64)&v13, &v15, (__int64)&v12, &v14);
    }
  }
  return result;
}
