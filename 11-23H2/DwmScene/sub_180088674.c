/*
 * XREFs of sub_180088674 @ 0x180088674
 * Callers:
 ...
 *     sub_180088894 @ 0x180088894 (sub_180088894.c)
 */

// Hidden C++ exception states: #wind=1
__int64 *__fastcall sub_180088674(__int64 *a1, size_t a2, const void *a3, size_t a4)
{
  size_t v7; // r15
  __int64 v8; // r14
  __int64 v9; // rax
  ...
  *a1 = v8;
  a1[1] = v9;
  v14 = 0;
  sub_180088894(&pExceptionObject);
  v10 = (void *)*a1;
  if ( !*a1 )
  {
    v13 = "bad allocation";
