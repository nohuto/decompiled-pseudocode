/*
 * XREFs of sub_180061AE8 @ 0x180061AE8
 * Callers:
...
_QWORD *__fastcall sub_180061AE8(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdi
  __int64 v5; // r14
  __int64 v6; // rax
