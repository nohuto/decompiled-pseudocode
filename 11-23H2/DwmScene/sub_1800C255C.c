/*
 * XREFs of sub_1800C255C @ 0x1800C255C
 * Callers:
 ...
 *     sub_1800C39E4 @ 0x1800C39E4 (sub_1800C39E4.c)
 */

__int64 __fastcall sub_1800C255C(__int64 a1)
{
  char v2; // al
  __int64 v3; // rdx
  _QWORD *v4; // rax
  ...
  if ( v2 )
  {
    v7[0] = &std::_Func_impl_no_alloc<_lambda_67580e89edb989bae1ab2e6bcdd7b69a_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
    v8 = v7;
  }
