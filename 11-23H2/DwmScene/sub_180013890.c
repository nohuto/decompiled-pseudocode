/*
 * XREFs of sub_180013890 @ 0x180013890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180013890(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v8; // r9
  __int128 *v9; // rax
  char v10; // bl
  ...
  if ( a3 )
  {
    v9 = (__int128 *)sub_18001246C(&v20, (_QWORD *)(a3 + 16));
    v10 = 1;
  }
  else
  {
  ...
  try
  {
    ...
    if ( a4 )
    {
      v12 = (__int128 *)sub_18001246C(&v20, (_QWORD *)(a4 + 16));
      v13 = v10 | 4;
    }
    else
    {
    ...
    if ( (v13 & 4) != 0 && v21 )
      sub_180010530(v21);
    v14 = *(_QWORD *)(a1 + 16);
    v15 = sub_18001338C(&v20, a2, qword_1801D6CA8);
    LOBYTE(v16) = a3 != 0;
    sub_1800446A0(v14, v15, v16);
