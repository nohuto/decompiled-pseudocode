/*
 * XREFs of sub_180016F04 @ 0x180016F04
 * Callers:
...
_QWORD *__fastcall sub_180016F04(_QWORD *a1, char *a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( a2 != v16 )
  {
    sub_180012228(v17, a2, v13);
    v16 = (char *)a1[1];
    v15 = v14 + 2;
    v17 = a2;
  }
  sub_180012228(v17, v16, v15);
  sub_18001306C((__int64)a1, (__int64)v13, v9, v3);
  return v14;
}
