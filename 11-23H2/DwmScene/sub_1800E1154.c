/*
 * XREFs of sub_1800E1154 @ 0x1800E1154
 * Callers:
...
__int64 __fastcall sub_1800E1154(int a1, unsigned int a2, __int64 a3, int a4, int a5, _QWORD *a6, __int64 a7)
{
  int v9; // r11d
  _QWORD *v10; // r9
  ...
  while ( (unsigned int)v13 < v16 )
  {
    ...
    {
      sub_180010DD0(v24, (__int64)"Index out of range while computing normals");
      sub_1800E1AFC(pExceptionObject, v24);
    ...
    v20 = v11 && (v13 & 1) != 0;
    result = sub_1800E1F58(v9, v17, v18, v19, v20, a7);
