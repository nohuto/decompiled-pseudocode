/*
 * XREFs of sub_180052860 @ 0x180052860
 * Callers:
 *     sub_180053DC0 @ 0x180053DC0 (sub_180053DC0.c)
 * Callees:
...
_QWORD *__fastcall sub_180052860(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rax
  __int64 v4; // rdi
  _QWORD *v5; // rbx
