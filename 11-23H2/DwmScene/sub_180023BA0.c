/*
 * XREFs of sub_180023BA0 @ 0x180023BA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180023BA0(__int64 a1, __int64 a2, void *a3)
{
  ...
  if ( (unsigned int)dword_1801C81C0 > 5 && sub_180001528((__int64)&dword_1801C81C0, 0x400000000000LL) )
  {
    ...
    sub_180001B44(v9, byte_1801AB961, v10, v11, (void **)&v18, (__int64)&v14, &v17, &v16, &v15);
  }
