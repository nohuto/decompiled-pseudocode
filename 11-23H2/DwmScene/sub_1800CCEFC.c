/*
 * XREFs of sub_1800CCEFC @ 0x1800CCEFC
 * Callers:
...
__int64 __fastcall sub_1800CCEFC(__int64 a1, _DWORD *a2, int a3)
{
  int v6; // edx
  unsigned int v7; // eax
  int v8; // ecx
  ...
  *(_DWORD *)a1 = *a2;
  *(_DWORD *)(a1 + 4) = a2[1];
  *(_DWORD *)(a1 + 16) = sub_1800CE15C((unsigned int)a2[4], (unsigned int)a2[5]);
  if ( (a2[5] & 0x10) != 0 )
  {
    *(_DWORD *)(a1 + 40) |= 4u;
    *(_DWORD *)(a1 + 12) = 6;
