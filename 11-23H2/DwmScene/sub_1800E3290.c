/*
 * XREFs of sub_1800E3290 @ 0x1800E3290
 * Callers:
...
__int64 __fastcall sub_1800E3290(__m128 *a1, unsigned int a2, __int64 a3, unsigned __int64 *a4, __int64 a5, char a6)
{
  __int64 v6; // r8
  __int64 v7; // r10
  __int64 v8; // r11
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      v28 = _mm_sqrt_ps(v27);
      v29 = _mm_cmpneq_ps(v27, (__m128)xmmword_180106340);
      *a1 = _mm_or_ps(
              _mm_and_ps(_mm_and_ps(_mm_div_ps(*a1, v28), _mm_cmpneq_ps((__m128)0LL, v28)), v29),
              _mm_andnot_ps(v29, (__m128)xmmword_180106390));
      v30 = _mm_and_ps(
