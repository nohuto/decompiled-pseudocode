/*
 * XREFs of sub_18008A51C @ 0x18008A51C
 * Callers:
 *     sub_18008B300 @ 0x18008B300 (sub_18008B300.c)
 * Callees:
...
_QWORD *__fastcall sub_18008A51C(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
  void **v8; // rax
  __int64 v9; // rcx
