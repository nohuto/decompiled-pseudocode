/*
 * XREFs of sub_180067AE0 @ 0x180067AE0
 * Callers:
 *     <none>
 * Callees:
...
Concurrency::details::UMSThreadProxy *__fastcall sub_180067AE0(
        __int64 a1,
  ...
  for ( i = *a2; i != v5; i += 2 )
  {
    ...
    if ( *((_BYTE *)*i + 72) )
    {
      (*(void (__fastcall **)(__int64, Concurrency::details::UMSThreadProxy **, __int64, __int64))(*(_QWORD *)a1 + 120LL))(
        ...
        a3,
        a4);
      result = (Concurrency::details::UMSThreadProxy *)sub_18005BF0C(*i, a3, a4);
    }
  }
  return result;
}
