/*
 * XREFs of sub_18001B0B0 @ 0x18001B0B0
 * Callers:
...
__m128 __fastcall sub_18001B0B0(__m128 *a1, double a2, double a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm11
  __m128 v6; // xmm13
  ...
  if ( a1 )
    *a1 = v24;
  return _mm_mul_ps(_mm_div_ps((__m128)xmmword_180106540, v24), v20);
}
