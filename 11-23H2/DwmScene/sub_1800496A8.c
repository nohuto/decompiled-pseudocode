/*
 * XREFs of sub_1800496A8 @ 0x1800496A8
 * Callers:
 ...
 *     sub_180049EA0 @ 0x180049EA0 (sub_180049EA0.c)
...
__int64 __fastcall sub_1800496A8(__int64 a1)
{
  __int64 v1; // rdx
  __int64 v2; // rcx
  char v3; // r8
  ...
  LOBYTE(v4) = v3;
  return sub_180049784(v2, v1, *(unsigned int *)(v2 + 120), v4);
}
