/*
 * XREFs of sub_18008A3AC @ 0x18008A3AC
 * Callers:
 *     sub_18008B2C0 @ 0x18008B2C0 (sub_18008B2C0.c)
 * Callees:
...
_QWORD *__fastcall sub_18008A3AC(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
  void **v8; // rax
  __int64 v9; // rcx
