/*
 * XREFs of sub_180015C10 @ 0x180015C10
 * Callers:
...
_QWORD *__fastcall sub_180015C10(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v8; // rax
  _QWORD *v9; // rax
  __int64 v10; // r10
  ...
  v8 = sub_18001C190(4136LL);
  if ( v8 )
  {
    v9 = sub_18001246C(&v15, (_QWORD *)(a1 + 464));
    v8 = sub_180052770(v10, a1, v9);
  }
  sub_180015530(v14, v8);
  v11 = v14[0];
  sub_18002A070(v14[0] + 24LL, v17);
  sub_180026B40(v11, a3, a4);
