/*
 * XREFs of sub_18002AC04 @ 0x18002AC04
 * Callers:
...
__int64 __fastcall sub_18002AC04(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rbp
  ...
  v12 = v11 + 152 * ((a2 - v3) / 152);
  sub_18002B730(v12, a3);
  v13 = a1[1];
  v14 = *a1;
  if ( a2 == v13 )
  {
    sub_18002AFDC(v14, v13, v11, a1);
  }
  else
  {
    sub_18002B050(v14, a2, v11, a1);
    sub_18002B050(a2, a1[1], v12 + 152, a1);
  }
