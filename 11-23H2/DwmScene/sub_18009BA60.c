/*
 * XREFs of sub_18009BA60 @ 0x18009BA60
 * Callers:
 *     sub_180098AA0 @ 0x180098AA0 (sub_180098AA0.c)
 * Callees:
 *     sub_18001EA20 @ 0x18001EA20 (sub_18001EA20.c)
 *     sub_18009B6F0 @ 0x18009B6F0 (sub_18009B6F0.c)
 */

_QWORD *__fastcall sub_18009BA60(_QWORD *a1, _QWORD *a2, _QWORD *a3)
{
  _QWORD *v6; // r12
  _QWORD *v7; // rax
  __int64 v8; // rsi
  ...
  if ( a2 != a3 )
  {
    ...
    if ( !v11 )
      v10 = (_QWORD *)*v10;
    v13 = sub_18001EA20((__int64)v10, v12);
    v15 = 2 * (a1[6] & v13);
...
LABEL_8:
    ...
    for ( *(_QWORD *)(v8 + 8 * v15 + 8) = v6; ; *(_QWORD *)(v8 + 8 * v15 + 8) = v9 )
    {
      ...
      if ( v26[5] >= 0x10uLL )
        v20 = (_QWORD *)*v20;
      v21 = sub_18001EA20((__int64)v20, v26[4]);
      v15 = 2 * (a1[6] & v21);
