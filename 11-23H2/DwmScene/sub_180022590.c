/*
 * XREFs of sub_180022590 @ 0x180022590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180022590(__int64 a1, __int64 a2, __int64 a3, void *a4, void *a5)
{
  ...
  _BYTE *v23; // [rsp+98h] [rbp-70h] BYREF
  ...
  if ( (unsigned int)dword_1801C81C0 > 5 && sub_180001528((__int64)&dword_1801C81C0, 0x400000000000LL) )
  {
    ...
    sub_1800029D4(v12, byte_1801AB201, v13, v14, (void **)&v23, (__int64)&v17, &v22, &v21, &v20, &v19, &v18);
  }
