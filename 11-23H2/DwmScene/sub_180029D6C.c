/*
 * XREFs of sub_180029D6C @ 0x180029D6C
 * Callers:
...
__int64 __fastcall sub_180029D6C(__int64 a1)
{
  _QWORD *v2; // rax
  __int64 v3; // r8
  __int64 v4; // rbx
  ...
  if ( !(unsigned __int8)sub_18002A5B8() )
  {
    ...
    v2 = sub_180010DD0(
           ...
           (__int64)"onecoreuap\\windows\\dwm\\spectre\\engine\\products\\components\\nativerenderer\\cpp\\source\\engine"
                    "\\concurrency.cpp");
    sub_180029ECC(pExceptionObject, v2, v3, v10);
    throw (Spectre::Engine::EngineAccessDeniedException *)pExceptionObject;
  }
  v4 = sub_18002A1BC();
  v5 = (_QWORD *)sub_18002A018(a1, v7, 0LL);
  sub_18002A538(v4, v8, *v5);
  return sub_1800E0F30(a1);
}
