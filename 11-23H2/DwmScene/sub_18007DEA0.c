...
__int64 __fastcall sub_18007DEA0(__int64 a1, __int64 a2)
{
  _QWORD *v2; // rbx
  _QWORD *v4; // rax
  _QWORD *v5; // rax
  ...
  v2 = (_QWORD *)(a1 + 56);
  v4 = sub_18001246C(v10, (_QWORD *)(a1 + 56));
  sub_180045298(a2, (__int64)v4);
  v5 = sub_18001246C(v10, v2);
  sub_180045FF8(a2, (__int64)v5);
  v6 = sub_18001246C(v10, v2);
  sub_180046554(a2, (__int64)v6);
  v7 = sub_18001246C(v10, v2);
  sub_180046AE8(a2, (__int64)v7);
  v8 = sub_18001246C(v10, v2);
  return sub_180046A58(a2, (__int64)v8);
}
