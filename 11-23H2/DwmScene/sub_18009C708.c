/*
 * XREFs of sub_18009C708 @ 0x18009C708
 * Callers:
 ...
 *     sub_18009BE18 @ 0x18009BE18 (sub_18009BE18.c)
 *     sub_18009C144 @ 0x18009C144 (sub_18009C144.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x1800E39B0 (_guard_xfg_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall sub_18009C708(__int64 a1, __int64 a2, __int64 a3, float a4, float a5)
{
  __int64 v8; // rdi
  __int64 v9; // rbx
  __int64 v10; // r14
  ...
  v9 = *(_DWORD *)(a1 + 372) / 2;
  v10 = 16LL;
  sub_1800294DC((__int64)v36, 16LL, 16LL, (__int64 (__fastcall *)(__int64))unknown_libname_7);
  sub_1800294DC((__int64)v37, 16LL, 16LL, (__int64 (__fastcall *)(__int64))unknown_libname_7);
  v11 = (float)(int)v8;
...
LABEL_10:
  ...
  {
    LODWORD(v32[0]) = 0;
    sub_18009BE18((__int64)v35, (__int64)v36, v32);
    v35[v9] = 1065353216;
  }
  v18 = 0.0;
  v22 = (float *)v35;
  do
    v18 = v18 + *v22++;
  while ( v22 != (float *)v36 );
  sub_1800294DC((__int64)v38, 16LL, 16LL, (__int64 (__fastcall *)(__int64))unknown_libname_7);
  v23 = v9;
  if ( (int)v9 > 0 )
  {
    v24 = 0LL;
...
LABEL_24:
  ...
  sub_18009C144((__int64)v36, (__int64)v38);
  sub_18009C144((__int64)v37, (__int64)v38);
  if ( v28 > 0 )
  {
    v29 = 0LL;
    do
  ...
  sub_18009C144(a2, (__int64)v36);
  sub_18009C144(a3, (__int64)v37);
  return sub_18001DE1C((__int64)v33, v30);
}
