...
__int64 __fastcall sub_1800A3E10(__int64 a1)
{
  __m128 *v1; // r8
  __m128 v2; // xmm2
  __m128 *v3; // rcx
  ...
  sub_1800A3D78(a1);
  v2 = _mm_mul_ps(v1[3], (__m128)xmmword_18019BA50);
  ...
  v4 = _mm_mul_ps(v1[1], (__m128)xmmword_18019BA50);
  ...
  v5 = _mm_mul_ps(v1[2], (__m128)xmmword_18019BA50);
  ...
  v6 = _mm_add_ps(
         _mm_sub_ps(_mm_mul_ps((__m128)xmmword_18019B9E0, *v1), _mm_mul_ps(v1[6], (__m128)xmmword_18019B8F0)),
         _mm_mul_ps(v1[8], (__m128)xmmword_18019B950));
  ...
  v7 = _mm_sub_ps(
         _mm_sub_ps(_mm_mul_ps((__m128)xmmword_18019B9E0, *v1), _mm_mul_ps((__m128)xmmword_18019B8F0, v1[6])),
         _mm_mul_ps(v1[8], (__m128)xmmword_18019B950));
  ...
  v8 = _mm_add_ps(_mm_mul_ps((__m128)xmmword_18019B960, v1[6]), _mm_mul_ps((__m128)xmmword_18019B9E0, *v1));
  ...
  v9 = _mm_mul_ps(v1[5], (__m128)xmmword_18019B9D0);
  ...
  v10 = _mm_mul_ps(v1[7], (__m128)xmmword_18019B9D0);
  ...
  v11 = _mm_mul_ps(v1[4], (__m128)xmmword_18019B9D0);
  ...
  sub_1800A3AC0(v3, COERCE_DOUBLE(1050868099LL));
  return v12;
}
