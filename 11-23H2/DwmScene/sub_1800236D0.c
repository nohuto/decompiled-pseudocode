/*
 * XREFs of sub_1800236D0 @ 0x1800236D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800236D0(__int64 a1, __int64 a2, void *a3)
{
  __int64 v3; // rbx
  __int64 *v5; // rdi
  __int64 v8; // rax
  ...
  if ( (unsigned int)dword_1801C81C0 > 5 )
  {
    ...
    if ( result )
    {
      ...
      return sub_180001B44(v16, byte_1801AB9EA, v17, v18, (void **)&v23, (__int64)&v19, &v22, &v21, &v20);
    }
  }
  return result;
}
