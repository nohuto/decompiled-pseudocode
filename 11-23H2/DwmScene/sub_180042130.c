/*
 * XREFs of sub_180042130 @ 0x180042130
 * Callers:
...
unsigned __int64 __fastcall sub_180042130(unsigned __int64 *a1, __int64 a2, double a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm1
  __m128 v6; // xmm7
  ...
  v12 = _mm_add_ps(_mm_mul_ps(v11, (__m128)xmmword_180106460[0]), v9);
  v13 = _mm_add_ps(
          _mm_add_ps(
  ...
  do
  {
    v15 = _mm_mul_ps(v11, (__m128)xmmword_180106460[result++]);
  ...
  while ( result < 8 );
  v18 = v13;
  v19 = _mm_mul_ps(_mm_sub_ps(v13, v14), (__m128)xmmword_18019B990);
  v20 = _mm_mul_ps(_mm_add_ps(v18, v14), (__m128)xmmword_18019B990);
