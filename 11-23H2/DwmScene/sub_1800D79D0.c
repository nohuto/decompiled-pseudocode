/*
 * XREFs of sub_1800D79D0 @ 0x1800D79D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800D79D0(__int64 a1, __int64 *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // r8
  __int64 v6; // rbx
  ...
  if ( *(_BYTE *)(a1 + 96) )
  {
    sub_180010DD0(&v20, (__int64)"HullShaderD3D11::Load() -- this function can only be called once per shader instance");
    v4 = sub_180010DD0(
           &v18,
  ...
  if ( !sub_180050C40((__int64)a2) )
  {
    ...
    v6 = v17;
    v7 = *(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64))(*(_QWORD *)v17 + 128LL);
    ...
    if ( v10 < 0 )
    {
      sub_18001DB68(&stru_1801C85C8, 5, "ERROR: Failed to create Hull shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
