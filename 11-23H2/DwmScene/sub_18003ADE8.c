...
__int64 *__fastcall sub_18003ADE8(__int64 *a1, __int64 *a2)
{
  __int64 v4; // rsi
  ...
  if ( v4 <= 32 )
    return sub_18003A7E4(a1, a2, (__int64 (__fastcall *)(__int64 *, __int64 *))sub_1800813A0);
  v6 = v4 - v4 / 2;
...
LABEL_10:
  v11[0] = v8;
  v11[1] = v6;
  sub_18003AAE0(a1, a2, v4, (__int64)v8, v6, (unsigned __int8 (__fastcall *)(__int64, __int64))sub_1800813A0);
  return (__int64 *)sub_18003B388(v11);
}
