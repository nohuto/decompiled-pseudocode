/*
 * XREFs of sub_180087CA0 @ 0x180087CA0
 * Callers:
...
__int64 __fastcall sub_180087CA0(_QWORD *a1, float a2, float a3, float a4, int a5, int a6)
{
  __int64 v7; // rcx
  __int64 result; // rax
  __m128 v10; // xmm5
    ...
    || HIDWORD(v33) != a6 )
  {
    ...
    *(_QWORD *)&v30 = __PAIR64__(LODWORD(a3), LODWORD(a4));
    BYTE8(v30) = 1;
    HIDWORD(v33) = a6;
    result = sub_1800883E0(v7, &v29, 0LL);
    v14 = a1[8];
    if ( v14 )
    {
      v15 = *(_QWORD *)(v14 + 112);
      ...
      *(_QWORD *)&v30 = __PAIR64__(LODWORD(a3), LODWORD(a4));
      v32 = v18;
      result = sub_1800883E0(v14, &v29, 0LL);
    }
    v19 = a1[10];
    if ( v19 )
    {
      ...
      *(_QWORD *)&v30 = __PAIR64__(LODWORD(a3), LODWORD(a4));
      v32 = v23;
      result = sub_1800883E0(v19, &v29, 0LL);
    }
    v24 = a1[12];
    if ( v24 )
    {
      ...
      *(_QWORD *)&v30 = __PAIR64__(LODWORD(a3), LODWORD(a4));
      v32 = v28;
      return sub_1800883E0(v24, &v29, 0LL);
    }
  }
  return result;
}
