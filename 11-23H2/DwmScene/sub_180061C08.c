/*
 * XREFs of sub_180061C08 @ 0x180061C08
 * Callers:
...
_QWORD *__fastcall sub_180061C08(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdi
  __int64 v5; // r14
  __int64 v6; // rax
  ...
  sub_18003E370(a1);
  v4 = *(_QWORD *)sub_180062708(a1, &v10);
  if ( v11 )
    sub_180010530(v11);
  if ( v4 )
  {
