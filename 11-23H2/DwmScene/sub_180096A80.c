/*
 * XREFs of sub_180096A80 @ 0x180096A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180096A80(__int64 a1)
{
  __int64 result; // rax
  __int64 v3; // rcx
  ...
  _DWORD *v8; // [rsp+40h] [rbp-10h] BYREF
  __int64 v9; // [rsp+48h] [rbp-8h]

  sub_180011C50(a1 + 56, &v8);
  ...
  v6 = 0LL;
  v7 = 0;
  result = sub_18003C998((__int64)v8, &v6, (__int64)&v4);
  *(_QWORD *)(a1 + 96) = 0LL;
  v3 = *(_QWORD *)(a1 + 104);
  *(_QWORD *)(a1 + 104) = 0LL;
  if ( v3 )
