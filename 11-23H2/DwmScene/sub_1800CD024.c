/*
 * XREFs of sub_1800CD024 @ 0x1800CD024
 * Callers:
...
__int64 __fastcall sub_1800CD024(__int64 a1, int a2, int a3, unsigned int a4, int a5, unsigned int a6)
{
  int v6; // edi
  _DWORD *v8; // rax
  int v9; // eax
  ...
  *(_DWORD *)(a1 + 4) = a3;
  *(_DWORD *)(a1 + 12) = 1;
  *(_DWORD *)(a1 + 16) = sub_1800CE15C(a4, a6);
  v8 = v11;
  do
    *v8++ = v6++;
  while ( v6 < 4 );
