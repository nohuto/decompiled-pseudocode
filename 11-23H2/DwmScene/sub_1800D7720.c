/*
 * XREFs of sub_1800D7720 @ 0x1800D7720
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800D7720(__int64 a1, __int64 *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // r8
  __int64 v6; // rbx
  ...
  if ( !sub_180050C40((__int64)a2) )
  {
    ...
    if ( v10 < 0 )
    {
      sub_18001DB68(&stru_1801C85A8, 5, "ERROR: Failed to create Domain shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
