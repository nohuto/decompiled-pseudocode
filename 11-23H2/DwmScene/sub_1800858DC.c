/*
 * XREFs of sub_1800858DC @ 0x1800858DC
 * Callers:
...
_QWORD *__fastcall sub_1800858DC(__int64 a1, unsigned __int16 a2, __int64 *a3)
{
  __int64 v4; // rcx
  ...
  result = sub_180011020((_QWORD *)(*(_QWORD *)(v11 + 56) + 8 * (5LL * (unsigned int)v10[10] + 2)), a3);
  v17 = a3[1];
  if ( v17 )
