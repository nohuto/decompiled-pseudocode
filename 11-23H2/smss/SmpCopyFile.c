/*
 * XREFs of SmpCopyFile @ 0x140017908
 * Callers:
...
__int64 __fastcall SmpCopyFile(HANDLE FileHandle, struct _UNICODE_STRING *a2, union _LARGE_INTEGER a3)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v3.QuadPart )
    {
      ...
      if ( v3.QuadPart % (unsigned __int64)(unsigned int)dword_14002BC28 )
        v8 = dword_14002BC28;
  ...
  if ( FileHandlea )
  {
          ...
          v12 < 0) )
    {
      ...
      if ( (unsigned int)dword_14002A028 > 5 )
      {
        ...
        v29 = &v24;
        v30 = 8LL;
        tlgWriteTransfer_EtwEventWriteTransfer(4LL, byte_140025DE1, v13, v14, 4, (__int64)v26);
      }
      v11 = FileHandlea;
    }
    NtClose(v11);
