/*
 * XREFs of SmpComputeDesiredPfSizeBasedOnHistory @ 0x140016AB8
 * Callers:
 *     SmpInitializeManagedPagefileSupport @ 0x1400171B4 (SmpInitializeManagedPagefileSupport.c)
 * Callees:
...
__int64 SmpComputeDesiredPfSizeBasedOnHistory()
{
  ...
  v25 = L"\\Registry\\Machine\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion";
  v24 = 8257660;
...
LABEL_20:
    v19 = v17;
    memcpy_0(Base, &unk_14002BD54, 4LL * v17);
    goto LABEL_21;
  }
  v19 = 0LL;
LABEL_21:
  qsort(Base, v19, 4uLL, SmpPagefileUsageSampleCompare);
  v20 = (unsigned int)dword_14002BC28 * (unsigned __int64)(unsigned int)Base[9 * v17 / 0xA];
  return v20 + (v20 >> 4);
}
