/*
 * XREFs of ?InsertVector4@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UVector4@Numerics@Foundation@5@@Z @ 0x18000E720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::Api::InsertVector4(
        __int64 a1,
        HSTRING a2,
        __int64 a3)
{
