/*
 * XREFs of ?Create@InteractionTrackerInertiaNaturalMotionStatics@Interactions@Composition@UI@Windows@@UEAAJPEAUICompositor@345@PEAPEAUIInteractionTrackerInertiaNaturalMotion@2345@@Z @ 0x18013E1D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTrackerInertiaNaturalMotionStatics::Create(
        Windows::UI::Composition::Interactions::InteractionTrackerInertiaNaturalMotionStatics *this,
        struct IUnknown *a2,
        struct Windows::UI::Composition::Interactions::IInteractionTrackerInertiaNaturalMotion **a3)
{
  unsigned int v4; // edi
  ...
  Microsoft::WRL2::NestableRuntimeClass *v11; // [rsp+58h] [rbp+20h] BYREF
...
LABEL_6:
  ...
  v11 = v5;
  v7 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Interactions::InteractionTrackerInertiaNaturalMotion,Windows::UI::Composition::Interactions::InteractionTrackerInertiaNaturalMotion,Windows::UI::Composition::Compositor *>(
         &v10,
         (__int64 *)&v11);
  v8 = v7;
  if ( v7 < 0 )
  {
    DoStackCaptureDirect(v7, 0x73u);
    v9 = v10;
  }
  else
  {
    v9 = 0LL;
    *a3 = (struct Windows::UI::Composition::Interactions::IInteractionTrackerInertiaNaturalMotion *)(((unsigned __int64)v10 + 168) & -(__int64)(v10 != 0LL));
    v8 = 0;
  }
  Microsoft::WRL2::ContextSession::EndApiEntry((struct _RTL_CRITICAL_SECTION *)v5);
