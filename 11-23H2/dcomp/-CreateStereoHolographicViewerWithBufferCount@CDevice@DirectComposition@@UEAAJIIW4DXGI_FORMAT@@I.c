/*
 * XREFs of ?CreateStereoHolographicViewerWithBufferCount@CDevice@DirectComposition@@UEAAJIIW4DXGI_FORMAT@@IAEBU_GUID@@PEAPEAUIDCompositionHolographicViewer@@@Z @ 0x1800F0A20
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall DirectComposition::CDevice::CreateStereoHolographicViewerWithBufferCount(
