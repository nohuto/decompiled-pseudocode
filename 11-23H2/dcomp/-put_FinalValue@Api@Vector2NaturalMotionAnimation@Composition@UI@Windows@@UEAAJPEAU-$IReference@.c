/*
 * XREFs of ?put_FinalValue@Api@Vector2NaturalMotionAnimation@Composition@UI@Windows@@UEAAJPEAU?$IReference@UVector2@Numerics@Foundation@Windows@@@Foundation@5@@Z @ 0x180168490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Vector2NaturalMotionAnimation::Api::put_FinalValue(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (*(_BYTE *)(a1 - 400) & 2) != 0 )
    {
      v6 = Windows::UI::Composition::Vector2NaturalMotionAnimation::SetVector2RefValue(&v8, v7, a1 - 32);
      v5 = v6;
      if ( v6 < 0 )
        DoStackCaptureDirect(v6, 0x85u);
      else
        v5 = 0;
    }
    else
