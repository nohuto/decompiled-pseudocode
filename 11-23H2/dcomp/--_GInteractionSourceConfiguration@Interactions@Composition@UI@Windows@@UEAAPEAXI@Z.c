/*
 * XREFs of ??_GInteractionSourceConfiguration@Interactions@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18011CB40
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::Interactions::InteractionSourceConfiguration::`scalar deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
