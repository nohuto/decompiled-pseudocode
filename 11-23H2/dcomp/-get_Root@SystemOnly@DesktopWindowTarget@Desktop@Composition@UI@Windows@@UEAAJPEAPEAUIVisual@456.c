/*
 * XREFs of ?get_Root@SystemOnly@DesktopWindowTarget@Desktop@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@456@@Z @ 0x18019FFA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Desktop::DesktopWindowTarget::SystemOnly::get_Root(
