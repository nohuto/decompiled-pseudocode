/*
 * XREFs of ??$MakeAndInitialize2@VManipulationTransform@Composition@UI@Windows@@V1234@PEAVInteropCompositor@234@AEAPEAUIDCompositionTransform@@@Details@WRL2@Microsoft@@YAJPEAPEAVManipulationTransform@Composition@UI@Windows@@$$QEAPEAVInteropCompositor@456@AEAPEAUIDCompositionTransform@@@Z @ 0x180082180
 * Callers:
 ...
 *     ?RuntimeClassInitialize@ManipulationTransform@Composition@UI@Windows@@QEAAJPEAVCompositor@234@PEAUIDCompositionTransform@@@Z @ 0x18008226C (-RuntimeClassInitialize@ManipulationTransform@Composition@UI@Windows@@QEAAJPEAVCompositor@234@PE.c)
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::ManipulationTransform,Windows::UI::Composition::ManipulationTransform,Windows::UI::Composition::InteropCompositor *,IDCompositionTransform * &>(
