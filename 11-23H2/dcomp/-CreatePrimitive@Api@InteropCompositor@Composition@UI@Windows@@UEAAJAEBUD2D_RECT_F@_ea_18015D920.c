/*
 * XREFs of ?CreatePrimitive@Api@InteropCompositor@Composition@UI@Windows@@UEAAJAEBUD2D_RECT_F@@AEBUD2D_MATRIX_3X2_F@@MPEAUIDCompositionSurface@@PEBU7@W4DCOMPOSITION_EDGE_FLAGS@@PEAUIDCompositionColorPartner@@PEAPEAUIDCompositionPrimitivePartner@@@Z @ 0x18015D920
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (*(_BYTE *)(v3 + 32) & 2) != 0 )
  {
    ...
    v7 = v8;
    if ( v8 < 0 )
      DoStackCaptureDirect(v8, 0x3B4u);
    else
      v7 = 0;
  }
  else
