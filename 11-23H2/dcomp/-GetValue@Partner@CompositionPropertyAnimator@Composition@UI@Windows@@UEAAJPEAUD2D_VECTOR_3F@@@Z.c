/*
 * XREFs of ?GetValue@Partner@CompositionPropertyAnimator@Composition@UI@Windows@@UEAAJPEAUD2D_VECTOR_3F@@@Z @ 0x180190DD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D2D_VECTOR_3F *a2)
{
  ...
  *(_QWORD *)&a2->x = 0LL;
  ...
  if ( (v2[32] & 2) != 0 )
  {
    v6 = (*(__int64 (__fastcall **)(char *, __int64 *))(*(_QWORD *)v2 + 344LL))(v2, &v9);
    v5 = v6;
    if ( v6 < 0 )
    {
      DoStackCaptureDirect(v6, 0x4D2u);
    }
    else
    {
      v5 = 0;
