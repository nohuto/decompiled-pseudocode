/*
 * XREFs of ?GetAnimatablePropertyInfo@PointLight@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18017A160
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::PointLight::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 8LL;
  v10[1] = &Windows::UI::Composition::PointLight::k_rgAnimDef;
