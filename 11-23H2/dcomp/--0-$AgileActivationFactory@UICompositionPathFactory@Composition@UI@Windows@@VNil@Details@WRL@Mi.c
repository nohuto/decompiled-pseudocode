/*
 * XREFs of ??0?$AgileActivationFactory@UICompositionPathFactory@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@V5678@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180017138
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AgileActivationFactory<Windows::UI::Composition::ICompositionPathFactory,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::AgileActivationFactory<Windows::UI::Composition::ICompositionPathFactory,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>(
        __int64 a1)
{
  _QWORD *v1; // rdi
