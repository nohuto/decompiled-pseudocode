/*
 * XREFs of ?CreateLinearGradientBrush@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUICompositionLinearGradientBrush@345@@Z @ 0x18005E100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Api::CreateLinearGradientBrush(
        Windows::UI::Composition::CompositorCommon::Api *this,
        struct Windows::UI::Composition::ICompositionLinearGradientBrush **a2)
{
  struct Windows::UI::Composition::Compositor *v2; // rdi
  int v4; // eax
  unsigned int v5; // ebx
  wil::details::in1diag3 *retaddr; // [rsp+28h] [rbp+0h]
  Windows::UI::Composition::CompositionGradientBrush *v8; // [rsp+30h] [rbp+8h] BYREF
  ...
  *a2 = 0LL;
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v4 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionLinearGradientBrush,Windows::UI::Composition::CompositionLinearGradientBrush,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v5 = v4;
    if ( v4 < 0 )
    {
      ...
      DoStackCaptureDirect(v5, 0x222Bu);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::ICompositionLinearGradientBrush *)(((unsigned __int64)v8 + 240) & ((unsigned __int128)-(__int128)(unsigned __int64)v8 >> 64));
      v5 = 0;
    }
  }
  else
