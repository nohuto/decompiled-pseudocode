/*
 * XREFs of ?QueryInterface@SceneLightingEffectFactory@Effects@Composition@UI@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180012E80
 * Callers:
 *     ?QueryInterface@SceneLightingEffectFactory@Effects@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB150 (-QueryInterface@SceneLightingEffectFactory@Effects@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAP.c)
 *     ?QueryInterface@SceneLightingEffectFactory@Effects@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB170 (-QueryInterface@SceneLightingEffectFactory@Effects@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PE.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Effects::SceneLightingEffectFactory::QueryInterface(
