/*
 * XREFs of ?get_CoordinateSpace@Api@DistantLight@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x180176620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::DistantLight::Api::get_CoordinateSpace(
        ...
        struct Windows::UI::Composition::IVisual **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v6 = (Microsoft::WRL2::NestableRuntimeClass *)*((_QWORD *)this + 7);
    v8 = 0LL;
