/*
 * XREFs of ?SetAnchorPoint@CaptureControllerBase@Internal@Composition@UI@Windows@@QEAAJAEBUVector2@Numerics@Foundation@5@@Z @ 0x18018A270
 * Callers:
 *     ?put_AnchorPoint@Partner@CaptureController@Internal@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@6@@Z @ 0x18017FC00 (-put_AnchorPoint@Partner@CaptureController@Internal@Composition@UI@Windows@@UEAAJUVector2@Numeri.c)
 *     ?put_AnchorPoint@Partner@SharedWriteCaptureController@Internal@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@6@@Z @ 0x1801828D0 (-put_AnchorPoint@Partner@SharedWriteCaptureController@Internal@Composition@UI@Windows@@UEAAJUVec.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureControllerBase::SetAnchorPoint(
        __int64 **this,
