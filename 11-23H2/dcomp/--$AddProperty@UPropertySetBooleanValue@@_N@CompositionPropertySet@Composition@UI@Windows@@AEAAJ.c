/*
 * XREFs of ??$AddProperty@UPropertySetBooleanValue@@_N@CompositionPropertySet@Composition@UI@Windows@@AEAAJPEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEB_N@Z @ 0x180092CC8
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::AddProperty<PropertySetBooleanValue,bool>(
        __int64 a1,
        HSTRING a2,
        __int64 a3,
        __int64 a4)
{
  ...
  int v21[2]; // [rsp+40h] [rbp-20h] BYREF
  ...
  v8 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<bool>(a1 + 208, v7, a4, &v19);
  v9 = v8;
  if ( v8 >= 0 )
  {
