/*
 * XREFs of ?SetInteraction@?$CVisualProxyBase@UIDCompositionCursorVisualPartner@@@DirectComposition@@UEAAJPEAUIDCompositionInteractionPartner@@@Z @ 0x1800F5650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CVisualProxyBase<IDCompositionCursorVisualPartner>::SetInteraction(
        __int64 a1,
        struct IUnknown *a2)
{
  __int64 v4; // r9
  ...
  if ( (Microsoft_Windows_DirectCompositionEnableBits & 0x80u) != 0 )
  {
    ...
    DirectComposition::CDevice::GetDeviceAndHandleWorker((v4 - 8) & -(__int64)(v4 != 0), &v9, &v8);
