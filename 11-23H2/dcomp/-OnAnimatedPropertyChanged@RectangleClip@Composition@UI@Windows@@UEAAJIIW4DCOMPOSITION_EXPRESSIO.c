/*
 * XREFs of ?OnAnimatedPropertyChanged@RectangleClip@Composition@UI@Windows@@UEAAJIIW4DCOMPOSITION_EXPRESSION_TYPE@@_N1PEBXG@Z @ 0x18017B630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::RectangleClip::OnAnimatedPropertyChanged(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        __int64 a4,
        ...
        __int16 a8)
{
  ...
  v8 = a4;
  v15[1] = &Windows::UI::Composition::RectangleClip::k_rgAnimDef;
  v15[0] = 12LL;
  if ( Windows::UI::Composition::ProxyObject::UpdateAnimatedProperty(a1, a2, a3, a4, a5, a6, (__int64)a7, a8, v15) )
    return 0LL;
  v12 = Windows::UI::Composition::CompositionClip::OnAnimatedPropertyChanged(a1, a2, a3, v8, a5, a6, a7, a8);
  v13 = v12;
  if ( v12 >= 0 )
    return 0LL;
