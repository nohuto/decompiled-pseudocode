/*
 * XREFs of ?CreateSharedVisualReferenceController@XUCPrivate2@CompositorCommon@Composition@UI@Windows@@UEAAJPEAUIVisual@345@PEAPEAUIVisualReferenceController@Private@345@@Z @ 0x180127200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::XUCPrivate2::CreateSharedVisualReferenceController(
        ...
        struct Windows::UI::Composition::Private::IVisualReferenceController **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (*((_BYTE *)v3 + 32) & 2) != 0 )
  {
    ...
    if ( v8 < 0 )
    {
      DoStackCaptureDirect(v8, 0x1AC4u);
    }
    else
    {
      v13 = 0LL;
      v10 = Windows::UI::Composition::CompositorCommon::CreateSharedVisualReferenceController(v3, v9, &v13);
      v7 = v10;
      if ( v10 < 0 )
      {
        DoStackCaptureDirect(v10, 0x1AC7u);
        if ( v13 )
