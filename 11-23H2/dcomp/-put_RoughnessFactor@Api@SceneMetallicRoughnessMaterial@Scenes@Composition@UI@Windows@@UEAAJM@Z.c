/*
 * XREFs of ?put_RoughnessFactor@Api@SceneMetallicRoughnessMaterial@Scenes@Composition@UI@Windows@@UEAAJM@Z @ 0x18013FEE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneMetallicRoughnessMaterial::Api::put_RoughnessFactor(
        ...
        float a2)
{
  ...
  if ( (*((_BYTE *)this - 208) & 2) != 0 )
  {
    *(float *)&v9 = a2;
    ...
    v8[1] = &v9;
    v8[2] = &v9;
    v10 = (void **)&Windows::UI::Composition::Scenes::SceneMetallicRoughnessMaterial::sc_RoughnessFactor;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0xA2u);
    else
      v5 = 0;
  }
  else
