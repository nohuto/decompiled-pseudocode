/*
 * XREFs of ?SetScale@CompositionGradientBrush@Composition@UI@Windows@@QEAAJAEBUVector2@Numerics@Foundation@4@@Z @ 0x1801745D8
 * Callers:
 *     ?put_Scale@Api@?$CompositionGradientBrushT@VCompositionGradientBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18012C540 (-put_Scale@Api@-$CompositionGradientBrushT@VCompositionGradientBrush@Composition@UI@Windows@@VCo.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionGradientBrush::SetScale(
        __int64 **this,
