/*
 * XREFs of ?put_BitmapInterpolationMode@Api@SceneSurfaceMaterialInput@Scenes@Composition@UI@Windows@@UEAAJW4CompositionBitmapInterpolationMode@456@@Z @ 0x180145680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneSurfaceMaterialInput::Api::put_BitmapInterpolationMode(
        wil *a1,
        int a2)
{
  __int64 v2; // rbp
  ...
  if ( (*((_BYTE *)a1 - 136) & 2) != 0 )
  {
    ...
    {
      Windows::UI::Composition::ProxyObject::SetScalarIntegerProperty((wil *)((char *)a1 - 168), 0, v2);
      *((_DWORD *)a1 + 6) = v2;
    }
  }
  else
