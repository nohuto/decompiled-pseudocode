/*
 * XREFs of ??_GProxyObject@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18010AD60
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::ProxyObject::`scalar deleting destructor'(void **this, char a2)
{
  __int64 v4; // rdx
