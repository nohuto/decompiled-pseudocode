/*
 * XREFs of ?get_WrappingUMode@Api@SceneSurfaceMaterialInput@Scenes@Composition@UI@Windows@@UEAAJPEAW4SceneWrappingMode@3456@@Z @ 0x180145500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneSurfaceMaterialInput::Api::get_WrappingUMode(
        Windows::UI::Composition::Scenes::SceneSurfaceMaterialInput::Api *this,
        enum Windows::UI::Composition::Scenes::SceneWrappingMode *a2)
{
  __int64 v4; // rcx
  unsigned int v5; // edi
  ...
  v5 = 0;
  if ( !wil::ProcessShutdownInProgress(this) && _InterlockedIncrement(&dword_180220940) == 1 )
  {
    v9 = 0LL;
    v8 = &dword_180220940;
