/*
 * XREFs of ?get_Controller@Partner@CaptureRenderTarget@Internal@Composition@UI@Windows@@UEAAJPEAPEAUICaptureControllerBase@3456@@Z @ 0x1801807C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureRenderTarget::Partner::get_Controller(
        ...
        struct Windows::UI::Composition::Internal::ICaptureControllerBase **a2)
{
  ...
  struct Windows::UI::Composition::Internal::ICaptureControllerBase *v8; // [rsp+30h] [rbp+8h] BYREF
