/*
 * XREFs of ?OnAnimatedPropertyChanged@CompositionLineGeometry@Composition@UI@Windows@@UEAAJIIW4DCOMPOSITION_EXPRESSION_TYPE@@_N1PEBXG@Z @ 0x180177930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionLineGeometry::OnAnimatedPropertyChanged(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        __int64 a4,
        ...
        __int16 a8)
{
  ...
  v8 = a4;
  v15[1] = &Windows::UI::Composition::CompositionLineGeometry::k_rgAnimDef;
  v15[0] = 2LL;
