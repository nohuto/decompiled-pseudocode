/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_HDRWallpaper@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180099F54
 * Callers:
...
_UNKNOWN **__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_HDRWallpaper>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_HDRWallpaper>::GetCachedFeatureEnabledState(
                      a1,
                      v8);
    v11 = v4;
  }
