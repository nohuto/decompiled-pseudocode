/*
 * XREFs of ??$TryGetProperty@UPropertySetQuaternionValue@@UD2DQuaternion@@@CompositionPropertySet@Composition@UI@Windows@@AEAA?AW4CompositionGetValueStatus@123@PEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DQuaternion@@@Z @ 0x1801484A0
 * Callers:
 *     ?TryGetQuaternion@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@PEAUQuaternion@Numerics@Foundation@5@PEAW4CompositionGetValueStatus@345@@Z @ 0x180149700 (-TryGetQuaternion@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@PEAUQua.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::TryGetProperty<PropertySetQuaternionValue,D2DQuaternion>(
