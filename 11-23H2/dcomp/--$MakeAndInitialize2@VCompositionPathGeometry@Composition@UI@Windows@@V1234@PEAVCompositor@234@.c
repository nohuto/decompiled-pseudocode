/*
 * XREFs of ??$MakeAndInitialize2@VCompositionPathGeometry@Composition@UI@Windows@@V1234@PEAVCompositor@234@@Details@WRL2@Microsoft@@YAJPEAPEAVCompositionPathGeometry@Composition@UI@Windows@@$$QEAPEAVCompositor@456@@Z @ 0x180040830
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionPathGeometry,Windows::UI::Composition::CompositionPathGeometry,Windows::UI::Composition::Compositor *>(
        ...
        struct Windows::UI::Composition::Compositor **a2)
{
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    v5 = (Windows::UI::Composition::CompositionGeometry *)memset_0(v4, 0, 0xC0uLL);
    v6 = v5;
    if ( v5 )
    {
      Windows::UI::Composition::CompositionGeometry::CompositionGeometry(v5);
      *(_QWORD *)v6 = &Windows::UI::Composition::CompositionPathGeometry::`vftable';
      *((_QWORD *)v6 + 23) = 0LL;
      *((_QWORD *)v6 + 21) = &Windows::UI::Composition::CompositionPathGeometry::Api::`vftable';
    }
    else
    {
      v6 = 0LL;
    ...
    v12 = 0LL;
    *((_QWORD *)v6 + 1) = &Windows::UI::Composition::CompositionPathGeometry::s_InterfaceType;
    v7 = *a2;
    v13 = v6;
    v8 = Windows::UI::Composition::ProxyObject::RuntimeClassInitialize(v6, v7, 0x7Eu, 0);
    v9 = v8;
    if ( v8 < 0 )
    {
