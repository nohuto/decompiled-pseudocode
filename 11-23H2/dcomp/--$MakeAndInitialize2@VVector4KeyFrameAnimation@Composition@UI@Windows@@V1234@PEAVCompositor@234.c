/*
 * XREFs of ??$MakeAndInitialize2@VVector4KeyFrameAnimation@Composition@UI@Windows@@V1234@PEAVCompositor@234@@Details@WRL2@Microsoft@@YAJPEAPEAVVector4KeyFrameAnimation@Composition@UI@Windows@@$$QEAPEAVCompositor@456@@Z @ 0x180121D34
 * Callers:
 *     ?CreateVector4KeyFrameAnimation@Api@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUIVector4KeyFrameAnimation@345@@Z @ 0x18010FA20 (-CreateVector4KeyFrameAnimation@Api@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUIVector4KeyFr.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Vector4KeyFrameAnimation,Windows::UI::Composition::Vector4KeyFrameAnimation,Windows::UI::Composition::Compositor *>(
...
LABEL_7:
  ...
  if ( v6 )
  {
    ...
    *((_QWORD *)v7 + 62) = &Windows::UI::Composition::Vector4KeyFrameAnimation::Api::`vftable';
  }
  else
  {
    v7 = 0LL;
  ...
  v10 = 0LL;
  *((_QWORD *)v7 + 1) = &Windows::UI::Composition::Vector4KeyFrameAnimation::s_InterfaceType;
  v8 = *a2;
  v11 = v7;
  v5 = Windows::UI::Composition::KeyFrameAnimation::RuntimeClassInitialize((__int64)v7, v8, 69);
  if ( v5 < 0 )
    goto LABEL_7;
  *a1 = v7;
  return 0LL;
