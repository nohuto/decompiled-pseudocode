/*
 * XREFs of ?put_LeftInsetScale@Api@?$CompositionNineGridBrushT@VCompositionNineGridBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJM@Z @ 0x180049F50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionNineGridBrushT<Windows::UI::Composition::CompositionNineGridBrush,Windows::UI::Composition::CompositionBrush>::Api::put_LeftInsetScale(
        __int64 a1,
        float a2)
{
  __int64 *v2; // rdi
...
LABEL_19:
    ...
    v4 = *((float *)v2 + 45);
    v37[2] = &v33;
    v36 = &Windows::UI::Composition::CompositionNineGridBrush::sc_LeftInsetScale;
    v37[0] = (char *)v2 + 180;
    if ( v4 == a2 )
    {
      v5 = 0;
    ...
    {
      v34[0] = (struct CompObjectDiagnosticsPrincipal *)Windows::UI::Composition::CompositionNineGridBrush::sc_LeftInsetScale;
