/*
 * XREFs of ??_E?$ReferenceImpl@UVector2@Numerics@Foundation@Windows@@@WRL2@Microsoft@@UEAAPEAXI@Z @ 0x1801365A0
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall Microsoft::WRL2::ReferenceImpl<Windows::Foundation::Numerics::Vector2>::`vector deleting destructor'(
        void *a1,
        volatile int *a2)
{
  char v2; // bl
