/*
 * XREFs of ?CreateSharedDistantLight@Internal@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUIDistantLight@345@@Z @ 0x180091AA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Internal::CreateSharedDistantLight(
        Windows::UI::Composition::Compositor::Internal *this,
        struct Windows::UI::Composition::IDistantLight **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    ...
    v8 = 1;
    v10 = v2;
    v4 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::DistantLight,Windows::UI::Composition::DistantLight,Windows::UI::Composition::Compositor *,bool>(
           &v9,
           &v10,
           &v8);
    v5 = v4;
    if ( v4 < 0 )
    {
      ...
      DoStackCaptureDirect(v5, 0x5FAu);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::IDistantLight *)((v9 + 264) & ((unsigned __int128)-(__int128)v9 >> 64));
      v5 = 0;
    }
  }
  else
