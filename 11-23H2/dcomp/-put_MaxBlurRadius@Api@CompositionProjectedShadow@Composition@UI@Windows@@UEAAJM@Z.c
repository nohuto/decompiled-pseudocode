/*
 * XREFs of ?put_MaxBlurRadius@Api@CompositionProjectedShadow@Composition@UI@Windows@@UEAAJM@Z @ 0x180011300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadow::Api::put_MaxBlurRadius(
        ...
        float a2)
{
  ...
  if ( (v2[32] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = &Windows::UI::Composition::CompositionProjectedShadow::sc_MaxBlurRadius;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x2B9u);
    else
      v5 = 0;
  }
  else
