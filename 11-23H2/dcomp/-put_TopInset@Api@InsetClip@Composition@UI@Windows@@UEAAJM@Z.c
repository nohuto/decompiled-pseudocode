/*
 * XREFs of ?put_TopInset@Api@InsetClip@Composition@UI@Windows@@UEAAJM@Z @ 0x1800808A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InsetClip::Api::put_TopInset(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::InsetClip::sc_TopInset;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x173u);
    else
      v5 = 0;
  }
  else
