/*
 * XREFs of ?Create@InteractionTrackerInertiaMotionStatics@Interactions@Composition@UI@Windows@@UEAAJPEAUICompositor@345@PEAPEAUIInteractionTrackerInertiaMotion@2345@@Z @ 0x18013DBF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotionStatics::Create(
        Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotionStatics *this,
        struct IUnknown *a2,
        struct Windows::UI::Composition::Interactions::IInteractionTrackerInertiaMotion **a3)
{
  unsigned int v4; // edi
...
LABEL_6:
  ...
  v11 = v5;
  v7 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion,Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion,Windows::UI::Composition::Compositor *>(
         &v10,
         (__int64 *)&v11);
  v8 = v7;
  if ( v7 < 0 )
  ...
  {
    v9 = 0LL;
    *a3 = (struct Windows::UI::Composition::Interactions::IInteractionTrackerInertiaMotion *)(((unsigned __int64)v10
                                                                                             + 168) & -(__int64)(v10 != 0LL));
    v8 = 0;
  }
  Microsoft::WRL2::ContextSession::EndApiEntry((struct _RTL_CRITICAL_SECTION *)v5);
