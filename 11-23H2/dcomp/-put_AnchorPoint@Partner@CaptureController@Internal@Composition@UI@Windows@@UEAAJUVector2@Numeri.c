/*
 * XREFs of ?put_AnchorPoint@Partner@CaptureController@Internal@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@6@@Z @ 0x18017FC00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureController::Partner::put_AnchorPoint(
        __int64 a1,
        __int64 a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v5 = Windows::UI::Composition::Internal::CaptureControllerBase::SetAnchorPoint(
           v2,
           (const struct Windows::Foundation::Numerics::Vector2 *)v7);
    v4 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0x125u);
    else
      v4 = 0;
  }
  else
