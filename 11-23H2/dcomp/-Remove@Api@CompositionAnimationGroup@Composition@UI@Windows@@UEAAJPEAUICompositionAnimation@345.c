/*
 * XREFs of ?Remove@Api@CompositionAnimationGroup@Composition@UI@Windows@@UEAAJPEAUICompositionAnimation@345@@Z @ 0x180151F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionAnimationGroup::Api::Remove(
        Windows::UI::Composition::CompositionAnimationGroup::Api *this,
        struct IUnknown *a2)
{
  Windows::UI::Composition::CompositionAnimationGroup *v2; // rdi
  struct _RTL_CRITICAL_SECTION *v4; // rsi
  unsigned int v5; // ebx
  int v6; // eax
  struct Microsoft::WRL2::ContextRuntimeClass *v8; // [rsp+30h] [rbp+8h] BYREF

  v2 = (Windows::UI::Composition::CompositionAnimationGroup::Api *)((char *)this - 128);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    if ( a2 )
    {
      ...
      if ( v6 < 0 )
      {
        DoStackCaptureDirect(v6, 0x206u);
      }
      else
      {
        Windows::UI::Composition::CompositionAnimationGroup::Remove(v2, v8);
        v5 = 0;
      }
      Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionPropertySet>::InternalUnlock(&v8);
    }
    ...
    {
      v5 = -2147024809;
      DoStackCaptureDirect(-2147024809, 0x203u);
    }
  }
  else
  {
