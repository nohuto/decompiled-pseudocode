/*
 * XREFs of ?put_FinalValue@Api@ScalarNaturalMotionAnimation@Composition@UI@Windows@@UEAAJPEAU?$IReference@M@Foundation@5@@Z @ 0x180167A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::ScalarNaturalMotionAnimation::Api::put_FinalValue(__int64 a1, __int64 a2)
{
  __int64 result; // rax
  unsigned int v4; // edi
