/*
 * XREFs of ?InsertVector3@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UVector3@Numerics@Foundation@5@@Z @ 0x180008A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::Api::InsertVector3(
        __int64 a1,
        HSTRING a2,
        __int64 a3)
{
  ...
  v5 = *(Microsoft::WRL2::ContextSession **)(a1 - 136 + 24);
