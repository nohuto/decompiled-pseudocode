/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAUIUnknown@@@?$vector@PEAUIUnknown@@V?$allocator@PEAUIUnknown@@@std@@@std@@QEAAPEAPEAUIUnknown@@QEAPEAU2@AEBQEAU2@@Z @ 0x1801ACB3C
 * Callers:
...
char *__fastcall std::vector<IUnknown *>::_Emplace_reallocate<IUnknown * const &>(_QWORD *a1, _BYTE *a2, _QWORD *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
