/*
 * XREFs of ?EnableFurtherProcessingForInput@Partner@CompositionPointerEventRouter@Composition@UI@Windows@@UEAAJH@Z @ 0x1801537A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionPointerEventRouter::Partner::EnableFurtherProcessingForInput(
        ...
        int a2)
{
  ...
  if ( (v2[8] & 2) != 0 )
  {
    ...
    else
    {
      ...
      DoStackCaptureDirect(v5, 0x329u);
    }
  }
  else
  {
