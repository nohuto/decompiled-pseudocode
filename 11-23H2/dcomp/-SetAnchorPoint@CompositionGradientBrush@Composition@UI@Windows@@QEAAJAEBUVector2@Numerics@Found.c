/*
 * XREFs of ?SetAnchorPoint@CompositionGradientBrush@Composition@UI@Windows@@QEAAJAEBUVector2@Numerics@Foundation@4@@Z @ 0x1801740CC
 * Callers:
 *     ?put_AnchorPoint@Api@?$CompositionGradientBrushT@VCompositionGradientBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18012BED0 (-put_AnchorPoint@Api@-$CompositionGradientBrushT@VCompositionGradientBrush@Composition@UI@Window.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionGradientBrush::SetAnchorPoint(
        __int64 **this,
