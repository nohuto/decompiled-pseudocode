/*
 * XREFs of ?TargetFramesPresentedWithOutstandingPresents@CCompFrameStats@@UEBAIAEBUtagCOMPOSITION_TARGET_ID@@_K1@Z @ 0x1801A9E60
 * Callers:
 *     ?TargetFramesPresentedWithOutstandingPresents@CTouchFrameStats@@UEBAIAEBUtagCOMPOSITION_TARGET_ID@@_K1@Z @ 0x1801A4460 (-TargetFramesPresentedWithOutstandingPresents@CTouchFrameStats@@UEBAIAEBUtagCOMPOSITION_TARGET_I.c)
 * Callees:
