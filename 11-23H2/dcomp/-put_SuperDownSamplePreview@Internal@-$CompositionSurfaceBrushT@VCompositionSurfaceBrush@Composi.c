/*
 * XREFs of ?put_SuperDownSamplePreview@Internal@?$CompositionSurfaceBrushT@VCompositionSurfaceBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJE@Z @ 0x18012C6E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionSurfaceBrushT<Windows::UI::Composition::CompositionSurfaceBrush,Windows::UI::Composition::CompositionBrush>::Internal::put_SuperDownSamplePreview(
        __int64 a1,
        char a2)
{
  ...
  v2 = (Windows::UI::Composition::CompositionObject *)(a1 - 184);
  v4 = *(struct _RTL_CRITICAL_SECTION **)(a1 - 184 + 24);
  Microsoft::WRL2::ContextSession::BeginApiEntry(v4);
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    *(_QWORD *)v9 = (char *)v2 + 297;
    v10 = &v13;
    v13 = a2 != 0;
    v11 = &v13;
    v14 = (PVOID *)&Windows::UI::Composition::CompositionSurfaceBrush::sc_SuperDownSample;
