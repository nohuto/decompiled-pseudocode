/*
 * XREFs of ?SetMaxAttenuationCutoff@PointLight@Composition@UI@Windows@@QEAAJM@Z @ 0x18017A6CC
 * Callers:
 *     ?put_MaxAttenuationCutoff@Api@PointLight@Composition@UI@Windows@@UEAAJM@Z @ 0x18017B070 (-put_MaxAttenuationCutoff@Api@PointLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::PointLight::SetMaxAttenuationCutoff(
        ...
        float a2)
{
  ...
  v5[1] = &v8;
  v5[2] = &v8;
  v7 = (void **)&Windows::UI::Composition::PointLight::sc_MaxAttenuationCutoff;
