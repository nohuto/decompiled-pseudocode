/*
 * XREFs of ?put_TransformMatrix@Partner@SharedWriteCaptureController@Internal@Composition@UI@Windows@@UEAAJUMatrix3x2@Numerics@Foundation@6@@Z @ 0x180182D00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::SharedWriteCaptureController::Partner::put_TransformMatrix(
        __int64 a1,
        const struct Windows::Foundation::Numerics::Matrix3x2 *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      DoStackCaptureDirect(v6, 0x12Eu);
    else
      v5 = 0;
  }
  else
