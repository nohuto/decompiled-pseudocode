/*
 * XREFs of ??0?$AgileActivationFactory@UISceneMetallicRoughnessMaterialStatics@Scenes@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@V6789@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x1801055DC
 * Callers:
 *     ??$MakeAndInitialize@VSceneMetallicRoughnessMaterialFactory@Scenes@Composition@UI@Windows@@V12345@$$V@Details@WRL@Microsoft@@YAJPEAPEAVSceneMetallicRoughnessMaterialFactory@Scenes@Composition@UI@Windows@@@Z @ 0x180104774 (--$MakeAndInitialize@VSceneMetallicRoughnessMaterialFactory@Scenes@Composition@UI@Windows@@V1234.c)
 * Callees:
 *     ??0FtmBase@WRL@Microsoft@@QEAA@XZ @ 0x18002DED4 (--0FtmBase@WRL@Microsoft@@QEAA@XZ.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x1800A8170 (_guard_xfg_dispatch_icall_nop.c)
 */

__int64 __fastcall Microsoft::WRL::AgileActivationFactory<Windows::UI::Composition::Scenes::ISceneMetallicRoughnessMaterialStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::AgileActivationFactory<Windows::UI::Composition::Scenes::ISceneMetallicRoughnessMaterialStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>(
        __int64 a1)
{
  _QWORD *v1; // rdi
  ...
  *(_QWORD *)a1 = &Microsoft::WRL::ActivationFactory<Microsoft::WRL::Implements<Microsoft::WRL::FtmBase,Windows::UI::Composition::Scenes::ISceneMetallicRoughnessMaterialStatics>,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::`vftable';
