/*
 * XREFs of ?get_WrappingVMode@Api@SceneSurfaceMaterialInput@Scenes@Composition@UI@Windows@@UEAAJPEAW4SceneWrappingMode@3456@@Z @ 0x1801455C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneSurfaceMaterialInput::Api::get_WrappingVMode(
        ...
        enum Windows::UI::Composition::Scenes::SceneWrappingMode *a2)
{
  ...
  v5 = 0;
  if ( !wil::ProcessShutdownInProgress(this) && _InterlockedIncrement(&dword_180220948) == 1 )
  {
    v9 = 0LL;
    v8 = &dword_180220948;
