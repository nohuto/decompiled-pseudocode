/*
 * XREFs of ?QueryInterface@CInteractionConfiguration@DirectComposition@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002A230
 * Callers:
 *     ?QueryInterface@CInteractionConfiguration@DirectComposition@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A8E10 (-QueryInterface@CInteractionConfiguration@DirectComposition@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
        ...
        void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      v5 = (*(__int64 (__fastcall **)(DirectComposition::CInteractionConfiguration *))(*(_QWORD *)this + 40LL))(this);
      if ( v5 < 0 )
      {
        *a3 = 0LL;
