/*
 * XREFs of ??_EInteropDDisplayRenderTarget@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180091920
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::InteropDDisplayRenderTarget::`vector deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx

  InteropProxyRef<IDCompositionRemoteAppRenderTargetPartner>::Reset(this + 19);
