/*
 * XREFs of ?TelemetrySetAnimationScenarioGUID@Internal@KeyFrameAnimation@Composition@UI@Windows@@UEAAJPEBU_GUID@@@Z @ 0x180084450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::KeyFrameAnimation::Internal::TelemetrySetAnimationScenarioGUID(
