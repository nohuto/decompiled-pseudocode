/*
 * XREFs of ?QueryInterface@CompositionIslandStatics@Composition@UI@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18008E700
 * Callers:
 *     ?QueryInterface@CompositionIslandStatics@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9D10 (-QueryInterface@CompositionIslandStatics@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CompositionIslandStatics@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9D30 (-QueryInterface@CompositionIslandStatics@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionIslandStatics::QueryInterface(
