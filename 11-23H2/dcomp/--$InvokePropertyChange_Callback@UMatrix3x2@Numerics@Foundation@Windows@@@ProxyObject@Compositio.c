/*
 * XREFs of ??$InvokePropertyChange_Callback@UMatrix3x2@Numerics@Foundation@Windows@@@ProxyObject@Composition@UI@Windows@@AEAAXW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBUMatrix3x2@Numerics@Foundation@3@@Z @ 0x1801464C4
 * Callers:
 *     ?Thunk_Message_Matrix3x2PropertyChanged_Callback_187@?$IPropertyChanged_Receive@VProxyObject@Composition@UI@Windows@@@@SAJPEAXPEAPEAX@Z @ 0x18010C4D0 (-Thunk_Message_Matrix3x2PropertyChanged_Callback_187@-$IPropertyChanged_Receive@VProxyObject@Com.c)
 * Callees:
...
char __fastcall Windows::UI::Composition::ProxyObject::InvokePropertyChange_Callback<Windows::Foundation::Numerics::Matrix3x2>(
        ...
        __int64 a4)
{
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v16 = v14;
    ...
    v19 = v16;
    v20 = a4;
    result = Microsoft::WRL2::ContextSession::LeaveSession_Callback<_lambda_a6db259483414c5f4a6b2cc09fccf246_>(v12);
  }
  v13 = Buffer;
  if ( Buffer )
  {
