/*
 * XREFs of ?SetRotationAngle@CompositionClip@Composition@UI@Windows@@QEAAJM@Z @ 0x180155A68
 * Callers:
 *     ?put_RotationAngle@Api@CompositionClip@Composition@UI@Windows@@UEAAJM@Z @ 0x1801561F0 (-put_RotationAngle@Api@CompositionClip@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionClip::SetRotationAngle(__int64 **this, float a2)
{
  int updated; // ebx
  __int64 *v5; // rcx
