/*
 * XREFs of ?QueryInterface@?$NestedWinRtImplements@VExpressionAnimation@Composition@UI@Windows@@UIExpressionAnimation@234@@WRL2@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800754A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::NestedWinRtImplements<Windows::UI::Composition::ExpressionAnimation,Windows::UI::Composition::IExpressionAnimation>::QueryInterface(
        __int64 a1,
        int *a2,
        _QWORD *a3)
{
