/*
 * XREFs of ?Create@SceneMeshFactory@Scenes@Composition@UI@Windows@@UEAAJPEAUICompositor@345@PEAPEAUISceneMesh@2345@@Z @ 0x1801322C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneMeshFactory::Create(
        Windows::UI::Composition::Scenes::SceneMeshFactory *this,
        struct IUnknown *a2,
        struct Windows::UI::Composition::Scenes::ISceneMesh **a3)
{
  unsigned int v4; // edi
...
LABEL_6:
  ...
  v11 = v5;
  v7 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Scenes::SceneMesh,Windows::UI::Composition::Scenes::SceneMesh,Windows::UI::Composition::Compositor *>(
         &v10,
         &v11);
  v8 = v7;
  if ( v7 < 0 )
  {
    DoStackCaptureDirect(v7, 0x123u);
    v9 = v10;
  }
  else
  {
    v9 = 0LL;
    *a3 = (struct Windows::UI::Composition::Scenes::ISceneMesh *)(((unsigned __int64)v10 + 152) & -(__int64)(v10 != 0LL));
    v8 = 0;
  }
  Microsoft::WRL2::ContextSession::EndApiEntry((struct _RTL_CRITICAL_SECTION *)v5);
