/*
 * XREFs of Microsoft::WRL2::ContextSession::LeaveSession_Callback__lambda_c3413dcf6b5d18fccd5a820b18bbf4cc___ @ 0x1801348C4
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::ContextSession::LeaveSession_Callback__lambda_c3413dcf6b5d18fccd5a820b18bbf4cc___(
        ...
        _QWORD *a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)*a2 + 48LL))(
         *a2,
         a2[1],
