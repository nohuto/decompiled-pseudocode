/*
 * XREFs of ?ResumeDraw@Interop@CompositionVirtualDrawingSurface@Composition@UI@Windows@@UEAAJXZ @ 0x18008D980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVirtualDrawingSurface::Interop::ResumeDraw(
        Windows::UI::Composition::CompositionVirtualDrawingSurface::Interop *this)
{
  ...
  if ( (*((_BYTE *)v1 + 32) & 2) != 0 )
  {
    v3 = Windows::UI::Composition::DrawingSurfaceBase::ResumeDraw(v1);
    v4 = v3;
    if ( v3 < 0 )
      DoStackCaptureDirect(v3, 0x224u);
    else
      v4 = 0;
  }
  else
