        ...
        unsigned __int16 a6)
{
  ...
  if ( a4 )
    Windows::UI::Composition::SparsePropertyUpdater<Windows::Foundation::Numerics::Vector3,Windows::UI::Composition::Visual,Windows::Foundation::Numerics::Vector3 (Windows::UI::Composition::Visual::*)(void)const,void (Windows::UI::Composition::Visual::*)(Windows::Foundation::Numerics::Vector3)>::UpdateApiValueWithMask(
      a2,
      a6);
}
