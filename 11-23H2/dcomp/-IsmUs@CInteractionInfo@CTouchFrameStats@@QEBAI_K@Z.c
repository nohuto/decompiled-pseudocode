/*
 * XREFs of ?IsmUs@CInteractionInfo@CTouchFrameStats@@QEBAI_K@Z @ 0x1801A8888
 * Callers:
...
unsigned __int64 __fastcall CTouchFrameStats::CInteractionInfo::IsmUs(
        ...
        unsigned __int64 a2)
{
  ...
  v2 = *((_QWORD *)this + 6);
  if ( v2 && (v3 = *((_QWORD *)this + 7)) != 0 && v3 > v2 )
