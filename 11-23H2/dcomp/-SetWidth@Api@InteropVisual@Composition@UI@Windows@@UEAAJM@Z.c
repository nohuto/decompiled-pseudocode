/*
 * XREFs of ?SetWidth@Api@InteropVisual@Composition@UI@Windows@@UEAAJM@Z @ 0x180007F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InteropVisual::Api::SetWidth(
        ...
        float a2)
{
  ...
  if ( (*((_BYTE *)this - 264) & 2) != 0 )
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      DoStackCaptureDirect(v4, 0x20Du);
    else
      v5 = 0;
  }
  else
