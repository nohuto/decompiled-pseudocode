/*
 * XREFs of ?CreateDrawingSurface2@Api@CompositionGraphicsDevice@Composition@UI@Windows@@UEAAJUSizeInt32@Graphics@5@W4DirectXPixelFormat@DirectX@75@W4DirectXAlphaMode@975@PEAPEAUICompositionDrawingSurface@345@@Z @ 0x180156DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionGraphicsDevice::Api::CreateDrawingSurface2(
        __int64 a1,
        __int64 a2,
        int a3,
        int a4,
        Microsoft::WRL2::NestableRuntimeClass *a5)
{
  ...
  Windows::UI::Composition::CompositionGraphicsDevice *v6; // rbp
  ...
  v5 = a5;
  v6 = (Windows::UI::Composition::CompositionGraphicsDevice *)(a1 - 144);
  *(_QWORD *)a5 = 0LL;
  ...
  {
    a5 = 0LL;
    v12 = Windows::UI::Composition::CompositionGraphicsDevice::CreateDrawingSurface(v6, a2, a3, a4, 0, &a5);
    v11 = v12;
    if ( v12 < 0 )
    {
      DoStackCaptureDirect(v12, 0x270u);
    }
    else
    {
      v13 = a5;
      a5 = 0LL;
      v14 = ((unsigned __int64)v13 + 192) & -(__int64)(v13 != 0LL);
      if ( v14 )
        v15 = v14 + 8;
      else
        v15 = 0LL;
