/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_CompositionTextures@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18009B1D0
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_CompositionTextures>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        int *a4)
  ...
  *(_DWORD *)a2 = v9;
  ...
  if ( (v9 & 0xC00) == 0xC00 || (v9 & 0x40) != 0 )
  {
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_MTestUx15>::ReportUsage(
      (wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_MTestUx15>::GetImpl'::`2'::impl,
      v9,
      3072LL,
      v6);
    v10 = 1;
