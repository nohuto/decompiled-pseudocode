/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$0N@@WRL@Microsoft@@$0A@UIActivationFactory@@U?$Implements@VFtmBase@WRL@Microsoft@@UISceneMeshRendererComponentStatics@Scenes@Composition@UI@Windows@@@23@VNil@Details@23@V6723@V6723@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x1801063FC
 * Callers:
 ...
 *     ?QueryInterface@SceneMeshRendererComponentFactory@Scenes@Composition@UI@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801081A0 (-QueryInterface@SceneMeshRendererComponentFactory@Scenes@Composition@UI@Windows@@UEAAJAEBU_GUID@.c)
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  else
  {
    ...
    {
      if ( InlineIsEqualGUID(a2, &GUID_4954f37a_4459_4521_bd6e_2b38b8d711ea) )
        *v9 = v7 + 32;
      else
        return v10;
    }
