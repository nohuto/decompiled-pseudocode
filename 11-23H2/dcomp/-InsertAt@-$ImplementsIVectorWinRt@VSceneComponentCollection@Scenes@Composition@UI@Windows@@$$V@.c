/*
 * XREFs of ?InsertAt@?$ImplementsIVectorWinRt@VSceneComponentCollection@Scenes@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJIPEAUISceneComponent@Scenes@234@@Z @ 0x1801435C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::Scenes::SceneComponentCollection,>::InsertAt(
        __int64 a1,
        unsigned int a2,
        struct IUnknown *a3)
{
