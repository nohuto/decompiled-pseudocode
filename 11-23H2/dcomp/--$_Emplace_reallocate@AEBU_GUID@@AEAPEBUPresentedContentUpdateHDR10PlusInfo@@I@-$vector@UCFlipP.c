/*
 * XREFs of ??$_Emplace_reallocate@AEBU_GUID@@AEAPEBUPresentedContentUpdateHDR10PlusInfo@@I@?$vector@UCFlipPropertyItem@@V?$allocator@UCFlipPropertyItem@@@std@@@std@@QEAAPEAUCFlipPropertyItem@@QEAU2@AEBU_GUID@@AEAPEBUPresentedContentUpdateHDR10PlusInfo@@$$QEAI@Z @ 0x1801AF8A0
 * Callers:
...
char *__fastcall std::vector<CFlipPropertyItem>::_Emplace_reallocate<_GUID const &,PresentedContentUpdateHDR10PlusInfo const * &,unsigned int>(
        char **a1,
        char *a2,
        __int128 *a3,
        _QWORD *a4,
