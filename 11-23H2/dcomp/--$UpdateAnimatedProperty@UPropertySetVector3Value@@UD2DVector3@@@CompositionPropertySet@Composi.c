/*
 * XREFs of ??$UpdateAnimatedProperty@UPropertySetVector3Value@@UD2DVector3@@@CompositionPropertySet@Composition@UI@Windows@@AEAAXIPEBUD2DVector3@@_N1G@Z @ 0x180004998
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::UpdateAnimatedProperty<PropertySetVector3Value,D2DVector3>(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        char a4,
        ...
        __int16 a6)
{
  ...
  v15[1] = v16;
  return Windows::UI::Composition::ProxyObject::UpdateAnimatedPropertyWorker<Windows::UI::Composition::PropertySetUpdater<PropertySetVector3Value,D2DVector3>,Windows::UI::Composition::PropertySetUpdaterInfo>(
           v9,
           (unsigned int)v15,
