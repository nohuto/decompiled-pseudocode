/*
 * XREFs of ??$MakeAndInitialize@VInteractionTrackerInteractingStateEnteredArgs@Interactions@Composition@UI@Windows@@V12345@AEAHAEA_N@Details@WRL@Microsoft@@YAJPEAPEAVInteractionTrackerInteractingStateEnteredArgs@Interactions@Composition@UI@Windows@@AEAHAEA_N@Z @ 0x180135104
 * Callers:
...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::Interactions::InteractionTrackerInteractingStateEnteredArgs,Windows::UI::Composition::Interactions::InteractionTrackerInteractingStateEnteredArgs,int &,bool &>(
        __int64 *a1,
        int *a2,
        _BYTE *a3)
{
  void *v6; // rax
  Windows::UI::Composition::Interactions::InteractionTrackerInteractingStateEnteredArgs *v8; // rax
  volatile int *v9; // rdx
  __int64 v10; // r10
  int v11; // ecx
  ...
  *a1 = 0LL;
  ...
  if ( v6 )
  {
    v8 = (Windows::UI::Composition::Interactions::InteractionTrackerInteractingStateEnteredArgs *)memset_0(
                                                                                                    v6,
                                                                                                    0,
                                                                                                    0x60uLL);
    if ( v8 )
      v10 = Windows::UI::Composition::Interactions::InteractionTrackerInteractingStateEnteredArgs::InteractionTrackerInteractingStateEnteredArgs(v8);
    else
      v10 = 0LL;
    v11 = *a2;
    *(_BYTE *)(v10 + 92) = *a3;
