/*
 * XREFs of ?Destroy@?$GlobalDesktopWindowTargetImpl@VInteropCompositionTarget@Composition@UI@Windows@@@Desktop@Composition@UI@Windows@@UEAAXXZ @ 0x18008A5D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Windows::UI::Composition::Desktop::GlobalDesktopWindowTargetImpl<Windows::UI::Composition::InteropCompositionTarget>::Destroy(
        Windows::UI::Composition::Desktop::DesktopWindowTarget *this)
{
  ...
  v1 = (Windows::UI::Composition::SystemBackdropHelper *)*((_QWORD *)this + 30);
  *((_QWORD *)this + 30) = 0LL;
  if ( v1 )
  {
  ...
  if ( *((_QWORD *)this + 24) )
  {
    ...
    v4 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 29) + 40LL))(*((_QWORD *)this + 29));
    DirectComposition::CDevice::ResourceSetReferenceProperty(v3, v4, 52, 0);
