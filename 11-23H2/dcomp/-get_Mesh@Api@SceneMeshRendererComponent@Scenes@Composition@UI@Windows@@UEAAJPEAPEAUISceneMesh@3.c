/*
 * XREFs of ?get_Mesh@Api@SceneMeshRendererComponent@Scenes@Composition@UI@Windows@@UEAAJPEAPEAUISceneMesh@3456@@Z @ 0x180133D00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneMeshRendererComponent::Api::get_Mesh(
        Windows::UI::Composition::Scenes::SceneMeshRendererComponent::Api *this,
        struct Windows::UI::Composition::Scenes::ISceneMesh **a2)
{
  __int64 v4; // rcx
  unsigned int v5; // esi
  ...
  v5 = 0;
  if ( !wil::ProcessShutdownInProgress(this) && _InterlockedIncrement(&dword_1802208E8) == 1 )
  {
    v10 = 0LL;
    v9 = (Microsoft::WRL2::NestableRuntimeClass *)&dword_1802208E8;
  ...
  *a2 = 0LL;
  ...
  if ( (*((_BYTE *)this - 184) & 2) != 0 )
  {
    ...
    if ( v7 )
    {
      ...
      v9 = 0LL;
      *a2 = (struct Windows::UI::Composition::Scenes::ISceneMesh *)(v7 + 152);
    }
