/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$0N@@WRL@Microsoft@@$0A@UIActivationFactory@@U?$Implements@VFtmBase@WRL@Microsoft@@UITransformInformationFactory@Private@Composition@UI@Windows@@@23@VNil@Details@23@V6723@V6723@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x18010672C
 * Callers:
 ...
 *     ?QueryInterface@?$ActivationFactory@U?$Implements@VFtmBase@WRL@Microsoft@@UITransformInformationFactory@Private@Composition@UI@Windows@@@WRL@Microsoft@@VNil@Details@23@V4523@$0A@@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180108500 (-QueryInterface@-$ActivationFactory@U-$Implements@VFtmBase@WRL@Microsoft@@UITransfo_ea_180108500.c)
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  else
  {
    ...
    {
      if ( InlineIsEqualGUID(a2, &GUID_a256a248_3c07_49c1_8b1c_9c47f9616c99) )
        *v9 = v7 + 32;
      else
        return v10;
    }
