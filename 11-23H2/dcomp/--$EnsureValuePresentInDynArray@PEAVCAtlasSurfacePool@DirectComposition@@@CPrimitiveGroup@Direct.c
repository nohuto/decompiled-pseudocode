/*
 * XREFs of ??$EnsureValuePresentInDynArray@PEAVCAtlasSurfacePool@DirectComposition@@@CPrimitiveGroup@DirectComposition@@AEAAJAEAV?$DynArray@PEAVCAtlasSurfacePool@DirectComposition@@$0A@@@AEBQEAVCAtlasSurfacePool@1@PEAI@Z @ 0x1800F98B8
 * Callers:
...
__int64 __fastcall DirectComposition::CPrimitiveGroup::EnsureValuePresentInDynArray<DirectComposition::CAtlasSurfacePool *>(
        __int64 a1,
        __int64 a2,
        _QWORD *a3,
        unsigned int *a4)
