/*
 * XREFs of ?First@?$ImplementsIVectorWinRt@VSceneNodeCollection@Scenes@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJPEAPEAU?$IIterator@PEAVSceneNode@Scenes@Composition@UI@Windows@@@Collections@Foundation@4@@Z @ 0x180142510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::Scenes::SceneNodeCollection,>::First(
        __int64 a1,
        _QWORD *a2)
{
  int v4; // eax
