/*
 * XREFs of ?EndDraw@Interop@CompositionVirtualDrawingSurface@Composition@UI@Windows@@UEAAJXZ @ 0x180064270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVirtualDrawingSurface::Interop::EndDraw(
        Windows::UI::Composition::CompositionVirtualDrawingSurface::Interop *this)
{
  ...
  if ( (*((_BYTE *)v1 + 32) & 2) != 0 )
  {
    v3 = Windows::UI::Composition::DrawingSurfaceBase::EndDraw(v1);
    v4 = v3;
    if ( v3 < 0 )
      DoStackCaptureDirect(v3, 0x1FCu);
    else
      v4 = 0;
  }
  else
