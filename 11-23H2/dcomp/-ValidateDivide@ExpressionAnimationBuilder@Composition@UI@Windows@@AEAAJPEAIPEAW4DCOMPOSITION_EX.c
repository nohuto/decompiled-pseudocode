/*
 * XREFs of ?ValidateDivide@ExpressionAnimationBuilder@Composition@UI@Windows@@AEAAJPEAIPEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18003F8C0
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::ExpressionAnimationBuilder::ValidateDivide(
...
LABEL_8:
  ...
  if ( v4 != 18 && v4 != 35 && v4 != 52 && v4 != 69 && v4 != 71 )
  {
    v7 = 4904;
