/*
 * XREFs of ?put_Root@Partner@SharedWriteCaptureController@Internal@Composition@UI@Windows@@UEAAJPEAUIVisual@456@@Z @ 0x180182A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::SharedWriteCaptureController::Partner::put_Root(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v7 < 0 )
    {
      DoStackCaptureDirect(v7, 0x5Eu);
    }
    else
    {
      Windows::UI::Composition::Internal::CaptureControllerBase::SetRoot(v2, v10);
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionBatch>::InternalUnlock(
      (volatile signed __int32 **)&v10,
