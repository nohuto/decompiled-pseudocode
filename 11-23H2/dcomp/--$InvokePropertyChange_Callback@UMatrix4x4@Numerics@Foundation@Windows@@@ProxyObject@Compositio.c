/*
 * XREFs of ??$InvokePropertyChange_Callback@UMatrix4x4@Numerics@Foundation@Windows@@@ProxyObject@Composition@UI@Windows@@AEAAXW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBUMatrix4x4@Numerics@Foundation@3@@Z @ 0x1801465C4
 * Callers:
 *     ?Thunk_Message_Matrix4x4PropertyChanged_Callback_193@?$IPropertyChanged_Receive@VProxyObject@Composition@UI@Windows@@@@SAJPEAXPEAPEAX@Z @ 0x18010C500 (-Thunk_Message_Matrix4x4PropertyChanged_Callback_193@-$IPropertyChanged_Receive@VProxyObject@Com.c)
 * Callees:
...
char __fastcall Windows::UI::Composition::ProxyObject::InvokePropertyChange_Callback<Windows::Foundation::Numerics::Matrix4x4>(
        ...
        __int64 a4)
{
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v16 = v14;
    ...
    v19 = v16;
    v20 = a4;
    result = Microsoft::WRL2::ContextSession::LeaveSession_Callback<_lambda_f4ab11bb8dcfcac7d428c4fc5a91824d_>(v12);
  }
  v13 = Buffer;
  if ( Buffer )
  {
