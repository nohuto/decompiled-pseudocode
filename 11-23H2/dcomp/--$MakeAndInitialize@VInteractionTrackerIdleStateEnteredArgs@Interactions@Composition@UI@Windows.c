/*
 * XREFs of ??$MakeAndInitialize@VInteractionTrackerIdleStateEnteredArgs@Interactions@Composition@UI@Windows@@V12345@AEAHAEA_N@Details@WRL@Microsoft@@YAJPEAPEAVInteractionTrackerIdleStateEnteredArgs@Interactions@Composition@UI@Windows@@AEAHAEA_N@Z @ 0x180134E88
 * Callers:
...
{
  void *v6; // rax
  Windows::UI::Composition::Interactions::InteractionTrackerIdleStateEnteredArgs *v8; // rax
  volatile int *v9; // rdx
  __int64 v10; // r10
  int v11; // ecx
  ...
  *a1 = 0LL;
  ...
  if ( v6 )
  {
    v8 = (Windows::UI::Composition::Interactions::InteractionTrackerIdleStateEnteredArgs *)memset_0(v6, 0, 0x60uLL);
    if ( v8 )
      v10 = Windows::UI::Composition::Interactions::InteractionTrackerIdleStateEnteredArgs::InteractionTrackerIdleStateEnteredArgs(v8);
    else
      v10 = 0LL;
    v11 = *a2;
    *(_BYTE *)(v10 + 92) = *a3;
