/*
 * XREFs of Microsoft::WRL2::ContextSession::LeaveSession_Callback__lambda_c8754ad6eec6c6d763ef76a998a36e22___ @ 0x1801309FC
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::ContextSession::LeaveSession_Callback__lambda_c8754ad6eec6c6d763ef76a998a36e22___(
        ...
        __int64 *a2)
{
  ...
  *(_QWORD *)&v6 = &v10;
  *((_QWORD *)&v6 + 1) = &v11;
  v4 = Microsoft::WRL::EventSource<Windows::Foundation::ITypedEventHandler<Windows::UI::Composition::Interactions::Internal::EdgyExperienceSource *,Windows::UI::Composition::Interactions::Internal::EdgyDetectedEventArgs *>,Microsoft::WRL::InvokeModeOptions<-2>>::DoInvoke<_lambda_fb243c6e7bdb5586a42c9b7b40fe0ed8_>(
         *a2,
         &v6);
  if ( v4 < 0 )
