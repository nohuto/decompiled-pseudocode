/*
 * XREFs of ?get_Root@Partner@SharedWriteCaptureController@Internal@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@456@@Z @ 0x18017F910
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::SharedWriteCaptureController::Partner::get_Root(
