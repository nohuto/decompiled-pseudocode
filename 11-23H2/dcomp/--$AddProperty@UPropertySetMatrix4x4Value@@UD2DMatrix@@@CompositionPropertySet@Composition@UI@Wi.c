/*
 * XREFs of ??$AddProperty@UPropertySetMatrix4x4Value@@UD2DMatrix@@@CompositionPropertySet@Composition@UI@Windows@@AEAAJPEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DMatrix@@@Z @ 0x18006EC6C
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::AddProperty<PropertySetMatrix4x4Value,D2DMatrix>(
        __int64 a1,
        HSTRING a2,
        __int64 a3,
        __int64 a4)
{
  ...
  HSTRING newString; // [rsp+38h] [rbp-41h] BYREF
  int v21[2]; // [rsp+40h] [rbp-39h] BYREF
  ...
  v8 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DMatrix>(a1 + 208, v7, a4, &v19);
  v9 = v8;
  if ( v8 >= 0 )
  {
