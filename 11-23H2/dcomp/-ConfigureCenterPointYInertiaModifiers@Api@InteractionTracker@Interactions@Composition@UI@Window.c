/*
 * XREFs of ?ConfigureCenterPointYInertiaModifiers@Api@InteractionTracker@Interactions@Composition@UI@Windows@@UEAAJPEAU?$IIterable@PEAVCompositionConditionalValue@Interactions@Composition@UI@Windows@@@Collections@Foundation@6@@Z @ 0x180137A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTracker::Api::ConfigureCenterPointYInertiaModifiers(
        __int64 a1,
        __int64 a2)
{
  int v3; // eax
...
LABEL_5:
  ...
  v10 = v9;
  if ( v9 < 0 )
    DoStackCaptureDirect(v9, 0xC3Fu);
  else
    v10 = 0;
  Microsoft::WRL2::ContextSession::EndApiEntry(v5);
  if ( v7 )
