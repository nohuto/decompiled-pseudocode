/*
 * XREFs of ?CreateLayerVisual@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUILayerVisual@345@@Z @ 0x18006CE50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Api::CreateLayerVisual(
        struct _RTL_CRITICAL_SECTION *this,
        struct Windows::UI::Composition::ILayerVisual **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v4 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::LayerVisual,Windows::UI::Composition::LayerVisual,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v5 = v4;
    if ( v4 < 0 )
    {
      ...
      DoStackCaptureDirect(v5, 0x18B0u);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::ILayerVisual *)((v8 + 312) & ((unsigned __int128)-(__int128)v8 >> 64));
      v5 = 0;
    }
  }
  else
