/*
 * XREFs of ?CreateQuaternionKeyFrameAnimation@Api@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUIQuaternionKeyFrameAnimation@345@@Z @ 0x18010EF60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Api::CreateQuaternionKeyFrameAnimation(
        struct _RTL_CRITICAL_SECTION *this,
        struct Windows::UI::Composition::IQuaternionKeyFrameAnimation **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::QuaternionKeyFrameAnimation,Windows::UI::Composition::QuaternionKeyFrameAnimation,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v4 = v5;
    if ( v5 >= 0 )
    {
      *a2 = (struct Windows::UI::Composition::IQuaternionKeyFrameAnimation *)(((unsigned __int64)v8 + 496) & ((unsigned __int128)-(__int128)(unsigned __int64)v8 >> 64));
      v4 = 0;
    }
    else
    {
      ...
      DoStackCaptureDirect(v4, 0x441u);
    }
  }
  else
  {
