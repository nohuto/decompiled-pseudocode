/*
 * XREFs of ?AddRef@CBitmapInfoFront@DirectComposition@@UEAAKXZ @ 0x1800811A0
 * Callers:
 *     ?AddRef@CBitmapInfoFront@DirectComposition@@WDI@EAAKXZ @ 0x1800A8210 (-AddRef@CBitmapInfoFront@DirectComposition@@WDI@EAAKXZ.c)
 * Callees:
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x18010084C (-IsKernelDebuggerPresent@@YAHXZ.c)
 */

__int64 __fastcall DirectComposition::CBitmapInfoFront::AddRef(DirectComposition::CBitmapInfoFront *this)
{
  int v3; // eax
  int v4; // edi
  BOOL v5; // eax
