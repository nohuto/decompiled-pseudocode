/*
 * XREFs of ??_GCompositionPartnerDebugSettings@Private@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18012F550
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::Private::CompositionPartnerDebugSettings::`scalar deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
