/*
 * XREFs of ?put_InitialValue@Api@Vector3NaturalMotionAnimation@Composition@UI@Windows@@UEAAJPEAU?$IReference@UVector3@Numerics@Foundation@Windows@@@Foundation@5@@Z @ 0x180168B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Vector3NaturalMotionAnimation::Api::put_InitialValue(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (*(_BYTE *)(a1 - 416) & 2) != 0 )
    {
      v8 = v10;
      v9 = v11;
      v6 = Windows::UI::Composition::Vector3NaturalMotionAnimation::SetVector3RefValue((__int64)&v8, v7[0], a1 - 32);
      v5 = v6;
      if ( v6 < 0 )
        DoStackCaptureDirect(v6, 0xB2u);
      else
        v5 = 0;
    }
    else
