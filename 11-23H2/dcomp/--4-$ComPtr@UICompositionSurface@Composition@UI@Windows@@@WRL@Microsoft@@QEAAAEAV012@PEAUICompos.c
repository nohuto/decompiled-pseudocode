/*
 * XREFs of ??4?$ComPtr@UICompositionSurface@Composition@UI@Windows@@@WRL@Microsoft@@QEAAAEAV012@PEAUICompositionSurface@Composition@UI@Windows@@@Z @ 0x1800A33BC
 * Callers:
...
__int64 *__fastcall Microsoft::WRL::ComPtr<Windows::UI::Composition::ICompositionSurface>::operator=(
        __int64 *a1,
        __int64 a2)
{
