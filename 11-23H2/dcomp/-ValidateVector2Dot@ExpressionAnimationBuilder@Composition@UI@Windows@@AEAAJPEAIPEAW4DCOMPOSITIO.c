/*
 * XREFs of ?ValidateVector2Dot@ExpressionAnimationBuilder@Composition@UI@Windows@@AEAAJPEAIPEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180166F28
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::ExpressionAnimationBuilder::ValidateVector2Dot(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a3)
{
  ...
  *a2 = 2;
  ...
  if ( *(_DWORD *)this >= 2u )
  {
    if ( *((_DWORD *)this + (unsigned int)(v3 - 2) + 66) == 35 )
    {
      if ( *((_DWORD *)this + (unsigned int)(v3 - 1) + 66) == 35 )
      {
        *(_DWORD *)a3 = 18;
        return 0;
      }
