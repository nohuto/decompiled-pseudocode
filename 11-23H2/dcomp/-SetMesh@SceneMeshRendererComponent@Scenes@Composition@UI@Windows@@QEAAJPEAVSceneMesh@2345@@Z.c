/*
 * XREFs of ?SetMesh@SceneMeshRendererComponent@Scenes@Composition@UI@Windows@@QEAAJPEAVSceneMesh@2345@@Z @ 0x180133B24
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneMeshRendererComponent::SetMesh(
        Windows::UI::Composition::Scenes::SceneMeshRendererComponent *this,
        struct Windows::UI::Composition::Scenes::SceneMesh *a2)
{
  int v4; // r9d
  Microsoft::WRL2::NestableRuntimeClass *v6; // [rsp+30h] [rbp+8h] BYREF

  if ( a2 != *((struct Windows::UI::Composition::Scenes::SceneMesh **)this + 30) )
  {
    ...
    DirectComposition::CDevice::ResourceSetReferenceProperty(
      ...
      *((_DWORD *)this + 32),
      1,
      v4);
    if ( *((struct Windows::UI::Composition::Scenes::SceneMesh **)this + 30) != a2 )
    {
      if ( a2 )
        Microsoft::WRL2::NestableRuntimeClass::InternalAddRef(a2);
      v6 = (Microsoft::WRL2::NestableRuntimeClass *)*((_QWORD *)this + 30);
      *((_QWORD *)this + 30) = a2;
