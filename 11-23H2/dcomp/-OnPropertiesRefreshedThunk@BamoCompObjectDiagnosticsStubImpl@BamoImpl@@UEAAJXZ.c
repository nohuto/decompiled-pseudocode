/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoCompObjectDiagnosticsStubImpl@BamoImpl@@UEAAJXZ @ 0x18019DBD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoCompObjectDiagnosticsStubImpl::OnPropertiesRefreshedThunk(
