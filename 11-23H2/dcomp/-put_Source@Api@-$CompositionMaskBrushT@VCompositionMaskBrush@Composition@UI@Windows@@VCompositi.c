/*
 * XREFs of ?put_Source@Api@?$CompositionMaskBrushT@VCompositionMaskBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJPEAUICompositionBrush@345@@Z @ 0x180048BA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionMaskBrushT<Windows::UI::Composition::CompositionMaskBrush,Windows::UI::Composition::CompositionBrush>::Api::put_Source(
        __int64 a1,
        struct Windows::UI::Composition::ICompositionBrush *a2)
{
  ...
  {
    v16 = 0LL;
    v5 = Windows::UI::Composition::CompositionMaskBrush::Validate_Source(
