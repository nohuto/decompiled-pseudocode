/*
 * XREFs of ??_ESharedSectionWrapper@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180132250
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::SharedSectionWrapper::`vector deleting destructor'(void **this, char a2)
{
  __int64 v4; // rdx
