/*
 * XREFs of ?put_RotationAngle@Api@CompositionShape@Composition@UI@Windows@@UEAAJM@Z @ 0x180189ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionShape::Api::put_RotationAngle(
        ...
        float a2)
{
  ...
  if ( ((_BYTE)v2[4] & 2) != 0 )
  {
    v5 = Windows::UI::Composition::CompositionShape::SetRotationAngle(v2, a2);
    v4 = v5;
    if ( v5 < 0 )
