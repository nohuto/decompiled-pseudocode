/*
 * XREFs of ?_Rrotate@?$_Tree_val@U?$_Tree_simple_types@UObjectPropertyPair@@@std@@@std@@QEAAXPEAU?$_Tree_node@UObjectPropertyPair@@PEAX@2@@Z @ 0x1800992D8
 * Callers:
...
_QWORD *__fastcall std::_Tree_val<std::_Tree_simple_types<ObjectPropertyPair>>::_Rrotate(__int64 a1, _QWORD *a2)
{
  __int64 v2; // r8
  __int64 v3; // rax
  _QWORD *result; // rax
