/*
 * XREFs of ??_EScalarKeyFrameAnimation@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180060210
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::ScalarKeyFrameAnimation *__fastcall Windows::UI::Composition::ScalarKeyFrameAnimation::`vector deleting destructor'(
        Windows::UI::Composition::ScalarKeyFrameAnimation *this,
        char a2)
{
  __int64 v4; // rcx
