/*
 * XREFs of ??_GInteropVisualReference@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123E80
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::InteropVisualReference::`scalar deleting destructor'(void **this, char a2)
{
  __int64 v4; // rdx
