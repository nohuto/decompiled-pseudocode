/*
 * XREFs of ??$MakeAndInitialize2@VCompositionDebugSettings@Diagnostics@Composition@UI@Windows@@V12345@PEAVCompositor@345@@Details@WRL2@Microsoft@@YAJPEAPEAVCompositionDebugSettings@Diagnostics@Composition@UI@Windows@@$$QEAPEAVCompositor@567@@Z @ 0x18012D710
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Diagnostics::CompositionDebugSettings,Windows::UI::Composition::Diagnostics::CompositionDebugSettings,Windows::UI::Composition::Compositor *>(
...
LABEL_7:
  ...
  v6 = (Microsoft::WRL2::NestableRuntimeClass *)memset_0(v4, 0, 0x40uLL);
  v7 = v6;
  if ( v6 )
  {
    Microsoft::WRL2::NestableRuntimeClass::NestableRuntimeClass(v6);
    *(_QWORD *)v7 = &Windows::UI::Composition::Diagnostics::CompositionDebugSettings::`vftable';
    *((_QWORD *)v7 + 7) = 0LL;
    *((_QWORD *)v7 + 5) = &Windows::UI::Composition::Diagnostics::CompositionDebugSettings::Api::`vftable';
  }
  else
  {
    v7 = 0LL;
  ...
  v10 = 0LL;
  *((_QWORD *)v7 + 1) = &Windows::UI::Composition::Diagnostics::CompositionDebugSettings::s_InterfaceType;
  v8 = *a2;
  v11 = v7;
  v5 = Windows::UI::Composition::Diagnostics::CompositionDebugSettings::RuntimeClassInitialize(v7, v8);
  if ( v5 < 0 )
    goto LABEL_7;
  *a1 = v7;
  return 0LL;
