/*
 * XREFs of ?SetTransformList@CTransform3DGroupProxy@DirectComposition@@QEAAJPEAPEAUIDCompositionTransform3D@@I@Z @ 0x1800FD5A4
 * Callers:
 *     ?CreateTransform3DGroup@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionTransform3D@@I0@Z @ 0x1800F0F20 (-CreateTransform3DGroup@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionTransform3D@@I0@Z.c)
 * Callees:
...
__int64 __fastcall DirectComposition::CTransform3DGroupProxy::SetTransformList(
        DirectComposition::CTransform3DGroupProxy *this,
        ...
        unsigned int a3)
{
  ...
  __int64 i; // r11
  struct IDCompositionTransform3D *v10; // rcx
  __int64 v11; // r11
  ...
  v14 = 0LL;
  v3 = (DirectComposition::CTransform3DGroupProxy *)((char *)this + 8);
  v16 = 0LL;
  v5 = a3;
