/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7PEAUFailureInfo@2@@Z @ 0x18000BA7C
 * Callers:
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x1800E4C64 (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x1800E4C84 (-RecordLog@details@wil@@YAHJ@Z.c)
...
LABEL_4:
  ...
  *(_QWORD *)(a15 + 128) = v25;
  ...
  if ( !wil::details::IsDebuggerPresent(v23) || (*(_BYTE *)(a15 + 4) & 2) != 0 )
  {
  ...
  else
  {
    ...
    if ( !*(_WORD *)lpOutputString )
      wil::GetFailureLogString(lpOutputString, (unsigned __int16 *)0x800, a15, v27);
