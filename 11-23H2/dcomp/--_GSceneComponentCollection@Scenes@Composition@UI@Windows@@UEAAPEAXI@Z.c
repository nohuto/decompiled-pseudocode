/*
 * XREFs of ??_GSceneComponentCollection@Scenes@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180141A40
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::Scenes::SceneComponentCollection::`scalar deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
