/*
 * XREFs of ?add_RequestedSizeChanged@Api@VisualIslandSite@Composition@UI@Windows@@UEAAJPEAU?$ITypedEventHandler@PEAVVisualIslandSite@Composition@UI@Windows@@PEAVVisualIslandSiteEventArgs@234@@Foundation@5@PEAUEventRegistrationToken@@@Z @ 0x18015AA70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$CreateAgileHelper@U?$ITypedEventHandler@PEAVVisualIslandSite@Composition@UI@Windows@@PEAVVisualIslandSiteEventArgs@234@@Foundation@Windows@@@Details@WRL@Microsoft@@YAJPEAU?$ITypedEventHandler@PEAVVisualIslandSite@Composition@UI@Windows@@PEAVVisualIslandSiteEventArgs@234@@Foundation@Windows@@PEAPEAU345@@Z @ 0x18015A514 (--$CreateAgileHelper@U-$ITypedEventHandler@PEAVVisualIslandSite@Composition@UI@Windows@@PEAVVisu.c)
 */

__int64 __fastcall Windows::UI::Composition::VisualIslandSite::Api::add_RequestedSizeChanged(
        __int64 a1,
        __int64 a2,
        struct IUnknown **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (*(_BYTE *)(a1 - 216) & 2) != 0 )
  {
    if ( a2 )
    {
      ...
      v7 = Microsoft::WRL::Details::CreateAgileHelper<Windows::Foundation::ITypedEventHandler<Windows::UI::Composition::VisualIslandSite *,Windows::UI::Composition::VisualIslandSiteEventArgs *>>(
             a2,
             (__int64 **)&v9);
      if ( v7 >= 0 )
      {
    ...
    DoStackCaptureDirect(v7, 0x13Du);
  }
  else
  {
    v7 = -2147483629;
