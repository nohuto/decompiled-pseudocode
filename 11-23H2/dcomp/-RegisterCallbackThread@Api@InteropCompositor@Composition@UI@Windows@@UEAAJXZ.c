/*
 * XREFs of ?RegisterCallbackThread@Api@InteropCompositor@Composition@UI@Windows@@UEAAJXZ @ 0x18008C130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InteropCompositor::Api::RegisterCallbackThread(
        Windows::UI::Composition::InteropCompositor::Api *this)
{
  ...
  if ( (v1->SpinCount & 2) != 0 )
  {
    ...
    v4 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v3 + 456LL))(v3);
    v5 = v4;
    if ( v4 < 0 )
      DoStackCaptureDirect(v4, 0x581u);
    else
      v5 = 0;
  }
  else
