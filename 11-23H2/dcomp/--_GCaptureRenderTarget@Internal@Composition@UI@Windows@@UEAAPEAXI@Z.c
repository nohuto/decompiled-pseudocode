/*
 * XREFs of ??_GCaptureRenderTarget@Internal@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123640
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::Internal::CaptureRenderTarget *__fastcall Windows::UI::Composition::Internal::CaptureRenderTarget::`scalar deleting destructor'(
