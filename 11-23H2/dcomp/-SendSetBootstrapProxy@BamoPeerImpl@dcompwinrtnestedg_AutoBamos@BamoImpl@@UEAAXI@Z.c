/*
 * XREFs of ?SendSetBootstrapProxy@BamoPeerImpl@dcompwinrtnestedg_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x18016E3A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dcompwinrtnestedg_AutoBamos::BamoPeerImpl::SendSetBootstrapProxy(
