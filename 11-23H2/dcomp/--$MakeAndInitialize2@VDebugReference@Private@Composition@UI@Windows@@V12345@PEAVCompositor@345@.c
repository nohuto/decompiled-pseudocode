/*
 * XREFs of ??$MakeAndInitialize2@VDebugReference@Private@Composition@UI@Windows@@V12345@PEAVCompositor@345@AEAPEAVProxyObject@345@@Details@WRL2@Microsoft@@YAJPEAPEAVDebugReference@Private@Composition@UI@Windows@@$$QEAPEAVCompositor@567@AEAPEAVProxyObject@567@@Z @ 0x180169BD0
 * Callers:
