/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@UIUnknown@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800E92F8
 * Callers:
 *     ?QueryInterface@?$CMILCOMBaseT@UIUnknown@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A0260 (-QueryInterface@-$CMILCOMBaseT@UIUnknown@@@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
