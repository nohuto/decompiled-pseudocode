/*
 * XREFs of ?CalcAverageRimReadLatency@CTouchFrameStats@@IEBAMXZ @ 0x1801A7AC8
 * Callers:
...
float __fastcall CTouchFrameStats::CalcAverageRimReadLatency(CTouchFrameStats::CInteractionInfo **this)
{
  ...
  if ( v6 != v7 )
  {
    ...
    do
    {
      if ( v6 != v9 )
      {
        Us = (float)(int)CTouchFrameStats::CInteractionInfo::RimReadUs(v6, v2);
        v18 = Us;
        if ( v10 == v5 )
        {
