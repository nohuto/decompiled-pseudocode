/*
 * XREFs of McTemplateU0pqq_EventWriteTransfer @ 0x1800E7618
 * Callers:
...
ULONG __fastcall McTemplateU0pqq_EventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  ...
  v9 = &v14;
  v11 = &a5;
  return McGenEventWrite_EventWriteTransfer(a1, (const EVENT_DESCRIPTOR *)"I", a3, 4u, &v6);
}
