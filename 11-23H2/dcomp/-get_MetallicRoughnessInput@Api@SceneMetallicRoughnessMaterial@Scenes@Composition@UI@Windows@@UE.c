/*
 * XREFs of ?get_MetallicRoughnessInput@Api@SceneMetallicRoughnessMaterial@Scenes@Composition@UI@Windows@@UEAAJPEAPEAUISceneMaterialInput@3456@@Z @ 0x18013F8A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneMetallicRoughnessMaterial::Api::get_MetallicRoughnessInput(
        ...
        struct Windows::UI::Composition::Scenes::ISceneMaterialInput **a2)
{
  ...
  v5 = 0;
  if ( !wil::ProcessShutdownInProgress(this) && _InterlockedIncrement(&dword_18022090C) == 1 )
  {
    v10 = 0LL;
    v9 = (Microsoft::WRL2::NestableRuntimeClass *)&dword_18022090C;
    wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[61],unsigned short const (&)[27],std::nullptr_t,long volatile *>(
      v4,
      L"get_MetallicRoughnessInput",
      &v10,
      (volatile int **)&v9);
  }
  *a2 = 0LL;
