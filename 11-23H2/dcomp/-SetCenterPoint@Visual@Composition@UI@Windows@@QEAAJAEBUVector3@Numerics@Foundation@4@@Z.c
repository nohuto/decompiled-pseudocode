/*
 * XREFs of ?SetCenterPoint@Visual@Composition@UI@Windows@@QEAAJAEBUVector3@Numerics@Foundation@4@@Z @ 0x18007DCC8
 * Callers:
 *     ?put_CenterPoint@Api@Visual@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@5@@Z @ 0x18007DC60 (-put_CenterPoint@Api@Visual@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@5@@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::SetCenterPoint(
        ...
        const struct Windows::Foundation::Numerics::Vector3 *a2)
{
  ...
  if ( !Reference )
  {
    v8 = *(_QWORD *)a2 - Windows::UI::Composition::ComponentTransform3D::sc_defaultCenterPoint;
    if ( *(_QWORD *)a2 == Windows::UI::Composition::ComponentTransform3D::sc_defaultCenterPoint )
      v8 = *((unsigned int *)a2 + 2) - (unsigned __int64)(unsigned int)dword_18021CEA0;
    if ( !v8 )
      return 0LL;
  ...
  v11 = a2;
  *(_QWORD *)v10 = Reference + 216;
  v12 = a2;
  v14 = &Windows::UI::Composition::ComponentTransform3D::sc_CenterPoint;
