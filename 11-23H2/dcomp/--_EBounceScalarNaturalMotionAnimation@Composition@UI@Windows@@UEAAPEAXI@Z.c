/*
 * XREFs of ??_EBounceScalarNaturalMotionAnimation@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x1801234B0
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::BounceScalarNaturalMotionAnimation *__fastcall Windows::UI::Composition::BounceScalarNaturalMotionAnimation::`vector deleting destructor'(
