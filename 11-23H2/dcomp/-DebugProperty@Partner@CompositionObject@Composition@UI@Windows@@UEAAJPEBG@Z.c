/*
 * XREFs of ?DebugProperty@Partner@CompositionObject@Composition@UI@Windows@@UEAAJPEBG@Z @ 0x180109560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionObject::Partner::DebugProperty(
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( (v2[32] & 2) != 0 )
  {
    ...
    v11 = 0LL;
    v7 = (*(__int64 (__fastcall **)(char *, PVOID))(*(_QWORD *)v2 + 272LL))(v2, Reserved1);
    v5 = v7;
    if ( v7 < 0 )
      DoStackCaptureDirect(v7, 0x55Au);
    else
      v5 = 0;
  }
  else
