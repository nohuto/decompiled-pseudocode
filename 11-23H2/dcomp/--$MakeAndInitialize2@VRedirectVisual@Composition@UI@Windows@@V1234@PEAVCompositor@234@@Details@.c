/*
 * XREFs of ??$MakeAndInitialize2@VRedirectVisual@Composition@UI@Windows@@V1234@PEAVCompositor@234@@Details@WRL2@Microsoft@@YAJPEAPEAVRedirectVisual@Composition@UI@Windows@@$$QEAPEAVCompositor@456@@Z @ 0x1801213EC
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::RedirectVisual,Windows::UI::Composition::RedirectVisual,Windows::UI::Composition::Compositor *>(
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      *(_QWORD *)v7 = &Windows::UI::Composition::RedirectVisual::`vftable';
      *((_QWORD *)v7 + 41) = 0LL;
      *((_QWORD *)v7 + 39) = &Windows::UI::Composition::RedirectVisual::Api::`vftable';
    }
    else
    {
      v7 = 0LL;
    ...
    v12 = 0LL;
    *((_QWORD *)v7 + 1) = &Windows::UI::Composition::RedirectVisual::s_InterfaceType;
    v8 = *a2;
    v13 = v7;
    v9 = Windows::UI::Composition::ContainerVisual::RuntimeClassInitialize(v7, v8, 0x8Du);
    v10 = v9;
    if ( v9 >= 0 )
    {
      *a1 = v7;
    ...
    else
    {
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)0x2F,
        (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtredirectvisual.cpp",
