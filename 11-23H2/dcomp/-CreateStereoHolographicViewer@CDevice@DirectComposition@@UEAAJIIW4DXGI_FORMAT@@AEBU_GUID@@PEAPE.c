/*
 * XREFs of ?CreateStereoHolographicViewer@CDevice@DirectComposition@@UEAAJIIW4DXGI_FORMAT@@AEBU_GUID@@PEAPEAUIDCompositionHolographicViewer@@@Z @ 0x1800F09D0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall DirectComposition::CDevice::CreateStereoHolographicViewer(
