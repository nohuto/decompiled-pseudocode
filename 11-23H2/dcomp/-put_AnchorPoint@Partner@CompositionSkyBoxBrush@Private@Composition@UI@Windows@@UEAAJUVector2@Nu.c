/*
 * XREFs of ?put_AnchorPoint@Partner@CompositionSkyBoxBrush@Private@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@6@@Z @ 0x180181C00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Private::CompositionSkyBoxBrush::Partner::put_AnchorPoint(
        __int64 a1,
        __int64 a2)
{
  ...
  *(_QWORD *)v8 = a2;
  ...
  if ( (*(_BYTE *)(a1 - 120) & 2) != 0 )
  {
    ...
    else
    {
      ...
      DoStackCaptureDirect(v4, 0x259u);
    }
  }
  else
  {
