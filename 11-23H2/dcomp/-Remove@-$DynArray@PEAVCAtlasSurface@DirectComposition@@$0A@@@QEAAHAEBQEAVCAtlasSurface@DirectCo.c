/*
 * XREFs of ?Remove@?$DynArray@PEAVCAtlasSurface@DirectComposition@@$0A@@@QEAAHAEBQEAVCAtlasSurface@DirectComposition@@@Z @ 0x18001F2F8
 * Callers:
...
__int64 __fastcall DynArray<DirectComposition::CAtlasSurface *,0>::Remove(__int64 *a1, _QWORD *a2)
{
  unsigned int v2; // r8d
  __int64 v3; // r9
  __int64 i; // r11
