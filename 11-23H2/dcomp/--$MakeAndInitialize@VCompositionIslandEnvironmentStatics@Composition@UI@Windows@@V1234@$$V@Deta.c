/*
 * XREFs of ??$MakeAndInitialize@VCompositionIslandEnvironmentStatics@Composition@UI@Windows@@V1234@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCompositionIslandEnvironmentStatics@Composition@UI@Windows@@@Z @ 0x180017D1C
 * Callers:
 ...
 *     ??0?$AgileActivationFactory@UICompositionIslandEnvironmentStatics@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@V5678@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180017DB4 (--0-$AgileActivationFactory@UICompositionIslandEnvironmentStatics@Composition@UI@Windows@@VNil@D.c)
 *     ?Alloc@DefaultHeap@@SAPEAX_K@Z @ 0x18004400C (-Alloc@DefaultHeap@@SAPEAX_K@Z.c)
 *     memset_0 @ 0x18009698C (memset_0.c)
 *     ??1?$MakeAllocator@VInjectionAnimation@Composition@UI@Windows@@@Details@WRL@Microsoft@@QEAA@XZ @ 0x1800A1230 (--1-$MakeAllocator@VInjectionAnimation@Composition@UI@Windows@@@Details@WRL@Microsoft@@QEAA@XZ.c)
 */

__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::CompositionIslandEnvironmentStatics,Windows::UI::Composition::CompositionIslandEnvironmentStatics,>(
        _QWORD *a1)
{
  void *v2; // rax
  _QWORD *v3; // rax
  ...
  *a1 = 0LL;
  ...
  if ( v2 )
  {
    ...
    if ( v3 )
    {
      Microsoft::WRL::AgileActivationFactory<Windows::UI::Composition::ICompositionIslandEnvironmentStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::AgileActivationFactory<Windows::UI::Composition::ICompositionIslandEnvironmentStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>(v3);
      *v4 = &Windows::UI::Composition::CompositionIslandEnvironmentStatics::`vftable';
      v4[1] = &Windows::UI::Composition::CompositionIslandEnvironmentStatics::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,Windows::UI::Composition::ICompositionIslandEnvironmentStatics>>'};
      v4[5] = &Windows::UI::Composition::CompositionIslandEnvironmentStatics::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Windows::UI::Composition::ICompositionIslandEnvironmentStatics>,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,Windows::UI::Composition::ICompositionIslandEnvironmentStatics>>'};
