/*
 * XREFs of ?get_CoordinateSpace@Api@SpotLight@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x18017C4F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::Api::get_CoordinateSpace(
