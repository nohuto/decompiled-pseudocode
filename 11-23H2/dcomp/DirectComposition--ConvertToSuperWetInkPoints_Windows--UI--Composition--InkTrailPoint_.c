/*
 * XREFs of DirectComposition::ConvertToSuperWetInkPoints_Windows::UI::Composition::InkTrailPoint_ @ 0x1800E60C4
 * Callers:
...
_QWORD *__fastcall DirectComposition::ConvertToSuperWetInkPoints_Windows::UI::Composition::InkTrailPoint_(
        _QWORD *a1,
        __int64 a2,
        unsigned int a3,
        unsigned __int8 a4)
