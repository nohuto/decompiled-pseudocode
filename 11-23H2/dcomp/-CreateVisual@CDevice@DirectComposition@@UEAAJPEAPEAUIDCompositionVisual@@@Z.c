/*
 * XREFs of ?CreateVisual@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionVisual@@@Z @ 0x1800106B0
 * Callers:
 *     <none>
 * Callees:
...
{
  __int64 result; // rax
  struct IDCompositionVisual *v4; // rdx
  unsigned int v5; // [rsp+48h] [rbp+10h] BYREF
  void *v6; // [rsp+50h] [rbp+18h] BYREF

  if ( !a2 )
    return 2147942487LL;
  result = DirectComposition::CDevice::CreateProxyInternal(this, 0xC4u, 0, &v6, &v5);
  if ( (int)result < 0 )
  {
    *a2 = 0LL;
  }
  ...
  {
    v4 = (struct IDCompositionVisual *)v6;
    *((_DWORD *)v6 + 3) = v5;
    *(_QWORD *)v4 = &DirectComposition::CVisualProxy::`vftable';
    *((_DWORD *)v4 + 2) = 1;
    *a2 = v4;
  }
  return result;
