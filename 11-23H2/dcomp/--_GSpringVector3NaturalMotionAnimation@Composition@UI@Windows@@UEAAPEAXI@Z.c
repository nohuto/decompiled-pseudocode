/*
 * XREFs of ??_GSpringVector3NaturalMotionAnimation@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180124620
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::SpringVector3NaturalMotionAnimation *__fastcall Windows::UI::Composition::SpringVector3NaturalMotionAnimation::`scalar deleting destructor'(
