/*
 * XREFs of ??$emplace@AEBV?$RefPtr@VCompositionProjectedShadowCaster@Composition@UI@Windows@@@WRL2@Microsoft@@@?$vector@V?$RefPtr@VCompositionProjectedShadowCaster@Composition@UI@Windows@@@WRL2@Microsoft@@V?$allocator@V?$RefPtr@VCompositionProjectedShadowCaster@Composition@UI@Windows@@@WRL2@Microsoft@@@std@@@std@@QEAA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@V?$RefPtr@VCompositionProjectedShadowCaster@Composition@UI@Windows@@@WRL2@Microsoft@@@std@@@std@@@1@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@V?$RefPtr@VCompositionProjectedShadowCaster@Composition@UI@Windows@@@WRL2@Microsoft@@@std@@@std@@@1@AEBV?$RefPtr@VCompositionProjectedShadowCaster@Composition@UI@Windows@@@WRL2@Microsoft@@@Z @ 0x180183634
 * Callers:
...
char **__fastcall std::vector<Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionProjectedShadowCaster>>::emplace<Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionProjectedShadowCaster> const &>(
        __int64 a1,
        char **a2,
        char *a3,
        Microsoft::WRL2::NestableRuntimeClass **a4)
{
  ...
  {
    *a2 = std::vector<Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionProjectedShadowCaster>>::_Emplace_reallocate<Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionProjectedShadowCaster> const &>(
            a1,
            a3,
            a4);
  }
  else
  {
    ...
    else
    {
      ...
      *(_QWORD *)(a1 + 8) += 8LL;
      ...
      Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionShape>::operator=(
