/*
 * XREFs of ??$_Emplace_reallocate@AEBU_GUID@@AEAPEBUBatchSyncInfo@@I@?$vector@UCFlipPropertyItem@@V?$allocator@UCFlipPropertyItem@@@std@@@std@@QEAAPEAUCFlipPropertyItem@@QEAU2@AEBU_GUID@@AEAPEBUBatchSyncInfo@@$$QEAI@Z @ 0x1800A70E8
 * Callers:
...
unsigned __int64 __fastcall std::vector<CFlipPropertyItem>::_Emplace_reallocate<_GUID const &,BatchSyncInfo const * &,unsigned int>(
        __int64 *a1,
        __int64 a2,
        __int128 *a3,
        _QWORD *a4,
        int *a5)
{
  ...
  if ( v8 == 0x7FFFFFFFFFFFFFFLL )
    std::vector<IUnknown *>::_Xlength((const char *)0x7FFFFFFFFFFFFFFLL);
  v11 = v8 + 1;
  ...
  v15 = *a3;
  v16 = v14;
  v17 = ((a2 - v5) & 0xFFFFFFFFFFFFFFE0uLL) + v14;
  v18 = *a5;
  *(_QWORD *)(v17 + 24) = *a4;
  *(_OWORD *)v17 = v15;
  *(_DWORD *)(v17 + 16) = v18;
  ...
  std::vector<CFlipPropertyItem>::_Change_array(a1, v21, v11, v12);
  return v17;
}
