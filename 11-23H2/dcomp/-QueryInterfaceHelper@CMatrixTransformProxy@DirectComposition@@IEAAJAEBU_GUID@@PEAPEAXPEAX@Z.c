/*
 * XREFs of ?QueryInterfaceHelper@CMatrixTransformProxy@DirectComposition@@IEAAJAEBU_GUID@@PEAPEAXPEAX@Z @ 0x1800F387C
 * Callers:
 *     ?QueryInterface@CMatrixTransformProxy@DirectComposition@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F3020 (-QueryInterface@CMatrixTransformProxy@DirectComposition@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall DirectComposition::CMatrixTransformProxy::QueryInterfaceHelper(
        ...
        void *a4)
{
  ...
  v4 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_16cdff07_c503_419c_83f2_0965c7af1fa6.Data1;
  if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_16cdff07_c503_419c_83f2_0965c7af1fa6.Data1 )
    v4 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_16cdff07_c503_419c_83f2_0965c7af1fa6.Data4;
  if ( v4 )
  {
