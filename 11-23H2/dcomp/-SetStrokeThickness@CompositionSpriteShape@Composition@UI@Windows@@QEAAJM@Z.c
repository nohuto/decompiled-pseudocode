/*
 * XREFs of ?SetStrokeThickness@CompositionSpriteShape@Composition@UI@Windows@@QEAAJM@Z @ 0x1800120F8
 * Callers:
 *     ?put_StrokeThickness@Api@CompositionSpriteShape@Composition@UI@Windows@@UEAAJM@Z @ 0x180012090 (-put_StrokeThickness@Api@CompositionSpriteShape@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionSpriteShape::SetStrokeThickness(
        ...
        float a2)
{
  ...
  if ( a2 < 0.0 )
  {
    Windows::UI::Composition::OriginateInvalidArgument(14LL, L"StrokeThickness");
    v4 = 440LL;
    updated = -2147024809;
  }
  else
  {
    ...
    v5[1] = &v7;
    v5[2] = &v7;
    v8 = &Windows::UI::Composition::CompositionSpriteShape::sc_StrokeThickness;
