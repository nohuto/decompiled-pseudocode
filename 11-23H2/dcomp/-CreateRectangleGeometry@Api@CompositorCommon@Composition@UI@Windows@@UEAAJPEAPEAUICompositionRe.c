/*
 * XREFs of ?CreateRectangleGeometry@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUICompositionRectangleGeometry@345@@Z @ 0x180072730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Api::CreateRectangleGeometry(
        Windows::UI::Composition::CompositorCommon::Api *this,
        struct Windows::UI::Composition::ICompositionRectangleGeometry **a2)
{
  ...
  if ( _InterlockedIncrement(&dword_1802208B0) == 1 && wil::details::ApiTelemetryLogger::IsEnabled((__int64)this) )
  {
  ...
  *a2 = 0LL;
  ...
  if ( (v4->SpinCount & 2) != 0 )
  {
    v11 = 0LL;
    v12 = v4;
    v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionRectangleGeometry,Windows::UI::Composition::CompositionRectangleGeometry,Windows::UI::Composition::Compositor *>(
           &v11,
           &v12);
    v6 = v5;
    if ( v5 < 0 )
    {
      ...
      DoStackCaptureDirect(v6, 0x20A7u);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::ICompositionRectangleGeometry *)((v11 + 168) & ((unsigned __int128)-(__int128)v11 >> 64));
      v6 = 0;
    }
  }
  else
