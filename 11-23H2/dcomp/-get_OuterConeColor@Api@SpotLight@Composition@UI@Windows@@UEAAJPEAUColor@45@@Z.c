/*
 * XREFs of ?get_OuterConeColor@Api@SpotLight@Composition@UI@Windows@@UEAAJPEAUColor@45@@Z @ 0x18017CBE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::Api::get_OuterConeColor(
        const __m128i *this,
        struct Windows::UI::Color *a2)
{
  ...
  *(_DWORD *)a2 = 0;
  ...
  {
    v6 = (__m128)_mm_loadu_si128(this + 5);
