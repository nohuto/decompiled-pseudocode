/*
 * XREFs of ?EndDraw@Interop@CompositionDrawingSurface@Composition@UI@Windows@@UEAAJXZ @ 0x180061A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionDrawingSurface::Interop::EndDraw(
        Windows::UI::Composition::CompositionDrawingSurface::Interop *this)
{
  ...
  if ( (*((_BYTE *)v1 + 32) & 2) != 0 )
  {
    ...
    v4 = v3;
    if ( v3 < 0 )
      DoStackCaptureDirect(v3, 0x2A3u);
    else
      v4 = 0;
  }
  else
