/*
 * XREFs of ?CreateManipulationTransform@Api@InteropCompositor@Composition@UI@Windows@@UEAAJPEAPEAUIDCompositionManipulationTransform@@@Z @ 0x18015D250
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDCompositionManipulationTransform **a2)
{
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    ...
    v7 = (*(__int64 (__fastcall **)(__int64, struct IDCompositionManipulationTransform **))(*(_QWORD *)v6 + 384LL))(
           v6,
           a2);
    v5 = v7;
    if ( v7 < 0 )
      DoStackCaptureDirect(v7, 0x4FDu);
    else
      v5 = 0;
  }
  else
