/*
 * XREFs of ??$MakeAndInitialize@VCompositionProjectedShadowCasterCollectionStatics@Composition@UI@Windows@@V1234@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCompositionProjectedShadowCasterCollectionStatics@Composition@UI@Windows@@@Z @ 0x1801041A4
 * Callers:
 ...
 *     ??0?$AgileActivationFactory@UICompositionProjectedShadowCasterCollectionStatics@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@V5678@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180104F4C (--0-$AgileActivationFactory@UICompositionProjectedShadowCasterCollectionStatics@Composition@UI@W.c)
 */

__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::CompositionProjectedShadowCasterCollectionStatics,Windows::UI::Composition::CompositionProjectedShadowCasterCollectionStatics,>(
        _QWORD *a1)
{
  void *v2; // rax
  _QWORD *v4; // rax
  ...
  *a1 = 0LL;
  ...
  if ( v2 )
  {
    ...
    if ( v4 )
    {
      Microsoft::WRL::AgileActivationFactory<Windows::UI::Composition::ICompositionProjectedShadowCasterCollectionStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::AgileActivationFactory<Windows::UI::Composition::ICompositionProjectedShadowCasterCollectionStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>(v4);
      *v5 = &Windows::UI::Composition::CompositionProjectedShadowCasterCollectionStatics::`vftable';
      v5[1] = &Windows::UI::Composition::CompositionProjectedShadowCasterCollectionStatics::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,Windows::UI::Composition::ICompositionProjectedShadowCasterCollectionStatics>>'};
      v5[5] = &Windows::UI::Composition::CompositionProjectedShadowCasterCollectionStatics::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Windows::UI::Composition::ICompositionProjectedShadowCasterCollectionStatics>,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,Windows::UI::Composition::ICompositionProjectedShadowCasterCollectionStatics>>'};
