/*
 * XREFs of ?put_EmissiveInput@Api@ScenePbrMaterial@Scenes@Composition@UI@Windows@@UEAAJPEAUISceneMaterialInput@3456@@Z @ 0x1801921A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::ScenePbrMaterial::Api::put_EmissiveInput(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)this - 136) & 2) != 0 )
  {
    ...
    if ( v6 < 0 )
    {
      DoStackCaptureDirect(v6, 0xF7u);
    }
    else
    {
      if ( v10 != *((struct Microsoft::WRL2::ContextRuntimeClass **)this + 2) )
      {
        if ( v10 )
          v8 = *((_DWORD *)v10 + 32);
        else
