/*
 * XREFs of McTemplateU0xqqtt_EventWriteTransfer @ 0x1800EA51C
 * Callers:
...
ULONG __fastcall McTemplateU0xqqtt_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, (const EVENT_DESCRIPTOR *)"+", a3, 6u, &v8);
}
