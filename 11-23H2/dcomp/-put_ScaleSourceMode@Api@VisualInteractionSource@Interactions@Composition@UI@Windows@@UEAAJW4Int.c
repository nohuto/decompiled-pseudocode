/*
 * XREFs of ?put_ScaleSourceMode@Api@VisualInteractionSource@Interactions@Composition@UI@Windows@@UEAAJW4InteractionSourceMode@3456@@Z @ 0x18011F460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::VisualInteractionSource::Api::put_ScaleSourceMode(
        __int64 a1,
        int a2)
{
  __int64 v2; // rsi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    v6 = Windows::UI::Composition::Interactions::VisualInteractionSource::SetEnabledForAxis(v2, 2, a2 != 0);
    v5 = v6;
    if ( v6 < 0 )
    {
      DoStackCaptureDirect(v6, 0x4BCu);
    }
    else
    {
      LOBYTE(v7) = a2 == 1;
      Windows::UI::Composition::Interactions::VisualInteractionSource::SetInertiaEnabledForAxis(v2, 2LL, v7);
      v5 = 0;
    }
  }
  else
