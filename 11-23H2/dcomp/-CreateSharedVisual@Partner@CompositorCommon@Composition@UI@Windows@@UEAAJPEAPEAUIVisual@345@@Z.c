/*
 * XREFs of ?CreateSharedVisual@Partner@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x180126F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Partner::CreateSharedVisual(
        ...
        struct Windows::UI::Composition::IVisual **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v5 < 0 )
    {
      DoStackCaptureDirect(v5, 0x1CAFu);
    }
    else
    {
      v7 = v9;
