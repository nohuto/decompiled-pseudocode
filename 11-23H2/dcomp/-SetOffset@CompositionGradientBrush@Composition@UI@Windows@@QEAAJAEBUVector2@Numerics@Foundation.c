/*
 * XREFs of ?SetOffset@CompositionGradientBrush@Composition@UI@Windows@@QEAAJAEBUVector2@Numerics@Foundation@4@@Z @ 0x1801743A4
 * Callers:
 *     ?put_Offset@Api@?$CompositionGradientBrushT@VCompositionGradientBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18012C1E0 (-put_Offset@Api@-$CompositionGradientBrushT@VCompositionGradientBrush@Composition@UI@Windows@@VC.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionGradientBrush::SetOffset(
        __int64 **this,
