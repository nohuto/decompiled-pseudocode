/*
 * XREFs of ?SetAnchorPoint@CompositionClip@Composition@UI@Windows@@QEAAJAEBUVector2@Numerics@Foundation@4@@Z @ 0x18015572C
 * Callers:
 *     ?put_AnchorPoint@Api@CompositionClip@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x1801560D0 (-put_AnchorPoint@Api@CompositionClip@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionClip::SetAnchorPoint(
        __int64 **this,
