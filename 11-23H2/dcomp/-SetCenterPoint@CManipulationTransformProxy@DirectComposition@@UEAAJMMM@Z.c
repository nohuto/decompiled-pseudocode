/*
 * XREFs of ?SetCenterPoint@CManipulationTransformProxy@DirectComposition@@UEAAJMMM@Z @ 0x1800360B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CManipulationTransformProxy::SetCenterPoint(
