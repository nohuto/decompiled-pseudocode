/*
 * XREFs of ?CreateVisualIslandSite@SystemOnly@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUIVisualIslandSite@345@@Z @ 0x180086740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::SystemOnly::CreateVisualIslandSite(
        Windows::UI::Composition::Compositor::SystemOnly *this,
        struct Windows::UI::Composition::IVisualIslandSite **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v4 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::VisualIslandSite,Windows::UI::Composition::VisualIslandSite,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v5 = v4;
    if ( v4 < 0 )
    {
      ...
      DoStackCaptureDirect(v5, 0x905u);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::IVisualIslandSite *)((v8 + 248) & ((unsigned __int128)-(__int128)v8 >> 64));
      v5 = 0;
    }
  }
  else
