/*
 * XREFs of ?put_RightInsetScale@Api@?$CompositionNineGridBrushT@VCompositionNineGridBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJM@Z @ 0x180049A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionNineGridBrushT<Windows::UI::Composition::CompositionNineGridBrush,Windows::UI::Composition::CompositionBrush>::Api::put_RightInsetScale(
        __int64 a1,
        float a2)
{
  __int64 *v2; // rdi
...
LABEL_19:
    ...
    v4 = *((float *)v2 + 49);
    v37[2] = &v33;
    v36 = &Windows::UI::Composition::CompositionNineGridBrush::sc_RightInsetScale;
    v37[0] = (char *)v2 + 196;
    if ( v4 == a2 )
    {
      v5 = 0;
    ...
    {
      v34[0] = (struct CompObjectDiagnosticsPrincipal *)Windows::UI::Composition::CompositionNineGridBrush::sc_RightInsetScale;
