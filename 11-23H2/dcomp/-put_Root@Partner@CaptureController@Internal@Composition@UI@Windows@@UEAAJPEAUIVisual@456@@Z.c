/*
 * XREFs of ?put_Root@Partner@CaptureController@Internal@Composition@UI@Windows@@UEAAJPEAUIVisual@456@@Z @ 0x18017FFD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureController::Partner::put_Root(
