/*
 * XREFs of dllmain_crt_process_attach @ 0x180097438
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x180095FDC (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x1800960C0 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x180096160 (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x1800966E4 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18009783C (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180097864 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180097888 (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x180097898 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x180097930 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18009793C (_initterm_e_0.c)
