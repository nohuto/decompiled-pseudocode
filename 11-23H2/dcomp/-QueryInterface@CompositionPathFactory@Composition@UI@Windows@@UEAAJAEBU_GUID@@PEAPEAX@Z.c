/*
 * XREFs of ?QueryInterface@CompositionPathFactory@Composition@UI@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18008E4D0
 * Callers:
 *     ?QueryInterface@CompositionPathFactory@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB030 (-QueryInterface@CompositionPathFactory@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CompositionPathFactory@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB050 (-QueryInterface@CompositionPathFactory@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
