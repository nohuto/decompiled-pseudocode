/*
 * XREFs of ??$_Emplace_reallocate@U?$pair@PEAVProxyObject@Composition@UI@Windows@@I@std@@@?$vector@U?$pair@PEAVProxyObject@Composition@UI@Windows@@I@std@@V?$allocator@U?$pair@PEAVProxyObject@Composition@UI@Windows@@I@std@@@2@@std@@QEAAPEAU?$pair@PEAVProxyObject@Composition@UI@Windows@@I@1@QEAU21@$$QEAU21@@Z @ 0x180094060
 * Callers:
...
char *__fastcall std::vector<std::pair<Windows::UI::Composition::ProxyObject *,unsigned int>>::_Emplace_reallocate<std::pair<Windows::UI::Composition::ProxyObject *,unsigned int>>(
        __int64 a1,
        char *a2,
        _OWORD *a3)
{
