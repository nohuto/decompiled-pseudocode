/*
 * XREFs of ?Scroll@Interop@CompositionVirtualDrawingSurface@Composition@UI@Windows@@UEAAJPEBUtagRECT@@0HH@Z @ 0x180195D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVirtualDrawingSurface::Interop::Scroll(
        ...
        int a5)
{
  ...
  if ( (*((_BYTE *)v5 + 32) & 2) != 0 )
  {
    ...
    v10 = v11;
    if ( v11 < 0 )
      DoStackCaptureDirect(v11, 0x23Cu);
    else
      v10 = 0;
  }
  else
