/*
 * XREFs of ?RemoveGuardRects@CPrimitiveGroup@DirectComposition@@IEAAXXZ @ 0x1800FA944
 * Callers:
...
void __fastcall DirectComposition::CPrimitiveGroup::RemoveGuardRects(DirectComposition::CPrimitiveGroup *this)
{
  __int64 v1; // rbx
  unsigned int i; // esi
  ...
  for ( i = 0; i < *((_DWORD *)this + 28); ++i )
    DirectComposition::CAtlasSurfacePool::RemoveGuardRect(*(DirectComposition::CAtlasSurfacePool **)(*((_QWORD *)this + 11) + 16LL * i));
  if ( *((_DWORD *)this + 36) )
  {
    do
    {
      DirectComposition::CAtlasSurfacePool::RemoveGuardRect(*(DirectComposition::CAtlasSurfacePool **)(*((_QWORD *)this + 15) + 8 * v1));
