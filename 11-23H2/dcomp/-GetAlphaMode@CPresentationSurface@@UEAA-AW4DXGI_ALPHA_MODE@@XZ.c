/*
 * XREFs of ?GetAlphaMode@CPresentationSurface@@UEAA?AW4DXGI_ALPHA_MODE@@XZ @ 0x1800A7CF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPresentationSurface::GetAlphaMode(CPresentationSurface *this)
{
  CPresentationSurface *v1; // rbx
  char v3; // [rsp+30h] [rbp+8h] BYREF

  v1 = this;
  wil::critical_section::lock(*((_QWORD *)this - 1) + 24LL, &v3);
  LODWORD(v1) = *((_DWORD *)v1 + 21);
