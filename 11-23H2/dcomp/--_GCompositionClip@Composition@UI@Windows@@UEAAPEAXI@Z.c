/*
 * XREFs of ??_GCompositionClip@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123820
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::CompositionClip *__fastcall Windows::UI::Composition::CompositionClip::`scalar deleting destructor'(
