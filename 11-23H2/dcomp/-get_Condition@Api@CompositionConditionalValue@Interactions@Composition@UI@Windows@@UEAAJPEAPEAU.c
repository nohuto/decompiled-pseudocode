/*
 * XREFs of ?get_Condition@Api@CompositionConditionalValue@Interactions@Composition@UI@Windows@@UEAAJPEAPEAUIExpressionAnimation@456@@Z @ 0x18012D290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::CompositionConditionalValue::Api::get_Condition(
