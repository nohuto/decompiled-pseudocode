/*
 * XREFs of ?SetAttenuation1@PointLight@Composition@UI@Windows@@QEAAJM@Z @ 0x18017A418
 * Callers:
 *     ?put_LinearAttenuation@Api@PointLight@Composition@UI@Windows@@UEAAJM@Z @ 0x18017AFE0 (-put_LinearAttenuation@Api@PointLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::PointLight::SetAttenuation1(
        ...
        float a2)
{
  ...
  if ( a2 < 0.0 )
  {
    Windows::UI::Composition::OriginateInvalidArgument(14, (__int64)L"LinearAttenuation");
    v3 = 184LL;
    updated = -2147024809;
  }
  else
  {
    ...
    v5[1] = &v7;
    v5[2] = &v7;
    v8 = (void **)&Windows::UI::Composition::PointLight::sc_LinearAttenuation;
