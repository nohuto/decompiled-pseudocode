/*
 * XREFs of ?SetFinalValueParameter@CompositionVisualSurface@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x180159100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVisualSurface::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 2LL;
  v11[1] = &Windows::UI::Composition::CompositionVisualSurface::k_rgAnimDef;
