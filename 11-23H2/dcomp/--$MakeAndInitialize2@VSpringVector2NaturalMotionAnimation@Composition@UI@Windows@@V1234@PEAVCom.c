/*
 * XREFs of ??$MakeAndInitialize2@VSpringVector2NaturalMotionAnimation@Composition@UI@Windows@@V1234@PEAVCompositor@234@@Details@WRL2@Microsoft@@YAJPEAPEAVSpringVector2NaturalMotionAnimation@Composition@UI@Windows@@$$QEAPEAVCompositor@456@@Z @ 0x180121A44
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::SpringVector2NaturalMotionAnimation,Windows::UI::Composition::SpringVector2NaturalMotionAnimation,Windows::UI::Composition::Compositor *>(
...
LABEL_7:
  ...
  v6 = (Windows::UI::Composition::Vector2NaturalMotionAnimation *)memset_0(v4, 0, 0x1E0uLL);
  v7 = v6;
  if ( v6 )
  {
    Windows::UI::Composition::Vector2NaturalMotionAnimation::Vector2NaturalMotionAnimation(v6);
    *(_QWORD *)v7 = &Windows::UI::Composition::SpringVector2NaturalMotionAnimation::`vftable';
    *((_DWORD *)v7 + 112) = 1060320051;
    *((_QWORD *)v7 + 57) = 500000LL;
    *((_QWORD *)v7 + 58) = &Windows::UI::Composition::SpringVector2NaturalMotionAnimation::Api::`vftable';
  }
  else
  {
    v7 = 0LL;
  ...
  v10 = 0LL;
  *((_QWORD *)v7 + 1) = &Windows::UI::Composition::SpringVector2NaturalMotionAnimation::s_InterfaceType;
  v8 = *a2;
  *((_DWORD *)v7 + 94) = 35;
  v11 = v7;
