/*
 * XREFs of ?FreePrincipalItem@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAXI@Z @ 0x18016C3B0
 * Callers:
...
LABEL_3:
  ...
  if ( v5 == *((_BYTE **)this + 26) )
  {
    std::vector<unsigned int>::_Emplace_reallocate<unsigned int const &>((__int64 *)this + 24, v5, &v10);
  }
  else
  {
    *(_DWORD *)v5 = a2;
