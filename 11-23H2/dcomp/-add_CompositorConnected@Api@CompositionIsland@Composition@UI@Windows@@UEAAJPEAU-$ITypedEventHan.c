/*
 * XREFs of ?add_CompositorConnected@Api@CompositionIsland@Composition@UI@Windows@@UEAAJPEAU?$ITypedEventHandler@PEAVCompositionIsland@Composition@UI@Windows@@PEAVCompositionIslandEventArgs@234@@Foundation@5@PEAUEventRegistrationToken@@@Z @ 0x180113710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionIsland::Api::add_CompositorConnected(
        __int64 a1,
        __int64 a2,
        struct IUnknown **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (*(_BYTE *)(a1 - 96) & 2) != 0 )
  {
    ...
    v7 = v8;
    if ( v8 < 0 )
      DoStackCaptureDirect(v8, 0x7E2u);
    else
      v7 = 0;
  }
  else
