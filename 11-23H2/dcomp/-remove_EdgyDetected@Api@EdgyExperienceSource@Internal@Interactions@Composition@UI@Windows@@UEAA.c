/*
 * XREFs of ?remove_EdgyDetected@Api@EdgyExperienceSource@Internal@Interactions@Composition@UI@Windows@@UEAAJUEventRegistrationToken@@@Z @ 0x180131AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::Internal::EdgyExperienceSource::Api::remove_EdgyDetected(
        RTL_SRWLOCK *this,
        struct EventRegistrationToken a2)
{
  ...
  Ptr = (struct _RTL_CRITICAL_SECTION *)this[-34].Ptr;
  Microsoft::WRL2::ContextSession::BeginApiEntry(Ptr);
  if ( ((__int64)this[-33].Ptr & 2) != 0 )
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      DoStackCaptureDirect(v6, 0x163u);
    else
      v5 = 0;
  }
  else
