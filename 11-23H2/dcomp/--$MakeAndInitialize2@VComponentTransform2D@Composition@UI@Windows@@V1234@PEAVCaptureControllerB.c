/*
 * XREFs of ??$MakeAndInitialize2@VComponentTransform2D@Composition@UI@Windows@@V1234@PEAVCaptureControllerBase@Internal@234@@Details@WRL2@Microsoft@@YAJPEAPEAVComponentTransform2D@Composition@UI@Windows@@$$QEAPEAVCaptureControllerBase@Internal@456@@Z @ 0x180189F5C
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::ComponentTransform2D,Windows::UI::Composition::ComponentTransform2D,Windows::UI::Composition::Internal::CaptureControllerBase *>(
        ...
        struct Windows::UI::Composition::Compositor ***a2)
{
  ...
  Windows::UI::Composition::ComponentTransform2D *v8; // rbx
  Windows::UI::Composition::ComponentTransform2D *v9; // rcx
...
LABEL_7:
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v7 = &Windows::UI::Composition::ComponentTransform2D::`vftable';
  }
  else
  {
    v7 = 0LL;
  }
  Microsoft::WRL::ComPtr<Windows::UI::Composition::ComponentTransform2D>::Attach(&v11, v7);
  v8 = v11;
  v12 = 0LL;
  v9 = v11;
  *((_QWORD *)v11 + 1) = &Windows::UI::Composition::CompositionObject::s_InterfaceType;
  v5 = Windows::UI::Composition::ComponentTransform2D::RuntimeClassInitialize(v9, *a2);
  if ( v5 < 0 )
    goto LABEL_7;
  *a1 = v8;
  return 0LL;
