/*
 * XREFs of ??_GCompositionAnimationGroup@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123720
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::CompositionAnimationGroup::`scalar deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
