/*
 * XREFs of ?Message_DisplayStateChanged@HolographicCompositionDisplay@Internal@Composition@UI@Windows@@QEAAJJ@Z @ 0x180119FB4
 * Callers:
 *     ?Thunk_Message_DisplayStateChanged_76@?$IHolographicCompositorDisplayCallbacks_Receive@VHolographicCompositionDisplay@Internal@Composition@UI@Windows@@@@SAJPEAXPEAPEAX@Z @ 0x18011A7A0 (-Thunk_Message_DisplayStateChanged_76@-$IHolographicCompositorDisplayCallbacks_Receive@VHolograp.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::HolographicCompositionDisplay::Message_DisplayStateChanged(
        ...
        int a2)
{
  ...
  if ( this )
    Microsoft::WRL2::NestableRuntimeClass::InternalAddRef(this);
  v4 = Microsoft::WRL::Details::Make_Microsoft::WRL::Details::DelegateArgTraits_long____cdecl_Windows::System::IDispatcherQueueHandler::___void__::DelegateInvokeHelper_Microsoft::WRL::Implements_Microsoft::WRL::RuntimeClassFlags_2__Windows::System::IDispatcherQueueHandler_Microsoft::WRL::FtmBase___lambda_0503c03458151d77f0968d2fc1c55318_____1___lambda_0503c03458151d77f0968d2fc1c55318____(
         &v15,
         (__int64)&v12);
  v6 = *v4;
  *v4 = 0LL;
