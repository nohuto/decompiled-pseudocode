/*
 * XREFs of ?put_Condition@Api@CompositionConditionalValue@Interactions@Composition@UI@Windows@@UEAAJPEAUIExpressionAnimation@456@@Z @ 0x18012D3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::CompositionConditionalValue::Api::put_Condition(
        Windows::UI::Composition::Interactions::CompositionConditionalValue::Api *this,
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)this - 96) & 2) != 0 )
  {
    ...
    {
      v9 = 0LL;
      Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionDrawingSurface>::InternalUnlock(&v9);
      ...
      if ( v6 < 0 )
      {
        DoStackCaptureDirect(v6, 0x83u);
      }
      else
      {
        if ( v9 != *((struct Microsoft::WRL2::ContextRuntimeClass **)this + 2) )
        {
          ++*((_DWORD *)this + 8);
    ...
    {
      v5 = -2147024809;
      DoStackCaptureDirect(-2147024809, 0x80u);
    }
  }
  else
  {
