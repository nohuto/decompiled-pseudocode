/*
 * XREFs of ?what@ResultException@wil@@UEBAPEBDXZ @ 0x1801A4600
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StringCchPrintfA@details@wil@@YAJPEAD_KPEBDZZ @ 0x1801A4374 (-StringCchPrintfA@details@wil@@YAJPEAD_KPEBDZZ.c)
 *     ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x1801A4560 (-create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z.c)
 */
