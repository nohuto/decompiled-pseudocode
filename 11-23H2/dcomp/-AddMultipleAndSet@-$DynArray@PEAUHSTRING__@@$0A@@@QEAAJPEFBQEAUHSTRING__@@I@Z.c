/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@PEAUHSTRING__@@$0A@@@QEAAJPEFBQEAUHSTRING__@@I@Z @ 0x180073424
 * Callers:
...
__int64 __fastcall DynArray<HSTRING__ *,0>::AddMultipleAndSet(__int64 a1, _QWORD *a2)
{
  __int64 v2; // rax
  unsigned int v4; // r8d
  unsigned int v5; // ebx
