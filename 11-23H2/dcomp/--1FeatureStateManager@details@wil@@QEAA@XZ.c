/*
 * XREFs of ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x1800E3C14
 * Callers:
...
void __fastcall wil::details::FeatureStateManager::~FeatureStateManager(wil::details::FeatureStateManager *this)
{
  ...
  *((_QWORD *)this + 32) = 0LL;
  ...
  if ( v4 )
  {
    v2 = (void *)*((_QWORD *)&xmmword_18021CD00 + 1);
    if ( *((_QWORD *)&xmmword_18021CD00 + 1) )
      wil::details_abi::SubscriptionList::Unsubscribe(
        (wil::details_abi::SubscriptionList *)(*((_QWORD *)&xmmword_18021CD00 + 1) + 200LL),
        *((struct wil::srwlock **)&xmmword_18021CD00 + 1),
        v4);
  }
