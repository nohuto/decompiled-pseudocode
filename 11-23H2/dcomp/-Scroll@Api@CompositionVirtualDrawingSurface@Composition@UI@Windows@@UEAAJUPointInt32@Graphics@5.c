/*
 * XREFs of ?Scroll@Api@CompositionVirtualDrawingSurface@Composition@UI@Windows@@UEAAJUPointInt32@Graphics@5@@Z @ 0x180195CF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVirtualDrawingSurface::Api::Scroll(__int64 a1, __int64 a2)
{
  ...
  v7 = a2;
  v2 = (Windows::UI::Composition::DrawingSurfaceBase *)(a1 - 200);
  v3 = *(struct _RTL_CRITICAL_SECTION **)(a1 - 200 + 24);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    v4 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0x174u);
    else
      v4 = 0;
  }
  else
