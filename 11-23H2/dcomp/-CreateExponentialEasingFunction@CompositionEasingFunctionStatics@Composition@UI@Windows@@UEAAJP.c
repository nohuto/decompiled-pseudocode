/*
 * XREFs of ?CreateExponentialEasingFunction@CompositionEasingFunctionStatics@Composition@UI@Windows@@UEAAJPEAUICompositor@234@W4CompositionEasingFunctionMode@234@MPEAPEAUIExponentialEasingFunction@234@@Z @ 0x18012EB60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionEasingFunctionStatics::CreateExponentialEasingFunction(
        __int64 a1,
        struct IUnknown *a2,
        unsigned int a3,
        float a4,
...
LABEL_6:
  ...
  if ( v8 < 0 )
  {
    DoStackCaptureDirect(v8, 0x17Du);
  }
  else
  {
    v12[0] = v13;
    v10 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::ExponentialEasingFunction,Windows::UI::Composition::ExponentialEasingFunction,Windows::UI::Composition::Compositor *,enum Windows::UI::Composition::CompositionEasingFunctionMode &,float &>(
            &a5,
            (__int64 *)v12,
            &v14,
            &v15);
    ...
    if ( v10 < 0 )
    {
      DoStackCaptureDirect(v10, 0x183u);
      v6 = a5;
    }
    else
    {
