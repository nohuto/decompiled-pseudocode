/*
 * XREFs of ?put_PositionYSourceMode@Api@InteractionSourceConfiguration@Interactions@Composition@UI@Windows@@UEAAJW4InteractionSourceRedirectionMode@3456@@Z @ 0x180162190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionSourceConfiguration::Api::put_PositionYSourceMode(
        __int64 a1,
        int a2)
{
  ...
  if ( (*(_BYTE *)(a1 - 96) & 2) != 0 )
  {
    ...
    *(_DWORD *)(a1 + 28) = a2;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x102u);
    else
      v5 = 0;
  }
  else
