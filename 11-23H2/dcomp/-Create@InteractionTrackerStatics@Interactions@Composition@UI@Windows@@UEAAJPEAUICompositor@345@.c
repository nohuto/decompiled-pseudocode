/*
 * XREFs of ?Create@InteractionTrackerStatics@Interactions@Composition@UI@Windows@@UEAAJPEAUICompositor@345@PEAPEAUIInteractionTracker@2345@@Z @ 0x180138700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTrackerStatics::Create(
        Windows::UI::Composition::Interactions::InteractionTrackerStatics *this,
        struct IUnknown *a2,
        struct Windows::UI::Composition::Interactions::IInteractionTracker **a3)
{
  unsigned int v4; // edi
  ...
  Microsoft::WRL2::NestableRuntimeClass *v11; // [rsp+58h] [rbp+28h] BYREF
...
LABEL_6:
  ...
  if ( v4 )
    goto LABEL_6;
  v5 = v12;
  Microsoft::WRL2::ContextSession::BeginApiEntry((struct _RTL_CRITICAL_SECTION *)v12);
  if ( (*((_BYTE *)v5 + 32) & 2) == 0 )
  {
    v4 = -2147483629;
    RoOriginateErrorW(
  ...
  v12 = 0LL;
  v10 = v5;
  v7 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Interactions::InteractionTracker,Windows::UI::Composition::Interactions::InteractionTracker,Windows::UI::Composition::Compositor *,std::nullptr_t>(
         &v11,
         &v10,
         &v12);
  v8 = v7;
  if ( v7 < 0 )
  {
    DoStackCaptureDirect(v7, 0xD79u);
    v9 = v11;
  }
  else
  {
    v9 = 0LL;
    *a3 = (struct Windows::UI::Composition::Interactions::IInteractionTracker *)(((unsigned __int64)v11 + 136) & -(__int64)(v11 != 0LL));
    v8 = 0;
  }
  Microsoft::WRL2::ContextSession::EndApiEntry((struct _RTL_CRITICAL_SECTION *)v5);
