/*
 * XREFs of ?put_BottomInset@Api@?$CompositionNineGridBrushT@VCompositionNineGridBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJM@Z @ 0x18004A690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionNineGridBrushT<Windows::UI::Composition::CompositionNineGridBrush,Windows::UI::Composition::CompositionBrush>::Api::put_BottomInset(
        __int64 a1,
        float a2)
{
  __int64 *v2; // rdi
...
LABEL_12:
  ...
  {
    v25[0] = (void *)Windows::UI::Composition::CompositionNineGridBrush::sc_BottomInset;
