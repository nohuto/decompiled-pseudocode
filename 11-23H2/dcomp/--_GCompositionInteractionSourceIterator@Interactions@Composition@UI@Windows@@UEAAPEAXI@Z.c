/*
 * XREFs of ??_GCompositionInteractionSourceIterator@Interactions@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18018FCA0
 * Callers:
 *     <none>
 * Callees:
...
Microsoft::WRL2::NestableRuntimeClass **__fastcall Windows::UI::Composition::Interactions::CompositionInteractionSourceIterator::`scalar deleting destructor'(
