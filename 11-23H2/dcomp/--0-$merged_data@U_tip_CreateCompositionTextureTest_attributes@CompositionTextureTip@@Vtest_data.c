/*
 * XREFs of ??0?$merged_data@U_tip_CreateCompositionTextureTest_attributes@CompositionTextureTip@@Vtest_data_basic@tip2@@@details@tip2@@QEAA@XZ @ 0x1800A0690
 * Callers:
        ...
        __int64 a1)
{
  ...
  *((_QWORD *)&v4 + 1) = 0LL;
  *(_QWORD *)&v3 = 0x2C10002BB080CLL;
  *((_QWORD *)&v3 + 1) = "CreateCompositionTextureTest";
  LOWORD(v4) = 1;
  v5[0] = v3;
  v5[1] = v4;
  v5[2] = 0uLL;
