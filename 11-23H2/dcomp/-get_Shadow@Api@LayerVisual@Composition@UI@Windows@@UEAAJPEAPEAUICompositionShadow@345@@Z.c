/*
 * XREFs of ?get_Shadow@Api@LayerVisual@Composition@UI@Windows@@UEAAJPEAPEAUICompositionShadow@345@@Z @ 0x18017A080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::LayerVisual::Api::get_Shadow(
        ...
        struct Windows::UI::Composition::ICompositionShadow **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (*((_BYTE *)this - 288) & 2) != 0 )
  {
    ...
    v8 = 0LL;
    Windows::UI::Composition::CompositionShadow::ToApi<Windows::UI::Composition::ICompositionShadow>(v6, (__int64 *)&v8);
    *a2 = v8;
    v8 = 0LL;
