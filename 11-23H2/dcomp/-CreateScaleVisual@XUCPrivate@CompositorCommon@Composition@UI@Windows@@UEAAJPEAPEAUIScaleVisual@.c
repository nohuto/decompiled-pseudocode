/*
 * XREFs of ?CreateScaleVisual@XUCPrivate@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUIScaleVisual@Private@345@@Z @ 0x180126B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::XUCPrivate::CreateScaleVisual(
        Windows::UI::Composition::CompositorCommon::XUCPrivate *this,
        struct Windows::UI::Composition::Private::IScaleVisual **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Private::ScaleVisual,Windows::UI::Composition::Private::ScaleVisual,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v4 = v5;
    if ( v5 >= 0 )
    {
      *a2 = (struct Windows::UI::Composition::Private::IScaleVisual *)(((unsigned __int64)v8 + 312) & ((unsigned __int128)-(__int128)(unsigned __int64)v8 >> 64));
      v4 = 0;
    }
    else
    {
      ...
      DoStackCaptureDirect(v4, 0x181Au);
    }
  }
  else
  {
