/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@dcompwinrtnestedg_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x18016E040
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dcompwinrtnestedg_AutoBamos::BamoPeerImpl::SendAckProxyReference(
