/*
 * XREFs of ?put_InnerConeAngleInDegrees@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z @ 0x180086E20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::Api::put_InnerConeAngleInDegrees(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v9;
    v10 = (void **)&Windows::UI::Composition::SpotLight::sc_InnerConeAngleInDegrees;
    v8 = a2 * 0.017453292;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x2FEu);
    else
      v5 = 0;
  }
  else
