/*
 * XREFs of ?AdjustPositionYIfGreaterThanThreshold@Api@InteractionTracker@Interactions@Composition@UI@Windows@@UEAAJMM@Z @ 0x180136FE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTracker::Api::AdjustPositionYIfGreaterThanThreshold(
