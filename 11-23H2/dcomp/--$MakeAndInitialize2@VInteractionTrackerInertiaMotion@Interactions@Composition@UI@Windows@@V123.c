/*
 * XREFs of ??$MakeAndInitialize2@VInteractionTrackerInertiaMotion@Interactions@Composition@UI@Windows@@V12345@PEAVCompositor@345@@Details@WRL2@Microsoft@@YAJPEAPEAVInteractionTrackerInertiaMotion@Interactions@Composition@UI@Windows@@$$QEAPEAVCompositor@567@@Z @ 0x18013DADC
 * Callers:
 *     ?Create@InteractionTrackerInertiaMotionStatics@Interactions@Composition@UI@Windows@@UEAAJPEAUICompositor@345@PEAPEAUIInteractionTrackerInertiaMotion@2345@@Z @ 0x18013DBF0 (-Create@InteractionTrackerInertiaMotionStatics@Interactions@Composition@UI@Windows@@UEAAJPEAUICo.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion,Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion,Windows::UI::Composition::Compositor *>(
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      *((_QWORD *)v7 + 23) = 0LL;
      *((_QWORD *)v7 + 21) = &Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion::Api::`vftable';
    }
    else
    {
      v7 = 0LL;
    ...
    v12 = 0LL;
    *((_QWORD *)v7 + 1) = &Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion::s_InterfaceType;
    v8 = *a2;
    v13 = v7;
    v9 = Windows::UI::Composition::Interactions::InteractionTrackerInertiaModifier::RuntimeClassInitialize(v7, v8, 2LL);
    v10 = v9;
    if ( v9 >= 0 )
    {
      *a1 = v7;
    ...
    else
    {
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)0x33,
        (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtinteractiontrackerinertiamotion.cpp",
