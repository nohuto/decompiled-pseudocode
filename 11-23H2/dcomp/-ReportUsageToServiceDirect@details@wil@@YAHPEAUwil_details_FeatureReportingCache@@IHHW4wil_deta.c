/*
 * XREFs of ?ReportUsageToServiceDirect@details@wil@@YAHPEAUwil_details_FeatureReportingCache@@IHHW4wil_details_ServiceReportingKind@@I_KE@Z @ 0x180066ABC
 * Callers:
 ...
 * Callees:
 *     ?EnsureSubscribedToUsageFlush@EnabledStateManager@details@wil@@QEAAXP6AXPEAX@Z@Z @ 0x180066A2C (-EnsureSubscribedToUsageFlush@EnabledStateManager@details@wil@@QEAAXP6AXPEAX@Z@Z.c)
        ...
        char a8)
{
  ...
  v12 = wil_details_FeatureReporting_RecordUsageInCache(&v20, a1, a5, a6);
  v13 = 1;
  v14 = *(_OWORD *)v12;
  v15 = *(_QWORD *)(v12 + 16);
