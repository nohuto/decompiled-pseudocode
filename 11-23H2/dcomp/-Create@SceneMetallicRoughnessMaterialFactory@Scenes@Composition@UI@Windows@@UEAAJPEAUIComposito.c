/*
 * XREFs of ?Create@SceneMetallicRoughnessMaterialFactory@Scenes@Composition@UI@Windows@@UEAAJPEAUICompositor@345@PEAPEAUISceneMetallicRoughnessMaterial@2345@@Z @ 0x18013F220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneMetallicRoughnessMaterialFactory::Create(
        Windows::UI::Composition::Scenes::SceneMetallicRoughnessMaterialFactory *this,
        struct IUnknown *a2,
        struct Windows::UI::Composition::Scenes::ISceneMetallicRoughnessMaterial **a3)
{
  unsigned int v4; // edi
...
LABEL_6:
  ...
  v11 = v5;
  v7 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Scenes::SceneMetallicRoughnessMaterial,Windows::UI::Composition::Scenes::SceneMetallicRoughnessMaterial,Windows::UI::Composition::Compositor *>(
         &v10,
         &v11);
  v8 = v7;
  if ( v7 < 0 )
  {
    DoStackCaptureDirect(v7, 0xF9u);
    v9 = v10;
  }
  else
  {
    v9 = 0LL;
    *a3 = (struct Windows::UI::Composition::Scenes::ISceneMetallicRoughnessMaterial *)(((unsigned __int64)v10 + 240) & -(__int64)(v10 != 0LL));
    v8 = 0;
  }
  Microsoft::WRL2::ContextSession::EndApiEntry((struct _RTL_CRITICAL_SECTION *)v5);
