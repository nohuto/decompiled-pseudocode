/*
 * XREFs of ?get_ClearColor@Partner@CaptureRenderTarget@Internal@Composition@UI@Windows@@UEAAJPEAUColor@56@@Z @ 0x1801806D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureRenderTarget::Partner::get_ClearColor(
        ...
        struct Windows::UI::Color *a2)
{
  ...
  *(_DWORD *)a2 = _ResolveDelayLoadedAPIFlags;
