/*
 * XREFs of ?put_Offset@Api@CompositionViewBox@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x180179CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionViewBox::Api::put_Offset(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  *(_QWORD *)v7 = a2;
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v8[1] = v7;
    v8[2] = v7;
    v10 = (WCHAR **)&Windows::UI::Composition::CompositionViewBox::sc_Offset;
    ...
    else
    {
      ...
      DoStackCaptureDirect(v4, 0x131u);
    }
  }
  else
  {
