/*
 * XREFs of ?put_InnerConeColor@Api@SpotLight@Composition@UI@Windows@@UEAAJUColor@45@@Z @ 0x180093970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::Api::put_InnerConeColor(__int64 a1, unsigned int a2)
{
  __int64 v2; // rsi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v10[1] = &v11;
    v10[2] = &v11;
    v9 = (void **)&Windows::UI::Composition::SpotLight::sc_InnerConeColor;
    v11 = v5;
    ...
    v7 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x389u);
    else
      v7 = 0;
  }
  else
