/*
 * XREFs of ??$_Emplace_reallocate@AEBU_GUID@@AEAPEBUPresentParametersInfo@@I@?$vector@UCFlipPropertyItem@@V?$allocator@UCFlipPropertyItem@@@std@@@std@@QEAAPEAUCFlipPropertyItem@@QEAU2@AEBU_GUID@@AEAPEBUPresentParametersInfo@@$$QEAI@Z @ 0x1801ACD30
 * Callers:
...
unsigned __int64 __fastcall std::vector<CFlipPropertyItem>::_Emplace_reallocate<_GUID const &,PresentParametersInfo const * &,unsigned int>(
        __int64 *a1,
        __int64 a2,
        __int128 *a3,
        _QWORD *a4,
