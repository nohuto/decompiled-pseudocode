/*
 * XREFs of ??$MakeAndInitialize2@VCompositionProjectedShadowReceiverIterator@Composition@UI@Windows@@V1234@PEAVCompositionProjectedShadow@234@@Details@WRL2@Microsoft@@YAJPEAPEAVCompositionProjectedShadowReceiverIterator@Composition@UI@Windows@@$$QEAPEAVCompositionProjectedShadow@456@@Z @ 0x1801A166C
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionProjectedShadowReceiverIterator,Windows::UI::Composition::CompositionProjectedShadowReceiverIterator,Windows::UI::Composition::CompositionProjectedShadow *>(
...
LABEL_7:
  ...
  if ( v6 )
  {
    ...
    *((_QWORD *)v7 + 8) = 0LL;
    *((_QWORD *)v7 + 5) = &Windows::UI::Composition::CompositionProjectedShadowReceiverIterator::Api::`vftable';
  }
  else
  {
    v7 = 0LL;
  ...
  v10 = 0LL;
  *((_QWORD *)v7 + 1) = &Windows::UI::Composition::CompositionProjectedShadowReceiverIterator::s_InterfaceType;
  v8 = *a2;
  v11 = v7;
  v5 = Windows::UI::Composition::CompositionProjectedShadowReceiverIterator::RuntimeClassInitialize(v7, v8);
  if ( v5 < 0 )
    goto LABEL_7;
  *a1 = v7;
  return 0LL;
