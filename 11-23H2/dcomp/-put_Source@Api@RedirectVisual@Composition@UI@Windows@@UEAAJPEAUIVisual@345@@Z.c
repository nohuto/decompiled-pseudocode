/*
 * XREFs of ?put_Source@Api@RedirectVisual@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x18016F3B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::RedirectVisual::Api::put_Source(
        Windows::UI::Composition::RedirectVisual::Api *this,
        struct IUnknown *a2)
{
  Windows::UI::Composition::RedirectVisual *v2; // rdi
  ...
  v2 = (Windows::UI::Composition::RedirectVisual::Api *)((char *)this - 312);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v7 < 0 )
    {
      DoStackCaptureDirect(v7, 0x8Eu);
    }
    else
    {
      Windows::UI::Composition::RedirectVisual::SetSource(v2, v10);
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionBatch>::InternalUnlock(
      (volatile signed __int32 **)&v10,
