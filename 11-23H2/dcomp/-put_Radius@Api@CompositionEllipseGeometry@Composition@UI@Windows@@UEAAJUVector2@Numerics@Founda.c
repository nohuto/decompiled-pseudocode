/*
 * XREFs of ?put_Radius@Api@CompositionEllipseGeometry@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x1800949C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionEllipseGeometry::Api::put_Radius(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  *(_QWORD *)v9 = a2;
  ...
  {
    Windows::UI::Composition::OriginateInvalidArgument(14LL, L"Radius");
    v5 = -2147024809;
    v8 = 101LL;
    v7 = 2147942487LL;
    goto LABEL_10;
  ...
  v10[1] = v9;
  v10[2] = v9;
  v12 = (WCHAR **)&Windows::UI::Composition::CompositionEllipseGeometry::sc_Radius;
