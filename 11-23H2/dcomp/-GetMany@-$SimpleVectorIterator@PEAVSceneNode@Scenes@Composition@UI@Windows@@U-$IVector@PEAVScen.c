/*
 * XREFs of ?GetMany@?$SimpleVectorIterator@PEAVSceneNode@Scenes@Composition@UI@Windows@@U?$IVector@PEAVSceneNode@Scenes@Composition@UI@Windows@@@Collections@Foundation@5@U?$DefaultLifetimeTraits@PEAVSceneNode@Scenes@Composition@UI@Windows@@@Internal@785@UNoVersionTag@Internal@785@$0A@@Internal@Collections@Foundation@Windows@@UEAAJIPEAPEAUISceneNode@Scenes@Composition@UI@5@PEAI@Z @ 0x180142CD0
 * Callers:
 *     <none>
 * Callees:
 *     ??R_lambda_88e7c3b32846f20ca39c94fc857c5caa_@@QEBAJIPEAI@Z @ 0x180141798 (--R_lambda_88e7c3b32846f20ca39c94fc857c5caa_@@QEBAJIPEAI@Z.c)
 *     ??R_lambda_98fa70a4ebc5bf98e37d565e5dc8e214_@@QEBA@XZ @ 0x180141818 (--R_lambda_98fa70a4ebc5bf98e37d565e5dc8e214_@@QEBA@XZ.c)
 */

__int64 Windows::Foundation::Collections::Internal::SimpleVectorIterator<Windows::UI::Composition::Scenes::SceneNode *,Windows::Foundation::Collections::IVector<Windows::UI::Composition::Scenes::SceneNode *>,Windows::Foundation::Collections::Internal::DefaultLifetimeTraits<Windows::UI::Composition::Scenes::SceneNode *>,Windows::Foundation::Collections::Internal::NoVersionTag,0>::GetMany(
        __int64 a1,
        unsigned int a2,
        ...)
{
  ...
  *v16 = 0;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v5 )
    {
      while ( 1 )
      {
        v3 = _lambda_88e7c3b32846f20ca39c94fc857c5caa_::operator()((__int64)v11, v7, &v12);
        if ( v3 < 0 )
          break;
        ...
        if ( v5 )
          break;
        _lambda_98fa70a4ebc5bf98e37d565e5dc8e214_::operator()(v10);
      }
    }
    else
    {
      return (unsigned int)_lambda_88e7c3b32846f20ca39c94fc857c5caa_::operator()((__int64)v11, v7, (_DWORD *)(a1 + 40));
    }
  }
  else
  {
