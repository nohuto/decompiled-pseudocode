/*
 * XREFs of ?CalcAverageAppLatency@CTouchFrameStats@@IEBAMXZ @ 0x1801A7114
 * Callers:
...
float __fastcall CTouchFrameStats::CalcAverageAppLatency(CTouchFrameStats::CInteractionInfo **this)
{
  ...
  if ( v6 != v7 )
  {
    ...
    do
    {
      if ( v6 != v9 )
      {
        v11 = (float)(int)CTouchFrameStats::CInteractionInfo::AppUs(v6, v2);
        v18 = v11;
        if ( v10 == v5 )
        {
