/*
 * XREFs of ?First@SceneMeshMaterialAttributeMap@Scenes@Composition@UI@Windows@@QEAAJPEAPEAU?$IIterator@PEAU?$IKeyValuePair@PEAUHSTRING__@@W4SceneAttributeSemantic@Scenes@Composition@UI@Windows@@@Collections@Foundation@Windows@@@Collections@Foundation@5@@Z @ 0x18018D594
 * Callers:
 ...
 *     ?First@Api@SceneMeshMaterialAttributeMap@Scenes@Composition@UI@Windows@@UEAAJPEAPEAU?$IIterator@PEAU?$IKeyValuePair@PEAUHSTRING__@@W4SceneAttributeSemantic@Scenes@Composition@UI@Windows@@@Collections@Foundation@Windows@@@Collections@Foundation@6@@Z @ 0x18018D480 (-First@Api@SceneMeshMaterialAttributeMap@Scenes@Composition@UI@Windows@@UEAAJPEAPEAU-$IIterator@.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneMeshMaterialAttributeMap::First(__int64 a1, __int64 a2)
{
  __int64 v2; // rbx
  int v4; // eax
  int v5; // eax
  ...
  if ( v4 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      181LL,
      (__int64)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtscenemeshmaterialattributemap.cpp",
