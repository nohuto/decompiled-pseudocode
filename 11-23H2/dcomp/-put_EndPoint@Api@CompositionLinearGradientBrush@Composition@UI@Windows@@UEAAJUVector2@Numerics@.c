/*
 * XREFs of ?put_EndPoint@Api@CompositionLinearGradientBrush@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18006E240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionLinearGradientBrush::Api::put_EndPoint(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v8[1] = &v7;
    v8[2] = &v7;
    v9 = &Windows::UI::Composition::CompositionLinearGradientBrush::sc_EndPoint;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0xCBu);
    else
      v5 = 0;
  }
  else
