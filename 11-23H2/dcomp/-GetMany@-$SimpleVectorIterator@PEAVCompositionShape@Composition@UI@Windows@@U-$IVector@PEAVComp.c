  ...
  *v16 = 0;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v5 )
    {
      while ( 1 )
      {
        v3 = _lambda_860de50048d0c85d0681e56c22c158b2_::operator()((__int64)v11, v7, &v12);
        if ( v3 < 0 )
          break;
        ...
        if ( v5 )
          break;
        _lambda_41bb01c7cfe485fd071b4a3ecead6adf_::operator()(v10);
      }
    }
    else
    {
      return (unsigned int)_lambda_860de50048d0c85d0681e56c22c158b2_::operator()((__int64)v11, v7, (_DWORD *)(a1 + 40));
    }
  }
  else
  {
