/*
 * XREFs of ?OpenSharedTargetFromVisual@Partner@CompositorCommon@Composition@UI@Windows@@UEAAJPEAUIVisual@345@PEAPEAUIVisualTargetPartner@345@@Z @ 0x180128A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Partner::OpenSharedTargetFromVisual(
        ...
        struct Windows::UI::Composition::IVisualTargetPartner **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    SharedHandleFromIUnknown_NoLock = (*(__int64 (__fastcall **)(Windows::UI::Composition::CompositorCommon::Partner *, HANDLE, struct Windows::UI::Composition::IVisualTargetPartner **))(*(_QWORD *)this + 72LL))(
                                        this,
                                        hObject,
                                        a3);
    v6 = SharedHandleFromIUnknown_NoLock;
