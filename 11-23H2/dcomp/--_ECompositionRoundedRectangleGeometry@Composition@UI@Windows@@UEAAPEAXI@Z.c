/*
 * XREFs of ??_ECompositionRoundedRectangleGeometry@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123C60
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::CompositionRoundedRectangleGeometry::`vector deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
