/*
 * XREFs of ?SetFinalValueParameter@CompositionLineGeometry@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x180177A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionLineGeometry::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 2LL;
  v11[1] = &Windows::UI::Composition::CompositionLineGeometry::k_rgAnimDef;
