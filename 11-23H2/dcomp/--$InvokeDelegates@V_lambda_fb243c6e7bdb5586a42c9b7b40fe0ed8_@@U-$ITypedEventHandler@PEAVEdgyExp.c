/*
 * XREFs of ??$InvokeDelegates@V_lambda_fb243c6e7bdb5586a42c9b7b40fe0ed8_@@U?$ITypedEventHandler@PEAVEdgyExperienceSource@Internal@Interactions@Composition@UI@Windows@@PEAVEdgyDetectedEventArgs@23456@@Foundation@Windows@@@?$InvokeTraits@$0?1@WRL@Microsoft@@SAJV_lambda_fb243c6e7bdb5586a42c9b7b40fe0ed8_@@PEAVEventTargetArray@Details@12@PEAV?$EventSource@U?$ITypedEventHandler@PEAVEdgyExperienceSource@Internal@Interactions@Composition@UI@Windows@@PEAVEdgyDetectedEventArgs@23456@@Foundation@Windows@@U?$InvokeModeOptions@$0?1@WRL@Microsoft@@@12@@Z @ 0x180130868
 * Callers:
 *     ??$DoInvoke@V_lambda_fb243c6e7bdb5586a42c9b7b40fe0ed8_@@@?$EventSource@U?$ITypedEventHandler@PEAVEdgyExperienceSource@Internal@Interactions@Composition@UI@Windows@@PEAVEdgyDetectedEventArgs@23456@@Foundation@Windows@@U?$InvokeModeOptions@$0?1@WRL@Microsoft@@@WRL@Microsoft@@AEAAJV_lambda_fb243c6e7bdb5586a42c9b7b40fe0ed8_@@@Z @ 0x1801307C0 (--$DoInvoke@V_lambda_fb243c6e7bdb5586a42c9b7b40fe0ed8_@@@-$EventSource@U-$ITypedEventHandler@PEA.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL::InvokeTraits<-2>::InvokeDelegates<_lambda_fb243c6e7bdb5586a42c9b7b40fe0ed8_,Windows::Foundation::ITypedEventHandler<Windows::UI::Composition::Interactions::Internal::EdgyExperienceSource *,Windows::UI::Composition::Interactions::Internal::EdgyDetectedEventArgs *>>(
        _QWORD *a1,
        volatile int *a2,
        RTL_SRWLOCK *a3)
{
  ...
  while ( 1 )
  {
    v12 = ((__int64 (__fastcall *)(struct IUnknown *, _QWORD, __int64))(*v8)->lpVtbl[1].QueryInterface)(
            *v8,
            *v11,
            (*v10 + 48LL) & -(__int64)(*v10 != 0LL));
    v4 = v12;
