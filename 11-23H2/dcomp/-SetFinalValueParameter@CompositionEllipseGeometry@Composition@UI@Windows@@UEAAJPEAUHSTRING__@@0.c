/*
 * XREFs of ?SetFinalValueParameter@CompositionEllipseGeometry@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x1801775F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionEllipseGeometry::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 2LL;
  v11[1] = &Windows::UI::Composition::CompositionEllipseGeometry::k_rgAnimDef;
