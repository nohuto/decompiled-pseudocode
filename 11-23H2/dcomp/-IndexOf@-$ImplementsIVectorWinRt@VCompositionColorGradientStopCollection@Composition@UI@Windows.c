/*
 * XREFs of ?IndexOf@?$ImplementsIVectorWinRt@VCompositionColorGradientStopCollection@Composition@UI@Windows@@UICompositionColorGradientStopCollection@234@@Composition@UI@Windows@@UEAAJPEAUICompositionColorGradientStop@234@PEAIPEAE@Z @ 0x180173B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::CompositionColorGradientStopCollection,Windows::UI::Composition::ICompositionColorGradientStopCollection>::IndexOf(
        __int64 a1,
        struct IUnknown *a2,
        _DWORD *a3,
        bool *a4)
{
  ...
  *a3 = 0;
  *a4 = 0;
  v8 = *(struct _RTL_CRITICAL_SECTION **)(a1 - 160 + 24);
