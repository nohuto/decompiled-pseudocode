/*
 * XREFs of ?SetAt@?$ImplementsIVectorWinRt@VSceneNodeCollection@Scenes@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJIPEAUISceneNode@Scenes@234@@Z @ 0x180144380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::Scenes::SceneNodeCollection,>::SetAt(
        __int64 a1,
        unsigned int a2,
        struct IUnknown *a3)
{
