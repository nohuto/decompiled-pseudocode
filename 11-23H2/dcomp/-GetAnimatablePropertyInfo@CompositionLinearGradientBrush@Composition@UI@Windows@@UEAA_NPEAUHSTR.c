/*
 * XREFs of ?GetAnimatablePropertyInfo@CompositionLinearGradientBrush@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1800928D0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::CompositionLinearGradientBrush::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 2LL;
  v10[1] = &Windows::UI::Composition::CompositionLinearGradientBrush::k_rgAnimDef;
  return Windows::UI::Composition::ProxyObject::GetAnimatablePropertyInfoImpl((__int64)this, a2, v10, a3, a4, a5)
      || Windows::UI::Composition::CompositionGradientBrush::GetAnimatablePropertyInfo(this, a2, a3, a4, a5);
}
