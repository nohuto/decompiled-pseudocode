/*
 * XREFs of ?TraceOperationStart@?$AsyncBase@U?$IAsyncOperationCompletedHandler@PEAVHolographicCompositionDisplay@Internal@Composition@UI@Windows@@@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@IEAAXXZ @ 0x18011A7B0
 * Callers:
 *     ?Start@?$AsyncBase@U?$IAsyncOperationCompletedHandler@PEAVHolographicCompositionDisplay@Internal@Composition@UI@Windows@@@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@MEAAJXZ @ 0x18011A700 (-Start@-$AsyncBase@U-$IAsyncOperationCompletedHandler@PEAVHolographicCompositionDisplay@Internal.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( Microsoft::WRL::gCausality )
  {
    ...
    *(_QWORD *)&v8.Data1 = L"Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.UI.Composition.Internal.Holograph"
                            "icCompositionDisplay>";
