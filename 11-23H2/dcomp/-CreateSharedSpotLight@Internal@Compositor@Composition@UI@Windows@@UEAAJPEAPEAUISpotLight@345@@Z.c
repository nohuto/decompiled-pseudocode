/*
 * XREFs of ?CreateSharedSpotLight@Internal@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUISpotLight@345@@Z @ 0x180091CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Internal::CreateSharedSpotLight(
        ...
        struct Windows::UI::Composition::ISpotLight **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    ...
    v8 = 1;
    v10 = v2;
    v4 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::SpotLight,Windows::UI::Composition::SpotLight,Windows::UI::Composition::Compositor *,bool>(
           &v9,
           &v10,
           &v8);
    v5 = v4;
    if ( v4 < 0 )
    {
      ...
      DoStackCaptureDirect(v5, 0x630u);
    }
    else
    {
