/*
 * XREFs of ?SendDisposeProxy@BamoPeerImpl@dcompwinrtnestedg_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x18016E160
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dcompwinrtnestedg_AutoBamos::BamoPeerImpl::SendDisposeProxy(
