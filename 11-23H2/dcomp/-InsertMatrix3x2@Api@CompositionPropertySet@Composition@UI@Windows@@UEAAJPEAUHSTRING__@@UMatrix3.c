/*
 * XREFs of ?InsertMatrix3x2@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UMatrix3x2@Numerics@Foundation@5@@Z @ 0x180080570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::Api::InsertMatrix3x2(
        __int64 a1,
        HSTRING a2,
        __int64 a3)
{
