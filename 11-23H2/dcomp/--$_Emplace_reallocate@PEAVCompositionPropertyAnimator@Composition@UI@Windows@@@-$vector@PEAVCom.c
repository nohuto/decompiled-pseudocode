 ...
 *     ?_Change_array@?$vector@PEAVCompositionPropertyAnimator@Composition@UI@Windows@@V?$allocator@PEAVCompositionPropertyAnimator@Composition@UI@Windows@@@std@@@std@@AEAAXQEAPEAVCompositionPropertyAnimator@Composition@UI@Windows@@_K1@Z @ 0x180152950 (-_Change_array@-$vector@PEAVCompositionPropertyAnimator@Composition@UI@Windows@@V-$allocator@PEA.c)
 */

char *__fastcall std::vector<Windows::UI::Composition::CompositionPropertyAnimator *>::_Emplace_reallocate<Windows::UI::Composition::CompositionPropertyAnimator *>(
        __int64 a1,
        _BYTE *a2,
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<Windows::UI::Composition::CompositionPropertyAnimator *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
