/*
 * XREFs of ?get_Color@Api@DropShadow@Composition@UI@Windows@@UEAAJPEAUColor@45@@Z @ 0x180183160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::DropShadow::Api::get_Color(
