/*
 * XREFs of ?QueryInterface@CCompFrameStats@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A9890
 * Callers:
 *     ?QueryInterface@CAnimationFrameStats@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A40B0 (-QueryInterface@CAnimationFrameStats@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
