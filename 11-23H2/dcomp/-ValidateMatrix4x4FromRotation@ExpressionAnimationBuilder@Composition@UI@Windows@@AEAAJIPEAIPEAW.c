/*
 * XREFs of ?ValidateMatrix4x4FromRotation@ExpressionAnimationBuilder@Composition@UI@Windows@@AEAAJIPEAIPEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180166168
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::ExpressionAnimationBuilder::ValidateMatrix4x4FromRotation(
...
LABEL_5:
    ...
    else
    {
      ...
      if ( *((_DWORD *)this + (unsigned int)(v5 - 2) + 66) != 18
        || *((_DWORD *)this + (unsigned int)(v5 - 1) + 66) != 52 )
      {
        goto LABEL_5;
      }
    }
