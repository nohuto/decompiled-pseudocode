/*
 * XREFs of ?SetMinAttenuationCutoff@PointLight@Composition@UI@Windows@@QEAAJM@Z @ 0x18017A740
 * Callers:
 *     ?put_MinAttenuationCutoff@Api@PointLight@Composition@UI@Windows@@UEAAJM@Z @ 0x18017B100 (-put_MinAttenuationCutoff@Api@PointLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::PointLight::SetMinAttenuationCutoff(
        ...
        float a2)
{
  ...
  v5[1] = &v8;
  v5[2] = &v8;
  v7 = (void **)&Windows::UI::Composition::PointLight::sc_MinAttenuationCutoff;
