/*
 * XREFs of ??4?$com_ptr_t@VCPresentStatusPresentStatistics@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVCPresentStatusPresentStatistics@@@Z @ 0x1801AD07C
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<CPresentStatusPresentStatistics,wil::err_returncode_policy>::operator=(
        __int64 *a1,
        __int64 a2)
{
  __int64 v2; // rdi
