/*
 * XREFs of ?SetFinalValueParameter@ScenePbrMaterial@Scenes@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@345@@Z @ 0x180191850
 * Callers:
 *     ?SetFinalValueParameter@SceneMetallicRoughnessMaterial@Scenes@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@345@@Z @ 0x18013F5A0 (-SetFinalValueParameter@SceneMetallicRoughnessMaterial@Scenes@Composition@UI@Windows@@UEAAJPEAUH.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::ScenePbrMaterial::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 4LL;
  v11[1] = &Windows::UI::Composition::Scenes::ScenePbrMaterial::k_rgAnimDef;
