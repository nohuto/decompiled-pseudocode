/*
 * XREFs of ?Pause@CAnimationInstance@DirectComposition@@UEAAJXZ @ 0x180012CC0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall DirectComposition::CAnimationInstance::Pause(DirectComposition::CAnimationInstance *this)
{
  __int64 v1; // rcx
