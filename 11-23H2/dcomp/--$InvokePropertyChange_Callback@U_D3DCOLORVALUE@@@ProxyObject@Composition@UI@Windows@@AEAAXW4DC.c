/*
 * XREFs of ??$InvokePropertyChange_Callback@U_D3DCOLORVALUE@@@ProxyObject@Composition@UI@Windows@@AEAAXW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBU_D3DCOLORVALUE@@@Z @ 0x1801468C4
 * Callers:
 *     ?Thunk_Message_ColorPropertyChanged_Callback_175@?$IPropertyChanged_Receive@VProxyObject@Composition@UI@Windows@@@@SAJPEAXPEAPEAX@Z @ 0x18010C4A0 (-Thunk_Message_ColorPropertyChanged_Callback_175@-$IPropertyChanged_Receive@VProxyObject@Composi.c)
 * Callees:
...
char __fastcall Windows::UI::Composition::ProxyObject::InvokePropertyChange_Callback<_D3DCOLORVALUE>(
        ...
        __int64 a4)
{
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v16 = v14;
    ...
    v19 = v16;
    v20 = a4;
    result = Microsoft::WRL2::ContextSession::LeaveSession_Callback<_lambda_64934c7e96d1b9526a948e7f65b87268_>(v12);
  }
  v13 = Buffer;
  if ( Buffer )
  {
