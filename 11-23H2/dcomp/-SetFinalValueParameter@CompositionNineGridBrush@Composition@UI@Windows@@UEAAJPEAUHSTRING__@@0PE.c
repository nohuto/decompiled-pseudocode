/*
 * XREFs of ?SetFinalValueParameter@CompositionNineGridBrush@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x180168EE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionNineGridBrush::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 8LL;
  v11[1] = &Windows::UI::Composition::CompositionNineGridBrush::k_rgAnimDef;
