/*
 * XREFs of ?CreateInkProxy@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionInkPartner@@@Z @ 0x1800EF7D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateInkProxy(
        DirectComposition::CDevice *this,
        struct IDCompositionInkPartner **a2)
{
  __int64 result; // rax
  struct IDCompositionInkPartner *v4; // rdx
  ...
  {
    v4 = (struct IDCompositionInkPartner *)v6;
    *((_DWORD *)v6 + 3) = v5;
    *(_QWORD *)v4 = &DirectComposition::CInkProxy::`vftable';
    *((_DWORD *)v4 + 2) = 1;
    *a2 = v4;
  }
  return result;
