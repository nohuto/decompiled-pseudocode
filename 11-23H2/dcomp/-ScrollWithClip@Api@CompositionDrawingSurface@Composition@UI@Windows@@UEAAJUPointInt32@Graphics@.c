/*
 * XREFs of ?ScrollWithClip@Api@CompositionDrawingSurface@Composition@UI@Windows@@UEAAJUPointInt32@Graphics@5@URectInt32@75@@Z @ 0x18010A8D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionDrawingSurface::Api::ScrollWithClip(
        __int64 a1,
        __int64 a2,
        const struct Windows::Graphics::RectInt32 *a3)
{
  ...
  v9 = a2;
  v3 = (Windows::UI::Composition::DrawingSurfaceBase *)(a1 - 192);
  v5 = *(struct _RTL_CRITICAL_SECTION **)(a1 - 192 + 24);
  ...
  if ( (*((_BYTE *)v3 + 32) & 2) != 0 )
  {
    ...
    v6 = v7;
    if ( v7 < 0 )
      DoStackCaptureDirect(v7, 0x1EFu);
    else
      v6 = 0;
  }
  else
