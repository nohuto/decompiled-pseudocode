/*
 * XREFs of ?CreateVector2KeyFrameAnimation@Api@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUIVector2KeyFrameAnimation@345@@Z @ 0x18005EDD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Api::CreateVector2KeyFrameAnimation(
        struct _RTL_CRITICAL_SECTION *this,
        struct Windows::UI::Composition::IVector2KeyFrameAnimation **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v4 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Vector2KeyFrameAnimation,Windows::UI::Composition::Vector2KeyFrameAnimation,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v5 = v4;
    if ( v4 < 0 )
    {
      ...
      DoStackCaptureDirect(v5, 0x501u);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::IVector2KeyFrameAnimation *)((v8 + 496) & ((unsigned __int128)-(__int128)v8 >> 64));
      v5 = 0;
    }
  }
  else
