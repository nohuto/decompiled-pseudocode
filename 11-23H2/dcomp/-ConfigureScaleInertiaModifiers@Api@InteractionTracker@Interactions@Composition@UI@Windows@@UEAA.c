/*
 * XREFs of ?ConfigureScaleInertiaModifiers@Api@InteractionTracker@Interactions@Composition@UI@Windows@@UEAAJPEAU?$IIterable@PEAVInteractionTrackerInertiaModifier@Interactions@Composition@UI@Windows@@@Collections@Foundation@6@@Z @ 0x180138150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTracker::Api::ConfigureScaleInertiaModifiers(
        __int64 a1,
        __int64 a2)
{
  int v3; // eax
...
LABEL_5:
  ...
  if ( v12[0] == -1LL || !v8 && v12[0] )
  {
    ...
    JUMPOUT(0x180138300LL);
  }
  if ( !v12[0] )
  {
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionPropertySet>::InternalUnlock((Microsoft::WRL2::NestableRuntimeClass **)(v6 + 360));
  ...
  v12[1] = v8;
  v10 = Windows::UI::Composition::Interactions::InteractionTracker::ConfigureInertiaModifiers(v6, v12, 2);
  v11 = v10;
  if ( v10 >= 0 )
  {
LABEL_13:
  ...
  DoStackCaptureDirect(v11, 0xCAAu);
LABEL_14:
  Microsoft::WRL2::ContextSession::EndApiEntry(v5);
  if ( v8 )
