/*
 * XREFs of ??_ESharedLight@Private@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18000DDC0
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::Private::SharedLight *__fastcall Windows::UI::Composition::Private::SharedLight::`vector deleting destructor'(
