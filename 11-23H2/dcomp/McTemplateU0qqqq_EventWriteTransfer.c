/*
 * XREFs of McTemplateU0qqqq_EventWriteTransfer @ 0x18016973C
 * Callers:
...
ULONG __fastcall McTemplateU0qqqq_EventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  v14 = &a6;
  v15 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, &REGISTERANIMATIONTARGET, a3, 5u, &v7);
}
