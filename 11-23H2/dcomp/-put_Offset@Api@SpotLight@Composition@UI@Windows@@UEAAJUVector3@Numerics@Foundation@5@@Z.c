/*
 * XREFs of ?put_Offset@Api@SpotLight@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@5@@Z @ 0x18017D130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::Api::put_Offset(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v9[0] = v2 + 296;
    v9[2] = a2;
    v8 = (PVOID *)&Windows::UI::Composition::SpotLight::sc_Offset;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x27Au);
    else
      v5 = 0;
  }
  else
