/*
 * XREFs of ?RemoveAllVisuals@?$CVisualProxyBase@UIDCompositionVisualRestricted@@@DirectComposition@@UEAAJXZ @ 0x18000F3D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CVisualProxyBase<IDCompositionVisualRestricted>::RemoveAllVisuals(__int64 a1)
{
  __int64 v1; // rax
  __int64 v2; // rcx
  void *v3; // rcx
