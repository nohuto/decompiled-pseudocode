/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$0N@@WRL@Microsoft@@$0A@UIActivationFactory@@U?$Implements@VFtmBase@WRL@Microsoft@@UICompositionPartnerDebugSettingsStatics@Private@Composition@UI@Windows@@@23@VNil@Details@23@V6723@V6723@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x180105FC4
 * Callers:
 ...
 *     ?QueryInterface@?$ActivationFactory@U?$Implements@VFtmBase@WRL@Microsoft@@UICompositionPartnerDebugSettingsStatics@Private@Composition@UI@Windows@@@WRL@Microsoft@@VNil@Details@23@V4523@$0A@@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180107A50 (-QueryInterface@-$ActivationFactory@U-$Implements@VFtmBase@WRL@Microsoft@@UIComposi_ea_180107A50.c)
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  else
  {
    ...
    {
      if ( InlineIsEqualGUID(a2, &GUID_a0817f60_477d_4d8a_b0cc_0509bd48635b) )
        *v9 = v7 + 32;
      else
        return v10;
    }
