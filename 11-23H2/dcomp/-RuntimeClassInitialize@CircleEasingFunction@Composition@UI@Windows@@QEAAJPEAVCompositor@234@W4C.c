/*
 * XREFs of ?RuntimeClassInitialize@CircleEasingFunction@Composition@UI@Windows@@QEAAJPEAVCompositor@234@W4CompositionEasingFunctionMode@234@@Z @ 0x180175640
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CircleEasingFunction::RuntimeClassInitialize(
        ...
        unsigned int a3)
{
  ...
  if ( a3 <= 2 )
  {
    v6 = Windows::UI::Composition::CompositionEasingFunction::RuntimeClassInitialize(a1, a2, 65539);
    v7 = v6;
    if ( v6 >= 0 )
    {
      *((_DWORD *)a1 + 42) = a3;
    ...
    else
    {
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)0x38,
        (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtcircleeasingfunction.cpp",
