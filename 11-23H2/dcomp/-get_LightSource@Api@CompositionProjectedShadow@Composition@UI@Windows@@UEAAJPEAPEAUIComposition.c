/*
 * XREFs of ?get_LightSource@Api@CompositionProjectedShadow@Composition@UI@Windows@@UEAAJPEAPEAUICompositionLight@345@@Z @ 0x180183B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadow::Api::get_LightSource(
        Windows::UI::Composition::CompositionProjectedShadow::Api *this,
        struct Windows::UI::Composition::ICompositionLight **a2)
{
  unsigned int v3; // edi
  struct _RTL_CRITICAL_SECTION *v5; // rbx
  Microsoft::WRL2::NestableRuntimeClass *v6; // rsi
  struct Windows::UI::Composition::ICompositionLight *v7; // rax
  ...
  *a2 = 0LL;
  ...
  {
    v6 = (Microsoft::WRL2::NestableRuntimeClass *)*((_QWORD *)this + 13);
    v7 = 0LL;
    v9 = 0LL;
    if ( v6 )
    {
