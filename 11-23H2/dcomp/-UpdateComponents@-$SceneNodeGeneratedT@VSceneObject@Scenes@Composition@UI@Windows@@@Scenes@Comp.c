/*
 * XREFs of ?UpdateComponents@?$SceneNodeGeneratedT@VSceneObject@Scenes@Composition@UI@Windows@@@Scenes@Composition@UI@Windows@@QEAAJXZ @ 0x1801446EC
 * Callers:
 *     ?RebuildInternal@SceneNode@Scenes@Composition@UI@Windows@@UEAAJXZ @ 0x180143C90 (-RebuildInternal@SceneNode@Scenes@Composition@UI@Windows@@UEAAJXZ.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneNodeGeneratedT<Windows::UI::Composition::Scenes::SceneObject>::UpdateComponents(
        __int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rdx
  ...
  if ( v2 )
  {
    ...
    v11 = 0LL;
    *(_OWORD *)v10 = 0LL;
    std::vector<unsigned int>::reserve((char *)v10, (unsigned int)(v3 >> 3));
    v4 = *(_QWORD *)(a1 + 168);
    v5 = v10[1];
    v6 = *(_QWORD *)(v4 + 144);
    for ( i = *(_QWORD *)(v4 + 136); i != v6; i += 8LL )
    {
      ...
      if ( v5 == v11 )
      {
        std::vector<unsigned int>::_Emplace_reallocate<unsigned int>((__int64 *)v10, v5, &v12);
        v5 = v10[1];
      }
      else
      {
    ...
    DirectComposition::CDevice::ResourceSetReferenceArrayProperty(
      ...
      *(_DWORD *)(a1 + 128),
      ...
      v10[0],
      v5 - v10[0]);
    std::vector<unsigned int>::_Tidy((__int64)v10);
  }
  return 0LL;
}
