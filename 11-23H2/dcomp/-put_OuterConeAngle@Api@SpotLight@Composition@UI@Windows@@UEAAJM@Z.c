/*
 * XREFs of ?put_OuterConeAngle@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z @ 0x18017D1F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::Api::put_OuterConeAngle(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::SpotLight::sc_OuterConeAngle;
    ...
    v4 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x32Au);
    else
      v4 = 0;
  }
  else
