/*
 * XREFs of ??_GCompositionVisualSurface@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180091990
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::CompositionVisualSurface *__fastcall Windows::UI::Composition::CompositionVisualSurface::`scalar deleting destructor'(
        ...
        __int64 a2)
{
  ...
  Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionBatch>::InternalUnlock(
    (volatile signed __int32 **)this + 22,
    a2);
