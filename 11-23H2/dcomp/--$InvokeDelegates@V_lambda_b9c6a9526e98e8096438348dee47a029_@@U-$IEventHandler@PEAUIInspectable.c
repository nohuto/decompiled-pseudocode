...
__int64 __fastcall Microsoft::WRL::InvokeTraits<-2>::InvokeDelegates<_lambda_b9c6a9526e98e8096438348dee47a029_,Windows::Foundation::IEventHandler<IInspectable *>>(
        _QWORD *a1,
        volatile int *a2,
        RTL_SRWLOCK *a3)
{
