/*
 * XREFs of ?EndpointProc@CompositionIslandSite@Composition@UI@Windows@@CAJPEAXPEBXH@Z @ 0x18006B940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionIslandSite::EndpointProc(
        struct IUnknown *a1,
        const void *a2,
        int a3)
{
...
LABEL_8:
        ...
        v10 = CoreUICallReceive(
                a1[29].lpVtbl,
                &ICompositionIslandSiteNotification_Receive<Windows::UI::Composition::CompositionIslandSite>::Type,
