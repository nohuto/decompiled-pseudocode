/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@UIDCompositionPrimitivePartner@@@@IEAAKXZ @ 0x180081BCC
 * Callers:
 ...
 *     ?Release@?$CMILCOMBaseT@UIDCompositionPrimitivePartner@@@@UEAAKXZ @ 0x180081BC0 (-Release@-$CMILCOMBaseT@UIDCompositionPrimitivePartner@@@@UEAAKXZ.c)
...
__int64 __fastcall CMILRefCountBaseT<IDCompositionPrimitivePartner>::InternalRelease(volatile signed __int32 *a1)
{
...
LABEL_3:
  ...
  if ( !v2 )
  {
    v3 = *(_QWORD *)a1;
    --*((_DWORD *)a1 + 2);
    (*(void (__fastcall **)(volatile signed __int32 *, __int64))(v3 + 48))(a1, 1LL);
  }
  return v2;
}
