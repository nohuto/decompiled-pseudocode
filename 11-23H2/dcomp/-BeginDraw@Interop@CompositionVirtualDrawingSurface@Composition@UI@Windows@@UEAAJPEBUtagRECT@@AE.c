/*
 * XREFs of ?BeginDraw@Interop@CompositionVirtualDrawingSurface@Composition@UI@Windows@@UEAAJPEBUtagRECT@@AEBU_GUID@@PEAPEAXPEAUtagPOINT@@@Z @ 0x1800641D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVirtualDrawingSurface::Interop::BeginDraw(
        ...
        struct tagPOINT *a5)
{
  ...
  *a5 = 0LL;
  v9 = (struct _RTL_CRITICAL_SECTION *)*((_QWORD *)this - 26);
  ...
  if ( (*((_BYTE *)v5 + 32) & 2) != 0 )
  {
    ...
    v11 = v10;
    if ( v10 < 0 )
      DoStackCaptureDirect(v10, 0x1E8u);
    else
      v11 = 0;
  }
  else
