/*
 * XREFs of ?AllocatePeerThunk@BamoConnectionImpl@dcompwinrtnestedg_AutoBamos@BamoImpl@@MEAAJPEAPEAVBaseBamoPeer@Bamo@Microsoft@@@Z @ 0x18016B3C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::dcompwinrtnestedg_AutoBamos::BamoConnectionImpl::AllocatePeerThunk(
