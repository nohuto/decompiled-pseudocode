/*
 * XREFs of ?CreateHolographicViewerWithBufferCount@CDevice@DirectComposition@@UEAAJIIW4DXGI_FORMAT@@IAEBU_GUID@@PEAPEAUIDCompositionHolographicViewer@@@Z @ 0x1800EF6E0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall DirectComposition::CDevice::CreateHolographicViewerWithBufferCount(
