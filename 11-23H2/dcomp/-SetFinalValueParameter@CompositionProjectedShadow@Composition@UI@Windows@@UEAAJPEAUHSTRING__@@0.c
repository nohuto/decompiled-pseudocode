/*
 * XREFs of ?SetFinalValueParameter@CompositionProjectedShadow@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x180183A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadow::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 6LL;
  v11[1] = &Windows::UI::Composition::CompositionProjectedShadow::k_rgAnimDef;
