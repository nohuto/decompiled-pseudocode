/*
 * XREFs of ??$MakeAndInitialize2@VScaleVisual@Private@Composition@UI@Windows@@V12345@PEAVCompositor@345@@Details@WRL2@Microsoft@@YAJPEAPEAVScaleVisual@Private@Composition@UI@Windows@@$$QEAPEAVCompositor@567@@Z @ 0x1801214FC
 * Callers:
 *     ?CreateScaleVisual@XUCPrivate@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUIScaleVisual@Private@345@@Z @ 0x180126B10 (-CreateScaleVisual@XUCPrivate@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUIScaleVisual@.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Private::ScaleVisual,Windows::UI::Composition::Private::ScaleVisual,Windows::UI::Composition::Compositor *>(
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      *(_QWORD *)v7 = &Windows::UI::Composition::Private::ScaleVisual::`vftable';
      *((_QWORD *)v7 + 39) = &Windows::UI::Composition::Private::ScaleVisual::Api::`vftable';
    }
    else
    {
      v7 = 0LL;
    ...
    v12 = 0LL;
    *((_QWORD *)v7 + 1) = &Windows::UI::Composition::Private::ScaleVisual::s_InterfaceType;
    v8 = *a2;
    v13 = v7;
    v9 = Windows::UI::Composition::ContainerVisual::RuntimeClassInitialize(v7, v8, 0xC4u);
    v10 = v9;
    if ( v9 >= 0 )
    {
      *a1 = v7;
    ...
    else
    {
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)0x31,
        (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtscalevisual.cpp",
