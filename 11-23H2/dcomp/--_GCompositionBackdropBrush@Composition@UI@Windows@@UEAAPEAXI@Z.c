/*
 * XREFs of ??_GCompositionBackdropBrush@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18008C4F0
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::CompositionBackdropBrush::`scalar deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
