/*
 * XREFs of ?get_Root@SystemOnly@CompositionIslandTarget@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x18015A300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionIslandTarget::SystemOnly::get_Root(
