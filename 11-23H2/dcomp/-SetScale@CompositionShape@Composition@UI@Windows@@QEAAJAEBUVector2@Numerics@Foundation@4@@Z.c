/*
 * XREFs of ?SetScale@CompositionShape@Composition@UI@Windows@@QEAAJAEBUVector2@Numerics@Foundation@4@@Z @ 0x18006E104
 * Callers:
 *     ?put_Scale@Api@CompositionShape@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18006E0A0 (-put_Scale@Api@CompositionShape@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionShape::SetScale(
...
LABEL_4:
    ...
    v7[2] = a2;
    v7[0] = v5 + 184;
    v9 = &Windows::UI::Composition::ComponentTransform2D::sc_Scale;
