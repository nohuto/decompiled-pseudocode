/*
 * XREFs of ?SetAttenuation1@SpotLight@Composition@UI@Windows@@QEAAJM@Z @ 0x1800884C8
 * Callers:
 *     ?put_LinearAttenuation@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z @ 0x180088460 (-put_LinearAttenuation@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::SetAttenuation1(
        ...
        float a2)
{
  ...
  if ( a2 < 0.0 )
  {
    Windows::UI::Composition::OriginateInvalidArgument(14LL, L"LinearAttenuation");
    v4 = 362LL;
    updated = -2147024809;
  }
  else
  {
    ...
    v5[1] = &v7;
    v5[2] = &v7;
    v8 = (void **)&Windows::UI::Composition::SpotLight::sc_LinearAttenuation;
