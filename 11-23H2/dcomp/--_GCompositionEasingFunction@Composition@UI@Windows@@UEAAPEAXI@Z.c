/*
 * XREFs of ??_GCompositionEasingFunction@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x1801239F0
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::CompositionEasingFunction::`scalar deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
