/*
 * XREFs of ?HandlePropertyChange@ComponentTransform3D@Composition@UI@Windows@@UEAAJPEBUAnimationValueData@234@PEA_N@Z @ 0x1800B7630
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall Windows::UI::Composition::ComponentTransform3D::HandlePropertyChange(
