/*
 * XREFs of ?Free@CCrossContainerGuestReadWriteSharedSection@DirectComposition@@UEAAXPEAVCSharedAllocationBase@2@@Z @ 0x1800EC740
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DirectComposition::CCrossContainerGuestReadWriteSharedSection::Free(
