/*
 * XREFs of ?put_CoordinateSpace@Api@SpotLight@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x180062790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::Api::put_CoordinateSpace(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v5 < 0 )
    {
      DoStackCaptureDirect(v5, 0x471u);
    }
    else
    {
      Windows::UI::Composition::SpotLight::SetCoordinateSpace(v2, v8);
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionBatch>::InternalUnlock(&v8);
  }
