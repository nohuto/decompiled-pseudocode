/*
 * XREFs of ?GetAnimatablePropertyInfo@CompositionAnimationTriggerPartner@Internal@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@345@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801871E0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::Internal::CompositionAnimationTriggerPartner::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 1LL;
  v10[1] = &Windows::UI::Composition::Internal::CompositionAnimationTriggerPartner::k_rgAnimDef;
