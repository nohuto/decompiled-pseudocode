/*
 * XREFs of ??_GPointLight@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180124360
 * Callers:
 *     <none>
 * Callees:
...
volatile signed __int32 **__fastcall Windows::UI::Composition::PointLight::`scalar deleting destructor'(
