/*
 * XREFs of ?SetColorBrushAtlasSurfacePool@CPrimitive@DirectComposition@@QEAAXPEAVCAtlasSurfacePool@2@@Z @ 0x1800F9374
 * Callers:
...
void __fastcall DirectComposition::CPrimitive::SetColorBrushAtlasSurfacePool(
        ...
        struct DirectComposition::CAtlasSurfacePool *a2)
{
  ...
  if ( v4 )
  {
    ...
    ReleaseInterface<DirectComposition::CAtlasSurfacePool>((volatile signed __int32 **)this + 27);
