/*
 * XREFs of ??_EBackEasingFunction@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x1801233A0
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::BackEasingFunction::`vector deleting destructor'(void **this, char a2)
{
  __int64 v4; // rdx
