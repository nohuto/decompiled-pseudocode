/*
 * XREFs of ?put_BottomRightRadius@Api@RectangleClip@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x180081790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::RectangleClip::Api::put_BottomRightRadius(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v8 = &v10;
    v9 = &v10;
    v11 = (void **)&Windows::UI::Composition::RectangleClip::sc_BottomRightRadiusX;
    ...
    v8 = &v10;
    v9 = &v10;
    v11 = (void **)&Windows::UI::Composition::RectangleClip::sc_BottomRightRadiusY;
    Windows::UI::Composition::ProxyObject::SetAnimatablePropertyWorker<Windows::UI::Composition::PropertyUpdater<float>,Windows::UI::Composition::PropertyUpdateInfo>(
      (__int64 *)v2,
      (__int64)&v7,
      &v11);
