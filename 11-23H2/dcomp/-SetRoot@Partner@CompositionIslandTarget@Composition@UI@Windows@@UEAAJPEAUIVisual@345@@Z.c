/*
 * XREFs of ?SetRoot@Partner@CompositionIslandTarget@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x18015A230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionIslandTarget::Partner::SetRoot(
        ...
        struct IUnknown *a2)
{
  ...
  v2 = (Windows::UI::Composition::CompositionIslandTarget::Partner *)((char *)this - 144);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v7 < 0 )
    {
      DoStackCaptureDirect(v7, 0xE8u);
    }
    else
    {
      Windows::UI::Composition::CompositionIslandTarget::SetRoot(v2, v10);
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionBatch>::InternalUnlock(
      (volatile signed __int32 **)&v10,
