/*
 * XREFs of ?SetRoot@Partner@InteropHolographicTexture@Composition@UI@Windows@@UEAAJPEAUIDCompositionVisual@@@Z @ 0x180198180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InteropHolographicTexture::Partner::SetRoot(
  ...
  if ( (*((_BYTE *)this - 104) & 2) != 0 )
  {
    ...
    else
    {
      if ( v12 )
        ...
        v8 = 0LL;
      v7 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 2) + 64LL))(*((_QWORD *)this + 2), v8);
      v6 = v7;
      if ( v7 >= 0 )
      {
        v6 = 0;
