/*
 * XREFs of ?QueryInterface@?$NestedWinRtImplements@VColorKeyFrameAnimation@Composition@UI@Windows@@UIColorKeyFrameAnimation@234@@WRL2@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800785B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::NestedWinRtImplements<Windows::UI::Composition::ColorKeyFrameAnimation,Windows::UI::Composition::IColorKeyFrameAnimation>::QueryInterface(
        __int64 a1,
        _DWORD *a2,
        _QWORD *a3)
{
