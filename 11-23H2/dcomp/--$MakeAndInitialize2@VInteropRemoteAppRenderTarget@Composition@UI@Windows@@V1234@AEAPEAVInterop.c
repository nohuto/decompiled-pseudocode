/*
 * XREFs of ??$MakeAndInitialize2@VInteropRemoteAppRenderTarget@Composition@UI@Windows@@V1234@AEAPEAVInteropCompositor@234@AEAPEAUHWND__@@AEBUtagRECT@@_N@Details@WRL2@Microsoft@@YAJPEAPEAVInteropRemoteAppRenderTarget@Composition@UI@Windows@@AEAPEAVInteropCompositor@456@AEAPEAUHWND__@@AEBUtagRECT@@$$QEA_N@Z @ 0x18015F708
 * Callers:
 *     ?CreateRemoteAppRenderTarget@Api@InteropCompositor@Composition@UI@Windows@@UEAAJPEAUHWND__@@AEBUtagRECT@@PEAPEAUIDCompositionRemoteAppRenderTargetPartner@@@Z @ 0x18015FEB0 (-CreateRemoteAppRenderTarget@Api@InteropCompositor@Composition@UI@Windows@@UEAAJPEAUHWND__@@AEBU.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::InteropRemoteAppRenderTarget,Windows::UI::Composition::InteropRemoteAppRenderTarget,Windows::UI::Composition::InteropCompositor * &,HWND__ * &,tagRECT const &,bool>(
...
LABEL_6:
  ...
  if ( v11 )
    v11 = Windows::UI::Composition::InteropRemoteAppRenderTarget::InteropRemoteAppRenderTarget(v11);
