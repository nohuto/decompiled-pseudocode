/*
 * XREFs of ?QueryInterface@?$ActivationFactory@U?$Implements@VFtmBase@WRL@Microsoft@@UICompositionProjectedShadowCasterCollectionStatics@Composition@UI@Windows@@@WRL@Microsoft@@VNil@Details@23@V4523@$0A@@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AA950
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        void **a3)
{
  return Windows::UI::Composition::CompositionProjectedShadowCasterCollectionStatics::QueryInterface(
           (Windows::UI::Composition::CompositionProjectedShadowCasterCollectionStatics *)(a1 - 8),
           a2,
           a3);
}
