/*
 * XREFs of ?ValidateClamp@ExpressionAnimationBuilder@Composition@UI@Windows@@AEAAJPEAIPEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180094D3C
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::ExpressionAnimationBuilder::ValidateClamp(
...
LABEL_9:
  ...
  v4 = *((_DWORD *)this + v3 + 63);
  if ( v4 != 18 && v4 != 35 && v4 != 52 && v4 != 69 )
  {
    v7 = 5171;
    *(_DWORD *)(*((_QWORD *)this + 1) + 1000LL) = 15;
    goto LABEL_9;
  }
  if ( v4 != *((_DWORD *)this + v3 + 64) )
  {
    v7 = 5162;
    *(_DWORD *)(*((_QWORD *)this + 1) + 1000LL) = 15;
    goto LABEL_9;
