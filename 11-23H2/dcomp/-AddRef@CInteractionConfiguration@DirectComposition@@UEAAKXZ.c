/*
 * XREFs of ?AddRef@CInteractionConfiguration@DirectComposition@@UEAAKXZ @ 0x180084210
 * Callers:
 *     ?AddRef@CInteractionConfiguration@DirectComposition@@WBA@EAAKXZ @ 0x1800A84F0 (-AddRef@CInteractionConfiguration@DirectComposition@@WBA@EAAKXZ.c)
 * Callees:
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x18010084C (-IsKernelDebuggerPresent@@YAHXZ.c)
 */

__int64 __fastcall DirectComposition::CInteractionConfiguration::AddRef(
