/*
 * XREFs of ?SetFinalValueParameter@InsetClip@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x1801770E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InsetClip::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 4LL;
  v11[1] = &Windows::UI::Composition::InsetClip::k_rgAnimDef;
