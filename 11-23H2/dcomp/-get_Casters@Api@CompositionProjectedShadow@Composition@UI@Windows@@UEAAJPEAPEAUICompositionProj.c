/*
 * XREFs of ?get_Casters@Api@CompositionProjectedShadow@Composition@UI@Windows@@UEAAJPEAPEAUICompositionProjectedShadowCasterCollection@345@@Z @ 0x180008290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadow::Api::get_Casters(
        Windows::UI::Composition::CompositionProjectedShadow::Api *this,
        struct Windows::UI::Composition::ICompositionProjectedShadowCasterCollection **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v9 = 0LL;
    v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionProjectedShadowCasterCollection,Windows::UI::Composition::CompositionProjectedShadowCasterCollection,Windows::UI::Composition::CompositionProjectedShadow * &>(
           &v9,
           &v10);
    v6 = v5;
    if ( v5 < 0 )
    {
      DoStackCaptureDirect(v5, 0x230u);
      if ( v9 )
    ...
    else
    {
      ...
      *a2 = (struct Windows::UI::Composition::ICompositionProjectedShadowCasterCollection *)((v7 + 8) & -(__int64)(v7 != 0));
      v6 = 0;
    }
  }
  else
