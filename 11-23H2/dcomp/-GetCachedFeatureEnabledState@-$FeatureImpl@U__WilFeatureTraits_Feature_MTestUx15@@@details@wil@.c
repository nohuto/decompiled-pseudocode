/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MTestUx15@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180099BD0
 * Callers:
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_MTestUx15>::GetCurrentFeatureEnabledState(v6, &v15, &v14);
    for ( i = *a2; ; i = v10 )
    {
      v8 = v14 == 0;
      v9 = i;
