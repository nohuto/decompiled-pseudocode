/*
 * XREFs of ?CreateExponentialEasingFunction@CompositorCommon@Composition@UI@Windows@@QEAAJW4DCOMPOSITION_EASING_FUNCTION_MODE@@MPEAPEAVCompositionEasingFunction@234@@Z @ 0x18000C398
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::CreateExponentialEasingFunction(
        __int64 a1,
        int a2,
        float a3,
        _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  v10 = a2;
  v12 = a1;
  v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::ExponentialEasingFunction,Windows::UI::Composition::ExponentialEasingFunction,Windows::UI::Composition::Compositor *,enum Windows::UI::Composition::CompositionEasingFunctionMode,float &>(
         &v9,
         &v12,
         &v10,
         &v11);
