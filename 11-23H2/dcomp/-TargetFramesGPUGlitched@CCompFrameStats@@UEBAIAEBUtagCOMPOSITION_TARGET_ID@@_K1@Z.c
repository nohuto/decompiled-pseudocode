/*
 * XREFs of ?TargetFramesGPUGlitched@CCompFrameStats@@UEBAIAEBUtagCOMPOSITION_TARGET_ID@@_K1@Z @ 0x1801A9CD0
 * Callers:
 *     ?TargetFramesGPUGlitched@CTouchFrameStats@@UEBAIAEBUtagCOMPOSITION_TARGET_ID@@_K1@Z @ 0x1801A4430 (-TargetFramesGPUGlitched@CTouchFrameStats@@UEBAIAEBUtagCOMPOSITION_TARGET_ID@@_K1@Z.c)
 * Callees:
  ...
  if ( v8 != v7 )
  {
    ...
    do
    {
      if ( *(_QWORD *)v8 >= v10
        ...
        && CCompFrameStats::IsGPUGlitch((const struct tagCOMPOSITION_TARGET_STATS *)(v8 + 64)) )
      {
        ++v6;
      }
      v8 += 136LL;
