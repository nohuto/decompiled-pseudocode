/*
 * XREFs of ??_GSceneBoundingBox@Scenes@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123450
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::Scenes::SceneBoundingBox::`scalar deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
