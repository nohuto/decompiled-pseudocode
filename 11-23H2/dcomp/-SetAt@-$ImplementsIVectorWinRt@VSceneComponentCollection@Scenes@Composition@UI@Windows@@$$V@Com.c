/*
 * XREFs of ?SetAt@?$ImplementsIVectorWinRt@VSceneComponentCollection@Scenes@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJIPEAUISceneComponent@Scenes@234@@Z @ 0x1801442B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::Scenes::SceneComponentCollection,>::SetAt(
        __int64 a1,
        unsigned int a2,
        struct IUnknown *a3)
{
