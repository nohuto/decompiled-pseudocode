/*
 * XREFs of ?put_BottomInset@Api@InsetClip@Composition@UI@Windows@@UEAAJM@Z @ 0x180080AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InsetClip::Api::put_BottomInset(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::InsetClip::sc_BottomInset;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x175u);
    else
      v5 = 0;
  }
  else
