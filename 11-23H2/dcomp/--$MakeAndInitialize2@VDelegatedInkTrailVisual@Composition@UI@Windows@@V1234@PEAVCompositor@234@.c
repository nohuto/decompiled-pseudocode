/*
 * XREFs of ??$MakeAndInitialize2@VDelegatedInkTrailVisual@Composition@UI@Windows@@V1234@PEAVCompositor@234@$$T@Details@WRL2@Microsoft@@YAJPEAPEAVDelegatedInkTrailVisual@Composition@UI@Windows@@$$QEAPEAVCompositor@456@$$QEA$$T@Z @ 0x18011AF94
 * Callers:
 *     ?Create@DelegatedInkTrailVisualFactory@Composition@UI@Windows@@UEAAJPEAUICompositor@234@PEAPEAUIDelegatedInkTrailVisual@234@@Z @ 0x18011B330 (-Create@DelegatedInkTrailVisualFactory@Composition@UI@Windows@@UEAAJPEAUICompositor@234@PEAPEAUI.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::DelegatedInkTrailVisual,Windows::UI::Composition::DelegatedInkTrailVisual,Windows::UI::Composition::Compositor *,std::nullptr_t>(
