/*
 * XREFs of ?CreateDistantLight@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUIDistantLight@345@@Z @ 0x180125A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Api::CreateDistantLight(
        ...
        struct Windows::UI::Composition::IDistantLight **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::DistantLight,Windows::UI::Composition::DistantLight,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v4 = v5;
    if ( v5 >= 0 )
    {
      *a2 = (struct Windows::UI::Composition::IDistantLight *)(((unsigned __int64)v8 + 264) & ((unsigned __int128)-(__int128)(unsigned __int64)v8 >> 64));
      v4 = 0;
    }
    else
    {
      ...
      DoStackCaptureDirect(v4, 0x187Au);
    }
  }
  else
  {
