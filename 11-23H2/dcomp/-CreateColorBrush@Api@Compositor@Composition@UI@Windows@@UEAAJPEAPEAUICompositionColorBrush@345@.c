/*
 * XREFs of ?CreateColorBrush@Api@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUICompositionColorBrush@345@@Z @ 0x180047170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Api::CreateColorBrush(
        ...
        struct Windows::UI::Composition::ICompositionColorBrush **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v4 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionColorBrush,Windows::UI::Composition::CompositionColorBrush,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v5 = v4;
    if ( v4 < 0 )
    {
      ...
      DoStackCaptureDirect(v5, 0x2EAu);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::ICompositionColorBrush *)((v8 + 152) & ((unsigned __int128)-(__int128)v8 >> 64));
      v5 = 0;
    }
  }
  else
