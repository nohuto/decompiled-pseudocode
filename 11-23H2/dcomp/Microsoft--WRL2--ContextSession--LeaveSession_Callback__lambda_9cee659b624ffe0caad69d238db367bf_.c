/*
 * XREFs of Microsoft::WRL2::ContextSession::LeaveSession_Callback__lambda_9cee659b624ffe0caad69d238db367bf___ @ 0x18001F0AC
 * Callers:
...
unsigned int __fastcall Microsoft::WRL2::ContextSession::LeaveSession_Callback__lambda_9cee659b624ffe0caad69d238db367bf___(
        ...
        __int64 a2)
{
  ...
  v4 = lambda_9cee659b624ffe0caad69d238db367bf_::operator()(a2);
  if ( v4 < 0 )
