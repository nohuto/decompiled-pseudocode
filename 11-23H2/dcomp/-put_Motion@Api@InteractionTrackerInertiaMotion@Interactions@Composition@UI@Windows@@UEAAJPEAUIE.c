/*
 * XREFs of ?put_Motion@Api@InteractionTrackerInertiaMotion@Interactions@Composition@UI@Windows@@UEAAJPEAUIExpressionAnimation@456@@Z @ 0x18013DF60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion::Api::put_Motion(
        Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion::Api *this,
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)this - 136) & 2) != 0 )
  {
    ...
    {
      v5 = -2147024809;
      DoStackCaptureDirect(-2147024809, 0xB1u);
    }
  }
  else
  {
