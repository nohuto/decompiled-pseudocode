/*
 * XREFs of ??$AddProperty@UPropertySetColorValue@@U_D3DCOLORVALUE@@@CompositionPropertySet@Composition@UI@Windows@@AEAAJPEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBU_D3DCOLORVALUE@@@Z @ 0x18006F51C
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::AddProperty<PropertySetColorValue,_D3DCOLORVALUE>(
        __int64 a1,
        HSTRING a2,
        __int64 a3,
        __int64 a4)
