/*
 * XREFs of ??$TryGetProperty@UPropertySetColorValue@@U_D3DCOLORVALUE@@@CompositionPropertySet@Composition@UI@Windows@@AEAA?AW4CompositionGetValueStatus@123@PEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEAU_D3DCOLORVALUE@@@Z @ 0x180148248
 * Callers:
 *     ?TryGetColor@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@PEAUColor@45@PEAW4CompositionGetValueStatus@345@@Z @ 0x180149410 (-TryGetColor@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@PEAUColor@45.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::TryGetProperty<PropertySetColorValue,_D3DCOLORVALUE>(
        ...
        _OWORD *a4)
{
  ...
  if ( Windows::UI::Composition::CompositionPropertySet::GetPropertyIdFromName(a1, a2, &v11) )
  {
    ...
    if ( *(_DWORD *)(*v8 + 8 * v7) == 70 )
      *a4 = *(_OWORD *)((*(_DWORD *)(*v8 + 8 * v7 + 4) & 0x1FFFFFFF) + *((_QWORD *)a1 + 30));
    else
      return 1;
  }
  else
