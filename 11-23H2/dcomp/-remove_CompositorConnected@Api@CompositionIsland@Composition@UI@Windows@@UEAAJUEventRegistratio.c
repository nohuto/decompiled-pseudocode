/*
 * XREFs of ?remove_CompositorConnected@Api@CompositionIsland@Composition@UI@Windows@@UEAAJUEventRegistrationToken@@@Z @ 0x180113D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionIsland::Api::remove_CompositorConnected(
        RTL_SRWLOCK *this,
        struct EventRegistrationToken a2)
{
  ...
  if ( ((__int64)this[-12].Ptr & 2) != 0 )
  {
    ...
    v7 = v6;
    if ( v6 < 0 )
      DoStackCaptureDirect(v6, 0x7EFu);
    else
      v7 = 0;
    v5 = v7;
  }
