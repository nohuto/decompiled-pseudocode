/*
 * XREFs of ?GetAt@?$ImplementsIVectorWinRt@VSceneNodeCollection@Scenes@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJIPEAPEAUISceneNode@Scenes@234@@Z @ 0x180142770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::Scenes::SceneNodeCollection,>::GetAt(
        __int64 a1,
        unsigned int a2,
        __int64 *a3)
{
