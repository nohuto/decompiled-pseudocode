/*
 * XREFs of ??$InitApiData@AEAY0DJ@$$CBGAEAY0N@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0DJ@$$CBGAEAY0N@$$CBG$$QEA$$T$$QEAPECJ@Z @ 0x1800A2E7C
 * Callers:
...
void __fastcall wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[57],unsigned short const (&)[13],std::nullptr_t,long volatile *>(
        __int64 a1,
