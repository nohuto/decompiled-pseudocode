/*
 * XREFs of ?ScrollRect@Api@CompositionDrawingSurface@Composition@UI@Windows@@UEAAJUPointInt32@Graphics@5@URectInt32@75@@Z @ 0x18010A780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionDrawingSurface::Api::ScrollRect(
        __int64 a1,
        __int64 a2,
