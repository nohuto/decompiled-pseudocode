/*
 * XREFs of ?SetIntensity@PointLight@Composition@UI@Windows@@QEAAJM@Z @ 0x18017A658
 * Callers:
 *     ?put_Intensity@Api@PointLight@Composition@UI@Windows@@UEAAJM@Z @ 0x18017AF50 (-put_Intensity@Api@PointLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::PointLight::SetIntensity(
        ...
        float a2)
{
  ...
  v5[1] = &v8;
  v5[2] = &v8;
  v7 = (void **)&Windows::UI::Composition::PointLight::sc_Intensity;
