/*
 * XREFs of ?put_BaseColorInput@Api@SceneMetallicRoughnessMaterial@Scenes@Composition@UI@Windows@@UEAAJPEAUISceneMaterialInput@3456@@Z @ 0x18013FB50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneMetallicRoughnessMaterial::Api::put_BaseColorInput(
        ...
        struct IUnknown *a2)
{
  ...
  if ( !wil::ProcessShutdownInProgress((wil *)this) && _InterlockedIncrement(&dword_180220910) == 1 )
  {
    v12 = 0LL;
    v11 = (Microsoft::WRL2::NestableRuntimeClass *)&dword_180220910;
    wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[61],unsigned short const (&)[19],std::nullptr_t,long volatile *>(
      v4,
      L"put_BaseColorInput",
      &v12,
      (volatile int **)&v11);
  }
    ...
    else
    {
      if ( v13 != this[2] )
      {
        ...
        Windows::UI::Composition::ProxyObject::SetReferenceProperty(
          ...
          9u,
          v9);
        Microsoft::WRL2::RefPtr<Windows::UI::Composition::Scenes::SceneMaterialInput>::operator=(this + 2, v8);
      }
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionPropertySet>::InternalUnlock(&v11);
