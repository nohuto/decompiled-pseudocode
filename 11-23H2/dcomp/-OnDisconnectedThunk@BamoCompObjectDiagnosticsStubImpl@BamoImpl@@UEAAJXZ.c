/*
 * XREFs of ?OnDisconnectedThunk@BamoCompObjectDiagnosticsStubImpl@BamoImpl@@UEAAJXZ @ 0x18019DAE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoCompObjectDiagnosticsStubImpl::OnDisconnectedThunk(
