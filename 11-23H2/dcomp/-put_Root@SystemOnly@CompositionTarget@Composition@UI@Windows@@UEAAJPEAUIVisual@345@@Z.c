/*
 * XREFs of ?put_Root@SystemOnly@CompositionTarget@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x1801972B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionTarget::SystemOnly::put_Root(
        ...
        struct IUnknown *a2)
{
  ...
  v2 = (Windows::UI::Composition::CompositionTarget::SystemOnly *)((char *)this - 152);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    {
      v7 = Windows::UI::Composition::CompositionTarget::SetRoot(v2, v11);
      v6 = v7;
      if ( v7 >= 0 )
      {
        v6 = 0;
