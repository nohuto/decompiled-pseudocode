/*
 * XREFs of McTemplateU0qqxqqx_EventWriteTransfer @ 0x1800F71AC
 * Callers:
...
ULONG __fastcall McTemplateU0qqxqqx_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  v19 = 4LL;
  v21 = 8LL;
  return McGenEventWrite_EventWriteTransfer(a1, (const EVENT_DESCRIPTOR *)";", a3, 7u, &v9);
}
