/*
 * XREFs of ??$MakeAndInitialize2@VBackEasingFunction@Composition@UI@Windows@@V1234@PEAVCompositor@234@W4CompositionEasingFunctionMode@234@AEAM@Details@WRL2@Microsoft@@YAJPEAPEAVBackEasingFunction@Composition@UI@Windows@@$$QEAPEAVCompositor@456@$$QEAW4CompositionEasingFunctionMode@456@AEAM@Z @ 0x18011F780
 * Callers:
...
LABEL_6:
  ...
  if ( v8 )
    v8 = (Windows::UI::Composition::BackEasingFunction *)Windows::UI::Composition::BackEasingFunction::BackEasingFunction(v8);
