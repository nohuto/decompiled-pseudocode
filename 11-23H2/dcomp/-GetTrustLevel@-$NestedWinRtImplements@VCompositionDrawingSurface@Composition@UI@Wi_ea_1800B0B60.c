/*
 * XREFs of ?GetTrustLevel@?$NestedWinRtImplements@VCompositionDrawingSurface@Composition@UI@Windows@@UICompositionDrawingSurface2@234@UICompositionDrawingSurface@234@UICompositionSurface@234@@WRL2@Microsoft@@WBA@EAAJPEAW4TrustLevel@@@Z @ 0x1800B0B60
 * Callers:
 *     <none>
 * Callees:
 *     <none>
