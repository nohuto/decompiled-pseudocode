/*
 * XREFs of ?CreatePointLight@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUIPointLight@345@@Z @ 0x1801263F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Api::CreatePointLight(
        ...
        struct Windows::UI::Composition::IPointLight **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::PointLight,Windows::UI::Composition::PointLight,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v4 = v5;
    if ( v5 >= 0 )
    {
      *a2 = (struct Windows::UI::Composition::IPointLight *)(((unsigned __int64)v8 + 264) & ((unsigned __int128)-(__int128)(unsigned __int64)v8 >> 64));
      v4 = 0;
    }
    else
    {
      ...
      DoStackCaptureDirect(v4, 0x1901u);
    }
  }
  else
  {
