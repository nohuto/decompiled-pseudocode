/*
 * XREFs of ?get_RotationAxis@Api@Visual@Composition@UI@Windows@@UEAAJPEAUVector3@Numerics@Foundation@5@@Z @ 0x18010D200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::Api::get_RotationAxis(
  ...
  *((_DWORD *)a2 + 2) = 0;
  ...
  if ( (*((_BYTE *)this - 136) & 2) != 0 )
  {
    ...
    if ( Reference )
      ...
      v7 = &Windows::UI::Composition::ComponentTransform3D::sc_defaultRotationAxis;
    *(_QWORD *)a2 = *(_QWORD *)v7;
    *((_DWORD *)a2 + 2) = v7[2];
  }
  else
