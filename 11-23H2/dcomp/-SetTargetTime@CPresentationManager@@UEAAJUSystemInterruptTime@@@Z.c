/*
 * XREFs of ?SetTargetTime@CPresentationManager@@UEAAJUSystemInterruptTime@@@Z @ 0x1801AE720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPresentationManager::SetTargetTime(__int64 a1, __int64 a2)
{
  struct _RTL_CRITICAL_SECTION *v5; // [rsp+30h] [rbp+8h] BYREF

  wil::critical_section::lock((struct _RTL_CRITICAL_SECTION *)(a1 + 24), &v5);
  *(_QWORD *)(a1 + 192) = a2;
