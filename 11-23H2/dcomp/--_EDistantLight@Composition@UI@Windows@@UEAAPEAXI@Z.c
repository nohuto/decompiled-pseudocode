/*
 * XREFs of ??_EDistantLight@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180124020
 * Callers:
 *     <none>
 * Callees:
...
volatile signed __int32 **__fastcall Windows::UI::Composition::DistantLight::`vector deleting destructor'(
