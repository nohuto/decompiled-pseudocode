/*
 * XREFs of ?SetRoot@Partner@CompositionTarget@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x180196EE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionTarget::Partner::SetRoot(
        Windows::UI::Composition::CompositionTarget::Partner *this,
        struct IUnknown *a2)
{
  Windows::UI::Composition::CompositionTarget *v2; // rdi
  ...
  v2 = (Windows::UI::Composition::CompositionTarget::Partner *)((char *)this - 136);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v7 < 0 )
    {
      DoStackCaptureDirect(v7, 0xF4u);
    }
    else
    {
      Windows::UI::Composition::CompositionTarget::SetRoot(v2, v10);
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionBatch>::InternalUnlock(
      (volatile signed __int32 **)&v10,
