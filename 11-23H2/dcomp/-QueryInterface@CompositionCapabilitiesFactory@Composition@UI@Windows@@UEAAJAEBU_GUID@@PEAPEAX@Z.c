/*
 * XREFs of ?QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18008E560
 * Callers:
 *     ?QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9C50 (-QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9C70 (-QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEA.c)
 *     ?QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@WDA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9C90 (-QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@WDA@EAAJAEBU_GUID@@PEAPEA.c)
 *     ?QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9CB0 (-QueryInterface@CompositionCapabilitiesFactory@Composition@UI@Windows@@WDI@EAAJAEBU_GUID@@PEAPEA.c)
 * Callees:
