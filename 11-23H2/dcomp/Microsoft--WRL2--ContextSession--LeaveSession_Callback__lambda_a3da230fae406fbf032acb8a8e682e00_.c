/*
 * XREFs of Microsoft::WRL2::ContextSession::LeaveSession_Callback__lambda_a3da230fae406fbf032acb8a8e682e00___ @ 0x180147798
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::ContextSession::LeaveSession_Callback__lambda_a3da230fae406fbf032acb8a8e682e00___(
        ...
        __int64 a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(a2 + 8) + 48LL))(*(_QWORD *)(a2 + 8), *(_QWORD *)a2);
  if ( v4 < 0 )
