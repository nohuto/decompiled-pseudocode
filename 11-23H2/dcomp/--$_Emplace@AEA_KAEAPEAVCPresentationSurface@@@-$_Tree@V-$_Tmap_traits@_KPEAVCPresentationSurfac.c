/*
 * XREFs of ??$_Emplace@AEA_KAEAPEAVCPresentationSurface@@@?$_Tree@V?$_Tmap_traits@_KPEAVCPresentationSurface@@U?$less@_K@std@@V?$allocator@U?$pair@$$CB_KPEAVCPresentationSurface@@@std@@@3@$0A@@std@@@std@@IEAA?AU?$pair@PEAU?$_Tree_node@U?$pair@$$CB_KPEAVCPresentationSurface@@@std@@PEAX@std@@_N@1@AEA_KAEAPEAVCPresentationSurface@@@Z @ 0x1801AF6C0
 * Callers:
 ...
 *     ??$?0AEA_KAEAPEAVCPresentationSurface@@@?$_Tree_temp_node@V?$allocator@U?$_Tree_node@U?$pair@$$CB_KPEAVCPresentationSurface@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_Tree_node@U?$pair@$$CB_KPEAVCPresentationSurface@@@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@$$CB_KPEAVCPresentationSurface@@@std@@PEAX@1@AEA_KAEAPEAVCPresentationSurface@@@Z @ 0x1801AF638 (--$-0AEA_KAEAPEAVCPresentationSurface@@@-$_Tree_temp_node@V-$allocator@U-$_Tree_node@U-$pair@$$C.c)
...
__int64 __fastcall std::_Tree<std::_Tmap_traits<unsigned __int64,CPresentationSurface *,std::less<unsigned __int64>,std::allocator<std::pair<unsigned __int64 const,CPresentationSurface *>>,0>>::_Emplace<unsigned __int64 &,CPresentationSurface * &>(
        __int64 *a1,
        __int64 a2)
{
  __int64 lower; // rax
  ...
  lower = std::_Tree<std::_Tmap_traits<unsigned __int64,CPresentationSurface *,std::less<unsigned __int64>,std::allocator<std::pair<unsigned __int64 const,CPresentationSurface *>>,0>>::_Find_lower_bound<unsigned __int64>(
            a1,
            &v11);
  v7 = *(_OWORD *)lower;
  v14 = *(char **)(lower + 16);
  if ( v14[25] || *v5 < *((_QWORD *)v14 + 4) )
  {
    if ( a1[1] == 0x555555555555555LL )
      std::_Dwm_Xlength_error(v14);
    v8 = std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<unsigned __int64 const,CPresentationSurface *>,void *>>>::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<unsigned __int64 const,CPresentationSurface *>,void *>>>(
           &v11,
           (__int64)a1,
           *a1,
           v5,
