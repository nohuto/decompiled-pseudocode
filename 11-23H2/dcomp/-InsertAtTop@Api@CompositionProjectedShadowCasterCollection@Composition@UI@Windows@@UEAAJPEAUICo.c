/*
 * XREFs of ?InsertAtTop@Api@CompositionProjectedShadowCasterCollection@Composition@UI@Windows@@UEAAJPEAUICompositionProjectedShadowCaster@345@@Z @ 0x180007070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowCasterCollection::Api::InsertAtTop(
...
LABEL_15:
  ...
  inserted = Windows::UI::Composition::CompositionProjectedShadow::InsertCaster(v2[19], v12, 1, 0LL);
  v6 = inserted;
  if ( inserted < 0 )
  {
    v11 = 155;
