/*
 * XREFs of ?QueryInterface@DelegatedInkTrailVisualFactory@Composition@UI@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801027F0
 * Callers:
 *     ?QueryInterface@?$ActivationFactory@U?$Implements@VFtmBase@WRL@Microsoft@@UIDelegatedInkTrailVisualStatics@Composition@UI@Windows@@@WRL@Microsoft@@VNil@Details@23@V4523@$0A@@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9AD0 (-QueryInterface@-$ActivationFactory@U-$Implements@VFtmBase@WRL@Microsoft@@UIDelegatedInkTrailVis.c)
 *     ?QueryInterface@DelegatedInkTrailVisualFactory@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A9AF0 (-QueryInterface@DelegatedInkTrailVisualFactory@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEA.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::DelegatedInkTrailVisualFactory::QueryInterface(
