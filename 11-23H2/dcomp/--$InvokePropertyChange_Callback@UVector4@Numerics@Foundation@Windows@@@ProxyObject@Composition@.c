/*
 * XREFs of ??$InvokePropertyChange_Callback@UVector4@Numerics@Foundation@Windows@@@ProxyObject@Composition@UI@Windows@@AEAAXW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBUVector4@Numerics@Foundation@3@@Z @ 0x1801467C4
 * Callers:
 *     ?Thunk_Message_Vector4PropertyChanged_Callback_169@?$IPropertyChanged_Receive@VProxyObject@Composition@UI@Windows@@@@SAJPEAXPEAPEAX@Z @ 0x18010C5A0 (-Thunk_Message_Vector4PropertyChanged_Callback_169@-$IPropertyChanged_Receive@VProxyObject@Compo.c)
 * Callees:
...
char __fastcall Windows::UI::Composition::ProxyObject::InvokePropertyChange_Callback<Windows::Foundation::Numerics::Vector4>(
        ...
        __int64 a4)
{
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v16 = v14;
    ...
    v19 = v16;
    v20 = a4;
    result = Microsoft::WRL2::ContextSession::LeaveSession_Callback<_lambda_11a7e0926f067da0f34c5b9b86ec737f_>(v12);
  }
  v13 = Buffer;
  if ( Buffer )
  {
