/*
 * XREFs of ?GetAnimatablePropertyInfo@DropShadow@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180182DC0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::DropShadow::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 4LL;
  v10[1] = &Windows::UI::Composition::DropShadow::k_rgAnimDef;
