/*
 * XREFs of ?CreateBounceVector2Animation@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUIBounceVector2NaturalMotionAnimation@345@@Z @ 0x180125180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Api::CreateBounceVector2Animation(
        Windows::UI::Composition::CompositorCommon::Api *this,
        struct Windows::UI::Composition::IBounceVector2NaturalMotionAnimation **a2)
{
  ...
  if ( _InterlockedIncrement(&dword_180220FA8) == 1 )
  {
    v10 = 0LL;
    v9 = (Microsoft::WRL2::NestableRuntimeClass *)&dword_180220FA8;
    wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[34],unsigned short const (&)[29],std::nullptr_t,long volatile *>(
      (__int64)this,
      L"CreateBounceVector2Animation",
      (const char **)&v10,
      (volatile int **)&v9);
  }
  *a2 = 0LL;
  ...
  if ( (v4->SpinCount & 2) != 0 )
  {
    v9 = 0LL;
    v10 = v4;
    v6 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::BounceVector2NaturalMotionAnimation,Windows::UI::Composition::BounceVector2NaturalMotionAnimation,Windows::UI::Composition::Compositor *>(
           &v9,
           (struct Windows::UI::Composition::Compositor **)&v10);
    v5 = v6;
    if ( v6 >= 0 )
    {
      *a2 = (struct Windows::UI::Composition::IBounceVector2NaturalMotionAnimation *)(((unsigned __int64)v9 + 456) & ((unsigned __int128)-(__int128)(unsigned __int64)v9 >> 64));
      v5 = 0;
    }
    else
    {
      ...
      DoStackCaptureDirect(v5, 0x1FC3u);
    }
  }
  else
  {
