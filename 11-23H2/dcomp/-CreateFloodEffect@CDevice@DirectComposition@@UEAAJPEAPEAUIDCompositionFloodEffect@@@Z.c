/*
 * XREFs of ?CreateFloodEffect@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionFloodEffect@@@Z @ 0x1800EF290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateFloodEffect(
  ...
  if ( a2 )
  {
    *a2 = 0LL;
    ...
    if ( v3 >= 0 )
    {
      ...
      *((_DWORD *)v5 + 2) = 1;
      v3 = DirectComposition::CFloodEffect::Create(v5, a2);
      if ( v3 < 0 )
        *a2 = 0LL;
