/*
 * XREFs of ?FireCompletion@?$AsyncBaseFTM@U?$IAsyncOperationCompletedHandler@PEAVHolographicCompositor@Internal@Composition@UI@Windows@@@Foundation@Windows@@$00U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@UEAAJXZ @ 0x180116660
 * Callers:
 ...
 *     ??$As@U?$IAsyncOperation@PEAVHolographicCompositor@Internal@Composition@UI@Windows@@@Foundation@Windows@@@?$ComPtr@UIAsyncInfo@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@U?$IAsyncOperation@PEAVHolographicCompositor@Internal@Composition@UI@Windows@@@Foundation@Windows@@@WRL@Microsoft@@@Details@12@@Z @ 0x1801146B4 (--$As@U-$IAsyncOperation@PEAVHolographicCompositor@Internal@Composition@UI@Windows@@@Foundation@.c)
...
__int64 __fastcall Windows::Internal::AsyncBaseFTM<Windows::Foundation::IAsyncOperationCompletedHandler<Windows::UI::Composition::Internal::HolographicCompositor *>,1,Microsoft::WRL::AsyncOptions<-1,0,&_GUID const GUID_CAUSALITY_WINDOWS_PLATFORM_ID,2>>::FireCompletion(
        __int64 a1)
{
  unsigned int v1; // ebx
  unsigned int v3; // edx
  ...
  unsigned int v8; // eax
  LPSTREAM ppstm; // [rsp+30h] [rbp-18h] BYREF
  HRESULT v11; // [rsp+38h] [rbp-10h]
  __int64 (__fastcall ***v12)(_QWORD, GUID *, __int64 *); // [rsp+70h] [rbp+28h] BYREF
  struct IUnknown *v13; // [rsp+78h] [rbp+30h] BYREF
  struct IRpcOptions *v14; // [rsp+80h] [rbp+38h] BYREF
  LPUNKNOWN pUnk; // [rsp+88h] [rbp+40h] BYREF
  ...
  {
    v12 = (__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *))a1;
    ...
    if ( (int)Microsoft::WRL::ComPtr<IAsyncInfo>::As<Windows::Foundation::IAsyncOperation<Windows::UI::Composition::Internal::HolographicCompositor *>>(
                &v12,
                (__int64 *)&pUnk) >= 0 )
    {
      v4 = *(_DWORD *)(a1 + 48);
      ...
      if ( *(_QWORD *)(a1 + 112) )
      {
        if ( (int)Microsoft::WRL::AgileRef::InternalResolve(
    ...
    Microsoft::WRL::ComPtr<Windows::Foundation::ITypedEventHandler<Windows::UI::Composition::Internal::HolographicCompositor *,enum Windows::UI::Composition::Internal::HolographicCompositorStatus>>::InternalRelease((__int64 *)&pUnk);
