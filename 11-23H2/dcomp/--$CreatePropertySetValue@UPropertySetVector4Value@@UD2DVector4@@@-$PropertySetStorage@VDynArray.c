/*
 * XREFs of ??$CreatePropertySetValue@UPropertySetVector4Value@@UD2DVector4@@@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAA?AUPropertySetVector4Value@@IPEBUD2DVector4@@@Z @ 0x18000A874
 * Callers:
...
__int64 __fastcall PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::CreatePropertySetValue<PropertySetVector4Value,D2DVector4>(
        __int64 a1,
        __int64 a2,
        unsigned int a3)
{
