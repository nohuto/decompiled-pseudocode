/*
 * XREFs of ??_GVisualCapture@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x1801545E0
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::VisualCapture *__fastcall Windows::UI::Composition::VisualCapture::`scalar deleting destructor'(
