/*
 * XREFs of ??$InvokePropertyChange_Callback@UQuaternion@Numerics@Foundation@Windows@@@ProxyObject@Composition@UI@Windows@@AEAAXW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBUQuaternion@Numerics@Foundation@3@@Z @ 0x1801466C4
 * Callers:
 *     ?Thunk_Message_QuaternionPropertyChanged_Callback_181@?$IPropertyChanged_Receive@VProxyObject@Composition@UI@Windows@@@@SAJPEAXPEAPEAX@Z @ 0x18010C530 (-Thunk_Message_QuaternionPropertyChanged_Callback_181@-$IPropertyChanged_Receive@VProxyObject@Co.c)
 * Callees:
...
char __fastcall Windows::UI::Composition::ProxyObject::InvokePropertyChange_Callback<Windows::Foundation::Numerics::Quaternion>(
        ...
        __int64 a4)
{
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v16 = v14;
    ...
    v19 = v16;
    v20 = a4;
    result = Microsoft::WRL2::ContextSession::LeaveSession_Callback<_lambda_707b29dbea9b654e1d98bab86da837b0_>(v12);
  }
  v13 = Buffer;
  if ( Buffer )
  {
