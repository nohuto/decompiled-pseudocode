/*
 * XREFs of ?CreateTouchInteractionConfiguration@CDevice@DirectComposition@@UEAAJIIW4DCOMPOSITION_INTERACTION_TYPE_TOUCH@@PEAPEAUIDCompositionInteractionConfigurationPartner@@@Z @ 0x18007F640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateTouchInteractionConfiguration(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        int a4,
