 ...
 *     ?QueryInterface@EdgyExperienceSourceFactory@Internal@Interactions@Composition@UI@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180107C00 (-QueryInterface@EdgyExperienceSourceFactory@Internal@Interactions@Composition@UI@Windows@@UEAAJA.c)
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  else
  {
    ...
    {
      if ( InlineIsEqualGUID(a2, &GUID_f6ccb499_c401_4acb_bcde_64b353719b1a) )
        *v9 = v7 + 32;
      else
        return v10;
    }
