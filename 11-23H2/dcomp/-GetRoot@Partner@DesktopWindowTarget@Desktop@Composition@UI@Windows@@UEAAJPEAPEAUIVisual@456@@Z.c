/*
 * XREFs of ?GetRoot@Partner@DesktopWindowTarget@Desktop@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@456@@Z @ 0x18019FDB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Desktop::DesktopWindowTarget::Partner::GetRoot(
        Windows::UI::Composition::Desktop::DesktopWindowTarget::Partner *this,
        struct Windows::UI::Composition::IVisual **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v6 = (Microsoft::WRL2::NestableRuntimeClass *)*((_QWORD *)this + 9);
    v8 = 0LL;
