/*
 * XREFs of ?InsertAt@?$DynArray@UTimeEventCallbackData@CAnimationInstance@DirectComposition@@$0A@@@QEAAJAEBUTimeEventCallbackData@CAnimationInstance@DirectComposition@@I@Z @ 0x1800E8DE0
 * Callers:
...
__int64 __fastcall DynArray<DirectComposition::CAnimationInstance::TimeEventCallbackData,0>::InsertAt(
        __int64 a1,
        unsigned __int64 a2,
        unsigned int a3)
{
