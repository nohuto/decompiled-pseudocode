/*
 * XREFs of ?ScrollRectWithClip@Api@CompositionDrawingSurface@Composition@UI@Windows@@UEAAJUPointInt32@Graphics@5@URectInt32@75@1@Z @ 0x18010A820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionDrawingSurface::Api::ScrollRectWithClip(
        __int64 a1,
        __int64 a2,
        ...
        const struct Windows::Graphics::RectInt32 *a4)
{
  ...
  v11 = a2;
  v4 = (Windows::UI::Composition::DrawingSurfaceBase *)(a1 - 192);
  v6 = *(struct _RTL_CRITICAL_SECTION **)(a1 - 192 + 24);
  ...
  if ( (*((_BYTE *)v4 + 32) & 2) != 0 )
  {
    ...
    v8 = v9;
    if ( v9 < 0 )
      DoStackCaptureDirect(v9, 0x206u);
    else
      v8 = 0;
  }
  else
