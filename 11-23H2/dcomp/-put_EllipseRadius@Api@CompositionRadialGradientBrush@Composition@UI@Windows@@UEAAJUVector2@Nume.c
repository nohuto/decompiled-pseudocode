/*
 * XREFs of ?put_EllipseRadius@Api@CompositionRadialGradientBrush@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x1801760E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionRadialGradientBrush::Api::put_EllipseRadius(
        __int64 a1,
        __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v8[1] = &v7;
    v8[2] = &v7;
    v9 = (WCHAR **)&Windows::UI::Composition::CompositionRadialGradientBrush::sc_ellipseRadius;
    ...
    v4 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0xD3u);
    else
      v4 = 0;
  }
  else
