/*
 * XREFs of ?SetFinalValueParameter@CompositionColorGradientStop@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x180174860
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionColorGradientStop::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 2LL;
  v11[1] = &Windows::UI::Composition::CompositionColorGradientStop::k_rgAnimDef;
