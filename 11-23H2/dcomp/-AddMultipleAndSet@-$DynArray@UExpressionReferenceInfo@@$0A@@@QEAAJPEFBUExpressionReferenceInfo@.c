/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@UExpressionReferenceInfo@@$0A@@@QEAAJPEFBUExpressionReferenceInfo@@I@Z @ 0x180073378
 * Callers:
...
__int64 __fastcall DynArray<ExpressionReferenceInfo,0>::AddMultipleAndSet(__int64 *a1, __int64 a2)
{
  __int64 v2; // rax
  unsigned int v4; // r8d
  unsigned int v5; // ebx
