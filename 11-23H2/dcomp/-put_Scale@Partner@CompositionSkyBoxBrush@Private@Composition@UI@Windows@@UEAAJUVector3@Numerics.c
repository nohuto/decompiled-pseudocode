/*
 * XREFs of ?put_Scale@Partner@CompositionSkyBoxBrush@Private@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@6@@Z @ 0x1801821C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Private::CompositionSkyBoxBrush::Partner::put_Scale(
        __int64 a1,
        __int64 a2)
{
  ...
  if ( (*(_BYTE *)(a1 - 120) & 2) != 0 )
  {
    ...
    v10[2] = a2;
    v10[0] = v6 + 240;
    *(_QWORD *)v9 = &Windows::UI::Composition::ComponentTransform3D::sc_Scale;
    ...
    else
    {
      ...
      DoStackCaptureDirect(v5, 0x261u);
    }
  }
  else
  {
