/*
 * XREFs of ?put_Offset@Api@CompositionShape@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18006DE10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionShape::Api::put_Offset(__int64 a1, __int64 a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v4 = Windows::UI::Composition::CompositionShape::SetOffset(
           v2,
           (const struct Windows::Foundation::Numerics::Vector2 *)v7);
    v5 = v4;
    if ( v4 < 0 )
      DoStackCaptureDirect(v4, 0xC2u);
    else
      v5 = 0;
  }
  else
