/*
 * XREFs of ?put_CornerRadius@Api@CompositionRoundedRectangleGeometry@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18006C9B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionRoundedRectangleGeometry::Api::put_CornerRadius(
        __int64 a1,
        __int64 a2)
{
  __int64 v2; // rdi
  ...
  *(_QWORD *)v9 = a2;
  ...
  {
    Windows::UI::Composition::OriginateInvalidArgument(14LL, L"CornerRadius");
    v5 = -2147024809;
    v8 = 86LL;
    v7 = 2147942487LL;
    goto LABEL_10;
  ...
  v10[1] = v9;
  v10[2] = v9;
  v12 = &Windows::UI::Composition::CompositionRoundedRectangleGeometry::sc_CornerRadius;
