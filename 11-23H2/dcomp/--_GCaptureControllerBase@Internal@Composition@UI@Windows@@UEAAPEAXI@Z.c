/*
 * XREFs of ??_GCaptureControllerBase@Internal@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x1801235F0
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::Internal::CaptureControllerBase *__fastcall Windows::UI::Composition::Internal::CaptureControllerBase::`scalar deleting destructor'(
