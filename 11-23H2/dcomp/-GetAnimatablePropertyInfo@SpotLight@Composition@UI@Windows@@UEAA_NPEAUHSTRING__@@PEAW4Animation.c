/*
 * XREFs of ?GetAnimatablePropertyInfo@SpotLight@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18000E2F0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::SpotLight::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 15LL;
  v10[1] = &Windows::UI::Composition::SpotLight::k_rgAnimDef;
  return (unsigned __int8)((__int64 (__fastcall *)(Windows::UI::Composition::SpotLight *, HSTRING, _QWORD *, enum Windows::UI::Composition::AnimationBindingDirection *, struct ExpressionObjectPropertyInfo *, enum DCOMPOSITION_EXPRESSION_TYPE *))Windows::UI::Composition::ProxyObject::GetAnimatablePropertyInfoImpl)(
                            this,
                            a2,
                            v10,
                            a3,
