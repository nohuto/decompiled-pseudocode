/*
 * XREFs of ?Remove@Api@VisualUnorderedCollection@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x180014570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::VisualUnorderedCollection::Api::Remove(
