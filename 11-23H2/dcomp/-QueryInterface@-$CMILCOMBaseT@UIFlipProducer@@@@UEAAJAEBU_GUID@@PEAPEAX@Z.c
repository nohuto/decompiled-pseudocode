/*
 * XREFs of ?QueryInterface@?$CMILCOMBaseT@UIFlipProducer@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801AA9E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<IFlipProducer>::QueryInterface(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  int v5; // edi
  __int64 v6; // rax
