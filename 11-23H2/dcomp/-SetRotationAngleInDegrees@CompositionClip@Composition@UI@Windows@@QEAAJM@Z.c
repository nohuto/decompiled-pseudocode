/*
 * XREFs of ?SetRotationAngleInDegrees@CompositionClip@Composition@UI@Windows@@QEAAJM@Z @ 0x180155B24
 * Callers:
 *     ?put_RotationAngleInDegrees@Api@CompositionClip@Composition@UI@Windows@@UEAAJM@Z @ 0x180156280 (-put_RotationAngleInDegrees@Api@CompositionClip@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionClip::SetRotationAngleInDegrees(__int64 **this, float a2)
{
  int updated; // ebx
  __int64 *v5; // rcx
