/*
 * XREFs of ?Create@SceneSurfaceMaterialInputFactory@Scenes@Composition@UI@Windows@@UEAAJPEAUICompositor@345@PEAPEAUISceneSurfaceMaterialInput@2345@@Z @ 0x180145060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneSurfaceMaterialInputFactory::Create(
        Windows::UI::Composition::Scenes::SceneSurfaceMaterialInputFactory *this,
        struct IUnknown *a2,
        struct Windows::UI::Composition::Scenes::ISceneSurfaceMaterialInput **a3)
{
  unsigned int v4; // edi
...
LABEL_6:
  ...
  v11 = v5;
  v7 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Scenes::SceneSurfaceMaterialInput,Windows::UI::Composition::Scenes::SceneSurfaceMaterialInput,Windows::UI::Composition::Compositor *>(
         &v10,
         &v11);
  v8 = v7;
  if ( v7 < 0 )
  {
    DoStackCaptureDirect(v7, 0xCDu);
    v9 = v10;
  }
  else
  {
    v9 = 0LL;
    *a3 = (struct Windows::UI::Composition::Scenes::ISceneSurfaceMaterialInput *)(((unsigned __int64)v10 + 168) & -(__int64)(v10 != 0LL));
    v8 = 0;
  }
  Microsoft::WRL2::ContextSession::EndApiEntry((struct _RTL_CRITICAL_SECTION *)v5);
