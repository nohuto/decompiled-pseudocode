/*
 * XREFs of ?_Reallocate_exactly@?$vector@UPathSharedSectionData@@V?$allocator@UPathSharedSectionData@@@std@@@std@@AEAAX_K@Z @ 0x180178B1C
 * Callers:
...
__int64 __fastcall std::vector<PathSharedSectionData>::_Reallocate_exactly(__int64 a1, unsigned __int64 a2)
{
  __int64 v3; // rdi
  SIZE_T size_of; // rax
  void *v6; // rbx
  ...
  return std::vector<PathSharedSectionData>::_Change_array(a1, (__int64)v6, v3, a2);
}
