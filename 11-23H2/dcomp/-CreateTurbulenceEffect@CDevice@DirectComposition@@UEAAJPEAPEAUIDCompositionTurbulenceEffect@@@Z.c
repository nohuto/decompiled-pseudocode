/*
 * XREFs of ?CreateTurbulenceEffect@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionTurbulenceEffect@@@Z @ 0x1800F1180
 * Callers:
 *     ?CreateTurbulenceEffect@CDevice@DirectComposition@@W7EAAJPEAPEAUIDCompositionTurbulenceEffect@@@Z @ 0x1800A8B10 (-CreateTurbulenceEffect@CDevice@DirectComposition@@W7EAAJPEAPEAUIDCompositionTurbulenceEffect@@@.c)
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateTurbulenceEffect(
  ...
  if ( a2 )
  {
    *a2 = 0LL;
    ...
    if ( v3 >= 0 )
    {
      ...
      *((_DWORD *)v5 + 2) = 1;
      v3 = DirectComposition::CTurbulenceEffect::Create(v5, a2);
      if ( v3 < 0 )
        *a2 = 0LL;
