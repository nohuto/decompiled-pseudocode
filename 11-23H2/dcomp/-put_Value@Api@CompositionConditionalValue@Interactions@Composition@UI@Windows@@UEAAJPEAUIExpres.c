/*
 * XREFs of ?put_Value@Api@CompositionConditionalValue@Interactions@Composition@UI@Windows@@UEAAJPEAUIExpressionAnimation@456@@Z @ 0x18012D4E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::CompositionConditionalValue::Api::put_Value(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)this - 96) & 2) != 0 )
  {
    if ( a2 )
    {
      ...
      if ( v6 < 0 )
      {
        DoStackCaptureDirect(v6, 0x9Cu);
      }
      else
      {
        if ( v9 != *((struct Microsoft::WRL2::ContextRuntimeClass **)this + 3) )
        {
          ++*((_DWORD *)this + 8);
    ...
    {
      v5 = -2147024809;
      DoStackCaptureDirect(-2147024809, 0x99u);
    }
  }
  else
  {
