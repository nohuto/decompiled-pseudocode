/*
 * XREFs of ?put_AlphaCutoff@Api@ScenePbrMaterial@Scenes@Composition@UI@Windows@@UEAAJM@Z @ 0x180191F50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::ScenePbrMaterial::Api::put_AlphaCutoff(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::Scenes::ScenePbrMaterial::sc_AlphaCutoff;
    ...
    v4 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x159u);
    else
      v4 = 0;
  }
  else
