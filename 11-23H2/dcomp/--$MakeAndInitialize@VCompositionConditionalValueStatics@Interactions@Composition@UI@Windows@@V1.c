/*
 * XREFs of ??$MakeAndInitialize@VCompositionConditionalValueStatics@Interactions@Composition@UI@Windows@@V12345@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCompositionConditionalValueStatics@Interactions@Composition@UI@Windows@@@Z @ 0x180103F14
 * Callers:
 *     ??$CreateActivationFactory@VCompositionConditionalValueStatics@Interactions@Composition@UI@Windows@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x180102FE0 (--$CreateActivationFactory@VCompositionConditionalValueStatics@Interactions@Composition@UI@Windo.c)
 * Callees:
 ...
 *     ??0?$AgileActivationFactory@UICompositionConditionalValueStatics@Interactions@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@V6789@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180104CBC (--0-$AgileActivationFactory@UICompositionConditionalValueStatics@Interactions@Composition@UI@Win.c)
 */

__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::Interactions::CompositionConditionalValueStatics,Windows::UI::Composition::Interactions::CompositionConditionalValueStatics,>(
        _QWORD *a1)
{
  void *v2; // rax
  _QWORD *v4; // rax
