/*
 * XREFs of ??$CreatePropertyValue@P8IPropertyValueStatics@Foundation@Windows@@EAAJUTimeSpan@23@PEAPEAUIInspectable@@@ZU423@@PropertyValueHelper@Composition@UI@Windows@@CAJP8IPropertyValueStatics@Foundation@3@EAAJUTimeSpan@53@PEAPEAUIInspectable@@@ZPEAPEAUIPropertyValue@53@0@Z @ 0x18018B764
 * Callers:
 ...
 *     ??_9IPropertyValueStatics@Foundation@Windows@@$BLA@AA @ 0x1800B1150 (--_9IPropertyValueStatics@Foundation@Windows@@$BLA@AA.c)
...
__int64 __fastcall Windows::UI::Composition::PropertyValueHelper::CreatePropertyValue<long (Windows::Foundation::IPropertyValueStatics::*)(Windows::Foundation::TimeSpan,IInspectable * *),Windows::Foundation::TimeSpan>(
        __int64 a1,
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  v4 =  Windows::Foundation::IPropertyValueStatics::`vcall'{176,{flat}}((__int64)PropertyValueStatics);
  v5 = v4;
  if ( v4 >= 0 )
  {
    *a2 = v8;
