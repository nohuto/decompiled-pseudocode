/*
 * XREFs of ?put_CenterPoint@Api@Visual@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@5@@Z @ 0x18007DC60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::Api::put_CenterPoint(
        __int64 a1,
        const struct Windows::Foundation::Numerics::Vector3 *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v5 = Windows::UI::Composition::Visual::SetCenterPoint(v2, a2);
    v6 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0xA83u);
    else
      v6 = 0;
  }
  else
