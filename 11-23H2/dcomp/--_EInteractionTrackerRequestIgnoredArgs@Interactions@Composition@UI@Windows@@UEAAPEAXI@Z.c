/*
 * XREFs of ??_EInteractionTrackerRequestIgnoredArgs@Interactions@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180136840
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::Interactions::InteractionTrackerRequestIgnoredArgs *__fastcall Windows::UI::Composition::Interactions::InteractionTrackerRequestIgnoredArgs::`vector deleting destructor'(
