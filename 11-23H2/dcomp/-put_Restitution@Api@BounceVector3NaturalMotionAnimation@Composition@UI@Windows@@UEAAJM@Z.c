/*
 * XREFs of ?put_Restitution@Api@BounceVector3NaturalMotionAnimation@Composition@UI@Windows@@UEAAJM@Z @ 0x18017E050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::BounceVector3NaturalMotionAnimation::Api::put_Restitution(
