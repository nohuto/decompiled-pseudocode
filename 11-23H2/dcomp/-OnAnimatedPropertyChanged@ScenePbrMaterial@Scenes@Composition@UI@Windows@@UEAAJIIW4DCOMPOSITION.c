/*
 * XREFs of ?OnAnimatedPropertyChanged@ScenePbrMaterial@Scenes@Composition@UI@Windows@@UEAAJIIW4DCOMPOSITION_EXPRESSION_TYPE@@_N1PEBXG@Z @ 0x180191710
 * Callers:
 *     ?OnAnimatedPropertyChanged@SceneMetallicRoughnessMaterial@Scenes@Composition@UI@Windows@@UEAAJIIW4DCOMPOSITION_EXPRESSION_TYPE@@_N1PEBXG@Z @ 0x18013F3F0 (-OnAnimatedPropertyChanged@SceneMetallicRoughnessMaterial@Scenes@Composition@UI@Windows@@UEAAJII.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::ScenePbrMaterial::OnAnimatedPropertyChanged(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        __int64 a4,
        ...
        __int16 a8)
{
  ...
  v8 = a4;
  v15[1] = &Windows::UI::Composition::Scenes::ScenePbrMaterial::k_rgAnimDef;
  v15[0] = 4LL;
