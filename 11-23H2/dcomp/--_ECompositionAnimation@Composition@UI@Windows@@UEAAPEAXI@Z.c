/*
 * XREFs of ??_ECompositionAnimation@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18011CA90
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::CompositionAnimation *__fastcall Windows::UI::Composition::CompositionAnimation::`vector deleting destructor'(
