/*
 * XREFs of ?CreateElasticEasingFunction@CompositorCommon@Composition@UI@Windows@@QEAAJW4DCOMPOSITION_EASING_FUNCTION_MODE@@HMPEAPEAVCompositionEasingFunction@234@@Z @ 0x180125B48
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::CreateElasticEasingFunction(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        float a4,
        Microsoft::WRL2::NestableRuntimeClass *a5)
{
  ...
  v10 = a1;
  *(_QWORD *)v5 = 0LL;
  v6 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::ElasticEasingFunction,Windows::UI::Composition::ElasticEasingFunction,Windows::UI::Composition::Compositor *,enum Windows::UI::Composition::CompositionEasingFunctionMode,int &,float &>(
         &a5,
         &v10,
         &v11,
         &v12,
