/*
 * XREFs of ?remove_TriggerFired@Partner@CompositionAnimationTriggerPartner@Internal@Composition@UI@Windows@@UEAAJUEventRegistrationToken@@@Z @ 0x180187860
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CompositionAnimationTriggerPartner::Partner::remove_TriggerFired(
        RTL_SRWLOCK *this,
        struct EventRegistrationToken a2)
{
  ...
  if ( ((__int64)this[-13].Ptr & 2) != 0 )
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      DoStackCaptureDirect(v6, 0x118u);
    else
      v5 = 0;
  }
  else
