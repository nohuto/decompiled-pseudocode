/*
 * XREFs of McTemplateU0xxqqqq_EventWriteTransfer @ 0x1800FD4E8
 * Callers:
...
ULONG McTemplateU0xxqqqq_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  v13 = 4LL;
  v15 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, &DCOMPEVENT_CREATE_CLUMP, v17, 7u, &v3);
}
