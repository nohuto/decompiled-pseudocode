/*
 * XREFs of ?_Change_array@?$vector@PEAVBamoPrincipalImpl@BamoImpl@Microsoft@@V?$allocator@PEAVBamoPrincipalImpl@BamoImpl@Microsoft@@@std@@@std@@AEAAXQEAPEAVBamoPrincipalImpl@BamoImpl@Microsoft@@_K1@Z @ 0x18016F06C
 * Callers:
