/*
 * XREFs of ??0?$AgileActivationFactory@UIInspectable@@VNil@Details@WRL@Microsoft@@V2345@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180002FFC
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AgileActivationFactory<IInspectable,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::AgileActivationFactory<IInspectable,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>(
        __int64 a1)
{
  _QWORD *v1; // rdi
  ...
  *(_QWORD *)a1 = &Microsoft::WRL::AgileActivationFactory<IInspectable,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::`vftable';
  *v1 = &Microsoft::WRL::AgileActivationFactory<IInspectable,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,IInspectable>>'};
