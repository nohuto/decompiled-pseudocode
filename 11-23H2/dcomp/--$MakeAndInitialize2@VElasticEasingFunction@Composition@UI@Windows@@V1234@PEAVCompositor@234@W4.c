...
LABEL_6:
  ...
  if ( v11 )
    v11 = (Windows::UI::Composition::ElasticEasingFunction *)Windows::UI::Composition::ElasticEasingFunction::ElasticEasingFunction(v11);
