/*
 * XREFs of ?RuntimeClassInitialize@ExponentialEasingFunction@Composition@UI@Windows@@QEAAJPEAVCompositor@234@W4CompositionEasingFunctionMode@234@M@Z @ 0x18000C4E8
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::ExponentialEasingFunction::RuntimeClassInitialize(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        float a4)
...
LABEL_8:
    wil::details::in1diag3::Return_HrMsg(
      retaddr,
      (void *)v11,
      (unsigned int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtexponentialeasingfunction.cpp",
  ...
  if ( !_finite(a4) )
  {
    v10 = "Invalid exponent.";
    v11 = 60LL;
    goto LABEL_8;
  }
  v7 = Windows::UI::Composition::CompositionEasingFunction::RuntimeClassInitialize(a1, a2, 65541LL);
  v8 = v7;
  if ( v7 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x40,
      (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtexponentialeasingfunction.cpp",
