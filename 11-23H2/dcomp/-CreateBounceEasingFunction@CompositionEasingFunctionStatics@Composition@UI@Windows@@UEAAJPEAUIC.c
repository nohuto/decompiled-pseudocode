/*
 * XREFs of ?CreateBounceEasingFunction@CompositionEasingFunctionStatics@Composition@UI@Windows@@UEAAJPEAUICompositor@234@W4CompositionEasingFunctionMode@234@HMPEAPEAUIBounceEasingFunction@234@@Z @ 0x18012E520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionEasingFunctionStatics::CreateBounceEasingFunction(
        __int64 a1,
        struct IUnknown *a2,
        unsigned int a3,
        unsigned int a4,
...
LABEL_6:
  ...
  if ( v9 < 0 )
  {
    DoStackCaptureDirect(v9, 0x117u);
  }
  else
  {
    v13[0] = v14;
    v11 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::BounceEasingFunction,Windows::UI::Composition::BounceEasingFunction,Windows::UI::Composition::Compositor *,enum Windows::UI::Composition::CompositionEasingFunctionMode &,int &,float &>(
            &a6,
            v13,
            &v15,
            &v16,
    ...
    if ( v11 < 0 )
    {
      DoStackCaptureDirect(v11, 0x11Eu);
      v7 = a6;
    }
    else
    {
