/*
 * XREFs of ??$MakeAndInitialize@VInteractionTrackerStatics@Interactions@Composition@UI@Windows@@V12345@$$V@Details@WRL@Microsoft@@YAJPEAPEAVInteractionTrackerStatics@Interactions@Composition@UI@Windows@@@Z @ 0x1801044D8
 * Callers:
 ...
 *     ??0?$AgileActivationFactory@UIInteractionTrackerStatics@Interactions@Composition@UI@Windows@@UIInteractionTrackerStatics2@2345@VNil@Details@WRL@Microsoft@@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180105338 (--0-$AgileActivationFactory@UIInteractionTrackerStatics@Interactions@Composition@UI@Windows@@UII.c)
 */

__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::Interactions::InteractionTrackerStatics,Windows::UI::Composition::Interactions::InteractionTrackerStatics,>(
        _QWORD *a1)
{
  void *v2; // rax
  _QWORD *v4; // rax
  ...
  *a1 = 0LL;
  ...
  if ( v2 )
  {
    ...
    if ( v4 )
    {
      Microsoft::WRL::AgileActivationFactory<Windows::UI::Composition::Interactions::IInteractionTrackerStatics,Windows::UI::Composition::Interactions::IInteractionTrackerStatics2,Microsoft::WRL::Details::Nil,0>::AgileActivationFactory<Windows::UI::Composition::Interactions::IInteractionTrackerStatics,Windows::UI::Composition::Interactions::IInteractionTrackerStatics2,Microsoft::WRL::Details::Nil,0>(v4);
      *v5 = &Windows::UI::Composition::Interactions::InteractionTrackerStatics::`vftable'{for `IActivationFactory'};
      v5[1] = &Windows::UI::Composition::Interactions::InteractionTrackerStatics::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,Windows::UI::Composition::Interactions::IInteractionTrackerStatics>>'};
      v5[5] = &Windows::UI::Composition::Interactions::InteractionTrackerStatics::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Windows::UI::Composition::Interactions::IInteractionTrackerStatics>,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,Windows::UI::Composition::Interactions::IInteractionTrackerStatics>>'};
      v5[7] = &Windows::UI::Composition::Interactions::InteractionTrackerStatics::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<13>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::Implements<Microsoft::WRL::FtmBase,Windows::UI::Composition::Interactions::IInteractionTrackerStatics>>,Windows::UI::Composition::Interactions::IInteractionTrackerStatics2,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil>'};
