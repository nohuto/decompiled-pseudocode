/*
 * XREFs of ?put_Opacity@Api@DropShadow@Composition@UI@Windows@@UEAAJM@Z @ 0x180183570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::DropShadow::Api::put_Opacity(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::DropShadow::sc_Opacity;
    ...
    v4 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x156u);
    else
      v4 = 0;
  }
  else
