/*
 * XREFs of ?put_ReceivingVisual@Api@CompositionProjectedShadowReceiver@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x180010950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowReceiver::Api::put_ReceivingVisual(
        ...
        struct IUnknown *a2)
{
  ...
  v2 = (Windows::UI::Composition::CompositionProjectedShadowReceiver::Api *)((char *)this - 136);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v5 < 0 )
    {
      DoStackCaptureDirect(v5, 0x107u);
    }
    else
    {
      Windows::UI::Composition::CompositionProjectedShadowReceiver::SetReceivingVisual(v2, v8);
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionBatch>::InternalUnlock(&v8);
  }
