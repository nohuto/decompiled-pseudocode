/*
 * XREFs of ?GetAnimatablePropertyInfo@CompositionProjectedShadow@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180183720
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::CompositionProjectedShadow::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 6LL;
  v10[1] = &Windows::UI::Composition::CompositionProjectedShadow::k_rgAnimDef;
