/*
 * XREFs of ?SendMaterializeProxy@BamoCompObjectDiagnosticsPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18019E350
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoCompObjectDiagnosticsPrincipalImpl::SendMaterializeProxy(
