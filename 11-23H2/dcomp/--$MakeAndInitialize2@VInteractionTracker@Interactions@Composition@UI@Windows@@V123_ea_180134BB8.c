/*
 * XREFs of ??$MakeAndInitialize2@VInteractionTracker@Interactions@Composition@UI@Windows@@V12345@PEAVCompositor@345@AEAPEAUIInteractionTrackerOwner@2345@@Details@WRL2@Microsoft@@YAJPEAPEAVInteractionTracker@Interactions@Composition@UI@Windows@@$$QEAPEAVCompositor@567@AEAPEAUIInteractionTrackerOwner@4567@@Z @ 0x180134BB8
 * Callers:
 *     ?CreateWithOwner@InteractionTrackerStatics@Interactions@Composition@UI@Windows@@UEAAJPEAUICompositor@345@PEAUIInteractionTrackerOwner@2345@PEAPEAUIInteractionTracker@2345@@Z @ 0x180138930 (-CreateWithOwner@InteractionTrackerStatics@Interactions@Composition@UI@Windows@@UEAAJPEAUICompos.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Interactions::InteractionTracker,Windows::UI::Composition::Interactions::InteractionTracker,Windows::UI::Composition::Compositor *,Windows::UI::Composition::Interactions::IInteractionTrackerOwner * &>(
