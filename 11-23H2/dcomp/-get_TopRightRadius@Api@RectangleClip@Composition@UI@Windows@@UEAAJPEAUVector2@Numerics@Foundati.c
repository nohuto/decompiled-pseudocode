/*
 * XREFs of ?get_TopRightRadius@Api@RectangleClip@Composition@UI@Windows@@UEAAJPEAUVector2@Numerics@Foundation@5@@Z @ 0x18017BD00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::RectangleClip::Api::get_TopRightRadius(
