/*
 * XREFs of ??_ECursorVisual@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123EF0
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::CursorVisual *__fastcall Windows::UI::Composition::CursorVisual::`vector deleting destructor'(
