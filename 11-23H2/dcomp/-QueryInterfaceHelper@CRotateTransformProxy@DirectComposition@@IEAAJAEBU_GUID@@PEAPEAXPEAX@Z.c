/*
 * XREFs of ?QueryInterfaceHelper@CRotateTransformProxy@DirectComposition@@IEAAJAEBU_GUID@@PEAPEAXPEAX@Z @ 0x1800F3900
 * Callers:
 *     ?QueryInterface@CRotateTransformProxy@DirectComposition@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F3210 (-QueryInterface@CRotateTransformProxy@DirectComposition@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall DirectComposition::CRotateTransformProxy::QueryInterfaceHelper(
        ...
        void *a4)
{
  ...
  v4 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_641ed83c_ae96_46c5_90dc_32774cc5c6d5.Data1;
  if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_641ed83c_ae96_46c5_90dc_32774cc5c6d5.Data1 )
    v4 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_641ed83c_ae96_46c5_90dc_32774cc5c6d5.Data4;
  if ( v4 )
  {
