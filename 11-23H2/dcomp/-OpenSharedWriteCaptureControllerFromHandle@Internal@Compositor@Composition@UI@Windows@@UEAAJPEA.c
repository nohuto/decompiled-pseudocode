/*
 * XREFs of ?OpenSharedWriteCaptureControllerFromHandle@Internal@Compositor@Composition@UI@Windows@@UEAAJPEAUICompositionHandle@1Handles@Foundation@5@PEAPEAUIWriteCaptureController@1345@@Z @ 0x180110800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Internal::OpenSharedWriteCaptureControllerFromHandle(
        ...
        struct Windows::UI::Composition::Internal::IWriteCaptureController **a3)
{
  ...
  struct Windows::UI::Composition::Internal::IWriteCaptureController *v22; // [rsp+88h] [rbp+48h] BYREF
  ...
  *a3 = 0LL;
  ...
  if ( v8 < 0 )
  {
    DoStackCaptureDirect(v8, 0x782u);
    v14 = v20;
    if ( v20 )
    {
      v20 = 0LL;
  ...
  if ( v6 < 0 )
  {
    DoStackCaptureDirect(v6, 0x783u);
  }
  else
  {
    v16 = 0LL;
    v10 = Windows::UI::Composition::CompositorCommon::OpenSharedWriteCaptureControllerFromHandle(v3, hObject, &v16);
    v6 = v10;
    if ( v10 >= 0 )
    {
      v11 = v16;
    ...
    DoStackCaptureDirect(v10, 0x787u);
    v12 = v16;
    if ( v16 )
LABEL_10:
