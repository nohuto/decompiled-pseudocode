/*
 * XREFs of ??$MakeAndInitialize@VInteractionTrackerInertiaRestingValueStatics@Interactions@Composition@UI@Windows@@V12345@$$V@Details@WRL@Microsoft@@YAJPEAPEAVInteractionTrackerInertiaRestingValueStatics@Interactions@Composition@UI@Windows@@@Z @ 0x180104434
 * Callers:
 ...
 *     ??0?$AgileActivationFactory@UIInteractionTrackerInertiaRestingValueStatics@Interactions@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@V6789@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180105294 (--0-$AgileActivationFactory@UIInteractionTrackerInertiaRestingValueStatics@Interactions@Composit.c)
 */

__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::Interactions::InteractionTrackerInertiaRestingValueStatics,Windows::UI::Composition::Interactions::InteractionTrackerInertiaRestingValueStatics,>(
        _QWORD *a1)
{
  void *v2; // rax
  _QWORD *v4; // rax
