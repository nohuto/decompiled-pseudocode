/*
 * XREFs of ?Add@Api@CompositionAnimationGroup@Composition@UI@Windows@@UEAAJPEAUICompositionAnimation@345@@Z @ 0x180151750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionAnimationGroup::Api::Add(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    {
      v5 = -2147024809;
      DoStackCaptureDirect(-2147024809, 0x1EAu);
      goto LABEL_12;
    }
    v9 = 0LL;
    ...
    {
      v6 = Windows::UI::Composition::CompositionAnimationGroup::Add(v2, v9);
      v5 = v6;
      if ( v6 >= 0 )
      {
        v5 = 0;
