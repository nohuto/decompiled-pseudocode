/*
 * XREFs of ?put_CenterPoint@Partner@CaptureController@Internal@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@6@@Z @ 0x18017FC90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureController::Partner::put_CenterPoint(
        __int64 a1,
        __int64 a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    v4 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0x126u);
    else
      v4 = 0;
  }
  else
