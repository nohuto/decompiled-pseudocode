/*
 * XREFs of ?_Change_array@?$vector@PEAVBamoProxyImpl@BamoImpl@Microsoft@@V?$allocator@PEAVBamoProxyImpl@BamoImpl@Microsoft@@@std@@@std@@AEAAXQEAPEAVBamoProxyImpl@BamoImpl@Microsoft@@_K1@Z @ 0x18016F0D4
 * Callers:
