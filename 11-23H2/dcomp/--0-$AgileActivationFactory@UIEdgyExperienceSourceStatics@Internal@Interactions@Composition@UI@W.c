/*
 * XREFs of ??0?$AgileActivationFactory@UIEdgyExperienceSourceStatics@Internal@Interactions@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@V789Microsoft@@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180104FF0
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_QWORD *)a1 = &Microsoft::WRL::AgileActivationFactory<Windows::UI::Composition::Interactions::Internal::IEdgyExperienceSourceStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::`vftable';
