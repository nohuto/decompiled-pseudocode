/*
 * XREFs of ?put_AnchorPoint@Api@CompositionClip@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x1801560D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionClip::Api::put_AnchorPoint(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    v5 = Windows::UI::Composition::CompositionClip::SetAnchorPoint(
           (__int64 **)v2,
