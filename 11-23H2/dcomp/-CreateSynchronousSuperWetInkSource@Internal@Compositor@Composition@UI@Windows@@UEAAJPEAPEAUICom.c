/*
 * XREFs of ?CreateSynchronousSuperWetInkSource@Internal@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUICompositionSynchronousSuperWetInkSource@1345@@Z @ 0x18010F3C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Internal::CreateSynchronousSuperWetInkSource(
        Windows::UI::Composition::Compositor::Internal *this,
        struct Windows::UI::Composition::Internal::ICompositionSynchronousSuperWetInkSource **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    v8 = 0LL;
    v9 = v2;
    v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Internal::CompositionSynchronousSuperWetInkSource,Windows::UI::Composition::Internal::CompositionSynchronousSuperWetInkSource,Windows::UI::Composition::Compositor *>(
           &v8,
           &v9);
    v4 = v5;
    if ( v5 >= 0 )
    {
      *a2 = (struct Windows::UI::Composition::Internal::ICompositionSynchronousSuperWetInkSource *)(((unsigned __int64)v8 + 168) & ((unsigned __int128)-(__int128)(unsigned __int64)v8 >> 64));
      v4 = 0;
    }
    else
    {
      ...
      DoStackCaptureDirect(v4, 0x69Cu);
    }
  }
  else
  {
