/*
 * XREFs of ?CreateAffineTransform2DEffect@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionAffineTransform2DEffect@@@Z @ 0x1800EE8A0
 * Callers:
 *     ?CreateAffineTransform2DEffect@CDevice@DirectComposition@@W7EAAJPEAPEAUIDCompositionAffineTransform2DEffect@@@Z @ 0x1800A8550 (-CreateAffineTransform2DEffect@CDevice@DirectComposition@@W7EAAJPEAPEAUIDCompositionAffineTransf.c)
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateAffineTransform2DEffect(
  ...
  if ( a2 )
  {
    *a2 = 0LL;
    ...
    if ( v3 >= 0 )
    {
      ...
      *((_DWORD *)v5 + 2) = 1;
      v3 = DirectComposition::CAffineTransform2DEffect::Create(v5, a2);
      if ( v3 < 0 )
        *a2 = 0LL;
