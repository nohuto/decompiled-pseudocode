/*
 * XREFs of ?QueryInterface@?$NestedWinRtImplements@VWhiteNoiseEffect@Effects@Composition@UI@Windows@@UIWhiteNoiseEffect@2345@UIGraphicsEffect@2Graphics@5@UIGraphicsEffectSource@285@UIGraphicsEffectD2D1Interop@285@@WRL2@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AF280
 * Callers:
 *     <none>
 * Callees:
 *     <none>
