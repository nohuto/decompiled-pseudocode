/*
 * XREFs of ?GetRoot@Partner@CompositionTarget@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x180196A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionTarget::Partner::GetRoot(
