/*
 * XREFs of ?GetAnimatablePropertyInfo@CompositionVisualSurface@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180158F70
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::CompositionVisualSurface::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 2LL;
  v10[1] = &Windows::UI::Composition::CompositionVisualSurface::k_rgAnimDef;
