/*
 * XREFs of ?put_Source@Api@?$CompositionNineGridBrushT@VCompositionNineGridBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJPEAUICompositionBrush@345@@Z @ 0x180046470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionNineGridBrushT<Windows::UI::Composition::CompositionNineGridBrush,Windows::UI::Composition::CompositionBrush>::Api::put_Source(
        __int64 a1,
        struct Windows::UI::Composition::ICompositionBrush *a2)
{
  ...
  {
    v16 = 0LL;
    v5 = Windows::UI::Composition::CompositionNineGridBrush::Validate_Source(
           (Windows::UI::Composition::CompositionNineGridBrush *)v2,
           a2,
           &v16);
    v6 = v5;
    if ( v5 < 0 )
