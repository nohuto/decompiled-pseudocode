/*
 * XREFs of ?put_StrokeDashOffset@Api@CompositionSpriteShape@Composition@UI@Windows@@UEAAJM@Z @ 0x180172260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionSpriteShape::Api::put_StrokeDashOffset(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::CompositionSpriteShape::sc_StrokeDashOffset;
    ...
    v4 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x2CCu);
    else
      v4 = 0;
  }
  else
