/*
 * XREFs of ?SetVector2Parameter@CompositionAnimation@Composition@UI@Windows@@QEAAJPEAUHSTRING__@@AEBUVector2@Numerics@Foundation@4@@Z @ 0x18014FD04
 * Callers:
 ...
 *     ?SetVector2Parameter@Api@CompositionAnimation@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UVector2@Numerics@Foundation@5@@Z @ 0x18014FC70 (-SetVector2Parameter@Api@CompositionAnimation@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UVecto.c)
...
__int64 __fastcall Windows::UI::Composition::CompositionAnimation::SetVector2Parameter(
        ...
        const struct Windows::Foundation::Numerics::Vector2 *a3)
{
  ...
  if ( v6 < 0 )
  {
    DoStackCaptureDirect(v6, 0x18Cu);
  }
  else
  {
