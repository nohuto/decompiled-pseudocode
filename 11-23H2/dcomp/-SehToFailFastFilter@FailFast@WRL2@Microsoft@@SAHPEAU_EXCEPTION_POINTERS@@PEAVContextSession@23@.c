/*
 * XREFs of ?SehToFailFastFilter@FailFast@WRL2@Microsoft@@SAHPEAU_EXCEPTION_POINTERS@@PEAVContextSession@23@@Z @ 0x180108EF8
 * Callers:
 ...
 * Callees:
 *     ?NotifyUnhandledExternalExceptionNL@ContextSession@WRL2@Microsoft@@QEAAXPEBU_EXCEPTION_POINTERS@@@Z @ 0x180108DCC (-NotifyUnhandledExternalExceptionNL@ContextSession@WRL2@Microsoft@@QEAAXPEBU_EXCEPTION_POINTERS@.c)
...
__int64 __fastcall Microsoft::WRL2::FailFast::SehToFailFastFilter(
        struct _EXCEPTION_POINTERS *a1,
        struct Microsoft::WRL2::ContextSession *this)
{
  struct _EXCEPTION_RECORD *ExceptionRecord; // rdx

  ExceptionRecord = a1->ExceptionRecord;
  if ( a1->ExceptionRecord->ExceptionCode != -532459699
    && ExceptionRecord->ExceptionCode != -532462766
    && ExceptionRecord->ExceptionCode != -531410097
    && ExceptionRecord->ExceptionCode != -2146232797 )
  {
    Microsoft::WRL2::FailFast::_Do(0LL, ExceptionRecord, a1->ContextRecord, 0LL);
    __debugbreak();
  }
  if ( this )
    Microsoft::WRL2::ContextSession::NotifyUnhandledExternalExceptionNL(this, a1);
  return 0LL;
}
