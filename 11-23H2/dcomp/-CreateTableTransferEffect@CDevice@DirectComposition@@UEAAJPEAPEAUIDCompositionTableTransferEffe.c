/*
 * XREFs of ?CreateTableTransferEffect@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionTableTransferEffect@@@Z @ 0x1800F0E80
 * Callers:
 *     ?CreateTableTransferEffect@CDevice@DirectComposition@@W7EAAJPEAPEAUIDCompositionTableTransferEffect@@@Z @ 0x1800A89D0 (-CreateTableTransferEffect@CDevice@DirectComposition@@W7EAAJPEAPEAUIDCompositionTableTransferEff.c)
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateTableTransferEffect(
  ...
  if ( a2 )
  {
    *a2 = 0LL;
    ...
    if ( v3 >= 0 )
    {
      ...
      *((_DWORD *)v5 + 2) = 1;
      v3 = DirectComposition::CTableTransferEffect::Create(v5, a2);
      if ( v3 < 0 )
        *a2 = 0LL;
