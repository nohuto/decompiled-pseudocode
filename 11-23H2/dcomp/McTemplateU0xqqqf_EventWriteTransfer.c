/*
 * XREFs of McTemplateU0xqqqf_EventWriteTransfer @ 0x1800EA3A8
 * Callers:
...
ULONG __fastcall McTemplateU0xqqqf_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, &DCOMPEVENT_ATLAS_UTILIZATION, a3, 6u, &v8);
}
