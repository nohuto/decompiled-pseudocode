/*
 * XREFs of ?QueryInterface@?$NestedWinRtImplements@VCubicBezierEasingFunction@Composition@UI@Windows@@UICubicBezierEasingFunction@234@@WRL2@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007A110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::NestedWinRtImplements<Windows::UI::Composition::CubicBezierEasingFunction,Windows::UI::Composition::ICubicBezierEasingFunction>::QueryInterface(
        __int64 a1,
        _DWORD *a2,
        _QWORD *a3)
{
