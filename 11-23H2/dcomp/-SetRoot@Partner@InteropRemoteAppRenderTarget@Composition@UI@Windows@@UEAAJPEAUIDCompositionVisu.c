/*
 * XREFs of ?SetRoot@Partner@InteropRemoteAppRenderTarget@Composition@UI@Windows@@UEAAJPEAUIDCompositionVisual@@@Z @ 0x1801986B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InteropRemoteAppRenderTarget::Partner::SetRoot(
  ...
  if ( (*((_BYTE *)this - 104) & 2) != 0 )
  {
    ...
    else
    {
      if ( v12 )
        ...
        v8 = 0LL;
      v7 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 2) + 24LL))(*((_QWORD *)this + 2), v8);
      v6 = v7;
      if ( v7 >= 0 )
      {
        v6 = 0;
