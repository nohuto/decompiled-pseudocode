/*
 * XREFs of ?put_SourceOffset@Api@CompositionVisualSurface@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x180095290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVisualSurface::Api::put_SourceOffset(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v7[1] = &v6;
    v7[2] = &v6;
    v8 = (WCHAR **)&Windows::UI::Composition::CompositionVisualSurface::sc_SourceOffset;
