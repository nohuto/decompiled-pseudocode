/*
 * XREFs of ??_ENaturalMotionAnimation@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x1801242C0
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::NaturalMotionAnimation *__fastcall Windows::UI::Composition::NaturalMotionAnimation::`vector deleting destructor'(
