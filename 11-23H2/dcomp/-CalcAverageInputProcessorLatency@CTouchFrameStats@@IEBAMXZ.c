/*
 * XREFs of ?CalcAverageInputProcessorLatency@CTouchFrameStats@@IEBAMXZ @ 0x1801A76AC
 * Callers:
...
float __fastcall CTouchFrameStats::CalcAverageInputProcessorLatency(CTouchFrameStats::CInteractionInfo **this)
{
  ...
  if ( v6 != v7 )
  {
    ...
    do
    {
      if ( v6 != v9 )
      {
        v11 = (float)(int)CTouchFrameStats::CInteractionInfo::InputProcessorUs(v6, v2);
        v18 = v11;
        if ( v10 == v5 )
        {
