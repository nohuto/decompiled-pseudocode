...
__int64 __fastcall std::vector<std::pair<Windows::UI::Composition::CompositionAnimation *,std::unordered_map<std::wstring,Windows::UI::Composition::ParameterOverrideEntry>>>::at(
        _QWORD *a1,
        unsigned __int64 a2)
{
  if ( 0x8E38E38E38E38E39uLL * ((__int64)(a1[1] - *a1) >> 3) <= a2 )
    std::_Dwm_Xlength_error((const char *)0x8E38E38E38E38E39LL);
  return *a1 + 72 * a2;
}
