/*
 * XREFs of ?SetCenterPoint@CompositionClip@Composition@UI@Windows@@QEAAJAEBUVector2@Numerics@Foundation@4@@Z @ 0x1801557D8
 * Callers:
 *     ?put_CenterPoint@Api@CompositionClip@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x180156160 (-put_CenterPoint@Api@CompositionClip@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionClip::SetCenterPoint(
        __int64 **this,
