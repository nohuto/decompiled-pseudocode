/*
 * XREFs of ?SetTransform@Api@InteropCursorVisual@Composition@UI@Windows@@UEAAJPEAUIDCompositionTransform@@@Z @ 0x18019A350
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDCompositionTransform *a2)
{
  ...
  {
    v6 = (*(__int64 (__fastcall **)(_QWORD, struct IDCompositionTransform *))(**((_QWORD **)this + 2) + 248LL))(
           *((_QWORD *)this + 2),
           a2);
    v5 = v6;
    if ( v6 < 0 )
