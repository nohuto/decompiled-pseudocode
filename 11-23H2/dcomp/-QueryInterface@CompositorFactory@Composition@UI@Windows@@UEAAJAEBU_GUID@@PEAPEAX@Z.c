/*
 * XREFs of ?QueryInterface@CompositorFactory@Composition@UI@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18008E100
 * Callers:
 *     ?QueryInterface@CompositorFactory@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB0D0 (-QueryInterface@CompositorFactory@Composition@UI@Windows@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CompositorFactory@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB0F0 (-QueryInterface@CompositorFactory@Composition@UI@Windows@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CompositorFactory@Composition@UI@Windows@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB110 (-QueryInterface@CompositorFactory@Composition@UI@Windows@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CompositorFactory@Composition@UI@Windows@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AB130 (-QueryInterface@CompositorFactory@Composition@UI@Windows@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
