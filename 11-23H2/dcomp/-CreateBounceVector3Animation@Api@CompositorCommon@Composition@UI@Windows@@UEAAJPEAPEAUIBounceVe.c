/*
 * XREFs of ?CreateBounceVector3Animation@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUIBounceVector3NaturalMotionAnimation@345@@Z @ 0x1801252A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Api::CreateBounceVector3Animation(
        Windows::UI::Composition::CompositorCommon::Api *this,
        struct Windows::UI::Composition::IBounceVector3NaturalMotionAnimation **a2)
{
  ...
  if ( _InterlockedIncrement(&dword_180220FA4) == 1 )
  {
    v10 = 0LL;
    v9 = (Microsoft::WRL2::NestableRuntimeClass *)&dword_180220FA4;
    wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[34],unsigned short const (&)[29],std::nullptr_t,long volatile *>(
      (__int64)this,
      L"CreateBounceVector3Animation",
      (const char **)&v10,
      (volatile int **)&v9);
  }
  *a2 = 0LL;
  ...
  if ( (v4->SpinCount & 2) != 0 )
  {
    v9 = 0LL;
    v10 = v4;
    v6 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::BounceVector3NaturalMotionAnimation,Windows::UI::Composition::BounceVector3NaturalMotionAnimation,Windows::UI::Composition::Compositor *>(
           &v9,
           (struct Windows::UI::Composition::Compositor **)&v10);
    v5 = v6;
    if ( v6 >= 0 )
    {
      *a2 = (struct Windows::UI::Composition::IBounceVector3NaturalMotionAnimation *)(((unsigned __int64)v9 + 472) & ((unsigned __int128)-(__int128)(unsigned __int64)v9 >> 64));
      v5 = 0;
    }
    else
    {
      ...
      DoStackCaptureDirect(v5, 0x1FDFu);
    }
  }
  else
  {
