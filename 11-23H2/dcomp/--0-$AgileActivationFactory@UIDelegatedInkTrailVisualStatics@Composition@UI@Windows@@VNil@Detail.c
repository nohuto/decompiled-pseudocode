/*
 * XREFs of ??0?$AgileActivationFactory@UIDelegatedInkTrailVisualStatics@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@V5678@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180101BD0
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AgileActivationFactory<Windows::UI::Composition::IDelegatedInkTrailVisualStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::AgileActivationFactory<Windows::UI::Composition::IDelegatedInkTrailVisualStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>(
        __int64 a1)
{
  _QWORD *v1; // rdi
