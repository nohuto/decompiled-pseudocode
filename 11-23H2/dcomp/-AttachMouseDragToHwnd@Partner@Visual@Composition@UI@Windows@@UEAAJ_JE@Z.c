/*
 * XREFs of ?AttachMouseDragToHwnd@Partner@Visual@Composition@UI@Windows@@UEAAJ_JE@Z @ 0x18010AE00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::Partner::AttachMouseDragToHwnd(
        ...
        char a3)
{
  ...
  if ( (*((_BYTE *)this - 200) & 2) != 0 )
  {
    ...
    v7 = v8;
    if ( v8 < 0 )
      DoStackCaptureDirect(v8, 0xB9Au);
    else
      v7 = 0;
  }
  else
