/*
 * XREFs of ?GetCenterPoint@Visual@Composition@UI@Windows@@QEAAAEBUVector3@Numerics@Foundation@4@XZ @ 0x1800A1A30
 * Callers:
...
const struct Windows::Foundation::Numerics::Vector3 *__fastcall Windows::UI::Composition::Visual::GetCenterPoint(
        Windows::UI::Composition::Visual *this)
{
  ...
  if ( Reference )
    return (const struct Windows::Foundation::Numerics::Vector3 *)(Reference + 216);
  else
    return (const struct Windows::Foundation::Numerics::Vector3 *)&Windows::UI::Composition::ComponentTransform3D::sc_defaultCenterPoint;
}
