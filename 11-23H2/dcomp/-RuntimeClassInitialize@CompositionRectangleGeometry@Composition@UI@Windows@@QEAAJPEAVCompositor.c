/*
 * XREFs of ?RuntimeClassInitialize@CompositionRectangleGeometry@Composition@UI@Windows@@QEAAJPEAVCompositor@234@@Z @ 0x1800728D4
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionRectangleGeometry::RuntimeClassInitialize(
