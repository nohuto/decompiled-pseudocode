/*
 * XREFs of ?HasKey@Api@InitialValueExpressionCollectionMapView@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@PEAE@Z @ 0x1801A24D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InitialValueExpressionCollectionMapView::Api::HasKey(
        ...
        unsigned __int8 *a3)
{
  ...
  v4 = 0;
  *a3 = 0;
  v6 = (struct _RTL_CRITICAL_SECTION *)*((_QWORD *)this - 2);
  Microsoft::WRL2::ContextSession::BeginApiEntry(v6);
  if ( (*((_BYTE *)this - 8) & 2) != 0 )
  {
    *a3 = Windows::UI::Composition::InitialValueExpressionCollection::HasKey(
