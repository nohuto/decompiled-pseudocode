/*
 * XREFs of ?put_Direction@Api@SpotLight@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@5@@Z @ 0x18017CDF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::Api::put_Direction(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v9[0] = v2 + 308;
    v9[2] = a2;
    v8 = (PVOID *)&Windows::UI::Composition::SpotLight::sc_Direction;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x2A6u);
    else
      v5 = 0;
  }
  else
