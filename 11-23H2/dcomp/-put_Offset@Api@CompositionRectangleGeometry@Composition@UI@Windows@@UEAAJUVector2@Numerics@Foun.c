/*
 * XREFs of ?put_Offset@Api@CompositionRectangleGeometry@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18006BED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionRectangleGeometry::Api::put_Offset(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  *(_QWORD *)v7 = a2;
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v8[1] = v7;
    v8[2] = v7;
    v10 = &Windows::UI::Composition::CompositionRectangleGeometry::sc_Offset;
