/*
 * XREFs of ?put_Condition@Api@InteractionTrackerVector2InertiaNaturalMotion@Interactions@Composition@UI@Windows@@UEAAJPEAUIExpressionAnimation@456@@Z @ 0x18013EAC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTrackerVector2InertiaNaturalMotion::Api::put_Condition(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)this - 136) & 2) != 0 )
  {
    ...
    {
      v5 = -2147024809;
      DoStackCaptureDirect(-2147024809, 0x38u);
    }
  }
  else
  {
