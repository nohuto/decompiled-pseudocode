/*
 * XREFs of ??$MakeAndInitialize2@VCircleEasingFunction@Composition@UI@Windows@@V1234@PEAVCompositor@234@AEAW4CompositionEasingFunctionMode@234@@Details@WRL2@Microsoft@@YAJPEAPEAVCircleEasingFunction@Composition@UI@Windows@@$$QEAPEAVCompositor@456@AEAW4CompositionEasingFunctionMode@456@@Z @ 0x18012DF80
 * Callers:
 *     ?CreateCircleEasingFunction@CompositionEasingFunctionStatics@Composition@UI@Windows@@UEAAJPEAUICompositor@234@W4CompositionEasingFunctionMode@234@PEAPEAUICircleEasingFunction@234@@Z @ 0x18012E6C0 (-CreateCircleEasingFunction@CompositionEasingFunctionStatics@Composition@UI@Windows@@UEAAJPEAUIC.c)
 * Callees:
...
LABEL_6:
  ...
  if ( v8 )
    v8 = Windows::UI::Composition::CircleEasingFunction::CircleEasingFunction(v8);
