/*
 * XREFs of ?save_nothrow@tson@@YAXAEAVoutput_archive@1@AEAVStoredFailureInfo@wil@@@Z @ 0x18009F074
 * Callers:
...
void __fastcall tson::save_nothrow(tson *this, struct tson::output_archive *a2, struct wil::StoredFailureInfo *a3)
{
  ...
  __int128 v45; // [rsp+108h] [rbp+8h] BYREF
  ...
  v5 = *((_QWORD *)a2 + 7);
  v48 = v4;
  string_tag = tson::make_string_tag((__int64)&v21, v5);
  v8 = *(_QWORD *)(v7 + 128);
  v45 = *(_OWORD *)string_tag;
  v46 = *(_QWORD *)(string_tag + 16);
