/*
 * XREFs of ??$MakeAndInitialize2@VComponentTransform3D@Composition@UI@Windows@@V1234@PEAVSceneModelTransform@Scenes@234@@Details@WRL2@Microsoft@@YAJPEAPEAVComponentTransform3D@Composition@UI@Windows@@$$QEAPEAVSceneModelTransform@Scenes@456@@Z @ 0x1801929B8
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::ComponentTransform3D,Windows::UI::Composition::ComponentTransform3D,Windows::UI::Composition::Scenes::SceneModelTransform *>(
