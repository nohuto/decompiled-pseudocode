/*
 * XREFs of ?put_Translation@Api@SceneModelTransform@Scenes@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@6@@Z @ 0x180193800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneModelTransform::Api::put_Translation(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_BYTE *)(a1 - 128) & 2) != 0 )
  {
    ...
    v10[2] = a2;
    v10[0] = v6 + 228;
    *(_QWORD *)v9 = &Windows::UI::Composition::ComponentTransform3D::sc_Offset;
    ...
    else
    {
      ...
      DoStackCaptureDirect(v5, 0x160u);
    }
  }
  else
  {
