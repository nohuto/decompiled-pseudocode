/*
 * XREFs of ?GetAnimatablePropertyInfo@CompositionEllipseGeometry@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180177460
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::CompositionEllipseGeometry::GetAnimatablePropertyInfo(
        Windows::UI::Composition::CompositionEllipseGeometry *this,
        HSTRING a2,
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 2LL;
  v10[1] = &Windows::UI::Composition::CompositionEllipseGeometry::k_rgAnimDef;
