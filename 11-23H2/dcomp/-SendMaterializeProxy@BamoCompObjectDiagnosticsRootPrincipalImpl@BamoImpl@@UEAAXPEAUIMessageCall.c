/*
 * XREFs of ?SendMaterializeProxy@BamoCompObjectDiagnosticsRootPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18019F740
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoCompObjectDiagnosticsRootPrincipalImpl::SendMaterializeProxy(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  LOWORD(v12) = 2;
  v9 = CoreUICallSend(a2, &v13, 2LL, 1LL);
  if ( v9 < 0 )
  ...
  v14 = *(unsigned int *)(v3 + 40);
  LOWORD(v12) = 3;
  v11 = CoreUICallSend(a2, &v13, 2LL, 1LL);
  if ( v11 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      4680LL,
