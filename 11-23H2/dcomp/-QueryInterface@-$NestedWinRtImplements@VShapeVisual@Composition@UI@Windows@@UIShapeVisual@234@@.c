/*
 * XREFs of ?QueryInterface@?$NestedWinRtImplements@VShapeVisual@Composition@UI@Windows@@UIShapeVisual@234@@WRL2@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180074960
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL2::NestedWinRtImplements<Windows::UI::Composition::ShapeVisual,Windows::UI::Composition::IShapeVisual>::QueryInterface(
        __int64 a1,
        int *a2,
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    *a3 = v3;
    Microsoft::WRL2::NestableRuntimeClass::InternalAddRef((Microsoft::WRL2::NestableRuntimeClass *)(a1 - 352));
    return 0LL;
  }
  else
  {
