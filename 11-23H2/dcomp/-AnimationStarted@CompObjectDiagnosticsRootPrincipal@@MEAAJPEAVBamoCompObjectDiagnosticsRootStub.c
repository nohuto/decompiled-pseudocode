/*
 * XREFs of ?AnimationStarted@CompObjectDiagnosticsRootPrincipal@@MEAAJPEAVBamoCompObjectDiagnosticsRootStub@@I_KIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x18019EE40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CompObjectDiagnosticsRootPrincipal::AnimationStarted(
        gsl::details *a1,
        __int64 a2,
        unsigned int a3,
        __int64 a4,
        ...
        unsigned int a9)
{
  __int64 (__fastcall *v10)(CompObjectDiagnosticsPrincipal *, __int64, unsigned int, int, unsigned int, __int128 *); // [rsp+40h] [rbp-28h] BYREF
  ...
  v11 = 0;
  *(_QWORD *)&v12 = a9;
  v10 = CompObjectDiagnosticsPrincipal::AnimationStarted;
  *((_QWORD *)&v12 + 1) = a8;
