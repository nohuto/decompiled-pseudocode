/*
 * XREFs of ?get_FillBrush@Api@CompositionSpriteShape@Composition@UI@Windows@@UEAAJPEAPEAUICompositionBrush@345@@Z @ 0x180171A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionSpriteShape::Api::get_FillBrush(
