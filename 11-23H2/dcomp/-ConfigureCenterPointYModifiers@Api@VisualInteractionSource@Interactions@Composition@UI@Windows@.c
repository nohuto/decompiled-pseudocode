/*
 * XREFs of ?ConfigureCenterPointYModifiers@Api@VisualInteractionSource@Interactions@Composition@UI@Windows@@UEAAJPEAU?$IIterable@PEAVCompositionConditionalValue@Interactions@Composition@UI@Windows@@@Collections@Foundation@6@@Z @ 0x18011CD60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::VisualInteractionSource::Api::ConfigureCenterPointYModifiers(
        __int64 a1,
        __int64 a2)
{
  int v3; // eax
...
LABEL_5:
  ...
  if ( v11[0] == -1LL || !v7 && v11[0] )
  {
    ...
    JUMPOUT(0x18011CE9BLL);
  }
  v11[1] = v7;
  v9 = Windows::UI::Composition::Interactions::VisualInteractionSource::ConfigureSourceModifiers(a1 - 136, v11, 1LL);
  v10 = v9;
  if ( v9 < 0 )
    DoStackCaptureDirect(v9, 0x5BAu);
  else
    v10 = 0;
  Microsoft::WRL2::ContextSession::EndApiEntry(v5);
  if ( v7 )
