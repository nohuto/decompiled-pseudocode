/*
 * XREFs of ?SetMinAttenuationCutoff@SpotLight@Composition@UI@Windows@@QEAAJM@Z @ 0x18017C380
 * Callers:
 *     ?put_MinAttenuationCutoff@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z @ 0x18017D0A0 (-put_MinAttenuationCutoff@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::SetMinAttenuationCutoff(
        ...
        float a2)
{
  ...
  v5[1] = &v8;
  v5[2] = &v8;
  v7 = (void **)&Windows::UI::Composition::SpotLight::sc_MinAttenuationCutoff;
