/*
 * XREFs of ?CreatePenInteractionConfiguration@CDevice@DirectComposition@@UEAAJIIW4DCOMPOSITION_INTERACTION_TYPE_PEN@@PEAPEAUIDCompositionInteractionConfigurationPartner@@@Z @ 0x18007F7C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreatePenInteractionConfiguration(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        int a4,
