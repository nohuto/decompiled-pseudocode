/*
 * XREFs of ??$InvokeDelegates@V_lambda_d16c3ce53091cdff7fe6d9084e2b21fb_@@U?$ITypedEventHandler@PEAVCompositorController@Core@Composition@UI@Windows@@PEAUIInspectable@@@Foundation@Windows@@@?$InvokeTraits@$0?1@WRL@Microsoft@@SAJV_lambda_d16c3ce53091cdff7fe6d9084e2b21fb_@@PEAVEventTargetArray@Details@12@PEAV?$EventSource@U?$ITypedEventHandler@PEAVCompositorController@Core@Composition@UI@Windows@@PEAUIInspectable@@@Foundation@Windows@@U?$InvokeModeOptions@$0?1@WRL@Microsoft@@@12@@Z @ 0x1800B6438
 * Callers:
...
__int64 __fastcall Microsoft::WRL::InvokeTraits<-2>::InvokeDelegates<_lambda_d16c3ce53091cdff7fe6d9084e2b21fb_,Windows::Foundation::ITypedEventHandler<Windows::UI::Composition::Core::CompositorController *,IInspectable *>>(
        _QWORD *a1,
        volatile int *a2,
        __int64 a3)
{
  ...
  v7 = v18[0];
  v8 = (_QWORD *)*((_QWORD *)v18[0] + 2);
  v9 = (volatile int **)*((_QWORD *)v18[0] + 4);
  if ( v8 == *((_QWORD **)v18[0] + 3) )
    goto LABEL_22;
  v10 = (_QWORD *)a1[1];
  v11 = (_QWORD *)*a1;
  while ( 1 )
