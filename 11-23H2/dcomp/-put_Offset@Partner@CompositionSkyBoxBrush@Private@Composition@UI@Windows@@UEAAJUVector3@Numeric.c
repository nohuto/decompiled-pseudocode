/*
 * XREFs of ?put_Offset@Partner@CompositionSkyBoxBrush@Private@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@6@@Z @ 0x180181E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Private::CompositionSkyBoxBrush::Partner::put_Offset(
        __int64 a1,
        __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v9[0] = v2 + 180;
    v9[2] = a2;
    v8 = (PVOID *)&Windows::UI::Composition::Private::CompositionSkyBoxBrush::sc_Offset;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x25Bu);
    else
      v5 = 0;
  }
  else
