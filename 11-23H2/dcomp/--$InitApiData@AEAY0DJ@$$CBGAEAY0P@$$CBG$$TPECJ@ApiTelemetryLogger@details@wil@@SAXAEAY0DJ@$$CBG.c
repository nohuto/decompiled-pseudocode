/*
 * XREFs of ??$InitApiData@AEAY0DJ@$$CBGAEAY0P@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0DJ@$$CBGAEAY0P@$$CBG$$QEA$$T$$QEAPECJ@Z @ 0x1800A2EE0
 * Callers:
...
void __fastcall wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[57],unsigned short const (&)[15],std::nullptr_t,long volatile *>(
        __int64 a1,
        __int64 a2,
        const char **a3,
        volatile int **a4)
