/*
 * XREFs of ?put_ViewBox@Api@CompositionGeometricClip@Composition@UI@Windows@@UEAAJPEAUICompositionViewBox@345@@Z @ 0x180172680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionGeometricClip::Api::put_ViewBox(
        ...
        struct IUnknown *a2)
{
  ...
  if ( ((_BYTE)v2[4] & 2) != 0 )
  {
    ...
    {
      Windows::UI::Composition::CompositionGeometricClip::SetViewBox(
