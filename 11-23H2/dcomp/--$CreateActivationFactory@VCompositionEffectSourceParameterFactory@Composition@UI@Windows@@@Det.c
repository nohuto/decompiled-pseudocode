/*
 * XREFs of ??$CreateActivationFactory@VCompositionEffectSourceParameterFactory@Composition@UI@Windows@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x1800171E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL::Details::CreateActivationFactory<Windows::UI::Composition::CompositionEffectSourceParameterFactory>(
        _BYTE *a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v13[0] = 0LL;
  v8 = Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::CompositionEffectSourceParameterFactory,Windows::UI::Composition::CompositionEffectSourceParameterFactory,>(v13);
  if ( v8 < 0 )
  {
