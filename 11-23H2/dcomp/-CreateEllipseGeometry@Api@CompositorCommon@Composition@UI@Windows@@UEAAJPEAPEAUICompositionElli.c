/*
 * XREFs of ?CreateEllipseGeometry@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUICompositionEllipseGeometry@345@@Z @ 0x180093340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::Api::CreateEllipseGeometry(
        Windows::UI::Composition::CompositorCommon::Api *this,
        struct Windows::UI::Composition::ICompositionEllipseGeometry **a2)
{
  __int64 v4; // rcx
  __int64 *v5; // rax
  ...
  if ( _InterlockedIncrement(&dword_180220BA8) == 1 && wil::details::ApiTelemetryLogger::IsEnabled((__int64)this) )
  {
  ...
  *a2 = 0LL;
  ...
  if ( (v6->SpinCount & 2) != 0 )
  {
    v11 = 0LL;
    v12 = v6;
    v7 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionEllipseGeometry,Windows::UI::Composition::CompositionEllipseGeometry,Windows::UI::Composition::Compositor *>(
           &v11,
           &v12);
    v8 = v7;
    if ( v7 < 0 )
    {
      ...
      DoStackCaptureDirect(v8, 0x2017u);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::ICompositionEllipseGeometry *)((v11 + 168) & ((unsigned __int128)-(__int128)v11 >> 64));
      v8 = 0;
    }
  }
  else
