/*
 * XREFs of ?EnableDesktopOffset@Partner@VisualTreeIsland@Composition@UI@Windows@@UEAAJXZ @ 0x18008DCC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::VisualTreeIsland::Partner::EnableDesktopOffset(
