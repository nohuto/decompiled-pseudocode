/*
 * XREFs of ?CreateVirtualSurface@Api@InteropCompositor@Composition@UI@Windows@@W7EAAJIIW4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@PEAPEAUIDCompositionVirtualSurface@@@Z @ 0x1800AC190
 * Callers:
 *     <none>
 * Callees:
 *     <none>
