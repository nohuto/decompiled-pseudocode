/*
 * XREFs of ??$AddProperty@UPropertySetVector4Value@@UD2DVector4@@@CompositionPropertySet@Composition@UI@Windows@@AEAAJPEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector4@@@Z @ 0x18000A714
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::AddProperty<PropertySetVector4Value,D2DVector4>(
        __int64 a1,
        HSTRING a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v8 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector4>(a1 + 208, v7, a4, &v19);
  v9 = v8;
  if ( v8 >= 0 )
  {
