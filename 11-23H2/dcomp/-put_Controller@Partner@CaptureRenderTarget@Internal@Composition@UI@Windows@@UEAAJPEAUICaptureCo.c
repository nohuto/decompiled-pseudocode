/*
 * XREFs of ?put_Controller@Partner@CaptureRenderTarget@Internal@Composition@UI@Windows@@UEAAJPEAUICaptureControllerBase@3456@@Z @ 0x180180A90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureRenderTarget::Partner::put_Controller(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    v6 = Microsoft::WRL2::ContextRuntimeClass::ValidateInterface(
           ...
           a2,
           (const struct Microsoft::WRL2::NestableRuntimeClass::InterfaceType *)&Windows::UI::Composition::Internal::CaptureControllerBase::s_InterfaceType,
           &v8);
    v5 = v6;
    if ( v6 < 0 )
    {
      DoStackCaptureDirect(v6, 0x158u);
    }
    else
    {
      Windows::UI::Composition::Internal::CaptureRenderTarget::SetController(v2, v8);
      v5 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionPropertySet>::InternalUnlock(&v8);
  }
