/*
 * XREFs of ?GetAnimatablePropertyInfo@CompositionNineGridBrush@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180168D50
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::CompositionNineGridBrush::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 8LL;
  v10[1] = &Windows::UI::Composition::CompositionNineGridBrush::k_rgAnimDef;
