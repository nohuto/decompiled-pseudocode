/*
 * XREFs of ?SetFinalValueParameter@PointLight@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x18017A5C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::PointLight::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 8LL;
  v11[1] = &Windows::UI::Composition::PointLight::k_rgAnimDef;
