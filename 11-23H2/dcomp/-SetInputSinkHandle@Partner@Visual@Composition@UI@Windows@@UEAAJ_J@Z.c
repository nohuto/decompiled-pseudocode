/*
 * XREFs of ?SetInputSinkHandle@Partner@Visual@Composition@UI@Windows@@UEAAJ_J@Z @ 0x180035D10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::Partner::SetInputSinkHandle(
        ...
        void *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v5 = Windows::UI::Composition::Visual::SetInputSinkHandle(v2, a2);
    v6 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0xB60u);
    else
      v6 = 0;
  }
  else
