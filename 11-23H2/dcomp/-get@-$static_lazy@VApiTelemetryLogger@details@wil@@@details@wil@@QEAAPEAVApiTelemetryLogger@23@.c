/*
 * XREFs of ?get@?$static_lazy@VApiTelemetryLogger@details@wil@@@details@wil@@QEAAPEAVApiTelemetryLogger@23@P6AXXZ@Z @ 0x18006431C
 * Callers:
 ...
 *     ?CreateRoundedRectangleGeometry@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUICompositionRoundedRectangleGeometry@345@@Z @ 0x180067A20 (-CreateRoundedRectangleGeometry@Api@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUICompos.c)
 ...
 *     ??$InitApiData@AEAY0CC@$$CBGAEAY0BD@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0CC@$$CBGAEAY0BD@$$CBG$$QEA$$T$$QEAPECJ@Z @ 0x18008B7F8 (--$InitApiData@AEAY0CC@$$CBGAEAY0BD@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0CC@$$CB.c)
 ...
 *     ??$InitApiData@AEAY0DJ@$$CBGAEAY0N@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0DJ@$$CBGAEAY0N@$$CBG$$QEA$$T$$QEAPECJ@Z @ 0x1800A2E7C (--$InitApiData@AEAY0DJ@$$CBGAEAY0N@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0DJ@$$CBG.c)
 ...
 *     ??$InitApiData@AEAY0CI@$$CBGAEAY0P@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0CI@$$CBGAEAY0P@$$CBG$$QEA$$T$$QEAPECJ@Z @ 0x1800A31D8 (--$InitApiData@AEAY0CI@$$CBGAEAY0P@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0CI@$$CBG.c)
...
__int64 *__fastcall wil::details::static_lazy<wil::details::ApiTelemetryLogger>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(
         &`wil::details::ApiTelemetryLogger::Instance'::`2'::wrapper,
         0,
         (PBOOL)&v6,
         (LPVOID *)&v7)
    && (_DWORD)v6 )
  {
    v4 = &`wil::details::ApiTelemetryLogger::Instance'::`2'::wrapper;
    v7 = &qword_18021CFC0;
    qword_18021CFC0 = (__int64)&wil::details::ApiTelemetryLogger::`vftable';
    qword_18021CFF0 = 0LL;
    qword_18021CFD8 = (__int64)&`wil::details::ApiTelemetryLogger::StaticHandle::StaticHandle'::`2'::__hInner;
    dword_18021CFFC = 1200000;
    xmmword_18021CFE0 = 0LL;
    atexit(a2);
    v5 = 0;
