/*
 * XREFs of ?SetOuterConeIntensity@SpotLight@Composition@UI@Windows@@QEAAJM@Z @ 0x18017C3F4
 * Callers:
 *     ?put_OuterConeIntensity@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z @ 0x18017D2C0 (-put_OuterConeIntensity@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::SetOuterConeIntensity(
        ...
        float a2)
{
  ...
  v5[1] = &v8;
  v5[2] = &v8;
  v7 = (void **)&Windows::UI::Composition::SpotLight::sc_OuterConeIntensity;
