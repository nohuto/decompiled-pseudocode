/*
 * XREFs of Windows::Internal::ComTaskPool::RunSynchronousTaskOnMTA__lambda_90b75ecb1bcd1b4e7d5d99e276904407___ @ 0x1800A1EA4
 * Callers:
...
__int64 __fastcall Windows::Internal::ComTaskPool::RunSynchronousTaskOnMTA__lambda_90b75ecb1bcd1b4e7d5d99e276904407___(
        unsigned int a1,
        unsigned int a2,
        __int128 *a3)
{
  ...
  if ( CoGetApartmentType((APTTYPE *)&v13, (APTTYPEQUALIFIER *)&v10) < 0 || !v13 || v13 == 3 )
    ...
    v5 = 4;
  v12 = 0;
  v6 = Microsoft::WRL::Details::Make_Windows::Internal::ComTaskPool::CResultTaskWrapper__lambda_90b75ecb1bcd1b4e7d5d99e276904407____long____lambda_90b75ecb1bcd1b4e7d5d99e276904407___(
         &v11,
         (__int64)&v12,
         a3);
  v7 = *v6;
