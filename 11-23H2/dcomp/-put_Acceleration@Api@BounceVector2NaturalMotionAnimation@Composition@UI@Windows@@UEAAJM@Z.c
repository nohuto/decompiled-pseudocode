/*
 * XREFs of ?put_Acceleration@Api@BounceVector2NaturalMotionAnimation@Composition@UI@Windows@@UEAAJM@Z @ 0x18017DD80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::BounceVector2NaturalMotionAnimation::Api::put_Acceleration(
