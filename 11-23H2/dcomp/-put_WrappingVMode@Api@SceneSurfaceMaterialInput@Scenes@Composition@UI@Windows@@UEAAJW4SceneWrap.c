/*
 * XREFs of ?put_WrappingVMode@Api@SceneSurfaceMaterialInput@Scenes@Composition@UI@Windows@@UEAAJW4SceneWrappingMode@3456@@Z @ 0x180145900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneSurfaceMaterialInput::Api::put_WrappingVMode(wil *a1, int a2)
{
  __int64 v2; // rbp
  __int64 v4; // rcx
  unsigned int v5; // edi
  ...
  v2 = a2;
  v5 = 0;
  if ( !wil::ProcessShutdownInProgress(a1) && _InterlockedIncrement(&dword_18022093C) == 1 )
  {
    v9 = 0LL;
    v8 = &dword_18022093C;
  ...
  if ( (*((_BYTE *)a1 - 136) & 2) != 0 )
  {
    ...
    {
      Windows::UI::Composition::ProxyObject::SetScalarIntegerProperty((wil *)((char *)a1 - 168), 3u, v2);
      *((_DWORD *)a1 + 8) = v2;
    }
  }
  else
