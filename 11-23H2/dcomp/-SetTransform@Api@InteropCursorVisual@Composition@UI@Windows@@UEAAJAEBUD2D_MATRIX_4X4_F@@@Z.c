/*
 * XREFs of ?SetTransform@Api@InteropCursorVisual@Composition@UI@Windows@@UEAAJAEBUD2D_MATRIX_4X4_F@@@Z @ 0x18019A1F0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct D2D_MATRIX_4X4_F *a2)
{
  ...
  {
    v6 = (*(__int64 (__fastcall **)(_QWORD, const struct D2D_MATRIX_4X4_F *))(**((_QWORD **)this + 2) + 256LL))(
           *((_QWORD *)this + 2),
           a2);
    v5 = v6;
    if ( v6 < 0 )
      DoStackCaptureDirect(v6, 0x1A7u);
    else
      v5 = 0;
  }
  else
