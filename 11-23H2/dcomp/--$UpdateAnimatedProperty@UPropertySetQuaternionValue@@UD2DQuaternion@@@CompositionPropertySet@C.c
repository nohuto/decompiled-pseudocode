/*
 * XREFs of ??$UpdateAnimatedProperty@UPropertySetQuaternionValue@@UD2DQuaternion@@@CompositionPropertySet@Composition@UI@Windows@@AEAAXIPEBUD2DQuaternion@@_N1G@Z @ 0x1801489C8
 * Callers:
...
void __fastcall Windows::UI::Composition::CompositionPropertySet::UpdateAnimatedProperty<PropertySetQuaternionValue,D2DQuaternion>(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        char a4,
