/*
 * XREFs of ?put_RotationAngle@Partner@CaptureController@Internal@Composition@UI@Windows@@UEAAJM@Z @ 0x1801800A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureController::Partner::put_RotationAngle(
