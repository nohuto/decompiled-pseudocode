/*
 * XREFs of ?put_Size@Partner@CompositionSkyBoxBrush@Private@Composition@UI@Windows@@UEAAJM@Z @ 0x180182290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Private::CompositionSkyBoxBrush::Partner::put_Size(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::Private::CompositionSkyBoxBrush::sc_Size;
    ...
    v4 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x260u);
    else
      v4 = 0;
  }
  else
