/*
 * XREFs of ?CreateSurface@Api@InteropCompositor@Composition@UI@Windows@@WBA@EAAJIIW4DXGI_FORMAT@@W4DXGI_ALPHA_MODE@@PEAPEAUIDCompositionSurface@@@Z @ 0x1800ABFB0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
