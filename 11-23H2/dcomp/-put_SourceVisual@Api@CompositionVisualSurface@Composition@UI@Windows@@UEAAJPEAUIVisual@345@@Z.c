/*
 * XREFs of ?put_SourceVisual@Api@CompositionVisualSurface@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x1800629B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVisualSurface::Api::put_SourceVisual(
        Windows::UI::Composition::CompositionVisualSurface::Api *this,
        struct IUnknown *a2)
{
  Windows::UI::Composition::CompositionVisualSurface *v2; // rdi
  struct _RTL_CRITICAL_SECTION *v4; // rsi
  int v5; // eax
  unsigned int v6; // ebx
  struct Microsoft::WRL2::ContextRuntimeClass *v8; // [rsp+30h] [rbp+8h] BYREF

  v2 = (Windows::UI::Composition::CompositionVisualSurface::Api *)((char *)this - 136);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v5 < 0 )
    {
      DoStackCaptureDirect(v5, 0x206u);
    }
    else
    {
      Windows::UI::Composition::CompositionVisualSurface::SetSourceVisual(v2, v8);
      v6 = 0;
    }
