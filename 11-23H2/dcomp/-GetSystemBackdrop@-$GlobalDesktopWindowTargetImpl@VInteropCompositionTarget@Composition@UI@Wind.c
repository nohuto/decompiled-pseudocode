/*
 * XREFs of ?GetSystemBackdrop@?$GlobalDesktopWindowTargetImpl@VInteropCompositionTarget@Composition@UI@Windows@@@Desktop@Composition@UI@Windows@@MEBAPEAUICompositionBrush@345@XZ @ 0x180010090
 * Callers:
 *     <none>
 * Callees:
...
char *__fastcall Windows::UI::Composition::Desktop::GlobalDesktopWindowTargetImpl<Windows::UI::Composition::InteropCompositionTarget>::GetSystemBackdrop(
        __int64 a1)
{
  Windows::UI::Composition::SystemBackdropHelper *v1; // rcx
  struct Windows::UI::Composition::CompositionBrush *SystemBackdrop; // rax

  v1 = *(Windows::UI::Composition::SystemBackdropHelper **)(a1 + 240);
