/*
 * XREFs of ?GetColorSpace@CPresentationSurface@@UEAA?AW4DXGI_COLOR_SPACE_TYPE@@XZ @ 0x1800A7D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPresentationSurface::GetColorSpace(CPresentationSurface *this)
{
