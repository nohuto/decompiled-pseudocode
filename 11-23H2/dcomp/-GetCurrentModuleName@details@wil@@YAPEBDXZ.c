/*
 * XREFs of ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x18000D800
 * Callers:
 *     <none>
 * Callees:
 *     ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x18000D844 (-GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z.c)
 */
