/*
 * XREFs of ?HideSurfaces@CDynamicPoolSet@DirectComposition@@QEAAJXZ @ 0x1800391EC
 * Callers:
...
__int64 __fastcall DirectComposition::CDynamicPoolSet::HideSurfaces(DirectComposition::CDynamicPoolSet *this)
{
  char *v1; // rdi
  ...
  do
  {
    if ( !v4 )
      break;
    v5 = DirectComposition::CAtlasSurfacePool::Hide(*((DirectComposition::CAtlasSurfacePool **)v4 + 4));
    v6 = (char *)*((_QWORD *)v4 + 2);
    v3 = v5;
    v4 = v6 - 16;
    if ( v6 == v1 )
