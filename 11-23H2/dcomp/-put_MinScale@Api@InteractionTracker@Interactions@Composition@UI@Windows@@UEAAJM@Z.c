/*
 * XREFs of ?put_MinScale@Api@InteractionTracker@Interactions@Composition@UI@Windows@@UEAAJM@Z @ 0x1800B6E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTracker::Api::put_MinScale(
        ...
        float a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v5 = Windows::UI::Composition::Interactions::InteractionTracker::SetMinScale(v2, a2);
    v4 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0xAB0u);
    else
      v4 = 0;
  }
  else
