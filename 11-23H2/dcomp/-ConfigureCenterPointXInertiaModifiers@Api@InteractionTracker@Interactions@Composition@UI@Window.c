/*
 * XREFs of ?ConfigureCenterPointXInertiaModifiers@Api@InteractionTracker@Interactions@Composition@UI@Windows@@UEAAJPEAU?$IIterable@PEAVCompositionConditionalValue@Interactions@Composition@UI@Windows@@@Collections@Foundation@6@@Z @ 0x1801378B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTracker::Api::ConfigureCenterPointXInertiaModifiers(
        __int64 a1,
        __int64 a2)
{
  int v3; // eax
  ...
  unsigned __int64 v11[2]; // [rsp+20h] [rbp-30h] BYREF
...
LABEL_5:
  ...
  if ( v11[0] == -1LL || !v7 && v11[0] )
  {
    ...
    JUMPOUT(0x1801379E8LL);
  }
  v11[1] = (unsigned __int64)v7;
  v9 = Windows::UI::Composition::Interactions::InteractionTracker::ConfigureCenterPointInertiaModifiers(
         a1 - 144,
         v11,
         0);
  v10 = v9;
  if ( v9 < 0 )
    DoStackCaptureDirect(v9, 0xC23u);
  else
    v10 = 0;
  Microsoft::WRL2::ContextSession::EndApiEntry(v5);
  if ( v7 )
