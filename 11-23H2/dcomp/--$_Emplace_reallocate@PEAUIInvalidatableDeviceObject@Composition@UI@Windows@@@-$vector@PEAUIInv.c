/*
 * XREFs of ??$_Emplace_reallocate@PEAUIInvalidatableDeviceObject@Composition@UI@Windows@@@?$vector@PEAUIInvalidatableDeviceObject@Composition@UI@Windows@@V?$allocator@PEAUIInvalidatableDeviceObject@Composition@UI@Windows@@@std@@@std@@QEAAPEAPEAUIInvalidatableDeviceObject@Composition@UI@Windows@@QEAPEAU2345@$$QEAPEAU2345@@Z @ 0x180064578
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAUIInvalidatableDeviceObject@Composition@UI@Windows@@V?$allocator@PEAUIInvalidatableDeviceObject@Composition@UI@Windows@@@std@@@std@@AEAAXQEAPEAUIInvalidatableDeviceObject@Composition@UI@Windows@@_K1@Z @ 0x18006466C (-_Change_array@-$vector@PEAUIInvalidatableDeviceObject@Composition@UI@Windows@@V-$allocator@PEAU.c)
 *     memmove_0 @ 0x1800A8138 (memmove_0.c)
 *     ?_Dwm_Xlength_error@std@@YAXPEBD@Z @ 0x1801004AC (-_Dwm_Xlength_error@std@@YAXPEBD@Z.c)
 */

char *__fastcall std::vector<Windows::UI::Composition::IInvalidatableDeviceObject *>::_Emplace_reallocate<Windows::UI::Composition::IInvalidatableDeviceObject *>(
        __int64 a1,
        _BYTE *a2,
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<Windows::UI::Composition::IInvalidatableDeviceObject *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
