/*
 * XREFs of ?UpdateChildren@?$SceneNodeGeneratedT@VSceneObject@Scenes@Composition@UI@Windows@@@Scenes@Composition@UI@Windows@@QEAAJXZ @ 0x1801445F4
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneNodeGeneratedT<Windows::UI::Composition::Scenes::SceneObject>::UpdateChildren(
        __int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rdx
