/*
 * XREFs of ?QueryInterface@?$NestedWinRtImplements@VCompositionLight@Composition@UI@Windows@@UICompositionLight@234@UICompositionLight2@234@UICompositionLight3@234@@WRL2@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AC710
 * Callers:
 *     <none>
 * Callees:
 *     <none>
