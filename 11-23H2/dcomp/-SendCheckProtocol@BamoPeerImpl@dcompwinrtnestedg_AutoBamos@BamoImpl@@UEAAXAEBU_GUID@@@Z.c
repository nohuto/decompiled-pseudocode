/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@dcompwinrtnestedg_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x18016E0D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dcompwinrtnestedg_AutoBamos::BamoPeerImpl::SendCheckProtocol(
        ...
        const struct _GUID *a2)
{
  ...
  LOWORD(v6) = 0;
  v8 = v2;
  v5 = CoreUICallSend(v4, v7, 2LL, 1LL);
  if ( v5 < 0 )
