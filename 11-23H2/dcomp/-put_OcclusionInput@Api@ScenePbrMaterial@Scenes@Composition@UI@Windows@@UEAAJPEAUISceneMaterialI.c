/*
 * XREFs of ?put_OcclusionInput@Api@ScenePbrMaterial@Scenes@Composition@UI@Windows@@UEAAJPEAUISceneMaterialInput@3456@@Z @ 0x180192500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::ScenePbrMaterial::Api::put_OcclusionInput(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)this - 136) & 2) != 0 )
  {
    ...
    if ( v6 < 0 )
    {
      DoStackCaptureDirect(v6, 0x151u);
    }
    else
    {
      if ( v10 != *((struct Microsoft::WRL2::ContextRuntimeClass **)this + 4) )
      {
        if ( v10 )
          v8 = *((_DWORD *)v10 + 32);
        else
        ...
        Microsoft::WRL2::RefPtr<Windows::UI::Composition::Scenes::SceneMaterialInput>::operator=(
          (Microsoft::WRL2::NestableRuntimeClass **)this + 4,
          v7);
      }
      v5 = 0;
    }
