/*
 * XREFs of ??$?RV?$nvp@AEAJ@tson@@@input_archive@tson@@QEAAAEAV01@$$QEAV?$nvp@AEAJ@1@@Z @ 0x18009C5F0
 * Callers:
...
__int64 __fastcall tson::input_archive::operator()<tson::nvp<long &>>(__int64 a1, __int64 a2)
{
  char v2; // r8
  _DWORD *v4; // rdi
  __int64 v5; // rdx
