/*
 * XREFs of ?CalcAverageRimQueueLatency@CTouchFrameStats@@IEBAMXZ @ 0x1801A7964
 * Callers:
...
float __fastcall CTouchFrameStats::CalcAverageRimQueueLatency(CTouchFrameStats::CInteractionInfo **this)
{
  ...
  if ( v6 != v7 )
  {
    ...
    do
    {
      if ( v6 != v9 )
      {
        v11 = (float)(int)CTouchFrameStats::CInteractionInfo::RimQueueUs(v6, v2);
        v18 = v11;
        if ( v10 == v5 )
        {
