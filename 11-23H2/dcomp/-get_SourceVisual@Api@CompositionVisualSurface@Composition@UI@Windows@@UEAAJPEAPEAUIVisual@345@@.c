/*
 * XREFs of ?get_SourceVisual@Api@CompositionVisualSurface@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x180159330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVisualSurface::Api::get_SourceVisual(
