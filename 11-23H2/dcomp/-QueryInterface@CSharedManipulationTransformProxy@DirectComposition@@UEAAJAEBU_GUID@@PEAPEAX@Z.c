/*
 * XREFs of ?QueryInterface@CSharedManipulationTransformProxy@DirectComposition@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180086090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CSharedManipulationTransformProxy::QueryInterface(
        ...
        void **a3)
{
  ...
  if ( !a3 )
    return 2147942487LL;
  v3 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_a06cd146_3f2c_4975_bd5c_7db1ec71f2dd.Data1;
  if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_a06cd146_3f2c_4975_bd5c_7db1ec71f2dd.Data1 )
    v3 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_a06cd146_3f2c_4975_bd5c_7db1ec71f2dd.Data4;
  if ( !v3 )
    goto LABEL_5;
