/*
 * XREFs of ??$CreateActivationFactory@VCompositionConditionalValueStatics@Interactions@Composition@UI@Windows@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x180102FE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL::Details::CreateActivationFactory<Windows::UI::Composition::Interactions::CompositionConditionalValueStatics>(
        _BYTE *a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v13[0] = 0LL;
  v8 = Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::Interactions::CompositionConditionalValueStatics,Windows::UI::Composition::Interactions::CompositionConditionalValueStatics,>(v13);
  if ( v8 >= 0 )
  {
    v10 = v13[0];
