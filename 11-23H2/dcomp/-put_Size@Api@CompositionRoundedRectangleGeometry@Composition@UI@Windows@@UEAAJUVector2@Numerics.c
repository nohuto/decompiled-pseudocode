/*
 * XREFs of ?put_Size@Api@CompositionRoundedRectangleGeometry@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18006CA70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionRoundedRectangleGeometry::Api::put_Size(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  *(_QWORD *)v9 = a2;
  ...
  v10[1] = v9;
  v10[2] = v9;
  v12 = &Windows::UI::Composition::CompositionRoundedRectangleGeometry::sc_Size;
