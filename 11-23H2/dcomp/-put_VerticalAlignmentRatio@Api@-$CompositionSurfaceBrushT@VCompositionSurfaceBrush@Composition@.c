/*
 * XREFs of ?put_VerticalAlignmentRatio@Api@?$CompositionSurfaceBrushT@VCompositionSurfaceBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJM@Z @ 0x18004A8F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionSurfaceBrushT<Windows::UI::Composition::CompositionSurfaceBrush,Windows::UI::Composition::CompositionBrush>::Api::put_VerticalAlignmentRatio(
        __int64 a1,
        float a2)
{
  __int64 *v2; // rdi
  ...
  if ( a2 < 0.0 || a2 > 1.0 )
  {
    Windows::UI::Composition::OriginateInvalidArgument(16LL, L"VerticalAlignmentRatio");
    v18 = 199LL;
    v7 = -2147024809;
    goto LABEL_31;
  }
  ...
  {
    v24[0] = (void *)Windows::UI::Composition::CompositionSurfaceBrush::sc_VerticalAlignmentRatio;
