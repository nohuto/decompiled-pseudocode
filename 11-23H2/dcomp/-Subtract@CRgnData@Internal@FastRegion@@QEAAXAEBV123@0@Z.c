/*
 * XREFs of ?Subtract@CRgnData@Internal@FastRegion@@QEAAXAEBV123@0@Z @ 0x18007A954
 * Callers:
 ...
 *     ?Subtract@CStripe@Internal@FastRegion@@QEAAXPEBV123@00@Z @ 0x18007AC78 (-Subtract@CStripe@Internal@FastRegion@@QEAAXPEBV123@00@Z.c)
 */
        ...
        const struct FastRegion::Internal::CRgnData *a3)
{
  ...
  _DWORD *v29; // rax
  const struct FastRegion::Internal::CStripe *v30; // r9
  _DWORD *v31; // rdx
  int v32; // ecx
  char *v33; // rcx
  int v34; // eax
...
LABEL_38:
  ...
  if ( v12 != v6 )
    goto LABEL_47;
  v33 = (char *)v6 + 8;
  v34 = *((_DWORD *)v6 + 3) - *((_DWORD *)v6 + 1);
LABEL_32:
  if ( (_DWORD)v33 + v34 - (_DWORD)v12 )
...
LABEL_47:
  ...
  {
    v35 = (const struct FastRegion::Internal::CStripe *)((char *)v19 - 8);
  }
  FastRegion::Internal::CStripe::Subtract(v12, v35, v7, v7);
  if ( v12 != v6 )
    goto LABEL_38;
  v20 = (char *)v12 + 8;
...
LABEL_9:
  ...
  while ( 1 )
  {
    ...
    v30 = v26;
LABEL_20:
    FastRegion::Internal::CStripe::Subtract(v12, v24, v26, v30);
    if ( v12 == v6 )
    {
