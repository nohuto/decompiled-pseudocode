/*
 * XREFs of ?RemoveAll@Api@CompositionProjectedShadowCasterCollection@Composition@UI@Windows@@UEAAJXZ @ 0x180007380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowCasterCollection::Api::RemoveAll(
        Windows::UI::Composition::CompositionProjectedShadowCasterCollection::Api *this)
{
  ...
  valid = Windows::UI::Composition::CompositionProjectedShadowCasterCollection::EnsureValidState((Windows::UI::Composition::CompositionProjectedShadowCasterCollection *)v1);
  v4 = valid;
  if ( valid < 0 )
  {
    v6 = 234;
  ...
  valid = Windows::UI::Composition::CompositionProjectedShadow::RemoveAllCasters(v1[19]);
  v4 = valid;
  if ( valid < 0 )
  {
    v6 = 236;
