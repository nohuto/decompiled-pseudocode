/*
 * XREFs of ?CreateSharedVisualReferenceController@DCPrivate@CompositorCommon@Composition@UI@Windows@@UEAAJPEAUIVisual@345@PEAPEAUIVisualReferenceController@Private@345@@Z @ 0x1801270E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::DCPrivate::CreateSharedVisualReferenceController(
        ...
        struct Windows::UI::Composition::Private::IVisualReferenceController **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (*((_BYTE *)v3 + 32) & 2) != 0 )
  {
    ...
    if ( v8 < 0 )
    {
      DoStackCaptureDirect(v8, 0x1CC3u);
    }
    else
    {
      v13 = 0LL;
      ...
      if ( v10 < 0 )
      {
        DoStackCaptureDirect(v10, 0x1CC6u);
        if ( v13 )
