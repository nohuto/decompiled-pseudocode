/*
 * XREFs of ?CalcAverageAppCommitLatency@CTouchFrameStats@@IEBAMXZ @ 0x1801A6CF8
 * Callers:
...
float __fastcall CTouchFrameStats::CalcAverageAppCommitLatency(CTouchFrameStats::CInteractionInfo **this)
{
  ...
  if ( v6 != v7 )
  {
    ...
    do
    {
      if ( v6 != v9 )
      {
        v11 = (float)(int)CTouchFrameStats::CInteractionInfo::AppCommitUs(v6, v2);
        v18 = v11;
        if ( v10 == v5 )
        {
