/*
 * XREFs of ?GetAnimatablePropertyInfo@InsetClip@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@234@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180072C30
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::InsetClip::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 4LL;
  v10[1] = &Windows::UI::Composition::InsetClip::k_rgAnimDef;
