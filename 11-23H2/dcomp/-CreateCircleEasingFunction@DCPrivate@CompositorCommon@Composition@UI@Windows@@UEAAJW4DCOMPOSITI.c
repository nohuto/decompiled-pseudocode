/*
 * XREFs of ?CreateCircleEasingFunction@DCPrivate@CompositorCommon@Composition@UI@Windows@@UEAAJW4DCOMPOSITION_EASING_FUNCTION_MODE@@PEAPEAUICompositionEasingFunction@345@@Z @ 0x1801253C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::DCPrivate::CreateCircleEasingFunction(
        __int64 a1,
        unsigned int a2,
        unsigned __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (*(_BYTE *)(v3 + 32) & 2) != 0 )
  {
    ...
    v13 = a2;
    v11 = v3;
    v8 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CircleEasingFunction,Windows::UI::Composition::CircleEasingFunction,Windows::UI::Composition::Compositor *,enum Windows::UI::Composition::CompositionEasingFunctionMode>(
           &v15,
           &v11,
           &v13);
    v7 = v8;
    ...
    else
    {
      ...
      DoStackCaptureDirect(v7, 0x1C02u);
    }
