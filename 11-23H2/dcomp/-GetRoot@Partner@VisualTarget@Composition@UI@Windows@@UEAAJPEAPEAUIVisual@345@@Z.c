/*
 * XREFs of ?GetRoot@Partner@VisualTarget@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x18015FFB0
 * Callers:
 *     ?GetRoot@Partner@VisualTarget@Composition@UI@Windows@@W7EAAJPEAPEAUIVisual@345@@Z @ 0x1800ACD70 (-GetRoot@Partner@VisualTarget@Composition@UI@Windows@@W7EAAJPEAPEAUIVisual@345@@Z.c)
 * Callees:
