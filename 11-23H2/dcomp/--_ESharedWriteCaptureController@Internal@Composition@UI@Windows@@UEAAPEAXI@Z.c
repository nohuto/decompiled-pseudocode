/*
 * XREFs of ??_ESharedWriteCaptureController@Internal@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180124580
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::Internal::SharedWriteCaptureController *__fastcall Windows::UI::Composition::Internal::SharedWriteCaptureController::`vector deleting destructor'(
