/*
 * XREFs of ?get_Mask@Api@?$CompositionMaskBrushT@VCompositionMaskBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJPEAPEAUICompositionBrush@345@@Z @ 0x18007D8B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionMaskBrushT<Windows::UI::Composition::CompositionMaskBrush,Windows::UI::Composition::CompositionBrush>::Api::get_Mask(
        __int64 a1,
        _QWORD *a2)
{
  unsigned int v3; // esi
