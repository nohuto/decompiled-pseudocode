/*
 * XREFs of ?Attach@?$ComPtr@VPointLight@Composition@UI@Windows@@@WRL@Microsoft@@QEAAXPEAVPointLight@Composition@UI@Windows@@@Z @ 0x180124A88
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<Windows::UI::Composition::PointLight>::Attach(
