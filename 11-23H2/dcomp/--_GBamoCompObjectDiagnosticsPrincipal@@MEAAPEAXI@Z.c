/*
 * XREFs of ??_GBamoCompObjectDiagnosticsPrincipal@@MEAAPEAXI@Z @ 0x18019CB50
 * Callers:
 *     <none>
 * Callees:
...
BamoCompObjectDiagnosticsPrincipal *__fastcall BamoCompObjectDiagnosticsPrincipal::`scalar deleting destructor'(
