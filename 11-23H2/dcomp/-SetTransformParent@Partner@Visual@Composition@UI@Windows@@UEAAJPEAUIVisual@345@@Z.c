/*
 * XREFs of ?SetTransformParent@Partner@Visual@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x18010C390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::Partner::SetTransformParent(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    {
      v7 = Windows::UI::Composition::Visual::SetParentForTransform(v2, v11);
      v6 = v7;
      if ( v7 >= 0 )
      {
        v6 = 0;
