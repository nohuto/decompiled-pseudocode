/*
 * XREFs of ?SetProperties@SpringVector2NaturalMotionAnimation@Composition@UI@Windows@@UEAAJPEAVNaturalMotionAnimator@234@@Z @ 0x180129CB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpringVector2NaturalMotionAnimation::SetProperties(
        ...
        struct Windows::UI::Composition::NaturalMotionAnimator *a2)
{
  ...
  v4 = Windows::UI::Composition::Vector2NaturalMotionAnimation::SetProperties(this, a2);
  v5 = v4;
  if ( v4 >= 0 )
  {
    Windows::UI::Composition::Spring::SetProperties(
      (Windows::UI::Composition::SpringVector2NaturalMotionAnimation *)((char *)this + 448),
      a2);
    return 0LL;
  }
  else
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x20,
      (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\WrtSpringVector2NaturalMotionAnimation.h",
