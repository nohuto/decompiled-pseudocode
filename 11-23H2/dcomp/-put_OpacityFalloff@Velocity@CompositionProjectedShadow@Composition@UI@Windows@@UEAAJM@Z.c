/*
 * XREFs of ?put_OpacityFalloff@Velocity@CompositionProjectedShadow@Composition@UI@Windows@@UEAAJM@Z @ 0x180011040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadow::Velocity::put_OpacityFalloff(
        ...
        float a2)
{
  ...
  if ( (v2[32] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = &Windows::UI::Composition::CompositionProjectedShadow::sc_OpacityFalloff;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x2BBu);
    else
      v5 = 0;
  }
  else
