/*
 * XREFs of ?CreateSharedWriteCaptureController@Internal@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUIWriteCaptureController@1345@@Z @ 0x18010F1E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Internal::CreateSharedWriteCaptureController(
        Windows::UI::Composition::Compositor::Internal *this,
        struct Windows::UI::Composition::Internal::IWriteCaptureController **a2)
{
  struct _RTL_CRITICAL_SECTION *v2; // rsi
  unsigned int v4; // edi
  int v5; // eax
  struct Windows::UI::Composition::Internal::IWriteCaptureController *v6; // rax
  wil::details::in1diag3 *retaddr; // [rsp+38h] [rbp+0h]
  Microsoft::WRL2::NestableRuntimeClass *v9; // [rsp+40h] [rbp+8h] BYREF
  struct Windows::UI::Composition::Internal::IWriteCaptureController *v10; // [rsp+48h] [rbp+10h] BYREF
  ...
  *a2 = 0LL;
  ...
  if ( (v2->SpinCount & 2) != 0 )
  {
    v9 = 0LL;
    v11 = v2;
    v5 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Internal::SharedWriteCaptureController,Windows::UI::Composition::Internal::SharedWriteCaptureController,Windows::UI::Composition::Compositor *>(
           &v9,
           &v11);
    v4 = v5;
    if ( v5 >= 0 )
    ...
    else
    {
      ...
      DoStackCaptureDirect(v4, 0x666u);
    }
  }
  else
  {
