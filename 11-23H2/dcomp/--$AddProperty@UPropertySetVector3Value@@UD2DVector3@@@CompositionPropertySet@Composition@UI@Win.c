/*
 * XREFs of ??$AddProperty@UPropertySetVector3Value@@UD2DVector3@@@CompositionPropertySet@Composition@UI@Windows@@AEAAJPEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector3@@@Z @ 0x180004C34
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::AddProperty<PropertySetVector3Value,D2DVector3>(
        __int64 a1,
        HSTRING a2,
        __int64 a3,
        __int64 a4)
{
  ...
  v8 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector3>(a1 + 208, v7, a4, &v19);
  v9 = v8;
  if ( v8 >= 0 )
  {
