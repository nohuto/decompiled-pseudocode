/*
 * XREFs of ?DebuggingStarted@BamoCompObjectDiagnosticsRootPrincipalImpl@BamoImpl@@QEAAJI_KIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x18019EECC
 * Callers:
 *     ?Thunk_DebuggingStarted_2@?$ICompObjectDiagnosticsRootPrincipal_Receive@VBamoCompObjectDiagnosticsRootPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18019F9B0 (-Thunk_DebuggingStarted_2@-$ICompObjectDiagnosticsRootPrincipal_Receive@VBamoCompObjectDiagnosti.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoCompObjectDiagnosticsRootPrincipalImpl::DebuggingStarted(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        int a4)
  ...
  if ( *(int *)(a1 + 8) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
      ...
      *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(v14 + 32),
      v12,
      v13);
    v16 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64))(*(_QWORD *)(a1 - 16) + 88LL))(
            a1 - 16,
            v11,
            a2,
            a3);
