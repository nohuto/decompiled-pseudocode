/*
 * XREFs of ?SetInteraction@Partner@Visual@Composition@UI@Windows@@UEAAJPEAUICompositionInteractionPartner@345@@Z @ 0x18008C9A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::Partner::SetInteraction(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v5 < 0 )
    {
      DoStackCaptureDirect(v5, 0xC80u);
    }
    else
    {
      Windows::UI::Composition::Visual::SetInteraction(v2, v8);
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionPropertySet>::InternalUnlock(&v8);
  }
