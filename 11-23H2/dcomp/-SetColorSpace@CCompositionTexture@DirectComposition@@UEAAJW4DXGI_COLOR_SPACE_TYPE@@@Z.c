/*
 * XREFs of ?SetColorSpace@CCompositionTexture@DirectComposition@@UEAAJW4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x1800A0310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CCompositionTexture::SetColorSpace(
        ...
        unsigned int a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)this + 2) + 40LL))(*((_QWORD *)this + 2), a2);
  v5 = v4;
  if ( v4 >= 0 )
    v5 = 0;
  else
