/*
 * XREFs of ?CreateLinearEasingFunction@Api@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUILinearEasingFunction@345@@Z @ 0x1800798F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Api::CreateLinearEasingFunction(
        struct _RTL_CRITICAL_SECTION *this,
        struct Windows::UI::Composition::ILinearEasingFunction **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v7 = 0LL;
    v4 = Windows::UI::Composition::CompositorCommon::CreateLinearEasingFunction(v2, &v7);
    v5 = v4;
    if ( v4 < 0 )
    {
      DoStackCaptureDirect(v4, 0x40Bu);
      if ( v7 )
        Microsoft::WRL2::NestableRuntimeClass::InternalRelease(v7);
    }
    else
    {
      *a2 = (struct Windows::UI::Composition::ILinearEasingFunction *)(((unsigned __int64)v7 + 152) & -(__int64)(v7 != 0LL));
      v5 = 0;
    }
  }
  else
