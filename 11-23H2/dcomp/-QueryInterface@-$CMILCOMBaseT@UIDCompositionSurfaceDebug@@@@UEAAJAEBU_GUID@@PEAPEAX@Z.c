/*
 * XREFs of ?QueryInterface@?$CMILCOMBaseT@UIDCompositionSurfaceDebug@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FD3D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<IDCompositionSurfaceDebug>::QueryInterface(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  int v5; // edi
  __int64 v6; // rax
