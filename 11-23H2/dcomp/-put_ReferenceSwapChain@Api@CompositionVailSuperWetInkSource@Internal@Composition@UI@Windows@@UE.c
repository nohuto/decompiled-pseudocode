/*
 * XREFs of ?put_ReferenceSwapChain@Api@CompositionVailSuperWetInkSource@Internal@Composition@UI@Windows@@UEAAJPEAUICompositionSurfaceBrush@456@@Z @ 0x180185F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CompositionVailSuperWetInkSource::Api::put_ReferenceSwapChain(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (v2[32] & 2) != 0 )
  {
    ...
    {
      v5 = -2147024809;
      DoStackCaptureDirect(-2147024809, 0x9Bu);
      goto LABEL_12;
    }
    v6 = 0LL;
    v7 = 0LL;
    if ( a2 )
    {
      ...
      else
      {
        ...
        DoStackCaptureDirect(v10, 0xADu);
        if ( v13 )
          Microsoft::WRL2::NestableRuntimeClass::InternalRelease(v13);
      }
      Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionPropertySet>::InternalUnlock(&v12);
