/*
 * XREFs of ?SetFinalValueParameter@SpotLight@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x18017C200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 15LL;
  v11[1] = &Windows::UI::Composition::SpotLight::k_rgAnimDef;
