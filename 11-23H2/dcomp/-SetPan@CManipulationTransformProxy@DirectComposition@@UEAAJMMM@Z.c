/*
 * XREFs of ?SetPan@CManipulationTransformProxy@DirectComposition@@UEAAJMMM@Z @ 0x180036070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CManipulationTransformProxy::SetPan(
