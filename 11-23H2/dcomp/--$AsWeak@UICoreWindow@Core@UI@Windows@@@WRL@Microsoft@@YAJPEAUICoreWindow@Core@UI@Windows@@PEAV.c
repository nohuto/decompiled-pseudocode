/*
 * XREFs of ??$AsWeak@UICoreWindow@Core@UI@Windows@@@WRL@Microsoft@@YAJPEAUICoreWindow@Core@UI@Windows@@PEAVWeakRef@01@@Z @ 0x180018C88
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AsWeak<Windows::UI::Core::ICoreWindow>(
