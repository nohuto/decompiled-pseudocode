/*
 * XREFs of ??4?$com_ptr_t@VCPresentationBuffer@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVCPresentationBuffer@@@Z @ 0x1801AF0EC
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<CPresentationBuffer,wil::err_returncode_policy>::operator=(__int64 *a1, __int64 a2)
{
  __int64 v2; // rdi
