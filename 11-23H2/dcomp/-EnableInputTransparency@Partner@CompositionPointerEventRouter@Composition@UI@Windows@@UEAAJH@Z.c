/*
 * XREFs of ?EnableInputTransparency@Partner@CompositionPointerEventRouter@Composition@UI@Windows@@UEAAJH@Z @ 0x180153870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionPointerEventRouter::Partner::EnableInputTransparency(
        ...
        int a2)
{
  ...
  if ( (v2[8] & 2) != 0 )
  {
    ...
    else
    {
      ...
      DoStackCaptureDirect(v5, 0x33Eu);
    }
  }
  else
  {
