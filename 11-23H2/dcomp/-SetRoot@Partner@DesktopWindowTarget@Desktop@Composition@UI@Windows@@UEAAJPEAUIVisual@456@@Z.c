/*
 * XREFs of ?SetRoot@Partner@DesktopWindowTarget@Desktop@Composition@UI@Windows@@UEAAJPEAUIVisual@456@@Z @ 0x18008C720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Desktop::DesktopWindowTarget::Partner::SetRoot(
