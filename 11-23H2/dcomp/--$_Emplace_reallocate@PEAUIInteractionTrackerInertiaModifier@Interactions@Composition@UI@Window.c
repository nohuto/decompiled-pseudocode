 ...
 *     ?_Change_array@?$vector@PEAUIInteractionTrackerInertiaModifier@Interactions@Composition@UI@Windows@@V?$allocator@PEAUIInteractionTrackerInertiaModifier@Interactions@Composition@UI@Windows@@@std@@@std@@AEAAXQEAPEAUIInteractionTrackerInertiaModifier@Interactions@Composition@UI@Windows@@_K1@Z @ 0x18013C594 (-_Change_array@-$vector@PEAUIInteractionTrackerInertiaModifier@Interactions@Composition@UI@Windo.c)
 */

char *__fastcall std::vector<Windows::UI::Composition::Interactions::IInteractionTrackerInertiaModifier *>::_Emplace_reallocate<Windows::UI::Composition::Interactions::IInteractionTrackerInertiaModifier *>(
        __int64 a1,
        _BYTE *a2,
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<Windows::UI::Composition::Interactions::IInteractionTrackerInertiaModifier *>::_Change_array(
    a1,
    v13,
    v9,
    v3);
