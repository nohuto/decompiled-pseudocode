/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_EffectSupport@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18006973C
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_EffectSupport>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        ...
        int *a4)
{
  ...
  FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0x902C68, 3u, a3, a4);
  *a2 = 0LL;
