/*
 * XREFs of ?SetTag@CPresentationSurface@@UEAAX_K@Z @ 0x1801B07D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CPresentationSurface::SetTag(CPresentationSurface *this, __int64 a2)
{
  struct _RTL_CRITICAL_SECTION *v4; // [rsp+30h] [rbp+8h] BYREF

  CPresentationManager::Lock(*((_QWORD *)this + 3), (__int64)&v4);
  *((_QWORD *)this + 6) = a2;
