/*
 * XREFs of ?SetFinalValueParameter@KeyFrameAnimator@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x180161170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::KeyFrameAnimator::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 4LL;
  v11[1] = &Windows::UI::Composition::KeyFrameAnimator::k_rgAnimDef;
