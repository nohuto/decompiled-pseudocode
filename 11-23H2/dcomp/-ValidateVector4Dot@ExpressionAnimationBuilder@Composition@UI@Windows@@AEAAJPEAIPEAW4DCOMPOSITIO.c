/*
 * XREFs of ?ValidateVector4Dot@ExpressionAnimationBuilder@Composition@UI@Windows@@AEAAJPEAIPEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180167554
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::ExpressionAnimationBuilder::ValidateVector4Dot(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a3)
{
  ...
  *a2 = 2;
  ...
  if ( *(_DWORD *)this >= 2u )
  {
    if ( *((_DWORD *)this + (unsigned int)(v3 - 2) + 66) == 69 )
    {
      if ( *((_DWORD *)this + (unsigned int)(v3 - 1) + 66) == 69 )
      {
        *(_DWORD *)a3 = 18;
        return 0;
      }
