/*
 * XREFs of ??_ERectangleClip@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180063440
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::RectangleClip *__fastcall Windows::UI::Composition::RectangleClip::`vector deleting destructor'(
