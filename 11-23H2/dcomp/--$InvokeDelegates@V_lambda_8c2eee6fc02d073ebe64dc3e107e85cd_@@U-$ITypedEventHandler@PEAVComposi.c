...
__int64 __fastcall Microsoft::WRL::InvokeTraits<-2>::InvokeDelegates<_lambda_8c2eee6fc02d073ebe64dc3e107e85cd_,Windows::Foundation::ITypedEventHandler<Windows::UI::Composition::CompositionIsland *,Windows::UI::Composition::CompositionIslandAutomationProviderRequestedEventArgs *>>(
        _QWORD *a1,
        volatile int *a2,
        __int64 a3)
{
