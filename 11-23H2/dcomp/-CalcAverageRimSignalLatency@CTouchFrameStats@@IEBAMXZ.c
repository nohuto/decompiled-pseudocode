/*
 * XREFs of ?CalcAverageRimSignalLatency@CTouchFrameStats@@IEBAMXZ @ 0x1801A7C24
 * Callers:
...
float __fastcall CTouchFrameStats::CalcAverageRimSignalLatency(CTouchFrameStats::CInteractionInfo **this)
{
  ...
  if ( v6 != v7 )
  {
    ...
    do
    {
      if ( v6 != v9 )
      {
        v11 = (float)(int)CTouchFrameStats::CInteractionInfo::RimSignalUs(v6, v2);
        v18 = v11;
        if ( v10 == v5 )
        {
