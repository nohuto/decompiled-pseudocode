/*
 * XREFs of ??$InitApiData@AEAY0DI@$$CBGAEAY0BM@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0DI@$$CBGAEAY0BM@$$CBG$$QEA$$T$$QEAPECJ@Z @ 0x1800A32F4
 * Callers:
...
void __fastcall wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[56],unsigned short const (&)[28],std::nullptr_t,long volatile *>(
        __int64 a1,
