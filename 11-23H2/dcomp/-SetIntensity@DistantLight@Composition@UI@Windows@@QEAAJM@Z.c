/*
 * XREFs of ?SetIntensity@DistantLight@Composition@UI@Windows@@QEAAJM@Z @ 0x1801764B8
 * Callers:
 *     ?put_Intensity@Api@DistantLight@Composition@UI@Windows@@UEAAJM@Z @ 0x1801768E0 (-put_Intensity@Api@DistantLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::DistantLight::SetIntensity(
        ...
        float a2)
{
  ...
  v5[1] = &v8;
  v5[2] = &v8;
  v7 = (void **)&Windows::UI::Composition::DistantLight::sc_Intensity;
