/*
 * XREFs of ?get_Geometry@Api@CompositionGeometricClip@Composition@UI@Windows@@UEAAJPEAPEAUICompositionGeometry@345@@Z @ 0x180172470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionGeometricClip::Api::get_Geometry(
