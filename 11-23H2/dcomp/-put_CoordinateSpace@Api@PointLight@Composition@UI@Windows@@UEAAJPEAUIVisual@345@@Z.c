/*
 * XREFs of ?put_CoordinateSpace@Api@PointLight@Composition@UI@Windows@@UEAAJPEAUIVisual@345@@Z @ 0x18017AE80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::PointLight::Api::put_CoordinateSpace(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    if ( v7 < 0 )
    {
      DoStackCaptureDirect(v7, 0x2B7u);
    }
    else
    {
      Windows::UI::Composition::PointLight::SetCoordinateSpace(v2, v10);
      v6 = 0;
    }
    Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionBatch>::InternalUnlock(
      (volatile signed __int32 **)&v10,
