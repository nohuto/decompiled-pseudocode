/*
 * XREFs of ?SetRotationAngleInDegrees@Visual@Composition@UI@Windows@@QEAAJM@Z @ 0x18010C0B8
 * Callers:
 *     ?put_RotationAngleInDegrees@Api@Visual@Composition@UI@Windows@@UEAAJM@Z @ 0x18010D7B0 (-put_RotationAngleInDegrees@Api@Visual@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::SetRotationAngleInDegrees(
...
LABEL_5:
  ...
  v8[1] = &v10;
  v8[2] = &v11;
  v12 = (void **)&Windows::UI::Composition::ComponentTransform3D::sc_RotationAngleInDegrees;
  v10 = a2 * 0.017453292;
