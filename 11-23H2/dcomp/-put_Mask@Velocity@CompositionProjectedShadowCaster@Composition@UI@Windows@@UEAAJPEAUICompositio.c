/*
 * XREFs of ?put_Mask@Velocity@CompositionProjectedShadowCaster@Composition@UI@Windows@@UEAAJPEAUICompositionBrush@345@@Z @ 0x180184190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowCaster::Velocity::put_Mask(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    {
      v7 = Windows::UI::Composition::CompositionProjectedShadowCaster::SetMask(v2, (struct IUnknown *)v11);
      v6 = v7;
      if ( v7 >= 0 )
      {
        v6 = 0;
