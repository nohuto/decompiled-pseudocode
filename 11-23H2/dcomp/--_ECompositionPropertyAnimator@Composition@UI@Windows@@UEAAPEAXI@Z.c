/*
 * XREFs of ??_ECompositionPropertyAnimator@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180161A50
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::CompositionPropertyAnimator *__fastcall Windows::UI::Composition::CompositionPropertyAnimator::`vector deleting destructor'(
