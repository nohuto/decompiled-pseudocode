/*
 * XREFs of ?ValidateVector3Cross@ExpressionAnimationBuilder@Composition@UI@Windows@@AEAAJPEAIPEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180167194
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::ExpressionAnimationBuilder::ValidateVector3Cross(
  ...
  *a2 = 2;
  ...
  if ( *(_DWORD *)this >= 2u )
  {
    *(_DWORD *)a3 = 52;
    ...
    {
      if ( *((_DWORD *)this + (unsigned int)(v3 - 1) + 66) == 52 )
        return 0;
      v6 = 7042;
