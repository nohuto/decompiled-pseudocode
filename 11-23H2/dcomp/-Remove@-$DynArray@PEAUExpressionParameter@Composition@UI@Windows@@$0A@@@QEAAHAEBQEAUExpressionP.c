/*
 * XREFs of ?Remove@?$DynArray@PEAUExpressionParameter@Composition@UI@Windows@@$0A@@@QEAAHAEBQEAUExpressionParameter@Composition@UI@Windows@@@Z @ 0x1801634D4
 * Callers:
...
__int64 __fastcall DynArray<Windows::UI::Composition::ExpressionParameter *,0>::Remove(__int64 *a1, _QWORD *a2)
{
  unsigned int v2; // r8d
  __int64 v3; // r9
  __int64 i; // r11
