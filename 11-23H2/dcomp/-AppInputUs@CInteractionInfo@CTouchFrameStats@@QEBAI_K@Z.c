/*
 * XREFs of ?AppInputUs@CInteractionInfo@CTouchFrameStats@@QEBAI_K@Z @ 0x1801A6C78
 * Callers:
...
unsigned __int64 __fastcall CTouchFrameStats::CInteractionInfo::AppInputUs(
