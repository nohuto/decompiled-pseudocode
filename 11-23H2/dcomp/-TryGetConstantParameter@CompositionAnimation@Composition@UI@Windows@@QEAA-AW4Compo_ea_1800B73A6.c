/*
 * XREFs of ?TryGetConstantParameter@CompositionAnimation@Composition@UI@Windows@@QEAA?AW4CompositionGetValueStatus@234@PEAUHSTRING__@@PEAU_D3DCOLORVALUE@@@Z @ 0x1800B73A6
 * Callers:
        ...
        __m128i *a3)
{
  ...
  result = Windows::UI::Composition::CompositionAnimation::TryGetParameterEntry(a1, a2, 70, &v5);
  if ( !(_DWORD)result )
    *a3 = _mm_loadu_si128((const __m128i *)(v5 + 40));
  return result;
}
