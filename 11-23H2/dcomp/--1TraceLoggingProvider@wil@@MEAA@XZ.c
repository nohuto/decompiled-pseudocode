/*
 * XREFs of ??1TraceLoggingProvider@wil@@MEAA@XZ @ 0x1800EB128
 * Callers:
 *     ??_GInputTraceLogging@@UEAAPEAXI@Z @ 0x180099550 (--_GInputTraceLogging@@UEAAPEAXI@Z.c)
 *     ??_ETraceLoggingProvider@wil@@MEAAPEAXI@Z @ 0x1800EB170 (--_ETraceLoggingProvider@wil@@MEAAPEAXI@Z.c)
