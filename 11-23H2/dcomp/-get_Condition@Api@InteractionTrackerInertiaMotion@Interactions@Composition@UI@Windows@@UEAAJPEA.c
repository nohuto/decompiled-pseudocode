/*
 * XREFs of ?get_Condition@Api@InteractionTrackerInertiaMotion@Interactions@Composition@UI@Windows@@UEAAJPEAPEAUIExpressionAnimation@456@@Z @ 0x18013DD20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTrackerInertiaMotion::Api::get_Condition(
