/*
 * XREFs of ??$_Emplace_reallocate@AEBU_GUID@@AEAPEBUPresentedContentUpdateInfo@@I@?$vector@UCFlipPropertyItem@@V?$allocator@UCFlipPropertyItem@@@std@@@std@@QEAAPEAUCFlipPropertyItem@@QEAU2@AEBU_GUID@@AEAPEBUPresentedContentUpdateInfo@@$$QEAI@Z @ 0x1801AF99C
 * Callers:
...
char *__fastcall std::vector<CFlipPropertyItem>::_Emplace_reallocate<_GUID const &,PresentedContentUpdateInfo const * &,unsigned int>(
        char **a1,
        char *a2,
        __int128 *a3,
        _QWORD *a4,
