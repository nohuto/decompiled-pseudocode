/*
 * XREFs of ??1SwapDeviceContextState@DirectComposition@@QEAA@XZ @ 0x180035000
 * Callers:
...
void __fastcall DirectComposition::SwapDeviceContextState::~SwapDeviceContextState(
        DirectComposition::SwapDeviceContextState *this)
{
  __int64 v2; // rcx

  (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)this + 72LL) + 1048LL))(
  ...
  DirectComposition::MultithreadDeviceLock::Leave(*(const struct DirectComposition::CDxDevice **)this);
}
