/*
 * XREFs of ?get_Root@Api@SceneVisual@Scenes@Composition@UI@Windows@@UEAAJPEAPEAUISceneNode@3456@@Z @ 0x180145DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneVisual::Api::get_Root(
        ...
        struct Windows::UI::Composition::Scenes::ISceneNode **a2)
{
  ...
  v5 = 0;
  if ( !wil::ProcessShutdownInProgress(this) && _InterlockedIncrement(&dword_180220964) == 1 )
  {
    v10 = 0LL;
    v9 = (Microsoft::WRL2::NestableRuntimeClass *)&dword_180220964;
  ...
  *a2 = 0LL;
  v6 = (struct _RTL_CRITICAL_SECTION *)*((_QWORD *)this - 37);
  ...
  if ( (*((_BYTE *)this - 288) & 2) != 0 )
  {
    ...
    if ( v7 )
    {
      ...
      v9 = 0LL;
      *a2 = (struct Windows::UI::Composition::Scenes::ISceneNode *)(v7 + 208);
    }
