/*
 * XREFs of ?CreateProjectedShadowCaster@VelocityProjectedShadow@CompositorCommon@Composition@UI@Windows@@UEAAJPEAPEAUICompositionProjectedShadowCaster@345@@Z @ 0x1800069C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositorCommon::VelocityProjectedShadow::CreateProjectedShadowCaster(
        ...
        struct Windows::UI::Composition::ICompositionProjectedShadowCaster **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    v10 = 0LL;
    v12 = v2;
    v4 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionProjectedShadowCaster,Windows::UI::Composition::CompositionProjectedShadowCaster,Windows::UI::Composition::Compositor *>(
           &v10,
           &v12);
    v5 = v4;
    if ( v4 < 0 )
    ...
    if ( v5 < 0 )
    {
      DoStackCaptureDirect(v5, 0x2294u);
    }
    else
    {
      v11 = 0LL;
      *a2 = (struct Windows::UI::Composition::ICompositionProjectedShadowCaster *)((v6 + 136) & -(__int64)(v6 != 0));
      v5 = 0;
    }
