/*
 * XREFs of ?SetAttenuation2@SpotLight@Composition@UI@Windows@@QEAAJM@Z @ 0x18017C154
 * Callers:
 *     ?put_QuadraticAttenuation@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z @ 0x18017D350 (-put_QuadraticAttenuation@Api@SpotLight@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpotLight::SetAttenuation2(
        ...
        float a2)
{
  ...
  else
  {
    ...
    v5[1] = &v7;
    v5[2] = &v7;
    v8 = (void **)&Windows::UI::Composition::SpotLight::sc_QuadraticAttenuation;
