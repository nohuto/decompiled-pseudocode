/*
 * XREFs of ??_GCompositionHoverPointerSource@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123B10
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::CompositionHoverPointerSource::`scalar deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx
