/*
 * XREFs of ?CreateAsync@HolographicCompositorStatics@Internal@Composition@UI@Windows@@UEAAJPEAUICompositor@345@U_GUID@@IPEAPEAU?$IAsyncOperation@PEAVHolographicCompositor@Internal@Composition@UI@Windows@@@Foundation@5@@Z @ 0x180116350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::HolographicCompositorStatics::CreateAsync(
        __int64 a1,
        struct IUnknown *a2,
        struct _GUID *a3,
        int a4,
        __int64 *a5)
{
  ...
  if ( a2 )
  {
    ...
    v8 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Internal::HolographicCompositor,Windows::UI::Composition::Internal::HolographicCompositor,Windows::UI::Composition::Compositor *,_GUID &,unsigned int &>(
           &v13,
    ...
    else
    {
      ...
      v16 = 0;
      v15 = 0x8000000003LL;
      v6 = Windows::Internal::MakeAsyncOperation_Windows::Internal::CMarshaledInterfaceResult_Windows::UI::Composition::Internal::IHolographicCompositor__Windows::UI::Composition::Internal::HolographicCompositor___Windows::Internal::ComTaskPoolHandler__lambda_525e999c26fbeca1a1e2a68ab2096671___(
             (__int64)&v15,
             a5,
             v9,
             &v14);
