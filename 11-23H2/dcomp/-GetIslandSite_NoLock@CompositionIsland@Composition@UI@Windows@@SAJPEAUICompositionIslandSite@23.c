/*
 * XREFs of ?GetIslandSite_NoLock@CompositionIsland@Composition@UI@Windows@@SAJPEAUICompositionIslandSite@234@PEAPEAVCompositionIslandSite@234@@Z @ 0x1801128EC
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionIsland::GetIslandSite_NoLock(
        struct IUnknown *a1,
...
LABEL_6:
  ...
  *a2 = v9;
  if ( v8 < 0 )
    DoStackCaptureDirect(v8, 0x203u);
  else
    v8 = 0;
  Microsoft::WRL2::ContextSession::EndApiEntry(v6);
