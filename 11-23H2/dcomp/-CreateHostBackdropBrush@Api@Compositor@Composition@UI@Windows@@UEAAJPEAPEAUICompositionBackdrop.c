/*
 * XREFs of ?CreateHostBackdropBrush@Api@Compositor@Composition@UI@Windows@@UEAAJPEAPEAUICompositionBackdropBrush@345@@Z @ 0x180069BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::Api::CreateHostBackdropBrush(
        ...
        struct Windows::UI::Composition::ICompositionBackdropBrush **a2)
{
  ...
  *a2 = 0LL;
  v2 = (struct _RTL_CRITICAL_SECTION *)((char *)this - 1088);
  Microsoft::WRL2::ContextSession::BeginApiEntry((struct _RTL_CRITICAL_SECTION *)((char *)this - 1088));
  if ( (v2->SpinCount & 2) != 0 )
  {
    v9 = 0LL;
    v8 = 1;
    ...
    if ( v4 < 0 )
    {
      ...
      DoStackCaptureDirect(v5, 0x56Cu);
    }
    else
    {
