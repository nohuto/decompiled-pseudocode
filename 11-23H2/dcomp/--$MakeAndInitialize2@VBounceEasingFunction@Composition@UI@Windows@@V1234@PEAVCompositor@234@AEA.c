/*
 * XREFs of ??$MakeAndInitialize2@VBounceEasingFunction@Composition@UI@Windows@@V1234@PEAVCompositor@234@AEAW4CompositionEasingFunctionMode@234@AEAHAEAM@Details@WRL2@Microsoft@@YAJPEAPEAVBounceEasingFunction@Composition@UI@Windows@@$$QEAPEAVCompositor@456@AEAW4CompositionEasingFunctionMode@456@AEAHAEAM@Z @ 0x18012DE9C
 * Callers:
 *     ?CreateBounceEasingFunction@CompositionEasingFunctionStatics@Composition@UI@Windows@@UEAAJPEAUICompositor@234@W4CompositionEasingFunctionMode@234@HMPEAPEAUIBounceEasingFunction@234@@Z @ 0x18012E520 (-CreateBounceEasingFunction@CompositionEasingFunctionStatics@Composition@UI@Windows@@UEAAJPEAUIC.c)
 * Callees:
...
LABEL_6:
  ...
  if ( v11 )
    v11 = Windows::UI::Composition::BounceEasingFunction::BounceEasingFunction(v11);
