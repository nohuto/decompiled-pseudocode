/*
 * XREFs of ?CreateBackEasingFunction@CompositionEasingFunctionStatics@Composition@UI@Windows@@UEAAJPEAUICompositor@234@W4CompositionEasingFunctionMode@234@MPEAPEAUIBackEasingFunction@234@@Z @ 0x18012E390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionEasingFunctionStatics::CreateBackEasingFunction(
        __int64 a1,
        struct IUnknown *a2,
        unsigned int a3,
        float a4,
...
LABEL_6:
  ...
  if ( v8 < 0 )
  {
    DoStackCaptureDirect(v8, 0xF4u);
  }
  else
  {
    v12[0] = v13;
    v10 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::BackEasingFunction,Windows::UI::Composition::BackEasingFunction,Windows::UI::Composition::Compositor *,enum Windows::UI::Composition::CompositionEasingFunctionMode &,float &>(
            &a5,
            v12,
            &v14);
    v8 = v10;
    if ( v10 < 0 )
    {
      DoStackCaptureDirect(v10, 0xFAu);
      v6 = a5;
    }
    else
    {
