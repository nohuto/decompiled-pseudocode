/*
 * XREFs of ?GetAt@?$ImplementsIVectorWinRt@VCompositionShapeCollection@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJIPEAPEAUICompositionShape@234@@Z @ 0x1801A0C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::CompositionShapeCollection,>::GetAt(
        __int64 a1,
        unsigned int a2,
        __int64 *a3)
{
