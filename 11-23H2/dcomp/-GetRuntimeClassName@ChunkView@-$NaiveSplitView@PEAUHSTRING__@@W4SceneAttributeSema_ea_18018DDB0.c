  ...
  *a2 = 0LL;
  return WindowsCreateString(
           L"Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Collections.IKeyValuePair`2<String, Windows.UI."
            "Composition.Scenes.SceneAttributeSemantic>>",
           0x98u,
           a2);
}
