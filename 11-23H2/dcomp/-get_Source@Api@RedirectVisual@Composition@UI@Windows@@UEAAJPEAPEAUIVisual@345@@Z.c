/*
 * XREFs of ?get_Source@Api@RedirectVisual@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x18016F310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::RedirectVisual::Api::get_Source(
        Windows::UI::Composition::RedirectVisual::Api *this,
