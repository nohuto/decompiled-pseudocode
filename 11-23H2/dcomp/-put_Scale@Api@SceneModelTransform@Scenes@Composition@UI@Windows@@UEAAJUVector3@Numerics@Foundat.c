/*
 * XREFs of ?put_Scale@Api@SceneModelTransform@Scenes@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@6@@Z @ 0x180193730
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::SceneModelTransform::Api::put_Scale(__int64 a1, __int64 a2)
{
