/*
 * XREFs of ?get_Color@Api@PointLight@Composition@UI@Windows@@UEAAJPEAUColor@45@@Z @ 0x18017A7C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::PointLight::Api::get_Color(
        ...
        struct Windows::UI::Color *a2)
{
  ...
  *(_DWORD *)a2 = 0;
  ...
  {
    v6 = (__m128)_mm_loadu_si128((const __m128i *)((char *)this + 44));
