/*
 * XREFs of ?TryGetConstantParameter@CompositionAnimation@Composition@UI@Windows@@QEAA?AW4CompositionGetValueStatus@234@PEAUHSTRING__@@PEAUQuaternion@Numerics@Foundation@4@@Z @ 0x18014FF0C
 * Callers:
        ...
        _OWORD *a3)
{
  ...
  result = Windows::UI::Composition::CompositionAnimation::TryGetParameterEntry(a1, a2, 71, &v5);
  if ( !(_DWORD)result )
    *a3 = *(_OWORD *)(v5 + 40);
  return result;
}
