/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_CompTexturesNoRedirectionFix@@@details@wil@@QEAA_NXZ @ 0x1800A7744
 * Callers:
...
char __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_CompTexturesNoRedirectionFix>::__private_IsEnabled(
        wil::details *a1)
{
  char v2; // bl
  __int64 v3; // r8
  ...
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_CompTexturesNoRedirectionFix>::GetCachedFeatureEnabledState(
    a1,
    &v6);
  v2 = v6 & 1;
  wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_CompTexturesNoRedirectionFix>::ReportUsage(
    a1,
    v6 & 1,
    v3,
    v4);
