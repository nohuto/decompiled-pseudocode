/*
 * XREFs of ?put_Mask@Api@DropShadow@Composition@UI@Windows@@UEAAJPEAUICompositionBrush@345@@Z @ 0x180183490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::DropShadow::Api::put_Mask(
        Windows::UI::Composition::DropShadow::Api *this,
        struct IUnknown *a2)
{
  Windows::UI::Composition::DropShadow *v2; // rdi
  ...
  v2 = (Windows::UI::Composition::DropShadow::Api *)((char *)this - 152);
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    {
      v7 = Windows::UI::Composition::DropShadow::SetMask(v2, (struct IUnknown *)v11);
      v6 = v7;
      if ( v7 >= 0 )
      {
        v6 = 0;
