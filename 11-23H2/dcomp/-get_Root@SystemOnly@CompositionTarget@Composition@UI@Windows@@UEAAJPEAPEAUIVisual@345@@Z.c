/*
 * XREFs of ?get_Root@SystemOnly@CompositionTarget@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x180197090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionTarget::SystemOnly::get_Root(
