/*
 * XREFs of ?GetSourceRect@CPresentationSurface@@UEAA?AUtagRECT@@XZ @ 0x1800A7D70
 * Callers:
 *     <none>
 * Callees:
...
struct tagRECT *__fastcall CPresentationSurface::GetSourceRect(
        CPresentationSurface *this,
        struct tagRECT *__return_ptr retstr)
{
  char v5; // [rsp+30h] [rbp+8h] BYREF

  wil::critical_section::lock(*((_QWORD *)this - 1) + 24LL, &v5);
  *retstr = *(struct tagRECT *)((char *)this + 68);
