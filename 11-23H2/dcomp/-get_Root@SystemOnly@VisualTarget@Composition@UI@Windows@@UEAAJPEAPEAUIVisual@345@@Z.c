/*
 * XREFs of ?get_Root@SystemOnly@VisualTarget@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x180160050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::VisualTarget::SystemOnly::get_Root(
