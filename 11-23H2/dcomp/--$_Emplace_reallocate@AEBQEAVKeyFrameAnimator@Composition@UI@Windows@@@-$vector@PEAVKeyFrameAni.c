/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVKeyFrameAnimator@Composition@UI@Windows@@@?$vector@PEAVKeyFrameAnimator@Composition@UI@Windows@@V?$allocator@PEAVKeyFrameAnimator@Composition@UI@Windows@@@std@@@std@@QEAAPEAPEAVKeyFrameAnimator@Composition@UI@Windows@@QEAPEAV2345@AEBQEAV2345@@Z @ 0x1800449B8
 * Callers:
...
char *__fastcall std::vector<Windows::UI::Composition::KeyFrameAnimator *>::_Emplace_reallocate<Windows::UI::Composition::KeyFrameAnimator * const &>(
        char *a1,
        _BYTE *a2,
        _QWORD *a3)
{
  ...
  *(_QWORD *)a1 = v13;
  result = v14;
  *((_QWORD *)a1 + 1) = &v13[8 * v9];
  *((_QWORD *)a1 + 2) = &v13[8 * v3];
  return result;
}
