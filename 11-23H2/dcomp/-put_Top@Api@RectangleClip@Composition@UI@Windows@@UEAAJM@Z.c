/*
 * XREFs of ?put_Top@Api@RectangleClip@Composition@UI@Windows@@UEAAJM@Z @ 0x180082BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::RectangleClip::Api::put_Top(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::RectangleClip::sc_Top;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x248u);
    else
      v5 = 0;
  }
  else
