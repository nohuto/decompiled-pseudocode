/*
 * XREFs of ?put_Color@Api@CompositionColorGradientStop@Composition@UI@Windows@@UEAAJUColor@45@@Z @ 0x180174AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionColorGradientStop::Api::put_Color(__int64 a1, unsigned int a2)
{
  __int64 v2; // rsi
  ...
  if ( (*(_BYTE *)(v2 + 32) & 2) != 0 )
  {
    ...
    v10[1] = &v11;
    v10[2] = &v11;
    v9 = (void **)&Windows::UI::Composition::CompositionColorGradientStop::sc_Color;
    v11 = v6;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x107u);
    else
      v5 = 0;
  }
  else
