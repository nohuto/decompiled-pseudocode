/*
 * XREFs of ?CreateCompositeEffect@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionCompositeEffect@@@Z @ 0x1800EEE20
 * Callers:
 *     ?CreateCompositeEffect@CDevice@DirectComposition@@W7EAAJPEAPEAUIDCompositionCompositeEffect@@@Z @ 0x1800A8630 (-CreateCompositeEffect@CDevice@DirectComposition@@W7EAAJPEAPEAUIDCompositionCompositeEffect@@@Z.c)
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateCompositeEffect(
  ...
  if ( a2 )
  {
    *a2 = 0LL;
    ...
    if ( v3 >= 0 )
    {
      ...
      *((_DWORD *)v5 + 2) = 1;
      v3 = DirectComposition::CCompositeEffect::Create(v5, a2);
      if ( v3 < 0 )
        *a2 = 0LL;
