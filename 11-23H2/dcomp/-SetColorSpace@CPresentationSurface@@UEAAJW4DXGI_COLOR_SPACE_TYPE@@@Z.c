/*
 * XREFs of ?SetColorSpace@CPresentationSurface@@UEAAJW4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x1801B05D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPresentationSurface::SetColorSpace(CPresentationSurface *this, enum DXGI_COLOR_SPACE_TYPE a2)
{
