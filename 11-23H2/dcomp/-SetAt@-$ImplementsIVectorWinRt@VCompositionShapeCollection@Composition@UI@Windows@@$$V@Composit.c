/*
 * XREFs of ?SetAt@?$ImplementsIVectorWinRt@VCompositionShapeCollection@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJIPEAUICompositionShape@234@@Z @ 0x1801A1540
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CollectionItemFromApi@CompositionShapeCollection@Composition@UI@Windows@@QEAA@PEAUICompositionShape@234@PEAJ@Z @ 0x1801A0AB8 (-CollectionItemFromApi@CompositionShapeCollection@Composition@UI@Windows@@QEAA@PEAUICompositionS.c)
 */

__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::CompositionShapeCollection,>::SetAt(
        __int64 a1,
        unsigned int a2,
        struct IUnknown *a3)
{
  ...
  if ( (*(_BYTE *)(v3 + 32) & 2) != 0 )
  {
    Windows::UI::Composition::CompositionShapeCollection::CollectionItemFromApi(
