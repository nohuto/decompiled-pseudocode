/*
 * XREFs of McTemplateU0xqqqtqq_EventWriteTransfer @ 0x1800EA454
 * Callers:
...
ULONG __fastcall McTemplateU0xqqqtqq_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v22 = 4LL;
  v24 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, &DCOMPEVENT_ATLAS_ALLOCATE, a3, 8u, &v10);
}
