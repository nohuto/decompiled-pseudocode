/*
 * XREFs of ?SetProperties@SpringScalarNaturalMotionAnimation@Composition@UI@Windows@@UEAAJPEAVNaturalMotionAnimator@234@@Z @ 0x180129C40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::SpringScalarNaturalMotionAnimation::SetProperties(
        Windows::UI::Composition::SpringScalarNaturalMotionAnimation *this,
        struct Windows::UI::Composition::NaturalMotionAnimator *a2)
{
  ...
  if ( v4 >= 0 )
  {
    Windows::UI::Composition::Spring::SetProperties(
      (Windows::UI::Composition::SpringScalarNaturalMotionAnimation *)((char *)this + 440),
      a2);
    return 0LL;
  }
  else
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x20,
      (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\WrtSpringScalarNaturalMotionAnimation.h",
