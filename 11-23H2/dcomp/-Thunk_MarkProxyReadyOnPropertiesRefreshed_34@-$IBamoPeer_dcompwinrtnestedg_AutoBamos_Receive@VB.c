/*
 * XREFs of ?Thunk_MarkProxyReadyOnPropertiesRefreshed_34@?$IBamoPeer_dcompwinrtnestedg_AutoBamos_Receive@VBamoPeerImpl@dcompwinrtnestedg_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016E9B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IBamoPeer_dcompwinrtnestedg_AutoBamos_Receive<BamoImpl::dcompwinrtnestedg_AutoBamos::BamoPeerImpl>::Thunk_MarkProxyReadyOnPropertiesRefreshed_34(
        __int64 a1,
        unsigned int **a2)
{
