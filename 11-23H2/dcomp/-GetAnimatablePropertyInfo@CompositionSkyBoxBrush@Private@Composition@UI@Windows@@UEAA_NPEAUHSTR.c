/*
 * XREFs of ?GetAnimatablePropertyInfo@CompositionSkyBoxBrush@Private@Composition@UI@Windows@@UEAA_NPEAUHSTRING__@@PEAW4AnimationBindingDirection@345@PEAVExpressionObjectPropertyInfo@@PEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x180180E50
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Windows::UI::Composition::Private::CompositionSkyBoxBrush::GetAnimatablePropertyInfo(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a5)
{
  ...
  v10[0] = 2LL;
  v10[1] = &Windows::UI::Composition::Private::CompositionSkyBoxBrush::k_rgAnimDef;
  ...
  if ( Windows::UI::Composition::ComponentTransform3D::GetAnimatablePropertyInfo(
         ...
         a5) )
  {
    *(_DWORD *)a4 = *(_DWORD *)(*((_QWORD *)this + 25) + 128LL);
    return 1;
  }
