/*
 * XREFs of ?put_Offset@Partner@CaptureController@Internal@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@6@@Z @ 0x18017FF40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureController::Partner::put_Offset(__int64 a1, __int64 a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    ...
    v4 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0x127u);
    else
      v4 = 0;
  }
  else
