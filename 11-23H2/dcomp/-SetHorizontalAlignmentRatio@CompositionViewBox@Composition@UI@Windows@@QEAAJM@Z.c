/*
 * XREFs of ?SetHorizontalAlignmentRatio@CompositionViewBox@Composition@UI@Windows@@QEAAJM@Z @ 0x1801797B8
 * Callers:
 *     ?put_HorizontalAlignmentRatio@Api@CompositionViewBox@Composition@UI@Windows@@UEAAJM@Z @ 0x180179C40 (-put_HorizontalAlignmentRatio@Api@CompositionViewBox@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionViewBox::SetHorizontalAlignmentRatio(
        ...
        float a2)
{
  ...
  if ( a2 < 0.0 || a2 > 1.0 )
  {
    Windows::UI::Composition::OriginateInvalidArgument(16, (__int64)L"HorizontalAlignmentRatio");
    v3 = 191LL;
    updated = -2147024809;
  }
  else
  {
    ...
    v5[1] = &v7;
    v5[2] = &v7;
    v8 = (void **)&Windows::UI::Composition::CompositionViewBox::sc_HorizontalAlignmentRatio;
