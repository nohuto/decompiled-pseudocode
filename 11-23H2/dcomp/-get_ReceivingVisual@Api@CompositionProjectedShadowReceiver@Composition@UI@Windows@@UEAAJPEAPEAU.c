/*
 * XREFs of ?get_ReceivingVisual@Api@CompositionProjectedShadowReceiver@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x180184390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowReceiver::Api::get_ReceivingVisual(
        Windows::UI::Composition::CompositionProjectedShadowReceiver::Api *this,
