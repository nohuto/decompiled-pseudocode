/*
 * XREFs of ?SetRoot@Api@InteropVisualTarget@Composition@UI@Windows@@UEAAJPEAUIDCompositionVisual@@@Z @ 0x180060970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InteropVisualTarget::Api::SetRoot(
        Windows::UI::Composition::InteropVisualTarget::Api *this,
        struct IUnknown *a2)
{
  ...
  v2 = (Windows::UI::Composition::InteropVisualTarget::Api *)((char *)this - 184);
