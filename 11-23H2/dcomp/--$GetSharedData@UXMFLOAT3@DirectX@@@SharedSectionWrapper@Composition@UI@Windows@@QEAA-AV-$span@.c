/*
 * XREFs of ??$GetSharedData@UXMFLOAT3@DirectX@@@SharedSectionWrapper@Composition@UI@Windows@@QEAA?AV?$span@$$CBUXMFLOAT3@DirectX@@$0?0@gsl@@XZ @ 0x180131D6C
 * Callers:
...
gsl::details *__fastcall Windows::UI::Composition::SharedSectionWrapper::GetSharedData<DirectX::XMFLOAT3>(
        __int64 a1,
        gsl::details *a2)
{
  __int64 v3; // rdi
  ...
  gsl::details::extent_type<-1>::extent_type<-1>(a2, *(_QWORD *)(a1 + 152) / 0xCuLL);
  v5 = *(_QWORD *)a2 == -1LL;
  *((_QWORD *)a2 + 1) = v3;
  if ( v5 || !v3 && *(_QWORD *)a2 )
  {
    gsl::details::terminate(v4);
    JUMPOUT(0x180131DC9LL);
  }
  return a2;
}
