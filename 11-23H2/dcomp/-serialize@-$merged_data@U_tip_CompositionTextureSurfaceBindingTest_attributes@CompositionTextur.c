/*
 * XREFs of ?serialize@?$merged_data@U_tip_CompositionTextureSurfaceBindingTest_attributes@CompositionTextureTip@@Vtest_data_basic@tip2@@@details@tip2@@EEAAXAEAVoutput_archive@tson@@W4serialize_options@23@@Z @ 0x18009F320
 * Callers:
 *     <none>
 * Callees:
...
tson::output_archive *__fastcall tip2::details::merged_data<CompositionTextureTip::_tip_CompositionTextureSurfaceBindingTest_attributes,tip2::test_data_basic>::serialize(
        __int64 a1,
        ...
        char a3)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    v9 = 4;
    v8 = "test";
    v10 = (_QWORD *)((a1 + 248) & -(__int64)(a1 != 0));
