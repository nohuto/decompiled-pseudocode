/*
 * XREFs of ??_EInjectionAnimation@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180124160
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::InjectionAnimation *__fastcall Windows::UI::Composition::InjectionAnimation::`vector deleting destructor'(
