/*
 * XREFs of ?CalcAverageDwmRenderLatency@CTouchFrameStats@@IEBAMXZ @ 0x1801A73E0
 * Callers:
...
float __fastcall CTouchFrameStats::CalcAverageDwmRenderLatency(CTouchFrameStats::CInteractionInfo **this)
{
  ...
  if ( v6 != v7 )
  {
    ...
    do
    {
      ...
      {
        v12 = (float)(int)CTouchFrameStats::CInteractionInfo::DwmRenderUs(v10, v2);
        v19 = v12;
        if ( v11 == v5 )
        {
