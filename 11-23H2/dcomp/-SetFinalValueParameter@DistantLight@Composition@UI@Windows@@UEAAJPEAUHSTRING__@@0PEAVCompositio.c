/*
 * XREFs of ?SetFinalValueParameter@DistantLight@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x180176420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::DistantLight::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 3LL;
  v11[1] = &Windows::UI::Composition::DistantLight::k_rgAnimDef;
