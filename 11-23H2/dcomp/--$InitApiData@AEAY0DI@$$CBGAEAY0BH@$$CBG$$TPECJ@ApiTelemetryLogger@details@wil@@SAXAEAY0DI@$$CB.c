/*
 * XREFs of ??$InitApiData@AEAY0DI@$$CBGAEAY0BH@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0DI@$$CBGAEAY0BH@$$CBG$$QEA$$T$$QEAPECJ@Z @ 0x1800A3298
 * Callers:
...
void __fastcall wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[56],unsigned short const (&)[23],std::nullptr_t,long volatile *>(
        __int64 a1,
        __int64 a2,
        const char **a3,
        volatile int **a4)
