/*
 * XREFs of ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@VFtmBase@23@UIInteractionTrackerIdleStateEnteredArgs@Interactions@Composition@UI@Windows@@UIInteractionTrackerIdleStateEnteredArgs2@6789@UIInspectable@@@Details@WRL@Microsoft@@WCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800AFCA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        void **a3)
{
  return Windows::UI::Composition::Interactions::InteractionTrackerIdleStateEnteredArgs::QueryInterface(
           (Windows::UI::Composition::Interactions::InteractionTrackerIdleStateEnteredArgs *)(a1 - 40),
           a2,
           a3);
}
