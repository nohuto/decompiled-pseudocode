/*
 * XREFs of ?SendRequestDisposeProxy@BamoPeerImpl@dcompwinrtnestedg_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x18016E310
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dcompwinrtnestedg_AutoBamos::BamoPeerImpl::SendRequestDisposeProxy(
