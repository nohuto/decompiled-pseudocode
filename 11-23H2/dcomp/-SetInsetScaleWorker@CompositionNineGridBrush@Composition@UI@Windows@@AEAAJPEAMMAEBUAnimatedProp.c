/*
 * XREFs of ?SetInsetScaleWorker@CompositionNineGridBrush@Composition@UI@Windows@@AEAAJPEAMMAEBUAnimatedProperty@AnimationHelper@234@@Z @ 0x180168F78
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionNineGridBrush::SetInsetScaleWorker(
        ...
        void **a4)
{
  ...
  if ( a3 < 0.0 )
  {
    Windows::UI::Composition::OriginateInvalidArgument(14, (__int64)L"InsetScale");
    v5 = 177LL;
    updated = -2147024809;
  }
  else
