/*
 * XREFs of ?put_RotationAxis@Api@Visual@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@5@@Z @ 0x18010D840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Visual::Api::put_RotationAxis(
        __int64 a1,
        const struct Windows::Foundation::Numerics::Vector3 *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v6 = Windows::UI::Composition::Visual::SetRotationAxis(v2, a2);
    v5 = v6;
    if ( v6 < 0 )
      DoStackCaptureDirect(v6, 0xA8Au);
    else
      v5 = 0;
  }
  else
