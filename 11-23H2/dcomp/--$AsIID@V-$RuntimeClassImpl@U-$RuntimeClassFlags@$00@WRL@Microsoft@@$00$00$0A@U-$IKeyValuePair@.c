...
__int64 __fastcall Microsoft::WRL::Details::RuntimeClassBaseT<1>::AsIID<Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<1>,1,1,0,Windows::Foundation::Collections::IKeyValuePair<HSTRING__ *,Windows::UI::Composition::ICompositionAnimationBase *>,Microsoft::WRL::FtmBase>>(
        __int64 a1,
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    if ( InlineIsEqualGUID(v6, &GUID_3b9a274f_891d_5208_96bb_e3f40c809e9b) )
    {
      *v7 = v8;
      CanCastTo = 0;
    }
