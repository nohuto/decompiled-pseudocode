/*
 * XREFs of ?GetView@?$ImplementsIVectorWinRt@VCompositionStrokeDashArray@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJPEAPEAU?$IVectorView@M@Collections@Foundation@4@@Z @ 0x180170E30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$SimpleVectorView@MU?$IVector@M@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@M@Internal@234@UNoVersionTag@6234@$0A@@Internal@Collections@Foundation@Windows@@QEAA@PEAU?$IVector@M@234@Upermission@01234@@Z @ 0x180170168 (--0-$SimpleVectorView@MU-$IVector@M@Collections@Foundation@Windows@@U-$DefaultLifetimeTraits@M@I.c)
 */

__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::CompositionStrokeDashArray,>::GetView(
        __int64 a1,
        __int64 *a2)
{
  int v4; // ebx
