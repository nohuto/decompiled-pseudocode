/*
 * XREFs of ?CreateMouseInteractionConfiguration@CDevice@DirectComposition@@UEAAJW4DCOMPOSITION_INTERACTION_TYPE_MOUSE@@PEAPEAUIDCompositionInteractionConfigurationPartner@@@Z @ 0x1800EFB70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateMouseInteractionConfiguration(__int64 a1, int a2, _QWORD *a3)
{
  unsigned int v3; // ebx
  _QWORD *v6; // rax
  _QWORD *v7; // rdi
