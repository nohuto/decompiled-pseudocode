/*
 * XREFs of ?ScrollWithClip@Api@CompositionVirtualDrawingSurface@Composition@UI@Windows@@UEAAJUPointInt32@Graphics@5@URectInt32@75@@Z @ 0x180195F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionVirtualDrawingSurface::Api::ScrollWithClip(
        __int64 a1,
        __int64 a2,
        const struct Windows::Graphics::RectInt32 *a3)
{
  ...
  if ( (*((_BYTE *)v3 + 32) & 2) != 0 )
  {
    ...
    v6 = v7;
    if ( v7 < 0 )
      DoStackCaptureDirect(v7, 0x1A0u);
    else
      v6 = 0;
  }
  else
