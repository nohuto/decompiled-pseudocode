/*
 * XREFs of ??$TryGetProperty@UPropertySetVector2Value@@UD2DVector2@@@CompositionPropertySet@Composition@UI@Windows@@AEAA?AW4CompositionGetValueStatus@123@PEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DVector2@@@Z @ 0x18014856C
 * Callers:
 *     ?TryGetVector2@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@PEAUVector2@Numerics@Foundation@5@PEAW4CompositionGetValueStatus@345@@Z @ 0x1801497C0 (-TryGetVector2@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@PEAUVector.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::TryGetProperty<PropertySetVector2Value,D2DVector2>(
  ...
  if ( Windows::UI::Composition::CompositionPropertySet::GetPropertyIdFromName(a1, a2, &v17) )
  {
    ...
    if ( *(_DWORD *)(*v9 + 8 * v7) == 35 )
    {
      ...
      if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(
                               ...
                               v10) )
        ModuleFailFastForHRESULT(-2147024809, retaddr);
      *a4 = *(_QWORD *)((*(_DWORD *)(v14 + 8 * v12 + 4) & 0x1FFFFFFF) + *(_QWORD *)(v13 + 32));
    }
    else
    {
      return 1;
