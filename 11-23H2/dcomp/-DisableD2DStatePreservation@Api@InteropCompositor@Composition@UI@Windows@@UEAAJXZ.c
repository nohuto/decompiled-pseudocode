/*
 * XREFs of ?DisableD2DStatePreservation@Api@InteropCompositor@Composition@UI@Windows@@UEAAJXZ @ 0x18008C230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InteropCompositor::Api::DisableD2DStatePreservation(
        Windows::UI::Composition::InteropCompositor::Api *this)
{
  ...
  if ( (v1->SpinCount & 2) != 0 )
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      DoStackCaptureDirect(v4, 0x415u);
    else
      v5 = 0;
  }
  else
