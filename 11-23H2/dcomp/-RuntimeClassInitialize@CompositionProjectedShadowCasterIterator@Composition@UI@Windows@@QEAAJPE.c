/*
 * XREFs of ?RuntimeClassInitialize@CompositionProjectedShadowCasterIterator@Composition@UI@Windows@@QEAAJPEAVCompositionProjectedShadow@234@@Z @ 0x18018B460
 * Callers:
 *     ??$MakeAndInitialize2@VCompositionProjectedShadowCasterIterator@Composition@UI@Windows@@V1234@PEAVCompositionProjectedShadow@234@@Details@WRL2@Microsoft@@YAJPEAPEAVCompositionProjectedShadowCasterIterator@Composition@UI@Windows@@$$QEAPEAVCompositionProjectedShadow@456@@Z @ 0x18012FE78 (--$MakeAndInitialize2@VCompositionProjectedShadowCasterIterator@Composition@UI@Windows@@V1234@PE.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowCasterIterator::RuntimeClassInitialize(
        ...
        struct Microsoft::WRL2::ContextSession **a2)
{
  ...
  else
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x30,
      (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtcompositionprojectedshadowcasteriterator.cpp",
