/*
 * XREFs of ??$InsertProperty@UPropertySetVector3Value@@UD2DVector3@@@CompositionPropertySet@Composition@UI@Windows@@AEAAJPEAUHSTRING__@@W4DCOMPOSITION_EXPRESSION_TYPE@@_NPEBUD2DVector3@@@Z @ 0x180004A7C
 * Callers:
 *     ?InsertVector3@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UVector3@Numerics@Foundation@5@@Z @ 0x180008A10 (-InsertVector3@Api@CompositionPropertySet@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UVector3@N.c)
 ...
 *     ??$CreatePropertySetValue@UPropertySetVector3Value@@UD2DVector3@@@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAA?AUPropertySetVector3Value@@IPEBUD2DVector3@@@Z @ 0x180004D94 (--$CreatePropertySetValue@UPropertySetVector3Value@@UD2DVector3@@@-$PropertySetStorage@VDynArray.c)
...
__int64 __fastcall Windows::UI::Composition::CompositionPropertySet::InsertProperty<PropertySetVector3Value,D2DVector3>(
...
LABEL_5:
    ...
    PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::CreatePropertySetValue<PropertySetVector3Value,D2DVector3>(
      v10,
      v25,
      (unsigned int)v8,
      a5);
    ...
    v22 = v8;
    v21 = StringRawBuffer;
    Windows::UI::Composition::ProxyObject::SetAnimatablePropertyWorker<Windows::UI::Composition::PropertySetUpdater<PropertySetVector3Value,D2DVector3>,Windows::UI::Composition::PropertySetUpdaterInfo>(this);
    return 0LL;
  }
  ...
  v18 = Windows::UI::Composition::CompositionPropertySet::AddProperty<PropertySetVector3Value,D2DVector3>(
          this,
          a2,
          v17,
          a5);
