/*
 * XREFs of ?CreateCompositionSurfaceForHandle@SystemOnly@Compositor@Composition@UI@Windows@@UEAAJPEAXPEAPEAUICompositionSurface@345@@Z @ 0x18010ECB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Compositor::SystemOnly::CreateCompositionSurfaceForHandle(
        ...
        struct Windows::UI::Composition::ICompositionSurface **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (*((_BYTE *)v3 + 32) & 2) != 0 )
  {
    ...
    v7 = Windows::UI::Composition::CompositorCommon::CreateCompositionSurfaceForHandle(v3, a2, &v10);
    v6 = v7;
    if ( v7 < 0 )
    {
      DoStackCaptureDirect(v7, 0x859u);
    }
    else
    {
      v8 = v10;
