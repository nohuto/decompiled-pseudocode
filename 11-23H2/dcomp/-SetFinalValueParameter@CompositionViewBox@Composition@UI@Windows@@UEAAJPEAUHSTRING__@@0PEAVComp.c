/*
 * XREFs of ?SetFinalValueParameter@CompositionViewBox@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@0PEAVCompositionAnimation@234@@Z @ 0x180179720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionViewBox::SetFinalValueParameter(
        ...
        struct Windows::UI::Composition::CompositionAnimation *a4)
{
  ...
  v11[0] = 4LL;
  v11[1] = &Windows::UI::Composition::CompositionViewBox::k_rgAnimDef;
