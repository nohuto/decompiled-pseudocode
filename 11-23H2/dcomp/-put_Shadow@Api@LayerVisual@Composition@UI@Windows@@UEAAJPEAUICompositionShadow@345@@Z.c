/*
 * XREFs of ?put_Shadow@Api@LayerVisual@Composition@UI@Windows@@UEAAJPEAUICompositionShadow@345@@Z @ 0x180086490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::LayerVisual::Api::put_Shadow(
        ...
        struct IUnknown *a2)
{
  ...
  v2 = (Windows::UI::Composition::LayerVisual::Api *)((char *)this - 320);
  ...
  if ( v5 < 0 )
  {
    DoStackCaptureDirect(v5, 0x111u);
    v8 = v9;
    if ( !v9 )
      goto LABEL_4;
    goto LABEL_6;
  }
  Windows::UI::Composition::LayerVisual::SetShadow(v2, v9);
  v6 = 0;
  if ( v9 )
  {
    v8 = v9;
