/*
 * XREFs of ?put_RotationAngleInDegrees@Partner@CaptureController@Internal@Composition@UI@Windows@@UEAAJM@Z @ 0x180180130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::CaptureController::Partner::put_RotationAngleInDegrees(
