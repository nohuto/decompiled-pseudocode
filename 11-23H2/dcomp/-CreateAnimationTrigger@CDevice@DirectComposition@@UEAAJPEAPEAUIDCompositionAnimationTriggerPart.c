/*
 * XREFs of ?CreateAnimationTrigger@CDevice@DirectComposition@@UEAAJPEAPEAUIDCompositionAnimationTriggerPartner@@@Z @ 0x1800EE940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CDevice::CreateAnimationTrigger(
        DirectComposition::CDevice *this,
        struct IDCompositionAnimationTriggerPartner **a2)
{
  __int64 result; // rax
  struct IDCompositionAnimationTriggerPartner *v4; // rdx
  ...
  {
    v4 = (struct IDCompositionAnimationTriggerPartner *)v6;
    *((_DWORD *)v6 + 3) = v5;
    *(_QWORD *)v4 = &DirectComposition::CLegacyAnimationTrigger::`vftable';
    *((_DWORD *)v4 + 2) = 1;
    *a2 = v4;
  }
  return result;
