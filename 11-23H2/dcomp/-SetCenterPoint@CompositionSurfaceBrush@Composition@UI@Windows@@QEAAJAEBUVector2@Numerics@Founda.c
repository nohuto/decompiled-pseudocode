/*
 * XREFs of ?SetCenterPoint@CompositionSurfaceBrush@Composition@UI@Windows@@QEAAJAEBUVector2@Numerics@Foundation@4@@Z @ 0x180159948
 * Callers:
 *     ?put_CenterPoint@Api@?$CompositionSurfaceBrushT@VCompositionSurfaceBrush@Composition@UI@Windows@@VCompositionBrush@234@@Composition@UI@Windows@@UEAAJUVector2@Numerics@Foundation@5@@Z @ 0x18012C0B0 (-put_CenterPoint@Api@-$CompositionSurfaceBrushT@VCompositionSurfaceBrush@Composition@UI@Windows@.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionSurfaceBrush::SetCenterPoint(
        __int64 **this,
