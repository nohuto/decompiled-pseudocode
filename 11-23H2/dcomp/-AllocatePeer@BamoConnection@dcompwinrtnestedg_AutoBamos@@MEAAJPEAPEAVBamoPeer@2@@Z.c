/*
 * XREFs of ?AllocatePeer@BamoConnection@dcompwinrtnestedg_AutoBamos@@MEAAJPEAPEAVBamoPeer@2@@Z @ 0x18016B330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall dcompwinrtnestedg_AutoBamos::BamoConnection::AllocatePeer(
        ...
        struct dcompwinrtnestedg_AutoBamos::BamoPeer **a2)
{
  ...
  *(_QWORD *)v3 = &dcompwinrtnestedg_AutoBamos::BamoPeer::`vftable';
  v3[4] = 1;
  *((_QWORD *)v3 + 4) = 0LL;
  *((_QWORD *)v3 + 3) = v3;
  *((_QWORD *)v3 + 5) = 0LL;
  ...
  *((_QWORD *)v3 + 11) = 0LL;
  *((_QWORD *)v3 + 12) = 0LL;
  *((_QWORD *)v3 + 1) = &BamoImpl::dcompwinrtnestedg_AutoBamos::BamoPeerImpl::`vftable';
  *a2 = (struct dcompwinrtnestedg_AutoBamos::BamoPeer *)v3;
  return 0LL;
}
