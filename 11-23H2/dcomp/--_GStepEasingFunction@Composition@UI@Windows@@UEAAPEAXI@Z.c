/*
 * XREFs of ??_GStepEasingFunction@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180060D60
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::StepEasingFunction::`scalar deleting destructor'(void **this, char a2)
{
  __int64 v4; // rdx
