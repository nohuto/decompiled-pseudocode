/*
 * XREFs of ??$MakeAndInitialize2@VCompositor@Composition@UI@Windows@@V1234@$$T$$T$$T$$TW4CreationFlags@CompositorCommon@234@@Details@WRL2@Microsoft@@YAJPEAPEAVCompositor@Composition@UI@Windows@@$$QEA$$T111$$QEAW4CreationFlags@CompositorCommon@456@@Z @ 0x18003E174
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::Compositor,Windows::UI::Composition::Compositor,std::nullptr_t,std::nullptr_t,std::nullptr_t,std::nullptr_t,enum Windows::UI::Composition::CompositorCommon::CreationFlags>(
        ...
        int *a6)
{
  ...
  Microsoft::WRL2::NestableRuntimeClass *v16; // [rsp+70h] [rbp+8h] BYREF
...
LABEL_8:
  ...
  v12 = v16;
  v15 = 0LL;
  *((_QWORD *)v16 + 1) = &Windows::UI::Composition::Compositor::s_InterfaceType;
