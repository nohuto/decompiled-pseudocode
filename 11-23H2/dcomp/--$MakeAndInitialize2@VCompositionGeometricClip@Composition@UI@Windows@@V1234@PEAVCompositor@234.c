/*
 * XREFs of ??$MakeAndInitialize2@VCompositionGeometricClip@Composition@UI@Windows@@V1234@PEAVCompositor@234@@Details@WRL2@Microsoft@@YAJPEAPEAVCompositionGeometricClip@Composition@UI@Windows@@$$QEAPEAVCompositor@456@@Z @ 0x180087AA4
 * Callers:
...
__int64 __fastcall Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::CompositionGeometricClip,Windows::UI::Composition::CompositionGeometricClip,Windows::UI::Composition::Compositor *>(
        Windows::UI::Composition::ProxyObject **a1,
        struct Windows::UI::Composition::Compositor **a2)
{
  void *v4; // rax
  Windows::UI::Composition::CompositionClip *v5; // rax
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    v5 = (Windows::UI::Composition::CompositionClip *)memset_0(v4, 0, 0xC8uLL);
    v6 = v5;
    if ( v5 )
    {
      Windows::UI::Composition::CompositionClip::CompositionClip(v5);
      *(_QWORD *)v6 = &Windows::UI::Composition::CompositionGeometricClip::`vftable';
      *((_QWORD *)v6 + 23) = 0LL;
      *((_QWORD *)v6 + 24) = 0LL;
      *((_QWORD *)v6 + 21) = &Windows::UI::Composition::CompositionGeometricClip::Api::`vftable';
    }
    else
    {
      v6 = 0LL;
    ...
    v12 = 0LL;
    *((_QWORD *)v6 + 1) = &Windows::UI::Composition::CompositionGeometricClip::s_InterfaceType;
    v7 = *a2;
    v13 = v6;
    v8 = Windows::UI::Composition::ProxyObject::RuntimeClassInitialize(v6, v7, 136, 0);
    v9 = v8;
    if ( v8 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
        retaddr,
        (void *)0x32,
        (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\wrtcompositiongeometricclip.cpp",
