/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@PEAVCDirtyListener@DirectComposition@@$0A@@@QEAAJPEFBQEAVCDirtyListener@DirectComposition@@I@Z @ 0x18007304C
 * Callers:
...
__int64 __fastcall DynArray<DirectComposition::CDirtyListener *,0>::AddMultipleAndSet(__int64 a1, _QWORD *a2)
{
  unsigned int v2; // eax
  unsigned int v3; // r9d
  unsigned int v4; // ebx
