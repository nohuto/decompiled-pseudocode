/*
 * XREFs of ?CalcAverageAppDeliveryLatency@CTouchFrameStats@@IEBAMXZ @ 0x1801A6E54
 * Callers:
...
float __fastcall CTouchFrameStats::CalcAverageAppDeliveryLatency(CTouchFrameStats::CInteractionInfo **this)
{
  ...
  if ( v6 != v7 )
  {
    ...
    do
    {
      if ( v6 != v9 )
      {
        v11 = (float)(int)CTouchFrameStats::CInteractionInfo::AppDeliveryUs(v6, v2);
        v18 = v11;
        if ( v10 == v5 )
        {
