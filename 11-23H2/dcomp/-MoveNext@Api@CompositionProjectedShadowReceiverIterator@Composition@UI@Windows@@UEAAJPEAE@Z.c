/*
 * XREFs of ?MoveNext@Api@CompositionProjectedShadowReceiverIterator@Composition@UI@Windows@@UEAAJPEAE@Z @ 0x1801A35F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowReceiverIterator::Api::MoveNext(
        ...
        bool *a2)
{
  ...
  *a2 = 0;
  ...
  if ( (*((_BYTE *)this - 8) & 2) != 0 )
  {
    if ( Windows::UI::Composition::CompositionProjectedShadow::GetReceiverAtIndex(
           ...
           *((_DWORD *)this + 4)) )
    {
      ...
      v8 = v6 + 1;
      *((_DWORD *)this + 4) = v8;
      *a2 = Windows::UI::Composition::CompositionProjectedShadow::GetReceiverAtIndex(v7, v8) != 0LL;
    }
  }
  else
  {
