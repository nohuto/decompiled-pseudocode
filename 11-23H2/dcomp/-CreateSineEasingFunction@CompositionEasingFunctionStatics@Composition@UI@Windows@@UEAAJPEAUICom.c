/*
 * XREFs of ?CreateSineEasingFunction@CompositionEasingFunctionStatics@Composition@UI@Windows@@UEAAJPEAUICompositor@234@W4CompositionEasingFunctionMode@234@PEAPEAUISineEasingFunction@234@@Z @ 0x18012EFF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionEasingFunctionStatics::CreateSineEasingFunction(
        __int64 a1,
        struct IUnknown *a2,
        unsigned int a3,
        unsigned __int64 *a4)
...
LABEL_6:
  ...
  if ( v7 < 0 )
  {
    DoStackCaptureDirect(v7, 0x1C0u);
  }
  else
  {
    v11[0] = v14;
    v9 = Microsoft::WRL2::Details::MakeAndInitialize2<Windows::UI::Composition::SineEasingFunction,Windows::UI::Composition::SineEasingFunction,Windows::UI::Composition::Compositor *,enum Windows::UI::Composition::CompositionEasingFunctionMode &>(
           &v12,
           v11,
           &v13);
    v7 = v9;
    if ( v9 < 0 )
    {
      DoStackCaptureDirect(v9, 0x1C5u);
      v4 = v12;
    }
    else
    {
