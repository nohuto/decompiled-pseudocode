/*
 * XREFs of ?UpdateCasters@CompositionProjectedShadow@Composition@UI@Windows@@QEAAJXZ @ 0x18000745C
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadow::UpdateCasters(
        Windows::UI::Composition::CompositionProjectedShadow *this)
{
  ...
  v1 = *((_QWORD *)this + 25) - *((_QWORD *)this + 24);
  LODWORD(v21) = 0;
...
LABEL_17:
  ...
  if ( (_DWORD)v3 )
  {
    ...
    while ( 1 )
    {
      v10 = *(_DWORD *)(*(_QWORD *)(v9 + *((_QWORD *)this + 24)) + 128LL);
      v16 = v10;
      if ( v6 + 1 < v6 )
        break;
      if ( v6 + 1 > v20 )
