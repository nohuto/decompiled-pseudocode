/*
 * XREFs of ?OnDisconnectedThunk@BamoCompObjectDiagnosticsRootStubImpl@BamoImpl@@UEAAJXZ @ 0x18019F130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoCompObjectDiagnosticsRootStubImpl::OnDisconnectedThunk(
