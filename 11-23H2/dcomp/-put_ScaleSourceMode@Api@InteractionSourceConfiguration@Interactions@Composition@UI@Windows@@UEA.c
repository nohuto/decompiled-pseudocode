/*
 * XREFs of ?put_ScaleSourceMode@Api@InteractionSourceConfiguration@Interactions@Composition@UI@Windows@@UEAAJW4InteractionSourceRedirectionMode@3456@@Z @ 0x180162220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionSourceConfiguration::Api::put_ScaleSourceMode(
        __int64 a1,
        int a2)
{
  ...
  if ( (*(_BYTE *)(a1 - 96) & 2) != 0 )
  {
    ...
    *(_DWORD *)(a1 + 32) = a2;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x128u);
    else
      v5 = 0;
  }
  else
