/*
 * XREFs of ?SetOcclusionStrength@ScenePbrMaterial@Scenes@Composition@UI@Windows@@QEAAJM@Z @ 0x18019195C
 * Callers:
 *     ?put_OcclusionStrength@Api@ScenePbrMaterial@Scenes@Composition@UI@Windows@@UEAAJM@Z @ 0x180192610 (-put_OcclusionStrength@Api@ScenePbrMaterial@Scenes@Composition@UI@Windows@@UEAAJM@Z.c)
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Scenes::ScenePbrMaterial::SetOcclusionStrength(
        ...
        float a2)
{
  ...
  v5[1] = &v8;
  v5[2] = &v8;
  v7 = (void **)&Windows::UI::Composition::Scenes::ScenePbrMaterial::sc_OcclusionStrength;
