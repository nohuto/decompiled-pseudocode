/*
 * XREFs of ?put_RotationAngleInDegrees@Partner@SharedWriteCaptureController@Internal@Composition@UI@Windows@@UEAAJM@Z @ 0x180182BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Internal::SharedWriteCaptureController::Partner::put_RotationAngleInDegrees(
        ...
        float a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v5 = Windows::UI::Composition::Internal::CaptureControllerBase::SetRotationAngleInDegrees(v2, a2);
    v4 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0x12Cu);
    else
      v4 = 0;
  }
  else
