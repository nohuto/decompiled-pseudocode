/*
 * XREFs of ??_GCompositionShapeCollection@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18000F6C0
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::CompositionShapeCollection *__fastcall Windows::UI::Composition::CompositionShapeCollection::`scalar deleting destructor'(
        ...
        char a2)
{
  ...
  CSparseStorage::~CSparseStorage((Windows::UI::Composition::CompositionShapeCollection *)((char *)this + 112));
