/*
 * XREFs of ?RuntimeClassInitialize@?$GlobalDesktopWindowTargetImpl@VInteropCompositionTarget@Composition@UI@Windows@@@Desktop@Composition@UI@Windows@@QEAAJPEAVCompositor@345@PEAUHWND__@@W4_HwndTargetType@@@Z @ 0x18008534C
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::Desktop::GlobalDesktopWindowTargetImpl<Windows::UI::Composition::InteropCompositionTarget>::RuntimeClassInitialize(
...
LABEL_3:
  ...
  Microsoft::WRL::ComPtr<DirectComposition::IHwndTarget>::operator=((char *)this + 232, v11[0]);
  v8 = 0;
  *((_BYTE *)this + 208) = a4 == 1;
LABEL_5:
