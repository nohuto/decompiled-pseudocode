/*
 * XREFs of ?GetPresentStatisticsAvailableEvent@CPresentationManager@@UEAAJPEAPEAX@Z @ 0x1801ADB60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPresentationManager::GetPresentStatisticsAvailableEvent(CPresentationManager *this, void **a2)
{
  signed int v4; // ebp
  ...
  if ( !DuplicateHandle(v8, v6, v7, a2, 0, 0, 2u) )
  {
    ...
    if ( v4 >= 0 )
      v4 = -2003304445;
    DoStackCaptureDirect(v4, 0x1CCu);
  }
