/*
 * XREFs of ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@U?$IVectorView@PEAVCompositionShape@Composition@UI@Windows@@@Collections@Foundation@Windows@@U?$IIterable@PEAVCompositionShape@Composition@UI@Windows@@@567@@Details@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B1580
 * Callers:
 *     <none>
 * Callees:
 *     <none>
