/*
 * XREFs of ?put_BlurRadius@Api@DropShadow@Composition@UI@Windows@@UEAAJM@Z @ 0x18008C2E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::DropShadow::Api::put_BlurRadius(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::DropShadow::sc_BlurRadius;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x154u);
    else
      v5 = 0;
  }
  else
