/*
 * XREFs of ?DoStackCapture@@YAXJIPEAX@Z @ 0x18000B060
 * Callers:
 ...
 * Callees:
 *     ?MilWerRegisterMemoryBlock@@YAXPEBXI@Z @ 0x18000B1DC (-MilWerRegisterMemoryBlock@@YAXPEBXI@Z.c)
...
void __fastcall DoStackCapture(int a1, int a2, PVOID a3)
{
  ...
  if ( !_InterlockedCompareExchange(&dword_18021D050, 1, 0) )
  {
