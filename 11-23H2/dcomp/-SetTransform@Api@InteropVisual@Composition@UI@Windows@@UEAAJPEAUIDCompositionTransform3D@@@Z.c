/*
 * XREFs of ?SetTransform@Api@InteropVisual@Composition@UI@Windows@@UEAAJPEAUIDCompositionTransform3D@@@Z @ 0x1800B7B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::InteropVisual::Api::SetTransform(
        ...
        struct IDCompositionTransform3D *a2)
{
  ...
  if ( (*((_BYTE *)this - 264) & 2) != 0 )
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      DoStackCaptureDirect(v6, 0x1DCu);
    else
      v5 = 0;
  }
  else
