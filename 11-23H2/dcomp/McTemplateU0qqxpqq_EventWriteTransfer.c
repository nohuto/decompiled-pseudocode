/*
 * XREFs of McTemplateU0qqxpqq_EventWriteTransfer @ 0x1800F70F0
 * Callers:
...
ULONG __fastcall McTemplateU0qqxpqq_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  v19 = 4LL;
  v21 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, (const EVENT_DESCRIPTOR *)"9", a3, 7u, &v9);
}
