/*
 * XREFs of ?get_AlphaMode@Api@CompositionTexture@Composition@UI@Windows@@UEAAJPEAW4DirectXAlphaMode@DirectX@Graphics@5@@Z @ 0x1800A38C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionTexture::Api::get_AlphaMode(
        Windows::UI::Composition::CompositionTexture::Api *this,
        enum Windows::Graphics::DirectX::DirectXAlphaMode *a2)
{
  ...
  if ( (*((_BYTE *)this - 96) & 2) != 0 )
  {
    ...
    (***(void (__fastcall ****)(_QWORD, GUID *, __int64 *))(v6 + 32))(
      *(_QWORD *)(v6 + 32),
      ...
      &v9);
    v7 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v9 + 40LL))(v9);
