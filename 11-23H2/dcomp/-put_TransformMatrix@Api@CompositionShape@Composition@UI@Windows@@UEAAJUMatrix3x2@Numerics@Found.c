/*
 * XREFs of ?put_TransformMatrix@Api@CompositionShape@Composition@UI@Windows@@UEAAJUMatrix3x2@Numerics@Foundation@5@@Z @ 0x18005C1D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionShape::Api::put_TransformMatrix(
        __int64 a1,
        const struct Windows::Foundation::Numerics::Matrix3x2 *a2)
{
  ...
  if ( (*((_BYTE *)v2 + 32) & 2) != 0 )
  {
    v5 = Windows::UI::Composition::CompositionShape::SetTransformMatrix(v2, a2);
    v6 = v5;
    if ( v5 < 0 )
      DoStackCaptureDirect(v5, 0xC6u);
    else
      v6 = 0;
  }
  else
