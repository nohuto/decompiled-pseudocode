/*
 * XREFs of ?SetProperties@BounceVector3NaturalMotionAnimation@Composition@UI@Windows@@UEAAJPEAVNaturalMotionAnimator@234@@Z @ 0x180129BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::BounceVector3NaturalMotionAnimation::SetProperties(
        ...
        struct Windows::UI::Composition::NaturalMotionAnimator *a2)
{
  ...
  if ( v4 >= 0 )
  {
    Windows::UI::Composition::Bounce::SetProperties(
      (Windows::UI::Composition::BounceVector3NaturalMotionAnimation *)((char *)this + 464),
      a2);
    return 0LL;
  }
  else
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x20,
      (int)"onecoreuap\\windows\\dwm\\dcomp\\winrtnested\\WrtBounceVector3NaturalMotionAnimation.h",
