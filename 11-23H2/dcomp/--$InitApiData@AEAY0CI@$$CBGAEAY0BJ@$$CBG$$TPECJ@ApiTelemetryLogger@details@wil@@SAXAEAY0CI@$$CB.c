/*
 * XREFs of ??$InitApiData@AEAY0CI@$$CBGAEAY0BJ@$$CBG$$TPECJ@ApiTelemetryLogger@details@wil@@SAXAEAY0CI@$$CBGAEAY0BJ@$$CBG$$QEA$$T$$QEAPECJ@Z @ 0x1800A30C4
 * Callers:
...
void __fastcall wil::details::ApiTelemetryLogger::InitApiData<unsigned short const (&)[40],unsigned short const (&)[25],std::nullptr_t,long volatile *>(
        __int64 a1,
        __int64 a2,
        const char **a3,
        volatile int **a4)
