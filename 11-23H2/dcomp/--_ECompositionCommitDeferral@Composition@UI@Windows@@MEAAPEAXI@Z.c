/*
 * XREFs of ??_ECompositionCommitDeferral@Composition@UI@Windows@@MEAAPEAXI@Z @ 0x1801236B0
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::CompositionCommitDeferral::`vector deleting destructor'(
        void **this,
        char a2)
{
  __int64 v4; // rdx

  *this = &Windows::UI::Composition::CompositionCommitDeferral::`vftable';
