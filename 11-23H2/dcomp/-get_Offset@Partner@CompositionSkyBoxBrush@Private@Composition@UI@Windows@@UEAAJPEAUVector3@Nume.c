/*
 * XREFs of ?get_Offset@Partner@CompositionSkyBoxBrush@Private@Composition@UI@Windows@@UEAAJPEAUVector3@Numerics@Foundation@6@@Z @ 0x180181670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Private::CompositionSkyBoxBrush::Partner::get_Offset(
