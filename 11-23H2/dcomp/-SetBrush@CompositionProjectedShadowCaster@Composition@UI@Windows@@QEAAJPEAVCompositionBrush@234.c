/*
 * XREFs of ?SetBrush@CompositionProjectedShadowCaster@Composition@UI@Windows@@QEAAJPEAVCompositionBrush@234@@Z @ 0x18000D584
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowCaster::SetBrush(
...
LABEL_12:
  ...
  wil::details::in1diag3::Return_HrMsg(
    ...
    (const char *)0x80070057LL,
    (int)"This type of caster cannot write to the brush property.",
    v9);
  return 2147942487LL;
}
