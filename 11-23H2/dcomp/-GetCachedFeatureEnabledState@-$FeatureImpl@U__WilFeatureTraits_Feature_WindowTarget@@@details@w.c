/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_WindowTarget@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800FFAA4
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_WindowTarget>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_WindowTarget>::GetCurrentFeatureEnabledState(a1, &v14, &i);
    v6 = *a2;
    v7 = v5 != 0 ? i : 0;
    for ( i = v7; ; v7 = i )
    {
    ...
    if ( (v6 & 4) == 0 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_18021CE14
        || (v11 = 0, v12 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_18021CE48, &v11, 0x10uLL)) )
      {
