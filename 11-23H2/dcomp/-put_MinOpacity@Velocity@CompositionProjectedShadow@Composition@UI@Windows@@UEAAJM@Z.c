/*
 * XREFs of ?put_MinOpacity@Velocity@CompositionProjectedShadow@Composition@UI@Windows@@UEAAJM@Z @ 0x1800110F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadow::Velocity::put_MinOpacity(
        ...
        float a2)
{
  ...
  if ( (v2[32] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = &Windows::UI::Composition::CompositionProjectedShadow::sc_MinOpacity;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x2BDu);
    else
      v5 = 0;
  }
  else
