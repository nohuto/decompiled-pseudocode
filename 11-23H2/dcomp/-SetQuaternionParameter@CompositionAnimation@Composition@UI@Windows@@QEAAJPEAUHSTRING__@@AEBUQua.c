/*
 * XREFs of ?SetQuaternionParameter@CompositionAnimation@Composition@UI@Windows@@QEAAJPEAUHSTRING__@@AEBUQuaternion@Numerics@Foundation@4@@Z @ 0x18014FA88
 * Callers:
 ...
 *     ?SetQuaternionParameter@Api@CompositionAnimation@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UQuaternion@Numerics@Foundation@5@@Z @ 0x18014F9F0 (-SetQuaternionParameter@Api@CompositionAnimation@Composition@UI@Windows@@UEAAJPEAUHSTRING__@@UQu.c)
...
__int64 __fastcall Windows::UI::Composition::CompositionAnimation::SetQuaternionParameter(
