/*
 * XREFs of ?InsertBelow@Api@CompositionProjectedShadowCasterCollection@Composition@UI@Windows@@UEAAJPEAUICompositionProjectedShadowCaster@345@0@Z @ 0x180130340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowCasterCollection::Api::InsertBelow(
...
LABEL_19:
    ...
    if ( v11 < 0 )
    {
      DoStackCaptureDirect(v11, 0xB6u);
      goto LABEL_17;
    }
    v17 = 0LL;
    ...
    {
      inserted = Windows::UI::Composition::CompositionProjectedShadow::InsertCaster(v3[19], v12, 0, v17);
      v7 = inserted;
      if ( inserted >= 0 )
      {
        v7 = 0;
