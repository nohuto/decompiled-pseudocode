/*
 * XREFs of ?ValidateNot@ExpressionAnimationBuilder@Composition@UI@Windows@@AEAAJPEAIPEAW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801666A4
 * Callers:
...
__int64 __fastcall Windows::UI::Composition::ExpressionAnimationBuilder::ValidateNot(
        ...
        enum DCOMPOSITION_EXPRESSION_TYPE *a3)
{
  ...
  *a2 = 1;
  if ( v3 )
  {
    if ( *((_DWORD *)this + (unsigned int)(v3 - 1) + 66) == 17 )
    {
      *(_DWORD *)a3 = 17;
      return 0;
    }
