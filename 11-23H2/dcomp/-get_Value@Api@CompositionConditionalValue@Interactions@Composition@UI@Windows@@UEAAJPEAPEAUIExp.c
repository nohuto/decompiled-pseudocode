/*
 * XREFs of ?get_Value@Api@CompositionConditionalValue@Interactions@Composition@UI@Windows@@UEAAJPEAPEAUIExpressionAnimation@456@@Z @ 0x18012D340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::CompositionConditionalValue::Api::get_Value(
