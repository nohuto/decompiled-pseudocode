/*
 * XREFs of ?SetAlphaMode@CPresentationSurface@@UEAAJW4DXGI_ALPHA_MODE@@@Z @ 0x1801B0530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPresentationSurface::SetAlphaMode(CPresentationSurface *this, enum DXGI_ALPHA_MODE a2)
{
