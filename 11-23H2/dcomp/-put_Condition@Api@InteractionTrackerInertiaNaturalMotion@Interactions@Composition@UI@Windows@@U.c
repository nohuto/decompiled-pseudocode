/*
 * XREFs of ?put_Condition@Api@InteractionTrackerInertiaNaturalMotion@Interactions@Composition@UI@Windows@@UEAAJPEAUIExpressionAnimation@456@@Z @ 0x18013E450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Interactions::InteractionTrackerInertiaNaturalMotion::Api::put_Condition(
        ...
        struct IUnknown *a2)
{
  ...
  if ( (*((_BYTE *)this - 136) & 2) != 0 )
  {
    ...
    {
      v5 = -2147024809;
      DoStackCaptureDirect(-2147024809, 0x41u);
    }
  }
  else
  {
