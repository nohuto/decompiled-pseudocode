/*
 * XREFs of ?get_CenterPoint@Api@CompositionShape@Composition@UI@Windows@@UEAAJPEAUVector2@Numerics@Foundation@5@@Z @ 0x180189B20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionShape::Api::get_CenterPoint(
