/*
 * XREFs of ?get_AncestorClip@Velocity@CompositionProjectedShadowCaster@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x180183ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionProjectedShadowCaster::Velocity::get_AncestorClip(
