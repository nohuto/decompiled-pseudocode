/*
 * XREFs of ?get_CoordinateSpace@Api@PointLight@Composition@UI@Windows@@UEAAJPEAPEAUIVisual@345@@Z @ 0x18017A930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::PointLight::Api::get_CoordinateSpace(
