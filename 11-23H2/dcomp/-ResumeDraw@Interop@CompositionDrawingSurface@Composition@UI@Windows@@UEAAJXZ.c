/*
 * XREFs of ?ResumeDraw@Interop@CompositionDrawingSurface@Composition@UI@Windows@@UEAAJXZ @ 0x180065A30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionDrawingSurface::Interop::ResumeDraw(
        Windows::UI::Composition::CompositionDrawingSurface::Interop *this)
{
  ...
  if ( (*((_BYTE *)v1 + 32) & 2) != 0 )
  {
    ...
    v4 = v3;
    if ( v3 < 0 )
      DoStackCaptureDirect(v3, 0x2E2u);
    else
      v4 = 0;
  }
  else
