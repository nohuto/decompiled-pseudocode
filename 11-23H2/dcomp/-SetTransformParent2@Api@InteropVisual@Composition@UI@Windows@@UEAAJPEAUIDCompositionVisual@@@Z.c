/*
 * XREFs of ?SetTransformParent2@Api@InteropVisual@Composition@UI@Windows@@UEAAJPEAUIDCompositionVisual@@@Z @ 0x180062500
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IUnknown *a2)
{
  ...
  v10 = 0LL;
  Microsoft::WRL2::RefPtr<Windows::UI::Composition::CompositionObject>::InternalUnlock(&v10);
  ...
  if ( v10 )
    ...
    v7 = 0LL;
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 2) + 400LL))(*((_QWORD *)this + 2), v7);
  v6 = v5;
  if ( v5 < 0 )
  {
    v9 = 681;
LABEL_13:
    DoStackCaptureDirect(v5, v9);
    goto LABEL_7;
  }
  v6 = 0;
LABEL_7:
