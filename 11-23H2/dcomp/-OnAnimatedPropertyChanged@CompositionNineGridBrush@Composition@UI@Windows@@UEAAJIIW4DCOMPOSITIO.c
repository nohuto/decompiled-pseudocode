/*
 * XREFs of ?OnAnimatedPropertyChanged@CompositionNineGridBrush@Composition@UI@Windows@@UEAAJIIW4DCOMPOSITION_EXPRESSION_TYPE@@_N1PEBXG@Z @ 0x180168DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionNineGridBrush::OnAnimatedPropertyChanged(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        __int64 a4,
        ...
        __int16 a8)
{
  ...
  v8 = a4;
  v15[1] = &Windows::UI::Composition::CompositionNineGridBrush::k_rgAnimDef;
  v15[0] = 8LL;
