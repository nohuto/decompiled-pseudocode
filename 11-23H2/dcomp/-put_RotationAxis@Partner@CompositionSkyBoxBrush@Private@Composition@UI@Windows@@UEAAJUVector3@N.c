/*
 * XREFs of ?put_RotationAxis@Partner@CompositionSkyBoxBrush@Private@Composition@UI@Windows@@UEAAJUVector3@Numerics@Foundation@6@@Z @ 0x1801820F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::Private::CompositionSkyBoxBrush::Partner::put_RotationAxis(
        __int64 a1,
        __int64 a2)
{
  ...
  if ( (*(_BYTE *)(a1 - 120) & 2) != 0 )
  {
    ...
    *(_QWORD *)v9 = &Windows::UI::Composition::ComponentTransform3D::sc_RotationAxis;
    ...
    else
    {
      ...
      DoStackCaptureDirect(v5, 0x25Fu);
    }
  }
  else
  {
