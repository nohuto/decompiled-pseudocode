/*
 * XREFs of ?remove_RenderingDeviceReplaced@Api@CompositionGraphicsDevice@Composition@UI@Windows@@UEAAJUEventRegistrationToken@@@Z @ 0x1801577F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::CompositionGraphicsDevice::Api::remove_RenderingDeviceReplaced(
        RTL_SRWLOCK *this,
        struct EventRegistrationToken a2)
{
  ...
  Ptr = (struct _RTL_CRITICAL_SECTION *)this[-14].Ptr;
  Microsoft::WRL2::ContextSession::BeginApiEntry(Ptr);
  if ( ((__int64)this[-13].Ptr & 2) != 0 )
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      DoStackCaptureDirect(v6, 0x325u);
    else
      v5 = 0;
  }
  else
