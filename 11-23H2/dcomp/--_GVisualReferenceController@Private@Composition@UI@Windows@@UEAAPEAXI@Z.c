/*
 * XREFs of ??_GVisualReferenceController@Private@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180124750
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::Private::VisualReferenceController *__fastcall Windows::UI::Composition::Private::VisualReferenceController::`scalar deleting destructor'(
