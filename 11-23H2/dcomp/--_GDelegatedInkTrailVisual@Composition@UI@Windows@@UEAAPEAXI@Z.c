/*
 * XREFs of ??_GDelegatedInkTrailVisual@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x18011B0A0
 * Callers:
 *     <none>
 * Callees:
...
Windows::UI::Composition::DelegatedInkTrailVisual *__fastcall Windows::UI::Composition::DelegatedInkTrailVisual::`scalar deleting destructor'(
        ...
        char a2)
{
  ...
  Microsoft::WRL::ComPtr<DirectComposition::CDelegatedInkTrailImpl>::InternalRelease((__int64 *)this + 39);
