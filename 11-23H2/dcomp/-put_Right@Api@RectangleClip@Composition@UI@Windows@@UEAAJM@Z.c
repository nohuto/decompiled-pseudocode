/*
 * XREFs of ?put_Right@Api@RectangleClip@Composition@UI@Windows@@UEAAJM@Z @ 0x180082A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::UI::Composition::RectangleClip::Api::put_Right(
        ...
        float a2)
{
  ...
  if ( (v2[4] & 2) != 0 )
  {
    ...
    v7[1] = &v8;
    v7[2] = &v8;
    v9 = (void **)&Windows::UI::Composition::RectangleClip::sc_Right;
    ...
    v5 = updated;
    if ( updated < 0 )
      DoStackCaptureDirect(updated, 0x249u);
    else
      v5 = 0;
  }
  else
