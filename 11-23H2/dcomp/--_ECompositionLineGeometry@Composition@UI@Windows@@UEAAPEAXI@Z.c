/*
 * XREFs of ??_ECompositionLineGeometry@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180123A50
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::CompositionLineGeometry::`vector deleting destructor'(void **this, char a2)
{
  __int64 v4; // rdx
