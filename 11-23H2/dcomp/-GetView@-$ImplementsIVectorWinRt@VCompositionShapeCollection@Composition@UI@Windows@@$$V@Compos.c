/*
 * XREFs of ?GetView@?$ImplementsIVectorWinRt@VCompositionShapeCollection@Composition@UI@Windows@@$$V@Composition@UI@Windows@@UEAAJPEAPEAU?$IVectorView@PEAVCompositionShape@Composition@UI@Windows@@@Collections@Foundation@4@@Z @ 0x1801A1080
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$SimpleVectorView@PEAVCompositionShape@Composition@UI@Windows@@U?$IVector@PEAVCompositionShape@Composition@UI@Windows@@@Collections@Foundation@4@U?$DefaultLifetimeTraits@PEAVCompositionShape@Composition@UI@Windows@@@Internal@674@UNoVersionTag@9674@$0A@@Internal@Collections@Foundation@Windows@@QEAA@PEAU?$IVector@PEAVCompositionShape@Composition@UI@Windows@@@234@Upermission@01234@@Z @ 0x1801A0744 (--0-$SimpleVectorView@PEAVCompositionShape@Composition@UI@Windows@@U-$IVector@PEAVCompositionSha.c)
 */

__int64 __fastcall Windows::UI::Composition::ImplementsIVectorWinRt<Windows::UI::Composition::CompositionShapeCollection,>::GetView(
        __int64 a1,
        __int64 *a2)
{
  int v4; // ebx
