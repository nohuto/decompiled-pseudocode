/*
 * XREFs of ??_ECompositionObject@Composition@UI@Windows@@UEAAPEAXI@Z @ 0x180109220
 * Callers:
 *     <none>
 * Callees:
...
void **__fastcall Windows::UI::Composition::CompositionObject::`vector deleting destructor'(void **this, char a2)
{
  __int64 v4; // rdx
