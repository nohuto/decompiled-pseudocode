/*
 * XREFs of ??$MakeAndInitialize@VAnimationControllerFactory@Composition@UI@Windows@@V1234@$$V@Details@WRL@Microsoft@@YAJPEAPEAVAnimationControllerFactory@Composition@UI@Windows@@@Z @ 0x180103E64
 * Callers:
 ...
 *     ??0?$AgileActivationFactory@UIInspectable@@UIAnimationControllerStatics@Composition@UI@Windows@@VNil@Details@WRL@Microsoft@@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x180105094 (--0-$AgileActivationFactory@UIInspectable@@UIAnimationControllerStatics@Composition@UI@Windows@@.c)
 */

__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Windows::UI::Composition::AnimationControllerFactory,Windows::UI::Composition::AnimationControllerFactory,>(
        _QWORD *a1)
{
  void *v2; // rax
  _QWORD *v4; // rax
  ...
  *a1 = 0LL;
  ...
  if ( v2 )
  {
    ...
    if ( v4 )
    {
      Microsoft::WRL::AgileActivationFactory<IInspectable,Windows::UI::Composition::IAnimationControllerStatics,Microsoft::WRL::Details::Nil,0>::AgileActivationFactory<IInspectable,Windows::UI::Composition::IAnimationControllerStatics,Microsoft::WRL::Details::Nil,0>(v4);
      *v5 = &Windows::UI::Composition::AnimationControllerFactory::`vftable'{for `IActivationFactory'};
      v5[1] = &Windows::UI::Composition::AnimationControllerFactory::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,IInspectable>>'};
      v5[5] = &Windows::UI::Composition::AnimationControllerFactory::`vftable'{for `Microsoft::WRL::Details::Selector<Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,IInspectable>,Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::FtmBase>,IInspectable>>'};
      v5[7] = &Windows::UI::Composition::AnimationControllerFactory::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<13>,1,Microsoft::WRL::Details::ImplementsMarker<Microsoft::WRL::Implements<Microsoft::WRL::FtmBase,IInspectable>>,Windows::UI::Composition::IAnimationControllerStatics,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil>'};
