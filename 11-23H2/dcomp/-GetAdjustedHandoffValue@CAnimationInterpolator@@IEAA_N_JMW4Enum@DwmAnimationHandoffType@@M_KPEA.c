/*
 * XREFs of ?GetAdjustedHandoffValue@CAnimationInterpolator@@IEAA_N_JMW4Enum@DwmAnimationHandoffType@@M_KPEAM@Z @ 0x1801B2658
 * Callers:
        ...
        float *a7)
{
  ...
  v7 = (int)a4;
  v9 = a3;
  v11 = CAnimationInterpolator::EnsureHandoffCachedData((CAnimationInterpolator *)a1, a5, a6, a4);
  if ( v11 )
  {
    v12 = v7 - 1;
    if ( v12 )
