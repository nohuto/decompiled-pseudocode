/*
 * XREFs of PepProcessorIdleVeto @ 0x1C000A694
 * Callers:
...
NTSTATUS __fastcall PepProcessorIdleVeto(__int64 a1, __int64 a2)
{
  ...
  if ( !*(_QWORD *)(a1 + 712) || !*(_QWORD *)(a1 + 1152) && !_bittest64((const signed __int64 *)(a1 + 280), 0x2Cu) )
    return -1073741637;
  v3 = *(_DWORD *)(a1 + 56);
  v5 = 72;
  *(_OWORD *)&ProcNumber[0].Group = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    return ((__int64 (__fastcall *)(int *))qword_1C0012818)(&v5);
  }
  return result;
}
