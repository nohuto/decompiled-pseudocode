/*
 * XREFs of WPP_RECORDER_SF_si @ 0x1C000741C
 * Callers:
 *     DisplayGenAddr @ 0x1C002AD84 (DisplayGenAddr.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_si(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, const char *a6, ...)
{
  ...
  if ( !a6 )
    v6 = "NULL";
  LOWORD(v13) = 161;
  return WppAutoLogTrace(a1, 5LL, 2LL, &WPP_8ce74bd36e8a3de55b0fe4d3e246537d_Traceguids, v13, v6);
}
