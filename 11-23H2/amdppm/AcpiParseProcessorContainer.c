/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C002A6A8
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C0029598 (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x1C0003BB8 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C0006768 (RtlUnicodeStringCopyString.c)
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)(a3 + 32) = v16;
      if ( !v16 )
        return -1073741670;
      v17 = 0;
      for ( j = (char *)a1 + (unsigned int)a1[2 * v5 + 7]; v17 < a1[2 * v5 + 6]; v17 = v20 + 1 )
      {
        DevExtByAcpiId = GetDevExtByAcpiId(*(_DWORD *)&j[4 * v17]);
        if ( DevExtByAcpiId )
        {
        ...
        {
          if ( dword_1C0012DBC <= (unsigned int)dword_1C00124D4 )
            return -1073741275;
