/*
 * XREFs of RegisterHvPackage @ 0x1C0025ED0
 * Callers:
 *     <none>
 * Callees:
 *     GetHvProcessorInfo @ 0x1C0005B4C (GetHvProcessorInfo.c)
 *     InitializeHvPhysicalCores @ 0x1C0005B88 (InitializeHvPhysicalCores.c)
