/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C00352F4
 * Callers:
 ...
 *     PepQueryName @ 0x1C0037F34 (PepQueryName.c)
 */
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = a1;
  v2 = dword_1C00124D4;
  if ( byte_1C0012DC0 && dword_1C0012DBC > (unsigned int)dword_1C00124D4 )
    v2 = dword_1C0012DBC;
  v3 = (unsigned int)dword_1C0012B4C;
  if ( !dword_1C0012B4C )
    return 0;
  v5 = (48 * dword_1C0012B4C + 59) & 0xFFFFFFFC;
  Pool2 = (char *)ExAllocatePool2(256LL, v5 + 8 * dword_1C0012B4C * v2, 1919119952LL);
  if ( !Pool2 )
  {
  ...
  if ( v7 )
  {
    ...
    if ( (_DWORD)v3 )
    {
      ...
      while ( 1 )
      {
        ...
        *v7 = v8;
        v7[8] = v2;
        ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, unsigned int *, _QWORD))qword_1C0012858)(
                                     *(_QWORD *)(v1 + 1120),
                                     v7,
                                     0LL);
...
LABEL_24:
      *(_DWORD *)Pool2 = 72;
      *((_DWORD *)Pool2 + 1) = dword_1C0012B4C;
      *((_DWORD *)Pool2 + 2) = dword_1C0012B4C;
      ...
      *((_QWORD *)Pool2 + 4) = PepIdleComplete;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C00127F8)(Pool2);
      if ( ProcessorNumberFromIndex < 0 )
      {
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          goto LABEL_33;
