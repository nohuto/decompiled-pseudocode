/*
 * XREFs of TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x1C0022B10
 * Callers:
...
__int64 TraceLoggingRegisterEx_EtwRegister_EtwSetInformation()
{
  ...
  if ( RegHandle )
    __fastfail(5u);
  xmmword_1C0012120 = 0LL;
  v0 = EtwRegister(&ProviderId, tlgEnableCallback, &dword_1C00120F8, &RegHandle);
  if ( !v0 )
