/*
 * XREFs of memcpy_s @ 0x1C0002C38
 * Callers:
 *     AcpiEval_OSC @ 0x1C0027C70 (AcpiEval_OSC.c)
 *     AcpiEval_PDC @ 0x1C00281FC (AcpiEval_PDC.c)
 * Callees:
 *     AcpiCStateIdleCancel @ 0x1C00021C0 (AcpiCStateIdleCancel.c)
