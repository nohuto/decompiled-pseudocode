/*
 * XREFs of HwDebugCreateRegisterGroup @ 0x1C0038498
 * Callers:
 ...
 *     GetPackageAffinity @ 0x1C0030ED0 (GetPackageAffinity.c)
 *     HwDebugInitializeRegister @ 0x1C00389F8 (HwDebugInitializeRegister.c)
 */
...
__int64 __fastcall HwDebugCreateRegisterGroup(__int64 a1, int a2, __int64 a3, unsigned __int8 *a4, _QWORD *a5, int a6)
{
  ...
  *a5 = 0LL;
  ...
  v18 = (_QWORD **)((char *)&unk_1C00124F8 + 16 * a6);
  v32 = v18;
    ...
    if ( PackageAffinity >= 0 )
    {
      ...
      do
      {
        for ( j = 0LL; (unsigned int)j < *a4; j = (unsigned int)(j + 1) )
        {
          ...
          if ( *(_DWORD *)(v24 + 12) == a2
            && (int)HwDebugInitializeRegister(v24, &v21[24 * (unsigned __int8)v21[308] + 312]) >= 0 )
          {
            v25 = (__int64 *)&v21[24 * (unsigned __int8)v21[308] + 312];
            *v25 = v24;
