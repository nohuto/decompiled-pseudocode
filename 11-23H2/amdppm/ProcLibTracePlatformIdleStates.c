/*
 * XREFs of ProcLibTracePlatformIdleStates @ 0x1C001FA64
 * Callers:
          ...
          do
          {
            *(_QWORD *)&UserData.Size = 4LL;
            ...
            if ( *(_DWORD *)(v12 + 16) )
            {
              ...
              {
                v16 = v15;
                KeGetProcessorNumberFromIndex(*(ULONG *)(*(_QWORD *)(v12 + 40) + 8LL * v15), &ProcNumber);
                v17 = 3LL * v15;
                Pool2[2 * v17] = ProcNumber.Group;
                ++v15;
                LOBYTE(Pool2[2 * v17 + 1]) = ProcNumber.Number;
                HIBYTE(Pool2[2 * v17 + 1]) = *(_BYTE *)(*(_QWORD *)(v12 + 40) + 8 * v16 + 4);
                *(_DWORD *)&Pool2[2 * v17 + 2] = *(unsigned __int8 *)(*(_QWORD *)(v12 + 40) + 8 * v16 + 5);
                *(_DWORD *)&Pool2[2 * v17 + 4] = *(unsigned __int8 *)(*(_QWORD *)(v12 + 40) + 8 * v16 + 6);
                v18 = *v14;
              }
              while ( v15 < *v14 );
              v35 = Pool2;
            ...
            EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, v3, 0LL, v13, &UserData);
            v11 = (unsigned int)(v19 + 1);
            v19 = v11;
          }
          while ( (unsigned int)v11 < v1[2] );
        }
        if ( Pool2 )
