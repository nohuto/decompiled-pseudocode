/*
 * XREFs of RegisterKernelCStates @ 0x1C0033468
 * Callers:
  ...
  if ( v3 && *(_DWORD *)v3 )
  {
    ...
    *(_DWORD *)(a3 + 56) = 0;
    ...
    if ( *(_BYTE *)(v3 + 16) != 1 )
    {
      ...
      HIWORD(v27) = 0;
      v28 = 0;
      DecodeAcpi2CState(a1, (__int64)&v27, (__int64)&v23, (__int64)v22, a3 + 64);
      v8 = 2;
      *(_DWORD *)(a2 + 120) = *(_DWORD *)(a2 + 120) & 0x7FFFFF80 | (v22[0] << 31) | 0xF;
      *(_DWORD *)(a2 + 116) = 1;
      *(_DWORD *)(a3 + 56) = 1;
    }
    v9 = *(_DWORD *)v3;
    for ( i = 0; i < *(_DWORD *)v3; ++v8 )
    {
      ...
      if ( v11 == v8 )
      {
        ...
        v25 = 32LL * *(unsigned int *)(a2 + 116);
        v21 = (_QWORD *)(v14 + a3 + 64);
        *v21 = v3 + 4 * (i + 4LL * i + 1);
        v26 = v3 + 4 * (i + 4LL * i + 1);
        if ( (int)DecodeAcpi2CState(v7, v26, (__int64)&v23, (__int64)v22, (__int64)v21) < 0 )
        {
        ...
        else
        {
          v15 = v25;
          v16 = v26;
          v17 = *(_DWORD *)(v25 + a2 + 120) ^ (*(_DWORD *)(v25 + a2 + 120) ^ (8 * v8)) & 0x78 | 7;
          *(_DWORD *)(v25 + a2 + 120) = v17;
          *(_DWORD *)(v15 + a2 + 120) = v17 & 0x7FFFFFFF | (v22[0] << 31);
