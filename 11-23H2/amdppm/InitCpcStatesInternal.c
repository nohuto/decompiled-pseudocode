/*
 * XREFs of InitCpcStatesInternal @ 0x1C0031174
 * Callers:
 *     RegisterHvCpcCounters @ 0x1C00257A0 (RegisterHvCpcCounters.c)
 *     RegisterKernelCpc @ 0x1C0033980 (RegisterKernelCpc.c)
 * Callees:
 ...
 *     ClearEnumerationContext @ 0x1C0003BA4 (ClearEnumerationContext.c)
...
__int64 __fastcall InitCpcStatesInternal(__int64 a1, __int64 (__fastcall *a2)(__int64))
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00124D8,
    0LL);
  LODWORD(v149) = GetPerfDomain(v4, v142, &v150);
