/*
 * XREFs of AcquirePccInterface @ 0x1C002627C
 * Callers:
...
__int64 __fastcall AcquirePccInterface(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v3 >= 0 )
    {
      v3 = ValidatePccHeader(qword_1C0012AA0);
      if ( v3 < 0 )
      {
        ((void (__fastcall *)(__int64))qword_1C0012A70)(qword_1C0012A60);
        memset(&unk_1C0012A58, 0, 0x80uLL);
      }
    }
  }
