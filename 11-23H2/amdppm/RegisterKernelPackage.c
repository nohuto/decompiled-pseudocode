/*
 * XREFs of RegisterKernelPackage @ 0x1C00343F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 80) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1C00128B0)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_1C0012538;
  ...
  while ( (__int64 *)v4 != &qword_1C0012538 );
  if ( !v5 )
  {
LABEL_8:
    ...
    *(_DWORD *)(Pool2 + 32) = v3;
    *(_DWORD *)(Pool2 + 36) = ((__int64 (__fastcall *)(_QWORD))qword_1C00128B8)(v3);
    ...
    *(_QWORD *)(v5 + 320) = v5 + 320;
    v8 = (__int64 *)qword_1C0012540;
    if ( *(__int64 **)qword_1C0012540 != &qword_1C0012538 )
LABEL_17:
      __fastfail(3u);
    *(_QWORD *)v5 = &qword_1C0012538;
    *(_QWORD *)(v5 + 8) = v8;
    *v8 = v5;
    qword_1C0012540 = v5;
  }
