/*
 * XREFs of PccInitiateExecuteCallback @ 0x1C000BED0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    ...
    v3 = qword_1C0012558;
    v4 = 0;
    while ( (__int64 *)v3 != &qword_1C0012558 )
    {
    ...
    if ( v4 )
    {
      LOBYTE(word_1C0012B2C) = 1;
      if ( !HIBYTE(word_1C0012B2C) )
      {
        HIBYTE(word_1C0012B2C) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_1C0012B18);
    if ( v11 )
      IoQueueWorkItem(qword_1C0012B20, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
