/*
 * XREFs of ?CanCoalesceTimestampMessages@CCrossProcessServerOutputEndpoint@@IEAAIIW4EndpointMessageID@@IPEAUAE_CURRENT_POSITION@@W4APO_BUFFER_FLAGS@@@Z @ 0x14003A7E8
 * Callers:
        ...
        int a6)
{
  ...
  if ( (unsigned int)v12 < *(_DWORD *)(a1 + 96) )
    v13 = v11;
  v14 = v13 | 0x40;
  if ( *(_DWORD *)(v8 + v6 + 4) + *(_DWORD *)(a1 + 88) * (_DWORD)v12 == a4 )
    v14 = v13;
