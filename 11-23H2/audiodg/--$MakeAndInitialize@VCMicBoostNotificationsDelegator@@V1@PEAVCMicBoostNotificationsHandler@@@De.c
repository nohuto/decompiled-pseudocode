/*
 * XREFs of ??$MakeAndInitialize@VCMicBoostNotificationsDelegator@@V1@PEAVCMicBoostNotificationsHandler@@@Details@WRL@Microsoft@@YAJPEAPEAVCMicBoostNotificationsDelegator@@$$QEAPEAVCMicBoostNotificationsHandler@@@Z @ 0x140077C9C
 * Callers:
 *     ?RegisterMicBoostNotification@CMicBoostNotificationsHandler@@AEAAJXZ @ 0x140078458 (-RegisterMicBoostNotification@CMicBoostNotificationsHandler@@AEAAJXZ.c)
 * Callees:
 ...
 *     ??0CMicBoostNotificationsDelegator@@QEAA@XZ @ 0x140077E70 (--0CMicBoostNotificationsDelegator@@QEAA@XZ.c)
