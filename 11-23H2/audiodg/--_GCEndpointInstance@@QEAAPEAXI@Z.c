 ...
 *     ??1?$out_param_t@V?$unique_ptr@VCEndpointInstance@@U?$default_delete@VCEndpointInstance@@@std@@@std@@@details@wil@@QEAA@XZ @ 0x14005D084 (--1-$out_param_t@V-$unique_ptr@VCEndpointInstance@@U-$default_delete@VCEndpointInstance@@@std@@@.c)
