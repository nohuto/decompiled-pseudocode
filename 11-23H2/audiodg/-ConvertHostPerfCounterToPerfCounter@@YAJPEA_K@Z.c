/*
 * XREFs of ?ConvertHostPerfCounterToPerfCounter@@YAJPEA_K@Z @ 0x1400951F8
 * Callers:
 ...
 *     ?GetClockingData@CSpatialCrossProcessBaseEndpoint@@MEAAJPEAUAE_CURRENT_POSITION@@0PEA_J1@Z @ 0x14009D510 (-GetClockingData@CSpatialCrossProcessBaseEndpoint@@MEAAJPEAUAE_CURRENT_POSITION@@0PEA_J1@Z.c)
 * Callees:
 *     <none>
 */
