/*
 * XREFs of ??1?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAA@XZ @ 0x140064C28
 * Callers:
 *     _GetModuleName_::_1_::dtor$5 @ 0x140065A4D (_GetModuleName_--_1_--dtor$5.c)
 * Callees:
