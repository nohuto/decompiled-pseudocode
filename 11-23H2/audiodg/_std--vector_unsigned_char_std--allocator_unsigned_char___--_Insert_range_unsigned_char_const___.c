/*
 * XREFs of _std::vector_unsigned_char_std::allocator_unsigned_char___::_Insert_range_unsigned_char_const____::_1_::catch$3 @ 0x1400646A2
 * Callers:
 *     <none>
 * Callees:
 *     _CxxThrowException_0 @ 0x140029240 (_CxxThrowException_0.c)
 *     ?deallocate@?$allocator@E@std@@QEAAXQEAE_K@Z @ 0x140065FC0 (-deallocate@-$allocator@E@std@@QEAAXQEAE_K@Z.c)
 */
