/*
 * XREFs of ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x14004C6D4
 * Callers:
 *     ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x14004C300 (-GetCurrentModuleName@details@wil@@YAPEBDXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x140027DF0 (__security_check_cookie.c)
 *     ?StringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x14004E4E8 (-StringCchCopyA@@YAJPEAD_KPEBD@Z.c)
 */
