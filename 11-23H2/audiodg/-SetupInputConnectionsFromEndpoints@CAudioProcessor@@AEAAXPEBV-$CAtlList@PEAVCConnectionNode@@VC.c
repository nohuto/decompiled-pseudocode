/*
 * XREFs of ?SetupInputConnectionsFromEndpoints@CAudioProcessor@@AEAAXPEBV?$CAtlList@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATLRT@@PEB_JPEAUAE_CURRENT_POSITION@@@Z @ 0x140039C4C
 * Callers:
