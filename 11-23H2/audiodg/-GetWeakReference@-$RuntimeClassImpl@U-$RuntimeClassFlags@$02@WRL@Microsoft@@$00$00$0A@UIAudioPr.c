        ...
        struct IUnknown *a2)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    *(_DWORD *)(WeakReference + 16) = v2;
    ...
    v11 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 104), v9, v2);
    for ( i = v2 == v11; ; i = v11 == v2 )
    {
      ...
      v11 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 104), v9, v11);
    }
