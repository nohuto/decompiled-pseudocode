/*
 * XREFs of ?IndexOfInternal@?$Vector@PEAUIBuffer@Streams@Storage@Windows@@U?$DefaultEqualityPredicate@PEAUIBuffer@Streams@Storage@Windows@@@Internal@Collections@Foundation@4@U?$DefaultLifetimeTraits@PEAUIBuffer@Streams@Storage@Windows@@@6784@U?$DefaultVectorOptions@PEAUIBuffer@Streams@Storage@Windows@@@6784@@Internal@Collections@Foundation@Windows@@AEAAJPEAPEAUIBuffer@Streams@Storage@5@IPEAU6785@PEAIPEAE@Z @ 0x1400873C4
 * Callers:
 ...
 * Callees:
 *     ??$?RUIBuffer@Streams@Storage@Windows@@@InterfaceEquals@XWinRT@@QEBAJPEAUIBuffer@Streams@Storage@Windows@@0PEA_N@Z @ 0x14007BCD0 (--$-RUIBuffer@Streams@Storage@Windows@@@InterfaceEquals@XWinRT@@QEBAJPEAUIBuffer@Streams@Storage.c)
 */
