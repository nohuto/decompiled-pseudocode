 ...
 *     ?GetOutputEndpointBuffers@CAudioProcessor@@AEAAXPEBV?$CAtlList@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATLRT@@PEAUAE_CURRENT_POSITION@@@Z @ 0x140039BE2 (-GetOutputEndpointBuffers@CAudioProcessor@@AEAAXPEBV-$CAtlList@PEAVCConnectionNode@@VCConnection.c)
 *     ?SetupInputConnectionsFromEndpoints@CAudioProcessor@@AEAAXPEBV?$CAtlList@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATLRT@@PEB_JPEAUAE_CURRENT_POSITION@@@Z @ 0x140039C4C (-SetupInputConnectionsFromEndpoints@CAudioProcessor@@AEAAXPEBV-$CAtlList@PEAVCConnectionNode@@VC.c)
