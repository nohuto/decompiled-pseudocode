/*
 * XREFs of ??1?$forward_list@V?$com_ptr_t@VCAudioSystemEffectsPropertyChangeNotificationsHandler@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCAudioSystemEffectsPropertyChangeNotificationsHandler@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x14006B9B8
 * Callers:
 *     _CAPOProcessingHost::CAPOProcessingHost_::_1_::dtor$7 @ 0x14006B5D3 (_CAPOProcessingHost--CAPOProcessingHost_--_1_--dtor$7.c)
 * Callees:
