/*
 * XREFs of ?RegisterThread@CpuManager@@UEAAJPEAXPEAPEAUThreadRegistrationToken__@@@Z @ 0x1400549B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CpuManager::RegisterThread(CpuManager *this, void *a2, struct ThreadRegistrationToken__ **a3)
{
  ...
  v8 = (*(__int64 (__fastcall **)(CpuManager *, void *, __int64))(*(_QWORD *)v5 + 96LL))(v5, v4, v10 + 16);
  if ( v8 >= 0 )
  {
LABEL_11:
