/*
 * XREFs of ??$MakeAndInitialize@VAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@UIAudioDeviceBrokerDevice@2345@AEAPEAX@Details@WRL@Microsoft@@YAJPEAPEAUIAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@AEAPEAX@Z @ 0x14001B204
 * Callers:
...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Windows::Media::Devices::Internal::AudioDeviceBrokerDevice,Windows::Media::Devices::Internal::IAudioDeviceBrokerDevice,void * &>(
        Windows::Media::Devices::Internal::AudioDeviceBrokerDevice **a1,
        HANDLE *a2)
{
  ...
  __int64 v10; // rdx
  Windows::Media::Devices::Internal::AudioDeviceBrokerDevice *v12; // [rsp+30h] [rbp+8h] BYREF
  Windows::Media::Devices::Internal::AudioDeviceBrokerDevice *v13; // [rsp+40h] [rbp+18h] BYREF
...
LABEL_13:
  ...
  v5 = Windows::Media::Devices::Internal::AudioDeviceBrokerDevice::AudioDeviceBrokerDevice(v4);
  v13 = v5;
  v12 = 0LL;
  ...
  *a1 = 0LL;
  ...
  {
    *a1 = v5;
    (*(void (__fastcall **)(Windows::Media::Devices::Internal::AudioDeviceBrokerDevice *))(*(_QWORD *)v5 + 8LL))(v5);
    CanCastTo = 0;
  }
  else
  {
    if ( InlineIsEqualGUID(v8, v9) )
    {
      *a1 = v5;
      CanCastTo = 0;
LABEL_7:
      (*(void (__fastcall **)(Windows::Media::Devices::Internal::AudioDeviceBrokerDevice *))(*(_QWORD *)*a1 + 8LL))(*a1);
      goto LABEL_8;
    }
