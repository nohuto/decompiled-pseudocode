/*
 * XREFs of ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x14004B080
 * Callers:
 *     <none>
 * Callees:
 *     ??0exception@std@@QEAA@AEBV01@@Z @ 0x14004B160 (--0exception@std@@QEAA@AEBV01@@Z.c)
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x14004EBE0 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
 */
