/*
 * XREFs of ?Set@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEBUFailureInfo@3@I@Z @ 0x14004E04C
 * Callers:
 *     ?SetLastError@ThreadLocalData@details_abi@wil@@QEAAXAEBUFailureInfo@3@@Z @ 0x14004E3E4 (-SetLastError@ThreadLocalData@details_abi@wil@@QEAAXAEBUFailureInfo@3@@Z.c)
 * Callees:
 ...
 *     ?ProcessHeapAlloc@details@wil@@YAPEAXK_K@Z @ 0x14004D2BC (-ProcessHeapAlloc@details@wil@@YAPEAXK_K@Z.c)
 *     ?ResultStringSize@details@wil@@YA_KPEBD@Z @ 0x14004DE3C (-ResultStringSize@details@wil@@YA_KPEBD@Z.c)
 *     ?ResultStringSize@details@wil@@YA_KPEBG@Z @ 0x14004DE68 (-ResultStringSize@details@wil@@YA_KPEBG@Z.c)
 */
