/*
 * XREFs of ??$MakeAndInitialize@VCAudioSystemEffectsPropertyChangeNotificationsHandler@@V1@PEAGAEAU_GUID@@AEAPEAUIMMDevice@@@Details@WRL@Microsoft@@YAJPEAPEAVCAudioSystemEffectsPropertyChangeNotificationsHandler@@$$QEAPEAGAEAU_GUID@@AEAPEAUIMMDevice@@@Z @ 0x14006A65C
 * Callers:
 ...
 *     ??0CAudioSystemEffectsPropertyChangeNotificationsHandler@@QEAA@XZ @ 0x14006B614 (--0CAudioSystemEffectsPropertyChangeNotificationsHandler@@QEAA@XZ.c)
