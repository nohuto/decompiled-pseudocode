/*
 * XREFs of ?GetLatency@CSystemAudioDeviceSharedBase@@UEAAJ_KPEA_J@Z @ 0x140059360
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  v7 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64 *))(**((_QWORD **)this + 41) + 56LL))(
         *((_QWORD *)this + 41),
         a2,
         a3);
  if ( v7 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceSharedBase::GetLatency", 0x170u, v7);
  }
  if ( v6 )
