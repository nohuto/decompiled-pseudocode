 ...
 *     _CProcessingData::CopyAPOList_::_1_::catch$2 @ 0x14003574B (_CProcessingData--CopyAPOList_--_1_--catch$2.c)
 *     ??1?$CAutoPtr@VCAPONode@@@ATL@@QEAA@XZ @ 0x1400708E0 (--1-$CAutoPtr@VCAPONode@@@ATL@@QEAA@XZ.c)
 * Callees:
