/*
 * XREFs of ??1CCritSecLock@ATL@@QEAA@XZ @ 0x14007A930
 * Callers:
 ...
 *     _CAudioProcessor::ActivateAPO_::_1_::dtor$0 @ 0x140034F50 (_CAudioProcessor--ActivateAPO_--_1_--dtor$0.c)
 *     _CAudioProcessor::AddAPOOutputConnection_::_1_::dtor$2 @ 0x14003532B (_CAudioProcessor--AddAPOOutputConnection_--_1_--dtor$2.c)
 *     _CAudioProcessor::CommitGraphChanges_::_1_::dtor$0 @ 0x140035558 (_CAudioProcessor--CommitGraphChanges_--_1_--dtor$0.c)
 *     _CAudioProcessor::DeactivateAPO_::_1_::dtor$0 @ 0x140036376 (_CAudioProcessor--DeactivateAPO_--_1_--dtor$0.c)
