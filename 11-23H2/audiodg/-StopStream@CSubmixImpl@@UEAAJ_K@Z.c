/*
 * XREFs of ?StopStream@CSubmixImpl@@UEAAJ_K@Z @ 0x140068F20
 * Callers:
 *     ?StopStream@CStreamGroup@@UEAAJ_K@Z @ 0x1400523E0 (-StopStream@CStreamGroup@@UEAAJ_K@Z.c)
 *     ?StopStream@CProcessSubmix@@UEAAJ_K@Z @ 0x140069500 (-StopStream@CProcessSubmix@@UEAAJ_K@Z.c)
 * Callees:
