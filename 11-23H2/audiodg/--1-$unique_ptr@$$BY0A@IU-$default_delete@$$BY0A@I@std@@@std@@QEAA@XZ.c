/*
 * XREFs of ??1?$unique_ptr@$$BY0A@IU?$default_delete@$$BY0A@I@std@@@std@@QEAA@XZ @ 0x14006BA5C
 * Callers:
 *     _CAPOProcessingHost::RegisterAPONotifications_::_1_::dtor$7 @ 0x140036712 (_CAPOProcessingHost--RegisterAPONotifications_--_1_--dtor$7.c)
