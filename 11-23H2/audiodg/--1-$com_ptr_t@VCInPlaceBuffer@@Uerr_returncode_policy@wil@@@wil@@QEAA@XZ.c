/*
 * XREFs of ??1?$com_ptr_t@VCInPlaceBuffer@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x14005C034
 * Callers:
 *     ?CreateAPOConnections@CPipeInstance@@AEAAJXZ @ 0x14001118C (-CreateAPOConnections@CPipeInstance@@AEAAJXZ.c)
 *     _CPipeInstance::CreateAPOConnections_::_1_::dtor$0 @ 0x140035510 (_CPipeInstance--CreateAPOConnections_--_1_--dtor$0.c)
 * Callees:
