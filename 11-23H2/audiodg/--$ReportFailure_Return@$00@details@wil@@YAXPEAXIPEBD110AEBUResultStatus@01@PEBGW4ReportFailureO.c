/*
 * XREFs of ??$ReportFailure_Return@$00@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x14004A9CC
 * Callers:
 ...
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x14004D92C (-RecordReturn@details@wil@@YAHJ@Z.c)
