/*
 * XREFs of ?SetCount@?$CAtlArray@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATL@@QEAA_N_KH@Z @ 0x140012D08
 * Callers:
...
char __fastcall ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::SetCount(
        __int64 a1,
        unsigned __int64 a2,
        __int64 a3)
{
...
LABEL_7:
      *(_QWORD *)(a1 + 16) = v7;
LABEL_8:
      ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::CallConstructors(a1, v6, a3);
LABEL_9:
      v3 = a2;
LABEL_10:
      *(_QWORD *)(a1 + 8) = v3;
