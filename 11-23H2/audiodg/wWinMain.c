 ...
 *     McGenEventRegister_EtwEventRegister @ 0x1400526FC (McGenEventRegister_EtwEventRegister.c)
 *     WPP_SF_S @ 0x1400528D0 (WPP_SF_S.c)
 *     WPP_SF_d @ 0x140052944 (WPP_SF_d.c)
 *     WppInitUm @ 0x140052A88 (WppInitUm.c)
 *     ?AERTMemoryShutdown@@YAJXZ @ 0x14007ADD4 (-AERTMemoryShutdown@@YAJXZ.c)
 */
