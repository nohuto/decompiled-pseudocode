/*
 * XREFs of ??1SendCommandAsyncOperation@Devices@Media@Windows@@UEAA@XZ @ 0x140080E1C
 * Callers:
        ...
        Windows::Media::Devices::SendCommandAsyncOperation *this)
{
  ...
  *((_QWORD *)this + 22) = 0LL;
  wil::com_ptr_t<CPrivateAPO,wil::err_returncode_policy>::~com_ptr_t<CPrivateAPO,wil::err_returncode_policy>((__int64 *)this + 21);
