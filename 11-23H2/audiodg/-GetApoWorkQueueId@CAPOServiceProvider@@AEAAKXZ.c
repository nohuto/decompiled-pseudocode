/*
 * XREFs of ?GetApoWorkQueueId@CAPOServiceProvider@@AEAAKXZ @ 0x14006F278
 * Callers:
 *     ?GetRealTimeWorkQueue@CAPOServiceProvider@@UEAAJPEAK@Z @ 0x14006F340 (-GetRealTimeWorkQueue@CAPOServiceProvider@@UEAAJPEAK@Z.c)
 * Callees:
