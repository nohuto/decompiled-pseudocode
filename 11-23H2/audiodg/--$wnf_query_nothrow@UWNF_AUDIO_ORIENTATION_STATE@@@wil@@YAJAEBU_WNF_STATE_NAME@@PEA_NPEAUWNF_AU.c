/*
 * XREFs of ??$wnf_query_nothrow@UWNF_AUDIO_ORIENTATION_STATE@@@wil@@YAJAEBU_WNF_STATE_NAME@@PEA_NPEAUWNF_AUDIO_ORIENTATION_STATE@@PEAUWNF_CHANGE_STAMP_STRUCT@0@@Z @ 0x14006B0C8
 * Callers:
 ...
 * Callees:
 *     ??$ZeroStateDataIfSizeInconsistent@UWNF_AUDIO_ORIENTATION_STATE@@@details@wil@@YAXPEAUWNF_AUDIO_ORIENTATION_STATE@@KK@Z @ 0x14002D474 (--$ZeroStateDataIfSizeInconsistent@UWNF_AUDIO_ORIENTATION_STATE@@@details@wil@@YAXPEAUWNF_AUDIO_.c)
