/*
 * XREFs of ?InsertAfter@?$CAtlList@PEAVCAPONode@@VCAPONodeTraits@@@ATL@@QEAAPEAU__POSITION@@PEAU3@AEBQEAVCAPONode@@@Z @ 0x14008F370
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<CAPONode *,CAPONodeTraits>::InsertAfter(__int64 *a1, __int64 *a2, __int64 *a3)
{
  ...
  if ( !a2 )
    return (__int64 *)ATL::CAtlList<CAPONode *,CAPONodeTraits>::AddTail(a1, (__int64)a3);
