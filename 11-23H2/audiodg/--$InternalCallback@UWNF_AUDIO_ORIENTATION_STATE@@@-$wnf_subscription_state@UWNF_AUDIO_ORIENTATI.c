/*
 * XREFs of ??$InternalCallback@UWNF_AUDIO_ORIENTATION_STATE@@@?$wnf_subscription_state@UWNF_AUDIO_ORIENTATION_STATE@@@details@wil@@QEAAXPEBUWNF_AUDIO_ORIENTATION_STATE@@K@Z @ 0x140076668
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_f009824708dbe55f35ab228094a3f5e0_@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x140076640 (-_lambda_invoker_cdecl_@_lambda_f009824708dbe55f35ab228094a3f5e0_@@CAJU_WNF_STATE_NAME@@KPEAU_WN.c)
 * Callees:
