/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCStreamInstance@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x14004BEEC
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  try
  {
    *a3 = 0LL;
    ...
    v8 = ATL::CComAggObject<CStreamInstance>::CComAggObject<CStreamInstance>((__int64)v7, a1);
    v10 = v8;
  }
  catch ( ... )
  {
