/*
 * XREFs of ?GetAudioFormat@@YAXPEAUIAudioMediaType@@PEAU_UNCOMPRESSEDAUDIOFORMAT@@@Z @ 0x140010B50
 * Callers:
 *     ?ValidateUncompressedFrameFormat@@YAJPEAUIAudioMediaType@@@Z @ 0x140010ACC (-ValidateUncompressedFrameFormat@@YAJPEAUIAudioMediaType@@@Z.c)
