/*
 * XREFs of ??$com_weak_query@AEAPEAVCAudioSystemEffectsPropertyChangeNotificationsHandler@@@wil@@YA?AV?$com_ptr_t@UIWeakReference@@Uerr_exception_policy@wil@@@0@AEAPEAVCAudioSystemEffectsPropertyChangeNotificationsHandler@@@Z @ 0x1400729E4
 * Callers:
