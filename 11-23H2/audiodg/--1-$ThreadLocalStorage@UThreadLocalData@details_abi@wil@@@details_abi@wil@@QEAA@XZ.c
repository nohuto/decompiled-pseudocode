/*
 * XREFs of ??1?$ThreadLocalStorage@UThreadLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x14004B3C0
 * Callers:
 ...
 * Callees:
 *     ?Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ @ 0x14004B9BC (-Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ.c)
 */
