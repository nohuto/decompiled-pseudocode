 ...
 * Callees:
 *     ?FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x14004C14C (-FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
        ...
        _QWORD *a2)
{
  ...
  {
    wil::details::in1diag3::FailFast_Unexpected(retaddr, (void *)0xB6D, v5, v6);
  }
  *a2 = v2;
  return a2;
}
