/*
 * XREFs of ?GetMany@?$SimpleVectorIterator@UEventRegistrationToken@@V?$Vector@UEventRegistrationToken@@UEventRegistrationTokenEqual@Internal@Devices@Media@Windows@@UPodLifetimeTraits@XWinRT@@U?$DefaultVectorOptions@UEventRegistrationToken@@@3Collections@Foundation@6@@Internal@Collections@Foundation@Windows@@UPodLifetimeTraits@XWinRT@@UIntVersionTag@8@$0A@@Internal@Collections@Foundation@Windows@@UEAAJIPEAUEventRegistrationToken@@PEAI@Z @ 0x1400851F0
 * Callers:
 *     <none>
 * Callees:
 *     ??R_lambda_7183e9ae03d95d0d634d64af3f4c35bb_@@QEBAJIPEAI@Z @ 0x140081474 (--R_lambda_7183e9ae03d95d0d634d64af3f4c35bb_@@QEBAJIPEAI@Z.c)
 *     ??R_lambda_cdc67ce79880dc59329b171674cbd71c_@@QEBA@XZ @ 0x14008175C (--R_lambda_cdc67ce79880dc59329b171674cbd71c_@@QEBA@XZ.c)
 */
