/*
 * XREFs of ??$MakeAndInitialize@VSendCommandAsyncOperation@Devices@Media@Windows@@V1234@PEAVAudioDeviceModule@234@AEAPEAUIBuffer@Streams@Storage@4@@Details@WRL@Microsoft@@YAJPEAPEAVSendCommandAsyncOperation@Devices@Media@Windows@@$$QEAPEAVAudioDeviceModule@456@AEAPEAUIBuffer@Streams@Storage@6@@Z @ 0x14007E82C
 * Callers:
 ...
 *     ??0SendCommandAsyncOperation@Devices@Media@Windows@@QEAA@XZ @ 0x140080114 (--0SendCommandAsyncOperation@Devices@Media@Windows@@QEAA@XZ.c)
        ...
        struct Windows::Storage::Streams::IBuffer **a3)
{
  ...
  Windows::Media::Devices::SendCommandAsyncOperation *v17; // [rsp+58h] [rbp+20h] BYREF
...
LABEL_5:
  ...
  if ( v7 < 0 )
  {
    Microsoft::WRL::ComPtr<Windows::Media::Devices::SendCommandAsyncOperation>::~ComPtr<Windows::Media::Devices::SendCommandAsyncOperation>(&v17);
    goto LABEL_5;
  }
  if ( v11 )
  {
    ...
    while ( v14 >= 0 )
    {
      ...
      {
        v15 = v14;
        v14 = _InterlockedCompareExchange64((volatile signed __int64 *)v11 + 20, v14 + 1, v14);
        if ( v15 != v14 )
          continue;
      }
      goto LABEL_13;
    }
    Microsoft::WRL::Details::SafeUnknownIncrementReference((Microsoft::WRL::Details *)(2 * v14 + 16), v12);
LABEL_13:
    *a1 = v11;
