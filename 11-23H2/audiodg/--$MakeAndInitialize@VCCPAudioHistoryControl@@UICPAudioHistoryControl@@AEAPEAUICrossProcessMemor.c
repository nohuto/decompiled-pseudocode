/*
 * XREFs of ??$MakeAndInitialize@VCCPAudioHistoryControl@@UICPAudioHistoryControl@@AEAPEAUICrossProcessMemory@@@Details@WRL@Microsoft@@YAJPEAPEAUICPAudioHistoryControl@@AEAPEAUICrossProcessMemory@@@Z @ 0x140094468
 * Callers:
 ...
 *     ??0CCPAudioHistoryControl@@QEAA@XZ @ 0x140094774 (--0CCPAudioHistoryControl@@QEAA@XZ.c)
