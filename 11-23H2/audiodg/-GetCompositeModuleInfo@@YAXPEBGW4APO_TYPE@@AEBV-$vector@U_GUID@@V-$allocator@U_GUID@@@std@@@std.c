/*
 * XREFs of ?GetCompositeModuleInfo@@YAXPEBGW4APO_TYPE@@AEBV?$vector@U_GUID@@V?$allocator@U_GUID@@@std@@@std@@PEAUIComCatalog@@AEAV?$vector@EV?$allocator@E@std@@@3@PEAUIPropertyStore@@@Z @ 0x1400650F4
 * Callers:
...
void __fastcall GetCompositeModuleInfo(__int64 a1, unsigned int a2, __int64 *a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v26 )
    {
      cotaskmem_string_nothrow = (void **)wil::make_cotaskmem_string_nothrow((wil *)&pv, &word_1400B6CD8);
    ...
    if ( !v27 )
    {
      v16 = (void **)wil::make_cotaskmem_string_nothrow((wil *)&v31, &word_1400B6CD8);
      if ( &v27 != v16 )
      {
        wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>::reset(
          &v27,
    ...
    if ( !v23 )
    {
      v19 = (void **)wil::make_cotaskmem_string_nothrow((wil *)&v32, &word_1400B6CD8);
      if ( &v23 != v19 )
      {
        wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>::reset(
          &v23,
