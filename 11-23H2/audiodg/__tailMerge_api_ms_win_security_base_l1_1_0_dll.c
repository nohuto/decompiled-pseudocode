/*
 * XREFs of __tailMerge_api_ms_win_security_base_l1_1_0_dll @ 0x140029456
 * Callers:
 *     __imp_load_MakeAbsoluteSD @ 0x14002944A (__imp_load_MakeAbsoluteSD.c)
 *     __imp_load_GetTokenInformation @ 0x14002A5B1 (__imp_load_GetTokenInformation.c)
 * Callees:
