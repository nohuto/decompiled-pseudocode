/*
 * XREFs of ??1last_error_context@wil@@QEAA@XZ @ 0x14004B55C
 * Callers:
 ...
 *     _wil::details_abi::heap_buffer::reserve_::_1_::dtor$0 @ 0x14005A051 (_wil--details_abi--heap_buffer--reserve_--_1_--dtor$0.c)
