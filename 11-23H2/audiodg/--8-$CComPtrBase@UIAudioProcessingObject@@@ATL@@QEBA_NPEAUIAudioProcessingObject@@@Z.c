/*
 * XREFs of ??8?$CComPtrBase@UIAudioProcessingObject@@@ATL@@QEBA_NPEAUIAudioProcessingObject@@@Z @ 0x1400381CC
 * Callers:
...
bool __fastcall ATL::CComPtrBase<IAudioProcessingObject>::operator==(_QWORD *a1, __int64 a2)
{
  return *a1 == a2;
}
