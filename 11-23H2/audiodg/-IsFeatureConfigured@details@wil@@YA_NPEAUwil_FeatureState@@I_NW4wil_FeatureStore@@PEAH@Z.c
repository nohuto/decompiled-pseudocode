/*
 * XREFs of ?IsFeatureConfigured@details@wil@@YA_NPEAUwil_FeatureState@@I_NW4wil_FeatureStore@@PEAH@Z @ 0x1400880EC
 * Callers:
 *     ?WilApiImpl_GetFeatureEnabledState@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@PEAH@Z @ 0x14008D640 (-WilApiImpl_GetFeatureEnabledState@details@wil@@YA-AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_T.c)
 * Callees:
 *     wil_QueryFeatureState @ 0x14002EB98 (wil_QueryFeatureState.c)
 ...
 *     ?EnsureSubscribedToFeatureConfigurationChangesImpl@EnabledStateManager@details@wil@@AEAAIXZ @ 0x140058CA8 (-EnsureSubscribedToFeatureConfigurationChangesImpl@EnabledStateManager@details@wil@@AEAAIXZ.c)
...
bool __fastcall wil::details::IsFeatureConfigured(__int64 a1, __int64 a2, unsigned __int8 a3, __int64 a4, _DWORD *a5)
{
  int v5; // esi
  unsigned int v6; // ebp
  ...
  if ( (*v8 & 2) != 0 )
    return (*v8 & 1) != 0 && (unsigned int)wil_QueryFeatureState(a1, a2, a3, a4, 0LL, a5) != 0;
  v10 = dword_1400CF504;
  if ( !dword_1400CF504 )
  ...
  v16 = 0;
  *a5 = 1;
  v11 = (unsigned int)wil_RtlStagingConfig_QueryFeatureState(a1, v6, v5, &v16) != 0;
  v12 = _InterlockedExchange(v8, (v16 != 0) + 6);
  if ( !v16 && (v12 & 4) == 0 && wil::details::g_enabledStateManager )
  {
    wil::srwlock::lock_exclusive((RTL_SRWLOCK *)&qword_1400CF4F0, &v13);
    if ( !v10
      || v10 != dword_1400CF504
      || (v14 = 0, v15 = v8, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_1400CF538, &v14, 0x10uLL)) )
    {
      _InterlockedAnd(v8, 0xFFFFF7C1);
    }
