/*
 * XREFs of ??1?$CAggregateTelemetry@V?$CAggregateValuesClusteredBase@W4SpatialCpErrorEvent@@PEAI@@W4SpatialCpErrorEvent@@PEAI$0A@$0A@@@UEAA@XZ @ 0x14009B340
 * Callers:
 *     _CAggregateTelemetryClustered_enum_SpatialCpErrorEvent_unsigned_int___0_0_::CAggregateTelemetryClustered_enum_SpatialCpErrorEvent_unsigned_int___0_0__::_1_::dtor$0 @ 0x14009B01D (_CAggregateTelemetryClustered_enum_SpatialCpErrorEvent_unsigned_int___0_0_--CAggregateTelemetryC.c)
 ...
 *     ?Log@?$CAggregateTelemetry@V?$CAggregateValuesClusteredBase@W4CpGlitchEvent@@PEAI@@W4CpGlitchEvent@@PEAI$0A@$0A@@@UEAAX_N@Z @ 0x1400969F0 (-Log@-$CAggregateTelemetry@V-$CAggregateValuesClusteredBase@W4CpGlitchEvent@@PEAI@@W4CpGlitchEve.c)
 */
