/*
 * XREFs of ?Initialize@_WorkTask@@QEAAJV?$function@$$A6AXXZ@std@@PEAVCSerialWorkQueue@@@Z @ 0x14006FF1C
 * Callers:
 ...
 *     ??0?$function@$$A6AXXZ@std@@QEAA@AEBV01@@Z @ 0x140038518 (--0-$function@$$A6AXXZ@std@@QEAA@AEBV01@@Z.c)
 */
