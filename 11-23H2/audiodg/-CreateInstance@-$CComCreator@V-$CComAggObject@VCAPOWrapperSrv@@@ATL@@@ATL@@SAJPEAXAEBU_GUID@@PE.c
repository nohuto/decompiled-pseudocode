/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComAggObject@VCAPOWrapperSrv@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x14004BCE4
 * Callers:
 ...
 *     ??0?$CComAggObject@VCAPOWrapperSrv@@@ATL@@QEAA@PEAX@Z @ 0x14004AEB4 (--0-$CComAggObject@VCAPOWrapperSrv@@@ATL@@QEAA@PEAX@Z.c)
 */
        ...
        _QWORD *a3)
{
  ...
  try
  {
    *a3 = 0LL;
    ...
    v8 = ATL::CComAggObject<CAPOWrapperSrv>::CComAggObject<CAPOWrapperSrv>((__int64)v7, a1);
    v10 = v8;
  }
  catch ( ... )
  {
  ...
  if ( v8 )
  {
    v9 = ATL::CComCriticalSection::Init((struct _RTL_CRITICAL_SECTION *)(v8 + 64));
    if ( v9 < 0
      || (*(_BYTE *)(v8 + 104) = 1, (v9 = (**(__int64 (__fastcall ***)(__int64, __int64, _QWORD *))v8)(v8, v4, v3)) != 0) )
    {
