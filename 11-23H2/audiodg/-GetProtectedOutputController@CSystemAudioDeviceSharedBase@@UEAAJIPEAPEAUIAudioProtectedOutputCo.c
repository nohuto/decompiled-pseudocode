/*
 * XREFs of ?GetProtectedOutputController@CSystemAudioDeviceSharedBase@@UEAAJIPEAPEAUIAudioProtectedOutputController@@@Z @ 0x140059490
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProtectedOutputController **a3)
{
  ...
  *a3 = 0LL;
        ...
        v6 < 0) )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceSharedBase::GetProtectedOutputController", 0x1C3u, v6);
  }
  EtwEventActivityIdControl(4LL, &v10);
