/*
 * XREFs of ??1CSerialWorkQueue@@QEAA@XZ @ 0x14006F69C
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCSerialWorkQueue@@@std@@EEAAXXZ @ 0x140038800 (-_Destroy@-$_Ref_count_obj2@VCSerialWorkQueue@@@std@@EEAAXXZ.c)
 * Callees:
 *     <none>
 */
