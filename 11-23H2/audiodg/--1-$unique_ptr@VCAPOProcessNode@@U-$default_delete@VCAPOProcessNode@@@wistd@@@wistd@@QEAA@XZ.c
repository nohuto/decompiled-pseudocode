/*
 * XREFs of ??1?$unique_ptr@VCAPOProcessNode@@U?$default_delete@VCAPOProcessNode@@@wistd@@@wistd@@QEAA@XZ @ 0x14005D0FC
 * Callers:
 ...
 *     _CAPOProcessNode::CreateAPOProcessNode_::_1_::dtor$3 @ 0x140035795 (_CAPOProcessNode--CreateAPOProcessNode_--_1_--dtor$3.c)
 * Callees:
