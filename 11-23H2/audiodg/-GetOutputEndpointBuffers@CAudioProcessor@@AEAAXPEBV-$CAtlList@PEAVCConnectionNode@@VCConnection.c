/*
 * XREFs of ?GetOutputEndpointBuffers@CAudioProcessor@@AEAAXPEBV?$CAtlList@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATLRT@@PEAUAE_CURRENT_POSITION@@@Z @ 0x140039BE2
 * Callers:
