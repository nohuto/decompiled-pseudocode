/*
 * XREFs of ?reset@?$unique_ptr@VCAudioHistoryBufferManager@@U?$default_delete@VCAudioHistoryBufferManager@@@wistd@@@wistd@@QEAAXPEAVCAudioHistoryBufferManager@@@Z @ 0x140027918
 * Callers:
 *     _dynamic_atexit_destructor_for__g_AudioHistoryManager___0 @ 0x140036E40 (_dynamic_atexit_destructor_for__g_AudioHistoryManager___0.c)
 * Callees:
