/*
 * XREFs of ?TrackAPOFailureUnhandled@CSystemAudioDeviceSharedBase@@QEAAXM@Z @ 0x140059D78
 * Callers:
 ...
 *     ??1?$CComPtrBase@VCAudioDeviceGraph@@@ATL@@QEAA@XZ @ 0x1400584C8 (--1-$CComPtrBase@VCAudioDeviceGraph@@@ATL@@QEAA@XZ.c)
 */
