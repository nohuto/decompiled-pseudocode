/*
 * XREFs of ??1heap_buffer@details_abi@wil@@QEAA@XZ @ 0x140058714
 * Callers:
 *     _wil::details_abi::RawUsageIndex::RecordUsage_::_1_::dtor$0 @ 0x14008A2F7 (_wil--details_abi--RawUsageIndex--RecordUsage_--_1_--dtor$0.c)
 * Callees:
