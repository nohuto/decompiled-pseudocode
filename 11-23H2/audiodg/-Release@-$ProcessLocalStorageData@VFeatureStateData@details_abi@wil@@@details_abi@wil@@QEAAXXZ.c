/*
 * XREFs of ?Release@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x14008A704
 * Callers:
 ...
 *     ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x140080C68 (--1FeatureStateManager@details@wil@@QEAA@XZ.c)
 * Callees:
