/*
 * XREFs of ?InsertBefore@?$CAtlList@PEAVCAPONode@@VCAPONodeTraits@@@ATL@@QEAAPEAU__POSITION@@PEAU3@AEBQEAVCAPONode@@@Z @ 0x14008F3C8
 * Callers:
...
__int64 *__fastcall ATL::CAtlList<CAPONode *,CAPONodeTraits>::InsertBefore(
        ...
        __int64 *a3)
{
  ...
  if ( !a2 )
    return (__int64 *)ATL::CAtlList<CAPONode *,CAPONodeTraits>::AddHead(a1, a3);
