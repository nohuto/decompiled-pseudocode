        ...
        void **a19)
{
  ...
  const unsigned __int16 *v51; // [rsp+70h] [rbp-90h]
  ...
  const unsigned __int16 *v66; // [rsp+D0h] [rbp-30h]
  ...
  v50 = 4LL;
  v48 = 8LL;
  return tlgWriteTransfer_EtwEventWriteTransfer(a1, a2, 0LL, 0LL, 17, (__int64)v46);
}
