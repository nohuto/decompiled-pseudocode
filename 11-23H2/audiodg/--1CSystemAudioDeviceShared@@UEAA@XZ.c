/*
 * XREFs of ??1CSystemAudioDeviceShared@@UEAA@XZ @ 0x14005A34C
 * Callers:
 ...
 *     ??1?$CComObject@VCSystemAudioDeviceShared@@@ATL@@UEAA@XZ @ 0x14005A2C0 (--1-$CComObject@VCSystemAudioDeviceShared@@@ATL@@UEAA@XZ.c)
