/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAUCO_DEVICE_CATALOG_COOKIE__@@P6AJPEAU1@@Z$1?CoRevokeDeviceCatalog@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x140064C8C
 * Callers:
 *     _GetModuleName_::_1_::dtor$0 @ 0x140065A29 (_GetModuleName_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
