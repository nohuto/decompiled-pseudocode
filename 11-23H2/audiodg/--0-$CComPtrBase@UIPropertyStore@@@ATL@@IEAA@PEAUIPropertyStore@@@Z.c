/*
 * XREFs of ??0?$CComPtrBase@UIPropertyStore@@@ATL@@IEAA@PEAUIPropertyStore@@@Z @ 0x14000C4F0
 * Callers:
...
_QWORD *__fastcall ATL::CComPtrBase<IPropertyStore>::CComPtrBase<IPropertyStore>(_QWORD *a1, __int64 a2)
{
  *a1 = a2;
  if ( a2 )
