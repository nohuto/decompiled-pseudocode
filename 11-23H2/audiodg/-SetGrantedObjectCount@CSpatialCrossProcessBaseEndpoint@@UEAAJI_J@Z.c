/*
 * XREFs of ?SetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJI_J@Z @ 0x14009E900
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( a2 <= *((_DWORD *)this + 67) )
  {
    ...
    if ( _InterlockedExchange64((volatile __int64 *)(*((_QWORD *)this + 159) + 8LL), a3) && a3 )
    {
      v6 = -2005139348;
    }
    else
    {
      _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this + 159) + 16LL), a2);
      _InterlockedExchange64((volatile __int64 *)(*((_QWORD *)this + 159) + 8LL), a3);
      v8 = *((_QWORD *)this + 159);
      if ( a3 )
      {
      ...
      else
      {
        ...
        if ( (unsigned __int64)_InterlockedCompareExchange64(
                                 (volatile signed __int64 *)(*((_QWORD *)this + 159) + 56LL),
                                 0LL,
                                 0LL) >> 32 < a2 )
        {
          _InterlockedOr((volatile signed __int32 *)(*((_QWORD *)this + 159) + 64LL), 0x40u);
        }
        else
        {
          v9 = *((_QWORD *)this + 94);
