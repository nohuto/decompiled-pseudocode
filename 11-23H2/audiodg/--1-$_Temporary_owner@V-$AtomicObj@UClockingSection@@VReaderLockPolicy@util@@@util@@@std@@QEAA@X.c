/*
 * XREFs of ??1?$_Temporary_owner@V?$AtomicObj@UClockingSection@@VReaderLockPolicy@util@@@util@@@std@@QEAA@XZ @ 0x14009CDDC
 * Callers:
 ...
 *     _std::shared_ptr_util::AtomicObj_ClockingSection_util::ReaderLockPolicy___::reset_util::AtomicObj_ClockingSection_util::ReaderLockPolicy____::_1_::dtor$1 @ 0x14009CC7D (_std--shared_ptr_util--AtomicObj_ClockingSection_util--ReaderLockPolicy___--reset_util--AtomicOb.c)
 * Callees:
