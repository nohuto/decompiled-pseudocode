/*
 * XREFs of ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x14004DED4
 * Callers:
 ...
 *     sub_14003D7ED @ 0x14003D7ED (sub_14003D7ED.c)
 ...
 *     sub_1400414F3 @ 0x1400414F3 (sub_1400414F3.c)
 *     sub_1400469C0 @ 0x1400469C0 (sub_1400469C0.c)
 *     sub_1400474A0 @ 0x1400474A0 (sub_1400474A0.c)
 ...
 *     AudioDGPublishApoTelemetry @ 0x140061B30 (AudioDGPublishApoTelemetry.c)
 ...
 *     ?GetEffectsList@CAPOWrapperSrv@@UEAAJPEAPEAU_GUID@@PEAIPEAX@Z @ 0x14006E7F0 (-GetEffectsList@CAPOWrapperSrv@@UEAAJPEAPEAU_GUID@@PEAIPEAX@Z.c)
 ...
 *     ?Invoke@CRtwqAsyncCallback@@UEAAJPEAUIRtwqAsyncResult@@@Z @ 0x140074DF0 (-Invoke@CRtwqAsyncCallback@@UEAAJPEAUIRtwqAsyncResult@@@Z.c)
 ...
 *     ?GetControllableSystemEffectsList@CSystemEffectWrapper@@UEAAJPEAPEAUAUDIO_SYSTEMEFFECT@@PEAIPEAX@Z @ 0x140075950 (-GetControllableSystemEffectsList@CSystemEffectWrapper@@UEAAJPEAPEAUAUDIO_SYSTEMEFFECT@@PEAIPEAX.c)
 ...
 *     ?GetEffectsListRemote@CSystemEffectWrapper@@UEAAJPEAPEAU_GUID@@PEAI_K@Z @ 0x140075C00 (-GetEffectsListRemote@CSystemEffectWrapper@@UEAAJPEAPEAU_GUID@@PEAI_K@Z.c)
 *     ?SetAudioSystemEffectStateRemote@CSystemEffectWrapper@@UEAAJU_GUID@@H@Z @ 0x140076120 (-SetAudioSystemEffectStateRemote@CSystemEffectWrapper@@UEAAJU_GUID@@H@Z.c)
 ...
 *     ?FindAll@AudioDeviceModulesManager@Devices@Media@Windows@@UEAAJPEAPEAU?$IVectorView@PEAVAudioDeviceModule@Devices@Media@Windows@@@Collections@Foundation@4@@Z @ 0x1400830A0 (-FindAll@AudioDeviceModulesManager@Devices@Media@Windows@@UEAAJPEAPEAU-$IVectorView@PEAVAudioDev.c)
 ...
 *     ?get_ClassId@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x14008DB70 (-get_ClassId@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAPEAUHSTRING__@@@Z.c)
 ...
 *     ?get_DisplayName@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x14008DD60 (-get_DisplayName@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAPEAUHSTRING__@@@Z.c)
 *     ?get_InstanceId@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z @ 0x14008DEB0 (-get_InstanceId@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z.c)
 *     ?get_MajorVersion@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z @ 0x14008DF00 (-get_MajorVersion@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z.c)
 *     ?get_MinorVersion@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z @ 0x14008DF50 (-get_MinorVersion@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z.c)
 *     ?get_Module@AudioDeviceModuleNotificationEventArgs@Devices@Media@Windows@@UEAAJPEAPEAUIAudioDeviceModule@234@@Z @ 0x14008DFA0 (-get_Module@AudioDeviceModuleNotificationEventArgs@Devices@Media@Windows@@UEAAJPEAPEAUIAudioDevi.c)
 *     ?get_NotificationData@AudioDeviceBrokerChangedEventArgs@Internal@Devices@Media@Windows@@UEAAJPEAPEAUIBuffer@Streams@Storage@5@@Z @ 0x14008E000 (-get_NotificationData@AudioDeviceBrokerChangedEventArgs@Internal@Devices@Media@Windows@@UEAAJPEA.c)
 *     ?get_NotificationData@AudioDeviceModuleNotificationEventArgs@Devices@Media@Windows@@UEAAJPEAPEAUIBuffer@Streams@Storage@4@@Z @ 0x14008E060 (-get_NotificationData@AudioDeviceModuleNotificationEventArgs@Devices@Media@Windows@@UEAAJPEAPEAU.c)
 *     ?get_Result@ModuleCommandResult@Devices@Media@Windows@@UEAAJPEAPEAUIBuffer@Streams@Storage@4@@Z @ 0x14008E0C0 (-get_Result@ModuleCommandResult@Devices@Media@Windows@@UEAAJPEAPEAUIBuffer@Streams@Storage@4@@Z.c)
 *     ?get_Status@ModuleCommandResult@Devices@Media@Windows@@UEAAJPEAW4SendCommandStatus@234@@Z @ 0x14008E320 (-get_Status@ModuleCommandResult@Devices@Media@Windows@@UEAAJPEAW4SendCommandStatus@234@@Z.c)
