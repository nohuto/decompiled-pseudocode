/*
 * XREFs of McTemplateU0pqq_EtwEventWriteTransfer @ 0x1400391F0
 * Callers:
...
__int64 __fastcall McTemplateU0pqq_EtwEventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  ...
  v9 = &v14;
  v11 = &a5;
  return McGenEventWrite_EtwEventWriteTransfer(a1, (__int64)&AudioCore_Pump_YieldStop, a3, 4LL, (__int64)v6);
}
