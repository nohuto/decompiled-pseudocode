/*
 * XREFs of ??1CDeviceGraphObjectCache@@MEAA@XZ @ 0x1400709A8
 * Callers:
 ...
 *     ?GetCount@?$CRealTimeSafeList@VCConnectionNode@@V?$CAtlList@PEAVCConnectionNode@@VCConnectionNodeTraits@@@ATLRT@@@@QEAA_KXZ @ 0x140070D94 (-GetCount@-$CRealTimeSafeList@VCConnectionNode@@V-$CAtlList@PEAVCConnectionNode@@VCConnectionNod.c)
 ...
 *     ?AERTUnlockHeap@@YAJPEAX@Z @ 0x14007AEA8 (-AERTUnlockHeap@@YAJPEAX@Z.c)
 */
