/*
 * XREFs of ??$MakeAndInitialize@VCAPOEndpointNotificationsDelegator@@V1@PEAVCAPOEndpointNotificationsHandler@@@Details@WRL@Microsoft@@YAJPEAPEAVCAPOEndpointNotificationsDelegator@@$$QEAPEAVCAPOEndpointNotificationsHandler@@@Z @ 0x1400713CC
 * Callers:
 ...
 *     ??0CAPOEndpointNotificationsDelegator@@QEAA@XZ @ 0x1400715A0 (--0CAPOEndpointNotificationsDelegator@@QEAA@XZ.c)
