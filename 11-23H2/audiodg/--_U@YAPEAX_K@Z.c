/*
 * XREFs of ??_U@YAPEAX_K@Z @ 0x140028518
 * Callers:
 ...
 *     ??$make_unique@$$BY0A@I$0A@@std@@YA?AV?$unique_ptr@$$BY0A@IU?$default_delete@$$BY0A@I@std@@@0@_K@Z @ 0x14006B068 (--$make_unique@$$BY0A@I$0A@@std@@YA-AV-$unique_ptr@$$BY0A@IU-$default_delete@$$BY0A@I@std@@@0@_K.c)
 ...
 *     ??$make_unique@$$BY0A@E$0A@@std@@YA?AV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@0@_K@Z @ 0x1400A03D4 (--$make_unique@$$BY0A@E$0A@@std@@YA-AV-$unique_ptr@$$BY0A@EU-$default_delete@$$BY0A@E@std@@@0@_K.c)
 * Callees:
 *     <none>
 */
