/*
 * XREFs of _CSpatialCrossProcessBaseEndpoint::InitializeCPMemory_::_1_::catch$6 @ 0x14009E5BC
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpatialCrossProcessBaseEndpoint::InitializeCPMemory_::_1_::catch_6(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
