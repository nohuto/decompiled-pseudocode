/*
 * XREFs of ?AddRef@AudioDeviceBroker@Internal@Devices@Media@Windows@@UEAAKXZ @ 0x140026310
 * Callers:
 *     ?AddRef@AudioDeviceModulesManager@Devices@Media@Windows@@W7EAAKXZ @ 0x140031DD0 (-AddRef@AudioDeviceModulesManager@Devices@Media@Windows@@W7EAAKXZ.c)
 *     ?AddRef@AudioDeviceModulesManager@Devices@Media@Windows@@WBA@EAAKXZ @ 0x140031DF0 (-AddRef@AudioDeviceModulesManager@Devices@Media@Windows@@WBA@EAAKXZ.c)
 * Callees:
