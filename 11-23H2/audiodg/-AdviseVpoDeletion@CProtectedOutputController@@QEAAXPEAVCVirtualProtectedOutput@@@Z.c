/*
 * XREFs of ?AdviseVpoDeletion@CProtectedOutputController@@QEAAXPEAVCVirtualProtectedOutput@@@Z @ 0x14005DDC0
 * Callers:
 *     ?Release@CVirtualProtectedOutput@@UEAAKXZ @ 0x14005E3D0 (-Release@CVirtualProtectedOutput@@UEAAKXZ.c)
 * Callees:
