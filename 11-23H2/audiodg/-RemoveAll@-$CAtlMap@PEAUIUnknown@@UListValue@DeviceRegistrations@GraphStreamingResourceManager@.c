/*
 * XREFs of ?RemoveAll@?$CAtlMap@PEAUIUnknown@@UListValue@DeviceRegistrations@GraphStreamingResourceManager@@V?$CElementTraits@PEAUIUnknown@@@ATL@@V?$CElementTraits@UListValue@DeviceRegistrations@GraphStreamingResourceManager@@@6@@ATL@@QEAAXXZ @ 0x140054F70
 * Callers:
 *     ??1GraphStreamingResourceManager@@UEAA@XZ @ 0x140037F9E (--1GraphStreamingResourceManager@@UEAA@XZ.c)
 * Callees:
