/*
 * XREFs of _CAPOProcessingHost::GetEndpointNotificationHandler_::_1_::catch$24 @ 0x14006CEA3
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAPOProcessingHost::GetEndpointNotificationHandler_::_1_::catch_24(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
