/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x14008A500
 * Callers:
 ...
 *     ?NtStatusToHr@details@wil@@YAJJ@Z @ 0x140076E98 (-NtStatusToHr@details@wil@@YAJJ@Z.c)
