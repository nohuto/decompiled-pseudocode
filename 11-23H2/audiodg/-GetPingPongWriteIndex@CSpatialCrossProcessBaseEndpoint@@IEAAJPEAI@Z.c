/*
 * XREFs of ?GetPingPongWriteIndex@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI@Z @ 0x14009DC20
 * Callers:
...
LABEL_7:
  ...
  if ( (_DWORD)v10 == 3 )
  {
    ...
    v3 = -2005139387;
    v11 = PingPongState::GetState((__int64)v2);
  ...
  else
  {
    ...
    if ( (_DWORD)v10 != 2 )
    {
      *(_DWORD *)(*(_QWORD *)(v7 + 1296) + 4 * v10 + 48) = *(_DWORD *)(v14 + 44);
      *a2 = v10;
      return v3;
    }
  ...
  SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetPingPongWriteIndex", 623, v3, v10);
  return v3;
}
