/*
 * XREFs of ??0CSpatialCrossProcessEndpointTraceLogger@@QEAA@XZ @ 0x14009B124
 * Callers:
 ...
 *     ??0?$CAggregateTelemetryClustered@W4SpatialCpErrorEvent@@PEAI$0A@$0A@@@QEAA@PEAV?$CAggregateValuesClusteredBase@W4SpatialCpErrorEvent@@PEAI@@_K11@Z @ 0x14009AF70 (--0-$CAggregateTelemetryClustered@W4SpatialCpErrorEvent@@PEAI$0A@$0A@@@QEAA@PEAV-$CAggregateValu.c)
 *     ??0?$CAggregateTelemetryClustered@W4SpatialCpGlitchEvent@@PEAI$0A@$0A@@@QEAA@PEAV?$CAggregateValuesClusteredBase@W4SpatialCpGlitchEvent@@PEAI@@_K11@Z @ 0x14009B030 (--0-$CAggregateTelemetryClustered@W4SpatialCpGlitchEvent@@PEAI$0A@$0A@@@QEAA@PEAV-$CAggregateVal.c)
 *     ?Clear@?$CSimplePerfCounterAggregateValues@W4SpatialObjectCountTypes@@I$01@@UEAAXXZ @ 0x14009BEA0 (-Clear@-$CSimplePerfCounterAggregateValues@W4SpatialObjectCountTypes@@I$01@@UEAAXXZ.c)
 */
        ...
        CSpatialCrossProcessEndpointTraceLogger *this)
{
  char *v2; // rsi
  _QWORD *v3; // rbx
  struct _RTL_CRITICAL_SECTION *v5; // [rsp+68h] [rbp+10h]
  ...
  *v3 = &CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues::`vftable';
  ...
  CAggregateTelemetryClustered<enum SpatialCpGlitchEvent,unsigned int *,0,0>::CAggregateTelemetryClustered<enum SpatialCpGlitchEvent,unsigned int *,0,0>(
    (__int64)this + 256,
    (__int64)this + 24);
  CAggregateTelemetryClustered<enum SpatialCpErrorEvent,unsigned int *,0,0>::CAggregateTelemetryClustered<enum SpatialCpErrorEvent,unsigned int *,0,0>(
    (__int64)this + 352,
    (__int64)this + 96);
  ...
  *((_DWORD *)this + 124) = -1;
  *((_DWORD *)this + 125) = -1;
  ((void (__fastcall *)(char *, __int64))CAggregateTelemetryLazyUpdate<CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues,enum SpatialObjectCountTypes,unsigned int,1,0>::SetPeriod)(
    (char *)this + 448,
    180000LL);
  return this;
}
