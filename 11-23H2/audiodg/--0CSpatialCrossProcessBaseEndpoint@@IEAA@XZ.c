/*
 * XREFs of ??0CSpatialCrossProcessBaseEndpoint@@IEAA@XZ @ 0x140098F9C
 * Callers:
 *     ??0CSpatialCrossProcessClientEndpoint@@QEAA@XZ @ 0x1400991C8 (--0CSpatialCrossProcessClientEndpoint@@QEAA@XZ.c)
