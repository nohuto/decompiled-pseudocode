/*
 * XREFs of LdrpLogVsmEnclaveLdrInitializeEnclaveTelemetry @ 0x1800DC1F8
 * Callers:
  ...
  if ( v1->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_180181970 > 4 )
    {
      ...
      if ( (_BYTE)v1 )
      {
        ...
        v7 = a1;
        v13 = v5;
        LOBYTE(v1) = tlgWriteTransfer_EtwEventWriteTransfer(v3, (unsigned __int8 *)dword_18014E17A, v4, v5, v5, &v8);
      }
    }
  }
  return (char)v1;
