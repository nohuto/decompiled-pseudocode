/*
 * XREFs of RtlpWow64CtxToAmd64 @ 0x180111C28
 * Callers:
 *     RtlpWow64SetContextOnAmd64 @ 0x1800783F0 (RtlpWow64SetContextOnAmd64.c)
 * Callees:
 *     RtlFnToFxFrame @ 0x18010AA78 (RtlFnToFxFrame.c)
 */
