/*
 * XREFs of RtlpRemoveUserSubFromNameSub @ 0x18004C57C
 * Callers:
 ...
 *     RtlUnsubscribeWnfStateChangeNotification @ 0x1800888D0 (RtlUnsubscribeWnfStateChangeNotification.c)
 *     RtlUnsubscribeWnfNotificationWithCompletionCallback @ 0x1800894C0 (RtlUnsubscribeWnfNotificationWithCompletionCallback.c)
 * Callees:
...
__int64 __fastcall RtlpRemoveUserSubFromNameSub(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  v5 = (volatile signed __int64 *)(qword_180187E00 + 8);
  *a3 = 0;
