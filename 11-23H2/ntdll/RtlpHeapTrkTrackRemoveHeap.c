/*
 * XREFs of RtlpHeapTrkTrackRemoveHeap @ 0x18010CD9C
 * Callers:
...
_QWORD *__fastcall RtlpHeapTrkTrackRemoveHeap(__int64 a1)
{
  ...
  {
    v3 = v2 & 0xF;
    RtlAcquireSRWLockExclusive(*(volatile signed __int64 **)(qword_180188A20 + 8 * v3));
    v4 = (__int64 **)(16LL * v2 + qword_1801886A0);
    v5 = *v4;
    if ( *v4 != (__int64 *)v4 )
    {
      do
...
LABEL_16:
    ...
    RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_180188A20 + 8 * v3));
    ++v2;
  }
  while ( v2 < 0x1EEF );
  while ( 1 )
  {
    ...
    *(_QWORD *)(v11 + 8) = v12;
    ...
    RtlFreeHeap(qword_180188A40, 0, v9);
  }
}
