/*
 * XREFs of RtlpHeapTrkTrackRemoveHeap @ 0x18010CD6C
 * Callers:
...
PVOID *__fastcall RtlpHeapTrkTrackRemoveHeap(PVOID a1)
{
  ...
  {
    v3 = v2 & 0xF;
    RtlAcquireSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_180188A20 + 8 * v3));
    v4 = (PVOID **)(16LL * v2 + qword_1801886A0);
    v5 = *v4;
    if ( *v4 != (PVOID *)v4 )
    {
      do
...
LABEL_16:
    ...
    RtlReleaseSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_180188A20 + 8 * v3));
    ++v2;
  }
  while ( v2 < 0x1EEF );
  while ( 1 )
