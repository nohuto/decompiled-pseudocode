/*
 * XREFs of TppCleanupGroupMemberInitialize @ 0x180033284
 * Callers:
...
LABEL_12:
    ...
    else
    {
      ...
      v16 = (_QWORD *)(a1 + 152);
      v17 = off_180181A08;
      if ( *off_180181A08 != (_UNKNOWN *)&TppCleanupGroupMemberpNoPoolList )
        __fastfail(3u);
      *v16 = &TppCleanupGroupMemberpNoPoolList;
      *(_QWORD *)(a1 + 160) = v17;
      *v17 = v16;
      off_180181A08 = (_UNKNOWN **)(a1 + 152);
    }
  ...
  InformationActivationContext = TppPoolpReferenceGlobalPool((volatile signed __int32 **)v19, v18, v6, a4);
  if ( InformationActivationContext >= 0 )
    goto LABEL_12;
LABEL_27:
  if ( InformationActivationContext < 0 )
