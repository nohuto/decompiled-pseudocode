 ...
 *     RtlStackDbContextSerialize @ 0x18012D3B4 (RtlStackDbContextSerialize.c)
 ...
 *     RtlpStackDbSegmentRemoveRef @ 0x18012E784 (RtlpStackDbSegmentRemoveRef.c)
 * Callees:
    ...
    while ( 1 )
    {
      if ( (v2 & 1) != 0 )
      {
        ...
        if ( (v2 & 2) != 0 )
        {
          v15 = 0LL;
          v18 = -1;
          v14 = v2 & 0xFFFFFFFFFFFFFFF0uLL;
          v5 = (unsigned __int64)&v14 | v2 & 8 | 7;
          v3 = (v2 & 4) == 0;
        }
        else
        {
