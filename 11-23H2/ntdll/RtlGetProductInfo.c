/*
 * XREFs of RtlGetProductInfo @ 0x180078240
 * Callers:
 *     <none>
 * Callees:
 *     CompareVersions @ 0x180078380 (CompareVersions.c)
        ...
        PDWORD ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  ...
  v17 = xmmword_18013F430;
  v16[2] = SpMajorVersion;
  v16[3] = SpMinorVersion;
  if ( (int)CompareVersions(v16, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1801338B0, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1801338A0, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
