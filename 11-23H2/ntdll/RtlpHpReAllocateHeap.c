/*
 * XREFs of RtlpHpReAllocateHeap @ 0x180041D6C
 * Callers:
        ...
        _WORD *a6)
{
  ...
  {
    v13 = RtlCSparseBitmapBitmaskRead(&unk_180188A90, 2 * ((a3 - qword_180188A88) >> 20));
...
LABEL_38:
  ...
  v29 = RtlCSparseBitmapBitmaskRead(&unk_180188A90, 2 * ((a3 - qword_180188A88) >> 20));
  if ( v29 )
  {
    v28 = v29 - 1;
    if ( v28 != 2 )
