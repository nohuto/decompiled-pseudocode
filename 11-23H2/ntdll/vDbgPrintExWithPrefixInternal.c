/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x180053958
 * Callers:
 *     DbgPrintEx @ 0x1800538D0 (DbgPrintEx.c)
 *     DbgPrint @ 0x180053910 (DbgPrint.c)
 *     LdrpLogDbgPrint @ 0x1800D90D0 (LdrpLogDbgPrint.c)
 *     DbgPrintReturnControlC @ 0x1800EC3F0 (DbgPrintReturnControlC.c)
 *     vDbgPrintEx @ 0x1800EC4B0 (vDbgPrintEx.c)
 *     vDbgPrintExWithPrefix @ 0x1800EC4E0 (vDbgPrintExWithPrefix.c)
 * Callees:
 *     RtlRaiseException @ 0x180054840 (RtlRaiseException.c)
 *     __security_check_cookie @ 0x18008EF90 (__security_check_cookie.c)
 *     _vsnprintf @ 0x180090CD0 (_vsnprintf.c)
 *     ZwQueryDebugFilterState @ 0x1800A37E0 (ZwQueryDebugFilterState.c)
 *     DbgBreakPointWithStatus @ 0x1800A4BD0 (DbgBreakPointWithStatus.c)
 *     DebugPrint @ 0x1800A4BE0 (DebugPrint.c)
