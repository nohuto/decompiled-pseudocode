/*
 * XREFs of RtlpAddVectoredHandler @ 0x180084C10
 * Callers:
 *     RtlAddVectoredExceptionHandler @ 0x180084C00 (RtlAddVectoredExceptionHandler.c)
 *     RtlAddVectoredContinueHandler @ 0x1800AFDD0 (RtlAddVectoredContinueHandler.c)
 * Callees:
...
_QWORD *__fastcall RtlpAddVectoredHandler(int a1, __int64 a2, unsigned int a3)
{
  ...
  v3 = a3;
  if ( (int)LdrEnsureMrdataHeapExists() >= 0 && ((int)RtlQueryProtectedPolicy(&unk_18013A148) < 0 || !v19) )
  {
