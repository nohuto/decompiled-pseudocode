/*
 * XREFs of ?ChunkAllocate@?$RTL_BINARY_ARRAY@URTLP_FLS_SLOT@@$07$03@@SAPEAURTL_BINARY_ARRAY_CHUNK@1@PEAU1@K@Z @ 0x1800529EC
 * Callers:
...
_OWORD *__fastcall RTL_BINARY_ARRAY<RTLP_FLS_SLOT,8,4>::ChunkAllocate(__int64 a1, unsigned int a2)
{
  ...
  v3 = a2;
  v4 = 1 << (a2 + 4);
  Heap = (_OWORD *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 8 * v4 + 8);
  v6 = Heap;
  if ( Heap )
  {
    *Heap = 0LL;
