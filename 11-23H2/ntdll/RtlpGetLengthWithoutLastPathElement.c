/*
 * XREFs of RtlpGetLengthWithoutLastPathElement @ 0x180077DB4
 * Callers:
 *     RtlGetLengthWithoutLastFullDosOrNtPathElement @ 0x180077DA0 (RtlGetLengthWithoutLastFullDosOrNtPathElement.c)
 * Callees:
