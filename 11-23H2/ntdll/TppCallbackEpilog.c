/*
 * XREFs of TppCallbackEpilog @ 0x18003620C
 * Callers:
 ...
 *     ZwReleaseMutant @ 0x1800A12B0 (ZwReleaseMutant.c)
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( !v2 )
          {
            memset_thunk_772440563353939046(a1, 0, 0x90uLL);
            return;
          }
...
LABEL_49:
  ...
  memset_thunk_772440563353939046(a1, 0, 0x100uLL);
