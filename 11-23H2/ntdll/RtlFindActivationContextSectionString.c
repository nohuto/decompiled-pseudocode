/*
 * XREFs of RtlFindActivationContextSectionString @ 0x18001D420
 * Callers:
        ...
        PACTCTX_SECTION_KEYED_DATA ReturnedData)
{
  ...
  struct _TEB *v28; // [rsp+50h] [rbp-30h] BYREF
  ...
  if ( result >= 0 )
  {
    ...
    if ( (Flags & 0xFFFFFFF8) != 0 )
      return -1073741811;
    v34 = 0;
    result = RtlpFindNextActivationContextSection(&v30, &v29, &v25, &v28);
    if ( result >= 0 )
    {
      v12 = v25;
      if ( v25 < 0x2C )
...
LABEL_60:
      ...
      result = RtlpFindUnicodeStringInSection(v29, v12, v6, ReturnedData, &v27, &v26);
      if ( result >= 0 )
      {
