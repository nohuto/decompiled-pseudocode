/*
 * XREFs of RtlpCompareKnownObjectAces @ 0x1800F3040
 * Callers:
...
char __fastcall RtlpCompareKnownObjectAces(unsigned __int8 *a1, unsigned __int8 *a2, _WORD *a3, _WORD *a4)
{
  ...
  if ( !RtlEqualSid(v20, &a1[v19 + (v16 != 0 ? 28LL : 12LL)]) )
  {
    if ( (a2[1] & 3 | ~a2[1] & 8) != 8 || !a3 && !a4 )
      return 0;
    v23 = 0;
    v24 = 768;
    if ( (int)RtlInitializeSid((__int64)v25, (__int64)&v23, 1u) < 0 )
      return 0;
    v26 = 0;
    if ( !RtlEqualPrefixSid(&a1[v19 + (v16 != 0 ? 28LL : 12LL)], v25) )
      return 0;
    v21 = *(_DWORD *)&a1[v19 + (v16 != 0 ? 36LL : 20LL)];
    if ( v21 )
    {
      if ( v21 != 1 || !a4 )
        return 0;
