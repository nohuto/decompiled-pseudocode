/*
 * XREFs of RtlpHpSizeHeap @ 0x18003ACD0
 * Callers:
...
__int64 __fastcall RtlpHpSizeHeap(__int64 a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  {
    v16 = qword_180187F48 ^ *(_DWORD *)(v15 + 40) ^ ((unsigned int)v15 >> 12);
    ...
    else
    {
      ...
      if ( (v24 & 1) != 0 )
      {
        ...
        v26 = (unsigned __int16)qword_180187F48 ^ v25;
        if ( (v24 & 2) != 0 )
        {
          v27 = (unsigned __int16)qword_180187F48 ^ (unsigned __int64)v25;
