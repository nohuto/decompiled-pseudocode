/*
 * XREFs of RtlpConstructCrossVmObjectPath @ 0x1801029DC
 * Callers:
 *     RtlConstructCrossVmMutexPath @ 0x1801029D0 (RtlConstructCrossVmMutexPath.c)
 * Callees:
...
__int64 __fastcall RtlpConstructCrossVmObjectPath(_UNICODE_STRING *a1, GUID *a2, GUID *a3)
{
  ...
  {
    appended = RtlAppendUnicodeStringToString(&Destination, &stru_1801348A8);
    if ( appended < 0
