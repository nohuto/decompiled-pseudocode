/*
 * XREFs of RtlpHpTagQueryTags @ 0x18008BC00
 * Callers:
    ...
    if ( (v8 & 1) != 0 )
    {
      ...
      *((_WORD *)a1 + 1) = v9;
      if ( (v9 & 2) != 0 )
      {
        ...
        Mapping = RtlpHpTagContextFindMapping((__int64)&RtlpHpTagContext, (__int64)(a1 + 3), v18);
        a1[2] = 1LL;
        if ( Mapping )
      ...
      else
      {
        ...
        v12 = &v10[24 * v11];
        RtlAcquireSRWLockShared(&RtlpHpTagContext);
        if ( (unsigned int)dword_180185DE8 > v11 )
        {
          v7 = -1073741789;
          *a3 = 8 * (3LL * (unsigned int)dword_180185DE8 + 3);
          RtlReleaseSRWLockShared(&RtlpHpTagContext);
        }
        else
        {
          v13 = (__int64 *)qword_180185DF0;
          v14 = qword_180185DF0;
          if ( v10 < v12 )
          {
            while ( v14 )
...
LABEL_12:
            ...
            for ( ++v13;
                  (unsigned __int64)v13 < qword_180185DF0 + 8 * ((unsigned __int64)(unsigned int)dword_180185DEC >> 5);
                  ++v13 )
            {
              v14 = *v13;
              if ( (*v13 & 1) == 0 )
