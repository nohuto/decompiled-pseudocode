/*
 * XREFs of RtlGetFullPathName_Ustr @ 0x18001C0C0
 * Callers:
  ...
  if ( v17 != 2 )
  {
    switch ( v17 )
    {
      ...
      case 3:
        ...
        v76 = NLS_UPCASE(qword_180184808, *p_CurrentDirectory->DosPath.Buffer);
        v49 = NLS_UPCASE(qword_180184808, **((unsigned __int16 **)a1 + 1));
        v50 = v49;
        v77 = v49;
        if ( v51 == v49 )
        {
