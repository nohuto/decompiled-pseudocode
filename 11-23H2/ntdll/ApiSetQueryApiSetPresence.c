/*
 * XREFs of ApiSetQueryApiSetPresence @ 0x180077770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ApiSetQueryApiSetPresence(unsigned __int16 *a1, char *a2)
{
  ...
  LdrpLogDllState(0LL, (__int64)a1, 0x14D0u);
  v5 = ApiSetResolveToHost(ApiSetMap, a1, 0LL, a2, (__int64)v8);
  if ( v5 >= 0 && *a2 )
  {
    if ( v8[0] )
      v6 = 5329;
  ...
  LdrpLogDllState(0LL, (__int64)a1, v6);
  if ( v5 < 0 )
