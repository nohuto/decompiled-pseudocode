/*
 * XREFs of LdrpLoadContextReplaceModule @ 0x180073404
 * Callers:
 ...
 *     LdrpDependencyExist @ 0x18002AB74 (LdrpDependencyExist.c)
 *     RtlAcquireSRWLockExclusive @ 0x180037D80 (RtlAcquireSRWLockExclusive.c)
 *     RtlFreeHeap @ 0x18003B030 (RtlFreeHeap.c)
 *     LdrpQueueWork @ 0x180073560 (LdrpQueueWork.c)
 */

signed __int64 __fastcall LdrpLoadContextReplaceModule(__int64 a1, __int64 a2)
{
  __int64 v4; // r8
  __int64 v5; // rdi
  int v6; // eax
