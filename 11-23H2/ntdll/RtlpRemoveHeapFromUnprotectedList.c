/*
 * XREFs of RtlpRemoveHeapFromUnprotectedList @ 0x180048E8C
 * Callers:
...
void **__fastcall RtlpRemoveHeapFromUnprotectedList(__int64 a1)
{
  ...
  if ( NumberOfHeaps && (_WORD)result && (unsigned __int16)result <= NumberOfHeaps )
  {
    ...
    if ( v7 )
    {
      v8 = HIWORD(dword_180185FC8);
      v9 = HIWORD(dword_180185FB8);
      v10 = word_180185FAA;
      do
      {
        v11 = (__int64)*v5++;
      ...
      while ( v7 );
      HIWORD(dword_180185FC8) = v8;
      HIWORD(dword_180185FB8) = v9;
      word_180185FAA = v10;
    }
    --v1->NumberOfHeaps;
