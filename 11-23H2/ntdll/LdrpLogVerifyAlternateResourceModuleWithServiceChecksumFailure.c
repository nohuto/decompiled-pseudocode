/*
 * XREFs of LdrpLogVerifyAlternateResourceModuleWithServiceChecksumFailure @ 0x1800DBEC8
 * Callers:
        ...
        __int64 a3)
{
  ...
  v6 = RtlRunOnceExecuteOnce(&stru_1801883E8, LdrpResReportResourceAccessInternalInitOnce, 0LL, 0LL);
  if ( v6 >= 0 && (unsigned int)dword_180181938 > 5 )
  {
    LOBYTE(v6) = tlgKeywordOn((__int64)&dword_180181938, 0x200000000000LL);
    if ( (_BYTE)v6 )
    {
      v13 = 0x1000000LL;
      v16 = 8LL;
      ...
      LOBYTE(v6) = tlgWriteTransfer_EtwEventWriteTransfer(
                     v7,
                     (unsigned __int8 *)dword_18014DC3E,
                     (unsigned int)(v9 + 4),
                     v8,
                     9u,
                     &v14);
