/*
 * XREFs of TppAllocAlpcCompletion @ 0x18004B874
 * Callers:
 *     TpAllocAlpcCompletionEx @ 0x18004B850 (TpAllocAlpcCompletionEx.c)
 *     TpAllocAlpcCompletion @ 0x180089190 (TpAllocAlpcCompletion.c)
 * Callees:
