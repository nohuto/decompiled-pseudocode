/*
 * XREFs of RtlpHpLfhSubsegmentFreeBlock @ 0x18003C490
 * Callers:
 ...
 *     RtlpHpLfhSubsegmentFindEmptyUnits @ 0x18006797C (RtlpHpLfhSubsegmentFindEmptyUnits.c)
...
__int64 __fastcall RtlpHpLfhSubsegmentFreeBlock(unsigned __int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v7 = a1;
  v8 = 0LL;
  v9 = qword_180187F48 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
  if ( !a3 )
    goto LABEL_16;
  v10 = a3 - HIWORD(v9) - a2;
  v11 = *(_QWORD *)(a1
