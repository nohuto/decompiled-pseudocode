/*
 * XREFs of PsspDuplicateSnapshotRemoteToRemote @ 0x18012C484
 * Callers:
...
__int64 __fastcall PsspDuplicateSnapshotRemoteToRemote(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, char a5)
{
  ...
  __int64 v44[111]; // [rsp+500h] [rbp+400h] BYREF
  unsigned int v45; // [rsp+878h] [rbp+778h]
  __int64 v46; // [rsp+880h] [rbp+780h]
  __int64 v47; // [rsp+888h] [rbp+788h]
  __int64 v48; // [rsp+898h] [rbp+798h]
  __int64 v49; // [rsp+8B0h] [rbp+7B0h]
  __int64 v50; // [rsp+8D0h] [rbp+7D0h]
  __int64 v51; // [rsp+8F0h] [rbp+7F0h]
  __int64 v52; // [rsp+968h] [rbp+868h]
  ...
  *a4 = 0LL;
  ...
  if ( v29 == 1144 )
  {
    if ( LODWORD(v44[0]) == 1146311504 )
    {
      if ( (unsigned int)Feature_2838281531__private_IsEnabledDeviceUsage() )
      {
        VirtualMemory = PssValidateSnapshotDescriptor(v44);
        if ( VirtualMemory < 0 )
          goto LABEL_44;
      }
      if ( LODWORD(v44[0]) == 1146311504 )
      {
        v6 = (unsigned __int64)v45 << 6;
