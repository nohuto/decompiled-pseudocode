/*
 * XREFs of RtlpSetPreferredUILanguages @ 0x1800FD570
 * Callers:
 ...
 *     RtlpGetMultiStringLength @ 0x1800FC9E0 (RtlpGetMultiStringLength.c)
 *     RtlpSetInstallLanguage @ 0x1800FCEB0 (RtlpSetInstallLanguage.c)
 *     RtlpSetMachineUILanguagesImmediate @ 0x1800FD398 (RtlpSetMachineUILanguagesImmediate.c)
 *     RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId @ 0x180112B18 (RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId.c)
 */
...
LABEL_77:
    ...
    {
      v38 = (WCHAR *)&unk_1801547EC;
      LODWORD(Data[0]) = 262146;
      Data[1] = &unk_1801547EC;
      v35 = 2;
      v3 = v12;
    }
    if ( (v3 & 0x400) != 0 )
