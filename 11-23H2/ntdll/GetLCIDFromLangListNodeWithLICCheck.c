/*
 * XREFs of GetLCIDFromLangListNodeWithLICCheck @ 0x18001EA5C
 * Callers:
 ...
 *     RtlGetThreadLangIdByIndex @ 0x1800FB620 (RtlGetThreadLangIdByIndex.c)
 * Callees:
...
LABEL_11:
    ...
    RtlInitUnicodeString(
      ...
      (PCWSTR)(*(_QWORD *)(*(_QWORD *)(v9 + 32) + 24LL)
             + 2LL * *(__int16 *)(*(_QWORD *)(*(_QWORD *)(v9 + 32) + 16LL) + 2 * v17)));
  ...
  {
    InstalledLanguageIndexByName = RtlpMuiRegGetInstalledLanguageIndexByName(v9, DestinationString.Buffer, 1, v20);
  }
  else
  {
    if ( (int)RtlpIsALicensedRegularLanguage((_QWORD *)v9, DestinationString.Buffer) >= 0 )
      return v7;
