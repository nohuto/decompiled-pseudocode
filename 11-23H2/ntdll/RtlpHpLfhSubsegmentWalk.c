/*
 * XREFs of RtlpHpLfhSubsegmentWalk @ 0x18008BDF4
 * Callers:
 *     RtlpHpSegWalk @ 0x180063BB0 (RtlpHpSegWalk.c)
 * Callees:
 *     RtlReleaseSRWLockShared @ 0x180026CF0 (RtlReleaseSRWLockShared.c)
 *     RtlAcquireSRWLockShared @ 0x180026DB0 (RtlAcquireSRWLockShared.c)
 *     RtlpHpLfhSubsegmentSizeBlockInternal @ 0x18008C080 (RtlpHpLfhSubsegmentSizeBlockInternal.c)
 */
        ...
        __int64 a7)
{
  ...
  v8 = qword_180187F48 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
...
LABEL_12:
    ...
    v19 = a2 + v23;
    v39 = (((unsigned int)(unsigned __int16)v8 + (_DWORD)v23 - 1) >> v21) + 1;
    v37 = a2 + *(unsigned __int16 *)(a2 + 46);
    RtlAcquireSRWLockShared((volatile signed __int64 *)(a2 + 24), v23, v13, i);
