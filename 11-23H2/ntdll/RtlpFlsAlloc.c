/*
 * XREFs of RtlpFlsAlloc @ 0x180074830
 * Callers:
 *     RtlFlsAlloc @ 0x180074810 (RtlFlsAlloc.c)
 * Callees:
...
__int64 __fastcall RtlpFlsAlloc(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int *a5)
{
  ...
  while ( 1 )
  {
    v8 = RTL_BINARY_ARRAY<RTLP_FLS_CALLBACK_ENTRY,8,4>::SlotAllocate(&xmmword_180187ED8);
    v9 = v8;
    if ( v8 == -1 )
    {
      v6 = -1073741801;
  ...
  {
    v6 = -1073741801;
    RTL_BINARY_ARRAY<RTLP_FLS_CALLBACK_ENTRY,8,4>::SlotFree((__int64)&xmmword_180187ED8, v8);
LABEL_20:
  ...
  *(_QWORD *)v14 = 0LL;
  v15 = qword_180187F28;
  if ( v10 > (unsigned int)qword_180187F28 )
    v15 = v9 - 16;
  LODWORD(qword_180187F28) = v15;
  RtlReleaseSRWLockExclusive(&RtlpFlsContext);
  *a5 = v10;
  return v6;
}
