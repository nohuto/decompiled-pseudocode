/*
 * XREFs of RtlQueryProcessHeapInformation @ 0x1800E36A0
 * Callers:
...
LABEL_34:
  ...
  if ( !RtlpGlobalTagHeap || !*(_QWORD *)(RtlpGlobalTagHeap + 232) )
    goto LABEL_10;
  v6 = RtlpCommitQueryDebugInfo((_QWORD *)a1, 0x60u);
  v7 = v6;
  v33 = (__int64)v6;
  if ( v6 )
  {
    memset_thunk_772440563353939046(v6, 0, 0x60uLL);
    *(_QWORD *)v7 = v5;
    *((_DWORD *)v7 + 2) = *(_DWORD *)(v5 + 112);
    *((_WORD *)v7 + 6) = 16;
    *((_QWORD *)v7 + 11) = RtlpGetHeapTag(v5);
    ++*(_DWORD *)v3;
LABEL_10:
    v8 = 0;
    for ( i = 0; ; i = v8 )
...
LABEL_37:
  ...
  {
    qword_180186070 = 0LL;
    v25 = _InterlockedCompareExchange(&dword_180186068, -1, -2);
    if ( v25 != -2 )
    {
      ...
      v41 = 0;
      while ( v25 != _InterlockedCompareExchange(&dword_180186068, (v25 & 2 | 1) + v25, v25) )
      {
        RtlBackoff(&v41);
