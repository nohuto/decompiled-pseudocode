/*
 * XREFs of TpAllocPoolInternal @ 0x18004C010
 * Callers:
 ...
 *     NtCreateIoCompletion @ 0x1800A24A0 (NtCreateIoCompletion.c)
 *     NtCreateWorkerFactory @ 0x1800A2900 (NtCreateWorkerFactory.c)
...
LABEL_35:
      ...
      *(_QWORD *)(Heap + 400) = retaddr;
      ...
      if ( updated >= 0 )
      {
        ...
        v24 = (_QWORD *)(Heap + 384);
        v25 = off_1801814E0;
        if ( *off_1801814E0 != (_UNKNOWN *)&TppPoolpList )
          __fastfail(3u);
        *v24 = &TppPoolpList;
        *(_QWORD *)(Heap + 392) = v25;
        *v25 = v24;
        off_1801814E0 = (_UNKNOWN **)(Heap + 384);
