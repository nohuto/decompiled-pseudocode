/*
 * XREFs of RtlFindClearRuns @ 0x1800F86B0
 * Callers:
 *     RtlFindLongestRunClear @ 0x1800F8990 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
        ...
        BOOLEAN LocateLongestRuns)
{
  ...
  while ( 1 )
  {
    ...
    if ( v16 == v18 && v8 )
    {
      v19 |= byte_180146378[SizeOfBitMap & 7];
      v16 = v42;
    }
    if ( !v19 )
    {
...
LABEL_20:
    ...
    v5 = v17 - v15 + 8;
    v25 = *((_BYTE *)&unk_180146380 - v15) | byte_180146368[v20] | v19;
    v38 = v5;
    if ( v25 != 0xFF )
    {
      do
