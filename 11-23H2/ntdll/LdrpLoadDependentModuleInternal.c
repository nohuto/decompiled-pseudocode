  ...
  while ( v51 < (wchar_t *)((char *)String1.Buffer + String1.Length) )
  {
    ...
    if ( (_WORD)v53 != (_WORD)v54 )
    {
      if ( (unsigned int)v53 >= 0x61 )
      {
        ...
        {
          if ( qword_180184808 && (unsigned __int16)v53 >= 0xC0u )
            LOWORD(v53) = *(_WORD *)(qword_180184808
                                   + 2
                                   * ((v53 & 0xF)
                                    + *(unsigned __int16 *)(qword_180184808
                                                          + 2LL
      ...
      if ( (unsigned int)v54 >= 0x61 )
      {
        ...
        {
          if ( qword_180184808 && (unsigned __int16)v54 >= 0xC0u )
            LOWORD(v54) = *(_WORD *)(qword_180184808
                                   + 2
                                   * ((v54 & 0xF)
                                    + *(unsigned __int16 *)(qword_180184808
                                                          + 2LL
