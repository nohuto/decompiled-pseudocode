/*
 * XREFs of RtlpTimeToTimeFieldsNoLeapSeconds @ 0x1800F1A18
 * Callers:
 *     RtlpTimeToTimeFields @ 0x1800596C0 (RtlpTimeToTimeFields.c)
 * Callees:
 *     TimeToDaysAndFraction @ 0x1800F1BEC (TimeToDaysAndFraction.c)
 */
