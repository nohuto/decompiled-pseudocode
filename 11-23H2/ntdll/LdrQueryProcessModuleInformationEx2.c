/*
 * XREFs of LdrQueryProcessModuleInformationEx2 @ 0x1800D9808
 * Callers:
...
__int64 __fastcall LdrQueryProcessModuleInformationEx2(void *a1, __int64 a2, _WORD *a3, unsigned int a4, int *a5)
{
  ...
  {
    v22 = LdrpQueryProcessModuleInformationLoopDetectorCount;
    v11 = 1;
    if ( v10 )
      *v10 = v7;
    v30 = a2 & 2;
    ...
    Memory = ((__int64 (__fastcall *)(void *, __int64 *, __int64 *))off_180133F50[v12])(v6, &v26, &v29);
    if ( Memory < 0 )
    {
LABEL_15:
      v8 = Memory;
    ...
    if ( v26 )
    {
      Memory = ((__int64 (__fastcall *)(void *, __int64, __int64 *))off_180133F50[v21 + 1])(v6, v26, &v23);
      if ( Memory < 0 )
        goto LABEL_15;
      while ( v23 != v26 )
      {
        ...
        {
          *v5 = 320;
          Memory = ((__int64 (__fastcall *)(void *, _WORD *, __int64, __int64, __int64))off_180133F50[v21 + 2])(
                     v6,
                     v5 + 4,
                     v23,
                     v29,
        ...
        Memory = ((__int64 (__fastcall *)(void *, __int64, __int64 *))off_180133F50[v21 + 1])(v6, v23, &v23);
        if ( Memory < 0 )
          goto LABEL_15;
      }
    }
