/*
 * XREFs of RtlpCommitQueryDebugInfo @ 0x180001934
 * Callers:
 *     RtlQueryProcessModuleInformation @ 0x1800014C0 (RtlQueryProcessModuleInformation.c)
 *     RtlpWalkCallbackRoutine @ 0x1800AFB50 (RtlpWalkCallbackRoutine.c)
 *     RtlCommitDebugInfo @ 0x1800E34F0 (RtlCommitDebugInfo.c)
