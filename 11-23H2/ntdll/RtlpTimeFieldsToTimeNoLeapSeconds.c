/*
 * XREFs of RtlpTimeFieldsToTimeNoLeapSeconds @ 0x18005949C
 * Callers:
 *     RtlpTimeFieldsToTime @ 0x180059390 (RtlpTimeFieldsToTime.c)
 * Callees:
 *     <none>
 */
...
char __fastcall RtlpTimeFieldsToTimeNoLeapSeconds(__int16 *a1, _QWORD *a2)
{
  ...
  *a2 = 10000
      * (v9
       + 1000 * (v8 + 60 * (v7 + 60 * v5))
       + 86400000LL * (int)(v4 + (v10 >> 2) + 365 * v10 - v10 / 0x64 + v10 / 0x190 + v14));
  return result;
}
