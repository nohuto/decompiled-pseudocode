/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x180077900
 * Callers:
...
ULONG __cdecl RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_1801483C4[8 * v5] )
        {
          v8 = (unsigned __int16)word_1801483C6[4 * v5];
          if ( byte_1801483C5[8 * v5] == 1 )
