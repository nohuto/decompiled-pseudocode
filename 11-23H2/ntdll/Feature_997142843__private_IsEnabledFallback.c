/*
 * XREFs of Feature_997142843__private_IsEnabledFallback @ 0x18009F510
 * Callers:
...
__int64 __fastcall Feature_997142843__private_IsEnabledFallback(__int64 a1, unsigned int a2)
{
