/*
 * XREFs of RtlNumberOfSetBits @ 0x180080370
 * Callers:
 *     RtlNumberOfClearBits @ 0x18008CC60 (RtlNumberOfClearBits.c)
...
ULONG __cdecl RtlNumberOfSetBits(PRTL_BITMAP BitMapHeader)
{
  ...
  for ( i = 0; v9; --v9 )
  {
    ...
    if ( i == v7 - 1 && v4 )
      v12 &= byte_180146368[SizeOfBitMap & 7];
    ++i;
  ...
  if ( v8 )
  {
    ...
    do
    {
      ...
      Buffer = (unsigned int *)((char *)Buffer + 1);
      if ( i == v19 && v4 )
        v20 &= byte_180146368[SizeOfBitMap & 7];
      ++i;
