/*
 * XREFs of RtlpHpSegAlloc @ 0x180034D48
 * Callers:
...
__int64 __fastcall RtlpHpSegAlloc(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5)
{
  ...
  if ( !v15 )
    v18 = a5;
  if ( (int)RtlpHpSegPageRangeCommit(a1, v13, 0, v6, v18, 0LL) < 0 )
  {
    v16 = 0LL;
...
LABEL_6:
    if ( v8 )
      RtlpHpSegPageRangeCommit(a1, v13, v11 - 1, v11 - (v14 << *(_BYTE *)(a1 + 9)) - 1, 0, 0LL);
