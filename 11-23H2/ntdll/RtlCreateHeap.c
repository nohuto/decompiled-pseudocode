...
__int64 __fastcall RtlCreateHeap(unsigned int a1, char *a2, __int64 a3, unsigned __int64 a4, __int64 a5, __int64 a6)
{
  ...
  *(_QWORD *)&v72 = a5;
  ...
  v60 = 0LL;
  v62 = 0LL;
  if ( !dword_180181238 || a2 || a5 )
  {
    if ( dword_180181248 && a6 == 1 )
      v10 = (a1 & 0x100) == 0;
  }
  else
  {
    v12 = (_DWORD *)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_180181268)(a1, 0LL);
    if ( v12 )
    {
LABEL_93:
      v26 = v61;
...
LABEL_120:
  ...
  if ( v12 )
  {
    ...
    if ( (v12[1] & 1) != 0 )
    {
      if ( dword_180181248 )
      {
        v12 = (_DWORD *)((__int64 (__fastcall *)(_QWORD, char *, __int64, unsigned __int64, _QWORD, _QWORD))qword_180181268)(
                          v11,
                          a2,
                          v68,
                          a4,
