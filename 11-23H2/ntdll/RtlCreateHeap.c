/*
 * XREFs of RtlCreateHeap @ 0x180047FD0
 * Callers:
 ...
 *     RtlpHpConvertCreationFlags @ 0x180085ADC (RtlpHpConvertCreationFlags.c)
        ...
        PVOID Parameters)
{
  ...
  *(_QWORD *)&v72 = Lock;
  ...
  HeapHandle = 0LL;
  v62 = 0LL;
  if ( !dword_180181238 || HeapBase || Lock )
  {
    if ( dword_180181248 && Parameters == (PVOID)1 )
      v10 = (Flags & 0x100) == 0;
  }
  else
  {
    v12 = (_DWORD *)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_180181268)(Flags, 0LL);
    if ( v12 )
    {
LABEL_93:
...
LABEL_120:
  ...
  if ( v12 )
  {
    ...
    if ( (v12[1] & 1) != 0 )
    {
      if ( dword_180181248 )
      {
        v12 = (_DWORD *)((__int64 (__fastcall *)(_QWORD, PVOID, SIZE_T, SIZE_T, _QWORD, _QWORD))qword_180181268)(
                          v11,
                          HeapBase,
                          v68,
                          CommitSize,
...
LABEL_32:
  if ( !*((_QWORD *)&v82 + 1) )
    *((_QWORD *)&v82 + 1) = v20 - qword_180187D80 - 4096;
  v21 = v83;
  ...
  *(_QWORD *)&v83 = v21;
  ...
  if ( (v18 & 0x61000000) != 0 && (v18 & 0x10000000) == 0 )
    return (PVOID)RtlDebugCreateHeap(v18, HeapBase);
  NtGlobalFlag = 704;
  v26 = (_RTL_CRITICAL_SECTION *)v61;
  if ( (v18 & 1) != 0 )
  {
  ...
  if ( HeapBase )
  {
    if ( *((_QWORD *)&v84 + 1) )
    {
      if ( !*((_QWORD *)&v83 + 1) || !(_QWORD)v84 || *((_QWORD *)&v83 + 1) > (unsigned __int64)v84 || (v18 & 2) != 0 )
        goto LABEL_184;
      v67 = HeapBase;
      v30 = (char *)HeapBase + *((_QWORD *)&v83 + 1);
      v64 = v84;
      memset_thunk_772440563353939046(HeapBase, 0, 0x1000uLL);
      v29 = (char *)HeapBase;
    }
    else
    {
      ...
      if ( v76 == 4096 )
      {
        if ( (v18 & 0x40000) != 0 && (v77 & 0x40) == 0 )
          goto LABEL_185;
        memset_thunk_772440563353939046(MemoryInformation[0], 0, 0x1000uLL);
...
LABEL_184:
  ...
  if ( v69 )
  {
    RtlpSecMemFreeVirtualMemory(v27, &BaseAddress, &v69, 0x8000u);
    v28 = (char *)BaseAddress + v69;
...
LABEL_59:
  if ( v29 == v30 )
  {
    if ( ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &v67, 0LL, &v66, 0x1000u, (v18 & 0x40000) != 0 ? 64 : 4) < 0 )
      goto LABEL_185;
    v31 = 2147353472LL;
  ...
  *((_DWORD *)HeapHandle + 162) = 1;
  ...
  v36[29] = v18 & 0x6001007D;
  *((_WORD *)HeapHandle + 105) = v33 - (_WORD)HeapHandle;
...
LABEL_71:
  ...
  *((_DWORD *)HeapHandle + 30) |= 0x80000000;
         ...
         (ULONG_PTR)v67 + v64 - v68) )
  {
    ...
    *(_QWORD *)(v33 + 32) = (char *)HeapHandle + 336;
    *(_QWORD *)(v33 + 48) = v33 + 72;
    RtlpPopulateListIndex((__int64)HeapHandle, v33, v41);
    *((_WORD *)HeapHandle + 104) = 0;
    *((_QWORD *)HeapHandle + 20) = *((_QWORD *)&v80 + 1);
    *((_QWORD *)HeapHandle + 21) = v81;
    *((_QWORD *)HeapHandle + 22) = *((_QWORD *)&v81 + 1) >> 4;
    *((_QWORD *)HeapHandle + 23) = (unsigned __int64)v82 >> 4;
    *((_QWORD *)HeapHandle + 25) = *((_QWORD *)&v82 + 1);
    *((_DWORD *)HeapHandle + 37) = (unsigned __int64)(v83 + 15) >> 4;
    *((_QWORD *)HeapHandle + 45) = RtlpHeapKey ^ *((_QWORD *)&v84 + 1);
...
LABEL_81:
      ...
      if ( *((_WORD *)HeapHandle + 104) )
      {
        ...
        if ( *(_BYTE *)v44 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        {
          ...
          RtlpLogHeapCreateEvent((_DWORD)HeapHandle, v18, v64, v66, *(unsigned __int8 *)v31);
        }
        v45 = 2147353482LL;
        if ( RtlGetCurrentServiceSessionId() )
