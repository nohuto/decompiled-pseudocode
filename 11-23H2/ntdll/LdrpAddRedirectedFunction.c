/*
 * XREFs of LdrpAddRedirectedFunction @ 0x1800E09C4
 * Callers:
 ...
 *     LdrpHashAsciizString @ 0x1800E1AD8 (LdrpHashAsciizString.c)
 */
...
LABEL_23:
          ...
          if ( Heap )
          {
            ...
            *(_WORD *)(Heap + 42) = v13;
            ...
            if ( (qword_180188408 & 1) != 0 && LdrpRedirectionTree )
              v14 = (unsigned __int64)&LdrpRedirectionTree ^ LdrpRedirectionTree;
            v15 = 0;
            v16 = qword_180188408 & 1;
            if ( v14 )
            {
              while ( 1 )
              {
