/*
 * XREFs of RtlpGetNormalization @ 0x180089D98
 * Callers:
 ...
 *     NormalizationList__Lookup @ 0x180089EB8 (NormalizationList__Lookup.c)
...
LABEL_6:
    ...
    if ( Heap )
    {
      ...
      {
        *(_DWORD *)(v11 + 16) = a1;
        v13 = (__int64 *)off_180181570;
        if ( *off_180181570 != (_UNKNOWN *)&NormalizationListHead )
          __fastfail(3u);
        *(_QWORD *)v11 = &NormalizationListHead;
        *(_QWORD *)(v11 + 8) = v13;
        *v13 = v11;
        off_180181570 = (_UNKNOWN **)v11;
        goto LABEL_3;
      }
