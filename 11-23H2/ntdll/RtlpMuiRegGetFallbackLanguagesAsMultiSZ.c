/*
 * XREFs of RtlpMuiRegGetFallbackLanguagesAsMultiSZ @ 0x1801130C4
 * Callers:
 ...
 *     RtlpMuiRegGetFallbackLanguageInfoByIndex @ 0x180112C48 (RtlpMuiRegGetFallbackLanguageInfoByIndex.c)
 */
