/*
 * XREFs of RtlpMuiRegGetFallbackLanguagesAsMultiSZ @ 0x1801130F4
 * Callers:
 ...
 *     RtlpMuiRegGetFallbackLanguageInfoByIndex @ 0x180112C78 (RtlpMuiRegGetFallbackLanguageInfoByIndex.c)
 */
