/*
 * XREFs of RtlQueueWorkItem @ 0x18004CA10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
          ...
          *((_DWORD *)BaseAddress + 2) = 0;
          ...
          {
            v20 = 1;
            if ( (unsigned __int64)*v11 < *((_QWORD *)&xmmword_18019C530 + 1)
              || (unsigned __int64)*v11 >= *((_QWORD *)&xmmword_18019C530 + 1)
            ...
            {
              *(_OWORD *)DllHandle = xmmword_18019C530;
              v37 = qword_18019C540;
            }
            v14 = DllHandle[1];
