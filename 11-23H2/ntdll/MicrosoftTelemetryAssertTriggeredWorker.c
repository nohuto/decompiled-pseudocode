  ...
  if ( !(unsigned int)TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation(&dword_180181530) )
  {
    if ( *(_BYTE *)(a1 + 24) )
    {
      if ( (unsigned int)dword_180181530 <= 5
        || !(unsigned __int8)tlgKeywordOn(&dword_180181530, 0x400000000000LL, v15, v16) )
      {
        goto LABEL_26;
      }
      v26 = v69;
    ...
    v62 = 4LL;
    tlgWriteTransfer_EtwEventWriteTransfer((unsigned int)&dword_180181530, (_DWORD)v21, v18, v19, v34, (__int64)v46);
LABEL_26:
    v22 = qword_180181550;
    qword_180181550 = 0LL;
    dword_180181530 = 0;
