/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x18007C61C
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredUM @ 0x18007C600 (MicrosoftTelemetryAssertTriggeredUM.c)
 * Callees:
 ...
 *     _tlgCreate1Sz_char @ 0x18007CAF8 (_tlgCreate1Sz_char.c)
...
LABEL_4:
  ...
  *(_DWORD *)(i + 8) = (MEMORY[0x7FFE0320] * (unsigned __int64)MEMORY[0x7FFE0004]) >> 24;
  ...
  if ( !*(_QWORD *)(a1 + 32) && ImageTuple )
    *(_QWORD *)(a1 + 32) = v68;
  if ( *(_DWORD *)(i + 16) == 1
    && !(unsigned int)TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation(&dword_1801814F8) )
  {
    if ( dword_1801814F8 )
    {
      v29 = v68[0];
  ...
  if ( !(unsigned int)TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation(&dword_180181530) )
  {
    if ( *(_BYTE *)(a1 + 24) )
    {
      if ( (unsigned int)dword_180181530 <= 5
        || !(unsigned __int8)tlgKeywordOn(&dword_180181530, 0x400000000000LL, v14, v15) )
      {
        goto LABEL_26;
      }
      v25 = v68;
    ...
    v61 = 4LL;
    tlgWriteTransfer_EtwEventWriteTransfer((int)&dword_180181530, (int)v20, v17, v18, v33, &v45);
LABEL_26:
    v21 = qword_180181550;
    qword_180181550 = 0LL;
    dword_180181530 = 0;
