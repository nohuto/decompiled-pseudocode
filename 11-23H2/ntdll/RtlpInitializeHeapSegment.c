/*
 * XREFs of RtlpInitializeHeapSegment @ 0x180047D5C
 * Callers:
        ...
        unsigned __int64 a8)
{
  ...
  if ( v16 >= a7 )
  {
    if ( v16 < a8 )
    {
      ...
      if ( (unsigned int)RtlpHpHeapCheckCommitLimit(a8, v26, a1, (__int64 *)(a1 + 376)) )
      {
...
LABEL_3:
  ...
  *(_BYTE *)(v15 + 14) = v21;
  RtlpCreateUCREntry(a1, a2, v13 - 48, (unsigned int)((_DWORD)v18 << 12), v15, (__int64 *)&a8);
  if ( *(_DWORD *)(a1 + 124) )
  {
