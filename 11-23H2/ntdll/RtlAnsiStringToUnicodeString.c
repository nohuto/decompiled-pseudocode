/*
 * XREFs of RtlAnsiStringToUnicodeString @ 0x180024EF0
 * Callers:
 ...
 *     RtlCreateUnicodeStringFromAsciiz @ 0x18006B4A0 (RtlCreateUnicodeStringFromAsciiz.c)
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  while ( 1 )
  {
    ...
    if ( *(_WORD *)(qword_1801847F0 + 2 * v28) )
      break;
LABEL_48:
    v8 += 2;
    if ( !(_DWORD)Length )
...
LABEL_5:
  ...
  if ( result >= 0 )
  {
    ...
    {
      v15 = Utf8TableInfo;
      v16 = (__int64 *)&xmmword_180184710;
      v17 = WORD6(Utf8TableInfo);
      v18 = xmmword_180184710;
      v19 = qword_180184728;
    }
    else
    {
