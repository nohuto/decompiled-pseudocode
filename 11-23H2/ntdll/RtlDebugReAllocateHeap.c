...
char *__fastcall RtlDebugReAllocateHeap(_DWORD *Src, ULONG a2, char *a3, SIZE_T a4)
{
  ...
  if ( (Src[29] & 0x1000000) != 0 )
    return (char *)((__int64 (*)(void))qword_180181258)();
...
LABEL_67:
  ...
  if ( RtlpValidateHeapEntry((unsigned __int64)Src, v12, "RtlReAllocateHeap") )
  {
    ...
    else
    {
      ...
      if ( !v15 || __PAIR32__(*((_WORD *)Src + 104), v15) != dword_180185FB8 )
        goto LABEL_35;
      if ( NtCurrentPeb()->Ldr )
        DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
      else
...
LABEL_35:
  ...
  if ( v32 )
  {
    ...
    {
      if ( (v24->NtGlobalFlag & 0x800) == 0 || __PAIR32__(*((_WORD *)Src + 104), v31) != dword_180185FB8 )
        goto LABEL_68;
      if ( NtCurrentPeb()->Ldr )
        DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
      else
