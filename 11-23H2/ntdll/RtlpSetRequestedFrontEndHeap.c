/*
 * XREFs of RtlpSetRequestedFrontEndHeap @ 0x18007D2E4
 * Callers:
...
__int64 __fastcall RtlpSetRequestedFrontEndHeap(__int64 a1)
{
    ...
    if ( (*(_DWORD *)(v10 + 12))-- == 1 )
    {
      *(_QWORD *)(v10 + 16) = 0LL;
      ...
      if ( v13 != -2 )
      {
        ...
        v18 = *(_QWORD *)(v10 + 24);
        if ( !v18 )
          v18 = RtlpCreateDeferredCriticalSectionEvent(v10);
        LODWORD(v24) = 0;
  ...
  {
    qword_180186070 = 0LL;
    v14 = _InterlockedCompareExchange(&dword_180186068, -1, -2);
    if ( v14 != -2 )
    {
      ...
      v16 = qword_180186078;
      if ( !qword_180186078 )
        v16 = RtlpCreateDeferredCriticalSectionEvent(&RtlpProcessHeapsListLock);
      v25 = 0;
      while ( v14 != _InterlockedCompareExchange(&dword_180186068, (v14 & 2 | 1) + v14, v14) )
      {
        RtlBackoff(&v25);
