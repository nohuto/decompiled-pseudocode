/*
 * XREFs of RtlpAllocateHeapInternal @ 0x18003CC00
 * Callers:
...
LABEL_22:
        ...
        {
          v28 = *(_QWORD *)(a1 + 48);
          if ( (v28 || (v28 = qword_180187F68) != 0) && v26 > v28 )
          {
            v87 = *(_QWORD *)(a1 + 56);
            if ( v87 )
            {
...
LABEL_80:
        ...
        *(_BYTE *)(v52 + 2) = v53 | (16 * (BYTE1(v31) & 0xFE));
        ...
        {
          v85 = RtlCSparseBitmapBitmaskRead(&unk_180188A90, 2 * ((unsigned __int64)(Heap - qword_180188A88) >> 20));
...
LABEL_76:
                ...
                else
                {
                  ...
                  if ( v60 == 8 )
                  {
                    v62 = (unsigned __int16)qword_180187F48 ^ *(unsigned __int16 *)(v61 + 40) ^ (unsigned __int64)(unsigned __int16)((unsigned int)v61 >> 12);
  ...
  {
    if ( (v7 & 0x1000000) == 0 && !dword_180181238 )
    {
      v10 = *(_QWORD *)(a1 + 392);
      v11 = v10;
      if ( (v10 || (v11 = qword_180187F68) != 0) && a2 > v11 )
      {
        v89 = *(_QWORD *)(a1 + 400);
        if ( v89 )
