/*
 * XREFs of RtlpHpCustomVaCallbacksRegistrarRegister @ 0x180122CB8
 * Callers:
 ...
 *     RtlpHpCustomVaCallbacksEncodedComparison @ 0x180122C38 (RtlpHpCustomVaCallbacksEncodedComparison.c)
 */
