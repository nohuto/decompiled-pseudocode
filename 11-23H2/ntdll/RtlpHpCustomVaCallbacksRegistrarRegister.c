/*
 * XREFs of RtlpHpCustomVaCallbacksRegistrarRegister @ 0x180122CE8
 * Callers:
 ...
 *     RtlpHpCustomVaCallbacksEncodedComparison @ 0x180122C68 (RtlpHpCustomVaCallbacksEncodedComparison.c)
 */
