...
struct _PEB *__fastcall LdrpEtwLogLoaderSnaps(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_BYTE *)v9 )
  {
    ...
    if ( (result->TracingFlags & 4) != 0 )
    {
      ...
      if ( *(char *)v10 < 0 )
      {
        memset_thunk_772440563353939046(v22, 0, 0x100uLL);
        memset_thunk_772440563353939046(v23, 0, 0x100uLL);
        memset_thunk_772440563353939046(v24, 0, 0x200uLL);
        v19 = 0;
        v16 = 0;
...
LABEL_17:
              ...
              v15[0] = 2 * (256 - v13);
              v17 = v24;
              result = (struct _PEB *)RtlMultiByteToUnicodeN((int)v24, 512LL, (__int64)&v14, (__int64)v23, 256 - v13);
              if ( !(_DWORD)result )
