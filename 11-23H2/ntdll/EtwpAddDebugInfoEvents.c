/*
 * XREFs of EtwpAddDebugInfoEvents @ 0x180126168
 * Callers:
...
__int64 __fastcall EtwpAddDebugInfoEvents(__int64 a1, __int64 a2, int a3)
{
  ...
  _BYTE v12[272]; // [rsp+50h] [rbp-348h] BYREF
  _BYTE v13[528]; // [rsp+160h] [rbp-238h] BYREF
  ...
  result = EtwpQueryRegString(
             ...
             0x104u);
  if ( (int)result < 0
    || (result = RtlUnicodeToMultiByteN((__int64)v12, 260LL, 0LL, (__int64)v13, 520), (int)result < 0) )
  {
    v7 = (_QWORD *)(a2 + 88);
  }
  else
  {
    ...
    do
      ++v8;
    while ( v12[v8] );
    result = EtwpAddEventToBuffer(a2, 66, (_QWORD *)(a2 + 88), v12, (int)v8 + 1, v4, v11);
    if ( (int)result < 0 )
      return result;
