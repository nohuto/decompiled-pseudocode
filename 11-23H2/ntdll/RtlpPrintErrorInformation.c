...
ULONG RtlpPrintErrorInformation()
{
  ...
  if ( NtCurrentPeb()->Ldr )
    ...
    DbgPrint("HEAP: ");
  DbgPrint("Heap error detected at %p (heap handle %p)\n", (const void *)qword_1801848C8, (const void *)qword_1801848C0);
  if ( dword_1801848B8 > 8 )
  {
    switch ( dword_1801848B8 )
    {
      case 9:
  ...
  else if ( dword_1801848B8 == 8 )
  {
    v0 = "heap_failure_block_not_busy";
  }
  else if ( dword_1801848B8 )
  {
    switch ( dword_1801848B8 )
    {
      case 1:
  ...
  if ( qword_1801848E0 )
  {
    if ( NtCurrentPeb()->Ldr )
      ...
      DbgPrint("HEAP: ");
    DbgPrint("Parameter3: %p\n", (const void *)qword_1801848E0);
  }
  if ( qword_1801848E8 || qword_1801848F0 )
  {
    if ( NtCurrentPeb()->Ldr )
      DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
    else
    ...
    DbgPrint(
      ...
      (const void *)qword_1801848E8,
      (const void *)qword_1801848F0);
  }
  if ( NtCurrentPeb()->Ldr )
    DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
  else
