/*
 * XREFs of RtlpMuiRegConfigMatchesInstalled @ 0x180112698
 * Callers:
...
LABEL_22:
  ...
  if ( a6 )
  {
    if ( v13 )
    {
      ...
      {
        *a6 = 0LL;
        if ( (int)RtlpMuiRegGetInstalledLanguageIndex(a1, v8, v9, &v28) >= 0 && (v28 & 0x8000u) == 0 )
        {
          v25 = *(_QWORD *)(a1 + 24);
          if ( (__int16)v28 < (int)*(unsigned __int16 *)(v25 + 6) )
            *v19 = *(_QWORD *)(v25 + 16) + 28LL * (__int16)v28;
        }
      }
    }
    else
