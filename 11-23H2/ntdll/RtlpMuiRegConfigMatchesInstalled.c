/*
 * XREFs of RtlpMuiRegConfigMatchesInstalled @ 0x180112668
 * Callers:
 *     RtlpMuiRegValidateConfigNode @ 0x1801142B4 (RtlpMuiRegValidateConfigNode.c)
 * Callees:
        ...
        unsigned __int16 *a7)
{
  ...
  DWORD Lcid; // [rsp+78h] [rbp+38h] BYREF
...
LABEL_22:
  ...
  if ( a6 )
  {
    if ( v13 )
    {
      ...
      {
        *a6 = 0LL;
        if ( (int)RtlpMuiRegGetInstalledLanguageIndex(a1, v8, v9, &Lcid) >= 0 && (Lcid & 0x8000u) == 0 )
        {
          v25 = *(_QWORD *)(a1 + 24);
          if ( (__int16)Lcid < (int)*(unsigned __int16 *)(v25 + 6) )
            *v19 = *(_QWORD *)(v25 + 16) + 28LL * (__int16)Lcid;
        }
      }
    }
    else
