  ...
  if ( ReplyRequested )
  {
    ...
    if ( v13 )
    {
      if ( (unsigned int)dword_1801814A0 > 2 && (unsigned __int8)tlgKeywordOn(&dword_1801814A0, 10LL, v11, v12) )
      {
        ...
        v23 = v13;
        v36 = 4LL;
        tlgWriteTransfer_EtwEventWriteTransfer((int)&dword_1801814A0, (int)&dword_18014E7AB, v20, v21, 5u, &v30);
      }
    }
    else
    {
      ...
      if ( ReplyCount )
      {
        if ( (unsigned int)dword_1801814A0 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1801814A0, 10LL, v11, v12) )
        {
          ...
          v38 = 4LL;
          tlgWriteTransfer_EtwEventWriteTransfer((int)&dword_1801814A0, (int)&dword_18014E7FA, v11, v19, 6u, &v30);
        }
        v17 = &v29;
