/*
 * XREFs of RtlpAllocateUserBlockFromHeap @ 0x18006372C
 * Callers:
      ...
      if ( v14 )
      {
        *(_QWORD *)(v19 + 16) = 0LL;
        ...
        if ( v20 != -2 )
        {
          ...
          DeferredCriticalSectionEvent = *(void **)(v19 + 24);
          if ( !DeferredCriticalSectionEvent )
            DeferredCriticalSectionEvent = (void *)RtlpCreateDeferredCriticalSectionEvent(v19);
          v32 = 0;
      ...
      if ( v14 )
      {
        *(_QWORD *)(v13 + 16) = 0LL;
        ...
        if ( v15 != -2 )
        {
          ...
          v21 = *(void **)(v13 + 24);
          if ( !v21 )
            v21 = (void *)RtlpCreateDeferredCriticalSectionEvent(v13);
          v29 = 0;
    ...
    if ( v14 )
    {
      *(_QWORD *)(v23 + 16) = 0LL;
      ...
      if ( v24 != -2 )
      {
        ...
        v25 = *(void **)(v23 + 24);
        if ( !v25 )
          v25 = (void *)RtlpCreateDeferredCriticalSectionEvent(v23);
        v30 = 0;
