/*
 * XREFs of _woutput_s @ 0x18009CE40
 * Callers:
 ...
 *     write_char_2 @ 0x18009D7D0 (write_char_2.c)
...
__int64 __fastcall woutput_s(__int64 a1, unsigned __int16 *a2, unsigned __int16 *a3)
{
  ...
  v7 = a3;
  v70 = 0;
  memset_thunk_772440563353939046(v73, 0, 0x400uLL);
  v9 = 0;
  v62[0] = 0;
  v63 = 0;
  if ( !a1 || !a2 )
  ...
  do
  {
    ...
    if ( (unsigned __int16)(v10 - v14) <= 0x5Au )
      v11 = _lookuptable_s[v10 - 32] & 0xF;
    v9 = _lookuptable_s[v11 + v9 + 8 * v11] >> 4;
    v58 = v9;
    if ( v9 == 8 )
      goto LABEL_211;
    if ( v9 )
...
LABEL_55:
              ...
              if ( ((unsigned __int8)v4 & (unsigned __int8)v14) != 0 )
              {
                v64[0] = v21;
                v64[1] = 0;
                if ( (int)safecrt_mbtowc(v73, v64, _mb_cur_max) < 0 )
                  v70 = 1;
              }
              else
              {
