/*
 * XREFs of RtlCreateProcessParametersInternal @ 0x180057E10
 * Callers:
 *     RtlCreateProcessParametersEx @ 0x180057C60 (RtlCreateProcessParametersEx.c)
 *     RtlCreateProcessParametersWithTemplate @ 0x180057CE0 (RtlCreateProcessParametersWithTemplate.c)
 *     RtlCreateProcessParameters @ 0x1800E2BC0 (RtlCreateProcessParameters.c)
 * Callees:
 ...
 *     ValidateStringParameter @ 0x1800583C0 (ValidateStringParameter.c)
 *     RtlpGetBlockSizeEx @ 0x1800586B0 (RtlpGetBlockSizeEx.c)
 *     memmove @ 0x1800A7A40 (memmove.c)
 *     RtlDeNormalizeProcessParams @ 0x1800E2C30 (RtlDeNormalizeProcessParams.c)
