/*
 * XREFs of EvtIntReportEventWorker @ 0x1800531D0
 * Callers:
 *     EvtIntReportEventAndSourceAsync @ 0x180053160 (EvtIntReportEventAndSourceAsync.c)
 *     EvtIntReportAuthzEventAndSourceAsync @ 0x1801263E0 (EvtIntReportAuthzEventAndSourceAsync.c)
 * Callees:
        ...
        __int64 a11)
{
  ...
  *((_QWORD *)&v43 + 1) = v17;
  if ( v13 )
  {
    ...
    {
      v34 = 87;
      local_unwind(v42, &loc_180053519);
      goto LABEL_29;
    }
