/*
 * XREFs of RtlpHpLfhBucketActivate @ 0x18006722C
 * Callers:
...
char __fastcall RtlpHpLfhBucketActivate(__int64 a1, unsigned int a2)
{
  ...
  if ( (v5 & 3) == 1 )
  {
    ...
    if ( v6 == (void *)v5 )
    {
      ...
      if ( v6 )
      {
        memset_thunk_772440563353939046(v6, 0, v14);
        RtlpHpLfhBucketInitialize(v16, a2);
        v17 = v16 + v24;
        ...
        if ( v8 )
        {
          ...
          do
          {
            *(_QWORD *)(*(_QWORD *)(v16 + 96) + 8 * v18) = v17;
            ...
            memset_thunk_772440563353939046(v19, 0, 0x40uLL);
            RtlpHpLfhOwnerInitialize(v19, *(unsigned __int8 *)(v16 + 1), v15);
            ++*(_BYTE *)(v16 + 2);
            v17 += v25;
            v6 = *(void **)(v16 + 88);
            *((_BYTE *)v6 + v18++) = v15++;
