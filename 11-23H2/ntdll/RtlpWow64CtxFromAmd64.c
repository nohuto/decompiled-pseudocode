/*
 * XREFs of RtlpWow64CtxFromAmd64 @ 0x180111A10
 * Callers:
 *     RtlpWow64GetContextOnAmd64 @ 0x18007A170 (RtlpWow64GetContextOnAmd64.c)
 * Callees:
 *     RtlFxToFnFrame @ 0x18010AB20 (RtlFxToFnFrame.c)
 */
