 ...
 *     Normalization__AppendDecomposedChar @ 0x18010DF80 (Normalization__AppendDecomposedChar.c)
 * Callees:
 *     NormBuffer__AppendEx @ 0x18008A0FC (NormBuffer__AppendEx.c)
 *     NormBuffer__Append @ 0x18008A160 (NormBuffer__Append.c)
 *     ComposeHangulLV @ 0x18010D798 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x18010D7C8 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x18010D7FC (IsHangulLV.c)
 *     NormBuffer__GetLastChar @ 0x18010D924 (NormBuffer__GetLastChar.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x18010DE6C (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x18010DF80 (Normalization__AppendDecomposedChar.c)
