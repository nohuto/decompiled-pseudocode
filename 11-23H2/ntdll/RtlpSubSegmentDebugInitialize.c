/*
 * XREFs of RtlpSubSegmentDebugInitialize @ 0x18011AE78
 * Callers:
 ...
 *     RtlpInitializeLfhBitmapData @ 0x18012349C (RtlpInitializeLfhBitmapData.c)
 */
        ...
        __int64 a7)
{
  ...
  signed __int64 v31; // [rsp+30h] [rbp-40h]
  char v32; // [rsp+38h] [rbp-38h] BYREF
  char v33; // [rsp+3Ch] [rbp-34h] BYREF
  ...
  *(_QWORD *)a2 = v14;
  ...
  v34 = ((a5 + 4119) & 0xFFFFFFFFFFFFF000uLL) + 4096;
  v16 = (a6 + a3 - v15) / v34;
  HIWORD(v39) = ((a5 + 4119) & 0xF000) + 4096;
  ...
  *(_WORD *)(a2 + 38) = a4;
  ...
  LOWORD(v39) = FirstBlockAddress - a3;
  *(_DWORD *)(a3 + 24) = v39 ^ RtlpLFHKey ^ a3 ^ a1;
...
LABEL_15:
  *(_QWORD *)(a2 + 8) = a3;
  ...
  while ( v25 != _InterlockedCompareExchange64((volatile signed __int64 *)(v14 + 160), v31, v25) );
  v27 = *(_QWORD *)v14;
  *(_DWORD *)(v14 + 168) = ++*(_DWORD *)(v27 + 32);
