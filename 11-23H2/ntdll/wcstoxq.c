/*
 * XREFs of wcstoxq @ 0x1800911D4
 * Callers:
 *     _wcstoi64 @ 0x180091160 (_wcstoi64.c)
 *     _wcstoui64 @ 0x1800911A0 (_wcstoui64.c)
 * Callees:
 *     _errno @ 0x180088DF0 (_errno.c)
 *     _invalid_parameter @ 0x18008EEB8 (_invalid_parameter.c)
 *     _iswctype_l @ 0x180092E80 (_iswctype_l.c)
 *     _wchartodigit @ 0x180097024 (_wchartodigit.c)
 */
