...
__int64 __fastcall RtlpCreateSerializationGroup(int a1, unsigned __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  RtlAcquireSRWLockShared((volatile signed __int64 *)(qword_180187E00 + 48), a2, a3, a4);
  for ( i = *(_QWORD **)(qword_180187E00 + 32); i != (_QWORD *)(qword_180187E00 + 32); i = (_QWORD *)*i )
  {
    ...
    if ( *((_DWORD *)i - 1) == a1 )
    {
      ...
      RtlReleaseSRWLockShared((volatile signed __int64 *)(qword_180187E00 + 48));
      return v6;
    }
  }
  RtlReleaseSRWLockShared((volatile signed __int64 *)(qword_180187E00 + 48));
  ...
  if ( result )
  {
    ...
    *(_QWORD *)(result + 24) = 0LL;
    v8 = (volatile signed __int64 *)(qword_180187E00 + 48);
    *(_DWORD *)(result + 4) = a1;
    *(_DWORD *)(result + 32) = 1;
    RtlAcquireSRWLockExclusive(v8);
    v9 = qword_180187E00;
    v10 = qword_180187E00 + 32;
    for ( j = *(_QWORD **)(qword_180187E00 + 32); j != (_QWORD *)v10; j = (_QWORD *)*j )
    {
    ...
    v13 = *(__int64 ***)(qword_180187E00 + 40);
    v14 = (__int64 *)(v6 + 8);
    if ( *v13 != (__int64 *)v10 )
      __fastfail(3u);
    *v14 = v10;
