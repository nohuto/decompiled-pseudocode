/*
 * XREFs of LdrpGetImportDescriptorForSnap @ 0x18007648C
 * Callers:
...
__int64 __fastcall LdrpGetImportDescriptorForSnap(__int64 a1)
{
  ...
  if ( v3 < 0 )
    v4 = 0LL;
  if ( v1 == LdrpImageEntry && (((unsigned __int64)qword_18019C3B8 >> 44) & 3) == 1 )
  {
    ...
    {
      v6 = RtlpImageDirectoryEntryToDataEx(*(_QWORD *)(a1 + 192), 1, 1u, &v7, &v8);
      v4 = v8;
      if ( v6 < 0 )
        return 0LL;
    }
