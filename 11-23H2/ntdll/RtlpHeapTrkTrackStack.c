/*
 * XREFs of RtlpHeapTrkTrackStack @ 0x18010CEAC
 * Callers:
...
_WORD *RtlpHeapTrkTrackStack()
{
  ...
  v3 = v1 & 0xF;
  RtlAcquireSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_180188A38 + 8 * v3));
  v4 = qword_1801886B0;
...
LABEL_6:
    if ( Heap )
    {
      ...
      *(_QWORD *)v8 = Heap;
      ...
      RtlReleaseSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_180188A38 + 8 * v3));
      return Heap;
    }
    else
    {
