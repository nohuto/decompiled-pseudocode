/*
 * XREFs of RtlpFreeHeapInternal @ 0x18003BBF0
 * Callers:
...
LABEL_56:
    ...
    else if ( (*(_BYTE *)(v20 + 24) & 0xC) == 8 )
    {
      ...
      v26 = *(_DWORD *)(v24 + 40) ^ qword_180187F48 ^ ((unsigned int)v24 >> 12);
      ...
      else
      {
        ...
        if ( (v34 & 1) != 0 )
        {
          v35 = (unsigned __int16)qword_180187F48 ^ (unsigned __int16)(*(_WORD *)(v24 + 40) ^ v25);
          if ( (v34 & 2) != 0 )
          {
            v36 = (unsigned __int16)qword_180187F48 ^ (unsigned __int64)(unsigned __int16)(*(_WORD *)(v24 + 40) ^ v25);
            v37 = *(_WORD *)(v36 + v8 - 2);
            v38 = v37 & 0x4000;
            if ( (v37 & 0x4000) != 0 )
            {
