/*
 * XREFs of LdrpGetMUILangConfigNode @ 0x1800B0296
 * Callers:
 *     RtlpTraverseParents @ 0x180004050 (RtlpTraverseParents.c)
 * Callees:
 *     RtlpMuiRegGetLanginfoTypeNSpec @ 0x1800B051E (RtlpMuiRegGetLanginfoTypeNSpec.c)
 *     RtlpCompareConfigNodeWithSpec @ 0x1800FC148 (RtlpCompareConfigNodeWithSpec.c)
 */
