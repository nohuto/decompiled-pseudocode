/*
 * XREFs of wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x1800D71B8
 * Callers:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x1800D73A8 (wil_details_FeatureReporting_RecordUsageInCache.c)
 * Callees:
 *     <none>
 */
