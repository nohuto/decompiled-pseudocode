/*
 * XREFs of ?SessionInitialize@DesktopRecalc@@YAXXZ @ 0x1C005A3B8
 * Callers:
 *     EditionUserInitialize @ 0x1C005A3A0 (EditionUserInitialize.c)
 * Callees:
...
void __fastcall DesktopRecalc::SessionInitialize(DesktopRecalc *this)
{
  ...
  v5 = 0;
  v1 = 1;
  FastGetProfileIntFromID(0LL, 39LL, 616LL, 1LL);
  v4 = v5;
