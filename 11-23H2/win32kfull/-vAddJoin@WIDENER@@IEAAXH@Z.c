/*
 * XREFs of ?vAddJoin@WIDENER@@IEAAXH@Z @ 0x1C02F1770
 * Callers:
 *     ?bWiden@WIDENER@@IEAAHXZ @ 0x1C015D470 (-bWiden@WIDENER@@IEAAHXZ.c)
 * Callees:
 *     ?bMiterInLimit@WIDENER@@IEAAHVEVECTORFX@@@Z @ 0x1C015D1C8 (-bMiterInLimit@WIDENER@@IEAAHVEVECTORFX@@@Z.c)
 *     ?bTurnLeftRandom@@YAHPEAVEVECTORFX@@0@Z @ 0x1C015D2D0 (-bTurnLeftRandom@@YAHPEAVEVECTORFX@@0@Z.c)
 ...
 *     ?vecInPerp@WIDENER@@IEAA?AVEVECTORFX@@XZ @ 0x1C015DF54 (-vecInPerp@WIDENER@@IEAA-AVEVECTORFX@@XZ.c)
 *     ?vecOutPerp@WIDENER@@IEAA?AVEVECTORFX@@XZ @ 0x1C015DFE0 (-vecOutPerp@WIDENER@@IEAA-AVEVECTORFX@@XZ.c)
