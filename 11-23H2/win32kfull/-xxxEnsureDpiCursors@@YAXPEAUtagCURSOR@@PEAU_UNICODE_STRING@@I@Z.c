/*
 * XREFs of ?xxxEnsureDpiCursors@@YAXPEAUtagCURSOR@@PEAU_UNICODE_STRING@@I@Z @ 0x1C00DEE44
 * Callers:
 *     ?xxxEnsureAllDpiCursors@@YAXXZ @ 0x1C00630B4 (-xxxEnsureAllDpiCursors@@YAXXZ.c)
 *     ?xxxEnsureDpiCursorsForSysCur@@YAXI@Z @ 0x1C00DEDF4 (-xxxEnsureDpiCursorsForSysCur@@YAXI@Z.c)
 * Callees:
 ...
 *     ?zzzFixupGlobalCursorWhenChanged@@YAXPEAUtagCURSOR@@@Z @ 0x1C00DF2E0 (-zzzFixupGlobalCursorWhenChanged@@YAXPEAUtagCURSOR@@@Z.c)
      ...
      if ( v13 )
      {
        if ( !FindDPICursor(v4, v12) )
        {
          ...
          if ( a2 )
          {
            ...
            Image = (__int64)xxxClientLoadImage((void **)a2, v17, 2u, v15, v16, a3 | 0x40000);
          }
          else
          {
          ...
          if ( Image )
          {
            ...
            else
            {
              ...
              {
                if ( (*v3 & 0x200) == 0 )
                  HMChangeOwnerProcess(v19, *(_QWORD *)(v22 + 328));
              }
