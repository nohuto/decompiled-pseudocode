/*
 * XREFs of _anonymous_namespace_::HasLegacyForegroundActivateRight @ 0x1C008A7C0
 * Callers:
...
char __fastcall anonymous_namespace_::HasLegacyForegroundActivateRight(__int64 a1)
{
  ...
  CAutoPushLockSh::CAutoPushLockSh((CAutoPushLockSh *)&v10, (struct _EX_PUSH_LOCK *)&unk_1C035F388);
