/*
 * XREFs of PhysicalToLogicalInPlacePointWithParent @ 0x1C01515A0
 * Callers:
 ...
 *     ?AdjustMouseCoordinates@@YAXPEAUtagWND@@PEA_J@Z @ 0x1C0213258 (-AdjustMouseCoordinates@@YAXPEAUtagWND@@PEA_J@Z.c)
 * Callees:
 *     ?GetTopLevelOrDpiBoundaryWindow@@YAPEBUtagWND@@PEBU1@@Z @ 0x1C00B14EC (-GetTopLevelOrDpiBoundaryWindow@@YAPEBUtagWND@@PEBU1@@Z.c)
 *     FixedPointSubPixel @ 0x1C015156E (FixedPointSubPixel.c)
 */
