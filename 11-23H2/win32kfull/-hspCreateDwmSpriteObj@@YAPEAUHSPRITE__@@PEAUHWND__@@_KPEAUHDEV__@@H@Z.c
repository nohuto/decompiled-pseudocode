/*
 * XREFs of ?hspCreateDwmSpriteObj@@YAPEAUHSPRITE__@@PEAUHWND__@@_KPEAUHDEV__@@H@Z @ 0x1C00C5F3C
 * Callers:
...
__int64 __fastcall hspCreateDwmSpriteObj(Gre::Base *a1, __int64 a2, HDEV a3, int a4)
{
  ...
  *(_QWORD *)(Object + 24) = Object + 24;
  ...
  NeighborSprite = (HSPRITE)hspGetNeighborSprite(v15, 0, 0);
  if ( NeighborSprite )
  {
