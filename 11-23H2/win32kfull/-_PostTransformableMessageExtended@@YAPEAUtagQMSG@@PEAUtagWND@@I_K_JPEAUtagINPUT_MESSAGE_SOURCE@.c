/*
 * XREFs of ?_PostTransformableMessageExtended@@YAPEAUtagQMSG@@PEAUtagWND@@I_K_JPEAUtagINPUT_MESSAGE_SOURCE@@H@Z @ 0x1C011EE90
 * Callers:
...
LABEL_49:
    if ( (!(unsigned __int8)Enforced(v19) || *(_QWORD *)v17 == gpepCSRSS)
      && (*(_DWORD *)(v17 + 780) != *((_DWORD *)v20 + 195) || *(_DWORD *)(v17 + 784) != *((_DWORD *)v20 + 196)) )
    {
      goto LABEL_53;
    }
    goto LABEL_54;
