/*
 * XREFs of ?LOADSTRING@@YAHPEAXIPEAGH@Z @ 0x1C0019D48
 * Callers:
 *     InitializeScripts @ 0x1C03B38F8 (InitializeScripts.c)
 * Callees:
 *     ?pvFindResource@@YAPEAXPEAX0HHPEAK@Z @ 0x1C00842DC (-pvFindResource@@YAPEAXPEAX0HHPEAK@Z.c)
