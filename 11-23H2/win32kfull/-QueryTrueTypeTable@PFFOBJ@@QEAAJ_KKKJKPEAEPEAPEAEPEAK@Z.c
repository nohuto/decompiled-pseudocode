/*
 * XREFs of ?QueryTrueTypeTable@PFFOBJ@@QEAAJ_KKKJKPEAEPEAPEAEPEAK@Z @ 0x1C00C803C
 * Callers:
 ...
 *     ?bCheckFntFileInfo@PFFOBJ@@QEAAHXZ @ 0x1C00C9BC8 (-bCheckFntFileInfo@PFFOBJ@@QEAAHXZ.c)
