/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C01554DC
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1C0155540 (EditionFindNodeQueuedMessage.c)
 * Callees:
