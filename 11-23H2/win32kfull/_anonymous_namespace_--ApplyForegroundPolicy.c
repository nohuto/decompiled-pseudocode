/*
 * XREFs of _anonymous_namespace_::ApplyForegroundPolicy @ 0x1C00EE6B0
 * Callers:
...
__int64 __fastcall anonymous_namespace_::ApplyForegroundPolicy(__int64 a1)
{
  ...
  v7 = 3LL * v5;
  v3 = qword_1C035E1B0[3 * v5 + 1];
  if ( (v3 & 0xFFFFFFFB) == 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 410LL);
  if ( HIDWORD(qword_1C035E1B0[v7 + 1]) )
  {
    LODWORD(qword_1C035E1B0[v7 + 1]) = 0;
  }
  else
  {
    *(_OWORD *)&qword_1C035E1B0[v7] = 0LL;
    qword_1C035E1B0[v7 + 2] = 0LL;
  }
LABEL_10:
