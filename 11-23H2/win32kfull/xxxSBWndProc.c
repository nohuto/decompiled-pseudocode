/*
 * XREFs of xxxSBWndProc @ 0x1C022A1A0
 * Callers:
 ...
 *     ?zzzSetSBCaretPos@@YAXPEAUtagSBWND@@@Z @ 0x1C02294C0 (-zzzSetSBCaretPos@@YAXPEAUtagSBWND@@@Z.c)
 ...
 *     _ClientToScreen @ 0x1C024B260 (_ClientToScreen.c)
 */
...
LABEL_124:
        ...
        v61 = *(_BYTE *)(v59 + 25);
        ThreadLock(v58, &v85);
        v62 = *(unsigned __int64 **)(*v12 + 104LL);
        _InterlockedAdd(&glSendMessage, 1u);
