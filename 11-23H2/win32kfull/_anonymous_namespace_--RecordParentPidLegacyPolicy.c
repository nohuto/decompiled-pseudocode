/*
 * XREFs of _anonymous_namespace_::RecordParentPidLegacyPolicy @ 0x1C00EE2B4
 * Callers:
...
__int64 __fastcall anonymous_namespace_::RecordParentPidLegacyPolicy(__int64 a1)
{
  ...
  *(_QWORD *)v6 = a1;
  v4 = 3LL * (unsigned int)dword_1C035E1A8;
  *(_OWORD *)&qword_1C035E1B0[v4] = *(_OWORD *)v6;
  qword_1C035E1B0[v4 + 2] = *(_OWORD *)&_mm_unpackhi_pd(*(__m128d *)&v6[8], *(__m128d *)&v6[8]);
  result = 5 * ((v3 + 1) / 5u);
  dword_1C035E1A8 = (v3 + 1) % 5u;
  return result;
}
