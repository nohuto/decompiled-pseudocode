/*
 * XREFs of ?_SwapMouseButton@@YAHH@Z @ 0x1C01BEBD8
 * Callers:
 *     xxxSystemParametersInfoWorker @ 0x1C00D9A30 (xxxSystemParametersInfoWorker.c)
 *     NtUserSwapMouseButton @ 0x1C01DE500 (NtUserSwapMouseButton.c)
 * Callees:
...
__int64 __fastcall _SwapMouseButton(__int64 a1)
{
  ...
  if ( !(unsigned int)CheckGrantedAccess(*(_DWORD *)(v3 + 680), 0x12u) )
    return 0LL;
