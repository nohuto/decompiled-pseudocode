/*
 * XREFs of ?xxxReadyTimer@@YAXPEAUtagTIMER@@K@Z @ 0x1C01BFF14
 * Callers:
 *     xxxTimersProc @ 0x1C00D7480 (xxxTimersProc.c)
 * Callees:
 *     SetWakeBit @ 0x1C01190C0 (SetWakeBit.c)
 *     _guard_dispatch_icall_nop @ 0x1C01409C0 (_guard_dispatch_icall_nop.c)
 *     ?ApplyTimerDelay@@YAXPEAUtagTIMER@@@Z @ 0x1C01BFCAC (-ApplyTimerDelay@@YAXPEAUtagTIMER@@@Z.c)
  ...
  if ( (v5 & 1) == 0 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(v8 + 8) = v7;
      ...
      ++*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 3) + 424LL) + 1064LL);
    }
  }
}
