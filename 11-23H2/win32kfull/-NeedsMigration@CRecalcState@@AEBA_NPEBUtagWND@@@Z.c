/*
 * XREFs of ?NeedsMigration@CRecalcState@@AEBA_NPEBUtagWND@@@Z @ 0x1C005E540
 * Callers:
 ...
 *     ?MonitorDataFromId@CMonitorTopology@@QEBAPEBUMonitorData@1@AEBUMonitorId@1@@Z @ 0x1C005E658 (-MonitorDataFromId@CMonitorTopology@@QEBAPEBUMonitorData@1@AEBUMonitorId@1@@Z.c)
 *     ?Compare@MonitorData@CMonitorTopology@@SA_NAEBU12@0@Z @ 0x1C0060478 (-Compare@MonitorData@CMonitorTopology@@SA_NAEBU12@0@Z.c)
 */
...
char __fastcall CRecalcState::NeedsMigration(CRecalcState *this, PETHREAD **a2)
{
  ...
  if ( v2 )
  {
    ...
    v6 = qword_1C035E320;
    v7 = CMonitorTopology::MonitorDataFromId(qword_1C035E320, (const struct CMonitorTopology::MonitorId *)(v2 + 44));
    if ( v7 )
    {
      if ( !*((_DWORD *)this + 7)
        && !*((_DWORD *)this + 8)
