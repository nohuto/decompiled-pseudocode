/*
 * XREFs of GreRectangle @ 0x1C02AC350
 * Callers:
 ...
 *     ?vInit@RECTANGLEPATHOBJ@@QEAAXPEAU_RECTL@@H@Z @ 0x1C02867AC (-vInit@RECTANGLEPATHOBJ@@QEAAXPEAU_RECTL@@H@Z.c)
...
__int64 __fastcall GreRectangle(Gre::Base *a1, LONG a2, LONG a3, LONG a4, LONG a5)
{
  ...
  else
  {
    ...
    v16 = v62[0];
    v17 = v59[0];
    if ( (*(_DWORD *)(v62[0] + 32LL) & 1) != 0 && (v59[0][31].x & 1) == 0 )
    {
      if ( *(_QWORD *)&v59[0][18] == *((_QWORD *)v9 + 32) )
      {
        if ( *(_QWORD *)&v59[0][17] != *((_QWORD *)v9 + 30) || (v59[0][4].y & 0x40) != 0 )
        {
          v18 = *(_DWORD *)(v62[0] + 32LL) & 2;
          if ( *(_DWORD *)(*(_QWORD *)&v59[0][122] + 208LL) == 2 )
          {
            if ( v18 )
            {
              v27 = (*(_DWORD *)(v62[0] + 24LL) + 15) >> 4;
              v63.left += v27;
              v63.right += v27;
              v28 = (*(_DWORD *)(v62[0] + 28LL) + 15) >> 4;
              v63.top += v28;
              v63.bottom += v28;
            }
            else
            {
              v57 = 0;
              bFToL((float)v63.left * *(float *)v62[0], &v57, 0);
          ...
          else
          {
            if ( v18 )
            {
              v19 = ((*(int *)(v62[0] + 24LL) >> 3) + 1) >> 1;
              v63.left += v19;
              v63.right += v19;
              v20 = ((*(int *)(v62[0] + 28LL) >> 3) + 1) >> 1;
              v63.top += v20;
              v63.bottom += v20;
            }
            else
...
LABEL_46:
      ...
      if ( (v59[0][26].x & 1) == 0 )
      {
        v33 = *(_DWORD *)(v62[0] + 32LL) & 2;
        if ( *(_DWORD *)(*(_QWORD *)&v59[0][122] + 208LL) == 2 )
        {
          if ( v33 )
          {
            v44 = (*(_DWORD *)(v62[0] + 24LL) + 15) >> 4;
            v63.left += v44;
            v63.right += v44;
            v45 = (*(_DWORD *)(v62[0] + 28LL) + 15) >> 4;
            v63.top += v45;
            v63.bottom += v45;
          }
          else
        ...
        else
        {
          if ( v33 )
          {
            v34 = ((*(int *)(v62[0] + 24LL) >> 3) + 1) >> 1;
            v63.left += v34;
            v63.right += v34;
            v35 = ((*(int *)(v62[0] + 28LL) >> 3) + 1) >> 1;
            v63.top += v35;
            v63.bottom += v35;
          }
          else
...
LABEL_49:
    ...
    else
    {
      ...
      if ( (*(_DWORD *)(*(_QWORD *)&v53 + 40LL) & 0x800) != 0 )
        v17[26].y = 2;
      v55 = EPATHOBJ::bStrokeAndOrFill(&v67, v59, (LINEATTRS *)&v17[26], (struct _XFORMOBJ *)v62, 3u);
      v17[26].y = y;
    }
    XEPATHOBJ::~XEPATHOBJ((XEPATHOBJ *)&v67);
    if ( v59[0] )
