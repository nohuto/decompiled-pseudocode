/*
 * XREFs of NtGdiExtEscape @ 0x1C00D09E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GreScalingDispatchEscape @ 0x1C02A79C0 (GreScalingDispatchEscape.c)
...
__int64 __fastcall NtGdiExtEscape(HDC a1, char *a2, int a3, unsigned int a4, int a5, char *a6, int a7, char *a8)
{
  ...
  if ( a5 >= 0 && a7 >= 0 && a3 >= 0 && (!a1 || !a2) )
  {
    ...
    {
      UmfdDispatchWinLogonEscape((unsigned __int64)a6);
      return 0LL;
    }
...
LABEL_53:
        ...
        if ( Str1 )
          v23 = GreNamedEscape(Str1, a7, (__int64)v10);
        else
