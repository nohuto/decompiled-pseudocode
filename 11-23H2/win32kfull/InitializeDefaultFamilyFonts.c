/*
 * XREFs of InitializeDefaultFamilyFonts @ 0x1C03B3AEC
 * Callers:
 *     vInitMapper @ 0x1C03B3380 (vInitMapper.c)
 * Callees:
 *     ?GetGreRegKey@@YAJPEAPEAXKPEBG@Z @ 0x1C0018C00 (-GetGreRegKey@@YAJPEAPEAXKPEBG@Z.c)
