/*
 * XREFs of ?GetCursorMaskAndXorBits@CursorApiRouter@@CA_NPEAUHBITMAP__@@PEBUtagBITMAP@@PEAPEAEPEAI@Z @ 0x1C02229C4
 * Callers:
 ...
 *     GreGetBitmapBits @ 0x1C02ADAA0 (GreGetBitmapBits.c)
 */
