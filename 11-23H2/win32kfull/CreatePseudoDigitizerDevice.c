/*
 * XREFs of CreatePseudoDigitizerDevice @ 0x1C01B1A64
 * Callers:
 *     _InitializeTouchInjectionWorker @ 0x1C01AFE40 (_InitializeTouchInjectionWorker.c)
 * Callees:
 *     __security_check_cookie @ 0x1C01381F0 (__security_check_cookie.c)
 *     memset_0 @ 0x1C0140D40 (memset_0.c)
 *     ?_UpdateReportDescriptor@@YAXUtagRECT@@KK@Z @ 0x1C01B195C (-_UpdateReportDescriptor@@YAXUtagRECT@@KK@Z.c)
 */
...
struct DEVICEINFO *__fastcall CreatePseudoDigitizerDevice(int a1, int a2, __int64 a3)
{
  ...
  if ( (int)CHidInput::GetKernelHandleToRimObj(*(CHidInput **)(v8 + 16840), (void **)(a3 + 88)) >= 0 )
  {
    ...
    v30 = *(_QWORD *)(CurrentProcessWin32Process + 896);
