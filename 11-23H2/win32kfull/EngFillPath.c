/*
 * XREFs of EngFillPath @ 0x1C0288AF0
 * Callers:
 ...
 *     ?bPreComputedFill@EPATHOBJ@@QEBAHXZ @ 0x1C0159DF2 (-bPreComputedFill@EPATHOBJ@@QEBAHXZ.c)
 *     ??0RGNMEMOBJTMPIFNEEDED@@QEAA@AEAVEPATHOBJ@@W4PRECOMPUTETYPE@@KPEAU_RECTL@@@Z @ 0x1C028434C (--0RGNMEMOBJTMPIFNEEDED@@QEAA@AEAVEPATHOBJ@@W4PRECOMPUTETYPE@@KPEAU_RECTL@@@Z.c)
 *     ??1RGNMEMOBJTMPIFNEEDED@@QEAA@XZ @ 0x1C0288AAC (--1RGNMEMOBJTMPIFNEEDED@@QEAA@XZ.c)
        ...
        if ( (unsigned int)RGNOBJ::iComplexity((RGNOBJ *)v30) != 1 )
        {
          ...
          if ( v27 )
          {
            if ( RGNOBJ::bMerge((RGNOBJ *)&v27, (struct RGNOBJ *)v30, (struct RGNOBJ *)&pco[2].rclBounds.top, 8u) )
            {
              ...
              v46 = 1;
              v47 = 0LL;
              XCLIPOBJ::vSetup((XCLIPOBJ *)&v42, v22, (struct ERECTL *)&v35, 0);
              if ( ERECTL::bEmpty((ERECTL *)&v42.rclBounds) )
              {
                RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)&v27);
                goto LABEL_21;
              }
              v23 = v42.iDComplexity;
              v24 = v28;
              if ( !v42.iDComplexity )
                v23 = 1;
              v25 = pboa;
              v42.iDComplexity = v23;
              v26 = (__int64)&pso->iUniq;
              if ( !pso )
                v26 = 92LL;
              ++*(_DWORD *)v26;
              v8 = EngPaint(pso, &v42, v25, v24, mix);
            }
          }
          else
          {
