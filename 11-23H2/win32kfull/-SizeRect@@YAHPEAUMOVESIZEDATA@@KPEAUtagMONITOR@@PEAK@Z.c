/*
 * XREFs of ?SizeRect@@YAHPEAUMOVESIZEDATA@@KPEAUtagMONITOR@@PEAK@Z @ 0x1C01EA094
 * Callers:
...
__int64 __fastcall SizeRect(struct MOVESIZEDATA *a1, unsigned int a2, struct tagMONITOR *a3, unsigned int *a4)
{
  ...
  v21 = *((int *)a1 + 44);
  v22 = (struct tagMONITOR *)dword_1C0320E48[v21];
  if ( (int)v22 >= 0 )
  {
    v23 = (__int16)v6;
    v24 = dword_1C0320E48[v21];
