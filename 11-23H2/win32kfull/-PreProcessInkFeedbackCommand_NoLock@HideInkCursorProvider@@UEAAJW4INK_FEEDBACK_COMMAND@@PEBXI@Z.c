/*
 * XREFs of ?PreProcessInkFeedbackCommand_NoLock@HideInkCursorProvider@@UEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C0241BB0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( a2 == 3 )
  {
    ...
    if ( (v4 & 0x80000000) == 0 || (unsigned int)dword_1C03540E0 <= 2 )
      return v4;
LABEL_16:
    v8 = v4;
