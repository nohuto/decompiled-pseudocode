/*
 * XREFs of _QuerySendMessage @ 0x1C01FB53C
 * Callers:
 *     NtUserQuerySendMessage @ 0x1C01D83C0 (NtUserQuerySendMessage.c)
 * Callees:
 *     IsPointerInputMessageWithState @ 0x1C0118D84 (IsPointerInputMessageWithState.c)
 *     TranslateSentPointerMessageForClient @ 0x1C01C3B9C (TranslateSentPointerMessageForClient.c)
 */
