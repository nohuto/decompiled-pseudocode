/*
 * XREFs of _RegisterUserApiHook @ 0x1C003AC64
 * Callers:
...
__int64 __fastcall RegisterUserApiHook(ULONG64 a1, ULONG64 a2, ULONG64 a3, ULONG64 a4)
{
  ...
  if ( *(_DWORD *)(v10 + 780) != luidSystem[0] )
    goto LABEL_64;
  v11 = PsGetCurrentProcessWin32Process(luidSystem[0]);
  v12 = v11;
  if ( v11 )
    v12 = -(__int64)(*(_QWORD *)v11 != 0LL) & v11;
  if ( *(_DWORD *)(v12 + 784) != luidSystem[1] || !(unsigned int)IsPrivileged(psTcb) )
  {
LABEL_64:
    v31 = 5LL;
LABEL_65:
  ...
  {
LABEL_56:
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2942LL);
LABEL_57:
    ExRaiseAccessViolation();
  }
...
LABEL_53:
  ...
  {
LABEL_48:
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2951LL);
LABEL_49:
    ExRaiseAccessViolation();
  }
