/*
 * XREFs of ?ReadLinearityDataImp@@YAHPEAXU_UNICODE_STRING@@W4tagCALIBRATION_TYPE@@PEAKPEAPEAE@Z @ 0x1C01A4584
 * Callers:
 ...
 *     ValidateCalibrationData @ 0x1C01A51B0 (ValidateCalibrationData.c)
 */
