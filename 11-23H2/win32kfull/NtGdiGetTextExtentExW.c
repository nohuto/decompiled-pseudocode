/*
 * XREFs of NtGdiGetTextExtentExW @ 0x1C00C6630
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  __int64 v27; // [rsp+88h] [rbp-110h]
  ULONG64 v28; // [rsp+90h] [rbp-108h]
  __int64 v29; // [rsp+98h] [rbp-100h] BYREF
  ...
  if ( (_DWORD)v8 )
  {
    ...
    if ( !a5 )
      v16 = 0xFFFFFFFFLL;
    TextExtent = GreGetTextExtentExW(v27, v10, (unsigned int)v8, v16, &v20, v11 & -(__int64)(a6 != 0LL), &v29, a8, 9);
