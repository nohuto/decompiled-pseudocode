/*
 * XREFs of ?xxxProcessMousePromotionQueue@@YAXXZ @ 0x1C01F7F68
 * Callers:
 ...
 *     ?DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z @ 0x1C01F7354 (-DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z.c)
      ...
      *(_QWORD *)(v5 + 16312) = gptiCurrent;
      for ( i = DequeueMousePromotionEntry(v4); ; i = DequeueMousePromotionEntry(v4) )
      {
        ...
        v9 = (unsigned __int8)HasCapture()
          && !(unsigned int)CheckIntegrityAccessToCapture(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 896LL));
