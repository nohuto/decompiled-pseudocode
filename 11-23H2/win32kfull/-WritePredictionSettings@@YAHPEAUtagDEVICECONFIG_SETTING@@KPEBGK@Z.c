/*
 * XREFs of ?WritePredictionSettings@@YAHPEAUtagDEVICECONFIG_SETTING@@KPEBGK@Z @ 0x1C01F2FF0
 * Callers:
    ...
    if ( v4 >= 0 )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( v4 >= 0 )
      {
        ...
        do
        {
          v4 = WritePointerDeviceCfgSetting(KeyHandle, *v5, 4u, (unsigned __int8 *)&dword_1C035420C[4 * v3], 4u);
          if ( v4 < 0 )
            break;
          ++v3;
          v5 += 2;
