/*
 * XREFs of ?HKRemoveHotkeyOrMakePlaceholder@@YA_NPEAPEAUtagHOTKEY@@@Z @ 0x1C003FDFC
 * Callers:
 ...
 *     DestroyThreadsHotKeys @ 0x1C003ED70 (DestroyThreadsHotKeys.c)
 * Callees:
 ...
 *     ?RemoveSasKey@@YA_NII@Z @ 0x1C009EE38 (-RemoveSasKey@@YA_NII@Z.c)
 */
