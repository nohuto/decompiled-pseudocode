/*
 * XREFs of ?_InitializeData@Edgy@@YAPEAUtagEDGY_DATA@@PEAUtagDESKTOP@@@Z @ 0x1C01E7CD8
 * Callers:
...
struct tagEDGY_DATA *__fastcall Edgy::_InitializeData(Edgy *this, struct tagDESKTOP *a2)
{
  ...
  result = (struct tagEDGY_DATA *)*((_QWORD *)this + 31);
  if ( !result )
  {
    ...
    if ( v4 )
    {
      memmove((void *)(v4 + 20), &unk_1C0320D10, 0x9CuLL);
      *(_DWORD *)(v5 + 252) = 350;
      *(_DWORD *)(v5 + 264) = 4000;
      *(_DWORD *)(v5 + 268) = 4000;
      *(_DWORD *)(v5 + 272) = 450;
