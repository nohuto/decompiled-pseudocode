/*
 * XREFs of _GetRegisteredRawInputDevices @ 0x1C01A9A38
 * Callers:
 *     NtUserGetRegisteredRawInputDevices @ 0x1C01D34B0 (NtUserGetRegisteredRawInputDevices.c)
 * Callees:
 *     UserSetLastError @ 0x1C00EDA4C (UserSetLastError.c)
 *     ?SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z @ 0x1C01A93D0 (-SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z.c)
 */
...
LABEL_44:
          ...
          v42 = *(__int64 **)(v35 + 48);
          while ( v42 != (__int64 *)(*(_QWORD *)(v7 + 856) + 48LL) && v16 < v19 )
          {
            v43 = 2LL * v16;
