/*
 * XREFs of TouchTargetingClipContact @ 0x1C024D5A8
 * Callers:
 ...
 *     ?_TTClip@@YAXPEAUtagTOUCHTARGETINGCONTACT@@JW4tagCLIP_SIDE@@@Z @ 0x1C024CEE4 (-_TTClip@@YAXPEAUtagTOUCHTARGETINGCONTACT@@JW4tagCLIP_SIDE@@@Z.c)
 */
