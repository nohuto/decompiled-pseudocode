/*
 * XREFs of SetupAAHeader @ 0x1C025AFE8
 * Callers:
 ...
 *     _ALIGN_MEM @ 0x1C0157C8A (_ALIGN_MEM.c)
 *     CheckBMPNeedFixup @ 0x1C0157CB8 (CheckBMPNeedFixup.c)
 *     ComputeByteOffset @ 0x1C0250804 (ComputeByteOffset.c)
 *     ComputeBytesPerScanLine @ 0x1C025089C (ComputeBytesPerScanLine.c)
 *     ComputeAABBP @ 0x1C025A718 (ComputeAABBP.c)
 *     ComputeInputColorInfo @ 0x1C025AC24 (ComputeInputColorInfo.c)
 */
