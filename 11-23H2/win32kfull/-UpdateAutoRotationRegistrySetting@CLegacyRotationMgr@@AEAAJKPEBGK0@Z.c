/*
 * XREFs of ?UpdateAutoRotationRegistrySetting@CLegacyRotationMgr@@AEAAJKPEBGK0@Z @ 0x1C0090940
 * Callers:
 ...
 *     ?xxxSetSensorPresence@CLegacyRotationMgr@@UEAAXH@Z @ 0x1C01A7270 (-xxxSetSensorPresence@CLegacyRotationMgr@@UEAAXH@Z.c)
