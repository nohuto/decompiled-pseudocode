/*
 * XREFs of ?bDetermineAlphaBlendFunction@@YAHPEAVSURFACE@@0PEAVXEPALOBJ@@1PEAVXLATE@@JPEAU_ALPHA_DISPATCH_FORMAT@@H@Z @ 0x1C00B82CC
 * Callers:
...
LABEL_22:
  ...
  v7 = 0;
LABEL_23:
  if ( *((__int64 (__fastcall **)(__int64, _DWORD *, int, unsigned int))a7 + 4) != vAlphaConstOnly )
    return v7;
