/*
 * XREFs of ?GrePatBltLockedDC@@YAHAEAVXDCOBJ@@AEAVEXFORMOBJ@@PEAVERECTL@@KPEAVSURFACE@@KKKK@Z @ 0x1C00494B0
 * Callers:
        ...
        unsigned int a9)
{
  ...
  _OWORD v44[4]; // [rsp+68h] [rbp-40h] BYREF
          ...
          if ( v22 < (int)v24 )
          {
            ...
            if ( v26 < v25 )
            {
                 ...
                 && *((_DWORD *)a3 + 1) != *((_DWORD *)a3 + 3)) )
              {
                ...
                {
                  v44[0] = *(_OWORD *)a3;
                  XDCOBJ::vAccumulateTight(this, v24, (struct ERECTL *)v44);
                }
                ++*((_DWORD *)a5 + 23);
                if ( (*((_DWORD *)a5 + 28) & 1) != 0 )
