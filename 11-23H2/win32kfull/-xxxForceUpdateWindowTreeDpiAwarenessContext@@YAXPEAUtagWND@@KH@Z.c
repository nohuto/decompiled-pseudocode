/*
 * XREFs of ?xxxForceUpdateWindowTreeDpiAwarenessContext@@YAXPEAUtagWND@@KH@Z @ 0x1C021F254
 * Callers:
  ...
  *(_DWORD *)(v3 + 288) = a2;
  ...
  PostEventMessageEx(
    ...
    *(struct tagQ **)(*((_QWORD *)a1 + 2) + 432LL),
    ...
    0LL,
    0LL);
  PrimaryMonitorRectForWindow = (__m128i *)GetPrimaryMonitorRectForWindow((__int64)&v16, a1, v10);
  v12 = _mm_srli_si128(*PrimaryMonitorRectForWindow, 8);
  PostMessage(
    a1,
    0x7Eu,
    *(unsigned __int16 *)(gpsi + 6996LL),
    (unsigned __int16)(v12.m128i_i16[0] - *(_OWORD *)PrimaryMonitorRectForWindow) | (unsigned __int64)(int)((v12.m128i_i32[1] << 16) - (HIDWORD(PrimaryMonitorRectForWindow->m128i_i64[0]) << 16)));
