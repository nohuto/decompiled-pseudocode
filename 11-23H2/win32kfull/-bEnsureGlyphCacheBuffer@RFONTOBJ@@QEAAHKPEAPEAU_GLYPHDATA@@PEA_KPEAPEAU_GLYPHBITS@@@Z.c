/*
 * XREFs of ?bEnsureGlyphCacheBuffer@RFONTOBJ@@QEAAHKPEAPEAU_GLYPHDATA@@PEA_KPEAPEAU_GLYPHBITS@@@Z @ 0x1C00C88F8
 * Callers:
 ...
 *     ?bCheckMetricsCache@RFONTOBJ@@QEAAHXZ @ 0x1C00C8C60 (-bCheckMetricsCache@RFONTOBJ@@QEAAHXZ.c)
 *     ?bEnsureAuxCacheBuffer@RFONTOBJ@@QEAAHK@Z @ 0x1C02FCD2C (-bEnsureAuxCacheBuffer@RFONTOBJ@@QEAAHK@Z.c)
