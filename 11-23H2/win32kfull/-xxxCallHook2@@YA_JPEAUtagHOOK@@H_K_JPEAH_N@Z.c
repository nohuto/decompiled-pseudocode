/*
 * XREFs of ?xxxCallHook2@@YA_JPEAUtagHOOK@@H_K_JPEAH_N@Z @ 0x1C011FE30
 * Callers:
 ...
 *     ?IsForegroundShellFrameQueueAccessible@@YAHPEBUtagTHREADINFO@@@Z @ 0x1C0084260 (-IsForegroundShellFrameQueueAccessible@@YAHPEBUtagTHREADINFO@@@Z.c)
 ...
 *     ??1?$ObjectLock@$$V@?$DomainExclusive@$$V@?$DomainShared@VDLT_HANDLEMANAGER@@@SharedUserCritOnly@@QEAA@XZ @ 0x1C0122A80 (--1-$ObjectLock@$$V@-$DomainExclusive@$$V@-$DomainShared@VDLT_HANDLEMANAGER@@@SharedUserCritOnly.c)
 ...
 *     Feature_HandleHookDestroyedDuringCallout__private_IsEnabledDeviceUsage @ 0x1C013A308 (Feature_HandleHookDestroyedDuringCallout__private_IsEnabledDeviceUsage.c)
...
LABEL_93:
  if ( (unsigned int)(*((_DWORD *)Valid + 12) - 13) <= 1 )
  {
    if ( a6
      || !gpqForeground
      || (unsigned __int8)CheckAccess(*(_QWORD *)(*((_QWORD *)Valid + 2) + 424LL) + 896LL, gpqForeground + 432LL)
      ...
      || (v40 = *((_QWORD *)Valid + 2), *(int *)(*(_QWORD *)(v40 + 424) + 12LL) < 0) )
    {
      ...
      if ( *(_DWORD *)(v14 + 1408) == -1 )
        goto LABEL_110;
      if ( (unsigned __int8)CheckAccess(*(_QWORD *)(*((_QWORD *)Valid + 2) + 424LL) + 896LL, v14 + 1408) )
        goto LABEL_110;
      v40 = *((_QWORD *)Valid + 2);
  ...
  if ( !(unsigned __int8)CheckAccess(
                           *(_QWORD *)(*((_QWORD *)Valid + 2) + 424LL) + 896LL,
                           *(_QWORD *)(v14 + 424) + 896LL) )
  {
    v39 = *((_QWORD *)Valid + 2);
...
LABEL_110:
    ...
    && !(unsigned int)IsImmersiveBroker(*(_QWORD *)(*((_QWORD *)Valid + 2) + 424LL)) )
  {
    ...
    {
      v44 = *(_QWORD *)(v14 + 424);
      if ( v43 != v44 && (*(_DWORD *)(v43 + 824) & 0x100) == 0 )
      {
