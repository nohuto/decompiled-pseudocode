/*
 * XREFs of ?xxxAutoRotateScreen@CLegacyRotationMgr@@UEAAJK@Z @ 0x1C01A6CB0
 * Callers:
 *     <none>
 * Callees:
 *     ?AutoRotationUpdateRegistry@CLegacyRotationMgr@@UEAAXXZ @ 0x1C0090520 (-AutoRotationUpdateRegistry@CLegacyRotationMgr@@UEAAXXZ.c)
 ...
 *     ?GetDockedOrientationValue@CLegacyRotationMgr@@AEAAKPEAK@Z @ 0x1C01A65F8 (-GetDockedOrientationValue@CLegacyRotationMgr@@AEAAKPEAK@Z.c)
...
__int64 __fastcall CLegacyRotationMgr::xxxAutoRotateScreen(CLegacyRotationMgr *this, unsigned int a2)
{
  ...
  if ( !gbIgnoreStressedOutStuff && !dword_1C035A5DC )
  {
    v12 = 0x20000;
