/*
 * XREFs of ?NtUserSetWindowsHookAW_Body@@YAPEAUHHOOK__@@HP6A_JH_K_J@ZK@Z @ 0x1C01CB86C
 * Callers:
 *     NtUserSetWindowsHookAW @ 0x1C01DD090 (NtUserSetWindowsHookAW.c)
 * Callees:
