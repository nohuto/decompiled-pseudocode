/*
 * XREFs of ?zzzAnimateCursor@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C00EFAA0
 * Callers:
 *     ?Cursor_DaemonTimeRateChanged@@YAXW4RitTimerRate@@@Z @ 0x1C009F3E0 (-Cursor_DaemonTimeRateChanged@@YAXW4RitTimerRate@@@Z.c)
 * Callees:
