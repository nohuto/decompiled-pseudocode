/*
 * XREFs of ?vDrawLine@@YAXPEAU_POINTFIX@@0PEAEJKPEAU_RECTL@@KPEAU_W32KCDD_ENG_CALLBACKS@@@Z @ 0x1C02FB490
 * Callers:
 ...
 *     ?bGIQtoIntegerLine@@YAHPEAU_POINTFIX@@0PEAU_RECTL@@PEAU_DDALINE@@@Z @ 0x1C02FB064 (-bGIQtoIntegerLine@@YAHPEAU_POINTFIX@@0PEAU_RECTL@@PEAU_DDALINE@@@Z.c)
 */
...
LABEL_45:
      ...
      if ( (v40 & 2) != 0 )
        v12 = -v12;
LABEL_48:
      (*(&off_1C030B4F0[8 * v38] + (v40 & 7)))((struct _DDALINE *)&v40, &v9[(int)v41 * a4], v12, a5);
      return;
    }
  }
  v26 = v22 - v19;
