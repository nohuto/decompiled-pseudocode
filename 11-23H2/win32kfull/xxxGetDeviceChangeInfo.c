/*
 * XREFs of xxxGetDeviceChangeInfo @ 0x1C01B224C
 * Callers:
 *     NtUserGetDeviceChangeInfo @ 0x1C01D07E0 (NtUserGetDeviceChangeInfo.c)
 * Callees:
...
__int64 __fastcall xxxGetDeviceChangeInfo(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v4 = qword_1C035E4D8;
    v5 = *(_QWORD **)(qword_1C035E4D8 + 8);
    if ( *(struct _LIST_ENTRY **)qword_1C035E4D8 != &gMediaChangeList || *v5 != qword_1C035E4D8 )
      __fastfail(3u);
    qword_1C035E4D8 = *(_QWORD *)(qword_1C035E4D8 + 8);
    *v5 = &gMediaChangeList;
  }
  ExReleaseFastMutexUnsafeAndLeaveCriticalRegion(gMediaChangeMutex);
  if ( !v4 )
    return 0LL;
  PushW32ThreadLock(v4, &v18, (__int64)Win32FreePool);
  ...
  {
    PushW32ThreadLock((__int64)FileObject, &v16, UserDereferenceObject);
