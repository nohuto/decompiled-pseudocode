/*
 * XREFs of ?vCharPos_H1@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJPEBJVEFLOAT@@@Z @ 0x1C010F9A0
 * Callers:
        ...
        int a7)
{
  ...
  if ( !*(_QWORD *)(v14 + 480) )
  {
    result = (struct _GLYPHDATA *)RFONTOBJ::bAllocateCache(v8, (struct RFONTOBJ *)a1, (__int64)v10, a4);
    if ( !(_DWORD)result )
      return result;
    v11 = (struct ESTROBJ *)a1;
    v8 = a3;
...
LABEL_9:
    if ( !v25->gdf.pgb
      ...
      && !(unsigned int)RFONTOBJ::bInsertGlyphbits(a3, v25, v15 == v9, a4) )
    {
      a7 = 0;
    }
    ++v15;
