/*
 * XREFs of xxxInjectTouchInput @ 0x1C01AFFF4
 * Callers:
 ...
 *     ?CheckCurrentInjectionConfiguration@@YAXXZ @ 0x1C01AE534 (-CheckCurrentInjectionConfiguration@@YAXXZ.c)
 ...
 *     ?SortTouchContacts@@YAHPEAUtagPOINTER_TOUCH_INFO@@I@Z @ 0x1C01AEC80 (-SortTouchContacts@@YAHPEAUtagPOINTER_TOUCH_INFO@@I@Z.c)
 ...
 *     ?_GetQpcBasedTouchStackTime@@YAKXZ @ 0x1C01AF4C0 (-_GetQpcBasedTouchStackTime@@YAKXZ.c)
 *     ?_ValidateInjectionQpcCount@@YAH_K00HH@Z @ 0x1C01AF54C (-_ValidateInjectionQpcCount@@YAH_K00HH@Z.c)
 *     ?_ValidateInjectionTime@@YAHKKKHH@Z @ 0x1C01AF5CC (-_ValidateInjectionTime@@YAHKKKHH@Z.c)
 ...
 *     ?xxxSendToTouchStack@@YAXPEAUDEVICEINFO@@IPEAUtagPOINTER_TOUCH_INFO@@K@Z @ 0x1C01AF7A4 (-xxxSendToTouchStack@@YAXPEAUDEVICEINFO@@IPEAUtagPOINTER_TOUCH_INFO@@K@Z.c)
...
LABEL_93:
    ...
    *(_QWORD *)&v95 = v35;
    ...
    {
      *(_DWORD *)(v34 + 32) = 0;
      *(_DWORD *)(*(_QWORD *)(v5 + 912) + 36LL) = 0;
      *(_DWORD *)(*(_QWORD *)(v5 + 912) + 40LL) = 0;
      *(_DWORD *)(*(_QWORD *)(v5 + 912) + 48LL) = 0;
      *(_QWORD *)(*(_QWORD *)(v5 + 912) + 56LL) = 0LL;
      *(_QWORD *)(*(_QWORD *)(v5 + 912) + 64LL) = 0LL;
      *(_DWORD *)(*(_QWORD *)(v5 + 912) + 72LL) = 0;
    }
    v36 = *(_QWORD *)(v5 + 912);
    v37 = v92;
    ...
    if ( v46 )
    {
      ...
      if ( !v52 )
      {
        xxxSendLastFrameTouchUp(v38, (struct DEVICEINFO *)v35, v25, *(_DWORD *)(*(_QWORD *)(v5 + 912) + 36LL));
        UserSetLastError(87);
        v26 = WPP_GLOBAL_Control;
        if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80000) == 0
    ...
    else
    {
      ...
      if ( !(unsigned int)_ValidateInjectionQpcCount(v37, v93, *(_QWORD *)(v53 + 800), v50, *(_DWORD *)(v49 + 72)) )
      {
        xxxSendLastFrameTouchUp(
          ...
          (struct DEVICEINFO *)v35,
          v25,
          (unsigned __int64)(10000LL * *(_QWORD *)(*(_QWORD *)(v5 + 912) + 56LL)) / gliQpcFreq);
        UserSetLastError(87);
        if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80000) == 0
          || BYTE1(WPP_GLOBAL_Control->Timer) < 2u )
