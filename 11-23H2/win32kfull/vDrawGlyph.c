/*
 * XREFs of vDrawGlyph @ 0x1C029FB6C
 * Callers:
 *     vStringBitmapTextOut @ 0x1C029FFA8 (vStringBitmapTextOut.c)
 * Callees:
 *     <none>
 */
      ...
      if ( v9 < v12 )
      {
        ...
        if ( (v8 & 7) != 0 )
        {
          ...
          do
          {
            ...
            if ( (_DWORD)v24 )
              *v26 |= byte_1C0328E08[v24] & (unsigned __int8)(v28 >> v17);
            --v15;
          }
          while ( v15 );
        }
        else
        {
          ...
          do
          {
            ...
            if ( (_DWORD)v18 )
            {
              LOBYTE(v3) = byte_1C0328E08[v18] & *v20;
              *v21 |= v3;
            }
            --v15;
          }
