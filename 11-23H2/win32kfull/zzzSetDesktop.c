/*
 * XREFs of zzzSetDesktop @ 0x1C002B850
 * Callers:
    ...
    else
    {
      ...
      *((_DWORD *)a1 + 224) = HandleInformation.GrantedAccess;
      ...
      if ( CurrentProcessWin32Process )
      {
        ...
        if ( CurrentProcessWin32Process
          && v8 < *(_DWORD *)(CurrentProcessWin32Process + 720)
          && _bittest64(*(const signed __int64 **)(CurrentProcessWin32Process + 728), v8) )
        {
          v9 = 1;
        }
      }
...
LABEL_34:
  ...
  if ( a2 )
  {
    *((_QWORD *)a1 + 58) = *(_QWORD *)(a2 + 8);
    v19 = (_QWORD *)((char *)a1 + 744);
    v20 = (_QWORD *)(a2 + 176);
    v21 = *(_QWORD *)(a2 + 176);
    if ( *(_QWORD *)(v21 + 8) != a2 + 176 )
      goto LABEL_34;
    *v19 = v21;
    *((_QWORD *)a1 + 94) = v20;
    *(_QWORD *)(v21 + 8) = v19;
...
LABEL_50:
  ...
  if ( v30 == v23 )
    ...
    *(_QWORD *)(v31 + 96) = &v30[-*v26];
  if ( *((_QWORD *)a1 + 54) && (*((_DWORD *)a1 + 122) & 0x80u) == 0 && *v12 )
  {
    if ( !gbInDestroyHandleTableObjects )
    {
      v32 = (PERESOURCE *)SGDCRITTYPEgpresUser<_ERESOURCE *>::operator _ERESOURCE * &();
...
LABEL_65:
    ...
    if ( !gbInDestroyHandleTableObjects )
    {
      v35 = (PERESOURCE *)SGDCRITTYPEgpresUser<_ERESOURCE *>::operator _ERESOURCE * &();
...
LABEL_82:
        ...
        if ( v37 )
          tagQ::zzzAttachToQueue(v37, a1, 0LL, 0);
      }
    }
  }
