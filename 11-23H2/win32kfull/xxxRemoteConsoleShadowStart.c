/*
 * XREFs of xxxRemoteConsoleShadowStart @ 0x1C0202F40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GreConsoleShadowStart @ 0x1C02DC290 (GreConsoleShadowStart.c)
...
LABEL_29:
      ...
      if ( MirrorDriver < 0 )
      {
        ...
        {
          v18 = &WPP_38afe8d8a8303f1671169ac824553c0d_Traceguids;
          LOBYTE(v18) = v9;
