/*
 * XREFs of ?ppoGetPath@XCLIPOBJ@@QEAAPEAU_PATHOBJ@@XZ @ 0x1C0264A58
 * Callers:
 ...
 *     CLIPOBJ_ppoGetPath @ 0x1C0264D20 (CLIPOBJ_ppoGetPath.c)
 *     VerifierCLIPOBJ_ppoGetPath @ 0x1C02A63B0 (VerifierCLIPOBJ_ppoGetPath.c)
 * Callees:
 *     __security_check_cookie @ 0x1C01381F0 (__security_check_cookie.c)
 *     ?vLock@EPATHOBJ@@QEAAXPEAUHPATH__@@@Z @ 0x1C0158F0A (-vLock@EPATHOBJ@@QEAAXPEAUHPATH__@@@Z.c)
 *     ?bDiagonalizePath@RTP_PATHMEMOBJ@@QEAAHPEAVEPATHOBJ@@@Z @ 0x1C02DF2A4 (-bDiagonalizePath@RTP_PATHMEMOBJ@@QEAAHPEAVEPATHOBJ@@@Z.c)
 */
