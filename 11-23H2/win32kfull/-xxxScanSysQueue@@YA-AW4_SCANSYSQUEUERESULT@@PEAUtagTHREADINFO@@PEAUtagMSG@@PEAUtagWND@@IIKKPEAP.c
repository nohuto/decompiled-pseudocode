/*
 * XREFs of ?xxxScanSysQueue@@YA?AW4_SCANSYSQUEUERESULT@@PEAUtagTHREADINFO@@PEAUtagMSG@@PEAUtagWND@@IIKKPEAPEAUtagQMSG@@@Z @ 0x1C012BAE0
 * Callers:
 ...
 *     IsInsideMenuLoop @ 0x1C00951F0 (IsInsideMenuLoop.c)
 ...
 *     Feature_WebThreatDefenseToggle__private_IsEnabledDeviceUsage @ 0x1C0139F4C (Feature_WebThreatDefenseToggle__private_IsEnabledDeviceUsage.c)
 *     MicrosoftTelemetryAssertTriggeredArgsKM @ 0x1C014083C (MicrosoftTelemetryAssertTriggeredArgsKM.c)
 *     strcmp_0 @ 0x1C01409A2 (strcmp_0.c)
 ...
 *     ?ResetMouseHover@@YAXPEAUtagDESKTOP@@UtagPOINT@@@Z @ 0x1C014FF26 (-ResetMouseHover@@YAXPEAUtagDESKTOP@@UtagPOINT@@@Z.c)
 ...
 *     GetMessageWindow @ 0x1C01555C6 (GetMessageWindow.c)
              ...
              if ( !v385 )
              {
                ...
                LockExchangeW32Thread(v199, (__int64)&v420);
                   ...
                   && !(unsigned __int8)CheckAccess(
                                          &v399,
                                          *(_QWORD *)(*(_QWORD *)(ThreadDesktopWindow + 16) + 424LL) + 896LL) )
            {
            ...
            if ( v82 )
            {
              ...
              if ( (WORD2(v398) & 0x8000) == 0 )
              {
                ...
                *((_QWORD *)&v443 + 1) = v370;
                ...
                if ( (BYTE2(v444) & 1) != 0 )
                {
                  if ( (*(_DWORD *)(*((_QWORD *)v8 + 53) + 824LL) & 0x30) == 0x10 )
                    WORD1(v444) |= 0x10u;
