/*
 * XREFs of ?xxxArrangeWindow@@YAXPEAUtagWND@@W4_WINDOW_ARRANGEMENT_COMMAND@@@Z @ 0x1C01EB2A4
 * Callers:
 ...
 *     ?ArrangeActionCompatibleWithStyle@@YAHPEAUtagWND@@W4_WARR_ACTIONS@@@Z @ 0x1C01E88B0 (-ArrangeActionCompatibleWithStyle@@YAHPEAUtagWND@@W4_WARR_ACTIONS@@@Z.c)
      ...
      if ( *(_DWORD *)*gpDispInfo > 1u || (LOBYTE(v4) = v2 - 22, (unsigned int)(v2 - 22) > 1) )
      {
          ...
          || (LOBYTE(v4) = ShellWindowManagement::BehaviorEnabled(a1[3], (const struct tagDESKTOP *)2), !(_BYTE)v4) )
        {
          ...
          if ( (_DWORD)v4 != 6 )
          {
            ...
            v6 = *((_DWORD *)&unk_1C03117A0 + 10 * v4 + v5 + 4);
            if ( v6 != 8 )
            {
              if ( (*((_DWORD *)&unk_1C03117A0 + 10 * v4 + 3) & 1) == 0 )
