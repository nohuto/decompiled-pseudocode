/*
 * XREFs of ?AllocateSessionGlobalsArea@Full@Gre@@YA_NXZ @ 0x1C0092AA8
 * Callers:
 *     AllocateEditionSessionGlobalsArea @ 0x1C0092A90 (AllocateEditionSessionGlobalsArea.c)
 * Callees:
