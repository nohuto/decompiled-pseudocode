/*
 * XREFs of NtUserRegisterPointerDeviceNotifications @ 0x1C009C420
 * Callers:
 *     <none>
 * Callees:
 *     _RegisterPointerDeviceNotifications @ 0x1C009C504 (_RegisterPointerDeviceNotifications.c)
...
__int64 __fastcall NtUserRegisterPointerDeviceNotifications(__int64 a1, unsigned int a2)
{
  ...
  if ( v4 )
  {
    ...
    {
      if ( a2 && !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 424LL) + 896LL, &v13) )
      {
