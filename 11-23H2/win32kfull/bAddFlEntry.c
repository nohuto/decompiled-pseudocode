/*
 * XREFs of bAddFlEntry @ 0x1C0112C30
 * Callers:
...
__int64 __fastcall bAddFlEntry(unsigned __int16 *a1, __int64 a2, int a3, int a4, _QWORD *a5)
{
  struct PFF *v7; // rax
  __int64 v8; // rcx
  WCHAR *v9; // rdi
...
LABEL_151:
  ...
  if ( v9[1] == 58 && v9[2] == 92 )
  {
    if ( (int)StringCchCopyW(v24, 0x104uLL, v9) < 0 )
      goto LABEL_152;
    v94 = v9;
    do
    {
...
LABEL_104:
  ...
  *(_QWORD *)&v107 = *(_QWORD *)(v106 + 20272);
  ...
  if ( !v11 )
  {
    ...
    if ( (int)StringCchCopyW((unsigned __int16 *)(v86 + 32), 0x21uLL, a1) < 0 )
    {
