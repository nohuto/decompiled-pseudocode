/*
 * XREFs of ?xxxSetWindowLongPtr@@YA_KPEAUtagWND@@H_KHH@Z @ 0x1C00A7D28
 * Callers:
...
__int64 __fastcall xxxSetWindowLongPtr(struct tagWND *a1, int a2, __int64 a3, __int64 a4, int a5)
{
  ...
  if ( *(_DWORD *)(v19 + 780) != *(_DWORD *)(v18 + 780) || (v16 = 1, *(_DWORD *)(v19 + 784) != *(_DWORD *)(v18 + 784)) )
LABEL_10:
    v16 = 0;
LABEL_11:
  if ( !v16 )
    ...
    if ( v6 + 8 > v20 )
    {
      ...
      if ( v23 != v22 )
      {
        ...
        if ( (v24 & 0x10) == 0 )
        {
          ...
          if ( !(unsigned __int8)CheckAccess(v26 + 896, v25) )
          {
...
LABEL_58:
  ...
  if ( !a5 )
    goto LABEL_77;
  v39 = *(const signed __int16 **)(*((_QWORD *)a1 + 17) + 8LL);
  if ( !_bittest16(v39 + 3, 8u) )
    goto LABEL_77;
  v40 = 0LL;
  v41 = *(unsigned __int16 *)v39;
  v42 = &gDefaultServerClasses;
  while ( (_WORD)v41 != *(_WORD *)(gpsi + 2LL * ((*v42 >> 3) & 0x1F) + 868) )
  {
  ...
  if ( (int)v6 >= *((_DWORD *)&gDefaultServerClasses + 12 * (unsigned int)v40 + 6) )
    goto LABEL_77;
  v44 = Feature_Backport_UserModeTooltips__private_IsEnabledDeviceUsage(v40, v42, v41, gpsi, v52, v53) != 0;
