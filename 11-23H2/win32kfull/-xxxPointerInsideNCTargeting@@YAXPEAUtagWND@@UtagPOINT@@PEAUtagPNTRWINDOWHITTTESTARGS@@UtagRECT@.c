/*
 * XREFs of ?xxxPointerInsideNCTargeting@@YAXPEAUtagWND@@UtagPOINT@@PEAUtagPNTRWINDOWHITTTESTARGS@@UtagRECT@@K@Z @ 0x1C01E41C0
 * Callers:
 ...
 *     ?_TTCheckNCTarget@@YAHUtagRECT@@PEAUtagWND@@PEAUtagPNTRWINDOWHITTTESTARGS@@PEAU1@PEAGPEAUtagPOINT@@3K@Z @ 0x1C01E3FC0 (-_TTCheckNCTarget@@YAHUtagRECT@@PEAUtagWND@@PEAUtagPNTRWINDOWHITTTESTARGS@@PEAU1@PEAGPEAUtagPOIN.c)
        ...
        unsigned int a5)
{
  ...
  if ( v33[0] < 0xFFDu )
  {
    ...
    v34 = 0;
    xxxSendNCHitTest((ULONG_PTR)a1, a2, v30[4], &v35, &v34, a3);
    v31 = v34;
