/*
 * XREFs of DwmAsyncDestroyDCompositionHwndTarget @ 0x1C008F0C4
 * Callers:
 *     EditionNotifyDwmForSystemVisualDestruction @ 0x1C008F060 (EditionNotifyDwmForSystemVisualDestruction.c)
 * Callees:
 *     <none>
 */
