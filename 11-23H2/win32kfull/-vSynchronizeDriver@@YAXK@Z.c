/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C00C2CEC
 * Callers:
 *     GreFlush @ 0x1C00C2CD0 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C02A7160 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
