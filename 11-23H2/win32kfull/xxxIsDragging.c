/*
 * XREFs of xxxIsDragging @ 0x1C022F688
 * Callers:
 *     xxxSysCommand @ 0x1C00857C4 (xxxSysCommand.c)
 *     NtUserDragDetect @ 0x1C01CDFA0 (NtUserDragDetect.c)
 * Callees:
  ...
  *(_QWORD *)(gptiCurrent + 416LL) = v20;
  ...
  do
  {
    while ( 1 )
    {
      ...
      while ( (unsigned int)xxxInternalGetMessage(&v17, 0LL, 512, 526, 1, 0)
           || (unsigned int)xxxInternalGetMessage(&v17, 0LL, 35, 35, 1, 0)
           || (unsigned int)xxxInternalGetMessage(&v17, 0LL, 256, 265, 1, 0)
