/*
 * XREFs of SfnOUTSTRING @ 0x1C00925A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_40:
  ...
  v10 = (unsigned __int8 *)AllocCallbackMessage(0x60u, 1u, (unsigned int)v15, v51, 0, 0x200uLL);
  v39 = v10;
  if ( !v10 )
    return 0LL;
  PtiCurrentShared();
  ...
  v46 = 0LL;
  if ( v10 != v50 && v10 != v51 )
    PushW32ThreadLock(v10, &v45, Win32FreePool);
  *((_QWORD *)v10 + 5) = v13;
  *((_DWORD *)v10 + 12) = v41;
  if ( v35 )
  {
...
LABEL_13:
  ...
  *(_QWORD *)(v23 + 80) = v44;
  ...
  v25 = CalcOutputStringSize((struct _CALLBACKSTATUS *)&v43, v25, *(_DWORD *)(a4 + 4) >> 31, v35);
  RegionSize = v25;
