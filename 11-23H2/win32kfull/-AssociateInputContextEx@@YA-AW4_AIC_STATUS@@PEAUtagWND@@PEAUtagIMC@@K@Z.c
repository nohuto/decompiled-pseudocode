/*
 * XREFs of ?AssociateInputContextEx@@YA?AW4_AIC_STATUS@@PEAUtagWND@@PEAUtagIMC@@K@Z @ 0x1C01B6DAC
 * Callers:
 ...
 *     ?AssociateInputContext@@YAPEAUHIMC__@@PEAUtagWND@@PEAUtagIMC@@@Z @ 0x1C01B6D84 (-AssociateInputContext@@YAPEAUHIMC__@@PEAUtagWND@@PEAUtagIMC@@@Z.c)
 */
...
LABEL_31:
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    if ( v11 )
    {
      v12 = BuildHwndList(v11, (const struct tagWND *)3, (__int64)v5, 1LL);
      v13 = v12;
      if ( v12 )
      {
