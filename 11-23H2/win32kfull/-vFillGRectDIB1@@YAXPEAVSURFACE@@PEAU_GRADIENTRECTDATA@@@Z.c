/*
 * XREFs of ?vFillGRectDIB1@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02F6AC0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Xlate555 )
  {
    ...
    if ( v3 < v5 )
    {
      ...
      do
      {
        ...
        {
          v19 = (_BYTE *)(v6 + v13 / 8);
          v40 = (char *)&unk_1C0329CE0 + 16 * (((_BYTE)v3 + (_BYTE)v11) & 0xFu);
          v20 = v13 + v45;
          v21 = v12;
          do
          {
            ...
            ++v20;
            v25 = v18 + 1;
            *v19 = *v19 & ~(1 << (7 - v18)) | (byte_1C03299E0[Xlate555[~(_BYTE)v24 & 0x1F | v23]] << (7 - v18));
            v26 = v19 + 1;
            if ( v18 != 7 )
              v26 = v19;
            v19 = v26;
