/*
 * XREFs of xxxMenuWindowProc @ 0x1C0219F60
 * Callers:
 ...
 *     IsPointerParentNotify @ 0x1C0118D6C (IsPointerParentNotify.c)
 ...
 *     zzzShowFade @ 0x1C01BCCB8 (zzzShowFade.c)
 ...
 *     MNCreateAnimationBitmap @ 0x1C01FE9E8 (MNCreateAnimationBitmap.c)
 ...
 *     MNDrawEdge @ 0x1C0233F70 (MNDrawEdge.c)
 ...
 *     MNFindNextValidItem @ 0x1C023E700 (MNFindNextValidItem.c)
        ...
        __int64 a4)
{
  ...
  v153 = 0LL;
  v151 = 0LL;
  if ( !(unsigned int)xxxValidateClassAndSize((__int64)a1, a2, a3, a4, 668, 129, &v142) )
  {
    v8 = (__int64)v142;
LABEL_137:
              ...
              if ( (v90 & 0x100) != 0 )
              {
                ...
                if ( (v94 & 0x10000) != 0 && gpqForeground == *(_QWORD *)(gptiCurrent + 432LL) )
                {
                  *(_DWORD *)(i + 8) = v94 & 0xFFFEFFFF;
                  PostMessage((struct tagWND *)a1, 0x1F2u, 0LL, 0LL);
                  goto LABEL_164;
                }
                goto LABEL_166;
              }
...
LABEL_167:
                PostMessage(v95, 0x1F3u, 0LL, 0LL);
                goto LABEL_305;
              }
...
LABEL_174:
              ...
              *((_QWORD *)&v149 + 1) = a1;
              ...
              {
                xxxActivateWindowWithOptions((const struct tagWND *)a1, 0, 0LL, 1);
              }
              ...
              if ( v104 )
              {
                ...
                if ( v106 )
                {
                  ...
                  if ( *v104 )
                  {
                    ...
                    xxxSetWindowPos((struct tagWND *)*v105, 0LL, (unsigned int)v141, HIDWORD(v141), 0, 0, 1029);
...
LABEL_277:
        ...
        if ( !(_DWORD)v24 )
        {
          ...
          if ( !a3 || (*(_DWORD *)(i + 8) & 0x10000) != 0 )
            ...
            v120 = 1;
          xxxDWP_DoNCActivate(*(__int64 **)(*(_QWORD *)v140[0] + 8LL), v120, 1LL);
          goto LABEL_245;
        }
...
LABEL_94:
    ...
    switch ( (_DWORD)v24 )
    {
      case 0x83:
        v139 = v144[0];
        xxxDefWindowProc((struct tagWND *)a1, 0x83u, a3, v144[0]);
      ...
      case 0x85:
        ...
        else
        {
          ...
          else
          {
            ...
            {
              v134 = xxxDefWindowProc((struct tagWND *)a1, v141, a3, v144[0]);
              if ( (unsigned int)MNIsUAHMenu(v19) )
              {
                v136 = v140[0];
                v135 = *(_QWORD *)v140[0];
...
LABEL_37:
  ...
  if ( (unsigned int)v24 > 0x2A3 )
  {
    ...
    if ( (v144[0] & 2) != 0 && (*(_DWORD *)(v19 + 124) & 3) != 0 )
    {
      ...
      xxxDefWindowProc((struct tagWND *)a1, v141, a3, v80 & 0xFFFFFFFFFFFFFFFDuLL);
      GreSetWindowOrg((HDC)a3);
      goto LABEL_305;
    }
    ValidItem = xxxDefWindowProc((struct tagWND *)a1, 0x317u, a3, v144[0]);
    if ( !(unsigned int)MNIsUAHMenu(v19)
  ...
  if ( (unsigned int)v24 > 0x1ED )
  {
    ...
    if ( !v68 )
    {
      xxxActivateWindowWithOptions(*(const struct tagWND **)(*(_QWORD *)v140[0] + 16LL), 0, 0LL, 1);
      goto LABEL_305;
    }
    ...
    if ( (_DWORD)v24 )
    {
      ...
      ThreadLockAlways(*(_QWORD *)(*(_QWORD *)v140[0] + 8LL), &v151);
      *(_DWORD *)(i + 8) |= 0x8000u;
      v72 = xxxSendMessage(*(_QWORD *)(*(_QWORD *)v140[0] + 8LL));
  ...
  if ( v25 )
  {
    ...
    if ( v30 )
    {
      ...
      if ( (_DWORD)v24 )
      {
        if ( (_DWORD)v24 == 1 )
        {
          xxxPlayEventSound(5LL, 256LL, (__int64)FadeInternal, v18);
          xxxShowWindowEx((struct tagWND *)a1, BYTE1(*(_DWORD *)(i + 8)) & 1 | 4, 0);
          goto LABEL_305;
        }
LABEL_164:
        if ( v9 )
LABEL_165:
          ThreadUnlock1(v24, v21, FadeInternal);
LABEL_135:
        v8 = xxxDefWindowProc((struct tagWND *)a1, v141, a3, v144[0]);
        goto LABEL_136;
      }
...
LABEL_56:
  ...
  v51 = _MonitorFromWindowInternal((struct tagWND *)a1, 1LL, 0LL);
  v52 = *(_DWORD *)(v19 + 64);
  v142 = v51;
  SmartObjStackRefBase<tagMENU>::Init(&v147, v19);
  v148 = 0LL;
