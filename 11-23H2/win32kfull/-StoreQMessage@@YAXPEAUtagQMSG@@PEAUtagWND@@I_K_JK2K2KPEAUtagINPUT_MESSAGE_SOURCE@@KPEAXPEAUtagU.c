/*
 * XREFs of ?StoreQMessage@@YAXPEAUtagQMSG@@PEAUtagWND@@I_K_JK2K2KPEAUtagINPUT_MESSAGE_SOURCE@@KPEAXPEAUtagUIPI_INFO@@@Z @ 0x1C011F900
 * Callers:
        ...
        struct tagUIPI_INFO *a14)
{
  ...
  *((_QWORD *)a1 + 18) = a13;
  ...
  else
  {
    v40 = a14;
    if ( !a14 )
      v40 = (struct tagUIPI_INFO *)(*(_QWORD *)(gptiCurrent + 424LL) + 896LL);
    v41 = *(_QWORD *)v40;
    *((_DWORD *)a1 + 25) |= 0x800u;
    *((_QWORD *)a1 + 14) = v41;
  }
