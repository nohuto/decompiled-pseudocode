/*
 * XREFs of CheckHandleFlag @ 0x1C0078380
 * Callers:
 *     _GetUserObjectInformation @ 0x1C006F2F4 (_GetUserObjectInformation.c)
 *     OkayToCloseWindowStation @ 0x1C0078260 (OkayToCloseWindowStation.c)
 *     OkayToCloseDesktop @ 0x1C00782F0 (OkayToCloseDesktop.c)
 * Callees:
...
__int64 __fastcall CheckHandleFlag(PRKPROCESS PROCESS, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v11 && v8 < *(_DWORD *)(v11 + 720) && _bittest64(*(const signed __int64 **)(v11 + 728), v8) )
    v6 = 1;
  if ( v7 )
