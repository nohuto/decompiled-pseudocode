/*
 * XREFs of ?GreExtEscapeInternal@@YAHAEAVDCOBJ@@HHPEADH1AEBUTag@RFONTOBJ@@@Z @ 0x1C0275074
 * Callers:
        ...
        const struct RFONTOBJ::Tag *a7)
{
  ...
  int v33; // [rsp+48h] [rbp-190h]
  HDEV v34; // [rsp+50h] [rbp-188h] BYREF
  unsigned __int16 v35; // [rsp+58h] [rbp-180h]
  int v36; // [rsp+5Ch] [rbp-17Ch]
  int v37; // [rsp+60h] [rbp-178h]
  struct _RECTL v38; // [rsp+70h] [rbp-168h] BYREF
  __int64 v39; // [rsp+80h] [rbp-158h] BYREF
  int v40; // [rsp+8Ch] [rbp-14Ch]
  _BYTE v41[112]; // [rsp+90h] [rbp-148h] BYREF
  _BYTE v42[112]; // [rsp+100h] [rbp-D8h] BYREF
  __int128 v43; // [rsp+170h] [rbp-68h] BYREF
  __int128 v44; // [rsp+180h] [rbp-58h]
