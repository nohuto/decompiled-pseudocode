/*
 * XREFs of ?pxrlStrRead04@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C0080FE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        v46 = (v42 & (unsigned int)dword_1C0319840[v44]) >> dword_1C0319820[v62];
        if ( a5 )
          LODWORD(v46) = a5->pulXlate[v46];
        if ( (v41 & dword_1C03197A0[v45]) != 0 )
        {
    ...
    if ( a6 < a7 )
    {
      ...
      if ( a5 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( (_DWORD)v29 )
          {
            v30 = v15->pulXlate[(unsigned __int64)(v17 & (unsigned int)dword_1C0319840[v18]) >> dword_1C0319820[v18]];
            v31 = &v9[v28 + 2];
      ...
      else
      {
        ...
        {
          v20 = *v16++;
          v21 = (v17 & (unsigned int)dword_1C0319840[v18]) >> dword_1C0319820[v18];
          if ( (_DWORD)v20 )
          {
            v22 = &v9[v19 + 2];
