/*
 * XREFs of ?bWiden@WIDENER@@IEAAHXZ @ 0x1C015D470
 * Callers:
 ...
 *     ?vNextStyleEvent@STYLER@@QEAAXXZ @ 0x1C02F24EC (-vNextStyleEvent@STYLER@@QEAAXXZ.c)
 *     ?vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ @ 0x1C02F278C (-vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ.c)
 *     ?vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ @ 0x1C02F2800 (-vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ.c)
 */
