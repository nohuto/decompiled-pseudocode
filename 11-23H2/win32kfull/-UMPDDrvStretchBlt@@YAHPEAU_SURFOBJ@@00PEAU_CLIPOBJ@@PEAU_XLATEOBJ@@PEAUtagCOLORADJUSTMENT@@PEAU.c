/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02BCF90
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v17, (UMPDOBJ *)((char *)v17 + 112), (const void **)&v52, 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::pxlo(v17, &v53) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v54, 0x18u) )
            {
              ...
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v56, 0x10u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v57, 0x10u) )
                  {
                    ...
                    {
                      LODWORD(Size) = 4;
                      if ( (unsigned int)UMPDOBJ::Thunk(v17, v47, 0x80u, &v24, Size) != -1 )
                      {
                        if ( v24 )
                          v21 = 1;
                      }
