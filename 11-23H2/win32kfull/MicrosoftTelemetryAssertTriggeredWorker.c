/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C0306C18
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredArgsKM @ 0x1C014083C (MicrosoftTelemetryAssertTriggeredArgsKM.c)
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1C0306BE8 (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 * Callees:
 *     TakeTelemetryAssertsLock @ 0x1C00998E8 (TakeTelemetryAssertsLock.c)
 ...
 *     GetImageTuple @ 0x1C0306B98 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C0307334 (_tlgCreate1Sz_char.c)
 */
...
LABEL_45:
  ...
  if ( v37 )
  {
    if ( (unsigned int)dword_1C0398040 > 5 && tlgKeywordOn((__int64)&dword_1C0398040, 0x400000000000LL) )
    {
      v38 = 10;
      v80 = &v38;
      v25 = "<unknown>";
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C0398040,
        (unsigned __int8 *)dword_1C031EA8B,
        0LL,
        0LL,
        0xEu,
        &v79);
  ...
  else if ( (unsigned int)dword_1C0398040 > 5 && tlgKeywordOn((__int64)&dword_1C0398040, 0x400000000000LL) )
  {
    v48 = 10;
    v103 = &v48;
    v29 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0398040, byte_1C031EB35, 0LL, 0LL, 0xBu, &v102);
  }
  if ( dword_1C0398078 && !v55 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C0398040 > 5 && tlgKeywordOn((__int64)&dword_1C0398040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C0398040,
        (unsigned __int8 *)dword_1C031EBA2,
        0LL,
        0LL,
        v32,
        &v63);
