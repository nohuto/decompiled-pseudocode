/*
 * XREFs of ?DestroyHandleInternal@?$CMonitorHandleTable@VCPhysicalMonitorHandle@@PEAX@OPM@@AEAAJPEAVCPhysicalMonitorHandle@@KPEAVCMutex@2@@Z @ 0x1C0269478
 * Callers:
 *     MonitorAPIProcessTerminating @ 0x1C007E5B0 (MonitorAPIProcessTerminating.c)
