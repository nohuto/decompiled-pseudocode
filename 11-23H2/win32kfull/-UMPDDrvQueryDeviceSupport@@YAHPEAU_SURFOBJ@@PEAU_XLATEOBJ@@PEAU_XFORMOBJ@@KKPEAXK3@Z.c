/*
 * XREFs of ?UMPDDrvQueryDeviceSupport@@YAHPEAU_SURFOBJ@@PEAU_XLATEOBJ@@PEAU_XFORMOBJ@@KKPEAXK3@Z @ 0x1C02BB960
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  if ( v10 )
  {
    ...
    if ( (!v14 || (unsigned int)UMPDOBJ::ThunkMemBlock(v12, (const void **)&v46, v14))
      && (!Size || (v48 = UMPDOBJ::_AllocUserMem(v12, Size, 1)) != 0LL)
      ...
      && (LODWORD(v25) = 4, (unsigned int)UMPDOBJ::Thunk(v12, v39, 0x50u, &v26, v25) != -1) )
    {
      ...
      {
        v22 = (char *)v48;
        if ( (unsigned __int64)v48 + Size > MmUserProbeAddress || (char *)v48 + Size < v48 )
