/*
 * XREFs of NtUserSetCalibrationData @ 0x1C01D9E70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetCalibrationData(__int64 a1, unsigned int a2, volatile void *a3, int a4)
{
  ...
  if ( a4 == 3 )
  {
    if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 424LL) + 896LL, v26) )
      goto LABEL_10;
  }
  else if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 424LL) + 896LL, v25) )
  {
LABEL_10:
