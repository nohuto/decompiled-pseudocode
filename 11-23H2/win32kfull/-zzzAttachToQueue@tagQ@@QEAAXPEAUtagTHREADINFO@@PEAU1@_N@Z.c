/*
 * XREFs of ?zzzAttachToQueue@tagQ@@QEAAXPEAUtagTHREADINFO@@PEAU1@_N@Z @ 0x1C0039524
 * Callers:
 ...
 *     ?CheckTransferState@tagQ@@AEAAKPEAUtagTHREADINFO@@PEQ1@PEAUtagWND@@_N@Z @ 0x1C003998C (-CheckTransferState@tagQ@@AEAAKPEAUtagTHREADINFO@@PEQ1@PEAUtagWND@@_N@Z.c)
...
LABEL_25:
  ...
  if ( gspwndCursor && a2 == *(struct tagTHREADINFO **)(gspwndCursor + 16LL) )
    LockQCursor(this, *(_QWORD *)(*((_QWORD *)a2 + 54) + 384LL));
  *((_DWORD *)this + 98) += *((_DWORD *)a2 + 190);
  *((_QWORD *)this + 12) = a2;
  *((_QWORD *)this + 13) = a2;
  v25 = *(_DWORD *)(*((_QWORD *)a2 + 53) + 896LL);
