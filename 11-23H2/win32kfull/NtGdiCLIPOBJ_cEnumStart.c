/*
 * XREFs of NtGdiCLIPOBJ_cEnumStart @ 0x1C02C7D80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_CLIPOBJ@@@UMPDOBJ@@QEAAPEAU_CLIPOBJ@@PEAU1@@Z @ 0x1C0298240 (--$GetDDIOBJ@U_CLIPOBJ@@@UMPDOBJ@@QEAAPEAU_CLIPOBJ@@PEAU1@@Z.c)
 */
