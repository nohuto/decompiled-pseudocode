/*
 * XREFs of ?IsPointerQueuedMessageCoalescable@@YAHPEAUtagQ@@PEAUtagQMSG@@KK_KK@Z @ 0x1C01E82CC
 * Callers:
 *     EditionIsPointerQueuedMessageCoalescable @ 0x1C0155570 (EditionIsPointerQueuedMessageCoalescable.c)
 * Callees:
