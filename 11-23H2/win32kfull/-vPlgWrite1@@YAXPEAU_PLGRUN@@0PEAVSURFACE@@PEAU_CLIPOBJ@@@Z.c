/*
 * XREFs of ?vPlgWrite1@@YAXPEAU_PLGRUN@@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C0300840
 * Callers:
 *     <none>
 * Callees:
                ...
                do
                {
                  ...
                  if ( !v31 )
                  {
                    if ( v33 )
                      *v30 = v32;
                    ++v30;
                    v31 = *((_BYTE *)&dword_1C0329F28 + (v26 & 7));
                    if ( v26 < 0
                      || v26 >= *((_DWORD *)a3 + 14)
    ...
    else if ( a1 < a2 )
    {
      ...
      do
      {
        ...
        for ( j = *((_QWORD *)a3 + 10) + v12; v11; --v11 )
        {
          ...
          v18 = *((_BYTE *)&dword_1C0329F28 + (*(_DWORD *)v8 & 7));
              ...
              if ( !v18 )
              {
                *v17++ = v19;
                if ( (unsigned __int64)v17 < v4 || (unsigned __int64)v17 > v9 )
                  ...
                  v19 = *v17;
                v18 = *((_BYTE *)&dword_1C0329F28 + (v15 & 7));
              }
              if ( !v16 )
                goto LABEL_21;
            }
