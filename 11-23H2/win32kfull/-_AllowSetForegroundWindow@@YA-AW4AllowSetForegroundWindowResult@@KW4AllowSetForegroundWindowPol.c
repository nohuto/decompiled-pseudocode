/*
 * XREFs of ?_AllowSetForegroundWindow@@YA?AW4AllowSetForegroundWindowResult@@KW4AllowSetForegroundWindowPolicy@@@Z @ 0x1C003214C
 * Callers:
...
LABEL_23:
    ...
    else
    {
      ...
      if ( v13 )
      {
        ...
        CInputGlobals::SetPtiLastWoken(gpInputGlobals, *(struct tagTHREADINFO **)(v13 + 328), v14);
        v9 = 1;
        goto LABEL_23;
      }
      v9 = 3;
