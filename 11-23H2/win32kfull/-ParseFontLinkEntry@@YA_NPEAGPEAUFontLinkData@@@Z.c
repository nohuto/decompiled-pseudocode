/*
 * XREFs of ?ParseFontLinkEntry@@YA_NPEAGPEAUFontLinkData@@@Z @ 0x1C029EA20
 * Callers:
 *     bDeleteFlEntry @ 0x1C029EF40 (bDeleteFlEntry.c)
 * Callees:
 *     ?ParseFontScaleFactor@@YA_NPEBGPEAJ@Z @ 0x1C029EB64 (-ParseFontScaleFactor@@YA_NPEBGPEAJ@Z.c)
 */
