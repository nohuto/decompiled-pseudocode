/*
 * XREFs of CheckEasPolicyChange @ 0x1C01BA710
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C035F848 != KeyInformation )
  {
    qword_1C035F848 = KeyInformation;
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C035F850 != KeyInformation )
  {
    qword_1C035F850 = KeyInformation;
    return 1;
  }
  return v0;
}
