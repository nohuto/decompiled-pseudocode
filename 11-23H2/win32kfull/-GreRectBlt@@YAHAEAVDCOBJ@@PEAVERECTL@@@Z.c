/*
 * XREFs of ?GreRectBlt@@YAHAEAVDCOBJ@@PEAVERECTL@@@Z @ 0x1C0299A10
 * Callers:
...
__int64 __fastcall GreRectBlt(struct DCOBJ *a1, struct ERECTL *a2)
{
  ...
  __int128 v32; // [rsp+1F8h] [rbp+F0h]
  __int64 v33; // [rsp+230h] [rbp+128h]
  int v34; // [rsp+238h] [rbp+130h]
  int v35; // [rsp+23Ch] [rbp+134h]
...
LABEL_21:
  DEVLOCKBLTOBJ::~DEVLOCKBLTOBJ((DEVLOCKBLTOBJ *)v18, v7, v8);
  BLTRECORD::~BLTRECORD((BLTRECORD *)v26);
  return v9;
}
