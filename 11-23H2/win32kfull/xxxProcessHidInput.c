/*
 * XREFs of xxxProcessHidInput @ 0x1C014E260
 * Callers:
 ...
 *     ?HidIsRequestedByThisProcess@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUDEVICEINFO@@PEAUtagPROCESS_HID_TABLE@@@Z @ 0x1C014E170 (-HidIsRequestedByThisProcess@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUDEVICEINFO@@PEAUtagPROCESS_HID_T.c)
...
__int64 __fastcall xxxProcessHidInput(struct DEVICEINFO *a1, void *a2, unsigned int a3)
{
  ...
  char v56; // [rsp+B8h] [rbp+20h] BYREF
  ...
  if ( (result & 0x2000) == 0 )
  {
    if ( (result & 0x4000) == 0
      ...
      && *(_WORD *)(result + 40) == 5 )
    {
      ReEnterLeaveCrit::ReEnterLeaveCrit((ReEnterLeaveCrit *)&v56);
      if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80000) == 0
      ...
      if ( gpqForeground )
      {
        ...
        v16 = HidIsRequestedByThisProcess(a1, *(struct tagPROCESS_HID_TABLE **)(v4 + 856));
        if ( v16 )
        {
            ...
            || (v20 = *(struct tagQ **)(*((_QWORD *)v19 + 2) + 432LL), *(char *)(*((_QWORD *)v19 + 5) + 20LL) >= 0) )
          {
            if ( (*((_DWORD *)a1 + 46) & 0x20) == 0
              ...
              || (!(unsigned __int8)IsInputThread(v21, v17, v18)
                ? (v22 = *(_QWORD *)(gptiCurrent + 424LL) + 896LL)
...
LABEL_83:
          ...
          if ( !v56 )
            return UserSessionSwitchLeaveCrit(v29, v39, v40, v41);
          return result;
        }
        if ( *((int *)i + 20) > 0 )
        {
...
LABEL_77:
      if ( gpqForeground )
      {
        if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(v33 + 432) + 432LL, gpqForeground + 432LL) )
        {
          ...
          {
            EtwTraceUIPIInputError(v36, 0LL, gpqForeground, *(_QWORD *)(gpqForeground + 432LL));
            goto LABEL_81;
          }
        }
      }
      v42 = SGDGetUserSessionState(v36) + 240;
      RIMLockShared(v42);
      if ( (*((_DWORD *)a1 + 46) & 0x2000) != 0 )
      {
        v45 = *(_QWORD *)(*((_QWORD *)a1 + 48) + 88LL);
        if ( !v45
          || *(int *)(v45 + 12) >= 0
          && ((v46 = *(_QWORD *)(*((_QWORD *)v32 + 2) + 432LL), !(unsigned __int8)IsInputThread(v45, v43, v44))
           || (*((_DWORD *)a1 + 50) & 0x80u) == 0
            ? (v47 = *(_QWORD *)(gptiCurrent + 424LL) + 896LL)
            : (v47 = *((_QWORD *)a1 + 59) + 944LL),
              !(unsigned __int8)CheckAccess(v47, v46 + 432)) )
        {
          RIMUnlockShared(v42);
          goto LABEL_81;
        }
