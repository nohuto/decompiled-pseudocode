/*
 * XREFs of bInitStockFontsInternal @ 0x1C03B33B8
 * Callers:
 *     bInitStockFonts @ 0x1C03B33A0 (bInitStockFonts.c)
 * Callees:
 *     ?bOpenKey@@YAHPEBGPEAPEAX@Z @ 0x1C0019A54 (-bOpenKey@@YAHPEBGPEAPEAX@Z.c)
 *     ?bSetStockFont@@YAHPEAXHH@Z @ 0x1C0019AE0 (-bSetStockFont@@YAHPEAXHH@Z.c)
 *     ?bQueryValueKey@@YAHPEBGPEAXPEAU_KEY_VALUE_PARTIAL_INFORMATION@@K@Z @ 0x1C0019F18 (-bQueryValueKey@@YAHPEBGPEAXPEAU_KEY_VALUE_PARTIAL_INFORMATION@@K@Z.c)
