/*
 * XREFs of ?xxxGetArrangeRectFromHitTarget@@YA_NPEAUMOVESIZEDATA@@PEAUtagMONITOR@@W4ShellNotificationWindowKind@@W4THRESHOLD_MARGIN_DIRECTION@@PEAUtagRECT@@@Z @ 0x1C01EC878
 * Callers:
  ...
  if ( *(_DWORD *)(a1 + 296) != 2 && a4 <= 2 )
  {
    ...
    if ( v9 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_AND_TRACE_SF_D(
        ...
        a4);
    *(_OWORD *)a5 = *(_OWORD *)GetMonitorWorkRectForWindow((__int64)&v22, a2, *(const struct tagWND **)(a1 + 16));
    if ( a4 )
    {
      if ( a4 == 1 )
      {
