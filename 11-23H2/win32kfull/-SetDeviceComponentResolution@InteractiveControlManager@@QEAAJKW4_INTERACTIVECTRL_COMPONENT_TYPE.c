/*
 * XREFs of ?SetDeviceComponentResolution@InteractiveControlManager@@QEAAJKW4_INTERACTIVECTRL_COMPONENT_TYPE@@JPEAW4tagINTERACTIVECTRL_HAPTICS_MODE@@@Z @ 0x1C00162B8
 * Callers:
        ...
        __int64 a5)
{
  ...
  do
  {
    ...
    if ( *v10 && (!a2 || a2 == *(_DWORD *)(v12 + 8)) )
    {
      ...
      v5 = v14;
      if ( v14 < 0 && (unsigned int)dword_1C0354150 > 2 )
      {
        LODWORD(v18) = v14;
