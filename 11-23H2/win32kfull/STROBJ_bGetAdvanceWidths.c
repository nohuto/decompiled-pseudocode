/*
 * XREFs of STROBJ_bGetAdvanceWidths @ 0x1C02DB220
 * Callers:
 *     NtGdiSTROBJ_bGetAdvanceWidths @ 0x1C02CCDD0 (NtGdiSTROBJ_bGetAdvanceWidths.c)
 * Callees:
 *     ?STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z @ 0x1C02D9010 (-STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z.c)
 */
