/*
 * XREFs of ?vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x1C0270E04
 * Callers:
 *     ?draw_clrt_f_ntb_o_to_temp_start@@YAXPEAU_GLYPHPOS@@KPEAEKKKK@Z @ 0x1C0270420 (-draw_clrt_f_ntb_o_to_temp_start@@YAXPEAU_GLYPHPOS@@KPEAEKKKK@Z.c)
 * Callees:
 *     <none>
 */
  ...
  do
  {
    ...
    do
    {
      ...
      if ( *v12 )
      {
        ...
        a1 = (struct _GLYPHBITS *)byte_1C0317060;
        ...
        if ( v22 > 6 )
          v22 = 6;
        v14 = byte_1C0317060[49 * v19 + 7 * v21 + v22];
      }
      *v12 = v14;
LABEL_15:
      ++v12;
