/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_DqD @ 0x1C001669C
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_DqD(__int64 a1, char a2, char a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  __int64 result; // rax
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_998a63ff47c63414c5882e9b8cb70cf1_Traceguids,
               76LL,
               (__int64 *)va,
               4LL,
               (__int64 *)va1,
