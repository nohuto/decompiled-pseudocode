/*
 * XREFs of ?CreateHLSURFClone@SFMLOGICALSURFACE@@SAPEAUHLSURF__@@PEAUHDEV__@@PEAV1@HHH@Z @ 0x1C00853DC
 * Callers:
 ...
 *     SFMLOGICALSURFACE_CreateHLSURFCloneWrap @ 0x1C02681E0 (SFMLOGICALSURFACE_CreateHLSURFCloneWrap.c)
 * Callees:
