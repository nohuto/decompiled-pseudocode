/*
 * XREFs of InitFNTCache @ 0x1C0018810
 * Callers:
 *     <none>
 * Callees:
 *     vGetFontDriverLWT @ 0x1C0018488 (vGetFontDriverLWT.c)
 *     vGetLastBootTimeStatus @ 0x1C00186BC (vGetLastBootTimeStatus.c)
 ...
 *     bFntCacheDisabled @ 0x1C001A08C (bFntCacheDisabled.c)
...
void __fastcall InitFNTCache(Gre::Base *a1)
{
  ...
  *(_DWORD *)(*(_QWORD *)(v4 + 19392) + 20LL) = 0;
  ...
  if ( !(unsigned int)bServicingStackModifiedFonts()
    && bMapFileRetainHandle(v9, (struct _FILEVIEW *)(*(_QWORD *)(v4 + 19392) + 48LL), 0, v10) )
  {
  ...
  if ( !*v11 )
  {
    if ( !*((_DWORD *)v2 + 752) )
      goto LABEL_19;
    inited = bInitCacheTable(v8, v1, v26, v25, v24, v23, AnsiCodePage);
LABEL_36:
    if ( inited )
      *(_DWORD *)(v4 + 19384) = 2;
    goto LABEL_19;
...
LABEL_34:
    if ( !*((_DWORD *)v20 + 752) )
      goto LABEL_19;
    inited = bInitCacheTable(v8, v31, v13, v14, v15, v16, v18);
    goto LABEL_36;
  }
  v19 = *((_DWORD *)v30 + 3);
  v20 = v22;
  if ( (v19 & 1) != 0
    || *((_DWORD *)v22 + 752)
    && ((v19 & 2) != 0 || *(_QWORD *)(v12 + 40) != v15 || v13 != *(_QWORD *)(v12 + 56) || v14 != *(_QWORD *)(v12 + 64)) )
  {
    goto LABEL_34;
  }
  *(_DWORD *)(v4 + 19384) = 1;
  if ( (unsigned int)RtlGetCurrentServiceSessionId() && v13 == *(_QWORD *)(**(_QWORD **)(v4 + 19392) + 56LL) )
    *(_DWORD *)(v4 + 19384) |= 4u;
LABEL_19:
