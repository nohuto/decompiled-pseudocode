/*
 * XREFs of ?SPISetIconTitleFont@@YAHPEAU_UNICODE_STRING@@PEAUtagLOGFONTW@@H@Z @ 0x1C01C71A4
 * Callers:
...
__int64 __fastcall SPISetIconTitleFont(struct _UNICODE_STRING *a1, struct tagLOGFONTW *a2, int a3)
{
  ...
  _BYTE v21[96]; // [rsp+40h] [rbp-98h] BYREF
  ...
  if ( FontFromUserProfile )
  {
    ...
    if ( a3 )
    {
      if ( a2 )
      {
        ...
        if ( (unsigned int)GreExtGetObjectW((HBRUSH)v11, 92LL, (__int64)v21) )
