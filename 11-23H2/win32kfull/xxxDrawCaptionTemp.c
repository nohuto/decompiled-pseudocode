/*
 * XREFs of xxxDrawCaptionTemp @ 0x1C022B7E4
 * Callers:
        ...
        __int16 a7)
{
  ...
  struct tagSIZE v54; // [rsp+68h] [rbp-98h] BYREF
...
LABEL_45:
  ...
  if ( (unsigned int)CALL_LPK((__int64)v55) )
    ...
    GreGetTextExtentW((HDC)a2, v39, v27, &v54);
  if ( a1 && (*(_BYTE *)(a1[5] + 25LL) & 0x20) != 0 )
  {
    GreGetTextAlign((HDC)a2);
    GreSetTextAlign((HDC)a2);
  }
  if ( (a7 & 0x4000) != 0 || (_DWORD)v27 && v54.cx > a3->right - a3->left - 2 )
  {
    v60 = 0LL;
    v58 = 20LL;
    v59 = 2;
