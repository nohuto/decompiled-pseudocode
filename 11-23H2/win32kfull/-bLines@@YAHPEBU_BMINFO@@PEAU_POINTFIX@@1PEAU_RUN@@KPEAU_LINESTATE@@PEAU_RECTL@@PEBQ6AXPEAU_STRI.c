/*
 * XREFs of ?bLines@@YAHPEBU_BMINFO@@PEAU_POINTFIX@@1PEAU_RUN@@KPEAU_LINESTATE@@PEAU_RECTL@@PEBQ6AXPEAU_STRIP@@03@ZKPEAKJPEAU_W32KCDD_ENG_CALLBACKS@@@Z @ 0x1C000D864
 * Callers:
        ...
        struct _W32KCDD_ENG_CALLBACKS *a12)
{
  ...
  v12 = a3;
  v88 = a3;
  if ( a1 <= (const struct _BMINFO *)&off_1C0308140 || !(unsigned int)bUMPDSecurityGateEx() )
  {
    v92 = &v12[a5];
    v78 = 0;
    v85 = 0;
