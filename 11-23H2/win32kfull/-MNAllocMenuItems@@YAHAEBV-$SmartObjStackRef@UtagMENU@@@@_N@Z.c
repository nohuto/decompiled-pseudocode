/*
 * XREFs of ?MNAllocMenuItems@@YAHAEBV?$SmartObjStackRef@UtagMENU@@@@_N@Z @ 0x1C00E40DC
 * Callers:
 ...
 * Callees:
 *     ??4?$SharedMixedObjectPointerFieldrgItems@UtagITEM@@@tagMENU@@QEAAPEAUtagITEM@@PEAU2@@Z @ 0x1C00E42BC (--4-$SharedMixedObjectPointerFieldrgItems@UtagITEM@@@tagMENU@@QEAAPEAUtagITEM@@PEAU2@@Z.c)
...
__int64 __fastcall MNAllocMenuItems(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( *(_QWORD *)(**(_QWORD **)a1 + 88LL) )
  {
    ...
    RtlFreeHeap(*(PVOID *)(*(_QWORD *)(**(_QWORD **)a1 + 24LL) + 136LL), 0, *(PVOID *)(**(_QWORD **)a1 + 96LL));
