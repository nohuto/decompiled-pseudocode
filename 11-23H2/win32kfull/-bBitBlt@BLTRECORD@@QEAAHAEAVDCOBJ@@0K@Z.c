/*
 * XREFs of ?bBitBlt@BLTRECORD@@QEAAHAEAVDCOBJ@@0K@Z @ 0x1C00FEE00
 * Callers:
...
__int64 __fastcall BLTRECORD::bBitBlt(BLTRECORD *this, DC **a2, struct DCOBJ *a3, char a4)
{
  ...
  int v147; // [rsp+110h] [rbp+10h]
  __int64 v148; // [rsp+120h] [rbp+20h]
  _BYTE v149[4]; // [rsp+130h] [rbp+30h] BYREF
  __m128i v150; // [rsp+134h] [rbp+34h] BYREF
  __int64 v151; // [rsp+168h] [rbp+68h]
  __int64 v152; // [rsp+180h] [rbp+80h]
  int v153; // [rsp+188h] [rbp+88h]
  int v154; // [rsp+1B0h] [rbp+B0h]
  __int64 v155; // [rsp+1C0h] [rbp+C0h]
    ...
    *((_DWORD *)this + 45) = v19;
    ...
    if ( *(_QWORD *)(*(_QWORD *)a3 + 496LL) != *((_QWORD *)*a2 + 62) )
    {
      ...
      *((_DWORD *)this + 43) = v33;
      ...
      v154 = 1;
      v155 = 0LL;
      XCLIPOBJ::vSetup((XCLIPOBJ *)v149, v43, (struct ERECTL *)&v141, 0);
      v44 = v150;
      v45 = _mm_cvtsi128_si32(v150);
      v141 = v150;
      if ( v45 != _mm_cvtsi128_si32(_mm_srli_si128(v150, 8))
        && v150.m128i_i32[1] != _mm_srli_si128(v150, 8).m128i_i32[1] )
      {
        v46 = v150.m128i_i32[1];
...
LABEL_46:
                ...
                *((_DWORD *)this + 45) = v46 - *((_DWORD *)this + 43);
                if ( (*((_DWORD *)*a2 + 9) & 0xE0) != 0 )
                {
                  ...
                  {
                    v140 = v44;
                    XDCOBJ::vAccumulateTight((XDCOBJ *)a2, v135, &v140);
                  }
                }
...
LABEL_156:
    ...
    *((_DWORD *)this + 43) = v96;
    ...
    ERECTL::operator*=(v141.m128i_i32, (int *)v4);
    v98 = XDCOBJ::prgnEffRao(a2);
    v144 = 0LL;
    v145 = 0LL;
    v146 = 0;
    v147 = 1;
    ...
    if ( (*((_DWORD *)*a2 + 9) & 0xE0) != 0 )
    {
      ...
      {
        v140 = v99;
        XDCOBJ::vAccumulateTight((XDCOBJ *)a2, v105, &v140);
      }
    }
  ...
  else
  {
    ...
    if ( (*((_DWORD *)*a2 + 9) & 0xE0) != 0 )
    {
      ...
      {
        v140 = v143;
        XDCOBJ::vAccumulateTight((XDCOBJ *)a2, v80, &v140);
      }
    }
    ++*(_DWORD *)(*((_QWORD *)this + 8) + 92LL);
    SURFACE::pfnBitBlt(*((SURFACE **)this + 8));
