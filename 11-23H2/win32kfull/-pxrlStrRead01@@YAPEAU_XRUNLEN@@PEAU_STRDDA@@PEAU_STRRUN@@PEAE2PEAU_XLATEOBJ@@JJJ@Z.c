/*
 * XREFs of ?pxrlStrRead01@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C00595F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        if ( (v29 & dword_1C03197A0[v33]) != 0 )
        {
          v34 = (unsigned int)*v32;
          if ( (v30 & dword_1C03197A0[v15]) != 0 )
          {
            if ( (_DWORD)v34 )
            {
              v35 = &v9[v31 + 2];
