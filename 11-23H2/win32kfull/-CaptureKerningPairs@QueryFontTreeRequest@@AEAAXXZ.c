/*
 * XREFs of ?CaptureKerningPairs@QueryFontTreeRequest@@AEAAXXZ @ 0x1C0305B98
 * Callers:
 *     ?CaptureUsermodeParameters@QueryFontTreeRequest@@UEAAXPEAX@Z @ 0x1C00647B0 (-CaptureUsermodeParameters@QueryFontTreeRequest@@UEAAXPEAX@Z.c)
 * Callees:
 ...
 *     ?Win32ProbeForRead@@YAXPEAX_KK@Z @ 0x1C00655AC (-Win32ProbeForRead@@YAXPEAX_KK@Z.c)
