/*
 * XREFs of xxxInheritWindowMonitor @ 0x1C00B04C0
 * Callers:
...
LABEL_114:
  if ( v59 )
  {
    ...
    if ( v73 )
    {
      v74 = _MonitorFromWindowInternal(a1, 1LL, 0LL);
      if ( v74 )
      {
        v75 = *(_DWORD *)(v73 + 992);
        v76 = *(_DWORD *)(v73 + 1004) | 1;
        ...
        *(_OWORD *)(v73 + 976) = v77;
        ...
        {
          *(_DWORD *)(v73 + 1000) = v75;
          *(_DWORD *)(v73 + 1004) = v76 | 2;
        }
        *(_DWORD *)(v73 + 992) = *(unsigned __int16 *)(*((_QWORD *)v74 + 5) + 60LL);
      }
      else
      {
        *(_QWORD *)(v73 + 988) = 0LL;
