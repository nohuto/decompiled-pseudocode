/*
 * XREFs of ?NtGdiDrawStreamInternal@@YAHAEAVXDCOBJ@@AEAVEXFORMOBJ@@PEAVSURFACE@@PEAU_XLATEOBJ@@PEAU_RECTL@@4JPEADPEAU_DRAWSTREAMINFO@@@Z @ 0x1C00BBED0
 * Callers:
...
LABEL_45:
                ...
                else
                {
                  ...
                  {
                    *(__m128i *)v70 = v47;
                    XDCOBJ::vAccumulateTight(v48, v46, (struct ERECTL *)v70);
                  }
                  ++*(_DWORD *)(v39 + 92);
