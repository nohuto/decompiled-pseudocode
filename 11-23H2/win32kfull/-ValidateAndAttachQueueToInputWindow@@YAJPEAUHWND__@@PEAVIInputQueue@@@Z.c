/*
 * XREFs of ?ValidateAndAttachQueueToInputWindow@@YAJPEAUHWND__@@PEAVIInputQueue@@@Z @ 0x1C0041524
 * Callers:
 *     UserValidateAndAttachQueueToInputWindowApiExt @ 0x1C0041200 (UserValidateAndAttachQueueToInputWindowApiExt.c)
 * Callees:
