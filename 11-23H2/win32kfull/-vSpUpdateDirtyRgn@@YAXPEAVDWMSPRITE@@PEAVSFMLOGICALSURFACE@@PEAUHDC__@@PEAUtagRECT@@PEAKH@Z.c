/*
 * XREFs of ?vSpUpdateDirtyRgn@@YAXPEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAUHDC__@@PEAUtagRECT@@PEAKH@Z @ 0x1C00BA500
 * Callers:
        ...
        if ( *(_QWORD *)CurrentProcessWin32Process )
        {
          ...
          if ( (v30 & 4) == 0 )
          {
            *(_DWORD *)(CurrentProcessWin32Process + 288) = v30 | 4;
            ...
            {
              if ( (unsigned __int8)tlgKeywordOn(&dword_1C0354098, 0x400000000000LL) )
              {
