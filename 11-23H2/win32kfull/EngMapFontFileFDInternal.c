/*
 * XREFs of EngMapFontFileFDInternal @ 0x1C00CF330
 * Callers:
 *     ?MapFontFiles@@YA_NKPEAPEAU_FONTFILEVIEW@@PEAPEAXPEAK@Z @ 0x1C00CF2A0 (-MapFontFiles@@YA_NKPEAPEAU_FONTFILEVIEW@@PEAPEAXPEAK@Z.c)
 *     EngMapFontFileFD @ 0x1C028ADC0 (EngMapFontFileFD.c)
 *     ?TryMapAllFileViews@UmfdClientSideFileViewMapper@@AEAAIXZ @ 0x1C02B5E64 (-TryMapAllFileViews@UmfdClientSideFileViewMapper@@AEAAIXZ.c)
 ...
 *     ?hGetHandleFromFilePath@@YAPEAXPEBGH@Z @ 0x1C00CF588 (-hGetHandleFromFilePath@@YAPEAXPEBGH@Z.c)
 *     ?bMapRoutine@@YAHPEAU_FONTFILEVIEW@@PEAU_FILEVIEW@@W4_MAP_MODE@@H@Z @ 0x1C00CF6A4 (-bMapRoutine@@YAHPEAU_FONTFILEVIEW@@PEAU_FILEVIEW@@W4_MAP_MODE@@H@Z.c)
...
LABEL_9:
              ...
              &v34) >= 0 )
  {
    ...
    {
      v20 = bMapRoutine(a1, v30, 1LL, (unsigned int)v26);
      v6 = v20;
    }
    GreReleaseFastMutex(*((_QWORD *)v9 + 18));
    if ( !v20 )
      vUnmapFileFD((struct _FILEVIEW *)v30, 1u);
    goto LABEL_23;
  }
