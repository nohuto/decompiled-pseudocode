/*
 * XREFs of NtUserGetWindowCompositionAttribute @ 0x1C00ECC50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetWindowCompositionAttribute(__int64 a1, ULONG64 a2, __int64 a3)
{
  ...
  *(_OWORD *)v82 = *(_OWORD *)Address;
  ...
  {
    v8 = 0x1C0000000uLL;
    Size = qword_1C0317408[2 * SLODWORD(Address[0])];
    v3 = a1;
...
LABEL_35:
      ...
      {
        v21 = 1;
        Prop = GetProp((__int64)v19, *(unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Busy, 1LL, v16);
      }
      if ( Prop )
      {
        v91[0] = *(__m256i *)Prop;
    ...
    if ( (_DWORD)v13 || LODWORD(v82[0]) == 20 && (unsigned int)IsTopLevelOrLayeredChildWindow((__int64)v17) )
    {
      switch ( LODWORD(v82[0]) )
      {
        case 1:
          ...
          {
            v43 = GetProp(v81, *(unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Busy, 1LL, v16);
            v42 = 1;
          }
          if ( v43 )
          {
...
LABEL_47:
  if ( WindowMinimizeAnimation >= 0 )
  {
    v11 = (void *)ReferenceDwmApiPort(v14, v13);
    v84 = v11;
  }
LABEL_49:
