/*
 * XREFs of ?xxxPointerActivateInternal@@YAXPEAUtagWND@@F_KPEBUtagPOINTEREVENTINT@@H@Z @ 0x1C01C5BAC
 * Callers:
 *     EditionPointerActivate @ 0x1C0152DC0 (EditionPointerActivate.c)
 * Callees:
 ...
 *     PhysicalToLogicalInPlacePointWithParent @ 0x1C01515A0 (PhysicalToLogicalInPlacePointWithParent.c)
      ...
      if ( TopLevelWindow )
      {
        if ( a1 != *(struct tagWND **)(v9 + 128) )
        {
          ...
          if ( !v8 )
          {
            ...
            if ( v26 == 1 || v26 != 3 && xxxQueryLegacyActivation((ULONG_PTR)a1, (struct tagWND *)v11, a2, a4) == 1 )
              xxxActivateWindowWithOptions((const struct tagWND *)v11, 3, 49LL, 1);
          }
