/*
 * XREFs of ?DT_GetExtentMinusPrefixes@@YAHPEAUHDC__@@PEBGHIHPEAUDRAWTEXTDATA@@H@Z @ 0x1C024C448
 * Callers:
        ...
        int a7)
{
  ...
  __int64 v16; // r8
  struct tagSIZE v18[2]; // [rsp+50h] [rbp-18h] BYREF
  ...
  if ( (unsigned int)CALL_LPK((__int64)v15) )
    ...
    GreGetTextExtentW((HDC)a1, SourceString, a3, v18);
  return (unsigned int)v18[0].cx;
}
