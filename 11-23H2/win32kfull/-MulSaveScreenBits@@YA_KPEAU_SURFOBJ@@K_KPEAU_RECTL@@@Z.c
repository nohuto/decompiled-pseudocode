/*
 * XREFs of ?MulSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1C02AFD00
 * Callers:
...
unsigned __int64 __fastcall MulSaveScreenBits(struct _SURFOBJ *a1, unsigned int a2, _QWORD *a3, struct _RECTL *a4)
{
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      if ( v22 )
      {
        ...
        {
          a4 = (struct _RECTL *)&stru_1C0329000;
          v5 = 0LL;
          v18 = (struct _RECTL *)&stru_1C0329000;
          v8 = 2;
        }
      }
      v7 = (__int64 *)*v7;
  ...
  MulSaveScreenBits(a1, 2u, v5, (struct _RECTL *)&stru_1C0329000);
  return 0LL;
}
