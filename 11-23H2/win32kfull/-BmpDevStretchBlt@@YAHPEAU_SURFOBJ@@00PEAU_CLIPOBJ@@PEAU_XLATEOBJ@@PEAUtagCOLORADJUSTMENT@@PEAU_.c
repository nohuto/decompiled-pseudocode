/*
 * XREFs of ?BmpDevStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02A1B70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0BMPDEVOPEN@@QEAA@PEAU_SURFOBJ@@@Z @ 0x1C02A09A4 (--0BMPDEVOPEN@@QEAA@PEAU_SURFOBJ@@@Z.c)
 *     ?GetDevBitmap@@YAPEAU_SURFOBJ@@PEAU_DISPSURF@@PEAU1@@Z @ 0x1C02A25FC (-GetDevBitmap@@YAPEAU_SURFOBJ@@PEAU_DISPSURF@@PEAU1@@Z.c)
 *     ?bBmpMakeOpaque@@YAHPEAVSURFACE@@@Z @ 0x1C02A2680 (-bBmpMakeOpaque@@YAHPEAVSURFACE@@@Z.c)
 */
        ...
        if ( v19 )
        {
          do
          {
            ...
            if ( v20 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v20 + 1760) + 224LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, __int64, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _RECTL *, struct _RECTL *, struct _POINTL *, unsigned int))(*(_QWORD *)(v20 + 1760) + 224LL))(
                    v22,
                    v23,
                    DevBitmap,
                    a4,
