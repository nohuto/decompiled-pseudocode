/*
 * XREFs of GreSetClientRgn @ 0x1C0287AC0
 * Callers:
 ...
 *     ?bValid@EWNDOBJ@@QEBAHXZ @ 0x1C0286AA4 (-bValid@EWNDOBJ@@QEBAHXZ.c)
...
void __fastcall GreSetClientRgn(struct EWNDOBJ *a1, HRGN a2, unsigned int *a3)
{
  ...
  __int64 v22; // rax
  struct _POINTL v23; // [rsp+20h] [rbp-49h] BYREF
  __int64 v24; // [rsp+28h] [rbp-41h] BYREF
  __int128 v25; // [rsp+30h] [rbp-39h] BYREF
  _QWORD v26[8]; // [rsp+40h] [rbp-29h] BYREF
