/*
 * XREFs of DwmAsyncRegisterSharedThumbnailVisual @ 0x1C0012104
 * Callers:
 *     DwmAsyncRegisterSharedThumbnailVisualApiExt @ 0x1C00120C0 (DwmAsyncRegisterSharedThumbnailVisualApiExt.c)
 * Callees:
