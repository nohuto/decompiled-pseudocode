/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_i @ 0x1C0008124
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_i(__int64 a1, char a2, char a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_b0547e54f0a835780768a0ab694adaf1_Traceguids,
               12LL,
               va,
               8LL,
               0LL);
  ...
  {
    LOWORD(v11) = 12;
    return WppAutoLogTrace(v8, 4LL, 20LL, &WPP_b0547e54f0a835780768a0ab694adaf1_Traceguids, v11, va, 8LL, 0LL);
  }
  return result;
}
