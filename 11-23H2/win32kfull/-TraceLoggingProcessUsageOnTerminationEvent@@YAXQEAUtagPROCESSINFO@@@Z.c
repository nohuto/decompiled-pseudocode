/*
 * XREFs of ?TraceLoggingProcessUsageOnTerminationEvent@@YAXQEAUtagPROCESSINFO@@@Z @ 0x1C001395C
 * Callers:
 *     DestroyProcessInfoEditionRundown @ 0x1C0089180 (DestroyProcessInfoEditionRundown.c)
 * Callees:
