/*
 * XREFs of ?GreSetDIBitsToDeviceInternalImpl@@YAHPEAUHDC__@@HHKKHHKKAEAV?$umptr_r@E@@PEAUtagBITMAPINFO@@KIHPEAX@Z @ 0x1C00BEBE0
 * Callers:
        ...
        __int64 a15)
{
  ...
  __int128 v266; // [rsp+3C0h] [rbp+2C0h] BYREF
  __int128 v267; // [rsp+3D0h] [rbp+2D0h] BYREF
  ...
  __int128 v273; // [rsp+424h] [rbp+324h]
  ...
  __int128 v280[3]; // [rsp+4C4h] [rbp+3C4h] BYREF
                    ...
                    && (unsigned __int64)(v99 + v269.bottom + 0x80000000LL) <= 0xFFFFFFFF )
                  {
                    ...
                    if ( v209 )
                    {
                      ...
                      if ( !ERECTL::bEmpty((ERECTL *)v280) )
                      {
                        ...
                        {
                          v266 = v280[0];
                          XDCOBJ::vAccumulateTight((XDCOBJ *)&v202, v110, (struct ERECTL *)&v266);
                        }
                        v111 = v214;
                        ++*(_DWORD *)(v76 + 92);
                      ...
                      if ( v108 >= v120 )
                      {
                        ...
                        if ( v120 != v108 && v106 != v107 )
                        {
                          ...
                          if ( v121 + left != v122 + right && v123 + top != v124 + bottom )
                          {
                            ...
                            if ( (_DWORD)v273 != DWORD2(v273) && DWORD1(v273) != HIDWORD(v273) )
                            {
                              if ( (*((_DWORD *)v202 + 9) & 0xE0) != 0 )
                              {
                                v267 = v273;
                                XDCOBJ::vAccumulateTight((XDCOBJ *)&v202, v128, (struct ERECTL *)&v267);
                              }
                              if ( (unsigned int)(v197 - 4) <= 1 )
                              {
                                v129 = v194 - v193 - v184;
