/*
 * XREFs of UmfdSessionInitialize @ 0x1C007C240
 * Callers:
 *     <none>
 * Callees:
 *     ?Create@?$CSortedVector@_K_K@NSInstrumentation@@SAPEAV12@XZ @ 0x1C007C334 (-Create@-$CSortedVector@_K_K@NSInstrumentation@@SAPEAV12@XZ.c)
 *     ?UmfdCallSessionInitialize@@YAJXZ @ 0x1C007C40C (-UmfdCallSessionInitialize@@YAJXZ.c)
 *     bEnableFontDriver @ 0x1C007C5F0 (bEnableFontDriver.c)
 *     ?Initialize@UmfdAllocation@@SA_NXZ @ 0x1C007CA98 (-Initialize@UmfdAllocation@@SA_NXZ.c)
 *     ?SessionInitialize@UmfdHostLifeTimeManager@@CA_NXZ @ 0x1C007CCE0 (-SessionInitialize@UmfdHostLifeTimeManager@@CA_NXZ.c)
