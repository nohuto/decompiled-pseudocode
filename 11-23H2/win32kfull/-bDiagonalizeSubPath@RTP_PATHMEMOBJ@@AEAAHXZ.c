/*
 * XREFs of ?bDiagonalizeSubPath@RTP_PATHMEMOBJ@@AEAAHXZ @ 0x1C02DF340
 * Callers:
 ...
 *     ?bFetchNextPoint@RTP_PATHMEMOBJ@@AEAAHXZ @ 0x1C02DF590 (-bFetchNextPoint@RTP_PATHMEMOBJ@@AEAAHXZ.c)
