/*
 * XREFs of xxxSetInformationThread @ 0x1C002A9A0
 * Callers:
            ...
            *(_OWORD *)v39 = 0LL;
            if ( a2 == 15 )
            {
              if ( v32 )
                ...
                *(_DWORD *)(gpsi + 2236LL) &= ~8u;
              RtlLoadStringOrError(629LL, v43, 40LL);
            ...
            else
            {
              if ( v32 )
                ...
                *(_DWORD *)(gpsi + 2236LL) &= ~0x10u;
              RtlLoadStringOrError(630LL, v43, 40LL);
              (*(void (__fastcall **)(PVOID))(*(_QWORD *)P + 8LL))(P);
              EtwTraceDockState(*(unsigned int *)a3);
            }
            RtlInitLargeUnicodeString(v39, v43);
            v33 = *(unsigned int *)a3;
            *(_QWORD *)&v41[2] = &Interval;
            v41[0] = 0;
            v41[1] = 100;
            ((void (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD, _DWORD, _DWORD, _QWORD))xxxBroadcastMessageEx)(
              0LL,
              26LL,
              v33,
              v39,
