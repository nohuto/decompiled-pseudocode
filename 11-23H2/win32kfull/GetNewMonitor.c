/*
 * XREFs of GetNewMonitor @ 0x1C010C10C
 * Callers:
 ...
 *     ?TransformRectAroundCursor@@YAXPEAUMOVESIZEDATA@@PEBUtagRECT@@GPEAU2@2G@Z @ 0x1C01B8BD4 (-TransformRectAroundCursor@@YAXPEAUMOVESIZEDATA@@PEBUtagRECT@@GPEAU2@2G@Z.c)
 *     TransformRectAroundPoint @ 0x1C01B9920 (TransformRectAroundPoint.c)
...
LABEL_18:
  ...
  if ( !InheritedMonitor )
  {
    ...
    if ( !InheritedMonitor )
    {
      v24 = _MonitorFromWindowInternal(a1, 0LL, 1LL);
      ...
      {
        v25 = MonitorFromRect((__int64)&v38, 2LL, 0LL);
        v18 = (__m128i)v38;
      }
      else
      {
        v25 = (__int64)_MonitorFromWindowInternal(a1, 2LL, 1LL);
      }
