/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_sDD @ 0x1C0082778
 * Callers:
        ...
        ...)
{
  ...
  if ( a2 )
  {
    ...
    ((void (__fastcall *)(__int64, __int64, void *, __int64, const char *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      a1,
      43LL,
      &WPP_61c26a9f6da9378abf1f04fdf8202002_Traceguids,
      38LL,
      v17,
      v16,
      (__int64 *)va,
  ...
  if ( a3 )
  {
    ...
    if ( !a9 )
      v9 = "NULL";
    LOWORD(v18) = 38;
    WppAutoLogTrace(a4, 4LL, 2LL, &WPP_61c26a9f6da9378abf1f04fdf8202002_Traceguids, v18, v9, v14, (__int64 *)va);
  }
}
