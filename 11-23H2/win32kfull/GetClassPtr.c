/*
 * XREFs of GetClassPtr @ 0x1C00A68F0
 * Callers:
...
__int64 __fastcall GetClassPtr(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v4 = a2 + 352;
  v6 = a1;
  result = InnerGetClassPtr(a1, a2 + 352, a3, a4);
  if ( !result )
  {
    result = InnerGetClassPtr(v6, a2 + 360, 0LL, v8);
    if ( !result )
    {
      v10 = hModClient;
      result = InnerGetClassPtr(v6, v4, hModClient, v9);
      if ( !result )
        return InnerGetClassPtr(v6, a2 + 360, v10, v11);
    }
  }
  return result;
}
