/*
 * XREFs of ?_TTUpdateBestTarget@@YAXPEAUtagPNTRWINDOWHITTTESTARGS@@PEAUtagWND@@IPEBUtagPOINT@@PEAUtagRECT@@HU4@K@Z @ 0x1C01E40A0
 * Callers:
        ...
        __int16 a8)
{
  ...
  *(struct tagRECT *)((char *)a1 + 68) = *v9;
  ...
  if ( a8 != 3 )
    v14 = v15;
  *((_DWORD *)a1 + 44) = v14;
  if ( !(unsigned int)IsCompositionInputWindow(a2, (__int64)a2, a3, (__int64)a4)
