/*
 * XREFs of ?DdcciGetTimingReport@CMonitorAPI@@QEAAJPEAXPEAU_MC_TIMING_REPORT@@@Z @ 0x1C0268E2C
 * Callers:
 *     NtGdiDDCCIGetTimingReport @ 0x1C0269A90 (NtGdiDDCCIGetTimingReport.c)
 * Callees:
