/*
 * XREFs of ?UnlinkAndFreeThreadPointerData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@PEAUtagTHREADPOINTERDATA@@@Z @ 0x1C0152AD2
 * Callers:
 *     xxxCleanupThreadPointerInputInfo @ 0x1C0078680 (xxxCleanupThreadPointerInputInfo.c)
 *     EditionUnlinkAndFreeThreadPointerData @ 0x1C01C61F0 (EditionUnlinkAndFreeThreadPointerData.c)
 * Callees:
 *     <none>
 */
