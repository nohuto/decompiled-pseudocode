/*
 * XREFs of FindBestPos @ 0x1C0231A14
 * Callers:
        ...
        unsigned __int64 a9)
{
  ...
  char v41[16]; // [rsp+90h] [rbp-59h] BYREF
  __int128 v42; // [rsp+A0h] [rbp-49h] BYREF
  ...
  if ( *v12 )
  {
    ...
    v14 = *(_OWORD *)GetMonitorWorkRectForWindow((__int64)&v42, (__int64)a8, v17);
    *(_OWORD *)v35 = v14;
    MonitorRectForWindow = (__int128 *)GetMonitorRectForWindow((__int64)v41, (__int64)a8, v17);
    v10 = v36[0];
  }
  else
  {
    ...
    *(_OWORD *)v35 = v14;
    MonitorRectForWindow = (__int128 *)GetMonitorRect((__int64 *)&v40.left, (__int64)a8);
  }
...
LABEL_12:
  ...
  else
  {
    ...
    v19 = CurrentProcessWin32Process
       ...
       && (*(_DWORD *)(CurrentProcessWin32Process + 824) & 0x30) == 0;
  }
