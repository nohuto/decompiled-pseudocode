/*
 * XREFs of _GetClassInfoEx @ 0x1C00A9E08
 * Callers:
...
LABEL_7:
  ...
  v52 = *(_QWORD *)(v42 + 424);
  v44 = (_QWORD *)(v52 + 352);
  ClassPtr = (__int64 *)InnerGetClassPtr((unsigned __int16)a2, v52 + 352, a1, v22);
  if ( ClassPtr
    || (ClassPtr = (__int64 *)InnerGetClassPtr((unsigned __int16)a2, v52 + 360, 0LL, v25)) != 0LL
    || (ClassPtr = (__int64 *)InnerGetClassPtr((unsigned __int16)a2, v44, v23, v26)) != 0LL
    || (ClassPtr = (__int64 *)InnerGetClassPtr((unsigned __int16)a2, v52 + 360, v23, v27)) != 0LL )
  {
    v29 = *ClassPtr;
