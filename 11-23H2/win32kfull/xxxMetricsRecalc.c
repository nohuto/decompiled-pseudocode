/*
 * XREFs of xxxMetricsRecalc @ 0x1C01C804C
 * Callers:
...
void __fastcall xxxMetricsRecalc(char a1, int a2, int a3, int a4, int a5, int a6, int a7)
{
  ...
  do
  {
    ...
    if ( !v14
      ...
      || (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)v15 + 2) + 424LL) + 824LL) & 0x30) == 0x10 )
    {
      goto LABEL_56;
    }
...
LABEL_29:
    ...
    {
      Prop = (_DWORD *)GetProp((__int64)v15, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1LL, v16);
      v28 = a6;
