/*
 * XREFs of ?bInsertGlyphbitsPath@RFONTOBJ@@QEAAHPEAU_GLYPHDATA@@K@Z @ 0x1C02FCF78
 * Callers:
 *     xInsertGlyphbitsRFONTOBJ @ 0x1C00C8CF4 (xInsertGlyphbitsRFONTOBJ.c)
 * Callees:
 *     ?pgbCheckGlyphCache@RFONTOBJ@@QEAAPEAX_K@Z @ 0x1C00C89AC (-pgbCheckGlyphCache@RFONTOBJ@@QEAAPEAX_K@Z.c)
 ...
 *     ?vInit@EPATHFONTOBJ@@QEAAXK@Z @ 0x1C0285E0C (-vInit@EPATHFONTOBJ@@QEAAXK@Z.c)
 *     ?vFlushCache@RFONTOBJ@@QEAAXXZ @ 0x1C02FD4C8 (-vFlushCache@RFONTOBJ@@QEAAXXZ.c)
 */
