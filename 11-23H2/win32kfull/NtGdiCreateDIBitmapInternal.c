/*
 * XREFs of NtGdiCreateDIBitmapInternal @ 0x1C0046DC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GreGetBitmapSizeInternal@@YAKPEBUtagBITMAPINFO@@KI@Z @ 0x1C0073B84 (-GreGetBitmapSizeInternal@@YAKPEBUtagBITMAPINFO@@KI@Z.c)
...
LABEL_15:
  ...
  if ( v14 && a5 )
  {
    inited = umptr_r<unsigned char>::init_probe(v25, a5, a9, 4LL);
    v21 = *(_QWORD *)inited;
    v22 = *(_QWORD *)(inited + 8);
