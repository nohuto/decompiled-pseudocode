/*
 * XREFs of ULongLongMult @ 0x1C0159DCA
 * Callers:
 ...
 *     ?init_probe@?$umptr_r@D@@SA?AV1@PEAD_K1@Z @ 0x1C02C14A8 (-init_probe@-$umptr_r@D@@SA-AV1@PEAD_K1@Z.c)
 *     ?init_probe@?$umptr_r@UtagPOINT@@@@SA?AV1@PEAUtagPOINT@@_K1@Z @ 0x1C02C1530 (-init_probe@-$umptr_r@UtagPOINT@@@@SA-AV1@PEAUtagPOINT@@_K1@Z.c)
 * Callees:
 *     <none>
 */
