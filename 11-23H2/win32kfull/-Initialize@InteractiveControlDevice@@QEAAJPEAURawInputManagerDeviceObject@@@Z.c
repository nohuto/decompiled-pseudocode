/*
 * XREFs of ?Initialize@InteractiveControlDevice@@QEAAJPEAURawInputManagerDeviceObject@@@Z @ 0x1C0244EF4
 * Callers:
 ...
 *     ??_GSimpleHapticsController@@QEAAPEAXI@Z @ 0x1C02445E0 (--_GSimpleHapticsController@@QEAAPEAXI@Z.c)
 ...
 *     ?InitializeWaveformOrdinalForDevice@InteractiveControlDevice@@QEAAJXZ @ 0x1C02452D0 (-InitializeWaveformOrdinalForDevice@InteractiveControlDevice@@QEAAJXZ.c)
 *     ?DeInitialize@SimpleHapticsController@@QEAAJXZ @ 0x1C0247AF0 (-DeInitialize@SimpleHapticsController@@QEAAJXZ.c)
 ...
 *     ?SetDevicePropertyData@SimpleHapticsController@@QEAAJPEBU_DEVPROPKEY@@KKKKPEAX@Z @ 0x1C0249508 (-SetDevicePropertyData@SimpleHapticsController@@QEAAJPEBU_DEVPROPKEY@@KKKKPEAX@Z.c)
...
__int64 __fastcall InteractiveControlDevice::Initialize(InteractiveControlDevice *this, char *Object)
{
  ...
  SimpleHapticsController *v32; // rcx
  int v33; // eax
  __int64 v34; // r8
  __int64 v35; // r9
  int v36; // eax
  ...
  __int64 v41[2]; // [rsp+40h] [rbp-10h] BYREF
  __int64 v42; // [rsp+88h] [rbp+38h] BYREF
        ...
        if ( v6 >= 0 )
        {
          ...
          *((_QWORD *)this + 48) = v12;
          ...
          if ( v14 < 0 )
          {
            ...
            {
              LODWORD(v42) = v14;
              v41[0] = (__int64)"SimpleHapticsController->Initialize failed with.";
...
LABEL_21:
          ...
          {
            LODWORD(v42) = 235930369;
            UserSessionSwitchLeaveCrit(v25, v24, v26, v27);
            v28 = (SimpleHapticsController *)*((_QWORD *)this + 48);
            if ( v28 )
              SimpleHapticsController::SendDeviceIOControl(v28, 0xB0191u, &v42, 4u, 0LL, 0, 0LL);
            EnterCrit(1LL, 0LL);
          }
          RIMLockExclusive(v13);
          if ( (*(_DWORD *)(*(_QWORD *)this + 256LL) & 0x2000) == 0 && *((_DWORD *)this + 18) == 1 )
          {
            v32 = (SimpleHapticsController *)*((_QWORD *)this + 48);
            if ( v32 )
            {
              v33 = SimpleHapticsController::SetDevicePropertyData(
                      v32,
                      v29,
                      v30,
                      v31,
                      ...
                      AccessMode,
                      (char *)this + 72);
              if ( v33 < 0 && (unsigned int)dword_1C0354150 > 2 )
              {
                LODWORD(v42) = v33;
                v41[0] = (__int64)"Function failed.";
                _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<4>>(
                  (__int64)&dword_1C0354150,
                  byte_1C031D8C8,
                  v34,
          ...
          v36 = InteractiveControlDevice::InitializeWaveformOrdinalForDevice(this);
          v6 = v36;
          if ( v36 < 0 && (unsigned int)dword_1C0354150 > 2 )
          {
            LODWORD(v42) = v36;
            v41[0] = (__int64)"Function failed.";
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<4>>(
