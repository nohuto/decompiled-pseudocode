/*
 * XREFs of xxxSetInternalWindowPos @ 0x1C01F26BC
 * Callers:
  ...
  if ( result )
  {
    if ( a3 )
    {
      *(_OWORD *)result = *(_OWORD *)a3;
      ...
      {
        v10 = MonitorFromRect((__int64)a3, 1LL, 0LL);
        v11 = *(__m128i *)GetMonitorWorkRect(&v23, v10);
        v12 = *GetMonitorRect((__int64 *)&v23, v10);
    ...
    else
    {
      *(_QWORD *)(v9 + 32) = *a4;
      if ( *((_QWORD *)a1 + 13) == GetDesktopWindow((__int64)a1) )
      {
        v15 = MonitorFromRect(v9, 1LL, 0LL);
        v16 = *(__m128i *)GetMonitorWorkRect(&v23, v15);
        MonitorRect = GetMonitorRect((__int64 *)&v23, v15);
