/*
 * XREFs of ?DoFontManagement@@YAKAEAVDCOBJ@@KKPEAXK1AEBUTag@RFONTOBJ@@@Z @ 0x1C02746E4
 * Callers:
 ...
 *     wil::scope_exit__lambda_7684baa8fa620ec8aa6115923601a5ea___ @ 0x1C013E5DC (wil--scope_exit__lambda_7684baa8fa620ec8aa6115923601a5ea___.c)
 *     ??0SURFFAKEOBJ@@QEAA@PEAUHDEV__@@PEAUDHPDEV__@@@Z @ 0x1C013E5F4 (--0SURFFAKEOBJ@@QEAA@PEAUHDEV__@@PEAUDHPDEV__@@@Z.c)
 *     wil::details::lambda_call__lambda_3c37ad0d9e9c71fe69a6ff6ac7bd17c8___::_lambda_call__lambda_3c37ad0d9e9c71fe69a6ff6ac7bd17c8___ @ 0x1C013E6AC (wil--details--lambda_call__lambda_3c37ad0d9e9c71fe69a6ff6ac7bd17c8___--_lambda_call__lambda_3c37.c)
        ...
        const struct RFONTOBJ::Tag *a7)
{
  ...
  _QWORD v25[2]; // [rsp+40h] [rbp-E8h] BYREF
  _BYTE v26[16]; // [rsp+50h] [rbp-D8h] BYREF
  ...
  _QWORD *v31; // [rsp+130h] [rbp+8h] BYREF
  unsigned int v32; // [rsp+138h] [rbp+10h]
  ...
  v25[0] = 0LL;
  v31 = v25;
  wil::scope_exit__lambda_7684baa8fa620ec8aa6115923601a5ea___((__int64)v26, &v31);
  ...
  if ( v13 )
  {
    ...
    v31 = 0LL;
    if ( (unsigned int)RFONTOBJ::bInit((RFONTOBJ *)&v31, a1, 0, 2u, a7) )
