/*
 * XREFs of ?SendMITCursorShape@CursorApiRouter@@CA_NPEAU_CURSINFO@@K@Z @ 0x1C0222BE0
 * Callers:
 ...
 *     ?PopulateMSLogoTestPattern@@YAXPEAXHH@Z @ 0x1C0222AE4 (-PopulateMSLogoTestPattern@@YAXPEAXHH@Z.c)
 *     ?PopulateXORTestPattern@@YAXPEAXHH@Z @ 0x1C0222B64 (-PopulateXORTestPattern@@YAXPEAXHH@Z.c)
 */
...
char __fastcall CursorApiRouter::SendMITCursorShape(struct _CURSINFO *a1, unsigned int a2)
{
  ...
  if ( v4 )
  {
    if ( !(unsigned int)GreExtGetObjectW(v4, 32LL, (__int64)&v46) )
      return 0;
...
LABEL_31:
  ...
  if ( !(unsigned int)GreExtGetObjectW(*((HBRUSH *)a1 + 1), 32LL, (__int64)&v46) )
    return 0;
