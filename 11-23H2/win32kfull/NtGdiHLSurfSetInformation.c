/*
 * XREFs of NtGdiHLSurfSetInformation @ 0x1C00C42D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     GreSfmGenerateMoveData @ 0x1C02ADAD8 (GreSfmGenerateMoveData.c)
 */

__int64 __fastcall NtGdiHLSurfSetInformation(Gre::Base *a1, int a2, _QWORD *a3, unsigned int a4)
{
  NTSTATUS v5; // ebx
  int v6; // edx
  int v7; // edx
...
LABEL_46:
  ...
  if ( !v15 )
  {
    ...
    updated = GreSfmCloseCompositorRef(v16, (HLSURF)a1);
    goto LABEL_46;
  }
  if ( v15 == 2 )
