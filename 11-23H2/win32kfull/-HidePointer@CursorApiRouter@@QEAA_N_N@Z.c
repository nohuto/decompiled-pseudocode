/*
 * XREFs of ?HidePointer@CursorApiRouter@@QEAA_N_N@Z @ 0x1C00C2A00
 * Callers:
 ...
 *     GreUpdatePointerState @ 0x1C00C2E70 (GreUpdatePointerState.c)
...
char __fastcall CursorApiRouter::HidePointer(CursorApiRouter *this, unsigned __int8 a2)
{
  ...
  ExAcquirePushLockExclusiveEx(&qword_1C035F100, 0LL);
  v5 = dword_1C035F0F8;
  if ( dword_1C035F0F8 != 1 )
  {
    if ( dword_1C035F0F8 != 2 )
      goto LABEL_4;
    goto LABEL_3;
  }
...
LABEL_4:
  ExReleasePushLockExclusiveEx(&qword_1C035F100, 0LL);
