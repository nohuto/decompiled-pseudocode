/*
 * XREFs of ?_TTIntersectLine@@YAHUtagPOINT@@0PEBUtagTOUCHTARGETINGCONTACT@@PEAU1@2@Z @ 0x1C024CF2C
 * Callers:
 *     TouchTargetingIntersectSegment @ 0x1C024D99C (TouchTargetingIntersectSegment.c)
