/*
 * XREFs of ?bCreateHTPalette@PALMEMOBJ@@QEAAHJPEAU_GDIINFO@@@Z @ 0x1C001F770
 * Callers:
...
_BOOL8 __fastcall PALMEMOBJ::bCreateHTPalette(PALMEMOBJ *this, int a2, struct _GDIINFO *a3)
{
  ...
  if ( a2 )
  {
    ...
    {
      v17 = 16;
      v19 = (struct tagPALETTEENTRY *)&unk_1C03293F0;
      goto LABEL_40;
    }
    if ( v14 == 1 )
    {
...
LABEL_24:
      ...
      v28[0] = xmmword_1C0329430;
      v28[1] = xmmword_1C0329440;
      if ( (v20 & 1) != 0 )
      {
        for ( i = 1LL; i < 7; ++i )
        {
  ...
  {
    v19 = (struct tagPALETTEENTRY *)&unk_1C0329490;
    v17 = 2;
    if ( (a3->flHTFlags & 0x100) != 0 )
    {
      v19 = (struct tagPALETTEENTRY *)v28;
