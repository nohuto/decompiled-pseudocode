/*
 * XREFs of NtUserGetWindowTrackInfoAsync @ 0x1C00A4230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetWindowTrackInfoAsync(__int64 a1)
{
  ...
  __int64 v5; // r8
  __int64 v6; // r9
  __int64 WindowTrackInfoAsync; // rbx
  ...
  if ( v2 )
  {
    ...
    *((_QWORD *)&v13 + 1) = v2;
    HMLockObject(v2);
    WindowTrackInfoAsync = _GetWindowTrackInfoAsync(v8);
    ThreadUnlock1(v10, v9, v11);
  }
  UserSessionSwitchLeaveCrit(v4, v3, v5, v6);
  return WindowTrackInfoAsync;
}
