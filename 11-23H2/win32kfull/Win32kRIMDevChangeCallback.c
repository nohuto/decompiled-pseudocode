/*
 * XREFs of Win32kRIMDevChangeCallback @ 0x1C01A6230
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsPublicPointerDevice @ 0x1C01C29B4 (IsPublicPointerDevice.c)
 *     UpdatePointerDeviceCount @ 0x1C01C2BFC (UpdatePointerDeviceCount.c)
...
LABEL_34:
    ...
    case 2:
      ...
      PostDeviceNotification(0LL, (struct DEVICEINFO *)(v1 + 72), v13, 1LL, updated);
    ...
    case 3:
      if ( (*(_DWORD *)(v1 + 256) & 0x2000) != 0 )
      {
        ...
        PostDeviceNotification(0LL, (struct DEVICEINFO *)(v1 + 72), v11, 2LL, v5 + 1);
      }
      else
      {
        if ( (unsigned int)IsPublicPointerDevice(v1 + 72) )
        ...
        PostDeviceNotification(0LL, (struct DEVICEINFO *)(v1 + 72), v12, 2LL, updated);
      }
      if ( (*(_DWORD *)(v1 + 272) & 0x200) != 0 )
