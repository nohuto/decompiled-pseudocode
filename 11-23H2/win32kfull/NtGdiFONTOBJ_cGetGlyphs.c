/*
 * XREFs of NtGdiFONTOBJ_cGetGlyphs @ 0x1C02CBD20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CacheGlyphPath@UMPDOBJ@@QEAAPEAU_PATHOBJ@@PEAU2@@Z @ 0x1C0298348 (-CacheGlyphPath@UMPDOBJ@@QEAAPEAU_PATHOBJ@@PEAU2@@Z.c)
...
__int64 __fastcall NtGdiFONTOBJ_cGetGlyphs(__int64 a1, ULONG a2, __int64 a3, ULONG64 a4, ULONG64 a5)
{
  ...
  if ( ThreadCurrentObj )
    ++*v11;
  ppvGlyph[1] = (char *)ThreadCurrentObj + 436;
  if ( !ThreadCurrentObj )
    return 0LL;
