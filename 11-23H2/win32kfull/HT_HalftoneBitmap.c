/*
 * XREFs of HT_HalftoneBitmap @ 0x1C024FCBC
 * Callers:
 *     EngHTBlt @ 0x1C02DE1C0 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C0157328 (SanityCheckDimension.c)
 *     CheckABInfo @ 0x1C024EE5C (CheckABInfo.c)
...
__int64 __fastcall HT_HalftoneBitmap(int a1, int a2, __int64 a3, __int64 a4, __int64 a5, __int16 *a6)
{
  ...
  if ( (_DWORD)v6 != 1 && (unsigned int)(v6 - 2) > 1
    || (v14 = *(_QWORD *)(a3 + 32), v13 = 1 << byte_1C0323494[v6], v14) && (v33 = *(_DWORD *)(v14 + 8)) != 0 )
  {
