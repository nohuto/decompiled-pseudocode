/*
 * XREFs of NtUserSetWindowsHookEx @ 0x1C003DC20
 * Callers:
 *     <none>
 * Callees:
 *     ??0EnterLeaveCritByVelocityWithDispositionOverride@@QEAA@W4CritOptType@@_NW4HandleToObjILCheck@@@Z @ 0x1C003DE8C (--0EnterLeaveCritByVelocityWithDispositionOverride@@QEAA@W4CritOptType@@_NW4HandleToObjILCheck@@.c)
...
__int64 __fastcall NtUserSetWindowsHookEx(__int64 a1, ULONG64 a2, unsigned int a3, unsigned int a4, __int64 a5, int a6)
{
  ...
  if ( a4 + 1 <= 0xF )
  {
    v10 = 0LL;
    v11 = &unk_1C0316E78;
    LOBYTE(a2) = !v7 && (*((_BYTE *)&unk_1C0316E78 + (int)a4 + 1) & 0x10) != 0;
    if ( (*((_BYTE *)&unk_1C0316E78 + (int)a4 + 1) & 4) != 0 || (LOBYTE(v11) = 0, (_BYTE)a2) )
      LOBYTE(v11) = 1;
