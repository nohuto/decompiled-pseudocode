/*
 * XREFs of ReadPointerDeviceSettingsFull @ 0x1C00DD4E0
 * Callers:
 ...
 *     RtlUnicodeStringValidateWorker @ 0x1C00DDCC4 (RtlUnicodeStringValidateWorker.c)
 *     ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C00DDD04 (-GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z.c)
 *     __security_check_cookie @ 0x1C01381F0 (__security_check_cookie.c)
 *     ?GetCustomFlick@@YAHPEAUtagCUSTOM_FLICK@@@Z @ 0x1C01F2A70 (-GetCustomFlick@@YAHPEAUtagCUSTOM_FLICK@@@Z.c)
 */
...
LABEL_24:
  ...
  if ( v5 )
  {
    ...
    if ( v32 )
    {
      if ( v32 == 2 )
      {
        if ( !gPredictionMonitor && (int)CreatePredictionSettings(off_1C0354018, (const unsigned __int16 *)a2, a3) >= 0 )
        {
...
LABEL_46:
          v33 = off_1C0354018;
          GetPredictionSettings(off_1C0354018, (const unsigned __int16 *)a2, a3);
          v34 = *((_DWORD *)v33 + 3);
          v35 = 60;
          if ( v34 == -1 )
          {
  ...
  else
  {
    v39 = off_1C03541F8;
    if ( !gModeMonitor )
      GetDWORDSettingValues(7LL, off_1C03541F8);
    v40 = *((_DWORD *)v39 + 3);
    if ( v40 == -1 )
      v40 = *((_DWORD *)v39 + 2);
    *v4 = v40;
