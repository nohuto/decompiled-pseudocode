/*
 * XREFs of NtGdiGetFontData @ 0x1C00C7D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetFontData(__int64 a1, unsigned int a2, unsigned int a3, void *a4, unsigned int a5)
{
  const void *v9; // rdi
...
LABEL_3:
  ...
  if ( a5 <= 0x2710000 )
    v9 = (const void *)AllocFreeTmpBuffer(a5);
  if ( v9 )
  {
