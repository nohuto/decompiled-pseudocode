/*
 * XREFs of MonitorAPIProcessTerminating @ 0x1C007E5B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextElementIndex@?$CList@VCPhysicalMonitorHandle@@@OPM@@QEAAEKPEAK@Z @ 0x1C0269768 (-GetNextElementIndex@-$CList@VCPhysicalMonitorHandle@@@OPM@@QEAAEKPEAK@Z.c)
 */
