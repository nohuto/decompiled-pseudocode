/*
 * XREFs of NtUserSetWindowShowState @ 0x1C01DCC10
 * Callers:
 *     <none>
 * Callees:
        ...
        && *(_QWORD *)(gptiCurrent + 424LL) == *(_QWORD *)(*((_QWORD *)v15 + 2) + 424LL) )
      {
        ...
        if ( v21 != gptiCurrent )
        {
          ...
          if ( (unsigned int)v6 <= 5 )
          {
            ...
            v30 = *a4;
            a4 = &v30;
            v22 = _MonitorFromWindowInternal(v13, 2LL, 1LL);
            if ( v22 )
            {
              *(_OWORD *)v29 = *(_OWORD *)GetMonitorWorkRectForWindow((__int64)v29, (__int64)v22, v15);
              v31 = 0LL;
              if ( (unsigned int)IntersectRect(&v31, &v30.left, v29) )
              {
                ...
                if ( !v24 )
                {
                  ...
                  {
LABEL_25:
                    v14 = xxxSetWindowShowState(v13, byte_1C0320988[v6], a4);
                    goto LABEL_26;
                  }
                }
              }
