/*
 * XREFs of ?NtGdiSTROBJ_bEnumInternal@@YAHPEAU_STROBJ@@PEAKPEAPEAU_GLYPHPOS@@H@Z @ 0x1C02C6B60
 * Callers:
 *     NtGdiSTROBJ_bEnum @ 0x1C02CCD90 (NtGdiSTROBJ_bEnum.c)
 *     NtGdiSTROBJ_bEnumPositionsOnly @ 0x1C02CCDB0 (NtGdiSTROBJ_bEnumPositionsOnly.c)
 * Callees:
 ...
 *     STROBJ_bEnumPositionsOnly @ 0x1C02DB1F0 (STROBJ_bEnumPositionsOnly.c)
 */
