/*
 * XREFs of InitClipFormatExceptionList @ 0x1C0095A70
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    if ( (v2 == -1073741789 || v2 == -2147483643)
      ...
      && (v5 = v0[8]) != 0
      && (*((_DWORD *)&WPP_MAIN_CB.DeviceQueue.1 + 1) = v0[8], v5 <= 0x1FFF)
      ...
      && (v7 = (_DWORD *)Win32AllocPoolZInit(v6 + 16, 1650684757LL)) != 0LL )
    {
      ...
      if ( *((_DWORD *)&WPP_MAIN_CB.DeviceQueue.1 + 1) )
      {
        while ( ZwEnumerateValueKey(KeyHandle, v8, KeyValuePartialInformation, v7, v0[10] + 16, &Length) >= 0 )
        {
          ...
          if ( ++v8 >= *((_DWORD *)&WPP_MAIN_CB.DeviceQueue.1 + 1) )
            goto LABEL_15;
        }
        *((_DWORD *)&WPP_MAIN_CB.DeviceQueue.1 + 1) = v8;
      }
LABEL_15:
      Win32FreePool(v7);
    }
