/*
 * XREFs of GreDwmStartup @ 0x1C008F45C
 * Callers:
 ...
 *     GreSfmDwmStartup @ 0x1C0090490 (GreSfmDwmStartup.c)
...
__int64 __fastcall GreDwmStartup(Gre::Base *a1)
{
  ...
  unsigned int v19; // [rsp+D8h] [rbp+60h] BYREF
  ...
  {
    *(_QWORD *)(v5 + 176) = a1;
    LOBYTE(v3) = (int)GrepDwmCreateComposedEvent((struct DwmState *)v5) >= 0;
