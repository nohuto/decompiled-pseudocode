/*
 * XREFs of ?SetWindowCompositionHolographic@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1C01F688C
 * Callers:
        ...
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    if ( -__CFSHR__(v9[0], 14) == v5 )
    {
      return 0;
    }
    else
    {
      v9[0] = (v5 << 13) | v9[0] & 0xFFFFDFFF;
