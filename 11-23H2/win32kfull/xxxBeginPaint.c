/*
 * XREFs of xxxBeginPaint @ 0x1C00606C0
 * Callers:
...
__int64 __fastcall xxxBeginPaint(struct tagWND *a1, __int64 *a2)
{
  ...
  __int64 v117; // rcx
  void *v118; // rax
  __int128 v119; // [rsp+20h] [rbp-68h] BYREF
  _QWORD v120[11]; // [rsp+30h] [rbp-58h] BYREF
  int v121; // [rsp+90h] [rbp+8h]
...
LABEL_70:
    ...
    DwmAsyncChildStyleChange(v93, v90, v89, v8);
LABEL_71:
...
LABEL_79:
  DirtyVisRgnTrackers(a1);
  v95 = *(_QWORD *)a1;
  v98 = (void *)ReferenceDwmApiPort(v97, v96);
  DwmAsyncChildStyleChange(v98, v95, v94, v20);
LABEL_80:
...
LABEL_88:
    DirtyVisRgnTrackers(a1);
    v100 = *(_QWORD *)a1;
    v103 = (void *)ReferenceDwmApiPort(v102, v101);
    DwmAsyncChildStyleChange(v103, v100, v99, v32);
LABEL_89:
...
LABEL_97:
    DirtyVisRgnTrackers(a1);
    v105 = *(_QWORD *)a1;
    v108 = (void *)ReferenceDwmApiPort(v107, v106);
    DwmAsyncChildStyleChange(v108, v105, v104, v43);
LABEL_98:
...
LABEL_106:
    DirtyVisRgnTrackers(a1);
    v110 = *(_QWORD *)a1;
    v113 = (void *)ReferenceDwmApiPort(v112, v111);
    DwmAsyncChildStyleChange(v113, v110, v109, v63);
LABEL_107:
...
LABEL_30:
  ...
  if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 20LL) & 2) != 0 )
  {
    if ( v66 )
    {
      ...
      if ( *(_QWORD *)&WPP_MAIN_CB.DeviceQueue.Type
        || (EmptyRgnPublic = CreateEmptyRgnPublic(v57, v56, v58, v59),
            (*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.Type = EmptyRgnPublic) != 0LL) )
      {
        if ( v66 == 1 )
          CalcWindowRgn(a1, EmptyRgnPublic, (((unsigned int)gRdwFlags >> 10) & 1) == 0);
        else
          GreCombineRgn(EmptyRgnPublic, EmptyRgnPublic, v66, 2LL);
  ...
  *a2 = DCEx;
  ...
  if ( (unsigned int)GreGetClipBox(DCEx, (char *)a2 + 12, 1LL) != 1 )
  {
    ...
    v71 = *(_QWORD *)(v70 + 8);
    if ( *(char *)(v71 + 8) >= 0
      || (GetRect(a1, &v119, 17LL), (unsigned int)IntersectRect((char *)a2 + 12, (char *)a2 + 12, &v119)) )
    {
      if ( v27 && v66 && (*(_BYTE *)(*((_QWORD *)a1 + 5) + 31LL) & 0x20) == 0 )
      {
        ...
        if ( *(_QWORD *)(*((_QWORD *)a1 + 2) + 424LL) != *(_QWORD *)(gptiCurrent + 424LL) )
          GreSetDCOwnerEx(v72, 0LL, 0LL, 1LL, v119, *((_QWORD *)&v119 + 1));
        v73 = xxxSendMessage(a1, 20LL, v72, 0LL);
        v70 = *((_QWORD *)a1 + 2);
        v74 = v73;
        if ( *(_QWORD *)(v70 + 424) != *(_QWORD *)(gptiCurrent + 424LL) )
          GreSetDCOwnerEx(v72, 2147483650LL, 0LL, 1LL, v119, *((_QWORD *)&v119 + 1));
        if ( v74 )
          goto LABEL_50;
        v75 = *((_QWORD *)a1 + 5);
        v76 = *(_DWORD *)(v75 + 28);
...
LABEL_122:
            DirtyVisRgnTrackers(a1);
            v115 = *(_QWORD *)a1;
            v118 = (void *)ReferenceDwmApiPort(v117, v116);
            DwmAsyncChildStyleChange(v118, v115, v121, v82);
LABEL_123:
...
LABEL_53:
  v120[2] = 0LL;
  v84 = gptiCurrent;
  v120[0] = *(_QWORD *)(gptiCurrent + 416LL);
  *(_QWORD *)(gptiCurrent + 416LL) = v120;
  ...
  while ( v85 )
  {
    ...
    {
      ThreadLockExchangeAlways(v85, v120);
