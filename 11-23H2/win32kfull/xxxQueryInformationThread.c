/*
 * XREFs of xxxQueryInformationThread @ 0x1C0027854
 * Callers:
 ...
 *     ?IsProcessUserService@@YAHQEAU_EPROCESS@@@Z @ 0x1C0027D40 (-IsProcessUserService@@YAHQEAU_EPROCESS@@@Z.c)
 ...
 *     ?AppModelPolicy_GetPolicy_Internal@@YAJPEAXW4AppModelPolicy_Type@@PEAW4AppModelPolicy_PolicyValue@@PEAU_PS_PKG_CLAIM@@PEA_K@Z @ 0x1C01B2638 (-AppModelPolicy_GetPolicy_Internal@@YAJPEAXW4AppModelPolicy_Type@@PEAW4AppModelPolicy_PolicyValu.c)
...
LABEL_16:
              ...
              if ( v48 >= 8 )
              {
                if ( v8 && (v24 = *(_DWORD *)(v8 + 384)) != 0 )
                {
                  v25 = 8LL * (unsigned int)(v24 + 1);
                  if ( v25 <= v48 )
                  {
                    for ( i = *(_QWORD *)(v8 + 328); i; i = *(_QWORD *)(i + 664) )
                    {
    ...
    *(_OWORD *)a3 = 0LL;
    ...
    else
    {
      if ( ThreadWin32Thread && *(_QWORD *)(ThreadWin32Thread + 456) )
      {
        ...
        if ( v37 && (*(_DWORD *)(v37 + 824) & 0x80u) != 0 && (v30 & 0x800) == 0 )
          a3[2] = 1;
        goto LABEL_63;
      }
      v38 = 1;
