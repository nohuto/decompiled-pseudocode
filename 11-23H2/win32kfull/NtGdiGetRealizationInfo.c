/*
 * XREFs of NtGdiGetRealizationInfo @ 0x1C00C6300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetRealizationInfo(__int64 a1, unsigned int *a2)
{
  unsigned int *v4; // rax
  __int64 v5; // rax
  ...
  RealizationInfo = GreGetRealizationInfo(a1, Length);
  if ( RealizationInfo )
  {
    v7 = Length[0];
