/*
 * XREFs of ?UnlinkAndDestroyComponent@CoreWindowProp@@IEAAXPEAUComponent@1@0@Z @ 0x1C021FC28
 * Callers:
 *     ?Delete@CoreWindowProp@@UEAAXXZ @ 0x1C021F8F0 (-Delete@CoreWindowProp@@UEAAXXZ.c)
