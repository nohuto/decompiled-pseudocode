/*
 * XREFs of ?bFoundExactMatch@MAPPER@@QEAAHPEAPEAU_FONTHASH@@H@Z @ 0x1C0110630
 * Callers:
...
__int64 __fastcall MAPPER::bFoundExactMatch(MAPPER *this, struct _FONTHASH **a2, int a3)
{
  ...
  _BYTE v84[64]; // [rsp+100h] [rbp+0h] BYREF
    ...
    if ( v73 )
    {
      if ( !j )
      {
        ...
        if ( v53 )
        {
          ...
          cCapString(v84, v7, 32LL);
          if ( v53 < v57 )
          {
            while ( 1 )
            {
              v58 = (unsigned __int16 *)v84;
              do
              {
                v59 = *(unsigned __int16 *)((char *)v58 + v53 - (_QWORD)v84);
                v60 = *v58 - v59;
                if ( v60 )
                  break;
                ++v58;
