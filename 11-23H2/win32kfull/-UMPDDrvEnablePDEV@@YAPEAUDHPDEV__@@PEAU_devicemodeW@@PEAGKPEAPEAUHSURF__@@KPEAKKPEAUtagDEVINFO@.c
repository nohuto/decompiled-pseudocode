/*
 * XREFs of ?UMPDDrvEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEAGKPEAPEAUHSURF__@@KPEAKKPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1C02B9130
 * Callers:
 *     <none>
 * Callees:
 *     ?SETFLAG@@YAXHAECKK@Z @ 0x1C0095E74 (-SETFLAG@@YAXHAECKK@Z.c)
 ...
 *     ?ThunkStringW@UMPDOBJ@@QEAAHPEAPEAG@Z @ 0x1C02B7D48 (-ThunkStringW@UMPDOBJ@@QEAAHPEAPEAG@Z.c)
