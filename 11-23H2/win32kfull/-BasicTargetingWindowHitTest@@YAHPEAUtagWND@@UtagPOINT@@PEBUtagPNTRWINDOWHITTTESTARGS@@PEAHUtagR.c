/*
 * XREFs of ?BasicTargetingWindowHitTest@@YAHPEAUtagWND@@UtagPOINT@@PEBUtagPNTRWINDOWHITTTESTARGS@@PEAHUtagRECT@@3PEAIPEAU2@W4tagTARGETING_PROPERTY@@K@Z @ 0x1C01E3580
 * Callers:
        ...
        int a10)
{
  ...
  v10 = 0;
  v19 = 0;
  if ( !(unsigned int)IsCompositionInputWindow(a1, a2, a3, (__int64)a4) || (v15 = 1, (*(_DWORD *)(a3 + 36) & 8) == 0) )
    v15 = 0;
