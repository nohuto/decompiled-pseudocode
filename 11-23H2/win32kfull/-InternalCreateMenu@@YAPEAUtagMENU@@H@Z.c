/*
 * XREFs of ?InternalCreateMenu@@YAPEAUtagMENU@@H@Z @ 0x1C007F558
 * Callers:
 *     NtUserCreateMenu @ 0x1C008B130 (NtUserCreateMenu.c)
 *     NtUserCreatePopupMenu @ 0x1C0095DF0 (NtUserCreatePopupMenu.c)
 ...
 *     ??$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z @ 0x1C007F6DC (--$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z.c)
 */
