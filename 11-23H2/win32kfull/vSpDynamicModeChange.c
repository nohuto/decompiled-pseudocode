/*
 * XREFs of vSpDynamicModeChange @ 0x1C006AE30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z @ 0x1C006CC40 (-vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z.c)
