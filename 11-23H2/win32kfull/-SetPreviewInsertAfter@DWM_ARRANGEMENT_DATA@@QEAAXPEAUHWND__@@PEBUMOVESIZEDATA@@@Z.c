/*
 * XREFs of ?SetPreviewInsertAfter@DWM_ARRANGEMENT_DATA@@QEAAXPEAUHWND__@@PEBUMOVESIZEDATA@@@Z @ 0x1C023A750
 * Callers:
 ...
 *     DwmAsyncSendSnapPreviewInsertAfter @ 0x1C026CE98 (DwmAsyncSendSnapPreviewInsertAfter.c)
 */
