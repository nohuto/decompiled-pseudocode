/*
 * XREFs of ??0EBOX@@QEAA@AEAVDCOBJ@@AEAU_RECTL@@PEAU_LINEATTRS@@H@Z @ 0x1C02C4938
 * Callers:
 ...
 *     ?efHalfDiff@@YA?AVEFLOAT@@JJ@Z @ 0x1C02C5A9C (-efHalfDiff@@YA-AVEFLOAT@@JJ@Z.c)
 */
...
EBOX *__fastcall EBOX::EBOX(EBOX *this, struct DCOBJ *a2, struct _RECTL *a3, struct _LINEATTRS *a4, int a5)
{
  ...
  int v59; // eax
  int v60; // r8d
  int v62; // [rsp+30h] [rbp-50h]
  _DWORD *v63; // [rsp+38h] [rbp-48h] BYREF
  int v64; // [rsp+40h] [rbp-40h]
  int v65; // [rsp+44h] [rbp-3Ch]
  struct _LINEATTRS *v66; // [rsp+48h] [rbp-38h]
  _DWORD *v67; // [rsp+50h] [rbp-30h]
  _BYTE v68[16]; // [rsp+58h] [rbp-28h] BYREF
  struct _POINTL v69; // [rsp+68h] [rbp-18h] BYREF
  LONG v70; // [rsp+70h] [rbp-10h]
  LONG v71; // [rsp+74h] [rbp-Ch]
  ...
  if ( *(_DWORD *)(v30 + 208) == 2 || v29 || *((_DWORD *)this + 1) || (*(_DWORD *)(v30 + 340) & 0x20) != 0 )
  {
    ...
    *((_DWORD *)this + 7) = v20;
    ...
    if ( v62 )
    {
      ...
      v65 = v52;
      HIDWORD(v63) = v52;
      EXFORMOBJ::bXform((EXFORMOBJ *)v68, (struct _VECTORL *)&v63, (struct _VECTORFX *)&v63, 2uLL, 0);
      v55 = v64;
      v56 = HIDWORD(v63) + 1;
      v57 = ((int)v63 + 1) >> 1;
      *v39 += v57;
