/*
 * XREFs of ?pSpCreateSprite@@YAPEAVSPRITE@@PEAUHDEV__@@PEAU_RECTL@@PEAUHWND__@@PEAU_POINTL@@@Z @ 0x1C006B744
 * Callers:
 ...
 * Callees:
 *     ?vSpRenumberZOrder@@YAXPEAU_SPRITESTATE@@@Z @ 0x1C006BE68 (-vSpRenumberZOrder@@YAXPEAU_SPRITESTATE@@@Z.c)
...
struct SPRITE *__fastcall pSpCreateSprite(HDEV a1, struct _RECTL *a2, HWND a3, struct _RECTL *a4)
{
  ...
  _BYTE v17[192]; // [rsp+30h] [rbp-D8h] BYREF
