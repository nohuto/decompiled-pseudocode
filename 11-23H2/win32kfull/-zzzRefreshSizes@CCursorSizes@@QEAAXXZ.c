/*
 * XREFs of ?zzzRefreshSizes@CCursorSizes@@QEAAXXZ @ 0x1C001D40C
 * Callers:
 *     EditionInitGlobalCursorSizes @ 0x1C001CC00 (EditionInitGlobalCursorSizes.c)
 *     EditionzzzUpdateCursorSizes @ 0x1C001CE60 (EditionzzzUpdateCursorSizes.c)
 ...
 * Callees:
 *     GetCursorSizeFromIndex @ 0x1C001D660 (GetCursorSizeFromIndex.c)
 ...
 *     ?_CleanupUnneededSystemCursorSizes@@YAXI@Z @ 0x1C014E05E (-_CleanupUnneededSystemCursorSizes@@YAXI@Z.c)
  ...
  *((_DWORD *)this + 1) = v2;
  ...
  do
  {
    if ( *(_DWORD *)((char *)v30 + v17) )
    {
      ...
      if ( (unsigned int)dword_1C0359080 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0359080, 8LL) )
      {
        v27 = v24;
        v35 = &v27;
        v36 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0359080, (int)&dword_1C0319D3A, 0, 0, 3u, &v34);
      }
    ...
    {
      v19 = 1;
      if ( (unsigned int)dword_1C0359080 > 5 )
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C0359080, 8LL) )
        {
          ...
          v38 = &v28;
          v39 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0359080, (int)&dword_1C0319D06, 0, 0, 3u, &v37);
        }
      }
    }
    v17 += 8LL;
