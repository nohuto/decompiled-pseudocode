/*
 * XREFs of xxxInsertMenuItem @ 0x1C00E4DD0
 * Callers:
...
__int64 __fastcall xxxInsertMenuItem(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4, __int64 a5)
{
  ...
  __int64 v69; // r9
  int *v70; // rcx
  _DWORD *v71; // [rsp+30h] [rbp-61h] BYREF
  __int64 v72; // [rsp+38h] [rbp-59h] BYREF
  __int64 v73; // [rsp+40h] [rbp-51h]
  __int64 v74; // [rsp+48h] [rbp-49h] BYREF
  ...
  _QWORD v83[9]; // [rsp+98h] [rbp+7h] BYREF
  ...
  *(_QWORD *)(v6 + 1512) = &v72;
  ...
  v21 = v86;
  if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 40LL) & 1) == 0
    && *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL)
    && ((*(_DWORD *)(v86 + 4) & 0x80u) == 0 || (unsigned __int64)(*(_QWORD *)(v86 + 72) - 1LL) > 6) )
  {
    ...
    if ( v20 && !a3 )
    {
      ...
      if ( !v73 )
        v60 = *(_QWORD *)v71;
      v22 = MNGetpItemIndex(v60, v20);
    }
    if ( v22 )
    {
      if ( v22 == v18 )
        v22 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL);
      v24 = v18 + v22;
      v25 = *(_QWORD *)(*(_QWORD *)v71 + 88LL) + 96 * v24;
      if ( !(_DWORD)v24 )
        goto LABEL_22;
      do
      {
    ...
    {
      if ( *(_QWORD *)(**(_QWORD **)(*(_QWORD *)v71 + 88LL) + 96LL) == 1LL )
      {
        v58 = 1;
        a2 = 1;
      }
    ...
    if ( a2 != v23 )
      v20 = (int **)(*(_QWORD *)(*(_QWORD *)v71 + 88LL) + 96LL * a2);
  }
LABEL_22:
  if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL) >= *(_DWORD *)(*(_QWORD *)v71 + 60LL) )
  {
    ...
    if ( a2 != -1 )
    {
      ...
      v79 = 0LL;
      SmartObjStackRefBase<tagMENU>::operator=(&v77, v76);
      if ( !SmartObjStackRef<tagMENU>::operator==((__int64)&v71, (__int64)&v77) )
        goto LABEL_121;
    }
  }
  v27 = v73;
  ...
  if ( v20 )
  {
    ...
    if ( *(_QWORD *)v74 )
    {
      ...
      if ( !v73 )
        v61 = *(_QWORD *)v71;
      v14 = MNGetpItemIndex(v61, v20);
      if ( *(_DWORD *)(*(_QWORD *)v74 + 80LL) >= v14 )
        ++*(_DWORD *)(*(_QWORD *)v74 + 80LL);
      v63 = *(_QWORD *)v74;
      if ( (**(_DWORD **)v74 & 0x20) != 0 && *(_DWORD *)(*(_QWORD *)v74 + 84LL) >= v14 )
        ++*(_DWORD *)(*(_QWORD *)v74 + 84LL);
      if ( *(_QWORD *)(v80 + 64) == *(_QWORD *)(*(_QWORD *)v74 + 16LL) )
      {
        v64 = *(_DWORD *)(v80 + 72);
        if ( v64 >= (int)v14 )
          *(_DWORD *)(v80 + 72) = v64 + 1;
      ...
      v65 = v80;
      if ( *(_QWORD *)(v80 + 80) == *(_QWORD *)(*(_QWORD *)v74 + 16LL) )
      {
        v63 = *(unsigned int *)(v80 + 88);
        if ( (int)v63 >= (int)v14 )
        {
          *(_DWORD *)(v80 + 88) = v63 + 1;
          if ( (_DWORD)v63 == v14 )
          {
            v62 = *(unsigned int *)(v65 + 92);
            if ( (v62 & 1) != 0 )
              xxxMNSetGapState(*(_QWORD *)(v65 + 80), v63, v62, 0LL);
          }
        }
      }
      AtomicExecutionCheck::Disarm((AtomicExecutionCheck *)&v85, v63, v62);
    }
  }
  ...
  if ( v31 == *(_QWORD *)v71
    || ((SmartObjStackRefBase<tagMENU>::DecrementCountAndTryFree(&v71), v31)
      ? (_DWORD *)(v71 = *(_DWORD **)(v31 + 152), ++v71[2])
      : (v71 = (_DWORD *)gSmartObjNullRef),
        !v73) )
  {
    if ( !*(_QWORD *)v71 )
...
LABEL_121:
  ...
  if ( v20 )
  {
    v53 = *(_QWORD *)(*(_QWORD *)v71 + 88LL)
        + 96LL * (unsigned int)(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL) - 1)
        - (_QWORD)v20;
    if ( v53 )
    {
      memmove(
        v20[12],
        *v20,
        **(_QWORD **)(*(_QWORD *)v71 + 88LL)
      + 112LL * (unsigned int)(*(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL) - 1)
      - (_QWORD)*v20);
      memmove(v20 + 12, v20, v53);
      v54 = ((__int64)v20 - *(_QWORD *)(*(_QWORD *)v71 + 88LL) + 96) / 96;
      while ( (unsigned int)v54 < *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL) )
      {
        v55 = 96LL * (int)v54;
        *(_QWORD *)(v55 + *(_QWORD *)(*(_QWORD *)v71 + 88LL)) = *(_QWORD *)(*(_QWORD *)v71 + 96LL)
                                                              + 112LL * (unsigned int)v54;
        LODWORD(v54) = v54 + 1;
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 88LL) + v55 + 8) = *(_QWORD *)(v55 + *(_QWORD *)(*(_QWORD *)v71 + 88LL))
                                                                  - *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 24LL) + 16LL);
      }
    }
  }
  else
  {
    v20 = (int **)(96LL * *(unsigned int *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL)
                 + *(_QWORD *)(*(_QWORD *)v71 + 88LL)
                 - 96LL);
  }
  **v20 = 0;
  ...
  *((_QWORD *)*v20 + 5) = 0LL;
  ...
  if ( (unsigned int)SetLPITEMInfoNoRedraw((unsigned int)&v71, (_DWORD)v20, v21, a5, (__int64)&v84) )
  {
    if ( !v84 )
      goto LABEL_41;
    v33 = v73;
    if ( !v73 )
      v33 = *(_QWORD *)v71;
    ThreadLock(v33, &v81);
    xxxRedrawForSetLPITEMInfo(&v71, v20);
...
LABEL_41:
      ...
      if ( !v73 )
        v38 = *(_QWORD *)v71;
LABEL_43:
      if ( (unsigned int)MNGetpItemIndex(v38, v20) != -1 )
      {
        if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 40LL) & 0x20) != 0
  ...
  else
  {
    if ( *(_QWORD *)v74 )
    {
      SmartObjStackRefBase<tagPOPUPMENU>::Init(v83, *(_QWORD *)v74);
    ...
    v67 = 96 * *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL)
        + *(_DWORD *)(*(_QWORD *)v71 + 88LL)
        - (_DWORD)v20
        - 96;
    if ( 96 * *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL) + *(_DWORD *)(*(_QWORD *)v71 + 88LL) - (_DWORD)v20 != 96 )
    {
      memmove(
        *v20,
        v20[12],
        (unsigned int)(112 * *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL)
                     + **(_DWORD **)(*(_QWORD *)v71 + 88LL)
                     - *((_DWORD *)v20 + 24)));
      memmove(v20, v20 + 12, v67);
      v68 = 0xAAAAAAAAAAAAAAABuLL * (((__int64)v20 - *(_QWORD *)(*(_QWORD *)v71 + 88LL)) >> 5);
      while ( (unsigned int)v68 < *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL) - 1 )
      {
        v69 = 96LL * (int)v68;
        *(_QWORD *)(v69 + *(_QWORD *)(*(_QWORD *)v71 + 88LL)) = *(_QWORD *)(*(_QWORD *)v71 + 96LL)
                                                              + 112LL * (unsigned int)v68;
        LODWORD(v68) = v68 + 1;
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 88LL) + v69 + 8) = *(_QWORD *)(v69 + *(_QWORD *)(*(_QWORD *)v71 + 88LL))
                                                                  - *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 24LL) + 16LL);
      }
    }
    --*(_DWORD *)(*(_QWORD *)(*(_QWORD *)v71 + 40LL) + 44LL);
...
LABEL_46:
  ...
  if ( v44 )
    v43 = *v44;
  if ( v74 != gSmartObjNullRef && !--*(_DWORD *)(v74 + 8) )
  {
    if ( *(_BYTE *)(v74 + 12) )
