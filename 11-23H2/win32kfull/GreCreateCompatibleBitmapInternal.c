/*
 * XREFs of GreCreateCompatibleBitmapInternal @ 0x1C0024FB0
 * Callers:
 ...
 *     NtGdiCreateCompatibleBitmap @ 0x1C007A750 (NtGdiCreateCompatibleBitmap.c)
 ...
 *     ?CreateScreenBitmap@@YAPEAUHBITMAP__@@HHI@Z @ 0x1C01FB608 (-CreateScreenBitmap@@YAPEAUHBITMAP__@@HHI@Z.c)
        ...
        unsigned __int16 *a6)
{
  ...
  if ( !a1 )
    return GreCreateBitmap((unsigned int)v6, (unsigned int)v8, 1LL);
  v69 = 0LL;
