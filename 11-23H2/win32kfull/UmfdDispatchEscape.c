/*
 * XREFs of UmfdDispatchEscape @ 0x1C00D0B30
 * Callers:
 *     NtGdiExtEscape @ 0x1C00D09E0 (NtGdiExtEscape.c)
 * Callees:
 *     ?UmfdEscEngComputeGlyphSet@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z @ 0x1C00744C8 (-UmfdEscEngComputeGlyphSet@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z.c)
...
LABEL_38:
        ...
        case 0x11u:
          ...
          break;
        case 0x12u:
          UmfdHostLifeTimeManager::OnHostReady(v3);
          break;
        case 0x13u:
