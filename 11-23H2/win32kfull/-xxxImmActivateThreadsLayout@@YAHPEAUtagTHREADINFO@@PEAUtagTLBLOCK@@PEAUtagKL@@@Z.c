/*
 * XREFs of ?xxxImmActivateThreadsLayout@@YAHPEAUtagTHREADINFO@@PEAUtagTLBLOCK@@PEAUtagKL@@@Z @ 0x1C01B7734
 * Callers:
 ...
 *     EditionImmActivateThreadsLayout @ 0x1C01E83D0 (EditionImmActivateThreadsLayout.c)
 * Callees:
