/*
 * XREFs of ?PanEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEAGKPEAPEAUHSURF__@@KPEAKKPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1C029B3D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bCreateSemaphores@@YAHPEAU_PANDEV@@@Z @ 0x1C029C970 (-bCreateSemaphores@@YAHPEAU_PANDEV@@@Z.c)
 *     ?vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z @ 0x1C029CD7C (-vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z.c)
 */
