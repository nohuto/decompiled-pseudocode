/*
 * XREFs of ?xxxMigrateWindow@AdvancedWindowPos@@YA?AW4MigrateWindowResult@@PEAUtagWND@@PEAUtagMONITOR@@AEBVCMonitorTopology@@W4MigrateWindowOptions@@PEAK@Z @ 0x1C005C088
 * Callers:
...
__int64 __fastcall AdvancedWindowPos::xxxMigrateWindow(struct tagWND *a1, __int64 a2, __int64 a3, char a4, int *a5)
{
  ...
  {
    v19 = *(_QWORD *)a1;
    v13 = (__int128 *)GetProp(a1, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1LL);
    if ( v13 )
      v14 = *v13;
    else
      v14 = 0LL;
    v16 = *a5;
    v20 = v14;
    anonymous_namespace_::xxxMigrateWindowPosition(a1, v16);
