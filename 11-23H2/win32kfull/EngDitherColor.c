/*
 * XREFs of EngDitherColor @ 0x1C02887F0
 * Callers:
 ...
 *     ?vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z @ 0x1C0287FAC (-vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z.c)
 *     ?vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x1C0288240 (-vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z.c)
 *     ?vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x1C0288538 (-vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z.c)
 */
    ...
    if ( iMode == 2 )
    {
      ...
      *((_OWORD *)pul + 1) = 0LL;
      ...
      if ( v10 )
      {
        ...
        do
        {
          v12 = *((unsigned __int8 *)&dword_1C0328930[31] + v11 + 3);
          pul[v12] |= *((unsigned __int8 *)&dword_1C0328930[16] + --v11);
          --v10;
        }
        while ( v10 );
      }
