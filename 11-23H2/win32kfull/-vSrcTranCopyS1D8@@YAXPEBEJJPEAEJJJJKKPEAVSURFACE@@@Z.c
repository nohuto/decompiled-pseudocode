/*
 * XREFs of ?vSrcTranCopyS1D8@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1C0294FA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        unsigned __int8 a9)
{
  ...
  if ( (a6 & 0xFFFFFFF8) != (a5 & 0xFFFFFFF8) )
  {
    ...
    do
    {
      ...
      {
        v21 = 0x101010101010101LL * a9;
        v24 = dword_1C0328AE0[(unsigned __int64)(unsigned __int8)(v45 & *v20) >> 4] | ((unsigned __int64)dword_1C0328AE0[(unsigned __int8)v45 & *v20 & 0xF] << 32);
      ...
      if ( v26 != (unsigned __int64 *)v23 )
      {
        do
        {
          if ( *v25 )
          {
            v27 = dword_1C0328AE0[(unsigned __int64)(unsigned __int8)*v25 >> 4] | ((unsigned __int64)dword_1C0328AE0[*v25 & 0xF] << 32);
            *v26 = v21 & v27 | *v26 & ~v27;
          }
          ++v25;
          ++v26;
