/*
 * XREFs of _ScaleSystemMetricForDPIWithoutCache @ 0x1C01BEE20
 * Callers:
 ...
 *     NtUserScaleSystemMetricForDPIWithoutCache @ 0x1C01D9880 (NtUserScaleSystemMetricForDPIWithoutCache.c)
 * Callees:
