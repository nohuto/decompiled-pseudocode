/*
 * XREFs of ?bCreateSectionFromHandle@@YAHPEAXPEBGPEAU_FILEVIEW@@HPEAHE@Z @ 0x1C00CF7F4
 * Callers:
 ...
 *     ?bCreateSection@@YAHPEBGPEAU_FILEVIEW@@HPEAHE@Z @ 0x1C00D0934 (-bCreateSection@@YAHPEBGPEAU_FILEVIEW@@HPEAHE@Z.c)
 * Callees:
 *     ?ScrutinizeFontLoad@@YAJW4_W32KFontSourceType@@PEBG@Z @ 0x1C009CE24 (-ScrutinizeFontLoad@@YAJW4_W32KFontSourceType@@PEBG@Z.c)
 *     ZwWin32CreateSection @ 0x1C00CFAE8 (ZwWin32CreateSection.c)
 *     ?bIsFileInSystemFontsDir@@YAHPEAX@Z @ 0x1C00CFC00 (-bIsFileInSystemFontsDir@@YAHPEAX@Z.c)
 *     ?TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z @ 0x1C00CFD58 (-TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z.c)
