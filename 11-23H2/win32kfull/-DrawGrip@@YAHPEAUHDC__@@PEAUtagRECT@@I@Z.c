/*
 * XREFs of ?DrawGrip@@YAHPEAUHDC__@@PEAUtagRECT@@I@Z @ 0x1C008D198
 * Callers:
...
__int64 __fastcall DrawGrip(HDC a1, struct tagRECT *a2, __int16 a3)
{
  ...
  v17 = GreSetTextColor((__int64)a1, v15);
  if ( (a3 & 0x10) != 0 )
  {
    GreExtTextOutW((__int64)a1, v12, v13, 0, 0LL, (__int64)L"x", 1);
    GreSetTextColor((__int64)a1, v16);
    GreExtTextOutW((__int64)a1, v12, v13, 0, 0LL, (__int64)L"y", 1);
  }
  else
  {
    GreExtTextOutW((__int64)a1, v12, v13, 0, 0LL, (__int64)L"o", 1);
    GreSetTextColor((__int64)a1, v16);
    GreExtTextOutW((__int64)a1, v12, v13, 0, 0LL, (__int64)L"p", 1);
  }
  GreSetTextColor((__int64)a1, v17);
  return 1LL;
}
