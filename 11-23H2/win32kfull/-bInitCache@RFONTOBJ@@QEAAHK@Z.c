/*
 * XREFs of ?bInitCache@RFONTOBJ@@QEAAHK@Z @ 0x1C00CE65C
 * Callers:
...
__int64 __fastcall RFONTOBJ::bInitCache(RFONTOBJ *this, int a2)
{
  ...
  __int64 v14; // rcx
  unsigned __int16 v15; // [rsp+40h] [rbp-78h] BYREF
  unsigned int v16; // [rsp+48h] [rbp-70h] BYREF
  __int64 v17; // [rsp+50h] [rbp-68h] BYREF
  _GLYPHDATA v18; // [rsp+60h] [rbp-58h] BYREF
