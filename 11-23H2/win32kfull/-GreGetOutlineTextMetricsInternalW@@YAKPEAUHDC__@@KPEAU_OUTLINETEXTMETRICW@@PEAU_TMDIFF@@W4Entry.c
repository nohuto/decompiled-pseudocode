/*
 * XREFs of ?GreGetOutlineTextMetricsInternalW@@YAKPEAUHDC__@@KPEAU_OUTLINETEXTMETRICW@@PEAU_TMDIFF@@W4EntryPoint@RFONTOBJ@@@Z @ 0x1C00CA878
 * Callers:
 ...
 *     ?cjOTMAWSize@@YAIPEAU_IFIMETRICS@@PEAI@Z @ 0x1C00CABBC (-cjOTMAWSize@@YAIPEAU_IFIMETRICS@@PEAI@Z.c)
