/*
 * XREFs of ?xxxRestoreToPosAndState@AdvancedWindowPos@@YA_NPEAUtagWND@@AEBUMonitorData@CMonitorTopology@@W4State@1@UtagRECT@@3W4ApplyOption@1@PEAK@Z @ 0x1C023C82C
 * Callers:
        ...
        int *a7)
{
  ...
  *(_QWORD *)&v75 = a5;
  ...
  v30 = *((_WORD *)v9 + 20);
  v78 = 0LL;
  v31 = (__int64 *)CMonitorTopology::MonitorData::LogicalWorkArea((CMonitorTopology::MonitorData *)v9, &v84, a1);
  v32 = v9 + 3;
  v33 = v73;
  v75 = v29;
...
LABEL_24:
  if ( v25 != 3 )
  {
    ...
    v80 = (int)v50;
    v82 = v48;
    AdvancedWindowPos::xxxApplyWindowPos(a1, (struct tagWND *)&v79, v50);
    if ( WindowState == 3 )
      NotifyShell::ArrangementCompleted(a1, (unsigned int)*v33, 2LL, v58);
    goto LABEL_80;
  }
  if ( !(_BYTE)v24 )
  {
  ...
  Prop = GetProp((__int64)a1, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1LL, v24);
  if ( Prop )
  ...
  if ( WindowArrangement::xxxSetSnapArrangementPos((__int64)a1, (__int64)v8, 2, *v73) )
  {
    v43 = (_OWORD *)GetProp((__int64)a1, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1LL, v42);
    if ( v43 )
    {
      *v43 = *(_OWORD *)v27;
...
LABEL_81:
  ...
  if ( v60 || v12 )
  {
    v61 = AdvancedWindowPos::GetWindowState(a1);
    v62 = AdvancedWindowPos::GetStateString(v61);
    v63 = (_DWORD *)*((_QWORD *)a1 + 5);
