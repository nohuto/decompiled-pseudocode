/*
 * XREFs of ?xxxApplyWindowPos@AdvancedWindowPos@@YAXPEAUtagWND@@AEBUWINDOWPOSANDSTATE@1@@Z @ 0x1C023B1B4
 * Callers:
        ...
        const struct AdvancedWindowPos::WINDOWPOSANDSTATE *a3)
{
  ...
  if ( v75 != (_BYTE)v20 )
  {
    v30 = v16 ? 18LL : *(unsigned int *)(*((_QWORD *)this + 5) + 288LL);
    v29 = (struct tagWND *)MonitorFromRect((__int64)v82, 2LL, v30);
    v83 = v29;
    if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      || (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) == 0
...
LABEL_197:
  ...
  if ( v17 == 1 )
  {
    ...
    if ( v80 )
    {
      Prop = (_OWORD *)GetProp((__int64)this, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1LL, v41);
      if ( Prop )
      {
        if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          || (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) == 0
