/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1C00997E4
 * Callers:
 *     InitializeWin32kFullTelemetryAsserts @ 0x1C0099790 (InitializeWin32kFullTelemetryAsserts.c)
 * Callees:
