/*
 * XREFs of ?bMapRoutine@@YAHPEAU_FONTFILEVIEW@@PEAU_FILEVIEW@@W4_MAP_MODE@@H@Z @ 0x1C00CF6A4
 * Callers:
 ...
 * Callees:
 *     ?bShouldMap@@YAHPEAU_FILEVIEW@@0H@Z @ 0x1C00CF764 (-bShouldMap@@YAHPEAU_FILEVIEW@@0H@Z.c)
 */
