/*
 * XREFs of ?xxxMoveEventAbsolute@@YA?AW4_CommitMousePosAndMoveResult@@JJ_KPEAXPEAU_MOUSE_INPUT_DATA@@00HHHPEAU_MousePacketPerf@@@Z @ 0x1C014EA9E
 * Callers:
 *     EditionCommitMousePosAndMove @ 0x1C01AB770 (EditionCommitMousePosAndMove.c)
 * Callees:
 ...
 *     RawInputRequestedForMouse @ 0x1C01ABE70 (RawInputRequestedForMouse.c)
 *     UsingPenCursors @ 0x1C01AD49C (UsingPenCursors.c)
 */
