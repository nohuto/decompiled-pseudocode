/*
 * XREFs of ?Create@CPointerHashTable@NSInstrumentation@@SAPEAV12@_N@Z @ 0x1C007CAFC
 * Callers:
 *     ?Initialize@UmfdAllocation@@SA_NXZ @ 0x1C007CA98 (-Initialize@UmfdAllocation@@SA_NXZ.c)
 * Callees:
 *     ?Destroy@CPointerHashTable@NSInstrumentation@@SAXPEAV12@@Z @ 0x1C009BCB0 (-Destroy@CPointerHashTable@NSInstrumentation@@SAXPEAV12@@Z.c)
