/*
 * XREFs of ??0CRecalcState@@AEAA@PEBUtagWND@@PEAVCMonitorTopology@@W4StartRecalcOption@@@Z @ 0x1C005DC9C
 * Callers:
...
__int64 __fastcall CRecalcState::CRecalcState(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  *(_OWORD *)(v4 + 28) = *(_OWORD *)(*(_QWORD *)(v8 + 40) + 88LL);
  ...
  {
    Prop = (__int128 *)GetProp(v10, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1LL);
    if ( Prop )
    {
      v12 = *Prop;
      goto LABEL_3;
