/*
 * XREFs of xxxRealDrawMenuItem @ 0x1C0236080
 * Callers:
 ...
 *     FindCharPosition @ 0x1C024C000 (FindCharPosition.c)
 *     xxxPSMGetTextExtent @ 0x1C024E610 (xxxPSMGetTextExtent.c)
 *     GreCreateDIBitmapReal @ 0x1C02DDA3C (GreCreateDIBitmapReal.c)
 *     GreDecBitmapExclusiveRefCnt @ 0x1C02DDAE0 (GreDecBitmapExclusiveRefCnt.c)
 */
...
__int64 __fastcall xxxRealDrawMenuItem(Gre::Base *a1, __int64 *a2, int a3, int a4, int a5, int a6)
{
  ...
  int v61; // r8d
  int v62; // eax
  unsigned int CharPosition; // r15d
  ...
  unsigned __int8 *v94; // [rsp+88h] [rbp-78h] BYREF
  BOOL v95; // [rsp+90h] [rbp-70h]
  __int64 *v96[2]; // [rsp+98h] [rbp-68h] BYREF
  ...
  _OWORD v102[3]; // [rsp+D8h] [rbp-28h] BYREF
  _BYTE v103[16]; // [rsp+110h] [rbp+10h] BYREF
  unsigned __int16 v104; // [rsp+120h] [rbp+20h]
  unsigned __int16 v105; // [rsp+122h] [rbp+22h]
  __int16 v106; // [rsp+13Eh] [rbp+3Eh]
  int v107; // [rsp+140h] [rbp+40h]

  SmartObjStackRefBase<tagMENU>::Init(v96, 0LL);
  v9 = *a2;
  v97 = 0LL;
  v101 = 0LL;
  v10 = 0;
  v95 = 0;
  v100 = 0LL;
  SmartObjStackRefBase<tagMENU>::operator=(v96, v9);
  v11 = a2[1];
  v12 = *(_DWORD *)(*(_QWORD *)(*v96[0] + 40) + 40LL) & 1;
  v91 = v12;
  if ( v12 )
  {
    v13 = 2;
    v14 = *v96[0];
    if ( *(int *)(*(_QWORD *)(*v96[0] + 40) + 40LL) >= 0 )
    {
      if ( a5 )
      {
        v15 = *(_QWORD *)v11;
  ...
  {
    v14 = *v96[0];
    if ( (*(_DWORD *)(*(_QWORD *)(*v96[0] + 40) + 40LL) & 0x4000000) != 0 )
      goto LABEL_39;
  }
  if ( a5 )
    goto LABEL_73;
      ...
      if ( v21 )
      {
        ...
        if ( v22 )
        {
          ...
          if ( v23 == 1 )
          {
            ...
            v19 = v13 + 2;
LABEL_38:
            BitBltSysBmp((HDC)a1, v19, 2, v24, 1);
LABEL_39:
            v26 = v91;
            goto LABEL_40;
          }
LABEL_49:
  ...
  if ( v18 == -1LL )
  {
    xxxSendMenuDrawItemMessage((__int64)a1, 1, v96, v11, 1, v13, 0LL);
    goto LABEL_39;
  }
...
LABEL_73:
  ...
  {
    if ( v12
      || (v14 = *v96[0], v11 != *(_QWORD *)(*v96[0] + 88))
      || (v14 = *v96[0], *(_DWORD *)(*(_QWORD *)(*v96[0] + 40) + 44LL) <= 1u)
      || (v14 = *(_QWORD *)(*(_QWORD *)(*v96[0] + 88) + 96LL), *(_QWORD *)(v14 + 96))
      || !*(_QWORD *)(v11 + 16) )
    {
LABEL_74:
      v43 = *(_QWORD *)v11;
      ...
      v99 = GreSelectBitmap(ghdcMem2, *(_QWORD *)(*(_QWORD *)v11 + 96LL));
      if ( !v99 )
        goto LABEL_39;
      memset_0(v103, 0, 0x68uLL);
      ObjectW = GreExtGetObjectW(*(HBRUSH *)(*(_QWORD *)v11 + 96LL), 104LL, (__int64)v103);
      if ( !a5 || **(_DWORD **)v11 == 4 )
      {
        if ( ObjectW != 104 || v106 != 32 || v107 || **(_DWORD **)v11 == 4 )
        {
          if ( v104 * v105 == 1 )
            v57 = 12060490;
          else
            v57 = (unsigned int)MNDrawHilite((__int64)v96, v11) != 0 ? 3342344 : 13369376;
          NtGdiBitBltInternal(
            (__int64)a1,
            v95 + v13,
            v95 + v46,
      ...
      if ( a6 )
      {
        ...
        if ( !CompatibleDC )
          goto LABEL_98;
        memset((char *)&v102[1] + 4, 0, 24);
        LODWORD(v102[0]) = 40;
        *(_QWORD *)((char *)v102 + 4) = __PAIR64__(DpiDependentMetric, v44);
        *(_QWORD *)((char *)v102 + 12) = 2097153LL;
...
LABEL_98:
  ...
  {
LABEL_61:
    if ( !*(_QWORD *)(*(_QWORD *)v11 + 56LL) && *(_QWORD *)(*v96[0] + 80) )
      SetupFakeMDIAppStuff((__int64)v96, (_QWORD *)v11);
...
LABEL_40:
  ...
  if ( !v30 )
    goto LABEL_170;
  v98 = *(_QWORD *)(v11 + 88);
  if ( v26 && (v28 = *v96[0], *(_DWORD *)(*v96[0] + 72)) )
  {
    v28 = *v96[0];
    v13 = *(_DWORD *)(*v96[0] + 72);
  }
  ...
  v59 = *(_QWORD *)v11;
  v60 = DPIMetrics;
  v94 = (unsigned __int8 *)DPIMetrics;
  ...
  CharPosition = FindCharPosition(v29, 9LL);
  ...
  if ( v68 && v68 != v30 )
  {
    if ( (**(_DWORD **)v11 & 0x2000) != 0 && v91 )
    {
      xxxPSMGetTextExtent((HDC)a1);
      v72 = v97;
      if ( !v97 )
        v72 = *v96[0];
      if ( (unsigned int)MNGetpItemIndex(v72, v11) == -1 || v98 != *(_QWORD *)(v11 + 88) )
        goto LABEL_170;
      v13 = v71;
    }
    xxxDrawMenuItemText(
      ...
      (__int64)v29,
      v68,
      *(_DWORD *)(*(_QWORD *)(*v96[0] + 40) + 40LL) & 4);
    v73 = v97;
    if ( !v97 )
      v73 = *v96[0];
    if ( (unsigned int)MNGetpItemIndex(v73, v11) != -1 && v98 == *(_QWORD *)(v11 + 88) )
    {
      if ( CharPosition <= v68 + 1 )
      {
        v77 = v98;
        goto LABEL_147;
      }
      ...
      else
      {
        ...
        if ( !v97 )
          v75 = *v96[0];
        if ( (unsigned int)MNGetpItemIndex(v75, v11) == -1 || v98 != *(_QWORD *)(v11 + 88) )
          goto LABEL_170;
      }
      xxxPSMTextOut((HDC)a1, v74 - 1, ~(*(_DWORD *)(*(_QWORD *)(*v96[0] + 40) + 40LL) << 18) & 0x100000);
      v76 = v97;
      if ( !v97 )
        v76 = *v96[0];
...
LABEL_170:
  ...
  if ( (**(_DWORD **)v11 & 0x2000) != 0 )
  {
    ...
    if ( !v97 )
      v81 = *v96[0];
    if ( (unsigned int)MNGetpItemIndex(v81, v11) == -1 )
      goto LABEL_170;
    v77 = v98;
    if ( v98 != *(_QWORD *)(v11 + 88) )
      goto LABEL_170;
    v13 = v71;
    if ( !v91 && !*(_QWORD *)(*(_QWORD *)v11 + 96LL) )
      v13 = *((_DWORD *)v94 + 2) + v71;
  }
  else
  {
    v77 = v98;
  ...
  if ( !v97 )
    v82 = *v96[0];
  if ( (unsigned int)MNGetpItemIndex(v82, v11) == -1 || v77 != *(_QWORD *)(v11 + 88) )
    goto LABEL_170;
LABEL_147:
  if ( CharPosition >= v30 - 1 )
    goto LABEL_170;
  if ( (**(_DWORD **)v11 & 0x2000) == 0 || !v91 )
  {
    ...
    v79 = (HDC)a1;
LABEL_185:
    xxxPSMTextOut(v79, v78 - 1, ~(*(_DWORD *)(*(_QWORD *)(*v96[0] + 40) + 40LL) << 18) & 0x100000);
    goto LABEL_171;
  }
  v78 = v30 - CharPosition;
  v79 = (HDC)a1;
  ...
  if ( !v97 )
    v80 = *v96[0];
  if ( (unsigned int)MNGetpItemIndex(v80, v11) != -1 && v77 == *(_QWORD *)(v11 + 88) )
    goto LABEL_185;
LABEL_171:
  v83 = v97;
  if ( !v97 )
    v83 = *v96[0];
  if ( (unsigned int)MNGetpItemIndex(v83, v11) != -1 && !a5 )
  {
    if ( v91 )
    {
      if ( *(_QWORD *)(v11 + 16) )
      {
        v84 = (**(_DWORD **)v11 & 0x2000) != 0 ? 0x1E : 0;
        v85 = GetDpiForSystem(-(**(_DWORD **)v11 & 0x2000));
        v86 = (__int16 *)GetOemBitmapInfoForDpi((unsigned int)(v84 + 62), v85);
        if ( *(_DWORD *)(*(_QWORD *)v11 + 76LL) >= v86[3] )
        {
          if ( PrepareHDCBITSBitmap(0LL, *(_QWORD *)v11) )
          {
            v87 = v86[3];
            v88 = (*(_DWORD *)(*(_QWORD *)v11 + 76LL) - v87 - 2) / 2;
            if ( v88 <= 0 )
              v88 = 0;
            BltColor(v79, v88, v86[2], v87, *v86, v86[1], 1);
          }
        }
      }
    }
