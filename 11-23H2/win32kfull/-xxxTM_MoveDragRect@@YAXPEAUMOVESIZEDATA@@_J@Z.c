/*
 * XREFs of ?xxxTM_MoveDragRect@@YAXPEAUMOVESIZEDATA@@_J@Z @ 0x1C01F0D1C
 * Callers:
...
LABEL_33:
  ...
  if ( (v16 & 0x1000000) != 0 )
  {
    ...
    {
      v17 = *((int *)this + 44);
      v18 = (unsigned __int64 *)*((_QWORD *)this + 2);
  ...
  v19 = *((int *)this + 44);
  v20 = (unsigned __int64 *)*((_QWORD *)this + 2);
  v28 = *v14;
