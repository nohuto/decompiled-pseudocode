/*
 * XREFs of ?xxxRealSleepThread@@YAHIKHHPEAW4SLEEP_STATUS@@@Z @ 0x1C01266D0
 * Callers:
 ...
 *     ?CheckProcessForeground@@YAJPEAUtagTHREADINFO@@@Z @ 0x1C008DD78 (-CheckProcessForeground@@YAJPEAUtagTHREADINFO@@@Z.c)
  ...
  while ( 2 )
  {
    ...
    if ( v7 != 258 )
    {
      ...
      *(_QWORD *)(*(_QWORD *)(gptiCurrent + 480LL) + 8LL) = 0LL;
      ...
      if ( !*(_QWORD *)(v19 + 336) )
        *(_QWORD *)(v19 + 336) = gptiCurrent;
      if ( *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 336LL) != gptiCurrent )
      {
LABEL_30:
        v20 = *((_DWORD *)v18 + 3);
        if ( (v20 & 4) != 0 )
...
LABEL_32:
        ...
        while ( 1 )
        {
          ...
          {
            v27 = DWORD2(v51[0]) + 4;
            xxxHandleCoreMessagingQueueCompletion(gptiCurrent, (ULONG64 *)v51, (unsigned int)(DWORD2(v51[0]) + 1));
          }
          if ( v27 == 3 )
