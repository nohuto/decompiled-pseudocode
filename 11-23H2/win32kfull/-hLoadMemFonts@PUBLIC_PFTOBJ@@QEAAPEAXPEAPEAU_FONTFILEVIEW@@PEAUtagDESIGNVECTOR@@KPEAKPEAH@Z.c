/*
 * XREFs of ?hLoadMemFonts@PUBLIC_PFTOBJ@@QEAAPEAXPEAPEAU_FONTFILEVIEW@@PEAUtagDESIGNVECTOR@@KPEAKPEAH@Z @ 0x1C026ABD0
 * Callers:
 ...
 *     ?vKeepIt@PFFMEMOBJ@@QEAAXXZ @ 0x1C008B4E8 (-vKeepIt@PFFMEMOBJ@@QEAAXXZ.c)
 *     ??1PFFMEMOBJ@@QEAA@XZ @ 0x1C008C9EC (--1PFFMEMOBJ@@QEAA@XZ.c)
