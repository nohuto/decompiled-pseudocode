/*
 * XREFs of ?SetWindowCompositionPassiveUpdateMode@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1C01F6A10
 * Callers:
        ...
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    v7 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v9[0], 16) == v7 )
    {
      return 0;
    }
    else
    {
      v9[0] = v9[0] & 0xFFFF7FFF | (v7 << 15);
