/*
 * XREFs of RenderNineGrid @ 0x1C005791C
 * Callers:
        ...
        int a11)
{
  ...
  if ( (*a9 & 4) != 0 )
  {
    ...
    {
      v21 = *(__int64 (__fastcall **)(struct _SURFOBJ *, __int64, __int64, __int64, int *, __int64 *, _QWORD *))(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280) + 120LL);
...
LABEL_7:
  ...
  else
  {
    ...
    if ( (*a9 & 8) != 0 )
    {
      ...
      {
        v22 = *(__int64 (__fastcall **)(struct _SURFOBJ *, __int64, __int64, __int64, int *, __int64 *, _DWORD, _DWORD))(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280) + 112LL);
    ...
    else
    {
      ...
      {
        v23 = *(__int64 (__fastcall **)(struct _SURFOBJ *, __int64, __int64, __int64, int *, _DWORD **))(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280) + 80LL);
