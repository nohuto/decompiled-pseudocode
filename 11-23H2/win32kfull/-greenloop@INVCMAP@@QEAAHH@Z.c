/*
 * XREFs of ?greenloop@INVCMAP@@QEAAHH@Z @ 0x1C02A329C
 * Callers:
 *     ?redloop@INVCMAP@@QEAAHXZ @ 0x1C02A369C (-redloop@INVCMAP@@QEAAHXZ.c)
 * Callees:
 *     ?blueloop@INVCMAP@@QEAAHH@Z @ 0x1C02A3104 (-blueloop@INVCMAP@@QEAAHH@Z.c)
 */
