/*
 * XREFs of xxxTimersProc @ 0x1C00D7480
 * Callers:
 *     RawInputThread @ 0x1C00D6580 (RawInputThread.c)
 * Callees:
 *     ThreadLockExchangeWorker @ 0x1C003C878 (ThreadLockExchangeWorker.c)
 *     MicrosoftTelemetryAssertTriggeredArgsKM @ 0x1C014083C (MicrosoftTelemetryAssertTriggeredArgsKM.c)
 *     _guard_dispatch_icall_nop @ 0x1C01409C0 (_guard_dispatch_icall_nop.c)
 *     memset_0 @ 0x1C0140D40 (memset_0.c)
 *     ?CoalescableDueTime@@YAKPEBUtagTIMER@@@Z @ 0x1C01BFCE0 (-CoalescableDueTime@@YAKPEBUtagTIMER@@@Z.c)
