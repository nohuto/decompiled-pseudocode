/*
 * XREFs of ?bGetNtoD_Win31@@YAHPEAU_FD_XFORM@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@KQEAU_POINTL@@H@Z @ 0x1C0112414
 * Callers:
 ...
 * Callees:
 *     ?bParityViolatingXform@@YAHPEAVDCOBJ@@@Z @ 0x1C00168F8 (-bParityViolatingXform@@YAHPEAVDCOBJ@@@Z.c)
    ...
    if ( (v12 & 0x3000010) == 0 )
    {
            ...
            v32) )
      {
        ...
        if ( !v33 )
        {
          ...
          a1->eXX = 0.0;
          a1->eYY = 0.0;
          LODWORD(a1->eYX) = dword_1C0319928[x];
          LODWORD(a1->eXY) = dword_1C0319928[a6->y];
          return 1LL;
        }
        v34 = v33 - 1;
        if ( v34 )
        {
          if ( v34 == 1 )
          {
            ...
            a1->eXX = 0.0;
            a1->eYY = 0.0;
            LODWORD(a1->eXY) = dword_1C0319900[y];
            LODWORD(a1->eYX) = dword_1C0319900[a6->x];
          }
          return 1LL;
        }
        v36 = a6->x;
        *(_QWORD *)&a1->eXY = 0LL;
        LODWORD(a1->eXX) = dword_1C0319928[v36];
        v26 = dword_1C0319900[a6->y];
      }
      else
      {
        v25 = a6->x;
        *(_QWORD *)&a1->eXY = 0LL;
        LODWORD(a1->eXX) = dword_1C0319900[v25];
        v26 = dword_1C0319928[a6->y];
      }
      LODWORD(a1->eYY) = v26;
      return 1LL;
    }
  }
  if ( (unsigned int)bGetNtoW_Win31((struct MATRIX *)&v52, a2, a3, (struct DCOBJ *)a4, a5, a7) )
  {
    v13 = *a4;
    v44 = &v46;
    v45 = 0;
