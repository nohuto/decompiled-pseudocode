/*
 * XREFs of ?vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x1C0288240
 * Callers:
...
void __fastcall vDitherColor4bpp(unsigned int *a1, struct _VERTEX_DATA *a2, struct _VERTEX_DATA *a3, unsigned int a4)
{
  ...
  if ( a4 > 2 )
  {
    ...
    *((_DWORD *)v11 + 1) = 255;
    ...
    v53 = v39;
    v54 = v39;
    v14 = (unsigned int *)&unk_1C0328670;
...
LABEL_21:
  ...
  if ( (unsigned int)v20 < v22 )
  {
    ...
    v22 = *(_DWORD *)a2;
    v21 = (char *)a2 + 4;
    v23 = dword_1C0328930[v25];
    v24 = (unsigned int *)&unk_1C0328670;
  }
  else
  {
    v23 = dword_1C0328930[*v19];
    v24 = (unsigned int *)((char *)&unk_1C0328670 + 4 * v20);
  }
  v26 = *v21;
  v39 = v23;
  v40 = v23;
