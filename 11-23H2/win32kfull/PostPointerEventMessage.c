/*
 * XREFs of PostPointerEventMessage @ 0x1C01C2A30
 * Callers:
 *     PostDeviceNotification @ 0x1C0038650 (PostDeviceNotification.c)
 *     PostPointerDeviceInRangeMessage @ 0x1C01525C0 (PostPointerDeviceInRangeMessage.c)
 *     PostPointerDeviceOutOfRangeMessage @ 0x1C01525E0 (PostPointerDeviceOutOfRangeMessage.c)
 * Callees:
