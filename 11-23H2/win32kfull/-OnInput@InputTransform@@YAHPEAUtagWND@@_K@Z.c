/*
 * XREFs of ?OnInput@InputTransform@@YAHPEAUtagWND@@_K@Z @ 0x1C0007A4C
 * Callers:
 ...
 *     InputTransformOnInput @ 0x1C0153270 (InputTransformOnInput.c)
 ...
 *     MagpRemoveTransformOutputMagFac @ 0x1C0085278 (MagpRemoveTransformOutputMagFac.c)
...
__int64 __fastcall InputTransform::OnInput(struct _EX_PUSH_LOCK **this, struct tagWND *a2)
{
  ...
  if ( (unsigned __int8)InputTraceLogging::Enabled(0LL) && (unsigned int)dword_1C0359080 > 5 )
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C0359080, 4LL) )
    {
      v35 = *((_DWORD *)v5 + 21);
      v37 = *((_DWORD *)v5 + 20);
      v38 = *((_DWORD *)v5 + 19);
