/*
 * XREFs of ?xxxFullscreenRestore@CRecalcState@@QEAAXPEAUtagWND@@AEBVCMonitorTopology@@PEAVCRecalcContext@@@Z @ 0x1C0225EB0
 * Callers:
        ...
        struct CRecalcContext *a4)
{
  ...
  {
    v15 = 1;
    Prop = GetProp((__int64)a2, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1LL, v9);
    v24 = 0;
