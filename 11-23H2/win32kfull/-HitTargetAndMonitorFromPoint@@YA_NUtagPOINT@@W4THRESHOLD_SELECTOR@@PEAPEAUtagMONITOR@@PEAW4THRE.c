/*
 * XREFs of ?HitTargetAndMonitorFromPoint@@YA_NUtagPOINT@@W4THRESHOLD_SELECTOR@@PEAPEAUtagMONITOR@@PEAW4THRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01E9628
 * Callers:
...
char __fastcall HitTargetAndMonitorFromPoint(__int64 a1, int a2, __int64 *a3, _DWORD *a4)
{
  ...
  v24 = HIDWORD(a1);
  v7 = a1;
  v8 = MonitorFromPoint(a1, 2LL, 18LL);
  *a3 = v8;
  v9 = *(_QWORD *)(v8 + 40);
  v10 = *(__m128i *)(v9 + 44);
  v26 = *(_OWORD *)(v9 + 28);
  ...
  if ( *(_DWORD *)*gpDispInfo > 1u )
    v11 = (__m128i *)&v26;
  v12 = *v11;
  v13 = *((unsigned __int8 *)&unk_1C03591E0 + 4 * v4 + 2);
  v14 = *((unsigned __int8 *)&unk_1C03591E0 + 4 * v4);
  v15 = *((unsigned __int8 *)&unk_1C03591E0 + 4 * v4 + 3);
  v16 = *((unsigned __int8 *)&unk_1C03591E0 + 4 * v4 + 1);
