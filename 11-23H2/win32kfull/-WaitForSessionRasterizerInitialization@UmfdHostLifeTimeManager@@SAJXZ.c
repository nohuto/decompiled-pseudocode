/*
 * XREFs of ?WaitForSessionRasterizerInitialization@UmfdHostLifeTimeManager@@SAJXZ @ 0x1C0111E2C
 * Callers:
 *     xxxLW_LoadFonts @ 0x1C001A550 (xxxLW_LoadFonts.c)
 *     NtGdiAddFontResourceW @ 0x1C0076AD0 (NtGdiAddFontResourceW.c)
 *     NtGdiWaitForTextReady @ 0x1C009F320 (NtGdiWaitForTextReady.c)
 *     GreWaitForTextReady @ 0x1C00A06A0 (GreWaitForTextReady.c)
