/*
 * XREFs of vInitFontSubTable @ 0x1C03B4F60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( v5 )
  {
    *(_OWORD *)v5 = xmmword_1C0317310;
    *(_OWORD *)(v5 + 16) = xmmword_1C0317320;
    *(_DWORD *)(v5 + 32) = 6684777;
    *(_WORD *)(v5 + 36) = 0;
    v6 = *(_QWORD *)(v2 + 19472);
    *(_OWORD *)(v6 + 64) = xmmword_1C0317338;
    *(_OWORD *)(v6 + 80) = xmmword_1C0317348;
    *(_DWORD *)(v6 + 96) = 4587593;
    *(_WORD *)(v6 + 100) = 0;
    v7 = *(_QWORD *)(v2 + 19472);
    *(_OWORD *)(v7 + 130) = xmmword_1C0317360;
