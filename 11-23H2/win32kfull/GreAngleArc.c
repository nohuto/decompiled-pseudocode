/*
 * XREFs of GreAngleArc @ 0x1C02AB0F8
 * Callers:
 *     NtGdiAngleArc @ 0x1C02C1780 (NtGdiAngleArc.c)
 * Callees:
 ...
 *     ??0EBOX@@QEAA@AEAVEXFORMOBJ@@AEAU_RECTL@@@Z @ 0x1C02C4F30 (--0EBOX@@QEAA@AEAVEXFORMOBJ@@AEAU_RECTL@@@Z.c)
 ...
 *     ?vCosSinPrecise@@YAXVEFLOAT@@PEAV1@1@Z @ 0x1C02C5E90 (-vCosSinPrecise@@YAXVEFLOAT@@PEAV1@1@Z.c)
 */
...
__int64 __fastcall GreAngleArc(HDC a1, int a2, int a3, int a4, unsigned int a5, float a6)
{
  ...
  struct _XFORMOBJ v41[6]; // [rsp+B0h] [rbp-58h] BYREF
