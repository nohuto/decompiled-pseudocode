/*
 * XREFs of ??0?$ObjectLockRecursive@$$V@?$DomainExclusiveRecursive@VDLT_HOOK@@@?$DomainSharedRecursive@$$V@@QEAA@XZ @ 0x1C003FC7C
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_BYTE *)(a1 + 40) = 0;
  do
  {
    ...
    {
      if ( tagDomLock::IsLockedExclusive(v6) || tagDomLock::IsLockedShared(*(PERESOURCE **)v4) )
      {
LABEL_5:
        *(_QWORD *)v4 = 0LL;
        goto LABEL_6;
