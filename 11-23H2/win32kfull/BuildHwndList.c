/*
 * XREFs of BuildHwndList @ 0x1C00B1DD0
 * Callers:
 ...
 *     ?InternalRebuildHwndListForIMEClass@@YAPEAUtagBWL@@PEAU1@@Z @ 0x1C00B2770 (-InternalRebuildHwndListForIMEClass@@YAPEAUtagBWL@@PEAU1@@Z.c)
  ...
  for ( *((_QWORD *)v9 + 1) = (char *)v9 + 32; v8; v8 = (ShellWindowManagement *)*((_QWORD *)v8 + 11) )
  {
      ...
      || (_DWORD)a2 == 16 )
    {
      if ( (v7 & 0x20) == 0
        ...
        || (*((_BYTE *)a2 + 20) & 0x40) != 0
        || !ShellWindowManagement::EligibleWindow((ShellWindowManagement **)v8, a2) )
      {
