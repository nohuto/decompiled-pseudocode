/*
 * XREFs of NtGdiEnumObjects @ 0x1C02D2910
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
      ...
      else
      {
        ...
        v11 = (char *)&unk_1C0329350 + 4 * v9;
        v12 = a2 - 1;
        if ( v12 )
        {
          if ( v12 == 1 )
          {
            for ( i = (char *)&unk_1C0329350; i < v11; i += 4 )
            {
              *v4 = 0;
              v4[1] = *(_DWORD *)i;
              *((_QWORD *)v4 + 1) = 0LL;
            ...
            for ( j = (unsigned int *)&unk_1C03293A0; j < (unsigned int *)"Windows! Windows! Windows!"; ++j )
            {
              for ( k = (char *)&unk_1C0329350; k < v11; k += 4 )
              {
                *v4 = 2;
                v4[1] = *(_DWORD *)k;
                *((_QWORD *)v4 + 1) = *j;
        ...
        {
          for ( m = &unk_1C0329338; m < &dword_1C032934C; ++m )
          {
            for ( n = (char *)&unk_1C0329350; n < v11; n += 4 )
            {
              v4[1] = 0;
              v4[2] = 0;
              *v4 = *m;
