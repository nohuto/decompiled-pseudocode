/*
 * XREFs of SetupClassAtoms @ 0x1C008E720
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 SetupClassAtoms()
{
  ...
  *((_WORD *)&WPP_MAIN_CB.AlignmentRequirement + 2) = UserAddAtomEx(L"SysCP", 1LL, 2LL);
  v8 = *((_WORD *)&WPP_MAIN_CB.AlignmentRequirement + 2) != 0 && v7;
  ...
  *(_WORD *)&WPP_MAIN_CB.DeviceQueue.Busy = UserAddAtomEx(L"SysDWM", 1LL, 2LL);
  ...
  v17 = WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc) != 0;
  ...
  v18 = LOWORD(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc) != 0 && CHwndTargetProp::s_atom != 0 && v16 & v17;
