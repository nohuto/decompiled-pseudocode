/*
 * XREFs of ??0SPRITEDDIACCESS@@QEAA@AEAVPDEVOBJ@@@Z @ 0x1C00F73B0
 * Callers:
 ...
 *     ?pSpCreateSprite@@YAPEAVSPRITE@@PEAUHDEV__@@PEAU_RECTL@@PEAUHWND__@@PEAU_POINTL@@@Z @ 0x1C006B744 (-pSpCreateSprite@@YAPEAVSPRITE@@PEAUHDEV__@@PEAU_RECTL@@PEAUHWND__@@PEAU_POINTL@@@Z.c)
 *     ?vSpZorderSprite@@YAXPEAUHDEV__@@PEAVSPRITE@@1@Z @ 0x1C006BCE4 (-vSpZorderSprite@@YAXPEAUHDEV__@@PEAVSPRITE@@1@Z.c)
 ...
 *     ?vSpHideSprites@@YAXPEAUHDEV__@@H@Z @ 0x1C009A904 (-vSpHideSprites@@YAXPEAUHDEV__@@H@Z.c)
  ...
  *((_DWORD *)this + 3) = 0;
  if ( v5 && PDEVOBJ::bAllowShareAccess(a2) && (*(_DWORD *)(v5 + 104) || *(_DWORD *)(v5 + 108)) )
  {
    ...
    if ( *(_QWORD *)(*(_QWORD *)(v7 + 280) + 32LL) == *(_QWORD *)this )
      v9 = **(_DWORD **)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280);
    else
      v9 = 0;
    *((_DWORD *)this + 2) = v9;
...
LABEL_19:
  ...
  if ( *((_DWORD *)this + 3) == 1 )
  {
    v43 = *(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280);
