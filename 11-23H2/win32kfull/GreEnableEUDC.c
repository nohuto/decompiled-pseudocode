/*
 * XREFs of GreEnableEUDC @ 0x1C001BD38
 * Callers:
 *     NtGdiEnableEudc @ 0x1C001BD20 (NtGdiEnableEudc.c)
 *     ?CleanUpEUDC@@YAXXZ @ 0x1C001BF44 (-CleanUpEUDC@@YAXXZ.c)
 * Callees:
 *     bAddAllFlEntry @ 0x1C001ADEC (bAddAllFlEntry.c)
 *     ?GetSessionTextStackStatus@UmfdHostLifeTimeManager@@SAJXZ @ 0x1C001BEB4 (-GetSessionTextStackStatus@UmfdHostLifeTimeManager@@SAJXZ.c)
 ...
 *     ?bSetupDefaultFlEntry@@YAHXZ @ 0x1C029DB3C (-bSetupDefaultFlEntry@@YAHXZ.c)
 */
