/*
 * XREFs of ?ExtTextOutRect@@YAHAEAVXDCOBJ@@PEAUtagRECT@@AEBUTag@RFONTOBJ@@@Z @ 0x1C00C363C
 * Callers:
...
__int64 __fastcall ExtTextOutRect(struct XDCOBJ *this, struct tagRECT *a2, const struct RFONTOBJ::Tag *a3)
{
  ...
  if ( !*(_QWORD *)this || (*(_DWORD *)(*(_QWORD *)this + 36LL) & 0x10000) != 0 )
    return 0;
  EXFORMOBJ::vQuickInit((EXFORMOBJ *)&v37, this, -2147483132);
  v6 = 1;
  v7 = *(_DWORD *)(v37 + 32);
  if ( (v7 & 1) == 0 )
      ...
      && (unsigned __int64)(v17 + SHIDWORD(v39) + 0x80000000LL) <= 0xFFFFFFFF )
    {
      ...
      *(_QWORD *)((char *)&v39 + 4) = __PAIR64__(v19, v21);
      ...
      if ( (v23 & 1) != 0 && (v23 & 2) == 0 )
      {
        ...
        do
        {
          if ( !(unsigned int)bFToL((float)*v35 * *(float *)(v13 + 524), (int *)&v39 + (unsigned int)v18, 6u) )
            break;
          LODWORD(v18) = v18 + 1;
          ++v35;
        }
