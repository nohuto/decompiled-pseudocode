/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C00CB23C
 * Callers:
 ...
 * Callees:
 *     IsAnyCharsetDbcs @ 0x1C00CB66C (IsAnyCharsetDbcs.c)
 *     ?dpNtmi@PFEOBJ@@QEAAKXZ @ 0x1C00CB6C8 (-dpNtmi@PFEOBJ@@QEAAKXZ.c)
