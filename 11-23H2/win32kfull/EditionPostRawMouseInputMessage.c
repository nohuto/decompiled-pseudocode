/*
 * XREFs of EditionPostRawMouseInputMessage @ 0x1C014F070
 * Callers:
        ...
        struct tagRAWMOUSE *a5)
{
  ...
  v13 = 1;
  if ( v10 )
    v12 = *(_QWORD *)(*(_QWORD *)(PtiMouseFromQ(*v9) + 424) + 856LL);
  v14 = (struct tagQ *)v10;
  ...
  v15 = 0LL;
  v16 = *(struct tagWND **)(*(_QWORD *)(*(_QWORD *)(PtiMouseFromQ(v10) + 424) + 856LL) + 64LL);
  if ( v16 )
      ...
      if ( (*((_DWORD *)v22 + 25) & 4) != 0 )
      {
        ...
        if ( v23 )
        {
          ...
          if ( *(char *)(v24 + 20) >= 0 && *(char *)(v24 + 19) >= 0 )
          {
            ...
            {
              if ( (unsigned __int8)CheckAccess(*(_QWORD *)(v25 + 424) + 896LL, &v32)
