/*
 * XREFs of _anonymous_namespace_::xxxMigrateWindowCheckpoint @ 0x1C023C18C
 * Callers:
        ...
        int *a6)
{
  ...
  if ( v14 )
  {
    v16 = *(__m128i *)anonymous_namespace_::xxxNormalizeRect((struct tagWND *)&v46, a1, &a2->left, v45, v14, 0);
