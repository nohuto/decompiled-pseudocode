/*
 * XREFs of ?CreateEdgePalmRejectionZones@PalmRejection@@YAHPEAX@Z @ 0x1C01E6A20
 * Callers:
 *     EditionCreateEdgePalmRejectionZones @ 0x1C01E6CD0 (EditionCreateEdgePalmRejectionZones.c)
 * Callees:
