/*
 * XREFs of ?bComputeGISET@@YAHPEAU_IFIMETRICS@@PEAVPFE@@PEAPEAU_GISET@@@Z @ 0x1C00CB7CC
 * Callers:
 ...
 *     ?cComputeGISET@@YAKPEBGKPEAU_GISET@@K@Z @ 0x1C00CBB64 (-cComputeGISET@@YAKPEBGKPEAU_GISET@@K@Z.c)
      ...
      if ( v11 <= 0xFFFFFFFF )
      {
        ...
        if ( (_DWORD)v11 )
        {
          ...
          if ( v12 )
          {
            ...
            if ( 4 * v19 == -8
              || (v20 = (struct _GISET *)Win32AllocPoolZInit(4 * v19 + 8, 1936484167LL), (v21 = v20) == 0LL) )
            {
LABEL_42:
              v5 = 0;
            }
