/*
 * XREFs of ?vAddEndCap@WIDENER@@IEAAXXZ @ 0x1C015D810
 * Callers:
 ...
 *     ?vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z @ 0x1C015DACE (-vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z.c)
 *     ?vecInDraw@WIDENER@@IEAA?AVEVECTORFX@@XZ @ 0x1C015DF0E (-vecInDraw@WIDENER@@IEAA-AVEVECTORFX@@XZ.c)
