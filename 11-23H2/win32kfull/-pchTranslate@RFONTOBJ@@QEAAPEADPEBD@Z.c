/*
 * XREFs of ?pchTranslate@RFONTOBJ@@QEAAPEADPEBD@Z @ 0x1C02B662C
 * Callers:
 *     ?pjTable@RFONTOBJ@@QEAAPEAEKPEAK@Z @ 0x1C02B68E8 (-pjTable@RFONTOBJ@@QEAAPEAEKPEAK@Z.c)
 *     ?pvFile@RFONTOBJ@@QEAAPEAXPEAK@Z @ 0x1C02B6998 (-pvFile@RFONTOBJ@@QEAAPEAXPEAK@Z.c)
 * Callees:
 *     ?MapFontFileInKernel@@YAJPEAXPEAPEAX@Z @ 0x1C02B5C80 (-MapFontFileInKernel@@YAJPEAXPEAPEAX@Z.c)
