/*
 * XREFs of ?vNextStyleEvent@STYLER@@QEAAXXZ @ 0x1C02F24EC
 * Callers:
 *     ?bWiden@WIDENER@@IEAAHXZ @ 0x1C015D470 (-bWiden@WIDENER@@IEAAHXZ.c)
 * Callees:
 *     ?efNextStyleLength@STYLER@@IEAA?AVEFLOAT@@XZ @ 0x1C015D6FC (-efNextStyleLength@STYLER@@IEAA-AVEFLOAT@@XZ.c)
 ...
 *     ?efWorldLength@STYLER@@IEAA?AVEFLOAT@@VEVECTORFX@@@Z @ 0x1C02F16E0 (-efWorldLength@STYLER@@IEAA-AVEFLOAT@@VEVECTORFX@@@Z.c)
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C02F1FF8 (-vNextEvent@LINER@@QEAAXXZ.c)
 */
