/*
 * XREFs of ?xxxRemoveDeleteMenuHelper@@YAHAEBV?$SmartObjStackRef@UtagMENU@@@@IKH@Z @ 0x1C00E5ED8
 * Callers:
...
__int64 __fastcall xxxRemoveDeleteMenuHelper(__int64 a1, unsigned int a2, __int16 a3, int a4)
{
  ...
  *(_QWORD *)(v9 + 1512) = &v36;
  ...
  if ( a2 >= 0xFFFFF000 && !v13 )
  {
    ...
    if ( !v25 )
      v25 = *(_QWORD *)v38[0];
    v14 = MNLookUpItem(v25, (unsigned __int16)a2, 0, &v33);
    v39 = 0LL;
    SmartObjStackRefBase<tagMENU>::operator=(v38, v33);
    if ( v14 )
    {
LABEL_52:
      ...
      *(_DWORD *)(*(_QWORD *)v38[0] + 68LL) = 0;
      ...
      {
        RtlFreeHeap(*(PVOID *)(*(_QWORD *)(*(_QWORD *)v38[0] + 24LL) + 136LL), 0, *(PVOID *)(v19 + 96));
        ...
        && (unsigned int)IsWindowDesktopComposed(*(_QWORD *)(*(_QWORD *)v38[0] + 80LL)) )
      {
        ...
        v32 = (void *)ReferenceDwmApiPort(v29, *(_QWORD *)v38[0]);
