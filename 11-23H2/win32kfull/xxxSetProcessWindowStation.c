/*
 * XREFs of xxxSetProcessWindowStation @ 0x1C0073E60
 * Callers:
 *     EditionSetProcessWindowStationEntryPoint @ 0x1C0073D90 (EditionSetProcessWindowStationEntryPoint.c)
 * Callees:
...
__int64 __fastcall xxxSetProcessWindowStation(HANDLE SourceHandle, __int64 a2, __int64 a3)
{
      ...
      if ( (_DWORD *)v15 != v13 )
      {
        ...
        if ( v27 && *(_QWORD *)(*(_QWORD *)(v27 + 16) + 424LL) == v10 )
        {
          ...
          else
          {
            ...
            v43 = 0LL;
            v45 = 0LL;
            PushW32ThreadLock(v13, &v43, UserDereferenceObject);
            ThreadLockAlways(*(_QWORD *)(*(_QWORD *)(v10 + 664) + 112LL), &v45);
            xxxDisownClipboard(*(struct tagWND **)(*(_QWORD *)(v10 + 664) + 112LL));
            ThreadUnlock1(v37, v36, v38);
            ThreadWin32Thread = W32GetThreadWin32Thread(KeGetCurrentThread());
            *(_QWORD *)(ThreadWin32Thread + 16) = v43;
          }
        }
        v28 = *(_QWORD *)(v10 + 664) + 96LL;
        if ( *(_QWORD *)v28 && *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v28 + 16LL) + 424LL) == v10 )
        {
          HMAssignmentUnlock(v28);
          *(_QWORD *)(*(_QWORD *)(v10 + 664) + 80LL) = 0LL;
        }
        v29 = *(_QWORD *)(v10 + 664);
        v30 = *(_QWORD *)(v29 + 80);
        if ( v30 && *(_QWORD *)(v30 + 424) == v10 )
          *(_QWORD *)(v29 + 80) = 0LL;
        v31 = *(_QWORD *)(v10 + 664) + 104LL;
        if ( *(_QWORD *)v31 && *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v31 + 16LL) + 424LL) == v10 )
          HMAssignmentUnlock(v31);
        v32 = (PVOID *)(*(_QWORD *)(v10 + 664) + 152LL);
        while ( 1 )
        {
          v33 = *v32;
          if ( !*v32 )
  ...
  if ( *(HANDLE *)(v10 + 672) != SourceHandle )
  {
  ...
  LockObjectAssignment(v10 + 664, v13);
  ObfDereferenceObject(v13);
  *(_QWORD *)(v10 + 672) = SourceHandle;
  ...
  v17 = *(_DWORD *)(v10 + 12);
  *(_DWORD *)(v10 + 680) = HandleAttributes.GrantedAccess;
  v18 = v17;
  v19 = v17 & 0xFFFBFFFF;
  v20 = v18 | 0x40000;
  if ( (v13[16] & 4) == 0 )
