/*
 * XREFs of ?HKAddChildHotkey@@YA_NPEAUtagTHREADINFO@@PEAUtagHOTKEY@@PEAUtagWND@@HGPEAUHWND__@@@Z @ 0x1C0097748
 * Callers:
  ...
  if ( (a5 & 0xBF7F) == 0 )
  {
    ...
    for ( i = (char *)*((_QWORD *)a2 + 7); ; i = *(char **)i )
    {
      if ( i == v10 )
      {
        ...
        *v16 = v15;
        *((_QWORD *)v10 + 1) = v15;
        NotifyHotKeyRegistrationChanged(a2, (struct tagCHILDHOTKEY *const)v14, 1u);
        return 1;
      }
