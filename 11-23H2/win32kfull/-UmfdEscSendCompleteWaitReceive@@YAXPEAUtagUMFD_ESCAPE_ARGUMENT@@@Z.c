/*
 * XREFs of ?UmfdEscSendCompleteWaitReceive@@YAXPEAUtagUMFD_ESCAPE_ARGUMENT@@@Z @ 0x1C00D0D50
 * Callers:
 ...
 *     ?UmfdCreateRequestContext@@YAPEAXXZ @ 0x1C00D2E9C (-UmfdCreateRequestContext@@YAPEAXXZ.c)
 ...
 *     ?Complete@CWaitableWorkItem@CMultipleConsumerWorkQueue@@QEAAXXZ @ 0x1C0306A10 (-Complete@CWaitableWorkItem@CMultipleConsumerWorkQueue@@QEAAXXZ.c)
 *     ?QueueWorkItem@CWorkItemQueue@@QEAA_NQEAVCWorkItem@1@@Z @ 0x1C0306A48 (-QueueWorkItem@CWorkItemQueue@@QEAA_NQEAVCWorkItem@1@@Z.c)
 */
            ...
            else if ( !*(_BYTE *)*v42 )
            {
              *((_DWORD *)v19 + 2) = 3;
                                   ...
                                   0LL) == 192 )
              {
                ...
                v23 = CWorkItemQueue::DequeueWorkItem((union _SLIST_HEADER *)v24);
                goto LABEL_41;
              }
