/*
 * XREFs of ?bSrcCopySRLE4D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02EEB10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSrcCopySRLE4D1(struct BLTINFO *a1)
{
  ...
  v16 = byte_1C03198D8[(v13 & 7) + 8];
  v59 = (unsigned int)(v8 - 1) >> 3;
  v17 = v62;
  v70 = ~byte_1C03198D8[(v8 & 7) + 8];
  if ( v5 >= v6 )
    goto LABEL_10;
  if ( v9 >= v13 )
  {
    if ( v9 < v8 )
    {
      v15 = byte_1C03198D8[(v9 & 7) + 8] & *(_BYTE *)((unsigned int)(v9 >> 3) + v3);
      v13 = v57;
      goto LABEL_10;
    }
    goto LABEL_8;
  ...
  for ( i = v21 <= v17; ; i = v21 <= v62 )
  {
    ...
    if ( v23 )
    {
      if ( v5 < v58 && v9 < v8 && (int)(v23 + v9) > v13 )
      {
        ...
        if ( (int)v50 < (int)v53 )
        {
          *(_BYTE *)(v25 + v3) = v15 | ((unsigned __int8)(v48 & byte_1C03198D8[v50 + 9]) >> v71);
          LODWORD(v49) = v69;
          if ( (v69 & 1) == 0 )
          {
            v48 *= 2;
    ...
    if ( v5 < v58 && (v9 & 7) != 0 )
    {
      ...
      {
        *(_BYTE *)(v25 + v3) = v15 | *(_BYTE *)(v25 + v3) & ~byte_1C03198D8[(v9 & 7) + 8];
        goto LABEL_72;
      }
  ...
  if ( (_DWORD)v26 != 1 )
  {
    if ( (_DWORD)v26 != 2 )
    {
      ...
      else
      {
        if ( v9 >= v13 )
        {
          v30 = byte_1C03198D8[(unsigned __int8)(7 - (v9 & 7)) + 24];
        }
        else
        {
          v29 = v13 - v9;
          ...
          LODWORD(v26) = v26 - v29;
          v30 = byte_1C03198D8[(unsigned __int8)(7 - (v13 & 7)) + 24];
          if ( (v29 & 1) != 0 )
          {
            v31 = *v2;
            v32 = v15 | v30;
...
LABEL_56:
      ...
      else
      {
        if ( v9 < v8 )
        {
          *(_BYTE *)((unsigned int)v25 + v3) = v15 | *(_BYTE *)((unsigned int)v25 + v3) & ~byte_1C03198D8[(v9 & 7) + 8];
          v42 = v58;
          goto LABEL_56;
        }
LABEL_53:
