/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qqDqqqDqqDqqqD @ 0x1C0150860
 * Callers:
        ...
        char a22)
{
  ...
  {
    LOWORD(v25) = 27;
    return WppAutoLogTrace(v22, 4LL, 18LL, &WPP_0bd01f6e78ca3341e624bb2278b12953_Traceguids, v25, &a9, 8LL, &a10);
  }
  return result;
}
