/*
 * XREFs of GetLocalMachineRegistryDWORDValues @ 0x1C00D94E0
 * Callers:
 *     EditionOverrideUserTouchGestureSettings @ 0x1C00D9490 (EditionOverrideUserTouchGestureSettings.c)
 *     ?_ReadSettingsFromRegKey@PalmRejection@@YAXXZ @ 0x1C01E6BD8 (-_ReadSettingsFromRegKey@PalmRejection@@YAXXZ.c)
 * Callees:
 *     ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C00D992C (-RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z.c)
