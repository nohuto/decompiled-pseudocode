/*
 * XREFs of zzzUpdateCursorImage @ 0x1C00F0570
 * Callers:
...
void zzzUpdateCursorImage()
{
  ...
  if ( !gpqForeground
    || ((v4 = *(_QWORD *)(gpqForeground + 112LL)) != 0
     ...
     || (v6 = *(_QWORD *)(v5 + 424)) == 0
     || !*(_QWORD *)(v6 + 856)
     || (*(_DWORD *)(*(_QWORD *)(v6 + 856) + 100LL) & 0x100) == 0
  ...
  if ( (struct tagCURSOR *)v1 != gpcurLogCurrent )
  {
    if ( v1 && (*(_DWORD *)(v1 + 80) & 8) != 0 && *(_QWORD *)(v1 + 112) )
    {
      if ( !WPP_MAIN_CB.DeviceQueue.Lock )
      {
        *(_DWORD *)(v1 + 120) = 0;
        ...
        WPP_MAIN_CB.DeviceQueue.Lock = SetRITTimer(
    ...
    {
      FindTimer(0LL, WPP_MAIN_CB.DeviceQueue.Lock, 4u, 1, 0LL);
...
LABEL_33:
  ...
  v22 = (v21 & 0x20) != 0;
  if ( v22 != byte_1C035F108 )
  {
    byte_1C035F108 = (v21 & 0x20) != 0;
