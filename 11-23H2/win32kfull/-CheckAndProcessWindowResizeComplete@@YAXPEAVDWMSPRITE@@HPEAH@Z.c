/*
 * XREFs of ?CheckAndProcessWindowResizeComplete@@YAXPEAVDWMSPRITE@@HPEAH@Z @ 0x1C0264EC4
 * Callers:
 ...
 *     DwmCheckForDeferredUpdateSpriteCommands @ 0x1C026D5BC (DwmCheckForDeferredUpdateSpriteCommands.c)
 */
