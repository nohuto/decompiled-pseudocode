/*
 * XREFs of zzzUpdateWindowsAfterModeChange @ 0x1C00A47A4
 * Callers:
        ...
        && (a1 || (unsigned int)IsWindowDesktopComposed(v7)) )
      {
        *(_DWORD *)(v7 + 320) &= ~0x20000u;
        ...
        if ( (unsigned int)GreIsReusedDeviceDependentBitmap(RedirectionBitmap) )
          a2 = 1;
        v21 = a2;
        RecreateRedirectionBitmap((struct tagWND *)v7, 0, 0, a2, 0, &v23);
        ...
        if ( v23 )
        {
          ...
          DeleteOrSetRedirectionBitmap(v7, v23, 1);
        }
        if ( !v15 )
        {
LABEL_33:
...
LABEL_4:
  ...
  return zzzEndDeferWinEventNotify(v17);
}
