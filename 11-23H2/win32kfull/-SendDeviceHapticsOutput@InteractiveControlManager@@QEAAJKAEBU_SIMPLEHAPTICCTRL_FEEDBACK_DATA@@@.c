/*
 * XREFs of ?SendDeviceHapticsOutput@InteractiveControlManager@@QEAAJKAEBU_SIMPLEHAPTICCTRL_FEEDBACK_DATA@@@Z @ 0x1C0240B58
 * Callers:
        ...
        __int64 a4)
{
  ...
  do
  {
    ...
    if ( *v8 && (!a2 || a2 == *((_DWORD *)v10 + 2)) )
    {
      ...
      v4 = v11;
      if ( v11 < 0 && (unsigned int)dword_1C0354150 > 2 )
      {
        LODWORD(v14) = v11;
