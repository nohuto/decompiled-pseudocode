/*
 * XREFs of ?DxLddmSharedPrimaryUnLockNotification@@YAJU_LUID@@I@Z @ 0x1C026E150
 * Callers:
 *     NtGdiDdDDISharedPrimaryUnLockNotification @ 0x1C026F8E0 (NtGdiDdDDISharedPrimaryUnLockNotification.c)
 * Callees:
