/*
 * XREFs of ?s_xxxOnWindowRestoreFromMinimized@CRecalcProp@@SA_NPEAUtagWND@@_NPEA_NPEAKPEAUtagRECT@@@Z @ 0x1C0015D98
 * Callers:
        ...
        struct tagRECT *a5)
{
  ...
  if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 31LL) & 0x20) == 0 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 2097LL);
  *a3 = 0;
  *a5 = 0LL;
  ...
  if ( v23 )
  {
    v18 = *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2);
    *a3 = v23;
    *a4 = v22;
