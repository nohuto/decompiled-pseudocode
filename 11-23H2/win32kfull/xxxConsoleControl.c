/*
 * XREFs of xxxConsoleControl @ 0x1C0042DE8
 * Callers:
...
__int64 __fastcall xxxConsoleControl(int a1, struct _CONSOLE_PROCESS_INFO *a2, int a3)
{
  ...
  if ( !v7 )
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 5424LL);
    v19 = -1073741637;
    if ( a3 != 24 )
      return (unsigned int)-1073741811;
    return v19;
  ...
  if ( v10 )
  {
    ...
    if ( a3 == 16 )
    {
      ...
      {
        v30 = (_DWORD *)(*((_QWORD *)v28 + 37) + *(_QWORD *)(*v29 + 136LL));
      }
      else
      {
