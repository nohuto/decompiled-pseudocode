/*
 * XREFs of ?_GetWindowCompositionVisualBitmap@@YAJPEAUtagWND@@PEAPEAUCompositionObject@@@Z @ 0x1C0015414
 * Callers:
 ...
 * Callees:
 *     ??$CreateWindowProp@VCHwndBitmapProp@@@CWindowProp@@SAJPEAPEAVCHwndBitmapProp@@@Z @ 0x1C00154C0 (--$CreateWindowProp@VCHwndBitmapProp@@@CWindowProp@@SAJPEAPEAVCHwndBitmapProp@@@Z.c)
 *     ?Initialize@CHwndBitmapProp@@QEAAJXZ @ 0x1C001551C (-Initialize@CHwndBitmapProp@@QEAAJXZ.c)
