/*
 * XREFs of DestroyThreadHidObjects @ 0x1C0037B50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HasRawKeyboardPerThreadRegistration@@YAHPEBUtagPROCESSINFO@@@Z @ 0x1C01A8EF0 (-HasRawKeyboardPerThreadRegistration@@YAHPEBUtagPROCESSINFO@@@Z.c)
 */
