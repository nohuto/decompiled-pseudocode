/*
 * XREFs of CreateFontFromUserProfile @ 0x1C00D0578
 * Callers:
 ...
 *     GreSetLFONTOwner @ 0x1C00D0680 (GreSetLFONTOwner.c)
...
struct HLFONT__ *__fastcall CreateFontFromUserProfile(struct _UNICODE_STRING *a1, _DWORD *a2, unsigned int a3)
{
  ...
  if ( FontIndirectW )
  {
    ...
    if ( (unsigned int)GreExtGetObjectW((HBRUSH)FontIndirectW, 92LL, (__int64)&v16) && v16.lfHeight == *a2 )
    {
