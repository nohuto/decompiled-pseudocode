/*
 * XREFs of ?vPatXorRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02E6D00
 * Callers:
 *     <none>
 * Callees:
 *     vFetchAndMerge @ 0x1C0005A84 (vFetchAndMerge.c)
 *     vFetchShiftAndMerge @ 0x1C0303780 (vFetchShiftAndMerge.c)
 */
  ...
  *((_QWORD *)&v24 + 1) = v11;
  if ( a3 )
  {
    do
    {
      ...
      {
        LODWORD(v25) = v23;
        *(_DWORD *)(v19 + v8) ^= v20 & v27 & *(_DWORD *)(v23 + v11);
      }
      else
      {
        if ( (_DWORD)v18 )
        {
          LODWORD(v25) = v23;
          *(_DWORD *)(v19 + v8) ^= v20 & *(_DWORD *)(v23 + v11);
          LODWORD(v19) = v19 + 4;
          v21 = *((_DWORD *)a1 + 10);
          v23 += 4;
        }
        ...
        if ( (unsigned int)(v16 - v19) >= 4 )
        {
          ...
          *(_QWORD *)&v25 = __PAIR64__(v21, v23);
          ...
          {
            vFetchShiftAndMerge(&v24);
          }
          else
          {
            HIDWORD(v25) = v21 >> 2;
            vFetchAndMerge((__int64)&v24);
          }
          v11 = *((_QWORD *)&v24 + 1);
        }
        if ( v28 )
        {
          ...
          *(_DWORD *)(v16 + v8) ^= v27 & *(_DWORD *)((unsigned int)v25 + v11);
        }
      }
      if ( ++v10 == *((_DWORD *)a1 + 11) )
      {
