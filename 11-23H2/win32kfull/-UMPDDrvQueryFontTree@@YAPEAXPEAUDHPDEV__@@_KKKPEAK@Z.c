/*
 * XREFs of ?UMPDDrvQueryFontTree@@YAPEAXPEAUDHPDEV__@@_KKKPEAK@Z @ 0x1C02BC0D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bIsFreeHooked@@YAHPEAUDHPDEV__@@PEAVUMPDOBJ@@@Z @ 0x1C02BE654 (-bIsFreeHooked@@YAHPEAUDHPDEV__@@PEAVUMPDOBJ@@@Z.c)
 */
  ...
  if ( v37 )
  {
    ...
    if ( (unsigned int)UMPDOBJ::Thunk(v10, v31, 0x48u, &v26, Size) != -1 )
    {
      ...
      if ( v26 )
      {
        ...
        v16 = (char *)v39;
        *a5 = *(_DWORD *)KernelPtr;
        if ( !*((_DWORD *)v10 + 110) || !v16 || !v38 )
          v12 = 0;
        v17 = UMPDOBJ::GetKernelPtr((char **)v10, v16);
        if ( a4 == 3 )
        {
          if ( (unsigned int)UMPDOBJ::bSandboxedClient(v10) && (v18 = *((_QWORD *)v10 + 51)) != 0 )
            v19 = *(_QWORD *)(v18 + 48);
          else
            v19 = 0LL;
          if ( v12 )
