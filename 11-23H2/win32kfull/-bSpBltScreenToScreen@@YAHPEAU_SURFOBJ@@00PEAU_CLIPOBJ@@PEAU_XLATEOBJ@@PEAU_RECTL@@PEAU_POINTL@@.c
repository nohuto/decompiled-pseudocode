/*
 * XREFs of ?bSpBltScreenToScreen@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C027D220
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  *(_QWORD *)&v54.left = 0LL;
  v55 = 0LL;
  UNDOW32THREADPIDLOCKS::vUndo((UNDOW32THREADPIDLOCKS *)&v54);
  ...
  if ( (unsigned int)UNDOW32THREADPIDLOCKS::bRedo((__int64 **)&v54) )
  {
...
LABEL_24:
    ...
    PIDLOCKSPRITEAREA::vLock((PIDLOCKSPRITEAREA *)v94, v18, &v54);
    if ( v94[0] )
    {
      v34 = v52;
      ENUMAREAS::ENUMAREAS((ENUMAREAS *)v84, v18, v12, v52, &v54);
      v73 = 0LL;
      if ( !v85 )
        goto LABEL_102;
      while ( 1 )
      {
        v64 = ENUMAREAS::bEnum((ENUMAREAS *)v84, &v62, &v72);
        ...
        do
        {
          if ( v62 )
          {
            ...
            v68 = (struct _POINTL *)((char *)v62 + 168);
          }
          else
          {
            v35 = v77;
            v68 = (struct _POINTL *)&v73;
          }
          v74 = v35;
          ...
          do
          {
            v37 = ENUMAREAS::bEnum((ENUMAREAS *)v86, &v65, &v90);
            v38 = v65;
            v63 = v37;
            while ( (unsigned int)ENUMAREAS::bEnumLayers((ENUMAREAS *)v86, &v75) )
              v38 = v75;
            v65 = v38;
            if ( v38 )
            {
              v39 = (struct _SURFOBJ *)*((_QWORD *)v38 + 20);
              v67 = (struct _POINTL *)((char *)v38 + 168);
            }
            else
            {
              v39 = v77;
              v67 = (struct _POINTL *)&v73;
            }
            v89.left = v59 + v90.left;
            v89.right = v59 + v90.right;
            *(_QWORD *)&v54.left = v39;
            v89.top = v36 + v90.top;
            ...
            if ( !v51 )
            {
              ...
              if ( ThreadWin32Thread )
              {
                if ( (*(_DWORD *)(ThreadWin32Thread + 328) & 1) != 0 )
                {
                  ...
                  v69 = XDCOBJ::prgnEffRao(v45);
                  if ( (*(_DWORD *)(v47 + 40) & 0x20000) != 0 )
                  {
                    v53.x = -v58.x;
                    v53.y = -v58.y;
                    RGNOBJ::bOffset((RGNOBJ *)&v69, &v53);
                    v57 = 1;
                  }
            ...
            if ( NEEDDDILOCK::bRender((NEEDDDILOCK *)&p_pvScan0, &v51) )
            {
              if ( a11 != 52428 )
              {
                if ( v83 )
                {
                  LODWORD(v66) = v89.left + v83->x - v12->left;
                  HIDWORD(v66) = v89.top + v83->y - v12->top;
                }
                *(_QWORD *)&v54.left = v51;
                if ( v35->iType != 1 )
                  goto LABEL_83;
...
LABEL_83:
              ...
              INVOKEOFFCOPYBITS(v68, v35, v67, v39, v51, v76, &v89, (struct _POINTL *)&v90);
            }
LABEL_87:
            if ( v56 == 1 )
            {
