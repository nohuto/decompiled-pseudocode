/*
 * XREFs of ?DdcciGetCapabilitiesStringLength@CMonitorAPI@@QEAAJPEAXPEAK@Z @ 0x1C0268D14
 * Callers:
 *     NtGdiDDCCIGetCapabilitiesStringLength @ 0x1C0269A10 (NtGdiDDCCIGetCapabilitiesStringLength.c)
 * Callees:
