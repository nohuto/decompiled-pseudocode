/*
 * XREFs of ?InternalSetClipboardData@@YAHPEAUtagWINDOWSTATION@@IPEAXHH@Z @ 0x1C01FB874
 * Callers:
...
LABEL_13:
  ...
  *((_DWORD *)v10 + 5) = *(_DWORD *)(CurrentProcessWin32Process + 896);
  v18 = PsGetCurrentProcessWin32Process(v17);
  if ( v18 )
    v18 &= -(__int64)(*(_QWORD *)v18 != 0LL);
  *((_DWORD *)v10 + 6) = *(_DWORD *)(v18 + 900);
  if ( a5 )
  {
    *((_DWORD *)a1 + 16) |= 0x40u;
