/*
 * XREFs of ?xxxMNPositionHierarchy@@YAIAEBV?$SmartObjStackRef@UtagPOPUPMENU@@@@PEAUtagITEM@@HHPEAH2PEAPEAUtagMONITOR@@@Z @ 0x1C0215824
 * Callers:
...
LABEL_16:
    ...
    v27 = MonitorFromRect((__int64)&v52, 1LL, 0LL);
    v28 = *a1;
    v29 = v27;
    v46 = v27;
  ...
  v33 = _MonitorFromWindowInternal(*(struct tagWND **)(**a1 + 16), 1LL, 0LL);
  v34 = *a1;
  v35 = (__int64)v33;
  v46 = (__int64)v33;
