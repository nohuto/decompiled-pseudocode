/*
 * XREFs of DwmSyncFlushForceRenderAndWaitForBatch @ 0x1C026D620
 * Callers:
 *     DwmSyncFlushWindowChanges @ 0x1C026D710 (DwmSyncFlushWindowChanges.c)
 * Callees:
 *     ?DwmSyncLPCAllowed@@YAJXZ @ 0x1C008F300 (-DwmSyncLPCAllowed@@YAJXZ.c)
 *     ?SyncLpcCheckNtStatus@@YAJJPEAU_PORT_MESSAGE@@@Z @ 0x1C008F330 (-SyncLpcCheckNtStatus@@YAJJPEAU_PORT_MESSAGE@@@Z.c)
 */
