/*
 * XREFs of xxxSwitchDesktopWithFade @ 0x1C0091F0C
 * Callers:
 *     NtUserSwitchDesktop @ 0x1C0091DC0 (NtUserSwitchDesktop.c)
 * Callees:
 *     xxxSwitchDesktop @ 0x1C002C52C (xxxSwitchDesktop.c)
 *     PrepareGammaRampData @ 0x1C0092090 (PrepareGammaRampData.c)
 *     RestoreGammaRamp @ 0x1C0092250 (RestoreGammaRamp.c)
 *     PushW32ThreadLock @ 0x1C00AD510 (PushW32ThreadLock.c)
 *     W32GetThreadWin32Thread @ 0x1C011E7DC (W32GetThreadWin32Thread.c)
 *     FadeDesktop @ 0x1C01BE150 (FadeDesktop.c)
 */
...
__int64 __fastcall xxxSwitchDesktopWithFade(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, int a5)
{
  ...
  if ( !gfIsFadingInProgress )
  {
    ...
    v6 = v26;
    if ( v23 >= 0 )
      PushW32ThreadLock(v26, &v27, RestoreGammaRamp);
    v9 = v30;
  }
  if ( !v25 )
  {
