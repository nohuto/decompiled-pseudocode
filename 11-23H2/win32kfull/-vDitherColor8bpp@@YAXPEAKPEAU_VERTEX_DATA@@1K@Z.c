/*
 * XREFs of ?vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x1C0288538
 * Callers:
...
void __fastcall vDitherColor8bpp(unsigned int *a1, struct _VERTEX_DATA *a2, struct _VERTEX_DATA *a3, unsigned int a4)
{
  ...
  if ( a4 > 2 )
  {
    ...
    *a1 = v14;
    ...
    a1[14] = v14;
    a1[15] = v14;
    v15 = (unsigned int *)&unk_1C0328830;
    while ( 1 )
    {
...
LABEL_21:
  ...
  if ( *(_DWORD *)a2 < v24 )
  {
    ...
    v24 = *(_DWORD *)a2;
    v26 = (unsigned int *)&unk_1C0328830;
    v23 = (char *)a2 + 4;
    v25 = dword_1C0328770[v27];
  }
  else
  {
    v25 = dword_1C0328770[*v21];
    v26 = (unsigned int *)((char *)&unk_1C0328830 + 4 * v22);
  }
  v28 = byte_1C0328660[*(unsigned int *)v23];
  *a1 = v25;
  a1[1] = v25;
  a1[2] = v25;
  a1[3] = v25;
