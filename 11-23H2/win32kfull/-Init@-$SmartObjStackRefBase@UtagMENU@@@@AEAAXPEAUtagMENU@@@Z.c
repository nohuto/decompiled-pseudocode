/*
 * XREFs of ?Init@?$SmartObjStackRefBase@UtagMENU@@@@AEAAXPEAUtagMENU@@@Z @ 0x1C007BA50
 * Callers:
 ...
 *     _CheckMenuItem @ 0x1C0221680 (_CheckMenuItem.c)
 ...
 *     MenuRecalc @ 0x1C022D36C (MenuRecalc.c)
 *     ?ItemContainingSubMenu@@YAHAEBV?$SmartObjStackRef@UtagMENU@@@@_K@Z @ 0x1C022F914 (-ItemContainingSubMenu@@YAHAEBV-$SmartObjStackRef@UtagMENU@@@@_K@Z.c)
