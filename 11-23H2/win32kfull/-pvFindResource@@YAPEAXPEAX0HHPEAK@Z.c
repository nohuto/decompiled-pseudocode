/*
 * XREFs of ?pvFindResource@@YAPEAXPEAX0HHPEAK@Z @ 0x1C00842DC
 * Callers:
 *     ?LOADSTRING@@YAHPEAXIPEAGH@Z @ 0x1C0019D48 (-LOADSTRING@@YAHPEAXIPEAGH@Z.c)
 *     cParseFontResources @ 0x1C00D40F4 (cParseFontResources.c)
 *     EngFindResource @ 0x1C0278D70 (EngFindResource.c)
 * Callees:
 *     <none>
 */
