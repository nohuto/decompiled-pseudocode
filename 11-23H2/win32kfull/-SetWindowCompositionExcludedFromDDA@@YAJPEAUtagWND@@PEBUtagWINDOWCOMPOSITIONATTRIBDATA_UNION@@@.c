/*
 * XREFs of ?SetWindowCompositionExcludedFromDDA@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1C01F67C8
 * Callers:
        ...
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    v7 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v9[0], 15) == v7 )
    {
      return 0;
    }
    else
    {
      v9[0] = (v7 << 14) | v9[0] & 0xFFFFBFFF;
