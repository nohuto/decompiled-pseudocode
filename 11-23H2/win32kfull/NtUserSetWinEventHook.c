/*
 * XREFs of NtUserSetWinEventHook @ 0x1C003F0B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$ObjectLock@$$V@?$DomainExclusive@VDLT_WINEVENT@@@?$DomainShared@$$V@@QEAA@XZ @ 0x1C0139924 (--0-$ObjectLock@$$V@-$DomainExclusive@VDLT_WINEVENT@@@-$DomainShared@$$V@@QEAA@XZ.c)
