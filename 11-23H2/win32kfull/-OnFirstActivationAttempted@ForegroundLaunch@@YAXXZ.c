/*
 * XREFs of ?OnFirstActivationAttempted@ForegroundLaunch@@YAXXZ @ 0x1C0030878
 * Callers:
...
void __fastcall ForegroundLaunch::OnFirstActivationAttempted(ForegroundLaunch *this)
{
  ...
  v3 = *(int *)(v2 + 56);
  CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v10, (struct _EX_PUSH_LOCK *)&unk_1C035F388);
  v5 = 5LL;
  v6 = &unk_1C035E228;
  v7 = 1;
  while ( *v6 != v3 )
  ...
  *(_OWORD *)&qword_1C035E1B0[v8] = 0LL;
  qword_1C035E1B0[v8 + 2] = 0LL;
LABEL_8:
