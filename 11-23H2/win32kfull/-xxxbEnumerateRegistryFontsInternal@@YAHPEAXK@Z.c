/*
 * XREFs of ?xxxbEnumerateRegistryFontsInternal@@YAHPEAXK@Z @ 0x1C00E68B8
 * Callers:
 ...
 *     ?RtlStringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1C01BA63C (-RtlStringCchCatW@@YAJPEAG_KPEBG@Z.c)
 */
...
__int64 __fastcall xxxbEnumerateRegistryFontsInternal(HANDLE KeyHandle, unsigned int a2)
{
  ...
  *(_QWORD *)v21 = *(_QWORD *)L".FON";
  ...
  if ( result )
  {
    PushW32ThreadLock(result, &v16, (__int64)Win32FreePool);
    for ( i = 0; ; ++i )
    {
      ...
      if ( v13 )
      {
        ThreadLockExchange(v13, (__int64)&v16);
...
LABEL_5:
          ...
          if ( *(_DWORD *)(v6 + 4) == 1 )
          {
            ...
            *(_WORD *)(v6 + 2 * v9 + 20) = 0;
            vCheckMMInstance((char *)(v6 + 20), (struct tagDESIGNVECTOR *)v19);
            *(_WORD *)(v6 + 2 * ((unsigned __int64)*(unsigned int *)(v6 + 16) >> 1) + 20) = v10;
            ...
            if ( wcschr(v11, 0x2Eu) )
            {
              ...
              xxxClientAddFontResourceW(&DestinationString, a2, v12);
            }
            else
            {
