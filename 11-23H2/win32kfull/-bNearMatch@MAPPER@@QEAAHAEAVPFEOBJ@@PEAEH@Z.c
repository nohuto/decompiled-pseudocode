/*
 * XREFs of ?bNearMatch@MAPPER@@QEAAHAEAVPFEOBJ@@PEAEH@Z @ 0x1C0110BDC
 * Callers:
 ...
 *     ?bCalcOrientation@MAPPER@@QEAAHXZ @ 0x1C0074F00 (-bCalcOrientation@MAPPER@@QEAAHXZ.c)
 *     ?bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z @ 0x1C0089CE0 (-bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z.c)
 ...
 *     ?bSimItalic@IFIOBJ@@QEAAHXZ @ 0x1C015A276 (-bSimItalic@IFIOBJ@@QEAAHXZ.c)
 ...
 *     ??$SafeDivide@KKK@@YAJKKPEAK@Z @ 0x1C029A314 (--$SafeDivide@KKK@@YAJKKPEAK@Z.c)
 ...
 *     ?pvSimBold@IFIOBJ@@QEAAPEAXXZ @ 0x1C029A734 (-pvSimBold@IFIOBJ@@QEAAPEAXXZ.c)
 */
...
LABEL_54:
    ...
    if ( (v64 & 0x41000) == 0x41000 )
      goto LABEL_55;
    if ( (v64 & 0x80000) != 0 || (unsigned int)MAPPER::bCalcOrientation((__int64 **)this) )
    {
      v65 = *((_DWORD *)this + 44);
