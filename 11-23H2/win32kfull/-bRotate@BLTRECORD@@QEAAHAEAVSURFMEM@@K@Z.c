/*
 * XREFs of ?bRotate@BLTRECORD@@QEAAHAEAVSURFMEM@@K@Z @ 0x1C028EC30
 * Callers:
 ...
 *     ?vMirror@BLTRECORD@@QEAAXPEAU_POINTFIX@@@Z @ 0x1C028EFA4 (-vMirror@BLTRECORD@@QEAAXPEAU_POINTFIX@@@Z.c)
