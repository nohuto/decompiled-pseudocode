/*
 * XREFs of ?_DestroyCursor@@YA_NPEAUtagCURSOR@@K@Z @ 0x1C004829C
 * Callers:
 ...
 *     DestroyUnlockedCursor @ 0x1C009AFB0 (DestroyUnlockedCursor.c)
 ...
 *     ?DestroyEmptyCursorObject@@YAXPEAUtagCURSOR@@@Z @ 0x1C01C0288 (-DestroyEmptyCursorObject@@YAXPEAUtagCURSOR@@@Z.c)
 */
