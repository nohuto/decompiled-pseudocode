/*
 * XREFs of ?GenerateMessages@InteractiveControlDefaultScroller@@QEAAJPEAUtagINTERACTIVECTRL_INFO@@W4tagINTERACTIVECTRL_PROMOTION_TYPE@@@Z @ 0x1C0246CE4
 * Callers:
          ...
          *((_DWORD *)a1 + 15) = v12;
          ...
          if ( updated >= 0 )
          {
            ...
            if ( updated >= 0 )
            {
              ...
              v6 = updated;
              if ( updated >= 0 || (unsigned int)dword_1C0354150 <= 2 )
                return v6;
            }
