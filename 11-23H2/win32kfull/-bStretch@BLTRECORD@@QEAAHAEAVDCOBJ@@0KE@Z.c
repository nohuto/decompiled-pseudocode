/*
 * XREFs of ?bStretch@BLTRECORD@@QEAAHAEAVDCOBJ@@0KE@Z @ 0x1C00BDB6C
 * Callers:
 ...
 *     ?pSurfMskOut@BLTRECORD@@QEAAPEAVSURFACE@@XZ @ 0x1C009D754 (-pSurfMskOut@BLTRECORD@@QEAAPEAVSURFACE@@XZ.c)
 *     ?prgnEffRao@XDCOBJ@@QEAAPEAVREGION@@XZ @ 0x1C00BB318 (-prgnEffRao@XDCOBJ@@QEAAPEAVREGION@@XZ.c)
 *     ?vOrderStupid@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1C00BE348 (-vOrderStupid@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
 *     ?vMirror@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1C00BE370 (-vMirror@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
 ...
 *     ?bBitBlt@BLTRECORD@@QEAAHAEAVDCOBJ@@0KJJ@Z @ 0x1C0292B1C (-bBitBlt@BLTRECORD@@QEAAHAEAVDCOBJ@@0KJJ@Z.c)
        ...
        unsigned __int8 a5)
{
  ...
  _OWORD v83[3]; // [rsp+B4h] [rbp-4Ch] BYREF
...
LABEL_12:
    ...
    *((_DWORD *)this + 44) = v18;
    v15 = BLTRECORD::bBitBlt(this, a2, a2, a4);
    goto LABEL_12;
  }
  v19 = 0LL;
  v20 = *(unsigned int *)(*(_QWORD *)a2 + 36LL);
      ...
      if ( *((_WORD *)v37 + 50) || *((_QWORD *)v37 + 3) )
      {
        ...
        if ( *((_WORD *)v39 + 50) || *((_QWORD *)v39 + 3) )
        {
          if ( v40
            ...
            && (unsigned __int8)tlgKeywordOn(&dword_1C0354098, 0x400000000000LL) )
          {
            v75 = 0;
            v76 = 1;
            *(_QWORD *)&v74 = 0x1000000LL;
            v77 = 80812;
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<8>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
              v41,
              (unsigned int)&unk_1C031E89C,
              v42,
              v43,
              (__int64)&v77,
              (__int64)&v74,
    ...
    && (*((_DWORD *)this + 53) & 0x18) == 0 )
  {
    ...
    if ( (unsigned int)(v47 + 1) <= 2 && (unsigned int)(v48 + 1) <= 2 )
      return BLTRECORD::bBitBlt(this, a2, v46, a4, v47, v48);
  }
  if ( !*(_QWORD *)(*(_QWORD *)a2 + 496LL) || !*(_QWORD *)(*(_QWORD *)v46 + 496LL) )
    return 1LL;
  if ( (*(_DWORD *)(*(_QWORD *)a2 + 36LL) & 0xE0) != 0 )
    XDCOBJ::vAccumulate(a2, v45);
  v49 = *(_QWORD *)a2;
  v50 = *(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1LL;
  *(_DWORD *)v45 += *(_DWORD *)(*(_QWORD *)a2 + 8 * v50 + 1016);
  *((_DWORD *)v45 + 2) += *(_DWORD *)(v49 + 8 * v50 + 1016);
  *((_DWORD *)v45 + 1) += *(_DWORD *)(v49 + 8 * v50 + 1020);
  *((_DWORD *)v45 + 3) += *(_DWORD *)(v49 + 8 * v50 + 1020);
  v51 = *(_QWORD *)v46;
  ...
  *v44 += *(_DWORD *)(*(_QWORD *)v46 + 8 * v52 + 1016);
  ...
  {
    v74 = v83[0];
    XDCOBJ::vAccumulateTight(a2, v55, (struct ERECTL *)&v74);
  }
  v57 = *((_QWORD *)this + 8);
  v58 = *((_QWORD *)this + 9);
  v59 = *(_DWORD **)(v58 + 48);
  ...
  if ( !v73 )
  {
    if ( a5 == 4 && (*(_BYTE *)(v21 + 1792) & 0x10) == 0 )
      v60 = EngStretchBltROP;
    *(_QWORD *)&v74 = (char *)this + 80;
    v61 = 0;
    if ( *(_WORD *)(v58 + 100) == 1 && (*(_QWORD *)&v74 = (char *)this + 80, v59) && (v59[10] & 0x20000) != 0 )
    {
      v62 = v59[640];
      v63 = (char *)this + 168;
...
LABEL_93:
  ...
  *(_QWORD *)&v74 = *((_QWORD *)this + 12);
  ...
  if ( v68 != 52428 && (*((_DWORD *)this + 53) & 0x10000) != 0 && *v66 )
    v19 = *v66 + 24LL;
  return ((__int64 (__fastcall *)(__int64, __int64, __int64, _BYTE *, __int64, __int64, __int64, struct ERECTL *, char *, char *, _DWORD, _QWORD, int))v60)(
