/*
 * XREFs of ?xxxBMPtoDIB@@YAPEAUtagBITMAPINFOHEADER@@PEAUHBITMAP__@@PEAUHPALETTE__@@PEAK@Z @ 0x1C01FBF0C
 * Callers:
 *     ?xxxBMPtoDIBV5@@YAPEAUBITMAPV5HEADER@@PEAUHBITMAP__@@PEAUHPALETTE__@@@Z @ 0x1C01FC1D0 (-xxxBMPtoDIBV5@@YAPEAUBITMAPV5HEADER@@PEAUHBITMAP__@@PEAUHPALETTE__@@@Z.c)
...
struct tagBITMAPINFOHEADER *__fastcall xxxBMPtoDIB(HBRUSH a1, __int64 a2, unsigned int *a3)
{
  ...
  *(_OWORD *)v23 = 0LL;
  v24 = 0LL;
  if ( (unsigned int)GreExtGetObjectW(a1, 32LL, (__int64)v23) )
  {
    v5 = v24 * WORD1(v24);
