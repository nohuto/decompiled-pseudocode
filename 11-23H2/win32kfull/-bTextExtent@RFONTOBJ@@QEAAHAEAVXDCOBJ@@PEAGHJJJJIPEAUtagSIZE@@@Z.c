/*
 * XREFs of ?bTextExtent@RFONTOBJ@@QEAAHAEAVXDCOBJ@@PEAGHJJJJIPEAUtagSIZE@@@Z @ 0x1C00CCDE0
 * Callers:
 ...
 *     ?bIs1Over16@EFLOAT@@QEBAHXZ @ 0x1C00CCFE4 (-bIs1Over16@EFLOAT@@QEBAHXZ.c)
        ...
        struct tagSIZE *a10)
{
  ...
  if ( (_DWORD)v14 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v19 > 82 )
        v21 = 82;
      if ( !(unsigned int)RFONTOBJ::bGetGlyphMetrics(this, (struct RFONTOBJ *)(unsigned int)v21, &v48, v20, v16, 0LL) )
        return 0LL;
      if ( v21 > 0 )
      {
        v22 = v42;
...
LABEL_15:
    ...
    if ( (unsigned __int8)bCalcBreakExtra(*(unsigned int *)(*(_QWORD *)this + 404LL), a7, a8, &v41) )
    {
      v34 = v41;
