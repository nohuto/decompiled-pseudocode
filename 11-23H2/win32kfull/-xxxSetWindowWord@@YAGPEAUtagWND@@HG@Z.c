/*
 * XREFs of ?xxxSetWindowWord@@YAGPEAUtagWND@@HG@Z @ 0x1C022C654
 * Callers:
 *     NtUserSetWindowWord @ 0x1C01DCFB0 (NtUserSetWindowWord.c)
 * Callees:
 ...
 *     FCallerOk @ 0x1C022CB88 (FCallerOk.c)
 */
...
__int64 __fastcall xxxSetWindowWord(struct tagWND *a1, unsigned int a2, unsigned __int16 a3)
{
  ...
  if ( (*(_BYTE *)(v6 + 18) & 1) != 0 )
  {
    ...
    if ( (*(_WORD *)(v6 + 42) & 0x2FFF) == 0x2A4 )
    {
      ...
      if ( (unsigned __int8)CheckAccess(v13 + 896, v12) )
        goto LABEL_20;
  ...
  if ( (int)v4 >= 0 && (int)v4 + 2LL > (unsigned __int64)*(unsigned int *)(v6 + 248) )
  {
    ...
    if ( v19 != v18 )
    {
      ...
      if ( (v20 & 0x10) == 0 )
      {
        ...
        if ( !(unsigned __int8)CheckAccess(v22 + 896, v21) )
        {
