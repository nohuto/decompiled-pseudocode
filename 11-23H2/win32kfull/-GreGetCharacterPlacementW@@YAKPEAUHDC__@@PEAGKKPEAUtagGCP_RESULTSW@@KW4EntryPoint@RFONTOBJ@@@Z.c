/*
 * XREFs of ?GreGetCharacterPlacementW@@YAKPEAUHDC__@@PEAGKKPEAUtagGCP_RESULTSW@@KW4EntryPoint@RFONTOBJ@@@Z @ 0x1C02D67C0
 * Callers:
 ...
 *     ?nCalcJustInArray@@YAKPEAPEAIGPEAXHI@Z @ 0x1C02D6FE8 (-nCalcJustInArray@@YAKPEAPEAIGPEAXHI@Z.c)
 */
        ...
        int a6)
{
  ...
  if ( !a5 )
  {
    if ( (unsigned int)GrepGetTextExtentW(a1, a2, a3, &v60, 1, COERCE_FLOAT(8)) )
