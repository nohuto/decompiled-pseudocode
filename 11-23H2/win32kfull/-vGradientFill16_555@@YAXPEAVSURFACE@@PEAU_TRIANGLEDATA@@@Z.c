/*
 * XREFs of ?vGradientFill16_555@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02F8420
 * Callers:
 *     <none>
 * Callees:
 *     <none>
      ...
      if ( *((_QWORD *)v3 + 9) <= (unsigned __int64)(v15 + v7) && v15 < v10 )
      {
        ...
        if ( (unsigned __int64)v17 < v18 )
        {
          ...
          do
          {
            ...
            v25 = HIDWORD(v13);
            v13 += v31;
            v26 = byte_1C0329AE0[(unsigned __int64)(v22 + ((unsigned int)v25 >> 11)) >> 16] | (unsigned __int16)(32 * v24);
            v27 = HIDWORD(v12);
            v12 += v32;
