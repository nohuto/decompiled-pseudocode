/*
 * XREFs of ?_LoadCursorsAndIcons@@YAHXZ @ 0x1C008EE0C
 * Callers:
 *     NtUserLoadCursorsAndIcons @ 0x1C008EDD0 (NtUserLoadCursorsAndIcons.c)
 * Callees:
    ...
    for ( i = gpcurFirst; i; i = *(_QWORD *)(i + 32) )
    {
      if ( *(_WORD *)(i + 74) == 1 )
      {
        if ( *(_QWORD *)(i + 48) == i )
        {
          ...
          zzzInternalSetSystemCursor(i, v6, i + 56, 0LL);
        }
      }
