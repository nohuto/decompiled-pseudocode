/*
 * XREFs of ?vGradientFill16Bitfields@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02F8190
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vGradientFill16Bitfields(struct SURFACE *a1, struct _TRIANGLEDATA *a2)
{
  ...
  if ( v4 < v6 )
  {
    ...
    do
    {
      ...
      v14 = *((_QWORD *)v5 + 3);
      v15 = *(_DWORD *)v2;
      v30 = 0x1C0000000LL + 16LL * (v8 & 3) + 3316896;
      if ( v9 >= *((_DWORD *)v2 + 2) )
        v9 = *((_DWORD *)v2 + 2);
      if ( v10 <= v15 )
        v11 = *(_DWORD *)v2;
          ...
          do
          {
            ...
            v22 = XEPALOBJ::ulDispatchGFPEFunction(
                    ...
                    *(unsigned int *)(*(_QWORD *)v31 + 100LL),
                    8
                  * (byte_1C0329AE0[(unsigned __int64)(unsigned int)(v21 + (HIDWORD(v12) >> 11)) >> 16] | ((byte_1C0329AE0[(unsigned __int64)(unsigned int)(v21 + (HIDWORD(v13) >> 11)) >> 16] | (byte_1C0329AE0[(unsigned __int64)(unsigned int)(v21 + (HIDWORD(v14) >> 11)) >> 16] << 8)) << 8)));
            v14 += v27;
            v12 += v25;
            *v18 = v22;
            v13 += v26;
