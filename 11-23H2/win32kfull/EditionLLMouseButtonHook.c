/*
 * XREFs of EditionLLMouseButtonHook @ 0x1C01ABA90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsGpqForegroundAccessibleOnInputThread@@YA_N_NAEBUtagUIPI_INFO_INT@@@Z @ 0x1C014EA56 (-IsGpqForegroundAccessibleOnInputThread@@YA_N_NAEBUtagUIPI_INFO_INT@@@Z.c)
 */
  ...
  if ( Valid )
  {
    ...
    *(_QWORD *)(gptiCurrent + 1416LL) = a2;
    if ( v7 )
    {
      ...
      {
        *(_QWORD *)(gptiCurrent + 1408LL) = v15[112];
      }
      v12 = 1;
    }
    else
    ...
    {
      *(_QWORD *)(gptiCurrent + 1400LL) = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 896LL);
    }
