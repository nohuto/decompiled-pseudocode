/*
 * XREFs of ?GreStretchDIBitsInternalImpl@@YAHPEAUHDC__@@HHHHHHHHAEAV?$umptr_r@E@@PEAUtagBITMAPINFO@@KKIPEAX@Z @ 0x1C00C0EB0
 * Callers:
                  ...
                  else if ( (v143[24] & 1) != 0 )
                  {
                      ...
                      && !ERECTL::bEmpty((ERECTL *)&v149) )
                    {
                      ...
                      else
                      {
                        ...
                        {
                          *(_OWORD *)v137 = v154[0];
                          XDCOBJ::vAccumulateTight((XDCOBJ *)v135, v84, (struct ERECTL *)v137);
                        }
                        if ( v115 )
                        {
                          v85 = v130;
