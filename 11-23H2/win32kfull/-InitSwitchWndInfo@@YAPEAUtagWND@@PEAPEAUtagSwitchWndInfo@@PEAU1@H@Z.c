/*
 * XREFs of ?InitSwitchWndInfo@@YAPEAUtagWND@@PEAPEAUtagSwitchWndInfo@@PEAU1@H@Z @ 0x1C01C87B0
 * Callers:
...
LABEL_7:
  ...
  *(_DWORD *)(v16 + 116) = v21 + v22;
  PrevTaskIndex = (int)NextPrevTaskIndex((struct tagSwitchWndInfo *)v16, v23, 1, v49 == 0);
