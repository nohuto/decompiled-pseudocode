/*
 * XREFs of ?xxxSetForegroundThreadWithWindowHint@@YAXPEAUtagTHREADINFO@@PEAUtagWND@@@Z @ 0x1C0031B48
 * Callers:
 *     xxxSetModernAppWindow @ 0x1C000EF34 (xxxSetModernAppWindow.c)
 *     xxxSetForegroundThread @ 0x1C0017B60 (xxxSetForegroundThread.c)
 ...
 * Callees:
 *     SetNewForegroundPti @ 0x1C0032010 (SetNewForegroundPti.c)
...
LABEL_7:
  ...
  if ( gptiForeground )
  {
    ...
    {
      v13 = (_QWORD *)gptiForeground;
      *(_DWORD *)(*(_QWORD *)(gptiForeground + 424LL) + 1100LL) = (MEMORY[0xFFFFF78000000320]
