/*
 * XREFs of ?ThrottleRawInput@Mouse@InputTraceLogging@@SAXPEAUtagPROCESS_HID_TABLE@@_K1@Z @ 0x1C01AAA1C
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::ThrottleRawInput(struct tagPROCESS_HID_TABLE *a1)
{
  __int64 v1; // r9
  __int64 v2; // r10
  __int64 v3; // r11
  ...
  if ( (unsigned int)dword_1C0359080 > 4 )
  {
    if ( tlgKeywordOn((__int64)&dword_1C0359080, 64LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C031A1CC,
        0LL,
        0LL,
        5u,
        &v7);
