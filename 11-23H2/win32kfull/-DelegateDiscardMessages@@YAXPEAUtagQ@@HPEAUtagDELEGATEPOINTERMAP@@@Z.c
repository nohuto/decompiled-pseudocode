/*
 * XREFs of ?DelegateDiscardMessages@@YAXPEAUtagQ@@HPEAUtagDELEGATEPOINTERMAP@@@Z @ 0x1C01C3438
 * Callers:
 ...
 *     ?GetPwndFromPointerMsgId@@YAPEAUtagWND@@_K@Z @ 0x1C01C38C0 (-GetPwndFromPointerMsgId@@YAPEAUtagWND@@_K@Z.c)
