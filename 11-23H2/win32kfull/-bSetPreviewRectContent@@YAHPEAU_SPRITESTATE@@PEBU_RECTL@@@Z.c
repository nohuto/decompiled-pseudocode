/*
 * XREFs of ?bSetPreviewRectContent@@YAHPEAU_SPRITESTATE@@PEBU_RECTL@@@Z @ 0x1C027CD88
 * Callers:
...
__int64 __fastcall bSetPreviewRectContent(struct _SPRITESTATE *a1, const struct _RECTL *a2)
{
  ...
  struct _RECTL v32; // [rsp+130h] [rbp+30h] BYREF
  struct _RECTL v33; // [rsp+140h] [rbp+40h] BYREF
  __m128i si128; // [rsp+150h] [rbp+50h] BYREF
  int v35; // [rsp+160h] [rbp+60h]
  __m128i v36; // [rsp+164h] [rbp+64h]
            ...
            && v17 )
          {
            ...
            *(_QWORD *)&v23 = *(_QWORD *)v20;
                   ...
                   0) )
            {
              if ( v24 )
              {
                *(struct tagSIZE *)&v32.right = v16;
                *(_QWORD *)&v32.left = 0LL;
                v33 = (struct _RECTL)_mm_load_si128((const __m128i *)&_xmm);
