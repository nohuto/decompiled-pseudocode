/*
 * XREFs of ?RemoveProcRequest@@YAXPEAUtagPROCESSINFO@@PEAUtagPROCESS_HID_REQUEST@@KH@Z @ 0x1C01A9200
 * Callers:
...
void __fastcall RemoveProcRequest(struct tagPROCESS_HID_TABLE **a1, struct tagPROCESS_HID_REQUEST *a2, int a3, int a4)
{
  ...
  if ( v8 )
  {
    ...
    {
      DerefPageOnlyRequest(a2, a1[107], 0);
    }
  }
  else
  {
    DerefIncludeRequest(a2, a1[107], a4, 0);
  }
  v10 = *(_QWORD *)a2;
