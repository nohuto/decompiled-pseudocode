/*
 * XREFs of _anonymous_namespace_::xxxSetForegroundCheckNoActivate @ 0x1C01ADB4C
 * Callers:
 *     EditionSetForegroundCheckNoActivate @ 0x1C01ADD90 (EditionSetForegroundCheckNoActivate.c)
 * Callees:
