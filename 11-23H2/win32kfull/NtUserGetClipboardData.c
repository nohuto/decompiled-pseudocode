/*
 * XREFs of NtUserGetClipboardData @ 0x1C01CFAA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Feature_ReadClipboardEvent__private_ReportDeviceUsage @ 0x1C013BD84 (Feature_ReadClipboardEvent__private_ReportDeviceUsage.c)
...
__int64 __fastcall NtUserGetClipboardData(unsigned int a1, _OWORD *a2)
{
  ...
  v33 = 0LL;
  EnterCrit(0LL, 0LL);
  v4 = (const char *)(*(_QWORD *)(gptiCurrent + 424LL) + 1008LL);
  v30 = (__int64)v4;
  ...
  if ( (*(_DWORD *)(gptiCurrent + 488LL) & 0x20000000) != 0 )
    v12 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 768LL) + 24LL) & 2;
  else
    v12 = 0;
  if ( v12 )
  {
...
LABEL_9:
  ...
  if ( !*(_DWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 900LL)
