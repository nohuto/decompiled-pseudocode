/*
 * XREFs of ?ShouldMinimizeOnMonitorRemove@DesktopRecalcSettings@@YA_NXZ @ 0x1C005B460
 * Callers:
 ...
 *     Feature_Emrbspi__private_ReportDeviceUsage @ 0x1C013CF24 (Feature_Emrbspi__private_ReportDeviceUsage.c)
 */
