/*
 * XREFs of ?DT_InitDrawTextInfo@@YAHPEAUHDC__@@PEAUtagRECT@@IPEAUDRAWTEXTDATA@@PEAUtagDRAWTEXTPARAMS@@@Z @ 0x1C024C5A8
 * Callers:
  ...
  if ( (_DWORD)result )
  {
    ...
    *((_DWORD *)a4 + 7) = v21;
    ...
    else
    {
      ...
      v23 = *(_DWORD *)(CurrentProcessWin32Process + 760) & 4;
    }
    *((_DWORD *)a4 + 15) = v23;
    if ( !v23 )
