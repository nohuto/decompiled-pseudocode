/*
 * XREFs of ?ThrottleRawMouseInputToBackgroundListener@@YA_NPEAUtagPROCESS_HID_TABLE@@PEAXPEBUtagRAWMOUSE@@_KK@Z @ 0x1C01AAAE4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v11 == 1 )
  {
    ...
    *((_DWORD *)a1 + 42) = 0;
    ...
    if ( a4 >= *((_QWORD *)a1 + 15) )
      MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 435);
  }
  v13 = *((_DWORD *)a1 + 28);
  if ( v13 != 2 )
  {
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 439);
    v13 = *((_DWORD *)a1 + 28);
  }
