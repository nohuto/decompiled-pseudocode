/*
 * XREFs of ?vNextPoint@LINER@@AEAAXXZ @ 0x1C02F2148
 * Callers:
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C02F1FF8 (-vNextEvent@LINER@@QEAAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C01381F0 (__security_check_cookie.c)
 *     ?bNextPoint@READER@@IEAAHAEAU_POINTFIX@@@Z @ 0x1C015D234 (-bNextPoint@READER@@IEAAHAEAU_POINTFIX@@@Z.c)
 *     ?bNextFigure@READER@@IEAAHXZ @ 0x1C02F0E0C (-bNextFigure@READER@@IEAAHXZ.c)
 *     ?vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z @ 0x1C02F1ED4 (-vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z.c)
 */
