/*
 * XREFs of ?DoHideInkCursorStart@HideInkCursorProvider@@AEAAJPEBUIFC_HIDE_INK_CURSOR_START_DATA@@@Z @ 0x1C024187C
 * Callers:
 ...
 * Callees:
 *     ?ForceHidePenCursor@Feedback@@YAXH@Z @ 0x1C01ACCDC (-ForceHidePenCursor@Feedback@@YAXH@Z.c)
