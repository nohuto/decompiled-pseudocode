/*
 * XREFs of EngAlphaBlend @ 0x1C00B72C0
 * Callers:
 ...
 *     ?cEnumStart@XCLIPOBJ@@QEAAKHKKK@Z @ 0x1C0059440 (-cEnumStart@XCLIPOBJ@@QEAAKHKKK@Z.c)
 ...
 *     ?bDetermineAlphaBlendFunction@@YAHPEAVSURFACE@@0PEAVXEPALOBJ@@1PEAVXLATE@@JPEAU_ALPHA_DISPATCH_FORMAT@@H@Z @ 0x1C00B82CC (-bDetermineAlphaBlendFunction@@YAHPEAVSURFACE@@0PEAVXEPALOBJ@@1PEAVXLATE@@JPEAU_ALPHA_DISPATCH_F.c)
