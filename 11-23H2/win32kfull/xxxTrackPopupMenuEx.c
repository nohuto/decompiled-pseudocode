/*
 * XREFs of xxxTrackPopupMenuEx @ 0x1C0231EEC
 * Callers:
...
LABEL_7:
  ...
  *(_QWORD *)&v71 = gptiCurrent;
    ...
    || (W32GetCurrentThreadDpiAwarenessContext(v17) & 0xF) == 3 )
  {
    ...
    v18 = *(_QWORD *)(MonitorFromPoint(__SPAIR64__(a4, a3), 2LL, 0LL) + 40);
...
LABEL_35:
  ...
  if ( v68 )
  {
    ...
    {
      if ( (*(_DWORD *)(*(_QWORD *)(v71 + 424) + 824LL) & 0x100000) != 0
        || ((a2 & 0x200) == 0
          ? (!IsTopLevelWindow(a5)
      ...
      if ( xxxMNStartMenu(v64, v44, -1) )
      {
        if ( (*(_DWORD *)(v72[0] + 8) & 0x400) != 0 )
        {
          *(_QWORD *)&v71 = *(_QWORD *)Window;
          xxxUserModeCallback(0x64u, (__int64)&v71, 8u, v45);
        }
...
LABEL_97:
        ...
        *(_QWORD *)&v71 = xxxSendMessage(Window);
        if ( (_DWORD)v71 )
        {
          ...
          v56 = (struct tagMONITOR *)MonitorFromPoint(__SPAIR64__(a4, a3), 2LL, 0LL);
          v70 = (__int64)v56;
          v57 = a2 ^ 8;
