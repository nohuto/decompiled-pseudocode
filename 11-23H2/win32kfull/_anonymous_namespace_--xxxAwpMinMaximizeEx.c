/*
 * XREFs of _anonymous_namespace_::xxxAwpMinMaximizeEx @ 0x1C023BFBC
 * Callers:
...
__int64 __fastcall anonymous_namespace_::xxxAwpMinMaximizeEx(struct tagWND *a1, unsigned int a2, int a3, __int64 a4)
{
  int v5; // ebx
  __int64 v8; // rcx
  int v9; // edx
    ...
    if ( v8 )
    {
      if ( (a3 & 0x20) != 0 )
      {
        ...
        if ( v10 )
        {
          ...
          if ( v14 != (*(_BYTE *)(*((_QWORD *)a1 + 5) + 24LL) & 8) )
