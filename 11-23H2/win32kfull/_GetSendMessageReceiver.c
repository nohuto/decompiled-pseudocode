/*
 * XREFs of _GetSendMessageReceiver @ 0x1C01FB414
 * Callers:
 *     NtUserGetSendMessageReceiver @ 0x1C01D3530 (NtUserGetSendMessageReceiver.c)
 * Callees:
...
__int64 __fastcall GetSendMessageReceiver(__int64 a1)
{
  ...
  {
    if ( *(_DWORD *)(v5 + 780) != *(_DWORD *)(v4 + 780) || *(_DWORD *)(v5 + 784) != *(_DWORD *)(v4 + 784) )
      goto LABEL_5;
LABEL_8:
    v6 = *(_QWORD *)(v2 + 504);
    if ( !v6 )
  ...
  if ( (unsigned __int8)CheckAccess(v5 + 896, v4 + 896) )
    goto LABEL_8;
LABEL_5:
