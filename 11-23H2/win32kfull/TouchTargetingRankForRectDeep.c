/*
 * XREFs of TouchTargetingRankForRectDeep @ 0x1C024E108
 * Callers:
 ...
 *     ?_TTIntersectLine@@YAHUtagPOINT@@0PEBUtagTOUCHTARGETINGCONTACT@@PEAU1@2@Z @ 0x1C024CF2C (-_TTIntersectLine@@YAHUtagPOINT@@0PEBUtagTOUCHTARGETINGCONTACT@@PEAU1@2@Z.c)
 *     ?_TTLimitDeepTargetingPoint@@YAXJJPEAJ@Z @ 0x1C024D1D8 (-_TTLimitDeepTargetingPoint@@YAXJJPEAJ@Z.c)
 *     TouchTargetingRank @ 0x1C024DB44 (TouchTargetingRank.c)
 *     TouchTargetingSnapToSegment @ 0x1C024E404 (TouchTargetingSnapToSegment.c)
 */
