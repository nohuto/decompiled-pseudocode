/*
 * XREFs of GreMovePointer @ 0x1C001D070
 * Callers:
 ...
 * Callees:
 *     ?bDontShowPointer@@YAHXZ @ 0x1C001D300 (-bDontShowPointer@@YAHXZ.c)
  ...
  if ( ((_DWORD)v34[10] & 0x20000) != 0 )
  {
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        if ( !v25 )
          v31 = v26;
        v32 = v41 - *((_DWORD *)v27 + 8);
        v33 = v40 - *((_DWORD *)v27 + 7);
      }
      vMovePointer((HDEV)v27[6], v33, v32, v31);
