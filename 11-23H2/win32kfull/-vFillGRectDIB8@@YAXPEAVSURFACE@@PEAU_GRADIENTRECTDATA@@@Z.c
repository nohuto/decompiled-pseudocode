/*
 * XREFs of ?vFillGRectDIB8@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02F7E20
 * Callers:
 *     <none>
 * Callees:
 *     ?XLATEOBJ_pGetXlate555@@YAPEAEPEAU_XLATEOBJ@@@Z @ 0x1C02DB93C (-XLATEOBJ_pGetXlate555@@YAPEAEPEAU_XLATEOBJ@@@Z.c)
 */
...
void __fastcall vFillGRectDIB8(struct SURFACE *a1, struct _GRADIENTRECTDATA *a2)
{
  ...
  v5 = *((_DWORD *)v2 + 9);
  v6 = (unsigned __int8 *)&unk_1C0329CE0;
  v7 = byte_1C0329B20;
  v8 = v4;
  v49 = v5;
  v9 = (unsigned __int8 *)&unk_1C0329860;
  v37 = *((_DWORD *)a1 + 22);
  v10 = (unsigned __int8 *)&unk_1C0329DE0;
  v51 = v5 + *((_DWORD *)v2 + 11);
  v35 = (unsigned __int8 *)&unk_1C0329CE0;
  ...
  {
    v9 = byte_1C0329B20;
    v10 = (unsigned __int8 *)&unk_1C0329CE0;
  }
