/*
 * XREFs of ?bProxyDrvTextOut@@YAHAEAVXDCOBJ@@PEAVSURFACE@@AEAVESTROBJ@@AEAVECLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@AEAVRFONTOBJ@@PEAVPDEVOBJ@@K4@Z @ 0x1C029F228
 * Callers:
 ...
 *     ?bAdjusBaseLine@@YAHAEAVRFONTOBJ@@0PEAU_POINTL@@@Z @ 0x1C029EBD8 (-bAdjusBaseLine@@YAHAEAVRFONTOBJ@@0PEAU_POINTL@@@Z.c)
 *     bOutOfBounds @ 0x1C029F144 (bOutOfBounds.c)
 *     ?pfnTextOut@SURFACE@@QEAAP6AHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@ZXZ @ 0x1C029FB48 (-pfnTextOut@SURFACE@@QEAAP6AHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@.c)
 *     ?ptlBaseLineAdjustSet@ESTROBJ@@QEAAXAEAU_POINTL@@@Z @ 0x1C02B47AC (-ptlBaseLineAdjustSet@ESTROBJ@@QEAAXAEAU_POINTL@@@Z.c)
  ...
  *(_QWORD *)&pstro->flAccel = 0LL;
  ...
  if ( *(_DWORD *)(*(_QWORD *)a10 + 840LL) + 4 > 0 )
  {
    while ( 1 )
    {
      ...
      if ( v25 )
        break;
      v31 = pstro[5].ulCharInc + pstro[5].rclBkGround.left + pstro[5].rclBkGround.top;
      v32 = (struct _SURFOBJ *)*(unsigned int *)(v26 + 840);
      if ( (_DWORD)v32 )
      {
        v33 = (unsigned int)v32;
        v34 = *(int **)&pstro[5].rclBkGround.bottom;
        do
        {
          if ( *(_QWORD *)&pstro[5].rclBkGround.bottom )
            v35 = *v34;
          else
            v35 = 0;
          v31 += v35;
      ...
      v30 = v14;
LABEL_48:
      v41 = *(_DWORD **)&pstro[4].rclBkGround.top;
      v42 = pwszOrg;
      v43 = v16;
      v44 = &v41[cGlyphs];
      while ( v41 < v44 )
      ...
      v77 += v45;
      pstro->cGlyphs = v45;
      HIDWORD(pstro[4].pwszOrg) = v25;
      pstro[1].cGlyphs = 0;
      if ( v25 && (unsigned int)bAdjusBaseLine(v14, (struct RFONTOBJ *)&v72, &v87) )
        ESTROBJ::ptlBaseLineAdjustSet((ESTROBJ *)pstro, &v87);
      rclBkGround = pstro->rclBkGround;
      *(_QWORD *)&pstro[1].ulCharInc = v30;
      *(RECTL *)((char *)&pstro[3].pgp + 4) = rclBkGround;
      if ( (*(_DWORD *)(*(_QWORD *)v30 + 88LL) & 2) == 0 )
      {
        v20 = 0LL;
        if ( !(unsigned int)bOutOfBounds(pstro, (__int64 *)v30) )
        {
          ...
          v71 &= -(((unsigned int (__fastcall *)(unsigned __int64, STROBJ *, _QWORD, CLIPOBJ *, struct _RECTL *))v55)(
      ...
      if ( v95 )
      {
        ...
        v50 = 0;
        v51 = 0;
        v71 = ESTROBJ::bTextToPathWorkhorse(pstro, (struct EPATHOBJ *)&ppo);
        if ( v71 )
        {
...
LABEL_100:
      v17 = pco;
      pstro->rclBkGround = *(RECTL *)((char *)&pstro[3].pgp + 4);
LABEL_101:
      v72 = 0LL;
LABEL_102:
    ...
    {
      case 1:
        if ( v22 || !pstro[5].ulCharInc )
          goto LABEL_102;
        v29 = *(_QWORD *)(v26 + 720);
        break;
      case 2:
        if ( v22 || !pstro[5].rclBkGround.left )
          goto LABEL_102;
        v29 = *(_QWORD *)(v26 + 728);
        break;
      case 3:
        if ( v22 || !pstro[5].rclBkGround.top )
          goto LABEL_102;
        v29 = *(_QWORD *)(v26 + 736);
        break;
      default:
        if ( v22 )
          goto LABEL_102;
        v27 = *(_QWORD *)&pstro[5].rclBkGround.bottom;
        if ( !v27 )
          goto LABEL_102;
