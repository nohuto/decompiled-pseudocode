/*
 * XREFs of ?ShellHotKey@NotifyShell@@YA_NPEBUtagWND@@_J_KW4SHELLHOTKEYADDITIONACTIONRESULT@@@Z @ 0x1C009CB54
 * Callers:
...
bool __fastcall NotifyShell::ShellHotKey(__int64 *a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  *((_QWORD *)&v8 + 1) = a2;
  v13 = a4;
  v12 = v8;
  return (unsigned int)anonymous_namespace_::NotifyIAMWindowManagementEvent((__int64)&v9, 0) != 0;
}
