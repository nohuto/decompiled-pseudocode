/*
 * XREFs of ?MNDeleteAdjustIndexes@@YAXPEAUtagMENUSTATE@@V?$SmartObjStackRef@UtagPOPUPMENU@@@@I@Z @ 0x1C0230B7C
 * Callers:
 ...
 *     ?NNDeleteAdjustIndex@@YAXPEAII@Z @ 0x1C0230C04 (-NNDeleteAdjustIndex@@YAXPEAII@Z.c)
 */
