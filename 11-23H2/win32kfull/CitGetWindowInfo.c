/*
 * XREFs of CitGetWindowInfo @ 0x1C005FC80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CitGetWindowInfo(__int64 a1, _WORD *a2)
{
  ...
  if ( result )
  {
    ...
    {
      Prop = (__int128 *)GetProp(result, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1LL);
      if ( Prop )
        v17 = *Prop;
    }
    ...
    *a2 = WORD4(v17) - v17;
    ...
    a2[4] = v5 | v14;
    result = GetProp(v4, *(unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Busy, 1LL);
    if ( result )
    {
