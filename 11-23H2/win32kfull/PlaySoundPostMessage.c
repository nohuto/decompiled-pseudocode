/*
 * XREFs of PlaySoundPostMessage @ 0x1C03993D0
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1C007A890 (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     PlaySndClient_midl_user_allocate @ 0x1C007A930 (PlaySndClient_midl_user_allocate.c)
 *     I_PlaySoundkPostMessage @ 0x1C007A95C (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_free @ 0x1C024AF00 (PlaySndClient_midl_user_free.c)
 */
