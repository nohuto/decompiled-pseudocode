/*
 * XREFs of ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C00DDD04
 * Callers:
...
_BOOL8 __fastcall GetFlickMap(struct tagFLICK_MAP *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v20[14] = (char *)a1 + 112;
  v20[2] = (char *)a1 + 16;
  if ( (unsigned int)RIMIsDefaultUILanguageRTL(a1, a2, a3, a4) != dword_1C0354024 )
  {
    v16 = xmmword_1C0354308;
    xmmword_1C0354308 = xmmword_1C03542A8;
    dword_1C0354024 = dword_1C0354024 == 0;
    xmmword_1C03542A8 = v16;
  }
...
LABEL_2:
    ...
    *(_OWORD *)a1 = xmmword_1C03542A8;
    *v4 = xmmword_1C03542C0;
    *((_OWORD *)a1 + 2) = xmmword_1C03542D8;
    *((_OWORD *)a1 + 3) = xmmword_1C03542F0;
    *((_OWORD *)a1 + 4) = xmmword_1C0354308;
    *((_OWORD *)a1 + 5) = xmmword_1C0354320;
    *((_OWORD *)a1 + 6) = xmmword_1C0354338;
    *((_OWORD *)a1 + 7) = xmmword_1C0354350;
  }
