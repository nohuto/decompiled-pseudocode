/*
 * XREFs of ?AdjustLegacyDeviceFlags@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C0037984
 * Callers:
 *     _RegisterRawInputDevices @ 0x1C0037EE8 (_RegisterRawInputDevices.c)
 * Callees:
 *     ?InProcessDeviceTypeRequestTable@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z @ 0x1C0037E60 (-InProcessDeviceTypeRequestTable@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z.c)
  ...
  if ( v6 )
  {
    ...
    *(_DWORD *)(v1 + 100) = v13;
    ...
    if ( gpqForeground )
    {
      ...
      if ( v14 )
      {
        if ( (unsigned int)HasHidTable(v14) && *(_QWORD *)(*(_QWORD *)(v15 + 424) + 856LL) == v1 )
    ...
    *(_DWORD *)(v1 + 100) &= 0xFFFFFFF3;
    if ( gpqForeground )
    {
      ...
      if ( v10 )
      {
        ...
        {
          if ( *(_QWORD *)(*(_QWORD *)(v11 + 424) + 856LL) == v1 )
            UpdateRawMouseMode(gpqForeground);
        }
      }
    }
