/*
 * XREFs of ?FreeMoveSizeData@MOVESIZEDATA@@SAXPEAPEAU1@@Z @ 0x1C0239AD0
 * Callers:
 *     ?xxxMoveSize@@YAXPEAUtagWND@@IK@Z @ 0x1C01EF350 (-xxxMoveSize@@YAXPEAUtagWND@@IK@Z.c)
 *     EditionFreeMoveSizeDataOnThreadDestroy @ 0x1C01F1900 (EditionFreeMoveSizeDataOnThreadDestroy.c)
 * Callees:
 *     <none>
 */
