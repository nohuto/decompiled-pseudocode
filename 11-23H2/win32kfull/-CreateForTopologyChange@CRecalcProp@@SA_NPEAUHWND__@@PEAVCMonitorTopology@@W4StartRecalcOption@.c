/*
 * XREFs of ?CreateForTopologyChange@CRecalcProp@@SA_NPEAUHWND__@@PEAVCMonitorTopology@@W4StartRecalcOption@@@Z @ 0x1C005D284
 * Callers:
    ...
    if ( v14 != 2 )
    {
      if ( v14 == 3 )
      {
        ...
        *((_QWORD *)v11 + 5) = *((_QWORD *)v11 + 4);
        CRecalcProp::PruneRecalcStateList(v11, 0LL);
      }
      else
      {
        if ( v14 )
