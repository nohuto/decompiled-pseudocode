/*
 * XREFs of ?HandleRawInput@@YA?AW4RAW_INPUT_PROCESSING_RESULT@@PEAXPEAU_KEYBOARD_INPUT_DATA@@PEBURAW_INPUT_SUPPLEMENTAL_INFO@@@Z @ 0x1C0036714
 * Callers:
...
LABEL_21:
    if ( *(_DWORD *)(a3 + 16)
      ...
      && (v13 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 424) + 856LL) + 100LL), (v13 & 0x20) != 0)
