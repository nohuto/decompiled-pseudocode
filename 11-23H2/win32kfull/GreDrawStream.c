/*
 * XREFs of GreDrawStream @ 0x1C00FA480
 * Callers:
 ...
 *     ?vDec_cRef@SURFACE@@QEAAXXZ @ 0x1C0276F70 (-vDec_cRef@SURFACE@@QEAAXXZ.c)
 *     ??0SURFREFDC@@QEAA@XZ @ 0x1C028E06C (--0SURFREFDC@@QEAA@XZ.c)
 */
