/*
 * XREFs of ?ObtainSectionForNetworkedFontFile@@YAJPEAU_UNICODE_STRING@@PEAU_FILEVIEW@@PEAU_OBJECT_ATTRIBUTES@@PEAT_LARGE_INTEGER@@_N@Z @ 0x1C028A270
 * Callers:
 ...
 *     ZwWin32CreateSectionRetainHandle @ 0x1C00CFB44 (ZwWin32CreateSectionRetainHandle.c)
