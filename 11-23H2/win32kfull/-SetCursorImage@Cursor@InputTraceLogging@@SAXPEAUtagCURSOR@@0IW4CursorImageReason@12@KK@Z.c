/*
 * XREFs of ?SetCursorImage@Cursor@InputTraceLogging@@SAXPEAUtagCURSOR@@0IW4CursorImageReason@12@KK@Z @ 0x1C002D6DC
 * Callers:
        ...
        int a6)
{
  ...
  {
    result = (_UNKNOWN **)tlgKeywordOn(&dword_1C0359080, 8LL);
    if ( (_BYTE)result )
    {
