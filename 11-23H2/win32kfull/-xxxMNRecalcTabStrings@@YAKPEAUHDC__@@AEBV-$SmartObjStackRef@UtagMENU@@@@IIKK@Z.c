/*
 * XREFs of ?xxxMNRecalcTabStrings@@YAKPEAUHDC__@@AEBV?$SmartObjStackRef@UtagMENU@@@@IIKK@Z @ 0x1C0237A2C
 * Callers:
...
__int64 __fastcall xxxMNRecalcTabStrings(Gre::Base *a1, __int64 a2, unsigned int a3, unsigned int a4, int a5, int a6)
{
  ...
  struct tagSIZE v45[8]; // [rsp+38h] [rbp-40h] BYREF
      ...
      if ( !v15 )
      {
        ...
        if ( CharPosition < v24 )
        {
          ...
          if ( v26 )
            ...
            GreGetTextExtentW((HDC)a1, v29, v30, v45);
          DPIMetrics = GetDPIMetrics(v31);
          v16 = *(_DWORD *)(DPIMetrics + 8) + v45[0].cx;
        }
        goto LABEL_17;
      }
LABEL_28:
