/*
 * XREFs of ?SearchProcessHidRequest@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESSINFO@@GGPEAK@Z @ 0x1C0038218
 * Callers:
 ...
 * Callees:
 *     ?SearchProcessHidRequestInclusion@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z @ 0x1C0038278 (-SearchProcessHidRequestInclusion@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z.c)
 */
        ...
        unsigned int *a4)
{
  ...
  if ( !*((_QWORD *)a1 + 107) )
    return 0LL;
  result = SearchProcessHidRequestInclusion(*((struct tagPROCESS_HID_TABLE **)a1 + 107), a2, a3);
  if ( result )
  {
    *v7 = 1;
  }
