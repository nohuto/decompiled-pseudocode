/*
 * XREFs of ?xxxPaintIconsInSwitchWindow@@YAXPEAUtagWND@@PEAUtagSwitchWndInfo@@PEAUHDC__@@HHHHHPEAUtagCURSOR@@@Z @ 0x1C01C8F9C
 * Callers:
 ...
 *     ?NextPrevPhwnd@@YAPEAPEAUHWND__@@PEAUtagSwitchWndInfo@@PEAPEAU1@H@Z @ 0x1C01C8B0C (-NextPrevPhwnd@@YAPEAPEAUHWND__@@PEAUtagSwitchWndInfo@@PEAPEAU1@H@Z.c)
 *     ?NextPrevTaskIndex@@YAHPEAUtagSwitchWndInfo@@HHH@Z @ 0x1C01C8B48 (-NextPrevTaskIndex@@YAHPEAUtagSwitchWndInfo@@HHH@Z.c)
        ...
        struct tagCURSOR *a9)
{
  ...
  v58 = 0LL;
  if ( a2 != Getpswi(a1) )
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTellMeIf", 0x20000, 837);
  LODWORD(v16) = 0;
  if ( DCEx )
  {
    v55 = 0;
...
LABEL_49:
        ...
        if ( (*(_BYTE *)(*((_QWORD *)v35 + 5) + 21LL) & 2) == 0 )
        {
          ...
          xxxSendMessageCallback(
            ...
            0LL,
            0LL,
            (void (__fastcall *)(struct tagWND *, _QWORD, unsigned __int64, __int64))DrawIconCallBack,
            (unsigned int)v39,
            0,
            0,
            1);
        ...
        v9 = (struct tagCURSOR *)qword_1C0359CF0;
      }
      if ( v9 )
        goto LABEL_49;
LABEL_36:
