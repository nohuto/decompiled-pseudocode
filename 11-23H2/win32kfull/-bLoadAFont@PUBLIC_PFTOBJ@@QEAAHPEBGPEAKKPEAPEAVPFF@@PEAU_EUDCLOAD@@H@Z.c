/*
 * XREFs of ?bLoadAFont@PUBLIC_PFTOBJ@@QEAAHPEBGPEAKKPEAPEAVPFF@@PEAU_EUDCLOAD@@H@Z @ 0x1C0019B48
 * Callers:
 *     ?vInitEmergencyStockFont@@YAXPEBG@Z @ 0x1C0019454 (-vInitEmergencyStockFont@@YAXPEBG@Z.c)
