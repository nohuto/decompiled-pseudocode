/*
 * XREFs of ?MakeITable@@YAHPEAEPEAURGBX@@H@Z @ 0x1C02A2D64
 * Callers:
 ...
 *     ?MakeITable256@@YAHPEAE@Z @ 0x1C02A2D0C (-MakeITable256@@YAHPEAE@Z.c)
 *     ?MakeITableMono@@YAHPEAE@Z @ 0x1C02A2F68 (-MakeITableMono@@YAHPEAE@Z.c)
 *     ?MakeITableVGA@@YAHPEAE@Z @ 0x1C02A2FBC (-MakeITableVGA@@YAHPEAE@Z.c)
 *     ?inv_cmap@@YAXHPEAURGBX@@HPEAKPEAE@Z @ 0x1C02A349C (-inv_cmap@@YAXHPEAURGBX@@HPEAKPEAE@Z.c)
 */
