/*
 * XREFs of ?BltLnkSrcCopyMsk1@@YAXPEAUBLTINFO@@PEAU_BLTLNK_MASKINFO@@PEAK2@Z @ 0x1C03045A0
 * Callers:
 *     <none>
 * Callees:
 *     ?BltLnkReadPat1@@YAXPEAEKPEBEKKKK@Z @ 0x1C03040A0 (-BltLnkReadPat1@@YAXPEAEKPEBEKKKK@Z.c)
 */
