/*
 * XREFs of _CloseDesktop @ 0x1C0028218
 * Callers:
 *     EditionCloseDesktopEntryPoint @ 0x1C00281D0 (EditionCloseDesktopEntryPoint.c)
...
__int64 __fastcall CloseDesktop(unsigned __int64 Handle, KPROCESSOR_MODE a2)
{
  ...
  else
  {
    ...
    {
      for ( i = *(_QWORD *)(v5 + 328); i; i = *(_QWORD *)(i + 664) )
      {
      ...
      if ( Object == *(PVOID *)(v5 + 344) && ((*(_QWORD *)(v5 + 392) ^ Handle) & 0xFFFFFFFFFFFFFFFCuLL) == 0 )
      {
