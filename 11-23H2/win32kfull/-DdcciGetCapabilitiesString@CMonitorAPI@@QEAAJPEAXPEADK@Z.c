/*
 * XREFs of ?DdcciGetCapabilitiesString@CMonitorAPI@@QEAAJPEAXPEADK@Z @ 0x1C0268600
 * Callers:
 *     NtGdiDDCCIGetCapabilitiesString @ 0x1C02699B0 (NtGdiDDCCIGetCapabilitiesString.c)
 * Callees:
