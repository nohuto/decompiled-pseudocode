/*
 * XREFs of ?bAddEntry@PFFMEMOBJ@@QEAAHKPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@1PEAU_UNIVERSAL_FONT_ID@@PEAU_EUDCLOAD@@@Z @ 0x1C00CB050
 * Callers:
 ...
 *     ?IsCHSBaseFont@@YAHPEBGI@Z @ 0x1C00CBC18 (-IsCHSBaseFont@@YAHPEBGI@Z.c)
