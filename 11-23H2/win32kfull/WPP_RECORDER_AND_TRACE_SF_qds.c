/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qds @ 0x1C0226D68
 * Callers:
        ...
        const char *a11)
{
  ...
  if ( a2 )
  {
    ...
    ((void (__fastcall *)(__int64, __int64, void *, __int64, char *, __int64, char *, __int64, const char *, __int64, _QWORD))pfnWppTraceMessage)(
      a1,
      43LL,
      &WPP_be08460427f83b68b58b8518e40b91a4_Traceguids,
      21LL,
      &a9,
      8LL,
      &a10,
  ...
  if ( a3 )
  {
    ...
    LOWORD(v19) = 21;
    WppAutoLogTrace(a4, 5LL, 7LL, &WPP_be08460427f83b68b58b8518e40b91a4_Traceguids, v19, &a9, 8LL, &a10);
  }
}
