/*
 * XREFs of InitDwmInputProcessing @ 0x1C009C860
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 InitDwmInputProcessing()
{
  ...
  WPP_MAIN_CB.Dpc.SystemArgument1 = (PVOID)CreateKernelEvent(1LL, 0LL);
  WPP_MAIN_CB.Dpc.DpcListEntry.Next = (struct _SINGLE_LIST_ENTRY *)CreateKernelEvent(1LL, 0LL);
  *(_QWORD *)&WPP_MAIN_CB.Dpc.TargetInfoAsUlong = CreateKernelEvent(1LL, 0LL);
