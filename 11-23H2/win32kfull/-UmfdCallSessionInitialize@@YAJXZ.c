/*
 * XREFs of ?UmfdCallSessionInitialize@@YAJXZ @ 0x1C007C40C
 * Callers:
 *     UmfdSessionInitialize @ 0x1C007C240 (UmfdSessionInitialize.c)
 * Callees:
 *     ?Create@CEventPool@@SAQEAV1@XZ @ 0x1C007C510 (-Create@CEventPool@@SAQEAV1@XZ.c)
 *     ?Create@CManualResetEvent@@SAQEAV1@XZ @ 0x1C007C55C (-Create@CManualResetEvent@@SAQEAV1@XZ.c)
 *     ?Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z @ 0x1C00987DC (-Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z.c)
 *     ??1?$CAutoDestroy@VCMultipleConsumerWorkQueue@@@@QEAA@XZ @ 0x1C0306998 (--1-$CAutoDestroy@VCMultipleConsumerWorkQueue@@@@QEAA@XZ.c)
 *     ??1?$CAutoDestroy@VCWorkItemQueue@@@@QEAA@XZ @ 0x1C03069B8 (--1-$CAutoDestroy@VCWorkItemQueue@@@@QEAA@XZ.c)
 */
