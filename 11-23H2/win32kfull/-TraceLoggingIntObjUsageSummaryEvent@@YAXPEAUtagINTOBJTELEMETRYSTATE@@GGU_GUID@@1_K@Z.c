/*
 * XREFs of ?TraceLoggingIntObjUsageSummaryEvent@@YAXPEAUtagINTOBJTELEMETRYSTATE@@GGU_GUID@@1_K@Z @ 0x1C02013A4
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C0354098, 0x800000000000LL) )
    {
      v37 = *((_QWORD *)v8 + 10);
      v10 = v8[3];
      v18 = v8[19];
