/*
 * XREFs of GreEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C0298160
 * Callers:
 *     NtGdiEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C02C1B40 (NtGdiEnsureDpiDepDefaultGuiFontForPlateau.c)
 * Callees:
