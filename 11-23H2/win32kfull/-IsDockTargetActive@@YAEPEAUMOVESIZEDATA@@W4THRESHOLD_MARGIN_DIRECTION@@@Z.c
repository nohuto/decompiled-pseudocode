/*
 * XREFs of ?IsDockTargetActive@@YAEPEAUMOVESIZEDATA@@W4THRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01E9998
 * Callers:
...
bool __fastcall IsDockTargetActive(__int64 a1, int a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 200) & 0x80000) == 0 )
    return *((_BYTE *)&unk_1C03591E0 + a2 + 24) != 0;
  result = 0;
  if ( *((_BYTE *)&unk_1C03591E0 + a2) )
    return *((_BYTE *)&unk_1C03591E0 + a2 + 4) != 0;
  return result;
}
