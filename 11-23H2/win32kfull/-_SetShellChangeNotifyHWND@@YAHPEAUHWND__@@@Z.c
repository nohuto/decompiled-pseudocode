/*
 * XREFs of ?_SetShellChangeNotifyHWND@@YAHPEAUHWND__@@@Z @ 0x1C009DB5C
 * Callers:
 *     NtUserSetShellChangeNotifyHWND @ 0x1C009DB20 (NtUserSetShellChangeNotifyHWND.c)
 * Callees:
  ...
  if ( v3 )
  {
    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( *(_DWORD *)(v7 + 780) == *(_DWORD *)(v8 + 780) )
        {
          v9 = PsGetCurrentProcessWin32Process(v8);
          v10 = v9;
          if ( v9 )
            v10 = -(__int64)(*(_QWORD *)v9 != 0LL) & v9;
          if ( *(_DWORD *)(v10 + 784) == *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v5 + 16) + 424LL) + 784LL) )
          {
            result = 1LL;
