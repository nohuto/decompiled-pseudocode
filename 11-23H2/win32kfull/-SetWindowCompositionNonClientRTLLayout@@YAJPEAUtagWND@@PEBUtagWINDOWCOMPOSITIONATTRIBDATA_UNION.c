/*
 * XREFs of ?SetWindowCompositionNonClientRTLLayout@@YAJPEAUtagWND@@PEBUtagWINDOWCOMPOSITIONATTRIBDATA_UNION@@@Z @ 0x1C01F694C
 * Callers:
        ...
        const struct tagWINDOWCOMPOSITIONATTRIBDATA_UNION *a2)
{
  ...
  {
    if ( -__CFSHR__(v9[0], 3) == v5 )
    {
      return 0;
    }
    else
    {
      v9[0] = v9[0] & 0xFFFFFFFB | (4 * v5);
