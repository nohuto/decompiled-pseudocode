/*
 * XREFs of GreStretchBltInternal @ 0x1C0100110
 * Callers:
 ...
 *     NtGdiStretchBlt @ 0x1C0070E90 (NtGdiStretchBlt.c)
 ...
 *     GreStretchBlt @ 0x1C013E874 (GreStretchBlt.c)
 *     NtUserBitBltSysBmp @ 0x1C01CC510 (NtUserBitBltSysBmp.c)
 *     ?CreateScaledWindowShadowFromDIB@@YAPEAUHBITMAP__@@PEAUtagWND@@PEAUHDC__@@J@Z @ 0x1C021FF60 (-CreateScaledWindowShadowFromDIB@@YAPEAUHBITMAP__@@PEAUtagWND@@PEAUHDC__@@J@Z.c)
 ...
 *     ??1UNDORENDERLOCKCOUNTS@@QEAA@XZ @ 0x1C0017900 (--1UNDORENDERLOCKCOUNTS@@QEAA@XZ.c)
 ...
 *     ?bValid@DLODCOBJ@@QEAA_NXZ @ 0x1C011CE34 (-bValid@DLODCOBJ@@QEAA_NXZ.c)
 ...
 *     ?TrgPlg@BLTRECORD@@QEAAHHHHH@Z @ 0x1C0292ABC (-TrgPlg@BLTRECORD@@QEAAHHHHH@Z.c)
...
LABEL_120:
                ...
                if ( (a13 & 2) == 0 || !LODWORD(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink) )
                  GreMovePointer(*((HDEV *)v55 + 6), -1, -1, 0);
...
LABEL_254:
                      ...
                      if ( (v58 & 2) == 0 || !LODWORD(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink) )
                        GreMovePointer(*((HDEV *)v55 + 6), v56, SHIDWORD(v236), 0);
