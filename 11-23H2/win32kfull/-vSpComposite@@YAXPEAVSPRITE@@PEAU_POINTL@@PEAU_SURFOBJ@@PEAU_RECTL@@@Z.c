/*
 * XREFs of ?vSpComposite@@YAXPEAVSPRITE@@PEAU_POINTL@@PEAU_SURFOBJ@@PEAU_RECTL@@@Z @ 0x1C0137328
 * Callers:
...
LABEL_18:
  ...
  v20 = (unsigned int)(*((_DWORD *)a1 + 25) + a4->top - *((_DWORD *)a1 + 29));
  v76.y = *((_DWORD *)a1 + 25) + a4->top - *((_DWORD *)a1 + 29);
  v21 = v15[4];
  v81 = v19;
  v22 = *((_QWORD *)v9 + 750);
  v23 = *((_QWORD *)v9 + 751);
