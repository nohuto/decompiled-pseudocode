/*
 * XREFs of ?xxxNotifyImeShowStatus@@YAXPEAUtagWND@@@Z @ 0x1C01B7B08
 * Callers:
 *     ?xxxSetIMEShowStatus@@YAHHHPEAH@Z @ 0x1C00D64F4 (-xxxSetIMEShowStatus@@YAHHHPEAH@Z.c)
 *     ?xxxBroadcastImeShowStatusChange@@YAHPEAUtagWND@@H@Z @ 0x1C01B72F4 (-xxxBroadcastImeShowStatusChange@@YAHPEAUtagWND@@H@Z.c)
 * Callees:
