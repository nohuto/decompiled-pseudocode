/*
 * XREFs of ?TraceChildWindowDpiTelemetry@@YAXPEAUtagWND@@0W4_CHILD_WINDOW_DPI_TELEMETRY@@@Z @ 0x1C000F68C
 * Callers:
 ...
 * Callees:
 *     GetProcessImageFilename @ 0x1C000F788 (GetProcessImageFilename.c)
