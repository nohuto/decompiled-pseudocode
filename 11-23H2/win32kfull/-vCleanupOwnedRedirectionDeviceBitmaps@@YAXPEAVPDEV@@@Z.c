/*
 * XREFs of ?vCleanupOwnedRedirectionDeviceBitmaps@@YAXPEAVPDEV@@@Z @ 0x1C007D1E8
 * Callers:
 *     vCleanupOwnedRedirectionDeviceBitmapsWrap @ 0x1C007D1D0 (vCleanupOwnedRedirectionDeviceBitmapsWrap.c)
 * Callees:
