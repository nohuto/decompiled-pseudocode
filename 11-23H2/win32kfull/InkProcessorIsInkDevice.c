/*
 * XREFs of InkProcessorIsInkDevice @ 0x1C01FDC80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsEnabled@InkProcessor@@QEBA_NXZ @ 0x1C023D73C (-IsEnabled@InkProcessor@@QEBA_NXZ.c)
 *     ?IsInkDevice@InkDeviceParser@@SA_NGGPEBG0@Z @ 0x1C023E4D0 (-IsInkDevice@InkDeviceParser@@SA_NGGPEBG0@Z.c)
 */
