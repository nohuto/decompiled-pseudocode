/*
 * XREFs of xxxDesktopThreadWaiter @ 0x1C002B130
 * Callers:
 ...
 *     SleepInputIdle @ 0x1C002B5F4 (SleepInputIdle.c)
...
__int64 __fastcall xxxDesktopThreadWaiter(char a1, unsigned __int8 a2)
{
  ...
  v4 = (LegacyInputDispatcher *)qword_1C035E180;
  if ( gptiCurrent == gTermIO[2] )
    v4 = (LegacyInputDispatcher *)qword_1C035E190;
  v5 = *((_DWORD *)v4 + 15);
  v6 = 0;
  if ( a1 )
