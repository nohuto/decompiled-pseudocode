/*
 * XREFs of DwmAsyncCreateDCompositionHwndTarget @ 0x1C008C318
 * Callers:
 *     ?ReNotifyDwm@CHwndTargetProp@@SAXPEAUtagWND@@@Z @ 0x1C002327C (-ReNotifyDwm@CHwndTargetProp@@SAXPEAUtagWND@@@Z.c)
 *     EditionNotifyDwmForSystemVisualCreation @ 0x1C008C280 (EditionNotifyDwmForSystemVisualCreation.c)
 * Callees:
