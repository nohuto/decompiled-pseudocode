/*
 * XREFs of ?ulGetEntries@XEPALOBJ@@QEAAKKKPEAUtagPALETTEENTRY@@H@Z @ 0x1C00271B0
 * Callers:
 ...
 *     PALOBJ_cGetColors @ 0x1C02D8730 (PALOBJ_cGetColors.c)
 *     XLATEOBJ_cGetPalette @ 0x1C02DB550 (XLATEOBJ_cGetPalette.c)
