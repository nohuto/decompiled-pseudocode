/*
 * XREFs of ?vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z @ 0x1C0287FAC
 * Callers:
...
struct _VERTEX_DATA *__fastcall vComputeSubspaces(unsigned int a1, struct _VERTEX_DATA *a2)
{
  ...
  if ( v10 + v9 <= 0x100 )
  {
    if ( v10 <= 0x80 )
    {
      ...
      if ( v29 )
      {
        *((_DWORD *)a2 + 1) = byte_1C03287B0[v12];
        *(_DWORD *)a2 = v29;
      ...
      {
        *(_DWORD *)a2 = v30;
        *((_DWORD *)a2 + 1) = byte_1C03287B0[(unsigned int)(v12 + 1)];
        a2 = (struct _VERTEX_DATA *)((char *)a2 + 8);
      }
      v31 = 2 * v15;
      v32 = 64 - v31 - v30 - v29;
      ...
      {
        *(_DWORD *)a2 = v32;
        *((_DWORD *)a2 + 1) = byte_1C03287B0[(unsigned int)(v12 + 3)];
        a2 = (struct _VERTEX_DATA *)((char *)a2 + 8);
      }
      if ( v31 )
      {
    ...
    else
    {
      ...
      {
        *(_DWORD *)a2 = v26;
        *((_DWORD *)a2 + 1) = byte_1C03287B0[(unsigned int)(v12 + 7)];
        a2 = (struct _VERTEX_DATA *)((char *)a2 + 8);
      }
      if ( v27 )
      {
  ...
  else if ( v10 + v4 <= 0x100 )
  {
    ...
    {
      *(_DWORD *)a2 = v22;
      *((_DWORD *)a2 + 1) = byte_1C03287B0[(unsigned int)(v12 + 9)];
      a2 = (struct _VERTEX_DATA *)((char *)a2 + 8);
    }
    if ( v23 )
    {
  ...
  else
  {
    ...
    {
      *(_DWORD *)a2 = v17;
      *((_DWORD *)a2 + 1) = byte_1C03287B0[(unsigned int)(v12 + 11)];
      a2 = (struct _VERTEX_DATA *)((char *)a2 + 8);
    }
    if ( v18 )
    {
...
LABEL_47:
      *((_DWORD *)a2 + 1) = byte_1C03287B0[v20];
