/*
 * XREFs of ?xxxEnableWindowGDIScaledDpiMessageX@@YA_NPEAUtagWND@@H@Z @ 0x1C021EFB8
 * Callers:
 *     NtUserEnableWindowGDIScaledDpiMessage @ 0x1C01CED00 (NtUserEnableWindowGDIScaledDpiMessage.c)
 * Callees:
