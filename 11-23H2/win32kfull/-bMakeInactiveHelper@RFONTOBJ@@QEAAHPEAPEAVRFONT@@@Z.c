/*
 * XREFs of ?bMakeInactiveHelper@RFONTOBJ@@QEAAHPEAPEAVRFONT@@@Z @ 0x1C006E81C
 * Callers:
 ...
 *     TraceGreReleaseSemaphore @ 0x1C013D854 (TraceGreReleaseSemaphore.c)
...
__int64 __fastcall RFONTOBJ::bMakeInactiveHelper(RFONTOBJ *this, struct RFONT **a2)
{
  ...
  struct RFONT *v44; // [rsp+B0h] [rbp+50h] BYREF
  ...
  if ( v7 )
  {
    ...
    RFONTOBJ::vDeleteRFONT((RFONTOBJ *)&v44, 0LL, (struct PFFOBJ *)v42, 1);
