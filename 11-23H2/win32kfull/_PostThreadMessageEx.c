/*
 * XREFs of _PostThreadMessageEx @ 0x1C01162B8
 * Callers:
 ...
 *     ?AdjustForCoalescing@@YAXPEAUtagMLIST@@PEAUHWND__@@I@Z @ 0x1C0116288 (-AdjustForCoalescing@@YAXPEAUtagMLIST@@PEAUHWND__@@I@Z.c)
...
LABEL_37:
  if ( (!(unsigned __int8)Enforced(v13) || *(_QWORD *)v11 == gpepCSRSS)
    && (*(_DWORD *)(v11 + 780) != *(_DWORD *)(v14 + 780) || *(_DWORD *)(v11 + 784) != *(_DWORD *)(v14 + 784)) )
  {
    goto LABEL_41;
  }
LABEL_22:
