/*
 * XREFs of ?CoalesceMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@_K@Z @ 0x1C0087D70
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CoalesceMessage(const struct tagQMSG *a1)
{
  ...
  {
    if ( (unsigned int)dword_1C0359080 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0359080, 16LL) )
    {
      ...
      v33 = 4;
      v27 = 2;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0359080, (int)&dword_1C031ABD7, 0, 0, v3 - 8, &v22);
    }
  }
  ...
  else if ( InputTraceLogging::IsMouseInputMessage(v1) && (unsigned int)dword_1C0359080 > 4 )
  {
