/*
 * XREFs of ?xxxDoLocalTSFWork@@YAXKPEAUtagWND@@JJKKPEAUtagTHREADINFO@@K@Z @ 0x1C01BF628
 * Callers:
        ...
        unsigned int a8)
{
  ...
  if ( (v17 & 0x1700) != 0 && v17 && (v17 & 0xFFFFE8FC) == 0 )
  {
    if ( (v15 & 2) != 0 )
    {
      Notify = CreateNotify(0LL, v11, a2, v9, v8, (PETHREAD *)a7, a8, 1u);
      if ( Notify )
        *((_QWORD *)Notify + 8) = a7;
    }
    else if ( v16 )
    {
      CreateAndPostTSFNotify(v11, a2, v9, v8, a7, a7, a8);
    }
    else
    {
