/*
 * XREFs of _EnableModernAppWindowKeyboardIntercept @ 0x1C01E2DE8
 * Callers:
 *     NtUserEnableModernAppWindowKeyboardIntercept @ 0x1C01CEB70 (NtUserEnableModernAppWindowKeyboardIntercept.c)
 * Callees:
...
__int64 __fastcall EnableModernAppWindowKeyboardIntercept(__int64 a1, int a2)
{
  ...
  v7 = *(_QWORD *)(a1 + 16);
  if ( *(_QWORD *)(v7 + 424) != v6 || (*(_DWORD *)(v6 + 824) & 0x30) != 0x10 && !(unsigned int)IsImmersiveBroker(v6) )
  {
    v8 = 5;
LABEL_14:
    UserSetLastError(v8);
