/*
 * XREFs of ?ReleaseKernelmodeAllocation@UmfdAllocation@@SAXPEAX@Z @ 0x1C009A208
 * Callers:
 ...
 *     ??1?$AutoReleasePtr@U_FD_GLYPHSET@@$1?ReleaseKernelmodeAllocation@UmfdAllocation@@SAXPEAX@Z@@QEAA@XZ @ 0x1C0305B70 (--1-$AutoReleasePtr@U_FD_GLYPHSET@@$1-ReleaseKernelmodeAllocation@UmfdAllocation@@SAXPEAX@Z@@QEA.c)
 * Callees:
