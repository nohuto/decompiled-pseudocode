/*
 * XREFs of ?LoadModuleWorkHorse@@YAPEAXPEAGH@Z @ 0x1C028A060
 * Callers:
 *     EngLoadModule @ 0x1C028ACC0 (EngLoadModule.c)
 *     EngLoadModuleForWrite @ 0x1C028ACE0 (EngLoadModuleForWrite.c)
 * Callees:
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x1C0115E6C (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
 *     ?GetModuleHandleAndIncrementRefcount@@YAPEAXPEBG@Z @ 0x1C0289F84 (-GetModuleHandleAndIncrementRefcount@@YAPEAXPEBG@Z.c)
 *     bMapFile @ 0x1C028B228 (bMapFile.c)
 *     MakeSystemRelativePath @ 0x1C030536C (MakeSystemRelativePath.c)
 */
