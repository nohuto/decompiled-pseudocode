/*
 * XREFs of ?SendRequest@CApiPortClient@@QEAAJPEBXFPEAXIPEAJ1F@Z @ 0x18000DF74
 * Callers:
        ...
        int a8)
{
  ...
  if ( !byte_180016C58 )
  {
    if ( (unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_2163525945>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_2163525945>::GetImpl'::`2'::impl) )
    {
      ...
      {
        v13 = (volatile signed __int32 *)*(&xmmword_180016C20 + 1);
        ...
        EnterCriticalSection(&stru_180016C30);
        v16 = (CPortClient *)*(&xmmword_180016C20 + 1);
        if ( *(&xmmword_180016C20 + 1)
...
LABEL_14:
    ...
    else
    {
      ...
      do
      {
        ...
        v24 = (volatile signed __int32 *)*(&xmmword_180016C20 + 1);
        if ( *(&xmmword_180016C20 + 1) )
          _InterlockedAdd((volatile signed __int32 *)*(&xmmword_180016C20 + 1) + 14, 1u);
        LeaveCriticalSection(&stru_180016C30);
        v26 = CPortClient::SendComplexSyncRequest((CPortClient *)v24, *a2, a2, v25, v31, v32, v33, v34, &a8);
        if ( v24 && _InterlockedExchangeAdd(v24 + 14, 0xFFFFFFFF) == 1 )
          (**(void (__fastcall ***)(volatile signed __int32 *, __int64))v24)(v24, 1LL);
        EnterCriticalSection(&stru_180016C30);
        v20 = (CApiPortClient *)*(&xmmword_180016C20 + 1);
        if ( *(&xmmword_180016C20 + 1)
          && _InterlockedCompareExchange((volatile signed __int32 *)*(&xmmword_180016C20 + 1) + 14, 1, 1) == 1 )
        {
