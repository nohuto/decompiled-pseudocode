/*
 * XREFs of ?ReportAggregatedValues@_unnamed_type_gDwmInitTelemetryAggregator_@@QEAAXXZ @ 0x18000B628
 * Callers:
        ...
        _unnamed_type_gDwmInitTelemetryAggregator_ *this)
{
  ...
  if ( (gDwmInitTelemetryAggregator
     || (_DWORD)qword_180016C84
     || __PAIR64__(HIDWORD(qword_180016C84), 0) != (unsigned int)qword_180016C8C)
    && (unsigned int)dword_180016000 > 5
    && (qword_180016010 & 0x400000000000LL) != 0
    && (qword_180016018 & 0x400000000000LL) == qword_180016018 )
  {
    v1 = qword_180016C8C;
    v19 = &gDwmInitTargetAppSessionGuid;
    v2 = HIDWORD(qword_180016C84);
    v17 = &v1;
    v3 = qword_180016C84;
    v15 = &v2;
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_180012413,
      0LL,
      0LL,
      9u,
      &v6);
