/*
 * XREFs of DwmpStartWinlogonMouseThread @ 0x18000C860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$?8VCKstWinLogon@@U?$default_delete@VCKstWinLogon@@@std@@@std@@YA_NAEBV?$unique_ptr@VCKstWinLogon@@U?$default_delete@VCKstWinLogon@@@std@@@0@$$T@Z @ 0x18000A364 (--$-8VCKstWinLogon@@U-$default_delete@VCKstWinLogon@@@std@@@std@@YA_NAEBV-$unique_ptr@VCKstWinLo.c)
