/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x180004F54
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( ValueInternal < 0 )
  {
    wil::details::in1diag3::Return_Hr(
      ...
      304);
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x6B, (unsigned int)"wil", (const char *)v7, v29);
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x128, (unsigned int)"wil", (const char *)v7, v30);
...
LABEL_26:
    ...
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x147, (unsigned int)"wil", (const char *)(unsigned int)v22, 304);
    wil::details_abi::SemaphoreValue::~SemaphoreValue((wil::details_abi::SemaphoreValue *)&v33);
  ...
  {
    v21 = -2147024882;
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x144, (unsigned int)"wil", (const char *)0x8007000ELL, 304);
  }
  wil::details::in1diag3::Return_Hr(retaddr, (void *)0x130, (unsigned int)"wil", (const char *)v21, v31);
  if ( v12 && !ReleaseMutex(v12) )
    wil::details::in1diag3::_FailFast_GetLastError(
      retaddr,
      (void *)0x941,
