/*
 * XREFs of ?SendNotification@CApiPortClient@@QEAAJPEAXF@Z @ 0x18000DE08
 * Callers:
 *     DwmpUpdateUserSettings @ 0x18000D090 (DwmpUpdateUserSettings.c)
 * Callees:
...
__int64 __fastcall CApiPortClient::SendNotification(CApiPortClient *this, unsigned int *a2)
{
  ...
  if ( !byte_180016C58 )
  {
    ...
    do
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v9, &CApiPortClient::MILINSTRUMENTATIONHRESULTLIST, 2LL, v8, 0x72u);
        goto LABEL_17;
      }
      v10 = (volatile signed __int32 *)*(&xmmword_180016C20 + 1);
      if ( *(&xmmword_180016C20 + 1) )
        _InterlockedAdd((volatile signed __int32 *)*(&xmmword_180016C20 + 1) + 14, 1u);
      ...
      EnterCriticalSection(&stru_180016C30);
      v6 = (CApiPortClient *)*(&xmmword_180016C20 + 1);
      if ( *(&xmmword_180016C20 + 1)
        && _InterlockedCompareExchange((volatile signed __int32 *)*(&xmmword_180016C20 + 1) + 14, 1, 1) == 1 )
      {
    ...
    v3 = v14;
    if ( v14 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v15, &CApiPortClient::MILINSTRUMENTATIONHRESULTLIST, 2LL, v14, 0x8Bu);
  }
LABEL_17:
  LeaveCriticalSection(&stru_180016C30);
  return v3;
