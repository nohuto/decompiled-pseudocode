/*
 * XREFs of ?GetValueFromSemaphore@SemaphoreValue@details_abi@wil@@CAJPEAXPEAJ@Z @ 0x140004C94
 * Callers:
 ...
 * Callees:
 *     ?Return_GetLastError@in1diag3@details@wil@@YAJPEAXIPEBD@Z @ 0x14000BC8C (-Return_GetLastError@in1diag3@details@wil@@YAJPEAXIPEBD@Z.c)
