/*
 * XREFs of ?Release@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x14000BB98
 * Callers:
 ...
 *     ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x140009FC4 (--1FeatureStateManager@details@wil@@QEAA@XZ.c)
 * Callees:
