/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_keyboard_l1_1_0_dll @ 0x140006C48
 * Callers:
 *     __imp_load_RegisterHotKey @ 0x140006C3C (__imp_load_RegisterHotKey.c)
 *     __imp_load_UnregisterHotKey @ 0x140006CC7 (__imp_load_UnregisterHotKey.c)
 * Callees:
