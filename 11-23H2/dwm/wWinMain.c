 ...
 *     McGenEventRegister_EtwEventRegister @ 0x140003754 (McGenEventRegister_EtwEventRegister.c)
...
LABEL_13:
    v13 = v6;
LABEL_14:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1400111B8, 5LL, v13, v17);
  }
