/*
 * XREFs of ??1?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UIHotKeyClientOwner@Text@Internal@UI@Windows@@@Details@WRL@Microsoft@@UEAA@XZ @ 0x14000C904
 * Callers:
 *     ??1HotKeyCallback@@UEAA@XZ @ 0x14000C95C (--1HotKeyCallback@@UEAA@XZ.c)
 *     ??_E?$RuntimeClass@UIHotKeyClientOwner@Text@Internal@UI@Windows@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x14000C9D0 (--_E-$RuntimeClass@UIHotKeyClientOwner@Text@Internal@UI@Windows@@@WRL@Microsoft@@UEAAPEAXI@Z.c)
 * Callees:
