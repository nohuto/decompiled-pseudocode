/*
 * XREFs of ?DoDisplayModeReset@CBlackScreenDiagnosticReport@BlackScreenDiagnostics@@AEAAXAEBU_GUID@@@Z @ 0x14000DBB4
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  else
  {
    if ( (unsigned int)dword_140017000 > 5 && (unsigned __int8)tlgKeywordOn() )
    {
      ...
      v14 = 16;
      v11 = 8;
      tlgWriteTransfer_EventWriteTransfer((int)&dword_140017000, (int)&dword_1400124A2, 0, 0, 5u, &v9);
    }
    LOBYTE(v3) = 1;
