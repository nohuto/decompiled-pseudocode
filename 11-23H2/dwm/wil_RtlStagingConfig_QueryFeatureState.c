/*
 * XREFs of wil_RtlStagingConfig_QueryFeatureState @ 0x140007598
 * Callers:
 ...
 * Callees:
 *     ?wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ @ 0x140005734 (-wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ.c)
