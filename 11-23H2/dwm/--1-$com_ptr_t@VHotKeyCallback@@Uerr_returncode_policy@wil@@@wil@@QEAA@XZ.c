/*
 * XREFs of ??1?$com_ptr_t@VHotKeyCallback@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x140005880
 * Callers:
 *     _dynamic_atexit_destructor_for__g_spHotkeyCallback__ @ 0x1400087B0 (_dynamic_atexit_destructor_for__g_spHotkeyCallback__.c)
 * Callees:
