/*
 * XREFs of ?Run@CBlackScreenDiagnosticReport@BlackScreenDiagnostics@@AEAAXW4CallingSource@2@W4DiagnosticFlags@2@AEBU_GUID@@@Z @ 0x14000E584
 * Callers:
 ...
 *     ?GetVidPnOwner@CBlackScreenDiagnosticReport@BlackScreenDiagnostics@@AEAAPEBGXZ @ 0x14000E234 (-GetVidPnOwner@CBlackScreenDiagnosticReport@BlackScreenDiagnostics@@AEAAPEBGXZ.c)
...
LABEL_12:
  ...
  if ( (v5 & 2) != 0 )
  {
    if ( (unsigned int)dword_140017000 > 5 && (unsigned __int8)tlgKeywordOn() )
    {
      v36 = (__int64)a4;
      v37 = 0x1000000LL;
