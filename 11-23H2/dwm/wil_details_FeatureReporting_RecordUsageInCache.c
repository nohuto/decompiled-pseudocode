/*
 * XREFs of wil_details_FeatureReporting_RecordUsageInCache @ 0x140008268
 * Callers:
 ...
 * Callees:
 *     wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x140008078 (wil_details_FeatureReporting_IncrementOpportunityInCache.c)
 *     wil_details_FeatureReporting_IncrementUsageInCache @ 0x14000816C (wil_details_FeatureReporting_IncrementUsageInCache.c)
 */
