/*
 * XREFs of ?ReportEventW@CDwmAppHost@@AEAAXGKPEBG0@Z @ 0x1400042B8
 * Callers:
 ...
 * Callees:
 *     ??1?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?DeregisterEventSource@@YAH0@Z@details@wil@@@details@wil@@IEAA@XZ @ 0x140004378 (--1-$unique_storage@U-$handle_null_resource_policy@P6AHPEAX@Z$1-DeregisterEventSource@@YAH0@Z@de.c)
 */
