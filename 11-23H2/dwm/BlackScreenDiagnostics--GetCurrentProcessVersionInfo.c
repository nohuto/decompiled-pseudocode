/*
 * XREFs of BlackScreenDiagnostics::GetCurrentProcessVersionInfo @ 0x14000DCE0
 * Callers:
 ...
 *     memmove_0 @ 0x1400085F8 (memmove_0.c)
 ...
 *     ??$_Deallocate@$0BA@$0A@@std@@YAXPEAX_K@Z @ 0x14000D8D4 (--$_Deallocate@$0BA@$0A@@std@@YAXPEAX_K@Z.c)
 ...
 *     ??1?$_Tidy_guard@V?$vector@EV?$allocator@E@std@@@std@@@std@@QEAA@XZ @ 0x14000DA88 (--1-$_Tidy_guard@V-$vector@EV-$allocator@E@std@@@std@@@std@@QEAA@XZ.c)
 ...
 *     ??1?$vector@EV?$allocator@E@std@@@std@@QEAA@XZ @ 0x14000DB64 (--1-$vector@EV-$allocator@E@std@@@std@@QEAA@XZ.c)
