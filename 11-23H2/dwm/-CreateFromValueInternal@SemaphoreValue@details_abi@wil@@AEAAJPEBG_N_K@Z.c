/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x14000A3C8
 * Callers:
 ...
 *     StringCopyWorkerW @ 0x140007334 (StringCopyWorkerW.c)
 *     StringValidateDestAndLengthW @ 0x1400073F0 (StringValidateDestAndLengthW.c)
