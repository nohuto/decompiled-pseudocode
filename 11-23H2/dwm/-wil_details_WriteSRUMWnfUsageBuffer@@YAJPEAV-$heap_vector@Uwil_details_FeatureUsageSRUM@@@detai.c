/*
 * XREFs of ?wil_details_WriteSRUMWnfUsageBuffer@@YAJPEAV?$heap_vector@Uwil_details_FeatureUsageSRUM@@@details_abi@wil@@@Z @ 0x14000C454
 * Callers:
...
LABEL_11:
        ...
        updated = wil_details_NtUpdateWnfStateData((__int64)&unk_140012598, (__int64)v18, v7, v7, v15, v17[0], 1);
      }
      ++v6;
    }
