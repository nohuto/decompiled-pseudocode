/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x140004D48
 * Callers:
 ...
 * Callees:
 *     ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x1400056C4 (-CloseHandle@details@wil@@YAXPEAX@Z.c)
 */
