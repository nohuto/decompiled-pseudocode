/*
 * XREFs of ?NotifyWndProc@CDwmAppHost@@AEAA_JPEAUHWND__@@I_K_J@Z @ 0x1400028E4
 * Callers:
 *     ?s_NotifyWndProc@CDwmAppHost@@CA_JPEAUHWND__@@I_K_J@Z @ 0x1400028C0 (-s_NotifyWndProc@CDwmAppHost@@CA_JPEAUHWND__@@I_K_J@Z.c)
 * Callees:
...
LRESULT __fastcall CDwmAppHost::NotifyWndProc(CDwmAppHost *this, HWND a2, UINT a3, unsigned __int64 a4, LPARAM lParam)
{
  ...
  if ( a3 != 786 )
  {
    ...
    v8 = 4;
LABEL_13:
    CDwmAppHost::LpcNotifySettingsChange(this, v8);
    return v5;
  }
  if ( !a4 )
