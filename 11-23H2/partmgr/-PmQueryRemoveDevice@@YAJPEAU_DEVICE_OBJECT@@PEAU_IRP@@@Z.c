/*
 * XREFs of ?PmQueryRemoveDevice@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z @ 0x1C000EE44
 * Callers:
...
__int64 __fastcall PmQueryRemoveDevice(struct _DEVICE_OBJECT *a1, struct _IRP *a2)
{
  ...
  v4 = (struct _LIST_ENTRY *)(DeviceExtension + 688);
  v5 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)DeviceExtension + 14);
  if ( v4->Flink == v4 )
  {
    *((_DWORD *)DeviceExtension + 128) |= 0x100u;
    PmWakeupNotificationWorkItem((__int64)DeviceExtension);
  }
  v6 = (struct _LIST_ENTRY *)*((_QWORD *)DeviceExtension + 87);
  ...
  *((_QWORD *)DeviceExtension + 87) = p_ListEntry;
