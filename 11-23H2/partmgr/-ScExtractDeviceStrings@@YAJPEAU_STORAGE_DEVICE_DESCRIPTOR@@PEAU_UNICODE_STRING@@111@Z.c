/*
 * XREFs of ?ScExtractDeviceStrings@@YAJPEAU_STORAGE_DEVICE_DESCRIPTOR@@PEAU_UNICODE_STRING@@111@Z @ 0x1C0009EE8
 * Callers:
 ...
 *     ?SaveStorageProperty@SC_DEVICE@@MEAAXW4_STORAGE_PROPERTY_ID@@PEAU_STORAGE_DESCRIPTOR_HEADER@@@Z @ 0x1C00118B0 (-SaveStorageProperty@SC_DEVICE@@MEAAXW4_STORAGE_PROPERTY_ID@@PEAU_STORAGE_DESCRIPTOR_HEADER@@@Z.c)
 * Callees:
        ...
        struct _UNICODE_STRING *a5)
{
  ...
  do
  {
    ...
    {
      v11 = ScAnsiToUnicodeString((PCSZ)a1 + v13, *v5);
      if ( v11 < 0 )
        break;
    }
    ++v12;
