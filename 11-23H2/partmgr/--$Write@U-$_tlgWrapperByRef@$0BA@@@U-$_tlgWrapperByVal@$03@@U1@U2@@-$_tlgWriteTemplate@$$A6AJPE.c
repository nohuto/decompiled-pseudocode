/*
 * XREFs of ??$Write@U?$_tlgWrapperByRef@$0BA@@@U?$_tlgWrapperByVal@$03@@U1@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByRef@$0BA@@@AEBU?$_tlgWrapperByVal@$03@@34@Z @ 0x1C000F3E0
 * Callers:
        ...
        __int64 a8)
{
  ...
  v12 = 16LL;
  v11 = *a5;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0017048, a2, 0LL, 0LL, 6u, &v10);
}
