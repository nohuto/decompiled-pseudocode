/*
 * XREFs of ?Read@PM_DRIVE@@UEAAJ_KKPEAE@Z @ 0x1C001DFF0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
int __fastcall PM_DRIVE::Read(PM_DRIVE *this, union _LARGE_INTEGER a2, ULONG a3, unsigned __int8 *a4)
{
  PIRP v7; // rax
  int result; // eax
  ...
  if ( !v7 )
    return -1073741670;
  v7->Tail.Overlay.CurrentStackLocation[-1].Flags |= 2u;
