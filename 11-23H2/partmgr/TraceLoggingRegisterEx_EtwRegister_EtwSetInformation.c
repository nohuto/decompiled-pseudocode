/*
 * XREFs of TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x1C0023238
 * Callers:
...
__int64 TraceLoggingRegisterEx_EtwRegister_EtwSetInformation()
{
  ...
  if ( RegHandle )
    __fastfail(5u);
  xmmword_1C0017070 = 0LL;
  v0 = EtwRegister(&ProviderId, tlgEnableCallback, &dword_1C0017048, &RegHandle);
  if ( !v0 )
