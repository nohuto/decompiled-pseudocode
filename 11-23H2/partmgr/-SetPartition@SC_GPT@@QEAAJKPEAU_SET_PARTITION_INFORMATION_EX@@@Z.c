/*
 * XREFs of ?SetPartition@SC_GPT@@QEAAJKPEAU_SET_PARTITION_INFORMATION_EX@@@Z @ 0x1C00116B0
 * Callers:
...
__int64 __fastcall SC_GPT::SetPartition(SC_DISK **this, int a2, struct _SET_PARTITION_INFORMATION_EX *a3)
{
  ...
  if ( a2 )
  {
    PartitionTable = SC_GPT::ReadPartitionTable(this, (struct SC_DISK_LAYOUT **)&P);
    v8 = (struct SC_DISK_LAYOUT *)P;
    v6 = PartitionTable;
    if ( PartitionTable >= 0 )
    {
      v9 = (unsigned int)(a2 - 1);
      if ( (unsigned int)v9 < *((_DWORD *)P + 1) )
      {
        v10 = 18 * v9;
        *(_OWORD *)((char *)P + 8 * v10 + 80) = *(_OWORD *)&a3->Mbr.PartitionType;
