/*
 * XREFs of ?OnChanged@CVisual@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x18004A410
 * Callers:
...
__int64 __fastcall CVisual::OnChanged(CVisual *a1, int a2, __int64 a3)
{
  ...
  DwmDbg::DbgString *v70; // rbx
  DwmDbg::DbgString *v71; // rax
  DwmDbg::DbgString *v72; // rbx
  DwmDbg::DbgString *v73; // rax
  DwmDbg::DbgString *v74; // rbx
  DwmDbg::DbgString *v75; // rax
  DwmDbg::DbgString *v76; // rbx
  DwmDbg::DbgString *v77; // rax
  __int64 v78; // rsi
  __int64 v79; // r14
  __int64 v80; // rax
  int v81; // eax
  ...
  char *v97; // [rsp+A0h] [rbp-60h] BYREF
  char *v98; // [rsp+A8h] [rbp-58h] BYREF
  char *v99; // [rsp+B0h] [rbp-50h] BYREF
  char *v100; // [rsp+B8h] [rbp-48h] BYREF
  char *v101; // [rsp+C0h] [rbp-40h] BYREF
  char *v102; // [rsp+C8h] [rbp-38h] BYREF
  char *v103; // [rsp+D0h] [rbp-30h] BYREF
  char *v104; // [rsp+D8h] [rbp-28h] BYREF
...
LABEL_25:
    if ( dword_1803E3760 )
    {
      ...
      {
        v70 = DwmDbg::DbgString::DbgString(&v97, "m_fIsBackdropBlur=%d", v10);
        v71 = DwmDbg::DbgString::DbgString(&v98, "Visual-IsBackdropBlurFlagChanged");
      ...
      {
        v72 = DwmDbg::DbgString::DbgString(&v99, "m_fHasBlurredWallpaperBackdropInput=%d", v14);
        v73 = DwmDbg::DbgString::DbgString(&v100, "Visual-HasBlurredWallpaperBackdropInputFlagChanged");
    ...
    *(_BYTE *)(v5 + 102) |= 4 * (v10 & 1);
    if ( (v6 != 0LL) != (*v19 & 1) )
    {
      if ( dword_1803E3760 )
      {
        v74 = DwmDbg::DbgString::DbgString(&v101, "m_fHasBackdropInput=%d", v6 != 0LL);
        v75 = DwmDbg::DbgString::DbgString(&v102, "Visual-HasBackdropInputFlagChanged");
    ...
    if ( v13 != ((*v19 & 4) != 0) )
    {
      if ( dword_1803E3760 )
      {
        v76 = DwmDbg::DbgString::DbgString(&v103, "m_fHasWindowBackdropInput=%d", v13);
        v77 = DwmDbg::DbgString::DbgString(&v104, "Visual-HasWindowBackdropInputFlagChanged");
