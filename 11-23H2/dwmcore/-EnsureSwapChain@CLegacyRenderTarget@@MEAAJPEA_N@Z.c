/*
 * XREFs of ?EnsureSwapChain@CLegacyRenderTarget@@MEAAJPEA_N@Z @ 0x1800FD990
 * Callers:
 *     <none>
 * Callees:
  ...
  *a2 = 0;
  ...
  if ( !v4 )
  {
    ...
    *((_DWORD *)this + 4614) = *((_DWORD *)this + 4606);
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180356BC8, 4u, v10, 0x466u, 0LL);
      goto LABEL_18;
    }
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_180356BC8, 4u, v12, 0x471u, 0LL);
      goto LABEL_18;
    }
    ...
    if ( Device < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_180356BC8, 4u, Device, 0x473u, 0LL);
      v25 = v29;
      if ( !v29 )
        goto LABEL_18;
      goto LABEL_17;
    ...
    if ( *((_DWORD *)this + 30) > 1u )
    {
      *((_BYTE *)this + 18698) = 0;
      ...
      ConversionSwapChain = CD3DDevice::CreateConversionSwapChain(
                              ...
                              *((_DWORD *)this + 4607),
                              (struct ILegacySwapChain **)v2);
      v6 = ConversionSwapChain;
      if ( ConversionSwapChain >= 0 )
      {
LABEL_11:
        *((_QWORD *)this + 2304) = *(_QWORD *)(*(__int64 (__fastcall **)(__int64, CD3DDevice **))(*(_QWORD *)*v2 + 48LL))(
                                                *v2,
                                                &v29);
        v20 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)*v2 + 56LL))(*v2);
        v21 = *v2;
        *((_DWORD *)this + 4612) = v20;
        *((_DWORD *)this + 4613) = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v21 + 64LL))(v21);
        v22 = COverlayContext::OnSwapChainCreated((CLegacyRenderTarget *)((char *)this + 200));
        v6 = v22;
        if ( v22 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_180356BC8, 4u, v22, 0x496u, 0LL);
        }
        else
        {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v27, &dword_180356BC8, 4u, ConversionSwapChain, 0x48Fu, 0LL);
    }
    else
    {
      wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::reset(v2);
      ...
      if ( LegacySwapChain >= 0 )
        goto LABEL_11;
      MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_180356BC8, 4u, LegacySwapChain, 0x482u, 0LL);
    }
LABEL_15:
    if ( !v17 )
    {
...
LABEL_17:
  ...
  {
    v6 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180356BC8, 4u, -2003304442, 0x45Bu, 0LL);
    goto LABEL_32;
  }
  return v6;
}
