/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::_FrameSequenceInfo @ 0x1800B1DB8
 * Callers:
 ...
 *     _anonymous_namespace_::_dynamic_atexit_destructor_for___currentSequence__ @ 0x180124050 (_anonymous_namespace_--_dynamic_atexit_destructor_for___currentSequence__.c)
 * Callees:
