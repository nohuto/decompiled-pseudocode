/*
 * XREFs of ?EnsureDDisplayManager@CDDisplayManager@@QEAAJXZ @ 0x180294200
 * Callers:
...
__int64 __fastcall CDDisplayManager::EnsureDDisplayManager(CDDisplayManager *this)
{
  ...
  _QWORD *v7; // rbx
  __int64 v8; // rax
  __int64 (__fastcall *v9)(_QWORD *, __int64, void *); // rdi
  int v10; // eax
  __int64 v11; // rcx
  HRESULT v12; // eax
  __int64 v13; // rcx
  ...
  if ( !g_DDisplayManager )
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v9 = *(__int64 (__fastcall **)(_QWORD *, __int64, void *))(v8 + 48);
        if ( v6 )
