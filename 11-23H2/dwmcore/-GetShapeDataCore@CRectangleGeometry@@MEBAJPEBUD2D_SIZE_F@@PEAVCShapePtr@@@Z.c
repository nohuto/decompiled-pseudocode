/*
 * XREFs of ?GetShapeDataCore@CRectangleGeometry@@MEBAJPEBUD2D_SIZE_F@@PEAVCShapePtr@@@Z @ 0x18005A570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRectangleGeometry::GetShapeDataCore(
        ...
        struct CShapePtr *a3)
{
  CRoundedRectangleShape::SharedData *v3; // r14
  float *v4; // rdi
  float *v6; // rax
  ...
  CRoundedRectangleShape::SharedData *v28; // rax
...
LABEL_36:
        *((_QWORD *)v20 + 2) = v3;
        if ( v3 )
          (**(void (__fastcall ***)(CRoundedRectangleShape::SharedData *))v3)(v3);
        goto LABEL_25;
      }
      v28 = (CRoundedRectangleShape::SharedData *)CRoundedRectangleShape::FlattenedShapeSharedData::FlattenedShapeSharedData(
                                                    v34,
