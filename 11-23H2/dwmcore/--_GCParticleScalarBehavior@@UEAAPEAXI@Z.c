/*
 * XREFs of ??_GCParticleScalarBehavior@@UEAAPEAXI@Z @ 0x1801C30E0
 * Callers:
 *     ??_ECParticleScalarBehavior@@WHA@EAAPEAXI@Z @ 0x18011B9D0 (--_ECParticleScalarBehavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
