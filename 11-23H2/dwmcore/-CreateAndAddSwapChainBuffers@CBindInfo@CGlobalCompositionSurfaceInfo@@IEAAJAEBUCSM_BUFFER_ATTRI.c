/*
 * XREFs of ?CreateAndAddSwapChainBuffers@CBindInfo@CGlobalCompositionSurfaceInfo@@IEAAJAEBUCSM_BUFFER_ATTRIBUTES@@I@Z @ 0x18009ECE0
 * Callers:
 ...
 * Callees:
 *     ??0CDecodeBitmap@@QEAA@XZ @ 0x18001BD14 (--0CDecodeBitmap@@QEAA@XZ.c)
 ...
 *     ??$_Resize@U_Value_init_tag@std@@@?$vector@UCSM_REALIZATION_INFO@@V?$allocator@UCSM_REALIZATION_INFO@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x1800E581C (--$_Resize@U_Value_init_tag@std@@@-$vector@UCSM_REALIZATION_INFO@@V-$allocator@UCSM_REALIZATION_.c)
 ...
 *     ??1?$vector@V?$com_ptr_t@VISwapChainRealization@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VISwapChainRealization@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x180133FFC (--1-$vector@V-$com_ptr_t@VISwapChainRealization@@Uerr_returncode_policy@wil@@@wil@@V-$allocator@.c)
 ...
 *     ??1?$vector@UCSM_REALIZATION_INFO@@V?$allocator@UCSM_REALIZATION_INFO@@@std@@@std@@QEAA@XZ @ 0x18025A5A4 (--1-$vector@UCSM_REALIZATION_INFO@@V-$allocator@UCSM_REALIZATION_INFO@@@std@@@std@@QEAA@XZ.c)
 */
        ...
        unsigned int a3)
{
  ...
  *((_BYTE *)this + 96) = 0;
  ...
  {
    v4 = v12 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_180357868, 4u, v12 | 0x10000000, 0x514u, 0LL);
    goto LABEL_42;
  }
...
LABEL_34:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v29, &dword_180357868, 4u, v28, 0x563u, 0LL);
      wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::~com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>((__int64)&v34);
    }
    else
    {
...
LABEL_15:
  ...
  *((_QWORD *)this + 1) = v18;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_180357868, 4u, v4, 0x51Bu, 0LL);
LABEL_37:
  v30 = 0;
  if ( v44 )
  {
