/*
 * XREFs of ?SetLifetime@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleScalarBehavior@@@Z @ 0x1801C6D28
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[20] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xA20u, 0LL);
    }
    else
    {
