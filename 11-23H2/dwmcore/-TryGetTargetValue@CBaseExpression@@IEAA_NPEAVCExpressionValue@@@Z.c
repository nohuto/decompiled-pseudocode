/*
 * XREFs of ?TryGetTargetValue@CBaseExpression@@IEAA_NPEAVCExpressionValue@@@Z @ 0x18008143C
 * Callers:
  ...
  if ( v2 && (this = *(CBaseExpression **)(v2 + 16)) != 0LL )
  {
    v5 = (*(__int64 (__fastcall **)(CBaseExpression *, _QWORD, struct CExpressionValue *))(*(_QWORD *)this + 136LL))(
           ...
           *((unsigned int *)v4 + 48),
           a2);
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802EE388, 2u, v5, 0x53Au, 0LL);
    else
      return 1;
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, &dword_1802EE388, 2u, -2147024890, 0x539u, 0LL);
  }
  return v3;
}
