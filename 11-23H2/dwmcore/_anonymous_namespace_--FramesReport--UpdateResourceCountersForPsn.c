/*
 * XREFs of _anonymous_namespace_::FramesReport::UpdateResourceCountersForPsn @ 0x1800B14B0
 * Callers:
        ...
        __int64 a5)
{
  ...
  _QWORD v38[4]; // [rsp+48h] [rbp-60h] BYREF
