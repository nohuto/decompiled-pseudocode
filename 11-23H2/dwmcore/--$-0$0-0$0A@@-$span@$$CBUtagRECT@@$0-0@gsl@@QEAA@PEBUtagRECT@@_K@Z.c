/*
 * XREFs of ??$?0$0?0$0A@@?$span@$$CBUtagRECT@@$0?0@gsl@@QEAA@PEBUtagRECT@@_K@Z @ 0x1801BD6C0
 * Callers:
...
gsl::details *__fastcall gsl::span<tagRECT const,-1>::span<tagRECT const,-1>(gsl::details *a1, __int64 a2, __int64 a3)
{
  gsl::details *v5; // rcx
  bool v6; // zf
