/*
 * XREFs of ?UpdateExpressions@CExpressionManager@@QEAAX_K0@Z @ 0x180049C24
 * Callers:
 ...
 *     ?FlushQueuedSuspendAnimations@CExpressionManager@@AEAAXXZ @ 0x18004C1F0 (-FlushQueuedSuspendAnimations@CExpressionManager@@AEAAXXZ.c)
 ...
 *     ?GetDurationAverage@CExpressionPerformanceCounter@@QEAANW4ExpressionPerformanceLabel@@@Z @ 0x180262DA4 (-GetDurationAverage@CExpressionPerformanceCounter@@QEAANW4ExpressionPerformanceLabel@@@Z.c)
 *     ?Reset@CExpressionPerformanceCounter@@QEAAXXZ @ 0x180262DD8 (-Reset@CExpressionPerformanceCounter@@QEAAXXZ.c)
 */
...
void __fastcall CExpressionManager::UpdateExpressions(CExpressionManager *this, __int64 a2, __int64 a3)
{
  ...
  if ( (Microsoft_Windows_Dwm_CompositorEnableBits & 2) != 0 )
    McGenEventWrite_EventWriteTransfer(&Microsoft_Windows_Dwm_Compositor_Context, &UpdateExpressions_Start);
  v5 = 0;
  v6 = 0LL;
  v34 = 0LL;
    ...
    if ( *((_DWORD *)this + 110) )
    {
      ...
      *((_BYTE *)this + 448) = *((_BYTE *)this + 448) & 0xF3 | (2 * (*((_BYTE *)this + 448) & 4));
      if ( (unsigned int)dword_1803E37D0 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1803E37D0, 4LL) )
        tlgWriteTransfer_EventWriteTransfer((int)&dword_1803E37D0, (int)&dword_1803806F9, 0, 0, 2u, &v45);
