/*
 * XREFs of ??1CDxHandleStereoBitmapRealization@@MEAA@XZ @ 0x1802B2A88
 * Callers:
 ...
 *     ?AdjustStereoEntityCount@CComposition@@QEAAX_N@Z @ 0x1801B4414 (-AdjustStereoEntityCount@CComposition@@QEAAX_N@Z.c)
 */
