/*
 * XREFs of ?Begin@CDrawListEntryBuilder@@QEAAXAEBUDrawListEntryBuilderSetupParams@@PEAVCRenderingEffect@@@Z @ 0x1800C3570
 * Callers:
 ...
 * Callees:
 *     ?Get2DPointUsing2DInverse@CMILMatrix@@QEBA_NAEBUD2D_POINT_2F@@PEAU2@@Z @ 0x1800C388C (-Get2DPointUsing2DInverse@CMILMatrix@@QEBA_NAEBUD2D_POINT_2F@@PEAU2@@Z.c)
        ...
        __int64 a4)
{
  ...
  __int64 v24; // r8
  __int64 v25; // r8
  float v26[16]; // [rsp+20h] [rbp-60h]
  struct D2D_POINT_2F v27; // [rsp+90h] [rbp+10h] BYREF
  struct D2D_POINT_2F v28; // [rsp+98h] [rbp+18h] BYREF
  ...
  *(_DWORD *)this = v7;
  if ( *(_QWORD *)(v10 + 104) )
  {
    v28.x = 0.0;
    v28.y = 0.0;
    CMILMatrix::Get2DPointUsing2DInverse((CMILMatrix *)(v10 + 8), &v28, &v27);
    x_low = (__m128)LODWORD(v27.x);
    if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v27.x - 0.0) & _xmm) <= 0.015625 )
      x_low = 0LL;
    y_low = (__m128)LODWORD(v27.y);
    if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v27.y - 0.0) & _xmm) <= 0.015625 )
      y_low = 0LL;
  }
  ...
  *((_BYTE *)this + 4473) = v13;
  if ( v13 )
  {
    ...
    *(_QWORD *)v26 = v11.m128_u32[0];
    v26[3] = v12.m128_f32[0];
    v16 = *(_OWORD *)v26;
    *(_QWORD *)&v26[1] = 0LL;
    *((_OWORD *)this + 2) = v16;
    ...
    *((_QWORD *)this + 6) = _mm_unpacklo_ps(_mm_xor_ps(v14, (__m128)_xmm), _mm_xor_ps(v15, (__m128)_xmm)).m128_u64[0];
    v26[0] = 1.0 / v11.m128_f32[0];
    v26[3] = 1.0 / v12.m128_f32[0];
    *(_OWORD *)((char *)this + 56) = *(_OWORD *)v26;
  ...
  *((_DWORD *)this + 6) = v22;
  if ( (v22 & 0x2000) != 0 )
    *((_BYTE *)this + 28) = 0;
  v23 = (__int64)(*((_QWORD *)this + 21) - *((_QWORD *)this + 20)) >> 4;
  if ( v23 )
    detail::vector_facade<TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,detail::buffer_impl<TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,10,1,detail::liberal_expansion_policy>>::clear_region(
      ...
      0LL,
      v23);
  v24 = (__int64)(*((_QWORD *)this + 265) - *((_QWORD *)this + 264)) >> 4;
  if ( v24 )
    detail::vector_facade<TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,detail::buffer_impl<TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,10,1,detail::liberal_expansion_policy>>::clear_region(
      (char *)this + 2112,
      0LL,
      v24);
  v25 = (__int64)(*((_QWORD *)this + 510) - *((_QWORD *)this + 509)) >> 1;
  if ( v25 )
