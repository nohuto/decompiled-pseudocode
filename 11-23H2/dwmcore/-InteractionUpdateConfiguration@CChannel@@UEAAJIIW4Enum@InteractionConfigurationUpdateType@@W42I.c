/*
 * XREFs of ?InteractionUpdateConfiguration@CChannel@@UEAAJIIW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@PEBXI@Z @ 0x180029CA0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int Size)
{
  ...
  CChannel::CheckHandle(a1, a2, 89LL);
  v20[0] = 195;
  v20[2] = a3;
  v20[1] = a2;
  v20[3] = a4;
  v20[4] = a5;
  v11 = CChannel::BeginCommand((CChannel *)a1, v20, 0x14u, Size);
  v12 = v11;
  if ( v11 < 0 )
  {
