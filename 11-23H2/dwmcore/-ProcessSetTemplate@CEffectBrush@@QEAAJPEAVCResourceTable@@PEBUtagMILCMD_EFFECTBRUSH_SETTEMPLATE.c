/*
 * XREFs of ?ProcessSetTemplate@CEffectBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EFFECTBRUSH_SETTEMPLATE@@@Z @ 0x1800BA1B0
 * Callers:
        ...
        const struct tagMILCMD_EFFECTBRUSH_SETTEMPLATE *a3)
{
  ...
  Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, *((_DWORD *)a3 + 2), 0x1Cu);
  v7 = Resource;
  if ( !Resource )
  {
