/*
 * XREFs of ??_ECParticleColorBehavior@@UEAAPEAXI@Z @ 0x1801C2FA0
 * Callers:
 *     ??_ECParticleVector3Behavior@@WHA@EAAPEAXI@Z @ 0x18011B9B0 (--_ECParticleVector3Behavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
        ...
        char a2)
{
  ...
  if ( v4 )
  {
    std::_Deallocate<16,0>(v4, 8 * ((__int64)(*((_QWORD *)this + 17) - (_QWORD)v4) >> 3));
    *((_QWORD *)this + 15) = 0LL;
    *((_QWORD *)this + 16) = 0LL;
    *((_QWORD *)this + 17) = 0LL;
  }
