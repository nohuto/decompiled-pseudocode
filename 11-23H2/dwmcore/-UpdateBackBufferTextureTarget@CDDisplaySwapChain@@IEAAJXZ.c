/*
 * XREFs of ?UpdateBackBufferTextureTarget@CDDisplaySwapChain@@IEAAJXZ @ 0x18028B740
 * Callers:
...
__int64 __fastcall CDDisplaySwapChain::UpdateBackBufferTextureTarget(CDDisplaySwapChain *this)
{
  ...
  if ( v7 )
  {
    ...
    *v1 = 0LL;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180386F20, 2u, DeviceTextureTarget, 0xD9u, 0LL);
    }
    else
    {
  ...
  {
    v12 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(v3, &dword_180386F20, 2u, -2003304307, 0xDFu, 0LL);
  }
  return v12;
}
