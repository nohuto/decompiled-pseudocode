/*
 * XREFs of ?CurrentInertiaPanningVelocity@CPositionMotion@@AEBAMXZ @ 0x18026F2F8
 * Callers:
 *     ?CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ @ 0x18026F370 (-CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ.c)
 * Callees:
