/*
 * XREFs of ?RetrieveUsageUnderLock@FeatureStateData@details_abi@wil@@AEAAXAEAUUsageIndexes@23@@Z @ 0x180199CD8
 * Callers:
 ...
 * Callees:
 *     ?Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z @ 0x18019A25C (-Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z.c)
 */
