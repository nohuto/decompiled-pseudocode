/*
 * XREFs of ?PushEffectiveAlphaForNode@CDrawingContext@@AEAAJPEBVCVisual@@M_N@Z @ 0x1800D8398
 * Callers:
        ...
        char a4)
{
  ...
  if ( a4 )
  {
    *((_QWORD *)&v14 + 1) = a2;
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x11D1u, 0LL);
      return v9;
    }
    v4 = 1;
  }
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x11D5u, 0LL);
    if ( v4 )
