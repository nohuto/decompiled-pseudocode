/*
 * XREFs of ?RenderSubgraphs@CBrushRenderingGraph@@QEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEBVCDrawListBrush@@IPEAVCDrawListCache@@@Z @ 0x18007AD18
 * Callers:
 ...
 *     ?reserve@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@QEAAX_K@Z @ 0x1800DC04C (-reserve@-$vector@UEffectInput@@V-$allocator@UEffectInput@@@std@@@std@@QEAAX_K@Z.c)
 ...
 *     ??$emplace_back@$$T@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@QEAA?A_T$$QEA$$T@Z @ 0x1800E0BD0 (--$emplace_back@$$T@-$vector@UEffectInput@@V-$allocator@UEffectInput@@@std@@@std@@QEAA-A_T$$QEA$.c)
 ...
 *     ??$?4VIRenderTargetBitmap@@Uerr_returncode_policy@wil@@X@?$com_ptr_t@VIBitmapRealization@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@$$QEAV?$com_ptr_t@VIRenderTargetBitmap@@Uerr_returncode_policy@wil@@@1@@Z @ 0x180262DFC (--$-4VIRenderTargetBitmap@@Uerr_returncode_policy@wil@@X@-$com_ptr_t@VIBitmapRealization@@Uerr_r.c)
  ...
  *(_OWORD *)v79 = 0LL;
  ...
  if ( *((_QWORD *)this + 26) )
  {
    ...
    if ( !v18 )
    {
      ...
      {
        EffectInput = CBackdropVisualImage::GenerateEffectInput(v23, v115);
        v25 = 0;
        v26 = 1;
      }
      else
      ...
      else
      {
        if ( !CBrushRenderingGraph::IsBlurredWallpaperBackdropInput(this, v28) )
        {
          ...
          else
          {
            ...
            v66 = CDrawListBitmap::CDrawListBitmap((CDrawListBitmap *)v87, v9);
            CDrawListBitmap::operator=(v32, v66);
