/*
 * XREFs of ?RenderAdditionalTopmostContent@CCaptureRenderTarget@@IEAAJPEAVCDrawingContext@@@Z @ 0x1801ED8E0
 * Callers:
 ...
 *     ?GetRootVisualTree@CVisualTree@@QEBAPEAV1@XZ @ 0x180213EA8 (-GetRootVisualTree@CVisualTree@@QEBAPEAV1@XZ.c)
 */
