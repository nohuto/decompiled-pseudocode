/*
 * XREFs of ?SetBaseColorInput@?$CSceneMetallicRoughnessMaterialGeneratedT@VCSceneMetallicRoughnessMaterial@@VCScenePbrMaterial@@@@QEAAJPEAVCSceneMaterialInput@@@Z @ 0x1801C5F0C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[21] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x15D3u, 0LL);
    }
    else
    {
