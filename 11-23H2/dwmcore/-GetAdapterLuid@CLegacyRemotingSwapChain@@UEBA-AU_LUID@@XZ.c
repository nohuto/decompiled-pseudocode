/*
 * XREFs of ?GetAdapterLuid@CLegacyRemotingSwapChain@@UEBA?AU_LUID@@XZ @ 0x1802A32D4
 * Callers:
 *     ?GetAdapterLuid@CLegacyRemotingSwapChain@@$4PPPPPPPM@A@EBA?AU_LUID@@XZ @ 0x1801212D0 (-GetAdapterLuid@CLegacyRemotingSwapChain@@$4PPPPPPPM@A@EBA-AU_LUID@@XZ.c)
 * Callees:
