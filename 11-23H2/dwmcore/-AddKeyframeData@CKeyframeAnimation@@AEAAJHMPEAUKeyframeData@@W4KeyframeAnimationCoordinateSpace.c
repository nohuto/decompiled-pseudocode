/*
 * XREFs of ?AddKeyframeData@CKeyframeAnimation@@AEAAJHMPEAUKeyframeData@@W4KeyframeAnimationCoordinateSpace@@@Z @ 0x18004E4B8
 * Callers:
...
LABEL_45:
  ...
  KeyframeValue::CreateExpressionKeyframeValue(*(unsigned int *)(a1 + 152), a1, *(unsigned int *)(a4 + 32), &v67);
LABEL_49:
  v7 = v67;
LABEL_16:
  v22 = v5 * 1000.0;
