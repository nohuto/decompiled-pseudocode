/*
 * XREFs of ?PushLayer@CDrawingContext@@AEAAJPEBVCVisual@@PEAVCLayer@@_N2@Z @ 0x1800AEA10
 * Callers:
        ...
        bool a5)
{
  ...
  if ( a5 )
  {
    *((_QWORD *)&v21[0] + 1) = a2;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v9, 0x1003u, 0LL);
      return v10;
    }
    v5 = 1;
  }
