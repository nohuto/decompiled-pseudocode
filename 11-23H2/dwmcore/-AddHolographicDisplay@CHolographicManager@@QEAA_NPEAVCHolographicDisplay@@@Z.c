/*
 * XREFs of ?AddHolographicDisplay@CHolographicManager@@QEAA_NPEAVCHolographicDisplay@@@Z @ 0x1802A445C
 * Callers:
 *     ?OnChanged@CHolographicDisplay@@AEAAXXZ @ 0x1802A7718 (-OnChanged@CHolographicDisplay@@AEAAXXZ.c)
 * Callees:
