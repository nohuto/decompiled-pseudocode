/*
 * XREFs of ?GetCommonOrCubeMapRenderingShader@CCommonRenderingShaderCache@@AEAAJPEAVCD3DDevice@@AEBUCommonRenderingShaderDesc@@_NPEAIPEAPEAUID3D11PixelShader@@@Z @ 0x1800B67F0
 * Callers:
 ...
 *     ??0CLinkedShader@@QEAA@PEAUID3D10Blob@@I@Z @ 0x1800BC4A0 (--0CLinkedShader@@QEAA@PEAUID3D10Blob@@I@Z.c)
 ...
 *     ?TryLookupPreCompiledBytecode@CommonRenderingShaderDesc@@SA?AV?$span@$$CBE$0?0@gsl@@AEBU1@@Z @ 0x1800F782C (-TryLookupPreCompiledBytecode@CommonRenderingShaderDesc@@SA-AV-$span@$$CBE$0-0@gsl@@AEBU1@@Z.c)
 *     ?GetShaderLinkingBody@CommonRenderingShaderBody@@YA?AUShaderLinkingBody@@W4Enum@1@W4D3DShaderProfileVersion@@@Z @ 0x1800F7EA0 (-GetShaderLinkingBody@CommonRenderingShaderBody@@YA-AUShaderLinkingBody@@W4Enum@1@W4D3DShaderPro.c)
        ...
        struct ID3D11PixelShader **a6)
{
  ...
  _OWORD v68[4]; // [rsp+B0h] [rbp-50h] BYREF
  __int64 v69; // [rsp+F0h] [rbp-10h]
  _BYTE v70[56]; // [rsp+F8h] [rbp-8h] BYREF
  ...
  __int128 v81; // [rsp+1C8h] [rbp+C8h]
  __int128 v82; // [rsp+1D8h] [rbp+D8h]

  v6 = (ShaderLinkingSamplerDesc *)&v72;
  v66 = a5;
  v67 = a6;
  v64[0] = a2;
  v72 = 0LL;
  ...
  BYTE8(v73) = (v13 & 4) != 0;
  v82 = 0LL;
  BYTE1(v82) = (v11 & 0x10) != 0;
  BYTE7(v82) = *((_BYTE *)a3 + 44);
  LOBYTE(v82) = (v11 & 8) != 0;
  v14 = *((_DWORD *)a2 + 146) < 37632;
  v15 = *(_OWORD *)((char *)a3 + 24);
  BYTE6(v82) = *((_BYTE *)a3 + 45);
  BYTE8(v82) = *((_BYTE *)a3 + 46);
  v81 = v15;
  BYTE4(v82) = a4;
  if ( v14 )
  {
  ...
  ShaderLinkingConfig::GetLookupKey(&v72, &v71, v19);
  v21 = 0;
  v22 = 0;
  ...
  {
    v20 = v18;
    if ( *(_QWORD *)(v24 + g_commonRenderingShaderCache) == (_QWORD)v71
      && *(_DWORD *)(v24 + g_commonRenderingShaderCache + 8) == DWORD2(v71) )
    {
      break;
    }
    ++v22;
...
LABEL_23:
      ...
      *(_QWORD *)&v71 = 0x200000000LL;
      ...
      else
      {
        ...
        if ( DefaultHeap::Alloc(0x58uLL)
          && (v48 = VertexShaderDesc::ResolveKey((VertexShaderDesc *)&v71),
              ...
              (v25 = (volatile signed __int32 *)v50) != 0LL) )
        {
          ...
          ShaderLinkingConfig::GetLookupKey(&v72, v68, v63);
    ...
    {
      ShaderLinkingBody = CommonRenderingShaderBody::GetShaderLinkingBody(v70, v18, v16);
      v71 = 0uLL;
      v68[1] = *(_OWORD *)ShaderLinkingBody;
      v68[2] = *(_OWORD *)(ShaderLinkingBody + 16);
      v68[3] = *(_OWORD *)(ShaderLinkingBody + 32);
      v69 = *(_QWORD *)(ShaderLinkingBody + 48);
      *(_OWORD *)Size = 0uLL;
      LinkedShader = CShaderCache::CreateLinkedShader(
                       (CShaderCache *)&g_commonRenderingShaderCache,
                       v63,
                       (__int64)Size,
                       (__int64)&ppBlob);
      v37 = LinkedShader;
...
LABEL_27:
  ...
  if ( Resource >= 0 )
  {
    ...
    *(_QWORD *)detail::vector_facade<wil::com_ptr_t<CD3DPixelShader,wil::err_returncode_policy>,detail::buffer_impl<wil::com_ptr_t<CD3DPixelShader,wil::err_returncode_policy>,2,1,detail::liberal_expansion_policy>>::reserve_region(
    ...
    wil::com_ptr_t<ID2DBitmap,wil::err_returncode_policy>::~com_ptr_t<ID2DBitmap,wil::err_returncode_policy>((__int64)&v71);
    wil::com_ptr_t<ID2DBitmap,wil::err_returncode_policy>::~com_ptr_t<ID2DBitmap,wil::err_returncode_policy>((__int64)&ppBlob);
    v21 = v41;
LABEL_20:
    *v66 = *((_DWORD *)v25 + 6);
