/*
 * XREFs of ?GetBrushParametersWorker@CBitmapResourceRenderStrategy@@KAJPEBVCSurfaceBrush@@PEAVIBitmapResource@@PEAULayoutData@CContent@@W4D2D1_INTERPOLATION_MODE@@PEAVCBrushDrawListGenerator@@@Z @ 0x18007A6A4
 * Callers:
...
LABEL_19:
  ...
  v23 = 257;
  v9 = CSurfaceDrawListBrush::CreateWithContentRect(v29, &v22, (char *)a3 + 24, &v27);
  if ( v28 )
  {
    v11 = *v26;
    *v26 = v27;
  ...
  if ( v9 >= 0 )
  {
    ...
    *((_QWORD *)v12 + 3) = *((_QWORD *)a3 + 2);
    ...
    if ( (char *)a5 + 40 != &v25 )
    {
      ...
      *v14 = v13;
      if ( v17 )
      {
        std::default_delete<CDrawListBrush>::operator()(0LL, v17);
        v15 = v24;
      }
    }
    v18 = 1;
    ...
    *((_DWORD *)a5 + 18) = v18;
    if ( v16 )
    {
      std::default_delete<CDrawListBrush>::operator()(v15, v16);
      v15 = v24;
    }
    if ( v15 )
