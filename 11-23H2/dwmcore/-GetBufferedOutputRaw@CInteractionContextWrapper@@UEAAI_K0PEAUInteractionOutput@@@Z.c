/*
 * XREFs of ?GetBufferedOutputRaw@CInteractionContextWrapper@@UEAAI_K0PEAUInteractionOutput@@@Z @ 0x180283FA0
 * Callers:
 *     <none>
 * Callees:
 *     _anonymous_namespace_::ResetInteractionOutput @ 0x1800B4250 (_anonymous_namespace_--ResetInteractionOutput.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x18011B6B0 (_guard_xfg_dispatch_icall_nop.c)
 *     ?GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ @ 0x180284190 (-GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ.c)
