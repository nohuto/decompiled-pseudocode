/*
 * XREFs of ??$IsAffine@$00@CMILMatrix@@AEBA_N_N@Z @ 0x180070318
 * Callers:
 ...
 *     ?PrependTranslate@CMILMatrix@@QEAAXMM@Z @ 0x180270058 (-PrependTranslate@CMILMatrix@@QEAAXMM@Z.c)
 *     ?Transform3DRectToPerspective@CMILMatrix@@QEBAXAEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEAUMilPoint3F@@@Z @ 0x180270514 (-Transform3DRectToPerspective@CMILMatrix@@QEBAXAEBV-$TMil3DRect@MV-$TMilRect_@MUMilRectF@@UMil3D.c)
