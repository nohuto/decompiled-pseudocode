/*
 * XREFs of ?HitTestContent@CWindowNode@@UEAAJ_NAEBUD2D_POINT_2F@@PEA_N@Z @ 0x1800DA280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ShouldHitTest@CWindowNode@@MEBA_NXZ @ 0x1800DA490 (-ShouldHitTest@CWindowNode@@MEBA_NXZ.c)
 ...
 *     ?IsColorKey@CColorKey@@QEBA_NAEBU_D3DCOLORVALUE@@@Z @ 0x1802AFA00 (-IsColorKey@CColorKey@@QEBA_NAEBU_D3DCOLORVALUE@@@Z.c)
 */
