/*
 * XREFs of ??$_Emplace_reallocate@E@?$vector@EV?$allocator@E@std@@@std@@QEAAPEAEQEAE$$QEAE@Z @ 0x18010D72C
 * Callers:
 *     _anonymous_namespace_::SendFramesReport @ 0x18010BBC0 (_anonymous_namespace_--SendFramesReport.c)
 *     _anonymous_namespace_::PackedStringArrayBuilder::Append @ 0x18010C704 (_anonymous_namespace_--PackedStringArrayBuilder--Append.c)
 ...
 *     ?_Change_array@?$vector@EV?$allocator@E@std@@@std@@AEAAXQEAE_K1@Z @ 0x1800931C0 (-_Change_array@-$vector@EV-$allocator@E@std@@@std@@AEAAXQEAE_K1@Z.c)
 *     ?_Calculate_growth@?$vector@DV?$allocator@D@std@@@std@@AEBA_K_K@Z @ 0x18010D8B4 (-_Calculate_growth@-$vector@DV-$allocator@D@std@@@std@@AEBA_K_K@Z.c)
