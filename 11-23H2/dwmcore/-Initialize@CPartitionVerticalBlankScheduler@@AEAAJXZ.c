/*
 * XREFs of ?Initialize@CPartitionVerticalBlankScheduler@@AEAAJXZ @ 0x1800BF558
 * Callers:
...
__int64 __fastcall CPartitionVerticalBlankScheduler::Initialize(CPartitionVerticalBlankScheduler *this)
{
  ...
  *((_QWORD *)this + 3) = WaitableTimerW;
  if ( WaitableTimerW )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v3, v12, 0LL);
    return v5;
  }
  ...
  if ( (v5 & 0x80000000) == 0 )
    v5 = -2003304445;
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v5, 0xE5u, 0LL);
  return v5;
}
