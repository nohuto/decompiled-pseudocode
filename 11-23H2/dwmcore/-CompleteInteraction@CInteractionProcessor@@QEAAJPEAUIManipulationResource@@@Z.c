/*
 * XREFs of ?CompleteInteraction@CInteractionProcessor@@QEAAJPEAUIManipulationResource@@@Z @ 0x1801AC230
 * Callers:
 *     ?CompleteInteraction@CInteractionRoot@@UEAAJXZ @ 0x1801A3F10 (-CompleteInteraction@CInteractionRoot@@UEAAJXZ.c)
 *     ?CompleteInteraction@CInteraction@@UEAAJXZ @ 0x18020BA10 (-CompleteInteraction@CInteraction@@UEAAJXZ.c)
 * Callees:
