/*
 * XREFs of ??_ECDxHandleAdvancedDirectFlipBitmapRealization@@UEAAPEAXI@Z @ 0x1802B18A0
 * Callers:
 *     ??_ECDxHandleAdvancedDirectFlipBitmapRealization@@WBEA@EAAPEAXI@Z @ 0x180122670 (--_ECDxHandleAdvancedDirectFlipBitmapRealization@@WBEA@EAAPEAXI@Z.c)
 * Callees:
