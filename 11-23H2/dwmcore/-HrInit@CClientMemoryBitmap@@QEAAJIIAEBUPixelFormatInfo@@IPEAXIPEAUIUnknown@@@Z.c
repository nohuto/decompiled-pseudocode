/*
 * XREFs of ?HrInit@CClientMemoryBitmap@@QEAAJIIAEBUPixelFormatInfo@@IPEAXIPEAUIUnknown@@@Z @ 0x180028A40
 * Callers:
...
LABEL_13:
  ...
  v14 = HrCheckBufferSize(*a4, a7, a2, v13, a5);
  v16 = v14;
  if ( v14 < 0 )
  {
