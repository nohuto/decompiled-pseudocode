/*
 * XREFs of ?FillVertexUVs@CCpuClipAntialiasDrawListEntry@@QEBAXAEBUBounds@CCpuClipAntialiasSink@@AEBV?$StridedSpan@UUVxN@CCpuClipAntialiasSink@@@@_K@Z @ 0x1800385AC
 * Callers:
 ...
 * Callees:
 *     ?ComputeRelativeOutlinePosition@Bounds@CCpuClipAntialiasSink@@QEBAMM@Z @ 0x180038774 (-ComputeRelativeOutlinePosition@Bounds@CCpuClipAntialiasSink@@QEBAMM@Z.c)
