/*
 * XREFs of ?BoostFrameRate@CLegacySwapChain@@UEAA_N_N@Z @ 0x18029A390
 * Callers:
 *     ?BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@BLA@EAA_N_N@Z @ 0x18011F390 (-BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@BLA@EAA_N_N@Z.c)
 *     ?BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@BLI@EAA_N_N@Z @ 0x180120410 (-BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@BLI@EAA_N_N@Z.c)
 *     ?BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@DFI@EAA_N_N@Z @ 0x180120AF0 (-BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@DFI@EAA_N_N@Z.c)
 * Callees:
 ...
 *     ?IsValidVariableRefreshDuration@CLegacySwapChain@@IEBA_N_K@Z @ 0x18029B11C (-IsValidVariableRefreshDuration@CLegacySwapChain@@IEBA_N_K@Z.c)
 */
