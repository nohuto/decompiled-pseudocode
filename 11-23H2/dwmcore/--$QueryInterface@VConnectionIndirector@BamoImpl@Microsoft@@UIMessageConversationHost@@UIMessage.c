/*
 * XREFs of ??$QueryInterface@VConnectionIndirector@BamoImpl@Microsoft@@UIMessageConversationHost@@UIMessageConversationBouncer@@@Util@BamoImpl@Microsoft@@YAJPEAVConnectionIndirector@12@AEBU_GUID@@PEAPEAX@Z @ 0x1800F70D0
 * Callers:
 *     ?QueryInterface@ConnectionIndirector@BamoImpl@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F70C0 (-QueryInterface@ConnectionIndirector@BamoImpl@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
