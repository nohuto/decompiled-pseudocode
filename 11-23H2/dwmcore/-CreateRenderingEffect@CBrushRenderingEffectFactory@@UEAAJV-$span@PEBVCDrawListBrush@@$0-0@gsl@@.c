/*
 * XREFs of ?CreateRenderingEffect@CBrushRenderingEffectFactory@@UEAAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@PEAPEAVCRenderingEffect@@@Z @ 0x1800DA800
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  v15[0] = 4LL;
  v16 = v10;
  v12 = CBrushRenderingEffect::CBrushRenderingEffect((__int64)v8, v11, (gsl::details *)&v16, v15);
  v13 = v12;
  if ( v12 )
  {
...
LABEL_8:
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v8, 0LL, 0, -2147024882, 0x4Bu, 0LL);
  }
  return v6;
}
