/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCCursorVisual@@@?$vector@PEAVCCursorVisual@@V?$allocator@PEAVCCursorVisual@@@std@@@std@@QEAAPEAPEAVCCursorVisual@@QEAPEAV2@AEBQEAV2@@Z @ 0x1801F209C
 * Callers:
 *     ?RegisterCursorVisual@CGlobalComposition@@UEAAXPEAVCCursorVisual@@@Z @ 0x1801F2710 (-RegisterCursorVisual@CGlobalComposition@@UEAAXPEAVCCursorVisual@@@Z.c)
 * Callees:
 ...
 *     ?_Change_array@?$vector@PEAVCCursorVisual@@V?$allocator@PEAVCCursorVisual@@@std@@@std@@AEAAXQEAPEAVCCursorVisual@@_K1@Z @ 0x1801F2868 (-_Change_array@-$vector@PEAVCCursorVisual@@V-$allocator@PEAVCCursorVisual@@@std@@@std@@AEAAXQEAP.c)
 */
