/*
 * XREFs of ?CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ @ 0x18026F370
 * Callers:
 *     <none>
 * Callees:
 *     ?CurrentInertiaPanningVelocity@CPositionMotion@@AEBAMXZ @ 0x18026F2F8 (-CurrentInertiaPanningVelocity@CPositionMotion@@AEBAMXZ.c)
 */
