/*
 * XREFs of ?GenerateDrawList@CVisualBitmap@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18021ED10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  else
  {
    ...
    v20 = 0LL;
    v19 = v11;
    CBrushDrawListGenerator::AttachInput((__int64)v33, 0, &v19);
    if ( v19 )
