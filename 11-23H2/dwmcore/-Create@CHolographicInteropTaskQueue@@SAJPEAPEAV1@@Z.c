/*
 * XREFs of ?Create@CHolographicInteropTaskQueue@@SAJPEAPEAV1@@Z @ 0x1802ABD44
 * Callers:
 ...
 *     ??0CHolographicInteropTaskQueue@@AEAA@XZ @ 0x1802ABBD8 (--0CHolographicInteropTaskQueue@@AEAA@XZ.c)
