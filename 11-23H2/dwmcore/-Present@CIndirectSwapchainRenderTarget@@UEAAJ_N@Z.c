/*
 * XREFs of ?Present@CIndirectSwapchainRenderTarget@@UEAAJ_N@Z @ 0x1801EEE48
 * Callers:
 *     ?Present@CIndirectSwapchainRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x18011C7B0 (-Present@CIndirectSwapchainRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
