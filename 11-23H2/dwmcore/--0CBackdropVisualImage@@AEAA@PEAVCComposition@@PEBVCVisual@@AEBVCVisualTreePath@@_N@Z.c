/*
 * XREFs of ??0CBackdropVisualImage@@AEAA@PEAVCComposition@@PEBVCVisual@@AEBVCVisualTreePath@@_N@Z @ 0x180025A04
 * Callers:
        ...
        bool a5)
{
  ...
  *((_QWORD *)this + 226) = (char *)this + 1848;
  ...
  v12 = *(__int128 **)a4;
  v13 = (_OWORD *)detail::vector_facade<CVisualTreePath::VisualTreePathUnit,detail::buffer_impl<CVisualTreePath::VisualTreePathUnit,2,1,detail::liberal_expansion_policy>>::reserve_region(
                    (char *)this + 1792,
                    0LL,
