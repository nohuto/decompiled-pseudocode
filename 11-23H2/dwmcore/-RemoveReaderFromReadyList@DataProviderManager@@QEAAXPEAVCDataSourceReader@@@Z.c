/*
 * XREFs of ?RemoveReaderFromReadyList@DataProviderManager@@QEAAXPEAVCDataSourceReader@@@Z @ 0x1801B78B4
 * Callers:
 *     ??1CDataSourceReader@@UEAA@XZ @ 0x180228B0C (--1CDataSourceReader@@UEAA@XZ.c)
 * Callees:
 *     memmove_0 @ 0x18011B674 (memmove_0.c)
 *     ?_Reallocate_exactly@?$vector@PEAVCDataSourceReader@@V?$allocator@PEAVCDataSourceReader@@@std@@@std@@AEAAX_K@Z @ 0x1801B7CCC (-_Reallocate_exactly@-$vector@PEAVCDataSourceReader@@V-$allocator@PEAVCDataSourceReader@@@std@@@.c)
