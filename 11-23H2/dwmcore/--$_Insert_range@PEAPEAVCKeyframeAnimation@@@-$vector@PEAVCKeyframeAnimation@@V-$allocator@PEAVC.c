/*
 * XREFs of ??$_Insert_range@PEAPEAVCKeyframeAnimation@@@?$vector@PEAVCKeyframeAnimation@@V?$allocator@PEAVCKeyframeAnimation@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCKeyframeAnimation@@@std@@@std@@@1@PEAPEAVCKeyframeAnimation@@1Uforward_iterator_tag@1@@Z @ 0x180022E1C
 * Callers:
 ...
 * Callees:
 *     ?_Change_array@?$vector@PEAVCKeyframeAnimation@@V?$allocator@PEAVCKeyframeAnimation@@@std@@@std@@AEAAXQEAPEAVCKeyframeAnimation@@_K1@Z @ 0x1800233F8 (-_Change_array@-$vector@PEAVCKeyframeAnimation@@V-$allocator@PEAVCKeyframeAnimation@@@std@@@std@.c)
