/*
 * XREFs of ?GenerateShaders@CD3DDevice@@AEAAJXZ @ 0x1801033E0
 * Callers:
 ...
 *     ?size_bytes@?$span@$$CBUD3D11_INPUT_ELEMENT_DESC@@$0?0@gsl@@QEBA_KXZ @ 0x180103A00 (-size_bytes@-$span@$$CBUD3D11_INPUT_ELEMENT_DESC@@$0-0@gsl@@QEBA_KXZ.c)
  ...
  do
  {
    ...
    if ( ((__int64)Src_8[0] & 1) != 0 )
    {
      ...
      if ( CommonOrCubeMapRenderingShader < 0 )
      {
        v70 = 483;
LABEL_64:
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v19, 0LL, 0, CommonOrCubeMapRenderingShader, v70, 0LL);
        return v14;
      }
    }
    v15 = v16 + 1;
    ...
    do
    {
      ...
      if ( (unsigned __int8)v2 >= (unsigned __int8)((v24 & 4) != 0) )
      {
        ...
        *(_OWORD *)Src_8 = v25;
        if ( v73 )
        {
          v75 = *((_OWORD *)&unk_1802D7DE0 + v23);
          *(_OWORD *)v72 = *((_OWORD *)&unk_1802D7BE0 + (int)v22);
          v26 = *(_QWORD *)v72;
          if ( *(_QWORD *)v72 )
          {
            ...
            gsl::details::extent_type<-1>::extent_type<-1>(v83, v29 + v26);
            if ( v83[0] == -1 )
            {
              gsl::details::terminate(v30);
              JUMPOUT(0x1801039F6LL);
            }
            v32 = *(_QWORD *)gsl::details::extent_type<-1>::extent_type<-1>(&v82, v83[0]);
            if ( v32 == -1 )
            {
  ...
  do
  {
    ...
    *((_QWORD *)v43 + 205) = 0LL;
    ...
    CommonOrCubeMapRenderingShader = v46(v42, &byte_180383070[264 * (int)v38], v43 + 1640);
    v14 = CommonOrCubeMapRenderingShader;
    if ( CommonOrCubeMapRenderingShader < 0 )
    {
      v70 = 538;
  ...
  do
  {
    ...
    *((_QWORD *)v53 + 277) = 0LL;
    ...
    CommonOrCubeMapRenderingShader = v56(v52, &_ImageBase[20 * (int)v48 + 1972676], v53 + 2216);
    v14 = CommonOrCubeMapRenderingShader;
    if ( CommonOrCubeMapRenderingShader < 0 )
    {
      v70 = 544;
  ...
  do
  {
    ...
    *((_QWORD *)v63 + 278) = 0LL;
    ...
    CommonOrCubeMapRenderingShader = v66(v62, &byte_180384930[52 * (int)v58], v63 + 2224);
    v14 = CommonOrCubeMapRenderingShader;
    if ( CommonOrCubeMapRenderingShader < 0 )
    {
      v70 = 550;
