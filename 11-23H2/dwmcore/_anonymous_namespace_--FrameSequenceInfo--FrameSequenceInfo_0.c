/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo_0 @ 0x1801CD1C8
 * Callers:
...
__int64 __fastcall anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo_0(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 448) = 0LL;
  *(_QWORD *)(a1 + 456) = 0LL;
  v12 = std::_Tree_node_std::pair__anonymous_namespace_::AnimationId_const__unsigned_int__void___::_Buyheadnode_std::allocator_std::_Tree_node_std::pair__anonymous_namespace_::AnimationId_const__unsigned_int__void_______();
  *(_QWORD *)(a1 + 448) = v12;
  v13 = v12;
