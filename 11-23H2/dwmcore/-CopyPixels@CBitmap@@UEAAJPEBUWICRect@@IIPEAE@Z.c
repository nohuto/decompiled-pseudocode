/*
 * XREFs of ?CopyPixels@CBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x180026480
 * Callers:
 *     ?CopyPixels@CBitmap@@WDA@EAAJPEBUWICRect@@IIPEAE@Z @ 0x18011CF90 (-CopyPixels@CBitmap@@WDA@EAAJPEBUWICRect@@IIPEAE@Z.c)
 * Callees:
