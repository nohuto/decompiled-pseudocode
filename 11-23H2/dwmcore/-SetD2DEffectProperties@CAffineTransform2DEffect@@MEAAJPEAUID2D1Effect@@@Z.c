/*
 * XREFs of ?SetD2DEffectProperties@CAffineTransform2DEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1802573F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Invert@Matrix3x2F@D2D1@@QEAA_NXZ @ 0x1800E0B24 (-Invert@Matrix3x2F@D2D1@@QEAA_NXZ.c)
