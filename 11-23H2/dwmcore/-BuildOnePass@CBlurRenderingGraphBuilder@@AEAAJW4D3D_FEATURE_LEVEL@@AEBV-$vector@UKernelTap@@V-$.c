/*
 * XREFs of ?BuildOnePass@CBlurRenderingGraphBuilder@@AEAAJW4D3D_FEATURE_LEVEL@@AEBV?$vector@UKernelTap@@V?$allocator@UKernelTap@@@std@@@std@@W4SeparableKernelPass@@@Z @ 0x1800BD0DC
 * Callers:
...
__int64 __fastcall CBlurRenderingGraphBuilder::BuildOnePass(_QWORD *a1, int a2, _QWORD *a3, char a4)
{
  ...
  else
  {
    ...
    if ( v10 <= *((float *)&unk_18033C480 + 5 * *(int *)(v4 + 1584)) )
    {
      v13 = off_1802D4A50;
    }
    else
    ...
    *(_QWORD *)(v14 + 56) = 0LL;
    ...
    if ( v9 )
    {
      while ( 1 )
      {
        ...
        if ( v7 >= v18 )
          v20 = v18;
        gsl::details::extent_type<-1>::extent_type<-1>(v44, v20);
        v44[1] = v19;
        if ( v44[0] == -1LL || !v19 && v44[0] )
        {
          gsl::details::terminate(v22);
          JUMPOUT(0x1800BD393LL);
        }
        v38 = 0LL;
        LOBYTE(v22) = v5;
