/*
 * XREFs of ?TransformToDifferentScope@CCpuClippingData@@QEBA_NPEAV1@AEBVCMILMatrix@@1@Z @ 0x180022114
 * Callers:
 ...
 *     ??$make_unique@VCMILMatrix@@$$V$0A@@std@@YA?AV?$unique_ptr@VCMILMatrix@@U?$default_delete@VCMILMatrix@@@std@@@0@XZ @ 0x18002222C (--$make_unique@VCMILMatrix@@$$V$0A@@std@@YA-AV-$unique_ptr@VCMILMatrix@@U-$default_delete@VCMILM.c)
