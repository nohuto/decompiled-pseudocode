/*
 * XREFs of ?SetState@CHolographicComposition@@UEAAJJ@Z @ 0x1802A7410
 * Callers:
 *     ?ProcessCreate@CHolographicComposition@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_HOLOGRAPHICCOMPOSITION_CREATE@@@Z @ 0x1802A7338 (-ProcessCreate@CHolographicComposition@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_HOLOGRAPHICCOMPOS.c)
 * Callees:
...
__int64 __fastcall CHolographicComposition::SetState(CHolographicComposition *this)
{
  ...
  if ( CNotificationResource::ShouldNotify((CHolographicComposition *)((char *)this - 72)) )
  {
    ...
    v6 = CoreUICallSend(v4, v10, 2LL, 9LL, 0, &unk_18033C03C, v9);
    if ( v6 < 0 )
