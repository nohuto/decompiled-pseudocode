/*
 * XREFs of ?RenderTexture@CHolographicInteropTarget@@AEAAJPEAVCDrawingContext@@PEAVCHolographicInteropTexture@@II@Z @ 0x1802A96F4
 * Callers:
 ...
 *     ?GetFrameContainsMonitorSpecificContent@CDrawingContext@@QEBA_NXZ @ 0x1800A35E0 (-GetFrameContainsMonitorSpecificContent@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?BeginFrame@CHolographicInteropTexture@@QEAAPEAVIRenderTargetBitmap@@II@Z @ 0x1802AA36C (-BeginFrame@CHolographicInteropTexture@@QEAAPEAVIRenderTargetBitmap@@II@Z.c)
 *     ?EndFrame@CHolographicInteropTexture@@QEAAXII_N@Z @ 0x1802AA5CC (-EndFrame@CHolographicInteropTexture@@QEAAXII_N@Z.c)
