/*
 * XREFs of __scrt_dllmain_uninitialize_c @ 0x18010F134
 * Callers:
 ...
 *     _cexit_0 @ 0x18010FFBA (_cexit_0.c)
 *     __scrt_stub_for_is_c_termination_complete @ 0x1801112D8 (__scrt_stub_for_is_c_termination_complete.c)
 */
