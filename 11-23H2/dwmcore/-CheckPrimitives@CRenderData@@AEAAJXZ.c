/*
 * XREFs of ?CheckPrimitives@CRenderData@@AEAAJXZ @ 0x180095CB0
 * Callers:
 ...
 *     ?GetNextItemSafe@CDataBlockReader@@QEAAJPEAIPEAPEAX0@Z @ 0x180096114 (-GetNextItemSafe@CDataBlockReader@@QEAAJPEAIPEAPEAX0@Z.c)
 *     ?FlushData@CDataStreamWriter@@QEAAPEAU_LIST_ENTRY@@XZ @ 0x1800962AC (-FlushData@CDataStreamWriter@@QEAAPEAU_LIST_ENTRY@@XZ.c)
 *     ?GetFirstItemSafe@CDataBlockReader@@QEAAJPEAIPEAPEAX0@Z @ 0x1800962E0 (-GetFirstItemSafe@CDataBlockReader@@QEAAJPEAIPEAPEAX0@Z.c)
...
LABEL_6:
  ...
  VisualTree = CVisual::GetVisualTree(v5, &v12, 1);
  v7 = VisualTree;
  if ( VisualTree >= 0 )
  {
