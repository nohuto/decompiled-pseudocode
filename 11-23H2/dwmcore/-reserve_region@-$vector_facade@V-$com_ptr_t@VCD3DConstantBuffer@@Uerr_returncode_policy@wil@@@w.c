        ...
        __int64 a2)
{
  ...
  __int64 *v26; // rsi
  __int64 v27; // rax
  LPVOID v28; // [rsp+20h] [rbp-58h] BYREF
  unsigned __int64 v29; // [rsp+28h] [rbp-50h]
  __int64 v30; // [rsp+30h] [rbp-48h]
  _BYTE v31[32]; // [rsp+40h] [rbp-38h] BYREF
...
LABEL_16:
  ...
  if ( v8 > 1 )
  {
    ...
    v30 = v7;
    v28 = v6;
    ((void (__fastcall *)(_BYTE *, char *, char *, LPVOID *))std::move_backward<std::move_iterator<wil::com_ptr_t<CD3DConstantBuffer,wil::err_returncode_policy> *>,stdext::checked_array_iterator<wil::com_ptr_t<CD3DConstantBuffer,wil::err_returncode_policy> *>>)(
      v31,
      &v6[8 * a2],
      &v6[8 * v7 - 8],
      &v28);
  ...
  if ( v9 < v13 )
    v13 = v9;
  detail::destruct_range<wil::com_ptr_t<CD3DConstantBuffer,wil::err_returncode_policy>>(v14, v13);
  *((_QWORD *)a1 + 1) += 8LL;
  return v14;
}
