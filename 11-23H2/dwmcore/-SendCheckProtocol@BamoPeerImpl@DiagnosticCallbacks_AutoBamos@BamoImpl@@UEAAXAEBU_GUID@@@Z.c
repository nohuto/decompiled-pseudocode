/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x1801BA810
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  v8 = v2;
  v5 = CoreUICallSend(v4, v7, 2LL, 1LL, 0, &unk_180356735, &v8);
  if ( v5 < 0 )
