/*
 * XREFs of ?SetStateOnDevice@CCommonRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEAI@Z @ 0x1800B5CB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetColorChannelDepth@@YAIW4DXGI_FORMAT@@@Z @ 0x1800B6414 (-GetColorChannelDepth@@YAIW4DXGI_FORMAT@@@Z.c)
 ...
 *     ?ToD3D11TextureAddressMode@ExtendMode@@YA?AW4D3D11_TEXTURE_ADDRESS_MODE@@W4Enum@1@@Z @ 0x1800F8A98 (-ToD3D11TextureAddressMode@ExtendMode@@YA-AW4D3D11_TEXTURE_ADDRESS_MODE@@W4Enum@1@@Z.c)
 ...
 *     ?IsHDRColorSpace@ColorConversion@@SA_NW4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x18013176A (-IsHDRColorSpace@ColorConversion@@SA_NW4DXGI_COLOR_SPACE_TYPE@@@Z.c)
 */
...
LABEL_78:
  ...
  if ( v6 )
  {
    if ( v6 != 1 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v10, 0LL, 0, -2003292288, 0xB6u, 0LL);
      return 2291675008LL;
    }
    goto LABEL_78;
  }
...
LABEL_44:
      ...
      if ( v14 >= 2 )
      {
        ...
        CommonOrCubeMapRenderingShader = CCommonRenderingShaderCache::GetCommonOrCubeMapRenderingShader(
                                           (CCommonRenderingShaderCache *)v16,
                                           v84,
...
LABEL_52:
    ...
    v17 = *(_QWORD *)v16;
    v76 = 0LL;
    if ( (*(int (__fastcall **)(__int64, _QWORD, __int64 **))(v17 + 48))(v16, *((_QWORD *)a2 + 14), &v76) < 0 )
    {
    ...
    *((_QWORD *)&v91 + i) = v22;
    v25 = (char *)v9 + 2 * i;
    v16 = (unsigned __int8)*(_WORD *)&v25[i + 64];
    v73 = *(_WORD *)&v25[i + 64];
    v87 = v25;
    v26 = (_QWORD *)((char *)v24
                   + 128 * (_DWORD)v16
    ...
    *v65 = 0LL;
    ...
    {
      v67 = v66;
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v66, 0xC29u, 0LL);
      goto LABEL_126;
    }
    v9 = v72;
    v26 = v86;
...
LABEL_37:
  ...
  v67 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, -2147024809, 0xC24u, 0LL);
LABEL_126:
