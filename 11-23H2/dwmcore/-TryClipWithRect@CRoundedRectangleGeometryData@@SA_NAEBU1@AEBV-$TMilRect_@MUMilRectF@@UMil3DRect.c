/*
 * XREFs of ?TryClipWithRect@CRoundedRectangleGeometryData@@SA_NAEBU1@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAU1@@Z @ 0x18003A820
 * Callers:
...
bool __fastcall CRoundedRectangleGeometryData::TryClipWithRect(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v51 = *v3;
  TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::Inflate(&v51);
