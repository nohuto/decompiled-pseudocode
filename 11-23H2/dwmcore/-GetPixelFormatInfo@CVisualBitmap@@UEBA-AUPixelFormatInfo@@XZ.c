/*
 * XREFs of ?GetPixelFormatInfo@CVisualBitmap@@UEBA?AUPixelFormatInfo@@XZ @ 0x18021EFC0
 * Callers:
 *     ?IsOpaque@CVisualBitmap@@UEBA_NXZ @ 0x1801C5450 (-IsOpaque@CVisualBitmap@@UEBA_NXZ.c)
 * Callees:
