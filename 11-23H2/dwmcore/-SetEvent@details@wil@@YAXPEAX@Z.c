/*
 * XREFs of ?SetEvent@details@wil@@YAXPEAX@Z @ 0x1800D1614
 * Callers:
 *     ?CleanTrees@CComposition@@IEAAJXZ @ 0x18005EF70 (-CleanTrees@CComposition@@IEAAJXZ.c)
 *     ?ResetMmcss@CGlobalMit@@UEAAJXZ @ 0x1800D1490 (-ResetMmcss@CGlobalMit@@UEAAJXZ.c)
 *     ?TriggerMmcss@CKst@@QEAAJXZ @ 0x1800D1564 (-TriggerMmcss@CKst@@QEAAJXZ.c)
 *     ?RequestCursorUpdate@CGlobalMit@@UEAAXXZ @ 0x1800D15F0 (-RequestCursorUpdate@CGlobalMit@@UEAAXXZ.c)
