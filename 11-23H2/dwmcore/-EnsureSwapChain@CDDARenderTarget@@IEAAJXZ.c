/*
 * XREFs of ?EnsureSwapChain@CDDARenderTarget@@IEAAJXZ @ 0x1801313EC
 * Callers:
 *     ?CheckOcclusionState@CDDARenderTarget@@UEAAJXZ @ 0x1801313CA (-CheckOcclusionState@CDDARenderTarget@@UEAAJXZ.c)
 * Callees:
