/*
 * XREFs of ?SetAlphaMode@CConversionSwapChain@@UEAAXW4DXGI_ALPHA_MODE@@@Z @ 0x1802A2730
 * Callers:
 *     ?SetAlphaMode@CConversionSwapChain@@$4PPPPPPPM@DFI@EAAXW4DXGI_ALPHA_MODE@@@Z @ 0x180120FD0 (-SetAlphaMode@CConversionSwapChain@@$4PPPPPPPM@DFI@EAAXW4DXGI_ALPHA_MODE@@@Z.c)
 * Callees:
