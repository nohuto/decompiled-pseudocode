 ...
 *     ?_Calculate_growth@?$vector@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@V?$allocator@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@@2@@std@@AEBA_K_K@Z @ 0x1801E6824 (-_Calculate_growth@-$vector@V-$unique_ptr@VCSyncLockGroup@@U-$default_delete@VCSyncLockGroup@@@s.c)
        ...
        __int64 *a3)
{
  ...
  v6 = (qword_1803E6328 - CSyncLockGroup::g_syncLockGroups) >> 3;
