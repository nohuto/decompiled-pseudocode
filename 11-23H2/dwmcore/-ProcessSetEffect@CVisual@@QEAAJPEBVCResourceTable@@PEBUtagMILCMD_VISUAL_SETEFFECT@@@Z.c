/*
 * XREFs of ?ProcessSetEffect@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_SETEFFECT@@@Z @ 0x1800BEC2C
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETEFFECT *a3)
{
  ...
  {
    v10 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2003303421, 0xA0Bu, 0LL);
  }
  else
  {
    ...
    v10 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0xA0Fu, 0LL);
  }
  return v10;
}
