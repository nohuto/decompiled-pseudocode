/*
 * XREFs of ?EnsureShaderCache@CBrushRenderingGraphBuilder@@IEAAJ_N@Z @ 0x1800B92D4
 * Callers:
 ...
 *     ?GetUniqueShaderCache@CRenderingTechniqueFragment@@QEBAPEAVCShaderCache@@XZ @ 0x1800B9630 (-GetUniqueShaderCache@CRenderingTechniqueFragment@@QEBAPEAVCShaderCache@@XZ.c)
 */
...
LABEL_6:
  ...
  *(_QWORD *)(*(_QWORD *)this + 184LL) = v13;
  ...
  {
    v3 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, -2147024882, 0x2B4u, 0LL);
  }
  return v3;
}
