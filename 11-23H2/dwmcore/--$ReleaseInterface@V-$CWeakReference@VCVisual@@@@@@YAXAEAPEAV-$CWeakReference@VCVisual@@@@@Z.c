/*
 * XREFs of ??$ReleaseInterface@V?$CWeakReference@VCVisual@@@@@@YAXAEAPEAV?$CWeakReference@VCVisual@@@@@Z @ 0x1800E1B98
 * Callers:
 ...
 *     ?UnRegisterNotifiers@CInteraction@@UEAAXXZ @ 0x18020C990 (-UnRegisterNotifiers@CInteraction@@UEAAXXZ.c)
 * Callees:
