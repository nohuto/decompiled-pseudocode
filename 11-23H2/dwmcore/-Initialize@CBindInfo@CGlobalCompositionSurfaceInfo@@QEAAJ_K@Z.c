/*
 * XREFs of ?Initialize@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJ_K@Z @ 0x1800EBB30
 * Callers:
        ...
        __int64 a2)
{
  ...
  {
    v3 = v4 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_180357868, 4u, v4 | 0x10000000, 0x2A1u, 0LL);
    ...
    if ( v8 )
    {
      ...
      if ( !v9 )
      {
        if ( v33 > 1 )
        {
          ...
          if ( v13 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_180357868, 4u, v13, 0x2BDu, 0LL);
            if ( v28 )
...
LABEL_12:
        ...
        v27 = 707;
LABEL_26:
        MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_180357868, 4u, v16, v27, 0LL);
        goto LABEL_20;
      }
      if ( v9 == 1 )
      {
        ...
        if ( v19 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_180357868, 4u, v19, 0x2D3u, 0LL);
        }
        else
        {
          v21 = *((_QWORD *)this + 2);
          ...
          *((_QWORD *)this + 2) = v22;
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v24, &dword_180357868, 4u, v23, 0x2D7u, 0LL);
        }
        wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v28);
        if ( (unsigned __int64)(v17 - 1) <= 0xFFFFFFFFFFFFFFFDuLL )
          CloseHandle(v17);
    ...
    else
    {
      ...
      v3 = v25;
      if ( v25 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v26, &dword_1803B8B50, 3u, v25, 0x4EEu, 0LL);
      else
