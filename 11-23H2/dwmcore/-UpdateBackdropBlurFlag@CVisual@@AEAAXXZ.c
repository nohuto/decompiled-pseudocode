/*
 * XREFs of ?UpdateBackdropBlurFlag@CVisual@@AEAAXXZ @ 0x1800800D4
 * Callers:
...
void __fastcall CVisual::UpdateBackdropBlurFlag(CVisual *this)
{
  ...
  _BYTE *v9; // r14
  _BYTE *v10; // r15
  DwmDbg::DbgString *v11; // rbx
  DwmDbg::DbgString *v12; // rax
  DwmDbg::DbgString *v13; // rbx
  ...
  if ( dword_1803E3760 )
  {
    if ( v5 != ((*v9 & 4) != 0) )
    {
      v11 = DwmDbg::DbgString::DbgString((char **)&v15, "m_fIsBackdropBlur=%d", v5);
      v12 = DwmDbg::DbgString::DbgString(&v16, "Visual-IsBackdropBlurFlagChanged");
      DwmDbg::Backdrops::LogBrushEtwEvent(v12, this, v11);
    }
    v10 = (char *)this + 272;
    if ( v3 != ((*((_BYTE *)this + 272) & 2) != 0) )
    {
      v13 = DwmDbg::DbgString::DbgString((char **)&v15, "m_fHasBlurredWallpaperBackdropInput=%d", v3);
      v14 = DwmDbg::DbgString::DbgString(&v16, "Visual-HasBlurredWallpaperBackdropInputFlagChanged");
