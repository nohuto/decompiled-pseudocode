/*
 * XREFs of ??$_Destroy_range@V?$allocator@UHandleTableEntry@CChannel@@@std@@@std@@YAXPEAUHandleTableEntry@CChannel@@QEAU12@AEAV?$allocator@UHandleTableEntry@CChannel@@@0@@Z @ 0x18002934C
 * Callers:
 ...
 *     ?_Change_array@?$vector@UHandleTableEntry@CChannel@@V?$allocator@UHandleTableEntry@CChannel@@@std@@@std@@AEAAXQEAUHandleTableEntry@CChannel@@_K1@Z @ 0x180026834 (-_Change_array@-$vector@UHandleTableEntry@CChannel@@V-$allocator@UHandleTableEntry@CChannel@@@st.c)
...
__int64 __fastcall std::_Destroy_range<std::allocator<CChannel::HandleTableEntry>>(__int64 a1, __int64 a2)
{
  ...
  if ( a1 != a2 )
  {
    ...
    do
    {
      result = wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>(v3 + 8);
      v3 += 16LL;
    }
    while ( v3 != a2 );
  }
