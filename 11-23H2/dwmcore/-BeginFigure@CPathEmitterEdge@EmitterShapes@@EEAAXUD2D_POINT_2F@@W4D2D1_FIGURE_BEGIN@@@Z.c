/*
 * XREFs of ?BeginFigure@CPathEmitterEdge@EmitterShapes@@EEAAXUD2D_POINT_2F@@W4D2D1_FIGURE_BEGIN@@@Z @ 0x1802694E0
 * Callers:
 *     <none>
 * Callees:
 *     ?_Tidy@?$vector@MV?$allocator@M@std@@@std@@AEAAXXZ @ 0x1800F2840 (-_Tidy@-$vector@MV-$allocator@M@std@@@std@@AEAAXXZ.c)
