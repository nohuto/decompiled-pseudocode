/*
 * XREFs of ?PushRenderTarget@CDrawingContext@@QEAAJPEAVIDeviceTarget@@@Z @ 0x1800742C8
 * Callers:
...
LABEL_48:
  ...
  *v2 = a2;
  ...
  if ( v15 )
  {
    v28 = (char *)v15 + *(int *)(*((_QWORD *)v15 + 1) + 4LL) + 8;
...
LABEL_44:
  ...
  v21 = (**(__int64 (__fastcall ***)(struct IDeviceTarget *, __int128 *))*v2)(*v2, &v38);
  v22 = *v2;
