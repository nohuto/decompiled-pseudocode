/*
 * XREFs of ?LogEtwEvent@CBackdropVisualImage@@QEBAXVDbgString@DwmDbg@@0@Z @ 0x18004582C
 * Callers:
...
void __fastcall CBackdropVisualImage::LogEtwEvent(__int64 a1, void **a2, void **a3)
{
  ...
  if ( dword_1803E3760 )
  {
    ...
    if ( (unsigned int)dword_1803E3760 > 5 )
    {
      ...
      v19 = DwmDbg::DbgString::DbgString(
              (char **)&v61,
      ...
      if ( v20 )
      {
        v21 = DwmDbg::DbgString::DbgString((char **)&v59, "NoEffectInputTransform");
        v22 = 10;
        v14 = 6;
      }
      else
      {
        v21 = (DwmDbg::DbgString *)DwmDbg::DbgString::DbgString(
      ...
      if ( v11 )
      {
        v25 = (__int64 *)DwmDbg::DbgString::DbgString((char **)&v57, "0x%p (DesktopRoot)", v24);
      }
      else
      {
        DwmDbg::DbgString::DbgString((char **)&v36, "0x%p", v24);
        v25 = (__int64 *)&v36;
        v14 = v22;
      }
      v44 = *v25;
      ...
      v28 = DwmDbg::DbgString::DbgString((char **)&v54, "RealizationScale=[%s], DPI=[%s]", *v27, v26);
      v29 = *(_QWORD *)(a1 + 128);
      v30 = *(_QWORD *)(a1 + 120);
      v45 = *(_QWORD *)v28;
      DwmDbg::DbgString::DbgString((char **)&v37, "%.2f x %.2f", v30, v29);
      v31 = v37;
      ...
      v48 = *(_QWORD *)DwmDbg::DbgString::DbgString((char **)&lpMem, "[%s] -> 0x%p", *v34, v33);
