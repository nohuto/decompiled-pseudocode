/*
 * XREFs of ?FlushData@CDataStreamWriter@@QEAAPEAU_LIST_ENTRY@@XZ @ 0x1800962AC
 * Callers:
 ...
 *     ?GetCommandBatch@CChannel@@UEAAXPEAPEAXPEA_N@Z @ 0x1801CF120 (-GetCommandBatch@CChannel@@UEAAXPEAPEAXPEA_N@Z.c)
 * Callees:
 *     <none>
 */
