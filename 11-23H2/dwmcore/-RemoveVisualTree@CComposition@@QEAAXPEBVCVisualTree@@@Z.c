/*
 * XREFs of ?RemoveVisualTree@CComposition@@QEAAXPEBVCVisualTree@@@Z @ 0x1800C0314
 * Callers:
 *     ??1CVisual@@MEAA@XZ @ 0x18008375C (--1CVisual@@MEAA@XZ.c)
 *     ?FinalRelease@CVisualTree@@MEAAXXZ @ 0x1800C0300 (-FinalRelease@CVisualTree@@MEAAXXZ.c)
 * Callees:
