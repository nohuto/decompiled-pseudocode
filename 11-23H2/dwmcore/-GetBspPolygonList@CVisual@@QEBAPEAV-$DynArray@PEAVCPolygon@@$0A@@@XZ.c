/*
 * XREFs of ?GetBspPolygonList@CVisual@@QEBAPEAV?$DynArray@PEAVCPolygon@@$0A@@@XZ @ 0x18008336C
 * Callers:
 ...
 *     ?GetBspPolygonListCount@CVisual@@IEBAIXZ @ 0x1802106A4 (-GetBspPolygonListCount@CVisual@@IEBAIXZ.c)
