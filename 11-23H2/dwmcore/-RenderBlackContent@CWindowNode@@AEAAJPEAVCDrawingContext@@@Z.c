/*
 * XREFs of ?RenderBlackContent@CWindowNode@@AEAAJPEAVCDrawingContext@@@Z @ 0x1802564DC
 * Callers:
 ...
 * Callees:
 *     ?SetSingleRect@CRectanglesShape@@QEAAXAEBUMilRectF@@@Z @ 0x180011E44 (-SetSingleRect@CRectanglesShape@@QEAAXAEBUMilRectF@@@Z.c)
...
__int64 __fastcall CWindowNode::RenderBlackContent(CWindowNode *this, struct CDrawingContext *a2)
{
  ...
  v8 = CDrawingContext::FillShapeWithSolidColor(a2, v4, (const __m128i *)&stru_180386510);
  v10 = v8;
  v7 = v8;
  if ( v8 < 0 )
  {
