/*
 * XREFs of ?UpdateHardwareCursorOverlay@CCursorState@@AEAAXPEAUMonitorData@1@_N@Z @ 0x18027B5DC
 * Callers:
 *     ?SetPosition@CCursorState@@UEAAXMM@Z @ 0x18027ACB0 (-SetPosition@CCursorState@@UEAAXMM@Z.c)
 ...
 *     ?_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x18027BA90 (-_Log_NtStatus@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 */
