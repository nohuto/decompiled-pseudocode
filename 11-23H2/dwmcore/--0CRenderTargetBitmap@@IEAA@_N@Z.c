/*
 * XREFs of ??0CRenderTargetBitmap@@IEAA@_N@Z @ 0x1800A0EA0
 * Callers:
 ...
 *     ??0IRenderTargetBitmap@@QEAA@XZ @ 0x1800A1110 (--0IRenderTargetBitmap@@QEAA@XZ.c)
 *     ??0CD2DBitmapCache@@IEAA@XZ @ 0x1800ACA6C (--0CD2DBitmapCache@@IEAA@XZ.c)
 */
