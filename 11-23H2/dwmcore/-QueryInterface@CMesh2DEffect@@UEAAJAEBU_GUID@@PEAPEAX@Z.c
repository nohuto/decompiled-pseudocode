/*
 * XREFs of ?QueryInterface@CMesh2DEffect@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802BEDA0
 * Callers:
 *     ?QueryInterface@CMesh2DEffect@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180123D70 (-QueryInterface@CMesh2DEffect@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
