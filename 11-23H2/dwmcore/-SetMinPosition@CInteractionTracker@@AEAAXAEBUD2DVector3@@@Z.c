/*
 * XREFs of ?SetMinPosition@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z @ 0x180234838
 * Callers:
 *     ?ProcessSetMinPosition@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETMINPOSITION@@@Z @ 0x180233770 (-ProcessSetMinPosition@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTR.c)
 *     ?SetMaxPosition@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z @ 0x180234684 (-SetMaxPosition@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z.c)
 ...
 *     ?SetMaxPosition@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z @ 0x180234684 (-SetMaxPosition@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z.c)
 *     ?ReconfigureAllManipulations@InteractionSourceManager@@QEAAXXZ @ 0x180274DAC (-ReconfigureAllManipulations@InteractionSourceManager@@QEAAXXZ.c)
 */
...
void __fastcall CInteractionTracker::SetMinPosition(CInteractionTracker *this, const struct D2DVector3 *a2)
{
  ...
  v4 = *(_QWORD *)((char *)this + 92) - *(_QWORD *)a2;
  if ( !v4 )
    v4 = *((unsigned int *)this + 25) - (unsigned __int64)*((unsigned int *)a2 + 2);
  if ( v4 )
  {
    LODWORD(v5) = COERCE_UNSIGNED_INT(*((float *)this + 23) - *(float *)a2) & _xmm;
    v6 = v5 > 0.0000011920929;
    v7 = 0.0000011920929 == v5;
    v8 = *((float *)this + 24) - *((float *)a2 + 1);
    v9 = (v6 || v7) + 4;
    ...
    *((_DWORD *)this + 25) = *((_DWORD *)a2 + 2);
    ...
    v10 = fmaxf(*((float *)this + 24), *((float *)this + 27));
    v12[0] = fmaxf(*((float *)this + 23), *((float *)this + 26));
    v11 = fmaxf(*((float *)this + 25), *((float *)this + 28));
    *(float *)&v12[1] = v10;
    *(float *)&v12[2] = v11;
