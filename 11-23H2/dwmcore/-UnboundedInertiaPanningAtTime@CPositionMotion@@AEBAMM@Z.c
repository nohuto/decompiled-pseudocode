/*
 * XREFs of ?UnboundedInertiaPanningAtTime@CPositionMotion@@AEBAMM@Z @ 0x18026F4A8
 * Callers:
 *     ?AdvanceInertiaToTimeDefault@CPositionMotion@@MEAAMXZ @ 0x18026F1C0 (-AdvanceInertiaToTimeDefault@CPositionMotion@@MEAAMXZ.c)
