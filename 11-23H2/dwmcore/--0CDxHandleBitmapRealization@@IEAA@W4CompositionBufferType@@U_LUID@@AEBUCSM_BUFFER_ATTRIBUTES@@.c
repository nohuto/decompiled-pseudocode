/*
 * XREFs of ??0CDxHandleBitmapRealization@@IEAA@W4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@_N4PEAVCDecodeBitmap@@@Z @ 0x1800A0414
 * Callers:
        ...
        int a9)
{
  ...
  *(_BYTE *)(a1 + 393) = 1;
  ...
  v16 = (int *)CBitmapRealization::CalcDisplayRestriction(&a7, v15, *(_QWORD *)(a4 + 8), v12, v19, v20);
  v17 = *v16;
  *(_DWORD *)(a1 + 280) = *v16;
