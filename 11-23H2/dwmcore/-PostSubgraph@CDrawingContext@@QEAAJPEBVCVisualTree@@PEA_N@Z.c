/*
 * XREFs of ?PostSubgraph@CDrawingContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x180044720
 * Callers:
...
LABEL_5:
        ...
        while ( 1 )
        {
          ...
          if ( v17 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0xDFAu, 0LL);
            MilInstrumentationCheckHR_MaybeFailFast(v43, 0LL, 0, v5, 0x1813u, 0LL);
            goto LABEL_19;
          }
        }
        v11 = *((_DWORD *)this + 848);
               ...
               (unsigned int)v13) )
        {
          ...
          if ( v44 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v45, 0LL, 0, v44, 0x181Fu, 0LL);
            goto LABEL_19;
          }
          goto LABEL_17;
        }
...
LABEL_26:
    ...
    {
      v5 = -2147221184;
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v27, 0LL, 0, -2147221184, 0x17E1u, 0LL);
      goto LABEL_19;
    }
  }
LABEL_27:
