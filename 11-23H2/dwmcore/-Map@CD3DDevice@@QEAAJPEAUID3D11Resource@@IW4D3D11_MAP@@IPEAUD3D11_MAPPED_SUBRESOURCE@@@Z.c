/*
 * XREFs of ?Map@CD3DDevice@@QEAAJPEAUID3D11Resource@@IW4D3D11_MAP@@IPEAUD3D11_MAPPED_SUBRESOURCE@@@Z @ 0x1800B7688
 * Callers:
        ...
        struct D3D11_MAPPED_SUBRESOURCE *a6)
{
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v6, 0x9F9u, 0LL);
  }
  else
  {
