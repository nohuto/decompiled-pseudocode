/*
 * XREFs of ?ConfigureIntermediateFromBackdropInput@CBrushRenderingGraph@@KAXAEBUIntermediateConfigurationInputs@1@PEAUIntermediateConfigurationOutputs@1@@Z @ 0x1800B2164
 * Callers:
        ...
        struct CBrushRenderingGraph::IntermediateConfigurationOutputs *a2)
{
  ...
  float v19[10]; // [rsp+30h] [rbp-81h] BYREF
  float v20[10]; // [rsp+58h] [rbp-59h] BYREF
  struct D2D_RECT_F v21; // [rsp+80h] [rbp-31h] BYREF
  float v22; // [rsp+90h] [rbp-21h]
  float v23; // [rsp+94h] [rbp-1Dh]
  struct D2D_RECT_F v24; // [rsp+98h] [rbp-19h] BYREF
  ...
  Matrix3x3::operator*((float *)(v6 + 48), v19, &v21.left);
  Matrix3x3::Get2DScaleDimensionsWithPerspective(v19, (char *)a2 + 24, (char *)a2 + 28, &v24);
  v8 = *a1;
  v9 = a1[1];
  v24.left = 0.0;
  v24.top = 0.0;
  ...
  *((float *)a2 + 3) = _mm_shuffle_ps(v12, v12, 255).m128_f32[0] - v13;
  ...
  v22 = 0.0 - (float)((float)(int)v18 * 0.0);
  v23 = 0.0 - (float)((float)SHIDWORD(v18) * 0.0);
  v14 = Matrix3x3::operator*((float *)(v6 + 48), v19, &v21.left);
  v12.m128_i32[0] ^= _xmm;
  LODWORD(v15) = LODWORD(v13) ^ _xmm;
  v21 = *(struct D2D_RECT_F *)&_xmm;
  v22 = v12.m128_f32[0];
  v23 = v15;
  v16 = Matrix3x3::operator*(v14, v20, &v21.left);
  *(_OWORD *)(v7 + 48) = *(_OWORD *)v16;
  *(_OWORD *)(v7 + 64) = *((_OWORD *)v16 + 1);
  *(float *)(v7 + 80) = v16[8];
