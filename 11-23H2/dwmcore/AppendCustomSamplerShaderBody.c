/*
 * XREFs of AppendCustomSamplerShaderBody @ 0x1800F6404
 * Callers:
        ...
        __int64 a7)
{
  ...
  v15 = (_BYTE *)(a4 + 32LL * (unsigned __int8)*(_WORD *)(a3 + 52));
  if ( v15[18] )
  {
    LOBYTE(v13) = v15[16];
    if ( (_BYTE)v13 )
...
LABEL_18:
  ...
  appended = AppendColorModifications(a1, (__int64)v15, a2, v30);
  v22 = appended;
  if ( appended < 0 )
  {
    v25 = 1162LL;
