/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x1802BA850
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x1802BB208 (s_TransformPointByMatrix.c)
 */
