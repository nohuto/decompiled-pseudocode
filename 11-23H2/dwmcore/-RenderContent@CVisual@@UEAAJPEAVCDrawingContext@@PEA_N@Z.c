/*
 * XREFs of ?RenderContent@CVisual@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x1800517A0
 * Callers:
 ...
 *     ?GetWindowBackgroundTreatmentVisual@CWindowBackgroundTreatment@@SAPEBVCVisual@@PEBV2@@Z @ 0x1800137C4 (-GetWindowBackgroundTreatmentVisual@CWindowBackgroundTreatment@@SAPEBVCVisual@@PEBV2@@Z.c)
...
__int64 __fastcall CVisual::RenderContent(CVisual *this, struct CDrawingContext *a2, bool *a3)
{
  ...
  DwmDbg::DbgString *v33; // rbx
  DwmDbg::DbgString *v34; // rax
  const char *v35; // rsi
  const char *v36; // rbx
  char v37; // r15
  __int64 v38; // rcx
  ...
  if ( *((_QWORD *)this + 32) )
  {
    ...
    else
    {
      if ( dword_1803E3760 )
      {
        ...
        v33 = DwmDbg::DbgString::DbgString(&v47, "pBVI=0x%p, bviPath=[%s]", BackdropVisualImage, v31);
        v34 = DwmDbg::DbgString::DbgString(&v48, "Visual-HasBackdropInput-ValidateBVI");
      ...
      v50 = v24 + 0.0;
      v51 = v23 + 0.0;
      v25 = CDrawingContext::ValidateBVIEffectInputForRender((__int64)a2, (struct MilRectF *)&v49, (bool *)&v43);
      if ( v25 < 0 )
      {
...
LABEL_7:
        ...
        if ( p_Blink )
        {
          ...
          if ( Cache < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast((unsigned int)p_Blink, 0LL, 0, Cache, 0x71Eu, 0LL);
            v13 = v45;
            goto LABEL_42;
          }
          v13 = v45;
...
LABEL_15:
          ...
          v20 = (*(__int64 (__fastcall **)(__int64, struct CDrawingContext *, char *, struct CDrawListCache *))(*(_QWORD *)v19 + 16LL))(
                  ...
                  v13);
          if ( v20 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v21, &dword_18033BD28, 3u, v20, 0x1035u, 0LL);
          goto LABEL_17;
        }
LABEL_42:
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)p_Blink, &dword_18033BD28, 3u, v15, 0x1030u, 0LL);
        v3 = v44;
LABEL_17:
        if ( v13 )
        {
