/*
 * XREFs of _anonymous_namespace_::SealCurrentFrameSequence @ 0x1800B080C
 * Callers:
 ...
 *     ??$_Buyheadnode@V?$allocator@U?$_Tree_node@U?$pair@$$CBW4Enum@SceneMaterialInputType@@I@std@@PEAX@std@@@std@@@?$_Tree_node@U?$pair@$$CBW4Enum@SceneMaterialInputType@@I@std@@PEAX@std@@SAPEAU01@AEAV?$allocator@U?$_Tree_node@U?$pair@$$CBW4Enum@SceneMaterialInputType@@I@std@@PEAX@std@@@1@@Z @ 0x1800B0BE8 (--$_Buyheadnode@V-$allocator@U-$_Tree_node@U-$pair@$$CBW4Enum@SceneMaterialInputType@@I@std@@PEA.c)
 *     _anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo @ 0x1800B0DAC (_anonymous_namespace_--FrameSequenceInfo--FrameSequenceInfo.c)
 *     std::_Tree_node_std::pair__anonymous_namespace_::AnimationId_const__unsigned_int__void___::_Buyheadnode_std::allocator_std::_Tree_node_std::pair__anonymous_namespace_::AnimationId_const__unsigned_int__void_______ @ 0x1800B1768 (std--_Tree_node_std--pair__anonymous_namespace_--AnimationId_const__unsigned_int__void___--_Buyh.c)
 *     _anonymous_namespace_::FrameSequenceInfo::operator_ @ 0x1800B18F8 (_anonymous_namespace_--FrameSequenceInfo--operator_.c)
 ...
 *     _anonymous_namespace_::FramesReport::FramesReport @ 0x1800BF9B0 (_anonymous_namespace_--FramesReport--FramesReport.c)
...
void __fastcall anonymous_namespace_::SealCurrentFrameSequence(char a1)
{
  ...
  if ( dword_1803E5A18 )
  {
    ...
    *(_QWORD *)ppsmemCounters = off_1802CE298;
    xmmword_1803E5C70 = *(_OWORD *)&ppsmemCounters[64];
    qword_1803E5C80 = v31;
    *(_QWORD *)&ppsmemCounters[56] = ppsmemCounters;
    CProcessAttributionObserver::ForEachChangedProcessAttribution(*(_QWORD *)qword_1803E5C90, 0LL, ppsmemCounters);
    v2 = g_qpcFrequency;
      ...
      || g_fTelemetry_FramesReportFast && v7 >= 0x3E8 )
    {
      ...
      *(_OWORD *)(*((_QWORD *)qword_1803E5C90 + 5) + 176LL) = xmmword_1803E5C18;
      v15 = v13[5];
      ...
      *(_QWORD *)(v15 + 104) = v16;
      ...
      v20 = (union _SLIST_HEADER *)qword_1803E5C90;
      v21 = (struct _SLIST_ENTRY *)*((_QWORD *)qword_1803E5C90 + 5);
      *((_QWORD *)qword_1803E5C90 + 5) = v18;
      InterlockedPushEntrySList(v20 + 3, v21);
      SubmitThreadpoolWork(*((PTP_WORK *)qword_1803E5C90 + 1));
    }
    v29 = 0LL;
