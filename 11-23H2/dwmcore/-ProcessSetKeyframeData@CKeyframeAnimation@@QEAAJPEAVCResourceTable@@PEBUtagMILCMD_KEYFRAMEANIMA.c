/*
 * XREFs of ?ProcessSetKeyframeData@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_KEYFRAMEANIMATION_SETKEYFRAMEDATA@@@Z @ 0x1800810E0
 * Callers:
 ...
 *     ??$ReleaseInterface@VCSharedSection@@@@YAXAEAPEAVCSharedSection@@@Z @ 0x180099984 (--$ReleaseInterface@VCSharedSection@@@@YAXAEAPEAVCSharedSection@@@Z.c)
  ...
  *((_DWORD *)v5 + 92) = *((_DWORD *)a3 + 2);
  ...
  if ( v12 >= 0 )
  {
    if ( *((_DWORD *)a3 + 13) )
    {
      ...
      ReplaceInterface<CSharedSection,CSharedSection>((CResource **)v5 + 47, v18);
