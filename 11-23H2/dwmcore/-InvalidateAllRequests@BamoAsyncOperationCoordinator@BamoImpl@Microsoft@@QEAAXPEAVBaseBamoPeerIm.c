/*
 * XREFs of ?InvalidateAllRequests@BamoAsyncOperationCoordinator@BamoImpl@Microsoft@@QEAAXPEAVBaseBamoPeerImpl@23@@Z @ 0x1801B97F0
 * Callers:
      ...
      if ( v11 )
      {
        ...
        if ( v12 < 0 )
          wil::details::in1diag3::FailFast_Hr(
            retaddr,
            251LL,
            (__int64)"g:\\os\\tools\\BamoCodegen\\Inc\\BamoAsyncOperationCoordinator.inl",
