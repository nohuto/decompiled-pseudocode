/*
 * XREFs of ?AddToBspPolygonList@CVisual@@IEAAJPEAVCPolygon@@@Z @ 0x180210150
 * Callers:
...
__int64 __fastcall CVisual::AddToBspPolygonList(CVisual *this, struct CPolygon *a2)
{
  ...
  if ( !BspPolygonList )
  {
    ...
    {
      v10 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024882, 0x1760u, 0LL);
      return v10;
    }
    *v6 = 0LL;
    v6[1] = 0LL;
...
LABEL_12:
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x1764u, 0LL);
    return v10;
  }
  v11 = 0;
