/*
 * XREFs of ?insert@?$vector_facade@DV?$buffer_impl@D$0DA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAA?AV?$basic_iterator@D@2@V?$basic_iterator@$$CBD@2@_KAEBD@Z @ 0x1800F65E8
 * Callers:
