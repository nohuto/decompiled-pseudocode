/*
 * XREFs of ?CalcRootBounds@CVisual@@QEBAJPEAV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800BE880
 * Callers:
 ...
 *     ?Initialize@CSubVisualTree@@MEAAJXZ @ 0x180258AA0 (-Initialize@CSubVisualTree@@MEAAJXZ.c)
 * Callees:
...
LABEL_7:
  ...
  *(_QWORD *)&v28 = 0LL;
  ...
  if ( ShapeData < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, ShapeData, 0x63u, 0LL);
    goto LABEL_38;
  }
  ...
  {
LABEL_36:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v16, 0LL, 0, v17, 0x64u, 0LL);
LABEL_38:
    v16 = (void (__fastcall ***)(_QWORD, __int64))v28;
  }
  if ( v15 == -2003304438 )
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v16, 0LL, 0, v15, 0x617u, 0LL);
  }
  else
  {
    v20 = *(_DWORD *)(a2 + 16);
