/*
 * XREFs of ?MakeTargetFromSource@CGraphRenderingContext@CExternalEffectGraph@@QEAAIIAEBVMatrix3x2F@D2D1@@@Z @ 0x1800AFCEC
 * Callers:
        ...
        const struct D2D_RECT_F *a3)
{
  ...
  *((float *)this + 11) = _mm_shuffle_ps(v12, v12, 255).m128_f32[0] - v13;
  ...
  CDrawListBitmap::GetSize((CDrawListBitmap *)v7, &v25);
  top = v25.top;
  v25.top = 0.0;
  v25.right = 0.0;
