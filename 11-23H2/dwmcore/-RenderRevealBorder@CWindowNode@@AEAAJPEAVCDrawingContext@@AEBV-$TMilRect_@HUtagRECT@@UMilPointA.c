/*
 * XREFs of ?RenderRevealBorder@CWindowNode@@AEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@PEBVCShape@@@Z @ 0x180133B8A
 * Callers:
...
__int64 __fastcall CWindowNode::RenderRevealBorder(__int64 a1, __int64 a2, const struct tagRECT *a3, __int64 a4)
{
  ...
  struct CShape *v26; // [rsp+48h] [rbp-B8h] BYREF
     ...
     || *(_DWORD *)(a1 + 756) - *(_DWORD *)(a1 + 748) > a3->bottom - a3->top) )
  {
    ...
    v25 = &v23;
    v27 = 1;
    v4 = CShape::Combine((__int64)v30, v12, (__int64)v29, 0LL, 2, &v26);
    if ( v27 )
    {
      v14 = (__int64)v26;
      v13 = *v25;
      *v25 = v26;
      if ( v13 )
        std::default_delete<CShape>::operator()(v14, (__int64 (__fastcall ***)(_QWORD, __int64))v13);
    }
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v4, 0x5C8u, 0LL);
    }
    else if ( a4 )
    {
      v25 = &v24;
      ...
      v26 = 0LL;
      v27 = 1;
      v4 = CShape::Combine((__int64)v23, (__int64)v13, a4, 0LL, 1, &v26);
      if ( v27 )
      {
        v16 = *v25;
        *v25 = v26;
