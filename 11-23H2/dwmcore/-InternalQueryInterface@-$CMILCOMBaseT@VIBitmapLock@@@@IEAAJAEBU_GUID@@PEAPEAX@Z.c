/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIBitmapLock@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180281D28
 * Callers:
 *     ?QueryInterface@CBitmapLock@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180281DD0 (-QueryInterface@CBitmapLock@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
