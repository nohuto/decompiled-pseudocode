/*
 * XREFs of CHolographicInteropTaskQueue::ProcessPendingMessages__lambda_db6293ec4389496e05a5db7898b72386___ @ 0x1802A3CBC
 * Callers:
 *     ?PreRender@CHolographicManager@@UEAAXXZ @ 0x1800E88A0 (-PreRender@CHolographicManager@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?ReleaseInteropRenderTarget@CHolographicManager@@AEAAXXZ @ 0x1802A57C0 (-ReleaseInteropRenderTarget@CHolographicManager@@AEAAXXZ.c)
 *     ?ReleaseInteropTextures@CHolographicManager@@QEAAXXZ @ 0x1802A582C (-ReleaseInteropTextures@CHolographicManager@@QEAAXXZ.c)
