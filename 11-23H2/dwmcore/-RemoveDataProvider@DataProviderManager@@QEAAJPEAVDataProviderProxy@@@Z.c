/*
 * XREFs of ?RemoveDataProvider@DataProviderManager@@QEAAJPEAVDataProviderProxy@@@Z @ 0x1801B77F0
 * Callers:
 ...
 *     ?OnDisconnected@DataProviderProxy@@MEAAJXZ @ 0x1801E4370 (-OnDisconnected@DataProviderProxy@@MEAAJXZ.c)
 * Callees:
