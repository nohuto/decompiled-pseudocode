/*
 * XREFs of ?ResetBackBuffer@CLegacyStereoSwapChain@@MEAAJXZ @ 0x18029FF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLegacyStereoSwapChain::ResetBackBuffer(CLegacyStereoSwapChain *this)
{
  ...
  *v1 = 0LL;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_180386F20, 2u, v5, 0xC6u, 0LL);
  }
  else
  {
    v8 = *((_QWORD *)this + 16);
    if ( v8 )
    {
      ...
      *v1 = 0LL;
      ...
      v7 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_180386F20, 2u, v14, 0xCEu, 0LL);
      else
