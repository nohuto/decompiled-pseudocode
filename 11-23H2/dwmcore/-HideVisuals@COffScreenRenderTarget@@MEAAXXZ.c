/*
 * XREFs of ?HideVisuals@COffScreenRenderTarget@@MEAAXXZ @ 0x1801E9A30
 * Callers:
 *     ?HideVisuals@CMagnifierRenderTarget@@MEAAXXZ @ 0x1801EFDA0 (-HideVisuals@CMagnifierRenderTarget@@MEAAXXZ.c)
 * Callees:
