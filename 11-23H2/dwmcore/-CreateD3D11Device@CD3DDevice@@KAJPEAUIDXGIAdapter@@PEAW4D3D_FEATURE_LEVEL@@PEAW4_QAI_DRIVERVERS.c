/*
 * XREFs of ?CreateD3D11Device@CD3DDevice@@KAJPEAUIDXGIAdapter@@PEAW4D3D_FEATURE_LEVEL@@PEAW4_QAI_DRIVERVERSION@@PEAT_LARGE_INTEGER@@PEAPEAUID3D11Device1@@@Z @ 0x1801018B4
 * Callers:
 ...
 *     ?IsOOM@@YA_NJ@Z @ 0x1800ED1B8 (-IsOOM@@YA_NJ@Z.c)
 *     ?CurrentProcessHasIncreasedPriorityPrivileges@@YA_NXZ @ 0x1800FF754 (-CurrentProcessHasIncreasedPriorityPrivileges@@YA_NXZ.c)
        ...
        struct ID3D11Device1 **a5)
{
  ...
  v12 = CurrentProcessHasIncreasedPriorityPrivileges() == 0;
  FeatureLevels = 9;
