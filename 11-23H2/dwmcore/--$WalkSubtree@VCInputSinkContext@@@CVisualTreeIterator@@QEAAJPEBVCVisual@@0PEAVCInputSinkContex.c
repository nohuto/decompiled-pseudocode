/*
 * XREFs of ??$WalkSubtree@VCInputSinkContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@0PEAVCInputSinkContext@@W4WalkReason@@@Z @ 0x180083458
 * Callers:
 ...
 *     ?GotoParent@?$CGraphWalker@VCVisual@@@@QEAAXPEAPEAVCVisual@@@Z @ 0x1800814C0 (-GotoParent@-$CGraphWalker@VCVisual@@@@QEAAXPEAPEAVCVisual@@@Z.c)
 ...
 *     ?GotoSibling@?$CGraphWalker@VCVisual@@@@QEAAJPEAPEAVCVisual@@PEAV?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@@Z @ 0x1800836A4 (-GotoSibling@-$CGraphWalker@VCVisual@@@@QEAAJPEAPEAVCVisual@@PEAV-$vector@PEAVCVisual@@V-$alloca.c)
...
__int64 __fastcall CVisualTreeIterator::WalkSubtree<CInputSinkContext>(__int64 a1, CVisual *a2, __int64 a3, __int64 a4)
{
  int v8; // eax
  unsigned int v9; // ecx
  ...
  *(_DWORD *)(a1 + 72) = 1;
  v8 = CGraphWalker<CVisual>::BeginWalk();
  v10 = v8;
  if ( v8 < 0 )
  {
  ...
  else
  {
    v11 = *(CVisual **)(a1 + 8);
LABEL_3:
    while ( (*((_BYTE *)v11 + 103) & 1) != 0 || v11 == a2 )
    {
