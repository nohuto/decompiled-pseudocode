/*
 * XREFs of ?RecordCachedUsageUnderLock@EnabledStateManager@details@wil@@AEAAXXZ @ 0x180199300
 * Callers:
 ...
 *     ?OnTimer@EnabledStateManager@details@wil@@QEAAXXZ @ 0x1801A77C0 (-OnTimer@EnabledStateManager@details@wil@@QEAAXXZ.c)
 * Callees:
