/*
 * XREFs of ??1CDDisplayManager@@QEAA@XZ @ 0x18010E8E0
 * Callers:
 *     _dynamic_atexit_destructor_for__g_DDisplayManager__ @ 0x180124350 (_dynamic_atexit_destructor_for__g_DDisplayManager__.c)
 * Callees:
