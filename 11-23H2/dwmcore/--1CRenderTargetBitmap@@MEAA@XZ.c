/*
 * XREFs of ??1CRenderTargetBitmap@@MEAA@XZ @ 0x1800A0D7C
 * Callers:
...
void __fastcall CRenderTargetBitmap::~CRenderTargetBitmap(CRenderTargetBitmap *this)
{
  ...
  *(_DWORD *)((char *)this + v6 + 12) = v6 - 224;
  ...
  wil::com_ptr_t<ID2DBitmap,wil::err_returncode_policy>::~com_ptr_t<ID2DBitmap,wil::err_returncode_policy>((char *)this + 136);
