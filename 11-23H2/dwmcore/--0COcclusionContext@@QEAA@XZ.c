/*
 * XREFs of ??0COcclusionContext@@QEAA@XZ @ 0x1800B391C
 * Callers:
 ...
 *     ??0CDirtyRegion@@IEAA@PEAVCVisualTree@@@Z @ 0x18009FFC4 (--0CDirtyRegion@@IEAA@PEAVCVisualTree@@@Z.c)
 *     ??0CCachedVisualImage@@IEAA@PEAVCComposition@@_N@Z @ 0x1800A3A98 (--0CCachedVisualImage@@IEAA@PEAVCComposition@@_N@Z.c)
 *     ??0COffScreenRenderTarget@@IEAA@PEAVCComposition@@AEBVCResourceTag@@@Z @ 0x1801E940C (--0COffScreenRenderTarget@@IEAA@PEAVCComposition@@AEBVCResourceTag@@@Z.c)
 ...
 * Callees:
 *     ??0CLightStack@@QEAA@XZ @ 0x1800B38C4 (--0CLightStack@@QEAA@XZ.c)
