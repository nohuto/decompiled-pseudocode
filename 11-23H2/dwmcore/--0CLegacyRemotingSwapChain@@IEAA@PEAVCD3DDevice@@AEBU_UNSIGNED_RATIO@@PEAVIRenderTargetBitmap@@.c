/*
 * XREFs of ??0CLegacyRemotingSwapChain@@IEAA@PEAVCD3DDevice@@AEBU_UNSIGNED_RATIO@@PEAVIRenderTargetBitmap@@PEAXPEAUHINSTANCE__@@@Z @ 0x180109CF0
 * Callers:
 ...
 * Callees:
 *     ??0CDeviceResource@@IEAA@XZ @ 0x1800A10B4 (--0CDeviceResource@@IEAA@XZ.c)
 ...
 *     ??0ILegacyRemotingSwapChain@@QEAA@XZ @ 0x18010A0A8 (--0ILegacyRemotingSwapChain@@QEAA@XZ.c)
 */
