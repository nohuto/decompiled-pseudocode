/*
 * XREFs of ?WaitForNextFrameStart@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x1800465B8
 * Callers:
...
void __fastcall CPartitionVerticalBlankScheduler::WaitForNextFrameStart(CPartitionVerticalBlankScheduler *this)
{
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 4) != 0 )
    McGenEventWrite_EventWriteTransfer(&Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_WFVB_Start);
  v7 = *((_QWORD *)this + 527);
  *((_BYTE *)this + 4552) = 0;
