/*
 * XREFs of ?SetProjectedShadowCasters@CVisual@@QEAAXPEAV?$vector@PEAVCProjectedShadowCaster@@V?$allocator@PEAVCProjectedShadowCaster@@@std@@@std@@@Z @ 0x18000A31C
 * Callers:
...
__int64 __fastcall CVisual::SetProjectedShadowCasters(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      result = CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot(v2, 14LL);
      *(_QWORD *)result = a2;
    }
  }
  else if ( (result & 0x40000) != 0 )
  {
    ...
    *v5 = result & 0xFFFBFFFF;
    result = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v7, 14LL);
