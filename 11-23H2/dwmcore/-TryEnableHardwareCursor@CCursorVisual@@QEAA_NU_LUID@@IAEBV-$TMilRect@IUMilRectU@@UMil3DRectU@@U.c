/*
 * XREFs of ?TryEnableHardwareCursor@CCursorVisual@@QEAA_NU_LUID@@IAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@AEBVCMILMatrix@@@Z @ 0x180228A9C
 * Callers:
...
bool __fastcall CCursorVisual::TryEnableHardwareCursor(__int64 a1, int a2, int a3, int a4, __int64 a5)
{
  ...
  if ( v5 )
  {
    ...
    v11[2] = v8;
    v11[3] = v9;
    return (unsigned __int8)CCursorState::TryEnableHardwareCursor(v5, a2, a3, a4, (struct CMILMatrix *)v11) != 0;
  }
  return v6;
}
