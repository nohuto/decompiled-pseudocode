/*
 * XREFs of ?Push@?$CWatermarkStack@UCFrame@?$CGraphWalker@VCBspNode@@@@$0EA@$01$09@@QEAAJAEBUCFrame@?$CGraphWalker@VCBspNode@@@@@Z @ 0x1801F6390
 * Callers:
...
__int64 __fastcall CWatermarkStack<CGraphWalker<CBspNode>::CFrame,64,2,10>::Push(unsigned int *a1, _OWORD *a2)
{
  ...
  if ( (unsigned int)v7 <= 0x40 )
    LODWORD(v7) = 64;
  v8 = HrMalloc(0x10uLL, (unsigned int)v7, &v14);
  v6 = v8;
  if ( v8 < 0 )
  {
