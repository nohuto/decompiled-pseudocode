/*
 * XREFs of ?CreateDeviceTextureTarget@CD3DDevice@@QEAAJAEBVCResourceTag@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVIDeviceTextureTarget@@@Z @ 0x1800A0618
 * Callers:
        ...
        struct IDeviceTextureTarget **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802EE308, 2u, v10, 0x4B1u, 0LL);
  }
  else
  {
    v13 = *((_DWORD *)a4 + 1);
    ...
    v12 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_1802EE308, 2u, v16, 0x4C2u, 0LL);
  }
