/*
 * XREFs of ??1?$CTransform3DGroupGeneratedT@VCTransform3DGroup@@VCTransform3D@@@@MEAA@XZ @ 0x1801C17F8
 * Callers:
 *     ??1CTransform3DGroup@@MEAA@XZ @ 0x180254AD8 (--1CTransform3DGroup@@MEAA@XZ.c)
 * Callees:
