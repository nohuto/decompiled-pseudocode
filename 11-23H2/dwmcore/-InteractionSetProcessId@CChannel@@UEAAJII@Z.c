/*
 * XREFs of ?InteractionSetProcessId@CChannel@@UEAAJII@Z @ 0x1800F6F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::InteractionSetProcessId(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
