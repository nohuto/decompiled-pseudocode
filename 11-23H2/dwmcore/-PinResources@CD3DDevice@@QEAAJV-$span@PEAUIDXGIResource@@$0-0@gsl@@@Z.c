/*
 * XREFs of ?PinResources@CD3DDevice@@QEAAJV?$span@PEAUIDXGIResource@@$0?0@gsl@@@Z @ 0x180290110
 * Callers:
...
__int64 __fastcall CD3DDevice::PinResources(__int64 a1, _QWORD *a2)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1803BA148, 2u, v2, 0x35Cu, 0LL);
  }
  else
  {
    v7 = 0;
...
LABEL_11:
    ...
    if ( ((v5 - v3) & 0xFFFFFFFFFFFFFFF8uLL) != 0 )
    {
      ...
      v2 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1803BA148, 2u, v11, 0x37Fu, 0LL);
      if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10000000) != 0 )
        McTemplateU0q_EventWriteTransfer(
          (__int64)&Microsoft_Windows_Dwm_Core_Provider_Context,
