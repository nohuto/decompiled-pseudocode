/*
 * XREFs of ?ExecuteShaders@CGraphRenderingContext@CExternalEffectGraph@@QEBAJII@Z @ 0x1800A912C
 * Callers:
  ...
  *((_OWORD *)v12 + 2) = *(_OWORD *)v26;
  if ( a3 )
  {
    while ( 1 )
    {
      ...
      v28[1] = 1;
      v28[0] = v10 + a2;
      EffectInput::operator=((__int64)v29, *((_QWORD *)this + 6) + 104LL * *((unsigned int *)this + 8));
      ...
      if ( updated < 0 )
        break;
      v16 = CDrawListCache::Render((__int64)v13, *(CDrawingContext **)this, (CMILMatrix *)&CMILMatrix::Identity, 1.0);
      v15 = v16;
      if ( v16 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
