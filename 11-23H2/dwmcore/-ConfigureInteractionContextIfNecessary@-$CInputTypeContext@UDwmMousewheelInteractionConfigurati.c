/*
 * XREFs of ?ConfigureInteractionContextIfNecessary@?$CInputTypeContext@UDwmMousewheelInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeMousewheelPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeMousewheelPrimitiveType@@@@QEAAJAEBUInteractionStateInfo@@PEAUTemporaryConfiguration@@@Z @ 0x1801AC630
 * Callers:
...
LABEL_44:
  ...
  if ( v16 == 2 && ((*((_BYTE *)a1 + 136) ^ (*((_BYTE *)a1 + 148) >> 1)) & 1) != 0 )
  {
    ...
    if ( (*((_BYTE *)a1 + 148) & 2) != 0
      ...
      && tlgKeywordOn((__int64)&dword_1803E37D0, 2LL) )
    {
      *(_QWORD *)&v30 = a1;
      v33 = &v30;
      v34 = 8LL;
      tlgWriteTransfer_EventWriteTransfer(v17, (unsigned __int8 *)dword_18037E1F3, 0LL, 0LL, 3u, &v32);
      v16 = *((_DWORD *)a1 + 39);
      v8 = 1;
    }
  }
