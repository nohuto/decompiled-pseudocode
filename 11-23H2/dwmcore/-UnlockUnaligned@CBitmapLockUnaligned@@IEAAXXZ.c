/*
 * XREFs of ?UnlockUnaligned@CBitmapLockUnaligned@@IEAAXXZ @ 0x180282284
 * Callers:
 *     ??1CBitmapLockUnaligned@@UEAA@XZ @ 0x180281EE8 (--1CBitmapLockUnaligned@@UEAA@XZ.c)
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x180042C34 (--3@YAXPEAX@Z.c)
 *     ?WriteUnalignedScanline@@YAXPEAEPEBEII@Z @ 0x180282318 (-WriteUnalignedScanline@@YAXPEAEPEBEII@Z.c)
 */
