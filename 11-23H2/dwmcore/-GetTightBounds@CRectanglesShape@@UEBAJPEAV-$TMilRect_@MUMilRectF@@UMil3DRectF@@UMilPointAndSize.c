/*
 * XREFs of ?GetTightBounds@CRectanglesShape@@UEBAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x18005AD70
 * Callers:
 *     <none>
 * Callees:
 *     ??$IsAffine@$0A@@CMILMatrix@@AEBA_N_N@Z @ 0x18005AB20 (--$IsAffine@$0A@@CMILMatrix@@AEBA_N_N@Z.c)
...
LABEL_4:
    ...
    {
      return CShape::GetTightBounds(a1, a2, v3);
    }
  }
  else
  {
