/*
 * XREFs of ?GetInputBrushParameters@CBrushRenderingGraph@@IEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@IIPEAUEffectInput@@@Z @ 0x1800A7A24
 * Callers:
 ...
 *     ?DoesSurfaceHaveBorder@CRenderingTechnique@@QEBA_NI@Z @ 0x1802B96AC (-DoesSurfaceHaveBorder@CRenderingTechnique@@QEBA_NI@Z.c)
 */
  ...
  if ( !BaseSimpleInputBrush )
  {
    ...
    else
    {
      ...
      *(_QWORD *)&v52.left = &v49;
      ...
      if ( IntermediateSurfaceBrush < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v36, 0LL, 0, IntermediateSurfaceBrush, 0xF2u, 0LL);
        goto LABEL_65;
      }
      width = a3->width;
      height = a3->height;
    ...
    *(_QWORD *)&v52.right = 0LL;
    ...
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v40, 0LL, 0, IntermediateSurfaceBrush, 0xFBu, 0LL);
    if ( v50 )
      CSurfaceDrawListBrush::`vector deleting destructor'(v50, 1u);
LABEL_65:
    if ( v49 )
...
LABEL_9:
  ...
  *(_OWORD *)((char *)a6 + 24) = v63;
  ...
  if ( IntermediateSurfaceBrush < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v43, 0LL, 0, IntermediateSurfaceBrush, 0xD2u, 0LL);
    v48 = v49;
    goto LABEL_82;
  }
...
LABEL_35:
  ...
  {
    CDrawListBitmap::operator=((__int64 *)a6, (__int64 *)(v20 + 56));
    v21 = 0;
  }
  else
  {
  ...
  *((_BYTE *)a6 + 45) = v21;
    ...
    || (*(unsigned __int8 (__fastcall **)(CSurfaceDrawListBrush *, __int64))(*(_QWORD *)v8 + 8LL))(v8, 4LL) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v28, 0LL, 0, IntermediateSurfaceBrush, 0x146u, 0LL);
    if ( v50 )
      CEmptyRegionDrawListBrush::`scalar deleting destructor'(v50, 1);
LABEL_67:
    v8 = v51;
...
LABEL_23:
  ...
  MilInstrumentationCheckHR_MaybeFailFast((__int64)v33, 0LL, 0, IntermediateSurfaceBrush, 0x16Eu, 0LL);
  v48 = v54;
LABEL_82:
  if ( v48 )
