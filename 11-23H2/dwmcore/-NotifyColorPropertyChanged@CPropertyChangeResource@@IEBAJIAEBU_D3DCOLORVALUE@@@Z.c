/*
 * XREFs of ?NotifyColorPropertyChanged@CPropertyChangeResource@@IEBAJIAEBU_D3DCOLORVALUE@@@Z @ 0x18021AD30
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this) )
  {
    ...
    v16[1] = v7;
    v17 = v11;
    v12 = CoreUICallSend(v9, v16, 2LL, 14LL, 5, &unk_18033C09F, v15);
    v4 = v12;
    if ( v12 == -2018375675 )
    {
      return 0;
