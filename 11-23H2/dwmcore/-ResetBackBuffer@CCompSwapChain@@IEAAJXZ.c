/*
 * XREFs of ?ResetBackBuffer@CCompSwapChain@@IEAAJXZ @ 0x18029E844
 * Callers:
...
__int64 __fastcall CCompSwapChain::ResetBackBuffer(CCompSwapChain *this)
{
  ...
  *v1 = 0LL;
  ...
  if ( v7 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_180386F20, 2u, v9, 0x189u, 0LL);
    }
    else
    {
      v12 = *((_QWORD *)this + 13);
      *((_QWORD *)this + 13) = 0LL;
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_180386F20, 2u, v13, 0x18Bu, 0LL);
      }
      else
      {
        v15 = *v1;
        ...
        *v1 = 0LL;
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_180386F20, 2u, DeviceTextureTarget, 0x193u, 0LL);
        }
        else
        {
  ...
  {
    v11 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, &dword_180386F20, 2u, -2003304307, 0x199u, 0LL);
  }
  return v11;
}
