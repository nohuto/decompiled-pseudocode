/*
 * XREFs of ?Render@CRemoteAppRenderTarget@@UEAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1801EB180
 * Callers:
 *     ?Render@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x18011D4B0 (-Render@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 * Callees:
 ...
 *     ?CalcVailAlphaMode@CRemoteAppRenderTarget@@IEBA?AW4DXGI_ALPHA_MODE@@XZ @ 0x1801EA4CC (-CalcVailAlphaMode@CRemoteAppRenderTarget@@IEBA-AW4DXGI_ALPHA_MODE@@XZ.c)
