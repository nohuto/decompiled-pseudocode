/*
 * XREFs of ?CheckForMajorityScreenVideoNotificationsWithCompSurfInfo@CFSVPProvider@@QEAAXPEAVCCompositionSurfaceInfo@@@Z @ 0x1801E7074
 * Callers:
        ...
        struct CCompositionSurfaceInfo *a2)
{
  ...
  if ( this[2] || (v4 = PubSebRegisterRpc(WNF_SEB_FULL_SCREEN_VIDEO_PLAYBACK, this + 2), v4 >= 0) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_180356B70, 2u, v6, 0x75u, 0LL);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_180356B70, 2u, v4, 0x6Fu, 0LL);
  }
}
