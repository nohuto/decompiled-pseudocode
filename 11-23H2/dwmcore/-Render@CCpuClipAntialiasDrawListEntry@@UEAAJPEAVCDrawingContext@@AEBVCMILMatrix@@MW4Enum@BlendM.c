/*
 * XREFs of ?Render@CCpuClipAntialiasDrawListEntry@@UEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@MW4Enum@BlendMode@@@Z @ 0x1800762B0
 * Callers:
 *     <none>
 * Callees:
 *     ?CeilingSat@CFloatFPU@@SAHM@Z @ 0x18006CEB0 (-CeilingSat@CFloatFPU@@SAHM@Z.c)
 *     ?FromMilCompositingMode@BlendMode@@YA?AW4Enum@1@W42MilCompositingMode@@@Z @ 0x180072E78 (-FromMilCompositingMode@BlendMode@@YA-AW4Enum@1@W42MilCompositingMode@@@Z.c)
...
__int64 __fastcall CCpuClipAntialiasDrawListEntry::Render(_DWORD *a1, __int64 a2)
{
  ...
  *(_OWORD *)v27 = *(_OWORD *)(v8 + 52);
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, CurrentLightBufferForContextNoRef, 0x3DFu, 0LL);
