/*
 * XREFs of ?ReadyWakeupFence@CComputeScribbleScheduler@@AEAAJ_K@Z @ 0x180203768
 * Callers:
...
__int64 __fastcall CComputeScribbleScheduler::ReadyWakeupFence(CComputeScribbleScheduler *this, __int64 a2)
{
  ...
  if ( v8 >= 0 )
  {
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x100000) != 0 )
      McTemplateU0x_EventWriteTransfer(v9, (__int64)&EVTDESC_COMPUTESCRIBBLE_WAKEUPEVENTREADY);
    return 0LL;
  }
  else
  {
