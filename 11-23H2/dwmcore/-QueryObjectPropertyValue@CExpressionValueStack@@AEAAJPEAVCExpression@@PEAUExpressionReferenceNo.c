/*
 * XREFs of ?QueryObjectPropertyValue@CExpressionValueStack@@AEAAJPEAVCExpression@@PEAUExpressionReferenceNode@@_KPEAVCExpressionValue@@PEAVSubchannelMaskInfo@@@Z @ 0x18009EB94
 * Callers:
 ...
 *     ?GetReferenceInfoFromNode@CExpression@@QEAAPEAUExpressionReferenceInfo@@PEAUExpressionReferenceNode@@@Z @ 0x18009EC8C (-GetReferenceInfoFromNode@CExpression@@QEAAPEAUExpressionReferenceInfo@@PEAUExpressionReferenceN.c)
 *     ?ShouldLogPerfStats@CBaseExpression@@IEAA_NXZ @ 0x18009ECB8 (-ShouldLogPerfStats@CBaseExpression@@IEAA_NXZ.c)
 ...
 *     ?Start@QpcStopwatch@@QEAAXXZ @ 0x180216CB0 (-Start@QpcStopwatch@@QEAAXXZ.c)
    ...
    if ( a6 )
    {
      if ( *((_BYTE *)a6 + 4) )
      {
        ...
        if ( v12 < 0 )
        {
          v26 = 279;
LABEL_30:
          MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_18033C0D8, 2u, v12, v26, 0LL);
          return v14;
        }
      }
    }
    ...
    if ( (unsigned int)dword_1803E37D0 > 4
      && (unsigned __int8)tlgKeywordOn(&dword_1803E37D0, 2LL)
      && v15
  ...
  {
    v14 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_18033C0D8, 2u, -2147467259, 0xFFu, 0LL);
  }
  return v14;
}
