/*
 * XREFs of ?PushDeviceTransform@CDrawingContext@@IEAAJAEBVCMILMatrix@@PEA_N@Z @ 0x1800193D0
 * Callers:
...
__int64 __fastcall CDrawingContext::PushDeviceTransform(CDrawingContext *this, const struct CMILMatrix *a2, bool *a3)
{
  ...
  if ( CMILMatrix::Invert((CMILMatrix *)v15) )
  {
    ...
    v13 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x12FCu, 0LL);
  }
  else
  {
    v13 = -2003304441;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2003304441, 0x12EFu, 0LL);
  }
  return v13;
}
