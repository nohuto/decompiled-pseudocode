/*
 * XREFs of ?UpdatePixelFormatInfo@COffScreenRenderTarget@@IEAAJW4DXGI_FORMAT@@@Z @ 0x1801EA178
 * Callers:
 ...
 *     ?HasAlphaChannel@@YAHW4DXGI_FORMAT@@@Z @ 0x1800282EC (-HasAlphaChannel@@YAHW4DXGI_FORMAT@@@Z.c)
