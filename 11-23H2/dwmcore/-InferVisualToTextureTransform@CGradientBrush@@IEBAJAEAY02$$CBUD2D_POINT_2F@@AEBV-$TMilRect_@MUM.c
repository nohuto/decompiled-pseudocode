/*
 * XREFs of ?InferVisualToTextureTransform@CGradientBrush@@IEBAJAEAY02$$CBUD2D_POINT_2F@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1800A6A10
 * Callers:
...
__int64 __fastcall CGradientBrush::InferVisualToTextureTransform(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  float v17[4]; // [rsp+80h] [rbp+37h] BYREF
...
LABEL_5:
  ...
  CMILMatrix::InferAffineMatrix((CMILMatrix *)v16, v17, v6);
  v7 = v16[1];
  v8 = v16[4];
  v9 = v16[5];
  v10 = v16[12];
