/*
 * XREFs of ?SendMaterializeProxy@BamoDataProviderRegistrarPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800F6C90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v17, 2LL, 7LL, 2, &unk_180353715, v15);
  if ( v8 < 0 )
  ...
  LODWORD(v16) = ItemId;
  v18 = *(unsigned int *)(v3 + 40);
  v11 = CoreUICallSend(a2, &v17, 2LL, 7LL, 5, &unk_180353715, v16);
  if ( v11 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x2E09,
