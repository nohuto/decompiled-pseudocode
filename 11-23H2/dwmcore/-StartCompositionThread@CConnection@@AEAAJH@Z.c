/*
 * XREFs of ?StartCompositionThread@CConnection@@AEAAJH@Z @ 0x1800FFA6C
 * Callers:
...
__int64 __fastcall CConnection::StartCompositionThread(HANDLE *this, int nPriority)
{
  ...
  {
    v7 = this + 5;
    v8 = CreateThread(0LL, 0LL, (LPTHREAD_START_ROUTINE)CConnection::CompositionThreadEntryPoint, this, 4u, &ThreadId);
    wil::details::unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>::reset(
      this + 5,
      v8);
