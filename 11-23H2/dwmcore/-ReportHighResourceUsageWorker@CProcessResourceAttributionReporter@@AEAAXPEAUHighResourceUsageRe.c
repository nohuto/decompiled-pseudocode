/*
 * XREFs of ?ReportHighResourceUsageWorker@CProcessResourceAttributionReporter@@AEAAXPEAUHighResourceUsageReport@1@@Z @ 0x1800D79AC
 * Callers:
  ...
  if ( v3 != v45 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v5 != *((_QWORD **)this + 5) )
      {
        ...
        {
          v48 = 1;
          if ( v10 > v13[2] || v11 > v13[3] || v12 > v13[4] || (int)v7 > v13[5] || v8 > v13[6] || v9 > v13[7] )
          {
            ...
            *(_DWORD *)(*v5 + 20LL) = 200
                                    * (((int)((unsigned __int64)(1374389535LL * (int)v7) >> 32) >> 6)
                                     + 1
                                     + ((unsigned int)((unsigned __int64)(1374389535LL * (int)v7) >> 32) >> 31));
            *(_DWORD *)(*v5 + 24LL) = 500
