/*
 * XREFs of ?PresentDFlip@CLegacyStereoSwapChain@@UEAAJIIIPEAUIUnknown@@W4DXGI_COLOR_SPACE_TYPE@@W4DXGI_HDR_METADATA_TYPE@@PEBXAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@4@Z @ 0x18029FE80
 * Callers:
 *     ?PresentDFlip@CLegacyStereoSwapChain@@$4PPPPPPPM@BLI@EAAJIIIPEAUIUnknown@@W4DXGI_COLOR_SPACE_TYPE@@W4DXGI_HDR_METADATA_TYPE@@PEBXAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@4@Z @ 0x180120870 (-PresentDFlip@CLegacyStereoSwapChain@@$4PPPPPPPM@BLI@EAAJIIIPEAUIUnknown@@W4DXGI_COLOR_SPACE_TYP.c)
 * Callees:
...
__int64 __fastcall CLegacyStereoSwapChain::PresentDFlip(CD3DDevice **this)
{
  ...
  else
  {
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10) != 0 )
      McTemplateU0x_EventWriteTransfer(v3, (__int64)&EVTDESC_ETWGUID_DIRECTFLIP_PRESENTEVENT);
