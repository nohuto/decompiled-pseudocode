/*
 * XREFs of ?GenerateDrawListForOverlayColor@CDrawingContext@@QEAAJAEBU_D3DCOLORVALUE@@AEBUD2D_RECT_F@@PEBUD2D_MATRIX_3X2_F@@PEAVCDrawListEntryBuilder@@@Z @ 0x1801D55B0
 * Callers:
        ...
        struct CDrawListEntryBuilder *a5)
{
  ...
  *(_OWORD *)&v30[1] = 0LL;
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v11, 0LL, 0, v12, 0x19D9u, 0LL);
    if ( v25 )
  ...
  else
  {
    ...
    *((_OWORD *)v13 + 2) = v14;
    ...
    CBrushDrawListGenerator::AttachInput((__int64)v34, 0, &v26);
    if ( v26 )
    ...
    if ( DrawList < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, DrawList, 0x19E5u, 0LL);
    }
    else if ( a2->a != 0.0 )
    {
      v21 = *(_OWORD *)&a2->r;
      ...
      v12 = v22;
      if ( v22 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x19EEu, 0LL);
    }
  }
