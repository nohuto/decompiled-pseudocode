/*
 * XREFs of ??_ECDxHandleBitmapRealization@@MEAAPEAXI@Z @ 0x1800A24A0
 * Callers:
 *     ??_ECDxHandleBitmapRealization@@OBEA@EAAPEAXI@Z @ 0x180121E30 (--_ECDxHandleBitmapRealization@@OBEA@EAAPEAXI@Z.c)
 * Callees:
