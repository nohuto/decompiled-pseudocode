/*
 * XREFs of ?QueryInterface@BamoDataProviderRegistrarStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801E0F20
 * Callers:
 *     ?QueryInterface@BamoDataProviderRegistrarStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011D1B0 (-QueryInterface@BamoDataProviderRegistrarStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
