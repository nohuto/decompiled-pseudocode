/*
 * XREFs of ?DecideBufferToDispatch@CComputeScribbleScheduler@@AEAAJPEAPEAVCComputeScribbleFramebuffer@@0@Z @ 0x180202C2C
 * Callers:
        ...
        struct CComputeScribbleFramebuffer **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 >= 0 )
  {
    ...
    v10 = (PerformanceCount.QuadPart - v28) / (qword_1803E5B70 / 0xF4240uLL);
