/*
 * XREFs of ?NotifyVector3PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DVector3@@@Z @ 0x180081D28
 * Callers:
    ...
    if ( *(_DWORD *)(v3 + 76) )
    {
      if ( *((_DWORD *)this + 16) )
      {
        ...
        if ( _bittest(&v6, a2) )
        {
          ...
          v10 = CoreUICallSend(v9, v15, 2LL, 14LL, 3, &unk_18033C093, a2, &v13);
          v4 = v10;
          if ( v10 == -2018375675 )
          {
            return 0;
