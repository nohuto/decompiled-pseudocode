/*
 * XREFs of ?Render@CDDARenderTarget@@UEAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1801F9398
 * Callers:
 *     ?Render@CDDARenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x18011D710 (-Render@CDDARenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 * Callees:
 ...
 *     ?HideDDAVisuals@CComposition@@QEBAXXZ @ 0x18012DAC0 (-HideDDAVisuals@CComposition@@QEBAXXZ.c)
 *     ?RestoreDDAVisuals@CComposition@@QEBAXXZ @ 0x18012DAFC (-RestoreDDAVisuals@CComposition@@QEBAXXZ.c)
  ...
  if ( *((_QWORD *)this - 247) && *(int *)(*((_QWORD *)this - 265) + 1104LL) <= 3 )
  {
    ...
    if ( !CDirtyRegion::IsEmpty(v10) )
    {
      ...
      *(_BYTE *)(*((_QWORD *)this - 265) + 1274LL) = 1;
      ...
      v14 = *((_QWORD *)this - 255);
      v15 = *(__int64 (__fastcall **)(__int64, _QWORD *, char *))(*(_QWORD *)v14 + 200LL);
      DirtyRects = CDirtyRegion::GetDirtyRects((__int64)v10, v33);
      ...
      if ( *((_DWORD *)v10 + 705) )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)&v34) )
          {
            ...
            v35 = v34;
            v21 = CDrawingContext::DrawVisualTree(a2, v20, (__int64)&v35, v18, v30, 0, 0LL);
            v4 = v21;
            if ( v21 < 0 )
            {
