/*
 * XREFs of ?NotifyDirty@CGdiSpriteBitmap@@QEAAX_K@Z @ 0x18010E5DC
 * Callers:
...
void __fastcall CGdiSpriteBitmap::NotifyDirty(CGdiSpriteBitmap *this, __int64 a2)
{
  ...
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(2291662851LL, &dword_180358AE8, 4u, LastError, 0xBEu, 0LL);
  }
}
