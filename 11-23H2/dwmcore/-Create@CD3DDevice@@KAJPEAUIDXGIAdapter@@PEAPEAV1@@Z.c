/*
 * XREFs of ?Create@CD3DDevice@@KAJPEAUIDXGIAdapter@@PEAPEAV1@@Z @ 0x180101484
 * Callers:
...
__int64 __fastcall CD3DDevice::Create(struct IDXGIAdapter *a1, struct CD3DDevice **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 < 0 )
  {
    v12 = 339;
LABEL_13:
    MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802EE308, 2u, v5, v12, 0LL);
    goto LABEL_14;
  }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802EE308, 2u, -2147024882, 0x158u, 0LL);
LABEL_14:
  v9 = -2003304307;
LABEL_7:
  if ( v2 )
