/*
 * XREFs of ?RenderContent@CWindowNode@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x180051460
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetMonitorTargetId@CDrawingContext@@QEBA_NPEAUtagCOMPOSITION_TARGET_ID@@@Z @ 0x1802561EC (-GetMonitorTargetId@CDrawingContext@@QEBA_NPEAUtagCOMPOSITION_TARGET_ID@@@Z.c)
...
LABEL_6:
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0
    ...
    && !TMilRect<unsigned int,MilRectU,Mil3DRectU,RectUniqueness::NotNeeded>::IsEmpty((_DWORD *)(v17 + 336)) )
  {
    v32 = *v31;
    *((_DWORD *)v31 + 3) = 0;
    *((_DWORD *)v31 + 2) = 0;
