/*
 * XREFs of ?TransitionToCustomAnimation@CInteractionTracker@@AEAA_NPEAVCBaseExpression@@W4CustomAnimationTarget@@@Z @ 0x180235570
 * Callers:
...
char __fastcall CInteractionTracker::TransitionToCustomAnimation(CInteractionTracker *a1, struct CResource *a2, int a3)
{
  ...
  v17 = 0LL;
  v10 = CWeakResourceReference::Get(a2, (void (__fastcall ****)(LPVOID))&v17);
  v12 = v10;
  if ( v10 < 0 )
  {
