/*
 * XREFs of ?_Reallocate_exactly@?$vector@U_D3D11_PARAMETER_DESC@@V?$allocator@U_D3D11_PARAMETER_DESC@@@std@@@std@@AEAAX_K@Z @ 0x1800BC93C
 * Callers:
 ...
 *     ??$_Get_size_of_n@$0DI@@std@@YA_K_K@Z @ 0x1800B1794 (--$_Get_size_of_n@$0DI@@std@@YA_K_K@Z.c)
