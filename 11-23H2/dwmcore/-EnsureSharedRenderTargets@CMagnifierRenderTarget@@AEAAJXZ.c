/*
 * XREFs of ?EnsureSharedRenderTargets@CMagnifierRenderTarget@@AEAAJXZ @ 0x1801EFBF0
 * Callers:
...
LABEL_12:
          v14 = v2;
          MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_180386F20, 2u, v3, 0x16Fu, 0LL);
          goto LABEL_14;
        }
      }
      else
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_180386F20, 2u, v6, 0x16Cu, 0LL);
    v3 = v2;
  }
LABEL_14:
