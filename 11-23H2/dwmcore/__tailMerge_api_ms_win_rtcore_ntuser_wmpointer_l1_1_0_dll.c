/*
 * XREFs of __tailMerge_api_ms_win_rtcore_ntuser_wmpointer_l1_1_0_dll @ 0x180110A2B
 * Callers:
 *     __imp_load_GetPointerDeviceRects @ 0x180110A1F (__imp_load_GetPointerDeviceRects.c)
 * Callees:
