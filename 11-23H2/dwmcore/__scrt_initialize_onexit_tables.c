/*
 * XREFs of __scrt_initialize_onexit_tables @ 0x18010F1D8
 * Callers:
 *     __scrt_dllmain_before_initialize_c @ 0x18010F05C (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_thread_safe_statics @ 0x18010F7C0 (__scrt_initialize_thread_safe_statics.c)
 * Callees:
 *     __scrt_is_ucrt_dll_in_use @ 0x18010FC30 (__scrt_is_ucrt_dll_in_use.c)
 *     __scrt_fastfail @ 0x18010FC54 (__scrt_fastfail.c)
 *     _initialize_onexit_table_0 @ 0x18010FF8A (_initialize_onexit_table_0.c)
 */
