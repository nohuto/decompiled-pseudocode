/*
 * XREFs of ?GenerateDrawList@CShapeTree@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18026B550
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InferAffineMatrix@MILMatrix3x2@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x1800C2E64 (-InferAffineMatrix@MILMatrix3x2@@QEAAXAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF.c)
        ...
        struct CDrawListCache *a4)
{
  ...
  float v67[6]; // [rsp+D0h] [rbp-30h] BYREF
  ...
  if ( *((_BYTE *)this + 97) )
  {
    ...
    if ( v15 > v9 && v18 > v14 )
    {
      ...
      CMILMatrix::Get2DScaleDimensionsWithPerspective((CMILMatrix *)&v62, (float *)v57, (float *)v57 + 1, (__int64)&v68);
      v20 = *((_QWORD *)a2 + 4);
      v75 = 0.0;
      v21 = 0.0;
      v22 = 0.0;
      ...
      if ( fmaxf(v24 - 0.0, v25 - 0.0) > fmaxf((float)v61[0], (float)v61[1]) )
      {
        v19 = 1;
        *(_OWORD *)v67 = 0LL;
        CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)&v62, (struct MilRectF *)&v68, v67);
        v69 = 0LL;
        ...
        v31 = v67[1];
        if ( *((float *)&v69 + 1) > v67[1] )
        {
          v67[1] = *((float *)&v69 + 1);
          v31 = *((float *)&v69 + 1);
        }
        v32 = v67[2];
        if ( v67[2] > *((float *)&v69 + 2) )
        {
          v67[2] = *((float *)&v69 + 2);
          v32 = *((float *)&v69 + 2);
        }
        v33 = v67[3];
        if ( v67[3] > *((float *)&v69 + 3) )
        {
          v67[3] = *((float *)&v69 + 3);
          v33 = *((float *)&v69 + 3);
        }
      ...
      if ( v34 >= 1.0 )
      {
        ...
        if ( v35 >= 1.0 )
        {
          ...
          *(_QWORD *)v67 = __PAIR64__(LODWORD(v35), LODWORD(v34));
          ...
          v36 = CDrawingContext::PushOffScreenRenderingLayer(a2, (__int64)&v69, v67, DisplayId::None, v56, (__int64)v57);
          v8 = v36;
          if ( v36 < 0 )
          {
            ...
            if ( v41 >= 0 )
            {
              ...
              else
              {
                ...
                *((_QWORD *)&v69 + 1) = __PAIR64__(LODWORD(v25), LODWORD(v24));
                ...
                wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::~com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>((__int64)&v67[2]);
                ...
                else
                {
                  ...
                  *(_QWORD *)v67 = v60;
                  v60 = 0LL;
                  CBrushDrawListGenerator::AttachInput((__int64)v78, 0, v67);
                  if ( *(_QWORD *)v67 )
