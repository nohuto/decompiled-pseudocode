/*
 * XREFs of ?Create@CWICBitmapRealization@@SAJPEAUIWICBitmapSource@@PEAPEAVIBitmapRealization@@@Z @ 0x1800260CC
 * Callers:
 ...
 * Callees:
 *     ??0CWICBitmapRealization@@QEAA@XZ @ 0x1800261BC (--0CWICBitmapRealization@@QEAA@XZ.c)
