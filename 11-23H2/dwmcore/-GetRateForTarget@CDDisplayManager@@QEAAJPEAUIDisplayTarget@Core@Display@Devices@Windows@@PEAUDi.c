/*
 * XREFs of ?GetRateForTarget@CDDisplayManager@@QEAAJPEAUIDisplayTarget@Core@Display@Devices@Windows@@PEAUDisplayPresentationRate@3456@@Z @ 0x1802958A8
 * Callers:
        ...
        struct Windows::Devices::Display::Core::DisplayPresentationRate *a3)
{
  ...
  v24 = 0LL;
  v23 = 0LL;
  v5 = (*(__int64 (__fastcall **)(_QWORD, struct Windows::Devices::Display::Core::IDisplayTarget *, CDDisplayManager **))(*g_DDisplayManager + 64LL))(
         g_DDisplayManager,
         a2,
         &v26);
  v7 = v5;
  ...
  {
    v8 = (*(__int64 (__fastcall **)(_QWORD, __int64 *))(*g_DDisplayManager + 80LL))(g_DDisplayManager, &v24);
    v7 = v8;
    if ( v8 < 0 )
    {
