/*
 * XREFs of ?PushExact@CD2DClipStack@@QEAAJAEBUMilRectF@@W4D2D1_ANTIALIAS_MODE@@@Z @ 0x180021C08
 * Callers:
 ...
 * Callees:
 *     ?PushExact@CBaseClipStack@@IEAAJAEBUMilRectF@@@Z @ 0x180021C70 (-PushExact@CBaseClipStack@@IEAAJAEBUMilRectF@@@Z.c)
