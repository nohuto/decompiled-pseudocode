/*
 * XREFs of ?Thunk_DisposeProxy_37@?$IBamoPeer_DiagnosticCallbacks_AutoBamos_Receive@VBamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801BB440
 * Callers:
 *     <none>
 * Callees:
 *     <none>
