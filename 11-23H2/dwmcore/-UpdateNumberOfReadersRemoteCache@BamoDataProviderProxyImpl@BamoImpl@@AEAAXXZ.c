/*
 * XREFs of ?UpdateNumberOfReadersRemoteCache@BamoDataProviderProxyImpl@BamoImpl@@AEAAXXZ @ 0x1801E4DB4
 * Callers:
 *     ?SetNumberOfReaders@BamoDataProviderProxy@@UEAAXI@Z @ 0x1801E4D60 (-SetNumberOfReaders@BamoDataProviderProxy@@UEAAXI@Z.c)
 *     ?PushStateToPrincipal@BamoDataProviderProxyImpl@BamoImpl@@UEAAXXZ @ 0x1801F78C0 (-PushStateToPrincipal@BamoDataProviderProxyImpl@BamoImpl@@UEAAXXZ.c)
 * Callees:
        ...
        Microsoft::BamoImpl::BaseBamoPeerImpl **this)
{
  ...
  if ( !Microsoft::BamoImpl::BamoProxyImpl::IsDisconnected((Microsoft::BamoImpl::BamoProxyImpl *)this) )
  {
    ...
    v12[0] = v7;
    v12[1] = v6;
    v9 = CoreUICallSend(v8, v12, 2LL, 0LL, 6, &unk_180353715, v11);
