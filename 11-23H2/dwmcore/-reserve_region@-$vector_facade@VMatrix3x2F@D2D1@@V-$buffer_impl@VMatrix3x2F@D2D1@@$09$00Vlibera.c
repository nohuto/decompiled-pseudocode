/*
 * XREFs of ?reserve_region@?$vector_facade@VMatrix3x2F@D2D1@@V?$buffer_impl@VMatrix3x2F@D2D1@@$09$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAVMatrix3x2F@D2D1@@_K0@Z @ 0x18003AF84
 * Callers:
 *     ?Clear@CMatrixStack2D@@QEAAXXZ @ 0x18003AF0C (-Clear@CMatrixStack2D@@QEAAXXZ.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  if ( !(0xAAAAAAAAAAAAAAABuLL * ((v4 - v2) >> 3)) )
  {
    ...
    v26 = v14;
    v27 = 0LL;
    ((void (__fastcall *)(_BYTE *, char *, __int64, void **))std::uninitialized_move<std::move_iterator<D2D1::Matrix3x2F *>,stdext::checked_array_iterator<D2D1::Matrix3x2F *>>)(
      v28,
      v19,
      v18,
      &v25);
