/*
 * XREFs of ?CreateTokenThread@CSurfaceManager@@IEAAJP6AKPEAX@ZPEBG@Z @ 0x1800FFBA8
 * Callers:
...
LABEL_9:
  ...
  Thread = CreateThread(0LL, 0LL, (LPTHREAD_START_ROUTINE)CGlobalSurfaceManager::s_TokenThreadMain, v3, 4u, 0LL);
  wil::details::unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>::reset(
    (char *)v3 + 120,
    Thread);
