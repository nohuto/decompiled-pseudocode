/*
 * XREFs of ?AddDirtyRegion@CGDISubSectionBitmapRealization@@EEAAXAEBVCRegion@@@Z @ 0x1802B062C
 * Callers:
 *     ?AddDirtyRegion@CGDISubSectionBitmapRealization@@$0PPPPPPPM@A@EAAXAEBVCRegion@@@Z @ 0x180121CD0 (-AddDirtyRegion@CGDISubSectionBitmapRealization@@$0PPPPPPPM@A@EAAXAEBVCRegion@@@Z.c)
 * Callees:
 ...
 *     ?Offset@CRgnData@Internal@FastRegion@@QEAA_NHH@Z @ 0x1801B205C (-Offset@CRgnData@Internal@FastRegion@@QEAA_NHH@Z.c)
