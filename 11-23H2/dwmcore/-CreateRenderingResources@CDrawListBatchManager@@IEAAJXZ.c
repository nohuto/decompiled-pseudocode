/*
 * XREFs of ?CreateRenderingResources@CDrawListBatchManager@@IEAAJXZ @ 0x1801026F8
 * Callers:
 ...
 *     ??0CBatchOptimizer@@QEAA@PEAVCDrawListBatchManager@@@Z @ 0x1800DD220 (--0CBatchOptimizer@@QEAA@PEAVCDrawListBatchManager@@@Z.c)
...
__int64 __fastcall CDrawListBatchManager::CreateRenderingResources(CDrawListBatchManager *this)
{
  ...
  v7 = (volatile signed __int32 *)*((_QWORD *)this + 15);
  *((_QWORD *)this + 15) = 0LL;
  if ( v7 )
  ...
  if ( v13 < 0 )
  {
    ...
    CMILRefCountBaseT<IMILRefCount>::InternalRelease((volatile signed __int32 *)v12);
    v20 = v6;
LABEL_23:
