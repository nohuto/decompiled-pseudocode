/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@UIAccelerator@@@@IEAAKXZ @ 0x180232BF0
 * Callers:
 *     ?Release@?$CMILRefCountBaseT@UIAccelerator@@@@UEAAKXZ @ 0x180233BC0 (-Release@-$CMILRefCountBaseT@UIAccelerator@@@@UEAAKXZ.c)
 * Callees:
