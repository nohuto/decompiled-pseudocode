/*
 * XREFs of ?OpenSharedSurfaceRenderTarget@CMagnifierRenderTarget@@AEAAJPEAXU_LUID@@PEAUHMONITOR__@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x1801EFE18
 * Callers:
        ...
        struct IRenderTargetBitmap **a5)
{
  ...
  *a5 = 0LL;
  if ( a4 )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180386F20, 2u, v10, 0x1D7u, 0LL);
      return v12;
    }
  }
  else
  ...
  if ( Device < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_180386F20, 2u, Device, 0x1DFu, 0LL);
  }
  else
  {
    ...
    if ( RenderTargetBitmap < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_180386F20, 2u, RenderTargetBitmap, 0x1E7u, 0LL);
  }
  if ( v16 )
