/*
 * XREFs of ?GetScaledLetterboxingMargins@CDxHandleYUVBitmapRealization@@UEBA_NPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180135C2C
 * Callers:
 *     ?GetScaledLetterboxingMargins@CDxHandleYUVBitmapRealization@@$4PPPPPPPM@A@EBA_NPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180122E10 (-GetScaledLetterboxingMargins@CDxHandleYUVBitmapRealization@@$4PPPPPPPM@A@EBA_NPEAV-$TMilRect_@M.c)
 ...
 *     ?IsCloseRealZero@@YA_NMM@Z @ 0x1801B4748 (-IsCloseRealZero@@YA_NMM@Z.c)
 */
