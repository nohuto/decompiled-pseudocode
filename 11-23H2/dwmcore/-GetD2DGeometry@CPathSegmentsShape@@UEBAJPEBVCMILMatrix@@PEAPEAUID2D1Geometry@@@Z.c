/*
 * XREFs of ?GetD2DGeometry@CPathSegmentsShape@@UEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x180036020
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v11, 0LL, 0, v7, 0x1Au, 0LL);
  }
  else
  {
