/*
 * XREFs of ?DrawDirtyRegionVisualizationForCurrentNode@CDrawingContext@@AEAAJXZ @ 0x1801D3610
 * Callers:
 ...
 *     ?CurrentRedrawRegionColor@CComposition@@QEAA?AU_D3DCOLORVALUE@@XZ @ 0x1801B45E8 (-CurrentRedrawRegionColor@CComposition@@QEAA-AU_D3DCOLORVALUE@@XZ.c)
 ...
 *     ??0?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@QEAA@AEBV01@@Z @ 0x1801D2970 (--0-$vector@UMilRectF@@V-$allocator@UMilRectF@@@std@@@std@@QEAA@AEBV01@@Z.c)
...
__int64 __fastcall CDrawingContext::DrawDirtyRegionVisualizationForCurrentNode(CDrawingContext *this)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)this + 1007) + 184LL))(*((_QWORD *)this + 1007)) )
  {
    ...
    *((float *)&X + 3) = v15;
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x191Fu, 0LL);
    ...
    else
    {
          ...
          if ( DirtyRegionVisualizationData[4] )
          {
            ...
            while ( 1 )
            {
              ...
              if ( _mm_shuffle_ps(v39, v39, 255).m128_f32[0] > 0.0 )
              {
                ...
                if ( v31 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0, v31, 0x1953u, 0LL);
      ...
      else
      {
        ...
        *((_QWORD *)&v44 + 1) = v21;
        ...
        v2 = v23;
        if ( v23 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x192Au, 0LL);
      }
      DynArrayImpl<0>::~DynArrayImpl<0>((__int64)&v34[1]);
