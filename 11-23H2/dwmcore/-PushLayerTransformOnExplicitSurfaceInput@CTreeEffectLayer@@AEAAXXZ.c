/*
 * XREFs of ?PushLayerTransformOnExplicitSurfaceInput@CTreeEffectLayer@@AEAAXXZ @ 0x1801F3C94
 * Callers:
 ...
 *     ?GetTransformToLayerSpace@CTreeEffectLayer@@AEBA?AVMatrix3x2F@D2D1@@XZ @ 0x1801F3A78 (-GetTransformToLayerSpace@CTreeEffectLayer@@AEBA-AVMatrix3x2F@D2D1@@XZ.c)
 */
          ...
          if ( v10 )
          {
            if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64, __int64, wil::details::in1diag3 *))(*(_QWORD *)v10 + 56LL))(
                   *(_QWORD *)(v7 + v9),
                   ...
                   retaddr) )
            {
              CTreeEffectLayer::GetTransformToLayerSpace((__int64)this, (D2D1::Matrix3x2F *)&v12);
              v11 = v13;
              *(_OWORD *)(v10 + 128) = v12;
              *(_QWORD *)(v10 + 144) = v11;
            }
