/*
 * XREFs of ?PushRenderOptionsInternal@CDrawingContext@@IEAAJPEBVCVisual@@PEBUMilRenderOptions@@_N@Z @ 0x18008EBF0
 * Callers:
        ...
        char a4)
{
  ...
  *((_QWORD *)&v34 + 1) = a2;
  v33 = 0LL;
  if ( *((_DWORD *)this + 92) == (_DWORD)v7 )
  {
    v25 = 2 * v7;
    if ( (unsigned __int64)(2 * v7) > 0xFFFFFFFF )
    {
      v9 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, -2147024362, 0x64u, 0LL);
      goto LABEL_6;
    }
    if ( v25 <= 0x40 )
      v25 = 64;
    ...
    v29 = v33;
    v9 = 0;
    memcpy_0(v33, *((const void **)v6 + 48), (unsigned int)v28);
    operator delete(*((void **)v6 + 48));
    *((_QWORD *)v6 + 48) = v29;
    v8 = 0LL;
    *((_DWORD *)v6 + 93) = v25;
  }
  *(_OWORD *)(*((_QWORD *)v6 + 48) + 16LL * *((unsigned int *)v6 + 92)) = v34;
  v10 = *((_DWORD *)v6 + 98);
  LODWORD(this) = ++*((_DWORD *)v6 + 92);
...
LABEL_6:
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, v9, 0x11F6u, 0LL);
...
LABEL_9:
  ...
  v9 = 0;
  *(_QWORD *)&v34 = *(_QWORD *)((char *)v6 + 332);
  DWORD2(v34) = *((_DWORD *)v6 + 90);
  HIDWORD(v34) = *((_DWORD *)v6 + 85);
  v35 = *((_QWORD *)v6 + 43);
  v12 = *((unsigned int *)v6 + 217);
  v33 = 0LL;
  if ( *((_DWORD *)v6 + 216) != (_DWORD)v12 )
  {
LABEL_10:
    v13 = v35;
    v14 = v36;
    v15 = *((_QWORD *)v6 + 110) + 28LL * *((unsigned int *)v6 + 216);
    *(_OWORD *)v15 = v34;
    *(_QWORD *)(v15 + 16) = v13;
    *(_DWORD *)(v15 + 24) = v14;
    v16 = *((_DWORD *)v6 + 222);
  ...
  else
  {
    ...
    {
      v23 = 28LL * *((unsigned int *)v6 + 216);
      if ( v23 <= 0xFFFFFFFF )
      {
        v24 = v33;
        v9 = 0;
        memcpy_0(v33, *((const void **)v6 + 110), (unsigned int)v23);
        operator delete(*((void **)v6 + 110));
        *((_QWORD *)v6 + 110) = v24;
        v11 = 0LL;
        *((_DWORD *)v6 + 217) = v20;
        goto LABEL_10;
...
LABEL_13:
  ...
  {
    CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop((char *)v6 + 368, 0LL, v32);
  }
  else
  {
    if ( (*(_BYTE *)a3 & 1) != 0 )
    ...
    if ( (*(_BYTE *)a3 & 8) != 0 )
      *((_DWORD *)v6 + 84) = *((_DWORD *)a3 + 2);
    if ( (*(_BYTE *)a3 & 0x10) != 0 )
      *((_DWORD *)v6 + 85) = *((_DWORD *)a3 + 5);
    if ( (*(_BYTE *)a3 & 0x20) != 0 )
      *((_DWORD *)v6 + 86) = *((_DWORD *)a3 + 6);
    if ( (*(_BYTE *)a3 & 0x40) != 0 )
      *((_DWORD *)v6 + 87) = *((_DWORD *)a3 + 7);
    if ( (*(_BYTE *)a3 & 4) != 0 )
      *((_DWORD *)v6 + 90) = *((_DWORD *)a3 + 3);
  }
  return (unsigned int)v9;
}
