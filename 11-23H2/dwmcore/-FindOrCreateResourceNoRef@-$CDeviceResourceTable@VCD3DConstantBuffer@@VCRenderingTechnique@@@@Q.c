/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD3DConstantBuffer@@VCRenderingTechnique@@@@QEAAJPEAVCD3DDevice@@PEAPEAVCD3DConstantBuffer@@@Z @ 0x1800B70CC
 * Callers:
...
LABEL_8:
        v15 = v24;
        v25 = v6;
        v16 = (const void **)((char *)v24 + 72);
        v17 = (_BYTE *)*((_QWORD *)v24 + 10);
        if ( v17 == *((_BYTE **)v24 + 11) )
        {
