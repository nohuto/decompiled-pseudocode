/*
 * XREFs of ??1CSectionBitmapRealization@@MEAA@XZ @ 0x180024F9C
 * Callers:
...
void __fastcall CSectionBitmapRealization::~CSectionBitmapRealization(CSectionBitmapRealization *this)
{
  ...
  *(_DWORD *)((char *)this + v5 + 12) = v5 - 440;
  ...
  if ( v8 && *((_BYTE *)this + 384) )
    CloseHandle(v8);
  wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::~com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>((char *)this + 344);
  if ( *((_QWORD *)this + 36) )
