/*
 * XREFs of ?NotifyAtlasEntryInvalidated@CGradientBrush@@UEAAXXZ @ 0x18024D2E0
 * Callers:
 *     <none>
 * Callees:
 *     ?NotifyAtlasEntryInvalidated@CGradientSource@@MEAAXXZ @ 0x18024D38C (-NotifyAtlasEntryInvalidated@CGradientSource@@MEAAXXZ.c)
 */
