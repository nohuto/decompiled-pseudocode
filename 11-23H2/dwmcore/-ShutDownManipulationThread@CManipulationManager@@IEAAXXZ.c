/*
 * XREFs of ?ShutDownManipulationThread@CManipulationManager@@IEAAXXZ @ 0x1801A12EC
 * Callers:
 *     ??1CGlobalManipulationManager@@EEAA@XZ @ 0x180282EE8 (--1CGlobalManipulationManager@@EEAA@XZ.c)
 * Callees:
 *     _guard_xfg_dispatch_icall_nop @ 0x18011B6B0 (_guard_xfg_dispatch_icall_nop.c)
 *     ?ClearWaitHandles@CManipulationManager@@KAXXZ @ 0x18019DBA8 (-ClearWaitHandles@CManipulationManager@@KAXXZ.c)
 */
