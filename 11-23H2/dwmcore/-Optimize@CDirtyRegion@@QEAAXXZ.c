/*
 * XREFs of ?Optimize@CDirtyRegion@@QEAAXXZ @ 0x18006D920
 * Callers:
 ...
 *     ?AppendDirtyRegionLists@CDirtyRegion@@AEAAXII@Z @ 0x180070FC0 (-AppendDirtyRegionLists@CDirtyRegion@@AEAAXII@Z.c)
 ...
 *     ?CalcAcceleration@CDirtyRegion@@AEAAMAEBUDirtyRegionCachedData@1@0@Z @ 0x1800E3540 (-CalcAcceleration@CDirtyRegion@@AEAAMAEBUDirtyRegionCachedData@1@0@Z.c)
 *     __security_check_cookie @ 0x18010EE30 (__security_check_cookie.c)
 *     memset_0 @ 0x18010FFF8 (memset_0.c)
 *     ?SetRedrawRects@CDirtyRegion@@AEAAXXZ @ 0x1801CDDE8 (-SetRedrawRects@CDirtyRegion@@AEAAXXZ.c)
 */
      ...
      if ( (unsigned int)v8 < 8 )
      {
        ...
        while ( 1 )
        {
          if ( *v9 > *(v9 - 2) && v9[1] > *(v9 - 1) )
          {
            ...
            v83 = *v7;
            v84 = v83;
            TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v83, v12 - 8);
            if ( *v38 > v39 )
              v39 = *v38;
            v40 = v84.m128_f32[1];
            v41 = v84.m128_f32[1];
        ...
        TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v83, (char *)this + v13 + 1568);
        v16 = v83.m128_f32[0];
        v17 = v83.m128_f32[3];
        v18 = v83.m128_f32[1];
...
LABEL_41:
        TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(
          (char *)this + 16 * v6 + 1696,
          (char *)this + 16 * v84.m128_u64[0] + 1696);
        v36 = 2 * (v35 + 106);
