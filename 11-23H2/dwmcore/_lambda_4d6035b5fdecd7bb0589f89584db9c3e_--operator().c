/*
 * XREFs of _lambda_4d6035b5fdecd7bb0589f89584db9c3e_::operator() @ 0x1801EC31C
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_4d6035b5fdecd7bb0589f89584db9c3e__long_CCursorVisual___::_Do_call @ 0x1801EDEB0 (std--_Func_impl_no_alloc__lambda_4d6035b5fdecd7bb0589f89584db9c3e__long_CCursorVisual___--_Do_ca.c)
 * Callees:
...
__int64 __fastcall lambda_4d6035b5fdecd7bb0589f89584db9c3e_::operator()(__int64 a1, struct CVisual *a2)
{
  ...
  if ( !CVisualTree::_IsInTree(*(const struct CVisualTree **)(*(_QWORD *)a1 + 96LL), (__int64)a2, 0) )
  {
    if ( CVisualTree::_IsInTree(*(const struct CVisualTree **)(a1 + 16), (__int64)a2, 0) )
    {
      ...
      v7 = CDrawingContext::DrawVisualTree(*(CDrawingContext **)(a1 + 8), v6, (__int64)Bounds, 0LL, 0, 0, a2);
      v4 = v7;
      if ( v7 < 0 )
