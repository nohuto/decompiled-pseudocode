/*
 * XREFs of ??4SubTreeContext@CPreComputeContext@@QEAAAEAV01@$$QEAV01@@Z @ 0x1801B5D48
 * Callers:
 ...
 *     ??$move_backward@V?$move_iterator@PEAVSubTreeContext@CPreComputeContext@@@std@@V?$checked_array_iterator@PEAVSubTreeContext@CPreComputeContext@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAVSubTreeContext@CPreComputeContext@@@stdext@@V?$move_iterator@PEAVSubTreeContext@CPreComputeContext@@@0@0V12@@Z @ 0x1801B5778 (--$move_backward@V-$move_iterator@PEAVSubTreeContext@CPreComputeContext@@@std@@V-$checked_array_.c)
 *     ??0SubTreeContext@CPreComputeContext@@QEAA@$$QEAV01@@Z @ 0x1801B5980 (--0SubTreeContext@CPreComputeContext@@QEAA@$$QEAV01@@Z.c)
 * Callees:
 *     ??4CBspPreComputeHelper@@QEAAAEAV0@$$QEAV0@@Z @ 0x1801B5A3C (--4CBspPreComputeHelper@@QEAAAEAV0@$$QEAV0@@Z.c)
 */
