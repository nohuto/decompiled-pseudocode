/*
 * XREFs of ?TimeSeek@CKeyframeAnimation@@AEAAJM@Z @ 0x1800E6374
 * Callers:
 ...
 *     ?GetAnimationTimeLength@CKeyframeAnimation@@QEBAMXZ @ 0x1800E6480 (-GetAnimationTimeLength@CKeyframeAnimation@@QEBAMXZ.c)
 */
...
__int64 __fastcall CKeyframeAnimation::TimeSeek(CKeyframeAnimation *this, float a2)
{
  ...
  {
    v13 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024809, 0x9FCu, 0LL);
  }
  else
  {
    v3 = *((_BYTE *)this + 581);
