/*
 * XREFs of ?TargetFrameInput@CManipulationManager@@IEAAXPEAVCManipulationFrame@@@Z @ 0x1801A14BC
 * Callers:
 ...
 *     ?TargetBufferedFrames@CManipulationManager@@IEAAXIPEAXK@Z @ 0x1801A13E4 (-TargetBufferedFrames@CManipulationManager@@IEAAXIPEAXK@Z.c)
