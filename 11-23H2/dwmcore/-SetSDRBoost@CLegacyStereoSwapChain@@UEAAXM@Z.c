/*
 * XREFs of ?SetSDRBoost@CLegacyStereoSwapChain@@UEAAXM@Z @ 0x1802A01C4
 * Callers:
 *     ?SetSDRBoost@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EAAXM@Z @ 0x1801209D0 (-SetSDRBoost@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EAAXM@Z.c)
 * Callees:
