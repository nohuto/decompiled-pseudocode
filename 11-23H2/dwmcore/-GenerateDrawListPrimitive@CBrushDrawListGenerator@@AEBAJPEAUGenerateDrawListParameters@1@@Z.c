/*
 * XREFs of ?GenerateDrawListPrimitive@CBrushDrawListGenerator@@AEBAJPEAUGenerateDrawListParameters@1@@Z @ 0x1800593C0
 * Callers:
        ...
        struct CBrushDrawListGenerator::GenerateDrawListParameters *a2)
{
  ...
  char *v23; // rax
  int v24; // r12d
  struct CRectanglesShape *v25; // rbx
  gsl::details *v26; // rcx
  __int64 v27; // r15
  __int64 v28; // rsi
  __int64 v29; // rcx
  ...
  __m128 v44; // xmm1
  __m128 v45; // xmm1
  struct CRectanglesShape *v46; // rsi
  ...
  _BYTE *v51; // rdx
  __int64 v52; // rcx
  struct CRectanglesShape *v53; // rdx
  __int64 v54; // rcx
  char v55; // r12
  ...
  __int64 *v77; // rcx
  __int64 v78; // rdx
  struct CRectanglesShape *v79; // rcx
  struct CRectanglesShape *v80; // rax
  __int64 v81; // rcx
  int v82; // eax
  int v83; // xmm1_4
  int v84; // xmm0_4
  ...
  struct CRectanglesShape *v106; // [rsp+40h] [rbp-C0h] BYREF
  ...
  struct CShape *v119; // [rsp+110h] [rbp+10h] BYREF
...
LABEL_18:
    ...
    *((_QWORD *)&v129 + 1) = v141;
    ...
    if ( v19 < 0 )
    {
      ...
      wil::com_ptr_t<CExternalEffectGraph,wil::err_returncode_policy>::~com_ptr_t<CExternalEffectGraph,wil::err_returncode_policy>(&v104);
      return v21;
    }
...
LABEL_48:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)v118 = &v104;
    v119 = 0LL;
    v120 = 1;
    v75 = CShape::TryOptimizedCombinePaths(v106, 0LL, (CShape *)&v131, (__int64)&v121, 1, &v119);
    v48 = v75;
    if ( v75 < 0 )
    {
    ...
    {
      v96 = CShape::D2DCombine(v46, v76, &v131, &v121, 1, &v119);
      v48 = v96;
      if ( v96 < 0 )
    ...
    if ( v79 )
    {
      (**(void (__fastcall ***)(struct CRectanglesShape *, __int64))v79)(v79, 1LL);
      if ( v104 )
...
LABEL_145:
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct CRectanglesShape *))(*(_QWORD *)v25 + 16LL))(v25) )
    goto LABEL_145;
  v107 = 0LL;
  v55 = 1;
  ...
  if ( *((_DWORD *)a2 + 44) )
  {
    ...
    v25 = (struct CRectanglesShape *)v130;
    v56 = (unsigned int *)((char *)a2 + 176);
  }
  v142 = 0;
  v109 = 0LL;
  BYTE8(v109) = 6;
  v108 = 0LL;
  if ( !(*(unsigned __int8 (__fastcall **)(struct CRectanglesShape *, int *))(*(_QWORD *)v25 + 64LL))(v25, &v105)
    || v105 != 1 )
  {
    BYTE8(v109) |= 1u;
    *(_QWORD *)&v108 = v25;
    if ( v55 && !*((_QWORD *)a2 + 1) && !*((_QWORD *)a2 + 11) )
      goto LABEL_75;
    v103 = *((_DWORD *)a2 + 50);
    gsl::details::extent_type<-1>::extent_type<-1>(&v129, *v56);
  ...
  v130 = 0LL;
  v67 = (*(__int64 (__fastcall **)(struct CRectanglesShape *, __int128 *, _QWORD))(*(_QWORD *)v25 + 48LL))(
          v25,
          &v130,
          0LL);
  v21 = v67;
...
LABEL_75:
  ...
  *(_OWORD *)v125 = v129;
  ...
  (**(void (__fastcall ***)(struct CRectanglesShape *, __int64))v25)(v25, 1LL);
  return v21;
}
