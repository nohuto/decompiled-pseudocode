/*
 * XREFs of ?ProcessSetSources@CExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EXPRESSION_SETSOURCES@@PEBXI@Z @ 0x18009783C
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  struct CWeakResourceReference *v13; // r9
