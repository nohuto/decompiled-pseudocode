/*
 * XREFs of ?LockForRead@CColorKeyBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVIBitmapLock@@@Z @ 0x1802B7240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorKeyBitmap::LockForRead(CColorKeyBitmap *this, _DWORD *a2, __int64 a3)
{
  ...
  *(_QWORD *)&v36.X = 0LL;
  if ( TMilRect<unsigned int,MilRectU,Mil3DRectU,RectUniqueness::NotNeeded>::DoesContain((__int64)&v36, (__int64)a2, v6) )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x96u, 0LL);
    }
    else
    {
      v36.Width = a2[2] - *a2;
      ...
      *(_QWORD *)&v36.X = 0LL;
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x9Cu, 0LL);
      }
      else
      {
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x9Fu, 0LL);
        }
        else
        {
          ...
          if ( v18 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0xA3u, 0LL);
          }
          else
          {
            ...
            else
            {
              ...
              if ( v23 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0xAFu, 0LL);
              }
              else
              {
                v25 = v30;
                ...
                v12 = v27;
                if ( v27 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0xB5u, 0LL);
              }
            }
          }
        }
  ...
  {
    v12 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0xB9u, 0LL);
  }
  return v12;
}
