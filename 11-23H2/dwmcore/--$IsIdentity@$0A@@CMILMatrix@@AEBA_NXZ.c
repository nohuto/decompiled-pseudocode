/*
 * XREFs of ??$IsIdentity@$0A@@CMILMatrix@@AEBA_NXZ @ 0x18005AB90
 * Callers:
 ...
 *     ?GetTightBounds@CRegionShape@@UEBAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x1800C93A0 (-GetTightBounds@CRegionShape@@UEBAJPEAV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@U.c)
 ...
 * Callees:
 *     ??$ProducesUniformZ@$0A@@CMILMatrix@@AEBA_NXZ @ 0x18005AA9C (--$ProducesUniformZ@$0A@@CMILMatrix@@AEBA_NXZ.c)
 */
