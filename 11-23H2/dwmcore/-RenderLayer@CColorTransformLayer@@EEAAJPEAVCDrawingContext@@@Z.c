/*
 * XREFs of ?RenderLayer@CColorTransformLayer@@EEAAJPEAVCDrawingContext@@@Z @ 0x1801F33F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorTransformLayer::RenderLayer(CColorTransformLayer *this, struct CDrawingContext *a2)
{
  ...
  *(_QWORD *)&v37 = 0x1FF000000LL;
  v6 = CDrawingContext::PushRenderOptionsInternal(a2, 0LL, (const struct MilRenderOptions *)&v36, 1);
  v8 = v6;
  if ( v6 < 0 )
  {
    v33 = 70;
