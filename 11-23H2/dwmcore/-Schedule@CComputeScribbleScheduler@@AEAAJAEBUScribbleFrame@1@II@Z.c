/*
 * XREFs of ?Schedule@CComputeScribbleScheduler@@AEAAJAEBUScribbleFrame@1@II@Z @ 0x180203860
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( (int)v7 - LODWORD(this[20].Ptr) > 5 )
  {
    ...
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x100000) != 0 )
      McTemplateU0xqq_EventWriteTransfer(v10, (__int64)&EVTDESC_COMPUTESCRIBBLE_WORKERHANG);
  }
LABEL_8:
  if ( !this[12].Ptr )
  {
