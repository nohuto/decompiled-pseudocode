/*
 * XREFs of ?PrepareShadows@CProjectedShadowScene@@AEAAJPEAVCDrawingContext@@PEAVCProjectedShadowReceiver@@@Z @ 0x180004FF4
 * Callers:
 ...
 *     ?CalculateBlurRadius@CProjectedShadowScene@@AEBAMM@Z @ 0x1800076DC (-CalculateBlurRadius@CProjectedShadowScene@@AEBAMM@Z.c)
