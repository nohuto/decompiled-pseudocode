/*
 * XREFs of ?AddHolographicComposition@CHolographicManager@@QEAA_NPEAVCHolographicComposition@@@Z @ 0x1802A43B4
 * Callers:
 ...
 *     ?InitializeClient@CHolographicManager@@AEAAXXZ @ 0x1802A5448 (-InitializeClient@CHolographicManager@@AEAAXXZ.c)
