/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIUnknownWeakRefSource@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FA78C
 * Callers:
 ...
 *     ?QueryInterface@?$CMILCOMBaseT@VIUnknownWeakRefSource@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18028B5B0 (-QueryInterface@-$CMILCOMBaseT@VIUnknownWeakRefSource@@@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
