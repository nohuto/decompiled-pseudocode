/*
 * XREFs of ?GetNextRunningEffect@CCommonRenderingEffect@@UEAA?AV?$com_ptr_t@VCRenderingEffect@@Uerr_returncode_policy@wil@@@wil@@PEAVCRenderingEffect@@PEA_N@Z @ 0x1800C3030
 * Callers:
 *     <none>
 * Callees:
...
LABEL_29:
    ...
    *a4 = 1;
    ...
    v25 = *(_WORD *)(a1 + 67);
    v26 = a1[69];
    v27 = (__int64 *)(*(__int64 (__fastcall **)(_BYTE *, __int64))(*(_QWORD *)a1 + 16LL))(a1, 1LL);
    v28 = *((_WORD *)v22 + 32);
    v29 = v22[66];
    v30 = (__int64 *)(*(__int64 (__fastcall **)(_BYTE *, _QWORD))(*(_QWORD *)v22 + 16LL))(v22, 0LL);
    LOWORD(v33) = v25;
    BYTE2(v33) = v26;
    v34 = v28;
    v35 = v29;
