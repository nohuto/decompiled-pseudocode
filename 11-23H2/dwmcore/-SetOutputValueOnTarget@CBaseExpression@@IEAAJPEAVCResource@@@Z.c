/*
 * XREFs of ?SetOutputValueOnTarget@CBaseExpression@@IEAAJPEAVCResource@@@Z @ 0x18004D5C0
 * Callers:
...
LABEL_125:
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v59, 0LL, 0, v8, 0x2ADu, 0LL);
          goto LABEL_126;
        }
        v13 = v80;
        if ( v80 == 104 || v80 == 265 )
...
LABEL_25:
            ...
            || (*(unsigned __int8 (__fastcall **)(struct CResource *))(*(_QWORD *)a2 + 128LL))(a2) )
          {
            ...
            if ( v47 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v48, 0LL, 0, v47, 0x2B1u, 0LL);
LABEL_126:
...
LABEL_81:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x291u, 0LL);
  }
LABEL_7:
  v10 = v79;
  if ( v79 )
