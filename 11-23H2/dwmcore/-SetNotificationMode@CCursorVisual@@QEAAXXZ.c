/*
 * XREFs of ?SetNotificationMode@CCursorVisual@@QEAAXXZ @ 0x1802289E8
 * Callers:
 *     ?EndUpdateCursors@CGlobalComposition@@UEAAXXZ @ 0x1800E34F0 (-EndUpdateCursors@CGlobalComposition@@UEAAXXZ.c)
 * Callees:
