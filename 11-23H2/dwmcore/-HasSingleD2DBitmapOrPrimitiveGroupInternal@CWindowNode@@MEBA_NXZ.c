/*
 * XREFs of ?HasSingleD2DBitmapOrPrimitiveGroupInternal@CWindowNode@@MEBA_NXZ @ 0x1800BE790
 * Callers:
 *     <none>
 * Callees:
 *     ?GetCount@CPtrArrayBase@@IEBA_KXZ @ 0x180091A90 (-GetCount@CPtrArrayBase@@IEBA_KXZ.c)
 *     ?HasSpriteContent@CWindowNode@@AEBA_NXZ @ 0x1800BE7D8 (-HasSpriteContent@CWindowNode@@AEBA_NXZ.c)
