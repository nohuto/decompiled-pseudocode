/*
 * XREFs of ?Initialize@CRenderTargetBitmap@@IEAAXPEAVIDeviceTarget@@@Z @ 0x1800A2018
 * Callers:
...
void __fastcall CRenderTargetBitmap::Initialize(CRenderTargetBitmap *this, struct IDeviceTarget *a2)
{
  ...
  v2 = (char *)this + 136;
  wil::com_ptr_t<IDeviceTarget,wil::err_returncode_policy>::operator=((char *)this + 136, a2);
