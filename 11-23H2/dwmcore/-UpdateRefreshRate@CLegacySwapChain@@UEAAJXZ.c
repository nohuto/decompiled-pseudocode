/*
 * XREFs of ?UpdateRefreshRate@CLegacySwapChain@@UEAAJXZ @ 0x18029B670
 * Callers:
 *     ?UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@BLA@EAAJXZ @ 0x18011F990 (-UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@BLA@EAAJXZ.c)
 *     ?UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@BLI@EAAJXZ @ 0x180120A30 (-UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@BLI@EAAJXZ.c)
 *     ?UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@DFI@EAAJXZ @ 0x1801210F0 (-UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@DFI@EAAJXZ.c)
 * Callees:
 ...
 *     ?CalcVBlankDuration@CLegacySwapChain@@IEAA_NAEBUDXGI_RATIONAL@@_K1I@Z @ 0x1800FD7D0 (-CalcVBlankDuration@CLegacySwapChain@@IEAA_NAEBUDXGI_RATIONAL@@_K1I@Z.c)
 *     ?GetCompositorClockBoost@CComposition@@QEBA_NXZ @ 0x1800FD8B0 (-GetCompositorClockBoost@CComposition@@QEBA_NXZ.c)
 *     ?ValidateMinMaxVBlankDuration@@YAXAEBUDXGI_OUTPUT_DWM_DESC@@PEA_K1PEAI@Z @ 0x1800FD924 (-ValidateMinMaxVBlankDuration@@YAXAEBUDXGI_OUTPUT_DWM_DESC@@PEA_K1PEAI@Z.c)
