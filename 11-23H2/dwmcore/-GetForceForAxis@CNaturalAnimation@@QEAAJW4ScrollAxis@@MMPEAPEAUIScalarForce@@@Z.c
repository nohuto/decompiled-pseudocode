/*
 * XREFs of ?GetForceForAxis@CNaturalAnimation@@QEAAJW4ScrollAxis@@MMPEAPEAUIScalarForce@@@Z @ 0x18023C60C
 * Callers:
        ...
        struct CWeakResourceReference *a5)
{
  ...
  *(_BYTE *)(a1 + 588) |= 0x10u;
  ...
  else
  {
    ...
    *((_QWORD *)v9 + 3) = v14;
    *((_DWORD *)v9 + 4) = a2;
    v15 = CWeakResourceReference::Get((struct CResource *)a1, (void (__fastcall ****)(LPVOID))&a5);
    v13 = v15;
    if ( v15 < 0 )
    {
