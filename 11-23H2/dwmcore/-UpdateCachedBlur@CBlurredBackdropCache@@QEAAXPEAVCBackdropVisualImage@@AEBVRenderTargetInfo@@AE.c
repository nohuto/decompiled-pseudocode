/*
 * XREFs of ?UpdateCachedBlur@CBlurredBackdropCache@@QEAAXPEAVCBackdropVisualImage@@AEBVRenderTargetInfo@@AEBUEffectInput@@@Z @ 0x1800A710C
 * Callers:
        ...
        const struct EffectInput *a4)
{
  ...
  while ( 1 )
  {
    ...
    {
      v9 = v4;
      EffectInput::operator=((__int64)(v4 + 4), (__int64)a4);
    }
    v4 += 17;
  }
  if ( !v9 )
  {
    ...
    *(_BYTE *)(v11 + 48) = 0;
    *(_OWORD *)(v11 + 80) = 0LL;
    EffectInput::operator=((__int64)(this[1] - 13), (__int64)a4);
