/*
 * XREFs of ?Present@CRemoteAppRenderTarget@@UEAAJ_N@Z @ 0x1801EAC18
 * Callers:
 *     ?Present@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x18011D450 (-Present@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
