/*
 * XREFs of ?DestroyResources@CAtlasTexture@@AEAAXXZ @ 0x180018300
 * Callers:
 *     ??1CAtlasTexture@@QEAA@XZ @ 0x180018278 (--1CAtlasTexture@@QEAA@XZ.c)
 *     ?NotifyInvalidResource@CAtlasTexture@@UEAAXPEBVIDeviceResource@@@Z @ 0x18029C3C0 (-NotifyInvalidResource@CAtlasTexture@@UEAAXPEBVIDeviceResource@@@Z.c)
 * Callees:
