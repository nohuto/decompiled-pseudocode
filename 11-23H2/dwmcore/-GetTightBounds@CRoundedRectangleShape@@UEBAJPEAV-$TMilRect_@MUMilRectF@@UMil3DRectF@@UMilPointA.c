/*
 * XREFs of ?GetTightBounds@CRoundedRectangleShape@@UEBAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x180050630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRoundedRectangleShape::GetTightBounds(__int64 a1, struct MilRectF *a2, __int64 a3)
{
  __int64 v3; // rax
  __int64 v5; // r11
  char v7; // cl
  ...
  else
  {
    ...
    {
LABEL_23:
      TightBounds = CShape::GetTightBounds(a1, a2, v5);
      if ( TightBounds < 0 )
