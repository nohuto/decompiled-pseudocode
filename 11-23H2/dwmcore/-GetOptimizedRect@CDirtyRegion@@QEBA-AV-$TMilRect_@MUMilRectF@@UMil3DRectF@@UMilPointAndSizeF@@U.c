/*
 * XREFs of ?GetOptimizedRect@CDirtyRegion@@QEBA?AV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@IAEBV2@PEAVCRegion@@PEBVCMILMatrix@@_NAEBV?$span@PEBVCVisual@@$0?0@gsl@@PEBVCOcclusionContext@@@Z @ 0x18003F8D0
 * Callers:
 ...
 * Callees:
 *     ?SubtractionIsSingleRect@@YA_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x180017C6C (-SubtractionIsSingleRect@@YA_NAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNe.c)
 ...
 *     ?GetBVIKeyForCurrentWalk@COcclusionContext@@QEBAAEBVCBackdropVisualImageKey@@XZ @ 0x1800400E0 (-GetBVIKeyForCurrentWalk@COcclusionContext@@QEBAAEBVCBackdropVisualImageKey@@XZ.c)
 ...
 *     ?CalcSubtractionRectangles@?$TMilRect@MUMilRectF@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEBAIAEBV1@_NPEAV1@IPEAK@Z @ 0x1800AD0C0 (-CalcSubtractionRectangles@-$TMilRect@MUMilRectF@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEBA.c)
 ...
 *     ?PageInPixelsRectToDeviceRect@COcclusionContext@@AEBA_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x18012FFD4 (-PageInPixelsRectToDeviceRect@COcclusionContext@@AEBA_NAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@.c)
 *     ?DeviceRectToPageInPixelsRect@COcclusionContext@@AEBA_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x1801E6C00 (-DeviceRectToPageInPixelsRect@COcclusionContext@@AEBA_NAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@.c)
        ...
        COcclusionContext *a9)
{
  ...
  *a2 = 0LL;
  a2[1] = 0LL;
  v98 = 0LL;
  if ( a6 && (unsigned __int8)CMILMatrix::IsIdentity<0>(a6) )
  {
    v9 = 0LL;
    v91 = 0LL;
  }
  if ( a5 )
  {
    ...
    v98 = *(struct tagRECT *)PixelAlign(&v96, v64);
  }
  if ( *(_BYTE *)(v14 + 4420) )
  {
              ...
              if ( !(unsigned __int8)CArrayBasedCoverageSet::IsCovered((char *)v12 + 448, &v95, v35) )
              {
                ...
                do
                {
                  if ( *(_DWORD *)(v54 + 36 * v52 + 16) >= (signed int)v35 )
                    break;
                  if ( !(unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(v54 + 36 * v52) )
                  {
                    v70 = v69;
                    v71 = v68;
                    v72 = v49;
                ...
                if ( a5 || SubtractionIsSingleRect((float *)&v95, (float *)&v97) )
                {
                  ...
                  if ( (unsigned int)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::CalcSubtractionRectangles(
                    ...
                    v60 = &v97;
                  TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(v13, v60);
                  if ( a5 && (_DWORD)v61 )
                  {
                ...
                {
LABEL_34:
                  TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(v13, &v97);
                  if ( a5 )
...
LABEL_37:
    ...
    if ( v19 )
    {
      ...
      if ( v91 )
        ...
        v96 = *(_OWORD *)v13;
      if ( (unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(&v96) )
      {
        v13[1] = 0LL;
        *v13 = 0LL;
      }
      ...
      {
        TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::Inflate(&v96);
        if ( v85 )
        {
          v86 = *v85;
          v87 = v85[1];
