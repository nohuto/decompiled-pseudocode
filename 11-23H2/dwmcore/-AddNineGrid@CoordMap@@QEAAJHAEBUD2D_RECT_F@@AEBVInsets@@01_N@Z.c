/*
 * XREFs of ?AddNineGrid@CoordMap@@QEAAJHAEBUD2D_RECT_F@@AEBVInsets@@01_N@Z @ 0x1800A85BC
 * Callers:
 ...
 *     ?IsEmpty@Insets@@SA_NAEBV1@@Z @ 0x1800A6B48 (-IsEmpty@Insets@@SA_NAEBV1@@Z.c)
 ...
 *     ?Clamp@Insets@@SA?AV1@AEBV1@MM@Z @ 0x1800A8C30 (-Clamp@Insets@@SA-AV1@AEBV1@MM@Z.c)
