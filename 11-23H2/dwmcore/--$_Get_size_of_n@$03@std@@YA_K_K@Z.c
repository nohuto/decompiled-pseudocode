/*
 * XREFs of ??$_Get_size_of_n@$03@std@@YA_K_K@Z @ 0x1801B83B0
 * Callers:
 ...
 *     ?_Reallocate_exactly@?$vector@MV?$allocator@M@std@@@std@@AEAAX_K@Z @ 0x1801CA924 (-_Reallocate_exactly@-$vector@MV-$allocator@M@std@@@std@@AEAAX_K@Z.c)
