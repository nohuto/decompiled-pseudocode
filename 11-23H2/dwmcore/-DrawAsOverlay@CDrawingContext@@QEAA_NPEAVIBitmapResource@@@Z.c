/*
 * XREFs of ?DrawAsOverlay@CDrawingContext@@QEAA_NPEAVIBitmapResource@@@Z @ 0x1800AD9B0
 * Callers:
 ...
 * Callees:
 *     ?IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ @ 0x180018BB4 (-IsNormalDesktopRender@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?IsOverlayAssigned@COverlayContext@@QEAA_NPEBVCVisual@@U_LUID@@PEAUtagRECT@@2@Z @ 0x18012F87A (-IsOverlayAssigned@COverlayContext@@QEAA_NPEBVCVisual@@U_LUID@@PEAUtagRECT@@2@Z.c)
        ...
        else
        {
          *(struct _D3DCOLORVALUE *)&v47.r = (struct _D3DCOLORVALUE)v46;
          ...
          else
          {
            ...
            if ( v31 )
            {
              gsl::details::extent_type<-1>::extent_type<-1>(&v46, v31);
              *(_QWORD *)&v46.right = v30;
              ...
              v33 = CDrawingContext::FillRectanglesWithSolidColor(this, &v46, &stru_180386510);
              if ( v33 < 0 )
