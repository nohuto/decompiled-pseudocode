/*
 * XREFs of ?ProcessStateChanges@CCursorState@@QEAAX_K_N@Z @ 0x18027A068
 * Callers:
 *     ?BeginUpdateCursors@CGlobalComposition@@UEAAXXZ @ 0x1800E2BC0 (-BeginUpdateCursors@CGlobalComposition@@UEAAXXZ.c)
 *     ?TrySetVisual@CCursorState@@QEAA_NPEAVCCursorVisual@@_K@Z @ 0x18027B554 (-TrySetVisual@CCursorState@@QEAA_NPEAVCCursorVisual@@_K@Z.c)
 * Callees:
 ...
 *     ??0?$shared_ptr@UShapeData@CCursorState@@@std@@QEAA@AEBV01@@Z @ 0x18012EEF8 (--0-$shared_ptr@UShapeData@CCursorState@@@std@@QEAA@AEBV01@@Z.c)
