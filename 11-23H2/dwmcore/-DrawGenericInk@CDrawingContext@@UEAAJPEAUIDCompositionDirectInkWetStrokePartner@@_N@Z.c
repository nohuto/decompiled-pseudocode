/*
 * XREFs of ?DrawGenericInk@CDrawingContext@@UEAAJPEAUIDCompositionDirectInkWetStrokePartner@@_N@Z @ 0x1801D3A60
 * Callers:
 *     <none>
 * Callees:
 *     ?HasDeferredD2DLayers@CScopedClipStack@@QEBA_NXZ @ 0x180012898 (-HasDeferredD2DLayers@CScopedClipStack@@QEBA_NXZ.c)
