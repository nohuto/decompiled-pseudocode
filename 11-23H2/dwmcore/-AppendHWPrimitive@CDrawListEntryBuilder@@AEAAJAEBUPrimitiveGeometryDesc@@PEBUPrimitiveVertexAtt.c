/*
 * XREFs of ?AppendHWPrimitive@CDrawListEntryBuilder@@AEAAJAEBUPrimitiveGeometryDesc@@PEBUPrimitiveVertexAttributesDesc@@@Z @ 0x180057C00
 * Callers:
 ...
 *     ?Transform@CPolygonBuilder@@QEAAXAEBUD2D_MATRIX_3X2_F@@@Z @ 0x180014190 (-Transform@CPolygonBuilder@@QEAAXAEBUD2D_MATRIX_3X2_F@@@Z.c)
 ...
 *     ?ResolveEdgeFlags@CEdgeFlagsMap@@QEBAXV?$StridedSpan@$$CBUD2D_VECTOR_2F@@@@PEBUD2D_POINT_2F@@W4D2D1_EDGE_FLAGS@@PEAUResolveEdgeFlagsResult@1@M@Z @ 0x1800C9BD4 (-ResolveEdgeFlags@CEdgeFlagsMap@@QEBAXV-$StridedSpan@$$CBUD2D_VECTOR_2F@@@@PEBUD2D_POINT_2F@@W4D.c)
 ...
 *     ?ClipRectAndEdgeFlags@@YA?AW4D2D1_EDGE_FLAGS@@AEBUD2D_RECT_F@@W41@01PEAU2@PEAW41@@Z @ 0x1800CE044 (-ClipRectAndEdgeFlags@@YA-AW4D2D1_EDGE_FLAGS@@AEBUD2D_RECT_F@@W41@01PEAU2@PEAW41@@Z.c)
 ...
 *     ?MakeRectangleEdgeFlags@@YA?AW4D2D1_EDGE_FLAGS@@W41@000@Z @ 0x1800EF698 (-MakeRectangleEdgeFlags@@YA-AW4D2D1_EDGE_FLAGS@@W41@000@Z.c)
 ...
 *     ?_Destroy@?$_Variant_base@Umonostate@std@@VCRectangleMapStrategy@CEdgeFlagsMap@@VCPolygonMapStrategy@4@@std@@QEAAXXZ @ 0x1801FADD0 (-_Destroy@-$_Variant_base@Umonostate@std@@VCRectangleMapStrategy@CEdgeFlagsMap@@VCPolygonMapStra.c)
        ...
        struct D2D_MATRIX_3X2_F **a3)
{
  ...
  struct CShape *v203; // [rsp+198h] [rbp+90h] BYREF
  ...
  *(_OWORD *)v210 = 0LL;
  ...
  if ( v46 )
  {
    v48 = (*(unsigned int (__fastcall **)(CShape *))(*(_QWORD *)v46 + 8LL))(v46)
        ? CCpuClip::RectangleShapeFullyContains(v46, v210, v47)
        : CRoundedRectangleGeometryData::FillContainsRect(*((_QWORD *)v46 + 2) + 16LL, (struct MilRectF *)v210, v47);
    if ( v48 )
    {
      v8 = v219;
      v4 = 0;
LABEL_5:
      ...
      else
      {
        ...
        v203 = (struct CShape *)__PAIR64__(v15, v16);
        v204 = v14;
        v205 = v13;
...
LABEL_92:
  v54 = (struct CShape *)*((_QWORD *)this + 2);
  v4 = 1;
  v170 = 1;
  v171 = 0;
  v203 = v54;
  ...
  {
    v132 = CShape::Combine(*(_QWORD *)a2, v59, (__int64)v210[0], (__int64)&v187, 1, &v203);
    v24 = v132;
    if ( v132 >= 0 )
    {
      v7 = v203;
  ...
  else
  {
    ...
    if ( TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::DoesContain((float *)&v203, (float *)&v220) )
    {
      v105 = v210[0];
      v171 = 1;
...
LABEL_11:
    ...
    *((_QWORD *)&v209 + 1) = __PAIR64__(v61, v62);
    DynArray<TMilRect_<float,MilRectF,Mil3DRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,0>::AddMultipleAndSet(
      ...
      &v209,
      1LL);
    v65 = CShape::TryOptimizedCombinePaths((struct CRectanglesShape *)&v212, 0LL, v210[0], (__int64)&v187, 1, &v203);
    v176 = v65;
    v24 = v65;
    if ( v65 < 0 )
    {
...
LABEL_104:
      ...
      v103 = CShape::D2DCombine(&v212, v66, v210[0], &v187, 1, &v203);
      v176 = v103;
      v24 = v103;
      if ( v103 >= 0 )
      {
