/*
 * XREFs of ?RenderDirtyRegion@CHolographicInteropTarget@@AEAAJPEAVCHolographicInteropTexture@@PEAVCVisualTree@@PEBVCDirtyRegion@@IIPEAVIRenderTargetBitmap@@PEAVCDrawingContext@@@Z @ 0x1802A948C
 * Callers:
        ...
        struct CDrawingContext *a8)
{
  ...
  for ( i = 0; i < *((_DWORD *)a4 + 705); ++i )
  {
    v30[0] = 0LL;
    v30[1] = 0LL;
    CDirtyRegion::GetOptimizedRect((__int64)a4, &v31, i, (__int64)v34, 0LL, 0LL, 0, v30, 0LL);
    if ( !TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)&v31) )
    {
      ...
      if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
        McTemplateU0qdffff_EventWriteTransfer(v15, v17, i, v18, v31, SBYTE4(v31), v32, v33);
      ...
      v35[2] = v20;
      v35[3] = v19;
      v25 = CDrawingContext::DrawVisualTree(
              a8,
              a3,
              (__int64)v35,
              (COcclusionContext *)(v24 & -(__int64)IsCurrent),
              2,
              0,
              0LL);
      v11 = v25;
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
    McTemplateU0x_EventWriteTransfer(v15, (__int64)&EVTDESC_MILEVENT_MEDIA_UCE_RENDEREVENT_Stop);
  return v11;
}
