/*
 * XREFs of ?Thunk_AckProxyReference_37@?$IBamoPeer_DiagnosticCallbacks_AutoBamos_Receive@VBamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801BB1A0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v10 )
    {
      ...
      if ( !v13 )
        wil::details::in1diag3::_FailFast_Unexpected(
          retaddr,
          (void *)0xD5,
          (int)"g:\\os\\tools\\BamoCodegen\\Inc\\BamoStub.inl",
          v6);
      v14 = v13 - 1;
      *(_DWORD *)(v10 + 16) = v14;
