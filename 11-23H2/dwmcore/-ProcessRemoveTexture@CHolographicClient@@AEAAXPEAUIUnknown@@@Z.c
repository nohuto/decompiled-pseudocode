/*
 * XREFs of ?ProcessRemoveTexture@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x1802ADA28
 * Callers:
 ...
 *     ?Remove@?$DynArray@PEAUIHolographicInteropTexture@@$0A@@@QEAAHAEBQEAUIHolographicInteropTexture@@@Z @ 0x1802ADF20 (-Remove@-$DynArray@PEAUIHolographicInteropTexture@@$0A@@@QEAAHAEBQEAUIHolographicInteropTexture@.c)
 */
