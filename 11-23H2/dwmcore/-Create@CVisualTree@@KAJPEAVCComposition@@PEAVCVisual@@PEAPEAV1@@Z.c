/*
 * XREFs of ?Create@CVisualTree@@KAJPEAVCComposition@@PEAVCVisual@@PEAPEAV1@@Z @ 0x18009FDD4
 * Callers:
 ...
 *     ??0CVisualTree@@IEAA@PEAVCComposition@@PEAVCVisual@@@Z @ 0x18009FECC (--0CVisualTree@@IEAA@PEAVCComposition@@PEAVCVisual@@@Z.c)
