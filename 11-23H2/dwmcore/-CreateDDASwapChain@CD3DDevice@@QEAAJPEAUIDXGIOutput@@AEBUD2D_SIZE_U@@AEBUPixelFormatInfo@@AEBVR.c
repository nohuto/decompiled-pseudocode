/*
 * XREFs of ?CreateDDASwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVIDDASwapChain@@@Z @ 0x18028F7F8
 * Callers:
...
LABEL_11:
    v18 = v15;
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_180386F20, 2u, v18, v21, 0LL);
  }
