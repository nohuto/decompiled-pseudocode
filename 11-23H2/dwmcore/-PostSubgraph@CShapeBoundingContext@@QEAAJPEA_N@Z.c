/*
 * XREFs of ?PostSubgraph@CShapeBoundingContext@@QEAAJPEA_N@Z @ 0x1800967B4
 * Callers:
 ...
 * Callees:
 *     ?ConvertInnerToOuterBounds@CVectorShape@@QEAAXAEBUD2D_MATRIX_3X2_F@@@Z @ 0x180096920 (-ConvertInnerToOuterBounds@CVectorShape@@QEAAXAEBUD2D_MATRIX_3X2_F@@@Z.c)
      ...
      *(_OWORD *)&v12.m11 = *(_OWORD *)(v5 + 80);
      if ( v4 )
        *(_OWORD *)&v12.m11 = v11;
        ...
        TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v12, &v11);
      v9 = *(_OWORD *)&v12.m11;
      *(_WORD *)(v5 + 96) = 256;
      *(_OWORD *)(v5 + 80) = v9;
    }
