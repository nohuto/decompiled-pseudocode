/*
 * XREFs of ??1?$com_ptr_t@VCExternalEffectGraph@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1800B2BB8
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__CCommonRenderingEffectFactory::s_cpSolidColorEffect__ @ 0x1801240A0 (_dynamic_atexit_destructor_for__CCommonRenderingEffectFactory--s_cpSolidColorEffect__.c)
 *     ??1SharedStateLayer@@QEAA@XZ @ 0x18020A0F0 (--1SharedStateLayer@@QEAA@XZ.c)
