/*
 * XREFs of ?OnAnimationEvent@CKeyframeAnimation@@QEAAJW4AnimationEventType@@PEAVCExpressionValueStack@@@Z @ 0x18009A1DC
 * Callers:
 ...
 *     ?IsWaiting@CKeyframeAnimation@@QEBA_NXZ @ 0x18009A270 (-IsWaiting@CKeyframeAnimation@@QEBA_NXZ.c)
