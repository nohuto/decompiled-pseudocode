/*
 * XREFs of ?construct@?$manually_managed_shutdown_aware_object@VFeatureStateManager@details@wil@@@wil@@QEAAXXZ @ 0x1800F7404
 * Callers:
 ...
 * Callees:
 *     ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x1800F73C8 (--0SubscriptionList@details_abi@wil@@QEAA@XZ.c)
 */
