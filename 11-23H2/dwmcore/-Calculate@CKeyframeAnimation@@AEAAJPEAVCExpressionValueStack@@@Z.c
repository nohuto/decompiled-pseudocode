/*
 * XREFs of ?Calculate@CKeyframeAnimation@@AEAAJPEAVCExpressionValueStack@@@Z @ 0x18004FB40
 * Callers:
 ...
 *     ?GetIsComplete@Timer@@QEBA_NXZ @ 0x1800E3660 (-GetIsComplete@Timer@@QEBA_NXZ.c)
