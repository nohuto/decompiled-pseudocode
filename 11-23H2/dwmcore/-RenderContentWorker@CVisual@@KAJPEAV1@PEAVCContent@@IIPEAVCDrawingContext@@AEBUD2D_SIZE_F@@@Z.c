/*
 * XREFs of ?RenderContentWorker@CVisual@@KAJPEAV1@PEAVCContent@@IIPEAVCDrawingContext@@AEBUD2D_SIZE_F@@@Z @ 0x18021147C
 * Callers:
  ...
  if ( *((_BYTE *)a5 + 8171) )
  {
    ...
    if ( TreeData )
    {
      ...
      if ( Cache < 0 )
      {
        ...
        v14 = v9;
LABEL_7:
        MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_18033BD28, 3u, v9, 0x1030u, 0LL);
        goto LABEL_10;
      }
      v6 = v19;
    }
  ...
  v14 = v16;
  if ( v16 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_18033BD28, 3u, v16, 0x1035u, 0LL);
LABEL_10:
  if ( v6 )
