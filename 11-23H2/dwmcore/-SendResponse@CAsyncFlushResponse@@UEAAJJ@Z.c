/*
 * XREFs of ?SendResponse@CAsyncFlushResponse@@UEAAJJ@Z @ 0x1800F3300
 * Callers:
 *     ?OnPresentComplete@CAsyncFlushResponse@@UEAAJXZ @ 0x1800F32F0 (-OnPresentComplete@CAsyncFlushResponse@@UEAAJXZ.c)
 * Callees:
