/*
 * XREFs of ?CaptureCurrentManipulation@CInteractionProcessor@@QEAAXI_K@Z @ 0x1801AC15C
 * Callers:
 *     ?CaptureCurrentManipulation@CInteraction@@UEAAXI_K@Z @ 0x18020B9F0 (-CaptureCurrentManipulation@CInteraction@@UEAAXI_K@Z.c)
 * Callees:
  ...
  *((_QWORD *)this + 104) = a3;
  if ( (unsigned int)dword_1803E37D0 > 4 )
  {
    if ( tlgKeywordOn((__int64)&dword_1803E37D0, 2LL) )
    {
      ...
      v14 = 4LL;
      v12 = 8LL;
      tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_18037E65F, 0LL, 0LL, 5u, &v10);
    }
  }
}
