/*
 * XREFs of ?InitializeDefaultPlaceholderPeer@BamoConnectionImpl@dataprovider_AutoBamos@BamoImpl@@MEAAJPEAPEAVBaseBamoPeer@Bamo@Microsoft@@@Z @ 0x1801E0030
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BaseBamoPeer **a2)
{
  ...
  *((_QWORD *)v4 + 1) = &BamoImpl::dataprovider_AutoBamos::BamoPeerImpl::`vftable';
  v7 = (Microsoft::BamoImpl::BaseBamoPeerImpl *)(*(__int64 (__fastcall **)(struct Microsoft::Bamo::BaseBamoPeer *))(*(_QWORD *)v4 + 8LL))(v4);
  v10 = *((_DWORD *)this + 9);
  v8 = v7;
  *((_DWORD *)this + 9) = v10 + 1;
