/*
 * XREFs of ?PushStateToPrincipalOnPropertiesRefresh@BamoDataProviderProxyImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBaseBamoPeerImpl@2Microsoft@@@Z @ 0x1801F78D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BaseBamoPeerImpl *a3)
{
  ...
  v6 = CoreUICallSend(a2, &v12, 2LL, 7LL, 14, &unk_180353715, v10);
  if ( v6 < 0 )
  ...
  v12 = *((unsigned int *)a3 + 9);
  v13 = *((unsigned int *)a3 + 10);
  v7 = CoreUICallSend(a2, &v12, 2LL, 7LL, 13, &unk_180353715, v11);
  if ( v7 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      10938LL,
