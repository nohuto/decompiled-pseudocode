/*
 * XREFs of ?UpdateOnManipulationThreadWithoutDelta@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadWithoutDeltaArgs@@@Z @ 0x18020E8C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_UpdateCaptureState@CManipulation@@AEAAX_N@Z @ 0x18020F274 (-_UpdateCaptureState@CManipulation@@AEAAX_N@Z.c)
 */
