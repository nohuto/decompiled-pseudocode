/*
 * XREFs of ?DwmHolographicDisplayAdd_@CompositorTracing@@QEAAXIAEBU_GUID@@@Z @ 0x1802A4A38
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicDisplayAdd_(CompositorTracing *this, int a2, const struct _GUID *a3)
{
  ...
  if ( *v5 > 4u )
  {
    if ( tlgKeywordOn((__int64)v5, 0x400000000000LL) )
    {
      ...
      v13 = a3;
      v14 = 16;
      tlgWriteTransfer_EventWriteTransfer(v6, (unsigned __int8 *)dword_180382BD5, 0LL, 0LL, v7, &v9);
    }
  }
}
