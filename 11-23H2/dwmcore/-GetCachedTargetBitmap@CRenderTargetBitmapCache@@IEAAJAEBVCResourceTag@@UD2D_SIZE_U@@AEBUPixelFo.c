/*
 * XREFs of ?GetCachedTargetBitmap@CRenderTargetBitmapCache@@IEAAJAEBVCResourceTag@@UD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@W4Enum@CacheMode@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x1800AF214
 * Callers:
        ...
        unsigned __int64 *a7)
{
  ...
  *a7 = 0LL;
  ...
  else
  {
    ...
    v23 = 0LL;
    if ( v18 )
      CMILRefCountBaseT<IUnknown>::InternalRelease((volatile signed __int32 *)v18);
    v19 = CD3DDevice::CreateScratchRenderTargetBitmap(
            (CD3DDevice *)(((unsigned __int64)a1 - 464) & -(__int64)(a1 != 0LL)),
            &v22,
            (struct D3D11_SUBRESOURCE_DATA *)a4,
            v13,
            &v23);
    v8 = v19;
    if ( v19 < 0 )
