/*
 * XREFs of ??$_Resize_reallocate@U_Value_init_tag@std@@@?$vector@UDISPLAYCONFIG_MODE_INFO@@V?$allocator@UDISPLAYCONFIG_MODE_INFO@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x180201E90
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  return std::vector<DISPLAYCONFIG_MODE_INFO>::_Change_array(a1, v10, a2, v2);
}
