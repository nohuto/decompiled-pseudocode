/*
 * XREFs of ?ProcessSetSourceOffset@CVisualSurface@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALSURFACE_SETSOURCEOFFSET@@@Z @ 0x18021AA34
 * Callers:
        ...
        const struct tagMILCMD_VISUALSURFACE_SETSOURCEOFFSET *a3)
{
  ...
  v3 = ((__int64 (__fastcall *)(char *, void *, char *))xmmword_1803E4468)(
         (char *)this + SDWORD2(xmmword_1803E4468),
