/*
 * XREFs of ??_GCParticleVector4Behavior@@UEAAPEAXI@Z @ 0x1801C3290
 * Callers:
 *     ??_ECParticleVector4Behavior@@WHA@EAAPEAXI@Z @ 0x18011BA10 (--_ECParticleVector4Behavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
