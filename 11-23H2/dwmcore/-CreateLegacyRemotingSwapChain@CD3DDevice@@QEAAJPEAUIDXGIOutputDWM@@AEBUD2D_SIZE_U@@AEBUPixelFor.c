/*
 * XREFs of ?CreateLegacyRemotingSwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutputDWM@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVILegacyRemotingSwapChain@@@Z @ 0x1801098D8
 * Callers:
  ...
  if ( *((_BYTE *)this + 1509) && (*((_BYTE *)this + 924) & 4) != 0 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)&v36 = "DWM LegacyRemoting SwapChain";
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_1802EE308, 2u, v19, 0x287u, 0LL);
      ...
      else
      {
        ...
        if ( v15 >= 0 )
        {
          ...
          if ( v25 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v26, &dword_1802EE308, 2u, v25, 0x29Eu, 0LL);
            wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v32);
            v6 = v34;
            goto LABEL_6;
          }
    ...
    v24 = v15;
LABEL_22:
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802EE308, 2u, v24, v30, 0LL);
    wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>((__int64 *)&v32);
    goto LABEL_6;
  }
  wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::reset((__int64 *)&v33);
...
LABEL_31:
  v28 = v12;
LABEL_34:
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802EE308, 2u, v28, v31, 0LL);
LABEL_6:
