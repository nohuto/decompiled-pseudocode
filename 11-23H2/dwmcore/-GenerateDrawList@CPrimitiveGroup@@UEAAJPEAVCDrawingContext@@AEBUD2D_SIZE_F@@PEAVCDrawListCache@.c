/*
 * XREFs of ?GenerateDrawList@CPrimitiveGroup@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18000F210
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ClearPrimitiveContent@CPrimitiveGroup@@AEAAXXZ @ 0x18011A05C (-ClearPrimitiveContent@CPrimitiveGroup@@AEAAXXZ.c)
 */
