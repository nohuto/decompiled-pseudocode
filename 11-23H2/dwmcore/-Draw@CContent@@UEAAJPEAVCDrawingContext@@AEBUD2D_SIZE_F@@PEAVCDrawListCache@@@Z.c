/*
 * XREFs of ?Draw@CContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180072B60
 * Callers:
 ...
 *     ?Draw@CContent@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18011B7B0 (-Draw@CContent@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z.c)
 *     ?Draw@CContent@@$4PPPPPPPM@DI@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18011BFB0 (-Draw@CContent@@$4PPPPPPPM@DI@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z.c)
 *     ?Draw@CContent@@$4PPPPPPPM@JA@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18011BFD0 (-Draw@CContent@@$4PPPPPPPM@JA@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z.c)
 *     ?Draw@CContent@@$4PPPPPPPM@7EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18011DEB0 (-Draw@CContent@@$4PPPPPPPM@7EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z.c)
 ...
 *     ?HasMoreClipPlanes@ClipPlaneIterator@@QEBA_NXZ @ 0x1801D9A58 (-HasMoreClipPlanes@ClipPlaneIterator@@QEBA_NXZ.c)
        ...
        struct CDrawListCache *a4)
{
    ...
    || (*(unsigned __int8 (__fastcall **)(char *, __int64))(*(_QWORD *)v11 + 56LL))((char *)this - 96, 129LL) )
  {
    ...
    else
    {
      ...
      if ( v24 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v25, &dword_18033BD28, 3u, v24, 0x7Eu, 0LL);
        v5 = v57;
        goto LABEL_25;
      }
      v5 = v57;
...
LABEL_18:
      ...
      v20 = v54;
      if ( v54 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v55, &dword_18033BD28, 3u, v54, 0xA0u, 0LL);
      else
LABEL_19:
        v20 = 0;
LABEL_20:
...
LABEL_35:
        if ( v20 != -2003304441 && v20 < 0 )
        {
          ...
          v56 = 136;
LABEL_59:
          MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_18033BD28, 3u, v44, v56, 0LL);
          goto LABEL_21;
        }
LABEL_17:
        v8 = v58;
...
LABEL_64:
  ...
  if ( v28 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v29, &dword_18033BD28, 3u, v28, 0x42u, 0LL);
    v39 = v60;
    if ( !(_QWORD)v60 )
      goto LABEL_21;
  }
  else
  {
    for ( i = 0; ; i = v59 + 1 )
    {
      ...
      if ( v31 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v32, &dword_18033BD28, 3u, v31, 0x4Cu, 0LL);
        if ( (_QWORD)v60 )
          std::_Deallocate<16,0>(v60, 8 * ((v61 - (__int64)v60) >> 3));
        goto LABEL_20;
      }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v38, &dword_18033BD28, 3u, v37, 0x5Au, 0LL);
    v39 = v60;
    if ( !(_QWORD)v60 )
      goto LABEL_21;
  }
