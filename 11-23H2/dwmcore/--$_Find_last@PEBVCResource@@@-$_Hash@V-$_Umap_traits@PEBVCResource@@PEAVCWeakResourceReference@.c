        ...
        __int64 a4)
{
  ...
  v4 = *(_QWORD **)(qword_1803E62F8 + 16 * (a4 & xmmword_1803E6310) + 8);
  if ( v4 == (_QWORD *)qword_1803E62E8 )
  {
    *a2 = qword_1803E62E8;
  }
  else
  {
    while ( 1 )
    {
      ...
      if ( v4 == *(_QWORD **)(qword_1803E62F8 + 16 * (a4 & xmmword_1803E6310)) )
        break;
      v4 = (_QWORD *)v4[1];
    }
    *a2 = v4;
