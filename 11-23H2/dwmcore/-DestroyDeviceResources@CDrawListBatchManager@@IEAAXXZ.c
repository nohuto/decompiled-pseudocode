/*
 * XREFs of ?DestroyDeviceResources@CDrawListBatchManager@@IEAAXXZ @ 0x18010472C
 * Callers:
 ...
 *     ?DestroyDeviceResources@CSharedDirect3DResources@CDrawListEntryBatch@@QEAAXXZ @ 0x180105018 (-DestroyDeviceResources@CSharedDirect3DResources@CDrawListEntryBatch@@QEAAXXZ.c)
...
void __fastcall CDrawListBatchManager::DestroyDeviceResources(CDrawListBatchManager *this)
{
  ...
  if ( v10 )
    CMILRefCountBaseT<IMILRefCount>::InternalRelease((volatile signed __int32 *)(v10 + 8));
  ...
  *((_DWORD *)this + 18) = 0;
  if ( *((_DWORD *)this + 26) )
  {
    ...
    do
    {
      CMILRefCountBaseT<IMILRefCount>::InternalRelease((volatile signed __int32 *)(*(_QWORD *)(*((_QWORD *)this + 10)
                                                                                             + v9)
                                                                                 + 8LL));
      v9 += 8LL;
      --v8;
