/*
 * XREFs of ?Link@CShaderLinkingGraphBuilder@@QEAAJAEBUSignatureParameter@1@PEAPEAUID3D10Blob@@@Z @ 0x1800BBE9C
 * Callers:
        ...
        struct ID3D10Blob **a3)
{
  ...
  *(_DWORD *)&v27[20] = 2;
  ...
  v25[1] = &unk_1802C5C00;
  v25[0] = 1LL;
  v11 = CShaderLinkingGraphBuilder::FulfillInputs((unsigned __int64)this, (__int64)v31, v25);
  v10 = v11;
  if ( v11 < 0 )
  {
