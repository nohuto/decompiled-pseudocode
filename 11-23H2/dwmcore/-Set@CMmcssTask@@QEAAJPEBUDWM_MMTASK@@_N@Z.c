/*
 * XREFs of ?Set@CMmcssTask@@QEAAJPEBUDWM_MMTASK@@_N@Z @ 0x1801009FC
 * Callers:
 ...
 *     ?AreEqualMmTask@CMmcssTask@@CA_NPEBUDWM_MMTASK@@0@Z @ 0x180101368 (-AreEqualMmTask@CMmcssTask@@CA_NPEBUDWM_MMTASK@@0@Z.c)
...
LABEL_21:
    ...
    *(_QWORD *)&this[1].DebugInfo[2].Flags = 0LL;
    if ( !a3 )
      goto LABEL_5;
    Runtime = CMmcssTask::Apply(this, 0);
    v11 = Runtime;
    if ( Runtime >= 0 )
      goto LABEL_5;
    v14 = 204;
