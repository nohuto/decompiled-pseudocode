/*
 * XREFs of ?AddEdgeFlags@CPolygonMapStrategy@CEdgeFlagsMap@@QEAAXAEBUD2D_RECT_F@@W4D2D1_EDGE_FLAGS@@PEBVMatrix3x3@@M@Z @ 0x1801FF214
 * Callers:
  ...
  else
  {
    do
    {
      ...
      if ( v12 >= 4uLL )
      {
        ...
        JUMPOUT(0x1801FF3BELL);
      }
      result = CConvexPolygonEdgeMap<unsigned int>::TryAddEdge(
                 a1,
                 (unsigned int)&unk_1802DF210 + 32 * v12,
