/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DQuaternion@@@Z @ 0x18021AE08
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this) )
  {
    ...
    v16[1] = v7;
    v17 = v11;
    v12 = CoreUICallSend(v9, v16, 2LL, 14LL, 6, &unk_18033C0A5, v15);
    v4 = v12;
    if ( v12 == -2018375675 )
    {
      return 0;
