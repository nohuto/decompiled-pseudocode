/*
 * XREFs of ?CalculateValueWorker@CKeyframeAnimation@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x18004E940
 * Callers:
 ...
 *     ?Play@CKeyframeAnimation@@AEAAXPEAVCExpressionValueStack@@@Z @ 0x18009A0BC (-Play@CKeyframeAnimation@@AEAAXPEAVCExpressionValueStack@@@Z.c)
 ...
 *     ?SortKeyFrames@KeyframeSequence@@AEAAXXZ @ 0x18009A294 (-SortKeyFrames@KeyframeSequence@@AEAAXXZ.c)
 *     ?ConfigureTimer@KeyframeSequence@@QEAAXXZ @ 0x18009A2F8 (-ConfigureTimer@KeyframeSequence@@QEAAXXZ.c)
 ...
 *     ?SetProgress@CKeyframeAnimation@@AEAAXM@Z @ 0x1800E31C8 (-SetProgress@CKeyframeAnimation@@AEAAXM@Z.c)
 *     ?Pause@CKeyframeAnimation@@AEAAXXZ @ 0x1800E7DB0 (-Pause@CKeyframeAnimation@@AEAAXXZ.c)
