/*
 * XREFs of ??$?0$0?0$0A@@?$span@$$CBUMilPoint2D@@$0?0@gsl@@QEAA@PEBUMilPoint2D@@_K@Z @ 0x1801BD5E8
 * Callers:
...
gsl::details *__fastcall gsl::span<MilPoint2D const,-1>::span<MilPoint2D const,-1>(
        gsl::details *a1,
        __int64 a2,
        __int64 a3)
{
