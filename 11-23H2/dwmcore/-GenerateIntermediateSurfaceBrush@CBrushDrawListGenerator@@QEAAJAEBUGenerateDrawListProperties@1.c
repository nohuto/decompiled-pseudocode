/*
 * XREFs of ?GenerateIntermediateSurfaceBrush@CBrushDrawListGenerator@@QEAAJAEBUGenerateDrawListProperties@1@PEAPEAVCSurfaceDrawListBrush@@@Z @ 0x1801FC508
 * Callers:
...
LABEL_43:
      ...
      CMILMatrix::Get2DScaleDimensionsWithPerspective((CMILMatrix *)v80, (float *)&v84, (float *)&v74, (__int64)&v87);
