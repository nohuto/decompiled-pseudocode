/*
 * XREFs of ?EnsureResources@CCaptureRenderTarget@@IEAAJPEAVCD3DDevice@@@Z @ 0x1801ECAD4
 * Callers:
 ...
 *     ?IsValidPixelFormat@@YAHW4DXGI_FORMAT@@@Z @ 0x180027C64 (-IsValidPixelFormat@@YAHW4DXGI_FORMAT@@@Z.c)
...
__int64 __fastcall CCaptureRenderTarget::EnsureResources(CCaptureRenderTarget *this, struct D3D11_SUBRESOURCE_DATA *a2)
{
  ...
  DXGI_FORMAT v33[4]; // [rsp+78h] [rbp-31h]
