/*
 * XREFs of ?LinkCompositingShader@@YAJW4D3DShaderProfileVersion@@V?$span@$$CBUPixelFormatInfo@@$0?0@gsl@@W4DXGI_COLOR_SPACE_TYPE@@PEAPEAUID3D10Blob@@@Z @ 0x18020A918
 * Callers:
        ...
        struct ID3D10Blob **a4)
{
  ...
  *((_QWORD *)&v56 + 1) = &unk_1802D7E20;
  ...
  v59 = v56;
  v8 = CShaderLinkingGraphBuilder::Initialize(ppLinker, a1, &v59);
  v10 = v8;
  if ( v8 < 0 )
  {
