 ...
 *     ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@U?$IMap@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@U?$IIterable@PEAU?$IKeyValuePair@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@@567@VFtmBase@23@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180297380 (-QueryInterface@-$RuntimeClassImpl@U-$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0_ea_180297380.c)
 * Callees:
 ...
 *     ?InlineIsEqualGUID@@YAHAEBU_GUID@@0@Z @ 0x180296778 (-InlineIsEqualGUID@@YAHAEBU_GUID@@0@Z.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    if ( (unsigned int)InlineIsEqualGUID(v6, &GUID_5ee3189c_7dbf_5998_ad07_5414fb82567c) )
    {
      *v7 = v8;
      CanCastTo = 0;
    }
