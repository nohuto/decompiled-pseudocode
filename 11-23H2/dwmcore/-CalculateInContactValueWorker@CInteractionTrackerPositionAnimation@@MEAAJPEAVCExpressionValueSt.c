/*
 * XREFs of ?CalculateInContactValueWorker@CInteractionTrackerPositionAnimation@@MEAAJPEAVCExpressionValueStack@@_KMPEAM@Z @ 0x180266470
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z @ 0x18026F218 (-CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z.c)
