/*
 * XREFs of ?OnVisualPropertyChange@CManipulationContext@@SAXPEAVCVisual@@PEAVCDesktopTree@@@Z @ 0x1801A4E0C
 * Callers:
 ...
 * Callees:
 *     ?GetInputQueueType@CInputSinkStruct@@QEBA?AW4CompositionInputQueueType@@W4InputType@@@Z @ 0x1800199CC (-GetInputQueueType@CInputSinkStruct@@QEBA-AW4CompositionInputQueueType@@W4InputType@@@Z.c)
 ...
 *     _lambda_9a9771997357178f95a5eaf72b6b0000_::operator() @ 0x1801A3404 (_lambda_9a9771997357178f95a5eaf72b6b0000_--operator().c)
 */
