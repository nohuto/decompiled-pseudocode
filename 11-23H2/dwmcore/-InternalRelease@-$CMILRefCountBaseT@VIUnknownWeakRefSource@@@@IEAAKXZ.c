/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VIUnknownWeakRefSource@@@@IEAAKXZ @ 0x1800FA90C
 * Callers:
 *     ?InternalRelease@CMILCOMBaseWeakRef@@IEAAKXZ @ 0x1800FA8BC (-InternalRelease@CMILCOMBaseWeakRef@@IEAAKXZ.c)
 *     ?Release@?$CMILCOMBaseT@VIUnknownWeakRefSource@@@@UEAAKXZ @ 0x18028B650 (-Release@-$CMILCOMBaseT@VIUnknownWeakRefSource@@@@UEAAKXZ.c)
 * Callees:
