/*
 * XREFs of ?GetShaderLinkingBody@ProjectedShadowRenderingShaderBody@@YA?AUShaderLinkingBody@@W4Enum@CommonRenderingShaderBody@@W4D3DShaderProfileVersion@@@Z @ 0x180208BA8
 * Callers:
 ...
 * Callees:
 *     ?GetInputs@CommonRenderingShaderBody@@YA?AV?$span@$$CBW4ShaderLinkingArgument@@$0?0@gsl@@W4Enum@1@@Z @ 0x1800F7F38 (-GetInputs@CommonRenderingShaderBody@@YA-AV-$span@$$CBW4ShaderLinkingArgument@@$0-0@gsl@@W4Enum@.c)
 */
