/*
 * XREFs of ?FreeBatchPool@CInternalMilCmdConnection@@AEAAXXZ @ 0x180098A80
 * Callers:
 *     ?ClearBatchCaches@CInternalMilCmdConnection@@UEAA_NK@Z @ 0x1800DF690 (-ClearBatchCaches@CInternalMilCmdConnection@@UEAA_NK@Z.c)
