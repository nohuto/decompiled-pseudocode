/*
 * XREFs of ?GetWindowBackgroundTreatmentInternal@CVisual@@QEBAPEAVCWindowBackgroundTreatment@@XZ @ 0x18002492C
 * Callers:
 ...
 *     ?Initialize@CBackdropVisualImage@@EEAAJXZ @ 0x180025C80 (-Initialize@CBackdropVisualImage@@EEAAJXZ.c)
