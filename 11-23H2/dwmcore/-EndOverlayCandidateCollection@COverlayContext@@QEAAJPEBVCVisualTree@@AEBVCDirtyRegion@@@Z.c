/*
 * XREFs of ?EndOverlayCandidateCollection@COverlayContext@@QEAAJPEBVCVisualTree@@AEBVCDirtyRegion@@@Z @ 0x180040AC4
 * Callers:
 ...
 *     ?CopyTransientProperties@OverlayPlaneInfo@COverlayContext@@QEAAXAEBV12@@Z @ 0x1801DCA48 (-CopyTransientProperties@OverlayPlaneInfo@COverlayContext@@QEAAXAEBV12@@Z.c)
        ...
        const struct CDirtyRegion *a3)
{
  ...
  if ( *((_BYTE *)this + 11302) && v5 )
  {
    ...
    while ( v7 < -1227133513 * (unsigned int)((__int64)(*((_QWORD *)this + 12) - *((_QWORD *)this + 11)) >> 5) )
    {
      ...
      IsOccluded = COcclusionContext::IsOccluded(v5, &v53, v21, 0LL);
      v24 = IsOccluded;
