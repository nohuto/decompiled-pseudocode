/*
 * XREFs of ?Interpolate@CInterpolatePathsOperation@@QEAAJPEBVCPathData@@0MPEAPEAV2@@Z @ 0x1802AEF9C
 * Callers:
 ...
 *     ??9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z @ 0x1800D9F5C (--9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z.c)
 ...
 *     ??Econst_iterator@ControlPointCollection@Path@@QEAAAEAV012@XZ @ 0x1800D9FEC (--Econst_iterator@ControlPointCollection@Path@@QEAAAEAV012@XZ.c)
 *     ??Econst_iterator@SegmentCollection@Path@@QEAAAEAV012@XZ @ 0x1800DA0C4 (--Econst_iterator@SegmentCollection@Path@@QEAAAEAV012@XZ.c)
