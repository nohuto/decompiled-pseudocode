/*
 * XREFs of ?ProcessRemoveDisplay@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x1802AD830
 * Callers:
 ...
 *     ?Remove@?$DynArray@PEAUIHolographicDisplayInfo@@$0A@@@QEAAHAEBQEAUIHolographicDisplayInfo@@@Z @ 0x1802ADEB4 (-Remove@-$DynArray@PEAUIHolographicDisplayInfo@@$0A@@@QEAAHAEBQEAUIHolographicDisplayInfo@@@Z.c)
 */
