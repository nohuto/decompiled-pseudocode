/*
 * XREFs of ?EnsureRenderTargetBitmap@CCachedVisualImage@@IEAAJAEBVRenderTargetInfo@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x1800A2A20
 * Callers:
        ...
        struct IRenderTargetBitmap **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( this[19].width )
  {
    ...
    v35 = 913;
LABEL_55:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v6, v35, 0LL);
    return v6;
  }
  ...
  v7 = 0.0;
  v45 = 0LL;
  if ( !*(_QWORD *)&v5[18] || (width = v39.width) == 0 || (this = (struct D2D_SIZE_U *)v39.height, !v39.height) )
  {
