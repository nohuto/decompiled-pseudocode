/*
 * XREFs of ?EnsureRenderTargets@CVisualCapture@@MEAAJXZ @ 0x1802557A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1803B8AF0, 3u, v8, 0x43u, 0LL);
      goto LABEL_15;
    }
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1803B8AF0, 3u, v18, 0x4Au, 0LL);
      goto LABEL_15;
    }
    v20 = v31;
...
LABEL_12:
      MilInstrumentationCheckHR_MaybeFailFast(v27, &dword_1803B8AF0, 3u, v26, 0x4Fu, 0LL);
      goto LABEL_15;
    }
    v26 = 0;
