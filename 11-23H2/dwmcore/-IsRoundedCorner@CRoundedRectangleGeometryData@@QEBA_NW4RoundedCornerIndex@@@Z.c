/*
 * XREFs of ?IsRoundedCorner@CRoundedRectangleGeometryData@@QEBA_NW4RoundedCornerIndex@@@Z @ 0x1800CFBF4
 * Callers:
 ...
 *     ?IsRectangles@CRoundedRectangleShape@@UEBA_NPEAI@Z @ 0x1800CB610 (-IsRectangles@CRoundedRectangleShape@@UEBA_NPEAI@Z.c)
