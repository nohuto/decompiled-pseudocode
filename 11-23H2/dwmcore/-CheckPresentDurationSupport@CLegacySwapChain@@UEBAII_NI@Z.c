/*
 * XREFs of ?CheckPresentDurationSupport@CLegacySwapChain@@UEBAII_NI@Z @ 0x18029A500
 * Callers:
 *     ?CheckPresentDurationSupport@CLegacySwapChain@@$4PPPPPPPM@BLA@EBAII_NI@Z @ 0x18011F430 (-CheckPresentDurationSupport@CLegacySwapChain@@$4PPPPPPPM@BLA@EBAII_NI@Z.c)
 * Callees:
        ...
        unsigned int a4)
{
  ...
  unsigned int v26; // [rsp+20h] [rbp-10h]
  ...
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v21 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, int *, int *, unsigned int, int))(**((_QWORD **)this + 28)
                                                                                         + 192LL))(
                *((_QWORD *)this + 28),
                v14,
                &v29,
  ...
  else
  {
    ...
    {
      v11 = v28;
      if ( (int)abs32(a2 - v29) < (int)abs32(a2 - v28) )
        v11 = v29;
      LODWORD(v8) = v11;
    }
  }
