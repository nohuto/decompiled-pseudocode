/*
 * XREFs of ?DrawRectangleOverlay@CDrawingContext@@AEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801D41FC
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawRectangleOverlay(gsl::details *a1, __int64 a2)
{
  ...
  v2 = (__m128)_mm_loadu_si128(&xmmword_180386C08[g_DirtyRegionColor]);
