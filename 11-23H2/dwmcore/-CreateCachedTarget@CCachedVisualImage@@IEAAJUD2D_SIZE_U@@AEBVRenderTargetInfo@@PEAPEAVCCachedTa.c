/*
 * XREFs of ?CreateCachedTarget@CCachedVisualImage@@IEAAJUD2D_SIZE_U@@AEBVRenderTargetInfo@@PEAPEAVCCachedTarget@1@@Z @ 0x1800A2744
 * Callers:
        ...
        struct CCachedVisualImage::CCachedTarget **a4)
{
  ...
  *a4 = 0LL;
  ...
  else
  {
    ...
    v13 = (*(__int64 (__fastcall **)(CCachedVisualImage *, _BYTE *))(*(_QWORD *)this + 200LL))(this, v21);
    v14 = CD3DDevice::CreateRenderTargetBitmap(v19, v13, &v20, &v22, a3, 0, &v18);
    v12 = v14;
    if ( v14 < 0 )
    {
