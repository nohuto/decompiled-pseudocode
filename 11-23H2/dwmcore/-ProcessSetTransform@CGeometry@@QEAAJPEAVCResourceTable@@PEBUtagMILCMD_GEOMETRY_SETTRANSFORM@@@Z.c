/*
 * XREFs of ?ProcessSetTransform@CGeometry@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_GEOMETRY_SETTRANSFORM@@@Z @ 0x1800F7DB0
 * Callers:
        ...
        const struct tagMILCMD_GEOMETRY_SETTRANSFORM *a3)
{
  ...
  if ( ResourceWithoutType != v6 )
  {
    if ( ResourceWithoutType )
    {
      ...
      {
        v4 = -2003303421;
        MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003303421, 0x170u, 0LL);
        return v4;
      }
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x173u, 0LL);
        return v4;
      }
      v6 = (struct CResource *)*((_QWORD *)this + 10);
    }
