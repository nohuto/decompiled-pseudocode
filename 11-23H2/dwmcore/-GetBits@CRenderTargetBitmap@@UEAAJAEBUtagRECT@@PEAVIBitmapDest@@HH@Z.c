/*
 * XREFs of ?GetBits@CRenderTargetBitmap@@UEAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z @ 0x1800E4210
 * Callers:
 *     ?GetBits@CStereoRenderTargetBitmap@@UEAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z @ 0x1802B58B0 (-GetBits@CStereoRenderTargetBitmap@@UEAAJAEBUtagRECT@@PEAVIBitmapDest@@HH@Z.c)
 * Callees:
        ...
        int a5)
{
  ...
  if ( a2->left < 0
    || (top = a2->top, top < 0)
    || (right = (unsigned int)a2->right, (unsigned int)right > v31[0])
