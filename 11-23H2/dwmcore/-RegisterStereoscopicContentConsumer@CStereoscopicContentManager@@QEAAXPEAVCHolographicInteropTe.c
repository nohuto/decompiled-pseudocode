/*
 * XREFs of ?RegisterStereoscopicContentConsumer@CStereoscopicContentManager@@QEAAXPEAVCHolographicInteropTexture@@@Z @ 0x1802A6DA4
 * Callers:
 ...
 *     ??0StereoscopicViewData@@QEAA@XZ @ 0x1802A6688 (--0StereoscopicViewData@@QEAA@XZ.c)
 */
