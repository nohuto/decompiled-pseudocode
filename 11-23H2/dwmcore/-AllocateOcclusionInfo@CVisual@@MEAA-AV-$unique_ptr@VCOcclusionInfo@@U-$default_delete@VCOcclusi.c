/*
 * XREFs of ?AllocateOcclusionInfo@CVisual@@MEAA?AV?$unique_ptr@VCOcclusionInfo@@U?$default_delete@VCOcclusionInfo@@@std@@@std@@AEBVCBackdropVisualImageKey@@@Z @ 0x1800CF1C0
 * Callers:
 *     <none>
 * Callees:
