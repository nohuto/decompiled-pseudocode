/*
 * XREFs of ?AdjustSurfaceBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVCSurfaceBrush@@@Z @ 0x180248BB8
 * Callers:
        ...
        struct CSurfaceBrush *a3)
{
  ...
  *(_QWORD *)&v16.left = 0LL;
  ...
  if ( *(_QWORD *)&v16.left )
  {
    v11 = ((__int64 (__fastcall *)(_QWORD, void *, struct D2D_RECT_F *))xmmword_1803E3638)(
            *(_QWORD *)&v16.left + SDWORD2(xmmword_1803E3638),
