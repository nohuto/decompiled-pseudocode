/*
 * XREFs of ?CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z @ 0x18026F218
 * Callers:
 ...
 * Callees:
 *     ?AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ @ 0x18026F0F0 (-AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ.c)
 */
