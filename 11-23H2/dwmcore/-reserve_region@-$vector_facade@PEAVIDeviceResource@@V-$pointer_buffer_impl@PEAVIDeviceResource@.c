/*
 * XREFs of ?reserve_region@?$vector_facade@PEAVIDeviceResource@@V?$pointer_buffer_impl@PEAVIDeviceResource@@@detail@@@detail@@IEAAPEAPEAVIDeviceResource@@_K0@Z @ 0x180027180
 * Callers:
...
__int64 __fastcall detail::vector_facade<IDeviceResource *,detail::pointer_buffer_impl<IDeviceResource *>>::reserve_region(
        __int64 a1,
        __int64 a2)
{
  __int64 v4; // rax
...
LABEL_8:
  ...
  if ( v5 > 1 )
  {
    ...
    v13[1] = v6;
    v13[2] = v6;
    ((void (__fastcall *)(_BYTE *, __int64, __int64, _QWORD *))std::move_backward<std::move_iterator<D2D_POINT_2F *>,stdext::checked_array_iterator<D2D_POINT_2F *>>)(
      v14,
      v8 + 8 * a2,
      v8 + 8 * (v6 - 1),
      v13);
  }
  detail::pointer_buffer_impl<IDeviceResource *>::consume(a1, 1LL, v11);
  return v8 + 8 * a2;
}
