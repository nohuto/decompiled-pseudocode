/*
 * XREFs of ?AddDeviceResourceToCache@CDrawListBitmap@@QEBAXPEAVCDrawListCache@@@Z @ 0x1800272A0
 * Callers:
 *     ?AddDeviceResourcesToCache@CBrushRenderingEffect@@UEBAXPEAVCDrawListCache@@@Z @ 0x180027250 (-AddDeviceResourcesToCache@CBrushRenderingEffect@@UEBAXPEAVCDrawListCache@@@Z.c)
 *     ?AddDeviceResourcesToCache@CWARPDrawListEntry@@UEBAXPEAVCDrawListCache@@@Z @ 0x1801FF940 (-AddDeviceResourcesToCache@CWARPDrawListEntry@@UEBAXPEAVCDrawListCache@@@Z.c)
 *     ?AddDeviceResourcesToCache@CCubeMapRenderingEffect@@UEBAXPEAVCDrawListCache@@@Z @ 0x1802B80B0 (-AddDeviceResourcesToCache@CCubeMapRenderingEffect@@UEBAXPEAVCDrawListCache@@@Z.c)
 * Callees:
