/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@UIEffectInstance@Composition@UI@Windows@@@@IEAAKXZ @ 0x1800F573C
 * Callers:
 ...
 *     ?Release@CRadialGradientEffect@@UEAAKXZ @ 0x1800F5730 (-Release@CRadialGradientEffect@@UEAAKXZ.c)
