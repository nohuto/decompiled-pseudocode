/*
 * XREFs of ??$UpdateProperty@UD2DVector3@@@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector3@@@Z @ 0x1800C7290
 * Callers:
...
__int64 __fastcall CPropertySet::UpdateProperty<D2DVector3>(CResource *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(*v6 + 8 * v8) == v7 )
  {
    ...
    *(_DWORD *)(v14 + v13 + 8) = *(_DWORD *)(a4 + 8);
    v15 = CPropertySet::PropertyUpdated<D2DVector3>(this, v12, 1, a4);
    v17 = v15;
    if ( v15 < 0 )
