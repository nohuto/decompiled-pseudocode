/*
 * XREFs of ?CollectOcclusion@CVisual@@UEAAJPEAVCOcclusionContext@@PEAVCOcclusionInfo@@@Z @ 0x1800C9430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVisual::CollectOcclusion(CVisual *this, struct COcclusionContext *a2, struct COcclusionInfo *a3)
{
  ...
  if ( result )
  {
    ...
    if ( (int)result < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, result, 0xF38u, 0LL);
      return v5;
    }
  }
  return result;
