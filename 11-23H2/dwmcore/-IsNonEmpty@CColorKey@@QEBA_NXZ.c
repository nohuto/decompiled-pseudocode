/*
 * XREFs of ?IsNonEmpty@CColorKey@@QEBA_NXZ @ 0x180092B3C
 * Callers:
 *     ?SetColorKey@CGdiSpriteBitmap@@QEAAX_NAEBVCColorKey@@@Z @ 0x180091AAC (-SetColorKey@CGdiSpriteBitmap@@QEAAX_NAEBVCColorKey@@@Z.c)
