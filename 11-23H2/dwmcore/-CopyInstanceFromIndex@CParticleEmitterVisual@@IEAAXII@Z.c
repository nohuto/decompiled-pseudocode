/*
 * XREFs of ?CopyInstanceFromIndex@CParticleEmitterVisual@@IEAAXII@Z @ 0x1802445B4
 * Callers:
 ...
 * Callees:
 *     ?ColorDWFromStraightColorF@@YAKAEBU_D3DCOLORVALUE@@@Z @ 0x1800388CC (-ColorDWFromStraightColorF@@YAKAEBU_D3DCOLORVALUE@@@Z.c)
