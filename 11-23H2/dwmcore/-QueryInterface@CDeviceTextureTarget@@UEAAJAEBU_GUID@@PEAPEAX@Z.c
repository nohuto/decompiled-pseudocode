/*
 * XREFs of ?QueryInterface@CDeviceTextureTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180049E20
 * Callers:
 *     ?QueryInterface@CDeviceTextureTarget@@$4PPPPPPPM@BCI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180120270 (-QueryInterface@CDeviceTextureTarget@@$4PPPPPPPM@BCI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CDeviceTextureTarget@@WHA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180120290 (-QueryInterface@CDeviceTextureTarget@@WHA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CDeviceTextureTarget::QueryInterface(CDeviceTextureTarget *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      v5 = (*(__int64 (__fastcall **)(CDeviceTextureTarget *))(*(_QWORD *)this + 40LL))(this);
      if ( v5 < 0 )
      {
        *a3 = 0LL;
