/*
 * XREFs of ?MarkPrincipalReadyOnPropertiesRefreshed@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJPEAVBaseBamoPeerImpl@23@I@Z @ 0x1801B9B28
 * Callers:
 *     ?Thunk_MarkPrincipalReadyOnPropertiesRefreshed_34@?$IBamoPeer_DiagnosticCallbacks_AutoBamos_Receive@VBamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801BB470 (-Thunk_MarkPrincipalReadyOnPropertiesRefreshed_34@-$IBamoPeer_DiagnosticCallbacks_AutoBamos_Rece.c)
 * Callees:
    ...
    *((_BYTE *)i + 57) = 1;
    ...
    if ( v10 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        263LL,
        (__int64)"g:\\os\\tools\\BamoCodegen\\Inc\\BamoStub.inl",
