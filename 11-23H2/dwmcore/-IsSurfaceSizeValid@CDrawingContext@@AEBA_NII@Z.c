/*
 * XREFs of ?IsSurfaceSizeValid@CDrawingContext@@AEBA_NII@Z @ 0x1800108A8
 * Callers:
 ...
 * Callees:
 *     ?GetMaxTextureSize@CDrawingContext@@QEBAI_N@Z @ 0x1800108D4 (-GetMaxTextureSize@CDrawingContext@@QEBAI_N@Z.c)
 */
