/*
 * XREFs of ?SetStateOnDevice@CBrushRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEAI@Z @ 0x1800B5260
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0ShaderLinkingSamplerDesc@@QEAA@XZ @ 0x180106DC0 (--0ShaderLinkingSamplerDesc@@QEAA@XZ.c)
        ...
        unsigned int *a3)
{
  ...
  enum DXGI_FORMAT v109[2]; // [rsp+D0h] [rbp-38h]
