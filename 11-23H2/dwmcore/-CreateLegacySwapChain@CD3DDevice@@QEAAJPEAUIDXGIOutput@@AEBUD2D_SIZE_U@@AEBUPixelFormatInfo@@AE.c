/*
 * XREFs of ?CreateLegacySwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@I_NPEAPEAVILegacySwapChain@@@Z @ 0x1800FF054
 * Callers:
...
LABEL_30:
    v22 = v14;
LABEL_39:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_180358A40, 3u, v22, v23, 0LL);
  }
