/*
 * XREFs of _anonymous_namespace_::GetTemporaryConfigWithMask @ 0x1800E3C64
 * Callers:
 ...
 *     ?SupportsInteractionType@CInteractionProcessor@@QEBAHW4InputType@@I_N@Z @ 0x1800E894C (-SupportsInteractionType@CInteractionProcessor@@QEBAHW4InputType@@I_N@Z.c)
