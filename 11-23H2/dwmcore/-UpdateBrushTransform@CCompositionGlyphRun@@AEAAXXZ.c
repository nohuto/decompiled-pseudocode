/*
 * XREFs of ?UpdateBrushTransform@CCompositionGlyphRun@@AEAAXXZ @ 0x180223660
 * Callers:
 *     ?NotifyOnChanged@CCompositionGlyphRun@@UEAAXW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x180223620 (-NotifyOnChanged@CCompositionGlyphRun@@UEAAXW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
 * Callees:
    ...
    if ( v6 )
    {
      if ( *(_QWORD *)(v6 + 120) )
      {
        ...
        D2D1::Matrix3x2F::SetProduct(
          ...
          (const struct D2D1::Matrix3x2F *)&v14);
        ((void (__fastcall *)(_QWORD, void *, float *))xmmword_1803E3638)(
          *(_QWORD *)(v12 + 120) + SDWORD2(xmmword_1803E3638),
