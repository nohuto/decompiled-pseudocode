/*
 * XREFs of ?ClearD2DCaches@CDeviceManager@@IEAA_NK@Z @ 0x180048A64
 * Callers:
...
char __fastcall CDeviceManager::ClearD2DCaches(CDeviceManager *this, int a2)
{
  ...
  v7 = xmmword_1803EA140;
  for ( i = qword_1803EA138; i != v7; i += 16LL )
  {
    v9 = 0;
    v10 = *(_QWORD *)(*(_QWORD *)i + 896LL);
    EnterCriticalSection(&CriticalSection);
    for ( j = qword_1803EA138; j != (_QWORD)xmmword_1803EA140; j += 16LL )
    {
      if ( v10 == *(_QWORD *)(*(_QWORD *)j + 896LL) )
      {
        if ( j && !*(_BYTE *)(*(_QWORD *)j + 452LL) && !byte_1803EA150 && *(_DWORD *)(*(_QWORD *)j + 448LL) )
          v9 = 1;
        break;
      }
    }
