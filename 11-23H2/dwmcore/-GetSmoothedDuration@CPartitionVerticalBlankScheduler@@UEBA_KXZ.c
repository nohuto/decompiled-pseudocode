/*
 * XREFs of ?GetSmoothedDuration@CPartitionVerticalBlankScheduler@@UEBA_KXZ @ 0x18007EFE0
 * Callers:
 *     ?GetNextFrameStartTime@CPartitionVerticalBlankScheduler@@UEBA_KXZ @ 0x1800EF9A0 (-GetNextFrameStartTime@CPartitionVerticalBlankScheduler@@UEBA_KXZ.c)
 * Callees:
