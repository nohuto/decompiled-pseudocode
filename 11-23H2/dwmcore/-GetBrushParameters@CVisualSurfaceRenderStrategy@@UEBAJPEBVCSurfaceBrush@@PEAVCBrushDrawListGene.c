/*
 * XREFs of ?GetBrushParameters@CVisualSurfaceRenderStrategy@@UEBAJPEBVCSurfaceBrush@@PEAVCBrushDrawListGenerator@@@Z @ 0x1800C21C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetProduct@MILMatrix3x2@@QEAAXAEBV1@0@Z @ 0x1800C2D9C (-SetProduct@MILMatrix3x2@@QEAAXAEBV1@0@Z.c)
        ...
        struct D2D_SIZE_F *a3)
{
  ...
  if ( v7 )
  {
    if ( *((_BYTE *)a2 + 169) )
    {
      ...
      v32.m11 = 1.0;
      if ( CMILMatrix::Get2DScaleDimensionsWithPerspective((CMILMatrix *)&v38, &v32.m12, &v32.m11, (__int64)&v50)
  ...
  else
  {
    ...
    CMILMatrix::Multiply((CMILMatrix *)&v38, (const struct CMILMatrix *)v48);
    v50 = v34;
    CMILMatrix::Get2DScaleDimensionsWithPerspective((CMILMatrix *)&v38, &v32.m12, &v32.m11, (__int64)&v50);
    v30 = *((_BYTE *)v3 + 200);
