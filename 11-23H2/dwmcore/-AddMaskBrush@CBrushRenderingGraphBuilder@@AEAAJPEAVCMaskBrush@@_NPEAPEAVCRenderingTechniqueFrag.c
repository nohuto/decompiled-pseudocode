/*
 * XREFs of ?AddMaskBrush@CBrushRenderingGraphBuilder@@AEAAJPEAVCMaskBrush@@_NPEAPEAVCRenderingTechniqueFragment@@@Z @ 0x1800EDD94
 * Callers:
        ...
        struct CRenderingTechniqueFragment **a4)
{
  ...
  __int64 *v15; // rsi
  CRenderingTechniqueFragment ***v16; // rdx
  __int64 *v17; // rax
  ...
  if ( *((_BYTE *)v4 + 80) )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v5, 0x163u, 0LL);
      goto LABEL_18;
    }
    v5 = 0;
  }
  ...
  if ( v7 )
  {
    ...
    if ( v26 )
    {
      v26 = 0LL;
      v15 = v7 + 4;
      v16 = (CRenderingTechniqueFragment ***)v7[5];
      v28 = v14;
      if ( v16 == (CRenderingTechniqueFragment ***)v7[6] )
      {
      ...
      {
        *v16 = v27;
        v16[1] = (CRenderingTechniqueFragment **)v14;
        v7[5] += 16LL;
        v28 = 0LL;
      }
...
LABEL_17:
    ...
    if ( v5 >= 0 )
    {
      v22 = v30;
      v30 = 0LL;
      v23 = (CRenderingTechniqueFragment ***)v15[1];
      v28 = v22;
      if ( v23 == (CRenderingTechniqueFragment ***)v15[2] )
      {
        std::vector<CRenderingTechniqueFragment::FragmentInput>::_Emplace_reallocate<CRenderingTechniqueFragment::FragmentInput>(
          v15,
          (__int64)v23,
      ...
      else
      {
        v28 = 0LL;
        *v23 = v27;
        v23[1] = (CRenderingTechniqueFragment **)v22;
        v15[1] += 16LL;
      }
      std::unique_ptr<CRenderingTechniqueFragment>::~unique_ptr<CRenderingTechniqueFragment>(&v28);
      v24 = v30;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v5, 0x17Du, 0LL);
    v25 = v30;
    if ( v30 )
    {
      CRenderingTechniqueFragment::~CRenderingTechniqueFragment(v30);
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, -2147024882, 0x169u, 0LL);
  }
LABEL_18:
  v18 = v26;
  if ( v26 )
