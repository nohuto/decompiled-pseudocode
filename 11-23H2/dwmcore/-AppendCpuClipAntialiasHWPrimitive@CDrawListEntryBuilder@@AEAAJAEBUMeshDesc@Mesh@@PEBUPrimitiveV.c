/*
 * XREFs of ?AppendCpuClipAntialiasHWPrimitive@CDrawListEntryBuilder@@AEAAJAEBUMeshDesc@Mesh@@PEBUPrimitiveVertexAttributesDesc@@_N2PEA_N@Z @ 0x180036350
 * Callers:
 ...
 *     ?CalcOutlinePosition@CCpuClipAntialiasSink@@QEBAMGAEBUD2D_POINT_2F@@@Z @ 0x1800371A8 (-CalcOutlinePosition@CCpuClipAntialiasSink@@QEBAMGAEBUD2D_POINT_2F@@@Z.c)
 ...
 *     ??A?$span@$$CBUPrimitiveUVDesc@@$0?0@gsl@@QEBAAEBUPrimitiveUVDesc@@_K@Z @ 0x1800DFD7C (--A-$span@$$CBUPrimitiveUVDesc@@$0-0@gsl@@QEBAAEBUPrimitiveUVDesc@@_K@Z.c)
...
LABEL_59:
      ...
      v170 = 1;
      *(_OWORD *)v158 = v100;
      CCpuClipAntialiasSink::CreateUVData((_DWORD)v95, 0, (unsigned int)&v156, v102, v98, (__int64)v158, (__int64)&v169);
      if ( v170 )
      {
        v103 = *v168;
        *v168 = v169;
...
LABEL_110:
      ...
      *(_QWORD *)&v150.m[1][0] = 0LL;
      v105 = CCpuClipAntialiasDrawListEntry::Create(v175, &v152, v150.m[1]);
      v153 = v105;
      v12 = v105;
      if ( v105 < 0 )
      {
