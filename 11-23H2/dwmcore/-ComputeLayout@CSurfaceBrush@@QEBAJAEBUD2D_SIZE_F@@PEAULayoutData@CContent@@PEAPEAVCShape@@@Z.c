/*
 * XREFs of ?ComputeLayout@CSurfaceBrush@@QEBAJAEBUD2D_SIZE_F@@PEAULayoutData@CContent@@PEAPEAVCShape@@@Z @ 0x180039860
 * Callers:
  ...
  *(__m128 *)&v53.m11 = v51;
  ...
  if ( a4 )
  {
    ...
    *(_QWORD *)&v53.m11 = &v47;
    ...
    {
      v46 = CShape::D2DCombine(&v63, v32, &v55, v50, 1, v53.m[1]);
      v11 = v46;
      if ( v46 < 0 )
