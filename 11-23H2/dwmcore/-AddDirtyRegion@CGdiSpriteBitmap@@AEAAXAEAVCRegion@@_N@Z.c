/*
 * XREFs of ?AddDirtyRegion@CGdiSpriteBitmap@@AEAAXAEAVCRegion@@_N@Z @ 0x18002FC00
 * Callers:
 ...
 *     ?Contains@CRegion@FastRegion@@QEBA_NAEBV12@@Z @ 0x1800E48C4 (-Contains@CRegion@FastRegion@@QEBA_NAEBV12@@Z.c)
