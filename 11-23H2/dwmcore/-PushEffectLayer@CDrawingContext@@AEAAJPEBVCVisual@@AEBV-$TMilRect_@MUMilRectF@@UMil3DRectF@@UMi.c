/*
 * XREFs of ?PushEffectLayer@CDrawingContext@@AEAAJPEBVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@11PEAVCResource@@PEA_N@Z @ 0x18000D200
 * Callers:
 ...
 *     ?GetLayerPointAndSize@CTreeEffectLayer@@SA?AUMilPointAndSizeL@@PEBVCEffectBrush@@AEBU2@AEBUMilPointAndSizeF@@@Z @ 0x18000D780 (-GetLayerPointAndSize@CTreeEffectLayer@@SA-AUMilPointAndSizeL@@PEBVCEffectBrush@@AEBU2@AEBUMilPo.c)
 *     ?RoundOffLayerSize@CTreeEffectLayer@@SA?AUMilPointAndSizeL@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18000D7B8 (-RoundOffLayerSize@CTreeEffectLayer@@SA-AUMilPointAndSizeL@@AEBV-$TMilRect_@MUMilRectF@@UMil3DRe.c)
  ...
  if ( a6 )
  {
    if ( (*(unsigned __int8 (__fastcall **)(struct CFilterEffect *, __int64))(*(_QWORD *)a6 + 56LL))(a6, 61LL) )
    {
      if ( CDrawingContext::IsSurfaceSizeValid((CDrawingContext *)this, v42[2], v42[3]) )
      {
        ...
        if ( v33 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v33, 0xED2u, 0LL);
          v9 = v43[0];
          goto LABEL_13;
        }
        v9 = v43[0];
    ...
    {
      v27 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(v35, 0LL, 0, -2147024809, 0xF0Au, 0LL);
      goto LABEL_13;
    }
  }
...
LABEL_12:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v37, 0LL, 0, v36, 0xEF7u, 0LL);
  v10 = v41;
LABEL_13:
  if ( v9 )
