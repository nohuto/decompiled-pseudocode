/*
 * XREFs of ?OnTaskCompleted_AnyThread@CEffectCompilationService@@AEAAXPEAVCEffectCompilationTask@@_N@Z @ 0x1800DDC74
 * Callers:
  ...
  if ( !*((_BYTE *)this + 72) )
  {
    ...
    if ( v6 )
    {
      ...
      if ( (unsigned int)v7 < v6 )
      {
        ...
        if ( a3 )
        {
          DynArray<CScratchRenderTargetBitmap *,0>::RemoveAt((char *)this + 80);
          --*((_DWORD *)this + 19);
        }
