/*
 * XREFs of McTemplateU0xqxxqq_EventWriteTransfer @ 0x18012E6FC
 * Callers:
        ...
        char a8)
{
  ...
  v19 = 4LL;
  v21 = 4LL;
  return McGenEventWrite_EventWriteTransfer(&Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_SCHEDULE_RETIREFRAME);
}
