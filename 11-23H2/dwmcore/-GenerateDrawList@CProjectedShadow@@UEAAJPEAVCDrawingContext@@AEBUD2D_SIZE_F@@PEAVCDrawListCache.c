/*
 * XREFs of ?GenerateDrawList@CProjectedShadow@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180249D20
 * Callers:
 *     <none>
 * Callees:
      ...
      *(_QWORD *)&v43 = &CProjectedShadowRenderingEffectFactory::`vftable';
      ...
      else
      {
        ...
        else
        {
          ...
          v61 = *((_OWORD *)this + 22);
          CBrushDrawListGenerator::AttachInput((__int64)v60, 0, &v42);
          CBrushDrawListGenerator::AttachInput((__int64)v60, 1u, &v41);
