/*
 * XREFs of ??$_Insert_range@PEAPEAVCGeometry2D@@@?$vector@PEAVCGeometry2D@@V?$allocator@PEAVCGeometry2D@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCGeometry2D@@@std@@@std@@@1@PEAPEAVCGeometry2D@@1Uforward_iterator_tag@1@@Z @ 0x1801BE368
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCGeometry2D@@V?$allocator@PEAVCGeometry2D@@@std@@@std@@AEAAXQEAPEAVCGeometry2D@@_K1@Z @ 0x1801CA324 (-_Change_array@-$vector@PEAVCGeometry2D@@V-$allocator@PEAVCGeometry2D@@@std@@@std@@AEAAXQEAPEAVC.c)
 */
        ...
        __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    else
    {
      ...
      std::vector<CGeometry2D *>::_Change_array(a1, v17, v25, v11);
    }
  }
}
