/*
 * XREFs of ?Create@CD3DVidMemOnlyTexture@@SAJPEAUID3D11Texture2D@@I_NPEAVCD3DDevice@@PEAPEAV1@@Z @ 0x1802BF6FC
 * Callers:
 ...
 *     ??0CD3DVidMemOnlyTexture@@IEAA@_N@Z @ 0x1802BF618 (--0CD3DVidMemOnlyTexture@@IEAA@_N@Z.c)
 */
