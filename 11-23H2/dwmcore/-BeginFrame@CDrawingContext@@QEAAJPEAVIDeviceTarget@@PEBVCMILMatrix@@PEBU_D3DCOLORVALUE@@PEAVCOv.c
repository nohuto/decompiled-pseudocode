/*
 * XREFs of ?BeginFrame@CDrawingContext@@QEAAJPEAVIDeviceTarget@@PEBVCMILMatrix@@PEBU_D3DCOLORVALUE@@PEAVCOverlayContext@@@Z @ 0x180076C14
 * Callers:
        ...
        struct COverlayContext *a5)
{
  ...
  *((_QWORD *)this + 9) = *(_QWORD *)(v9 + 16);
  if ( *((_QWORD *)this + 26) )
  {
    wil::com_ptr_t<IDeviceTarget,wil::err_returncode_policy>::operator=((char *)this + 32, a2);
