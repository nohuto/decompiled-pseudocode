/*
 * XREFs of ??$UpdateProperty@UD2D_MATRIX_3X2_F@@@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x1800C7850
 * Callers:
...
__int64 __fastcall CPropertySet::UpdateProperty<D2D_MATRIX_3X2_F>(CResource *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(*v8 + 8LL * v7) == v9 )
  {
    ...
    *(_QWORD *)(v16 + v15 + 16) = *(_QWORD *)(a4 + 16);
    v17 = CPropertySet::PropertyUpdated<D2D_MATRIX_3X2_F>(this, v11, 1, a4);
    v19 = v17;
    if ( v17 < 0 )
