/*
 * XREFs of ?ScheduleCompositionPass@CPartitionVerticalBlankScheduler@@UEAAXKW4CompositionReason@@@Z @ 0x1800CE200
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  _m_prefetchw(&dword_1803E65D0);
  result = (unsigned int)~_InterlockedOr(&dword_1803E65D0, a3);
