/*
 * XREFs of ?GetBitmapInternal@CD2DBitmapCache@@IEAAJU_LUID@@VDisplayId@@_NPEAPEAVID2DBitmap@@@Z @ 0x1800ADF80
 * Callers:
...
__int64 __fastcall CD2DBitmapCache::GetBitmapInternal(__int64 a1, CSecondaryD2DBitmap *a2, int a3, CHAR a4, _QWORD *a5)
{
  char *v5; // rbx
...
LABEL_30:
  ...
  else
  {
    ...
    v22 = 2;
    v19 = *(CSecondaryD2DBitmap **)(*(_QWORD *)v20 + 8LL);
    v43 = v19;
    if ( v19 )
    {
...
LABEL_16:
        ...
        v24 = FastRegion::CRegion::Intersect(
                (const struct FastRegion::Internal::CRgnData **)&lpMem,
                (const struct FastRegion::Internal::CRgnData **)v19 + 33);
        if ( v24 < 0 )
        ...
        {
          v25 = CSecondaryD2DBitmap::Update(v19, (__int64)v46, *(__int64 **)(a1 + 24));
          v27 = v25;
          v9 = v25;
          if ( v25 >= 0 )
            goto LABEL_27;
        ...
        else
        {
          ...
          else
          {
            ...
            v25 = CSecondaryD2DBitmap::Update(v19, (__int64)v46, *(__int64 **)(a1 + 40));
            v27 = v25;
            v9 = v25;
            if ( v25 >= 0 )
            {
...
LABEL_76:
        ...
        if ( v19 )
          CMILRefCountBaseT<IUnknown>::InternalRelease((volatile signed __int32 *)v19);
        goto LABEL_9;
      }
    }
  }
  ...
  if ( v43 )
    CMILRefCountBaseT<IUnknown>::InternalRelease((volatile signed __int32 *)v43);
LABEL_9:
  *a5 = v5;
  return v9;
}
