/*
 * XREFs of ?DrawSolidColorRectangle@CRenderData@@AEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@AEBUMilRectF@@AEBU_D3DCOLORVALUE@@@Z @ 0x1800E90FC
 * Callers:
 ...
 *     ?Convert_MilColorF_scRGB_To_MilColorF_sRGB@@YA?AU_D3DCOLORVALUE@@PEBU1@@Z @ 0x1800E9260 (-Convert_MilColorF_scRGB_To_MilColorF_sRGB@@YA-AU_D3DCOLORVALUE@@PEBU1@@Z.c)
        ...
        const struct _D3DCOLORVALUE *a5)
{
  ...
  *(_QWORD *)&v18.b = &v18;
  ...
  else
  {
    ...
    *(_QWORD *)&v18.b = v12;
    CBrushDrawListGenerator::AttachInput((__int64)v24, 0, &v18.b);
    if ( *(_QWORD *)&v18.b )
