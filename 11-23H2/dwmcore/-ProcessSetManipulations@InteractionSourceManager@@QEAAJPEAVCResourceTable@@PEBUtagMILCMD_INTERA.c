/*
 * XREFs of ?ProcessSetManipulations@InteractionSourceManager@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETMANIPULATIONS@@PEBUMarshaledManipulationInfo@@@Z @ 0x180274A8C
 * Callers:
 *     ?ProcessSetManipulations@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETMANIPULATIONS@@PEBXI@Z @ 0x1802336C8 (-ProcessSetManipulations@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTION.c)
 * Callees:
 ...
 *     ??1?$vector@PEAUDepthGraphNode@@V?$allocator@PEAUDepthGraphNode@@@std@@@std@@QEAA@XZ @ 0x18026C6BC (--1-$vector@PEAUDepthGraphNode@@V-$allocator@PEAUDepthGraphNode@@@std@@@std@@QEAA@XZ.c)
 *     ??$_Emplace_reallocate@PEAVCManipulation@@@?$vector@PEAVCManipulation@@V?$allocator@PEAVCManipulation@@@std@@@std@@QEAAPEAPEAVCManipulation@@QEAPEAV2@$$QEAPEAV2@@Z @ 0x180273440 (--$_Emplace_reallocate@PEAVCManipulation@@@-$vector@PEAVCManipulation@@V-$allocator@PEAVCManipul.c)
 ...
 *     ?IsManipulationActive@InteractionSourceManager@@AEAA_NPEBVCManipulation@@@Z @ 0x180274580 (-IsManipulationActive@InteractionSourceManager@@AEAA_NPEBVCManipulation@@@Z.c)
