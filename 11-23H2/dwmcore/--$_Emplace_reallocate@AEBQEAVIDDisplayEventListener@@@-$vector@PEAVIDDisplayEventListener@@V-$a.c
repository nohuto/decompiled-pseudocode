/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVIDDisplayEventListener@@@?$vector@PEAVIDDisplayEventListener@@V?$allocator@PEAVIDDisplayEventListener@@@std@@@std@@QEAAPEAPEAVIDDisplayEventListener@@QEAPEAV2@AEBQEAV2@@Z @ 0x180290F9C
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVIDDisplayEventListener@@V?$allocator@PEAVIDDisplayEventListener@@@std@@@std@@AEAAXQEAPEAVIDDisplayEventListener@@_K1@Z @ 0x1802981FC (-_Change_array@-$vector@PEAVIDDisplayEventListener@@V-$allocator@PEAVIDDisplayEventListener@@@st.c)
 */
