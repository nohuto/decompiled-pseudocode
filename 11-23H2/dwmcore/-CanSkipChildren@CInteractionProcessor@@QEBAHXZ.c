/*
 * XREFs of ?CanSkipChildren@CInteractionProcessor@@QEBAHXZ @ 0x1801AC090
 * Callers:
 *     ?CanSkipChildren@CInteraction@@UEBAHXZ @ 0x18020B9D0 (-CanSkipChildren@CInteraction@@UEBAHXZ.c)
 * Callees:
