/*
 * XREFs of ?HrConvertBitmap@CFormatConverter@@SAJPEAVIBitmapSource@@AEBUPixelFormatInfo@@PEAPEAV2@@Z @ 0x1802BBCF8
 * Callers:
 ...
 *     ??0CFormatConverter@@QEAA@XZ @ 0x1802BB274 (--0CFormatConverter@@QEAA@XZ.c)
