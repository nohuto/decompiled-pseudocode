/*
 * XREFs of ??_GCSpectreCallbackRenderer@@UEAAPEAXI@Z @ 0x1801FD634
 * Callers:
 *     ??_ECSpectreCallbackRenderer@@W7EAAPEAXI@Z @ 0x18011D730 (--_ECSpectreCallbackRenderer@@W7EAAPEAXI@Z.c)
 * Callees:
