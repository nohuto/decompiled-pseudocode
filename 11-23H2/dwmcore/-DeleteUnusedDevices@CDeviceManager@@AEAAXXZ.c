/*
 * XREFs of ?DeleteUnusedDevices@CDeviceManager@@AEAAXXZ @ 0x1800CE390
 * Callers:
...
void __fastcall CDeviceManager::DeleteUnusedDevices(CDeviceManager *this)
{
  ...
  while ( (_QWORD *)v1 != v2 )
  {
    ...
    else
    {
      ...
      v2 = (_QWORD *)(xmmword_1803EA140 - 16);
      *(_QWORD *)&xmmword_1803EA140 = xmmword_1803EA140 - 16;
    }
  }
