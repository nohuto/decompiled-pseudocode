/*
 * XREFs of ?CreateScratchRenderTargetBitmap@CD3DDevice@@IEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVCScratchRenderTargetBitmap@@@Z @ 0x1800A08AC
 * Callers:
...
LABEL_11:
    v17 = v11;
LABEL_14:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802EE308, 2u, v17, v19, 0LL);
  }
  v15 = CD3DDevice::TranslateDXGIorD3DErrorInContext((__int64)this, v8, 0);
