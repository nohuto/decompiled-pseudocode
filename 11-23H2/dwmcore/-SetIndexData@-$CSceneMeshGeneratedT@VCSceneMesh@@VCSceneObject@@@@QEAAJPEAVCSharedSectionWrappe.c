/*
 * XREFs of ?SetIndexData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1801C6B6C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[12] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1156u, 0LL);
    }
    else
    {
