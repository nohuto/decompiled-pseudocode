/*
 * XREFs of ?ProcessManipulationThreadCallbackInput@CManipulationManager@@KAHPEAUtagMANIPULATION_INPUT_INFO@@PEAX@Z @ 0x18019FA18
 * Callers:
        ...
        CManipulationManager *this)
{
  ...
  dword_1803E9F58 = GetCurrentThreadId();
  v15 = 0LL;
  v16 = *v4;
  if ( (_DWORD)v16 )
  {
