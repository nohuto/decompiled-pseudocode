/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@PEBVCResource@@PEAVCWeakResourceReference@@V?$_Uhash_compare@PEBVCResource@@U?$hash@PEBVCResource@@@std@@U?$equal_to@PEBVCResource@@@3@@std@@V?$allocator@U?$pair@QEBVCResource@@PEAVCWeakResourceReference@@@std@@@4@$0A@@std@@@std@@IEAAX_K@Z @ 0x1800CA464
 * Callers:
...
__int64 __fastcall std::_Hash<std::_Umap_traits<CResource const *,CWeakResourceReference *,std::_Uhash_compare<CResource const *,std::hash<CResource const *>,std::equal_to<CResource const *>>,std::allocator<std::pair<CResource const * const,CWeakResourceReference *>>,0>>::_Forced_rehash(
        __int64 a1,
        unsigned __int64 a2)
{
  ...
  result = std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<CResource const * const,CWeakResourceReference *>>>>>>::_Assign_grow(
             &qword_1803E62F8,
             2 * v5,
             qword_1803E62E8);
  v8 = v5 - 1;
  *((_QWORD *)&xmmword_1803E6310 + 1) = v5;
  *(_QWORD *)&xmmword_1803E6310 = v5 - 1;
  v9 = *(const unsigned __int8 **)qword_1803E62E8;
  v10 = *(const unsigned __int8 **)qword_1803E62E8;
  while ( v9 != (const unsigned __int8 *)v3 )
  {
    ...
    v13 = qword_1803E62F8;
    v14 = 2 * (v8 & result);
    if ( *(_QWORD *)(qword_1803E62F8 + 16 * (v8 & result)) == v3 )
    {
      *(_QWORD *)(qword_1803E62F8 + 16 * (v8 & result)) = v12;
LABEL_6:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v12;
      goto LABEL_7;
    }
    result = *(_QWORD *)(qword_1803E62F8 + 16 * (v8 & result) + 8);
    v7 = *v11;
    ...
    do
    {
      ...
      if ( *(_QWORD *)(qword_1803E62F8 + 8 * v14) == result )
      {
