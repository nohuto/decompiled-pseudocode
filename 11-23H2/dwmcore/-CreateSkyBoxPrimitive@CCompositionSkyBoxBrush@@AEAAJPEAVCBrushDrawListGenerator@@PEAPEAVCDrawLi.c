/*
 * XREFs of ?CreateSkyBoxPrimitive@CCompositionSkyBoxBrush@@AEAAJPEAVCBrushDrawListGenerator@@PEAPEAVCDrawListPrimitive@@@Z @ 0x180225330
 * Callers:
        ...
        struct CDrawListPrimitive **a3)
{
  ...
  else
  {
    for ( i = 0; i < 6; ++i )
    {
      v10 = *((_DWORD *)this + 30);
      if ( _bittest(&v10, i) )
        DynArray<unsigned short,0>::AddMultipleAndSet((__int64)&v27, (__int64 *)((char *)&unk_1803B8250 + 12 * i));
    }
    ...
    v13 = 0LL;
    v14 = (const struct MilPoint4F *)&unk_1803B82A0;
    v15 = 8LL;
    do
    {
