/*
 * XREFs of ??0CCustomKernelEffect@@AEAA@W4D3DShaderProfileVersion@@W4Enum@ExtendMode@@AEBV?$span@$$CBUKernelTap@@$0?0@gsl@@@Z @ 0x1800BD6EC
 * Callers:
...
__int64 __fastcall CCustomKernelEffect::CCustomKernelEffect(__int64 a1, char a2, __int64 a3, __int64 *a4)
{
  ...
  *(_QWORD *)(a1 + 208) = 0LL;
  ...
  if ( (unsigned __int64)((v4[1] - *v4) >> 4) <= 8 )
  {
    ...
    *(_QWORD *)(a1 + 208) = v11;
    v8 = a1 + 240;
    *(_OWORD *)(a1 + 240) = xmmword_1803C3370;
    v12 = *(_QWORD *)(a1 + 40) - v7;
    *(_BYTE *)(a1 + 257) = 0;
