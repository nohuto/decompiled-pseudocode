/*
 * XREFs of ?NotifyVector2PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DVector2@@@Z @ 0x18007FB18
 * Callers:
 *     ?NotifyCurrentPropertyValues@CVisual@@MEBAJI@Z @ 0x180023750 (-NotifyCurrentPropertyValues@CVisual@@MEBAJI@Z.c)
 *     ?SetSize@CVisual@@QEAAXMM@Z @ 0x18007F894 (-SetSize@CVisual@@QEAAXMM@Z.c)
    ...
    if ( *(_DWORD *)(v3 + 76) )
    {
      if ( *((_DWORD *)this + 16) )
      {
        ...
        if ( _bittest(&v6, a2) )
        {
          ...
          v11 = CoreUICallSend(v10, v13, 2LL, 14LL, 2, &unk_18033C08D, a2, &v14);
          v4 = v11;
          if ( v11 == -2018375675 )
          {
            return 0;
