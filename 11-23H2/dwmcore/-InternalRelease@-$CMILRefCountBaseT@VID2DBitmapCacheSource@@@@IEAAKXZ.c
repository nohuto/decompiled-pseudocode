/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VID2DBitmapCacheSource@@@@IEAAKXZ @ 0x1800F82E0
 * Callers:
 ...
 *     ?Release@CSecondarySysmemBitmap@@UEAAKXZ @ 0x1800F82D0 (-Release@CSecondarySysmemBitmap@@UEAAKXZ.c)
 * Callees:
