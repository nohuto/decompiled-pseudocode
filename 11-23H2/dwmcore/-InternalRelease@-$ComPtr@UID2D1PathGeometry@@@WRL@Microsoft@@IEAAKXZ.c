/*
 * XREFs of ?InternalRelease@?$ComPtr@UID2D1PathGeometry@@@WRL@Microsoft@@IEAAKXZ @ 0x1800DBD80
 * Callers:
 ...
 *     ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBW4ShaderLinkingArgument@@UNode@CShaderLinkingGraphBuilder@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800B8000 (--1-$_List_node_emplace_op2@V-$allocator@U-$_List_node@U-$pair@$$CBW4ShaderLinkingArgument@@UNod.c)
 ...
 *     ?ReleaseD3DResources@CD3DConstantBuffer@@MEAAXXZ @ 0x1800F8240 (-ReleaseD3DResources@CD3DConstantBuffer@@MEAAXXZ.c)
 ...
 *     ??1CSharedDirect3DResources@CDrawListEntryBatch@@UEAA@XZ @ 0x1800FAB0C (--1CSharedDirect3DResources@CDrawListEntryBatch@@UEAA@XZ.c)
 ...
 *     _dynamic_atexit_destructor_for__CExpressionValueStack::s_emptyValue__ @ 0x180124290 (_dynamic_atexit_destructor_for__CExpressionValueStack--s_emptyValue__.c)
 ...
 *     ??$_Destroy_range@V?$allocator@V?$ComPtr@VCPathData@@@WRL@Microsoft@@@std@@@std@@YAXPEAV?$ComPtr@VCPathData@@@WRL@Microsoft@@QEAV123@AEAV?$allocator@V?$ComPtr@VCPathData@@@WRL@Microsoft@@@0@@Z @ 0x18023955C (--$_Destroy_range@V-$allocator@V-$ComPtr@VCPathData@@@WRL@Microsoft@@@std@@@std@@YAXPEAV-$ComPtr.c)
