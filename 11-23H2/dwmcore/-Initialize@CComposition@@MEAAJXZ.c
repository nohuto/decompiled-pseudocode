/*
 * XREFs of ?Initialize@CComposition@@MEAAJXZ @ 0x1800D1B80
 * Callers:
 ...
 *     ??0CInputManager@@IEAA@PEAVCComposition@@@Z @ 0x1800D221C (--0CInputManager@@IEAA@PEAVCComposition@@@Z.c)
...
LABEL_61:
    v39 = v19;
LABEL_75:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v4, 0LL, 0, v39, v40, 0LL);
