/*
 * XREFs of ?CopyFrom@CAtlasTexture@@QEAAXPEBV1@PEAI@Z @ 0x1800183A4
 * Callers:
 ...
 * Callees:
 *     ?IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x18001866C (-IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 *     ?IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x18001869C (-IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
