/*
 * XREFs of ?EnsureDevice@CDDisplayManager@@AEAAJAEBU_LUID@@PEAUIDisplayAdapter@Core@Display@Devices@Windows@@PEAPEAUIDisplayDevice@4567@@Z @ 0x180294564
 * Callers:
...
LABEL_9:
  ...
  v11 = *(__int64 (__fastcall **)(__int64, struct Windows::Devices::Display::Core::IDisplayAdapter *, struct Windows::Devices::Display::Core::IDisplayDevice **))(*g_DDisplayManager + 112LL);
