/*
 * XREFs of ?ExecuteBlur@CRenderingTechnique@@QEAAJPEAVCDrawingContext@@AEBUEffectInput@@AEBUD2D_VECTOR_2F@@PEAU3@@Z @ 0x1800B26D4
 * Callers:
 ...
 *     ?UpdateCachedBlur@CBlurredBackdropCache@@QEAAXPEAVCBackdropVisualImage@@AEBVRenderTargetInfo@@AEBUEffectInput@@@Z @ 0x1800A710C (-UpdateCachedBlur@CBlurredBackdropCache@@QEAAXPEAVCBackdropVisualImage@@AEBVRenderTargetInfo@@AE.c)
 ...
 *     ?DeterminePreScale@CBlurRenderingGraph@@SAXAEBUEffectInput@@0W4D2D1_GAUSSIANBLUR_OPTIMIZATION@@AEBUD2D_VECTOR_2F@@PEAU4@@Z @ 0x1800B2BE0 (-DeterminePreScale@CBlurRenderingGraph@@SAXAEBUEffectInput@@0W4D2D1_GAUSSIANBLUR_OPTIMIZATION@@A.c)
 ...
 *     ?HasMatchingParameters@CBlurRenderingGraph@@QEBA_NAEBUD2D_VECTOR_2F@@W4D2D1_GAUSSIANBLUR_OPTIMIZATION@@@Z @ 0x1800B3010 (-HasMatchingParameters@CBlurRenderingGraph@@QEBA_NAEBUD2D_VECTOR_2F@@W4D2D1_GAUSSIANBLUR_OPTIMIZ.c)
 *     ?LookupCachedBlur@CBlurredBackdropCache@@QEBA_NPEBVCBackdropVisualImage@@AEBVRenderTargetInfo@@PEAUEffectInput@@@Z @ 0x1800B3DC8 (-LookupCachedBlur@CBlurredBackdropCache@@QEBA_NPEBVCBackdropVisualImage@@AEBVRenderTargetInfo@@P.c)
        ...
        struct EffectInput *a5)
{
  ...
  FLOAT v12; // xmm1_4
  __int64 v13; // rdx
  struct CBackdropVisualImage ***v14; // rsi
  __int64 v15; // rcx
  ...
  char *v43; // [rsp+70h] [rbp-98h] BYREF
  struct D2D_RECT_F v44; // [rsp+78h] [rbp-90h] BYREF
  float v45[9]; // [rsp+90h] [rbp-78h] BYREF
  float v46[9]; // [rsp+B4h] [rbp-54h] BYREF
  float v47[10]; // [rsp+D8h] [rbp-30h] BYREF
  ...
  wil::com_ptr_t<CBlurRenderingGraph,wil::err_returncode_policy>::com_ptr_t<CBlurRenderingGraph,wil::err_returncode_policy>(
    &v36,
    v13);
  v14 = (struct CBackdropVisualImage ***)v36;
  if ( v36 )
  {
    if ( CBlurRenderingGraph::HasMatchingParameters(v36, &v37, v38[0]) )
    {
      if ( BackdropVisualImage )
      {
        ...
        if ( CBlurredBackdropCache::LookupCachedBlur((CBlurredBackdropCache *)(v14 + 27), BackdropVisualImage, v16, a5) )
        {
          v32 = (void **)DwmDbg::DbgString::DbgString(&v41, word_18033C470);
          v33 = (void **)DwmDbg::DbgString::DbgString((char **)&v39, "BVI-UsingCachedBlur");
          CBackdropVisualImage::LogEtwEvent((__int64)BackdropVisualImage, v33, v32);
          goto LABEL_17;
        }
        v17 = (void **)DwmDbg::DbgString::DbgString(&v43, word_18033C470);
        v18 = (void **)DwmDbg::DbgString::DbgString((char **)&v48, "BVI-CouldNotFindCachedBlur");
        CBackdropVisualImage::LogEtwEvent((__int64)BackdropVisualImage, v18, v17);
      }
      if ( v14 )
        goto LABEL_10;
    }
  ...
  v36 = 0LL;
  if ( v14 )
    ((void (__fastcall *)(struct CBackdropVisualImage ***))(*v14)[1])(v14);
  v30 = *((_QWORD *)a2 + 5);
...
LABEL_27:
  ...
  v14 = (struct CBackdropVisualImage ***)v36;
LABEL_10:
  *(struct CBackdropVisualImage ***)((char *)v14 + 1588) = (struct CBackdropVisualImage **)v39;
  v19 = CExternalEffectGraph::Render((CExternalEffectGraph *)v14, a2, a3, a5);
  if ( v19 < 0 )
  {
    v34 = 796LL;
    goto LABEL_27;
  }
  CDrawListBitmap::GetSize(a5, &v36);
  D2DMatrixHelper::ComputeRectangleTransform(
    (const struct EffectInput *)((char *)a3 + 84),
    (const struct D2D_RECT_F *)((char *)a5 + 84),
    &v44,
    v20);
  CDrawListBitmap::GetSize(a3, &v39);
  ...
  *((float *)&v49 + 1) = 0.0 - (float)((float)SLODWORD(v39.y) * 0.0);
  v21 = Matrix3x3::operator*((float *)a3 + 12, v45, (float *)&v48);
  v22 = Matrix3x3::operator*(v21, v46, &v44.left);
  *(_QWORD *)((char *)&v48 + 4) = 0LL;
  ...
  *((float *)&v49 + 1) = 0.0 - (float)(*((float *)&v48 + 3) * 0.0);
  v23 = Matrix3x3::operator*(v22, v47, (float *)&v48);
  *((_OWORD *)a5 + 3) = *(_OWORD *)v23;
  *((_OWORD *)a5 + 4) = *((_OWORD *)v23 + 1);
  *((float *)a5 + 20) = v23[8];
  if ( BackdropVisualImage )
  {
    ...
    if ( CCommonRegistryData::EnableBackdropBlurCaching )
    {
      if ( CBackdropVisualImage::TranslateRenderTargetInfo(BackdropVisualImage, (struct RenderTargetInfo *)&v48) )
      {
        CBlurredBackdropCache::UpdateCachedBlur(
          ...
          a5);
        v26 = (void **)DwmDbg::DbgString::DbgString((char **)&v48, word_18033C470);
        v27 = (void **)DwmDbg::DbgString::DbgString(&v43, "BVI-CachedNewBlur");
        CBackdropVisualImage::LogEtwEvent((__int64)BackdropVisualImage, v27, v26);
        ++dword_1803E5AAC;
      }
    }
  }
...
LABEL_17:
  wil::com_ptr_t<CExternalEffectGraph,wil::err_returncode_policy>::~com_ptr_t<CExternalEffectGraph,wil::err_returncode_policy>(&v36);
  return v5;
}
