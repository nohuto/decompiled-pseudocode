/*
 * XREFs of ??1CPropertySet@@UEAA@XZ @ 0x18007F404
 * Callers:
...
void __fastcall CPropertySet::~CPropertySet(CPropertySet *this)
{
  ...
  *(_QWORD *)this = &CPropertySet::`vftable';
  if ( v1 && (unsigned int)dword_1803E37D0 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1803E37D0, 1LL) )
  {
    v9 = 0;
    v7 = &v5;
    v5 = v4;
    v8 = 4;
    tlgWriteTransfer_EventWriteTransfer(v3, (int)&dword_180381C0D, 0, 0, 3u, &v6);
  }
