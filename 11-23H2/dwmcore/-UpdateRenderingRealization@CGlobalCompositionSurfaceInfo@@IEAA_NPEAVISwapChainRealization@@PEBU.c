/*
 * XREFs of ?UpdateRenderingRealization@CGlobalCompositionSurfaceInfo@@IEAA_NPEAVISwapChainRealization@@PEBUCSM_BUFFER_ATTRIBUTES@@PEAUHRGN__@@PEBUScrollOptimization@@@Z @ 0x180032038
 * Callers:
 ...
 *     ??9@YA_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x1800CFC78 (--9@YA_NAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@.c)
        ...
        const struct ScrollOptimization *a5)
{
  ...
  _BYTE v50[80]; // [rsp+C0h] [rbp-40h] BYREF
...
LABEL_9:
  ...
  if ( v19 )
  {
    ...
    (*(void (__fastcall **)(__int64, _BYTE *, __int128 *))(*(_QWORD *)v20 + 8LL))(v20, v50, &v51);
  ...
  if ( a2 )
  {
    ...
    (*(void (__fastcall **)(char *, _BYTE *, __int128 *))(*(_QWORD *)v29 + 8LL))(v29, v49, &v55);
  ...
  if ( (unsigned __int8)operator!=(&v51, &v55, v18)
    || !(unsigned __int8)CMILMatrix::IsEqualTo<0>(v50, v49)
