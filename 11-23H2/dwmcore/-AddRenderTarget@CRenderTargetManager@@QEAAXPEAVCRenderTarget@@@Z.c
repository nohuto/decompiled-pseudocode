/*
 * XREFs of ?AddRenderTarget@CRenderTargetManager@@QEAAXPEAVCRenderTarget@@@Z @ 0x1800C9554
 * Callers:
 *     ?CheckOcclusionState@CRenderTargetManager@@QEAAJXZ @ 0x180048800 (-CheckOcclusionState@CRenderTargetManager@@QEAAJXZ.c)
 *     ?Initialize@CRenderTarget@@MEAAJXZ @ 0x1800FB810 (-Initialize@CRenderTarget@@MEAAJXZ.c)
 ...
 *     ?Initialize@CCaptureRenderTarget@@MEAAJXZ @ 0x1801ED050 (-Initialize@CCaptureRenderTarget@@MEAAJXZ.c)
 ...
 *     ?NotifyOnChangeCompleted@CVisualCapture@@MEAAXXZ @ 0x180255BB0 (-NotifyOnChangeCompleted@CVisualCapture@@MEAAXXZ.c)
