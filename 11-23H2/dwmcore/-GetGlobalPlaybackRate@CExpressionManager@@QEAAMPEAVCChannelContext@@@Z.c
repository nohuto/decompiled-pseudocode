/*
 * XREFs of ?GetGlobalPlaybackRate@CExpressionManager@@QEAAMPEAVCChannelContext@@@Z @ 0x1800D0D94
 * Callers:
...
float __fastcall CExpressionManager::GetGlobalPlaybackRate(CExpressionManager *this, struct CChannelContext *a2)
{
  ...
  v3 = (char *)this + 464;
  appended = std::_Fnv1a_append_bytes((__int64)this, (const unsigned __int8 *const)&v8, 8uLL);
