/*
 * XREFs of ?Create@CColorKeyBitmap@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV1@@Z @ 0x1802B6640
 * Callers:
 ...
 *     ??0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z @ 0x1802B6120 (--0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z.c)
