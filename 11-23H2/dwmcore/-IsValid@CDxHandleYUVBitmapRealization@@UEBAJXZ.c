/*
 * XREFs of ?IsValid@CDxHandleYUVBitmapRealization@@UEBAJXZ @ 0x1802B4080
 * Callers:
 *     ?IsValid@CDxHandleYUVBitmapRealization@@$4PPPPPPPM@A@EBAJXZ @ 0x180122FF0 (-IsValid@CDxHandleYUVBitmapRealization@@$4PPPPPPPM@A@EBAJXZ.c)
 * Callees:
