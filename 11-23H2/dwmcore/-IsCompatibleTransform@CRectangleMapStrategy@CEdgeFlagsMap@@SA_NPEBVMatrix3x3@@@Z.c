/*
 * XREFs of ?IsCompatibleTransform@CRectangleMapStrategy@CEdgeFlagsMap@@SA_NPEBVMatrix3x3@@@Z @ 0x1801FF510
 * Callers:
 ...
 *     ?Is2DAffine@Matrix3x3@@QEBA_NXZ @ 0x180273050 (-Is2DAffine@Matrix3x3@@QEBA_NXZ.c)
 */
