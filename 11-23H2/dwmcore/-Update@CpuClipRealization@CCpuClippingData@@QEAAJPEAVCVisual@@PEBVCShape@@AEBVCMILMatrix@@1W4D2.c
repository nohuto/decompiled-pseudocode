/*
 * XREFs of ?Update@CpuClipRealization@CCpuClippingData@@QEAAJPEAVCVisual@@PEBVCShape@@AEBVCMILMatrix@@1W4D2D1_ANTIALIAS_MODE@@PEA_N@Z @ 0x180053BBC
 * Callers:
        ...
        bool *a7)
{
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(const struct CShape *))(v9 + 56))(a3) )
  {
    ...
    else
    {
      ...
      v36[8] = v27;
      v36[2] = v31;
      if ( !(unsigned __int8)Matrix3x3::Get2DScaleDimensionsWithPerspective(v36, &v35, &v34, &v38) )
      {
LABEL_25:
