/*
 * XREFs of ??$_Insert_range@PEAPEAVCAtlasedRectsMesh@@@?$vector@PEAVCAtlasedRectsMesh@@V?$allocator@PEAVCAtlasedRectsMesh@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCAtlasedRectsMesh@@@std@@@std@@@1@PEAPEAVCAtlasedRectsMesh@@1Uforward_iterator_tag@1@@Z @ 0x180023180
 * Callers:
...
void __fastcall std::vector<CAtlasedRectsMesh *>::_Insert_range<CAtlasedRectsMesh * *>(
        _QWORD *a1,
        _BYTE *a2,
        const void *a3,
        __int64 a4)
