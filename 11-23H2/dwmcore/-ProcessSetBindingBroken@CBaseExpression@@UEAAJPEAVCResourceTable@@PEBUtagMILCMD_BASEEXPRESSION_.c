/*
 * XREFs of ?ProcessSetBindingBroken@CBaseExpression@@UEAAJPEAVCResourceTable@@PEBUtagMILCMD_BASEEXPRESSION_SETBINDINGBROKEN@@@Z @ 0x1800D5E80
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagMILCMD_BASEEXPRESSION_SETBINDINGBROKEN *a3)
{
  ...
  if ( (*((_BYTE *)this + 216) & 2) != 0 )
  {
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x190u, 0LL);
      return v6;
    }
    CBaseExpression::EnsureExpressionIsUnregistered(this);
  }
  *((_BYTE *)this + 232) |= 1u;
  if ( (unsigned int)dword_1803E37D0 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1803E37D0, 4LL) )
  {
    v10 = *((_DWORD *)this + 16);
