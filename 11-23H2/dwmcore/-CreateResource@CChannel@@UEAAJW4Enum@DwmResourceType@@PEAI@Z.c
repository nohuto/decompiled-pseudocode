/*
 * XREFs of ?CreateResource@CChannel@@UEAAJW4Enum@DwmResourceType@@PEAI@Z @ 0x18002DAD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetFreeHandle@CChannel@@AEAAIXZ @ 0x18002DF2C (-GetFreeHandle@CChannel@@AEAAIXZ.c)
