/*
 * XREFs of ?ProcessUpdate@CCompiledEffectTemplate@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_COMPILEDEFFECTTEMPLATE@@@Z @ 0x1800DDF94
 * Callers:
 ...
 *     ?SignalCompileCompletedEvent@CCompiledEffectTemplate@@AEAAXXZ @ 0x1800E5630 (-SignalCompileCompletedEvent@CCompiledEffectTemplate@@AEAAXXZ.c)
...
LABEL_17:
  ...
  if ( CNotificationResource::ShouldNotify(v4) )
  {
    ...
    LODWORD(v19) = v12;
    v16 = CoreUICallSend(v13, v20, 2LL, 8LL, 1, &unk_18033C038, v19);
    v8 = v16;
    if ( v16 < 0 )
