/*
 * XREFs of ?NotifyPropertyValue@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1800C6D34
 * Callers:
...
__int64 __fastcall CPropertySet::NotifyPropertyValue(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( a3 == 18 )
  {
    ...
    v54 = 0;
    v49 = CoreUICallSend(v48, &v57, 2LL, 14LL, v54, &unk_18033C085, v56, *(_QWORD *)&v46);
    v10 = v49;
...
LABEL_33:
    ...
    v60 = v19;
    v53 = 7;
    v22 = CoreUICallSend(v21, &v57, 2LL, 14LL, v53, &unk_18033C0AB, v55, &v59);
    v10 = v22;
