/*
 * XREFs of ?SetProperty@CInteractionTracker@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180234AB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_29:
  ...
  {
    v20 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, -2147024809, 0x58Du, 0LL);
  }
  else
  {
    return 0;
