/*
 * XREFs of ?ProcessSetSourceVisual@CVisualSurface@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUALSURFACE_SETSOURCEVISUAL@@@Z @ 0x18009F438
 * Callers:
        ...
        const struct tagMILCMD_VISUALSURFACE_SETSOURCEVISUAL *a3)
{
  ...
  *((_QWORD *)this + 8) = Resource;
  ...
  else
  {
    ...
    wil::com_ptr_t<CVisualTree,wil::err_returncode_policy>::reset((char *)this + 72);
    VisualTree = CVisual::GetVisualTree(v9, (struct CVisualTree **)this + 9, 1);
    if ( VisualTree >= 0 )
    {
LABEL_7:
