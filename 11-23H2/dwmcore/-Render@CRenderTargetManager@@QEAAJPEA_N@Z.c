/*
 * XREFs of ?Render@CRenderTargetManager@@QEAAJPEA_N@Z @ 0x18004852C
 * Callers:
...
__int64 __fastcall CRenderTargetManager::Render(CRenderTargetManager *this, bool *a2)
{
  ...
  *((_BYTE *)this + 576) = 1;
  ...
  v2 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_180356700, 3u, v9, 0x68u, 0LL);
  ...
  for ( j = (__int64 *)*((_QWORD *)this + 1); j != v12; ++j )
  {
    ...
    v18 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180356700, 3u, v16, 0x70u, 0LL);
    if ( !v2 || v2 >= 0 && v18 < 0 )
      v2 = v18;
    if ( v24 )
      *v4 = 1;
