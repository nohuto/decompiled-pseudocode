/*
 * XREFs of ?PrepareForRemoteReference@BamoPrincipalImpl@BamoImpl@Microsoft@@QEAAIPEAVBaseBamoPeerImpl@23@@Z @ 0x1800D63BC
 * Callers:
        ...
        struct Microsoft::BamoImpl::BaseBamoPeerImpl *a2)
{
  ...
  if ( *((_QWORD *)a2 + 3) != *((_QWORD *)this + 2) )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x19D,
      (unsigned int)"g:\\os\\tools\\BamoCodegen\\Inc\\BamoPrincipal.inl",
