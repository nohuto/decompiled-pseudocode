/*
 * XREFs of ?RenderContent@CCursorVisual@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x180228710
 * Callers:
 *     <none>
 * Callees:
      ...
      while ( v12 != (__int64 *)v10 )
      {
        if ( *((_BYTE *)v12 + 32) )
        {
          if ( !v9 )
          {
            v24[0] = 4;
            v25 = 2;
            v13 = CDrawingContext::PushRenderOptionsInternal(a2, 0LL, (const struct MilRenderOptions *)v24, 1);
            v14 = v13;
            if ( v13 < 0 )
            {
              v20 = 149LL;
