/*
 * XREFs of ?IsBufferingOutput@CInteractionProcessor@@QEAA_NW4InputType@@@Z @ 0x1801AE7F4
 * Callers:
 *     ?IsBufferingOutput@CInteractionRoot@@UEAA_NW4InputType@@@Z @ 0x1801A4650 (-IsBufferingOutput@CInteractionRoot@@UEAA_NW4InputType@@@Z.c)
 *     ?IsBufferingOutput@CInteraction@@UEAA_NW4InputType@@@Z @ 0x18020BF00 (-IsBufferingOutput@CInteraction@@UEAA_NW4InputType@@@Z.c)
 * Callees:
