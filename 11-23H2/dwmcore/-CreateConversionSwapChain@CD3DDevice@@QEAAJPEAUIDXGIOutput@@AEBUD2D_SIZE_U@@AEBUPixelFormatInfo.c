/*
 * XREFs of ?CreateConversionSwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVILegacySwapChain@@@Z @ 0x18028F414
 * Callers:
...
LABEL_16:
    v15 = v12;
LABEL_26:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1803BA160, 3u, v15, v18, 0LL);
  }
