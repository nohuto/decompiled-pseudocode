/*
 * XREFs of ?IsValid@CCompositionSpotLight@@UEBA_NPEBVCVisualTree@@PEBVCVisual@@@Z @ 0x18000A410
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 )
  {
    ...
    while ( (*((_BYTE *)v6 + 103) & 1) != 0 && (*((_BYTE *)v6 + 102) & 2) == 0 )
    {
      if ( v6 == *((CVisual **)a2 + 8) )
      {
        ...
        if ( !TreeData )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, -2003292412, 0x6AEu, 0LL);
          return 0;
        }
        v17 = 0;
