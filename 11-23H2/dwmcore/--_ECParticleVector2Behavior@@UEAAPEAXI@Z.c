/*
 * XREFs of ??_ECParticleVector2Behavior@@UEAAPEAXI@Z @ 0x1801C31B0
 * Callers:
 *     ??_ECParticleVector2Behavior@@WHA@EAAPEAXI@Z @ 0x18011B9F0 (--_ECParticleVector2Behavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
