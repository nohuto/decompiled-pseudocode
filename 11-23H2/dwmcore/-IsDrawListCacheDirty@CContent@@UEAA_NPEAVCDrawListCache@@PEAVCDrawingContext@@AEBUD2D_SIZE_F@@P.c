/*
 * XREFs of ?IsDrawListCacheDirty@CContent@@UEAA_NPEAVCDrawListCache@@PEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEBVCMILMatrix@@@Z @ 0x180071040
 * Callers:
 ...
 *     ?IsDrawListCacheDirty@CProjectedShadow@@UEAA_NPEAVCDrawListCache@@PEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEBVCMILMatrix@@@Z @ 0x18024AC40 (-IsDrawListCacheDirty@CProjectedShadow@@UEAA_NPEAVCDrawListCache@@PEAVCDrawingContext@@AEBUD2D_S.c)
 * Callees:
      ...
      if ( *(_DWORD *)(a2 + 96) == (*((_DWORD *)a3 + 84) != 0) )
      {
        ...
        if ( (v7 & 0x800) == 0
          || (v23 = (CVisual *)(*(__int64 (__fastcall **)(char *))(*((_QWORD *)a3 + 3) + 32LL))((char *)a3 + 24),
              ...
              v25 = *(_QWORD *)(v6 + 32),
              v25 >= (unsigned __int64)TreeData[31])
          && ((*((_BYTE *)v23 + 272) & 2) == 0 || v25 >= *((_QWORD *)g_pComposition + 39)) )
        {
          ...
          if ( (*(_BYTE *)(v6 + 88) & 0x20) == 0 || CMILMatrix::Is2DAxisAlignedPreserving((CMILMatrix *)&v34) )
          {
            v7 = *(_DWORD *)(v6 + 88);
            if ( (v7 & 0x40) == 0
              || CMILMatrix::IsAffine<1>((__int64)&v34, 1)
              && (v20 = sqrtf_0(
...
LABEL_27:
                    ...
                    if ( a5 )
                    {
                      v8 = (const struct D2D_MATRIX_3X2_F *)v46;
                      v29 = *((_DWORD *)a5 + 1);
                      v46[0] = *(_DWORD *)a5;
                      v30 = *((_DWORD *)a5 + 4);
                      v46[1] = v29;
                    ...
                    v45 = *(_OWORD *)(v6 + 64);
                    if ( CCpuClip::FullyContains((CShape **)&v34, (struct MilRectF *)&v45, v8) )
                    {
                      v22 = v40;
                      goto LABEL_27;
                    }
