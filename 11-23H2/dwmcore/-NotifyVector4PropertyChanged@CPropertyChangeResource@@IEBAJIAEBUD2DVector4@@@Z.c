/*
 * XREFs of ?NotifyVector4PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DVector4@@@Z @ 0x18001F9CC
 * Callers:
        ...
        const struct D2DVector4 *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, a2) )
  {
    ...
    v15[1] = v8;
    v16 = v12;
    v13 = CoreUICallSend(v10, v15, 2LL, 14LL, 4, &unk_18033C099, v6, &v16);
    v4 = v13;
    if ( v13 == -2018375675 )
    {
      return 0;
