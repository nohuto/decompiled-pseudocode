/*
 * XREFs of ?SendPropertyChanged@DiagnosticCallbacksManager@@QEAAJII_KIGAEBVCExpressionValue@@@Z @ 0x1801BAA6C
 * Callers:
 ...
 *     ?GetValueSizeInBytes@CExpressionValue@@QEBA_KXZ @ 0x180217134 (-GetValueSizeInBytes@CExpressionValue@@QEBA_KXZ.c)
 */
