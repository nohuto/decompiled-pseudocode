/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIBitmapResource@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18026AB68
 * Callers:
 *     ?QueryInterface@CAtlasBitmapResource@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18026AC04 (-QueryInterface@CAtlasBitmapResource@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
