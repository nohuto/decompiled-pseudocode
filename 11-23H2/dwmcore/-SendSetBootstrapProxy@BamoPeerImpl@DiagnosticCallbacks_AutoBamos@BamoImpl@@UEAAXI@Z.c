/*
 * XREFs of ?SendSetBootstrapProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x1801BAC50
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v4 = CoreUICallSend(v3, v7, 2LL, 1LL, 8, &unk_18035673A, v6);
  if ( v4 < 0 )
