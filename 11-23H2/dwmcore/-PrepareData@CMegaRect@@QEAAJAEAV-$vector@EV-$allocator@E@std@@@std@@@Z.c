/*
 * XREFs of ?PrepareData@CMegaRect@@QEAAJAEAV?$vector@EV?$allocator@E@std@@@std@@@Z @ 0x180034ABC
 * Callers:
 ...
 *     IsValidAxisAlignedRect @ 0x1800349C8 (IsValidAxisAlignedRect.c)
 ...
 *     VerticesHaveIntegralXY @ 0x18006ED04 (VerticesHaveIntegralXY.c)
...
__int64 __fastcall CMegaRect::PrepareData(__int64 a1, unsigned __int64 *a2)
{
  ...
  v4 = 0;
  Primitive = (unsigned int)CMegaRectBatchCommand::GetPrimitive(*(CMegaRectBatchCommand **)a1);
  v7 = (char *)v6[1];
  v8 = Primitive;
  v9 = *v6;
  v10 = &v7[-v9];
...
LABEL_27:
  ...
  TransferVertices<Vertex_UVxN<VertexXYW_ColorDW>>(v8, *(_DWORD *)a1 + 16, v16, v17, (__int64)&v46);
  v46.m128_u64[0] = v13;
  v46.m128_u64[1] = v11 | 0x400000000LL;
