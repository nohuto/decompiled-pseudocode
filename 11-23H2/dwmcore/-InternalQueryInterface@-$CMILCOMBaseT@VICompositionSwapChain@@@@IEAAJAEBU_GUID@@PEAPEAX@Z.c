/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VICompositionSwapChain@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18029E2CC
 * Callers:
 *     ?QueryInterface@CCompSwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18029E7A4 (-QueryInterface@CCompSwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<ICompositionSwapChain>::InternalQueryInterface(_QWORD *a1, _QWORD *a2, __int64 *a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      v5 = (*(__int64 (__fastcall **)(_QWORD *))(*a1 + 96LL))(a1);
      if ( v5 < 0 )
      {
        *a3 = 0LL;
