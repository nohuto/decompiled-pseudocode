/*
 * XREFs of ?Render@CRemoteRenderTarget@@UEAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x18010A1FC
 * Callers:
 *     ?Render@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x18011CE90 (-Render@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 * Callees:
 ...
 *     ?IsPrimaryMonitor@CRemoteRenderTarget@@UEBA_NXZ @ 0x18010A4F0 (-IsPrimaryMonitor@CRemoteRenderTarget@@UEBA_NXZ.c)
...
LABEL_18:
  ...
  while ( 1 )
  {
    ...
    v41 = v40;
    v24 = CDrawingContext::DrawVisualTree(a2, v23, (__int64)&v41, v38, v37, 0, 0LL);
    v4 = v24;
    if ( v24 < 0 )
      break;
