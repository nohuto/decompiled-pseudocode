/*
 * XREFs of _anonymous_namespace_::SynthesizeDescription @ 0x180033F0C
 * Callers:
...
__int64 __fastcall anonymous_namespace_::SynthesizeDescription(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  ExpressionTypeString = anonymous_namespace_::GetExpressionTypeString(
                           ...
                           *(unsigned int *)(a2 + 192));
  v10 = v5;
  v7 = swprintf_s(Buffer, 0x64uLL, L"%s::%s::%d", off_1802CDB20[*(unsigned int *)(v6 + 212)], ExpressionTypeString, v10);
