/*
 * XREFs of ?GetGroup@CSyncLockGroup@@SAPEAV1@I@Z @ 0x1801E645C
 * Callers:
 *     ?CheckForceParallelMode@CLegacyRenderTarget@@AEAAXXZ @ 0x1800FD860 (-CheckForceParallelMode@CLegacyRenderTarget@@AEAAXXZ.c)
