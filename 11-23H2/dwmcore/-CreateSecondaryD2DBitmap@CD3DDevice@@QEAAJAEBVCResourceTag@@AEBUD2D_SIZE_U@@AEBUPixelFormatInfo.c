/*
 * XREFs of ?CreateSecondaryD2DBitmap@CD3DDevice@@QEAAJAEBVCResourceTag@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x1800E72EC
 * Callers:
 ...
 *     ?GetCompatibleTextureFormat@CD3DDevice@@QEBA?AW4DXGI_FORMAT@@W42@@Z @ 0x1800E7488 (-GetCompatibleTextureFormat@CD3DDevice@@QEBA-AW4DXGI_FORMAT@@W42@@Z.c)
...
LABEL_16:
    v23 = v19;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802EE308, 2u, v23, v24, 0LL);
  }
