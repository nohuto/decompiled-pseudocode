/*
 * XREFs of ?PostPresent@CComposition@@QEAAJ_N@Z @ 0x18004B780
 * Callers:
 ...
 *     ?MustUpdateExpressions@CExpressionManager@@QEBA_NXZ @ 0x18004B090 (-MustUpdateExpressions@CExpressionManager@@QEBA_NXZ.c)
        ...
        do
        {
          ...
          if ( v8 )
          {
            ...
            if ( v9 || v8[21] )
            {
              ...
              dword_1803E5AA0 += v8[23];
              dword_1803E5AA4 += v8[21];
              v8[23] = 0;
              v8[21] = 0;
            }
          }
