/*
 * XREFs of ?PreSubgraph@CHitTestContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x1800AB170
 * Callers:
 ...
 *     ?GetPointInLocalSpace@CHitTestContext@@SA_NAEBUD2D_POINT_2F@@AEBVCMILMatrix@@PEAU2@@Z @ 0x1800DB358 (-GetPointInLocalSpace@CHitTestContext@@SA_NAEBUD2D_POINT_2F@@AEBVCMILMatrix@@PEAU2@@Z.c)
...
LABEL_4:
  ...
  *a3 = 1;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0xFFFFFFFFLL, 0LL, 0, -2147024362, 0x64u, 0LL);
    v3 = v112;
  }
  else
  {
...
LABEL_8:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0xFFFFFFFFLL, 0LL, 0, -2147024362, 0x6Du, 0LL);
    }
    v15 = (void *)v111;
    v3 = v112;
  }
...
LABEL_21:
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(const struct CVisualTree *))(*(_QWORD *)a2 + 184LL))(a2) )
  {
    ...
    if ( TreeData )
    {
      if ( TreeData[32] == *(__int64 **)(TreeData[33][2] + 496) )
        goto LABEL_85;
    }
  }
  v19 = (_DWORD *)*v18;
...
LABEL_34:
  ...
  {
    v92 = (__int64 *)CVisual::GetTreeDataListHead((CVisual *)v5);
    if ( !v92 )
      goto LABEL_198;
    v24 = *v92;
    if ( (__int64 *)*v92 == v92 )
...
LABEL_198:
    v10 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, -2003292412, 0x6AEu, 0LL);
  ...
  if ( (*(_DWORD *)*v18 & 0x1000000) != 0 )
  {
    ...
    v73 = *v72;
    if ( v73 )
      v26 = (__int64 **)(*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*v73 + 184LL))(*v73);
  }
  ...
  if ( v28 && *(_QWORD *)(v28 + 256) != *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v28 + 264) + 16LL) + 496LL) && v26 )
  {
    v26 = CVisual::FindTreeData((CVisual *)v26, a2);
    LOBYTE(v23) = 1;
    goto LABEL_49;
  }
LABEL_46:
...
LABEL_88:
  v30 = 0LL;
  if ( g_pComposition )
    v30 = (__int64 *)*((_QWORD *)g_pComposition + 62);
LABEL_51:
  if ( *(_QWORD *)(v25 + 248) < (unsigned __int64)v30 )
    CVisual::UpdateWorldTransform((CVisual *)v5, a2, (struct CTreeData *)v25, v23, (const struct CTreeData *)v26);
  if ( !*(_QWORD *)(v25 + 248) )
    ModuleFailFastForHRESULT(2291674884LL, retaddr);
  v31 = v111;
  v32 = *(_DWORD *)(v25 + 352);
  v117[0] = *(_OWORD *)(v25 + 288);
  v118 = v32;
  v33 = *(_OWORD *)(v25 + 320);
  v117[1] = *(_OWORD *)(v25 + 304);
  v117[2] = v33;
  v117[3] = *(_OWORD *)(v25 + 336);
  if ( v111 )
  {
    v60 = *(_QWORD *)(v25 + 272);
    if ( v60 )
    {
      v61 = *(_OWORD *)(v60 + 16);
      *(_OWORD *)*(_QWORD *)&v111 = *(_OWORD *)v60;
      v62 = *(_OWORD *)(v60 + 32);
      *(_OWORD *)(*(_QWORD *)&v31 + 16LL) = v61;
      v63 = *(_OWORD *)(v60 + 48);
      v64 = *(_DWORD *)(v60 + 64);
    }
    else
    {
      v64 = *(_DWORD *)(v25 + 352);
      v69 = *(_OWORD *)(v25 + 304);
      *(_OWORD *)*(_QWORD *)&v111 = *(_OWORD *)(v25 + 288);
      v62 = *(_OWORD *)(v25 + 320);
      *(_OWORD *)(*(_QWORD *)&v31 + 16LL) = v69;
      v63 = *(_OWORD *)(v25 + 336);
    }
    *(_OWORD *)(*(_QWORD *)&v31 + 32LL) = v62;
    *(_OWORD *)(*(_QWORD *)&v31 + 48LL) = v63;
  ...
  if ( v5 != *((_QWORD *)a2 + 8) )
  {
    ...
    {
      v98 = (__int64 *)CVisual::GetTreeDataListHead((CVisual *)v34);
      if ( !v98 )
        goto LABEL_215;
      v38 = *v98;
      if ( (__int64 *)*v98 == v98 )
      ...
      while ( 1 )
      {
        v39 = (struct CTreeData *)(v38 - 360);
        if ( *(const struct CVisualTree **)(v38 + 32) == a2 )
          break;
        v38 = *(_QWORD *)v38;
        if ( (__int64 *)v38 == v98 )
          goto LABEL_215;
    ...
    if ( v39 )
    {
      ...
      if ( (*v40 & 0x1000000) != 0 )
      {
        ...
        v77 = *v76;
        if ( v77 )
          v35 = (__int64 **)(*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*v77 + 184LL))(*v77);
      }
      ...
      {
        v35 = CVisual::FindTreeData((CVisual *)v35, a2);
        LOBYTE(v37) = 1;
        goto LABEL_69;
      }
LABEL_66:
...
LABEL_69:
      if ( v35 )
      {
        v42 = v35[31];
LABEL_71:
        if ( *((_QWORD *)v39 + 31) < (unsigned __int64)v42 )
          CVisual::UpdateWorldTransform((CVisual *)v34, a2, v39, v37, (const struct CTreeData *)v35);
        CTreeData::GetWorldTransform(v39, (struct CMILMatrix *)v121, &v109, 0LL);
        v10 = 0;
        CMILMatrix::Transform3DBoundsHelper<1>((CMILMatrix *)v121, (float *)&v123, (float *)&v123);
        goto LABEL_74;
      }
LABEL_90:
      v42 = 0LL;
      if ( g_pComposition )
        v42 = (__int64 *)*((_QWORD *)g_pComposition + 62);
      goto LABEL_71;
    }
LABEL_215:
    v10 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v38, 0LL, 0, -2003292412, 0x6AEu, 0LL);
...
LABEL_83:
  ...
  if ( CVisual::HasBspPolygonList((CVisual *)v5) && (*(_BYTE *)(v5 + 101) & 1) != 0 )
  {
    v120 = 0;
    v109 = 0;
    CVisual::CalcTransform((CVisual *)v5, (CVisual **)a2, 0LL, &v109, (struct CMILMatrix *)v119, 0LL);
