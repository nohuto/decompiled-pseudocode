/*
 * XREFs of ?GetUnOccludedWorldShape@CRectanglesShape@@UEBAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBVCMILMatrix@@PEAPEAVCShape@@@Z @ 0x1800ACEB0
 * Callers:
 *     <none>
 * Callees:
        ...
        CRectanglesShape **a4)
{
  ...
  *a4 = 0LL;
    ...
    for ( i = v10; v12 < *(_DWORD *)(a1 + 40); ++v12 )
    {
      ...
      else
      {
        ...
        if ( v20 < 0 )
        {
          ...
          CRectanglesShape::`scalar deleting destructor'(v11, 1);
          return v4;
        }
  ...
  {
    v4 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v8, 0LL, 0, -2147024882, 0xB5u, 0LL);
  }
  return v4;
}
