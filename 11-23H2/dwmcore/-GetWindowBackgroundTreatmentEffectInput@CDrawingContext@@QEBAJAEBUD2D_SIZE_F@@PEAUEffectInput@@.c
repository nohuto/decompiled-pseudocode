/*
 * XREFs of ?GetWindowBackgroundTreatmentEffectInput@CDrawingContext@@QEBAJAEBUD2D_SIZE_F@@PEAUEffectInput@@@Z @ 0x18000A984
 * Callers:
 ...
 * Callees:
 *     ?GetParentTreeData@CVisual@@AEBAPEBVCTreeData@@PEBVCVisualTree@@PEAV2@PEA_N@Z @ 0x18000B0DC (-GetParentTreeData@CVisual@@AEBAPEBVCTreeData@@PEBVCVisualTree@@PEAV2@PEA_N@Z.c)
 ...
 *     ?GetRealizationForEffectInput@CWindowBackgroundTreatment@@QEBAPEAVIBitmapRealization@@XZ @ 0x18000B1A8 (-GetRealizationForEffectInput@CWindowBackgroundTreatment@@QEBAPEAVIBitmapRealization@@XZ.c)
...
LABEL_33:
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)v56 + 1007) + 184LL))(*((_QWORD *)v56 + 1007)) && !v36 )
  {
    ...
    if ( v55 )
    {
      ...
      if ( v39 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v40, 0LL, 0, v39, 0x7E6u, 0LL);
        return v4;
      }
    }
    else
    {
      ...
      if ( v44 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v45, 0LL, 0, v44, 0x7EFu, 0LL);
        return v4;
      }
...
LABEL_52:
  ...
  v4 = v52;
  if ( v52 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v53, 0LL, 0, v52, 0x806u, 0LL);
  else
