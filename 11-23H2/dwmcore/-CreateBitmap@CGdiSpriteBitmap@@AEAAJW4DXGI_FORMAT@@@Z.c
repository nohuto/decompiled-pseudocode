/*
 * XREFs of ?CreateBitmap@CGdiSpriteBitmap@@AEAAJW4DXGI_FORMAT@@@Z @ 0x180027CCC
 * Callers:
 ...
 *     ?RegisterWithSurfaceManager@CGdiSpriteBitmap@@AEAAJXZ @ 0x180027A38 (-RegisterWithSurfaceManager@CGdiSpriteBitmap@@AEAAJXZ.c)
 *     ?GetSurfaceData@CRedirectedGDISurface@@QEAAJPEAW4_RedirectGDISurfaceRedirStyle@@PEAI11PEAPEAXPEAU_LUID@@2PEAW4DXGI_FORMAT@@@Z @ 0x180027DF4 (-GetSurfaceData@CRedirectedGDISurface@@QEAAJPEAW4_RedirectGDISurfaceRedirStyle@@PEAI11PEAPEAXPEA.c)
 *     ?RegisterForSignaling@CGdiSpriteBitmap@@AEAAJXZ @ 0x180027EE8 (-RegisterForSignaling@CGdiSpriteBitmap@@AEAAJXZ.c)
 *     ?UpdatePixelFormat@CGdiSpriteBitmap@@AEAAXW4DXGI_FORMAT@@@Z @ 0x180027FE0 (-UpdatePixelFormat@CGdiSpriteBitmap@@AEAAXW4DXGI_FORMAT@@@Z.c)
 *     ?ReleaseBitmapResources@CGdiSpriteBitmap@@AEAAXXZ @ 0x180028394 (-ReleaseBitmapResources@CGdiSpriteBitmap@@AEAAXXZ.c)
 *     ?OnMarginsChanged@CGdiSpriteBitmap@@QEAAXXZ @ 0x180028538 (-OnMarginsChanged@CGdiSpriteBitmap@@QEAAXXZ.c)
 *     ?UnRegisterWithSurfaceManager@CGdiSpriteBitmap@@AEAAXXZ @ 0x1800936A4 (-UnRegisterWithSurfaceManager@CGdiSpriteBitmap@@AEAAXXZ.c)
