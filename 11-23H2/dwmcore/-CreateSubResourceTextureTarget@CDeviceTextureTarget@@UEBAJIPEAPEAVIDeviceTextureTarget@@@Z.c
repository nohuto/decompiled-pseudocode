/*
 * XREFs of ?CreateSubResourceTextureTarget@CDeviceTextureTarget@@UEBAJIPEAPEAVIDeviceTextureTarget@@@Z @ 0x18029F680
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDeviceTextureTarget **a3)
{
  ...
  *a3 = 0LL;
  ...
  v10 = (volatile signed __int32 *)DefaultHeap::Alloc(0x1A8uLL);
  if ( v10 )
    v10 = (volatile signed __int32 *)CDeviceTextureTarget::CDeviceTextureTarget(
                                       (__int64)v10,
                                       *((_QWORD *)this - 28),
                                       *((_QWORD *)this - 16),
                                       (__int64)this - 96,
                                       ...
                                       *((_BYTE *)this + 33),
                                       a2);
  wil::com_ptr_t<CDeviceTextureTarget,wil::err_returncode_policy>::operator=((volatile signed __int32 **)&v16, v10);
  v3 = v16;
  if ( !v16 )
  {
    v9 = -2147024882;
