/*
 * XREFs of _anonymous_namespace_::SendFramesReport @ 0x18010BBC0
 * Callers:
 ...
 *     ??E?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@std@@@std@@U_Iterator_base0@2@@std@@QEAAAEAV01@XZ @ 0x18010DBD0 (--E-$_Tree_unchecked_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@V-$basic_string@GU-$char_.c)
 ...
 *     _anonymous_namespace_::QpcToFileTimeAndGetCurrentFileTime @ 0x18010E370 (_anonymous_namespace_--QpcToFileTimeAndGetCurrentFileTime.c)
