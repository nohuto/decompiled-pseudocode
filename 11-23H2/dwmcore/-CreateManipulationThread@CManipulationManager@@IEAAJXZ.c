/*
 * XREFs of ?CreateManipulationThread@CManipulationManager@@IEAAJXZ @ 0x1800D175C
 * Callers:
...
LABEL_8:
    v6 = v3;
LABEL_10:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_180356620, 3u, v6, dwCreationFlags, 0LL);
    return v3;
  }
