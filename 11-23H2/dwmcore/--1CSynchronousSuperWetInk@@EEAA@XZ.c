/*
 * XREFs of ??1CSynchronousSuperWetInk@@EEAA@XZ @ 0x180252D98
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_1867205945@@@details@wil@@QEAA_NXZ @ 0x18011A498 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_1867205945@@@details@wil@@QEAA_NX.c)
...
void __fastcall CSynchronousSuperWetInk::~CSynchronousSuperWetInk(CSynchronousSuperWetInk *this)
{
  ...
  *(_DWORD *)((char *)this + v3 + 60) = v3 - 248;
  if ( wil::details::FeatureImpl<__WilFeatureTraits_Feature_1867205945>::__private_IsEnabled(`wil::Feature<__WilFeatureTraits_Feature_1867205945>::GetImpl'::`2'::impl)
