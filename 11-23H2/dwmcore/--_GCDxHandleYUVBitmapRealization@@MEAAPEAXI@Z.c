/*
 * XREFs of ??_GCDxHandleYUVBitmapRealization@@MEAAPEAXI@Z @ 0x1802B3610
 * Callers:
 *     ??_ECDxHandleYUVBitmapRealization@@OBEA@EAAPEAXI@Z @ 0x180122B70 (--_ECDxHandleYUVBitmapRealization@@OBEA@EAAPEAXI@Z.c)
 * Callees:
