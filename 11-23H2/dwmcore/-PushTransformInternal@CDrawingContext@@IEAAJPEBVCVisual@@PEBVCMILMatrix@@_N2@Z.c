/*
 * XREFs of ?PushTransformInternal@CDrawingContext@@IEAAJPEBVCVisual@@PEBVCMILMatrix@@_N2@Z @ 0x18008F1C0
 * Callers:
...
LABEL_28:
      ...
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v23, 0xD2Fu, 0LL);
LABEL_87:
        if ( *v15 )
          --*v15;
        goto LABEL_89;
...
LABEL_36:
      ...
      if ( v23 >= 0 )
        return (unsigned int)v23;
      MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0, v23, 0xD35u, 0LL);
      CWatermarkStack<bool,64,2,10>::Pop((char *)this + 432);
      goto LABEL_87;
    }
    MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x36u, 0LL);
LABEL_78:
    MilInstrumentationCheckHR_MaybeFailFast(v72, 0LL, 0, v19, 0xD2Bu, 0LL);
LABEL_89:
    if ( v5 )
...
LABEL_6:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v12, 0xD26u, 0LL);
