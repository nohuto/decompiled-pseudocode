/*
 * XREFs of ?Add@?$CMergedRectBase@$03@@UEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180034F00
 * Callers:
 ...
 *     ?SwapExisting@?$CMergedRectBase@$03@@IEAAXII@Z @ 0x1800C5A48 (-SwapExisting@-$CMergedRectBase@$03@@IEAAXII@Z.c)
...
void __fastcall CMergedRectBase<4>::Add(__int64 a1, float *a2)
{
  ...
  _BYTE *v29; // rax
  _OWORD v30[2]; // [rsp+20h] [rbp-28h] BYREF
