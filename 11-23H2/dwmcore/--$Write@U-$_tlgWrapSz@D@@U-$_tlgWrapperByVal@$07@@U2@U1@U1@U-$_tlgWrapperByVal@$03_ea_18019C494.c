        ...
        const char **a19)
{
  ...
  const char *v65; // [rsp+130h] [rbp+30h]
  ...
  v35 = v31;
  v36 = 0;
  return tlgWriteTransfer_EventWriteTransfer(a1, a2, 0LL, 0LL, 0x11u, &v33);
}
