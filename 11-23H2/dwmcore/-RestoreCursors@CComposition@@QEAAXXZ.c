/*
 * XREFs of ?RestoreCursors@CComposition@@QEAAXXZ @ 0x180021DCC
 * Callers:
 *     ?RenderForCapture@CaptureBitsResponse@@IEAAJXZ @ 0x180020A74 (-RenderForCapture@CaptureBitsResponse@@IEAAJXZ.c)
 *     ?RestoreVisuals@COffScreenRenderTarget@@MEAAXXZ @ 0x180130C00 (-RestoreVisuals@COffScreenRenderTarget@@MEAAXXZ.c)
 ...
 *     ?RestoreVisuals@CMagnifierRenderTarget@@MEAAXXZ @ 0x1801F06F0 (-RestoreVisuals@CMagnifierRenderTarget@@MEAAXXZ.c)
 * Callees:
