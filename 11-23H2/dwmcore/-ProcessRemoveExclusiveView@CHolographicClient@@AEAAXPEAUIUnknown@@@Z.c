/*
 * XREFs of ?ProcessRemoveExclusiveView@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x1802AD970
 * Callers:
 ...
 *     ?UninitializeResources@CHolographicClient@@AEAAXXZ @ 0x1802AE0CC (-UninitializeResources@CHolographicClient@@AEAAXXZ.c)
 * Callees:
 ...
 *     ?Remove@?$DynArray@PEAVCHolographicExclusiveView@@$0A@@@QEAAHAEBQEAVCHolographicExclusiveView@@@Z @ 0x1802A586C (-Remove@-$DynArray@PEAVCHolographicExclusiveView@@$0A@@@QEAAHAEBQEAVCHolographicExclusiveView@@@.c)
