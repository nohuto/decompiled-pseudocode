/*
 * XREFs of ?RegisterForSignaling@CGdiSpriteBitmap@@AEAAJXZ @ 0x180027EE8
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::RegisterForSignaling(CGdiSpriteBitmap *this)
{
  ...
  if ( !*((_QWORD *)this + 44) )
  {
    ...
    if ( v2 >= 0 )
      v2 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180358AE0, 2u, v2, 0xFAu, 0LL);
    v12 = 775;
LABEL_17:
    v13 = v2;
    MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_180356BE8, 2u, v2, v12, 0LL);
    goto LABEL_5;
  }
  SetLastError(0);
  if ( !(unsigned int)DwmHLSurfSetSignalOnDirty(*(_QWORD *)(v4 + 24), 0LL, qword_1803EA298, 1LL) )
  {
    ...
    if ( v2 >= 0 )
      v2 = -2003304445;
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180358AE0, 2u, v2, 0xE9u, 0LL);
    v12 = 779;
    goto LABEL_17;
  }
  v1 = 1;
