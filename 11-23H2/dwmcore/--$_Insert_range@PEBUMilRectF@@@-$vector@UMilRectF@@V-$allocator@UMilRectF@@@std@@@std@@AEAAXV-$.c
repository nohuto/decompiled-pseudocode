/*
 * XREFs of ??$_Insert_range@PEBUMilRectF@@@?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UMilRectF@@@std@@@std@@@1@PEBUMilRectF@@1Uforward_iterator_tag@1@@Z @ 0x1800E0338
 * Callers:
