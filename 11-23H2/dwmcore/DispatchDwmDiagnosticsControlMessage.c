/*
 * XREFs of DispatchDwmDiagnosticsControlMessage @ 0x180273194
 * Callers:
 *     McGenControlCallbackV2 @ 0x18001A0F0 (McGenControlCallbackV2.c)
 * Callees:
 *     ModuleFailFastForHRESULT @ 0x18026F868 (ModuleFailFastForHRESULT.c)
 *     ?HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z @ 0x180273254 (-HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z.c)
 */
