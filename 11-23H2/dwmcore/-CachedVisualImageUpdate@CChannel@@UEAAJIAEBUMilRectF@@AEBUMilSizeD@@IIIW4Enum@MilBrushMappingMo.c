/*
 * XREFs of ?CachedVisualImageUpdate@CChannel@@UEAAJIAEBUMilRectF@@AEBUMilSizeD@@IIIW4Enum@MilBrushMappingMode@@W44MilStretch@@@Z @ 0x18002AB30
 * Callers:
 *     <none>
 * Callees:
        ...
        int a9)
{
  ...
  if ( a5 )
    CChannel::CheckHandle(a1, a5, 140LL);
  if ( a6 )
    CChannel::CheckHandle(a1, a6, 172LL);
  if ( a7 )
    CChannel::CheckHandle(a1, a7, 196LL);
  v18 = 29;
