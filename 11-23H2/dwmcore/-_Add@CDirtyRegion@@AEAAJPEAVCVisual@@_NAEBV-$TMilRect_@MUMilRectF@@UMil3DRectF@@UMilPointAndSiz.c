/*
 * XREFs of ?_Add@CDirtyRegion@@AEAAJPEAVCVisual@@_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180062F30
 * Callers:
 ...
 *     ?CalcDirtyRegionCachedData@CDirtyRegion@@AEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUDirtyRegionCachedData@1@@Z @ 0x180080434 (-CalcDirtyRegionCachedData@CDirtyRegion@@AEAAXAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPoint.c)
 *     ?Merge@CDirtyRegion@@AEAAXII@Z @ 0x1800804A4 (-Merge@CDirtyRegion@@AEAAXII@Z.c)
 ...
 *     ?UpdateAcceleration@CDirtyRegion@@AEAAXI@Z @ 0x18008064C (-UpdateAcceleration@CDirtyRegion@@AEAAXI@Z.c)
  ...
  if ( !*((_BYTE *)this + 4420) )
  {
    ...
    if ( v13 > v9 && v14 > v11 )
    {
      ...
      if ( a2 )
      {
        ...
        if ( v17 == 32 )
        {
          v128 = DefaultHeap::Alloc(0x610uLL);
          v19 = v128;
          if ( !v128 )
          {
            v134 = -2147024882;
...
LABEL_99:
          ...
          else
          {
            ...
            *((__m128 *)this + v38 + 98) = v16;
            CDirtyRegion::CalcDirtyRegionCachedData(v120, &X, (char *)this + 16 * v38 + 1952);
