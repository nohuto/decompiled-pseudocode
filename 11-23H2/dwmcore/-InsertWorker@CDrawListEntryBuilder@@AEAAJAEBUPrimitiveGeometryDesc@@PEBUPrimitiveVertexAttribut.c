/*
 * XREFs of ?InsertWorker@CDrawListEntryBuilder@@AEAAJAEBUPrimitiveGeometryDesc@@PEBUPrimitiveVertexAttributesDesc@@@Z @ 0x180055474
 * Callers:
...
LABEL_2:
  ...
  if ( !*((_BYTE *)this + 4474) )
    goto LABEL_36;
  v11 = *((_QWORD *)this + 2);
  if ( !*(_QWORD *)v11 && !*(_QWORD *)(v11 + 80) )
    goto LABEL_36;
  v12 = (const struct D2D_MATRIX_3X2_F *)((char *)this + 56);
  if ( !*((_BYTE *)this + 4473) )
    v12 = 0LL;
  v29 = *(_OWORD *)a2;
  if ( !CCpuClip::FullyContains((CShape **)v11, (struct MilRectF *)&v29, v12) )
  {
    v32 = v35;
    v33 = v35;
    v34 = &v36;
