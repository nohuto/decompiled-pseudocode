/*
 * XREFs of ?AllocateGradientStrip@CAtlasManager@@QEAAJPEAVCAtlasEntry@@@Z @ 0x1800A5744
 * Callers:
 ...
 *     ?DetermineIdealAtlasSize@CAtlasManager@@CAII@Z @ 0x1800F36E4 (-DetermineIdealAtlasSize@CAtlasManager@@CAII@Z.c)
