/*
 * XREFs of ?GetBrushParameters@CRadialGradientBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x18024D5B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetCommonShaderConstants@CRadialGradientEffect@@QEAAXMM@Z @ 0x1802B942C (-SetCommonShaderConstants@CRadialGradientEffect@@QEAAXMM@Z.c)
 *     ?SetNonCenteredShaderConstants@CRadialGradientEffect@@QEAAXAEBUD2D_POINT_2F@@MM@Z @ 0x1802B945C (-SetNonCenteredShaderConstants@CRadialGradientEffect@@QEAAXAEBUD2D_POINT_2F@@MM@Z.c)
 */
        ...
        struct CBrushDrawListGenerator *a2)
{
  ...
  if ( CurrentSurface < 0 )
  {
    v32 = 122;
LABEL_22:
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1803B8878, 2u, CurrentSurface, v32, 0LL);
    goto LABEL_23;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v28, &dword_1803B8878, 2u, v6, 0xBBu, 0LL);
LABEL_23:
    CBrushDrawListGenerator::Reset(a2);
    goto LABEL_24;
  }
