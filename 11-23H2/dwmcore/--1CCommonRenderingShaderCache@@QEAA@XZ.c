/*
 * XREFs of ??1CCommonRenderingShaderCache@@QEAA@XZ @ 0x18010E7C0
 * Callers:
 *     _dynamic_atexit_destructor_for__g_commonRenderingShaderCache__ @ 0x1801240C0 (_dynamic_atexit_destructor_for__g_commonRenderingShaderCache__.c)
 * Callees:
