/*
 * XREFs of ?DrawScene3D@CDrawingContext@@QEAAJPEAUISpectreWorld@@PEAVCCompositionEnvironmentLight@@AEBVCMILMatrix@@@Z @ 0x1801D42C4
 * Callers:
        ...
        const struct CMILMatrix *a4)
{
  ...
  struct D3D11_SUBRESOURCE_DATA v98; // [rsp+60h] [rbp-A8h] BYREF
  ...
  if ( *(_QWORD *)(v9 + 712) > *(_QWORD *)(*(_QWORD *)(v9 + 16) + 296LL) )
  {
    ...
    *(_OWORD *)v106 = 0LL;
    ...
    v109 = *(float *)&v102 * v20;
    v98.pSysMem = (const void *)__PAIR64__(
                                  COERCE_UNSIGNED_INT(fmaxf(COERCE_FLOAT(LODWORD(v116) & _xmm), COERCE_FLOAT(LODWORD(v119) & _xmm))),
                                  COERCE_UNSIGNED_INT(fmaxf(COERCE_FLOAT(LODWORD(v115) & _xmm), COERCE_FLOAT(LODWORD(v118) & _xmm))));
    v98.SysMemPitch = fmaxf(COERCE_FLOAT(LODWORD(v117) & _xmm), COERCE_FLOAT(LODWORD(v120) & _xmm));
    v21 = CMILMatrix::Transform3DVector((CMILMatrix *)&v99[1], &v112, (const struct D2D_VECTOR_3F *)&v98);
    v22 = sqrtf_0(
...
LABEL_85:
    ...
    *((float *)&v108 + 3) = *((float *)&v114 + 3) - *((float *)&v114 + 1);
    ...
    LODWORD(v98.pSysMem) = v52 - (_DWORD)v95;
    v49.m128_f32[0] = (float)(int)v54.m128_f32[0];
    LODWORD(v95) = _mm_cmplt_ss(v49, v54).m128_u32[0];
    HIDWORD(v98.pSysMem) = (int)v54.m128_f32[0] - (_DWORD)v95;
    v106[0] = *((void **)v96 + 112);
...
LABEL_74:
    ...
    v64 = (__int64 *)(*(__int64 (__fastcall **)(struct ISpectreRenderer *))(v63 + 40))(SpectreRenderer);
    v107 = 0LL;
    *(_OWORD *)v106 = 0LL;
    pSysMem = v64;
    v98.pSysMem = v64;
    ...
    {
LABEL_61:
      (*(void (__fastcall **)(__int64 *, float *))(*pSysMem + 16))(pSysMem, &v109);
      v77 = *(void (__fastcall **)(__int64 *, __int64))(*pSysMem + 24);
      ...
      v112.z = v48;
      v113 = v50;
      (*(void (__fastcall **)(__int64 *, struct D2D_VECTOR_3F *))(v79 + 32))(pSysMem, &v112);
      v80 = CMILMatrix::GetD2D1Matrix4x4((CMILMatrix *)&v99[1], &v127);
      LOBYTE(v94) = v68;
      LOBYTE(v81) = 1;
      v83 = v82(pSysMem, a2, v80, v81, v94);
      v8 = v83;
      if ( v83 >= 0 )
      {
