/*
 * XREFs of ??1CD3DDevice@@MEAA@XZ @ 0x18010488C
 * Callers:
...
void __fastcall CD3DDevice::~CD3DDevice(CD3DDevice *this)
{
  ...
  *((_QWORD *)this + 2) = &CD3DDevice::`vftable'{for `CD2DContext'};
  ...
  `vector destructor iterator'(
    ...
    8uLL,
    0x30uLL,
    (void (*)(void *))wil::com_ptr_t<ID3D11SamplerState,wil::err_returncode_policy>::~com_ptr_t<ID3D11SamplerState,wil::err_returncode_policy>);
  `vector destructor iterator'(
    (char *)this + 1640,
    8uLL,
    0x18uLL,
  ...
  *((_QWORD *)this + 138) = &CD3DResourceManager::`vftable';
  ...
  v20 = (CAtlasTexture **)*((_QWORD *)this + 64);
  if ( v20 )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<CAtlasTexture>>>(v20, *((CAtlasTexture ***)this + 65));
    std::_Deallocate<16,0>(
      *((void **)this + 64),
