/*
 * XREFs of ?RemoteReplace@?$ListProxySimpleCommon@VBamoList_uint_Proxy@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@II@Bamo@Microsoft@@MEAAJII@Z @ 0x1801F7E10
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v12 )
    {
      ...
      if ( v18 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          1280LL,
          (__int64)"g:\\os\\tools\\BamoCodegen\\Inc\\BamoList.inl",
