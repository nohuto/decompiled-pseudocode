/*
 * XREFs of ?EmitCpuClipAntialiasTemplateGeometry@@YAJPEAVCD3DBatchExecutionContext@@PEBVCCpuClipAntialiasBatchCommand@@_N@Z @ 0x180037288
 * Callers:
 ...
 *     ?GetScaleCorrectLocalToWorldTransform@CDrawListPrimitive@@QEBA?AVCMILMatrix@@AEBV2@@Z @ 0x180037590 (-GetScaleCorrectLocalToWorldTransform@CDrawListPrimitive@@QEBA-AVCMILMatrix@@AEBV2@@Z.c)
        ...
        char a3)
{
  ...
  v43 = 0LL;
  v44 = 0LL;
  CCpuClipAntialiasSink::GetAntialiasTemplateGeometry(v6, (unsigned int)v4, (char *)a2 + 100, &v37);
  CDrawListPrimitive::GetScaleCorrectLocalToWorldTransform(*(_QWORD *)(v6 + 8 * v4 + 40), v50, (char *)a2 + 16);
  v8 = v37;
  v34 = 0LL;
  appended = CD3DBatchExecutionContext::AppendGeometry((_DWORD)a1, v37, 0, (unsigned int)&v43, (__int64)&v34, 0LL);
  v47 = appended;
  if ( appended < 0 )
  {
  ...
  else
  {
    ...
    if ( v12 )
    {
      ...
      v46 = v12;
      if ( (_DWORD)v12 )
        TransferVertices<Vertex_UVxN<VertexXYW_ColorDW>>(&v37, v51, v50);
      else
