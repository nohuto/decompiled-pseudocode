/*
 * XREFs of ??$make_unique@UCpuClipRealization@CCpuClippingData@@$$V$0A@@std@@YA?AV?$unique_ptr@UCpuClipRealization@CCpuClippingData@@U?$default_delete@UCpuClipRealization@CCpuClippingData@@@std@@@0@XZ @ 0x1800E9C90
 * Callers:
