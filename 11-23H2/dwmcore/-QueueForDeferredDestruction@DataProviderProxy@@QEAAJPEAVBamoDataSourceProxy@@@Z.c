/*
 * XREFs of ?QueueForDeferredDestruction@DataProviderProxy@@QEAAJPEAVBamoDataSourceProxy@@@Z @ 0x1801E4A8C
 * Callers:
 *     ?OnDisconnected@DataSourceProxy@@MEAAJXZ @ 0x1801E2C20 (-OnDisconnected@DataSourceProxy@@MEAAJXZ.c)
 * Callees:
 ...
 *     ??$_Emplace_reallocate@AEA_K@?$vector@_KV?$allocator@_K@std@@@std@@QEAAPEA_KQEA_KAEA_K@Z @ 0x1801E3AC4 (--$_Emplace_reallocate@AEA_K@-$vector@_KV-$allocator@_K@std@@@std@@QEAAPEA_KQEA_KAEA_K@Z.c)
