/*
 * XREFs of ??I?$com_ptr_t@VIAdvancedDirectFlipBitmapRealization@@Uerr_returncode_policy@wil@@@wil@@QEAAPEAPEAVIAdvancedDirectFlipBitmapRealization@@XZ @ 0x1801DB228
 * Callers:
