/*
 * XREFs of ?RegisterIndirectTargetsForBoundTrackers@CInteractionTrackerBindingManager@@QEAAJPEAVCInteractionTracker@@PEAVCBaseExpression@@W4Enum@InteractionTrackerProperty@@@Z @ 0x180238360
 * Callers:
 *     ?RegisterIndirectTargetsForBoundTrackers@CInteractionTracker@@QEAAJPEAVCBaseExpression@@W4Enum@InteractionTrackerProperty@@@Z @ 0x180233B80 (-RegisterIndirectTargetsForBoundTrackers@CInteractionTracker@@QEAAJPEAVCBaseExpression@@W4Enum@I.c)
        ...
        struct CBaseExpression *a3)
{
  ...
  void *v14[3]; // [rsp+38h] [rbp-18h] BYREF
  ...
  while ( !*((_BYTE *)v8 + 25) )
  {
    ...
    if ( v9 != (struct CWeakResourceReference **)a2 )
    {
      ...
      if ( v10 < 0 )
      {
        ...
        std::set<CInteractionTracker *>::~set<CInteractionTracker *>(v14);
        return v11;
      }
    }
