/*
 * XREFs of ?GetBrushParameters@CLinearGradientBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x1800A65E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CBrushDrawListGenerator *a2)
{
  ...
  v7 = CDrawListBitmap::CDrawListBitmap((CDrawListBitmap *)&v34, v30);
  CDrawListBitmap::operator=(&v32, v7);
...
LABEL_22:
  ...
  v31 = 0LL;
  *(_QWORD *)&v38 = v24;
  CBrushDrawListGenerator::AttachInput(a2, 0LL, &v38);
  if ( (_QWORD)v38 )
    std::default_delete<CDrawListBrush>::operator()(v25, v38);
  v6 = 0;
LABEL_15:
