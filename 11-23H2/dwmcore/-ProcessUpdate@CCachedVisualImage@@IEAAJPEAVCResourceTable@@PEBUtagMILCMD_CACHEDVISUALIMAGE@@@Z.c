/*
 * XREFs of ?ProcessUpdate@CCachedVisualImage@@IEAAJPEAVCResourceTable@@PEBUtagMILCMD_CACHEDVISUALIMAGE@@@Z @ 0x180028024
 * Callers:
...
LABEL_27:
  ...
  *(_OWORD *)((char *)this + 120) = *(_OWORD *)((char *)a3 + 24);
  ...
  v24 = CResourceTable::GetResource(a2, v7, 172LL);
  *((_QWORD *)this + 17) = v24;
  if ( !v24 )
  {
    v14 = -2003303421;
...
LABEL_5:
  ...
  v9 = CResourceTable::GetResource(a2, v8, 196LL);
  *((_QWORD *)this + 18) = v9;
  if ( !v9 )
  {
    v14 = -2003303421;
