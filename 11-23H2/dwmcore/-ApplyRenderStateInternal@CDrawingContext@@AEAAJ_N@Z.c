/*
 * XREFs of ?ApplyRenderStateInternal@CDrawingContext@@AEAAJ_N@Z @ 0x18006D350
 * Callers:
 ...
 *     ?ApplyRenderState@CDrawingContext@@UEAAJXZ @ 0x18006ED70 (-ApplyRenderState@CDrawingContext@@UEAAJXZ.c)
