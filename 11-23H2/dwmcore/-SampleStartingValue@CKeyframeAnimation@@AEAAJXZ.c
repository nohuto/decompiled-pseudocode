/*
 * XREFs of ?SampleStartingValue@CKeyframeAnimation@@AEAAJXZ @ 0x1800EDA14
 * Callers:
 ...
 *     ?ResolveTargetNoRef@CBaseExpression@@IEAAPEAVCResource@@XZ @ 0x1800EDB64 (-ResolveTargetNoRef@CBaseExpression@@IEAAPEAVCResource@@XZ.c)
