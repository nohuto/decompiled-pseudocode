/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCHolographicInteropTexture@@@?$vector@PEAVCHolographicInteropTexture@@V?$allocator@PEAVCHolographicInteropTexture@@@std@@@std@@QEAAPEAPEAVCHolographicInteropTexture@@QEAPEAV2@AEBQEAV2@@Z @ 0x1802A3E10
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCHolographicInteropTexture@@V?$allocator@PEAVCHolographicInteropTexture@@@std@@@std@@AEAAXQEAPEAVCHolographicInteropTexture@@_K1@Z @ 0x1802A60D8 (-_Change_array@-$vector@PEAVCHolographicInteropTexture@@V-$allocator@PEAVCHolographicInteropText.c)
 */
