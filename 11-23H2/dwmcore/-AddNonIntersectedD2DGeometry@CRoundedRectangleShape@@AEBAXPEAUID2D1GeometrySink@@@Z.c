/*
 * XREFs of ?AddNonIntersectedD2DGeometry@CRoundedRectangleShape@@AEBAXPEAUID2D1GeometrySink@@@Z @ 0x18003C2D0
 * Callers:
 ...
 *     ??0CMilPoint2F@@QEAA@XZ @ 0x180105320 (--0CMilPoint2F@@QEAA@XZ.c)
  ...
  if ( *(_QWORD *)(v2 + 80) == *(_QWORD *)(v2 + 88) )
  {
    ...
    do
    {
      ...
      if ( *v13 <= 0.0 || v13[1] <= 0.0 )
        v14 = dword_180378270[v11];
      else
        v14 = *((_DWORD *)&unk_18033BEC0 + 4 * v11);
      v15 = v14;
      v16 = (float *)(v10 + 32);
      if ( !v12 )
        v16 += 2 * v9;
...
LABEL_76:
      ...
      {
        v36 = (int *)((char *)&unk_18033BEC0 + 16 * v9);
        v37 = &v115[2 * *v36];
        v38 = &v115[2 * v36[1]];
        v92 = &v115[2 * v36[2]];
