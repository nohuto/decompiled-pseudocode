/*
 * XREFs of ?Merge@CDirtyRegion@@AEAAXII@Z @ 0x1800804A4
 * Callers:
...
void __fastcall CDirtyRegion::Merge(__m128 *this, unsigned int a2, unsigned int a3)
{
  ...
  v6 = a3;
  v16 = this[a2 + 98];
  TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v16, &this[v5 + 98]);
  v7 = v16;
  ...
  *(float *)v10 = (float)(v13 * 0.5) + v7.m128_f32[0];
  ...
  TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&this[v3 + 106], &this[v5 + 106]);
  v15 = &this[v6 + 106];
  v15->m128_i32[3] = 0;
  v15->m128_i32[2] = 0;
  v15->m128_i32[1] = 0;
