/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIRenderTargetBitmap@@@Z @ 0x18028CC10
 * Callers:
        ...
        struct IRenderTargetBitmap **a7)
{
  ...
  *a7 = 0LL;
  ...
  {
    v12 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180386F20, 2u, -2147024809, 0x442u, 0LL);
    goto LABEL_13;
  }
  v23[0] = v27;
  v13 = 1;
  ...
  if ( v15 < 0 )
  {
    v21 = 1117;
LABEL_12:
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_180386F20, 2u, v15, v21, 0LL);
  }
LABEL_13:
