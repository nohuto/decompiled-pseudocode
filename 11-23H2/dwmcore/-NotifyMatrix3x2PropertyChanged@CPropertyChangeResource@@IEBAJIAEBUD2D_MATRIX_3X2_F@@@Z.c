/*
 * XREFs of ?NotifyMatrix3x2PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2D_MATRIX_3X2_F@@@Z @ 0x1800EE530
 * Callers:
        ...
        const struct D2D_MATRIX_3X2_F *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this) )
  {
    ...
    v18 = v12;
    v19 = v13;
    v14 = CoreUICallSend(v10, v17, 2LL, 14LL, 7, &unk_18033C0AB, v16);
    v4 = v14;
    if ( v14 == -2018375675 )
    {
      return 0;
