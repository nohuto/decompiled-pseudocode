/*
 * XREFs of ?SetTransformParentDataInternal@CVisual@@QEAAXPEAUTransformParentData@@@Z @ 0x1800EF328
 * Callers:
...
void __fastcall CVisual::SetTransformParentDataInternal(CVisual *this, struct TransformParentData *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot(v2, 8) = a2;
    }
  }
  else if ( (v6 & 0x1000000) != 0 )
  {
    v7 = *v2;
    *v5 = v6 & 0xFEFFFFFF;
    Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot((__int64)v7, 8);
    if ( Slot < *(_DWORD *)(v9 + 4) )
      *(_BYTE *)(Slot + v9 + 8) = v10;
  }
}
