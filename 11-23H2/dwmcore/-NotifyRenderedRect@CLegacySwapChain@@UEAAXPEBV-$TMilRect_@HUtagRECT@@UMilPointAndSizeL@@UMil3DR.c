/*
 * XREFs of ?NotifyRenderedRect@CLegacySwapChain@@UEAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x180030050
 * Callers:
 *     ?NotifyRenderedRect@CLegacySwapChain@@$4PPPPPPPM@BLA@EAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x18011F790 (-NotifyRenderedRect@CLegacySwapChain@@$4PPPPPPPM@BLA@EAAXPEBV-$TMilRect_@HUtagRECT@@UMilPointAnd.c)
 *     ?NotifyRenderedRect@CLegacySwapChain@@$4PPPPPPPM@BLI@EAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x180120830 (-NotifyRenderedRect@CLegacySwapChain@@$4PPPPPPPM@BLI@EAAXPEBV-$TMilRect_@HUtagRECT@@UMilPointAnd.c)
...
void __fastcall CLegacySwapChain::NotifyRenderedRect(__int64 a1, int *a2)
{
  ...
  if ( a2 )
  {
    if ( TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::IntersectUnsafe((int *)&v25, a2) )
    {
