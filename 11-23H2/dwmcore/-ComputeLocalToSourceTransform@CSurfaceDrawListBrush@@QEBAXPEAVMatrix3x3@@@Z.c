/*
 * XREFs of ?ComputeLocalToSourceTransform@CSurfaceDrawListBrush@@QEBAXPEAVMatrix3x3@@@Z @ 0x1800F4594
 * Callers:
 ...
 *     ?TryInvert@Matrix3x3@@SA_NAEBV1@PEAV1@@Z @ 0x1800CB04C (-TryInvert@Matrix3x3@@SA_NAEBV1@PEAV1@@Z.c)
 */
