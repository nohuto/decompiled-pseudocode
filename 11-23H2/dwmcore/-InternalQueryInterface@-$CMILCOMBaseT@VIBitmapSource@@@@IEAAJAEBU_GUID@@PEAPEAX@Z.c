/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIBitmapSource@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EFB40
 * Callers:
 *     ?QueryInterface@CWICBitmapWrapper@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EFB30 (-QueryInterface@CWICBitmapWrapper@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@?$CMILCOMBaseT@VIBitmapSource@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802BC0A4 (-QueryInterface@-$CMILCOMBaseT@VIBitmapSource@@@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
