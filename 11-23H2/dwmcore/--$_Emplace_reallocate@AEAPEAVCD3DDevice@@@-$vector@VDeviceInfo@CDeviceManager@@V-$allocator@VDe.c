/*
 * XREFs of ??$_Emplace_reallocate@AEAPEAVCD3DDevice@@@?$vector@VDeviceInfo@CDeviceManager@@V?$allocator@VDeviceInfo@CDeviceManager@@@std@@@std@@QEAAPEAVDeviceInfo@CDeviceManager@@QEAV23@AEAPEAVCD3DDevice@@@Z @ 0x180100334
 * Callers:
        ...
        __int64 *a3)
{
  ...
  *(_QWORD *)v15 = v14;
  ...
  std::vector<CDeviceManager::DeviceInfo>::_Change_array((__int64)a1, v16, v9, v3);
  return v15;
}
