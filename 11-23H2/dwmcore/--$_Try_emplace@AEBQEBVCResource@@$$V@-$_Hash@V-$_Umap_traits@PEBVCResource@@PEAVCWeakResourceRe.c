        ...
        __int64 *a3)
{
  ...
  v8 = qword_1803E62E8;
  v9 = *(__int64 **)(qword_1803E62F8 + 16 * (v5 & xmmword_1803E6310) + 8);
  if ( v9 == (__int64 *)qword_1803E62E8 )
    goto LABEL_8;
  while ( 1 )
  {
    if ( *a3 == v9[2] )
    ...
    if ( v9 == *(__int64 **)(qword_1803E62F8 + 16 * (v5 & xmmword_1803E6310)) )
      break;
    v9 = (__int64 *)v9[1];
  }
  v8 = (__int64)v9;
...
LABEL_6:
  ...
  {
LABEL_8:
    if ( qword_1803E62F0 == 0x7FFFFFFFFFFFFFFLL )
    ...
    v10[2] = v11;
    v12 = qword_1803E62F0;
    v13 = qword_1803E62F0 + 1;
    if ( qword_1803E62F0 + 1 < 0 )
      v14 = (float)(int)(v13 & 1 | (v13 >> 1)) + (float)(int)(v13 & 1 | (v13 >> 1));
    else
      v14 = (float)(int)v13;
    if ( xmmword_1803E6310 < 0 )
      v15 = (float)(int)(BYTE8(xmmword_1803E6310) & 1 | (*((_QWORD *)&xmmword_1803E6310 + 1) >> 1))
          + (float)(int)(BYTE8(xmmword_1803E6310) & 1 | (*((_QWORD *)&xmmword_1803E6310 + 1) >> 1));
    else
      v15 = (float)SDWORD2(xmmword_1803E6310);
    ...
    v16 = *(__int64 ***)(v8 + 8);
    qword_1803E62F0 = v12 + 1;
    *v10 = v8;
    v10[1] = (__int64)v16;
    *v16 = v10;
    *(_QWORD *)(v8 + 8) = v10;
    v17 = qword_1803E62F8;
    v18 = 2 * (v5 & xmmword_1803E6310);
    v19 = *(_QWORD *)(qword_1803E62F8 + 16 * (v5 & xmmword_1803E6310));
    if ( v19 == qword_1803E62E8 )
    {
      *(_QWORD *)(qword_1803E62F8 + 16 * (v5 & xmmword_1803E6310)) = v10;
    }
    else
    {
      if ( v19 == v8 )
      ...
      if ( *(__int64 ***)(qword_1803E62F8 + 16 * (v5 & xmmword_1803E6310) + 8) != v16 )
        goto LABEL_18;
    }
