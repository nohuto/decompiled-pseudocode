/*
 * XREFs of ?Update@CCpuClippingData@@QEAAJPEBVCVisualTree@@PEAVCVisual@@AEBVCScopedClipStack@@PEBVCShape@@PEBVCMILMatrix@@PEBV1@W4D2D1_ANTIALIAS_MODE@@W4CpuClippingScopeMode@@@Z @ 0x1800523D0
 * Callers:
        ...
        int a9)
{
  ...
  CCpuClippingData::CpuClipRealization *v58; // rdx
  char v59; // al
  bool v60; // al
...
LABEL_33:
              ...
              if ( v27 )
              {
                ...
                {
                  v127 = std::make_unique<CCpuClippingData::CpuClipRealization,,0>(&v185, v27, v28, v29);
                  v34 = (CCpuClippingData::CpuClipRealization **)(a1 + 64);
...
LABEL_96:
                  ...
                  v58 = (CCpuClippingData::CpuClipRealization *)v178;
                  v51 = v181;
                  v45 = v182;
LABEL_97:
                  if ( !v51 )
...
LABEL_173:
                    ...
                    if ( v85 )
                    {
                      v58 = (CCpuClippingData::CpuClipRealization *)EffectInternal;
...
LABEL_100:
                      ...
                      v120 = CMILMatrix::IsTranslate<1>(v56);
                      v56 = v179;
                      if ( v120
...
LABEL_239:
                              v177 = v57;
                              if ( (unsigned __int8)CMILMatrix::IsTranslate<1>(v182) )
                              {
                                v122 = v182;
                                v123 = *((float *)v182 + 12);
                                v124 = *((float *)v182 + 13);
...
LABEL_10:
      ...
      if ( (*v23 & 0x1000000) != 0 )
      {
        ...
        v133 = *v132;
        if ( v133 )
          v22 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*v133 + 184LL))(*v133);
      }
      if ( (*(unsigned __int8 (__fastcall **)(const struct CVisualTree *))(*(_QWORD *)a2 + 184LL))(a2) )
      {
        v24 = (_QWORD *)(a3 + 336);
      ...
      {
        v201 = 0;
        WorldTransform = CVisual::GetWorldTransform(v22, a2, 0LL, v200, 0LL, 0LL);
        v135 = WorldTransform;
        if ( WorldTransform < 0 )
        {
          wil::details::in1diag3::Return_Hr(
