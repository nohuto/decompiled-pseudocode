/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCInteractionTracker@@@?$vector@PEAVCInteractionTracker@@V?$allocator@PEAVCInteractionTracker@@@std@@@std@@QEAAPEAPEAVCInteractionTracker@@QEAPEAV2@AEBQEAV2@@Z @ 0x180236060
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCInteractionTracker@@V?$allocator@PEAVCInteractionTracker@@@std@@@std@@AEAAXQEAPEAVCInteractionTracker@@_K1@Z @ 0x180239054 (-_Change_array@-$vector@PEAVCInteractionTracker@@V-$allocator@PEAVCInteractionTracker@@@std@@@st.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<CInteractionTracker *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
