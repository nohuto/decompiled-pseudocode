/*
 * XREFs of ?CopyPixels@CD2DBitmap@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@IIPEAE@Z @ 0x18029ECB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CD2DBitmap::CopyPixels(__int64 a1, int *a2, __int64 a3, unsigned int a4, unsigned __int8 *a5)
{
  int v7; // eax
  unsigned int v8; // ebx
  _DWORD *v10; // rdx
  ...
  else
  {
    ...
    v20 = HrCreateBitmapFromMemoryEx(a2[2] - *a2, a2[3] - a2[1], v19, v8, a4, a5, 0LL, &v33);
    v16 = v20;
    if ( v20 < 0 )
    {
