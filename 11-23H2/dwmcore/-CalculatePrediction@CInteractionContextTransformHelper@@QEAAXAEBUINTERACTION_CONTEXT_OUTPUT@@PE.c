/*
 * XREFs of ?CalculatePrediction@CInteractionContextTransformHelper@@QEAAXAEBUINTERACTION_CONTEXT_OUTPUT@@PEBUMANIPULATION_TRANSFORM@@PEBUtagRECT@@IMMPEAM3@Z @ 0x1802B9E48
 * Callers:
 ...
 *     _anonymous_namespace_::operator_ @ 0x1802B9DE0 (_anonymous_namespace_--operator_.c)
