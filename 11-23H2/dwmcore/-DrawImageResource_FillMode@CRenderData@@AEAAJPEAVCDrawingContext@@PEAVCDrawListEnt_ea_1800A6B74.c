/*
 * XREFs of ?DrawImageResource_FillMode@CRenderData@@AEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@PEAVCImageSource@@PEBUD2D_RECT_F@@3M@Z @ 0x1800A6B74
 * Callers:
...
LABEL_30:
      ...
      if ( D2DMatrixHelper::ComputeRectangleTransform((D2DMatrixHelper *)&v30, &v42, &v33, v14) )
      {
        ...
        *(_QWORD *)&v42.right = 0LL;
        ...
        if ( v7 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast((__int64)v21, 0LL, 0, v7, 0x480u, 0LL);
        }
        else
        {
          v22 = v29;
          ...
          *(_QWORD *)&v41.left = v29;
          v29 = 0LL;
          CBrushDrawListGenerator::AttachInput(v44, 0LL, &v41);
          if ( *(_QWORD *)&v41.left )
            std::default_delete<CDrawListBrush>::operator()(v24, *(_QWORD *)&v41.left);
