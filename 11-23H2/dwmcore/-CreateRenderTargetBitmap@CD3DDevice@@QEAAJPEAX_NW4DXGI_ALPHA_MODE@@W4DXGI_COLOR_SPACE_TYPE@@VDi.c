/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJPEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIRenderTargetBitmap@@@Z @ 0x18028CD9C
 * Callers:
...
LABEL_8:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, &dword_180386F20, 2u, v12, v14, 0LL);
  }
