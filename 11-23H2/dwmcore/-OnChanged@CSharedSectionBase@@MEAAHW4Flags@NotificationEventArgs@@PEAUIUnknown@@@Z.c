/*
 * XREFs of ?OnChanged@CSharedSectionBase@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1800F1360
 * Callers:
 *     <none>
 * Callees:
 *     ?UnmapSharedMemory@CSharedSectionBase@@IEBAXXZ @ 0x1800EEA80 (-UnmapSharedMemory@CSharedSectionBase@@IEBAXXZ.c)
 *     ?MapSharedMemory@CSharedSectionBase@@KAPEAXPEAX_K@Z @ 0x1800F13AC (-MapSharedMemory@CSharedSectionBase@@KAPEAXPEAX_K@Z.c)
 */
