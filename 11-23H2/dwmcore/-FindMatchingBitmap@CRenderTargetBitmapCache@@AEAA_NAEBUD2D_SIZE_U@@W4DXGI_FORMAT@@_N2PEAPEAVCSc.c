/*
 * XREFs of ?FindMatchingBitmap@CRenderTargetBitmapCache@@AEAA_NAEBUD2D_SIZE_U@@W4DXGI_FORMAT@@_N2PEAPEAVCScratchRenderTargetBitmap@@@Z @ 0x1800AF69C
 * Callers:
 ...
 *     ?Remove@?$DynArray@PEAVCScratchRenderTargetBitmap@@$0A@@@QEAAHAEBQEAVCScratchRenderTargetBitmap@@@Z @ 0x1800AFAA0 (-Remove@-$DynArray@PEAVCScratchRenderTargetBitmap@@$0A@@@QEAAHAEBQEAVCScratchRenderTargetBitmap@.c)
        ...
        struct CScratchRenderTargetBitmap **a6)
{
  ...
  while ( 1 )
  {
    v15 = *(_QWORD *)(*(_QWORD *)this + 8LL * (unsigned int)--v10);
