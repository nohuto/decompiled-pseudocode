/*
 * XREFs of ?OnPeerConnected@DiagnosticCallbacksManager@@MEAAJPEAVBamoPeer@DiagnosticCallbacks_AutoBamos@@PEA_NPEAPEAVBamoPrincipal@Bamo@Microsoft@@@Z @ 0x180105810
 * Callers:
 *     <none>
 * Callees:
 *     <none>
