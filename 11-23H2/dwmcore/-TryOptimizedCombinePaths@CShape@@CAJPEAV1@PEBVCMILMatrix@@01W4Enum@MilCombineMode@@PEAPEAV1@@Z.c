/*
 * XREFs of ?TryOptimizedCombinePaths@CShape@@CAJPEAV1@PEBVCMILMatrix@@01W4Enum@MilCombineMode@@PEAPEAV1@@Z @ 0x180039F90
 * Callers:
 ...
 *     ??8CRoundedRectangleGeometryData@@QEBA_NAEBU0@@Z @ 0x180038EF8 (--8CRoundedRectangleGeometryData@@QEBA_NAEBU0@@Z.c)
  ...
  if ( a5 != 1 )
  {
    if ( a5 )
    {
      ...
      if ( (unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::DoesContain(&v119, v117)
        || (unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(v117) )
      {
      ...
      if ( !(unsigned __int8)CanCombineToRegion(a1, v61, a3, a4) )
        return v10;
      v62 = (const struct tagRECT *)PixelAlign(&v118, v117);
      FastRegion::CRegion::CRegion((FastRegion::CRegion *)&v120, v62);
      v63 = (const struct tagRECT *)PixelAlign(&v118, &v119);
...
LABEL_137:
    ...
    if ( (unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::DoesContain(v117, &v119)
      || (unsigned __int8)TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(&v119) )
    {
      v18 = CShape::CopyShape(a1, 0LL, a6);
      v10 = v18;
      if ( v18 >= 0 )
