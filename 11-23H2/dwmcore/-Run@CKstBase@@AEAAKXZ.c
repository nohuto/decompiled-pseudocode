/*
 * XREFs of ?Run@CKstBase@@AEAAKXZ @ 0x1800F39AC
 * Callers:
 *     ?RunKernelThreadStatic@CKstBase@@CAKPEAX@Z @ 0x1800F39A0 (-RunKernelThreadStatic@CKstBase@@CAKPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CKstBase::Run(CKstBase *this)
{
  ...
  *((_DWORD *)this + 6) = CurrentThreadId;
  ...
  if ( *v5 > 4u && tlgKeywordOn((__int64)v5, 2LL) )
  {
    ...
    v22 = v3;
    v25 = 4;
    tlgWriteTransfer_EventWriteTransfer(v15, (unsigned __int8 *)dword_18038297F, 0LL, 0LL, 3u, &v23);
  }
  if ( (unsigned int)NtKSTInitialize(*((_QWORD *)this + 4), *((_QWORD *)this + 1)) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *v8 > 4u && tlgKeywordOn((__int64)v8, 2LL) )
        tlgWriteTransfer_EventWriteTransfer(v19, (unsigned __int8 *)dword_1803829A9, 0LL, 0LL, 2u, &v23);
      v9 = NtKSTWait();
      ...
      if ( *v11 > 4u && tlgKeywordOn((__int64)v11, 2LL) )
      {
        ...
        v22 = v9;
        v25 = 4;
        tlgWriteTransfer_EventWriteTransfer(v20, (unsigned __int8 *)dword_180382930, 0LL, 0LL, 3u, &v23);
      }
      if ( !v9 )
        break;
      v13 = v9 - 1;
