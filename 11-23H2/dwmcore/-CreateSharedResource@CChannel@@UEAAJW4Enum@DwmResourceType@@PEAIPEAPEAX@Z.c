/*
 * XREFs of ?CreateSharedResource@CChannel@@UEAAJW4Enum@DwmResourceType@@PEAIPEAPEAX@Z @ 0x1801CEAF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    if ( v14 >= 0 )
    {
      ...
      if ( v14 >= 0 )
      {
        ...
        *a4 = hObject;
LABEL_16:
        CChannel::CreateNewHandleTableEntry((__int64 *)a1, v22, v11, *(__int64 *)v26);
        v9 = 0;
        *a3 = v22;
        goto LABEL_17;
      }
