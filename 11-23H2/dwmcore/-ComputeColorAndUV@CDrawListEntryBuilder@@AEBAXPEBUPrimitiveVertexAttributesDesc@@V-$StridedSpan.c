/*
 * XREFs of ?ComputeColorAndUV@CDrawListEntryBuilder@@AEBAXPEBUPrimitiveVertexAttributesDesc@@V?$StridedSpan@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@V?$StridedSpan@UVertexAAFixup_UVxN@@@@@Z @ 0x180068560
 * Callers:
...
__int64 __fastcall CDrawListEntryBuilder::ComputeColorAndUV(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v8; // eax
  unsigned int v9; // r9d
  int v10; // r10d
...
LABEL_17:
      ...
      result = (unsigned int)((int)(LODWORD(v52.r) << 10) >> 11);
  ...
  for ( j = 0; j < *(_DWORD *)(a3 + 12); ++j )
  {
    ...
    *(_DWORD *)(v27 + 12) = v29;
    ...
    if ( *(_DWORD *)a1 )
    {
      do
      {
        if ( v47[(unsigned int)result] )
        {
          if ( (unsigned __int64)(unsigned int)result >= *(_QWORD *)(a2 + 40) )
            goto LABEL_59;
          v30 = *(float *)(v27 + 4);
          v31 = *(_QWORD *)(a2 + 48) + 52LL * (unsigned int)result;
          v32 = *(float *)(v31 + 32);
          v33 = *(float *)(v31 + 24);
          v34 = *(float *)(v31 + 28);
          ...
          *(float *)(v27 + 8LL * (unsigned int)result + 16) = v35;
          *(float *)(v27 + 8LL * (unsigned int)result + 20) = v36;
          v28[2 * (unsigned int)result + 4] = v40;
          v28[2 * (unsigned int)result + 5] = v41;
        }
        else
        {
          *(_QWORD *)(v27 + 8LL * (unsigned int)result + 16) = 0LL;
          *(_QWORD *)&v52.r = 0LL;
          *(_QWORD *)&v28[2 * (unsigned int)result + 4] = 0LL;
        }
        result = (unsigned int)(result + 1);
      }
      while ( (unsigned int)result < *(_DWORD *)a1 );
      i = 0.0;
    }
  }
  return result;
