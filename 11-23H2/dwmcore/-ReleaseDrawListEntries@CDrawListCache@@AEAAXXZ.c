/*
 * XREFs of ?ReleaseDrawListEntries@CDrawListCache@@AEAAXXZ @ 0x1800732B0
 * Callers:
...
LABEL_11:
  ...
  if ( v16 )
  {
    v42 = detail::vector_facade<IDeviceResource *,detail::pointer_buffer_impl<IDeviceResource *>>::size((__int64)this + 56);
    if ( v16 > v42 )
    {
LABEL_118:
    ...
    detail::pointer_buffer_impl<IDeviceResource *>::consume((_DWORD *)this + 14, -(__int64)v16);
  }
  v17 = *((_QWORD *)this + 6);
