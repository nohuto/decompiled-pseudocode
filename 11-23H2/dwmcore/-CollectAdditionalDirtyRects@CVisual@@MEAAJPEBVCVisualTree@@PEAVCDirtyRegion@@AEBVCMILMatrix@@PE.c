/*
 * XREFs of ?CollectAdditionalDirtyRects@CVisual@@MEAAJPEBVCVisualTree@@PEAVCDirtyRegion@@AEBVCMILMatrix@@PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800801F0
 * Callers:
 ...
 * Callees:
 *     ?GetAdditionalDirtyRects@CVisual@@QEBAPEAVCMergedDirtyRect@@XZ @ 0x18007F040 (-GetAdditionalDirtyRects@CVisual@@QEBAPEAVCMergedDirtyRect@@XZ.c)
  ...
  if ( AdditionalDirtyRects )
  {
    if ( !(*(unsigned __int8 (__fastcall **)(struct CMergedDirtyRect *))(*(_QWORD *)AdditionalDirtyRects + 32LL))(AdditionalDirtyRects) )
    {
      ...
      if ( v24 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xE67u, 0LL);
      }
    }
  }
  return v8;
