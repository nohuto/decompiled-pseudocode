/*
 * XREFs of ??0QpcTimeConverter@@QEAA@XZ @ 0x1800B40C8
 * Callers:
 *     ??0CInteractionContextWrapper@@QEAA@XZ @ 0x1800B3FF8 (--0CInteractionContextWrapper@@QEAA@XZ.c)
 *     ??0CManipulationManager@@IEAA@PEAVCComposition@@@Z @ 0x1800D3F10 (--0CManipulationManager@@IEAA@PEAVCComposition@@@Z.c)
 * Callees:
 *     <none>
 */
