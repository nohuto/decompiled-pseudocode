/*
 * XREFs of ?Create@?$CWeakReference@VCInteractionTracker@@@@SAJPEAVCInteractionTracker@@PEAPEAV1@@Z @ 0x1802649A0
 * Callers:
        ...
        struct CWeakResourceReference **a2)
{
  ...
  v8 = 0LL;
  v3 = CWeakResourceReference::Get(a1, (void (__fastcall ****)(LPVOID))&v8);
  v5 = v3;
  if ( v3 < 0 )
  {
