/*
 * XREFs of ?GetTopGpuClipInScope@CScopedClipStack@@QEBAXPEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@_NPEAV2@@Z @ 0x18002159C
 * Callers:
 ...
 *     ?HasClipBoundsInScope@CScopedClipStack@@QEBA_NXZ @ 0x1800DABC4 (-HasClipBoundsInScope@CScopedClipStack@@QEBA_NXZ.c)
