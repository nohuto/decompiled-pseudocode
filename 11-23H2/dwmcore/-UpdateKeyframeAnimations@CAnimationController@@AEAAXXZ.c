/*
 * XREFs of ?UpdateKeyframeAnimations@CAnimationController@@AEAAXXZ @ 0x1800CBBD4
 * Callers:
 *     ?OnPlaybackRateChanged@CAnimationController@@QEAAXXZ @ 0x180022CD8 (-OnPlaybackRateChanged@CAnimationController@@QEAAXXZ.c)
 *     ?NotifyBatchProcessingComplete@CAnimationController@@UEAAXXZ @ 0x1800CBAD0 (-NotifyBatchProcessingComplete@CAnimationController@@UEAAXXZ.c)
