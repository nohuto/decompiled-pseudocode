/*
 * XREFs of ?DirtyRenderingRealization@CGlobalCompositionSurfaceInfo@@IEAA_N_NPEAUHRGN__@@PEBUScrollOptimization@@PEAVCRegion@@@Z @ 0x1800327BC
 * Callers:
        ...
        struct CRegion *a5)
{
  ...
  const struct FastRegion::Internal::CRgnData *v30[10]; // [rsp+40h] [rbp-41h] BYREF
  ...
  else
  {
    ...
    if ( a4 && *(_DWORD *)a4 && (*((_DWORD *)a4 + 5) || *((_DWORD *)a4 + 6)) )
    {
      if ( v9 )
      {
        ...
        v20 = FastRegion::CRegion::Union((const struct FastRegion::Internal::CRgnData **)a5, v30);
        if ( v20 < 0 )
