/*
 * XREFs of ?ComputeBrushClamp@CBrushDrawListGenerator@@CAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@KAEBVMatrix3x3@@PEAPEAVCShape@@@Z @ 0x1801FC1C4
 * Callers:
    ...
    do
    {
      ...
      if ( v10 && *(_BYTE *)(v10 + 52) )
      {
        ...
        if ( v27 )
        {
          v35[0] = 0LL;
          v28 = (__int64 *)v35;
          v19 = CShape::Combine((__int64)v27, v17, (__int64)v45, (__int64)&v36, 1, &v29);
          if ( (_BYTE)v30 )
          {
            v22 = (__int64)v28;
