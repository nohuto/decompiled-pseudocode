/*
 * XREFs of ?AddHolographicViewer@CHolographicManager@@QEAA_NPEAVCHolographicViewer@@@Z @ 0x1802A45A4
 * Callers:
 *     ?OnChanged@CHolographicViewer@@AEAAXXZ @ 0x1802AB870 (-OnChanged@CHolographicViewer@@AEAAXXZ.c)
 * Callees:
