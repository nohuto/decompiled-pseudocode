/*
 * XREFs of ?GetD2DBrush@CLinearGradientBrush@@UEAAJPEAVCDrawingContext@@AEBUD2D_RECT_F@@PEAPEAUID2D1Brush@@@Z @ 0x1800A6200
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1Brush **a4)
{
  ...
  *((_QWORD *)&v25 + 1) = &v22;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v10, 0xD3u, 0LL);
    if ( v6 )
