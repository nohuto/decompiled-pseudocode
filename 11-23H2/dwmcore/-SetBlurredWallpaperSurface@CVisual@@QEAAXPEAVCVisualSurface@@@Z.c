/*
 * XREFs of ?SetBlurredWallpaperSurface@CVisual@@QEAAXPEAVCVisualSurface@@@Z @ 0x1800C47C4
 * Callers:
...
void __fastcall CVisual::SetBlurredWallpaperSurface(CVisual *this, struct CVisualSurface *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot(v2, 17) = a2;
    }
  }
  else if ( (v6 & 0x8000) != 0 )
  {
    v7 = *v2;
    *v5 = v6 & 0xFFFF7FFF;
    Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v7, 17LL);
    if ( Slot < *(_DWORD *)(v9 + 4) )
      *(_BYTE *)(Slot + v9 + 8) = v10;
  }
}
