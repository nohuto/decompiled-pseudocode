/*
 * XREFs of ?CheckMultiPlaneOverlaySupport@COverlayContext@@CA_NAEBV?$span@PEAVCOverlayContext@@$0?0@gsl@@AEBV?$span@PEAVOverlayPlaneInfo@COverlayContext@@$0?0@3@@Z @ 0x1801DC290
 * Callers:
...
char __fastcall COverlayContext::CheckMultiPlaneOverlaySupport(__int64 a1, unsigned int *a2)
{
  _QWORD **v2; // rbx
  __int64 v3; // rax
  unsigned int v4; // edi
...
LABEL_11:
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x200) != 0 )
    McTemplateU0dd_EventWriteTransfer(a1, (__int64)&EVTDESC_OVERLAY_CHECKSUPPORT_Start);
  v11 = v4;
  v64 = v4;
...
LABEL_21:
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x200) != 0 )
    McTemplateU0d_EventWriteTransfer(v43, (__int64)&EVTDESC_OVERLAY_CHECKSUPPORT_Stop);
  if ( v15 )
  {
    if ( v4 )
    {
