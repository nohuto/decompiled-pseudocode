/*
 * XREFs of ?GetSurfacePlaneResource@CLegacySwapChain@@UEBAJPEAVCCompositionSurfaceInfo@@PEAPEAUIUnknown@@PEAI@Z @ 0x180135340
 * Callers:
 *     ?GetSurfacePlaneResource@CLegacySwapChain@@$4PPPPPPPM@BLA@EBAJPEAVCCompositionSurfaceInfo@@PEAPEAUIUnknown@@PEAI@Z @ 0x18011F630 (-GetSurfacePlaneResource@CLegacySwapChain@@$4PPPPPPPM@BLA@EBAJPEAVCCompositionSurfaceInfo@@PEAPE.c)
 *     ?GetSurfacePlaneResource@CLegacySwapChain@@$4PPPPPPPM@BLI@EBAJPEAVCCompositionSurfaceInfo@@PEAPEAUIUnknown@@PEAI@Z @ 0x1801206B0 (-GetSurfacePlaneResource@CLegacySwapChain@@$4PPPPPPPM@BLI@EBAJPEAVCCompositionSurfaceInfo@@PEAPE.c)
 *     ?GetSurfacePlaneResource@CLegacySwapChain@@$4PPPPPPPM@DFI@EBAJPEAVCCompositionSurfaceInfo@@PEAPEAUIUnknown@@PEAI@Z @ 0x180120D70 (-GetSurfacePlaneResource@CLegacySwapChain@@$4PPPPPPPM@DFI@EBAJPEAVCCompositionSurfaceInfo@@PEAPE.c)
 * Callees:
