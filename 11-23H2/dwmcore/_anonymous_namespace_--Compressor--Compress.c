/*
 * XREFs of _anonymous_namespace_::Compressor::Compress @ 0x18010DF40
 * Callers:
 ...
 *     ?_Buy_raw@?$vector@EV?$allocator@E@std@@@std@@AEAAX_K@Z @ 0x18010E2DC (-_Buy_raw@-$vector@EV-$allocator@E@std@@@std@@AEAAX_K@Z.c)
