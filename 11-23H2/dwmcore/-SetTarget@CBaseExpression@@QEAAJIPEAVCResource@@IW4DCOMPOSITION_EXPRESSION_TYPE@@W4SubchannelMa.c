/*
 * XREFs of ?SetTarget@CBaseExpression@@QEAAJIPEAVCResource@@IW4DCOMPOSITION_EXPRESSION_TYPE@@W4SubchannelMaskType@@E_K@Z @ 0x180084158
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( !a3 )
  {
    if ( (*(_BYTE *)(a1 + 216) & 2) != 0 )
    {
      ...
      if ( v27 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0x89u, 0LL);
        return v16;
      }
    }
    else
    {
      ...
      if ( v25 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v25, 0x8Du, 0LL);
        return v16;
      }
    }
  }
  ...
  if ( a3 )
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x95u, 0LL);
      v9 = v34;
      goto LABEL_19;
    }
    v9 = v34;
  ...
  *(_BYTE *)(a1 + 216) = v19;
  if ( v20 )
  {
    ...
    {
      v16 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, -2147024809, 0x2EBu, 0LL);
      v33 = 163;
      goto LABEL_36;
    }
  }
