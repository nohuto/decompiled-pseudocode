/*
 * XREFs of ?RunCompositionThread@CConnection@@AEAAJXZ @ 0x1800BF1CC
 * Callers:
 *     ?CompositionThreadEntryPoint@CConnection@@CAKPEAX@Z @ 0x1800BF1C0 (-CompositionThreadEntryPoint@CConnection@@CAKPEAX@Z.c)
 * Callees:
 ...
 *     ??0CProcessAttributionReporter@@AEAA@XZ @ 0x1800BF828 (--0CProcessAttributionReporter@@AEAA@XZ.c)
 ...
 *     ??1CProcessAttributionManager@@AEAA@XZ @ 0x1801D1AE0 (--1CProcessAttributionManager@@AEAA@XZ.c)
...
LABEL_32:
  ...
  if ( qword_1803E5C90 )
  {
    anonymous_namespace_::State::_State(qword_1803E5C90);
