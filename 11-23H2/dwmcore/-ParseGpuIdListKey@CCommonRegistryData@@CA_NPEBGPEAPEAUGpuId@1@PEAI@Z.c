/*
 * XREFs of ?ParseGpuIdListKey@CCommonRegistryData@@CA_NPEBGPEAPEAUGpuId@1@PEAI@Z @ 0x1800FD554
 * Callers:
 *     ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800FF9F0 (-IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z.c)
 * Callees:
 ...
 *     ??1?$DynArrayIA@M$01$0A@@@QEAA@XZ @ 0x1802541A0 (--1-$DynArrayIA@M$01$0A@@@QEAA@XZ.c)
...
LABEL_14:
    ...
    std::unique_ptr<detail::aligned_storage_for<CVisual *> [0],std::default_delete<detail::aligned_storage_for<CVisual *> [0]>>::~unique_ptr<detail::aligned_storage_for<CVisual *> [0],std::default_delete<detail::aligned_storage_for<CVisual *> [0]>>(&pvData);
  }
  return 0;
}
