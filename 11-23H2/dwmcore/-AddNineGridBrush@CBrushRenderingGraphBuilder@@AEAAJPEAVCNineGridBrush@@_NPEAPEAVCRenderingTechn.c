/*
 * XREFs of ?AddNineGridBrush@CBrushRenderingGraphBuilder@@AEAAJPEAVCNineGridBrush@@_NPEAPEAVCRenderingTechniqueFragment@@@Z @ 0x18026D9B0
 * Callers:
        ...
        struct CRenderingTechniqueFragment **a4)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v9, 0x1CEu, 0LL);
    goto LABEL_11;
  }
...
LABEL_9:
  ...
  v9 = -2147418113;
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, -2147418113, 0x1DDu, 0LL);
LABEL_11:
