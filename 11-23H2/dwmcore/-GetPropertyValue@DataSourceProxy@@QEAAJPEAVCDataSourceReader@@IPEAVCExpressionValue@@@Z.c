/*
 * XREFs of ?GetPropertyValue@DataSourceProxy@@QEAAJPEAVCDataSourceReader@@IPEAVCExpressionValue@@@Z @ 0x1801E2A80
 * Callers:
 ...
 *     ?GetEffectiveCompositionFrameId@CComposition@@QEBA_KXZ @ 0x1801B32EC (-GetEffectiveCompositionFrameId@CComposition@@QEBA_KXZ.c)
