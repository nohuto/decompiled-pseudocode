/*
 * XREFs of ?AtlasedRectsGroupUpdate@CChannel@@UEAAJIIPEBII@Z @ 0x18002B7F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  if ( a3 )
    CChannel::CheckHandle(this, a3, 13LL);
  LODWORD(v21) = 487;
  HIDWORD(v21) = a2;
  v22 = a3;
...
LABEL_15:
  ...
  v22 = 4 * a5;
  v12 = CChannel::BeginCommand((CChannel *)this, &v21, 0xCu, v11);
  v10 = v12;
  if ( v12 < 0 )
  {
