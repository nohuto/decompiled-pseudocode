/*
 * XREFs of ?SetProtected@CStereoRenderTargetBitmap@@UEAAX_N@Z @ 0x1802B59E0
 * Callers:
 *     ?SetProtected@CStereoRenderTargetBitmap@@$4PPPPPPPM@KI@EAAX_N@Z @ 0x1801238B0 (-SetProtected@CStereoRenderTargetBitmap@@$4PPPPPPPM@KI@EAAX_N@Z.c)
 * Callees:
