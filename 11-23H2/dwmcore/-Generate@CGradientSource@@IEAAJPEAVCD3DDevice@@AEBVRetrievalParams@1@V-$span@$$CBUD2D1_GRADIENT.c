/*
 * XREFs of ?Generate@CGradientSource@@IEAAJPEAVCD3DDevice@@AEBVRetrievalParams@1@V?$span@$$CBUD2D1_GRADIENT_STOP@@$0?0@gsl@@_N33W4D2D1_EXTEND_MODE@@@Z @ 0x1800A59E0
 * Callers:
  ...
  if ( v8 && !*v8 )
  {
    ...
    else
    {
      ...
      if ( v17 )
      {
        ...
        {
          gsl::details::extent_type<-1>::extent_type<-1>(v45, 0x2000LL);
          if ( v45[0] == (struct ID2D1Brush *)-1LL )
          {
            gsl::details::terminate(v20);
            JUMPOUT(0x1800A5CBALL);
          }
          v22 = v44[0];
          LOBYTE(v21) = a6;
          v45[1] = v17;
