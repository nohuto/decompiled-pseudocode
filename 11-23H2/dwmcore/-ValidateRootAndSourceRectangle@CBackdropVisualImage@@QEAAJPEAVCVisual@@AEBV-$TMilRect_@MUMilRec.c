/*
 * XREFs of ?ValidateRootAndSourceRectangle@CBackdropVisualImage@@QEAAJPEAVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@_NPEA_N@Z @ 0x1800809F0
 * Callers:
        ...
        char *a5)
{
  ...
  *(_QWORD *)&v40.m[2][0] = a5;
  ...
  if ( *((_QWORD *)this + 18) != v11
    || !TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::DoesContain((float *)this + 24, a3)
    || v13 )
  {
  ...
  v14 = v12;
  *(_OWORD *)((char *)this + 1848) = *(_OWORD *)a3;
  ...
  *((float *)this + 464) = v20;
  ...
  if ( v14 )
  {
    v28 = (void **)DwmDbg::DbgString::DbgString((char **)v40.m[2], word_18033C470);
    v29 = "BVI-RealizationIsDirty-Updated";
    if ( !v12 )
      v29 = "BVI-RealizationIsDirty-NotUpdated";
    v30 = (void **)DwmDbg::DbgString::DbgString((char **)&v40, v29);
    CBackdropVisualImage::LogEtwEvent((__int64)this, v30, v28);
  }
  return 0LL;
}
