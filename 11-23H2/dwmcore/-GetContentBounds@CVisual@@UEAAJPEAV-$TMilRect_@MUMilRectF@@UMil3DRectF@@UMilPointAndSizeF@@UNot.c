/*
 * XREFs of ?GetContentBounds@CVisual@@UEAAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18002F1F0
 * Callers:
...
__int64 __fastcall CVisual::GetContentBounds(char *a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    v12 = (__int64 (__fastcall ***)(_QWORD, char *, _QWORD *))(v5 + 64 + *(int *)(*(_QWORD *)(v5 + 64) + 8LL));
    v13 = (**v12)(v12, a1 + 140, a2);
    v4 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xE7Bu, 0LL);
  }
