/*
 * XREFs of ?CalcFrustumOutline@@YAXVCMILMatrix@@PEAULine3D@@111@Z @ 0x180218978
 * Callers:
 ...
 *     log10f_0 @ 0x18011B5D8 (log10f_0.c)
 *     powf_0 @ 0x18011B5FC (powf_0.c)
 *     sqrtf_0 @ 0x18011B62C (sqrtf_0.c)
 *     ??0Line3D@@QEAA@UMilPoint4F@@0@Z @ 0x1802184E0 (--0Line3D@@QEAA@UMilPoint4F@@0@Z.c)
 */
