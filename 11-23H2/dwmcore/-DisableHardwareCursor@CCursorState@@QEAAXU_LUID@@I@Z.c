/*
 * XREFs of ?DisableHardwareCursor@CCursorState@@QEAAXU_LUID@@I@Z @ 0x180279978
 * Callers:
 *     ?DisableHardwareCursor@COverlayContext@@AEAAXXZ @ 0x1800FC7C0 (-DisableHardwareCursor@COverlayContext@@AEAAXXZ.c)
 * Callees:
 *     ?EnsureHardwareOverlayCleared@CCursorState@@AEAAXPEAUMonitorData@1@@Z @ 0x180279DF8 (-EnsureHardwareOverlayCleared@CCursorState@@AEAAXPEAUMonitorData@1@@Z.c)
 *     ?FindMonitorData@CCursorState@@AEAA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@UMonitorData@CCursorState@@@std@@@std@@@std@@U_LUID@@I@Z @ 0x180279E84 (-FindMonitorData@CCursorState@@AEAA-AV-$_Vector_iterator@V-$_Vector_val@U-$_Simple_types@UMonito.c)
