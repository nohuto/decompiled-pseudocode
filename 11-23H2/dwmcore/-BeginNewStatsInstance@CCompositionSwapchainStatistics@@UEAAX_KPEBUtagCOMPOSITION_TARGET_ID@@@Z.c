/*
 * XREFs of ?BeginNewStatsInstance@CCompositionSwapchainStatistics@@UEAAX_KPEBUtagCOMPOSITION_TARGET_ID@@@Z @ 0x18026D1D0
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x18010EE30 (__security_check_cookie.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x18011B6B0 (_guard_xfg_dispatch_icall_nop.c)
 *     ??$_Emplace_reallocate@AEBUCompositionFrameInstance@@@?$vector@UCompositionFrameInstance@@V?$allocator@UCompositionFrameInstance@@@std@@@std@@QEAAPEAUCompositionFrameInstance@@QEAU2@AEBU2@@Z @ 0x18026CE78 (--$_Emplace_reallocate@AEBUCompositionFrameInstance@@@-$vector@UCompositionFrameInstance@@V-$all.c)
 */
