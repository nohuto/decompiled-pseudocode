/*
 * XREFs of ?CreateNewDevice@CDeviceManager@@AEAAJU_LUID@@PEAPEAVCD3DDevice@@@Z @ 0x18010029C
 * Callers:
...
__int64 __fastcall CDeviceManager::CreateNewDevice(CDeviceManager *this, struct _LUID a2, struct CD3DDevice **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( Adapter < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1803589A0, 2u, Adapter, 0x51u, 0LL);
    TranslateDXGIorD3DErrorInContext(v7, 4, &v13);
    v7 = v13;
  }
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_1802EE308, 2u, v7, 0x15Du, 0LL);
  }
  else
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802EE308, 2u, v8, 0x15Fu, 0LL);
    }
    else
    {
      v10 = *((_QWORD *)this + 8);
