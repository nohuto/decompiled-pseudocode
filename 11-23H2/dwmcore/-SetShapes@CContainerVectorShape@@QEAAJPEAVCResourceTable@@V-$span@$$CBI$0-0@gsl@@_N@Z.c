/*
 * XREFs of ?SetShapes@CContainerVectorShape@@QEAAJPEAVCResourceTable@@V?$span@$$CBI$0?0@gsl@@_N@Z @ 0x1800971C0
 * Callers:
...
__int64 __fastcall CContainerVectorShape::SetShapes(struct CResource ***this, CResourceTable *a2, __int64 *a3, char a4)
{
  __int64 *v7; // rbx
  __int64 v8; // rax
  __int64 v9; // rbp
  ...
  if ( !a4 )
  {
    ...
    {
      if ( (unsigned __int64)*a3 > 0x1FFFFFFFFFFFFFFFLL )
        std::_Xlength_error("vector too long");
      std::vector<CVectorShape *>::_Reallocate_exactly((__int64)v7, *a3);
    }
  }
  v9 = 0LL;
  v10 = this[14];
  ...
  if ( *(_DWORD *)a3 )
  {
    while ( 1 )
    {
      if ( (unsigned int)v9 >= (unsigned __int64)*a3 )
      {
        gsl::details::terminate((gsl::details *)(unsigned int)v9);
        JUMPOUT(0x18009732DLL);
      }
      _mm_lfence();
