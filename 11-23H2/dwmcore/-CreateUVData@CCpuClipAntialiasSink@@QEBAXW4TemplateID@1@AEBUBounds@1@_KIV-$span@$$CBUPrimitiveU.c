/*
 * XREFs of ?CreateUVData@CCpuClipAntialiasSink@@QEBAXW4TemplateID@1@AEBUBounds@1@_KIV?$span@$$CBUPrimitiveUVDesc@@$0?0@gsl@@PEAPEAVUVData@1@@Z @ 0x180037780
 * Callers:
 ...
 * Callees:
 *     ?GetAntialiasTemplateGeometry@CCpuClipAntialiasSink@@QEBAXW4TemplateID@1@AEBUBounds@1@PEAUTemplateGeometryDesc@1@@Z @ 0x18003845C (-GetAntialiasTemplateGeometry@CCpuClipAntialiasSink@@QEBAXW4TemplateID@1@AEBUBounds@1@PEAUTempla.c)
 *     ??A?$span@$$CBUD2D_POINT_2F@@$0?0@gsl@@QEBAAEBUD2D_POINT_2F@@_K@Z @ 0x1800D9FC8 (--A-$span@$$CBUD2D_POINT_2F@@$0-0@gsl@@QEBAAEBUD2D_POINT_2F@@_K@Z.c)
 *     _lambda_2d1d0b9d59cfdef8f44c4926bb7a86e6_::operator() @ 0x1800DFC78 (_lambda_2d1d0b9d59cfdef8f44c4926bb7a86e6_--operator().c)
 *     _lambda_b3835ef70f259f7b8f0c06129dcd6911_::operator() @ 0x1800F036C (_lambda_b3835ef70f259f7b8f0c06129dcd6911_--operator().c)
        ...
        _QWORD *a7)
{
  ...
  v98 = 0LL;
  v99 = 0LL;
  CCpuClipAntialiasSink::GetAntialiasTemplateGeometry(a1, a2, a3, &v92);
