/*
 * XREFs of ??$_Insert_range@PEAPEAVCSceneComponent@@@?$vector@PEAVCSceneComponent@@V?$allocator@PEAVCSceneComponent@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCSceneComponent@@@std@@@std@@@1@PEAPEAVCSceneComponent@@1Uforward_iterator_tag@1@@Z @ 0x1801BE738
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCSceneComponent@@V?$allocator@PEAVCSceneComponent@@@std@@@std@@AEAAXQEAPEAVCSceneComponent@@_K1@Z @ 0x1801CA3F4 (-_Change_array@-$vector@PEAVCSceneComponent@@V-$allocator@PEAVCSceneComponent@@@std@@@std@@AEAAX.c)
 */
        ...
        __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    else
    {
      ...
      std::vector<CSceneComponent *>::_Change_array(a1, v17, v25, v11);
    }
  }
}
