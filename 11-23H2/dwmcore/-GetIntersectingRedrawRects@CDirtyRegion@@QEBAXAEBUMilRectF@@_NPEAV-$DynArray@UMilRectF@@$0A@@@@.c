/*
 * XREFs of ?GetIntersectingRedrawRects@CDirtyRegion@@QEBAXAEBUMilRectF@@_NPEAV?$DynArray@UMilRectF@@$0A@@@@Z @ 0x1801CD93C
 * Callers:
 *     ?GetIntersectingRedrawRects@CDesktopTree@@UEBAXAEBUMilRectF@@_NPEAV?$DynArray@UMilRectF@@$0A@@@@Z @ 0x1801C40F0 (-GetIntersectingRedrawRects@CDesktopTree@@UEBAXAEBUMilRectF@@_NPEAV-$DynArray@UMilRectF@@$0A@@@@.c)
 * Callees:
                ...
                if ( !TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)v59.m128i_i32) )
                {
                  ...
                  v37 = CDirtyRegionAnnotation::GetZ(
                          ...
                          *(const struct CVisualTree **)a1,
                          ...
                          v36);
                  if ( !COcclusionContext::IsOccluded(a1 + 16, (float *)v59.m128i_i32, v37) )
                  {
                    v39 = *(_DWORD *)(a4 + 24);
                    v40 = v39 + 1;
                    if ( v39 + 1 >= v39 )
