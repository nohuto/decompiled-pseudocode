/*
 * XREFs of ?BeginOverlayCandidateCollection@COverlayContext@@QEAAJXZ @ 0x180040418
 * Callers:
...
__int64 __fastcall COverlayContext::BeginOverlayCandidateCollection(COverlayContext *this)
{
  ...
  *((_WORD *)this + 5651) = 0;
  ...
  if ( (unsigned __int8)CMILMatrix::IsTranslateAndScaleIgnoreZ<1>(v5)
  ...
  v11 = dword_1803EA08C;
  v12 = dword_1803EA084;
  if ( TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::sc_rcEmpty >= dword_1803EA088
    || dword_1803EA084 >= dword_1803EA08C )
  {
    **((_DWORD **)this + 1397) = 0;
  }
  else
