/*
 * XREFs of ??$CreateServer@VDataProviderRegistrarConnection@@@BaseBamoConnection@Bamo@Microsoft@@SAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBGPEAPEAVDataProviderRegistrarConnection@@@Z @ 0x1800D4AC0
 * Callers:
        ...
        ...)
{
  ...
  *v7 = &DataProviderRegistrarConnection::`vftable';
  v14 = v7;
  v12 = v8;
  v9 = Microsoft::Bamo::BaseBamoConnection::JoinConversationAsServer(v7, a1, a2, &v12);
  v10 = v9;
  if ( v9 < 0 )
  {
