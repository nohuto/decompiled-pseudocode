/*
 * XREFs of ?reserve_region@?$vector_facade@VPlaneInfo@CCheckMPOCache@@V?$buffer_impl@VPlaneInfo@CCheckMPOCache@@$05$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAVPlaneInfo@CCheckMPOCache@@_K0@Z @ 0x18011B0FC
 * Callers:
 ...
 *     ??$move_backward_uninitialized@V?$basic_iterator@VPlaneInfo@CCheckMPOCache@@@detail@@V?$checked_array_iterator@PEAVPlaneInfo@CCheckMPOCache@@@stdext@@@detail@@YAXV?$basic_iterator@VPlaneInfo@CCheckMPOCache@@@0@0V?$checked_array_iterator@PEAVPlaneInfo@CCheckMPOCache@@@stdext@@@Z @ 0x18011A86C (--$move_backward_uninitialized@V-$basic_iterator@VPlaneInfo@CCheckMPOCache@@@detail@@V-$checked_.c)
