/*
 * XREFs of ?_UpdateEdgyExperienceInput@CManipulation@@AEAAJW4Enum@EdgyCompositionUpdateType@@@Z @ 0x18020F2B4
 * Callers:
...
__int64 __fastcall CManipulation::_UpdateEdgyExperienceInput(__int64 a1)
{
  ...
  if ( *(_QWORD *)(a1 + 720) )
    goto LABEL_11;
  v20 = 0LL;
  v4 = CWeakResourceReference::Get((struct CResource *)a1, (void (__fastcall ****)(LPVOID))&v20);
  v1 = v4;
  if ( v4 < 0 )
  {
