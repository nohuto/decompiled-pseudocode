/*
 * XREFs of ?Present@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@IAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I_N@Z @ 0x180079B74
 * Callers:
 ...
 * Callees:
 *     ?LegacyPresentRequired@COverlayContext@@AEBA_NXZ @ 0x180079CBC (-LegacyPresentRequired@COverlayContext@@AEBA_NXZ.c)
