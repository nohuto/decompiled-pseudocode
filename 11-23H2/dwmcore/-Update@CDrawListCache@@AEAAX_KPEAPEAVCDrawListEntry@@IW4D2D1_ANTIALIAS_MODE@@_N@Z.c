/*
 * XREFs of ?Update@CDrawListCache@@AEAAX_KPEAPEAVCDrawListEntry@@IW4D2D1_ANTIALIAS_MODE@@_N@Z @ 0x1800736F0
 * Callers:
...
LABEL_41:
      ...
      *((_DWORD *)v6 + 23) &= v40;
      ...
      if ( (v39[12] & 0x1000) == 0 )
      {
        ...
        TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v69, &v68);
      }
