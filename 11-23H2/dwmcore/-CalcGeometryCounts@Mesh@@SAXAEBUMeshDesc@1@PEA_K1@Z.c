/*
 * XREFs of ?CalcGeometryCounts@Mesh@@SAXAEBUMeshDesc@1@PEA_K1@Z @ 0x1800CFCB8
 * Callers:
 ...
 *     ?CalcGeometryCountsForRectangle@Mesh@@CAXAEBUMeshDesc@1@PEA_K1@Z @ 0x1801FF0F4 (-CalcGeometryCountsForRectangle@Mesh@@CAXAEBUMeshDesc@1@PEA_K1@Z.c)
 * Callees:
 *     ?CheckExteriorFilterCondition@Mesh@@CA_NAEBUMeshDesc@1@I@Z @ 0x1800CFDA0 (-CheckExteriorFilterCondition@Mesh@@CA_NAEBUMeshDesc@1@I@Z.c)
 *     ?CalcGeometryCountsForRectangle@Mesh@@CAXAEBUMeshDesc@1@PEA_K1@Z @ 0x1801FF0F4 (-CalcGeometryCountsForRectangle@Mesh@@CAXAEBUMeshDesc@1@PEA_K1@Z.c)
 */
