/*
 * XREFs of ?CreateD2DBitmap@CD3DDevice@@QEAAJPEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MMPEAPEAVCD2DBitmap@@@Z @ 0x1800A01A4
 * Callers:
        ...
        _QWORD *a9)
{
  ...
  D3D11_TEXTURE2D_DESC v23; // [rsp+78h] [rbp-29h] BYREF
...
LABEL_7:
    v17 = v12;
LABEL_9:
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802EE308, 2u, v17, v18, 0LL);
  }
  v15 = CD3DDevice::TranslateDXGIorD3DErrorInContext(a1, v11, 0);
