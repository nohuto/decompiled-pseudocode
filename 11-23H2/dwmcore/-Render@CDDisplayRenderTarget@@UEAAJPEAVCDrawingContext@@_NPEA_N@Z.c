/*
 * XREFs of ?Render@CDDisplayRenderTarget@@UEAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1801E84C4
 * Callers:
 *     ?Render@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x18011CE10 (-Render@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 * Callees:
 ...
 *     ?GetCurrentBackBuffer@CLegacySwapChain@@UEBAPEAVIDeviceTarget@@XZ @ 0x1800E3180 (-GetCurrentBackBuffer@CLegacySwapChain@@UEBAPEAVIDeviceTarget@@XZ.c)
        ...
        bool *a4)
{
  ...
  __int64 v43; // [rsp+88h] [rbp-1h] BYREF
...
LABEL_61:
    if ( CDirtyRegion::DoesIntersect(v11, v17) )
    {
      ...
      {
        v20 = gsl::span<CVisual const *,-1>::span<CVisual const *,-1>(&v43, (__int64 *)&v39[3]);
...
LABEL_42:
  ...
  v24 = gsl::span<CVisual const *,-1>::span<CVisual const *,-1>(v44, (__int64 *)&v39[3]);
