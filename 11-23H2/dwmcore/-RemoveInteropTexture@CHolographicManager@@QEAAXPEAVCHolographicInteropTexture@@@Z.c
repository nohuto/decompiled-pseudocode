/*
 * XREFs of ?RemoveInteropTexture@CHolographicManager@@QEAAXPEAVCHolographicInteropTexture@@@Z @ 0x1802A5C78
 * Callers:
      ...
      if ( CompositorTracing::IsEnabled((__int64)Ptr) )
      {
        ...
        if ( *v12 > 4u )
        {
          if ( tlgKeywordOn((__int64)v12, 0x400000000000LL) )
          {
            ...
            v14 = v9;
            v18 = 4;
            tlgWriteTransfer_EventWriteTransfer(v13, (unsigned __int8 *)dword_180382C14, 0LL, 0LL, 3u, &v16);
          }
        }
      }
