/*
 * XREFs of ?Create@CDxHandleAdvancedDirectFlipBitmapRealization@@SAJW4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@PEAVCDecodeBitmap@@PEAPEAVISwapChainRealization@@@Z @ 0x18009F21C
 * Callers:
 ...
 *     ??0CDxHandleAdvancedDirectFlipBitmapRealization@@IEAA@W4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@PEAVCDecodeBitmap@@@Z @ 0x1802B161C (--0CDxHandleAdvancedDirectFlipBitmapRealization@@IEAA@W4CompositionBufferType@@U_LUID@@AEBUCSM_B.c)
        ...
        __int64 *a6)
{
  ...
  {
    v12 = -2003292287;
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_18033C0E0, 3u, -2003292287, 0x25u, 0LL);
LABEL_3:
    v13 = 0LL;
    goto LABEL_4;
  }
  ...
  if ( !v20 )
  {
    ...
    v19 = 51;
LABEL_17:
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_18033C0E0, 3u, v12, v19, 0LL);
LABEL_18:
    if ( v6 )
      *((_QWORD *)v6 + 31) = 0LL;
    goto LABEL_3;
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_18033C0E0, 3u, v16, 0x34u, 0LL);
    goto LABEL_18;
  }
  v18 = v6;
  v6 = 0LL;
