/*
 * XREFs of ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800FF9F0
 * Callers:
...
char __fastcall CCommonRegistryData::IsShaderLinkingBlacklistedGpu(const unsigned __int16 *a1, unsigned __int16 a2)
{
  ...
  {
    v2 = (const struct CCommonRegistryData::GpuId *)&unk_180355024;
    CCommonRegistryData::m_cShaderLinkingBlacklistedGpuIds = 0;
    CCommonRegistryData::m_rgwShaderLinkingBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_180355024;
    v6 = 0;
  }
  if ( !v6 )
    return 0;
