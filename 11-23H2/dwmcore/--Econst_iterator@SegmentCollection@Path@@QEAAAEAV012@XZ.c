/*
 * XREFs of ??Econst_iterator@SegmentCollection@Path@@QEAAAEAV012@XZ @ 0x1800DA0C4
 * Callers:
 ...
 *     ?IsSimpleGeometry@CPathData@@QEBA_NXZ @ 0x1800163C8 (-IsSimpleGeometry@CPathData@@QEBA_NXZ.c)
