/*
 * XREFs of ?AdjustNineGridBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVCNineGridBrush@@@Z @ 0x18024894C
 * Callers:
 ...
 *     ?CalculateBounds@CProjectedShadow@@AEBA?AV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@MPEBVCVisualTree@@@Z @ 0x180248D3C (-CalculateBounds@CProjectedShadow@@AEBA-AV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF.c)
 */
...
LABEL_16:
  ...
  v15 = ((__int64 (__fastcall *)(char *, void *, float *))xmmword_1803E35C8)(
          (char *)v20 + SDWORD2(xmmword_1803E35C8),
  ...
  v15 = ((__int64 (__fastcall *)(char *, void *, struct D2D_MATRIX_3X2_F *))xmmword_1803E3590)(
          (char *)v13 + SDWORD2(xmmword_1803E3590),
