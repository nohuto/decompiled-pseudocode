/*
 * XREFs of ?DepartBufferedOutputPointer@CInteractionProcessor@@QEAA_NIW4InputType@@@Z @ 0x1801AE29C
 * Callers:
 *     ?DepartBufferedOutputPointer@CInteractionRoot@@UEAA_NI@Z @ 0x1801A3F30 (-DepartBufferedOutputPointer@CInteractionRoot@@UEAA_NI@Z.c)
 *     ?DepartBufferedOutputPointer@CInteraction@@UEAA_NI@Z @ 0x18020BA40 (-DepartBufferedOutputPointer@CInteraction@@UEAA_NI@Z.c)
 * Callees:
