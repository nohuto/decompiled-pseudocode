/*
 * XREFs of ?CreateCompositionSwapChain@CD3DDevice@@QEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVICompositionSwapChain@@@Z @ 0x18028C5F4
 * Callers:
        ...
        struct ICompositionSwapChain **a6)
{
  ...
  *a6 = 0LL;
  ...
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_180386F20, 2u, v13, v16, 0LL);
LABEL_17:
