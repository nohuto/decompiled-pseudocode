/*
 * XREFs of ?ReportInertiaStartHelper@@YAH_KIMMAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBU_D3DMATRIX@@@Z @ 0x18019AB64
 * Callers:
 ...
 *     InputTypeToInertiaSourceType @ 0x18019AB28 (InputTypeToInertiaSourceType.c)
 */
