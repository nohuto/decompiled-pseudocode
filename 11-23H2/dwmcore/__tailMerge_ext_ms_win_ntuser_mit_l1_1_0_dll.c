/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_mit_l1_1_0_dll @ 0x180110C69
 * Callers:
 *     __imp_load_MITGetCursorUpdateHandle @ 0x180110C5D (__imp_load_MITGetCursorUpdateHandle.c)
 * Callees:
