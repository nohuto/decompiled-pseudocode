/*
 * XREFs of ?Initialize@CShaderLinkingGraphBuilder@@QEAAJW4D3DShaderProfileVersion@@V?$span@$$CBUSignatureParameter@CShaderLinkingGraphBuilder@@$0?0@gsl@@@Z @ 0x1800B99B4
 * Callers:
 ...
 *     ?_Reallocate_exactly@?$vector@U_D3D11_PARAMETER_DESC@@V?$allocator@U_D3D11_PARAMETER_DESC@@@std@@@std@@AEAAX_K@Z @ 0x1800BC93C (-_Reallocate_exactly@-$vector@U_D3D11_PARAMETER_DESC@@V-$allocator@U_D3D11_PARAMETER_DESC@@@std@.c)
 ...
 *     ??$_Emplace_reallocate@AEBU_D3D11_PARAMETER_DESC@@@?$vector@U_D3D11_PARAMETER_DESC@@V?$allocator@U_D3D11_PARAMETER_DESC@@@std@@@std@@QEAAPEAU_D3D11_PARAMETER_DESC@@QEAU2@AEBU2@@Z @ 0x18020AFF0 (--$_Emplace_reallocate@AEBU_D3D11_PARAMETER_DESC@@@-$vector@U_D3D11_PARAMETER_DESC@@V-$allocator.c)
 */
...
__int64 __fastcall CShaderLinkingGraphBuilder::Initialize(struct ID3D11Linker **ppLinker, char a2, _QWORD *a3)
{
  ...
  unsigned __int8 v40[8]; // [rsp+D0h] [rbp+7h] BYREF
  ...
  *((_BYTE *)ppLinker + 84) = a2;
  ...
  if ( *a3 )
  {
    ...
    std::vector<_D3D11_PARAMETER_DESC>::_Reallocate_exactly(&v28, *a3);
    v3 = v29;
  }
  v6 = a3[1];
  v7 = *((_QWORD *)&v28 + 1);
        ...
        if ( *(_DWORD *)a3 )
        {
          ...
          do
          {
            ...
            if ( (unsigned __int64)v23 >= *a3 )
            {
              ...
              JUMPOUT(0x1800B9C96LL);
            }
            v41 = v35;
            *(_WORD *)v40 = *(_WORD *)(32LL * v23 + v24);
            if ( v35 )
