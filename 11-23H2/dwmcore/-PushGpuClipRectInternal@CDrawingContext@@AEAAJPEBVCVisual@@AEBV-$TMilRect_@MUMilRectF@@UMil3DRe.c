/*
 * XREFs of ?PushGpuClipRectInternal@CDrawingContext@@AEAAJPEBVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4D2D1_ANTIALIAS_MODE@@_N@Z @ 0x18006C304
 * Callers:
 ...
 *     ?HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ @ 0x1800216AC (-HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ.c)
