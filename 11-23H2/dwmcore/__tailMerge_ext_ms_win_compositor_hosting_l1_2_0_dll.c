/*
 * XREFs of __tailMerge_ext_ms_win_compositor_hosting_l1_2_0_dll @ 0x1801104B8
 * Callers:
 *     __imp_load_RegisterManipulationThread @ 0x1801104AC (__imp_load_RegisterManipulationThread.c)
 *     __imp_load_StopAndEndInertia @ 0x1801105C2 (__imp_load_StopAndEndInertia.c)
 * Callees:
