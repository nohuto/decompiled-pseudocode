/*
 * XREFs of ?put_Path@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x18008B8C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::TargetedContentTriggerImpl::put_Path(
        ...
        HSTRING a2)
{
  ...
  v8 = v2;
  v4 = Microsoft::WRL::Wrappers::HString::Set((HSTRING *)this + 13, &v9);
  v5 = v4;
  if ( v4 >= 0 )
    v5 = 0;
  else
