/*
 * XREFs of ??1UniqueExtendedExecutionSession@@UEAA@XZ @ 0x1800A5508
 * Callers:
 *     ??_GUniqueExtendedExecutionSession@@UEAAPEAXI@Z @ 0x1800A5800 (--_GUniqueExtendedExecutionSession@@UEAAPEAXI@Z.c)
 * Callees:
