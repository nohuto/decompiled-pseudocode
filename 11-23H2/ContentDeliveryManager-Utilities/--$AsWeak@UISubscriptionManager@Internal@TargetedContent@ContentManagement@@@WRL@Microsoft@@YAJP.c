/*
 * XREFs of ??$AsWeak@UISubscriptionManager@Internal@TargetedContent@ContentManagement@@@WRL@Microsoft@@YAJPEAUISubscriptionManager@Internal@TargetedContent@ContentManagement@@PEAVWeakRef@01@@Z @ 0x180065C10
 * Callers:
