/*
 * XREFs of ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEA_J@Z @ 0x1800B9580
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a7)
{
  ...
  v12 = std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getifld(
          ...
          *(_DWORD *)(a5 + 24),
          v11);
  v13 = Stollx((unsigned __int8 *)v18, (unsigned __int8 **)&v17, v12, &v15);
