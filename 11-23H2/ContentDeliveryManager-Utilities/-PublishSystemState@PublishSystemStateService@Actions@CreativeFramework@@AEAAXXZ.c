/*
 * XREFs of ?PublishSystemState@PublishSystemStateService@Actions@CreativeFramework@@AEAAXXZ @ 0x1800BA120
 * Callers:
 *     ?Invoke@PublishSystemStateService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800BA030 (-Invoke@PublishSystemStateService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
