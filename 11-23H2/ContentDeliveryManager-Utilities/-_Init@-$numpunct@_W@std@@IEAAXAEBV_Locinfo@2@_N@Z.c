/*
 * XREFs of ?_Init@?$numpunct@_W@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x1800B8920
 * Callers:
 ...
 *     ??$_Maklocstr@D@std@@YAPEADPEBDPEADAEBU_Cvtvec@@@Z @ 0x18004FB60 (--$_Maklocstr@D@std@@YAPEADPEBDPEADAEBU_Cvtvec@@@Z.c)
...
wchar_t *__fastcall std::numpunct<wchar_t>::_Init(mbstate_t a1, __int64 a2, char a3)
{
  ...
  *(_QWORD *)(*(_QWORD *)&a1 + 40LL) = 0LL;
  Getcvt(&v13);
  grouping = (wchar_t *)&word_180106C60;
  if ( !a3 )
