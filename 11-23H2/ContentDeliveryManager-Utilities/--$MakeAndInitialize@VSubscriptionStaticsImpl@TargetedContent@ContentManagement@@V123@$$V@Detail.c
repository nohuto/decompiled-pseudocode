/*
 * XREFs of ??$MakeAndInitialize@VSubscriptionStaticsImpl@TargetedContent@ContentManagement@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAVSubscriptionStaticsImpl@TargetedContent@ContentManagement@@@Z @ 0x18004793C
 * Callers:
 ...
 *     ??0SubscriptionStaticsImpl@TargetedContent@ContentManagement@@QEAA@XZ @ 0x180047FE0 (--0SubscriptionStaticsImpl@TargetedContent@ContentManagement@@QEAA@XZ.c)
