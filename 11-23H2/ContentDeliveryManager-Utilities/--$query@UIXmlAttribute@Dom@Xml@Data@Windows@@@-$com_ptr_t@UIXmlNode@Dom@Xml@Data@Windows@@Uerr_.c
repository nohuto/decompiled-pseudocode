/*
 * XREFs of ??$query@UIXmlAttribute@Dom@Xml@Data@Windows@@@?$com_ptr_t@UIXmlNode@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIXmlAttribute@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800C66C8
 * Callers:
