/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_AccountAndRegionalPolicyEnforcement@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180033F88
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_AccountAndRegionalPolicyEnforcement>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        ...
        int *a4)
{
  ...
  FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0x2D5AAEE, 3u, a3, a4);
  *a2 = 0LL;
