/*
 * XREFs of ?do_get_time@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x1800D18F0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a6 |= v14;
  ...
  if ( *v15
    || (v18 = *(unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*((__int64)a3),
        (*(unsigned __int8 (__fastcall **)(const struct std::locale::facet *, __int64, _QWORD))(*(_QWORD *)v12 + 112LL))(
          v12,
          v18,
          0LL) != 58) )
  {
