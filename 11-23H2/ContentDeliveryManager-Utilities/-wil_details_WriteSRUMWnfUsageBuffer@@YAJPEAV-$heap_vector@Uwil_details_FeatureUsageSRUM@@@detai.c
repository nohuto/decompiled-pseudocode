/*
 * XREFs of ?wil_details_WriteSRUMWnfUsageBuffer@@YAJPEAV?$heap_vector@Uwil_details_FeatureUsageSRUM@@@details_abi@wil@@@Z @ 0x180045808
 * Callers:
...
LABEL_15:
        ...
        updated = wil_details_NtUpdateWnfStateData((unsigned int)&unk_180106B78, (unsigned int)v18, v7, v7, v15, v17, 1);
      }
      ++v6;
    }
