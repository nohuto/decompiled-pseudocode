/*
 * XREFs of Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_6ab1f6f5bfb1610cca41dbb66aaa8812___ @ 0x180073204
 * Callers:
 *     ?UnstageAsync@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUIAsyncAction@Foundation@5@@Z @ 0x1800785E0 (-UnstageAsync@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJ.c)
 * Callees:
