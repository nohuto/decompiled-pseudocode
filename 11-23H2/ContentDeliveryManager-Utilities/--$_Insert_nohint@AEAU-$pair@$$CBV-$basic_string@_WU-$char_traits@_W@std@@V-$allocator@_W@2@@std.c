        ...
        _QWORD *a5)
{
  ...
  try
  {
    while ( !*(_BYTE *)(v9 + 25) )
    {
      v8 = v9;
      v25 = v23;
      v11 = std::wstring::wstring(v23, v9 + 32);
      v12 = std::wstring::wstring(v24, a4);
    ...
    v25 = v24;
    v18 = std::wstring::wstring(v24, a4);
    v19 = std::wstring::wstring(v23, v14 + 32);
