/*
 * XREFs of ?get@?$static_lazy@VTaskbarLogging@@@details@wil@@QEAAPEAVTaskbarLogging@@P6AXXZ@Z @ 0x180043DA0
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<TaskbarLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`TaskbarLogging::Instance'::`2'::wrapper, 0, (PBOOL)&v8, (LPVOID *)&v9) && (_DWORD)v8 )
  {
    ...
    v9 = &qword_180196478;
    qword_180196478 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_180196490 = (__int64)&`TaskbarLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
