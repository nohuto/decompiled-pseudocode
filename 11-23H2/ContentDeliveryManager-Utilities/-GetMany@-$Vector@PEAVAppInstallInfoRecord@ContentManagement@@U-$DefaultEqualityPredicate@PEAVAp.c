...
LABEL_27:
      ...
      v15 = XWinRT::detail::GitStorageType<ContentManagement::IAppInstallInfoRecord>::ReferencedGitCookie::Localize(
              v35[0].m128i_i64[0],
              v20);
LABEL_26:
      if ( v15 < 0 )
...
LABEL_46:
    if ( v9 )
    {
      ...
      do
      {
        XWinRT::InterfaceLifetimeTraits::Destroy<ContentManagement::IAppInstallInfoRecord>(v28++);
        --v27;
      }
      while ( v27 );
    }
        ...
        do
        {
          ...
          *v25 = 0LL;
          if ( v24[8] )
          {
            ...
            if ( v15 < 0 )
              goto LABEL_46;
            XWinRT::detail::GitStorageType<Windows::Services::TargetedContent::Internal::ITargetedContentTriggerInternal>::ReferencedGitCookie::Release(*(_QWORD *)v24);
            v24[8] = 0;
            *(_QWORD *)v24 = 0LL;
            v26 = v36;
          }
