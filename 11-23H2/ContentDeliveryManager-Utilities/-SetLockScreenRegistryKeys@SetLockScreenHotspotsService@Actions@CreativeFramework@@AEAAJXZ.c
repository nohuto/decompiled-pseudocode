/*
 * XREFs of ?SetLockScreenRegistryKeys@SetLockScreenHotspotsService@Actions@CreativeFramework@@AEAAJXZ @ 0x1800BB838
 * Callers:
 *     ?Stage@SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800BBBC0 (-Stage@SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
        ...
        CreativeFramework::Actions::SetLockScreenHotspotsService *this)
{
  ...
  WCHAR v20[264]; // [rsp+288h] [rbp+180h] BYREF
