        ...
        int a2)
{
  ...
  {
    LODWORD(v13) = 0;
    XWinRT::SerializingLockPolicy::Write(&v14, (_DWORD *)(a1 + 160), &v13);
    v3 = v13;
    if ( (int)v13 >= 0 )
    {
