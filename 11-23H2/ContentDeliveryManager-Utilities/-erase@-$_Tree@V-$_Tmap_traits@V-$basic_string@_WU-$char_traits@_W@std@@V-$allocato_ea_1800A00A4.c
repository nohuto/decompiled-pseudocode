 ...
 *     ?_Rrotate@?$_Tree@V?$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@$0A@@std@@@std@@IEAAXPEAU?$_Tree_node@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@PEAX@2@@Z @ 0x180062528 (-_Rrotate@-$_Tree@V-$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V-$.c)
...
LABEL_13:
    ...
    if ( *(_BYTE **)(*a1 + 16) == v6 )
    {
      if ( *(_BYTE *)(v10 + 25) )
        ...
        v14 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Max(v10);
      *(_QWORD *)(a2 + 16) = v14;
    }
    goto LABEL_41;
  }
...
LABEL_58:
    ...
    else
    {
      ...
      {
        v18 = *(_QWORD *)(a2 + 16);
        if ( *(_BYTE *)(v18 + 24) != 1 || *(_BYTE *)(*(_QWORD *)a2 + 24LL) != 1 )
        {
