/*
 * XREFs of ??_GContentManagementService@ContentManagement@@UEAAPEAXI@Z @ 0x180048860
 * Callers:
 *     <none>
 * Callees:
 *     ??1ContentManagementService@ContentManagement@@UEAA@XZ @ 0x1800484BC (--1ContentManagementService@ContentManagement@@UEAA@XZ.c)
 */
