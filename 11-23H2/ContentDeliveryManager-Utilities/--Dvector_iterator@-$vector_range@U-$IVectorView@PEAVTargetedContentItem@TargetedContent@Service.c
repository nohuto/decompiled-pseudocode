/*
 * XREFs of ??Dvector_iterator@?$vector_range@U?$IVectorView@PEAVTargetedContentItem@TargetedContent@Services@Windows@@@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@QEAAAEBV?$ComPtr@UITargetedContentItem@TargetedContent@Services@Windows@@@WRL@Microsoft@@XZ @ 0x1800C7728
 * Callers:
...
__int64 *__fastcall wil::vector_range<Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::TargetedContentItem *>,wil::err_exception_policy>::vector_iterator::operator*(
        __int64 *a1)
{
  __int64 v1; // rsi
  __int64 *v2; // rbp
