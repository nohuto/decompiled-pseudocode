/*
 * XREFs of ?ProcessLayoutBindings@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@QEAAXPEAUHSTRING__@@V1ShellPlacementTelemetry@Logging@3@@Z @ 0x1800CAB98
 * Callers:
 ...
 *     ??$GetActivationFactory@UITargetedContentIdAliasStoreStatics@Internal@TargetedContent@Services@Windows@@@wil@@YA?AV?$com_ptr_t@UITargetedContentIdAliasStoreStatics@Internal@TargetedContent@Services@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800ABCC4 (--$GetActivationFactory@UITargetedContentIdAliasStoreStatics@Internal@TargetedContent@Services@W.c)
 *     ??$LayoutAndItemsRetrieved@_NII@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAX$$QEA_N$$QEAI1@Z @ 0x1800C572C (--$LayoutAndItemsRetrieved@_NII@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework.c)
 *     ??$TargetedContentTilesExtracted@IAEBQEB_W@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAX$$QEAIAEBQEB_W@Z @ 0x1800C5A80 (--$TargetedContentTilesExtracted@IAEBQEB_W@LayoutResolver@ShellPlacementTelemetry@Logging@Creati.c)
 *     ??$TargetedContentTilesExtracted@IPEB_W@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAX$$QEAI$$QEAPEB_W@Z @ 0x1800C5AF0 (--$TargetedContentTilesExtracted@IPEB_W@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeF.c)
        ...
        CreativeFramework::Logging::ShellPlacementTelemetry::LayoutResolver *a3)
{
  ...
  char v30[8]; // [rsp+30h] [rbp-208h] BYREF
  HSTRING v31; // [rsp+38h] [rbp-200h] BYREF
  PCWSTR StringRawBuffer; // [rsp+40h] [rbp-1F8h] BYREF
  __int64 *v33; // [rsp+48h] [rbp-1F0h] BYREF
  __int64 v34[4]; // [rsp+50h] [rbp-1E8h] BYREF
  _QWORD v35[41]; // [rsp+70h] [rbp-1C8h] BYREF
  _QWORD v36[3]; // [rsp+1B8h] [rbp-80h] BYREF
  unsigned __int64 v37; // [rsp+1D0h] [rbp-68h]
  HSTRING_HEADER v38; // [rsp+1D8h] [rbp-60h] BYREF
  ...
  if ( *(_QWORD *)(a1 + 88) || CreativeFramework::TargetedContentLayoutHelpers::DoesCollectionExist(v18, v17) )
  {
    CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver::ExtractTargetedContentTilesInCollection(
      ...
      v17);
    std::wstring::assign((__int64)v36, L"collection");
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    std::wstring::assign((__int64)v36, L"cloud");
LABEL_11:
    v20 = v36;
    if ( v37 >= 8 )
      v20 = (_QWORD *)v36[0];
