/*
 * XREFs of ??1AppManager@ContentManagement@@UEAA@XZ @ 0x18007DDD8
 * Callers:
 *     ??_EAppManager@ContentManagement@@UEAAPEAXI@Z @ 0x18007EA80 (--_EAppManager@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
