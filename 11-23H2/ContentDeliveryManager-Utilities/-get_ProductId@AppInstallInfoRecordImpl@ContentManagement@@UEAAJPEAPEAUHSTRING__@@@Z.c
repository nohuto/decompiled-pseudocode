/*
 * XREFs of ?get_ProductId@AppInstallInfoRecordImpl@ContentManagement@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x18004BAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ContentManagement::AppInstallInfoRecordImpl::get_ProductId(RTL_SRWLOCK *this, HSTRING *a2)
{
  RTL_SRWLOCK *v2; // rbx
  HSTRING Ptr; // rcx
