/*
 * XREFs of ??$ActivateInstance@UIWpnAppInfoProvider@Notifications@Internal@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIWpnAppInfoProvider@Notifications@Internal@1@@Z @ 0x1800C223C
 * Callers:
...
__int64 __fastcall Windows::Foundation::ActivateInstance<Windows::Internal::Notifications::IWpnAppInfoProvider>(
        __int64 a1,
        _QWORD *a2)
{
  int v3; // ebx
  ...
  *a2 = 0LL;
  ...
  if ( v3 >= 0 )
  {
    v4 = *(_QWORD *)&GUID_535aa053_78a8_438b_a1c9_94dcad4a6a67.Data1
    ...
    if ( *(_QWORD *)&GUID_535aa053_78a8_438b_a1c9_94dcad4a6a67.Data1 == *(_QWORD *)&GUID_af86e2e0_b12d_4c6a_9c5a_d7aa65101e90.Data1 )
      v4 = *(_QWORD *)GUID_535aa053_78a8_438b_a1c9_94dcad4a6a67.Data4
