/*
 * XREFs of ??$MakeAndInitialize@VUnlockActionHelper@@V1@AEAPEAUIInspectable@@@Details@WRL@Microsoft@@YAJPEAPEAVUnlockActionHelper@@AEAPEAUIInspectable@@@Z @ 0x18004DB48
 * Callers:
 ...
 *     ??0?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIPendingLaunch@Private@System@Windows@@@Details@WRL@Microsoft@@QEAA@XZ @ 0x180051624 (--0-$RuntimeClassImpl@U-$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIPendingLaunch@Private@.c)
 ...
 *     ?RuntimeClassInitialize@UnlockActionHelper@@QEAAJPEAUIInspectable@@@Z @ 0x1800A7644 (-RuntimeClassInitialize@UnlockActionHelper@@QEAAJPEAUIInspectable@@@Z.c)
