/*
 * XREFs of ?HrToNtStatus@details@wil@@YAJJ@Z @ 0x18003752C
 * Callers:
 ...
 *     ?ResultFromCaughtExceptionInternal@details@wil@@YA?AUResultStatus@12@PEAG_KPEA_N@Z @ 0x18003EFE0 (-ResultFromCaughtExceptionInternal@details@wil@@YA-AUResultStatus@12@PEAG_KPEA_N@Z.c)
 ...
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x1800D5C6B (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
