/*
 * XREFs of ??1last_error_context@wil@@QEAA@XZ @ 0x18002C874
 * Callers:
 ...
 *     ?reset@?$unique_storage@U?$resource_policy@PEAU_TP_TIMER@@P6AXPEAU1@@Z$1?Destroy@?$DestroyThreadPoolTimer@USystemThreadPoolMethods@details@wil@@$0A@@details@wil@@SAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAU_TP_TIMER@@@Z @ 0x1800454C0 (-reset@-$unique_storage@U-$resource_policy@PEAU_TP_TIMER@@P6AXPEAU1@@Z$1-Destroy@-$DestroyThread.c)
 ...
 *     ?reset@?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@_E$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEAAXPEAX@Z @ 0x180045588 (-reset@-$unique_storage@U-$resource_policy@PEAXP6AXPEAX@_E$1-CloseHandle@details@wil@@YAX0@ZU-$i.c)
 ...
 *     _wil::details::StagingFailureInformation::StagingFailureInformation_::_1_::dtor$0 @ 0x1800D51A1 (_wil--details--StagingFailureInformation--StagingFailureInformation_--_1_--dtor$0.c)
 *     _wil::details_abi::heap_buffer::reserve_::_1_::dtor$0 @ 0x1800D5FA7 (_wil--details_abi--heap_buffer--reserve_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
