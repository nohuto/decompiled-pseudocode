/*
 * XREFs of ?GetTileIdforNavigationUrl@EdgeTileUtils@@YAJPEB_WPEAPEA_W@Z @ 0x1800BE8A8
 * Callers:
 ...
 *     ?TileIdtoPWSTR@EdgeTileUtils@@YAJKPEAPEA_W@Z @ 0x1800BF21C (-TileIdtoPWSTR@EdgeTileUtils@@YAJKPEAPEA_W@Z.c)
