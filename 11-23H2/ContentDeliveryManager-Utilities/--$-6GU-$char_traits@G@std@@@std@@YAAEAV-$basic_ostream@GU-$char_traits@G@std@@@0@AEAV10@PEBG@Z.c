/*
 * XREFs of ??$?6GU?$char_traits@G@std@@@std@@YAAEAV?$basic_ostream@GU?$char_traits@G@std@@@0@AEAV10@PEBG@Z @ 0x1800658C0
 * Callers:
 ...
 * Callees:
 *     ??0sentry@?$basic_ostream@GU?$char_traits@G@std@@@std@@QEAA@AEAV12@@Z @ 0x18005217C (--0sentry@-$basic_ostream@GU-$char_traits@G@std@@@std@@QEAA@AEAV12@@Z.c)
...
__int64 __fastcall std::operator<<<unsigned short,std::char_traits<unsigned short>>(__int64 a1, _WORD *a2)
{
  ...
  if ( v7 <= 0 || v7 <= v5 )
    ...
    v8 = v7 - v5;
  std::basic_ostream<unsigned short>::sentry::sentry((__int64)&v13, v3);
  if ( v14 )
  {
