/*
 * XREFs of ??_EPinWebsiteToTaskbarService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800ACFF0
 * Callers:
 *     <none>
 * Callees:
 *     ??1SetDefaultApplicationService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800AC970 (--1SetDefaultApplicationService@Actions@CreativeFramework@@UEAA@XZ.c)
 */
