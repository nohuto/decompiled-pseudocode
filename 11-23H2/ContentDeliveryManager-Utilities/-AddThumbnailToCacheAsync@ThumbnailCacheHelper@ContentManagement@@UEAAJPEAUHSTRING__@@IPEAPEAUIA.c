        ...
        struct Windows::Foundation::IAsyncAction **a4)
{
  ...
  *a4 = 0LL;
  if ( a2 )
  {
    ...
    v17 = 0;
    v18 = a2;
    v7 = Windows::Internal::String::Duplicate(&v16, (const struct Windows::Internal::String *)&v18);
    v6 = v7;
    if ( v7 >= 0 )
    {
      v18 = v16;
