/*
 * XREFs of ?_Init@?$ctype@_W@std@@IEAAXAEBV_Locinfo@2@@Z @ 0x180061B9C
 * Callers:
 *     ??0?$ctype@G@std@@QEAA@AEBV_Locinfo@1@_K@Z @ 0x1800519D0 (--0-$ctype@G@std@@QEAA@AEBV_Locinfo@1@_K@Z.c)
 * Callees:
