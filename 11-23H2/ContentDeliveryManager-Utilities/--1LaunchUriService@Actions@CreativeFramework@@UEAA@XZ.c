/*
 * XREFs of ??1LaunchUriService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800B1B44
 * Callers:
 *     ??_GLaunchUriService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800B1E90 (--_GLaunchUriService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
