/*
 * XREFs of ?DeleteDesktopSpotlightCreative@DesktopSpotlightHelpers@CreativeFramework@@YAJPEB_WPEA_N@Z @ 0x1800BBF9C
 * Callers:
 ...
 *     ?Unstage@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800BCF40 (-Unstage@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?c_str@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEBAPEB_WXZ @ 0x180096E18 (-c_str@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEBAPEB_WXZ.c)
