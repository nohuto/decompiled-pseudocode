/*
 * XREFs of ?RegisterWnfTrigger@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x180098970
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  int v26; // [rsp+60h] [rbp-F8h] BYREF
  unsigned int v27; // [rsp+64h] [rbp-F4h] BYREF
  ...
  try
  {
    ...
    v10 = std::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>(
            v32,
            (__int64 *)a2);
    v11 = v26;
    v12 = (int)v29;
    Reserved1 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v35, (const WCHAR **)&off_1800F5640, v13)[1].Reserved.Reserved1;
    v16 = (const WCHAR *)v33;
    if ( v33[3] >= 8uLL )
