 ...
 *     ??_9IStorageFolderStatics@Storage@Windows@@$BDA@AA @ 0x1800A1A60 (--_9IStorageFolderStatics@Storage@Windows@@$BDA@AA.c)
 */
        ...
        _QWORD *a4)
{
  ...
  v7 =  Windows::Storage::IStorageFolderStatics::`vcall'{48,{flat}}(a2, *a4, &v11);
  if ( v7 < 0 )
