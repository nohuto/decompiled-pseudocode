/*
 * XREFs of ??$ActivateInstance@UIExtendedExecutionSession@ExtendedExecution@ApplicationModel@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIExtendedExecutionSession@ExtendedExecution@ApplicationModel@1@@Z @ 0x1800A400C
 * Callers:
