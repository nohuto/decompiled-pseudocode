/*
 * XREFs of _std::basic_string_wchar_t_std::char_traits_wchar_t__std::allocator_wchar_t___::_Copy_::_1_::catch$0 @ 0x1800D901F
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::basic_string_wchar_t_std::char_traits_wchar_t__std::allocator_wchar_t___::_Copy_::_1_::catch_0(
        ...
        __int64 a2)
{
  std::wstring::_Tidy(*(_QWORD **)(a2 + 112), 1, 0LL);
  throw;
}
