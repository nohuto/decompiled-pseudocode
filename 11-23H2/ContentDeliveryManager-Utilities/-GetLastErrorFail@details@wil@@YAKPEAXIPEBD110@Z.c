/*
 * XREFs of ?GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z @ 0x1800352A0
 * Callers:
 ...
 *     ?GetLastErrorFailHr@details@wil@@YAJXZ @ 0x18003530C (-GetLastErrorFailHr@details@wil@@YAJXZ.c)
