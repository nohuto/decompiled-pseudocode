/*
 * XREFs of ??1CreativeEventReportedCache@ContentManagement@@UEAA@XZ @ 0x180053498
 * Callers:
 *     ??_GCreativeEventReportedCache@ContentManagement@@UEAAPEAXI@Z @ 0x1800548F0 (--_GCreativeEventReportedCache@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
