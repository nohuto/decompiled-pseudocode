 ...
 *     ?get_SuggestionsDisabled@MobilityExperienceSettings@ContentManagement@@UEAAJPEAE@Z @ 0x1800449D0 (-get_SuggestionsDisabled@MobilityExperienceSettings@ContentManagement@@UEAAJPEAE@Z.c)
 *     ?get_YourPhoneTaskbarIconCreated@MobilityExperienceSettings@ContentManagement@@UEAAJPEAE@Z @ 0x180044AF0 (-get_YourPhoneTaskbarIconCreated@MobilityExperienceSettings@ContentManagement@@UEAAJPEAE@Z.c)
 * Callees:
 *     <none>
 */
