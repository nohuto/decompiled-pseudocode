/*
 * XREFs of ?_Concat@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAJPEBG_K@Z @ 0x1800C4614
 * Callers:
 ...
 *     ?StringCchCopyNW@@YAJPEAG_KPEBG1@Z @ 0x180079318 (-StringCchCopyNW@@YAJPEAG_KPEBG1@Z.c)
 */
