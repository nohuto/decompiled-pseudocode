 ...
 *     _lambda_4f27881777b3828299edd9a0e9cb6746_::__lambda_4f27881777b3828299edd9a0e9cb6746_ @ 0x18008F9D4 (_lambda_4f27881777b3828299edd9a0e9cb6746_--__lambda_4f27881777b3828299edd9a0e9cb6746_.c)
        ...
        __int64 *a5)
{
  ...
  HSTRING v22; // [rsp+30h] [rbp-D0h] BYREF
  char v23; // [rsp+38h] [rbp-C8h]
  HSTRING v24; // [rsp+40h] [rbp-C0h] BYREF
  char v25; // [rsp+48h] [rbp-B8h]
  HSTRING v26; // [rsp+50h] [rbp-B0h] BYREF
  int v27; // [rsp+58h] [rbp-A8h]
  HSTRING v28; // [rsp+60h] [rbp-A0h] BYREF
  __int64 v29; // [rsp+68h] [rbp-98h] BYREF
  std::_Ref_count_base *v30; // [rsp+70h] [rbp-90h]
  __int64 v31; // [rsp+80h] [rbp-80h] BYREF
  __int64 v32[2]; // [rsp+88h] [rbp-78h] BYREF
  char v33; // [rsp+98h] [rbp-68h]
  HSTRING v34; // [rsp+A0h] [rbp-60h]
  char v35; // [rsp+A8h] [rbp-58h]
  void **v36; // [rsp+B0h] [rbp-50h] BYREF
  __int64 v37; // [rsp+1F0h] [rbp+F0h] BYREF
  _QWORD v38[40]; // [rsp+200h] [rbp+100h] BYREF
  ...
  *a5 = 0LL;
  ...
  v38[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerGetTriggeredItemsForStateActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerGetTriggeredItemsForStateActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerGetTriggeredItemsForStateActivity *)v38,
    v10,
    StringRawBuffer,
    (const char *)(v8 + 8));
  v22 = 0LL;
  v23 = 0;
  v11 = Windows::Internal::String::Initialize(&v22, &v26);
  v12 = v11;
  if ( v11 < 0 )
  {
    ...
    ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerGetTriggeredItemsForStateActivity::~TriggerManagerGetTriggeredItemsForStateActivity((ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerGetTriggeredItemsForStateActivity *)v38);
    if ( v30 )
  ...
  v24 = 0LL;
  v25 = 0;
  v14 = Windows::Internal::String::Initialize(&v24, &v28);
  v12 = v14;
  if ( v14 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
  ...
  wil::ActivityBase<ContentDeliveryManager::Background::ContentDeliveryManagerLogging,1,0,5,0,_TlgReflectorTag_Param0IsProviderType>::ActivityBase<ContentDeliveryManager::Background::ContentDeliveryManagerLogging,1,0,5,0,_TlgReflectorTag_Param0IsProviderType>(
    (__int64)&v36,
    (__int64)v38);
  v36 = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerGetTriggeredItemsForStateActivity::`vftable';
  std::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>::shared_ptr<ContentDeliveryManager::Background::CorrelationVectorWrapper>(
    &v37,
    &v29);
  v26 = (HSTRING)0x8200000003LL;
  v27 = 0;
  v17 = Windows::Internal::MakeOpLambda_0_Windows::Internal::CMarshaledInterfaceResult_Windows::Foundation::Collections::IVectorView_Windows::Services::TargetedContent::Internal::TargetedContentTriggerInternal_______lambda_4f27881777b3828299edd9a0e9cb6746___((__int64)&v31);
  v19 = Windows::Internal::MakeAsyncHelper<Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::Internal::TargetedContentTriggerInternal *> *>,Windows::Foundation::IAsyncOperationCompletedHandler<Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::Internal::TargetedContentTriggerInternal *> *>,Windows::Internal::INilDelegate,Windows::Internal::CMarshaledInterfaceResult<Windows::Foundation::Collections::IVectorView<Windows::Services::TargetedContent::Internal::TargetedContentTriggerInternal *>>,Windows::Internal::ComTaskPoolHandler,Microsoft::WRL::AsyncOptions<-1,0,&_GUID const GUID_CAUSALITY_WINDOWS_PLATFORM_ID,2>>(
          a5,
          (__int64)&v26,
          (__int64)L"Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Services.Ta"
                    "rgetedContent.Internal.TargetedContentTriggerInternal>>",
          v18,
          (__int64)v17);
  lambda_4f27881777b3828299edd9a0e9cb6746_::__lambda_4f27881777b3828299edd9a0e9cb6746_((__int64)&v31);
  if ( v19 >= 0 )
  {
    if ( a1 != 40 )
