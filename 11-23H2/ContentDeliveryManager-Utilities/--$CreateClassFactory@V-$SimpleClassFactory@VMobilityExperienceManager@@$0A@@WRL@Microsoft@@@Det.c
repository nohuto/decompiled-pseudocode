/*
 * XREFs of ??$CreateClassFactory@V?$SimpleClassFactory@VMobilityExperienceManager@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x1800C1150
 * Callers:
 *     <none>
 * Callees:
 *     ??$MakeAndInitialize@V?$SimpleClassFactory@VMobilityExperienceManager@@$0A@@WRL@Microsoft@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAV?$SimpleClassFactory@VMobilityExperienceManager@@$0A@@12@@Z @ 0x1800C124C (--$MakeAndInitialize@V-$SimpleClassFactory@VMobilityExperienceManager@@$0A@@WRL@Microsoft@@V123@.c)
