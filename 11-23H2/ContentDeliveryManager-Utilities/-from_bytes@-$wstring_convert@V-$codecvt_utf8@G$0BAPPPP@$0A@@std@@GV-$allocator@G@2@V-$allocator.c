/*
 * XREFs of ?from_bytes@?$wstring_convert@V?$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV?$allocator@G@2@V?$allocator@D@2@@std@@QEAA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@PEBD0@Z @ 0x18007222C
 * Callers:
        ...
        unsigned __int8 *a4)
{
  ...
  _BYTE pExceptionObject[24]; // [rsp+68h] [rbp-51h] BYREF
  _QWORD v17[2]; // [rsp+80h] [rbp-39h] BYREF
