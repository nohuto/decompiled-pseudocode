/*
 * XREFs of ??0?$IVector@PEAUIInspectable@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x1800C6AE4
 * Callers:
 ...
 * Callees:
 *     ??0?$IVector_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@QEAA@XZ @ 0x1800C6B44 (--0-$IVector_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@QEAA@XZ.c)
 */
