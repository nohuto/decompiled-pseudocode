/*
 * XREFs of _wil::wait_for_completion_Windows::Internal::Security::Authentication::Web::GetDefaultSignInAccountResult___Microsoft::WRL::ComPtr_Windows::Internal::Security::Authentication::Web::IGetDefaultSignInAccountResult____::_1_::dtor$0 @ 0x1800DA74C
 * Callers:
 *     <none>
 * Callees:
