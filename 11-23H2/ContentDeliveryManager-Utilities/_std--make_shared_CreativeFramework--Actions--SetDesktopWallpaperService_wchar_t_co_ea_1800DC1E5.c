/*
 * XREFs of _std::make_shared_CreativeFramework::Actions::SetDesktopWallpaperService_wchar_t_const___wchar_t_const___wchar_t_const____::_1_::dtor$1 @ 0x1800DC1E5
 * Callers:
 *     <none>
 * Callees:
