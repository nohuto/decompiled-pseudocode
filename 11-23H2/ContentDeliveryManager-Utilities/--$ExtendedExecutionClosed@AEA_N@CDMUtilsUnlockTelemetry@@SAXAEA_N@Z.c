/*
 * XREFs of ??$ExtendedExecutionClosed@AEA_N@CDMUtilsUnlockTelemetry@@SAXAEA_N@Z @ 0x1800A4530
 * Callers:
...
char __fastcall CDMUtilsUnlockTelemetry::ExtendedExecutionClosed<bool &>(char *a1)
{
  ...
  if ( *(_DWORD *)v2 > 5u )
  {
    ...
    if ( (_BYTE)v2 )
    {
      ...
      v6 = v4;
      v9 = 1;
      LOBYTE(v2) = tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_18017DDA7, 0LL, 0LL, 3u, &v7);
    }
  }
  return (char)v2;
}
