/*
 * XREFs of ?do_get@?$money_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0_NAEAVios_base@2@AEAHAEAO@Z @ 0x1800180E0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a8)
{
  ...
  v15[1] = -2LL;
  std::money_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getmfld(a1, v16, a3, (_QWORD *)a4, a5, a6, v18);
  if ( !*(_BYTE *)(a3 + 8) )
