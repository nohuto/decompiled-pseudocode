        ...
        unsigned __int64 *a5)
{
  ...
  if ( a4 )
  {
    ...
    if ( (__int64)(*(_QWORD *)(a1 + 16) - (_QWORD)v10) >> 3 >= a4 )
    {
      ...
      if ( v10 - a3 >= a4 )
      {
        v23 = &v10[v20 / 0xFFFFFFFFFFFFFFF8uLL];
      ...
      else
      {
        ...
        *(_QWORD *)(a1 + 8) = &v22[(unsigned __int64)v20 / 8];
      }
    ...
    else
    {
      ...
      if ( v14 >= v12 )
        v12 = v14;
      v25 = v12;
      v15 = (_QWORD *)std::_Wrap_alloc<std::_Wrap_alloc<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::shared_ptr<ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl::SubscriptionMapValue>>>>>>>>::allocate();
      v17 = v15;
      v26 = v15;
      ...
      v19 = ((__int64)(*(_QWORD *)(a1 + 8) - *(_QWORD *)a1) >> 3) + a4;
      if ( *(_QWORD *)a1 )
