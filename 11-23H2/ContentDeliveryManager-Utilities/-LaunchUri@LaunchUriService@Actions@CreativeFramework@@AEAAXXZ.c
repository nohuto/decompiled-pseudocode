/*
 * XREFs of ?LaunchUri@LaunchUriService@Actions@CreativeFramework@@AEAAXXZ @ 0x1800B3CD8
 * Callers:
 *     ?Invoke@LaunchUriService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800B3BB0 (-Invoke@LaunchUriService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?CreateApplicationUserModelIdFromPackageData@LaunchUriService@Actions@CreativeFramework@@AEAA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W0@Z @ 0x1800B2130 (-CreateApplicationUserModelIdFromPackageData@LaunchUriService@Actions@CreativeFramework@@AEAA-AV.c)
...
void __fastcall CreativeFramework::Actions::LaunchUriService::LaunchUri(void **this)
{
  ...
  __int64 v14; // rcx
  __int64 v15; // rbx
  __int64 (__fastcall *v16)(__int64, PVOID, void *, _QWORD); // r15
  ...
  void *v31[3]; // [rsp+58h] [rbp-31h] BYREF
  ...
  if ( *((_BYTE *)this + 113) )
  {
    std::wstring::operator=(v31, this + 5);
    v4 = v32;
  }
  v29 = 0LL;
  v5 = v27;
  ...
  {
    v15 = v27;
    v16 = *(__int64 (__fastcall **)(__int64, PVOID, void *, _QWORD))(*(_QWORD *)v27 + 56LL);
    v17 = *((_DWORD *)this + 29);
    v18 = this[13];
    v19 = (const WCHAR *)(this + 9);
    if ( (unsigned __int64)this[12] >= 8 )
      v19 = *(const WCHAR **)v19;
    v20 = (const WCHAR *)(this + 5);
