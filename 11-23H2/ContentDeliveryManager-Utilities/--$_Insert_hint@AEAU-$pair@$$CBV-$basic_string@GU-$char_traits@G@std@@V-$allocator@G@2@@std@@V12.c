        ...
        _QWORD *a5)
{
  ...
  if ( a1[1] )
  {
    if ( a3 == *v8 )
    {
      if ( std::wstring::compare(a4, (const wchar_t *)(a3 + 32)) < 0 )
      {
    ...
    if ( (_QWORD *)a3 == v8 )
    {
      if ( std::wstring::compare((const wchar_t *)(v8[2] + 32LL), a4) < 0 )
      {
        std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_at<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
          a1,
          a2,
    ...
    {
      v14 = std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Max(*(_QWORD *)v13);
    }
    if ( std::wstring::compare((const wchar_t *)(v14 + 32), a4) >= 0 )
    {
LABEL_26:
      if ( std::wstring::compare((const wchar_t *)(v13 + 32), a4) >= 0
        || (v22 = v17,
            ...
            v19 = (_QWORD *)v22,
            v22 != *a1)
        && std::wstring::compare(a4, (const wchar_t *)(v22 + 32)) >= 0 )
      {
LABEL_31:
