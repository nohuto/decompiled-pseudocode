/*
 * XREFs of ??$ReportFailure_Hr@$01@details@wil@@YAXPEAXIPEBD110J@Z @ 0x180028418
 * Callers:
 *     ?GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z @ 0x1800352A0 (-GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z.c)
