/*
 * XREFs of ?GetEventNameFromToken@ContentManagement@@YA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@PEBG@Z @ 0x180058384
 * Callers:
 *     ?IsHighPriorityEvent@ContentManagement@@YA_NPEBG@Z @ 0x18005A280 (-IsHighPriorityEvent@ContentManagement@@YA_NPEBG@Z.c)
 * Callees:
