/*
 * XREFs of ?_Log_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180042F10
 * Callers:
 ...
 *     ?CloseConnection@ContentManagementService@ContentManagement@@AEAAXXZ @ 0x1800552A4 (-CloseConnection@ContentManagementService@ContentManagement@@AEAAXXZ.c)
 ...
 *     ??0SwapStartTileService@Actions@CreativeFramework@@QEAA@PEB_W0AEBUSwapStartTileProperties@12@@Z @ 0x1800AC678 (--0SwapStartTileService@Actions@CreativeFramework@@QEAA@PEB_W0AEBUSwapStartTileProperties@12@@Z.c)
