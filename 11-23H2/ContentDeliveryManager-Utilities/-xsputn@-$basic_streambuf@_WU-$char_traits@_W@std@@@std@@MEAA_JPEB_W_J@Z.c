/*
 * XREFs of ?xsputn@?$basic_streambuf@_WU?$char_traits@_W@std@@@std@@MEAA_JPEB_W_J@Z @ 0x1800655E0
 * Callers:
 *     <none>
 * Callees:
 *     ?_Pnavail@?$basic_streambuf@GU?$char_traits@G@std@@@std@@IEBA_JXZ @ 0x180062380 (-_Pnavail@-$basic_streambuf@GU-$char_traits@G@std@@@std@@IEBA_JXZ.c)
