/*
 * XREFs of _lambda_929976d9f769b9ae6bfa1e1f0592e0ca_::operator() @ 0x180053B1C
 * Callers:
 ...
 *     ?ResolveEventNotificationHandlerFromType@ContentManagement@@YA?AV?$function@$$A6AJXZ@std@@W4EventNotificationType@1@@Z @ 0x18005D3A8 (-ResolveEventNotificationHandlerFromType@ContentManagement@@YA-AV-$function@$$A6AJXZ@std@@W4Even.c)
