/*
 * XREFs of ?GetOrCreateBaseEventForPlacementId@?$GenericOffersHealthTracker@$0L@$00@details@Health@CreativeFramework@@CA?AV?$shared_ptr@VBaseScenarioEvents@details@Health@CreativeFramework@@@std@@AEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@6@@Z @ 0x180059500
 * Callers:
 ...
 *     ??0?$shared_ptr@VIRuleSetHandler@RuleSetHandlers@CreativeFramework@@@std@@QEAA@AEBV01@@Z @ 0x180051A64 (--0-$shared_ptr@VIRuleSetHandler@RuleSetHandlers@CreativeFramework@@@std@@QEAA@AEBV01@@Z.c)
 *     ??1?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@2@@std@@QEAA@XZ @ 0x18005332C (--1-$pair@$$CBV-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@V-$shared_ptr@VIS.c)
 *     ?ResolveIsCriticalHealthEnabledForPlacementId@?$GenericOffersHealthTracker@$0L@$00@details@Health@CreativeFramework@@CA_NPEBG@Z @ 0x18005D538 (-ResolveIsCriticalHealthEnabledForPlacementId@-$GenericOffersHealthTracker@$0L@$00@details@Healt.c)
 *     ?_Decref@_Ref_count_base@std@@QEAAXXZ @ 0x180060444 (-_Decref@_Ref_count_base@std@@QEAAXXZ.c)
 *     ?find@?$_Tree@V?$_Tmap_traits@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$shared_ptr@VBaseScenarioEvents@details@Health@CreativeFramework@@@2@U?$less@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$shared_ptr@VBaseScenarioEvents@details@Health@CreativeFramework@@@2@@std@@@2@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$shared_ptr@VBaseScenarioEvents@details@Health@CreativeFramework@@@2@@std@@@std@@@std@@@2@AEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@@Z @ 0x180064424 (-find@-$_Tree@V-$_Tmap_traits@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V-$s.c)
 */
        ...
        const WCHAR *a2)
{
  ...
  __int64 v10; // rcx
  __int64 v11; // rdx
  bool v13[8]; // [rsp+20h] [rbp-29h] BYREF
  RTL_SRWLOCK *v14; // [rsp+28h] [rbp-21h] BYREF
  _QWORD *v15; // [rsp+30h] [rbp-19h] BYREF
  std::_Ref_count_base *v16; // [rsp+38h] [rbp-11h]
  char v17[16]; // [rsp+48h] [rbp-1h] BYREF
  _BYTE v18[48]; // [rsp+58h] [rbp+Fh] BYREF

  v15 = a1;
  AcquireSRWLockShared(&CreativeFramework::Health::details::s_rwLock);
  v14 = &CreativeFramework::Health::details::s_rwLock;
  std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::Health::details::BaseScenarioEvents>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::Health::details::BaseScenarioEvents>>>,0>>::find(
    ...
    &v15,
    a2);
  if ( v15 == (_QWORD *)CreativeFramework::Health::details::s_placementToBaseScenarioEventsMap )
  {
    ...
    if ( v15 == (_QWORD *)CreativeFramework::Health::details::s_placementToBaseScenarioEventsMap )
    {
      if ( *((_QWORD *)a2 + 3) < 8uLL )
        ...
        v7 = *(const WCHAR **)a2;
      v13[0] = (unsigned __int8)CreativeFramework::Health::details::GenericOffersHealthTracker<11,1>::ResolveIsCriticalHealthEnabledForPlacementId(v7) != 0;
      v8 = std::make_shared<CreativeFramework::Health::details::BaseEventsWithEvaluation<1>,std::wstring const &,bool const &>(
             &v15,
             (__int64)a2,
             v13);
      v9 = std::make_pair<std::wstring const &,std::shared_ptr<CreativeFramework::Health::details::BaseEventsWithEvaluation<1>>>(
             (__int64)v18,
             (__int64)a2,
             (__int64)v8);
      v6 = *(_QWORD **)std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::Health::details::BaseScenarioEvents>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::Health::details::BaseScenarioEvents>>>,0>>::insert<std::pair<std::wstring,std::shared_ptr<CreativeFramework::Health::details::BaseEventsWithEvaluation<1>>>>(
                         v10,
                         (__int64)v17,
                         v9);
    ...
    std::shared_ptr<CreativeFramework::RuleSetHandlers::IRuleSetHandler>::shared_ptr<CreativeFramework::RuleSetHandlers::IRuleSetHandler>(
      a1,
      v6 + 8);
