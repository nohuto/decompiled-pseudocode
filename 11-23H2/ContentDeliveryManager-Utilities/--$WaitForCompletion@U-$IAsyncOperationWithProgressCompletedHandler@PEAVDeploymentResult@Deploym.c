        ...
        __int64 a3)
{
  ...
  if ( v4 >= 0 )
  {
    v4 = ((__int64 (__fastcall *)(__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *), __int64))(*a1)[8])(a1, v17);
    v15 = v4;
    if ( v4 >= 0 )
    {
