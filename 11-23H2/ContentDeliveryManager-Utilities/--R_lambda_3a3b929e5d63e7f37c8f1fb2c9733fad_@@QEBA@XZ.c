/*
 * XREFs of ??R_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@QEBA@XZ @ 0x18002CEE0
 * Callers:
 *     ?Run@?$functor_wrapper_void@AEAV_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@@details@wil@@UEAAJXZ @ 0x18003F710 (-Run@-$functor_wrapper_void@AEAV_lambda_3a3b929e5d63e7f37c8f1fb2c9733fad_@@@details@wil@@UEAAJXZ.c)
 * Callees:
 ...
 *     ??$YourPhoneTaskbarIconCreated@AEAW4TaskbarPinReason@Pinning@Mobility@@@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@SAXAEAW4TaskbarPinReason@Pinning@Mobility@@@Z @ 0x180029594 (--$YourPhoneTaskbarIconCreated@AEAW4TaskbarPinReason@Pinning@Mobility@@@MobilityExperienceTeleme.c)
 ...
 *     ?isTaskbarIconCreationBlockedByPolicy@Policy@Mobility@@YA_NXZ @ 0x180044B40 (-isTaskbarIconCreationBlockedByPolicy@Policy@Mobility@@YA_NXZ.c)
        ...
        if ( (_BYTE)MobilityValue )
        {
            ...
            || (LOBYTE(MobilityValue) = Mobility::Pinning::IsInRestrictedRegion(v8), !(_BYTE)MobilityValue) )
          {
            if ( *a1 != 2 && a1[1] != 2 && (*a1 == 1 || a1[1] == 1 || a1[2] == 1) )
            {
              ...
              {
                v26 = TaskbarContentDeliveryPinningTelemetry::Instance();
