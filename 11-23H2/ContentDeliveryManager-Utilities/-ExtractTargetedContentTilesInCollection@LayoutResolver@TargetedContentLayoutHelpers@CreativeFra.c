/*
 * XREFs of ?ExtractTargetedContentTilesInCollection@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXPEB_W@Z @ 0x1800C7F70
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  if ( *((_QWORD *)this + 11) )
  {
    ...
    for ( i = 0; i != v15; i = ++v12 )
    {
      v5 = *(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(*(_QWORD *)v11 + 48LL);
