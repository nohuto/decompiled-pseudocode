/*
 * XREFs of ?Localize@ReferencedGitCookie@?$GitStorageType@UIAppInstallInfoRecord@ContentManagement@@@detail@XWinRT@@QEAAJPEAPEAUIAppInstallInfoRecord@ContentManagement@@@Z @ 0x180082850
 * Callers:
