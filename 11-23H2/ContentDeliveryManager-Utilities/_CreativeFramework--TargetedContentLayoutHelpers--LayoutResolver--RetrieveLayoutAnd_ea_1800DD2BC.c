/*
 * XREFs of _CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver::RetrieveLayoutAndItems_::_1_::catch$23 @ 0x1800DD2BC
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  v4 = (const char *)WindowsGetStringRawBuffer(*(HSTRING *)(*(_QWORD *)(a2 + 96) + 8LL), 0LL);
