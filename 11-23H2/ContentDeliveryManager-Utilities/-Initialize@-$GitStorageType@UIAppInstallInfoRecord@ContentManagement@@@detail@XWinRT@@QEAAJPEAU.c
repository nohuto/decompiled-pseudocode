  ...
  if ( (int)IUnknown::QueryInterface<IAgileObject>(a2, (__int64)&v10) < 0 )
  {
    ...
    if ( v6 )
    {
      *v6 = 1;
      ...
      if ( v9 >= 0 )
        v9 = (*(__int64 (__fastcall **)(__int64, __int64 (__fastcall ***)(_QWORD, GUID *, __int64), GUID *, _DWORD *))(*(_QWORD *)qword_1801964B8 + 24LL))(
               qword_1801964B8,
               a2,
