/*
 * XREFs of _wil::wait_for_completion_Windows::Foundation::Collections::IVectorView_HSTRING________Microsoft::WRL::ComPtr_Windows::Foundation::Collections::IVectorView_HSTRING__________::_1_::dtor$0 @ 0x1800DCA8C
 * Callers:
 *     <none>
 * Callees:
