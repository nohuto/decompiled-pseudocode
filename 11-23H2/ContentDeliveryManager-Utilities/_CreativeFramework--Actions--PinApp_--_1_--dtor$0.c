/*
 * XREFs of _CreativeFramework::Actions::PinApp_::_1_::dtor$0 @ 0x1800DBB11
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CreativeFramework::Actions::PinApp_::_1_::dtor_0(__int64 a1, __int64 a2)
{
