/*
 * XREFs of ??1ActivityToastNotificationCallback@ToastNotification@@UEAA@XZ @ 0x18006E734
 * Callers:
 *     ??_EActivityToastNotificationCallback@ToastNotification@@UEAAPEAXI@Z @ 0x18006ED90 (--_EActivityToastNotificationCallback@ToastNotification@@UEAAPEAXI@Z.c)
 * Callees:
