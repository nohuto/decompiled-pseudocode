/*
 * XREFs of ?wnf_publish@wil@@YAXAEBU_WNF_STATE_NAME@@@Z @ 0x18006C1CC
 * Callers:
 ...
 *     ?Commit@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@UEAAXXZ @ 0x1800A1D40 (-Commit@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@UEAAXXZ.c)
 * Callees:
