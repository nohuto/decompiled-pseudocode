/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x180042090
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a4)
{
  ...
  else
  {
    *this = 0LL;
    ...
    {
      AcquireSRWLockExclusive(&stru_180194928);
      v8 = &stru_180194928;
      if ( qword_180194998
        || (qword_180194998 = 0LL,
                             ...
                             &qword_180194998)) )
      {
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&unk_180194950,
          this,
          (void (*)(void *))a2,
          a3);
      }
