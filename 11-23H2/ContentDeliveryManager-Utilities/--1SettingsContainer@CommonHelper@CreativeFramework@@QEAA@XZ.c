/*
 * XREFs of ??1SettingsContainer@CommonHelper@CreativeFramework@@QEAA@XZ @ 0x1800D3954
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@VSettingsContainer@CommonHelper@CreativeFramework@@@std@@EEAAXXZ @ 0x1800D4250 (-_Destroy@-$_Ref_count_obj@VSettingsContainer@CommonHelper@CreativeFramework@@@std@@EEAAXXZ.c)
 * Callees:
