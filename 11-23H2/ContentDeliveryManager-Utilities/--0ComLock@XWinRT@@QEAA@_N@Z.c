/*
 * XREFs of ??0ComLock@XWinRT@@QEAA@_N@Z @ 0x18002AD9C
 * Callers:
...
XWinRT::ComLock *__fastcall XWinRT::ComLock::ComLock(XWinRT::ComLock *this, char a2)
{
  ...
  if ( a2 || CoGetApartmentType(&pAptType, &pAptQualifier) < 0 )
  {
    v3 = APTTYPE_MTA;
