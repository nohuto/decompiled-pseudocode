/*
 * XREFs of ??1SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800BAE94
 * Callers:
 *     ??_GSetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800BAF00 (--_GSetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
