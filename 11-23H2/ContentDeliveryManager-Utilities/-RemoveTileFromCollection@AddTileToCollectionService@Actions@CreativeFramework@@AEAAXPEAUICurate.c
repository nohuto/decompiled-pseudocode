/*
 * XREFs of ?RemoveTileFromCollection@AddTileToCollectionService@Actions@CreativeFramework@@AEAAXPEAUICuratedTileCollection@CuratedTileCollections@UnifiedTile@Shell@WindowsInternal@@@Z @ 0x1800AF298
 * Callers:
 ...
 *     ??0_lambda_33066bbcaa202ed8496d422e2c9143b2_@@QEAA@AEAVHString@Wrappers@WRL@Microsoft@@AEAPEAUICuratedTileCollection@CuratedTileCollections@UnifiedTile@Shell@WindowsInternal@@AEA_N@Z @ 0x1800AC470 (--0_lambda_33066bbcaa202ed8496d422e2c9143b2_@@QEAA@AEAVHString@Wrappers@WRL@Microsoft@@AEAPEAUIC.c)
