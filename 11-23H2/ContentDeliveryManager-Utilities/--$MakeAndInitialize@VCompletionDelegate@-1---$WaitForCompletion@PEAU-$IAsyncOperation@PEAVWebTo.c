        ...
        __int64 *a1)
{
  ...
  *a1 = 0LL;
  ...
  if ( v2 )
  {
    v4 = `wil::details::WaitForCompletion<Windows::Foundation::IAsyncOperation<Windows::Security::Authentication::Web::Core::WebTokenRequestResult *> *>'::`2'::CompletionDelegate::CompletionDelegate(v2);
    v9 = v4;
    v10 = 0LL;
