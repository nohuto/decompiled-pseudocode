/*
 * XREFs of ??_9ITargetedContentContainerStatics@TargetedContent@Services@Windows@@$BDA@AA @ 0x1800C79F8
 * Callers:
...
__int64 __fastcall  Windows::Services::TargetedContent::ITargetedContentContainerStatics::`vcall'{48,{flat}}(
        __int64 a1)
{
