/*
 * XREFs of ?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@D_N@Z @ 0x18000B310
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (*(_DWORD *)(a4 + 24) & 0x4000) != 0 )
  {
    ...
    *(_OWORD *)Src = *a3;
    if ( v15 )
    {
      do
      {
        std::ostreambuf_iterator<char>::operator=((__int64)Src, *v18++);
        --v15;
      }
      while ( v15 );
      v19 = *(_OWORD *)Src;
