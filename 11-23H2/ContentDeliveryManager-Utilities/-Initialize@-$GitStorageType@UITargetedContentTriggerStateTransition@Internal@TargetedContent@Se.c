/*
 * XREFs of ?Initialize@?$GitStorageType@UITargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@@detail@XWinRT@@QEAAJPEAUITargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@@Z @ 0x1800891A8
 * Callers:
 *     ??$?0PEAUITargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@@?$AutoValue@V?$GitStorageType@UITargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@@detail@XWinRT@@U?$DefaultLifetimeTraits@PEAVTargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@@Internal@Collections@Foundation@Windows@@@XWinRT@@QEAA@AEBQEAUITargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@PEAJ@Z @ 0x1800852F4 (--$-0PEAUITargetedContentTriggerStateTransition@Internal@TargetedContent@Services@W_ea_1800852F4.c)
 *     ?ReplaceAll@?$Vector@PEAVTargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@U?$DefaultEqualityPredicate@PEAVTargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@@2Collections@Foundation@5@U?$DefaultLifetimeTraits@PEAVTargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@@2785@U?$VectorOptions@PEAVTargetedContentTriggerStateTransition@Internal@TargetedContent@Services@Windows@@$0A@$00$0A@@2785@@Internal@Collections@Foundation@Windows@@UEAAJIPEAPEAUITargetedContentTriggerStateTransition@2TargetedContent@Services@5@@Z @ 0x18008A0B0 (-ReplaceAll@-$Vector@PEAVTargetedContentTriggerStateTransition@Internal@TargetedCon_ea_18008A0B0.c)
 * Callees:
 *     ??2@YAPEAX_KAEBUnothrow_t@std@@@Z @ 0x1800227B4 (--2@YAPEAX_KAEBUnothrow_t@std@@@Z.c)
 *     ?InternalRelease@?$ComPtr@UIUnknown@@@WRL@Microsoft@@IEAAKXZ @ 0x180037CF0 (-InternalRelease@-$ComPtr@UIUnknown@@@WRL@Microsoft@@IEAAKXZ.c)
 *     ??$QueryInterface@UIAgileObject@@@IUnknown@@QEAAJPEAPEAUIAgileObject@@@Z @ 0x18007BF18 (--$QueryInterface@UIAgileObject@@@IUnknown@@QEAAJPEAPEAUIAgileObject@@@Z.c)
 *     ?Acquire@Git@Details@Internal@Windows@@QEAAJXZ @ 0x18007EC00 (-Acquire@Git@Details@Internal@Windows@@QEAAJXZ.c)
  ...
  if ( (int)IUnknown::QueryInterface<IAgileObject>(a2, (__int64)&v10) < 0 )
  {
    ...
    if ( v6 )
    {
      ...
      *((_DWORD *)v6 + 1) = 0;
      ...
      if ( v9 >= 0 )
        v9 = (*(__int64 (__fastcall **)(__int64, __int64 (__fastcall ***)(_QWORD, GUID *, __int64), GUID *, volatile signed __int32 *))(*(_QWORD *)qword_1801964B8 + 24LL))(
               qword_1801964B8,
               a2,
