/*
 * XREFs of ?GetUrisFromActivity@ActivityToastNotificationCallback@ToastNotification@@AEAAXVActivityWrapper@MobilityExperience@@PEAPEAUHSTRING__@@1@Z @ 0x1800701A0
 * Callers:
 ...
 *     ??$query@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@@?$com_ptr_t@UIUriRuntimeClass@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x18006DE50 (--$query@UIUriRuntimeClassWithAbsoluteCanonicalUri@Foundation@Windows@@@-$com_ptr_t@UIUriRuntime.c)
