 ...
 *     ??$wait_for_completion@PEAVStorageFolder@Storage@Windows@@V?$ComPtr@UIStorageFolder@Storage@Windows@@@WRL@Microsoft@@@wil@@YA?AV?$ComPtr@UIStorageFolder@Storage@Windows@@@WRL@Microsoft@@PEAU?$IAsyncOperation@PEAVStorageFolder@Storage@Windows@@@Foundation@Windows@@W4tagCOWAIT_FLAGS@@@Z @ 0x1800A173C (--$wait_for_completion@PEAVStorageFolder@Storage@Windows@@V-$ComPtr@UIStorageFolder@Storage@Wind.c)
 *     ??_9IStorageFolder@Storage@Windows@@$BEI@AA @ 0x1800BDEF0 (--_9IStorageFolder@Storage@Windows@@$BEI@AA.c)
 */
        ...
        unsigned int *a5)
{
  ...
  v8 =  Windows::Storage::IStorageFolder::`vcall'{72,{flat}}(a2, *a4, *a5, &v13);
  if ( v8 < 0 )
