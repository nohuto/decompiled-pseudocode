/*
 * XREFs of ?RetrieveItemsFromCollection@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXPEAUITargetedContentCollection@TargetedContent@Services@Windows@@PEAUHSTRING__@@I@Z @ 0x1800CB744
 * Callers:
 ...
 *     ??Dvector_iterator@?$vector_range@U?$IVectorView@PEAVTargetedContentCollection@TargetedContent@Services@Windows@@@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@QEAAAEBV?$ComPtr@UITargetedContentCollection@TargetedContent@Services@Windows@@@WRL@Microsoft@@XZ @ 0x1800C76A0 (--Dvector_iterator@-$vector_range@U-$IVectorView@PEAVTargetedContentCollection@TargetedContent@S.c)
 *     ??Dvector_iterator@?$vector_range@U?$IVectorView@PEAVTargetedContentItem@TargetedContent@Services@Windows@@@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@QEAAAEBV?$ComPtr@UITargetedContentItem@TargetedContent@Services@Windows@@@WRL@Microsoft@@XZ @ 0x1800C7728 (--Dvector_iterator@-$vector_range@U-$IVectorView@PEAVTargetedContentItem@TargetedContent@Service.c)
 ...
 *     ?RetrieveItemsFromCollection@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXPEAUITargetedContentCollection@TargetedContent@Services@Windows@@PEAUHSTRING__@@I@Z @ 0x1800CB744 (-RetrieveItemsFromCollection@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAA.c)
 *     ?end@?$vector_range@U?$IVectorView@PEAVTargetedContentCollection@TargetedContent@Services@Windows@@@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@QEAA?AVvector_iterator@12@XZ @ 0x1800CCDA0 (-end@-$vector_range@U-$IVectorView@PEAVTargetedContentCollection@TargetedContent@Services@Window.c)
