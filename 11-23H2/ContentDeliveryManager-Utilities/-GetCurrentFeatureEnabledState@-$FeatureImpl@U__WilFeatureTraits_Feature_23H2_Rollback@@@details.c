/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_23H2_Rollback@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180033DD4
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_23H2_Rollback>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        ...
        int *a4)
{
  ...
  FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0x2BC012C, 3u, a3, a4);
  *a2 = 0LL;
