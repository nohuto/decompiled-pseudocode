        ...
        __int64 a6)
{
  ...
  if ( a2 != a3 )
  {
    do
    {
      if ( a4 == a5 )
        break;
      v10 = CreativeFramework::TargetedContentLayoutHelpers::less_than_rank::operator()(a1, a4, v8);
      v12 = v11;
      v13 = a4;
      if ( !v10 )
      {
      ...
      v14 = v10;
      std::_Temp_iterator<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>::operator=(a6, v13);
      v15 = a4 + 16;
      v8 = v12;
      if ( !v14 )
        v15 = a4;
