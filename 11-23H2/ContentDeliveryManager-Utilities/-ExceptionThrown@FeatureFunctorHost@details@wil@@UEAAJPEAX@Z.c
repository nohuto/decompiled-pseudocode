/*
 * XREFs of ?ExceptionThrown@FeatureFunctorHost@details@wil@@UEAAJPEAX@Z @ 0x180031820
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RethrowCaughtException@wil@@YAXXZ @ 0x18003F174 (-RethrowCaughtException@wil@@YAXXZ.c)
 */
