/*
 * XREFs of ??5?$basic_istream@GU?$char_traits@G@std@@@std@@QEAAAEAV01@AEAI@Z @ 0x18005385C
 * Callers:
...
__int64 __fastcall std::basic_istream<unsigned short>::operator>>(__int64 a1, __int64 a2)
{
  ...
  if ( v13 )
  {
    v4 = (std::locale *)std::ios_base::getloc(v3 + *(int *)(*(_QWORD *)v3 + 4LL), &v18);
  ...
  std::basic_ios<unsigned short>::setstate(v3 + *(int *)(*(_QWORD *)v3 + 4LL), v17);
