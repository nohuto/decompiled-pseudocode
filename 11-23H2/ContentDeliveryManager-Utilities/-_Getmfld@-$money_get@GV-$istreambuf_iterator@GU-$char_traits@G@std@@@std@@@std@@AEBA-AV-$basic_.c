/*
 * XREFs of ?_Getmfld@?$money_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@AEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@0_NAEAVios_base@2@PEAG@Z @ 0x1800125B0
 * Callers:
        ...
        __int16 *a7)
{
  ...
  if ( a5 )
  {
    ...
    v12 = 32;
    v13 = std::use_facet<std::moneypunct<unsigned short,1>>(&v79);
    v80 = v13;
    if ( v11 )
    {
  ...
  else
  {
    ...
    v12 = 64;
    v13 = std::use_facet<std::moneypunct<unsigned short,0>>(&v79);
    v80 = v13;
    if ( v15 )
    {
  ...
  *(_BYTE *)v9 = 0;
  ...
  v18 = v12 | 0x81;
  v19 = std::use_facet<std::ctype<unsigned short>>((std::locale *)&v79);
  v79 = v19;
  if ( v17 )
  {
