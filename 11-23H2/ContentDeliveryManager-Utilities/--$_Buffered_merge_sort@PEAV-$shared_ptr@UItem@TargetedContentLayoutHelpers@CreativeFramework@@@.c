        ...
        char a5)
{
  ...
  LOBYTE(a3) = a5;
  result = std::_Insertion_sort1<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,CreativeFramework::TargetedContentLayoutHelpers::less_than_rank,std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>(
             a1,
             a2,
             a3);
  while ( v5 < v7 )
  {
    ...
    *(_QWORD *)(*(_QWORD *)(a4 + 32) + 8LL) = **(_QWORD **)(a4 + 32);
    std::_Chunked_merge<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,std::_Temp_iterator<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>,__int64,CreativeFramework::TargetedContentLayoutHelpers::less_than_rank>(
      v9,
      a2,
      (unsigned int)&v14,
      v5,
      ...
      0LL,
      *(_QWORD *)(a4 + 32));
    result = std::_Chunked_merge<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,__int64,CreativeFramework::TargetedContentLayoutHelpers::less_than_rank>(
               **(_QWORD **)(a4 + 32),
