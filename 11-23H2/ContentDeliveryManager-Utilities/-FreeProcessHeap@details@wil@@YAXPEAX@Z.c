/*
 * XREFs of ?FreeProcessHeap@details@wil@@YAXPEAX@Z @ 0x180032E00
 * Callers:
 ...
 *     ??1RawUsageIndex@details_abi@wil@@QEAA@XZ @ 0x18002C6B8 (--1RawUsageIndex@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ??1heap_buffer@details_abi@wil@@QEAA@XZ @ 0x18002C84C (--1heap_buffer@details_abi@wil@@QEAA@XZ.c)
