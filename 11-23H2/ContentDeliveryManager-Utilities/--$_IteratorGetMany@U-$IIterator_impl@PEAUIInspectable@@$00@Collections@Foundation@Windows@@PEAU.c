/*
 * XREFs of ??$_IteratorGetMany@U?$IIterator_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@PEAUIInspectable@@@Detail@Collections@Foundation@Windows@@YAJPEAU?$IIterator_impl@PEAUIInspectable@@$00@123@IPEAPEAUIInspectable@@PEAI@Z @ 0x1800C5FC8
 * Callers:
 *     ?GetMany@?$IIterator_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@UEAAJIPEAPEAUIInspectable@@PEAI@Z @ 0x1800C8A50 (-GetMany@-$IIterator_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@UEAAJIPEAPEAUIIn.c)
 * Callees:
