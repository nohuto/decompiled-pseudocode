/*
 * XREFs of ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEAPEAX@Z @ 0x18000A400
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a7)
{
  ...
  if ( v16 )
  {
    v12 = (void (__fastcall ***)(_QWORD, __int64))(*(__int64 (**)(void))(*(_QWORD *)v16 + 16LL))();
    if ( v12 )
      (**v12)(v12, 1LL);
  }
