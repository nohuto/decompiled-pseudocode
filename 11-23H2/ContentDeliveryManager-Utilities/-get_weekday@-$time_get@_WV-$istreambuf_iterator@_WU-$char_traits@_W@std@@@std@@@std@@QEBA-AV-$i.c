/*
 * XREFs of ?get_weekday@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@QEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x1800D1F14
 * Callers:
        ...
        __int64 a7)
{
  ...
  v11 = *a4;
  v12 = v9;
  (*(void (__fastcall **)(__int64 *, __int64, __int128 *, __int128 *, __int64, __int64, __int64))(v7 + 48))(
    a1,
    a2,
    &v12,
    &v11,
