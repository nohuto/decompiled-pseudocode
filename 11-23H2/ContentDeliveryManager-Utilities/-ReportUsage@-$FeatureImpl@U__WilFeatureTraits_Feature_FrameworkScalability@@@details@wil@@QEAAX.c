/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_FrameworkScalability@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18005CF04
 * Callers:
...
_UNKNOWN **__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_FrameworkScalability>::ReportUsage(
        ...
        __int64 a4)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v10 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_FrameworkScalability>::GetCachedFeatureEnabledState(
                       a1,
                       v7);
    v4 = v10;
  }
