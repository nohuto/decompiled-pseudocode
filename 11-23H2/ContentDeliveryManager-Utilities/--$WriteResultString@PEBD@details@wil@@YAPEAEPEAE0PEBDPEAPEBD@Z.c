/*
 * XREFs of ??$WriteResultString@PEBD@details@wil@@YAPEAEPEAE0PEBDPEAPEBD@Z @ 0x18002948C
 * Callers:
 ...
 * Callees:
 *     ?ResultStringSize@details@wil@@YA_KPEBD@Z @ 0x18003F100 (-ResultStringSize@details@wil@@YA_KPEBD@Z.c)
 */
