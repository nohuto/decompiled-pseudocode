/*
 * XREFs of ??$ActivateInstance@UILauncherOptions@System@Windows@@@wil@@YA?AV?$com_ptr_t@UILauncherOptions@System@Windows@@Uerr_exception_policy@wil@@@0@PEBG@Z @ 0x18006C3AC
 * Callers:
 ...
 *     ??$query@UILauncherOptions@System@Windows@@@?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UILauncherOptions@System@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x18006DDF0 (--$query@UILauncherOptions@System@Windows@@@-$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil.c)
