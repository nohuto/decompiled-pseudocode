/*
 * XREFs of ??1NotificationManagerService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800B7190
 * Callers:
 *     ??_ENotificationManagerService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800B73A0 (--_ENotificationManagerService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ?_Delete@?$unique_ptr@VToastHelpers@NotificationManager@CreativeFramework@@U?$default_delete@VToastHelpers@NotificationManager@CreativeFramework@@@std@@@std@@AEAAXXZ @ 0x1800B77EC (-_Delete@-$unique_ptr@VToastHelpers@NotificationManager@CreativeFramework@@U-$default_delete@VTo.c)
 */
