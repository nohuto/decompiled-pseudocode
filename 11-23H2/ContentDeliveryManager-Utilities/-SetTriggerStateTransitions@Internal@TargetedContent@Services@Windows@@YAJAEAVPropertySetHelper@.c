/*
 * XREFs of ?SetTriggerStateTransitions@Internal@TargetedContent@Services@Windows@@YAJAEAVPropertySetHelper@Triggers@CreativeFramework@@PEAUITargetedContentTriggerInternal@1234@@Z @ 0x18009F1A8
 * Callers:
        ...
        struct Windows::Services::TargetedContent::Internal::ITargetedContentTriggerInternal *a3)
{
  ...
  for ( i = 0; i < v35; ++i )
  {
    ...
    v23 = (_WORD *)Windows::Services::TargetedContent::Internal::ResolveNameFromTriggerState(v36);
