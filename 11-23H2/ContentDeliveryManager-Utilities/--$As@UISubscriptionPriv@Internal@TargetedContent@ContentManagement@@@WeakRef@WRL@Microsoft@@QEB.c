/*
 * XREFs of ??$As@UISubscriptionPriv@Internal@TargetedContent@ContentManagement@@@WeakRef@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UISubscriptionPriv@Internal@TargetedContent@ContentManagement@@@WRL@Microsoft@@@Details@12@@Z @ 0x180065A90
 * Callers:
 *     _lambda_7b359f7de2cb9222ee62c5860a33e596_::operator() @ 0x1800677DC (_lambda_7b359f7de2cb9222ee62c5860a33e596_--operator().c)
