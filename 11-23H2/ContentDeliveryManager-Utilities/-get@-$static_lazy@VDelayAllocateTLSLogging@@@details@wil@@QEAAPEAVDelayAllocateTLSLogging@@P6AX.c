/*
 * XREFs of ?get@?$static_lazy@VDelayAllocateTLSLogging@@@details@wil@@QEAAPEAVDelayAllocateTLSLogging@@P6AXXZ@Z @ 0x180043BC0
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<DelayAllocateTLSLogging>::get(__int64 a1, void (__cdecl *a2)())
{
    ...
    && (_DWORD)v8 )
  {
    ...
    v9 = &qword_1801964F0;
    qword_1801964F0 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_180196508 = (__int64)&`DelayAllocateTLSLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
