/*
 * XREFs of ??0?$SimpleClassFactory@VActivityToastNotificationCallback@ToastNotification@@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x18006E180
 * Callers:
 *     ??$MakeAndInitialize@V?$SimpleClassFactory@VActivityToastNotificationCallback@ToastNotification@@$0A@@WRL@Microsoft@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAV?$SimpleClassFactory@VActivityToastNotificationCallback@ToastNotification@@$0A@@12@@Z @ 0x18006CC3C (--$MakeAndInitialize@V-$SimpleClassFactory@VActivityToastNotificationCallback@ToastNotification@.c)
 * Callees:
