 ...
 *     ??_9ITargetedContentContainerStatics@TargetedContent@Services@Windows@@$BDA@AA @ 0x1800C79F8 (--_9ITargetedContentContainerStatics@TargetedContent@Services@Windows@@$BDA@AA.c)
 */
