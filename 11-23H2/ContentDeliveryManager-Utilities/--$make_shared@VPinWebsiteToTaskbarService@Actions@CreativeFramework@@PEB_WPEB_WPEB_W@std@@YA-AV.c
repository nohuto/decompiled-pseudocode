/*
 * XREFs of ??$make_shared@VPinWebsiteToTaskbarService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W@std@@YA?AV?$shared_ptr@VPinWebsiteToTaskbarService@Actions@CreativeFramework@@@0@$$QEAPEB_W00@Z @ 0x1800B5BA4
 * Callers:
