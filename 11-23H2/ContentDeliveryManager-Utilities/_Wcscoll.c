/*
 * XREFs of _Wcscoll @ 0x180021C04
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x180017C80 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000D91C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000D928 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x18000D99C (__crtCompareStringW_Stub.c)
 */
