/*
 * XREFs of ?_Getcat@?$numpunct@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800608E4
 * Callers:
 ...
 *     ??0?$numpunct@G@std@@QEAA@AEBV_Locinfo@1@_K_N@Z @ 0x1800519FC (--0-$numpunct@G@std@@QEAA@AEBV_Locinfo@1@_K_N@Z.c)
