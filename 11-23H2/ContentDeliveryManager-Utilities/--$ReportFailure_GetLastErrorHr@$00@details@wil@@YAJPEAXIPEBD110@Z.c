/*
 * XREFs of ??$ReportFailure_GetLastErrorHr@$00@details@wil@@YAJPEAXIPEBD110@Z @ 0x1800282FC
 * Callers:
        ...
        const char *a6)
{
  ...
  v20 = v18;
  v19 = v17;
  wil::details::ReportFailure_Base<1,0>(v8, v7, a3, v12, v15, (__int64)a6, (__int64)&v19, 0LL);
  return v11;
}
