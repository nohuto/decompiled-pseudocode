/*
 * XREFs of ??$ReportFailure_GetLastError@$0A@@details@wil@@YAKPEAXIPEBD110@Z @ 0x180066114
 * Callers:
        ...
        const char *a6)
{
  ...
  v16 = v14;
  v15 = v13;
  wil::details::ReportFailure_Base<0,0>(v8, v7, v6, v10, v12, (__int64)a6, (__int64)&v15, 0LL);
}
