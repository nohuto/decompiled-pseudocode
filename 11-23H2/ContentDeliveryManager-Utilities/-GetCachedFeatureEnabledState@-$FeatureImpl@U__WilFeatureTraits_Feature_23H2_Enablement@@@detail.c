/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_23H2_Enablement@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180033118
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_23H2_Enablement@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x18004345C (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_23H2_Enablement@@@details@wil@@QE.c)
 * Callees:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_23H2_Enablement>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_23H2_Enablement>::GetCurrentFeatureEnabledState(v6, &v13, &v12);
    for ( i = *a2; ; i = v10 )
    {
      v8 = v12 == 0;
      v9 = i;
