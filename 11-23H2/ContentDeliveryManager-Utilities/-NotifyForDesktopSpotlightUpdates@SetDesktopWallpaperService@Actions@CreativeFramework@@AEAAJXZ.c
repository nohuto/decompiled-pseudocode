/*
 * XREFs of ?NotifyForDesktopSpotlightUpdates@SetDesktopWallpaperService@Actions@CreativeFramework@@AEAAJXZ @ 0x1800BC78C
 * Callers:
 *     ?Commit@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800BBF60 (-Commit@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?SHRegGetBOOLWithREGSAM@@YAJPEAUHKEY__@@PEB_W1KPEAH@Z @ 0x1800BCB64 (-SHRegGetBOOLWithREGSAM@@YAJPEAUHKEY__@@PEB_W1KPEAH@Z.c)
