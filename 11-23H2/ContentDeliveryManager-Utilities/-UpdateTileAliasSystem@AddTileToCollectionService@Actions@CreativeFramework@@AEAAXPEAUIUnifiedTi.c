/*
 * XREFs of ?UpdateTileAliasSystem@AddTileToCollectionService@Actions@CreativeFramework@@AEAAXPEAUIUnifiedTileIdentifier@UnifiedTile@Shell@WindowsInternal@@_N@Z @ 0x1800AF824
 * Callers:
 ...
 *     ??0HStringReference@Wrappers@WRL@Microsoft@@QEAA@PEB_WI@Z @ 0x1800AC628 (--0HStringReference@Wrappers@WRL@Microsoft@@QEAA@PEB_WI@Z.c)
