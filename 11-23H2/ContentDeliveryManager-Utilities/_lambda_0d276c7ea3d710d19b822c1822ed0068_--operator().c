/*
 * XREFs of _lambda_0d276c7ea3d710d19b822c1822ed0068_::operator() @ 0x180074E68
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_0d276c7ea3d710d19b822c1822ed0068__Windows::Internal::CNoResult_::Run @ 0x1800766D0 (Windows--Internal--COperationLambdaVar_0__lambda_0d276c7ea3d710d19b822c1822ed0068__Windows--Inte.c)
 * Callees:
...
__int64 __fastcall lambda_0d276c7ea3d710d19b822c1822ed0068_::operator()(_QWORD *a1)
{
  ...
  wil::ActivityBase<ContentDeliveryManager::Background::ContentDeliveryManagerLogging,1,35184372088832,5,0,_TlgReflectorTag_Param0IsProviderType>::ActivityBase<ContentDeliveryManager::Background::ContentDeliveryManagerLogging,1,35184372088832,5,0,_TlgReflectorTag_Param0IsProviderType>(
    ...
    (__int64)"ActionStagedActivity");
  v15[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity *)v15,
    v8,
    v6,
    v4);
  ...
  try
  {
    ...
    ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity::~ActionStagedActivity((ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionStagedActivity *)v15);
    result = 0LL;
  }
  catch ( ... )
  {
