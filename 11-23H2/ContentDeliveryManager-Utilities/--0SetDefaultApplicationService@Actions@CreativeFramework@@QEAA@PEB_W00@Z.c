/*
 * XREFs of ??0SetDefaultApplicationService@Actions@CreativeFramework@@QEAA@PEB_W00@Z @ 0x1800B06F4
 * Callers:
 *     ??$make_shared@VSetDefaultApplicationService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W@std@@YA?AV?$shared_ptr@VSetDefaultApplicationService@Actions@CreativeFramework@@@0@$$QEAPEB_W00@Z @ 0x1800B0660 (--$make_shared@VSetDefaultApplicationService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W@std@@YA-.c)
 * Callees:
        ...
        const wchar_t *a4)
{
  ...
  *(_QWORD *)this = &CreativeFramework::Actions::SetDefaultApplicationService::`vftable';
  ...
  if ( *((_QWORD *)this + 12) >= 8uLL )
    v5 = *(const WCHAR **)v5;
  for ( i = &off_1800FE2E8; ; i += 2 )
  {
    if ( i == (wchar_t **)&unk_1800FE308 )
