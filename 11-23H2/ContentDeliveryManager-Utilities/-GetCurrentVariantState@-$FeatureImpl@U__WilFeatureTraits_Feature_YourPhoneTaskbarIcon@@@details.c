/*
 * XREFs of ?GetCurrentVariantState@?$FeatureImpl@U__WilFeatureTraits_Feature_YourPhoneTaskbarIcon@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800345B4
 * Callers:
...
int *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_YourPhoneTaskbarIcon>::GetCurrentVariantState(
        ...
        __int64 a3)
{
  __int64 (__fastcall *v4)(__int64, _QWORD, int *, int *, __int64); // rax
  int v5; // edx
  int v6; // r9d
  int v7; // r8d
  unsigned int v8; // edx
  ...
  v11 = HIDWORD(a1);
  v10 = 0;
  v4 = (__int64 (__fastcall *)(__int64, _QWORD, int *, int *, __int64))g_wil_details_internalGetFeatureVariant;
  if ( g_wil_details_internalGetFeatureVariant
    || (v4 = (__int64 (__fastcall *)(__int64, _QWORD, int *, int *, __int64))g_wil_details_apiGetFeatureVariant) != 0LL )
  {
    v5 = v4(16257538LL, 0LL, &v12, &v10, a3);
  }
  else
  {
    v5 = 0;
