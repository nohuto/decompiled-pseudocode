/*
 * XREFs of ?_Ipfx@?$basic_istream@GU?$char_traits@G@std@@@std@@QEAA_N_N@Z @ 0x18006203C
 * Callers:
  ...
  if ( !*(_DWORD *)((char *)v1 + v3 + 16) )
  {
    ...
    if ( (*(_BYTE *)(v4 + 24) & 1) != 0 )
    {
      ...
      try
      {
        ...
        while ( v9 != 0xFFFF )
        {
          if ( !(*(unsigned __int8 (__fastcall **)(const struct std::locale::facet *, __int64, _QWORD))(*(_QWORD *)v6 + 32LL))(
                  v6,
                  72LL,
                  v9) )
            goto LABEL_20;
