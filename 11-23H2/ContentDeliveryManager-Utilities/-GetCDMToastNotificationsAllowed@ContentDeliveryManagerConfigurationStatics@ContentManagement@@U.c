/*
 * XREFs of ?GetCDMToastNotificationsAllowed@ContentDeliveryManagerConfigurationStatics@ContentManagement@@UEAAJPEAE@Z @ 0x180084B80
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 *a2)
{
  ...
  unsigned __int8 v11; // [rsp+58h] [rbp+28h] BYREF
  ...
  *a2 = 1;
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v7 >= 0 )
    {
      v7 = (*(__int64 (__fastcall **)(__int64, unsigned __int8 *))(*(_QWORD *)v12 + 40LL))(v12, &v11);
      v4 = v7;
      if ( v7 >= 0 )
      {
        *a2 = v11;
