/*
 * XREFs of ??$ActivateInstance@UILockScreenRegistrySettingProvider@ContentManagement@@@wil@@YA?AV?$com_ptr_t@UILockScreenRegistrySettingProvider@ContentManagement@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800BA254
 * Callers:
 ...
 *     ??$query@UILockScreenRegistrySettingProvider@ContentManagement@@@?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UILockScreenRegistrySettingProvider@ContentManagement@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800BA308 (--$query@UILockScreenRegistrySettingProvider@ContentManagement@@@-$com_ptr_t@UIInspectable@@Uerr.c)
 */
