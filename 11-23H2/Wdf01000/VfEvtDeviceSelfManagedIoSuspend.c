/*
 * XREFs of VfEvtDeviceSelfManagedIoSuspend @ 0x1C00B8FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VfEvtDeviceSelfManagedIoSuspend(WDFDEVICE__ *Device)
{
  unsigned int v2; // edi
  ...
  v4 = (__int64 (__fastcall *)(WDFDEVICE__ *))*((_QWORD *)TypedContext + 11);
  if ( v4 )
  {
    critRegion = 0;
