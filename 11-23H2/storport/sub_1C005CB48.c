/*
 * XREFs of sub_1C005CB48 @ 0x1C005CB48
 * Callers:
...
NTSTATUS __fastcall sub_1C005CB48(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 1LL;
  v15 = &a7;
  return sub_1C001579C(a1, &stru_1C00831F0, 0LL, 5u, &v8);
}
