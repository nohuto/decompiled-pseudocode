/*
 * XREFs of sub_1C00504C4 @ 0x1C00504C4
 * Callers:
...
NTSTATUS __fastcall sub_1C00504C4(__int64 a1, __int64 a2, __int64 a3, const wchar_t *a4, char a5)
{
  __int64 v5; // rax
  __int64 v6; // rcx
  ...
  v9 = a4;
  v12 = &a5;
  return sub_1C001579C(v6, &stru_1C00831D0, 0LL, 3u, &v8);
}
