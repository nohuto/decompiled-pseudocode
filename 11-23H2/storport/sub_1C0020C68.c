/*
 * XREFs of sub_1C0020C68 @ 0x1C0020C68
 * Callers:
 *     sub_1C00207F8 @ 0x1C00207F8 (sub_1C00207F8.c)
 *     sub_1C002095C @ 0x1C002095C (sub_1C002095C.c)
 * Callees:
 *     sub_1C0020D68 @ 0x1C0020D68 (sub_1C0020D68.c)
 *     memset_0 @ 0x1C0024D40 (memset_0.c)
 *     sub_1C0063C20 @ 0x1C0063C20 (sub_1C0063C20.c)
 */

__int64 sub_1C0020C68(_WORD *a1, unsigned __int64 a2, _QWORD *a3, unsigned __int64 *a4, int a5, _WORD *a6, ...)
{
  int v9; // ebx
  _WORD *v10; // r13
  ...
  else
  {
    ...
    {
      v17[0] = 0LL;
      v13 = sub_1C0020D68(a1, a2, v17, v12, va);
      v14 = v17[0];
      v9 = v13;
      v11 = a2 - v17[0];
      v17[0] = a2 - v17[0];
...
LABEL_11:
    ...
    if ( (a5 & 0x1C00) != 0 && a2 )
    {
      sub_1C0063C20(a1, 2 * a2, a3, &v16, v17, a5);
      v10 = v16;
      v11 = v17[0];
    }
