/*
 * XREFs of sub_1C00B0690 @ 0x1C00B0690
 * Callers:
...
void __fastcall sub_1C00B0690(__int64 a1, _DWORD *a2)
{
  void *v3; // rbx
  int v4; // ecx
  ...
  if ( a2 )
  {
    ...
    if ( v3 )
    {
      ...
      if ( ZwQueryValueKey(v3, &DestinationString, KeyValueFullInformation, KeyValueInformation, 0x200u, &ResultLength) >= 0
        ...
        && !wcsnicmp(Str1, L"BusyRetryCount", (unsigned __int64)KeyValueInformation[4] >> 1) )
      {
