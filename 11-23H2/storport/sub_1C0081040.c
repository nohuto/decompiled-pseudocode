/*
 * XREFs of sub_1C0081040 @ 0x1C0081040
 * Callers:
...
__int64 __fastcall sub_1C0081040(__int64 a1, const void *a2, unsigned int a3)
{
  __int64 v5; // rcx
  unsigned int v6; // edi
  unsigned int v7; // r9d
  ...
  else
  {
    ...
    {
      v9 = v5 + a3 + 2;
      sub_1C003EE60((__int64)off_1C0093070->AttachedDevice, 0xDu, (__int64)&unk_1C008B738, v7, v9);
    }
