/*
 * XREFs of sub_1C001B810 @ 0x1C001B810
 * Callers:
...
NTSTATUS __fastcall sub_1C001B810(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a63)
{
  char a64; // [rsp+760h] [rbp+658h] BYREF
  const wchar_t *v64; // rcx
  const wchar_t *v65; // rsi
  const char *v66; // rbx
  const wchar_t *v67; // r10
  const char *v68; // r9
  int v69; // edi
  const char *v70; // r8
  const char *v71; // rdx
  ...
  struct _EVENT_DATA_DESCRIPTOR v88; // [rsp+48h] [rbp-C0h] BYREF
  ...
  unsigned __int64 *v238; // [rsp+4C8h] [rbp+3C0h]
  __int64 v239; // [rsp+4D0h] [rbp+3C8h]
  unsigned __int64 *v240; // [rsp+4D8h] [rbp+3D0h]
  __int64 v241; // [rsp+4E0h] [rbp+3D8h]
  unsigned __int64 *v242; // [rsp+4E8h] [rbp+3E0h]
  __int64 v243; // [rsp+4F0h] [rbp+3E8h]
  unsigned __int64 *v244; // [rsp+4F8h] [rbp+3F0h]
  __int64 v245; // [rsp+500h] [rbp+3F8h]
  unsigned __int64 *v246; // [rsp+508h] [rbp+400h]
  __int64 v247; // [rsp+510h] [rbp+408h]
  unsigned __int64 *v248; // [rsp+518h] [rbp+410h]
  __int64 v249; // [rsp+520h] [rbp+418h]
  int v250; // [rsp+580h] [rbp+478h] BYREF
  ...
  v247 = 8LL;
  v249 = 8LL;
  return sub_1C001579C((__int64)&a34, &stru_1C00826A8, 0LL, 0x4Eu, &v88);
}
