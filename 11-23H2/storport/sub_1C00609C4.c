/*
 * XREFs of sub_1C00609C4 @ 0x1C00609C4
 * Callers:
...
__int64 __fastcall sub_1C00609C4(__int64 a1, IRP *a2)
{
...
LABEL_14:
    ...
    if ( Length < IrpCount + (unsigned __int64)HIDWORD(MasterIrp->AssociatedIrp.SystemBuffer) + 8 )
      goto LABEL_5;
    v9 = sub_1C0057238(*(_QWORD *)(a1 + 8), (__int64)a2, &P, (unsigned int *)&v13);
    v3 = P;
    if ( v9 >= 0 )
      v9 = sub_1C001FA9C(a1, (__int64)a2, (__int64)P, v13, 0LL, v12, 64);
  }
  else
  {
    v9 = -1073741585;
