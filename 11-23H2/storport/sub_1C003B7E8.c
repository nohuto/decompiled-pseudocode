/*
 * XREFs of sub_1C003B7E8 @ 0x1C003B7E8
 * Callers:
...
__int64 __fastcall sub_1C003B7E8(__int64 a1, IRP *a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
    ...
    && ((v13 = _mm_cvtsi128_si32(v9)) == 0 || v13 >= 0x28 && v9.m128i_i32[1]) )
  {
    ...
    if ( Length < v13 + HIDWORD(v9.m128i_i64[0]) + 8 )
      return (unsigned int)-1073741585;
    v12 = sub_1C001EDE4(*(_QWORD *)(a1 + 8), (__int64)a2, &P, &v21);
    if ( v12 < 0 )
    {
      v4 = (unsigned int *)P;
    }
    ...
    {
      v4 = (unsigned int *)P;
      v12 = sub_1C001F308(a1, a2, (unsigned int *)P, v21, 0LL, 0, 64);
      if ( v12 >= 0 )
      {
