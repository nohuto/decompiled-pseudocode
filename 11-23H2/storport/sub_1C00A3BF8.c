/*
 * XREFs of sub_1C00A3BF8 @ 0x1C00A3BF8
 * Callers:
...
__int64 __fastcall sub_1C00A3BF8(__int64 a1, __int64 a2)
{
  __int64 v2; // rdi
  ...
  if ( *(_DWORD *)(a2 + 8) > 1u )
    return 3221225485LL;
  DriverObjectExtension = (const void **)IoGetDriverObjectExtension(*(PDRIVER_OBJECT *)(v9 + 8), StorPortGetSrb);
