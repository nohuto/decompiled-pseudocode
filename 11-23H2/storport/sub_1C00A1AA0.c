/*
 * XREFs of sub_1C00A1AA0 @ 0x1C00A1AA0
 * Callers:
...
__int64 __fastcall sub_1C00A1AA0(__int64 a1, unsigned int a2, __int64 a3)
{
  __int64 v6; // rax
  ...
  v6 = sub_1C0007CF4(72LL, 16LL * a2, 1297375570LL, a3);
  *(_QWORD *)(a1 + 64) = v6;
  if ( !v6 )
    return 3221225495LL;
  ...
  v10 = sub_1C0007CF4(72LL, v9 << 6, 1297375570LL, a3);
  *(_QWORD *)a1 = v10;
  if ( v10 )
  {
    *(_DWORD *)(a1 + 72) = a2 / v8;
