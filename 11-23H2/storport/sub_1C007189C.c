/*
 * XREFs of sub_1C007189C @ 0x1C007189C
 * Callers:
        ...
        __int64 a14)
{
  ...
  if ( (unsigned int)dword_1C00930C8 > 5 )
  {
    if ( sub_1C001ABEC(a1, 0x800000000000LL) )
    {
      ...
      v80 = 8LL;
      v82 = 8LL;
      sub_1C001D420(*(__int64 *)&qword_1C0093B20, (unsigned __int8 *)dword_1C0087D88, v22, v23, 0x1Au, &v38);
    }
  }
}
