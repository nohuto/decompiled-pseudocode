/*
 * XREFs of sub_1C006E67C @ 0x1C006E67C
 * Callers:
...
int __fastcall sub_1C006E67C(__int64 a1, const WCHAR *a2)
{
  int result; // eax
  ULONG Length; // esi
  __int64 v5; // rbx
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    Length = 20;
    v5 = sub_1C0007CF4(256LL, 20LL, 1700028754LL, *(_QWORD *)(a1 + 8));
    if ( v5 )
    {
      v6 = 0;
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( *(_DWORD *)(v5 + 4) == 4 && *(_DWORD *)(v5 + 12) == 4 )
          {
            ...
            if ( RtlUnicodeStringToInteger(&String, 0, &Value) >= 0 )
              sub_1C00729D8(a1, Value, *(unsigned int *)(*(unsigned int *)(v5 + 8) + v5));
          }
          ++v6;
        }
        ...
        v5 = sub_1C0007CF4(256LL, Length, 1700028754LL, *(_QWORD *)(a1 + 8));
        if ( !v5 )
