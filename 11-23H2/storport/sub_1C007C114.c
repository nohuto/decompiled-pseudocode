/*
 * XREFs of sub_1C007C114 @ 0x1C007C114
 * Callers:
...
__int64 __fastcall sub_1C007C114(__int64 a1, __int64 a2, unsigned int a3, int a4, int a5, char a6, char a7, __int64 a8)
{
  __int64 v8; // rbx
  int v11; // r9d
  int v12; // r9d
  ...
  __int64 Dst; // [rsp+D0h] [rbp-30h] BYREF
...
LABEL_16:
  ...
  *((_QWORD *)&v47 + 1) = &Dst;
  if ( (_DWORD)v8 )
    ...
    v27 = 0x80200000001LL;
  return sub_1C007D4BC(a1, a2, v27, &v47, v28, v29);
}
