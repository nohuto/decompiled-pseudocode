/*
 * XREFs of sub_1C00157F4 @ 0x1C00157F4
 * Callers:
...
__int64 __fastcall sub_1C00157F4(__int64 a1, int a2, int a3, __int64 a4)
{
  __int64 v6; // rdx
  int v7; // eax
  __int128 v8; // xmm2
  ...
  v38 = 0LL;
  v39 = 0LL;
  sub_1C0015B08(a1, a2, a3, a4, (__int64)&v38);
  ...
  *(_QWORD *)(a1 + 2440) = v11;
  ...
  LOBYTE(v6) = BYTE5(v38);
  if ( (unsigned int)sub_1C0015A74(v12, v6) == 1 )
  {
    v28 = *(_DWORD *)(a1 + 2396);
    if ( v28 != v13 )
...
LABEL_9:
  ...
  while ( 1 )
  {
    if ( (unsigned __int8)sub_1C0015A40(a1 + 2408, a1 + 8 * (v17 + 4 * (v17 + 89LL))) == 1 )
    {
    ...
    v40 = 0LL;
    v39 = 0LL;
    if ( (unsigned __int8)sub_1C0015A40(v22, &v38) == 1 )
      break;
    if ( ++v17 >= 0xAu )
      goto LABEL_16;
  }
