        ...
        __int64 a7)
{
  ...
  if ( !a4 )
    return 3221225485LL;
  v12 = *a4;
  if ( !*a4 || !a5 || a6 || !(unsigned __int8)sub_1C004DD04(a5, v12) )
    return 3221225485LL;
  v13 = 48 * v12 + 56;
  v14 = (_DWORD *)(a5 + 24);
  v15 = v12;
  ...
  while ( v15 );
  v16 = (_DWORD *)sub_1C0007CF4(64LL, v13, 1330667858LL, a1);
  v52 = v16;
  v7 = v16;
  if ( !v16 )
    return 3221225626LL;
  ...
  if ( *a4 )
  {
    do
    {
      ...
      else
      {
        ...
        {
          v26 = sub_1C0044F7C((_DWORD *)v21, v25);
          v25 = v27 + 1;
          v20[1] = *(_QWORD *)(v26 + 16);
          *v20 = *(_QWORD *)(v26 + 8);
        }
...
LABEL_30:
  ...
  while ( v36 );
  v8 = (char *)sub_1C0007CF4(64LL, v34, 1330667858LL, a1);
  if ( !v8 )
  {
    v31 = -1073741670;
    goto LABEL_72;
