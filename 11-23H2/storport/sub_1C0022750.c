/*
 * XREFs of sub_1C0022750 @ 0x1C0022750
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1C0022750(__int64 DeviceObject, struct _IO_WORKITEM *Context)
{
  PVOID v2; // r14
  ...
  if ( !KeGetCurrentIrql() )
  {
    ...
    while ( 1 )
    {
      ...
      OutputBuffer = (_DWORD *)sub_1C0007CF4(64LL, OutputBufferLength, 1700028754LL, DeviceObject);
      if ( !OutputBuffer )
        break;
      InputBuffer = 53LL;
