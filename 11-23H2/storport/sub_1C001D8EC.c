/*
 * XREFs of sub_1C001D8EC @ 0x1C001D8EC
 * Callers:
...
void __fastcall sub_1C001D8EC(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rcx
  ...
  if ( ((_DWORD)v2
    ...
    && sub_1C001ABEC(v2, 0x400000000000LL) )
  {
    v29 = 16LL;
    v28 = a1 + 5000;
    v16 = *(_DWORD *)(a1 + 56);
    ...
    v59 = 4LL;
    v61 = 1LL;
    sub_1C001D420(v5, (unsigned __int8 *)dword_1C008673E, v6, v7, 0x13u, &v27);
  }
  ...
  if ( ((_DWORD)v3
     ...
     || *(_DWORD *)(a1 + 5136))
    && (unsigned int)dword_1C00930C8 > 5
    && sub_1C001ABEC(v3, 0x400000000000LL) )
  {
    v29 = 16LL;
    v28 = a1 + 5000;
    v26[0] = *(_DWORD *)(a1 + 56);
    ...
    v59 = 4LL;
    v61 = 1LL;
    sub_1C001D420(v8, (unsigned __int8 *)dword_1C0087481, v9, v10, 0x13u, &v27);
  }
  sub_1C001DA20(a1);
  if ( !*(_BYTE *)(a1 + 5280) && (int)sub_1C00076F4(a1) >= 0 )
  {
    WorkItem = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(a1 + 8));
    if ( WorkItem )
      IoQueueWorkItem(WorkItem, sub_1C0022750, NormalWorkQueue, WorkItem);
    else
