/*
 * XREFs of sub_1C00745B0 @ 0x1C00745B0
 * Callers:
...
__int64 __fastcall sub_1C00745B0(__int64 a1, __int64 a2, unsigned int a3, _BYTE *a4)
{
  __int64 v4; // r12
  int v5; // esi
  ...
  v6 = 0;
  v7 = a3;
  v8 = (_DWORD *)sub_1C0007CF4(64LL, a3, 1213423954LL, *(_QWORD *)(a1 + 8));
  v9 = v8;
  if ( !v8 )
