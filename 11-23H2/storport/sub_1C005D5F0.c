/*
 * XREFs of sub_1C005D5F0 @ 0x1C005D5F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1C005D5F0(PDEVICE_OBJECT DeviceObject, PVOID Context)
{
  __int64 v2; // rbx
  ...
  if ( AttachedDeviceReference )
  {
    ...
    {
      sub_1C003EF0C((__int64)off_1C0093070->AttachedDevice, 0x46u, (__int64)&unk_1C0083530, DeviceObject);
    }
