/*
 * XREFs of sub_1C006ECA8 @ 0x1C006ECA8
 * Callers:
 *     sub_1C0072B64 @ 0x1C0072B64 (sub_1C0072B64.c)
 * Callees:
 *     sub_1C0073C4C @ 0x1C0073C4C (sub_1C0073C4C.c)
 */

__int64 __fastcall sub_1C006ECA8(__int64 a1, __int16 a2, _DWORD *a3)
{
  __int64 result; // rax
