/*
 * XREFs of sub_1C00484D0 @ 0x1C00484D0
 * Callers:
...
__int64 __fastcall sub_1C00484D0(
        __int64 a1,
        unsigned __int64 a2,
        unsigned __int64 a3,
        __int64 a4,
...
LABEL_59:
  ...
  if ( dword_1C00933F0 == 1 )
    goto LABEL_20;
  if ( dword_1C00933F0 == 2 )
  {
LABEL_19:
    v23 = v10;
    goto LABEL_21;
  }
  if ( dword_1C00933F0 != 3 )
  {
    v21 = -1056964606;
    v20 = 4;
    goto LABEL_60;
...
LABEL_20:
  ...
  if ( v23 > v10 )
    goto LABEL_19;
LABEL_21:
  v17 = (unsigned int)dword_1C00933F8;
  v24 = v15;
  v48 = *(_QWORD *)(v15 + 760);
  v25 = 0LL;
  if ( v23 <= (unsigned int)dword_1C00933F8 )
    v17 = v23;
  v44 = v17;
  v26 = v17;
  while ( v26 >= 0x1000 && v16 < v17 )
  {
    *(_QWORD *)&v12 = sub_1C0007CF4(64LL, 40LL, 1161912658LL, *(_QWORD *)(v24 + 8));
