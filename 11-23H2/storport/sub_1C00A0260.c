/*
 * XREFs of sub_1C00A0260 @ 0x1C00A0260
 * Callers:
...
__int64 __fastcall sub_1C00A0260(volatile signed __int32 *a1, unsigned __int32 a2, __int64 a3)
{
...
LABEL_3:
    if ( !v7 )
    {
      while ( 1 )
      {
        ...
        {
          v9 = sub_1C00A0228(*(unsigned int **)v8, *v6);
          v5 = v5 && (v9 & 1) != 0;
          ++v6;
          v7 = v5 == 0;
          goto LABEL_3;
