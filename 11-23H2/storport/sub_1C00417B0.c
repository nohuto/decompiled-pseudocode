/*
 * XREFs of sub_1C00417B0 @ 0x1C00417B0
 * Callers:
...
LABEL_8:
        ...
        if ( DeviceObjectPointer >= 0 )
        {
          if ( v14 >= 0x80 )
          {
            _InterlockedCompareExchange64(&qword_1C0093C98, (signed __int64)DeviceObject, 0LL);
            v3 = DeviceObject;
            if ( (PDEVICE_OBJECT)qword_1C0093C98 == DeviceObject )
            {
              v1 = 0;
              Object = FileObject;
              DeviceObject = 0LL;
...
LABEL_18:
    if ( (byte_1C0093A06 & 0x40) != 0 )
      sub_1C0041AC0(v3, &unk_1C0088F78, v4, (unsigned int)DeviceObjectPointer);
  }
  if ( FileObject )
