/*
 * XREFs of sub_1C0061770 @ 0x1C0061770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1C0061770(__int64 a1)
{
  __int64 v1; // rdi
  IRP *v3; // rsi
  __int64 v4; // rbx
  ...
  if ( v8 != 16 )
  {
    ...
    {
      sub_1C003DB10(*(_QWORD *)(v4 + 24));
    }
  }
  v11 = *(unsigned __int8 *)(v1 + 2);
  if ( (_BYTE)v11 == 40 )
    v11 = *(_DWORD *)(v1 + 20);
  if ( v11 == 16 && (unsigned int)dword_1C00930C8 > 5 && sub_1C001ABEC(v5, 0x400000000000LL) )
  {
    v14 = *(_QWORD *)(v4 + 24);
    v27 = 0;
    v30 = 0;
    ...
    v43 = &v22;
    v44 = v13;
    sub_1C001D420(v14, (unsigned __int8 *)dword_1C0085100, v12, v13, 9u, &v24);
  }
  sub_1C0061A30(v4, v3);
  if ( (*(_BYTE *)(a1 + 17) & 2) != 0 )
  {
    sub_1C001AEA8(v4, *(_DWORD *)(a1 + 748));
    *(_BYTE *)(a1 + 17) &= ~2u;
  }
  v3->IoStatus.Status = sub_1C0008570(*(_BYTE *)(v1 + 3));
  v3->IoStatus.Information = v7;
  sub_1C0017AF4((__int64)v3);
  if ( v8 == 16 )
  {
    sub_1C0008C44(a1, 1, v16);
    sub_1C00084E4(*(_QWORD *)(v4 + 24), a1 - 48);
  }
  else
  {
    *(_DWORD *)(v4 + 1776) = 0;
    ...
    && BYTE1(off_1C0093070->Timer) >= 4u )
  {
    ...
    sub_1C003F0C4((__int64)off_1C0093070->AttachedDevice, 0x1Au, (__int64)&unk_1C0083530, v4, v3, v18);
  }
  if ( (qword_1C0093468 & 0x10) != 0 )
    sub_1C0060EDC(*(_QWORD *)(v4 + 24), (__int64)v3, v1);
  return sub_1C0003440(v3, 0, v3->IoStatus.Status);
}
