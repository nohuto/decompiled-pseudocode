/*
 * XREFs of sub_1C006F440 @ 0x1C006F440
 * Callers:
...
void __fastcall sub_1C006F440(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // r11
  ...
  ++dword_1C0093BDC;
  if ( (unsigned int)dword_1C00930C8 > 5 && sub_1C001ABEC(a1, 0x800000000000LL) )
  {
    v2 = *(_QWORD *)(v1 + 24);
    v46 = 16LL;
    v48 = 16LL;
    ...
    v111 = &v32;
    v112 = 1LL;
    sub_1C001D420(v26, (unsigned __int8 *)dword_1C00882C7, v6, v23, 0x26u, &v44);
  }
}
