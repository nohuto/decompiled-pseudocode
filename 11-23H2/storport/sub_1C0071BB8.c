/*
 * XREFs of sub_1C0071BB8 @ 0x1C0071BB8
 * Callers:
...
void __fastcall sub_1C0071BB8(__int64 a1)
{
  ...
  if ( sub_1C0008B84(a1) )
  {
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1792) + 32LL) & 0x100) != 0 )
    {
      ...
      {
        if ( sub_1C001ABEC(v2, 0x400000000000LL) )
        {
          v6 = *(_QWORD *)(a1 + 24);
          v24 = a1 + 2024;
          v23 = 16LL;
          ...
          v46 = &v20;
          v47 = 8LL;
          sub_1C001D420(v9, (unsigned __int8 *)dword_1C008662A, v3, v4, 0xFu, &v21);
        }
      }
