/*
 * XREFs of sub_1C00A9A4C @ 0x1C00A9A4C
 * Callers:
...
void __fastcall sub_1C00A9A4C(GUID *Guid, _QWORD *a2, int *a3, _BYTE *a4)
{
  __int64 v8; // rbx
  __int64 v9; // rax
  ...
  v25 = 0;
  GuidString = 0LL;
  if ( (int)RtlQueryRegistryValuesEx(2147483650LL, &xmmword_1C00899D0, &v17, 0LL, 0LL) >= 0 )
  {
    if ( v13 )
    {
      v21 = 4;
      ...
      v31 = 0LL;
      v32 = 0;
      v33[0] = xmmword_1C00899D0;
      v33[1] = xmmword_1C00899E0;
