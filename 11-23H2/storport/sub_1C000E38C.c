/*
 * XREFs of sub_1C000E38C @ 0x1C000E38C
 * Callers:
...
__int64 __fastcall sub_1C000E38C(
        __int64 a1,
        __int64 a2,
        int a3,
        unsigned int a4,
        ...
        __int64 a12)
{
  ...
  if ( !a3 )
  {
    if ( a9 && byte_1C0093BE8 && (byte_1C0093A03 & 0x10) != 0 )
    {
      if ( a10 > 2 )
      {
        if ( a10 > 4 )
          v17 = (EVENT_DESCRIPTOR)xmmword_1C00894B0;
        else
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0089510;
      }
      else
      {
        v17 = (EVENT_DESCRIPTOR)xmmword_1C00895A0;
      }
      goto LABEL_86;
    }
    if ( !a2 )
...
LABEL_8:
        ...
        {
          if ( a10 > 4 )
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0088CD0;
          else
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0089750;
        }
        else
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0089128;
        }
        goto LABEL_86;
      }
      if ( a10 > 2 )
      {
        if ( a10 > 4 )
          v17 = (EVENT_DESCRIPTOR)xmmword_1C00890F8;
        else
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0089068;
      }
      else
      {
        v17 = (EVENT_DESCRIPTOR)xmmword_1C0089118;
      }
LABEL_86:
      EventDescriptor = v17;
      goto LABEL_87;
  ...
  if ( a3 == 1 )
  {
    if ( (unsigned int)(a7 - 1) > 1 )
    {
      if ( a7 != 3 )
        goto LABEL_87;
      if ( a9 && (byte_1C0093A05 & 8) != 0 )
      {
        if ( a10 > 2 )
        {
          if ( a10 > 4 )
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0089610;
          else
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0088C50;
        }
        else
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088E78;
        }
        goto LABEL_86;
      }
      if ( a2 )
      {
        if ( (byte_1C0093A05 & 8) != 0 )
        {
          ...
          {
            if ( a10 > 4 )
              v17 = (EVENT_DESCRIPTOR)xmmword_1C0089108;
            else
              v17 = (EVENT_DESCRIPTOR)xmmword_1C00895D0;
          }
          else
          {
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0089098;
          }
          goto LABEL_86;
        }
      }
      else if ( (byte_1C0093A05 & 8) != 0 )
      {
        if ( a10 > 2 )
        {
          if ( a10 > 4 )
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0089550;
          else
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0088B90;
        }
        else
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C00895F0;
        }
        goto LABEL_86;
      }
    }
    ...
    {
      if ( a9 && (byte_1C0093A04 & 0x20) != 0 )
      {
        if ( a10 <= 2 )
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088A70;
        }
        else if ( a10 <= 4 )
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088CF0;
        }
        else
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C00841A8;
        }
        goto LABEL_86;
      }
      if ( a2 )
      {
        if ( (byte_1C0093A04 & 0x20) != 0 )
        {
          ...
          {
            if ( a10 > 4 )
              v17 = (EVENT_DESCRIPTOR)xmmword_1C0088BD0;
            else
              v17 = (EVENT_DESCRIPTOR)xmmword_1C0089230;
          }
          else
          {
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0089460;
          }
          goto LABEL_86;
        }
      }
      else if ( (byte_1C0093A04 & 0x20) != 0 )
      {
        if ( a10 > 2 )
        {
          if ( a10 > 4 )
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0088BF0;
          else
            v17 = (EVENT_DESCRIPTOR)xmmword_1C00897B0;
        }
        else
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088F08;
        }
        goto LABEL_86;
      }
    }
  ...
  if ( (unsigned int)(a7 - 1) <= 1 )
  {
    if ( a2 )
    {
      if ( (byte_1C0093A05 & 0x20) != 0 )
      {
        ...
        {
          if ( a10 > 4 )
            v17 = (EVENT_DESCRIPTOR)xmmword_1C0088A50;
          else
            v17 = (EVENT_DESCRIPTOR)xmmword_1C00890B8;
        }
        else
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088B50;
        }
        goto LABEL_86;
      }
    }
    else if ( (byte_1C0093A05 & 0x20) != 0 )
    {
      if ( a10 > 2 )
      {
        if ( a10 > 4 )
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088B30;
        else
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088C60;
      }
      else
      {
        v17 = (EVENT_DESCRIPTOR)xmmword_1C0088E98;
      }
      goto LABEL_86;
    }
    return 0LL;
  ...
  if ( a7 == 3 )
  {
    if ( a2 )
    {
      if ( (byte_1C0093A05 & 0x40) != 0 )
      {
        if ( a10 <= 2 )
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088CE0;
        }
        else if ( a10 <= 4 )
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C00896D0;
        }
        else
        {
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0084198;
        }
        goto LABEL_86;
      }
    }
    else if ( (byte_1C0093A05 & 0x40) != 0 )
    {
      if ( a10 > 2 )
      {
        if ( a10 > 4 )
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0089470;
        else
          v17 = (EVENT_DESCRIPTOR)xmmword_1C0088AC0;
      }
      else
      {
        v17 = (EVENT_DESCRIPTOR)xmmword_1C0088F68;
      }
      goto LABEL_86;
    }
    return 0LL;
...
LABEL_87:
  ...
  if ( (unsigned int)(a3 - 1) <= 1 && (unsigned int)(a7 - 2) <= 2 )
  {
    ...
    {
      case 2:
        v59 = v58 <= dword_1C009344C;
        break;
      case 3:
        v59 = v58 <= dword_1C0093448;
        break;
      case 4:
        v59 = v58 <= dword_1C0093478;
        break;
      default:
        goto LABEL_73;
    }
...
LABEL_73:
  ...
  v50 = sub_1C0013F74(a6, EventDescriptor.Keyword);
  v51 = *(_QWORD *)(a1 + 16);
  EventDescriptor.Keyword = v50;
  sub_1C0010EE0(v51, &v69);
  if ( *((_QWORD *)&v69 + 1) )
  {
    v52 = -1LL;
    do
  ...
  UserDataCount = v19 + 1;
  v27 *= 2LL;
  *(&UserData.Ptr + v27) = (ULONGLONG)&v63;
  *((_QWORD *)&UserData.Size + v27) = 4LL;
  if ( v18 )
  {
    ...
    *((_QWORD *)&UserData.Size + v47) = 8LL;
    v49 = 2LL * v48;
    UserDataCount = v48 + 1;
    *(&UserData.Ptr + v49) = (ULONGLONG)&v64;
...
LABEL_46:
      ...
      v39 = UserDataCount + 1;
      v38 *= 2LL;
      *(&UserData.Ptr + v38) = (ULONGLONG)v37;
      ...
      *(&UserData.Reserved + 2 * v38) = 0;
      ...
      UserDataCount = v39 + 1;
      ++v32;
      *(&UserData.Ptr + v41) = (ULONGLONG)v40;
...
LABEL_50:
  v42 = EtwWriteEx(RegHandle, &EventDescriptor, 0LL, 1u, &ActivityId, 0LL, UserDataCount, &UserData);
  if ( (unsigned int)(a3 - 1) <= 1 )
    sub_1C0010F40(v61, v67, a1, a2, v64, a10, v29, v66);
  return v42;
}
