/*
 * XREFs of sub_1C00031D0 @ 0x1C00031D0
 * Callers:
...
__int64 __fastcall sub_1C00031D0(__int64 a1, _QWORD *a2, __int64 a3)
{
  __int64 v3; // rbx
...
LABEL_42:
  ...
  if ( *(_DWORD *)(v10 + 928) == 2 )
  {
    v25 = sub_1C000FE18(v10, a2, a3);
    v28 = *(_QWORD *)(v9 + 48);
    if ( v25 <= *(_DWORD *)(v28 + 920) )
    {
      sub_1C0066DC8(v28, v26, v27);
      goto LABEL_42;
    }
  }
LABEL_6:
  ...
  if ( *(_DWORD *)(v9 + 24) && *(int *)(v9 + 40) <= 0 && !(unsigned __int8)sub_1C001A174(v9) && a2 )
  {
    KeAcquireInStackQueuedSpinLockAtDpcLevel(v15, &LockHandle);
    if ( *(int *)(v9 + 40) > 0 || (unsigned __int8)sub_1C001A174(v9) || !*(_DWORD *)(v9 + 24) )
    {
      sub_1C0022D64(v9 + 64, *(_QWORD *)(a1 + 16) - 48LL);
    }
    else
    {
      v17 = *(_QWORD **)(v9 + 8);
      ...
      *(_DWORD *)(v9 + 36) = v21;
      ...
      if ( (*(_BYTE *)(*a2 + 22LL) & 0x20) == 0 )
        goto LABEL_35;
      v22 = (_QWORD *)sub_1C00215F4(*a2, v19, v16);
      v23 = *v22;
