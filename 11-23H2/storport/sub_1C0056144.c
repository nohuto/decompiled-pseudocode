/*
 * XREFs of sub_1C0056144 @ 0x1C0056144
 * Callers:
 *     StorPortNotification @ 0x1C000EAB0 (StorPortNotification.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00249D0 (_guard_dispatch_icall_nop.c)
 *     sub_1C0079464 @ 0x1C0079464 (sub_1C0079464.c)
 *     sub_1C0079534 @ 0x1C0079534 (sub_1C0079534.c)
 *     sub_1C00797A4 @ 0x1C00797A4 (sub_1C00797A4.c)
 *     sub_1C00B1D68 @ 0x1C00B1D68 (sub_1C00B1D68.c)
 */

void __fastcall sub_1C0056144(__int64 a1, int a2, _QWORD *a3)
{
  int v4; // edx
  int v5; // edx
  int v6; // edx
