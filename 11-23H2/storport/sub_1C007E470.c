/*
 * XREFs of sub_1C007E470 @ 0x1C007E470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1C007E470(int **a1, __int64 a2, __int64 *a3, _QWORD *a4)
{
  unsigned int v4; // ebx
  __int64 *v6; // rdi
  __int64 v8; // rsi
  ...
  *a4 = 0LL;
  ...
  {
    if ( off_1C0093070 != (PDEVICE_OBJECT)&off_1C0093070 && BYTE1(off_1C0093070->Timer) >= 2u )
      sub_1C007E934(off_1C0093070->AttachedDevice);
    v10 = 4;
    v15 = v6[2];
LABEL_35:
    v14 = *((unsigned int *)v6 + 3);
...
LABEL_37:
    v4 = -1073741435;
    sub_1C0055EEC(*a1, "ErrInvalidSecretProtection", v10, v12, v14, v15);
    return v4;
  }
  v6 = (__int64 *)*v6;
  v9 = *((_DWORD *)v6 + 2);
  ...
  {
    if ( off_1C0093070 != (PDEVICE_OBJECT)&off_1C0093070 && BYTE1(off_1C0093070->Timer) >= 2u )
      sub_1C003EE60((__int64)off_1C0093070->AttachedDevice, 0x12u, (__int64)&unk_1C008B550, v9, *((_DWORD *)v6 + 3));
    v10 = 5;
    v15 = 0LL;
    v14 = *((unsigned int *)v6 + 3);
    goto LABEL_36;
