/*
 * XREFs of sub_1C00A0400 @ 0x1C00A0400
 * Callers:
...
__int64 __fastcall sub_1C00A0400(__int64 a1, int a2, __int64 a3, _BYTE *a4, _BYTE *a5)
{
  _BYTE *v5; // rsi
  ...
  *a4 = 0;
  *a5 = 0;
  Dst = (_BYTE *)sub_1C0007CF4(64LL, 4096LL, 1229873490LL, *(_QWORD *)(*(_QWORD *)(a3 + 8) + 8LL));
  v5 = Dst;
  if ( !Dst )
    goto LABEL_4;
  v14 = sub_1C00ACAB4(a1, *(_QWORD *)(a3 + 8), a2, 0, v28, v31, 0, Dst);
  if ( v14 < 0 )
  {
    v9 = 2;
    goto LABEL_5;
  ...
  if ( !v5[4 * (v5[26] & 0xF) + 130] && !*(_QWORD *)v5 )
    goto LABEL_5;
  *a4 = 1;
  v15 = (unsigned __int8 *)sub_1C0007CF4(64LL, 4096LL, 1229873490LL, *(_QWORD *)(*(_QWORD *)(a3 + 8) + 8LL));
  v7 = v15;
  if ( !v15 )
  {
LABEL_4:
...
LABEL_14:
  ...
  v14 = sub_1C00ACAB4(a1, *(_QWORD *)(a3 + 8), a2, 3, v29, v32, 0, v15);
  if ( v14 < 0 )
  {
    v9 = 3;
LABEL_13:
  ...
  if ( (*(_DWORD *)(v23 + 1872) & 0x20) == 0 )
    goto LABEL_13;
  v24 = (void *)sub_1C0007CF4(64LL, 4096LL, 1229873490LL, *(_QWORD *)(v23 + 8));
  v25 = *(_QWORD *)(a3 + 8);
  v8 = v24;
  if ( !v24 )
  {
  ...
  v26 = sub_1C00ACAB4(a1, v25, a2, 5, v30, v33, 2, v24);
  v11 = a2;
  v14 = v26;
  v12 = a1;
  if ( v26 >= 0 )
