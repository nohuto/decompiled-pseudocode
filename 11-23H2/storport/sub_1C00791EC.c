/*
 * XREFs of sub_1C00791EC @ 0x1C00791EC
 * Callers:
 ...
 *     sub_1C00B1AF0 @ 0x1C00B1AF0 (sub_1C00B1AF0.c)
 */

__int64 __fastcall sub_1C00791EC(__int64 a1, IRP *a2, char a3, unsigned int a4, unsigned int a5, unsigned int *a6)
{
  int v10; // ebx
  __int64 v11; // r8
  int v12; // r8d
  ...
  v10 = sub_1C007913C(a6, a2);
  if ( v10 >= 0 )
  {
    LOBYTE(v11) = a3;
    v10 = sub_1C00B1AF0(a6, a2, v11);
    if ( v10 >= 0 )
    {
      v17 = 0LL;
      v18[0] = 0LL;
      ...
      LOBYTE(v12) = a3;
      sub_1C00B1AA4((_DWORD)a6, (_DWORD)a2, v12, (unsigned int)&v17, (__int64)v18);
