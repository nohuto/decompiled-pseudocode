/*
 * XREFs of sub_1C0058B88 @ 0x1C0058B88
 * Callers:
 ...
 *     sub_1C0057480 @ 0x1C0057480 (sub_1C0057480.c)
 */

__int64 __fastcall sub_1C0058B88(__int64 a1, __int64 a2, __int64 a3)
{
  int v3; // ebx
  __int64 v4; // r14
  bool v5; // zf
    ...
    && (unsigned int)(*(_DWORD *)(a3 + 8) - 1) <= 1 )
  {
    if ( sub_1C0057480(a1, a2, a3) )
    {
      ...
      v12 = DbgkWerCaptureLiveKernelDump(v8, 481LL, 1LL, v4, v14, v11, v9, sub_1C0058DD0, v13);
    }
    else
    {
      v12 = -1073741823;
  ...
  if ( byte_1C0093BE8 )
  {
    ...
    if ( (byte_1C0093A06 & 0x10) != 0 )
    {
      ...
      else
      {
        ...
        v19 = (const char *)&dword_1C0082784;
