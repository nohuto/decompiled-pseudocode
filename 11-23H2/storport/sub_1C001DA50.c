/*
 * XREFs of sub_1C001DA50 @ 0x1C001DA50
 * Callers:
...
void __fastcall sub_1C001DA50(__int64 a1)
{
  __int64 v2; // rcx
  __int64 v3; // rdx
  ...
  if ( (unsigned int)dword_1C00930C8 > 5 && sub_1C001ABEC(a1, 0x400000000000LL) )
  {
    ...
    v36 = 1LL;
    v38 = 1LL;
    sub_1C001AA4C((__int64)v39, *(_WORD **)(v3 + 4656));
    sub_1C001AAA8((__int64)v40, (_BYTE *)(a1 + 160));
    sub_1C001AAA8((__int64)v41, (_BYTE *)(a1 + 169));
    sub_1C001AAA8((__int64)v42, (_BYTE *)(a1 + 186));
    v5 = v4[1];
    v43 = &v23;
    v14 = *(_DWORD *)(a1 + 2392);
    v45 = &v14;
    ...
    v69 = 4LL;
    v71 = 4LL;
    sub_1C001D420(v6, (unsigned __int8 *)dword_1C0087824, v7, v8, 0x1Du, &v24);
  }
  *(_QWORD *)(a1 + 2204) = 0LL;
}
