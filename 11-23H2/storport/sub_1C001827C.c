/*
 * XREFs of sub_1C001827C @ 0x1C001827C
 * Callers:
 *     sub_1C00173C4 @ 0x1C00173C4 (sub_1C00173C4.c)
 * Callees:
 *     sub_1C00A1728 @ 0x1C00A1728 (sub_1C00A1728.c)
 */

_QWORD *__fastcall sub_1C001827C(__int64 *a1, unsigned int a2, _QWORD *a3, int a4, unsigned int a5, _QWORD *a6)
{
  __int64 v6; // rdi
  __int64 v8; // rbx
  __int64 v10; // rsi
  ...
  v8 = *a1;
  v10 = 0LL;
  sub_1C00A1728(v6, a2, a2 >> 8, HIWORD(a2), a3[4], a5, *(_BYTE *)(*a1 + 442));
  if ( *(_BYTE *)(v8 + 442) == 1 )
  {
