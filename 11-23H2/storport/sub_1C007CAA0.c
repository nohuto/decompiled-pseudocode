/*
 * XREFs of sub_1C007CAA0 @ 0x1C007CAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1C007CAA0(int **a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v6; // ebx
  __int64 v7; // rax
  int v8; // r9d
  ...
  {
    if ( off_1C0093070 != (PDEVICE_OBJECT)&off_1C0093070 && BYTE1(off_1C0093070->Timer) >= 2u )
      sub_1C003EE60((__int64)off_1C0093070->AttachedDevice, 0xCu, (__int64)&unk_1C008B4B8, v8, *(_DWORD *)(v7 + 12));
    v9 = 2;
LABEL_50:
    v6 = -1073741435;
    sub_1C0055EEC(*a1, "ErrInvalidColData", v9, *(_DWORD *)a4, *(unsigned int *)(a4 + 4), 0LL);
...
LABEL_39:
      if ( off_1C0093070 != (PDEVICE_OBJECT)&off_1C0093070 && BYTE1(off_1C0093070->Timer) >= 2u )
      {
        ...
        sub_1C003EE60((__int64)off_1C0093070->AttachedDevice, 0xDu, (__int64)&unk_1C008B4B8, v14, v31);
      }
      v6 = -1073741435;
      sub_1C0055EEC(*a1, "ErrInvalidColData", 3, *(_DWORD *)a4, *(unsigned int *)(a4 + 4), v16);
      break;
    }
    if ( *(_DWORD *)(v15 + 12) )
    {
      v38 = 1;
      v18 = sub_1C007C758(v15, v7, &v35);
      v17 = v35;
      v6 = v18;
      goto LABEL_24;
    }
    if ( v12 )
    {
      ...
      if ( off_1C0093070 != (PDEVICE_OBJECT)&off_1C0093070 && BYTE1(off_1C0093070->Timer) >= 2u )
      {
        sub_1C003EDF0((__int64)off_1C0093070->AttachedDevice, 0xFu, (__int64)&unk_1C008B4B8);
        break;
      }
LABEL_32:
      ++v13;
    ...
    else
    {
      ...
      if ( v19 < *((_DWORD *)v17 + 3) )
      {
        if ( off_1C0093070 != (PDEVICE_OBJECT)&off_1C0093070 && BYTE1(off_1C0093070->Timer) >= 2u )
        {
          ...
          sub_1C003EEB0((__int64)off_1C0093070->AttachedDevice, 0xEu, (__int64)&unk_1C008B4B8, v13, v31, v32);
        }
        sub_1C0055EEC(*a1, "ErrInvalidColData", 4, *(_DWORD *)a4, *(unsigned int *)(a4 + 4), v13);
        v6 = -1073741789;
        v17 = 0LL;
      }
      else
      {
        if ( v19 > 8 )
        {
          ...
          v20 = (const void *)sub_1C007FC70(v17, v23, *((unsigned int *)v17 + 3));
          v22 = *(void **)v15;
        }
        else
        {
          *(_QWORD *)v15 = 0LL;
          v20 = (const void *)sub_1C007FC70(v17, 0LL, *((unsigned int *)v17 + 3));
          v22 = (void *)v15;
        }
        memmove(v22, v20, v21);
...
LABEL_24:
      ...
      if ( v25 < *(_DWORD *)(v24 + 12) )
      {
        ...
        if ( off_1C0093070 != (PDEVICE_OBJECT)&off_1C0093070 && BYTE1(off_1C0093070->Timer) >= 2u )
        {
          ...
          sub_1C003EEB0((__int64)off_1C0093070->AttachedDevice, 0x10u, (__int64)&unk_1C008B4B8, v13, v31, v32);
        }
        sub_1C0055EEC(*a1, "ErrInvalidColData", 5, *(_DWORD *)a4, *(unsigned int *)(a4 + 4), v13);
        break;
      }
      memset_0(*(void **)(v15 + 16), 0, v25);
      v27 = (const void *)sub_1C007FC70(v24, v26, *(unsigned int *)(v24 + 12));
