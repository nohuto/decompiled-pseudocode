/*
 * XREFs of sub_1C000B120 @ 0x1C000B120
 * Callers:
 *     sub_1C0009BC0 @ 0x1C0009BC0 (sub_1C0009BC0.c)
 * Callees:
 *     memmove @ 0x1C0024A40 (memmove.c)
 *     sub_1C00504C4 @ 0x1C00504C4 (sub_1C00504C4.c)
 *     sub_1C0050564 @ 0x1C0050564 (sub_1C0050564.c)
 */

__int64 __fastcall sub_1C000B120(__int64 a1, __int64 a2, unsigned int a3, char a4, __int64 a5, char a6)
{
  char v6; // r15
    ...
    switch ( *(_BYTE *)(a2 + 2) )
    {
      ...
      case 0x26:
        if ( (unsigned int)v7 < 0x90 )
          goto LABEL_82;
        sub_1C0050564(a1, a2, 0, 0, 144);
        goto LABEL_49;
      case 0x17:
        if ( (unsigned int)v7 < 0xA8 )
          goto LABEL_82;
        sub_1C0050564(a1, a2, 1, 0, 168);
        *(_DWORD *)(a1 + 120) = 144;
        *(_DWORD *)(a1 + 144) = 96;
        *(_DWORD *)(a1 + 148) = 16;
...
LABEL_51:
  ...
  if ( (byte_1C0093A00 & 0x40) != 0 )
    sub_1C00504C4(LowPart, v30.LowPart, v32, (unsigned int)L"Translate SCSI_REQUEST_BLOCK", v6);
