/*
 * XREFs of sub_1C0023744 @ 0x1C0023744
 * Callers:
...
__int64 __fastcall sub_1C0023744(__int64 a1, _DWORD *a2)
{
  __int64 v3; // rdx
  _BOOL8 v5; // r8
  int v6; // eax
      ...
      while ( (v9 & 1) != 0 )
      {
        ...
        else
        {
          ...
          if ( (v20 & 2) != 0 )
            ...
            LOBYTE(v12) = sub_1C00235F0((volatile signed __int32 *)*v11, v20, (__int64)v11);
