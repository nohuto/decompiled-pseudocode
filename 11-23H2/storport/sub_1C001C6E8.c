/*
 * XREFs of sub_1C001C6E8 @ 0x1C001C6E8
 * Callers:
...
__int64 __fastcall sub_1C001C6E8(__int64 a1)
{
  __int64 v2; // rdi
  ...
  char Dst[8]; // [rsp+2E0h] [rbp-28h] BYREF
  ...
  v2 = (unsigned int)qword_1C0093570;
  v3 = 0LL;
  v4 = 0LL;
  v5 = 0LL;
  v49 = 0LL;
  ...
  if ( *(_QWORD *)(a1 + 2296) )
  {
    v4 = (_QWORD *)sub_1C0007CF4(72LL, (unsigned int)Size, 1700028754LL, *(_QWORD *)(a1 + 8));
    if ( v4 && (v5 = (_QWORD *)sub_1C0007CF4(72LL, (unsigned int)(24 * v2), 1700028754LL, *(_QWORD *)(a1 + 8))) != 0LL )
    {
      if ( byte_1C0093BA0 )
      ...
      qword_1C0093588 = v9.QuadPart;
      v13 = *(const void **)(a1 + 2296);
      *(LARGE_INTEGER *)(a1 + 2312) = v9;
      v54 = v12;
      memmove(v4, v13, (unsigned int)Size);
      for ( i = 1; i < dword_1C0093BF0; ++i )
      {
        v15 = (unsigned int)dword_1C0093578 * i;
        if ( (_DWORD)v2 )
        {
          v16 = v4 + 1;
          v17 = v2;
      ...
      memmove(*(void **)(a1 + 2320), v4, (unsigned int)dword_1C0093578);
      if ( v47 )
      {
        v85 = 0LL;
        if ( (_WORD)qword_1C00934E0 )
        {
          if ( WORD1(qword_1C00934E0) )
          {
            ...
            if ( (_DWORD)v2 )
            {
              ...
              do
              {
                if ( v27 < *((_DWORD *)&xmmword_1C0093530 + 3) && v27 >= dword_1C009350C )
                {
                  v29 = v27 / (unsigned __int16)qword_1C00934E0;
                  v30 = *(v28 - 2);
        ...
        if ( *(_QWORD *)(a1 + 2336) )
        {
          ...
          {
            v32 = v3;
            v33 = (unsigned __int64 *)(*(_QWORD *)(a1 + 2336) + dword_1C0093590 * (unsigned int)(unsigned __int16)v26);
            v34 = *v33;
            v35 = *v33 <= v3;
            *v33 = 0LL;
            v3 = v34;
          ...
          while ( (unsigned __int16)v26 <= (unsigned __int16)word_1C0093BEC );
          *((_QWORD *)&v52 + 1) = v6;
        ...
        if ( (*(_BYTE *)(a1 + 450) & 2) != 0 )
          dword_1C0093B1C = -1;
        if ( dword_1C0093B1C )
          sub_1C0070108(a1, &v54, v26, 1LL);
        else
LABEL_52:
          sub_1C001D070(a1, &v54, v26, 1LL);
        if ( (byte_1C0093A04 & 0x10) != 0 )
        {
          ...
          if ( v41 )
            v43 = v41;
          v44 = (const wchar_t *)&unk_1C0082788;
          if ( *(_QWORD *)(v42 + 5016) )
            v44 = *(const wchar_t **)(v42 + 5016);
          sub_1C001B810(
            (__int64)&RegHandle,
            (__int64)&stru_1C00826A8,
            0LL,
            *(_DWORD *)(v42 + 56),
            *(_BYTE *)(a1 + 96),
            *(_BYTE *)(a1 + 97),
      ...
      if ( dword_1C0093B14 && (*(_BYTE *)(a1 + 451) & 0x10) != 0 )
        sub_1C00722C8(a1);
      v45 = 0;
    }
    else
