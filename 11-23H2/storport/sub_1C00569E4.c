/*
 * XREFs of sub_1C00569E4 @ 0x1C00569E4
 * Callers:
...
__int64 __fastcall sub_1C00569E4(__int64 a1, __int64 a2, int a3, _QWORD *a4, _DWORD *a5)
{
  __int64 v5; // rdi
  unsigned int v6; // ebx
  __int64 v7; // r15
  ...
  {
    v13 = (_DWORD *)sub_1C0007CF4(64LL, v11 + 28, 1918067026LL, a1);
    v14 = v13;
    if ( v13 )
    {
      v13[4] = 1771776;
