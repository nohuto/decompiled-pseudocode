/*
 * XREFs of sub_1C0021134 @ 0x1C0021134
 * Callers:
...
__int64 sub_1C0021134(__int64 a1, unsigned __int64 a2, ...)
{
  _DWORD *v3; // rax
  __int64 v4; // r10
  __int64 v5; // r11
  ...
  if ( *((_BYTE *)v3 + 768) && v3[197] == 3 )
  {
    v11 = (*(__int64 (__fastcall **)(_QWORD, __int64 *, __int64 *, _QWORD, _DWORD, _QWORD, _DWORD, PHYSICAL_ADDRESS *))(*(_QWORD *)(*((_QWORD *)v3 + 95) + 8LL) + 272LL))(
            *((_QWORD *)v3 + 95),
            (__int64 *)va,
            (__int64 *)va1,
            (unsigned int)a2,
  ...
  {
    if ( (*(_DWORD *)(*((_QWORD *)v3 + 71) + 184LL) & 0x2000) != 0 && a2 <= 0x1000 )
      ContiguousNodeMemory = (void *)sub_1C0007CF4(72LL, 4096LL, 1161912658LL, *((_QWORD *)v3 + 1));
    else
      ContiguousNodeMemory = (void *)MmAllocateContiguousNodeMemory(a2, v5, v4, v16, v6, v18);
    v8 = v19;
