/*
 * XREFs of sub_1C0051188 @ 0x1C0051188
 * Callers:
...
__int64 __fastcall sub_1C0051188(__int64 a1, IRP *a2)
{
  struct _IRP *v3; // rbp
      ...
      else
      {
        ...
        if ( v10 >= 0 )
        {
          if ( *(_BYTE *)(*(_QWORD *)(a1 + 6016) + 53LL) )
          {
            ...
            v10 = sub_1C0058FA8(a1, HIDWORD(v3->MdlAddress), v11, v3->Flags, (__int64)(&v3->Flags + 1), (__int64)v16);
          }
          else
          {
            v10 = -1073741637;
