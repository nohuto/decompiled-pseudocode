/*
 * XREFs of sub_1C003DB80 @ 0x1C003DB80
 * Callers:
...
__int64 __fastcall sub_1C003DB80(__int64 a1, IRP *a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
     ...
     || (unsigned int)IrpCount >= 0x40 && HIDWORD(MasterIrp->AssociatedIrp.SystemBuffer)) )
  {
    ...
    if ( Length < IrpCount + (unsigned __int64)HIDWORD(MasterIrp->AssociatedIrp.SystemBuffer) + 8 )
      return (unsigned int)-1073741585;
    v10 = sub_1C0057238(*(_QWORD *)(a1 + 8), a2, &P, &v16);
    if ( v10 < 0 )
    {
      v4 = (unsigned int *)P;
    }
    ...
    {
      v4 = (unsigned int *)P;
      v10 = sub_1C001F308(a1, a2, (unsigned int *)P, v16, 0LL, 0, 64);
      if ( v10 >= 0 )
      {
