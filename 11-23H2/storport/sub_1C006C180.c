/*
 * XREFs of sub_1C006C180 @ 0x1C006C180
 * Callers:
...
void __fastcall sub_1C006C180(__int64 a1)
{
  __int64 v2; // rsi
  __int64 v3; // rax
  __int64 v4; // rax
  ...
  if ( a1 )
  {
    ...
    v3 = *(_QWORD *)(a1 + 5160);
    if ( v3 )
      *(_QWORD *)(a1 + 5168) += (MEMORY[0xFFFFF78000000008] - v3) / 0x2710uLL;
    if ( *(_QWORD *)(a1 + 4896) )
    {
      v4 = *(_QWORD *)(a1 + 5184);
      if ( v4 )
        *(_QWORD *)(a1 + 5192) += (v2 - v4) / 0x2710uLL;
      v5 = *(_QWORD *)(a1 + 5264);
      if ( v5 )
        *(_QWORD *)(a1 + 5272) += (v2 - v5) / 0x2710uLL;
      v6 = *(_QWORD *)(a1 + 5200);
      if ( v6 )
        *(_QWORD *)(a1 + 5208) += (v2 - v6) / 0x2710uLL;
      v7 = *(_QWORD *)(a1 + 5176);
      if ( v7 )
        v7 -= *(_QWORD *)(a1 + 5152);
      if ( (unsigned int)dword_1C00930C8 > 5 && sub_1C001ABEC(v7, 0x400000000000LL) )
      {
        v47 = 16LL;
        v46 = a1 + 5000;
        v29 = *(_DWORD *)(a1 + 56);
        ...
        v73 = 8LL;
        v75 = 4LL;
        sub_1C001D420(v13, (unsigned __int8 *)dword_1C0086D96, v8, v9, 0x11u, &v45);
      }
    }
    ...
    for ( i = *(__int64 **)(a1 + 144); i != (__int64 *)(a1 + 144); i = (__int64 *)*i )
    {
      if ( sub_1C0008B84((__int64)(i - 7)) )
      {
        v15 = i[250];
        if ( v15 )
          i[251] += (v2 - v15) / 0x2710uLL;
        v16 = i[252];
        if ( v16 )
          i[253] += (v2 - v16) / 0x2710uLL;
        v17 = i[260];
        if ( v17 )
          i[261] += (v2 - v17) / 0x2710uLL;
        v18 = i[249];
        if ( v18 )
          v18 -= *(_QWORD *)(a1 + 5152);
        if ( (unsigned int)dword_1C00930C8 > 5 )
        {
          if ( sub_1C001ABEC(v18, 0x400000000000LL) )
          {
            v21 = i[217];
            v46 = a1 + 5000;
            v47 = 16LL;
            ...
            v85 = 8LL;
            v87 = 4LL;
            sub_1C001D420(v24, (unsigned __int8 *)dword_1C0086B33, v19, v20, 0x17u, &v45);
          }
        }
        ExReleaseRundownProtectionCacheAware((PEX_RUNDOWN_REF_CACHE_AWARE)i[216]);
      }
      *(__int64 *)((char *)i + 2052) = 0LL;
      *(__int64 *)((char *)i + 2060) = 0LL;
    }
