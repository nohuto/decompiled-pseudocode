/*
 * XREFs of sub_1C00787D4 @ 0x1C00787D4
 * Callers:
 *     StorPortRegistryWrite @ 0x1C0047100 (StorPortRegistryWrite.c)
 * Callees:
 *     sub_1C00782F0 @ 0x1C00782F0 (sub_1C00782F0.c)
 */

int __fastcall sub_1C00787D4(__int64 a1, __int64 a2, ULONG a3, __int64 a4)
{
  int result; // eax
  unsigned int v9; // eax
  _BYTE *ValueData; // rdi
    ...
    || (result = RtlCreateRegistryKey(0, *(PWSTR *)(a1 + 8)), result >= 0) )
  {
    ...
    if ( a3 == 1 )
    {
      ...
      ValueLength = sub_1C00782F0(Pool2, ValueData, (unsigned __int16)v11);
