/*
 * XREFs of sub_1C0056CF4 @ 0x1C0056CF4
 * Callers:
...
__int64 __fastcall sub_1C0056CF4(__int64 a1, __int64 a2, __int64 *a3, _DWORD *a4)
{
  __int64 v4; // rsi
  unsigned int v5; // edi
  __int64 v6; // r14
...
LABEL_16:
  ...
  v13 = sub_1C0007CF4(64LL, (unsigned int)v9, 1918067026LL, a1);
  v8 = v13;
  if ( v13 )
  {
    *(_DWORD *)v13 = 28;
    *(_DWORD *)(v13 + 16) = 1771392;
    *(_QWORD *)(v13 + 4) = 0x455241574D524946LL;
    if ( v6 )
      v14 = *(_DWORD *)(v6 + 1320);
    else
      v14 = *(_DWORD *)(v10 + 4060);
