/*
 * XREFs of sub_1C004B254 @ 0x1C004B254
 * Callers:
...
NTSTATUS __fastcall sub_1C004B254(__int64 a1, __int64 a2, const GUID *a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v20 = 8LL;
  v22 = 4LL;
  return sub_1C001579C(a1, &stru_1C0088EC8, a3, 7u, &v10);
}
