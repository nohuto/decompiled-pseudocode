/*
 * XREFs of sub_1C0015DDC @ 0x1C0015DDC
 * Callers:
 ...
 *     sub_1C00A1390 @ 0x1C00A1390 (sub_1C00A1390.c)
 */

__int64 __fastcall sub_1C0015DDC(__int64 a1)
{
  unsigned int v2; // edi
  ...
  KeFlushQueuedDpcs();
  v2 = *(_DWORD *)(a1 + 1744);
  if ( v2 != -1 && !(unsigned __int8)sub_1C0023100(*(_QWORD *)(a1 + 24)) )
  {
  ...
  v4 = *(_QWORD *)(a1 + 1760);
  if ( v4 )
    sub_1C00084E4(*(_QWORD *)(a1 + 24), v4 - 48);
  v5 = *(void **)(a1 + 3472);
  if ( v5 )
  {
