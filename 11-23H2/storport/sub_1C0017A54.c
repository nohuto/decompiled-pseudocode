/*
 * XREFs of sub_1C0017A54 @ 0x1C0017A54
 * Callers:
...
_UNKNOWN **__fastcall sub_1C0017A54(__int64 a1, __int64 a2)
{
  _UNKNOWN **result; // rax
  __int64 v3; // rbx
  _BYTE *v4; // r8
  ...
  if ( *(_BYTE *)(v3 + 2) == 40 )
  {
    if ( !*(_DWORD *)(v3 + 20) )
    {
      result = (_UNKNOWN **)sub_1C0018028(v3, 0, 0, 0, (__int64)&v17, (__int64)&v16);
      v4 = v17;
      v5 = v16;
    }
  }
...
LABEL_20:
  if ( v11 )
  {
    ...
    {
      sub_1C0064388(off_1C0093070->AttachedDevice, v7, v6, a1, v3, v6, v7, v8);
    }
    result = (_UNKNOWN **)&unk_1C0082480;
