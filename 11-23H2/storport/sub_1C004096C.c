/*
 * XREFs of sub_1C004096C @ 0x1C004096C
 * Callers:
 ...
 *     sub_1C0041534 @ 0x1C0041534 (sub_1C0041534.c)
 */

__int64 __fastcall sub_1C004096C(__int64 a1, int a2, __int64 a3)
{
  _QWORD *v4; // r15
  char v5; // si
...
LABEL_26:
        ...
        *(_QWORD *)(v15 + 8) = v17;
        if ( (*(_BYTE *)(v16 + 20) & 2) != 0 )
        {
          ...
          sub_1C0041534((PSLIST_HEADER)(a1 + 96));
          sub_1C0041534((PSLIST_HEADER)(a1 + 112));
          *(_BYTE *)(v16 + 20) &= ~2u;
          v11 = v22;
        }
        else
