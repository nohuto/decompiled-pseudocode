/*
 * XREFs of sub_1C0079534 @ 0x1C0079534
 * Callers:
...
char __fastcall sub_1C0079534(__int64 *a1)
{
  __int64 v1; // r14
  _QWORD *v2; // rbx
  int *v3; // rdi
  ...
  if ( v6 >= 0 && v11 )
  {
    ...
    do
      ++v7;
    while ( *((_WORD *)v31 + v7) );
    sub_1C007984C((char *)v31 + 2 * v7, v1);
    DestinationString = 0LL;
    RtlInitUnicodeString(&DestinationString, L"RtlQueryRegistryValuesEx");
