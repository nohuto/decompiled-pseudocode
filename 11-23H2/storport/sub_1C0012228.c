/*
 * XREFs of sub_1C0012228 @ 0x1C0012228
 * Callers:
...
__int64 __fastcall sub_1C0012228(__int64 a1, IRP *a2)
{
  ...
  {
    sub_1C003F074(off_1C0093070->AttachedDevice, 39LL, &unk_1C008A080, a1, a2);
  }
  sub_1C00076F4(a1);
  ...
  *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.SetQuota
  ...
  v5[-1].Context = 0LL;
  v5[-1].CompletionRoutine = (PIO_COMPLETION_ROUTINE)sub_1C0014130;
  v5[-1].Control = -32;
  ...
  if ( off_1C0093070 != (PDEVICE_OBJECT)&off_1C0093070
    ...
    && BYTE1(off_1C0093070->Timer) >= 4u )
  {
    sub_1C003F0C4(off_1C0093070->AttachedDevice, 40LL, &unk_1C008A080, a1, a2, 259);
  }
  return 259LL;
}
