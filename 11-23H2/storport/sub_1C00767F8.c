/*
 * XREFs of sub_1C00767F8 @ 0x1C00767F8
 * Callers:
...
void __fastcall sub_1C00767F8(__int64 a1, char a2, __int64 a3, unsigned __int16 a4, char a5)
{
  __int128 v8; // xmm1
  ...
  if ( byte_1C0093BE8 )
  {
    ...
    if ( byte_1C0093A03 < 0 )
    {
      ...
      v22 = (const wchar_t *)&unk_1C0082788;
      v23 = a4;
      if ( *(_QWORD *)(v11 + 5952) )
