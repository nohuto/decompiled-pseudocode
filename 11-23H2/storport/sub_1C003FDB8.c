/*
 * XREFs of sub_1C003FDB8 @ 0x1C003FDB8
 * Callers:
...
__int64 __fastcall sub_1C003FDB8(_QWORD *a1)
{
  __int64 result; // rax
  _QWORD *v2; // rbx
  ...
  if ( a1[8] && a1[9] )
  {
    DriverObjectExtension = (KSPIN_LOCK *)IoGetDriverObjectExtension(*(PDRIVER_OBJECT *)(a1[1] + 8LL), StorPortGetSrb);
