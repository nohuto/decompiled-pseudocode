/*
 * XREFs of sub_1C0040220 @ 0x1C0040220
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1C0040220(__int64 DeviceObject, struct _IO_WORKITEM *Context)
{
  KSPIN_LOCK *v2; // rbx
  _QWORD *v5; // rdi
  _QWORD *v6; // rsi
  ...
  if ( *(_DWORD *)v2 == 1094997074 )
  {
    ...
    while ( (_QWORD *)*v5 != v5 )
    {
      ...
      *v7 = v5;
      ...
      sub_1C0040190(DeviceObject, *(v6 - 1));
    }
    *((_BYTE *)v2 + 109) &= ~0x40u;
  }
...
LABEL_14:
      ...
      *v10 = v8;
      --*((_DWORD *)v2 + 854);
      KeReleaseInStackQueuedSpinLock(&LockHandle);
      sub_1C0040190(DeviceObject, *(v9 - 1));
    }
    *((_BYTE *)v2 + 451) &= ~2u;
  }
  if ( Context )
