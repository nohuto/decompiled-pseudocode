/*
 * XREFs of sub_1C007C52C @ 0x1C007C52C
 * Callers:
...
__int64 __fastcall sub_1C007C52C(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  __int64 v5; // rdi
  __int64 v8; // r8
  int v10; // [rsp+20h] [rbp-59h] BYREF
  int v11; // [rsp+24h] [rbp-55h]
  __int64 *p_Dst; // [rsp+28h] [rbp-51h]
  int v13; // [rsp+30h] [rbp-49h]
  int v14; // [rsp+34h] [rbp-45h]
  __int64 Dst; // [rsp+40h] [rbp-39h] BYREF
  ...
  return ((__int64 (__fastcall *)(__int64, __int64, __int64, int *))sub_1C007D4BC)(a1, a2, v8, &v10);
}
