/*
 * XREFs of sub_1C0078F68 @ 0x1C0078F68
 * Callers:
 *     sub_1C001F11C @ 0x1C001F11C (sub_1C001F11C.c)
 * Callees:
 *     memmove @ 0x1C0024A40 (memmove.c)
 *     sub_1C0078DDC @ 0x1C0078DDC (sub_1C0078DDC.c)
 *     sub_1C007913C @ 0x1C007913C (sub_1C007913C.c)
 */

void __fastcall sub_1C0078F68(PIRP Irp, __int64 a2, char a3, __int64 a4)
{
...
LABEL_11:
        ...
        if ( v25 >= Length )
          v25 = Length;
        *(_QWORD *)(a4 + 8) = v25;
        sub_1C0078DDC((__int128 *)v12, Irp);
        goto LABEL_36;
      }
