...
void __fastcall sub_1C001FFFC(__int64 a1)
{
  ...
  struct _SECURITY_QUALITY_OF_SERVICE *v54; // rax
  char v55; // al
  char v56; // cl
  char v57; // cl
  char v58; // al
  ...
  v5 = 0;
  v6 = 0;
  if ( !(unsigned int)sub_1C00201C4(v3) )
    goto LABEL_2;
  v18 = *((_DWORD *)v3 + 226);
  v19 = 0LL;
  if ( !v18 )
    goto LABEL_2;
  while ( *(_QWORD *)(320 * v19 + v3[112] + 264) == 320 * v19 + v3[112] + 264 )
  {
      ...
      do
      {
        ...
        *v28 = (__int64 ***)v27;
        ...
        if ( *(_QWORD *)(*(_QWORD *)v29 + 8LL) != v29
          || (v31 = v23[2][16], *v31 != v29)
          || (*v31 = v30, *(_QWORD *)(v30 + 8) = v31, --*(_DWORD *)(v21 + 24), v32 = v63, *v63 != (__int64 *)&v62) )
        {
LABEL_90:
          __fastfail(3u);
        }
  ...
  while ( (unsigned int)v20 < *(_DWORD *)(*(_QWORD *)(v61 + 48) + 904LL) );
  if ( v5 && v6 > *((_DWORD *)v3 + 1321) )
    *((_DWORD *)v3 + 1321) = v6;
LABEL_2:
  while ( 1 )
  {
    ...
    v36 = v7[2];
    v37 = *(_BYTE *)(v35 + 450);
    sub_1C0040778(v35 + 656, *(_BYTE *)(v36 + 142) & 1);
    _InterlockedIncrement64((volatile signed __int64 *)(v35 + 2168));
    sub_1C000729C(v35);
  ...
  if ( v68 != v4 )
  {
    ...
    v9 = *(_DWORD *)(a1 + 160);
    v67 = v9;
    if ( v9 && (v10 = (__int64 *)sub_1C0007CF4(64LL, 8LL * v9, 1280663890LL, *(_QWORD *)(v8 + 8))) != 0LL )
    {
      v11 = (_QWORD *)(v8 + 144);
      v12 = *(_QWORD **)(v8 + 144);
      if ( v12 != v11 )
      {
        ...
        do
        {
          v14 = v12 - 7;
          if ( *((_BYTE *)v12 + 3224)
            && (*((_DWORD *)v14 + 826) != -1 || (*((_BYTE *)v14 + 450) & 2) != 0)
            && (int)sub_1C00071D4((__int64)(v12 - 7), 0LL, 0LL) >= 0 )
          {
            v46 = v13++;
            v10[v46] = (__int64)v14;
          }
      ...
      if ( v9 )
      {
        ...
        do
        {
          ...
          if ( v68 > v4 )
          {
            v47 = sub_1C004096C(*v16 + 656, v68 - v4, &v62);
            v4 += v47;
            if ( v47 )
              _InterlockedExchangeAdd64((volatile signed __int64 *)(*v16 + 2176), v47);
          }
          sub_1C000729C(*v16);
          ++v15;
          ++v16;
      ...
      ExFreePoolWithTag(v10, 0x4C556152u);
      while ( 1 )
      {
        v17 = v62;
        if ( v62 == (__int64 *)&v62 )
        ...
        *(_QWORD *)(v48 + 8) = &v62;
        ...
        sub_1C000729C(v51);
        v54 = (struct _SECURITY_QUALITY_OF_SERVICE *)v49[2];
