/*
 * XREFs of sub_1C00214E8 @ 0x1C00214E8
 * Callers:
...
NTSTATUS __fastcall sub_1C00214E8(HANDLE KeyHandle, const WCHAR *a2, ULONG a3, PWSTR Buffer, ULONG a5)
{
  char v5; // r14
...
LABEL_4:
  ...
  SourceString.Buffer = (PCHAR)Buffer;
