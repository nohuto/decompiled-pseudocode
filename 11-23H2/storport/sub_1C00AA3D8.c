/*
 * XREFs of sub_1C00AA3D8 @ 0x1C00AA3D8
 * Callers:
...
__int64 __fastcall sub_1C00AA3D8(_DWORD *a1, __int64 a2, int a3, int a4, char a5, char a6)
{
  int v10; // ebp
  int v11; // ecx
  __int64 v12; // rax
  ...
  *((_BYTE *)a1 + 89) = *(_BYTE *)(a2 + 88);
  ...
  {
    v13 = sub_1C0007CF4(64LL, 16 * v12, 1129341266LL, 0LL);
    *((_QWORD *)a1 + 7) = v13;
    if ( !v13 )
      return 3221225495LL;
  }
