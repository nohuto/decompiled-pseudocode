/*
 * XREFs of sub_1C007530C @ 0x1C007530C
 * Callers:
...
__int64 __fastcall sub_1C007530C(_QWORD *a1, __int64 a2)
{
  __int64 v3; // rdi
  char v5; // al
  _QWORD *v6; // rsi
  ...
  else if ( v5 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 )
      {
        ...
        if ( !v8 )
          v8 = v6[2] - v7[2];
        if ( !v8 && !(unsigned int)sub_1C00248F0((_QWORD *)((char *)v6 + 25), (__int64)v7 + 25, 0x40uLL) )
        {
