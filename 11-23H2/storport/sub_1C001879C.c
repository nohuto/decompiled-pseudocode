/*
 * XREFs of sub_1C001879C @ 0x1C001879C
 * Callers:
 *     sub_1C0016C84 @ 0x1C0016C84 (sub_1C0016C84.c)
 * Callees:
 *     memset_0 @ 0x1C0024D40 (memset_0.c)
 *     sub_1C00A17F8 @ 0x1C00A17F8 (sub_1C00A17F8.c)
 */

_QWORD *__fastcall sub_1C001879C(__int64 *a1, unsigned int a2, _QWORD *a3, unsigned int a4, _QWORD *a5)
{
  void *v5; // rbp
  __int64 v7; // r14
  __int64 v10; // r12
  ...
  v11 = *a1;
  LOBYTE(v12) = a2;
  sub_1C00A17F8(v7, v12, a2 >> 8, HIWORD(a2), (__int64)v5, v10, *(_BYTE *)(v11 + 442));
  v13 = 0;
  if ( *(_BYTE *)(v11 + 442) == 1 )
  {
