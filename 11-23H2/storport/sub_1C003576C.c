/*
 * XREFs of sub_1C003576C @ 0x1C003576C
 * Callers:
...
__int64 __fastcall sub_1C003576C(__int64 a1, __int64 a2, __int64 a3)
{
  int v7; // r14d
  unsigned int v8; // ebx
  __int64 v9; // rsi
  ...
  _SLIST_HEADER SListHead; // [rsp+90h] [rbp+7h] BYREF
  ...
  if ( !*(_QWORD *)(a1 + 5312) )
    return 3221225488LL;
  if ( !(unsigned int)sub_1C0007798(a1, 22) )
    return 3221225659LL;
  ...
  if ( !sub_1C0013278(
          ...
          *(_QWORD *)(a1 + 8),
          a3,
          (__int64)Event,
          (void (__fastcall *)(__int64, __int64, __int64))&sub_1C003A360) )
    KeWaitForSingleObject(Event, Executive, 0, 0, 0LL);
  v12 = sub_1C0047948(*(_QWORD *)(a1 + 576) + 16LL, *(unsigned int *)(a2 + 8), *(_QWORD *)(a2 + 16), 0LL);
  if ( v12 >= 0 && (*(_BYTE *)(a2 + 16) & 1) == 0 )
  {
    v25 = 0LL;
    v23 = 16;
    v24 = 16;
    v12 = sub_1C001A364(a1 + 336);
  }
  if ( *(int *)(a1 + 4600) > 1 )
  {
    v13 = 0;
  ...
  if ( v12 >= 0 && (v16 = *(_DWORD *)(a1 + 560)) != 0 )
  {
    ...
    if ( v16 == 1000000 * (v16 / 0xF4240) )
      v17 = v16 / 0xF4240;
    sub_1C0039708(a1, a1 + 4072, a1 + 4136, v17);
  }
  else
  {
    v18 = KfRaiseIrql(2u);
