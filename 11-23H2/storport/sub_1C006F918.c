/*
 * XREFs of sub_1C006F918 @ 0x1C006F918
 * Callers:
...
void __fastcall sub_1C006F918(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // r11
  ...
  if ( (unsigned int)dword_1C00930C8 > 5 && sub_1C001ABEC(a1, 0x400000000000LL) )
  {
    ...
    v54 = 1LL;
    v56 = 1LL;
    sub_1C001AA4C((__int64)v57, *(_WORD **)(v2 + 4656));
    sub_1C001AAA8((__int64)v58, (_BYTE *)(v3 + 160));
    sub_1C001AAA8((__int64)v59, (_BYTE *)(v4 + 169));
    sub_1C001AAA8((__int64)v60, (_BYTE *)(v5 + 186));
    v61 = &v42;
    v8 = -1;
    v9 = *(__int16 **)v7;
    v42 = *(_QWORD *)&qword_1C0093B20;
    v62 = 8LL;
    v10 = *v9;
    v63 = &v33;
    v33 = v10;
    ...
    v111 = &v32;
    v112 = 1LL;
    sub_1C001D420(v26, (unsigned __int8 *)dword_1C0086050, v6, v23, 0x26u, &v44);
  }
}
