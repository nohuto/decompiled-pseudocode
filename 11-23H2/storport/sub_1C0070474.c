/*
 * XREFs of sub_1C0070474 @ 0x1C0070474
 * Callers:
...
char __fastcall sub_1C0070474(__int64 a1)
{
  _UNKNOWN **v1; // rax
  __int64 v2; // rcx
  __int64 v3; // rdx
  ...
  {
    LOBYTE(v1) = sub_1C001ABEC(a1, 0x400000000000LL);
    if ( (_BYTE)v1 )
    {
      v3 = *(_QWORD *)(v2 + 24);
      v35 = 16LL;
      ...
      v43 = 1LL;
      v45 = 1LL;
      sub_1C001AA4C((__int64)v46, *(_WORD **)(v3 + 4656));
      sub_1C001AAA8((__int64)v47, (_BYTE *)(v4 + 160));
      sub_1C001AAA8((__int64)v48, (_BYTE *)(v5 + 169));
      sub_1C001AAA8((__int64)v49, (_BYTE *)(v6 + 186));
      v8 = *(unsigned int *)(v7 + 3284);
      v50 = &v20;
      v21 = *(_DWORD *)(v7 + 3288);
      v52 = &v21;
      v22 = *(_DWORD *)(v7 + 3292);
      ...
      v77 = 4LL;
      v79 = 4LL;
      LOBYTE(v1) = sub_1C001D420(v8, (unsigned __int8 *)dword_1C0087BC6, v11, v12, 0x1Bu, &v33);
    }
  }
  return (char)v1;
}
