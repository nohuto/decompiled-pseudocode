/*
 * XREFs of sub_1C0026B86 @ 0x1C0026B86
 * Callers:
...
__int64 __fastcall sub_1C0026B86(__int64 a1, unsigned __int16 *a2, char a3, __int64 a4)
{
  bool v5; // zf
  _BYTE *v9; // r8
  ...
  if ( v5 )
  {
    sub_1C0018028(a1, 0LL, 0LL, 0LL, &v24, &v25);
    v9 = v24;
    v10 = v25;
    v11 = *(_DWORD *)(a1 + 60);
  }
