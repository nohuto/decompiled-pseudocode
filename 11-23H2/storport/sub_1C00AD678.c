/*
 * XREFs of sub_1C00AD678 @ 0x1C00AD678
 * Callers:
...
__int64 __fastcall sub_1C00AD678(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v3; // rax
  _DWORD *v6; // rbx
  size_t v7; // rbp
  ...
  *a3 = 0LL;
  ...
  if ( v7 < 0x60 )
    return 3221225507LL;
  v9 = sub_1C00ACFB0((__int64 *)a1, 1);
  if ( v9 >= 0 )
  {
    if ( sub_1C003EDC4(*(_QWORD *)(a1 + 5968)) )
    {
      memset_0(v6, 0, v7);
      *v6 = 6291457;
