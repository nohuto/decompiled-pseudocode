/*
 * XREFs of sub_1C0050054 @ 0x1C0050054
 * Callers:
...
__int64 sub_1C0050054(__int64 a1, unsigned __int16 a2, __int64 a3, ...)
{
  const char *v3; // r9
  __int64 v4; // r8
  __int64 v5; // r8
  ...
  if ( !v11 )
    v3 = "NULL";
  return ((__int64 (__fastcall *)(__int64, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, const char *, __int64, _QWORD))qword_1C0093C08)(
           a1,
           43LL,
           &unk_1C008A080,
           a2,
