/*
 * XREFs of sub_1C00707BC @ 0x1C00707BC
 * Callers:
...
void __fastcall sub_1C00707BC(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // r11
  ...
  if ( (unsigned int)dword_1C00930C8 > 5 )
  {
    if ( sub_1C001ABEC(a1, 0x800000000000LL) )
    {
      ...
      v50 = 1LL;
      v52 = 1LL;
      sub_1C001AA4C((__int64)v53, *(_WORD **)(v2 + 4656));
      sub_1C001AAA8((__int64)v54, (_BYTE *)(v3 + 160));
      sub_1C001AAA8((__int64)v55, (_BYTE *)(v4 + 169));
      sub_1C001AAA8((__int64)v56, (_BYTE *)(v5 + 186));
      v57 = &v27;
      ...
      v103 = v11;
      v104 = 512LL;
      sub_1C001D420((__int64)v11, (unsigned __int8 *)dword_1C00875E7, v12, v13, 0x24u, &v40);
    }
  }
}
