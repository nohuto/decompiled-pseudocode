/*
 * XREFs of sub_1C0059884 @ 0x1C0059884
 * Callers:
...
void __fastcall sub_1C0059884(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4, _WORD *Dst)
{
  _DWORD *v5; // r15
  char v7; // dl
  bool v8; // r12
...
LABEL_52:
    ...
    if ( v11 < v9 )
    {
      sub_1C00597E8(a2 + v29, (__int64)&Dst[32 * (unsigned __int64)v11 + 8]);
      v27 = v35;
      v25 = a1;
      ++v11;
    }
