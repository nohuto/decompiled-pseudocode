/*
 * XREFs of sub_1C0050358 @ 0x1C0050358
 * Callers:
 *     StorPortGetDeviceBase @ 0x1C0046480 (StorPortGetDeviceBase.c)
 * Callees:
 *     sub_1C00501AC @ 0x1C00501AC (sub_1C00501AC.c)
 */

__int64 __fastcall sub_1C0050358(_QWORD *a1, int a2, int a3, unsigned __int64 a4, unsigned int a5, int a6, _QWORD *a7)
{
  _QWORD *v7; // r15
  char v8; // di
  __int64 v9; // rax
  ...
  *a7 = 0LL;
  if ( v9 )
  {
    ...
    if ( v13 )
    {
      while ( 1 )
      {
        sub_1C00501AC(a1, v14, &a6, &v20, &v17, &v18);
        if ( a6 == v12 && v20 == a3 )
        {
          v15 = *(_QWORD *)(v17 + 4);
