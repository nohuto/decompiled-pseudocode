/*
 * XREFs of sub_1C004123C @ 0x1C004123C
 * Callers:
...
void __fastcall sub_1C004123C(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // r13
  __int64 v6; // rdi
  int v7; // r12d
...
LABEL_42:
  ...
  if ( sub_1C0010160(v27, a2, 0LL, 0LL) )
  {
    v28 = sub_1C007896C(v8, v19);
    v29 = (unsigned int)sub_1C0023A9C(v27, v28);
    if ( (v7 & 0x1000000) != 0 )
    {
    ...
    else
    {
      for ( j = *(_QWORD *)(v27 + 3352); ; j = *(_QWORD *)(v27 + 3352) )
      {
        ...
        if ( !v32 )
          break;
        v31 = *(_BYTE *)(j + v29);
        if ( v31 == _InterlockedCompareExchange8((volatile signed __int8 *)(j + v29), v32 - 1, v32) )
          break;
      }
    }
    if ( (qword_1C0093468 & 0x1000) != 0 )
    {
      v34 = 0LL;
      v35 = 0;
      sub_1C00407E4(v8, (__int64)&v34, (__int64)&v35);
      sub_1C0019E4C(*(_QWORD *)(v27 + 24), 46, v34, v35, *(unsigned __int8 *)(*v33 + v29), v6, 0LL);
    }
  }
}
