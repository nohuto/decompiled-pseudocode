/*
 * XREFs of sub_1C00ADC5C @ 0x1C00ADC5C
 * Callers:
...
__int64 __fastcall sub_1C00ADC5C(__int64 a1, __int64 a2, _QWORD *a3)
{
  _DWORD *v4; // rbx
  size_t v6; // r12
  __int64 v7; // rsi
  ...
  *a3 = 0LL;
  ...
  if ( v4 && v6 >= 8 )
  {
    ...
    if ( v9 )
      ...
      v10 = 255;
    v11 = (v10 << 8) + 8;
    v12 = sub_1C0007CF4(64LL, v11, 1179476306LL, *(_QWORD *)(a1 + 8));
    v13 = (_WORD *)v12;
    if ( !v12 )
    {
      v26 = -1073741670;
    ...
    Dst[10] = v11 >> 2;
    v26 = sub_1C00AEFFC(a1, v12, 0, v11, (__int64)Dst);
    v14 = v26;
    if ( v26 >= 0 )
    {
...
LABEL_41:
  sub_1C003EC88(v8, &v26);
  v14 = v26;
  if ( v26 >= 0 )
    goto LABEL_42;
LABEL_43:
  sub_1C0076C14(a1, v7, v8, v14);
