/*
 * XREFs of sub_1C000B6FC @ 0x1C000B6FC
 * Callers:
...
__int64 __fastcall sub_1C000B6FC(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rax
  __int64 v5; // rsi
  int v6; // edi
  ...
  result = sub_1C000B7F8(
             (int)a1 + 760,
             *(_QWORD *)(a1 + 8),
             *(_QWORD *)(v5 + 104),
             *(_QWORD *)(v5 + 184),
             v7,
             (__int64)sub_1C0008ED0,
             v5,
             v10,
             v5 + 232);
  if ( (_DWORD)result == -1073741789 )
    return sub_1C003F964(
             (int)a1 + 760,
             *(_QWORD *)(a1 + 8),
             *(_QWORD *)(v5 + 104),
             *(_QWORD *)(v5 + 184),
