/*
 * XREFs of sub_1C00B0368 @ 0x1C00B0368
 * Callers:
...
__int64 __fastcall sub_1C00B0368(__int64 a1, __int64 a2, _QWORD *a3)
{
  int v3; // edi
  __int64 v7; // rsi
  char v8; // r12
  ...
  if ( (*(_BYTE *)(a1 + 111) & 1) != 0 )
  {
    if ( *(_DWORD *)(*(_QWORD *)(a2 + 184) + 16LL) >= 0x1Cu )
    {
      ...
      else
      {
        ...
        BYTE1(v19) = v10;
        v20 = sub_1C00AEFFC(a1, 0LL, 0LL, 0, Dst, v16, 0, 1, 0, 0LL, &v21);
        v11 = v20;
        if ( v8 )
          sub_1C0078140(a1, 0);
        if ( v11 < 0 )
...
LABEL_24:
  ...
  sub_1C0078014(a1, v3, v14, v13, v21, v11);
