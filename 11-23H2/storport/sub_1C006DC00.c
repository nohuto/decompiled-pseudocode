/*
 * XREFs of sub_1C006DC00 @ 0x1C006DC00
 * Callers:
...
char __fastcall sub_1C006DC00(__int64 a1, __int64 a2)
{
  _UNKNOWN **v2; // rax
  __int64 v3; // rbx
  int v4; // r9d
  ...
  {
    LOBYTE(v2) = sub_1C001ABEC(a1, 0x400000000000LL);
    if ( (_BYTE)v2 )
    {
      v27 = 0;
      v30 = 0;
      ...
      v23 = v12;
      v47 = 8;
      LOBYTE(v2) = sub_1C001D420(8LL, (unsigned __int8 *)dword_1C00869BD, v10, v11, 0xAu, &v24);
    }
  }
  return (char)v2;
}
