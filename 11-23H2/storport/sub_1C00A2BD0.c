/*
 * XREFs of sub_1C00A2BD0 @ 0x1C00A2BD0
 * Callers:
...
__int64 __fastcall sub_1C00A2BD0(
        void *a1,
        ...
        _DWORD *a6)
{
  ...
  __int64 (__fastcall *Dst)(__int64, int, const void *, unsigned int, int, __int64); // [rsp+90h] [rbp-49h] BYREF
  ...
  v10 = SystemRoutineAddress(0x40000000LL, v9, &Dst, v8, 0LL);
  *v11 = v15;
  *v12 = v16;
  if ( a2 )
    ZwClose(KeyHandle);
