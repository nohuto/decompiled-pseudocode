/*
 * XREFs of sub_1C006FDF8 @ 0x1C006FDF8
 * Callers:
...
void __fastcall sub_1C006FDF8(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // r9
  __int64 v3; // rdx
  ...
  if ( (unsigned int)dword_1C00930C8 > 5 )
  {
    if ( sub_1C001ABEC(a1, 0x800000000000LL) )
    {
      ...
      v38 = v2;
      v40 = v2;
      sub_1C001AA4C((__int64)v41, *(_WORD **)(v3 + 4656));
      sub_1C001AAA8((__int64)v42, (_BYTE *)(v4 + 160));
      sub_1C001AAA8((__int64)v43, (_BYTE *)(v5 + 169));
      sub_1C001AAA8((__int64)v44, (_BYTE *)(v6 + 186));
      v8 = v7[1];
      v45 = &v25;
      v18 = v9[598];
      v47 = &v18;
      ...
      v67 = 2LL;
      v69[1] = 0;
      sub_1C001D420(v10, (unsigned __int8 *)dword_1C00855A6, v11, v12, 0x1Bu, &v26);
    }
  }
}
