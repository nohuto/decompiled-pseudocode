/*
 * XREFs of sub_1C00A11B0 @ 0x1C00A11B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1C00A11B0(__int64 a1, __int64 a2)
{
  _DWORD *v4; // rax
  unsigned int v5; // eax
  unsigned int v6; // ebx
  ...
  {
    sub_1C003F074((__int64)off_1C0093070->AttachedDevice, 0xCu, (__int64)&unk_1C0089898, a1, a2);
  }
  *(_BYTE *)(a2 + 141) = -88;
  v4 = *(_DWORD **)(a1 + 64);
  if ( *v4 == 1431193940 )
...
LABEL_6:
  ...
  {
    v8 = v6;
    sub_1C003F0C4((__int64)off_1C0093070->AttachedDevice, 0xDu, (__int64)&unk_1C0089898, a1, a2, v8);
  }
  return v6;
}
