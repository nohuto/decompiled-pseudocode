/*
 * XREFs of sub_1C00531E4 @ 0x1C00531E4
 * Callers:
...
__int64 __fastcall sub_1C00531E4(__int64 a1, IRP *a2)
{
      ...
      else
      {
        ...
        if ( v10 >= 0 )
        {
          if ( *(_BYTE *)(*(_QWORD *)(a1 + 3504) + 53LL) )
          {
            ...
            v10 = sub_1C0058FA8(a1, HIDWORD(v4->MdlAddress), v11, v4->Flags, (__int64)(&v4->Flags + 1), (__int64)v18);
          }
          else
          {
            v10 = -1073741637;
