/*
 * XREFs of sub_1C00AD828 @ 0x1C00AD828
 * Callers:
...
__int64 __fastcall sub_1C00AD828(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v3; // rbx
  _DWORD *v5; // rsi
  size_t v7; // r12
  ...
  int v25; // [rsp+E8h] [rbp+6Fh]
  _QWORD *v26; // [rsp+F0h] [rbp+77h]
  ...
  *a3 = 0LL;
  ...
  if ( *((_WORD *)v5 + 4) == 1 && v5[3] >= 0x10u )
  {
    ...
    v10 = sub_1C0007CF4(64LL, 1024LL, 1179476306LL, *(_QWORD *)(a1 + 8));
    v11 = (_WORD *)v10;
    if ( !v10 )
    {
      v24 = -1073741670;
    ...
    v24 = sub_1C00AEFFC(a1, v10, 0, 1024, (__int64)Dst);
    v12 = v24;
    if ( v24 >= 0 )
    {
...
LABEL_27:
  sub_1C003EC88(v9, &v24);
  v12 = v24;
  if ( v24 >= 0 )
    goto LABEL_28;
LABEL_29:
  sub_1C0076AD4(a1, v8, v9, v12);
