/*
 * XREFs of sub_1C006970C @ 0x1C006970C
 * Callers:
...
int __fastcall sub_1C006970C(__int64 a1, __int64 a2, unsigned __int8 a3)
{
  _DWORD *v3; // r13
  int v5; // edi
  int v6; // r12d
  ...
  if ( (byte_1C0093A03 & 1) != 0 )
  {
    ...
    v16 = v5;
    v15 = *(_DWORD *)(v12 + 24);
    LODWORD(v12) = sub_1C0067008((__int64)v13, v11, &v26, a2, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, v25);
  }
  return v12;
}
