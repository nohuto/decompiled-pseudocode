/*
 * XREFs of sub_1C00603D0 @ 0x1C00603D0
 * Callers:
...
__int64 __fastcall sub_1C00603D0(__int64 a1, IRP *a2)
{
...
LABEL_7:
  ...
  v8 = sub_1C0056F98(*(_QWORD *)(a1 + 8), v6, (__int64 *)&P, &v13);
  v9 = P;
  v7 = v8;
  if ( v8 >= 0 )
  {
    v7 = sub_1C001FA9C(a1, (__int64)a2, (__int64)P, v13, 0LL, v12, 64);
