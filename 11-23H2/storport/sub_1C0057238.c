/*
 * XREFs of sub_1C0057238 @ 0x1C0057238
 * Callers:
...
__int64 __fastcall sub_1C0057238(__int64 a1, __int64 a2, _QWORD *a3, unsigned int *a4)
{
  __int64 v4; // r14
  _DWORD *v6; // r15
  _DWORD *v7; // rsi
...
LABEL_9:
  ...
  v14 = 0;
  v16 = sub_1C0007CF4(64LL, v8, 1918067026LL, a1);
  v7 = (_DWORD *)v16;
  if ( v16 )
  {
    *(_DWORD *)v16 = 28;
    *(_DWORD *)(v16 + 16) = 2987004;
    *(_QWORD *)(v16 + 4) = 0x4F544F5250544553LL;
    if ( v4 )
      v17 = *(_DWORD *)(v4 + 1320);
    else
      v17 = *(_DWORD *)(v11 + 4060);
