/*
 * XREFs of sub_1C0033D34 @ 0x1C0033D34
 * Callers:
...
NTSTATUS __fastcall sub_1C0033D34(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v18 = &a8;
  v19 = 4LL;
  return sub_1C001579C(a1, &stru_1C0088D70, 0LL, 6u, &v9);
}
