/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C001F388
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C001F4DC (wil_details_GetCurrentFeatureEnabledState.c)
