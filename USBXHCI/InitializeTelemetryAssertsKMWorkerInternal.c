/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1C001D15C
 * Callers:
...
__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
  ...
  if ( Pool2 )
  {
    ...
    qword_1C00648C8 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C006C040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C006C008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C006C078);
