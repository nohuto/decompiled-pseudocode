/*
 * XREFs of McTemplateK0qqqq_EtwWriteTransfer @ 0x1C0052358
 * Callers:
        ...
        char a7)
{
  ...
  v15 = &a7;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &USBXHCI_ETW_EVENT_SENDING_TRUSTLET_REQUEST_V1, a3, 5u, &v8);
}
