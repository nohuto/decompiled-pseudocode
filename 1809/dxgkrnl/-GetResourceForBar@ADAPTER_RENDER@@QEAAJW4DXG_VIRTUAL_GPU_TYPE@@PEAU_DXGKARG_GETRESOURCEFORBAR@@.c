/*
 * XREFs of ?GetResourceForBar@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1C01DF8C0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetResourceForBar(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v9 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, unsigned int *))(*(_QWORD *)VirtualGpuByIndex + 104LL))(
           VirtualGpuByIndex,
           a3);
  }
  else
