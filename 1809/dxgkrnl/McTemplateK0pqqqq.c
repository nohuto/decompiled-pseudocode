/*
 * XREFs of McTemplateK0pqqqq @ 0x1C002FFF8
 * Callers:
 *     DpIndicateChildStatus @ 0x1C0042AB0 (DpIndicateChildStatus.c)
 *     DpiMiracastIoCompleteRoutine @ 0x1C0046350 (DpiMiracastIoCompleteRoutine.c)
...
ULONG McTemplateK0pqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
