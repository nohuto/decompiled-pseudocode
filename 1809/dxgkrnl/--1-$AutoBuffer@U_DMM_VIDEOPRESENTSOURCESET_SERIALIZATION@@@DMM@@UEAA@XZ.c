/*
 * XREFs of ??1?$AutoBuffer@U_DMM_VIDEOPRESENTSOURCESET_SERIALIZATION@@@DMM@@UEAA@XZ @ 0x1C004C250
 * Callers:
 *     ??_E?$AutoBuffer@U_DMM_VIDEOPRESENTTARGETSET_SERIALIZATION@@@DMM@@UEAAPEAXI@Z @ 0x1C004C9D0 (--_E-$AutoBuffer@U_DMM_VIDEOPRESENTTARGETSET_SERIALIZATION@@@DMM@@UEAAPEAXI@Z.c)
