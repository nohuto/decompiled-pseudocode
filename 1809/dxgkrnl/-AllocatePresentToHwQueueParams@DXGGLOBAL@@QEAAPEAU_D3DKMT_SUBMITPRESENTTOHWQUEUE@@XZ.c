/*
 * XREFs of ?AllocatePresentToHwQueueParams@DXGGLOBAL@@QEAAPEAU_D3DKMT_SUBMITPRESENTTOHWQUEUE@@XZ @ 0x1C00012F8
 * Callers:
...
struct _D3DKMT_SUBMITPRESENTTOHWQUEUE *__fastcall DXGGLOBAL::AllocatePresentToHwQueueParams(DXGGLOBAL *this)
{
  ...
  v1 = (char *)this + 896;
  ++*((_DWORD *)this + 229);
  v2 = ExpInterlockedPopEntrySList((PSLIST_HEADER)this + 56);
  if ( v2
