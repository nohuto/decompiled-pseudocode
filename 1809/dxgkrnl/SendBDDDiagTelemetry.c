/*
 * XREFs of SendBDDDiagTelemetry @ 0x1C001EA14
 * Callers:
...
void __fastcall SendBDDDiagTelemetry(__int64 a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    if ( (*(int (__fastcall **)(__int64, __int64 *))(v4 + 408))(v4, &v13) >= 0 )
    {
      ...
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C008D838, 0x800000000000uLL) )
        {
          v6 = 1;
          v20 = &v6;
          v22 = v25;
          ...
          v25[16] = 1LL;
          v25[18] = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C008D838, &unk_1C006B522, &ActivityId, v5, 0xEu, &pData);
        }
      }
    }
