/*
 * XREFs of ?ReleaseModeInfo@DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@QEBU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C00DB3D0
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 7012);
  ...
  *(_QWORD *)(v9 + 32) = this;
  if ( a2 )
  {
    ...
    if ( v11 )
    {
      v12 = DMMVIDPNTARGETMODESET::ReleaseDdiEnumerator(v11, a2);
    }
    else
    {
