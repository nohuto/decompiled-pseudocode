/*
 * XREFs of ?Open@DxgkCompositionObject@@SAJW4_OB_OPEN_REASON@@DPEAU_EPROCESS@@PEAXPEAKK@Z @ 0x1C0015C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCompositionObject::Open(unsigned int a1, char a2, __int64 a3, __int64 a4, __int64 a5, int a6)
{
     ...
     && ProcessSessionId == *(_DWORD *)(a4 + 8)) )
  {
    ...
    if ( (unsigned int)PsGetProcessSessionIdEx(CurrentProcess) != v22 )
    {
      Global = DXGGLOBAL::GetGlobal(v15);
      SessionMgr = DXGGLOBAL::GetSessionMgr(Global);
      v13 = DXGSESSIONMGR::ReferenceSessionCSRSSProcess(SessionMgr, v22, &PROCESS);
      if ( v13 >= 0 )
      {
