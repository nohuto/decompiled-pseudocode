/*
 * XREFs of ?OutputDuplPreIndirectPresent@@YAJPEAU_D3DKMT_OUTPUTDUPLPRESENT@@PEAVDXGPROCESS@@PEAPEAVDXGADAPTER@@PEA_K@Z @ 0x1C023ED14
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  *a3 = 0LL;
  ...
  if ( v29 )
  {
    ...
    if ( v18 >= 0 )
    {
      VidPnSourceOwner = ADAPTER_DISPLAY::GetVidPnSourceOwner(*(DXGADAPTER ***)(v17 + 2520), a1->VidPnSourceId);
      if ( VidPnSourceOwner )
      {
        v21 = *((_QWORD *)v11 + 2);
        v20 = *(_QWORD *)(v21 + 40);
