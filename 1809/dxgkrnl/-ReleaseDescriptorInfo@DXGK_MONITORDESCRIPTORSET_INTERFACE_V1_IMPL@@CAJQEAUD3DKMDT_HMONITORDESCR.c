/*
 * XREFs of ?ReleaseDescriptorInfo@DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORDESCRIPTORSET__@@QEBU_D3DKMDT_MONITOR_DESCRIPTOR@@@Z @ 0x1C0293C10
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 7030);
  ...
  *(_QWORD *)(v9 + 32) = a2;
  if ( a2 )
  {
    ...
    else
    {
      ...
      v21 = DXGMONITOR::_ReleaseMonitorDescriptorEnumerator(v17, a2);
