/*
 * XREFs of DpWriteDeviceSpace @ 0x1C001E860
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
    ...
    v15 = *(__int64 (__fastcall **)(_QWORD, void *, _QWORD, _QWORD))(a1 + 2888);
    if ( !v15 )
    {
      v6 = -1073741823;
    ...
    v10 = v15(*(_QWORD *)(a1 + 2856), a3, Offset, Length);
  }
  ...
  {
    v9 = *(__int64 (__fastcall **)(_QWORD, __int64, void *))(a1 + 608);
    if ( !v9 )
    {
      v13 = -1073741823LL;
      goto LABEL_17;
    }
    v10 = v9(*(_QWORD *)(a1 + 568), a2, a3);
  }
  *a6 = v10;
