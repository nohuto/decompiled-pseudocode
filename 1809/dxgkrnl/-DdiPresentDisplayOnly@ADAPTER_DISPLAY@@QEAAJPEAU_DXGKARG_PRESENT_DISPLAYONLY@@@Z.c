/*
 * XREFs of ?DdiPresentDisplayOnly@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_PRESENT_DISPLAYONLY@@@Z @ 0x1C01CC948
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5048);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_PRESENT_DISPLAYONLY *))(*((_QWORD *)this + 2) + 712LL))(
  ...
  {
    v24 = WdLogNewEntry5_WdError(NumDirtyRects);
    *(_QWORD *)(v24 + 24) = v14;
