/*
 * XREFs of ?ReportState@ADAPTER_RENDER@@QEAAXXZ @ 0x1C01C708C
 * Callers:
 *     ?ReportState@DXGADAPTER@@QEAAXXZ @ 0x1C01BEE70 (-ReportState@DXGADAPTER@@QEAAXXZ.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0022E60 (_guard_dispatch_icall_nop.c)
 *     ?ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ @ 0x1C01FD864 (-ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ.c)
...
void __fastcall ADAPTER_RENDER::ReportState(ADAPTER_RENDER *this)
{
  ...
  {
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 68) + 8LL) + 48LL))(*((_QWORD *)this + 69));
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 65) + 8LL) + 48LL))(*((_QWORD *)this + 66));
  }
}
