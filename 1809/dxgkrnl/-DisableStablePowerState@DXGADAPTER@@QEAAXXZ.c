/*
 * XREFs of ?DisableStablePowerState@DXGADAPTER@@QEAAXXZ @ 0x1C01BD2C0
 * Callers:
 ...
 *     ?DisableStablePState@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C003CD54 (-DisableStablePState@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 */
...
void __fastcall DXGADAPTER::DisableStablePowerState(DXGADAPTER *this)
{
  ...
  if ( *((_BYTE *)this + 2999) )
  {
    ...
    v6 = (ADAPTER_RENDER *)*((_QWORD *)this + 316);
    if ( v6 )
