/*
 * XREFs of ?FindFirstAvailableTarget@DMMVIDPNTOPOLOGY@@QEBAJIW4_D3DKMDT_VIDEO_PRESENT_TARGET_SUBSET_TYPE@@PEAIPEAW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@2PEAW4_D3DKMT_DISPLAY_TARGET_USAGE@@@Z @ 0x1C028445C
 * Callers:
 ...
 *     ?GetNextTarget@DMMVIDPNTARGETSET@@QEBAPEAVDMMVIDPNTARGET@@QEBV2@@Z @ 0x1C004DFA0 (-GetNextTarget@DMMVIDPNTARGETSET@@QEBAPEAVDMMVIDPNTARGET@@QEBV2@@Z.c)
    ...
    while ( 1 )
    {
      if ( v18 )
      {
        ...
        if ( *(_QWORD *)(v23 + 112)
          ...
          && (unsigned int)DMMVIDPNTOPOLOGY::GetPathSourceFromTarget(a1, *((unsigned int *)NextTarget + 6), v20) == -1 )
        {
LABEL_22:
          v15 = a7;
          v14 = a6;
  ...
  if ( v18 )
  {
    ...
    {
      v26 = WdLogNewEntry5_WdDmmEvent(v22, v21, v20, v16);
