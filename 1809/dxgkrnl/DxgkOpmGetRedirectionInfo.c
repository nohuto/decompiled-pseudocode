/*
 * XREFs of DxgkOpmGetRedirectionInfo @ 0x1C01C7F70
 * Callers:
...
__int64 __fastcall DxgkOpmGetRedirectionInfo(ADAPTER_DISPLAY **a1, unsigned int a2, unsigned __int64 *a3, char *a4)
{
  ...
  enum _D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING v25; // [rsp+70h] [rbp+8h] BYREF
  ...
  result = ADAPTER_DISPLAY::DodGetOpmMftContext(a1[315], (unsigned int)v5, a3);
...
LABEL_7:
    if ( a4 )
    {
      ...
      if ( v25 == -1 )
      {
        ...
        *(_QWORD *)(v16 + 24) = 1003LL;
        WdLogEvent5_WdAssertion(v16);
      }
      DisplayModeInfo = ADAPTER_DISPLAY::GetDisplayModeInfo((DXGADAPTER **)a1[315], v15);
      if ( !DisplayModeInfo )
      {
      ...
      SourceConnectedToTargetInClientVidPn = DmmGetClientVidPnTargetModeInfo(a1, v5, 0LL, 0LL, 0LL, &v25, &v26, &v24);
      if ( SourceConnectedToTargetInClientVidPn < 0 )
      {
LABEL_9:
