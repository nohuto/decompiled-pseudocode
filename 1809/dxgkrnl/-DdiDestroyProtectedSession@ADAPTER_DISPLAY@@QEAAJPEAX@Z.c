/*
 * XREFs of ?DdiDestroyProtectedSession@ADAPTER_DISPLAY@@QEAAJPEAX@Z @ 0x1C01CAF3C
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiDestroyProtectedSession(ADAPTER_DISPLAY *this, void *a2, const GUID *a3)
{
  __int64 v5; // rcx
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5109);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5109);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 1160LL))(
