/*
 * XREFs of ?CreateWin32kImportTable@@YAJPEAXPEAPEAVDXGKW32KIMPORTS@@@Z @ 0x1C002001C
 * Callers:
 *     ?DelayLoadWin32k@DXGGLOBAL@@QEAAJPEAX@Z @ 0x1C0018BA0 (-DelayLoadWin32k@DXGGLOBAL@@QEAAJPEAX@Z.c)
 * Callees:
 *     ??2@YAPEAX_KIW4_POOL_TYPE@@@Z @ 0x1C0011EE0 (--2@YAPEAX_KIW4_POOL_TYPE@@@Z.c)
 *     ??0W32KIMPORTS@@QEAA@PEAX@Z @ 0x1C0020084 (--0W32KIMPORTS@@QEAA@PEAX@Z.c)
 */
...
__int64 __fastcall CreateWin32kImportTable(void *a1, struct DXGKW32KIMPORTS **a2)
{
  ...
  v4 = 0;
  v5 = (W32KIMPORTS *)operator new(0x118uLL, 0x4B677844u, PagedPool);
  if ( v5 )
