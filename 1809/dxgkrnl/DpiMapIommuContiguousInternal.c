/*
 * XREFs of DpiMapIommuContiguousInternal @ 0x1C0049394
 * Callers:
...
__int64 __fastcall DpiMapIommuContiguousInternal(__int64 a1, struct _MDL *a2, SIZE_T a3)
{
  ...
  if ( Mdl )
  {
    ...
    v6 = ((__int64 (__fastcall *)(_QWORD, __int64, PMDL))qword_1C008EC88)(*(_QWORD *)(a1 + 80), 3LL, v9);
  ...
  else
  {
    ...
    if ( (_DWORD)v5 )
    {
      while ( 1 )
      {
        ...
        v6 = ((__int64 (__fastcall *)(__int64, __int64, __int64 *))qword_1C008EC88)(v13, 3LL, &v17);
        if ( v6 < 0 )
          break;
      ...
      if ( v12 )
      {
        do
        {
          v15 = *(_QWORD *)(a1 + 80);
          v23 = a2;
          ((void (__fastcall *)(__int64, __int64 *))qword_1C008EC90)(v15, &v17);
          a2 = (struct _MDL *)((char *)a2 + 1);
          --v14;
        }
        while ( v14 );
