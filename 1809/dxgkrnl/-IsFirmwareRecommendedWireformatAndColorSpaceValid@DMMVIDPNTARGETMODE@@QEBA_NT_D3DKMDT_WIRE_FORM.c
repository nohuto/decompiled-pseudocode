/*
 * XREFs of ?IsFirmwareRecommendedWireformatAndColorSpaceValid@DMMVIDPNTARGETMODE@@QEBA_NT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@W4_D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE@@@Z @ 0x1C004DB08
 * Callers:
        ...
        enum _D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE a3)
{
  ...
  if ( ((v3 - 1) & v3) == 0 && (*((_DWORD *)this + 32) & v3) != 0 )
  {
    if ( (v5 = ((v3 | ((v3 | ((v3 | ((v3 | (v3 >> 6)) >> 6)) >> 6)) >> 6)) >> 2) & 0x3F,
      ...
      || *((_BYTE *)DXGGLOBAL::GetGlobal((__int64)this) + 20264) && a3 == D3DDDI_OUTPUT_WIRE_COLOR_SPACE_G22_P2020
