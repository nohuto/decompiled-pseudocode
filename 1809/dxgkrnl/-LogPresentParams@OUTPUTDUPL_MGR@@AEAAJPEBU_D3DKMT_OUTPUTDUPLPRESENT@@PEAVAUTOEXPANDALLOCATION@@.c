/*
 * XREFs of ?LogPresentParams@OUTPUTDUPL_MGR@@AEAAJPEBU_D3DKMT_OUTPUTDUPLPRESENT@@PEAVAUTOEXPANDALLOCATION@@@Z @ 0x1C023DFE8
 * Callers:
...
__int64 __fastcall OUTPUTDUPL_MGR::LogPresentParams(
        ...
        struct AUTOEXPANDALLOCATION *a3)
{
  size_t v5; // rdi
  UINT v6; // r14d
  char *Buffer; // rax
