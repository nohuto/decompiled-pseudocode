/*
 * XREFs of ?ObjectInit@FlipManagerObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@@Z @ 0x1C00594F0
 * Callers:
 *     <none>
 * Callees:
 *     ??0FlipManagerObject@@IEAA@XZ @ 0x1C0059440 (--0FlipManagerObject@@IEAA@XZ.c)
