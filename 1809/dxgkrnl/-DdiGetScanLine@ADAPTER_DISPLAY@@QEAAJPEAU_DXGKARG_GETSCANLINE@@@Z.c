/*
 * XREFs of ?DdiGetScanLine@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETSCANLINE@@@Z @ 0x1C01CBD88
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v29, 5036);
...
LABEL_16:
  ...
  v17 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETSCANLINE *))(*((_QWORD *)this + 2) + 552LL))(
  ...
  if ( (_DWORD)v17 )
  {
    v25 = WdLogNewEntry5_WdError(ScanLine);
    *(_QWORD *)(v25 + 24) = v17;
