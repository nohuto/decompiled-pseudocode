/*
 * XREFs of DxgkOpenKeyedMutex2 @ 0x1C02374A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenKeyedMutex2(ULONG64 a1, __int64 a2, const GUID *a3)
{
  ...
  void *v25[2]; // [rsp+48h] [rbp-30h]
  unsigned int v26[8]; // [rsp+58h] [rbp-20h]
  unsigned int v27; // [rsp+88h] [rbp+10h] BYREF
  struct DXGKEYEDMUTEX *v28; // [rsp+90h] [rbp+18h] BYREF
  struct DXGPROCESS *v29; // [rsp+98h] [rbp+20h]
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v22, 2067);
  ...
  if ( Current )
  {
    ...
    *(_QWORD *)v26 = *(_QWORD *)(v10 + 16);
    v28 = 0LL;
    v27 = 0;
    DXGGLOBAL::GetGlobal(MmUserProbeAddress);
    v12 = DXGGLOBAL::OpenKeyedMutex(v11, (unsigned int)v25[0], &v28, &v27, (char *)v25[1], v26[0]);
    if ( v12 >= 0 )
    {
      v13 = (_DWORD *)(a1 + 4);
