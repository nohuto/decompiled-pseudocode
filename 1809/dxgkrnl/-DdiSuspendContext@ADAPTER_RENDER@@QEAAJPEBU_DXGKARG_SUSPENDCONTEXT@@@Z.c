/*
 * XREFs of ?DdiSuspendContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1C01D1008
 * Callers:
 *     ?ADAPTER_RENDER_DdiSuspendContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1C0037BA0 (-ADAPTER_RENDER_DdiSuspendContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SUSPENDCONTEXT@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  int v12; // r14d
  __int64 v13; // rcx
  __int64 (__fastcall *v14)(_QWORD, const struct _DXGKARG_SUSPENDCONTEXT *); // rax
  int v15; // edi
  __int64 v16; // rcx
  _QWORD *v17; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5118);
...
LABEL_16:
  ...
  v13 = *((_QWORD *)this + 2);
  v14 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SUSPENDCONTEXT *))(v13 + 1200);
  if ( v14 )
