/*
 * XREFs of ?DisplayID_GetProductCode@@YAJPEAUDisplayIDObj@@PEAG@Z @ 0x1C00502A0
 * Callers:
...
__int64 __fastcall DisplayID_GetProductCode(struct DisplayIDObj *a1, unsigned __int16 *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( DisplayID_ProductId_Parser::IsValidBlock((DisplayID_ProductId_Parser *)&v5) )
      return RtlStringCchPrintfW(v4, 5uLL, L"%04x", *(unsigned __int8 *)(v3 + 6) + (*(unsigned __int8 *)(v3 + 7) << 8));
    else
      return 3221225659LL;
  }
  return result;
