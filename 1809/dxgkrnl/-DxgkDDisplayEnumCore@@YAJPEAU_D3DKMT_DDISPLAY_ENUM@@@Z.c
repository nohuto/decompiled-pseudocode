/*
 * XREFs of ?DxgkDDisplayEnumCore@@YAJPEAU_D3DKMT_DDISPLAY_ENUM@@@Z @ 0x1C0135FE4
 * Callers:
...
__int64 __fastcall DxgkDDisplayEnumCore(struct _D3DKMT_DDISPLAY_ENUM *a1)
{
  ...
  *((_QWORD *)&v3 + 1) = &v6;
  ...
  DXGGLOBAL::IterateAdaptersWithCallback(
    (__int64)Global,
    (__int64 (__fastcall *)(_QWORD *, __int64))lambda_bef923f74a514834b01f3b45f93c4ee0_::_lambda_invoker_cdecl_,
    (__int64)&v4,
    4);
  *(_DWORD *)v6 = v8;
  *((_DWORD *)v6 + 4) = v7;
