/*
 * XREFs of ?GetDisplayedAllMultiPlaneOverlays@DXGDEVICE@@QEAAXIPEAVDXGALLOCATIONREFERENCE@@I@Z @ 0x1C0040B24
 * Callers:
        ...
        unsigned int a4)
{
  ...
  {
    ADAPTER_DISPLAY::GetAllocationsForAllPlanes(*(ADAPTER_DISPLAY **)(v6 + 2520), a2, a3, a4);
  }
  else
  {
