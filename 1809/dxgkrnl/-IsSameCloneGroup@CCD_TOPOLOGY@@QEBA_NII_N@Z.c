/*
 * XREFs of ?IsSameCloneGroup@CCD_TOPOLOGY@@QEBA_NII_N@Z @ 0x1C02886A8
 * Callers:
...
bool __fastcall CCD_TOPOLOGY::IsSameCloneGroup(CCD_TOPOLOGY *this, unsigned int a2, unsigned int a3, char a4)
{
  ...
  v6 = a3;
  v8 = a2;
  if ( !v4 && (v10 = WdLogNewEntry5_WdAssertion(this), WdLogEvent5_WdAssertion(v10), (v4 = *((_QWORD *)this + 8)) == 0)
    || (v11 = *(unsigned __int16 *)(v4 + 20), (unsigned int)v8 >= v11)
    || (unsigned int)v6 >= v11 )
  {
    v17 = (_QWORD *)WdLogNewEntry5_WdAssertion(this);
    v17[3] = v8;
    v17[4] = v6;
    v17[5] = this;
    v17[6] = *((_QWORD *)this + 8);
