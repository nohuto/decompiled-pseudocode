/*
 * XREFs of ?OfferAllocations@DXGDEVICE@@QEAAJPEAU_D3DKMT_OFFERALLOCATIONS@@@Z @ 0x1C0105790
 * Callers:
...
__int64 __fastcall DXGDEVICE::OfferAllocations(DXGDEVICE *this, struct _D3DKMT_OFFERALLOCATIONS *a2)
{
  ...
  DXGDEVICE **v74; // [rsp+A8h] [rbp+20h] BYREF
    ...
    if ( a2->pResources )
    {
      if ( !HandleList )
      {
        for ( i = 0; i < a2->NumAllocations; ++i )
        {
          ...
          DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v72, (struct DXGFASTMUTEX *const)(v70 + 80), 0);
          ...
          if ( v17 )
          {
            while ( 1 )
            {
              v18 = *(struct _VIDMM_MULTI_ALLOC **)(v17 + 24);
              if ( !v18 )
                break;
...
LABEL_61:
        ...
        if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)this) + 255) )
        {
...
LABEL_84:
    ...
    else if ( HandleList )
    {
      for ( j = 0; j < a2->NumAllocations; ++j )
      {
        ...
        if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v28) + 255) )
        {
