/*
 * XREFs of DpiPdoGetDeviceContainerIdFromDescriptor @ 0x1C027556C
 * Callers:
  ...
  *(_QWORD *)Guid.Data4 = 0LL;
  ...
  if ( *(_DWORD *)(v4 + 496) == 1 )
  {
    ...
    *(_QWORD *)(v13 + 32) = v12;
    ...
    if ( (int)ChildContainerId < 0 )
      return (unsigned int)ChildContainerId;
    LODWORD(ChildContainerId) = MonitorGetContainerIDFromDescriptor(v6[474], *(unsigned int *)(v4 + 504), &Guid);
    if ( (int)ChildContainerId < 0 )
    {
  ...
  if ( *(_DWORD *)(v7 + 28) >= 0x3005u && *(_QWORD *)(v7 + 768) )
  {
    ...
    DxgkAcquireAdapterDdiSync(v6[474], 1);
    ChildContainerId = (int)DpiDxgkDdiGetChildContainerId(
                              v7,
                              v6[6],
                              (const GUID *)*(unsigned int *)(*(_QWORD *)(v4 + 936) + 24LL),
                              (__int64)v44);
    DxgkReleaseAdapterDdiSync((DXGADAPTER *)v6[474]);
