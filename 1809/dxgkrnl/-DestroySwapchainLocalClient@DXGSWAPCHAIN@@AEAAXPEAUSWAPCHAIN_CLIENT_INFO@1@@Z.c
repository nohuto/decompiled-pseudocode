/*
 * XREFs of ?DestroySwapchainLocalClient@DXGSWAPCHAIN@@AEAAXPEAUSWAPCHAIN_CLIENT_INFO@1@@Z @ 0x1C0250590
 * Callers:
        ...
        struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_INFO *a2)
{
  ...
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 12); i = (unsigned int)(i + 1) )
    DXGSWAPCHAIN::DestroySurfacesResourcesLocal((__int64)v4, *((_DWORD *)a2 + 7), *((_QWORD *)this + 7) + 96 * i);
  *((_QWORD *)a2 + 2) = 0LL;
}
