/*
 * XREFs of ?ReleaseBuffer@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_RELEASESWAPCHAIN@@PEAXD@Z @ 0x1C0251A30
 * Callers:
 ...
 *     ?GetClientSurfaceInfo@DXGSWAPCHAIN@@AEAAXPEAUSWAPCHAIN_CLIENT_INFO@1@IPEAPEAUSWAPCHAIN_SURF_INFO@1@PEAPEAUSWAPCHAIN_CLIENT_SURF_INFO@1@@Z @ 0x1C0040EF8 (-GetClientSurfaceInfo@DXGSWAPCHAIN@@AEAAXPEAUSWAPCHAIN_CLIENT_INFO@1@IPEAPEAUSWAPCHAIN_SURF_INFO.c)
 *     ?GetOtherClientSurfaceInfo@DXGSWAPCHAIN@@AEAAXPEAUSWAPCHAIN_CLIENT_INFO@1@IPEAPEAUSWAPCHAIN_SURF_INFO@1@PEAPEAUSWAPCHAIN_CLIENT_SURF_INFO@1@@Z @ 0x1C0040F84 (-GetOtherClientSurfaceInfo@DXGSWAPCHAIN@@AEAAXPEAUSWAPCHAIN_CLIENT_INFO@1@IPEAPEAUSWAPCHAIN_SURF.c)
        ...
        char a4)
{
  ...
  *((_DWORD *)v22 + 1) = DXGSWAPCHAIN::SwitchClient(v21, *((_DWORD *)v11 + 7));
  ...
  if ( !*((_DWORD *)v22 + 6) )
    AUTOEXPANDALLOCATION::GetBuffer(*((AUTOEXPANDALLOCATION **)v22 + 2), 0, 0);
  v26 = *((_DWORD *)this + 58);
  if ( *((_DWORD *)v11 + 7) )
  {
    if ( v26 )
...
LABEL_35:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000000) != 0 )
  {
    ...
    LODWORD(v30) = inserted;
    McTemplateK0pqdqp(v20, v18, v19, this, v30, Src, v32, v8);
  }
