/*
 * XREFs of ?_GetMonitorCCDMonitorID@DXGMONITOR@@QEAAJEKPEAG@Z @ 0x1C00C3344
 * Callers:
...
LABEL_6:
    appended = RtlAppendUnicodeStringToString(
                 &Destination,
                 (PCUNICODE_STRING)((char *)this + (-(__int64)(a2 != 0) & 0xFFFFFFFFFFFFFFF0uLL) + 536));
    v15 = appended;
    if ( appended >= 0 )
    {
      v16 = *((_QWORD *)this + 71);
      ...
      v17 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 8LL) + 16LL) + 308LL);
