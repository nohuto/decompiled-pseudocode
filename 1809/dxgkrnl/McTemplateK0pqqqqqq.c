/*
 * XREFs of McTemplateK0pqqqqqq @ 0x1C004B60C
 * Callers:
...
ULONG McTemplateK0pqqqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, a3, 8u, &EventData);
}
