/*
 * XREFs of ?IsValidGammaRamp@@YAEAEBU_D3DKMDT_GAMMA_RAMP@@@Z @ 0x1C0005F74
 * Callers:
 ...
 * Callees:
 *     ?GetSizeFromGammaRampType@@YA_KW4_D3DDDI_GAMMARAMP_TYPE@@@Z @ 0x1C0005FBC (-GetSizeFromGammaRampType@@YA_KW4_D3DDDI_GAMMARAMP_TYPE@@@Z.c)
 */
...
unsigned __int8 __fastcall IsValidGammaRamp(const struct _D3DKMDT_GAMMA_RAMP *a1)
{
  ...
  Type = a1->Type;
  if ( (unsigned int)(Type - 1) > 3 || a1->DataSize != GetSizeFromGammaRampType(Type) )
    return 0;
  result = 1;
