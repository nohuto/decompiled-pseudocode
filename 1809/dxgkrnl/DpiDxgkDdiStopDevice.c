/*
 * XREFs of DpiDxgkDdiStopDevice @ 0x1C0273F04
 * Callers:
...
__int64 __fastcall DpiDxgkDdiStopDevice(__int64 a1, __int64 a2, const GUID *a3)
{
  int v5; // eax
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  {
    v14 = 0;
    McTemplateK0xq(a1, &EventEnterDdiStopDevice, a3, a2, v14);
  }
  ...
  {
    LODWORD(v13) = v5;
    McTemplateK0xq(v7, &EventExitDdiStopDevice, v8, a2, v13);
  }
