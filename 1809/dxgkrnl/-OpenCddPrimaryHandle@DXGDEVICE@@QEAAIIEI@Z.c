/*
 * XREFs of ?OpenCddPrimaryHandle@DXGDEVICE@@QEAAIIEI@Z @ 0x1C0225358
 * Callers:
      ...
      if ( v26 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          if ( P )
          {
            ...
            {
              *((_BYTE *)this + v16 + 504) = 1;
              if ( !*((_QWORD *)this + v16 + 65) )
              {
                v33 = WdLogNewEntry5_WdAssertion(v32);
                *(_QWORD *)(v33 + 24) = 9086LL;
...
LABEL_45:
  ...
  v38 = *((_QWORD *)this + v16 + 65);
  if ( !v38 )
    return 0LL;
  if ( (*(_DWORD *)(v38 + 4) & 1) == 0 )
  {
    v39 = WdLogNewEntry5_WdAssertion(v38);
    *(_QWORD *)(v39 + 24) = 9106LL;
  ...
  if ( v5 )
  {
    ...
    v54[7] = 1LL;
    LOBYTE(v49) = 0;
    v54[2] = *(_QWORD *)(v41[2] + 2376LL);
    v42 = *((_QWORD *)this + v16 + 65);
    v54[3] = *(_QWORD *)(v41[2] + 2384LL);
  ...
  return *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + v16 + 65) + 24LL) + 16LL);
}
