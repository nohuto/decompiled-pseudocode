/*
 * XREFs of McTemplateK0pxzqq @ 0x1C0048D28
 * Callers:
...
ULONG McTemplateK0pxzqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v19 = 4LL;
  va_copy(v18, va3);
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, (LPCGUID)a2, 6u, &EventData);
}
