/*
 * XREFs of ?VailDRTProcessExtractWorker@@YAXPEAX@Z @ 0x1C025AF10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VailDRTProcessExtractWorker(char *a1)
{
  struct _KPROCESS *v1; // rdx
  int RemoteBundleObject; // eax
  bool v4; // zf
  ...
  RemoteBundleObject = DxgkExtractRemoteBundleObject(*((_DWORD *)a1 + 12), *((_DWORD *)a1 + 13), (void **)a1 + 7, 0LL);
  v4 = v6 == 0;
  *((_DWORD *)a1 + 56) = RemoteBundleObject;
  if ( !v4 )
