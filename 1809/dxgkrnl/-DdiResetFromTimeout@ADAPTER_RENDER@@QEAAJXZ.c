/*
 * XREFs of ?DdiResetFromTimeout@ADAPTER_RENDER@@QEAAJXZ @ 0x1C01CDC30
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiResetFromTimeout(ADAPTER_RENDER *this, __int64 a2, const GUID *a3)
{
  __int64 v4; // rcx
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5020);
  }
  else
  {
    v27 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5020);
...
LABEL_16:
  ...
  v13 = (*(int (__fastcall **)(_QWORD))(*((_QWORD *)this + 2) + 440LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 248LL));
  if ( v28[0] )
  ...
  v19 = WdLogNewEntry5_WdEvent(v14, v12);
  *(_QWORD *)(v19 + 24) = v13;
  *(_QWORD *)(v19 + 32) = *(_QWORD *)(*((_QWORD *)this + 2) + 248LL);
