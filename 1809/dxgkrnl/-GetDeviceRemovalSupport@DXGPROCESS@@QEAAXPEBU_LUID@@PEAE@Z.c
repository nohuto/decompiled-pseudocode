/*
 * XREFs of ?GetDeviceRemovalSupport@DXGPROCESS@@QEAAXPEBU_LUID@@PEAE@Z @ 0x1C022959C
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( *(_DWORD *)(Current + 328) != 2 )
      {
        ...
        if ( !v14 )
        {
          ...
          *(_QWORD *)(v15 + 24) = 4625LL;
          WdLogEvent5_WdAssertion(v15);
        }
        if ( *(_DWORD *)(v14 + 276) == a2->LowPart && *(_DWORD *)(v14 + 280) == a2->HighPart )
        {
          *a3 = 0;
          break;
        }
