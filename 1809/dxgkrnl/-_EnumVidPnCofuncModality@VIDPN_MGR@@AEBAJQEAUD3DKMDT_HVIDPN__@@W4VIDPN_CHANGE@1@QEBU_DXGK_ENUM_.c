/*
 * XREFs of ?_EnumVidPnCofuncModality@VIDPN_MGR@@AEBAJQEAUD3DKMDT_HVIDPN__@@W4VIDPN_CHANGE@1@QEBU_DXGK_ENUM_PIVOT@@@Z @ 0x1C00E5038
 * Callers:
...
__int64 __fastcall VIDPN_MGR::_EnumVidPnCofuncModality(__int64 a1, __int64 a2, int a3, DXGK_ENUM_PIVOT *a4)
{
  ...
  LOBYTE(v9) = 3;
  ApplyPermissionWithinThisScope::ApplyPermissionWithinThisScope(v26, v10 + 152, v9);
  v12 = *(_QWORD *)(a1 + 8);
  if ( !v12 )
  {
