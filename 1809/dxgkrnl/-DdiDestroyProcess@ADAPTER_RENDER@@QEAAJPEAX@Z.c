/*
 * XREFs of ?DdiDestroyProcess@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C00F1DDC
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyProcess@@YAJPEAVADAPTER_RENDER@@PEAX@Z @ 0x1C0037980 (-ADAPTER_RENDER_DdiDestroyProcess@@YAJPEAVADAPTER_RENDER@@PEAX@Z.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyProcess(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v23, 5065);
...
LABEL_16:
  ...
  v13 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 864LL))(
