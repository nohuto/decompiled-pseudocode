/*
 * XREFs of ?TdrCollectDbgInfoStage2@@YAXPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C020AD00
 * Callers:
 ...
 *     ??_GCTDR_DUMP_BUFFER@@QEAAPEAXI@Z @ 0x1C0209B90 (--_GCTDR_DUMP_BUFFER@@QEAAPEAXI@Z.c)
