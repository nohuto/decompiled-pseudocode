/*
 * XREFs of ?CheckMultiPlaneOverlaySupport@DXGDEVICE@@QEAAJIPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE@@_NPEAH@Z @ 0x1C01FD6A8
 * Callers:
        ...
        int *a5)
{
  ...
  *a5 = 0;
  if ( ADAPTER_RENDER::IsMultiPlaneOverlaySupported(this[2]) && (v10 = *((_QWORD *)this[2] + 2), *(_QWORD *)(v10 + 784)) )
  {
    v12 = 0;
    if ( a2 )
    {
