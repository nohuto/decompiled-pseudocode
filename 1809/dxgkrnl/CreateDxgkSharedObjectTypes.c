/*
 * XREFs of CreateDxgkSharedObjectTypes @ 0x1C0155888
 * Callers:
 *     ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C015434C (-Initialize@DXGGLOBAL@@QEAAJXZ.c)
 * Callees:
 *     ?GenericMapping@DxgkCompositionObject@@SA?AU_GENERIC_MAPPING@@XZ @ 0x1C001A730 (-GenericMapping@DxgkCompositionObject@@SA-AU_GENERIC_MAPPING@@XZ.c)
...
__int64 CreateDxgkSharedObjectTypes()
{
  ...
  if ( g_pDxgkSharedAllocationObjectType
    || (v1 = (struct _GENERIC_MAPPING)xmmword_1C0069708,
        ...
        (int)result >= 0) )
  {
    ...
    {
      v1 = (struct _GENERIC_MAPPING)xmmword_1C0069728;
      result = CreateSharedObject(
    ...
    if ( (int)result >= 0 )
    {
      ...
      {
        v1 = (struct _GENERIC_MAPPING)xmmword_1C0069738;
        result = CreateSharedObject(
          ...
          if ( (int)result >= 0 )
          {
            ...
            if ( (int)result >= 0 )
            {
              ...
              if ( (int)result >= 0 )
              {
                ...
                {
                  v1 = (struct _GENERIC_MAPPING)xmmword_1C0069718;
                  result = CreateSharedObject(
