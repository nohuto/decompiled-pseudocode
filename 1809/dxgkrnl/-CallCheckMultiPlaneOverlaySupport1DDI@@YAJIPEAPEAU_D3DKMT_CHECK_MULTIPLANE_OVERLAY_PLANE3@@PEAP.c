/*
 * XREFs of ?CallCheckMultiPlaneOverlaySupport1DDI@@YAJIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXPEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1C01FB7F4
 * Callers:
...
LABEL_7:
  ...
  if ( v9 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)&a3[-1].Data4[4] ^= ((unsigned __int8)*v19 ^ (unsigned __int8)*(_DWORD *)&a3[-1].Data4[4]) & 1;
