/*
 * XREFs of ?Initialize@DripsBlockerInfoList@@QEAAJXZ @ 0x1C020FE3C
 * Callers:
...
__int64 __fastcall DripsBlockerInfoList::Initialize(DripsBlockerInfoList *this)
{
  ...
  v2 = (char *)operator new[](0x4808uLL, 0x4B677844u, PagedPool);
  if ( v2 )
  {
    v3 = v2 + 8;
    *(_QWORD *)v2 = 256LL;
  ...
  *((_QWORD *)this + 1) = v3;
  if ( v3 )
  {
    ...
    {
      v6 = *((_QWORD *)this + 1);
      v7 = operator new[](0x21uLL, 0x4B677844u, PagedPool);
      if ( !v7 )
        break;
      *(_WORD *)(i + v6 + 2) = 33;
      ++v4;
