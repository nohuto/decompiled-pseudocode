/*
 * XREFs of DpiPdoSetMonitorDriverInterfaceStateWorker @ 0x1C0277900
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DpiPdoSetMonitorDriverInterfaceStateWorker(PVOID IoObject, PVOID Context, PIO_WORKITEM IoWorkItem)
{
  ...
  while ( 1 )
  {
    ...
    v4 = (PDEVICE_OBJECT *)qword_1C008EB18;
    if ( (__int64 *)qword_1C008EB18 == &qword_1C008EB18 )
    {
      v4 = 0LL;
      byte_1C008EAD8 = 0;
    }
    ...
    {
      if ( *(__int64 **)(qword_1C008EB18 + 8) != &qword_1C008EB18
        || (v5 = *(_QWORD *)qword_1C008EB18, *(_QWORD *)(*(_QWORD *)qword_1C008EB18 + 8LL) != qword_1C008EB18) )
      {
        __fastfail(3u);
      }
      qword_1C008EB18 = *(_QWORD *)qword_1C008EB18;
      *(_QWORD *)(v5 + 8) = &qword_1C008EB18;
    }
