/*
 * XREFs of ?DdiVirtualGpuDriverEscape@ADAPTER_RENDER@@QEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C01E534C
 * Callers:
 *     ?VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C01E7A00 (-VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 5105);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGK_VIRTUALGPUDRIVERESCAPE *))(*(_QWORD *)(*((_QWORD *)this + 2) + 944LL)
                                                                             + 112LL))(
  ...
  if ( (_DWORD)v14 != -1073741823 && (_DWORD)v14 != -1073741811 )
  {
    v21 = (int)v14 < 0;
    if ( !(_DWORD)v14 )
      goto LABEL_28;
