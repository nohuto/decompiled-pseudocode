/*
 * XREFs of ?GetTopology@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@PEAPEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEAPEBU_DXGK_VIDPNTOPOLOGY_INTERFACE@@@Z @ 0x1C012AEA0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGK_VIDPNTOPOLOGY_INTERFACE **a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v21, 7042);
