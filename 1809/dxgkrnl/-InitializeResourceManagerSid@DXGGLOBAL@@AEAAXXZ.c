/*
 * XREFs of ?InitializeResourceManagerSid@DXGGLOBAL@@AEAAXXZ @ 0x1C01553B8
 * Callers:
  ...
  if ( v3 )
  {
    ...
    *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
    ...
    if ( v7 < 0 )
    {
      ...
      *((_QWORD *)this + 2532) = 0LL;
    }
    else
    {
      *RtlSubAuthoritySid(*((PSID *)this + 2532), 0) = 80;
      *RtlSubAuthoritySid(*((PSID *)this + 2532), 1u) = 1988685059;
      *RtlSubAuthoritySid(*((PSID *)this + 2532), 2u) = 1921232356;
      *RtlSubAuthoritySid(*((PSID *)this + 2532), 3u) = 378231328;
      *RtlSubAuthoritySid(*((PSID *)this + 2532), 4u) = -1590824699;
      *RtlSubAuthoritySid(*((PSID *)this + 2532), 5u) = 890457928;
    }
  }
  else
  {
    v13 = WdLogNewEntry5_WdWarning(v5, v4, v6);
    *(_QWORD *)(v13 + 24) = 6759LL;
