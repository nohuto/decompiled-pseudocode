/*
 * XREFs of DxgkSetVidPnSourceOwner @ 0x1C011E180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetVidPnSourceOwner(struct _D3DKMT_SETVIDPNSOURCEOWNER *a1)
{
  ...
  __int64 v18; // rcx
  const GUID *v19; // r8
  int v20; // [rsp+20h] [rbp-98h] BYREF
  __int64 v21; // [rsp+28h] [rbp-90h]
  char v22; // [rsp+30h] [rbp-88h]
  struct _D3DKMT_VIDPNSOURCEOWNER_FLAGS v23; // [rsp+38h] [rbp-80h]
  void *const *v24; // [rsp+40h] [rbp-78h]
  _QWORD v25[10]; // [rsp+50h] [rbp-68h] BYREF
