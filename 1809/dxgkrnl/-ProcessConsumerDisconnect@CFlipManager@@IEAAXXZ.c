/*
 * XREFs of ?ProcessConsumerDisconnect@CFlipManager@@IEAAXXZ @ 0x1C005A90C
 * Callers:
...
void __fastcall CFlipManager::ProcessConsumerDisconnect(PRKEVENT *this)
{
  ...
  CEndpointResourceStateManager::DestroyAllResourceStates((CEndpointResourceStateManager *)(this + 12));
  CFlipManager::FreeQueuedUpdates((CFlipManager *)this);
  KeResetEvent(this[29]);
  this[6] = 0LL;
}
