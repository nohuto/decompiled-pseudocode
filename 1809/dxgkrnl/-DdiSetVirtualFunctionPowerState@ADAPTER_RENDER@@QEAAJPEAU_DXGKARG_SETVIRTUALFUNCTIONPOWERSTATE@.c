/*
 * XREFs of ?DdiSetVirtualFunctionPowerState@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE@@@Z @ 0x1C01E4AC0
 * Callers:
 *     ?SetVirtualFunctionPowerState@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE@@@Z @ 0x1C01E77B0 (-SetVirtualFunctionPowerState@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_SETVIRTUALFUNCTIONPOWERST.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 5094);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALFUNCTIONPOWERSTATE *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                                  + 928LL)
                                                                                      + 96LL))(
