/*
 * XREFs of ?ProcessPStateTransitionRequest@DXGADAPTER@@QEAAXXZ @ 0x1C002EA34
 * Callers:
...
void __fastcall DXGADAPTER::ProcessPStateTransitionRequest(DXGADAPTER *this, __int64 a2, const GUID *a3)
{
  ...
  v3 = 0;
  _InterlockedExchange((volatile __int32 *)this + 1021, 0);
  if ( *((_DWORD *)this + 970) )
  {
    do
    {
      ...
      Arg3 = _InterlockedExchange(
               (volatile __int32 *)((char *)&v5[3].MatchAllKeyword + *((_QWORD *)this + 484) + 4),
               -1);
      if ( Arg3 != -1 )
      {
        v7 = *((_QWORD *)this + 484);
