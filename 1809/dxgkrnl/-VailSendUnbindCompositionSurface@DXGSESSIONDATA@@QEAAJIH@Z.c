/*
 * XREFs of ?VailSendUnbindCompositionSurface@DXGSESSIONDATA@@QEAAJIH@Z @ 0x1C025D4B0
 * Callers:
...
__int64 __fastcall DXGSESSIONDATA::VailSendUnbindCompositionSurface(DXGSESSIONDATA *this, int a2, unsigned int a3)
{
