/*
 * XREFs of ?ReleaseSourceModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNSOURCEMODESET__@@@Z @ 0x1C0136C30
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 6035);
  ...
  if ( v5 )
  {
    ...
    {
      v8 = ExposedViaHandle<DMMVIDPNSOURCEMODESET,D3DKMDT_HVIDPNSOURCEMODESET__ *>::GetFromHandle((__int64)a2);
      v10 = (struct DMMVIDPNSOURCEMODESET *)v8;
      if ( v8 )
      {
        v11 = *(DMMVIDPNSOURCE **)(v8 + 112);
        if ( !v11 )
        {
        ...
        if ( ContainedBy<DMMVIDPN>::GetContainer(v12 + 64) == v7 )
        {
          ...
          DMMVIDPNSOURCE::ReleaseModeSet(v11, v10);
