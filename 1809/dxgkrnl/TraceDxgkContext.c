/*
 * XREFs of TraceDxgkContext @ 0x1C0035D40
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall TraceDxgkContext(
        int a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        __int64 a11)
{
  ...
  return McTemplateK0pqqqqqqqqppp(v12, v14, a3, v13, (_DWORD)a3, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24);
}
