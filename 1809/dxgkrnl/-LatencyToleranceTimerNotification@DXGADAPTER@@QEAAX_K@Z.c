/*
 * XREFs of ?LatencyToleranceTimerNotification@DXGADAPTER@@QEAAX_K@Z @ 0x1C002D7E8
 * Callers:
 *     ?DxgkLatencyToleranceTimerNotification@@YAXQEAX_K@Z @ 0x1C01C6430 (-DxgkLatencyToleranceTimerNotification@@YAXQEAX_K@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::LatencyToleranceTimerNotification(KSPIN_LOCK *this, __int64 a2)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v21, this + 378, 1);
  v5 = this + 376;
  v6 = (_QWORD *)this[376];
  while ( v6 != v5 )
  {
...
LABEL_20:
      ...
      else
      {
        ...
        DXGADAPTER::SetPowerComponentLatencyCB(
          (DXGADAPTER *)this,
          *((_DWORD *)v7 - 99),
          *(_QWORD *)(this[356] + 16 * (v10 + 1)));
        *((_DWORD *)v7 - 4) = v12;
        *(v7 - 1) = a2 + *(_QWORD *)(this[356] + 16 * v11 + 8);
        if ( v12 == *((_DWORD *)v7 - 3) )
        {
          v13 = *v7;
          if ( *(_QWORD **)(*v7 + 8LL) != v7 )
  ...
  {
    LOBYTE(v4) = *((_BYTE *)this + 2996);
  }
  (*(void (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(this[316] + 520) + 8LL) + 864LL))(
    *(_QWORD *)(this[316] + 528),
    v4);
  if ( v24 )
  {
