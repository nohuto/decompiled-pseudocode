/*
 * XREFs of ?DdiCancelCommand@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_CANCELCOMMAND@@@Z @ 0x1C01C88FC
 * Callers:
 *     ?ADAPTER_RENDER_DdiCancelCommand@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_CANCELCOMMAND@@@Z @ 0x1C00378C0 (-ADAPTER_RENDER_DdiCancelCommand@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_CANCELCOMMAND@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5052);
  }
  else
  {
    v30 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5052);
...
LABEL_16:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_CANCELCOMMAND *))(*((_QWORD *)this + 2) + 744LL))(
  ...
  if ( (_DWORD)v16 )
  {
    v24 = WdLogNewEntry5_WdError(DmaBufferSize);
    *(_QWORD *)(v24 + 24) = v16;
