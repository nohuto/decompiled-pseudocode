/*
 * XREFs of ?AcquireBuffer@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_ACQUIRESWAPCHAIN@@PEAI@Z @ 0x1C024FB44
 * Callers:
 ...
 *     ?Remove@DXGFIXEDQUEUE@@QEAAJPEAI@Z @ 0x1C0041088 (-Remove@DXGFIXEDQUEUE@@QEAAJPEAI@Z.c)
