/*
 * XREFs of ?DdiSetupPriorityBands@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETUPPRIORITYBANDS@@@Z @ 0x1C01D0754
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetupPriorityBands@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETUPPRIORITYBANDS@@@Z @ 0x1C0037B20 (-ADAPTER_RENDER_DdiSetupPriorityBands@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETUPPRIORITYBANDS@@@.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  int v13; // r14d
  __int64 v14; // rcx
  __int64 (__fastcall *v15)(_QWORD, const struct _DXGKARG_SETUPPRIORITYBANDS *); // rax
  int v16; // edi
  __int64 v17; // rcx
  _QWORD *v18; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5115);
...
LABEL_16:
  ...
  v14 = *((_QWORD *)this + 2);
  v15 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETUPPRIORITYBANDS *))(v14 + 1176);
  if ( v15 )
