/*
 * XREFs of ?DdiQueryCurrentFence@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYCURRENTFENCE@@@Z @ 0x1C00326E4
 * Callers:
 *     ?ADAPTER_RENDER_DdiQueryCurrentFence@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYCURRENTFENCE@@@Z @ 0x1C00379E0 (-ADAPTER_RENDER_DdiQueryCurrentFence@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYCURRENTFENCE@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5015);
...
LABEL_16:
  ...
  v13 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYCURRENTFENCE *))(*((_QWORD *)this + 2) + 472LL))(
  ...
  v19[3] = v13;
  v19[4] = a2->CurrentFence;
  v19[5] = a2->NodeOrdinal;
  EngineOrdinal = a2->EngineOrdinal;
  v19[6] = EngineOrdinal;
  if ( (_DWORD)v13 )
  {
    v21 = WdLogNewEntry5_WdError(EngineOrdinal);
    *(_QWORD *)(v21 + 24) = v13;
