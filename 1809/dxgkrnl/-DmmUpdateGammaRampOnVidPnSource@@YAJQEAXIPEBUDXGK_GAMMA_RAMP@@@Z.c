/*
 * XREFs of ?DmmUpdateGammaRampOnVidPnSource@@YAJQEAXIPEBUDXGK_GAMMA_RAMP@@@Z @ 0x1C00D34E0
 * Callers:
      ...
      *(_QWORD *)(v13 + 128) = a3;
      ...
      if ( v42 )
      {
        ...
        for ( i = 0LL; ; ++i )
        {
          ...
          Path = DMMVIDPNTOPOLOGY::FindPath(v18, v4, v41);
          if ( !Path )
          {
          ...
          LODWORD(v6) = DMMVIDPNPRESENTPATH::SetDriverGammaRamp(Path);
          if ( (int)v6 < 0 )
            goto LABEL_37;
        }
