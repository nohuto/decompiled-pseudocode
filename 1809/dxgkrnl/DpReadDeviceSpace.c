/*
 * XREFs of DpReadDeviceSpace @ 0x1C001E750
 * Callers:
...
LABEL_17:
    ...
    if ( (*(_DWORD *)(a1 + 3892) & 4) == 0 )
    {
      v13 = -1071774661LL;
      goto LABEL_17;
    }
    v15 = *(__int64 (__fastcall **)(_QWORD, void *, _QWORD, _QWORD))(a1 + 2880);
    if ( v15 )
    {
      BusDataByOffset = v15(*(_QWORD *)(a1 + 2856), a3, Offset, Length);
      goto LABEL_12;
    }
LABEL_23:
    v6 = -1073741823;
