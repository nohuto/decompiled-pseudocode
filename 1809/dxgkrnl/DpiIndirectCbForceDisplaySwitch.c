/*
 * XREFs of DpiIndirectCbForceDisplaySwitch @ 0x1C026F830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiIndirectCbForceDisplaySwitch(__int64 a1)
{
  ...
  if ( !a1 )
    return 3221225485LL;
  v1 = *(_QWORD *)(a1 + 64);
  if ( !v1 || *(_DWORD *)(v1 + 16) != 1953656900 || *(_DWORD *)(v1 + 20) != 2 || !*(_BYTE *)(v1 + 1151) )
    return 3221225485LL;
  memset(v3, 0, 0x48uLL);
  ...
  LODWORD(v3[3]) = 56;
  LOBYTE(v3[6]) = -1;
  return DxgkRequestAsyncDisplaySwitchCallout(0LL, (struct _DXGK_DISPLAY_SCENARIO_CONTEXT *)v3, *(_QWORD *)(v1 + 5536));
}
