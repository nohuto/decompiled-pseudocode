/*
 * XREFs of IsThreadCrossSessionAttached @ 0x1C0020F7C
 * Callers:
 ...
 *     DXGETWPROFILER_BASE_PushProfilerEntry @ 0x1C00142C0 (DXGETWPROFILER_BASE_PushProfilerEntry.c)
 ...
 *     ?DXGTHREAD_GetCurrent@@YAPEAVDXGTHREAD@@XZ @ 0x1C0037C40 (-DXGTHREAD_GetCurrent@@YAPEAVDXGTHREAD@@XZ.c)
