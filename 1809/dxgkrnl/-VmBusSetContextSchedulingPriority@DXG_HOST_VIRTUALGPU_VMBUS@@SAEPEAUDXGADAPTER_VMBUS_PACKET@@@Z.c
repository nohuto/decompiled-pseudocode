/*
 * XREFs of ?VmBusSetContextSchedulingPriority@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C01F8680
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusSetContextSchedulingPriority(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 5) + 157LL) )
  {
    ...
    if ( v5 )
    {
      v8 = DxgkSetContextSchedulingPriority(v5 + 24, v6, v7);
