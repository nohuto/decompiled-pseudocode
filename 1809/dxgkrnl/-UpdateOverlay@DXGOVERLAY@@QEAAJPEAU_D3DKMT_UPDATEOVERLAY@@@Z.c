/*
 * XREFs of ?UpdateOverlay@DXGOVERLAY@@QEAAJPEAU_D3DKMT_UPDATEOVERLAY@@@Z @ 0x1C021F744
 * Callers:
...
LABEL_28:
  ...
  if ( PrivateDriverDataSize && a2->OverlayInfo.pPrivateDriverData )
  {
    ...
    v27.OverlayInfo.pPrivateDriverData = v18;
    if ( !v18 )
    {
