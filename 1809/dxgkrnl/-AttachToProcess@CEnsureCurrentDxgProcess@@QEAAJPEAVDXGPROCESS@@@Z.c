/*
 * XREFs of ?AttachToProcess@CEnsureCurrentDxgProcess@@QEAAJPEAVDXGPROCESS@@@Z @ 0x1C0031600
 * Callers:
 ...
 * Callees:
 *     ?Destroy@CEnsureCurrentDxgProcess@@AEAAXXZ @ 0x1C00316E4 (-Destroy@CEnsureCurrentDxgProcess@@AEAAXXZ.c)
 */
