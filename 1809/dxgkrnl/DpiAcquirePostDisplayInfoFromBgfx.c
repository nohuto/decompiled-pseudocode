/*
 * XREFs of DpiAcquirePostDisplayInfoFromBgfx @ 0x1C0145794
 * Callers:
...
__int64 __fastcall DpiAcquirePostDisplayInfoFromBgfx(unsigned int *a1, char a2, char a3)
{
  ...
  unsigned int v33; // [rsp+60h] [rbp-20h]
  unsigned int v34; // [rsp+64h] [rbp-1Ch]
...
LABEL_15:
    ...
    v31[0] = PoolWithTag;
    v31[1] = v22;
    if ( !v5 || v33 > 0xBB8 || (LOBYTE(v31[5]) = 0, v34 > 0x7D0) )
      LOBYTE(v31[5]) = 1;
