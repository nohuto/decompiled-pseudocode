/*
 * XREFs of ?ObjectInit@CompositionTokenObject@@KAJPEAVDxgkCompositionObject@@PEAXPEAPEAVIDxgkCompositionObject@@@Z @ 0x1C000C720
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDxgkCompositionObject **a3)
{
  ...
  if ( a1 )
  {
    ...
    *(_QWORD *)(v3 + 40) = &CCompositionToken::`vftable'{for `CPushLock'};
    *(_BYTE *)(v3 + 64) = 0;
    *(_QWORD *)(v3 + 72) = 0LL;
    *(_DWORD *)(v3 + 80) = 0;
    *(_QWORD *)(v3 + 88) = 0LL;
