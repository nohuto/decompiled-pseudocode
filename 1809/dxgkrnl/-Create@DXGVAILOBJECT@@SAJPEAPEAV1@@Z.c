/*
 * XREFs of ?Create@DXGVAILOBJECT@@SAJPEAPEAV1@@Z @ 0x1C0259CD4
 * Callers:
...
__int64 __fastcall DXGVAILOBJECT::Create(struct DXGVAILOBJECT **a1)
{
  ...
  void *v17; // [rsp+70h] [rbp-10h]
  __int64 v18; // [rsp+78h] [rbp-8h]
  HANDLE Handle; // [rsp+A0h] [rbp+20h] BYREF
  void *v20; // [rsp+A8h] [rbp+28h] BYREF

  *a1 = 0LL;
  v20 = 0LL;
  Handle = 0LL;
  DefaultSecurityDescriptor = DXGVAILOBJECT::AllocateDefaultSecurityDescriptor(0xC0060000, (struct _ACL **)&v20);
  v7 = v20;
