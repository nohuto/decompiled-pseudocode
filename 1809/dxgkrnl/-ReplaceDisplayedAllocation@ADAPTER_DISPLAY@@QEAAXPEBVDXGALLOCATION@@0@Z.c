/*
 * XREFs of ?ReplaceDisplayedAllocation@ADAPTER_DISPLAY@@QEAAXPEBVDXGALLOCATION@@0@Z @ 0x1C0121530
 * Callers:
 ...
 *     ?GetDisplayPlaneConfigHead@@YAPEAU_DISPLAY_PLANE_CONFIG@@PEAU_DISPLAY_PLANE_CONFIG_QUEUE@@PEAH@Z @ 0x1C0121B00 (-GetDisplayPlaneConfigHead@@YAPEAU_DISPLAY_PLANE_CONFIG@@PEAU_DISPLAY_PLANE_CONFIG_QUEUE@@PEAH@Z.c)
 */
      ...
      if ( *(_DWORD *)(v8 + v9 + 3740) )
      {
        ...
        do
        {
            ...
            && *(const struct DXGALLOCATION **)(v9 + 80 * ((unsigned int)v10 + 47 * v26) + 2896) == v3 )
          {
            ...
            *(_BYTE *)((unsigned int)v10 + *((_QWORD *)this + 14) + v8 + 2880) = 0;
