/*
 * XREFs of ?DmmGetPreferredMonitorSourceModeOnTarget@@YAJPEAXIPEAU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C00BAC28
 * Callers:
        ...
        struct _D3DKMDT_MONITOR_SOURCE_MODE *a3)
{
  ...
  v7 = *(VIDPN_MGR **)(*((_QWORD *)a1 + 315) + 88LL);
  EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v17, (__int64)v7);
