/*
 * XREFs of ?PinMode@DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@I@Z @ 0x1C0286170
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v22, 7015);
  ...
  *(_QWORD *)(v9 + 32) = this;
  ...
  if ( v11 )
  {
    v16 = DMMVIDPNTARGETMODESET::PinMode(v11, (unsigned int)v4, v13, v14);
    if ( v16 >= 0 )
    {
      v16 = 0;
    }
