/*
 * XREFs of DxgkProcessDisplayCalloutBatch @ 0x1C023B9D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
    ...
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v15, (struct DXGGLOBAL *)((char *)v11 + 1448), 0);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v15);
    v12 = (__int64 *)((char *)v11 + 1488);
    v6 = (__int64 *)*((_QWORD *)v11 + 186);
    if ( v6 == v12 )
      break;
...
LABEL_20:
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v15, (struct DXGGLOBAL *)((char *)v13 + 1448), 0);
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v15);
  *((_QWORD *)v13 + 188) = 0LL;
  if ( v16 )
    DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v15);
