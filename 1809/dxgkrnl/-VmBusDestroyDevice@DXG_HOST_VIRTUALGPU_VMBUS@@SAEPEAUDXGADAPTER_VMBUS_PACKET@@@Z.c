/*
 * XREFs of ?VmBusDestroyDevice@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C01EEA00
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDestroyDevice(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  _D3DKMT_DESTROYDEVICE v10; // [rsp+50h] [rbp+8h] BYREF
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 5) + 157LL) )
  {
    ...
    if ( v5 )
    {
      v10.hDevice = *(_DWORD *)(v5 + 24);
      v6 = DxgkDestroyDeviceImpl(&v10, 0);
      v7 = (struct VMBPACKETCOMPLETION__ *)*((_QWORD *)a1 + 9);
      v11 = v6;
      VmBusCompletePacket(v7, &v11, 4u);
      v3 = 1;
    }
  }
  else
