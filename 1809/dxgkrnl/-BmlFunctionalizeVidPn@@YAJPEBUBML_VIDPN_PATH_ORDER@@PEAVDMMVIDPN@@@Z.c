/*
 * XREFs of ?BmlFunctionalizeVidPn@@YAJPEBUBML_VIDPN_PATH_ORDER@@PEAVDMMVIDPN@@@Z @ 0x1C00D617C
 * Callers:
...
LABEL_16:
  ...
  if ( (_BYTE)v8 )
  {
    do
    {
      ...
      v31 = BmlFunctionalizePath(a1, a2, v22, v26);
      if ( v31 < 0 )
      {
        if ( v31 != -1071774970 )
        {
        ...
        *(_QWORD *)(WdLogNewEntry5_WdTrace(v28, v27, v29, v30) + 24) = v22;
        ...
        DxgkLogCodePointPacket(0x11u, v22, 0, 0, *(_QWORD *)(*(_QWORD *)(v43 + 16) + 276LL));
        if ( !v22 )
          return 3223192326LL;
        --v22;
      }
