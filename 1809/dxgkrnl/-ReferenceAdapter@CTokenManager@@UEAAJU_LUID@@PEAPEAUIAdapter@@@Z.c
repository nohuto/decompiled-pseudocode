/*
 * XREFs of ?ReferenceAdapter@CTokenManager@@UEAAJU_LUID@@PEAPEAUIAdapter@@@Z @ 0x1C00069E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTokenManager::ReferenceAdapter(CTokenManager *this, struct _LUID a2, struct IAdapter **a3)
{
  ...
  v5 = 0LL;
  result = CAdapterCollection::ReferenceAdapter((CTokenManager *)((char *)this + 104), a2, &v5);
  *a3 = v5;
  return result;
}
