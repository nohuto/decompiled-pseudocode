/*
 * XREFs of ?AddChunkListToTail@MIRACAST_CHUNK_LIST@@QEAAXPEAV1@@Z @ 0x1C00452E0
 * Callers:
 *     ?MiracastProcessPendingDPCChunks@@YAEPEAX@Z @ 0x1C0045510 (-MiracastProcessPendingDPCChunks@@YAEPEAX@Z.c)
 *     DpiMiracastMoveChunkList @ 0x1C0046460 (DpiMiracastMoveChunkList.c)
 * Callees:
 *     <none>
 */
