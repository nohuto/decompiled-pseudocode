/*
 * XREFs of ?DdiUpdateOverlay@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_UPDATEOVERLAY@@@Z @ 0x1C01D15C4
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiUpdateOverlay(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 5033);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 624LL))(a2, a3);
  if ( v30[0] )
