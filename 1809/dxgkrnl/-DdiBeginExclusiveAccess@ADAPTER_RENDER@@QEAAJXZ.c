/*
 * XREFs of ?DdiBeginExclusiveAccess@ADAPTER_RENDER@@QEAAJXZ @ 0x1C01C8634
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiBeginExclusiveAccess(ADAPTER_RENDER *this, __int64 a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5130);
  v4 = *((_QWORD *)this + 2);
  LODWORD(v5) = 0;
  if ( *(_QWORD *)(v4 + 1224) )
  {
...
LABEL_17:
    ...
    v14 = *((_QWORD *)this + 2);
    v24 = 0;
    v5 = (*(int (__fastcall **)(_QWORD, int *))(v14 + 1224))(*(_QWORD *)(v14 + 248), &v24);
    if ( v28[0] )
