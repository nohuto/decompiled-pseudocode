/*
 * XREFs of ?DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C01D0D2C
 * Callers:
 *     ?ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C0037B60 (-ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  _QWORD *v20; // rax
  __int64 v21; // rcx
  struct _DXGKARG_STOPCAPTURE *v22; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5039);
...
LABEL_16:
  ...
  v16 = (void *)(*(int (__fastcall **)(_QWORD, struct _DXGKARG_STOPCAPTURE *))(*((_QWORD *)this + 2) + 560LL))(
  ...
  v22 = (struct _DXGKARG_STOPCAPTURE *)WdLogNewEntry5_WdTrace(v17, v13, v14, v15);
  v22[3].hAllocation = v16;
  v22[4].hAllocation = *(HANDLE *)(*((_QWORD *)this + 2) + 248LL);
  hAllocation = a2->hAllocation;
  v22[5].hAllocation = a2->hAllocation;
  if ( (_DWORD)v16 )
  {
