/*
 * XREFs of DxgkSetIndependentFlipMode @ 0x1C014001C
 * Callers:
 ...
 *     ?GetPlaneIndex@DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAAIXZ @ 0x1C001D358 (-GetPlaneIndex@DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAAIXZ.c)
 *     ?GetVidPnSourceId@DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAAIXZ @ 0x1C001D380 (-GetVidPnSourceId@DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAAIXZ.c)
        ...
        __int64 a9)
{
  ...
  char v47; // [rsp+88h] [rbp-59h]
  struct _OBJECT_HANDLE_INFORMATION HandleInformation; // [rsp+90h] [rbp-51h] BYREF
  _BYTE v49[8]; // [rsp+98h] [rbp-49h] BYREF
  _BYTE v50[32]; // [rsp+A0h] [rbp-41h] BYREF
  _BYTE v51[88]; // [rsp+C0h] [rbp-21h] BYREF
  ...
  *a8 = 0;
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v45, 2094);
...
LABEL_30:
  ...
  COREADAPTERACCESS::COREADAPTERACCESS((COREADAPTERACCESS *)v49, v15, 0LL);
  if ( *((_QWORD *)v15 + 315) == v16 )
  {
    LODWORD(v14) = -1073741823;
  }
  else
  {
    v17 = COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v49);
    v14 = v17;
    if ( v17 < 0 )
    {
    ...
    else
    {
      ...
      while ( v23 )
      {
        v24 = *(_DWORD *)(*((_QWORD *)v15 + 315) + 80LL);
...
LABEL_39:
        ...
        v26 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)Object + 2) + 72LL) + 16LL) + 2368LL);
...
LABEL_40:
      ...
      if ( a4 )
        (*(void (__fastcall **)(_QWORD, _QWORD, __int64, const GUID *, __int64, int, _DWORD *, __int64))(v31 + 392))(
          *(_QWORD *)(v30 + 528),
          a6,
          a2,
          a3,
        ...
        (*(void (__fastcall **)(_QWORD, _QWORD, __int64, const GUID *, __int64, int, char, _DWORD *, __int64))(v31 + 400))(
          *(_QWORD *)(v30 + 528),
          a6,
          a2,
          a3,
