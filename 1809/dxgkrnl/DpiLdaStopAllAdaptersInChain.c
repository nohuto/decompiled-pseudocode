/*
 * XREFs of DpiLdaStopAllAdaptersInChain @ 0x1C02734C8
 * Callers:
...
__int64 __fastcall DpiLdaStopAllAdaptersInChain(struct _DEVICE_OBJECT *a1, __int64 a2)
{
  ...
  if ( *((_DWORD *)DeviceExtension + 666) )
  {
    do
    {
      v8 = *(struct _DEVICE_OBJECT **)(DeviceExtension[332] + 8LL * v3);
    ...
    while ( v3 < *((_DWORD *)DeviceExtension + 666) );
  }
  return 0LL;
}
