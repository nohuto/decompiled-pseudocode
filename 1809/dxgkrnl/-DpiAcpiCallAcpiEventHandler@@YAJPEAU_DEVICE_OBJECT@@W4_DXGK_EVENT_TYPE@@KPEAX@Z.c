/*
 * XREFs of ?DpiAcpiCallAcpiEventHandler@@YAJPEAU_DEVICE_OBJECT@@W4_DXGK_EVENT_TYPE@@KPEAX@Z @ 0x1C004A2A4
 * Callers:
 *     ?DpiAcpiPowerStateCallback@@YAXPEAX00@Z @ 0x1C001E9F0 (-DpiAcpiPowerStateCallback@@YAXPEAX00@Z.c)
 *     ?DpiAcpiEventCallback@@YAXPEAXK@Z @ 0x1C004A500 (-DpiAcpiEventCallback@@YAXPEAXK@Z.c)
 *     DpiAcpiDockEventCallback @ 0x1C026FEE0 (DpiAcpiDockEventCallback.c)
 * Callees:
  ...
  *(_DWORD *)ActivityId[1].Data4 = 4;
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)PoolWithTag + 13) = *(_QWORD *)&ActivityId[4].Data1;
    ...
    v12 = (_QWORD *)qword_1C008E928;
    if ( *(__int64 **)qword_1C008E928 != &qword_1C008E920 )
      __fastfail(3u);
    *(_QWORD *)PoolWithTag = &qword_1C008E920;
    *((_QWORD *)PoolWithTag + 1) = v12;
    *v12 = PoolWithTag;
    qword_1C008E928 = (__int64)PoolWithTag;
    if ( !IoWorkItem )
    {
