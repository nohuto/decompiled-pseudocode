/*
 * XREFs of ?DpiIndirectGetMiniport@@YAJAEBUDXGK_MINIPORT_FILTER@@AEAVAUTO_REMOVE_LOCK@@AEAVAUTO_PNPPOWER_LOCK@@PEAPEAU_FDO_CONTEXT@@@Z @ 0x1C026ED40
 * Callers:
        ...
        struct _FDO_CONTEXT **a4)
{
  ...
  v7 = qword_1C008E778;
  v14 = 0;
  if ( (__int64 *)qword_1C008E778 == &qword_1C008E778 )
    goto LABEL_33;
  do
  {
          ...
          *((_BYTE *)a2 + 8) = 0;
          ...
          if ( DeviceInstanceId >= 0 )
          {
            ...
            *((_BYTE *)v10 + 10) = 0;
            ...
            if ( *(_DWORD *)a1 == 1 )
            {
              if ( *((_DWORD *)i + 650) == *((_DWORD *)a1 + 2) && *((_DWORD *)i + 651) == *((_DWORD *)a1 + 3) )
              {
                v11 = 1;
...
LABEL_27:
  ...
  while ( (__int64 *)v7 != &qword_1C008E778 );
  v5 = v15;
