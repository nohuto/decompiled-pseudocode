/*
 * XREFs of ?InitializePowerManagement@ADAPTER_RENDER@@QEAAJXZ @ 0x1C01C6A14
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::InitializePowerManagement(ADAPTER_RENDER *this)
{
  ...
  void (__fastcall *v4)(__int64, unsigned int); // rcx
  bool v5; // cc
  __int64 v6; // rax
  ...
  LODWORD(v17[9]) = *(_DWORD *)(v1 + 2992);
  v17[7] = DxgkNotifyMemorySegmentHasData;
  DriverVersion = DXGADAPTER::GetDriverVersion((DXGADAPTER *)v1);
  v4 = (void (__fastcall *)(__int64, unsigned int))v17[6];
  v5 = DriverVersion < 1300;
  v6 = *((_QWORD *)this + 65);
  if ( !v5 )
    v4 = DxgNotifyVSyncCB;
  v17[6] = v4;
  (*(void (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)(v6 + 8) + 792LL))(*((_QWORD *)this + 66), v17);
  ...
  if ( v7 )
  {
    ...
    do
    {
      ...
      if ( v12 )
      {
        ...
        {
          case 2:
            v13 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, unsigned int, char *))(*(_QWORD *)(*((_QWORD *)this + 65) + 8LL) + 800LL))(
                    *((_QWORD *)this + 66),
                    2LL,
                    0LL,
