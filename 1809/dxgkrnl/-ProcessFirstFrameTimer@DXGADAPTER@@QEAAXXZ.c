/*
 * XREFs of ?ProcessFirstFrameTimer@DXGADAPTER@@QEAAXXZ @ 0x1C002E944
 * Callers:
 *     ?DxgkpFirstFrameTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C0034B70 (-DxgkpFirstFrameTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::ProcessFirstFrameTimer(KSPIN_LOCK *this)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 509, &LockHandle);
  v2 = 0;
  for ( *((_BYTE *)this + 4080) = 0; v2 < *((_DWORD *)this + 970); ++v2 )
  {
    v3 = 248LL * v2;
    v4 = this[484];
    if ( *(_BYTE *)(v4 + v3 + 240) )
