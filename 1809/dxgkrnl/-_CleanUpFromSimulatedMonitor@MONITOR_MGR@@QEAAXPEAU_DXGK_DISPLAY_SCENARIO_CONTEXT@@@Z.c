/*
 * XREFs of ?_CleanUpFromSimulatedMonitor@MONITOR_MGR@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00D4FC0
 * Callers:
...
void __fastcall MONITOR_MGR::_CleanUpFromSimulatedMonitor(MONITOR_MGR *this, struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a2)
{
  ...
  if ( !v5 )
    MONITOR_MGR::_EnableDisableMonitor((__int64)this, 0xFFFFFFFF, 1, 8u, 0LL, (__int64)a2);
}
