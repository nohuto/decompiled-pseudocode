/*
 * XREFs of ?DdiSetTargetContentType@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETCONTENTTYPE@@@Z @ 0x1C01CF530
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5078);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETCONTENTTYPE *))(*((_QWORD *)this + 2) + 1080LL))(
