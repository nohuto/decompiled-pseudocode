/*
 * XREFs of DxgkAcquireHandleDataCB @ 0x1C00F2AD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReleaseShared@DXGAUTOPUSHLOCK@@QEAAXXZ @ 0x1C00208B8 (-ReleaseShared@DXGAUTOPUSHLOCK@@QEAAXXZ.c)
...
ULONG_PTR __fastcall DxgkAcquireHandleDataCB(unsigned int *a1, struct _EX_RUNDOWN_REF **a2)
{
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx(v9 + 208, 0LL) )
  {
    if ( bTracingEnabled )
    {
      ...
      if ( v22 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0q(v20, &EventBlockThread, (const GUID *)v21, v22);
    }
  ...
  if ( v23 == 1 )
  {
    ...
    if ( (unsigned int)v26 < *(_DWORD *)(v9 + 248) )
    {
      ...
      if ( (_BYTE)v25 == (*(_BYTE *)(v27 + 16 * v26 + 8) & 0x60)
        && ((v20 & 0x2000) == 0 || (v20 & 0x4000) != 0)
        && (v20 & 0x1F) != 0 )
      {
...
LABEL_64:
  ...
  DxgkReferenceDxgResource((struct _EX_RUNDOWN_REF *)v37);
  if ( v17 )
    ++*(_DWORD *)(v17 + 136);
