/*
 * XREFs of ?ClipRects@DXGPRESENT@@SAHPEAUtagRECT@@0PEBU2@1@Z @ 0x1C013CF10
 * Callers:
 ...
 * Callees:
 *     ?ClipIntervals@DXGPRESENT@@CAXPEAJ000JJ@Z @ 0x1C022453C (-ClipIntervals@DXGPRESENT@@CAXPEAJ000JJ@Z.c)
