/*
 * XREFs of ?DdiQueryProbedBars@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYPROBEDBARS@@@Z @ 0x1C01E3A38
 * Callers:
 *     ?QueryProbedBars@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_QUERYPROBEDBARS@@@Z @ 0x1C01E76A0 (-QueryProbedBars@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_QUERYPROBEDBARS@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v21, 5090);
...
LABEL_16:
  ...
  (*(void (__fastcall **)(_QWORD, struct _DXGKARG_QUERYPROBEDBARS *))(*(_QWORD *)(*((_QWORD *)this + 2) + 928LL) + 64LL))(
