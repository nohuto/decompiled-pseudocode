/*
 * XREFs of ?DdiPresent@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_PRESENT@@@Z @ 0x1C013E22C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiPresent(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5031);
  }
  else
  {
    v32 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v30, 5031);
...
LABEL_16:
  ...
  v24[3] = v16;
  v24[4] = a2;
  v24[5] = *(unsigned int *)&a3[5].Data4[4];
  v24[6] = *(_QWORD *)&a3->Data1;
  v25 = *(unsigned int *)a3->Data4;
  v24[7] = v25;
  if ( (unsigned int)(v16 + 1073741816) > 0x15 || (v25 = 2129921LL, !_bittest((const int *)&v25, v16 + 1073741816)) )
  {
