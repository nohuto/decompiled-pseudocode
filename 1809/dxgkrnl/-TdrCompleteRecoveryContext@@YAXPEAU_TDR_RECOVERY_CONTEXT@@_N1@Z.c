/*
 * XREFs of ?TdrCompleteRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N1@Z @ 0x1C020AF30
 * Callers:
...
void __fastcall TdrCompleteRecoveryContext(struct _TDR_RECOVERY_CONTEXT *a1, char a2, bool a3)
{
  ...
  if ( a1 )
  {
    v4 = *((_QWORD *)a1 + 6);
    if ( v4 )
      (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2528LL) + 520LL)
                                                          + 8LL)
                                              + 472LL))(
        v4,
        0LL);
    ...
    if ( v7 != 6 )
    {
      v8 = 5LL * (((unsigned __int8)_InterlockedExchangeAdd(dword_1C008EFA4, 1u) + 1) & 0x3F);
    ...
    DxgkLogCodePointPacket(
      0x18u,
      v7,
      *(_DWORD *)(*((_QWORD *)a1 + 4) + 208LL),
      *((_DWORD *)a1 + 20),
      *(_QWORD *)(*((_QWORD *)a1 + 4) + 276LL));
