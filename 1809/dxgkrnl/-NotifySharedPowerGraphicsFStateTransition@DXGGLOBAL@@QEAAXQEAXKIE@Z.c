/*
 * XREFs of ?NotifySharedPowerGraphicsFStateTransition@DXGGLOBAL@@QEAAXQEAXKIE@Z @ 0x1C003B974
 * Callers:
        ...
        char a5)
{
  ...
  {
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 175, &LockHandle);
  }
  else if ( (struct _KTHREAD *)this[177] != KeGetCurrentThread() )
  {
    DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(this + 176));
    v9 = 1;
  }
  for ( i = this[179]; (KSPIN_LOCK *)i != this + 179 && i; i = *(_QWORD *)i )
  {
  ...
  {
    ExReleasePushLockSharedEx(this + 176, 0LL);
