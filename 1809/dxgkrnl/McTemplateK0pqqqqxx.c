/*
 * XREFs of McTemplateK0pqqqqxx @ 0x1C00390C4
 * Callers:
...
ULONG McTemplateK0pqqqqxx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &DevicePresentStateEvent, a3, 8u, &EventData);
}
