/*
 * XREFs of ?GetCurrentOrientation@ADAPTER_DISPLAY@@QEAA?AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@IW4_ROTATION_MODE_TYPE@@@Z @ 0x1C00E544C
 * Callers:
...
LABEL_8:
  if ( a3 != 1 && DmmEnumClientVidPnPathTargetsFromSource(*(void *const *)(a1 + 16), v3, 0LL, &v11) >= 0 )
