/*
 * XREFs of ?InitializeVirtualGpuManager@DXGVIRTUALGPUMANAGER_GPUP@@UEAAJPEAU_DXGKARG_SETGPUPARTITIONCOUNT@@@Z @ 0x1C01E7570
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  v11 = ADAPTER_RENDER::DdiSetGpuPartitionCount(*((ADAPTER_RENDER **)this + 4), a2, a3);
  if ( v11 < 0 )
  {
    operator delete[](*((void **)this + 3));
    *((_DWORD *)this + 3) = 0;
