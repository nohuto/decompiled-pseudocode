/*
 * XREFs of DxgkOpenKeyedMutexFromNtHandle @ 0x1C021E270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenKeyedMutexFromNtHandle(ULONG64 a1, __int64 a2, const GUID *a3)
{
  ...
  void *v25[2]; // [rsp+48h] [rbp-40h]
  void *v26[2]; // [rsp+58h] [rbp-30h]
  unsigned int v27; // [rsp+98h] [rbp+10h] BYREF
  struct DXGKEYEDMUTEX *v28; // [rsp+A0h] [rbp+18h] BYREF
  struct DXGPROCESS *v29; // [rsp+A8h] [rbp+20h]
  ...
  if ( Current )
  {
    ...
    *(_OWORD *)v26 = v10[1];
    ...
    v12 = DXGGLOBAL::OpenKeyedMutexFromNtHandle(v11, v25[0], &v28, &v27, v26[0], (unsigned int)v26[1]);
    if ( v12 >= 0 )
    {
      v13 = (_DWORD *)(a1 + 8);
