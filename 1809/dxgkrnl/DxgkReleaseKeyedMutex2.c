/*
 * XREFs of DxgkReleaseKeyedMutex2 @ 0x1C0237A10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkReleaseKeyedMutex2(__int64 a1, __int64 a2, const GUID *a3)
{
  ...
  unsigned int v25[4]; // [rsp+48h] [rbp-30h]
  void *v26[2]; // [rsp+58h] [rbp-20h]
  unsigned int v27[2]; // [rsp+68h] [rbp-10h]
  DXGKEYEDMUTEX *v28; // [rsp+88h] [rbp+10h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v22, 2069);
...
LABEL_12:
  ...
  *(_OWORD *)v26 = *(_OWORD *)(v3 + 16);
  *(_QWORD *)v27 = *(_QWORD *)(v3 + 32);
  v7 = v25[0];
  DXGKEYEDMUTEXBYHANDLE::DXGKEYEDMUTEXBYHANDLE((DXGKEYEDMUTEXBYHANDLE *)&v28, v25[0], Current, &v29);
  v11 = v29;
  if ( !v29 )
  {
  ...
  v16 = DXGKEYEDMUTEX::ReleaseSync(v29, v7, *(__int64 *)&v25[2], (struct _LIST_ENTRY *)v26[0], (char *)v26[1], v27[0]);
  v18 = v16;
  if ( v16 < 0 )
  {
