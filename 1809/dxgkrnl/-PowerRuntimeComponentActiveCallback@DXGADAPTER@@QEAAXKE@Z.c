/*
 * XREFs of ?PowerRuntimeComponentActiveCallback@DXGADAPTER@@QEAAXKE@Z @ 0x1C002E070
 * Callers:
...
void __fastcall DXGADAPTER::PowerRuntimeComponentActiveCallback(DXGADAPTER *this, unsigned int a2, char a3, __int64 a4)
{
  ...
  v6 = (unsigned int *)(*((_QWORD *)this + 320) + 520LL * a2);
  *((_BYTE *)v6 + 356) = a3;
  if ( *((_DWORD *)this + 44) == 1 )
  {
    v7 = v6[52];
    ...
    {
      if ( v7 == 3 )
        (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, char))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 316)
                                                                                             + 544LL)
                                                                                 + 8LL)
                                                                     + 744LL))(
          *(_QWORD *)(*((_QWORD *)this + 316) + 552LL),
    ...
    {
      LOBYTE(a4) = a3;
      (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 316) + 520LL)
                                                                          + 8LL)
                                                              + 808LL))(
    ...
    {
      DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v26, (KSPIN_LOCK *)this + 378, 1);
      if ( a3 )
      {
        v8 = v6 + 100;
        v9 = *((_QWORD *)v6 + 50);
      ...
      else
      {
        ...
        if ( v6[104] )
        {
          ...
          *((_QWORD *)v6 + 49) = v14 + *(_QWORD *)(*((_QWORD *)this + 356) + 8LL);
          v15 = v6 + 100;
          if ( !*((_QWORD *)v6 + 50) )
          {
        ...
        else if ( v11 != 2 )
        {
          v12 = v6[1];
          v6[96] = 2;
          DXGADAPTER::SetPowerComponentLatencyCB(this, v12, *(_QWORD *)(*((_QWORD *)this + 356) + 32LL));
        }
      }
      if ( v29 )
      {
    ...
    if ( !v6[52] && *((_QWORD *)this + 365) )
    {
      DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v30, (KSPIN_LOCK *)this + 378, 1);
      v21 = *((_DWORD *)this + 680);
      if ( !a3 )
      {
        v25 = v21 - 1;
...
LABEL_39:
      ...
      v22 = (__int64 *)(*((_QWORD *)this + 365) + 400LL);
      v23 = (__int64 *)*v22;
      if ( !*v22 )
      {
LABEL_33:
      ...
      {
        v24 = *(__int64 ***)(*((_QWORD *)this + 365) + 408LL);
        if ( *v24 == v22 )
        {
          *v24 = v23;
          v23[1] = (__int64)v24;
          *(_QWORD *)(*((_QWORD *)this + 365) + 400LL) = 0LL;
          goto LABEL_33;
        }
      }
LABEL_36:
