/*
 * XREFs of ?ReleaseAnalogTokensAndGetUpdates@CTokenQueue@@QEAA_NIPEAUCSM_SURFACE_UPDATE@@IPEA_NPEAIPEAPEAVCToken@@@Z @ 0x1C0053B00
 * Callers:
      ...
      do
      {
        ...
        else
        {
          *((_DWORD *)a3 + 7) = (*(__int64 (__fastcall **)(const struct CToken *))(*(_QWORD *)v22 + 112LL))(v22);
          ...
          (*(void (__fastcall **)(CompositionSurfaceObject *, _QWORD))(*((_QWORD *)Global + 2541) + 56LL))(v23, v24);
          *v21 = v22;
        }
        v18 = (_QWORD *)v29[0];
        if ( *(_QWORD **)(v29[0] + 8LL) != v29 )
