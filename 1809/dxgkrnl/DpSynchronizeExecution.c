/*
 * XREFs of DpSynchronizeExecution @ 0x1C0013DF0
 * Callers:
 *     DxgNotifyDpcCB @ 0x1C0013CC0 (DxgNotifyDpcCB.c)
 *     DpiMiracastChunkInfoCallbackDpc @ 0x1C0045780 (DpiMiracastChunkInfoCallbackDpc.c)
 * Callees:
...
LABEL_12:
  ...
  {
    v12 = KfRaiseIrql(3u);
    KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v8 + 1376), &LockHandle);
