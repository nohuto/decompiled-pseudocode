/*
 * XREFs of ?UnpinCofuncModalityOnPathsFromSource@@YAJPEAUD3DKMDT_HVIDPN__@@PEBU_DXGDMM_VIDPN_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@I_K@Z @ 0x1C00B85CC
 * Callers:
...
LABEL_46:
  ...
  if ( !v58 )
  {
    ...
    *(_QWORD *)(v42 + 24) = 3116LL;
    WdLogEvent5_WdAssertion(v42);
  }
  if ( !v60 )
  {
    v43 = WdLogNewEntry5_WdAssertion(v13);
    *(_QWORD *)(v43 + 24) = 3117LL;
...
LABEL_45:
    ...
    if ( !v58 )
    {
      ...
      *(_QWORD *)(v45 + 24) = 3216LL;
      WdLogEvent5_WdAssertion(v45);
    }
    if ( !v61 )
    {
      v46 = WdLogNewEntry5_WdAssertion(v26);
      *(_QWORD *)(v46 + 24) = 3217LL;
