/*
 * XREFs of ?_ReadVirtualModeSupportFromRegistry@DXGMONITOR@@AEAAJXZ @ 0x1C0295B10
 * Callers:
...
__int64 __fastcall DXGMONITOR::_ReadVirtualModeSupportFromRegistry(DXGMONITOR *this)
{
  __int64 result; // rax
  __int64 v3; // rdi
  __int64 v4; // rcx
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (int)v3 >= 0 )
    {
      if ( v11 == 4 && v12 == 4 )
      {
        *((_DWORD *)this + 10) = *((_DWORD *)this + 10) & 0xFFFFFF7F | (v13 != 0 ? 0x80 : 0);
        return 0LL;
      }
      else
      {
