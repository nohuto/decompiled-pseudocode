/*
 * XREFs of ?_CommitEntry@CDS_JOURNAL@@CAJAEBU_ENTRY@1@PEAVCCD_TOPOLOGY@@_N@Z @ 0x1C00B4FBC
 * Callers:
 ...
 * Callees:
 *     ?_IsUnextend@CDS_JOURNAL@@CA_NAEBU_ENTRY@1@@Z @ 0x1C0001CD0 (-_IsUnextend@CDS_JOURNAL@@CA_NAEBU_ENTRY@1@@Z.c)
...
__int64 __fastcall CDS_JOURNAL::_CommitEntry(const struct CDS_JOURNAL::_ENTRY *a1, struct CCD_TOPOLOGY *this)
{
  ...
  bool v19; // r15
  char v20; // al
  struct D3DKMT_PATHMODALITY_DESCRIPTOR *v21; // r11
  __int64 result; // rax
  _QWORD *v23; // rax
    ...
    if ( v4 != -1 )
    {
      if ( IsPrimaryClonePathByModality )
      {
        for ( j = 0; ; ++j )
        {
          ...
          {
            v19 = *((_DWORD *)v18 + 6) != v4
               || *((_DWORD *)v18 + 4) != *((_DWORD *)a1 + 5)
               || *((_DWORD *)v18 + 5) != *((_DWORD *)a1 + 6);
            v20 = CCD_TOPOLOGY::IsPrimaryClonePathByModality(this, j);
            CDS_JOURNAL::_FillPathDescriptor(v21, a1, v20, v19, 0LL);
          }
        }
        return v11;
      }
