/*
 * XREFs of ?DestroyDynamicVideoPresentTarget@DMMVIDEOPRESENTTARGETSET@@QEAAJIPEAW4_CONNECTION_CHANGE_FAILURE_REASON@@@Z @ 0x1C02838B0
 * Callers:
...
LABEL_5:
  ...
  v16 = (DMMVIDEOPRESENTTARGET *)*((_QWORD *)TargetById + 57);
  if ( !v16 )
  {
    *(_DWORD *)a3 = 5;
  ...
  v21 = (DMMVIDEOPRESENTTARGET *)*((_QWORD *)TargetById + 64);
  if ( v21 )
  {
    DMMVIDEOPRESENTTARGET::RemoveJoinedTarget(v21, v8);
    v16 = (DMMVIDEOPRESENTTARGET *)*((_QWORD *)v8 + 57);
  }
  if ( v16 )
