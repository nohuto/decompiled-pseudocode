/*
 * XREFs of McTemplateK0xqqqqqqqq @ 0x1C0049198
 * Callers:
...
ULONG McTemplateK0xqqqqqqqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventMiracastInterrupt, a3, 0xAu, &EventData);
}
