/*
 * XREFs of ?VailSendRemoteObjectTestCommand@DXGSESSIONDATA@@QEAAJPEAXI0PEAIH@Z @ 0x1C025D25C
 * Callers:
  ...
  if ( *((_QWORD *)this + 2346) )
  {
    ...
    if ( v14 && ExAcquireRundownProtection(v14 + 7) )
    {
      if ( ExAcquireRundownProtection((PEX_RUNDOWN_REF)(*(_QWORD *)(*((_QWORD *)this + 2346) + 64LL) + 64LL)) )
      {
        ...
        v18 = *(__int64 **)(*(_QWORD *)(*((_QWORD *)this + 2346) + 72LL) + 8LL);
        if ( v18 )
        {
          v19 = *v18;
          if ( a6 )
