/*
 * XREFs of ?SetConsoleSession@DXGSESSIONMGR@@QEAAXE@Z @ 0x1C0138F24
 * Callers:
...
void __fastcall DXGSESSIONMGR::SetConsoleSession(struct DXGSESSIONDATA **this, char a2)
{
  ...
  if ( v6 && *((_BYTE *)v6 + 18488) )
  {
    ...
    else
    {
      ...
      if ( v16 )
      {
        v17 = (_QWORD *)((char *)v16 + 18584);
        v18 = (_QWORD *)*((_QWORD *)v16 + 2323);
        while ( v18 != v17 )
        {
