/*
 * XREFs of ?DdiReadVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C01E4218
 * Callers:
 *     ?ReadVirtualFunctionConfigBlock@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C01E7700 (-ReadVirtualFunctionConfigBlock@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONF.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 5089);
...
LABEL_16:
  ...
  v13 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK *))(*(_QWORD *)(*((_QWORD *)this + 2) + 928LL)
                                                                                        + 48LL))(
