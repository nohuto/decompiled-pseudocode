/*
 * XREFs of ?GetVidSchCompanionContext@DXGCONTEXT@@QEAAPEAU_VIDSCH_CONTEXT@@XZ @ 0x1C01DE810
 * Callers:
...
struct _VIDSCH_CONTEXT *__fastcall DXGCONTEXT::GetVidSchCompanionContext(DXGCONTEXT *this)
{
  ...
  if ( !result )
  {
    ...
    v6 = 0LL;
    v7 = 0;
    v3 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 40LL) + 328LL);
    v4 = 64LL;
    HIDWORD(v6) = v3;
    LODWORD(v5) = *((_DWORD *)this + 98);
