/*
 * XREFs of ??_GDXG_HOST_REMOTEOBJECTCHANNEL@@IEAAPEAXI@Z @ 0x1C02594D8
 * Callers:
 *     ?Delete@DXG_HOST_REMOTEOBJECTCHANNEL@@UEAAXXZ @ 0x1C025A410 (-Delete@DXG_HOST_REMOTEOBJECTCHANNEL@@UEAAXXZ.c)
 * Callees:
