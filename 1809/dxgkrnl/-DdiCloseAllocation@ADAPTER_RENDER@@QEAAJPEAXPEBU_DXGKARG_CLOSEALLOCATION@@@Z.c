/*
 * XREFs of ?DdiCloseAllocation@ADAPTER_RENDER@@QEAAJPEAXPEBU_DXGKARG_CLOSEALLOCATION@@@Z @ 0x1C01C94CC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiCloseAllocation(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v30, 5029);
...
LABEL_16:
  ...
  v16 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 600LL))(a2, a3);
  if ( v34[0] )
