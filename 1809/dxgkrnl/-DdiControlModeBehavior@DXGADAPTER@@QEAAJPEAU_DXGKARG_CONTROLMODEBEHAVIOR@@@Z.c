/*
 * XREFs of ?DdiControlModeBehavior@DXGADAPTER@@QEAAJPEAU_DXGKARG_CONTROLMODEBEHAVIOR@@@Z @ 0x1C015D848
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v31, 5071);
...
LABEL_16:
  ...
  v15 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_CONTROLMODEBEHAVIOR *))this + 120))(*((_QWORD *)this + 31), a2);
  if ( v35[0] )
  ...
  v23[5] = a2->Request.Value;
  v23[6] = a2->Satisfied.Value;
