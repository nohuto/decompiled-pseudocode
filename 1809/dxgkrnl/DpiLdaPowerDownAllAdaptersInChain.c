/*
 * XREFs of DpiLdaPowerDownAllAdaptersInChain @ 0x1C0273008
 * Callers:
...
__int64 __fastcall DpiLdaPowerDownAllAdaptersInChain(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(v4 + 2664) )
  {
    ...
    while ( 1 )
    {
      v18 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v4 + 2656) + 8 * v14) + 64LL);
      v3 = DpiFdoSetAdapterPowerState(
             *(PDEVICE_OBJECT *)(v18 + 24),
             *(POWER_STATE *)(v18 + 4 * v15 + 1240),
             v17,
             v16,
             v6);
      ...
      if ( (unsigned int)v14 >= *(_DWORD *)(v4 + 2664) )
        return (unsigned int)v3;
      v6 = v22;
    }
    v3 = -1071774666;
