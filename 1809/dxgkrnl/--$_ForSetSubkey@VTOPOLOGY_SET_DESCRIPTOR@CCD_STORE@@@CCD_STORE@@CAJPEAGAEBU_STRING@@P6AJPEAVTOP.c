/*
 * XREFs of ??$_ForSetSubkey@VTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@@CCD_STORE@@CAJPEAGAEBU_STRING@@P6AJPEAVTOPOLOGY_SET_DESCRIPTOR@0@PEAX@Z3_N@Z @ 0x1C00CC08C
 * Callers:
        ...
        char a5)
{
  ...
  *(_QWORD *)&v29.Length = 0LL;
  ...
  if ( v11 < 0 )
    goto LABEL_9;
  v26 = 2;
  v10 = CcdOpenRegistrySubkey_0(&Handle, 0xF003Fu, v28, &v29, (PULONG)((unsigned __int64)&v26 & -(__int64)(a5 != 0)));
