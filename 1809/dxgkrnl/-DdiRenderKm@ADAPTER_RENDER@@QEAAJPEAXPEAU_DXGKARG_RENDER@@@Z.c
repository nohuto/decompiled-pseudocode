/*
 * XREFs of ?DdiRenderKm@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_RENDER@@@Z @ 0x1C012CB5C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiRenderKm(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v30, 5045);
...
LABEL_16:
  ...
  v16 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 672LL))(a2, a3);
  if ( v34[0] )
  ...
  v24[3] = v16;
  v24[4] = a2;
  v24[5] = *(_QWORD *)&a3[1].Data1;
  v24[6] = *(unsigned int *)a3[1].Data4;
  v25 = *(_QWORD *)&a3[3].Data1;
  v24[7] = v25;
  if ( (unsigned int)(v16 + 1073741816) > 0xF || (v25 = 32801LL, !_bittest((const int *)&v25, v16 + 1073741816)) )
  {
