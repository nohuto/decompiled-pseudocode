/*
 * XREFs of ?GetNumModes@DXGDMM_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEA_K@Z @ 0x1C0280CF0
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v14, 6002);
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
