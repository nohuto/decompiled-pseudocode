/*
 * XREFs of DpiMiracastChunkInfoCallbackDpc @ 0x1C0045780
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel(&qword_1C008EB30, &LockHandle);
  ...
  if ( v5 )
  {
    ...
    DpSynchronizeExecution(v5, (KSYNCHRONIZE_ROUTINE *)DpiMiracastMoveChunkList, v7, *(_DWORD *)(v6 + 3804), &v9);
  }
