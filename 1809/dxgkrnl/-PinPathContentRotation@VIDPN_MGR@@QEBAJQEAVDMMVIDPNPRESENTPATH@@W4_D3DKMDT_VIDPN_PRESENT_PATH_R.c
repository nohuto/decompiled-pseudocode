/*
 * XREFs of ?PinPathContentRotation@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C027D88C
 * Callers:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a3)
{
  ...
  LOBYTE(v15) = 1;
  v16 = *((_QWORD *)a2 + 12);
  v21 = *(_DWORD *)(*((_QWORD *)a2 + 11) + 24LL);
  v22 = *(_DWORD *)(v16 + 24);
  v17 = VIDPN_MGR::FormalizeVidPnChange((__int64)this, (D3DKMDT_HVIDPN)(v14 & -(__int64)(v14 != -88)), 9LL, v15, &v21);
  v10 = v17;
  if ( v17 < 0 )
  {
    if ( v17 == -1071774970 )
    {
      v20 = WdLogNewEntry5_WdWarning(v9, v18, v19);
      *(_QWORD *)(v20 + 24) = v3;
      *(_QWORD *)(v20 + 32) = a2;
