/*
 * XREFs of ?CreateValidationProcessInCallerSession@DXGVALIDATION@@AEAAJPEAPEAU_EPROCESS@@@Z @ 0x1C004213C
 * Callers:
...
__int64 __fastcall DXGVALIDATION::CreateValidationProcessInCallerSession(DXGVALIDATION *this, struct _EPROCESS **a2)
{
  ...
  *(_DWORD *)&SourceString.Length = 2883626;
  ...
  v3 = (char *)operator new[](0x44CuLL, 0x4B677844u, PagedPool);
  v4 = v3;
  if ( v3 )
  {
    memset(v3, 0, 0x44CuLL);
    *((_DWORD *)v4 + 1) = 1100;
    *((_QWORD *)v4 + 8) = v4 + 1056;
    *(_DWORD *)v4 = 1100;
    *((_DWORD *)v4 + 2) = 1;
