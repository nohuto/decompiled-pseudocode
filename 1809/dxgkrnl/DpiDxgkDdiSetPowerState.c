/*
 * XREFs of DpiDxgkDdiSetPowerState @ 0x1C01426D0
 * Callers:
...
__int64 __fastcall DpiDxgkDdiSetPowerState(__int64 a1, __int64 a2, const GUID *a3, int a4, unsigned int a5)
{
  __int64 v7; // rbx
  __int64 v8; // rdi
  int v9; // eax
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0pqqqq(a1, &EventEnterDdiSetPowerState, a3, a2, (_DWORD)a3, a4, a5, 0);
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
  {
    ...
    LODWORD(v17) = v7;
    LODWORD(v16) = v8;
    McTemplateK0pqqqq(v11, &EventExitDdiSetPowerState, v12, a2, v16, v17, v18, v19);
  }
