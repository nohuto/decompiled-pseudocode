/*
 * XREFs of ?DdiQueryEngineStatus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYENGINESTATUS@@@Z @ 0x1C0032C9C
 * Callers:
 *     ?ADAPTER_RENDER_DdiQueryEngineStatus@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYENGINESTATUS@@@Z @ 0x1C0037A20 (-ADAPTER_RENDER_DdiQueryEngineStatus@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYENGINESTATUS@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5050);
...
LABEL_16:
  ...
  v13 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYENGINESTATUS *))(*((_QWORD *)this + 2) + 696LL))(
  ...
  if ( (_DWORD)v13 )
  {
    v21 = WdLogNewEntry5_WdError(Value);
    *(_QWORD *)(v21 + 24) = v13;
