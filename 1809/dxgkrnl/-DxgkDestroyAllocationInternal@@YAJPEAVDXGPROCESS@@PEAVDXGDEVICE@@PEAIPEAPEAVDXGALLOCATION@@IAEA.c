/*
 * XREFs of ?DxgkDestroyAllocationInternal@@YAJPEAVDXGPROCESS@@PEAVDXGDEVICE@@PEAIPEAPEAVDXGALLOCATION@@IAEAPEBIIU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEBIPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@E@Z @ 0x1C00FFD40
 * Callers:
        ...
        unsigned __int8 a11)
{
  ...
  struct _KTHREAD **v152; // [rsp+120h] [rbp-268h]
  ...
  v134 = 0LL;
  v20 = ValidateDestroyAllocation(a1, a2, a5, (struct DXGRESOURCE *)*a6, v17, a4, &v134);
  if ( v20 == 255 )
    return 0LL;
  if ( v20 < 0 )
  {
  ...
  {
    COREDEVICEACCESS::COREDEVICEACCESS((__int64)v153, (__int64)a2, 2, v24, 0);
  ...
  v143 = 1;
  COREDEVICEACCESS::COREDEVICEACCESS((__int64)v146, (__int64)a2, 2, v33, 0);
  if ( v149 )
  {
...
LABEL_48:
  ...
  if ( *((_DWORD *)a2 + 116) == 4 )
  {
    ...
    *(_QWORD *)(v41 + 24) = a2;
    ...
    DxgkDestroyClientAllocation(v42, a2, v17, a4, v134);
    goto LABEL_46;
  }
  ...
  v135 = 0LL;
  DXGPROCESSCOPYPROTECTIONMUTEX::DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v145, a1);
  v45 = *(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL);
  v138 = v45;
  v46 = v134;
  if ( v134 )
  {
    if ( *((struct DXGDEVICE **)v134 + 1) != a2 )
    {
      v47 = WdLogNewEntry5_WdAssertion(v44);
      *(_QWORD *)(v47 + 24) = 9371LL;
    ...
    if ( v48 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (unsigned int)v51 > 1 )
        {
          ...
          *(_QWORD *)(v52 + 24) = 9380LL;
          WdLogEvent5_WdAssertion(v52);
          v50 = *((_QWORD *)v48 + 6);
        }
        v53 = *(_DWORD *)(v50 + 4);
        if ( (v53 & 1) != 0
          && (DXGDEVICE::IsVidPnSourcePrimaryValid(a2, (v53 >> 6) & 0xF)
           || v45
           && (v55 = *(ADAPTER_DISPLAY **)(v45 + 2520)) != 0LL
  ...
  if ( v17 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !*v59 )
      {
        ...
        *(_QWORD *)(v61 + 24) = 9410LL;
        WdLogEvent5_WdAssertion(v61);
      }
      if ( *((struct DXGDEVICE **)v60 + 1) != a2 )
      {
        v62 = WdLogNewEntry5_WdAssertion(v44);
        *(_QWORD *)(v62 + 24) = 9411LL;
        WdLogEvent5_WdAssertion(v62);
      }
      if ( *(_DWORD *)(v138 + 284) == 1297040209 )
      {
      ...
      if ( (v64 & 1) != 0
        && (DXGDEVICE::IsVidPnSourcePrimaryValid(a2, (v64 >> 6) & 0xF)
         || (v44 = *(ADAPTER_DISPLAY **)(v66 + 2520)) != 0LL && !ADAPTER_DISPLAY::IsVidPnSourceVisible(v44, v65)) )
      {
        v124 = 1;
        v126 = v136 != 0LL;
        v136 = v60;
    ...
    v129 = 1;
    if ( !DXGDEVICE::IsDisplayedPrimary((struct _KTHREAD **)a2, (v63 >> 6) & 0xF, v60) )
    {
LABEL_86:
      v57 = v126;
      goto LABEL_87;
  ...
  if ( v69 >= 0 )
  {
    ...
    if ( *((_DWORD *)a2 + 116) == 4 )
    {
      ...
      *(_QWORD *)(v89 + 24) = a2;
      ...
      DxgkDestroyClientAllocation(v90, a2, a7, v137, v134);
    ...
    v79 = v132;
    MANAGEDPRIMARIESTRACKER::SaveManagedPrimaryState((MANAGEDPRIMARIESTRACKER *)v154, (struct _KTHREAD **)a2, v132);
    v81 = (struct ADAPTER_RENDER *)*((_QWORD *)a2 + 2);
    if ( *((_QWORD *)a2 + 216) == *((_QWORD *)v81 + 2) )
    {
      if ( ((v79 - 1) & v79) != 0 )
      {
        v82 = v133;
        ADAPTER_DISPLAY::DisableAllPrimaries(*(PERESOURCE ***)(v133 + 2520), v81);
      }
      else if ( v57 )
      {
        if ( v43 == -1 )
        {
          ...
          *(_QWORD *)(v83 + 24) = 9613LL;
          WdLogEvent5_WdAssertion(v83);
        }
        v82 = v133;
        ADAPTER_DISPLAY::DisablePrimaryOnDevice(*(ADAPTER_DISPLAY **)(v133 + 2520), a2, v43, 0);
      }
      else
      {
        v82 = v133;
        ...
        if ( ((*(_DWORD *)(v86 + 4) >> 6) & 0xF) != v43 )
        {
          ...
          *(_QWORD *)(v88 + 24) = 9641LL;
          WdLogEvent5_WdAssertion(v88);
        }
        ADAPTER_DISPLAY::DisablePrimaryAllocation(*(PERESOURCE ***)(v82 + 2520), a2, v84);
      }
    }
    else
    {
...
LABEL_131:
    if ( v127 || v129 )
    {
      ...
      if ( v130 )
      {
        v93 = ADAPTER_DISPLAY::SetVidPnSourceVisibility(*(ADAPTER_DISPLAY **)(v82 + 2520), v43, 0, 0x10u, 0);
        v95 = v93;
        if ( v93 < 0 )
        {
    ...
    if ( *(_BYTE *)(v100 + 185) )
    {
      ...
      v105 = (DXG_GUEST_VIRTUALGPU_VMBUS *)(v100 + 4152);
      v106 = a7;
    ...
    {
      v139 = 0LL;
      DXGDEVICE::RemoveAllocationsAndTransferToList(a2, v107, v106, &v139);
      v110 = v139;
      if ( v139 )
      {
        ...
        if ( v111 )
        {
          do
          {
            ...
            *v113 = 0LL;
            DXGDEVICE::TerminateAllocations(a2, v111, 0, v112, (struct COREDEVICEACCESS *)v146, v15);
          }
          while ( v110 );
        }
        else
        {
          do
          {
            ...
            v110 = (struct DXGALLOCATION *)*((_QWORD *)v110 + 8);
            *v115 = 0LL;
            DXGDEVICE::TerminateAllocations(a2, 0LL, 0, v114, (struct COREDEVICEACCESS *)v146, v15);
          }
          while ( v110 );
        }
        v139 = v110;
    ...
    if ( v127 )
      DXGDEVICE::CloseInternalCddPrimaryHandle(a2, (struct COREDEVICEACCESS *)v146);
    v116 = 0;
    v128 = 0;
    v131[0] = 0;
    if ( (_BYTE)v67 )
    {
      ...
      if ( v117 )
      {
        ...
        *((_BYTE *)v117 + 1785) = 0;
        ...
        if ( v128 && v131[0] )
          (*(void (**)(void))(*(_QWORD *)(*((_QWORD *)a2 + 5) + 104LL) + 192LL))();
      }
    }
    DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v145);
    DXGSESSIONMODECHANGELOCK::~DXGSESSIONMODECHANGELOCK((DXGSESSIONMODECHANGELOCK *)&v123);
