/*
 * XREFs of ?DxgkSendCreateBundleObject@@YAJKPEAI0@Z @ 0x1C022F218
 * Callers:
...
__int64 __fastcall DxgkSendCreateBundleObject(unsigned int a1, unsigned int *a2, unsigned int *a3)
{
  __int64 v6; // rdi
  __int64 v7; // rcx
...
LABEL_15:
    ...
    {
      BundleObject = DXGSESSIONDATA::VailSendCreateBundleObject(SessionDataForSpecifiedSession, a1, a2, a3);
      v6 = BundleObject;
      if ( BundleObject < 0 )
        goto LABEL_15;
    }
