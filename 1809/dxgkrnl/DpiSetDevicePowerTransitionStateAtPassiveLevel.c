/*
 * XREFs of DpiSetDevicePowerTransitionStateAtPassiveLevel @ 0x1C0043A1C
 * Callers:
...
void __fastcall DpiSetDevicePowerTransitionStateAtPassiveLevel(__int64 a1, int a2, char a3)
{
  ...
  v6 = 5LL;
  if ( (_DWORD)v3 != 5 || *(_DWORD *)(a1 + 4048) == 4 )
  {
  ...
  if ( a3 && !*(_DWORD *)(a1 + 4052) )
  {
    ...
    DxgkReportDevicePoweredOn(*(_QWORD *)(a1 + 3792));
  }
