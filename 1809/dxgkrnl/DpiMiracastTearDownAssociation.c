/*
 * XREFs of DpiMiracastTearDownAssociation @ 0x1C00471B8
 * Callers:
...
void __fastcall DpiMiracastTearDownAssociation(char *P, int a2, int a3, unsigned int a4, char a5)
{
  ...
  if ( v9 )
  {
    ...
    *((_DWORD *)P + 104) = a3;
    ...
    if ( !P[590] && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000000) != 0 )
      McTemplateK0qqz(
        v13,
