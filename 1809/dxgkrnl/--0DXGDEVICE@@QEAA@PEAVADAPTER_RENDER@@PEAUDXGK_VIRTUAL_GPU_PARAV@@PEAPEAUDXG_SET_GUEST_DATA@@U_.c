/*
 * XREFs of ??0DXGDEVICE@@QEAA@PEAVADAPTER_RENDER@@PEAUDXGK_VIRTUAL_GPU_PARAV@@PEAPEAUDXG_SET_GUEST_DATA@@U_D3DKMT_CREATEDEVICEFLAGS@@PEAVDXGPROCESS@@W4DXGDEVICECLIENT_TYPE@@PEAVDXGADAPTER@@@Z @ 0x1C00E8120
 * Callers:
...
LABEL_21:
    ...
    *(_DWORD *)(a1 + 1736) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1728) + 2520LL) + 80LL);
  }
  *(_BYTE *)(a1 + 1748) = *(_BYTE *)(a6 + 322) != 0;
  if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 16LL) + 2460LL) )
  {
    v15 = *(_QWORD *)(a1 + 40);
    *(_BYTE *)(a1 + 1751) = 1;
    *(_BYTE *)(v15 + 289) = 1;
