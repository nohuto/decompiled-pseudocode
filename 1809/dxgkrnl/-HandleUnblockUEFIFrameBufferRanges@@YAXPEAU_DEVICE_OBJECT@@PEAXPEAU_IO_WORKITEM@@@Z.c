/*
 * XREFs of ?HandleUnblockUEFIFrameBufferRanges@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C01BDDA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HandleUnblockUEFIFrameBufferRanges(__int64 IoObject, struct _LUID *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  if ( v6 )
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      (*(void (__fastcall **)(_QWORD, struct _LUID *))(*(_QWORD *)(*(_QWORD *)(v19 + 544) + 8LL) + 1168LL))(
        *(_QWORD *)(v19 + 552),
        Context + 1);
    }
    else
