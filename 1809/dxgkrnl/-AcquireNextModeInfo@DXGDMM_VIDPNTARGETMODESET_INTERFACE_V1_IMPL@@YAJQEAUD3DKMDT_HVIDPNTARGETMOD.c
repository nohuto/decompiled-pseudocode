/*
 * XREFs of ?AcquireNextModeInfo@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@QEBU_D3DKMDT_VIDPN_TARGET_MODE@@PEAPEBU3@@Z @ 0x1C00D8CD0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_TARGET_MODE **a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v39, 6011);
  if ( a3 )
  {
    *(_QWORD *)&a3->Data1 = 0LL;
    ...
    if ( v9 )
    {
      ...
      if ( v12 && *v12 == 305419896 )
      {
               ...
               v13) )
        {
          ...
          v42 = v13;
          v38 = v13;
          v15 = DMMVIDPNTARGETMODESET::AcquireDdiEnumeratorCachedModeInfo<KM_STL::binder2nd<KM_STL::mem_fun1_t<DMMVIDPNTARGETMODE *,DMMVIDPNTARGETMODESET,DMMVIDPNTARGETMODE const *>>>(
                  v9,
                  &v36,
                  &v43);
          v20 = v15;
