/*
 * XREFs of ?GetPostCompositionCaps@ADAPTER_DISPLAY@@QEAAJIPEAM0@Z @ 0x1C012E474
 * Callers:
        ...
        float *a4)
{
  ...
  else
  {
    ...
    *a3 = 1.0;
    *a4 = 1.0;
    v9 = *(ADAPTER_RENDER **)(*((_QWORD *)this + 2) + 2528LL);
    if ( v9 )
    {
      if ( ADAPTER_RENDER::IsMultiPlaneOverlaySupported(v9) )
      {
        v12 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 2528LL) + 16LL);
        if ( *(_QWORD *)(v12 + 1136) )
        {
          if ( *(_BYTE *)(v12 + 2466) && ADAPTER_DISPLAY::IsVidPnSourceActive(this, v7) )
          {
            ...
            if ( PostCompositionCaps < 0 )
            {
              ...
              v16[3] = v8;
              v16[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 248LL);
              v16[5] = v7;
