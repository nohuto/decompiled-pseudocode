/*
 * XREFs of ?GetBackingResource@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETBACKINGRESOURCE@@@Z @ 0x1C01DF4AC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetBackingResource(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v9 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, unsigned int *))(*(_QWORD *)VirtualGpuByIndex + 152LL))(
           VirtualGpuByIndex,
           a3);
  }
  else
