/*
 * XREFs of ?DdiValidateSubmitCommand@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_VALIDATESUBMITCOMMAND@@@Z @ 0x1C01D18B8
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5136);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_VALIDATESUBMITCOMMAND *))(*((_QWORD *)this + 2) + 1272LL))(
  ...
  v22[3] = v14;
  v22[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 248LL);
  Commands = a2->Commands;
  v22[5] = a2->Commands;
  if ( (_DWORD)v14 != -1073741592 && (_DWORD)v14 )
  {
    v24 = WdLogNewEntry5_WdError(Commands);
    *(_QWORD *)(v24 + 24) = v14;
