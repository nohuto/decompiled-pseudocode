/*
 * XREFs of ?_RetrieveMonitorDescriptorsFromDriver@DXGMONITOR@@AEAAJXZ @ 0x1C029D710
 * Callers:
...
LABEL_39:
  ...
  v31 = *((_QWORD *)this + 7);
  LODWORD(Size) = 0;
  if ( (unsigned int)DpiQueryDisplayIDDescriptor(v31, (unsigned int *)&Size, 0LL) != -1073741789 )
    return (unsigned int)v17;
  v35 = (unsigned int)Size;
  if ( (unsigned int)(Size - 1) > 0xFFFF )
  {
    v45 = WdLogNewEntry5_WdWarning(v33, v32, v34);
    *(_QWORD *)(v45 + 24) = v35;
    goto LABEL_49;
  }
...
LABEL_47:
  ...
  DisplayIDDescriptor = DpiQueryDisplayIDDescriptor(*((_QWORD *)this + 7), (unsigned int *)&Size, *((void **)this + 20));
  v39 = DisplayIDDescriptor;
  if ( DisplayIDDescriptor < 0 )
  {
    v46 = WdLogNewEntry5_WdError(v38);
    *(_QWORD *)(v46 + 24) = v39;
