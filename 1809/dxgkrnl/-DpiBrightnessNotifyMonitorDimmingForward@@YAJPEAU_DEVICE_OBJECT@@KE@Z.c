/*
 * XREFs of ?DpiBrightnessNotifyMonitorDimmingForward@@YAJPEAU_DEVICE_OBJECT@@KE@Z @ 0x1C026C5B0
 * Callers:
...
__int64 __fastcall DpiBrightnessNotifyMonitorDimmingForward(struct _DEVICE_OBJECT *a1, int a2, char a3)
{
  ...
  if ( a2 == -1 )
  {
    v6 = *((_DWORD *)DeviceExtension + 853);
    if ( v6 == -1 )
      return (unsigned int)-1073741637;
  }
  KeEnterCriticalRegion();
  v8 = (struct _ERESOURCE *)(DeviceExtension + 3232);
  ExAcquireResourceSharedLite((PERESOURCE)(DeviceExtension + 3232), 1u);
  v9 = (_QWORD **)(DeviceExtension + 3392);
  v10 = *v9;
  while ( v10 != v9 )
  {
    v11 = v10 - 4;
