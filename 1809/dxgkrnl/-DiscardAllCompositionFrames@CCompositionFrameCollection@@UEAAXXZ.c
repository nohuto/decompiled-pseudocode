/*
 * XREFs of ?DiscardAllCompositionFrames@CCompositionFrameCollection@@UEAAXXZ @ 0x1C0019DA0
 * Callers:
 *     ??_GCCompositionFrameCollection@@IEAAPEAXI@Z @ 0x1C0019CDC (--_GCCompositionFrameCollection@@IEAAPEAXI@Z.c)
 * Callees:
 *     ?Release@CPushLockCriticalSection@@QEAAXXZ @ 0x1C0006AC8 (-Release@CPushLockCriticalSection@@QEAAXXZ.c)
 *     _guard_dispatch_icall_nop @ 0x1C0022E60 (_guard_dispatch_icall_nop.c)
 *     ?AcquireExclusive@CPushLockCriticalSection@@QEAAXXZ @ 0x1C0053AD8 (-AcquireExclusive@CPushLockCriticalSection@@QEAAXXZ.c)
 */
