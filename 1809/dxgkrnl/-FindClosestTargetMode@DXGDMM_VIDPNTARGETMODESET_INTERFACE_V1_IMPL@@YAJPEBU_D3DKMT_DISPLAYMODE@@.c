/*
 * XREFs of ?FindClosestTargetMode@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJPEBU_D3DKMT_DISPLAYMODE@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@EEEPEAPEBU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C0280990
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _D3DKMDT_VIDPN_TARGET_MODE *a6)
{
  ...
  if ( a6 && this )
  {
    *(_QWORD *)&a6->Id = 0LL;
    ...
    if ( v19 == -1071774902 )
    {
      v22 = WdLogNewEntry5_WdWarning(v18, v17, v20);
      *(_QWORD *)(v22 + 24) = v13;
    ...
    else
    {
      ...
      v25 = WdLogNewEntry5_WdDmmEvent(v18, v17, v20, v21);
      *(_QWORD *)(v25 + 24) = v13;
