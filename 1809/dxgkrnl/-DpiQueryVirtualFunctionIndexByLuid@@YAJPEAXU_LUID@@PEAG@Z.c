/*
 * XREFs of ?DpiQueryVirtualFunctionIndexByLuid@@YAJPEAXU_LUID@@PEAG@Z @ 0x1C0049F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiQueryVirtualFunctionIndexByLuid(_DWORD *a1, struct _LUID a2, unsigned __int16 *a3)
{
  ...
  if ( v7 >= 0 )
  {
    VirtualFunctionIndexByLuid = DxgkDdiQueryVirtualFunctionIndexByLuid(*(void **)(v6 + 3792));
