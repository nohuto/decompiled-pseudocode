/*
 * XREFs of ?GetOwnedSourceFromTarget@DXGDISPLAYMANAGEROBJECT@@QEAAJU_LUID@@IPEAI@Z @ 0x1C0256A80
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( v8 )
  {
    ...
    if ( (int)COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v20) >= 0 && *((_QWORD *)v12 + 315) )
    {
