/*
 * XREFs of ?DdiSignalMonitoredFence@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_SIGNALMONITOREDFENCE@@@Z @ 0x1C01D0A30
 * Callers:
 *     ?ADAPTER_RENDER_DdiSignalMonitoredFence@@YAJPEAVADAPTER_RENDER@@PEAXPEAU_DXGKARG_SIGNALMONITOREDFENCE@@@Z @ 0x1C0037B40 (-ADAPTER_RENDER_DdiSignalMonitoredFence@@YAJPEAVADAPTER_RENDER@@PEAXPEAU_DXGKARG_SIGNALMONITORED.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiSignalMonitoredFence(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v30, 5134);
  if ( a3->Data1 )
...
LABEL_21:
  ...
  v16 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 1256LL))(a2, a3);
  if ( v34[0] )
  ...
  v24[3] = v16;
  v24[4] = a2;
  v24[5] = *(_QWORD *)a3->Data4;
  v25 = *(unsigned int *)a3[1].Data4;
  v24[6] = v25;
