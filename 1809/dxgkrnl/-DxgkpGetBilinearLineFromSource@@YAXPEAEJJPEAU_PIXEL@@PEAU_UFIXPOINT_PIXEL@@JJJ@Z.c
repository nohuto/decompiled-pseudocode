/*
 * XREFs of ?DxgkpGetBilinearLineFromSource@@YAXPEAEJJPEAU_PIXEL@@PEAU_UFIXPOINT_PIXEL@@JJJ@Z @ 0x1C01DE0B8
 * Callers:
...
LABEL_21:
          ...
          *((_BYTE *)a4 + 2) = (v19 * *v16 + 0x8000 + v20 * (unsigned int)*v18) >> 16;
...
LABEL_22:
    ...
    {
      *((_DWORD *)v15 + 3) = v27;
      *((_DWORD *)v15 + 2) = v24 * v25[2] + v26 * v10[2];
      *((_DWORD *)v15 + 1) = v24 * v25[1] + v26 * v10[1];
      *(_DWORD *)v15 = v24 * *v25 + v26 * *v10;
      return;
    }
    *((_BYTE *)a4 + 3) = (unsigned int)(v27 + 0x8000) >> 16;
    *((_BYTE *)a4 + 2) = (v24 * v25[2] + 0x8000 + v26 * (unsigned int)v10[2]) >> 16;
    *((_BYTE *)a4 + 1) = (v24 * v25[1] + 0x8000 + v26 * (unsigned int)v10[1]) >> 16;
    v28 = v24 * *v25;
    v29 = v26 * *v10 + 0x8000;
LABEL_50:
  ...
  else
  {
    ...
    do
    {
      ...
      if ( v14 >= a3 )
      {
        v31 -= a3 << 16;
        v14 -= a3;
        v39 = (unsigned __int16)(v31 / a3);
        v40 = v45 - v39;
        v41 = (v45 - v39) * v10[3];
        if ( a4 )
        {
          *((_BYTE *)a4 + 3) = (unsigned int)(v34 + v41 + 0x8000) >> 16;
          *((_BYTE *)a4 + 2) = (v35 + v40 * (unsigned int)v10[2] + 0x8000) >> 16;
          *((_BYTE *)a4 + 1) = (v36 + v40 * (unsigned int)v10[1] + 0x8000) >> 16;
        ...
        {
          *((_DWORD *)v38 + 3) = v34 + v41;
          *((_DWORD *)v38 + 2) = v35 + v40 * v10[2];
          *((_DWORD *)v38 + 1) = v36 + v40 * v10[1];
        ...
        v35 = v39 * v10[2];
        v36 = v39 * v10[1];
        v37 = (unsigned __int16)(v31 / a3) * *v10;
      }
      else
      {
        v34 += v32 * v10[3];
  ...
  if ( v14 )
  {
    ...
    if ( !a4 )
    {
      *((_DWORD *)v38 + 3) = v34 + v43;
      *((_DWORD *)v38 + 2) = v35 + v42 * v10[2];
      *((_DWORD *)v38 + 1) = v36 + v42 * v10[1];
      *(_DWORD *)v38 = v30 + v42 * *v10;
      return;
    }
    *((_BYTE *)a4 + 3) = (unsigned int)(v34 + v43 + 0x8000) >> 16;
    *((_BYTE *)a4 + 2) = (v35 + v42 * (unsigned int)v10[2] + 0x8000) >> 16;
    *((_BYTE *)a4 + 1) = (v36 + v42 * (unsigned int)v10[1] + 0x8000) >> 16;
    v29 = v30 + 0x8000;
    v28 = v42 * *v10;
    goto LABEL_50;
  }
