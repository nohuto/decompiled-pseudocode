/*
 * XREFs of ?CreateDynamicVideoPresentTarget@DMMVIDEOPRESENTTARGETSET@@QEAAJIIAEAU_DXGK_CHILD_CAPABILITIES@@EPEAW4_CONNECTION_CHANGE_FAILURE_REASON@@@Z @ 0x1C0283430
 * Callers:
 ...
 *     ?IsLeafTarget@DMMVIDEOPRESENTTARGET@@QEBAEXZ @ 0x1C004E224 (-IsLeafTarget@DMMVIDEOPRESENTTARGET@@QEBAEXZ.c)
...
LABEL_18:
    ...
    v36 = *(_QWORD **)(v35 + 472);
    v37 = (_QWORD *)((char *)TargetById + 480);
    if ( *v36 == v35 + 464 )
    {
      *v37 = v35 + 464;
      *((_QWORD *)TargetById + 61) = v36;
      *v36 = v37;
      *(_QWORD *)(v35 + 472) = v37;
      *((_QWORD *)TargetById + 64) = v35;
      return 0LL;
    }
    goto LABEL_42;
  }
  ...
  v42 = (DMMVIDEOPRESENTTARGET *)operator new(0x230uLL, 0x4E506456u, PagedPool);
  if ( v42 )
  ...
  if ( v44 )
  {
    ...
    if ( v50 >= 0 )
    {
      ...
      if ( v53 >= 0 )
      {
        ...
        v56 = (struct DMMVIDEOPRESENTTARGET **)*((_QWORD *)TargetById + 54);
        v57 = (DMMVIDEOPRESENTTARGET *)((char *)v44 + 440);
        if ( *v56 == (struct DMMVIDEOPRESENTTARGET *)((char *)TargetById + 424) )
        {
          *(_QWORD *)v57 = (char *)TargetById + 424;
          *((_QWORD *)v44 + 56) = v56;
          *v56 = v57;
          *((_QWORD *)TargetById + 54) = v57;
          *((_QWORD *)v44 + 57) = TargetById;
