/*
 * XREFs of ?QueryNodeMetadata@DXGADAPTER@@QEAAJIPEAU_DXGK_NODEMETADATA@@@Z @ 0x1C01BEC54
 * Callers:
...
__int64 __fastcall DXGADAPTER::QueryNodeMetadata(DXGADAPTER *this, __int64 a2, struct _DXGK_NODEMETADATA *a3)
{
  ...
  v11 = (unsigned __int16 *)(*((_QWORD *)this + 302) + 352LL * v4);
  if ( (unsigned __int16)a2 >= *v11 )
  {
...
LABEL_8:
  ...
  if ( v13 )
  {
    *a3 = *(struct _DXGK_NODEMETADATA *)(74LL * v3 + v13);
    return 0LL;
  }
  else
  {
