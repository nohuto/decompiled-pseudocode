/*
 * XREFs of _lambda_06c7fb13e4115b68176da9e8404c9d66_::operator() @ 0x1C0282F58
 * Callers:
...
unsigned int *__fastcall lambda_06c7fb13e4115b68176da9e8404c9d66_::operator()(unsigned int **a1, int a2)
{
  _DWORD *v2; // r8
  unsigned int *v5; // rax
  __int64 v6; // rcx
  ...
  *v2 = v6 - 1;
  result = a1[2];
  *(_DWORD *)(*(_QWORD *)result + 4LL * (unsigned int)(v6 - 1)) = a2;
  return result;
}
