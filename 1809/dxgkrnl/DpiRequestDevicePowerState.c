/*
 * XREFs of DpiRequestDevicePowerState @ 0x1C0043520
 * Callers:
 ...
 *     DpiSuspendAdapterDpc @ 0x1C0043B10 (DpiSuspendAdapterDpc.c)
 ...
 *     DxgkReportDevicePoweredOn @ 0x1C0031B50 (DxgkReportDevicePoweredOn.c)
 ...
 *     DpiCancelAsyncRequest @ 0x1C0043E70 (DpiCancelAsyncRequest.c)
 *     DpiSendAsyncResumeAdapterRequest @ 0x1C00440E4 (DpiSendAsyncResumeAdapterRequest.c)
 */
...
void __fastcall DpiRequestDevicePowerState(__int64 a1, int a2, int a3)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    McTemplateK0pqq(v7, &Dxgk_DpiRequestDevicePowerState, v8, *(_QWORD *)(v3 + 3792), v5, v4);
  v9 = (KSPIN_LOCK *)(v3 + 3984);
  if ( (_DWORD)v5 == 1 )
  {
    ...
    if ( *(_DWORD *)(v3 + 3888) == 1 && *(_DWORD *)(v3 + 236) != 6 && !*(_DWORD *)(v3 + 4048) )
    {
      v13 = WdLogNewEntry5_WdAssertion(v11);
      *(_QWORD *)(v13 + 24) = 4086LL;
    ...
    {
      _InterlockedAdd((volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v3 + 24) + 64LL) + 3992LL), 1u);
    }
    if ( *(_DWORD *)(v3 + 4048) == 1 )
    {
...
LABEL_27:
        if ( *(_DWORD *)(v3 + 4048) != 6 )
        {
          ...
          DxgkReportDevicePoweredOn(*(_QWORD *)(v3 + 3792));
        }
        goto LABEL_29;
      }
      if ( (_DWORD)v4 == 2 )
  ...
  if ( (_DWORD)v4 == 2 )
    *(_DWORD *)(v3 + 4052) = 1;
  if ( !*(_DWORD *)(v3 + 3992) && ((_DWORD)v4 != 1 || *(_DWORD *)(v3 + 4052)) )
  {
    v21 = *(_DWORD *)(v3 + 4048);
    if ( v21 == 3 )
    {
    ...
    else if ( !v21 )
    {
      ...
      if ( !*(_QWORD *)(v3 + 3896) )
      {
        ...
        *v25 = v24;
        *(_QWORD *)(v3 + 3880) = v24;
        KeSetEvent((PRKEVENT)(v3 + 3840), 0, 0);
      }
    }
  }
  if ( (unsigned int)(*(_DWORD *)(v3 + 4048) - 4) > 1 && *(_DWORD *)(v3 + 236) != 6 )
