/*
 * XREFs of ?Retire@CCompositionFrame@@UEAAXAEBUDXGI_FRAME_STATISTICS@@@Z @ 0x1C0015730
 * Callers:
 *     <none>
 * Callees:
 *     ??_GCLegacyTokenBuffer@@AEAAPEAXI@Z @ 0x1C001AE5C (--_GCLegacyTokenBuffer@@AEAAPEAXI@Z.c)
