/*
 * XREFs of ?DpiDdiGetResourceForBar@@YAJPEAXGGPEAU_CM_PARTIAL_RESOURCE_DESCRIPTOR@@@Z @ 0x1C0049970
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _CM_PARTIAL_RESOURCE_DESCRIPTOR *a4)
{
  ...
  if ( v10 >= 0 )
  {
    ResourceForBar = DxgkDdiGetResourceForBar(*(void **)(v9 + 3792), (__int64)a4);
    v10 = ResourceForBar;
  }
