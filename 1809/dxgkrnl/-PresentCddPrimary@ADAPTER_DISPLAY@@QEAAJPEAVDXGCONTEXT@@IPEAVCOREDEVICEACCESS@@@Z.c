/*
 * XREFs of ?PresentCddPrimary@ADAPTER_DISPLAY@@QEAAJPEAVDXGCONTEXT@@IPEAVCOREDEVICEACCESS@@@Z @ 0x1C01C3E9C
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  _QWORD v27[18]; // [rsp+90h] [rbp-70h] BYREF
...
LABEL_13:
  ...
  if ( CddPrimaryAllocation )
  {
    ...
    v17 = *(_QWORD **)(*((_QWORD *)this + 2) + 2528LL);
    ...
    *(_OWORD *)((char *)&v27[9] + 4) = *(_OWORD *)((char *)&v27[7] + 4);
    ...
    v26[2] = &v24;
    HIDWORD(v26[1]) = 1;
    v19 = (*(__int64 (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)(v17[65] + 8LL) + 824LL))(v17[66], v26);
    v12 = v19;
