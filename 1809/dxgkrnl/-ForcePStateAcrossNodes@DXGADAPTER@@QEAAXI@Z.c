/*
 * XREFs of ?ForcePStateAcrossNodes@DXGADAPTER@@QEAAXI@Z @ 0x1C01BD5EC
 * Callers:
...
void __fastcall DXGADAPTER::ForcePStateAcrossNodes(DXGADAPTER *this, unsigned int a2)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 970); ++i )
    DXGPOWERSTATISTICSTRANSITIONENGINE::ForcePState((KSPIN_LOCK *)(248LL * i + *((_QWORD *)this + 484) + 136LL), a2);
}
