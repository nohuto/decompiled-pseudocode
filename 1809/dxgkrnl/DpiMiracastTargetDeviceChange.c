/*
 * XREFs of DpiMiracastTargetDeviceChange @ 0x1C0046CD0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v15 )
        {
          ...
          *((_QWORD *)Context + 11) = KeGetCurrentThread();
          ...
          if ( *(char **)(*(_QWORD *)Context + 8LL) != Context
            ...
            || (*v24 = v23,
                v23[1] = v24,
                v25 = (char **)qword_1C008EB50,
                *(__int64 **)qword_1C008EB50 != &qword_1C008EB48) )
          {
            __fastfail(3u);
          }
          *(_QWORD *)Context = &qword_1C008EB48;
          *((_QWORD *)Context + 1) = v25;
          *v25 = Context;
          qword_1C008EB50 = (__int64)Context;
