/*
 * XREFs of ?CallCheckMultiPlaneOverlaySupport2DDI@@YAJIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXPEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1C01FBA74
 * Callers:
...
LABEL_7:
  ...
  if ( v9 )
  {
    ...
    do
    {
      a3 = *(const GUID **)((char *)&v7->Data1 + v18);
      *(_QWORD *)(v17 - 12) = *(_QWORD *)&v7->Data1;
      *((_DWORD *)v17 - 1) = a3[1].Data1;
      *(_DWORD *)v17 = a3->Data1;
      *(_OWORD *)(v17 + 8) = *(_OWORD *)(*(_QWORD *)a3[1].Data4 + 4LL);
      *(_OWORD *)(v17 + 24) = *(_OWORD *)(*(_QWORD *)a3[1].Data4 + 20LL);
      *(_OWORD *)(v17 + 40) = *(_OWORD *)(*(_QWORD *)a3[1].Data4 + 36LL);
      *((_DWORD *)v17 + 14) = *(_DWORD *)(*(_QWORD *)a3[1].Data4 + 52LL);
      *((_DWORD *)v17 + 17) = *(_DWORD *)(*(_QWORD *)a3[1].Data4 + 72LL);
      *((_DWORD *)v17 + 1) ^= (*((_DWORD *)v17 + 1) ^ **(_DWORD **)a3[1].Data4) & 1;
      *((_DWORD *)v17 + 1) ^= ((unsigned __int8)*((_DWORD *)v17 + 1) ^ (unsigned __int8)**(_DWORD **)a3[1].Data4) & 2;
      *((_DWORD *)v17 + 15) ^= (*((_DWORD *)v17 + 15) ^ *(_DWORD *)(*(_QWORD *)a3[1].Data4 + 56LL)) & 1;
      if ( *(_DWORD *)(*(_QWORD *)a3[1].Data4 + 76LL) == 1 )
      {
        *((_DWORD *)v17 + 22) = 1;
      }
      else if ( *(_DWORD *)(*(_QWORD *)a3[1].Data4 + 76LL) == 2 )
      {
        *((_DWORD *)v17 + 22) = 2;
      }
      v7 = (const GUID *)((char *)v7 + 8);
      v17 += 112;
      --v10;
    }
    while ( v10 );
  ...
  *(_QWORD *)&v21.Supported = 0LL;
  v19 = ADAPTER_DISPLAY::DdiCheckMultiPlaneOverlaySupport2(a4, &v21, a3);
  if ( v19 >= 0 )
  {
    *a5 = v21.Supported;
