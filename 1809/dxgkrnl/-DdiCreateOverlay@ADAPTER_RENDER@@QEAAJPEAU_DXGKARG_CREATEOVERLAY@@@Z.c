/*
 * XREFs of ?DdiCreateOverlay@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEOVERLAY@@@Z @ 0x1C01C9D98
 * Callers:
        ...
        const GUID *a3)
{
  ...
  if ( (*(_BYTE *)(&DxgkControlGuid_Context + 2) & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5032);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5032);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEOVERLAY *))(*((_QWORD *)this + 2) + 576LL))(
  ...
  v20[3] = v14;
  v20[4] = a2->OverlayInfo.hAllocation;
  v20[5] = a2->hOverlay;
