/*
 * XREFs of DxgkPowerRuntimeControlRequestCB @ 0x1C00388D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    McTemplateK0pj(v12, &Dxgk_PowerRuntimeControlRequestCB, v13, DxgAdapter, a2);
  if ( v14 && *(_BYTE *)(v14 + 3001) )
  {
    v15 = PoFxPowerControl(*(_QWORD *)(v14 + 2568), a2, a3, a4, a5, a6, a7);
  }
  else
  {
