/*
 * XREFs of McTemplateK0juhbr2 @ 0x1C003A288
 * Callers:
 *     DxgLogEtwEventCb @ 0x1C003A200 (DxgLogEtwEventCb.c)
 * Callees:
 *     McGenEventWrite @ 0x1C00130CC (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C0020760 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0juhbr2(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        __int64 a7)
{
  ...
  v12 = 1LL;
  v14 = 2LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventExternalEvent, a3, 5u, &EventData);
}
