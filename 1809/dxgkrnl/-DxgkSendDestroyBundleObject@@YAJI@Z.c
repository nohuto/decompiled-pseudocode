/*
 * XREFs of ?DxgkSendDestroyBundleObject@@YAJI@Z @ 0x1C022F580
 * Callers:
...
__int64 __fastcall DxgkSendDestroyBundleObject(unsigned int a1)
{
  __int64 v2; // rdi
  __int64 v3; // rcx
...
LABEL_15:
    ...
    {
      v16 = DXGSESSIONDATA::VailSendDestroyBundleObject(SessionDataForSpecifiedSession, a1);
      v2 = v16;
      if ( v16 < 0 )
        goto LABEL_15;
    }
