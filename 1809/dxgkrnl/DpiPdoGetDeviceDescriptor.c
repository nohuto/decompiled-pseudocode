/*
 * XREFs of DpiPdoGetDeviceDescriptor @ 0x1C0275A2C
 * Callers:
 ...
 *     DpiPdoPollChild @ 0x1C0276E9C (DpiPdoPollChild.c)
 */
...
LABEL_35:
      KeWaitForSingleObject((PVOID)(v8 + 3336), Executive, 0, 0, 0LL);
      a2[15] = 0;
      KeReleaseMutex((PRKMUTEX)(v8 + 3336), 0);
      goto LABEL_36;
    }
...
LABEL_31:
  ...
  *(_QWORD *)(v27 + 24) = *(_QWORD *)(v13 + 216);
  ...
  if ( a6 == 1 && (unsigned int)a2[15] < 3 )
  {
    ...
    if ( !*((_BYTE *)a2 + 64) )
    {
      _InterlockedAdd((volatile signed __int32 *)(v8 + 3584), 1u);
      *((_BYTE *)a2 + 64) = 1;
    }
    KeReleaseMutex((PRKMUTEX)(v8 + 3336), 0);
    LOBYTE(v28) = a4;
