/*
 * XREFs of ?RemoveListObjectFromSharedPowerList@DXGGLOBAL@@QEAAXPEAVDXGSHAREDPOWERREGISTRATIONOBJECT@@@Z @ 0x1C003BE54
 * Callers:
        ...
        struct DXGSHAREDPOWERREGISTRATIONOBJECT ***a2)
{
  ...
  KeAcquireInStackQueuedSpinLock(this + 175, &LockHandle);
  v3 = *a2;
