/*
 * XREFs of ?SaveTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEBVCCD_TOPOLOGY@@_N@Z @ 0x1C0131A70
 * Callers:
 *     _anonymous_namespace_::_SaveTopologySetCallback @ 0x1C0131A40 (_anonymous_namespace_--_SaveTopologySetCallback.c)
 * Callees:
 ...
 *     _CcdWriteRegistryValues @ 0x1C0131E34 (_CcdWriteRegistryValues.c)
 *     ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x1C0131F64 (-TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ.c)
 */
...
LABEL_45:
      ...
      {
        v41 = *(_DWORD *)(v20 + 132);
        *((_DWORD *)DXGGLOBAL::GetGlobal(v38) + 254) = v41;
      }
      if ( ++v10 >= v8[16] )
        goto LABEL_31;
    }
