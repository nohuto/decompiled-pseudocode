/*
 * XREFs of ?DestroySyncObject@DXGGLOBAL@@QEAAXPEAVDXGSYNCOBJECT@@I@Z @ 0x1C00DC96C
 * Callers:
...
void __fastcall DXGGLOBAL::DestroySyncObject(PERESOURCE *this, struct DXGSYNCOBJECT *a2, unsigned int a3)
{
  ...
  char *v20; // rdx
  __int64 v21; // rax
  PERESOURCE *v22; // [rsp+50h] [rbp-20h] BYREF
  ...
  {
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v24, (struct DXGSYNCOBJECT *)((char *)a2 + 32), 0);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v24);
    v19 = (struct DXGSYNCOBJECT *)*((_QWORD *)a2 + 33);
    v20 = (char *)v19 - 40;
    if ( v19 == (struct DXGSYNCOBJECT *)((char *)a2 + 264) )
      v20 = 0LL;
    if ( v20 )
    {
      v26 = *((_QWORD *)v20 + 4);
      if ( v26 )
      {
        v21 = *((_QWORD *)v20 + 2);
        v25 = -1LL;
        (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, int, __int64 *, _DWORD, __int64 *))(*(_QWORD *)(*(_QWORD *)(v21 + 520) + 8LL)
                                                                                                  + 640LL))(
          0LL,
          0LL,
          0LL,
