/*
 * XREFs of ?IsTdrAdapterUsedInSessionCallback@CTDR_GDI_RESET_THREAD@@KAEPEAXW4_SESSION_CALLBACK_REASON@@K@Z @ 0x1C0209E60
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CTDR_GDI_RESET_THREAD::IsTdrAdapterUsedInSessionCallback(__int64 a1, int a2, unsigned int a3)
{
  ...
  if ( !SessionDataForSpecifiedSession )
    return 0;
  v8 = *((_QWORD *)SessionDataForSpecifiedSession + 2312);
  v9 = *(_QWORD *)(a1 + 32);
  if ( v9 )
    return v8 == *(_QWORD *)(v9 + 276);
  return v8 != 0;
}
