/*
 * XREFs of DxgDetermineBootImageMode @ 0x1C0155D5C
 * Callers:
...
LABEL_8:
      ...
      else
      {
        ...
        *((_OWORD *)Global + 73) = *(_OWORD *)a1;
        *((_OWORD *)Global + 74) = *(_OWORD *)(a1 + 16);
        v22 = *a2;
        *((_QWORD *)DXGGLOBAL::GetGlobal(v23) + 145) = v22;
        v24 = a2[2];
        *((_QWORD *)DXGGLOBAL::GetGlobal(v25) + 158) = v24;
        *((_DWORD *)DXGGLOBAL::GetGlobal(v26) + 288) = 1;
...
LABEL_12:
        ...
        *(_QWORD *)(v31 + 24) = 5151LL;
      }
      LOBYTE(v15) = WdLogEvent5_WdAssertion(v31);
      goto LABEL_12;
    case 0xFFFFFFFF:
    case 2u:
      v20 = WdLogNewEntry5_WdWarning(v17, v16, v18);
      *(_QWORD *)(v20 + 24) = 5105LL;
...
LABEL_22:
    *(_QWORD *)(v28 + 24) = v29;
    LOBYTE(v15) = WdLogEvent5_WdWarning(v28);
    return v15;
  }
  *((_DWORD *)DXGGLOBAL::GetGlobal(v17) + 288) = 3;
  LOBYTE(v15) = DxgkSetBootAnimationRelayState(1LL);
  return v15;
}
