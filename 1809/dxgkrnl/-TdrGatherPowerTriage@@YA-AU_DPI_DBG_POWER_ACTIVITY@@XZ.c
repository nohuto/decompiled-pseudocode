/*
 * XREFs of ?TdrGatherPowerTriage@@YA?AU_DPI_DBG_POWER_ACTIVITY@@XZ @ 0x1C003A8D0
 * Callers:
...
__int64 __fastcall TdrGatherPowerTriage(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    v7 = v6[24];
    v5 = (_QWORD *)*v5;
    if ( v7 && *(_DWORD *)(*(_QWORD *)(v7 + 64) + 4184LL) )
    {
      if ( (v2 & 1) != 0 || (v8 = 0, v6[317]) )
        v8 = 1;
      v9 = v8 | v2 & 0xFE;
      if ( (v9 & 2) != 0 || (v10 = 0, *((_DWORD *)v6 + 1064)) )
        v10 = 2;
      v2 = v10 | v9 & 0xFD;
      LOBYTE(v12) = v2;
    }
