/*
 * XREFs of ?_ReadSDRWhiteLevelFromMonitorStore@DXGMONITOR@@AEAAJXZ @ 0x1C02954D4
 * Callers:
...
__int64 __fastcall DXGMONITOR::_ReadSDRWhiteLevelFromMonitorStore(DXGMONITOR *this)
{
  __int64 result; // rax
  __int64 v3; // rdi
  __int64 v4; // rcx
