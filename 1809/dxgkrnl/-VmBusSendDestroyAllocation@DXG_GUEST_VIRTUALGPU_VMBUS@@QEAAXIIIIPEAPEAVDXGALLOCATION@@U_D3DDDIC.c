/*
 * XREFs of ?VmBusSendDestroyAllocation@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAXIIIIPEAPEAVDXGALLOCATION@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x1C01F4264
 * Callers:
  ...
  if ( a5 <= 0x8000 )
  {
    ...
    if ( v13 )
    {
      ...
      *((_DWORD *)v13 + 8) = a5;
      ...
      DXG_VMBUS_CHANNEL_BASE::VmBusSendSyncMessage(this, v15, v12, 0LL, 0LL, v21);
      operator delete[](v15);
    }
    else
    {
      v16 = WdLogNewEntry5_WdLowResource(v14);
      *(_QWORD *)(v16 + 24) = 6884LL;
