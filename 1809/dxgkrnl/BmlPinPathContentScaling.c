/*
 * XREFs of BmlPinPathContentScaling @ 0x1C00D67C0
 * Callers:
...
__int64 __fastcall BmlPinPathContentScaling(__int64 a1, __int64 a2, unsigned __int16 a3)
{
  ...
  else
  {
    ...
    {
      if ( (dword_1C0090250 & 1) == 0 )
      {
        v23 = *(VIDPN_MGR **)(a2 + 48);
        dword_1C0090250 |= 1u;
        dword_1C0090208[0] = VIDPN_MGR::GetAdapterDefaultScaling(v23);
        dword_1C009020C = 3;
        dword_1C0090210 = 4;
        dword_1C0090214 = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v24 >= 4 )
          break;
        v10 = dword_1C0090208;
        v11 = (unsigned int)dword_1C0090208[v24];
