/*
 * XREFs of ?GetRequestedPathsModality@@YAJIHPEAU_QDC_CONTEXT@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x1C00C7320
 * Callers:
...
__int64 __fastcall GetRequestedPathsModality(__int64 a1, __int64 a2, GUID *a3, enum DISPLAYCONFIG_TOPOLOGY_ID *a4)
{
  __int64 v5; // rbx
  int v7; // r12d
  int v8; // ebp
  ...
  if ( !*(_DWORD *)&a3->Data2 )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(a1, a2, a3, a4) + 24) = 1218LL;
    return 3221225507LL;
  }
  v8 = a1 & 0x200000;
  if ( (a1 & 0x200000) != 0 )
  {
    ...
    DisplayConfigBufferSizes = DxgkGetDisplayConfigBufferSizes(v16, &v25, a3);
  ...
  if ( v24 )
    ...
    v11 = 0;
  if ( (unsigned int)v11 < *(_DWORD *)&a3->Data2 )
  {
    v22 = WdLogNewEntry5_WdLowResource(v10);
    *(_QWORD *)(v22 + 24) = *(unsigned int *)&a3->Data2;
  ...
  else
  {
    ...
    if ( PathsModality >= 0 )
    {
      LOBYTE(v14) = v8 != 0;
      LOBYTE(v12) = v7 != 0;
      PathsModality = ConvertPathModalityToDisplayConfig(v24, v12, v14, (struct _QDC_CONTEXT *)a3);
      if ( PathsModality >= 0 )
