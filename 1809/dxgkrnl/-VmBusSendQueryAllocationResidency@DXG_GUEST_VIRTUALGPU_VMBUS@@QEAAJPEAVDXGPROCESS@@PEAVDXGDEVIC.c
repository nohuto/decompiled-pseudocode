/*
 * XREFs of ?VmBusSendQueryAllocationResidency@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGDEVICE@@EPEAU_D3DKMT_QUERYALLOCATIONRESIDENCY@@@Z @ 0x1C01F5890
 * Callers:
...
LABEL_3:
  ...
  if ( (_DWORD)AllocationCount )
  {
    if ( (unsigned __int64)(4 * AllocationCount) > 0xFFFFFFFF )
    {
      ...
      *(_QWORD *)(v10 + 24) = 7309LL;
      goto LABEL_3;
    }
    v12 = 4 * AllocationCount;
    if ( v12 >= 0xFFFFFFC8 )
    {
      v10 = WdLogNewEntry5_WdError((unsigned int)(4 * AllocationCount));
      *(_QWORD *)(v10 + 24) = 7314LL;
      goto LABEL_3;
    }
    v8 = v12 + 56;
  }
...
LABEL_22:
    ...
    else
    {
      for ( i = 0LL; (unsigned int)i < v7->AllocationCount; i = (unsigned int)(i + 1) )
      {
        ...
        {
          v30 = WdLogNewEntry5_WdError(Count_low);
          *(_QWORD *)(v30 + 24) = 7385LL;
    ...
    Count = DXG_VMBUS_CHANNEL_BASE::VmBusSendSyncMessage(
              this,
              (struct DXGKVMB_COMMAND_BASE *)v15,
              v8,
              v21,
              (unsigned int *)&a5,
              v36);
