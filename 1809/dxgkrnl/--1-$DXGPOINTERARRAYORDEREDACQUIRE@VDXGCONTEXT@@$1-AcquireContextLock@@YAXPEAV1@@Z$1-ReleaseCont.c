/*
 * XREFs of ??1?$DXGPOINTERARRAYORDEREDACQUIRE@VDXGCONTEXT@@$1?AcquireContextLock@@YAXPEAV1@@Z$1?ReleaseContextLock@@YAX0@Z$03@@QEAA@XZ @ 0x1C00193BC
 * Callers:
  ...
  if ( v2 )
  {
    if ( !*(_BYTE *)(a1 + 48) )
    {
      ...
      if ( *(_DWORD *)(a1 + 40) )
      {
        do
        {
          v4 = *(_QWORD *)(*(_QWORD *)a1 + 8 * v3) + 440LL;
          *(_QWORD *)(v4 + 8) = 0LL;
