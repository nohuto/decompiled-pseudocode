/*
 * XREFs of MonitorCreateMonitorManager @ 0x1C0154260
 * Callers:
 ...
 *     ?_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ @ 0x1C01542FC (-_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ.c)
 */
...
__int64 __fastcall MonitorCreateMonitorManager(struct ADAPTER_DISPLAY *a1, MONITOR_MGR **a2, __int64 a3, __int64 a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v7 )
    v9 = MONITOR_MGR::MONITOR_MGR(v7, a1);
  else
    v9 = 0LL;
  if ( !v9 )
  {
