/*
 * XREFs of ?DxgkSetProcessStatus@@YAXPEAU_D3DKMT_PROCESS_STATUS_INTERNAL@@@Z @ 0x1C012D610
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkSetProcessStatus(struct _D3DKMT_PROCESS_STATUS_INTERNAL *a1)
{
  ...
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)a1) + 332)
    && _InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal(v2) + 331, 1, 1) )
  {
    return;
  }
  v3 = *(_QWORD *)a1;
