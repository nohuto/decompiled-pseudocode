/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C00E1A90
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v29, 7049);
  ...
  *(_QWORD *)(v9 + 32) = this;
  ...
  if ( v11 )
  {
    ...
    if ( v12 )
    {
      ...
      if ( v15 == v11 )
      {
        DMMVIDPNTARGET::ReleaseModeSet((struct DMMVIDPNTARGETMODESET **)v13, (struct DMMVIDPNTARGETMODESET *)v12);
        v16 = 0;
      }
      else
      {
