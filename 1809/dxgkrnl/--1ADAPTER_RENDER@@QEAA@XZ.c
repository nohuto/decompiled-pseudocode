/*
 * XREFs of ??1ADAPTER_RENDER@@QEAA@XZ @ 0x1C01C5C88
 * Callers:
 ...
 *     ??1?$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ @ 0x1C0031594 (--1-$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ.c)
