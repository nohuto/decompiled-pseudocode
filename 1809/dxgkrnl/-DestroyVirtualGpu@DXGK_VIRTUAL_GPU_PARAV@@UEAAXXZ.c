/*
 * XREFs of ?DestroyVirtualGpu@DXGK_VIRTUAL_GPU_PARAV@@UEAAXXZ @ 0x1C01E5E70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DXGK_VIRTUAL_GPU_PARAV::DestroyVirtualGpu(DXGPROCESS **this)
{
  ...
  if ( v2 )
  {
    ...
    if ( v3 )
    {
      DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v8, (struct _KTHREAD **)v3 + 8);
