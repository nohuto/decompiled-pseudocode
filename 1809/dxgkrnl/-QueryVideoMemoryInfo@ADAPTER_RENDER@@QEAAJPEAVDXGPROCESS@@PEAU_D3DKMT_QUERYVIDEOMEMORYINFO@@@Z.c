/*
 * XREFs of ?QueryVideoMemoryInfo@ADAPTER_RENDER@@QEAAJPEAVDXGPROCESS@@PEAU_D3DKMT_QUERYVIDEOMEMORYINFO@@@Z @ 0x1C00B34B0
 * Callers:
        ...
        struct _D3DKMT_QUERYVIDEOMEMORYINFO *a3)
{
  ...
  return (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD, UINT64 *, UINT64 *, UINT64 *, UINT64 *))(*(_QWORD *)(v4 + 8) + 1040LL))(
           v3,
           v6,
