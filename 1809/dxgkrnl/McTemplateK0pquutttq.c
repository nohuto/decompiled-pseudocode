/*
 * XREFs of McTemplateK0pquutttq @ 0x1C003141C
 * Callers:
...
ULONG McTemplateK0pquutttq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventInvalidateModeCache, a3, 9u, &EventData);
}
