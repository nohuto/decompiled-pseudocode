/*
 * XREFs of ?DmmInitializeAdapter@@YAJQEAX@Z @ 0x1C0147284
 * Callers:
...
__int64 __fastcall DmmInitializeAdapter(DXGADAPTER *this)
{
  ...
  if ( v5 )
  {
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v33, *(_QWORD *)(v4 + 88));
    v6 = 0LL;
    v7 = (*((_DWORD *)this + 77) & 0x8000) == 0;
    v30 = 0LL;
    *(_QWORD *)&v34[0].0 = 0LL;
    v35 = 0;
    if ( !v7 )
      ...
      if ( v6 )
      {
        ...
        if ( *(_QWORD *)(v6 + 136) == 1LL )
        {
                 ...
                 (enum _D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE)v34[0].Value) )
          {
            ...
            DxgkLogCodePointPacket(0x59u, *(_DWORD *)(v21 + 24), v35, 1u, *(_QWORD *)((char *)this + 276));
          }
          else
          {
