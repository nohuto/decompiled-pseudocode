/*
 * XREFs of ?DdiResetVirtualFunction@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETVIRTUALFUNCTION@@@Z @ 0x1C01E44F8
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 5093);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RESETVIRTUALFUNCTION *))(*(_QWORD *)(*((_QWORD *)this + 2) + 928LL)
                                                                              + 88LL))(
