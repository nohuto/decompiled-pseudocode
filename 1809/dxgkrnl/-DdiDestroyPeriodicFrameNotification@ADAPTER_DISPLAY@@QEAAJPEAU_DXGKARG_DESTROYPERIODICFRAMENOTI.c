/*
 * XREFs of ?DdiDestroyPeriodicFrameNotification@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_DESTROYPERIODICFRAMENOTIFICATION@@@Z @ 0x1C01CAC60
 * Callers:
 *     ?ADAPTER_DISPLAY_DdiDestroyPeriodicFrameNotification@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_DESTROYPERIODICFRAMENOTIFICATION@@@Z @ 0x1C00377E0 (-ADAPTER_DISPLAY_DdiDestroyPeriodicFrameNotification@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_DESTR.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5075);
  DXGADAPTER::AcquireDdiSync(*((_QWORD *)this + 2), 1);
  v5 = *(void **)(*((_QWORD *)this + 2) + 248LL);
  a2->hAdapter = v5;
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(struct _DXGKARG_DESTROYPERIODICFRAMENOTIFICATION *))(*((_QWORD *)this + 2) + 1056LL))(a2);
  if ( v31[0] )
  ...
  v22 = WdLogNewEntry5_WdTrace(v17, v13, v15, v16);
  *(_QWORD *)(v22 + 24) = v14;
  hNotification = a2->hNotification;
  *(_QWORD *)(v22 + 32) = a2->hNotification;
