/*
 * XREFs of ?_ParseMonitorDescriptors@CCD_SET_STRING_ID@@AEAAXXZ @ 0x1C00CBC90
 * Callers:
 *     ??0CCD_SET_STRING_ID@@QEAA@AEBU_STRING@@@Z @ 0x1C00CB808 (--0CCD_SET_STRING_ID@@QEAA@AEBU_STRING@@@Z.c)
 ...
 *     ?_CompareDescriptors@CCD_SET_STRING_ID@@AEBAHII@Z @ 0x1C028D3A8 (-_CompareDescriptors@CCD_SET_STRING_ID@@AEBAHII@Z.c)
 */
