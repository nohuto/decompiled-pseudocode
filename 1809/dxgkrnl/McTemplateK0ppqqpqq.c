/*
 * XREFs of McTemplateK0ppqqpqq @ 0x1C002260C
 * Callers:
...
ULONG McTemplateK0ppqqpqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, (LPCGUID)4, 8u, &EventData);
}
