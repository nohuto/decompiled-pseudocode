/*
 * XREFs of ?VmBusDestroyPagingQueue@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C01EED00
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDestroyPagingQueue(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  D3DDDI_DESTROYPAGINGQUEUE v11; // [rsp+50h] [rbp+8h] BYREF
  ...
  if ( *(_BYTE *)(*((_QWORD *)a1 + 5) + 157LL) )
  {
    ...
    {
      v11.hPagingQueue = 0;
      v11.hPagingQueue = *(_DWORD *)(v5 + 24);
      v7 = DxgkDestroyPagingQueueInternal(&v11, 0, v6);
