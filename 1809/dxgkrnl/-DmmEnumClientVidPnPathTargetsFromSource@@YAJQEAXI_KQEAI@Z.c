/*
 * XREFs of ?DmmEnumClientVidPnPathTargetsFromSource@@YAJQEAXI_KQEAI@Z @ 0x1C00E550C
 * Callers:
...
LABEL_15:
  ...
  if ( v10 )
  {
    ...
    if ( v15 )
    {
      ...
      {
        v17 = v16 + 96;
        v18 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource((DMMVIDPNTOPOLOGY *)(v16 + 96), v4, a3, &v30);
        v7 = (DXGADAPTER *)v18;
        if ( v18 >= 0 )
        {
