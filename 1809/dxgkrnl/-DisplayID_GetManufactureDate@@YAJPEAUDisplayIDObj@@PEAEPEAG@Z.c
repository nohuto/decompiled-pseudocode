/*
 * XREFs of ?DisplayID_GetManufactureDate@@YAJPEAUDisplayIDObj@@PEAEPEAG@Z @ 0x1C0050164
 * Callers:
...
__int64 __fastcall DisplayID_GetManufactureDate(struct DisplayIDObj *a1, unsigned __int8 *a2, unsigned __int16 *a3)
{
  __int64 result; // rax
  __int64 v4; // rdx
  _WORD *v5; // r10
