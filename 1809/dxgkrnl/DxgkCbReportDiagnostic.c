/*
 * XREFs of DxgkCbReportDiagnostic @ 0x1C0041F60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( (*(_DWORD *)(DxgAdapter + 4LL * v4 + 4280) & *(_DWORD *)(DxgAdapter + 4LL * v4 + 4288) & (unsigned int)v9) == 0 )
  {
    v10 = (_QWORD *)WdLogNewEntry5_WdWarning(v4, v9, DxgAdapter);
    v10[3] = *a2;
    v10[4] = a2[1];
    v10[5] = 8LL;
