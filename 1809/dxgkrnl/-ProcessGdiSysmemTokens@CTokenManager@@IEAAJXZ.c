/*
 * XREFs of ?ProcessGdiSysmemTokens@CTokenManager@@IEAAJXZ @ 0x1C001E0F0
 * Callers:
 ...
 *     ?EnsureCurrentLegacyTokenBuffer@CTokenManager@@IEAAJXZ @ 0x1C001E244 (-EnsureCurrentLegacyTokenBuffer@CTokenManager@@IEAAJXZ.c)
...
__int64 __fastcall CTokenManager::ProcessGdiSysmemTokens(CLegacyTokenBuffer **this)
{
  ...
  if ( CurrentBufferPointer >= 0 )
  {
    ...
    if ( CurrentBufferPointer >= 0 )
    {
      ...
      v5 = (*(__int64 (__fastcall **)(_QWORD, int *, unsigned __int8 *))(*((_QWORD *)Global + 2541) + 120LL))(
             (unsigned int)PreviousState,
             &v10,
             v12);
      v6 = this[23];
