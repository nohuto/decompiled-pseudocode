/*
 * XREFs of ?CreateProtectedOutputIndirectDisplay@@YAJPEAU_FDO_CONTEXT@@0W4_DXGKMDT_OPM_VIDEO_OUTPUT_SEMANTICS@@IPEAPEAX2@Z @ 0x1C004A5B4
 * Callers:
...
LABEL_5:
  ...
  RedirectionInfo = v12;
  if ( v12 < 0
    || (RedirectionInfo = (int)DxgkOpmGetRedirectionInfo(*((void **)a2 + 474), v9, &v21, v22),
...
LABEL_4:
  ...
  if ( v16 < 0 )
    goto LABEL_4;
  DxgkAcquireAdapterOpmI2CSync(*((_QWORD *)a1 + 474));
  DxgkAcquireAdapterDdiSync(*((_QWORD *)a1 + 474), 1LL);
  v17 = *((_DWORD *)a1 + 736);
  if ( v17 == 2 )
  {
    v18 = (*((__int64 (__fastcall **)(_QWORD, _QWORD, unsigned __int64, _BYTE *, _DWORD, void **))a1 + 383))(
            *((_QWORD *)a1 + 6),
            v6,
            v21,
            v22,
  ...
  else
  {
    ...
    v18 = (*((__int64 (__fastcall **)(_QWORD, _QWORD, unsigned __int64, _BYTE *, __int64, int, void **))a1 + 382))(
            *((_QWORD *)a1 + 6),
            v6,
            v21,
            v22,
...
LABEL_16:
  ...
  {
    LODWORD(RedirectionInfo) = DxgkOpmCreateHandle(*((DXGADAPTER **)a1 + 474), v20, a5);
    if ( (int)RedirectionInfo < 0 )
      (*((void (__fastcall **)(_QWORD, void *))a1 + 381))(*((_QWORD *)a1 + 6), v20);
    else
      *a6 = v20;
  }
  DxgkReleaseAdapterDdiSync(*((_QWORD *)a1 + 474));
  DxgkReleaseAdapterOpmI2CSync(*((_QWORD *)a1 + 474));
