/*
 * XREFs of ?DpiBrightnessIfSetBacklightOptimization@@YAJPEAXW4DXGK_BACKLIGHT_OPTIMIZATION_LEVEL@@@Z @ 0x1C026C360
 * Callers:
 *     <none>
 * Callees:
        ...
        enum DXGK_BACKLIGHT_OPTIMIZATION_LEVEL a2)
{
  ...
  v3 = 0LL;
  if ( *((_WORD *)DeviceExtension + 2321) == 2 )
    v3 = DeviceExtension + 4640;
  if ( !v3 )
    return 3221225659LL;
  v7 = -1073741661;
