/*
 * XREFs of McTemplateK0pqqqqqqqqqqqqqqq @ 0x1C004E000
 * Callers:
...
ULONG McTemplateK0pqqqqqqqqqqqqqqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v34 = 4LL;
  v36 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &SetTimingsFromVidPn, a3, 0x11u, &EventData);
}
