/*
 * XREFs of ?UpdateDodFrontBuffer@DXGDEVICE@@QEAAJPEAVDXGALLOCATION@@@Z @ 0x1C021A774
 * Callers:
...
LABEL_12:
  ...
  if ( *(_QWORD *)&v32.Width == __PAIR64__(v21.m128i_u32[1], (unsigned int)DisplayModeInfo)
    && (v32.Rotation == -1 || v32.Rotation == HIDWORD(v35)) )
  {
    v20 = 22LL;
...
LABEL_34:
            ...
            v28 = *(_QWORD *)(*((_QWORD *)this[216] + 315) + 264LL);
