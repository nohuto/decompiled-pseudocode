/*
 * XREFs of ?ConsumerBeginProcessPresent@CFlipManager@@QEAAJPEAI0@Z @ 0x1C0059A38
 * Callers:
 ...
 *     ??2?$DXGQUOTAALLOCATOR@$00$0HFHAEDEG@@@SAPEAX_K@Z @ 0x1C00596B8 (--2-$DXGQUOTAALLOCATOR@$00$0HFHAEDEG@@@SAPEAX_K@Z.c)
...
__int64 __fastcall CFlipManager::ConsumerBeginProcessPresent(CFlipManager *this, unsigned int *a2, unsigned int *a3)
{
  ...
  v3 = 0;
  v7 = 0LL;
  if ( *(_OWORD *)((char *)this + 216) != 0LL
    || (v8 = (_QWORD *)((char *)this + 136), v9 = (_QWORD *)*((_QWORD *)this + 17), v9 == v8) )
  {
    v11 = -1073741823;
  }
  else
  {
    ...
    *((_QWORD *)this + 27) = v10;
    v11 = CEndpointResourceStateManager::ApplyIncrementalUpdate((CFlipManager *)((char *)this + 96), v10);
    if ( v11 >= 0 )
    {
      CFlipObjectQueue<CFlipPresentUpdate>::Dequeue(v8);
      if ( (_QWORD *)*v8 == v8 )
        KeResetEvent(*((PRKEVENT *)this + 29));
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v11 >= 0 )
      {
        CFlipPresentUpdate::SetFlipPropertySet(
          ...
          *(struct CFlipPropertySet **)(*((_QWORD *)this + 27) + 56LL));
        *((_QWORD *)this + 28) = v7;
        *a2 = *((_DWORD *)v7 + 10);
        v15 = *(_QWORD *)(*((_QWORD *)this + 28) + 56LL);
        if ( v15 )
          v3 = *(_DWORD *)(v15 + 32);
        *a3 = v3;
