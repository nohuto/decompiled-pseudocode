/*
 * XREFs of DxgkFlushHeapTransitions @ 0x1C01300A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkFlushHeapTransitions(unsigned int *a1)
{
  ...
  DXGADAPTERBYHANDLE::DXGADAPTERBYHANDLE((DXGADAPTERBYHANDLE *)&v14, v1, Current, &v18, 1);
  v9 = v18;
  if ( !v18 )
  {
  ...
  if ( *((_DWORD *)v9 + 44) == 1 )
  {
    ...
    {
      if ( *((_BYTE *)v18 + 185) )
        DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendFlushHeapTransitions((struct DXGADAPTER *)((char *)v18 + 4152));
      else
        (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(v10 + 544) + 8LL) + 1088LL))(*(_QWORD *)(v10 + 552));
    }
  }
  if ( v17 )
