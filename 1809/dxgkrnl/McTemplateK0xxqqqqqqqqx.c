/*
 * XREFs of McTemplateK0xxqqqqqqqqx @ 0x1C0013614
 * Callers:
...
ULONG McTemplateK0xxqqqqqqqqx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v24 = 4LL;
  v26 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &DMM_SnapPerfCounters, a3, 0xCu, &EventData);
}
