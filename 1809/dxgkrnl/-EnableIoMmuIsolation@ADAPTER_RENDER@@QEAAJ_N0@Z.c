/*
 * XREFs of ?EnableIoMmuIsolation@ADAPTER_RENDER@@QEAAJ_N0@Z @ 0x1C01C646C
 * Callers:
...
LABEL_22:
      ...
      if ( a2 )
      {
        ...
        if ( v15 < 0 )
          goto LABEL_6;
        v16 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 68) + 8LL) + 1208LL))(*((_QWORD *)this + 69));
        v12 = v16;
        if ( v16 < 0 )
          goto LABEL_6;
        if ( a3 )
        {
          ...
          if ( *(_DWORD *)(v17 + 256) )
          {
            while ( 1 )
            {
              v19 = *(_QWORD *)(352LL * v18 + *(_QWORD *)(v17 + 2416) + 8);
              IoMmuContextFromDevice = DpiGetIoMmuContextFromDevice(v19);
              v21 = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD, __int64))qword_1C008EC50)(
            ...
            if ( v18 )
            {
              ...
              do
              {
                DpiDetachIoMmuDomain(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 2416LL) + v25 + 8));
                v25 += 352LL;
                --v26;
              }
              while ( v26 );
