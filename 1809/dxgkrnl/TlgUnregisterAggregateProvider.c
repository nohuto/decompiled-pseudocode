/*
 * XREFs of TlgUnregisterAggregateProvider @ 0x1C029E794
 * Callers:
...
void TlgUnregisterAggregateProvider()
{
  ...
  if ( (void (__fastcall *)(LPCGUID, __int64, __int64, ULONGLONG, ULONGLONG, PEVENT_FILTER_DESCRIPTOR, _QWORD *))qword_1C008D860 == TlgAggregateInternalRegisteredProviderEtwCallback )
  {
    v0 = 0LL;
    ...
    {
      v3 = (__int64 *)(v1 + 352);
      if ( *(_UNKNOWN **)(v1 + 344) == &dword_1C008D838 )
      {
        v0 = (_QWORD *)v1;
        *v2 = *v3;
