/*
 * XREFs of DpiFdoDispatchInternalIoctl @ 0x1C015B900
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0022E60 (_guard_dispatch_icall_nop.c)
 *     DpiSharedPowerRegister @ 0x1C0267E2C (DpiSharedPowerRegister.c)
 */
...
LABEL_29:
  ...
  if ( (unsigned int)v9 < 0x10 || !v10 )
    goto LABEL_29;
  Mutex = (PRKMUTEX)(v4 + 3480);
  KeWaitForSingleObject((PVOID)(v4 + 3480), Executive, 0, 0, 0LL);
  v6 = 0;
  v20 = *(_QWORD *)(v10 + 8);
  v21 = *(PRKMUTEX *)v10;
  for ( i = 0; i < *(_DWORD *)(v4 + 2612); ++i )
  {
