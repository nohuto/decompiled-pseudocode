/*
 * XREFs of ?InitializeSwapchainGlobalState@DXGSWAPCHAIN@@QEAAJPEAVADAPTER_RENDER@@PEAU_D3DKMT_CREATESWAPCHAIN@@@Z @ 0x1C0250AA0
 * Callers:
  ...
  *((_QWORD *)this + 27) = v12;
  ...
  if ( v14 >= 0 )
  {
    *((_QWORD *)this + 24) = *(_QWORD *)(*((_QWORD *)a2 + 2) + 276LL);
    v19 = *(unsigned int *)(*((_QWORD *)a2 + 2) + 308LL);
    if ( (v19 & 0x10) != 0 )
      *((_DWORD *)this + 47) = 1;
    v20 = WdLogNewEntry5_WdEvent(v19, v15);
    *(_QWORD *)(v20 + 24) = this;
    *(_QWORD *)(v20 + 32) = DXGPROCESS::GetCurrent();
