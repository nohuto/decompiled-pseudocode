/*
 * XREFs of ?GetSetMetaData@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_GETSETSWAPCHAINMETADATA@@IPEAXD@Z @ 0x1C0250818
 * Callers:
...
LABEL_19:
        ...
        {
          if ( !a2->pBuffer || (Microsoft_Windows_DxgKrnlEnableBits & 0x8000000) == 0 )
            return v24;
        ...
        McTemplateK0pqddqqqqq(v19, v25, v20, this, v29, Src, v32, v33, HIDWORD(v38), v39, HIDWORD(v39), v40, v34);
        return v24;
      }
    }
    else
