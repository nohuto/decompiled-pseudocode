/*
 * XREFs of DxgkPresentMultiPlaneOverlay2 @ 0x1C024DCA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay2(struct _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 *a1)
{
  ...
  struct _D3DKMT_MULTIPLANE_OVERLAY2 *v76; // [rsp+B0h] [rbp-50h] BYREF
  ...
  _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 v88; // [rsp+190h] [rbp+90h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v78, 2163);
  ...
  v76 = 0LL;
  v77 = 0LL;
  v68 = CapturePresentMultiPlaneOverlayArgs2(a1, &v88, &v76, &v77);
  if ( v68 < 0 )
  {
