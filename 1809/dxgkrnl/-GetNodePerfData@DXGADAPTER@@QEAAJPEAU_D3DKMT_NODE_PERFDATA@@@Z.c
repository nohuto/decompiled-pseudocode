/*
 * XREFs of ?GetNodePerfData@DXGADAPTER@@QEAAJPEAU_D3DKMT_NODE_PERFDATA@@@Z @ 0x1C01BD910
 * Callers:
...
__int64 __fastcall DXGADAPTER::GetNodePerfData(DXGADAPTER *this, struct _D3DKMT_NODE_PERFDATA *a2, __int64 a3)
{
  ...
  if ( a2
    ...
    && (NodeOrdinal = a2->NodeOrdinal,
        v7 = (unsigned __int16 *)(*((_QWORD *)this + 302) + 352 * PhysicalAdapterIndex),
        (unsigned int)NodeOrdinal < *v7) )
  {
    ...
    else
    {
      ...
      v12 = DXGADAPTER::DdiQueryAdapterInfo(this, &v20, v11);
      v16 = v12;
      if ( v12 < 0 )
      {
      ...
      {
        *(LARGE_INTEGER *)(*((_QWORD *)v7 + 15) + 8 * NodeOrdinal) = v10;
      }
    }
    if ( (int)v16 >= 0 )
    {
