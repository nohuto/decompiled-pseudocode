/*
 * XREFs of ?PrepareIncrementalUpdateForStateManager@CEndpointResourceStateManager@@QEAAJPEAVCFlipPresentUpdate@@PEA_N@Z @ 0x1C005B67C
 * Callers:
...
__int64 __fastcall CEndpointResourceStateManager::PrepareIncrementalUpdateForStateManager(
        ...
        bool *a3)
{
  CEndpointResourceStateManager *v3; // rbx
  signed int v6; // edi
  int v7; // r8d
  __int64 v8; // rsi
  signed int v9; // eax
