/*
 * XREFs of ?CreatePagingQueue@DXGDEVICE@@QEAAJIW4D3DDDI_PAGINGQUEUE_PRIORITY@@PEAPEAVDXGPAGINGQUEUE@@@Z @ 0x1C00E7998
 * Callers:
        ...
        struct DXGPAGINGQUEUE **a4)
{
  ...
  if ( !*((_DWORD *)this + 18) && !ExIsResourceAcquiredExclusiveLite(*((PERESOURCE *)this + 13)) )
  {
    ...
    *(_QWORD *)(v20 + 24) = 7502LL;
    WdLogEvent5_WdAssertion(v20);
  }
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(*(DXGADAPTER **)(*((_QWORD *)this + 2) + 16LL)) )
  {
    v21 = WdLogNewEntry5_WdAssertion(v9);
    *(_QWORD *)(v21 + 24) = 7503LL;
    WdLogEvent5_WdAssertion(v21);
  }
  if ( !a4 )
  {
    v22 = WdLogNewEntry5_WdAssertion(v9);
    *(_QWORD *)(v22 + 24) = 7504LL;
    WdLogEvent5_WdAssertion(v22);
  }
  PoolWithQuotaTag = ExAllocatePoolWithQuotaTag((POOL_TYPE)9, 0x50uLL, 0x4B677844u);
  if ( PoolWithQuotaTag )
  {
    v12 = 0LL;
    ...
    *((_DWORD *)PoolWithQuotaTag + 12) = 0;
    PoolWithQuotaTag[7] = 0LL;
    PoolWithQuotaTag[8] = 1LL;
    *((_BYTE *)PoolWithQuotaTag + 72) = 0;
  }
  *a4 = (struct DXGPAGINGQUEUE *)PoolWithQuotaTag;
  if ( PoolWithQuotaTag )
  {
    LODWORD(v14) = DXGPAGINGQUEUE::Initialize((DXGPAGINGQUEUE *)PoolWithQuotaTag, a2, a3);
    if ( (int)v14 >= 0 )
    {
...
LABEL_13:
        v16 = *a4;
        v17 = (DXGPAGINGQUEUE **)((char *)this + 392);
        v18 = *((_QWORD *)this + 49);
        if ( *(DXGDEVICE **)(v18 + 8) != (DXGDEVICE *)((char *)this + 392) )
          __fastfail(3u);
        *(_QWORD *)v16 = v18;
        *((_QWORD *)v16 + 1) = v17;
        *(_QWORD *)(v18 + 8) = v16;
      ...
      LODWORD(v14) = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendCreatePagingQueue(
                       (DXG_GUEST_VIRTUALGPU_VMBUS *)(v15 + 4152),
                       HostProcess,
                       v25,
                       &v31,
      ...
      if ( (int)v14 >= 0 )
      {
        v27 = *((_QWORD *)*a4 + 5);
        *((_DWORD *)*a4 + 7) = v32;
        *(_DWORD *)(v27 + 44) = HIDWORD(v32);
        v28 = MapGuestFenceCpuVaToHost(
                v33,
                (void **)(v27 + 56),
                (unsigned __int64 *)(v27 + 80),
                (unsigned int *)(v27 + 88));
        v14 = v28;
        if ( v28 >= 0 )
          goto LABEL_13;
