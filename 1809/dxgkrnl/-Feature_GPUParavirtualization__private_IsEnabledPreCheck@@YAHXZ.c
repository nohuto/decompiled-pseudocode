/*
 * XREFs of ?Feature_GPUParavirtualization__private_IsEnabledPreCheck@@YAHXZ @ 0x1C001EEF8
 * Callers:
...
__int64 Feature_GPUParavirtualization__private_IsEnabledPreCheck(void)
{
