/*
 * XREFs of ?AcquireSourceModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_DXGK_VIDPNSOURCEMODESET_INTERFACE@@@Z @ 0x1C00D9E60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNSOURCEMODESET__ **a4)
{
  ...
  struct D3DKMDT_HVIDPNSOURCEMODESET__ *v35; // [rsp+70h] [rbp+8h]
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v32, 7043);
  ...
  *a4 = 0LL;
  ...
  do
  {
    if ( *(_DWORD *)(*((_QWORD *)v15 + 11) + 24LL) == (_DWORD)v6 )
      break;
...
LABEL_29:
  ...
  v35 = *(struct D3DKMDT_HVIDPNSOURCEMODESET__ **)(*((_QWORD *)v14 + 6) + 384LL);
  v17 = IndexedSet<DMMVIDPNSOURCE>::FindById(*((_QWORD *)v14 + 38), v6);
  v19 = v17;
  if ( !v17 )
  {
