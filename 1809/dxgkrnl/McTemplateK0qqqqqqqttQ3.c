/*
 * XREFs of McTemplateK0qqqqqqqttQ3 @ 0x1C0035874
 * Callers:
 *     ?DxgkCddLogEvent@@YAXIEPEAU_DXGKETW_PARAMS@@@Z @ 0x1C012C610 (-DxgkCddLogEvent@@YAXIEPEAU_DXGKETW_PARAMS@@@Z.c)
 * Callees:
 *     McGenEventWrite @ 0x1C00130CC (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C0020760 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0qqqqqqqttQ3(
        __int64 a1,
        ...
        __int64 a13)
{
  ...
  v32 = 4LL;
  v34 = 12LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, a2, a3, 0xBu, &EventData);
}
