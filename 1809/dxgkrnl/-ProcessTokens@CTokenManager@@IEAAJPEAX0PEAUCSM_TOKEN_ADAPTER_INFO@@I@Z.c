/*
 * XREFs of ?ProcessTokens@CTokenManager@@IEAAJPEAX0PEAUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x1C000CCE8
 * Callers:
              ...
              if ( v12 && inited <= (unsigned int)(v12 + 1) )
              {
                ...
                *((_BYTE *)this + 152) = 0;
                if ( v13 < *((_DWORD *)this + 27) )
                {
                  ...
                  while ( v16 != (CTokenManager *)((char *)this + 128) )
                  {
                    v14 = ((unsigned __int64)v16 - 8) & -(__int64)(v16 != 0LL);
                    if ( !v13 )
                    {
                      v15 = 0;
                      break;
