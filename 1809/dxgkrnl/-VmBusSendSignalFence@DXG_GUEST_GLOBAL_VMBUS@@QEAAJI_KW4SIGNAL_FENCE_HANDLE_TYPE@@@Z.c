/*
 * XREFs of ?VmBusSendSignalFence@DXG_GUEST_GLOBAL_VMBUS@@QEAAJI_KW4SIGNAL_FENCE_HANDLE_TYPE@@@Z @ 0x1C01F6394
 * Callers:
        ...
        struct _MDL *a4)
{
  ...
  v12 = 1006;
  v14 = (int)a4;
  v4 = DXG_VMBUS_CHANNEL_BASE::VmBusSendSyncMessageStatusReturn(a1, (struct DXGKVMB_COMMAND_BASE *)&v9, 0x28u, a4);
  v6 = v4;
  if ( v4 < 0 )
  {
