/*
 * XREFs of ?ScheduleAdapterActivityCheck@DXGADAPTER@@QEAAXXZ @ 0x1C002ED0C
 * Callers:
...
void __fastcall DXGADAPTER::ScheduleAdapterActivityCheck(KSPIN_LOCK *this)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v7, this + 378, 0);
  ...
  *(_QWORD *)(this[365] + 392) = MEMORY[0xFFFFF78000000320];
  *(_QWORD *)(this[365] + 392) += this[358];
  v4 = (KSPIN_LOCK *)(this[365] + 400);
  if ( !*v4 )
  {
    v5 = (KSPIN_LOCK **)(this + 376);
    v2 = this[376];
    if ( *(KSPIN_LOCK **)(v2 + 8) != this + 376 )
      __fastfail(3u);
    *v4 = v2;
    v4[1] = (KSPIN_LOCK)v5;
    *(_QWORD *)(v2 + 8) = v4;
  ...
  if ( !*((_BYTE *)this + 2996) )
  {
    ...
    LOBYTE(v2) = 1;
    *((_BYTE *)this + 2996) = 1;
    (*(void (__fastcall **)(_QWORD, KSPIN_LOCK))(*(_QWORD *)(*(_QWORD *)(v6 + 520) + 8LL) + 864LL))(
      *(_QWORD *)(v6 + 528),
      v2);
  }
  if ( v10 )
