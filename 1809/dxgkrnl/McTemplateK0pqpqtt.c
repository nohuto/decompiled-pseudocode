/*
 * XREFs of McTemplateK0pqpqtt @ 0x1C0022190
 * Callers:
...
ULONG McTemplateK0pqpqtt(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventFlip, a3, 7u, &EventData);
}
