/*
 * XREFs of ?RemoveSurface@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_REMOVESURFACEFROMSWAPCHAIN@@@Z @ 0x1C0251DE4
 * Callers:
...
LABEL_8:
  ...
  DXGSWAPCHAIN::DestroySurfacesResourcesLocal((__int64)this, 0, v12);
  if ( *(_BYTE *)(v12 + 64) )
  {
    *(_DWORD *)(v12 + 8) = 2;
  }
