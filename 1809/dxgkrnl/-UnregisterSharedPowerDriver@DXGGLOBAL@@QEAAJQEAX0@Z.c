/*
 * XREFs of ?UnregisterSharedPowerDriver@DXGGLOBAL@@QEAAJQEAX0@Z @ 0x1C02126F8
 * Callers:
...
LABEL_19:
  *((_QWORD *)this + 177) = 0LL;
  ExReleasePushLockExclusiveEx((char *)this + 1408, 0LL);
