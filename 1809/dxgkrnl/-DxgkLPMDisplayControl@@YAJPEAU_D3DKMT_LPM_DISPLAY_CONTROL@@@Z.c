/*
 * XREFs of ?DxgkLPMDisplayControl@@YAJPEAU_D3DKMT_LPM_DISPLAY_CONTROL@@@Z @ 0x1C021AD40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCaps@LPMDisplayCtrl@@QEAAJPEAU_D3DKMT_LPMD_CAPS@@@Z @ 0x1C021B068 (-GetCaps@LPMDisplayCtrl@@QEAAJPEAU_D3DKMT_LPMD_CAPS@@@Z.c)
