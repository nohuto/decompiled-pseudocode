/*
 * XREFs of ?SetVirtualRenderAdapter@DXGGLOBAL@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C0212020
 * Callers:
...
void __fastcall DXGGLOBAL::SetVirtualRenderAdapter(DXGGLOBAL *this, struct DXGADAPTER *a2)
{
  ...
  *((_QWORD *)this + 79) = a2;
  if ( v2 )
  {
    v3 = (struct DXGADAPTER **)((char *)this + 640);
    if ( a2 )
    {
      v6 = *v3;
      if ( *v3 && (*((_DWORD *)v6 + 77) & 0x10) != 0 )
        ADAPTER_RENDER::DisconnectFromDisplayAdapters(*((ADAPTER_RENDER **)v6 + 316), a2, v3);
      else
        *((_QWORD *)this + 80) = a2;
    }
    else
