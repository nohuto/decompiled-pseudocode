/*
 * XREFs of DxgkMapContextAllocationCB @ 0x1C01FB290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkMapContextAllocationCB(__int64 a1, __int64 a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(DxgAdapter + 2528) + 544LL) + 8LL)
                                                  + 832LL))(
         *(_QWORD *)(*(_QWORD *)(DxgAdapter + 2528) + 552LL),
         a2);
  if ( v7[0] )
