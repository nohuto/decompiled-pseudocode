/*
 * XREFs of McTemplateK0pqqqqqqqqppp @ 0x1C0035C0C
 * Callers:
 *     TraceDxgkContext @ 0x1C0035D40 (TraceDxgkContext.c)
...
ULONG McTemplateK0pqqqqqqqqppp(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
