/*
 * XREFs of BmlDoesTargetModeObeyConstraint @ 0x1C00C5F24
 * Callers:
...
bool __fastcall BmlDoesTargetModeObeyConstraint(__int64 a1, unsigned __int16 a2, __int64 a3)
{
  ...
  v4 = 104LL * a2;
  v6 = *(__int64 **)(a1 + v4 + 16);
  if ( (!BmlAreRawModesEnabled(a1, a2) || (*(_BYTE *)v6 & 0x87) == 0) && (*(_DWORD *)(a1 + 8) & 4) == 0 )
  {
    LOBYTE(v7) = v8;
    if ( !BmlIsSupportedByMonitorTargetMode(a3, v7) )
      return 0;
  }
  v9 = *v6;
