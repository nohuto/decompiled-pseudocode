/*
 * XREFs of McTemplateK0pqqqqjzqqx @ 0x1C00300A0
 * Callers:
...
ULONG McTemplateK0pqqqqjzqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v28 = 8LL;
  va_copy(v27, va7);
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &Dxgk_PowerComponent, 0LL, 0xBu, &EventData);
}
