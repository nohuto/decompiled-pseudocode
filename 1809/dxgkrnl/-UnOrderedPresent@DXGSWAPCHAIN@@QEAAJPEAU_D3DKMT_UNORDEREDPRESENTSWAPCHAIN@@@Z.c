/*
 * XREFs of ?UnOrderedPresent@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_UNORDEREDPRESENTSWAPCHAIN@@@Z @ 0x1C0252510
 * Callers:
...
LABEL_8:
  ...
  v14 = DXGSWAPCHAIN::AcquireBuffer(this, &v24, (const GUID *)&a2->PresentBufferIdx);
  v16 = v14;
  if ( v14 >= 0 )
  {
