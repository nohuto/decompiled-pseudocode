/*
 * XREFs of ?Initialize@DXGPROTECTEDSESSION@@QEAAJPEAPEAVDXGSYNCOBJECT@@PEAPEAXI1I@Z @ 0x1C022CAEC
 * Callers:
        ...
        unsigned int a6)
{
  ...
  *(_QWORD *)&v23.PrivateDriverDataSize = 0LL;
  v23.pPrivateDriverData = (PVOID)*((_QWORD *)this + 10);
  v23.hProtectedSession = this;
  v23.PrivateDriverDataSize = a4;
  v17 = *((_QWORD *)v16 + 2);
  if ( *(_QWORD *)(v17 + 1152) && *(_QWORD *)(v17 + 1160) )
  {
  ...
  if ( v19 < 0 )
  {
    *((_DWORD *)this + 6) = 3;
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)this + 18, 0xFFFFFFFF) != 1 )
    {
      ...
      *(_QWORD *)(v21 + 24) = 1048LL;
      WdLogEvent5_WdAssertion(v21);
    }
  }
  else
  {
    *((_QWORD *)this + 18) = v23.hProtectedSession;
  }
