/*
 * XREFs of ?AcquireTargetModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGDMM_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C00BDC90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  struct D3DKMDT_HVIDPNTARGETMODESET__ *v32; // [rsp+70h] [rbp+18h]
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v29, 6036);
  if ( !a3 || !a4 )
  {
  ...
  *a4 = 0LL;
  ...
  if ( !DMMVIDPNTOPOLOGY::IsTargetInTopology((DMMVIDPNTOPOLOGY *)(v9 + 96), v7) )
  {
  ...
  v32 = *(struct D3DKMDT_HVIDPNTARGETMODESET__ **)(v13 + 448);
  v14 = IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(*(_QWORD *)(v11 + 312), v7);
  v16 = v14;
  if ( !v14 )
  {
