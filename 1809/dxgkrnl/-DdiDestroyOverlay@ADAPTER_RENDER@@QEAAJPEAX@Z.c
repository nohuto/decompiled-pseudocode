/*
 * XREFs of ?DdiDestroyOverlay@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C01CA990
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyOverlay(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5035);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 640LL))(a2);
  if ( v29[0] )
