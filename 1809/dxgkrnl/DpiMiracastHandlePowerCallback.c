/*
 * XREFs of DpiMiracastHandlePowerCallback @ 0x1C02696F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiMiracastHandlePowerCallback(LPCGUID SettingGuid, _DWORD *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      if ( *Value )
      {
        if ( byte_1C008E759 && KeCancelTimer(&Timer) )
        {
          _InterlockedIncrement(&dword_1C008EB70);
      ...
      {
        byte_1C008E759 = 1;
        if ( byte_1C008E757 && dword_1C008EB58 )
        {
