/*
 * XREFs of ?ProcessProducerDisconnect@CFlipManager@@IEAAXXZ @ 0x1C005A9C0
 * Callers:
...
void __fastcall CFlipManager::ProcessProducerDisconnect(CFlipManager *this)
{
  ...
  {
    v8 = (CFlipPropertySetBase *)CFlipObjectQueue<CFlipConsumerMessage>::Dequeue((_QWORD *)this + 23);
