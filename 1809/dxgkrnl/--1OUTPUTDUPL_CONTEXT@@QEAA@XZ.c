/*
 * XREFs of ??1OUTPUTDUPL_CONTEXT@@QEAA@XZ @ 0x1C0242D8C
 * Callers:
...
void __fastcall OUTPUTDUPL_CONTEXT::~OUTPUTDUPL_CONTEXT(OUTPUTDUPL_CONTEXT *this, __int64 a2, const GUID *a3)
{
  __int64 i; // rdi
  void *v5; // rsi
  __int64 v6; // rbp
  ...
  if ( *((_DWORD *)this + 76) )
  {
    v13 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal((__int64)this) + 77);
    if ( v13 )
    {
  ...
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0p((struct _MCGEN_TRACE_CONTEXT *)&DxgkControlGuid_Context, &EventOutputDuplicationDestroy, a3, this);
}
