/*
 * XREFs of ?DdiPresentToHwQueue@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_PRESENT@@@Z @ 0x1C01CCC3C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiPresentToHwQueue(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  __int64 v16; // r8
  __int64 v17; // r9
  __int64 (__fastcall *v18)(void *, const GUID *); // rax
  int v19; // ebx
  __int64 v20; // rcx
  _QWORD *v21; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v31, 5135);
...
LABEL_16:
  ...
  v18 = *(__int64 (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 1264LL);
  if ( v18 )
    v19 = v18(a2, a3);
  else
    v19 = -1073741822;
  ...
  v25[3] = v19;
  v25[4] = a2;
  v25[5] = *(unsigned int *)&a3[5].Data4[4];
  v25[6] = *(_QWORD *)&a3->Data1;
  v26 = *(unsigned int *)a3->Data4;
  v25[7] = v26;
  if ( v19 != -1073741670 )
  {
    if ( (unsigned int)(v19 + 1073741822) > 0x1B || (v26 = 136314945LL, !_bittest((const int *)&v26, v19 + 1073741822)) )
    {
      if ( v19 != -1073741674 && v19 != -1071775743 && v19 != -1071775736 && v19 != -1071775232 && v19 )
      {
