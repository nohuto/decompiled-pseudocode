/*
 * XREFs of BmlCompareTargetModesWithConstraint @ 0x1C00D7018
 * Callers:
 *     BmlCompareTargetModes @ 0x1C00C6070 (BmlCompareTargetModes.c)
 * Callees:
 *     ??$DIFF@I@@YAIII@Z @ 0x1C0006504 (--$DIFF@I@@YAIII@Z.c)
...
LABEL_10:
        if ( (*(_BYTE *)v6 & 8) != 0 )
        {
          DoesTargetModeSupportWireFormat = BmlDoesTargetModeSupportWireFormat(a3, *(_DWORD *)(v6 + 204));
          if ( DoesTargetModeSupportWireFormat == BmlDoesTargetModeSupportWireFormat(a4, *(_DWORD *)(v6 + 204)) )
          {
            return 0;
          }
          else
