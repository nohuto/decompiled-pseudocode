/*
 * XREFs of DxgkUpdateOverlay @ 0x1C0221190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkUpdateOverlay(__int64 a1, __int64 a2, const GUID *a3)
{
  ...
  __int64 v26; // rcx
  const GUID *v27; // r8
  int v28; // [rsp+20h] [rbp-E8h] BYREF
  __int64 v29; // [rsp+28h] [rbp-E0h]
  char v30; // [rsp+30h] [rbp-D8h]
  _QWORD v31[2]; // [rsp+38h] [rbp-D0h] BYREF
  _BYTE v32[24]; // [rsp+48h] [rbp-C0h] BYREF
  _D3DKMT_UPDATEOVERLAY v33; // [rsp+60h] [rbp-A8h] BYREF
  _BYTE v34[24]; // [rsp+A0h] [rbp-68h] BYREF
  DXGADAPTER *v35[10]; // [rsp+B8h] [rbp-50h] BYREF
  struct DXGDEVICE *v36; // [rsp+118h] [rbp+10h] BYREF
  DXGDEVICE *v37; // [rsp+120h] [rbp+18h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 2023);
...
LABEL_28:
  ...
  v33 = *v3;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v36, v33.hDevice, (struct _KTHREAD **)Current, &v37);
  v8 = (struct ADAPTER_RENDER **)v37;
  if ( !v37 )
  {
    v9 = WdLogNewEntry5_WdError(v7);
    *(_QWORD *)(v9 + 24) = v33.hDevice;
...
LABEL_25:
  ...
  v13 = (v33.hOverlay >> 6) & 0xFFFFFF;
  if ( (unsigned int)v13 >= *((_DWORD *)Current + 62) )
    goto LABEL_17;
  v12 = *((_QWORD *)Current + 29);
  v10 = *(unsigned int *)(v12 + 16 * v13 + 8);
  v11 = (v33.hOverlay >> 25) & 0x60;
  if ( ((v33.hOverlay >> 25) & 0x60) != (*(_BYTE *)(v12 + 16 * v13 + 8) & 0x60)
    || (v10 & 0x2000) != 0
    || (v10 & 0x1F) == 0 )
  {
    goto LABEL_17;
...
LABEL_23:
  ...
  if ( v20 >= 0 )
  {
    ...
    DXGOVERLAYMUTEX::DXGOVERLAYMUTEX((DXGOVERLAYMUTEX *)v32, v8[2]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v32);
    updated = DXGOVERLAY::UpdateOverlay((struct _EX_RUNDOWN_REF *)v15, &v33);
