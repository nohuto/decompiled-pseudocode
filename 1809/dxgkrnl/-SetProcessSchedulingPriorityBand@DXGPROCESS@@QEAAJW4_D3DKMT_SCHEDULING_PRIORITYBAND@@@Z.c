/*
 * XREFs of ?SetProcessSchedulingPriorityBand@DXGPROCESS@@QEAAJW4_D3DKMT_SCHEDULING_PRIORITYBAND@@@Z @ 0x1C022A63C
 * Callers:
...
__int64 __fastcall DXGPROCESS::SetProcessSchedulingPriorityBand(__int64 a1, int a2)
{
  ...
  v3 = a2;
  if ( *(struct _KTHREAD **)(*(_QWORD *)(a1 + 112) + 8LL) != KeGetCurrentThread() )
  {
  ...
  ExAcquirePushLockExclusiveEx(a1 + 168, 0LL);
  *(_QWORD *)(a1 + 176) = KeGetCurrentThread();
  if ( (_DWORD)v3 == 1 )
  {
    *((_QWORD *)DXGGLOBAL::GetGlobal(v7) + 167) = a1;
    _InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal(v9) + 331, 1, 0);
    *(_DWORD *)(a1 + 328) = 1;
  }
  else
  {
  ...
  if ( !(_DWORD)v3 && a1 == *((_QWORD *)DXGGLOBAL::GetGlobal(v12) + 167) )
    _InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal(v21) + 331, 0, 1);
  v22 = 0;
LABEL_20:
  *(_QWORD *)(v5 + 8) = 0LL;
