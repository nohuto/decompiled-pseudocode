/*
 * XREFs of ?SetPrimaryPath@ADAPTER_DISPLAY@@QEAAXIIW4_DXGK_PRIMARY_TARGET_TYPE@@@Z @ 0x1C013A510
 * Callers:
 ...
 *     DxgkSetPostDeviceCandidateTarget @ 0x1C00199B0 (DxgkSetPostDeviceCandidateTarget.c)
 */
