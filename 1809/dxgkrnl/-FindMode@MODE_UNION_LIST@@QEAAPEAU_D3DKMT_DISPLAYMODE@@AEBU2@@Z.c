/*
 * XREFs of ?FindMode@MODE_UNION_LIST@@QEAAPEAU_D3DKMT_DISPLAYMODE@@AEBU2@@Z @ 0x1C00E3A30
 * Callers:
        ...
        const struct _D3DKMT_DISPLAYMODE *a2)
{
  ...
  while ( 1 )
  {
      ...
      && a2->DisplayFixedOutput == *(_DWORD *)(v6 + 32) )
    {
      ...
      if ( a2->ScanLineOrdering == (_DWORD)v8
        && ((*((_BYTE *)&a2->Flags + 4) ^ *(_BYTE *)(v6 + 40)) & 0x10) == 0
        && ((*(_BYTE *)&a2->Flags ^ *(_BYTE *)(v6 + 36)) & 2) == 0 )
      {
        break;
      }
    }
  ...
  {
    v9 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v8, (unsigned int)(*(_DWORD *)&a2->Flags ^ *(_DWORD *)(v6 + 36)), v2, v5);
    v9[3] = a2->Width;
    v9[4] = a2->Height;
    v9[5] = a2->Format;
