/*
 * XREFs of _BtlPreAcquireSharedAccess_&CCD_BTL_ACTIVE_PATHS_COLLECTOR::_CollectActiveAdaptersCallback_1_1_ @ 0x1C00BF460
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 && *(_DWORD *)(v4 + 80) && *((_DWORD *)a1 + 44) == 1 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 && *(_QWORD *)(v7 + 136) )
      {
        ...
        else if ( !*((_BYTE *)a1 + 2429) && (!DXGADAPTER::IsBddFallbackDriver(a1) || DxgkIsMSBDDFallbackEnabled()) )
        {
          v14 = *((_QWORD *)a1 + 315);
          if ( v14 )
          {
            ...
            {
              LODWORD(v13) = CCD_BTL_ACTIVE_PATHS_COLLECTOR::_ProcessVidPn(a2, v34, 1);
              auto_rc<DMMVIDPN>::reset((__int64 *)&v34, 0LL);
              if ( (int)v13 >= 0 )
              {
