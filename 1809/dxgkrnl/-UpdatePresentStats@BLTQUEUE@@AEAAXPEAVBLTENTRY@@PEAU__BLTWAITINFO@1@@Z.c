/*
 * XREFs of ?UpdatePresentStats@BLTQUEUE@@AEAAXPEAVBLTENTRY@@PEAU__BLTWAITINFO@1@@Z @ 0x1C0248FE8
 * Callers:
...
void __fastcall BLTQUEUE::UpdatePresentStats(BLTQUEUE *this, struct BLTENTRY *a2, struct BLTQUEUE::__BLTWAITINFO *a3)
{
  ...
  *((_QWORD *)this + 36) = v12;
  ...
  {
    McTemplateK0qiii(v8, v13, (const GUID *)v7, 1, v10, *((_QWORD *)this + 34), v12);
    v11 = *((_DWORD *)this + 70);
  }
