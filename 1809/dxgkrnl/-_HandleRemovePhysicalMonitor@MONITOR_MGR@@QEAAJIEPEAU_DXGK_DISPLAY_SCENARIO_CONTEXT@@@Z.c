/*
 * XREFs of ?_HandleRemovePhysicalMonitor@MONITOR_MGR@@QEAAJIEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C028F32C
 * Callers:
...
LABEL_20:
    v9 = 1;
  MONITOR_MGR::_IssueMonitorEvent(this, *((_DWORD *)v14 + 11), 0, v16, v9, (__int64)a4);
