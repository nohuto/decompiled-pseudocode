/*
 * XREFs of McTemplateK0ppqQR2QR2QR2QR2QR2QR2QR2 @ 0x1C003A320
 * Callers:
...
ULONG McTemplateK0ppqQR2QR2QR2QR2QR2QR2QR2(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v8 = 8LL;
  v10 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventPatchLocationList, a3, 0xBu, &EventData);
}
