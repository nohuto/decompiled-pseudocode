/*
 * XREFs of ?RemoveJoinedTarget@DMMVIDEOPRESENTTARGET@@QEAAXAEAV1@@Z @ 0x1C004E340
 * Callers:
        ...
        struct DMMVIDEOPRESENTTARGET *a2)
{
  ...
  v3 = (struct DMMVIDEOPRESENTTARGET **)*((_QWORD *)a2 + 60);
  if ( v3[1] != (struct DMMVIDEOPRESENTTARGET *)((char *)a2 + 480)
    || (v4 = (struct DMMVIDEOPRESENTTARGET **)*((_QWORD *)a2 + 61),
        *v4 != (struct DMMVIDEOPRESENTTARGET *)((char *)a2 + 480)) )
  {
    __fastfail(3u);
  }
