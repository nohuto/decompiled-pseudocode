/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C0039640
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C0090158 )
    {
      v4 = (unsigned int)(dword_1C0090150 - 1);
      if ( dword_1C0090150 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C0090158) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C008ED18;
      ReasonSpecificData[4] = qword_1C0090158;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C008ED18;
      if ( v5 )
      {
