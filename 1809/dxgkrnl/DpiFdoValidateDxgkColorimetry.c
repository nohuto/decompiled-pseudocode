/*
 * XREFs of DpiFdoValidateDxgkColorimetry @ 0x1C02676A4
 * Callers:
 ...
 * Callees:
 *     _lambda_7fd6b90712c1724b9dd78ba440ff6b5c_::operator() @ 0x1C0044170 (_lambda_7fd6b90712c1724b9dd78ba440ff6b5c_--operator().c)
 */
...
LABEL_6:
  if ( v2 )
    return 279LL;
  if ( !lambda_7fd6b90712c1724b9dd78ba440ff6b5c_::operator()(v5, *((_QWORD *)a1 + 3)) )
  {
...
LABEL_40:
    ...
    || (v12 & 0x3F00000) != 0 )
  {
    ...
    if ( !lambda_7fd6b90712c1724b9dd78ba440ff6b5c_::operator()(v13, *((_QWORD *)a1 + 1)) )
    {
