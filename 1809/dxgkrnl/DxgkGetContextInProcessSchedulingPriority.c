/*
 * XREFs of DxgkGetContextInProcessSchedulingPriority @ 0x1C0202250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetContextInProcessSchedulingPriority(__int64 a1, __int64 a2, const GUID *a3)
{
  ...
  DXGCONTEXT *v30; // [rsp+F0h] [rbp+18h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v22, 2085);
...
LABEL_11:
  ...
  COREDEVICEACCESS::COREDEVICEACCESS((__int64)v28, v11[2], 0, v16, 0);
  v17 = COREDEVICEACCESS::AcquireShared((COREDEVICEACCESS *)v28);
  if ( v17 >= 0 )
  {
    HIDWORD(v29) = DXGCONTEXT::GetInProcessSchedulingPriority((DXGCONTEXT *)v11);
    if ( (unsigned __int64)v3 >= MmUserProbeAddress )
