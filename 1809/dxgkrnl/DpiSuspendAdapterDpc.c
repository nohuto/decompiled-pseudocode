/*
 * XREFs of DpiSuspendAdapterDpc @ 0x1C0043B10
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  v5[4] = *((int *)DeferredContext + 1012);
  v5[5] = *((int *)DeferredContext + 1013);
  WdLogEvent5_WdTrace(v5);
  if ( *((_DWORD *)DeferredContext + 1012) != 4 && *((_DWORD *)DeferredContext + 1013) == 1 )
