/*
 * XREFs of ?IsCurrentModeAdvancedColor@@YAEPEAVDXGADAPTER@@IPEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@PEAW4_D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE@@@Z @ 0x1C00BEC18
 * Callers:
        ...
        enum _D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE *a4)
{
  ...
  v5 = a2;
  v8 = ADAPTER_DISPLAY::MapVidPnTargetToVidPnSource(a1[315], a2);
  CurrentWireFormatAndColorSpace = DmmGetCurrentWireFormatAndColorSpace(a1, v8, v5, &v21, v20);
  v12 = 0;
  v13 = CurrentWireFormatAndColorSpace;
  if ( CurrentWireFormatAndColorSpace < 0 )
  {
    v17 = WdLogNewEntry5_WdWarning(0LL, v10, v11);
    *(_QWORD *)(v17 + 24) = *((int *)a1 + 70);
    *(_QWORD *)(v17 + 32) = *((unsigned int *)a1 + 69);
    v18 = ADAPTER_DISPLAY::MapVidPnTargetToVidPnSource(a1[315], v5);
    v19[5] = v18;
    v19[6] = v5;
    v19[7] = v13;
