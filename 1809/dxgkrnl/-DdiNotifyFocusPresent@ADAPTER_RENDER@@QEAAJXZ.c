/*
 * XREFs of ?DdiNotifyFocusPresent@ADAPTER_RENDER@@QEAAJXZ @ 0x1C01CC084
 * Callers:
 *     ?ADAPTER_RENDER_DdiNotifyFocusPresent@@YAJPEAVADAPTER_RENDER@@@Z @ 0x1C00379C0 (-ADAPTER_RENDER_DdiNotifyFocusPresent@@YAJPEAVADAPTER_RENDER@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiNotifyFocusPresent(ADAPTER_RENDER *this, __int64 a2, const GUID *a3)
{
  ...
  __int64 v22; // rcx
  const GUID *v23; // r8
  int v25; // [rsp+28h] [rbp-29h] BYREF
  __int64 v26; // [rsp+30h] [rbp-21h]
  char v27; // [rsp+38h] [rbp-19h]
  _BYTE v28[24]; // [rsp+40h] [rbp-11h] BYREF
  _BYTE v29[8]; // [rsp+58h] [rbp+7h] BYREF
  struct _KAPC_STATE ApcState; // [rsp+60h] [rbp+Fh] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5116);
...
LABEL_16:
  ...
  v13 = *((_QWORD *)this + 2);
  v14 = *(__int64 (__fastcall **)(_QWORD))(v13 + 1184);
  if ( v14 )
    v15 = v14(*(_QWORD *)(v13 + 248));
  else
    v15 = -1073741822;
  if ( v29[0] )
  ...
  if ( v15 != -1073741822 && v15 != -1073741801 && v15 )
  {
