/*
 * XREFs of DpiLdaLinkDeviceToChain @ 0x1C0272E10
 * Callers:
...
__int64 __fastcall DpiLdaLinkDeviceToChain(__int64 a1)
{
  ...
  if ( *(_QWORD *)v4 != v4 )
  {
    do
    {
      ...
      if ( *(_BYTE *)(v8 + 508) == 1 || *(_DWORD *)(v7 + 2664) >= *(_DWORD *)(v7 + 504) )
      {
        v2 = -1071774666;
      ...
      *(_QWORD *)(v8 + 2656) = *(_QWORD *)(v7 + 24);
      *(_DWORD *)(v8 + 2664) = *(_DWORD *)(v7 + 2664);
      *(_QWORD *)(*(_QWORD *)(v7 + 2656) + 8LL * (unsigned int)(*(_DWORD *)(v7 + 2664))++) = *(_QWORD *)(v8 + 24);
      if ( *(_BYTE *)(v8 + 1144) )
        *(_BYTE *)(v7 + 1146) = 1;
      if ( *(_BYTE *)(v4 + 483) )
      {
