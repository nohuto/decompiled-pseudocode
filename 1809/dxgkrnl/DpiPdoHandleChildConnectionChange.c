/*
 * XREFs of DpiPdoHandleChildConnectionChange @ 0x1C02760FC
 * Callers:
...
LABEL_21:
    ...
    if ( v9 )
    {
      ...
      if ( !*(_BYTE *)(v23 + 944) )
        goto LABEL_20;
      MonitorNotifyDeviceNodeReady(*(DXGADAPTER **)(v11 + 3792), a2);
    }
    else
    {
  ...
  *(_BYTE *)(v18 + 66) = v13;
  if ( (_BYTE)v17 != v9 || v9 && a6 )
  {
    *(_BYTE *)(v18 + 65) = v9;
    ...
    {
      _m_prefetchw((const void *)(v11 + 3540));
      if ( (_InterlockedOr((volatile signed __int32 *)(v11 + 3540), 1u) & 1) == 0 )
