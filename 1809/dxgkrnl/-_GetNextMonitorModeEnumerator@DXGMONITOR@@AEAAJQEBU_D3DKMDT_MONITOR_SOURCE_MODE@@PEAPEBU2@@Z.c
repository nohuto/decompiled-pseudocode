/*
 * XREFs of ?_GetNextMonitorModeEnumerator@DXGMONITOR@@AEAAJQEBU_D3DKMDT_MONITOR_SOURCE_MODE@@PEAPEBU2@@Z @ 0x1C029BADC
 * Callers:
        ...
        __int64 a4)
{
  ...
  v9 = (const struct _D3DKMDT_MONITOR_SOURCE_MODE **)(this + 30);
  if ( !a2 )
    goto LABEL_24;
  v10 = *v9;
  ...
  v9 = (const struct _D3DKMDT_MONITOR_SOURCE_MODE **)(this + 27);
  if ( !v11
