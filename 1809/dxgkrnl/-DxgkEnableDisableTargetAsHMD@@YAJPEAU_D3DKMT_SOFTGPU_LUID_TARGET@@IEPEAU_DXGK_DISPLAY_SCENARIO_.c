/*
 * XREFs of ?DxgkEnableDisableTargetAsHMD@@YAJPEAU_D3DKMT_SOFTGPU_LUID_TARGET@@IEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01D24C0
 * Callers:
...
LABEL_13:
    ...
    v15 = COREADAPTERACCESS::AcquireExclusive(&v22, 1LL);
    v7 = v15;
    if ( v15 >= 0 )
    {
      if ( !*((_QWORD *)v13 + 315) )
