/*
 * XREFs of ?Create@CContentResource@@SAJ_KPEAVCFlipPropertySet@@PEAPEAVCContentResourceState@@@Z @ 0x1C005C744
 * Callers:
...
__int64 __fastcall CContentResource::Create(__int64 a1, struct CFlipPropertySet *a2, struct CContentResourceState **a3)
{
  ...
  v3 = 0LL;
  PoolWithQuotaTag = (CFlipResource *)ExAllocatePoolWithQuotaTag((POOL_TYPE)9, 0x40uLL, 0x72634346u);
  v8 = PoolWithQuotaTag;
  if ( PoolWithQuotaTag )
  {
