/*
 * XREFs of DpiVerifyResources @ 0x1C0159F70
 * Callers:
 *     DpMapMemory @ 0x1C0159CF0 (DpMapMemory.c)
 * Callees:
...
LABEL_33:
  ...
  if ( *(_QWORD *)a2 == 786432LL || v14 == 655360 || v14 == 944 || v14 == 960 )
  {
    ...
    {
      v8 = -1073741811;
      v30 = WdLogNewEntry5_WdError(786432LL);
...
LABEL_20:
  if ( !v13 )
    goto LABEL_33;
  KeWaitForSingleObject((PVOID)(v7 + 2448), Executive, 0, 0, 0LL);
  v19 = *(__int64 **)(v7 + 2432);
  v20 = v19;
  if ( (__int64 *)*v19 != v19 )
  {
...
LABEL_26:
  KeReleaseMutex((PRKMUTEX)(v7 + 2448), 0);
  return v8;
}
