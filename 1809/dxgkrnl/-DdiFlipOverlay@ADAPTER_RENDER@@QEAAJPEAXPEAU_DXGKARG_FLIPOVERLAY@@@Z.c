/*
 * XREFs of ?DdiFlipOverlay@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_FLIPOVERLAY@@@Z @ 0x1C01CB4D0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiFlipOverlay(ADAPTER_RENDER *this, void *a2, const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v29, 5034);
...
LABEL_16:
  ...
  v15 = (*(int (__fastcall **)(void *, const GUID *))(*((_QWORD *)this + 2) + 632LL))(a2, a3);
  if ( v32[0] )
