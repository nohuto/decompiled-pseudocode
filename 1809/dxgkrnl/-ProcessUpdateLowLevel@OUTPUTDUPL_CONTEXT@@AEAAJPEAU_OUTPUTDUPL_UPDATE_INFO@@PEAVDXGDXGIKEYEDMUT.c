/*
 * XREFs of ?ProcessUpdateLowLevel@OUTPUTDUPL_CONTEXT@@AEAAJPEAU_OUTPUTDUPL_UPDATE_INFO@@PEAVDXGDXGIKEYEDMUTEX@@PEAU_PRODUCER_INFO@@PEAH3@Z @ 0x1C0244EA0
 * Callers:
...
LABEL_10:
  ...
  if ( *((_DWORD *)a4 + 4) == 1 )
  {
    ...
    DirtyRectData = DDAMetaData::GetDirtyRectData((AUTOEXPANDALLOCATION **)v22, v39.DirtyRectCount);
    v24 = *((_QWORD *)a4 + 1);
