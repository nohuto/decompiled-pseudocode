/*
 * XREFs of ?GetCurrentContentResolution@@YAJQEAXIPEAPEBUtagRECT@@PEAU1@PEAK@Z @ 0x1C00BADAC
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(a1) )
  {
    ...
    *(_QWORD *)(v16 + 24) = 1026LL;
    WdLogEvent5_WdAssertion(v16);
  }
  v10 = *(_QWORD *)(*((_QWORD *)a1 + 315) + 112LL) + 3760 * v6;
  if ( !v10 )
  {
    v17 = WdLogNewEntry5_WdAssertion(v9);
    *(_QWORD *)(v17 + 24) = 1029LL;
