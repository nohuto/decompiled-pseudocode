/*
 * XREFs of MapChildVaSpace @ 0x1C01FAC40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MapChildVaSpace(__int64 a1, __int64 a2, unsigned __int64 a3, int a4, int a5, _QWORD *a6, __int64 a7)
{
  ...
  KeStackAttachProcess(*(PRKPROCESS *)(*(_QWORD *)(v16 + 456) + 192LL), &ApcState);
  v17 = *(_BYTE *)(a1 + 323);
  if ( (v17 & 8) != 0 )
  {
  ...
  v19 = (_QWORD *)(v18 + 88);
LABEL_12:
  v20 = (int)((__int64 (__fastcall *)(_QWORD, __int64, unsigned __int64, _QWORD, int, int, PVOID, __int64))qword_1C008FE78)(
               *v19,
               a2,
               a3 >> 12,
               0LL,
