/*
 * XREFs of DxgkQueryConnectionChanges @ 0x1C0044888
 * Callers:
...
__int64 __fastcall DxgkQueryConnectionChanges(__int64 a1, char a2, char a3, char a4, char a5)
{
  ...
  if ( (unsigned int)(*(_DWORD *)(v5 + 236) - 1) > 1 || *(_DWORD *)(v5 + 3888) == 1 || *(_DWORD *)(v5 + 284) != 1 )
  {
  ...
  KeEnterCriticalRegion();
  v13 = (struct _ERESOURCE *)(v5 + 3232);
  ExAcquireResourceExclusiveLite((PERESOURCE)(v5 + 3232), 1u);
  if ( (*(_BYTE *)(v5 + 3800) & 1) != 0 )
  {
    LOBYTE(v14) = 1;
    ...
    DxgkStartDisplayCalloutBatch(*(_QWORD *)(v5 + 3792));
  }
  if ( a2 )
  {
    if ( (*(_BYTE *)(v5 + 3801) & 8) != 0 )
    {
  ...
  do
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)&v47[48] = 60;
      ...
      v47[101] = a5;
      v47[100] = v7;
      _InterlockedExchange((volatile __int32 *)(v5 + 3444), 2);
      ...
      if ( v47[102] )
      {
        DxgkInvalidateVidPnDisplayModeListCache(*(_QWORD *)(v5 + 3792));
        MonitorRebuildMonitorModeListCache(*(struct DXGADAPTER **)(v5 + 3792));
      }
      else
      {
...
LABEL_41:
  ...
  while ( (_InterlockedExchange((volatile __int32 *)(v5 + 3444), 0) & 1) != 0 );
  v13 = (struct _ERESOURCE *)(v5 + 3232);
  if ( (*(_BYTE *)(v5 + 3800) & 1) != 0 )
  {
    DxgkEndDisplayCalloutBatch(*(_QWORD *)(v5 + 3792));
    LOBYTE(v37) = 1;
    DpiReleaseCoreSyncAccessSafe(v9, v37);
  }
  if ( (int)v17 < 0 )
  {
    _InterlockedAnd((volatile signed __int32 *)(v5 + 3540), 0xFFFFFFFE);
