/*
 * XREFs of ?WnfScreenOnCallback@@YAJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@Z @ 0x1C001E950
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  if ( (int)ExQueryWnfStateData(a1, &v9, v10, &v8) >= 0 && v8 == 20 )
  {
    ...
    DXGGLOBAL::IterateAdaptersWithCallback(Global, v6, v11, 4LL);
  }
  return 0LL;
}
