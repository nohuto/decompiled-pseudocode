/*
 * XREFs of ?DdiGetBackingResource@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETBACKINGRESOURCE@@@Z @ 0x1C01E1C94
 * Callers:
 *     ?GetBackingResource@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETBACKINGRESOURCE@@@Z @ 0x1C01E7490 (-GetBackingResource@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETBACKINGRESOURCE@@@Z.c)
 * Callees:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v22, 5137);
...
LABEL_16:
  ...
  v13 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETBACKINGRESOURCE *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                            + 952LL)
                                                                                + 32LL))(
