/*
 * XREFs of ?DdiCreateProtectedSession@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CREATEPROTECTEDSESSION@@@Z @ 0x1C01CA3B8
 * Callers:
        ...
        const GUID *a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5108);
...
LABEL_16:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEPROTECTEDSESSION *))(*((_QWORD *)this + 2) + 1152LL))(
