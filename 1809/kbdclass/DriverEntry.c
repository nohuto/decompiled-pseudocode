/*
 * XREFs of DriverEntry @ 0x1C000F080
 * Callers:
 ...
 *     WppInitKm @ 0x1C000D040 (WppInitKm.c)
 *     WppLoadTracingSupport @ 0x1C000D0E0 (WppLoadTracingSupport.c)
 *     WppCleanupKm @ 0x1C000E83C (WppCleanupKm.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  xmmword_1C0009030 = 0LL;
  ProviderId = v7;
  if ( !EtwRegister(&ProviderId, TlgEnableCallback, &dword_1C0009008, &RegHandle) )
  ...
  qword_1C00094D0 = (__int64)&qword_1C00094C8;
  qword_1C00094C8 = (__int64)&qword_1C00094C8;
  ...
  *(_DWORD *)&::DestinationString.Length = 0x2000000;
  ::DestinationString.Buffer = (PWSTR)&unk_1C00092C8;
  memset(v37, 0, sizeof(v37));
  *(_DWORD *)&DestinationString.Length = 0x2000000;
  DestinationString.Buffer = (PWSTR)v37;
  word_1C00092A8 = RegistryPath->Length;
  word_1C00092AA = RegistryPath->Length + 2;
  PoolWithTag = ExAllocatePoolWithTag((POOL_TYPE)512, (unsigned __int16)word_1C00092AA, 0x4364624Bu);
  ::P = PoolWithTag;
  if ( !PoolWithTag )
  {
    LOBYTE(v9) = 2;
  ...
  *((_WORD *)::P + ((unsigned __int64)RegistryPath->Length >> 1)) = 0;
  ...
  else
  {
    ...
    if ( v13 )
    {
      ...
      v16 = (__int64 *)qword_1C00094C8;
      for ( j = 0; v16 != &qword_1C00094C8; v16 = (__int64 *)*v16 )
