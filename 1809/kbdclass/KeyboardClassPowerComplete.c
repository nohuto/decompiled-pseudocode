/*
 * XREFs of KeyboardClassPowerComplete @ 0x1C00015A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KeyboardClassPowerComplete(__int64 a1, IRP *a2)
{
  ...
  int RemlockSizea; // [rsp+20h] [rbp-48h]
  int RemlockSizeb; // [rsp+20h] [rbp-48h]
        ...
        if ( Options == 1 )
        {
          ...
          *(POWER_STATE *)(v2 + 188) = v10;
          ...
          if ( Irp )
          {
            ...
            {
              WPP_RECORDER_SF_qq(WPP_GLOBAL_Control->DeviceExtension, 4, 4, 98, RemlockSize, a1, (char)v12);
