/*
 * XREFs of WPP_RECORDER_SF_qq @ 0x1C0001880
 * Callers:
 *     KeyboardClassRead @ 0x1C0001410 (KeyboardClassRead.c)
 *     KeyboardClassPowerComplete @ 0x1C00015A0 (KeyboardClassPowerComplete.c)
 *     KeyboardClassSetLedsComplete @ 0x1C00017D0 (KeyboardClassSetLedsComplete.c)
 *     KeyboardClassPower @ 0x1C0001960 (KeyboardClassPower.c)
 *     KeyboardClassCreate @ 0x1C0001CA0 (KeyboardClassCreate.c)
 *     KeyboardClassCancelPendingIrpLeds @ 0x1C00047A8 (KeyboardClassCancelPendingIrpLeds.c)
  ...
  if ( _bittest(&v11, v10 & 0x1F) )
  {
    ...
    if ( (unsigned __int8)v13[41] >= a2 )
      ((void (__fastcall *)(_QWORD, __int64, void *, _QWORD, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
        *((_QWORD *)v13 + 3),
        43LL,
        &WPP_1975c0ad83fe39ae2d5358536952ac4e_Traceguids,
        a4,
        (__int64 *)va,
        8LL,
        va1,
