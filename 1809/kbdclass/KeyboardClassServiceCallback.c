/*
 * XREFs of KeyboardClassServiceCallback @ 0x1C00050C0
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x1C0002D40 (memmove.c)
 *     KeyboardClassDequeueRead @ 0x1C0004A14 (KeyboardClassDequeueRead.c)
 *     KeyboardClassReadCopyData @ 0x1C0004D08 (KeyboardClassReadCopyData.c)
 *     WPP_RECORDER_SF_ @ 0x1C0005B2C (WPP_RECORDER_SF_.c)
 *     WPP_RECORDER_SF_qL @ 0x1C0005CB0 (WPP_RECORDER_SF_qL.c)
 *     WPP_RECORDER_SF_qLL @ 0x1C0005D84 (WPP_RECORDER_SF_qLL.c)
 *     WPP_RECORDER_SF_qLqq @ 0x1C0005E7C (WPP_RECORDER_SF_qLqq.c)
 *     WPP_RECORDER_SF_qlqqd @ 0x1C0006068 (WPP_RECORDER_SF_qlqqd.c)
 *     WPP_RECORDER_SF_qqLLqq @ 0x1C00062C4 (WPP_RECORDER_SF_qqLLqq.c)
 *     WPP_RECORDER_SF_qqiL @ 0x1C00067C4 (WPP_RECORDER_SF_qqiL.c)
 */
...
LABEL_40:
  ...
  {
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_qLL(WPP_GLOBAL_Control->DeviceExtension, 12 * *(_DWORD *)(v8 + 84), v12, 52);
    v22 = *(_DWORD *)(v8 + 140);
    v23 = v22;
    if ( v22 >= v21 )
      v23 = v21;
    ...
    *(_QWORD *)(v8 + 112) += v25;
    ...
    v29 = *(char **)(v8 + 104);
    v30 = *(char **)(v8 + 112);
    if ( v30 >= &v29[*(unsigned int *)(v8 + 140)] )
    {
      *(_QWORD *)(v8 + 112) = v29;
      v30 = v29;
    }
    ...
    *a4 += v23 / 0xC;
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_qlqqd(WPP_GLOBAL_Control->DeviceExtension, v23 / 0xC, v26, v27);
  }
  while ( *(_DWORD *)(v8 + 84) )
  {
