/*
 * XREFs of KeyboardPnP @ 0x1C0001ED0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qqc @ 0x1C00022D0 (WPP_RECORDER_SF_qqc.c)
 ...
 *     KeyboardClassRemoveDevice @ 0x1C0004F2C (KeyboardClassRemoveDevice.c)
