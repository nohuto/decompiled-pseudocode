/*
 * XREFs of ComputeProcessorEnergy @ 0x1C000C820
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        unsigned __int64 *a5)
{
  ...
  v6 = (unsigned int *)((char *)&unk_1C0011988 + 256 * (unsigned __int64)a1);
  v8 = v6[1];
  if ( (v8 & 1) != 0 )
  {
    v9 = 0;
...
LABEL_15:
  ...
  result = 10 * a2 * v17 * v14 / (unsigned __int64)qword_1C0011B90;
  *a5 = result;
  return result;
}
