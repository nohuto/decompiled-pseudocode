/*
 * XREFs of CpcGuaranteedNotifyWorker @ 0x1C0022778
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C0022700 (CpcNativeInterruptWorker.c)
 *     AcpiCppcGuaranteedNotifyWorker @ 0x1C0026E50 (AcpiCppcGuaranteedNotifyWorker.c)
 * Callees:
  ...
  if ( v7 )
  {
    ...
    if ( *(_BYTE *)(v7 + 99) )
    {
      (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
        ...
        0LL);
      if ( !*(_BYTE *)(v7 + 101)
        || (*(int (__fastcall **)(_QWORD))(qword_1C0011900 + 88))(*(_QWORD *)(qword_1C0011900 + 56)) >= 0
        && (*(int (__fastcall **)(_QWORD, _QWORD))(qword_1C0011900 + 104))(*(_QWORD *)(qword_1C0011900 + 56), 0LL) >= 0 )
      {
        ...
        *(_DWORD *)(v7 + 84) = v12;
        if ( v12 != *(_DWORD *)(v5 + 708) )
        {
          ...
          ((void (__fastcall *)(__int64))qword_1C00117A8)(v5);
        }
