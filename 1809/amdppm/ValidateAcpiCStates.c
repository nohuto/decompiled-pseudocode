/*
 * XREFs of ValidateAcpiCStates @ 0x1C002F354
 * Callers:
...
LABEL_24:
          ...
          case 2:
            ...
            break;
          default:
            if ( !IsValidAcpiGenericAddress((char *)&dword_1C0011BD4)
              || !IsValidAcpiGenericAddress((char *)&dword_1C0011BA4)
              || !IsValidAcpiGenericAddress((char *)&dword_1C0011BBC) )
            {
              v8 = 27;
              goto LABEL_24;
            }
