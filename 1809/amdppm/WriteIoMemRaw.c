/*
 * XREFs of WriteIoMemRaw @ 0x1C000377C
 * Callers:
 *     WriteGenAddr @ 0x1C00038E8 (WriteGenAddr.c)
 *     PerfControlCpcSingleRegister @ 0x1C0003FF0 (PerfControlCpcSingleRegister.c)
 * Callees:
 *     <none>
 */
...
char __fastcall WriteIoMemRaw(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( *(_BYTE *)a1 != 1 )
  {
    ...
    result = qword_1C0011900;
    v9 = *(_QWORD *)(qword_1C0011900 + 72);
    switch ( v8 )
    {
      case 8:
        v4[v9] = a2;
