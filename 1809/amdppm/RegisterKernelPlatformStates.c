/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C001D178
 * Callers:
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = (unsigned int)dword_1C0011930;
  v2 = dword_1C00113E4;
  if ( !dword_1C0011930 )
    return 0;
  v4 = (48 * dword_1C0011930 + 59) & 0xFFFFFFFC;
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + 8 * dword_1C00113E4 * dword_1C0011930, 0x72637250u);
  v6 = PoolWithTag;
  if ( !PoolWithTag )
  {
    WPP_RECORDER_SF_(
...
LABEL_16:
    *(_DWORD *)v6 = 60;
    *((_DWORD *)v6 + 1) = dword_1C0011930;
    *((_DWORD *)v6 + 2) = dword_1C0011930;
