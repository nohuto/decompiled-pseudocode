/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C001E73C
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x1C001B4F0 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x1C001EB10 (RegisterKernelPerfFeedback.c)
 * Callees:
