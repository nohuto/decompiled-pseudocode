/*
 * XREFs of PerfControlCpcSingleRegister @ 0x1C0003FF0
 * Callers:
 *     <none>
 * Callees:
 *     ReadIoMemRaw @ 0x1C0003668 (ReadIoMemRaw.c)
 *     WriteIoMemRaw @ 0x1C000377C (WriteIoMemRaw.c)
 *     PerformanceFromPercentage @ 0x1C00047C8 (PerformanceFromPercentage.c)
 */
  ...
  if ( a3 || a4 )
  {
    ...
    *(_QWORD *)(a1 + 48) = *(_QWORD *)a2;
    ...
    if ( *(_BYTE *)(a1 + 93) )
    {
      ...
      {
        if ( v11 < 0x40u || v9[70] )
          IoMemRaw &= ~(((1LL << v11) - 1) << v9[70]);
        else
          IoMemRaw = 0LL;
      }
      else if ( v11 < 0x40u || v9[70] )
      {
        IoMemRaw = IoMemRaw & ~(((1LL << v11) - 1) << v9[70]) | (((1LL << v11) - 1) << v9[70]) & (*(_QWORD *)a2 << v9[70]);
      }
      else
      {
        IoMemRaw = *(_QWORD *)a2;
    ...
    if ( *(_BYTE *)(a1 + 96) )
    {
      ...
      if ( v24 < 0x40u || v9[214] )
        IoMemRaw = IoMemRaw & ~(((1LL << v24) - 1) << v9[214]) | (((1LL << v24) - 1) << v9[214]) & ((unsigned __int64)v25 << v9[214]);
      else
        IoMemRaw = v25;
    }
