/*
 * XREFs of PepNotifyQueryCoordinatedStates @ 0x1C002C8F8
 * Callers:
...
__int64 __fastcall PepNotifyQueryCoordinatedStates(__int64 a1, _QWORD *a2)
{
  ...
  char v49[176]; // [rsp+50h] [rbp-F8h] BYREF

  v2 = (unsigned int)dword_1C0011930;
  v4 = (unsigned int)(16 * dword_1C0011930 + 4);
  v5 = 0LL;
  v6 = 0LL;
        ...
        if ( (_DWORD)v2 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( *((_DWORD *)v29 - 3) )
              break;
LABEL_27:
            KeCopyAffinityEx(v49, &unk_1C00116F0);
            v35 = *((_DWORD *)v29 - 3);
            v36 = 0;
            if ( !v35 )
              goto LABEL_50;
...
LABEL_50:
            ...
            if ( (unsigned int)KeIsEqualAffinityEx(v29 - 27, &unk_1C00116F0) )
              *((_BYTE *)v29 - 8) = 1;
            ++v28;
            v29 += 28;
          ...
          while ( 1 )
          {
            ...
            *v6 = v28;
            ...
            if ( v8 < 0 )
              break;
            v8 = ValidateCoordinatedDependencyOptions((_DWORD)v5, v28, v30, *((_DWORD *)v29 - 4), (__int64)v6);
            if ( v8 < 0 )
              break;
            v31 = *((_QWORD *)v6 + 2);
            v32 = *v29 + 16LL * v30;
