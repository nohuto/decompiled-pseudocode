/*
 * XREFs of ReadGenAddrHidden @ 0x1C0003A5C
 * Callers:
...
unsigned __int64 __fastcall ReadGenAddrHidden(unsigned int a1, __int64 a2)
{
  ...
  if ( v5 != 1 )
  {
    if ( v5 == 127 && v7 == 64 )
    {
      ((void (__fastcall *)(_QWORD, _QWORD, unsigned __int64 *))qword_1C00116C0)(a1, (unsigned int)v6, &v12);
      goto LABEL_18;
    }
    return 0LL;
  }
  switch ( v7 )
  {
    ...
    case 32:
      v9 = 4LL;
LABEL_17:
      ((void (__fastcall *)(_QWORD, _QWORD, __int64, unsigned __int64 *))qword_1C00116D0)(
        a1,
        (unsigned __int16)v6,
        v9,
        &v12);
