...
char __fastcall C2Idle(__int64 a1, unsigned int a2)
{
  ...
  if ( v3 == 1 )
  {
    ...
    LOBYTE(v3) = WriteGenAddr(&dword_1C0011BBC, GenAddr & 0xFFFFFFFD);
    if ( qword_1C0011BCC )
    {
      v6 = ReadGenAddr((__int64)&dword_1C0011BC8);
      LOBYTE(v3) = WriteGenAddr(&dword_1C0011BC8, v6 & 0xFFFFFFFD);
    }
  }
  if ( (_DWORD)v2 )
  {
