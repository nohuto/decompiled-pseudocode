/*
 * XREFs of PepIdlePrepare @ 0x1C000A4F0
 * Callers:
 *     <none>
 * Callees:
 *     AcpiCStateIdlePrepare @ 0x1C0004DB0 (AcpiCStateIdlePrepare.c)
 *     PepIdleCancel @ 0x1C000A970 (PepIdleCancel.c)
...
__int64 __fastcall PepIdlePrepare(__int64 a1)
{
  ...
  if ( dword_1C0011928 >= (unsigned int)dword_1C00113E4 )
  {
    ...
    v19 = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C0011680)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C0011930 )
