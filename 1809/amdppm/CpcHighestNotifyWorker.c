/*
 * XREFs of CpcHighestNotifyWorker @ 0x1C00229EC
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C0022700 (CpcNativeInterruptWorker.c)
 *     AcpiCppcHighestNotifyWorker @ 0x1C0026E70 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
  ...
  if ( v8 )
  {
      ...
      && (*(int (__fastcall **)(_QWORD, _QWORD))(qword_1C0011900 + 104))(*(_QWORD *)(qword_1C0011900 + 56), 0LL) >= 0 )
    {
      ...
      *(_DWORD *)(v8 + 68) = v13;
      ...
      ((void (__fastcall *)(_DWORD *))qword_1C00115F0)(v19);
