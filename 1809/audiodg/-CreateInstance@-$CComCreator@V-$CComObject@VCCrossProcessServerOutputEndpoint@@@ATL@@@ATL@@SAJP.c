/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCCrossProcessServerOutputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x1400518E8
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  try
  {
    v8 = (CCrossProcessServerOutputEndpoint *)AERTAllocate(0x250uLL, v7);
    v12[5] = v8;
    if ( v8 )
  ...
  if ( v10 )
  {
    Microsoft::WRL::Details::SafeUnknownIncrementReference((CCrossProcessServerOutputEndpoint *)((char *)v10 + 488), v9);
