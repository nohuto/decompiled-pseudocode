/*
 * XREFs of ?IdentifyCpuSets@@YAJPEAUCpuSet@@PEAUCpuGroupMask@@PEAK@Z @ 0x140033130
 * Callers:
...
NTSTATUS __fastcall IdentifyCpuSets(struct CpuSet *a1, struct CpuGroupMask *a2, unsigned int *a3)
{
  ...
  BOOL LogicalProcessorInformation; // r13d
  int v21; // ecx
  char v22; // r11
  __int64 v23; // r9
  __int128 v24; // xmm0
  ...
  DWORD ReturnedLength[3]; // [rsp+24h] [rbp-DCh] BYREF
