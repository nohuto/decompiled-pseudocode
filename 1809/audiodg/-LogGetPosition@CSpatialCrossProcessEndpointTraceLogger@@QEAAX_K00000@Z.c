/*
 * XREFs of ?LogGetPosition@CSpatialCrossProcessEndpointTraceLogger@@QEAAX_K00000@Z @ 0x14005C0A0
 * Callers:
        ...
        char a7)
{
  ...
  if ( (unsigned int)dword_140088108 > 5 )
  {
    ...
    v19 = 8LL;
    v21 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_140088108, &unk_140072C35, 0LL, a4, 9u, &pData);
  }
}
