/*
 * XREFs of ?LogGetAvailableObjectCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXPEBDI@Z @ 0x14005BEB4
 * Callers:
        ...
        int a3)
{
  ...
  if ( (unsigned int)dword_140088108 > 5 )
  {
    ...
    v9 = &v12;
    v10 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_140088108, &unk_140072EAE, 0LL, v3, 5u, &pData);
  }
}
