/*
 * XREFs of ?CreateApoEndpointInstance@CEndpointInstance@@SAJPEAUIDeviceGraphObjectCache@@PEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@PEAUIAudioMediaType@@IPEAPEAV1@@Z @ 0x14003D564
 * Callers:
 ...
 *     ??0CEndpointInstance@@IEAA@PEAUIAudioEndpointRT@@PEAVHandleSendReceiveServer@@_J@Z @ 0x14003D4AC (--0CEndpointInstance@@IEAA@PEAUIAudioEndpointRT@@PEAVHandleSendReceiveServer@@_J@Z.c)
        ...
        struct CEndpointInstance **a6)
{
  ...
  struct BRIDGE_STREAM_DESCRIPTOR *v10; // [rsp+30h] [rbp-20h] BYREF
  struct IDeviceGraphObjectCache *v11[3]; // [rsp+38h] [rbp-18h] BYREF
  struct IAudioEndpointRT *v12; // [rsp+70h] [rbp+20h] BYREF
  struct CEndpointInstance **v13; // [rsp+78h] [rbp+28h]
  struct IAudioMediaType *v14; // [rsp+80h] [rbp+30h] BYREF
  struct IAudioProcessingObject *v15; // [rsp+88h] [rbp+38h] BYREF

  v11[1] = (struct IDeviceGraphObjectCache *)-2LL;
  v13 = 0LL;
  v6 = a6;
  *a6 = 0LL;
  v14 = a4;
  ...
  if ( !v8 )
  {
    v7 = -2147024882;
LABEL_8:
    AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateApoEndpointInstance", 0x289u, v7);
    goto LABEL_9;
  }
  v13 = 0LL;
...
LABEL_9:
  if ( v12 )
    ((void (__fastcall *)(struct IAudioEndpointRT *, struct IAudioEndpointRTVtbl *))v12->lpVtbl->Release)(
      v12,
      v12->lpVtbl);
