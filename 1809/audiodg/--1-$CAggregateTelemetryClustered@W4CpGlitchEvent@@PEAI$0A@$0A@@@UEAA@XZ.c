/*
 * XREFs of ??1?$CAggregateTelemetryClustered@W4CpGlitchEvent@@PEAI$0A@$0A@@@UEAA@XZ @ 0x1400159F8
 * Callers:
 *     ??1CCrossProcessBaseEndpoint@@UEAA@XZ @ 0x140015934 (--1CCrossProcessBaseEndpoint@@UEAA@XZ.c)
 *     ??1CCrossProcessEndpointTraceLogger@@UEAA@XZ @ 0x140056040 (--1CCrossProcessEndpointTraceLogger@@UEAA@XZ.c)
