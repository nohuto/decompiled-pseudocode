/*
 * XREFs of ?LogAsarUsageReporting@CSpatialCrossProcessEndpointTraceLogger@@QEAAXII@Z @ 0x14005BC34
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140088108 > 5 )
  {
    ...
    v15 = 4LL;
    v17 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140088108, &unk_140072E33, 0LL, a4, 5u, &pData);
    a2 = v9;
    v4 = v10;
  }
  LOBYTE(cData) = 1;
