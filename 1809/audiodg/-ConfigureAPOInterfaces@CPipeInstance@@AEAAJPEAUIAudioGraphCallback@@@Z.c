/*
 * XREFs of ?ConfigureAPOInterfaces@CPipeInstance@@AEAAJPEAUIAudioGraphCallback@@@Z @ 0x140006890
 * Callers:
...
LABEL_30:
    ...
    AudDGTraceLoggingErrorHelper("CPipeInstance::ConfigureAPOInterfaces", 0x1126u, v15);
  }
