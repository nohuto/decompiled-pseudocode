/*
 * XREFs of pre_c_initialization @ 0x14001B9A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AddRef@CRegObject@ATL@@UEAAKXZ @ 0x14001B240 (-AddRef@CRegObject@ATL@@UEAAKXZ.c)
 *     __scrt_initialize_onexit_tables @ 0x14001C0D0 (__scrt_initialize_onexit_tables.c)
 *     atexit @ 0x14001C308 (atexit.c)
 *     _get_startup_file_mode @ 0x14001C48C (_get_startup_file_mode.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x14001C498 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_fastfail @ 0x14001C500 (__scrt_fastfail.c)
 *     __scrt_initialize_mta @ 0x14001C694 (__scrt_initialize_mta.c)
 *     _RTC_Initialize @ 0x14001C750 (_RTC_Initialize.c)
 *     __p__commode @ 0x14001CAA6 (__p__commode.c)
 *     _configthreadlocale @ 0x14001CB06 (_configthreadlocale.c)
 *     _o__configure_wide_argv_0 @ 0x14001CB12 (_o__configure_wide_argv_0.c)
 *     _o__initialize_wide_environment_0 @ 0x14001CB4E (_o__initialize_wide_environment_0.c)
 *     _set_app_type @ 0x14001CB94 (_set_app_type.c)
 *     _o__set_fmode_0 @ 0x14001CBA0 (_o__set_fmode_0.c)
 */
