/*
 * XREFs of ?IsRightFormatSupported@CAPOProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x140017F30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioMediaType *a4)
{
  ...
  if ( v8 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAPOProcessNode::IsRightFormatSupported", 0x2BFu, v9);
  }
  return v9;
}
