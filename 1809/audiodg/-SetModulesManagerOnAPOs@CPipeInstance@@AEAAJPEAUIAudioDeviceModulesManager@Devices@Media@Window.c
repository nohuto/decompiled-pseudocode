/*
 * XREFs of ?SetModulesManagerOnAPOs@CPipeInstance@@AEAAJPEAUIAudioDeviceModulesManager@Devices@Media@Windows@@@Z @ 0x140009E70
 * Callers:
...
LABEL_16:
  if ( v3 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CPipeInstance::SetModulesManagerOnAPOs", 0xC29u, v3);
  }
  return (unsigned int)v3;
}
