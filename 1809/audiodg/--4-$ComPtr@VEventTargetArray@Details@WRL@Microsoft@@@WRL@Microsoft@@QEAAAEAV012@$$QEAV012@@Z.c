/*
 * XREFs of ??4?$ComPtr@VEventTargetArray@Details@WRL@Microsoft@@@WRL@Microsoft@@QEAAAEAV012@$$QEAV012@@Z @ 0x140048468
 * Callers:
...
__int64 *__fastcall Microsoft::WRL::ComPtr<Microsoft::WRL::Details::EventTargetArray>::operator=(__int64 *a1, char *a2)
{
  ...
  *a1 = v3;
  if ( v4 )
  {
    if ( !(unsigned int)ATL::SafeDecrementReferenceMultiThread((int *)(v4 + 12)) )
    {
