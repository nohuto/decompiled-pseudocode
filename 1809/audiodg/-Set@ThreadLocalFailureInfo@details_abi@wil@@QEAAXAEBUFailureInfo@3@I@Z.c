/*
 * XREFs of ?Set@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEBUFailureInfo@3@I@Z @ 0x14002FE7C
 * Callers:
 ...
 *     ?ResultStringSize@details@wil@@YA_KPEBG@Z @ 0x14002FD8C (-ResultStringSize@details@wil@@YA_KPEBG@Z.c)
 */
