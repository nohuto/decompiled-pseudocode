/*
 * XREFs of ?Create@CRegKey@ATL@@QEAAJPEAUHKEY__@@PEBGPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAK@Z @ 0x140050F20
 * Callers:
 ...
 * Callees:
 *     ?Close@CRegKey@ATL@@QEAAJXZ @ 0x140050EF4 (-Close@CRegKey@ATL@@QEAAJXZ.c)
 */
