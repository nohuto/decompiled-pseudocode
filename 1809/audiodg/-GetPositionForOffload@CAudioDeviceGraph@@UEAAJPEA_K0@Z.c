/*
 * XREFs of ?GetPositionForOffload@CAudioDeviceGraph@@UEAAJPEA_K0@Z @ 0x14003CAA0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *((_DWORD *)this + 64) )
  {
    ...
    else
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        v12 = 17;
LABEL_21:
        WPP_SF_D((__int64)v8[2], v12, (__int64)&WPP_c996c122903733bc288a845a1996e411_Traceguids, v11);
LABEL_32:
        v8 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
    }
...
LABEL_4:
  if ( v8 != &WPP_GLOBAL_Control && (*((_DWORD *)v8 + 7) & 0x20000) != 0 && *((_BYTE *)v8 + 25) >= 2u )
    WPP_SF_D((__int64)v8[2], 0x14u, (__int64)&WPP_c996c122903733bc288a845a1996e411_Traceguids, v7);
  AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::GetPositionForOffload", 0x1BAu, v7);
LABEL_9:
  if ( v3 )
