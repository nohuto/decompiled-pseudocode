/*
 * XREFs of ??_E?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIAudioEndpoint@@UIAudioEndpointRT@@UIAudioOutputEndpointRT@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x140030F50
 * Callers:
 *     <none>
 * Callees:
