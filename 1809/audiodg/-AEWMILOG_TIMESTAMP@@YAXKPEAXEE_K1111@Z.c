/*
 * XREFs of ?AEWMILOG_TIMESTAMP@@YAXKPEAXEE_K1111@Z @ 0x140062458
 * Callers:
        ...
        unsigned __int64 a9)
{
  ...
  void *v11; // [rsp+50h] [rbp-11h]
  int v12; // [rsp+58h] [rbp-9h]
  unsigned __int64 v13; // [rsp+60h] [rbp-1h]
  unsigned __int64 v14; // [rsp+68h] [rbp+7h]
  ...
  if ( g_u32AEWMILogLevel >= 5 )
  {
    ...
    LOWORD(EventTrace.Version) = 1282;
    v11 = a2;
