/*
 * XREFs of ?FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x14002E930
 * Callers:
        ...
        const char *a4)
{
  ...
  wil::details::ReportFailure_Hr(this, 2893LL, "internal\\sdk\\inc\\wil\\resource.h", 0LL, 0LL, retaddr, 3, -2147418113);
}
