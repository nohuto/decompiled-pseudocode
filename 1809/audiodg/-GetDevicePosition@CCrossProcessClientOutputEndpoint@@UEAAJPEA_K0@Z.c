/*
 * XREFs of ?GetDevicePosition@CCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z @ 0x140056B00
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a3)
{
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      a3 = (unsigned int)_InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this - 44) + 160LL), 0, 0);
      v8 = *(_QWORD *)(*((_QWORD *)this - 44) + 40 * a3 + 32);
      v9 = *(_DWORD *)(*((_QWORD *)this - 44) + 40 * a3 + 68);
      if ( (_DWORD)a3 == _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this - 44) + 160LL), 0, 0) )
        break;
      if ( !--v7 )
      {
        v6 = -2005139393;
...
LABEL_12:
  ...
  if ( a2 )
    v14 = *a2;
  AEWMILOG_POSITION(v14, (char *)this - 416, a3, 7u, 0LL, v14, 0LL, v10);
  if ( a2 )
    *((_QWORD *)this - 28) = *a2;
  if ( v6 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xDu, (__int64)&WPP_23cce490298439044b313548040b8dc4_Traceguids, v6);
    }
