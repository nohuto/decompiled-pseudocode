/*
 * XREFs of ?reset@shared_buffer@details@wil@@QEAAXXZ @ 0x140030A78
 * Callers:
 *     ??1ResultException@wil@@UEAA@XZ @ 0x14002E0E4 (--1ResultException@wil@@UEAA@XZ.c)
 ...
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x1400309A8 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
