/*
 * XREFs of ?LogReleaseInputDataPointer@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI_N@Z @ 0x14005C368
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140088108 > 5 )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140088108, &unk_140072D88, 0LL, a4, 5u, &pData);
  }
}
