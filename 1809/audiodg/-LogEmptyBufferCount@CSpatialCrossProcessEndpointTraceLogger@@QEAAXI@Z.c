/*
 * XREFs of ?LogEmptyBufferCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI@Z @ 0x14005BE24
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140088108 > 5 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_140088108, &unk_140072B89, 0LL, a4, 4u, &v4);
  }
}
