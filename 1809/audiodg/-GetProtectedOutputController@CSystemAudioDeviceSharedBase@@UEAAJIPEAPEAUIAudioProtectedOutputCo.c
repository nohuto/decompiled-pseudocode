/*
 * XREFs of ?GetProtectedOutputController@CSystemAudioDeviceSharedBase@@UEAAJIPEAPEAUIAudioProtectedOutputController@@@Z @ 0x140037A20
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProtectedOutputController **a3)
{
  ...
  *a3 = 0LL;
        ...
        v6 < 0) )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceSharedBase::GetProtectedOutputController", 0x23Cu, v6);
  }
  EtwEventActivityIdControl(4LL, &v10);
