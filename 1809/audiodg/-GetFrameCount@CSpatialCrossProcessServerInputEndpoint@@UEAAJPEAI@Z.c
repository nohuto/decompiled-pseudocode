/*
 * XREFs of ?GetFrameCount@CSpatialCrossProcessServerInputEndpoint@@UEAAJPEAI@Z @ 0x1400617C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  if ( !*((_BYTE *)this + 56) )
  {
    v2 = -2005139437;
LABEL_5:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessServerInputEndpoint::GetFrameCount", 223, v2);
    return v2;
  }
  if ( !a2 )
  {
    ...
    && *(_BYTE *)(v3 + 1152) )
  {
    v5 = _InterlockedCompareExchange(
           (volatile signed __int32 *)(*(_QWORD *)(v3 + 864) + 4LL * *(unsigned int *)(v3 + 1144) + 56),
           0,
           0);
  }
  else
