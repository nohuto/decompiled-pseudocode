/*
 * XREFs of ?IsProperlyInitialized@CSpatialCrossProcessClientEndpoint@@MEAAJXZ @ 0x14005A7E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (CSpatialCrossProcessBaseEndpoint::ReadCPFlags(this, a2, a3, 2289827918LL) & 0x20) != 0 || *(_BYTE *)(v3 + 968) )
    return 0;
  return v4;
}
