/*
 * XREFs of ?GetPosition@CCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z @ 0x140056FF0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  if ( a3 && !*a3 )
  {
    ...
    *a3 = v17;
    if ( a2 )
      ...
      v18 = 0LL;
    AEWMILOG_GENERIC(v17, (char *)this - 408, v12, 6u, v18, (unsigned int)(int)v16, 0LL, 0LL, 0.0, 0.0, 0.0, 0.0);
  }
  if ( a2 )
  {
    v19 = *a2;
  ...
  if ( v6 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, (__int64)&WPP_23cce490298439044b313548040b8dc4_Traceguids, v6);
    }
