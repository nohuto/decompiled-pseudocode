/*
 * XREFs of ?CreateApoEndpointInstance@CPipeInstance@@QEAAJPEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x140039E98
 * Callers:
        ...
        struct SYSTEM_AUDIO_STREAM *a4)
{
  ...
  v10 = v9;
  if ( v9 < 0 )
    AudDGTraceLoggingErrorHelper("CAPOEndpointProcessNode::CreateAPOEndpointInstance", 0x34Cu, v9);
  else
    *(_QWORD *)(v8 + 32) = v12;
  if ( v10 < 0 )
    AudDGTraceLoggingErrorHelper("CPipeInstance::CreateApoEndpointInstance", 0x450u, v10);
