/*
 * XREFs of ?TryGetFxPropertyStore@@YAJPEBGPEAPEAUIPropertyStore@@@Z @ 0x14000A600
 * Callers:
...
__int64 __fastcall TryGetFxPropertyStore(const unsigned __int16 *a1, struct IPropertyStore **a2)
{
  ...
  void (__fastcall ***v13)(_QWORD, GUID *, __int64 *); // [rsp+68h] [rbp+10h] BYREF
  __int64 v14; // [rsp+70h] [rbp+18h] BYREF
  LPVOID v15; // [rsp+78h] [rbp+20h] BYREF
  ...
  *a2 = 0LL;
  ...
  if ( v13 )
  {
    (**v13)(v13, &GUID_a4566d7a_c8f5_4150_0b7b_4ee7e744fc5c, &v14);
    v8 = v13;
    v7 = v14;
  }
  if ( v7 )
