/*
 * XREFs of ?GetCharacteristics@CCrossProcessBaseClientEndpoint@@UEAAJPEAK@Z @ 0x140054A60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  else
  {
    ...
    AudCPTraceLoggingErrorHelper("CCrossProcessBaseClientEndpoint::GetCharacteristics", 0x538u, -2147467261);
  }
  return v2;
}
