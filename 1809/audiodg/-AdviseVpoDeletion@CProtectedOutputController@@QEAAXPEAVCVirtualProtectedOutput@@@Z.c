/*
 * XREFs of ?AdviseVpoDeletion@CProtectedOutputController@@QEAAXPEAVCVirtualProtectedOutput@@@Z @ 0x14003B914
 * Callers:
 *     ?Release@CVirtualProtectedOutput@@UEAAKXZ @ 0x14003BEA0 (-Release@CVirtualProtectedOutput@@UEAAKXZ.c)
 * Callees:
