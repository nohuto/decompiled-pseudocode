/*
 * XREFs of ?GetNodeMode@CDisplayNode@@QEAAIXZ @ 0x14003F2A4
 * Callers:
      ...
      if ( v5 )
      {
        ...
        if ( v6 )
        {
          ...
          if ( v7 )
          {
            ...
            {
              Buf2 = v3;
              v9 = *(_QWORD *)&GUID_9cf2a70b_f377_403b_bd6b_360863e0355c.Data1 - v3;
              if ( *(_QWORD *)&GUID_9cf2a70b_f377_403b_bd6b_360863e0355c.Data1 == (_QWORD)v3 )
                v9 = *(_QWORD *)GUID_9cf2a70b_f377_403b_bd6b_360863e0355c.Data4 - *((_QWORD *)&Buf2 + 1);
              if ( v9 )
              {
                Buf2 = v3;
                v10 = *(_QWORD *)&GUID_4780004e_7133_41d8_8c74_660dadd2c0ee.Data1 - v3;
                if ( *(_QWORD *)&GUID_4780004e_7133_41d8_8c74_660dadd2c0ee.Data1 == (_QWORD)v3 )
                  v10 = *(_QWORD *)GUID_4780004e_7133_41d8_8c74_660dadd2c0ee.Data4 - *((_QWORD *)&Buf2 + 1);
                if ( v10 )
                {
                  Buf2 = v3;
