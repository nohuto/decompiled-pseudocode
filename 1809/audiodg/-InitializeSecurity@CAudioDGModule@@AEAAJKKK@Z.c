/*
 * XREFs of ?InitializeSecurity@CAudioDGModule@@AEAAJKKK@Z @ 0x140013BF8
 * Callers:
...
__int64 __fastcall CAudioDGModule::InitializeSecurity(CAudioDGModule *this)
{
         ...
         &SecurityDescriptorSize) )
  {
           ...
           &dwPrimaryGroupSize) )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 20LL, &WPP_711c7ea4d6ef3114826377fbf0f64df5_Traceguids, 12320LL);
      }
      ...
      WPP_SF_D(v13[2], v14, &WPP_711c7ea4d6ef3114826377fbf0f64df5_Traceguids, (unsigned int)v7);
      goto LABEL_31;
    }
  }
  LastError = GetLastError();
...
LABEL_31:
  ...
  if ( v7 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAudioDGModule::InitializeSecurity", 0x265u, v7);
  }
