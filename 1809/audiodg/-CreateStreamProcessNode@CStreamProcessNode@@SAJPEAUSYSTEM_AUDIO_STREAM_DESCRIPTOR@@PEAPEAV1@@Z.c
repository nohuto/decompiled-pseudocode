/*
 * XREFs of ?CreateStreamProcessNode@CStreamProcessNode@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAPEAV1@@Z @ 0x140010AB4
 * Callers:
        ...
        struct IAudioMediaType ***a2)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 16LL, &WPP_968226bc83e533aa0e0333cfe0d2c4af_Traceguids, v7);
  }
