/*
 * XREFs of ?Initialize@CSystemAudioDeviceOffloadGraph@@UEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@PEAUIAudioGraphCallback@@K@Z @ 0x140039240
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  __int128 v30; // [rsp+48h] [rbp-30h]
  __int128 v31; // [rsp+58h] [rbp-20h] BYREF
