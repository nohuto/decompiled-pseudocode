/*
 * XREFs of ??1?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@UIModuleCommandResult@Devices@Media@Windows@@VFtmBase@23@@Details@WRL@Microsoft@@UEAA@XZ @ 0x1400481C8
 * Callers:
 ...
 *     ??1ModuleCommandResult@Devices@Media@Windows@@MEAA@XZ @ 0x1400482C0 (--1ModuleCommandResult@Devices@Media@Windows@@MEAA@XZ.c)
