/*
 * XREFs of _dynamic_initializer_for__g_SpatialCrossProcessTelemetryProviderRegistration__ @ 0x140001290
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_SpatialCrossProcessTelemetryProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_140088108, a2, a3);
