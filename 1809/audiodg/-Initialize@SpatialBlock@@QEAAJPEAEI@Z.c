/*
 * XREFs of ?Initialize@SpatialBlock@@QEAAJPEAEI@Z @ 0x14005E778
 * Callers:
 ...
 *     ?SetPointersFromDescriptor@SpatialBlock@@AEAAXXZ @ 0x14005F24C (-SetPointersFromDescriptor@SpatialBlock@@AEAAXXZ.c)
