/*
 * XREFs of ?NDQueryInterface@CSystemEffectWrapper@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14000A270
 * Callers:
 *     <none>
 * Callees:
...
LABEL_80:
  ...
  result = CSystemEffectWrapper::QIInternal((CSystemEffectWrapper *)this, a2, this + 17);
  v3 = result;
  if ( (int)result < 0 )
    return (unsigned int)v3;
  *a3 = this + 1;
