/*
 * XREFs of __tailMerge_api_ms_win_security_base_l1_1_0_dll @ 0x14001CE18
 * Callers:
 *     __imp_load_MakeAbsoluteSD @ 0x14001CE0C (__imp_load_MakeAbsoluteSD.c)
 *     __imp_load_GetTokenInformation @ 0x14001D341 (__imp_load_GetTokenInformation.c)
 * Callees:
