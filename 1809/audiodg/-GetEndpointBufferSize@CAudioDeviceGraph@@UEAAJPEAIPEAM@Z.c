/*
 * XREFs of ?GetEndpointBufferSize@CAudioDeviceGraph@@UEAAJPEAIPEAM@Z @ 0x14003C4D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_Dg @ 0x14003D400 (WPP_SF_Dg.c)
...
LABEL_4:
  if ( v8 != &WPP_GLOBAL_Control && (*((_DWORD *)v8 + 7) & 0x20000) != 0 && *((_BYTE *)v8 + 25) >= 2u )
    WPP_SF_D((__int64)v8[2], 0x10u, (__int64)&WPP_c996c122903733bc288a845a1996e411_Traceguids, v7);
  AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::GetEndpointBufferSize", 0x168u, v7);
LABEL_9:
  if ( v3 )
