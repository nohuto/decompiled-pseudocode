/*
 * XREFs of ?GetFrequencyForOffload@CAudioDeviceGraph@@UEAAJPEA_K@Z @ 0x14003C880
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *((_DWORD *)this + 64) )
  {
      ...
      if ( v9 >= 0 )
      {
        ...
        WPP_SF_q(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0x17u,
          (__int64)&WPP_c996c122903733bc288a845a1996e411_Traceguids,
          *a2);
        goto LABEL_32;
      }
    ...
    else
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        v10 = 21;
LABEL_21:
        WPP_SF_D((__int64)v6[2], v10, (__int64)&WPP_c996c122903733bc288a845a1996e411_Traceguids, v9);
LABEL_32:
        v6 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
    }
...
LABEL_4:
  if ( v6 != &WPP_GLOBAL_Control && (*((_DWORD *)v6 + 7) & 0x20000) != 0 && *((_BYTE *)v6 + 25) >= 2u )
    WPP_SF_D((__int64)v6[2], 0x18u, (__int64)&WPP_c996c122903733bc288a845a1996e411_Traceguids, v5);
  AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::GetFrequencyForOffload", 0x20Du, v5);
LABEL_9:
  if ( v2 )
