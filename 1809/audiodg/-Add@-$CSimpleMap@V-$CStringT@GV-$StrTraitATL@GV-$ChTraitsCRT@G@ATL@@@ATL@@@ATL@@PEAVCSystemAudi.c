 ...
 *     ?ThrowMemoryException@?$CSimpleStringT@G$0A@@ATL@@KAXXZ @ 0x1400359DC (-ThrowMemoryException@-$CSimpleStringT@G$0A@@ATL@@KAXXZ.c)
 */
        ...
        _QWORD *a3)
{
  ...
  v5 = (void *)_o__recalloc(qword_140089010, (int)qword_140089020 + 1, 8LL);
  if ( !v5 )
    return 0LL;
  qword_140089010 = v5;
  v6 = (char *)_o__recalloc(qword_140089018, (int)qword_140089020 + 1, 8LL);
  if ( !v6 )
    return 0LL;
  qword_140089018 = v6;
  v7 = qword_140089020;
  v8 = (int)qword_140089020;
  v9 = (char *)qword_140089010 + 8 * (int)qword_140089020;
  if ( v9 )
  {
    v10 = (char *)*a2;
    v11 = v10 - 24;
...
LABEL_7:
    ...
    *(_DWORD *)(v16 + 8) = *v15;
    ...
    if ( v16 != -24 )
    {
      if ( v10 )
      {
        memcpy_0(v18, v10, v19);
        goto LABEL_7;
      }
      memset_0(v18, 0, v19);
    }
    *(_DWORD *)_o__errno(v18, v17, v19) = 22;
