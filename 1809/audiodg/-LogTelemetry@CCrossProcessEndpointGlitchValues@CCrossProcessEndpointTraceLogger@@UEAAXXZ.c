/*
 * XREFs of ?LogTelemetry@CCrossProcessEndpointGlitchValues@CCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x140019480
 * Callers:
 *     <none>
 * Callees:
        ...
        CCrossProcessEndpointTraceLogger::CCrossProcessEndpointGlitchValues *this)
{
  ...
  _FILETIME SystemTimeAsFileTime; // [rsp+58h] [rbp-B0h] BYREF
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v5 > 3u && TlgKeywordOn(v5, 2uLL) )
      {
        v13 = *((_QWORD *)this + 5);
        v15 = &v9;
        v19 = (char *)this + 48;
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite(v7, &unk_140072439, 0LL, (LPCGUID)v7, 0xDu, &pData);
      }
    }
    else if ( *(_DWORD *)v5 > 3u )
    {
      if ( TlgKeywordOn(v5, 0x400000000002uLL) )
      {
        v13 = *((_QWORD *)this + 5);
        v15 = &v9;
        v19 = (char *)this + 48;
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite(v6, &unk_14007256D, 0LL, (LPCGUID)v6, 0xDu, &pData);
      }
    }
  }
}
