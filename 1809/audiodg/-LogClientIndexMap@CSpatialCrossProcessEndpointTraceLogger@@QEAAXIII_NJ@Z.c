/*
 * XREFs of ?LogClientIndexMap@CSpatialCrossProcessEndpointTraceLogger@@QEAAXIII_NJ@Z @ 0x14005BD30
 * Callers:
        ...
        char a6)
{
  ...
  if ( (unsigned int)dword_140088108 > 5 )
  {
    ...
    v19 = 4LL;
    v21 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140088108, &unk_140072DD9, 0LL, a4, 9u, &pData);
  }
}
