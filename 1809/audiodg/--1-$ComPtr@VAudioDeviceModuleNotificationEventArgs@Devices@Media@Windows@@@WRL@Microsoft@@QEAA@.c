/*
 * XREFs of ??1?$ComPtr@VAudioDeviceModuleNotificationEventArgs@Devices@Media@Windows@@@WRL@Microsoft@@QEAA@XZ @ 0x140048044
 * Callers:
 *     _Windows::Media::Devices::AudioDeviceModulesManager::OnModuleChanged_::_1_::dtor$7 @ 0x14004CA4C (_Windows--Media--Devices--AudioDeviceModulesManager--OnModuleChanged_--_1_--dtor$7.c)
 * Callees:
