/*
 * XREFs of ?RemoveAt@?$CAtlList@PEAVCSubmixImpl@@V?$CElementTraits@PEAVCSubmixImpl@@@ATL@@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x140010750
 * Callers:
...
void __fastcall ATL::CAtlList<CSubmixImpl *,ATL::CElementTraits<CSubmixImpl *>>::RemoveAt(__int64 a1, __int64 *a2)
{
  ...
  if ( a2 == (__int64 *)SubmixList )
    ...
    *(_QWORD *)a2[1] = *a2;
  if ( a2 == (__int64 *)qword_1400886F8 )
    qword_1400886F8 = a2[1];
  else
    *(_QWORD *)(*a2 + 8) = a2[1];
  *a2 = qword_140088710;
  v2 = qword_140088700-- == 1;
  qword_140088710 = (__int64)a2;
  if ( v2 )
