/*
 * XREFs of ?FixupStreamPipe@CPipeInstance@@AEAAJXZ @ 0x14000B36C
 * Callers:
...
__int64 __fastcall CPipeInstance::FixupStreamPipe(CPipeInstance *this)
{
  ...
  if ( *((_DWORD *)this + 28) == 2 && *((_QWORD *)this + 4) > 1uLL )
  {
      ...
      && (*(_BYTE *)(v6 + 48) & 1) != 0 )
    {
      ...
      v11 = v20;
      v2 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, __int64))(**((_QWORD **)v1 + 29) + 24LL))(
             *((_QWORD *)v1 + 29),
             v20[4] + 8LL,
...
LABEL_68:
  ...
  if ( *((_DWORD *)v1 + 28) == 5 && *((_QWORD *)v1 + 4) == 1LL )
  {
    v19 = 0LL;
    v17 = 0LL;
    v12 = *(unsigned int **)ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::GetHead((_QWORD *)v1 + 2);
    v16[0] = GUID_c18e2f7e_933d_4965_b7d1_1eef228d2af3;
    v2 = CAPOProcessNode::CreateAPOProcessNode(
           &GUID_e916b6b2_22bd_4afc_b337_d3d9fb27670e,
           0LL,
...
LABEL_3:
  if ( v2 < 0 )
    AudDGTraceLoggingErrorHelper("CPipeInstance::FixupStreamPipe", 0x9A4u, v2);
