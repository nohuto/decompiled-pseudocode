/*
 * XREFs of ?InitializePump@CAudioDeviceGraph@@AEAAJPEAVCPipeInstance@@PEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@_N@Z @ 0x140001A24
 * Callers:
...
LABEL_15:
    ...
    AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::InitializePump", 0x521u, v9);
  }
  CoTaskMemFree(pv);
  pv = 0LL;
  if ( v12 )
