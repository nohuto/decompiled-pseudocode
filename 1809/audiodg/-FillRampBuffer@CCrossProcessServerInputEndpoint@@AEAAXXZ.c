/*
 * XREFs of ?FillRampBuffer@CCrossProcessServerInputEndpoint@@AEAAXXZ @ 0x1400149FC
 * Callers:
...
void __fastcall CCrossProcessServerInputEndpoint::FillRampBuffer(CCrossProcessServerInputEndpoint *this)
{
  ...
  v1 = *((_DWORD *)this + 20) * *((_DWORD *)this + 119);
  v2 = 128;
  v3 = *((_DWORD *)this + 24) == 8;
  ...
  if ( CCrossProcessBaseEndpoint::IsValidOffset(this, v7) && CCrossProcessBaseEndpoint::IsValidOffset(this, v8) )
  {
    ...
    memcpy_0(
      (void *)(*((_QWORD *)this + 13) + v13),
      (const void *)(*((_QWORD *)this + 8) + *(unsigned int *)(*((_QWORD *)this + 9) + 152LL)),
      v1 - (unsigned int)v13);
  }
}
