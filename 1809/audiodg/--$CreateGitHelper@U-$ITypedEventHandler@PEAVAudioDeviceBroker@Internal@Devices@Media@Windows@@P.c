        ...
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  AgileReference = v6 == 0LL ? 0x8007000E : 0;
  if ( v6 )
  {
    v9 = v5 + 6;
    ...
    if ( a1 )
    {
      ...
      AgileReference = RoGetAgileReference(0LL, &GUID_610c5f91_da25_52b0_ae7d_2d3a45cdf4ef, a1, &v12);
      if ( AgileReference >= 0 )
      {
        v10 = *v9;
        *v9 = v12;
