/*
 * XREFs of ?IsInputFormatSupported@CSystemEffectWrapper@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z @ 0x14001A770
 * Callers:
 *     <none>
 * Callees:
...
{
  return (*(__int64 (__fastcall **)(_QWORD, struct IAudioMediaType *, struct IAudioMediaType *, struct IAudioMediaType **))(**((_QWORD **)this + 16) + 56LL))(
           *((_QWORD *)this + 16),
           a2,
           a3,
           a4);
