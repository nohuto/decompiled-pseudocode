/*
 * XREFs of ?DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ @ 0x140054880
 * Callers:
...
void __fastcall CCrossProcessBaseEndpoint::DrainAndResetQueue(CCrossProcessBaseEndpoint *this)
{
  ...
  for ( i = 0; i < v2[33]; v2 = (_DWORD *)*((_QWORD *)this + 9) )
  {
    v4 = i++;
    *(_DWORD *)((v4 << 6) + *((_QWORD *)this + 14) + 4) = 0;
  }
  for ( j = 0; j < v2[34]; v2 = (_DWORD *)*((_QWORD *)this + 9) )
  {
    v6 = j++;
    *(_DWORD *)((v6 << 6) + *((_QWORD *)this + 16) + 4) = 0;
  }
  v7 = 0;
  if ( v2[35] )
  {
    ...
    {
      v8 = v7++;
      *(_DWORD *)((v8 << 6) + *((_QWORD *)this + 15) + 4) = -1;
    }
    while ( v7 < *(_DWORD *)(*((_QWORD *)this + 9) + 140LL) );
  }
  _InterlockedExchange(*((volatile __int32 **)this + 8), 0);
  _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this + 8) + 4LL), 0);
  _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this + 8) + 8LL), 0);
  _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this + 8) + 12LL), 0);
