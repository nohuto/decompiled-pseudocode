/*
 * XREFs of ?StopStream@CSubmixImpl@@UEAAJ_K@Z @ 0x1400116F0
 * Callers:
 *     ?StopStream@CProcessSubmix@@UEAAJ_K@Z @ 0x140011830 (-StopStream@CProcessSubmix@@UEAAJ_K@Z.c)
 *     ?StopStream@CStreamGroup@@UEAAJ_K@Z @ 0x140032600 (-StopStream@CStreamGroup@@UEAAJ_K@Z.c)
 * Callees:
