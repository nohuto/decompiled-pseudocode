/*
 * XREFs of ?ReleaseInputDataPointer@CCrossProcessServerInputEndpoint@@UEAAXI_K@Z @ 0x140014D70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  if ( (_DWORD)v4 && ((*(_DWORD *)(*((_QWORD *)this - 49) + 164LL) & 1) != 0 || (*((_BYTE *)this - 280) & 1) != 0) )
  {
    v5 = *((_QWORD *)this - 49);
    v6 = *(_QWORD *)(v5 + 24);
    if ( v6 < 0 )
    {
      AEWMILOG_SECURITY(v6, (char *)this - 456, a3);
    ...
    {
      v7 = (unsigned int)(v4 * *((_DWORD *)this - 94) - *((_DWORD *)this + 20)) + v6;
      if ( v7 > *(_QWORD *)(v5 + 16) )
        v7 = *(_QWORD *)(v5 + 16);
      *(_QWORD *)(v5 + 24) = v7;
    }
