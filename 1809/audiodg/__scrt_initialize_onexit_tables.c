 ...
 *     __scrt_is_ucrt_dll_in_use @ 0x14001C9A4 (__scrt_is_ucrt_dll_in_use.c)
 *     _initialize_onexit_table @ 0x14001CB42 (_initialize_onexit_table.c)
 */
...
char __fastcall _scrt_initialize_onexit_tables(unsigned int a1)
{
  ...
  if ( !byte_140088CF0 )
  {
    ...
    if ( !(unsigned int)_scrt_is_ucrt_dll_in_use() || a1 )
    {
      ...
      *((_QWORD *)&v4 + 1) = v3;
      Table._end = v3;
      *(_OWORD *)&stru_140088CD8._first = v4;
      stru_140088CD8._end = v3;
    }
    else if ( initialize_onexit_table(&Table) || initialize_onexit_table(&stru_140088CD8) )
    {
      return 0;
    }
    byte_140088CF0 = 1;
