/*
 * XREFs of ?SetEventHandle@CSpatialCrossProcessClientEndpoint@@UEAAJPEAX@Z @ 0x14005FDC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Initialize@HandleSendReceiveClient@@QEAAJPEAG@Z @ 0x140044318 (-Initialize@HandleSendReceiveClient@@QEAAJPEAG@Z.c)
 ...
 *     WPP_SF_SD @ 0x140055F0C (WPP_SF_SD.c)
 ...
 *     ?GetBuffer@?$CSimpleStringT@G$0A@@ATL@@QEAAPEAGXZ @ 0x14005FAE4 (-GetBuffer@-$CSimpleStringT@G$0A@@ATL@@QEAAPEAGXZ.c)
 */
...
LABEL_26:
  ...
  if ( v5 )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      ...
      WPP_SF_SD(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_6bfee242b46d393ee06055bf3a2863ce_Traceguids, v10, v6);
    }
    if ( v6 >= 0 )
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_D(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0xBu,
          (__int64)&WPP_6bfee242b46d393ee06055bf3a2863ce_Traceguids,
          v6);
      }
      if ( v6 == -2147023537 )
        v6 = -2004287484;
