/*
 * XREFs of ?GetBufferSize@CCrossProcessBaseClientEndpoint@@UEAAJPEAI@Z @ 0x140054980
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  {
    if ( *((_DWORD *)this - 86) )
      *a2 = *((_DWORD *)this - 62) / *((_DWORD *)this - 80);
    else
      v5 = -2005139437;
  }
  else
  ...
  if ( v5 < 0 )
  {
    ...
    AudCPTraceLoggingErrorHelper("CCrossProcessBaseClientEndpoint::GetBufferSize", 0x4ADu, v5);
  }
