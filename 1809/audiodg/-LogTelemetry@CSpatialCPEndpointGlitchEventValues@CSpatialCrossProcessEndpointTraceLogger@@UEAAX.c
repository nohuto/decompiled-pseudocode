/*
 * XREFs of ?LogTelemetry@CSpatialCPEndpointGlitchEventValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005C990
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialCrossProcessEndpointTraceLogger::CSpatialCPEndpointGlitchEventValues *this)
{
  ...
  const GUID *v9; // r9
  __int64 v10; // [rsp+38h] [rbp-79h]
  __int64 v11; // [rsp+48h] [rbp-69h] BYREF
  __int64 v12; // [rsp+50h] [rbp-61h] BYREF
  struct _FILETIME SystemTimeAsFileTime; // [rsp+58h] [rbp-59h] BYREF
  ...
  char *v21; // [rsp+B8h] [rbp+7h]
  __int64 v22; // [rsp+C0h] [rbp+Fh]
  char *v23; // [rsp+C8h] [rbp+17h]
  __int64 v24; // [rsp+D0h] [rbp+1Fh]
  char *v25; // [rsp+D8h] [rbp+27h]
  __int64 v26; // [rsp+E0h] [rbp+2Fh]
  char *v27; // [rsp+E8h] [rbp+37h]
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v5 > 3u )
      {
        if ( TlgKeywordOn(v5, 0x200000000000uLL) )
        {
          ...
          v26 = 4LL;
          v28 = 8LL;
          TlgWrite(v6, &unk_14007296D, 0LL, v7, 9u, &pData);
        }
      }
    }
    else
    {
      if ( *(_DWORD *)v5 > 3u && TlgKeywordOn(v5, 0x400000000000uLL) )
      {
        v15 = *((_QWORD *)this + 5);
        v17 = &v11;
        v19 = &v12;
        ...
        v26 = 4LL;
        v28 = 8LL;
        TlgWrite(v8, &unk_140072A14, 0LL, v9, 9u, &pData);
      }
      *((_QWORD *)this + 8) = 0LL;
    }
  }
