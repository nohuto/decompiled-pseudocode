/*
 * XREFs of ?GetPosition_NonOffload@CCrossProcessClientOutputEndpoint@@IEAAJPEA_K0@Z @ 0x140057220
 * Callers:
...
LABEL_3:
  ...
  v11 = v9[14];
  v12 = 3;
  v13 = *(_QWORD *)(*((_QWORD *)this + 8) + 128LL);
  while ( 1 )
  {
    v14 = (unsigned int)_InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this + 8) + 160LL), 0, 0);
    v15 = *(_QWORD *)(*((_QWORD *)this + 8) + 40 * v14 + 32);
    v16 = *((_QWORD *)this + 8);
    v41 = v15;
    v17 = *(_QWORD *)(v16 + 40 * v14 + 56);
    v18 = *(float *)(*((_QWORD *)this + 8) + 40 * v14 + 64);
    v19 = *(_DWORD *)(*((_QWORD *)this + 8) + 40 * v14 + 68);
    if ( (_DWORD)v14 == _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this + 8) + 160LL), 0, 0) )
      break;
    if ( !--v12 )
    {
      v4 = -2005139393;
...
LABEL_12:
    *a2 = *((_QWORD *)this + 23);
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_23cce490298439044b313548040b8dc4_Traceguids, v4);
    }
    AudCPTraceLoggingErrorHelper("CCrossProcessClientOutputEndpoint::GetPosition_NonOffload", 0x12Bu, v4);
    return v4;
  }
  v20 = *((_QWORD *)this + 8);
  v21 = *(_QWORD *)(v20 + 152) / (unsigned __int64)*((unsigned int *)this + 20);
  v39 = *(_QWORD *)(v20 + 24) / (unsigned __int64)*((unsigned int *)this + 20);
  if ( v15 >= v11 + v13 )
  {
    ...
    *a2 = v37;
    ...
    AEWMILOG_GENERIC(
      *(_QWORD *)(*((_QWORD *)this + 8) + 24LL),
      ...
      v34,
      v21,
      (double)(int)*(_QWORD *)(*((_QWORD *)this + 8) + 24LL),
