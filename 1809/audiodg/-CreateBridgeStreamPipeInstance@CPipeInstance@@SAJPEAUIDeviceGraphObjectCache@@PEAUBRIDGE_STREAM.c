/*
 * XREFs of ?CreateBridgeStreamPipeInstance@CPipeInstance@@SAJPEAUIDeviceGraphObjectCache@@PEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@PEAV1@PEAUtWAVEFORMATEX@@PEAUSYSTEM_AUDIO_STREAM@@PEAPEAV1@@Z @ 0x140039F4C
 * Callers:
        ...
        struct CPipeInstance **a7)
{
  ...
  if ( v22 < 0 )
    AudDGTraceLoggingErrorHelper("CPipeInstance::CreateBridgeStreamPipeInstance", 0x3C3u, v22);
  ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::RemoveAll((__int64)&v33);
