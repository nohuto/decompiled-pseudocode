/*
 * XREFs of ?RegisterSubkeys@CRegParser@ATL@@IEAAJPEAGPEAUHKEY__@@HH@Z @ 0x140052EC4
 * Callers:
 ...
 *     ?CanForceRemoveKey@CRegParser@ATL@@IEAAHPEBG@Z @ 0x140050DD4 (-CanForceRemoveKey@CRegParser@ATL@@IEAAHPEBG@Z.c)
 ...
 *     ?DeleteSubKey@CRegKey@ATL@@QEAAJPEBG@Z @ 0x140051A24 (-DeleteSubKey@CRegKey@ATL@@QEAAJPEBG@Z.c)
 *     ?HasSubKeys@CRegParser@ATL@@IEAAHPEAUHKEY__@@@Z @ 0x140051B2C (-HasSubKeys@CRegParser@ATL@@IEAAHPEAUHKEY__@@@Z.c)
...
LABEL_16:
      ...
      if ( v5 )
      {
        ...
        {
          if ( (unsigned int)ATL::CRegKey::Open(v32, a3, v7, 0x20019u) )
          {
            v17 = ATL::CRegKey::Create(v32, a3, v7, v16, v27);
            if ( v17 )
            {
LABEL_85:
              v26 = v17;
...
LABEL_58:
        ...
        if ( !a5 || !(unsigned int)ATL::CRegParser::HasSubKeys(0LL, v32[0]) )
        {
          ...
          if ( v12 && !HasSubKeys )
          {
            ...
            v31 = 0LL;
            hKey = a3;
            v18 = ATL::CRegKey::DeleteSubKey((ATL::CRegKey *)&hKey, v33);
            hKey = 0LL;
            ATL::CRegKey::Close(&hKey);
            if ( !v18 )
            {
...
LABEL_59:
    ...
    if ( v5 )
    {
      ...
      v31 = 0LL;
      hKey = a3;
      v11 = ATL::CRegParser::AddValue(v8, &hKey, ValueName, v7);
      hKey = 0LL;
      ATL::CRegKey::Close(&hKey);
      goto LABEL_15;
    }
