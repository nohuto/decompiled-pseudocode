/*
 * XREFs of ?LogTelemetry@CSpatialCPEndpointErrorEventValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005C740
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialCrossProcessEndpointTraceLogger::CSpatialCPEndpointErrorEventValues *this)
{
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v5 > 3u )
      {
        if ( TlgKeywordOn(v5, 0x200000000000uLL) )
        {
          ...
          v24 = 4LL;
          v26 = 4LL;
          TlgWrite(v6, &unk_140072ABB, 0LL, v7, 8u, &pData);
        }
      }
    }
    else if ( *(_DWORD *)v5 > 3u && TlgKeywordOn(v5, 0x400000000000uLL) )
    {
      ...
      v24 = 4LL;
      v26 = 4LL;
      TlgWrite(v8, &unk_14007282E, 0LL, v9, 8u, &pData);
    }
  }
}
