/*
 * XREFs of ?SetEventHandle@CCrossProcessBaseClientEndpoint@@UEAAJPEAX@Z @ 0x140055AA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCrossProcessBaseClientEndpoint::SetEventHandle(CCrossProcessBaseClientEndpoint *this, void *a2)
{
  ...
  if ( (*((_DWORD *)this + 44) & 0x40000) == 0 || *((_QWORD *)this + 9) == -4LL )
  {
LABEL_2:
    v5 = -2147418113;
  }
    ...
    if ( v7 )
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_SD(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          14,
          (unsigned int)&WPP_66a5760bf1703aef601fd26b60b3d9f6_Traceguids,
          *((_QWORD *)this + 9) + 4,
          v5);
        v9 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
      ...
      else if ( v5 >= 0 && v2 < 0 )
      {
        ...
        if ( v9 != &WPP_GLOBAL_Control && (*((_DWORD *)v9 + 7) & 0x80000) != 0 && *((_BYTE *)v9 + 25) >= 2u )
          WPP_SF_D((__int64)v9[2], 0x10u, (__int64)&WPP_66a5760bf1703aef601fd26b60b3d9f6_Traceguids, v2);
        AudCPTraceLoggingErrorHelper("CCrossProcessBaseClientEndpoint::SetEventHandle", 0x1B6u, v2);
      }
    }
    else
    {
