/*
 * XREFs of ?ReportFailure_Msg@details@wil@@YAXPEAXIPEBD110W4FailureType@2@J1PEAD@Z @ 0x14003AF5C
 * Callers:
 ...
 *     ?StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z @ 0x140030430 (-StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z.c)
 */
        ...
        char *a10)
{
  ...
  if ( a9 )
  {
    StringCchPrintfW((unsigned __int16 *)v14, 2048LL, L"%hs");
