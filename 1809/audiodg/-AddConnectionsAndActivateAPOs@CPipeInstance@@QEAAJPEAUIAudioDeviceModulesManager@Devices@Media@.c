/*
 * XREFs of ?AddConnectionsAndActivateAPOs@CPipeInstance@@QEAAJPEAUIAudioDeviceModulesManager@Devices@Media@Windows@@@Z @ 0x140009910
 * Callers:
...
LABEL_9:
    ...
    {
      v16 = CPipeInstance::ActivateAPOs(this, v22);
      v14 = v16;
      if ( v16 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
      ...
      {
        v17 = (*(__int64 (__fastcall **)(_QWORD, unsigned __int64))(**((_QWORD **)this + 18) + 40LL))(
                *((_QWORD *)this + 18),
                v22);
        v14 = v17;
        if ( v17 < 0 )
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( !v12 )
    {
      v13 = CConnectionInstance::AddRenderConnection(v10, v11, v22);
      v14 = v13;
      if ( v13 >= 0 )
        goto LABEL_6;
      v19 = 242LL;
    ...
    if ( v12 != 1 )
      break;
    v13 = CConnectionInstance::AddCaptureConnection(v10, v11, v22);
    v14 = v13;
    if ( v13 >= 0 )
    {
LABEL_6:
...
LABEL_13:
  if ( v6 )
    (*(void (__fastcall **)(_QWORD, unsigned __int64))(**((_QWORD **)this + 18) + 48LL))(*((_QWORD *)this + 18), v22);
