/*
 * XREFs of ?RemoveAll@?$CSimpleMap@PEAGPEAGVCExpansionVectorEqualHelper@ATL@@@ATL@@QEAAXXZ @ 0x140053550
 * Callers:
 *     ??1CRegObject@ATL@@UEAA@XZ @ 0x14004FE70 (--1CRegObject@ATL@@UEAA@XZ.c)
