/*
 * XREFs of ??1CWin32Heap@ATL@@UEAA@XZ @ 0x14001B57C
 * Callers:
 *     ATL::_dynamic_atexit_destructor_for__g_strheap__ @ 0x1400213C0 (ATL--_dynamic_atexit_destructor_for__g_strheap__.c)
