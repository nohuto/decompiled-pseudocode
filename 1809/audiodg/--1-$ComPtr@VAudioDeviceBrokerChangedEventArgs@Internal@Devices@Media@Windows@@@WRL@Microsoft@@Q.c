/*
 * XREFs of ??1?$ComPtr@VAudioDeviceBrokerChangedEventArgs@Internal@Devices@Media@Windows@@@WRL@Microsoft@@QEAA@XZ @ 0x140048020
 * Callers:
 *     _Windows::Media::Devices::Internal::AudioDeviceBroker::CMModulesNotificationCallback_::_1_::dtor$3 @ 0x14004933D (_Windows--Media--Devices--Internal--AudioDeviceBroker--CMModulesNotificationCallbac_ea_14004933D.c)
 *     _Windows::Media::Devices::Internal::AudioDeviceBroker::ThreadpoolCallback_::_1_::dtor$1 @ 0x14004E864 (_Windows--Media--Devices--Internal--AudioDeviceBroker--ThreadpoolCallback_--_1_--dtor$1.c)
 * Callees:
