  ...
  *v17 = 0;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v6 )
    {
      while ( 1 )
      {
        v4 = lambda_6e535b2589e16be8e59d14ca837e6d0f_::operator()((__int64)v12, v7, &v13);
        if ( v4 < 0 )
          break;
    ...
    {
      v4 = lambda_6e535b2589e16be8e59d14ca837e6d0f_::operator()((__int64)v12, v7, (_DWORD *)(a1 + 40));
    }
