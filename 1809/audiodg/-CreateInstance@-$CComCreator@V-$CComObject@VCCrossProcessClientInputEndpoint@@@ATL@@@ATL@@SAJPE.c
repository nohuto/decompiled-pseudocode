/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCCrossProcessClientInputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140051534
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  try
  {
    v8 = (CCrossProcessClientInputEndpoint *)AERTAllocate(0x220uLL, v7);
    v12[5] = v8;
    if ( v8 )
  ...
  if ( v10 )
  {
    Microsoft::WRL::Details::SafeUnknownIncrementReference((CCrossProcessClientInputEndpoint *)((char *)v10 + 488), v9);
