/*
 * XREFs of ?Add@CAudioHistoryBufferManager@@QEAAJ_K0@Z @ 0x1400424D0
 * Callers:
...
__int64 __fastcall CAudioHistoryBufferManager::Add(LPCRITICAL_SECTION lpCriticalSection, __int64 a2, char *a3)
{
  ...
  ATL::CAtlException *v14; // [rsp+58h] [rbp-20h] BYREF
...
LABEL_3:
  ...
  v12[0] = 0LL;
  v17 = a3;
  v6 = Microsoft::WRL::Details::MakeAndInitialize<CCPAudioHistoryControl,ICPAudioHistoryControl,unsigned __int64 &>(
         v12,
         &v17);
  if ( v6 < 0 )
  {
