/*
 * XREFs of ?SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x140014B20
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(struct AE_CURRENT_POSITION *)(v5 + *((_QWORD *)this + 8) + 32) = *a2;
  _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this + 8) + 160LL), v4);
  v7 = _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this + 8) + 164LL), 0, 0);
  if ( (v7 & 2) == 0 )
  {
    *(_QWORD *)(*((_QWORD *)this + 8) + 112LL) = a2->u64DevicePosition;
    *(_QWORD *)(*((_QWORD *)this + 8) + 128LL) = a2->u64PaddingFrames;
    *(_QWORD *)(*((_QWORD *)this + 8) + 136LL) = a2->hnsQPCPosition;
    _InterlockedExchange64((volatile __int64 *)(*((_QWORD *)this + 8) + 152LL), a3);
    _InterlockedOr((volatile signed __int32 *)(*((_QWORD *)this + 8) + 164LL), 6u);
  }
  if ( (unsigned int)dword_140088010 > 5 )
  {
    ...
    v9[1] = 5;
    v11 = off_140088018;
    v9[0] = ((unsigned int)&unk_14007236D - (unsigned int)&TraceLoggingMetadata) | 0xB000000;
    v10 = 0LL;
    v12 = *(unsigned __int16 *)off_140088018;
    v14 = &unk_140072378;
    v13 = 2;
    v15 = 112;
    v16 = 1;
    EtwEventWriteTransfer(qword_140088030, v9, 0LL, 0LL, 9, &v11);
  }
}
