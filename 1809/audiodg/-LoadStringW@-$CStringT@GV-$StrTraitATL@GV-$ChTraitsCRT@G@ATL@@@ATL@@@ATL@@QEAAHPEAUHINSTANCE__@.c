/*
 * XREFs of ?LoadStringW@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAAHPEAUHINSTANCE__@@I@Z @ 0x14003571C
 * Callers:
 ...
 *     _o_wmemcpy_s_0 @ 0x14001CC00 (_o_wmemcpy_s_0.c)
