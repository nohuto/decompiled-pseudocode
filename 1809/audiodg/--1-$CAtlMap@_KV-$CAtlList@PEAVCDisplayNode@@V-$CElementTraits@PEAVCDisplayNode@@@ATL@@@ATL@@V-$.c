/*
 * XREFs of ??1?$CAtlMap@_KV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@V?$CElementTraits@_K@2@V?$CElementTraits@V?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@@2@@ATL@@QEAA@XZ @ 0x14003531C
 * Callers:
 *     _PublishDeviceGraphWnfState_::_1_::dtor$1 @ 0x140020AD0 (_PublishDeviceGraphWnfState_--_1_--dtor$1.c)
 *     _PublishDeviceGraphWnfState_::_1_::dtor$2 @ 0x140020AF0 (_PublishDeviceGraphWnfState_--_1_--dtor$2.c)
 * Callees:
      ...
      if ( v4 )
      {
        do
        {
          ...
          *(_QWORD *)(a1 + 8) = v7;
          ...
          if ( !v8 )
            ATL::CAtlMap<unsigned __int64,wil::com_ptr_t<ICPAudioHistoryControl,wil::err_returncode_policy>,ATL::CElementTraits<unsigned __int64>,ATL::CElementTraits<wil::com_ptr_t<ICPAudioHistoryControl,wil::err_returncode_policy>>>::FreePlexes(a1);
        }
        while ( v4 );
        v2 = *(void **)a1;
      }
