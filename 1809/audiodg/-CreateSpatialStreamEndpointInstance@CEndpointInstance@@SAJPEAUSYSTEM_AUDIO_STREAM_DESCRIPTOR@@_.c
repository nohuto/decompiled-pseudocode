/*
 * XREFs of ?CreateSpatialStreamEndpointInstance@CEndpointInstance@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@_JIPEAUSYSTEM_AUDIO_STREAM@@PEAPEAV1@@Z @ 0x14003D6AC
 * Callers:
        ...
        struct CEndpointInstance **a5)
{
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    WPP_SF_DDD(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      0xEu,
      (__int64)&WPP_aaa44b5172b232dd71a9829e6fd58753_Traceguids,
      v10);
    v13 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  v14 = *((_QWORD *)a1 + 2);
  if ( (*((_DWORD *)a1 + 22) & 0x40000) != 0 )
  {
    ...
    if ( started < 0 )
    {
      ...
      AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateSpatialStreamEndpointInstance", 0x20Fu, started);
      v8 = v26[0];
LABEL_15:
      v13 = (_UNKNOWN **)WPP_GLOBAL_Control;
      goto LABEL_16;
      ...
      if ( started >= 0 )
      {
        ...
        if ( started >= 0 )
        {
          ...
          *((_DWORD *)a4 + 4) = v12 * *((unsigned __int16 *)v25 + 6);
          v18 = (CEndpointInstance *)operator new(0x20uLL);
          v25 = v18;
          if ( v18 )
            v18 = CEndpointInstance::CEndpointInstance(v18, (struct IUnknown *)v7, v8, 0LL);
          if ( v18 )
          {
            *v27 = v18;
            goto LABEL_22;
...
LABEL_16:
  if ( v13 != &WPP_GLOBAL_Control && (*((_DWORD *)v13 + 7) & 0x20000) != 0 && *((_BYTE *)v13 + 25) >= 2u )
    WPP_SF_D((__int64)v13[2], 0x11u, (__int64)&WPP_aaa44b5172b232dd71a9829e6fd58753_Traceguids, started);
  AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateSpatialStreamEndpointInstance", 0x252u, started);
  if ( v8 )
    (**(void (__fastcall ***)(struct HandleSendReceiveServer *, __int64))v8)(v8, 1LL);
LABEL_22:
  v16 = (void *)*((_QWORD *)a1 + 12);
  if ( v16 )
  {
    CoTaskMemFree(v16);
    *((_QWORD *)a1 + 12) = 0LL;
