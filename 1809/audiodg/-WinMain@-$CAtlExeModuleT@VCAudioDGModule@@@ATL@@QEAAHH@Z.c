/*
 * XREFs of ?WinMain@?$CAtlExeModuleT@VCAudioDGModule@@@ATL@@QEAAHH@Z @ 0x140013FDC
 * Callers:
 ...
 *     ?ParseCommandLine@CAudioDGModule@@QEAA_NPEBGPEAJ@Z @ 0x1400139AC (-ParseCommandLine@CAudioDGModule@@QEAA_NPEBGPEAJ@Z.c)
...
__int64 __fastcall ATL::CAtlExeModuleT<CAudioDGModule>::WinMain(CAudioDGModule *this, int a2)
{
  ...
  if ( CAudioDGModule::ParseCommandLine((void **)this, CommandLineW, v6) == 1 )
  {
    ...
    v13[1] = &v14;
    v13[0] = this;
    v7 = lambda_d1de4b53b525fd4013d62472baaa2c14_::operator()(v13);
