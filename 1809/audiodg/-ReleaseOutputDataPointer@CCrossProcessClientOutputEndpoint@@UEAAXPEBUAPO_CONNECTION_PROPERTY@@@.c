/*
 * XREFs of ?ReleaseOutputDataPointer@CCrossProcessClientOutputEndpoint@@UEAAXPEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x140057930
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  v7 = 0;
  v8 = *(_QWORD *)(*((_QWORD *)this - 48) + 16LL);
  v9 = (unsigned int)u32ValidFrameCount;
  AEWMILOG_DATA((unsigned int)this, (char *)this - 448, a3, 0x13u, u32ValidFrameCount, v8, 0LL);
  ...
  v11 = *((_DWORD *)this - 74);
  v12 = *((_QWORD *)this - 47);
  v7 = u32ValidFrameCount * *((_DWORD *)this - 92);
  v13 = *(_DWORD *)(v12 + 152) + v8 % v11;
  if ( v13 > *(_DWORD *)(v12 + 156) )
    goto LABEL_17;
  LOBYTE(v12) = 1;
  if ( (unsigned int)u32ValidFrameCount >= *((_DWORD *)this + 5) || (v14 = 1, (*((_BYTE *)this - 272) & 1) == 0) )
    v14 = 0;
  _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this - 48) + 176LL), v14);
  v11 = *((_DWORD *)this + 4);
  if ( !v11 )
  {
  ...
  if ( v11 != 1 )
    goto LABEL_17;
  v15 = *(_DWORD *)(*((_QWORD *)this - 47) + 156LL);
  if ( v13 + v7 > v15 )
  {
    v18 = v15 - v13;
    v19 = (void *)(*((_QWORD *)this - 48) + v13);
    if ( a2->u32BufferFlags == BUFFER_VALID )
    {
      memcpy_0(v19, *((const void **)this - 43), v18);
      memcpy_0(
        (void *)(*((_QWORD *)this - 48) + *(unsigned int *)(*((_QWORD *)this - 47) + 152LL)),
        (const void *)(v18 + *((_QWORD *)this - 43)),
        v7 - v18);
LABEL_27:
      v11 = _InterlockedExchangeAdd64((volatile signed __int64 *)(*((_QWORD *)this - 48) + 16LL), v7);
      goto LABEL_17;
    }
    v20 = 128;
    v21 = 128;
    ...
    v22 = v7 - v18;
    v23 = *(unsigned int *)(*((_QWORD *)this - 47) + 152LL);
    if ( *((_DWORD *)this - 88) != 8 )
      v20 = 0;
LABEL_26:
    memset_0((void *)(*((_QWORD *)this - 48) + v23), v20, v22);
    goto LABEL_27;
  }
  if ( v7 <= v15 )
  {
    v16 = (void *)(*((_QWORD *)this - 48) + v13);
    if ( a2->u32BufferFlags == BUFFER_VALID )
    {
      memcpy_0(v16, *((const void **)this - 43), v7);
    }
    else
    {
      v17 = 128;
    ...
    _InterlockedExchangeAdd64((volatile signed __int64 *)(*((_QWORD *)this - 48) + 16LL), v7);
  }
LABEL_17:
  if ( *((_QWORD *)this - 3) )
  {
