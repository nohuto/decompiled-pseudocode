/*
 * XREFs of ?RegisterThread@GraphStreamingResourceManager@@UEAAJPEAXPEAPEAUThreadRegistrationToken__@@@Z @ 0x140018AB0
 * Callers:
 *     <none>
 * Callees:
...
{
  struct ThreadRegistrationToken__ **v3; // rsi
  void *v4; // r14
  ...
  char v15; // [rsp+48h] [rbp-80h] BYREF
  __int64 *v16; // [rsp+50h] [rbp-78h]
  _QWORD v17[4]; // [rsp+58h] [rbp-70h] BYREF
  _BYTE v18[8]; // [rsp+78h] [rbp-50h] BYREF
...
LABEL_3:
  v9 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*((_QWORD *)v5 - 1) + 48LL))((__int64)v5 - 8, v4, v8 + 16);
  if ( v9 < 0 )
    goto LABEL_5;
  goto LABEL_4;
}
