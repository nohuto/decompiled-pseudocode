/*
 * XREFs of privateCreateSpatialCrossProcessEndpoint @ 0x14005AF10
 * Callers:
...
__int64 __fastcall privateCreateSpatialCrossProcessEndpoint(_QWORD *a1, _OWORD *a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( v6 )
  {
    ...
    v13 = (CSpatialCrossProcessClientOutputEndpoint *)AERTAllocate(0x438uLL, v12);
    if ( v13 )
  ...
  else
  {
    ...
    v9 = (CSpatialCrossProcessServerInputEndpoint *)AERTAllocate(0x4A0uLL, v8);
    if ( v9 )
