/*
 * XREFs of ?CommitWrite@CSpatialCrossProcessBaseEndpoint@@IEAAJII@Z @ 0x14005DB5C
 * Callers:
        ...
        __int32 a3)
{
  ...
  if ( a2 > 1 )
  {
    v4 = -2005139345;
LABEL_10:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::CommitWrite", 953, v4);
    return v4;
  }
  v5 = 16;
