/*
 * XREFs of ?CreateStreamInstance@CStreamProcessNode@@QEAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@_JIPEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x14001866C
 * Callers:
        ...
        struct SYSTEM_AUDIO_STREAM *a5)
{
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CStreamProcessNode::CreateStreamInstance", 0x1DFu, v7);
  }
  else
  {
    *((_QWORD *)this + 4) = v9;
