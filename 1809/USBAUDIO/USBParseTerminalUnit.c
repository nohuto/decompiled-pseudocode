/*
 * XREFs of USBParseTerminalUnit @ 0x1C002B830
 * Callers:
 *     <none>
 * Callees:
 *     BusApiBuildTerminalFunctionUnit @ 0x1C0027808 (BusApiBuildTerminalFunctionUnit.c)
 *     USBParseGetMicArrayDescriptor @ 0x1C002ADCC (USBParseGetMicArrayDescriptor.c)
 *     USBParseGetPinIndexForStreamingTerminal @ 0x1C002B280 (USBParseGetPinIndexForStreamingTerminal.c)
