/*
 * XREFs of USBHwGetSetProperty @ 0x1C0028C78
 * Callers:
 *     USBHwGetSetByte @ 0x1C0028DD0 (USBHwGetSetByte.c)
 *     USBHwGetSetShort @ 0x1C0028E80 (USBHwGetSetShort.c)
 ...
 *     USBCntrlMuxSource @ 0x1C002DB50 (USBCntrlMuxSource.c)
 *     USBCntrlGetSetMixerLevels @ 0x1C002DC00 (USBCntrlGetSetMixerLevels.c)
