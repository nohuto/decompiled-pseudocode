/*
 * XREFs of USBType1AdjustPositionWithin1Ms @ 0x1C0003760
 * Callers:
...
unsigned __int64 __fastcall USBType1AdjustPositionWithin1Ms(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( CurrentTime < v10 )
    v10 = CurrentTime;
  v11 = CurrentTime - v10;
  v12 = (CurrentTime - v10) * (unsigned int)(*(_DWORD *)(v4 + 8) * *(_DWORD *)(a1 + 104)) / (1000 * a2);
  v13 = v11 * (unsigned __int64)(unsigned int)(*(_DWORD *)(v4 + 8) * *(_DWORD *)(a1 + 104)) / (1000 * a2);
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_ii(
      (__int64)WPP_GLOBAL_Control->DeviceExtension,
      v11 * (unsigned __int64)(unsigned int)(*(_DWORD *)(v4 + 8) * *(_DWORD *)(a1 + 104)) % (1000 * a2),
      v11,
      0xAu,
