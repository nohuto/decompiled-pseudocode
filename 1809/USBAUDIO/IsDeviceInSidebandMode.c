/*
 * XREFs of IsDeviceInSidebandMode @ 0x1C00078C4
 * Callers:
...
__int64 __fastcall IsDeviceInSidebandMode(__int64 a1, _DWORD *a2)
{
  ...
  unsigned int v4; // edi
  __int64 v5; // r8
  __int64 Alertable; // [rsp+28h] [rbp-40h]
  PLARGE_INTEGER Timeout; // [rsp+30h] [rbp-38h]
  PVOID Object[2]; // [rsp+40h] [rbp-28h] BYREF
  union _LARGE_INTEGER v10; // [rsp+70h] [rbp+8h] BYREF
