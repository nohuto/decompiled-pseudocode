/*
 * XREFs of USBParseGetMicArrayDescriptor @ 0x1C002ADCC
 * Callers:
 ...
 *     USBHwGetSetMemory @ 0x1C0028F40 (USBHwGetSetMemory.c)
 */
...
LABEL_13:
  ...
  {
    v12 = *(void **)(a1 + 8);
    v16 = ExAllocatePoolWithTag(PagedPool, 12LL * (unsigned __int16)PoolWithTag[17] + 18, 0x41627845u);
    v7 = v16;
    if ( v16 )
