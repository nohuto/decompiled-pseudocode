/*
 * XREFs of ?RecurseBackward@CSidebandDevice@@AEAAJPEAU_KSFILTER_DESCRIPTOR@@PEBUKSTOPOLOGY_CONNECTION@@KPEAU_LIST_ENTRY@@@Z @ 0x1C000881C
 * Callers:
 *     ?RecurseBackward@CSidebandDevice@@AEAAJPEAU_KSFILTER_DESCRIPTOR@@PEBUKSTOPOLOGY_CONNECTION@@KPEAU_LIST_ENTRY@@@Z @ 0x1C000881C (-RecurseBackward@CSidebandDevice@@AEAAJPEAU_KSFILTER_DESCRIPTOR@@PEBUKSTOPOLOGY_CONNECTION@@KPEA.c)
...
__int64 __fastcall CSidebandDevice::RecurseBackward(
        ...
        struct _LIST_ENTRY *a5)
{
  ...
  v9 = -1073741275;
  if ( a3->FromNode == -1 )
    return a4 != a3->FromNodePin ? 0xC0000225 : 0;
  ...
  if ( ConnectionsCount )
  {
    for ( i = &Connections->ToNode; ; i += 4 )
    {
      if ( *i == a3->FromNode )
      {
        v15 = CSidebandDevice::RecurseBackward(v8, a2, &Connections[v12], a4, a5);
        Connections = v20;
        v9 = v15;
        v8 = this;
      }
    ...
    LODWORD(PoolWithTag[1].Flink) = a3->FromNode;
    Flink = a5->Flink;
