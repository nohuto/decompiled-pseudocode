/*
 * XREFs of RegistryReadName @ 0x1C0026F3C
 * Callers:
 *     PropertyGetPinName @ 0x1C0024340 (PropertyGetPinName.c)
 * Callees:
...
NTSTATUS __fastcall RegistryReadName(__int64 a1, const GUID *a2, unsigned int a3, void *a4, ULONG *a5)
{
  ...
  KeyHandle = 0LL;
  *a5 = 0;
  result = IoOpenDeviceRegistryKey(*(PDEVICE_OBJECT *)(a1 + 32), 2u, 0x20019u, &DeviceRegKey);
  if ( result >= 0 )
  {
