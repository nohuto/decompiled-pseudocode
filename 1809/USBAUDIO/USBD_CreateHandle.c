/*
 * XREFs of USBD_CreateHandle @ 0x1C000EBF8
 * Callers:
 ...
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C000E348 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
