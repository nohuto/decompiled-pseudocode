/*
 * XREFs of PropertyAudioSignalProcessingBasicSupport @ 0x1C0024B20
 * Callers:
 *     <none>
 * Callees:
 *     PropertyAudioSignalProcessingPinValidation @ 0x1C0024A7C (PropertyAudioSignalProcessingPinValidation.c)
 */
