/*
 * XREFs of _ctrlfp @ 0x1C0010324
 * Callers:
 *     _call_matherr @ 0x1C000FC08 (_call_matherr.c)
...
__int64 __fastcall ctrlfp(int a1, int a2)
{
  ...
  if ( byte_1C0017530 && (((unsigned __int8)(a2 & a1) | fpsr & ((unsigned __int8)~(_BYTE)a2 | 0x7F)) & 0x40) != 0 )
    set_fpsr(v5);
  else
