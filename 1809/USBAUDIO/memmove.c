 ...
 *     PropertyGetMicArrayGeometry @ 0x1C00249B0 (PropertyGetMicArrayGeometry.c)
 *     PropertyAudioSignalProcessing @ 0x1C0024BD0 (PropertyAudioSignalProcessing.c)
 *     RegistryReadNameValue @ 0x1C0026D28 (RegistryReadNameValue.c)
 *     RegistryGetValue @ 0x1C00272C8 (RegistryGetValue.c)
 *     WmiQueryRegInfo @ 0x1C00278B0 (WmiQueryRegInfo.c)
 ...
 *     USBCntrlGetDescriptor @ 0x1C002DE60 (USBCntrlGetDescriptor.c)
 *     USBCaptureCopyRequestToBuffer @ 0x1C002F1D4 (USBCaptureCopyRequestToBuffer.c)
 *     USBMidiInCopyEvent @ 0x1C002F890 (USBMidiInCopyEvent.c)
 * Callees:
 *     <none>
 */
