/*
 * XREFs of PropertyGetDbLevelSideband @ 0x1C002581C
 * Callers:
...
__int64 __fastcall PropertyGetDbLevelSideband(__int64 a1, __int64 a2, _DWORD *a3, unsigned int a4, _DWORD *a5)
{
  __int64 result; // rax
  __int64 v6; // rcx
