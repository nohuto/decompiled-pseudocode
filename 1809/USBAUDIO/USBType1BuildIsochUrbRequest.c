/*
 * XREFs of USBType1BuildIsochUrbRequest @ 0x1C0004584
 * Callers:
 *     USBType1Build1MsecIsocRequest @ 0x1C0004CD0 (USBType1Build1MsecIsocRequest.c)
 *     USBType1ProcessStreamPointer @ 0x1C0004EA4 (USBType1ProcessStreamPointer.c)
        ...
        __int64 (__fastcall *a2)(__int64 a1, __int64 a2, __int64 *a3))
{
  ...
  PSLIST_ENTRY v65; // [rsp+60h] [rbp-19h]
  __int64 v66; // [rsp+68h] [rbp-11h]
  char *v67; // [rsp+70h] [rbp-9h]
  ...
  *((_QWORD *)&ListEntry.Next + 1) = &ListEntry;
  ...
  while ( v10 >= 0 && !v6 )
  {
    if ( v2 == USBType1MsCompleteCallback )
    {
      ...
      v13 = 1;
      v65 = (PSLIST_ENTRY)v5->Context;
    }
    else
    {
      v14 = *(_QWORD *)(v8 + 128);
      ++*(_DWORD *)(v14 + 20);
      v65 = ExpInterlockedPopEntrySList((PSLIST_HEADER)v14);
      v12 = v65;
      if ( !v65 )
      {
...
LABEL_29:
    ...
    *((_QWORD *)&v30[2].Next + 1) = 0LL;
    HIDWORD(Size) = KsStreamPointerClone(StreamPointer, 0LL, 0, (PKSSTREAM_POINTER *)&v30[2].Next + 1);
    v10 = HIDWORD(Size);
    if ( Size >= 0 )
    {
...
LABEL_34:
  ...
  if ( Remaining )
  {
    if ( !v6 )
    {
      ...
      {
        v32[1].OffsetOut.Remaining = v11 - Remaining;
        v33 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)Context + 14);
        v34 = (struct _KSPIN *)v5->Context;
        p_Pin = &v32[2].Pin;
        v36 = *p_Pin;
        if ( (*p_Pin)->Bag != p_Pin )
LABEL_71:
      ...
      else
      {
        ...
        *((_DWORD *)&v38->ConnectionIsExternal + 1) = Size;
        memmove(v39, v5->OffsetIn.Data, (unsigned int)Size);
...
LABEL_47:
    ...
    v40 = v2 == USBType1MsCompleteCallback;
  }
  else
  {
    v40 = !v7;
  ...
  if ( p_ListEntry != &ListEntry )
  {
    do
    {
      ...
      *((_QWORD *)&Next->Next + 1) = &ListEntry;
      ...
      IoInitializeIrp(v44, 72 * *(char *)(*(_QWORD *)(v43 + 40) + 76LL) + 208, *(_BYTE *)(*(_QWORD *)(v43 + 40) + 76LL));
      ...
      if ( IofCallDriver(*(PDEVICE_OBJECT *)(v43 + 40), (PIRP)p_ListEntry[1].Next) >= 0
