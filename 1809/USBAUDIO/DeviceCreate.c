/*
 * XREFs of DeviceCreate @ 0x1C0001DC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     InitializeSidebandContext @ 0x1C0007378 (InitializeSidebandContext.c)
 *     _guard_dispatch_icall_nop @ 0x1C0010480 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C00113C0 (memset.c)
 *     WmiRegisterProvider @ 0x1C0027A94 (WmiRegisterProvider.c)
 */
...
__int64 __fastcall DeviceCreate(__int64 a1, __int64 a2)
{
  ...
  {
    *(_QWORD *)(a1 + 16) = v8;
    memset(v8, 0, 0x3E0uLL);
    InitializeSidebandContext(v8 + 88);
    ...
    *((_BYTE *)v8 + 64) = 1;
    ...
    if ( v10 )
    {
      ...
      PoCreatePowerRequest((PVOID *)v8 + 64, *(PDEVICE_OBJECT *)(a1 + 24), &Context);
    }
    KeInitializeEvent((PRKEVENT)(v8 + 68), NotificationEvent, 1u);
    KeInitializeSpinLock((PKSPIN_LOCK)v8 + 79);
    KeInitializeSemaphore((PRKSEMAPHORE)(v8 + 82), 0, 0x7FFFFFFF);
    v8[81] = (PDRIVER_CONTROL)(v8 + 80);
    v8[80] = (PDRIVER_CONTROL)(v8 + 80);
    v3 = IoCsqInitialize(
           (PIO_CSQ)(v8 + 71),
           CsInsertIrp,
