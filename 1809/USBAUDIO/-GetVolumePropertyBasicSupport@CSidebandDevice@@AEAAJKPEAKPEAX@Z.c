/*
 * XREFs of ?GetVolumePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000A4A0
 * Callers:
        ...
        void *a4)
{
  ...
  if ( PinFromEpIndex >= 0 )
  {
    ...
    if ( PinFromEpIndex >= 0 )
    {
      ...
      if ( PinFromEpIndex >= 0 )
      {
        PinFromEpIndex = PropertyGetDbBasicSupportSideband(*(_QWORD *)(v9 + 200) + v17 * *(_DWORD *)(v9 + 196), a3, a4);
        v12 = PinFromEpIndex;
        if ( PinFromEpIndex >= 0 )
          goto LABEL_12;
        v13 = 101;
