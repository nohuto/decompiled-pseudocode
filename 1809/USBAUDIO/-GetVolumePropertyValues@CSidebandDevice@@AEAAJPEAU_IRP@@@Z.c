/*
 * XREFs of ?GetVolumePropertyValues@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C000C218
 * Callers:
...
LABEL_3:
  ...
  VolumePropertyBasicSupport = CSidebandDevice::GetVolumePropertyBasicSupport(this, NamedPipeType, &Length, UserBuffer);
  if ( VolumePropertyBasicSupport >= 0 )
    Irp->IoStatus.Information = Length;
  WPP_RECORDER_SF_dq((__int64)WPP_GLOBAL_Control->DeviceExtension, v10, v11, 0x1Cu, v13);
LABEL_9:
