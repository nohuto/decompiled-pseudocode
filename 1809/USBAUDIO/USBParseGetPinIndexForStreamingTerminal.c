/*
 * XREFs of USBParseGetPinIndexForStreamingTerminal @ 0x1C002B280
 * Callers:
 *     USBParseTerminalUnit @ 0x1C002B830 (USBParseTerminalUnit.c)
 *     USBParseMIDIInJack @ 0x1C002C430 (USBParseMIDIInJack.c)
 *     USBParseMIDIOutJack @ 0x1C002C520 (USBParseMIDIOutJack.c)
 * Callees:
