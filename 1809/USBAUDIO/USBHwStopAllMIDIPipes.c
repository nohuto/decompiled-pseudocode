/*
 * XREFs of USBHwStopAllMIDIPipes @ 0x1C002A2FC
 * Callers:
 *     USBDeviceStop @ 0x1C00287A0 (USBDeviceStop.c)
 *     USBDeviceSetPowerState @ 0x1C0028A20 (USBDeviceSetPowerState.c)
 * Callees:
 *     USBHwStopMIDIPipe @ 0x1C0002C58 (USBHwStopMIDIPipe.c)
 */
