/*
 * XREFs of USBHwGetClockRatio @ 0x1C0003050
 * Callers:
...
__int64 __fastcall USBHwGetClockRatio(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  __int64 v3; // rdi
  int v5; // r14d
  ...
  *(_BYTE *)(v3 + 12) = 1;
  if ( *(_DWORD *)(v3 + 24) )
  {
    if ( !*(_DWORD *)(v3 + 40) )
    {
      ...
      if ( v18 > 0x7A120 )
      {
        v8 = UsbHwFrameCountTimestamp(a1, &v28, v24);
        v6 = v24[0];
        v5 = v28;
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
          WPP_RECORDER_SF_did((__int64)WPP_GLOBAL_Control->DeviceExtension, v19, v20, 0x2Au, v23);
      }
  ...
  else
  {
    ...
    v13 = v24[0];
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_did((__int64)WPP_GLOBAL_Control->DeviceExtension, v10, v11, 0x29u, v23);
    v9 = KeAcquireSpinLockRaiseToDpc(v7);
    if ( v8 >= 0 )
    {
      *(_DWORD *)(v3 + 24) = v12;
