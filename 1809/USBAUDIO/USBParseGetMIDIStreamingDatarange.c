/*
 * XREFs of USBParseGetMIDIStreamingDatarange @ 0x1C002D100
 * Callers:
        ...
        _QWORD *PoolWithTag)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v20 )
    {
      ...
      *((_OWORD *)v11 + 1) = xmmword_1C0014340;
      *((_DWORD *)v11 + 24) = ((v26 >> 31) & 8) + 8;
      *((_OWORD *)v11 + 2) = xmmword_1C0014350;
      *((_OWORD *)v11 + 3) = xmmword_1C0014360;
      *((_OWORD *)v11 + 4) = xmmword_1C0014370;
      *((_OWORD *)v11 + 5) = xmmword_1C0014380;
      *a5 = v11;
      v27 = 88;
