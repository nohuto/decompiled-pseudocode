/*
 * XREFs of ?GetMuteImmediate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C000A630
 * Callers:
 ...
 *     PropertyGetBooleanSideband @ 0x1C0025330 (PropertyGetBooleanSideband.c)
 */
...
LABEL_9:
  ...
  PinFromEpIndex = CSidebandDevice::GetBridgePinForDataPin(this, (struct _KSFILTER_DESCRIPTOR *)(v5 + 128), v15, &v16);
  v7 = PinFromEpIndex;
  if ( PinFromEpIndex < 0 )
  {
    v10 = 105;
