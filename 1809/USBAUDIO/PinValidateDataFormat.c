/*
 * XREFs of PinValidateDataFormat @ 0x1C0020954
 * Callers:
 ...
 *     PinMIDIDataFormatIntersection @ 0x1C00214C0 (PinMIDIDataFormatIntersection.c)
 * Callees:
 *     IsSampleRateInRange @ 0x1C002082C (IsSampleRateInRange.c)
