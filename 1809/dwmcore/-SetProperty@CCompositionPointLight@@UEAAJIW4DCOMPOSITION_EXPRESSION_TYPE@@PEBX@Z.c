/*
 * XREFs of ?SetProperty@CCompositionPointLight@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801904E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionPointLight::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  v12[0] = 8LL;
  v12[1] = &CCompositionPointLight::k_rgAnimDef;
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v10 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0xAFu);
  }
  else
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0xB3u);
  }
  return v10;
}
