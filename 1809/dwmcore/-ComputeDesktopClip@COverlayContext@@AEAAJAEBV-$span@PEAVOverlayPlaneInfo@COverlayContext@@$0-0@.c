/*
 * XREFs of ?ComputeDesktopClip@COverlayContext@@AEAAJAEBV?$span@PEAVOverlayPlaneInfo@COverlayContext@@$0?0@gsl@@AEAVCRegion@@@Z @ 0x18016A614
 * Callers:
        ...
        const struct FastRegion::Internal::CRgnData **a3)
{
  ...
  while ( --v15 >= 0 )
  {
    ...
    if ( (v3 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v3, 0xD7Eu);
      return v3;
    }
    if ( !*(_BYTE *)(*(_QWORD *)gsl::span<COverlayContext::OverlayPlaneInfo *,-1>::operator[](a2, v15) + 187LL) )
    {
      ...
      v19 = FastRegion::CRegion::Union(a3, *(const struct FastRegion::Internal::CRgnData ***)(*(_QWORD *)v18 + 168LL));
      v3 = v19;
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0xD85u);
        return v3;
      }
    }
  }
