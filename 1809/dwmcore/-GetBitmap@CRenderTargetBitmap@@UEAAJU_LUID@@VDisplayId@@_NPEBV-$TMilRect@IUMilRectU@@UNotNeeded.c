/*
 * XREFs of ?GetBitmap@CRenderTargetBitmap@@UEAAJU_LUID@@VDisplayId@@_NPEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@2PEAPEAUID2D1Bitmap1@@@Z @ 0x180094CF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
    v16 = v14;
LABEL_19:
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v16, v17);
    return v14;
  }
