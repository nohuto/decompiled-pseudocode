/*
 * XREFs of ?Thunk_UpdateHoverPointer_140@?$IManipulation_Receive@VCManipulationManager@@@@SAJPEAXPEAPEAX@Z @ 0x180018410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IManipulation_Receive<CManipulationManager>::Thunk_UpdateHoverPointer_140(__int64 a1, __int64 **a2)
{
  __int64 *v2; // rcx
  __int64 v3; // rbx
