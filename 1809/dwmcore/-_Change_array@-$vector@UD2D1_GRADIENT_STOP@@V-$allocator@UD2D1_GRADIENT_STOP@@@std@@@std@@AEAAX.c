/*
 * XREFs of ?_Change_array@?$vector@UD2D1_GRADIENT_STOP@@V?$allocator@UD2D1_GRADIENT_STOP@@@std@@@std@@AEAAXQEAUD2D1_GRADIENT_STOP@@_K1@Z @ 0x1800063B8
 * Callers:
...
__int64 __fastcall std::vector<D2D1_GRADIENT_STOP>::_Change_array(__int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = *a1;
  if ( v6 )
    std::_Deallocate<16,0>(v6, 20 * ((a1[2] - v6) / 20));
  *a1 = a2;
  result = 5 * a4;
  a1[1] = a2 + 20 * a3;
  a1[2] = a2 + 20 * a4;
