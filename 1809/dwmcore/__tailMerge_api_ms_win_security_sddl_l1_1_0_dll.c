/*
 * XREFs of __tailMerge_api_ms_win_security_sddl_l1_1_0_dll @ 0x1800EC847
 * Callers:
 *     __imp_load_ConvertStringSecurityDescriptorToSecurityDescriptorW @ 0x1800EC83B (__imp_load_ConvertStringSecurityDescriptorToSecurityDescriptorW.c)
 * Callees:
