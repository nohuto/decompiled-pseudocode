/*
 * XREFs of ?Join@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBG_N@Z @ 0x1800857D8
 * Callers:
 ...
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x180084254 (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
        ...
        _WORD *a5)
{
  ...
  const char *v24; // r9
  __int64 v25; // rcx
  Microsoft::BamoImpl::BamoImplObject *v26; // rcx
  __int64 v28; // rdx
  __int64 v29; // rdx
  __int64 v30; // r9
  ...
  *(_DWORD *)&v37[4] = *(_DWORD *)L"O";
  ...
  if ( v35 )
  {
    ...
    else
    {
      *(_OWORD *)v37 = *v36;
      v31 = v37;
      ConversationHost = (*(__int64 (__fastcall **)(__int64 *, wil::details *, _WORD *, __int64))(*a2 + 304))(
                           a2,
                           v15,
                           a5,
                           v34);
      ...
      else
      {
        ...
        *(_QWORD *)(a1 + 48) = 0LL;
        ...
        if ( ConversationHost >= 0 )
        {
          v19 = *a2;
          v33 = 0LL;
          v20 = (*(__int64 (__fastcall **)(__int64 *, __int64 *))(v19 + 40))(a2, &v33);
          if ( v20 < 0 )
          {
          ...
          v21 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v33 + 120LL))(v33, a1 + 24);
          if ( v21 < 0 )
          {
            wil::details::in1diag3::FailFast_Hr(
              retaddr,
          ...
          *(_QWORD *)(a1 + 40) = 0LL;
          ...
          v26 = *(Microsoft::BamoImpl::BamoImplObject **)(a1 + 64);
          v9 = 0LL;
          *(_QWORD *)(a1 + 64) = v8;
          if ( v26 )
          {
            Microsoft::BamoImpl::BamoImplObject::Release(v26, (__int64)v22, v23, v24);
...
LABEL_29:
  if ( v9 )
    Microsoft::BamoImpl::BamoImplObject::Release(v9, (__int64)v22, v23, v24);
  return v12;
}
