/*
 * XREFs of _dynamic_initializer_for__CManipulationManager::s_InputQueue__ @ 0x180002B10
 * Callers:
 *     <none>
 * Callees:
 *     ??0?$CQueue@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@QEAA@XZ @ 0x18007BF28 (--0-$CQueue@V-$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@QEAA@XZ.c)
 */
