/*
 * XREFs of ?Append_Convert_BetweenInterchange@ScanPipelineBuilder@@IEAAJW4DXGI_FORMAT@@0W4Subpipe@1@@Z @ 0x18021642C
 * Callers:
    ...
    switch ( (_DWORD)a3 )
    {
      case 2:
        ...
        else
        {
          ...
          {
            v3 = -2003304320;
            MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, -2003304320, 0x190u);
            return v3;
          }
      ...
      case 0xB:
        ...
        else
        {
          ...
          {
            v3 = -2003304320;
            MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, -2003304320, 0x17Au);
            return v3;
          }
      ...
      case 0x57:
        ...
        else
        {
          ...
          {
            v3 = -2003304320;
            MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, -2003304320, 0x164u);
            return v3;
          }
...
LABEL_26:
        MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, v7);
        break;
    }
  }
  return v3;
