/*
 * XREFs of ?GetTextureMemoryLayoutData@CSurfaceBrush@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801B4420
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?swap@?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@QEAAXAEAV12@@Z @ 0x1801B486C (-swap@-$vector@ULayoutData@CContent@@V-$allocator@ULayoutData@CContent@@@std@@@std@@QEAAXAEAV12@.c)
 */
...
__int64 __fastcall CSurfaceBrush::GetTextureMemoryLayoutData(CSurfaceBrush *this, struct D2D_SIZE_F *a2, __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 8) = *(_QWORD *)a3;
          ...
          79LL) )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x1B8u);
    }
                ...
                109LL) )
    {
      ...
      v27 = 0LL;
      v26 = 0LL;
      v16 = (*(__int64 (__fastcall **)(__int64, struct D2D_SIZE_F *, __int128 *))(*(_QWORD *)v15 + 272LL))(
              v15,
              a2,
              &v26);
      v8 = v16;
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x1CDu);
      }
      else
      {
