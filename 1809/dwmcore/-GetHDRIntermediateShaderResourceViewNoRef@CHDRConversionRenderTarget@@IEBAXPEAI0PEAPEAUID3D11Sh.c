/*
 * XREFs of ?GetHDRIntermediateShaderResourceViewNoRef@CHDRConversionRenderTarget@@IEBAXPEAI0PEAPEAUID3D11ShaderResourceView@@@Z @ 0x180208DE0
 * Callers:
        ...
        struct ID3D11ShaderResourceView **a4)
{
  ...
  v7 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 74) + 104LL))(*((_QWORD *)this + 74));
  *a2 = *(_DWORD *)(v7 + 140);
  *a3 = *(_DWORD *)(v7 + 144);
