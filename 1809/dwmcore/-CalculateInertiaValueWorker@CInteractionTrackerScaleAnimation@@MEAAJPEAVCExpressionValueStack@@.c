/*
 * XREFs of ?CalculateInertiaValueWorker@CInteractionTrackerScaleAnimation@@MEAAJPEAVCExpressionValueStack@@_KMPEAM@Z @ 0x1801D83A0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, updated, 0x120u);
  }
  return v15;
}
