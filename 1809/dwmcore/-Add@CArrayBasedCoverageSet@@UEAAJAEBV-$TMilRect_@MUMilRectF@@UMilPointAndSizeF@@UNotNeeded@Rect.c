/*
 * XREFs of ?Add@CArrayBasedCoverageSet@@UEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@HPEBVCMILMatrix@@@Z @ 0x1800AC0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CArrayBasedCoverageSet::Add(__int64 a1, float *a2, int a3, CMILMatrix *a4)
{
  ...
  v20 = v8;
  v13 = DynArray<CZOrderedRect,0>::AddMultipleAndSet((__int64 *)(a1 + 24), (__int64)&v17);
  v15 = v13;
  if ( v13 < 0 )
