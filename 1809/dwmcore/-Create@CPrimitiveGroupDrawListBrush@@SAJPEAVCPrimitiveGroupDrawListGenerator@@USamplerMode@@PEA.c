/*
 * XREFs of ?Create@CPrimitiveGroupDrawListBrush@@SAJPEAVCPrimitiveGroupDrawListGenerator@@USamplerMode@@PEAPEAV1@@Z @ 0x18000E314
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = v11;
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, -2147024882, 0x17u);
  }
  return v6;
}
