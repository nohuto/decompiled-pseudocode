/*
 * XREFs of ?SetMultiplaneOverlayPresentInfo@CHDRConversionRenderTarget@@UEAAJ_NW4DXGI_HDR_METADATA_TYPE@@PEBXIPEAU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@PEAPEAVCBitmapRealization@@@Z @ 0x18020A020
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CBitmapRealization **a7)
{
  ...
  v19 = CHDRConversionRenderTarget::CalcPresentMode((CHDRConversionRenderTarget *)((char *)this - 208));
  v21 = v19;
  if ( v19 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x2CEu);
  if ( v7 == 2 && *((_DWORD *)this + 120) != 2 )
  {
    ...
    v24 = v22;
    if ( v22 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x2D9u);
    if ( !v21 || v21 >= 0 && v24 < 0 )
      v21 = v24;
  }
  v25 = *((_QWORD *)this + 4);
  if ( v25 )
  {
    ...
    (*(void (__fastcall **)(__int64, __int64, const void *))(*(_QWORD *)v25 + 120LL))(v25, v27, v26);
  }
