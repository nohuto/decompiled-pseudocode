/*
 * XREFs of ?SetProperty@CLinearGradientBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A4F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLinearGradientBrush::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  v12[0] = 2LL;
  v12[1] = &CLinearGradientBrush::k_rgAnimDef;
