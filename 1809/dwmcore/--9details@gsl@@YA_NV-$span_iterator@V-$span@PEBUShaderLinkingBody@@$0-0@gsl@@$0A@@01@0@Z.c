/*
 * XREFs of ??9details@gsl@@YA_NV?$span_iterator@V?$span@PEBUShaderLinkingBody@@$0?0@gsl@@$0A@@01@0@Z @ 0x1800713A0
 * Callers:
...
bool __fastcall gsl::details::operator!=(_OWORD *a1, _OWORD *a2)
{
  return *a1 != *a2;
}
