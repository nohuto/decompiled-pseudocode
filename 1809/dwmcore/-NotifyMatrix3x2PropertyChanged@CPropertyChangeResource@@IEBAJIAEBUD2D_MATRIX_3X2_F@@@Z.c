/*
 * XREFs of ?NotifyMatrix3x2PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2D_MATRIX_3X2_F@@@Z @ 0x18001ED2C
 * Callers:
        ...
        const struct D2D_MATRIX_3X2_F *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, a2) )
  {
    ...
    v3 = CoreUICallSend(v11, v14, 2LL, 12LL, 6, &unk_180276453, v6, &v15);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v3, 0x1D0u);
  }
