/*
 * XREFs of ??0CInteractionContextWrapper@@QEAA@XZ @ 0x180089448
 * Callers:
 ...
 *     ??0CInteractionContextTransformHelper@@QEAA@XZ @ 0x1800895FC (--0CInteractionContextTransformHelper@@QEAA@XZ.c)
 */
