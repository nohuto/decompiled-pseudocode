/*
 * XREFs of ?AddVisualTreeDataToList@CVisual@@IEAAXPEAVCVisualTreeData@@@Z @ 0x18002CAB8
 * Callers:
 *     ?Link@CVisualTreeData@@MEAAXXZ @ 0x18002CA60 (-Link@CVisualTreeData@@MEAAXXZ.c)
 * Callees:
  ...
  if ( !TreeDataListHead )
  {
    ...
    if ( *(int *)v6 < 0 )
    {
      ...
      if ( i < (unsigned int)v9 )
        v4 = (struct _LIST_ENTRY **)(v6 + v9 + 15 + 8LL * i - (((_BYTE)v9 + 15) & 7));
      *v4 = TreeDataListHead;
    }
    else
    {
      *(_QWORD *)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((char *)this + 224, 1LL) = TreeDataListHead;
    }
  }
