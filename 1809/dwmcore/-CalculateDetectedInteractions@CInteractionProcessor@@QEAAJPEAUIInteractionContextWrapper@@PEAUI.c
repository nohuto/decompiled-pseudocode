/*
 * XREFs of ?CalculateDetectedInteractions@CInteractionProcessor@@QEAAJPEAUIInteractionContextWrapper@@PEAUInteractionAxisGroup@@PEAH12PEAV?$DynArray@PEAUInteractionConfigurationGroup@@$0A@@@2@Z @ 0x1801EEEB8
 * Callers:
 *     ?CalculateDetectedInteractions@CInteraction@@UEAAJPEAUIInteractionContextWrapper@@PEAUInteractionAxisGroup@@PEAH12PEAV?$DynArray@PEAUInteractionConfigurationGroup@@$0A@@@2@Z @ 0x18019BE40 (-CalculateDetectedInteractions@CInteraction@@UEAAJPEAUIInteractionContextWrapper@@PEAUInteractio.c)
 *     ?CalculateDetectedInteractions@CInteractionRoot@@UEAAJPEAUIInteractionContextWrapper@@PEAUInteractionAxisGroup@@PEAH12PEAV?$DynArray@PEAUInteractionConfigurationGroup@@$0A@@@2@Z @ 0x1801F6860 (-CalculateDetectedInteractions@CInteractionRoot@@UEAAJPEAUIInteractionContextWrapper@@PEAUIntera.c)
 * Callees:
...
LABEL_41:
          ...
          v42 = *(_DWORD *)(v50 + 24);
          v43 = v42 + 1;
          v12 = v42 + 1 < v42 ? 0x80070216 : 0;
          if ( v42 + 1 < v42 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v12, 0xB5u);
          }
          else if ( v43 > *(_DWORD *)(v50 + 20) )
          {
            v44 = DynArrayImpl<0>::AddMultipleAndSet(v50, 8, 1, &v47);
            v12 = v44;
            if ( v44 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(v45, 0LL, 0, v44, 0xC0u);
          }
          else
          {
            *(_QWORD *)(*(_QWORD *)v50 + 8LL * v42) = v47;
            *(_DWORD *)(v41 + 24) = v43;
          }
          if ( v12 >= 0 )
          {
