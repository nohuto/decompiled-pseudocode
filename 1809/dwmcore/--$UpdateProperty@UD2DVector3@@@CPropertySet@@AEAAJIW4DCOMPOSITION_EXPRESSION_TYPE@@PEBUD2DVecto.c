/*
 * XREFs of ??$UpdateProperty@UD2DVector3@@@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector3@@@Z @ 0x180016034
 * Callers:
...
__int64 __fastcall CPropertySet::UpdateProperty<D2DVector3>(CResource *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(*v6 + 8 * v8) == v7 )
  {
    ...
    *(_DWORD *)(v14 + v13 + 8) = *(_DWORD *)(a4 + 8);
    v15 = CPropertySet::PropertyUpdated<D2DMatrix>(this, v12);
    v17 = v15;
    if ( v15 < 0 )
