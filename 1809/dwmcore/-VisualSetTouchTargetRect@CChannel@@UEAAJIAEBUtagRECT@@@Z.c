/*
 * XREFs of ?VisualSetTouchTargetRect@CChannel@@UEAAJIAEBUtagRECT@@@Z @ 0x18009A1C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetTouchTargetRect(CDataStreamWriter **this, int a2, const struct tagRECT *a3)
{
