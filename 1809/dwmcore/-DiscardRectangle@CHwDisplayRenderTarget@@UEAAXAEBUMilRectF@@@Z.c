/*
 * XREFs of ?DiscardRectangle@CHwDisplayRenderTarget@@UEAAXAEBUMilRectF@@@Z @ 0x18005F4A0
 * Callers:
 *     ?DiscardRectangle@CHwDisplayRenderTarget@@WNA@EAAXAEBUMilRectF@@@Z @ 0x1800F10C0 (-DiscardRectangle@CHwDisplayRenderTarget@@WNA@EAAXAEBUMilRectF@@@Z.c)
 * Callees:
