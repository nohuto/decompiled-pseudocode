/*
 * XREFs of ?Initialize@CInteractionRoot@@QEAAJPEAUIManipulationContext@@_N@Z @ 0x18019C224
 * Callers:
 ...
 * Callees:
 *     ?SetInteractionConfiguration@CInteractionProcessor@@QEAAJW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@PEBXI@Z @ 0x1800223C0 (-SetInteractionConfiguration@CInteractionProcessor@@QEAAJW4Enum@InteractionConfigurationUpdateTy.c)
...
__int64 __fastcall CInteractionRoot::Initialize(CInteractionRoot *this, struct IManipulationContext *a2, char a3)
{
  ...
  *((_QWORD *)this + 173) = a2;
  ...
  {
    v12 = (char *)this + 32;
    v13 = CInteractionProcessor::Initialize((CInteractionRoot *)((char *)this + 32), v6, v8, v10, v11);
  }
  else
  {
LABEL_16:
  ...
  if ( v13 >= 0 )
  {
    ...
    v20 = -805306369;
    v13 = CInteractionProcessor::SetInteractionConfiguration((__int64)v12, 0, 1, (int *)&v19, 1u);
    if ( v13 >= 0 )
    {
      v19 = 0xFFFFFFFF00000001uLL;
      v20 = -805306369;
      v13 = CInteractionProcessor::SetInteractionConfiguration((__int64)v12, 0, 2, (int *)&v19, 1u);
      if ( v13 >= 0 )
      {
        LODWORD(v16) = -805306369;
        v13 = CInteractionProcessor::SetInteractionConfiguration((__int64)v12, 0, 4, (int *)&v16, 1u);
        if ( v13 >= 0 )
        {
          v19 = 0xFFFFFFFF00000001uLL;
          v20 = -805306369;
          v13 = CInteractionProcessor::SetInteractionConfiguration((__int64)v12, 0, 5, (int *)&v19, 1u);
          if ( v13 >= 0 )
          {
            v19 = 0xFFFFFFFF00000001uLL;
            v20 = -805306369;
            v13 = CInteractionProcessor::SetInteractionConfiguration((__int64)v12, 0, 3, (int *)&v19, 1u);
            if ( v13 >= 0 )
            {
              if ( a3 )
              {
