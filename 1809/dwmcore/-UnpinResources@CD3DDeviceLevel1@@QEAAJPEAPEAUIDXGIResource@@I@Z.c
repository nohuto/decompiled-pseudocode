/*
 * XREFs of ?UnpinResources@CD3DDeviceLevel1@@QEAAJPEAPEAUIDXGIResource@@I@Z @ 0x1801FD46C
 * Callers:
...
__int64 __fastcall CD3DDeviceLevel1::UnpinResources(CD3DDeviceLevel1 *this, struct IDXGIResource **a2, unsigned int a3)
{
  ...
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v6, 0xB5u);
      }
      else if ( v7 > *((_DWORD *)v8 + 5) )
      {
        v11 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v8, 8, 1, &v14);
        v6 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v11, 0xC0u);
      }
      else
      {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v6, 0xFDAu);
  }
  return (unsigned int)v6;
}
