/*
 * XREFs of ?Scribble@CSuperWetInkScribble@@UEAAJPEAUID3D12GraphicsCommandList@@PEAUID3D12Resource@@PEAW4D3D12_RESOURCE_STATES@@PEAUComputeScribbleLatencyData@@PEAUtagRECT@@@Z @ 0x180184040
 * Callers:
 *     <none>
 * Callees:
