/*
 * XREFs of ?SaveRestoreWorker@CDxHandleAdvancedDirectFlipBitmapRealization@@IEAAJAEBVCRegion@@_N@Z @ 0x180227B7C
 * Callers:
        ...
        char a3)
{
  ...
  *(_QWORD *)&v28.left = 0LL;
  ...
  if ( D3DDevice < 0 )
  {
    v25 = 403;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, D3DDevice, v25);
    goto LABEL_21;
  }
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x194u);
    goto LABEL_21;
  }
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x19Au);
    goto LABEL_16;
  }
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x19Cu);
LABEL_16:
    v3 = (CD3DSurface *)v34;
    goto LABEL_21;
  }
