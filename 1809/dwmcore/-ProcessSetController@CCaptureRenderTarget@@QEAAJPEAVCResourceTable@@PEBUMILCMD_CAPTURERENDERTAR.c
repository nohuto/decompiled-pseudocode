/*
 * XREFs of ?ProcessSetController@CCaptureRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMILCMD_CAPTURERENDERTARGET_SETCONTROLLER@@@Z @ 0x18015899C
 * Callers:
...
__int64 __fastcall CCaptureRenderTarget::ProcessSetController(
        ...
        const struct MILCMD_CAPTURERENDERTARGET_SETCONTROLLER *a3)
{
