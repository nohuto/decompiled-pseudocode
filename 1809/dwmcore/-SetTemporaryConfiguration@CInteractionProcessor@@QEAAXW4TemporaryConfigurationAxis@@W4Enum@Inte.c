/*
 * XREFs of ?SetTemporaryConfiguration@CInteractionProcessor@@QEAAXW4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x1801F29F0
 * Callers:
...
char __fastcall CInteractionProcessor::SetTemporaryConfiguration(_BYTE *a1, int a2, int a3, unsigned __int8 a4, int a5)
{
  ...
  {
    result = TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL);
    if ( result )
    {
      v32 = a1;
      v34 = &v32;
      ...
      v54 = &v31;
      v55 = 4LL;
      return TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B7610, 0LL, 0LL, 0xDu, &pData);
    }
  }
  return result;
}
