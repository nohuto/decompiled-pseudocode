/*
 * XREFs of ?SetProperty@CViewBox@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801B5CA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CViewBox::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x2Du);
  }
  return v10;
}
