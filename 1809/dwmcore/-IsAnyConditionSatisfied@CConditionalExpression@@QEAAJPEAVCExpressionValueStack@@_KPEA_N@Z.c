/*
 * XREFs of ?IsAnyConditionSatisfied@CConditionalExpression@@QEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1801932E4
 * Callers:
        ...
        bool *a4)
{
  ...
  if ( v9 != v11 )
    goto LABEL_11;
  v12 = 0;
  if ( !((__int64)(*((_QWORD *)this + 38) - *((_QWORD *)this + 37)) >> 4) )
  {
LABEL_9:
    v11 = *((_DWORD *)this + 73);
    if ( v9 == v11 )
...
LABEL_11:
    if ( a4 )
    {
      if ( v9 != *((_DWORD *)this + 72) && v9 != v11 || *((_QWORD *)this + 40) )
        v4 = 1;
      *a4 = v4;
    }
    return v10;
  ...
  while ( 1 )
  {
    ...
    if ( ++v12 >= (unsigned __int64)((__int64)(*((_QWORD *)this + 38) - *((_QWORD *)this + 37)) >> 4) )
    {
      v9 = *((_DWORD *)this + 83);
      goto LABEL_9;
    }
  }
  MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x25Cu);
  return v10;
}
