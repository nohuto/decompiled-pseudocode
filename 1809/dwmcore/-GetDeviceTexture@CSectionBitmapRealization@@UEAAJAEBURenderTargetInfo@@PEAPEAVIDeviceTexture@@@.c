/*
 * XREFs of ?GetDeviceTexture@CSectionBitmapRealization@@UEAAJAEBURenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z @ 0x180094C50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDeviceTexture **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802925E8, 1u, v7, 0xDDu);
  }
  else if ( *((_QWORD *)this + 40) )
  {
    ...
    if ( DeviceTextureInternal < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802925E8, 1u, DeviceTextureInternal, 0xE2u);
  }
  else
  {
