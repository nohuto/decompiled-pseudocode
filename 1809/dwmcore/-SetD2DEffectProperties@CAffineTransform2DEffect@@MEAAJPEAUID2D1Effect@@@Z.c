/*
 * XREFs of ?SetD2DEffectProperties@CAffineTransform2DEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1801C0D90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1Effect *a2)
{
  ...
  *((float *)&v27 + 1) = v12 - v2;
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x92u);
  }
  else
  {
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x93u);
    }
    else
    {
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x94u);
      }
      else
      {
        ...
        v16 = v21;
        if ( v21 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v21, 0x95u);
      }
    }
  }
  return v16;
