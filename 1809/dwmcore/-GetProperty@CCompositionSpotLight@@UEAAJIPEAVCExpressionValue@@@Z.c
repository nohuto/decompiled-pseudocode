/*
 * XREFs of ?GetProperty@CCompositionSpotLight@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180057580
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0xA4u);
  }
  return v3;
}
