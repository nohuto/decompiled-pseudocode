/*
 * XREFs of ?OnRemoveDataSourceError@BamoDataProviderProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180170F7C
 * Callers:
 *     ?OnRemoveDataSourceError@BamoDataProviderProxy@@UEAAJI@Z @ 0x180170F30 (-OnRemoveDataSourceError@BamoDataProviderProxy@@UEAAJI@Z.c)
 * Callees:
...
LABEL_3:
  ...
  v4[0] = v6;
  v4[1] = v7;
  return CoreUICallSend(v8, v4, 2LL, 0LL, 3, &unk_18027732D);
}
