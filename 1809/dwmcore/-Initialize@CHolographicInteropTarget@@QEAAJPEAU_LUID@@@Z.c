/*
 * XREFs of ?Initialize@CHolographicInteropTarget@@QEAAJPEAU_LUID@@@Z @ 0x180210CE4
 * Callers:
...
__int64 __fastcall CHolographicInteropTarget::Initialize(CHolographicInteropTarget *this, struct _LUID *a2)
{
  ...
  *((_QWORD *)this + 21) = v4;
  ...
  {
    v5 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147418113, 0x4Du);
    return v5;
  }
  *((_DWORD *)this + 47) = 87;
...
LABEL_11:
      v5 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147024882, v15);
      return v5;
    }
    ++v7;
    ++v6;
  ...
  v5 = D3DDevice;
  if ( D3DDevice < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, D3DDevice, 0x5Du);
  return v5;
}
