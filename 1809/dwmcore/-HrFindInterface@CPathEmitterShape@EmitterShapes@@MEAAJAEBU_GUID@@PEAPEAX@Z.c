/*
 * XREFs of ?HrFindInterface@CPathEmitterShape@EmitterShapes@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801DCBE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EmitterShapes::CPathEmitterShape::HrFindInterface(
        ...
        void **a3)
{
  ...
  {
    v4 = -2147467262;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147467262, 0x5Fu);
  }
  else
  {
