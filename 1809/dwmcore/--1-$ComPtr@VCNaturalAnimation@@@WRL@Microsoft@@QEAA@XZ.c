/*
 * XREFs of ??1?$ComPtr@VCNaturalAnimation@@@WRL@Microsoft@@QEAA@XZ @ 0x18019DA40
 * Callers:
...
void __fastcall Microsoft::WRL::ComPtr<CNaturalAnimation>::~ComPtr<CNaturalAnimation>(__int64 *a1)
{
  __int64 v2; // rcx
