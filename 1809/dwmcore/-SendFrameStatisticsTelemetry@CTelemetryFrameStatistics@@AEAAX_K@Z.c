/*
 * XREFs of ?SendFrameStatisticsTelemetry@CTelemetryFrameStatistics@@AEAAX_K@Z @ 0x1800817EC
 * Callers:
 ...
 * Callees:
 *     GetProcessAndSessionId @ 0x180081A04 (GetProcessAndSessionId.c)
...
void __fastcall CTelemetryFrameStatistics::SendFrameStatisticsTelemetry(CTelemetryFrameStatistics *this, __int64 a2)
{
  ...
  if ( *((_DWORD *)this + 8) )
  {
    ...
    if ( dword_180305E80 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E80, 0x400000000000uLL) )
    {
      ...
      v49 = 4;
      v21 = v12 / v6;
      TlgWrite((TraceLoggingHProvider)&dword_180305E80, &unk_1802B3AD2, 0LL, 0LL, 0xBu, &pData);
    }
