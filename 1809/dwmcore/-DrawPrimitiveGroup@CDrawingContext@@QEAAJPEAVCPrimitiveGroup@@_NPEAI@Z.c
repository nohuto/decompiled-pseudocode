/*
 * XREFs of ?DrawPrimitiveGroup@CDrawingContext@@QEAAJPEAVCPrimitiveGroup@@_NPEAI@Z @ 0x180163D4C
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  {
    v12 = (*(__int64 (__fastcall **)(struct CPrimitiveGroup *, _QWORD, _QWORD, struct D2D_RECT_F *))(*(_QWORD *)v9 + 168LL))(
            a2,
            0LL,
            0LL,
            &v35);
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x6E0u);
    }
    else
    {
      ...
      *((_QWORD *)&v34 + 1) = 0x3F8000003F800000LL;
      ...
      v14 = v15;
      if ( v15 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x6E3u);
    }
    goto LABEL_29;
  }
  if ( v11 )
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x6EFu);
    goto LABEL_29;
  }
  v19 = *((_DWORD *)this + 816);
  if ( v19 )
...
LABEL_18:
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, ClippedD2D1CommandListForContext, 0x721u);
    goto LABEL_29;
  }
  ...
  if ( v26 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0x726u);
    goto LABEL_29;
  }
  if ( !CCommonRegistryData::m_fRenderPathTestMode )
    goto LABEL_25;
  v28 = (*(__int64 (__fastcall **)(struct CPrimitiveGroup *, _QWORD, _QWORD, struct D2D_RECT_F *, unsigned int))(*(_QWORD *)a2 + 168LL))(
          a2,
          0LL,
          0LL,
          &v35,
  ...
  if ( v28 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, v28, 0x72Du);
    goto LABEL_29;
  }
  *(_QWORD *)&v34 = 0LL;
...
LABEL_25:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v30, 0x730u);
LABEL_29:
