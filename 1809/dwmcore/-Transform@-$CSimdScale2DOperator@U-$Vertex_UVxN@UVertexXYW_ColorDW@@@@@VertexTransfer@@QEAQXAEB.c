/*
 * XREFs of ?Transform@?$CSimdScale2DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@VertexTransfer@@QEAQXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@T__m128@@2IPEAU3@@Z @ 0x1801898D8
 * Callers:
        ...
        __m128 *a7)
{
  ...
  *a7 = _mm_shuffle_ps(
  ...
  if ( a6 )
  {
    ...
    do
    {
      *(__m128 *)((char *)result + (_QWORD)v15) = _mm_add_ps(
                                                    _mm_mul_ps(
