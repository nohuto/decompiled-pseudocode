/*
 * XREFs of ?QueuePointerFrame@GestureTargeting@InputTraceLogging@@SAX_K0KK@Z @ 0x1801EBFDC
 * Callers:
...
void __fastcall InputTraceLogging::GestureTargeting::QueuePointerFrame(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( *(_DWORD *)v6 > 4u )
  {
    if ( TlgKeywordOn(v6, 0x800uLL) )
    {
      ...
      v17 = v8;
      v19 = v8;
      TlgWrite(v7, &unk_1802B70D5, 0LL, 0LL, 6u, &pData);
    }
  }
}
