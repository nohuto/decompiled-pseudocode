/*
 * XREFs of ?Create@CD2DFactory@@SAJW4D2D1_FACTORY_TYPE@@UD2D1_FACTORY_OPTIONS@@PEAPEAV1@@Z @ 0x18007AC64
 * Callers:
        ...
        struct CD2DFactory **a3)
{
  ...
  v5 = (CD2DFactory *)HeapAlloc(WPF::g_processHeap, 0, 0x28uLL);
  v7 = v5;
  if ( v5 )
  {
    *((_DWORD *)v5 + 4) = 0;
  ...
  if ( v7 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x20u);
