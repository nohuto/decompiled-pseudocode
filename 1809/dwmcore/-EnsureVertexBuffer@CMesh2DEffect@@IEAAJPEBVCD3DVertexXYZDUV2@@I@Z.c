/*
 * XREFs of ?EnsureVertexBuffer@CMesh2DEffect@@IEAAJPEBVCD3DVertexXYZDUV2@@I@Z @ 0x180232914
 * Callers:
...
LABEL_9:
    *((_DWORD *)this + 46) = 0;
    ...
    {
      v16 = 558;
      v12 = v13 > 0xFFFFFFFF ? 0x80070216 : 0;
      goto LABEL_17;
    }
    v19 = v10;
    v14 = *((_QWORD *)this + 17);
...
LABEL_6:
    v12 = v9;
LABEL_17:
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v12, v16);
    return v11;
  }
LABEL_13:
