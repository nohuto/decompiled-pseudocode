/*
 * XREFs of ?Ensure3DFlags@CMILMatrix@@AEBAXXZ @ 0x1800454C0
 * Callers:
...
void __fastcall CMILMatrix::Ensure3DFlags(CMILMatrix *this)
{
    ...
    || (v24 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(*((float *)this + 5) - 0.0)) & _xmm), v24 >= 0.000081380211) )
  {
    ...
    *((_BYTE *)this + 64) = v19;
    ...
    {
      v21 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(*((float *)this + 13) - 0.0)) & _xmm);
      if ( v21 < 0.000081380211 )
      {
        v22 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(*((float *)this + 14) - 0.0)) & _xmm);
