/*
 * XREFs of ?Create@COffScreenRenderingLayer@@SAJAEBVCResourceTag@@PEAVIRenderTarget@@AEBUMilPointAndSizeL@@_NPEAPEAV1@@Z @ 0x18002F92C
 * Callers:
        ...
        struct COffScreenRenderingLayer **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x24u);
  }
  else
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x32u);
      v5 = v24;
    }
    else
    {
      ...
      *a5 = v20;
      ...
      {
        v15 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, -2147024882, 0x37u);
      }
    }
  }
  if ( v5 )
