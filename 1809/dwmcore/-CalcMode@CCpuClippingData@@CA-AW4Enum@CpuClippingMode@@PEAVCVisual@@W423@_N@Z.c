/*
 * XREFs of ?CalcMode@CCpuClippingData@@CA?AW4Enum@CpuClippingMode@@PEAVCVisual@@W423@_N@Z @ 0x1800328F4
 * Callers:
...
LABEL_6:
  if ( a2 != 2 )
  {
    ...
    if ( ShapeData < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, ShapeData, 0x11Fu);
    }
