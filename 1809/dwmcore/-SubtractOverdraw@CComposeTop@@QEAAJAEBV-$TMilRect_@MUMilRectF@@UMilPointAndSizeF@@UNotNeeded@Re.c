/*
 * XREFs of ?SubtractOverdraw@CComposeTop@@QEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801BE164
 * Callers:
...
__int64 __fastcall CComposeTop::SubtractOverdraw(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(a1 + 152) )
  {
    ...
    v6 = CShape::Combine(*(CShape **)(a1 + 152), v5, (CShape *)v13, (float *)(a1 + 84), 2, &v12);
    v2 = v6;
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0xCAu);
      v8 = v12;
    }
    else
    {
