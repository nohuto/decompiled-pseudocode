/*
 * XREFs of ?DrawSolidRectangle@COcclusionContext@@UEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBU_D3DCOLORVALUE@@@Z @ 0x180176F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall COcclusionContext::DrawSolidRectangle(__int64 a1, float *a2, __int64 a3)
{
  ...
  if ( !*(_DWORD *)(a1 + 1036) && *(float *)(a3 + 12) == 1.0 )
  {
    ...
    v3 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x427u);
  }
  return v3;
}
