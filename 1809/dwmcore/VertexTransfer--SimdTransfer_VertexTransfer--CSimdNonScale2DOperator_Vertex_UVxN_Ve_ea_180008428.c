/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____0_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x180008428
 * Callers:
        ...
        CMILMatrix *a4)
{
  ...
  v19 = (__m128)a2[13];
  v20 = 0;
  for ( i = _mm_unpacklo_ps(_mm_unpacklo_ps(v15, (__m128)LODWORD(FLOAT_1_0)), _mm_unpacklo_ps(v19, (__m128)0LL));
        v20 < v16;
