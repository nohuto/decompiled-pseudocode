/*
 * XREFs of ?GetBoundsWithLayerEffect@CLayerVisual@@QEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18000F7AC
 * Callers:
...
__int64 __fastcall CLayerVisual::GetBoundsWithLayerEffect(CVisual *a1, _OWORD *a2)
{
  ...
  *a2 = *(_OWORD *)((char *)a1 + 164);
  if ( (CVisual::GetEffectiveSize(a1, &v17, &v19) || CLayerVisual::GetAutomaticBoundsExpansion(v6))
    && (*(unsigned __int8 (__fastcall **)(CVisual *))(*(_QWORD *)a1 + 176LL))(a1) )
  {
      ...
      *a2 = *v2;
      if ( *(_QWORD *)(v9 + 96) )
      {
        ...
        if ( SourceInputBounds < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, SourceInputBounds, 0x276u);
        else
          v5 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _OWORD *))(**(_QWORD **)(v9 + 96) + 88LL))(
                 *(_QWORD *)(v9 + 96),
                 v13,
                 v16,
                 a2);
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v5, 0x196u);
    }
