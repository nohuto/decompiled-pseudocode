/*
 * XREFs of ?LengthSquared@CExpressionValueStack@@QEAAJXZ @ 0x1801CF294
 * Callers:
    ...
    switch ( v6 )
    {
      case 18:
        *(float *)v5->m128i_i32 = *(float *)v5->m128i_i32 * *(float *)v5->m128i_i32;
        break;
      case 35:
        *(float *)v5->m128i_i32 = (float)(*(float *)&v5->m128i_i32[1] * *(float *)&v5->m128i_i32[1])
                                + (float)(*(float *)v5->m128i_i32 * *(float *)v5->m128i_i32);
        break;
      case 52:
