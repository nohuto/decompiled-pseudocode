/*
 * XREFs of ?PartitionToggleHolographicSuspension@CChannel@@UEAAJH@Z @ 0x18007A270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::PartitionToggleHolographicSuspension(CChannel *this, int a2)
{
  unsigned int v4; // ebx
