/*
 * XREFs of _anonymous_namespace_::CreateD3D12ResourcesInternal @ 0x1801FB898
 * Callers:
...
__int64 __fastcall anonymous_namespace_::CreateD3D12ResourcesInternal(IUnknown **a1, __int64 *a2, __int64 *a3)
{
  ...
  ppDevice = 0LL;
  wil::com_ptr_t<IDwmSpatialWorld,wil::err_returncode_policy>::reset((__int64 *)&ppDevice);
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( !HIDWORD(v18) )
    {
      if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
        McTemplateU0d(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_COMPUTESCRIBBLE_INCOMPATIBLE, 2LL);
      wil::com_ptr_t<IDwmSpatialWorld,wil::err_returncode_policy>::reset(a3);
      wil::com_ptr_t<IDwmSpatialWorld,wil::err_returncode_policy>::reset(a3 + 1);
LABEL_20:
      v7 = 0;
      goto LABEL_21;
    }
    v15 = 0LL;
    v9 = ppDevice;
    wil::com_ptr_t<IDwmSpatialWorld,wil::err_returncode_policy>::reset(&v15);
