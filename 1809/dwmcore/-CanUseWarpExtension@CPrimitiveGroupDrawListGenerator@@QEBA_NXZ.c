/*
 * XREFs of ?CanUseWarpExtension@CPrimitiveGroupDrawListGenerator@@QEBA_NXZ @ 0x18022A9C0
 * Callers:
 ...
 *     ??$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ @ 0x1801E2314 (--$IsTranslateAndScale@$0A@@CMILMatrix@@AEBA_NXZ.c)
 */
