/*
 * XREFs of ?Initialize@CMesh2DEffect@@UEAAJPEAUID2D1EffectContext@@PEAUID2D1TransformGraph@@@Z @ 0x180232B90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1TransformGraph *a3)
{
  ...
  *((_QWORD *)this + 17) = a2;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, v12);
LABEL_22:
  if ( v13 )
