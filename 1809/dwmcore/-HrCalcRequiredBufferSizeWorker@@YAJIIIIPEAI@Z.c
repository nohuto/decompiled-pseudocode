/*
 * XREFs of ?HrCalcRequiredBufferSizeWorker@@YAJIIIIPEAI@Z @ 0x1800C2008
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( a4 )
  {
    ...
    if ( v9 > 0xFFFFFFFF )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v5, 0x64Cu);
      return v5;
    }
    v11 = v10 + 7;
    v12 = -1;
    ...
    if ( v11 < v10 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v5, 0x64Du);
      return v5;
    }
    v13 = v12 >> 3;
    ...
    {
      v5 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147024809, 0x652u);
      return v5;
    }
    v14 = -1;
    v15 = v6 * v8;
    ...
    if ( v15 > 0xFFFFFFFF )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v5, 0x655u);
      return v5;
    }
    v16 = v13 + v14;
    if ( v13 + v14 >= v14 )
    ...
    if ( v16 < v14 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v5, 0x656u);
      return v5;
    }
  }
  *a5 = v7;
