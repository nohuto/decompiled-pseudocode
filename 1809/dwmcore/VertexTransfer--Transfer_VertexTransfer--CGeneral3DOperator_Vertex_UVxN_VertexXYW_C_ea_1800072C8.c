/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____2_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1800072C8
 * Callers:
        ...
        CMILMatrix *a3)
{
  ...
  v19[0] = a2;
  v6 = CMILMatrix::ComputeAdjointIgnoreZ(v22, a2, a1 + 8);
  v10 = *(float *)(a1 + 44);
  v11 = 0;
  v12 = *(_DWORD *)(a1 + 20);
  v13 = *(_OWORD *)(v6 + 16);
  ...
  *(_OWORD *)&v19[1] = _xmm;
  if ( a3 && v9 )
  {
    result = CalculateTBNFrameFrom3Vertices((struct D2DQuaternion *)&v19[1], v9);
    v7 = (CMILMatrix *)v19[0];
    v8 = a1 + 8;
