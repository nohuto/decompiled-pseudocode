/*
 * XREFs of ?AddLines@CDrawListPolygonBuilder@@EEAAXPEBUD2D_POINT_2F@@I@Z @ 0x180181B80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDrawListPolygonBuilder::AddLines(CDrawListPolygonBuilder *this, const struct D2D_POINT_2F *a2, int a3)
{
