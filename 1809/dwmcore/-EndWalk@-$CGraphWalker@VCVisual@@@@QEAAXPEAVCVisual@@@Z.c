/*
 * XREFs of ?EndWalk@?$CGraphWalker@VCVisual@@@@QEAAXPEAVCVisual@@@Z @ 0x18002C884
 * Callers:
...
void __fastcall CGraphWalker<CVisual>::EndWalk(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 32) = 0;
  ...
  if ( v4 == 10 )
  {
    ...
    if ( v7 > 0xFFFFFFFF )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v7 > 0xFFFFFFFF ? 0x80070216 : 0, 0xEFu);
    }
    else if ( v6 <= *(_DWORD *)(a1 + 36) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v10, 0x100u);
    }
LABEL_12:
    *(_DWORD *)(a1 + 56) = 0;
    goto LABEL_5;
