/*
 * XREFs of ?CreateNodeFromOutputArgument@CShaderLinkingGraphBuilder@@QEAAJW4ShaderLinkingArgument@@0H@Z @ 0x1800217CC
 * Callers:
        ...
        char a4)
{
  ...
  v16 = a3;
  v15 = a2;
  v7 = a1[8] & std::_Hash_bytes((const unsigned __int8 *)&v16, 2uLL);
...
LABEL_4:
  ...
  {
    v11 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147024809, 0x86u);
  }
  else
  {
