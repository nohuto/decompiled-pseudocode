/*
 * XREFs of ?GetLegacyTokens@CLegacySurfaceManager@@QEAAJ_KPEAIPEAH@Z @ 0x1800206EC
 * Callers:
        ...
        int *a4)
{
  ...
  if ( FrameLegacyTokens < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, FrameLegacyTokens | 0x10000000, 0x17u);
  }
