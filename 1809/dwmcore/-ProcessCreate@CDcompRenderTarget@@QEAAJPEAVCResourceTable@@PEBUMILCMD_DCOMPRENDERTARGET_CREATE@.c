/*
 * XREFs of ?ProcessCreate@CDcompRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMILCMD_DCOMPRENDERTARGET_CREATE@@@Z @ 0x18007C4B0
 * Callers:
        ...
        const struct MILCMD_DCOMPRENDERTARGET_CREATE *a3)
{
  ...
  if ( !v3 )
  {
    v7 = (CHwndRenderTarget *)CHwndRenderTarget::operator new();
    if ( v7 )
    ...
    *((_QWORD *)this + 7) = v8;
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0, 0LL, 0, -2147024882, 0x25u);
      return v4;
    }
  ...
  *(_DWORD *)(v3 + 96) = v10;
  *(_BYTE *)(*((_QWORD *)this + 7) + 867LL) = *((_DWORD *)a3 + 10) != 0;
