/*
 * XREFs of ?AddHolographicDisplay@CHolographicManager@@QEAA_NPEAVCHolographicDisplay@@@Z @ 0x18020A5F0
 * Callers:
...
bool __fastcall CHolographicManager::AddHolographicDisplay(RTL_SRWLOCK *this, struct CHolographicDisplay *a2)
{
  ...
  v10 = Ptr + 1;
  v11 = Ptr + 1 < Ptr ? 0x80070216 : 0;
  if ( Ptr + 1 < Ptr )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v11, 0xB5u);
  }
  else if ( v10 > HIDWORD(this[13].Ptr) )
  {
    v12 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&this[11], 8, 1, &v17);
    v11 = v12;
    if ( v12 < 0 )
  ...
  {
    *((_QWORD *)this[11].Ptr + Ptr) = v17;
    LODWORD(this[14].Ptr) = v10;
  }
  if ( v11 >= 0 )
  {
    CMILCOMBase::InternalAddRef(v17);
    v14 = (CHolographicInteropTaskQueue *)this[5].Ptr;
    if ( v14 )
    {
