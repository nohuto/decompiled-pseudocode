/*
 * XREFs of ?GetSecondaryCloneDisplaysNoRef@CDisplaySet@@QEBAJPEAVCDisplay@@PEAV?$DynArray@PEAVCDisplay@@$0A@@@@Z @ 0x1801E1E08
 * Callers:
    ...
    if ( (_DWORD)v7 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( *(_QWORD *)(v9 + 152) == a2 && v9 != a2 )
        {
          ...
          {
            v12 = DynArrayImpl<0>::AddMultipleAndSet(a3, 8, 1, &v14);
            v3 = v12;
            if ( v12 < 0 )
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v3, 0x3EBu);
    }
  }
  return (unsigned int)v3;
}
