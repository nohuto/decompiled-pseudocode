/*
 * XREFs of ?GetSimplifiedPathDataInternal@CPathSegmentsShape@@MEBAJPEAPEAVCPathData@@@Z @ 0x18021FA40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  if ( v6 >= 0 )
    goto LABEL_4;
  MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x2Fu);
  if ( v9 )
