/*
 * XREFs of ?PostRender@CComputeScribbleRenderer@@QEAAJPEA_N@Z @ 0x18022C978
 * Callers:
  ...
  if ( v3 )
  {
    ...
    if ( v5 )
    {
      ...
      *((_QWORD *)this + 5) = 0LL;
      ...
      v6 = (*(__int64 (__fastcall **)(_QWORD, char *))(**(_QWORD **)(*(_QWORD *)this + 240LL) + 320LL))(
      ...
      v9 = v23;
      v10 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)this + 240LL) + 72LL))(*(_QWORD *)(*(_QWORD *)this + 240LL));
      v11 = *(_QWORD *)this;
      v21 = 0;
      v12 = v10;
      LastPresentCount = CSwapChainBase::GetLastPresentCount(*(CSwapChainBase **)(v11 + 240), &v21);
