/*
 * XREFs of ?AddKeyframe@KeyframeSequence@@QEAAXIMPEAVKeyframeValue@@PEAVKeyframeInterpolation@@@Z @ 0x180053720
 * Callers:
        ...
        struct KeyframeInterpolation *a5)
{
  ...
  *(_DWORD *)(*((_QWORD *)this + 13) + 24LL * a2) = v6;
  ...
  Microsoft::WRL::ComPtr<KeyframeValue>::operator=(*((_QWORD *)this + 13) + 8 * (v7 + 2), a5);
  *((_BYTE *)this + 140) |= 4u;
}
