/*
 * XREFs of ?ExpressionValueLerp@KeyframeInterpolation@@KAXW4DCOMPOSITION_EXPRESSION_TYPE@@MPEAVCExpressionValue@@11@Z @ 0x18005F1EC
 * Callers:
...
void __fastcall KeyframeInterpolation::ExpressionValueLerp(int a1, float a2, __int64 a3, unsigned int *a4, __int64 a5)
{
  ...
  float v41; // xmm1_4
  float v42; // xmm0_4
  const struct CPathData *v43; // r8
  const struct CPathData *v44; // rdx
  int v45; // eax
  struct CPathData *v46; // rbx
  char v47[16]; // [rsp+30h] [rbp-50h] BYREF
  char v48[16]; // [rsp+40h] [rbp-40h] BYREF
  struct CPathData *v49[2]; // [rsp+50h] [rbp-30h] BYREF
  ...
  if ( (_DWORD)v8 )
  {
    ...
    if ( v9 )
    {
          ...
          if ( v14 )
          {
            ...
            if ( v15 )
            {
              ...
              else
              {
                ...
                *(float *)v49 = (float)((float)(v18.m128_f32[0] - v17.m128_f32[0]) * v19) + v17.m128_f32[0];
                ...
                *((float *)v49 + 1) = v21;
                *(float *)&v49[1] = (float)((float)(_mm_shuffle_ps(v18, v18, 170).m128_f32[0] - v22) * v19) + v22;
                *((float *)&v49[1] + 1) = (float)((float)(_mm_shuffle_ps(v18, v18, 255).m128_f32[0] - v17.m128_f32[0])
                                                * v19)
                                        + v17.m128_f32[0];
              }
              v23 = *(_OWORD *)v49;
            ...
            {
              v28 = (float *)D2DVector4::operator-(a4, v47, a3, a3);
              *(float *)&v29 = a2 * v28[1];
              *(float *)&v30 = a2 * *v28;
              *(float *)&v31 = a2 * v28[2];
              *(float *)&v32 = a2 * v28[3];
              v49[0] = (struct CPathData *)__PAIR64__(v29, v30);
              v49[1] = (struct CPathData *)__PAIR64__(v32, v31);
              v34 = (__int128 *)D2DVector4::operator+(v33, v48, v49);
              *(_DWORD *)(a5 + 72) = 69;
              v23 = *v34;
            }
            *(_OWORD *)a5 = v23;
      ...
      else
      {
        ...
        v42 = *((float *)a4 + 1);
        *(_DWORD *)(a5 + 72) = 35;
        *(float *)a5 = v39 + (float)((float)(v41 - v39) * a2);
        *(float *)(a5 + 4) = v40 + (float)((float)(v42 - v40) * a2);
      }
    }
    else
    {
  ...
  {
    v43 = (const struct CPathData *)*((_QWORD *)a4 + 8);
    v44 = *(const struct CPathData **)(a3 + 64);
    v49[0] = 0LL;
    v45 = CInterpolatePathsOperation::Interpolate(v8, v44, v43, a2, v49);
    if ( v45 < 0 )
      ModuleFailFastForHRESULT((unsigned int)v45, retaddr);
    *(_DWORD *)(a5 + 72) = 11;
    *(_BYTE *)(a5 + 76) = 1;
    v46 = v49[0];
    Microsoft::WRL::ComPtr<CPathData>::operator=(a5 + 64, v49[0]);
    if ( v46 )
      (*(void (__fastcall **)(struct CPathData *))(*(_QWORD *)v46 + 16LL))(v46);
  }
}
