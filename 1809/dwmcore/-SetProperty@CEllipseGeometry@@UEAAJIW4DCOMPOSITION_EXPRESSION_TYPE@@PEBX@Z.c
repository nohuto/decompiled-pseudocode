/*
 * XREFs of ?SetProperty@CEllipseGeometry@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801958C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEllipseGeometry::SetProperty(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  v15[0] = 2LL;
  v15[1] = &CEllipseGeometry::k_rgAnimDef;
