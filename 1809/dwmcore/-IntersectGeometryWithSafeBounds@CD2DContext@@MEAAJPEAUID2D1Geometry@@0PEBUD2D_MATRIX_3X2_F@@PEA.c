/*
 * XREFs of ?IntersectGeometryWithSafeBounds@CD2DContext@@MEAAJPEAUID2D1Geometry@@0PEBUD2D_MATRIX_3X2_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAU2@@Z @ 0x1801FFCF0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a6)
{
  ...
  *a6 = 0LL;
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if ( v13 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x6E0u);
              goto LABEL_32;
            }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, v24);
LABEL_32:
