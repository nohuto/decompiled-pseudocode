/*
 * XREFs of ?GetProperty@CParticleEmitter@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801C6160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CParticleEmitter::GetProperty(CParticleEmitter *this, int a2, struct CExpressionValue *a3)
{
  unsigned int v5; // ebx
  ...
  v9[0] = 1LL;
  v9[1] = &CParticleEmitter::k_rgAnimDef;
  v5 = 0;
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x316u);
  }
  return v5;
}
