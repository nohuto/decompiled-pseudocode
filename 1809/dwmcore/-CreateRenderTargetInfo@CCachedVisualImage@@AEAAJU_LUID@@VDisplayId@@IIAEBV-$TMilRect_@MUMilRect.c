/*
 * XREFs of ?CreateRenderTargetInfo@CCachedVisualImage@@AEAAJU_LUID@@VDisplayId@@IIAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4Enum@MilStretch@@PEAURenderTargetBitmapInfo@1@@Z @ 0x18008B310
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( a4 && a5 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, &dword_180292820, 1u, RenderTargetBitmap, 0x521u);
    }
    else
    {
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v22, &dword_180292820, 1u, v21, 0x524u);
        v13 = v24;
      }
      else
      {
