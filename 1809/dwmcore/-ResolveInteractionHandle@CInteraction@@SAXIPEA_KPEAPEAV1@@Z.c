/*
 * XREFs of ?ResolveInteractionHandle@CInteraction@@SAXIPEA_KPEAPEAV1@@Z @ 0x18019CEC0
 * Callers:
...
void __fastcall CInteraction::ResolveInteractionHandle(unsigned int a1, unsigned __int64 *a2, struct CInteraction **a3)
{
  ...
  *a3 = 0LL;
  if ( a1 )
  {
    ...
    if ( Entry )
    {
      Microsoft::WRL::ComPtr<CInteraction>::operator=(&v8, *((__int64 (__fastcall ****)(_QWORD))Entry + 1));
      v6 = v8;
      if ( v8 )
      {
        if ( a2 )
