/*
 * XREFs of ?ReportFailure_Msg@details@wil@@YAXPEAXIPEBD110W4FailureType@2@J1PEAD@Z @ 0x18018C100
 * Callers:
 ...
 *     ?StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z @ 0x180144C50 (-StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z.c)
 */
