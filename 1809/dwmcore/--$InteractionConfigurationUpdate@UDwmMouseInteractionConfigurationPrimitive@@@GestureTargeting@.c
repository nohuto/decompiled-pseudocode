/*
 * XREFs of ??$InteractionConfigurationUpdate@UDwmMouseInteractionConfigurationPrimitive@@@GestureTargeting@InputTraceLogging@@SAXPEBUInteractionUpdate@CManipulationManager@@@Z @ 0x180075370
 * Callers:
        ...
        unsigned int *a1)
{
  ...
  unsigned int v43; // [rsp+3Ch] [rbp-CCh] BYREF
  int v44; // [rsp+40h] [rbp-C8h] BYREF
  int v45; // [rsp+44h] [rbp-C4h] BYREF
  const struct CInteraction *v46; // [rsp+48h] [rbp-C0h] BYREF
  ...
  unsigned int *v61; // [rsp+D8h] [rbp-30h]
  ...
  struct _EVENT_DATA_DESCRIPTOR v70; // [rsp+108h] [rbp+0h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v71; // [rsp+118h] [rbp+10h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v72; // [rsp+128h] [rbp+20h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v73; // [rsp+138h] [rbp+30h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v74; // [rsp+148h] [rbp+40h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v75; // [rsp+158h] [rbp+50h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v76; // [rsp+168h] [rbp+60h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v77; // [rsp+178h] [rbp+70h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v78; // [rsp+188h] [rbp+80h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v79; // [rsp+198h] [rbp+90h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v80; // [rsp+1A8h] [rbp+A0h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v81; // [rsp+1B8h] [rbp+B0h] BYREF
  ...
  if ( *(_DWORD *)v4 > 4u )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      if ( (*(_DWORD *)v1 & 0x8000) == 0 )
        v40 = v39;
      TlgCreateSz(&v82, v40);
      LOBYTE(v3) = TlgWrite(v4, &unk_1802B6E60, 0LL, 0LL, 0x18u, &pData);
    }
  }
  return (char)v3;
}
