/*
 * XREFs of ??Dconst_iterator@ControlPointCollection@Path@@QEBAAEBUD2D_POINT_2F@@XZ @ 0x18021C7D0
 * Callers:
...
__int64 __fastcall Path::ControlPointCollection::const_iterator::operator*(__int64 a1)
{
  ...
  return gsl::span<COverlayContext::OverlayPlaneInfo *,-1>::operator[](ControlPoints, v1);
}
