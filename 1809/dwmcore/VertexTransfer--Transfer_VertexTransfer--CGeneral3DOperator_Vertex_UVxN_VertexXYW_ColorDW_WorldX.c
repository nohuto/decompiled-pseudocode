/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____0_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x180006F9C
 * Callers:
        ...
        CMILMatrix *a3)
{
  ...
  v6 = CMILMatrix::ComputeAdjointIgnoreZ(v21, a2, a1 + 8);
  v10 = *(_DWORD *)(a1 + 20);
  v11 = 0;
  v12 = *(_OWORD *)(v6 + 16);
  v19[0] = *(_OWORD *)v6;
  ...
  if ( a3 && v9 )
  {
    result = CalculateTBNFrameFrom3Vertices((struct D2DQuaternion *)&v18, v9);
    v7 = a2;
    v8 = a1 + 8;
    v18 = *(_OWORD *)result;
  }
