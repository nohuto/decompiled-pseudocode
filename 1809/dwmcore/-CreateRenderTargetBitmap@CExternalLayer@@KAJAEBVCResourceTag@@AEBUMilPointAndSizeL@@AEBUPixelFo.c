/*
 * XREFs of ?CreateRenderTargetBitmap@CExternalLayer@@KAJAEBVCResourceTag@@AEBUMilPointAndSizeL@@AEBUPixelFormatInfo@@U_LUID@@VDisplayId@@_N55PEAPEAVIRenderTargetBitmap@@@Z @ 0x18002FB08
 * Callers:
  ...
  *a9 = 0LL;
  ...
  if ( a7 )
  {
    ...
    if ( ScratchRenderTargetBitmap >= 0 )
      goto LABEL_5;
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, ScratchRenderTargetBitmap, 0x2Du);
  }
  else
  {
    RenderTargetBitmap = CD3DDeviceManager::CreateRenderTargetBitmap(
                           (unsigned int)&qword_180308A48,
                           a1,
                           v15,
                           v14,
                           v24,
...
LABEL_5:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, RenderTargetBitmap, 0x3Du);
  }
  if ( v23 )
