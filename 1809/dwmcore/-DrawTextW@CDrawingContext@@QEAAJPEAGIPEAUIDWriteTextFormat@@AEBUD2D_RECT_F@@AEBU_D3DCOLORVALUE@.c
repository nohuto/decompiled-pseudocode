/*
 * XREFs of ?DrawTextW@CDrawingContext@@QEAAJPEAGIPEAUIDWriteTextFormat@@AEBUD2D_RECT_F@@AEBU_D3DCOLORVALUE@@@Z @ 0x180164B14
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a6)
{
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x2547u);
  }
  else
  {
    v13 = D2DPrimitiveBlendFromMilCompositingMode(*((_DWORD *)this + 69));
    v16 = (*(__int64 (__fastcall **)(__int64, char *, unsigned __int16 *, _QWORD, struct IDWriteTextFormat *, const struct D2D_RECT_F *, const struct _D3DCOLORVALUE *, bool, int, _DWORD, _DWORD))(v14 + 144))(
            v15,
            (char *)this + 8,
            a2,
            a3,
    ...
    v12 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x2550u);
  }
  return v12;
}
