/*
 * XREFs of ?ConstructLocalToGlobalTransform@CInteractionProcessor@@AEAA?AUD2DMatrix@@PEAV?$DynArray@UAxisWithType@@$0A@@@@Z @ 0x1801F061C
 * Callers:
 ...
 *     _anonymous_namespace_::ConvertVectorArrayToMatrix @ 0x1801F0D28 (_anonymous_namespace_--ConvertVectorArrayToMatrix.c)
 */
...
__int64 __fastcall CInteractionProcessor::ConstructLocalToGlobalTransform(__int64 *a1, __int64 a2, __int64 *a3)
{
  ...
  if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
  {
    ...
    v54 = a2 + 40;
    v55 = v14;
    TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B7815, 0LL, 0LL, 0x11u, &pData);
  }
  return a2;
}
