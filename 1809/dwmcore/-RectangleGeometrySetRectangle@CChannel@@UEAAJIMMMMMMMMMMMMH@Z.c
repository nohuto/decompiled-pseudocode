/*
 * XREFs of ?RectangleGeometrySetRectangle@CChannel@@UEAAJIMMMMMMMMMMMMH@Z @ 0x18009D6D0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a15)
{
  ...
  *(float *)&v33[8] = a14;
  v33[0] = a2;
  *(_QWORD *)&v34 = a15;
  v17 = CChannel::SendCommand(this, &v32, 0x30u);
  v19 = v17;
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x72Du);
  }
  else
  {
    v29 = 347;
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x735u);
    }
    else
    {
      v29 = 352;
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x73Du);
      }
      else
      {
        v29 = 350;
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0x745u);
        }
        else
        {
          v29 = 346;
          ...
          v19 = v26;
          if ( v26 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0x74Du);
        }
      }
    }
  }
