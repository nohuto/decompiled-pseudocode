/*
 * XREFs of ??$_Insert_range@PEAULayoutData@CContent@@@?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@ULayoutData@CContent@@@std@@@std@@@1@PEAULayoutData@CContent@@1Uforward_iterator_tag@1@@Z @ 0x180194F28
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v9 == 1 && a2 == *(char **)(a1 + 8) || (v24 = 0, v9) )
  {
    ...
    else
    {
      ...
      v25 = v13 + v9;
      v14 = std::vector<CContent::LayoutData>::_Calculate_growth(a1, v13 + v9, 1LL);
      v15 = 40 * v14;
      if ( v14 > v16 )
        v15 = -1LL;
      ...
      return (void *)std::vector<CContent::LayoutData>::_Change_array(a1, v17, v25, v14);
    }
  }
  return result;
}
