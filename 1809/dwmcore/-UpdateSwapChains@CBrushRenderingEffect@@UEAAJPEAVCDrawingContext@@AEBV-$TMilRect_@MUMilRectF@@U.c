/*
 * XREFs of ?UpdateSwapChains@CBrushRenderingEffect@@UEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18022D240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBrushRenderingEffect::UpdateSwapChains(__int64 a1, CDrawingContext *a2)
{
  ...
  if ( v6 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, updated, 0x106u);
  }
  return v2;
}
