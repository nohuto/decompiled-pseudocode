/*
 * XREFs of ?NotifyPropertyChanged@CPropertyChangeResource@@IEBAJPEBUAnimatedProperty@AnimationHelper@@PEBX@Z @ 0x1800A3B20
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a3)
{
  ...
  switch ( *((_DWORD *)a2 + 1) )
  {
    ...
    default:
LABEL_19:
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, v3, 0x9Cu);
      return v3;
  }
  v3 = v4;
  if ( v4 < 0 )
