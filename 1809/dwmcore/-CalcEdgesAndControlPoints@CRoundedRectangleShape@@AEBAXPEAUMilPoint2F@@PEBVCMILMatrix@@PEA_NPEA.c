/*
 * XREFs of ?CalcEdgesAndControlPoints@CRoundedRectangleShape@@AEBAXPEAUMilPoint2F@@PEBVCMILMatrix@@PEA_NPEAH@Z @ 0x180016E7C
 * Callers:
  ...
  *((_QWORD *)&v37 + 1) = __PAIR64__(LODWORD(v12), LODWORD(v9));
  if ( v13 > 0.0 )
  {
    ...
    if ( v14 > 0.0 )
    {
      ...
      *((float *)&v38 + 3) = v11;
      *((float *)&v38 + 1) = (float)(v11 + v14) - (float)(v14 * 0.55228478);
    }
  }
  ...
  if ( *v18 > 0.0 )
  {
    ...
    if ( v20 > 0.0 )
    {
      ...
      *((float *)&v35 + 1) = v12 - v20;
      *((float *)&v41 + 1) = v12;
      *(float *)&v41 = (float)(v19 + v10) - (float)(v19 * 0.55228478);
      *(float *)&v40 = v10;
  ...
  if ( a3 )
  {
    CMILMatrix::Transform(a3, (const struct MilPoint2F *)&v32, a2, 20);
  }
  else
  {
    v24 = v33;
