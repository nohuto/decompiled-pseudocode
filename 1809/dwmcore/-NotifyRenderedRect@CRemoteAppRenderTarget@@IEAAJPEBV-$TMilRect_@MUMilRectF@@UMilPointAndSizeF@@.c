/*
 * XREFs of ?NotifyRenderedRect@CRemoteAppRenderTarget@@IEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18015F8DC
 * Callers:
...
__int64 __fastcall CRemoteAppRenderTarget::NotifyRenderedRect(__int64 a1, FLOAT *a2)
{
  ...
  *(_QWORD *)&v6 = COERCE_UNSIGNED_INT((float)*(int *)(a1 + 288));
  v7 = (float)*(int *)(a1 + 292);
  v20.left = (float)*(int *)(a1 + 288);
  v20.top = v7;
  ...
  if ( a2 )
  {
    *(_QWORD *)&v10 = *(unsigned int *)a2;
    if ( *(float *)&v10 > *(float *)&v6 )
    {
      v20.left = *a2;
      v6 = v10;
    }
  ...
  if ( !IsEmpty(&v20) )
  {
    ...
    v14 = PixelAlign((__int64)v23, v21, v6);
    v20.left = *(FLOAT *)v14;
    v20.top = *(FLOAT *)(v14 + 4);
    v15 = *(float *)(v14 + 8);
    ...
    v2 = v17;
    if ( v17 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x176u);
  }
  return v2;
}
