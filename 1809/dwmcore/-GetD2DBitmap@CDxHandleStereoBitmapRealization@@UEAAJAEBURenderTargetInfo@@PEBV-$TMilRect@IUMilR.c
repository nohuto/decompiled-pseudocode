/*
 * XREFs of ?GetD2DBitmap@CDxHandleStereoBitmapRealization@@UEAAJAEBURenderTargetInfo@@PEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@_NPEAPEAUID2D1Bitmap1@@@Z @ 0x180228220
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x3Du);
  }
  else
  {
    ...
    if ( v9 )
    {
      ...
      v16 = Bitmap;
      if ( Bitmap < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, Bitmap, 0x46u);
    }
    else
    {
      ...
      v16 = v21;
      if ( v21 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v21, 0x4Fu);
    }
  }
  return v16;
}
