/*
 * XREFs of ?AddOp_Binary@ScanPipelineBuilder@@QEAAJP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZPEAUOpSpecificData@@W4Subpipe@1@@Z @ 0x180216078
 * Callers:
 ...
 *     ?GetFreeIntermediateBuffer@ScanPipelineBuilder@@IEAA?AW4BufferLocation@@XZ @ 0x180216620 (-GetFreeIntermediateBuffer@ScanPipelineBuilder@@IEAA-AW4BufferLocation@@XZ.c)
 */
...
LABEL_15:
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, v7, 0x342u);
  }
  else
  {
    *v16 = a2;
...
LABEL_12:
    v13 = v9;
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, v13, v15);
  }
