/*
 * XREFs of ?DuplicateHandleOnSource@CChannel@@UEAAJIPEAUIDwmChannel@@PEAI@Z @ 0x180099780
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  if ( *((_QWORD *)a3 + 6) == *((_QWORD *)this + 6) )
  {
    ...
    v11 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x2E2u);
  }
  else
  {
    v11 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2147024809, 0x2DCu);
  }
