/*
 * XREFs of ?RenderLayer@CFilterEffectLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x18017CA1C
 * Callers:
  ...
  if ( v26 )
  {
    ...
    *(float *)&v29[3] = v19 + v20;
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v11, 0xDAu);
        goto LABEL_13;
      }
      goto LABEL_9;
    }
    v23 = 204;
LABEL_12:
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, v23);
    goto LABEL_13;
  }
LABEL_9:
