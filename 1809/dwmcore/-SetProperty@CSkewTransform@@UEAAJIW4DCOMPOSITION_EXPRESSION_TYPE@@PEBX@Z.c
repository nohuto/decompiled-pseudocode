/*
 * XREFs of ?SetProperty@CSkewTransform@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801BC030
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
          v5 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0, -2147024809, 0x993u);
          return v5;
        }
        v8 = 176LL;
      }
