/*
 * XREFs of ?Create@CColorDrawListBrush@@SAJAEBU_D3DCOLORVALUE@@PEAPEAV1@@Z @ 0x18001DA44
 * Callers:
...
__int64 __fastcall CColorDrawListBrush::Create(struct _D3DCOLORVALUE *a1, struct CColorDrawListBrush **a2)
{
  ...
  if ( v7 || (v7 = (char *)HeapAlloc(WPF::g_processHeap, 0, 0x48uLL)) != 0LL )
  {
    *(_OWORD *)(v7 + 8) = _xmm;
    v7[52] = 0;
  ...
  *a2 = (struct CColorDrawListBrush *)v7;
  ...
  {
    v4 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, -2147024882, 0x2Du);
  }
  return v4;
}
