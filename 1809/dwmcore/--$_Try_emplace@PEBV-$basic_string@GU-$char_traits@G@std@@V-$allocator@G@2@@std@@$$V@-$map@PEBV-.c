        ...
        unsigned __int64 *a3)
{
  ...
  if ( v6 == *a1 || *a3 < v6[4] )
  {
    v9 = std::_Tree_comp_alloc<std::_Tmap_traits<std::wstring const *,unsigned int,std::less<std::wstring const *>,std::allocator<std::pair<std::wstring const * const,unsigned int>>,0>>::_Buynode0();
    *(_WORD *)(v9 + 24) = 0;
    v10 = *a3;
    *(_DWORD *)(v9 + 40) = 0;
    *(_QWORD *)(v9 + 32) = v10;
