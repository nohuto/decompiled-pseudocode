/*
 * XREFs of ?CaptureControllerSetTransform@CChannel@@UEAAJII@Z @ 0x180145DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetTransform(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
