/*
 * XREFs of ?LogAnimationEnded@CAnimationLoggingManager@@QEAAX_KPEAVCResource@@IIW4AnimationEndedReasonType@@@Z @ 0x18018AD70
 * Callers:
 ...
 *     ?ProcessSetAnimationEnded@CAnimationLoggingManager@@QEAAJPEAVCResourceTable@@PEBUMILCMD_ANIMATIONLOGGINGMANAGER_SETANIMATIONENDED@@@Z @ 0x18018BE78 (-ProcessSetAnimationEnded@CAnimationLoggingManager@@QEAAJPEAVCResourceTable@@PEBUMILCMD_ANIMATIO.c)
 * Callees:
        ...
        int a6)
{
  ...
  {
    LOBYTE(DebugInfoForResource) = TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL);
    if ( (_BYTE)DebugInfoForResource )
    {
      ...
      LOBYTE(DebugInfoForResource) = TlgWrite(
                                       (TraceLoggingHProvider)&dword_180305E40,
                                       &unk_1802B3DA8,
                                       0LL,
                                       0LL,
                                       8u,
  ...
  if ( a3 )
  {
    ...
    if ( DebugInfoForResource )
    {
      ...
      {
        v15 = *(DiagnosticCallbacksManager **)(*((_QWORD *)a1 + 2) + 1248LL);
        memset_0(&v24, 0, 0x40uLL);
        v16 = *(_QWORD *)a3;
        v31 = 0LL;
        v32 = 18;
        v17 = *(__int64 (__fastcall **)(struct CResource *, _QWORD, EVENT_DATA_DESCRIPTOR *))(v16 + 104);
        LOBYTE(v33) = 0;
