/*
 * XREFs of ?CalculateViewTransformsForSlate@CStereoscopicContentManager@@AEAAXW4StereoscopicContentMode@@MMAEBUStereoscopicSlateData@@PEAUStereoscopicViewData@@@Z @ 0x18020FE90
 * Callers:
        ...
        __int64 a6)
{
  ...
  v32 = _mm_unpacklo_ps(_mm_unpacklo_ps(v26, (__m128)0LL), _mm_unpacklo_ps(v27, (__m128)LODWORD(FLOAT_1_0)));
  v33 = _mm_unpacklo_ps(_mm_unpacklo_ps(v8, (__m128)0LL), _mm_unpacklo_ps(v7, (__m128)LODWORD(FLOAT_1_0)));
  do
  {
    ...
    *(_QWORD *)&v39 = DirectX::XMMatrixMultiply(v38, v64).m128_u64[0];
    v40 = _mm_mul_ps(DirectX::XMMatrixMultiply(v39, v65), v22);
    v66[0] = (__m128)DirectX::g_XMIdentityR0;
    v66[1] = (__m128)DirectX::g_XMIdentityR1;
    v66[2] = (__m128)DirectX::g_XMIdentityR2;
    v41 = _mm_mul_ps(
            _mm_add_ps(_mm_add_ps(v40, _mm_mul_ps(v35, v30)), _mm_add_ps(_mm_mul_ps(v36, v29), _mm_mul_ps(v37, v28))),
            (__m128)_xmm);
    v42 = _mm_unpacklo_ps(
            _mm_unpacklo_ps(v41, (__m128)0LL),
            _mm_unpacklo_ps(_mm_shuffle_ps(v41, v41, 85), (__m128)LODWORD(FLOAT_1_0)));
