/*
 * XREFs of ?UpdatePixelFormatInfo@CHwFullScreenRenderTarget@@MEAAXAEBUPixelFormatInfo@@@Z @ 0x18007B490
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CHwFullScreenRenderTarget::UpdatePixelFormatInfo(CD3DSurface **this, const struct PixelFormatInfo *a2)
{
  ...
  {
    (*((void (__fastcall **)(CD3DSurface **, _QWORD, _QWORD, CD3DSurface **))*this + 33))(this, 0LL, 0LL, &v6);
  ...
  if ( v6 )
    (*(void (__fastcall **)(CD3DSurface *))(*(_QWORD *)v6 + 8LL))(v6);
}
