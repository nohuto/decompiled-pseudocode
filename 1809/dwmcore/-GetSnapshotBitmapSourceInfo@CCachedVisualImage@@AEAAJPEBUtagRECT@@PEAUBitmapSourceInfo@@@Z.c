/*
 * XREFs of ?GetSnapshotBitmapSourceInfo@CCachedVisualImage@@AEAAJPEBUtagRECT@@PEAUBitmapSourceInfo@@@Z @ 0x18008AEE8
 * Callers:
        ...
        struct BitmapSourceInfo *a3)
{
  ...
  LONG *v16; // rcx
  LONG v17; // r8d
  void (__fastcall **v18)(struct CDisplay *); // rax
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, CurrentDisplaySet, 0x4A7u);
    goto LABEL_12;
  }
  v11 = v22;
  if ( *((_DWORD *)v22 + 18) )
  {
    ...
    v18 = *(void (__fastcall ***)(struct CDisplay *))v15;
    v20 = v15;
    (*v18)(v15);
  }
  else
...
LABEL_14:
    if ( (int)CDisplaySet::GetPrimaryDisplay(v11, &v20) < 0 )
    {
      ...
      *((_DWORD *)a3 + 2) = DisplayId::None;
      goto LABEL_12;
    }
    v15 = v20;
  }
  *(_QWORD *)a3 = *((_QWORD *)v15 + 30);
  *((_DWORD *)a3 + 2) = *(_DWORD *)CDisplay::GetDisplayId(v15, &v21);
LABEL_12:
