/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::operator_ @ 0x1800D9C50
 * Callers:
...
__int64 __fastcall anonymous_namespace_::FrameSequenceInfo::operator_(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 404) = *(_DWORD *)(a2 + 404);
  if ( a1 + 408 != a2 + 408 )
  {
    std::_Tree<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::clear(a1 + 408);
    v6 = *v5;
    *v5 = *v4;
    *v4 = v6;
    v7 = v5[1];
  ...
  if ( a1 + 424 != a2 + 424 )
  {
    std::_Tree<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::clear(a1 + 424);
    v10 = *v9;
    *v9 = *v8;
    *v8 = v10;
    v11 = *(_QWORD *)(a1 + 432);
