/*
 * XREFs of ?wil_details_StagingConfig_Load@@YAJPEAUwil_details_StagingConfig@@W4wil_FeatureStore@@_KPEAXH@Z @ 0x180087AD8
 * Callers:
...
__int64 __fastcall wil_details_StagingConfig_Load(unsigned int *a1, unsigned int a2, __int64 a3, void *a4)
{
  ...
  *a1 = a2;
  ...
  v37 = v12;
  v33 = a4 != 0LL ? 0xC8 : 0;
  v15 = wil_details_NtQueryWnfStateData((const struct __WIL__WNF_STATE_NAME *)&v37, v7, v8, a1 + 2, a4, &v33);
  v16 = v15;
  if ( !v15 )
  {
    v13 = *(char **)v35;
...
LABEL_15:
    ...
    if ( !v11 )
      return 3221225626LL;
    v33 = v14;
    v15 = wil_details_NtQueryWnfStateData((const struct __WIL__WNF_STATE_NAME *)&v37, v23, v24, a1 + 2, v11, &v33);
    v16 = v15;
    v13 = v11;
  }
  if ( v16 || !v13 )
