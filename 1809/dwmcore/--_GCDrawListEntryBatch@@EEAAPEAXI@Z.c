/*
 * XREFs of ??_GCDrawListEntryBatch@@EEAAPEAXI@Z @ 0x18002202C
 * Callers:
 *     ??_ECDrawListEntryBatch@@G7EAAPEAXI@Z @ 0x1800F0920 (--_ECDrawListEntryBatch@@G7EAAPEAXI@Z.c)
 * Callees:
...
CDrawListEntryBatch *__fastcall CDrawListEntryBatch::`scalar deleting destructor'(CDrawListEntryBatch *this, char a2)
{
  ...
  *((_QWORD *)this + 11) = 0LL;
  v5 = (CMILRefCountBase *)*((_QWORD *)this + 10);
  if ( v5 )
  {
    *((_QWORD *)this + 10) = 0LL;
