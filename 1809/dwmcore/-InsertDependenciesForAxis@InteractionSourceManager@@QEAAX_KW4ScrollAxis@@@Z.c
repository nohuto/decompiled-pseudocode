/*
 * XREFs of ?InsertDependenciesForAxis@InteractionSourceManager@@QEAAX_KW4ScrollAxis@@@Z @ 0x1801E53C8
 * Callers:
...
void __fastcall InteractionSourceManager::InsertDependenciesForAxis(_QWORD *a1, unsigned __int64 a2, int a3)
{
  ...
  while ( v3 != v6 )
  {
    ...
    {
      (*(void (__fastcall **)(__int64, unsigned __int64))(*(_QWORD *)SourceModifierConditionalAnimation + 168LL))(
    ...
    if ( v13 )
    {
      (*(void (__fastcall **)(__int64, unsigned __int64))(*(_QWORD *)v13 + 168LL))(v13, a2);
...
LABEL_11:
    ...
    if ( a3 >= 0 )
    {
      ...
      CExpressionManager::InsertExpressionsInOrderForTarget(*(_QWORD *)(*a1 + 224LL), a2, (__int64)v18, v16);
    }
LABEL_18:
    CExpressionManager::InsertExpressionsInOrderForTarget(*(_QWORD *)(*a1 + 224LL), a2, (__int64)v15, 9u);
