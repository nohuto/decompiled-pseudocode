/*
 * XREFs of ?CreateD2DInk@CSwRenderTargetGetBounds@@UEAAJAEBUD2D1_INK_POINT@@AEBUD2D1_INK_STYLE_PROPERTIES@@PEAPEAVCD2DInk@@@Z @ 0x1802014A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CD2DInk **a4)
{
  ...
  int v11; // eax
  __int64 v12; // rcx
  struct ID2DContext *v14; // [rsp+68h] [rbp+20h] BYREF
  ...
  *a4 = 0LL;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, DefaultD2DContext, 0x134u);
  }
  else
  {
    ...
    v10 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x136u);
  }
  if ( v9 )
