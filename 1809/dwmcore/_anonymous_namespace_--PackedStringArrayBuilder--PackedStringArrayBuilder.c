/*
 * XREFs of _anonymous_namespace_::PackedStringArrayBuilder::PackedStringArrayBuilder @ 0x18007744C
 * Callers:
...
__int64 __fastcall anonymous_namespace_::PackedStringArrayBuilder::PackedStringArrayBuilder(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 24) = 0LL;
  v5 = 0;
  std::vector<unsigned char>::_Emplace_reallocate<unsigned char const &>(a1 + 8, 0LL, &v5);
  v3 = *(_BYTE **)(v1 + 8);
  v5 = 0;
  if ( *(_BYTE **)(v1 + 16) == v3 )
  {
