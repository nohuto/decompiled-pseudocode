/*
 * XREFs of ?IsRenderTarget@CD3DTexture@@AEBA_NXZ @ 0x18001DF68
 * Callers:
...
bool __fastcall CD3DTexture::IsRenderTarget(CD3DTexture *this)
{
  ...
  if ( (*((_BYTE *)this + 160) & 0x20) != 0 )
  {
    ...
    if ( DXGIResource < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0, DXGIResource, 0x25Fu);
    }
    else
    {
      v4 = ((__int64 (__fastcall *)(struct IDXGIResource *, int *))v8->lpVtbl->GetUsage)(v8, &v7);
      if ( v4 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x261u);
      else
        v1 = (v7 & 0x100) == 0;
    }
    if ( v8 )
