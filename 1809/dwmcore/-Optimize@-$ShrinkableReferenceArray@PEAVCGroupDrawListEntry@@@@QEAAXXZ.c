/*
 * XREFs of ?Optimize@?$ShrinkableReferenceArray@PEAVCGroupDrawListEntry@@@@QEAAXXZ @ 0x180022940
 * Callers:
...
void __fastcall ShrinkableReferenceArray<CGroupDrawListEntry *>::Optimize(__int64 a1)
{
  ...
  if ( v1 > 0x10 && *(_DWORD *)(a1 + 36) < v1 / 3 )
  {
    ...
    v4 = v1 >> 1;
    *(_OWORD *)v11 = 0LL;
    if ( (int)DynArrayImpl<0>::Grow((unsigned int)v11, 8, v4, 1, 0LL) >= 0 )
    {
      v5 = 0LL;
      if ( v3 > v4 )
      {
        ...
        if ( (_DWORD)v5 )
        {
          ...
          do
          {
            CMILRefCountBase::Release(*(CMILRefCountBase **)(v7 + *(_QWORD *)a1));
            v7 += 8LL;
            --v8;
          }
          while ( v8 );
