/*
 * XREFs of ?SetUpNewInteractionSummary@CTelemetryTouchLatencyAnalysis@@AEAAHPEAUTouchScenarioInfo@1@@Z @ 0x18014FA08
 * Callers:
        ...
        struct CTelemetryTouchLatencyAnalysis::TouchScenarioInfo *a2)
{
  ...
  char v27[120]; // [rsp+1F8h] [rbp+68h] BYREF
  ...
  char v40[120]; // [rsp+2C0h] [rbp+130h] BYREF
