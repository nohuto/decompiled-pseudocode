/*
 * XREFs of ?CalculateFigureLength@Figure@CPathEmitterShape@EmitterShapes@@QEAAX_N@Z @ 0x1801DC4BC
 * Callers:
 *     ?EndFigure@CPathEmitterShape@EmitterShapes@@EEAAXW4D2D1_FIGURE_END@@@Z @ 0x1801DC770 (-EndFigure@CPathEmitterShape@EmitterShapes@@EEAAXW4D2D1_FIGURE_END@@@Z.c)
 * Callees:
...
void __fastcall EmitterShapes::CPathEmitterShape::Figure::CalculateFigureLength(
        EmitterShapes::CPathEmitterShape::Figure *this,
        char a2)
{
  __int64 v2; // rbx
  __int64 v4; // rax
