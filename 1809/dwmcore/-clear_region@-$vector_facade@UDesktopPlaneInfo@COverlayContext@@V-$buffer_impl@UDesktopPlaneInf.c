/*
 * XREFs of ?clear_region@?$vector_facade@UDesktopPlaneInfo@COverlayContext@@V?$buffer_impl@UDesktopPlaneInfo@COverlayContext@@$01$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x1800EE568
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  *((_QWORD *)&v10 + 1) = v5 / 120;
  if ( a3 != v8 )
  {
    ...
    v13 = 0LL;
    v12 = v10;
    result = std::move<std::move_iterator<COverlayContext::DesktopPlaneInfo *>,stdext::checked_array_iterator<COverlayContext::DesktopPlaneInfo *>>(
               (__int64)&v10,
               v9 + v4,
               v4 + 120 * v8,
               &v12);
