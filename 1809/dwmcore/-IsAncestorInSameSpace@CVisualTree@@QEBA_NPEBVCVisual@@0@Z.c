/*
 * XREFs of ?IsAncestorInSameSpace@CVisualTree@@QEBA_NPEBVCVisual@@0@Z @ 0x180006F0C
 * Callers:
 ...
 * Callees:
 *     ?IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z @ 0x180006F74 (-IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z.c)
 */
