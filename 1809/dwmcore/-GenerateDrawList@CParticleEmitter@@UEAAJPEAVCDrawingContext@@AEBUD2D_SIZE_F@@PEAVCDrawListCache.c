/*
 * XREFs of ?GenerateDrawList@CParticleEmitter@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1801C5CD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  FLOAT height; // xmm1_4
  int DrawList; // eax
  struct CGeometryOnlyDrawListBrush *v10; // rcx
  ...
  struct CGeometryOnlyDrawListBrush *v30[2]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  *(_WORD *)v36 = 1;
  ...
  DrawList = (*(__int64 (__fastcall **)(_QWORD, struct CDrawingContext *, const struct D2D_SIZE_F *))(**((_QWORD **)this + 717) + 296LL))(
               *((_QWORD *)this + 717),
               a2,
               a3);
  ...
  DrawList = (*(__int64 (__fastcall **)(_QWORD, struct CDrawingContext **))(**((_QWORD **)this + 717) + 304LL))(
               *((_QWORD *)this + 717),
               &v37);
  ParticlesPrimitive = DrawList;
  if ( DrawList < 0 )
  ...
  for ( i = 0; i < v43; ++i )
  {
    ...
    if ( v14 )
    {
      if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)v14 + 8LL))(v42[i], 3LL) )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, -2147467259, 0x86u);
        goto LABEL_38;
      }
      v12 = v12 || v14[52];
    }
  ...
  *(_WORD *)&v36[1] = 257;
  ...
  {
    v30[1] = 0LL;
    v30[0] = (struct CGeometryOnlyDrawListBrush *)&v32;
    v31 = 1;
...
LABEL_37:
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v10, 0LL, 0, v21, v29);
      goto LABEL_38;
    }
    v17 = a3->height;
    v18 = a3->width;
    v19 = v32;
    v30[0] = 0LL;
    v30[1] = (struct CGeometryOnlyDrawListBrush *)__PAIR64__(LODWORD(v17), LODWORD(v18));
    v20 = *(_OWORD *)v30;
    *((_BYTE *)v32 + 52) = 1;
...
LABEL_36:
  ...
  {
    ParticlesPrimitive = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v10, 0LL, 0, -2147467259, 0x9Du);
    goto LABEL_38;
  }
  v22 = *v46;
  v23 = *(_DWORD *)(*v46 + 124);
  if ( (v23 & 8) != 0 )
    *(_DWORD *)(v22 + 124) = v23 & 0xFFFFFFF7;
  v24 = *(struct CDrawListPrimitive **)(v22 + 136);
  v30[0] = (struct CGeometryOnlyDrawListBrush *)v33;
  v30[1] = 0LL;
  v31 = 1;
  ParticlesPrimitive = CParticleEmitter::CreateParticlesPrimitive(this, v24, &v30[1]);
  if ( v31 )
  {
  ...
  CHWDrawListEntry::ReplacePrimitive(v22, (__int64 *)v30, (__int64 *)v33, (__int64)&CMILMatrix::Identity);
  if ( v30[0] )
