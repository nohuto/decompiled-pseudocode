/*
 * XREFs of ?HitTestWithTransformation@CPolygon@@QEAAJAEBUD2D_POINT_2F@@AEBVCMILMatrix@@1AEBW4Enum@MilBackfaceVisibility@@PEA_N@Z @ 0x1801BF9F4
 * Callers:
 ...
 *     ?IsPointInPolygon@CPolygon@@AEBA_NAEBT__m128@@@Z @ 0x1801BFD34 (-IsPointInPolygon@CPolygon@@AEBA_NAEBT__m128@@@Z.c)
  ...
  *(double *)v15.m128_u64 = DirectX::XMMatrixInverse(0LL);
              ...
              _mm_cmpeq_ps(_mm_and_ps((__m128)_xmm, DirectX::g_XMAbsMask), DirectX::g_XMInfinity)))) )
  {
    ...
    *a6 = IsPointInPolygon;
    ...
    if ( ShapeData < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, ShapeData, 0x1DAu);
    }
    else
    {
...
LABEL_10:
        ...
        v6 = v29;
        if ( v29 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, v29, 0x1E7u);
        else
          *a6 = (_DWORD)v33 != 0;
        goto LABEL_17;
      }
      MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, D2DGeometry, 0x1DBu);
    }
    CShapePtr::Release((CShapePtr *)&v32);
  }
LABEL_17:
