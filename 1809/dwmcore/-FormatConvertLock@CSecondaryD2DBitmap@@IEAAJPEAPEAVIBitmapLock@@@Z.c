/*
 * XREFs of ?FormatConvertLock@CSecondaryD2DBitmap@@IEAAJPEAPEAVIBitmapLock@@@Z @ 0x180181314
 * Callers:
...
__int64 __fastcall CSecondaryD2DBitmap::FormatConvertLock(CSecondaryD2DBitmap *this, struct IBitmapLock **a2)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x196u);
  }
  else
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x198u);
    }
    else
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x199u);
      }
      else
      {
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x1A4u);
          v6 = v31;
        }
        else
        {
          ...
          if ( v17 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v17, 0x1ABu);
            v3 = v30;
          }
          else
          {
            ...
            if ( v20 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x1B2u);
            }
            else
            {
              ...
              v10 = v22;
              if ( v22 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x1BBu);
            }
          }
        }
      }
