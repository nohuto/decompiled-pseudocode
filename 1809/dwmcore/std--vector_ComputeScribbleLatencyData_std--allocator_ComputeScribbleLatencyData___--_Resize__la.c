/*
 * XREFs of std::vector_ComputeScribbleLatencyData_std::allocator_ComputeScribbleLatencyData___::_Resize__lambda_49aad73161a680b61c856fa3713eefe3___ @ 0x18022D430
 * Callers:
 ...
 *     ?_Change_array@?$vector@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@AEAAXQEAUComputeScribbleLatencyData@@_K1@Z @ 0x18022E550 (-_Change_array@-$vector@UComputeScribbleLatencyData@@V-$allocator@UComputeScribbleLatencyData@@@.c)
 */
