/*
 * XREFs of ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_RenderThreadWatchdog@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x180086134
 * Callers:
 *     _dynamic_initializer_for__CCommonRegistryData::m_renderThreadWatchdogTimeoutMilliseconds__ @ 0x1800029D0 (_dynamic_initializer_for__CCommonRegistryData--m_renderThreadWatchdogTimeoutMilliseconds__.c)
 * Callees:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_RenderThreadWatchdog>::ReportUsageToService(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
