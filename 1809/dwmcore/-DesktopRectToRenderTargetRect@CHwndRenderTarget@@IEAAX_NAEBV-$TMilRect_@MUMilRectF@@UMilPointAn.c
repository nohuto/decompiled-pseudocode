/*
 * XREFs of ?DesktopRectToRenderTargetRect@CHwndRenderTarget@@IEAAX_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x18008FFC8
 * Callers:
...
__int64 __fastcall CHwndRenderTarget::DesktopRectToRenderTargetRect(__int64 a1, char a2, __int64 a3, _OWORD *a4)
{
  ...
  if ( !a2 || (v9 = *(_QWORD *)(a1 + 848)) == 0 || (v10 = *(_BYTE *)(v9 + 13423) == 0, v5 = 288LL, v10) )
    v5 = 220LL;
  CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)(v5 + a1));
