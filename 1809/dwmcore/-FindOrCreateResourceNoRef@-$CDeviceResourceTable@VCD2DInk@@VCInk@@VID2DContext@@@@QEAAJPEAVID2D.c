/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD2DInk@@VCInk@@VID2DContext@@@@QEAAJPEAVID2DContext@@PEAPEAVCD2DInk@@@Z @ 0x18019B0E4
 * Callers:
        ...
        struct CD2DInk **a3)
{
  ...
  int v21; // eax
  int v22; // r9d
  struct CD2DInk *v23; // rcx
  unsigned int v25; // [rsp+20h] [rbp-10h]
  struct CD2DInk *v26; // [rsp+60h] [rbp+30h] BYREF
...
LABEL_33:
    ...
    v13 = CInk::CreateResource(*((CInk **)a1 + 1), a2, &v26);
    v3 = v13;
    if ( v13 < 0 )
    {
      v25 = 83;
...
LABEL_34:
  ...
  if ( v23 )
    (*(void (__fastcall **)(struct CD2DInk *))(*(_QWORD *)v23 + 16LL))(v23);
LABEL_40:
  if ( v4 )
