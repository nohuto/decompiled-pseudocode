/*
 * XREFs of ?SetProperty@CMatrixTransform@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801C3800
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
              v5 = -2147024809;
              MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0, -2147024809, 0x66u);
              return v5;
            }
            v10 = 192LL;
          }
