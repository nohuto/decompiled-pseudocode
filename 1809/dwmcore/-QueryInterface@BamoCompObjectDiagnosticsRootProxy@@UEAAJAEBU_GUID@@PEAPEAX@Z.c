/*
 * XREFs of ?QueryInterface@BamoCompObjectDiagnosticsRootProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801729A0
 * Callers:
 *     ?QueryInterface@BamoCompObjectDiagnosticsRootProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F02A0 (-QueryInterface@BamoCompObjectDiagnosticsRootProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
