/*
 * XREFs of ?SetProperty@CTextBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801B5640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTextBrush::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v10 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x58u);
  }
  else
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x5Cu);
  }
  Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)(a1 + 152));
  return v10;
}
