/*
 * XREFs of ?CheckForIdle@CInteractionTracker@@AEAAXXZ @ 0x18019EDCC
 * Callers:
...
void __fastcall CInteractionTracker::CheckForIdle(CInteractionTracker *this)
{
  ...
  if ( !v3 )
  {
    if ( CInteractionTracker::AreInteractionAnimationsAlive(this)
      && ((*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)this + 40) + 264LL))(*((_QWORD *)this + 40))
       || (*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)this + 41) + 264LL))(*((_QWORD *)this + 41))
       || (*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)this + 42) + 264LL))(*((_QWORD *)this + 42)))
