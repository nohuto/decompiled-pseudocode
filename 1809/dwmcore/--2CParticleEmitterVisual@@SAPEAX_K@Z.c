/*
 * XREFs of ??2CParticleEmitterVisual@@SAPEAX_K@Z @ 0x180173D78
 * Callers:
...
void *__fastcall CParticleEmitterVisual::operator new()
{
  void *result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = WPF::ProcessHeapImpl::AllocClear(0x230uLL);
  if ( !result )
