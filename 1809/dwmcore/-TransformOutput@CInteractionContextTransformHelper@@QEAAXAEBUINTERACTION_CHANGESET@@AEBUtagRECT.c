/*
 * XREFs of ?TransformOutput@CInteractionContextTransformHelper@@QEAAXAEBUINTERACTION_CHANGESET@@AEBUtagRECT@@1K_NPEAU2@@Z @ 0x180221640
 * Callers:
  ...
  *((_OWORD *)a7 + 6) = v14;
  ...
  if ( !D2D1::Matrix3x2F::IsIdentity(this) )
  {
    ...
    if ( v18 )
    {
      if ( v15 )
      {
        ...
        *(float *)(v16 + 4) = v23;
        if ( a5 != 5 )
        {
          v24 = (float)((float)(*(float *)(v15 + 16) * v21[1]) + (float)(*(float *)(v15 + 20) * v21[3])) + v21[5];
    ...
    if ( (*((_BYTE *)a7 + 84) & 4) != 0 )
    {
      if ( v17 )
      {
        v25 = (float)((float)(*(float *)v17 * *((float *)this + 25))
        ...
        *(float *)(v17 + 4) = v25;
        if ( a5 != 5 )
        {
          v26 = (float)((float)(*(float *)(v17 + 16) * v21[1]) + (float)(*(float *)(v17 + 20) * v21[3])) + v21[5];
  ...
  if ( (*((_BYTE *)a7 + 84) & 2) != 0 && v15 )
  {
    v27 = *(float *)(v15 + 28);
    if ( v27 != 0.0 )
      *((double *)this + 21) = (float)((float)(*(float *)(v15 + 24) - 1.0) / v27);
    if ( v16 )
