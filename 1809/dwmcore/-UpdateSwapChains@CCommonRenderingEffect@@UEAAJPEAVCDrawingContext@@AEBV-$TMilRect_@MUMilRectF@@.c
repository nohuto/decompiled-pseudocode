/*
 * XREFs of ?UpdateSwapChains@CCommonRenderingEffect@@UEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180015930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCommonRenderingEffect::UpdateSwapChains(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, updated, 0x54u);
  return v9;
}
