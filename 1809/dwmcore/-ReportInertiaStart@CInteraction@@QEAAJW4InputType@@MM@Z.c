/*
 * XREFs of ?ReportInertiaStart@CInteraction@@QEAAJW4InputType@@MM@Z @ 0x18019CBD4
 * Callers:
 ...
 *     _anonymous_namespace_::InputTypeToInertiaSourceType @ 0x18019C450 (_anonymous_namespace_--InputTypeToInertiaSourceType.c)
 */
