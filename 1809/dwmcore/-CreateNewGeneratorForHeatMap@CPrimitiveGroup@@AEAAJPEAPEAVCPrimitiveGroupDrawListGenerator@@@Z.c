/*
 * XREFs of ?CreateNewGeneratorForHeatMap@CPrimitiveGroup@@AEAAJPEAPEAVCPrimitiveGroupDrawListGenerator@@@Z @ 0x1801ABDE4
 * Callers:
        ...
        struct CPrimitiveGroupDrawListGenerator **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x2F9u);
    if ( v12 )
