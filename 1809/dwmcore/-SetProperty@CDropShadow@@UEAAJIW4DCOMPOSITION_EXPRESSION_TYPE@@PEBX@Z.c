/*
 * XREFs of ?SetProperty@CDropShadow@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180194820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDropShadow::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v10 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x7Au);
  }
  else
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x7Eu);
  }
  return v10;
}
