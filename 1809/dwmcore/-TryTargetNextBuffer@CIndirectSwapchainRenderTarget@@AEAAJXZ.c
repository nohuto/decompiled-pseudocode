/*
 * XREFs of ?TryTargetNextBuffer@CIndirectSwapchainRenderTarget@@AEAAJXZ @ 0x18015CBA0
 * Callers:
  ...
  if ( v3 && !*((_QWORD *)this + 66) )
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      if ( RenderTargetForAcquiredBuffer < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, RenderTargetForAcquiredBuffer, 0x1B6u);
    }
    else
    {
