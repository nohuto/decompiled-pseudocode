/*
 * XREFs of ?ProcessSetMinScale@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUMILCMD_INTERACTIONTRACKER_SETMINSCALE@@@Z @ 0x1801A0BA0
 * Callers:
...
__int64 __fastcall CInteractionTracker::ProcessSetMinScale(
        ...
        const struct MILCMD_INTERACTIONTRACKER_SETMINSCALE *a3)
{
