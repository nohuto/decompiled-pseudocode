/*
 * XREFs of ??$TakeItemFromCache@VCStateSettingDrawListEntry@@@CDrawListBatchManager@@CAJPEAV?$ShrinkableReferenceArray@PEAVCStateSettingDrawListEntry@@@@PEAPEAVCStateSettingDrawListEntry@@@Z @ 0x180010860
 * Callers:
...
__int64 __fastcall CDrawListBatchManager::TakeItemFromCache<CStateSettingDrawListEntry>(__int64 a1, _QWORD *a2)
{
  ...
  if ( !v2 )
  {
    ...
    {
      v15 = DynArrayImpl<0>::AddMultipleAndSet(a1, 8LL, 1LL, &v16);
      v3 = v15;
      if ( v15 < 0 )
