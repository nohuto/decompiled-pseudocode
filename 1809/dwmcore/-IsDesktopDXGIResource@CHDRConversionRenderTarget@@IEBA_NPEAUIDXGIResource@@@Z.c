/*
 * XREFs of ?IsDesktopDXGIResource@CHDRConversionRenderTarget@@IEBA_NPEAUIDXGIResource@@@Z @ 0x18020935C
 * Callers:
...
char __fastcall CHDRConversionRenderTarget::IsDesktopDXGIResource(CSwapChainBase **this, struct IDXGIResource *a2)
{
  ...
  if ( !a2 )
    return 1;
  LogicalBackBuffer = CSwapChainBase::GetLogicalBackBuffer(this[30], &v9);
  v5 = v9;
