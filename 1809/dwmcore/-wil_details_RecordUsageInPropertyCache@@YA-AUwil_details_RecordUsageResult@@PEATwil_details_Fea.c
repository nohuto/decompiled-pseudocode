/*
 * XREFs of ?wil_details_RecordUsageInPropertyCache@@YA?AUwil_details_RecordUsageResult@@PEATwil_details_FeaturePropertyCache@@W4wil_details_ServiceReportingKind@@II@Z @ 0x180055870
 * Callers:
        ...
        int a4)
{
  ...
  int v11; // edx
  int v12; // edi
  int (*v13)(union wil_details_FeaturePropertyCache *, void *); // rdx
  ...
  else
  {
    switch ( a3 )
    {
      ...
      case 5:
        ...
        v13 = (int (*)(union wil_details_FeaturePropertyCache *, void *))wil_details_SetPropertyCacheUsageCallback;
        if ( !v4 )
          v13 = (int (*)(union wil_details_FeaturePropertyCache *, void *))wil_details_SetPropertyCacheOpportunityCallback;
        v22 = 1LL;
        LOBYTE(v12) = (unsigned int)wil_details_ModifyFeatureData(a2, v13, &v20) == 0;
        *(_DWORD *)(a1 + 16) = v12;
        return a1;
      case 3:
      case 6:
