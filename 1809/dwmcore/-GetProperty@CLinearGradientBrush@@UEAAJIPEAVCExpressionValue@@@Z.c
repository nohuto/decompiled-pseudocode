/*
 * XREFs of ?GetProperty@CLinearGradientBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801A4E10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLinearGradientBrush::GetProperty(CLinearGradientBrush *this, int a2, struct CExpressionValue *a3)
{
  ...
  v9[0] = 2LL;
  v9[1] = &CLinearGradientBrush::k_rgAnimDef;
  v5 = 0;
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x2Fu);
  }
  return v5;
}
