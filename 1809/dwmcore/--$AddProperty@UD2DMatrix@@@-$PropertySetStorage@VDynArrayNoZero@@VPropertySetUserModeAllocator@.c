/*
 * XREFs of ??$AddProperty@UD2DMatrix@@@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DMatrix@@PEAI@Z @ 0x1800A1A04
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *a4 = -1;
  ...
  if ( (int)result >= 0 )
  {
    v10 = DynArrayImpl<0>::Grow((int)a1 + 32, 1, 64, 1, 0LL);
    if ( v10 >= 0 )
    {
      *(_DWORD *)(a1 + 56) += 64;
      v11 = *(_QWORD *)(a1 + 32);
