/*
 * XREFs of ?EnsureHolographicClient@CHolographicManager@@AEAAJXZ @ 0x18020AFF0
 * Callers:
...
__int64 __fastcall CHolographicManager::EnsureHolographicClient(CHolographicManager *this)
{
  ...
  if ( !*((_QWORD *)this + 4) )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x285u);
    }
    else
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x286u);
        v2 = v15;
        v3 = v16;
      }
      else
