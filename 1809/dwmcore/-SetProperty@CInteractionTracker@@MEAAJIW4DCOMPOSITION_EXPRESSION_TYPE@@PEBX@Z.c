/*
 * XREFs of ?SetProperty@CInteractionTracker@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A2530
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetScaleInertiaDecayRate@CInteractionTracker@@AEAAXM@Z @ 0x1801A2818 (-SetScaleInertiaDecayRate@CInteractionTracker@@AEAAXM@Z.c)
 */
...
__int64 __fastcall CInteractionTracker::SetProperty(CInteractionTracker *a1, int a2, int a3, float *a4)
{
  ...
  v10 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0, -2147024809, 0x54Cu);
  return v10;
}
