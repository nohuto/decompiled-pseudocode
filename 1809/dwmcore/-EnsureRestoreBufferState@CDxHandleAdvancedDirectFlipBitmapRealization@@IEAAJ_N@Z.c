/*
 * XREFs of ?EnsureRestoreBufferState@CDxHandleAdvancedDirectFlipBitmapRealization@@IEAAJ_N@Z @ 0x180227268
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( v4 )
  {
    ...
    v14[2] = 0;
    v13[0] = 1;
    v6 = *(__int64 (__fastcall **)(__int64 *, __int64, __int64 *))(v5 + 400);
    v14[0] = 87;
    v14[1] = 3;
    v7 = v6(v4, a2, &v12);
    v2 = v7;
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x15Au);
    }
    else
    {
      ...
      RenderTargetBitmapFromTexture = CD3DDeviceManager::CreateRenderTargetBitmapFromTexture(
                                        ...
                                        *((_DWORD *)this + 106),
                                        (struct ID3D11Texture2D *)v12,
                                        (_QWORD *)this + 55);
      v2 = RenderTargetBitmapFromTexture;
      if ( RenderTargetBitmapFromTexture < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, RenderTargetBitmapFromTexture, 0x164u);
    }
    if ( v12 )
