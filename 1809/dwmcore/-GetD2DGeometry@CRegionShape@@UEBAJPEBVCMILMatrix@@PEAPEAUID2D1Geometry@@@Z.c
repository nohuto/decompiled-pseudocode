/*
 * XREFs of ?GetD2DGeometry@CRegionShape@@UEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x180012220
 * Callers:
        ...
        struct ID2D1Geometry **a3)
{
  ...
  struct ID2D1GeometrySink *v15; // rcx
  __int64 v16; // rbx
  int v17; // eax
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v7, 0LL, 0, v6, 0x93u);
    goto LABEL_6;
  }
  if ( !a2 )
  {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, D2DFactoryNoRef, 0xA7u);
    goto LABEL_23;
  }
  v24 = 0LL;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xA9u);
    goto LABEL_23;
  }
  v15 = v25;
  v25 = 0LL;
  v16 = (__int64)v24;
  if ( v15 )
    (*(void (__fastcall **)(struct ID2D1GeometrySink *))(*(_QWORD *)v15 + 16LL))(v15);
  v17 = (*(__int64 (__fastcall **)(__int64, struct ID2D1GeometrySink **))(*(_QWORD *)v16 + 136LL))(v16, &v25);
  v8 = v17;
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0xAAu);
    goto LABEL_23;
  }
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0xB9u);
LABEL_23:
