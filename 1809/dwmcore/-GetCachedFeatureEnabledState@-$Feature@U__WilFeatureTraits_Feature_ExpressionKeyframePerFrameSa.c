/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_ExpressionKeyframePerFrameSampling@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800884F4
 * Callers:
 *     ?PrepareForCalculation@CExpression@@MEAAXPEA_N@Z @ 0x1800556C0 (-PrepareForCalculation@CExpression@@MEAAXPEA_N@Z.c)
 * Callees:
