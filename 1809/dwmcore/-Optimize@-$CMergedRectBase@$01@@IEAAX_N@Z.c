/*
 * XREFs of ?Optimize@?$CMergedRectBase@$01@@IEAAX_N@Z @ 0x18016C2C4
 * Callers:
    ...
    *(_DWORD *)(a1 + 36) = 1;
    ...
    else
    {
      ...
      do
      {
        ...
        if ( *(_BYTE *)(v2 + v5 + 32) )
        {
          v10 = TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::AreaUnsafe((const struct D2D_RECT_F *)(v2 + 16LL * (unsigned int)v5));
          if ( *(float *)&v10 > v4 )
            v4 = *(float *)&v10;
          v11 = v5;
          v12 = v5 + 1;
