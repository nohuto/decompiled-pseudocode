/*
 * XREFs of ??0CDxHandleAdvancedDirectFlipBitmapRealization@@IEAA@W4CompositionBufferType@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@U_LUID@@@Z @ 0x180227088
 * Callers:
        ...
        __int64 a5)
{
  ...
  CDxHandleBitmapRealization::CDxHandleBitmapRealization(a1, a2, a3, a4, 1, 0LL);
  *(_QWORD *)(a1 + 440) = 0LL;
