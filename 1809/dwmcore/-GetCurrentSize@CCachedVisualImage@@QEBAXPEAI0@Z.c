/*
 * XREFs of ?GetCurrentSize@CCachedVisualImage@@QEBAXPEAI0@Z @ 0x18008CFC0
 * Callers:
 ...
 *     ?GetSize@CCachedVisualImage@@UEBAXPEAI0@Z @ 0x18018D120 (-GetSize@CCachedVisualImage@@UEBAXPEAI0@Z.c)
