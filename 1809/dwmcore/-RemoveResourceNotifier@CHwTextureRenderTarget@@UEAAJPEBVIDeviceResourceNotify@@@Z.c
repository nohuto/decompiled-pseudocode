/*
 * XREFs of ?RemoveResourceNotifier@CHwTextureRenderTarget@@UEAAJPEBVIDeviceResourceNotify@@@Z @ 0x18009B6D0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct IDeviceResourceNotify *a2)
{
  ...
  if ( v2 )
  {
    ...
    v3 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x35Au);
  }
  return v3;
}
