/*
 * XREFs of McTemplateU0dtxxxx @ 0x18014A70C
 * Callers:
...
ULONG __fastcall McTemplateU0dtxxxx(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v19 = 8LL;
  v21 = 8LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_PROGRESS_BASED_PPM_HINT, a3, 7u, &v9);
}
