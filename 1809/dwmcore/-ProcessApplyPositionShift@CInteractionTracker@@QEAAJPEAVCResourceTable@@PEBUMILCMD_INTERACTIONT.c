/*
 * XREFs of ?ProcessApplyPositionShift@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUMILCMD_INTERACTIONTRACKER_APPLYPOSITIONSHIFT@@PEBXI@Z @ 0x1801A0348
 * Callers:
        ...
        char *a4)
{
  ...
  if ( *((_DWORD *)a3 + 2) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2003303421, 0x35Du);
  }
  else
  {
    return 0;
