/*
 * XREFs of ?GotoSibling@?$CGraphWalker@VCVectorShape@@@@QEAAJPEAPEAVCVectorShape@@PEAV?$vector@PEAVCVectorShape@@V?$allocator@PEAVCVectorShape@@@std@@@std@@@Z @ 0x180223428
 * Callers:
...
__int64 __fastcall CGraphWalker<CVectorShape>::GotoSibling(__int64 a1, __int64 *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( *(_DWORD *)(a1 + 28) != 1
    ...
    || v6 + 1 >= (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v4 + 280LL))(v4) )
  {
    v7 = *(_DWORD *)(a1 + 28);
    if ( !v7 )
    {
...
LABEL_8:
  ...
  if ( v7 != 1 )
    v9 = v8;
  v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(a1 + 16) + 288LL))(*(_QWORD *)(a1 + 16), v9);
  *(_QWORD *)(a1 + 8) = v10;
  *(_DWORD *)(a1 + 24) = v9;
  *a2 = v10;
  return v2;
