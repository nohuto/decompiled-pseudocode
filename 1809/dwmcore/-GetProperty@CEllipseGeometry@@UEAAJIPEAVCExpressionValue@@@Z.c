/*
 * XREFs of ?GetProperty@CEllipseGeometry@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801956C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEllipseGeometry::GetProperty(CEllipseGeometry *this, unsigned int a2, struct CExpressionValue *a3)
{
  unsigned int v6; // ebx
  ...
  else
  {
    ...
    v6 = Property;
    if ( Property < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, Property, 0x3Fu);
  }
  return v6;
}
