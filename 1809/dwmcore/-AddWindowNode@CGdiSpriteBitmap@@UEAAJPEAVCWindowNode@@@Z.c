/*
 * XREFs of ?AddWindowNode@CGdiSpriteBitmap@@UEAAJPEAVCWindowNode@@@Z @ 0x1800755C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
    ...
    {
      v10 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v2, 8, 1, &v11);
      v3 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v10, 0xC0u);
    }
    else
    {
      *(_QWORD *)(v6 + 8 * v4) = v11;
    ...
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v3, 0xC5u);
  }
