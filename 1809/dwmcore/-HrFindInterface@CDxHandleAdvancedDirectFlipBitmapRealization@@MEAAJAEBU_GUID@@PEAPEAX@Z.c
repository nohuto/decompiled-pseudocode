/*
 * XREFs of ?HrFindInterface@CDxHandleAdvancedDirectFlipBitmapRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180227760
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CBitmapRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180047410 (-HrFindInterface@CBitmapRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
        ...
        void **a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      *a3 = (void *)(((unsigned __int64)this + 432) & -(__int64)(this != 0LL));
      return 0LL;
    }
  }
  return result;
