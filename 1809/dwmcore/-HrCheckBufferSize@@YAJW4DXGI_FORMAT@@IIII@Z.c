/*
 * XREFs of ?HrCheckBufferSize@@YAJW4DXGI_FORMAT@@IIII@Z @ 0x1800969C4
 * Callers:
...
__int64 __fastcall HrCheckBufferSize(enum DXGI_FORMAT a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x67Au);
  }
  else if ( v13[0] > a5 )
  {
    v11 = -2003292276;
    MilInstrumentationCheckHR_MaybeFailFast(a5, 0LL, 0, -2003292276, 0x67Eu);
  }
  return v11;
}
