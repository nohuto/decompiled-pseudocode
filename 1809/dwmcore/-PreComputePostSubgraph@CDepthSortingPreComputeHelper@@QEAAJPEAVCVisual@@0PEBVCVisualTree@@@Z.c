/*
 * XREFs of ?PreComputePostSubgraph@CDepthSortingPreComputeHelper@@QEAAJPEAVCVisual@@0PEBVCVisualTree@@@Z @ 0x1802255A8
 * Callers:
 ...
 *     ?DeleteDepthSortedList@CVisual@@AEAAXXZ @ 0x1801B66FC (-DeleteDepthSortedList@CVisual@@AEAAXXZ.c)
