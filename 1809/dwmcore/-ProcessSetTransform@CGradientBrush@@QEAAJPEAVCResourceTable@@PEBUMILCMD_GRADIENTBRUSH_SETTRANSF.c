/*
 * XREFs of ?ProcessSetTransform@CGradientBrush@@QEAAJPEAVCResourceTable@@PEBUMILCMD_GRADIENTBRUSH_SETTRANSFORM@@@Z @ 0x18001FD78
 * Callers:
        ...
        const struct MILCMD_GRADIENTBRUSH_SETTRANSFORM *a3)
{
  ...
  if ( ResourceWithoutType != v6 )
  {
    if ( ResourceWithoutType )
    {
      ...
      {
        v4 = -2003303421;
        MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003303421, 0x87u);
        return v4;
      }
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x8Au);
        return v4;
      }
      v6 = (struct CResource *)*((_QWORD *)this + 20);
    }
