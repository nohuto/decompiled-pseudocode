/*
 * XREFs of ?GetSwapChainSize@CSurfaceBrush@@AEBAJ_NPEAUD2D_SIZE_F@@PEAUD2D_RECT_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801B41F0
 * Callers:
        ...
        struct D2D_MATRIX_3X2_F *a5)
{
  ...
  v20 = 0LL;
  v19 = 0LL;
  v9 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v5 + 80LL))(v5, &v20);
  v11 = v9;
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, (const int *)"\a", 1u, v9, 0x2D6u);
  }
  else
  {
    if ( a2
    ...
    {
      v11 = -2003304441;
      MilInstrumentationCheckHR_MaybeFailFast(v13, (const int *)"\a", 1u, -2003304441, 0x2FEu);
    }
    else
    {
