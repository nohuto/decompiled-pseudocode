/*
 * XREFs of ?GetValue@KeyframeValue@@QEBAJPEAVCExpressionValueStack@@PEAVCExpressionValue@@@Z @ 0x1801D9908
 * Callers:
        ...
        struct CExpressionValue *a3)
{
  ...
  if ( *((_DWORD *)this + 5) == 2 )
  {
    v12 = CKeyframeAnimation::ProcessInnerExpression(*((CKeyframeAnimation **)this + 3), *((_DWORD *)this + 8), a2, a3);
    v10 = v12;
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x4Du);
      return v10;
    }
    return 0;
  }
  ...
  if ( !*(_DWORD *)v5 )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x6B9u);
      goto LABEL_30;
    }
  }
  if ( *(_DWORD *)v5 == 11 )
...
LABEL_30:
  ...
  v8 = -2147467259;
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147467259, 0x6ECu);
  v10 = -2147467259;
LABEL_31:
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x53u);
  return v10;
}
