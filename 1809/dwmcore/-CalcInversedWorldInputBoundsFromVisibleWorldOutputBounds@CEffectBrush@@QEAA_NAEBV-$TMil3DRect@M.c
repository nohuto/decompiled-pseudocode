        ...
        __int64 a8)
{
  ...
  if ( *(_QWORD *)(a1 + 96) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, SourceInputBounds, 0x2A3u);
    }
    else
    {
      v14 = *(_DWORD *)(a4 + 64);
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, -2147024809, 0x2B5u);
        DynArrayImpl<1>::~DynArrayImpl<1>(&v35);
        return 0;
      }
      v19 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *, __int64, _QWORD, int, __int128 *, __int128 *))(**(_QWORD **)(a1 + 96) + 96LL))(
              *(_QWORD *)(a1 + 96),
              v46,
              a2,
              v35,
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x2B1u);
      }
      else
      {
        v21 = v42;
  ...
  {
    v13 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, -2147024809, 0x2E1u);
  }
  return v13 >= 0;
}
