/*
 * XREFs of ?Draw@CPrimitiveGroup@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180175000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPrimitiveGroup::Draw(CPrimitiveGroup *a1, __int64 a2, __int64 a3, _BYTE *a4, __int64 a5)
{
