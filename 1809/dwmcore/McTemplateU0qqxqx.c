/*
 * XREFs of McTemplateU0qqxqx @ 0x1801576E0
 * Callers:
...
ULONG __fastcall McTemplateU0qqxqx(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v17 = &a7;
  v18 = 8LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_DCOMPEVENT_RESOURCE, a3, 6u, &v8);
}
