/*
 * XREFs of ?RegisterDwmGuidWithEtw@@YAXXZ @ 0x180084B40
 * Callers:
 ...
 *     McGenEventRegister @ 0x180084C84 (McGenEventRegister.c)
...
void RegisterDwmGuidWithEtw(void)
{
  ...
  McGenEventRegister();
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_180305E40, v0, v1);
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_180305EB8, v2, v3);
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_180305E80, v4, v5);
    ...
    if ( (int)StringCchPrintfW(Value, 0x22uLL, (size_t *)L"%s_%08X", L"DwmInitSessionActivityId", pdwType) >= 0 )
    {
        ...
        && dword_180305E80 > 5u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180305E80, 0x400000000000uLL) )
        {
          ...
          TlgWrite((TraceLoggingHProvider)&dword_180305E80, &unk_1802B652E, 0LL, 0LL, 4u, &pData);
        }
      }
    }
  }
