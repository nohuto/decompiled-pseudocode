/*
 * XREFs of ?TargetFrameInput@CManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x1801ECE74
 * Callers:
 ...
 *     ?TargetBufferedFrames@CManipulationManager@@AEAAXIPEAXK@Z @ 0x1801ECDB4 (-TargetBufferedFrames@CManipulationManager@@AEAAXIPEAXK@Z.c)
...
void __fastcall CManipulationManager::TargetFrameInput(CManipulationManager *this, struct CManipulationFrame *a2)
{
    ...
    if ( (*((_BYTE *)a2 + 40) & 2) == 0 || *(_QWORD *)((char *)a2 + v6 + 120) == -1LL )
    {
      ...
      *(_QWORD *)((char *)a2 + v6 + 120) = v9;
      if ( v9 != (void *)-1LL )
      {
        *((_BYTE *)a2 + 40) |= 1u;
        if ( (*((_BYTE *)a2 + 40) & 2) == 0 )
          CManipulationManager::TargetBufferedFrames(this, v7[25], v9, i);
      }
  ...
  if ( *((int *)this + 38) > 0 )
  {
    ...
    do
    {
      ...
      v14 = *(_QWORD *)(v11 + *((_QWORD *)this + 18));
      v15 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v14 + 16LL))(v14);
      CGestureTargetingManager::ProcessHandledInteractionsWalk(v14, v15, v2, v12, (char *)a2 + 48);
      ++v10;
      v11 += 8LL;
    }
