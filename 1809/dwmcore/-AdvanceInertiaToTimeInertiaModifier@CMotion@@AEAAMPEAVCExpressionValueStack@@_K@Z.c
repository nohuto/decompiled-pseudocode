/*
 * XREFs of ?AdvanceInertiaToTimeInertiaModifier@CMotion@@AEAAMPEAVCExpressionValueStack@@_K@Z @ 0x1801DF9D0
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( dword_180305E40 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
    {
      ...
      v34 = v15;
      v35 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B60E5, 0LL, 0LL, 8u, &pData);
      return v16;
    }
  }
  return result;
