/*
 * XREFs of ?InitializeForces@CNaturalAnimation@@AEAAXXZ @ 0x1801A9160
 * Callers:
...
void __fastcall CNaturalAnimation::InitializeForces(CNaturalAnimation *this)
{
  ...
  void *retaddr; // [rsp+2E0h] [rbp+1D8h]
  ...
  {
LABEL_7:
    v8 = (__m128)*((unsigned int *)this + 79);
    v3 = (CNaturalAnimation *)((char *)this + 324);
    LODWORD(v27) = *((_DWORD *)this + 74);
    v9 = (__m128)*((unsigned int *)this + 78);
    v10 = v27;
    LODWORD(v27) = 0;
    v9.m128_u64[0] = _mm_unpacklo_ps(v9, v8).m128_u64[0];
    v11 = (__m128)*((unsigned int *)this + 82);
    *((_QWORD *)this + 39) = v9.m128_u64[0];
    v9.m128_u64[0] = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 81), v11).m128_u64[0];
    *((_DWORD *)this + 80) = v10;
    v12 = v27;
    *(_QWORD *)((char *)this + 324) = v9.m128_u64[0];
    *((_DWORD *)this + 83) = v12;
    goto LABEL_8;
  }
  if ( v1 != 52 )
...
LABEL_8:
  ...
  *(float *)&v27 = v14;
  ...
  if ( v16 )
  {
    ...
    *((_QWORD *)v16 + 1) = &CFrictionAccelerator::`vftable'{for `CMILRefCountBase'};
    v16[6] = -1035468800;
    (**(void (__fastcall ***)(LPVOID))v16)(v16);
  }
  ...
  Microsoft::WRL::ComPtr<CManipulationContext>::operator=(
    (__int64 (__fastcall ****)(_QWORD))this + 49,
  ...
  *(_DWORD *)(v22 + 348) = v23;
    ...
    && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 4uLL) )
  {
    ...
    v94 = v24;
    v96 = v24;
    TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B5527, 0LL, 0LL, 0x22u, &pData);
  }
  if ( v18 )
