/*
 * XREFs of __tailMerge_api_ms_win_rtcore_ntuser_wmpointer_l1_1_0_dll @ 0x1800ED16D
 * Callers:
 *     __imp_load_GetPointerDeviceRects @ 0x1800ED161 (__imp_load_GetPointerDeviceRects.c)
 * Callees:
