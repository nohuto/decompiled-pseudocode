/*
 * XREFs of ?GetProperty@CTextBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801B5140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTextBrush::GetProperty(CTextBrush *this, int a2, struct CExpressionValue *a3)
{
  unsigned int v5; // ebx
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x42u);
  }
  return v5;
}
