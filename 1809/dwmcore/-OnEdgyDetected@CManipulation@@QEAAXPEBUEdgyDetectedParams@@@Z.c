/*
 * XREFs of ?OnEdgyDetected@CManipulation@@QEAAXPEBUEdgyDetectedParams@@@Z @ 0x1801A5AB8
 * Callers:
 *     ?s_OnReceiveInputThreadMessage@CInputManager@@CAJPEAXPEBXH@Z @ 0x1801E98A0 (-s_OnReceiveInputThreadMessage@CInputManager@@CAJPEAXPEBXH@Z.c)
 * Callees:
...
void __fastcall CManipulation::OnEdgyDetected(CManipulation *this, const struct EdgyDetectedParams *a2)
{
  ...
  if ( CNotificationResource::ShouldNotify(this) )
  {
    ...
    CoreUICallSend(v4, v8, 2LL, 11LL, 0, &unk_18027642C);
  }
}
