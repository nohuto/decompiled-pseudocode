/*
 * XREFs of ?GetTransformedOutput@CInteractionContextWrapper@@UEAAJAEBVCMILMatrix@@PEAUInteractionOutput@@@Z @ 0x1801F3DD0
 * Callers:
 *     <none>
 * Callees:
    ...
    *((_DWORD *)a3 + 14) = *((_DWORD *)v3 + 14);
    if ( dword_180305E40 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
      {
        ...
        v35 = v11;
        v37 = v11;
        TlgWrite(v10, &unk_1802B8093, 0LL, 0LL, 0xDu, &pData);
        return v13;
      }
    }
  }
