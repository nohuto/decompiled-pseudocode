/*
 * XREFs of ?CreateSwapChainForComposition@CD3DDeviceLevel1@@QEAAJAEBUDXGI_SWAP_CHAIN_DESC1@@PEAPEAUIDXGISwapChain1@@@Z @ 0x1801FBDE8
 * Callers:
        ...
        struct IDXGISwapChain1 **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v6, 0x6C8u);
  }
  else
  {
    v8 = CDisplayManager::EnsureDXGIEnumeration((CSurfaceManager **)&g_DisplayManager, &v14);
    v6 = v8;
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x6CAu);
      v3 = v14;
    }
    else
    {
      ...
      v6 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x6CFu);
    }
  }
  if ( v3 )
