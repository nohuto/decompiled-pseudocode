/*
 * XREFs of ?DeleteScenario@CAnimationTracking@@AEAAXI@Z @ 0x1800820F8
 * Callers:
 *     ?TelemetryNotifyChannelDetach@CPartitionVerticalBlankScheduler@@UEAAXI@Z @ 0x1800760C0 (-TelemetryNotifyChannelDetach@CPartitionVerticalBlankScheduler@@UEAAXI@Z.c)
...
void __fastcall CAnimationTracking::DeleteScenario(CAnimationTracking *this, unsigned int a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v4, 0LL, 0, -2147024809, 0x21Fu);
  }
  else
  {
    v6 = v5 - 1;
