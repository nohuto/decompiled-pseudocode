/*
 * XREFs of ?_Reallocate_exactly@?$vector@UD2D1_GRADIENT_STOP@@V?$allocator@UD2D1_GRADIENT_STOP@@@std@@@std@@AEAAX_K@Z @ 0x180006314
 * Callers:
...
__int64 __fastcall std::vector<D2D1_GRADIENT_STOP>::_Reallocate_exactly(__int64 a1, unsigned __int64 a2)
{
  ...
  return std::vector<D2D1_GRADIENT_STOP>::_Change_array(a1, v7, v6, a2);
}
