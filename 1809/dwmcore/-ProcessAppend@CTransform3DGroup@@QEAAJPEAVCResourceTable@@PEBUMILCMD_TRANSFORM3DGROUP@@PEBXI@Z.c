/*
 * XREFs of ?ProcessAppend@CTransform3DGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_TRANSFORM3DGROUP@@PEBXI@Z @ 0x1801BA818
 * Callers:
  ...
  if ( v16 >= (unsigned int)v12 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        if ( (_DWORD)v17 )
        {
          memcpy_0(v7, this[23], 8LL * (unsigned int)v17);
          v17 = *((unsigned int *)this + 44);
        }
