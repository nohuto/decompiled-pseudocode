/*
 * XREFs of ?EncodeBlock@Base853Encoder@@AEAAXXZ @ 0x1800DE778
 * Callers:
...
void __fastcall Base853Encoder::EncodeBlock(Base853Encoder *this)
{
  ...
  {
    std::basic_string_char_std::char_traits_char__std::allocator_char___::_Reallocate_grow_by__lambda_319d5e083f45f90dcdce5dce53cbb275__char_(v10);
  }
  else
  {
    v13 = v10[3] < 0x10uLL;
  ...
  if ( v3 > 2 )
  {
    ...
    if ( v3 > 3 )
    {
      ...
      {
        std::basic_string_char_std::char_traits_char__std::allocator_char___::_Reallocate_grow_by__lambda_319d5e083f45f90dcdce5dce53cbb275__char_(v18);
      }
      else
      {
        v13 = v18[3] < 0x10uLL;
      ...
      if ( v3 > 4 )
      {
        ...
        {
          std::basic_string_char_std::char_traits_char__std::allocator_char___::_Reallocate_grow_by__lambda_319d5e083f45f90dcdce5dce53cbb275__char_(v20);
        }
        else
        {
          v13 = v20[3] < 0x10uLL;
