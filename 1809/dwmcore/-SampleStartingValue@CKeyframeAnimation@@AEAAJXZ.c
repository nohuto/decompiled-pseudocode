/*
 * XREFs of ?SampleStartingValue@CKeyframeAnimation@@AEAAJXZ @ 0x180054AB4
 * Callers:
...
__int64 __fastcall CKeyframeAnimation::SampleStartingValue(CKeyframeAnimation *this)
{
  ...
  if ( v3 )
    ...
    v4 = 0LL;
  v5 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int128 *))(*(_QWORD *)v4 + 104LL))(
         v4,
...
LABEL_12:
    ...
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, -2147024809, 0x7F8u);
    goto LABEL_13;
  }
  v19 = 1979;
LABEL_38:
  MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, v19);
LABEL_13:
  v13 = v24;
  if ( v24 )
  {
