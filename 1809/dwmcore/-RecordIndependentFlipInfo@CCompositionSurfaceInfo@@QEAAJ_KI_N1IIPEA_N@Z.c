/*
 * XREFs of ?RecordIndependentFlipInfo@CCompositionSurfaceInfo@@QEAAJ_KI_N1IIPEA_N@Z @ 0x1801BD0CC
 * Callers:
        ...
        bool *a8)
{
  ...
  {
    v11 = v14 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v14 | 0x10000000, 0x10Du);
  }
  return v11;
}
