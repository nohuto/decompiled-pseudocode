/*
 * XREFs of ?SetProperty@CLineGeometry@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A5320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLineGeometry::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  v15[0] = 2LL;
  v15[1] = &CLineGeometry::k_rgAnimDef;
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v11 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x22u);
  }
  else
  {
