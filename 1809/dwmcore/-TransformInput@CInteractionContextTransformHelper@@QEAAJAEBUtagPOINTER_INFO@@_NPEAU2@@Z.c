/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x1802215CC
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x180221EE4 (s_TransformPointByMatrix.c)
 */
