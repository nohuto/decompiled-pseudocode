/*
 * XREFs of ?Create@CColorKeyBitmapRealization@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV2@@Z @ 0x180226648
 * Callers:
        ...
        struct IBitmapRealization **a3)
{
  ...
  *(_QWORD *)(v7 + 16) = &CSectionBitmapSubRectRealization::`vftable'{for `ID2DBitmapCache'};
