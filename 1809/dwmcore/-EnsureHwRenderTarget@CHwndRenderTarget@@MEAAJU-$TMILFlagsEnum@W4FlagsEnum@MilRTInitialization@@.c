/*
 * XREFs of ?EnsureHwRenderTarget@CHwndRenderTarget@@MEAAJU?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@@Z @ 0x1800D8150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwndRenderTarget::EnsureHwRenderTarget(__int64 a1, unsigned int a2)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, &dword_180292610, 2u, v3, 0x8A8u);
  }
  else
  {
