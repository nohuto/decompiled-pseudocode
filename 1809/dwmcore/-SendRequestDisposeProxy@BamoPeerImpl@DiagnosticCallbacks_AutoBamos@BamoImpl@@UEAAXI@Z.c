/*
 * XREFs of ?SendRequestDisposeProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x180155760
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoImpl::DiagnosticCallbacks_AutoBamos::BamoPeerImpl *this)
{
  ...
  v3 = CoreUICallSend(v2, v4, 2LL, 1LL, 5, &unk_1802914D2);
  if ( v3 < 0 )
  {
