/*
 * XREFs of ?LogCacheAccess@CExpression@@AEAAX_NIPEAVCExpressionValue@@@Z @ 0x180195A44
 * Callers:
        ...
        if ( v25 )
        {
          ...
          if ( v26 )
          {
            ...
            if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
            {
              ...
              *(_QWORD *)&v51.Size = v28;
              ...
              v79 = v28;
              v81 = v28;
              TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B493C, 0LL, 0LL, 0x17u, &pData);
            }
          }
          else if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
          {
            ...
            *(_QWORD *)&v51.Size = v30;
            ...
            v59 = v30;
            v61 = v30;
            TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B47ED, 0LL, 0LL, 0xDu, &pData);
          }
        }
        else if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
        {
          ...
          *(_QWORD *)&v51.Size = v32;
          ...
          v55 = v32;
          v57 = v32;
          TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B486D, 0LL, 0LL, 0xBu, &pData);
        }
      }
      else if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
      {
        ...
        *(_QWORD *)&v51.Size = v34;
        ...
        v55 = v34;
        v57 = v34;
        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B4AC1, 0LL, 0LL, 0xBu, &pData);
      }
    }
    else if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
    {
  ...
  else if ( v4 == 52 )
  {
    if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
    {
      ...
      *(_QWORD *)&v51.Size = v22;
      v53 = v22;
      v55 = v22;
      TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B49EE, 0LL, 0LL, 0xAu, &pData);
    }
  }
  else
  {
            ...
            if ( v10 == 7 )
            {
              if ( dword_180305E40 > 4u )
              {
                if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
                {
                  ...
                  v51.Ptr = (ULONGLONG)v5;
                  *(_QWORD *)&v51.Size = v12;
                  TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B48DB, 0LL, 0LL, 8u, &pData);
                }
              }
              return;
            }
LABEL_33:
          ...
          if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
          {
            ...
            *(_QWORD *)&v51.Size = v14;
            v53 = v14;
            TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B4A59, 0LL, 0LL, 9u, &pData);
          }
        }
        else if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
        {
      ...
      else if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
      {
        ...
        v50 = 8LL;
        *(_QWORD *)&v51.Size = v18;
        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B4B8A, 0LL, 0LL, 8u, &pData);
      }
    }
    else if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B478C, 0LL, 0LL, 8u, &pData);
    }
  }
}
