/*
 * XREFs of ?CaptureControllerSetCaptureState@CChannel@@UEAAJIH@Z @ 0x180145B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetCaptureState(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
