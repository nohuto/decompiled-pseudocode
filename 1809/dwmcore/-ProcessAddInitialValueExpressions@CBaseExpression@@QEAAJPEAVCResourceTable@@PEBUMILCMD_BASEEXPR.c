/*
 * XREFs of ?ProcessAddInitialValueExpressions@CBaseExpression@@QEAAJPEAVCResourceTable@@PEBUMILCMD_BASEEXPRESSION_ADDINITIALVALUEEXPRESSIONS@@PEBXI@Z @ 0x18018CEFC
 * Callers:
...
__int64 __fastcall CBaseExpression::ProcessAddInitialValueExpressions(
        ...
        const struct MILCMD_BASEEXPRESSION_ADDINITIALVALUEEXPRESSIONS *a3,
        unsigned int *a4)
{
