/*
 * XREFs of ?TryProcessInertiaModifier@CScrollKeyframeAnimation@@IEAAJPEAVCExpressionValueStack@@_KW4ModifierType@1@W4ScrollAxis@@PEAVCExpressionValue@@@Z @ 0x1801E05DC
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  if ( (_DWORD)a4 )
  {
    ...
    v6 = *(CConditionalExpression **)(*(_QWORD *)(a1 + 528) + 8LL * a5 + 360);
  }
  else
  {
    v6 = *(CConditionalExpression **)(*(_QWORD *)(a1 + 528) + 8LL * a5 + 376);
  }
  LOBYTE(v13) = 0;
  if ( v6 )
  {
