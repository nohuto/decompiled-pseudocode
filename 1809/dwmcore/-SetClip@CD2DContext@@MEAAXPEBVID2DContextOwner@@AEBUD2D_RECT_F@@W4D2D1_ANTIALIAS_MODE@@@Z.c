/*
 * XREFs of ?SetClip@CD2DContext@@MEAAXPEBVID2DContextOwner@@AEBUD2D_RECT_F@@W4D2D1_ANTIALIAS_MODE@@@Z @ 0x180046D70
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v9 )
    {
      ...
      *((_QWORD *)this + 22) = 0LL;
      if ( v17 )
      {
        ...
        if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v17 + 16), 0xFFFFFFFF) == 1 && v17 != -8 )
          (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)(v17 + 8) + 16LL))(v17 + 8, 1LL);
      }
    }
    v10 = *(_BYTE *)(v5 + 48) == 0;
    v11 = (__int128)*a3;
