/*
 * XREFs of ?SetProperty@CSpriteVectorShape@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801B3F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVectorShape::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  v12[0] = 3LL;
  v12[1] = &CSpriteVectorShape::k_rgAnimDef;
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v10 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x2Bu);
  }
  else
  {
    v10 = -2147024809;
