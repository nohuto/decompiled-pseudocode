/*
 * XREFs of ?TryGetDataForInteraction@CTelemetryComputeScribbleAggregator@@SA_NIPEAUComputeScribbleLatencyData@@@Z @ 0x180152094
 * Callers:
        ...
        struct ComputeScribbleLatencyData *a2)
{
  ...
  v4 = (_DWORD *)xmmword_180308680;
  v5 = 1;
  v6 = *(_DWORD **)xmmword_180308680;
  while ( v6 != v4 )
  {
    if ( a1 >= v6[4] && a1 <= v6[5] )
    {
