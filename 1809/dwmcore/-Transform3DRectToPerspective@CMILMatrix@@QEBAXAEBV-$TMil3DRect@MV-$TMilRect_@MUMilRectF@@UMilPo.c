/*
 * XREFs of ?Transform3DRectToPerspective@CMILMatrix@@QEBAXAEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEAUMilPoint3F@@@Z @ 0x18000A7B4
 * Callers:
      ...
      || v45 < 0.000081380211 )
    {
        ...
        || v45 >= -0.000081380211 )
      {
        ...
        *v24 = TMil3DRect<float,TMilRect_<float,MilRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcInfinite;
        ...
        v24[11] = qword_1803075E0;
        v24[8] = qword_1803075E0;
        v24[5] = qword_1803075E0;
        *(_DWORD *)v25 = qword_1803075E0;
        v24[23] = HIDWORD(qword_1803075E0);
        v24[20] = HIDWORD(qword_1803075E0);
        v24[17] = HIDWORD(qword_1803075E0);
        v50 = HIDWORD(qword_1803075E0);
      }
      else
      {
        ...
        *v24 = TMil3DRect<float,TMilRect_<float,MilRectF,MilPointAndSizeF,RectUniqueness::NotNeeded>,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcEmpty;
        ...
        v24[11] = qword_1803075C8;
        v24[8] = qword_1803075C8;
        v24[5] = qword_1803075C8;
        *(_DWORD *)v25 = qword_1803075C8;
        v24[23] = HIDWORD(qword_1803075C8);
        v24[20] = HIDWORD(qword_1803075C8);
        v24[17] = HIDWORD(qword_1803075C8);
        v50 = HIDWORD(qword_1803075C8);
      }
      v24[14] = v50;
    }
    else
