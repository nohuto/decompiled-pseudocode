/*
 * XREFs of McTemplateU0xqqqq @ 0x18022CE34
 * Callers:
...
ULONG __fastcall McTemplateU0xqqqq(
        __int64 a1,
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, a2, a3, 6u, &v8);
}
