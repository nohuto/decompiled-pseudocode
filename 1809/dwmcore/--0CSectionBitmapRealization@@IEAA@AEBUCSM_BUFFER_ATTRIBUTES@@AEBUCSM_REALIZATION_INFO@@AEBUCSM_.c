/*
 * XREFs of ??0CSectionBitmapRealization@@IEAA@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@AEBUCSM_SYSMEM_SECTION_INFO@@_N@Z @ 0x180091D10
 * Callers:
        ...
        bool a5)
{
  ...
  CBitmapRealization::CBitmapRealization(this, 0LL, a2, a3, 0LL);
