/*
 * XREFs of ?OnAllReadersDisconnected@BamoDataProviderProxyImpl@BamoImpl@@QEAAJXZ @ 0x180170D30
 * Callers:
 *     ?OnAllReadersDisconnected@BamoDataProviderProxy@@UEAAJXZ @ 0x180170CF0 (-OnAllReadersDisconnected@BamoDataProviderProxy@@UEAAJXZ.c)
 * Callees:
...
LABEL_3:
  ...
  v4[0] = v6;
  v4[1] = v7;
  return CoreUICallSend(v8, v4, 2LL, 0LL, 1, &unk_18027732B);
}
