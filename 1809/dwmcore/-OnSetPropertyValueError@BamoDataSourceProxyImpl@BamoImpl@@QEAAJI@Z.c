/*
 * XREFs of ?OnSetPropertyValueError@BamoDataSourceProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18016FC6C
 * Callers:
 *     ?OnSetPropertyValueError@BamoDataSourceProxy@@UEAAJI@Z @ 0x18016FC20 (-OnSetPropertyValueError@BamoDataSourceProxy@@UEAAJI@Z.c)
 * Callees:
...
LABEL_3:
  ...
  v4[0] = v6;
  v4[1] = v7;
  return CoreUICallSend(v8, v4, 2LL, 4LL, 0, &unk_18027732D);
}
