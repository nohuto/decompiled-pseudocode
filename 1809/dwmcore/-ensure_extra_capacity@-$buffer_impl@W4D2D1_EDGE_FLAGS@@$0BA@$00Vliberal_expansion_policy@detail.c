/*
 * XREFs of ?ensure_extra_capacity@?$buffer_impl@W4D2D1_EDGE_FLAGS@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@QEAAX_K@Z @ 0x18000C018
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  if ( result < a2 )
  {
    ...
    *((_QWORD *)&v15 + 1) = v6;
    ...
    v17 = v15;
    v18 = 0LL;
    ((void (__fastcall *)(__int128 *, void *, __int64, __int128 *))std::uninitialized_copy<std::move_iterator<enum D2D1_EDGE_FLAGS *>,stdext::checked_array_iterator<enum D2D1_EDGE_FLAGS *>>)(
      &v15,
      v10,
      v9,
      &v17);
