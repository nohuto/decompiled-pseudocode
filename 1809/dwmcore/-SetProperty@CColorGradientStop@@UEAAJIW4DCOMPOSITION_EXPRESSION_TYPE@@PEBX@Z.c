/*
 * XREFs of ?SetProperty@CColorGradientStop@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x18018E0F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorGradientStop::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  v12[0] = 2LL;
  v12[1] = &CColorGradientStop::k_rgAnimDef;
