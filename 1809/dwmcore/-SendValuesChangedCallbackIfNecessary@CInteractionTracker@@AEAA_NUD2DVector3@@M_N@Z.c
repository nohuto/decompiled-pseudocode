/*
 * XREFs of ?SendValuesChangedCallbackIfNecessary@CInteractionTracker@@AEAA_NUD2DVector3@@M_N@Z @ 0x1801A1DA4
 * Callers:
...
LABEL_7:
  ...
  CoreUICallSend(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 1208LL) + 56LL), v13, 2LL, 8LL, 0, &unk_1802763E4);
