/*
 * XREFs of ?ComputeAdjointIgnoreZ@CMILMatrix@@SA?AV1@AEBV1@@Z @ 0x180015624
 * Callers:
...
__int64 __fastcall CMILMatrix::ComputeAdjointIgnoreZ(__int64 a1, float *a2)
{
  ...
  *(float *)(a1 + 4) = (float)(v6 * v4) - (float)(v3 * v7);
  *(float *)(a1 + 12) = (float)(v2 * v7) - (float)(v10 * v4);
  *(float *)(a1 + 16) = (float)(v5 * v2) - (float)(v9 * v3);
  *(float *)(a1 + 20) = (float)(v8 * v3) - (float)(v5 * v4);
  *(float *)(a1 + 28) = (float)(v9 * v4) - (float)(v8 * v2);
  *(float *)(a1 + 60) = (float)(v10 * v8) - (float)(v9 * v7);
  *(float *)(a1 + 52) = (float)(v7 * v5) - (float)(v6 * v8);
