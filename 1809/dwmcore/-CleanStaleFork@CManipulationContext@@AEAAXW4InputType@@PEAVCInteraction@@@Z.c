/*
 * XREFs of ?CleanStaleFork@CManipulationContext@@AEAAXW4InputType@@PEAVCInteraction@@@Z @ 0x1801F6968
 * Callers:
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
      {
        ...
        v24 = 0;
        v22 = &v3[4 * v7 + 240];
        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B8B63, 0LL, 0LL, 6u, &pData);
      }
