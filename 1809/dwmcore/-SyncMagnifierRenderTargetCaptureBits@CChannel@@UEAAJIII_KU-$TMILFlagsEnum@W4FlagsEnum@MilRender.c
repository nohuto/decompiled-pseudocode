/*
 * XREFs of ?SyncMagnifierRenderTargetCaptureBits@CChannel@@UEAAJIII_KU?$TMILFlagsEnum@W4FlagsEnum@MilRenderPassFlags@@@@IAEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAI@Z @ 0x180147550
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a9)
{
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x7E4u);
  }
  else
  {
    v16 = v19;
    if ( v19 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v19, 0x7E6u);
    else
      *a9 = v20;
  }
