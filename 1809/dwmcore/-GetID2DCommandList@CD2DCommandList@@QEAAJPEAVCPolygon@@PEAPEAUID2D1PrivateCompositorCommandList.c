/*
 * XREFs of ?GetID2DCommandList@CD2DCommandList@@QEAAJPEAVCPolygon@@PEAPEAUID2D1PrivateCompositorCommandList@@@Z @ 0x180202A4C
 * Callers:
  ...
  if ( v29 )
  {
    ...
    if ( v14 )
    {
      if ( v10 )
      {
        ...
        do
        {
          v19 = *(_OWORD *)(v16 + *((_QWORD *)a2 + 2));
          v16 += 20LL;
          *v18 = v19;
          v18 += 2;
          *(v18 - 1) = *(_DWORD *)(v16 + *((_QWORD *)a2 + 2) - 16);
          *v17++ = *(_DWORD *)(v16 + *((_QWORD *)a2 + 2) - 4);
          --v11;
        }
        while ( v11 );
      }
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x51u);
        goto LABEL_16;
      }
      ...
      v7 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, -2147024882, 0x56u);
    }
    else
    {
      v7 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, -2147024882, 0x43u);
    }
  }
  else
  {
