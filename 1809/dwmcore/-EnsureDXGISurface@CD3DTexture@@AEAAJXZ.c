/*
 * XREFs of ?EnsureDXGISurface@CD3DTexture@@AEAAJXZ @ 0x18001E044
 * Callers:
...
__int64 __fastcall CD3DTexture::EnsureDXGISurface(CD3DTexture *this)
{
  ...
  {
    v2 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, -2003292412, 0x27Cu);
    goto LABEL_5;
  }
  if ( *((_QWORD *)this + 26) )
    goto LABEL_5;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, v10);
LABEL_5:
  if ( v11 )
