/*
 * XREFs of ??$SetProperty@UD2DMatrix@@@DataSourcePropertySet@@QEAAJIPEBUD2DMatrix@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18016E628
 * Callers:
 *     ?SetMatrix4x4Value@DataSourceProxy@@MEAAJIAEBU_D3DMATRIX@@@Z @ 0x180170030 (-SetMatrix4x4Value@DataSourceProxy@@MEAAJIAEBU_D3DMATRIX@@@Z.c)
 * Callees:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DMatrix>(__int64 a1, int a2, _OWORD *a3)
{
  __int64 v6; // r11
  _QWORD *v7; // rax
  __int64 v8; // r10
...
LABEL_6:
  ...
  if ( v8 == v9 )
  {
    v11 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DMatrix>(v10, 265, a3, &v27);
    v12 = v11;
    if ( v11 < 0 )
    {
  ...
  else
  {
    ...
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v17) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    v21 = *(_DWORD *)(v19 + 8 * v18 + 4) & 0x1FFFFFFF;
    v22 = *(_QWORD *)(v20 + 32);
    *(_OWORD *)(v21 + v22) = *a3;
    *(_OWORD *)(v21 + v22 + 16) = a3[1];
    *(_OWORD *)(v21 + v22 + 32) = a3[2];
    *(_OWORD *)(v21 + v22 + 48) = a3[3];
  }
  return 0LL;
}
