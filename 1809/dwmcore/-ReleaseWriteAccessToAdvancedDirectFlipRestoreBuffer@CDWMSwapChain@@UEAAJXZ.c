/*
 * XREFs of ?ReleaseWriteAccessToAdvancedDirectFlipRestoreBuffer@CDWMSwapChain@@UEAAJXZ @ 0x1802042F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDWMSwapChain::ReleaseWriteAccessToAdvancedDirectFlipRestoreBuffer(CDWMSwapChain *this)
{
  ...
  if ( *((_BYTE *)this + 573) )
  {
    ...
    v1 = v3;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v3, 0x3C9u);
    else
      *((_BYTE *)this + 573) = 0;
  }
  return v1;
