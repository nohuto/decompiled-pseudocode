/*
 * XREFs of ?Initialize@CDXGIAdapterLimited@@AEAAJXZ @ 0x180080750
 * Callers:
...
__int64 __fastcall CDXGIAdapterLimited::Initialize(CDXGIAdapterLimited *this)
{
         ...
         &v34) < 0 )
  {
    ...
    if ( v31 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0, v31, 0x87u);
      goto LABEL_14;
    }
  }
  else
  {
    ...
    if ( v2 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0, v2, 0x7Fu);
      goto LABEL_14;
    }
    v5 = 2LL;
         ...
         &v33) >= 0 )
  {
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x8Eu);
      goto LABEL_14;
    }
    v19 = (v36 & 0x10) != 0;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, KMTDriverVersion, 0x94u);
  }
  else
  {
    ...
    if ( KMTAdapterType < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, KMTAdapterType, 0x95u);
    }
    else
    {
      ...
      if ( v24 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0x97u);
      }
      else
      {
        ...
        v4 = v26;
        if ( v26 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0x9Eu);
      }
    }
  }
LABEL_14:
