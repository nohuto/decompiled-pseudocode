/*
 * XREFs of ?SetD2DEffectProperties@CLinearTransferEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1801C3440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLinearTransferEffect::SetD2DEffectProperties(CLinearTransferEffect *this, struct ID2D1Effect *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x2Eu);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x33u);
    }
    else
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x38u);
      }
      else
      {
        ...
        if ( v11 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x3Du);
        }
        else
        {
          ...
          if ( v13 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x42u);
          }
          else
          {
            ...
            if ( v15 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x47u);
            }
            else
            {
              ...
              if ( v17 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x4Cu);
              }
              else
              {
                ...
                if ( v19 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x51u);
                }
                else
                {
                  ...
                  if ( v21 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v21, 0x56u);
                  }
                  else
                  {
                    ...
                    if ( v23 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x5Bu);
                    }
                    else
                    {
                      ...
                      if ( v25 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v25, 0x60u);
                      }
                      else
                      {
                        ...
                        if ( v27 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0x65u);
                        }
                        else
                        {
                          v29 = (*(__int64 (__fastcall **)(struct ID2D1Effect *, __int64, _QWORD, char *, int))(*(_QWORD *)a2 + 72LL))(
                                  a2,
                                  12LL,
                                  0LL,
                                  (char *)this + 224,
                          ...
                          v6 = v29;
                          if ( v29 < 0 )
                            MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, v29, 0x6Au);
                        }
                      }
                    }
                  }
