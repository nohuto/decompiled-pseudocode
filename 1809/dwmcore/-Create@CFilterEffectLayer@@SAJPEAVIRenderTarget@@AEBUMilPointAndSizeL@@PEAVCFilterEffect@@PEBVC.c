/*
 * XREFs of ?Create@CFilterEffectLayer@@SAJPEAVIRenderTarget@@AEBUMilPointAndSizeL@@PEAVCFilterEffect@@PEBVCVisual@@AEBUMilPointAndSizeF@@PEAPEAV1@@Z @ 0x18017C830
 * Callers:
        ...
        struct CFilterEffectLayer **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x24u);
  }
  else
  {
    if ( (int)CFilterEffect::ContainEffectInChainInputs(a3, 56LL) < 0
      && (int)CFilterEffect::ContainEffectInChainInputs(a3, 134LL) < 0 )
    {
      v15 = 0;
    }
    v34 = 46;
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x35u);
      v6 = v29;
    }
    else
    {
      ...
      *a6 = v26;
      ...
      {
        v20 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, -2147024882, 0x3Bu);
      }
    }
  }
  if ( v6 )
