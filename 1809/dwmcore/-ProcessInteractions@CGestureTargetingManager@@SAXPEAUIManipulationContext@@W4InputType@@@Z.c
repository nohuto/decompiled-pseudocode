/*
 * XREFs of ?ProcessInteractions@CGestureTargetingManager@@SAXPEAUIManipulationContext@@W4InputType@@@Z @ 0x1801FA404
 * Callers:
...
__int64 __fastcall CGestureTargetingManager::ProcessInteractions(__int64 *a1, unsigned int a2)
{
  ...
  __int64 (__fastcall **v15)(_QWORD); // [rsp+70h] [rbp-90h] BYREF
  ...
  LODWORD(v27) = 0;
  *(_QWORD *)((char *)&v28 + 4) = _mm_unpacklo_ps((__m128)0LL, (__m128)0LL).m128_u64[0];
  LOWORD(v28) = 0;
  v20 = 0LL;
  HIDWORD(v28) = 0;
  v16 = 0LL;
