/*
 * XREFs of ?OnAddDataSourceError@BamoDataProviderProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180170C2C
 * Callers:
 *     ?OnAddDataSourceError@BamoDataProviderProxy@@UEAAJI@Z @ 0x180170BE0 (-OnAddDataSourceError@BamoDataProviderProxy@@UEAAJI@Z.c)
 * Callees:
...
LABEL_3:
  ...
  v4[0] = v6;
  v4[1] = v7;
  return CoreUICallSend(v8, v4, 2LL, 0LL, 2, &unk_18027732D);
}
