/*
 * XREFs of ?GetProperty@CManipulation@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801A5740
 * Callers:
 *     <none>
 * Callees:
...
LABEL_25:
  ...
  v3 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024809, 0x1FFu);
  return v3;
}
