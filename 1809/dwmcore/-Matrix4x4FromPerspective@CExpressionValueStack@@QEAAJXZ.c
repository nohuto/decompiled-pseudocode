/*
 * XREFs of ?Matrix4x4FromPerspective@CExpressionValueStack@@QEAAJXZ @ 0x1801D012C
 * Callers:
 ...
 *     ?D2DMatrixPerspectiveRH@@YAPEAUD2DMatrix@@PEAU1@MMMM@Z @ 0x1802190F8 (-D2DMatrixPerspectiveRH@@YAPEAUD2DMatrix@@PEAU1@MMMM@Z.c)
 */
    ...
    if ( *((_DWORD *)v8 + 18) == 18 )
    {
      if ( *((_DWORD *)v11 + 18) == 18 )
      {
        if ( *((_DWORD *)v14 + 18) == 18 )
        {
          if ( *((_DWORD *)v6 + 18) == 18 )
          {
            v16 = D2DMatrixPerspectiveRH((struct D2DMatrix *)v20, *v8, *v11, *v14, *v6);
            v3 = 0;
            if ( v16 )
            {
              v17 = v20[0];
