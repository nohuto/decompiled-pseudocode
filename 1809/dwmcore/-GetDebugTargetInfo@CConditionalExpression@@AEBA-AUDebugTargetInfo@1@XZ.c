/*
 * XREFs of ?GetDebugTargetInfo@CConditionalExpression@@AEBA?AUDebugTargetInfo@1@XZ @ 0x180193064
 * Callers:
...
__int64 __fastcall CConditionalExpression::GetDebugTargetInfo(__int64 a1, __int64 a2)
{
  ...
  {
    for ( i = v2 + 12; (*(_DWORD *)i & 0x7F000000) != 0x5000000; i += (*(_DWORD *)i & 0xFFFFFF) + 4LL )
      ;
    v4 = *(_DWORD *)(i + 12);
