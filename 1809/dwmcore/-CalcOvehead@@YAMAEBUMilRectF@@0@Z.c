/*
 * XREFs of ?CalcOvehead@@YAMAEBUMilRectF@@0@Z @ 0x180066224
 * Callers:
...
float __fastcall CalcOvehead(const struct MilRectF *a1, const struct MilRectF *a2)
{
  ...
  return fmaxf(
           (float)((float)(v19 - v17) * (float)(v18 - v16))
         - (float)((float)((float)((float)(v7[3] - v7[1]) * (float)(v7[2] - *v7))
                         + (float)((float)(v12 - v10) * (float)(v11 - *v6)))
                 - (float)((float)(v8 - v2) * (float)(v9 - v3))),
           0.0);
}
