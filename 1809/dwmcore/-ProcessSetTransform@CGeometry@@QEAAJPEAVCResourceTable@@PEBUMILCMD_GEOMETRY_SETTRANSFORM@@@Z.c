/*
 * XREFs of ?ProcessSetTransform@CGeometry@@QEAAJPEAVCResourceTable@@PEBUMILCMD_GEOMETRY_SETTRANSFORM@@@Z @ 0x1800761B4
 * Callers:
        ...
        const struct MILCMD_GEOMETRY_SETTRANSFORM *a3)
{
  ...
  if ( ResourceWithoutType != v6 )
  {
    if ( ResourceWithoutType )
    {
      ...
      {
        v4 = -2003303421;
        MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003303421, 0x13Fu);
        return v4;
      }
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x142u);
        return v4;
      }
