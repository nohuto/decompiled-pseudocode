/*
 * XREFs of ?CreateLayoutGeometryDrawListBrush@CDropShadow@@MEBAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAPEAVCDrawListBrush@@@Z @ 0x180018BE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListBrush **a4)
{
  ...
  *a4 = 0LL;
  v5 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 26)) & _xmm);
  if ( v5 >= 0.0000011920929 )
    return 0;
  width = a3->width;
  height = a3->height;
  v31.m128_u64[0] = 0LL;
  LODWORD(v8) = *((_DWORD *)this + 24) ^ _xmm;
  LODWORD(v9) = *((_DWORD *)this + 25) ^ _xmm;
  v10 = v8 + *((float *)this + 27);
  v11 = v8 + *((float *)this + 29);
  v31.m128_u64[1] = __PAIR64__(LODWORD(height), LODWORD(width));
  v12 = v9 + *((float *)this + 28);
  v13 = v9 + *((float *)this + 30);
  v14 = *((float *)this + 22);
  v29.left = v10;
  ...
  *(_QWORD *)&v29.left = &v34;
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v22, 0LL, 0, v20, 0x226u);
  }
  else
  {
    v23 = v34;
    ...
    *(_QWORD *)&v32 = &v35;
    ...
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v26, 0LL, 0, v20, 0x22Fu);
    if ( v35 )
