/*
 * XREFs of ?Transform2DRectToPerspective@CMILMatrix@@QEBAXAEBUMilRectF@@QEAUMilPoint2F@@@Z @ 0x1800DC524
 * Callers:
        ...
        struct MilPoint2F *const a3)
{
  ...
  *((float *)a3 + 7) = (float)(v13 + v7) + *((float *)this + 13);
  ...
  if ( v22 < 0.000081380211 || v23 < 0.000081380211 || v24 < 0.000081380211 || v25 < 0.000081380211 )
  {
    if ( v22 >= -0.000081380211 || v23 >= -0.000081380211 || v24 >= -0.000081380211 || v25 >= -0.000081380211 )
    {
      *(_DWORD *)v15 = TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcInfinite;
      *(_DWORD *)(v15 + 4) = *(&TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcInfinite + 1);
      *(_DWORD *)(v15 + 8) = TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcInfinite;
      *(_DWORD *)(v15 + 12) = *(&TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcInfinite + 3);
      *(_DWORD *)(v15 + 16) = *(&TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcInfinite + 2);
      *(_DWORD *)(v15 + 20) = *(&TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcInfinite + 3);
      *(_DWORD *)(v15 + 24) = *(&TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcInfinite + 2);
      v33 = *(&TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::sc_rcInfinite + 1);
    }
    else
    {
