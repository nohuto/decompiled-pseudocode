/*
 * XREFs of ?GetBits@CDesktopRenderTarget@@UEAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x18008FEE0
 * Callers:
 *     ?GetBits@CDesktopRenderTarget@@WGI@EAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x1800F01C0 (-GetBits@CDesktopRenderTarget@@WGI@EAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z.c)
 * Callees:
...
LABEL_7:
    ...
    if ( *((_DWORD *)this + 34) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, Bits, 0x7A6u);
    }
  }
  return v3;
}
