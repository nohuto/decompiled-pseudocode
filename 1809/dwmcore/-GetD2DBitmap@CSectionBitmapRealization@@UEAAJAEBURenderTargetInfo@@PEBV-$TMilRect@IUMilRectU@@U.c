/*
 * XREFs of ?GetD2DBitmap@CSectionBitmapRealization@@UEAAJAEBURenderTargetInfo@@PEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@_NPEAPEAUID2D1Bitmap1@@@Z @ 0x180226260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSectionBitmapRealization::GetD2DBitmap(__int64 a1, __int64 a2, __int64 a3, char a4, _QWORD *a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802BC050, 1u, v9, 0xBCu);
  }
  else if ( *(_QWORD *)(a1 + 320) )
  {
    ...
    v12 = Bitmap;
    if ( Bitmap < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_1802BC050, 1u, Bitmap, 0xC5u);
  }
  else
  {
