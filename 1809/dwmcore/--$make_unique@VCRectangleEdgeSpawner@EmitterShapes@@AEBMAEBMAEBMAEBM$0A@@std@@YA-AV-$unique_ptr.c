/*
 * XREFs of ??$make_unique@VCRectangleEdgeSpawner@EmitterShapes@@AEBMAEBMAEBMAEBM$0A@@std@@YA?AV?$unique_ptr@VCRectangleEdgeSpawner@EmitterShapes@@U?$default_delete@VCRectangleEdgeSpawner@EmitterShapes@@@std@@@0@AEBM000@Z @ 0x1801C47C4
 * Callers:
...
__int64 *__fastcall std::make_unique<EmitterShapes::CRectangleEdgeSpawner,float const &,float const &,float const &,float const &,0>(
        __int64 *a1,
        float *a2,
        float *a3,
        float *a4,
