/*
 * XREFs of ?ProcessSetFillBrush@CSpriteVectorShape@@QEAAJPEAVCResourceTable@@PEBUMILCMD_SPRITEVECTORSHAPE_SETFILLBRUSH@@@Z @ 0x1801B39E4
 * Callers:
...
LABEL_9:
    ...
    {
      v4 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003303421, 0x5Du);
      return v4;
    }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x60u);
  }
  return v4;
}
