/*
 * XREFs of ?CreateAndAddSwapChainBuffers@CBindInfo@CCompositionSurfaceInfo@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SWAPCHAIN_REALIZATION_INFO@@@Z @ 0x180097870
 * Callers:
        ...
        struct _LUID *a3)
{
  ...
  {
    v7 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_18029B808, 3u, -2147024809, 0x5CBu);
  }
  else
  {
    ...
    {
      v7 = v9 | 0x10000000;
      MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_18029B808, 3u, v9 | 0x10000000, 0x5D4u);
    }
    else
    {
      if ( a3->HighPart <= 1u )
      ...
      if ( !this[20] )
      {
        ...
        v7 = v23;
        if ( v23 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v23, 0x736u);
      }
      if ( v7 >= 0 )
      {
LABEL_4:
        ...
        if ( HighPart )
        {
          while ( 1 )
          {
            ...
            v25 = v14;
            v27 = v13;
            v15 = CCompositionSurfaceInfo::CBindInfo::CreateNewRealization(
            ...
            v6 = v30;
            hObject[v12] = 0LL;
            v17 = CCompositionSurfaceInfo::CBindInfo::AddRealization((CCompositionSurfaceInfo::CBindInfo *)this, v6);
            v7 = v17;
            if ( v17 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_18029B808, 3u, v17, 0x603u);
              goto LABEL_11;
            }
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_18029B808, 3u, v15, 0x5F8u);
          v6 = v30;
        }
        else
        {
LABEL_9:
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_18029B808, 3u, v7, 0x5DEu);
      }
LABEL_11:
      v19 = v28;
