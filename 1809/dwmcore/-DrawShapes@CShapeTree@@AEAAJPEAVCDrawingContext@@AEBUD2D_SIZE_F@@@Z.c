/*
 * XREFs of ?DrawShapes@CShapeTree@@AEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@@Z @ 0x1801DA22C
 * Callers:
...
__int64 __fastcall CShapeTree::DrawShapes(CShapeTree *this, struct CDrawingContext *a2, const struct D2D_SIZE_F *a3)
{
  ...
  if ( *((_BYTE *)this + 81) )
  {
    ...
    if ( !TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::DoesContain(v22, (float *)&v23) )
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x13Fu);
        return v3;
      }
      v4 = 1;
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x142u);
LABEL_13:
    ...
    CScopedClipStack::GetClipBoundsWorld((struct CDrawingContext *)((char *)a2 + 1008), (__int64)&v23);
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x14Eu);
    }
    else
    {
      ...
      v3 = v16;
      if ( v16 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x14Fu);
    }
