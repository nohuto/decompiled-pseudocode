/*
 * XREFs of ?GetTextureMemoryLayoutData@CEffectBrush@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801952D0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)(a3 + 8) = v3;
  for ( i = 0LL; (unsigned int)v5 < *(_DWORD *)(a1 + 128); v5 = (unsigned int)(v5 + 1) )
  {
    ...
    if ( v9 )
    {
      v14 = 0LL;
      v13 = 0LL;
      v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int128 *))(*(_QWORD *)v9 + 272LL))(v9, a2, &v13);
      v4 = v10;
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x161u);
