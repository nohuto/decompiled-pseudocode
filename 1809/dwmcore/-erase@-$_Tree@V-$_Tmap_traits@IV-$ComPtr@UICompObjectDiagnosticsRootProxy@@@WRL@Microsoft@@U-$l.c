...
_QWORD *__fastcall std::_Tree<std::_Tmap_traits<unsigned int,Microsoft::WRL::ComPtr<ICompObjectDiagnosticsRootProxy>,std::less<unsigned int>,std::allocator<std::pair<unsigned int const,Microsoft::WRL::ComPtr<ICompObjectDiagnosticsRootProxy>>>,0>>::erase(
        _QWORD *a1,
        _QWORD *a2,
        _QWORD *a3,
        _QWORD *a4)
  ...
  else
  {
    while ( v7 != a4 )
    {
      ...
      v17 = std::_Tree<std::_Tmap_traits<unsigned int,StereoscopicSlateData,std::less<unsigned int>,std::allocator<std::pair<unsigned int const,StereoscopicSlateData>>,0>>::_Extract(
              a1,
              v11);
      Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease(v17 + 5);
      std::_Deallocate<16,0>(v17, 0x30uLL);
    }
    *a2 = v7;
  }
  return a2;
