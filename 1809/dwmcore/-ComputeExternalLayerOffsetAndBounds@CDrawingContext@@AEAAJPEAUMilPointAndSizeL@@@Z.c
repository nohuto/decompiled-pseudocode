/*
 * XREFs of ?ComputeExternalLayerOffsetAndBounds@CDrawingContext@@AEAAJPEAUMilPointAndSizeL@@@Z @ 0x1801622A8
 * Callers:
        ...
        struct MilPointAndSizeL *a2)
{
  ...
  CScopedClipStack::GetClipBoundsWorld((CDrawingContext *)((char *)this + 1008), (__int64)v8);
  if ( TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsInfinite(v8) )
  {
    v4 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0, -2003292412, 0x141Eu);
  }
  else
  {
    v5 = InflateRectFToPointAndSizeL(v8, a2);
    v4 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1421u);
  }
  return v4;
}
