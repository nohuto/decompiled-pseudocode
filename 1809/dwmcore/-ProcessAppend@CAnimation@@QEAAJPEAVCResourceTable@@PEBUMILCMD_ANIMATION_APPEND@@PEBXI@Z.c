/*
 * XREFs of ?ProcessAppend@CAnimation@@QEAAJPEAVCResourceTable@@PEBUMILCMD_ANIMATION_APPEND@@PEBXI@Z @ 0x180015160
 * Callers:
...
LABEL_19:
        v15 = v11;
LABEL_23:
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, v15, v16);
        goto LABEL_12;
      }
      v10 = v17;
      *((_QWORD *)v8 + 15) = v17;
