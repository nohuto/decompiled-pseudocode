/*
 * XREFs of ?EnsureD2DGeometry@CRectanglesShape@@IEBAJXZ @ 0x18021D448
 * Callers:
...
__int64 __fastcall CRectanglesShape::EnsureD2DGeometry(CRectanglesShape *this)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, D2DFactoryNoRef, 0xF9u);
  }
...
LABEL_13:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xFEu);
  }
  else
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x105u);
    }
    else
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x107u);
      }
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x115u);
      }
    }
  }
LABEL_20:
