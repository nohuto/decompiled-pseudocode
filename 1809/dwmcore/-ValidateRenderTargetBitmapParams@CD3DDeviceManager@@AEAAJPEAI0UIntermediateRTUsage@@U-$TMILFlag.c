/*
 * XREFs of ?ValidateRenderTargetBitmapParams@CD3DDeviceManager@@AEAAJPEAI0UIntermediateRTUsage@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@PEAUPixelFormatInfo@@_NU_LUID@@VDisplayId@@@Z @ 0x18002FDB0
 * Callers:
        ...
        unsigned int a9)
{
  ...
  {
    v12 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, -2147024809, 0x402u);
  }
  else
  {
      ...
      if ( (a4 & 1) != 0 && *(_DWORD *)a6 == 24 )
      {
        *(_DWORD *)a6 = 10;
        ...
        if ( PixelFormatColorSpace < 0 )
        {
          v14 = 1089;
LABEL_14:
          MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, PixelFormatColorSpace, v14);
        }
      }
    }
  }
