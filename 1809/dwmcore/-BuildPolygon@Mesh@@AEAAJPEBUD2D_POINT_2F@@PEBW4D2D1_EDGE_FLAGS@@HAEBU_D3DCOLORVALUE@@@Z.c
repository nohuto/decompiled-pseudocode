/*
 * XREFs of ?BuildPolygon@Mesh@@AEAAJPEBUD2D_POINT_2F@@PEBW4D2D1_EDGE_FLAGS@@HAEBU_D3DCOLORVALUE@@@Z @ 0x180184978
 * Callers:
 ...
 *     ?AllocateVertex@Mesh@@AEAAJHPEAH@Z @ 0x1800E6A14 (-AllocateVertex@Mesh@@AEAAJHPEAH@Z.c)
 ...
 *     ?AddPolygon@MeshGraph@Mesh@@QEAAJPEAUMeshEdge@2@@Z @ 0x180184848 (-AddPolygon@MeshGraph@Mesh@@QEAAJPEAUMeshEdge@2@@Z.c)
 ...
 *     ?ComputeNormalizedLine@MeshGraph@Mesh@@SA?AVLine2d@2@AEBUD2D_VECTOR_2F@@0@Z @ 0x1801851AC (-ComputeNormalizedLine@MeshGraph@Mesh@@SA-AVLine2d@2@AEBUD2D_VECTOR_2F@@0@Z.c)
 *     ?ComputeRadialIndex@MeshGraph@Mesh@@SAMAEBVLine2d@2@@Z @ 0x1801852C8 (-ComputeRadialIndex@MeshGraph@Mesh@@SAMAEBVLine2d@2@@Z.c)
...
LABEL_11:
  ...
  if ( Vertex < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, Vertex, 0x3C5u);
  }
  else
  {
    ...
    if ( v33 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v33, 0x3C8u);
    }
    else
    {
      ...
      if ( v36 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v37, 0LL, 0, v36, 0x3CBu);
      }
      else
      {
        ...
        if ( v39 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v40, 0LL, 0, v39, 0x3CEu);
        }
        else
        {
          v41 = v101;
              ...
              if ( *((char **)v52 + 6) == v61 )
              {
                ...
                *((_DWORD *)v65 + 4) |= 2u;
                ...
                if ( (*(_BYTE *)(*((_QWORD *)v53 + 4) + 16LL) & 8) != 0 )
                {
                  ...
                  if ( v76 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v77, 0LL, 0, v76, 0x41Du);
                    goto LABEL_47;
                  }
                }
              }
              else
              {
                ...
                *((_DWORD *)v61 + 4) |= 2u;
                ...
                if ( (*(_BYTE *)(v80 + 16) & 4) != 0 )
                {
                  ...
                  if ( v81 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v82, 0LL, 0, v81, 0x429u);
                    goto LABEL_47;
                  }
                }
              }
