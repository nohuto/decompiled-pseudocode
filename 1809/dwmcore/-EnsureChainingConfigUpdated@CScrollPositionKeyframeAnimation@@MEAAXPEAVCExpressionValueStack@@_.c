/*
 * XREFs of ?EnsureChainingConfigUpdated@CScrollPositionKeyframeAnimation@@MEAAXPEAVCExpressionValueStack@@_K@Z @ 0x1801D6F40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CExpressionValueStack *a2)
{
  ...
  v9 = *v5;
  CInteractionTracker::BoundaryFromValue(*((_QWORD *)this + 66), COERCE_FLOAT(*v5), 0);
