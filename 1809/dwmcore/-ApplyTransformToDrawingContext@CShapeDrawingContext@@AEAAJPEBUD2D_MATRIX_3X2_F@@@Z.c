/*
 * XREFs of ?ApplyTransformToDrawingContext@CShapeDrawingContext@@AEAAJPEBUD2D_MATRIX_3X2_F@@@Z @ 0x18022303C
 * Callers:
  ...
  if ( a2 )
  {
    ...
    if ( !*((_BYTE *)this + 538) )
    {
      ...
      *(FLOAT *)&v14[5] = m22;
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x189u);
      }
      else
      {
        *((_BYTE *)this + 536) = 0;
