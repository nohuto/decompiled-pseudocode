/*
 * XREFs of ?OnInteractionTrackerTransitionToIdle@InteractionSourceManager@@QEAAXW4ScrollState@@@Z @ 0x1801E567C
 * Callers:
...
void __fastcall InteractionSourceManager::OnInteractionTrackerTransitionToIdle(InteractionSourceManager *a1)
{
  ...
  if ( InteractionSourceManager::HasActiveManipulation(a1) )
  {
    if ( v2 == 2 )
    {
      ...
      while ( v3 != v4 )
      {
        v5 = (CManipulation **)(*(_QWORD *)(*((_QWORD *)a1 + 11) + 8 * ((v3 >> 1) & (*((_QWORD *)a1 + 12) - 1LL)))
                              + 8 * (v3 & 1));
