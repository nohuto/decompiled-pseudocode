/*
 * XREFs of ?Reset@CScalarForceEvaluator@@QEAAXMMPEAUIAccelerator@@AEBVForceThreshold@@@Z @ 0x1801E79FC
 * Callers:
 ...
 *     ?GetMinAcceleration@ForceThreshold@@QEBAMXZ @ 0x1801E8708 (-GetMinAcceleration@ForceThreshold@@QEBAMXZ.c)
 *     ?GetMinVelocity@ForceThreshold@@QEBAMXZ @ 0x1801E8784 (-GetMinVelocity@ForceThreshold@@QEBAMXZ.c)
 */
