/*
 * XREFs of ?GetDisplaySize@CTreeEffectLayer@@SAJVDisplayId@@U_LUID@@PEAI2@Z @ 0x180011480
 * Callers:
...
__int64 __fastcall CTreeEffectLayer::GetDisplaySize(CDisplayManager *a1, __int64 a2, _DWORD *a3, _DWORD *a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, CurrentDisplaySet, 0xB9u);
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, PrimaryDisplay, 0xBCu);
  }
