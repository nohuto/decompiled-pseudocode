/*
 * XREFs of ?SetLightingCollection@CDrawListEntryBatch@@QEAAJPEAVCHwLightCollectionBuffer@@@Z @ 0x180024C90
 * Callers:
        ...
        struct CHwLightCollectionBuffer *a2)
{
  ...
  if ( a2 != *((struct CHwLightCollectionBuffer **)this + 5) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0xC3u);
      v13 = v16;
      if ( !v16 )
        return v2;
      goto LABEL_16;
    ...
    *((_QWORD *)v16 + 3) = a2;
    ...
    else
    {
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0xCDu);
        goto LABEL_11;
      }
    }
    *((_QWORD *)this + 5) = a2;
