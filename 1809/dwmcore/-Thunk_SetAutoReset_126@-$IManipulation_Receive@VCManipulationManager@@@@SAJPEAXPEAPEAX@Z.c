/*
 * XREFs of ?Thunk_SetAutoReset_126@?$IManipulation_Receive@VCManipulationManager@@@@SAJPEAXPEAPEAX@Z @ 0x1801ED6C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IManipulation_Receive<CManipulationManager>::Thunk_SetAutoReset_126(__int64 a1, __int64 a2)
{
  char *v2; // rax
  __int64 *v3; // rdx
  char v4; // bl
