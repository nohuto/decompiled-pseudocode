/*
 * XREFs of ?BuildRoundedRectangleShape@CRoundedRectangleShape@@AEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x1800166EC
 * Callers:
    ...
    while ( 1 )
    {
      if ( *v9 )
      {
        v10 = CRoundedRectangleShape::IntersectGeometryBuilder(
                ...
                &dword_18024C6B0[7 * v7],
                &v16,
                v8);
        v6 = v10;
        if ( v10 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v10, 0x13Fu);
LABEL_8:
          if ( v6 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v6, 0x75u);
          else
LABEL_9:
            *a3 = v16;
  ...
  if ( v12 >= 0 )
    goto LABEL_9;
  MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x6Eu);
  return (unsigned int)v6;
}
