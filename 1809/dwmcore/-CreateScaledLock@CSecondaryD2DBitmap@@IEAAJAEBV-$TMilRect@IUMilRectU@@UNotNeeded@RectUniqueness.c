/*
 * XREFs of ?CreateScaledLock@CSecondaryD2DBitmap@@IEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAVID2DBitmapCacheSource@@PEAPEAVIBitmapLock@@@Z @ 0x180180F78
 * Callers:
...
__int64 __fastcall CSecondaryD2DBitmap::CreateScaledLock(__int64 a1, _DWORD *a2, __int64 *a3, _QWORD *a4)
{
  ...
  int v36; // eax
  __int64 v37; // rcx
  struct IUnknown *v39; // [rsp+30h] [rbp-69h]
  __int64 v40; // [rsp+40h] [rbp-59h] BYREF
  struct IWICBitmapSource *v41; // [rsp+48h] [rbp-51h] BYREF
  unsigned int v42; // [rsp+50h] [rbp-49h] BYREF
  unsigned int v43; // [rsp+54h] [rbp-45h] BYREF
  struct IBitmapSource *v44; // [rsp+58h] [rbp-41h] BYREF
  struct IBitmapSource *v45; // [rsp+60h] [rbp-39h] BYREF
  __int64 v46; // [rsp+68h] [rbp-31h] BYREF
  __int64 v47; // [rsp+70h] [rbp-29h] BYREF
  __int64 v48; // [rsp+78h] [rbp-21h] BYREF
  unsigned __int8 *v49; // [rsp+80h] [rbp-19h] BYREF
  int v50; // [rsp+88h] [rbp-11h] BYREF
  int v51; // [rsp+8Ch] [rbp-Dh]
  int v52; // [rsp+90h] [rbp-9h] BYREF
  int v53; // [rsp+94h] [rbp-5h] BYREF
  _DWORD v54[4]; // [rsp+98h] [rbp-1h] BYREF
  _BYTE v55[16]; // [rsp+A8h] [rbp+Fh] BYREF
  ...
  *a4 = 0LL;
  ...
  v44 = 0LL;
  v9(a3, &v52, &v53);
  v12 = (*(__int64 (__fastcall **)(__int64 *, int *, __int64 *))(*a3 + 64))(a3, &v50, &v40);
  v14 = v12;
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x13Eu);
  }
  else
  {
    (*(void (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v40 + 24LL))(v40, v55);
    v15 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v40 + 40LL))(v40, &v43);
    v14 = v15;
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x142u);
    }
    else
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x143u);
      }
      else
      {
        v19 = HrCreateBitmapFromMemoryEx(
                v52 - v50,
                v53 - v51,
                (const struct PixelFormatInfo *)v55,
                v43,
                v42,
                v49,
                v39,
        ...
        if ( v19 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x14Fu);
          v4 = v45;
        }
        else
        {
          ...
          if ( v21 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v21, 0x151u);
          }
          else
          {
            ...
            if ( v23 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x157u);
            }
            else
            {
              ...
              if ( v25 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, v25, 0x159u);
              }
              else
              {
                ...
                if ( v27 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0x161u);
                }
                else
                {
                  ...
                  if ( v29 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, v29, 0x166u);
                    v10 = v44;
                  }
                  else
                  {
                    ...
                    if ( v31 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0, v31, 0x168u);
                    }
                    else
                    {
                      v33 = a2[1];
                      ...
                      v14 = v36;
                      if ( v36 < 0 )
                        MilInstrumentationCheckHR_MaybeFailFast(v37, 0LL, 0, v36, 0x16Fu);
                    }
                  }
                }
              }
