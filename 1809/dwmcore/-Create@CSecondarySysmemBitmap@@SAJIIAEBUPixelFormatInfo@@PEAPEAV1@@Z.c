/*
 * XREFs of ?Create@CSecondarySysmemBitmap@@SAJIIAEBUPixelFormatInfo@@PEAPEAV1@@Z @ 0x18001A700
 * Callers:
        ...
        struct CSecondarySysmemBitmap **a4)
{
  char *v8; // rax
  char *v9; // rbx
  EmitterShapes::CPathEmitterShape *v10; // rcx
  int v11; // eax
  int v12; // eax
  ...
  *((_DWORD *)v8 + 2) = 0;
  v10 = (EmitterShapes::CPathEmitterShape *)v8;
  ...
  *((_DWORD *)v9 + 33) = v11;
  v9[148] = 0;
  EmitterShapes::CPathEmitterShape::AddRef(v10);
