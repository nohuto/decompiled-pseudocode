/*
 * XREFs of ?UnrefAnimationScenario@CAnimationTracking@@QEAAXI_KPEBU_GUID@@AEBUTelFrameInfo@1@@Z @ 0x18008285C
 * Callers:
        ...
        const struct CAnimationTracking::TelFrameInfo *a5)
{
  ...
  if ( CAnimationTracking::FindScenario(this, a2, v5, &v19) != *((_DWORD *)this + 6) )
  {
    ...
    if ( (_DWORD)v11 != v14 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, -2147024809, 0x21Fu);
      }
      else
      {
        v18 = v17 - 1;
