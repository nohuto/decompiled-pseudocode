/*
 * XREFs of ?Add@CDirtyRegion@@QEAAJPEAVCVisual@@_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18002CE38
 * Callers:
...
__int64 __fastcall CDirtyRegion::Add(CDirtyRegion *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    v7 = CDirtyRegion::_Add(this);
    v5 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x1ABu);
  }
  return v5;
}
