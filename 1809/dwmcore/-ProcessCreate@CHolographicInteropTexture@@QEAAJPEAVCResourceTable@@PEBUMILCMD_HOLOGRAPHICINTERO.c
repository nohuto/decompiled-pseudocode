/*
 * XREFs of ?ProcessCreate@CHolographicInteropTexture@@QEAAJPEAVCResourceTable@@PEBUMILCMD_HOLOGRAPHICINTEROPTEXTURE_CREATE@@@Z @ 0x18020E290
 * Callers:
        ...
        const struct MILCMD_HOLOGRAPHICINTEROPTEXTURE_CREATE *a3)
{
  ...
  *((_OWORD *)this + 12) = _xmm;
  *((_OWORD *)this + 13) = _xmm;
  v4 = *(CHolographicManager **)(*((_QWORD *)this + 2) + 120LL);
  *((_QWORD *)this + 9) = v4;
  if ( v4 )
  {
