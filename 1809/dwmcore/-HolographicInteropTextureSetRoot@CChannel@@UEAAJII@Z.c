/*
 * XREFs of ?HolographicInteropTextureSetRoot@CChannel@@UEAAJII@Z @ 0x1801463A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::HolographicInteropTextureSetRoot(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
