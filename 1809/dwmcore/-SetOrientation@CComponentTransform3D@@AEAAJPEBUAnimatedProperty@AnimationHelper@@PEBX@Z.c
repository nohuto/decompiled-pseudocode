/*
 * XREFs of ?SetOrientation@CComponentTransform3D@@AEAAJPEBUAnimatedProperty@AnimationHelper@@PEBX@Z @ 0x18006B610
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct D2DQuaternion *a3)
{
    ...
    || *((float *)this + 55) != v8[3] )
  {
    *((_OWORD *)this + 13) = *(_OWORD *)v8;
    CResource::InvalidateAnimationSources(this, 0x18u);
    ...
    v4 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x16Au);
  }
  return v4;
}
