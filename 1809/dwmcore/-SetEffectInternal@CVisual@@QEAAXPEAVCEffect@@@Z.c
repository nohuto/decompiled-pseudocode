/*
 * XREFs of ?SetEffectInternal@CVisual@@QEAAXPEAVCEffect@@@Z @ 0x180029940
 * Callers:
...
void __fastcall CVisual::SetEffectInternal(CVisual *this, struct CEffect *a2)
{
  ...
  if ( a2 )
  {
    if ( (v6 & 0x200000) != 0 )
    {
      ...
      if ( i < (unsigned int)v7 )
        v3 = (_QWORD *)((char *)v5 + v7 + 8LL * i - (((_BYTE)v7 + 15) & 7) + 15);
      *v3 = a2;
    }
    else
    {
  ...
  else if ( (v6 & 0x200000) != 0 )
  {
    v10 = *v2;
    *v5 = v6 & 0xFFDFFFFF;
    Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v10, 11LL);
