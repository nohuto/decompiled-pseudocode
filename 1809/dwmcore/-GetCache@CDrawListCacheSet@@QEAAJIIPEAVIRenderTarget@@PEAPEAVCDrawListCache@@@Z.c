/*
 * XREFs of ?GetCache@CDrawListCacheSet@@QEAAJIIPEAVIRenderTarget@@PEAPEAVCDrawListCache@@@Z @ 0x180027190
 * Callers:
        ...
        struct CDrawListCache **a5)
{
  ...
  CMILRefCountBase *v24; // [rsp+70h] [rbp+8h] BYREF
...
LABEL_5:
    ...
    {
      if ( *(_DWORD *)i == a2 && *(_DWORD *)(i + 4) == a3 )
      {
        v11 = *(volatile signed __int32 **)(i + 8);
        v24 = (CMILRefCountBase *)v11;
        if ( !v11 )
          goto LABEL_12;
  ...
  v18 = HeapAlloc(WPF::g_processHeap, 0, 0x58uLL);
  v12 = v18;
  if ( !v18 )
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, -2147024882, 0x6Bu);
    goto LABEL_12;
  }
...
LABEL_21:
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x7Eu);
LABEL_11:
