/*
 * XREFs of ?CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z @ 0x1801E0890
 * Callers:
 ...
 * Callees:
 *     ?AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ @ 0x1801E0758 (-AdvanceDeltaDueToScale@CPositionMotion@@AEAAXXZ.c)
 */
