/*
 * XREFs of ?RenderXBR@CResampleLayer@@AEAAJPEAVCSurfaceShaderComposer@@PEAUID3D11RenderTargetView@@AEBUD3D11_VIEWPORT@@@Z @ 0x18017E498
 * Callers:
        ...
        const struct D3D11_VIEWPORT *a4)
{
  ...
  unsigned __int32 v39; // [rsp+B0h] [rbp-1h]
  unsigned __int32 v40; // [rsp+B4h] [rbp+3h]
...
LABEL_3:
  ...
  SurfacePixelShaderNoRef = CSurfaceShaderComposer::GetSurfacePixelShaderNoRef(a2, 4LL, &v33);
  if ( SurfacePixelShaderNoRef < 0 )
  {
    v13 = 377LL;
    goto LABEL_3;
  ...
  v36 = &v27;
  v35 = 1LL;
  v39 = _mm_cvtepi32_ps(v15).m128_u32[0];
  v42 = FLOAT_1_0;
  v40 = _mm_cvtepi32_ps(v16).m128_u32[0];
  ...
  *(float *)v21.m128i_i32 = _mm_cvtepi32_ps(v21).m128_f32[0] * *((float *)this + 32);
  ...
  SurfacePixelShaderNoRef = CSurfaceShaderComposer::GetSurfacePixelShaderNoRef(a2, 5LL, &v33);
  if ( SurfacePixelShaderNoRef < 0 )
  {
    v13 = 417LL;
    goto LABEL_3;
