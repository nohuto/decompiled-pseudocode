/*
 * XREFs of ?CalculateValueForState@CScrollAnimation@@AEAAJPEAVCExpressionValueStack@@_KW4ScrollState@@PEAM@Z @ 0x1801D5F08
 * Callers:
        ...
        float *a5)
{
  ...
  if ( !v5 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x135u);
      return v8;
    }
    return 0;
  }
  ...
  if ( v6 >= 0 )
    return 0;
  MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x13Eu);
  return v8;
}
