/*
 * XREFs of InitializeInteractionStateInfo @ 0x18006E84C
 * Callers:
...
_OWORD *__fastcall InitializeInteractionStateInfo(__int64 a1)
{
  ...
  __int128 v12; // xmm1
  __int128 v13; // xmm1
  _BYTE v14[120]; // [rsp+20h] [rbp-E0h] BYREF
  int v15; // [rsp+98h] [rbp-68h]
  int v16; // [rsp+DCh] [rbp-24h]
  int v17; // [rsp+120h] [rbp+20h]
  int v18; // [rsp+164h] [rbp+64h]
  int v19; // [rsp+1A8h] [rbp+A8h]
  int v20; // [rsp+1ECh] [rbp+ECh]
