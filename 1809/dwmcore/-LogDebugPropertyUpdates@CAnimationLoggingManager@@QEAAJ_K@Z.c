/*
 * XREFs of ?LogDebugPropertyUpdates@CAnimationLoggingManager@@QEAAJ_K@Z @ 0x180066DAC
 * Callers:
...
LABEL_9:
  ...
  v11 = (*(__int64 (__fastcall **)(struct CResource *, _QWORD, _BYTE *))(*(_QWORD *)ResourceWithoutType + 104LL))(
          ResourceWithoutType,
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x1A0u);
LABEL_3:
  v6 = v14;
  if ( v14 )
  {
