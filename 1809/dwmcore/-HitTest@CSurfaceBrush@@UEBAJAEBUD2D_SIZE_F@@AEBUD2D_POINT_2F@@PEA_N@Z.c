/*
 * XREFs of ?HitTest@CSurfaceBrush@@UEBAJAEBUD2D_SIZE_F@@AEBUD2D_POINT_2F@@PEA_N@Z @ 0x18006E0D0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a4 = 0;
    ...
    && !(*(unsigned __int8 (__fastcall **)(CSurfaceBrush *))(*(_QWORD *)this + 192LL))(this) )
  {
    ...
    if ( v11 )
    {
      ...
      v4 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v10, 0LL, 0, v13, 0x176u);
    }
    if ( v18 )
