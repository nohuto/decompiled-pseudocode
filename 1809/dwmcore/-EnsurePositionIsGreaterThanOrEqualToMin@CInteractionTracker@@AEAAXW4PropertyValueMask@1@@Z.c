/*
 * XREFs of ?EnsurePositionIsGreaterThanOrEqualToMin@CInteractionTracker@@AEAAXW4PropertyValueMask@1@@Z @ 0x18019F57C
 * Callers:
...
void __fastcall CInteractionTracker::EnsurePositionIsGreaterThanOrEqualToMin(__int64 a1, char a2)
{
  int v2; // eax
  ...
  if ( !*(_DWORD *)(a1 + 168) && (*(_BYTE *)(a1 + 532) & 0x20) == 0 )
  {
    ...
    v4 = v2;
    if ( (a2 & 1) != 0 )
      LODWORD(v3) = fmaxf(*(float *)(a1 + 72), *(float *)(a1 + 84));
    if ( (a2 & 2) != 0 )
      HIDWORD(v3) = fmaxf(*(float *)(a1 + 76), *(float *)(a1 + 88));
    v4 = 0;
