/*
 * XREFs of ?DrawImageResource_FillMode@CRenderData@@AEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@_NPEAVCImageSource@@PEBUD2D_RECT_F@@4M4@Z @ 0x18005C00C
 * Callers:
    ...
    else
    {
      ...
      *(_QWORD *)&v43.left = 0x3F8000003F800000LL;
      ...
      else
      {
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x440u);
          goto LABEL_24;
        }
        v30 = v43;
      }
      ...
      if ( D2DMatrixHelper::ComputeRectangleTransform((D2DMatrixHelper *)&v43, &v30, &v37, v14) )
      {
        ...
        *(_QWORD *)&v30.left = 0LL;
        ...
        if ( v11 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v18, 0LL, 0, v11, 0x452u);
        }
        else
        {
          v19 = *(_QWORD *)&v30.left;
          ...
          *(_QWORD *)&v30.left = 0LL;
          ...
          v11 = DrawList;
          if ( DrawList < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, DrawList, 0x45Cu);
        }
        if ( *(_QWORD *)&v30.left )
