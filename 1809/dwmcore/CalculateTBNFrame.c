/*
 * XREFs of CalculateTBNFrame @ 0x180008F4C
 * Callers:
...
__int64 __fastcall CalculateTBNFrame(_QWORD *a1, _QWORD *a2, float *a3, __int64 a4, __int64 a5)
{
  ...
  v21 = (float)(v17 * v20) - (float)(v19 * v18);
  ...
  if ( v22 < 0.0000011920929 )
  {
    ...
    v28 = 0LL;
    v29 = 0.0;
    v30 = _mm_unpacklo_ps((__m128)0LL, (__m128)LODWORD(FLOAT_1_0)).m128_u64[0];
  }
  else
  {
    v27 = v7;
    ...
    v25 = v24;
    v25.m128_f32[0] = (float)(1.0 / v21) * (float)((float)(v17 * v12) - (float)(v7.m128_f32[0] * v19));
    v26 = v24;
