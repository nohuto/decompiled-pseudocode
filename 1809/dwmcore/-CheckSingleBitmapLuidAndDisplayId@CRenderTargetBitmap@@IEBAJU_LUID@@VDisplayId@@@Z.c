/*
 * XREFs of ?CheckSingleBitmapLuidAndDisplayId@CRenderTargetBitmap@@IEBAJU_LUID@@VDisplayId@@@Z @ 0x180094F6C
 * Callers:
...
__int64 __fastcall CRenderTargetBitmap::CheckSingleBitmapLuidAndDisplayId(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x1B1u);
  }
  else
  {
    v9 = v11;
    if ( v11 == DisplayId::All )
      v9 = DisplayId::None;
    v11 = v9;
    if ( __PAIR64__(HIDWORD(v12), v5) != v13 || v9 != a3 && v9 != DisplayId::None && a3 != DisplayId::All )
    {
      v8 = -2003304287;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2003304287, 0x1BDu);
    }
  }
  return v8;
}
