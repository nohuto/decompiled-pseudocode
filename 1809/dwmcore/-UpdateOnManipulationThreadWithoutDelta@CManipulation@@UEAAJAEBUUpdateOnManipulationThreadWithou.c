/*
 * XREFs of ?UpdateOnManipulationThreadWithoutDelta@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadWithoutDeltaArgs@@@Z @ 0x1801A6AA0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct UpdateOnManipulationThreadWithoutDeltaArgs *a2)
{
  ...
  *(_DWORD *)(v6 + 28) = 0;
  *(_QWORD *)(v6 + 44) = _mm_unpacklo_ps((__m128)LODWORD(FLOAT_1_0), (__m128)LODWORD(FLOAT_1_0)).m128_u64[0];
  *(_DWORD *)(v6 + 52) = 1065353216;
    ...
    || ((*(_BYTE *)(v7 + 16) ^ *(_BYTE *)(v6 + 188)) & 2) != 0 )
  {
    ...
    *(_BYTE *)(v6 + 188) ^= (*(_BYTE *)(v7 + 16) ^ *(_BYTE *)(v6 + 188)) & 2;
    ...
    v3 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0xABu);
  }
  return v3;
}
