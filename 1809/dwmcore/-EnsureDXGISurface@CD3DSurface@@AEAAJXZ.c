/*
 * XREFs of ?EnsureDXGISurface@CD3DSurface@@AEAAJXZ @ 0x180098A5C
 * Callers:
...
__int64 __fastcall CD3DSurface::EnsureDXGISurface(CD3DSurface *this)
{
  ...
  {
    v2 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, -2003292412, 0x365u);
    goto LABEL_3;
  }
  if ( *((_QWORD *)this + 26) )
    goto LABEL_3;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, v10);
LABEL_3:
  if ( v11 )
