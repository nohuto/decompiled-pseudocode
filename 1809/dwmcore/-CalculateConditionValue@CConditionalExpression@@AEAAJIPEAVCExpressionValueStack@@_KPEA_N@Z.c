/*
 * XREFs of ?CalculateConditionValue@CConditionalExpression@@AEAAJIPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180192C64
 * Callers:
        ...
        bool *a5)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x18Du);
  }
  else
  {
    ...
    {
      v9 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2147024809, 0x193u);
    }
  }
  return v9;
}
