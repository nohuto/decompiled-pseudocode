/*
 * XREFs of ?DrawSolidColorRectangle@CRenderData@@AEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@_NAEBUMilRectF@@AEBU_D3DCOLORVALUE@@@Z @ 0x18005BE38
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a6)
{
  ...
  *(_QWORD *)&v21.r = 0LL;
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v13, 0LL, 0, v14, 0x382u);
  }
  else
  {
    v15 = *(_OWORD *)a5;
    ...
    *(_QWORD *)&v21.r = 0LL;
    ...
    v14 = DrawList;
    if ( DrawList < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, DrawList, 0x386u);
  }
  if ( *(_QWORD *)&v21.r )
