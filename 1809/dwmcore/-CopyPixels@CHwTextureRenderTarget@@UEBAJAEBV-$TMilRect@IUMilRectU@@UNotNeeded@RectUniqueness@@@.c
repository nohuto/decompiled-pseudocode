/*
 * XREFs of ?CopyPixels@CHwTextureRenderTarget@@UEBAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@IIPEAE@Z @ 0x180202EA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x2E7u);
    v6 = v23;
    goto LABEL_15;
  }
  v6 = v23;
  ...
  v17 = v16;
LABEL_14:
  MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, v17, v19);
LABEL_15:
  if ( v21 )
