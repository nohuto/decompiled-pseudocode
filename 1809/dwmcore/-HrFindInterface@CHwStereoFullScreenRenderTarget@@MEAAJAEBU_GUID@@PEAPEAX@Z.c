/*
 * XREFs of ?HrFindInterface@CHwStereoFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180207290
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      *a3 = (void *)(((unsigned __int64)this + 424) & -(__int64)(this != (CHwStereoFullScreenRenderTarget *)160));
      return 0LL;
    }
  }
  return result;
