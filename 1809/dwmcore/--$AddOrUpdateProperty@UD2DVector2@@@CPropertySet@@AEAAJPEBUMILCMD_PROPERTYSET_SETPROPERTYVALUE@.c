/*
 * XREFs of ??$AddOrUpdateProperty@UD2DVector2@@@CPropertySet@@AEAAJPEBUMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DVector2@@@Z @ 0x180073098
 * Callers:
...
LABEL_11:
    ...
    updated = CPropertySet::UpdateProperty<D2DVector2>(v11, v7, *(unsigned int *)(v10 + 16), v9);
    v5 = updated;
    if ( updated < 0 )
    {
      v13 = 344;
