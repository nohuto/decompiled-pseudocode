/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo_0 @ 0x180148360
 * Callers:
...
__int64 __fastcall anonymous_namespace_::FrameSequenceInfo::FrameSequenceInfo_0(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 408) = 0LL;
  *(_QWORD *)(a1 + 416) = 0LL;
  v4 = std::_Tree_comp_alloc<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::_Buyheadnode();
  *(_QWORD *)(a1 + 408) = v4;
  ...
  *(_QWORD *)(a1 + 424) = 0LL;
  *(_QWORD *)(a1 + 432) = 0LL;
  v6 = std::_Tree_comp_alloc<std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0>>::_Buyheadnode();
  *(_QWORD *)(a1 + 424) = v6;
