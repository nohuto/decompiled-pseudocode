/*
 * XREFs of ?UpdateLightInfo@CHwLightCollectionBuffer@@AEAAXPEBULightInfo@@I_N@Z @ 0x18000A1E4
 * Callers:
        ...
        char a4)
{
  ...
  int v21; // r11d
  __m128 v22; // [rsp+48h] [rbp-9h] BYREF
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      if ( *((_DWORD *)v13 - 3) )
      {
        ...
        v24 = v16;
        v25 = v17;
        CMILMatrix::Transpose(&v22);
        v18 = v23;
        v19 = 112LL * v10;
        v20 = (unsigned __int64)v10++ << 7;
        *(__m128 *)((char *)this + v20 + 20) = v22;
