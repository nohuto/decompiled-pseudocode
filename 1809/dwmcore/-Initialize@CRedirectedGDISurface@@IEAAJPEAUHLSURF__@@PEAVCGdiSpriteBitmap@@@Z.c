/*
 * XREFs of ?Initialize@CRedirectedGDISurface@@IEAAJPEAUHLSURF__@@PEAVCGdiSpriteBitmap@@@Z @ 0x18006FB20
 * Callers:
  ...
  if ( inserted )
  {
    ...
    *((_BYTE *)this + 40) = 1;
    ...
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x88980003, 0LL, 0, LastError, 0x4Cu);
    }
  }
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, -2147024882, 0x48u);
  }
