/*
 * XREFs of ?SetProperty@CParticleEmitter@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801C6A90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CParticleEmitter::SetProperty(__int64 a1, int a2, int a3, __int64 a4)
{
  ...
  v12[0] = 1LL;
  v12[1] = &CParticleEmitter::k_rgAnimDef;
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v10 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x32Du);
  }
  else
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x331u);
  }
  return v10;
}
