/*
 * XREFs of ??$SetProperty@UD2DVector4@@@DataSourcePropertySet@@QEAAJIPEBUD2DVector4@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18016EC04
 * Callers:
 *     ?SetVector4Value@DataSourceProxy@@MEAAJIMMMM@Z @ 0x180170220 (-SetVector4Value@DataSourceProxy@@MEAAJIMMMM@Z.c)
 * Callees:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DVector4>(__int64 a1, int a2, _OWORD *a3)
{
  __int64 v6; // r11
  _QWORD *v7; // rax
  __int64 v8; // r10
...
LABEL_6:
  ...
  if ( v8 == v9 )
  {
    v11 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector4>(v10, 69, a3, &v25);
    v12 = v11;
    if ( v11 < 0 )
    {
