/*
 * XREFs of ?PopStereoContext@CDrawingContext@@QEAAJPEAV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x180165C4C
 * Callers:
...
__int64 __fastcall CDrawingContext::PopStereoContext(__int64 a1, __int64 a2, double a3)
{
  ...
  *(_QWORD *)&v11 = v6;
  ...
  v9 = v7;
  if ( v7 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0xEEAu);
