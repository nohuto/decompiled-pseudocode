/*
 * XREFs of ?RegisterInteractionTrackerNotification@CExpressionManager@@QEAAXPEAVCInteractionTracker@@@Z @ 0x18018A338
 * Callers:
...
LABEL_5:
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, (unsigned int)v7 < (unsigned int)v4 ? 0x80070216 : 0, 0xB5u);
    }
