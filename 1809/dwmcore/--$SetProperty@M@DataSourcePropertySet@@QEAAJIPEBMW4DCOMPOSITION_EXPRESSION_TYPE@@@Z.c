/*
 * XREFs of ??$SetProperty@M@DataSourcePropertySet@@QEAAJIPEBMW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18016E4C4
 * Callers:
 *     ?SetScalarValue@DataSourceProxy@@MEAAJIM@Z @ 0x180170110 (-SetScalarValue@DataSourceProxy@@MEAAJIM@Z.c)
 * Callees:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<float>(__int64 a1, int a2, _DWORD *a3)
{
  __int64 v6; // r11
  _QWORD *v7; // rax
  __int64 v8; // r10
...
LABEL_6:
  ...
  if ( v8 == v9 )
  {
    v11 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<float>(v10, 18, a3, &v24);
    v12 = v11;
    if ( v11 < 0 )
    {
  ...
  else
  {
    ...
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v16) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    *(_DWORD *)((*(_DWORD *)(v19 + 8 * v17 + 4) & 0x1FFFFFFF) + *(_QWORD *)(v18 + 32)) = *a3;
  }
  return 0LL;
}
