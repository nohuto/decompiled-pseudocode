/*
 * XREFs of ?HrInit@CClientMemoryBitmap@@QEAAJIIAEBUPixelFormatInfo@@IPEAXIPEAUIUnknown@@@Z @ 0x180092C30
 * Callers:
...
LABEL_13:
    v15 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, -2147024809, v17);
    return v15;
  }
