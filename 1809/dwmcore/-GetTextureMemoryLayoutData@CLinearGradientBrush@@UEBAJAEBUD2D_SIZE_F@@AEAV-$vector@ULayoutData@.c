/*
 * XREFs of ?GetTextureMemoryLayoutData@CLinearGradientBrush@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801A4E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLinearGradientBrush::GetTextureMemoryLayoutData(__int64 a1, __int64 a2, __int64 a3)
{
  _OWORD *v5; // rdx
  __int64 v6; // rcx
  __int128 v7; // xmm2
  ...
  *(_QWORD *)(a3 + 8) = *(_QWORD *)a3;
  if ( *(_BYTE *)(a1 + 168) )
  {
    ...
    *(_OWORD *)&v10[8] = _xmm;
    if ( v6 )
    {
      (*(void (__fastcall **)(__int64, __int64, __int128 *))(*(_QWORD *)v6 + 176LL))(v6, a2, &v9);
      v5 = *(_OWORD **)(a3 + 8);
      v7 = v9;
    }
    else
