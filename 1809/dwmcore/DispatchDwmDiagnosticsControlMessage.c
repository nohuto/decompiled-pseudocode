/*
 * XREFs of DispatchDwmDiagnosticsControlMessage @ 0x1801E401C
 * Callers:
 *     McGenControlCallbackV2 @ 0x180076400 (McGenControlCallbackV2.c)
 * Callees:
 *     ModuleFailFastForHRESULT @ 0x1801E0F18 (ModuleFailFastForHRESULT.c)
 *     ?HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z @ 0x1801E40C8 (-HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z.c)
 */
