...
__int64 __fastcall std::vector<wil::com_ptr_t<CSubRectBitmapRealizationImageSource,wil::err_returncode_policy>>::_Emplace_reallocate<wil::com_ptr_t<CSubRectBitmapRealizationImageSource,wil::err_returncode_policy> const &>(
        char **a1,
        char *a2,
        CMILCOMBase **a3)
{
