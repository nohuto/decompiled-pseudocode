/*
 * XREFs of ?clear_region@?$vector_facade@MV?$buffer_impl@M$05$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x1800EE968
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  *((_QWORD *)&v8 + 1) = (v3 - (__int64)v5) >> 2;
  if ( a3 != result )
  {
    ...
    v11 = 0LL;
    v10 = v8;
    result = std::move<std::move_iterator<enum D2D1_EDGE_FLAGS *>,stdext::checked_array_iterator<enum D2D1_EDGE_FLAGS *>>(
               (__int64)&v8,
               &v5[v7],
               &v5[4 * result],
               &v10);
