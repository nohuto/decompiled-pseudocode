/*
 * XREFs of ??0?$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@QEAA@W4InputType@@@Z @ 0x180070638
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_QWORD *)a1 = 0LL;
  *(_OWORD *)(a1 + 20) = xmmword_1802AEC90;
  *(_OWORD *)(a1 + 36) = xmmword_1802AECA0;
  *(_OWORD *)(a1 + 52) = xmmword_1802AECB0;
  *(_OWORD *)(a1 + 68) = xmmword_1802AECC0;
  *(_QWORD *)(a1 + 88) = 0LL;
  *(_QWORD *)(a1 + 96) = 0LL;
  *(_QWORD *)(a1 + 104) = 0LL;
  *(_DWORD *)(a1 + 112) = 0;
