/*
 * XREFs of ?CalcInversedOffsetInputBoundsFromVisibleWorldOutputBounds@CLayerVisual@@AEAAXAEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@1PEAV3@2@Z @ 0x1801A4324
 * Callers:
        ...
        __int64 a6)
{
  ...
  v6 = *(_OWORD *)(a2 + 16);
  *(_QWORD *)v22 = *(_QWORD *)(*(_QWORD *)(a1 + 560) + 96LL);
  v9 = *(_OWORD *)a2;
  v24 = *(_DWORD *)(a2 + 64);
  v23[1] = v6;
  v10 = *(_OWORD *)(a2 + 48);
