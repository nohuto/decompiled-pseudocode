/*
 * XREFs of ?NotifyUpdateTemporaryConfiguration@CManipulationManager@@QEAAJPEAVCInteraction@@W4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x1801EAB20
 * Callers:
        ...
        int a6)
{
  ...
  if ( v11 )
  {
    *(_DWORD *)v11 = 8;
    ...
    Microsoft::WRL::ComPtr<CInteraction>::operator=((_QWORD *)(v11 + 16), a2);
    *(_BYTE *)(v11 + 64) &= ~1u;
    *(_BYTE *)(v11 + 64) |= a5;
    *(_DWORD *)(v11 + 40) = a4;
    *(_DWORD *)(v11 + 44) = a3;
    *(_DWORD *)(v11 + 48) = 1;
    ...
    if ( v16 )
    {
      ...
      *(_QWORD *)(v11 + 56) = v16;
      ...
      if ( v17 >= 0 )
        return v12;
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x223u);
    }
    else
    {
      v12 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, -2147024882, 0x218u);
    }
  ...
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, -2147024882, 0x20Cu);
  }
  return v12;
}
