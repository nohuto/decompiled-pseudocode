/*
 * XREFs of ?ProcessUpdateInputs@CFilterEffect@@QEAAJPEAVCResourceTable@@PEBUMILCMD_FILTEREFFECT_UPDATEINPUTS@@PEBXI@Z @ 0x1801980A0
 * Callers:
 ...
 *     ?Add@?$CMap@IPEAVInternalFilterInput@@V?$CMapEqualHelper@IPEAVInternalFilterInput@@@@@@QEAAHAEBIAEBQEAVInternalFilterInput@@@Z @ 0x180196634 (-Add@-$CMap@IPEAVInternalFilterInput@@V-$CMapEqualHelper@IPEAVInternalFilterInput@@@@@@QEAAHAEBI.c)
 *     ?EmptyFilterInputMap@CFilterEffect@@AEAAXXZ @ 0x1801973A8 (-EmptyFilterInputMap@CFilterEffect@@AEAAXXZ.c)
 *     ?RemoveRange@?$CMap@IPEAVInternalFilterInput@@V?$CMapEqualHelper@IPEAVInternalFilterInput@@@@@@QEAAHHH@Z @ 0x180198348 (-RemoveRange@-$CMap@IPEAVInternalFilterInput@@V-$CMapEqualHelper@IPEAVInternalFilterInput@@@@@@Q.c)
 */
        ...
        unsigned int a5)
{
  ...
  {
    v11 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024362, 0x2BFu);
    goto LABEL_43;
  }
  v10 = a5;
  v11 = 0;
...
LABEL_35:
        ...
        else
        {
          ...
          {
            v11 = -2147024882;
            MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, -2147024882, 0x2EAu);
            v6 = v30;
            goto LABEL_44;
          }
          v6 = v30;
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0x2FCu);
          goto LABEL_43;
        }
        goto LABEL_35;
      }
...
LABEL_5:
  v11 = v12;
  MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v12, v27);
LABEL_44:
