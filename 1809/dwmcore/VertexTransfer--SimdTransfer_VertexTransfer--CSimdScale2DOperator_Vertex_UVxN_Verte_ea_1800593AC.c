/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____0_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1800593AC
 * Callers:
  ...
  if ( v5 )
  {
    do
    {
      ...
      if ( (_mm_movemask_ps(_mm_cmpeq_ps(v19, DirectX::g_XMZero)) & 3) != 3 )
      {
        ...
        v10.m128_f32[0] = 1.0 / fsqrt(v20.m128_f32[0] + _mm_shuffle_ps(v20, v20, 85).m128_f32[0]);
      ...
      *v17 = _mm_shuffle_ps(
      ...
      {
        v21 = v8;
        v22 = (char *)v13 - (char *)v11;
        v23 = _mm_shuffle_ps(v10, v10, 0);
        v24 = (char *)v17 - (char *)v11;
        v25 = v11 + 1;
        do
        {
      ...
      v26 = *v14;
      v27 = _mm_sub_ps(_mm_shuffle_ps(*v12, DirectX::g_XMOne, 228), *v14);
      ...
      else
      {
        ...
        v30.m128_f32[0] = 1.0 / fsqrt(v29.m128_f32[0] + _mm_shuffle_ps(v29, v29, 85).m128_f32[0]);
        v31 = _mm_mul_ps(_mm_shuffle_ps(v26, v26, 170), _mm_shuffle_ps(v30, v30, 0));
      }
      *v18 = _mm_shuffle_ps(
               _mm_add_ps(
                 _mm_add_ps(
      ...
      if ( v8 )
      {
        ...
        v35 = (char *)v18 - (char *)v12;
        result = v12 + 1;
        do
        {
          *(__m128 *)((char *)result + v35) = _mm_add_ps(
                                                _mm_mul_ps(_mm_sub_ps(*result, *(__m128 *)((char *)result + v33)), v34),
                                                *(__m128 *)((char *)result + v33));
          ++result;
          --v32;
        }
        while ( v32 );
