/*
 * XREFs of ?Initialize@?$CTypedConstantBuffer@V?$array@M$07@std@@@@QEAAJPEAVCD3DDeviceLevel1@@W4D3D11_USAGE@@@Z @ 0x1800D7168
 * Callers:
...
__int64 __fastcall CTypedConstantBuffer<std::array<float,8>>::Initialize(
        ...
        struct CD3DDeviceLevel1 *a2)
{
  ...
  if ( !*a1 )
  {
    ...
    *(_QWORD *)&v6.SysMemPitch = 0LL;
    ...
    v2 = v3;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, v3, 0x44u);
  }
  return v2;
}
