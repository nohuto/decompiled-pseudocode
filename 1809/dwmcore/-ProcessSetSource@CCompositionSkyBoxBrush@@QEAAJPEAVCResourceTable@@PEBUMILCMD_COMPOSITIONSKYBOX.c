/*
 * XREFs of ?ProcessSetSource@CCompositionSkyBoxBrush@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPOSITIONSKYBOXBRUSH_SETSOURCE@@@Z @ 0x1801913F0
 * Callers:
        ...
        const struct MILCMD_COMPOSITIONSKYBOXBRUSH_SETSOURCE *a3)
{
  ...
  if ( !v5 || (Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, v5, 0x1Eu)) != 0LL )
  {
    if ( Resource != this[9] )
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x240u);
      }
      else
      {
        v11 = this[9];
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2003303421, 0x23Au);
  }
  return v4;
}
