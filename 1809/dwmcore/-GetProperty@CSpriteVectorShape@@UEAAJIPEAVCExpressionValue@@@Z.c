/*
 * XREFs of ?GetProperty@CSpriteVectorShape@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801B3920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVectorShape::GetProperty(CSpriteVectorShape *this, int a2, struct CExpressionValue *a3)
{
  ...
  v9[0] = 3LL;
  v9[1] = &CSpriteVectorShape::k_rgAnimDef;
  v5 = 0;
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024809, 0x48u);
  }
  return v5;
}
