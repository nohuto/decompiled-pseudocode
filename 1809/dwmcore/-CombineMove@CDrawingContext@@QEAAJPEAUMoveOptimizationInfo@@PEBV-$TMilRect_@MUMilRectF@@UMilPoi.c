/*
 * XREFs of ?CombineMove@CDrawingContext@@QEAAJPEAUMoveOptimizationInfo@@PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180162074
 * Callers:
...
LABEL_8:
    ...
    if ( v10 + 1 < v10 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, v12, 0xB5u);
    }
    else if ( v11 > *(_DWORD *)(v4 + 6164) )
    {
      v26 = DynArrayImpl<0>::AddMultipleAndSet(v4 + 6144, 8, 1, &v28);
      v12 = v26;
      if ( v26 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v26, 0xC0u);
    }
    else
    {
      v13 = v10;
      *(_QWORD *)(*(_QWORD *)(v4 + 6144) + 8LL * v10) = v28;
      *(_DWORD *)(v4 + 6168) = v11;
    }
    if ( v12 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x1C76u);
    else
  ...
  else
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x1C63u);
    }
    else
    {
