/*
 * XREFs of ?ProcessUpdate@CSnapshot@@UEAAJPEBVCResourceTable@@PEBUMILCMD_SNAPSHOT@@@Z @ 0x1801B2A50
 * Callers:
        ...
        const struct MILCMD_SNAPSHOT *a3)
{
  ...
  v5 = 0;
  Resource = (struct CVisual *)CResourceTable::GetResource((__int64)a2, *((_DWORD *)a3 + 2), 0x9Du);
      ...
      if ( *((_DWORD *)a3 + 4) )
      {
        ...
        if ( (int)CComposition::GetPrimaryDisplayDimensions(v7, &v14, &v15) >= 0 )
        {
          ...
          *((_BYTE *)this + 64) = *((_DWORD *)a3 + 5) != 0;
          ...
          v5 = CVI;
          if ( CVI < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, CVI, 0xAFu);
        }
      }
    }
  }
