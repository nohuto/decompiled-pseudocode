/*
 * XREFs of ?RemoveLogicalSurfaceEntry@CLogicalSurfaceHandleMap@@QEAAXPEBVCGdiSpriteBitmap@@PEAX@Z @ 0x18006FBE4
 * Callers:
 *     ??1CRedirectedGDISurface@@MEAA@XZ @ 0x18006FA40 (--1CRedirectedGDISurface@@MEAA@XZ.c)
 * Callees:
 *     <none>
 */
