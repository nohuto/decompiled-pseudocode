/*
 * XREFs of ?CheckDirectFlipSupport@CDWMSwapChain@@UEAAJPEAUIDXGIResource@@W4DXGI_COLOR_SPACE_TYPE@@AEBUtagRECT@@2PEA_N@Z @ 0x180203B70
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( v15 || v10 )
  {
    ...
    v41 = 0;
    v43 = 0;
    v23 = *(__int64 (__fastcall **)(CDWMSwapChain *, __int64, int *, bool *, char *))(v22 + 208);
    v35 = v20;
    v38 = 1LL;
    v36 = v19;
    v42 = a3;
    ...
    v9 = v24;
    if ( v24 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0x32Cu);
  }
  else if ( (unsigned int)a3 <= DXGI_COLOR_SPACE_RGB_FULL_G10_NONE_P709 )
  {
    ...
    v9 = v17;
    if ( v17 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x334u);
    else
      *a6 = (_DWORD)v28 != 0;
  }
  return v9;
