/*
 * XREFs of ?GetBrushParameters@CMaskBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x18005C350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMaskBrush::GetBrushParameters(CMaskBrush *this, struct CBrushDrawListGenerator *a2)
{
  ...
  v32 = 0;
  v33 = 0;
  v7 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 304LL))(v6, &v23);
  v9 = v7;
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x188u);
    goto LABEL_18;
  }
  v10 = v27;
  *((_BYTE *)a2 + 76) = v33;
  ...
  *(_OWORD *)((char *)a2 + 20) = v10;
  ...
  if ( !v13 )
    goto LABEL_10;
  if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v13 + 48LL))(v13, 101LL)
    && !CMaskBrush::IsValidMaskResource(*(const struct CResource **)(*((_QWORD *)this + 9) + 72LL)) )
  {
    v9 = -2147024846;
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x80000) != 0 )
      McTemplateU0d(
        ...
        2147942450LL);
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, -2147024846, 0x1A1u);
    goto LABEL_19;
  }
  v14 = *(_QWORD *)a2;
  v15 = *((_QWORD *)this + 9);
  ...
  v32 = 0;
  v33 = 0;
  v17 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v15 + 304LL))(v15, &v23);
  v9 = v17;
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x1A9u);
LABEL_18:
    CBrushDrawListGenerator::~CBrushDrawListGenerator((CBrushDrawListGenerator *)&v23);
LABEL_19:
