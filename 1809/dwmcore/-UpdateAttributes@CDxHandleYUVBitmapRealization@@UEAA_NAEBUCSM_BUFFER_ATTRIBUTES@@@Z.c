/*
 * XREFs of ?UpdateAttributes@CDxHandleYUVBitmapRealization@@UEAA_NAEBUCSM_BUFFER_ATTRIBUTES@@@Z @ 0x1802295A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CSM_BUFFER_ATTRIBUTES *a2)
{
  ...
  if ( v6 != (*((_DWORD *)this + 67) & 1) || *((_QWORD *)a2 + 1) != *((_QWORD *)this + 20) )
    *((_DWORD *)this + 108) = *(_DWORD *)CBitmapRealization::CalcDisplayRestriction(
                                           v5,
