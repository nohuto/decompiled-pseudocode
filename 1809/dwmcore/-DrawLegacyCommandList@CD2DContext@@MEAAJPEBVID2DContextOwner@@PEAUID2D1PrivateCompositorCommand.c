/*
 * XREFs of ?DrawLegacyCommandList@CD2DContext@@MEAAJPEBVID2DContextOwner@@PEAUID2D1PrivateCompositorCommandList@@MW4D2D1_ANTIALIAS_MODE@@W4D2D1_DRAW_COMPOSITOR_COMMAND_LIST_OPTIONS@@I_N@Z @ 0x1801FEBB0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a8)
{
  ...
  if ( CCommonRegistryData::m_fEnableDisallowNonDrawListRendering
    && *(char *)((*(__int64 (__fastcall **)(__int64 *))(*a2 + 40))(a2) + 94) < 0 )
  {
    while ( 1 )
    {
