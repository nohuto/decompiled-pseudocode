/*
 * XREFs of ??$SetProperty@UD2DQuaternion@@@DataSourcePropertySet@@QEAAJIPEBUD2DQuaternion@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18016E7B8
 * Callers:
 *     ?SetQuaternionValue@DataSourceProxy@@MEAAJIMMMM@Z @ 0x1801700A0 (-SetQuaternionValue@DataSourceProxy@@MEAAJIMMMM@Z.c)
 * Callees:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DQuaternion>(__int64 a1, int a2, _OWORD *a3)
{
  __int64 v6; // r11
  _QWORD *v7; // rax
  __int64 v8; // r10
...
LABEL_6:
  ...
  if ( v8 == v9 )
  {
    v11 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector4>(v10, 71, a3, &v25);
    v12 = v11;
    if ( v11 < 0 )
    {
  ...
  else
  {
    ...
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v17) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    *(_OWORD *)((*(_DWORD *)(v19 + 8 * v18 + 4) & 0x1FFFFFFF) + *(_QWORD *)(v20 + 32)) = *a3;
  }
  return 0LL;
}
