/*
 * XREFs of ?OnChanged@CInteractionTracker@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1801A0220
 * Callers:
 *     <none>
 * Callees:
 *     ?CheckAndUnRegisterDefaultAnimations@CInteractionTracker@@AEAA_NPEAUIUnknown@@@Z @ 0x18019ED50 (-CheckAndUnRegisterDefaultAnimations@CInteractionTracker@@AEAA_NPEAUIUnknown@@@Z.c)
  ...
  if ( a2 > 7 )
  {
    if ( a2 <= 9 )
    {
      if ( a3 )
      {
        ...
        CInteractionTracker::StopCustomAnimation((CInteractionTracker *)a1, v5);
        if ( *(_DWORD *)(a1 + 168) == 3 )
