/*
 * XREFs of ?HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z @ 0x1801E40C8
 * Callers:
 *     DispatchDwmDiagnosticsControlMessage @ 0x1801E401C (DispatchDwmDiagnosticsControlMessage.c)
 * Callees:
 *     <none>
 */
