/*
 * XREFs of ?EnsureInertiaModifierProcessed@CScrollPositionKeyframeAnimation@@MEAAJPEAVCExpressionValueStack@@_K@Z @ 0x1801D7000
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *((_BYTE *)this + 696) = v4 | 4;
  ...
  {
LABEL_6:
    if ( (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)this + 177)) & _xmm) >= 0.0000011920929 )
    {
