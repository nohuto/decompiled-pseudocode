/*
 * XREFs of ?FindMatchingBitmap@CRenderTargetBitmapCache@@AEAAJIIAEBUPixelFormatInfo@@_N1PEAPEAVCScratchRenderTargetBitmap@@@Z @ 0x1800DAC2C
 * Callers:
 ...
 *     ?IsValid@CHwTextureRenderTarget@@UEBA_NXZ @ 0x1800DADB0 (-IsValid@CHwTextureRenderTarget@@UEBA_NXZ.c)
 */
  ...
  if ( v7 )
  {
    do
    {
      ...
      if ( CHwTextureRenderTarget::IsValid((CHwTextureRenderTarget *)v14) )
      {
        ...
        v16 = *(_DWORD *)(v14 + 12);
        v17 = *(_QWORD *)(v14 + 248);
        if ( v15 >= a2 && (!a6 && v16 >= a3 && v17 == *(_DWORD *)a4 || v15 == a2 && v16 == a3 && v17 == *(_DWORD *)a4) )
        {
          v18 = *(_QWORD *)(v14 + 240);
          v19 = 0;
          if ( v18 )
