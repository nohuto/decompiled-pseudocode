/*
 * XREFs of ?RectangleShapeFullyContains@CCpuClip@@SA_NPEBVCShape@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x1800308C4
 * Callers:
...
char __fastcall CCpuClip::RectangleShapeFullyContains(__int64 a1, __int128 *a2, CMILMatrix *a3)
{
  ...
  if ( !IsEmpty(&v7) )
  {
    ...
    if ( a3 )
      ...
      v8 = *a2;
    return TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::DoesContain(&v7, &v8);
  }
  return v5;
}
