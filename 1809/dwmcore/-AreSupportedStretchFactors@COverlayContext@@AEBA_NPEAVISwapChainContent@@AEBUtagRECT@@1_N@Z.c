/*
 * XREFs of ?AreSupportedStretchFactors@COverlayContext@@AEBA_NPEAVISwapChainContent@@AEBUtagRECT@@1_N@Z @ 0x180168C68
 * Callers:
        ...
        bool a5)
{
  ...
  if ( *((float *)this + 40) >= fmaxf(v8, v9) && fminf(v8, v9) >= *((float *)this + 41) )
    return 1;
  v10 = (*(__int64 (__fastcall **)(struct ISwapChainContent *))(*(_QWORD *)a2 + 208LL))(a2);
