/*
 * XREFs of ?EnqueueComputeScribbleForCurrentBackbuffer@CHwFullScreenRenderTarget@@UEAAJPEAVCComputeScribble@@@Z @ 0x180208190
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CComputeScribble *a2)
{
  ...
  if ( !v4 )
  {
    v11 = 0LL;
    v12 = 1;
    v6 = CComputeScribbleRenderer::Create((CHwFullScreenRenderTarget *)((char *)this - 208), &v11);
    if ( v12 )
    {
      v7 = *v2;
      *v2 = v11;
