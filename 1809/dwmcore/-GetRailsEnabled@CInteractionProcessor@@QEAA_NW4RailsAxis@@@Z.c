/*
 * XREFs of ?GetRailsEnabled@CInteractionProcessor@@QEAA_NW4RailsAxis@@@Z @ 0x1801F16D4
 * Callers:
 *     ?GetProperty@CInteraction@@UEAAJIPEAVCExpressionValue@@@Z @ 0x18019C0E0 (-GetProperty@CInteraction@@UEAAJIPEAVCExpressionValue@@@Z.c)
