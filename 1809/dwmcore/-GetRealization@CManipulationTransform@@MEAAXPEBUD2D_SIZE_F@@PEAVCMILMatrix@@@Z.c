/*
 * XREFs of ?GetRealization@CManipulationTransform@@MEAAXPEBUD2D_SIZE_F@@PEAVCMILMatrix@@@Z @ 0x18001B3C0
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)a3 + 16) = 0;
  if ( dword_180305E40 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
    {
      ...
      v40 = 4LL;
      v42 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B5403, 0LL, 0LL, 0x12u, &pData);
      v9 = dword_180305E40;
    }
    if ( v9 > 4 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
      {
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B5384, 0LL, 0LL, 0xEu, &pData);
      }
    }
  }
}
