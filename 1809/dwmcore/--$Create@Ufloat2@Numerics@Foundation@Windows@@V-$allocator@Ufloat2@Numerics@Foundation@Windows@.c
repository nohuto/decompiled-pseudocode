/*
 * XREFs of ??$Create@Ufloat2@Numerics@Foundation@Windows@@V?$allocator@Ufloat2@Numerics@Foundation@Windows@@@std@@MV?$allocator@M@6@@BulkAnimator@Particles@@SAJPEAVIAnimator@1@AEAV?$vector@Ufloat2@Numerics@Foundation@Windows@@V?$allocator@Ufloat2@Numerics@Foundation@Windows@@@std@@@std@@HHAEAV?$vector@MV?$allocator@M@std@@@4@HAEAV?$unique_ptr@VBulkAnimator@Particles@@U?$default_delete@VBulkAnimator@Particles@@@std@@@4@@Z @ 0x1801C3964
 * Callers:
...
__int64 __fastcall Particles::BulkAnimator::Create<Windows::Foundation::Numerics::float2,std::allocator<Windows::Foundation::Numerics::float2>,float,std::allocator<float>>(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        __int64 a4,
