/*
 * XREFs of ?ShutDownManipulationThread@CManipulationManager@@AEAAXXZ @ 0x1801ECCE8
 * Callers:
...
void __fastcall CManipulationManager::ShutDownManipulationThread(CManipulationManager *this)
{
  ...
  v2 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(*((_QWORD *)this + 2) + 536LL) + 96LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 536LL));
