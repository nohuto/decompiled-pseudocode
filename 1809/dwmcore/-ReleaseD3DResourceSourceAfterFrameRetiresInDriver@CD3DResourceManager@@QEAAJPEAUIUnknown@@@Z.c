/*
 * XREFs of ?ReleaseD3DResourceSourceAfterFrameRetiresInDriver@CD3DResourceManager@@QEAAJPEAUIUnknown@@@Z @ 0x180202538
 * Callers:
        ...
        struct IUnknown *a2)
{
  ...
  {
    v3 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, -2147024882, 0x2C8u);
  }
  return v3;
}
