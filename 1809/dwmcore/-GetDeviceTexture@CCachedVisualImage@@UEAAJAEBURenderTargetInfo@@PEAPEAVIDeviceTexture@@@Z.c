/*
 * XREFs of ?GetDeviceTexture@CCachedVisualImage@@UEAAJAEBURenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z @ 0x18008BF00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDeviceTexture **a3)
{
  ...
  v10 = 0LL;
  v5 = CCachedVisualImage::EnsureRenderTargetBitmapInfo(
         (char *)this - 136,
         *(_QWORD *)a2,
         *((unsigned int *)a2 + 2),
         &v10);
  ...
  {
    v7 = -2003292287;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, -2003292287, 0x7A9u);
    return v7;
  }
  ...
  if ( v5 < 0 )
  {
    v9 = 1966;
LABEL_8:
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, v9);
  }
  return v7;
}
