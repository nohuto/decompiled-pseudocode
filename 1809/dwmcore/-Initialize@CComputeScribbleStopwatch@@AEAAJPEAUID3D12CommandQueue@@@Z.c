/*
 * XREFs of ?Initialize@CComputeScribbleStopwatch@@AEAAJPEAUID3D12CommandQueue@@@Z @ 0x180230564
 * Callers:
        ...
        struct ID3D12CommandQueue *a2)
{
  ...
  v12 = 0LL;
  wil::com_ptr_t<IDwmSpatialWorld,wil::err_returncode_policy>::reset(&v12);
