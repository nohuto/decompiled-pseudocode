/*
 * XREFs of ?ProcessSetSpriteImage@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUMILCMD_WINDOWNODE_SETSPRITEIMAGE@@@Z @ 0x18006EE3C
 * Callers:
        ...
        const struct MILCMD_WINDOWNODE_SETSPRITEIMAGE *a3)
{
  ...
  if ( (_DWORD)v5 == 57
    && ((Resource = CResourceTable::GetResource(a2, v3, 57LL)) == 0
      ? (v5 = 0LL)
...
LABEL_8:
    ...
    v10 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x3D8u);
  }
  else
  {
    v10 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(this, 0LL, 0, -2003303421, 0x3D4u);
  }
  return v10;
}
