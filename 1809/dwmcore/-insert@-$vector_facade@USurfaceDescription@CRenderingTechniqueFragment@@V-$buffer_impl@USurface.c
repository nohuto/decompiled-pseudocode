        ...
        __int64 a5)
{
  ...
  v6 = a4;
  v8 = (*a3 - *a1) / 28LL;
  for ( i = (_OWORD *)detail::vector_facade<CRenderingTechniqueFragment::SurfaceDescription,detail::buffer_impl<CRenderingTechniqueFragment::SurfaceDescription,4,1,detail::liberal_expansion_policy>>::reserve_region(
                        a1,
                        v8,
                        a4); v6; --v6 )
  {
    *i = *(_OWORD *)a5;
    i = (_OWORD *)((char *)i + 28);
    *(_QWORD *)((char *)i - 12) = *(_QWORD *)(a5 + 16);
    *((_DWORD *)i - 1) = *(_DWORD *)(a5 + 24);
  }
  *a2 = *a1 + 28 * v8;
  return a2;
}
