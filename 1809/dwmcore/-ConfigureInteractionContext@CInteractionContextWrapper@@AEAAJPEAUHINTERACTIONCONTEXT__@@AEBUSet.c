/*
 * XREFs of ?ConfigureInteractionContext@CInteractionContextWrapper@@AEAAJPEAUHINTERACTIONCONTEXT__@@AEBUSetupInfo@@@Z @ 0x1801F34F4
 * Callers:
 *     ?ApplySetupInfo@CInteractionContextWrapper@@UEAAJAEBUSetupInfo@@@Z @ 0x1801F3350 (-ApplySetupInfo@CInteractionContextWrapper@@UEAAJAEBUSetupInfo@@@Z.c)
      ...
      if ( v10 >= 0 )
      {
        ...
        if ( v22 >= 0 )
        {
          ...
          if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
          {
            ...
            v39 = v18;
            v42 = v18;
            TlgWrite(v17, &unk_1802B7FA0, 0LL, 0LL, 7u, &pData);
            v10 = v22;
          }
          if ( v10 >= 0 )
          {
