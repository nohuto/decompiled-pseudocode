/*
 * XREFs of ?CreateProcessAttribution@CProcessAttributionManager@@AEAAJKPEBUProcessAttributionRecord@1@_NPEAPEAVCProcessAttribution@@@Z @ 0x18006D32C
 * Callers:
 ...
 *     ?IsLessThan@ProcessAttributionRecord@CProcessAttributionManager@@SA_NPEBU12@_J@Z @ 0x180071C4C (-IsLessThan@ProcessAttributionRecord@CProcessAttributionManager@@SA_NPEBU12@_J@Z.c)
  ...
  if ( a4 )
  {
    ...
    while ( v11 != v12 )
    {
      ...
      if ( v14 == *(char **)(v16 + 24) || **(_QWORD **)v14 != *(_QWORD *)a3 )
      {
        ...
        {
          v9 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, -2147024882, 0x1C3u);
          return v9;
        }
        *v19 = *(_OWORD *)a3;
        v19[1] = *((_OWORD *)a3 + 1);
