/*
 * XREFs of ?Thunk_SetMatrix4x4Value_45@?$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180171D90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDataSourceProxy_Receive<BamoImpl::BamoDataSourceProxyImpl>::Thunk_SetMatrix4x4Value_45(
        __int64 a1,
        unsigned int **a2)
{
  int *v3; // rsi
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, _QWORD, int *))(*(_QWORD *)(a1 - 16) + 136LL))(a1 - 16, v4, v3);
  v6 = v9;
  v7 = v5;
  if ( v9 )
  {
