/*
 * XREFs of ?Snapshot@CCachedVisualImage@@QEAAJPEBUtagRECT@@@Z @ 0x18008FCAC
 * Callers:
 *     ?ProcessSnapshot@CCachedVisualImage@@QEAAJPEAVCResourceTable@@PEBUMILCMD_CACHEDVISUALIMAGE_SNAPSHOT@@@Z @ 0x18007BA80 (-ProcessSnapshot@CCachedVisualImage@@QEAAJPEAVCResourceTable@@PEBUMILCMD_CACHEDVISUALIMAGE_SNAPS.c)
...
__int64 __fastcall CCachedVisualImage::Snapshot(CCachedVisualImage *this, const struct tagRECT *a2)
{
  ...
  {
    Bounds = CCachedVisualImage::GetBounds((__int64)this + 8, 0LL, 0LL, (__int64)this + 400);
    v2 = Bounds;
    if ( Bounds < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, Bounds, 0x833u);
    }
    else
    {
      ...
      if ( v8 > 0 )
      {
        ...
        do
        {
            ...
            && !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v11 + 8) + 144LL) + 104LL))(*(_QWORD *)(v11 + 8) + 144LL) )
          {
            ...
            DynArray<CCachedVisualImage::RenderTargetBitmapInfo,1>::RemoveAt((char *)this + 240, (unsigned int)v10);
          }
          --v8;
        }
        while ( v8 > 0 );
