/*
 * XREFs of ?GetScratchRenderTargetBitmap@CD3DDeviceManager@@QEAAJAEBVCResourceTag@@IIUIntermediateRTUsage@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@PEAUPixelFormatInfo@@_NU_LUID@@VDisplayId@@44PEAPEAVIRenderTargetBitmap@@@Z @ 0x180015820
 * Callers:
        ...
        _QWORD *a13)
{
  ...
  *a13 = 0LL;
  ...
  if ( v21 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v22, &dword_18024C878, 1u, v21, 0x52Du);
  }
  else
  {
    ...
    if ( D3DDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v25, &dword_18024C878, 1u, D3DDevice, 0x52Fu);
      v20 = v32;
    }
    else
    {
      ...
      if ( RenderTargetBitmap < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v27, &dword_18024C878, 1u, RenderTargetBitmap, 0x538u);
    }
  }
  if ( v20 )
