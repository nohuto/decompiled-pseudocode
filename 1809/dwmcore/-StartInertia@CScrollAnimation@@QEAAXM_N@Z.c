/*
 * XREFs of ?StartInertia@CScrollAnimation@@QEAAXM_N@Z @ 0x1801D65B0
 * Callers:
...
void __fastcall CScrollAnimation::StartInertia(CScrollAnimation *this, float a2, char a3)
{
  ...
  if ( v3 )
    ...
    v6 = 0LL;
  *((_QWORD *)this + 39) = *(_QWORD *)(*((_QWORD *)this + 2) + 480LL);
  v7 = *((_DWORD *)this + 73);
  *((_DWORD *)this + 72) = 2;
  CInteractionTracker::AddOrUpdatePendingInertiaStateChange(v6, v7, a2);
  LOBYTE(v8) = a3;
  (*(void (__fastcall **)(CScrollAnimation *, __int64, __int64))(*(_QWORD *)this + 296LL))(this, v9, v8);
  v10 = *((_QWORD *)this + 38);
  if ( v10 )
    v10 = *(_QWORD *)(v10 + 16);
