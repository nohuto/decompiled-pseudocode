/*
 * XREFs of ?CorrectOvershootIfNecessary@CScalarForceEvaluator@@AEAA?AUIntegrationState@@AEBU2@PEAUIAccelerator@@PEA_N@Z @ 0x1801E756C
 * Callers:
    ...
    *(_BYTE *)(a1 + 64) = v9;
    ...
    if ( (v9 & 1) != 0 )
    {
      ...
      if ( *(float *)(a1 + 52) != (float)((v11 > 0.0) - v6) )
      {
        ...
        *((float *)&v20 + 1) = (float)(v15 * *(float *)(a1 + 16)) + (float)((float)(1.0 - v15) * v12);
        *(_OWORD *)a2 = v20;
        *(_DWORD *)(a2 + 16) = v14;
