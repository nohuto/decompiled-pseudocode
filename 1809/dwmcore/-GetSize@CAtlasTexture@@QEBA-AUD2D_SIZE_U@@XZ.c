/*
 * XREFs of ?GetSize@CAtlasTexture@@QEBA?AUD2D_SIZE_U@@XZ @ 0x1802227DC
 * Callers:
 ...
 *     ?GetSize@CAtlasImageSource@@UEBAXPEAI0@Z @ 0x180222790 (-GetSize@CAtlasImageSource@@UEBAXPEAI0@Z.c)
 * Callees:
