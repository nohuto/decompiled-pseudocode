/*
 * XREFs of ?Init@CD3DTexture@@IEAAJPEAVCD3DResourceManager@@PEAUID3D11Texture2D@@I@Z @ 0x180093BD4
 * Callers:
        ...
        unsigned int a4)
{
  ...
  *((_DWORD *)this + 46) = v11;
  ...
  {
    v10 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147467259, 0x71u);
    return v10;
  }
  *((_DWORD *)this + 43) = a4;
  ...
  {
    v10 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147467259, 0x77u);
    return v10;
  }
  ...
  if ( PixelFormatColorSpace < 0 )
  {
    v13 = 125;
LABEL_10:
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, PixelFormatColorSpace, v13);
  }
  return v10;
}
