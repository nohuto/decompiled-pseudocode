/*
 * XREFs of ?CompleteManipulation@CManipulation@@UEAAJW4InteractionState@@@Z @ 0x1801A5650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CManipulation::CompleteManipulation(__int64 a1)
{
  ...
  if ( *(_DWORD *)(v3 + 164) != v5 )
  {
    ...
    *(_DWORD *)(v3 + 28) = v1 & v7;
    *(_QWORD *)(v3 + 44) = _mm_unpacklo_ps((__m128)LODWORD(FLOAT_1_0), (__m128)LODWORD(FLOAT_1_0)).m128_u64[0];
    *(_DWORD *)(v3 + 164) = v5;
