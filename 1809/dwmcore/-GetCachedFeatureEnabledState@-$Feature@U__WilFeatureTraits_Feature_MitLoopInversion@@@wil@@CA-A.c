/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_MitLoopInversion@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180088374
 * Callers:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_MitLoopInversion>::GetCachedFeatureEnabledState(__int64 a1)
{
  int v1; // ebx
  unsigned int v2; // esi
  ...
  LOBYTE(v8) = a1;
  v1 = `wil::Feature<__WilFeatureTraits_Feature_MitLoopInversion>::GetFeaturePropertyCache'::`2'::data & 3;
  v2 = v1;
  if ( (`wil::Feature<__WilFeatureTraits_Feature_MitLoopInversion>::GetFeaturePropertyCache'::`2'::data & 3) == 0
    || (`wil::Feature<__WilFeatureTraits_Feature_MitLoopInversion>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
  {
    v8 = 0;
    CurrentFeatureEnabledState = wil::Feature<__WilFeatureTraits_Feature_MitLoopInversion>::GetCurrentFeatureEnabledState(
                                   a1,
                                   &v8,
                                   (unsigned int *)&v9);
    v4 = (`wil::Feature<__WilFeatureTraits_Feature_MitLoopInversion>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
    if ( !v1 )
    {
      v4 = v9;
    ...
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      (__int64)&`wil::Feature<__WilFeatureTraits_Feature_MitLoopInversion>::GetFeaturePropertyCache'::`2'::data,
      0);
    if ( v1 )
    {
      v6 = v8;
    ...
    wil_details_ModifyFeatureData(
      (union wil_details_FeaturePropertyCache *)&`wil::Feature<__WilFeatureTraits_Feature_MitLoopInversion>::GetFeaturePropertyCache'::`2'::data,
      v5,
      (void *)v6);
  }
  return v2;
