/*
 * XREFs of ??0CTransform3DGroup@@IEAA@PEAVCComposition@@PEAVCChannelContext@@@Z @ 0x18017355C
 * Callers:
 ...
 * Callees:
 *     ??0CCyclicResourceListEntry@@IEAA@PEAVCResourceTable@@@Z @ 0x18001CC28 (--0CCyclicResourceListEntry@@IEAA@PEAVCResourceTable@@@Z.c)
 */
        ...
        struct CResourceTable **a3)
{
  ...
  *((_DWORD *)this + 8) |= 1u;
  *((_BYTE *)this + 148) = 0;
  CCyclicResourceListEntry::CCyclicResourceListEntry((CTransform3DGroup *)((char *)this + 152), a3[3]);
  *v3 = &CTransform3DGroup::`vftable'{for `CCyclicResourceListEntry'};
  result = v4;
  *(_QWORD *)v4 = &CTransform3DGroup::`vftable'{for `CTransform3D'};
  return result;
}
