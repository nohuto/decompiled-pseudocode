/*
 * XREFs of ?SetExclusiveOpacity@CHolographicManager@@QEAAXM@Z @ 0x18020BC54
 * Callers:
 *     ?SetProperty@CHolographicExclusiveMode@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x18020C600 (-SetProperty@CHolographicExclusiveMode@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z.c)
 * Callees:
