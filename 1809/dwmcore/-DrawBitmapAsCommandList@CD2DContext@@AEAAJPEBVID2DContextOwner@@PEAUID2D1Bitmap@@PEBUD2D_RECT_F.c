/*
 * XREFs of ?DrawBitmapAsCommandList@CD2DContext@@AEAAJPEBVID2DContextOwner@@PEAUID2D1Bitmap@@PEBUD2D_RECT_F@@2MW4D2D1_ANTIALIAS_MODE@@W4D2D1_INTERPOLATION_MODE@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x1801FE5DC
 * Callers:
        ...
        enum D2D1_INTERPOLATION_MODE a8)
{
  ...
  else
  {
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0xB0u);
      v11 = v37;
      goto LABEL_21;
    }
    ...
    if ( v26 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0xB3u);
      v11 = v37;
      v12 = v38;
      goto LABEL_21;
    }
    ...
    *v30 = v20;
    ...
    else
    {
      ...
      v32 = (*(__int64 (__fastcall **)(CD2DContext *, const struct ID2DContextOwner *, __int64))(v33 + 136))(
              this,
              a2,
              v39);
      v15 = v32;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v34, v36);
LABEL_21:
  if ( v39 )
