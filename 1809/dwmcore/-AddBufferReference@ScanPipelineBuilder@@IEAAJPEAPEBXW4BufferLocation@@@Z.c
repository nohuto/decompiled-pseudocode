/*
 * XREFs of ?AddBufferReference@ScanPipelineBuilder@@IEAAJPEAPEBXW4BufferLocation@@@Z @ 0x180215F3C
 * Callers:
  ...
  if ( (unsigned int)(a3 - 3) > 2 )
  {
    *a2 = 0LL;
    ...
    else
    {
      ...
      v10 = *(_DWORD *)(v4 + 616);
      v11 = v10 + 1;
      v7 = v10 + 1 < v10 ? 0x80070216 : 0;
      if ( v10 + 1 >= v10 )
      {
        if ( v11 <= *(_DWORD *)(v4 + 612) )
        {
          *(_QWORD *)(*(_QWORD *)(v4 + 592) + 8LL * v10) = v13;
          *(_DWORD *)(v4 + 616) = v11;
          return v7;
        }
...
LABEL_13:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(1LL, 0LL, 0, v7, 0xB5u);
    return v7;
  }
