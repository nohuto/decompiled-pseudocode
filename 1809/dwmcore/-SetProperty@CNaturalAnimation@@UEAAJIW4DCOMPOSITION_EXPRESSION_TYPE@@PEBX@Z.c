/*
 * XREFs of ?SetProperty@CNaturalAnimation@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A9E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CNaturalAnimation::SetProperty(CNaturalAnimation *a1, unsigned int a2, int a3, float *a4)
{
  ...
  switch ( a3 )
  {
    ...
    case 52:
      ...
      v8 = 563;
LABEL_14:
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, v8);
      return v4;
  }
  v4 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0, -2147024809, 0x23Bu);
  return v4;
}
