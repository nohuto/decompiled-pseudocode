/*
 * XREFs of ?RecordVisualMove@CDrawingContext@@QEAAJPEAVCVisual@@PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUHWND__@@@Z @ 0x180166A58
 * Callers:
...
__int64 __fastcall CDrawingContext::RecordVisualMove(struct CDrawingContext *a1, CVisual *this, _OWORD *a3)
{
    ...
    && !CDrawingContext::IsInLayer(v7) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, LocalToWorldTransform, 0x1B52u);
    }
    else if ( v36[0] )
    {
      v39 = 0LL;
      ...
      *((float *)&v46 + 2) = *((float *)&v46 + 2) + COERCE_FLOAT(LODWORD(v14) ^ _xmm);
      ...
      if ( v20 )
      {
        v47[0] = 0LL;
        v38 = 0LL;
        if ( CVisual::GetAdditionalDirtyRects(this, &v38, (unsigned int *)&v36[4], v47)
          && *(_QWORD *)(*((_QWORD *)a1 + 4) + 368LL) == v38
          && (v21 = 0, *(_DWORD *)&v36[4]) )
        {
          while ( 1 )
          {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x1B7Au);
        }
        else
        {
LABEL_17:
          if ( (unsigned __int8)CDwmMetaRegion::ClipRectWitRegion(&v46, v20, &v39) )
          {
            ...
            v26 = *((float *)&v46 + 1) + v15;
            v27 = *((float *)&v46 + 2) + v14;
            *((float *)&v46 + 3) = *((float *)&v46 + 3) + v15;
            CScopedClipStack::GetClipBoundsWorld((struct CDrawingContext *)((char *)a1 + 1008), (__int64)v47);
            if ( *(float *)v47 > v25 )
              v25 = *(float *)v47;
            v28 = v26;
            if ( *((float *)v47 + 1) > v26 )
            ...
            if ( v24 > *((float *)&v47[1] + 1) )
            {
              HIDWORD(v46) = HIDWORD(v47[1]);
              v24 = *((float *)&v47[1] + 1);
            }
            if ( v29 > v25 && v24 > v28 )
            {
              ...
              *((float *)&v46 + 3) = v24 + v18;
              ...
              if ( v30 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v30, 0x1B8Cu);
              }
              else
              {
                ...
                v6 = v32;
                if ( v32 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0, v32, 0x1B8Eu);
              }
            }
          }
        }
  ...
  ReleaseInterface<CCompositionSurfaceInfo>(&v37);
  return v6;
}
