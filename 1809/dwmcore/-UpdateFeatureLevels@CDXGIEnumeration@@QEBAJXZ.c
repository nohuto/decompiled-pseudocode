/*
 * XREFs of ?UpdateFeatureLevels@CDXGIEnumeration@@QEBAJXZ @ 0x18007FC2C
 * Callers:
 *     ?EnsureRenderTargets@CDesktopRenderTarget@@UEAAJXZ @ 0x1800C8740 (-EnsureRenderTargets@CDesktopRenderTarget@@UEAAJXZ.c)
 * Callees:
 *     ?AreEffectsSupported@CD3DDeviceLevel1@@QEAA_NXZ @ 0x18007EE20 (-AreEffectsSupported@CD3DDeviceLevel1@@QEAA_NXZ.c)
      ...
      if ( v10 )
      {
        ...
        if ( *(_DWORD *)(v10 + 392) )
        {
          ...
          else
          {
            ...
            ReleaseInterface<CD3DDeviceLevel1>((__int64 *)&v25);
            v8 = 1;
            v6 = 1;
            v9 &= -v23;
            LODWORD(v1) = 0;
...
LABEL_4:
    ...
    if ( v6 )
    {
      ...
      v16 = *(_QWORD *)&g_pComposition;
      HIDWORD(v24) = v15;
      if ( *(_DWORD *)(*(_QWORD *)&g_pComposition + 1288LL) != v14
        || *(_DWORD *)(*(_QWORD *)&g_pComposition + 1292LL) != v12
        || *(_DWORD *)(*(_QWORD *)&g_pComposition + 1296LL) != v13
        || *(_DWORD *)(*(_QWORD *)&g_pComposition + 1300LL) != v15 )
      {
        *(_BYTE *)(*(_QWORD *)&g_pComposition + 1304LL) = v8;
        *(_OWORD *)(v16 + 1288) = v24;
      }
    }
  }
