/*
 * XREFs of ?EnsureChainingConfigUpdated@CScrollScaleKeyframeAnimation@@MEAAXPEAVCExpressionValueStack@@_K@Z @ 0x1801D74D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CExpressionValueStack *a2)
{
  ...
  v6 = CInteractionTracker::BoundaryFromValue(*((_QWORD *)this + 66), *v5, 2u);
