/*
 * XREFs of ?Init@CVisualDepthGeometry@@AEAAXAEBUfloat2@Numerics@Foundation@Windows@@AEBVCMILMatrix@@@Z @ 0x1801DEC70
 * Callers:
        ...
        const struct CMILMatrix *a3)
{
  ...
  __int64 v16; // r11
  float *v17; // r8
  struct D2D_VECTOR_4F *v18; // r10
  float v19; // xmm2_4
  int v20; // edx
  FLOAT v21; // xmm1_4
  struct D2D_VECTOR_4F *v22; // rax
  float *v23; // rcx
  __int64 v24; // rdx
  __m128 v25; // xmm2
  __m128 v26; // xmm3
  ...
  __m128 v32; // xmm1
  FLOAT v33; // xmm0_4
  struct D2D_VECTOR_4F v34; // [rsp+20h] [rbp-69h] BYREF
  ...
  v18 = (struct D2D_VECTOR_4F *)((char *)this + 84);
  do
  {
    v19 = *v17;
    v20 = v15 % 4;
    ...
    v34.z = *((float *)this + 3 * v20 + 9) - v34.x;
    v34.w = v21;
    *v18++ = v34;
    --v16;
  }
  while ( v16 );
  v22 = D2DVectorHelper::CalculatePlane(&v34, &v49, &v50, &v51);
  v23 = (float *)((char *)this + 56);
  v24 = 3LL;
  v25 = (__m128)_mm_loadu_si128((const __m128i *)v22);
  LODWORD(v34.x) = v25.m128_i32[0];
  LODWORD(v34.y) = _mm_shuffle_ps(v25, v25, 85).m128_u32[0];
  LODWORD(v34.w) = _mm_shuffle_ps(v25, v25, 255).m128_u32[0];
  LODWORD(v34.z) = _mm_shuffle_ps(v25, v25, 170).m128_u32[0];
  *((struct D2D_VECTOR_4F *)this + 10) = v34;
