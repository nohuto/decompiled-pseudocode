/*
 * XREFs of ?SetDepthSortedList@CVisual@@QEAAXPEAV?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@@Z @ 0x1801B8370
 * Callers:
...
__int64 __fastcall CVisual::SetDepthSortedList(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      result = (__int64)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot(v2, 5);
      *(_QWORD *)result = a2;
    }
  }
  else if ( (result & 0x8000000) != 0 )
  {
    v7 = *v2;
    *v5 = result & 0xF7FFFFFF;
    result = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot(v7, 5);
