/*
 * XREFs of ?CheckVisibilityAndInsertIntoBspTree@CBspPreComputeHelper@@AEAAJPEAVCVisual@@_N@Z @ 0x180224538
 * Callers:
        ...
        bool a3)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct CVisual *))(*(_QWORD *)a2 + 216LL))(a2) || a3 )
  {
    ...
    if ( PolygonAndPushToBspTree < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, PolygonAndPushToBspTree, 0x11Fu);
  }
  return v6;
}
