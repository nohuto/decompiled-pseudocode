/*
 * XREFs of ?CreateD3DDevice@CD3DDeviceLevel1@@CAJPEAVCDXGIAdapterLimited@@PEAPEAUID3D11Device1@@PEAW4D3D_FEATURE_LEVEL@@@Z @ 0x1800D74F0
 * Callers:
        ...
        enum D3D_FEATURE_LEVEL *a3)
{
  ...
  _OWORD v20[2]; // [rsp+60h] [rbp-9h] BYREF
  ...
  v13 = D3D11CreateDevice(
          ...
          0LL,
          v9,
          (const D3D_FEATURE_LEVEL *)v20 + v12,
          9 - v12,
          7u,
          &ppDevice,
          &pFeatureLevel,
  ...
  if ( v13 >= 0 )
  {
    ...
    pFeatureLevels = 326;
LABEL_24:
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, MaxFeatureLevel, pFeatureLevels);
    goto LABEL_10;
  }
  if ( v13 != -2147467262 && v13 != -2005270524 && IsOOM(v13) && *((_DWORD *)a1 + 74) == 4318 )
    ModuleFailFastForHRESULT(2291662989LL, retaddr);
  MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v8, 0x161u);
LABEL_10:
  Microsoft::WRL::ComPtr<ID2DBitmap>::InternalRelease((__int64 *)&ppDevice);
  return v8;
}
