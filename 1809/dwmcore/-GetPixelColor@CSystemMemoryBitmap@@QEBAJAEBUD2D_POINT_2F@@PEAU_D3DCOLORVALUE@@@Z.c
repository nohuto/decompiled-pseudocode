/*
 * XREFs of ?GetPixelColor@CSystemMemoryBitmap@@QEBAJAEBUD2D_POINT_2F@@PEAU_D3DCOLORVALUE@@@Z @ 0x180213980
 * Callers:
 *     ?GetPixelColor@CSectionBitmapRealization@@UEBAJAEBUD2D_POINT_2F@@PEAU_D3DCOLORVALUE@@@Z @ 0x180226330 (-GetPixelColor@CSectionBitmapRealization@@UEBAJAEBUD2D_POINT_2F@@PEAU_D3DCOLORVALUE@@@Z.c)
 * Callees:
