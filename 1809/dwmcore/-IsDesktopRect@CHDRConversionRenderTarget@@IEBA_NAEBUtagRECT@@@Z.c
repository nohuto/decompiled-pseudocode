/*
 * XREFs of ?IsDesktopRect@CHDRConversionRenderTarget@@IEBA_NAEBUtagRECT@@@Z @ 0x18020940C
 * Callers:
...
bool __fastcall CHDRConversionRenderTarget::IsDesktopRect(CHDRConversionRenderTarget *this, const struct tagRECT *a2)
{
  ...
  v3 = 0;
  if ( !a2->left && !a2->top && a2->right == *((_DWORD *)this + 62) )
    return a2->bottom == *((_DWORD *)this + 63);
  return v3;
}
