/*
 * XREFs of ?UpdateIntermediates@ShadowIntermediates@CDropShadow@@QEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@M@Z @ 0x18000E500
 * Callers:
        ...
        float a4)
{
  ...
  if ( !CDropShadow::ShadowIntermediates::CanUseFastShadow(this, a3, a4) )
  {
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0, updated, 0x2ECu);
      return v16;
    }
    ...
    if ( v27 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0x2EDu);
      return v16;
    }
    goto LABEL_15;
  }
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x2D0u);
    return v16;
  }
LABEL_4:
...
LABEL_29:
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x2D8u);
      return v16;
    }
  }
...
LABEL_15:
  ...
  if ( v15 && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v15 + 48LL))(v15, 19LL) )
    v7 = *(float *)(*((_QWORD *)this + 1) + 84LL);
  if ( *((_QWORD *)this + 5) != v14 || *((float *)this + 12) != v7 )
  {
    *((float *)this + 12) = v7;
    *((_QWORD *)this + 5) = v14;
    *((_QWORD *)this + 7) = *(_QWORD *)(*((_QWORD *)a2 + 4) + 368LL);
  }
  return 0;
}
