/*
 * XREFs of ?DrawAsDrawList@CDropShadow@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCDrawListCache@@@Z @ 0x180013AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDropShadow::DrawAsDrawList(float *a1, CDrawingContext *a2, int a3, int a4, __int64 a5, __int64 a6)
{
  float v6; // xmm3_4
  int v7; // esi
  float v8; // xmm2_4
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x18Du);
  }
  else
  {
    v16 = CSpriteVisualContent::DrawAsDrawList(v7, (_DWORD)a2, a3, a4, a5, a6);
    v15 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x190u);
