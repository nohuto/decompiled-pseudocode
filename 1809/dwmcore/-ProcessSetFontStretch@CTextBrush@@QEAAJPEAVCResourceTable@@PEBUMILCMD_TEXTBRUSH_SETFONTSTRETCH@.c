/*
 * XREFs of ?ProcessSetFontStretch@CTextBrush@@QEAAJPEAVCResourceTable@@PEBUMILCMD_TEXTBRUSH_SETFONTSTRETCH@@@Z @ 0x1801B53CC
 * Callers:
...
__int64 __fastcall CTextBrush::ProcessSetFontStretch(
        ...
        const struct MILCMD_TEXTBRUSH_SETFONTSTRETCH *a3)
{
