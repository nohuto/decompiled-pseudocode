/*
 * XREFs of ?OnRemovedFromDrawList@CGroupDrawListEntry@@UEAAXPEBVCDrawListEntryBatch@@@Z @ 0x18005FEF0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CDrawListEntryBatch *a2)
{
  ...
  CGroupDrawListEntry *v14; // [rsp+40h] [rbp+8h] BYREF
  ...
  *((_DWORD *)this + 4) = v5;
  if ( !v5 )
  {
    ...
    *((_QWORD *)this + 3) = 0LL;
    ...
    else if ( v9 > *(_DWORD *)(v7 + 108) )
    {
      v11 = DynArrayImpl<0>::AddMultipleAndSet(v7 + 88, 8, 1, &v14);
      v10 = v11;
      if ( v11 < 0 )
    ...
    {
      *(_QWORD *)(*(_QWORD *)(v7 + 88) + 8LL * v8) = v14;
      *(_DWORD *)(v7 + 112) = v9;
    }
    if ( v10 >= 0 )
