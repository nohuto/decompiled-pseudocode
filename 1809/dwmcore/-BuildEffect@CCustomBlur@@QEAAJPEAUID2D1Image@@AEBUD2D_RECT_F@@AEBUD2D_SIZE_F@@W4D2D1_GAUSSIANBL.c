/*
 * XREFs of ?BuildEffect@CCustomBlur@@QEAAJPEAUID2D1Image@@AEBUD2D_RECT_F@@AEBUD2D_SIZE_F@@W4D2D1_GAUSSIANBLUR_OPTIMIZATION@@AEBUD2D_VECTOR_2F@@PEAU6@@Z @ 0x1800ADB08
 * Callers:
        ...
        struct D2D_VECTOR_2F *a7)
{
  ...
  *(FLOAT *)&v11 = a6->x;
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0xB5u);
    return v18;
  }
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0xB7u);
    return v18;
  }
  ...
  if ( v26 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0xBBu);
    return v18;
  }
  ...
  if ( v28 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, v28, 0xBDu);
    return v18;
  }
  ...
  if ( v16 < 0 )
  {
    v33 = 193;
LABEL_39:
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, v33);
  }
  return v18;
}
