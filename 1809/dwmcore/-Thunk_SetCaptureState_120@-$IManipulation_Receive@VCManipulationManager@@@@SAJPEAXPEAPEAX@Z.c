/*
 * XREFs of ?Thunk_SetCaptureState_120@?$IManipulation_Receive@VCManipulationManager@@@@SAJPEAXPEAPEAX@Z @ 0x1801ED720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IManipulation_Receive<CManipulationManager>::Thunk_SetCaptureState_120(__int64 a1, __int64 a2)
{
  int *v2; // rax
  __int64 *v3; // rdx
  int v4; // ebx
