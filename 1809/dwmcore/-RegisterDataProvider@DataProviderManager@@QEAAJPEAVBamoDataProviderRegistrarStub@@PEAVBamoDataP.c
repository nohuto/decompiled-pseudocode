/*
 * XREFs of ?RegisterDataProvider@DataProviderManager@@QEAAJPEAVBamoDataProviderRegistrarStub@@PEAVBamoDataProviderProxy@@@Z @ 0x180078AEC
 * Callers:
        ...
        struct BamoDataProviderProxy *a3)
{
  ...
  *((_QWORD *)a3 + 9) = this;
  ...
  if ( v16 )
  {
    ...
    v6 = (unsigned __int64 **)*((_QWORD *)this + 14);
    v7 = v5;
    for ( i = (unsigned __int64 **)*((_QWORD *)this + 15); v6 != i; ++v6 )
    {
      v10 = *v6;
      if ( (*v6)[7] == v7 )
      {
