/*
 * XREFs of ?Partition_SetExcludeFromDDA@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_PARTITION_SETEXCLUDEFROMDDA@@@Z @ 0x18014B984
 * Callers:
        ...
        const struct MILCMD_PARTITION_SETEXCLUDEFROMDDA *a4)
{
  ...
  if ( *((_DWORD *)a4 + 2) )
  {
    ...
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x6F3u);
  }
  else
  {
