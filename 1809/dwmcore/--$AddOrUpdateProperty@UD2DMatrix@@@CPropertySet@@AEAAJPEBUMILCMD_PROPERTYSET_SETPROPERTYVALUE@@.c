/*
 * XREFs of ??$AddOrUpdateProperty@UD2DMatrix@@@CPropertySet@@AEAAJPEBUMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DMatrix@@@Z @ 0x1800A1F10
 * Callers:
...
__int64 __fastcall CPropertySet::AddOrUpdateProperty<D2DMatrix>(CResource *a1, _DWORD *a2, _OWORD *a3)
{
  int updated; // eax
  __int64 v4; // rcx
  unsigned int v5; // ebx
