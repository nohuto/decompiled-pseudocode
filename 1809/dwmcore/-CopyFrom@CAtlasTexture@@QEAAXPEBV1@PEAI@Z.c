/*
 * XREFs of ?CopyFrom@CAtlasTexture@@QEAAXPEBV1@PEAI@Z @ 0x180205B20
 * Callers:
 ...
 *     ?IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x180205DD0 (-IsFreeEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 *     ?IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z @ 0x180205E00 (-IsInUseEntryInRow@CAtlasTexture@@QEBA_NI@Z.c)
 */
...
void __fastcall CAtlasTexture::CopyFrom(CAtlasTexture *this, const struct CAtlasTexture *a2, unsigned int *a3)
{
  ...
  (*(void (__fastcall **)(_QWORD, struct CD3DTexture **))(**((_QWORD **)v5 + 1) + 232LL))(*((_QWORD *)v5 + 1), &v23);
  Microsoft::WRL::ComPtr<CD3DSurface>::InternalRelease((__int64 *)&v22);
  (*(void (__fastcall **)(_QWORD, struct CD3DTexture **))(**((_QWORD **)this + 1) + 232LL))(*((_QWORD *)this + 1), &v22);
  v6 = *((_DWORD *)v5 + 6) + 1;
  v24.x = 0;
  v24.y = 0;
  v7 = *v4;
