/*
 * XREFs of ?PushPolygon@CBspNode@@QEAAJPEAVCPolygon@@_N@Z @ 0x180231094
 * Callers:
...
LABEL_19:
    ...
    if ( !v12 )
    {
      ...
      *((_QWORD *)this + 3) = v12;
      ...
      {
        v7 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, -2147024882, 0xADu);
        goto LABEL_30;
      }
    }
    ...
    v15 = 175;
LABEL_29:
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, v15);
    goto LABEL_30;
  }
  v7 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, -2147024882, 0xA3u);
LABEL_30:
  if ( v17 == 3 )
  {
    if ( v18 )
