/*
 * XREFs of ?SortVisuals@CDepthSortingLayer@@QEAA_NPEAV?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@AEBV?$vector@VCVisualDepthGeometry@@V?$allocator@VCVisualDepthGeometry@@@std@@@3@@Z @ 0x180231FA0
 * Callers:
 *     ?SortVisuals@CDepthSortedVisualCollection@@QEAA_NPEAV?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@@Z @ 0x180231BE0 (-SortVisuals@CDepthSortedVisualCollection@@QEAA_NPEAV-$vector@PEAVCVisual@@V-$allocator@PEAVCVis.c)
 * Callees:
 ...
 *     ??0?$vector@UDepthGraphNode@@V?$allocator@UDepthGraphNode@@@std@@@std@@QEAA@_KAEBV?$allocator@UDepthGraphNode@@@1@@Z @ 0x180231DB4 (--0-$vector@UDepthGraphNode@@V-$allocator@UDepthGraphNode@@@std@@@std@@QEAA@_KAEBV-$allocator@UD.c)
 *     ?_Tidy@?$vector@UDepthGraphNode@@V?$allocator@UDepthGraphNode@@@std@@@std@@AEAAXXZ @ 0x1802322E0 (-_Tidy@-$vector@UDepthGraphNode@@V-$allocator@UDepthGraphNode@@@std@@@std@@AEAAXXZ.c)
 */
...
bool __fastcall CDepthSortingLayer::SortVisuals(unsigned int **a1, __int64 *a2, _QWORD *a3)
{
  ...
  __int64 v46[12]; // [rsp+68h] [rbp-9h] BYREF
  ...
  std::vector<DepthGraphNode>::vector<DepthGraphNode>(v46, (unsigned int)v5);
  v9 = 0LL;
  v10 = 0LL;
  v11 = 0LL;
  v38 = 0LL;
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(v15 - 24) = v19;
      ...
      do
      {
        ...
        std::vector<CVisual *>::_Emplace_reallocate<CVisual *>(v26, v25, &v50);
LABEL_19:
        ++v21;
        v19 = v45;
        v22 = v42 + 4;
...
LABEL_21:
      if ( *(_BYTE *)(v15 - 16) )
      {
        ...
        if ( v9 == v11 )
        {
          std::vector<CVisual *>::_Emplace_reallocate<CVisual *>(&v38, v11, &v50);
          v9 = v40;
          v11 = v39;
          v43 = v40;
        }
