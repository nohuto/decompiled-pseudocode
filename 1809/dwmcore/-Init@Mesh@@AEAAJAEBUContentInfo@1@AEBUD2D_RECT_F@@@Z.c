/*
 * XREFs of ?Init@Mesh@@AEAAJAEBUContentInfo@1@AEBUD2D_RECT_F@@@Z @ 0x180185518
 * Callers:
...
__int64 __fastcall Mesh::Init(float **this, const struct Mesh::ContentInfo *a2, const struct D2D_RECT_F *a3)
{
  ...
  if ( (*((_BYTE *)this + 76) & 4) != 0 )
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, 0x36u);
      return v8;
    }
    *((_BYTE *)this + 76) &= ~4u;
  }
  ...
  *v9 = v10;
  v9[2] = v10 * v10;
  v9[1] = v10 + v10;
  v11 = (float)(a3->top + a3->bottom) * 0.5;
