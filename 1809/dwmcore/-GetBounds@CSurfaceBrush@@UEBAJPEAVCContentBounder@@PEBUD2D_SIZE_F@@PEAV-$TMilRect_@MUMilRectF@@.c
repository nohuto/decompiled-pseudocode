/*
 * XREFs of ?GetBounds@CSurfaceBrush@@UEBAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18005DE70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSurfaceBrush::GetBounds(CSurfaceBrush *this, __int64 a2, const struct D2D_SIZE_F *a3, _DWORD *a4)
{
  ...
  if ( v9 )
  {
    ...
    v5 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x150u);
  }
  else
  {
    a4[3] = 0;
