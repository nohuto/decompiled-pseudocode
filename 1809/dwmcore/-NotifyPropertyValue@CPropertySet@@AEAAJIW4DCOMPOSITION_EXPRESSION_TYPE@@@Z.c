/*
 * XREFs of ?NotifyPropertyValue@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1800A4DF4
 * Callers:
...
__int64 __fastcall CPropertySet::NotifyPropertyValue(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( a3 == 18 )
  {
    ...
    if ( !_bittest(&v45, v41) )
      return 0;
    v46 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v42 + 16) + 1208LL) + 56LL);
    if ( v43 )
    ...
    v52 = v47;
    v53 = v48;
    v10 = CoreUICallSend(v46, &v52, 2LL, 12LL, 0, &unk_180276431);
    if ( v10 == -2018375675 )
      v10 = 0;
    if ( v10 >= 0 )
      return 0;
    MilInstrumentationCheckHR_MaybeFailFast(v49, 0LL, 0, v10, 0xC5u);
    v51 = 565;
  }
  else
  {
...
LABEL_39:
    ...
    v10 = CoreUICallSend(v22, &v52, 2LL, 12LL, 6, &unk_180276453);
    if ( v10 == -2018375675 )
      v10 = 0;
    if ( v10 >= 0 )
      return 0;
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v10, 0x1D0u);
    v51 = 581;
  }
  v24 = v10;
LABEL_40:
  MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v24, v51);
