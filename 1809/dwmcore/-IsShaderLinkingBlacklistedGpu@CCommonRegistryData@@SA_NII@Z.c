/*
 * XREFs of ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800D6608
 * Callers:
...
char __fastcall CCommonRegistryData::IsShaderLinkingBlacklistedGpu(int a1, unsigned __int16 a2)
{
  ...
  else
  {
    ...
    CCommonRegistryData::m_rgwShaderLinkingBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_1802BD174;
    v6 = 0;
  }
  if ( !v6 )
    return 0;
