/*
 * XREFs of ?Draw@CHwndBitmap@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18019A470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwndBitmap::Draw(__int64 a1, _DWORD *a2, __int64 a3, __int64 a4, __int64 a5)
{
