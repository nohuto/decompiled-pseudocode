/*
 * XREFs of ?CheckAndNotifyFullScreenSwapChain@COverlayContext@@QEAAJPEAVISwapChainContent@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180168F90
 * Callers:
        ...
        const struct D2D_RECT_F *a3)
{
  ...
  if ( *((_QWORD *)this + 2) )
  {
    ...
    *(float *)&v11 = v11 + 6291456.25;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, updated, 0x36Du);
    }
    ...
    {
      LOBYTE(v15) = 1;
      (*(void (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 2) + 496LL))(*((_QWORD *)this + 2), v15);
    }
  }
  return v3;
}
