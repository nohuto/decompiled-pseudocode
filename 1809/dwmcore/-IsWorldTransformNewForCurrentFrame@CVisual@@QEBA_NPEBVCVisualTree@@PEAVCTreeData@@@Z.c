/*
 * XREFs of ?IsWorldTransformNewForCurrentFrame@CVisual@@QEBA_NPEBVCVisualTree@@PEAVCTreeData@@@Z @ 0x180224418
 * Callers:
 ...
 * Callees:
 *     ?IsWorldTransformCurrent@CVisual@@AEBA_NPEBVCVisualTree@@PEAVCTreeData@@PEA_NPEAPEBV3@@Z @ 0x1801B736C (-IsWorldTransformCurrent@CVisual@@AEBA_NPEBVCVisualTree@@PEAVCTreeData@@PEA_NPEAPEBV3@@Z.c)
 */
        ...
        struct CTreeData *a3)
{
  ...
  if ( *((_QWORD *)a3 + 15) == *(_QWORD *)(*((_QWORD *)this + 2) + 368LL) )
    return 1;
