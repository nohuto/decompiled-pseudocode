/*
 * XREFs of McTemplateU0px @ 0x18019D638
 * Callers:
...
ULONG McTemplateU0px(__int64 a1, __int64 a2, ...)
{
  ...
  v9 = 0;
  v8 = 8;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_INTERACTION_SET_INPUT_SINK, v11, 3u, &v3);
}
