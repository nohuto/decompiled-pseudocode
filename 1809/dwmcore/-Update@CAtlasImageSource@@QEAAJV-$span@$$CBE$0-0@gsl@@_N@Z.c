/*
 * XREFs of ?Update@CAtlasImageSource@@QEAAJV?$span@$$CBE$0?0@gsl@@_N@Z @ 0x180004D38
 * Callers:
...
__int64 __fastcall CAtlasImageSource::Update(__int64 a1, __int128 *a2, char a3)
{
  ...
  {
    v6 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(0, 0LL, 0, -2003304307, 0x2Cu);
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, -2003304307, 0xACu);
  }
  return v6;
}
