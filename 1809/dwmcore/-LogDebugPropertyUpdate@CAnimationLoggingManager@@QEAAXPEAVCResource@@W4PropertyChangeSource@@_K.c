/*
 * XREFs of ?LogDebugPropertyUpdate@CAnimationLoggingManager@@QEAAXPEAVCResource@@W4PropertyChangeSource@@_KW4MIL_RESOURCE_TYPE@@IIPEAVSubchannelMaskInfo@@PEBVCExpressionValue@@@Z @ 0x18018B104
 * Callers:
 ...
 *     ?GetSubchannels@MatrixSubchannelMaskInfo@@QEBAGXZ @ 0x18021BBEC (-GetSubchannels@MatrixSubchannelMaskInfo@@QEBAGXZ.c)
 *     ?GetSubchannels@VectorSubchannelMaskInfo@@QEBAGXZ @ 0x18021BC3C (-GetSubchannels@VectorSubchannelMaskInfo@@QEBAGXZ.c)
 *     ?WriteSubchannelString@MatrixSubchannelMaskInfo@@QEBAXW4DCOMPOSITION_EXPRESSION_TYPE@@_KPEAG@Z @ 0x18021BF84 (-WriteSubchannelString@MatrixSubchannelMaskInfo@@QEBAXW4DCOMPOSITION_EXPRESSION_TYPE@@_KPEAG@Z.c)
 *     ?WriteSubchannelString@VectorSubchannelMaskInfo@@QEBAX_KPEAG@Z @ 0x18021C094 (-WriteSubchannelString@VectorSubchannelMaskInfo@@QEBAX_KPEAG@Z.c)
 */
    ...
    if ( v20 )
    {
      ...
      if ( v21 )
      {
        ...
        if ( v22 )
        {
          ...
          if ( !v23 )
          {
            if ( dword_180305E40 <= 5u || !TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
              goto LABEL_64;
            v65 = 8LL;
            v64 = &v60;
            TlgCreateWsz(&pDesc, off_1802407D0[a5]);
            v68 = 4LL;
            v67 = &v59;
            v69 = &a7;
            v70 = 4LL;
            ...
            if ( v25 )
            {
              ...
              if ( v26 )
              {
                ...
                if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
                {
                  ...
                  v104 = 4LL;
                  v106 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B3EFD, 0LL, 0LL, 0x1Au, &pData);
                }
              }
              else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
              {
                v65 = 8LL;
                v64 = &v60;
                TlgCreateWsz(&pDesc, off_1802407D0[a5]);
                ...
                v84 = 4LL;
                v86 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B3E35, 0LL, 0LL, 0x10u, &pData);
              }
              goto LABEL_64;
            }
            if ( dword_180305E40 <= 5u || !TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
...
LABEL_33:
            ...
            v80 = 4LL;
            v82 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B40AD, 0LL, 0LL, 0xEu, &pData);
            goto LABEL_64;
          }
          if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
          {
            ...
            v80 = 4LL;
            v82 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B3FF7, 0LL, 0LL, 0xEu, &pData);
          }
        }
        else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
        {
          ...
          v78 = 4LL;
          v80 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B4163, 0LL, 0LL, 0xDu, &pData);
        }
      }
      else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
      {
        ...
        v76 = 4LL;
        v78 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B42BF, 0LL, 0LL, 0xCu, &pData);
      }
    }
    else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
    {
      ...
      v75 = v14;
      v76 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B4216, 0LL, 0LL, 0xBu, &pData);
    }
  }
  else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
  {
    ...
    v61 = v53;
    v76 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B436F, 0LL, 0LL, 0xBu, &pData);
  }
LABEL_64:
  if ( a3 == 2 )
  {
    ...
    if ( DebugInfoForResource )
    {
      ...
      {
        v56 = *(DiagnosticCallbacksManager **)(*((_QWORD *)a1 + 2) + 1248LL);
        if ( v12 )
        {
          if ( *(_DWORD *)v12 == 1 )
          {
