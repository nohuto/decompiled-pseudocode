/*
 * XREFs of ?GetShapeDataCore@CGeometryGroup@@MEBAJPEBUD2D_SIZE_F@@PEAVCShapePtr@@@Z @ 0x1801C27D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CShapePtr *a3)
{
  ...
  *((_DWORD *)this + 8) = v3 ^ ((unsigned __int8)v3 ^ (unsigned __int8)(v3 + 2)) & 6;
  ...
  {
    v9 = (CShape *)CRectanglesShape::operator new(this);
    v5 = v9;
    if ( v9 )
    {
      *((_QWORD *)v9 + 1) = 0LL;
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, -2147024882, 0x27u);
      goto LABEL_21;
    }
    goto LABEL_15;
  }
  ...
  else
  {
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x32u);
      v5 = v19;
      goto LABEL_21;
    }
    v15 = 1;
...
LABEL_15:
    ...
    while ( 1 )
    {
      ...
      if ( ShapeData < 0 )
        break;
      ShapeData = CShape::Combine(v5, v16, *(CShape **)a3, 0LL, 1, &v19);
      v4 = ShapeData;
      if ( ShapeData < 0 )
      {
        v18 = 67;
...
LABEL_20:
  MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, ShapeData, v18);
LABEL_21:
