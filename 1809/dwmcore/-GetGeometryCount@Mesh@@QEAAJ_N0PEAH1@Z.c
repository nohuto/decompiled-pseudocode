/*
 * XREFs of ?GetGeometryCount@Mesh@@QEAAJ_N0PEAH1@Z @ 0x1800B8FDC
 * Callers:
...
__int64 __fastcall Mesh::GetGeometryCount(Mesh *this, char a2, char a3, int *a4, int *a5)
{
  ...
  if ( (v5 & 1) != 0 )
  {
    ...
    if ( !v12 || (v5 & 0x18) != 0 )
    {
      ...
      if ( inited < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, inited, 0xE55u);
        return v13;
      }
      if ( a2 )
        v11 = 3
  ...
  {
    v13 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, -2147467259, 0xE2Cu);
  }
  return v13;
}
