/*
 * XREFs of ?GetBits@COffScreenRenderTarget@@UEAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x180176110
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v5 )
  {
    ...
    *(_QWORD *)&v12 = LODWORD(v20);
    ...
    else
    {
      ...
      v10 = v16;
      if ( v16 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x1FCu);
    }
  }
  else
  {
    v10 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, -2003304442, 0x1F1u);
  }
  return v10;
}
