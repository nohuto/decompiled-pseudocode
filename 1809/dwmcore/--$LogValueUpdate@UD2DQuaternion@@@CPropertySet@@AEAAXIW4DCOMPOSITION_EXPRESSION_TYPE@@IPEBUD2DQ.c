/*
 * XREFs of ??$LogValueUpdate@UD2DQuaternion@@@CPropertySet@@AEAAXIW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBUD2DQuaternion@@@Z @ 0x1801B0BEC
 * Callers:
...
void __fastcall CPropertySet::LogValueUpdate<D2DQuaternion>(
        __int64 a1,
        __int64 a2,
        int a3,
        unsigned int a4,
      ...
      if ( v6 )
      {
        ...
        if ( v7 )
        {
              ...
              if ( v10 )
              {
                ...
                if ( v11 )
                {
                  ...
                  if ( v12 )
                  {
                    ...
                    if ( dword_180305E40 > 5u )
                    {
                      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
                      {
                        ...
                        v84 = 4LL;
                        v86 = 4LL;
                        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B5786, 0LL, 0LL, 0x16u, &pData);
                      }
                    }
                  }
                  else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
                  {
                    ...
                    v64 = 4LL;
                    v66 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B568C, 0LL, 0LL, 0xCu, &pData);
                  }
                }
                else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
                {
                  ...
                  v60 = 4LL;
                  v62 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B5712, 0LL, 0LL, 0xAu, &pData);
                }
              }
              else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
              {
                ...
                v60 = 4LL;
                v62 = 4LL;
                TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B591D, 0LL, 0LL, 0xAu, &pData);
              }
            }
            else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
            {
          ...
          else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
          {
            ...
            v58 = 4LL;
            v60 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B583E, 0LL, 0LL, 9u, &pData);
          }
        }
        else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
        {
          ...
          v56 = 4LL;
          v58 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B58AF, 0LL, 0LL, 8u, &pData);
        }
      }
      else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
      {
        ...
        v54 = 4LL;
        v56 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B5991, 0LL, 0LL, 7u, &pData);
      }
    }
    else if ( dword_180305E40 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 1uLL) )
    {
      ...
      v45 = v40;
      v56 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B59F8, 0LL, 0LL, 7u, &pData);
    }
  }
}
