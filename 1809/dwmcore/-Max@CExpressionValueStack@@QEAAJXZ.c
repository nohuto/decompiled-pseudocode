/*
 * XREFs of ?Max@CExpressionValueStack@@QEAAJXZ @ 0x180079560
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Max(unsigned __int64 this)
{
  ...
  if ( (unsigned int)this >= 2 )
  {
    ...
    if ( v9 == *((_DWORD *)v5 + 18) )
    {
      ...
      {
        case 18:
          v17 = fmaxf(*(float *)v7, *v5);
          *((_DWORD *)v7 + 18) = 18;
          *(float *)v7 = v17;
          break;
        case 35:
          v15 = fmaxf(*(float *)v7, *v5);
          v16 = fmaxf(*((float *)v7 + 1), v5[1]);
          *((_DWORD *)v7 + 18) = 35;
          *(float *)v7 = v15;
          *((float *)v7 + 1) = v16;
          break;
        case 52:
          ...
          v12.m128_f32[0] = fmaxf(COERCE_FLOAT(*v7), COERCE_FLOAT(*(_QWORD *)v5));
          v13.m128_f32[0] = fmaxf(COERCE_FLOAT(HIDWORD(*v7)), COERCE_FLOAT(HIDWORD(*(_QWORD *)v5)));
          v14 = fmaxf(*((float *)v7 + 2), v5[2]);
          *((_DWORD *)v7 + 18) = 52;
        ...
        case 69:
          ...
          *(_QWORD *)&v20 = __PAIR64__(
                              ...
                              COERCE_UNSIGNED_INT(fmaxf(v11.m128_f32[0], v10.m128_f32[0])));
