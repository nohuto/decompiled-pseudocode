/*
 * XREFs of ?GetTightBounds@CShape@@UEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x1800175B0
 * Callers:
...
LABEL_2:
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x377u);
  }
  else
  {
    ...
    *(_OWORD *)a2 = v18;
    ...
    {
      v9 = -2003304438;
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, -2003304438, 0x383u);
    }
  }
  if ( v16 )
