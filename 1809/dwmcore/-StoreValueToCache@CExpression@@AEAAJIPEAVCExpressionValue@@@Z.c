/*
 * XREFs of ?StoreValueToCache@CExpression@@AEAAJIPEAVCExpressionValue@@@Z @ 0x1800BF658
 * Callers:
...
LABEL_45:
        MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v6, v18);
        return v8;
      }
...
LABEL_32:
    v8 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2147024809, 0x5E1u);
    return v8;
  }
