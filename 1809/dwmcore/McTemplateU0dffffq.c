/*
 * XREFs of McTemplateU0dffffq @ 0x180177070
 * Callers:
...
ULONG __fastcall McTemplateU0dffffq(__int64 a1, __int64 a2, __int64 a3, float a4, char a5, char a6, char a7, char a8)
{
  ...
  v19 = 4LL;
  v21 = 4LL;
  return McGenEventWrite(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_OCCLUSIONEVENT, a3, 7u, &v9);
}
