/*
 * XREFs of ?CheckDirectFlipSupport@CHwFullScreenRenderTarget@@UEAAJPEAUIDXGIResource@@W4DXGI_COLOR_SPACE_TYPE@@AEBUtagRECT@@PEA_N@Z @ 0x180207E30
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  ...
  v10 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x161u);
  return v10;
}
