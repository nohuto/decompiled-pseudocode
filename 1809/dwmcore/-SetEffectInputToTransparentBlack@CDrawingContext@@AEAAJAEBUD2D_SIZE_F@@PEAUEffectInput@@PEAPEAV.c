/*
 * XREFs of ?SetEffectInputToTransparentBlack@CDrawingContext@@AEAAJAEBUD2D_SIZE_F@@PEAUEffectInput@@PEAPEAVIImageSource@@@Z @ 0x1800045B4
 * Callers:
        ...
        struct IImageSource **a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0, 0LL, 0, StockTransparentImageNoRef, 0xB23u);
  }
  else
  {
