/*
 * XREFs of ?GetOrCreateCompositionStatsForMonitor@CCompositionSwapchainStatistics@@AEAAAEAUCompositionStatsPerMonitor@1@PEAUHMONITOR__@@@Z @ 0x1801DBAD0
 * Callers:
 *     ?RecordCompositionMode@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@W4BufferCompositionMode@@@Z @ 0x1801DBC70 (-RecordCompositionMode@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@W4BufferCompositio.c)
 *     ?RecordOutputColorSpace@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@W4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x1801DBCB0 (-RecordOutputColorSpace@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@W4DXGI_COLOR_SPAC.c)
 *     ?RecordTransform@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@AEBVCMILMatrix@@@Z @ 0x1801DBCE0 (-RecordTransform@CCompositionSwapchainStatistics@@UEAA_NPEAUHMONITOR__@@AEBVCMILMatrix@@@Z.c)
 * Callees:
