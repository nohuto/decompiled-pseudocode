/*
 * XREFs of ?GetRealization@CViewBox@@UEBAXAEBUD2D_SIZE_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801B59E0
 * Callers:
        ...
        struct D2D_MATRIX_3X2_F *a3)
{
  ...
  struct D2D_RECT_F v14; // [rsp+60h] [rbp-20h] BYREF
  ...
  {
    StretchAlign::Arrange((StretchAlign *)&this[29], &v14, this + 28, a2, 0LL);
    v11[1] = 0.0;
    v11[2] = 0.0;
    v11[4] = v14.left;
    v8 = LODWORD(this[27].width) ^ _xmm;
    v11[0] = (float)(v14.right - v14.left) / *v7;
    v9 = v14.bottom - v14.top;
    v11[5] = v14.top;
    v15 = v8;
    v14 = (struct D2D_RECT_F)_xmm;
    v11[3] = v9 / this[28].height;
    v16 = LODWORD(this[27].height) ^ _xmm;
