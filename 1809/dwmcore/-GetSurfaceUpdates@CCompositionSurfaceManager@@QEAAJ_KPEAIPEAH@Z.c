/*
 * XREFs of ?GetSurfaceUpdates@CCompositionSurfaceManager@@QEAAJ_KPEAIPEAH@Z @ 0x18016D7C0
 * Callers:
        ...
        int *a4)
{
  ...
  if ( FrameSurfaceUpdates < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v6, &dword_180292838, 3u, FrameSurfaceUpdates | 0x10000000, 0x7Eu);
  }
  return v4;
}
