/*
 * XREFs of ?TelemetryRecordInputActivity@CPartitionVerticalBlankScheduler@@UEAAXI_K@Z @ 0x18001AA50
 * Callers:
 *     <none>
 * Callees:
 *     ?Update@CMouseKeyboardInfo@CTelemetryTouchLatencyAnalysis@@QEAAXI_K0@Z @ 0x18001AAFC (-Update@CMouseKeyboardInfo@CTelemetryTouchLatencyAnalysis@@QEAAXI_K0@Z.c)
        ...
        unsigned __int64 a3)
{
  ...
  if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
  {
    ...
    v18 = 4;
    v21 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B2166, 0LL, 0LL, 5u, &pData);
    v3 = v24;
    v4 = v23;
  }
  v6 = (unsigned __int64 *)*((_QWORD *)this + 3232);
  v11 = v3;
  v10 = v4;
  v7 = *v6;
  v12 = *v6;
  if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 2uLL) )
  {
    ...
    v18 = 8;
    v21 = 8;
    TlgWrite(v8, &unk_1802B3293, 0LL, 0LL, 5u, &pData);
    v7 = v12;
    v3 = v11;
    v4 = v10;
  }
  CTelemetryTouchLatencyAnalysis::CMouseKeyboardInfo::Update(
    (CPartitionVerticalBlankScheduler *)((char *)this + 29936),
    v4,
    v3,
    v7);
}
