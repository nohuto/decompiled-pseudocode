/*
 * XREFs of ?GetInformation@CRedirectedGDISurface@@QEAAJW4_RedirectGDISurfaceInformationClass@@PEAKPEAX@Z @ 0x180093374
 * Callers:
...
LABEL_37:
      v4 = v15;
LABEL_38:
      MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_18029BD00, 3u, v15, v18);
      return v4;
    }
    ...
    if ( a3 && *a3 >= 0x20u )
    {
      *a3 = 32;
      SetLastError(0);
      if ( (unsigned int)DwmGetRedirectionStyle(*(_QWORD *)(v7 + 24), &v19) )
      {
        *(_DWORD *)a4 = v19;
        *(_DWORD *)(a4 + 8) = v20;
        *(_DWORD *)(a4 + 12) = v21;
