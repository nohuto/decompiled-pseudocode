/*
 * XREFs of ?RevalidateMCTree@CManipulationContext@@AEAAXPEAUMCCollections@@@Z @ 0x1801F8708
 * Callers:
...
void __fastcall CManipulationContext::RevalidateMCTree(CManipulationContext *this, struct MCCollections *a2)
{
  ...
  struct CInteraction *v63; // [rsp+90h] [rbp-70h]
    ...
    while ( 1 )
    {
      ...
      for ( i = ClosestInteractionAncestor; i; i = CManipulationContext::GetClosestInteractionAncestor(v25, v20) )
      {
        if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
        {
          ...
          v51 = i;
          v68 = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B8C3B, 0LL, 0LL, 4u, &pData);
        }
        *((_BYTE *)i + 184) |= 0x10u;
        v25 = 0LL;
        v26 = *((_QWORD *)i + 13);
      ...
      for ( j = v19; j; j = (struct CInteraction *)*((_QWORD *)j + 25) )
      {
        if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
        {
          ...
          v51 = j;
          v68 = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B8C8D, 0LL, 0LL, 4u, &pData);
        }
        *((_BYTE *)j + 184) |= 0x20u;
      }
      if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
      {
        ...
        v55 = v19;
        v70 = 8LL;
        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B8A80, 0LL, 0LL, 5u, &pData);
      }
...
LABEL_67:
    ...
    while ( 1 )
    {
      ...
      if ( v33 )
        v34 = *(const struct CVisual **)(v33 + 16);
      ...
      if ( dword_180305E40 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_180305E40, 2uLL) )
      {
        ...
        v72 = v37 + 6;
        v75 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_180305E40, &unk_1802B8AE2, 0LL, 0LL, 7u, &pData);
      }
      ...
      if ( ClosestInteractionAncestor && (*((_BYTE *)ClosestInteractionAncestor + 184) & 0x20) == 0 )
      {
