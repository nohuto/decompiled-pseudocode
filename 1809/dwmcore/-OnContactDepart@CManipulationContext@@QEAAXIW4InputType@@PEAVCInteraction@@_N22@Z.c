/*
 * XREFs of ?OnContactDepart@CManipulationContext@@QEAAXIW4InputType@@PEAVCInteraction@@_N22@Z @ 0x1801F7480
 * Callers:
        ...
        char a7)
{
  ...
  if ( !v7 )
  {
    ...
    {
      v14 = *(__int64 (__fastcall ****)(_QWORD))(*(_QWORD *)(a1 + 72) + 8LL * Key);
      v7 = v14;
      Microsoft::WRL::ComPtr<IInteractionContextWrapper>::InternalAddRef(&v14);
      v12 = v7;
    }
  ...
  CManipulationContext::CleanTreeState((__int64)v7, a1, *(RTL_SRWLOCK **)(a1 + 48), a6, a3);
  if ( v7 )
    (*v7)[1](v7);
}
