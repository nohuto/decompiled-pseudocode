/*
 * XREFs of ?ComputeCpuClipBoundsInScope@CScopedClipStack@@AEAAXXZ @ 0x18002F22C
 * Callers:
...
void __fastcall CScopedClipStack::ComputeCpuClipBoundsInScope(CScopedClipStack *this)
{
  ...
  if ( v9 < v2 )
  {
    do
    {
      ...
      if ( (unsigned __int8)TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsInfinite(v10 + 112) )
      {
        if ( *(_BYTE *)(v10 + 128) )
        {
          v12 = *(float *)(v10 + 96);
