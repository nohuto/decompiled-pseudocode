/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x180143254
 * Callers:
        ...
        void **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( Pointer >= 0 )
  {
    ...
    {
      v14 = wil::details_abi::ProcessLocalStorageData<wil::details_abi::ProcessLocalData>::MakeAndInitialize((unsigned __int16 *)Name);
      v7 = v14;
      if ( v14 < 0 )
      {
