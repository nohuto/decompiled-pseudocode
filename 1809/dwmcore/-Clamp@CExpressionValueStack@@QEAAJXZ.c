/*
 * XREFs of ?Clamp@CExpressionValueStack@@QEAAJXZ @ 0x18001BE78
 * Callers:
...
LABEL_23:
      *(float *)v6 = v20;
      break;
    case 52:
      v16 = (__m128)(unsigned int)*v6;
      v17 = (__m128)(unsigned int)HIDWORD(*v6);
      v16.m128_f32[0] = fminf(fmaxf(COERCE_FLOAT(*v6), COERCE_FLOAT(*v9)), COERCE_FLOAT(*v4));
      v17.m128_f32[0] = fminf(fmaxf(COERCE_FLOAT(HIDWORD(*v6)), COERCE_FLOAT(HIDWORD(*v9))), COERCE_FLOAT(HIDWORD(*v4)));
      v18 = fmaxf(*((float *)v6 + 2), *((float *)v9 + 2));
      v26 = *((float *)v4 + 2);
      *((_DWORD *)v6 + 18) = 52;
      *v6 = _mm_unpacklo_ps(v16, v17).m128_u64[0];
