/*
 * XREFs of ?EnsureBlackColorBrush@CProjectedShadowReceiver@@AEAAJXZ @ 0x1801AEB04
 * Callers:
...
__int64 __fastcall CProjectedShadowReceiver::EnsureBlackColorBrush(CProjectedShadowReceiver *this)
{
  ...
  if ( !*((_QWORD *)this + 14) )
  {
    ...
    if ( *v2 )
    {
      ...
      v1 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x1C4u);
    }
    else
    {
      v1 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, -2147024882, 0x1BCu);
    }
  }
  return v1;
}
