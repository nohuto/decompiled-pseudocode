/*
 * XREFs of ?LogShaderStats@CTelemetryTracking@@QEAAXPEBGIIIMMM@Z @ 0x180084394
 * Callers:
 *     ?LogShaderStats@CPartitionVerticalBlankScheduler@@UEAAXPEBGIIIMMM@Z @ 0x180084380 (-LogShaderStats@CPartitionVerticalBlankScheduler@@UEAAXPEBGIIIMMM@Z.c)
 * Callees:
            ...
            * ((unsigned __int8)((v24 & (unsigned __int64)v13) >> 32)
             ...
             * ((((unsigned int)v24 & (unsigned int)v13) >> 24)
              ...
              * ((unsigned __int8)(((unsigned int)v24 & (unsigned int)v13) >> 16)
               + 37 * ((unsigned __int8)((unsigned __int16)(v24 & v13) >> 8) + 37 * ((unsigned __int8)v25 + 11623883)))))))) & ((v23 >> 5) - 1));
    while ( 1 )
    {
      v27 = *(_QWORD *)v27;
      if ( (v27 & 1) != 0 )
