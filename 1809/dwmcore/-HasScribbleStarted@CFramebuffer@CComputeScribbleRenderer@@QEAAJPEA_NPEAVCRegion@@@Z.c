/*
 * XREFs of ?HasScribbleStarted@CFramebuffer@CComputeScribbleRenderer@@QEAAJPEA_NPEAVCRegion@@@Z @ 0x18022DEA8
 * Callers:
...
__int64 __fastcall CComputeScribbleRenderer::CFramebuffer::HasScribbleStarted(void **this, bool *a2, void **a3)
{
  _DWORD *v5; // rax
  int v6; // eax
  unsigned int v7; // edi
