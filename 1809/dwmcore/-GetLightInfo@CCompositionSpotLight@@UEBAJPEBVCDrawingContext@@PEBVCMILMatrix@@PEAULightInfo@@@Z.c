/*
 * XREFs of ?GetLightInfo@CCompositionSpotLight@@UEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAULightInfo@@@Z @ 0x180191940
 * Callers:
 *     <none>
 * Callees:
        ...
        struct LightInfo *a4)
{
  ...
  *(_DWORD *)a4 = 3;
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x6Bu);
  }
  else
  {
