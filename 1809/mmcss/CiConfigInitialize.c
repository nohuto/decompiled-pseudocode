/*
 * XREFs of CiConfigInitialize @ 0x1C000D280
 * Callers:
...
__int64 CiConfigInitialize()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  else
  {
    ...
    {
      v3 = CiConfigReadDWORD(KeyHandle, 0x1C000F0A0LL, 10LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          v4);
      v5 = (unsigned __int8)CiConfigReadDWORD(KeyHandle, 0x1C000F080LL, 0LL) != 0;
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          v5);
      v6 = CiConfigReadDWORD(KeyHandle, 0x1C000F0B0LL, 2LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          ActiveThreadCount);
      v9 = CiConfigReadDWORD(KeyHandle, 0x1C000F0E0LL, 100000LL);
      *(&WPP_MAIN_CB.ActiveThreadCount + 1) = v9;
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          v9);
      v10 = CiConfigReadDWORD(KeyHandle, 0x1C000F0F0LL, 32LL);
