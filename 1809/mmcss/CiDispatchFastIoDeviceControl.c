/*
 * XREFs of CiDispatchFastIoDeviceControl @ 0x1C000A9C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  {
    WPP_SF_dd((__int64)WPP_GLOBAL_Control->AttachedDevice, 0x12u, v16, v13, TaskIndexClientFromThread);
  }
