/*
 * XREFs of HUBUCX_UCXIoctlComplete @ 0x1C00201A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_94:
    ...
    case 0x49101B:
      ...
      if ( v47 )
      {
        ...
        if ( v48 != (_QWORD *)*v48 )
        {
          do
          {
            for ( i = 0; i < *(_DWORD *)(v49 + 24); ++i )
            {
              if ( *(_DWORD *)(v49 + 72LL * i + 48) == 5 )
                *(_DWORD *)(v49 + 72LL * i + 48) = 6;
            }
            v51 = *(_QWORD **)(v49 + 8);
            v49 = (__int64)(v51 - 1);
          }
  ...
  if ( v27 )
  {
    if ( (*(_DWORD *)(v14 + 72) & 4) != 0 )
    {
      ...
      LODWORD(v56) = v28;
      LODWORD(v55) = v27;
      WPP_RECORDER_SF_dD(v30, v31, 5u, v29, (__int64)&WPP_df5029fda23434fb8c7e6119726b3851_Traceguids, v55, v56);
      goto LABEL_38;
    }
    if ( v4 < 0 )
    {
