/*
 * XREFs of HUBPDO_FindAndStoreMatchingInternalPipeHandle @ 0x1C0013F38
 * Callers:
 *     HUBDSM_GettingMatchingPipeHandleOnClientResetPipe @ 0x1C001AA20 (HUBDSM_GettingMatchingPipeHandleOnClientResetPipe.c)
 * Callees:
