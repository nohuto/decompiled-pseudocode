/*
 * XREFs of HUBMUX_QueueResetToAllPSMs @ 0x1C000DD90
 * Callers:
 *     HUBHSM_NotifyingHubResetToPortsOnResetOnResume @ 0x1C0007910 (HUBHSM_NotifyingHubResetToPortsOnResetOnResume.c)
 * Callees:
