/*
 * XREFs of HUBHTX_GetPortLostChangeEvent @ 0x1C0004908
 * Callers:
 *     HUBPSM20_GettingPortLostChangesOnStart @ 0x1C000F8F0 (HUBPSM20_GettingPortLostChangesOnStart.c)
 * Callees:
  ...
  if ( (v3 & 8) != 0 )
  {
    ...
    if ( ((v6 | v5) & 8) == 0 )
    {
      ...
      *((_DWORD *)a1 + 356) = 4;
      v11 = 3065;
LABEL_19:
      v14 = (struct _MCGEN_TRACE_CONTEXT *)*(unsigned int *)(*a1 + 2592LL);
      if ( ((unsigned __int16)v14 & 0x200) != 0 )
