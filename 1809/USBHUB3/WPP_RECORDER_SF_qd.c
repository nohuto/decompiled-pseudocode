/*
 * XREFs of WPP_RECORDER_SF_qd @ 0x1C0002AB0
 * Callers:
 *     HUBHTX_Get30PortChangeEvent @ 0x1C0004C20 (HUBHTX_Get30PortChangeEvent.c)
 *     HUBHSM_WaitingForOvercurrentToClear @ 0x1C0008250 (HUBHSM_WaitingForOvercurrentToClear.c)
 ...
 *     HUBMISC_StartOverCurrentTimer @ 0x1C002BBA0 (HUBMISC_StartOverCurrentTimer.c)
 *     HUBMISC_StartD3ColdReconnectTimer @ 0x1C002BCA8 (HUBMISC_StartD3ColdReconnectTimer.c)
 * Callees:
