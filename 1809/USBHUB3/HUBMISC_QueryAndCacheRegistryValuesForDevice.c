/*
 * XREFs of HUBMISC_QueryAndCacheRegistryValuesForDevice @ 0x1C0072564
 * Callers:
 *     HUBDSM_QueryingRegistryValuesForDevice @ 0x1C001C170 (HUBDSM_QueryingRegistryValuesForDevice.c)
 * Callees:
  ...
  if ( UsbflagsValuesForDevice < 0 )
  {
    *(_DWORD *)(a1 + 2432) = 1073807366;
    if ( SLOBYTE(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) < 0 )
    {
      ...
      McTemplateK0pq(v4, &USBHUB3_ETW_EVENT_REGISTRY_FAILURE, (const GUID *)(a1 + 1516), *(_QWORD *)(a1 + 24), v6);
    }
  }
  result = 4065LL;
  if ( UsbflagsValuesForDevice >= 0 )
