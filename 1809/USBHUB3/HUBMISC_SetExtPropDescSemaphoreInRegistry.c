/*
 * XREFs of HUBMISC_SetExtPropDescSemaphoreInRegistry @ 0x1C0072660
 * Callers:
 *     HUBDSM_SettingExtPropDescSemaphoreForMsOs2 @ 0x1C001F3B0 (HUBDSM_SettingExtPropDescSemaphoreForMsOs2.c)
 * Callees:
