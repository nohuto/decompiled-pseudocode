/*
 * XREFs of HUBDTX_LogAlternateMode @ 0x1C0026EA8
 * Callers:
 *     HUBDSM_CheckingIfAlternateModeStringDescriptorShouldBeQueried @ 0x1C001CF50 (HUBDSM_CheckingIfAlternateModeStringDescriptorShouldBeQueried.c)
...
ULONG __fastcall HUBDTX_LogAlternateMode(__int64 a1, _BYTE *a2)
{
  __int64 *v2; // r12
  __int64 v5; // rdi
