/*
 * XREFs of McTemplateK0phhhquuuuu @ 0x1C00277D0
 * Callers:
...
ULONG McTemplateK0phhhquuuuu(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v22 = 1LL;
  v24 = 1LL;
  return McGenEventWrite(a1, &USBHUB3_ETW_EVENT_ILLEGAL_ENDPOINT_SHARING_ACROSS_INTERFACES, a3, 0xBu, &EventData);
}
