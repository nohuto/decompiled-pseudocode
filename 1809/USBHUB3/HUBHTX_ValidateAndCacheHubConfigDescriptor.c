/*
 * XREFs of HUBHTX_ValidateAndCacheHubConfigDescriptor @ 0x1C0002EE0
 * Callers:
 *     HUBHSM_ValidatingHubConfigurationDescriptor @ 0x1C0008A70 (HUBHSM_ValidatingHubConfigurationDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBHTX_ValidateAndCacheHubConfigDescriptor(__int64 a1)
{
  ...
  LOWORD(v13[0]) = *(_WORD *)(a1 + 2458);
  HIDWORD(v13[0]) = *(_DWORD *)(a1 + 256);
