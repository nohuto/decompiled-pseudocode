/*
 * XREFs of HUBDTX_ValidateAndCacheLanguageIdStringDescriptor @ 0x1C00261A8
 * Callers:
 *     HUBDSM_ValidatingLanguageIdStringDescriptor @ 0x1C001C370 (HUBDSM_ValidatingLanguageIdStringDescriptor.c)
 * Callees:
