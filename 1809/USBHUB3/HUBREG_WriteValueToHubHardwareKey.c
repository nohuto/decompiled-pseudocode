/*
 * XREFs of HUBREG_WriteValueToHubHardwareKey @ 0x1C0074DF4
 * Callers:
...
__int64 __fastcall HUBREG_WriteValueToHubHardwareKey(__int64 a1, __int64 a2, int a3)
{
  ...
  LODWORD(v9) = v5;
  WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2520), 2u, 3u, v7, (__int64)&WPP_a5d7102001b13a39eb4d855100c5c7b8_Traceguids, v9);
LABEL_6:
  if ( v10 )
