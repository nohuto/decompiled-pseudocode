/*
 * XREFs of WPP_RECORDER_SF_q @ 0x1C0011A7C
 * Callers:
 ...
 *     HUBMISC_GetGenericErrorResponseOnDescriptorFailure @ 0x1C00271BC (HUBMISC_GetGenericErrorResponseOnDescriptorFailure.c)
 * Callees:
