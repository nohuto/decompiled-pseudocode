/*
 * XREFs of HUBMISC_CheckIfDeviceProgrammingWasLost @ 0x1C002A8B0
 * Callers:
 *     HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum @ 0x1C001B930 (HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum.c)
 * Callees:
 *     <none>
 */
