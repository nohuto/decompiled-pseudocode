/*
 * XREFs of HUBHTX_SetLinkStateToRxDetectUsingControlTransfer @ 0x1C00062F4
 * Callers:
 *     HUBPSM30_EnablingSuperSpeedOnTimerExpiration @ 0x1C000FD50 (HUBPSM30_EnablingSuperSpeedOnTimerExpiration.c)
 * Callees:
