/*
 * XREFs of HUBDESC_ValidateMsOs20CompatibleId @ 0x1C0035CF0
 * Callers:
 *     <none>
 * Callees:
  ...
  do
  {
    ...
    if ( *v12 )
    {
      if ( v11 == 1 )
      {
        v20 = 327;
LABEL_26:
        WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, v20, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
        v9 = 168LL;
        goto LABEL_6;
      }
