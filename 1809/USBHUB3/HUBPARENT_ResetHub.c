/*
 * XREFs of HUBPARENT_ResetHub @ 0x1C0006D60
 * Callers:
 *     HUBHSM_ResettingHubOnResume @ 0x1C0007D30 (HUBHSM_ResettingHubOnResume.c)
 * Callees:
...
__int64 __fastcall HUBPARENT_ResetHub(__int64 a1)
{
  ...
  _QWORD v10[7]; // [rsp+38h] [rbp-41h] BYREF
  _QWORD v11[9]; // [rsp+70h] [rbp-9h] BYREF
