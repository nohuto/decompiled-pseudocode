/*
 * XREFs of McTemplateK0pjq @ 0x1C0010F6C
 * Callers:
...
ULONG McTemplateK0pjq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v8 = 16LL;
  v10 = 4LL;
  return McGenEventWrite(a1, &USBHUB3_ETW_EVENT_DEVICE_QUERY_USB_CAPABILITY, a3, 4u, &EventData);
}
