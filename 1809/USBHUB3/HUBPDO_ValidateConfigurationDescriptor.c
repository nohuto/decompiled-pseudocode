/*
 * XREFs of HUBPDO_ValidateConfigurationDescriptor @ 0x1C00134D0
 * Callers:
...
__int64 __fastcall HUBPDO_ValidateConfigurationDescriptor(__int64 a1, unsigned __int8 *a2, int a3)
{
  ...
  if ( !*((_WORD *)a2 + 1) )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(v12 + 1432), 2u, 5u, 0x1Au, (__int64)&WPP_7c9a8c1f1a7c3ca72e1c468f1757432b_Traceguids);
    return (unsigned int)-1073737984;
  }
