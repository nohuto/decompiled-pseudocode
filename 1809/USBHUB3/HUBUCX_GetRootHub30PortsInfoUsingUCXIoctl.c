/*
 * XREFs of HUBUCX_GetRootHub30PortsInfoUsingUCXIoctl @ 0x1C00224E4
 * Callers:
 *     HUBHSM_GettingRootHub30PortsInfo @ 0x1C0008AF0 (HUBHSM_GettingRootHub30PortsInfo.c)
 * Callees:
...
LABEL_15:
  ...
  v8 = 224LL * *(unsigned __int16 *)(a1 + 114);
  memset(v15, 0, 0x38uLL);
  v15[4] = *(_QWORD *)(a1 + 16);
  LODWORD(v15[0]) = 56;
  v15[3] = 0x100000001LL;
