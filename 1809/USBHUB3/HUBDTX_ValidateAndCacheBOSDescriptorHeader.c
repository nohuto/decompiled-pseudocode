/*
 * XREFs of HUBDTX_ValidateAndCacheBOSDescriptorHeader @ 0x1C0025260
 * Callers:
 *     HUBDSM_ValidatingAlternateBOSDescriptorHeader @ 0x1C001D670 (HUBDSM_ValidatingAlternateBOSDescriptorHeader.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheBOSDescriptorHeader(__int64 a1)
{
  ...
  __int64 v15; // rbx
  _OWORD v17[4]; // [rsp+48h] [rbp-59h] BYREF
  _OWORD v18[3]; // [rsp+88h] [rbp-19h] BYREF
  __int64 v19; // [rsp+B8h] [rbp+17h]
  __int64 v20; // [rsp+C0h] [rbp+1Fh]
  __int64 v21; // [rsp+C8h] [rbp+27h]
  int v22; // [rsp+D0h] [rbp+2Fh]
  _OWORD *v23; // [rsp+D8h] [rbp+37h]
  char v24; // [rsp+108h] [rbp+67h] BYREF
