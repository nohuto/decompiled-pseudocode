/*
 * XREFs of HUBFDO_IoctlGetPortConnectorProperties @ 0x1C006D090
 * Callers:
...
LABEL_8:
    ...
    else
    {
      ...
      if ( *((_WORD *)v32 + 6) <= 1u )
      {
        ...
        if ( CompanionPort )
        {
          v24 = (unsigned __int16 *)(*(_QWORD *)CompanionPort + 2544LL);
...
LABEL_32:
  ...
  WPP_RECORDER_SF_d(v9[315], 2u, 3u, 0x2Eu, (__int64)&WPP_0e53b71dd48e35ef915a1bb9371a4353_Traceguids, v10);
LABEL_10:
