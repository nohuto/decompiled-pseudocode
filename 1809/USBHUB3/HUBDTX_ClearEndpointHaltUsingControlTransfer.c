/*
 * XREFs of HUBDTX_ClearEndpointHaltUsingControlTransfer @ 0x1C0026544
 * Callers:
 *     HUBDSM_ClearingEndpointHaltOnClientResetPipe @ 0x1C001A4A0 (HUBDSM_ClearingEndpointHaltOnClientResetPipe.c)
 * Callees:
