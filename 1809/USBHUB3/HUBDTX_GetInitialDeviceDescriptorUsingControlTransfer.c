/*
 * XREFs of HUBDTX_GetInitialDeviceDescriptorUsingControlTransfer @ 0x1C0024BD0
 * Callers:
 *     HUBDSM_GettingDeviceDescriptorInReEnumAtZero @ 0x1C001BBB0 (HUBDSM_GettingDeviceDescriptorInReEnumAtZero.c)
 * Callees:
