/*
 * XREFs of HUBREG_QueryUsbHardwareVerifierValue @ 0x1C00730AC
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  *a7 = 0;
  ...
  {
    LODWORD(v20) = v14;
    WPP_RECORDER_SF_d(a6, 2u, 5u, 0xFu, (__int64)&WPP_a5d7102001b13a39eb4d855100c5c7b8_Traceguids, v20);
    goto LABEL_12;
  }
...
LABEL_21:
  if ( v13 == -1073741772 )
  {
    ...
    {
      LODWORD(v20) = v16;
      WPP_RECORDER_SF_d(a6, 2u, 5u, 0x10u, (__int64)&WPP_a5d7102001b13a39eb4d855100c5c7b8_Traceguids, v20);
    }
  }
LABEL_12:
  if ( v13 >= 0 )
...
LABEL_45:
    LODWORD(v20) = *a7;
    WPP_RECORDER_SF_d(a6, 2u, 5u, 0x12u, (__int64)&WPP_a5d7102001b13a39eb4d855100c5c7b8_Traceguids, v20);
    goto LABEL_46;
  }
  *a7 = 0;
  if ( v13 != -1073741772 )
  {
    LODWORD(v20) = v13;
    WPP_RECORDER_SF_d(a6, 2u, 5u, 0x11u, (__int64)&WPP_a5d7102001b13a39eb4d855100c5c7b8_Traceguids, v20);
  }
LABEL_46:
  if ( v21 )
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 1848))(WdfDriverGlobals);
