/*
 * XREFs of HUBMISC_CreateNewDSM @ 0x1C002AB28
 * Callers:
 *     HUBPSM30_CreatingDeviceInConnectedWithResetInProgress @ 0x1C000EC20 (HUBPSM30_CreatingDeviceInConnectedWithResetInProgress.c)
 * Callees:
...
__int64 __fastcall HUBMISC_CreateNewDSM(__int64 a1)
{
  ...
  *(_QWORD *)(v2 + 8) = a1;
  *(_QWORD *)v2 = *(_QWORD *)a1;
  v7 = (struct _MCGEN_TRACE_CONTEXT *)*(unsigned int *)(a1 + 204);
