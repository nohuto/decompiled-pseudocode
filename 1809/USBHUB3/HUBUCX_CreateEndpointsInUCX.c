/*
 * XREFs of HUBUCX_CreateEndpointsInUCX @ 0x1C0021A78
 * Callers:
 *     HUBDSM_CreatingNewEndpoints @ 0x1C001E670 (HUBDSM_CreatingNewEndpoints.c)
 * Callees:
 *     WPP_RECORDER_SF_d @ 0x1C0001A3C (WPP_RECORDER_SF_d.c)
 *     WPP_RECORDER_SF_ @ 0x1C0001E44 (WPP_RECORDER_SF_.c)
 *     HUBUCX_GetEndpointPriority @ 0x1C0021914 (HUBUCX_GetEndpointPriority.c)
...
LABEL_23:
      ...
      v11 = *(_QWORD *)(v8 + 32);
      *(_DWORD *)(v8 + 8) = 2;
      v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64, __int64, __int64))(v1 + 448))(
              *(_QWORD *)(v1 + 248),
              *(_QWORD *)(a1 + 24),
              v11,
              v10,
      ...
      v13 = *(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(v1 + 592);
      if ( !v13 )
        goto LABEL_20;
...
LABEL_18:
      v13(*(_QWORD *)(v1 + 248), *(_QWORD *)(a1 + 24), *(_QWORD *)v8, v14);
      goto LABEL_19;
    }
LABEL_24:
    ;
    ...
    for ( k = 0LL; (unsigned int)k < *((_DWORD *)v20 + 6); k = (unsigned int)(k + 1) )
    {
      if ( LODWORD(v20[9 * k + 6]) == 2 )
      {
        ...
        else
        {
          v19 = v20[9 * k + 5];
          LODWORD(v20[9 * k + 6]) = 1;
          (*(void (__fastcall **)(_QWORD, _QWORD, __int64))(v1 + 456))(*(_QWORD *)(v1 + 248), *(_QWORD *)(a1 + 24), v19);
        }
      }
    }
  }
