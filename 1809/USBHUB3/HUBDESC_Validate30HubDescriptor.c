/*
 * XREFs of HUBDESC_Validate30HubDescriptor @ 0x1C0034FC8
 * Callers:
...
LABEL_34:
  ...
  {
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x11Du, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v8);
  ...
  {
    LODWORD(v17) = v8;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x11Eu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
  ...
  {
    LODWORD(v17) = v10;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x11Fu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
  ...
  {
    LODWORD(v17) = v11;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x120u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
  ...
  {
    LODWORD(v17) = 0;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x121u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
  ...
  if ( (v12 & 2) != 0 )
  {
    if ( *(_BYTE *)(a3 + 15) )
      v4 = 2;
    LODWORD(v17) = v12;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x122u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
  ...
  if ( v12 >= 0x20u )
  {
    if ( *(_BYTE *)(a3 + 15) )
      v4 = 2;
    LODWORD(v17) = v12;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x123u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 19LL);
  }
  v13 = a1[7];
  if ( v13 >= 0xBu )
  {
    LODWORD(v17) = v13;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x124u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
