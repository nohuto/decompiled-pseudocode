/*
 * XREFs of HUBUCX_GetRootHubInfoUsingUCXIoctl @ 0x1C0021E24
 * Callers:
...
void __fastcall HUBUCX_GetRootHubInfoUsingUCXIoctl(__int64 a1)
{
  ...
  WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2520), 2u, 3u, v5, (__int64)&WPP_df5029fda23434fb8c7e6119726b3851_Traceguids, v3);
LABEL_6:
  if ( v4 < 0 )
  {
    if ( v6 )
