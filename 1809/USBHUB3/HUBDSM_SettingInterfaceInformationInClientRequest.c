/*
 * XREFs of HUBDSM_SettingInterfaceInformationInClientRequest @ 0x1C001B440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_SettingInterfaceInformationInClientRequest(__int64 a1)
{
  ...
  if ( v5 != (_QWORD *)*v5 )
  {
    ...
    {
      v10 = (*(__int64 (__fastcall **)(_QWORD))(v2 + 472))(*(_QWORD *)(v7 + 72 * i + 40));
      if ( !v10 )
        WPP_RECORDER_SF_(
          *(_QWORD *)(v1[1] + 1432),
          2u,
      ...
      *(_QWORD *)(v6 + 24 * i + 32) = v10;
      (*(void (__fastcall **)(_QWORD))(v2 + 464))(*(_QWORD *)(v7 + 72 * i + 40));
    }
  }
  return 4077LL;
}
