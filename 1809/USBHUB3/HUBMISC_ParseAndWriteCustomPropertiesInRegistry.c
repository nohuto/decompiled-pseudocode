/*
 * XREFs of HUBMISC_ParseAndWriteCustomPropertiesInRegistry @ 0x1C0072778
 * Callers:
 *     HUBDSM_WritingCustomPropertiesInRegistry @ 0x1C001F4F0 (HUBDSM_WritingCustomPropertiesInRegistry.c)
 * Callees:
