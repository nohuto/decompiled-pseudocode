/*
 * XREFs of HUBMUX_QueueStopAfterSuspendToAllDSMs @ 0x1C000E31C
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove @ 0x1C0007A60 (HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove.c)
 * Callees:
