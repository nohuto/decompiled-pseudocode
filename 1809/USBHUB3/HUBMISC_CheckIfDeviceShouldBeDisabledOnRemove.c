/*
 * XREFs of HUBMISC_CheckIfDeviceShouldBeDisabledOnRemove @ 0x1C0029FD4
 * Callers:
 *     HUBDSM_CheckingIfDeviceShouldBeDisabled @ 0x1C001A310 (HUBDSM_CheckingIfDeviceShouldBeDisabled.c)
 * Callees:
