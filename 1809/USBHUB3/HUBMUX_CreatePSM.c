/*
 * XREFs of HUBMUX_CreatePSM @ 0x1C000D04C
 * Callers:
...
__int64 __fastcall HUBMUX_CreatePSM(__int64 a1, unsigned __int16 *a2)
{
  ...
  *(_QWORD *)(v4 + 232) = *((_QWORD *)a2 + 4);
  ...
  if ( v13 < 0 )
  {
    v14 = 11;
LABEL_7:
    WPP_RECORDER_SF_d(*v10, 2u, 4u, v14, (__int64)&WPP_0df060cec95237a3bf2334f6cc1dce5a_Traceguids, v13);
    goto LABEL_15;
  }
  ...
  *(_QWORD *)(v4 + 1312) = Timer;
  if ( Timer )
  {
    ...
    v20 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(v18 + 496))(*(_QWORD *)(v18 + 248), v19, 1LL);
    *(_QWORD *)(v4 + 1264) = v20;
    if ( !v20 )
    {
      WPP_RECORDER_SF_(*v10, 2u, 4u, 0xEu, (__int64)&WPP_0df060cec95237a3bf2334f6cc1dce5a_Traceguids);
      v6 = -1073741670;
    }
  }
  else
