/*
 * XREFs of HUBDTX_GetBOSDescriptorUsingControlTransfer @ 0x1C0024D20
 * Callers:
 *     HUBDSM_GettingAlternateBOSDescriptor @ 0x1C001D220 (HUBDSM_GettingAlternateBOSDescriptor.c)
 * Callees:
