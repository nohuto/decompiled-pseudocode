/*
 * XREFs of HUBHSM_SendingAckForHubChange @ 0x1C0007F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_SendingAckForHubChange(__int64 a1)
{
  ...
  *(_DWORD *)(v1 + 956) = 0;
  v6 = v3;
  WPP_RECORDER_SF_d(*(_QWORD *)(v1 + 2520), 4u, 3u, 0xCu, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids, v6);
