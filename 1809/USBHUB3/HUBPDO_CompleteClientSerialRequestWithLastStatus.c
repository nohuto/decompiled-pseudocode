/*
 * XREFs of HUBPDO_CompleteClientSerialRequestWithLastStatus @ 0x1C0012884
 * Callers:
 *     HUBDSM_CompletingClientRequestOnFailureInConfigured @ 0x1C001A510 (HUBDSM_CompletingClientRequestOnFailureInConfigured.c)
