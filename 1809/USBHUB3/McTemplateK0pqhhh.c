/*
 * XREFs of McTemplateK0pqhhh @ 0x1C00110FC
 * Callers:
...
ULONG McTemplateK0pqhhh(struct _MCGEN_TRACE_CONTEXT *a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v12 = 2LL;
  v14 = 2LL;
  return McGenEventWrite(a1, a2, a3, 6u, &EventData);
}
