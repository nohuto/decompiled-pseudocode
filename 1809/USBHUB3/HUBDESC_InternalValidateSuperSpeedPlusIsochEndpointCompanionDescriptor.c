/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedPlusIsochEndpointCompanionDescriptor @ 0x1C0030D2C
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = v11;
  ...
  {
    v14 = a5;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0x5Fu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v10);
  ...
  if ( *a1 > 8u )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a2) )
      *a4 = 2;
    WPP_RECORDER_SF_DDD(v14, 2u, v18, 0x62u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, *a1, v10, 8);
    ...
    *(_DWORD *)(a2 + 256) = v19 & 0xFFFFFFD7 | 0x20;
    if ( *a3 > v26 )
    {
      if ( *(_WORD *)a2 > 0x200u || *(_BYTE *)(a2 + 12) )
        *a4 = 2;
      LODWORD(v23) = v10;
      WPP_RECORDER_SF_d(v14, 2u, 5u, 0x64u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v23);
      v20 = 209LL;
LABEL_25:
    ...
    if ( v21 )
    {
      ...
      LODWORD(v24) = v21;
      LODWORD(v23) = v10;
      WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x65u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v23, v24);
...
LABEL_35:
    if ( !*a4 )
      return result;
    return WPP_RECORDER_SF_(v14, 2u, 5u, 0x67u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
  }
  LODWORD(v23) = v10;
  WPP_RECORDER_SF_d(v14, 2u, 5u, 0x63u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v23);
