/*
 * XREFs of WerKernelCreateReport @ 0x1C003B98C
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C007B6C0 (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpCreateRegistryKey @ 0x1C003B408 (WerpCreateRegistryKey.c)
 *     CheckSpaceAvailable @ 0x1C003B834 (CheckSpaceAvailable.c)
 */
