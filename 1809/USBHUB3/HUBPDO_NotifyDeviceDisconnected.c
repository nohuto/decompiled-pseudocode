/*
 * XREFs of HUBPDO_NotifyDeviceDisconnected @ 0x1C0014064
 * Callers:
 ...
 *     HUBDSM_NotifyingDeviceDisconnectedOnDetachWithSpecialFile @ 0x1C001AB00 (HUBDSM_NotifyingDeviceDisconnectedOnDetachWithSpecialFile.c)
