/*
 * XREFs of HUBHTX_DisablePortUsingControlTransfer @ 0x1C0003F84
 * Callers:
 *     HUBPSM20_DisablingPortOnPortCycleWithTimer @ 0x1C000ECE0 (HUBPSM20_DisablingPortOnPortCycleWithTimer.c)
 * Callees:
