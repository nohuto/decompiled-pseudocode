/*
 * XREFs of HUBHTX_GetClearTtBufferInfoForEndpoint @ 0x1C0005CCC
 * Callers:
...
__int64 __fastcall HUBHTX_GetClearTtBufferInfoForEndpoint(__int64 a1, __int64 a2, char a3, __int16 *a4)
{
  bool v5; // cc
