/*
 * XREFs of HUBFDO_EvtDeviceCleanupCallback @ 0x1C000B340
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall HUBFDO_EvtDeviceCleanupCallback(__int64 a1)
{
  ...
  v10 = (struct _MCGEN_TRACE_CONTEXT *)*(unsigned int *)(v3 + 96);
  if ( (_DWORD)v10 )
  {
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 2) != 0 )
    return McTemplateK0p(v10, &USBHUB3_ETW_EVENT_HUB_CLEANUP_COMPLETE, 0LL, *(_QWORD *)(v3 + 248));
  return result;
}
