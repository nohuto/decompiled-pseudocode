/*
 * XREFs of HUBHTX_GetErrorResponseEventForInvalidPortStatusInPendingReset @ 0x1C0005580
 * Callers:
 *     HUBPSM20_ErrorOnResettingPort @ 0x1C000EE20 (HUBPSM20_ErrorOnResettingPort.c)
 * Callees:
