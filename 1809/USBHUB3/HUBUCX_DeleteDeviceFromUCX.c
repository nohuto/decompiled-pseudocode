/*
 * XREFs of HUBUCX_DeleteDeviceFromUCX @ 0x1C00229B4
 * Callers:
 ...
 *     HUBDSM_DeletingUCXDeviceOnOperationFailureFor30OnHubSuspend @ 0x1C001BB70 (HUBDSM_DeletingUCXDeviceOnOperationFailureFor30OnHubSuspend.c)
 * Callees:
