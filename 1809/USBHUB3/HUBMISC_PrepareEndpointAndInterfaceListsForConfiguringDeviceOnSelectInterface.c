/*
 * XREFs of HUBMISC_PrepareEndpointAndInterfaceListsForConfiguringDeviceOnSelectInterface @ 0x1C0029368
 * Callers:
 *     HUBDSM_PreparingEndpointAndInterfaceListsOnSelectInterface @ 0x1C001EF10 (HUBDSM_PreparingEndpointAndInterfaceListsOnSelectInterface.c)
 * Callees:
...
__int64 __fastcall HUBMISC_PrepareEndpointAndInterfaceListsForConfiguringDeviceOnSelectInterface(__int64 a1)
{
  ...
  __int64 v55; // r10
  __int64 v56; // r9
  struct _MCGEN_TRACE_CONTEXT **v57; // rbx
  _QWORD *v58; // rax
  ...
  _DWORD v93[14]; // [rsp+C0h] [rbp-48h] BYREF
  _QWORD v94[5]; // [rsp+F8h] [rbp-10h] BYREF
...
LABEL_20:
  ...
  *(_BYTE *)(v5 + 6) = v13[7];
  ...
  if ( *(_DWORD *)(v5 + 16) )
  {
    ...
    v31 = 22;
LABEL_84:
    WPP_RECORDER_SF_(v30, 2u, 5u, v31, (__int64)&WPP_5bc5aabc45393ebf49682d6683797972_Traceguids);
    v14 = -1073741823;
    *(_DWORD *)(a1 + 1564) = -1073725440;
    goto LABEL_8;
  }
...
LABEL_104:
          ...
          while ( 1 )
          {
            ...
            if ( *(_BYTE *)(v55 + 2) == *(_BYTE *)(v56 + 2) && *(_WORD *)(v55 + 4) && *(_WORD *)(v56 + 4) )
              break;
            v53 = v88;
            if ( ++v54 >= v88 )
              goto LABEL_104;
          }
          v57 = (struct _MCGEN_TRACE_CONTEXT **)v85;
          ...
          if ( (BYTE3(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) & 0x10) != 0 )
          {
            ...
            McTemplateK0phhhquuuuu(v57[4], v49[4], (const GUID *)(a1 + 1516), *(_QWORD *)(a1 + 24));
          }
          v14 = -1073741811;
        }
LABEL_109:
