/*
 * XREFs of HUBMISC_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C00724F4
 * Callers:
 *     HUBDSM_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C001C900 (HUBDSM_MarkDeviceAsNotSupportingMSOSDescriptor.c)
 * Callees:
