/*
 * XREFs of HUBDESC_ValidateMsOs20FunctionSubset @ 0x1C0035A80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x143u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
...
LABEL_4:
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x144u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
  return v8;
}
