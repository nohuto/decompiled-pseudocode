/*
 * XREFs of HUBMUX_AcquireDevicePowerReference @ 0x1C000E914
 * Callers:
 *     HUBDSM_AcquiringPowerReferenceOnHubResume @ 0x1C001A2D0 (HUBDSM_AcquiringPowerReferenceOnHubResume.c)
 * Callees:
