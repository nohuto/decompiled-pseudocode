/*
 * XREFs of HUBDTX_ValidateAndCacheProductIdStringDescriptor @ 0x1C00268B4
 * Callers:
 *     HUBDSM_ValidatingLanguageSpecificProductIdString @ 0x1C001B860 (HUBDSM_ValidatingLanguageSpecificProductIdString.c)
 * Callees:
