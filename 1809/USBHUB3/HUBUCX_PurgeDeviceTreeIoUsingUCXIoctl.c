/*
 * XREFs of HUBUCX_PurgeDeviceTreeIoUsingUCXIoctl @ 0x1C002335C
 * Callers:
 *     HUBDSM_PurgingDeviceTreeIoOnReEnumerationInUnConfigured @ 0x1C001E4A0 (HUBDSM_PurgingDeviceTreeIoOnReEnumerationInUnConfigured.c)
 * Callees:
