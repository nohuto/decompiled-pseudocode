/*
 * XREFs of HUBDESC_InternalValidatePlatformCapabilityDescriptor @ 0x1C0032194
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *a1 < 0x14u )
  {
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_DDD(v11, 2u, v14, 0x8Du, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v9, *a1, 20);
      goto LABEL_15;
    }
    *v5 = 2;
    *a3 = 20;
  ...
  if ( *a3 > v12 )
  {
    if ( *(_WORD *)a2 > 0x200u || *(_BYTE *)(a2 + 12) )
      *v5 = 2;
    WPP_RECORDER_SF_d(v11, 2u, 5u, 0x8Eu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v9);
    v15 = 253LL;
    goto LABEL_13;
  }
  v17 = a1[3];
  if ( v17 )
  {
    ...
    WPP_RECORDER_SF_d(v11, 2u, 5u, 0x8Fu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v17);
  ...
  {
    *v5 = 1;
    WPP_RECORDER_SF_(v11, 2u, 5u, 0x90u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
    v15 = 196LL;
LABEL_13:
    ...
    && *(_QWORD *)(a1 + 12) == *(_QWORD *)GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID.Data4 )
  {
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_(v11, 2u, 5u, 0x91u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
      v15 = 197LL;
      goto LABEL_13;
    }
    v18 = *a1;
...
LABEL_31:
      *v5 = 1;
      LODWORD(v33) = *a1;
      WPP_RECORDER_SF_d(v11, 2u, 5u, v19, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v33);
      v15 = 198LL;
      goto LABEL_13;
    }
    if ( ((v18 - 4) & 7) != 0 )
        ...
        do
        {
          if ( *(_DWORD *)v24 == *v22 )
          {
            ...
            *(_QWORD *)(*(_QWORD *)(a2 + 80) + 48LL) = 0LL;
            LODWORD(v33) = *v22;
            WPP_RECORDER_SF_d(v11, 2u, 5u, 0x94u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v33);
    ...
    {
LABEL_49:
      WPP_RECORDER_SF_(v11, 2u, 5u, 0x95u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
         ...
         && *(_QWORD *)(a1 + 12) == *(_QWORD *)GUID_USB_PLATFORM_FEATURES.Data4 )
  {
    if ( *a1 < 0x1Au )
    {
      *v5 = 1;
      LODWORD(v33) = *a1;
      WPP_RECORDER_SF_d(v11, 2u, 5u, 0x96u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v33);
      v15 = 250LL;
      goto LABEL_13;
    }
    v30 = a1[20];
    if ( v30 == 1 )
    {
      if ( *a1 != 26 )
      {
        *v5 = 1;
        LODWORD(v33) = *a1;
        WPP_RECORDER_SF_d(v11, 2u, 5u, 0x97u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v33);
        v15 = 247LL;
        goto LABEL_13;
      }
    }
    else if ( !v30 )
    {
      *v5 = 1;
      LODWORD(v33) = a1[20];
      WPP_RECORDER_SF_d(v11, 2u, 5u, 0x98u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v33);
      v15 = 249LL;
      goto LABEL_13;
    }
    v31 = *(_QWORD *)(a2 + 80);
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_(v11, 2u, 5u, 0x99u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
      v15 = 248LL;
      goto LABEL_13;
    }
    *(_QWORD *)(v31 + 56) = a1;
...
LABEL_15:
  ...
  {
    v10 = 0;
    WPP_RECORDER_SF_(v11, 2u, 5u, 0x9Au, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids);
  }
  return v10;
}
