/*
 * XREFs of HUBHTX_Get20PortChangeEvent @ 0x1C00042A8
 * Callers:
 *     HUBPSM20_EnablingInterruptsAndGettingPortEvent @ 0x1C000F840 (HUBPSM20_EnablingInterruptsAndGettingPortEvent.c)
 *     HUBPSM20_GettingPortChangeEventInSuspended @ 0x1C000FAD0 (HUBPSM20_GettingPortChangeEventInSuspended.c)
 * Callees:
...
LABEL_15:
  ...
  WPP_RECORDER_SF_(a1[179], 2u, 4u, v16, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids);
LABEL_19:
  *((_DWORD *)a1 + 2) = v10;
  if ( v10 == 3017 && (v4 & 1) == 0 )
  {
    ...
    WPP_RECORDER_SF_(a1[179], 2u, 4u, 0x51u, (__int64)&WPP_74185d68226e30ea568d483797443b73_Traceguids);
    if ( (BYTE2(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) & 1) != 0 )
      McTemplateK0qhhhqhhh(
        v14,
        v13,
