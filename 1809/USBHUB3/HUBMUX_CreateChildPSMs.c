/*
 * XREFs of HUBMUX_CreateChildPSMs @ 0x1C000D554
 * Callers:
 *     HUBHSM_CreatingChildPSMs @ 0x1C0007730 (HUBHSM_CreatingChildPSMs.c)
 * Callees:
...
__int64 __fastcall HUBMUX_CreateChildPSMs(__int64 a1)
{
  ...
  __int64 v24; // rax
  _QWORD *v25; // rax
  _QWORD v26[5]; // [rsp+48h] [rbp-19h] BYREF
  _QWORD v27[7]; // [rsp+70h] [rbp+Fh] BYREF
