/*
 * XREFs of HUBDESC_ValidateDeviceDescriptor @ 0x1C00349F4
 * Callers:
...
LABEL_50:
  ...
  {
    v9 = a5;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xF9u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, a2);
LABEL_6:
    v10 = 71LL;
    goto LABEL_3;
  }
  ...
  {
    LODWORD(v27) = v11;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xFBu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v27);
  ...
  {
    LODWORD(v27) = a2;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xFCu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v27);
    goto LABEL_6;
  }
  v12 = *((_WORD *)a1 + 6);
  ...
  {
    LODWORD(v27) = v12;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xFDu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v27);
  ...
  {
    LODWORD(v27) = v14;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xFEu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v27);
...
LABEL_26:
  ...
  if ( v16 )
  {
    switch ( v16 )
    {
      ...
      case 2:
        ...
        {
          LODWORD(v27) = v22;
          WPP_RECORDER_SF_d(a5, 2u, 5u, 0x102u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v27);
      ...
      case 3:
        ...
        {
          LODWORD(v27) = v25;
          WPP_RECORDER_SF_d(a5, 2u, 5u, 0x104u, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v27);
          (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 78LL);
  ...
  else
  {
    ...
    {
      LODWORD(v27) = v17;
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xFFu, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v27);
      (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 78LL);
...
LABEL_44:
        ...
        WPP_RECORDER_SF_d(a5, 2u, 5u, v20, (__int64)&WPP_78dee903e07d3ced2930c3a7d0bd69e9_Traceguids, v27);
        (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 78LL);
        v5 = 2;
      }
    }
