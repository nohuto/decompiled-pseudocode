/*
 * XREFs of ??$_Maklocstr@G@std@@YAPEAGPEBDPEAGAEBU_Cvtvec@@@Z @ 0x1800240AC
 * Callers:
 ...
 *     ??$_Getvals@G@?$_Mpunct@G@std@@IEAAXGPEBUlconv@@@Z @ 0x1800B43C4 (--$_Getvals@G@-$_Mpunct@G@std@@IEAAXGPEBUlconv@@@Z.c)
 ...
 * Callees:
 *     _Mbrtowc @ 0x1800AA200 (_Mbrtowc.c)
