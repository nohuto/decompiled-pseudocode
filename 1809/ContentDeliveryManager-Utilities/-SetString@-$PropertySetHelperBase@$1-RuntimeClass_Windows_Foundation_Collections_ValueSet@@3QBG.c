/*
 * XREFs of ?SetString@?$PropertySetHelperBase@$1?RuntimeClass_Windows_Foundation_Collections_ValueSet@@3QBGB@Triggers@CreativeFramework@@QEAAJPEBG0@Z @ 0x18002E644
 * Callers:
        ...
        const WCHAR *a3)
{
  ...
  v18 = 0LL;
  v5 = *(_QWORD *)(a1 + 8);
  v6 = *(_QWORD *)(Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v22, &v20) + 24);
  v7 = (*(__int64 (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v5 + 144LL))(v5, v6, &v18);
  v4 = v7;
  v23 = 0LL;
  if ( v7 < 0 )
  {
...
LABEL_5:
  ...
  v12 = v19;
  v13 = *(_QWORD *)(Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v24, v21) + 24);
  v9 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _BYTE *))(*(_QWORD *)v12 + 80LL))(v12, v13, v18, v17);
  v4 = v9;
  v25 = 0LL;
  if ( v9 < 0 )
  {
