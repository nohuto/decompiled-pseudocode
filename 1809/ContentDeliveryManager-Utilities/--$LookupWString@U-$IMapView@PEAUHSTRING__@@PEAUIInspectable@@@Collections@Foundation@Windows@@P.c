/*
 * XREFs of ??$LookupWString@U?$IMapView@PEAUHSTRING__@@PEAUIInspectable@@@Collections@Foundation@Windows@@PEBG@PropertySetHelper@@SA_NPEAU?$IMapView@PEAUHSTRING__@@PEAUIInspectable@@@Collections@Foundation@Windows@@PEBGAEAV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@Z @ 0x18009B0F0
 * Callers:
 *     ?PrefetchDisplayInfo@ContentDeliveryManagerAppInfo@ApplicationModel@Extensions@Internal@Windows@@AEAAXXZ @ 0x18009AB38 (-PrefetchDisplayInfo@ContentDeliveryManagerAppInfo@ApplicationModel@Extensions@Internal@Windows@.c)
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  _BYTE v23[24]; // [rsp+48h] [rbp-28h] BYREF
  ...
  *v6 = 0;
  ...
  v8 = *(_QWORD *)(Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v23, &v19) + 24);
  v9 = 0LL;
  v21 = 0LL;
  v18[0] = 0;
  if ( a1 )
  {
    v10 = (*(__int64 (__fastcall **)(__int64, __int64, _BYTE *))(*(_QWORD *)a1 + 64LL))(a1, v8, v18);
    v11 = retaddr;
    if ( v10 < 0 )
    {
LABEL_25:
    ...
    {
      v19 = 0LL;
      v12 = (*(__int64 (__fastcall **)(__int64, __int64, const WCHAR **))(*(_QWORD *)a1 + 48LL))(a1, v8, &v19);
      v13 = retaddr;
      if ( v12 < 0 )
      {
LABEL_26:
