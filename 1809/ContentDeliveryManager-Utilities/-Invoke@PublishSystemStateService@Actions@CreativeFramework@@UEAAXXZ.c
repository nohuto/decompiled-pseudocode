/*
 * XREFs of ?Invoke@PublishSystemStateService@Actions@CreativeFramework@@UEAAXXZ @ 0x180092B00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  v7 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD))(*(_QWORD *)v5 + 48LL))(
         v5,
         v6,
