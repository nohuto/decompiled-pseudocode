/*
 * XREFs of _Strcoll @ 0x1800C6028
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x1800C3DB0 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B3564 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B3570 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x1800B35F4 (__crtCompareStringA_Stub.c)
