/*
 * XREFs of ??$TaskUnregistered@PEB_WAEAY0CH@_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEB_WAEAY0CH@_WPEBD@Z @ 0x1800A8A18
 * Callers:
        ...
        const unsigned __int16 *a3)
{
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
    ...
    v23 = v13 + 1;
    v22 = a3;
    LODWORD(v6) = TlgWrite(v7, &unk_180165B8A, 0LL, 0LL, 5u, &pData);
  }
  return (int)v6;
}
