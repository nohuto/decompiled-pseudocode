/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800653E0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  else if ( *(_DWORD *)v5 > 5u )
  {
    ...
    v95 = v26 + 1;
    v96 = 0;
    TlgWrite(v6, &unk_180162255, (LPCGUID)(a1[6] + 8LL), 0LL, 0x13u, &pData);
  }
