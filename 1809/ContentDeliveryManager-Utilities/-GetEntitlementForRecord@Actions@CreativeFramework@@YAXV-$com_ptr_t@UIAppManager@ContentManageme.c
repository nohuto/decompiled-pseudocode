/*
 * XREFs of ?GetEntitlementForRecord@Actions@CreativeFramework@@YAXV?$com_ptr_t@UIAppManager@ContentManagement@@Uerr_exception_policy@wil@@@wil@@AEBQEB_W111_N@Z @ 0x180080A7C
 * Callers:
 ...
 *     ?IsMsaConnected@Actions@CreativeFramework@@YA_NXZ @ 0x180080500 (-IsMsaConnected@Actions@CreativeFramework@@YA_NXZ.c)
        ...
        char a6)
{
  ...
  if ( a6 )
    goto LABEL_7;
  if ( dword_180185310 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_180185310);
    if ( dword_180185310 == -1 )
    {
      byte_180185314 = CreativeFramework::Actions::IsMsaConnected(v10);
      Init_thread_footer(&dword_180185310);
    }
  }
  if ( !byte_180185314 )
LABEL_7:
