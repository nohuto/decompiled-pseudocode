/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800A0180
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<CreativeFramework::Logging::ShellPlacementLogging,1,70368744177664,5,_TlgReflectorTag_Param0IsProviderType>::NotifyFailure(
        __int64 a1,
        int *a2)
{
  int v3; // edx
  ...
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v7 + 3) & 0x600000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v140 = 2 * v11 + 2;
      v141 = 0;
      TlgWrite(v8, &unk_180163D4E, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
    }
  }
         ...
         && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v103 = v28 + 1;
    v104 = 0;
    TlgWrite(v8, &unk_1801638FB, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v61);
  }
