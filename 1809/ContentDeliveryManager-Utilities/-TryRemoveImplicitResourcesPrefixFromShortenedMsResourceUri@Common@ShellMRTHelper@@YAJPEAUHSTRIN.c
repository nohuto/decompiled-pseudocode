/*
 * XREFs of ?TryRemoveImplicitResourcesPrefixFromShortenedMsResourceUri@Common@ShellMRTHelper@@YAJPEAUHSTRING__@@PEAPEAG@Z @ 0x18009B370
 * Callers:
    ...
    for ( i = 0; i < 3; ++i )
    {
      ...
      if ( v10 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
          retaddr,
          (void *)0xC2,
          (__int64)"internal\\onecoreuapshell\\inc\\shellmrthelper.common.h",
