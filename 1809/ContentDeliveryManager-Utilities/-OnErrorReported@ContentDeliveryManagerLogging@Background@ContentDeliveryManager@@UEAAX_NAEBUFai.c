/*
 * XREFs of ?OnErrorReported@ContentDeliveryManagerLogging@Background@ContentDeliveryManager@@UEAAX_NAEBUFailureInfo@wil@@@Z @ 0x18001F920
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct wil::FailureInfo *a3)
{
    ...
    && (*((_QWORD *)v4 + 3) & 0x400000000000LL) == *((_QWORD *)v4 + 3) )
  {
    ...
    v73 = v7 + 1;
    v74 = 0;
    TlgWrite(v4, &unk_180161DC0, 0LL, 0LL, 0x13u, &pData);
  }
}
