/*
 * XREFs of _anonymous_namespace_::DecodeBatchIdFromCreativeId @ 0x180028888
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::SplitString @ 0x1800284D0 (_anonymous_namespace_--SplitString.c)
...
__int64 __fastcall anonymous_namespace_::DecodeBatchIdFromCreativeId(__int64 a1, _WORD *a2)
{
  ...
  void *v17[3]; // [rsp+90h] [rbp+Fh] BYREF
  unsigned __int64 v18; // [rsp+A8h] [rbp+27h]
