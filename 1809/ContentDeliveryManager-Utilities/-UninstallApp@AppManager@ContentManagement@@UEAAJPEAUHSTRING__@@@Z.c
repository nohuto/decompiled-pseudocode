/*
 * XREFs of ?UninstallApp@AppManager@ContentManagement@@UEAAJPEAUHSTRING__@@@Z @ 0x180054C70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _lambda_e2ad4dd96f48ff51f3e39c6a0eec3847_::operator() @ 0x180054F00 (_lambda_e2ad4dd96f48ff51f3e39c6a0eec3847_--operator().c)
...
__int64 __fastcall ContentManagement::AppManager::UninstallApp(ContentManagement::AppManager *this, HSTRING a2)
{
  ...
  int v18; // eax
  int v19; // edi
  HSTRING *v21; // [rsp+20h] [rbp-60h] BYREF
  int v22; // [rsp+28h] [rbp-58h] BYREF
  __int16 v23; // [rsp+2Ch] [rbp-54h]
  int v24; // [rsp+30h] [rbp-50h] BYREF
  __int16 v25; // [rsp+34h] [rbp-4Ch]
  int v26[2]; // [rsp+38h] [rbp-48h] BYREF
  int v27; // [rsp+40h] [rbp-40h]
  int v28; // [rsp+44h] [rbp-3Ch]
  int v29; // [rsp+48h] [rbp-38h]
  unsigned int v30[2]; // [rsp+50h] [rbp-30h] BYREF
  const char *v31; // [rsp+58h] [rbp-28h]
  __int64 v32; // [rsp+60h] [rbp-20h]
  __int16 v33; // [rsp+68h] [rbp-18h]
  __int64 v34; // [rsp+70h] [rbp-10h]
  wil::details::in1diag3 *retaddr; // [rsp+A8h] [rbp+28h]
  HSTRING v36; // [rsp+B8h] [rbp+38h] BYREF
  unsigned int v37; // [rsp+C0h] [rbp+40h]
  __int16 v38; // [rsp+C4h] [rbp+44h]
  signed __int32 v39; // [rsp+C8h] [rbp+48h] BYREF
