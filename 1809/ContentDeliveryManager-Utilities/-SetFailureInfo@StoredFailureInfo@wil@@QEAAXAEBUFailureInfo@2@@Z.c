/*
 * XREFs of ?SetFailureInfo@StoredFailureInfo@wil@@QEAAXAEBUFailureInfo@2@@Z @ 0x18000245C
 * Callers:
 *     ??0ResultException@wil@@QEAA@AEBUFailureInfo@1@@Z @ 0x180002788 (--0ResultException@wil@@QEAA@AEBUFailureInfo@1@@Z.c)
 ...
 * Callees:
 *     ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x180001ECC (-create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z.c)
