/*
 * XREFs of ??$use_facet@V?$messages@G@std@@@std@@YAAEBV?$messages@G@0@AEBVlocale@0@@Z @ 0x1800B4BFC
 * Callers:
 ...
 *     ?_Getcat@?$messages@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B6EA4 (-_Getcat@-$messages@G@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
