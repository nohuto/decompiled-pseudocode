/*
 * XREFs of ?GetFileTimeFromString@StringUtils@CommonHelper@CreativeFramework@@YA?AU_FILETIME@@PEB_W_N@Z @ 0x1800A55B8
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  std::wistringstream::wistringstream(v14, v18);
  if ( v20 >= 8 )
