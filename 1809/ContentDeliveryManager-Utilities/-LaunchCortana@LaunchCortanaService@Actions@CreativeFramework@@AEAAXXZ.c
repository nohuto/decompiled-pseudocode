/*
 * XREFs of ?LaunchCortana@LaunchCortanaService@Actions@CreativeFramework@@AEAAXXZ @ 0x180092F1C
 * Callers:
 *     ?Invoke@LaunchCortanaService@Actions@CreativeFramework@@UEAAXXZ @ 0x180092F10 (-Invoke@LaunchCortanaService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ??$ActivateInstance@UILockScreenRegistrySettingProvider@ContentManagement@@@wil@@YA?AV?$com_ptr_t@UILockScreenRegistrySettingProvider@ContentManagement@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x18009327C (--$ActivateInstance@UILockScreenRegistrySettingProvider@ContentManagement@@@wil@@YA-AV-$com_ptr_.c)
        ...
        CreativeFramework::Actions::LaunchCortanaService *this)
{
  ...
  void *v15[3]; // [rsp+60h] [rbp-268h] BYREF
  ...
  std::wstring::append((char *)v15, Src, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  if ( v14[0] )
...
LABEL_28:
  ...
  if ( v16 >= 8 )
    v8 = (void **)v15[0];
  v9 = (*(__int64 (__fastcall **)(LPVOID, void **))(*(_QWORD *)ppv + 24LL))(ppv, v8);
  if ( v9 < 0 )
  {
    wil::details::in1diag3::Throw_Hr(
      retaddr,
