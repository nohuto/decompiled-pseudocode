/*
 * XREFs of ?RegisterWnfTrigger@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x18006DA80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
          ...
          v15 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(
                  (__int64)v38,
                  (const WCHAR **)off_1800EACA0);
          v16 = *(_QWORD *)(Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v39, &v26) + 24);
