/*
 * XREFs of ??$TargetedContentTilesExtracted@IAEBQEB_W@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAX$$QEAIAEBQEB_W@Z @ 0x1800A12E4
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u )
  {
    ...
    v11 = 2 * v5 + 2;
    v12 = 0;
    LODWORD(v4) = TlgWrite(v4, &unk_1801658AF, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &pData);
  }
  return (int)v4;
}
