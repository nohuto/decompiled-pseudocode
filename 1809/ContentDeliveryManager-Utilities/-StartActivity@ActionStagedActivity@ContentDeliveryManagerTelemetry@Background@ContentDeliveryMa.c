/*
 * XREFs of ?StartActivity@ActionStagedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBG00@Z @ 0x18004C768
 * Callers:
        ...
        const unsigned __int16 *a4)
{
    ...
    && (*((_QWORD *)v8 + 3) & 0x200000000000LL) == *((_QWORD *)v8 + 3) )
  {
    ...
    TlgWrite(v8, &unk_180163A23, (LPCGUID)(v15 + 8), v16, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
