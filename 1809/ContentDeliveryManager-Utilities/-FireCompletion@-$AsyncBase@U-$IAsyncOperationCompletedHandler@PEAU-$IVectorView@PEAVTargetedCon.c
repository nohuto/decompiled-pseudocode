        ...
        __int64 a1)
{
  ...
  if ( *(_QWORD *)(a1 + 24) && _InterlockedIncrement((volatile signed __int32 *)(a1 + 16)) == 1 )
  {
    ...
    if ( (**(int (__fastcall ***)(__int64, GUID *, __int64 *))a1)(a1, &GUID_8db07c2e_d5b7_55b8_b29e_1853d3eac30a, &v13) >= 0 )
    {
      v12 = -2;
