/*
 * XREFs of ?SetInt64@?$PropertySetHelperBase@$1?RuntimeClass_Windows_Foundation_Collections_PropertySet@@3QB_WB@Triggers@CreativeFramework@@QEAAJPEB_W_J@Z @ 0x1800740B0
 * Callers:
...
LABEL_5:
  ...
  v10 = v17;
  v11 = *(_QWORD *)(Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v19, v18) + 24);
  v7 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _BYTE *))(*(_QWORD *)v10 + 80LL))(v10, v11, v16, v15);
  v4 = v7;
  v20 = 0LL;
  if ( v7 < 0 )
  {
