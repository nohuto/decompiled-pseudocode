/*
 * XREFs of ?EnumerateTriggerStateTransitions@Internal@TargetedContent@Services@Windows@@YAXPEB_WV?$function@$$A6A_NPEAUHSTRING__@@W4TargetedContentTriggerState@Internal@TargetedContent@Services@Windows@@1@Z@std@@@Z @ 0x180071588
 * Callers:
...
void __fastcall Windows::Services::TargetedContent::Internal::EnumerateTriggerStateTransitions(char *Src, __int64 a2)
{
  ...
  while ( v4 != (void **)v5 )
  {
    ...
    if ( *(_QWORD *)(v18[0] + 24) >= 8uLL )
      v6 = *(const WCHAR **)v18[0];
    v16 = v6;
    v7 = *(_QWORD *)(Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v25, &v16) + 24);
    Windows::Services::TargetedContent::Internal::DecodeBase64String(&string, v7);
    v26 = 0LL;
