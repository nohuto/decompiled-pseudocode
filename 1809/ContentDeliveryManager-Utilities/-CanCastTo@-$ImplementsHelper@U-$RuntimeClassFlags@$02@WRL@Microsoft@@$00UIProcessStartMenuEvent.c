/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00UIProcessStartMenuEvent@ContentManagement@@UIProcessContextualSuggestionsEvent@5@UILayoutResolver@5@UILockScreenRegistrySettingProvider@5@UITaskBarAppProperties@5@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x180022A10
 * Callers:
 *     ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$0A@UIInspectable@@VFtmBase@23@UIWeakReferenceSource@@UIProcessCreativeEvent@ContentManagement@@UIProcessLockScreenEvent@8@UIProcessStartMenuEvent@8@UIProcessContextualSuggestionsEvent@8@UILayoutResolver@8@UILockScreenRegistrySettingProvider@8@UITaskBarAppProperties@8@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x1800228F8 (-CanCastTo@-$ImplementsHelper@U-$RuntimeClassFlags@$02@WRL@Microsoft@@$0A@UIInspectable@@VFtmBas.c)
 * Callees:
 *     <none>
 */
