  ...
  if ( a4 )
  {
    ...
    if ( (a1[2] - v10) >> 3 >= a4 )
    {
      ...
      else
      {
        ...
        v21 = a1[1];
        a1[1] = v20 * 8 + v21;
        v22 = (v21 - (unsigned __int64)v6 + 7) >> 3;
        if ( (unsigned __int64)v6 > v21 )
          v22 = 0LL;
        if ( v22 )
          memset64(v6, (unsigned __int64)v19, v22);
      }
    }
    else
    {
      ...
      if ( v12 )
      {
        if ( v12 > 0x1FFFFFFFFFFFFFFFLL || (v15 = (char *)operator new(8 * v12), (v26 = v15) == 0LL) )
          std::_Xbad_alloc();
      }
      v16 = ((__int64)v6 - *a1) >> 3;
      try
