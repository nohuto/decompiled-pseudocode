/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x180065BDC
 * Callers:
  ...
  if ( a2 < 0 )
  {
    ...
    if ( v6 )
    {
        ...
        && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
      {
        ...
        v73 = 2 * v11 + 2;
        v74 = 0;
        TlgWrite(v8, &unk_180161FD5, (LPCGUID)(a1[6] + 8LL), 0LL, 0x10u, &pData);
      }
    }
           ...
           && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v84 = 2 * v28 + 2;
      v85 = 0;
      TlgWrite(v8, &unk_180162624, (LPCGUID)(v26 + 8), 0LL, 6u, &v75);
    }
  }
