/*
 * XREFs of ?StopActivity@TriggerManagerGetTriggeredItemsForStateActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@MEAAXXZ @ 0x180061970
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      v80 = v10 + 1;
      v81 = 0;
      TlgWrite(v6, &unk_18016462F, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 5u )
    {
      ...
      v31 = CurrentThreadId;
      v85 = &v31;
      TlgWrite(v26, &unk_18016446B, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v82);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
