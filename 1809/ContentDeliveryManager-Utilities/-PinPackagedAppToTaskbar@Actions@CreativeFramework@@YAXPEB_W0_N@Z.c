/*
 * XREFs of ?PinPackagedAppToTaskbar@Actions@CreativeFramework@@YAXPEB_W0_N@Z @ 0x18008D93C
 * Callers:
 ...
 *     ?PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z @ 0x18008D7B0 (-PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z.c)
