/*
 * XREFs of ?from_bytes@?$wstring_convert@V?$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV?$allocator@G@2@V?$allocator@D@2@@std@@QEAA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@PEBD0@Z @ 0x180049348
 * Callers:
        ...
        unsigned __int8 *a4)
{
  ...
  std::wstring::append((char *)v20, 8uLL, 0);
  *(_QWORD *)(a1 + 96) = 0LL;
  i = v13;
  if ( v13 == a4 )
  {
LABEL_19:
  ...
  while ( 1 )
  {
    ...
    if ( v22 >= 8 )
      v9 = (void **)v20[0];
    v10 = (*(__int64 (__fastcall **)(_QWORD, __int64, unsigned __int8 *, unsigned __int8 *, unsigned __int8 **, void **, unsigned __int64, unsigned __int64 *))(**(_QWORD **)(a1 + 8) + 48LL))(
            *(_QWORD *)(a1 + 8),
            a1 + 88,
            i,
            a4,
