/*
 * XREFs of ?ResolveRatingImage@ToastHelpers@NotificationManager@CreativeFramework@@AEAAXPEB_W@Z @ 0x180098A9C
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1800C6BE8 (__report_rangecheckfailure.c)
...
LABEL_20:
  ...
  if ( v7 < 0 )
  {
    ...
    JUMPOUT(0x180098C64LL);
  }
  v8 = *((_QWORD *)this + 7);
  pv = 0LL;
  v9 = (*(__int64 (__fastcall **)(__int64, _QWORD, LPVOID, LPVOID *))(*(_QWORD *)v8 + 64LL))(
         v8,
         *((_QWORD *)this + 8),
         v13[0],
         &pv);
