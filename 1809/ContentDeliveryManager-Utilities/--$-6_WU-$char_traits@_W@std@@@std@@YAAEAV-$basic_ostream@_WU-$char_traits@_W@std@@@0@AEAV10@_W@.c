/*
 * XREFs of ??$?6_WU?$char_traits@_W@std@@@std@@YAAEAV?$basic_ostream@_WU?$char_traits@_W@std@@@0@AEAV10@_W@Z @ 0x180096344
 * Callers:
 ...
 * Callees:
 *     ?clear@ios_base@std@@QEAAXH_N@Z @ 0x18002487C (-clear@ios_base@std@@QEAAXH_N@Z.c)
 *     ??0sentry@?$basic_ostream@_WU?$char_traits@_W@std@@@std@@QEAA@AEAV12@@Z @ 0x180074A28 (--0sentry@-$basic_ostream@_WU-$char_traits@_W@std@@@std@@QEAA@AEAV12@@Z.c)
...
LABEL_16:
        ...
        *v16 = 38;
        ...
        {
          v17 = *(int *)(*v1 + 4);
          v18 = *(_WORD *)((char *)v1 + v17 + 88);
          v19 = *(__int64 *)((char *)v1 + v17 + 72);
          if ( **(_QWORD **)(v19 + 64) )
            v20 = **(_DWORD **)(v19 + 88);
          else
            v20 = 0;
          if ( v20 <= 0 )
          {
            v18 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v19 + 24LL))(v19, v18);
          }
          else
          {
            --**(_DWORD **)(v19 + 88);
      ...
      else
      {
        while ( !v2 )
        {
          if ( v6 <= 0 )
            goto LABEL_16;
          v7 = *(int *)(*v1 + 4);
          v8 = *(_WORD *)((char *)v1 + v7 + 88);
          v9 = *(__int64 *)((char *)v1 + v7 + 72);
          if ( **(_QWORD **)(v9 + 64) )
            v10 = **(_DWORD **)(v9 + 88);
          else
            v10 = 0;
          if ( v10 <= 0 )
          {
            v8 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v9 + 24LL))(v9, v8);
          }
          else
          {
            --**(_DWORD **)(v9 + 88);
