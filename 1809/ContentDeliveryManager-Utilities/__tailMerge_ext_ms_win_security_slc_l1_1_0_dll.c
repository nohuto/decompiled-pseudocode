/*
 * XREFs of __tailMerge_ext_ms_win_security_slc_l1_1_0_dll @ 0x1800C76B9
 * Callers:
 *     __imp_load_SLGetWindowsInformationDWORD @ 0x1800C76AD (__imp_load_SLGetWindowsInformationDWORD.c)
 * Callees:
