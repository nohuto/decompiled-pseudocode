 ...
 *     <none>
 * Callees:
 *     _lambda_f5308eba5b5d373daf8d44e93255183c_::operator() @ 0x180059DE4 (_lambda_f5308eba5b5d373daf8d44e93255183c_--operator().c)
        ...
        __int64 *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v2 >= 0 )
  {
    v5 = lambda_f5308eba5b5d373daf8d44e93255183c_::operator()(v8);
    v2 = v5;
