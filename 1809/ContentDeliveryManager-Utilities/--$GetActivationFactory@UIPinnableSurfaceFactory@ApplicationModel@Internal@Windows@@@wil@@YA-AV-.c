/*
 * XREFs of ??$GetActivationFactory@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@@wil@@YA?AV?$com_ptr_t@UIPinnableSurfaceFactory@ApplicationModel@Internal@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x180096704
 * Callers:
        ...
        const WCHAR *a1)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  ActivationFactory = RoGetActivationFactory(*(_QWORD *)(v2 + 24), &GUID_f27684e4_e634_4807_be9a_4838381fcbfc, a1);
