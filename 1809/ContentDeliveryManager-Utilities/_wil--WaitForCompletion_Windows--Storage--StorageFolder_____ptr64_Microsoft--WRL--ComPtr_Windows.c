/*
 * XREFs of _wil::WaitForCompletion_Windows::Storage::StorageFolder_____ptr64_Microsoft::WRL::ComPtr_Windows::Storage::IStorageFolder____::_1_::dtor$0 @ 0x1800CD46B
 * Callers:
 *     <none>
 * Callees:
