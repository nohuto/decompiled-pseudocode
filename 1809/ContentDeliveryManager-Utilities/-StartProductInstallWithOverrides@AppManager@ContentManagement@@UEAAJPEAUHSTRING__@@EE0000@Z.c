/*
 * XREFs of ?StartProductInstallWithOverrides@AppManager@ContentManagement@@UEAAJPEAUHSTRING__@@EE0000@Z @ 0x180055330
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING a8)
{
  ...
  int v25; // eax
  int v26; // edi
  __int16 v28; // [rsp+2Ch] [rbp-95h]
  signed __int32 v29; // [rsp+34h] [rbp-8Dh] BYREF
  int v30; // [rsp+38h] [rbp-89h] BYREF
  __int16 v31; // [rsp+3Ch] [rbp-85h]
  int v32; // [rsp+40h] [rbp-81h] BYREF
  __int16 v33; // [rsp+44h] [rbp-7Dh]
  int v34[2]; // [rsp+48h] [rbp-79h] BYREF
  int v35; // [rsp+50h] [rbp-71h]
  int v36; // [rsp+54h] [rbp-6Dh]
  int v37; // [rsp+58h] [rbp-69h]
  unsigned int v38[2]; // [rsp+60h] [rbp-61h] BYREF
  const char *v39; // [rsp+68h] [rbp-59h]
  __int64 v40; // [rsp+70h] [rbp-51h]
  __int16 v41; // [rsp+78h] [rbp-49h]
  _QWORD v42[15]; // [rsp+80h] [rbp-41h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+100h] [rbp+3Fh]
  HSTRING v44; // [rsp+110h] [rbp+4Fh] BYREF
  char v45; // [rsp+118h] [rbp+57h] BYREF
  char v46; // [rsp+120h] [rbp+5Fh] BYREF
  ...
  v11 = ((__int64 (__fastcall *)(__int64, _QWORD))v10)(8553651LL, 0LL);
LABEL_7:
  v12 = v11 & 0x80;
  v13 = (v11 >> 6) & 1;
  v14 = v11 & 0xFFFFFF3F;
