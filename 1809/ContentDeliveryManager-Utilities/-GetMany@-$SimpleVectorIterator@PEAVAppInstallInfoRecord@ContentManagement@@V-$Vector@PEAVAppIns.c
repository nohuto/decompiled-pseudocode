        ...
        _DWORD *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v6 >= 0 )
  {
    ...
    while ( 1 )
    {
      v6 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, void *, _DWORD *))(**(_QWORD **)(a1 + 64) + 128LL))(
             *(_QWORD *)(a1 + 64),
             v8,
             v5,
             a3,
      ...
      if ( v6 < 0 )
        break;
      v10 = _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 72), v8 + *a4, v8);
      v9 = v8 == v10;
      v8 = v10;
      if ( v9 )
        break;
