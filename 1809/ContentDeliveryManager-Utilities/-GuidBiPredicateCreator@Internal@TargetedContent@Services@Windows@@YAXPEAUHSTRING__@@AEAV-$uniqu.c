/*
 * XREFs of ?GuidBiPredicateCreator@Internal@TargetedContent@Services@Windows@@YAXPEAUHSTRING__@@AEAV?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CoTaskMemFree@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAX$0A@$$T@details@wil@@@details@wil@@@wil@@PEAI@Z @ 0x18006D2A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
    ...
    JUMPOUT(0x18006D37ALL);
  }
  v8 = (GUID *)CoTaskMemAlloc(0x10uLL);
  v11 = v8;
  if ( !v8 )
  {
    wil::details::in1diag3::_Throw_NullAlloc(retaddr, (void *)0x110, v9, v10);
    goto LABEL_7;
  }
  *v8 = pclsid;
  *a3 = 16;
