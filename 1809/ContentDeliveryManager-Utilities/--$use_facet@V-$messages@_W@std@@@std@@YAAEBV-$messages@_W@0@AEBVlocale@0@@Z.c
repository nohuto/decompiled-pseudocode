/*
 * XREFs of ??$use_facet@V?$messages@_W@std@@@std@@YAAEBV?$messages@_W@0@AEBVlocale@0@@Z @ 0x1800B4D3C
 * Callers:
 ...
 *     ?_Getcat@?$messages@_W@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B6F6C (-_Getcat@-$messages@_W@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 *     _CxxThrowException_0 @ 0x1800C713B (_CxxThrowException_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800C7DF0 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=1
struct std::_Facet_base *__fastcall std::use_facet<std::messages<wchar_t>>(__int64 *a1)
{
  __int64 v2; // rsi
  ...
  v2 = std::_Facetptr<std::messages<wchar_t>>::_Psave;
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::messages<wchar_t>>::_Psave;
  v3 = std::messages<wchar_t>::id;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::messages<wchar_t>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::messages<wchar_t>>::_Psave = (__int64)v11;
