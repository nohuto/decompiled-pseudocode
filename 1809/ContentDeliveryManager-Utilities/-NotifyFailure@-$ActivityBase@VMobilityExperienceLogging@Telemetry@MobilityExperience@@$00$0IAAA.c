/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VMobilityExperienceLogging@Telemetry@MobilityExperience@@$00$0IAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800488F0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v7 + 3) & 0xA00000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v140 = 2 * v11 + 2;
      v141 = 0;
      TlgWrite(v8, &unk_180163101, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
    }
  }
         ...
         && (*((_QWORD *)v7 + 3) & 0x800000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v103 = v28 + 1;
    v104 = 0;
    TlgWrite(v8, &unk_18016325B, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v61);
  }
