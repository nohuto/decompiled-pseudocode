/*
 * XREFs of ?GetRootRegistrationSettingsForTriggerContainer@Internal@TargetedContent@Services@Windows@@YA?AV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@W4TargetedContentKnownTrigger@1234@@Z @ 0x18006F5F0
 * Callers:
        ...
        int a2)
{
  ...
  v4 = Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v12, v9);
  LOBYTE(v5) = 1;
  CreativeFramework::CommonHelper::SettingsContainer::CreateContainer(v3, a1, *(_QWORD *)(v4 + 24), v5, v8);
  v13 = 0LL;
  v6 = v11;
  if ( v11 )
  {
