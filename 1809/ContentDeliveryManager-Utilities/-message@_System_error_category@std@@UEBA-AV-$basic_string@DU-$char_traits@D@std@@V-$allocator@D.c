/*
 * XREFs of ?message@_System_error_category@std@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@H@Z @ 0x180005360
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Winerror_map@std@@YAPEBDH@Z @ 0x1800AA0D0 (-_Winerror_map@std@@YAPEBDH@Z.c)
 */
