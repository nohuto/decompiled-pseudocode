/*
 * XREFs of ??$?5_WU?$char_traits@_W@std@@_W@std@@YAAEAV?$basic_istream@_WU?$char_traits@_W@std@@@0@AEAV10@AEBU?$_Timeobj@_W@0@@Z @ 0x1800A5808
 * Callers:
  ...
  if ( std::wistream::_Ipfx(v3) )
  {
    ...
    try
    {
      *(_QWORD *)&v19 = 0LL;
      ...
      v22 = v19;
      v9 = *v3;
      *(_QWORD *)&v19 = *(__int64 *)((char *)v3 + *(int *)(*v3 + 4) + 72);
