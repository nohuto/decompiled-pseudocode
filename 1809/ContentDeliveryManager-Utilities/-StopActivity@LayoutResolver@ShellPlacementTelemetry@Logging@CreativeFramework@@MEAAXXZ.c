/*
 * XREFs of ?StopActivity@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@MEAAXXZ @ 0x18009C2A0
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x400000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v72 = 2 * v10 + 2;
      v73 = 0;
      TlgWrite(v7, &unk_180165A3B, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v25 + 3) & 0x400000000000LL) == *((_QWORD *)v25 + 3) )
    {
      ...
      v32 = CurrentThreadId;
      v77 = &v32;
      TlgWrite(v26, &unk_1801659FC, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v74);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
