 ...
 *     ??$make_shared@VPublishWindowsTipService@Actions@CreativeFramework@@PEB_WPEB_W@std@@YA?AV?$shared_ptr@VPublishWindowsTipService@Actions@CreativeFramework@@@0@$$QEAPEB_W0@Z @ 0x180092944 (--$make_shared@VPublishWindowsTipService@Actions@CreativeFramework@@PEB_WPEB_W@std@@YA-AV-$share.c)
...
_QWORD *__fastcall CreativeFramework::Actions::MakePublishWindowsTipService(_QWORD *a1, __int64 a2, _QWORD *a3)
{
  ...
  void **v10; // [rsp+28h] [rbp-29h] BYREF
  _QWORD v11[2]; // [rsp+30h] [rbp-21h] BYREF
  _BYTE v12[8]; // [rsp+40h] [rbp-11h] BYREF
  volatile signed __int32 *v13; // [rsp+48h] [rbp-9h]
  void *v14[3]; // [rsp+50h] [rbp-1h] BYREF
  unsigned __int64 v15; // [rsp+68h] [rbp+17h]
  void *v16[4]; // [rsp+70h] [rbp+1Fh] BYREF
