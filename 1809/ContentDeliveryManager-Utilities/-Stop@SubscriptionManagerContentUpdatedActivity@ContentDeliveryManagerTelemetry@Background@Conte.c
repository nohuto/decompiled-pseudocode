/*
 * XREFs of ?Stop@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIIII@Z @ 0x18003C9E0
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v8 + 3) & 0x200000000000LL) == *((_QWORD *)v8 + 3) )
    {
      ...
      v80 = 4LL;
      v82 = 4LL;
      TlgWrite(v9, &unk_180162B7F, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x14u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v27 + 3) & 0x200000000000LL) == *((_QWORD *)v27 + 3) )
    {
      ...
      v93 = 4LL;
      v95 = 4LL;
      TlgWrite(v28, &unk_180162EA9, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 8u, &v83);
    }
  }
