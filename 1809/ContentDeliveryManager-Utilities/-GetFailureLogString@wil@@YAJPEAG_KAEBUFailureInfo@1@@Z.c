/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x180001C6C
 * Callers:
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x1800027F0 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 ...
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$0 @ 0x1800C7EE1 (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$0.c)
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$3 @ 0x1800C7FB6 (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$3.c)
 * Callees:
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x180001C1C (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
