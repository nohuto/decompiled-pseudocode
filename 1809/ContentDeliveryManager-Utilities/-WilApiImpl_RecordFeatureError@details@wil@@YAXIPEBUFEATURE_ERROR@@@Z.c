/*
 * XREFs of ?WilApiImpl_RecordFeatureError@details@wil@@YAXIPEBUFEATURE_ERROR@@@Z @ 0x1800090C0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct FEATURE_ERROR *a3)
{
  ...
  if ( wil::details::g_featureStateManager )
  {
    ...
    if ( wil::details::FeatureStateManager::EnsureStateData((RTL_SRWLOCK *)&wil::details::g_featureStateManager)
      && wil::details_abi::FeatureStateData::RecordFeatureError(qword_180183148, v4, a2)
