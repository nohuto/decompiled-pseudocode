/*
 * XREFs of ?isTaskbarIconCreationBlockedByPolicy@Policy@Mobility@@YA_NXZ @ 0x18000AF68
 * Callers:
 *     _lambda_437d9aff03d6676e5c9009da627b8fcc_::operator() @ 0x18000B238 (_lambda_437d9aff03d6676e5c9009da627b8fcc_--operator().c)
 * Callees:
 *     ?IsPreventedByMdmOrPolicy@Policy@Mobility@@YA_NPEBG000K@Z @ 0x18000AE94 (-IsPreventedByMdmOrPolicy@Policy@Mobility@@YA_NPEBG000K@Z.c)
 */
