/*
 * XREFs of ?_Iput@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DPEAD_K@Z @ 0x1800AEDD4
 * Callers:
 *     ?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DJ@Z @ 0x1800B0870 (-do_put@-$num_put@DV-$ostreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-AV-$ostreambuf.c)
 *     ?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DK@Z @ 0x1800B0930 (-do_put@-$num_put@DV-$ostreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-A_ea_1800B0930.c)
 *     ?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DPEBX@Z @ 0x1800B0D50 (-do_put@-$num_put@DV-$ostreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-A_ea_1800B0D50.c)
 *     ?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@D_J@Z @ 0x1800B0E00 (-do_put@-$num_put@DV-$ostreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-A_ea_1800B0E00.c)
 *     ?do_put@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@D_K@Z @ 0x1800B0EC0 (-do_put@-$num_put@DV-$ostreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-A_ea_1800B0EC0.c)
 * Callees:
        ...
        size_t Size)
{
  ...
  *(_QWORD *)&v40 = v11;
  ...
  v12 = std::use_facet<std::ctype<char>>((__int64 *)&v40);
  if ( v11 )
  {
  ...
  *(_QWORD *)&v40 = v15;
  ...
  v16 = std::use_facet<std::numpunct<char>>((__int64 *)&v40);
  if ( v15 )
  {
  ...
  if ( (unsigned __int8)(*(_BYTE *)v18 - 1) <= 0x7Du )
  {
    ...
    for ( i = *(_BYTE *)v18; i != 127 && i > 0 && i < v9 - v10; i = *v22 )
    {
      v9 -= i;
      LOBYTE(v19) = v20;
      std::string::insert(v43, v9, 1LL, v19);
      v22 = (char *)v18 + 1;
      if ( *((char *)v18 + 1) <= 0 )
        v22 = (char *)v18;
      v18 = (void **)v22;
  ...
  else if ( v26 == 256 )
  {
    ...
    if ( v45 >= 0x10 )
      v30 = (unsigned __int8 *)v43[0];
    v31 = v10;
    if ( v10 )
    {
      do
      {
        std::ostreambuf_iterator<char>::operator=((__int64)&v40, *v30++);
        --v31;
      }
      while ( v31 );
      v27 = v40;
  ...
  else
  {
    ...
    *a3 = v27;
    ...
    if ( v45 >= 0x10 )
      v28 = (unsigned __int8 *)v43[0];
    v29 = v10;
    if ( v10 )
    {
      do
      {
        std::ostreambuf_iterator<char>::operator=((__int64)&v40, *v28++);
        --v29;
      }
      while ( v29 );
LABEL_55:
