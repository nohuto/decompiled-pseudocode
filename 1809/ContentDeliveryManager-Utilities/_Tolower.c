/*
 * XREFs of _Tolower @ 0x1800AB554
 * Callers:
 *     ?do_tolower@?$ctype@D@std@@MEBADD@Z @ 0x1800B11A0 (-do_tolower@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_tolower@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x1800B11C0 (-do_tolower@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
