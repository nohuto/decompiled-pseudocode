/*
 * XREFs of Windows::Services::TargetedContent::Internal::ExecuteActionOnTrigger__lambda_25fdd0f24a46fb884595cc4fd71754f0___ @ 0x180066660
 * Callers:
        ...
        __int64 a2)
{
  ...
  const char *v24; // r9
  __int64 result; // rax
  HSTRING v26; // [rsp+40h] [rbp-98h] BYREF
  HSTRING v27; // [rsp+48h] [rbp-90h] BYREF
  HSTRING v28; // [rsp+50h] [rbp-88h] BYREF
  HSTRING string; // [rsp+58h] [rbp-80h]
  HSTRING v30; // [rsp+60h] [rbp-78h] BYREF
  PCWSTR StringRawBuffer; // [rsp+68h] [rbp-70h] BYREF
  PCWSTR v32; // [rsp+70h] [rbp-68h] BYREF
  PCWSTR v33; // [rsp+78h] [rbp-60h] BYREF
  PCWSTR v34; // [rsp+80h] [rbp-58h] BYREF
  const WCHAR *v35; // [rsp+88h] [rbp-50h] BYREF
  const WCHAR *v36[9]; // [rsp+90h] [rbp-48h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+D8h] [rbp+0h]
  unsigned int v38; // [rsp+E0h] [rbp+8h] BYREF
  __int64 v39; // [rsp+E8h] [rbp+10h]
  HSTRING v40; // [rsp+F0h] [rbp+18h] BYREF
  HSTRING v41; // [rsp+F8h] [rbp+20h] BYREF
  ...
  try
  {
    ...
    else
    {
      WindowsDeleteString(0LL);
      v28 = 0LL;
      v4 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)a1 + 176LL))(a1, &v28);
      v5 = retaddr;
      if ( v4 >= 0 )
      {
        WindowsDeleteString(0LL);
        v27 = 0LL;
        v6 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)a1 + 192LL))(a1, &v27);
        v7 = retaddr;
        if ( v6 >= 0 )
        {
          WindowsDeleteString(0LL);
          v26 = 0LL;
          v8 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)a1 + 96LL))(a1, &v26);
          v9 = retaddr;
          if ( v8 >= 0 )
          {
            v41 = 0LL;
            WindowsDeleteString(0LL);
            v41 = 0LL;
            v10 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)a1 + 144LL))(a1, &v41);
            v11 = retaddr;
            if ( v10 >= 0 )
            {
              v40 = 0LL;
              WindowsDeleteString(0LL);
              v40 = 0LL;
              v12 = (*(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)a1 + 128LL))(a1, &v40);
              v13 = retaddr;
              if ( v12 >= 0 )
              {
                v14 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)a1 + 80LL))(a1, &v38);
                v15 = retaddr;
                if ( v14 >= 0 )
                {
                  v16 = (const WCHAR *)Windows::Services::TargetedContent::Internal::ResolveNameFromTrigger(v38);
                  ...
                  StringRawBuffer = WindowsGetStringRawBuffer(v18, 0LL);
                  WindowsGetStringRawBuffer(v19, 0LL);
                  v33 = WindowsGetStringRawBuffer(v20, 0LL);
                  v34 = WindowsGetStringRawBuffer(v21, 0LL);
                  v36[0] = WindowsGetStringRawBuffer(v22, 0LL);
                  v35 = v16;
                  v23 = v39;
                  v32 = WindowsGetStringRawBuffer(**(HSTRING **)(v39 + 8), 0LL);
                  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerRegisterActivity::TriggerRegistrationPreconditionFailed<wchar_t const * &,wchar_t const * &,wchar_t const * &,wchar_t const * &,wchar_t const *,wchar_t const * &>(
                    ...
                    &v32,
                    &StringRawBuffer,
                    (const unsigned __int16 *)(**(_QWORD **)(v23 + 16) + 8LL));
