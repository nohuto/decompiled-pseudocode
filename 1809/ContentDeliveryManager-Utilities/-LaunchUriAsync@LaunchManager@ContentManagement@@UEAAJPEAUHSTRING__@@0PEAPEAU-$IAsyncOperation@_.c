/*
 * XREFs of ?LaunchUriAsync@LaunchManager@ContentManagement@@UEAAJPEAUHSTRING__@@0PEAPEAU?$IAsyncOperation@_N@Foundation@Windows@@@Z @ 0x18000C530
 * Callers:
 *     <none>
 * Callees:
...
__int64 ContentManagement::LaunchManager::LaunchUriAsync(__int64 a1, ...)
{
  ...
  int v17; // eax
  int v18; // edi
  __int16 v20; // [rsp+2Ch] [rbp-45h]
  signed __int32 v21; // [rsp+34h] [rbp-3Dh] BYREF
  int v22; // [rsp+38h] [rbp-39h] BYREF
  __int16 v23; // [rsp+3Ch] [rbp-35h]
  int v24; // [rsp+40h] [rbp-31h] BYREF
  __int16 v25; // [rsp+44h] [rbp-2Dh]
  int v26[2]; // [rsp+48h] [rbp-29h] BYREF
  int v27; // [rsp+50h] [rbp-21h]
  int v28; // [rsp+54h] [rbp-1Dh]
  int v29; // [rsp+58h] [rbp-19h]
  _QWORD v30[3]; // [rsp+60h] [rbp-11h] BYREF
  unsigned int v31[2]; // [rsp+78h] [rbp+7h] BYREF
  const char *v32; // [rsp+80h] [rbp+Fh]
  __int64 v33; // [rsp+88h] [rbp+17h]
  __int16 v34; // [rsp+90h] [rbp+1Fh]
  ...
  _QWORD *v41; // [rsp+F0h] [rbp+7Fh] BYREF
  ...
  *v41 = 0LL;
  ...
  v3 = ((__int64 (__fastcall *)(__int64, _QWORD))v2)(7960589LL, 0LL);
LABEL_7:
  v4 = v3 & 0x80;
  v5 = (v3 >> 6) & 1;
  v6 = v3 & 0xFFFFFF3F;
