/*
 * XREFs of ?ExtractTargetedContentTilesInLayout@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXXZ @ 0x18009FE40
 * Callers:
        ...
        CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver *this)
{
  ...
  char v32[24]; // [rsp+A8h] [rbp+27h] BYREF
  ...
  v3 = Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v32, (const WCHAR **)&string);
  v20 = 0LL;
  v4 = RoActivateInstance(*(_QWORD *)(v3 + 24), &v20);
  if ( v4 < 0 )
  {
