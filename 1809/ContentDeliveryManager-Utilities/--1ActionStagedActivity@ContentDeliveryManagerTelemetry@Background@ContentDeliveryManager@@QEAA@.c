/*
 * XREFs of ??1ActionStagedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAA@XZ @ 0x18004C73C
 * Callers:
 *     __lambda_fb6889284f8c6875beea5ab05f2a2ddf_::operator()_::_1_::dtor$3 @ 0x1800CB2AB (__lambda_fb6889284f8c6875beea5ab05f2a2ddf_--operator()_--_1_--dtor$3.c)
 * Callees:
