/*
 * XREFs of ?NotifyForLockScreenUpdates@SetLockScreenHotspotsService@Actions@CreativeFramework@@AEAAJXZ @ 0x180093C98
 * Callers:
 ...
 *     ?Commit@SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAXXZ @ 0x180093920 (-Commit@SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
...
LABEL_7:
  ...
  v6 = v14;
  v7 = Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v16, (const WCHAR **)off_1800F1950);
...
LABEL_9:
  if ( v14 )
    (*(void (__fastcall **)(__int64 *, __int64))(*v14 + 16))(v14, *v14);
