        ...
        volatile signed __int32 **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    *a2 = 0LL;
    v3 = (*(__int64 (__fastcall **)(__int64, _QWORD, GUID *, volatile signed __int32 **))(*(_QWORD *)qword_1801851B0
                                                                                        + 40LL))(
           qword_1801851B0,
           *((unsigned int *)v4 + 1),
