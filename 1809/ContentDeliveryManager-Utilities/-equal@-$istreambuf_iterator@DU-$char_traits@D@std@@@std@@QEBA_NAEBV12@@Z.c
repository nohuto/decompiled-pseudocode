/*
 * XREFs of ?equal@?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QEBA_NAEBV12@@Z @ 0x1800B1334
 * Callers:
 ...
 *     ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEAM@Z @ 0x1800AFEE0 (-do_get@-$num_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-A_ea_1800AFEE0.c)
 *     ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEAN@Z @ 0x1800AFFE0 (-do_get@-$num_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-A_ea_1800AFFE0.c)
 ...
 *     ?do_get@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x1800C40A0 (-do_get@-$time_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-AV-$istreambu.c)
...
char __fastcall std::istreambuf_iterator<char>::equal(__int64 *a1, __int64 *a2)
{
  ...
  if ( !*((_BYTE *)a1 + 8) )
  {
    v5 = *a1;
    if ( !v5
      || ((v6 = **(unsigned __int8 ***)(v5 + 56)) == 0LL ? (v7 = 0) : (v7 = **(_DWORD **)(v5 + 80)),
          v7 <= 0 ? (v8 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v5 + 48LL))(v5)) : (v8 = *v6),
          v8 == -1) )
    {
      *a1 = 0LL;
    }
  ...
  if ( !*((_BYTE *)a2 + 8) )
  {
    v9 = *a2;
    if ( !*a2
      || ((v10 = **(unsigned __int8 ***)(v9 + 56)) == 0LL ? (v11 = 0) : (v11 = **(_DWORD **)(v9 + 80)),
          v11 <= 0 ? (v12 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v9 + 48LL))(v9)) : (v12 = *v10),
          v12 == -1) )
    {
      *a2 = 0LL;
    }
