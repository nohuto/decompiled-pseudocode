/*
 * XREFs of ?Stop@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18004F5D4
 * Callers:
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  if ( v5 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x200000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      p_SRWLock = &SRWLock;
      v17 = 4;
      TlgWrite(v6, &unk_180162A08, (LPCGUID)(a1[6] + 8LL), 0LL, 4u, &pData);
    }
  }
  else
  {
