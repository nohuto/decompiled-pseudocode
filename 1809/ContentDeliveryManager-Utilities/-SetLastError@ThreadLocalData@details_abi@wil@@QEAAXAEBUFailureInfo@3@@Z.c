/*
 * XREFs of ?SetLastError@ThreadLocalData@details_abi@wil@@QEAAXAEBUFailureInfo@3@@Z @ 0x180003F1C
 * Callers:
 ...
 * Callees:
 *     ??$WriteResultString@PEBG@details@wil@@YAPEAEPEAE0PEBGPEAPEBG@Z @ 0x180014A64 (--$WriteResultString@PEBG@details@wil@@YAPEAEPEAE0PEBGPEAPEBG@Z.c)
 *     ??$WriteResultString@PEBD@details@wil@@YAPEAEPEAE0PEBDPEAPEBD@Z @ 0x180014B24 (--$WriteResultString@PEBD@details@wil@@YAPEAEPEAE0PEBDPEAPEBD@Z.c)
 */
...
LABEL_14:
          ...
          *((_WORD *)this + 17) = ((unsigned int)*((unsigned __int16 *)this + 17) + 1)
          ...
          v14 = -1LL;
          v15 = *((_QWORD *)this + 3) + 80LL * *((unsigned __int16 *)this + 17);
          *(_DWORD *)(v15 + 4) = v13 + 1;
          ...
          *(_QWORD *)(v15 + 32) = 0LL;
          *(_QWORD *)(v15 + 40) = *((_QWORD *)a2 + 16);
          *(_QWORD *)(v15 + 48) = *((_QWORD *)a2 + 17);
          *(_QWORD *)(v15 + 56) = 0LL;
          v16 = *((_QWORD *)a2 + 6);
          if ( v16 )
          {
          ...
          v23 = v17 + v22 + v11;
          if ( !*(_QWORD *)(v15 + 64) || *(_QWORD *)(v15 + 72) < v23 )
          {
            v24 = GetProcessHeap();
          ...
          if ( v27 )
          {
            v28 = v27 + *(_QWORD *)(v15 + 72);
            v29 = wil::details::WriteResultString<char const *>(v27, v28, *((_QWORD *)a2 + 6), v15 + 16);
            v30 = (void *)wil::details::WriteResultString<char const *>(v29, v28, *((_QWORD *)a2 + 15), v15 + 32);
