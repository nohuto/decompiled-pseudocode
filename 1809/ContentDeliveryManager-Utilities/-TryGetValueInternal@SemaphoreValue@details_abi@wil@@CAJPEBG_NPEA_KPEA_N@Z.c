/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x180003C54
 * Callers:
...
LABEL_20:
  ...
  if ( !CloseHandle(v17) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x90E, v19, v20);
    __debugbreak();
  }
LABEL_21:
  if ( v11 && !CloseHandle(v11) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x90E, v23, v24);
    __debugbreak();
  }
  return LastError;
}
