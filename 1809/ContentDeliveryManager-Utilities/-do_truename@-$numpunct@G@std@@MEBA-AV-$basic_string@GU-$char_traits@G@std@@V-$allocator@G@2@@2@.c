/*
 * XREFs of ?do_truename@?$numpunct@G@std@@MEBA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@XZ @ 0x1800303E0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::numpunct<unsigned short>::do_truename(__int64 a1, _QWORD *a2)
{
  _WORD *v3; // rdx
  __int64 v4; // rax
