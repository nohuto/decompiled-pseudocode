/*
 * XREFs of ?WilApiImpl_GetFeatureEnabledState@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@@Z @ 0x180008EE0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum FEATURE_CHANGE_TIME a3)
{
  ...
  if ( (*v5 & 3) != 1 )
  {
    IsFeatureConfigured = wil::details::IsFeatureConfigured((struct wil_FeatureState *)v12, v4, v6, v9, v5);
    v7 = v13;
