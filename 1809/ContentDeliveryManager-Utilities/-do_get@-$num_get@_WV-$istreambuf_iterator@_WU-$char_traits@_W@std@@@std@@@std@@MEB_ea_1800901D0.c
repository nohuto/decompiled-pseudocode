/*
 * XREFs of ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEA_N@Z @ 0x1800901D0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  if ( (*(_DWORD *)(a5 + 24) & 0x4000) != 0 )
  {
    ...
    std::wstring::append((char *)v28, v30, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    if ( v31 >= 8 )
