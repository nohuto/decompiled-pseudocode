/*
 * XREFs of ?replace@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAAEAV12@_K0AEBV12@00@Z @ 0x1800757D4
 * Callers:
...
LABEL_17:
  ...
  if ( Src != v7 )
  {
    ...
    if ( v16 )
    {
      memmove_0((char *)v22 + 2 * a2 + 2 * v13, (char *)v21 + 2 * (_QWORD)&a3[a2], 2LL * (_QWORD)v16);
      v20 = Src[3];
    }
    if ( v7[3] >= 8uLL )
      v7 = (_QWORD *)*v7;
  ...
  if ( v13 > (unsigned __int64)a3 )
  {
    if ( a5 > a2 )
    {
      ...
      if ( (unsigned __int64)&a3[a2] > a5 )
      {
        ...
        if ( a3 )
        {
          memmove_0((char *)v39 + 2 * a2, (char *)v38 + 2 * a5, 2LL * (_QWORD)a3);
          v20 = Src[3];
        }
        if ( v20 < 8 )
          v40 = Src;
        ...
        if ( v16 )
        {
          memmove_0((char *)v41 + 2 * a2 + 2 * v13, (char *)v40 + v42, 2LL * (_QWORD)v16);
          v20 = Src[3];
        }
        if ( v20 < 8 )
          v43 = Src;
      ...
      if ( v16 )
      {
        memmove_0((char *)v37 + 2 * a2 + 2 * v13, (char *)v36 + 2 * (_QWORD)v35, 2LL * (_QWORD)v16);
        v20 = Src[3];
      }
      if ( v20 < 8 )
        v33 = Src;
    ...
    else
    {
      ...
      if ( v16 )
      {
        memmove_0((char *)v32 + 2 * a2 + 2 * v13, (char *)v31 + 2 * (_QWORD)&a3[a2], 2LL * (_QWORD)v16);
        v20 = Src[3];
      }
      if ( v20 < 8 )
        v33 = Src;
  ...
  if ( v13 )
  {
    memmove_0((char *)v25 + 2 * a2, (char *)v24 + 2 * a5, 2 * v13);
    v20 = Src[3];
  }
  if ( v20 < 8 )
    v26 = Src;
