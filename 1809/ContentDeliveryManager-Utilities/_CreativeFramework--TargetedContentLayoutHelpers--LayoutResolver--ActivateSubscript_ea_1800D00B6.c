/*
 * XREFs of _CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver::ActivateSubscription_::_1_::dtor$5 @ 0x1800D00B6
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver::ActivateSubscription_::_1_::dtor_5(
        __int64 a1,
        __int64 a2)
{
  _QWORD *result; // rax
