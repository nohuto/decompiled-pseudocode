/*
 * XREFs of ??$YourPhoneTaskbarIconCreated@AEAW4TaskbarPinReason@Pinning@Mobility@@@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@SAXAEAW4TaskbarPinReason@Pinning@Mobility@@@Z @ 0x180015004
 * Callers:
        ...
        int *a1)
{
  ...
  if ( *(_DWORD *)v2 > 5u )
  {
      ...
      && (*((_QWORD *)v3 + 3) & 0x800000000000LL) == *((_QWORD *)v3 + 3) )
    {
      ...
      v8 = &v6;
      v9 = 4;
      LODWORD(v2) = TlgWrite(v3, &unk_180161D0B, 0LL, 0LL, 3u, &pData);
    }
  }
  return (int)v2;
}
