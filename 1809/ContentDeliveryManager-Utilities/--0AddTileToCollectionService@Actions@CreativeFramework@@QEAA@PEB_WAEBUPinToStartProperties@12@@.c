/*
 * XREFs of ??0AddTileToCollectionService@Actions@CreativeFramework@@QEAA@PEB_WAEBUPinToStartProperties@12@@Z @ 0x1800850FC
 * Callers:
        ...
        void **a3)
{
  ...
  _QWORD *v21; // rcx
  __int64 v22; // rdx
  _QWORD *v24; // [rsp+38h] [rbp-59h] BYREF
  ...
  char v31[24]; // [rsp+90h] [rbp-1h] BYREF
...
LABEL_9:
  ...
  *((_BYTE *)this + 8) = v15 == 0;
  ...
  v24 = 0LL;
  v19 = (*(__int64 (__fastcall **)(__int64, _QWORD, HSTRING, _QWORD **))(*(_QWORD *)v17 + 48LL))(
          v17,
          *(_QWORD *)(v18 + 24),
          string,
          &v24);
