 ...
 *     ??$make_shared@VAppUninstallService@Actions@CreativeFramework@@PEB_W@std@@YA?AV?$shared_ptr@VAppUninstallService@Actions@CreativeFramework@@@0@$$QEAPEB_W@Z @ 0x180082708 (--$make_shared@VAppUninstallService@Actions@CreativeFramework@@PEB_W@std@@YA-AV-$shared_ptr@VApp.c)
...
_QWORD *__fastcall CreativeFramework::Actions::MakeAppUninstallService(_QWORD *a1)
{
  ...
  void *v9[4]; // [rsp+40h] [rbp-38h] BYREF
