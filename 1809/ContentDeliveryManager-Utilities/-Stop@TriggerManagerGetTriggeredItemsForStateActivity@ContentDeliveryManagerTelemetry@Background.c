/*
 * XREFs of ?Stop@TriggerManagerGetTriggeredItemsForStateActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIPEBD@Z @ 0x180062044
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v7 )
  {
    ...
    if ( *(_DWORD *)v9 > 5u )
    {
      ...
      v89 = a3;
      v90 = v12 + 1;
      TlgWrite(v9, &unk_1801644CB, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x15u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v30 > 5u )
    {
      ...
      if ( !a3 )
        a3 = (const char *)&word_1800F8406;
      v99 = a3;
      TlgWrite(v30, &unk_1801642F9, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 6u, &v92);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
