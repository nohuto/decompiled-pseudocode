/*
 * XREFs of ??$ReportPlacementHealth@PEBGG_KAEBEPEBGPEBG@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEBG$$QEAG$$QEA_KAEBE00PEBD@Z @ 0x180034C48
 * Callers:
        ...
        const unsigned __int16 *a7)
{
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
      ...
      && (*((_QWORD *)v11 + 3) & 0x800000000000LL) == *((_QWORD *)v11 + 3) )
    {
      ...
      v36 = v14 + 1;
      v35 = v17;
      LODWORD(v10) = TlgWrite(v11, &unk_1801626CD, 0LL, 0LL, 9u, &pData);
    }
  }
  return (int)v10;
}
