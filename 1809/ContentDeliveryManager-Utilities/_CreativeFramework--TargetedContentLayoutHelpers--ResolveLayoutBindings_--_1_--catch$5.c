/*
 * XREFs of _CreativeFramework::TargetedContentLayoutHelpers::ResolveLayoutBindings_::_1_::catch$5 @ 0x1800CFE8D
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CreativeFramework::TargetedContentLayoutHelpers::ResolveLayoutBindings_::_1_::catch_5(
        wil *a1,
        _DWORD *a2,
        unsigned int a3)
{
