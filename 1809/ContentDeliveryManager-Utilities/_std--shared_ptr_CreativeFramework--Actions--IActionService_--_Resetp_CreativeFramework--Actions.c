/*
 * XREFs of _std::shared_ptr_CreativeFramework::Actions::IActionService_::_Resetp_CreativeFramework::Actions::SetLockScreenHotspotsService__::_1_::catch$1 @ 0x1800CDE82
 * Callers:
 *     <none>
 * Callees:
