        ...
        __int64 *a5)
{
  ...
  {
    v10 = a1[1];
    if ( (__int64)(a1[2] - v10) >> 3 >= a4 )
    {
      v19 = *a5;
      v20 = 8 * a4;
      if ( (__int64)(v10 - a3) >> 3 >= a4 )
      {
        v23 = (__int64 *)(v10 - v20);
        a1[1] = (unsigned __int64)std::_Uninit_move<std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0> *,std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0> *,std::_Wrap_alloc<std::allocator<std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0>>>,std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0>>(
                                    v10 - v20,
                                    v10,
                                    (_QWORD *)a1[1]);
        while ( v23 != v6 )
        {
          --v23;
          v23[(unsigned __int64)v20 / 8] = *v23;
        }
        v24 = &v6[(unsigned __int64)v20 / 8];
        while ( v6 != v24 )
          *v6++ = v19;
      }
      else
    ...
    else
    {
      ...
      a1[2] = (unsigned __int64)&v15[8 * v12];
      a1[1] = (unsigned __int64)&v15[8 * v18];
