/*
 * XREFs of ??$use_facet@V?$codecvt@GDH@std@@@std@@YAAEBV?$codecvt@GDH@0@AEBVlocale@0@@Z @ 0x1800B46FC
 * Callers:
 ...
 * Callees:
 *     ?_Getcat@?$codecvt@GDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x18004401C (-_Getcat@-$codecvt@GDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
...
struct std::_Facet_base *__fastcall std::use_facet<std::codecvt<unsigned short,char,int>>(__int64 *a1)
{
  __int64 v2; // rsi
  ...
  v2 = std::_Facetptr<std::codecvt<unsigned short,char,int>>::_Psave;
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::codecvt<unsigned short,char,int>>::_Psave;
  v3 = std::codecvt<unsigned short,char,int>::id;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::codecvt<unsigned short,char,int>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::codecvt<unsigned short,char,int>>::_Psave = (__int64)v11;
