 ...
 *     ??1?$basic_istringstream@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@UEAA@XZ @ 0x18002EBFC (--1-$basic_istringstream@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@UEAA@XZ.c)
 ...
 *     ??0?$basic_istringstream@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAA@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@1@H@Z @ 0x18008F2F4 (--0-$basic_istringstream@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEAA@AEBV-$basic_strin.c)
 *     ??5?$basic_istream@_WU?$char_traits@_W@std@@@std@@QEAAAEAV01@AEA_K@Z @ 0x18008F3EC (--5-$basic_istream@_WU-$char_traits@_W@std@@@std@@QEAAAEAV01@AEA_K@Z.c)
 *     ?_Delete@?$unique_ptr@VToastHelpers@NotificationManager@CreativeFramework@@U?$default_delete@VToastHelpers@NotificationManager@CreativeFramework@@@std@@@std@@AEAAXXZ @ 0x18008F5AC (-_Delete@-$unique_ptr@VToastHelpers@NotificationManager@CreativeFramework@@U-$default_delete@VTo.c)
 *     ??$_Copy@U?$integral_constant@_N$0A@@std@@@?$_Tree@V?$_Tmap_traits@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@U?$less@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@@2@$0A@@std@@@std@@IEAAXAEBV01@U?$integral_constant@_N$0A@@1@@Z @ 0x180091A1C (--$_Copy@U-$integral_constant@_N$0A@@std@@@-$_Tree@V-$_Tmap_traits@V-$basic_string@_WU-$char_tra.c)
        ...
        __int64 a3)
{
  ...
  _BYTE v32[144]; // [rsp+68h] [rbp-A0h] BYREF
  _QWORD v33[12]; // [rsp+F8h] [rbp-10h] BYREF
  void *v34[2]; // [rsp+158h] [rbp+50h] BYREF
  __int64 v35; // [rsp+168h] [rbp+60h]
  unsigned __int64 v36; // [rsp+170h] [rbp+68h]
  LPCWCH lpString2[3]; // [rsp+178h] [rbp+70h] BYREF
  unsigned __int64 v38; // [rsp+190h] [rbp+88h]
  void *v39[3]; // [rsp+198h] [rbp+90h] BYREF
  unsigned __int64 v40; // [rsp+1B0h] [rbp+A8h]
  ...
  *(_BYTE *)(a1 + 8) = *a2;
  ...
  v10 = -1LL;
  if ( (void **)(a1 + 16) != v9 )
    std::wstring::assign((void **)(a1 + 16), v9, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  if ( v7 != a3 )
  {
  ...
  v35 = 0LL;
  LOWORD(v34[0]) = 0;
  std::wstring::assign(v34, (char *)L"entityId", aEntityid_0[0] != 0 ? 8 : 0);
  ...
  wil::details::in1diag3::Throw_HrIfMsg(
    ...
    v26);
  if ( v6 != v12 + 64 )
    std::wstring::assign((void **)(a1 + 48), (void **)v12 + 8, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  v36 = 7LL;
  v35 = 0LL;
  LOWORD(v34[0]) = 0;
  std::wstring::assign(v34, (char *)L"ctx.contentId", aCtxContentid[0] != 0 ? 0xD : 0);
  v13 = *std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::find(
           a1 + 120,
           &v26,
           v34);
  if ( v36 >= 8 )
  ...
  v35 = 0LL;
  LOWORD(v34[0]) = 0;
  std::wstring::assign(v34, (char *)L"useAbsoluteExpiration", aUseabsoluteexp[0] != 0 ? 0x15 : 0);
  v14 = *std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::find(
           a1 + 120,
           &v26,
           v34);
  if ( v36 >= 8 )
    operator delete(v34[0]);
  if ( v14 != *(_QWORD *)v7 && std::operator==<wchar_t>((_QWORD *)(v14 + 64), L"true") )
  {
    v36 = 7LL;
    v35 = 0LL;
    LOWORD(v34[0]) = 0;
    std::wstring::assign(v34, (char *)L"ctx.expiration", aCtxExpiration[0] != 0 ? 0xE : 0);
    v16 = *std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::find(
             a1 + 120,
             &v26,
             v34);
    if ( v36 >= 8 )
    ...
    if ( v16 != *(_QWORD *)v7 )
    {
      std::wistringstream::wistringstream(v32, v16 + 64);
      std::wistream::operator>>(v32, a1 + 112);
      std::wistringstream::~wistringstream((__int64)v33);
      v33[0] = &std::ios_base::`vftable';
      std::ios_base::_Ios_base_dtor((struct std::ios_base *)v33);
    }
  }
  v36 = 7LL;
  v35 = 0LL;
  LOWORD(v34[0]) = 0;
  std::wstring::assign(v34, (char *)L"notificationGroup", aNotificationgr[0] != 0 ? 0x11 : 0);
  ...
  if ( v17 == *(_QWORD *)v7 )
  {
    ...
    v35 = 0LL;
    LOWORD(v34[0]) = 0;
    std::wstring::assign(v34, (char *)&Src, 0LL);
    v18 = v34;
    v19 = 2;
  }
  else
  {
    ...
    v39[2] = 0LL;
    LOWORD(v39[0]) = 0;
    std::wstring::assign(v39, (void **)(v17 + 64), 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    v18 = v39;
    v19 = 1;
  }
  v38 = 7LL;
  ...
  std::wstring::_Assign_rv(lpString2, v18);
  if ( (v19 & 2) != 0 )
  {
    v19 &= ~2u;
    if ( v36 >= 8 )
  ...
  if ( v38 >= 8 )
    v20 = lpString2[0];
  v21 = off_1800F1930;
  while ( CompareStringOrdinal(*v21, -1, v20, -1, 1) != 2 )
  {
    v21 += 2;
    if ( v21 == off_1800F1950 )
    {
      v22 = (char *)L"Windows.SystemToast.Suggested";
      goto LABEL_42;
    }
  }
  v22 = (char *)v21[1];
LABEL_42:
  ...
  std::wstring::assign((_QWORD *)(a1 + 80), v22, v10);
  ...
  if ( v23 )
  {
    ...
    *((_QWORD *)v24 + 7) = 0LL;
    *((_QWORD *)v24 + 8) = 0LL;
    CreativeFramework::NotificationManager::ToastHelpers::InitializeNotificationTemplate((CreativeFramework::NotificationManager::ToastHelpers *)v24);
    CreativeFramework::NotificationManager::ToastHelpers::EnforceSchemaAndValidate((CreativeFramework::NotificationManager::ToastHelpers *)v24);
  }
  else
  {
    v24 = 0LL;
  ...
  std::unique_ptr<CreativeFramework::NotificationManager::ToastHelpers>::_Delete(&v26);
  if ( v38 >= 8 )
