/*
 * XREFs of ??$TriggerRegistrationPreconditionFailed@AEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WPEB_WAEAPEB_W@TriggerManagerRegisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEAPEB_W000$$QEAPEB_W0PEBD@Z @ 0x180066438
 * Callers:
        ...
        const unsigned __int16 *a7)
{
  ...
  if ( *(_DWORD *)v11 > 5u )
  {
      ...
      && (*((_QWORD *)v12 + 3) & 0x200000000000LL) == *((_QWORD *)v12 + 3) )
    {
      ...
      v45 = v15 + 1;
      v44 = v23;
      LODWORD(v11) = TlgWrite(v12, &unk_180164BB0, 0LL, 0LL, 9u, &pData);
    }
  }
  return (int)v11;
}
