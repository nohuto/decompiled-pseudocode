        ...
        __int64 a2)
{
  ...
  else if ( _InterlockedIncrement((volatile signed __int32 *)(a1 + 20)) == 1 )
  {
    ...
    {
      v18 = 0LL;
      AgileReference = RoGetAgileReference(0LL, &GUID_08f0b54e_7aba_5ce4_bf52_79368d04b857, a2, &v18);
      if ( AgileReference < 0 )
      {
        v7 = v18;
      }
