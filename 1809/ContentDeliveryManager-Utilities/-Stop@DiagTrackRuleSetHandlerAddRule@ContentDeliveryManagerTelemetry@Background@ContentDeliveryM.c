/*
 * XREFs of ?Stop@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBD@Z @ 0x180077598
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v6 )
  {
    ...
    if ( *(_DWORD *)v8 > 5u )
    {
      ...
      v86 = a2;
      v87 = v11 + 1;
      TlgWrite(v8, &unk_180165317, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x14u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v29 > 5u )
    {
      ...
      if ( !a2 )
        a2 = (const char *)&word_1800F8406;
      v94 = a2;
      TlgWrite(v29, &unk_180164F91, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v89);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
