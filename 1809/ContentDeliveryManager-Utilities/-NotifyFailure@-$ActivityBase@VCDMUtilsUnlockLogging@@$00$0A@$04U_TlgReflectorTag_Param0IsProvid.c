/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x18007CAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v140 = 2 * v11 + 2;
      v141 = 0;
      TlgWrite(v8, &unk_180162416, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else if ( *(_DWORD *)v7 > 5u )
  {
    ...
    v103 = v28 + 1;
    v104 = 0;
    TlgWrite(v8, &unk_180162255, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v61);
  }
