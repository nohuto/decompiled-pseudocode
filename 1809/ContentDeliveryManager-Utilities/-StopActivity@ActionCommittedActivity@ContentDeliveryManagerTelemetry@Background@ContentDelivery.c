/*
 * XREFs of ?StopActivity@ActionCommittedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@MEAAXXZ @ 0x18004CEA0
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x200000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v69 = 2 * v10 + 2;
      v70 = 0;
      TlgWrite(v7, &unk_1801636E0, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v25 + 3) & 0x200000000000LL) == *((_QWORD *)v25 + 3) )
    {
      ...
      v29 = CurrentThreadId;
      v74 = &v29;
      TlgWrite(v26, &unk_180163652, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v71);
    }
  }
