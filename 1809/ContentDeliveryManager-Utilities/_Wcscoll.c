/*
 * XREFs of _Wcscoll @ 0x1800C6180
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x1800BCAE0 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B3564 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B3570 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x1800B3600 (__crtCompareStringW_Stub.c)
 */
