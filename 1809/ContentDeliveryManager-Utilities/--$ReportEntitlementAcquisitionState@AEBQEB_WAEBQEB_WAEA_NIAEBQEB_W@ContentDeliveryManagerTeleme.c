/*
 * XREFs of ??$ReportEntitlementAcquisitionState@AEBQEB_WAEBQEB_WAEA_NIAEBQEB_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEBQEB_W0AEA_N$$QEAI0@Z @ 0x180082368
 * Callers:
        ...
        const WCHAR **a5)
{
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
      ...
      && (*((_QWORD *)v10 + 3) & 0x400000000000LL) == *((_QWORD *)v10 + 3) )
    {
      ...
      v30 = 2 * v13 + 2;
      v31 = 0;
      LODWORD(v9) = TlgWrite(v10, &unk_18016580F, 0LL, 0LL, 7u, &pData);
    }
  }
  return (int)v9;
}
