/*
 * XREFs of ??$GetActivationFactory@UIJsonObjectStatics@Json@Data@Windows@@@wil@@YA?AV?$com_ptr_t@UIJsonObjectStatics@Json@Data@Windows@@Uerr_exception_policy@wil@@@0@PEBG@Z @ 0x180049A38
 * Callers:
...
const WCHAR *__fastcall wil::GetActivationFactory<Windows::Data::Json::IJsonObjectStatics>(const WCHAR *a1)
{
  ...
  v6[2] = a1;
  v6[0] = L"Windows.Data.Json.JsonObject";
  *(_QWORD *)a1 = 0LL;
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  ActivationFactory = RoGetActivationFactory(*(_QWORD *)(v2 + 24), &GUID_2289f159_54de_45d8_abcc_22603fa066a0, a1);
