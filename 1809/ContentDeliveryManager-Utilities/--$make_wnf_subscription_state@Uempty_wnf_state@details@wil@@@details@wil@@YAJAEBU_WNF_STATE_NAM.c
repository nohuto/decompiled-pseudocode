/*
 * XREFs of ??$make_wnf_subscription_state@Uempty_wnf_state@details@wil@@@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXXZ@wistd@@KPEAPEAU?$wnf_subscription_state@Uempty_wnf_state@details@wil@@@01@@Z @ 0x180042CB4
 * Callers:
 ...
 *     ?Return_NtStatus@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z @ 0x1800036C0 (-Return_NtStatus@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z.c)
...
LABEL_16:
  ...
  {
    v26 = 0;
    v12 = NtQueryWnfStateData(&WNF_SHEL_TARGETED_CONTENT_SUBSCRIPTION_UPDATED, 0LL, 0LL, &v21, 0LL, &v26) | 0x10000000;
