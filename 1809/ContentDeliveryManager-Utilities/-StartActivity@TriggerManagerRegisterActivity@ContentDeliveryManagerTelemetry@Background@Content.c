/*
 * XREFs of ?StartActivity@TriggerManagerRegisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBD@Z @ 0x1800608D4
 * Callers:
        ...
        const char *a2)
{
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
    ...
    TlgWrite(v6, &unk_180164C39, (LPCGUID)(v9 + 8), v10, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
