/*
 * XREFs of ?get_PhoneShellNamespaceHelper@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIPhoneShellNamespaceHelper@2@@Z @ 0x180010D40
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a3)
{
  ...
  int v5; // ebx
  _QWORD *v7; // rax
  ContentManagement::PhoneShellNamespaceHelper *v8; // rbx
  int v9; // edi
  _QWORD *v10; // rdi
...
LABEL_7:
  ...
  v8 = (ContentManagement::PhoneShellNamespaceHelper *)v7;
  if ( !v7 )
  {
    v9 = -2147024882;
LABEL_13:
  ...
  *((_QWORD *)v8 + 8) = 1LL;
  *(_QWORD *)v8 = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IPhoneShellNamespaceHelper>::`vftable'{for `IInspectable'};
  ...
  *((_QWORD *)v8 + 5) = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IPhoneShellNamespaceHelper>::`vftable'{for `IWeakReferenceSource'};
  *((_QWORD *)v8 + 6) = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::IPhoneShellNamespaceHelper>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,ContentManagement::IPhoneShellNamespaceHelper>'};
  if ( Microsoft::WRL::Details::ModuleBase::module_ )
    _InterlockedIncrement((volatile signed __int32 *)&Microsoft::WRL::Details::ModuleBase::objectCount_);
  *(_QWORD *)v8 = &ContentManagement::PhoneShellNamespaceHelper::`vftable'{for `IInspectable'};
  ...
  *((_QWORD *)v8 + 5) = &ContentManagement::PhoneShellNamespaceHelper::`vftable'{for `IWeakReferenceSource'};
  *((_QWORD *)v8 + 6) = &ContentManagement::PhoneShellNamespaceHelper::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,ContentManagement::IPhoneShellNamespaceHelper>'};
  v9 = ContentManagement::PhoneShellNamespaceHelper::`vftable'{for `IInspectable'}(
         v8,
         &GUID_66fbdb55_757a_4e3a_975d_ad5f9afbd372,
         (void **)&v17);
  (*(void (__fastcall **)(ContentManagement::PhoneShellNamespaceHelper *))(*(_QWORD *)v8 + 16LL))(v8);
  if ( v9 < 0 )
    goto LABEL_13;
