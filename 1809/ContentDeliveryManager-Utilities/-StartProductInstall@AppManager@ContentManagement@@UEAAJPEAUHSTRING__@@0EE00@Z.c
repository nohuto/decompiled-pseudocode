/*
 * XREFs of ?StartProductInstall@AppManager@ContentManagement@@UEAAJPEAUHSTRING__@@0EE00@Z @ 0x1800558D0
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING a7)
{
  ...
  v10 = ((__int64 (__fastcall *)(__int64, _QWORD))v9)(8553651LL, 0LL);
LABEL_7:
  v11 = v10 & 0x80;
  v12 = (v10 >> 6) & 1;
  v13 = v10 & 0xFFFFFF3F;
