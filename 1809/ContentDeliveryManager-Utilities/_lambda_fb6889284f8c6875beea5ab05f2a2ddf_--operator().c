/*
 * XREFs of _lambda_fb6889284f8c6875beea5ab05f2a2ddf_::operator() @ 0x18004EA0C
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_fb6889284f8c6875beea5ab05f2a2ddf____Windows::Internal::CNoResult_::Run @ 0x180050CD0 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_fb6889284f8c687.c)
 * Callees:
...
__int64 __fastcall lambda_fb6889284f8c6875beea5ab05f2a2ddf_::operator()(__int64 a1)
{
  ...
  try
  {
    ...
    v18 = 0LL;
    LOWORD(v17[0]) = 0;
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 72LL) + 24LL))(*(_QWORD *)(*(_QWORD *)a1 + 72LL));
