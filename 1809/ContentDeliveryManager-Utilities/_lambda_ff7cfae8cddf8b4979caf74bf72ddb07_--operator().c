/*
 * XREFs of _lambda_ff7cfae8cddf8b4979caf74bf72ddb07_::operator() @ 0x180046668
 * Callers:
 *     wil::details::functor_wrapper_void__lambda_ff7cfae8cddf8b4979caf74bf72ddb07__&___ptr64_::Run @ 0x18004ADD0 (wil--details--functor_wrapper_void__lambda_ff7cfae8cddf8b4979caf74bf72ddb07__-___ptr64_--Run.c)
 * Callees:
...
HRESULT __fastcall lambda_ff7cfae8cddf8b4979caf74bf72ddb07_::operator()(__int64 a1)
{
  ...
  try
  {
    ...
    for ( i = (__int64 *)v36; i != v11; ++i )
    {
      ...
      v29 = 0LL;
      if ( (*(int (__fastcall **)(__int64, GUID *, __int64 *))(*(_QWORD *)v13 + 48LL))(v13, &rguid, &v29) >= 0 )
      {
        v14 = v29;
        v29 = 0LL;
        v34 = v14;
