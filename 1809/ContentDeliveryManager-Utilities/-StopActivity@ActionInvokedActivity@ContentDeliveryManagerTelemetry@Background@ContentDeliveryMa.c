/*
 * XREFs of ?StopActivity@ActionInvokedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@MEAAXXZ @ 0x18004B8A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionInvokedActivity::StopActivity(
        ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionInvokedActivity *this)
{
  ...
  PSRWLOCK *v72; // [rsp+170h] [rbp+70h]
  __int64 v73; // [rsp+178h] [rbp+78h]
  DWORD *v74; // [rsp+180h] [rbp+80h]
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x400000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v69 = 2 * v10 + 2;
      v70 = 0;
      TlgWrite(v7, &unk_180163A86, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v25 + 3) & 0x400000000000LL) == *((_QWORD *)v25 + 3) )
    {
      ...
      v29 = CurrentThreadId;
      v74 = &v29;
      TlgWrite(v26, &unk_18016369A, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v71);
    }
  }
  wil::ActivityBase<ContentDeliveryManager::Background::ContentDeliveryManagerLogging,1,70368744177664,5,_TlgReflectorTag_Param0IsProviderType>::IgnoreCurrentThread((__int64)this);
}
