/*
 * XREFs of _Towupper @ 0x1800ABA38
 * Callers:
 *     ?do_toupper@?$ctype@G@std@@MEBAGG@Z @ 0x180024480 (-do_toupper@-$ctype@G@std@@MEBAGG@Z.c)
 *     ?do_toupper@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x1800244A0 (-do_toupper@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
