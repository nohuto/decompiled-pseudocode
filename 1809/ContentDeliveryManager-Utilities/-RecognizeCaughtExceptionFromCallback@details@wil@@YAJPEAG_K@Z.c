/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x180002A14
 * Callers:
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x1800C7F7E (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
 * Callees:
