/*
 * XREFs of ?GetTriggerSettingsContainerFromName@Internal@TargetedContent@Services@Windows@@YA?AV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@PEAUHSTRING__@@0@Z @ 0x180070E88
 * Callers:
 *     _lambda_3b51b811795083c8866600a62beaf61a_::operator() @ 0x180064818 (_lambda_3b51b811795083c8866600a62beaf61a_--operator().c)
 * Callees:
 *     ??1?$vector@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$allocator@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@@std@@QEAA@XZ @ 0x18002CF34 (--1-$vector@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V-$allocator@V-$basic_.c)
 ...
 *     ?ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA?AW4TargetedContentKnownTrigger@1234@PEB_W@Z @ 0x18006C838 (-ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA-AW4TargetedContentKnownTri.c)
 ...
 *     ??$_Resetp@VISettingsContainer@CommonHelper@CreativeFramework@@@?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@AEAAXPEAVISettingsContainer@CommonHelper@CreativeFramework@@@Z @ 0x180075380 (--$_Resetp@VISettingsContainer@CommonHelper@CreativeFramework@@@-$shared_ptr@VISettingsContainer.c)
        ...
        HSTRING a3)
{
  ...
  void **v21; // rdi
  __int64 v22; // rsi
  CreativeFramework::CommonHelper::SettingsContainer *v23; // rbx
  __int64 v24; // rbx
  __int64 *v25; // rax
  ...
  void *v35[2]; // [rsp+58h] [rbp-B0h] BYREF
  __int64 v36[4]; // [rsp+70h] [rbp-98h] BYREF
  char v37[8]; // [rsp+90h] [rbp-78h] BYREF
  ...
  CreativeFramework::CommonHelper::StringUtils::SplitString(v35, v43, L":");
  if ( v45 >= 8 )
...
LABEL_43:
    ...
    else
    {
      ...
      CreativeFramework::CommonHelper::StringUtils::SplitString(v36, v48, L"&");
      if ( v50 >= 8 )
      ...
      while ( 1 )
      {
        ...
        std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>(
          ...
          (char *)v23 + 16);
        v24 = v34;
        if ( *(_QWORD *)std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::find(
                          &v34,
                          v38,
                          v51) == v24 )
          break;
  ...
  v10 = (_QWORD *)std::wstring::append(v35[0], L":");
  if ( v10[3] >= 8uLL )
    v10 = (_QWORD *)*v10;
...
LABEL_53:
  std::vector<std::wstring>::~vector<std::wstring>((__int64 *)v35);
  return a1;
}
