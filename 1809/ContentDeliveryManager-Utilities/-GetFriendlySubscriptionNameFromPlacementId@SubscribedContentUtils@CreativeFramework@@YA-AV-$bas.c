/*
 * XREFs of ?GetFriendlySubscriptionNameFromPlacementId@SubscribedContentUtils@CreativeFramework@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W@Z @ 0x180082F40
 * Callers:
        ...
        char *a2)
{
  ...
  LPCWSTR lpStringSource[3]; // [rsp+88h] [rbp-19h] BYREF
  unsigned __int64 v20; // [rsp+A0h] [rbp-1h]
  void *v21[3]; // [rsp+A8h] [rbp+7h] BYREF
  unsigned __int64 v22; // [rsp+C0h] [rbp+1Fh]
  ...
  {
    v7 += 3;
    if ( v7 == (const wchar_t near *const *)&unk_1800F1928 )
    {
      v8 = 0LL;
      goto LABEL_16;
    }
