/*
 * XREFs of ?get_LaunchManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUILaunchManager@2@@Z @ 0x180010640
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a3)
{
  ...
  int v5; // ebx
  _QWORD *v7; // rax
  ContentManagement::LaunchManager *v8; // rbx
  int v9; // edi
  _QWORD *v10; // rdi
...
LABEL_7:
  ...
  v8 = (ContentManagement::LaunchManager *)v7;
  if ( !v7 )
  {
    v9 = -2147024882;
LABEL_13:
  ...
  *((_QWORD *)v8 + 8) = 1LL;
  *(_QWORD *)v8 = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::ILaunchManager>::`vftable'{for `IInspectable'};
  ...
  *((_QWORD *)v8 + 5) = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::ILaunchManager>::`vftable'{for `IWeakReferenceSource'};
  *((_QWORD *)v8 + 6) = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::FtmBase,ContentManagement::ILaunchManager>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,ContentManagement::ILaunchManager>'};
  if ( Microsoft::WRL::Details::ModuleBase::module_ )
    _InterlockedIncrement((volatile signed __int32 *)&Microsoft::WRL::Details::ModuleBase::objectCount_);
  *(_QWORD *)v8 = &ContentManagement::LaunchManager::`vftable'{for `IInspectable'};
  ...
  *((_QWORD *)v8 + 5) = &ContentManagement::LaunchManager::`vftable'{for `IWeakReferenceSource'};
  *((_QWORD *)v8 + 6) = &ContentManagement::LaunchManager::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,1,ContentManagement::ILaunchManager>'};
  v9 = ContentManagement::LaunchManager::`vftable'{for `IInspectable'}(
         v8,
         &GUID_3cb33ed0_2338_4892_aa4c_c96803309c9a,
         (void **)&v17);
  (*(void (__fastcall **)(ContentManagement::LaunchManager *))(*(_QWORD *)v8 + 16LL))(v8);
  if ( v9 < 0 )
    goto LABEL_13;
