/*
 * XREFs of ?GetToastContentXML@ToastHelpers@NotificationManager@CreativeFramework@@QEAA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@XZ @ 0x180097144
 * Callers:
 ...
 *     ?replace@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAAEAV12@_K0PEB_W0@Z @ 0x1800755A8 (-replace@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEAAAEAV12@_K0PEB_W0@Z.c)
...
void **__fastcall CreativeFramework::NotificationManager::ToastHelpers::GetToastContentXML(__int64 a1, void **a2)
{
  ...
  while ( v6 != v5 )
  {
    ...
    std::wstring::append(v34, (char *)L"{", asc_1801564F0[0] != 0);
    std::wstring::append((char *)v34, v6 + 4, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    v10 = std::wstring::append(v34, (char *)L"}", asc_1801564F4[0] != 0);
    v41 = 7LL;
    v40[2] = 0LL;
    LOWORD(v40[0]) = 0;
