/*
 * XREFs of _lambda_e2ad4dd96f48ff51f3e39c6a0eec3847_::operator() @ 0x180054F00
 * Callers:
...
__int64 __fastcall lambda_e2ad4dd96f48ff51f3e39c6a0eec3847_::operator()(_QWORD **a1)
{
  ...
  _QWORD *v34; // [rsp+70h] [rbp+Fh] BYREF
  ...
  {
    v35[0] = 0LL;
    v5 = (*(__int64 (__fastcall **)(_QWORD *, _QWORD, _QWORD, _QWORD *))(*v34 + 160LL))(v34, 0LL, **a1, v35);
    v4 = v5;
    if ( v5 >= 0 )
    {
      if ( v35[0] )
...
LABEL_41:
            ...
            v31 = 0LL;
            (*(void (__fastcall **)(_QWORD *, HSTRING, __int64 *))(*v34 + 64LL))(v34, v28, &v31);
            v33 = 0LL;
            v11 = v31;
