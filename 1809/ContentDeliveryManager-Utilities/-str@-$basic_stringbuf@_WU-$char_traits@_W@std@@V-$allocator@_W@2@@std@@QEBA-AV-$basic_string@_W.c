/*
 * XREFs of ?str@?$basic_stringbuf@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@XZ @ 0x180074C04
 * Callers:
...
_QWORD *__fastcall std::wstringbuf::str(__int64 a1, _QWORD *a2)
{
  ...
  __int64 v7; // r8
  __int64 v8; // r8
  void *v10[2]; // [rsp+20h] [rbp-30h] BYREF
