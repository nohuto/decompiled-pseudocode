/*
 * XREFs of McTemplateU0qqzr1qzr3qqqqpqqzr11 @ 0x180002B94
 * Callers:
 *     Pdcv2ActivationClientActivate @ 0x18002FA10 (Pdcv2ActivationClientActivate.c)
 *     Pdcv2EventWrite_ACTIVATION_CLIENT_ACTIVATE @ 0x180134568 (Pdcv2EventWrite_ACTIVATION_CLIENT_ACTIVATE.c)
 * Callees:
        ...
        __int64 a15)
{
  ...
  return McGenEventWrite(
           (unsigned int)&PDC_EVENT_PROVIDER_Context,
           (unsigned int)&PDCV2_ACTIVATION_ACTIVATE,
           a3,
           14,
           (__int64)v17);
}
