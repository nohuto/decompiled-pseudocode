/*
 * XREFs of s_midiOpenPort @ 0x1800E1060
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( KsMidiDeviceInfo >= 0 )
    {
      ...
      if ( v13 >= 0 )
      {
        ...
        *(&Connect.Medium.Alignment + 2) = 0LL;
        ...
        v26 = 64;
        v28 = GUID_1d262760_e957_11cf_a5d6_28db04c10000;
        v27 = GUID_e725d360_62cc_11cf_a5d6_28db04c10000;
        v29 = GUID_0f6417d6_c318_11d0_a43f_00a0c9223196;
