/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@_KP6AX_K@Z$1?ReleaseAudioResourceHandle@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@_K$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x1800E2114
 * Callers:
 *     _CSaDeviceProxy::_CSaDeviceProxy_::_1_::dtor$3 @ 0x18006A8A0 (_CSaDeviceProxy--_CSaDeviceProxy_--_1_--dtor$3.c)
 *     _TelephonyController::CreateCallInstance_::_1_::dtor$0 @ 0x18014595B (_TelephonyController--CreateCallInstance_--_1_--dtor$0.c)
 * Callees:
