/*
 * XREFs of asm_GetApplicationSubmixes @ 0x1800F3060
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Emplace_reallocate@_K@?$vector@_KV?$allocator@_K@std@@@std@@QEAAPEA_KQEA_K$$QEA_K@Z @ 0x1800F0DEC (--$_Emplace_reallocate@_K@-$vector@_KV-$allocator@_K@std@@@std@@QEAAPEA_KQEA_K$$QEA_K@Z.c)
 */
...
__int64 __fastcall asm_GetApplicationSubmixes(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  ...
  if ( InitOnceBeginInitialize(&`AudioSrvTelemetryProvider::Instance'::`2'::wrapper, 0, (PBOOL)&v25, (LPVOID *)&v18)
    && (_DWORD)v25 )
  {
    v18 = (struct _TP_TIMER **)qword_1801B3518;
