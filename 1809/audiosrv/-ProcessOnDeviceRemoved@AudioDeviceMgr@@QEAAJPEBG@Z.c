/*
 * XREFs of ?ProcessOnDeviceRemoved@AudioDeviceMgr@@QEAAJPEBG@Z @ 0x180142460
 * Callers:
 *     ?Process@DeviceRemovedWorkItem@@UEAAXPEAVAudioDeviceMgr@@@Z @ 0x180142370 (-Process@DeviceRemovedWorkItem@@UEAAXPEAVAudioDeviceMgr@@@Z.c)
        ...
        const unsigned __int16 *a2)
{
  ...
  struct IEndpointDevice *v15; // [rsp+70h] [rbp+30h] BYREF
  struct IEndpointCollection *v16; // [rsp+78h] [rbp+38h] BYREF
