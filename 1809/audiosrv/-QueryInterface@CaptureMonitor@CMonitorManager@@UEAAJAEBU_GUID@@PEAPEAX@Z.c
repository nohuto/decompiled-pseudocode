/*
 * XREFs of ?QueryInterface@CaptureMonitor@CMonitorManager@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FECC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x5Du, (__int64)&WPP_1c0de0291c27398d1c278f3c02582c75_Traceguids, v7);
  }
