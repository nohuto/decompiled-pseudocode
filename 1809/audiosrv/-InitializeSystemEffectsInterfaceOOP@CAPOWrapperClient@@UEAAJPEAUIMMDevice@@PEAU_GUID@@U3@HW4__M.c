/*
 * XREFs of ?InitializeSystemEffectsInterfaceOOP@CAPOWrapperClient@@UEAAJPEAUIMMDevice@@PEAU_GUID@@U3@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x18000DFC0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioSystemEffects2 **a7)
{
  ...
  if ( a2 && *((_QWORD *)this + 7) )
  {
    ...
    if ( v17 < 0 )
      goto LABEL_10;
    v14 = *(__int64 (__fastcall **)(__int64, LPVOID, struct _GUID *, __int128 *, int, enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001, bool, char *))(**((_QWORD **)this + 7) + 32LL);
    v15 = *((_QWORD *)this + 7);
    v20 = (__int128)*a4;
    v17 = v14(v15, pv, a3, &v20, a5, a6, a7 != 0LL, (char *)this + 72);
    v13 = v17;
    if ( v17 < 0 )
      goto LABEL_10;
    if ( a7 )
