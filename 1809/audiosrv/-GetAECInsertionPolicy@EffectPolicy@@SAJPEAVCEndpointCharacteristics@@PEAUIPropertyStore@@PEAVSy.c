/*
 * XREFs of ?GetAECInsertionPolicy@EffectPolicy@@SAJPEAVCEndpointCharacteristics@@PEAUIPropertyStore@@PEAVSystemEffectDescriptor@@U_GUID@@PEAW4INBOX_AEC_INSERTION_POLICY@@AEAU_AEC_POLICY_RESULTS@@@Z @ 0x18004C248
 * Callers:
...
LABEL_14:
  ...
  *((_DWORD *)a6 + 2) = v13;
  ...
  v20 = *a4;
  *((_DWORD *)a6 + 3) = CEndpointCharacteristics::IsConnectorModeSupported(this, *((unsigned int *)a3 + 12), &v20);
  v20 = *a4;
