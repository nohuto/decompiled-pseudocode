/*
 * XREFs of ?GetNextDevice@EndpointCollection@@QEAAJPEAPEAU__POSITION@@PEAPEAUIEndpointDevice@@@Z @ 0x180142EE0
 * Callers:
 *     ?GetNextDevice@EndpointIterator@@UEAAJPEAPEAUIEndpointDevice@@@Z @ 0x180142F90 (-GetNextDevice@EndpointIterator@@UEAAJPEAPEAUIEndpointDevice@@@Z.c)
 * Callees:
