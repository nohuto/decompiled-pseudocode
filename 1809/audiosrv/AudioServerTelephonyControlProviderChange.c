/*
 * XREFs of AudioServerTelephonyControlProviderChange @ 0x1800DF720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlProviderChange(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v5, (struct _TP_TIMER *)L"AudioServerTelephonyControlProviderChange");
