/*
 * XREFs of ?LogVolumePolicyChange@CSpatialAudioResourceManagerTraceLogger@@QEAAXKPEBG@Z @ 0x180116EA4
 * Callers:
        ...
        const unsigned __int16 *a3)
{
  ...
  if ( (unsigned int)dword_1801B1350 > 5 )
  {
    ...
    v10 = 0;
    TlgCreateWsz(&v11, a3);
    TlgWrite((TraceLoggingHProvider)&dword_1801B1350, &unk_1801753CA, v3, v4, cData, &pData);
  }
}
