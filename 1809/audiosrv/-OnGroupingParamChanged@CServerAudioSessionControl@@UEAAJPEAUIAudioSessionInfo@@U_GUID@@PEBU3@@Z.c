/*
 * XREFs of ?OnGroupingParamChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@U_GUID@@PEBU3@@Z @ 0x18000DE10
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v8 )
  {
    ...
    if ( v12 )
    {
      ...
      *((struct _GUID *)v12 + 3) = *a3;
      ...
      {
        v13 = 2147483646 - v15;
        v18 = *(_QWORD *)(*((_QWORD *)this + 9) + 768LL) - (_QWORD)v17;
        while ( v13 + v15 )
        {
