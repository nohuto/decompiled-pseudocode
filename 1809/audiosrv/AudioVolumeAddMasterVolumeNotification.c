/*
 * XREFs of AudioVolumeAddMasterVolumeNotification @ 0x180048B20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeAddMasterVolumeNotification(__int64 *a1)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v15[1], v2, (struct _TP_TIMER *)L"AudioVolumeAddMasterVolumeNotification");
  v3 = *a1;
