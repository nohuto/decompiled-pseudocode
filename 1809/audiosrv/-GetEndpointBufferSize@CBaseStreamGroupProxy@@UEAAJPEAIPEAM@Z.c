/*
 * XREFs of ?GetEndpointBufferSize@CBaseStreamGroupProxy@@UEAAJPEAIPEAM@Z @ 0x1800E3C00
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( v8 )
  {
    ...
    Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease(&v10);
    if ( v7 < 0 )
      AudSrvTraceLoggingErrorHelper("CBaseStreamGroupProxy::GetEndpointBufferSize", 764, v7);
  }
  if ( v3 )
