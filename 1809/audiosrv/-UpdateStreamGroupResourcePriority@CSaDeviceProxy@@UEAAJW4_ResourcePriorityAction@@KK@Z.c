/*
 * XREFs of ?UpdateStreamGroupResourcePriority@CSaDeviceProxy@@UEAAJW4_ResourcePriorityAction@@KK@Z @ 0x180009FD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
    ...
    if ( (*((_DWORD *)v11 + 8))-- == 1 )
    {
      ...
      v16 = (void *)std::_Tree<std::_Tmap_traits<unsigned long,unsigned long,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,unsigned long>>,0>>::_Extract(v4 + 40);
