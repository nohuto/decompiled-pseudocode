/*
 * XREFs of ?StringCbCatExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x180009448
 * Callers:
 *     ?LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z @ 0x1800079F4 (-LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z.c)
 * Callees:
 *     StringCopyWorkerW @ 0x180009504 (StringCopyWorkerW.c)
 *     StringLengthWorkerW @ 0x180009580 (StringLengthWorkerW.c)
 */
