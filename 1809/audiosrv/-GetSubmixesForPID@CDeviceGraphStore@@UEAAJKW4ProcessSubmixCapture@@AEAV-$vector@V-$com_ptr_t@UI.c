/*
 * XREFs of ?GetSubmixesForPID@CDeviceGraphStore@@UEAAJKW4ProcessSubmixCapture@@AEAV?$vector@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@@Z @ 0x1800E8B30
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_QWORD *)&v11 + 1) = &v17;
  ...
  try
  {
    ...
    if ( v14 )
    {
      v9 = &v12;
      LOBYTE(v9) = v14 != &v12;
      ((void (__fastcall *)(__int64 (__fastcall ***)(), __int64 (__fastcall ***)()))(*v14)[4])(v14, v9);
    }
    result = v8;
  }
  catch ( ... )
