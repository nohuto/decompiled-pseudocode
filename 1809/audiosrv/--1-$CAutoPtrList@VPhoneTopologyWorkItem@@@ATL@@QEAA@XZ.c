/*
 * XREFs of ??1?$CAutoPtrList@VPhoneTopologyWorkItem@@@ATL@@QEAA@XZ @ 0x180143458
 * Callers:
 *     _PhoneTopology::PhoneTopology_::_1_::dtor$3 @ 0x18006BAB3 (_PhoneTopology--PhoneTopology_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
