/*
 * XREFs of ?GetCallState@PhoneCallAudio@@UEAAJPEAU_TelephonyInstanceData@@PEAW4TelephonyState@@@Z @ 0x18011B5D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  v12 = 0;
  v8 = (*(__int64 (__fastcall **)(__int64, struct _TelephonyInstanceData *, int *))(*(_QWORD *)v7 + 96LL))(v7, a2, &v12);
  if ( v8 < 0 )
    goto LABEL_6;
  *(_DWORD *)a3 = v12 == 0;
LABEL_9:
