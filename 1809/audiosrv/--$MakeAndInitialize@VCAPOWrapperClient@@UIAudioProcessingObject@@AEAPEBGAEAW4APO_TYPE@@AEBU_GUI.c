/*
 * XREFs of ??$MakeAndInitialize@VCAPOWrapperClient@@UIAudioProcessingObject@@AEAPEBGAEAW4APO_TYPE@@AEBU_GUID@@@Details@WRL@Microsoft@@YAJPEAPEAUIAudioProcessingObject@@AEAPEBGAEAW4APO_TYPE@@AEBU_GUID@@@Z @ 0x18002DA50
 * Callers:
        ...
        __int64 a4)
{
  ...
  const GUID *v14; // r8
  const GUID *v15; // r9
  struct CAudioThreadPool *v17; // r15
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( (unsigned int)dword_1801B14C0 > 2 )
  {
    ...
    v35 = &v19;
    v36 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B14C0, &unk_180177A9E, v14, v15, 5u, &pData);
    Instance = v19;
  }
  if ( Instance >= 0 )
LABEL_7:
