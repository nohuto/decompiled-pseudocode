/*
 * XREFs of ?RecalculateSessionVolume@CAudioSession@@UEAAXW4AudioVolumeChangeType@@PEBU_GUID@@K_NPEA_J@Z @ 0x1800153B0
 * Callers:
...
__int64 __fastcall CAudioSession::RecalculateSessionVolume(__int64 a1, int a2, __int64 a3, int a4, char a5)
{
  ...
  v6[3] = &v7;
  v6[4] = &v9;
  return lambda_ce62a0462eef1ffdae6c0304eec1e9a4_::operator()(v6);
}
