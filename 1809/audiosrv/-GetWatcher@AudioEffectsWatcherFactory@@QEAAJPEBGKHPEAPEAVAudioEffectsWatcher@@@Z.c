/*
 * XREFs of ?GetWatcher@AudioEffectsWatcherFactory@@QEAAJPEBGKHPEAPEAVAudioEffectsWatcher@@@Z @ 0x1800BD4E8
 * Callers:
        ...
        struct AudioEffectsWatcher **a5)
{
  ...
  *a5 = 0LL;
  ...
  for ( i = (_QWORD *)qword_1801B3BA8; i; i = (_QWORD *)*i )
  {
    v10 = i[2];
...
LABEL_14:
  ...
  if ( v11 >= 0 )
  {
    v14 = ATL::CAtlList<COnDeviceWorkItem *,ATL::CElementTraits<COnDeviceWorkItem *>>::NewNode(
            (__int64)&qword_1801B3BA8,
            (__int64 *)&v18,
            qword_1801B3BB0);
    if ( qword_1801B3BB0 )
      *(_QWORD *)qword_1801B3BB0 = v14;
    else
      qword_1801B3BA8 = (__int64)v14;
    qword_1801B3BB0 = (__int64)v14;
    *((_QWORD *)v13 + 10) = v14;
    ++*((_DWORD *)v13 + 18);
    *v8 = v13;
    v11 = 0;
