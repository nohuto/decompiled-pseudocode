/*
 * XREFs of ?OnDefaultDeviceChangedForPolicy@AudioDeviceMgr@@UEAAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@PEBG@Z @ 0x180142130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioDeviceMgr::OnDefaultDeviceChangedForPolicy(__int64 a1, int a2, int a3, _BYTE *a4)
{
  unsigned int v5; // ebx
  void **v9; // rdi
  int v10; // eax
