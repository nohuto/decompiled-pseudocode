/*
 * XREFs of AudioServerTelephonyControlStartSession @ 0x1800DFD00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlStartSession(__int64 a1, unsigned int a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v3, (struct _TP_TIMER *)L"AudioServerTelephonyControlStartSession");
