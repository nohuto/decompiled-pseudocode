/*
 * XREFs of ?ToString@CAudioEndpointId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x18002D020
 * Callers:
...
__int64 __fastcall CAudioEndpointId::ToString(void **a1, void **a2)
{
  ...
  if ( v5 != v6 )
  {
    ...
    catch ( ATL::CAtlException *v13 )
    {
      ...
      v3 = *v9;
      if ( v14 < 0 )
        AudSrvTraceLoggingErrorHelper("CAudioEndpointId::ToString", 188, v14);
    }
  }
  return v3;
}
