/*
 * XREFs of ?PersistSessionConfiguration@CPerStreamVolumeAudioSession@@AEAAJXZ @ 0x180046998
 * Callers:
 ...
 *     WPP_SF_dSD @ 0x1800C39CC (WPP_SF_dSD.c)
 */
...
__int64 __fastcall CPerStreamVolumeAudioSession::PersistSessionConfiguration(CPerStreamVolumeAudioSession *this)
{
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(
      ...
      *((unsigned __int8 *)this + 1024));
  }
  if ( *((_QWORD *)this + 134) && *((_BYTE *)this + 1024) )
  {
    v28 = 0LL;
    v22 = 4LL;
    v23 = 0LL;
    v24 = 0LL;
    v18 = (LPCRITICAL_SECTION)((char *)this + 848);
    v19 = 0;
    ATL::CCritSecLock::Lock(&v18);
    LODWORD(v23) = *((_DWORD *)this + 222);
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 0x40) != 0
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_g(*((_QWORD *)WPP_GLOBAL_Control + 2), 107LL, &WPP_753fb3ff45c7308b48420cd59c2f48a5_Traceguids);
    }
    if ( v19 )
      LeaveCriticalSection(v18);
    v4 = (*(__int64 (__fastcall **)(_QWORD, void *, __int64 *))(**((_QWORD **)this + 134) + 48LL))(
           *((_QWORD *)this + 134),
    ...
    if ( (_DWORD)v5 )
    {
      ...
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 109LL, &WPP_753fb3ff45c7308b48420cd59c2f48a5_Traceguids, v5);
        v6 = *((_DWORD *)this + 250);
      }
              ...
              && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
            {
              WPP_SF_dg(
                *((_QWORD *)WPP_GLOBAL_Control + 2),
                ...
                &WPP_753fb3ff45c7308b48420cd59c2f48a5_Traceguids,
                v8,
                *(float *)(*((_QWORD *)this + 126) + 4LL * v8));
            }
            v4 = ATL::CComSafeArray<float,4>::SetAt(&v28, v8, *((_QWORD *)this + 126) + 4LL * v8);
            if ( v4 )
              break;
            if ( ++v8 >= *((_DWORD *)this + 250) )
              goto LABEL_43;
          }
          if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
            && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 0x40) != 0
            && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
          {
            WPP_SF_dSD(*((_QWORD *)WPP_GLOBAL_Control + 2), v9, v10, v8, *((_QWORD *)this + 96), v4);
          }
        }
      }
    }
LABEL_43:
    ...
    if ( v19 )
      LeaveCriticalSection(v18);
    v16 = (*(__int64 (__fastcall **)(_QWORD, void *, __int64 *))(**((_QWORD **)this + 134) + 48LL))(
            *((_QWORD *)this + 134),
    ...
    v17 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 134) + 56LL))(*((_QWORD *)this + 134));
    LODWORD(v2) = v17;
    if ( v17 )
    {
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    if ( (int)v2 < 0 )
      AudSrvTraceLoggingErrorHelper("CPerStreamVolumeAudioSession::PersistSessionConfiguration", 4770, (int)v2);
  }
  if ( v21 )
