/*
 * XREFs of std::_Func_impl_no_alloc__lambda_b2f72c50110305d9aa06d2931c2147e0__void_::_Do_call @ 0x1800E6090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc__lambda_b2f72c50110305d9aa06d2931c2147e0__void_::_Do_call(__int64 a1)
{
  ...
  v4[0] = v2;
  v4[1] = &v5;
  return lambda_3af8306e4cb261445d9be7b235e038d7_::operator()((__int64)v4);
}
