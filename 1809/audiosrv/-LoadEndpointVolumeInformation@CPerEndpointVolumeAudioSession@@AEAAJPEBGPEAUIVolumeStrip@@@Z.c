/*
 * XREFs of ?LoadEndpointVolumeInformation@CPerEndpointVolumeAudioSession@@AEAAJPEBGPEAUIVolumeStrip@@@Z @ 0x1800C0DB4
 * Callers:
            ...
            do
            {
              ...
              *(float *)(v32 + 4 * v31) = v33;
                ...
                && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
              {
                ...
                v35[4] = v33;
                WPP_SF_dg(v34, 0x27u, (__int64)&WPP_753fb3ff45c7308b48420cd59c2f48a5_Traceguids, v31);
              }
              v31 = (unsigned int)(v31 + 1);
            }
            while ( (unsigned int)v31 < *((_DWORD *)this + 250) );
          }
        }
      }
      if ( v40 )
