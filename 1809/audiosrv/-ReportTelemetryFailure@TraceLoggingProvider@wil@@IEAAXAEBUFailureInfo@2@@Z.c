/*
 * XREFs of ?ReportTelemetryFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x180016028
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x180016000 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  if ( *(_DWORD *)this[1] > 5u )
  {
    if ( TlgKeywordOn(this[1], 0x200000000000uLL) )
    {
      ...
      TlgWrite(v23, &unk_1801720AF, v21, v22, 0x10u, &pData);
    }
  }
}
