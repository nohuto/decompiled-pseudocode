/*
 * XREFs of ?GetEffectsList@CSystemEffectWrapper@@UEAAJPEAPEAU_GUID@@PEAIPEAX@Z @ 0x180130CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemEffectWrapper::GetEffectsList(
        ...
        void *a4)
{
  return (*(__int64 (__fastcall **)(_QWORD, struct _GUID **, unsigned int *, void *))(**((_QWORD **)this + 17) + 24LL))(
           *((_QWORD *)this + 17),
           a2,
           a3,
           a4);
