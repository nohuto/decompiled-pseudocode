/*
 * XREFs of ?CheckAndLogTelemetry@AudioJournal@@AEAAXXZ @ 0x180012FE4
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_ef92fad5d387f4ec2c28fdba8b86f656__void_::_Do_call @ 0x180015410 (std--_Func_impl_no_alloc__lambda_ef92fad5d387f4ec2c28fdba8b86f656__void_--_Do_call.c)
 * Callees:
  ...
  if ( *(_BYTE *)this )
  {
    ...
    if ( (__int64)((*(_QWORD *)&SystemTimeAsFileTime - *((_QWORD *)this + 28)) / 0x989680uLL) >= 86400 )
    {
      ...
      if ( **((_DWORD **)Context + 1) > 4u && TlgKeywordOn(*((TraceLoggingHProvider *)Context + 1), 0x400000000000uLL) )
      {
        ...
        TlgWrite(v7, &unk_180174CB8, v6, (LPCGUID)v7, 6u, &pData);
      }
