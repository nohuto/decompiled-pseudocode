/*
 * XREFs of ?ReadChannelLevelsFromHardware@CVolumeHardware@@IEAAJXZ @ 0x1800B8A88
 * Callers:
  ...
  if ( *((_DWORD *)this + 31) )
  {
    do
    {
      ...
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_dg(*((_QWORD *)WPP_GLOBAL_Control + 2), 41LL, &WPP_1ac98b3e4732363a42c9f2d13b70c7da_Traceguids, v3, v7);
      }
