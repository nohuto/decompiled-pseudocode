/*
 * XREFs of ?GetEndpointBufferSize@CVADServer@@UEAAJPEAIPEAM@Z @ 0x1800D9960
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
    if ( EndpointBufferSize >= 0 )
      goto LABEL_6;
LABEL_16:
    AudSrvTraceLoggingErrorHelper("CVADServer::GetEndpointBufferSize", 2151, EndpointBufferSize);
    goto LABEL_10;
  }
LABEL_6:
