/*
 * XREFs of ?PreStartStream@CVADServer@@UEAAJXZ @ 0x1800DA7B0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *((_QWORD *)this + 21) )
    {
             ...
             &v16) >= 0 )
      {
        ...
        if ( *(_DWORD *)v3 > 4u )
        {
          ...
          v27 = &v18;
          v28 = 4LL;
          TlgWrite(v3, &unk_18017322A, v7, v8, 5u, &pData);
        }
      }
    }
  }
...
LABEL_17:
  ...
  v12 = (__int64 *)((char *)this + 464);
  wil::com_ptr_t<Windows::Foundation::Collections::IPropertySet,wil::err_returncode_policy>::reset((__int64 *)this + 58);
  v13 = *((_QWORD *)this + 24);
