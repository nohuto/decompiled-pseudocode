/*
 * XREFs of ?Initialize@CAudioSessionInstanceId@@QEAAJPEBG@Z @ 0x1800CDFBC
 * Callers:
...
__int64 __fastcall CAudioSessionInstanceId::Initialize(CAudioSessionInstanceId *this, unsigned __int16 *a2)
{
  ...
  int *v25; // rbx
  __int64 v26; // r8
  unsigned __int16 *v27; // [rsp+20h] [rbp-68h] BYREF
  unsigned __int16 *v28; // [rsp+28h] [rbp-60h] BYREF
  unsigned __int16 *v29; // [rsp+30h] [rbp-58h] BYREF
  __int64 v30[2]; // [rsp+38h] [rbp-50h] BYREF
  ATL::CAtlException *v31; // [rsp+48h] [rbp-40h] BYREF
  ATL::CAtlException *v32; // [rsp+50h] [rbp-38h] BYREF
  int v34; // [rsp+98h] [rbp+10h] BYREF
  __int64 v35; // [rsp+A0h] [rbp+18h] BYREF
  char *v36; // [rsp+A8h] [rbp+20h] BYREF
  ...
  try
  {
    ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v36, a2, v5);
  }
  ...
  if ( v6 - 24 != (_BYTE *)(v29 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v29, v6, *((_DWORD *)v6 - 4));
    }
  }
  ...
  if ( v11 - 24 != (_BYTE *)(v28 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v28, v11, *((_DWORD *)v11 - 4));
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v35 - 24));
  if ( v34 == -1 )
  ...
  if ( v16 - 24 != (_BYTE *)(v27 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v27, v16, *((_DWORD *)v16 - 4));
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v35 - 24));
  if ( v34 == -1 )
