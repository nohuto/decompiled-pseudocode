/*
 * XREFs of ?ConfigureDolbyAtmosHeadphonesEncoder@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x180128950
 * Callers:
        ...
        struct ISpatialAudioEncoderProperties *a2)
{
  ...
  if ( MetadataDictionaryData >= 0 )
  {
                ...
                if ( MetadataDictionaryData >= 0 )
                {
                  MetadataDictionaryData = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 11) + 48LL))(
                                             *((_QWORD *)this + 11),
                                             v32[0]);
                  v30 = MetadataDictionaryData;
                  if ( MetadataDictionaryData < 0 && (unsigned int)dword_1801B1488 > 2 )
                  {
    ...
    else if ( (unsigned int)dword_1801B1488 > 2 )
    {
      ...
      v39 = &v30;
      v40 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B1488, &unk_180177A22, v7, v8, 5u, &pData);
    }
  }
  else if ( (unsigned int)dword_1801B1488 > 2 )
  {
