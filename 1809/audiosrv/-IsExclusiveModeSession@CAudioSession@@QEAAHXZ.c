/*
 * XREFs of ?IsExclusiveModeSession@CAudioSession@@QEAAHXZ @ 0x1800C0CD0
 * Callers:
...
__int64 __fastcall CAudioSession::IsExclusiveModeSession(CAudioSession *this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x8Du, (__int64)&WPP_753fb3ff45c7308b48420cd59c2f48a5_Traceguids, 0LL);
  }
