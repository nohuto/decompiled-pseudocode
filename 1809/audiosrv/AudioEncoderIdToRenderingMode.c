/*
 * XREFs of AudioEncoderIdToRenderingMode @ 0x1801263E4
 * Callers:
          ...
          if ( v9 )
          {
            ...
            if ( v10 )
            {
              ...
              if ( v11 )
              {
                ...
                if ( v12 && (unsigned int)dword_1801B1488 > 2 )
                {
                  v18 = 30LL;
                  ...
                  v15 = -2147418113;
                  v22 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1801B1488, &unk_180177A54, a3, a4, 5u, &pData);
                }
              }
            }
            else
