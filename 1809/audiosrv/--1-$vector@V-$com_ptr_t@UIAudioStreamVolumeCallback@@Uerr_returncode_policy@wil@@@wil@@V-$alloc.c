/*
 * XREFs of ??1?$vector@V?$com_ptr_t@UIAudioStreamVolumeCallback@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIAudioStreamVolumeCallback@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x1800CB434
 * Callers:
 *     _CAudioStream::CAudioStream_::_1_::dtor$13 @ 0x18006C210 (_CAudioStream--CAudioStream_--_1_--dtor$13.c)
 * Callees:
