/*
 * XREFs of ?LogSubscribe@CSpatialAudioResourceManagerTraceLogger@@QEAAXK_NI@Z @ 0x180116B18
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1801B1350 > 5 )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B1350, &unk_18017536A, a3, a4, 5u, &pData);
  }
}
