/*
 * XREFs of wil::ScopeExit__lambda_f4cda0dc8e90cff3e0444fc8376cd0f6___ @ 0x1800263D4
 * Callers:
...
__int64 __fastcall wil::ScopeExit__lambda_f4cda0dc8e90cff3e0444fc8376cd0f6___(__int64 a1, __int128 *a2)
{
  __int128 v2; // xmm0
  __int64 result; // rax
