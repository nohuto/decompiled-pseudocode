/*
 * XREFs of ?MmeOnDefaultDeviceChanged@@YAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@PEBG@Z @ 0x1800F8184
 * Callers:
 ...
 * Callees:
 *     WPP_SF_ddS @ 0x1800F8394 (WPP_SF_ddS.c)
 */
