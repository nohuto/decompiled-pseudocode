/*
 * XREFs of ?IsInCall@PhoneCallAudio@@AEAAHXZ @ 0x18011BA48
 * Callers:
 ...
 *     ??1?$CComCritSecLock@VCComAutoCriticalSection@ATL@@@ATL@@QEAA@XZ @ 0x1800F349C (--1-$CComCritSecLock@VCComAutoCriticalSection@ATL@@@ATL@@QEAA@XZ.c)
 */
...
__int64 __fastcall PhoneCallAudio::IsInCall(struct _RTL_CRITICAL_SECTION *this)
{
  ...
  {
    ATL::CComCritSecLock<ATL::CComAutoCriticalSection>::~CComCritSecLock<ATL::CComAutoCriticalSection>((__int64)&lpCriticalSection);
    return 1;
  }
  else if ( v5 )
  {
