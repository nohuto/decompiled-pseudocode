/*
 * XREFs of ?QueryInterface@EndpointCollection@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180050BC0
 * Callers:
 *     ?QueryInterface@EndpointCollection@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069940 (-QueryInterface@EndpointCollection@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
