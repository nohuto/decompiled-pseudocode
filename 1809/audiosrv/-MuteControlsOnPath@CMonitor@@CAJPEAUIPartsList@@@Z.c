/*
 * XREFs of ?MuteControlsOnPath@CMonitor@@CAJPEAUIPartsList@@@Z @ 0x180101948
 * Callers:
...
__int64 __fastcall CMonitor::MuteControlsOnPath(struct IPartsList *a1)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x43u, (__int64)&WPP_19c32bd6ba053f64fb4a85d982837be5_Traceguids);
  }
