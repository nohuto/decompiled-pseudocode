/*
 * XREFs of ?DoSetCellularEnable@PhoneTopology@@AEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x180143738
 * Callers:
 *     ?Process@CallEnableWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x1801449A0 (-Process@CallEnableWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
 ...
 *     ?RemoveKey@?$CAtlMap@IV?$CComPtr@UITelephonyControllerCallInstance@@@ATL@@V?$CElementTraits@I@2@V?$CElementTraits@V?$CComPtr@UITelephonyControllerCallInstance@@@ATL@@@2@@ATL@@QEAA_NI@Z @ 0x180144B58 (-RemoveKey@-$CAtlMap@IV-$CComPtr@UITelephonyControllerCallInstance@@@ATL@@V-$CElementTraits@I@2@.c)
  ...
  if ( !a3 )
  {
                            ...
                            &v16) )
    {
      ATL::CAtlMap<unsigned int,ATL::CComPtr<ITelephonyControllerCallInstance>,ATL::CElementTraits<unsigned int>,ATL::CElementTraits<ATL::CComPtr<ITelephonyControllerCallInstance>>>::RemoveKey(
        v7,
        *((unsigned int *)a2 + 1));
      v12 = (*(__int64 (__fastcall **)(_QWORD *, struct _TelephonyInstanceData *))(*v16 + 64LL))(v16, a2);
      if ( v12 < 0 )
        v5 = v12;
    }
LABEL_17:
  ...
  if ( !v9 )
  {
    v10 = (*(__int64 (__fastcall **)(_QWORD, struct _TelephonyInstanceData *, _QWORD **))(**((_QWORD **)this + 3) + 24LL))(
            *((_QWORD *)this + 3),
            a2,
            &v16);
    if ( v10 < 0 )
    ...
    ATL::CComCritSecLock<ATL::CComAutoCriticalSection>::CComCritSecLock<ATL::CComAutoCriticalSection>(
      (__int64)&lpCriticalSection,
      v6);
    v11 = (*(__int64 (__fastcall **)(_QWORD *, struct _TelephonyInstanceData *))(*v16 + 72LL))(v16, a2);
    if ( v11 < 0
