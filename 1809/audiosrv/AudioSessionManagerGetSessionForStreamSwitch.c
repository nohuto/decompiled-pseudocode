/*
 * XREFs of AudioSessionManagerGetSessionForStreamSwitch @ 0x1800C9E80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
    wil::com_ptr_t<CAudioSession,wil::err_returncode_policy>::~com_ptr_t<CAudioSession,wil::err_returncode_policy>((__int64 *)&v25);
    goto LABEL_22;
  }
  wil::details::in1diag3::Return_Hr(
    retaddr,
