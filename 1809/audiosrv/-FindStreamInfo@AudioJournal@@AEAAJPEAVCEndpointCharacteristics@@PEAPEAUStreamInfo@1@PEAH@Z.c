/*
 * XREFs of ?FindStreamInfo@AudioJournal@@AEAAJPEAVCEndpointCharacteristics@@PEAPEAUStreamInfo@1@PEAH@Z @ 0x180026490
 * Callers:
        ...
        int *a4)
{
  ...
  LPVOID pv[2]; // [rsp+28h] [rbp-58h] BYREF
  ...
  int v29; // [rsp+B4h] [rbp+34h]
  struct AudioJournal::StreamInfo *v30; // [rsp+B8h] [rbp+38h] BYREF
  struct AudioJournal::StreamInfo **v31; // [rsp+C0h] [rbp+40h] BYREF
  ...
  *((_QWORD *)&v23 + 1) = &v28;
  ...
  if ( !a2 )
  {
    v9 = (struct AudioJournal::StreamInfo *)&unk_1801B40E0;
    v30 = (struct AudioJournal::StreamInfo *)&unk_1801B40E0;
    v28 = 0;
LABEL_24:
  ...
  if ( *((_DWORD *)a2 + 39) )
  {
    v5 = (struct AudioJournal::StreamInfo *)&unk_1801B3F50;
    v6 = 2;
  }
  else
  {
    v5 = (struct AudioJournal::StreamInfo *)&unk_1801B3CF8;
    v6 = 3;
  }
  v30 = v5;
  Src = 0LL;
