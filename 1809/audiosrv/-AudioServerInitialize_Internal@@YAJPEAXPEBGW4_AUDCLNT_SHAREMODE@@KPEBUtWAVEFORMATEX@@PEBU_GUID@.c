/*
 * XREFs of ?AudioServerInitialize_Internal@@YAJPEAXPEBGW4_AUDCLNT_SHAREMODE@@KPEBUtWAVEFORMATEX@@PEBU_GUID@@PEAUVadServerSettings@@PEAPEAGPEAUIProcessSubmixProxy@@PEAPEAX@Z @ 0x180030000
 * Callers:
 *     AudioServerInitialize @ 0x180033410 (AudioServerInitialize.c)
        ...
        void **a10)
{
  ...
  *a10 = 0LL;
  ...
  if ( v21 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerInitialize_Internal", 2838, v21);
