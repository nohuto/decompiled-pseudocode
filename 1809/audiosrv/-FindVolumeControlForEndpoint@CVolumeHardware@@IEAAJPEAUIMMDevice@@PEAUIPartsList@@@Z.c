/*
 * XREFs of ?FindVolumeControlForEndpoint@CVolumeHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18005B3DC
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_1ac98b3e4732363a42c9f2d13b70c7da_Traceguids, this);
    v6 = v17;
  }
  if ( a2 )
  {
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control )
    {
      if ( (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x10000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_qS(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          34,
          (unsigned int)&WPP_1ac98b3e4732363a42c9f2d13b70c7da_Traceguids,
          (_DWORD)this,
          (__int64)pv);
        v8 = WPP_GLOBAL_Control;
      }
      if ( v8 != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)v8 + 25) >= 4u )
      {
        WPP_SF_q(*((_QWORD *)v8 + 2), 35LL, &WPP_1ac98b3e4732363a42c9f2d13b70c7da_Traceguids, this);
      }
    }
    v9 = v17;
    if ( v17 != a2 )
    {
      ATL::AtlComQIPtrAssign(&v17, a2, &GUID_a4566d7a_c8f5_4150_0b7b_4ee7e744fc5c);
      v9 = v17;
    }
    if ( v9 )
    {
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 36LL, &WPP_1ac98b3e4732363a42c9f2d13b70c7da_Traceguids, this);
    }
    ...
    if ( v7 < 0 )
LABEL_36:
      AudSrvTraceLoggingErrorHelper("CVolumeHardware::FindVolumeControlForEndpoint", 1320, v7);
    CoTaskMemFree(pv);
    pv = 0LL;
    if ( v15[0] )
