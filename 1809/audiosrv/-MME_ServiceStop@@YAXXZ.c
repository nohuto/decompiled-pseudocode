...
void MME_ServiceStop(void)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x20u, (__int64)&WPP_318757207047345406f66bc846efc13e_Traceguids);
  }
