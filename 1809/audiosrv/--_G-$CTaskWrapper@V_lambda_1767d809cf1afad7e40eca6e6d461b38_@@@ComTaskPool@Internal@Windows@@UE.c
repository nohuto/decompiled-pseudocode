/*
 * XREFs of ??_G?$CTaskWrapper@V_lambda_1767d809cf1afad7e40eca6e6d461b38_@@@ComTaskPool@Internal@Windows@@UEAAPEAXI@Z @ 0x180137A40
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall Windows::Internal::ComTaskPool::CTaskWrapper<_lambda_1767d809cf1afad7e40eca6e6d461b38_>::`scalar deleting destructor'(
        _QWORD *a1,
        char a2)
{
