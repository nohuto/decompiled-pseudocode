/*
 * XREFs of ServiceDeviceEvent @ 0x1801050B8
 * Callers:
 *     ServiceDeviceEventCallback @ 0x180105290 (ServiceDeviceEventCallback.c)
 * Callees:
...
__int64 __fastcall ServiceDeviceEvent(unsigned int a1, struct _DEV_BROADCAST_DEVICEINTERFACE_W *a2)
{
  ...
  if ( (unsigned int)dword_1801B14C0 > 4 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1801B14C0, &unk_180174D8C, v5, v6, 3u, &pData);
  }
