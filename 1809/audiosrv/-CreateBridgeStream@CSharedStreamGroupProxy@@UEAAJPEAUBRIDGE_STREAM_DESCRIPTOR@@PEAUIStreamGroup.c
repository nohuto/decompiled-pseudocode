/*
 * XREFs of ?CreateBridgeStream@CSharedStreamGroupProxy@@UEAAJPEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIStreamGroupProxy@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1800E30D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  if ( *(_DWORD *)v14 > 4u )
  {
    ...
    v28 = 8;
    v31 = 8;
    TlgWrite(v14, &unk_18017387D, (LPCGUID)v14, v12, 5u, &pData);
  }
  v15 = v17;
  if ( v20 )
