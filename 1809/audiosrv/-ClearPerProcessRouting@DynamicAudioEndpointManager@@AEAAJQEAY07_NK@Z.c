/*
 * XREFs of ?ClearPerProcessRouting@DynamicAudioEndpointManager@@AEAAJQEAY07_NK@Z @ 0x18011DF70
 * Callers:
  ...
  if ( v5 >= 0 )
  {
    ...
    while ( 2 )
    {
      ...
      do
      {
        if ( *v10 )
        {
          v5 = PublishChangeNotification((unsigned int)v8, (unsigned int)v9, &word_18015F720, a3);
          v6 = v5;
          if ( v5 < 0 )
          {
            v7 = 69LL;
