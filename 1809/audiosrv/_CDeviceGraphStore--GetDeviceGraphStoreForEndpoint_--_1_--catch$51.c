/*
 * XREFs of _CDeviceGraphStore::GetDeviceGraphStoreForEndpoint_::_1_::catch$51 @ 0x18006D210
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetDeviceGraphStoreForEndpoint_::_1_::catch_51(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
