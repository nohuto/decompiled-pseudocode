/*
 * XREFs of ?ParseStreamSwitchId@CAudioSession@@SAJPEBG0AEAVCAudioSessionInstanceId@@PEAK2PEA_N@Z @ 0x1800C1C8C
 * Callers:
        ...
        bool *a6)
{
  ...
  char *v39; // [rsp+28h] [rbp-70h] BYREF
  ...
  _QWORD v44[2]; // [rsp+50h] [rbp-48h] BYREF
  ATL::CAtlException *v45; // [rsp+60h] [rbp-38h] BYREF
  ATL::CAtlException *v46; // [rsp+68h] [rbp-30h] BYREF
  ...
  try
  {
    ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v39, a2, v8);
  }
  ...
  v48 = 0;
  v9 = *(_BYTE **)ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::Tokenize(
                    &v39,
                    &v38,
                    v37,
                    &v48);
  ...
  if ( v9 - 24 != (_BYTE *)(v43 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v43, v9, *((_DWORD *)v9 - 4));
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v38 - 24));
  if ( v48 == -1 )
    goto LABEL_34;
  v14 = *(_BYTE **)ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::Tokenize(
                     &v39,
                     &v38,
                     v13,
                     &v48);
  ...
  if ( v14 - 24 != (_BYTE *)(String - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&String, v14, *((_DWORD *)v14 - 4));
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v38 - 24));
  if ( v48 == -1 )
    goto LABEL_34;
  v19 = *(_BYTE **)ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::Tokenize(
                     &v39,
                     &v38,
                     v18,
                     &v48);
  ...
  if ( v19 - 24 != (_BYTE *)(v41 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v41, v19, *((_DWORD *)v19 - 4));
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v38 - 24));
  if ( v48 == -1 )
    goto LABEL_34;
  v24 = *(_BYTE **)ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::Tokenize(
                     &v39,
                     &v38,
                     v23,
                     &v48);
  ...
  if ( v24 - 24 != (_BYTE *)(v40 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v40, v24, *((_DWORD *)v24 - 4));
    }
  }
  ATL::CStringData::Release((ATL::CStringData *)(v38 - 24));
  if ( v48 == -1 )
