/*
 * XREFs of ?UpdateRule@DynamicAudioEndpointManager@@QEAAJPEAUIAudioProcess@@_JPEAU_DynamicRoutingRule@@@Z @ 0x18011F5F8
 * Callers:
...
LABEL_10:
  ...
  v11 = (*(__int64 (__fastcall **)(_QWORD, struct IAudioProcess *, bool *))(**(_QWORD **)v17 + 88LL))(
          *(_QWORD *)v17,
          v18,
          v28);
  v8 = v11;
...
LABEL_16:
    wil::details::in1diag3::Return_Hr(
      ...
      (__int64)"avcore\\audiocore\\server\\audiosrv\\defaultdevice\\dynamicrouting.cpp",
      (const char *)v13);
    (*(void (__fastcall **)(_QWORD, struct IAudioProcess *, bool *))(**(_QWORD **)v17 + 96LL))(*(_QWORD *)v17, v18, v28);
LABEL_17:
  ...
  if ( !DynamicAudioEndpointManager::VerifyListIntegrityAndRefreshDependencies(this, (bool (*const)[8])v29) )
  {
    v8 = -2147467259;
    v13 = 2147500037LL;
    v14 = 530LL;
  ...
  if ( v6 )
    LeaveCriticalSection(v6);
  v16 = DynamicAudioEndpointManager::RefreshPublishedDefaults(this, (bool (*const)[8])v29, 0);
  v8 = v16;
  if ( v16 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
