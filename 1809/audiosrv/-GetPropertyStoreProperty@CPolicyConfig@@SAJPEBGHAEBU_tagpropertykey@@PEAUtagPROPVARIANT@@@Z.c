/*
 * XREFs of ?GetPropertyStoreProperty@CPolicyConfig@@SAJPEBGHAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x1800D2B5C
 * Callers:
        ...
        struct tagPROPVARIANT *a4)
{
  ...
  {
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyStoreProperty", 4859, PropertyStoreProperty);
  }
  if ( v9[0] )
