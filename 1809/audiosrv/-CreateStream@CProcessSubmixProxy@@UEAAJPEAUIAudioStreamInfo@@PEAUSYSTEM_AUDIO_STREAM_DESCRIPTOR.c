/*
 * XREFs of ?CreateStream@CProcessSubmixProxy@@UEAAJPEAUIAudioStreamInfo@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@KPEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x18000D3B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SYSTEM_AUDIO_STREAM *a6)
{
  ...
  CProcessSubmixProxy *v22; // [rsp+40h] [rbp-79h] BYREF
  ...
  else
  {
    ...
    else
    {
      ...
      if ( *(_DWORD *)v15 > 4u )
      {
        ...
        v25[0] = ((unsigned int)&unk_1801733B9 - (unsigned int)&TraceLoggingMetadata) | 0xB000000;
        v17 = *(_QWORD *)(v15 + 32);
        v26 = 0LL;
        v28 = *v27;
        v30 = &unk_1801733C4;
