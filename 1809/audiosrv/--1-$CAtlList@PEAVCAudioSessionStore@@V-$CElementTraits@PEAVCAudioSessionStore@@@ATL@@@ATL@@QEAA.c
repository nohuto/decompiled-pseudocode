/*
 * XREFs of ??1?$CAtlList@PEAVCAudioSessionStore@@V?$CElementTraits@PEAVCAudioSessionStore@@@ATL@@@ATL@@QEAA@XZ @ 0x1800AF798
 * Callers:
 *     _CPolicyConfig::_CPolicyConfig_::_1_::dtor$2 @ 0x1800CEB21 (_CPolicyConfig--_CPolicyConfig_--_1_--dtor$2.c)
 * Callees:
 *     <none>
 */
