/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x180006370
 * Callers:
 ...
 *     ??0CAudioMediaType@@IEAA@XZ @ 0x1800126CC (--0CAudioMediaType@@IEAA@XZ.c)
 *     memcpy_0 @ 0x1800688A3 (memcpy_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800688D0 (_guard_dispatch_icall_nop.c)
 *     ??_ECAudioMediaType@@MEAAPEAXI@Z @ 0x180134D20 (--_ECAudioMediaType@@MEAAPEAXI@Z.c)
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x1801350C4 (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
 */
