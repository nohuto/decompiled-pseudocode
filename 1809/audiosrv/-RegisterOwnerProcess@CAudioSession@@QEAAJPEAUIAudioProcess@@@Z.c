/*
 * XREFs of ?RegisterOwnerProcess@CAudioSession@@QEAAJPEAUIAudioProcess@@@Z @ 0x1800C25B0
 * Callers:
...
__int64 __fastcall CAudioSession::RegisterOwnerProcess(CAudioSession *this, struct IAudioProcess *a2)
{
  ...
  v18 = -2LL;
  v15 = a2;
  v3 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 776);
  ...
  try
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      ATL::CComPtrBase<CMonitorManager::CaptureMonitor>::CComPtrBase<CMonitorManager::CaptureMonitor>(
        &v14,
        (__int64)v15);
      v8 = (__int64 *)*((_QWORD *)this + 103);
      if ( *((__int64 **)this + 104) == v8 )
      {
      ...
      v21 = 0;
      if ( *((_BYTE *)this + 840) )
        *((_BYTE *)this + 840) = (*(unsigned int (__fastcall **)(struct IAudioProcess *))(*(_QWORD *)v15 + 96LL))(v15) != 0;
      Context[0] = 0LL;
      ...
      if ( *(_DWORD *)v11 > 4u )
      {
        TlgCreateWsz(&pDesc, *((LPCWSTR *)this + 96));
        LODWORD(v14) = (*(__int64 (__fastcall **)(struct IAudioProcess *))(*(_QWORD *)v15 + 40LL))(v15);
        v24 = &v14;
        v25 = 4;
        v26 = 0;
        TlgWrite(v11, &unk_180172938, v12, v13, 4u, &pData);
      }
      if ( v3 )
