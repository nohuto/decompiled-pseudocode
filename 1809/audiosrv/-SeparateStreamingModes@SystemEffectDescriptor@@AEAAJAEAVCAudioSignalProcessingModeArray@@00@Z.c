/*
 * XREFs of ?SeparateStreamingModes@SystemEffectDescriptor@@AEAAJAEAVCAudioSignalProcessingModeArray@@00@Z @ 0x18004E378
 * Callers:
...
LABEL_6:
    ...
    if ( v12 == -1 )
      break;
    v18 = ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](a2, (unsigned int)v5);
...
LABEL_9:
  ...
  v14 = ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](a2, (unsigned int)v5);
