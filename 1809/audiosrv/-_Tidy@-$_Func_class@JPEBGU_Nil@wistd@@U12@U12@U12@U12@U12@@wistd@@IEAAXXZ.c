/*
 * XREFs of ?_Tidy@?$_Func_class@JPEBGU_Nil@wistd@@U12@U12@U12@U12@U12@@wistd@@IEAAXXZ @ 0x18000B9E4
 * Callers:
...
__int64 __fastcall wistd::_Func_class<long,unsigned short const *,wistd::_Nil,wistd::_Nil,wistd::_Nil,wistd::_Nil,wistd::_Nil,wistd::_Nil>::_Tidy(
        __int64 a1,
        __int64 a2)
{
  __int64 v3; // rcx
