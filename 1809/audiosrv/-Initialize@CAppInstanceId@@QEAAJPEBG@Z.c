/*
 * XREFs of ?Initialize@CAppInstanceId@@QEAAJPEBG@Z @ 0x1800CD7F8
 * Callers:
...
__int64 __fastcall CAppInstanceId::Initialize(CAppInstanceId *this, unsigned __int16 *a2)
{
  ...
  char *v26; // [rsp+28h] [rbp-60h] BYREF
  __int64 v27; // [rsp+30h] [rbp-58h] BYREF
  wchar_t *EndPtr[2]; // [rsp+38h] [rbp-50h] BYREF
  ...
  try
  {
    ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v26, a2, v6);
  }
  ...
  if ( v7 - 24 != (_BYTE *)(v25 - 12) )
  {
    ...
    {
      ATL::CSimpleStringT<unsigned short,0>::SetString((void **)&v25, v7, *((_DWORD *)v7 - 4));
      v9 = v25;
    }
  }
