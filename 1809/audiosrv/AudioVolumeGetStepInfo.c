/*
 * XREFs of AudioVolumeGetStepInfo @ 0x1800BC790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetStepInfo(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v12[1], v6, (struct _TP_TIMER *)L"AudioVolumeGetStepInfo");
  v8 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(*(_QWORD *)*a1 + 120LL))(*a1, a2, a3);
