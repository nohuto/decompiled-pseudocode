/*
 * XREFs of ?FixupProcessingModeSupport@CEndpointCharacteristics@@AEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@HH@Z @ 0x18004E4CC
 * Callers:
 ...
 *     ?GetConnectorFXModeEffectPKEY@CEndpointCharacteristics@@AEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAU_tagpropertykey@@1@Z @ 0x18004FAD4 (-GetConnectorFXModeEffectPKEY@CEndpointCharacteristics@@AEAAJW4__MIDL___MIDL_itf_audioengineendp.c)
        ...
        int a4)
{
  ...
  _BYTE v70[56]; // [rsp+160h] [rbp+58h] BYREF
  __int64 v71; // [rsp+198h] [rbp+90h]
  wil::details::in1diag3 *retaddr; // [rsp+1E0h] [rbp+D8h]
  struct _GUID *v73; // [rsp+1E8h] [rbp+E0h] BYREF
  unsigned int v74; // [rsp+1F0h] [rbp+E8h] BYREF
  unsigned int v75; // [rsp+1F8h] [rbp+F0h] BYREF
  ...
  if ( !*((_DWORD *)this + a2 + 12) )
  {
    ...
    {
      v39 = 16LL * a2;
      ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::RemoveAll((char *)this + v39 + 72);
      ...
      if ( a4 && !(_DWORD)v5 )
      {
        ...
        GetFxClsids(*((struct IMMDevice **)this + 2), &v59, (struct _tagpropertykey *)&v54[2], &v75, &v73);
        memset(&v56, 0, sizeof(v56));
        v60 = PKEY_FX_PostMixEffectClsid;
        GetFxClsids(*((struct IMMDevice **)this + 2), &v60, &v56, &v74, &v55);
...
LABEL_71:
    ...
    *(GUID *)&v54[2] = fmtid;
    ...
    v64.fmtid = fmtid;
    v64.pid = pid;
    GetFxClsids(*((struct IMMDevice **)this + 2), &v64, &v63, &v75, &v55);
    v66 = 96 * v7;
    v8 = v55;
    ...
    else
    {
      ...
      else
      {
        ...
        GetFxClsids(*((struct IMMDevice **)this + 2), &v63, &v64, &v74, (struct _GUID **)&pv);
        ...
        else
        {
          ...
          v63.fmtid = v34;
          v63.pid = v35;
          GetFxClsids(*((struct IMMDevice **)this + 2), &v63, &v64, (unsigned int *)&v73, &v67);
          v25 = v67;
          ConnectorFXModeEffectPKEY = SystemEffectDescriptor::SetDefaultEffectChain(
...
LABEL_26:
            ...
            if ( v9 > 0 )
            {
              do
              {
                v38 = (_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](v57, v32);
                if ( (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find(
                                     (__int64 *)&v60,
                                     v38) == -1 )
                {
                  v51 = ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](v57, v32);
