/*
 * XREFs of ?OnVolumeChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@M_NPEBU_GUID@@@Z @ 0x18000A370
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_Sgd @ 0x1800C6A50 (WPP_SF_Sgd.c)
 */
  ...
  if ( v10 )
  {
    ...
    if ( v14 )
    {
      ...
      *((_BYTE *)v16 + 52) = a4;
      ...
      {
        v15 = 2147483646 - v18;
        v21 = *(_QWORD *)(*((_QWORD *)this + 9) + 768LL) - (_QWORD)v19;
        while ( v15 + v18 )
        {
