/*
 * XREFs of AudioSessionManagerAddVolumeDuckNotification @ 0x18000FE20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionManagerAddVolumeDuckNotification(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _QWORD *v9; // [rsp+38h] [rbp-50h] BYREF
...
LABEL_8:
  if ( v5 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionManagerAddVolumeDuckNotification", 2209, v5);
LABEL_10:
  CWatchdogTimer<1>::~CWatchdogTimer<1>(pv);
