/*
 * XREFs of ?WorkItemThreadProc@AudioDeviceMgr@@AEAAXXZ @ 0x18005F7DC
 * Callers:
 *     ?s_WorkItemThreadProc@AudioDeviceMgr@@CAKPEAX@Z @ 0x18005F7C0 (-s_WorkItemThreadProc@AudioDeviceMgr@@CAKPEAX@Z.c)
 * Callees:
