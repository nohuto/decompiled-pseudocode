/*
 * XREFs of ?RestartMonitorIfAppropriate@CaptureMonitor@CMonitorManager@@QEAAJXZ @ 0x1800FF428
 * Callers:
...
LABEL_32:
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Eu, (__int64)&WPP_1c0de0291c27398d1c278f3c02582c75_Traceguids, v2);
  }
  return (unsigned int)v2;
}
