/*
 * XREFs of ?AERTDestroyHeap@@YAXPEAX@Z @ 0x180132FEC
 * Callers:
...
void __fastcall AERTDestroyHeap(void *a1, void *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Eu, (__int64)&WPP_c553bd3a27e539e4ab650ec0a4fc27b6_Traceguids, a1);
  }
  if ( a1 )
  {
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x20u, (__int64)&WPP_c553bd3a27e539e4ab650ec0a4fc27b6_Traceguids);
  }
}
