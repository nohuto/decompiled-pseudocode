/*
 * XREFs of ??1?$CLockedList@VCMasterVolumeNotificationProcess@@$00$0A@@@QEAA@XZ @ 0x1800BA4C4
 * Callers:
 *     _CVolumeStrip::CVolumeStrip_::_1_::dtor$1 @ 0x18006FE55 (_CVolumeStrip--CVolumeStrip_--_1_--dtor$1.c)
 * Callees:
