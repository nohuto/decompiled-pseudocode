/*
 * XREFs of ??_GTelephonyControllerCallInstance@@MEAAPEAXI@Z @ 0x180147680
 * Callers:
 *     ??_ETelephonyControllerCallInstance@@O7EAAPEAXI@Z @ 0x1800699C0 (--_ETelephonyControllerCallInstance@@O7EAAPEAXI@Z.c)
 * Callees:
