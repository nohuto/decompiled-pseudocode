/*
 * XREFs of ?GetDelayedAECInsertionPolicy@EffectPolicy@@SAJPEAVCEndpointCharacteristics@@PEAUIPropertyStore@@PEAVSystemEffectDescriptor@@U_GUID@@PEAW4INBOX_AEC_INSERTION_POLICY@@AEAU_AEC_POLICY_RESULTS@@@Z @ 0x180111D90
 * Callers:
        ...
        struct _AEC_POLICY_RESULTS *a6)
{
  ...
  _QWORD *v28; // [rsp+70h] [rbp-59h] BYREF
  ...
  if ( !EffectPolicy::IsMicArray(a2, a6) || EffectPolicy::IsValidMicArrayForAEC(this, a3[12], a2, a6) )
  {
    ...
    if ( DefaultEffectChainClsids >= 0 )
    {
      ...
      if ( DefaultEffectChainClsids >= 0 )
      {
        ...
        v32 = *(_OWORD *)v32;
        v14 = v34;
        if ( (*(int (__fastcall **)(_QWORD *, _OWORD *, __int128 *, __int64, _DWORD, _QWORD, __int64 *))(*v28 + 24LL))(
               v28,
               v10,
               &v32,
               1LL,
