/*
 * XREFs of ?DisconnectFromSaDevice@CBaseStreamGroupProxy@@UEAAJXZ @ 0x180048090
 * Callers:
...
__int64 __fastcall CBaseStreamGroupProxy::DisconnectFromSaDevice(CBaseStreamGroupProxy *this)
{
  ...
  _QWORD v13[8]; // [rsp+30h] [rbp-58h] BYREF
  ...
  if ( *((_QWORD *)this + 11) )
  {
    v13[0] = off_180157A30;
    v13[7] = v13;
    (*(void (__fastcall **)(CBaseStreamGroupProxy *, _QWORD *))(*(_QWORD *)this + 360LL))(this, v13);
    v3 = *((_QWORD *)this + 11);
    v15 = 0LL;
    v4 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v3 + 56LL))(v3, &v15);
    v5 = v4;
    if ( v4 < 0 )
    {
      v11 = 718LL;
