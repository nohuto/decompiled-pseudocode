/*
 * XREFs of ?RemoveAtPos@?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x18013F39C
 * Callers:
 *     _ATL::CAtlMap_ResourceConsumer_____ptr64_ATL::CAtlList__ResourceInfo_ResourceInfoTraits______ptr64_ResourceConsumerTraits_ATL::CElementTraits_ATL::CAtlList__ResourceInfo_ResourceInfoTraits______ptr64___::SetAt_::_1_::catch$0 @ 0x18013F596 (_ATL--CAtlMap_ResourceConsumer_____ptr64_ATL--CAtlList__ResourceInfo_ResourceInfoTr_ea_18013F596.c)
 * Callees:
