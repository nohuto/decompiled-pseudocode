/*
 * XREFs of _CDeviceGraphStore::GetSubmixesForPID_::_1_::catch$8 @ 0x1800E8BFE
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetSubmixesForPID_::_1_::catch_8(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
