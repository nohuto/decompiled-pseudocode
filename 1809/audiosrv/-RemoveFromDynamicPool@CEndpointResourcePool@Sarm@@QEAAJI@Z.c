/*
 * XREFs of ?RemoveFromDynamicPool@CEndpointResourcePool@Sarm@@QEAAJI@Z @ 0x1801174F4
 * Callers:
        ...
        unsigned int Data1)
{
  ...
  if ( (unsigned int)dword_1801B1350 > 4 )
  {
    ...
    v10 = this;
    v23 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1801B1350, &unk_1801755A4, v4, &pRelatedActivityId, 8u, &pData);
