/*
 * XREFs of _DynamicAudioEndpointManager::AddRule_::_1_::dtor$1 @ 0x18011DCE7
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DynamicAudioEndpointManager::AddRule_::_1_::dtor_1(__int64 a1, __int64 a2)
{
