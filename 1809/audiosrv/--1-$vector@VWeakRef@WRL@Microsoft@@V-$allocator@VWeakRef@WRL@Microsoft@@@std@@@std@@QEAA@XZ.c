/*
 * XREFs of ??1?$vector@VWeakRef@WRL@Microsoft@@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@QEAA@XZ @ 0x1800C70C0
 * Callers:
 *     _CAudioSessionManager::CAudioSessionManager_::_1_::dtor$4 @ 0x18006BFA7 (_CAudioSessionManager--CAudioSessionManager_--_1_--dtor$4.c)
 *     _CAudioSessionManager::_CAudioSessionManager_::_1_::dtor$4 @ 0x1800C74A4 (_CAudioSessionManager--_CAudioSessionManager_--_1_--dtor$4.c)
 * Callees:
