/*
 * XREFs of _dynamic_initializer_for__g_AudioEngineUtilTelemetryProviderRegistration__ @ 0x180001390
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_AudioEngineUtilTelemetryProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1801B14C0, a2, a3);
