/*
 * XREFs of Pdcv2ActivationClientActivate @ 0x18002FA10
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  _BYTE v69[256]; // [rsp+110h] [rbp+10h] BYREF
  _BYTE v70[280]; // [rsp+210h] [rbp+110h] BYREF
  unsigned int v71; // [rsp+328h] [rbp+228h] BYREF
  _BYTE v72[160]; // [rsp+330h] [rbp+230h] BYREF
  char v73; // [rsp+418h] [rbp+318h]
...
LABEL_98:
  ...
  if ( Heap )
  {
    ...
    *v24 = 0;
    ...
    {
      v31 = *(_WORD *)((char *)v30 + (char *)L"TimerForAudioPlayback" - v69);
      if ( !v31 )
        break;
      *v30++ = v31;
      if ( !--v29 )
    ...
    *v30 = 0;
    ...
    if ( v36 )
    {
      ...
      do
      {
        if ( (unsigned __int64)v37 >= *v36 )
          break;
        ++v37;
        *(_QWORD *)((char *)v38 + v72 - (_BYTE *)v36) = v38[1];
        *(_QWORD *)((char *)v38 + (char *)&v71 - (char *)v36) = *v38;
        v38 += 2;
      }
      while ( v37 < 0xA );
      v71 = v37;
    ...
    if ( *(_QWORD *)(v39 + 8) )
    {
      ...
      v58 = 800LL;
      v59[0] = 52429560LL;
      v40 = ZwAlpcSendWaitReceivePort(*(_QWORD *)(v39 + 8), 0x20000LL, v59);
      if ( v40 >= 0 )
    ...
    if ( v40 < 0 || (v40 = v62, v41 = v63, *a8 = v63, v40 < 0) || v41 == 300 )
    {
