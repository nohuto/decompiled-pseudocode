/*
 * XREFs of ?GetDeviceByInterfacePath@EndpointCollection@@UEAAJPEBGPEAPEAUIEndpointDevice@@@Z @ 0x180142C80
 * Callers:
 *     <none>
 * Callees:
      ...
      *a3 = 0LL;
      ...
      if ( v8 >= 0 )
      {
        while ( 1 )
        {
          ...
          ATL::CComQIPtr<IMMEndpointInternal,&__s_GUID const _GUID_a4566d7a_c8f5_4150_0b7b_4ee7e744fc5c>::CComQIPtr<IMMEndpointInternal,&__s_GUID const _GUID_a4566d7a_c8f5_4150_0b7b_4ee7e744fc5c>(
            v15,
            v13);
          v8 = (*(__int64 (__fastcall **)(_QWORD, LPVOID *))(*(_QWORD *)v15[0] + 96LL))(v15[0], &pv);
          if ( v8 >= 0 )
          {
