/*
 * XREFs of _CDeviceGraphObjectsStore::GetConnectedStreamGroups_::_1_::catch$38 @ 0x1800E7F3B
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphObjectsStore::GetConnectedStreamGroups_::_1_::catch_38(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
