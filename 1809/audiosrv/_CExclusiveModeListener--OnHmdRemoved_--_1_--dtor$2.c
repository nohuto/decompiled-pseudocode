/*
 * XREFs of _CExclusiveModeListener::OnHmdRemoved_::_1_::dtor$2 @ 0x180119DE7
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CExclusiveModeListener::OnHmdRemoved_::_1_::dtor_2(__int64 a1, __int64 a2)
{
