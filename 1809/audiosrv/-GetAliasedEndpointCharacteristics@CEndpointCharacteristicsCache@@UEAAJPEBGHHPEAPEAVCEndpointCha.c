/*
 * XREFs of ?GetAliasedEndpointCharacteristics@CEndpointCharacteristicsCache@@UEAAJPEBGHHPEAPEAVCEndpointCharacteristics@@@Z @ 0x180032420
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CEndpointCharacteristics **a5)
{
  ...
  __int64 v48; // [rsp+40h] [rbp-108h] BYREF
...
LABEL_83:
      ...
      v27 = *(_QWORD *)(Node + 8);
      v47 = (CEndpointCharacteristics *)v27;
      if ( v27 )
...
LABEL_49:
  ...
  if ( v7 >= 0 )
  {
    if ( v8 )
    {
      ...
      v8 = 0LL;
      v48 = 0LL;
      *v30 = (struct CEndpointCharacteristics *)v32;
    }
    else
    {
      v7 = -2147023728;
  ...
  if ( v7 < 0 && (unsigned int)hProvider > 3 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 4uLL) )
  {
    ...
    p_ppv = &ppv;
    v68 = v43;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1801751C9, v44, v45, 5u, &pData);
  }
  CoTaskMemFree(pv);
  pv = 0LL;
  if ( v8 )
