/*
 * XREFs of ?FlattenProperty@CAudioSessionStore@@AEAAPEAEPEBUtagPROPVARIANT@@PEA_K@Z @ 0x1800D20EC
 * Callers:
 ...
 *     WPP_SF_dP @ 0x1800D871C (WPP_SF_dP.c)
 */
...
LABEL_21:
    ...
    case 0x2004:
      ...
      {
        WPP_SF_dP(*((_QWORD *)WPP_GLOBAL_Control + 2), 34LL);
      }
      break;
  }
    ...
    if ( a2->vt != 31 )
    {
      ...
      else if ( a2->vt == 8196 )
      {
        if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_dP(*((_QWORD *)WPP_GLOBAL_Control + 2), 35LL);
        }
        v10[1] = 24LL;
        LODWORD(rgIndices) = 0;
        if ( plUbound > 0 )
...
LABEL_40:
          ...
          if ( v12 != (CAudioSessionManager *)&WPP_GLOBAL_Control
            ...
            && *((_BYTE *)v12 + 25) >= 4u )
          {
            WPP_SF_dg(*((_QWORD *)v12 + 2), 0x25u, (__int64)&WPP_8e50d3333ef73ff52f011be4f2d35929_Traceguids, rgIndices);
          }
          goto LABEL_45;
        }
      }
