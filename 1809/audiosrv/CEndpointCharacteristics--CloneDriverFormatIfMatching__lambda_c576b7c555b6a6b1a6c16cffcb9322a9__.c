/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_c576b7c555b6a6b1a6c16cffcb9322a9___ @ 0x180066124
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_c576b7c555b6a6b1a6c16cffcb9322a9___(
        __int64 a1,
        __int64 a2,
        unsigned int *a3,
    ...
    if ( v7 <= 0x28 )
    {
      ...
      if ( _bittest64(&v8, v7) )
      {
        ...
        if ( v7 >= (unsigned __int64)v9->cbSize + 18
          && (unsigned __int8)lambda_c576b7c555b6a6b1a6c16cffcb9322a9_::operator()(a2, v9) )
        {
