/*
 * XREFs of ?InitializeAPOs@CVolumeStrip@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x180011FE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProcessingObject **a4)
{
  ...
  if ( a4 || !a3 )
  {
    ...
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 24LL, &WPP_1af60ca396c231183a59f5c311004dee_Traceguids, this);
    }
    v9 = *((_QWORD *)this + 31);
    if ( v9 )
...
LABEL_18:
    AudSrvTraceLoggingErrorHelper("CVolumeStrip::InitializeAPOs", 643, v8);
    return (unsigned int)v8;
  }
  return 2147500035LL;
}
