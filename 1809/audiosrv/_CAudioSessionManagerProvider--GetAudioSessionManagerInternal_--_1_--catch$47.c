/*
 * XREFs of _CAudioSessionManagerProvider::GetAudioSessionManagerInternal_::_1_::catch$47 @ 0x18006C6B0
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CAudioSessionManagerProvider::GetAudioSessionManagerInternal_::_1_::catch_47(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
