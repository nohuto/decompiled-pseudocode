/*
 * XREFs of ?OnIconPathChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@PEBGPEBU_GUID@@@Z @ 0x1800C45E0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v8 )
  {
    ...
    if ( v14 )
    {
      ...
      *(GUID *)(v15 + 7) = v18;
      v15[12] = v12;
      v15[13] = v11 + 72;
      StringCbCopyW(v16, v11, *(char **)(*((_QWORD *)this + 9) + 768LL));
      ...
      operator delete(v15);
      if ( MediaEvent < 0 )
        AudSrvTraceLoggingErrorHelper("CServerAudioSessionControl::OnIconPathChanged", 500, MediaEvent);
    }
  }
  if ( v23 )
