/*
 * XREFs of ?CalculateDynamicObjectGrantCount@CStreamResource@Sarm@@QEBAIII@Z @ 0x180117658
 * Callers:
        ...
        const GUID *a3)
{
  ...
  if ( (unsigned int)dword_1801B1350 > 5 )
  {
    ...
    v38 = 1;
    v41 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1801B1350, &unk_18017587C, a3, (LPCGUID)v4, 0xCu, &pData);
    LODWORD(v4) = v10;
  }
