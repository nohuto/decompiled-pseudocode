/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@JPEBG_NPEAG_KPEAD6PEAUFailureInfo@2@@Z @ 0x180013FD8
 * Callers:
 ...
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x1800141D0 (-RecordReturn@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x1800141EC (-RecordLog@details@wil@@YAHJ@Z.c)
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x180042EB0 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x1800AD924 (-RecordException@details@wil@@YAHJ@Z.c)
