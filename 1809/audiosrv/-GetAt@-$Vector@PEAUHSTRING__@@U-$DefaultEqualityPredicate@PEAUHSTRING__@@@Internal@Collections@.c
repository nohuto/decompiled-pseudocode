/*
 * XREFs of ?GetAt@?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$VectorOptions@PEAUHSTRING__@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@UEAAJIPEAPEAUHSTRING__@@@Z @ 0x180138920
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a3)
{
  ...
  v3 = a2;
  *a3 = 0LL;
  XWinRT::SerializingLockPolicy::Read(&v10, a1 + 104, &v9);
  v6 = v9;
  if ( v9 >= 0 )
  {
