/*
 * XREFs of ?GetCurrentVariantState@?$Feature@U__WilFeatureTraits_Feature_HangDetectionThresholdTweaking@@@wil@@CA?AW4Variant_HangDetectionThresholdTweaking@@PEAIPEAH1@Z @ 0x18005E324
 * Callers:
