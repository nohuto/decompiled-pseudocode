/*
 * XREFs of AudioVolumeGetMute @ 0x180048D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetMute(_QWORD *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v4, (struct _TP_TIMER *)L"AudioVolumeGetMute");
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a1 + 152LL))(*a1, a2);
