/*
 * XREFs of ?QueryInterface@EndpointIterator@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180143010
 * Callers:
 *     ?QueryInterface@EndpointIterator@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069950 (-QueryInterface@EndpointIterator@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
