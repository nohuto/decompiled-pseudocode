/*
 * XREFs of ?OnHmdAdded@CExclusiveModeListener@@AEAAJPEAUIHolographicDisplayWatcher@Internal@Holographic@Graphics@Windows@@PEAUIHolographicDisplay@456@@Z @ 0x1801198E0
 * Callers:
        ...
        struct Windows::Graphics::Holographic::IHolographicDisplay *a3)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  wil::com_ptr_t<IAudioMediaType,wil::err_returncode_policy>::operator=((__int64 *)&v17, (__int64)a3);
  v16 = 0LL;
  v6 = (__int64)v17;
...
LABEL_3:
  ...
  try
  {
    ...
    v11 = v24;
    wil::com_ptr_t<IAudioMediaType,wil::err_returncode_policy>::operator=((__int64 *)(v24 + 48), v6);
    *(_QWORD *)(v11 + 56) = v18;
    v14 = v19;
    *(_BYTE *)(v11 + 64) = v19;
  }
