/*
 * XREFs of ?IsOffloadConnectorFormatSupportedForMixFormat@@YAJPEAVCEndpointCharacteristics@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@3@Z @ 0x1800D304C
 * Callers:
        ...
        const struct tWAVEFORMATEX *Src)
{
  ...
  v19 = 0LL;
  v20 = *a2;
  ModeEffect = CEndpointCharacteristics::GetModeEffect(a1, &v20, 0, eOffloadConnector, 0LL, &v19, 0LL);
  if ( ModeEffect >= 0 )
  {
    if ( v19 )
    {
