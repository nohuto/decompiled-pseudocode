/*
 * XREFs of ?ConfigureSpatialAudioHrtfEncoder@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x18012AAA4
 * Callers:
        ...
        struct ISpatialAudioEncoderProperties *a2)
{
  ...
  if ( v13[0] >= 0 )
  {
    ...
    if ( v12 >= 0 )
    {
      ...
      v6 = v12;
      if ( v12 < 0 && (unsigned int)dword_1801B1488 > 2 )
      {
        v18 = 0;
        v21 = 0;
        v24 = 0;
  ...
  else if ( (unsigned int)dword_1801B1488 > 2 )
  {
    ...
    v12 = 296;
    v22 = v13;
    TlgWrite((TraceLoggingHProvider)&dword_1801B1488, &unk_180177A22, v4, v5, 5u, &pData);
  }
  return v6;
}
