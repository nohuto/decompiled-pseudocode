/*
 * XREFs of _CExclusiveModeListener::RuntimeClassInitialize_::_1_::dtor$3 @ 0x18011A639
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CExclusiveModeListener::RuntimeClassInitialize_::_1_::dtor_3(__int64 a1, __int64 a2)
{
