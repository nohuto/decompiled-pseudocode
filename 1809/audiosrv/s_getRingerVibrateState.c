/*
 * XREFs of s_getRingerVibrateState @ 0x1800F96A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_getRingerVibrateState(__int64 a1, _DWORD *a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v8[1], v3, (struct _TP_TIMER *)L"s_getRingerVibrateState");
  *a2 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *))(*(_QWORD *)g_PolicyManager + 264LL))(g_PolicyManager);
