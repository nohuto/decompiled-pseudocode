/*
 * XREFs of ?LoadDictionary@SpatialAudioMetadataDictionary@@AEAAJW4DictionaryLoadKind@@AEBU_GUID@@GPEBG@Z @ 0x18012DAD8
 * Callers:
      ...
      if ( SpatialAudioDevicePropertyReader >= 0 )
      {
        ...
        if ( SpatialAudioDevicePropertyReader >= 0 )
        {
          ...
          if ( SpatialAudioDevicePropertyReader >= 0 )
          {
            ...
            *(_QWORD *)(a1 + 128) = v23;
            SpatialAudioDevicePropertyReader = (*(__int64 (__fastcall **)(__int64, LPVOID, _QWORD))(*(_QWORD *)v30 + 48LL))(
                                                 ...
                                                 v29);
            v27 = SpatialAudioDevicePropertyReader;
            if ( SpatialAudioDevicePropertyReader < 0 && (unsigned int)dword_1801B1488 > 2 )
            {
              v33 = "SpatialAudioMetadataDictionary::LoadDictionary";
              v34 = 47LL;
              v28 = 215;
          ...
          else if ( (unsigned int)dword_1801B1488 > 2 )
          {
            ...
            v37 = &v27;
            v38 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1801B1488, &unk_180177A22, v20, v21, 5u, &pData);
          }
        }
        else if ( (unsigned int)dword_1801B1488 > 2 )
        {
