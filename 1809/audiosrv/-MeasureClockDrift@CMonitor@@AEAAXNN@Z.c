/*
 * XREFs of ?MeasureClockDrift@CMonitor@@AEAAXNN@Z @ 0x1801017D8
 * Callers:
 ...
 *     WPP_SF_gg @ 0x180104474 (WPP_SF_gg.c)
 *     WPP_SF_gggg @ 0x1801044CC (WPP_SF_gggg.c)
 */
...
void __fastcall CMonitor::MeasureClockDrift(CMonitor *this, double a2, double a3)
{
  ...
  *((_QWORD *)this + 60) = v5 + 1;
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_g(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x33u, (__int64)&WPP_19c32bd6ba053f64fb4a85d982837be5_Traceguids, v11);
    v13 = *((double *)this + 59);
    v12 = WPP_GLOBAL_Control;
  }
