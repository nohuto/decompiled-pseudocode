/*
 * XREFs of _lambda_c2418f5ccc6644b853246d46ceaffa0b_::operator() @ 0x18006496C
 * Callers:
...
__int64 __fastcall lambda_c2418f5ccc6644b853246d46ceaffa0b_::operator()(__int64 a1, char a2)
{
