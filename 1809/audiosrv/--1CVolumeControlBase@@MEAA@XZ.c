/*
 * XREFs of ??1CVolumeControlBase@@MEAA@XZ @ 0x1800B6BD0
 * Callers:
 ...
 *     _CVolumeSoftware::CVolumeSoftware_::_1_::dtor$0 @ 0x1800BA46C (_CVolumeSoftware--CVolumeSoftware_--_1_--dtor$0.c)
