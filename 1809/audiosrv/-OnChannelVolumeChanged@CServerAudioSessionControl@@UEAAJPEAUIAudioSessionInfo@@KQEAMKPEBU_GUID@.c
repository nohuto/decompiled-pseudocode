/*
 * XREFs of ?OnChannelVolumeChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@KQEAMKPEBU_GUID@@@Z @ 0x1800C41A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID *a6)
{
  ...
  if ( v11 )
  {
    v12 = 2 * *(_DWORD *)(*(_QWORD *)(v11 + 768) - 16LL) + 2;
    ...
    if ( v13 )
    {
      ...
      *(GUID *)(v14 + 7) = v17;
      ...
      StringCbCopyW((char *)v14 + 72, v12, *(char **)(*((_QWORD *)this + 9) + 768LL));
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 0x40) != 0
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
