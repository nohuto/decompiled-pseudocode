/*
 * XREFs of ??1DynamicAudioEndpointManager@@UEAA@XZ @ 0x1800CA468
 * Callers:
...
void __fastcall DynamicAudioEndpointManager::~DynamicAudioEndpointManager(DynamicAudioEndpointManager *this)
{
  ...
  *(_QWORD *)this = &DynamicAudioEndpointManager::`vftable';
  ...
  ATL::CAtlList<ATL::CComQIPtr<IPolicyRule,&__s_GUID const _GUID_950f62ca_d61d_43ce_893e_dbf6fe56fbf3>,ATL::CComQIPtrElementTraits<IPolicyRule,&__s_GUID const _GUID_950f62ca_d61d_43ce_893e_dbf6fe56fbf3>>::RemoveAll((char *)this + 824);
