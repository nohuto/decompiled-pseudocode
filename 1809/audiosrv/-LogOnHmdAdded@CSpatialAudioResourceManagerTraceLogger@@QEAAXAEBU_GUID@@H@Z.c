/*
 * XREFs of ?LogOnHmdAdded@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@H@Z @ 0x180119448
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1801B1350 > 4 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1801B1350, &unk_180175B0D, a3, a4, 4u, &v4);
  }
}
