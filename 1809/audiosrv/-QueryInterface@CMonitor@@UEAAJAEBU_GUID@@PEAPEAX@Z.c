/*
 * XREFs of ?QueryInterface@CMonitor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801032D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMonitor::QueryInterface(CMonitor *this, const struct _GUID *a2, CMonitor **a3)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Fu, (__int64)&WPP_19c32bd6ba053f64fb4a85d982837be5_Traceguids, v6);
  }
