/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_AllowSpatialLicenseSideLoad@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1801389D0
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( (`wil::Feature<__WilFeatureTraits_Feature_AllowSpatialLicenseSideLoad>::GetFeaturePropertyCache'::`2'::data & 3) == 0
    || (`wil::Feature<__WilFeatureTraits_Feature_AllowSpatialLicenseSideLoad>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
  {
    v8 = 0;
