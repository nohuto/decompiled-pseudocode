/*
 * XREFs of ?QueryInterface@TelephonyController@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180146F70
 * Callers:
 *     ?QueryInterface@TelephonyController@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800699B0 (-QueryInterface@TelephonyController@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
