/*
 * XREFs of ?LogOnHmdRemoved@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@0@Z @ 0x1801194D0
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1801B1350 > 4 )
  {
    ...
    v10 = 0;
    v9 = 16;
    TlgWrite((TraceLoggingHProvider)&dword_1801B1350, &unk_180175A61, a3, a4, 4u, &v4);
  }
}
