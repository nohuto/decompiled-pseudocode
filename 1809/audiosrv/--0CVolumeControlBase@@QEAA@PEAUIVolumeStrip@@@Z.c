/*
 * XREFs of ??0CVolumeControlBase@@QEAA@PEAUIVolumeStrip@@@Z @ 0x18005B68C
 * Callers:
        ...
        struct IVolumeStrip *a2)
{
  ...
  *((_DWORD *)this + 60) = 0;
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_1ac98b3e4732363a42c9f2d13b70c7da_Traceguids, this);
  }
  return this;
}
