/*
 * XREFs of AudioVolumeSetChannelVolumeLevelScalar @ 0x1800BCBC0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a5)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v13[1], v8, (struct _TP_TIMER *)L"AudioVolumeSetChannelVolumeLevelScalar");
  v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64, __int64))(*(_QWORD *)*a1 + 96LL))(
          *a1,
          a2,
          v10,
          a4,
