/*
 * XREFs of ?UpdateCountOfPeriodicitySensitiveClients@CBaseStreamGroupProxy@@IEAAXH@Z @ 0x1800E5BEC
 * Callers:
...
void __fastcall CBaseStreamGroupProxy::UpdateCountOfPeriodicitySensitiveClients(CBaseStreamGroupProxy *this, int a2)
{
  ...
  *((_DWORD *)this + 34) = v3 + a2;
  ...
  if ( v5 )
  {
    v6 = *((_DWORD *)this + 34);
    if ( v3 != v6 && (!v3 || !v6) )
      (*(void (__fastcall **)(__int64, CBaseStreamGroupProxy *))(*(_QWORD *)v5 + 112LL))(v5, this);
  }
  if ( v4 )
