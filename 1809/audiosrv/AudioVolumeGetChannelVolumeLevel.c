/*
 * XREFs of AudioVolumeGetChannelVolumeLevel @ 0x1800BC490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetChannelVolumeLevel(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v12[1], v6, (struct _TP_TIMER *)L"AudioVolumeGetChannelVolumeLevel");
  v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)*a1 + 104LL))(*a1, a2, a3);
