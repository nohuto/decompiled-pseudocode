 ...
 *     ?Lookup@?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@QEBA_NAEBQEAVResourceConsumer@@AEAPEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@2@@Z @ 0x18013ED4C (-Lookup@-$CAtlMap@PEAVResourceConsumer@@PEAV-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL.c)
 *     ?Lookup@?$CAtlMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@W4RmResourceType@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@V?$CElementTraits@W4RmResourceType@@@2@@ATL@@QEBA_NPEBGAEAW4RmResourceType@@@Z @ 0x18013ED88 (-Lookup@-$CAtlMap@V-$CStringT@GV-$StrTraitATL@GV-$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@W4RmResourceTyp.c)
 *     ?SetAt@?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@QEAAPEAU__POSITION@@AEBQEAVResourceConsumer@@AEBQEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@2@@Z @ 0x18013F514 (-SetAt@-$CAtlMap@PEAVResourceConsumer@@PEAV-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@.c)
...
{
  __int64 v4; // r13
  struct IXmlReader *v5; // r12
  CConstraintModelXMLParser *v6; // r15
  int v7; // r14d
  __int64 *v8; // rax
  __int64 *v9; // rsi
  signed int StartElement; // edi
  ...
  while ( StartElement >= 0 )
  {
    ...
    StartElement = CConstraintModelXMLParser::FindStartOrEndElement(v6, v5, L"Resource", L"ResourceConsumer", 0, &v17);
    if ( StartElement >= 0 )
    {
      if ( v17 )
      {
        ...
        if ( StartElement >= 0 )
        {
                 ...
                 &v19) )
          {
            ...
            {
              if ( *(_DWORD *)(i + 16) == (_DWORD)v19 )
                goto LABEL_23;
            }
            i = 0LL;
LABEL_23:
            StartElement = i != 0 ? 0x80004005 : 0;
            v13 = i == 0;
            if ( i )
            {
              LogError((size_t *)L"Resource ID %s referenced in consumer has multiple consumptions declared", v32);
              v13 = i == 0;
            }
            v7 = v18;
            if ( v13 )
          ...
          else
          {
            ...
            LogError((size_t *)L"Resource ID %s referenced in consumer but limits not declared", v32);
          }
        }
      }
    }
