/*
 * XREFs of ?DeriveOffloadConnectorFormatFromStreamFormat@@YAJPEAVCEndpointCharacteristics@@PEAUtWAVEFORMATEX@@U_GUID@@22PEAPEAU2@@Z @ 0x1800D1950
 * Callers:
...
LABEL_14:
  if ( v16 >= 0 )
  {
    ...
    {
      v22 = *a4;
      if ( !(unsigned int)IsStreamFormatSupportedForMixFormat(a1, &v22, 1, v9, v13, 0LL) )
