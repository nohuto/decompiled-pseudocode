/*
 * XREFs of ?InitializeAPOs@CVolumeSoftware@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x1800B77A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
    ...
    if ( !*((_QWORD *)v6 + 31) )
    {
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x38u, (__int64)&WPP_1ac98b3e4732363a42c9f2d13b70c7da_Traceguids);
      }
      v7 = -2147467262;
      if ( v18 )
        LeaveCriticalSection(lpCriticalSection);
