/*
 * XREFs of ??1?$CAtlList@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@@ATL@@QEAA@XZ @ 0x180031B1C
 * Callers:
 ...
 *     _DynamicAudioEndpointManager::GetDefaultAudioEndpoint_::_1_::dtor$1 @ 0x18006D490 (_DynamicAudioEndpointManager--GetDefaultAudioEndpoint_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
