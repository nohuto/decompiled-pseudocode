/*
 * XREFs of _CDeviceGraphStore::GetSubmixHelper_::_1_::catch$323 @ 0x1800E89D6
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetSubmixHelper_::_1_::catch_323(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
