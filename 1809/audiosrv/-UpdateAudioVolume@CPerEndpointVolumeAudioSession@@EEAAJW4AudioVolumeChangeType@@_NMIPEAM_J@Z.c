/*
 * XREFs of ?UpdateAudioVolume@CPerEndpointVolumeAudioSession@@EEAAJW4AudioVolumeChangeType@@_NMIPEAM_J@Z @ 0x1800C3420
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( (unsigned int)(a2 - 2) <= 1 )
    return 0LL;
  v21 = 0LL;
  VolumeStrip = CPerEndpointVolumeAudioSession::GetVolumeStrip((struct IUnknown **)a1, &v21);
  v10 = VolumeStrip;
  if ( VolumeStrip >= 0 )
  {
    v12 = a1 + 336;
    VolumeStrip = (*(__int64 (__fastcall **)(struct IVolumeStrip *, _QWORD, __int64, _QWORD))(*(_QWORD *)v21 + 144LL))(
                    v21,
                    a3,
                    a1 + 336,
                    0LL);
    ...
    if ( a5 )
    {
      ...
      do
      {
        if ( v19 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v19 + 25) >= 4u )
        {
          WPP_SF_dg(*((_QWORD *)v19 + 2), 0x7Au, (__int64)&WPP_753fb3ff45c7308b48420cd59c2f48a5_Traceguids, v17);
          v19 = WPP_GLOBAL_Control;
        }
        if ( v17 < v23 )
        {
          v20 = (*(__int64 (__fastcall **)(struct IVolumeStrip *, _QWORD, __int64, __int64, _QWORD))(*(_QWORD *)v21 + 96LL))(
                  v21,
                  v17,
                  v14,
                  v12,
