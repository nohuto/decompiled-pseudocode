/*
 * XREFs of ?UpdateAuxiliaryInputForStreamGroup@@YAXAEBVWeakRef@WRL@Microsoft@@@Z @ 0x1800EDEDC
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_26d6b4fcc784cd5ce99dbb722cb42eb2__void_::_Do_call @ 0x1800E6050 (std--_Func_impl_no_alloc__lambda_26d6b4fcc784cd5ce99dbb722cb42eb2__void_--_Do_call.c)
 * Callees:
 *     <none>
 */
