/*
 * XREFs of __tailMerge_api_ms_win_core_winrt_error_l1_1_1_dll @ 0x1800625A0
 * Callers:
 *     __imp_load_RoGetMatchingRestrictedErrorInfo @ 0x180062594 (__imp_load_RoGetMatchingRestrictedErrorInfo.c)
 * Callees:
