/*
 * XREFs of ?SetDeviceSettings@SpatialAudioDevicePropertyWriter@@UEAAJPEAUSpatialAudioSettings@@PEAUSpatialAudioEncoderDescriptor@@I@Z @ 0x180125DB0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (_DWORD)v12 )
        {
          ...
          else
          {
            ...
            if ( (unsigned int)dword_1801B1488 > 2 )
            {
              ...
              v41 = &v26;
              v42 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801B1488, &unk_1801779E8, v20, v21, 5u, &pData);
            }
          }
        }
        else
...
LABEL_18:
    ...
    else if ( (unsigned int)dword_1801B1488 > 2 )
    {
      ...
      v41 = &v27;
      v42 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B1488, &unk_180177A22, v17, v18, 5u, &pData);
    }
  }
  return v19;
}
