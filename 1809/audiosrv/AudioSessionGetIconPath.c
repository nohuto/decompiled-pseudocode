/*
 * XREFs of AudioSessionGetIconPath @ 0x1800C5130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetIconPath(__int64 *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v11[1], v4, (struct _TP_TIMER *)L"AudioSessionGetIconPath");
  v6 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 200LL))(v2, a2);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetIconPath", 1940, v6);
