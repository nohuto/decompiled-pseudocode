/*
 * XREFs of ?RuntimeClassInitialize@CSaDeviceProxy@@QEAAJPEBUSaDeviceParams@@PEAVCEndpointCharacteristics@@PEAUIDeviceGraphObjectsStore@@W4_AUDCLNT_SHAREMODE@@KAEAUSaDeviceResourceParams@@@Z @ 0x18003EF00
 * Callers:
 ...
 *     WPP_SF_Sddd @ 0x1800E6718 (WPP_SF_Sddd.c)
 */
        ...
        struct SaDeviceResourceParams *a7)
{
  ...
  DWORD LastError; // ebx
  int v51; // [rsp+20h] [rbp-81h]
  int v52; // [rsp+20h] [rbp-81h]
  LPMALLOC ppMalloc[2]; // [rsp+60h] [rbp-41h] BYREF
  __int64 v54; // [rsp+70h] [rbp-31h]
  struct _GUID v55; // [rsp+80h] [rbp-21h] BYREF
  struct _GUID v56; // [rsp+90h] [rbp-11h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+E8h] [rbp+47h]
  struct IAudioDeviceGraph *v58; // [rsp+F0h] [rbp+4Fh] BYREF
  LPMALLOC v59; // [rsp+F8h] [rbp+57h] BYREF
  struct CEndpointCharacteristics *v60; // [rsp+100h] [rbp+5Fh]
