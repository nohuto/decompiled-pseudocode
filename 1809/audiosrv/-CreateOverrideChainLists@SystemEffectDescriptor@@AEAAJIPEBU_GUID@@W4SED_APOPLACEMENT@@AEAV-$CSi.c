/*
 * XREFs of ?CreateOverrideChainLists@SystemEffectDescriptor@@AEAAJIPEBU_GUID@@W4SED_APOPLACEMENT@@AEAV?$CSimpleArray@U_GUID@@V?$CSimpleArrayEqualHelper@U_GUID@@@ATL@@@ATL@@2@Z @ 0x18004E99C
 * Callers:
...
LABEL_8:
      ...
      while ( 1 )
      {
        ...
        if ( !(unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Add(a6, v14) )
          break;
        v11 = *(_QWORD *)(a1 + 16);
        if ( (signed int)++v13 >= *(_DWORD *)(v11 + 48) )
          return 0LL;
      }
      v16 = 291LL;
    }
