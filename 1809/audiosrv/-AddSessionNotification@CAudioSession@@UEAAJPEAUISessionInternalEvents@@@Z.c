/*
 * XREFs of ?AddSessionNotification@CAudioSession@@UEAAJPEAUISessionInternalEvents@@@Z @ 0x18000D870
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::AddSessionNotification(CAudioSession *this, struct ISessionInternalEvents *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 92LL, &WPP_753fb3ff45c7308b48420cd59c2f48a5_Traceguids, a2);
  }
  if ( a2 )
