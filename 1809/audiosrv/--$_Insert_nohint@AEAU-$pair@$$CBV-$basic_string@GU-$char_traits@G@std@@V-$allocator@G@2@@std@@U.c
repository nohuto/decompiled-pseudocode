...
LABEL_47:
    ...
    if ( v32 >= 0 )
    {
      ...
      v34 = *(_QWORD *)(a5 + 56);
      if ( v34 >= 8 )
        std::_Deallocate<16,0>(*(void **)(a5 + 32), (const struct std::nothrow_t *)(2 * v34 + 2));
      *(_QWORD *)(v33 + 48) = 0LL;
      *(_QWORD *)(v33 + 56) = 7LL;
      *(_WORD *)(v33 + 32) = 0;
