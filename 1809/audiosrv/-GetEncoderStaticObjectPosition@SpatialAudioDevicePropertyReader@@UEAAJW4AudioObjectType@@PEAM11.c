/*
 * XREFs of ?GetEncoderStaticObjectPosition@SpatialAudioDevicePropertyReader@@UEAAJW4AudioObjectType@@PEAM11@Z @ 0x180126FD0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  else
  {
    if ( (unsigned int)dword_1801B1488 > 2 )
    {
      ...
      v24 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801B1488, &unk_1801779E8, v11, v12, 5u, &pData);
    }
