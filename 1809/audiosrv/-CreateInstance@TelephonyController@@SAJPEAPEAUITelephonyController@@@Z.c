/*
 * XREFs of ?CreateInstance@TelephonyController@@SAJPEAPEAUITelephonyController@@@Z @ 0x18014597C
 * Callers:
 ...
 *     ?GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ @ 0x180145FC0 (-GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ.c)
