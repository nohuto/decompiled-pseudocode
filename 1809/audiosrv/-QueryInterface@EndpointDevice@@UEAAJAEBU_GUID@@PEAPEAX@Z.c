/*
 * XREFs of ?QueryInterface@EndpointDevice@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004D5C0
 * Callers:
 *     ?QueryInterface@EndpointDevice@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180069970 (-QueryInterface@EndpointDevice@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
