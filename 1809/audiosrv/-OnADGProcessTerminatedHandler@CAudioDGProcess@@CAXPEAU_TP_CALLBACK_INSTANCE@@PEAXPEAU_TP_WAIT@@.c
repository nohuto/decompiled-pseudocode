/*
 * XREFs of ?OnADGProcessTerminatedHandler@CAudioDGProcess@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x18012E730
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a4)
{
  ...
  v4 = dword_1801B14C0;
  if ( (unsigned int)dword_1801B14C0 > 2 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801B14C0, 0x400000000000uLL) )
  {
    TlgWrite((TraceLoggingHProvider)&dword_1801B14C0, &unk_180177BBD, a3, a4, 2u, &pData);
  ...
  if ( (_DWORD)a4 )
  {
    if ( v4 > 2 )
    {
      ...
      v12 = 4;
      v15 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1801B14C0, &unk_180177A9E, a3, a4, 5u, &v7);
    }
  }
  else
  {
