/*
 * XREFs of ?ProcessRenderBufferReadyEvent@CMonitor@@AEAAXXZ @ 0x180102CEC
 * Callers:
 ...
 *     ?GetHead@?$CAtlList@PEAUSampleDataBlock@CMonitor@@V?$CElementTraits@PEAUSampleDataBlock@CMonitor@@@ATL@@@ATL@@QEAAAEAPEAUSampleDataBlock@CMonitor@@XZ @ 0x1801007F0 (-GetHead@-$CAtlList@PEAUSampleDataBlock@CMonitor@@V-$CElementTraits@PEAUSampleDataBlock@CMonitor.c)
...
void __fastcall CMonitor::ProcessRenderBufferReadyEvent(CMonitor *this)
{
  ...
  unsigned __int64 v22; // [rsp+20h] [rbp-E8h]
  unsigned __int64 v23; // [rsp+28h] [rbp-E0h]
  ...
  ATL::CAtlException *v30; // [rsp+80h] [rbp-88h] BYREF
  LPCRITICAL_SECTION lpCriticalSection; // [rsp+88h] [rbp-80h] BYREF
  char v32; // [rsp+90h] [rbp-78h]
  int v34; // [rsp+118h] [rbp+10h] BYREF
  unsigned __int64 v35; // [rsp+120h] [rbp+18h] BYREF
...
LABEL_2:
  ...
  if ( !*((_QWORD *)v1 + 45) )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, (__int64)&WPP_19c32bd6ba053f64fb4a85d982837be5_Traceguids);
    }
...
LABEL_18:
        if ( v8 )
LABEL_19:
          CMonitor::SampleDataBlock::`scalar deleting destructor'((void **)v8);
LABEL_52:
        if ( v32 )
          LeaveCriticalSection(lpCriticalSection);
        goto LABEL_54;
