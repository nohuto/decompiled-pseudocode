/*
 * XREFs of _AtmosCheck::GetLicenseStatusForEndpointId_::_1_::dtor$0 @ 0x18013965D
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall AtmosCheck::GetLicenseStatusForEndpointId_::_1_::dtor_0(__int64 a1, __int64 a2)
{
