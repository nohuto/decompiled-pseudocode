/*
 * XREFs of ?Shutdown@CSpatialAudioResourceManager@Sarm@@UEAAXXZ @ 0x180115C00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextValue@?$CAtlMap@PEAUISaDeviceProxy@@VCEndpointResourcePool@Sarm@@V?$CElementTraits@PEAUISaDeviceProxy@@@ATL@@V?$CElementTraits@VCEndpointResourcePool@Sarm@@@5@@ATL@@QEAAAEAVCEndpointResourcePool@Sarm@@AEAPEAU__POSITION@@@Z @ 0x180113E84 (-GetNextValue@-$CAtlMap@PEAUISaDeviceProxy@@VCEndpointResourcePool@Sarm@@V-$CElementTraits@PEAUI.c)
...
LABEL_5:
  ...
  *((_QWORD *)this + 38) = v5;
  ...
  while ( NextValue )
  {
    Sarm::CSpatialAudioResourceManager::RemoveStream((struct IAudioProcess **)this, NextValue);
