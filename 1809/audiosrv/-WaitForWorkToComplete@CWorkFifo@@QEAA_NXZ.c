/*
 * XREFs of ?WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ @ 0x180115ECC
 * Callers:
 ...
 * Callees:
 *     ?FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x1800AD338 (-FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
...
char __fastcall CWorkFifo::WaitForWorkToComplete(CWorkFifo *this)
{
  ...
  if ( v3 )
  {
    ...
    if ( v4 != 258 )
    {
      if ( v4 )
      {
        wil::details::in1diag3::FailFast_Unexpected(retaddr, 2567LL, v5, v6);
        __debugbreak();
      }
