/*
 * XREFs of ?ToString@CAudioSessionInstanceId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x18002B7E0
 * Callers:
...
__int64 __fastcall CAudioSessionInstanceId::ToString(__int64 a1, void **a2)
{
  ...
  if ( v4 - 24 != (char *)v6 )
  {
    ...
    catch ( ATL::CAtlException *v13 )
    {
      ...
      v3 = *v9;
      if ( v14 < 0 )
        AudSrvTraceLoggingErrorHelper("CAudioSessionInstanceId::ToString", 1050, v14);
    }
  }
  return v3;
}
