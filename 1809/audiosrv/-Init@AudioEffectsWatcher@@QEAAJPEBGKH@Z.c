/*
 * XREFs of ?Init@AudioEffectsWatcher@@QEAAJPEBGKH@Z @ 0x1800BD6A0
 * Callers:
...
__int64 __fastcall AudioEffectsWatcher::Init(char *pv, const unsigned __int16 *a2, int a3, int a4)
{
  ...
  do
    ++v11;
  while ( a2[v11] );
  PropertyStoreProperty = _AllocStringWorker<CTCoAllocPolicy>(v9, v8, a2, v11, v19, (void **)pv + 3);
...
LABEL_9:
    ...
    *(_QWORD *)(pv + 92) = v24;
    pv[88] = 1;
    PropertyStoreProperty = (*(__int64 (__fastcall **)(PVOID, const unsigned __int16 *, _QWORD, _QWORD, CEndpointCharacteristics **))(*(_QWORD *)g_pEndpointCharacteristicsCache + 24LL))(
    ...
    {
      v14 = RtlPublishWnfStateData(*(_QWORD *)(pv + 92), 0LL, &unk_1801799F8, 16LL, 0LL);
      if ( v14 < 0 )
        goto LABEL_9;
    }
