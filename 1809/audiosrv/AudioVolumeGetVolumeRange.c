/*
 * XREFs of AudioVolumeGetVolumeRange @ 0x1800BC890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetVolumeRange(_QWORD *a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v13[1], v9, (struct _TP_TIMER *)L"AudioVolumeGetVolumeRange");
  v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64, __int64))(*(_QWORD *)*a1 + 200LL))(
          *a1,
          a2,
          a3,
          a4,
