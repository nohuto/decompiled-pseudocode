/*
 * XREFs of AudioServerTelephonyControlGetMaxCallInstanceCount @ 0x1800DF0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlGetMaxCallInstanceCount(__int64 a1, __int64 a2)
{
  ...
  v5 = ((__int64 (__fastcall *)(struct IUnknown *, __int64))g_TelephonyControl->lpVtbl[5].AddRef)(
         g_TelephonyControl,
         a2);
