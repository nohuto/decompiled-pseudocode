/*
 * XREFs of ?SetVolume@CPerStreamVolumeAudioSession@@EEAAJMPEBU_GUID@@PEAH@Z @ 0x180010AF0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a4)
{
  ...
  {
    v11 = a2;
    WPP_SF_Sg(*((_QWORD *)WPP_GLOBAL_Control + 2), 16, (_DWORD)a3, *((_QWORD *)this + 96), SLOBYTE(v11));
  }
