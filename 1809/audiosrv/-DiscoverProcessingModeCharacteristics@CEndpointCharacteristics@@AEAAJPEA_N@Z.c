/*
 * XREFs of ?DiscoverProcessingModeCharacteristics@CEndpointCharacteristics@@AEAAJPEA_N@Z @ 0x18004BBA8
 * Callers:
 ...
 *     ?Start@CQPCStopWatch@@QEAAHXZ @ 0x1800DB500 (-Start@CQPCStopWatch@@QEAAHXZ.c)
  ...
  if ( ProcessingModeCharacteristicsFromPropertyStore < 0 )
  {
    ...
    *(__int64 *)((char *)&v32[28] + 4) = 0LL;
      ...
      && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
    {
      ...
      v40 = 8LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_180174DB9, v13, v14, 5u, &pData);
    }
