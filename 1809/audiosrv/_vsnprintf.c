/*
 * XREFs of _vsnprintf @ 0x1800616DC
 * Callers:
 *     ?StringCbPrintfA@@YAJPEAD_KPEBDZZ @ 0x180141644 (-StringCbPrintfA@@YAJPEAD_KPEBDZZ.c)
 * Callees:
 *     __local_stdio_printf_options @ 0x1800601A4 (__local_stdio_printf_options.c)
 *     _o___stdio_common_vsprintf_0 @ 0x1800615EE (_o___stdio_common_vsprintf_0.c)
 */
