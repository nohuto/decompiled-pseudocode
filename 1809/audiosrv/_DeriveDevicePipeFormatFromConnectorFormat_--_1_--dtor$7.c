/*
 * XREFs of _DeriveDevicePipeFormatFromConnectorFormat_::_1_::dtor$7 @ 0x1800D1450
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DeriveDevicePipeFormatFromConnectorFormat_::_1_::dtor_7(__int64 a1, __int64 a2)
{
