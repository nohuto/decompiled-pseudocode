/*
 * XREFs of ?SetDefaultEndpointForPolicy@CPolicyConfig@@UEAAJPEBGW4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@@Z @ 0x1800D3FB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPolicyConfig::SetDefaultEndpointForPolicy(__int64 a1, __int64 a2)
{
  ...
  if ( !a2 )
  {
    v2 = -2147467261;
LABEL_4:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetDefaultEndpointForPolicy", 4434, v2);
