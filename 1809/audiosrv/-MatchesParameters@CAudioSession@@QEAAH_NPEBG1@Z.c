/*
 * XREFs of ?MatchesParameters@CAudioSession@@QEAAH_NPEBG1@Z @ 0x1800C1224
 * Callers:
        ...
        const unsigned __int16 *a4)
{
  ...
  v15 = 0LL;
  v7 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 776);
  EnterCriticalSection((LPCRITICAL_SECTION)((char *)this + 776));
  v8 = (__int64 *)*((_QWORD *)this + 102);
  if ( *((_QWORD *)this + 103) - (_QWORD)v8 < 8uLL || (v9 = *v8) == 0 )
  {
    if ( v7 )
