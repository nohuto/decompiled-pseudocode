/*
 * XREFs of ??$MakeAndInitialize@VDynamicAudioEndpointManager@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVDynamicAudioEndpointManager@@@Z @ 0x18005C8B4
 * Callers:
        ...
        DynamicAudioEndpointManager **a1)
{
  ...
  *a1 = 0LL;
  v2 = (DynamicAudioEndpointManager *)operator new(0x380uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v2 )
  {
