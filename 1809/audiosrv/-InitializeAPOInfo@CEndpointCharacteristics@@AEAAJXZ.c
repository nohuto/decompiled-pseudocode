/*
 * XREFs of ?InitializeAPOInfo@CEndpointCharacteristics@@AEAAJXZ @ 0x18010BBCC
 * Callers:
    ...
    if ( (int)v21 > 0 )
    {
      while ( 1 )
      {
        ...
        v22 = *(struct _GUID *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](
                                 (__int64)&v20,
                                 v6);
        if ( (int)CEndpointCharacteristics::GetStreamEffect(this, &v22, 1u, *v3, 0LL, 0LL, &v19) < 0 )
          goto LABEL_7;
        v7 = v19;
        if ( v19 )
          break;
...
LABEL_11:
  ...
  while ( 1 )
  {
    v20 = 0LL;
    v21 = 0LL;
    v10 = SystemEffectDescriptor::GetSupportedProcessingModes((char *)this + 96 * v8 + 616, &v20, 1LL);
    v11 = v10;
    if ( v10 < 0 )
    {
      wil::details::in1diag3::Return_Hr(
...
LABEL_26:
  ...
  while ( 1 )
  {
    ...
    if ( (int)CEndpointCharacteristics::GetModeEffect(this, &v22, 1u, *v9, 0LL, 0LL, &v19) < 0 )
      goto LABEL_22;
    v13 = v19;
    if ( v19 )
      break;
