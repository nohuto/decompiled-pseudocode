/*
 * XREFs of ?AddTail@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z @ 0x1801456C0
 * Callers:
 *     ?Initialize@TelephonyController@@IEAAJXZ @ 0x180146238 (-Initialize@TelephonyController@@IEAAJXZ.c)
 * Callees:
 *     ?NewNode@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z @ 0x180146D24 (-NewNode@-$CAtlList@IV-$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z.c)
 */
