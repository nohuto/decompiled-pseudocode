/*
 * XREFs of ?Create@CSystemEffectWrapper@@SAJAEBU_GUID@@PEAUIMMDevice@@PEBGW4APO_TYPE@@PEAUIUnknown@@PEAPEAU5@@Z @ 0x180130BF4
 * Callers:
 ...
 * Callees:
 *     ??0CSystemEffectWrapper@@QEAA@XZ @ 0x180130434 (--0CSystemEffectWrapper@@QEAA@XZ.c)
