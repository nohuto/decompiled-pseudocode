/*
 * XREFs of ?wil_details_RecordCachedUsage@@YAXIPEATwil_details_FeaturePropertyCache@@P6AXIIIPEBD@Z@Z @ 0x180063A04
 * Callers:
        ...
        void (*a3)(unsigned int, unsigned int, unsigned int, const char *))
{
  ...
  wil_details_ModifyFeatureData(
    a2,
    (unsigned int (__fastcall *)(signed __int32 *, void *))wil_details_CaptureReportedUsageCallback,
    &v8);
  v10 = 2;
