        ...
        __int64 a3)
{
  ...
  v10 = v8[7];
  if ( v10 >= 8 )
    std::_Deallocate<16,0>((void *)v8[4], (const struct std::nothrow_t *)(2 * v10 + 2));
  v8[6] = 0LL;
  v8[7] = 7LL;
  *((_WORD *)v8 + 16) = 0;
