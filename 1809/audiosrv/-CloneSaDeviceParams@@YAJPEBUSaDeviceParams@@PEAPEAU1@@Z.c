/*
 * XREFs of ?CloneSaDeviceParams@@YAJPEBUSaDeviceParams@@PEAPEAU1@@Z @ 0x18000A550
 * Callers:
 *     ?GetSaDeviceParams@CSaDeviceProxy@@UEAAJPEAPEAUSaDeviceParams@@@Z @ 0x18000A540 (-GetSaDeviceParams@CSaDeviceProxy@@UEAAJPEAPEAUSaDeviceParams@@@Z.c)
 * Callees:
...
__int64 __fastcall CloneSaDeviceParams(const struct SaDeviceParams *a1, struct SaDeviceParams **a2)
{
  ...
  v27 = a2;
  *(_QWORD *)&v3 = operator new(0x60uLL, (const struct std::nothrow_t *)&std::nothrow);
  v4 = v3;
  if ( (_QWORD)v3 )
  {
    memset_0((void *)v3, 0, 0x60uLL);
    *(_QWORD *)v4 = 0LL;
    *(_QWORD *)(v4 + 16) = 0LL;
    *(_QWORD *)(v4 + 24) = 0LL;
  }
