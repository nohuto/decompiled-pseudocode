/*
 * XREFs of PolicyConfigSetEndpointAbilityToBeDefault @ 0x1800D7EC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PolicyConfigSetEndpointAbilityToBeDefault(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v5, (struct _TP_TIMER *)L"PolicyConfigSetEndpointAbilityToBeDefault");
  v7 = (*(__int64 (__fastcall **)(struct IPolicyConfig *, __int64, _QWORD))(*(_QWORD *)g_PolicyConfig + 128LL))(
         g_PolicyConfig,
         a2,
         a3);
