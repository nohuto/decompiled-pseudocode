/*
 * XREFs of AudioVolumeGetChannelVolumeLevelScalar @ 0x1800BC590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeGetChannelVolumeLevelScalar(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v12[1], v6, (struct _TP_TIMER *)L"AudioVolumeGetChannelVolumeLevelScalar");
  v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(*(_QWORD *)*a1 + 112LL))(*a1, a2, a3);
