/*
 * XREFs of McTemplateU0qqzr1qzr3qqqxqqqpqzr13q @ 0x1801343C4
 * Callers:
        ...
        char a18)
{
  ...
  v49 = 4LL;
  v54 = 4LL;
  return McGenEventWrite(PDC_EVENT_PROVIDER_Context, (__int64)&PDCV2_ACTIVATION_RENEW_ACTIVATION, a3, 17, (__int64)v19);
}
