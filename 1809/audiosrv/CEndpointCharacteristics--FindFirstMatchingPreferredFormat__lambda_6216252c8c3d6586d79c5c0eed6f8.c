/*
 * XREFs of CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_6216252c8c3d6586d79c5c0eed6f8f6d___ @ 0x18010564C
 * Callers:
  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)&v15[1].nChannels = *v11;
      ...
      if ( v22 && (unsigned __int8)lambda_068f763f677867854f08eaa5008b23ee_::operator()(v24 + 3, Src) )
      {
