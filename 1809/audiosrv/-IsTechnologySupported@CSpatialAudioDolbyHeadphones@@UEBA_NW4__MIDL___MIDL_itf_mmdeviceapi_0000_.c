/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDolbyHeadphones@@UEBA_NW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003@@PEBUtWAVEFORMATEX@@1V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@PEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x1800555E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
      v21 = v34;
      CSpatialAudioTech::AssignPriority(v34, v9, Headphones, 2u, v11, v28);
      v13 = v28[0];
      if ( v28[0] )
      {
        if ( *v11 )
        ...
        {
          CSpatialAudioTech::AssignPriority(v21, v9, Speakers, 2u, v11, v28);
          v13 = v28[0];
        }
      }
    }
