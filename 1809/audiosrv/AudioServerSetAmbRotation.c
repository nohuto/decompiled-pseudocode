/*
 * XREFs of AudioServerSetAmbRotation @ 0x1800DE810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerSetAmbRotation(char *a1, __int64 a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(char *, __int64))(*(_QWORD *)a1 + 160LL))(a1, a2);
  v5 = v4;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerSetAmbRotation", 4743, v4);
