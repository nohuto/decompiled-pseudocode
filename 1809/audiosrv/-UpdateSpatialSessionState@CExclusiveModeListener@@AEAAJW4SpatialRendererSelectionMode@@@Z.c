/*
 * XREFs of ?UpdateSpatialSessionState@CExclusiveModeListener@@AEAAJW4SpatialRendererSelectionMode@@@Z @ 0x18011AB08
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1801B1350 > 5 )
  {
    ...
    v23 = 4;
    v24 = 0;
    TlgWrite((TraceLoggingHProvider)&dword_1801B1350, &unk_1801759EC, a3, a4, 4u, &pData);
    v6 = *(_DWORD *)(a1 + 152);
  }
  if ( a2 == v6 )
    return 0LL;
