/*
 * XREFs of ?DiscoverProcessingModeCapabilities@CEndpointCharacteristics@@AEAAJ_N@Z @ 0x18004ECF4
 * Callers:
...
LABEL_25:
  ...
  *((_QWORD *)this + 174) = 0LL;
  ...
  v49 = (struct IPropertyStore *)*((_QWORD *)this + 8);
  if ( v49
  ...
  else
  {
                         ...
                         &GUID_9e90ea20_b493_4fd1_a1a8_7e1361a956cf) == -1 )
    {
      if ( (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find(
        ...
        v50 = (GUID *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](v10, 0LL);
      else
        v50 = &GUID_c18e2f7e_933d_4965_b7d1_1eef228d2af3;
    }
    v68.fmtid = *v50;
    if ( !(unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Add((__int64)this + 136, &v68) )
    {
