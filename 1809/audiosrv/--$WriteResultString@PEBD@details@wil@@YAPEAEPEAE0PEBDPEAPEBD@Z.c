/*
 * XREFs of ??$WriteResultString@PEBD@details@wil@@YAPEAEPEAE0PEBDPEAPEBD@Z @ 0x1800ACE64
 * Callers:
 ...
 * Callees:
 *     ?ResultStringSize@details@wil@@YA_KPEBD@Z @ 0x1800ADCD8 (-ResultStringSize@details@wil@@YA_KPEBD@Z.c)
