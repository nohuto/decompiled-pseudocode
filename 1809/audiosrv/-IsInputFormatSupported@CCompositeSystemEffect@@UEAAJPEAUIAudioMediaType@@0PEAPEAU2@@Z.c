/*
 * XREFs of ?IsInputFormatSupported@CCompositeSystemEffect@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z @ 0x1801113B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioMediaType **a4)
{
  ...
  v44[0] = (__int64)a2;
  Microsoft::WRL::ComPtr<ISaDeviceProxy>::InternalAddRef(v44);
  v34 = 0LL;
  if ( v9 != v46 )
  {
    v16 = (char *)this + 64;
