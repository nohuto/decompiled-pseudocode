/*
 * XREFs of _dynamic_initializer_for__g_AudioLicenseTraceLoggingProviderRegistration__ @ 0x180001480
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_AudioLicenseTraceLoggingProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1801B1580, a2, a3);
