/*
 * XREFs of ??1?$map@U_GUID@@UHmdInfo@@U?$less@U_GUID@@@std@@V?$allocator@U?$pair@$$CBU_GUID@@UHmdInfo@@@std@@@4@@std@@QEAA@XZ @ 0x180112D68
 * Callers:
 *     _CExclusiveModeListener::CExclusiveModeListener_::_1_::dtor$5 @ 0x180112CDD (_CExclusiveModeListener--CExclusiveModeListener_--_1_--dtor$5.c)
 * Callees:
