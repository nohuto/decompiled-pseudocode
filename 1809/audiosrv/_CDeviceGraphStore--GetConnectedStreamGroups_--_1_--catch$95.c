/*
 * XREFs of _CDeviceGraphStore::GetConnectedStreamGroups_::_1_::catch$95 @ 0x1800E8154
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetConnectedStreamGroups_::_1_::catch_95(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
