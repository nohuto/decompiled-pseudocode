/*
 * XREFs of ?InternalRelease@?$ComPtr@VCAudioSessionManagerProvider@@@WRL@Microsoft@@IEAAKXZ @ 0x18005FB18
 * Callers:
 ...
 *     ??1?$ComPtr@VCAudioSessionManagerProvider@@@WRL@Microsoft@@QEAA@XZ @ 0x1800CA210 (--1-$ComPtr@VCAudioSessionManagerProvider@@@WRL@Microsoft@@QEAA@XZ.c)
