/*
 * XREFs of _DeriveDevicePipeFormatFromConnectorFormat_::_1_::dtor$1 @ 0x1800D1408
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DeriveDevicePipeFormatFromConnectorFormat_::_1_::dtor_1(__int64 a1, __int64 a2)
{
