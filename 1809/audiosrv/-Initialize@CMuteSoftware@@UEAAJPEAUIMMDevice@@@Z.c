/*
 * XREFs of ?Initialize@CMuteSoftware@@UEAAJPEAUIMMDevice@@@Z @ 0x1800B5B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMuteSoftware::Initialize(CMuteSoftware *this, struct IMMDevice *a2)
{
  ...
  if ( ThreadPool )
  {
    v4 = (*(__int64 (__fastcall **)(struct CAudioThreadPool *, void (*)(struct _TP_CALLBACK_INSTANCE *, void *, struct _TP_TIMER *), CMuteSoftware *))(*(_QWORD *)ThreadPool + 8LL))(
           ThreadPool,
