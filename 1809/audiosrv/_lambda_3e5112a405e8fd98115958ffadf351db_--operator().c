/*
 * XREFs of _lambda_3e5112a405e8fd98115958ffadf351db_::operator() @ 0x1800648B4
 * Callers:
...
__int64 __fastcall lambda_3e5112a405e8fd98115958ffadf351db_::operator()(__int64 a1, char a2)
{
