/*
 * XREFs of _dynamic_initializer_for__g_SarmTelemetryProviderRegistration__ @ 0x1800012D0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_SarmTelemetryProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1801B1350, a2, a3);
