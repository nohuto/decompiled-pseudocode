/*
 * XREFs of __report_gsfailure @ 0x14000D2A0
 * Callers:
 *     __security_check_cookie @ 0x14000D270 (__security_check_cookie.c)
 * Callees:
 *     NtTerminateProcess_0 @ 0x14000D4DA (NtTerminateProcess_0.c)
 *     RtlCaptureContext_0 @ 0x14000D4F2 (RtlCaptureContext_0.c)
 *     RtlLookupFunctionEntry_0 @ 0x14000D4FE (RtlLookupFunctionEntry_0.c)
 *     RtlVirtualUnwind_0 @ 0x14000D50A (RtlVirtualUnwind_0.c)
 *     RtlUnhandledExceptionFilter_0 @ 0x14000D516 (RtlUnhandledExceptionFilter_0.c)
 */
...
void __cdecl __noreturn _report_gsfailure(uintptr_t StackCookie)
{
  ...
  qword_140024EF0 = ContextRecord.Rip;
  ContextRecord.Rcx = v7;
  dword_140024EE0 = -1073740791;
  dword_140024EE4 = 1;
  dword_140024EF8 = 1;
  unk_140024F00 = 2LL;
