/*
 * XREFs of SmpCreateSecurityDescriptors @ 0x1400051C0
 * Callers:
 *     SmpConfigureProtectionMode @ 0x140005190 (SmpConfigureProtectionMode.c)
...
__int64 __fastcall SmpCreateSecurityDescriptors(char a1)
{
  ...
  _SID_IDENTIFIER_AUTHORITY IdentifierAuthority; // [rsp+C0h] [rbp+17h] BYREF
