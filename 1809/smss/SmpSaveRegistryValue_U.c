/*
 * XREFs of SmpSaveRegistryValue_U @ 0x140009410
 * Callers:
 *     SmpSaveRegistryValue @ 0x140008F18 (SmpSaveRegistryValue.c)
 *     SmpConfigureKnownDlls @ 0x140008F90 (SmpConfigureKnownDlls.c)
...
LABEL_7:
  ...
  v12 = (WCHAR *)RtlAllocateHeap(*(PVOID *)(*(_QWORD *)&KeGetPcr()->MajorVersion + 48LL), SmBaseTag, a3->MaximumLength);
  v10[2].Buffer = v12;
  if ( !v12 )
    goto LABEL_26;
...
LABEL_10:
  if ( v5 )
  {
    v13 = (struct _UNICODE_STRING **)a1[1];
