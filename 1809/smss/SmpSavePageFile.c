/*
 * XREFs of SmpSavePageFile @ 0x1400145E8
 * Callers:
 *     SmpCheckForCrashDump @ 0x14000B6CC (SmpCheckForCrashDump.c)
 *     SmpSaveOldPageFile @ 0x14001443C (SmpSaveOldPageFile.c)
 * Callees:
 *     RtlStringCbCopyW @ 0x140007CA4 (RtlStringCbCopyW.c)
 ...
 *     SmpSetEndOfFile @ 0x140014954 (SmpSetEndOfFile.c)
 */
