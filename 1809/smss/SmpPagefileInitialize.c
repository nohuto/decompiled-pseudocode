/*
 * XREFs of SmpPagefileInitialize @ 0x14000BD30
 * Callers:
 *     SmpAsyncMemoryConfiguration @ 0x14000BBB0 (SmpAsyncMemoryConfiguration.c)
 * Callees:
 *     SmpQueryFilterPagesDumpSetting @ 0x14000BF04 (SmpQueryFilterPagesDumpSetting.c)
 *     SmpQueryCrashDumpType @ 0x14000BF54 (SmpQueryCrashDumpType.c)
 ...
 *     SmpQueryCopyDumpSetting @ 0x14000D678 (SmpQueryCopyDumpSetting.c)
...
NTSTATUS SmpPagefileInitialize()
{
  ...
  qword_140025E78 = (__int64)&SmpPagingFileDescriptorList;
  SmpPagingFileDescriptorList = &SmpPagingFileDescriptorList;
  qword_140025E58 = (__int64)&SmpVolumeDescriptorList;
