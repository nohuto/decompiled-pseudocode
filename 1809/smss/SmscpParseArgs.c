/*
 * XREFs of SmscpParseArgs @ 0x140002444
 * Callers:
 *     SmscMain @ 0x140001234 (SmscMain.c)
 * Callees:
 *     SmpGetFirstSessionId @ 0x1400026CC (SmpGetFirstSessionId.c)
 *     SmscpSetupSharedSpace @ 0x1400026F8 (SmscpSetupSharedSpace.c)
 *     SmscpIsDebuggerPresent @ 0x140016A98 (SmscpIsDebuggerPresent.c)
 */
...
LABEL_16:
              ...
              && (SystemInformation[0] & 0x4000004) != 0 )
            {
              ...
              {
                RtlAppendUnicodeStringToString(a4, &stru_140017CA0);
                v32 = SystemInformation[0];
                if ( (SystemInformation[0] & 0x20000) != 0 )
                {
                  RtlAppendUnicodeStringToString(a4, &stru_140017C90);
                  v32 = SystemInformation[0];
                }
                if ( (v32 & 0x4000000) != 0 )
                  RtlAppendUnicodeStringToString(a4, &stru_140017C80);
              }
            }
LABEL_17:
            v20 = v4;
