/*
 * XREFs of SmpConfigureSharedSessionData @ 0x140007620
 * Callers:
...
NTSTATUS SmpConfigureSharedSessionData()
{
  ...
  __int64 (__usercall *v24)@<rax>(wchar_t *@<rcx>, int, __int64); // [rsp+A8h] [rbp-60h] BYREF
  ...
  v47 = L"Execute";
  v48 = &dword_140026348;
  qword_140026368 = (__int64)&qword_140026360;
  qword_140026360 = (__int64)&qword_140026360;
  v29 = 0LL;
  v30 = 0;
  v35 = 0;
  v36 = 0LL;
  ...
  v56 = 0LL;
  v57 = 0;
  qword_140026358 = (__int64)&qword_140026350;
  qword_140026350 = &qword_140026350;
  qword_140026378 = (__int64)&qword_140026370;
  qword_140026370 = (__int64)&qword_140026370;
  result = RtlQueryRegistryValuesEx(2LL, L"Session Manager", &v24, 0LL, 0LL);
  if ( result >= 0 )
  {
    v2 = (PVOID *)qword_140026350;
    while ( v2 != &qword_140026350 )
    {
      v3 = (PVOID *)*v2;
      v4 = v2;
      v2 = v3;
    ...
    if ( (__int64 *)qword_140026370 == &qword_140026370 )
    {
      v6 = 0LL;
    }
    else
    {
      v6 = qword_140026378;
      v18 = *(_QWORD **)(qword_140026378 + 8);
      if ( *(__int64 **)qword_140026378 != &qword_140026370 || *v18 != qword_140026378 )
LABEL_25:
        __fastfail(3u);
      qword_140026378 = *(_QWORD *)(qword_140026378 + 8);
      *v18 = &qword_140026370;
    }
    SmpInitExecuteCmd = v6;
    v7 = (16LL * (unsigned int)dword_140026348 + 105) & 0xFFFFFFFFFFFFFFFEuLL;
    if ( v6 )
    ...
    if ( result >= 0 )
    {
      ...
      if ( result >= 0 )
      {
        ...
        *(_WORD *)v14 = 0;
        ...
        SmpCopyListToSharedSection((unsigned int)&qword_140026360, 0, 1, 0, (__int64)&v20, (__int64)&v19);
        SmpCopyListToSharedSection((unsigned int)&SmpSubSystemsRequired, 1, 0, 1, (__int64)&v20, (__int64)&v19);
        SmpCopyListToSharedSection((unsigned int)&qword_140026370, 0, 1, 2, (__int64)&v20, (__int64)&v19);
