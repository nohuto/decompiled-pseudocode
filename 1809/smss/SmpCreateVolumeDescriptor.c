/*
 * XREFs of SmpCreateVolumeDescriptor @ 0x140006DD0
 * Callers:
 ...
 *     SmpIsVhdVolume @ 0x140007424 (SmpIsVhdVolume.c)
...
int __fastcall SmpCreateVolumeDescriptor(unsigned __int16 a1, struct _UNICODE_STRING *a2, struct _UNICODE_STRING *a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v5 < 0 )
  {
    ...
    v17 = 2LL * v16;
    *((_DWORD *)&SmpPagefileLog + 4 * v16) = 1355;
LABEL_33:
    LODWORD(Heap) = a1;
  ...
  if ( (int)Heap < 0 )
  {
    ...
    v17 = 2LL * v19;
    *((_DWORD *)&SmpPagefileLog + 4 * v19) = 1377;
    goto LABEL_33;
  }
  if ( (v27 & 0x17) != 0 )
    goto LABEL_23;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v5 < 0 )
  {
    ...
    v17 = 2LL * v20;
    *((_DWORD *)&SmpPagefileLog + 4 * v20) = 1423;
    goto LABEL_33;
  }
  ...
  if ( v5 < 0 )
  {
    ...
    v17 = 2LL * v18;
    *((_DWORD *)&SmpPagefileLog + 4 * v18) = 1445;
    goto LABEL_33;
  }
  ...
  *(_QWORD *)(v7 + 32) = v10;
  ...
  if ( (v12 & 1) == 0 )
  {
    v14 = (__int64 *)qword_140025E58;
    if ( *(__int64 **)qword_140025E58 == &SmpVolumeDescriptorList )
    {
