/*
 * XREFs of SmpCopyFile @ 0x1400137DC
 * Callers:
 ...
 *     _TlgKeywordOn @ 0x140014A1C (_TlgKeywordOn.c)
...
__int64 __fastcall SmpCopyFile(HANDLE FileHandle, struct _UNICODE_STRING *a2, union _LARGE_INTEGER a3)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v3.QuadPart )
    {
      ...
      if ( v3.QuadPart % (unsigned __int64)(unsigned int)dword_140025BA8 )
        v8 = dword_140025BA8;
        ...
        if ( v9 >= 0 )
        {
          ...
          do
          {
            ...
            if ( IoStatusBlock.Information != v7 )
            {
              ...
              v7 = -v8 & (v8 + v3.LowPart - v18.LowPart - 1);
            }
...
LABEL_13:
      ...
      if ( (unsigned int)dword_140024018 > 5 && TlgKeywordOn(v14, v13) )
      {
        ...
        v30 = 4LL;
        v32 = 8LL;
        TlgWrite((TraceLoggingHProvider)4, &unk_14001FA89, v15, v16, 4u, &pData);
      }
      v11 = FileHandlea;
    }
    NtClose(v11);
