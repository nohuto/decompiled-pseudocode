/*
 * XREFs of MouseClassFindMorePorts @ 0x1C000D530
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MouseClassFindMorePorts(struct _DRIVER_OBJECT *DriverObject, PVOID Context, ULONG Count)
{
  ...
  PDEVICE_OBJECT v18; // [rsp+58h] [rbp-B0h] BYREF
  ...
  *(_DWORD *)&DestinationString.Length = 0x2000000;
  ...
  v8 = 0;
  while ( NumberOfMapRegisters < HIDWORD(WPP_MAIN_CB.DeviceQueue.Lock) && NumberOfMapRegisters < (unsigned int)v21 )
  {
    ...
    v9 = MouCreateClassObject(DriverObject, &WPP_MAIN_CB.DeviceQueue.32, &v18, (PWSTR *)P, 1);
    if ( v9 < 0 )
    {
...
LABEL_9:
    ...
    DeviceExtension = (char *)v18->DeviceExtension;
    *(_QWORD *)DeviceExtension = v18;
    ...
    v4 = P[0];
    v12 = (const WCHAR *)P[0];
    v18->StackSize = *(_BYTE *)(*((_QWORD *)DeviceExtension + 2) + 76LL) + 1;
    ...
    if ( v13 >= 0 )
    {
      v15 = (_QWORD *)qword_1C00094A8;
      v16 = DeviceExtension + 320;
      if ( *(__int64 **)qword_1C00094A8 != &qword_1C00094A0 )
        __fastfail(3u);
      *v16 = &qword_1C00094A0;
      ++v8;
      v16[1] = v15;
      *v15 = v16;
      qword_1C00094A8 = (__int64)v16;
    }
    else
    {
