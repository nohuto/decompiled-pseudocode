 ...
 *     WppCleanupKm @ 0x1C000E108 (WppCleanupKm.c)
 *     WppInitKm @ 0x1C000E1AC (WppInitKm.c)
 *     WppLoadTracingSupport @ 0x1C000E274 (WppLoadTracingSupport.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  qword_1C00094A8 = (__int64)&qword_1C00094A0;
  qword_1C00094A0 = (__int64)&qword_1C00094A0;
  ...
  *(_DWORD *)&::DestinationString.Length = 0x2000000;
  ::DestinationString.Buffer = (PWSTR)&unk_1C00092A0;
  memset(v38, 0, sizeof(v38));
  *(_DWORD *)&Destination.Length = 0x2000000;
  Destination.Buffer = (PWSTR)v38;
  word_1C0009280 = RegistryPath->Length;
  word_1C0009282 = RegistryPath->Length + 2;
  PoolWithTag = ExAllocatePoolWithTag((POOL_TYPE)512, (unsigned __int16)word_1C0009282, 0x43756F4Du);
  ::P = PoolWithTag;
  if ( !PoolWithTag )
  {
    LOBYTE(v9) = 2;
...
LABEL_14:
  ...
  else
  {
    ...
    v30 = (__int64 *)qword_1C00094A0;
    ClassObject = 0;
    while ( v30 != &qword_1C00094A0 )
    {
