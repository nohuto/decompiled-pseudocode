/*
 * XREFs of MousePnP @ 0x1C00011E0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qqc @ 0x1C0001300 (WPP_RECORDER_SF_qqc.c)
 *     MouseClassRemoveDevice @ 0x1C00038FC (MouseClassRemoveDevice.c)
 *     MouseStart @ 0x1C0004264 (MouseStart.c)
 *     MouEnableDisablePort @ 0x1C000C010 (MouEnableDisablePort.c)
 *     MouseSendIrpSynchronously @ 0x1C000DFA0 (MouseSendIrpSynchronously.c)
 */
      ...
      *PoolWithTag = WorkItem;
      if ( WorkItem )
      {
        ...
        *(_OWORD *)(&v23[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&v23->Parameters.SetQuota + 6);
        ...
        v24[-1].CompletionRoutine = (PIO_COMPLETION_ROUTINE)&MousePnpStartCompletion;
        v24[-1].Context = PoolWithTag;
        v24[-1].Control = -32;
  ...
  if ( MinorFunction != 2 )
  {
    if ( MinorFunction == 4 )
    {
      if ( *((_BYTE *)DeviceExtension + 65) )
      {
        ...
        {
          v16 = *((_BYTE *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 24 * DeviceExtension[45] + 16);
          v17 = (char *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 24 * DeviceExtension[45];
          v17[16] = 0;
          ExReleaseFastMutex((PFAST_MUTEX)&WPP_MAIN_CB.Queue.Wcb.DeviceObject);
          if ( v16 )
          {
            v18 = (void *)_InterlockedExchange64((volatile __int64 *)DeviceExtension + 39, 0LL);
            if ( v18 )
              IoUnregisterPlugPlayNotification(v18);
            MouEnableDisablePort(0LL, 0LL, DeviceExtension, v17);
          }
        }
        else
        {
...
LABEL_7:
  ...
  *(_OWORD *)(&v19[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&v19->Parameters.SetQuota + 6);
  ...
  v19[-1].Control = 0;
  v20 = IofCallDriver(*((PDEVICE_OBJECT *)DeviceExtension + 2), Irp);
  ExAcquireFastMutex((PFAST_MUTEX)&WPP_MAIN_CB.Queue.Wcb.DeviceObject);
