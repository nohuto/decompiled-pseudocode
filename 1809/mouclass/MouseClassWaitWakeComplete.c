/*
 * XREFs of MouseClassWaitWakeComplete @ 0x1C0004050
 * Callers:
 *     <none>
 * Callees:
 *     MouseToggleWaitWake @ 0x1C000458C (MouseToggleWaitWake.c)
 *     WPP_RECORDER_SF_qd @ 0x1C0005124 (WPP_RECORDER_SF_qd.c)
 *     WPP_RECORDER_SF_qqd @ 0x1C0005A8C (WPP_RECORDER_SF_qqd.c)
 */
    ...
    && Status != -1072431071 )
  {
    if ( Status )
    {
      ...
      if ( (int)MouseToggleWaitWake(Context, 0LL) < 0 )
        WPP_RECORDER_SF_qd(WPP_GLOBAL_Control->DeviceExtension, v15, v16, v17);
      goto LABEL_19;
    }
    PoRequestPowerIrp(
