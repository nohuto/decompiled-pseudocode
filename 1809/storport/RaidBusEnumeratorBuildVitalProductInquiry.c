/*
 * XREFs of RaidBusEnumeratorBuildVitalProductInquiry @ 0x1C0019688
 * Callers:
 *     RaidBusEnumeratorGenericInquiry @ 0x1C0018184 (RaidBusEnumeratorGenericInquiry.c)
 * Callees:
 *     RaidInitializeInquirySrb @ 0x1C006B764 (RaidInitializeInquirySrb.c)
 */
        ...
        _QWORD *a6)
{
  ...
  v11 = 0;
  v12 = 0LL;
  RaidInitializeInquirySrb(v6, a2, a2 >> 8, HIWORD(a2), a3[4], a5, *(_BYTE *)(*a1 + 418));
  if ( *(_BYTE *)(v8 + 418) == 1 )
  {
