/*
 * XREFs of RaidTranslateResourceListAddress @ 0x1C00205EC
 * Callers:
 *     StorPortGetDeviceBase @ 0x1C0020490 (StorPortGetDeviceBase.c)
 * Callees:
 *     RaidGetResourceListElement @ 0x1C00207CC (RaidGetResourceListElement.c)
 */
