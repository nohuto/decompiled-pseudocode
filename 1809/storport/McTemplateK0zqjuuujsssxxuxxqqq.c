/*
 * XREFs of McTemplateK0zqjuuujsssxxuxxqqq @ 0x1C002A704
 * Callers:
...
ULONG __fastcall McTemplateK0zqjuuujsssxxuxxqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        ...
        char a21)
{
  ...
  __int64 v25; // rax
  int v26; // eax
  const struct _MCGEN_TRACE_CONTEXT *v27; // rdx
  __int64 v28; // rax
  int v29; // eax
  const struct _MCGEN_TRACE_CONTEXT *v30; // rax
  __int64 v31; // rcx
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+30h] [rbp-D0h] BYREF
  const struct _MCGEN_TRACE_CONTEXT *v34; // [rsp+40h] [rbp-C0h]
  ...
  if ( a4 )
  {
    ...
    do
      ++v22;
    while ( *((_WORD *)&a4->RegistrationHandle + v22) );
    v23 = 2 * v22 + 2;
  }
  else
  {
  ...
  if ( a11 )
  {
    ...
    do
      ++v25;
    while ( *((_BYTE *)&a11->RegistrationHandle + v25) );
    v26 = v25 + 1;
  }
  else
  {
  ...
  if ( a12 )
  {
    ...
    do
      ++v28;
    while ( *((_BYTE *)&a12->RegistrationHandle + v28) );
    v29 = v28 + 1;
  }
  else
  {
  ...
  if ( a13 )
  {
    do
      ++v21;
    while ( *((_BYTE *)&a13->RegistrationHandle + v21) );
  ...
  v71 = 4LL;
  v73 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v31, &EventUnitQosData, 0LL, 0x13u, &EventData);
}
