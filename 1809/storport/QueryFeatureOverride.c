/*
 * XREFs of QueryFeatureOverride @ 0x1C002617C
 * Callers:
 *     EvaluateCurrentStateFromRegistry @ 0x1C00260FC (EvaluateCurrentStateFromRegistry.c)
 * Callees:
...
__int64 __fastcall QueryFeatureOverride(ULONG a1, _DWORD *a2)
{
  ...
  *(_DWORD *)&String.Length = 0x200000;
  ...
  if ( ((int (__fastcall *)(_QWORD, unsigned __int64 *, _QWORD *, _QWORD, _QWORD))SystemRoutineAddress)(
         0LL,
