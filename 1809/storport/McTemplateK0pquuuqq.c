/*
 * XREFs of McTemplateK0pquuuqq @ 0x1C0041C80
 * Callers:
...
ULONG McTemplateK0pquuuqq(struct _MCGEN_TRACE_CONTEXT *a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite(a1, a2, 0LL, 8u, &EventData);
}
