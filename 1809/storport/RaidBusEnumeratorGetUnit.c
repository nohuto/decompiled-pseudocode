/*
 * XREFs of RaidBusEnumeratorGetUnit @ 0x1C00191AC
 * Callers:
 ...
 *     RaidAdapterFindZombieUnit @ 0x1C0019608 (RaidAdapterFindZombieUnit.c)
...
__int64 __fastcall RaidBusEnumeratorGetUnit(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( Unit )
    {
      RaUnitSetQueueDepth(
        v3[6],
        *(_DWORD *)(*(_QWORD *)(Unit + 24) + 532LL),
        *(_DWORD *)(*(_QWORD *)(Unit + 24) + 528LL));
LABEL_6:
      v11 = *(_QWORD *)(Unit + 24);
      *(_DWORD *)(Unit + 96) = a2;
      *(_WORD *)(Unit + 88) = 1;
