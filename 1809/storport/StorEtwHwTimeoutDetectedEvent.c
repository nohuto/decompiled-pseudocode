/*
 * XREFs of StorEtwHwTimeoutDetectedEvent @ 0x1C004C858
 * Callers:
...
LABEL_39:
  ...
  if ( (byte_1C00617E3 & 0x20) != 0 )
  {
    ...
    return McTemplateK0zqjuuujsssqqbr11qt(
             v11,
             v9 + 186,
             (const GUID *)(a1 + 728),
             *(const struct _MCGEN_TRACE_CONTEXT **)(*(_QWORD *)(v9 + 24) + 4864LL),
             ...
             *(_QWORD *)(v9 + 24) + 5256LL,
             ...
             SBYTE2(result),
             v9 + 1976,
             (const struct _MCGEN_TRACE_CONTEXT *)(v9 + 160),
             (const struct _MCGEN_TRACE_CONTEXT *)(v9 + 169),
             (const struct _MCGEN_TRACE_CONTEXT *)(v9 + 186),
             v8,
             v3,
             v6,
             v32,
