/*
 * XREFs of RaUnitStorageQueryDeviceTemperaturePropertyIoctl @ 0x1C0048E44
 * Callers:
 ...
 *     RaidUnitLogSenseTemperatureSrb @ 0x1C004A354 (RaidUnitLogSenseTemperatureSrb.c)
 */
...
LABEL_7:
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 24) + 540LL) & 0x20) == 0 )
  {
LABEL_16:
    v9 = RaidUnitLogSenseTemperatureSrb(a1, (int)a2);
    goto LABEL_17;
  }
  v9 = RaBuildQueryTemperaturePropertyBufferForMiniport(*(_QWORD *)(a1 + 8), (__int64)a2, &P, &v13);
  if ( v9 < 0 )
  {
    v3 = (char *)P;
  }
