/*
 * XREFs of RaidAdapterSetSystemPowerCompletion @ 0x1C0013540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterSetSystemPowerCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 42LL, &WPP_05398c2a44fb388ff25b1754e24905f8_Traceguids, v2, a2);
  }
  v4 = *(_QWORD *)(a2 + 184);
  v5 = *(_DWORD *)(v2 + 280);
  v6 = *(int *)(v4 + 24);
  v7.SystemState = (_SYSTEM_POWER_STATE)DeviceStateTable[v6];
  if ( v5 >= (int)v6 && *(_QWORD *)(v2 + 5152) )
  {
  ...
  if ( v10 >= 0 )
  {
    ...
    v12 = (_DWORD)v6 != 1 && *(_DWORD *)(v2 + 280) < (int)v6;
    *(_BYTE *)(v2 + 292) = v12;
    *(_DWORD *)(v2 + 280) = v6;
    *(_DWORD *)(v2 + 288) = v11;
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 43LL, &WPP_05398c2a44fb388ff25b1754e24905f8_Traceguids, v2, a2, v10);
  }
