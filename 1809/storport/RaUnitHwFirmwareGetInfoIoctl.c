/*
 * XREFs of RaUnitHwFirmwareGetInfoIoctl @ 0x1C0021834
 * Callers:
 ...
 *     RaTranslateMiniportFirmwareInfoToHwFirmwareInfo @ 0x1C004588C (RaTranslateMiniportFirmwareInfoToHwFirmwareInfo.c)
 */
...
LABEL_26:
  ...
  if ( ((__int64)MasterIrp->MdlAddress & 1) == 0 )
  {
    ...
    *(&MasterIrp->Flags + 1) = 0x10000;
    ...
    {
      v9 = a1[18];
      if ( v9 && (*(_DWORD *)(*(_QWORD *)(a1[3] + 544LL) + 184LL) & 0x40) != 0 )
