/*
 * XREFs of RaUnitTelemetryIdIoctl @ 0x1C00236F4
 * Callers:
...
__int64 __fastcall RaUnitTelemetryIdIoctl(__int64 a1, IRP *a2)
{
  ...
  void **p_CallbackContext; // [rsp+60h] [rbp-19h]
...
LABEL_13:
  ...
  *(_OWORD *)&MasterIrp->AssociatedIrp.MasterIrp = *(_OWORD *)(*(_QWORD *)(a1 + 24) + 5256LL);
  ...
  if ( (unsigned int)dword_1C0061058 > 5 && TlgKeywordOn(Length, 0x400000000000uLL) )
  {
    ...
    v14 = *(_BYTE *)(v8 + 97);
    v15 = *(_BYTE *)(v8 + 98);
    p_CallbackContext = &v10[93].CallbackContext;
    ...
    v27 = 1LL;
    v29 = 1LL;
    TlgWrite(v10, &unk_1C0057405, v7, (LPCGUID)v8, 8u, &pData);
  }
  v11 = 0;
  return RaidCompleteRequestEx(a2, 0, v11);
}
