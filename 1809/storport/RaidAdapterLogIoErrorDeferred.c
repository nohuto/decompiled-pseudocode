/*
 * XREFs of RaidAdapterLogIoErrorDeferred @ 0x1C00383E0
 * Callers:
...
char __fastcall RaidAdapterLogIoErrorDeferred(__int64 a1, char a2, char a3, char a4, int a5, int a6)
{
  ...
  v10 = ExpInterlockedPopEntrySList((PSLIST_HEADER)(a1 + 1232));
  if ( v10 )
  {
    ...
    BYTE5(v10[2].Next) = a3;
    BYTE6(v10[2].Next) = a4;
    LOBYTE(v10) = RaidQueueDeferredItem((char *)(a1 + 1152), v10);
  }
  else
  {
