/*
 * XREFs of TranslateResultToScsiRequestBlock @ 0x1C0022B74
 * Callers:
...
__int64 __fastcall TranslateResultToScsiRequestBlock(__int64 a1, __int64 a2)
{
  ...
  union _LARGE_INTEGER v20; // [rsp+58h] [rbp+10h] BYREF
...
LABEL_32:
  ...
  if ( (Microsoft_Windows_StorPortEnableBits & 0x40) != 0 )
    McTemplateK0zx(LowPart, v13.LowPart, v15.LowPart, (unsigned int)L"Translate STORAGE_REQUEST_BLOCK result", v2);
  return v6;
}
