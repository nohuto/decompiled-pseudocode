/*
 * XREFs of McTemplateK0quuujjqzqssszsxuxxqqxxxxxxxqqqzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx @ 0x1C0028838
 * Callers:
...
ULONG __fastcall McTemplateK0quuujjqzqssszsxuxxqqxxxxxxxqqqzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        const struct _MCGEN_TRACE_CONTEXT *a16,
        const struct _MCGEN_TRACE_CONTEXT *a17,
        __int64 a18,
        char a19,
        char a20,
        char a21,
        ...
        char a32,
        char a33,
        struct _MCGEN_TRACE_CONTEXT *a34,
        char a35,
        char a36,
        char a37,
        char a38,
        ...
        char a63)
{
  char a64; // [rsp+6D0h] [rbp+5C8h] BYREF
  const struct _MCGEN_TRACE_CONTEXT *v64; // rcx
  int v65; // r9d
  __int64 v66; // rax
  __int64 v67; // rdx
  int v68; // r8d
  ...
  __int64 v76; // rcx
  int v77; // ecx
  const struct _MCGEN_TRACE_CONTEXT *v78; // rcx
  __int64 v79; // rdx
  int v80; // r8d
  const struct _MCGEN_TRACE_CONTEXT *v81; // rdx
  __int64 v82; // rcx
  int v83; // ecx
  struct _MCGEN_TRACE_CONTEXT *v84; // rcx
  bool v85; // zf
  ...
  struct _MCGEN_TRACE_CONTEXT *v155; // [rsp+238h] [rbp+130h]
  int v156; // [rsp+240h] [rbp+138h]
  int v157; // [rsp+244h] [rbp+13Ch]
  char *v158; // [rsp+248h] [rbp+140h]
  __int64 v159; // [rsp+250h] [rbp+148h]
  ...
  int v236; // [rsp+4F0h] [rbp+3E8h] BYREF

  v236 = a4;
  v64 = a11;
  v87 = g_SystemUptime_s;
  v89 = &v236;
  v91 = &a5;
  v90 = 4LL;
  v93 = &a6;
  ...
  if ( a11 )
  {
    ...
    do
      ++v67;
    while ( *((_WORD *)&a11->RegistrationHandle + v67) );
    v68 = 2 * v67 + 2;
  }
  else
  {
  ...
  if ( a16 )
  {
    ...
    do
      ++v79;
    while ( *((_WORD *)&a16->RegistrationHandle + v79) );
    v80 = 2 * v79 + 2;
  }
  else
  {
  ...
  if ( a17 )
  {
    ...
    do
      ++v82;
    while ( *((_BYTE *)&a17->RegistrationHandle + v82) );
    v83 = v82 + 1;
  }
  else
  {
  ...
  if ( a34 )
  {
    do
      ++v66;
    while ( *((_WORD *)&a34->RegistrationHandle + v66) );
    v65 = 2 * v66 + 2;
    v85 = a34 == 0LL;
  }
  v156 = v65;
  v158 = &a35;
  if ( v85 )
    v84 = (struct _MCGEN_TRACE_CONTEXT *)&Context;
  v155 = v84;
  v160 = &a36;
  v162 = &a37;
  v164 = &a38;
  ...
  v233 = 8LL;
  v235 = 8LL;
  return McGenEventWrite(v84, &EventUnitPerformance, 0LL, 0x47u, &EventData);
}
