/*
 * XREFs of McTemplateK0zqjuuujsssq @ 0x1C0027594
 * Callers:
...
ULONG __fastcall McTemplateK0zqjuuujsssq(
        __int64 a1,
        ...
        char a14)
{
  ...
  __int64 v22; // rax
  int v23; // eax
  const struct _MCGEN_TRACE_CONTEXT *v24; // rax
  __int64 v25; // rcx
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+30h] [rbp-C9h] BYREF
  const struct _MCGEN_TRACE_CONTEXT *v28; // [rsp+40h] [rbp-B9h]
  ...
  const struct _MCGEN_TRACE_CONTEXT *v43; // [rsp+B0h] [rbp-49h]
  int v44; // [rsp+B8h] [rbp-41h]
  int v45; // [rsp+BCh] [rbp-3Dh]
  const struct _MCGEN_TRACE_CONTEXT *v46; // [rsp+C0h] [rbp-39h]
  int v47; // [rsp+C8h] [rbp-31h]
  int v48; // [rsp+CCh] [rbp-2Dh]
  const struct _MCGEN_TRACE_CONTEXT *v49; // [rsp+D0h] [rbp-29h]
  ...
  if ( a4 )
  {
    ...
    do
      ++v16;
    while ( *((_WORD *)&a4->RegistrationHandle + v16) );
    v17 = 2 * v16 + 2;
  }
  else
  {
  ...
  if ( a11 )
  {
    ...
    do
      ++v19;
    while ( *((_BYTE *)&a11->RegistrationHandle + v19) );
    v20 = v19 + 1;
  }
  else
  {
  ...
  if ( a12 )
  {
    ...
    do
      ++v22;
    while ( *((_BYTE *)&a12->RegistrationHandle + v22) );
    v23 = v22 + 1;
  }
  else
  {
  ...
  v49 = v24;
  v52 = &a14;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v25, a2, 0LL, 0xCu, &EventData);
}
