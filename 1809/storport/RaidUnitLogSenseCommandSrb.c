/*
 * XREFs of RaidUnitLogSenseCommandSrb @ 0x1C00280A0
 * Callers:
...
__int64 __fastcall RaidUnitLogSenseCommandSrb(__int64 a1, __int64 a2, char a3, char a4, unsigned int *a5, _BYTE *a6)
{
  ...
  memset(a6, 0, *a5);
  v27 = *(_QWORD *)(a1 + 24);
  Srb = RaidAllocateSrb(*(_QWORD *)(a1 + 8), 0, *(_BYTE *)(v27 + 418), 1);
  if ( !Srb )
...
LABEL_20:
    if ( *((_DWORD *)Srb + 4) >= 4u && (HIBYTE(v24) = a6[2], LOBYTE(v24) = a6[3], v21 = v24 + 4, (*a6 & 0x3F) == a3) )
    {
      if ( v21 < *a5 )
        *a5 = v21;
    }
