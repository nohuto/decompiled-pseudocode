/*
 * XREFs of StorpTelemetrySendUnitScsiDiagnostics @ 0x1C002AE30
 * Callers:
 ...
 *     StorpTelemetryGetReadErrorCounter @ 0x1C002A940 (StorpTelemetryGetReadErrorCounter.c)
 *     StorpTelemetryGetStartStopCycleCounter @ 0x1C002A9A0 (StorpTelemetryGetStartStopCycleCounter.c)
 *     StorpTelemetryGetWriteErrorCounter @ 0x1C002AA74 (StorpTelemetryGetWriteErrorCounter.c)
            ...
            if ( (byte_1C00617E4 & 8) != 0 )
              McTemplateK0quuujjzssstxuuzqqqqxxxxxxhuuqqbr29qbr31qbr33qbr35qbr37qbr39qbr41qbr43(
                ...
                *(_BYTE *)(v1 + 98),
                v1 + 1976,
                *(_QWORD *)(v1 + 24) + 5256LL,
                *(const struct _MCGEN_TRACE_CONTEXT **)(*(_QWORD *)(v1 + 24) + 4864LL),
