/*
 * XREFs of RaidUnitResetTarget @ 0x1C004A83C
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C004DD10 (StorpAggregateHierarchicalResetTarget.c)
 */
...
__int64 __fastcall RaidUnitResetTarget(__int64 a1)
{
  ...
  v5 = *(_QWORD *)(a1 + 8);
  v26 = v4;
  Srb = RaidAllocateSrb(v5, 0x13u, *(_BYTE *)(v3 + 418), 0);
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0061058 > 5 )
      {
        ...
        v40 = 1LL;
        v42 = 8LL;
        TlgWrite((TraceLoggingHProvider)8, &unk_1C0057464, v18, v19, 8u, &pData);
      }
