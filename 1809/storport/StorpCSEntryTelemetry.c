/*
 * XREFs of StorpCSEntryTelemetry @ 0x1C004DD64
 * Callers:
...
void __fastcall StorpCSEntryTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    *(_QWORD *)(a1 + 5416) = 0LL;
    v4 = (unsigned __int64)(v3 - *(_QWORD *)(a1 + 5408)) * (unsigned __int128)0x346DC5D63886594BuLL;
    *(_QWORD *)(a1 + 5408) = v2;
    *(_QWORD *)(a1 + 5424) = 0LL;
    *(_QWORD *)(a1 + 5432) = 0LL;
    *(_QWORD *)(a1 + 5440) = 0LL;
    ...
    *(_DWORD *)(a1 + 5504) = 0;
    ...
    if ( v5 )
    {
      ...
      if ( (unsigned int)dword_1C0061058 > 5 && TlgKeywordOn((TraceLoggingHProvider)v5, 0x400000000000uLL) )
      {
        v23 = *(_DWORD *)(a1 + 56);
        v55 = a1 + 5256;
        v57 = &v23;
        ...
        v58 = 4LL;
        v60 = 8LL;
        TlgWrite(v8, &unk_1C00579FC, v9, v10, 5u, &pData);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        ...
        if ( (unsigned int)dword_1C0061058 > 5 )
        {
          if ( TlgKeywordOn(v13, 0x400000000000uLL) )
          {
            ...
            v51 = 8LL;
            v53 = 4LL;
            TlgWrite(v14, &unk_1C0057A61, v15, v16, 0xDu, &v31);
          }
        }
