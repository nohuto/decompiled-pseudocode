/*
 * XREFs of RaidUnitSendPoFxPowerControlToMiniport @ 0x1C0043400
 * Callers:
 *     StorPortUnitPowerControl @ 0x1C00442F0 (StorPortUnitPowerControl.c)
 * Callees:
        ...
        _QWORD *a7)
{
  ...
  if ( RaidIsUnitControlSupported(a1, 8) )
  {
    ...
    v14[5] = a3;
    v14[3] = a4;
    return (unsigned int)RaCallMiniportUnitControl(v12 + 312);
  }
  else if ( a7 )
  {
    *a7 = 0LL;
