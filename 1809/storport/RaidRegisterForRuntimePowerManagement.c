/*
 * XREFs of RaidRegisterForRuntimePowerManagement @ 0x1C0024BB0
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  *v22 = 2;
  ...
  else
  {
    ...
    v40 = StorPortAdapterIdleCondition;
    v41 = StorPortAdapterActiveCondition;
  }
  *((_QWORD *)v22 + 2) = v41;
  *((_QWORD *)v22 + 3) = v40;
  *((_QWORD *)v22 + 6) = v39;
  ...
  if ( v42 >= 0 )
  {
    ...
    if ( (_DWORD)v43 == 1 )
    {
      ...
      if ( (unsigned int)*v7 >= 2 )
        v52 = v7[4];
      if ( (unsigned int)dword_1C0061058 > 5 && TlgKeywordOn(v43, 0x400000000000uLL) )
      {
        v57 = *(_QWORD *)(v54 + 24);
        ...
        Data4 = (unsigned __int8 *)(v57 + 5256);
        v68 = &v58;
        v64 = (char *)(v54 + 1976);
