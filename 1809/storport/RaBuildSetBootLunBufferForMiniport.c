/*
 * XREFs of RaBuildSetBootLunBufferForMiniport @ 0x1C00456B0
 * Callers:
 *     RaidAdapterSetBootLunIoctl @ 0x1C003A35C (RaidAdapterSetBootLunIoctl.c)
 * Callees:
 *     RaidAllocatePool @ 0x1C00081B4 (RaidAllocatePool.c)
 *     memset @ 0x1C002C3C0 (memset.c)
 *     RaidAdapterFindUnitByIdentifier @ 0x1C0037CC8 (RaidAdapterFindUnitByIdentifier.c)
 */
