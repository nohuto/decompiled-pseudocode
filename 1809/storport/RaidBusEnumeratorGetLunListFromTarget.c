/*
 * XREFs of RaidBusEnumeratorGetLunListFromTarget @ 0x1C0018748
 * Callers:
 *     RaidBusEnumeratorGetLunList @ 0x1C00183A0 (RaidBusEnumeratorGetLunList.c)
 * Callees:
 *     RaidBusEnumeratorIssueReportLuns @ 0x1C0018934 (RaidBusEnumeratorIssueReportLuns.c)
...
__int64 __fastcall RaidBusEnumeratorGetLunListFromTarget(_QWORD *a1, int a2, int a3, _BYTE *a4)
{
  ...
  if ( v8 != -1073741789 )
  {
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 16LL, &stru_1C0055A88.EnableBitMask, (unsigned int)v8);
    }
    return v9;
  }
  ...
  {
    v17 = 8 * *(unsigned __int8 *)(*a1 + 466LL) + 8;
    result = RaidBusEnumeratorIssueReportLuns((_DWORD)a1, a2, a3, (unsigned int)&v17, (__int64)&v18);
  }
  if ( (int)result >= 0 )
  {
LABEL_8:
        ...
        if ( v16 >= 0xFFu )
        {
          if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
          {
            if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
              WPP_SF_qD(WPP_GLOBAL_Control->AttachedDevice, 17LL, &stru_1C0055A88.EnableBitMask, *a1, v16);
            if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
              && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0
              && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
            {
              WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 18LL, &stru_1C0055A88.EnableBitMask, v16);
            }
          }
        }
        else
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
    {
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 19LL, &stru_1C0055A88.EnableBitMask, *a1);
      if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 20LL, &stru_1C0055A88.EnableBitMask);
      }
    }
    for ( i = 0; i < 0xFFu; ++i )
    {
      if ( *a4
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 21LL, &stru_1C0055A88.EnableBitMask, i);
      }
      ++a4;
    }
    return 0LL;
