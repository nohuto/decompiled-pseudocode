/*
 * XREFs of McTemplateK0quuujjzssstxuuzqqqqxxxxxxhuuqqbr29qbr31qbr33qbr35qbr37qbr39qbr41qbr43 @ 0x1C002976C
 * Callers:
...
ULONG __fastcall McTemplateK0quuujjzssstxuuzqqqqxxxxxxhuuqqbr29qbr31qbr33qbr35qbr37qbr39qbr41qbr43(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a16,
        char a17,
        struct _MCGEN_TRACE_CONTEXT *a18,
        char a19,
        char a20,
        char a21,
        char a22,
        ...
        __int64 a48)
{
  const struct _MCGEN_TRACE_CONTEXT *v48; // rcx
  int v49; // r9d
  __int64 v50; // rax
  __int64 v51; // rdx
  int v52; // r8d
  ...
  __int64 v54; // rcx
  int v55; // ecx
  const struct _MCGEN_TRACE_CONTEXT *v56; // rdx
  __int64 v57; // rcx
  int v58; // ecx
  const struct _MCGEN_TRACE_CONTEXT *v59; // rdx
  __int64 v60; // rcx
  int v61; // ecx
  ...
  const struct _MCGEN_TRACE_CONTEXT *v79; // [rsp+B8h] [rbp-50h]
  int v80; // [rsp+C0h] [rbp-48h]
  int v81; // [rsp+C4h] [rbp-44h]
  const struct _MCGEN_TRACE_CONTEXT *v82; // [rsp+C8h] [rbp-40h]
  int v83; // [rsp+D0h] [rbp-38h]
  int v84; // [rsp+D4h] [rbp-34h]
  const struct _MCGEN_TRACE_CONTEXT *v85; // [rsp+D8h] [rbp-30h]
  int v86; // [rsp+E0h] [rbp-28h]
  int v87; // [rsp+E4h] [rbp-24h]
  const struct _MCGEN_TRACE_CONTEXT *v88; // [rsp+E8h] [rbp-20h]
  ...
  struct _MCGEN_TRACE_CONTEXT *v99; // [rsp+138h] [rbp+30h]
  ...
  if ( a10 )
  {
    ...
    do
      ++v51;
    while ( *((_WORD *)&a10->RegistrationHandle + v51) );
    v52 = 2 * v51 + 2;
  }
  else
  {
  ...
  if ( a11 )
  {
    ...
    do
      ++v54;
    while ( *((_BYTE *)&a11->RegistrationHandle + v54) );
    v55 = v54 + 1;
  }
  else
  {
  ...
  if ( a12 )
  {
    ...
    do
      ++v57;
    while ( *((_BYTE *)&a12->RegistrationHandle + v57) );
    v58 = v57 + 1;
  }
  else
  {
  ...
  if ( a13 )
  {
    ...
    do
      ++v60;
    while ( *((_BYTE *)&a13->RegistrationHandle + v60) );
    v61 = v60 + 1;
  }
  else
  {
  ...
  if ( a18 )
  {
    do
      ++v50;
    while ( *((_WORD *)&a18->RegistrationHandle + v50) );
    v49 = 2 * v50 + 2;
    v63 = a18 == 0LL;
  }
  v100 = v49;
  v102 = &a19;
  if ( v63 )
    v62 = (struct _MCGEN_TRACE_CONTEXT *)&Context;
  v99 = v62;
  v104 = &a20;
  v106 = &a21;
  v108 = &a22;
  ...
  v166 = 4LL;
  v169 = 0;
  return McGenEventWrite(v62, &EventUnitScsiDiagnostics, 0LL, 0x2Eu, &EventData);
}
