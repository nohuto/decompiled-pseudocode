/*
 * XREFs of McTemplateK0pquuudttqqttq @ 0x1C0041A88
 * Callers:
...
ULONG McTemplateK0pquuudttqqttq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v28 = 4LL;
  v30 = 4LL;
  return McGenEventWrite(a1, &EventUnitPoFxRegistered, 0LL, 0xEu, &EventData);
}
