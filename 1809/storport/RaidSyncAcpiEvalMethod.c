/*
 * XREFs of RaidSyncAcpiEvalMethod @ 0x1C0021568
 * Callers:
...
LABEL_9:
  ...
  if ( !v11 )
  {
    ...
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 12LL, &WPP_d11a79b88e3f3e003d260997dd6ff069_Traceguids, DeviceObject);
    }
    Status = -1073741670;
    goto LABEL_9;
  }
