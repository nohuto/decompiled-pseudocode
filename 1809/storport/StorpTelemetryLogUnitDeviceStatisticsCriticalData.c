/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsCriticalData @ 0x1C004EFB8
 * Callers:
...
char __fastcall StorpTelemetryLogUnitDeviceStatisticsCriticalData(const struct _TlgProvider_t *a1)
{
  _UNKNOWN **v1; // rax
  __int64 v2; // rcx
  __int64 v3; // r9
  ...
  {
    LOBYTE(v1) = TlgKeywordOn(a1, 0x800000000000uLL);
    if ( (_BYTE)v1 )
    {
      v5 = *(_QWORD *)(v2 + 24);
      v6 = v4 + 1976;
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = g_SystemUptime_s;
      ...
      v117[1] = 0;
      v119 = 1LL;
      LOBYTE(v1) = TlgWrite(&hProvider, &unk_1C0059800, v31, 0LL, 0x25u, (EVENT_DATA_DESCRIPTOR *)&hProvider.RegHandle);
    }
  }
  return (char)v1;
}
