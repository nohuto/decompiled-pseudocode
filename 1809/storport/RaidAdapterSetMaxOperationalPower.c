/*
 * XREFs of RaidAdapterSetMaxOperationalPower @ 0x1C0042A24
 * Callers:
 ...
 *     RaidAdapterPassiveCoolingCallback @ 0x1C0042810 (RaidAdapterPassiveCoolingCallback.c)
 * Callees:
 ...
 *     RaidAdapterEffectiveMaxOperationalPower @ 0x1C00427E4 (RaidAdapterEffectiveMaxOperationalPower.c)
 */
...
LABEL_11:
  ...
  v33 = v26;
  v15 = RaCallMiniportAdapterControl(a1 + 312);
  if ( v15 >= 0 )
  {
    if ( a3 )
    {
  ...
  if ( (unsigned int)dword_1C0061058 > 5 )
  {
    if ( TlgKeywordOn(v14, 0x400000000000uLL) )
    {
      ...
      v56 = 8LL;
      v58 = 8LL;
      TlgWrite(v17, &unk_1C0057278, v18, v19, 0xEu, &pData);
    }
  }
