/*
 * XREFs of RaidAdapterResetBus @ 0x1C0038ED4
 * Callers:
  ...
  if ( (qword_1C00612B0 & 0x400) != 0 )
    DbgLogRequest(
      *(_QWORD *)(a1 + 312),
      11,
      *(_QWORD *)(a1 + 312),
      *(unsigned int *)(*(_QWORD *)(a1 + 312) + 56LL),
      a2,
      0LL,
      v35);
  v12 = *(_QWORD *)(a1 + 544);
  ...
  *(_BYTE *)(a1 + 560) &= ~2u;
    ...
    do
    {
      ...
      if ( v21 )
      {
        ExpInterlockedPushEntrySList(
          (PSLIST_HEADER)(*(_QWORD *)(a1 + 4816) + ((unsigned __int64)(HIDWORD(v21[1].Next) % v20) << 6)),
          v21);
        ++v19;
      }
    }
    while ( v19 < *(_DWORD *)(a1 + 4808) );
    v17 = v30;
  }
  ...
  if ( v22 )
  {
    ...
    if ( v22 == 1000000 * (v22 / 0xF4240) )
      v23 = v22 / 0xF4240;
    RaidAdapterSetPauseTimer(a1, a1 + 4280, a1 + 4344, v23);
  }
  else
  {
    v25 = KfRaiseIrql(2u);
  ...
  if ( (unsigned int)dword_1C0061058 > 5 )
  {
    if ( TlgKeywordOn(v24, 0x400000000000uLL) )
    {
      ...
      v51 = 4LL;
      v53 = 4LL;
      TlgWrite(v26, &unk_1C0056EF4, v27, v28, 9u, &pData);
    }
  }
  *(_DWORD *)(a1 + 268) = 0;
  return v15;
