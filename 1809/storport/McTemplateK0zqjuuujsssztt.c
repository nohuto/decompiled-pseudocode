/*
 * XREFs of McTemplateK0zqjuuujsssztt @ 0x1C0027B1C
 * Callers:
...
ULONG __fastcall McTemplateK0zqjuuujsssztt(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        ...
        char a16)
{
  ...
  const struct _MCGEN_TRACE_CONTEXT *v57; // [rsp+E0h] [rbp-20h]
  ...
  if ( a13 )
  {
    ...
    do
      ++v27;
    while ( *((_BYTE *)&a13->RegistrationHandle + v27) );
    v28 = v27 + 1;
  }
  else
  {
  ...
  if ( a14 )
  {
    do
      ++v16;
    while ( *((_WORD *)&a14->RegistrationHandle + v16) );
    v17 = 2 * v16 + 2;
    v30 = a14 == 0LL;
  }
  if ( v30 )
  ...
  v62 = &a16;
  v63 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v16, &EventUnitSurpriseRemoved, 0LL, 0xEu, &EventData);
}
