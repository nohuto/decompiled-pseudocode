/*
 * XREFs of McTemplateK0zx @ 0x1C0044C30
 * Callers:
...
ULONG __fastcall McTemplateK0zx(__int64 a1, __int64 a2, __int64 a3, const struct _MCGEN_TRACE_CONTEXT *a4, char a5)
{
  __int64 v5; // rax
  __int64 v6; // rcx
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+30h] [rbp-48h] BYREF
  const struct _MCGEN_TRACE_CONTEXT *v9; // [rsp+40h] [rbp-38h]
