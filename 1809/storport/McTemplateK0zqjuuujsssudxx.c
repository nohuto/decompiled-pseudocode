/*
 * XREFs of McTemplateK0zqjuuujsssudxx @ 0x1C0027938
 * Callers:
...
ULONG __fastcall McTemplateK0zqjuuujsssudxx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        ...
        char a17)
{
  ...
  v59 = 8LL;
  v61 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v27, &EventHierarchicalReset, 0LL, 0xFu, &EventData);
}
