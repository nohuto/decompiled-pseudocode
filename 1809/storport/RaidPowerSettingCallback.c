/*
 * XREFs of RaidPowerSettingCallback @ 0x1C001F240
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v9 )
  {
    ...
    *(_OWORD *)&v28[1] = v11;
    if ( !(unsigned int)RaidIsAdapterControlSupported((__int64)Context, 5) )
      return 0LL;
LABEL_8:
    RaCallMiniportAdapterControl((__int64)(Context + 39));
    return 0LL;
  }
  if ( ValueLength == 4 && Value )
  {
    v13 = *(_BYTE *)Value;
    if ( !(unsigned int)RaidIsAdapterControlSupported((__int64)Context, 12) || !Context[645] || !Context[647] )
      return 0LL;
