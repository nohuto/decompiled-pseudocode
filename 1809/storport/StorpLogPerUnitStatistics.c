/*
 * XREFs of StorpLogPerUnitStatistics @ 0x1C0002BC0
 * Callers:
 ...
 *     RaidUnitDeviceHealthTelemetrySupported @ 0x1C0002E98 (RaidUnitDeviceHealthTelemetrySupported.c)
