/*
 * XREFs of RaUnitQueryDeviceTextIrp @ 0x1C006DF9C
 * Callers:
 ...
 *     StorGetIdentityVendorId @ 0x1C001E080 (StorGetIdentityVendorId.c)
 *     StorGetIdentityProductId @ 0x1C001E0AC (StorGetIdentityProductId.c)
...
__int64 __fastcall RaUnitQueryDeviceTextIrp(__int64 a1, IRP *a2)
{
  ...
  if ( Pool )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 544LL) + 184LL) & 0x10) == 0 )
    {
