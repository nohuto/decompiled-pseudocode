/*
 * XREFs of RaidAdapterSetDevicePowerIrp @ 0x1C0014104
 * Callers:
...
__int64 __fastcall RaidAdapterSetDevicePowerIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 17LL, &WPP_05398c2a44fb388ff25b1754e24905f8_Traceguids, a1, a2);
  }
  v4 = *(_DWORD *)(a1 + 284);
...
LABEL_9:
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 19LL, &WPP_05398c2a44fb388ff25b1754e24905f8_Traceguids, a1, a2, v6);
  }
  return v7;
}
