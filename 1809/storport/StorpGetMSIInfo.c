/*
 * XREFs of StorpGetMSIInfo @ 0x1C0025AB4
 * Callers:
...
__int64 __fastcall StorpGetMSIInfo(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( !a1 )
  {
    ...
    v9 = 57LL;
LABEL_13:
    WPP_SF_(v8->AttachedDevice, v9, &WPP_890ff0257e5a37fc61b1814295f1a13c_Traceguids);
    return (unsigned int)-1056964602;
  }
  if ( !a3 )
  {
  ...
  v5 = *(_QWORD *)(a1 - 16);
  if ( !*(_BYTE *)(*(_QWORD *)v5 + 4513LL) )
    return (unsigned int)-1056964601;
  v6 = *(unsigned __int8 **)(*(_QWORD *)v5 + 4496LL);
  if ( a2 < *((_DWORD *)v6 + 1) )
  {
    *(_DWORD *)a3 = a2;
