/*
 * XREFs of StorpTelemetrySendUnitPauseRequestCounters @ 0x1C0002CB4
 * Callers:
...
void __fastcall StorpTelemetrySendUnitPauseRequestCounters(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 2120)
    || *(_DWORD *)(a1 + 2124)
    || *(_DWORD *)(a1 + 2128)
    || (v2 = *(_QWORD *)(a1 + 24), *(_DWORD *)(v2 + 5520))
    || *(_DWORD *)(v2 + 5516) )
  {
    if ( (unsigned int)dword_1C0061058 > 5 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
      {
        ...
        v36 = 4LL;
        v38 = 4LL;
        TlgWrite((TraceLoggingHProvider)v6, &unk_1C005866E, v4, v5, 0xDu, &pData);
      }
    }
    *(_QWORD *)(a1 + 2120) = 0LL;
    *(_DWORD *)(a1 + 2128) = 0;
