/*
 * XREFs of StorpAllocatePool @ 0x1C00160F0
 * Callers:
  ...
  if ( a4 )
  {
    *a4 = 0LL;
    if ( KeGetCurrentIrql() > 2u )
    {
      ...
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 27LL, &WPP_890ff0257e5a37fc61b1814295f1a13c_Traceguids);
      }
      ...
      *a4 = PoolWithTag;
      if ( !PoolWithTag )
      {
        if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          ...
          && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
        {
          WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 28LL, &WPP_890ff0257e5a37fc61b1814295f1a13c_Traceguids);
        }
