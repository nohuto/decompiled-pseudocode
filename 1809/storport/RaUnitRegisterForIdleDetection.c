/*
 * XREFs of RaUnitRegisterForIdleDetection @ 0x1C006E138
 * Callers:
  ...
  if ( !RaidUnitCheckAndAcquirePoFx((__int64)Context) )
  {
    ...
    if ( !v7 )
    {
      ...
      if ( RaidIsUnitControlSupported((__int64)Context, 4) )
        v6 = RaCallMiniportUnitControl(*((_QWORD *)Context + 3) + 312LL);
...
LABEL_12:
        if ( v6 >= 0 )
        {
          *(_DWORD *)(*((_QWORD *)Context + 218) + 32LL) ^= (*(_DWORD *)(*((_QWORD *)Context + 218) + 32LL) ^ *(_DWORD *)(a2 + 8)) & 1;
          v22 = *((_DWORD *)Context + 455);
          v23 = *((_QWORD *)Context + 218);
          if ( v22 == -1 )
          {
            v24 = *(_DWORD **)(v23 + 8);
          ...
          *(_DWORD *)(*((_QWORD *)Context + 218) + 20LL) = *(_DWORD *)(a2 + 12);
          ...
          {
            LOBYTE(v25) = 1;
            PoRegisterCoalescingCallback(RaidUnitIoCoalescingCallback, v25, v26 + 96, Context);
      ...
      *((_DWORD *)v19 + 41) = 32;
      *((_DWORD *)v19 + 42) = 1;
      *((_OWORD *)v19 + 11) = xmmword_1C005A830;
      *((_DWORD *)v19 + 48) = 1;
      *((_DWORD *)v19 + 49) = 32;
      v19[25] = 0LL;
      v19[26] = 0LL;
      *((_DWORD *)v19 + 54) = -1;
      ...
      if ( v6 >= 0 )
      {
        if ( *v19 )
        {
          ...
          v21 = (struct _EX_RUNDOWN_REF_CACHE_AWARE *)*((_QWORD *)Context + 217);
...
LABEL_15:
  if ( StorEtwLoggingEnabled )
  {
    ...
    if ( RaidUnitCheckAndAcquirePoFx((__int64)Context) )
    {
      v29 = (__int64 *)*((_QWORD *)Context + 218);
      v9 = *v29;
      v11 = v29[4] & 1;
      v3 = *((_DWORD *)v29 + 5);
      v10 = *(_DWORD *)(v29[1] + 24);
