/*
 * XREFs of RaidAdapterQueryDeviceRelationsIrp @ 0x1C0017234
 * Callers:
...
NTSTATUS __fastcall RaidAdapterQueryDeviceRelationsIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 14LL, &WPP_2427d071e20036a288b852fd33055616_Traceguids, a1, a2);
  }
  ...
  if ( CurrentStackLocation->Parameters.Read.Length )
  {
    if ( StorEtwLoggingEnabled )
    {
      ...
      if ( (byte_1C00617E2 & 0x20) != 0 )
        McTemplateK0pd(v16, &EventPnpRequestComplete, v22, a2, a2->IoStatus.Status);
    }
  ...
  else
  {
    ...
    if ( v18[0] )
    {
      ...
      *(_QWORD *)(a1 + 5000) = 0LL;
      ...
      v13 = *(_QWORD *)(a1 + 5016);
      *(_QWORD *)(a1 + 5016) = 0LL;
      v14 = *(void (__fastcall **)(__int64, __int64, _QWORD, unsigned __int16 *, int))(a1 + 5008);
      *(_QWORD *)(a1 + 5008) = 0LL;
      *(_QWORD *)(a1 + 4988) = 0LL;
      _InterlockedOr(v17, 0);
      _InterlockedExchange((volatile __int32 *)(a1 + 4984), 0);
      if ( v14 )
      {
        RaidAdapterAcquireStartIoLock(a1, &v21);
        v15 = RaidNtStatusToStorStatus(v19);
        v14(*(_QWORD *)(a1 + 552) + 16LL, v13, v3, v12, v15);
    ...
    else
    {
      if ( StorEtwLoggingEnabled )
      {
        ...
        if ( (byte_1C00617E2 & 0x20) != 0 )
          McTemplateK0pd(v7, &EventPnpRequestComplete, v23, a2, v6);
      }
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 15LL, &WPP_2427d071e20036a288b852fd33055616_Traceguids, a1, a2, v9);
    }
    return v10;
  }
}
