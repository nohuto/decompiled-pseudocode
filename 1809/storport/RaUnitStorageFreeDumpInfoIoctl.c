/*
 * XREFs of RaUnitStorageFreeDumpInfoIoctl @ 0x1C0074E54
 * Callers:
...
__int64 __fastcall RaUnitStorageFreeDumpInfoIoctl(_QWORD *a1, IRP *a2)
{
  ...
  while ( QuadPart != &Parameters->DefaultTimeout )
  {
    ...
    v11 = v10.QuadPart - a1[247];
    if ( !v11 )
      v11 = (__int64)v7[4] - a1[248];
    if ( !v11 )
      break;
    ...
    *v14 = (PVOID *)v13;
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)(v17 + 8) = v18;
      ...
      StorPortReleaseAdditionalCrashDumpArea(v12 + 720, *(_QWORD *)(v15 + 48) + 56LL);
...
LABEL_41:
        if ( *(_WORD *)(v12 + 5218) )
        {
          v25 = *(void (__fastcall **)(_QWORD))(v12 + 5240);
          if ( v25 )
            v25(*(_QWORD *)(v12 + 5224));
        }
