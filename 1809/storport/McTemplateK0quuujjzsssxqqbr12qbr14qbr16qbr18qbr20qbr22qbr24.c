/*
 * XREFs of McTemplateK0quuujjzsssxqqbr12qbr14qbr16qbr18qbr20qbr22qbr24 @ 0x1C0029CD8
 * Callers:
...
ULONG __fastcall McTemplateK0quuujjzsssxqqbr12qbr14qbr16qbr18qbr20qbr22qbr24(
        ...
        __int64 a29)
{
  const struct _MCGEN_TRACE_CONTEXT *v29; // rcx
  __int64 v30; // rax
  __int64 v31; // rdx
  int v32; // r8d
  ...
  const struct _MCGEN_TRACE_CONTEXT *v56; // [rsp+B0h] [rbp-50h]
  ...
  if ( a10 )
  {
    ...
    do
      ++v31;
    while ( *((_WORD *)&a10->RegistrationHandle + v31) );
    v32 = 2 * v31 + 2;
  }
  else
  {
  ...
  v70 = &a15;
  if ( !a13 )
    v39 = (struct _MCGEN_TRACE_CONTEXT *)&stru_1C0055A88;
  v81 = 0;
  v72 = &a16;
  v74 = a17;
  v75 = a16;
