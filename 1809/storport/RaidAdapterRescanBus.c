/*
 * XREFs of RaidAdapterRescanBus @ 0x1C0017760
 * Callers:
...
__int64 __fastcall RaidAdapterRescanBus(__int64 a1, int *a2, _BYTE *a3)
{
  ...
  if ( v3 )
  {
    ...
    *(_QWORD *)(a1 + 4408) = MEMORY[0xFFFFF78000000014];
    if ( (unsigned int)RaidIsAdapterControlSupported(a1, 11) )
      RaCallMiniportAdapterControl(a1 + 312);
    v13 = *(_DWORD *)(a1 + 4984);
    v11 = RaidAdapterEnumerateBus(a1, v12, v16);
    v4 = 1;
    v5 = v13 != *(_DWORD *)(a1 + 4984);
  }
  if ( (*(_BYTE *)(a1 + 104) & 0x40) == 0 || v5 )
  {
    if ( (*(_BYTE *)(a1 + 104) & 0x40) != 0
      ...
      && *(_QWORD *)(a1 + 5040) )
    {
      RtlSetBit((PRTL_BITMAP)(a1 + 5024), *(unsigned __int8 *)(*(_QWORD *)(a1 + 5000) + 8LL));
    }
  }
  else
  {
