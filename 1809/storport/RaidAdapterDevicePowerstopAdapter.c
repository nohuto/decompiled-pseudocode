/*
 * XREFs of RaidAdapterDevicePowerstopAdapter @ 0x1C0016B44
 * Callers:
 ...
 *     RaidAdapterClearCryptoKeyTable @ 0x1C00376F0 (RaidAdapterClearCryptoKeyTable.c)
...
NTSTATUS __fastcall RaidAdapterDevicePowerstopAdapter(PIRP Irp, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_05398c2a44fb388ff25b1754e24905f8_Traceguids, a2, Irp);
  }
  RaidAdapterStop(a2);
  ...
  *(_DWORD *)(a2 + 284) = LowPart;
  ...
  if ( *(_QWORD *)(a2 + 5768) && Irp->Tail.Overlay.CurrentStackLocation->Parameters.Create.EaLength == 3 )
