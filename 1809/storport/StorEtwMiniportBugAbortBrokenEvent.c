/*
 * XREFs of StorEtwMiniportBugAbortBrokenEvent @ 0x1C004D338
 * Callers:
...
ULONG __fastcall StorEtwMiniportBugAbortBrokenEvent(__int64 a1, __int64 a2)
{
  __int64 v2; // r8
  int v3; // r9d
  __int64 v4; // r14
...
LABEL_36:
  ...
  if ( (byte_1C00617E4 & 4) != 0 )
  {
    ...
    return McTemplateK0zquuujqqbr7(
             v30,
             *(_QWORD *)(v9 + 24),
             (const GUID *)(a1 + 728),
             *(const struct _MCGEN_TRACE_CONTEXT **)(v4 + 8),
