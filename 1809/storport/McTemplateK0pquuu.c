/*
 * XREFs of McTemplateK0pquuu @ 0x1C003DB90
 * Callers:
...
ULONG McTemplateK0pquuu(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 1LL;
  return McGenEventWrite(a1, &EventPortResumeDevice, 0LL, 6u, &EventData);
}
