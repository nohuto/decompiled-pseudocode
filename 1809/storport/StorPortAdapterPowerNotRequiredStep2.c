/*
 * XREFs of StorPortAdapterPowerNotRequiredStep2 @ 0x1C00259A4
 * Callers:
 *     StorPortAdapterPowerNotRequiredStep1 @ 0x1C0025950 (StorPortAdapterPowerNotRequiredStep1.c)
 *     StorPortAdapterPowerNotRequiredStep2Passive @ 0x1C0043C00 (StorPortAdapterPowerNotRequiredStep2Passive.c)
 * Callees:
...
void __fastcall StorPortAdapterPowerNotRequiredStep2(PVOID Context)
{
  ...
  v2 = *((_QWORD *)Context + 644);
  v3 = 0;
  v4 = *(_DWORD *)(*(_QWORD *)(v2 + 8) + 12LL);
  if ( (v4 & 2) == 0 && *((_DWORD *)Context + 71) == 1 )
  {
    if ( (*(_DWORD *)(v2 + 20) & 0x40) != 0 && (v4 & 0x800) != 0 )
    {
      ...
      if ( KeGetCurrentIrql() )
      {
        if ( !_InterlockedCompareExchange((volatile signed __int32 *)Context + 1464, 1, 0) )
          IoQueueWorkItem(
            *((PIO_WORKITEM *)Context + 730),
      ...
      v10 = PoRequestPowerIrp(
              *((PDEVICE_OBJECT *)Context + 1),
              ...
              Context,
              (PIRP *)(*((_QWORD *)Context + 644) + 72LL));
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)Context + 10, &LockHandle);
      if ( v10 == 259 )
        *(_DWORD *)(*((_QWORD *)Context + 644) + 20LL) |= 0x20u;
    }
    v3 = 0;
  ...
  *((_QWORD *)Context + 680) = MEMORY[0xFFFFF78000000008];
  v7 = *(_DWORD *)(v6 + 20);
  if ( v5 )
  {
    *(_DWORD *)(v6 + 20) = v7 | 8;
    if ( !*((_QWORD *)Context + 679) )
      *((_QWORD *)Context + 679) = *((_QWORD *)Context + 680);
  }
  else
  {
    *(_DWORD *)(v6 + 20) = v7 & 0xFFFFFFF7;
  }
  PoFxCompleteDevicePowerNotRequired(**((_QWORD **)Context + 644));
