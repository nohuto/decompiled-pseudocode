/*
 * XREFs of McTemplateK0zquuujqqbr7 @ 0x1C004C714
 * Callers:
 *     StorEtwMiniportBugAbortBrokenEvent @ 0x1C004D338 (StorEtwMiniportBugAbortBrokenEvent.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0011680 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C0026060 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0zquuujqqbr7(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        ...
        __int64 a12)
{
  ...
  const struct _MCGEN_TRACE_CONTEXT *v16; // [rsp+40h] [rbp-89h]
  ...
  if ( a4 )
  {
    ...
    do
      ++v12;
    while ( *((_WORD *)&a4->RegistrationHandle + v12) );
  ...
  v32 = 4LL;
  v35 = 0;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v13, &EventMiniportBugAbortBroken, a3, 0xAu, &EventData);
}
