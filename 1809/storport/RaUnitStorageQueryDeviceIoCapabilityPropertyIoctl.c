/*
 * XREFs of RaUnitStorageQueryDeviceIoCapabilityPropertyIoctl @ 0x1C0070D24
 * Callers:
  ...
  else
  {
    ...
    if ( Length >= 0x10 )
    {
      ...
      *(_DWORD *)(&MasterIrp->Size + 1) = 16;
      ...
      if ( v9 )
      {
        LODWORD(MasterIrp->MdlAddress) = *(_DWORD *)(v9 + 528);
        HIDWORD(MasterIrp->MdlAddress) = *(_DWORD *)(*(_QWORD *)(a1 + 24) + 524LL);
      }
