/*
 * XREFs of PortTraceInitGlobalLogger @ 0x1C0052FD4
 * Callers:
...
char __fastcall PortTraceInitGlobalLogger(__int64 *a1)
{
  ...
  const unsigned __int8 **p_EnableLevel; // [rsp+60h] [rbp-A0h]
  ...
  _OWORD v31[7]; // [rsp+100h] [rbp+0h] BYREF
  ...
  v11 = 0;
  v10 = 0;
  memset(v31, 0, 0x26uLL);
  LODWORD(v31[2]) = *(_DWORD *)L"\\";
  p_EnableLevel = &stru_1C0055A88.EnableLevel;
  ...
  {
    v16 = 288;
    p_EnableLevel = (const unsigned __int8 **)L"Flags";
    v23 = 288;
    v18 = &v12;
    v15 = 0LL;
    v20 = &v10;
