/*
 * XREFs of StorpInitializeTimer @ 0x1C0023870
 * Callers:
...
__int64 __fastcall StorpInitializeTimer(__int64 a1, _QWORD *a2)
{
  ...
  if ( !a1 || !a2 )
  {
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 69LL, &WPP_890ff0257e5a37fc61b1814295f1a13c_Traceguids, a1, a2);
    }
    return 3238002694LL;
  }
  if ( KeGetCurrentIrql() <= 2u )
  {
    ...
    if ( v4 && !*(_DWORD *)v4 )
    {
      ...
      if ( Pool )
      {
        ...
        *(_QWORD *)v6 = v4;
        ...
        _InterlockedIncrement((volatile signed __int32 *)(v4 + 4272));
        *a2 = v6;
      }
      else
      {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 71LL, &WPP_890ff0257e5a37fc61b1814295f1a13c_Traceguids, a1);
    }
    return 3238002694LL;
  }
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 70LL, &WPP_890ff0257e5a37fc61b1814295f1a13c_Traceguids);
  }
  return 3238002696LL;
}
