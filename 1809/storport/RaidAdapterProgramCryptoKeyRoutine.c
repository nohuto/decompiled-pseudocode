/*
 * XREFs of RaidAdapterProgramCryptoKeyRoutine @ 0x1C00386B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RaidAdapterProgramCryptoKeyRoutine(PVOID IoObject, _QWORD *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  if ( Context )
  {
    ...
    v8 = *(_QWORD *)(*Context + 5784LL) + ((unsigned __int64)*((unsigned int *)Context + 2) << 6);
    ...
    if ( v3 >= 0 )
    {
      v10 = ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(*Context + 5792LL));
      *(_DWORD *)(v8 + 44) = 2;
      v11 = v10;
      EntrySList = FirstEntrySList((PSLIST_HEADER)(v8 + 48));
      InitializeSListHead((PSLIST_HEADER)(v8 + 48));
      ExReleaseSpinLockExclusive((PEX_SPIN_LOCK)(*Context + 5792LL), v11);
    }
  }
  v12 = 0LL;
  if ( EntrySList )
