/*
 * XREFs of RaidAdapterSurpriseRemovalIrp @ 0x1C0074244
 * Callers:
...
NTSTATUS __fastcall RaidAdapterSurpriseRemovalIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 88) = 5;
  if ( (unsigned int)(v2 - 5) > 1 )
  {
    ...
    {
      v5 = RaCallMiniportAdapterControl(a1 + 312);
      v3 = 1;
    }
  ...
  if ( (unsigned int)dword_1C0061058 > 5 && TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
  {
    ...
    *(unsigned int *)((char *)&hProvider.LevelPlus1 + 7) = v5;
    ...
    v36 = v12;
    v39 = v14;
    TlgWrite(&hProvider, &unk_1C0057010, v15, v16, 0xAu, (EVENT_DATA_DESCRIPTOR *)((char *)&hProvider.KeywordAll + 7));
  }
