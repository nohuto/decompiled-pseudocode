/*
 * XREFs of McTemplateK0zqjqq @ 0x1C00262F0
 * Callers:
...
ULONG __fastcall McTemplateK0zqjqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        ...
        char a8)
{
  ...
  const struct _MCGEN_TRACE_CONTEXT *v12; // [rsp+40h] [rbp-29h]
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)v9, &EventAdapterRescan, 0LL, 6u, &EventData);
}
