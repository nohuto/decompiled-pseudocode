/*
 * XREFs of StorpTelemetryNvmeHealthCriticalInfo @ 0x1C0050F8C
 * Callers:
...
char __fastcall StorpTelemetryNvmeHealthCriticalInfo(
        ...
        void *a14)
{
  ...
  {
    LOBYTE(v14) = TlgKeywordOn(a1, 0x800000000000uLL);
    if ( (_BYTE)v14 )
    {
      v18 = *(_QWORD *)(v16 + 24);
      v31 = *(_DWORD *)(v18 + 56);
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = g_SystemUptime_s;
      ...
      v74 = 8LL;
      v76 = 8LL;
      LOBYTE(v14) = TlgWrite(&hProvider, &unk_1C0058CAC, v23, v24, 0x19u, &pData);
    }
  }
  return (char)v14;
}
