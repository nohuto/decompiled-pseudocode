/*
 * XREFs of RaidCreateUnit @ 0x1C0019C20
 * Callers:
...
NTSTATUS __fastcall RaidCreateUnit(__int64 a1, _QWORD *a2)
{
  ...
  result = IoCreateDevice(
             *(PDRIVER_OBJECT *)(*(_QWORD *)(a1 + 8) + 8LL),
             RecommendedSharedDataAlignment + ((MaximumProcessorCount + 52) << 6),
             0LL,
             0x2Du,
             0x180u,
             0,
  ...
  if ( result >= 0 )
  {
    ...
    v8 = (void *)(-(__int64)(unsigned int)RecommendedSharedDataAlignment & (unsigned __int64)&DeviceExtension[RecommendedSharedDataAlignment + 3327]);
    ...
    *((_DWORD *)DeviceExtension + 12) = 0;
    v9 = (*(_BYTE *)(a1 + 5052) + 3) & 0xFC;
    if ( ((*(unsigned __int8 *)(a1 + 5052) + 3) & 0xFFFFFFFC) > 0xFF )
      v9 = -1;
    ...
    else
    {
      RaUnitSetQueueDepth(
        ...
        *(_DWORD *)(*((_QWORD *)DeviceExtension + 3) + 532LL),
        *(_DWORD *)(*((_QWORD *)DeviceExtension + 3) + 528LL));
      ...
      *((_QWORD *)DeviceExtension + 218) = 0LL;
      ...
      if ( *(_QWORD *)(v11 + 5152) )
      {
        if ( (*(_BYTE *)(v11 + 109) & 4) == 0 )
        {
          ...
          RaidAdapterPoFxActivateComponent(v11, 0LL);
        }
      }
