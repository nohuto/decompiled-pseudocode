/*
 * XREFs of _WOWCleanup @ 0x1C01FD010
 * Callers:
 *     NtUserWOWCleanup @ 0x1C021EF70 (NtUserWOWCleanup.c)
 * Callees:
...
__int64 __fastcall WOWCleanup(__int64 a1, int a2)
{
  ...
  if ( !a1 )
  {
    v6 = (struct _CALLPROCDATA ***)(CurrentProcessWin32Process + 352);
    v7 = 2LL;
    do
    {
      while ( 1 )
      ...
      v6 = (struct _CALLPROCDATA ***)((char *)v5 + 360);
      --v7;
    }
    while ( v7 );
    v9 = gSharedInfo[1];
