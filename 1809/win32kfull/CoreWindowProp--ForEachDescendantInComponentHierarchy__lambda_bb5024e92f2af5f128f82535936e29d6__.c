/*
 * XREFs of CoreWindowProp::ForEachDescendantInComponentHierarchy__lambda_bb5024e92f2af5f128f82535936e29d6___ @ 0x1C01090E4
 * Callers:
        ...
        __int128 *a2)
{
  ...
  if ( a1 && (unsigned int)CoreWindowProp::IsHost(a1) )
  {
    for ( i = 0LL; ; i = v7 )
    {
      ...
      if ( **((_DWORD **)a2 + 1) == 1 )
        v5 = -2LL;
      lambda_febfd44819ec4f1448c7d434538d8b97_::operator()(*(_QWORD *)a2, (__int64)NextComponentWindow, (_QWORD *)v5);
      v8 = *a2;
