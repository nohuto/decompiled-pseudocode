/*
 * XREFs of ?vFlushSpriteUpdates@DEVLOCKOBJ@@QEAAXH@Z @ 0x1C00FF7C4
 * Callers:
  ...
  if ( v4 )
  {
    if ( a2 )
    {
      if ( (*((_DWORD *)this + 6) & 0x1000) != 0 )
      {
        ...
        *(_DWORD *)(v4 + 44) &= ~1u;
        v6 = *(_QWORD *)v2;
        if ( (*(_DWORD *)(*(_QWORD *)v2 + 36LL) & 0x4000) != 0 && *(_QWORD *)(v6 + 472) && *(_DWORD *)(v6 + 488) )
    ...
    {
      v5 = *(_DWORD *)(v4 + 36);
      if ( (v5 & 0x4000) != 0 && (v5 & 0x40) != 0 && *(_QWORD *)(v4 + 472) )
      {
        if ( *(_DWORD *)(v4 + 488) )
        {
          W32PIDLOCK::vLockSingleThread((W32PIDLOCK *)(*(_QWORD *)(v4 + 496) + 272LL));
          W32PIDLOCK::vUnlockSingleThread((W32PIDLOCK *)(*(_QWORD *)(*(_QWORD *)v2 + 496LL) + 272LL));
        }
      }
    }
  }
