/*
 * XREFs of ?bDisableHalftone@PDEVOBJ@@QEAAHXZ @ 0x1C0122404
 * Callers:
 *     PDEVOBJ_bDisableHalftoneWrap @ 0x1C01223F0 (PDEVOBJ_bDisableHalftoneWrap.c)
 * Callees:
...
__int64 __fastcall PDEVOBJ::bDisableHalftone(PDEVOBJ *this)
{
  ...
  if ( v7 )
  {
    ...
    v11 = (unsigned int)HT_DestroyDeviceHalftoneInfo(*(_QWORD *)(*(_QWORD *)this + 1512LL)) != 0;
    if ( !v10 || !v11 )
      v9 = 0;
  }
  v12 = *(_QWORD *)this;
  v13 = 1;
  if ( v5 != *(_QWORD **)(*(_QWORD *)this + 1512LL) )
  {
