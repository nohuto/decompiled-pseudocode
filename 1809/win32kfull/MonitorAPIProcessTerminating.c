/*
 * XREFs of MonitorAPIProcessTerminating @ 0x1C010A9B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextElementIndex@?$CList@VCPhysicalMonitorHandle@@@OPM@@QEAAEKPEAK@Z @ 0x1C0255FC8 (-GetNextElementIndex@-$CList@VCPhysicalMonitorHandle@@@OPM@@QEAAEKPEAK@Z.c)
 */
...
void __fastcall MonitorAPIProcessTerminating(void *a1)
{
  ...
  v1 = (char *)qword_1C0317778;
  OPM::CAutoMutex::CAutoMutex((OPM::CAutoMutex *)&v7, (struct OPM::CMutex *)((char *)qword_1C0317778 + 32));
  if ( *((_DWORD *)v1 + 4) )
  {
    if ( !**((_QWORD **)v1 + 1) )
    {
