/*
 * XREFs of ?ValidatePointerPromotion@@YAHGKPEAKPEAPEAUtagMOUSE_PROMOTION_ENTRY@@1@Z @ 0x1C01F1DDC
 * Callers:
        ...
        struct tagMOUSE_PROMOTION_ENTRY **a5)
{
  ...
  v10 = CacheById;
  if ( !CacheById || CacheById == word_1C03171F8 && (dword_1C03172F8 & 2) != 0 )
    return 0LL;
  ...
  if ( v5 != 0x10000000 || (v5 = DetectPromotionType(v12, v13), v5 != v15) )
  {
    ...
    else if ( v18 || v10 != word_1C03171F8 )
    {
      return 0LL;
    }
    *a3 = v5;
