/*
 * XREFs of ?MNInitDrawItemStruct@@YAXPEAUHDC__@@IAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@HHPEAUtagDRAWITEMSTRUCT@@@Z @ 0x1C00AB7F8
 * Callers:
...
__int64 __fastcall MNInitDrawItemStruct(__int64 a1, int a2, __int64 ***a3, __int64 *a4, int a5, int a6, __int64 a7)
{
  ...
  *(_DWORD *)(a7 + 8) = v10;
  ...
  v12 = 2 * (*(_DWORD *)(*a4 + 4) & 1);
  v13 = MNDrawHilite(a3, a4);
  *(_DWORD *)(a7 + 16) = v15 | v11 | (v13 != 0) | v12 | v14 | (8 * (*(_DWORD *)((**a3)[5] + 40) & 0x10)) | (*(_DWORD *)(*a4 + 4) >> 2) & 0x40 | ~((unsigned __int16)*(_DWORD *)((**a3)[5] + 40) << 6) & 0x100;
