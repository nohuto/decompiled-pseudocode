/*
 * XREFs of ?vXlatGlyphArray@RFONTOBJ@@QEAAXPEBGIPEAKKH@Z @ 0x1C0084210
 * Callers:
        ...
        int a6)
{
  ...
  if ( a6 )
  {
    ...
    {
      v8 = *(_QWORD *)(v6[16] + 8LL * ((v40 - 1) & 0xFFFFFFFE) + 224);
      v52 = v8;
      v53[0] = v8;
      if ( v8 && (v41 = PFEOBJ::pfdg((PFEOBJ *)v53), v8 = v52, v41) )
      {
        v10 = 1;
        v13 = v41;
        LODWORD(v54) = 1;
...
LABEL_120:
              ...
              v25 += v46;
LABEL_125:
              if ( v25 > v19 || (v47 = 4096, v23 < p_wcLow[8 * v25]) )
                v47 = -4096;
              v24 += v47;
LABEL_71:
              if ( v24 <= v17 && v23 >= p_wcLow[8 * v24] )
...
LABEL_53:
        ...
        {
          v48 = *a2;
          if ( *a2 >= gqlTTSystem && v48 <= (unsigned __int16)word_1C0319AD2 )
          {
            v49 = v48 - gqlTTSystem;
            ...
            if ( ((0x80000000 >> v50) & *(_DWORD *)(qword_1C0319AD8 + 4LL * (v49 >> 5))) != 0 )
LABEL_55:
