/*
 * XREFs of InputPreMul32BPPToAA24 @ 0x1C0249DA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
_BYTE *__fastcall InputPreMul32BPPToAA24(char *a1, _BYTE *a2)
{
  ...
  if ( (*a1 & 4) != 0 )
  {
    ...
    {
      v8 = dwABPreMul[v5[3]];
      v9 = *(_DWORD *)(v7 + 4 * ((unsigned __int64)(v8 * (unsigned int)v5[1] + 0x800000) >> 24) + 1024)
         + *(_DWORD *)(v7 + 4 * ((unsigned __int64)(v8 * (unsigned int)v5[2] + 0x800000) >> 24) + 2048);
      v10 = *v5;
      v5 += 4;
      *v2++ = (unsigned __int16)(*(_WORD *)(v7 + 4 * ((unsigned __int64)(unsigned int)(v8 * v10 + 0x800000) >> 24)) + v9) >> 8;
    }
  ...
  else
  {
    ...
    do
    {
      ...
      v19 = *v15;
      v15 += 4;
      *v2 = (unsigned int)(v18 * v19 + 0x800000) >> 24;
      v2[1] = (unsigned int)(v18 * v16 + 0x800000) >> 24;
