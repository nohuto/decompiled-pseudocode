/*
 * XREFs of ?bPolygonizePen@WIDEPENOBJ@@QEAAHAEAVEXFORMOBJ@@J@Z @ 0x1C01436AC
 * Callers:
 ...
 *     ?vHalve@@YAXAEAVEVECTORFX@@@Z @ 0x1C014396C (-vHalve@@YAXAEAVEVECTORFX@@@Z.c)
...
__int64 __fastcall WIDEPENOBJ::bPolygonizePen(WIDEPENOBJ *this, struct EXFORMOBJ *a2, int a3)
{
  ...
  *(_QWORD *)((char *)&v13 + 4) = 0LL;
  ...
  if ( !*((_QWORD *)this + 1) || *((_DWORD *)this + 30) )
    return 0LL;
  if ( !(unsigned int)bTurnLeftRandom((struct EVECTORFX *)&v13, (struct EVECTORFX *)((char *)&v13 + 8)) )
  {
  ...
  v17 = v8 + DWORD2(v13);
  v15 = v10 + v13;
  return WIDEPENOBJ::bPenFlatten(this, &v14);
}
