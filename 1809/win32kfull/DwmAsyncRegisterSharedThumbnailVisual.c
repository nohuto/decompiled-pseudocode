/*
 * XREFs of DwmAsyncRegisterSharedThumbnailVisual @ 0x1C0007B5C
 * Callers:
 *     DwmAsyncRegisterSharedThumbnailVisualApiExt @ 0x1C0007B20 (DwmAsyncRegisterSharedThumbnailVisualApiExt.c)
 * Callees:
