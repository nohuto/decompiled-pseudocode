/*
 * XREFs of ?SendSynchronousIoControl@RimBackedDeviceBase@Rim@@QEBAJKPEAXK0KPEAK@Z @ 0x1C0221C50
 * Callers:
 ...
 * Callees:
 *     ??1DeviceObjectPointer@Io@@QEAA@XZ @ 0x1C022188C (--1DeviceObjectPointer@Io@@QEAA@XZ.c)
 ...
 *     SendSynchronousIoControl @ 0x1C0221D5C (SendSynchronousIoControl.c)
 */
