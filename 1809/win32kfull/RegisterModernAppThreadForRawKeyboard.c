/*
 * XREFs of RegisterModernAppThreadForRawKeyboard @ 0x1C01C4F00
 * Callers:
...
__int64 __fastcall RegisterModernAppThreadForRawKeyboard(__int64 a1)
{
  ...
  {
    v7 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 424) + 832LL) + 100LL);
    if ( (v7 & 0x800) != 0 )
    {
      *(_DWORD *)(a1 + 1208) = v1 | 0x200000;
      return 1LL;
    }
    if ( (v7 & 0x10) != 0 )
    {
  ...
  v8[0] = 393217;
  v8[1] = 16944;
  if ( !(unsigned int)RegisterRawInputDevices((__int64)v8, 1u, 2u) )
    return 0LL;
  *(_DWORD *)(a1 + 1208) |= 0x200000u;
  return 1LL;
}
