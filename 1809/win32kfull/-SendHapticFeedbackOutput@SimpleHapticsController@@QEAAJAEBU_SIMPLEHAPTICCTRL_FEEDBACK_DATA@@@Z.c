/*
 * XREFs of ?SendHapticFeedbackOutput@SimpleHapticsController@@QEAAJAEBU_SIMPLEHAPTICCTRL_FEEDBACK_DATA@@@Z @ 0x1C023EDE4
 * Callers:
        ...
        const struct _SIMPLEHAPTICCTRL_FEEDBACK_DATA *a2)
{
  ...
  if ( (unsigned int)dword_1C030C3C8 > 4 )
  {
    ...
    v29 = 4LL;
    v31 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C3C8, &unk_1C02D6C52, 0LL, 0LL, 7u, &v21);
  }
...
LABEL_22:
  if ( (unsigned int)dword_1C030C3C8 > 4 )
  {
    ...
    v25 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C3C8, &unk_1C02D6BAB, 0LL, 0LL, 4u, &v21);
    return v17;
  }
  return result;
}
