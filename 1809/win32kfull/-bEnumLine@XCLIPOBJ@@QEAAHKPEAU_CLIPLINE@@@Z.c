/*
 * XREFs of ?bEnumLine@XCLIPOBJ@@QEAAHKPEAU_CLIPLINE@@@Z @ 0x1C013A654
 * Callers:
 ...
 *     ?bRecordRun@XCLIPOBJ@@IEAAHAEAJ@Z @ 0x1C013A3D8 (-bRecordRun@XCLIPOBJ@@IEAAHAEAJ@Z.c)
 *     ?bFindNextScan@XCLIPOBJ@@IEAAHXZ @ 0x1C013A45C (-bFindNextScan@XCLIPOBJ@@IEAAHXZ.c)
