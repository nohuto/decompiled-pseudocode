/*
 * XREFs of ?UMPDDrvFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C028D170
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a7)
{
  ...
  if ( v22 )
  {
          ...
          (v17 = v13) != 0) )
    {
      ...
      v25[4] = a2;
      v25[5] = a3;
      if ( !(unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 64), (EVENT_DATA_DESCRIPTOR **)&v25[3], v9)
