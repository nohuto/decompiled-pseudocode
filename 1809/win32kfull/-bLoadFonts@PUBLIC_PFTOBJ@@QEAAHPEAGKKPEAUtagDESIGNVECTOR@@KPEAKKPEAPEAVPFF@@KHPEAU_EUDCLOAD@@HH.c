/*
 * XREFs of ?bLoadFonts@PUBLIC_PFTOBJ@@QEAAHPEAGKKPEAUtagDESIGNVECTOR@@KPEAKKPEAPEAVPFF@@KHPEAU_EUDCLOAD@@HH@Z @ 0x1C007EB54
 * Callers:
        ...
        int a14)
{
  ...
  char v94[8]; // [rsp+F0h] [rbp-20h] BYREF
  unsigned int *v95; // [rsp+F8h] [rbp-18h]
  ...
  if ( a2 && a4 <= 3 )
  {
    ...
    if ( !a11 )
    {
      ...
      *v14 = v23;
      if ( v23 )
      {
        v24 = PFTOBJ::chpfeIncrPFF(v16, v23, &v83, v18, v22);
        *v19 = v24;
        if ( v24 )
        {
          if ( (v18 & 0x40) != 0 )
      ...
      if ( v27 && !a14 && !*((_QWORD *)v27 + 19) )
      {
        ...
        if ( v86[0] )
        {
          if ( (unsigned int)PFFMEMOBJ::bLoadFontFileTable((PFFMEMOBJ *)v86, SourceString, v64, 0LL, a12) )
          {
            ...
            *v14 = v65;
            if ( v65 && (v71 = PFTOBJ::chpfeIncrPFF(v16, v65, &v83, v18, a12), v17 = v83, (v64 = v71) != 0) )
            {
              *v19 = v71;
            }
            else
...
LABEL_57:
          ...
          *a9 = v44;
          if ( v44 )
          {
            v72 = PFTOBJ::chpfeIncrPFF(v16, v44, &v83, v18, a12);
            if ( v72 )
            {
              if ( (v18 & 0x40) != 0 )
                v72 = 0;
