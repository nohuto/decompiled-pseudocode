/*
 * XREFs of ?bCreateDIB@MULTISURF@@AEAAHXZ @ 0x1C02894E4
 * Callers:
 *     ?bLoadSourceNotMetaDEVBITMAP@MULTISURF@@AEAAHPEAUHDEV__@@@Z @ 0x1C02899D4 (-bLoadSourceNotMetaDEVBITMAP@MULTISURF@@AEAAHPEAUHDEV__@@@Z.c)
 * Callees:
...
__int64 __fastcall MULTISURF::bCreateDIB(MULTISURF *this)
{
  ...
  if ( SURFMEM::bCreateDIB(
         ...
         0,
         0)
    && (v8 = *(void (__fastcall **)(__int64, __int64, _QWORD, _QWORD, _DWORD *, int *))(v4 + 2840)) != 0LL )
  {
    v8(
