/*
 * XREFs of ?RedirAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x1C027F820
 * Callers:
 *     <none>
 * Callees:
        ...
        BLENDOBJ *pBlendObj)
{
  ...
  struct SURFACE *v22; // [rsp+58h] [rbp-61h] BYREF
  ...
  if ( a1 )
  {
    if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(a1) + 112) & 0x800) != 0 )
    {
      ...
      if ( HDEV )
      {
        ...
        {
          for ( i = **(struct _DISPSURF ***)(v11 + 1800); i; i = *(struct _DISPSURF **)i )
          {
            v13 = *((_QWORD *)i + 6);
            HDEV = v13;
            if ( v13 )
            {
              if ( (*(_DWORD *)(v13 + 1824) & 0x8000000) != 0 && (*(_DWORD *)(v13 + 2128) & 0x8000) != 0 )
              {
                if ( *(_QWORD *)(*(_QWORD *)(v13 + 1792) + 632LL) )
                {
