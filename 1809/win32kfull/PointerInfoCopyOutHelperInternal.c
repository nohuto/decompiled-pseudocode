/*
 * XREFs of PointerInfoCopyOutHelperInternal @ 0x1C01DD6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PointerInfoCopyOutHelperInternal(__int64 a1, __int64 a2, __int64 a3, int a4, int a5, ULONG64 a6)
{
  ...
  AdjustedPointerLocations = GetAdjustedPointerLocations(
                               ...
                               *(_QWORD *)(a1 + 64),
                               ...
                               v24,
                               a3);
  if ( (*(_DWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v10) + 1208) & 0x2000) != 0 )
  ...
  if ( v12 )
  {
    ...
    if ( (_BYTE)v13 != 2 )
    {
      ...
      if ( *(_DWORD *)*gpDispInfo > 1u && a3 && ((*(_DWORD *)(a3 + 308) & 0x20) != 0 || *(_DWORD *)(a3 + 24) == 6) )
      {
        v26 = *(_OWORD *)(a3 + 176);
...
LABEL_36:
  if ( v19 )
  {
    if ( *(_DWORD *)(a1 + 8) == 5 )
    {
      ...
      if ( (*(_DWORD *)(W32GetThreadWin32Thread((__int64)CurrentThread, v13) + 1208) & 0x10000) == 0 )
        *(_QWORD *)(a6 + 16) = -2LL;
    }
    if ( AdjustedPointerLocations )
    {
