/*
 * XREFs of ?SearchIconCache@@YAPEAUtagCURSOR@@PEAU1@GPEAU_UNICODE_STRING@@0PEAUtagCURSORFIND@@@Z @ 0x1C006B230
 * Callers:
 ...
 * Callees:
 *     ?ResStrCmp@@YAHPEAU_UNICODE_STRING@@0@Z @ 0x1C006B30C (-ResStrCmp@@YAHPEAU_UNICODE_STRING@@0@Z.c)
 */
