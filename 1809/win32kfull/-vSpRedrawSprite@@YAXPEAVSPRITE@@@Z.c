/*
 * XREFs of ?vSpRedrawSprite@@YAXPEAVSPRITE@@@Z @ 0x1C0096B08
 * Callers:
...
void __fastcall vSpRedrawSprite(struct SPRITE *a1)
{
  ...
  _BYTE v22[8]; // [rsp+68h] [rbp-A0h] BYREF
  ...
  unsigned int v32; // [rsp+128h] [rbp+20h] BYREF
  _OWORD v33[20]; // [rsp+12Ch] [rbp+24h] BYREF
...
LABEL_28:
            ...
            do
            {
              v11 = XCLIPOBJ::bEnum((XCLIPOBJ *)v24, 0x144u, (char *)&v32, 0LL);
LABEL_30:
              if ( v32 )
              {
                do
                {
                  v14 = (struct _RECTL *)&v33[v4];
                  if ( v14->left < *v5 )
                    v14->left = *v5;
                  v15 = *((_DWORD *)a1 + 22);
                  if ( v14->right > v15 )
