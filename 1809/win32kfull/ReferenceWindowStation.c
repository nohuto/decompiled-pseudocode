/*
 * XREFs of ReferenceWindowStation @ 0x1C00D9F40
 * Callers:
...
NTSTATUS __fastcall ReferenceWindowStation(struct _KTHREAD *a1, void *a2, ACCESS_MASK a3, _QWORD *a4, int a5)
{
  ...
  if ( ProcessWin32Process )
  {
    if ( !a5
      || !v12
      || (v16 = *(_QWORD *)(v12 + 456)) == 0
      || *(_QWORD *)(ProcessWin32Process + 672) == *(_QWORD *)(v16 + 40) )
    {
      v9 = *(PVOID *)(ProcessWin32Process + 672);
      if ( v9 )
      {
        if ( !RtlAreAllAccessesGranted(*(_DWORD *)(ProcessWin32Process + 688), a3) )
        {
