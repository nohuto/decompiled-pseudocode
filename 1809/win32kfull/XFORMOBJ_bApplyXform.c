/*
 * XREFs of XFORMOBJ_bApplyXform @ 0x1C02A0E10
 * Callers:
...
BOOL __stdcall XFORMOBJ_bApplyXform(XFORMOBJ *pxo, ULONG iMode, ULONG cPoints, PVOID pvIn, PVOID pvOut)
{
  ...
  if ( iMode )
  {
    ...
    EXFORMOBJ::EXFORMOBJ((EXFORMOBJ *)v16, (struct MATRIX *)v17, 0);
    if ( !EXFORMOBJ::bInverse((EXFORMOBJ *)v16, *(struct MATRIX **)&pxo->ulReserved) )
      return v6;
    if ( iMode == 1 )
    {
      if ( v8 != pvOut )
