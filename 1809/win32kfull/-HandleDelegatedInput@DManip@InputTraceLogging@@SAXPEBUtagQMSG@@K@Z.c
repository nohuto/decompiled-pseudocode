/*
 * XREFs of ?HandleDelegatedInput@DManip@InputTraceLogging@@SAXPEBUtagQMSG@@K@Z @ 0x1C01CDD9C
 * Callers:
 ...
 *     ?DelegationResponseToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C01CD4C8 (-DelegationResponseToString@InputTraceLogging@@CAPEBDK@Z.c)
 */
...
void __fastcall InputTraceLogging::DManip::HandleDelegatedInput(const struct tagQMSG *a1, int a2)
{
  ...
  if ( IsPointerInputMessage(*((_DWORD *)a1 + 6)) )
  {
    if ( (unsigned int)dword_1C030D340 > 4 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x1000uLL) )
      {
        ...
        TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D53AB, 0LL, 0LL, 8u, &pData);
      }
    }
  }
         ...
         && TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x1000uLL) )
  {
    ...
    TlgCreateSz(&v25, v13);
    TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D5423, 0LL, 0LL, 5u, &pData);
  }
}
