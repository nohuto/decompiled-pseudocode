/*
 * XREFs of ?OnInput@Transforms@InputTraceLogging@@SAX_KPEAUHWND__@@PEBUCompositionInputObject@@_NAEBUtagINPUT_TRANSFORM@@@Z @ 0x1C000599C
 * Callers:
        ...
        const struct tagINPUT_TRANSFORM *a5)
{
  ...
  if ( (unsigned __int8)InputTraceLogging::Enabled(0LL) && dword_1C030D340 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 4uLL) )
    {
      v22 = v6;
      v15 = &v11;
      v17 = &v12;
      ...
      v52 = 4LL;
      v54 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D55D7, 0LL, v7, 0x16u, &pData);
    }
  }
}
