/*
 * XREFs of ReadPointerDeviceSettings @ 0x1C00AA230
 * Callers:
...
__int64 __fastcall ReadPointerDeviceSettings(int a1, __int64 a2, unsigned __int16 *a3, unsigned int a4)
{
  ...
  int v36; // eax
  int v37; // ecx
  struct tagDEVICECONFIG_SETTING *v38; // rdi
  unsigned int v39; // eax
  unsigned int v40; // eax
  int v41; // eax
  struct tagDEVICECONFIG_SETTING *v42; // rdi
  int v43; // eax
  int v44; // eax
  int v45; // eax
  int v46; // eax
  ...
  if ( !(_DWORD)v6 )
  {
    ...
    v19 = off_1C030C060;
    GetLocalMachineRegistryDWORDValues(v6, L"\\Software\\Microsoft\\Wisp\\Touch", off_1C030C060);
  ...
  if ( v8 )
  {
    ...
    if ( v37 == 2 )
    {
      if ( !gPredictionMonitor && (int)CreatePredictionSettings(off_1C030C020, a2, a3, a4) >= 0 )
      {
...
LABEL_62:
        v38 = off_1C030C020;
        GetPredictionSettings(off_1C030C020, a2, a3, a4);
        v39 = *((_DWORD *)v38 + 3);
        if ( v39 == -1 )
        {
          v39 = *((_DWORD *)v38 + 2);
        ...
        *(_DWORD *)(a2 + 4) = v39;
        glTOUCH_DRIVER_HW_STACK_LATENCY = v39;
        v40 = *((_DWORD *)v38 + 7);
        if ( v40 == -1 )
        {
          v40 = *((_DWORD *)v38 + 6);
        ...
        *(_DWORD *)(a2 + 8) = v40;
        glTOUCH_DRIVER_HW_STACK_SAMPLETIME = v40;
        v41 = *((_DWORD *)v38 + 11);
        if ( v41 == -1 )
          v41 = *((_DWORD *)v38 + 10);
        *(_DWORD *)(a2 + 12) = v41;
        gbTOUCH_DRIVER_HW_STACK_TIMESTAMP = v41;
        return 1LL;
      }
    }
    return 0LL;
