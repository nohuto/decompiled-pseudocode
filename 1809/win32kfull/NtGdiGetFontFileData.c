/*
 * XREFs of NtGdiGetFontFileData @ 0x1C029D8B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CFixPred@Prediction@@QEAA@XZ @ 0x1C0137720 (--0CFixPred@Prediction@@QEAA@XZ.c)
 *     ??1PFFREFOBJ@@QEAA@XZ @ 0x1C0161750 (--1PFFREFOBJ@@QEAA@XZ.c)
...
LABEL_8:
  ...
  if ( v17 + Size < v17 || *(unsigned int *)(v11 + 24) < v17 + Size )
    goto LABEL_8;
  if ( (unsigned int)EngMapFontFileFDInternal(v11, 0LL, 0LL, 0) )
  {
