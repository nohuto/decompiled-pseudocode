/*
 * XREFs of ?HidRequestValidityCheck@@YAHQEAUtagRAWINPUTDEVICE@@PEBUtagPROCESS_HID_TABLE@@W4_REGISTER_RAW_INPUT_INTERNAL@@@Z @ 0x1C0103658
 * Callers:
...
__int64 __fastcall HidRequestValidityCheck(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v5 = 0LL;
  v6 = (_DWORD)a3 == 2;
  if ( (_DWORD)a3 != 2 && (*(_DWORD *)(a1 + 4) & 0xFFFFC0CE) != 0 )
    goto LABEL_40;
  if ( !*(_WORD *)a1 )
    goto LABEL_38;
