/*
 * XREFs of NtGdiCreateColorTransform @ 0x1C029A500
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a8)
{
  ...
  *(_DWORD *)&v12->lcsFilename[2] = *(_DWORD *)(a2 + 72);
  ...
  {
    v15 = v10;
    v16 = (ULONG64)Address + v10;
    if ( v16 > MmUserProbeAddress || v16 < (unsigned __int64)Address )
      *(_BYTE *)MmUserProbeAddress = 0;
    if ( EvaluateCurrentState((const struct reg_FeatureDescriptor *)&g_Feature_2182559032_59890558_FeatureDescriptorDetails) )
  ...
  {
    v18 = (ULONG64)a7 + v11;
    if ( v18 > MmUserProbeAddress || v18 < (unsigned __int64)a7 )
      *(_BYTE *)MmUserProbeAddress = 0;
    if ( EvaluateCurrentState((const struct reg_FeatureDescriptor *)&g_Feature_2182559032_59890558_FeatureDescriptorDetails) )
