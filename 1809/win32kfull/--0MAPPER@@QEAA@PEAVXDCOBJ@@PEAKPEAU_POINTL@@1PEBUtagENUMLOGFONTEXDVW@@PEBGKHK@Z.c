/*
 * XREFs of ??0MAPPER@@QEAA@PEAVXDCOBJ@@PEAKPEAU_POINTL@@1PEBUtagENUMLOGFONTEXDVW@@PEBGKHK@Z @ 0x1C00291D0
 * Callers:
...
LABEL_76:
  ...
  *((_DWORD *)this + 42) = abs32(v42);
  ...
  if ( (v50 & 1) != 0 && (v41 & 0xFu) - 1 > 1 )
    ...
    v51 = *(_DWORD *)&a6[5].elfEnumLogfontEx.elfLogFont.lfFaceName[24];
  *((_DWORD *)this + 61) = v51;
  ...
  if ( (*(_DWORD *)&a6->elfEnumLogfontEx.elfLogFont.lfFaceName[6] & 1) == 0 || (v40 & 0xFu) - 1 <= 1 )
    v49 = *(_DWORD *)&a6[5].elfEnumLogfontEx.elfLogFont.lfFaceName[26];
  *((_DWORD *)this + 62) = v49;
  *((_DWORD *)this + 63) |= (*(_DWORD *)&v57[5].elfEnumLogfontEx.elfLogFont.lfFaceName[28] >> 5) & 0x100;
  *((_DWORD *)this + 63) |= (*(_DWORD *)&v57[5].elfEnumLogfontEx.elfLogFont.lfFaceName[28] & 8) << 7;
  ...
  *((_DWORD *)this + 63) |= v60 ? 0x200 : 0;
  v63 = *((_DWORD *)this + 41);
  if ( *(_DWORD *)&v62[5].elfEnumLogfontEx.elfLogFont.lfFaceName[6] )
    v59 = 0;
  v64 = *((_DWORD *)this + 63) | v59;
  *((_DWORD *)this + 63) = v64;
  if ( *(_DWORD *)&v62[5].elfEnumLogfontEx.elfLogFont.lfFaceName[6] != 4 )
    v61 = 0;
  v65 = v64 | v61;
  *((_DWORD *)this + 63) = v65;
  v66 = v63 < 0;
  if ( !v63 )
  {
    v63 = *(_DWORD *)&v62[4].elfEnumLogfontEx.elfFullName[28];
    v65 |= 8u;
    *((_DWORD *)this + 63) = v65;
    v66 = v63 < 0;
    *((_DWORD *)this + 41) = v63;
