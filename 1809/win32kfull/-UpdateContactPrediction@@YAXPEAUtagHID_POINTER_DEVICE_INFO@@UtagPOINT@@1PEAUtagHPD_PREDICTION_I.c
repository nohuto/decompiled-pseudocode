/*
 * XREFs of ?UpdateContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x1C01D8A58
 * Callers:
 *     DoPrediction @ 0x1C01D9BB0 (DoPrediction.c)
 * Callees:
 *     ??KPrediction@@YA?AVCFixPred@0@AEBV10@0@Z @ 0x1C01D74A4 (--KPrediction@@YA-AVCFixPred@0@AEBV10@0@Z.c)
 *     ?DeltaOvershootCompensation@Prediction@@YA_J_J0@Z @ 0x1C01D77DC (-DeltaOvershootCompensation@Prediction@@YA_J_J0@Z.c)
 ...
 *     ?Smooth@tagExpoSmoother@Prediction@@QEAA?AVCFixPred@2@V32@@Z @ 0x1C01D88C8 (-Smooth@tagExpoSmoother@Prediction@@QEAA-AVCFixPred@2@V32@@Z.c)
 */
        ...
        struct tagPOINT *a6)
{
  ...
  v6 = a4;
  if ( gbTOUCH_DRIVER_HW_STACK_TIMESTAMP != 1 || (v7 = *((_DWORD *)a1 + 195) - *((_DWORD *)a1 + 196)) == 0 )
