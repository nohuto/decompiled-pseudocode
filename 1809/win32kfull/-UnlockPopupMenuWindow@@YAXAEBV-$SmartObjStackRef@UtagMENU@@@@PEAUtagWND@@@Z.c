/*
 * XREFs of ?UnlockPopupMenuWindow@@YAXAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagWND@@@Z @ 0x1C020A310
 * Callers:
...
char __fastcall UnlockPopupMenuWindow(__int64 a1)
{
  ...
  if ( !(_BYTE)v1 )
  {
    ...
    {
      v5 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)*v3 + 80LL) + 144LL);
      v6 = v4[2];
      v7 = v6 ? v6 == v5 : *(_QWORD *)*v4 == v5;
      LOBYTE(v1) = v7;
      if ( !v7 )
      {
        v8 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)*v4 + 80LL) + 136LL);
        v9 = v4[2];
        if ( v9 )
          v10 = v9 == v8;
        else
