/*
 * XREFs of ?ProbeAndDeepCaptureWinStaDesktopObjectAttributes@@YAJHPEAU_OBJECT_ATTRIBUTES@@AEAY0BAA@GAEAU1@AEAU_SECURITY_QUALITY_OF_SERVICE@@AEAPEAXAEAU_UNICODE_STRING@@AEAPEAG@Z @ 0x1C015DD04
 * Callers:
        ...
        unsigned __int16 **a8)
{
  ...
  __int64 v22; // rdx
  _DWORD v24[8]; // [rsp+38h] [rbp-20h] BYREF
  ...
  *(_OWORD *)&a4->SecurityDescriptor = v11;
  ...
  if ( a1 && !a4->ObjectName && !a4->RootDirectory )
  {
    ...
    if ( ProcessLuid >= 0 )
    {
      RtlStringCchPrintfW(a3, 0x100uLL, L"%ws\\Service-0x%x-%x$", szWindowStationDirectory, v24[1], v24[0], ProcessLuid);
