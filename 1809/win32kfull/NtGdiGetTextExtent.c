/*
 * XREFs of NtGdiGetTextExtent @ 0x1C0292760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetTextExtent(HDC a1, const void *a2, signed int a3, struct _POINTL *a4, char a5)
{
  ...
  ULONG64 v11; // rax
  struct _POINTL v13; // [rsp+50h] [rbp-88h] BYREF
  HDC v14; // [rsp+58h] [rbp-80h]
  HDC v15; // [rsp+60h] [rbp-78h]
  struct _POINTL *v16; // [rsp+68h] [rbp-70h]
...
LABEL_21:
    if ( (unsigned __int64)v5 >= MmUserProbeAddress )
      v5 = (struct _POINTL *)MmUserProbeAddress;
    *v5 = v13;
    return TextExtentW;
  }
  if ( a2 )
  ...
  if ( TextExtentW )
    TextExtentW = GreGetTextExtentW(a1, (unsigned __int16 *)v9, a3, (struct tagSIZE *)&v13, a5);
  if ( (int)v6 > 16 && v9 )
    FreeTmpBuffer(v9);
  if ( TextExtentW )
    goto LABEL_21;
