/*
 * XREFs of ?QueueAndGenerateInput@InteractiveControlDevice@@QEAAJPEAXK@Z @ 0x1C023B658
 * Callers:
 ...
 *     ??_GInteractiveControlInput@@QEAAPEAXI@Z @ 0x1C023A5C4 (--_GInteractiveControlInput@@QEAAPEAXI@Z.c)
 ...
 *     ?GetPreviousInputReport@InteractiveControlDevice@@QEAAHPEAU_LIST_ENTRY@@PEAPEAVInteractiveControlInput@@@Z @ 0x1C023AEF0 (-GetPreviousInputReport@InteractiveControlDevice@@QEAAHPEAU_LIST_ENTRY@@PEAPEAVInteractiveContro.c)
 ...
 *     ?QueueInput@InteractiveControlDevice@@QEAAXPEAU_LIST_ENTRY@@PEAVInteractiveControlInput@@@Z @ 0x1C023B8C0 (-QueueInput@InteractiveControlDevice@@QEAAXPEAU_LIST_ENTRY@@PEAVInteractiveControlInput@@@Z.c)
 ...
 *     ??0InteractiveControlInput@@QEAA@PEAVInteractiveControlDevice@@@Z @ 0x1C023C240 (--0InteractiveControlInput@@QEAA@PEAVInteractiveControlDevice@@@Z.c)
        ...
        unsigned int a3)
{
  ...
  if ( a3 % (unsigned int)v3 )
  {
    ...
    if ( dword_1C030C400 > 2u )
    {
      ...
      LODWORD(v13) = v3;
      v24 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C030C400, &unk_1C02D6A9E, 0LL, 0LL, 6u, &pData);
    }
  }
  else
  {
