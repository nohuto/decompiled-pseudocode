/*
 * XREFs of ?TestSequence@WindowArrangementSequence@@YAXQEBUtagHOTKEY@@IIIH@Z @ 0x1C00DFFF8
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( this )
  {
    if ( (((unsigned __int16)a2 << 16) | a4) == qword_1C03171E0 )
      return;
    v5 = *(_QWORD *)this == gptiRit && (unsigned int)(*((_DWORD *)this + 8) - 15) <= 0xD;
