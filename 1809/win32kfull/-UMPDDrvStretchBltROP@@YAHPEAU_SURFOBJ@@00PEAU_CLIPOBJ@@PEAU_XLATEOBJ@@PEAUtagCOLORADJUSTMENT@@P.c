/*
 * XREFs of ?UMPDDrvStretchBltROP@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54KPEAU_BRUSHOBJ@@K@Z @ 0x1C014B400
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
    ...
    v50[7] = a5;
    v22 = 0;
    if ( (unsigned int)UMPDOBJ::pso(v18, (UMPDOBJ *)((char *)v18 + 64), (EVENT_DATA_DESCRIPTOR **)&v50[3], v14) )
    {
      if ( (unsigned int)UMPDOBJ::pso(v18, (UMPDOBJ *)((char *)v18 + 80), (EVENT_DATA_DESCRIPTOR **)&v50[4], v15) )
      {
        if ( (unsigned int)UMPDOBJ::pso(v18, (UMPDOBJ *)((char *)v18 + 96), (EVENT_DATA_DESCRIPTOR **)&v50[5], v16) )
        {
          if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(
                               ...
                               0LL) )
          {
            if ( (unsigned int)UMPDOBJ::pxlo(v18, (struct _XLATEOBJ **)&v50[7]) )
            {
              if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v50[8], 0x18u) )
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v50[9], 8u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v50[10], 0x10u) )
                  {
                    if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v50[11], 0x10u) )
                    {
                      if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v18, (const void **)&v50[12], 8u) )
                      {
                        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(
                                             v18,
  ...
  if ( *((_DWORD *)v18 + 106) )
    UMPDOBJ::RestoreBitmaps(v18, v32, v19, v40, v39, v38, v37, v36, v35, v34, v31, v14, v30, v15, v29, v16);
LABEL_25:
