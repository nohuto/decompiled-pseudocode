/*
 * XREFs of ??1PANSURFLOCK@@QEAA@XZ @ 0x1C0278B4C
 * Callers:
 ...
 * Callees:
 *     ?vUnLockBmp1AndRemovePunt@MULTIPANSURFLOCK@@QEAAXXZ @ 0x1C027B528 (-vUnLockBmp1AndRemovePunt@MULTIPANSURFLOCK@@QEAAXXZ.c)
 *     ?vUnLockShadow@PANSURFLOCK@@QEAAXXZ @ 0x1C027B6A4 (-vUnLockShadow@PANSURFLOCK@@QEAAXXZ.c)
 */
