/*
 * XREFs of ?ProcessInkFeedbackCommand@HideInkCursorProvider@@UEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C0237210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HideInkCursorProvider::ProcessInkFeedbackCommand(HideInkCursorProvider *a1, int a2, int *a3, int a4)
{
  ...
  if ( a2 == 3 )
  {
    if ( a4 == 4 )
    {
      if ( dword_1C030C390 > 4u )
      {
        ...
        v81 = a3;
        v82 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D66CE, 0LL, 0LL, 7u, &v73);
      }
      if ( InkFeedbackProviderBase::FindActiveCommandByTargetPointerId((__int64)a1, 3, *a3) )
      {
        ...
        if ( v18 > 2 )
        {
          ...
          v51 = a3;
          v52 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D6691, 0LL, 0LL, 5u, &v46);
        }
      }
      else
      {
        ...
        if ( v19 >= 0 )
        {
          ...
          else
          {
            ...
            if ( dword_1C030C390 > 2u )
            {
              ...
              v100 = &v34;
              v101 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D57C3, 0LL, 0LL, 3u, &v99);
            }
          }
        }
        else if ( dword_1C030C390 > 2u )
        {
          ...
          v90 = 4LL;
          v92 = 23LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D5F95, 0LL, 0LL, 4u, &v88);
        }
      }
    }
    else
    {
      ...
      if ( dword_1C030C390 > 2u )
      {
        ...
        v97 = &v30;
        v98 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D57C3, 0LL, 0LL, 3u, &v96);
      }
    }
  }
  else if ( a2 == 4 )
  {
    if ( a4 == 4 )
    {
      if ( dword_1C030C390 > 4u )
      {
        ...
        v71 = a3;
        v72 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D66CE, 0LL, 0LL, 7u, &v63);
      }
      ...
      if ( ActiveCommandByTargetPointerId )
      {
        ...
        else if ( dword_1C030C390 > 2u )
        {
          ...
          v85 = 4LL;
          v87 = 23LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D5F95, 0LL, 0LL, 4u, &v83);
        }
      }
      else
      {
        ...
        if ( v12 > 2 )
        {
          ...
          v44 = a3;
          v45 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D6691, 0LL, 0LL, 5u, &v39);
        }
      }
    }
    else
    {
      ...
      if ( dword_1C030C390 > 2u )
      {
        ...
        v94 = &v26;
        v95 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D57C3, 0LL, 0LL, 3u, &v93);
      }
    }
  }
  else
  {
    ...
    if ( dword_1C030C390 > 2u )
    {
      ...
      v24 = v8;
      v62 = 1LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D6633, 0LL, 0LL, 7u, &pData);
    }
  }
