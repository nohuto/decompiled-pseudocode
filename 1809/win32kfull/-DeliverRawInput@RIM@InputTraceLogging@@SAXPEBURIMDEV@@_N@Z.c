/*
 * XREFs of ?DeliverRawInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@_N@Z @ 0x1C01C4604
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeliverRawInput(const struct RIMDEV *a1)
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x100uLL) )
    {
      v9 = 0;
      v12 = 0;
      v7 = &v5;
      ...
      v8 = 8;
      v11 = cData;
      TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D49A1, 0LL, 0LL, cData, &pData);
    }
  }
}
