/*
 * XREFs of ?MulAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x1C0284250
 * Callers:
 *     <none>
 * Callees:
...
LABEL_55:
              ...
              if ( psoSrc->iType == 1 && *(_QWORD *)(v22 + 48) != *(_QWORD *)(v40 + 48) )
                v33 = EngAlphaBlend;
              v18 = OffAlphaBlend(
                      (__int64 (__fastcall *)(__int64, __int64, struct _CLIPOBJ *, __int64, _DWORD *, _DWORD *, __int64))v33,
                      *(int **)v62,
                      *(__int64 *)v60,
                      (int *)&gptlZero,
                      (__int64)psoSrc,
