/*
 * XREFs of InitializeDefaultFamilyFonts @ 0x1C036D780
 * Callers:
 *     vInitMapper @ 0x1C036D200 (vInitMapper.c)
 * Callees:
...
int InitializeDefaultFamilyFonts()
{
  ...
  if ( result >= 0 )
  {
    for ( i = 0LL; i < 6; ++i )
    {
      if ( bQueryValueKey(*(PCWSTR *)&algn_1C02C5948[i * 8], Handle, KeyValueInformation, 0x54u) && v8 == 1 )
      {
        v2 = 33LL;
