/*
 * XREFs of ?xxxPromotePointer@PointerPromotion@@YAHGKK@Z @ 0x1C01F2390
 * Callers:
 ...
 *     EditionPromotePointer @ 0x1C01F2770 (EditionPromotePointer.c)
 * Callees:
 ...
 *     ?ValidatePointerPromotion@@YAHGKPEAKPEAPEAUtagMOUSE_PROMOTION_ENTRY@@1@Z @ 0x1C01F1DDC (-ValidatePointerPromotion@@YAHGKPEAKPEAPEAUtagMOUSE_PROMOTION_ENTRY@@1@Z.c)
...
__int64 __fastcall PointerPromotion::xxxPromotePointer(PointerPromotion *this, unsigned int a2, unsigned int a3)
{
  ...
  v12 = a3;
  v4 = (__int16)this;
  InputTraceLogging::Pointer::PromoteToMouse(a2, (__int16)this);
...
LABEL_12:
  ...
  if ( word_1C03172D0 != v4 || (v6 = v13, dword_1C03172D4 != *((_DWORD *)v13 + 8)) )
  {
  ...
  if ( (v12 & 0x80000) == 0 )
  {
    v9 = (dword_1C03172E4 != 0 ? 50331648 : 0x1000000) | ((dword_1C03172E0 != 0) + 1) | v12 & 0xFFFF00;
    goto LABEL_12;
  }
  if ( dword_1C03172E0 )
    v7 = v12 >> 1;
