/*
 * XREFs of ?CoalesceMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C00D0E30
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CoalesceMessage(const struct tagQMSG *a1)
{
  ...
  if ( IsPointerInputMessage(*((_DWORD *)a1 + 6)) )
  {
    if ( dword_1C030D340 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x10uLL) )
    {
      ...
      v11 = v3;
      v28 = v2;
      TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D5071, 0LL, 0LL, 7u, &pData);
    }
  }
  else if ( InputTraceLogging::IsMouseInputMessage(v1) && dword_1C030D340 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x10uLL) )
    {
      ...
      v11 = v7;
      v19 = cData;
      TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D50DC, 0LL, 0LL, cData, &pData);
    }
  }
}
