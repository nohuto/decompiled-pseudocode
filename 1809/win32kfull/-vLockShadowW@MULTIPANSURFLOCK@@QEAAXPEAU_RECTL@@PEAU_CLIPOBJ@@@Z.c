/*
 * XREFs of ?vLockShadowW@MULTIPANSURFLOCK@@QEAAXPEAU_RECTL@@PEAU_CLIPOBJ@@@Z @ 0x1C027B10C
 * Callers:
 ...
 *     ?vUnLockShadowWAndWait@MULTIPANSURFLOCK@@QEAAXXZ @ 0x1C027B850 (-vUnLockShadowWAndWait@MULTIPANSURFLOCK@@QEAAXXZ.c)
 */
