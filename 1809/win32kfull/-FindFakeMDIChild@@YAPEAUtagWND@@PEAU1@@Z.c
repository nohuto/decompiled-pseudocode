/*
 * XREFs of ?FindFakeMDIChild@@YAPEAUtagWND@@PEAU1@@Z @ 0x1C02246B4
 * Callers:
 *     ?FindFakeMDIChild@@YAPEAUtagWND@@PEAU1@@Z @ 0x1C02246B4 (-FindFakeMDIChild@@YAPEAUtagWND@@PEAU1@@Z.c)
...
struct tagWND *__fastcall FindFakeMDIChild(struct tagWND *a1)
{
  ...
  if ( (v1 & 0x10) != 0 )
  {
    if ( (v1 & 0x40) != 0 && ((v1 & 1) != 0 || *((_QWORD *)a1 + 17)) )
      return a1;
