/*
 * XREFs of ?CopyTouchInputListSorted@@YAHPEBUtagTOUCHINPUTLIST@@PEAU1@HPEAIPEAH@Z @ 0x1C01CA5B8
 * Callers:
...
LABEL_31:
          UserSetLastError(v19, v9, a3, (__int64)a4);
          return 0LL;
        }
        v17 = -1;
      }
...
LABEL_17:
      ...
      for ( i = v20; ; --i )
      {
        if ( !i )
          goto LABEL_29;
        v22 = i - 1;
        a4 = (unsigned int *)*((_QWORD *)a2 + 1);
        a3 = 6 * v22;
        v23 = *(_QWORD *)&a4[12 * v22 + 2];
        if ( v29.m128i_i64[1] >= v23 && (v29.m128i_i64[1] != v23 || v11.m128i_i32[0] >= a4[12 * v22 + 4]) )
          break;
        v24 = 6LL * i;
        *(_OWORD *)&a4[2 * v24] = *(_OWORD *)&a4[12 * v22];
        *(_OWORD *)&a4[2 * v24 + 4] = *(_OWORD *)&a4[12 * v22 + 4];
        *(_OWORD *)&a4[2 * v24 + 8] = *(_OWORD *)&a4[12 * v22 + 8];
      }
