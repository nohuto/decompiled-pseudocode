/*
 * XREFs of UmfdLoadFontFileView @ 0x1C0091154
 * Callers:
 ...
 *     ?bIsPathInSystemFontsDir@@YAHPEBG@Z @ 0x1C0092964 (-bIsPathInSystemFontsDir@@YAHPEBG@Z.c)
  ...
  *v15 = 0LL;
  if ( (_BYTE)result )
  {
    ...
    if ( !v41 )
    {
      ...
      v21 = v47;
      v22 = 1;
      for ( i = qword_1C031DE98; v20 < v47; v21 = v47 )
      {
        v23 = v20++;
        *((_DWORD *)v46[v23] + 16) = 0;
      }
      ...
      if ( v18 )
      {
        ...
        LOBYTE(v24) = v25;
        v28 = lambda_cf148b6edee2a97f1c16d0ea33321dda_::operator()(v45, v24, v26);
        v29 = 0LL;
        v30 = v28;
        if ( v28 )
        {
        ...
        else
        {
          ...
          if ( v27 == 2 )
            goto LABEL_21;
          LOBYTE(v29) = v22;
          v35 = lambda_cf148b6edee2a97f1c16d0ea33321dda_::operator()(v45, v29, 0LL);
          v15 = a10;
          v30 = v35;
        }
      }
      ...
      {
        LOBYTE(v24) = a1 != 0LL;
        v33 = lambda_cf148b6edee2a97f1c16d0ea33321dda_::operator()(v45, v24, *v17);
        v30 = v33;
        if ( !v33 )
          goto LABEL_21;
        v36 = *(_DWORD *)(v33 + 8);
        ...
        PutFntCacheDrvAndFileInfo(*v17, qword_1C031DE98, v39, v46, v47);
      }
      if ( v30 )
      {
        *v15 = qword_1C031DE98;
