/*
 * XREFs of _WOWModuleUnload @ 0x1C01FD140
 * Callers:
 *     <none>
 * Callees:
  ...
  do
  {
    while ( *v4 )
    {
      ...
      if ( HIWORD(*((_DWORD *)(*v4)[1] + 16)) == v1 )
      {
        ...
        PseudoDestroyClassWindows(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 456LL) + 8LL) + 24LL), v12);
...
LABEL_27:
    ...
    v4 = (struct _CALLPROCDATA ***)((char *)CurrentProcessWin32Process + 360);
    --v3;
  }
  while ( v3 );
  return 1LL;
