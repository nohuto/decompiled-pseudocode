/*
 * XREFs of ??0LeaveEnterCritProperDisposition@@QEAA@XZ @ 0x1C00199CC
 * Callers:
 ...
 *     xxxClientCharToWchar @ 0x1C0206A84 (xxxClientCharToWchar.c)
        ...
        LeaveEnterCritProperDisposition *this)
{
  ...
  if ( !ExIsResourceAcquiredExclusiveLite(gpresUser) )
    v6 = ExIsResourceAcquiredSharedLite(gpresUser) != 0;
  *(_BYTE *)this = v6;
