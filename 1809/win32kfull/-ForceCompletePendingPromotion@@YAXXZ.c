/*
 * XREFs of ?ForceCompletePendingPromotion@@YAXXZ @ 0x1C01F155C
 * Callers:
 ...
 *     ?ResetPendingPromotion@@YAXXZ @ 0x1C01F1D28 (-ResetPendingPromotion@@YAXXZ.c)
...
void ForceCompletePendingPromotion(void)
{
  ...
  v0 = word_1C03172D0;
  v2 = ((dword_1C03172E0 != 0) + 16842753) | (dword_1C03172E4 != 0 ? 0x2000000 : 0);
  if ( !ValidatePointerPromotion(word_1C03172D0, dword_1C03172D4, &v2, &v4, &v3) )
    goto LABEL_5;
  v1 = v3;
  if ( v3 )
  {
