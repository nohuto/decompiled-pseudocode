/*
 * XREFs of ?xxxDiscardPointerWindowFrameMessages@@YAHPEAUtagTHREADINFO@@_K@Z @ 0x1C01DC95C
 * Callers:
...
__int64 __fastcall xxxDiscardPointerWindowFrameMessages(struct tagTHREADINFO *a1, unsigned __int64 a2)
{
  ...
  {
    v5 = 0LL;
    v6 = (*((_DWORD *)a1 + 170) | *(_DWORD *)(**((_QWORD **)a1 + 58) + 16LL)) & 0x10;
    v7 = v6 != 0;
    if ( v6 )
    {
      v8 = 48LL * v23;
