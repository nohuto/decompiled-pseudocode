/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C01B95F0
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1C01B9710 (EditionFindNodeQueuedMessage.c)
 * Callees:
