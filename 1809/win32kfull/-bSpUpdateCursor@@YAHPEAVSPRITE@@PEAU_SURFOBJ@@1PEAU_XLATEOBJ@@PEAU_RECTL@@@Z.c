/*
 * XREFs of ?bSpUpdateCursor@@YAHPEAVSPRITE@@PEAU_SURFOBJ@@1PEAU_XLATEOBJ@@PEAU_RECTL@@@Z @ 0x1C0265308
 * Callers:
...
LABEL_8:
    ...
    *((_QWORD *)a1 + 15) = v12;
    ...
    if ( v19 )
    {
      bSpCreateShape(a1, &gptlZero, v19, v20, a5, *(struct PALETTE **)(v11 + 1808), 0, 0, 0LL);
    ...
    *((_DWORD *)a1 + 39) = *((_DWORD *)v9 + 28);
    *((_DWORD *)a1 + 38) = *((_DWORD *)v9 + 27);
  }
  else
  {
    *((_DWORD *)a1 + 1) = 2;
