/*
 * XREFs of InitializeClientPfnArrays @ 0x1C012FDBC
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C012FCB0 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( PsGetCurrentProcess(a1, a2, a3, a4) == gpepCSRSS )
  {
    ...
    *(_QWORD *)(gpsi + 856LL) = *(_QWORD *)(a3 + 80);
    ...
    qword_1C03165A8 = *(_QWORD *)(gpsi + 616LL);
    qword_1C03165B0 = *(_QWORD *)(gpsi + 696LL);
    qword_1C03165B8 = *(_QWORD *)(gpsi + 680LL);
    qword_1C03165C8 = *(_QWORD *)(gpsi + 648LL);
    qword_1C0316630 = *(_QWORD *)(gpsi + 664LL);
    qword_1C0316648 = *(_QWORD *)(gpsi + 592LL);
    qword_1C03165D0 = *(_QWORD *)(gpsi + 688LL);
    qword_1C03165D8 = *(_QWORD *)(gpsi + 656LL);
    qword_1C0316628 = 1LL;
    qword_1C0316638 = 3LL;
    qword_1C0316640 = 2LL;
    qword_1C0316650 = 5LL;
