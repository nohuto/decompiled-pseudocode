/*
 * XREFs of ?IsClassAtomRegistered@@YA_NPEAUtagPROCESSINFO@@G@Z @ 0x1C00232D4
 * Callers:
...
char __fastcall IsClassAtomRegistered(struct tagPROCESSINFO *a1, __int16 a2)
{
  ...
  SmartObjStackRefBase<tagCLS>::Init(v10, *((_QWORD *)a1 + 44));
  v5 = 1;
  while ( 1 )
  {
    v6 = (_QWORD *)v10[0];
  ...
  for ( i = *((_QWORD *)a1 + 45); ; i = **(_QWORD **)v10[0] )
  {
    if ( i != *v6 )
    {
      if ( v10[0] != gSmartObjNullRef && !--*(_DWORD *)(v10[0] + 8LL) )
