/*
 * XREFs of HT_HalftoneBitmap @ 0x1C001358C
 * Callers:
 *     EngHTBlt @ 0x1C0012AA4 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C0013838 (SanityCheckDimension.c)
 *     AAHalftoneBitmap @ 0x1C0013864 (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x1C00141A0 (pDCIAdjClr.c)
 *     CheckABInfo @ 0x1C0244920 (CheckABInfo.c)
 */
