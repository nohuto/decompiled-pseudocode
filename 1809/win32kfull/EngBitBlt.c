/*
 * XREFs of EngBitBlt @ 0x1C00890E0
 * Callers:
        ...
        ROP4 rop4)
{
    ...
    if ( ThreadWin32Thread )
    {
      ...
      if ( v18 )
      {
        ...
        if ( v19 != v18 + 40 )
        {
          ...
          if ( v20 )
          {
            if ( (*((_DWORD *)v20 + 103) & 0x100) != 0 && UMPDOBJ::bInEngCall(v20) )
            {
              ...
              if ( (v21 & 0xE8) != 0 && (!pbo || pbo->iSolidColor == -1 && !pptlBrush) )
              {
                ...
                {
                  DbgPrint(
                    "windows\\core\\ntgdi\\gre\\windows\\bbddi.cxx:%d:EngBitBlt:ROP4NEEDPAT && (!pbo || (pbo->iSolidColor"
                    " == -1 && !pptlBrush))\n",
                    67);
                  return 0;
                }
  ...
  if ( rop4 > 0x5A5A )
  {
    ...
    if ( rop4 == 52428 )
    {
      ...
      v27 = *(__int64 (__fastcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(v47 + 48) + 2840LL);
      if ( v27 )
...
LABEL_69:
  ...
  if ( v33 < 3 )
  {
    ...
    else if ( v33 == 1 && rop4 == 61680 && pvGetEngRbrush(pbo) )
    {
...
LABEL_89:
  ...
  if ( ((gajRop3[(unsigned __int8)rop4] | gajRop3[BYTE1(rop4)]) & 0xD4) != 0 )
  {
    if ( *(_WORD *)(v47 + 100) )
    {
      ...
      v64 = 0LL;
      v55 = 0LL;
      if ( !SURFMEM::bCreateDIB((SURFMEM *)&v49, (struct _DEVBITMAPINFO *)&v53, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0, 0)
        || (v41 = *(void (__fastcall **)(char *, SURFOBJ *, _QWORD, XLATEOBJ *, __int64 *, POINTL *))(v39 + 2840)) == 0LL )
      {
LABEL_105:
