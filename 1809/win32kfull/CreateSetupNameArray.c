/*
 * XREFs of CreateSetupNameArray @ 0x1C0136C40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 CreateSetupNameArray()
{
  ...
  result = FastGetProfileValue(0LL, 34LL, L"SetupProgramNames", 0LL, 0LL, 0);
  v1 = result;
  if ( (_DWORD)result )
  {
    ...
    if ( result )
    {
      ProfileValue = FastGetProfileValue(0LL, 34LL, L"SetupProgramNames", 0LL, result, v1);
