/*
 * XREFs of ?TraceLoggingIntObjUsageSummaryEvent@@YAXPEAUtagINTOBJTELEMETRYSTATE@@GGU_GUID@@1_K@Z @ 0x1C01B9B68
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v15 = dword_1C031DDE4;
      v54 = &v15;
      v10 = (unsigned int)qword_1C031DDF8 / 0x3E8;
      v17 = dword_1C031DDEC;
      v18 = (unsigned int)qword_1C031DE28 / 0x3E8;
      v28 = v6;
      v29 = 16LL;
      v33 = 16LL;
      v37 = 4LL;
      ...
      v77 = 4LL;
      v79 = 8LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02D3560, 0LL, 0LL, 0x1Cu, &pData);
    }
  }
}
