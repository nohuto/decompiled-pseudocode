/*
 * XREFs of ?EnsureOemBitmapInfoForDpiSlot@@YAXPEAUOEMBITMAPSET@@I@Z @ 0x1C0106860
 * Callers:
 ...
 * Callees:
 *     ?ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z @ 0x1C01069DC (-ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z.c)
