/*
 * XREFs of GrayExpandDIB_CX @ 0x1C024CA60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GrayExpandDIB_CX(__int128 *a1, char *a2, _BYTE *a3, __int64 a4, int a5)
{
  ...
  if ( a2 )
  {
    ...
    while ( v13 )
    {
      ...
      {
        v16 = (6 * BYTE5(v28) - v15 - BYTE4(v28)) >> 2;
        if ( (v16 & 0xFF00) != 0 )
    ...
    do
    {
      ...
      if ( (v21 & 0x8000u) != 0LL )
      {
        ...
        {
          v23 = (6 * BYTE5(v28) - v22 - BYTE4(v28)) >> 2;
          if ( (v23 & 0xFF00) != 0 )
            LOBYTE(v23) = ~HIBYTE(v23);
          BYTE3(v28) = v23;
        }
        LOWORD(v21) = v21 & 0x3FFF;
      }
      v24 = BYTE3(v28) * HIWORD(v25);
      if ( WORD2(v25) )
      {
        v24 += WORD2(v25) * BYTE2(v28);
        if ( WORD1(v25) )
        {
          v24 += WORD1(v25) * BYTE1(v28);
          if ( (_WORD)v21 )
            v24 += (unsigned __int16)v21 * (unsigned __int8)v28;
        }
      }
      result = (unsigned int)(v24 + 4096) >> 13;
      *a3 = result;
      a3 += a5;
    }
    while ( a3 != v20 );
