/*
 * XREFs of ?bEnumStartLine@XCLIPOBJ@@QEAAHK@Z @ 0x1C013ABD4
 * Callers:
 *     ?bGetLine@XCLIPOBJ@@IEAAHPEAVEPATHOBJ@@PEBK@Z @ 0x1C013AA48 (-bGetLine@XCLIPOBJ@@IEAAHPEAVEPATHOBJ@@PEBK@Z.c)
 * Callees:
 ...
 *     ?vUpdateStyleState@XCLIPOBJ@@QEAAXXZ @ 0x1C02B1C7C (-vUpdateStyleState@XCLIPOBJ@@QEAAXXZ.c)
 */
