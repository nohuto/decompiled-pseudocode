/*
 * XREFs of ?AllocateFromPagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAXPEAX@Z @ 0x1C02BFCB4
 * Callers:
 *     Win32UAFMAllocateFromPagedLookasideListImpl @ 0x1C01F8910 (Win32UAFMAllocateFromPagedLookasideListImpl.c)
 * Callees:
