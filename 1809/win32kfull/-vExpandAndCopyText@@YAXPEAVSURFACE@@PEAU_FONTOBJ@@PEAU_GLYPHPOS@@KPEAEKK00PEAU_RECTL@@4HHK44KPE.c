/*
 * XREFs of ?vExpandAndCopyText@@YAXPEAVSURFACE@@PEAU_FONTOBJ@@PEAU_GLYPHPOS@@KPEAEKK00PEAU_RECTL@@4HHK44KPEAU_BRUSHOBJ@@PEAU_POINTL@@@Z @ 0x1C0088B10
 * Callers:
        ...
        struct _POINTL *a19)
{
  ...
  LONG bottom; // r10d
  int v53; // r10d
  int v54; // [rsp+74h] [rbp-424h]
  LONG v55; // [rsp+A0h] [rbp-3F8h]
  int v56; // [rsp+B4h] [rbp-3E4h]
  __int64 v57; // [rsp+B8h] [rbp-3E0h] BYREF
  struct _RECTL *v58; // [rsp+C0h] [rbp-3D8h]
  struct _POINTL v59; // [rsp+C8h] [rbp-3D0h] BYREF
  struct _RECTL v60; // [rsp+D0h] [rbp-3C8h] BYREF
  int v61; // [rsp+E0h] [rbp-3B8h]
  void * near *v62; // [rsp+E8h] [rbp-3B0h]
  struct _RECTL *v63; // [rsp+F0h] [rbp-3A8h]
  struct SURFACE *v64; // [rsp+F8h] [rbp-3A0h]
  __int64 v65; // [rsp+100h] [rbp-398h] BYREF
  struct _POINTL *v66; // [rsp+108h] [rbp-390h]
  struct _BRUSHOBJ *v67; // [rsp+110h] [rbp-388h]
  struct SURFACE *v68; // [rsp+118h] [rbp-380h]
  _QWORD v69[2]; // [rsp+120h] [rbp-378h]
  __int64 v70; // [rsp+130h] [rbp-368h]
  _BYTE v71[96]; // [rsp+140h] [rbp-358h] BYREF
  char v72[56]; // [rsp+1A0h] [rbp-2F8h] BYREF
  unsigned int v73; // [rsp+1D8h] [rbp-2C0h]
  int v74; // [rsp+1DCh] [rbp-2BCh]
  unsigned __int8 *v75; // [rsp+1F0h] [rbp-2A8h]
  unsigned int v76; // [rsp+1F8h] [rbp-2A0h]
  int v77; // [rsp+200h] [rbp-298h]
  __int16 v78; // [rsp+204h] [rbp-294h]
  ...
  if ( (a14 & 1) != 0 || a4 <= 1 || (unsigned int)(a3->ptl.x - a3[a4 - 1].ptl.x + 0x8000000) <= 0x10000000 )
  {
    ...
    for ( i = &v63->left; ; i += 4 )
    {
      ...
      else
      {
        ...
        v43 = 0LL;
        if ( v64 )
          v43 = (struct _SURFOBJ *)((char *)v64 + 24);
        PDEVOBJ::vSync((PDEVOBJ *)&v65, v43, 0LL, 0);
        v31 = a13;
        v42 = v55;
        v41 = v54;
        v29 = a10;
      ...
      if ( v36 < v37 && v39 < v40 )
      {
        if ( a12 == -1 )
        {
          ...
          v76 = a6;
          v73 = 8 * a6;
          v74 = v29->bottom - v29->top;
          v59.x = v41 + v56;
          v59.y = v42;
          BltLnk(a8, 0LL, (struct SURFACE *)v72, 0LL, 0LL, &v60, 0LL, &v59, v67, v66, 0xAAF0u);
        }
        else
        {
          v70 = *((_QWORD *)a8 + 10);
