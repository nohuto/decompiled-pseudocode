/*
 * XREFs of ?pxrlStrRead04@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C0115750
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        v48 = (v43 & (unsigned int)dword_1C02D1FE0[v46]) >> dword_1C02D1FC0[v59];
        if ( a5 )
          LODWORD(v48) = a5->pulXlate[v48];
        if ( (dword_1C02D2C40[v47] & v65) != 0 )
        {
          v49 = *v44;
          if ( *v44 )
          {
  ...
  else
  {
    ...
    *((_DWORD *)a2 + 3) = *((_DWORD *)a1 + 2) - v11;
    if ( a5 )
    {
      if ( a6 < a7 )
      {
        ...
        while ( 1 )
        {
          ...
          {
            v20 = v19;
            v21 = a5->pulXlate[(unsigned __int64)(v15 & (unsigned int)dword_1C02D1FE0[v18]) >> LOBYTE(dword_1C02D1FC0[v18])];
            v22 = &v9[v17 + 2];
    ...
    else if ( a6 < a7 )
    {
      ...
      while ( 1 )
      {
        v33 = (v29 & (unsigned int)dword_1C02D1FE0[v32]) >> dword_1C02D1FC0[v32];
        v34 = *v30++;
        if ( (_DWORD)v34 )
        {
          v14 += v34;
