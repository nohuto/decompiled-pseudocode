/*
 * XREFs of ?xxxGetSizeRectFromShell@@YAHPEAU_MOVESIZEDATA@@PEAUtagMONITOR@@W4eTHRESHOLD_MARGIN_DIRECTION@@PEAUtagRECT@@@Z @ 0x1C01E8650
 * Callers:
 ...
 *     ?IsProperRectForArrangement@@YAHQEBUtagRECT@@0W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01E5280 (-IsProperRectForArrangement@@YAHQEBUtagRECT@@0W4eTHRESHOLD_MARGIN_DIRECTION@@@Z.c)
        ...
        if ( (v11 & 8) != 0 )
        {
          ...
          *(_OWORD *)a4 = v12;
                    ...
                    *(HWND *)(a1 + 308),
                    ...
                    &v19,
                    v16)
               && PtInRect(&v19, *(_QWORD *)(a1 + 308)) )
        {
          v13 = *(_QWORD *)(a2 + 40);
          if ( (unsigned int)IntersectRect(v18, &v17.left, (int *)(v13 + 44)) )
          {
            v14 = v18[0] - *(_QWORD *)&v17.left;
            if ( v18[0] == *(_QWORD *)&v17.left )
              v14 = v18[1] - *(_QWORD *)&v17.right;
            if ( !v14 && (unsigned int)IsProperRectForArrangement((const struct tagRECT *)(v13 + 44), &v17, a3) )
            {
              TransformShellProvidedRectangles(a1, a2, a3, &v17, (__int64)&v19, *(_QWORD *)(v8 + 328), a4, a1 + 264);
              *(_DWORD *)(a1 + 280) |= 2u;
            }
          }
        }
