/*
 * XREFs of GreSfmRegisterLogicalSurfaceForSignaling @ 0x1C00A4B34
 * Callers:
 ...
 *     ?SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z @ 0x1C00A4C20 (-SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z.c)
