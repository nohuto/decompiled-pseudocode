/*
 * XREFs of ?RedirStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C0280B50
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG iMode)
{
          ...
          if ( v16 )
          {
            do
            {
              ...
              if ( v17 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v17 + 1792) + 224LL) )
                  {
  ...
  v23 = EngStretchBlt(a1, a2, a3, v13, pxlo, pca, pptlHTOrg, prclDest, prclSrc, pptlMask, iMode);
  if ( v26 )
    bMakeOpaque(v26);
  if ( v27 )
    bMakeOpaque(v27);
