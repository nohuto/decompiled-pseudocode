/*
 * XREFs of ?DeliverRawInput@Mouse@InputTraceLogging@@SAX_K_N@Z @ 0x1C0007F34
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::DeliverRawInput()
{
  ...
  if ( dword_1C030D340 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x40uLL) )
    {
      ...
      v7 = 8;
      v10 = cData;
      TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D4A58, 0LL, 0LL, cData, &pData);
    }
  }
}
