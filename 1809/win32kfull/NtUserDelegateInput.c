/*
 * XREFs of NtUserDelegateInput @ 0x1C0120920
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v9 )
  {
    ...
    if ( *(char *)(v17 + 19) >= 0 && *(char *)(v17 + 20) >= 0 )
    {
      ...
      if ( v19 == PsGetCurrentProcessWin32Process(v11) )
      {
        ...
        else if ( v19 == *(_QWORD *)(v16 + 424) && v18 != v16 )
        {
          v11 = 1LL;
          if ( *(_DWORD *)(*(_QWORD *)(v16 + 432) + 392LL) == 1
            && *(_QWORD *)(v18 + 456) == *(_QWORD *)(v16 + 456)
            && !*(_QWORD *)(v18 + 1232) )
          {
            *(_QWORD *)(v15 + 248) = v16;
            v14 = 1LL;
            *(_DWORD *)(v15 + 244) = a5;
            *(_DWORD *)(v16 + 1208) |= 0x2000u;
