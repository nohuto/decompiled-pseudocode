/*
 * XREFs of EditionPostInputMessage @ 0x1C00D26D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a12)
{
  ...
  if ( *(char *)(*(_QWORD *)(v12 + 40) + 19LL) >= 0 )
  {
    ...
    v13 = *((_QWORD *)v14 + 1);
    return PostInputMessage(*(_QWORD *)(*(_QWORD *)(v12 + 16) + 432LL), a2, a3, a4, a5, a6, a7, a8, a9, a10, v13, a12);
  }
  return 0LL;
}
