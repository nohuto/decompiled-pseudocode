/*
 * XREFs of ?TransformWindowTrackInfo@ShellWindowManagement@@YAXPEAUtagWND@@PEAUtagSIZE@@1W4TransformWindowTrackInfoDirection@1@@Z @ 0x1C0124364
 * Callers:
...
int __fastcall ShellWindowManagement::TransformWindowTrackInfo(__int64 a1, INT *a2, INT *a3, int a4)
{
  ...
  if ( (*(_DWORD *)(v4 + 232) & 0x8000000) != 0 )
  {
    ...
    v8 = v7;
         ...
         && (v7 = *(_QWORD *)(*(_QWORD *)(a1 + 16) + 456LL)) != 0
