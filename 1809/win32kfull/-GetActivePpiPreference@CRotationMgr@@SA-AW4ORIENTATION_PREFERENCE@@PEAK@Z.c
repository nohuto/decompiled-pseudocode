/*
 * XREFs of ?GetActivePpiPreference@CRotationMgr@@SA?AW4ORIENTATION_PREFERENCE@@PEAK@Z @ 0x1C01C0D58
 * Callers:
...
__int64 __fastcall CRotationMgr::GetActivePpiPreference(_DWORD *a1)
{
  ...
  CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v5, gRotationProcessLock);
  v2 = 0;
  if ( grpdeskRitInput )
  {
