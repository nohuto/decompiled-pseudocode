/*
 * XREFs of ?vVecPerpCompute@WIDENER@@AEAAXAEAVLINEDATA@@@Z @ 0x1C01452C4
 * Callers:
 ...
 * Callees:
 *     ?vVecDrawCompute@WIDENER@@AEAAXAEAVLINEDATA@@@Z @ 0x1C0145420 (-vVecDrawCompute@WIDENER@@AEAAXAEAVLINEDATA@@@Z.c)
 */
...
LABEL_12:
  ...
  *(_DWORD *)a2 = v24 | 4;
  *((_DWORD *)a2 + 16) = (v25 + ((v22 >> 31) & 1) + 3) & 0xFFFFFFF8;
