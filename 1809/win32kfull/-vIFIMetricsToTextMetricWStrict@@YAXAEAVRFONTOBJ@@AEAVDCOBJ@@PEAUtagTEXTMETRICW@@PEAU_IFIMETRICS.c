/*
 * XREFs of ?vIFIMetricsToTextMetricWStrict@@YAXAEAVRFONTOBJ@@AEAVDCOBJ@@PEAUtagTEXTMETRICW@@PEAU_IFIMETRICS@@@Z @ 0x1C0084A00
 * Callers:
        ...
        struct _IFIMETRICS *a4)
{
  ...
  LOBYTE(v22) = *(_DWORD *)(*(_QWORD *)a2 + 1760LL) & 0x80;
