/*
 * XREFs of SfnINLPCOMPAREITEMSTRUCT @ 0x1C01FFD70
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  __int64 *v23; // rcx
  __int64 result; // rax
  __int64 v25; // [rsp+48h] [rbp-100h] BYREF
  volatile signed __int32 *v26; // [rsp+50h] [rbp-F8h]
  __int64 v27; // [rsp+58h] [rbp-F0h]
  __int128 v28; // [rsp+60h] [rbp-E8h]
  __int64 v29; // [rsp+70h] [rbp-D8h]
  __int64 v30; // [rsp+78h] [rbp-D0h]
  __int128 v31; // [rsp+98h] [rbp-B0h]
  _QWORD v32[19]; // [rsp+B0h] [rbp-98h] BYREF
  char v33; // [rsp+150h] [rbp+8h] BYREF
  char v34; // [rsp+158h] [rbp+10h] BYREF
  int v35; // [rsp+160h] [rbp+18h] BYREF
  unsigned __int64 v36; // [rsp+168h] [rbp+20h] BYREF
