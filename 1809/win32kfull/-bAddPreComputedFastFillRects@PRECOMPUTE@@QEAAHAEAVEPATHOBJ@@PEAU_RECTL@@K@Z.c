/*
 * XREFs of ?bAddPreComputedFastFillRects@PRECOMPUTE@@QEAAHAEAVEPATHOBJ@@PEAU_RECTL@@K@Z @ 0x1C02B1D9C
 * Callers:
...
LABEL_15:
  ...
  v12 = (const void *)*((_QWORD *)a2 + 6);
  if ( v12 )
    memmove(v10, v12, 16LL * *((unsigned int *)a2 + 14));
  memmove(&v11[16 * *((unsigned int *)a2 + 14)], a3, 16 * v6);
  v13 = *((_QWORD *)a2 + 6);
  if ( v13 )
    Win32FreePool(v13);
  *((_DWORD *)a2 + 14) += v6;
