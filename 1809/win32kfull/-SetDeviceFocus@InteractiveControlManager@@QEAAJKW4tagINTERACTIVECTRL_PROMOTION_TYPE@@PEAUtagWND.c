/*
 * XREFs of ?SetDeviceFocus@InteractiveControlManager@@QEAAJKW4tagINTERACTIVECTRL_PROMOTION_TYPE@@PEAUtagWND@@@Z @ 0x1C0236678
 * Callers:
...
__int64 __fastcall InteractiveControlManager::SetDeviceFocus(__int64 a1, int a2, unsigned int a3, __int64 a4)
{
  ...
  if ( dword_1C030C400 > 4u )
  {
    ...
    v15[0] = a4;
    v27 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C400, &unk_1C02D6338, 0LL, 0LL, 6u, &pData);
  }
  v8 = (__int64 *)(a1 + 40);
  v9 = 5LL;
  do
  {
    ...
    if ( *v8 && (!a2 || a2 == *(_DWORD *)(v10 + 8)) )
      InteractiveControlDevice::SetFocus(v10, a4, a3);
    ++v8;
    --v9;
  }
  while ( v9 );
