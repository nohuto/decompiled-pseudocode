/*
 * XREFs of ?MulCreateDeviceBitmapEx@@YAPEAUHBITMAP__@@PEAUDHPDEV__@@UtagSIZE@@KKPEAUDHSURF__@@KKPEAPEAX@Z @ 0x1C0285600
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v19 )
    {
      while ( 1 )
      {
        ...
        if ( (*(_DWORD *)(v20 + 1824) & 0x8000000) != 0
          ...
          && *(_QWORD *)(v20 + 2768) )
        {
          v21 = (HSURF)(*(__int64 (__fastcall **)(_QWORD, SIZEL, _QWORD))(v20 + 2768))(*(_QWORD *)(v20 + 1800), a2, v12);
          v22 = v21;
          if ( !v21 )
            goto LABEL_64;
        ...
        else
        {
          if ( (*(_DWORD *)(v20 + 1824) & 0x8000000) != 0 )
            goto LABEL_64;
          v24 = *(__int64 (__fastcall **)(_QWORD, SIZEL, _QWORD, _QWORD, struct DHSURF__ *, unsigned int, unsigned int, void **))(v20 + 3440);
          if ( !v24 )
            goto LABEL_64;
