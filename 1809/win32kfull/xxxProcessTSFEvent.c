/*
 * XREFs of xxxProcessTSFEvent @ 0x1C0004750
 * Callers:
 ...
 * Callees:
 *     ?TSFRangeFromEvent@@YAKKW4TSFLocality@@@Z @ 0x1C0004818 (-TSFRangeFromEvent@@YAKKW4TSFLocality@@@Z.c)
...
void *__fastcall xxxProcessTSFEvent(struct tagNOTIFY *a1)
{
  ...
  *(_QWORD *)a1 = a1;
  ...
  result = &unk_1C0319760;
  if ( a1 != (struct tagNOTIFY *)&unk_1C0319760 )
    return (void *)Win32FreePool(a1);
  dword_1C03171D8 = 0;
  return result;
}
