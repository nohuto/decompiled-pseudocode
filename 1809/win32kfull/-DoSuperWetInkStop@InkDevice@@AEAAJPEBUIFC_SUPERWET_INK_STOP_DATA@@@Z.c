/*
 * XREFs of ?DoSuperWetInkStop@InkDevice@@AEAAJPEBUIFC_SUPERWET_INK_STOP_DATA@@@Z @ 0x1C02383D4
 * Callers:
...
__int64 __fastcall InkDevice::DoSuperWetInkStop(InkDevice *this, const struct IFC_SUPERWET_INK_STOP_DATA *a2)
{
  ...
  if ( v4 >= 0 )
  {
    if ( dword_1C030C390 > 4u )
    {
      ...
      v19 = a2;
      v20 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D66CE, 0LL, v7, 7u, &v11);
    }
  }
