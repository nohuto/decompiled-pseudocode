/*
 * XREFs of ?GetReportExtendedUsage@InteractiveControlManager@@QEAAJKKGGGPEAJ@Z @ 0x1C0235688
 * Callers:
 ...
 *     ?ExtractCustomUsage@InteractiveControlParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAEKGGGPEAJ@Z @ 0x1C0240180 (-ExtractCustomUsage@InteractiveControlParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEAEKGGGPEAJ@Z.c)
 */
        ...
        int *a7)
{
  ...
  __int64 result; // rax
  const GUID *v12; // r8
  unsigned int v13; // [rsp+40h] [rbp-A1h] BYREF
  int v14; // [rsp+44h] [rbp-9Dh] BYREF
  ...
  if ( dword_1C030C400 > 4u )
  {
    ...
    v29 = 2LL;
    v31 = 2LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C400, &unk_1C02D63CF, 0LL, 0LL, 8u, &pData);
  }
  ...
  else
  {
    ...
    v21 = 17LL;
    v23 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C400, &unk_1C02D6152, v12, 0LL, 4u, &pData);
  }
  result = v13;
LABEL_12:
  if ( dword_1C030C400 > 4u )
  {
    ...
    v23 = 4LL;
    v25 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C400, &unk_1C02D638F, 0LL, 0LL, 5u, &pData);
    return v13;
  }
  return result;
}
