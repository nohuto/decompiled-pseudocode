/*
 * XREFs of ??$RemoveProp@VCSwapChainProp@@@CWindowProp@@SAHPEAUtagWND@@PEAPEAVCSwapChainProp@@@Z @ 0x1C02217F8
 * Callers:
...
__int64 __fastcall CWindowProp::RemoveProp<CSwapChainProp>(__int64 a1, __int64 *a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 120);
  v4 = CSwapChainProp::s_atom;
  v5 = 0;
  if ( CSwapChainProp::s_atom == word_1C0317660 )
