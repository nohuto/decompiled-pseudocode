/*
 * XREFs of SfnINSTRINGNULL @ 0x1C0068130
 * Callers:
        ...
        char a7)
{
  ...
  _BYTE v54[32]; // [rsp+D0h] [rbp-2B8h] BYREF
  ...
  *(_QWORD *)&v45 = a3;
  ...
  if ( v13 )
  {
    v9 = AllocCallbackMessage(88, v13, v14, v56, 1, 0x200uLL);
    v42 = v9;
    if ( !v9 )
      return 0LL;
  }
  ...
  if ( v9 != (unsigned __int8 *)v55 && v9 != v56 )
    PushW32ThreadLock(v9, v54, Win32FreePool);
  *((_QWORD *)v9 + 5) = v12;
  *((_DWORD *)v9 + 12) = v43;
  *((_QWORD *)v9 + 7) = v45;
  if ( v13 )
...
LABEL_13:
  ...
  *((_QWORD *)v9 + 2) = 0LL;
  v22 = KeUserModeCallback(27LL, v9, *(unsigned int *)v9, &v46, v44);
