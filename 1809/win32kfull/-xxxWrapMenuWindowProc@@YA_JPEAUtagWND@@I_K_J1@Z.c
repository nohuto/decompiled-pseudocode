/*
 * XREFs of ?xxxWrapMenuWindowProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C01D0770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxWrapMenuWindowProc(struct tagWND *a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
