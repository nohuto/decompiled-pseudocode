/*
 * XREFs of EngAlphaBlend @ 0x1C004FC70
 * Callers:
 ...
 *     ?bDetermineAlphaBlendFunction@@YAHPEAVSURFACE@@0PEAVXEPALOBJ@@1PEAVXLATE@@JPEAU_ALPHA_DISPATCH_FORMAT@@H@Z @ 0x1C0050508 (-bDetermineAlphaBlendFunction@@YAHPEAVSURFACE@@0PEAVXEPALOBJ@@1PEAVXLATE@@JPEAU_ALPHA_DISPATCH_F.c)
...
LABEL_45:
    ...
    if ( *(_WORD *)(v9 + 100) )
    {
      ...
      *(_QWORD *)&v84.right = __PAIR64__(v25, v22);
      ...
      v51 = v48
          ? EngCopyBits
          : *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v49 + 2840);
      v52 = v68 ? v68 + 24 : 0LL;
      ...
      if ( pulXlate && v28 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !v32 )
            break;
LABEL_47:
          v32 = XCLIPOBJ::bEnum(v30, 0x144u, &v86, 0LL);
          LODWORD(v56) = v32;
        }
        if ( v58 )
        {
          ...
          if ( (*(_DWORD *)(v80 + 112) & 0x400) != 0 )
            (*(void (__fastcall **)(__int64, __int64, XCLIPOBJ *, XLATEOBJ *const, struct _RECTL *, RECTL **))(*(_QWORD *)(v80 + 48) + 2840LL))(
              v80 + 24,
              v24 + 24,
              v67,
              xloIdent,
