/*
 * XREFs of ?FindDigitizerForDevice@InteractiveControlParser@@CAJPEAVInteractiveControlDevice@@@Z @ 0x1C024025C
 * Callers:
...
__int64 __fastcall InteractiveControlParser::FindDigitizerForDevice(struct InteractiveControlDevice *a1)
{
  ...
  if ( !*((_QWORD *)a1 + 30) )
  {
    if ( dword_1C030C400 > 3u )
    {
      ...
      v15 = 4LL;
      v17 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C030C400, &unk_1C02D6CFC, 0LL, 0LL, 5u, &pData);
    }
