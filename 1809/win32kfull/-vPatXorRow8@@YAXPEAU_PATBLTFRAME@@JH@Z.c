/*
 * XREFs of ?vPatXorRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02A9A30
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a3 )
  {
    do
    {
      ...
      else
      {
        ...
        v26 = (unsigned int)(v16 - v13) >> 2;
        if ( (unsigned int)(v16 - v13) >= 4 )
        {
          v21 = *((_DWORD *)a1 + 10);
          v25 = v21;
          v22 = v7 + (unsigned int)v13;
          v20 %= v21;
          v24 = v20;
          v27 = v21;
          if ( (((unsigned __int8)v20 | (unsigned __int8)v21) & 3) != 0 )
          {
            vFetchShiftAndMerge(&v22);
          }
          else
          {
            v27 = v21 >> 2;
            vFetchAndMerge((__int64)&v22);
          }
          v19 = v28;
          v10 = v23;
        }
        if ( v29 )
        {
          v24 = ((int)v20 + 4 * (unsigned __int64)v26) % *((unsigned int *)a1 + 10);
          *(_DWORD *)(v16 + v7) ^= v19 & *(_DWORD *)(v24 + v10);
        }
      }
      if ( ++v9 == *((_DWORD *)a1 + 11) )
      {
