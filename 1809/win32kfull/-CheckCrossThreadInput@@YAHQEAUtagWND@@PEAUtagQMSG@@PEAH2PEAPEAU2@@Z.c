/*
 * XREFs of ?CheckCrossThreadInput@@YAHQEAUtagWND@@PEAUtagQMSG@@PEAH2PEAPEAU2@@Z @ 0x1C0107208
 * Callers:
        ...
        struct tagQMSG **a5)
{
  ...
  if ( (v10 & 0x40) != 0
    ...
    || (v13 = CalcWakeMask(*((_DWORD *)a2 + 6), *((_DWORD *)a2 + 6), 0),
        (v13 & 2) == 0 || v9 == *((struct tagTHREADINFO **)a1 + 31)) )
  {
LABEL_7:
  ...
  *((_DWORD *)a2 + 25) = v10 | 0x20;
  ReassignInputMessage(v9, *((struct tagTHREADINFO **)a1 + 31), a2);
  result = 1LL;
