/*
 * XREFs of SlowAppThreadInShellFrame @ 0x1C012AEEC
 * Callers:
 ...
 *     ?OtherThreadsKeyboardInput@@YAPEAUtagTHREADINFO@@PEAUtagQ@@PEAUtagQMSG@@@Z @ 0x1C01CE1DC (-OtherThreadsKeyboardInput@@YAPEAUtagTHREADINFO@@PEAUtagQ@@PEAUtagQMSG@@@Z.c)
 */
        ...
        int a4)
{
    ...
    if ( v12 == a2 && v12 != a1 )
    {
      ...
      if ( v19 )
      {
        if ( a3 == v19 )
        {
          ...
          if ( v20 )
          {
            if ( (int)v9 - *(_DWORD *)(v20 + 48) >= v11 )
              return v12;
          }
          if ( (int)v9 - *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v4 + 64) + 448LL) + 12LL) >= v11 )
            return v12;
        }
      }
    }
  ...
  {
    v13 = v27;
    if ( (v27 || (*(_WORD *)(*((_QWORD *)a1 + 56) + 6LL) & 0x1084) != 0)
...
LABEL_6:
  ...
  {
    v21 = *((_QWORD *)v12 + 101);
    if ( v17 == v21 && (int)v9 - *(_DWORD *)(v21 + 48) >= v11 )
      return v12;
    v22 = *(_QWORD *)(v4 + 24);
    if ( v17 == v22 && (int)v9 - *(_DWORD *)(v22 + 48) >= v11 )
      return v12;
  }
  if ( v13
    && ((int)v9 - *(_DWORD *)(*((_QWORD *)v12 + 56) + 12LL) >= v11
...
LABEL_8:
  ...
  v24 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 54) + 120LL) + 88LL);
  if ( v24 )
