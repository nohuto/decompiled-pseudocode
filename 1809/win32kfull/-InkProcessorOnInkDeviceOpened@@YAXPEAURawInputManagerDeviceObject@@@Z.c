/*
 * XREFs of ?InkProcessorOnInkDeviceOpened@@YAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C01F8C4C
 * Callers:
...
void __fastcall InkProcessorOnInkDeviceOpened(struct RawInputManagerDeviceObject *a1)
{
  ...
  {
    InkProcessor::OnDeviceOpened((InkProcessor *)InkProcessor::s_pInstance, a1);
  }
