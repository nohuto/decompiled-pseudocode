/*
 * XREFs of ?RetrieveMessage@Pointer@InputTraceLogging@@SAXPEBUtagQMSG@@_NW4tagINPUTMESSAGE_RETRIEVE_RETVAL@@@Z @ 0x1C01CE634
 * Callers:
...
void InputTraceLogging::Pointer::RetrieveMessage()
{
  ...
  if ( (unsigned int)dword_1C030D340 > 4 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x20uLL) )
  {
    v3 = *(_QWORD *)(v2 + 136);
    v17 = 0;
    v20 = 0;
    ...
    v12 = v8;
    v32 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D4E67, 0LL, 0LL, 9u, &pData);
  }
}
