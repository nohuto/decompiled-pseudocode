/*
 * XREFs of ?MulSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1C0286DD0
 * Callers:
...
unsigned __int64 __fastcall MulSaveScreenBits(struct _SURFOBJ *a1, unsigned int a2, _QWORD *a3, struct _RECTL *a4)
{
  ...
  while ( 1 )
  {
    ...
    if ( bIntersect(a4, (const struct _RECTL *)((char *)v8 + 28), &v23) )
    {
      ...
      v23.bottom -= *((_DWORD *)v8 + 8);
      if ( *(_QWORD *)(v8[6] + 3008) )
        v6 = *(unsigned __int64 (**)(struct _SURFOBJ *, unsigned int, unsigned __int64, struct _RECTL *))(v8[6] + 3008);
      v12 = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD, struct _RECTL *))v6)(v8[8], 0LL, 0LL, &v23);
      if ( !v12 )
      {
    ...
    *(_QWORD *)(v5 + 16LL * *((unsigned int *)v8 + 4) + 8) = v12;
    if ( v12 )
      *(_DWORD *)(v5 + 16LL * *((unsigned int *)v8 + 4)) = (v6 != ulSimulateSaveScreenBits) + 1;
    v8 = (__int64 *)*v8;
    if ( !--v9 )
      return v5;
    a4 = v18;
