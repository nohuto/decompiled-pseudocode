/*
 * XREFs of xxxSetModernAppWindow @ 0x1C0004D50
 * Callers:
...
__int64 __fastcall xxxSetModernAppWindow(struct tagWND *a1, __int64 a2)
{
  ...
  v5 = 0LL;
  v6 = *(_QWORD *)(v2 + 1376);
  if ( (*(_DWORD *)(v2 + 1208) & 0x40000) == 0 )
    goto LABEL_58;
  v7 = *(struct tagWND **)(v2 + 1368);
  if ( !v7 || v7 != a1 )
    goto LABEL_58;
  if ( v2 == gptiCurrent )
  {
...
LABEL_57:
            ...
            if ( *(_QWORD *)(v2 + 1376) == v5 && *(struct tagWND **)(v17 + 120) == a1 )
            {
          ...
          if ( v6 )
          {
            if ( *(struct tagWND **)(v6 + 80) == a1 )
            {
              ...
              if ( *(_QWORD *)(v18 + 432) == *(_QWORD *)(v2 + 432) )
              {
                ...
                LockQCursor(*(struct tagQ **)(*(_QWORD *)(v6 + 16) + 432LL), *((struct tagCURSOR **)&gasyscur + 1));
                ...
                {
                  if ( (unsigned int)CoreWindowProp::CompositeAppHasForeground(a1) )
                    xxxSetForegroundWindow2(a1, 0LL, 2u);
                }
              }
            }
          }
