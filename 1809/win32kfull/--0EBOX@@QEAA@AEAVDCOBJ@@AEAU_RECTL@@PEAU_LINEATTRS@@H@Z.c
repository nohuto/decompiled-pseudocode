/*
 * XREFs of ??0EBOX@@QEAA@AEAVDCOBJ@@AEAU_RECTL@@PEAU_LINEATTRS@@H@Z @ 0x1C0293A6C
 * Callers:
...
EBOX *__fastcall EBOX::EBOX(EBOX *this, struct DCOBJ *a2, struct _RECTL *a3, struct _LINEATTRS *a4, int a5)
{
  ...
  __int64 v54; // rcx
  int v55; // edx
  float v57; // [rsp+30h] [rbp-40h] BYREF
  float v58; // [rsp+34h] [rbp-3Ch] BYREF
  int v59; // [rsp+38h] [rbp-38h] BYREF
  int v60; // [rsp+3Ch] [rbp-34h]
  int v61; // [rsp+40h] [rbp-30h]
  int v62; // [rsp+44h] [rbp-2Ch]
  _BYTE v63[16]; // [rsp+48h] [rbp-28h] BYREF
  struct _POINTL v64; // [rsp+58h] [rbp-18h] BYREF
  LONG v65; // [rsp+60h] [rbp-10h]
  LONG v66; // [rsp+64h] [rbp-Ch]
...
LABEL_25:
  ...
  if ( *(_DWORD *)(v30 + 208) == 2 || v26 || *((_DWORD *)this + 1) || (*(_DWORD *)(v30 + 340) & 0x20) != 0 )
  {
    v39 = (int *)((char *)this + 8);
    *((_DWORD *)this + 3) = y;
    *((_DWORD *)this + 5) = y;
    ...
    *((_DWORD *)this + 7) = v22;
    ...
    if ( v26 )
    {
      ...
      v62 = v45;
      v60 = v45;
      EXFORMOBJ::bXform((EXFORMOBJ *)v63, (struct _VECTORL *)&v59, (struct _VECTORFX *)&v59, 2uLL, 0);
      v48 = v61;
      v49 = v60 + 1;
      v50 = (v59 + 1) >> 1;
      *v39 += v50;
  ...
  EXFORMOBJ::bXformRound((EXFORMOBJ *)v63, &v64, (struct _POINTFIX *)&v64, 2uLL);
  v31 = 16;
  if ( a5 && v21[44] == 5 )
  {
    v32 = v64.y;
