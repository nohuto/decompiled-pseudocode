/*
 * XREFs of ?ObtainSectionForNetworkedFontFile@@YAJPEAU_UNICODE_STRING@@PEAU_FILEVIEW@@PEAU_OBJECT_ATTRIBUTES@@PEAT_LARGE_INTEGER@@_N@Z @ 0x1C026DCBC
 * Callers:
 ...
 *     ZwWin32CreateSectionRetainHandle @ 0x1C008D41C (ZwWin32CreateSectionRetainHandle.c)
        ...
        bool a5)
{
  ...
  _BYTE Buffer[16]; // [rsp+70h] [rbp-21h] BYREF
