/*
 * XREFs of ?MigrateRectMonitors@@YA_NPEAUtagWND@@PEAUtagRECT@@PEAUtagMONITOR@@122PEAU_MOVESIZEDATA@@K@Z @ 0x1C01E53B0
 * Callers:
 ...
 *     TransformRectAroundPoint @ 0x1C01D2AE4 (TransformRectAroundPoint.c)
 */
        ...
        char a8)
{
  ...
  struct tagWND *v68; // [rsp+80h] [rbp-59h]
  struct tagMONITOR *v69; // [rsp+88h] [rbp-51h]
  struct tagMONITOR *v70; // [rsp+90h] [rbp-49h]
  ...
  {
    ReduceArrangedRectangleByFrameMargin((__int64)a1, &v65, v71.m128i_i32);
    v8 = v71;
  }
  v66 = v8.m128i_i64[0];
...
LABEL_28:
            if ( v24 )
            {
              if ( (a8 & 8) != 0 || (v46 = *((_DWORD *)a7 + 29), v47 = v46 + v38, v23 < v46) )
                v47 = c_8[3];
              a4->bottom = v47;
            }
            v48 = *(_QWORD *)&a4->left - v37;
            if ( *(_QWORD *)&a4->left == v37 )
              v48 = *(_QWORD *)&a4->right - v67;
            v49 = v48 != 0;
            goto LABEL_61;
          }
          v45 = v20 - v42;
...
LABEL_60:
  v49 = 1;
LABEL_61:
  if ( v49 && (*(_DWORD *)(*((_QWORD *)v68 + 5) + 288LL) & 0xF) == 2 && (a8 & 0x10) != 0 )
  {
    *(struct tagRECT *)c_8 = *a4;
    TransformRectAroundPoint(
      c_8,
      *(_WORD *)(*((_QWORD *)v70 + 5) + 64LL),
      0LL,
      a4,
      *(_WORD *)(*((_QWORD *)v69 + 5) + 64LL),
      *(__int64 *)c_8);
  }
  return v49;
}
