/*
 * XREFs of ?_TTWindowPenalty@@YAIPEAUtagWND@@PEAUtagPNTRWINDOWHITTTESTARGS@@I@Z @ 0x1C01EE0B0
 * Callers:
 ...
 *     TouchTargetingBigTargetWindow @ 0x1C0242E9C (TouchTargetingBigTargetWindow.c)
 *     TouchTargetingDownrank @ 0x1C0243390 (TouchTargetingDownrank.c)
 */
