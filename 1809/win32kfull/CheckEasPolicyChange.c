/*
 * XREFs of CheckEasPolicyChange @ 0x1C01C3EA0
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C031DD18 != KeyInformation[0] )
  {
    qword_1C031DD18 = KeyInformation[0];
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C031DD10 != KeyInformation[0] )
  {
    qword_1C031DD10 = KeyInformation[0];
    return 1;
  }
  return v0;
}
