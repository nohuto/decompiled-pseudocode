/*
 * XREFs of NtGdiBRUSHOBJ_pvGetRbrush @ 0x1C0295CB0
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall NtGdiBRUSHOBJ_pvGetRbrush(__int64 a1, __int64 a2)
{
...
LABEL_5:
  ...
  v7 = (struct _BRUSHOBJ *)UMPDOBJ::GetDDIOBJ<_BRUSHOBJ>((__int64)ThreadCurrentObj, a1);
  if ( !v7 )
    goto LABEL_5;
  RbrushUMPD = BRUSHOBJ_pvGetRbrushUMPD(v7, v8);
LABEL_6:
  if ( ThreadCurrentObj )
