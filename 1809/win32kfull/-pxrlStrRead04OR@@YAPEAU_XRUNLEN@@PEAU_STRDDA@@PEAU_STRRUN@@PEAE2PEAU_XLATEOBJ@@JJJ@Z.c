/*
 * XREFs of ?pxrlStrRead04OR@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C02A46D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  *((_DWORD *)a2 + 3) = *((_DWORD *)a1 + 2) - v12;
  if ( a5 )
  {
    if ( a6 < a7 )
    {
      ...
      while ( 1 )
      {
        v28 = a5->pulXlate[(unsigned __int64)(v24 & (unsigned int)dword_1C02D1FE0[v27]) >> LOBYTE(dword_1C02D1FC0[v27])];
        v29 = *v25++;
        if ( (_DWORD)v29 )
        {
          v8 += v29;
  ...
  else if ( a6 < a7 )
  {
    ...
    {
      v17 = *v14++;
      v18 = (v13 & (unsigned int)dword_1C02D1FE0[v16]) >> dword_1C02D1FC0[v16];
      if ( (_DWORD)v17 )
      {
        v8 += v17;
