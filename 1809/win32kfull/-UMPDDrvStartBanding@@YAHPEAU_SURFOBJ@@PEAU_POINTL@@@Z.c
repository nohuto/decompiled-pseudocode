/*
 * XREFs of ?UMPDDrvStartBanding@@YAHPEAU_SURFOBJ@@PEAU_POINTL@@@Z @ 0x1C0126D40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UMPDDrvStartBanding(struct _SURFOBJ *a1, struct _POINTL *a2)
{
  ...
  if ( v16 )
  {
          ...
          (v11 = v9) != 0) )
    {
      ...
      v17[3] = a1;
      v17[4] = a2;
      if ( (unsigned int)UMPDOBJ::pso(v7, (UMPDOBJ *)((char *)v7 + 64), (EVENT_DATA_DESCRIPTOR **)&v17[3], v5) )
      {
