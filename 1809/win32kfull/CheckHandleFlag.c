/*
 * XREFs of CheckHandleFlag @ 0x1C00B18C8
 * Callers:
 *     OkayToCloseWindowStation @ 0x1C00B10A0 (OkayToCloseWindowStation.c)
 *     OkayToCloseDesktop @ 0x1C00B1120 (OkayToCloseDesktop.c)
