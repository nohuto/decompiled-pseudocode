/*
 * XREFs of ?SetAutoTriggerWaveform@SimpleHapticsController@@QEAAJG@Z @ 0x1C023F118
 * Callers:
...
__int64 __fastcall SimpleHapticsController::SetAutoTriggerWaveform(PHIDP_PREPARSED_DATA *this, unsigned __int16 a2)
{
  ...
  if ( (unsigned int)dword_1C030C3C8 > 4 )
  {
    ...
    v20 = 2LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C3C8, &unk_1C02D6C1A, 0LL, 0LL, 4u, &pData);
  }
