/*
 * XREFs of ?ReadLinearityData@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@U_UNICODE_STRING@@PEAX@Z @ 0x1C01BE194
 * Callers:
 *     RetrieveCalibrationData @ 0x1C01BEF80 (RetrieveCalibrationData.c)
 * Callees:
 *     RtlStringCchCopyNW @ 0x1C00ECB28 (RtlStringCchCopyNW.c)
 *     ?GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C01BDE04 (-GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
