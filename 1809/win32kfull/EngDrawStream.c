/*
 * XREFs of EngDrawStream @ 0x1C00F54C0
 * Callers:
 ...
 * Callees:
 *     ?bRedirHooked@SURFACE@@QEAAHXZ @ 0x1C00F5714 (-bRedirHooked@SURFACE@@QEAAHXZ.c)
        ...
        _QWORD *a9)
{
  ...
  __int64 v23; // rax
  __int64 (__fastcall *v24)(int, __int64, int, int, __int64, __int64, __int64, int *); // r10
  __int64 (__fastcall *v25)(int, __int64, int, int, __int64, __int64, __int64, int *); // r8
...
LABEL_23:
    ...
    v24 = EngNineGrid;
    if ( *(_QWORD *)(v23 + 3416) )
      v24 = *(__int64 (__fastcall **)(int, __int64, int, int, __int64, __int64, __int64, int *))(v23 + 3416);
