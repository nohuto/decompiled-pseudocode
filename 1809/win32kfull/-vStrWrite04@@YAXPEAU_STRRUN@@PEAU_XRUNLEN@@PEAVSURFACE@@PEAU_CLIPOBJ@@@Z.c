/*
 * XREFs of ?vStrWrite04@@YAXPEAU_STRRUN@@PEAU_XRUNLEN@@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02A5960
 * Callers:
 *     <none>
 * Callees:
            ...
            do
            {
              ...
              if ( v48 < v50 )
              {
                ...
                do
                {
                  ...
                  if ( v48 >= si128.left && v48 < si128.right )
                    v54 = v54 & ~dword_1C02D1FE0[v56] | dword_1C02D1FE0[v56] & (*v57 << dword_1C02D1FC0[v56]);
                  ++v52;
                  ++v56;
                  ++v57;
                  v61 = v52;
      ...
      for ( i = v8; v5 != (int *)a2; v65 = v5 )
      {
        ...
        if ( *v5 < v10 )
        {
          ...
          if ( (unsigned __int64)v11 < *((_QWORD *)a3 + 9) + (unsigned __int64)*((unsigned int *)a3 + 16) )
          {
            ...
            do
            {
              v18 = dword_1C02D1FE0[v15];
              ++v13;
              v19 = *v16;
              ++v9;
              v20 = dword_1C02D1FC0[v15];
              ++v16;
              ++v15;
          ...
          *v12 = v14;
          ...
          if ( v21 > 1 )
          {
            ...
            {
              v28 = 1;
              v29 = dword_1C02D2000[v26] & ~dword_1C02D2000[v27];
              v30 = *v11;
              do
              {
                ++v28;
            ...
            else
            {
              ...
              {
                v31 = 1;
                v32 = ~dword_1C02D2000[(unsigned int)v26];
                v33 = *v11 & dword_1C02D2000[(unsigned int)v26];
                do
                {
                  ++v31;
                  v11 = (int *)((char *)v11 + *((int *)a3 + 22));
              ...
              if ( (_DWORD)v27 )
              {
                v39 = 1;
                v40 = (int *)(v8 + 4LL * v25);
                v41 = dword_1C02D2000[(unsigned int)v27];
                v42 = *v40 & ~v41;
                if ( v34 > 1 )
                {
                  do
