/*
 * XREFs of ?UMPDDrvLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x1C028DE40
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a9)
{
  ...
  if ( v25 )
  {
          ...
          (v19 = v15) != 0) )
    {
      ...
      v27[4] = a2;
      v27[5] = a3;
      if ( !(unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 64), (EVENT_DATA_DESCRIPTOR **)&v27[3], v11)
