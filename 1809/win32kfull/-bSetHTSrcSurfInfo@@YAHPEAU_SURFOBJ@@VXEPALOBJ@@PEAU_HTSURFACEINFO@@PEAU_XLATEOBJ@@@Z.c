/*
 * XREFs of ?bSetHTSrcSurfInfo@@YAHPEAU_SURFOBJ@@VXEPALOBJ@@PEAU_HTSURFACEINFO@@PEAU_XLATEOBJ@@@Z @ 0x1C00127DC
 * Callers:
...
LABEL_7:
  ...
  *(_QWORD *)&v21 = a1;
  ...
  if ( v12 <= v11 )
    v11 = v12;
  v13 = AllocThreadBufferWithTag(4 * v11 + 24, 1668573255LL, 0LL, 4LL);
  v23 = v13;
  v14 = v13;
  if ( !v13 )
  {
