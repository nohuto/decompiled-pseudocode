/*
 * XREFs of ?SetShape@SFMLOGICALSURFACE@@QEAAHPEAUHDEV__@@PEAU_SURFOBJ@@@Z @ 0x1C000E604
 * Callers:
 ...
 *     vSpDwmMigrateLSurfShapeReferenceWrap @ 0x1C01353E0 (vSpDwmMigrateLSurfShapeReferenceWrap.c)
 * Callees:
 *     ?LockSurface@SFMLOGICALSURFACE@@AEAAPEAU_SURFOBJ@@PEAUHSURF__@@PEAUHLSURF__@@@Z @ 0x1C000E748 (-LockSurface@SFMLOGICALSURFACE@@AEAAPEAU_SURFOBJ@@PEAUHSURF__@@PEAUHLSURF__@@@Z.c)
 *     ?UnlockSurface@SFMLOGICALSURFACE@@AEAAXPEAU_SURFOBJ@@@Z @ 0x1C000E7A4 (-UnlockSurface@SFMLOGICALSURFACE@@AEAAXPEAU_SURFOBJ@@@Z.c)
