/*
 * XREFs of ?PromotePointerInternal@@YAHGKPEAUtagMOUSE_PROMOTION_ENTRY@@0@Z @ 0x1C01F1960
 * Callers:
 ...
 *     ?ValidateDoubleClick@@YAHAEBUtagTAP_INFO@@KKH@Z @ 0x1C01F1D60 (-ValidateDoubleClick@@YAHAEBUtagTAP_INFO@@KKH@Z.c)
 */
        ...
        struct tagMOUSE_PROMOTION_ENTRY *a4)
{
  ...
  if ( (dword_1C03172F8 & 8) != 0
    && CacheById == (struct tagMOUSE_PROMOTION_CACHE *)word_1C03171F8
  ...
  v21 = (v4 & 0x20000) != 0;
  if ( (v4 & 0x40000) != 0 )
    v13 = ValidateDoubleClick((const struct tagTAP_INFO *)&qword_1C03172B0, v26, *((_DWORD *)a3 + 4), (v4 & 2) != 0);
  else
    v13 = 0;
  if ( v13 )
    *((_QWORD *)a3 + 1) = qword_1C03172BC;
  v14 = v10 + 1;
  v15 = *((_QWORD *)a3 + 1);
  v26 = *((_DWORD *)a3 + 4);
  if ( (unsigned int)v14 < 5 )
  {
    ...
    v17 = (struct tagMOUSE_PROMOTION_QUEUE *)((char *)&unk_1C0317200 + 24 * v14);
    do
    {
  ...
  else
  {
    ...
    {
      if ( v22 )
        v18 = dword_1C03172F8 | 4;
      else
        v18 = dword_1C03172F8 & 0xFFFFFFFB;
      dword_1C03172F8 = v18 & 0xFFFFFFEF | (16 * v12) | 2;
    }
  }
  if ( v23 )
  {
    qword_1C03172B0 = gptiCurrent;
    dword_1C03172C4 = v26;
    word_1C03172B8 = v7;
    qword_1C03172BC = v15;
    dword_1C03172C8 = v22 != 0;
  }
  else if ( v4 )
  {
    memset(&qword_1C03172B0, 0, 0x20uLL);
  }
  return 1LL;
}
