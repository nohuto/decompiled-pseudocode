/*
 * XREFs of UninitializeTelemetryAssertsKM @ 0x1C0131DA0
 * Callers:
 *     UninitializeWin32kFullTelemetryAsserts @ 0x1C0131C50 (UninitializeWin32kFullTelemetryAsserts.c)
 * Callees:
...
NTSTATUS UninitializeTelemetryAssertsKM()
{
  ...
  if ( result )
  {
    ...
    EtwUnregister(qword_1C0354098);
    qword_1C0354098 = 0LL;
    dword_1C0354078 = 0;
    EtwUnregister(qword_1C0354028);
    qword_1C0354028 = 0LL;
    dword_1C0354008 = 0;
    result = EtwUnregister(qword_1C0354060);
    qword_1C0354060 = 0LL;
    dword_1C0354040 = 0;
  }
  return result;
