/*
 * XREFs of ?IsValidFONTSIM@@YA_NPEBXKJ@Z @ 0x1C028C30C
 * Callers:
 *     ?IsValidIFIMETRICS@@YA_NPEBU_IFIMETRICS@@K@Z @ 0x1C028C380 (-IsValidIFIMETRICS@@YA_NPEBU_IFIMETRICS@@K@Z.c)
 * Callees:
 *     ?IsValidFONTDIFF@@YA_NPEBXKJ@Z @ 0x1C028C2D4 (-IsValidFONTDIFF@@YA_NPEBXKJ@Z.c)
 */
