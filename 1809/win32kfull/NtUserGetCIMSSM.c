/*
 * XREFs of NtUserGetCIMSSM @ 0x1C014B2F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetCIMSSM(ULONG64 a1)
{
  ...
  EnterCrit(0LL, 1LL);
  v5 = 0LL;
  if ( a1 && (unsigned int)_GetCurrentInputMessageSource(0, (struct tagINPUT_MESSAGE_SOURCE *)&v14) && !v14 )
  {
    CurrentInputMessageSource = _GetCurrentInputMessageSource(1, (struct tagINPUT_MESSAGE_SOURCE *)&v14);
