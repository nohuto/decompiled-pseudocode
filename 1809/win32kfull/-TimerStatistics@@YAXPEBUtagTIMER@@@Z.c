/*
 * XREFs of ?TimerStatistics@@YAXPEBUtagTIMER@@@Z @ 0x1C00D3E80
 * Callers:
...
void __fastcall TimerStatistics(const struct tagTIMER *a1)
{
  ...
  if ( (gdwExtraInstrumentations & 2) != 0 )
  {
    ...
    if ( gaTimerDeliveryDistribution[2 * v9] >= 0x7FFFFFFFu || v10 >= 0x3FFFFFFF || (unsigned int)(v7 - v3) >= 0xEA60 )
    {
      ...
      while ( v12 );
      EtwTraceTimerDelayStatistics(gSessionId, 8LL, 4LL, &unk_1C02D9278, 32, 8, gaTimerDeliveryDistribution);
      dword_1C031DECC = v7;
