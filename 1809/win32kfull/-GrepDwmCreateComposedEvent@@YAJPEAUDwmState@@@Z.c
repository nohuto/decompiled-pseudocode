/*
 * XREFs of ?GrepDwmCreateComposedEvent@@YAJPEAUDwmState@@@Z @ 0x1C00EDE3C
 * Callers:
 ...
 *     ?RtlStringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C00EE110 (-RtlStringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
 */
