/*
 * XREFs of ?RedirDrawEscape@@YAKPEAU_SURFOBJ@@KPEAU_CLIPOBJ@@PEAU_RECTL@@KPEAX@Z @ 0x1C027FCE0
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( v11 )
          {
            ...
            do
            {
              ...
              if ( v14 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v14 + 1792) + 264LL) )
                  {
                    MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                      (MARK_ACCDRV_NOTIFICATION *)&v17,
                      (struct PDEVOBJ *)&HDEV,
                      a1);
                    (*(void (__fastcall **)(struct _SURFOBJ *, _QWORD, struct _CLIPOBJ *, struct _RECTL *, unsigned int, void *))(*(_QWORD *)(v15 + 1792) + 264LL))(
                      a1,
                      a2,
                      a3,
                      a4,
