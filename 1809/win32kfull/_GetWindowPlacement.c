/*
 * XREFs of _GetWindowPlacement @ 0x1C00B6B80
 * Callers:
...
LABEL_4:
  ...
  *(_OWORD *)(a2 + 28) = *(_OWORD *)updated;
  if ( (*(_BYTE *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v7) + 480) + 224LL) & 1) != 0
    || (v12 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v10) + 480),
  ...
  {
    v16 = MonitorFromRect((struct tagRECT *)(a2 + 28), 1u, 0);
