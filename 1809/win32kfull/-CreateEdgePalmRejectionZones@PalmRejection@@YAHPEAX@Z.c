/*
 * XREFs of ?CreateEdgePalmRejectionZones@PalmRejection@@YAHPEAX@Z @ 0x1C01E07B4
 * Callers:
 *     EditionCreateEdgePalmRejectionZones @ 0x1C01E09C0 (EditionCreateEdgePalmRejectionZones.c)
 * Callees:
