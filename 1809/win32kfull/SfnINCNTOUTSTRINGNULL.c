/*
 * XREFs of SfnINCNTOUTSTRINGNULL @ 0x1C01FF7E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  __int64 v38; // rdx
  PVOID *v39; // rdx
  char v40; // [rsp+30h] [rbp-388h] BYREF
  _BYTE v41[3]; // [rsp+31h] [rbp-387h] BYREF
  unsigned int v42; // [rsp+34h] [rbp-384h]
  unsigned __int8 *v43; // [rsp+38h] [rbp-380h]
  int v44[6]; // [rsp+40h] [rbp-378h] BYREF
  unsigned __int64 v45; // [rsp+58h] [rbp-360h] BYREF
  __int64 v46; // [rsp+60h] [rbp-358h]
  unsigned int v47[4]; // [rsp+68h] [rbp-350h]
  ULONG_PTR RegionSize; // [rsp+78h] [rbp-340h] BYREF
  __int64 v49; // [rsp+80h] [rbp-338h] BYREF
  volatile signed __int32 *v50; // [rsp+88h] [rbp-330h]
  __int64 v51; // [rsp+90h] [rbp-328h]
  __int128 v52; // [rsp+98h] [rbp-320h]
  __int64 v53; // [rsp+A8h] [rbp-310h]
  __m128i v54; // [rsp+B0h] [rbp-308h] BYREF
  __int64 v55; // [rsp+C0h] [rbp-2F8h]
  __int128 v56; // [rsp+E8h] [rbp-2D0h]
  _QWORD v57[3]; // [rsp+F8h] [rbp-2C0h] BYREF
  unsigned __int8 v58[96]; // [rsp+110h] [rbp-2A8h] BYREF
  unsigned __int8 v59[512]; // [rsp+170h] [rbp-248h] BYREF
  ...
  *(_QWORD *)v47 = a3;
  ...
  if ( a1 )
    v15 = *((_QWORD *)a1 + 5) - *(_QWORD *)(ThreadWin32Thread + 472);
  else
    v15 = 0LL;
  v16 = *(_DWORD *)(a4 + 4);
  v17 = v16 & 0x7FFFFFFF;
  ...
  result = AllocCallbackMessage(96, 1u, v18, v59, 0, 0x200uLL);
  v12 = result;
  v43 = result;
  if ( !result )
    return result;
  ...
  if ( v12 != v58 && v12 != v59 )
    PushW32ThreadLock((__int64)v12, v57, (__int64)Win32FreePool);
  v22 = *(_QWORD *)v47;
  if ( *(_QWORD *)v47 < 2uLL )
    goto LABEL_46;
  *((_QWORD *)v12 + 5) = v15;
  ...
  *(_QWORD *)(v26 + 72) = v15;
  if ( a1 )
    ...
    v27 = 0LL;
  *(_QWORD *)(*(_QWORD *)(v14 + 480) + 64LL) = v27;
  if ( a1 )
    v28 = *(_QWORD *)(*((_QWORD *)a1 + 5) + 224LL);
  else
    v28 = 0LL;
  *(_QWORD *)(*(_QWORD *)(v14 + 480) + 80LL) = v28;
...
LABEL_46:
  ...
  {
    v35 = (unsigned int)CalcOutputStringSize((struct _CALLBACKSTATUS *)&v54, v35, *(_DWORD *)(a4 + 4) >> 31, v11);
    v46 = v35;
    CopyOutputString((struct _CALLBACKSTATUS *)&v54, (PWCH *)a4, v47[0], v11);
  }
LABEL_47:
  if ( v12 != v58 && v12 != v59 )
  {
    ...
    PopAndFreeAlwaysW32ThreadLock((__int64)v57, (__int64)v39);
  }
