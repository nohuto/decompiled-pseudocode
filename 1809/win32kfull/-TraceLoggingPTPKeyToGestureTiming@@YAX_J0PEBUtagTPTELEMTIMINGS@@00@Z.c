/*
 * XREFs of ?TraceLoggingPTPKeyToGestureTiming@@YAX_J0PEBUtagTPTELEMTIMINGS@@00@Z @ 0x1C01BA3A8
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
    {
      ...
      v23 = 1000 * v6 / a5;
      v52 = &v23;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02D3E31, 0LL, 0LL, 0xCu, &pData);
    }
  }
}
