/*
 * XREFs of ?FindThreadPointerData@@YAPEAUtagTHREADPOINTERDATA@@PEAU_LIST_ENTRY@@G@Z @ 0x1C01DC188
 * Callers:
 ...
 *     EditionFindThreadPointerData @ 0x1C01DD2A0 (EditionFindThreadPointerData.c)
 * Callees:
 *     <none>
 */
