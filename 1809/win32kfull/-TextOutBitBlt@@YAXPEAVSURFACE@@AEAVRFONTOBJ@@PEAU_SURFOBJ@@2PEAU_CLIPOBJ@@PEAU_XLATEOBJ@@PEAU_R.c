/*
 * XREFs of ?TextOutBitBlt@@YAXPEAVSURFACE@@AEAVRFONTOBJ@@PEAU_SURFOBJ@@2PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@6PEAU_BRUSHOBJ@@6K@Z @ 0x1C02906CC
 * Callers:
        ...
        struct _POINTL *a11)
{
  ...
  {
    v18 = UMPDReleaseRFONTSem(a2, 0LL, &v21, &v22, (void **)&v23);
    v13 = v21;
    v15 = v18;
    v14 = v22;
    v11 = v23;
  ...
  ((void (__fastcall *)(__int64, _QWORD, _QWORD, struct _CLIPOBJ *, _QWORD, struct _RECTL *, _QWORD, _QWORD, struct _BRUSHOBJ *, struct _POINTL *, int))v19)(
    v20,
    0LL,
    0LL,
    a5,
