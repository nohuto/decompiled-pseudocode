/*
 * XREFs of ?xxxProcessMousePromotionQueue@@YAXXZ @ 0x1C01F1F8C
 * Callers:
 ...
 *     ?DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z @ 0x1C01F1378 (-DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z.c)
...
void xxxProcessMousePromotionQueue(void)
{
  ...
  v0 = 0;
  if ( !qword_1C03172F0 && qword_1C0317270 )
  {
    dword_1C03172F8 &= ~1u;
    qword_1C03172F0 = gptiCurrent;
    for ( i = DequeueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0317270);
          ;
          i = DequeueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0317270) )
    {
      v13 = (__int64)i;
      if ( !i )
        break;
