/*
 * XREFs of SetWindowCompositionExcludeFromLivePreview @ 0x1C00B9534
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludeFromLivePreview(__int64 a1, _DWORD *a2)
{
  unsigned int v3; // ebx
  int v4; // edi
  __int64 v5; // rdx
  ...
  {
    if ( -__CFSHR__(v9[0], 5) == v4 )
      return 0;
    v9[0] = v9[0] & 0xFFFFFFEF | (16 * v4);
