/*
 * XREFs of ?GetScaledComponentValue@InteractiveControlParser@@SAJPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@J@Z @ 0x1C0240520
 * Callers:
        ...
        int a2)
{
  ...
  if ( dword_1C030C400 > 3u )
  {
    ...
    v11 = v4;
    v20 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C400, &unk_1C02D6E52, 0LL, 0LL, 6u, &pData);
  }
  return 1LL;
}
