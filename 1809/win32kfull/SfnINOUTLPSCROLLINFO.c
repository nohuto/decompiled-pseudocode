/*
 * XREFs of SfnINOUTLPSCROLLINFO @ 0x1C010B220
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  *(_QWORD *)(*(_QWORD *)(v13 + 480) + 80LL) = v19;
  ...
  v20 = KeUserModeCallback(19LL, v43, 72LL, &v35, v34);
  ...
  *(_QWORD *)(v24 + 80) = v40;
  if ( v20 >= 0 && v34[0] == 24 )
  {
    ...
    {
      v28 = *(_QWORD *)(v35 + 16);
      if ( v28 + 28 < v28 || v28 + 28 > MmUserProbeAddress )
