/*
 * XREFs of ?UMPDDrvQueryPerBandInfo@@YAKPEAU_SURFOBJ@@PEAU_PERBANDINFO@@@Z @ 0x1C011DEF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UMPDDrvQueryPerBandInfo(struct _SURFOBJ *a1, struct _PERBANDINFO *a2)
{
  ...
  if ( v19 )
  {
          ...
          (v14 = v12) != 0) )
    {
      ...
      v20[2] = *(_QWORD *)v7;
      v20[3] = a1;
      if ( (unsigned int)UMPDOBJ::pso(v7, (UMPDOBJ *)((char *)v7 + 64), (EVENT_DATA_DESCRIPTOR **)&v20[3], v5) )
      {
        v8 = UMPDOBJ::_AllocUserMem(v7, 20LL, 0);
        v20[4] = v8;
        if ( v8 )
        {
          if ( a2 )
