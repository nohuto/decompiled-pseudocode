/*
 * XREFs of ?Insert@?$CSortedVector@_K_K@NSInstrumentation@@QEAA_NAEB_K0@Z @ 0x1C010122C
 * Callers:
 *     UmfdLoadFontFile @ 0x1C0100E70 (UmfdLoadFontFile.c)
 * Callees:
 *     ?LowerBound@?$CSortedVector@_K_K@NSInstrumentation@@QEBA_KAEB_K@Z @ 0x1C008E8DC (-LowerBound@-$CSortedVector@_K_K@NSInstrumentation@@QEBA_KAEB_K@Z.c)
 ...
 *     ?Wait@CPlatformSingleWatierSignal@NSInstrumentation@@QEAAXXZ @ 0x1C02BF894 (-Wait@CPlatformSingleWatierSignal@NSInstrumentation@@QEAAXXZ.c)
 */
        ...
        _QWORD *a3)
{
  ...
  v7 = NSInstrumentation::CSortedVector<unsigned __int64,unsigned __int64>::LowerBound((__int64)v3, a2);
  v8 = *((_QWORD *)v3 + 5);
  v9 = 16 * v7;
  v10 = v7;
