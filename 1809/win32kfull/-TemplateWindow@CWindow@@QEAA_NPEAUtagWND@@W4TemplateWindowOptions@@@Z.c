/*
 * XREFs of ?TemplateWindow@CWindow@@QEAA_NPEAUtagWND@@W4TemplateWindowOptions@@@Z @ 0x1C0225CD8
 * Callers:
...
char __fastcall CWindow::TemplateWindow(__int64 a1, __int64 a2, char a3)
{
  ...
  LOBYTE(a2) = 1;
  v5 = 0;
  v6 = HMValidateHandleNoSecure(*(_QWORD *)(a1 + 16), a2);
  v7 = v6;
  if ( v6 )
  {
    if ( v6 == v3 )
      ...
      if ( (a3 & 1) != 0 )
      {
        ...
        if ( v11 == (*(_BYTE *)(v10 + 24) & 8) )
        {
          ...
          if ( v12 == *(_DWORD *)(v10 + 236) )
          {
            ...
            {
              for ( i = *(struct tagWND **)(v6 + 72); i; i = *(struct tagWND **)(v15 + 72) )
              {
                ...
                if ( v11 != (*(_BYTE *)(v18 + 24) & 8) || v12 != *(_DWORD *)(v18 + 236) )
                {
                  if ( !v8 )
                    v8 = (__int64 *)v15;
                  return CloneWindowPosAndArrangementAsync((struct tagTHREADINFO **)v3, v7, v8, (a3 & 2) != 0);
                }
              }
            }
          }
