/*
 * XREFs of ?UnlinkAndFreeThreadPointerData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@PEAUtagTHREADPOINTERDATA@@@Z @ 0x1C01DC8E4
 * Callers:
 *     xxxCleanupThreadPointerInputInfo @ 0x1C01029F0 (xxxCleanupThreadPointerInputInfo.c)
 *     EditionUnlinkAndFreeThreadPointerData @ 0x1C01DD520 (EditionUnlinkAndFreeThreadPointerData.c)
 * Callees:
 *     <none>
 */
