/*
 * XREFs of BRUSHOBJ_pvAllocRbrush @ 0x1C0251630
 * Callers:
 *     VerifierBRUSHOBJ_pvAllocRbrush @ 0x1C0281DA0 (VerifierBRUSHOBJ_pvAllocRbrush.c)
 *     ?MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z @ 0x1C0286C90 (-MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z.c)
 * Callees:
