/*
 * XREFs of ?SetExternalParameters@InteractiveControlManager@@QEAAJPEAUtagINTERACTIVECTRL_PARAMETERS@@H@Z @ 0x1C02369CC
 * Callers:
        ...
        int a3)
{
  ...
  if ( dword_1C030C400 > 4u )
  {
    ...
    v11 = 55;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C400, &unk_1C02D61BA, 0LL, 0LL, 4u, &pData);
  }
  if ( a2 )
  {
    v6 = *(_DWORD *)a2;
