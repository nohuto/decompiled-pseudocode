/*
 * XREFs of ?UMPDDrvBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C0090050
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  struct _RECTL *v42; // [rsp+110h] [rbp+0h]
  struct _POINTL *v43; // [rsp+118h] [rbp+8h]
  struct _POINTL *v44; // [rsp+120h] [rbp+10h]
  struct _BRUSHOBJ *v45; // [rsp+128h] [rbp+18h]
      ...
      if ( (unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 80), (EVENT_DATA_DESCRIPTOR **)&v47[4], v13) )
      {
        if ( (unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 96), (EVENT_DATA_DESCRIPTOR **)&v47[5], v14) )
        {
                               ...
                               0LL) )
          {
            ...
            {
              if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v47[8], 0x10u) )
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v47[9], 8u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v47[10], 8u) )
                  {
                    if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(
                                         v16,
