/*
 * XREFs of ?ProbeAndReadFD_KERNINGPAIR@@YAPEAU_FD_KERNINGPAIR@@PEBU1@H_K@Z @ 0x1C028C564
 * Callers:
 ...
 *     ??9@YA_NAEBU_FD_KERNINGPAIR@@0@Z @ 0x1C028C258 (--9@YA_NAEBU_FD_KERNINGPAIR@@0@Z.c)
 */
