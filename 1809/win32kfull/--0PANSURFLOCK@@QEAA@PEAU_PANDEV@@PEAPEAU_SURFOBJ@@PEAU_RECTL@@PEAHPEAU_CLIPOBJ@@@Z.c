/*
 * XREFs of ??0PANSURFLOCK@@QEAA@PEAU_PANDEV@@PEAPEAU_SURFOBJ@@PEAU_RECTL@@PEAHPEAU_CLIPOBJ@@@Z @ 0x1C0278A1C
 * Callers:
 ...
 * Callees:
 *     ?vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ @ 0x1C027ADD0 (-vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ.c)
