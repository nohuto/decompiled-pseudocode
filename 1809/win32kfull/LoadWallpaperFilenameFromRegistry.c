/*
 * XREFs of LoadWallpaperFilenameFromRegistry @ 0x1C012E80C
 * Callers:
 ...
 *     ?GetDefaultWallpaperName@@YAXPEAGI@Z @ 0x1C01FABCC (-GetDefaultWallpaperName@@YAXPEAGI@Z.c)
 */
...
__int64 __fastcall LoadWallpaperFilenameFromRegistry(__int64 a1, wchar_t *a2, unsigned int a3)
{
  ...
  RtlLoadStringOrError(82LL, pszSrc, 20LL, 0LL);
