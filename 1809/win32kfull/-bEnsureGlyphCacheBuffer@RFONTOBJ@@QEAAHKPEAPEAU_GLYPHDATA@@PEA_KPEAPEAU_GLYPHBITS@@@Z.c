/*
 * XREFs of ?bEnsureGlyphCacheBuffer@RFONTOBJ@@QEAAHKPEAPEAU_GLYPHDATA@@PEA_KPEAPEAU_GLYPHBITS@@@Z @ 0x1C0162BA4
 * Callers:
...
LABEL_5:
  ...
  if ( v13 < 0x10 )
    return 0LL;
  v14 = v13 + 64;
  if ( v14 < 0x40 || !RFONTOBJ::bEnsureAuxCacheBuffer(this, v14) )
    return 0LL;
  v15 = *(struct _GLYPHDATA **)(*(_QWORD *)this + 616LL);
  *a3 = v15;
  *a4 = 64LL;
  v11 = (struct _GLYPHBITS *)&v15[1];
LABEL_17:
  *a5 = v11;
  return 1LL;
}
