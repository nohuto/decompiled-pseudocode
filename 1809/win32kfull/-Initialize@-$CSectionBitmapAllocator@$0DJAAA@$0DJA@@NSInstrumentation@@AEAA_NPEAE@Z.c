/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0DJAAA@$0DJA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C028B24C
 * Callers:
 ...
 * Callees:
 *     _lambda_2efbf0cef26c8b98c4ba734728b96fa6_::operator() @ 0x1C01F9070 (_lambda_2efbf0cef26c8b98c4ba734728b96fa6_--operator().c)
 */
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<233472,912>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = PoolWithTag;
  if ( !PoolWithTag )
    return 0;
  *PoolWithTag = 0LL;
  v10 = lambda_2efbf0cef26c8b98c4ba734728b96fa6_::operator()(v9, 0xE4u);
  if ( !v10 )
    return 0;
