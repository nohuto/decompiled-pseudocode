/*
 * XREFs of ?UMPDDrvStrokePath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@PEAU_LINEATTRS@@K@Z @ 0x1C028FA00
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a8)
{
  ...
  if ( v23 )
  {
          ...
          (v19 = v14) != 0) )
    {
      ...
      v28[4] = a2;
      v28[9] = a7;
      if ( !(unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 64), (EVENT_DATA_DESCRIPTOR **)&v28[3], v11) )
        goto LABEL_17;
