/*
 * XREFs of SfnOPTOUTLPDWORDOPTOUTLPDWORD @ 0x1C014A5A0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  *(_QWORD *)(*(_QWORD *)(v13 + 480) + 80LL) = v19;
  ...
  v20 = KeUserModeCallback(31LL, v35, 32LL, &v40, &v39);
