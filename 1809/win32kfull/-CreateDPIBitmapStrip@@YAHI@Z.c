/*
 * XREFs of ?CreateDPIBitmapStrip@@YAHI@Z @ 0x1C007B8B0
 * Callers:
...
__int64 __fastcall CreateDPIBitmapStrip(unsigned int a1)
{
  ...
  RECT v24; // [rsp+30h] [rbp-38h] BYREF
      ...
      if ( v9 )
      {
        ...
        if ( v12 == 0xFFFF )
        {
          if ( (v13 & 1) != 0 )
          {
            ...
            v16 = left + 2;
            v17 = v11 + 2;
            BitBltSysBmp(v3, v16, v17, 0);
            v19 = GetDpiDependentMetric(12LL, v2, v18) - 2 + v16;
            BitBltSysBmp(v3, v19, v17, 0);
            v21 = GetDpiDependentMetric(12LL, v2, v20) + v19;
            BitBltSysBmp(v3, v21, v17, 0);
            DpiDependentMetric = GetDpiDependentMetric(12LL, v2, v22);
            BitBltSysBmp(v3, v21 + DpiDependentMetric, v17, 0);
          }
        }
        else
        {
