/*
 * XREFs of DxgkEngGetRedirBitmapSharedHandle @ 0x1C025B650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkEngGetRedirBitmapSharedHandle(HDC a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  if ( v3 )
  {
    v4 = (HWND)v3[59];
    LODWORD(v10) = 0;
    GreGetDxSharedSurface(v4, a2, &v7, &v11, &v10, &v12);
    if ( v8 )
    {
      LODWORD(v10) = 0;
      v5 = *v8;
  ...
  return UnexpectedThreadTerminationHandler<DWMSPRITEREF>::~UnexpectedThreadTerminationHandler<DWMSPRITEREF>((__int64)v9);
}
