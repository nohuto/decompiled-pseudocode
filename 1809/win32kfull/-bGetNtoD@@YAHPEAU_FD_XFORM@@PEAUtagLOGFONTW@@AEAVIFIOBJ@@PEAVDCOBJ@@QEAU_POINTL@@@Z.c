/*
 * XREFs of ?bGetNtoD@@YAHPEAU_FD_XFORM@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@QEAU_POINTL@@@Z @ 0x1C0084E4C
 * Callers:
        ...
        struct _POINTL *const a5)
{
  ...
  if ( !a5->x || (v9 = *(_DWORD *)(*(_QWORD *)a3 + 48LL), (v9 & 0x3000010) != 0) )
  {
    ...
    {
      if ( !EXFORMOBJ::bMultiply((EXFORMOBJ *)&v28, (struct MATRIX *)v32, (struct MATRIX *)(v10 + 320), 0) )
        return v5;
