/*
 * XREFs of GreUpdateSpriteClipRgn @ 0x1C00746A8
 * Callers:
...
LABEL_26:
    ...
    CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)v13, (struct _EX_PUSH_LOCK *)(v18 + 88));
    v8 = *(_QWORD *)(v7 + 168);
    CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)v12, (struct _EX_PUSH_LOCK *)(v8 + 256));
