/*
 * XREFs of ?xxxWindowHitTestWithTargeting@@YAPEAUHWND__@@PEAUtagWND@@UtagPOINT@@PEAUtagPNTRWINDOWHITTTESTARGS@@UtagRECT@@W4tagTARGETING_PROPERTY@@@Z @ 0x1C01EF578
 * Callers:
 ...
 *     ?TouchTargetingIsSpecialTarget@@YAHPEAUtagWND@@0@Z @ 0x1C01EDD84 (-TouchTargetingIsSpecialTarget@@YAHPEAUtagWND@@0@Z.c)
...
LABEL_46:
      ...
      v31 = 0;
      if ( *(_DWORD *)(a3 + 88) || v17 )
        Prop = GetProp(v11, (unsigned __int16)gatomPtrTargetFlags, 1LL);
      else
        Prop = 4;
      if ( *(_DWORD *)(a3 + 84) )
      {
      ...
      {
        v34 = *v38;
        v25 = xxxTargetingHitTest(v11, a2, *(_QWORD *)&v10, a3, &v31, &v34, Prop, a5);
        v18 = v31;
        v23 = (HWND)v25;
      }
      if ( !v8 && v23 )
