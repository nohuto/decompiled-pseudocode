/*
 * XREFs of ?HandleRawInput@@YA?AW4RAW_INPUT_PROCESSING_RESULT@@PEAXPEAU_KEYBOARD_INPUT_DATA@@PEBURAW_INPUT_SUPPLEMENTAL_INFO@@@Z @ 0x1C00D1B74
 * Callers:
...
LABEL_2:
  ...
  if ( v9 )
  {
    if ( *(_DWORD *)(a3 + 16)
      ...
      && ((*(_DWORD *)(v10 + 1208) & 0x200000) != 0 || (v15 = *(_WORD *)(a3 + 8), v15 != 18)
                                                    && v15 != 9
                                                    && !gspwndAltTab)
