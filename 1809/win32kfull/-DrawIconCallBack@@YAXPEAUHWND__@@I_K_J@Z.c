/*
 * XREFs of ?DrawIconCallBack@@YAXPEAUHWND__@@I_K_J@Z @ 0x1C01DDCE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
          if ( *v14 != 1 )
          {
            ...
            if ( !a4 || (LOBYTE(v11) = 3, (v16 = (struct tagCURSOR *)HMValidateHandleNoRip(a4, v11)) == 0LL) )
              v16 = (struct tagCURSOR *)qword_1C030E080;
            ...
            *(_QWORD *)(ThreadWin32Thread + 416) = v21;
            ...
            xxxPaintIconsInSwitchWindow((struct tagWND *)v7, v12, 0LL, v13, v20, 1, 0, 0, v16);
