/*
 * XREFs of PlaySoundPostMessage @ 0x1C0355008
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1C00FF074 (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     I_PlaySoundkPostMessage @ 0x1C00FF10C (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C00FF160 (PlaySndClient_midl_user_allocate.c)
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C010B980 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 */
