/*
 * XREFs of NtGdiEudcLoadUnloadLink @ 0x1C027CD00
 * Callers:
 *     <none>
 * Callees:
        ...
        int a7)
{
  ...
  if ( a2 <= 0x20 && a3 && a4 - 1 <= 0x122 )
  {
    ...
    if ( v12 )
    {
      ...
      *((_WORD *)v12 + v7) = 0;
      if ( a7 )
        LinkW = GreEudcLoadLinkW((const unsigned __int16 *)Src, v14, (const unsigned __int16 *)v12, v15, a5, a6);
      else
        LinkW = GreEudcUnloadLinkW((unsigned __int16 *)Src, v14, (unsigned __int16 *)v12);
      v11 = LinkW;
      FreeTmpBuffer(v12);
    }
    return v11;
