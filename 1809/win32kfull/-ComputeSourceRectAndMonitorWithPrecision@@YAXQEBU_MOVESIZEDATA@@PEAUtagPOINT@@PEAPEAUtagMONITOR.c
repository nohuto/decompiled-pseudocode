/*
 * XREFs of ?ComputeSourceRectAndMonitorWithPrecision@@YAXQEBU_MOVESIZEDATA@@PEAUtagPOINT@@PEAPEAUtagMONITOR@@PEAUtagRECT@@@Z @ 0x1C01E46AC
 * Callers:
        ...
        struct tagRECT *a4)
{
  ...
  {
    v19 = MonitorFromPoint((unsigned __int64)*a2, 2LL, CurrentThreadDpiAwarenessContext);
...
LABEL_13:
  ...
  if ( *(_DWORD *)*gpDispInfo <= 1u || (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 40LL) + 288LL) & 0xF) == 2 )
  {
    ...
    v15 = MonitorFromPoint((unsigned __int64)*a2, 2LL, 0x12u);
