/*
 * XREFs of ?InitMapSharedSection@@YAJPEAU_EPROCESS@@PEAU_USERCONNECT@@@Z @ 0x1C00F9908
 * Callers:
...
__int64 __fastcall InitMapSharedSection(struct _EPROCESS *a1, struct _USERCONNECT *a2)
{
  ...
  {
    v15 = *(_QWORD *)(PsGetProcessWin32Process(a1) + 744);
    v8 = *(_QWORD *)(PsGetProcessWin32Process(a1) + 752);
    v14 = v8;
  }
  else
  {
