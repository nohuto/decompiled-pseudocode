/*
 * XREFs of FlushLookUpTableBucket @ 0x1C0240C24
 * Callers:
 *     LookUpTableFlushComplete @ 0x1C0355884 (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1C03561D4 (LookUpTableFlushPartial.c)
 * Callees:
 *     FlattenEventEntryTree @ 0x1C0240BDC (FlattenEventEntryTree.c)
 *     FlushEventEntryList @ 0x1C0356134 (FlushEventEntryList.c)
 */
