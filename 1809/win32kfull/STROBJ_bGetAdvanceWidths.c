/*
 * XREFs of STROBJ_bGetAdvanceWidths @ 0x1C02A0CE0
 * Callers:
 *     NtGdiSTROBJ_bGetAdvanceWidths @ 0x1C0299120 (NtGdiSTROBJ_bGetAdvanceWidths.c)
 * Callees:
 *     ?STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z @ 0x1C029F474 (-STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z.c)
 */
