/*
 * XREFs of ?AsyncWindowPos@@YAXPEAUtagSMWP@@@Z @ 0x1C010F3C0
 * Callers:
...
void __fastcall AsyncWindowPos(struct tagSMWP *a1)
{
  ...
  while ( v2 )
  {
    while ( 1 )
    {
      if ( *v1 )
      {
        v3 = (LARGE_INTEGER)v1[13];
        v4 = *(_QWORD *)(v3.QuadPart + 432);
    ...
    if ( v8 )
    {
      ...
      *(_QWORD *)(v8 + 40) = v8 + 48;
      while ( v5 )
      {
        if ( *v10 )
        {
          if ( *(_QWORD *)(v10[13] + 432LL) == *(_QWORD *)(v3.QuadPart + 432) )
          {
            --v5;
            *v11 = *(_OWORD *)v10;
            v12 = v11 + 8;
      ...
      if ( !(unsigned int)PostEventMessageEx(
                            (struct tagTHREADINFO *)v3.QuadPart,
                            *(_QWORD *)(v3.QuadPart + 432),
                            3u,
                            0LL,
                            0,
                            v8,
