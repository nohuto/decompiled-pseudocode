/*
 * XREFs of ?ulSimulateSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1C0289E70
 * Callers:
  ...
  if ( a2 )
  {
    ...
    if ( a2 == 1 )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE(a1) + 112) & 0x400) != 0 )
        (*((void (__fastcall **)(struct _SURFOBJ *, SURFOBJ *, _QWORD, _QWORD, struct _RECTL *, _DWORD *))hdev + 355))(
          a1,
          a3,
          0LL,
          0LL,
  ...
  else
  {
    ...
    if ( v12 )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE(v12) + 112) & 0x400) != 0 )
        (*((void (__fastcall **)(__int64, struct _SURFOBJ *, _QWORD, _QWORD, _DWORD *, struct _RECTL *))hdev + 355))(
          v13,
          a1,
          0LL,
          0LL,
