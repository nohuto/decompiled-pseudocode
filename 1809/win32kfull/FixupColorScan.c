/*
 * XREFs of FixupColorScan @ 0x1C0148858
 * Callers:
  ...
  else
  {
    ...
    else
    {
      ...
      *(_QWORD *)&v56[32] = v9;
      ...
      v49 = v6 - 1;
      v16 = *(_QWORD *)&v56[24];
      v44 = (unsigned __int8)*(_DWORD *)(*(_QWORD *)&v56[8] + 3LL)
          + 4
          * ((unsigned __int8)BYTE2(*(_DWORD *)(*(_QWORD *)&v56[8] + 3LL))
           + 2 * (unsigned __int8)BYTE1(*(_DWORD *)(*(_QWORD *)&v56[8] + 3LL)));
      if ( (_DWORD)v6 != 1 )
      {
        v17 = v9 + 5;
