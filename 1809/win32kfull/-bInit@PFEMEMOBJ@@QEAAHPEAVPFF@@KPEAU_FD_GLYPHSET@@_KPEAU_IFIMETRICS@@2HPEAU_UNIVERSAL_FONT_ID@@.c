/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C00CA4AC
 * Callers:
 ...
 *     IsAnyCharsetDbcs @ 0x1C00CAB7C (IsAnyCharsetDbcs.c)
        ...
        int a10)
{
  ...
  WCHAR v37[32]; // [rsp+68h] [rbp-59h] BYREF
  ...
  *(_DWORD *)(*(_QWORD *)this + 80LL) = _InterlockedIncrement(&dword_1C0319884);
  ...
  if ( v22 )
  {
    *(_DWORD *)(*(_QWORD *)this + 132LL) = 0;
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 32LL) + 40LL) )
    {
      ...
      cCapString(v37, (WCHAR *)(v19 + *v34), 32);
      if ( v23 < v24 )
      {
        v25 = v37[0];
        v26 = v23 + 195;
