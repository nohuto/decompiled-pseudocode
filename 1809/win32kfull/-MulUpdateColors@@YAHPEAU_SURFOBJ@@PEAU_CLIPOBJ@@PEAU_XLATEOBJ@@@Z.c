/*
 * XREFs of ?MulUpdateColors@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@@Z @ 0x1C0288828
 * Callers:
    ...
    do
    {
        ...
        && bIntersect(&v18, (const struct _RECTL *)((char *)v8 + 28), (struct _RECTL *)v17) )
      {
        ...
        if ( v13 )
          ...
          v14 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v9 + 2840);
