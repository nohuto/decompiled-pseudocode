/*
 * XREFs of ?vAddStartCap@WIDENER@@IEAAXXZ @ 0x1C0145084
 * Callers:
...
void __fastcall WIDENER::vAddStartCap(WIDENER *this)
{
  ...
  char v18; // [rsp+60h] [rbp+30h] BYREF
  ...
  if ( v2 )
  {
    ...
    if ( v3 )
    {
      if ( v3 != 1 )
        return;
      v4 = (unsigned __int64 *)WIDENER::vecOutPerp(this, &v16);
      v5 = 1;
      v6 = &v16;
      v16 = *v4;
    }
    else
    {
      ...
      v11 = (_DWORD *)WIDENER::vecOutPerp(this, &v18);
      v12 = v11[1];
      LODWORD(v16) = v10 + *v11;
  ...
  else
  {
    if ( (*((_DWORD *)this + 10) & 0x10) != 0 )
      ...
      v15 = (unsigned __int64 *)WIDENER::vecOutPerp(this, &v16);
    v8 = (struct _POINTFIX *)((char *)this + 692);
    v7 = (WIDENER *)((char *)this + 1136);
    v16 = *v15;
    WIDEPATHOBJ::vAddPoint(
