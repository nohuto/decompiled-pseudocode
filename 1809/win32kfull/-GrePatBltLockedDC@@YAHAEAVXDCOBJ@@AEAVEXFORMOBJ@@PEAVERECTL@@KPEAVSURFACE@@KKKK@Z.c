/*
 * XREFs of ?GrePatBltLockedDC@@YAHAEAVXDCOBJ@@AEAVEXFORMOBJ@@PEAVERECTL@@KPEAVSURFACE@@KKKK@Z @ 0x1C0055BA4
 * Callers:
        ...
        unsigned int a9)
{
  ...
  _OWORD v44[4]; // [rsp+60h] [rbp-48h] BYREF
  XDCOBJ *v45; // [rsp+B0h] [rbp+8h]
  _DWORD *v46; // [rsp+B8h] [rbp+10h]
          ...
          if ( (unsigned __int64)(v19 + v21 + 0x80000000LL) <= 0xFFFFFFFF )
          {
            ...
            *((_DWORD *)a3 + 3) = v25;
            if ( v22 < v23 && v24 < v25 )
            {
              ...
              v39 = (_DWORD *)((char *)v26 + 1776);
              v46 = (_DWORD *)((char *)v26 + 1776);
              if ( DC::prgnRao(*v11) )
                v41 = DC::prgnRao(v40);
              else
                v41 = DC::prgnVisSnap(v40);
              XCLIPOBJ::vSetup((XCLIPOBJ *)v39, v41, a3, 2);
              *(_OWORD *)a3 = *(_OWORD *)(v39 + 1);
              if ( !ERECTL::bEmpty(a3) )
              {
                v11 = (DC **)v45;
LABEL_16:
                ...
                {
                  v27 = (unsigned int *)*((_QWORD *)*v11 + 122);
                  v28 = (__int64)*v11 + 1208;
                  v16 = v27[38];
                  if ( (v16 & 1) != 0
                    || (*((_DWORD *)*v11 + 79) & 1) != 0
                    || (v38 = *((_DWORD *)*v11 + 332), (v38 & 1) != 0) && *((_DWORD *)*v11 + 314) != a6
                    || (v38 & 2) != 0 && *((_DWORD *)*v11 + 315) != a7 )
                  {
                    v29 = v27[46];
                    v30 = v27[44];
                    v31 = v27[47];
                    ...
                    *(_DWORD *)(*((_QWORD *)*v11 + 122) + 180LL) = a9;
                    EBRUSHOBJ::vInitBrush(v28, *v11, *((_QWORD *)*v11 + 17), v33, v43, a5, 1);
                    v11 = (DC **)v45;
                ...
                if ( (*((_DWORD *)*v11 + 9) & 0xE0) != 0 && (!v28 || (*(_DWORD *)(v28 + 120) & 0x100) == 0) )
                {
                  v44[0] = *(_OWORD *)a3;
                ...
                ++*((_DWORD *)a5 + 23);
                v34 = (__int64)*v11 + 1200;
                if ( (*((_DWORD *)a5 + 28) & 1) != 0 )
                  return (unsigned int)(*(__int64 (__fastcall **)(char *, _QWORD, _QWORD, _DWORD *, _QWORD, struct ERECTL *, _QWORD, _QWORD, __int64, __int64, int))(*((_QWORD *)a5 + 6) + 2832LL))(
                                         (char *)a5 + 24,
                                         0LL,
                                         0LL,
                                         v46,
