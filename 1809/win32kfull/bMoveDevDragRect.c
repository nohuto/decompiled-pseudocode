/*
 * XREFs of bMoveDevDragRect @ 0x1C02698C8
 * Callers:
...
__int64 __fastcall bMoveDevDragRect(HDEV a1, int *a2, int *a3, int a4)
{
  ...
  __int64 v31; // rbx
  void **v32; // rdi
  HDEV v34; // [rsp+88h] [rbp-49h] BYREF
  struct tagSIZE v35; // [rsp+90h] [rbp-41h] BYREF
  ...
  SPRITELOCK::SPRITELOCK((SPRITELOCK *)v37, (struct PDEVOBJ *)&v34);
  v8 = a2[3];
  v9 = a2[1];
  v10 = v34;
  v11 = *a3;
