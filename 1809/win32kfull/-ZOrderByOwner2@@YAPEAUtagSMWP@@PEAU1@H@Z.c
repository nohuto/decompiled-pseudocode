/*
 * XREFs of ?ZOrderByOwner2@@YAPEAUtagSMWP@@PEAU1@H@Z @ 0x1C000F6D0
 * Callers:
 *     ?ZOrderByOwner@@YAPEAUtagSMWP@@PEAU1@@Z @ 0x1C000F030 (-ZOrderByOwner@@YAPEAUtagSMWP@@PEAU1@@Z.c)
 * Callees:
 *     ?IsOwnee@@YAHPEAUtagWND@@0@Z @ 0x1C000F89C (-IsOwnee@@YAHPEAUtagWND@@0@Z.c)
...
struct tagSMWP *__fastcall ZOrderByOwner2(struct tagSMWP *a1, int a2)
{
  ...
  if ( (*(_DWORD *)(v4 + v2 + 32) & 0x204) != 0 )
    return v3;
  v6 = *(_QWORD *)(gpKernelHandleTable + 24LL * (unsigned __int16)*(_DWORD *)(v4 + v2));
  PWInsertAfter(*(_QWORD *)(v4 + v2 + 8));
  v7 = *(_QWORD *)(v6 + 80);
  OwnedWindow = NextOwnedWindow(0LL, v6, v7);
  v9 = 0LL;
  if ( !*(_QWORD *)(v6 + 96) && !OwnedWindow )
    return v3;
...
LABEL_16:
  ...
  while ( v23 != v14 )
  {
    v23 = (struct tagWND *)*((_QWORD *)v23 + 8);
    if ( !v23 )
      goto LABEL_16;
  }
  return v3;
