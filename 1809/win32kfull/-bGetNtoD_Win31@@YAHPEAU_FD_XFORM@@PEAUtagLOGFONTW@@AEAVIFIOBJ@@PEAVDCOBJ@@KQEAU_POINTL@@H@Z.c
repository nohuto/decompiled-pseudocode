/*
 * XREFs of ?bGetNtoD_Win31@@YAHPEAU_FD_XFORM@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@KQEAU_POINTL@@H@Z @ 0x1C0028C38
 * Callers:
 ...
 * Callees:
 *     ?bParityViolatingXform@@YAHPEAVDCOBJ@@@Z @ 0x1C0006FA0 (-bParityViolatingXform@@YAHPEAVDCOBJ@@@Z.c)
        ...
        int a7)
{
  ...
  if ( a6->x )
  {
    ...
    if ( (v12 & 0x3000010) == 0 )
    {
      ...
      if ( gbDBCSCodePage && (v12 & 0x200000) != 0 )
      {
        ...
        if ( (*(_DWORD *)(*((_QWORD *)*a4 + 122) + 340LL) & 0x40) != 0 )
  ...
  if ( result )
  {
    ...
    v56 = &v60;
    v57 = 0;
    if ( (*(_DWORD *)(*((_QWORD *)v24 + 122) + 340LL) & 0x802) == 0x802 || (a5 & 2) != 0 )
    {
      v25 = (__m128)v64[0];
      v62 = v65;
      v61 = v64[1];
    ...
    {
      if ( !EXFORMOBJ::bMultiply((EXFORMOBJ *)&v56, (struct MATRIX *)v64, (struct MATRIX *)(v24 + 80), 0) )
        return v7;
...
LABEL_57:
    ...
    if ( v44 != v42 )
    {
      ...
      v51 = *(_OWORD *)(*(_QWORD *)v55 + 336LL);
      v52 = *(_DWORD *)(*(_QWORD *)v55 + 352LL);
      v58[0] = *(_OWORD *)(*(_QWORD *)v55 + 320LL);
      v59 = v52;
      v58[1] = v51;
