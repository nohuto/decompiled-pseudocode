/*
 * XREFs of ?pxrlStrRead01@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C00F2590
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    while ( 1 )
    {
      if ( (dword_1C02D2C40[v35] & v51) != 0 )
      {
        v36 = (unsigned int)*v33;
        if ( (dword_1C02D2C40[v16] & v50) != 0 )
        {
          if ( !(_DWORD)v36 )
            goto LABEL_42;
          v37 = v54;
