/*
 * XREFs of xxxImmActivateThreadsLayout @ 0x1C01D03B0
 * Callers:
 *     xxxImmActivateThreadsLayout @ 0x1C01D03B0 (xxxImmActivateThreadsLayout.c)
 *     EditionImmActivateThreadsLayout @ 0x1C01E1F90 (EditionImmActivateThreadsLayout.c)
 * Callees:
...
__int64 __fastcall xxxImmActivateThreadsLayout(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _QWORD *v11; // r15
  __int64 v12; // rsi
  __int128 v13; // [rsp+40h] [rbp-308h]
  __int128 v14; // [rsp+70h] [rbp-2D8h] BYREF
...
LABEL_18:
  ...
  while ( v9 )
  {
    for ( i = v6 - 1; i >= 0; --i )
    {
      ...
      PopAndFreeW32ThreadLock((__int64)(v11 + 2), v7);
    }
    v9 = (_QWORD *)*v9;
    v6 = 16;
  }
