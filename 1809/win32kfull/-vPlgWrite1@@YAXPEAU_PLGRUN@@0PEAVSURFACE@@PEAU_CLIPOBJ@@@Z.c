/*
 * XREFs of ?vPlgWrite1@@YAXPEAU_PLGRUN@@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02BBBB0
 * Callers:
 *     <none>
 * Callees:
              ...
              do
              {
                ...
                if ( !v29 )
                {
                  if ( v31 )
                    *v28 = v30;
                  ++v28;
                  v29 = *((_BYTE *)&dword_1C02DEFA8 + (v24 & 7));
                  v33 = v29;
                  if ( v24 < 0
                    || v24 >= *((_DWORD *)a3 + 14)
                    || (unsigned __int64)v28 < v4
    ...
    else if ( a1 < a2 )
    {
      do
      {
        ...
        for ( j = *((_QWORD *)a3 + 10) + v10; v11; --v11 )
        {
          ...
          v17 = *((_BYTE *)&dword_1C02DEFA8 + (*(_DWORD *)a1 & 7));
              ...
              if ( !v17 )
              {
                *v16++ = v18;
                if ( (unsigned __int64)v16 < v4 || (unsigned __int64)v16 > *(_QWORD *)v35 )
                  ...
                  v18 = *v16;
                v17 = *((_BYTE *)&dword_1C02DEFA8 + (v14 & 7));
              }
            }
            while ( v15 );
            v8 = a2;
