/*
 * XREFs of NtGdiArcInternal @ 0x1C0294C80
 * Callers:
 *     <none>
 * Callees:
        ...
        int a10)
{
  ...
  _BYTE v44[32]; // [rsp+90h] [rbp-78h] BYREF
  ...
  PATHOBJ v52[10]; // [rsp+118h] [rbp+10h] BYREF
  _BYTE v53[32]; // [rsp+168h] [rbp+60h] BYREF
...
LABEL_44:
  ...
  v14 = 1;
  PATHSTACKOBJ::PATHSTACKOBJ((PATHSTACKOBJ *)v52, (DC **)v43, a1 == 1);
  if ( !*(_QWORD *)&v52[1] )
  {
    EngSetLastError(8u);
LABEL_10:
  ...
  EBOX::EBOX((EBOX *)v46, (struct DCOBJ *)v43, &v38, (struct _LINEATTRS *)&v43[0][26], 1);
  if ( v46[1] )
    goto LABEL_10;
  if ( !v46[0] )
  {
    LODWORD(v15) = efHalfDiff(v49, -v51);
    LODWORD(v20) = efHalfDiff(v48, -v50);
    if ( v16 == v19 || v18 == v17 )
    {
      v28 = 0;
      v27 = 0.0;
    ...
    {
      vCosSinPrecise((unsigned int)_mm_cvtsi128_si32(v26), (float *)&v41);
      vCosSinPrecise((unsigned int)_mm_cvtsi128_si32(v25), (float *)&v38.left);
    }
    ...
    if ( a1 == 1 )
    {
      ...
      *(_DWORD *)(*(_QWORD *)&v43[0][122] + 152LL) &= ~0x200u;
      Current = (_QWORD *)EPATHOBJ::ptfxGetCurrent((EPATHOBJ *)v52, &v38);
    ...
    else
    {
      if ( a1 != 2 )
      {
        if ( a1 != 3 )
          goto LABEL_37;
        if ( !EPATHOBJ::bPolyLineTo((EPATHOBJ *)v52, 0LL, &v47, 1u) )
          goto LABEL_10;
      }
      if ( !EPATHOBJ::bCloseFigure((EPATHOBJ *)v52) )
        goto LABEL_10;
    }
LABEL_37:
    if ( (v43[0][31].x & 1) == 0 )
    {
      if ( a1 <= 1 )
        v34 = EPATHOBJ::bStrokeAndOrFill(v52, v43, (LINEATTRS *)&v43[0][26], &v45, 1u);
      else
        v34 = EPATHOBJ::bStrokeAndOrFill(v52, v43, (LINEATTRS *)&v43[0][26], &v45, 3u);
      v14 = v34;
    }
  }
LABEL_11:
...
LABEL_45:
  ...
  UnexpectedThreadTerminationHandler<DWMSPRITEREF>::~UnexpectedThreadTerminationHandler<DWMSPRITEREF>((__int64)v44);
  return v14;
}
