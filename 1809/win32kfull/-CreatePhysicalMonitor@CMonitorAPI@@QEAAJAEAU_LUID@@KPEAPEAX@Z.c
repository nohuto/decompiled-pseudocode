/*
 * XREFs of ?CreatePhysicalMonitor@CMonitorAPI@@QEAAJAEAU_LUID@@KPEAPEAX@Z @ 0x1C0254CE4
 * Callers:
 *     CreatePhysicalMonitorWrap @ 0x1C0256180 (CreatePhysicalMonitorWrap.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C01632C0 (_guard_dispatch_icall_nop.c)
 *     ??0CPhysicalMonitorHandle@@QEAA@AEAU_LUID@@KPEAJ@Z @ 0x1C02549F4 (--0CPhysicalMonitorHandle@@QEAA@AEAU_LUID@@KPEAJ@Z.c)
...
__int64 __fastcall CMonitorAPI::CreatePhysicalMonitor(CMonitorAPI *this, struct _LUID *a2, unsigned int a3, void **a4)
{
  ...
  v14 = this;
  v4 = qword_1C0317778;
  OPM::CAutoMutex::CAutoMutex((OPM::CAutoMutex *)v13, (struct OPM::CMutex *)qword_1C0317778);
  v12 = 0LL;
  LODWORD(v14) = 0;
