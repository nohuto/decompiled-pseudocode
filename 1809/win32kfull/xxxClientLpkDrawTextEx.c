/*
 * XREFs of xxxClientLpkDrawTextEx @ 0x1C0207A40
 * Callers:
        ...
        int a10)
{
  ...
  ULONG_PTR v23; // r15
  PVOID *v24; // rdx
  char v25; // [rsp+60h] [rbp-358h] BYREF
  _BYTE v26[3]; // [rsp+61h] [rbp-357h] BYREF
  int v27; // [rsp+64h] [rbp-354h] BYREF
  HSURF v28; // [rsp+68h] [rbp-350h] BYREF
  struct _UNICODE_STRING DestinationString; // [rsp+70h] [rbp-348h] BYREF
  _QWORD v30[4]; // [rsp+80h] [rbp-338h] BYREF
  ULONG_PTR RegionSize[3]; // [rsp+A0h] [rbp-318h] BYREF
  _QWORD v32[3]; // [rsp+B8h] [rbp-300h] BYREF
  unsigned __int8 v33[176]; // [rsp+D0h] [rbp-2E8h] BYREF
  unsigned __int8 v34[512]; // [rsp+180h] [rbp-238h] BYREF

  v30[3] = a1;
  v28 = 0LL;
  RtlInitUnicodeString(&DestinationString, a4);
  v13 = CreateCompatiblePublicDC(a1, &v28);
  v30[2] = v13;
  if ( !v13 )
    return 0LL;
  ...
  v17 = AllocCallbackMessage(168, 1u, MaximumLength, v34, 1, 0x200uLL);
  v30[1] = v17;
  if ( !v17 )
  {
    if ( v13 != a1 )
  ...
  if ( v17 != v33 && v17 != v34 )
    PushW32ThreadLock((__int64)v17, v32, (__int64)Win32FreePool);
  *((_QWORD *)v17 + 7) = v13;
  *((_DWORD *)v17 + 16) = a2;
  *((_DWORD *)v17 + 17) = a3;
  *((_DWORD *)v17 + 18) = a5;
  ...
  *((_WORD *)v17 + 21) = DestinationString.MaximumLength;
  ...
  ReleaseAndReacquirePerObjectLocks::ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)v26, v18);
  ...
  *((_QWORD *)v17 + 2) = 0LL;
  v20 = KeUserModeCallback(79LL, v17, *(unsigned int *)v17, v30, &v27);
  EtwTraceEndCallback(79LL);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v25);
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)v26, v21);
  GreRestoreDC(a1, v19);
  if ( v13 != a1 )
  {
    if ( v20 < 0 )
...
LABEL_25:
  ...
  if ( v17 != v33 && v17 != v34 )
  {
    ...
    PopAndFreeAlwaysW32ThreadLock((__int64)v32, (__int64)v24);
  }
