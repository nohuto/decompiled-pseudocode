/*
 * XREFs of ?ParseFontLinkEntry@@YA_NPEAGPEAUFontLinkData@@@Z @ 0x1C007D760
 * Callers:
 *     bAddFlEntry @ 0x1C0080280 (bAddFlEntry.c)
 *     bDeleteFlEntry @ 0x1C027C558 (bDeleteFlEntry.c)
 * Callees:
 *     ?ParseFontScaleFactor@@YA_NPEBGPEAJ@Z @ 0x1C011D0FC (-ParseFontScaleFactor@@YA_NPEBGPEAJ@Z.c)
 */
