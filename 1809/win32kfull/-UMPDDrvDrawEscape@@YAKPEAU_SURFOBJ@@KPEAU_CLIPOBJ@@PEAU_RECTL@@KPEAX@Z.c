/*
 * XREFs of ?UMPDDrvDrawEscape@@YAKPEAU_SURFOBJ@@KPEAU_CLIPOBJ@@PEAU_RECTL@@KPEAX@Z @ 0x1C028CF40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
      ...
      {
        if ( (unsigned int)UMPDOBJ::pso(v10, (UMPDOBJ *)((char *)v10 + 64), (EVENT_DATA_DESCRIPTOR **)&v26[3], v9) )
        {
