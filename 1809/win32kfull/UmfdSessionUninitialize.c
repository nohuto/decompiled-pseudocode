/*
 * XREFs of UmfdSessionUninitialize @ 0x1C0132640
 * Callers:
 *     <none>
 * Callees:
 *     ?Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z @ 0x1C012DFF4 (-Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z.c)
 *     ?SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ @ 0x1C01326EC (-SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ.c)
