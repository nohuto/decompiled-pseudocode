/*
 * XREFs of ?xxxbEnumerateRegistryFonts@@YAHKIPEBG0@Z @ 0x1C00C30E0
 * Callers:
        ...
        const unsigned __int16 *a4)
{
  ...
  _WORD v18[4]; // [rsp+30h] [rbp-49h] BYREF
  unsigned int *v19; // [rsp+38h] [rbp-41h]
  _QWORD v20[3]; // [rsp+40h] [rbp-39h] BYREF
  ...
  if ( (_DWORD)a2 == 56 )
  {
    ProfileUserName = CreateProfileUserName(v21, a2, a3, a4);
    if ( !ProfileUserName )
      return 0LL;
  }
  v8 = (void *)OpenCacheKeyEx(ProfileUserName, v4, 131097LL);
  if ( ProfileUserName )
  ...
  if ( !v10 )
    return v9;
  PushW32ThreadLock(v10, v20, (__int64)Win32FreePool);
  for ( i = 0; ; ++i )
  {
    ...
    if ( v16 )
    {
      ThreadLockExchange(v16, v20);
      Win32FreePool(v11);
      v7 = ResultLength;
      v11 = v17;
      v13 = ZwEnumerateKey(v8, i, KeyBasicInformation, v17, ResultLength - 2, &ResultLength);
      if ( v13 != -2147483643 && v13 != -1073741789 )
        break;
    }
LABEL_20:
