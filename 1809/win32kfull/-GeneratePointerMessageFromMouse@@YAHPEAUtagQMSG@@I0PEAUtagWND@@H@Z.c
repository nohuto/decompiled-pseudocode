/*
 * XREFs of ?GeneratePointerMessageFromMouse@@YAHPEAUtagQMSG@@I0PEAUtagWND@@H@Z @ 0x1C01CD5A8
 * Callers:
 *     ?xxxScanSysQueue@@YA?AW4_SCANSYSQUEUERESULT@@PEAUtagTHREADINFO@@PEAUtagMSG@@PEAUtagWND@@IIKKPEAPEAUtagQMSG@@@Z @ 0x1C0034C00 (-xxxScanSysQueue@@YA-AW4_SCANSYSQUEUERESULT@@PEAUtagTHREADINFO@@PEAUtagMSG@@PEAUtagWND@@IIKKPEAP.c)
 * Callees:
 *     ?IsMiPMouseMessage@@YAHI@Z @ 0x1C00D46D4 (-IsMiPMouseMessage@@YAHI@Z.c)
 *     memset @ 0x1C0163640 (memset.c)
 *     ?GetPointerFlagsFromMouse@@YAKPEAII_KPEAKPEAW4tagPOINTER_BUTTON_CHANGE_TYPE@@@Z @ 0x1C01CD8D4 (-GetPointerFlagsFromMouse@@YAKPEAII_KPEAKPEAW4tagPOINTER_BUTTON_CHANGE_TYPE@@@Z.c)
        ...
        int a5)
{
  ...
  v9 = *(_DWORD **)(gptiCurrent + 1256LL);
  if ( !v9 )
  {
    v9 = (_DWORD *)Win32AllocPoolZInit(128LL, 1347253077LL);
    if ( !v9 )
      goto LABEL_29;
    *(_QWORD *)(gptiCurrent + 1256LL) = v9;
  }
  if ( a5 && (*v9 & 0x10) != 0 )
  {
    *v9 &= ~0x10u;
    **(_DWORD **)(gptiCurrent + 1256LL) &= ~4u;
  }
  if ( IsMiPMouseMessage(*((_DWORD *)a3 + 6)) )
  {
    ...
    *((_QWORD *)a1 + 1) = 0LL;
    *(_QWORD *)a1 = 0LL;
    DWORD2(v27[0]) = GetNextFrameId();
    *(_QWORD *)&v27[1] = ghMouseDevice;
    ...
    *(_QWORD *)&v27[5] = *((_QWORD *)a3 + 16);
    ...
    if ( HIDWORD(v27[0]) )
    {
      if ( (**(_DWORD **)(gptiCurrent + 1256LL) & 4) == 0 )
      {
        v13 = HIDWORD(v27[0]) | 0x2000;
      ...
      v14 = MiPConvertPoint((const struct tagPOINT *)&v27[2]);
      *(_QWORD *)&v27[3] = *(_QWORD *)&v27[2];
      *((struct tagPOINT *)&v27[2] + 1) = v14;
      *((struct tagPOINT *)&v27[3] + 1) = v14;
      *((_QWORD *)a1 + 13) = gptiCurrent;
      if ( (v13 & 0x180000) != 0 )
      {
        v15 = *((unsigned __int16 *)a3 + 17);
        DWORD2(v27[4]) = (__int16)v15;
        v16 = v15 << 16;
      }
      else
      {
        v16 = (unsigned __int16)(WORD6(v27[0]) & 0xE1F7) << 16;
      }
      *((_QWORD *)a1 + 4) = v16 | 1;
      v17 = *(_QWORD *)(gptiCurrent + 1256LL);
      v18 = v27[1];
      *(_OWORD *)(v17 + 24) = v27[0];
      v19 = v27[2];
      *(_OWORD *)(v17 + 40) = v18;
      ...
      *(_OWORD *)(v17 + 88) = v21;
      *(_OWORD *)(v17 + 104) = v22;
      **(_DWORD **)(gptiCurrent + 1256LL) |= 1u;
      if ( a5 )
      {
        if ( ((*v11 - 579) & 0xFFFFFFFB) == 0 )
        {
          v23 = *(_DWORD **)(gptiCurrent + 1256LL);
          if ( (*v23 & 4) != 0 )
          {
            *v23 |= 0x10u;
            **(_DWORD **)(gptiCurrent + 1256LL) &= ~2u;
          }
        }
      }
      v24 = *v11;
      if ( *v11 < 0x241 || v24 > 0x242 && v24 - 581 > 1 )
      {
        StopMiPIdleNotificationTimer(a4);
      }
      else
      {
        *(_QWORD *)(*(_QWORD *)(gptiCurrent + 1256LL) + 120LL) = *((_QWORD *)a1 + 5);
