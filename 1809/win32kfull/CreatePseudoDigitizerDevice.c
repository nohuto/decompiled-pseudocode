/*
 * XREFs of CreatePseudoDigitizerDevice @ 0x1C01CC5A8
 * Callers:
 *     _InitializeTouchInjectionWorker @ 0x1C01CB810 (_InitializeTouchInjectionWorker.c)
 * Callees:
 *     __security_check_cookie @ 0x1C015AF60 (__security_check_cookie.c)
 *     memset @ 0x1C0163640 (memset.c)
 *     ?_UpdateReportDescriptor@@YAXUtagRECT@@KK@Z @ 0x1C01CC4A0 (-_UpdateReportDescriptor@@YAXUtagRECT@@KK@Z.c)
 */
...
struct DEVICEINFO *__fastcall CreatePseudoDigitizerDevice(int a1, int a2, __int64 a3)
{
  ...
  {
    v8 = _mm_srli_si128(*(__m128i *)RIMGetVirtualDesktopPhysicalSize(&v13[1]), 8).m128i_u64[0];
    *(_OWORD *)&v13[1] = *(_OWORD *)(*gpDispInfo + 24LL);
    v9 = *(_OWORD *)&v13[1];
    _UpdateReportDescriptor(
      (struct tagRECT *)&v13[1],
      3937 * ((int)v8 / 1000) / 0x64u,
      3937 * (SHIDWORD(v8) / 1000) / 0x64u);
    memset(v15, 0, sizeof(v15));
    LODWORD(v15[1]) = 498;
    v15[0] = &unk_1C0310950;
    v15[10] = 0LL;
    *(_OWORD *)((char *)&v15[11] + 4) = v9;
    LODWORD(v15[11]) = a1;
    ...
    *(_QWORD *)((char *)&v15[14] + 4) = *(_QWORD *)(PsGetCurrentProcessWin32Process(v10) + 880);
    ...
    v11 = *v7;
    LODWORD(v15[16]) = a2;
    if ( (int)RIMAddInjectionDeviceOfType(v11, &DestinationString, 2LL, v15, 0, a3 + 96) < 0 )
    {
      ZwClose(*v7);
      *v7 = 0LL;
      *(_QWORD *)(a3 + 96) = 0LL;
