/*
 * XREFs of ?UMPDDrvCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C01525E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
    ...
    v32[4] = v13;
    v32[6] = a4;
    if ( (unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 64), (EVENT_DATA_DESCRIPTOR **)&v32[3], v9) )
    {
      if ( (unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 80), (EVENT_DATA_DESCRIPTOR **)&v32[4], v10) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v12, (UMPDOBJ *)((char *)v12 + 112), (const void **)&v32[5], 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::pxlo(v12, (struct _XLATEOBJ **)&v32[6]) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v12, (const void **)&v32[7], 0x10u) )
            {
              if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v12, (const void **)&v32[8], 8u) )
              {
                LODWORD(Size) = 4;
                if ( (unsigned int)UMPDOBJ::Thunk(v12, v32, 0x48u, &v18, Size) != -1 )
                {
                  if ( v18 )
                    v6 = 1;
                }
  ...
  if ( *((_DWORD *)v12 + 106) )
    UMPDOBJ::RestoreBitmaps(v12, a1, v13, 0LL, v27, v26, v25, v24, 0LL, 0LL, v22, v9, v21, v10, 0, 0);
LABEL_20:
