/*
 * XREFs of ?xxxCopyAckIn@@YAKPEAKPEA_JPEAUtagDDECONV@@PEAPEAUtagINTDDEINFO@@@Z @ 0x1C01F3F4C
 * Callers:
 ...
 *     ?RemovePublicObject@@YAHIPEAX@Z @ 0x1C01F3860 (-RemovePublicObject@@YAHIPEAX@Z.c)
