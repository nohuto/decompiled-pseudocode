/*
 * XREFs of ?AdjustLegacyDeviceFlags@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C01030EC
 * Callers:
  ...
  if ( v5 )
  {
    ...
    *(_DWORD *)(v1 + 100) = v8;
    ...
    if ( gpqForeground )
    {
      ...
      if ( v10 && (unsigned int)HasHidTable(v10) && *(_QWORD *)(*(_QWORD *)(v10 + 424) + 832LL) == v1 )
  ...
  else
  {
    ...
    *(_DWORD *)(v1 + 100) = v12 & 0xFFFFFFF3;
    if ( gpqForeground )
    {
      ...
      if ( v14 && (unsigned int)HasHidTable(v14) && *(_QWORD *)(*(_QWORD *)(v14 + 424) + 832LL) == v1 )
        UpdateRawMouseMode(gpqForeground);
    }
