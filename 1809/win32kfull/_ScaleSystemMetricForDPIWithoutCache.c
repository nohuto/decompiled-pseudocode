/*
 * XREFs of _ScaleSystemMetricForDPIWithoutCache @ 0x1C01B8D20
 * Callers:
...
LABEL_29:
              DpiDependentMetric = GetDpiDependentMetric(a1, 96LL, a3);
              ...
              if ( v5 > 19 )
              {
                ...
                if ( v25 )
                {
                  ...
                  if ( !v26 )
                  {
                    if ( v8 > *(_DWORD *)(GetDPIMETRICSForDpi(v4) + 44) + 2 )
                      return (unsigned int)v8;
                    v24 = *(_DWORD *)(GetDPIMETRICSForDpi(v4) + 44);
                  ...
                  if ( v27 )
                  {
                    ...
                    else if ( v8 <= *(_DWORD *)(GetDPIMETRICSForDpi(v4) + 28) )
                    {
                      return *(unsigned int *)(GetDPIMETRICSForDpi(v4) + 28);
                    }
                    return (unsigned int)v8;
                  }
                }
