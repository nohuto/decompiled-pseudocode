/*
 * XREFs of ?ValidatePointer@InkDevice@@AEBAJI@Z @ 0x1C0239D90
 * Callers:
...
__int64 __fastcall InkDevice::ValidatePointer(InkDevice *this, unsigned int a2, const struct tagPOINTER_INFO **a3)
{
  ...
  *(_QWORD *)v15 = 0LL;
  ...
  {
    LOBYTE(v5) = 19;
    v7 = *(_QWORD *)(HMValidateHandleNoSecure(*(_QWORD *)(*(_QWORD *)v15 + 16LL), v5) + 480);
    v8 = *(_DWORD *)(v7 + 24);
    if ( v8 == 5 )
    {
      v9 = *(_QWORD *)(v7 + 16);
      ...
      if ( v10 == 0x80000000 || v10 == 11 || v10 == 13 )
      {
          ...
          && *(unsigned __int16 *)(v11 + 110) == *((_DWORD *)this + 33) )
        {
          ...
          if ( v12 && *v12 )
          {
            if ( !byte_1C031DD64 )
            {
              if ( dword_1C030C390 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C030C390, 0x400000000000uLL) )
                TlgWrite((TraceLoggingHProvider)&dword_1C030C390, &unk_1C02D6833, 0LL, 0LL, 2u, &pData);
              byte_1C031DD64 = 1;
            }
            v6 = -1073741811;
