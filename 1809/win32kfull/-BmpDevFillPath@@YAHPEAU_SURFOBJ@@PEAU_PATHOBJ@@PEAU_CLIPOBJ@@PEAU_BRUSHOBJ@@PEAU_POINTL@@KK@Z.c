/*
 * XREFs of ?BmpDevFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C027D980
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( HDEV )
    {
      if ( (*(_DWORD *)(HDEV + 40) & 0x20000000) != 0 )
      {
        for ( i = **(_QWORD ***)(HDEV + 1800); i; i = (_QWORD *)*i )
        {
          ...
          if ( v14 )
          {
            if ( (*(_DWORD *)(v14 + 1824) & 0x8000000) != 0 )
            {
              v15 = *(_DWORD *)(v14 + 2128);
              if ( (v15 & 0x1000) != 0 && (v15 & 0x8000) != 0 )
              {
                if ( *(_QWORD *)(*(_QWORD *)(v14 + 1792) + 184LL) )
                {
                  MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                    (MARK_ACCDRV_NOTIFICATION *)&v19,
                    (struct PDEVOBJ *)&v18,
                    a1);
                  (*(void (__fastcall **)(struct _SURFOBJ *, PATHOBJ *, CLIPOBJ *, BRUSHOBJ *, POINTL *, MIX, FLONG))(*(_QWORD *)(v16 + 1792) + 184LL))(
                    a1,
                    ppo,
                    pco,
                    pbo,
