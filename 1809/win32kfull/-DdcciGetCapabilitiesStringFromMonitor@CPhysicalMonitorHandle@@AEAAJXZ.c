/*
 * XREFs of ?DdcciGetCapabilitiesStringFromMonitor@CPhysicalMonitorHandle@@AEAAJXZ @ 0x1C0254F94
 * Callers:
 *     ?DdcciGetCapabilitiesStringInternal@CPhysicalMonitorHandle@@AEAAJXZ @ 0x1C0255444 (-DdcciGetCapabilitiesStringInternal@CPhysicalMonitorHandle@@AEAAJXZ.c)
 * Callees:
 ...
 *     ?DdcciSendDataToMonitorDevice@CPhysicalMonitorHandle@@AEAAJ_JPEAXK@Z @ 0x1C02559B4 (-DdcciSendDataToMonitorDevice@CPhysicalMonitorHandle@@AEAAJ_JPEAXK@Z.c)
 *     ?IsDDCCICapabilitiesStringInitialized@CPhysicalMonitorHandle@@AEBAEXZ @ 0x1C025601C (-IsDDCCICapabilitiesStringInitialized@CPhysicalMonitorHandle@@AEBAEXZ.c)
 *     ?RtlStringCbCopyA@@YAJPEAD_KPEBD@Z @ 0x1C0256034 (-RtlStringCbCopyA@@YAJPEAD_KPEBD@Z.c)
 */
    ...
    *(_DWORD *)v18 = 15958865;
    ...
    if ( v5 )
    {
      if ( v3 > v5 )
      {
        v13 = v5 + 1;
        v2[v13 - 1] = 0;
        OPM::CAutoMutex::CAutoMutex((OPM::CAutoMutex *)&v17, (CPhysicalMonitorHandle *)((char *)this + 72));
        ...
        OPM::CAutoMutex::~CAutoMutex((OPM::CAutoMutex *)&v17);
      }
      else
      {
        v6 = -1071774328;
