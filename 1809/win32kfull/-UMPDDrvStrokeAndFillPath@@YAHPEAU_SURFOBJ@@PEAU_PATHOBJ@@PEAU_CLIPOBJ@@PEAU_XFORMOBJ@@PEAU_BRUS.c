/*
 * XREFs of ?UMPDDrvStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C028F700
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  if ( v25 )
  {
          ...
          (v21 = v16) != 0) )
    {
      ...
      v31[4] = a2;
      v31[9] = a6;
      if ( !(unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 64), (EVENT_DATA_DESCRIPTOR **)&v31[3], v13) )
        goto LABEL_18;
