/*
 * XREFs of ?BasicTargetingHitTest@@YAHPEAUtagWND@@PEAUtagTOUCHTARGETINGCONTACT@@UtagPOINT@@PEAGPEAU3@HPEAUtagRECT@@W4tagTARGETING_PROPERTY@@HKH@Z @ 0x1C01ECD8C
 * Callers:
...
LABEL_12:
    ...
    v32 = v33;
    v31 = v33;
    v19 = TouchTargetingRankForRect(&v31, &v32, a2, a7, a5, v16);
    *a4 = v19;
    if ( v19 > 0xFFDu )
      return 0LL;
    v18 = 0LL;
  }
  v20 = *(_QWORD *)(*(_QWORD *)(a1 + 40) + 168LL);
  if ( !v20 && (!a6 || *(_QWORD *)(a1 + 152) == v18) )
    goto LABEL_27;
  if ( v15 )
    goto LABEL_36;
  if ( !v20 )
...
LABEL_36:
    ...
    v23 = *(_QWORD *)(v21 + 168);
    v31 = *(_OWORD *)(v21 + 88);
    v24 = TouchTargetingRankForRegion(v23, (unsigned int)&v31, a2, a5, v28);
    v25 = a4;
    *a4 = v24;
    if ( v24 > 0xFFDu )
      return 0LL;
