/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C00551FC
 * Callers:
 *     GreFlush @ 0x1C00551E0 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C0282390 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
