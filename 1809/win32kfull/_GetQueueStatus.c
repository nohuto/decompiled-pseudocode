/*
 * XREFs of _GetQueueStatus @ 0x1C00E9280
 * Callers:
 *     NtUserGetThreadState @ 0x1C00F8390 (NtUserGetThreadState.c)
 * Callees:
...
__int64 __fastcall GetQueueStatus(__int64 a1, __int64 a2)
{
  ...
  if ( v4 + 49 == (_QWORD *)gDomainDummyLock )
  ...
  tagObjLock::LockExclusive((tagObjLock *)(v4 + 49));
  if ( v4[180] && (v3 & 8) != 0 )
