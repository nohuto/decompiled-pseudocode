/*
 * XREFs of ?IsOrientationWithinPreferences@CLegacyRotationMgr@@AEAAHK@Z @ 0x1C01C0FD8
 * Callers:
    ...
    if ( a2 )
    {
      ...
      if ( v6 )
      {
        ...
        if ( v7 )
        {
          if ( v7 != 1 )
            return v3;
          v8 = dword_1C0312E58 != 0 ? 1 : 8;
        }
        else
        {
          v8 = dword_1C0312E58 != 0 ? 8 : 4;
        }
      }
      else
      {
        v8 = dword_1C0312E58 != 0 ? 4 : 2;
      }
    }
    else
    {
      v8 = (dword_1C0312E58 != 0) + 1;
    }
