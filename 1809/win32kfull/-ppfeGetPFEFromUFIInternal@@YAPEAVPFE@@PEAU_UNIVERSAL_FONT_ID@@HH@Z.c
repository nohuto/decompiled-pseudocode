/*
 * XREFs of ?ppfeGetPFEFromUFIInternal@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z @ 0x1C007F8C8
 * Callers:
 ...
 * Callees:
 *     ?SameProccess@PFEOBJ@@QEAAHXZ @ 0x1C007F9C4 (-SameProccess@PFEOBJ@@QEAAHXZ.c)
