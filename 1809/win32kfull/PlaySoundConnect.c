/*
 * XREFs of PlaySoundConnect @ 0x1C035535C
 * Callers:
 *     ?Connect@CUserPlaySound@@AEAAJPEAX@Z @ 0x1C012CFDC (-Connect@CUserPlaySound@@AEAAJPEAX@Z.c)
 * Callees:
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C012C418 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
...
__int64 __fastcall PlaySoundConnect(unsigned int a1, __int64 a2, RPC_BINDING_HANDLE *a3)
{
              ...
              0LL) >= 0 )
  {
    ...
    if ( !v4 )
      v4 = RpcBindingBind(0LL, *a3, &unk_1C02C3330);
    if ( v4 && *a3 )
    {
      RpcBindingFree(a3);
      *a3 = 0LL;
