/*
 * XREFs of ?SpDdNotifyFullscreenSpriteUpdate@@YAJPEAUHDC__@@PEAX@Z @ 0x1C025246C
 * Callers:
 *     NtGdiDdNotifyFullscreenSpriteUpdate @ 0x1C025BE80 (NtGdiDdNotifyFullscreenSpriteUpdate.c)
 * Callees:
