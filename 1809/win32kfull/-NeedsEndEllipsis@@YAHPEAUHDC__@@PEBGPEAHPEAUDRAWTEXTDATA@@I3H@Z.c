/*
 * XREFs of ?NeedsEndEllipsis@@YAHPEAUHDC__@@PEBGPEAHPEAUDRAWTEXTDATA@@I3H@Z @ 0x1C0242220
 * Callers:
 ...
 *     ?DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z @ 0x1C0241BE4 (-DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z.c)
        ...
        struct DRAWTEXTDATA *a6)
{
  ...
  if ( v13 > 0 )
  {
    ...
    if ( v6 > 0 )
    {
      do
      {
        ExtentMinusPrefixes = DT_GetExtentMinusPrefixes(a1, a2, (v7 + v14 + 1) / 2, a5, v18, a6, -1);
