/*
 * XREFs of CalcForegroundInsertAfter @ 0x1C000FD34
 * Callers:
 ...
 * Callees:
 *     ?GetLastNonBottomMostWindow@@YAPEAUtagWND@@PEAU1@H@Z @ 0x1C000FCA8 (-GetLastNonBottomMostWindow@@YAPEAUtagWND@@PEAU1@H@Z.c)
...
struct tagWND *__fastcall CalcForegroundInsertAfter(__int64 a1)
{
    ...
    && (*(_DWORD *)(*(_QWORD *)(v5 + 424) + 12LL) & 0x80100) == 0 )
  {
    if ( gpqForeground )
    {
      ...
      {
        v8 = LastNonBottomMostWindow ? LastNonBottomMostWindow : *(struct tagWND **)(*(_QWORD *)(a1 + 80) + 88LL);
...
LABEL_22:
          ...
          if ( !LastNonBottomMostWindow )
            v9 = *(struct tagWND **)(*(_QWORD *)(a1 + 80) + 88LL);
