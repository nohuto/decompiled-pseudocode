/*
 * XREFs of ?TraceLoggingRimHidDeviceRemovedEvent@@YAXGIIKKHPEAU_UNICODE_STRING@@0HHIIIKK@Z @ 0x1C01BAB4C
 * Callers:
        ...
        char a15)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v49 = 4LL;
      v51 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02D392B, 0LL, 0LL, 0x13u, &pData);
    }
  }
}
