/*
 * XREFs of _DrainThreadCoreMessagingCompletions @ 0x1C00260B0
 * Callers:
...
__int64 __fastcall DrainThreadCoreMessagingCompletions(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(v4 + 1440) )
  {
    ...
    v23 = 0LL;
    v16 = 0;
    ZwSetIoCompletionEx(v14[175], v14[179], 0LL, 2LL, 0, 0LL);
    while ( 1 )
    {
      LOBYTE(v19) = 0;
      if ( (unsigned int)ZwRemoveIoCompletionEx(v14[175], v20, 1LL, &v22, &v23, v19) )
        break;
      if ( v21 == 1 )
      {
        v16 = 1;
    ...
    if ( v16 )
      ZwAssociateWaitCompletionPacket(v14[178], v14[175], v14[177], 0LL, 1LL, 0, 0LL, 0LL);
    v3 = 1;
  }
  else
  {
