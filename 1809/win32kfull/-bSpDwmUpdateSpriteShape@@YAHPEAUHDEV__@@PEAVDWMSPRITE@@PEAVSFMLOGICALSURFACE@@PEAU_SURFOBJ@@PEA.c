/*
 * XREFs of ?bSpDwmUpdateSpriteShape@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAU_SURFOBJ@@PEAU_RECTL@@PEAVPALETTE@@PEAK4PEAPEAV3@@Z @ 0x1C007CF18
 * Callers:
        ...
        if ( right <= a4->sizlBitmap.cx )
        {
          ...
          if ( bottom <= a4->sizlBitmap.cy && top <= bottom && left <= right )
          {
            ...
            *(_QWORD *)&v36.left = 0LL;
            if ( a8 )
            {
              ERECTL::operator*=(&v36.left, &a8->left);
              v30 = v36.left + v20;
              v31 = v36.top + v21;
            }
...
LABEL_27:
            ...
            if ( v13 )
            {
              ...
              else
              {
                ...
                if ( !v25 )
                  goto LABEL_25;
                vSpUpdateDirtyRgn(this, v18, 0LL, (struct _RECTL *)&v36, a7, 0);
              }
              if ( v13 )
                vSpUpdateDirtyRgn(this, v18, 0LL, (struct _RECTL *)&v36, a7, 0);
            }
