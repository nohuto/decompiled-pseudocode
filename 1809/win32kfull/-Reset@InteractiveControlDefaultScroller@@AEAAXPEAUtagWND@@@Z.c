/*
 * XREFs of ?Reset@InteractiveControlDefaultScroller@@AEAAXPEAUtagWND@@@Z @ 0x1C023D168
 * Callers:
...
void __fastcall InteractiveControlDefaultScroller::Reset(InteractiveControlDefaultScroller *this, struct tagWND *a2)
{
  ...
  dword_1C031DE48 = 0;
  dword_1C031DE38 = v4;
  dword_1C031DE34 = *((_DWORD *)InteractiveControlManager::Instance() + 59);
  dword_1C031DE3C = *((_DWORD *)InteractiveControlManager::Instance() + 61);
  dword_1C031DE44 = *((_DWORD *)InteractiveControlManager::Instance() + 63);
  dword_1C031DE4C = *((_DWORD *)InteractiveControlManager::Instance() + 65);
