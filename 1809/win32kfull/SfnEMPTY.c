...
__int64 __fastcall SfnEMPTY(volatile signed __int32 *a1, int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  *(_QWORD *)(*(_QWORD *)(v11 + 480) + 80LL) = v16;
  ...
  v17 = KeUserModeCallback(117LL, v27, 48LL, &v32, &v31);
