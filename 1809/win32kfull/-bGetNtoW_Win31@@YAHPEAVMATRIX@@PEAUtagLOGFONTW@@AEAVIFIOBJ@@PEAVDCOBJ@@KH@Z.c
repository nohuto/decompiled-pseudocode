/*
 * XREFs of ?bGetNtoW_Win31@@YAHPEAVMATRIX@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@KH@Z @ 0x1C002BEEC
 * Callers:
 ...
 *     ?bIs1@EFLOAT@@QEBAHXZ @ 0x1C0137D78 (-bIs1@EFLOAT@@QEBAHXZ.c)
        ...
        int a6)
{
  ...
  v84 = a2;
  v10 = 1;
  if ( *(float *)(v6 + 452) == 0.0 || (IsZero = EFLOAT::bIsZero((EFLOAT *)(v6 + 456)), v12 = v10, IsZero) )
    v12 = 0;
  v80 = v12;
  if ( (a5 & 2) != 0 || !v12 && (*(_DWORD *)(*(_QWORD *)(v6 + 976) + 340LL) & 0x1000) != 0 )
    v13 = 0;
  else
    v13 = v10;
  ...
  *((float *)a1 + 3) = v20;
  ...
  else
  {
    ...
    if ( (v26 & 2) == 0 )
    {
      v27 = (float)v25[84];
      v28 = (float)v25[80];
      v23 = (float)v25[83] / (float)v25[79];
      v74 = v23;
      v24 = v27 / v28;
      v76 = v27 / v28;
      goto LABEL_37;
    }
    v23 = *(float *)(v22 + 320) * 0.0625;
    v24 = *(float *)(v22 + 332) * 0.0625;
  }
  v74 = v23;
  v76 = v24;
LABEL_37:
