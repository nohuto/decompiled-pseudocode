/*
 * XREFs of GrePolyDraw @ 0x1C0250898
 * Callers:
 ...
 *     ??1PATHSTACKOBJ@@QEAA@XZ @ 0x1C015FB90 (--1PATHSTACKOBJ@@QEAA@XZ.c)
 */
...
__int64 __fastcall GrePolyDraw(HDC a1, struct _POINTL *a2, char *a3, unsigned int a4)
{
  ...
  PATHOBJ v23[88]; // [rsp+A0h] [rbp-308h] BYREF
...
LABEL_44:
  ...
  PATHSTACKOBJ::PATHSTACKOBJ((PATHSTACKOBJ *)v23, (DC **)v21, 1);
  if ( !*(_QWORD *)&v23[1] )
  {
    v12 = 8;
LABEL_11:
    EngSetLastError(v12);
LABEL_43:
    PATHSTACKOBJ::~PATHSTACKOBJ((PATHSTACKOBJ *)v23);
    v11 = 0;
    goto LABEL_44;
  }
  v13 = &a3[v4];
...
LABEL_38:
        if ( !EPATHOBJ::bPolyLineTo((EPATHOBJ *)v23, (struct EXFORMOBJ *)&v20, a2, (_DWORD)a3 - (_DWORD)v19) )
          goto LABEL_43;
        a2 += a3 - v19;
        if ( (*(a3 - 1) & 1) != 0 )
...
LABEL_18:
        ...
        if ( !EPATHOBJ::bPolyBezierTo((EPATHOBJ *)v23, (struct EXFORMOBJ *)&v20, a2, v15) )
          goto LABEL_43;
        a2 += v15;
        if ( (*(a3 - 1) & 1) != 0 )
          EPATHOBJ::bCloseFigure((EPATHOBJ *)v23);
        break;
      case 6:
        if ( !EPATHOBJ::bMoveTo((EPATHOBJ *)v23, (struct EXFORMOBJ *)&v20, a2) )
          goto LABEL_43;
        ++a2;
        break;
      default:
  ...
  Current = EPATHOBJ::ptfxGetCurrent((EPATHOBJ *)v23, &v22);
  v17 = v21[0];
  ...
  *(_DWORD *)(*(_QWORD *)&v17[122] + 12LL) = *(_DWORD *)(*(_QWORD *)&Current + 4LL);
  if ( (v21[0][31].x & 1) != 0 || (unsigned int)EPATHOBJ::bStrokeAndOrFill(v23, v21, (LINEATTRS *)&v21[0][26], &v20, 1u) )
    v8 = 1;
  PATHSTACKOBJ::~PATHSTACKOBJ((PATHSTACKOBJ *)v23);
  DCOBJ::~DCOBJ((DCOBJ *)v21);
  return v8;
