/*
 * XREFs of ?CallDelegateThread@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C01CD020
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CallDelegateThread(const struct tagQMSG *a1)
{
  ...
  if ( IsPointerInputMessage(*((_DWORD *)a1 + 6)) )
  {
    if ( (unsigned int)dword_1C030D340 > 4 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x10uLL) )
      {
        ...
        v11 = v3;
        v28 = v2;
        TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D52F8, 0LL, 0LL, 7u, &pData);
      }
    }
  }
         ...
         && TlgKeywordOn((TraceLoggingHProvider)&dword_1C030D340, 0x10uLL) )
  {
    ...
    v11 = v7;
    v19 = cData;
    TlgWrite((TraceLoggingHProvider)&dword_1C030D340, &unk_1C02D5366, 0LL, 0LL, cData, &pData);
  }
}
