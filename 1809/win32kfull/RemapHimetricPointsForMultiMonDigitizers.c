/*
 * XREFs of RemapHimetricPointsForMultiMonDigitizers @ 0x1C01D27D8
 * Callers:
...
__int64 __fastcall RemapHimetricPointsForMultiMonDigitizers(__int64 a1, __int64 a2, _DWORD *a3, _DWORD *a4)
{
  ...
  __m128i v30; // [rsp+48h] [rbp-30h] BYREF
  ...
  *(_OWORD *)b = *(_OWORD *)v4;
  ...
  v14 = *GetMonitorRect(&v29, a2);
  v29 = v14;
  ScreenRect = GetScreenRect(&v30, v15);
