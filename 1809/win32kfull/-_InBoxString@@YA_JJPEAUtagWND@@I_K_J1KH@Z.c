/*
 * XREFs of ?_InBoxString@@YA_JJPEAUtagWND@@I_K_J1KH@Z @ 0x1C0108C54
 * Callers:
 *     NtUserfnINLBOXSTRING @ 0x1C0108C10 (NtUserfnINLBOXSTRING.c)
 *     NtUserfnINCBOXSTRING @ 0x1C0156C40 (NtUserfnINCBOXSTRING.c)
 * Callees:
        ...
        int a8)
{
  ...
  v16 = *(_DWORD *)(gptiCurrent + 1388LL);
  if ( v14 || v15 )
  {
    *(_DWORD *)(gptiCurrent + 1388LL) = 2;
    if ( a3 == v13 )
  ...
  if ( v17 == xxxSendMessageFF || (char *)v17 == (char *)xxxWrapSendMessageBSM )
    return -1LL;
  *(_DWORD *)(gptiCurrent + 1388LL) = 1;
  result = v17((int)a2, a3, a4, a5, a6);
LABEL_9:
  *(_DWORD *)(gptiCurrent + 1388LL) = v16;
  return result;
}
