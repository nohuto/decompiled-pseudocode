/*
 * XREFs of ?UpdateWaveformInfoList@SimpleHapticsController@@IEAAJGG@Z @ 0x1C023F7E4
 * Callers:
...
LABEL_5:
    if ( (unsigned int)dword_1C030C3C8 > 4 )
    {
      ...
      v12 = 2LL;
      v14 = 2LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C030C3C8, &unk_1C02D6B69, 0LL, 0LL, 5u, &pData);
    }
    return 3221226021LL;
  }
}
