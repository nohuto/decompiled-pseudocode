/*
 * XREFs of ?DdcciGetTimingReport@CMonitorAPI@@QEAAJPEAXPEAU_MC_TIMING_REPORT@@@Z @ 0x1C0255608
 * Callers:
 *     NtGdiDDCCIGetTimingReport @ 0x1C0256250 (NtGdiDDCCIGetTimingReport.c)
 * Callees:
