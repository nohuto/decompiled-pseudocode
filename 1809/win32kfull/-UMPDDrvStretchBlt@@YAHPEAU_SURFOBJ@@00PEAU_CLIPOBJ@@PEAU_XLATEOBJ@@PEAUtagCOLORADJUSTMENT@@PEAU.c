/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C008D730
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  _QWORD v47[16]; // [rsp+140h] [rbp+30h] BYREF
  ...
  {
    if ( a5 )
      v18 = ((4 * a5->cEntries + 7) & 0xFFFFFFF8) + 256;
    else
      v18 = 232;
    v23 = v18;
  ...
  v47[7] = a5;
  v20 = 0;
  if ( (unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 64), (struct _SURFOBJ **)&v47[3], v12) )
  {
    if ( (unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 80), (struct _SURFOBJ **)&v47[4], v13) )
    {
      if ( (unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 96), (struct _SURFOBJ **)&v47[5], v14) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v16, (UMPDOBJ *)((char *)v16 + 112), (void **)&v47[6], 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::pxlo(v16, (struct _XLATEOBJ **)&v47[7]) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v47[8], 0x18u) )
            {
              ...
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v47[10], 0x10u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v47[11], 0x10u) )
                  {
                    ...
                    {
                      LODWORD(Size) = 4;
                      if ( UMPDOBJ::Thunk(v16, v47, 0x80u, &v23, Size) != -1 )
                      {
                        if ( v23 )
                          v20 = 1;
                      }
