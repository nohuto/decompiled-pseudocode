/*
 * XREFs of ?SendDeviceIOControl@SimpleHapticsController@@QEAAJKPEAXK0KPEAK@Z @ 0x1C023EB08
 * Callers:
...
LABEL_18:
  ...
  if ( (unsigned int)dword_1C030C3C8 > 4 )
  {
    ...
    v21 = a2;
    v30 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C030C3C8, &unk_1C02D6BE3, 0LL, 0LL, 4u, &pData);
  }
