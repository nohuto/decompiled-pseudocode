/*
 * XREFs of SetManifestWinVer @ 0x1C00FBB80
 * Callers:
 *     <none>
 * Callees:
 *     SbGetProcessSwitchContext @ 0x1C00FBC48 (SbGetProcessSwitchContext.c)
 *     SbGetContextDetailsByGuid @ 0x1C00FBC9C (SbGetContextDetailsByGuid.c)
 */
