/*
 * XREFs of ?_InertiaRegionIntersectsTopEdge@Edgy@@YAHPEBUINERTIA_INFO_INTERNAL@@PEBUtagRECT@@@Z @ 0x1C01E16F8
 * Callers:
 ...
 *     GetInertiaRegionInVirtualizedScreen @ 0x1C0226824 (GetInertiaRegionInVirtualizedScreen.c)
 */
