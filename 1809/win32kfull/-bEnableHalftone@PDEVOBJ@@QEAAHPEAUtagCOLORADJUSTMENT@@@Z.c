/*
 * XREFs of ?bEnableHalftone@PDEVOBJ@@QEAAHPEAUtagCOLORADJUSTMENT@@@Z @ 0x1C0112F44
 * Callers:
...
LABEL_36:
  ...
  v51[8] = *(_WORD *)(v5 + 2276);
  v51[9] = *(_WORD *)(v5 + 2280);
  v51[10] = *(_WORD *)(v5 + 2284);
  v51[11] = *(_WORD *)(v5 + 2288);
  v51[12] = *(_WORD *)(v5 + 2292);
  v51[13] = *(_WORD *)(v5 + 2296);
  v51[14] = *(_WORD *)(v5 + 2300);
  v51[15] = *(_WORD *)(v5 + 2304);
  v51[16] = *(_WORD *)(v5 + 2308);
  v51[17] = *(_WORD *)(v5 + 2312);
  v51[18] = *(_WORD *)(v5 + 2316);
  v51[19] = *(_WORD *)(v5 + 2320);
  v51[20] = *(_WORD *)(v5 + 2324);
  v31 = v51;
  v50[0] = *(_WORD *)(v5 + 2340);
  v50[1] = *(_WORD *)(v5 + 2344);
  v50[2] = *(_WORD *)(v5 + 2348);
  ...
  v18 = *(_QWORD *)this;
  v19 = 1;
  if ( (*(_DWORD *)(v18 + 40) & 1) == 0 && (unsigned int)XEPALOBJ::bEqualEntries(&v24, *(_QWORD *)(v18 + 1808)) )
  {
