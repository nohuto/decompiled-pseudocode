/*
 * XREFs of ?InvalidateInputQueues@CInputQueueProp@@IEAAXXZ @ 0x1C011E48C
 * Callers:
 *     ?Delete@CInputQueueProp@@UEAAXXZ @ 0x1C011E460 (-Delete@CInputQueueProp@@UEAAXXZ.c)
 * Callees:
 *     ?Reset@?$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z @ 0x1C011E514 (-Reset@-$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z.c)
