/*
 * XREFs of NtGdiModifyWorldTransform @ 0x1C00F3780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiModifyWorldTransform(HDC a1, struct _XFORML *a2, unsigned int a3)
{
  ...
  struct _XFORML v23; // [rsp+88h] [rbp+1Fh] BYREF
  ...
  if ( a2 )
  {
    v8 = ProbeAndConvertXFORM(a2, &v23);
    v7 = v16;
    v3 = v8;
  }
  else
  ...
  if ( a3 <= 3 )
  {
    vConvertXformToMatrix(&v23, &Buf1);
    v12 = v16;
...
LABEL_28:
  ...
  if ( a3 != 4 )
    goto LABEL_30;
  if ( v23.eM11 == 1.0 && v23.eM12 == 0.0 && v23.eM21 == 0.0 && v23.eM22 == 1.0 && v23.eDx == 0.0 && v23.eDy == 0.0 )
  {
LABEL_26:
