/*
 * XREFs of xxxGetInputEvent @ 0x1C0025880
 * Callers:
...
__int64 __fastcall xxxGetInputEvent(unsigned int a1)
{
  ...
  if ( ((unsigned __int16)(v5 | *(_WORD *)(v3 + 4)) & v1) != 0
    || (v6 = *(_DWORD *)(gptiCurrent + 1208LL), (v6 & 0x400) != 0 || (v2 & 8) != 0) && (v6 & 0x200) != 0
...
LABEL_38:
  ...
  if ( (v1 & 0x1C0F) != 0 )
    *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 336LL) = gptiCurrent;
  ...
  *(_DWORD *)(gptiCurrent + 488LL) &= ~0x2000u;
  ...
  else
  {
    ...
    if ( !*(_QWORD *)(v9 + 336) )
    {
      *(_QWORD *)(v9 + 336) = gptiCurrent;
      v9 = *(_QWORD *)(gptiCurrent + 424LL);
    }
    if ( *(_QWORD *)(v9 + 336) == gptiCurrent )
    {
      EtwTraceWakeInputIdle(0LL, gptiCurrent);
