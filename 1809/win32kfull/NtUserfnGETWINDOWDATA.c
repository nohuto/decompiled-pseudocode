/*
 * XREFs of NtUserfnGETWINDOWDATA @ 0x1C00FBD10
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C01632C0 (_guard_dispatch_icall_nop.c)
 *     ?GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z @ 0x1C0211294 (-GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z.c)
 */
        ...
        int a6)
{
  ...
  if ( a6 == 689 && a4 < 3 )
  {
    ...
    else
    {
      ...
      {
        WindowData = ((__int64 (__fastcall *)(struct tagWND *, _QWORD, __int64, __int64, ULONG64))qword_1C03167F8)(
                       a1,
                       a2,
                       a3,
                       a4,
        ...
        if ( a4 == 2 && (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 424LL) + 12LL) & 0x80u) != 0 )
        {
          if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 18LL) & 1) == 0 || a3 )
            ...
            v18 = 17LL;
          return (((__int64 (__fastcall *)(struct tagWND *, _QWORD, __int64))qword_1C03167F8)(a1, a2, v18) << 32) | WindowData;
        }
      }
      else
      {
        v16 = *(_QWORD *)(v13 + 880);
        v17 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 880LL);
        if ( !gbEnforceUIPI
