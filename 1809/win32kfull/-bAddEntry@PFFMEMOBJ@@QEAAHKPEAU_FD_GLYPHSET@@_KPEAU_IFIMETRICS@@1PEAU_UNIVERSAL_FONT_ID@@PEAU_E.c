/*
 * XREFs of ?bAddEntry@PFFMEMOBJ@@QEAAHKPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@1PEAU_UNIVERSAL_FONT_ID@@PEAU_EUDCLOAD@@@Z @ 0x1C00CA2B8
 * Callers:
 ...
 *     ?IsCHSBaseFont@@YAHPEBGIPEAJ@Z @ 0x1C01623A8 (-IsCHSBaseFont@@YAHPEBGIPEAJ@Z.c)
 */
        ...
        struct _EUDCLOAD *a8)
{
  ...
  if ( v11 )
  {
    v14 = (const unsigned __int16 *)*((_QWORD *)v11 + 1);
    v15 = v25;
    if ( v14 )
    {
      if ( a2 != 1 )
