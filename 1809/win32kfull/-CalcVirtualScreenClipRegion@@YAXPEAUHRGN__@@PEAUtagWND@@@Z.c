/*
 * XREFs of ?CalcVirtualScreenClipRegion@@YAXPEAUHRGN__@@PEAUtagWND@@@Z @ 0x1C010DD3C
 * Callers:
...
void __fastcall CalcVirtualScreenClipRegion(HRGN a1, struct tagWND *a2)
{
    ...
    && (v5 = (*(_DWORD *)(*((_QWORD *)a2 + 5) + 288LL) >> 8) & 0x1FF) != 0 )
  {
    ...
    if ( *(_DWORD *)*gpDispInfo == 1 )
    {
      ...
      MonitorRectForDpi = GetMonitorRectForDpi(&v12, *(_QWORD *)(DispInfo + 96), v5);
LABEL_6:
      v13 = *MonitorRectForDpi;
      SetRectRgnIndirect(a1, &v13);
      return;
    }
    EmptyRgn = CreateEmptyRgn(gpDispInfo, v6, v7);
    if ( !EmptyRgn )
    {
      MonitorRectForDpi = (__m128i *)GetScreenRectForWindow(&v12, a2);
      goto LABEL_6;
    }
    for ( i = *(_QWORD *)(gpDispInfo + 104LL); i; i = *(_QWORD *)(i + 56) )
    {
      ...
      {
        v13 = *GetMonitorRectForDpi(&v12, i, v5);
