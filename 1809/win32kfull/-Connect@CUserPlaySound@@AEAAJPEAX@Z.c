/*
 * XREFs of ?Connect@CUserPlaySound@@AEAAJPEAX@Z @ 0x1C012CFDC
 * Callers:
 *     NtUserDoSoundConnect @ 0x1C0135200 (NtUserDoSoundConnect.c)
 * Callees:
 *     PlaySoundDisconnect @ 0x1C035531C (PlaySoundDisconnect.c)
