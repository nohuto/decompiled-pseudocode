/*
 * XREFs of NtUserfnIMECONTROL @ 0x1C021F5A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserfnIMECONTROL(__int64 a1, int a2, unsigned __int64 a3, ULONG64 a4, __int64 a5, char a6)
{
  ...
  __int64 v10; // rbx
  __int64 v11; // rdx
  _QWORD v13[3]; // [rsp+50h] [rbp-F8h] BYREF
  __int128 v14; // [rsp+68h] [rbp-E0h]
  __int64 v15; // [rsp+78h] [rbp-D0h]
  int v16; // [rsp+80h] [rbp-C8h]
  __int128 v17; // [rsp+88h] [rbp-C0h]
  __int128 v18; // [rsp+98h] [rbp-B0h]
  __int128 v19; // [rsp+B0h] [rbp-98h]
...
LABEL_24:
    ...
    case 0x18:
      ...
      if ( !v9 )
        return 0LL;
      PushW32ThreadLock((__int64)v9, v13, (__int64)Win32FreePool);
      break;
  }
LABEL_33:
