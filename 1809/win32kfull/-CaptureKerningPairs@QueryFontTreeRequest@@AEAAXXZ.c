/*
 * XREFs of ?CaptureKerningPairs@QueryFontTreeRequest@@AEAAXXZ @ 0x1C0146978
 * Callers:
 *     ?CaptureUsermodeParameters@QueryFontTreeRequest@@UEAAXPEAX@Z @ 0x1C0093230 (-CaptureUsermodeParameters@QueryFontTreeRequest@@UEAAXPEAX@Z.c)
 * Callees:
 ...
 *     ?Win32ProbeForRead@@YAXPEAX_KK@Z @ 0x1C00939B8 (-Win32ProbeForRead@@YAXPEAX_KK@Z.c)
...
void __fastcall QueryFontTreeRequest::CaptureKerningPairs(QueryFontTreeRequest *this)
{
  ...
  if ( v2 )
  {
    ...
    v8 = v3 + 1;
    if ( (unsigned int)v8 >= v3 && (unsigned __int64)(6 * v8) <= 0xFFFFFFFF )
    {
      v9 = 6 * v8;
