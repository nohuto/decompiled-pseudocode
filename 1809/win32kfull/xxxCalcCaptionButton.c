/*
 * XREFs of xxxCalcCaptionButton @ 0x1C022B200
 * Callers:
...
__int64 __fastcall xxxCalcCaptionButton(__int64 a1, int a2, __int16 *a3, _DWORD *a4, int *a5, int a6)
{
  ...
  *a3 = 0;
  ...
  if ( (*(_DWORD *)(v10 + 232) & 0x8000000) != 0 )
  {
    WindowDpiLastNotify = GetWindowDpiLastNotify(a1);
         ...
         && (v12 = *(_QWORD *)(*(_QWORD *)(a1 + 16) + 456LL)) != 0
  ...
  *a4 = *(_DWORD *)(v10 + 88) - v13;
  ...
  DpiDependentMetric = GetDpiDependentMetric((unsigned int)(v17 + 12), WindowDpiLastNotify, v10);
  v21 = GetDpiDependentMetric((unsigned int)(v17 + 13), WindowDpiLastNotify, v19);
  if ( a2 != 5 )
  {
    v23 = *(_QWORD *)(a1 + 40);
    if ( a2 == 2 )
  ...
  if ( (unsigned int)xxxMNCanClose(a1, v20) || a6 )
  {
