/*
 * XREFs of ?GetLogFontFromUserProfile@@YA?AUtagLOGFONTW@@PEAU_UNICODE_STRING@@I@Z @ 0x1C00BFDA0
 * Callers:
        ...
        unsigned int a3)
{
  ...
  FastGetProfileValue(a2, 23LL, a3, 0LL, retstr, 92);
  if ( !retstr->lfFaceName[0] )
  {
    *(_OWORD *)retstr->lfFaceName = xmmword_1C02CE0A0;
