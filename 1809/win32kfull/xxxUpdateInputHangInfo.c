/*
 * XREFs of xxxUpdateInputHangInfo @ 0x1C00341E0
 * Callers:
 ...
 *     xxxClearWakeMask @ 0x1C01C3D00 (xxxClearWakeMask.c)
 * Callees:
...
LABEL_15:
  ...
  if ( v8 )
  {
    *(_QWORD *)v8 = *(_QWORD *)(gptiCurrent + 1136LL);
    *(_QWORD *)(v8 + 8) = a1;
    *(_DWORD *)(v8 + 16) = v5;
    *(_QWORD *)(gptiCurrent + 1136LL) = v8;
LABEL_12:
    v3 = 1;
  }
