/*
 * XREFs of NtUserGetControlColor @ 0x1C0214460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetControlColor(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  __int64 v8; // rax
  __int64 v9; // rdx
  __int64 v10; // rcx
