/*
 * XREFs of _SetCalibrationData @ 0x1C01C5510
 * Callers:
 *     NtUserSetCalibrationData @ 0x1C021C140 (NtUserSetCalibrationData.c)
 * Callees:
 *     UpdateTiltCalData @ 0x1C01BF09C (UpdateTiltCalData.c)
    ...
    if ( ValidateCalibrationData(a2, (__int64)a3, a4) )
    {
      ...
      if ( v4 && updated )
      {
        if ( (unsigned int)(a4 - 1) <= 1 )
        {
          ...
          if ( GetPointerDeviceKey(&v14, &KeyHandle, v11) )
          {
        ...
        {
          v14 = *(struct _UNICODE_STRING *)(a1 + 208);
          WriteTiltCalibrationData(&v14, v16, a2, a3);
        }
      }
    }
  }
