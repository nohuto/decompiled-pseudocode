/*
 * XREFs of EncodeRLE4 @ 0x1C02B07DC
 * Callers:
 ...
 * Callees:
 *     ?WriteEncoded8@@YAHEPEAEIPEBE@Z @ 0x1C02ADBAC (-WriteEncoded8@@YAHEPEAEIPEBE@Z.c)
...
__int64 __fastcall EncodeRLE4(__int64 a1, unsigned __int8 *a2, int a3, unsigned int a4, int a5)
{
  ...
  while ( 1 )
  {
    ...
    if ( v12 >= v5 )
      break;
    v13 = (const unsigned __int8 *)(v7 + v11 * v12);
    v14 = *v13;
...
LABEL_33:
    ...
    if ( v17 > 3 )
    {
      ...
      if ( v22 )
        v23 = v17;
      if ( v16 == 1 )
        v24 = WriteAbsolute4(v13, v6, v23 - 2, v10);
      else
        v24 = WriteEncoded8(v14, v6, (unsigned __int8)v23 - 2, v10);
      if ( v6 )
      {
        if ( v24 )
        {
