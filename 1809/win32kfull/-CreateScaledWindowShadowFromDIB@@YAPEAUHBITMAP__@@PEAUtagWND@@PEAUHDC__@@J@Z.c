/*
 * XREFs of ?CreateScaledWindowShadowFromDIB@@YAPEAUHBITMAP__@@PEAUtagWND@@PEAUHDC__@@J@Z @ 0x1C02228D0
 * Callers:
...
HSURF __fastcall CreateScaledWindowShadowFromDIB(struct tagWND *a1, HDC a2, int a3)
{
  HDC DCEx; // rax
  HDC v7; // rbx
  __m128i v8; // xmm1
  ...
  int v11; // r13d
  HSURF CompatibleBitmapInternal; // rsi
  __int64 v13; // rdx
  __int64 v14; // r8
  ...
  if ( !CompatibleBitmapInternal )
    return 0LL;
  CompatibleDC = GreCreateCompatibleDC(a2, v13, v14);
  v16 = (HDC)CompatibleDC;
  if ( !CompatibleDC
    || (v17 = GreSelectBitmap(CompatibleDC, CompatibleBitmapInternal),
        v18 = GreStretchBltInternal(v16, 0, 0, v10, v11, a2, 0, 0, a3 * v10, a3 * v11, 13369376, 0, 0),
        GreSelectBitmap(v16, v17),
        GreDeleteDC(v16),
        !v18) )
  {
