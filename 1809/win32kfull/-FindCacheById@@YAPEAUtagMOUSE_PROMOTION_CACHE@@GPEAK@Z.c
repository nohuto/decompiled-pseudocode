/*
 * XREFs of ?FindCacheById@@YAPEAUtagMOUSE_PROMOTION_CACHE@@GPEAK@Z @ 0x1C01F1484
 * Callers:
...
struct tagMOUSE_PROMOTION_CACHE *__fastcall FindCacheById(__int16 a1, unsigned int *a2)
{
  ...
  v2 = 0LL;
  for ( i = word_1C03171F8; *i != a1; i += 12 )
  {
  ...
  *a2 = v2;
  return (struct tagMOUSE_PROMOTION_CACHE *)&word_1C03171F8[12 * v2];
}
