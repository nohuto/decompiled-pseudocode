/*
 * XREFs of ?RedirStretchBltROP@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54KPEAU_BRUSHOBJ@@K@Z @ 0x1C0280DE0
 * Callers:
 *     <none>
 * Callees:
        ...
        DWORD rop4)
{
  ...
  struct SURFACE *v28; // [rsp+78h] [rbp-81h] BYREF
          ...
          if ( v18 )
          {
            do
            {
              ...
              if ( v19 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v19 + 1792) + 616LL) )
                  {
