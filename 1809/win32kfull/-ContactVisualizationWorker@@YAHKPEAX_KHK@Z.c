/*
 * XREFs of ?ContactVisualizationWorker@@YAHKPEAX_KHK@Z @ 0x1C01C95A0
 * Callers:
 *     EditionContactVisualization @ 0x1C01CA360 (EditionContactVisualization.c)
 * Callees:
 ...
 *     ?GetWindowBarrelVisualizationSetting@Feedback@@YAHAEBUtagPOINTER_INFO@@H@Z @ 0x1C01C9BB4 (-GetWindowBarrelVisualizationSetting@Feedback@@YAHAEBUtagPOINTER_INFO@@H@Z.c)
 *     ?GetWindowVisualizationSetting@Feedback@@YAHAEBUtagPOINTER_INFO@@HHHPEAH@Z @ 0x1C01C9C74 (-GetWindowVisualizationSetting@Feedback@@YAHAEBUtagPOINTER_INFO@@HHHPEAH@Z.c)
 *     ?PointerEventIntToDigitizerContactInfo@Feedback@@YAXPEBUtagPOINTEREVENTINT@@HHHPEAUtagDIGITIZER_CONTACT_INFO@@@Z @ 0x1C01C9E10 (-PointerEventIntToDigitizerContactInfo@Feedback@@YAXPEBUtagPOINTEREVENTINT@@HHHPEAUtagDIGITIZER_.c)
...
_BOOL8 __fastcall ContactVisualizationWorker(unsigned int a1, char *a2, __int64 a3, int a4, unsigned int a5)
{
  ...
  if ( (_DWORD)v5 )
  {
    ...
    do
    {
      ...
      if ( ContactVisualizationPointerEventInt )
      {
        ...
        {
          if ( *(_DWORD *)v15 == 3 && (unsigned int)GetPointerDeviceType(*((_QWORD *)v15 + 2)) == 1 )
          {
            v17 = *((_DWORD *)v15 + 3);
            ...
            v45[0] = v17;
            v45[2] = v18;
            DeferPointerCursorOperation((const struct tagPOINTER_INFO *)v15, (const struct tagPOINTERCURSORDATA *)v45);
          }
          else if ( !Feedback::gfIntegratedPenActive && (*((_DWORD *)v15 + 3) & 0x2000) != 0 )
          {
            v46[0] = *((_DWORD *)v15 + 3);
            v19 = 0;
            v46[1] = *((_DWORD *)v15 + 8);
            ...
            if ( (*((_DWORD *)v15 + 3) & 0x10001) != 0 )
            {
              ...
              if ( !v24 )
              {
                ...
                if ( *(_DWORD *)v15 == 3 || !v25 || !(unsigned int)IsCurrentDesktopComposed() || v22 )
                {
                  v22 = 1;
                  v23 = 0;
                }
  ...
  if ( v7 )
  {
    for ( i = 0LL; (unsigned int)i < v12; i = (unsigned int)(v35 + i) )
    {
      v35 = v12 - i;
      if ( v12 - (unsigned int)i > 0xB )
        v35 = 11;
      v36 = (void *)ReferenceDwmApiPort(5 * i, v11);
