...
void __fastcall __noreturn std::_List_buy_std::pair_unsigned___int64_const__Microsoft::WRL::ComPtr_MagnifierProcessor::DeviceState____std::allocator_std::pair_unsigned___int64_const__Microsoft::WRL::ComPtr_MagnifierProcessor::DeviceState_______::_Buynode_std::piecewise_construct_t_const_____ptr64_std::tuple_unsigned___int64_const_____ptr64__std::tuple_____::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
