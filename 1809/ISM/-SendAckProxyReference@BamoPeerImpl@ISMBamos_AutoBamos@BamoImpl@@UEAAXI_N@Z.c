/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x180017170
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v4 = CoreUICallSend(v3, v5, 2LL, 37LL, 27, &unk_18014AA36, a2);
  if ( v4 < 0 )
  {
