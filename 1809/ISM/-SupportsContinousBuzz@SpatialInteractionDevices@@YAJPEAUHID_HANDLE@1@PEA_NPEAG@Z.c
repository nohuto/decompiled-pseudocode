/*
 * XREFs of ?SupportsContinousBuzz@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEA_NPEAG@Z @ 0x1800A58F4
 * Callers:
...
LABEL_25:
  ...
  result = SpatialInteractionDevices::UpdateFeatureReportIfNeeded((__int64 *)this, v6);
  if ( (int)result < 0 )
    return result;
  v14 = SpatialInteractionDevices::Internal::HIDGetInteger<unsigned short>((int)this, v11, v13, (int)&v22, v20);
  v6 = 0LL;
  v15 = v14;
  if ( v14 >= 0 )
  {
