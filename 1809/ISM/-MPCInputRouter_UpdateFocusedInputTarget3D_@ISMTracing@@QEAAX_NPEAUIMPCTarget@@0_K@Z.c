/*
 * XREFs of ?MPCInputRouter_UpdateFocusedInputTarget3D_@ISMTracing@@QEAAX_NPEAUIMPCTarget@@0_K@Z @ 0x180009CCC
 * Callers:
  ...
  if ( v6 )
  {
    if ( *v6 )
    {
      ...
      if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
      {
        ...
        v22 = 4;
        v25 = 8;
        TlgWrite((TraceLoggingHProvider)v7, &unk_18016610F, 0LL, 0LL, 7u, &pData);
      }
    }
  }
}
