/*
 * XREFs of ?at@?$unordered_map@IUViewHierarchyEntry@ViewHierarchy@@U?$hash@I@std@@U?$equal_to@I@4@V?$allocator@U?$pair@$$CBIUViewHierarchyEntry@ViewHierarchy@@@std@@@4@@std@@QEBAAEBUViewHierarchyEntry@ViewHierarchy@@AEBI@Z @ 0x18000ED64
 * Callers:
 ...
 *     ?GetTopLevelHostView@ViewHierarchy@@UEBAII@Z @ 0x18000E840 (-GetTopLevelHostView@ViewHierarchy@@UEBAII@Z.c)
 * Callees:
 *     <none>
 */
