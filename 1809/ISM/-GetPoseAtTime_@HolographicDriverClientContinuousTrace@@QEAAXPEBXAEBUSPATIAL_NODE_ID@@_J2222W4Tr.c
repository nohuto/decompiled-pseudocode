/*
 * XREFs of ?GetPoseAtTime_@HolographicDriverClientContinuousTrace@@QEAAXPEBXAEBUSPATIAL_NODE_ID@@_J2222W4TracePredictionType@@AEBUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@_NI@Z @ 0x18010DDD4
 * Callers:
        ...
        int a12)
{
  ...
  v74 = a2;
  v13 = a10;
  v20 = 1000000 * (a5 - a4) / qword_180193A58;
  v21 = 1000000 * (a5 - a6) / qword_180193A58;
  v22 = 1000000 * (a7 - a5) / qword_180193A58;
  v23 = 1000000 * (a7 - a6) / qword_180193A58;
  v25 = 1000000 * (a8 - a6) / qword_180193A58;
  LODWORD(v19) = a12 ^ *(_DWORD *)(a10 + 16);
  v24 = 1000000 * (a4 - a8) / qword_180193A58;
  ...
  if ( *(_DWORD *)v15 > 5u )
  {
    ...
    if ( (v14 & 0x400000) != 0 )
    {
      ...
      if ( v14 == *(_QWORD *)(v15 + 24) )
      {
        ...
        v71 = 1LL;
        v73 = 4LL;
        LODWORD(v14) = TlgWrite((TraceLoggingHProvider)v15, &unk_18016D6F7, 0LL, 0LL, 0x19u, &pData);
      }
    }
  }
  return v14;
