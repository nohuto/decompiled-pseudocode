...
void __fastcall __noreturn std::_Tree_comp_alloc_std::_Tmap_traits_wil::com_ptr_t_MPCManagerBamo_AutoBamos::BamoPeer_wil::err_exception_policy__wil::com_ptr_t_IMPCManagerClientProxy_wil::err_exception_policy__std::less_wil::com_ptr_t_MPCManagerBamo_AutoBamos::BamoPeer_wil::err_exception_policy____std::allocator_std::pair_wil::com_ptr_t_MPCManagerBamo_AutoBamos::BamoPeer_wil::err_exception_policy__const__wil::com_ptr_t_IMPCManagerClientProxy_wil::err_exception_policy______0___::_Buynode_std::piecewise_construct_t_const_____ptr64_std::tuple_wil::com_ptr_t_MPCManagerBamo_AutoBamos::BamoPeer_wil::err_exception_policy_______ptr64__std::tuple_____::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
