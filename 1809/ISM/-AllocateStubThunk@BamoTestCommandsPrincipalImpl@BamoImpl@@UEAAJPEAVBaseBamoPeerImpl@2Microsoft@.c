/*
 * XREFs of ?AllocateStubThunk@BamoTestCommandsPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x1800C17F0
 * Callers:
 *     <none>
 * Callees:
