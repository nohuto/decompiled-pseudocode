/*
 * XREFs of ?NodeStatusOK_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXK@Z @ 0x18012301C
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_DWORD *)v2 > 4u && (*(_BYTE *)(v2 + 16) & 2) != 0 && (*(_QWORD *)(v2 + 24) & 2LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v4 = &v7;
    v5 = 4;
    TlgWrite((TraceLoggingHProvider)v2, &unk_18016E425, 0LL, 0LL, 3u, &pData);
  }
}
