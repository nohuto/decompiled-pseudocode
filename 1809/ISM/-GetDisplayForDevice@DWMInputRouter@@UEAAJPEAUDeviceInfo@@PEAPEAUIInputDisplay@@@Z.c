/*
 * XREFs of ?GetDisplayForDevice@DWMInputRouter@@UEAAJPEAUDeviceInfo@@PEAPEAUIInputDisplay@@@Z @ 0x18008B280
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IInputDisplay **a3)
{
  ...
  if ( !v3 )
  {
    v10 = (int *)*((_QWORD *)this + 26);
    for ( i = (int *)*((_QWORD *)this + 25); i != v10; i += 4 )
    {
      v12 = *((_QWORD *)i + 1);
      v13 = *i;
      if ( v12 )
...
LABEL_17:
    v15 = (struct IInputDisplay *)*((_QWORD *)this + 28);
    if ( v15 )
    {
      (*(void (__fastcall **)(struct IInputDisplay *))(*(_QWORD *)v15 + 8LL))(v15);
      v15 = (struct IInputDisplay *)*((_QWORD *)this + 28);
