/*
 * XREFs of ?SendMaterializeProxy@BamoMagnifierServerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180029270
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoMagnifierServerPrincipalImpl::SendMaterializeProxy(
