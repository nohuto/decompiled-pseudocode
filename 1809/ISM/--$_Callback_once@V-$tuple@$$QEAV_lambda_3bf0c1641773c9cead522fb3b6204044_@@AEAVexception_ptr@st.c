/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_3bf0c1641773c9cead522fb3b6204044_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x18003D4D0
 * Callers:
 *     <none>
 * Callees:
