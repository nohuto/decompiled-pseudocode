/*
 * XREFs of _SystemCursorController::CreateCustomCursorShapeAnimation_::_1_::catch$1 @ 0x1801328AA
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall SystemCursorController::CreateCustomCursorShapeAnimation_::_1_::catch_1(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
