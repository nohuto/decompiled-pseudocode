/*
 * XREFs of ?StopActivity@HandSpatialObjectAdded@SpatialInteractionTrace@SpatialInteractionDevices@@MEAAXXZ @ 0x1800BCC80
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 4u )
    {
      ...
      v78 = v9 + 1;
      v79 = 0;
      TlgWrite(v6, &unk_18016A79E, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 4u )
    {
      ...
      v29 = CurrentThreadId;
      v83 = &v29;
      TlgWrite(v26, &unk_18016AB33, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v80);
    }
  }
