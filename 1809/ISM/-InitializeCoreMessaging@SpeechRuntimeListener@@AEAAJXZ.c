/*
 * XREFs of ?InitializeCoreMessaging@SpeechRuntimeListener@@AEAAJXZ @ 0x180059AF0
 * Callers:
...
__int64 __fastcall SpeechRuntimeListener::InitializeCoreMessaging(SpeechRuntimeListener *this)
{
  ...
  v7 = InputSecurityDescriptor::QueryDescriptor(&v20, v6, L"System\\SpeechRuntimeListenerPort");
  if ( v7 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
