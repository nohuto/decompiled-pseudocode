/*
 * XREFs of ?QueryInterface@BamoInputSiteManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18001D440
 * Callers:
 *     ?QueryInterface@BamoInputSiteManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18001EB40 (-QueryInterface@BamoInputSiteManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
