/*
 * XREFs of ?Thunk_UpdateConstantForDevice_8@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18004B770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCConstantManagerClientPrincipal_Receive<BamoImpl::BamoMPCConstantManagerClientPrincipalImpl>::Thunk_UpdateConstantForDevice_8(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // ebp
  ...
  if ( !*(_DWORD *)(v9 + 140) )
  {
    ...
    if ( *(_DWORD *)(v9 + 136) != GetCurrentThreadId() )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v14);
      JUMPOUT(0x18004B965LL);
    }
    *(_DWORD *)(v9 + 136) = 0;
    LeaveCriticalSection((LPCRITICAL_SECTION)(v9 + 96));
  }
  v15 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD, int *, int *, __int64))(*(_QWORD *)(a1 - 16) + 72LL))(
          a1 - 16,
          v7,
          v20,
          v19,
