/*
 * XREFs of ?Thunk_UpdateDragNDropContextualProcessor_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019D20
 * Callers:
 *     <none>
 * Callees:
