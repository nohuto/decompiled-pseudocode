/*
 * XREFs of ?OnGamepadIsSupportedForProcess@BamoMPCManagerClientProxy@@UEAAJI@Z @ 0x1800DC6F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCManagerClientProxy::OnGamepadIsSupportedForProcess(BamoMPCManagerClientProxy *this, int a2)
{
  unsigned int v4; // ebx
  __int64 v5; // rdx
  __int64 v6; // r9
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      v10[0] = v12;
      v10[1] = v13;
      v4 = CoreUICallSend(v14, v10, 2LL, 4LL, 4, &unk_18014AFCD, a2);
      goto LABEL_7;
    }
    v6 = (unsigned int)v7;
    v5 = 8134LL;
