/*
 * XREFs of ?Create@ConsumerControlDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x180066C2C
 * Callers:
        ...
        struct ConsumerControlDeviceCollection **a4)
{
  ...
  if ( a1 && a3 && a4 )
  {
    ...
    if ( v12 )
    {
      ...
      *(_QWORD *)v12 = &ConsumerControlDeviceCollection::`vftable';
      *((_DWORD *)v12 + 690) = 0;
      *((_QWORD *)v12 + 346) = 0LL;
      *((_QWORD *)v12 + 347) = 0LL;
