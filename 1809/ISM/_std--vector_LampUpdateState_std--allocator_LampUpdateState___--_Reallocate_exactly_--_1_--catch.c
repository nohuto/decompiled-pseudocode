/*
 * XREFs of _std::vector_LampUpdateState_std::allocator_LampUpdateState___::_Reallocate_exactly_::_1_::catch$0 @ 0x1801319CB
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_LampUpdateState_std::allocator_LampUpdateState___::_Reallocate_exactly_::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
