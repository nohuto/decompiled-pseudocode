/*
 * XREFs of _Windows::Internal::SpatialInteractions::SpatialInteractionSourceHand::SendInputInfo_::_1_::catch$0 @ 0x180133AE3
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall Windows::Internal::SpatialInteractions::SpatialInteractionSourceHand::SendInputInfo_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
