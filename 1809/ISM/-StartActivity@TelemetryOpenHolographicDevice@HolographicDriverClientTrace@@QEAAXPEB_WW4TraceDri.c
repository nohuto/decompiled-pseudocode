/*
 * XREFs of ?StartActivity@TelemetryOpenHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x18010A664
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_DWORD *)v8 = 1;
    ...
    && (*((_QWORD *)v11 + 3) & 0x400000000000LL) == *((_QWORD *)v11 + 3) )
  {
    ...
    TlgWrite(v11, &unk_18016D4B9, (LPCGUID)(v15 + 8), v16, 6u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
