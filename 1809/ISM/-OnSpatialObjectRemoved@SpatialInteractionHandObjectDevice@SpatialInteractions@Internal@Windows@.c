/*
 * XREFs of ?OnSpatialObjectRemoved@SpatialInteractionHandObjectDevice@SpatialInteractions@Internal@Windows@@EEAAXPEAUISpatialObjectWatcher@Holographic@34@AEBU_GUID@@@Z @ 0x1800BEE00
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a3)
{
  ...
  if ( *(_OWORD *)(*(__int64 (__fastcall **)(struct Windows::Internal::Holographic::ISpatialObjectWatcher *))(*(_QWORD *)a2 + 32LL))(a2) == __PAIR128__(0x840AF7A562EA27A0uLL, SPATIALPROP_HandTracker_HandList) )
  {
    ...
    v10 = &v11;
    v11 = 0;
    v14 = "OnHandSpatialObjectRemoved";
    v12 = 0;
    v16 = 0;
    v13 = 0;
    v15 = 0LL;
    ...
    v20 = 0LL;
    v21 = 0LL;
    v7[0] = &SpatialInteractionDevices::SpatialInteractionTrace::OnHandSpatialObjectRemoved::`vftable';
    SpatialInteractionDevices::SpatialInteractionTrace::OnHandSpatialObjectRemoved::StartActivity(
      (SpatialInteractionDevices::SpatialInteractionTrace::OnHandSpatialObjectRemoved *)v7,
      v5,
      a3);
    v6 = Windows::Internal::SpatialInteractions::SpatialInteractionHandObjectDevice::OnHandSpatialObjectRemoved(
