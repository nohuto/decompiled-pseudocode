/*
 * XREFs of ?GetDynamicNodeButtonLatencyMicroseconds@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAAJAEBUSPATIAL_NODE_ID@@PEAH@Z @ 0x180113D80
 * Callers:
 *     ?GetDynamicNodeButtonLatencyMicroseconds@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJAEBUSPATIAL_NODE_ID@@PEAH@Z @ 0x180121DF0 (-GetDynamicNodeButtonLatencyMicroseconds@SpatialGraphDriverClient@Holographic@Inter_ea_180121DF0.c)
 * Callees:
        ...
        int *a3)
{
  ...
  if ( NodePropertyOfKnownSize >= 0 )
  {
    ...
    if ( v7 && *v7 )
    {
      ...
      HolographicDriverClientTrace::GetDynamicNodeButtonLatency_(
        v8,
        (char *)this - 8,
