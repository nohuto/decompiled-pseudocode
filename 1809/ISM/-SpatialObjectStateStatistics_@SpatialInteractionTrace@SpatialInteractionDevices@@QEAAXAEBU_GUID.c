/*
 * XREFs of ?SpatialObjectStateStatistics_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@II@Z @ 0x1800BAA00
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 2) != 0 && (*(_QWORD *)(v5 + 24) & 2LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    TlgWrite((TraceLoggingHProvider)v5, &unk_18016A692, 0LL, 0LL, 5u, &pData);
  }
}
