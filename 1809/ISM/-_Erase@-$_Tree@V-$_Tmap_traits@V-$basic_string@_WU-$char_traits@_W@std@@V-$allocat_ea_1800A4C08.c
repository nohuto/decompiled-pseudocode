        ...
        void *a2)
{
  ...
  if ( !*((_BYTE *)a2 + 25) )
  {
    do
    {
      ...
      operator delete(v2, (const struct std::nothrow_t *)0xE0);
      v2 = v4;
    }
    while ( !*((_BYTE *)v4 + 25) );
  }
