/*
 * XREFs of ?SetRestrictToProcessId@BamoDataSourcePrincipal@@UEAAXI@Z @ 0x1800998C0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  *((_DWORD *)this + 14) = a2;
  v4 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoDataSourcePrincipalImpl *>(
         (__int64)(this + 1),
         (__int64 (__fastcall *)(__int64, __int64))BamoImpl::BamoDataSourcePrincipalImpl::UpdateRestrictToProcessIdRemoteCacheStatic,
         (__int64)(this + 1));
  if ( v4 < 0 )
  {
