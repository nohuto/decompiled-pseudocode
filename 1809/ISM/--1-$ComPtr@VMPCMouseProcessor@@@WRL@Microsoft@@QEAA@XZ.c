/*
 * XREFs of ??1?$ComPtr@VMPCMouseProcessor@@@WRL@Microsoft@@QEAA@XZ @ 0x1800FDE40
 * Callers:
 *     _MPCMouseProcessor::Create_::_1_::dtor$2 @ 0x1801353F8 (_MPCMouseProcessor--Create_--_1_--dtor$2.c)
 * Callees:
