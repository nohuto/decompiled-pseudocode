/*
 * XREFs of ?SendMaterializeProxy@BamoTestCommandsPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800C16C0
 * Callers:
 *     <none>
 * Callees:
