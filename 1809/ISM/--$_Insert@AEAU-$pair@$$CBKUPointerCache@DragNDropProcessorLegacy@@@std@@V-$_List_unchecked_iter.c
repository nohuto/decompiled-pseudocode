/*
 * XREFs of ??$_Insert@AEAU?$pair@$$CBKUPointerCache@DragNDropProcessorLegacy@@@std@@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKUPointerCache@DragNDropProcessorLegacy@@@std@@@std@@@std@@@2@@?$_Hash@V?$_Umap_traits@KUPointerCache@DragNDropProcessorLegacy@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKUPointerCache@DragNDropProcessorLegacy@@@std@@@4@$0A@@std@@@std@@IEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKUPointerCache@DragNDropProcessorLegacy@@@std@@@std@@@std@@@std@@_N@1@AEAU?$pair@$$CBKUPointerCache@DragNDropProcessorLegacy@@@1@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKUPointerCache@DragNDropProcessorLegacy@@@std@@@std@@@std@@@1@@Z @ 0x180026448
 * Callers:
        ...
        __int64 *a4)
{
  ...
  __int64 v27; // rdi
  _QWORD *iter; // rax
  __int64 v29[2]; // [rsp+20h] [rbp-38h] BYREF
...
LABEL_9:
    ...
    {
      v18 = *(__int64 ***)(v16 + 8 * v11 + 8);
      v19 = *v18;
      *(_QWORD *)(v16 + 8 * v11 + 8) = *v18;
      if ( v19 != a4 )
        *(_QWORD *)(*((_QWORD *)a1 + 3) + 8 * v11 + 8) = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 3) + 8 * v11 + 8) + 8LL);
    }
    v20 = *((_QWORD *)a1 + 2);
    v21 = *((_QWORD *)a1 + 7);
    v22 = (float)(int)v20;
    ...
    if ( (float)(v22 / v23) > *a1 )
    {
      if ( (unsigned __int64)v21 >= 0x200 )
      {
        if ( (unsigned __int64)v21 < 0xFFFFFFFFFFFFFFFLL )
          v21 *= 2LL;
      }
      else
      {
  ...
  else
  {
    ...
    *(_QWORD *)(*a4 + 8) = a4[1];
    --*((_QWORD *)a1 + 2);
    operator delete(a4, (const struct std::nothrow_t *)0x30);
    *(_QWORD *)a2 = v10;
    *(_BYTE *)(a2 + 8) = 0;
    return a2;
  }
