/*
 * XREFs of ?DragStarted@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@00_KW4VirtualKeyModifiers@System@Windows@@@Z @ 0x1800222B4
 * Callers:
...
int __fastcall InputETW::DragNDrop::DragStarted(unsigned int a1, int *a2, int *a3, int *a4, char a5, unsigned int a6)
{
  __int64 v7; // r14
    ...
    if ( *v11 > 1u )
    {
      ...
      if ( *(_DWORD *)v12 > 5u && (*(_BYTE *)(v12 + 16) & 1) != 0 )
      {
        ...
        if ( v10 == *(struct InputETW **)(v12 + 24) )
        {
          ...
          v45 = 8;
          v48 = 8;
          LODWORD(v10) = TlgWrite((TraceLoggingHProvider)v12, &unk_180166757, 0LL, 0LL, 0xBu, &pData);
        }
      }
    }
  }
