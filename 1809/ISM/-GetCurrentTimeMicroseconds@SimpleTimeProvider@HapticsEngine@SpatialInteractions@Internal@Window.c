/*
 * XREFs of ?GetCurrentTimeMicroseconds@SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@UEAAJPEA_J@Z @ 0x180123BF0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        __int64 *a2)
{
  ...
  *a2 = 1000000 * PerformanceCount.QuadPart / qword_180193A58;
  return 0LL;
}
