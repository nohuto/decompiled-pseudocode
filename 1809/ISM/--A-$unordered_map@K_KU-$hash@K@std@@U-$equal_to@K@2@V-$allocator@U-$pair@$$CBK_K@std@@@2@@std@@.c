/*
 * XREFs of ??A?$unordered_map@K_KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@U?$pair@$$CBK_K@std@@@2@@std@@QEAAAEA_KAEBK@Z @ 0x180025C68
 * Callers:
...
__int64 *__fastcall std::unordered_map<unsigned long,unsigned __int64>::operator[](_QWORD *a1, _DWORD *a2)
{
  __int64 *v3; // r8
  int v4; // r9d
  __int64 *v5; // rcx
