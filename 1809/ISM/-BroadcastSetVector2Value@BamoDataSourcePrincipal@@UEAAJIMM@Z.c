/*
 * XREFs of ?BroadcastSetVector2Value@BamoDataSourcePrincipal@@UEAAJIMM@Z @ 0x1800991D0
 * Callers:
 *     <none>
 * Callees:
        ...
        float a4)
{
  ...
  if ( *(_QWORD *)(*((_QWORD *)this[3] + 3) + 40LL) )
  {
    for ( i = this[5]; i; i = (struct Microsoft::BamoImpl::ConnectionIndirector *)*((_QWORD *)i + 6) )
    {
      if ( *((_BYTE *)i + 32) )
      {
        v9 = BamoImpl::BamoDataSourceStubImpl::SetVector2Value(i, a2, a3, a4);
