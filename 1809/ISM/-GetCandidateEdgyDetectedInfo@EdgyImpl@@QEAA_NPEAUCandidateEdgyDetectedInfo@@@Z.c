/*
 * XREFs of ?GetCandidateEdgyDetectedInfo@EdgyImpl@@QEAA_NPEAUCandidateEdgyDetectedInfo@@@Z @ 0x1800CE334
 * Callers:
...
char __fastcall EdgyImpl::GetCandidateEdgyDetectedInfo(EdgyImpl *this, struct CandidateEdgyDetectedInfo *a2)
{
  ...
  if ( !Edges::GetCandidateConfiguration(
          (Edges *)(v4 + 72),
          (const struct CandidateIdentity *)v2,
