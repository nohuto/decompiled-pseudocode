/*
 * XREFs of ?DeliverInput@InputRedirectionTarget@@UEAAJPEAUInputInfo@@@Z @ 0x1800D1F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InputRedirectionTarget::DeliverInput(InputRedirectionTarget *this, struct InputInfo *a2)
{
  ...
  if ( a2 )
  {
    if ( InputRedirectionTarget::IsValid(this) )
    {
      ...
      if ( (*(int (__fastcall **)(_QWORD, _QWORD, __int64, void *, int))(**((_QWORD **)this + 4) + 152LL))(
             *((_QWORD *)this + 4),
             *((_QWORD *)this + 5),
             4LL,
             v7,
