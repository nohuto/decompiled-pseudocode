/*
 * XREFs of ?Thunk_UpdateSystemCursorController_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001AAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IInputSystemProxy_Receive<BamoImpl::BamoInputSystemProxyImpl>::Thunk_UpdateSystemCursorController_0(
        __int64 a1,
        unsigned int **a2)
{
  __int64 v3; // r8
    ...
    if ( !*(_DWORD *)(v11 + 140) )
    {
      ...
      if ( *(_DWORD *)(v11 + 136) != GetCurrentThreadId() )
      {
        wil::details::in1diag3::_FailFast_Unexpected(
          ...
          v13);
        JUMPOUT(0x18001AC3CLL);
      }
      *(_DWORD *)(v11 + 136) = 0;
      LeaveCriticalSection((LPCRITICAL_SECTION)(v11 + 96));
    }
    v14 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 120LL))(a1 - 16);
    if ( v14 >= 0 )
    {
      if ( v12 )
      {
