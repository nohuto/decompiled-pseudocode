/*
 * XREFs of ?Thunk_RegisterInputAttemptedClient_0@?$IInputDeliveryServerPrincipal_Receive@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002A9A0
 * Callers:
 *     <none>
 * Callees:
