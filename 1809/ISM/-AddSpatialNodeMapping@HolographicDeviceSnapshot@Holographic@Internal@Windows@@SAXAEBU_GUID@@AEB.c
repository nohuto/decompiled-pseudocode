/*
 * XREFs of ?AddSpatialNodeMapping@HolographicDeviceSnapshot@Holographic@Internal@Windows@@SAXAEBU_GUID@@AEBUDynamicNodeInfo@234@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@Z @ 0x18010F174
 * Callers:
        ...
        __int64 a3)
{
  ...
  try
  {
    ...
    if ( *((_BYTE *)v6 + 120) )
    {
      ...
      if ( v11 != *((_QWORD *)v6 + 9) )
      {
        lambda_a56f457f58ac66e3e3dc9abfa35bf876_::operator()(v8, v11 + 48);
        v6 = v10;
      }
      if ( v6 )
