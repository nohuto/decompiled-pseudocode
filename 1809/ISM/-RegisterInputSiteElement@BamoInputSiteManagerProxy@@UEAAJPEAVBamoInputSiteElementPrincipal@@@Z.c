/*
 * XREFs of ?RegisterInputSiteElement@BamoInputSiteManagerProxy@@UEAAJPEAVBamoInputSiteElementPrincipal@@@Z @ 0x180014230
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoInputSiteElementPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    if ( a2 )
    {
      v8 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoInputSiteElementPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
