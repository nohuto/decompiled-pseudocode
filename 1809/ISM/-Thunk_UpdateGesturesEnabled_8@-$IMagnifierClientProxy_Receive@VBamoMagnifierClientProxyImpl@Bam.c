/*
 * XREFs of ?Thunk_UpdateGesturesEnabled_8@?$IMagnifierClientProxy_Receive@VBamoMagnifierClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180028F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMagnifierClientProxy_Receive<BamoImpl::BamoMagnifierClientProxyImpl>::Thunk_UpdateGesturesEnabled_8(
        __int64 a1,
        _BYTE **a2)
{
  __int64 v3; // rdi
