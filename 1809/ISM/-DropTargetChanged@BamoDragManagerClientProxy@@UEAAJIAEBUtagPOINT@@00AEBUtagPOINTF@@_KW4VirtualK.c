/*
 * XREFs of ?DropTargetChanged@BamoDragManagerClientProxy@@UEAAJIAEBUtagPOINT@@00AEBUtagPOINTF@@_KW4VirtualKeyModifiers@System@Windows@@@Z @ 0x1800139A0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a6)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 24LL) + 24LL) + 40LL) )
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      v23[1] = v16;
      v18 = v14;
      v10 = CoreUICallSend(v21, v23, 2LL, 11LL, 4, &unk_18014A9A9, a2);
      goto LABEL_7;
    }
