/*
 * XREFs of ?QueryInterface@BamoAttachableInputObjectSampleProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180012A40
 * Callers:
 *     ?QueryInterface@BamoAttachableInputObjectSampleProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18001B080 (-QueryInterface@BamoAttachableInputObjectSampleProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
