/*
 * XREFs of ??1?$unique_ptr@VMPCCursorManager@@U?$default_delete@VMPCCursorManager@@@std@@@std@@QEAA@XZ @ 0x1800433FC
 * Callers:
 *     _MPCHolographicInputManager::MPCHolographicInputManager_::_1_::dtor$7 @ 0x18012FBFA (_MPCHolographicInputManager--MPCHolographicInputManager_--_1_--dtor$7.c)
 * Callees:
...
void __fastcall std::unique_ptr<MPCCursorManager>::~unique_ptr<MPCCursorManager>(__int64 *a1)
{
  ...
  if ( *a1 )
  {
    ...
    if ( v3 )
      FreeLibrary(v3);
    operator delete((void *)v1, (const struct std::nothrow_t *)0x48);
  }
}
