/*
 * XREFs of ?SpatialObjectDeviceInitializationDone_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_WJ@Z @ 0x1800ACE64
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 2) != 0 && (*(_QWORD *)(v4 + 24) & 2LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v7 = a2;
    v10 = &v12;
    TlgWrite((TraceLoggingHProvider)v4, &unk_180169498, 0LL, 0LL, 4u, &pData);
  }
}
