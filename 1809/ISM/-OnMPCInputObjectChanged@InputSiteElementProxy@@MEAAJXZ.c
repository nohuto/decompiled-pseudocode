/*
 * XREFs of ?OnMPCInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18001F7D0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  v14 = *((_QWORD *)this + 15);
  v15 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 88LL))((char *)this + 8);
  if ( v15 )
  {
    v20 = this;
    v16 = v15 + 8;
