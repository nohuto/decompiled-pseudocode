/*
 * XREFs of ?StopActivity@DeviceRemoved@SpatialInteractionTrace@SpatialInteractionDevices@@MEAAXXZ @ 0x1800AAC60
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 4u )
    {
      ...
      v78 = v9 + 1;
      v79 = 0;
      TlgWrite(v6, &unk_180169000, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 4u )
    {
      ...
      v29 = CurrentThreadId;
      v83 = &v29;
      TlgWrite(v26, &unk_180168F53, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v80);
    }
  }
