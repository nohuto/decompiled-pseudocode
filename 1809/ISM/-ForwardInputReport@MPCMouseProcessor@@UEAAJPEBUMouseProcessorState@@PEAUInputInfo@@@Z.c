/*
 * XREFs of ?ForwardInputReport@MPCMouseProcessor@@UEAAJPEBUMouseProcessorState@@PEAUInputInfo@@@Z @ 0x1800FB750
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputInfo *a3)
{
  ...
  *((_DWORD *)this + 1230) += v8;
  ++*((_DWORD *)this + 1231);
  *((_DWORD *)this + 1202) = v8;
  if ( *((_BYTE *)MPCHolographicInputManager::GetInstance() + 1872)
    && *((_QWORD *)MPCHolographicInputManager::GetInstance() + 233) )
  {
    MPCMouseProcessor::ProcessPoints((MPCMouseProcessor *)((char *)this - 8), v9, v10);
    if ( !*((_BYTE *)this + 4793) )
    {
      *((_DWORD *)this + 1199) = *(_DWORD *)a2;
      *((_DWORD *)this + 1200) = *((_DWORD *)a2 + 1);
      *((_BYTE *)this + 4793) = 1;
    }
    v11 = *((_QWORD *)a3 + 2);
    if ( (unsigned __int64)(v11 - *((_QWORD *)this + 608)) <= *((_QWORD *)this + 619) )
    {
      v12 = *((_DWORD *)this + 1203);
    }
    else
    {
      *((_DWORD *)this + 1203) = 0;
    ...
    v13 = (double)*((int *)this + 1201);
    *((_QWORD *)this + 608) = v11;
    v14 = pow(v13, 2.0);
    v15 = pow((double)*((int *)this + 1202), 2.0);
    *((_DWORD *)this + 1203) = v12 + (int)sqrt(v14 + v15);
  ...
  else
  {
    ...
    v18 = (*(__int64 (__fastcall **)(_QWORD, const struct MouseProcessorState *, struct InputInfo *))(**((_QWORD **)this + 475) + 24LL))(
            *((_QWORD *)this + 475),
            a2,
            a3);
    v19 = v18;
