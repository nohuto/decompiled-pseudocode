        ...
        void *a5)
{
  ...
  {
    v10 = (__int64 *)v9;
    v12 = memcmp_0(a4, (const void *)(v9 + 28), 0x10uLL);
    v11 = v12 < 0;
    if ( v12 >= 0 )
      v9 = *(_QWORD *)(v9 + 16);
    else
