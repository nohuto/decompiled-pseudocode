/*
 * XREFs of ?Stop@DeviceAttached@RawInputProvidersTracing@@QEAAXJK@Z @ 0x18005FB64
 * Callers:
 ...
 *     wil::details::lambda_call__lambda_aa67300acd5065abc23a85a7f508fe1a___::_lambda_call__lambda_aa67300acd5065abc23a85a7f508fe1a___ @ 0x180063544 (wil--details--lambda_call__lambda_aa67300acd5065abc23a85a7f508fe1a___--_lambda_call__lambda_aa67.c)
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v8 + 3) & 0x400000000000LL) == *((_QWORD *)v8 + 3) )
    {
      ...
      v76 = &v89;
      v77 = 4LL;
      TlgWrite(v8, &unk_180168215, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x12u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v26 + 3) & 0x400000000000LL) == *((_QWORD *)v26 + 3) )
    {
      ...
      v85 = &v89;
      v86 = 4LL;
      TlgWrite(v26, &unk_180168183, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 6u, &v78);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
