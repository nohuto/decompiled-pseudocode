/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_POINTER_INPUT_DOWN_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_POINTER_INPUT_DOWN_MESSAGE@@@Z@std@@@Z @ 0x18008C920
 * Callers:
...
struct ISMTestMode *__fastcall KernelInputConnection<_MIT_POINTER_INPUT_DOWN_MESSAGE>::Initialize(
        _QWORD *a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    v16 = (*(__int64 (__fastcall **)(__int64, __int64 (__fastcall *)(), _QWORD *, _QWORD, _QWORD *))(*(_QWORD *)v15 + 80LL))(
            v15,
            KernelInputConnection<_MIT_POINTER_INPUT_DOWN_MESSAGE>::s_OnKernelInputEventStatic,
            a1,
            *a1,
            a1 + 2);
    if ( v16 < 0 )
    ...
    if ( v17 < 0 )
    {
      ...
      JUMPOUT(0x18008CB0FLL);
    }
    result = (struct ISMTestMode *)MITCoreMsgKOpenConnectionTo(6LL, a1 + 3);
    if ( (int)result < 0 )
    {
