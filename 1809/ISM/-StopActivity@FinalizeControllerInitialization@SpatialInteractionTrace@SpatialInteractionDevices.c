/*
 * XREFs of ?StopActivity@FinalizeControllerInitialization@SpatialInteractionTrace@SpatialInteractionDevices@@MEAAXXZ @ 0x1800AA5B0
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x400000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v70 = 2 * v9 + 2;
      v71 = 0;
      TlgWrite(v6, &unk_180169128, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
    if ( v5 )
      ReleaseSRWLockExclusive(v5);
    v24 = (const struct _TlgProvider_t *)*((_QWORD *)SpatialInteractionDevices::SpatialInteractionTrace::Instance() + 1);
    if ( *(_DWORD *)v24 > 4u
      ...
      && (*((_QWORD *)v24 + 3) & 0x400000000000LL) == *((_QWORD *)v24 + 3) )
    {
      ...
      v30 = CurrentThreadId;
      v75 = &v30;
      TlgWrite(v24, &unk_180169D3F, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v72);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
