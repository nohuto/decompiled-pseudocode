/*
 * XREFs of ?ProcessCursorData@MPCHolographicInputManager@@AEAAXPEAUIMPCInputProviderBase@@AEBUHitTestResult3D@@W4MPCCursorId@@AEAUCursor3DHitData@@@Z @ 0x180041C34
 * Callers:
        ...
        __int64 a5)
{
  ...
  *(_DWORD *)(a5 + 164) = (__int64)(*(_QWORD *)(a1 + 2096) - *(_QWORD *)(a1 + 2088)) >> 3;
  ...
  *(_DWORD *)(a5 + 168) = v11;
  if ( v5 == 1 )
  {
    ...
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(***(_QWORD ***)(a1 + 2088) + 80LL))(**(_QWORD **)(a1 + 2088)) )
      v12 = 0;
LABEL_9:
    *(_BYTE *)(a5 + 160) = v12;
  }
  v15 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(a1 + 1856) + 104LL))(*(_QWORD *)(a1 + 1856), a5);
  if ( v15 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
  ...
  *(float *)&v29[1] = v25;
  *(float *)(a1 + 196) = v25;
  *(_OWORD *)(a1 + 1912) = *(_OWORD *)a5;
  *(_OWORD *)(a1 + 1928) = *(_OWORD *)(a5 + 16);
  *(_OWORD *)(a1 + 1944) = *(_OWORD *)(a5 + 32);
  *(_OWORD *)(a1 + 1960) = *(_OWORD *)(a5 + 48);
  *(_OWORD *)(a1 + 1976) = *(_OWORD *)(a5 + 64);
  *(_OWORD *)(a1 + 1992) = *(_OWORD *)(a5 + 80);
  *(_OWORD *)(a1 + 2008) = *(_OWORD *)(a5 + 96);
  result = a1 + 2040;
  *(_OWORD *)(a1 + 2024) = *(_OWORD *)(a5 + 112);
  *(_OWORD *)(a1 + 2040) = *(_OWORD *)(a5 + 128);
  *(_OWORD *)(a1 + 2056) = *(_OWORD *)(a5 + 144);
  *(_OWORD *)(a1 + 2072) = *(_OWORD *)(a5 + 160);
  return result;
}
