/*
 * XREFs of ?IsPopulatingCursorData@MPCGestureHandlerManager@@QEAA_NV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x180046134
 * Callers:
...
bool __fastcall MPCGestureHandlerManager::IsPopulatingCursorData(__int64 a1, unsigned __int64 *a2)
{
  int v3; // r9d
  __int64 *v4; // rax
  __int64 *v5; // rcx
...
LABEL_9:
  ...
  {
    v8 = *(_QWORD *)(*(_QWORD *)std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::operator[](v3)
                   + 896LL);
    v9 = *(_BYTE *)(v8 + 172) && *(_DWORD *)(v8 + 168);
    if ( *a2 )
      (*(void (__fastcall **)(unsigned __int64, _QWORD))(*(_QWORD *)*a2 + 16LL))(*a2, *(_QWORD *)*a2);
    return v9;
  }
}
