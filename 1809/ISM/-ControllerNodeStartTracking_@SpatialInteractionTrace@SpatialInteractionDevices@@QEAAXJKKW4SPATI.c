/*
 * XREFs of ?ControllerNodeStartTracking_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJKKW4SPATIAL_TRACKING_STATE@@_NKAEBUDynamicNodeInfo@Holographic@Internal@Windows@@@Z @ 0x180122A00
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( *(_DWORD *)v9 > 4u && (*((_QWORD *)v9 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( v8 == *((struct SpatialInteractionDevices::SpatialInteractionTrace **)v9 + 3) )
    {
      ...
      v27 = 16LL;
      v29 = 4LL;
      LODWORD(v8) = TlgWrite(v9, &unk_18016E382, 0LL, 0LL, 0xAu, &pData);
    }
  }
  return (int)v8;
}
