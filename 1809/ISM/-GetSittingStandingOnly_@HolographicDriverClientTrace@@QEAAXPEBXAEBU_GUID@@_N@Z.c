/*
 * XREFs of ?GetSittingStandingOnly_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@_N@Z @ 0x18010C898
 * Callers:
        ...
        char a4)
{
  ...
  if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 2) != 0 && (*(_QWORD *)(v5 + 24) & 2LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v10 = 16LL;
    v12 = 1LL;
    TlgWrite((TraceLoggingHProvider)v5, &unk_18016C88E, 0LL, 0LL, 5u, &pData);
  }
}
