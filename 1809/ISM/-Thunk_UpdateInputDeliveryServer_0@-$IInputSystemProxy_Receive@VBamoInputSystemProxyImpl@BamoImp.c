/*
 * XREFs of ?Thunk_UpdateInputDeliveryServer_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A3E0
 * Callers:
 *     <none>
 * Callees:
