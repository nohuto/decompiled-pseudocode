/*
 * XREFs of ?GetProcessIdFromViewId@ViewHelper@@SAKPEAUIViewHierarchy@@I@Z @ 0x18000C9E0
 * Callers:
...
__int64 __fastcall ViewHelper::GetProcessIdFromViewId(struct IViewHierarchy *a1, unsigned int a2)
{
  ...
  if ( v12 )
  {
    ...
    if ( WindowW >= 0 )
    {
      ...
      if ( v11 )
      {
        v5 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v11 + 128LL))(v11, &v10);
        if ( v5 < 0 )
        {
