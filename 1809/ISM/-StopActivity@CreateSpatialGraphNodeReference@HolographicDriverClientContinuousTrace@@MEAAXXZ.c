/*
 * XREFs of ?StopActivity@CreateSpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@MEAAXXZ @ 0x18010E3F0
 * Callers:
 *     <none>
 * Callees:
        ...
        HolographicDriverClientContinuousTrace::CreateSpatialGraphNodeReference *this)
{
  ...
  const WCHAR *v52; // [rsp+D0h] [rbp-30h]
  ...
  const WCHAR *v65; // [rsp+120h] [rbp+20h]
  ...
  const WCHAR *v73; // [rsp+150h] [rbp+50h]
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      v81 = v9 + 1;
      v82 = 0;
      TlgWrite(v6, &unk_18016CC23, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 5u )
    {
      ...
      v32 = CurrentThreadId;
      v86 = &v32;
      TlgWrite(v26, &unk_18016C497, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v83);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
