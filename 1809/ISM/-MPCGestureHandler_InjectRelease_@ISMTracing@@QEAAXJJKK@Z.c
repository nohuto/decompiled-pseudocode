/*
 * XREFs of ?MPCGestureHandler_InjectRelease_@ISMTracing@@QEAAXJJKK@Z @ 0x18004EDE8
 * Callers:
...
void __fastcall ISMTracing::MPCGestureHandler_InjectRelease_(ISMTracing *this, int a2, int a3, int a4, char a5)
{
  _DWORD *v5; // rcx
  __int64 v6; // rcx
  ...
  if ( v5 )
  {
    if ( *v5 )
    {
      ...
      if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
      {
        ...
        v15 = 4;
        v18 = 4;
        TlgWrite((TraceLoggingHProvider)v6, &unk_1801677A5, 0LL, 0LL, 6u, &pData);
      }
    }
  }
}
