/*
 * XREFs of ?InitializeValueCaps@Internal@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@2@@Z @ 0x1800A8918
 * Callers:
        ...
        struct SpatialInteractionDevices::HID_HANDLE *a2)
{
  ...
  __int64 v49; // r8
  __int64 v50; // rdx
  struct _HIDP_PREPARSED_DATA *v51; // r9
  unsigned int v52; // eax
  unsigned __int64 v53; // rax
  struct _HIDP_VALUE_CAPS *v54; // rax
  const struct std::nothrow_t *v55; // rdx
  void *v56; // rcx
  unsigned int v57; // eax
  char v58; // di
  RegistryHelpers *v59; // rcx
  bool v60; // zf
  char v61; // al
  RegistryHelpers *v62; // rcx
  int DwordWithDefault; // eax
  struct SpatialInteractionDevices::HID_HANDLE *v64; // rdx
...
LABEL_44:
    ...
    if ( v32 )
    {
      ...
      if ( v32 && *((_WORD *)this + 61) )
      {
        ...
        *((_QWORD *)this + 24) = v43;
        ...
        v47 = *((_QWORD *)this + 24);
        v48 = 72LL * ValueCapsLength;
        v49 = (unsigned __int128)(v48 * (__int128)0xE38E38E38E38E39LL) >> 64;
        v50 = v48 + v47;
        LOBYTE(v48) = ValueCapsLength;
        std::_Sort_unchecked__HIDP_BUTTON_CAPS_____ptr64__lambda_cc7dd983a7a4322fbd155d916a9399c1___(
          v47,
          v50,
          ((unsigned __int64)v49 >> 63) + (v49 >> 2),
          v48);
    ...
    {
      v51 = (struct _HIDP_PREPARSED_DATA *)*((_QWORD *)this + 7);
      ValueCapsLength = 0;
      v52 = HidP_GetValueCaps(HidP_Output, 0LL, &ValueCapsLength, v51);
      if ( v52 != -1072627705 )
      {
        v18 = SpatialInteractionDevices::HidStatus((SpatialInteractionDevices *)v52);
        if ( v18 < 0 )
        {
          v19 = 452LL;
          return wil::details::in1diag3::Return_NtStatus(
      ...
      v53 = 72LL * ValueCapsLength;
      if ( !is_mul_ok(ValueCapsLength, 0x48uLL) )
        v53 = -1LL;
      v54 = (struct _HIDP_VALUE_CAPS *)operator new[](v53, (const struct std::nothrow_t *)&std::nothrow);
      v56 = (void *)*((_QWORD *)this + 20);
      *((_QWORD *)this + 20) = v54;
      if ( v56 )
      {
        operator delete(v56, v55);
        v54 = (struct _HIDP_VALUE_CAPS *)*((_QWORD *)this + 20);
      }
      if ( !v54 )
      {
        v6 = 456LL;
      ...
      v57 = HidP_GetValueCaps(HidP_Output, v54, &ValueCapsLength, *((PHIDP_PREPARSED_DATA *)this + 7));
      v18 = SpatialInteractionDevices::HidStatus((SpatialInteractionDevices *)v57);
      if ( v18 < 0 )
      {
        v19 = 458LL;
        return wil::details::in1diag3::Return_NtStatus(
    ...
    *((_BYTE *)this + 235) = (unsigned int)RegistryHelpers::GetDwordWithDefault(
                                             ...
                                             0LL) == 1;
    if ( v58
      || (v60 = (unsigned int)RegistryHelpers::GetDwordWithDefault(
                                v59,
                                (const WCHAR *)&stru_1801510A0,
    ...
    *((_BYTE *)this + 234) = DwordWithDefault == 1;
    v7 = SpatialInteractionDevices::PrepareSpatialInteractionDeviceParsing(this, v64);
    if ( v7 < 0 )
    {
      v6 = 480LL;
      goto LABEL_6;
