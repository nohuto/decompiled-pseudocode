/*
 * XREFs of ?NodePropertyCache_SetValue_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0PEBX_K@Z @ 0x18010D608
 * Callers:
        ...
        char a6)
{
  ...
  if ( *(_DWORD *)v9 > 4u && (*(_BYTE *)(v9 + 16) & 2) != 0 && (*(_QWORD *)(v9 + 24) & 2LL) == *(_QWORD *)(v9 + 24) )
  {
    ...
    v16 = 16LL;
    v18 = 8LL;
    TlgWrite((TraceLoggingHProvider)v9, &unk_18016C18B, 0LL, 0LL, 6u, &pData);
  }
}
