/*
 * XREFs of ?SendLampRangeUpdateReport@HidLampArrayDevice@@QEAAJPEBULampRangeUpdateDeviceReport@@@Z @ 0x18007A63C
 * Callers:
        ...
        const struct LampRangeUpdateDeviceReport *a2)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    v25 = 2 * v5 + 2;
    v26 = 0;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1801688A1, 0LL, 0LL, 4u, &pData);
  }
  v8 = *((_QWORD *)this + 77);
  ReportBufferLength = 0;
  ReportBuffer = 0LL;
  v9 = HidLampRangeUpdateReportParser::CreateAndInitializeOutputBuffer(v8, a2, &ReportBuffer, &ReportBufferLength);
  v10 = v9;
  if ( v9 >= 0 )
  {
    v13 = ReportBuffer;
    if ( HidD_SetFeature(*(HANDLE *)(*((_QWORD *)this + 2) + 40LL), ReportBuffer, ReportBufferLength) )
    {
      if ( (unsigned int)hProvider > 5 )
      {
        ...
        v31 = 2 * v18 + 2;
        v32 = 0;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1801688A1, 0LL, 0LL, 4u, &v27);
      }
      if ( v13 )
