/*
 * XREFs of ?ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z @ 0x1800EAC64
 * Callers:
...
__int64 __fastcall ButtonProcessor::ButtonToVKeyMapping(ButtonProcessor *this, unsigned int a2, unsigned __int16 *a3)
{
  ...
  if ( a2 > 7 )
  {
    ...
    if ( !v9 )
    {
      v3 = *((_BYTE *)this + 57) == 0 ? 0x80004001 : 0;
      v4 = *((_BYTE *)this + 57) != 0 ? 0x5F : 0;
      goto LABEL_47;
    }
    v10 = v9 - 13;
    if ( !v10 )
