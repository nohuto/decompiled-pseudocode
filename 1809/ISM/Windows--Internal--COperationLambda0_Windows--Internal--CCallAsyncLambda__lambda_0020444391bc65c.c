/*
 * XREFs of Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_0020444391bc65c77824af03bb11f5f3____Windows::Internal::CNoResult_::Run @ 0x1800E2680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_0020444391bc65c77824af03bb11f5f3____Windows::Internal::CNoResult_::Run(
        __int64 a1,
        int a2,
        int a3,
        __int64 a4)
{
  ...
  if ( a2 == 1 && a3 >= 0 )
  {
    ...
    v8 = *v7;
    StringRawBuffer = WindowsGetStringRawBuffer(*(HSTRING *)(a1 + 48), 0LL);
    v10 = v13[0];
    v11 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, _QWORD, PCWSTR, __int64, _QWORD))(v8 + 24))(
            v7,
            *(unsigned int *)(a1 + 16),
            *(unsigned int *)(a1 + 20),
            StringRawBuffer,
