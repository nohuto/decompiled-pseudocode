/*
 * XREFs of ?OnMenuPressed@MPCManagerClientPrincipal@@UEAAJPEAVBamoMPCManagerClientStub@@AEBULegacyDeviceInfo@@I@Z @ 0x1800DF400
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  *v5 = *(_OWORD *)a3;
  ...
  v5[4] = v17;
  *((_QWORD *)v5 + 10) = v13;
  v18 = *(_QWORD *)(*((_QWORD *)this + 7) + 1048LL);
  result = 0LL;
  if ( v18 )
