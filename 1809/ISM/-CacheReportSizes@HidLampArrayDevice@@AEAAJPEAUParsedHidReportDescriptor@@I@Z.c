/*
 * XREFs of ?CacheReportSizes@HidLampArrayDevice@@AEAAJPEAUParsedHidReportDescriptor@@I@Z @ 0x18007B858
 * Callers:
    ...
    if ( a3 )
    {
      ...
      do
      {
        *(_BYTE *)(v11 + *((_QWORD *)this + 78)) = *((_BYTE *)v13 - 4);
        ...
        v14 = *v13;
        v13 += 6;
        *(_DWORD *)(v11 + *((_QWORD *)this + 78) - 4) = (unsigned int)(*(_DWORD *)(*((_QWORD *)v13 - 2)
