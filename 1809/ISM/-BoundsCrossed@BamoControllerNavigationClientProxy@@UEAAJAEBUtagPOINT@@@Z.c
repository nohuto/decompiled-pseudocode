/*
 * XREFs of ?BoundsCrossed@BamoControllerNavigationClientProxy@@UEAAJAEBUtagPOINT@@@Z @ 0x18002BE00
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagPOINT *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v11[0] = v13;
      v11[1] = v14;
      v4 = CoreUICallSend(v9, v11, 2LL, 3LL, 0, &unk_18014A97B, (unsigned int)&v15);
      goto LABEL_7;
    }
    v6 = (unsigned int)v7;
    v5 = 39211LL;
