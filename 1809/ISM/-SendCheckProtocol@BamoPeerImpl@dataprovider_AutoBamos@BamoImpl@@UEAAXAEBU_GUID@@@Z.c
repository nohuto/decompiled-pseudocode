/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x18009B850
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  v7 = v2;
  v5 = CoreUICallSend(v4, v6, 2LL, 6LL, 0, &unk_18014BF4B, (unsigned int)&v7);
  if ( v5 < 0 )
  {
