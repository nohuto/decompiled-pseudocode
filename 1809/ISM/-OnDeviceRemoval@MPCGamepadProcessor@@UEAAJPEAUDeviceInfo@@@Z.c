/*
 * XREFs of ?OnDeviceRemoval@MPCGamepadProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x1800F8250
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCGamepadProcessor::OnDeviceRemoval(MPCGamepadProcessor *this, struct DeviceInfo *a2)
{
  ...
  if ( v4 < 0 )
  {
    ...
    JUMPOUT(0x1800F82A4LL);
  }
  return (*(__int64 (__fastcall **)(_QWORD, struct DeviceInfo *))(**((_QWORD **)this + 470) + 40LL))(
           *((_QWORD *)this + 470),
           a2);
}
