/*
 * XREFs of ?InputAttempted@BamoInputAttemptedDeliveryClientProxy@@UEAAJXZ @ 0x1800296A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputAttemptedDeliveryClientProxy::InputAttempted(BamoInputAttemptedDeliveryClientProxy *this)
{
  ...
  volatile signed __int32 *v12; // [rsp+78h] [rbp+20h] BYREF
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    ...
    {
      v7[1] = v10;
      v2 = CoreUICallSend(v11, v7, 2LL, 21LL, 0, &unk_18014A98B, v9);
      goto LABEL_7;
    }
    v4 = (unsigned int)v5;
    v3 = 45485LL;
