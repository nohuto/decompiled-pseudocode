/*
 * XREFs of ?InitializeConstants@MPCSixDofProcessor@@EEAAXXZ @ 0x1800EE9F0
 * Callers:
...
void __fastcall MPCSixDofProcessor::InitializeConstants(MPCSixDofProcessor *this)
{
  ...
  if ( !std::_Execute_once(
          ...
          (int (*)(void *, void *, void **))std::_Callback_once<std::tuple<_lambda_0f4dc4d9939fbd6684d3ea70cabfe910_ &&,std::exception_ptr &>,std::integer_sequence<unsigned __int64,0>,1>,
          v3) )
  {
