/*
 * XREFs of ??$_Insert@AEAU?$pair@$$CBKV?$ComPtr@VPointerInfoAdapter@@@WRL@Microsoft@@@std@@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKV?$ComPtr@VPointerInfoAdapter@@@WRL@Microsoft@@@std@@@std@@@std@@@2@@?$_Hash@V?$_Umap_traits@KV?$ComPtr@VPointerInfoAdapter@@@WRL@Microsoft@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKV?$ComPtr@VPointerInfoAdapter@@@WRL@Microsoft@@@std@@@5@$0A@@std@@@std@@IEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKV?$ComPtr@VPointerInfoAdapter@@@WRL@Microsoft@@@std@@@std@@@std@@@std@@_N@1@AEAU?$pair@$$CBKV?$ComPtr@VPointerInfoAdapter@@@WRL@Microsoft@@@1@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKV?$ComPtr@VPointerInfoAdapter@@@WRL@Microsoft@@@std@@@std@@@std@@@1@@Z @ 0x1800857DC
 * Callers:
        ...
        _QWORD **a4)
{
  ...
  __int64 v31; // rdi
  _QWORD *iter; // rax
  __int64 v33[2]; // [rsp+20h] [rbp-38h] BYREF
...
LABEL_10:
    ...
    {
      v20 = *(void ***)(v18 + 8 * v11 + 8);
      v21 = (_QWORD **)*v20;
      *(_QWORD *)(v18 + 8 * v11 + 8) = *v20;
      if ( v21 != a4 )
      {
        v22 = *((_QWORD *)a1 + 3);
        v23 = *(_QWORD *)(*(_QWORD *)(v22 + 8 * v11 + 8) + 8LL);
        *(_QWORD *)(v22 + 8 * v11 + 8) = v23;
      }
    }
    v24 = *((_QWORD *)a1 + 2);
    v25 = *((_QWORD *)a1 + 7);
