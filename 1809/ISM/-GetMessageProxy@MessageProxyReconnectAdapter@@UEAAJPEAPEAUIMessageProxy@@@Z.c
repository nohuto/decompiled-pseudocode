/*
 * XREFs of ?GetMessageProxy@MessageProxyReconnectAdapter@@UEAAJPEAPEAUIMessageProxy@@@Z @ 0x180010440
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IMessageProxy **a2)
{
  ...
  else
  {
    ...
    if ( (Microsoft_WindowsPhone_InputEnableBits & 1) != 0 )
      McTemplateU0sqq((__int64)this, 0LL, (__int64)"MessageProxyReconnectAdapter::GetMessageProxy", 103LL, 87);
  }
  return v2;
}
