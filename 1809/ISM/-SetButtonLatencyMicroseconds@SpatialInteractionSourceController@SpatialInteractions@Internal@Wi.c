/*
 * XREFs of ?SetButtonLatencyMicroseconds@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAAXH@Z @ 0x180125070
 * Callers:
        ...
        int a2)
{
  ...
  _InterlockedExchange64((volatile __int64 *)this + 86, qword_180193A98 * a2 / 1000000);
