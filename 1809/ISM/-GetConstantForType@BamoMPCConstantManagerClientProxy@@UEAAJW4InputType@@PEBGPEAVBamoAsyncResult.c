/*
 * XREFs of ?GetConstantForType@BamoMPCConstantManagerClientProxy@@UEAAJW4InputType@@PEBGPEAVBamoAsyncResult_PROPVARIANT_Principal@@@Z @ 0x1800DD6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCConstantManagerClientProxy::GetConstantForType(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // ebx
  __int64 v8; // r9
  __int64 v9; // rdx
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 24LL) + 24LL) + 40LL) )
  {
    if ( a4 )
    {
      v10 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a4 + 32LL))(a4);
    ...
    if ( v11 >= 0 )
    {
      v16[0] = v18;
      v16[1] = v13;
      v7 = CoreUICallSend(v14, v16, 2LL, 1LL, 3, &unk_18014AFBF, a2);
      goto LABEL_9;
    }
    v8 = (unsigned int)v11;
    v9 = 6955LL;
