        ...
        _QWORD *a2)
{
  ...
  if ( v4 )
  {
    v5 = (void (__fastcall ***)(_QWORD))(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v4 + 8LL))(v4);
    (**v5)(v5);
  }
