 ...
 *     ?_Buynode0@?$_Tree_comp_alloc@V?$_Tmap_traits@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@UTrackedDeviceSnapshot@Holographic@Internal@Windows@@UCaseInsensitiveStringLess@456@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@UTrackedDeviceSnapshot@Holographic@Internal@Windows@@@std@@@2@$0A@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@UTrackedDeviceSnapshot@Holographic@Internal@Windows@@@std@@PEAX@2@XZ @ 0x18012142C (-_Buynode0@-$_Tree_comp_alloc@V-$_Tmap_traits@V-$basic_string@_WU-$char_traits@_W@s_ea_18012142C.c)
        ...
        __int64 *a3)
{
  ...
  *(_WORD *)(v4 + 24) = 0;
  try
  {
    ...
    memset_0((void *)(v5 + 64), 0, 0x128uLL);
    *(_QWORD *)(v5 + 80) = 0LL;
    *(_QWORD *)(v5 + 88) = 7LL;
    *(_WORD *)(v5 + 64) = 0;
    *(_QWORD *)(v5 + 96) = 0LL;
    ...
    *(_DWORD *)(v5 + 160) = 0;
    *(_QWORD *)(v5 + 168) = 0LL;
    memset_0((void *)(v5 + 176), 0, 0xA0uLL);
    *(_QWORD *)(v5 + 336) = 0LL;
    *(_DWORD *)(v5 + 344) = 0;
    *(_QWORD *)(v5 + 352) = 0LL;
    result = v5;
