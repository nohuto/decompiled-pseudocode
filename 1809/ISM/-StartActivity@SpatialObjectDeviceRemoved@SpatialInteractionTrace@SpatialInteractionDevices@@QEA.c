/*
 * XREFs of ?StartActivity@SpatialObjectDeviceRemoved@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_W@Z @ 0x1800ACCF8
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)v6 > 4u )
  {
    ...
    TlgWrite(v6, &unk_18016A23C, (LPCGUID)(v8 + 8), v9, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
