/*
 * XREFs of dllmain_crt_process_attach @ 0x18012B168
 * Callers:
 *     dllmain_crt_dispatch @ 0x18012B110 (dllmain_crt_dispatch.c)
 * Callees:
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18012B574 (-__scrt_initialize_type_info@@YAXXZ.c)
 ...
 *     __scrt_dllmain_before_initialize_c @ 0x18012B63C (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_crt @ 0x18012B760 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x18012B890 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18012B930 (__scrt_release_startup_lock.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18012BA08 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18012BA28 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18012BB7C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18012BDD6 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18012BDE2 (_initterm_e_0.c)
