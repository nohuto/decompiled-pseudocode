/*
 * XREFs of ?AsWeak@?$ComPtr@UISpatialGraphNodePropertiesUpdatedCallback@Holographic@Internal@Windows@@@WRL@Microsoft@@QEBAJPEAVWeakRef@23@@Z @ 0x1801183DC
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<Windows::Internal::Holographic::ISpatialGraphNodePropertiesUpdatedCallback>::AsWeak(
