/*
 * XREFs of ?Thunk_RegisterMagnifierClient_0@?$IMagnifierServerPrincipal_Receive@VBamoMagnifierServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180029450
 * Callers:
 *     <none>
 * Callees:
