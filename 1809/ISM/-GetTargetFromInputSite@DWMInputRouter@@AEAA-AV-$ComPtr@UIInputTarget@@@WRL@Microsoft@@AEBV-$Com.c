/*
 * XREFs of ?GetTargetFromInputSite@DWMInputRouter@@AEAA?AV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@AEBV?$ComPtr@VInputSite@@@34@W4InputType@@AEBUInternalHitTestResult@HitTestHelper@@AEBU_LUID@@AEAV?$ComPtr@UIDCompInputTarget@@@34@@Z @ 0x18008A33C
 * Callers:
        ...
        _QWORD *a7)
{
  ...
  InputSite *v32; // [rsp+60h] [rbp-89h] BYREF
...
LABEL_43:
  ...
  LegacyInputSinkData = InputSite::GetLegacyInputSinkData(*a3);
  v12 = LegacyInputSinkData;
  v33 = LegacyInputSinkData;
  if ( *a7 )
  {
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)*a7 + 40LL))(
           *a7,
           *(_QWORD *)LegacyInputSinkData) )
    {
      v13 = *a2;
      if ( *a2 )
      {
  ...
  if ( (unsigned int)(*(_DWORD *)CompositionInputQueue - 3) <= 1 )
  {
    ...
    v32 = v22;
    if ( v22 )
      (*(void (__fastcall **)(InputSite *))(*(_QWORD *)v22 + 8LL))(v22);
    ...
    DWMInputRouter::CreateAndRegisterTarget((__int64)this, (__int64)&v37, (__int64 *)&v32, a2);
  }
  else if ( ((1LL << gdwDeviceFamily) & 0x224A) != 0 && *(_DWORD *)CompositionInputQueue == 2 )
  {
    ...
    if ( (**(int (__fastcall ***)(_QWORD, GUID *, __int64 *))*a2)(*a2, &GUID_05b38163_1229_4e7b_a0fc_5b47c4e7b631, &v31) >= 0 )
    {
      ...
      v32 = v18;
      if ( v18 )
        (*(void (__fastcall **)(InputSite *))(*(_QWORD *)v18 + 8LL))(v18);
