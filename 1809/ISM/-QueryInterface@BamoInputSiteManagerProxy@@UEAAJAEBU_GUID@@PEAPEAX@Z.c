/*
 * XREFs of ?QueryInterface@BamoInputSiteManagerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800141B0
 * Callers:
 *     ?QueryInterface@BamoInputSiteManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18001B0D0 (-QueryInterface@BamoInputSiteManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
