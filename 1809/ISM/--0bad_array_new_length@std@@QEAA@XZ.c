/*
 * XREFs of ??0bad_array_new_length@std@@QEAA@XZ @ 0x18012C3A0
 * Callers:
 *     ?__scrt_throw_std_bad_array_new_length@@YAXXZ @ 0x18012C43C (-__scrt_throw_std_bad_array_new_length@@YAXXZ.c)
 * Callees:
 *     <none>
 */
