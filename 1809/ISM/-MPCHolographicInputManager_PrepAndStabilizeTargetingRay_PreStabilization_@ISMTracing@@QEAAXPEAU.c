/*
 * XREFs of ?MPCHolographicInputManager_PrepAndStabilizeTargetingRay_PreStabilization_@ISMTracing@@QEAAXPEAULegacyInputInfo@@@Z @ 0x180044814
 * Callers:
        ...
        struct LegacyInputInfo *a2)
{
  ...
  if ( *(_DWORD *)v3 > 5u && (*(_BYTE *)(v3 + 16) & 1) != 0 && (*(_QWORD *)(v3 + 24) & 1LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v16 = 4LL;
    v18 = 4LL;
    TlgWrite((TraceLoggingHProvider)v3, &unk_180167164, 0LL, 0LL, 9u, &pData);
  }
}
