/*
 * XREFs of ?SendMaterializeProxy@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800E9A10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoAsyncResult_PROPVARIANT_PrincipalImpl::SendMaterializeProxy(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v7 = CoreUICallSend(a2, &v12, 2LL, 0LL, 2, &unk_18014B005, v10);
  if ( v7 < 0 )
  {
