/*
 * XREFs of ?Thunk_UpdateControllerNavigationManager_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A740
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( !*(_DWORD *)(v11 + 140) )
    {
      ...
      if ( *(_DWORD *)(v11 + 136) != GetCurrentThreadId() )
      {
        wil::details::in1diag3::_FailFast_Unexpected(
          ...
          v13);
        JUMPOUT(0x18001A8DCLL);
      }
      *(_DWORD *)(v11 + 136) = 0;
      LeaveCriticalSection((LPCRITICAL_SECTION)(v11 + 96));
    }
    v14 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 104LL))(a1 - 16);
    if ( v14 >= 0 )
    {
      if ( v12 )
      {
