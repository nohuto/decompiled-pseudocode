/*
 * XREFs of ?Unregister@BamoDataProviderRegistrarProxy@@UEAAJPEAVBamoDataProviderPrincipal@@@Z @ 0x180098E60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoDataProviderPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    if ( a2 )
    {
      v7 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoDataProviderPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
    ...
    if ( v8 >= 0 )
    {
      v11[0] = v13;
      v11[1] = v14;
      v4 = CoreUICallSend(v15, v11, 2LL, 2LL, 1, &unk_18014BF1D, (_DWORD)a2);
      goto LABEL_9;
    }
    v5 = (unsigned int)v8;
    v6 = 8509LL;
