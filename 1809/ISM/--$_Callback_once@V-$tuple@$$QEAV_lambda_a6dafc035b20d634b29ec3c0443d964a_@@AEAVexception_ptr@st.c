/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_a6dafc035b20d634b29ec3c0443d964a_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180043BC0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a2)
{
  ...
  try
  {
    v2 = (MPCHolographicInputManager *)operator new(0x888uLL);
