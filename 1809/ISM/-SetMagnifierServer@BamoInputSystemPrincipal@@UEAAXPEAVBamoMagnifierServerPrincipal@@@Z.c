/*
 * XREFs of ?SetMagnifierServer@BamoInputSystemPrincipal@@UEAAXPEAVBamoMagnifierServerPrincipal@@@Z @ 0x18001BA50
 * Callers:
        ...
        struct BamoMagnifierServerPrincipal *a2)
{
  ...
  *((_QWORD *)v3 + 7) = a2;
  ...
  v5 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoDataSourcePrincipalImpl *>(
         v3,
         BamoImpl::BamoInputSystemPrincipalImpl::UpdateMagnifierServerRemoteCacheStatic,
         v3);
  if ( v5 < 0 )
  {
