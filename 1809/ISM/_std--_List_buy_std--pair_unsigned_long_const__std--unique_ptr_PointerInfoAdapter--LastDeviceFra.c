...
void __fastcall __noreturn std::_List_buy_std::pair_unsigned_long_const__std::unique_ptr_PointerInfoAdapter::LastDeviceFrame_std::default_delete_PointerInfoAdapter::LastDeviceFrame______std::allocator_std::pair_unsigned_long_const__std::unique_ptr_PointerInfoAdapter::LastDeviceFrame_std::default_delete_PointerInfoAdapter::LastDeviceFrame_________::_Buynode_unsigned_long_const_____ptr64_std::unique_ptr_PointerInfoAdapter::LastDeviceFrame_std::default_delete_PointerInfoAdapter::LastDeviceFrame______::_1_::catch_1(
        __int64 a1,
        __int64 a2)
{
