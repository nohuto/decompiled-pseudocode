/*
 * XREFs of ?OnButtonsChangedDuringHomeGesture@BamoMPCManagerClientProxy@@UEAAJIII_KI@Z @ 0x1800DC3A0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  volatile signed __int32 *v11; // [rsp+70h] [rbp-28h] BYREF
  _QWORD v12[3]; // [rsp+78h] [rbp-20h] BYREF
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      v12[0] = v14;
      v12[1] = v9;
      v4 = CoreUICallSend(v10, v12, 2LL, 4LL, 7, &unk_18014AFF1, a2);
      goto LABEL_7;
    }
    v6 = (unsigned int)v7;
    v5 = 8203LL;
