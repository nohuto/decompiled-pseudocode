/*
 * XREFs of ?SetDragNDropContextualProcessor@BamoInputSystemPrincipal@@UEAAXPEAVBamoDragNDropContextualProcessorPrincipal@@@Z @ 0x18001B8E0
 * Callers:
        ...
        struct BamoDragNDropContextualProcessorPrincipal *a2)
{
  ...
  *((_QWORD *)v3 + 5) = a2;
  ...
  v5 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoDataSourcePrincipalImpl *>(
         v3,
         BamoImpl::BamoInputSystemPrincipalImpl::UpdateDragNDropContextualProcessorRemoteCacheStatic,
         v3);
  if ( v5 < 0 )
  {
