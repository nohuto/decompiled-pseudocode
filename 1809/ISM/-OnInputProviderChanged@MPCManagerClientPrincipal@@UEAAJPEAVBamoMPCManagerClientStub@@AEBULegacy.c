/*
 * XREFs of ?OnInputProviderChanged@MPCManagerClientPrincipal@@UEAAJPEAVBamoMPCManagerClientStub@@AEBULegacyDeviceInfo@@I@Z @ 0x1800DF500
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  *(_DWORD *)(v4 + 1040) = a4;
  if ( v9 )
    return (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v9 + 40LL))(v9, v4 + 56, a4);
  return result;
}
