/*
 * XREFs of ?EffectiveHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXJKKE@Z @ 0x1801233AC
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v5 > 5u && (*(_BYTE *)(v5 + 16) & 2) != 0 && (*(_QWORD *)(v5 + 24) & 2LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v12 = 4LL;
    v14 = 1LL;
    TlgWrite((TraceLoggingHProvider)v5, &unk_18016DC33, 0LL, 0LL, 6u, &pData);
  }
}
