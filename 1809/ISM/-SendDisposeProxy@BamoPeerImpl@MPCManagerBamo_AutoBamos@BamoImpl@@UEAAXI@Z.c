/*
 * XREFs of ?SendDisposeProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x18003E5D0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v4 = CoreUICallSend(v3, v5, 2LL, 0LL, 9, &unk_18014B005, a2);
  if ( v4 < 0 )
  {
