/*
 * XREFs of ?GetConstantForDevice@BamoMPCConstantManagerClientProxy@@UEAAJIW4InputType@@PEBGPEAVBamoAsyncResult_PROPVARIANT_Principal@@@Z @ 0x1800DD7F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCConstantManagerClientProxy::GetConstantForDevice(
        __int64 a1,
        int a2,
        __int64 a3,
        __int64 a4,
        __int64 a5)
{
  ...
  struct IMessageCallSendHost *v14; // [rsp+58h] [rbp-40h] BYREF
  volatile signed __int32 *v15[2]; // [rsp+60h] [rbp-38h] BYREF
  _QWORD v16[2]; // [rsp+70h] [rbp-28h] BYREF
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 24LL) + 24LL) + 40LL) )
  {
    if ( a5 )
    {
      v10 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a5 + 32LL))(a5);
    ...
    if ( v11 >= 0 )
    {
      v16[0] = v18;
      v16[1] = v13;
      v7 = CoreUICallSend(v14, v16, 2LL, 1LL, 2, &unk_18014AFB9, a2);
      goto LABEL_9;
    }
    v8 = (unsigned int)v11;
    v9 = 6931LL;
