/*
 * XREFs of ?SetError@BamoAsyncResult_PROPVARIANT_Proxy@@UEAAJH@Z @ 0x1800DDC90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoAsyncResult_PROPVARIANT_Proxy::SetError(BamoAsyncResult_PROPVARIANT_Proxy *this, int a2)
{
  ...
  __int64 v6; // r9
  int v7; // eax
  volatile signed __int32 *v9; // [rsp+40h] [rbp-38h] BYREF
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      v10[0] = v12;
      v10[1] = v13;
      v4 = CoreUICallSend(v14, v10, 2LL, 0LL, 1, &unk_18014AFA5, a2);
      goto LABEL_7;
    }
    v6 = (unsigned int)v7;
    v5 = 6371LL;
