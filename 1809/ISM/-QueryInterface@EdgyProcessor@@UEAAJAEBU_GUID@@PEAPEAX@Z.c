/*
 * XREFs of ?QueryInterface@EdgyProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CA8C0
 * Callers:
 *     ?QueryInterface@EdgyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CACF0 (-QueryInterface@EdgyProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
