/*
 * XREFs of _std::vector_DWMInputRouter::DeviceDisplayMapping_std::allocator_DWMInputRouter::DeviceDisplayMapping___::_Emplace_reallocate_DWMInputRouter::DeviceDisplayMapping__::_1_::catch$8 @ 0x18013244F
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_DWMInputRouter::DeviceDisplayMapping_std::allocator_DWMInputRouter::DeviceDisplayMapping___::_Emplace_reallocate_DWMInputRouter::DeviceDisplayMapping__::_1_::catch_8(
        __int64 a1,
        __int64 a2)
{
  __int64 v3; // rcx
