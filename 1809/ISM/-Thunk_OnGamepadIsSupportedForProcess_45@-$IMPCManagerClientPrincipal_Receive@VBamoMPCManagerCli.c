/*
 * XREFs of ?Thunk_OnGamepadIsSupportedForProcess_45@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800DFE80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCManagerClientPrincipal_Receive<BamoImpl::BamoMPCManagerClientPrincipalImpl>::Thunk_OnGamepadIsSupportedForProcess_45(
        __int64 a1,
        unsigned int **a2)
{
