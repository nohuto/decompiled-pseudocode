/*
 * XREFs of ?Invoke@DisplayChangedHandler@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJPEAUIHolographicDisplayWatcher@4Holographic@Graphics@5@PEAUIHolographicDisplay@785@@Z @ 0x1800AE9A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Graphics::Holographic::IHolographicDisplay *a3)
{
  ...
  if ( !v6 )
    goto LABEL_16;
  v7 = *((_BYTE *)this + 16);
  v8 = (struct _RTL_CRITICAL_SECTION *)(v6 + 96);
  EnterCriticalSection((LPCRITICAL_SECTION)(v6 + 96));
  EnterCriticalSection((LPCRITICAL_SECTION)(v6 + 360));
  v10 = *(_QWORD *)(v6 + 408);
  if ( v10 )
  {
    *(_QWORD *)(v6 + 408) = 0LL;
  ...
  if ( v6 != -360 )
    LeaveCriticalSection((LPCRITICAL_SECTION)(v6 + 360));
