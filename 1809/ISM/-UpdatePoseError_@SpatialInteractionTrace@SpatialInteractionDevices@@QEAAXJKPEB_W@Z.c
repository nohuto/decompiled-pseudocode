/*
 * XREFs of ?UpdatePoseError_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJKPEB_W@Z @ 0x180122428
 * Callers:
        ...
        const wchar_t *a4)
{
  ...
  if ( *(_DWORD *)v5 > 2u && (*(_BYTE *)(v5 + 16) & 2) != 0 && (*(_QWORD *)(v5 + 24) & 2LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v12 = a4;
    v13 = 2 * v6 + 2;
    TlgWrite((TraceLoggingHProvider)v5, &unk_18016DDBF, 0LL, 0LL, 5u, &pData);
  }
}
