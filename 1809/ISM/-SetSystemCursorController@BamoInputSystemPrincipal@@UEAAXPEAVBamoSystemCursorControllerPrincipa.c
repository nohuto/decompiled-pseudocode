/*
 * XREFs of ?SetSystemCursorController@BamoInputSystemPrincipal@@UEAAXPEAVBamoSystemCursorControllerPrincipal@@@Z @ 0x18001BED0
 * Callers:
        ...
        struct BamoSystemCursorControllerPrincipal *a2)
{
  ...
  *((_QWORD *)v3 + 13) = a2;
  ...
  v5 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoDataSourcePrincipalImpl *>(
         v3,
         BamoImpl::BamoInputSystemPrincipalImpl::UpdateSystemCursorControllerRemoteCacheStatic,
         v3);
  if ( v5 < 0 )
  {
