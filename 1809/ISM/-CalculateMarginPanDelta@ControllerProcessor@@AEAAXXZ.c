/*
 * XREFs of ?CalculateMarginPanDelta@ControllerProcessor@@AEAAXXZ @ 0x1800356D0
 * Callers:
...
void __fastcall ControllerProcessor::CalculateMarginPanDelta(ControllerProcessor *this)
{
  ...
  v3 = (LONG *)((char *)this + 1828);
  v4 = PtInRect((const RECT *)((char *)this + 1828), pt);
  *((_BYTE *)this + 1844) = !v4;
  if ( !v4 )
  {
    ...
    {
      *((_DWORD *)this + 462) = TickCount;
      v6 = TickCount;
    }
    v7 = *((_DWORD *)this + 458);
    v8 = 0LL;
    if ( pt.y > v7 && (v7 = *((_DWORD *)this + 460), pt.y < v7) )
      v9 = 0LL;
    else
      v9 = (__m128)COERCE_UNSIGNED_INT((float)(v7 - pt.y));
    v10 = *v3;
    if ( pt.x > *v3 && (v10 = *((_DWORD *)this + 459), pt.x < v10) )
      v11 = 0LL;
    else
    ...
    v15 = _mm_shuffle_ps(v14, v14, 85).m128_f32[0] + *((float *)this + 464);
    *((float *)this + 463) = v14.m128_f32[0] + *((float *)this + 463);
    v16 = _mm_mul_ps(v14, (__m128)_xmm);
    v14.m128_f32[0] = _mm_shuffle_ps(v16, v16, 85).m128_f32[0] + *((float *)this + 448);
    v16.m128_f32[0] = v16.m128_f32[0] + *((float *)this + 447);
    *((float *)this + 464) = v15;
    *((_DWORD *)this + 448) = v14.m128_i32[0];
    *((_DWORD *)this + 447) = v16.m128_i32[0];
  }
}
