/*
 * XREFs of ?OnExclusiveModeStateChanged@MPCInputRouter@@UEAAJEK_K@Z @ 0x180007E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCInputRouter::OnExclusiveModeStateChanged(MPCInputRouter *this, char a2, __int32 a3, __int64 a4)
{
  *((_BYTE *)this + 96) = a2 != 0;
  ...
  (*(void (__fastcall **)(_QWORD, __int64 (__fastcall *)(), char *, __int64))(**((_QWORD **)this + 24) + 128LL))(
    *((_QWORD *)this + 24),
