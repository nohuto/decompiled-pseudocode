/*
 * XREFs of ?OnMenuPressed@BamoMPCManagerClientProxy@@UEAAJAEBULegacyDeviceInfo@@I@Z @ 0x1800DCB10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  *((_QWORD *)v9 + 10) = v17;
  v25[0] = v28;
  v25[1] = v29;
  v4 = CoreUICallSend(v23, v25, 2LL, 4LL, 1, &unk_18014AFE0, (unsigned int)v26);
LABEL_9:
