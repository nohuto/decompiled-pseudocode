/*
 * XREFs of ?StartActivity@CloseHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x18010B8C8
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_DWORD *)v8 = 1;
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
    ...
    TlgWrite(v10, &unk_18016D320, (LPCGUID)(v14 + 8), v15, 6u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
