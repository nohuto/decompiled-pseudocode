/*
 * XREFs of GetHolographicInputSession @ 0x180061970
 * Callers:
...
__int64 __fastcall GetHolographicInputSession(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v18.m128i_i64[1] >= 8uLL )
      v9 = (void **)Src[0];
    memmove_0((char *)v9 + 2 * v7, L"\\Temp\\HolographicInput.etl", 0x34uLL);
    *((_WORD *)v9 + v8) = 0;
  }
  v11 = 0;
  v12 = 0;
