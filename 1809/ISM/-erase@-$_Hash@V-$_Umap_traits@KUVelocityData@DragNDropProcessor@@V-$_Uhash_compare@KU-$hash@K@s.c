/*
 * XREFs of ?erase@?$_Hash@V?$_Umap_traits@KUVelocityData@DragNDropProcessor@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKUVelocityData@DragNDropProcessor@@@std@@@4@$0A@@std@@@std@@QEAA_KAEBK@Z @ 0x1800259B0
 * Callers:
  ...
  if ( v15 == *v11 && v9 == v11 )
  {
    ...
    *(_QWORD *)(a1[1] + 8LL) = a1[1];
    ...
    if ( v19 != (_QWORD *)a1[1] )
    {
      ...
      {
        v20 = (_QWORD *)*v19;
        operator delete(v19, (const struct std::nothrow_t *)0x30);
        v19 = v20;
      }
