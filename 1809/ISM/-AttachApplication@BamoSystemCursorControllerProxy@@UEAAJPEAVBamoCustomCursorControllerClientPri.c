/*
 * XREFs of ?AttachApplication@BamoSystemCursorControllerProxy@@UEAAJPEAVBamoCustomCursorControllerClientPrincipal@@@Z @ 0x180015140
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoCustomCursorControllerClientPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    if ( a2 )
    {
      v7 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoCustomCursorControllerClientPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
