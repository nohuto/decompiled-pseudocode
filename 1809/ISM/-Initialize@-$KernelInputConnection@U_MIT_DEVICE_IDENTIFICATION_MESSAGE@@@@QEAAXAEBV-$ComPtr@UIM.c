/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@Z@std@@@Z @ 0x1800849C8
 * Callers:
...
struct ISMTestMode *__fastcall KernelInputConnection<_MIT_DEVICE_IDENTIFICATION_MESSAGE>::Initialize(
        _QWORD *a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    if ( v17 < 0 )
    {
      ...
      JUMPOUT(0x180084BB4LL);
    }
    result = (struct ISMTestMode *)MITCoreMsgKOpenConnectionTo(0LL, a1 + 3);
    if ( (int)result < 0 )
    {
