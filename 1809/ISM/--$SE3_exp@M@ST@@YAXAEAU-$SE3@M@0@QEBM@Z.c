/*
 * XREFs of ??$SE3_exp@M@ST@@YAXAEAU?$SE3@M@0@QEBM@Z @ 0x18012A38C
 * Callers:
 ...
 * Callees:
 *     ??$SO3_build_exp_matrix@M@ST@@YAXQEAMQEBMMM@Z @ 0x18012A96C (--$SO3_build_exp_matrix@M@ST@@YAXQEAMQEBMMM@Z.c)
