/*
 * XREFs of ?MPCSixDofProcessor_HomeEventTuneablesChanged_@ISMTracing@@QEAAXMMMMMMMMMMMMMMMMMMMK@Z @ 0x1800F50F0
 * Callers:
        ...
        char a21)
{
  ...
  if ( *(_DWORD *)v21 > 4u
    && (*((_QWORD *)v21 + 2) & 0x400000000001LL) != 0
    && (*((_QWORD *)v21 + 3) & 0x400000000001LL) == *((_QWORD *)v21 + 3) )
  {
    v24 = 4LL;
    v23 = &v63;
    v25 = &v64;
    ...
    v60 = 4LL;
    v62 = 4LL;
    TlgWrite(v21, &unk_18016B4C8, 0LL, 0LL, 0x16u, &pData);
  }
}
