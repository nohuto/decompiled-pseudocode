/*
 * XREFs of ??1OpenHolographicDevice@HolographicDriverClientTrace@@QEAA@XZ @ 0x18010AC78
 * Callers:
 *     _Windows::Internal::Holographic::SpatialGraphDriverHandleWrapper::Create_::_1_::dtor$2 @ 0x180135CCF (_Windows--Internal--Holographic--SpatialGraphDriverHandleWrapper--Create_--_1_--dtor$2.c)
 * Callees:
