/*
 * XREFs of ?SetValue@NodePropertyCache@Holographic@Internal@Windows@@QEAA_NAEBUSPATIAL_NODE_ID@@AEBU_GUID@@PEBX_K@Z @ 0x180110804
 * Callers:
        ...
        size_t Size)
{
  RTL_SRWLOCK *v8; // rsi
  __int64 v9; // rdx
  const struct SPATIAL_NODE_ID *v10; // rbx
  __int64 *v11; // rdi
  const struct SPATIAL_NODE_ID *v12; // r12
  __int64 v13; // rax
  __int64 v14; // rdi
  size_t v15; // rbx
  void *v16; // r12
  ...
  const struct SPATIAL_NODE_ID *v24; // [rsp+80h] [rbp+8h] BYREF
  ...
  v25 = v8;
  v10 = *(const struct SPATIAL_NODE_ID **)this[1].Data4;
  ...
  while ( !*((_BYTE *)v11 + 25) )
  {
    ...
    {
      v10 = (const struct SPATIAL_NODE_ID *)v11;
      v11 = (__int64 *)*v11;
    }
    else
    {
  ...
  if ( v10 == v12 || memcmp_0(a2, (char *)v10 + 32, 0x10uLL) < 0 )
  {
    v24 = a2;
