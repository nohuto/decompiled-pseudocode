/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x18000A55C
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x18000A840 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  if ( *(_DWORD *)v2 > 5u )
  {
    ...
    v71 = v5 + 1;
    v72 = 0;
    TlgWrite(v2, &unk_180166316, 0LL, 0LL, 0x13u, &pData);
  }
}
