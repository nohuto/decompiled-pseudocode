/*
 * XREFs of ?UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z @ 0x1800BA798
 * Callers:
 *     ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x1800B97D4 (-InjectZoom@ManipulationInjector@@QEAAXMK@Z.c)
 * Callees:
 *     ?UpdateZoomPoints@ManipulationInjector@@AEAAXAEAUtagPOINT@@0M@Z @ 0x1800BA71C (-UpdateZoomPoints@ManipulationInjector@@AEAAXAEAUtagPOINT@@0M@Z.c)
 */
