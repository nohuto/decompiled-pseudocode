/*
 * XREFs of ?UpdateVelocityForPointerId@DragNDropProcessor@@AEAAJKUtagPOINT@@@Z @ 0x1800239D0
 * Callers:
...
__int64 __fastcall DragNDropProcessor::UpdateVelocityForPointerId(DragNDropProcessor *this, int a2, struct tagPOINT a3)
{
  ...
  else
  {
    ...
    {
      v15 = (float)(PerformanceCount.LowPart - *(_DWORD *)(v6.QuadPart + 24)) / (float)(int)*((_QWORD *)this + 30);
      y = v21.y;
