/*
 * XREFs of ?ReceivedRawInputMessage@Win32kInterop@InputETW@@SAXK@Z @ 0x180081CE0
 * Callers:
...
void __fastcall InputETW::Win32kInterop::ReceivedRawInputMessage(unsigned int a1)
{
  __int64 v1; // rbx
  _DWORD *v2; // rdx
  __int64 v3; // rcx
  ...
  if ( v2 )
  {
    if ( *v2 > 1u )
    {
      ...
      if ( *(_DWORD *)v3 > 5u && (*(_BYTE *)(v3 + 16) & 1) != 0 && (*(_QWORD *)(v3 + 24) & 1LL) == *(_QWORD *)(v3 + 24) )
      {
        ...
        v4 = v1;
        v7 = 8;
        TlgWrite((TraceLoggingHProvider)v3, &unk_180168C5D, 0LL, 0LL, 3u, &pData);
      }
    }
  }
}
