/*
 * XREFs of ?Thunk_GetConstantForType_31@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18004BD60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCConstantManagerClientPrincipal_Receive<BamoImpl::BamoMPCConstantManagerClientPrincipalImpl>::Thunk_GetConstantForType_31(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // ebp
  ...
  if ( !*(_DWORD *)(v9 + 140) )
  {
    ...
    if ( *(_DWORD *)(v9 + 136) != GetCurrentThreadId() )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v14);
      JUMPOUT(0x18004BF2CLL);
    }
    *(_DWORD *)(v9 + 136) = 0;
    LeaveCriticalSection((LPCRITICAL_SECTION)(v9 + 96));
  }
  v15 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, int *, __int64))(*(_QWORD *)(a1 - 16) + 96LL))(
          a1 - 16,
          v7,
          v5,
          v4,
