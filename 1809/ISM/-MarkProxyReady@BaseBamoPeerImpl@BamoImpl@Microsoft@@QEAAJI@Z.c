/*
 * XREFs of ?MarkProxyReady@BaseBamoPeerImpl@BamoImpl@Microsoft@@QEAAJI@Z @ 0x180011E94
 * Callers:
 *     ?Thunk_MarkProxyReady_5@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019180 (-Thunk_MarkProxyReady_5@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBam.c)
 * Callees:
...
__int64 __fastcall Microsoft::BamoImpl::BaseBamoPeerImpl::MarkProxyReady(
