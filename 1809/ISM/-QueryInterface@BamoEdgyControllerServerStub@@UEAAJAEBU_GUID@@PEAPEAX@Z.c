/*
 * XREFs of ?QueryInterface@BamoEdgyControllerServerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800280B0
 * Callers:
 *     ?QueryInterface@BamoEdgyControllerServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180028760 (-QueryInterface@BamoEdgyControllerServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
