        ...
        void **a1)
{
  ...
  if ( !*((_BYTE *)v3 + 25) )
  {
    do
    {
      ...
      operator delete(v3, (const struct std::nothrow_t *)0x88);
      v3 = v4;
    }
    while ( !*((_BYTE *)v4 + 25) );
    v2 = *a1;
