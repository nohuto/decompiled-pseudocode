/*
 * XREFs of ??$SE3_log@M@ST@@YAXQEAMAEBU?$SE3@M@0@@Z @ 0x18012A4E4
 * Callers:
 ...
 *     ??$SO3_compute_exp_diff_inv_coef@M@ST@@YAXAEAMMMMM@Z @ 0x18012B020 (--$SO3_compute_exp_diff_inv_coef@M@ST@@YAXAEAMMMMM@Z.c)
 */
...
__int64 __fastcall ST::SE3_log<float>(float *a1, float *a2)
{
  ...
  v13 = v20;
  v14 = a2[10] * v5;
  v15 = (float)(v11 * v4) - (float)(a2[10] * v6);
  *a1 = v12;
  v16 = (float)(v12 * v6) - (float)(v11 * v5);
  v17 = a2[10];
  a1[1] = v17;
  v18 = a2[11];
  v19 = v14 - (float)(v12 * v4);
  *a1 = (float)((float)((float)(v19 * v4) - (float)(v16 * v6)) * v13) + (float)(v12 - (float)(v15 * 0.5));
  a1[1] = (float)((float)((float)(v15 * v6) - (float)(v19 * v5)) * v13) + (float)(v17 - (float)(v16 * 0.5));
  a1[2] = (float)((float)((float)(v16 * v5) - (float)(v15 * v4)) * v13) + (float)(v18 - (float)(v19 * 0.5));
  return result;
}
