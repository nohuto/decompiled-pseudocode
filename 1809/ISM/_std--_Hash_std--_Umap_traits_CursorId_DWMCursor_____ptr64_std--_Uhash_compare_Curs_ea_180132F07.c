...
void __fastcall __noreturn std::_Hash_std::_Umap_traits_CursorId_DWMCursor_____ptr64_std::_Uhash_compare_CursorId_CursorIdHash_std::equal_to_CursorId____std::allocator_std::pair_CursorId_const__DWMCursor_____ptr64____0___::_Insert_std::pair_CursorId_const__DWMCursor_____ptr64______ptr64_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_CursorId_const__DWMCursor_____ptr64__________::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
  _QWORD *iter; // rax
