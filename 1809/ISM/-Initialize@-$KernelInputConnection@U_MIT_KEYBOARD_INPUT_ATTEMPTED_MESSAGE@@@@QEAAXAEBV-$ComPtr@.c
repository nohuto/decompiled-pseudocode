/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_KEYBOARD_INPUT_ATTEMPTED_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_KEYBOARD_INPUT_ATTEMPTED_MESSAGE@@@Z@std@@@Z @ 0x18002A3C4
 * Callers:
...
struct ISMTestMode *__fastcall KernelInputConnection<_MIT_KEYBOARD_INPUT_ATTEMPTED_MESSAGE>::Initialize(
        _QWORD *a1,
        _QWORD *a2,
        __int64 a3,
        __int64 a4)
{
  ...
  std::function<void (_MIT_KEYBOARD_INPUT_MESSAGE const *)>::operator=(a1 + 8, a4);
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    v17 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD *))(*(_QWORD *)*a2 + 112LL))(*a2, a1[2], a1 + 3);
    if ( v17 < 0 )
    {
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
      ...
      JUMPOUT(0x18002A5B3LL);
    }
    result = (struct ISMTestMode *)MITCoreMsgKOpenConnectionTo(4LL, a1 + 3);
    if ( (int)result < 0 )
    {
