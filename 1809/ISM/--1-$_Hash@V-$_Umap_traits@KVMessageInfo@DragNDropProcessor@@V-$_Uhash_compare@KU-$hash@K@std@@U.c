/*
 * XREFs of ??1?$_Hash@V?$_Umap_traits@KVMessageInfo@DragNDropProcessor@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKVMessageInfo@DragNDropProcessor@@@std@@@4@$0A@@std@@@std@@QEAA@XZ @ 0x180023228
 * Callers:
 *     ??_EDragNDropProcessor@@EEAAPEAXI@Z @ 0x180022F68 (--_EDragNDropProcessor@@EEAAPEAXI@Z.c)
 *     ??1?$unordered_map@KVMessageInfo@DragNDropProcessor@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKVMessageInfo@DragNDropProcessor@@@std@@@4@@std@@QEAA@XZ @ 0x1800230EC (--1-$unordered_map@KVMessageInfo@DragNDropProcessor@@U-$hash@K@std@@U-$equal_to@K@4@V-$allocator.c)
 * Callees:
        ...
        _QWORD *a1)
{
  ...
  *(_QWORD *)(a1[1] + 8LL) = a1[1];
  ...
  if ( v7 != v8 )
  {
    ...
    {
      v9 = (_QWORD *)*v7;
      DragNDropProcessor::MessageInfo::~MessageInfo((DragNDropProcessor::MessageInfo *)(v7 + 3));
