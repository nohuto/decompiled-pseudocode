/*
 * XREFs of ?ResultFromCaughtExceptionInternal@details@wil@@YAJPEAG_KPEA_N@Z @ 0x180002EA0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !g_pfnResultFromCaughtException_WinRt )
  {
    if ( !wil::g_pfnResultFromCaughtException )
    {
      ...
      catch ( const std::bad_alloc *v34 )
      {
        ...
        if ( v19 )
        {
          v20 = (*(__int64 (**)(void))(**((_QWORD **)v18 + 8) + 8LL))();
    ...
    catch ( const std::bad_alloc *v33 )
    {
      ...
      if ( v10 )
      {
        v11 = (*(__int64 (**)(void))(**((_QWORD **)v9 + 7) + 8LL))();
