/*
 * XREFs of ??_EKeyboardModifierState@@EEAAPEAXI@Z @ 0x1801041D0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  *(_QWORD *)this = &KeyboardModifierState::`vftable';
  std::_Hash<std::_Uset_traits<unsigned __int64,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<unsigned __int64>,0>>::~_Hash<std::_Uset_traits<unsigned __int64,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<unsigned __int64>,0>>((_QWORD *)this + 2);
