/*
 * XREFs of ?NoPoseReceivedYet_@HolographicDriverClientContinuousTrace@@QEAAXAEBUSPATIAL_NODE_ID@@J@Z @ 0x18010EF64
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v4 > 5u && (*(_BYTE *)(v4 + 16) & 2) != 0 && (*(_QWORD *)(v4 + 24) & 2LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v6 = a2;
    v7 = 16;
    TlgWrite((TraceLoggingHProvider)v4, &unk_18016D528, 0LL, 0LL, 4u, &pData);
  }
}
