/*
 * XREFs of _SystemCursorController::DestroyCursorShapeAnimation_::_1_::catch$2 @ 0x1801328F3
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall SystemCursorController::DestroyCursorShapeAnimation_::_1_::catch_2(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
