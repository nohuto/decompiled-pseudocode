/*
 * XREFs of ?SendMaterializeProxy@BamoDataProviderPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18009A040
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v7 = CoreUICallSend(a2, &v12, 2LL, 6LL, 1, &unk_18014BF1D, v10);
  if ( v7 < 0 )
  {
