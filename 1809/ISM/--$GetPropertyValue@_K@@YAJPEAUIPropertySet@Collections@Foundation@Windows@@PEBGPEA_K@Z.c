/*
 * XREFs of ??$GetPropertyValue@_K@@YAJPEAUIPropertySet@Collections@Foundation@Windows@@PEBGPEA_K@Z @ 0x18006F71C
 * Callers:
...
__int64 __fastcall GetPropertyValue<unsigned __int64>(__int64 a1, const WCHAR *a2, __int64 a3)
{
  ...
  const WCHAR *v22[2]; // [rsp+40h] [rbp-40h] BYREF
  char v23[32]; // [rsp+50h] [rbp-30h] BYREF
...
LABEL_15:
  ...
  v9 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v19 + 112LL))(v19, a3);
  v6 = v9;
  if ( v9 < 0 )
  {
    v8 = 117LL;
