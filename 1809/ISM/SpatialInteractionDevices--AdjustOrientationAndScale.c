/*
 * XREFs of SpatialInteractionDevices::AdjustOrientationAndScale @ 0x1800A67B4
 * Callers:
...
char __fastcall SpatialInteractionDevices::AdjustOrientationAndScale(unsigned __int64 *a1)
{
  char result; // al
  __m128 v2; // xmm7
  __m128 v3; // xmm3
  ...
  {
    v2 = (__m128)xmmword_180192BD8;
    if ( result )
    {
      v3 = _mm_add_ps((__m128)xmmword_180192BD8, (__m128)xmmword_180192BD8);
      v4 = _mm_movelh_ps((__m128)*a1, (__m128)*((unsigned int *)a1 + 2));
      v5 = _mm_mul_ps(v3, (__m128)xmmword_180192BD8);
      v6 = _mm_sub_ps(
             _mm_sub_ps(
      ...
      v7 = _mm_mul_ps(
             ...
             _mm_shuffle_ps((__m128)xmmword_180192BD8, (__m128)xmmword_180192BD8, 208));
      v8 = _mm_mul_ps(
             _mm_shuffle_ps(v3, v3, 201),
             _mm_shuffle_ps((__m128)xmmword_180192BD8, (__m128)xmmword_180192BD8, 255));
      v9 = _mm_add_ps(v8, v7);
