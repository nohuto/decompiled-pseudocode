/*
 * XREFs of ?Register@BamoDataProviderRegistrarProxy@@UEAAJPEAVBamoDataProviderPrincipal@@@Z @ 0x180098D40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoDataProviderPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    if ( a2 )
    {
      v8 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoDataProviderPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
    ...
    if ( v9 >= 0 )
    {
      v12[0] = v14;
      v12[1] = v15;
      v4 = CoreUICallSend(v16, v12, 2LL, 2LL, 0, &unk_18014BF1D, v7);
      goto LABEL_10;
    }
    v5 = (unsigned int)v9;
    v6 = 8487LL;
