/*
 * XREFs of ?ComputeControllerPoses@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAXAEBUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@0AEBUMatrix4x4@Numerics@Foundation@4@1@Z @ 0x1801268C0
 * Callers:
        ...
        __m128 *a5)
{
  ...
  v27 = v14 & v26;
  if ( v27 && v15 || (*((_BYTE *)this + 72) & 0x40) != 0 || !*((_BYTE *)this + 904) || !v27 )
  {
    ...
    *((_BYTE *)this + 1180) = 0;
    ...
    if ( v57 && v55 )
    {
      *(__m128 *)((char *)this + 820) = _mm_shuffle_ps(v56, _mm_shuffle_ps(v22, v56, 160), 36);
      *(__m128 *)((char *)this + 836) = _mm_shuffle_ps(v22, v24, 73);
      *(__m128 *)((char *)this + 852) = _mm_shuffle_ps(_mm_shuffle_ps(v24, v25, 10), v25, 152);
      *(__m128 *)((char *)this + 868) = _mm_shuffle_ps(v21, _mm_shuffle_ps(v21, v22, 10), 132);
      *(__m128 *)((char *)this + 884) = _mm_shuffle_ps(v22, v24, 73);
      *((_DWORD *)this + 225) = _mm_shuffle_ps(v24, v24, 170).m128_u32[0];
      *((_BYTE *)this + 904) = v54;
    }
  }
  else
  {
    v28 = *(__m128 *)((char *)this + 820);
    v29 = *(__m128 *)((char *)this + 852);
    v30 = _mm_unpacklo_ps(*(__m128 *)((char *)this + 884), (__m128)0LL);
    v31 = _mm_unpacklo_ps(
            _mm_unpacklo_ps((__m128)*((unsigned int *)a3 + 12), (__m128)*((unsigned int *)a3 + 14)),
            _mm_unpacklo_ps((__m128)*((unsigned int *)a3 + 13), (__m128)0LL));
    v32 = _mm_unpackhi_ps(*(__m128 *)((char *)this + 868), (__m128)0LL);
    v33 = _mm_unpacklo_ps(
            _mm_unpacklo_ps((__m128)*((unsigned int *)a3 + 15), (__m128)*((unsigned int *)a3 + 17)),
            _mm_unpacklo_ps((__m128)*((unsigned int *)a3 + 16), (__m128)0LL));
    v34 = _mm_movelh_ps(*(__m128 *)((char *)this + 868), v32);
    v35 = (__m128)*((unsigned int *)this + 225);
    v36 = _mm_shuffle_ps(*(__m128 *)((char *)this + 884), v35, 78);
  ...
  *(_QWORD *)&v78 = DirectX::XMMatrixMultiply(*(double *)_mm_shuffle_ps(v75, v75, 120).m128_u64, &v123).m128_u64[0];
  ...
  v80 = (__m128)*(unsigned __int64 *)((char *)this + 540);
  v81 = *(double *)&v79;
  v82 = (__m128)*((unsigned int *)this + 137);
  v122 = (__m128)DirectX::g_XMIdentityR3;
  v120 = _mm_shuffle_ps(v76, v76, 114);
  v121 = v77;
  v83 = *(__m128 *)((char *)this + 552);
  ...
  v87 = _mm_mul_ps(_mm_shuffle_ps(v84, v84, 230), _mm_shuffle_ps(v83, v83, 208));
  v88 = _mm_mul_ps(_mm_shuffle_ps(v84, v84, 201), _mm_shuffle_ps(v83, v83, 255));
  ...
  *(__m128 *)((char *)this + 1148) = DirectX::XMQuaternionRotationMatrix(
                                       *(double *)v100.m128_u64,
                                       v103,
                                       *(double *)v92.m128_u64);
  *((_DWORD *)this + 291) = DirectX::g_XMIdentityR3;
  *((_DWORD *)this + 292) = _mm_shuffle_ps(DirectX::g_XMIdentityR3, DirectX::g_XMIdentityR3, 85).m128_u32[0];
  *((_DWORD *)this + 293) = _mm_shuffle_ps(DirectX::g_XMIdentityR3, DirectX::g_XMIdentityR3, 170).m128_u32[0];
  *((_BYTE *)this + 1177) = v104;
  *((_BYTE *)this + 1176) = v105;
  ...
  *((__m128 *)this + 66) = v106;
  *((_DWORD *)this + 268) = DirectX::g_XMIdentityR3;
  *((_DWORD *)this + 269) = _mm_shuffle_ps(DirectX::g_XMIdentityR3, DirectX::g_XMIdentityR3, 85).m128_u32[0];
  *((_DWORD *)this + 270) = _mm_shuffle_ps(DirectX::g_XMIdentityR3, DirectX::g_XMIdentityR3, 170).m128_u32[0];
  *((_BYTE *)this + 1085) = v108;
  *((_BYTE *)this + 1084) = v109;
  *((__m128 *)this + 64) = DirectX::XMQuaternionRotationMatrix(v81, *(double *)v95.m128_u64, *(double *)v92.m128_u64);
  *((_DWORD *)this + 260) = v107.m128_i32[0];
  v112.m128_u64[1] = (unsigned __int64)v127;
  *((_DWORD *)this + 261) = _mm_shuffle_ps(v107, v107, 85).m128_u32[0];
  *((_DWORD *)this + 262) = _mm_shuffle_ps(v107, v107, 170).m128_u32[0];
  *((_BYTE *)this + 1053) = v110;
  *((_BYTE *)this + 1052) = v111;
