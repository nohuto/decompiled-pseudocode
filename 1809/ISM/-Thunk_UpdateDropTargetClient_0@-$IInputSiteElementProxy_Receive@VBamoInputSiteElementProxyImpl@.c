/*
 * XREFs of ?Thunk_UpdateDropTargetClient_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800208C0
 * Callers:
 *     <none>
 * Callees:
