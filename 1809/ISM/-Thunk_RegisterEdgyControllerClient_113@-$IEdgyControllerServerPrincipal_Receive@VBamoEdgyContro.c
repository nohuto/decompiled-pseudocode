/*
 * XREFs of ?Thunk_RegisterEdgyControllerClient_113@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800285A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IEdgyControllerServerPrincipal_Receive<BamoImpl::BamoEdgyControllerServerPrincipalImpl>::Thunk_RegisterEdgyControllerClient_113(
        __int64 a1,
        __int64 *a2)
{
  unsigned int v3; // ebp
  ...
  if ( !*(_DWORD *)(v9 + 140) )
  {
    ...
    if ( *(_DWORD *)(v9 + 136) != GetCurrentThreadId() )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v14);
      JUMPOUT(0x180028751LL);
    }
    *(_DWORD *)(v9 + 136) = 0;
    LeaveCriticalSection((LPCRITICAL_SECTION)(v9 + 96));
  }
  v15 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(*(_QWORD *)(a1 - 16) + 72LL))(
          a1 - 16,
          v7,
          v4,
