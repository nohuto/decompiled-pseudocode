/*
 * XREFs of ?SpatialGraphDeviceNotUsable_@HolographicDriverClientTrace@@QEAAXPEB_W@Z @ 0x18010C958
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  if ( *(_DWORD *)v3 > 2u && (*(_BYTE *)(v3 + 16) & 2) != 0 && (*(_QWORD *)(v3 + 24) & 2LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v6 = a2;
    v7 = 2 * v4 + 2;
    TlgWrite((TraceLoggingHProvider)v3, &unk_18016DB51, 0LL, 0LL, 3u, &pData);
  }
}
