/*
 * XREFs of ?DragInProgress@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@00_KW4VirtualKeyModifiers@System@Windows@@@Z @ 0x180022460
 * Callers:
...
int __fastcall InputETW::DragNDrop::DragInProgress(
        unsigned int a1,
        int *a2,
        int *a3,
        int *a4,
    ...
    if ( *v11 > 1u )
    {
      ...
      if ( *(_DWORD *)v12 > 5u && (*(_BYTE *)(v12 + 16) & 1) != 0 )
      {
        ...
        if ( v10 == *(struct InputETW **)(v12 + 24) )
        {
          ...
          v45 = 8;
          v48 = 8;
          LODWORD(v10) = TlgWrite((TraceLoggingHProvider)v12, &unk_1801667F6, 0LL, 0LL, 0xBu, &pData);
        }
      }
    }
  }
