/*
 * XREFs of _std::_List_alloc_std::_List_base_types_std::pair_unsigned_long_const__DragNDropProcessorLegacy::PointerCache__std::allocator_std::pair_unsigned_long_const__DragNDropProcessorLegacy::PointerCache_______::_Buynode0_::_1_::catch$0 @ 0x18012EE08
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::_List_alloc_std::_List_base_types_std::pair_unsigned_long_const__DragNDropProcessorLegacy::PointerCache__std::allocator_std::pair_unsigned_long_const__DragNDropProcessorLegacy::PointerCache_______::_Buynode0_::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
