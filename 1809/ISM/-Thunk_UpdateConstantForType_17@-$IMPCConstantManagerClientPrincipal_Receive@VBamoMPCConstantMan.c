/*
 * XREFs of ?Thunk_UpdateConstantForType_17@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18004B970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCConstantManagerClientPrincipal_Receive<BamoImpl::BamoMPCConstantManagerClientPrincipalImpl>::Thunk_UpdateConstantForType_17(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // ebp
  ...
  if ( !*(_DWORD *)(v9 + 140) )
  {
    ...
    if ( *(_DWORD *)(v9 + 136) != GetCurrentThreadId() )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v14);
      JUMPOUT(0x18004BB59LL);
    }
    *(_DWORD *)(v9 + 136) = 0;
    LeaveCriticalSection((LPCRITICAL_SECTION)(v9 + 96));
  }
  v15 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, int *, int *, __int64))(*(_QWORD *)(a1 - 16) + 80LL))(
          a1 - 16,
          v7,
          v19,
          v5,
