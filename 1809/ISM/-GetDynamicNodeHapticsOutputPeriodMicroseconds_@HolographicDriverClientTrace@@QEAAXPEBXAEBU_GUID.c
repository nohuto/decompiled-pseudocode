/*
 * XREFs of ?GetDynamicNodeHapticsOutputPeriodMicroseconds_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@H@Z @ 0x18010C450
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 2) != 0 && (*(_QWORD *)(v7 + 24) & 2LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    v14 = 16LL;
    v16 = 4LL;
    TlgWrite((TraceLoggingHProvider)v7, &unk_18016C03D, 0LL, 0LL, 6u, &pData);
  }
}
