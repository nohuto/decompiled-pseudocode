/*
 * XREFs of ?CreateSpatialPayloadDescriptor@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEBX_KPEAPEAUISpatialPayloadDescriptor@234@@Z @ 0x1800AA310
 * Callers:
 *     <none>
 * Callees:
