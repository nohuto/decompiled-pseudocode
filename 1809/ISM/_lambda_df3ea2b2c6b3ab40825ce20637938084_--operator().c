/*
 * XREFs of _lambda_df3ea2b2c6b3ab40825ce20637938084_::operator() @ 0x1800B0F3C
 * Callers:
 ...
 *     wil::details::lambda_call__lambda_df3ea2b2c6b3ab40825ce20637938084___::_lambda_call__lambda_df3ea2b2c6b3ab40825ce20637938084___ @ 0x1800B3C24 (wil--details--lambda_call__lambda_df3ea2b2c6b3ab40825ce20637938084___--_lambda_call__lambda_df3e.c)
 * Callees:
...
void __fastcall lambda_df3ea2b2c6b3ab40825ce20637938084_::operator()(__int64 a1)
{
  ...
  if ( **(_BYTE **)a1 )
  {
    ...
    while ( v4 != v3 )
    {
      (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v4[5] + 168LL))(v4[5], 1LL);
      if ( !*((_BYTE *)v4 + 25) )
      {
        v5 = (__int64 **)v4[2];
        if ( *((_BYTE *)v5 + 25) )
