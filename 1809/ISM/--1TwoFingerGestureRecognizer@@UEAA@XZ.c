/*
 * XREFs of ??1TwoFingerGestureRecognizer@@UEAA@XZ @ 0x1800D53B8
 * Callers:
 *     _GestureSession::GestureSession_::_1_::dtor$4 @ 0x1801344E8 (_GestureSession--GestureSession_--_1_--dtor$4.c)
 * Callees:
 *     <none>
 */
