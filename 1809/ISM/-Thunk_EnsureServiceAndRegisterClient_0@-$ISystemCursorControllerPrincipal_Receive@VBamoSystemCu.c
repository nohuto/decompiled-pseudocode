/*
 * XREFs of ?Thunk_EnsureServiceAndRegisterClient_0@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180094690
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !*(_DWORD *)(v8 + 140) )
  {
    ...
    if ( *(_DWORD *)(v8 + 136) != GetCurrentThreadId() )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v13);
      JUMPOUT(0x180094830LL);
    }
    *(_DWORD *)(v8 + 136) = 0;
    LeaveCriticalSection((LPCRITICAL_SECTION)(v8 + 96));
  }
  v14 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)(a1 - 16) + 72LL))(
          a1 - 16,
          v6,
          (v9 - 16) & -(__int64)(v9 != 0));
  if ( v14 < 0 )
