/*
 * XREFs of ?Thunk_RegisterClient_0@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180031F00
 * Callers:
 *     <none>
 * Callees:
