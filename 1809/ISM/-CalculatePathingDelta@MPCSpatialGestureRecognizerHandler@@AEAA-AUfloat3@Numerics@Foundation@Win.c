/*
 * XREFs of ?CalculatePathingDelta@MPCSpatialGestureRecognizerHandler@@AEAA?AUfloat3@Numerics@Foundation@Windows@@PEAUISpatialManipulationUpdatedEventArgs@Spatial@Input@UI@5@@Z @ 0x1800510D8
 * Callers:
        ...
        __int64 a3)
{
  ...
  char v34[64]; // [rsp+48h] [rbp-C0h] BYREF
  ...
  wil::details::in1diag3 *retaddr; // [rsp+790h] [rbp+688h]
  __int64 v48; // [rsp+7A8h] [rbp+6A0h] BYREF
  int v49; // [rsp+7B0h] [rbp+6A8h] BYREF
...
LABEL_8:
        ...
        v12 = (*(__int64 (__fastcall **)(__int64, float *))(*(_QWORD *)v48 + 48LL))(v48, a2);
        if ( v12 >= 0 )
        {
          v11 = v48;
          goto LABEL_8;
...
LABEL_25:
  ...
  if ( v49 == 3 )
  {
    ...
    memcpy_0(v34, Instance, 0x710uLL);
...
LABEL_18:
  ...
  if ( v17 > 0.037999999 )
  {
    v18 = _mm_movelh_ps((__m128)*(unsigned __int64 *)a2, (__m128)*((unsigned int *)a2 + 2));
