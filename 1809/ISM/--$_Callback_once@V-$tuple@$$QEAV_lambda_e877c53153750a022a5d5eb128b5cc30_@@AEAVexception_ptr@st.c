/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_e877c53153750a022a5d5eb128b5cc30_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180047D60
 * Callers:
 *     <none>
 * Callees:
