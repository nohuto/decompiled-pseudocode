/*
 * XREFs of _LampArrayDevice::Initialize_::_1_::catch$2 @ 0x18013191D
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall LampArrayDevice::Initialize_::_1_::catch_2(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
