/*
 * XREFs of ?MPCHolographicInputManager_FocusedAppDisabled3DGamepad_@ISMTracing@@QEAAXAEB_N@Z @ 0x180044038
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_FocusedAppDisabled3DGamepad_(ISMTracing *this, const bool *a2)
{
  ...
  if ( *(_DWORD *)v3 > 4u && (*(_BYTE *)(v3 + 16) & 1) != 0 && (*(_QWORD *)(v3 + 24) & 1LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v5 = a2;
    v6 = 1;
    TlgWrite((TraceLoggingHProvider)v3, &unk_180166D36, 0LL, 0LL, 3u, &pData);
  }
}
