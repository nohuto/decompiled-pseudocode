/*
 * XREFs of _DWMCursorBroker::GetCursors_::_1_::dtor$0 @ 0x180135803
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DWMCursorBroker::GetCursors_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  ...
  {
    *(_DWORD *)(a2 + 32) &= ~1u;
    std::vector<Microsoft::WRL::ComPtr<IMessageProxy>>::~vector<Microsoft::WRL::ComPtr<IMessageProxy>>(*(_QWORD *)(a2 + 88));
  }
}
