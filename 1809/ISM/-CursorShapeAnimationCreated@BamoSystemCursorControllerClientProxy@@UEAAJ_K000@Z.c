/*
 * XREFs of ?CursorShapeAnimationCreated@BamoSystemCursorControllerClientProxy@@UEAAJ_K000@Z @ 0x180015BB0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      v12[0] = v14;
      v12[1] = v9;
      v4 = CoreUICallSend(v10, v12, 2LL, 34LL, 4, &unk_18014AA30, a2);
      goto LABEL_7;
    }
    v6 = (unsigned int)v7;
    v5 = 51515LL;
