/*
 * XREFs of ?_Destroy@?$vector@V?$ComPtr@VWGIController@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@@std@@AEAAXPEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@0@Z @ 0x18006C2C4
 * Callers:
 *     _std::vector_Microsoft::WRL::ComPtr_WGIController__std::allocator_Microsoft::WRL::ComPtr_WGIController_____::_Emplace_reallocate_Microsoft::WRL::ComPtr_WGIController____::_1_::catch$0 @ 0x1801317B1 (_std--vector_Microsoft--WRL--ComPtr_WGIController__std--allocator_Microsoft--WRL--ComPtr_WGICont.c)
 * Callees:
