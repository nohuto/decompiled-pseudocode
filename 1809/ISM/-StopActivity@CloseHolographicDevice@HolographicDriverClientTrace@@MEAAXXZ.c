/*
 * XREFs of ?StopActivity@CloseHolographicDevice@HolographicDriverClientTrace@@MEAAXXZ @ 0x18010B4B0
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      v81 = v9 + 1;
      v82 = 0;
      TlgWrite(v6, &unk_18016C65D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 5u )
    {
      ...
      v32 = CurrentThreadId;
      v86 = &v32;
      TlgWrite(v26, &unk_18016D9E2, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v83);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
