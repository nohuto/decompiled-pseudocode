/*
 * XREFs of ?RegisterInputAttemptedClient@BamoInputDeliveryServerProxy@@UEAAJPEAVBamoInputAttemptedDeliveryClientPrincipal@@@Z @ 0x180014080
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoInputAttemptedDeliveryClientPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    if ( a2 )
    {
      v8 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoInputAttemptedDeliveryClientPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
