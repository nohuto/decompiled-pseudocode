/*
 * XREFs of ?TryCreateAndInitialize@HidLampAttributesRequestReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x18007E9E0
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    if ( *(_DWORD *)a1 == 2 )
    {
      ...
      {
        v8 = *((_QWORD *)a1 + 2);
        if ( *(_WORD *)(v8 + 72LL * i + 18) == 32 && *(_WORD *)(v8 + 72LL * i + 16) == 89 )
        {
          if ( *(_WORD *)(v8 + 72LL * i + 10) == 33 && *(_WORD *)(v8 + 72LL * i + 8) == 89 )
          {
          ...
          else
          {
            ...
            LampArrayTelemetry::LogUnexpectedUsage(v9, *(_WORD *)(v8 + 72LL * i + 8), *(_WORD *)(v8 + 72LL * i + 10));
          }
        }
      }
    }
    *((_DWORD *)v5 + 5) = (unsigned int)(*(_DWORD *)(*((_QWORD *)a1 + 2)
    ...
    if ( v5[17] == 2
      ...
      && *((_DWORD *)v5 + 6)
      && !*((_QWORD *)v5 + 6)
      && (unsigned __int64)(*((_QWORD *)v5 + 7) - 1LL) <= 0x7FFFFFFE )
    {
      v6 = 0LL;
