/*
 * XREFs of ?PropertyCache_RemoveValue_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@1@Z @ 0x18010D420
 * Callers:
 *     ?LogValueRemoved@PropertyCache@Holographic@Internal@Windows@@MEAAXAEBU_GUID@@@Z @ 0x180110700 (-LogValueRemoved@PropertyCache@Holographic@Internal@Windows@@MEAAXAEBU_GUID@@@Z.c)
 * Callees:
...
int __fastcall HolographicDriverClientTrace::PropertyCache_RemoveValue_(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*(_BYTE *)(v8 + 16) & 2) != 0 )
  {
    ...
    if ( v7 == *(struct HolographicDriverClientTrace **)(v8 + 24) )
    {
      ...
      v18 = a4;
      v19 = 16LL;
      LODWORD(v7) = TlgWrite((TraceLoggingHProvider)v8, &unk_18016D963, 0LL, 0LL, 5u, &pData);
    }
  }
  return (int)v7;
}
