/*
 * XREFs of ?StartActivity@DdiSource_BackgroundInit@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_WAEBU_GUID@@@Z @ 0x1800AD3B8
 * Callers:
        ...
        const struct _GUID *a3)
{
  ...
  *(_DWORD *)v6 = 1;
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    ...
    TlgWrite(v8, &unk_1801693EE, (LPCGUID)(v10 + 8), v11, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
