/*
 * XREFs of ?OnTouch@ClickRecognizer@@AEAAXPEBVGestureSession@@KKPEBUTouchContactInfo@@@Z @ 0x1800D6F68
 * Callers:
 ...
 * Callees:
 *     ?ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z @ 0x1800D7060 (-ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z.c)
 *     ?CancelTapAndHold@ClickRecognizer@@AEAAXXZ @ 0x1800D7144 (-CancelTapAndHold@ClickRecognizer@@AEAAXXZ.c)
 */
