/*
 * XREFs of ??1?$map@IV?$function@$$A6AX_N@Z@std@@U?$less@I@2@V?$allocator@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@@2@@std@@QEAA@XZ @ 0x18003ABBC
 * Callers:
 *     _MPC3DStateHelper::MPC3DStateHelper_::_1_::dtor$2 @ 0x18012F6B8 (_MPC3DStateHelper--MPC3DStateHelper_--_1_--dtor$2.c)
 *     _MPC3DStateHelper::MPC3DStateHelper_::_1_::dtor$3 @ 0x18012F6CE (_MPC3DStateHelper--MPC3DStateHelper_--_1_--dtor$3.c)
 * Callees:
