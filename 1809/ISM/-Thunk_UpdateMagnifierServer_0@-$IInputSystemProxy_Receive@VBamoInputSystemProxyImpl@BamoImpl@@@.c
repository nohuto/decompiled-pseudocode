/*
 * XREFs of ?Thunk_UpdateMagnifierServer_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IInputSystemProxy_Receive<BamoImpl::BamoInputSystemProxyImpl>::Thunk_UpdateMagnifierServer_0(
        __int64 a1,
        unsigned int **a2)
{
  __int64 v3; // r8
