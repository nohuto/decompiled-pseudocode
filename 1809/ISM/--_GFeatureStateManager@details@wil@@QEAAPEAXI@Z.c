/*
 * XREFs of ??_GFeatureStateManager@details@wil@@QEAAPEAXI@Z @ 0x180031300
 * Callers:
        ...
        wil::details::FeatureStateManager *this)
{
  ...
  *(_BYTE *)this = 0;
  ...
  if ( v8 && qword_180191608 )
    wil::details_abi::SubscriptionList::Unsubscribe((LPCRITICAL_SECTION)&qword_180191608[25], qword_180191608, v8);
