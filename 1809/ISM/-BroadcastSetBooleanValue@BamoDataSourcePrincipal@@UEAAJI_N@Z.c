/*
 * XREFs of ?BroadcastSetBooleanValue@BamoDataSourcePrincipal@@UEAAJI_N@Z @ 0x180099000
 * Callers:
 *     <none>
 * Callees:
        ...
        bool a3)
{
  ...
  if ( *(_QWORD *)(*((_QWORD *)this[3] + 3) + 40LL) )
  {
    for ( i = this[5]; i; i = (struct Microsoft::BamoImpl::ConnectionIndirector *)*((_QWORD *)i + 6) )
    {
      if ( *((_BYTE *)i + 32) )
      {
        v9 = BamoImpl::BamoDataSourceStubImpl::SetBooleanValue(i, a2, a3);
