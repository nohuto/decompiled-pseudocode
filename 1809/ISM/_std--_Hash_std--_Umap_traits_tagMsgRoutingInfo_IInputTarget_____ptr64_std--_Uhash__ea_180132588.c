...
void __fastcall __noreturn std::_Hash_std::_Umap_traits_tagMsgRoutingInfo_IInputTarget_____ptr64_std::_Uhash_compare_tagMsgRoutingInfo_RoutingInfoHash_std::equal_to_tagMsgRoutingInfo____std::allocator_std::pair_tagMsgRoutingInfo_const__IInputTarget_____ptr64____0___::_Insert_std::pair_tagMsgRoutingInfo_const__IInputTarget_____ptr64______ptr64_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_tagMsgRoutingInfo_const__IInputTarget_____ptr64__________::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
  _QWORD *iter; // rax
