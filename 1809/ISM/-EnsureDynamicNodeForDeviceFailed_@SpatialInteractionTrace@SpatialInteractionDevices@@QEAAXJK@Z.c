/*
 * XREFs of ?EnsureDynamicNodeForDeviceFailed_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJK@Z @ 0x1801225C4
 * Callers:
 ...
 *     wil::details::lambda_call__lambda_6bcc6914c6f7140c2e7947a0a05a7a7e___::_lambda_call__lambda_6bcc6914c6f7140c2e7947a0a05a7a7e___ @ 0x1801286F4 (wil--details--lambda_call__lambda_6bcc6914c6f7140c2e7947a0a05a7a7e___--_lambda_call__lambda_6bcc.c)
 * Callees:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v3 > 4u && (*(_BYTE *)(v3 + 16) & 2) != 0 && (*(_QWORD *)(v3 + 24) & 2LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v6 = 4;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)v3, &unk_18016DE30, 0LL, 0LL, 4u, &pData);
  }
}
