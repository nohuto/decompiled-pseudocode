/*
 * XREFs of ??$Telemetry_SpatialInteractionHeartbeat_ButtonCounters@$06@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEBU_GUID@@GGGIAEAY06$$CBW4ButtonFlags@1@AEAY06$$CBI@Z @ 0x1801290C0
 * Callers:
    ...
    if ( *v9 )
    {
      ...
      if ( *(_DWORD *)v10 > 5u && (*((_QWORD *)v10 + 2) & 0x200000000000LL) != 0 )
      {
        ...
        if ( v8 == *((struct SpatialInteractionDevices::SpatialInteractionTrace **)v10 + 3) )
        {
          ...
          v29 = 28;
          v32 = 28;
          LODWORD(v8) = TlgWrite(v10, &unk_18016E1C5, 0LL, 0LL, 9u, &pData);
        }
      }
    }
  }
