/*
 * XREFs of ?BroadcastSetQuaternionValue@BamoDataSourcePrincipal@@UEAAJIMMMM@Z @ 0x1800994A0
 * Callers:
 *     <none>
 * Callees:
        ...
        float a6)
{
  ...
  if ( *(_QWORD *)(*((_QWORD *)this[3] + 3) + 40LL) )
  {
    v9 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<unsigned int,float,float,float,float>(
           (int)this + 8,
           (unsigned int)BamoImpl::BamoDataSourcePrincipalImpl::CallSetQuaternionValueOnStub,
           a2,
           v8,
           LODWORD(a4),
           LODWORD(a5),
