/*
 * XREFs of std::_Func_impl_no_alloc__lambda_908627fe01edce7427e4f315127fd81c__void_std::shared_ptr_Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice__const_&___ptr64_::_Do_call @ 0x1800B79A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::_Func_impl_no_alloc__lambda_908627fe01edce7427e4f315127fd81c__void_std::shared_ptr_Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice__const_____ptr64_::_Do_call(
        __int64 a1,
        RTL_SRWLOCK **a2)
{
  int updated; // eax
  ...
  if ( Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice::CanSwitchTo6DOF(*a2) )
  {
