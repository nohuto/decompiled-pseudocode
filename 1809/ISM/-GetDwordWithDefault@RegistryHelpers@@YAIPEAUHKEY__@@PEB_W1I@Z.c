/*
 * XREFs of ?GetDwordWithDefault@RegistryHelpers@@YAIPEAUHKEY__@@PEB_W1I@Z @ 0x1800A4E18
 * Callers:
 *     _dynamic_initializer_for__SpatialInteractionDevices::SpatialInteractionHeartbeat::ReportIntervalTickCount64__ @ 0x1800017B0 (_dynamic_initializer_for__SpatialInteractionDevices--SpatialInteractionHeartbeat--ReportInterval.c)
