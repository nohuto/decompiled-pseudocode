/*
 * XREFs of ?OnInputProviderChanged@BamoMPCManagerClientProxy@@UEAAJAEBULegacyDeviceInfo@@I@Z @ 0x1800DC970
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct LegacyDeviceInfo *a2)
{
  ...
  __int128 v20; // xmm1
  __int128 v21; // xmm0
  struct IMessageCallSendHost *v23; // [rsp+40h] [rbp-C0h] BYREF
  volatile signed __int32 *v24; // [rsp+48h] [rbp-B8h] BYREF
  _QWORD v25[2]; // [rsp+50h] [rbp-B0h] BYREF
  _BYTE v26[1008]; // [rsp+60h] [rbp-A0h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+458h] [rbp+358h]
  unsigned int v28; // [rsp+460h] [rbp+360h] BYREF
  unsigned int v29; // [rsp+478h] [rbp+378h] BYREF
...
LABEL_3:
  ...
  *((_QWORD *)v9 + 10) = v17;
  v25[0] = v28;
  v25[1] = v29;
  v4 = CoreUICallSend(v23, v25, 2LL, 4LL, 2, &unk_18014AFE0, (unsigned int)v26);
LABEL_9:
