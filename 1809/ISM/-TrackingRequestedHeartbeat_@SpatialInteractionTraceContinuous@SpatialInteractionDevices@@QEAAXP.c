/*
 * XREFs of ?TrackingRequestedHeartbeat_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXPEB_WKKI_N10AEBU_GUID@@IAEAY02$$CBMAEAY03$$CBM34@Z @ 0x1800AE358
 * Callers:
        ...
        const float (*a14)[4])
{
  ...
  _o_setlocale(4LL);
  _o_setlocale(4LL);
  swprintf_s<128>(v53, L"(%.3e;%.3e;%.3e) (%.3e;%.3e;%.3e;%.3e)", *v14, v14[1], v14[2], *v15, v15[1], v15[2], v15[3]);
  ...
  if ( *(_DWORD *)v19 > 5u && (*(_BYTE *)(v19 + 16) & 2) != 0 && (*(_QWORD *)(v19 + 24) & 2LL) == *(_QWORD *)(v19 + 24) )
  {
    ...
    v50 = v54;
    v51 = 2 * v20 + 2;
    TlgWrite((TraceLoggingHProvider)v19, &unk_180169BDE, 0LL, 0LL, 0xDu, &pData);
  }
  _o_setlocale(4LL);
}
