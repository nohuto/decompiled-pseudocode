/*
 * XREFs of ?OnHeadUpdateEvent@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJPEAUIPerceptionTimestamp@Perception@4@PEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800B01B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Internal::SpatialInteractions::ISpatialInteractionSourceCollectionCallbacks *a3)
{
  ...
  if ( v7 )
  {
    v6 = (struct Windows::Internal::Holographic::ISpatialGraphNodeReference *)*((_QWORD *)this + 53);
  ...
  while ( j != v9 )
  {
    if ( (!(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)j[5] + 32LL))(j[5]) || !*(_BYTE *)(j[5] + 107))
      && (!(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)j[5] + 72LL))(j[5])
       || (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)j[5] + 80LL))(j[5])) )
    {
