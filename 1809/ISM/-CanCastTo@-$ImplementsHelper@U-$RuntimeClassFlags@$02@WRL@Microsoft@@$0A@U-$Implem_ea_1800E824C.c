...
LABEL_17:
  if ( (_DWORD)result == -2147467262 )
  {
    ...
    if ( *a2 == 56
      ...
      || (v6 = a1 + 168, *a2 == -1279705895)
      && a2[1] == *(_DWORD *)&GUID_b3b93cd9_12ee_5c48_ac50_33f6ca48e01f.Data2
      && a2[2] == *(_DWORD *)GUID_b3b93cd9_12ee_5c48_ac50_33f6ca48e01f.Data4
      && a2[3] == *(_DWORD *)&GUID_b3b93cd9_12ee_5c48_ac50_33f6ca48e01f.Data4[4] )
    {
      *a3 = v6;
      return 0LL;
    }
