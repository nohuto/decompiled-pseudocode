/*
 * XREFs of Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_64d1621e142b48138871a19a2ed9ec3f____Windows::Internal::CMarshaledInterfaceResult_Windows::Foundation::IPropertyValue___::Run @ 0x1800E23B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_64d1621e142b48138871a19a2ed9ec3f____Windows::Internal::CMarshaledInterfaceResult_Windows::Foundation::IPropertyValue___::Run(
        __int64 a1,
        int a2,
        int a3,
        __int64 a4)
{
  ...
  if ( a2 == 1 && a3 >= 0 )
  {
    ...
    v10 = v13[0];
    v11 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, PCWSTR, _QWORD))(v8 + 48))(
            v7,
            *(unsigned int *)(a1 + 16),
            StringRawBuffer,
            v13[0]);
