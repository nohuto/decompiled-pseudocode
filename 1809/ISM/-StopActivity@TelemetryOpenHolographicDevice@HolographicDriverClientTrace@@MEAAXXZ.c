/*
 * XREFs of ?StopActivity@TelemetryOpenHolographicDevice@HolographicDriverClientTrace@@MEAAXXZ @ 0x18010A1F0
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x400000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v70 = 2 * v9 + 2;
      v71 = 0;
      TlgWrite(v6, &unk_18016C8E0, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v24 + 3) & 0x400000000000LL) == *((_QWORD *)v24 + 3) )
    {
      ...
      v30 = CurrentThreadId;
      v75 = &v30;
      TlgWrite(v24, &unk_18016D3EC, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v72);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
