/*
 * XREFs of ?SetTestCommands@BamoInputSystemPrincipal@@UEAAXPEAVBamoTestCommandsPrincipal@@@Z @ 0x18001BE10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoTestCommandsPrincipal *a2)
{
  ...
  *((_QWORD *)v3 + 12) = a2;
  ...
  v5 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoDataSourcePrincipalImpl *>(
         v3,
         BamoImpl::BamoInputSystemPrincipalImpl::UpdateTestCommandsRemoteCacheStatic,
         v3);
  if ( v5 < 0 )
  {
