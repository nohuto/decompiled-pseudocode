/*
 * XREFs of ??$insert_or_assign@AEAPEAULegacyDeviceInfo@@@?$unordered_map@KPEAULegacyDeviceInfo@@U?$hash@K@std@@U?$equal_to@K@3@V?$allocator@U?$pair@$$CBKPEAULegacyDeviceInfo@@@std@@@3@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKPEAULegacyDeviceInfo@@@std@@@std@@@std@@@std@@_N@1@AEBKAEAPEAULegacyDeviceInfo@@@Z @ 0x1800851F0
 * Callers:
...
__int64 __fastcall std::unordered_map<unsigned long,LegacyDeviceInfo *>::insert_or_assign<LegacyDeviceInfo * &>(
        _QWORD *a1,
        __int64 a2,
        _DWORD *a3,
        _QWORD *a4)
{
  ...
  {
    v15 = *(__int64 **)(v10 + 8 * v13) == v11 ? a1[1] : **(_QWORD **)(v10 + 8 * v13 + 8);
    if ( j == v15 )
      break;
    if ( *(_DWORD *)(j + 16) == *a3 )
    {
