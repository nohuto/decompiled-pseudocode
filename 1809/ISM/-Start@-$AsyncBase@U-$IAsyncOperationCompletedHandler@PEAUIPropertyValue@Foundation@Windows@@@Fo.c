/*
 * XREFs of ?Start@?$AsyncBase@U?$IAsyncOperationCompletedHandler@PEAUIPropertyValue@Foundation@Windows@@@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@MEAAJXZ @ 0x1800E5D00
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a1)
{
  ...
  if ( v7 == -1 && (v3 = _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 48), 0, -1), v3 == v7) )
  {
    ...
    {
      v8 = L"Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.IPropertyValue>";
