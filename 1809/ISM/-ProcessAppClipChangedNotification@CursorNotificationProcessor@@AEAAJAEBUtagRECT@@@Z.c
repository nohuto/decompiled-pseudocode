/*
 * XREFs of ?ProcessAppClipChangedNotification@CursorNotificationProcessor@@AEAAJAEBUtagRECT@@@Z @ 0x1800865A0
 * Callers:
...
LABEL_7:
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      v6 = (*(__int64 (__fastcall **)(_QWORD, const struct tagRECT *))(*(_QWORD *)*v4 + 88LL))(*v4, a2);
      v7 = v6;
      if ( v6 < 0 )
        break;
      ++v4;
