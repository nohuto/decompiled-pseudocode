        ...
        void *a5)
{
  ...
  if ( a1[1] )
  {
    ...
    if ( a4[3] >= 8uLL )
      v16 = (_QWORD *)*a4;
    if ( (int)_o__wcsicmp(v16) < 0 )
    {
      v27 = v6;
      v17 = std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<SPATIAL_NODE_ID const,Microsoft::WRL::WeakRef>>>>::operator--(&v27);
      v18 = *v17 + 4;
