/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_INPUT_CONFIG_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_INPUT_CONFIG_MESSAGE@@@Z@std@@@Z @ 0x18009E204
 * Callers:
...
struct ISMTestMode *__fastcall KernelInputConnection<_MIT_INPUT_CONFIG_MESSAGE>::Initialize(
        _QWORD *a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    if ( v17 < 0 )
    {
      ...
      JUMPOUT(0x18009E3F3LL);
    }
    result = (struct ISMTestMode *)MITCoreMsgKOpenConnectionTo(7LL, a1 + 3);
    if ( (int)result < 0 )
    {
