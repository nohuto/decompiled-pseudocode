/*
 * XREFs of _lambda_e553b185ff1de720e49cf48bc3fd719c_::_lambda_invoker_cdecl_ @ 0x18009EFC0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall lambda_e553b185ff1de720e49cf48bc3fd719c_::_lambda_invoker_cdecl_(_QWORD *a1, __int64 a2)
{
  ...
  if ( a1[1] )
  {
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)*a1 + 144LL))(*a1);
    *v2 = 0LL;
  }
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD *))(*(_QWORD *)*a1 + 96LL))(*a1, a2 + 8, v2);
  if ( v5 < 0 )
  {
