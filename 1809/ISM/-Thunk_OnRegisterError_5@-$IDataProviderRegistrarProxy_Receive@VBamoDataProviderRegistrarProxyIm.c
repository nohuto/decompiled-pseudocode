/*
 * XREFs of ?Thunk_OnRegisterError_5@?$IDataProviderRegistrarProxy_Receive@VBamoDataProviderRegistrarProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18009CAC0
 * Callers:
 *     <none>
 * Callees:
