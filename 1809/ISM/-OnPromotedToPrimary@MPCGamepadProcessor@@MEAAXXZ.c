/*
 * XREFs of ?OnPromotedToPrimary@MPCGamepadProcessor@@MEAAXXZ @ 0x1800F9930
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::OnPromotedToPrimary(MPCGamepadProcessor *this)
{
  ...
  *((_QWORD *)this + 730) = *((_QWORD *)Instance + 22);
  *((_DWORD *)this + 1462) = *((_DWORD *)Instance + 46);
  v3 = MPCHolographicInputManager::GetInstance();
  memcpy_0(v8, v3, 0x710uLL);
  v4 = (__m128)*((unsigned int *)this + 1461);
  v5 = (__m128)*((unsigned int *)this + 1460);
  v6 = *((float *)this + 1462);
  v4.m128_f32[0] = (float)((float)((float)(v4.m128_f32[0] * v12) + (float)(*((float *)this + 1460) * v9))
                         + (float)(v6 * v15))
                 + v18;
  v5.m128_f32[0] = (float)((float)((float)(v5.m128_f32[0] * v10) + (float)(*((float *)this + 1461) * v13))
                         + (float)(v6 * v16))
                 + v19;
  v7 = (float)((float)((float)(*((float *)this + 1460) * v11) + (float)(*((float *)this + 1461) * v14))
             + (float)(v6 * v17))
     + v20;
  *(_QWORD *)((char *)this + 5852) = _mm_unpacklo_ps(v4, v5).m128_u64[0];
  *(_OWORD *)((char *)this + 5880) = 0LL;
  *((float *)this + 1465) = v7;
}
