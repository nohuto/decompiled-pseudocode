/*
 * XREFs of ?DragStartedLegacy@DragNDrop@InputETW@@SAXKUtagPOINT@@_K010W4VirtualKeyModifiers@System@Windows@@@Z @ 0x1800C80A0
 * Callers:
...
int __fastcall InputETW::DragNDrop::DragStartedLegacy(
        unsigned int a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
    ...
    if ( v10 == *(struct InputETW **)(v11 + 24) )
    {
      ...
      if ( *(_DWORD *)v12 > 5u && (*(_BYTE *)(v12 + 16) & 1) != 0 )
      {
        ...
        if ( v10 == *(struct InputETW **)(v12 + 24) )
        {
          ...
          v40 = 8LL;
          v42 = 8LL;
          LODWORD(v10) = TlgWrite((TraceLoggingHProvider)v12, &unk_18016AE36, 0LL, 0LL, 0xCu, &pData);
        }
      }
    }
  }
