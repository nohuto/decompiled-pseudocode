/*
 * XREFs of ?GetStaticNodeForPose_@HolographicDriverClientContinuousTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@AEBUXMFLOAT4X3@DirectX@@2@Z @ 0x18010E224
 * Callers:
        ...
        const struct SPATIAL_NODE_ID *a6)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*(_BYTE *)(v8 + 16) & 2) != 0 && (*(_QWORD *)(v8 + 24) & 2LL) == *(_QWORD *)(v8 + 24) )
  {
    ...
    v17 = 48LL;
    v19 = 16LL;
    TlgWrite((TraceLoggingHProvider)v8, &unk_18016D626, 0LL, 0LL, 7u, &pData);
  }
}
