/*
 * XREFs of _SystemCursorController::OnStubDisconnected_::_1_::catch$1 @ 0x18013283C
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall SystemCursorController::OnStubDisconnected_::_1_::catch_1(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
