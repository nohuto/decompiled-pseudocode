/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VHolographicDriverClientTrace@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180119DB0
 * Callers:
 *     <none>
 * Callees:
 *     _TlgWrite @ 0x180001144 (_TlgWrite.c)
 *     ?SetFailureInfo@StoredFailureInfo@wil@@QEAAXAEBUFailureInfo@2@@Z @ 0x180002774 (-SetFailureInfo@StoredFailureInfo@wil@@QEAAXAEBUFailureInfo@2@@Z.c)
...
char __fastcall wil::ActivityBase<HolographicDriverClientTrace,1,70368744177664,5,_TlgReflectorTag_Param0IsProviderType>::NotifyFailure(
        __int64 a1,
        int *a2)
{
  int v4; // edx
  ...
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v102 = v27 + 1;
      v103 = 0;
      TlgWrite(v7, &unk_180167C56, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v60);
    }
  }
         ...
         && (*((_QWORD *)v7 + 3) & 0x600000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v139 = 2 * v10 + 2;
    v140 = 0;
    TlgWrite(v7, &unk_180167B51, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
  }
