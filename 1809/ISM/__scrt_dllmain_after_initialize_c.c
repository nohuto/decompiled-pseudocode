/*
 * XREFs of __scrt_dllmain_after_initialize_c @ 0x18012B600
 * Callers:
 *     dllmain_crt_process_attach @ 0x18012B168 (dllmain_crt_process_attach.c)
 * Callees:
 *     ?GetNumPosesRequired@ConstantVelocityPosePredictionModel@Holographic@Internal@Windows@@UEAA?B_KXZ @ 0x180022160 (-GetNumPosesRequired@ConstantVelocityPosePredictionModel@Holographic@Internal@Windows@@UEAA-B_KX.c)
 *     __isa_available_init @ 0x18012BC04 (__isa_available_init.c)
 *     __scrt_is_ucrt_dll_in_use @ 0x18012BDC4 (__scrt_is_ucrt_dll_in_use.c)
 *     _o__configure_narrow_argv_0 @ 0x18012BE7E (_o__configure_narrow_argv_0.c)
 *     _initialize_narrow_environment @ 0x18012BEA2 (_initialize_narrow_environment.c)
 */
