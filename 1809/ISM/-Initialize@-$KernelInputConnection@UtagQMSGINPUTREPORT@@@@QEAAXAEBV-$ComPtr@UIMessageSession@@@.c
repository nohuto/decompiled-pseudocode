/*
 * XREFs of ?Initialize@?$KernelInputConnection@UtagQMSGINPUTREPORT@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBUtagQMSGINPUTREPORT@@@Z@std@@@Z @ 0x1800D49D0
 * Callers:
...
struct ISMTestMode *__fastcall KernelInputConnection<tagQMSGINPUTREPORT>::Initialize(
        _QWORD *a1,
        __int64 *a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    if ( v17 < 0 )
    {
      ...
      JUMPOUT(0x1800D4BBFLL);
    }
    result = (struct ISMTestMode *)MITCoreMsgKOpenConnectionTo(2LL, a1 + 3);
    if ( (int)result < 0 )
    {
