/*
 * XREFs of ?CheckRawReadingForChanges@WGIController@@AEAAJPEA_N@Z @ 0x18006E67C
 * Callers:
...
LABEL_17:
  memcpy_0(
    (void *)(8LL * *((int *)this + 38) + *((_QWORD *)this + 15)),
    *((const void **)this + 15),
    8LL * *((int *)this + 38));
  memcpy_0((void *)(*((int *)this + 39) + *((_QWORD *)this + 16)), *((const void **)this + 16), *((int *)this + 39));
  memcpy_0(
    (void *)(4LL * *((int *)this + 40) + *((_QWORD *)this + 17)),
    *((const void **)this + 17),
    4LL * *((int *)this + 40));
  return 0LL;
}
