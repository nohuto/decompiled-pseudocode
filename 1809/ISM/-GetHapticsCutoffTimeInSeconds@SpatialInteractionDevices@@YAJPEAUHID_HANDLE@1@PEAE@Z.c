/*
 * XREFs of ?GetHapticsCutoffTimeInSeconds@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEAE@Z @ 0x1800A5590
 * Callers:
...
LABEL_3:
  ...
  *(_BYTE *)a2 = 0;
  ...
  result = SpatialInteractionDevices::UpdateFeatureReportIfNeeded((__int64 *)this, v8);
  if ( (int)result >= 0 )
  {
    v5 = SpatialInteractionDevices::Internal::HIDGetInteger<unsigned char>(v4, v4 + 280, v10, v3, v11);
    if ( v5 < 0 )
    {
      v6 = 811LL;
      goto LABEL_3;
