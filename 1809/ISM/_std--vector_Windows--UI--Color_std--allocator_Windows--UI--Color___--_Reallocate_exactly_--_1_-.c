/*
 * XREFs of _std::vector_Windows::UI::Color_std::allocator_Windows::UI::Color___::_Reallocate_exactly_::_1_::catch$0 @ 0x1801319F5
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_Windows::UI::Color_std::allocator_Windows::UI::Color___::_Reallocate_exactly_::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
