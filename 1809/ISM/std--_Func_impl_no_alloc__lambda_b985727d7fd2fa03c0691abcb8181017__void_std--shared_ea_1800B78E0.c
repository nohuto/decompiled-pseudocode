/*
 * XREFs of std::_Func_impl_no_alloc__lambda_b985727d7fd2fa03c0691abcb8181017__void_std::shared_ptr_Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice__const_&___ptr64_::_Do_call @ 0x1800B78E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::_Func_impl_no_alloc__lambda_b985727d7fd2fa03c0691abcb8181017__void_std::shared_ptr_Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice__const_____ptr64_::_Do_call(
        __int64 a1,
        _QWORD *a2)
{
  int updated; // eax
