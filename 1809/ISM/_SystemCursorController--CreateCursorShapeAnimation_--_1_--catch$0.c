/*
 * XREFs of _SystemCursorController::CreateCursorShapeAnimation_::_1_::catch$0 @ 0x180132873
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall SystemCursorController::CreateCursorShapeAnimation_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
