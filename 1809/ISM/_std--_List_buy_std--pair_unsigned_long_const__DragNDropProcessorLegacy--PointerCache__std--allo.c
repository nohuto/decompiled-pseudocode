/*
 * XREFs of _std::_List_buy_std::pair_unsigned_long_const__DragNDropProcessorLegacy::PointerCache__std::allocator_std::pair_unsigned_long_const__DragNDropProcessorLegacy::PointerCache_____::_Buynode_unsigned_long_&___ptr64_DragNDropProcessorLegacy::PointerCache__::_1_::catch$0 @ 0x18012EE54
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::_List_buy_std::pair_unsigned_long_const__DragNDropProcessorLegacy::PointerCache__std::allocator_std::pair_unsigned_long_const__DragNDropProcessorLegacy::PointerCache_____::_Buynode_unsigned_long_____ptr64_DragNDropProcessorLegacy::PointerCache__::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
