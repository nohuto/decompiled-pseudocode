/*
 * XREFs of ??$insert_or_assign@H@?$unordered_map@KKU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@U?$pair@$$CBKK@std@@@2@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKK@std@@@std@@@std@@@std@@_N@1@$$QEAK$$QEAH@Z @ 0x1801042D0
 * Callers:
...
__int64 __fastcall std::unordered_map<unsigned long,unsigned long>::insert_or_assign<int>(
        __int64 a1,
        __int64 a2,
        _DWORD *a3,
        _DWORD *a4)
{
  ...
  if ( v15 == v8 )
  {
    v10 = *v8;
    v11 = *(_QWORD **)(*v8 + 8);
    v12 = std::_List_buy<std::pair<unsigned long const,unsigned long>>::_Buynode<unsigned long const &,unsigned long &>(
            (__int64)v8,
            (_QWORD *)*v8,
            v11,
            v7,
