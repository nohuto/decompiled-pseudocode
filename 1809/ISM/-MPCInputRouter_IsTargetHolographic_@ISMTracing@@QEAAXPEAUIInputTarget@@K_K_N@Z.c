/*
 * XREFs of ?MPCInputRouter_IsTargetHolographic_@ISMTracing@@QEAAXPEAUIInputTarget@@K_K_N@Z @ 0x180009A38
 * Callers:
        ...
        ...)
{
  _DWORD *v5; // rcx
  __int64 v6; // rbx
  unsigned int PIDOfTarget; // [rsp+30h] [rbp-41h] BYREF
  ...
  unsigned int *p_PIDOfTarget; // [rsp+90h] [rbp+1Fh]
  ...
  if ( v5 )
  {
    if ( *v5 )
    {
      ...
      if ( *(_DWORD *)v6 > 5u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
      {
        ...
        v19 = 4;
        TlgWrite((TraceLoggingHProvider)v6, &unk_18016602E, 0LL, 0LL, 6u, &pData);
      }
    }
  }
}
