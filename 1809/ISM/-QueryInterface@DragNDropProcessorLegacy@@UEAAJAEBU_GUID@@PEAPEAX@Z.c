/*
 * XREFs of ?QueryInterface@DragNDropProcessorLegacy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C8F50
 * Callers:
 *     ?QueryInterface@DragNDropProcessorLegacy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C9D50 (-QueryInterface@DragNDropProcessorLegacy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
