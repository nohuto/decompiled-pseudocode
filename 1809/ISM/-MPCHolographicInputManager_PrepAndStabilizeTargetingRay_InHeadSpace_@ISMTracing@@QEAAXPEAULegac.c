/*
 * XREFs of ?MPCHolographicInputManager_PrepAndStabilizeTargetingRay_InHeadSpace_@ISMTracing@@QEAAXPEAULegacyInputInfo@@@Z @ 0x1800445DC
 * Callers:
        ...
        struct LegacyInputInfo *a2)
{
  ...
  if ( *(_DWORD *)v3 > 5u && (*(_BYTE *)(v3 + 16) & 1) != 0 && (*(_QWORD *)(v3 + 24) & 1LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v16 = 4LL;
    v18 = 4LL;
    TlgWrite((TraceLoggingHProvider)v3, &unk_180166FD0, 0LL, 0LL, 9u, &pData);
  }
}
