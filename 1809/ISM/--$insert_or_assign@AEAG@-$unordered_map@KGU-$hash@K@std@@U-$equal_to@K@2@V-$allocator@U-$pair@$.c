/*
 * XREFs of ??$insert_or_assign@AEAG@?$unordered_map@KGU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@U?$pair@$$CBKG@std@@@2@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKG@std@@@std@@@std@@@std@@_N@1@AEBKAEAG@Z @ 0x180104F60
 * Callers:
...
__int64 __fastcall std::unordered_map<unsigned long,unsigned short>::insert_or_assign<unsigned short &>(
        __int64 a1,
        __int64 a2,
        _DWORD *a3,
        _WORD *a4)
...
LABEL_12:
  if ( (__int64 *)v16 == v11 )
  {
    v17 = *v11;
    v18 = *(_QWORD **)(*v11 + 8);
    v19 = std::_List_buy<std::pair<unsigned long const,unsigned short>>::_Buynode<unsigned long const &,unsigned short &>(
            v16,
            (_QWORD *)v17,
            *(_QWORD **)(v17 + 8),
            a3,
