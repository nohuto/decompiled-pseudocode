/*
 * XREFs of ?AllocateStub@BamoDragNDropContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoDragNDropContextualProcessorStub@@@Z @ 0x180021780
 * Callers:
 *     <none>
 * Callees:
