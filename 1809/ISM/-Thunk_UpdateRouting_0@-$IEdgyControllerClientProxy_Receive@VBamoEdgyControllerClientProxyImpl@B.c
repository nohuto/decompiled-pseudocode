/*
 * XREFs of ?Thunk_UpdateRouting_0@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180027DB0
 * Callers:
 *     <none>
 * Callees:
