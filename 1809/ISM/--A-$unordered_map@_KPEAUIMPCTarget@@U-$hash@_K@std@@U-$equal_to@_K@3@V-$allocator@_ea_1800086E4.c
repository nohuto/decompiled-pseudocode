/*
 * XREFs of ??A?$unordered_map@_KPEAUIMPCTarget@@U?$hash@_K@std@@U?$equal_to@_K@3@V?$allocator@U?$pair@$$CB_KPEAUIMPCTarget@@@std@@@3@@std@@QEAAAEAPEAUIMPCTarget@@$$QEA_K@Z @ 0x1800086E4
 * Callers:
...
LABEL_12:
  if ( v13 == v7 )
  {
    ...
    v21 = a2;
    v16 = *(__int64 **)(v14 + 8);
    v17 = std::_List_buy<std::pair<unsigned __int64 const,IMPCTarget *>>::_Buynode<std::piecewise_construct_t const &,std::tuple<unsigned __int64 &&>,std::tuple<>>(
            (_DWORD)v13,
            v15,
            (_DWORD)v16,
            v10,
