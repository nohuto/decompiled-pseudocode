/*
 * XREFs of ?SendMaterializeProxy@BamoMPCManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18003F690
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v7 = CoreUICallSend(a2, &v12, 2LL, 0LL, 4, &unk_18014B005, v10);
  if ( v7 < 0 )
  {
