/*
 * XREFs of _std::vector_Microsoft::WRL::ComPtr_InputSite__std::allocator_Microsoft::WRL::ComPtr_InputSite_____::_Reallocate_exactly_::_1_::catch$0 @ 0x18012EA28
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_Microsoft::WRL::ComPtr_InputSite__std::allocator_Microsoft::WRL::ComPtr_InputSite_____::_Reallocate_exactly_::_1_::catch_0(
        __int64 a1,
        __int64 a2)
{
