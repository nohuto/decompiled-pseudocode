/*
 * XREFs of ?OnMouseSnappedToGaze@MPCManagerClientPrincipal@@UEAAJPEAVBamoMPCManagerClientStub@@AEBULegacyDeviceInfo@@@Z @ 0x1800DF5D0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct LegacyDeviceInfo *a3)
{
  ...
  *v4 = *(_OWORD *)a3;
  ...
  v4[4] = v16;
  *((_QWORD *)v4 + 10) = v12;
  v17 = *(_QWORD *)(*((_QWORD *)this + 7) + 1048LL);
  result = 0LL;
  if ( v17 )
