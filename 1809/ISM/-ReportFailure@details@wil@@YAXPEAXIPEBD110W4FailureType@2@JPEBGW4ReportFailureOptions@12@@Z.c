/*
 * XREFs of ?ReportFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@JPEBGW4ReportFailureOptions@12@@Z @ 0x180003274
 * Callers:
 ...
 * Callees:
 *     ?RethrowCaughtException@wil@@YAXXZ @ 0x180002CA4 (-RethrowCaughtException@wil@@YAXXZ.c)
 *     ?ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z @ 0x180002CC8 (-ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z.c)
