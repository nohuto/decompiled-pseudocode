/*
 * XREFs of ?Thunk_UpdateDragSourceClient_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180020560
 * Callers:
 *     <none>
 * Callees:
