/*
 * XREFs of ?LogMPCClickerInputReport@ISMTracing@@SAXPEAUInputInfo@@AEB_N@Z @ 0x1801025D4
 * Callers:
...
void __fastcall ISMTracing::LogMPCClickerInputReport(struct InputInfo *a1, const bool *a2)
{
  ...
  if ( v2 == 3 || v2 == 6 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
    {
      ...
      v20 = 4LL;
      v22 = 4LL;
      TlgWrite((TraceLoggingHProvider)v6, &unk_18016BC9E, 0LL, 0LL, 8u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 1) != 0 && (*(_QWORD *)(v5 + 24) & 1LL) == *(_QWORD *)(v5 + 24) )
    {
      ...
      v20 = 4LL;
      v22 = 4LL;
      TlgWrite((TraceLoggingHProvider)v5, &unk_18016BA98, 0LL, 0LL, 8u, &pData);
    }
  }
}
