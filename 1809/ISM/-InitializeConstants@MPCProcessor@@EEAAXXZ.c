/*
 * XREFs of ?InitializeConstants@MPCProcessor@@EEAAXXZ @ 0x1800F5F30
 * Callers:
...
void __fastcall MPCProcessor::InitializeConstants(MPCProcessor *this)
{
  ...
  if ( !std::_Execute_once(
          (struct std::once_flag *)&MPCProcessor::s_constantsInitialized,
          (int (*)(void *, void *, void **))std::_Callback_once<std::tuple<_lambda_3929f32d634c578ffcbecb8bfbdfcf67_ &&,std::exception_ptr &>,std::integer_sequence<unsigned __int64,0>,1>,
          v3) )
  {
