/*
 * XREFs of ??A?$unordered_map@_KV?$shared_ptr@VSystemCursor@@@std@@U?$hash@_K@2@U?$equal_to@_K@2@V?$allocator@U?$pair@$$CB_KV?$shared_ptr@VSystemCursor@@@std@@@std@@@2@@std@@QEAAAEAV?$shared_ptr@VSystemCursor@@@1@AEB_K@Z @ 0x18009437C
 * Callers:
...
LABEL_12:
  if ( (_QWORD **)v13 == v7 )
  {
    ...
    v20 = a2;
    v15 = (_QWORD *)v14[1];
    v16 = std::_List_buy<std::pair<unsigned __int64 const,std::shared_ptr<SystemCursor>>>::_Buynode<std::piecewise_construct_t const &,std::tuple<unsigned __int64 const &>,std::tuple<>>(
            v13,
            v14,
            v15,
            v10,
