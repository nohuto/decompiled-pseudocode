/*
 * XREFs of ?Thunk_UpdateType_34@?$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180019C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDropTargetClientProxy_Receive<BamoImpl::BamoDropTargetClientProxyImpl>::Thunk_UpdateType_34(
        __int64 a1,
        _OWORD **a2)
{
  __int64 v3; // rdi
