/*
 * XREFs of ?MPCHolographicInputManager_UpdateDoubleClickValues_@ISMTracing@@QEAAXAEB_NAEBH1@Z @ 0x180044148
 * Callers:
        ...
        const int *a4)
{
  ...
  if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    v13 = a4;
    v14 = 4LL;
    TlgWrite((TraceLoggingHProvider)v7, &unk_180166D9A, 0LL, 0LL, 5u, &pData);
  }
}
