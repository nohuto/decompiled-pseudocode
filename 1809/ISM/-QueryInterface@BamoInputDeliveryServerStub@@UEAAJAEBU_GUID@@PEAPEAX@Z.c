/*
 * XREFs of ?QueryInterface@BamoInputDeliveryServerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180029C50
 * Callers:
 *     ?QueryInterface@BamoInputDeliveryServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002AB50 (-QueryInterface@BamoInputDeliveryServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
