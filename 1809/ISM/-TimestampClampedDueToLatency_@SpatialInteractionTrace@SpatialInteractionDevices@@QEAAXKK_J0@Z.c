/*
 * XREFs of ?TimestampClampedDueToLatency_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKK_J0@Z @ 0x180122890
 * Callers:
        ...
        ...)
{
  ...
  if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 2) != 0 && (*(_QWORD *)(v4 + 24) & 2LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v11 = 8LL;
    v13 = 8LL;
    TlgWrite((TraceLoggingHProvider)v4, &unk_18016DEE9, 0LL, 0LL, 6u, &pData);
  }
}
