/*
 * XREFs of ?PropertyCache_Cleared_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@@Z @ 0x18010D52C
 * Callers:
 *     ?LogCleared@PropertyCache@Holographic@Internal@Windows@@MEAAXXZ @ 0x1801106C0 (-LogCleared@PropertyCache@Holographic@Internal@Windows@@MEAAXXZ.c)
 * Callees:
...
int __fastcall HolographicDriverClientTrace::PropertyCache_Cleared_(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 2) != 0 )
  {
    ...
    if ( v5 == *(struct HolographicDriverClientTrace **)(v6 + 24) )
    {
      ...
      v14 = a3;
      v15 = 16LL;
      LODWORD(v5) = TlgWrite((TraceLoggingHProvider)v6, &unk_18016DBF1, 0LL, 0LL, 4u, &pData);
    }
  }
  return (int)v5;
}
