/*
 * XREFs of ?Thunk_Materialize_BamoActivationConfigurationInputObjectProxy_0@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800178D0
 * Callers:
 *     <none>
 * Callees:
