/*
 * XREFs of ?ControllerNodeButtonLatencySet_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKKH@Z @ 0x180122670
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 2) != 0 && (*(_QWORD *)(v4 + 24) & 2LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    TlgWrite((TraceLoggingHProvider)v4, &unk_18016DC7D, 0LL, 0LL, 5u, &pData);
  }
}
