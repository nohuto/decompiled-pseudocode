/*
 * XREFs of ?RegisterMagnifierClient@BamoMagnifierServerProxy@@UEAAJPEAVBamoMagnifierClientPrincipal@@@Z @ 0x180014E10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoMagnifierClientPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    if ( a2 )
    {
      v8 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoMagnifierClientPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
    ...
    v9 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(
           (BamoMagnifierServerProxy *)((char *)this + 8),
           &v16,
           &v14,
           &v15);
    v4 = v9;
