/*
 * XREFs of Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_d4d997c91d9ada6146019f0263a22bf4____Windows::Internal::CNoResult_::Run @ 0x1800E2580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_d4d997c91d9ada6146019f0263a22bf4____Windows::Internal::CNoResult_::Run(
        __int64 a1,
        int a2,
        int a3,
        __int64 a4)
{
  ...
  if ( a2 == 1 && a3 >= 0 )
  {
    ...
    v10 = v13[0];
    v11 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, PCWSTR, __int64, _QWORD))(v8 + 32))(
            v7,
            *(unsigned int *)(a1 + 16),
            StringRawBuffer,
            a1 + 24,
