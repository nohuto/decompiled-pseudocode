/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_keyboard_l1_1_0_dll @ 0x18012CE22
 * Callers:
 *     __imp_load_MapVirtualKeyExW @ 0x18012CE16 (__imp_load_MapVirtualKeyExW.c)
 *     __imp_load_GetKeyboardLayout @ 0x18012CEA1 (__imp_load_GetKeyboardLayout.c)
 * Callees:
