/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x18001DAE8
 * Callers:
 *     _InputSiteManager::GetInputSiteFromInputSinkHandle_::_1_::dtor$0 @ 0x18012E93B (_InputSiteManager--GetInputSiteFromInputSinkHandle_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
