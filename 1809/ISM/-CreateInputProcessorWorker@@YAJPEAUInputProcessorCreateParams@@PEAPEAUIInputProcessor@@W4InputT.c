/*
 * XREFs of ?CreateInputProcessorWorker@@YAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@W4InputType@@H@Z @ 0x180051EFC
 * Callers:
...
__int64 __fastcall CreateInputProcessorWorker(_QWORD *a1, __int64 a2, int a3, unsigned int a4)
{
  ...
  if ( a4 < 0xE )
  {
    v9 = (char *)&unk_180191360 + 48 * (int)a4;
    do
    {
      v10 = *((_QWORD *)v9 + 1);
