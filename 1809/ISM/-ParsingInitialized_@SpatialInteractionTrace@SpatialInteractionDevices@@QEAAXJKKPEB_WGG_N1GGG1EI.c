/*
 * XREFs of ?ParsingInitialized_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJKKPEB_WGG_N1GGG1EIKAEBUPoseData@2@2@Z @ 0x180121FC4
 * Callers:
        ...
        const struct SpatialInteractionDevices::PoseData *a18)
{
  ...
  if ( *((_BYTE *)v18 + 28) )
    swprintf_s<64>(v71, L"%.3f %.3f %.3f", *(float *)v18, *((float *)v18 + 1), *((float *)v18 + 2));
  else
    ...
    && (*((_QWORD *)v20 + 3) & 0x400000000000LL) == *((_QWORD *)v20 + 3) )
  {
    ...
    v68 = v74;
    v69 = 2 * v22 + 2;
    TlgWrite(v20, &unk_18016E263, 0LL, 0LL, 0x15u, &pData);
  }
}
