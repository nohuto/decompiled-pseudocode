/*
 * XREFs of ?SpatialObjectEnsureDynamicNodeInfoFailed_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@J@Z @ 0x1800BAC14
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 2) != 0 && (*(_QWORD *)(v4 + 24) & 2LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v7 = 16;
    v10 = 4;
    TlgWrite((TraceLoggingHProvider)v4, &unk_18016A758, 0LL, 0LL, 4u, &pData);
  }
}
