/*
 * XREFs of ?Thunk_GetConstantForDevice_25@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18004BB60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCConstantManagerClientPrincipal_Receive<BamoImpl::BamoMPCConstantManagerClientPrincipalImpl>::Thunk_GetConstantForDevice_25(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // ebp
  ...
  if ( !*(_DWORD *)(v9 + 140) )
  {
    ...
    if ( *(_DWORD *)(v9 + 136) != GetCurrentThreadId() )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v14);
      JUMPOUT(0x18004BD4CLL);
    }
    *(_DWORD *)(v9 + 136) = 0;
    LeaveCriticalSection((LPCRITICAL_SECTION)(v9 + 96));
  }
  v15 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD, int *, __int64))(*(_QWORD *)(a1 - 16) + 88LL))(
          a1 - 16,
          v7,
          v19,
          v5,
