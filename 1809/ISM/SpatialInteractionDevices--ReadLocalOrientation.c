/*
 * XREFs of SpatialInteractionDevices::ReadLocalOrientation @ 0x1800A5114
 * Callers:
    ...
    *(_BYTE *)(a4 + 92) = 1;
    ...
    if ( !*(_BYTE *)(a1 + 232) && !v7 )
    {
      if ( *(_BYTE *)(a1 + 237) )
      {
        ...
        v9 = _mm_mul_ps(_mm_shuffle_ps((__m128)xmmword_180192BD8, (__m128)xmmword_180192BD8, 0), v8);
                ...
                _mm_add_ps(
                  _mm_mul_ps(
                    _mm_mul_ps(
                      ...
                      _mm_shuffle_ps((__m128)xmmword_180192BD8, (__m128)xmmword_180192BD8, 170)),
                    (__m128)`DirectX::XMQuaternionMultiply'::`2'::ControlYXWZ),
                  _mm_mul_ps(
                    _mm_mul_ps(_mm_shuffle_ps((__m128)xmmword_180192BD8, (__m128)xmmword_180192BD8, 85), v10),
                    (__m128)`DirectX::XMQuaternionMultiply'::`2'::ControlZWXY)),
                _mm_add_ps(
                  _mm_mul_ps(_mm_shuffle_ps((__m128)xmmword_180192BD8, (__m128)xmmword_180192BD8, 255), *v4),
