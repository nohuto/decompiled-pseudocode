/*
 * XREFs of ?MPCGestureHandler_PointerDown_@ISMTracing@@QEAAXJJIKK@Z @ 0x18004EB28
 * Callers:
...
void __fastcall ISMTracing::MPCGestureHandler_PointerDown_(ISMTracing *this, int a2, int a3, int a4, char a5, char a6)
{
  _DWORD *v6; // rcx
  __int64 v7; // rcx
  ...
  if ( v6 )
  {
    if ( *v6 )
    {
      ...
      if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
      {
        ...
        v19 = 4;
        v22 = 4;
        TlgWrite((TraceLoggingHProvider)v7, &unk_1801675EF, 0LL, 0LL, 7u, &pData);
      }
    }
  }
}
