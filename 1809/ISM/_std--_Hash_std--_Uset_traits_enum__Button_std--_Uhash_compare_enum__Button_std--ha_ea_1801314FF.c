/*
 * XREFs of _std::_Hash_std::_Uset_traits_enum__Button_std::_Uhash_compare_enum__Button_std::hash_enum__Button__std::equal_to_enum__Button____std::allocator_enum__Button__0___::_Insert_enum__Button_const_&___ptr64_std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_enum__Button____std::_Iterator_base0____::_1_::catch$10 @ 0x1801314FF
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::_Hash_std::_Uset_traits_enum__Button_std::_Uhash_compare_enum__Button_std::hash_enum__Button__std::equal_to_enum__Button____std::allocator_enum__Button__0___::_Insert_enum__Button_const_____ptr64_std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_enum__Button____std::_Iterator_base0____::_1_::catch_10(
        __int64 a1,
        __int64 a2)
{
  _QWORD *iter; // rax
