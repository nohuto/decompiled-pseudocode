/*
 * XREFs of ?AllocateStub@BamoControllerNavigationManagerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoControllerNavigationManagerStub@@@Z @ 0x1800325F0
 * Callers:
 *     <none>
 * Callees:
