 ...
 *     ??0HapticsEngine@SpatialInteractions@Internal@Windows@@QEAA@XZ @ 0x180129518 (--0HapticsEngine@SpatialInteractions@Internal@Windows@@QEAA@XZ.c)
        ...
        __int64 *a8)
{
  ...
  __int64 v14; // rbx
  __int64 v15; // rcx
  _QWORD v17[9]; // [rsp+68h] [rbp-60h] BYREF
