/*
 * XREFs of ?AnimationStarted@BamoDragManagerClientProxy@@UEAAJI_K0@Z @ 0x180013B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDragManagerClientProxy::AnimationStarted(BamoDragManagerClientProxy *this, int a2)
{
  unsigned int v4; // ebx
  __int64 v5; // rdx
  __int64 v6; // r9
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 24LL) + 40LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      v12[0] = v14;
      v12[1] = v9;
      v4 = CoreUICallSend(v10, v12, 2LL, 11LL, 5, &unk_18014A9BA, a2);
      goto LABEL_7;
    }
    v6 = (unsigned int)v7;
    v5 = 42050LL;
