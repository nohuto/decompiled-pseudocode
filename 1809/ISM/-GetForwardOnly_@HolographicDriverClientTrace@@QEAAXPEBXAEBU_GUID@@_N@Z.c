/*
 * XREFs of ?GetForwardOnly_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@_N@Z @ 0x18010C7D8
 * Callers:
        ...
        char a4)
{
  ...
  if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 2) != 0 && (*(_QWORD *)(v5 + 24) & 2LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v10 = 16LL;
    v12 = 1LL;
    TlgWrite((TraceLoggingHProvider)v5, &unk_18016D020, 0LL, 0LL, 5u, &pData);
  }
}
