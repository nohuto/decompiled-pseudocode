/*
 * XREFs of ?HandleFlickFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x180091DE4
 * Callers:
  ...
  if ( v3 )
  {
    ...
    if ( (int)v6 >= 0 )
    {
      ...
      if ( a2 )
      {
        ...
        v5 = CContactManager::LoadFeedbackString(v14, ModuleHandleW, dword_1800C49A0[v12], &v28);
        if ( !v5 )
        {
          v27 = 1772;
LABEL_12:
