/*
 * XREFs of ?ProcessPenContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x180094210
 * Callers:
 ...
 *     ?LoadPenResources@CContactManager@@AEAAXXZ @ 0x1800923D4 (-LoadPenResources@CContactManager@@AEAAXXZ.c)
