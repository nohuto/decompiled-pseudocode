/*
 * XREFs of ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_DesktopDisplayBroker@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x180040050
 * Callers:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_DesktopDisplayBroker>::ReportUsageToService(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
  ...
  return wil::details::ReportUsageToService(
           &`wil::Feature<__WilFeatureTraits_Feature_DesktopDisplayBroker>::GetFeaturePropertyCache'::`2'::data,
           12773644LL,
           &v5,
           0LL,
           3);
