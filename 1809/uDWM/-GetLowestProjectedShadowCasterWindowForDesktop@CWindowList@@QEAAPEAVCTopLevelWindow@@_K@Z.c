/*
 * XREFs of ?GetLowestProjectedShadowCasterWindowForDesktop@CWindowList@@QEAAPEAVCTopLevelWindow@@_K@Z @ 0x18008A930
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( Element )
  {
    ...
    {
      v6 = i[49];
      if ( v6 && (*(_BYTE *)(v6 + 241) & 0x40) != 0 )
        return (struct CTopLevelWindow *)i[49];
    }
  }
