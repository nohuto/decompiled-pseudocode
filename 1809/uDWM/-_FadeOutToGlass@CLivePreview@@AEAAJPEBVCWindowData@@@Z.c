/*
 * XREFs of ?_FadeOutToGlass@CLivePreview@@AEAAJPEBVCWindowData@@@Z @ 0x180075684
 * Callers:
...
__int64 __fastcall CLivePreview::_FadeOutToGlass(CLivePreview *this, const struct CWindowData *a2)
{
  ...
  int v53; // eax
  int v54; // eax
  CBaseObject *v56; // [rsp+30h] [rbp-40h] BYREF
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x5BCu);
    return v5;
  }
  ...
  if ( inserted >= 0 )
  {
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x5C7u);
      return v5;
    }
    ...
    if ( v16 >= 0 )
    {
      ...
      do
      {
        ...
        if ( *(char *)(v19 + 598) >= 0 && (!a2 || *(_QWORD *)(v19 + 40) != *((_QWORD *)a2 + 5)) )
        {
          ...
          if ( v21 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x5D2u);
            return v5;
          }
          ...
          if ( v22 )
          {
            v24 = VisualCollection::InsertRelative((VisualCollection *)(*((_QWORD *)this + 64) + 32LL), v62, 0LL, 0, 1);
            v5 = v24;
            if ( v24 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v24, 0x5D6u);
              return v5;
            }
          }
          else
          {
            v25 = VisualCollection::InsertRelative((VisualCollection *)(*((_QWORD *)this + 65) + 32LL), v62, 0LL, 0, 1);
            v5 = v25;
            if ( v25 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v25, 0x5DAu);
              return v5;
            }
          }
    ...
    for ( i = WindowListForDesktop->Blink; i != WindowListForDesktop; i = i->Blink )
    {
      ...
      if ( Blink && LODWORD(i[7].Flink) == 12 )
      {
        ...
        v56 = 0LL;
        v35 = CTopLevelWindow::CloneVisualTreeForLivePreview((CTopLevelWindow *)Blink, 0, v29, v30, &v56);
        v5 = v35;
        if ( v35 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v35, 0x5F7u);
          goto LABEL_67;
        }
        v36 = v56;
        ...
        if ( v38 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v38, 0x604u);
          goto LABEL_67;
        }
        v39 = (unsigned __int8)~HIBYTE(i[37].Flink) >> 7;
        if ( SHIBYTE(i[37].Flink) < 0 )
        ...
        *(_QWORD *)&v58 = v36;
        ...
        if ( v42 >= (unsigned int)v41 )
        {
          ...
          {
            v43 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v40, 0x10u, 1, &v58);
            if ( v43 < 0 )
        ...
        if ( v46 >= v61 )
        {
          if ( v45 > HIDWORD(v60) )
          {
            v48 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v59, 0x10u, 1, &i[3]);
            if ( v48 < 0 )
...
LABEL_67:
      DynArrayImpl<0>::~DynArrayImpl<0>(&v59);
      return v5;
    }
    v50 = CLivePreview::_UpdateResources(this);
    v5 = v50;
    if ( v50 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v50, 0x617u);
      goto LABEL_67;
    }
    ...
    if ( v51 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v51, 0x618u);
      goto LABEL_67;
    }
    v52 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 66) + 64LL))(*((_QWORD *)this + 66));
    v5 = v52;
    if ( v52 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v52, 0x61Au);
      goto LABEL_67;
    }
    v53 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 65) + 64LL))(*((_QWORD *)this + 65));
    v5 = v53;
    if ( v53 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v53, 0x61Bu);
      goto LABEL_67;
    }
    v54 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 64) + 64LL))(*((_QWORD *)this + 64));
    v5 = v54;
    if ( v54 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v54, 0x61Cu);
      goto LABEL_67;
    }
    DynArrayImpl<0>::~DynArrayImpl<0>(&v59);
LABEL_79:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0x5C1u);
  return v5;
}
