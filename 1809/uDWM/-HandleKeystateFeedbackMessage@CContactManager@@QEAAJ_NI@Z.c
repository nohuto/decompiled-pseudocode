/*
 * XREFs of ?HandleKeystateFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x18009200C
 * Callers:
 ...
 *     ?BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z @ 0x180091768 (-BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z.c)
