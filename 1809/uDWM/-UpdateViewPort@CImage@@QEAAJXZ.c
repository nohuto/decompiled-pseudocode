/*
 * XREFs of ?UpdateViewPort@CImage@@QEAAJXZ @ 0x18007CC24
 * Callers:
...
__int64 __fastcall CImage::UpdateViewPort(CImage *this)
{
  ...
  if ( v1 )
  {
    ...
    if ( !v7 )
      v7 = *((_DWORD *)this + 31);
    v10[3] = (float)v7 + v5;
    v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *))(**(_QWORD **)(v1 + 16) + 312LL))(
           *(_QWORD *)(v1 + 16),
           *(unsigned int *)(v1 + 24),
           v10);
    v2 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0xB2u);
  }
  return v2;
}
