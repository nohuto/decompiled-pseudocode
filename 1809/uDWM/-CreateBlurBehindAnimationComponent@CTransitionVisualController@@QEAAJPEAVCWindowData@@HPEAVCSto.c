/*
 * XREFs of ?CreateBlurBehindAnimationComponent@CTransitionVisualController@@QEAAJPEAVCWindowData@@HPEAVCStoryboard@@PEAPEAVCAnimationComponent@@@Z @ 0x18000323C
 * Callers:
  ...
  *a5 = 0LL;
  ...
  if ( v15 )
  {
    ...
    if ( AccentBlurBehindBrush < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, AccentBlurBehindBrush, 0x67Eu);
    v14 = v26;
    v13 = v27;
  }
  if ( (v11 & 0x80000000) != 0 )
