/*
 * XREFs of ?_UpdateBrush@CAnimatedTransitionVisual@@IEAAJPEAVCResource@@@Z @ 0x180032F4C
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::_UpdateBrush(CAnimatedTransitionVisual *this, struct CResource *a2)
{
  ...
  v8 = _xmm;
  v7 = _xmm;
  v3 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int128 *, __int128 *, _DWORD, _DWORD, _DWORD, int, int, _DWORD, _DWORD, int, _DWORD, _DWORD, _DWORD, int))(**(_QWORD **)(v2 + 16) + 1200LL))(
         *(_QWORD *)(v2 + 16),
         *(unsigned int *)(v2 + 24),
         *(_QWORD *)(v2 + 16),
         &v8,
