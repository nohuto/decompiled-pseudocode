/*
 * XREFs of ?_Update3DResources@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18009CAB0
 * Callers:
 ...
 *     ?PerspectiveProjection@Matrix4x4F@D2D1@@SA?AV12@M@Z @ 0x18009BAD4 (-PerspectiveProjection@Matrix4x4F@D2D1@@SA-AV12@M@Z.c)
 *     ?SetProduct@Matrix4x4F@D2D1@@QEAAXAEBV12@0@Z @ 0x18009BEDC (-SetProduct@Matrix4x4F@D2D1@@QEAAXAEBV12@0@Z.c)
 */
...
__int64 __fastcall CAnimatedTransitionVisual::_Update3DResources(CAnimatedTransitionVisual *this)
{
  ...
  v24 = v20;
  v11 = (*(__int64 (__fastcall **)(__int64, __int64, _OWORD *))(*(_QWORD *)v9 + 1112LL))(v9, v10, v36);
  v12 = v11;
  if ( v11 >= 0 )
  {
    v13 = *((_QWORD *)this + 37);
    ...
    v15 = *((_QWORD *)this + 38);
    v28.top = v14;
    v16 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, struct tagRECT *, __int64))(**(_QWORD **)(v15 + 16) + 1120LL))(
            *(_QWORD *)(v15 + 16),
            *(unsigned int *)(v15 + 24),
            &v28,
            2LL);
    ...
    if ( v16 >= 0 )
    {
      ...
      if ( v17 >= 0 )
      {
        ...
        v12 = v18;
        if ( v18 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x735u);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x731u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0x729u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x71Du);
  }
  return v12;
}
