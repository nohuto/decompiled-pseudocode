/*
 * XREFs of ?UpdateScene@CProjectionBorderManager@@UEAAJXZ @ 0x1800343E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProjectionBorderManager::UpdateScene(CProjectionBorderManager *this)
{
  _QWORD *v2; // rax
  unsigned int v3; // ebx
  __int64 v5; // rcx
  ...
  RestartKey = 0LL;
  v2 = RtlEnumerateGenericTableWithoutSplaying((PRTL_GENERIC_TABLE)((char *)this + 440), &RestartKey);
  if ( v2 )
  {
    while ( 1 )
    {
