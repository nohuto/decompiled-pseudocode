/*
 * XREFs of ?_UpdateBackgroundGeometry@CAccent@@IEAAJXZ @ 0x180004B18
 * Callers:
...
__int64 __fastcall CAccent::_UpdateBackgroundGeometry(CAccent *this)
{
  ...
  if ( v10
    && (v11 = CAccent::_UpdateSolidFill(this, v10, *((unsigned int *)this + 72), &v15, LODWORD(FLOAT_1_0)),
        ...
        v11 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x2A8u);
  }
  else
  {
    v12 = *((_QWORD *)this + 41);
    if ( v12 )
    {
      ...
      v1 = updated;
      if ( updated < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x2ADu);
    }
  }
  return v1;
}
