/*
 * XREFs of ?SetReceiver@CProjectedShadowSceneInstance@CProjectedShadowScene@@QEAAJPEAUIVisual@Composition@UI@Windows@@@Z @ 0x1800B0D9C
 * Callers:
        ...
        struct Windows::UI::Composition::IVisual *a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v2 + 168LL))(v2, &v12);
  v6 = v5;
  if ( v5 >= 0 )
  {
    ...
    if ( a2 )
    {
      ...
      v5 = (*(__int64 (__fastcall **)(_QWORD, struct Windows::UI::Composition::IVisual *))(*(_QWORD *)*v8 + 104LL))(
             *v8,
             a2);
      v6 = v5;
      if ( v5 < 0 )
      ...
      v5 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v12 + 56LL))(v12, *v8);
      v6 = v5;
      if ( v5 < 0 )
      {
        v7 = 262LL;
