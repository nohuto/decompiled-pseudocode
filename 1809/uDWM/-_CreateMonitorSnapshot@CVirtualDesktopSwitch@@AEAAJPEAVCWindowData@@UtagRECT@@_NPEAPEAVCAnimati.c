/*
 * XREFs of ?_CreateMonitorSnapshot@CVirtualDesktopSwitch@@AEAAJPEAVCWindowData@@UtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800A5C0C
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  v13 = (*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
          ...
          144LL);
  if ( v13 )
    v5 = CAnimationComponent::CAnimationComponent(v13, 0LL, *((_DWORD *)a2 + 151) & 0xFFF, 1, (__int64)this);
  if ( !v5 )
  {
    v11 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(
  ...
  if ( v14 >= 0 )
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v16, 0x1295u);
      goto LABEL_22;
    }
    ...
    if ( a4
      && (v18 = *(CAnimatedTransitionVisual **)(v5 + 40),
          *(_BYTE *)(v5 + 67) = 1,
          ...
          v19 < 0) )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v19, 0x12A0u);
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v14, 0x1294u);
  }
  v15 = v22;
LABEL_22:
