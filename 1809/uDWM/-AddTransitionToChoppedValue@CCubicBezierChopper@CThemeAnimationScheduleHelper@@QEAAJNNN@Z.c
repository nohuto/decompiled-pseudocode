/*
 * XREFs of ?AddTransitionToChoppedValue@CCubicBezierChopper@CThemeAnimationScheduleHelper@@QEAAJNNN@Z @ 0x18009D944
 * Callers:
      ...
      do
      {
        ...
        else
        {
          ...
          if ( COERCE_DOUBLE(*(_QWORD *)&v13 & _xmm) >= 0.0001 )
            *(double *)&v21[v9] = (*(double *)(v9 * 8 + v11) - *(double *)(v12 + v9 * 8))
                                * (a2 - *(double *)(v12 + 8 * v10))
                                / v13
                                + *(double *)(v12 + v9 * 8);
          else
            v21[v9] = *(_QWORD *)(v12 + v9 * 8);
        }
        ++v8;
        ++v9;
      }
