/*
 * XREFs of ?OnBeginTransitionRequest@CTabletModeTransition@@UEAAJXZ @ 0x1800A4370
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( GetMonitorInfoW(v2, &mi) )
  {
    ...
    *(RECT *)&pt[0].x = *p_rcMonitor;
    ...
    if ( DesktopSnapshotComponent >= 0 )
    {
      ...
      v3 = v8;
      if ( v8 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v8, 0x1333u);
    }
    else
    {
