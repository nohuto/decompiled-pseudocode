/*
 * XREFs of ?LivePreviewAnimation_Flipped@CTopLevelWindow@@AEAAJXZ @ 0x18008776C
 * Callers:
...
__int64 __fastcall CTopLevelWindow::LivePreviewAnimation_Flipped(CTopLevelWindow *this)
{
  ...
  if ( v1 == 1 )
  {
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x108Bu);
      return v2;
    }
LABEL_10:
  ...
  if ( v1 == 2 )
  {
    ...
    if ( v5 )
    {
      if ( *(_BYTE *)(*(_QWORD *)(v5 + 464) + 72LL) )
      {
        ...
        if ( v6 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x1093u);
          return v2;
        }
        goto LABEL_10;
      }
