/*
 * XREFs of ?WrapExistingResource@UdwmTopVisual@@SAJPEAUIDwmChannel@@IPEAPEAV1@@Z @ 0x180021FF4
 * Callers:
...
__int64 __fastcall UdwmTopVisual::WrapExistingResource(
        struct IDwmChannel *a1,
        unsigned int a2,
        struct UdwmTopVisual **a3)
{
  CVisual *v6; // rax
  CVisual *v7; // rbx
  int v8; // eax
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      ...
      CVisual::CVisual(v7);
      *((_QWORD *)v7 + 30) = 0LL;
      *(_QWORD *)v7 = &UdwmTopVisual::`vftable';
    }
    else
    {
      v7 = 0LL;
    ...
    if ( v7 )
    {
      v8 = CVisual::InitializeFromExistingResource((struct CResource **)v7, a1, a2);
      v9 = v8;
      if ( v8 < 0 )
      {
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xE8u);
  }
  return v9;
}
