/*
 * XREFs of ?Initialize@CPenBarrelKeyVisual@@MEAAJPEAUIDwmChannel@@@Z @ 0x180099B90
 * Callers:
...
__int64 __fastcall CPenBarrelKeyVisual::Initialize(CPenBarrelKeyVisual *this, struct IDwmChannel *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( BitmapFromAtlas >= 0 )
    {
      ...
      *((_DWORD *)this + 84) = (int)(*((double *)v9 + 60) * 20.0);
      ...
      if ( v10 >= 0 )
      {
        ...
        v5 = inserted;
        if ( inserted >= 0 )
          CVisual::SetSize(*v8, (const struct tagSIZE *)this + 41);
        else
