/*
 * XREFs of ?_WindowEnumCallback@CFlyoutPopup@@UEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180002ED0
 * Callers:
...
char __fastcall CFlyoutPopup::_WindowEnumCallback(CStoryboard *a1, __int64 a2, char a3, int *a4)
{
  ...
  CBaseObject *v35; // [rsp+68h] [rbp-21h] BYREF
  ...
  if ( v9 > 0x10 )
  {
    if ( v9 == 43 )
    {
      ...
      v27 = CStoryboard::_CreateAndAddNullComponentWithWindowScreen(a1, (struct CWindowData *)a2, v26, 1, &v34);
      v8 = v27;
      if ( v27 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v27, 0x4F2u);
      goto LABEL_35;
    }
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v24, 0x4D4u);
      v4 = v35;
    }
    else
    {
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v11, 0x4AEu);
LABEL_35:
  v12 = v34;
LABEL_28:
  if ( v12 )
