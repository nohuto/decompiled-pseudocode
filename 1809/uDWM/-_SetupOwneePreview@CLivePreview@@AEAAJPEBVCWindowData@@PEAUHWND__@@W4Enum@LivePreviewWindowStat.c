/*
 * XREFs of ?_SetupOwneePreview@CLivePreview@@AEAAJPEBVCWindowData@@PEAUHWND__@@W4Enum@LivePreviewWindowState@@@Z @ 0x1800763B8
 * Callers:
...
__int64 __fastcall CLivePreview::_SetupOwneePreview(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(a2 + 576) )
  {
    while ( 1 )
    {
      ...
      if ( (*(_BYTE *)(v10 + 598) & 0x20) == 0 && ((*(_BYTE *)(v10 + 596) & 1) != 0 || *(_QWORD *)(v10 + 424)) )
      {
        LOBYTE(v13) = 1;
        LOBYTE(a4) = 1;
