/*
 * XREFs of ?BlurBehindChange@CWindowList@@UEAAJPEAUIDwmWindow@@PEBU_DWM_BLURBEHIND@@@Z @ 0x18004A9C0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DWM_BLURBEHIND *a3)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0x1334u);
  }
  else
  {
    v8 = v13;
    if ( v13 )
    {
      ...
      if ( (a3->dwFlags & 1) != 0 )
      {
        *((_BYTE *)v13 + 597) = *((_BYTE *)v13 + 597) & 0xFB | (a3->fEnable ? 4 : 0);
        dwFlags = a3->dwFlags;
      }
      if ( (dwFlags & 4) != 0 )
        *((_BYTE *)v8 + 597) = *((_BYTE *)v8 + 597) & 0xF7 | (a3->fTransitionOnMaximized ? 8 : 0);
