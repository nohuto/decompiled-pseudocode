/*
 * XREFs of CTransitionVisualController::ForEachOwnedWindow__lambda_7f932e07823e6f97f5e718b7a44a95ae___ @ 0x180006930
 * Callers:
  ...
  if ( !a3 || (*(_DWORD *)(a1 + 604) & 0x10000000) != 0 )
  {
    ...
    if ( !v7 || (*(_BYTE *)(v7 + 240) & 0x30) == 0 )
    {
      for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 576); i = (unsigned int)(i + 1) )
      {
        ...
        if ( (*(_DWORD *)(v9 + 604) & 0xFFF) == 0xFFF )
        {
          v10 = *(struct CTopLevelWindow **)(v9 + 392);
          if ( v10 )
