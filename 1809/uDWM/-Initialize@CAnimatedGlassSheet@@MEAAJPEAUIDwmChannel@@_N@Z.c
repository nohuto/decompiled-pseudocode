/*
 * XREFs of ?Initialize@CAnimatedGlassSheet@@MEAAJPEAUIDwmChannel@@_N@Z @ 0x18008F190
 * Callers:
 ...
 *     ?GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z @ 0x180087664 (-GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z.c)
 */
        ...
        unsigned __int8 a3)
{
  ...
  v42 = a2;
  v5 = CAtlasedRectsVisual::Initialize((CBaseObject **)this, a2);
  v6 = v5;
  if ( v5 >= 0 )
  {
    v7 = a3;
    ...
    *((_DWORD *)this + 117) = v21;
    ...
    v46[8] = -v19;
    v46[9] = -v20;
    *(double *)v22.m128i_i64 = _mm_cvtepi32_pd(v22).m128d_f64[0] * *((double *)v9 + 60);
    v52 = -v19;
    v60 = -v21;
    v65 = 0x7FFFFFFF;
    v66 = -v21;
    ...
    v23 = v46;
    v93 = v81;
    v24 = (struct CAtlasedImage **)((char *)this + 280);
    v98 = v109;
    v88 = -(v108 + v19);
    v25 = 0LL;
    v94 = v88;
    ...
    while ( 1 )
    {
      v28 = CAtlasedImage::Create(v42, (struct CAtlasedImage **)this + v25 + 35);
      v6 = v28;
      if ( v28 < 0 )
        break;
      CAtlasedRectsVisual::InsertAtlasImageAtIndex(this, *v24, *((_DWORD *)this + 66));
      ...
      CAtlasedImage::SetInsetFromParent(*v24, (struct _MARGINS *)&v45[6 * v25]);
      if ( *(v23 - 1) != 0x7FFFFFFF )
      {
        v30 = *v24;
        v41.cx = *(v23 - 1);
        v41.cy = *((_DWORD *)v30 + 7);
        CAtlasedImage::SetSize((struct tagSIZE *)v30, &v41);
      }
      if ( *v23 != 0x7FFFFFFF )
      {
        v31 = *v24;
        v40.cy = *v23;
        v40.cx = *((_DWORD *)v31 + 6);
        CAtlasedImage::SetSize((struct tagSIZE *)v31, &v40);
      }
      v32 = 8;
      if ( *(v23 - 2) != 0x7FFFFFFF )
        v32 = 0;
