/*
 * XREFs of ?RecordUsageInternal@RawUsageIndex@details_abi@wil@@AEAA_NPEAX_K01I@Z @ 0x180001CC4
 * Callers:
 ...
 *     ?Read@UsageIndexProperty@details_abi@wil@@QEAA_NAEAPEAEPEAE@Z @ 0x180001FD4 (-Read@UsageIndexProperty@details_abi@wil@@QEAA_NAEAPEAEPEAE@Z.c)
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x1800020BC (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
 *     ?Write@UsageIndexProperty@details_abi@wil@@QEBA_NAEAPEAEPEAE@Z @ 0x1800020E8 (-Write@UsageIndexProperty@details_abi@wil@@QEBA_NAEAPEAEPEAE@Z.c)
 *     ?AddToCount@UsageIndexProperty@details_abi@wil@@QEAA_NI@Z @ 0x18000219C (-AddToCount@UsageIndexProperty@details_abi@wil@@QEAA_NI@Z.c)
        ...
        unsigned int a6)
{
  ...
  unsigned __int16 v34; // [rsp+38h] [rbp-41h]
  void *Buf2[2]; // [rsp+40h] [rbp-39h]
...
LABEL_15:
    ...
    v40 = v22;
    v41 = v20;
    v24 = wil::details_abi::UsageIndexProperty::GetSize((wil::details_abi::UsageIndexProperty *)&v36);
    v25 = *((_QWORD *)this + 4);
    v27 = v26 + v24;
    v28 = *((_QWORD *)this + 5);
    if ( ((v28 - v25) & -(__int64)(v25 < v28)) >= v27 )
    {
      memmove_s(&v10[v27], v28 - v27 - (_QWORD)v10, v10, v25 - (_QWORD)v10);
      v29 = (unsigned __int8 *)(v27 + *((_QWORD *)this + 4));
      *((_QWORD *)this + 4) = v29;
      if ( v11 )
        wil::details_abi::UsageIndexProperty::AddToCount((wil::details_abi::UsageIndexProperty *)&v31, 1u);
      else
        wil::details_abi::UsageIndexProperty::Write((wil::details_abi::UsageIndexProperty *)&v31, &v47, v29);
