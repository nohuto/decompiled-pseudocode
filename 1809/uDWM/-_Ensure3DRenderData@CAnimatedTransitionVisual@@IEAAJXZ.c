/*
 * XREFs of ?_Ensure3DRenderData@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18009C844
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::_Ensure3DRenderData(CAnimatedTransitionVisual *this)
{
  ...
  struct CDrawBitmapInstruction *v12; // [rsp+70h] [rbp+30h] BYREF
  CBaseObject *v13; // [rsp+78h] [rbp+38h] BYREF
  ...
  if ( !*((_DWORD *)this + 70) )
  {
    v4 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 40) + 16LL) + 1144LL))(
