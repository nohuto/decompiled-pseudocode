/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VWindowFrameLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x18002AEAC
 * Callers:
  ...
  if ( a2 < 0 )
  {
    ...
    if ( v7 )
    {
        ...
        && (*(_QWORD *)(v9 + 24) & 0x200000000000LL) == *(_QWORD *)(v9 + 24) )
      {
        ...
        TlgWrite(v21, &unk_1800C2D72, (LPCGUID)(a1[6] + 8LL), 0LL, 0x10u, &pData);
      }
    }
    else
    {
      v22 = (const struct _TlgProvider_t *)v8[1];
      if ( *(_DWORD *)v22 > 5u
        ...
        && (*((_QWORD *)v22 + 3) & 0x200000000000LL) == *((_QWORD *)v22 + 3) )
      {
        ...
        TlgWrite(v22, &unk_1800C2E79, (LPCGUID)(a1[6] + 8LL), 0LL, 6u, &v57);
      }
    }
  }
