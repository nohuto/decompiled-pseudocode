/*
 * XREFs of ?_AddDisplayCaptureEntry@CProjectionBorderManager@@AEAAJPEAUHMONITOR__@@IAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x180082568
 * Callers:
...
LABEL_17:
  DynArrayImpl<0>::~DynArrayImpl<0>((_QWORD *)&v17 + 1);
  return v10;
}
