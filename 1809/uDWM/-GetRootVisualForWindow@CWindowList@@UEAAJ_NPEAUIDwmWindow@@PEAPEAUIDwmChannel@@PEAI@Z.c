/*
 * XREFs of ?GetRootVisualForWindow@CWindowList@@UEAAJ_NPEAUIDwmWindow@@PEAPEAUIDwmChannel@@PEAI@Z @ 0x18008ABC0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a5)
{
  ...
  v9 = a5;
  v16 = 0LL;
  *a4 = (struct IDwmChannel *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5);
  *v9 = 0;
  ...
  {
    if ( !v16
      || (v12 = (CTopLevelWindow *)*((_QWORD *)v16 + 49)) == 0LL
      || (!a2
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x14D5u);
  }
