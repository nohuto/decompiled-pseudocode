/*
 * XREFs of ?_RecordUnionRect@CGroupingStoryboard@@IEAAJW4DWMTRANSITION_TARGET@@AEBUtagRECT@@@Z @ 0x1800A64DC
 * Callers:
...
__int64 __fastcall CGroupingStoryboard::_RecordUnionRect(__int64 a1, __int64 a2, RECT *a3)
{
  ...
  v14 = v13;
  if ( v13 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v13, 0x7E2u);
  return v14;
}
