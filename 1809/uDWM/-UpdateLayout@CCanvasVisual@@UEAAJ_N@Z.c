/*
 * XREFs of ?UpdateLayout@CCanvasVisual@@UEAAJ_N@Z @ 0x18000B670
 * Callers:
...
__int64 __fastcall CCanvasVisual::UpdateLayout(CCanvasVisual *this)
{
  ...
  tagSIZE v10; // [rsp+60h] [rbp+18h] BYREF
  ...
  {
    v4 = (*(__int64 (__fastcall **)(CCanvasVisual *, tagSIZE *))(*(_QWORD *)this + 96LL))(this, &v10);
    v1 = v4;
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x11Cu);
      goto LABEL_12;
    }
