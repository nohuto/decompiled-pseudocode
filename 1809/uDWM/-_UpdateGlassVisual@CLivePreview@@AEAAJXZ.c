/*
 * XREFs of ?_UpdateGlassVisual@CLivePreview@@AEAAJXZ @ 0x180076BD4
 * Callers:
...
__int64 __fastcall CLivePreview::_UpdateGlassVisual(CLivePreview *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    do
    {
      v9 = *((_QWORD *)this + 38);
      v10 = *(_QWORD *)(v9 + v8);
      v11 = *(CTopLevelWindow **)(v10 + 392);
      if ( (*(_BYTE *)(v10 + 598) & 0x40) == 0 )
      {
        ...
        else if ( !*(_QWORD *)(v9 + v8 + 16) )
        {
          ...
          if ( v12 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x637u);
            return v4;
          }
          v13 = v18;
          ...
          if ( inserted < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0x638u);
            return v4;
          }
