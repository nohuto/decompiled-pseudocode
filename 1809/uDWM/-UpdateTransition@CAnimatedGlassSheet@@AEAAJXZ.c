/*
 * XREFs of ?UpdateTransition@CAnimatedGlassSheet@@AEAAJXZ @ 0x18008FC00
 * Callers:
 ...
 *     ?InterpolateValueLinear@CAnimatedGlassSheet@@AEAAJJJM@Z @ 0x18008F658 (-InterpolateValueLinear@CAnimatedGlassSheet@@AEAAJJJM@Z.c)
