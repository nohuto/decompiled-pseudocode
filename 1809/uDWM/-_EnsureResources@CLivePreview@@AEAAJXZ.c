/*
 * XREFs of ?_EnsureResources@CLivePreview@@AEAAJXZ @ 0x18003DC7C
 * Callers:
...
__int64 __fastcall CLivePreview::_EnsureResources(CLivePreview *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0x660u);
  }
  else
  {
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x661u);
    }
    else
    {
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x663u);
      }
      else
      {
        ...
        if ( v6 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x664u);
        }
        else
        {
          ...
          if ( v7 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x665u);
          }
          else
          {
            ...
            v3 = v8;
            if ( v8 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x666u);
          }
        }
      }
    }
