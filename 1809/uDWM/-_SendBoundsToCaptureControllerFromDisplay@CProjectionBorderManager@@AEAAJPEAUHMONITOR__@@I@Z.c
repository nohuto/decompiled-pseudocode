/*
 * XREFs of ?_SendBoundsToCaptureControllerFromDisplay@CProjectionBorderManager@@AEAAJPEAUHMONITOR__@@I@Z @ 0x1800833A8
 * Callers:
...
LABEL_3:
  ...
  DisplayRect = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)this + 54) + 1256LL))(
                  *((_QWORD *)this + 54),
                  a3);
  if ( DisplayRect < 0 )
  {
