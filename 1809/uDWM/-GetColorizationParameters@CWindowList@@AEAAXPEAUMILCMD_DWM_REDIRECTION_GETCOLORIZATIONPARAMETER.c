/*
 * XREFs of ?GetColorizationParameters@CWindowList@@AEAAXPEAUMILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS@@@Z @ 0x18008A710
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS *a2)
{
  ...
  v3 = *(__m128i *)((char *)CDesktopManager::s_pDesktopManagerInstance + 532);
  v4 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 139);
  v7 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 548);
