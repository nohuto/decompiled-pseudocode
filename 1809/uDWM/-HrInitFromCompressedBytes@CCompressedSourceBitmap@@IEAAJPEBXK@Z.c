/*
 * XREFs of ?HrInitFromCompressedBytes@CCompressedSourceBitmap@@IEAAJPEBXK@Z @ 0x180048D84
 * Callers:
        ...
        unsigned int a3)
{
  ...
  *((_QWORD *)this + 34) = v7;
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x8Fu);
  }
  return v6;
}
