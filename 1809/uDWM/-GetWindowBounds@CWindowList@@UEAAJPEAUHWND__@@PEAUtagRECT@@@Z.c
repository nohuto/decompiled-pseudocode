/*
 * XREFs of ?GetWindowBounds@CWindowList@@UEAAJPEAUHWND__@@PEAUtagRECT@@@Z @ 0x18008AD50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::GetWindowBounds(CWindowList *this, HWND a2, struct tagRECT *a3)
{
  ...
  *(_QWORD *)&a3->right = 0LL;
  ...
  if ( SyncedWindowDataByHwnd >= 0 )
  {
    if ( *(_QWORD *)&v11.left )
    {
      v8 = *(CTopLevelWindow **)(*(_QWORD *)&v11.left + 392LL);
      if ( v8 )
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowDataByHwnd, 0x15DEu);
  }
