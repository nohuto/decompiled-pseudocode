/*
 * XREFs of _CRT_INIT @ 0x18004CD0C
 * Callers:
 *     __DllMainCRTStartup @ 0x18004CF88 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x18004D1E6 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x18004D250 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x18004D3BF (_initterm_0.c)
