/*
 * XREFs of ??$UpdateCaptureControllerTransformFromDisplay@NN@WindowFrameLoggingTelemetry@@SAX$$QEAN0@Z @ 0x18007F24C
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( *(_DWORD *)v5 > 5u && (*((_QWORD *)v5 + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v4 == *((_QWORD *)v5 + 3) )
    {
      ...
      v8 = a1;
      v11 = a2;
      LODWORD(v4) = TlgWrite(v5, &unk_1800C1FA3, 0LL, 0LL, 4u, &pData);
    }
  }
  return v4;
}
