/*
 * XREFs of ?_WindowEnumCallback@CGroupingStoryboard@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800A8E50
 * Callers:
...
char __fastcall CGroupingStoryboard::_WindowEnumCallback(struct CStoryboard *a1, __int64 a2, char a3, _DWORD *a4)
{
  ...
  if ( (a3 & 4) != 0
    && ((*(__int64 (__fastcall **)(struct CStoryboard *, _QWORD))(*(_QWORD *)a1 + 120LL))(
          a1,
          *(_DWORD *)(a2 + 604) & 0xFFF) & 8) != 0 )
  {
    CGroupingStoryboard::_RecordUnionRect(
      (__int64)a1,
      *(unsigned int *)(a2 + 604),
      (RECT *)(a2 + ((*(_DWORD *)(a2 + 604) & 0x1000000) != 0 ? 624LL : 48LL)));
      ...
      *(_QWORD *)&v9.right = 0LL;
      if ( (int)CTransitionVisualController::GetBitmapRects(
                  *((CTransitionVisualController **)CDesktopManager::s_pDesktopManagerInstance + 31),
                  ...
                  &v9,
                  0LL) >= 0 )
        CGroupingStoryboard::_RecordUnionRect((__int64)a1, *(unsigned int *)(a2 + 604), &v9);
    }
  }
  *a4 = 0;
  return 1;
