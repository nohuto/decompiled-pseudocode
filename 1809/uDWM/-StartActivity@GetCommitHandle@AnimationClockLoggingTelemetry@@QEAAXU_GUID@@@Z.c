/*
 * XREFs of ?StartActivity@GetCommitHandle@AnimationClockLoggingTelemetry@@QEAAXU_GUID@@@Z @ 0x1800AED18
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  if ( *(_DWORD *)v6 > 4u )
  {
    ...
    TlgWrite(v6, &unk_1800C2F24, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v7, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
