/*
 * XREFs of ?CreateOrUpdateImageBrush@CBitmapSource@@QEAAJPEAPEAVCResource@@00W4Enum@MilStretch@@@Z @ 0x180077E48
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v27 )
    ...
    v20 = 0;
  v21 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int128 *, __int128 *, int, _DWORD, _DWORD, int, int, int, _DWORD, unsigned int, _DWORD, int, int, _DWORD))(**((_QWORD **)v28 + 2) + 1200LL))(
          *((_QWORD *)v28 + 2),
          *((unsigned int *)v28 + 6),
          a5,
          &v29,
