/*
 * XREFs of ?CreateCVIForAnimation@CSecondaryWindowRepresentation@@QEAAPEAVCResource@@_N@Z @ 0x180026164
 * Callers:
        ...
        char a2)
{
  ...
  v5 = CResource::Create(5u, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5), &v19);
  v6 = v19;
  v7 = v5;
  if ( v5 < 0 )
  {
...
LABEL_6:
  ...
  if ( v10 && (v13 = *(_QWORD *)(v10 + 16)) != 0 )
    ...
    v14 = 0;
  v15 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _DWORD *, __int128 *, _DWORD, _DWORD, int, _DWORD))(**((_QWORD **)v6 + 2) + 1000LL))(
          *((_QWORD *)v6 + 2),
          *((unsigned int *)v6 + 6),
          v21,
          &v20,
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x362u);
  }
  else if ( a2 )
  {
    (*(void (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)v6 + 2) + 1008LL))(
      *((_QWORD *)v6 + 2),
      *((unsigned int *)v6 + 6));
  }
LABEL_15:
