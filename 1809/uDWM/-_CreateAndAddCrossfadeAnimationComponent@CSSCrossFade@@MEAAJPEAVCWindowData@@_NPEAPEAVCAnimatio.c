/*
 * XREFs of ?_CreateAndAddCrossfadeAnimationComponent@CSSCrossFade@@MEAAJPEAVCWindowData@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800A5730
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CAnimationComponent **a4)
{
  ...
  if ( (_BYTE)a3 )
  {
    *((_DWORD *)a2 + 151) |= 0x200000u;
  }
  else if ( (*((_DWORD *)a2 + 151) & 0x10000000) == 0
         || (int)CTransitionVisualController::GetClonableOwnedWindowCount(a2, (__int64)a2, a3) <= 0 )
  {
    v7 = *((unsigned int *)a2 + 151);
    if ( (v7 & 0x20000000) == 0 )
    {
      v8 = 1;
      goto LABEL_4;
