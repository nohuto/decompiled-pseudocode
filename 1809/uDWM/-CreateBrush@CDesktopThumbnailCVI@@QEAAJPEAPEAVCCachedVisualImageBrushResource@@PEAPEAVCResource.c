/*
 * XREFs of ?CreateBrush@CDesktopThumbnailCVI@@QEAAJPEAPEAVCCachedVisualImageBrushResource@@PEAPEAVCResource@@1AEBUtagRECT@@@Z @ 0x1800AAAC4
 * Callers:
...
LABEL_5:
    ...
    if ( v12 >= 0 )
    {
      ...
      v12 = CCachedVisualImageBrushResource::Create(v14, *((_QWORD *)this + 2), &v26);
      v11 = v12;
      if ( v12 >= 0 )
      {
        v15 = 0;
        ...
        v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int128 *, int *, _DWORD, _DWORD, _DWORD, int, int, _DWORD, int, int, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)v26 + 2) + 1200LL))(
                *((_QWORD *)v26 + 2),
                *((unsigned int *)v26 + 6),
                *((_QWORD *)v26 + 2),
                &v29,
