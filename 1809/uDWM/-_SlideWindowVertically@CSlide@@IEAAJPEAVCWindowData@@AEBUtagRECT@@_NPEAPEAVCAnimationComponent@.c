/*
 * XREFs of ?_SlideWindowVertically@CSlide@@IEAAJPEAVCWindowData@@AEBUtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800A6A40
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  CBaseObject *v24; // [rsp+50h] [rbp-21h] BYREF
  ...
  v24 = 0LL;
  v11 = (*(__int64 (__fastcall **)(CSlide *, __int64))(v5 + 112))(this, bottom);
  ...
  if ( v12 >= 0 )
  {
    ...
    if ( (int)abs32(v16 - HIDWORD(v17)) >= (int)abs32(top - v25.top) )
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v12, 0x17Eu);
  }
  if ( v14 < 0 && v13 )
