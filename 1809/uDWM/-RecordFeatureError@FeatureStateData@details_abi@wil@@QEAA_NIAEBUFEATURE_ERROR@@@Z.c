/*
 * XREFs of ?RecordFeatureError@FeatureStateData@details_abi@wil@@QEAA_NIAEBUFEATURE_ERROR@@@Z @ 0x180070EE4
 * Callers:
 ...
 *     ?ensure@heap_buffer@details_abi@wil@@QEAA_N_K@Z @ 0x180039530 (-ensure@heap_buffer@details_abi@wil@@QEAA_N_K@Z.c)
