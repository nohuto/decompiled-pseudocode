/*
 * XREFs of ?DwmClientStartup@@YAJPEBUStartupInfo@@PEAUCompositionInfo@@@Z @ 0x18003C820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DwmClientStartup(const struct StartupInfo *a1, struct CompositionInfo *a2)
{
  ...
  if ( dword_1800D7BD8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800D7BD8);
    if ( dword_1800D7BD8 == -1 )
    {
      dword_1800D5068 = -2147024846;
      dword_1800D506C = -2003302655;
      Init_thread_footer(&dword_1800D7BD8);
    }
  }
  ...
  v6 = v5;
  if ( v5 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D5068, 2u, v5, 0x4Cu);
