/*
 * XREFs of ?FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x18006FDF4
 * Callers:
        ...
        const char *a4)
{
  ...
  wil::details::ReportFailure_Hr(this, a2, "internal\\sdk\\inc\\wil\\resource.h", 0LL, 0LL, retaddr, 3, -2147418113);
}
