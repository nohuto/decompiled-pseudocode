/*
 * XREFs of ??1CWindowSnapshot@@MEAA@XZ @ 0x180028364
 * Callers:
...
void __fastcall CWindowSnapshot::~CWindowSnapshot(CWindowSnapshot *this)
{
  ...
  *((_QWORD *)this + 2) = &CWindowSnapshot::`vftable'{for `ISecondaryWindowRepresentationChangedListener'};
  ...
  if ( v9 )
  {
    ...
    v17 = (CBaseObject *)v16[49];
    if ( v17 )
    {
      CBaseObject::Release(v17);
      v16 = (_QWORD *)*((_QWORD *)this + 4);
    }
    v18 = (CBaseObject *)v16[45];
    if ( v18 )
    {
      CBaseObject::Release(v18);
      v16 = (_QWORD *)*((_QWORD *)this + 4);
    }
    v19 = (CBaseObject *)v16[47];
    if ( v19 )
  ...
  if ( v21 )
  {
    CWindowData::`scalar deleting destructor'(v21);
    *((_QWORD *)this + 4) = 0LL;
  }
