/*
 * XREFs of ?UpdateThumbnailProperties@CWindowList@@AEAAJKPEAUMILCMD_DWM_REDIRECTION_UPDATETHUMBNAILPROPERTIES@@@Z @ 0x18008D500
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_UPDATETHUMBNAILPROPERTIES *a3)
{
  ...
  if ( ThumbnailData
    && a2 == *((_DWORD *)a3 + 2)
    && ((v7 = (const struct _DWM_THUMBNAIL_PROPERTIES *)((char *)a3 + 12), !*((_BYTE *)ThumbnailData + 42))
     || (v7->dwFlags & 0x3EFFFFF) != 0x3EFFFFF && (v7->dwFlags & 0xFC100000) != 0) )
  {
    updated = CThumbnailData::UpdateProperties(ThumbnailData, v7);
    v9 = updated;
    if ( updated < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x1027u);
  }
  else
  {
    v9 = -2147024809;
