/*
 * XREFs of ?StartIdle@CIndirectTouchVisual@@QEAAJPEBUtagPOINT@@W4DWM_SHOWCONTACT@@@Z @ 0x1800A2350
 * Callers:
 ...
 *     ?UpdateOpacityAndSource@CIndirectTouchVisual@@IEAAXXZ @ 0x1800A26DC (-UpdateOpacityAndSource@CIndirectTouchVisual@@IEAAXXZ.c)
 */
  ...
  *(_QWORD *)(a1 + 352) = v6;
  ...
  if ( *(float *)(a1 + 332) == 0.0 )
  {
    ...
    *(_QWORD *)(a1 + 368) = v8;
    if ( !v8 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0xAEu);
LABEL_22:
      CIndirectTouchVisual::StopAllTimelines((CIndirectTouchVisual *)a1);
      *(_DWORD *)(a1 + 340) = 0;
      *(_DWORD *)(a1 + 344) = 0;
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 360) = v10;
    if ( !v10 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0xB3u);
      goto LABEL_22;
    }
  }
  ...
  if ( v11 >= 0 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0xB6u);
  if ( v12 < 0 )
    goto LABEL_22;
  return 0LL;
}
