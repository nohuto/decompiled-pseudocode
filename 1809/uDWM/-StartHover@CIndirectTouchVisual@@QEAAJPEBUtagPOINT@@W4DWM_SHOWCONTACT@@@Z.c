/*
 * XREFs of ?StartHover@CIndirectTouchVisual@@QEAAJPEBUtagPOINT@@W4DWM_SHOWCONTACT@@@Z @ 0x1800A21CC
 * Callers:
...
__int64 __fastcall CIndirectTouchVisual::StartHover(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 368) = v8;
  if ( !v8 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x83u);
LABEL_16:
    CIndirectTouchVisual::StopAllTimelines((CIndirectTouchVisual *)a1);
    *(_DWORD *)(a1 + 344) = 0;
  ...
  if ( v9 >= 0 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x85u);
  if ( v10 < 0 )
    goto LABEL_16;
  return 0LL;
}
