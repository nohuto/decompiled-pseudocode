/*
 * XREFs of ?RemoveAllElements@?$CGenericTableMap@W4IMMERSIVE_COLOR_TYPE@@UColorData@ColorCache@@@@QEAAXXZ @ 0x18004BDBC
 * Callers:
 *     _dynamic_atexit_destructor_for__ColorCache::_cachedColors__ @ 0x18004EBB0 (_dynamic_atexit_destructor_for__ColorCache--_cachedColors__.c)
 * Callees:
 *     <none>
 */
