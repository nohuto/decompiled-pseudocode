/*
 * XREFs of ?GetCommitHandle@CAnimationClock@@QEAAJKPEAPEAX@Z @ 0x1800AE74C
 * Callers:
...
LABEL_13:
    wil::ActivityBase<AnimationClockLogging,0,0,4,_TlgReflectorTag_Param0IsProviderType>::Stop((__int64)v18, 0);
    goto LABEL_14;
  }
  v9 = 636LL;
LABEL_9:
