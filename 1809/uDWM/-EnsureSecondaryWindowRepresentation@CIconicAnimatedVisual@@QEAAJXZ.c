/*
 * XREFs of ?EnsureSecondaryWindowRepresentation@CIconicAnimatedVisual@@QEAAJXZ @ 0x1800ADA84
 * Callers:
...
__int64 __fastcall CIconicAnimatedVisual::EnsureSecondaryWindowRepresentation(CIconicAnimatedVisual *this)
{
  ...
  if ( !*((_QWORD *)this + 36) && *((_QWORD *)this + 37) )
  {
    ...
    if ( ScaleFactorForMonitorImp >= 0 )
    {
      ...
      v1 = v8;
      if ( v8 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x52u);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, ScaleFactorForMonitorImp, 0x4Bu);
    }
  }
  return v1;
}
