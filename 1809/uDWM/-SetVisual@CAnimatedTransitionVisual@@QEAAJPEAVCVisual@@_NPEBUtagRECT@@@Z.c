/*
 * XREFs of ?SetVisual@CAnimatedTransitionVisual@@QEAAJPEAVCVisual@@_NPEBUtagRECT@@@Z @ 0x180032BA0
 * Callers:
...
LABEL_9:
  ...
  *(_QWORD *)&v37.right = 0LL;
  ...
  if ( v25 )
    ...
    v26 = 0;
  v27 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64 *, struct tagRECT *, _DWORD, _DWORD, int, _DWORD))(**((_QWORD **)v24 + 2) + 1000LL))(
          *((_QWORD *)v24 + 2),
          *((unsigned int *)v24 + 6),
          &v35,
          &v37,
  ...
  if ( v27 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x2FBu);
         ...
         && (v30 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)this[73] + 2) + 1008LL))(
                     *((_QWORD *)this[73] + 2),
