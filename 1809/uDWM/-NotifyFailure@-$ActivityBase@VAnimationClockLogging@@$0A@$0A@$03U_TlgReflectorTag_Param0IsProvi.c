/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VAnimationClockLogging@@$0A@$0A@$03U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800AE980
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
                    ...
                    (void (__cdecl *)())lambda_9ef98c5d6b8c5c3c74462e1eb0f6f12e_::_lambda_invoker_cdecl_)[1] > 5u )
  {
    ...
    v65 = v22;
    TlgCreateSz(&v67, v21);
    TlgWrite(v23, &unk_1800C2ABC, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &pData);
  }
