/*
 * XREFs of ?_AddImmersiveBackground@CLivePreview@@AEAAJAEAV?$DynArray@UtagRECT@@$0A@@@@Z @ 0x1800747EC
 * Callers:
...
LABEL_11:
    if ( v11 )
      goto LABEL_25;
    v13 = CAccent::Create(*((struct IDwmChannel **)CDesktopManager::s_pDesktopManagerInstance + 5), &v27);
    v5 = v13;
    if ( v13 < 0 )
      break;
    v2 = v27;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x440u);
      goto LABEL_33;
    }
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x442u);
      v3 = v26;
      goto LABEL_33;
    }
    v3 = v26;
    ...
    if ( inserted < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0x448u);
      goto LABEL_33;
    }
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x44Au);
      goto LABEL_33;
    }
    v18 = v24;
    v19 = (_QWORD *)(a1 + 432);
    ...
    *(struct tagRECT *)&v30.m256i_u64[1] = v31;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21 < (unsigned int)v20 ? 0x80070216 : 0, 0xB5u);
    }
LABEL_25:
    v7 = *(_QWORD *)(a1 + 552);
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x43Cu);
  v2 = v27;
LABEL_33:
  if ( (v5 & 0x80000000) == 0 )
  {
