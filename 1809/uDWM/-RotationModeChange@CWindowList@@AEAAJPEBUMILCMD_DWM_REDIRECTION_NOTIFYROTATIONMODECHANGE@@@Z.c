/*
 * XREFs of ?RotationModeChange@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYROTATIONMODECHANGE@@@Z @ 0x18008C580
 * Callers:
    ...
    if ( v5
      || (v6 = CScreenRotation::Create(
                 *((struct IDwmChannel **)CDesktopManager::s_pDesktopManagerInstance + 5),
                 (struct CScreenRotation **)this + 62),
          v4 = v6,
          v6 >= 0) )
    {
      ...
      v8 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance + 5) + 24LL))(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5));
      v4 = v8;
      if ( v8 >= 0 )
      {
        ...
        v4 = v9;
        if ( v9 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x194Au);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x1948u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x193Fu);
    }
  }
