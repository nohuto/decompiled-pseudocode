/*
 * XREFs of ?StopActivity@CloneWindow@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x18002AC40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall WindowFrameLoggingTelemetry::CloneWindow::StopActivity(WindowFrameLoggingTelemetry::CloneWindow *this)
{
  ...
  if ( v4 )
  {
    if ( **(_DWORD **)(v6 + 8) > 5u )
    {
      ...
      v62 = 4;
      TlgCreateSz(&v64, v22);
      TlgWrite(v23, &unk_1800C2BE4, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &v31);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v7 > 5u )
    {
      ...
      v70 = 4;
      v69 = &v24;
      TlgWrite(v7, &unk_1800C2D0A, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &pData);
    }
  }
  if ( *((_DWORD *)this + 8) )
