/*
 * XREFs of ?ShouldAnimateShowWindow@CStoryboard@@SA_NPEBVCWindowData@@@Z @ 0x180006B90
 * Callers:
...
char __fastcall CStoryboard::ShouldAnimateShowWindow(const struct CWindowData *a1)
{
  ...
  v5 = v7;
  if ( v4 >= 0
    && (*((_DWORD *)a1 + 151) & 0x100000) != 0
    && (*((char *)a1 + 599) < 0 || CImmersiveState::IsLauncherShownAboveWindow(v7, a1)) )
  {
    v3 = 0;
  }
  if ( v5 )
