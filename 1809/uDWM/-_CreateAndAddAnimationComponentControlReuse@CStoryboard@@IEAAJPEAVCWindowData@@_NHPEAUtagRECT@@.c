/*
 * XREFs of ?_CreateAndAddAnimationComponentControlReuse@CStoryboard@@IEAAJPEAVCWindowData@@_NHPEAUtagRECT@@2H1PEAPEAVCAnimationComponent@@@Z @ 0x180030484
 * Callers:
        ...
        struct CAnimationComponent **a9)
{
  ...
  int v16; // eax
  CBaseObject *v18; // [rsp+78h] [rbp+10h] BYREF
  ...
  if ( ((*(__int64 (__fastcall **)(CStoryboard *, _QWORD))(*(_QWORD *)this + 120LL))(
          this,
          *((_DWORD *)a2 + 151) & 0xFFF) & 4) != 0 )
    *((_DWORD *)a2 + 151) |= 0x4000000u;
  v13 = CTransitionVisualController::CreateAnimationComponent(
          ...
          *((_DWORD *)a2 + 151),
          ...
          this,
          a5,
          (struct CTransitionWindowSnapshot *)a6,
          a7,
          a8,
          &v18);
  v14 = v13;
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v13, 0x1505u);
LABEL_8:
  ...
  if ( v16 >= 0 )
  {
    *a9 = (struct CAnimationComponent *)v15;
    if ( !v15 )
      return v14;
    _InterlockedIncrement(v15 + 2);
    goto LABEL_8;
  }
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v16, 0x1506u);
LABEL_9:
  if ( v15 )
