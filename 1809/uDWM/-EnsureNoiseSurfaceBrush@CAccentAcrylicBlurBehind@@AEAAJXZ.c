/*
 * XREFs of ?EnsureNoiseSurfaceBrush@CAccentAcrylicBlurBehind@@AEAAJXZ @ 0x180044C94
 * Callers:
...
__int64 __fastcall CAccentAcrylicBlurBehind::EnsureNoiseSurfaceBrush(CAccentAcrylicBlurBehind *this)
{
  ...
  if ( !*((_QWORD *)this + 40) )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x79Cu);
      Microsoft::WRL::ComPtr<IWICBitmapDecoder>::InternalRelease(&v44);
    ...
    else
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x79Du);
      }
      else
      {
        v45 = 0LL;
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x7A0u);
        }
        else
        {
          v13 = v45;
          ...
          if ( v14 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x7A3u);
          }
          else
          {
            v46 = 0LL;
            ...
            if ( v15 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x7A6u);
            }
            else
            {
              ...
              if ( v16 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x7A7u);
              }
              else
              {
                v48 = 0LL;
                ...
                if ( v17 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x7AAu);
                }
                else
                {
                  v55 = 0;
                  ...
                  if ( v18 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x7AFu);
                  }
                  else
                  {
                    v19 = (char *)this + 288;
                    ...
                    if ( v20 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x7B3u);
                    }
                    else
                    {
                      ...
                      if ( v21 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x7B5u);
                      }
                      else
                      {
                        v64 = v55;
                        ...
                        if ( v22 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x7B7u);
                        }
                        else
                        {
                          v52 = 0LL;
                          ...
                          if ( v23 < 0 )
                          {
                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x7BAu);
                          }
                          else
                          {
                            v24 = v52;
                            ...
                            if ( v27 < 0 )
                            {
                              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x7BDu);
                            }
                            else
                            {
                              v28 = v51;
                              ...
                              if ( v31 < 0 )
                              {
                                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v31, 0x7C3u);
                              }
                              else
                              {
                                v54 = 0LL;
                                ...
                                if ( v32 < 0 )
                                {
                                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v32, 0x7C6u);
                                }
                                else
                                {
                                  v33 = v54;
                                  ...
                                  if ( v34 < 0 )
                                  {
                                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0x7CBu);
                                  }
                                  else
                                  {
                                    v57 = 0LL;
                                    ...
                                    if ( v35 < 0 )
                                    {
                                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v35, 0x7CFu);
                                    }
                                    else
                                    {
                                      v66 = 0;
                                      ...
                                      if ( v36 < 0 )
                                      {
                                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v36, 0x7E4u);
                                      }
                                      else
                                      {
                                        v59 = 0LL;
                                        ...
                                        if ( v37 < 0 )
                                        {
                                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v37, 0x7E7u);
                                        }
                                        else
                                        {
                                          v60 = 0LL;
                                          ...
                                          if ( v38 < 0 )
                                          {
                                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v38, 0x7EBu);
                                          }
                                          else
                                          {
                                            v39 = v59;
                                            ...
                                            if ( v40 < 0 )
                                            {
                                              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v40, 0x7EFu);
                                            }
                                            else
                                            {
                                              ...
                                              if ( v41 < 0 )
                                              {
                                                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v41, 0x7F0u);
                                              }
                                              else
                                              {
                                                v42 = Microsoft::WRL::ComPtr<Windows::UI::Composition::ICompositionBackdropBrush>::As<Windows::UI::Composition::ICompositionBrush>(
                                                        &v58,
                                                        v1);
                                                v3 = v42;
                                                if ( v42 < 0 )
                                                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v42, 0x7F3u);
                                              }
                                            }
                                            Microsoft::WRL::ComPtr<IWICBitmapDecoder>::InternalRelease(&v58);
                                          }
