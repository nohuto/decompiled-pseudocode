/*
 * XREFs of ?OnMagnifierSyncApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEAX_NKPEBU_REMOTE_PORT_VIEW@@PEAJPEAI@Z @ 0x18007EC5C
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  v9 = 0;
  v13 = -2147023728;
  if ( dword_1800D7E98 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800D7E98);
    if ( dword_1800D7E98 == -1 )
    {
      dword_1800D7DE4 = -2147023728;
      Init_thread_footer(&dword_1800D7E98);
    }
  }
  ...
  if ( a2 == 1073741925 && a4 )
  {
    ...
    *a8 = 44;
    ...
    if ( v14 < 0 )
    {
      if ( v14 != -2147023728 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D7DE4, 1LL, v14, 0x192u);
        goto LABEL_14;
      }
      v9 = 0;
    }
