/*
 * XREFs of ?OnAnimationComplete@CScreenRotation@@UEAAJI@Z @ 0x1800A1170
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( *((_BYTE *)this + 49) )
  {
    ...
    v4 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x13Au);
  }
  else
  {
    ...
    v4 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x13Eu);
  }
LABEL_22:
