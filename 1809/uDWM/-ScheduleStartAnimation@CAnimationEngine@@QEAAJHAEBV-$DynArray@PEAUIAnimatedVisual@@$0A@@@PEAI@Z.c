/*
 * XREFs of ?ScheduleStartAnimation@CAnimationEngine@@QEAAJHAEBV?$DynArray@PEAUIAnimatedVisual@@$0A@@@PEAI@Z @ 0x180030924
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( *(_DWORD *)(a3 + 24) )
  {
    ...
    if ( v11 )
    {
      ...
      v9 = started;
      if ( started < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, started, 0xA3u);
    }
    else
    {
      v9 = -2147024882;
