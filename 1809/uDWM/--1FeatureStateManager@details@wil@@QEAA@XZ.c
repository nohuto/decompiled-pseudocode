/*
 * XREFs of ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x18006F54C
 * Callers:
...
void __fastcall wil::details::FeatureStateManager::~FeatureStateManager(wil::details::FeatureStateManager *this)
{
  ...
  *(_BYTE *)this = 0;
  ...
  if ( v5 && *(&xmmword_1800D4ED0 + 1) )
    wil::details_abi::SubscriptionList::Unsubscribe(
      (LPCRITICAL_SECTION)*(&xmmword_1800D4ED0 + 1) + 5,
      (PSRWLOCK)*(&xmmword_1800D4ED0 + 1),
      v5);
  v6 = *((_QWORD *)this + 10);
