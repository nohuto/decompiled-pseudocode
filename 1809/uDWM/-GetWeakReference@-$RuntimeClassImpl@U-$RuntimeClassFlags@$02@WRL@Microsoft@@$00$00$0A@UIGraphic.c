/*
 * XREFs of ?GetWeakReference@?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIGraphicsEffect@Effects@Graphics@Windows@@UIGraphicsEffectSource@567@UIGraphicsEffectD2D1Interop@567@UIGaussianBlurEffect@5Composition@UI@3@@Details@WRL@Microsoft@@UEAAJPEAPEAUIWeakReference@@@Z @ 0x1800B4210
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InternalAddRef@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIWeakReference@@@Details@WRL@Microsoft@@IEAAKXZ @ 0x1800B431C (-InternalAddRef@-$RuntimeClassImpl@U-$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIWeakRefe.c)
 */
        ...
        struct WPF::HeapBase *a2)
{
  ...
  Microsoft::WRL::Details::WeakReferenceImpl *v10; // rdx
  unsigned __int64 v11; // r8
  bool i; // zf
  signed __int64 v13; // rax
  signed __int64 v14; // rbx
  Microsoft::WRL::Details::WeakReferenceImpl *v15; // [rsp+30h] [rbp+8h]
  ...
  if ( v8 )
  {
    ...
    if ( v9 )
    {
      *((_DWORD *)v9 + 4) = v4;
      ...
      Microsoft::WRL::Details::WeakReferenceImpl::`vector deleting destructor'(v15, 1);
