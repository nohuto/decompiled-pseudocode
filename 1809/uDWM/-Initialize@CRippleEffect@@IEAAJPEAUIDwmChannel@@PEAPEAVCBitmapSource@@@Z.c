/*
 * XREFs of ?Initialize@CRippleEffect@@IEAAJPEAUIDwmChannel@@PEAPEAVCBitmapSource@@@Z @ 0x180090068
 * Callers:
...
__int64 __fastcall CRippleEffect::Initialize(struct tagSIZE *this, struct IDwmChannel *a2, struct CBitmapSource **a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_OWORD *)&this[46].cx = v9;
    ...
    this[31].cx = (int)((double)v11.cx * *((double *)v8 + 60));
    this[31].cy = (int)(_mm_cvtepi32_pd(v12).m128d_f64[0] * *((double *)v8 + 60));
