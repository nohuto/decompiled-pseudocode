/*
 * XREFs of ?OnSetColorEffect@CMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x18007DE08
 * Callers:
...
__int64 __fastcall CMagnifier::OnSetColorEffect(CMagnifier *this, const struct MilColorTransform *a2)
{
  ...
  {
    v5 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 4) + 16LL) + 784LL))(
    ...
    *(_OWORD *)((char *)this + 92) = xmmword_1800C4840;
    *(_OWORD *)((char *)this + 108) = xmmword_1800C4850;
    *(_OWORD *)((char *)this + 124) = xmmword_1800C4860;
    *(_OWORD *)((char *)this + 140) = xmmword_1800C4870;
    *(_OWORD *)((char *)this + 156) = xmmword_1800C4880;
    v6 = 1065353216;
    goto LABEL_16;
  }
  if ( memcmp_0((char *)this + 76, a2, 0x64uLL) )
  {
    ...
    if ( v10 >= 0 )
    {
      v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 4) + 16LL) + 784LL))(
              *(_QWORD *)(*((_QWORD *)this + 4) + 16LL),
              *(unsigned int *)(*((_QWORD *)this + 4) + 24LL),
