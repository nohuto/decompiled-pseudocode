/*
 * XREFs of ?TriangulatePathGeometry@CTouchDragVisualHelper@@SAJMPEBV?$DynArray@UTOUCH_DRAG_POINT@@$0A@@@PEBUtagRECT@@PEAV?$DynArray@UMilPoint3F@@$0A@@@PEAV?$DynArray@UMilPoint2D@@$0A@@@PEAV?$DynArray@I$0A@@@PEAV?$DynArray@K$0A@@@@Z @ 0x180097520
 * Callers:
    ...
    if ( !v100 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v94 >= (unsigned int)v91 )
        {
          if ( v92 > *(_DWORD *)(a6 + 20) )
          {
            v95 = DynArrayImpl<0>::AddMultipleAndSet(a6, 4u, 1, v93);
            v9 = v95;
            if ( v95 < 0 )
...
LABEL_87:
  ...
  if ( v79 >= (unsigned int)v78 )
  {
    ...
    {
      v80 = DynArrayImpl<0>::AddMultipleAndSet(v106, 4u, 1, &v104);
      v9 = v80;
      if ( v80 < 0 )
...
LABEL_89:
  DynArrayImpl<0>::~DynArrayImpl<0>(&v121);
