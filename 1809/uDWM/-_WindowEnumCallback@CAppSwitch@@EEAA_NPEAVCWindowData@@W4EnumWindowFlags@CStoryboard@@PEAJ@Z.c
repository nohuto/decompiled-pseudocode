/*
 * XREFs of ?_WindowEnumCallback@CAppSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800A8570
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _lambda_81f2de84cd03038fe2b12ca1386d224e_::operator() @ 0x1800A2DA4 (_lambda_81f2de84cd03038fe2b12ca1386d224e_--operator().c)
 *     ?GetPVLTarget@CAppSwitch@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800A3580 (-GetPVLTarget@CAppSwitch@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
char __fastcall CAppSwitch::_WindowEnumCallback(__int64 a1, struct tagRECT *a2, char a3, int *a4)
{
  LONG bottom; // eax
  ...
  if ( (bottom & 0x1000000) == 0 || (v11 = 1, IsRectEmpty(a2 + 38)) )
    v11 = 0;
  CTransitionVisualController::GetMonitorRectFromRectImpl(a2 + 3, &v38);
  v12 = a2 + 39;
  if ( !v11 )
    v12 = &v38;
  v40 = *v12;
  ...
  switch ( v8 )
  {
    case 2u:
      if ( a2[7].left == 1 )
        a2[37].bottom |= 0x4000000u;
      PVLTarget = CAppSwitch::GetPVLTarget(a1, a2[37].bottom);
      v25 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(
              (CStoryboard *)a1,
              (struct CWindowData *)a2,
              0,
              PVLTarget,
              (struct tagRECT *)((unsigned __int64)&a2[38] & -(__int64)(v11 != 0)),
              0LL,
              0x11u,
              1,
              &v34);
      ...
      if ( v25 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v25, 0x9DCu);
        goto LABEL_77;
      }
      if ( *((_DWORD *)v34 + 17) != 2 )
        *((_DWORD *)v34 + 17) = 1;
    ...
    case 3u:
      ...
      if ( *(_BYTE *)(a1 + 168) )
        ...
        v20 = CAppSwitch::GetPVLTarget(a1, a2[37].bottom);
      if ( v11 )
      {
        ...
        if ( v21 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v21, 0x99Au);
          goto LABEL_77;
        }
      }
      else
      {
        ...
        if ( v22 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v22, 0x99Eu);
          goto LABEL_77;
        }
      }
      v23 = v34;
    ...
    case 0x16u:
      if ( !CWindowData::IsWindowVisibleAndUncloaked((CWindowData *)a2)
        || !ContainsRect((const struct tagRECT *)(a1 + 152), a2 + 3) )
      {
        goto LABEL_85;
      }
      if ( *(_BYTE *)(a1 + 168) )
        ...
        v18 = CAppSwitch::GetPVLTarget(a1, a2[37].bottom);
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v19, 0x9B3u);
        goto LABEL_77;
      }
      if ( *((_DWORD *)v34 + 17) != 2 )
        *((_DWORD *)v34 + 17) = 1;
    ...
    case 0x1Cu:
      if ( *(_BYTE *)(a1 + 168) )
        ...
        v15 = CAppSwitch::GetPVLTarget(a1, a2[37].bottom);
      if ( v11 )
      {
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v16, 0x9C4u);
          goto LABEL_77;
        }
      }
      else
      {
        ...
        if ( v17 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v17, 0x9C8u);
          goto LABEL_77;
        }
      }
      if ( *((_DWORD *)v34 + 17) != 2 )
...
LABEL_78:
      ...
      goto LABEL_83;
    case 0x2Bu:
      v13 = CAppSwitch::GetPVLTarget(a1, a2[37].bottom);
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v14, 0x9E5u);
        goto LABEL_77;
      }
      goto LABEL_61;
  }
