/*
 * XREFs of ?_IsEligibleForLivePreview@CLivePreview@@AEAA_NPEBVCWindowData@@@Z @ 0x180075F0C
 * Callers:
 ...
 *     ?GetLivePreviewWindowRect@CTopLevelWindow@@QEBA?AUtagRECT@@_N@Z @ 0x180087504 (-GetLivePreviewWindowRect@CTopLevelWindow@@QEBA-AUtagRECT@@_N@Z.c)
 */
    ...
    if ( a2[49] )
    {
        ...
        && (*(_DWORD *)(v4 + 100) & 0x20000000) == 0 )
      {
        if ( *(_QWORD *)(v4 + 40) )
        {
          ...
          {
            CTopLevelWindow::GetLivePreviewWindowRect(a2[49], &rcSrc1, 1);
