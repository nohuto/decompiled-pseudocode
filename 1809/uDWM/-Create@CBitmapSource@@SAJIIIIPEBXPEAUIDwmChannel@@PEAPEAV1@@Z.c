/*
 * XREFs of ?Create@CBitmapSource@@SAJIIIIPEBXPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x180077BDC
 * Callers:
        ...
        struct CBitmapSource **a7)
{
  ...
  v15 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, GUID *, int, unsigned int, const void *, struct IWICBitmap **))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance + 39) + 160LL))(
  ...
  if ( v15 >= 0 )
  {
    ...
    if ( a3 != a1 || a4 != a2 )
    {
      v20 = 0LL;
      v7 = v17;
      v15 = (*(__int64 (__fastcall **)(_QWORD, __int64 *))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance + 39)
                                                         + 88LL))(
              *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 39),
              &v21);
      v14 = v15;
