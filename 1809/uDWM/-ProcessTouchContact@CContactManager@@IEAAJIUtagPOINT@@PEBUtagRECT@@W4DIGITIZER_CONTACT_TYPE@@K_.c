/*
 * XREFs of ?ProcessTouchContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x1800943F0
 * Callers:
 ...
 *     ?CheckShowContact@CContactManager@@AEAA_NW4DWM_SHOWCONTACT@@0@Z @ 0x180091A40 (-CheckShowContact@CContactManager@@AEAA_NW4DWM_SHOWCONTACT@@0@Z.c)
 ...
 *     ?IsOKToCleanup@CPressTapVisual@@UEAA_NXZ @ 0x1800922F0 (-IsOKToCleanup@CPressTapVisual@@UEAA_NXZ.c)
 ...
 *     ?IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ @ 0x180095588 (-IsInInitialDelay@CDirectTouchVisual@@QEBA_NXZ.c)
 ...
 *     ?UpdateShowContact@CTouchDragVisual@@QEAAXW4DWM_SHOWCONTACT@@@Z @ 0x180098C48 (-UpdateShowContact@CTouchDragVisual@@QEAAXW4DWM_SHOWCONTACT@@@Z.c)
 ...
 *     ?IsHolding@CTouchPressHoldVisual@@QEAA_NXZ @ 0x1800ACA60 (-IsHolding@CTouchPressHoldVisual@@QEAA_NXZ.c)
 *     ?IsOKToCleanup@CTouchPressHoldVisual@@UEAA_NXZ @ 0x1800ACA90 (-IsOKToCleanup@CTouchPressHoldVisual@@UEAA_NXZ.c)
 */
  ...
  if ( (int)v8 < 0 )
  {
    ...
    if ( a6 < 0 )
    {
      if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) == 0 )
        goto LABEL_192;
      v102 = &UdwmIndirectTouchVisual_Received_Info;
    }
    else
    {
      if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) == 0 )
        goto LABEL_192;
      v102 = &UdwmDirectTouchDownAnimation_Start;
    }
    McTemplateU0d(a1, (int)v102, a2);
LABEL_192:
    ...
    *(_OWORD *)v122 = 0LL;
    ...
    if ( a6 < 0 )
    {
      ...
      *((_DWORD *)v122[1] + 104) = a2;
      CContactManager::AddToTouchNode(v105, a7, v122[1]);
      if ( v15 == 1 )
    ...
    else
    {
      ...
      CContactManager::AddToTouchNode(v104, a7, v122[0]);
        ...
        *(_DWORD *)(v17 + v16 + 4) = 0;
        ...
        if ( v19 )
        {
          ...
          if ( v21 + 1 >= v21 )
          {
            ...
            {
              v25 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v108 + 152, 8u, 1, &v112);
              v23 = v25;
              if ( v25 < 0 )
        ...
        if ( *(_QWORD *)(v17 + v16 + 80) )
        {
          ...
          if ( v28 + 1 >= v28 )
          {
            ...
            {
              v32 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v20 + 152, 8u, 1, &v108);
              v30 = v32;
              if ( v32 < 0 )
  ...
  if ( v15 != 2 )
  {
    ...
    else if ( *(_QWORD *)(v17 + v16 + 56) )
    {
      ...
      if ( v61 + 1 >= v61 )
      {
        ...
        {
          v65 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v108 + 152, 8u, 1, &v113);
          v63 = v65;
          if ( v65 < 0 )
...
LABEL_143:
      if ( *(_QWORD *)(v17 + v16 + 72) )
      {
        ...
        if ( v81 + 1 >= v81 )
        {
          ...
          {
            v85 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v51 + 152, 8u, 1, &v115);
            v83 = v85;
            if ( v85 < 0 )
      ...
      if ( *(_QWORD *)(v17 + v16 + 80) )
      {
        ...
        if ( v88 + 1 >= v88 )
        {
          ...
          {
            v92 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v51 + 152, 8u, 1, &v116);
            v90 = v92;
            if ( v92 < 0 )
      ...
      if ( v97 + 1 >= v97 )
      {
        ...
        {
          v100 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v51 + 152, 8u, 1, &v111);
          v99 = v100;
          if ( v100 >= 0 )
            goto LABEL_181;
    ...
    if ( CTouchPressHoldVisual::IsHolding(*(CTouchPressHoldVisual **)(v17 + v16 + 64)) )
    {
      ...
      *((_QWORD *)&v117 + 1) = v68;
      ...
      if ( (int)v71 + 1 >= (unsigned int)v71 )
      {
        ...
        {
          v74 = DynArrayImpl<0>::AddMultipleAndSet(v70, 0x10u, 1, &v117);
          v73 = v74;
          if ( v74 < 0 )
...
LABEL_138:
    ...
    if ( v75 + 1 >= v75 )
    {
      ...
      {
        v78 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v51 + 152, 8u, 1, &v114);
        v77 = v78;
        if ( v78 >= 0 )
        {
LABEL_137:
        ...
        if ( !v36 || !CDirectTouchVisual::IsInInitialDelay(v36) )
        {
          ...
          if ( !*(_QWORD *)(v17 + v16 + 88) )
          {
            ...
            if ( (int)v39 > (int)(*((double *)CDesktopManager::s_pDesktopManagerInstance + 60) * 225.0) )
            {
              if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
              {
                McTemplateU0d(v39, (int)&UdwmTouchDragVisual_Start, a2);
                v38 = CDesktopManager::s_pDesktopManagerInstance;
              }
              Touch = CreateTouchVisual<CTouchDragVisual>(
                        *((struct IDwmChannel **)v38 + 5),
                        a7,
