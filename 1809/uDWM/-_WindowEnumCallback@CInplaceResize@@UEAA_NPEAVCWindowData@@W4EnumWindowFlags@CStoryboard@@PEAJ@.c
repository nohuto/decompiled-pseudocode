/*
 * XREFs of ?_WindowEnumCallback@CInplaceResize@@UEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800A9250
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CInplaceResize@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800A3760 (-GetPVLTarget@CInplaceResize@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
char __fastcall CInplaceResize::_WindowEnumCallback(CStoryboard *a1, __int64 a2, char a3, int *a4)
{
  ...
  CBaseObject *v25; // [rsp+C8h] [rbp+48h] BYREF
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0x6F7u);
    goto LABEL_23;
  }
