/*
 * XREFs of ?s_CalculateWindowMetrics@CSecondaryWindowRepresentation@@CA_NPEBVCWindowData@@U?$TMILFlagsEnum@W4FlagsEnum@SWRUsage@@@@_NPEAUtagSIZE@@PEAU_MARGINS@@@Z @ 0x180023070
 * Callers:
...
LABEL_11:
    ...
    v14 = (struct tagRECT)xmmword_1800BE620;
    goto LABEL_11;
  }
  return 0;
}
