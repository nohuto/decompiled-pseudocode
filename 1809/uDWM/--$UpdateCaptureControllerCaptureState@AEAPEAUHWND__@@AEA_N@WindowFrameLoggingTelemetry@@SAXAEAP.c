/*
 * XREFs of ??$UpdateCaptureControllerCaptureState@AEAPEAUHWND__@@AEA_N@WindowFrameLoggingTelemetry@@SAXAEAPEAUHWND__@@AEA_N@Z @ 0x18007F0D0
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( *(_DWORD *)v5 > 5u && (*((_QWORD *)v5 + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v4 == *((_QWORD *)v5 + 3) )
    {
      ...
      v13 = a2;
      v14 = 1;
      LODWORD(v4) = TlgWrite(v5, &unk_1800C1FF0, 0LL, 0LL, 4u, &pData);
    }
  }
  return v4;
}
