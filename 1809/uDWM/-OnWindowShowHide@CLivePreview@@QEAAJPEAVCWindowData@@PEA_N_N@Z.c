/*
 * XREFs of ?OnWindowShowHide@CLivePreview@@QEAAJPEAVCWindowData@@PEA_N_N@Z @ 0x18001F520
 * Callers:
...
__int64 __fastcall CLivePreview::OnWindowShowHide(CLivePreview *this, struct CWindowData *a2, bool *a3, char a4)
{
  ...
  CVisual *v69; // [rsp+38h] [rbp-C8h] BYREF
  CTopLevelWindow *v70; // [rsp+40h] [rbp-C0h]
  bool *v71; // [rsp+48h] [rbp-B8h]
  struct CWindowData *v72; // [rsp+50h] [rbp-B0h] BYREF
  __int128 v73; // [rsp+58h] [rbp-A8h]
  bool v74; // [rsp+68h] [rbp-98h]
  HMONITOR v75; // [rsp+70h] [rbp-90h]
  ...
  if ( a4 || !CLivePreview::_IsEligibleForLivePreview(this, a2) )
  {
    ...
    if ( (int)v42 >= 0 )
    {
      ...
      if ( v49 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v49, 0x73Cu);
        return v5;
      }
      ...
      if ( v51 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v51, 0x73Fu);
        return v5;
      }
    }
LABEL_60:
    ...
    if ( (int)v45 >= 0 )
    {
      ...
      if ( v52 )
      {
        ...
        if ( v53 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v53, 0x74Bu);
          return v5;
        }
        v47 = *v46;
      ...
      if ( v54 )
      {
        ...
        if ( v55 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v55, 0x751u);
          return v5;
        }
      ...
      v57 = (CTopLevelWindow *)*((_QWORD *)a2 + 49);
      if ( v57 )
      ...
      if ( v58 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v58, 0x75Au);
        return v5;
      }
      v68 = 1;
    }
LABEL_88:
    ...
    if ( v59 >= 0 )
    {
      ...
      {
        v61 = *((_QWORD *)this + 50);
        v62 = *(struct CWindowData ***)(v60 + v61);
        if ( v62[90] == a2 )
        {
          v63 = *((_DWORD *)this + 106);
          if ( v59 < v63 )
  ...
  else
  {
    ...
    v70 = (CTopLevelWindow *)*((_QWORD *)a2 + 49);
    v12 = v70;
    IsTrulyMaximized = CLivePreview::_IsTrulyMaximized(v11, a2);
    v14 = CVisual::RenderRecursive(v70);
    v5 = v14;
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x77Cu);
      return v5;
    }
    ...
    if ( IsTrulyMaximized )
    {
      ...
      if ( v6 > 0 )
      {
        ...
        if ( v19 )
        {
          ...
          if ( v20 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x789u);
            return v5;
          }
          v17 = *((_QWORD *)this + 38);
        ...
        if ( v22 )
        {
          ...
          if ( v23 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x78Fu);
            return v5;
          }
          v17 = *((_QWORD *)this + 38);
        ...
        *(_BYTE *)(*(_QWORD *)(v17 + 8 * v18) + 598LL) |= 0x80u;
...
LABEL_30:
    v74 = IsTrulyMaximized;
    v72 = a2;
    v26 = (char *)this + 304;
    v75 = v15;
    v73 = 0LL;
    v27 = DynArray<LivePreviewVisual,0>::InsertAt((char *)this + 304, &v72);
    v5 = v27;
    if ( v27 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x79Cu);
      return v5;
    }
    v10 = 1;
    v30 = *((_BYTE *)a2 + 598);
    ...
    {
      v31 = v30 & 0xBF | (*((_QWORD *)a2 + 45) != 0LL ? 0x40 : 0);
      *((_BYTE *)a2 + 598) = v31;
      v32 = *((_DWORD *)this + 143);
      if ( v32 >= 0xA )
      {
      ...
      if ( (v33 & 0x40) == 0 || v33 >= 0 )
      {
        ...
        {
          v69 = 0LL;
          v34 = CTopLevelWindow::CloneVisualTreeForLivePreview(v12, 0, v28, v29, &v69);
          v5 = v34;
          if ( v34 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0x7B2u);
            return v5;
          }
          v35 = v69;
          v36 = CVisual::RenderRecursive(v69);
          v5 = v36;
          if ( v36 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v36, 0x7B3u);
            return v5;
          }
          ...
          if ( inserted < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x7B4u);
            return v5;
          }
        ...
        {
          v69 = 0LL;
          v38 = CTopLevelWindow::CloneVisualTreeForLivePreview(v70, 1, v28, v29, &v69);
          v5 = v38;
          if ( v38 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v38, 0x7BCu);
            return v5;
          }
          v39 = v69;
          v40 = CVisual::RenderRecursive(v69);
          v5 = v40;
          if ( v40 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v40, 0x7BDu);
            return v5;
          }
          ...
          if ( v41 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v41, 0x7BEu);
            return v5;
          }
...
LABEL_100:
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x7D2u);
      return v5;
    }
  }
LABEL_101:
