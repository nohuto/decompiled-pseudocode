/*
 * XREFs of ?UpdateOutputDuplication@CProjectionBorderManager@@UEAAJPEBU_D3DKMT_OUTPUTDUPL_LOWBOX_CONTEXTS_@@@Z @ 0x180081FF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_FindProjectionVisualByAdapter@CProjectionBorderManager@@AEAAHAEBU_LUID@@I@Z @ 0x180082BD0 (-_FindProjectionVisualByAdapter@CProjectionBorderManager@@AEAAHAEBU_LUID@@I@Z.c)
...
LABEL_29:
  ...
  if ( ProjectionVisualByAdapter == -1 )
  {
    ...
    v31 = v10[2];
    v32 = *((_DWORD *)a2 + 6 * v9 + 6);
    v33 = v26;
    v34 = 1;
    v30 = rc1;
    v14 = CProjectionBorderVisual::Create(v13, &v29);
    i = v14;
    if ( v14 < 0 )
    {
