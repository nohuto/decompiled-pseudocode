/*
 * XREFs of ?InsertAfterAtlasImage@CAtlasedRectsVisual@@QEAAJPEAVCAtlasedImage@@0@Z @ 0x180072C34
 * Callers:
        ...
        struct CAtlasedImage *a3)
{
  ...
  if ( a3 )
  {
    v5 = *((_DWORD *)this + 66);
    v6 = 0;
    for ( i = (struct CAtlasedImage **)*((_QWORD *)this + 30); v6 < v5; ++i )
    {
      if ( a3 == *i )
        break;
      ++v6;
  ...
  v8 = inserted;
  if ( inserted < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0x40u);
  return v8;
}
