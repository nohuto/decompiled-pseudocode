/*
 * XREFs of ?UpdateOpacityAndLocation@CTouchPressHoldVisual@@IEAAJXZ @ 0x1800AD05C
 * Callers:
...
__int64 __fastcall CTouchPressHoldVisual::UpdateOpacityAndLocation(CTouchPressHoldVisual *this)
{
  ...
  int v36; // eax
  int v37; // eax
  CBaseObject *v39; // [rsp+38h] [rbp-D0h] BYREF
  ...
  *((float *)&v41 + 3) = (float)v7 + (float)v8;
  if ( v3 <= 4 || v7 <= 4 )
  {
    v35 = CRectangleInstruction::Create(*((struct IDwmChannel **)CDesktopManager::s_pDesktopManagerInstance + 5), &v39);
    v14 = v35;
    if ( v35 < 0 )
    {
  ...
  else
  {
    ...
    *(float *)&v41 = v5;
    *((float *)&v41 + 1) = (float)v8;
    v12 = (struct IDwmChannel *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5);
    *((float *)&v41 + 3) = v9 + v11;
    *((float *)&v41 + 2) = v5 + 2.0;
    v40 = (float)(v9 + 2.0);
...
LABEL_39:
    ...
    *(_OWORD *)((char *)v15 + 24) = v41;
    ...
    v39 = 0LL;
    v18 = v5 + 2.0;
    v19 = (struct IDwmChannel *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5);
    ...
    *(_OWORD *)((char *)v15 + 24) = v41;
    ...
    CBaseObject::Release(v15);
    v39 = 0LL;
    v23 = (struct IDwmChannel *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5);
    *((float *)&v41 + 1) = v9;
    ...
    *(_OWORD *)((char *)v15 + 24) = v41;
    ...
    CBaseObject::Release(v15);
    v39 = 0LL;
    v27 = (struct IDwmChannel *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5);
    *(float *)&v41 = v5 + 2.0;
    ...
    *(_OWORD *)((char *)v15 + 24) = v41;
    ...
    CBaseObject::Release(v15);
    v39 = 0LL;
    v31 = (struct IDwmChannel *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5);
    *(float *)&v41 = v5 + 2.0;
    *((float *)&v41 + 1) = v40;
    *((float *)&v41 + 2) = (float)(v18 + v10) - 4.0;
