/*
 * XREFs of ?Create@CAnimatedGlassSheet@@SAJPEAUIDwmChannel@@PEAPEAV1@_N@Z @ 0x18008F08C
 * Callers:
...
__int64 __fastcall CAnimatedGlassSheet::Create(struct IDwmChannel *a1, struct CAnimatedGlassSheet **a2)
{
  ...
  v4 = (CAtlasedRectsVisual *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
                                WPF::g_pProcessHeap,
                                496LL);
  v5 = v4;
  if ( v4 )
