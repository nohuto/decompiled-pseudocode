/*
 * XREFs of ?OnModifyWindowFilterList@CMagnifier@@QEAAJPEBUMAGN_FILTERLIST@@@Z @ 0x18007DB08
 * Callers:
...
__int64 __fastcall CMagnifier::OnModifyWindowFilterList(CMagnifier *this, const struct MAGN_FILTERLIST *a2)
{
  ...
  if ( dword_1800D7E90 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800D7E90);
    if ( dword_1800D7E90 == -1 )
    {
      dword_1800D7DD4 = -2147023728;
      Init_thread_footer(&dword_1800D7E90);
    }
  }
  v6 = (char *)this + 56;
  if ( *((_QWORD *)this + 7)
    || (v7 = CResource::Create(0x27u, *((_QWORD *)this + 2), (CBaseObject **)this + 7), v8 = v7, v7 >= 0) )
  {
    ...
    {
      v23 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 4) + 16LL) + 800LL))(
              *(_QWORD *)(*((_QWORD *)this + 4) + 16LL),
              *(unsigned int *)(*((_QWORD *)this + 4) + 24LL),
              0LL);
      v8 = v23;
      if ( v23 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D7DD4, 1LL, v23, 0xFEu);
    }
    else
    {
      v9 = 0;
      ...
      if ( (unsigned int)v11 < v5 )
      {
        ...
        while ( (unsigned int)v11 < 0x19 )
        {
          ...
          {
            v17 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance + 7) + 8LL))(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 7));
            if ( !v17 )
            {
              v8 = -2147023728;
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D7DD4, 1LL, -2147023728, 0x133u);
              return v8;
            }
      ...
      if ( v21 >= 0 )
      {
        v22 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 4) + 16LL) + 800LL))(
                *(_QWORD *)(*((_QWORD *)this + 4) + 16LL),
                *(unsigned int *)(*((_QWORD *)this + 4) + 24LL),
                *(unsigned int *)(*(_QWORD *)v6 + 24LL));
        v8 = v22;
        if ( v22 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D7DD4, 1LL, v22, 0x14Fu);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D7DD4, 1LL, v21, 0x14Bu);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D7DD4, 1LL, v7, 0xF6u);
  }
  return v8;
}
