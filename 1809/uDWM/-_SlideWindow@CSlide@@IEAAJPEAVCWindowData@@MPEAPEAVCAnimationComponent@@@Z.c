/*
 * XREFs of ?_SlideWindow@CSlide@@IEAAJPEAVCWindowData@@MPEAPEAVCAnimationComponent@@@Z @ 0x1800A6838
 * Callers:
        ...
        struct CAnimationComponent **a4)
{
  ...
  int v15; // eax
  __int64 v16; // rcx
  CBaseObject *v18; // [rsp+58h] [rbp-39h] BYREF
  ...
  v4 = *(_QWORD *)this;
  v6 = *((unsigned int *)a2 + 151);
  v18 = 0LL;
  v9 = (*(__int64 (__fastcall **)(CSlide *, __int64))(v4 + 112))(this, v6);
  v10 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v9, 0LL, 0LL, 0xFFFFFFFF, 1, &v18);
  v11 = v18;
  v12 = v10;
  if ( v10 >= 0 )
  {
    ...
    v23 = rc;
    v14 = (CWindowPropertyTracker *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 30) + 48LL);
    v21 = rc;
    ...
    v15 = *((_DWORD *)a2 + 151);
    if ( (v15 & 0x1000000) != 0 )
      rc = (struct tagRECT)*((_OWORD *)a2 + 39);
    if ( (v15 & 0x800000) != 0 )
      v23 = (struct tagRECT)*((_OWORD *)a2 + 41);
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0xDEu);
  }
  if ( v12 < 0 && v11 )
