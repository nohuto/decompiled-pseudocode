/*
 * XREFs of ?GetStride@CCompoundBitmapLock@@UEAAJPEAI@Z @ 0x18004BBF0
 * Callers:
 *     ?GetStride@CCompoundBitmapLock@@W7EAAJPEAI@Z @ 0x18004E590 (-GetStride@CCompoundBitmapLock@@W7EAAJPEAI@Z.c)
 * Callees:
 *     <none>
 */
