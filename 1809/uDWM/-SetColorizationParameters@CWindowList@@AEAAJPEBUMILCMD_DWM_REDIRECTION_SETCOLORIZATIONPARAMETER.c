/*
 * XREFs of ?SetColorizationParameters@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS@@@Z @ 0x18000CD6C
 * Callers:
 ...
 *     ?ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z @ 0x18000B968 (-ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z.c)
        ...
        const struct MILCMD_DWM_REDIRECTION_SETCOLORIZATIONPARAMETERS *a2)
{
  ...
  else
  {
    v5 = *((_DWORD *)a2 + 1);
    v6 = 0;
    v7 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 139) == 2;
    v8 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 548);
    v20 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 532);
    LODWORD(v20) = v5;
    ...
    while ( 1 )
    {
      ...
      if ( !v13 )
        break;
      v15 = (CWindowData *)(v13 + 10);
      for ( i = (CWindowData *)v13[10]; i != v15; i = *(CWindowData **)i )
      {
