/*
 * XREFs of ?OnRepresentationTypeUpdated@CImmersiveWindowIconic@@QEAAJH@Z @ 0x18007D2EC
 * Callers:
...
__int64 __fastcall CImmersiveWindowIconic::OnRepresentationTypeUpdated(CImmersiveWindowIconic *this, int a2)
{
  ...
  v3 = CImmersiveIconicBitmapRegistry::RegisterIconicRepresentation(
         ...
         *((_BYTE *)this + 320),
         (enum IconicRepresentationType *)&v8,
         0LL);
  if ( v3 < 0 )
  {
    v5 = 227LL;
LABEL_3:
  ...
  LOBYTE(v4) = 1;
  v3 = CImmersiveWindowIconic::SetRepresentationType(this, v8, v4);
  if ( v3 < 0 )
  {
    v5 = 228LL;
    goto LABEL_3;
