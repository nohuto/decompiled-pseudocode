/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_3_1_dll @ 0x18004C725
 * Callers:
 *     __imp_load_GetSystemMetricsForDpi @ 0x18004C719 (__imp_load_GetSystemMetricsForDpi.c)
 * Callees:
