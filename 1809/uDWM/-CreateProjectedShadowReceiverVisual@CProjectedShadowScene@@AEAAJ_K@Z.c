/*
 * XREFs of ?CreateProjectedShadowReceiverVisual@CProjectedShadowScene@@AEAAJ_K@Z @ 0x1800B0508
 * Callers:
      ...
      if ( inserted >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          ...
          if ( inserted >= 0 )
          {
            ...
            if ( inserted >= 0 )
            {
              inserted = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, unsigned int *))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance
                                                                                               + 5)
                                                                                            + 120LL))(
              ...
              if ( inserted >= 0 )
              {
                inserted = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance
                                                                + 5)
