/*
 * XREFs of ?_EnsureRecordExists@CWindowPropertyTracker@@AEAAJPEBVCStoryboard@@PEBVCWindowData@@PEAH@Z @ 0x180036620
 * Callers:
        ...
        int *a4)
{
  ...
  if ( Record >= 0 )
  {
    ...
    if ( v27 + 1 >= v27 )
    {
      ...
      {
        v29 = DynArrayImpl<0>::AddMultipleAndSet(v26 + 8, 8u, 1, &v31);
        if ( v29 < 0 )
  ...
  if ( v12 )
  {
    *(_QWORD *)v12 = *((_QWORD *)a3 + 5);
    ...
    {
      v16 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v32 + 8, 8u, 1, &v31);
      if ( v16 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0xC0u);
    }
    *((_BYTE *)v32 + 44) = *((_BYTE *)a3 + 599) >> 7;
    ...
    *(_QWORD *)((char *)v19 + 148) = *(_QWORD *)((char *)v19 + 92);
    ...
    {
      v23 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this, 8u, 1, &v32);
      v8 = v23;
      if ( v23 < 0 )
