/*
 * XREFs of ?UpdateLayout@UdwmBottomVisual@@UEAAJ_N@Z @ 0x1800AF9A0
 * Callers:
 *     <none>
 * Callees:
 *     ?DoCanvasLayout@CVisual@@SA_NAEBUtagSIZE@@AEBU_MARGINS@@0PEAUtagPOINT@@PEAU2@@Z @ 0x18000B788 (-DoCanvasLayout@CVisual@@SA_NAEBUtagSIZE@@AEBU_MARGINS@@0PEAUtagPOINT@@PEAU2@@Z.c)
