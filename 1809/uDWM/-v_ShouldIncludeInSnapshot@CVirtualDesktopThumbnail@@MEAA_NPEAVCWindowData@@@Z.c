/*
 * XREFs of ?v_ShouldIncludeInSnapshot@CVirtualDesktopThumbnail@@MEAA_NPEAVCWindowData@@@Z @ 0x1800AC250
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CWindowData *a2)
{
  ...
  if ( (unsigned int)DynArray<HMONITOR__ *,0>::Find(*((_QWORD *)this + 35) + 136LL, &v11)
    || !(unsigned int)DynArray<HMONITOR__ *,0>::Find(v10 + 168, &v11) && *((char *)a2 + 599) >= 0 )
  {
    return 1;
  }
  return v5;
