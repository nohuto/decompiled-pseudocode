/*
 * XREFs of ?CreateNCButtons@CTopLevelWindow@@CAJQEAXPEAUWindowFrame@1@1@Z @ 0x180046E8C
 * Callers:
        ...
        struct CTopLevelWindow::WindowFrame *a3)
{
  __int64 *v3; // rsi
  unsigned int v4; // ebx
  struct CTopLevelWindow::WindowFrame *v6; // r9
  int v7; // eax
  int v8; // eax
  int v9; // eax
  int v10; // eax
  ...
  while ( 1 )
  {
    ...
    if ( ThemeMargins < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ThemeMargins, 0x405u);
      return v4;
    }
    if ( *(_DWORD *)(v20 + 24) )
    {
      do
      {
        v24 = *(MARGINS **)(*(_QWORD *)v20 + 8 * v23);
        v23 = (unsigned int)(v23 + 1);
        v24[4] = pMargins;
      }
      while ( (unsigned int)v23 < *(_DWORD *)(v20 + 24) );
    }
LABEL_31:
    ++v19;
    v3 += 2;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x404u);
  return v4;
}
