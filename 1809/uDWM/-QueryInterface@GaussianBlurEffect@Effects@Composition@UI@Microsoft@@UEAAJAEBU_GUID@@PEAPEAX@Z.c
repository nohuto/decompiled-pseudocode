/*
 * XREFs of ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18003BCC0
 * Callers:
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004E760 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004E770 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBA@EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004E780 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WBI@EAAJAEBU_GUID@@PEAPEAX@.c)
 *     ?QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004E790 (-QueryInterface@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@WCA@EAAJAEBU_GUID@@PEAPEAX@.c)
 * Callees:
