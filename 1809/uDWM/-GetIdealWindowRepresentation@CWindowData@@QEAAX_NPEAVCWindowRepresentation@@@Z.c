/*
 * XREFs of ?GetIdealWindowRepresentation@CWindowData@@QEAAX_NPEAVCWindowRepresentation@@@Z @ 0x180023664
 * Callers:
    ...
    *((_DWORD *)a3 + 2) = IdealWindowRepresentationType;
      ...
      && !CWindowData::IsImmersiveWindow(this) )
    {
      ...
      if ( *((_DWORD *)this + 144) )
      {
        while ( 1 )
        {
          v10 = *(CWindowData **)(*((_QWORD *)this + 69) + 8 * v9);
