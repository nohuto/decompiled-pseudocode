/*
 * XREFs of ?FeatureLoggingHook@details@wil@@YAXIPEBUFEATURE_LOGGED_TRAITS@@PEBUFEATURE_ERROR@@HPEBW4wil_ReportingKind@@PEBW4wil_VariantReportingKind@@E_K@Z @ 0x18003AA90
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a5 )
    {
        ...
        && (*(_QWORD *)(v13 + 24) & 2LL) == *(_QWORD *)(v13 + 24) )
      {
        ...
        *(_QWORD *)&pDesc.Size = 4LL;
        v50 = 8LL;
        TlgWrite((TraceLoggingHProvider)v13, &unk_1800C1D64, 0LL, 0LL, 9u, &pData);
      }
      if ( *((_BYTE *)a2 + 4) == 1 )
      {
        if ( v9 )
        {
            ...
            && (*(_QWORD *)(v17 + 24) & 0xALL) == *(_QWORD *)(v17 + 24) )
          {
            ...
            *(_QWORD *)&pDesc.Size = 4LL;
            v50 = 8LL;
            TlgWrite((TraceLoggingHProvider)v17, &unk_1800C1CEC, 0LL, 0LL, 9u, &pData);
          }
        }
      }
    }
      ...
      if ( a6 )
      {
          ...
          && (*(_QWORD *)(v19 + 24) & 4LL) == *(_QWORD *)(v19 + 24) )
        {
          ...
          *(_QWORD *)&pDesc.Size = 4LL;
          v50 = 1LL;
          *(_QWORD *)&v51.Size = 8LL;
          TlgWrite((TraceLoggingHProvider)v19, &unk_1800C1C64, 0LL, 0LL, 0xAu, &pData);
        }
      }
      else if ( a3 )
      {
          ...
          && (*(_QWORD *)(v23 + 24) & 1LL) == *(_QWORD *)(v23 + 24) )
        {
          ...
          v64 = 4LL;
          v63 = (char *)a3 + 80;
          TlgWrite(v31, &unk_1800C1B44, 0LL, 0LL, 0x14u, &pData);
        }
      }
    }
  }
