/*
 * XREFs of ?GetLegacyPhoneScaleFactor@@YA?AW4DEVICE_SCALE_FACTOR@@UtagSIZE@@0@Z @ 0x1800B3C48
 * Callers:
 ...
 *     ?CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z @ 0x1800B3ADC (-CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z.c)
 */
