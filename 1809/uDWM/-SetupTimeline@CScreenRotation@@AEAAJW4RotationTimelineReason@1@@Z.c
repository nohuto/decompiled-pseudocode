/*
 * XREFs of ?SetupTimeline@CScreenRotation@@AEAAJW4RotationTimelineReason@1@@Z @ 0x1800A1554
 * Callers:
...
__int64 __fastcall CScreenRotation::SetupTimeline(__int64 a1, int a2)
{
  ...
  v15 = (struct _GUID)xmmword_1800BF168;
  ...
  *(_QWORD *)(a1 + 296) = v6;
  ...
  {
    v7 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0xFDu);
    return v7;
  }
  *(_DWORD *)(a1 + 304) = a2;
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x101u);
    return v7;
  }
  v10 = *(_BYTE *)(a1 + 380);
  *(_BYTE *)(a1 + 288) = 1;
