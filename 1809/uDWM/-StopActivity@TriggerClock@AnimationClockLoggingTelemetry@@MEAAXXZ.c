/*
 * XREFs of ?StopActivity@TriggerClock@AnimationClockLoggingTelemetry@@MEAAXXZ @ 0x18003A150
 * Callers:
 *     <none>
 * Callees:
        ...
        AnimationClockLoggingTelemetry::TriggerClock *this)
{
  ...
  if ( v4 )
  {
    if ( *(_DWORD *)v6[1] > 4u )
    {
      ...
      v62 = 4;
      TlgCreateSz(&v64, v22);
      TlgWrite(v23, &unk_1800C37B6, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &v31);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v7 > 4u )
    {
      ...
      v70 = 4;
      v69 = &v24;
      TlgWrite(v7, &unk_1800C38DD, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &pData);
    }
  }
  if ( *((_DWORD *)this + 8) )
