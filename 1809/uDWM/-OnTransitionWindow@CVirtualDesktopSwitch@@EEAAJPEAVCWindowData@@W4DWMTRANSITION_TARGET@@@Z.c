/*
 * XREFs of ?OnTransitionWindow@CVirtualDesktopSwitch@@EEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@@Z @ 0x1800A4A40
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( *(_DWORD *)(a1 + 176) )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v11 >= (unsigned int)v10 )
          {
            if ( v9 > *(_DWORD *)(a1 + 140) )
            {
              v12 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 120, 8u, 1, &v18);
              v3 = v12;
              if ( v12 < 0 )
...
LABEL_26:
  ...
  if ( v3 >= 0 )
    v3 = -2003304445;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v3, 0x1264u);
LABEL_28:
  if ( v18 )
