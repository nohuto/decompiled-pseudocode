/*
 * XREFs of ?AcceptBitmap@CIconicBitmapRegistry@@AEAAXPEAVCWindowData@@PEAVCBitmapSource@@@Z @ 0x18007B338
 * Callers:
        ...
        struct CBitmapSource *a3)
{
  ...
  *((_BYTE *)a2 + 598) &= ~8u;
  ...
  if ( v7 )
  {
    CWindowIconic::SetBitmap(v7, *((struct CBitmapSource **)v8 + 48), (*((_BYTE *)v8 + 598) & 2) != 0, 1);
    if ( !v3 )
