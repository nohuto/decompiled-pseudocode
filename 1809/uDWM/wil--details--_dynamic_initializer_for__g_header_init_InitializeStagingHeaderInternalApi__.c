...
unsigned int (__fastcall *wil::details::_dynamic_initializer_for__g_header_init_InitializeStagingHeaderInternalApi__())(wil::details *__hidden this, unsigned int, enum FEATURE_CHANGE_TIME, unsigned int *, int *)
{
  unsigned int (__fastcall *result)(wil::details *__hidden, unsigned int, enum FEATURE_CHANGE_TIME, unsigned int *, int *); // rax
  ...
  g_wil_details_internalGetFeatureVariant = (unsigned int (*)(unsigned int, enum FEATURE_CHANGE_TIME, unsigned int *, int *))wil::details::WilApiImpl_GetFeatureVariant;
  return result;
}
