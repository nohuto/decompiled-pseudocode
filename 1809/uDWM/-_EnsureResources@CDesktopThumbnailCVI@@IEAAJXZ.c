/*
 * XREFs of ?_EnsureResources@CDesktopThumbnailCVI@@IEAAJXZ @ 0x1800ABD18
 * Callers:
...
__int64 __fastcall CDesktopThumbnailCVI::_EnsureResources(CDesktopThumbnailCVI *this)
{
  ...
  *(double *)&v21[1] = (double)v7;
  ...
  v1 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *, _QWORD *, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)v11 + 2) + 1000LL))(
         *((_QWORD *)v11 + 2),
         *((unsigned int *)v11 + 6),
         v20,
         v21,
