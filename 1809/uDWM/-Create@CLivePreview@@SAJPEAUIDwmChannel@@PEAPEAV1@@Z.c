/*
 * XREFs of ?Create@CLivePreview@@SAJPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x18003DB70
 * Callers:
...
LABEL_13:
  ...
  v4 = (CLivePreview *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
                         WPF::g_pProcessHeap,
                         608LL);
  if ( v4 )
