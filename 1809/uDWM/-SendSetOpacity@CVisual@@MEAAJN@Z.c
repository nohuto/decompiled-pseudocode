/*
 * XREFs of ?SendSetOpacity@CVisual@@MEAAJN@Z @ 0x180036270
 * Callers:
...
__int64 __fastcall CVisual::SendSetOpacity(CVisual *this, double a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x376u);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x37Du);
    }
    else
    {
      v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 2) + 16LL) + 392LL))(
             *(_QWORD *)(*((_QWORD *)this + 2) + 16LL),
             *(unsigned int *)(*((_QWORD *)this + 2) + 24LL),
             v10);
      v6 = v8;
      if ( v8 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x382u);
    }
  }
  if ( v10 )
