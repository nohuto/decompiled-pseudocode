/*
 * XREFs of ?v_GetSourceRect@CDCompDesktopThumbnailCVI@@MEAAJPEAUtagRECT@@@Z @ 0x1800AC040
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDCompDesktopThumbnailCVI::v_GetSourceRect(HMONITOR *this, struct tagRECT *a2)
{
  ...
  else
  {
    ...
    v4 = LastError;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, LastError, 0x23Au);
  }
  return v4;
}
