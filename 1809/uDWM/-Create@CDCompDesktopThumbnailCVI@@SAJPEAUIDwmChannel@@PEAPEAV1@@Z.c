/*
 * XREFs of ?Create@CDCompDesktopThumbnailCVI@@SAJPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x180089304
 * Callers:
...
__int64 __fastcall CDCompDesktopThumbnailCVI::Create(struct IDwmChannel *a1, struct CDCompDesktopThumbnailCVI **a2)
{
  ...
  if ( a2 )
  {
    v5 = (_DWORD *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
                     WPF::g_pProcessHeap,
                     80LL);
    v6 = v5;
    if ( v5 )
