/*
 * XREFs of ?ReportFailure_GetLastError@details@wil@@YAKPEAXIPEBD110W4FailureType@2@@Z @ 0x180071418
 * Callers:
        ...
        int a7)
{
  ...
  if ( LastErrorFail > 0 )
    ...
    v12 = LastErrorFail;
  wil::details::ReportFailure((__int64)a1, v8, a3, 0LL, 0LL, (__int64)a6, a7, v12, 0LL, 0);
  return v11;
}
