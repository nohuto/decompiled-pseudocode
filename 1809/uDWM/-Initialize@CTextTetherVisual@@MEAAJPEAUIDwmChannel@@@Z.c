/*
 * XREFs of ?Initialize@CTextTetherVisual@@MEAAJPEAUIDwmChannel@@@Z @ 0x180096660
 * Callers:
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( BitmapFromAtlas >= 0 )
    {
      ...
      if ( v10 >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          CVisual::SetInterpolationMode((unsigned int *)*v9, 6u);
          v13 = CImage::SetBitmapSource(*v9, *v6);
          v5 = v13;
          if ( v13 >= 0 )
          {
            CVisual::SetSize(*v9, &v24);
            ...
            if ( v16 >= 0 )
            {
              ...
              if ( v18 >= 0 )
              {
                ...
                if ( v19 >= 0 )
                {
                  CVisual::SetInterpolationMode((unsigned int *)*v17, 6u);
                  v20 = *v14;
                  v21 = *v17;
                  v24 = (*v14)[3];
