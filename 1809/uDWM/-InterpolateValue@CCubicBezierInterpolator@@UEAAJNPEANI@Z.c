/*
 * XREFs of ?InterpolateValue@CCubicBezierInterpolator@@UEAAJNPEANI@Z @ 0x1800A06B0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z @ 0x1800A0400 (-GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z.c)
 */
