/*
 * XREFs of ?FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@PEAEPEAX_KI@Z @ 0x180001A50
 * Callers:
...
LABEL_12:
  if ( v8 )
    return v10;
  if ( wil::details_abi::UsageIndexProperty::AddToCount((wil::details_abi::UsageIndexProperty *)&v23, a6)
    || *((_BYTE *)this + 56) )
  {
    v6 = 1;
  }
