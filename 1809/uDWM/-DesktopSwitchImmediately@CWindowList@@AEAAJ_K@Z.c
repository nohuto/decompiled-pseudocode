/*
 * XREFs of ?DesktopSwitchImmediately@CWindowList@@AEAAJ_K@Z @ 0x18000B160
 * Callers:
...
LABEL_19:
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x18C1u);
    goto LABEL_12;
  }
  v10 = this[66];
  if ( v10 )
  ...
  v5 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance + 5) + 24LL))(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 5));
  v6 = v5;
  if ( v5 < 0 )
  {
    v13 = 6351;
