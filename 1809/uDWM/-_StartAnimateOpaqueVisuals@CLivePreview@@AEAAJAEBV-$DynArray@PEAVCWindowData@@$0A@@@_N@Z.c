/*
 * XREFs of ?_StartAnimateOpaqueVisuals@CLivePreview@@AEAAJAEBV?$DynArray@PEAVCWindowData@@$0A@@@_N@Z @ 0x1800767CC
 * Callers:
 ...
 *     ?_ContainsWindow@CLivePreview@@AEAA_NAEBV?$DynArray@PEAVCWindowData@@$0A@@@PEAUHWND__@@@Z @ 0x1800755DC (-_ContainsWindow@CLivePreview@@AEAA_NAEBV-$DynArray@PEAVCWindowData@@$0A@@@PEAUHWND__@@@Z.c)
      ...
      if ( !a3 || (this = (CLivePreview *)*((_QWORD *)v7 + 42), *(_DWORD *)((char *)this + v10 + 40)) )
      {
          ...
          || CLivePreview::_ContainsWindow((__int64)this, (__int64)&i, v14) )
        {
          if ( *(_DWORD *)(v10 + v12 + 40) == 1 )
          {
            ...
            if ( started < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, started, 0x200u);
              goto LABEL_24;
            }
        ...
        else if ( !*(_DWORD *)(v10 + v12 + 40) )
        {
          ...
          if ( v15 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x209u);
            goto LABEL_24;
          }
