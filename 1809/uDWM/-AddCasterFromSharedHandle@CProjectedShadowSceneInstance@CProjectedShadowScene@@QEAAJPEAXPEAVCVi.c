/*
 * XREFs of ?AddCasterFromSharedHandle@CProjectedShadowSceneInstance@CProjectedShadowScene@@QEAAJPEAXPEAVCVisual@@@Z @ 0x1800B00D4
 * Callers:
        ...
        struct CVisual *a3)
{
  ...
  if ( !RtlLookupElementGenericTable((PRTL_GENERIC_TABLE)((char *)this + 16), Buffer) )
  {
    ...
    v9 = (**(__int64 (__fastcall ***)(struct IDCompositionDesktopDevicePartner *, GUID *, __int64 *))v8)(
           v8,
           &GUID_b0055573_f481_4a01_b924_59a96e1c6b13,
           &v25);
    v10 = v9;
    if ( v9 < 0 )
    {
