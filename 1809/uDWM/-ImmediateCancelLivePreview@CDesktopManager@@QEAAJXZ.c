/*
 * XREFs of ?ImmediateCancelLivePreview@CDesktopManager@@QEAAJXZ @ 0x180005FE0
 * Callers:
  ...
  if ( v3 )
  {
    ...
    *(_DWORD *)(v3 + 32) = 1;
    ...
    else
    {
      ...
      v2 = LastError;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, LastError, 0xA7Eu);
    }
  }
  else
  {
    v2 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xA71u);
  }
