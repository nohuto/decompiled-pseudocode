/*
 * XREFs of ?_FadeWindow@CFade@@IEAAJPEAVCWindowData@@_N@Z @ 0x18004AAD4
 * Callers:
...
__int64 __fastcall CFade::_FadeWindow(CFade *this, struct CWindowData *a2, char a3)
{
  ...
  CBaseObject *v29; // [rsp+60h] [rbp-11h] BYREF
  ...
  if ( (*((_DWORD *)a2 + 151) & 0x100000) != 0 )
    IsWindowTrackedAndCloakChanged = *((char *)a2 + 599) >= 0
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v7, 0x1E7u);
    goto LABEL_20;
  }
...
LABEL_10:
  if ( (*((_DWORD *)a2 + 151) & 0x20000) != 0 )
  {
    ...
    v26 = (*(__int64 (__fastcall **)(CFade *, _QWORD))(*(_QWORD *)this + 112LL))(this, *((unsigned int *)a2 + 151));
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v27, 0x206u);
  }
  else
  {
...
LABEL_13:
      v16 = *((_DWORD *)a2 + 151);
      v17 = (struct tagRECT *)((char *)a2 + 624);
      if ( (v16 & 0x1000000) != 0 )
        v30 = *v17;
      v18 = (v16 & 0x800000) != 0;
      v19 = &v30;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v14, 0x20Au);
  }
  v15 = (struct tagPOINT **)v28;
LABEL_18:
  if ( v15 )
