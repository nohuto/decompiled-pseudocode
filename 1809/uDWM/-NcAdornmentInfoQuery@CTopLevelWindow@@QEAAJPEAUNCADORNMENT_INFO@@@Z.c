/*
 * XREFs of ?NcAdornmentInfoQuery@CTopLevelWindow@@QEAAJPEAUNCADORNMENT_INFO@@@Z @ 0x1800075F8
 * Callers:
 ...
 *     ?GetRootVisualNoAddRef@CTopLevelWindow@@QEAAPEAVCVisual@@_N@Z @ 0x180037218 (-GetRootVisualNoAddRef@CTopLevelWindow@@QEAAPEAVCVisual@@_N@Z.c)
...
LABEL_13:
  ...
  rcSrc2.left = *(_DWORD *)((char *)this + 2 * v12) + v11[12];
  rcSrc2.top = *(_DWORD *)((char *)this + 2 * v12 + 8) + v11[13];
  rcSrc2.right = v11[14] - *(_DWORD *)((char *)this + 2 * v12 + 4);
  rcSrc2.bottom = v11[15] - *(_DWORD *)((char *)this + 2 * v12 + 12);
