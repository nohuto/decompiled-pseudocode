/*
 * XREFs of ?CreateNullAnimationComponentWithWindow@CTransitionVisualController@@QEAAJPEAVCWindowData@@HPEAVCStoryboard@@_NPEAPEAVCAnimationComponent@@@Z @ 0x180005784
 * Callers:
        ...
        struct CAnimationComponent **a6)
{
  ...
  v11 = 4095;
  if ( a2 )
    v11 = *((_DWORD *)a2 + 151) & 0x400000 | 0xFFF;
        ...
        else
        {
          ...
          *((_DWORD *)v19 + 185) = a3;
          if ( a5 )
          {
            if ( a2 )
            {
              v20 = (struct CTopLevelWindow *)*((_QWORD *)a2 + 49);
              if ( v20 )
