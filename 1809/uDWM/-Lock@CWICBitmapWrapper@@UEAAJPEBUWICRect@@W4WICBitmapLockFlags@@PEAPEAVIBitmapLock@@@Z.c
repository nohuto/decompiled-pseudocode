/*
 * XREFs of ?Lock@CWICBitmapWrapper@@UEAAJPEBUWICRect@@W4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x180047A70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPixelFormatSize@@YAEW4DXGI_FORMAT@@@Z @ 0x180047F84 (-GetPixelFormatSize@@YAEW4DXGI_FORMAT@@@Z.c)
  ...
  *a4 = 0LL;
  ...
  else
  {
    ...
    if ( PixelFormatSize && (v20 = *((_DWORD *)this + 40), v20 <= 0x7FFFFFF8u / PixelFormatSize) )
    {
      ...
      v22 = v21 * (unsigned __int64)*((unsigned int *)this + 41);
      v23 = -1;
      if ( v22 <= 0xFFFFFFFF )
        v23 = v21 * *((_DWORD *)this + 41);
      v10 = v22 > 0xFFFFFFFF ? 0x80070216 : 0;
      if ( v22 <= 0xFFFFFFFF )
      {
        ...
        if ( v24 )
        {
          ...
          if ( v26 >= 0 )
          {
            ...
            v10 = v27;
            if ( v27 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0xDBu);
            else
              v25 = 0LL;
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0xD1u);
          }
          if ( v25 )
...
LABEL_10:
  ...
  CGuard<CMTALock>::~CGuard<CMTALock>((__int64 *)&v37);
  return v10;
}
