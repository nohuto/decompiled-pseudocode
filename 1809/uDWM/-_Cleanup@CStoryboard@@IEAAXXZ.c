/*
 * XREFs of ?_Cleanup@CStoryboard@@IEAAXXZ @ 0x18002D284
 * Callers:
 ...
 *     ?OnAnimationComplete@CStoryboard@@UEAAJI@Z @ 0x180030640 (-OnAnimationComplete@CStoryboard@@UEAAJI@Z.c)
    ...
    *((_DWORD *)this + 7) = -1;
    ...
    for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 28); i = (unsigned int)(i + 1) )
    {
      ...
      WindowDataByHwnd = CWindowList::FindWindowDataByHwnd(
                           ...
                           *(HWND *)(*(_QWORD *)(*((_QWORD *)this + 11) + 8 * i) + 16LL));
      if ( WindowDataByHwnd && (v3 || (*((_DWORD *)WindowDataByHwnd + 151) & 0xFFF) == 0xFFF) )
      {
        v9 = *((_DWORD *)WindowDataByHwnd + 151);
        if ( (v9 & 0x40000000) == 0 )
          *((_DWORD *)WindowDataByHwnd + 151) = v9 & 0x2000000 | 0xFFF;
      }
