/*
 * XREFs of ?OnGesture@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_RENDERGESTURE@@@Z @ 0x18009281C
 * Callers:
 ...
 *     ?IsCurrentSessionRemotable@CDesktopManager@@SA_NXZ @ 0x180092274 (-IsCurrentSessionRemotable@CDesktopManager@@SA_NXZ.c)
...
LABEL_88:
          ...
          if ( v52 + 1 >= v52 )
          {
            ...
            {
              v56 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 152, 8u, 1, &v116);
              v54 = v56;
              if ( v56 >= 0 )
              {
LABEL_87:
...
LABEL_89:
        ...
        do
        {
          if ( *(_DWORD *)(*v76 + v77) == *((_DWORD *)a2 + 2) )
          {
            v74 = *(struct CVisual **)(*v76 + v77 + 8);
            DynArray<CIconicBitmapPending,0>::RemoveAt((__int64 *)this + 35, v75);
          }
          v77 -= 16LL;
          --v75;
        }
...
LABEL_120:
          ...
          v74 = v114;
          CContactManager::AddToTouchNode(v78, v111, v114);
        }
      ...
      else
      {
        if ( CDesktopManager::IsCurrentSessionRemotable() )
        {
          ...
          CContactManager::AddToTouchNode(v80, v111, v112[1]);
          ...
          if ( started >= 0 )
          {
            ...
            if ( (int)v82 + 1 >= (unsigned int)v82 )
            {
              ...
              {
                v84 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v81, 0x10u, 1, v112);
                started = v84;
                if ( v84 < 0 )
