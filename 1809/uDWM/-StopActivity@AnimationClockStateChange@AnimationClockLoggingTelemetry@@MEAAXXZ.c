/*
 * XREFs of ?StopActivity@AnimationClockStateChange@AnimationClockLoggingTelemetry@@MEAAXXZ @ 0x180027C10
 * Callers:
 *     <none>
 * Callees:
        ...
        AnimationClockLoggingTelemetry::AnimationClockStateChange *this)
{
  ...
  if ( v3 < 0 && v3 == v1[21] )
    ...
    v4 = 0LL;
  wil::ActivityBase<AnimationClockLogging,0,0,4,_TlgReflectorTag_Param0IsProviderType>::zInternalStop();
  ...
  if ( v4 )
  {
    if ( **(_DWORD **)(v6 + 8) > 4u )
    {
      ...
      v62 = 4;
      TlgCreateSz(&v64, v22);
      TlgWrite(v23, &unk_1800C3638, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &v31);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v7 > 4u )
    {
      ...
      v70 = 4;
      v69 = &v24;
      TlgWrite(v7, &unk_1800C376C, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &pData);
    }
  }
  if ( *((_DWORD *)this + 8) )
