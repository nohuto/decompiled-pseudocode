/*
 * XREFs of ?Initialize@UdwmTopVisual@@MEAAJPEAUIDwmChannel@@@Z @ 0x1800AF500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UdwmTopVisual::Initialize(UdwmTopVisual *this, struct IDwmChannel *a2)
{
  int v2; // eax
  unsigned int v3; // ebx
