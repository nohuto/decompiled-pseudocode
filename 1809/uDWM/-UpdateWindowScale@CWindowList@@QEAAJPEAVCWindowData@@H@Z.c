/*
 * XREFs of ?UpdateWindowScale@CWindowList@@QEAAJPEAVCWindowData@@H@Z @ 0x1800146E8
 * Callers:
 ...
 *     ?EstablishPixelAlignedScale@CWindowData@@QEAAXPEA_N@Z @ 0x180015110 (-EstablishPixelAlignedScale@CWindowData@@QEAAXPEA_N@Z.c)
...
__int64 __fastcall CWindowList::UpdateWindowScale(CWindowList *this, struct tagPOINT *a2, int a3)
{
  ...
  a2[7].y = (int)v10;
  if ( *(_QWORD *)&a2[49] && (v11 = CWindowData::OnWindowSizeUpdated((CWindowData *)a2), v6 = v11, v11 < 0) )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0xD05u);
  }
  else if ( v16 || a3 )
  {
