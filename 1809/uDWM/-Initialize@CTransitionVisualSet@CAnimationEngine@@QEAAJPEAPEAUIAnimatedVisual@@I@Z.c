/*
 * XREFs of ?Initialize@CTransitionVisualSet@CAnimationEngine@@QEAAJPEAPEAUIAnimatedVisual@@I@Z @ 0x180030E20
 * Callers:
    ...
    if ( a3 )
    {
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v10 * 8 + *((_QWORD *)this + 5)) = v12;
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x64Eu);
          goto LABEL_13;
        }
        ++v9;
        ++v10;
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x64Du);
LABEL_13:
      if ( v6 < 0 )
        goto LABEL_22;
    }
