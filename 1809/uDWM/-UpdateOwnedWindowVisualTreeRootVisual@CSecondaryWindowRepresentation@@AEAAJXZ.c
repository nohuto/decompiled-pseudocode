/*
 * XREFs of ?UpdateOwnedWindowVisualTreeRootVisual@CSecondaryWindowRepresentation@@AEAAJXZ @ 0x180036FB8
 * Callers:
        ...
        CSecondaryWindowRepresentation *this)
{
  ...
  struct CDrawGeometryInstruction *v18; // [rsp+68h] [rbp+10h] BYREF
  CBaseObject *v19; // [rsp+70h] [rbp+18h] BYREF
