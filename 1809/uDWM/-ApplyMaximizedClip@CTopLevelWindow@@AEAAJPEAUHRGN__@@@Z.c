/*
 * XREFs of ?ApplyMaximizedClip@CTopLevelWindow@@AEAAJPEAUHRGN__@@@Z @ 0x1800355C0
 * Callers:
  ...
  if ( (*((_BYTE *)this + 240) & 8) != 0 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( !CombineRgn(a2, a2, v8, 1) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800BDE28, 0xBu, v2, 0x1243u);
      }
      DeleteObject(v8);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800BDE28, 0xBu, v2, 0x1241u);
    }
  }
