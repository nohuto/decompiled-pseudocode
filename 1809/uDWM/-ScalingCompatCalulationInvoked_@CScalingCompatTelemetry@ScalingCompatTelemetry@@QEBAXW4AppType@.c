/*
 * XREFs of ?ScalingCompatCalulationInvoked_@CScalingCompatTelemetry@ScalingCompatTelemetry@@QEBAXW4AppType@2@II@Z @ 0x1800B3D6C
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
    ...
    v13 = 4LL;
    v15 = 4LL;
    LODWORD(v5) = TlgWrite(v6, &unk_1800C3946, 0LL, 0LL, 5u, &pData);
  }
  return v5;
}
