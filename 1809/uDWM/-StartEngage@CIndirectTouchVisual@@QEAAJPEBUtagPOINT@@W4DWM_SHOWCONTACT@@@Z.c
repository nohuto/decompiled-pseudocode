/*
 * XREFs of ?StartEngage@CIndirectTouchVisual@@QEAAJPEBUtagPOINT@@W4DWM_SHOWCONTACT@@@Z @ 0x1800A2040
 * Callers:
...
__int64 __fastcall CIndirectTouchVisual::StartEngage(__int64 a1)
{
  ...
  *((_DWORD *)v2 + 87) = v3;
  ...
  if ( v5 )
  {
    CTimelineBase::CTimelineBase(v5, *(float *)(a1 + 320), (float)*(int *)(a1 + 344), 14.0, 0);
...
LABEL_16:
  ...
  if ( v9 >= 0 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x5Eu);
  if ( v10 < 0 )
    goto LABEL_16;
  return 0LL;
}
