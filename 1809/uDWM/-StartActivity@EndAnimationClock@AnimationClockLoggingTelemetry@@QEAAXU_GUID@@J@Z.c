/*
 * XREFs of ?StartActivity@EndAnimationClock@AnimationClockLoggingTelemetry@@QEAAXU_GUID@@J@Z @ 0x18002E678
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    ...
    TlgWrite(v8, &unk_1800C2F5F, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v9, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
