/*
 * XREFs of ?StopActivity@GetCommitHandle@AnimationClockLoggingTelemetry@@MEAAXXZ @ 0x1800AEE00
 * Callers:
 *     <none>
 * Callees:
        ...
        AnimationClockLoggingTelemetry::GetCommitHandle *this)
{
  ...
  if ( v4 )
  {
    if ( *(_DWORD *)v6[1] > 4u )
    {
      ...
      v62 = 4;
      TlgCreateSz(&v64, v19);
      TlgWrite(v20, &unk_1800C31EE, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v21 > 4u )
    {
      ...
      v70 = 4;
      v69 = &v24;
      TlgWrite(v21, &unk_1800C3318, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v65);
    }
  }
  if ( *((_DWORD *)this + 8) )
