/*
 * XREFs of ?zInternalStart@?$ActivityBase@VAnimationClockLogging@@$0A@$0A@$03U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x180027D30
 * Callers:
        ...
        __int64 a1)
{
  ...
  wil::ActivityBase<WindowFrameLogging,1,0,5,_TlgReflectorTag_Param0IsProviderType>::LockExclusive(a1, &v5);
  v2 = *(_QWORD *)(a1 + 48);
