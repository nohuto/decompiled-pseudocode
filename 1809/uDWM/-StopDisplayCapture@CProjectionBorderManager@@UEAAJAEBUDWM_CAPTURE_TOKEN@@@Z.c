/*
 * XREFs of ?StopDisplayCapture@CProjectionBorderManager@@UEAAJAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x180081BD0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct DWM_CAPTURE_TOKEN *a2)
{
  ...
  *(_QWORD *)v13 = &CDesktopManager::s_csDwmInstance;
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**((_QWORD **)this + 54) + 1232LL))(
         *((_QWORD *)this + 54),
         Element[2],
         0LL);
  v11 = v9;
