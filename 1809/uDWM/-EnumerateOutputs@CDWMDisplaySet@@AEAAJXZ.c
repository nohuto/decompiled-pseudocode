/*
 * XREFs of ?EnumerateOutputs@CDWMDisplaySet@@AEAAJXZ @ 0x180029AEC
 * Callers:
...
LABEL_4:
    ...
    while ( 1 )
    {
      v9 = (DXGIOutputInfo *)(*(_QWORD *)(v7 + 352) + 288 * v6);
      ...
      if ( *((_DWORD *)v9 + 46) || *((_DWORD *)v9 + 47) || *((_DWORD *)v9 + 48) || *((_DWORD *)v9 + 49) )
      {
        ...
        v11 = (CDWMDisplay *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 16LL))(
                               WPF::g_pProcessHeap,
                               224LL);
        if ( v11 )
...
LABEL_32:
      ...
      if ( (unsigned int)v6 >= *(_DWORD *)(v7 + 376) )
        goto LABEL_4;
    }
    v16 = 243;
LABEL_35:
