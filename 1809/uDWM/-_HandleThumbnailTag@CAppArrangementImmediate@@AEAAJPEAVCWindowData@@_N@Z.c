/*
 * XREFs of ?_HandleThumbnailTag@CAppArrangementImmediate@@AEAAJPEAVCWindowData@@_N@Z @ 0x1800A5F64
 * Callers:
 ...
 *     ?GetPVLTarget@CAppArrangementImmediate@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800A34E0 (-GetPVLTarget@CAppArrangementImmediate@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
 *     ?GetSpecialTargetInfo@CAppArrangementImmediate@@UEAA?AW4SpecialTargetInfo@@W4DWMTRANSITION_TARGET@@@Z @ 0x1800A3AD0 (-GetSpecialTargetInfo@CAppArrangementImmediate@@UEAA-AW4SpecialTargetInfo@@W4DWMTRANSITION_TARGE.c)
        ...
        char a3)
{
  ...
  *(_QWORD *)&v30.right = 0LL;
  ...
  if ( a3 )
  {
    ...
    rc = v7;
    if ( (v8 & 0x1000000) != 0 )
      rc = (struct tagRECT)*((_OWORD *)a2 + 38);
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0xE2Eu);
LABEL_6:
      v12 = v26;
      goto LABEL_30;
    }
  ...
  else
  {
    ...
    *(_QWORD *)&rc.right = 0LL;
    ...
    v18 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(
            ...
            1,
            v17,
            (struct tagRECT *)(((unsigned __int64)a2 + 608) & -(__int64)(v16 != 0)),
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v18, 0xE41u);
      goto LABEL_6;
    }
  }
  v19 = *((_DWORD *)a2 + 151);
  v12 = v26;
  if ( (v19 & 0x1000000) != 0 )
    v20 = (struct tagRECT)*((_OWORD *)a2 + 39);
  else
    v20 = *(struct tagRECT *)(*(_QWORD *)&v26 + 88LL);
  v30 = v20;
  if ( (v19 & 0x800000) != 0 )
  {
    v21 = (struct tagRECT)*((_OWORD *)a2 + 41);
  }
  else
  {
...
LABEL_24:
  ...
  *(_BYTE *)(*(_QWORD *)&v12 + 73LL) = 0;
  if ( (CAppArrangementImmediate::GetSpecialTargetInfo((__int64)this, *((_WORD *)a2 + 302) & 0xFFF) & 8) != 0 )
  {
