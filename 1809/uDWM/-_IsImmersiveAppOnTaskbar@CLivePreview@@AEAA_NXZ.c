/*
 * XREFs of ?_IsImmersiveAppOnTaskbar@CLivePreview@@AEAA_NXZ @ 0x180076058
 * Callers:
 ...
 *     ?_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ @ 0x18007667C (-_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ.c)
 * Callees:
 *     <none>
 */
