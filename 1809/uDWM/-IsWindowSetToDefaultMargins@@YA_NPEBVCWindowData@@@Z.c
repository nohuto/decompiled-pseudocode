/*
 * XREFs of ?IsWindowSetToDefaultMargins@@YA_NPEBVCWindowData@@@Z @ 0x180024718
 * Callers:
 ...
 *     ?GetDefaultWindowMarginsForWindowStyle@@YA?AU_MARGINS@@KKKN@Z @ 0x1800247FC (-GetDefaultWindowMarginsForWindowStyle@@YA-AU_MARGINS@@KKKN@Z.c)
 */
