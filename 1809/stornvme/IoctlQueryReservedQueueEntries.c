/*
 * XREFs of IoctlQueryReservedQueueEntries @ 0x1C0010E20
 * Callers:
...
__int64 __fastcall IoctlQueryReservedQueueEntries(__int64 a1, __int64 a2)
{
  ...
  if ( v2 )
  {
    v7 = (unsigned __int16 *)(*(_QWORD *)(a1 + 784) + 26LL);
    v8 = v2;
    do
    {
      if ( *(v7 - 5) )
