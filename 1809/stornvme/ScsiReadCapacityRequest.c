/*
 * XREFs of ScsiReadCapacityRequest @ 0x1C0003C94
 * Callers:
...
__int64 __fastcall ScsiReadCapacityRequest(__int64 a1, __int64 a2, _BYTE *a3, __int64 a4)
{
  ...
  v10 = *(_QWORD *)(a1 + 8 * v9 + 1640);
  v11 = 0;
  v12 = *(_DWORD *)(v10 + 52);
  v13 = *(_QWORD *)(v10 + 56) - 1LL;
  v20 = v13;
  v14 = *(_QWORD *)(a1 + 8LL * (unsigned __int8)v9 + 1640);
        ...
        if ( (_DWORD)a4 == 16 && *a3 == 0x9E )
        {
          ...
          *v8 = HIBYTE(v20);
          ...
          if ( (unsigned int)*v7 >= 0x10 )
          {
            v8[12] &= 0xF0u;
            v17 = v8[13];
            if ( *(_DWORD *)(*(_QWORD *)(a1 + 8 * v9 + 1640) + 52LL) == 512 )
              v18 = v17 & 0xF0 | 3;
            else
              v18 = v17 & 0xF0;
            v8[14] &= 0xC0u;
            ...
            v19 = v8[14] & 0x3F;
            v8[15] = 0;
            v8[14] = v19 & 0xBF | (*(_BYTE *)(*(_QWORD *)(a1 + 8 * v9 + 1640) + 65LL) << 7);
