/*
 * XREFs of NVMeControllerFilterResouceRequirements @ 0x1C000D798
 * Callers:
 ...
 *     IsPci3MsiInterrupt @ 0x1C000D128 (IsPci3MsiInterrupt.c)
 */
...
char __fastcall NVMeControllerFilterResouceRequirements(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = 0;
  v7 = 0;
  result = GetProcessorGroupInformation(a1, a2, a3, a4);
  if ( result )
  {
    v10 = *(_QWORD *)(a2 + 8);
    v11 = *(_DWORD *)(v10 + 36);
      ...
      if ( v12 )
      {
        while ( 1 )
        {
          if ( IsPci3MsiInterrupt(32LL * v17 + v10 + 40) )
          {
            ...
            *(_DWORD *)(v19 + v10 + 60) = 3;
            if ( (v21 & ~(1LL << v22)) == 0 && v23 == *(unsigned __int16 *)(a1 + 192) - 1 )
              break;
          }
          v18 = *(_DWORD *)(v10 + 36);
          v17 = v20 + 1;
