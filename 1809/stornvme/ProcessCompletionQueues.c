/*
 * XREFs of ProcessCompletionQueues @ 0x1C0017CAC
 * Callers:
...
__int64 __fastcall ProcessCompletionQueues(__int64 a1, unsigned __int16 a2, char a3)
{
  ...
  if ( a2 == 0xFFFF || *(_WORD *)(a1 + 232) <= 1u )
  {
    ...
    if ( (*(_WORD *)(result + 16LL * *(unsigned __int16 *)(a1 + 578) + 14) & 1) != *(_WORD *)(a1 + 580) )
    {
      NVMeMaskInterrupt(a1, *(_WORD *)(a1 + 576));
      if ( v4 )
    ...
    for ( i = 0; ; ++i )
    {
      ...
      if ( !v12 )
        break;
      result = *(unsigned __int16 *)(a1 + 266);
      ...
      if ( (*(_WORD *)(*(_QWORD *)v10 + 16LL * *(unsigned __int16 *)(v10 + 170) + 14) & 1) != *(_WORD *)(v10 + 172) )
      {
        ...
        if ( v4 )
          ...
          result = StorPortNotification(4098LL, a1, v11 + 24, v11);
      }
    }
  }
  else
  {
    if ( a2 )
      v5 = 344LL * a2 + *(_QWORD *)(a1 + 760) - 344LL;
    else
      v5 = a1 + 408;
    ...
    if ( v4 )
      ...
      return StorPortNotification(4098LL, a1, v6 + 24, v6);
  }
  return result;
}
