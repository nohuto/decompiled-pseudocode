/*
 * XREFs of NVMeQueuesReInit @ 0x1C000F68C
 * Callers:
...
void *__fastcall NVMeQueuesReInit(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 800) = 0;
  ...
  while ( v3 );
  SubmissionQueueReInit(a1, a1 + 272);
  result = CompletionQueueReInit(a1, a1 + 408);
  v5 = 0;
  if ( *(_WORD *)(a1 + 260) )
  {
    do
    {
      ...
      result = (void *)*(unsigned __int16 *)(a1 + 260);
      ++v5;
    }
  ...
  if ( *(_WORD *)(a1 + 264) )
  {
    do
    {
      SubmissionQueueReInit(a1, *(_QWORD *)(a1 + 752) + 136LL * v7);
      result = (void *)*(unsigned __int16 *)(a1 + 264);
      ++v7;
    }
  ...
  if ( *(_WORD *)(a1 + 266) )
  {
    do
    {
      CompletionQueueReInit(a1, *(_QWORD *)(a1 + 760) + 344LL * v8);
      result = (void *)*(unsigned __int16 *)(a1 + 266);
      ++v8;
    }
  ...
  if ( *(_WORD *)(a1 + 194) )
  {
    ...
    {
      v10 = v9++;
      *(_QWORD *)(*(_QWORD *)(a1 + 224) + 48 * v10 + 40) = 0LL;
      result = (void *)*(unsigned __int16 *)(a1 + 194);
    }
