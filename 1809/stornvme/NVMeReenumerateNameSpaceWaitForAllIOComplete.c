/*
 * XREFs of NVMeReenumerateNameSpaceWaitForAllIOComplete @ 0x1C00075B0
 * Callers:
...
char __fastcall NVMeReenumerateNameSpaceWaitForAllIOComplete(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 20) |= 0x100u;
  ...
  if ( (_WORD)v4 )
  {
    do
    {
      for ( i = 0; i < 0x3E8; ++i )
      {
        ...
        if ( !*(_WORD *)(*(_QWORD *)(a1 + 752) + 136LL * v5 + 128) )
          break;
      }
  ...
  if ( (_WORD)v4 )
  {
    while ( !*(_WORD *)(136LL * v7 + *(_QWORD *)(a1 + 752) + 128) )
    {
