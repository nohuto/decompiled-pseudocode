/*
 * XREFs of RIMIDE_InitializePointerDeviceInjection @ 0x1C0120C20
 * Callers:
        ...
        __int64 *a7)
{
  ...
  __int64 v20; // rax
  struct _HIDP_DEVICE_DESC v22; // [rsp+50h] [rbp-B0h] BYREF
  struct _HIDP_DEVICE_DESC v23; // [rsp+90h] [rbp-70h] BYREF
  _BYTE v24[160]; // [rsp+D0h] [rbp-30h] BYREF
  ...
  while ( v12 < 0xC );
  v19 = BuildReportDescriptor(0xDu, v13, (struct tagUSAGE_PROPERTIES *)v24, 0xCu, v15, &v23);
  if ( v19 )
  {
    v22 = v23;
