/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0200828
 * Callers:
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0200060 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 *     TlgUnregisterAggregateProvider @ 0x1C02006D0 (TlgUnregisterAggregateProvider.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C0201370 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 * Callees:
 *     _TlgKeywordOn @ 0x1C00304B0 (_TlgKeywordOn.c)
 *     _TlgWrite @ 0x1C003A4A8 (_TlgWrite.c)
 *     __security_check_cookie @ 0x1C00A63D0 (__security_check_cookie.c)
 *     memset @ 0x1C00AF780 (memset.c)
 *     FlushLookUpTableBucket @ 0x1C0185B1C (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C02013FC (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C01C7A00 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7A00, 0x400000000000uLL) )
      {
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C01C7A00, &unk_1C01A3656, 0LL, 0LL, 0xBu, &pData);
      }
