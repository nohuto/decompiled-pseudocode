/*
 * XREFs of HmgSafeNextObjtByIndex @ 0x1C0020040
 * Callers:
...
__int64 __fastcall HmgSafeNextObjtByIndex(__int64 a1, char a2, _QWORD *a3)
{
  ...
  while ( 1 )
  {
    do
    {
      NextEntryIndex = GdiHandleManager::GetNextEntryIndex((GdiHandleManager *)a1, v6, &v16);
      v6 = NextEntryIndex;
      if ( !NextEntryIndex )
        return 0LL;
      v8 = v16;
