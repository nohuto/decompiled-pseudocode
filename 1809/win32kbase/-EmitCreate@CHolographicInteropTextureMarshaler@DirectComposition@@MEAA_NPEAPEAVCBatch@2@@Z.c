/*
 * XREFs of ?EmitCreate@CHolographicInteropTextureMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C016DE20
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CHolographicInteropTextureMarshaler::EmitCreate(
