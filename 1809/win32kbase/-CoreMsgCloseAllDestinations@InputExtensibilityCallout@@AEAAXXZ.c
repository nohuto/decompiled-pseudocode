/*
 * XREFs of ?CoreMsgCloseAllDestinations@InputExtensibilityCallout@@AEAAXXZ @ 0x1C009213C
 * Callers:
...
void __fastcall InputExtensibilityCallout::CoreMsgCloseAllDestinations(InputExtensibilityCallout *this)
{
  ...
  v1 = (char *)this + 24;
  RIMLockExclusive((__int64)this + 24);
  v3 = (HANDLE *)((char *)this + 48);
  v4 = (HANDLE *)((char *)this + 488);
  while ( v3 != v4 )
  {
    if ( *v3 )
    {
