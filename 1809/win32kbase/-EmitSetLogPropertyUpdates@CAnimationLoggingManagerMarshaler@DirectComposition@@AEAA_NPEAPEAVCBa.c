/*
 * XREFs of ?EmitSetLogPropertyUpdates@CAnimationLoggingManagerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C006E2D0
 * Callers:
 ...
 *     _lambda_538836bead5a962845b1ca8b143e9ec1_::operator() @ 0x1C009E778 (_lambda_538836bead5a962845b1ca8b143e9ec1_--operator().c)
 */
  ...
  if ( v12 < v2 )
  {
    ...
    while ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x18uLL, &v13) )
    {
      ...
      *((_DWORD *)v8 + 2) = *((_DWORD *)this + 6);
      lambda_538836bead5a962845b1ca8b143e9ec1_::operator()(v11);
      v9 = v12;
      v10 = ++*((_DWORD *)this + 20);
      v12 = v9 + 1;
      if ( v9 + 1 >= v2 )
