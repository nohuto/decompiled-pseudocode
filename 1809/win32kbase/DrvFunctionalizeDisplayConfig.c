/*
 * XREFs of DrvFunctionalizeDisplayConfig @ 0x1C0104C14
 * Callers:
        ...
        int a6)
{
  ...
  v15 = *a1;
  v28[0] = (struct D3DKMT_GETPATHSMODALITY *)&off_1C018EB70;
  *(_OWORD *)v29 = 0LL;
  a6 = v6 & 1;
  if ( (v6 & 1) != 0 )
  {
...
LABEL_21:
  ...
  if ( PathModalityForDisplayConfig >= 0 )
  {
    if ( a4 )
    {
      PathModalityForDisplayConfig = ((__int64 (__fastcall *)(__int64, __int64, struct D3DKMT_GETPATHSMODALITY **))qword_1C01CDEB8)(
                                       a4,
                                       0x20000LL,
                                       &v29[1]);
      if ( PathModalityForDisplayConfig < 0 )
    ...
    if ( a6 )
    {
      ...
      v26 = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *, _QWORD, char *, char *))qword_1C01CDEA0)(
              v22,
              v24,
              v23,
              (char *)v8 - 176,
    ...
    {
      PathModalityForDisplayConfig = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *))qword_1C01CD8B0)(
                                       v22 | 0x8000,
                                       v29[0]);
      if ( PathModalityForDisplayConfig < 0 )
        goto LABEL_35;
      ...
      v26 = ((__int64 (__fastcall *)(struct D3DKMT_GETPATHSMODALITY *, unsigned int *, struct DISPLAYCONFIG_PATH_INFO_INTERNAL *, __int64))qword_1C01CDE10)(
              v29[0],
              a1,
              v8,
              a5);
