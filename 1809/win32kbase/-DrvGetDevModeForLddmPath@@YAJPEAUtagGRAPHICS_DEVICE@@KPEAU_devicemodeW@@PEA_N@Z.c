/*
 * XREFs of ?DrvGetDevModeForLddmPath@@YAJPEAUtagGRAPHICS_DEVICE@@KPEAU_devicemodeW@@PEA_N@Z @ 0x1C00498F8
 * Callers:
...
__int64 __fastcall DrvGetDevModeForLddmPath(struct tagGRAPHICS_DEVICE *a1, int a2, struct _devicemodeW *a3, bool *a4)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v16 )
    {
      ...
      v9 = 0;
      if ( !a3
        || (v9 = ((__int64 (__fastcall *)(__int64, struct _devicemodeW *))qword_1C01CDE18)(v17 + 200LL * v10, a3),
            v9 >= 0) )
      {
        if ( a4 )
        {
