/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_69dcdd6af9664359482e1764120b8c55___ @ 0x1C000E5FC
 * Callers:
        ...
        __int64 a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(*(_QWORD *)a3 + 24LL);
  result = 1;
  *((_DWORD *)v5 + 3) = *(_DWORD *)(*(_QWORD *)a3 + 300LL);
  return result;
}
