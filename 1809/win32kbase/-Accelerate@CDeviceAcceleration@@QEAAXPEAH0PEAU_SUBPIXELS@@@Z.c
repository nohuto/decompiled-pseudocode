/*
 * XREFs of ?Accelerate@CDeviceAcceleration@@QEAAXPEAH0PEAU_SUBPIXELS@@@Z @ 0x1C003CBB8
 * Callers:
...
void __fastcall CDeviceAcceleration::Accelerate(CDeviceAcceleration *this, int *a2, int *a3, struct _SUBPIXELS *a4)
{
  ...
  char v35[16]; // [rsp+60h] [rbp-10h] BYREF
  ...
  *((_DWORD *)a4 + 1) = 0;
  if ( v9 )
  {
    ...
    if ( v17 )
    {
      ...
      if ( dword_1C01CE080 != (_DWORD)v19 && (unsigned int)v19 > dword_1C01CE080 )
        v20 = (*(_QWORD *)(v33 + 8LL * (unsigned int)dword_1C01CE080)
             + (*(_QWORD *)(v32 + 8LL * (unsigned int)dword_1C01CE080) << 16) / v17
             + v20) >> 1;
      dword_1C01CE080 = v19;
      v21 = qword_1C01CE078 + ((v11 * v20) >> 16);
      v22 = -v21;
      v23 = qword_1C01CE070 + ((v10 * v20) >> 16);
      if ( v21 < 0 )
      {
        v25 = v21;
      ...
      *((_DWORD *)a4 + 1) = v23 - v28;
      qword_1C01CE070 = v23 - v28;
      if ( v23 < 0 )
        v29 = v30;
      *a3 = v29 >> 16;
    }
  }
  CEResourceLockExclusive::~CEResourceLockExclusive((CEResourceLockExclusive *)v35);
}
