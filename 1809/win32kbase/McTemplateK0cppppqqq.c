/*
 * XREFs of McTemplateK0cppppqqq @ 0x1C00E8D94
 * Callers:
...
ULONG __fastcall McTemplateK0cppppqqq(
        ...
        char a11)
{
  ...
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+50h] [rbp-81h] BYREF
  ...
  v29 = 4LL;
  v31 = 4LL;
  return McGenEventWrite(a1, a2, (LPCGUID)&Context.Flags, 9u, &EventData);
}
