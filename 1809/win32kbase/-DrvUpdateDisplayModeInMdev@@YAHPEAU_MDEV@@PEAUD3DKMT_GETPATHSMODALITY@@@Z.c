/*
 * XREFs of ?DrvUpdateDisplayModeInMdev@@YAHPEAU_MDEV@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C01027A8
 * Callers:
...
LABEL_3:
  ...
  {
    v7 = WdLogNewEntry5_WdEvent(v5, v4, v6);
    *(_QWORD *)(v7 + 24) = 26871LL;
    goto LABEL_3;
  }
  if ( *((_WORD *)a2 + 10) != 1 )
  {
    v7 = WdLogNewEntry5_WdEvent(v5, v4, v6);
    *(_QWORD *)(v7 + 24) = 26876LL;
    goto LABEL_3;
  }
  v9 = *(_QWORD *)a1;
  if ( (unsigned __int8)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C01CDA70)(
                          ...
                          *(unsigned int *)(*(_QWORD *)(*(_QWORD *)a1 + 2576LL) + 256LL)) )
  {
    ...
    if ( v14 && v14(*(_QWORD *)(v9 + 1800)) )
    {
      ...
      {
        v22 = gpGdiDevCaps;
        v23 = *(_DWORD **)(*((_QWORD *)a1 + 4) + 2592LL);
        *((_DWORD *)a1 + 12) = v23[19];
        *((_DWORD *)a1 + 13) = v23[20];
        *((_DWORD *)a1 + 14) = v23[19] + v23[43];
        *((_DWORD *)a1 + 15) = v23[20] + v23[44];
        v46 = *(_QWORD *)a1;
