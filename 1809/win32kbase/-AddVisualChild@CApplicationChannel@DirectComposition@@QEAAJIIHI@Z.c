/*
 * XREFs of ?AddVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIHI@Z @ 0x1C00193C0
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( !v13 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v13 + 120LL))(v13, 157LL) )
      v11 = -1073741811;
    if ( v11 >= 0 )
    {
      if ( a5 )
      {
        ...
        if ( !v5 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 120LL))(v5, 157LL) )
          v11 = -1073741811;
      }
      if ( v11 >= 0 )
      {
