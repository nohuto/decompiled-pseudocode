/*
 * XREFs of ?ShouldDeferToken@CSynchronizationManager@DirectComposition@@SA_N_K0@Z @ 0x1C006DD18
 * Callers:
 *     DCompositionShouldDeferToken @ 0x1C006DD00 (DCompositionShouldDeferToken.c)
 * Callees:
