/*
 * XREFs of ?EmitRoot@COverlayRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C017B7E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::COverlayRenderTargetMarshaler::EmitRoot(
