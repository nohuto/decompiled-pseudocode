/*
 * XREFs of VKFromVSC @ 0x1C00838B0
 * Callers:
...
char __fastcall VKFromVSC(unsigned __int8 *a1, char a2)
{
  ...
  *((_WORD *)a1 + 1) = 255;
  ...
  if ( gptiForeground && (v6 = *((_QWORD *)gptiForeground + 55)) != 0 )
...
LABEL_33:
  ...
  if ( (v4 & 0x200) != 0
    && (ModifierBits = GetModifierBits((unsigned __int8 **)&Modifiers_VK_STANDARD, (__int64)gafRawKeyState),
        ModifierBits <= (unsigned __int16)word_1C01C7FB0)
    && (_mm_lfence(), v12 = *((_BYTE *)&Modifiers_VK_STANDARD + ModifierBits + 10), v12 != 15)
