/*
 * XREFs of ?DrvUpdateDpiInfoOnOptimizedModeChange@@YAJPEAU_MDEV@@PEAE@Z @ 0x1C0102E74
 * Callers:
  ...
  if ( a1 )
  {
    for ( i = 0LL; (unsigned int)i < *((_DWORD *)a1 + 5); i = (unsigned int)(i + 1) )
    {
      ...
      if ( (unsigned int)PDEVOBJ::bLddmDriver((PDEVOBJ *)&v21) )
      {
        ...
        Buf1[4] = v13;
        Buf1[5] = v14;
        v15 = ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64, __int64))qword_1C01CDB50)(
                v10,
                v11,
                0xFFFFFFFFLL,
                v6 + 2136,
        ...
        if ( v15 >= 0 )
        {
          if ( memcmp(Buf1, (const void *)(v6 + 2456), 0x60uLL) )
          {
            *((_DWORD *)a1 + 10 * i + 16) = *(_DWORD *)(v6 + 2464);
            *a2 = 1;
          }
        }
        else
        {
          ...
          v19[3] = v2;
          v19[4] = *(_QWORD *)(*(_QWORD *)(v6 + 2576) + 240LL);
          v19[5] = *(unsigned int *)(*(_QWORD *)(v6 + 2576) + 256LL);
