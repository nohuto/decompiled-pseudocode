...
LABEL_17:
    if ( a4 )
    {
      do
      {
        v13 = (float)*v6;
        v14 = (float)v6[1];
        bFToL((float)(v14 * *(float *)(a1 + 8)) + (float)(v13 * *(float *)a1), &v17, 6u);
        bFToL((float)(v13 * *(float *)(a1 + 4)) + (float)(v14 * *(float *)(a1 + 12)), v16, v15);
        v6 += 2;
        *v5 = *(_DWORD *)(a1 + 24) + v17;
        v5[1] = v16[0] + *(_DWORD *)(a1 + 28);
        v5 += 2;
        --v4;
      }
      while ( v4 );
...
LABEL_11:
    if ( a4 )
    {
      do
      {
        bFToL((float)*v6 * *(float *)a1, &v17, 6u);
        bFToL((float)v6[1] * *(float *)(a1 + 12), v16, v11);
        v6 += 2;
        *v5 = *(_DWORD *)(a1 + 24) + v17;
        v5 += 2;
        *(v5 - 1) = v16[0] + *(_DWORD *)(a1 + 28);
