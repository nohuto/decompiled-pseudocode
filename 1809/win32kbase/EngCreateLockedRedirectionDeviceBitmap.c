/*
 * XREFs of EngCreateLockedRedirectionDeviceBitmap @ 0x1C00AC1C0
 * Callers:
 *     <none>
 * Callees:
...
SURFOBJ *__fastcall EngCreateLockedRedirectionDeviceBitmap(__int64 a1, unsigned __int64 a2, int a3)
{
  SURFOBJ *v3; // rbx
