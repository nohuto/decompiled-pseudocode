/*
 * XREFs of ?EmitDisplayRect@CRemotingRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C016D580
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CRemotingRenderTargetMarshaler::EmitDisplayRect(
