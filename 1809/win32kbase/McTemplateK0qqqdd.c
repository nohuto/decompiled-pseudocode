/*
 * XREFs of McTemplateK0qqqdd @ 0x1C00EA8A0
 * Callers:
 *     EtwTracePointerDeviceContactIds @ 0x1C00E7AF0 (EtwTracePointerDeviceContactIds.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0050EB8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00A63D0 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0qqqdd(
        ...
        char a8)
{
  ...
  v18 = &a8;
  v19 = 4LL;
  return McGenEventWrite(a1, &PointerDeviceContactIds, (LPCGUID)&Context.Flags, 6u, &EventData);
}
