/*
 * XREFs of McTemplateK0qqqqqqq @ 0x1C00EAB6C
 * Callers:
...
ULONG __fastcall McTemplateK0qqqqqqq(
        ...
        char a10)
{
  ...
  v27 = 4LL;
  v29 = 4LL;
  return McGenEventWrite(a1, &IdleStatusEvent, (LPCGUID)&Context.Flags, 8u, &EventData);
}
