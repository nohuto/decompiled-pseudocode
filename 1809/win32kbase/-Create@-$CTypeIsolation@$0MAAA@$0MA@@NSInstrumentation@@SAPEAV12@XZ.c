/*
 * XREFs of ?Create@?$CTypeIsolation@$0MAAA@$0MA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C0066F40
 * Callers:
...
_QWORD *NSInstrumentation::CTypeIsolation<49152,192>::Create()
{
  ...
  *PoolWithTag = PoolWithTag;
  ...
  v1[2] = v2;
  if ( !v2 || (*v2 = 0LL, (v3 = (_QWORD *)NSInstrumentation::CSectionEntry<49152,192>::Create()) == 0LL) )
  {
    v6 = (void *)v1[2];
    if ( !v6 )
      goto LABEL_10;
