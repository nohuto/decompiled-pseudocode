/*
 * XREFs of ?Create@?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C006705C
 * Callers:
...
_QWORD *NSInstrumentation::CTypeIsolation<233472,912>::Create()
{
  ...
  *PoolWithTag = PoolWithTag;
  ...
  v1[2] = v2;
  if ( !v2 || (*v2 = 0LL, (v3 = (_QWORD *)NSInstrumentation::CSectionEntry<233472,912>::Create()) == 0LL) )
  {
    v6 = (void *)v1[2];
    if ( !v6 )
      goto LABEL_10;
