/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_5977b5f41eb0659058fbaa4886c55b50___ @ 0x1C000E678
 * Callers:
...
char __fastcall DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_5977b5f41eb0659058fbaa4886c55b50___(
        __int64 a1,
        ...
        __int64 a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(*(_QWORD *)a3 + 24LL);
  result = 1;
  *((_DWORD *)v5 + 3) = *(_DWORD *)(*(_QWORD *)a3 + 296LL);
  return result;
}
