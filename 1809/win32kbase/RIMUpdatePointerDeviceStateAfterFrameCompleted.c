/*
 * XREFs of RIMUpdatePointerDeviceStateAfterFrameCompleted @ 0x1C0128580
 * Callers:
...
__int64 __fastcall RIMUpdatePointerDeviceStateAfterFrameCompleted(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  _BYTE v43[32]; // [rsp+50h] [rbp-20h] BYREF
  ...
  if ( v9 )
    *(_DWORD *)(v8 + 36) = 0;
  active = RIMCmActiveContactsBegin(&v41, v4);
  v11 = *(_QWORD *)(active + 16);
  v39 = *(_OWORD *)active;
  v40 = v11;
  while ( 1 )
  {
    v12 = RIMCmActiveContactsEnd(v43, v4);
    v13 = *(_OWORD *)v12;
    v14 = *(_QWORD *)(v12 + 16);
    v15 = *(_QWORD *)v12;
    v42 = v14;
    ...
    {
      result = DWORD2(v41);
      if ( DWORD2(v39) == DWORD2(v41) && v40 == v42 )
        break;
    }
    v17 = v40 - 16;
...
LABEL_28:
      ...
      if ( (*(_DWORD *)(v17 + 32) & 8) != 0 && (*(_DWORD *)(v17 + 2636) & 2) != 0 && (*(_DWORD *)(v17 + 2420) & 2) == 0 )
      {
        if ( *(_QWORD *)(v4 + 952) != v17 )
          MicrosoftTelemetryAssertTriggeredNoArgsKM(v19, v18, v20);
        RIMResetPointerDevicePrimaryContact(v4, v18, v20);
      }
      v18 = 128LL;
      v24 = *(_OWORD *)(v17 + 2360);
      *(_OWORD *)(v17 + 2560) = *(_OWORD *)(v17 + 2344);
      v25 = *(_OWORD *)(v17 + 2376);
      *(_OWORD *)(v17 + 2576) = v24;
      v26 = *(_OWORD *)(v17 + 2392);
      *(_OWORD *)(v17 + 2592) = v25;
      ...
      *(_OWORD *)(v17 + 2672) = v30;
      v31 = *(_OWORD *)(v17 + 2488);
      *(_OWORD *)(v17 + 2688) = *(_OWORD *)(v17 + 2472);
      v32 = *(_OWORD *)(v17 + 2504);
      *(_OWORD *)(v17 + 2704) = v31;
      v33 = *(_OWORD *)(v17 + 2520);
      *(_OWORD *)(v17 + 2720) = v32;
  ...
  if ( !a4 )
  {
    if ( v4 == *(_QWORD *)(a1 + 480) && !*(_DWORD *)(v4 + 948) )
      result = RIMUpdatePrimaryDevice(a1, 0LL);
    if ( !*(_DWORD *)(v4 + 944) )
    {
      RIMRemoveFromActiveDevices(a1, v4, 0, 0LL);
      return (__int64)memset((void *)(v4 + 776), 0, 0x38uLL);
    }
  }
  return result;
}
