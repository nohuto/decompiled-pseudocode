/*
 * XREFs of ?RawInputManagerObject@RIM@InputTraceLogging@@SAXPEBU0@@Z @ 0x1C00A45C0
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RawInputManagerObject(const struct RawInputManagerObject *a1)
{
  ...
  if ( dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
  {
    ...
    v28 = v14;
    v30 = v14;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019E933, 0LL, 0LL, 8u, &pData);
  }
}
