/*
 * XREFs of ?SendFrameToUserMode@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@K@Z @ 0x1C0142FC8
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::SendFrameToUserMode(const struct CPointerInputFrame *a1, int a2)
{
  ...
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
    {
      ...
      v12 = v3;
      v14 = v3;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C01A065B, 0LL, 0LL, 6u, &pData);
    }
  }
}
