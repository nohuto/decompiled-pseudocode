/*
 * XREFs of bDfbSurfacesMigrated @ 0x1C0042950
 * Callers:
 ...
 *     MulFindDisplayDhsurfFromMetaSurf @ 0x1C00FC244 (MulFindDisplayDhsurfFromMetaSurf.c)
 */
      ...
      || (DisplayDhsurfFromMetaSurf = MulFindDisplayDhsurfFromMetaSurf()) != 0 )
    {
      ...
      if ( (v5 & 0x4000000) != 0 )
      {
        ...
        for ( j = (_QWORD *)*v13; ; j = (_QWORD *)*v20 )
        {
          ...
          v15 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, __int64, _DWORD, _DWORD, __int64 *))(a1 + 3440))(
                  *(_QWORD *)(a1 + 1800),
                  v9,
                  *(unsigned int *)(a2 + 96),
                  v10 | 0x10u,
