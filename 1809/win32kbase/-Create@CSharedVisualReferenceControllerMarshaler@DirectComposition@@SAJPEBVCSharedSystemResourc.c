/*
 * XREFs of ?Create@CSharedVisualReferenceControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C018127C
 * Callers:
 *     CreateSharedVisualReferenceControllerMarshaler @ 0x1C0181430 (CreateSharedVisualReferenceControllerMarshaler.c)
 * Callees:
