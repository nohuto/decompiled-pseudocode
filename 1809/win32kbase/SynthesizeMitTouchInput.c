/*
 * XREFs of SynthesizeMitTouchInput @ 0x1C0156248
 * Callers:
 ...
 *     ?CreateInjectionDevice@@YAHXZ @ 0x1C01560CC (-CreateInjectionDevice@@YAHXZ.c)
...
char __fastcall SynthesizeMitTouchInput(unsigned int *a1)
{
  ...
  struct tagRECT v18; // [rsp+30h] [rbp-78h] BYREF
  struct tagRECT v19; // [rsp+40h] [rbp-68h] BYREF
  _BYTE v20[24]; // [rsp+50h] [rbp-58h] BYREF
  _BYTE v21[24]; // [rsp+68h] [rbp-40h] BYREF
  ...
  *((_DWORD *)v3 + 6) = *a1;
  if ( *a1 )
  {
    while ( 1 )
    {
      ...
      v12 = *((_QWORD *)v10 + 8);
      *(_QWORD *)(v8 + v5 + 48) = v12;
      v18 = TouchExtensibility::rcHimetricRect;
      v19 = TouchExtensibility::rcLogicalRect;
      if ( !(unsigned int)ConvertPointCoordinates(v12, &v19.left, &v18.left, &v22) )
        break;
      v13 = v22;
...
LABEL_12:
  PushW32ThreadLock(v3, v21, Win32FreePool);
  PushW32ThreadLock(v5, v20, Win32FreePool);
  v14 = HMValidateHandleNoSecure((unsigned __int64)TouchExtensibility::hDeviceUser, 19);
  InputTraceLogging::RIM::InjectInput(v14, 0);
