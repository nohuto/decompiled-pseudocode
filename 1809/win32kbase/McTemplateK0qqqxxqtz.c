/*
 * XREFs of McTemplateK0qqqxxqtz @ 0x1C016BD90
 * Callers:
...
ULONG __fastcall McTemplateK0qqqxxqtz(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        struct _MCGEN_TRACE_CONTEXT *a11)
{
  ...
  struct _MCGEN_TRACE_CONTEXT *v31; // [rsp+C0h] [rbp-1h]
  ...
  if ( a11 )
  {
    ...
    do
      ++v12;
    while ( *((_WORD *)&a11->RegistrationHandle + v12) );
    v13 = 2 * v12 + 2;
  }
  else
  {
  ...
  v31 = v11;
  return McGenEventWrite(v11, &DCompCreateImplicitInteraction, (LPCGUID)&Context.Flags, 9u, &EventData);
}
