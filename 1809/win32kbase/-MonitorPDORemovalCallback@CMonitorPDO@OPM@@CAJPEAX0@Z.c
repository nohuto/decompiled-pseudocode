/*
 * XREFs of ?MonitorPDORemovalCallback@CMonitorPDO@OPM@@CAJPEAX0@Z @ 0x1C00F6400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall OPM::CMonitorPDO::MonitorPDORemovalCallback(_QWORD *NotificationStructure, PVOID Context)
{
  ...
  v4 = 0x11D046F0CB3A4006LL - v3;
  if ( v3 == 0x11D046F0CB3A4006LL )
    v4 = 0x3F05139760008FB0LL - *(_QWORD *)((char *)NotificationStructure + 12);
  if ( !v4 )
    goto LABEL_7;
