/*
 * XREFs of ?FilterKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C0131560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FilterKeys(struct tagKE *a1, unsigned int a2, __int64 a3)
{
  ...
  if ( v4 == -95 )
  {
    ...
    else if ( gPhysModifierState == 2 && (dword_1C01CC99C & 4) != 0 && !gtmridFKActivation && gFilterKeysState != 8 )
    {
      gFilterKeysState = 1;
...
LABEL_19:
  ...
  {
    gBounceVk = v4;
    gtmridFKResponse = ApiSetEditionSetAccessibilityTimer(0LL, dword_1C01CC9AC, FKBounceKeyTimer);
