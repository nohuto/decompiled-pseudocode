/*
 * XREFs of ?EmitCreationCommand@CHostVisualMarshaler@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1C008B140
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CHostVisualMarshaler::EmitCreationCommand(
