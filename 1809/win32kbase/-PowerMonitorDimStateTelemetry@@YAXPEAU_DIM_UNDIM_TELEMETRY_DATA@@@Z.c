/*
 * XREFs of ?PowerMonitorDimStateTelemetry@@YAXPEAU_DIM_UNDIM_TELEMETRY_DATA@@@Z @ 0x1C00A8BF0
 * Callers:
...
LABEL_9:
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C3348, 0x400000000100uLL) )
    {
      v14 = &v12;
      v16 = &v10;
      ...
      v18 = &v5;
      v20 = &v6;
      v6 = LODWORD(WPP_MAIN_CB.Dpc.SystemArgument2) != v4;
      v7 = v2[4];
      v22 = &v7;
      v8 = v2[5];
      v24 = &v8;
      ...
      v27 = 1LL;
      v29 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C3348, &unk_1C019D59F, 0LL, 0LL, 0xAu, &pData);
    }
  }
}
