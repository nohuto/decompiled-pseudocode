/*
 * XREFs of ?UnregisterObject@RegistrarClient@CoreMessagingK@@SAJPEBG@Z @ 0x1C0084680
 * Callers:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::UnregisterObject(LPCWSTR pwsz)
{
  ...
  v11 = 1uLL;
  v12 = 0LL;
  v2 = CoreUICallSend((struct IMessageCallSendHost *)&v8, (__int64)&v7, 1u, 1u, 9u, byte_1C019437B, pwsz, &v11, v6);
  if ( v2 < 0 )
  ...
  if ( dword_1C01C77B8 > 5u )
  {
    ...
    v15 = &v7;
    v16 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C77B8, &unk_1C01A341B, 0LL, 0LL, 4u, &pData);
  }
  return v4;
}
