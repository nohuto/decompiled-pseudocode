/*
 * XREFs of ?SetIntegerProperty@CLinearTransferEffectMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C017F9C0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  {
    case 2:
      *a5 = v6 ^ *((_BYTE *)this + 128) & 1;
      v9 = *((_BYTE *)this + 128) & 0xFE;
      break;
    case 5:
      v12 = v6 ^ ((*((_BYTE *)this + 128) & 2) != 0);
      v6 *= 2;
      *a5 = v12;
      v9 = *((_BYTE *)this + 128) & 0xFD;
      break;
    case 8:
      v11 = v6 ^ ((*((_BYTE *)this + 128) & 8) != 0);
      v6 *= 8;
      *a5 = v11;
      v9 = *((_BYTE *)this + 128) & 0xF7;
      break;
    case 11:
      v10 = v6 ^ ((*((_BYTE *)this + 128) & 4) != 0);
      v6 *= 4;
      *a5 = v10;
      v9 = *((_BYTE *)this + 128) & 0xFB;
      break;
    case 12:
      v8 = v6 ^ ((*((_BYTE *)this + 128) & 0x10) != 0);
      v6 *= 16;
      *a5 = v8;
      v9 = *((_BYTE *)this + 128) & 0xEF;
      break;
    default:
      return DirectComposition::CFilterEffectMarshaler::SetIntegerProperty(this, a2, a3, a4, a5);
  }
  *((_BYTE *)this + 128) = v9 | v6;
  return 0LL;
}
