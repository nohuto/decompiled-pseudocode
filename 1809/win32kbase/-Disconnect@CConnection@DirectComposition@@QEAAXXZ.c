/*
 * XREFs of ?Disconnect@CConnection@DirectComposition@@QEAAXXZ @ 0x1C0059AF8
 * Callers:
 ...
 *     ?GetNewBatches@CConnection@DirectComposition@@QEAAXPEAPEAVCBatch@2@@Z @ 0x1C005A7EC (-GetNewBatches@CConnection@DirectComposition@@QEAAXPEAPEAVCBatch@2@@Z.c)
...
void __fastcall DirectComposition::CConnection::Disconnect(DirectComposition::CConnection *this)
{
  ...
  *((_QWORD *)this + 17) = 0LL;
  ...
  DirectComposition::CConnection::GetNewBatches(this, &v22);
  v9 = v22;
  if ( v22 )
  {
    do
