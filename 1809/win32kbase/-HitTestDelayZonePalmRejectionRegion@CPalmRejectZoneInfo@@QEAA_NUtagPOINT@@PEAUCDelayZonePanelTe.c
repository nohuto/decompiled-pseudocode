/*
 * XREFs of ?HitTestDelayZonePalmRejectionRegion@CPalmRejectZoneInfo@@QEAA_NUtagPOINT@@PEAUCDelayZonePanelTelemetryData@@@Z @ 0x1C014FA58
 * Callers:
 ...
 *     ?GetDelayZoneRectFromInputRect@CPalmRejectZoneInfo@@AEAA?AUtagRECT@@U2@J@Z @ 0x1C014F8D0 (-GetDelayZoneRectFromInputRect@CPalmRejectZoneInfo@@AEAA-AUtagRECT@@U2@J@Z.c)
