/*
 * XREFs of RIMGetPnpActionBitsFromGuid @ 0x1C0124494
 * Callers:
...
_DWORD *__fastcall RIMGetPnpActionBitsFromGuid(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4, _DWORD *a5, _DWORD *a6)
{
  ...
  v7 = *(_QWORD *)a3 - 0x11D046F0CB3A4006LL;
  if ( *(_QWORD *)a3 == 0x11D046F0CB3A4006LL )
    v7 = *(_QWORD *)(a3 + 8) - 0x3F05139760008FB0LL;
  if ( !v7 )
  {
  ...
  if ( !v9 )
  {
    WPP_RECORDER_SF_qq(gRimLog, 3u, 0x15u, 0xBu, (__int64)&WPP_e843b24bce37371af6d7cbb9fb8661d0_Traceguids, a1, a2);
    result = a5;
LABEL_13:
    *result = 1;
    return result;
  ...
  if ( !v10 )
  {
    WPP_RECORDER_SF_qq(gRimLog, 3u, 0x15u, 0xCu, (__int64)&WPP_e843b24bce37371af6d7cbb9fb8661d0_Traceguids, a1, a2);
    result = a6;
    goto LABEL_13;
  }
