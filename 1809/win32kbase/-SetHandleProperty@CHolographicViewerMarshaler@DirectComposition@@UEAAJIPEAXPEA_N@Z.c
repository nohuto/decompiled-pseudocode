/*
 * XREFs of ?SetHandleProperty@CHolographicViewerMarshaler@DirectComposition@@UEAAJIPEAXPEA_N@Z @ 0x1C017D440
 * Callers:
 *     <none>
 * Callees:
 *     CallerHasScreenDuplicationCapability @ 0x1C017D158 (CallerHasScreenDuplicationCapability.c)
 */
