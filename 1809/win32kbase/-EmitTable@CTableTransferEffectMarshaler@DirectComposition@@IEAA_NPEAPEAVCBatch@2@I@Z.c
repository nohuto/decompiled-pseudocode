/*
 * XREFs of ?EmitTable@CTableTransferEffectMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@I@Z @ 0x1C0175650
 * Callers:
 *     ?EmitUpdateCommands@CTableTransferEffectMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0175780 (-EmitUpdateCommands@CTableTransferEffectMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( *((_DWORD *)this + 4 * a3 + 27) < *((_DWORD *)this + 4 * a3 + 26) )
  {
    do
    {
      v7 = 4096LL - *((_QWORD *)(*a2)[17] + 5);
      v11 = v7;
      if ( v7 < 0x18 )
      {
        if ( !DirectComposition::CBatch::AllocateNewFragment(a2, &v11) )
          return *((_DWORD *)this + 2 * v4 + 27) == *((_DWORD *)this + 2 * v4 + 26);
        v7 = v11;
      }
      v8 = (unsigned int)(*((_DWORD *)this + 2 * v4 + 26) - *((_DWORD *)this + 2 * v4 + 27));
      if ( v8 >= (v7 - 20) >> 2 )
        LODWORD(v8) = (v7 - 20) >> 2;
      ...
      *((_DWORD *)v9 + 4) = v5;
      *((_DWORD *)v9 + 3) = *((_DWORD *)this + 2 * v4 + 27) != 0;
      memmove(
        v9 + 20,
        (const void *)(*((_QWORD *)this + 2 * v5 + 12) + 4LL * *((unsigned int *)this + 2 * v4 + 27)),
        (unsigned int)(4 * v8));
      *((_DWORD *)this + 2 * v4 + 27) += v8;
    }
    while ( *((_DWORD *)this + 2 * v4 + 27) < *((_DWORD *)this + 2 * v4 + 26) );
  }
  return *((_DWORD *)this + 2 * v4 + 27) == *((_DWORD *)this + 2 * v4 + 26);
}
