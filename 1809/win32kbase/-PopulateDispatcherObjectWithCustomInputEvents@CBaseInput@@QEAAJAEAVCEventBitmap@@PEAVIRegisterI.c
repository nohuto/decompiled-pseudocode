/*
 * XREFs of ?PopulateDispatcherObjectWithCustomInputEvents@CBaseInput@@QEAAJAEAVCEventBitmap@@PEAVIRegisterInputDispatcherObjects@@@Z @ 0x1C014A030
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IRegisterInputDispatcherObjects *a3)
{
  ...
  *(_DWORD *)a2 = 0;
  ...
  {
    if ( (v3 & 1) != 0 && CRIMBase::IsDispatcherObjectValid(this, v6, (__int64)a3) )
    {
