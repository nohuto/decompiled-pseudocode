/*
 * XREFs of ?GenerateMessage@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@G_KIPEAUHWND__@@@Z @ 0x1C0139FC8
 * Callers:
        ...
        HWND a5)
{
  ...
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
    {
      ...
      v25 = 4LL;
      v27 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C01A0352, 0LL, 0LL, 9u, &pData);
    }
  }
}
