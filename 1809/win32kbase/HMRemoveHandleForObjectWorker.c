/*
 * XREFs of HMRemoveHandleForObjectWorker @ 0x1C006587C
 * Callers:
...
__int64 __fastcall HMRemoveHandleForObjectWorker(_BYTE *a1)
{
  ...
  v3 = (unsigned int)((a1 - (_BYTE *)qword_1C01CBA58) >> 5);
  v4 = 3 * v3;
  if ( (a1[25] & 0x20) != 0 )
  {
  ...
  if ( v5 != -1 )
    v6 = v5;
  *((_WORD *)a1 + 13) = v6;
  v7 = (a1 - (_BYTE *)qword_1C01CBA58) >> 5;
  if ( (v7 & 1) != 0 )
  {
    *((_QWORD *)gpKernelHandleTable + 3 * v7) = qword_1C01CCB30;
    qword_1C01CCB30 = v7;
  }
  else
  {
    *((_QWORD *)gpKernelHandleTable + 3 * v7) = qword_1C01CCB28;
    qword_1C01CCB28 = v7;
  }
  return 1LL;
}
