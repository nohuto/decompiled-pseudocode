/*
 * XREFs of ??1CritAcquire@Perf@InputTraceLogging@@QEAA@XZ @ 0x1C0028A40
 * Callers:
...
void __fastcall InputTraceLogging::Perf::CritAcquire::~CritAcquire(InputTraceLogging::Perf::CritAcquire *this)
{
  ...
  __int64 v3; // rax
  unsigned int v4; // r9d
  int v5; // [rsp+30h] [rbp-C8h] BYREF
  int v6; // [rsp+34h] [rbp-C4h] BYREF
  int v7; // [rsp+38h] [rbp-C0h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+40h] [rbp-B8h] BYREF
  struct _EVENT_DATA_DESCRIPTOR pDesc; // [rsp+60h] [rbp-98h] BYREF
  int *v10; // [rsp+70h] [rbp-88h]
  __int64 v11; // [rsp+78h] [rbp-80h]
  int *v12; // [rsp+80h] [rbp-78h]
  __int64 v13; // [rsp+88h] [rbp-70h]
  EVENT_DATA_DESCRIPTOR v14; // [rsp+90h] [rbp-68h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v15; // [rsp+B0h] [rbp-48h] BYREF
  int *v16; // [rsp+C0h] [rbp-38h]
  __int64 v17; // [rsp+C8h] [rbp-30h]
  int *v18; // [rsp+D0h] [rbp-28h]
  ...
  if ( LOBYTE(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink) )
  {
    if ( *(_QWORD *)this )
    {
      v2 = *(_DWORD *)(*(_QWORD *)this + 24LL);
      v3 = *(_QWORD *)this;
      v5 = v2;
      if ( *(_DWORD *)(v3 + 48) || v2 > 0 )
      {
        *(_DWORD *)(v3 + 44) = 1;
        *(_OWORD *)(*(_QWORD *)this + 28LL) = *(_OWORD *)((char *)this + 12);
        if ( dword_1C01C7F10 > 6u )
        {
          ...
          {
            TlgCreateWsz(&pDesc, L"AcquiredCrit");
