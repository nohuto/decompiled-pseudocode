/*
 * XREFs of ?CreateProtectedOutput@COPM@@QEAAJW4_DXGKMDT_OPM_VIDEO_OUTPUT_SEMANTICS@@AEAU_LUID@@KPEAPEAXPEAH@Z @ 0x1C00A175C
 * Callers:
        ...
        int *a6)
{
  ...
  *a6 = 0;
  ...
  if ( v15 )
  {
    if ( v12 >= 0 )
    {
      v12 = OPM::CList<COPMProtectedOutput>::AddElement((char *)v6 + 24, v15, &v18);
      if ( v12 >= 0 )
      {
