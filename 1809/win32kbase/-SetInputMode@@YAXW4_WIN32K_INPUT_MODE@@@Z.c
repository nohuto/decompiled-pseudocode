/*
 * XREFs of ?SetInputMode@@YAXW4_WIN32K_INPUT_MODE@@@Z @ 0x1C00E1A40
 * Callers:
...
void __fastcall SetInputMode(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v13; // r8
  __int64 *v14; // rdi
  tagObjLock *v15; // [rsp+20h] [rbp-38h] BYREF
  ...
  InputTraceLogging::Perf::CritAcquire::CritAcquire((InputTraceLogging::Perf::CritAcquire *)v16, 1);
