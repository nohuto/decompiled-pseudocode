/*
 * XREFs of ?SetRemarshalingFlags@CTranslateTransform3DMarshaler@DirectComposition@@MEAA_NXZ @ 0x1C017B1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        DirectComposition::CTranslateTransform3DMarshaler *this)
{
  ...
  v3 = 0;
  if ( v2 || *((float *)this + 14) != 0.0 || *((float *)this + 15) != 0.0 || *((float *)this + 16) != 0.0 )
    return 1;
  return v3;
}
