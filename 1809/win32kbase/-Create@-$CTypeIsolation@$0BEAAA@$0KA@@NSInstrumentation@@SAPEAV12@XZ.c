/*
 * XREFs of ?Create@?$CTypeIsolation@$0BEAAA@$0KA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C0066DE0
 * Callers:
...
_QWORD *NSInstrumentation::CTypeIsolation<81920,160>::Create()
{
  ...
  *PoolWithTag = PoolWithTag;
  ...
  v1[2] = v2;
  if ( !v2 || (*v2 = 0LL, (v3 = (_QWORD *)NSInstrumentation::CSectionEntry<81920,160>::Create()) == 0LL) )
  {
    v6 = (void *)v1[2];
    if ( !v6 )
      goto LABEL_10;
