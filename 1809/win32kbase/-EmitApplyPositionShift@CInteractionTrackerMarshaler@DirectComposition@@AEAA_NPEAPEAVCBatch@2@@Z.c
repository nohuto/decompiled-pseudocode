/*
 * XREFs of ?EmitApplyPositionShift@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C016EBCC
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 99) < *((_DWORD *)this + 98); *((_DWORD *)this + 99) += v5 )
  {
    ...
    v5 = (unsigned int)(*((_DWORD *)this + 98) - *((_DWORD *)this + 99));
    if ( v5 >= (v4 - 16) / 0xC )
    ...
    *((_DWORD *)v6 + 2) = *((_DWORD *)this + 6);
    ...
    {
      v9 = (_QWORD *)*((_QWORD *)this + 48);
      v10 = v7 + *((_DWORD *)this + 99);
      ++v7;
      v11 = v9[4] * v10;
      v12 = *(_DWORD *)(v11 + *v9 + 8);
  ...
  if ( v13 == v14 )
  {
    ...
    *((_DWORD *)this + 99) = 0;
    ...
    if ( *((_QWORD *)this + 48) )
    {
      DirectComposition::CDCompDynamicArray<PositionShift>::`scalar deleting destructor'(*((__int64 **)this + 48));
      v16 = *((_DWORD *)this + 99);
      v17 = *((_DWORD *)this + 98);
    }
    *((_QWORD *)this + 48) = 0LL;
