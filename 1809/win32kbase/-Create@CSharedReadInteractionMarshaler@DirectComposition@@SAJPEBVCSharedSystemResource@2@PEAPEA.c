/*
 * XREFs of ?Create@CSharedReadInteractionMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00831B8
 * Callers:
 *     CreateSharedReadInteractionMarshaler @ 0x1C0083180 (CreateSharedReadInteractionMarshaler.c)
 * Callees:
