/*
 * XREFs of ?LogDeviceRemovedEvent@CHidInput@@AEAAXGIIKKHPEAU_UNICODE_STRING@@0@Z @ 0x1C014CA7C
 * Callers:
        ...
        struct _UNICODE_STRING *a9)
{
  ...
  if ( hProvider > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v29 = 2LL;
      v31[1] = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01A0D9E, 0LL, 0LL, 0xCu, &pData);
    }
  }
}
