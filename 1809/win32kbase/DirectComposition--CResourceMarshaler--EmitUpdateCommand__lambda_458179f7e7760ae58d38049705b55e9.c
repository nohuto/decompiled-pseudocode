/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_458179f7e7760ae58d38049705b55e9e___ @ 0x1C0170F88
 * Callers:
...
char __fastcall DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_458179f7e7760ae58d38049705b55e9e___(
        __int64 a1,
        ...
        __int64 a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(a1 + 24);
  result = 1;
  *((_DWORD *)v5 + 3) = *(unsigned __int8 *)(*(_QWORD *)a3 + 72LL);
  return result;
}
