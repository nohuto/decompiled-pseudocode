/*
 * XREFs of WPP_RECORDER_SF_qdqd @ 0x1C01487C8
 * Callers:
...
__int64 WPP_RECORDER_SF_qdqd(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 4LL, 12LL, &WPP_34edb07bf13d308a4f9f363aca43f10b_Traceguids, v8, (__int64 *)va);
}
