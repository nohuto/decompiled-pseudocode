/*
 * XREFs of ?UninitializeThreadInfoIocp@@YAXPEAUtagTHREADINFO@@@Z @ 0x1C00151C0
 * Callers:
...
void __fastcall UninitializeThreadInfoIocp(struct tagTHREADINFO *a1, __int64 a2)
{
  ...
  v3 = (void *)*((_QWORD *)a1 + 179);
  if ( v3 )
  {
    ObCloseHandle(v3, 0);
    *((_QWORD *)a1 + 179) = 0LL;
  }
  v4 = (void *)*((_QWORD *)a1 + 178);
  if ( v4 )
  {
    ObCloseHandle(v4, 0);
    *((_QWORD *)a1 + 178) = 0LL;
  ...
  if ( v5 )
  {
    if ( (int)ProtectHandle(v5, a2, 0LL, 0LL) >= 0 )
      ObCloseHandle(*((HANDLE *)a1 + 176), 1);
    *((_QWORD *)a1 + 176) = 0LL;
  }
  v6 = (void *)*((_QWORD *)a1 + 175);
  if ( v6 )
  {
    ObCloseHandle(v6, 0);
    *((_QWORD *)a1 + 175) = 0LL;
  }
  v7 = (void *)*((_QWORD *)a1 + 174);
  if ( v7 )
  {
