/*
 * XREFs of McTemplateK0qqxx @ 0x1C00EB020
 * Callers:
 *     EtwGdiSysMemToken @ 0x1C0087980 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x1C00E8030 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
