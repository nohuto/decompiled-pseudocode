/*
 * XREFs of ?EmitRoot@CRemotingRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C016D5F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CRemotingRenderTargetMarshaler::EmitRoot(
