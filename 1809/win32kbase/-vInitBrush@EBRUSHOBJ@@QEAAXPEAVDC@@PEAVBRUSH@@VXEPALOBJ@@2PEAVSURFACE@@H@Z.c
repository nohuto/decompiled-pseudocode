/*
 * XREFs of ?vInitBrush@EBRUSHOBJ@@QEAAXPEAVDC@@PEAVBRUSH@@VXEPALOBJ@@2PEAVSURFACE@@H@Z @ 0x1C005D300
 * Callers:
 ...
 *     rgbFromColorref @ 0x1C005D710 (rgbFromColorref.c)
 *     ?ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z @ 0x1C005D754 (-ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z.c)
...
LABEL_52:
          ...
          if ( *a1 == -1 && !v26 )
          {
            ...
            {
              if ( (!v7 || v7 == *(_QWORD *)(v27 + 1808))
                && (result = *(unsigned int *)(v27 + 1824), (result & 0x20) != 0)
                || (result = XEPALOBJ::bIsMonochrome((XEPALOBJ *)&a5), (_DWORD)result)
                && (*(_DWORD *)(v27 + 1824) & 0x400) != 0 )
              {
                v34 = a1[6];
                goto LABEL_45;
              }
