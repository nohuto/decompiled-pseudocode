/*
 * XREFs of ?Create@CSharedReadPrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01816AC
 * Callers:
 *     CreateSharedReadPrimitiveColorMarshaler @ 0x1C01818D0 (CreateSharedReadPrimitiveColorMarshaler.c)
 * Callees:
