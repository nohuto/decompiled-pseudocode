/*
 * XREFs of ?EmitUpdateCommands@CFilterEffectMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0173EF0
 * Callers:
 *     <none>
 * Callees:
...
{
  return DirectComposition::CEffectInputSet::EmitUpdateCommands((char *)this + 56, a2, *((unsigned int *)this + 6), a2);
}
