/*
 * XREFs of ?createrec@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@PEAU_POINTFIX@@@Z @ 0x1C0069854
 * Callers:
 *     ?addpoints@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@@Z @ 0x1C006978C (-addpoints@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@@Z.c)
 ...
 *     ?vInclude@ERECTFX@@QEAAXAEAU_POINTFIX@@@Z @ 0x1C009F778 (-vInclude@ERECTFX@@QEAAXAEAU_POINTFIX@@@Z.c)
 *     newpathalloc @ 0x1C009FF80 (newpathalloc.c)
 *     memmove @ 0x1C00AF880 (memmove.c)
 *     ?reinit@EPATHOBJ@@IEAAXXZ @ 0x1C00F7270 (-reinit@EPATHOBJ@@IEAAXXZ.c)
 *     ?vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z @ 0x1C00F7304 (-vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z.c)
 */
