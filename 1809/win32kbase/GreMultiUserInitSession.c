/*
 * XREFs of GreMultiUserInitSession @ 0x1C0099A20
 * Callers:
        ...
        unsigned __int16 *a11)
{
  ...
  *(_QWORD *)(a1 + 24) = a2;
  ...
  v15 = (unsigned __int16 *)Win32AllocPool(2 * v14, 0x79737355u);
  *(_QWORD *)(a1 + 40) = v15;
  if ( v15 )
  {
  ...
  if ( v16 )
    Win32FreePool(v16);
  v17 = (unsigned __int16 *)Win32AllocPool(2LL * (unsigned int)(a10 + 1), 0x79737355u);
  *(_QWORD *)(a1 + 56) = v17;
  if ( v17 )
  {
