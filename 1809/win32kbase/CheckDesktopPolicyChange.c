/*
 * XREFs of CheckDesktopPolicyChange @ 0x1C00E4C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CheckDesktopPolicyChange(const UNICODE_STRING *a1)
{
  ...
  gdwPolicyFlags = v6;
  if ( qword_1C01D1F00 != KeyInformation[0] )
  {
    qword_1C01D1F00 = KeyInformation[0];
    v1 = 1;
  }
  KeyInformation[0] = 0LL;
  v9 = 2;
  ...
  gdwPolicyFlags = v8;
  if ( qword_1C01D1F08 != KeyInformation[0] )
  {
    qword_1C01D1F08 = KeyInformation[0];
    return 1;
  }
  return v1;
}
