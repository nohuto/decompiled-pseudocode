/*
 * XREFs of ?SendWheelToUserMode@Mouse@InputTraceLogging@@SAX_K@Z @ 0x1C015988C
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::SendWheelToUserMode()
{
  __int64 v0; // r9
  ...
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x40uLL) )
    {
      ...
      v1 = v0;
      v4 = 8;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C01A199A, 0LL, 0LL, 3u, &pData);
    }
  }
}
