/*
 * XREFs of ?UnregisterAlpcPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@@Z @ 0x1C0084484
 * Callers:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::UnregisterAlpcPort(const struct _GUID *a1)
{
  ...
  v9 = v1;
  v3 = CoreUICallSend((struct IMessageCallSendHost *)&v8, (__int64)&v7, 1u, 1u, 0xBu, byte_1C0194322, &v9);
  if ( v3 < 0 )
  {
  ...
  if ( dword_1C01C77B8 > 5u )
  {
    ...
    v11 = a1;
    v12 = 16;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C77B8, &unk_1C01A348B, 0LL, 0LL, 4u, &pData);
  }
  return v5;
}
