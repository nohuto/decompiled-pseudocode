/*
 * XREFs of ?SetBufferProperty@CKeyframeAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C0072370
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
        ...
        while ( 1 )
        {
          ...
          if ( !v18
            || (*(unsigned int (__fastcall **)(DirectComposition::CResourceMarshaler *))(*(_QWORD *)v18 + 16LL))(v18) != 136 )
          {
            break;
          }
