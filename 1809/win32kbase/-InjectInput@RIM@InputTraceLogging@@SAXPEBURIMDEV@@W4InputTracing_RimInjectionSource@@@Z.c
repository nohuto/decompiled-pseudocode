/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@@Z @ 0x1C011CD70
 * Callers:
 ...
 *     ?InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z @ 0x1C011D070 (-InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z.c)
 */
  ...
  if ( v4 == 2 )
  {
    if ( (*(_DWORD *)(a1 + 200) & 0x80u) == 0 )
    {
      if ( dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
      {
        ...
        *(_QWORD *)&v34.Size = v20;
        ...
        v35 = &v27;
        v36 = v20;
        TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019EFDB, 0LL, 0LL, 6u, &pData);
      }
    }
    else if ( dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
    {
      ...
      *(_QWORD *)&v32.Size = 8LL;
      ...
      v38 = v9;
      v14 = *(_DWORD *)(v13 + 308);
      if ( (v14 & 0x20) == 0 || (v15 = v9 - 3, (v14 & 0x8000) != 0) )
        v15 = v10;
      v28 = v15;
      v39 = &v28;
      v40 = v9;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019EF6D, 0LL, 0LL, 8u, &pData);
    }
  }
  else if ( v4 )
  {
    if ( v4 == 1 && dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
    {
      ...
      *(_QWORD *)&pDesc.Size = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019F057, 0LL, 0LL, v26, &pData);
    }
  }
  else if ( dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
  {
    ...
    pDesc.Ptr = (ULONGLONG)&v29;
    *(_QWORD *)&pDesc.Size = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019F021, 0LL, 0LL, cData, &pData);
  }
}
