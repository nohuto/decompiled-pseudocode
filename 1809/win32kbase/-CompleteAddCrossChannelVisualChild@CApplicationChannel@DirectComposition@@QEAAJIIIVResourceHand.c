/*
 * XREFs of ?CompleteAddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIIVResourceHandle@@HI0@Z @ 0x1C000191C
 * Callers:
...
LABEL_35:
  ...
  if ( a5 )
  {
    v16 = (DirectComposition::CVisualMarshaler *)Win32AllocPoolWithQuotaZInit(0x168uLL);
    v17 = v16;
    if ( v16 )
    {
      memset(v16, 0, 0x168uLL);
    ...
    {
      (*(void (__fastcall **)(DirectComposition::CVisualMarshaler *, DirectComposition::CApplicationChannel *))(*(_QWORD *)v17 + 112LL))(
        v17,
        a1);
      (*(void (__fastcall **)(DirectComposition::CVisualMarshaler *, __int64))(*(_QWORD *)v17 + 104LL))(v17, 1LL);
    }
    else
    {
      v10 = v17;
