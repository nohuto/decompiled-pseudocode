/*
 * XREFs of ?vReferencePdev@PDEVOBJ@@QEAAXXZ @ 0x1C003F3D0
 * Callers:
...
void __fastcall PDEVOBJ::vReferencePdev(PDEVOBJ *this, __int64 a2, __int64 a3)
{
  ...
  v5 = *(_QWORD *)this;
  ++*(_DWORD *)(v5 + 8);
  v6 = *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v5 + 3552);
  v7 = qword_1C01C8838;
  if ( v6 && qword_1C01C8838 )
    NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C01C8838, v6, 1);
  if ( v3 )
  {
    if ( gbLockEtw )
    {
      if ( ((unsigned __int8)Microsoft_Windows_Win32kEnableBits & 0x10) != 0 )
        McTemplateK0pz(v7, &LockRelease, a3, v3, L"hsem");
    }
