/*
 * XREFs of ??$AddProperty@UD2DQuaternion@@@?$PropertySetStorage@VCDynamicArrayDefaultTag@@VPropertySetKernelModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DQuaternion@@PEAI@Z @ 0x1C016CAA0
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *a4 = -1;
  ...
  if ( (int)result >= 0 )
  {
    if ( (int)CDynamicArray<unsigned char,2003858261>::Grow((_QWORD *)(a1 + 16), 0x10u) >= 0 )
    {
      *(_DWORD *)(a1 + 24) += 16;
      v11 = *(_QWORD *)(a1 + 16);
      v12 = *a3;
