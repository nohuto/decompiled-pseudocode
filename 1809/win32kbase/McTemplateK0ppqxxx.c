/*
 * XREFs of McTemplateK0ppqxxx @ 0x1C00E9F58
 * Callers:
 *     EtwTraceTokenCompositionSurfaceObjectEvent @ 0x1C0081420 (EtwTraceTokenCompositionSurfaceObjectEvent.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0050EB8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00A63D0 (__security_check_cookie.c)
 */

ULONG McTemplateK0ppqxxx(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite(a1, &TokenCompositionSurfaceObjectEvent, (LPCGUID)&Context.Flags, 7u, &EventData);
}
