/*
 * XREFs of ??0CInpLockGuardShared@@QEAA@AEAUCInpLockGuard@@@Z @ 0x1C0132F34
 * Callers:
 ...
 *     ?IsPointerPrimary@CTouchProcessor@@QEAAH_K@Z @ 0x1C013F360 (-IsPointerPrimary@CTouchProcessor@@QEAAH_K@Z.c)
 * Callees:
