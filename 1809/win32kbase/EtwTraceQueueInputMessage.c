/*
 * XREFs of EtwTraceQueueInputMessage @ 0x1C0068B24
 * Callers:
...
_UNKNOWN **__fastcall EtwTraceQueueInputMessage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 96) )
  {
    if ( (BYTE1(Microsoft_Windows_Win32kEnableBits) & 0x40) != 0 )
    {
      if ( W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) )
        v11 = *(_BYTE *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 1224);
      else
        v11 = -1;
      LOBYTE(v10) = v11;
  ...
  {
    if ( W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) )
      v3 = *(_BYTE *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 1224);
    else
      v3 = -1;
    v4 = *(_DWORD *)(a1 + 100);
    v5 = -__CFSHR__(v4, 8);
