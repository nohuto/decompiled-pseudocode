/*
 * XREFs of ?ScaleOverrideTestHookCore@DpiInternal@@YAXQEBGPEAK@Z @ 0x1C00A481C
 * Callers:
...
void __fastcall DpiInternal::ScaleOverrideTestHookCore(DpiInternal *this, unsigned __int16 *a2, unsigned int *a3)
{
  ...
  unsigned __int16 v37[16]; // [rsp+F0h] [rbp-10h] BYREF
  unsigned __int16 v38[80]; // [rsp+110h] [rbp+10h] BYREF
  ...
  *(_DWORD *)a2 = 0;
  ...
  v10 = v6 & 0x7FFFFFFF;
  v11 = RtlStringCbPrintfW(v37, 0x16uLL, (size_t *)L"%d", v10);
  v15 = v11;
  if ( v11 < 0
