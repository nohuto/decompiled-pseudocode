/*
 * XREFs of ?GetDeferredBatches@CConnection@DirectComposition@@AEAA_N_KPEAPEAVCBatch@2@1@Z @ 0x1C01678A4
 * Callers:
        ...
        struct DirectComposition::CBatch **a4)
{
  ...
  do
  {
    ...
    if ( *(_BYTE *)(v9 + 49) )
    {
      if ( (*(_BYTE *)(v9 + 241) & 0x10) != 0 )
      {
        v10 = *(LARGE_INTEGER **)(v9 + 720);
        v10[6] = a2;
        v10[7] = KeQueryPerformanceCounter(0LL);
      }
      *(_BYTE *)(v9 + 49) = 0;
    }
    v11 = v4;
