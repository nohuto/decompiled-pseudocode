/*
 * XREFs of ?EmitSetRequestedPositionWithDefaultAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C016F948
 * Callers:
...
char __fastcall DirectComposition::CInteractionTrackerMarshaler::EmitSetRequestedPositionWithDefaultAnimation(
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 110) & 2) == 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x18uLL, &v6) )
    {
      ...
      *((_DWORD *)v4 + 3) = *((_DWORD *)this + 47);
      *((_DWORD *)v4 + 4) = *((_DWORD *)this + 48);
