/*
 * XREFs of RIMFixUpCompleteFrame @ 0x1C012335C
 * Callers:
...
__int64 __fastcall RIMFixUpCompleteFrame(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  v4 = *(_DWORD *)(a1 + 656);
  v8 = 0;
  WPP_RECORDER_SF_(gRimLog, 3u, 0x15u, 0x3Au, (__int64)&WPP_337bdb1c4c3536b074bd792c3d4c53de_Traceguids);
  if ( v4 == 1 )
  ...
  return WPP_RECORDER_SF_(gRimLog, 3u, 0x15u, 0x3Bu, (__int64)&WPP_337bdb1c4c3536b074bd792c3d4c53de_Traceguids);
}
