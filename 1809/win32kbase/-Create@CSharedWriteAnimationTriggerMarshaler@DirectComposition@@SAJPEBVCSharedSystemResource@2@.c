/*
 * XREFs of ?Create@CSharedWriteAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00038E8
 * Callers:
 *     CreateSharedWriteAnimationTriggerMarshaler @ 0x1C00038B0 (CreateSharedWriteAnimationTriggerMarshaler.c)
 * Callees:
