/*
 * XREFs of ?CheckAndUpdateLastPointerPositionEffectsTimestamp@CSpatialProcessor@@AEAA_N_K@Z @ 0x1C00888E0
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( a2 - *((_QWORD *)this + 5) <= PerformanceFrequency.QuadPart / 0x1EuLL )
    return 0;
  *((_QWORD *)this + 5) = a2;
  return 1;
}
