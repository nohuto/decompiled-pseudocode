/*
 * XREFs of ??$AddProperty@M@?$PropertySetStorage@VCDynamicArrayDefaultTag@@VPropertySetKernelModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBMPEAI@Z @ 0x1C016C924
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *a4 = -1;
  ...
  if ( (int)result >= 0 )
  {
    if ( (int)CDynamicArray<unsigned char,2003858261>::Grow((_QWORD *)(a1 + 16), 4u) >= 0 )
    {
      *(_DWORD *)(a1 + 24) += 4;
      v11 = *a3;
      v12 = *(_QWORD *)(a1 + 16);
