/*
 * XREFs of ?ldevFillTable@@YAHPEAU_LDEV@@PEAUtagDRVENABLEDATA@@W4_LDEVTYPE@@@Z @ 0x1C0056C40
 * Callers:
  ...
  *(_DWORD *)(a1 + 56) = v4;
  if ( bFillFunctionTable(v3, v5, (__int64 (**)(void))(a1 + 64)) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !*(_QWORD *)(a1 + 8LL * (unsigned int)dword_1C019CD20[v6] + 64) )
        break;
      if ( !(_DWORD)v6 )
      {
        if ( *(_DWORD *)(a1 + 24) == 6 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( !*(_QWORD *)(a1 + 8LL * (unsigned int)dword_1C01A5D58[v9] + 64) )
              break;
            if ( !(_DWORD)v9 )
              goto LABEL_6;
          }
...
LABEL_6:
          ...
          while ( 1 )
          {
            ...
            if ( (*(_QWORD *)(a1 + 8LL * (unsigned int)dword_1C019CD10[2 * v7] + 64) == 0LL) != (*(_QWORD *)(a1 + 8LL * (unsigned int)dword_1C019CD14[2 * v7] + 64) == 0LL) )
              break;
            if ( !(_DWORD)v7 )
              return 1LL;
          }
