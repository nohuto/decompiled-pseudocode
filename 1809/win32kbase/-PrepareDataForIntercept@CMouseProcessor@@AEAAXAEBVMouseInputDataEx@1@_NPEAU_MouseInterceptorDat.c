/*
 * XREFs of ?PrepareDataForIntercept@CMouseProcessor@@AEAAXAEBVMouseInputDataEx@1@_NPEAU_MouseInterceptorData@@@Z @ 0x1C0158964
 * Callers:
        ...
        struct _MouseInterceptorData *a4)
{
  ...
  *(_QWORD *)a4 = v8;
  if ( !v8 )
    MicrosoftTelemetryAssertTriggeredMsgKM("This is mouse input intercept. Expected for the scenarios it is used we always have device handle");
