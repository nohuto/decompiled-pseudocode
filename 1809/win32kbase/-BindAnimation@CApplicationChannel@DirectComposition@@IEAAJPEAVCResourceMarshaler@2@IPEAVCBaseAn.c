/*
 * XREFs of ?BindAnimation@CApplicationChannel@DirectComposition@@IEAAJPEAVCResourceMarshaler@2@IPEAVCBaseAnimation@2@@Z @ 0x1C0071CBC
 * Callers:
 ...
 *     ?FindAnimationBindings@CResourceMarshaler@DirectComposition@@QEAAXIPEAPEAVCAnimationBinding@2@00@Z @ 0x1C0071EBC (-FindAnimationBindings@CResourceMarshaler@DirectComposition@@QEAAXIPEAPEAVCAnimationBinding@2@00.c)
 ...
 *     ?GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z @ 0x1C01750F4 (-GetAnimationTimeState@CAnimationMarshaler@DirectComposition@@IEAAXPEA_NPEA_JPEA_K@Z.c)
 */
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v12 + 120LL))(v12, 2LL) )
  {
    ...
    if ( v4 && *(_DWORD *)(v4 + 164) )
    {
      ...
      if ( v29
        ...
        && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v21 + 120LL))(v21, 130LL) )
      {
        v23 = v20[10];
      }
      else
      ...
      {
        v22 = v20 - 4;
        if ( *(_QWORD *)(v4 + 176) || (*(_DWORD *)(v4 + 32) & 0x1000) != 0 || v22 == (_DWORD *)v4 )
        ...
        if ( v22 )
        {
          ...
          *(_BYTE *)(v4 + 208) ^= ((unsigned __int8)v29 ^ *(_BYTE *)(v4 + 208)) & 1;
          v22[8] |= 0x1000u;
        }
      }
      v5 = a3;
