/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0080EE0
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C0080EA0 (CreateSharedReadTransformMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadTransformMarshaler **a2)
{
  ...
  v4 = (struct DirectComposition::CSharedReadTransformMarshaler *)Win32AllocPoolWithQuotaZInit(0x38uLL, 0x756D4344u);
  v5 = v4;
  if ( v4 )
  {
    memset(v4, 0, 0x38uLL);
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CSharedReadTransformMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 248LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
