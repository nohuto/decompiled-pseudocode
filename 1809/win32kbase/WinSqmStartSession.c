/*
 * XREFs of WinSqmStartSession @ 0x1C009018C
 * Callers:
...
__int64 WinSqmStartSession()
{
  ...
  if ( (dword_1C01CD5A0 & 2) == 0 && (unsigned int)IsSessionDisabled(&Win32kSQMSession, 0x62004u) )
  {
    dword_1C01CD5A0 |= 2u;
  }
  else
  {
    ...
    if ( v0 )
    {
      v2 = xmmword_1C01C8788;
      *(_DWORD *)(v0 + 16) = 40;
      *(_OWORD *)v0 = v2;
      *(_DWORD *)(v0 + 20) = v5;
      *(GUID *)(v0 + 24) = Win32kSQMSession;
      if ( qword_1C01CD5A8 || !RegisterWinSqmProvider() )
      {
        UserData[0].Ptr = (ULONGLONG)&Win32kSQMSession;
        UserData[1].Ptr = (ULONGLONG)&unk_1C01D0F44;
