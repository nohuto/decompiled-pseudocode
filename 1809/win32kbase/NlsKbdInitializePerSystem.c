/*
 * XREFs of NlsKbdInitializePerSystem @ 0x1C0090DC0
 * Callers:
 *     <none>
 * Callees:
 *     ?NlsSetKeyStateToggle@@YAXE@Z @ 0x1C0090FC0 (-NlsSetKeyStateToggle@@YAXE@Z.c)
...
void NlsKbdInitializePerSystem()
{
  ...
  if ( gKeyboardInfo == 7 && byte_1C01C88B1 == 3 )
