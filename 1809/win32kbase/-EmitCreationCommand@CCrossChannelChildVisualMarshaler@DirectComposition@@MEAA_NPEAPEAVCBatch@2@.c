/*
 * XREFs of ?EmitCreationCommand@CCrossChannelChildVisualMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00041C0
 * Callers:
 *     <none>
 * Callees:
...
{
  return DirectComposition::CResourceMarshaler::EmitDuplicateHelper(this, a2, *((unsigned int *)this + 88));
}
