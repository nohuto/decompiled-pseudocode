/*
 * XREFs of McTemplateK0qqqqqp @ 0x1C00EAAAC
 * Callers:
 *     EtwTraceAuditApiSetWinEventHook @ 0x1C008BE10 (EtwTraceAuditApiSetWinEventHook.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0050EB8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00A63D0 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0qqqqqp(
        ...
        char a9)
{
  ...
  v20 = 4LL;
  v22 = 8LL;
  return McGenEventWrite(a1, &AuditApiSetWinEventHook, (LPCGUID)&Context.Flags, 7u, &EventData);
}
