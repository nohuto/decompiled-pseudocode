/*
 * XREFs of RIMLogDeviceHealthTelemetry @ 0x1C00A4610
 * Callers:
...
void __fastcall RIMLogDeviceHealthTelemetry(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( dword_1C01C7A38 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7A38, 0x400000000000uLL) )
  {
    ...
    if ( v10 < 0 && (v11 = *(_QWORD *)(v7 + 480)) != 0 )
      v12 = -__CFSHR__(*(_DWORD *)(v11 + 308), 15);
    else
      v12 = 0;
    v24 = v12;
    v51 = 4LL;
    ...
    v57 = 8LL;
    v59 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C7A38, &unk_1C019EA10, 0LL, 0LL, 0x13u, &pData);
  }
}
