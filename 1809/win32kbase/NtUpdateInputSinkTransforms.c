/*
 * XREFs of NtUpdateInputSinkTransforms @ 0x1C0002150
 * Callers:
 *     <none>
 * Callees:
    ...
    while ( v4 >= 0 && v5 < a2 )
    {
      ...
      *(_OWORD *)&Object[9] = v10;
      ...
      if ( v4 >= 0 )
      {
        ...
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 4uLL) )
          {
            v13 = v11;
            v16 = &v13;
            v17 = 8LL;
            ...
            v49 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C01A1F89, 0LL, 0LL, 0x13u, &pData);
          }
        }
