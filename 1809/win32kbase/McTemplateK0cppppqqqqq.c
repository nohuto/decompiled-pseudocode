/*
 * XREFs of McTemplateK0cppppqqqqq @ 0x1C00E8E80
 * Callers:
...
ULONG __fastcall McTemplateK0cppppqqqqq(
        ...
        char a13)
{
  ...
  EVENT_DATA_DESCRIPTOR EventData; // [rsp+50h] [rbp-B0h] BYREF
  ...
  v35 = 4LL;
  v37 = 4LL;
  return McGenEventWrite(a1, &BeginSendMessage, (LPCGUID)&Context.Flags, 0xBu, &EventData);
}
