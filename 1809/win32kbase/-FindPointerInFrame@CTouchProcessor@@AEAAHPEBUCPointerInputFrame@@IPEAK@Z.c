/*
 * XREFs of ?FindPointerInFrame@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@IPEAK@Z @ 0x1C0138788
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  {
    v13 = (_DWORD *)(*((_QWORD *)a2 + 13) + 576LL * v12 + 236);
    do
    {
      if ( *v13 == a3 )
        break;
...
LABEL_17:
  ...
  if ( v12 >= *((_DWORD *)a2 + 12) || *(unsigned __int16 *)(576LL * v12 + *((_QWORD *)a2 + 13) + 236) != a3 )
    return 0LL;
  *a4 = v12;
  return 1LL;
}
