/*
 * XREFs of ?HandleDesktopEdgy@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@H@Z @ 0x1C013E5A0
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::HandleDesktopEdgy(const struct CPointerInputFrame *a1, int a2)
{
  __int64 v2; // r9
  __int64 v3; // r10
  ...
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
    {
      ...
      v12 = v3;
      v14 = v3;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019FE8F, 0LL, 0LL, 6u, &pData);
    }
  }
}
