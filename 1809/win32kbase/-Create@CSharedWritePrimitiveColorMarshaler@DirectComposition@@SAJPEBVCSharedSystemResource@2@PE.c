/*
 * XREFs of ?Create@CSharedWritePrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C018175C
 * Callers:
 *     CreateSharedWritePrimitiveColorMarshaler @ 0x1C0181910 (CreateSharedWritePrimitiveColorMarshaler.c)
 * Callees:
