/*
 * XREFs of ?CreateWin32KFilterBitmap@@YAJKQEAPEBDHKPEAE@Z @ 0x1C006C0B8
 * Callers:
        ...
        unsigned __int8 *a5)
{
  ...
  char pszDest[272]; // [rsp+20h] [rbp-148h] BYREF
  ...
  if ( a1 && a2 && a5 )
  {
    ...
    if ( !a1 )
      return v5;
    while ( RtlStringCbPrintfA(pszDest, 0x104uLL, "__win32kstub_%s", *v7) >= 0 )
    {
      ExportedRoutineByName = (__int64 (*)(void))RtlFindExportedRoutineByName(gpvWin32kImageBase, pszDest);
