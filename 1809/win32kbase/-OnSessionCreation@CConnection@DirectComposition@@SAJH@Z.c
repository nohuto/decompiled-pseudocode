/*
 * XREFs of ?OnSessionCreation@CConnection@DirectComposition@@SAJH@Z @ 0x1C005CFC0
 * Callers:
 ...
 *     ??0CConnection@DirectComposition@@AEAA@XZ @ 0x1C005D0B4 (--0CConnection@DirectComposition@@AEAA@XZ.c)
...
__int64 __fastcall DirectComposition::CConnection::OnSessionCreation(int a1)
{
  ...
  if ( v3 )
  {
    ...
    else
    {
      ...
      {
        v5 = (DirectComposition::CConnection *)Win32AllocPoolZInit(0x110uLL, 0x63634344u);
        if ( v5 )
