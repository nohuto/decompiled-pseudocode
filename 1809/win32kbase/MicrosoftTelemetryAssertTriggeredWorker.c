/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C01860A8
 * Callers:
 ...
 *     TakeTelemetryAssertsLock @ 0x1C0091608 (TakeTelemetryAssertsLock.c)
        ...
        __int64 a6)
{
  ...
  unsigned int v44; // [rsp+80h] [rbp-88h] BYREF
...
LABEL_40:
  ...
  v21 = *((_DWORD *)v8 + 5);
  v22 = *((_DWORD *)v8 + 4);
  v23 = (struct _FAST_MUTEX *)g_AssertFastMutex;
  v8[1] = v15;
  v24 = *((_DWORD *)v8 + 6);
  v34 = v21;
  ExReleaseFastMutex(v23);
  v25 = "<unknown>";
  if ( (unsigned int)dword_1C01FF040 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01FF040, 0x400000000000uLL) )
  {
    v26 = "<unknown>";
    v35 = 10;
    v36 = v20;
    ...
    v81 = 4LL;
    TlgCreateSz(&v82, v28);
    TlgWrite((TraceLoggingHProvider)&dword_1C01FF040, &unk_1C01A3834, 0LL, 0LL, 0xBu, &pData);
  }
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1C01FF078, 0, 0LL) && !v24 && !KeGetCurrentIrql() )
  {
    v30 = DbgkWerCaptureLiveKernelDump(L"TELASSERT", 465LL, v20, g_ModuleName, v17, v18, v29, v29, 0);
    if ( (unsigned int)dword_1C01FF040 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01FF040, 0x400000000000uLL) )
    {
      v42 = 10;
      v43 = v20;
      ...
      v63 = 4LL;
      v65 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01FF040, &unk_1C01A37CB, 0LL, v31, cData, &v50);
    }
