/*
 * XREFs of ?CitpRegistryGetValue@@YAJPEAXPEBGPEAPEAU_KEY_VALUE_PARTIAL_INFORMATION@@@Z @ 0x1C00792A4
 * Callers:
        ...
        struct _KEY_VALUE_PARTIAL_INFORMATION **a3)
{
  ...
  if ( (v6 == -1073741789 || v6 == -2147483643) && (_DWORD)ResultLength )
  {
    ...
    {
      v7 = -1073741670;
      CitpLogFailureWorker(-1073741670, v9, 0x897u);
      return v7;
    }
    v10 = ZwQueryValueKey(
            KeyHandle,
    ...
    CitpLogFailureWorker(v10, v11, 0x8A3u);
  }
  else
  {
    if ( v6 < 0 )
