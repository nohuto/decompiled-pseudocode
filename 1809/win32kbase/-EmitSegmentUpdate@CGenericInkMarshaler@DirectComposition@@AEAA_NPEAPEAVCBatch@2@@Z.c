/*
 * XREFs of ?EmitSegmentUpdate@CGenericInkMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C016A4C8
 * Callers:
 ...
 *     ?GetSegmentCount@CGenericInkMarshaler@DirectComposition@@AEBAIXZ @ 0x1C016A708 (-GetSegmentCount@CGenericInkMarshaler@DirectComposition@@AEBAIXZ.c)
 *     ?NeedsSegmentUpdate@CGenericInkMarshaler@DirectComposition@@AEBA_NXZ @ 0x1C016A724 (-NeedsSegmentUpdate@CGenericInkMarshaler@DirectComposition@@AEBA_NXZ.c)
 */
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v11 >= (unsigned int)v10 )
      v11 = v10;
    v12 = v9 * v11 + 28;
    if ( !DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, v12, &v19) )
      break;
    v13 = (char *)v19;
    *(_DWORD *)v19 = v12;
    v14 = *((_DWORD *)this + 33);
