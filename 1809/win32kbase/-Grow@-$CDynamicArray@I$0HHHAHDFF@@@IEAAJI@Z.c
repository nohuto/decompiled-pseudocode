/*
 * XREFs of ?Grow@?$CDynamicArray@I$0HHHAHDFF@@@IEAAJI@Z @ 0x1C016D204
 * Callers:
 *     ?CapturePointer@CInteractionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I@Z @ 0x1C016D1B0 (-CapturePointer@CInteractionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I@Z.c)
 * Callees:
