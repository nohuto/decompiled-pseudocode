/*
 * XREFs of DrvSetDisplayConfigValidateParams @ 0x1C00AFBC0
 * Callers:
 ...
 *     _stricmp @ 0x1C00A6A28 (_stricmp.c)
    ...
    if ( (v128 & 0x1F) != 0 )
    {
      ...
      if ( (v128 & 0x10) != 0 )
      {
        ...
        for ( i = 0; i < v126; ++i )
        {
          ...
          if ( (*v123 & 0x7FFB8FFFFFFFFFFFLL) != 0 )
          {
            v117 = WdLogNewEntry5_WdError(0x7FFB8FFFFFFFFFFFLL, v10, v12);
            *(_QWORD *)(v117 + 24) = i;
