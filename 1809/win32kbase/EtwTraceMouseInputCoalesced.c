/*
 * XREFs of EtwTraceMouseInputCoalesced @ 0x1C0095320
 * Callers:
...
ULONG __fastcall EtwTraceMouseInputCoalesced(struct _MCGEN_TRACE_CONTEXT *a1)
{
  ULONG result; // eax

  if ( (BYTE3(Microsoft_Windows_Win32kEnableBits) & 0x20) != 0 )
    return McTemplateK0(a1, &MouseInputCoalesced, (const GUID *)&Context.Flags);
  return result;
}
