/*
 * XREFs of ?CoalesceFrame@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@@Z @ 0x1C01350CC
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::CoalesceFrame(const struct CPointerInputFrame *a1)
{
  ...
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
    {
      ...
      v8 = 8LL;
      v10 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C01A03C9, 0LL, 0LL, 5u, &pData);
    }
  }
}
