/*
 * XREFs of ?BindToInputSpace@Pointer@InputTraceLogging@@SAXPEBURIMDEV@@PEBUtagHID_POINTER_DEVICE_INFO@@PEBUINPUT_SPACE@@PEBUINPUT_SPACE_REGION@@@Z @ 0x1C0111F10
 * Callers:
        ...
        const struct INPUT_SPACE_REGION *a4)
{
  ...
  if ( a3 && a4 )
  {
    if ( dword_1C01C7F10 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
      {
        ...
        v52 = v7;
        v54 = v7;
        TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019EB76, 0LL, 0LL, 0x15u, &pData);
      }
    }
  }
  else if ( dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
  {
    ...
    v56 = &v15;
    v57 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019ECA0, 0LL, 0LL, 3u, &v55);
  }
}
