/*
 * XREFs of ??4CPointerInfoNode@@QEAAAEAU0@AEBU0@@Z @ 0x1C0132FC8
 * Callers:
...
__int64 __fastcall CPointerInfoNode::operator=(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 4) ^= (*(_DWORD *)(a2 + 4) ^ *(_DWORD *)(a1 + 4)) & 1;
  v34 = *(_DWORD *)(a1 + 4) ^ (*(_DWORD *)(a2 + 4) ^ *(_DWORD *)(a1 + 4)) & 2;
  *(_DWORD *)(a1 + 4) = v34;
  v35 = v34 ^ (*(_DWORD *)(a2 + 4) ^ v34) & 4;
  *(_DWORD *)(a1 + 4) = v35;
  v36 = v35 ^ (*(_DWORD *)(a2 + 4) ^ v35) & 8;
  *(_DWORD *)(a1 + 4) = v36;
  v37 = v36 ^ (*(_DWORD *)(a2 + 4) ^ v36) & 0x10;
  *(_DWORD *)(a1 + 4) = v37;
  v38 = v37 ^ (*(_DWORD *)(a2 + 4) ^ v37) & 0x20;
  *(_DWORD *)(a1 + 4) = v38;
  v39 = v38 ^ (*(_DWORD *)(a2 + 4) ^ v38) & 0x40;
  *(_DWORD *)(a1 + 4) = v39;
  v40 = v39 ^ (*(_DWORD *)(a2 + 4) ^ v39) & 0x80;
  *(_DWORD *)(a1 + 4) = v40;
  v41 = v40 ^ ((unsigned __int16)v40 ^ (unsigned __int16)*(_DWORD *)(a2 + 4)) & 0x100;
  *(_DWORD *)(a1 + 4) = v41;
  v42 = v41 ^ (v41 ^ *(_DWORD *)(a2 + 4)) & 0x200;
  *(_DWORD *)(a1 + 4) = v42;
  v43 = v42 ^ (v42 ^ *(_DWORD *)(a2 + 4)) & 0x400;
  *(_DWORD *)(a1 + 4) = v43;
  v44 = v43 ^ (v43 ^ *(_DWORD *)(a2 + 4)) & 0x800;
  *(_DWORD *)(a1 + 4) = v44;
  *(_DWORD *)(a1 + 4) = v44 ^ (v44 ^ *(_DWORD *)(a2 + 4)) & 0x1000;
  ...
  *(_DWORD *)(a1 + 388) = *(_DWORD *)(a2 + 388);
  CInputDest::operator=(a1 + 392, a2 + 392);
  return a1;
}
