/*
 * XREFs of ?CitpProcessForegroundChange@@YAHPEAUtagPROCESSINFO@@PEAUtagWND@@0PEAUtagMONITOR@@PEAUtagSHELL_INPUT_USAGE_DATA_INFO@@@Z @ 0x1C003A210
 * Callers:
 *     CitProcessForegroundChange @ 0x1C003A1C0 (CitProcessForegroundChange.c)
 *     CitModerncoreProcessForegroundChange @ 0x1C01854F0 (CitModerncoreProcessForegroundChange.c)
 * Callees:
        ...
        struct tagSHELL_INPUT_USAGE_DATA_INFO *a5)
{
  ...
  if ( (unsigned int)IsRemoteConnection() )
  {
    ...
    if ( !v11 )
    {
      if ( (unsigned int)dword_1C01C76E4 < MEMORY[0xFFFFF7800000037C] )
      {
        EtwTelemetryCoverageReport(&off_1C01C76D8);
        v11 = *((_WORD *)v8 + 57);
      }
      *((_BYTE *)v8 + 112) |= 4u;
      *((_WORD *)v8 + 57) = v11 + 1;
