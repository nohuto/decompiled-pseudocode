/*
 * XREFs of RIMGetQDCActivePathsData @ 0x1C004A680
 * Callers:
...
_QWORD *__fastcall RIMGetQDCActivePathsData(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v3; // rbx
  ...
  *a1 = 0LL;
  ...
  if ( DisplayConfigBufferSizes >= 0 )
  {
    ...
    DisplayConfigBufferSizes = DrvQueryDisplayConfig(2147483666LL, (__int64)a1, (__int64)v7, 0LL);
    if ( DisplayConfigBufferSizes >= 0 )
    {
      if ( *(_DWORD *)a1 )
      {
