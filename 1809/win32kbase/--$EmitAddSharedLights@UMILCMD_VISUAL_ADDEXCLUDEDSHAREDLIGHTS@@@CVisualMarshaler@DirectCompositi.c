/*
 * XREFs of ??$EmitAddSharedLights@UMILCMD_VISUAL_ADDEXCLUDEDSHAREDLIGHTS@@@CVisualMarshaler@DirectComposition@@IEAA_NAEBVCResourceMarshalerArray@1@W4MILCMD@@PEA_KPEAPEAVCBatch@1@@Z @ 0x1C000B334
 * Callers:
...
bool __fastcall DirectComposition::CVisualMarshaler::EmitAddSharedLights<MILCMD_VISUAL_ADDEXCLUDEDSHAREDLIGHTS>(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        unsigned __int64 *a4,
