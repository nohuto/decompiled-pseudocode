/*
 * XREFs of ?GetPointerTouchInfo@Pointer@InputTraceLogging@@SAXPEBUtagPOINTER_TOUCH_INFO@@@Z @ 0x1C013D8D4
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::GetPointerTouchInfo(const struct tagPOINTER_TOUCH_INFO *a1)
{
  ...
  if ( dword_1C01C7F10 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
    {
      ...
      v66 = 4LL;
      v68 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C01A00BC, 0LL, 0LL, 0x1Cu, &pData);
    }
  }
}
