/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_9f39bb051d838eb97bf84367ce2fb8b6___ @ 0x1C0178B98
 * Callers:
...
char __fastcall DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_9f39bb051d838eb97bf84367ce2fb8b6___(
        __int64 a1,
        ...
        __int64 a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(a1 + 24);
  result = 1;
  *((_DWORD *)v5 + 3) = *(_DWORD *)(*(_QWORD *)a3 + 176LL);
  return result;
}
