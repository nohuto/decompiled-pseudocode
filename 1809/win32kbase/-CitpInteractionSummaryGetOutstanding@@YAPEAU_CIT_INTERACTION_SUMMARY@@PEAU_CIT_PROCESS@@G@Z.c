/*
 * XREFs of ?CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z @ 0x1C0184730
 * Callers:
...
struct _CIT_INTERACTION_SUMMARY *__fastcall CitpInteractionSummaryGetOutstanding(struct _CIT_PROCESS *a1)
{
  ...
  if ( (qword_1C01D0CD4 & 2) != 0 )
  {
    ...
    if ( (unsigned int)v3 >= *((_DWORD *)qword_1C01D0CF0 + 14) )
      return 0LL;
    v4 = *(_QWORD *)qword_1C01D0CF0 + 96 * v3;
