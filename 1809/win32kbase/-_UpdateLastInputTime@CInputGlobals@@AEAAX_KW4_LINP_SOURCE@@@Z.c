/*
 * XREFs of ?_UpdateLastInputTime@CInputGlobals@@AEAAX_KW4_LINP_SOURCE@@@Z @ 0x1C003628C
 * Callers:
...
char __fastcall CInputGlobals::_UpdateLastInputTime(__int64 a1, __int64 a2, int a3)
{
  ...
  *(_QWORD *)(a1 + 16) = a2;
  ...
  if ( (W32kEtwEnabledKeyword & 0x2000000000008000LL) != 0 )
  {
    ...
    {
      LOBYTE(v4) = 0;
      if ( (qword_1C01C3318 & 0x2000000000008000LL) == qword_1C01C3318 && giPowerOffTimeOutMs > 0 )
      {
