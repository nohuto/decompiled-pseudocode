/*
 * XREFs of ?Create@CVisualTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C007DBD0
 * Callers:
 *     CreateVisualTargetMarshaler @ 0x1C007DB80 (CreateVisualTargetMarshaler.c)
 * Callees:
