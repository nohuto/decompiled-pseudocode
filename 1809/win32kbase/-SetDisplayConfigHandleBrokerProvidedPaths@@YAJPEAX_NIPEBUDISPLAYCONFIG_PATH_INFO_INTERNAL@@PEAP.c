/*
 * XREFs of ?SetDisplayConfigHandleBrokerProvidedPaths@@YAJPEAX_NIPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_GETPATHSMODALITY@@PEA_NPEAW4_DXGK_DIAG_SDC_STAGE@@@Z @ 0x1C01037AC
 * Callers:
 ...
 *     _SetDisplayConfigHandleBrokerProvidedPaths_::_2_::_AUTO_USING_PM_VirtualTopologyButNotVirtualModePath13740::__AUTO_USING_PM_VirtualTopologyButNotVirtualModePath13740 @ 0x1C00ABC10 (_SetDisplayConfigHandleBrokerProvidedPaths_--_2_--_AUTO_USING_PM_VirtualTopologyButNotVirtualMod.c)
        ...
        enum _DXGK_DIAG_SDC_STAGE *a7)
{
  ...
  *((_QWORD *)&v52 + 1) = &v50;
  ...
  if ( !a2 )
  {
    PathsModality = GetPathsModality((__int64)&v50, &v51, 16777280LL, 0);
    if ( PathsModality < 0 )
    {
      *(_DWORD *)a7 = 44;
      goto LABEL_58;
    ...
    if ( v11 )
    {
      *((_WORD *)v11 + 10) = 0;
      ...
      for ( i = v51; v15 < *((unsigned __int16 *)v51 + 10); ++v15 )
      {
        ...
        if ( !(unsigned __int8)((__int64 (__fastcall *)(void *, _QWORD, _QWORD))qword_1C01CDEC0)(
                                 a1,
                                 *(_QWORD *)(v17 + 16),
                                 *(unsigned int *)(v17 + 28)) )
        {
          v18 = *((unsigned __int16 *)v50 + 10);
          v19 = (_QWORD *)((char *)v50 + 272 * v18);
          *((_WORD *)v50 + 10) = v18 + 1;
          v20 = 2LL;
          v21 = v19 + 6;
          do
          ...
          *v21 = *(_OWORD *)v17;
          v23 = v19[6];
          v19[34] = 0LL;
          v19[7] = v23 & 0x18000820B8FLL;
          v19[6] = v23 | 0x80000000000000LL;
        }
        i = v51;
      }
      goto LABEL_15;
...
LABEL_34:
  ...
  *(_DWORD *)a7 = 48;
LABEL_57:
  SetDisplayConfigHandleBrokerProvidedPaths_::_2_::_AUTO_USING_PM_VirtualTopologyButNotVirtualModePath13740::__AUTO_USING_PM_VirtualTopologyButNotVirtualModePath13740((__int64 *)&v52);
LABEL_58:
