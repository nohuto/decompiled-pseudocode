/*
 * XREFs of WPP_RECORDER_SF_dD @ 0x1C0128C3C
 * Callers:
...
__int64 WPP_RECORDER_SF_dD(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      43LL,
      &WPP_4bfe390787383b4e17a2ea3fbc512894_Traceguids,
      a4,
      (__int64 *)va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(v6, 3LL, 22LL, &WPP_4bfe390787383b4e17a2ea3fbc512894_Traceguids, v8, (__int64 *)va);
}
