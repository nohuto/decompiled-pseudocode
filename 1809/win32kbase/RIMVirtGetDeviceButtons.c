/*
 * XREFs of RIMVirtGetDeviceButtons @ 0x1C0119F20
 * Callers:
...
__int64 __fastcall RIMVirtGetDeviceButtons(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  {
    *(_DWORD *)(a2 + 972) = *(_DWORD *)(a5 + 1264);
    v8 = v5;
    v9 = Win32AllocPoolZInit(12LL * v5, 0x78647352u);
    *(_QWORD *)(a2 + 960) = v9;
    if ( v9 )
    {
      if ( v5 )
...
LABEL_11:
  ...
  v14 = Win32AllocPoolZInit(12LL * *(unsigned int *)(a2 + 712), 0x78647352u);
  *(_QWORD *)(a2 + 960) = v14;
  if ( !v14 )
    goto LABEL_11;
  v15 = *(_DWORD *)(a2 + 712);
  v16 = 0;
  for ( *(_DWORD *)(a2 + 972) = v15; v16 < *(_DWORD *)(a2 + 972); *(_DWORD *)(v21 + 4 * v19 + 8) = v20 )
  {
    v17 = *(_QWORD *)(a5 + 1256);
    v18 = v16++;
    v19 = 3 * v18;
