/*
 * XREFs of ?SetReferenceProperty@CKeyframeAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C000C6B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetReferenceProperty@CBaseExpressionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C000E130 (-SetReferenceProperty@CBaseExpressionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2.c)
  ...
  *a5 = 0;
  switch ( a3 )
  {
    ...
    case 0x18u:
      ...
      v12 = (struct DirectComposition::CResourceMarshaler *)((*((_QWORD *)this + 36) + 16LL) & ((unsigned __int128)-(__int128)*((unsigned __int64 *)this + 36) >> 64));
      if ( a4 == v12 )
        return v5;
