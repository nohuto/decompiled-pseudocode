/*
 * XREFs of DrvEscapeRemoteDrivers @ 0x1C00A5340
 * Callers:
        ...
        unsigned int a6)
{
  ...
  *(_QWORD *)(v11 + 24) = a1;
  ...
  if ( (unsigned __int16)(gProtocolType - 1) > 0xFFFDu || !a3 )
    return HDXDrvEscape(*(_QWORD *)(a1 + 32), (HSEMAPHORE)(unsigned int)v7, a5, (HSEMAPHORE)a6);
  ...
  while ( 1 )
  {
    v27 = *(_QWORD *)(*(_QWORD *)(a1 + 40 * v14 + 32) + 2576LL);
...
LABEL_14:
  ...
  while ( 1 )
  {
    ...
    {
      v6 = *(_QWORD *)(a1 + 40 * v14 + 32);
      v8 = HDXDrvEscape(v6, (HSEMAPHORE)(unsigned int)v7, a5, (HSEMAPHORE)a6);
      if ( v8 != 1 )
        break;
    }
    if ( ++v17 >= *v16 )
