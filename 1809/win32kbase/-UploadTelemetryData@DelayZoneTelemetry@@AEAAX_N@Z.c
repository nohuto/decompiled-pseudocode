/*
 * XREFs of ?UploadTelemetryData@DelayZoneTelemetry@@AEAAX_N@Z @ 0x1C0157054
 * Callers:
...
void __fastcall DelayZoneTelemetry::UploadTelemetryData(DelayZoneTelemetry *this, char a2)
{
  ...
  EVENT_DATA_DESCRIPTOR v17; // [rsp+C0h] [rbp-1h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v18; // [rsp+E0h] [rbp+1Fh] BYREF
    ...
    *((_DWORD *)this + 2) = v7;
    if ( v7 )
    {
      ...
      do
      {
        ...
        if ( pcchLength + 96 >= 0x800 )
        {
          if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
          {
            ...
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01A1731, 0LL, 0LL, 3u, &pData);
          }
          v9 = 0LL;
          pcchLength = 0LL;
          v4 = 1;
      ...
      if ( v9 )
      {
        ...
        {
          TlgCreateSz(&v18, v2);
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01A1731, 0LL, 0LL, 3u, &v17);
        }
        v4 = 1;
      }
      if ( v4 )
