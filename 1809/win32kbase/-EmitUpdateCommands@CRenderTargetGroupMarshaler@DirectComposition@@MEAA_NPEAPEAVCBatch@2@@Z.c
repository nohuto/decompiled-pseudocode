/*
 * XREFs of ?EmitUpdateCommands@CRenderTargetGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C008C880
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( *((_DWORD *)this + 13) < *((_DWORD *)this + 12) )
  {
    do
    {
      ...
      *((_DWORD *)this + 13) = v8 + v5;
    }
    while ( v8 + (unsigned int)v5 < *((_DWORD *)this + 12) );
  }
  return *((_DWORD *)this + 13) == *((_DWORD *)this + 12);
}
