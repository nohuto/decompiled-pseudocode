/*
 * XREFs of WPP_RECORDER_SF_LsHHsLLLL @ 0x1C014831C
 * Callers:
...
{
  const struct _MCGEN_TRACE_CONTEXT *v5; // rdi
  const struct _MCGEN_TRACE_CONTEXT *v6; // rsi
  __int64 v7; // rbx
  __int64 v9; // rdx
  __int64 v10; // rdx
  const struct _MCGEN_TRACE_CONTEXT *v11; // r9
  __int64 v12; // r8
  __int64 v13; // r8
  const struct _MCGEN_TRACE_CONTEXT *v14; // rcx
  __int64 v15; // rax
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x400) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    ...
    if ( v20 )
    {
      ...
      do
        ++v12;
      while ( *((_BYTE *)&v20->RegistrationHandle + v12) );
      v13 = v12 + 1;
    }
    else
    {
    ...
    if ( !v20 )
      v14 = &stru_1C01A3F30;
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, const struct _MCGEN_TRACE_CONTEXT *, __int64, __int64 *, __int64, __int64 *, __int64, const struct _MCGEN_TRACE_CONTEXT *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
  ...
  if ( v5 )
  {
    ...
    do
      ++v15;
    while ( *((_BYTE *)&v5->RegistrationHandle + v15) );
  }
  if ( v6 )
  {
    do
      ++v7;
    while ( *((_BYTE *)&v6->RegistrationHandle + v7) );
  }
  LOWORD(v17) = 274;
  return WppAutoLogTrace(a1, 4LL, 11LL, &WPP_34edb07bf13d308a4f9f363aca43f10b_Traceguids, v17, (__int64 *)va);
}
