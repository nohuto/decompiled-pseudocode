/*
 * XREFs of DrvGetDisplayDriverParameters @ 0x1C0053824
 * Callers:
 ...
 *     ?DrvGetDisplayDriverDpiSetting@@YAXPEAU_devicemodeW@@@Z @ 0x1C0053D2C (-DrvGetDisplayDriverDpiSetting@@YAXPEAU_devicemodeW@@@Z.c)
...
__int64 __fastcall DrvGetDisplayDriverParameters(__int64 a1, struct _devicemodeW *a2, int a3, __int64 a4)
{
  ...
  __int64 v93; // [rsp+280h] [rbp+180h]
  int v94; // [rsp+288h] [rbp+188h]
  __int64 v95; // [rsp+290h] [rbp+190h]
  ...
  __int64 v105; // [rsp+2E0h] [rbp+1E0h]
  int v106; // [rsp+2E8h] [rbp+1E8h]
  int (*v107)(unsigned __int16 *, unsigned int, void *, unsigned int, void *, void *); // [rsp+2F0h] [rbp+1F0h]
  int v108; // [rsp+2F8h] [rbp+1F8h]
  __int64 v109; // [rsp+300h] [rbp+200h]
  struct _devicemodeW *v110; // [rsp+308h] [rbp+208h]
  int v111; // [rsp+310h] [rbp+210h]
  int *v112; // [rsp+318h] [rbp+218h]
  int v113; // [rsp+320h] [rbp+220h]
  __int64 v114; // [rsp+328h] [rbp+228h]
  int v115; // [rsp+330h] [rbp+230h]
  _BYTE v116[40]; // [rsp+338h] [rbp+238h] BYREF
