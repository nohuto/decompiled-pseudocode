/*
 * XREFs of ?Create@CSharedWriteDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00925B8
 * Callers:
 *     CreateSharedWriteDesktopTargetMarshaler @ 0x1C0092580 (CreateSharedWriteDesktopTargetMarshaler.c)
 * Callees:
