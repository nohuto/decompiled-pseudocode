/*
 * XREFs of LogDiagCDS @ 0x1C004BF0C
 * Callers:
 ...
 *     ?FillSimpleDevModeField@@YAXQEAU_devicemodeW@@PEAU_DXGK_DIAG_SIMPLE_DEVMODE@@@Z @ 0x1C004C13C (-FillSimpleDevModeField@@YAXQEAU_devicemodeW@@PEAU_DXGK_DIAG_SIMPLE_DEVMODE@@@Z.c)
        ...
        struct _devicemodeW *a14)
{
  ...
  if ( v18 )
  {
    ...
    *(_DWORD *)(v19 + 48) = v20;
    ...
    ((void (__fastcall *)(__int64))qword_1C01CD968)(v19);
    Win32FreePool(v19);
  }
  else
  {
