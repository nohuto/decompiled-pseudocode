/*
 * XREFs of ?CitpSetSpeechRecognitionInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1C01852B4
 * Callers:
...
__int64 __fastcall CitpSetSpeechRecognitionInfo(union _CIT_SI_INFOFLAGS *a1, union _CIT_SI_INFO *a2)
{
  ...
  v2 = qword_1C01D0CF0;
  if ( (unsigned int)dword_1C01C7FCC < MEMORY[0xFFFFF7800000037C] )
    EtwTelemetryCoverageReport(&off_1C01C7FC0);
  ...
  if ( (unsigned int)v9 >= 0x40 )
  {
    ...
    if ( (int)v9 - 63 > v11 )
    {
      *((_DWORD *)v2 + 206) = v12;
      if ( v12 - v11 < 0x40 )
        *((_QWORD *)v2 + 102) >>= (unsigned __int8)v12 - (unsigned __int8)v11;
      else
        *((_QWORD *)v2 + 102) = 0LL;
    }
  }
    ...
    *((_QWORD *)v2 + 102) = v15;
    if ( v13 )
    {
      ...
      if ( v20 )
      {
        ...
        if ( v21 )
          CitpStatIncrement((unsigned __int16 *)v21 + 44, v13);
      }
    }
  }
  return 0LL;
