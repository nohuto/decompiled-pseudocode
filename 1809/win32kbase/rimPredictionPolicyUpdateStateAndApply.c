/*
 * XREFs of rimPredictionPolicyUpdateStateAndApply @ 0x1C012B520
 * Callers:
 *     rimApplyPointerDevicePolicies @ 0x1C0128D14 (rimApplyPointerDevicePolicies.c)
 * Callees:
 *     ApiSetDoPrediction @ 0x1C0160E4C (ApiSetDoPrediction.c)
 */
...
__int64 __fastcall rimPredictionPolicyUpdateStateAndApply(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( a4 || (*(_DWORD *)(a1 + 308) & 0x20) != 0 || (v5 = 1, (unsigned int)(*(_DWORD *)(a1 + 24) - 1) > 3) )
    v5 = 0;
  v6 = (_DWORD *)(a2 + 2440);
  if ( v5 )
  {
