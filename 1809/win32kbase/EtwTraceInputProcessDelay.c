/*
 * XREFs of EtwTraceInputProcessDelay @ 0x1C00E6850
 * Callers:
...
void __fastcall EtwTraceInputProcessDelay(struct tagTHREADINFO *a1)
{
  ...
  const struct _MCGEN_TRACE_CONTEXT *v6; // rsi
  ...
  int v19; // eax
  __int64 v20; // r8
  struct _MCGEN_TRACE_CONTEXT *v21; // rdx
  const struct _MCGEN_TRACE_CONTEXT *v22; // rcx
  int v23; // r11d
  const WCHAR *v24; // rdx
  const WCHAR *v25; // rdx
  int v26; // r11d
  ...
  int v40; // [rsp+90h] [rbp-3C8h] BYREF
  unsigned int v41; // [rsp+94h] [rbp-3C4h] BYREF
  unsigned int v42; // [rsp+98h] [rbp-3C0h] BYREF
  int v43; // [rsp+9Ch] [rbp-3BCh] BYREF
  const struct _MCGEN_TRACE_CONTEXT *v44; // [rsp+A0h] [rbp-3B8h]
  const struct _MCGEN_TRACE_CONTEXT *v45; // [rsp+A8h] [rbp-3B0h]
  int *v46; // [rsp+B0h] [rbp-3A8h]
  struct tagTHREADINFO *v47; // [rsp+C0h] [rbp-398h]
  __int64 v48; // [rsp+C8h] [rbp-390h] BYREF
  __int64 v49; // [rsp+D0h] [rbp-388h] BYREF
  int v50; // [rsp+D8h] [rbp-380h] BYREF
  WCHAR *v51; // [rsp+E0h] [rbp-378h]
  struct _UNICODE_STRING UnicodeString; // [rsp+E8h] [rbp-370h] BYREF
  struct _UNICODE_STRING v53; // [rsp+F8h] [rbp-360h] BYREF
  EVENT_DATA_DESCRIPTOR v54; // [rsp+110h] [rbp-348h] BYREF
  int *v55; // [rsp+130h] [rbp-328h]
  ...
  v6 = 0LL;
  v44 = 0LL;
  v7 = (struct tagWND *)ValidateHwnd(*((void **)a1 + 145));
  v8 = v7;
  if ( !v7 )
    goto LABEL_27;
  ...
  if ( (int)EtwpGetClassName(v9, &v53) >= 0 )
  {
    v6 = (const struct _MCGEN_TRACE_CONTEXT *)v53.Buffer;
LABEL_26:
    v44 = v6;
  }
LABEL_27:
...
LABEL_38:
  ...
  if ( &v50 )
    v10 = v51;
  v17 = *((_QWORD *)a1 + 53);
  if ( (*(_DWORD *)(v17 + 820) & 0x30) == 0x10 )
  {
    v18 = PsReferencePrimaryToken(*(PEPROCESS *)v17);
    v49 = 256LL;
    v48 = 130LL;
    v19 = RtlQueryPackageIdentity(v18, v104, &v49, v103, &v48, 0LL);
    v32 = v19;
    if ( (BYTE1(Microsoft_Windows_Win32kEnableBits) & 1) != 0 )
    {
      v21 = (struct _MCGEN_TRACE_CONTEXT *)v103;
      if ( v19 < 0 )
        v21 = (struct _MCGEN_TRACE_CONTEXT *)&word_1C01944BC;
      v22 = (const struct _MCGEN_TRACE_CONTEXT *)v104;
      if ( v19 < 0 )
        v22 = (const struct _MCGEN_TRACE_CONTEXT *)&word_1C01944BC;
      McTemplateK0qqqzzzzqx((__int64)v22, (__int64)v21, v20, v4, v29, v30, Buffer, v6, v22, v21, v31, v33);
    }
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000040000uLL) )
    {
      ...
      TlgCreateWsz(&v89, (LPCWSTR)Buffer);
      TlgCreateWsz(&v90, (LPCWSTR)v6);
      v91 = &v31;
      v92 = v27;
      v93 = 0;
      v94 = &v33;
      ...
      v101 = v27;
      v102 = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C019DA1C, 0LL, 0LL, 0xEu, &pData);
    }
  ...
  {
    if ( (BYTE1(Microsoft_Windows_Win32kEnableBits) & 1) != 0 )
      McTemplateK0qqqzzzqx(v17, v15, v14, v4, v29, v30, Buffer, v6, (struct _MCGEN_TRACE_CONTEXT *)v10, v31, v33);
    if ( hProvider > 5u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000040000uLL) )
    {
      v40 = v4;
      v55 = &v40;
      ...
      TlgCreateWsz(&v65, (LPCWSTR)Buffer);
      TlgCreateWsz(&v66, (LPCWSTR)v6);
      v67 = &v31;
      v68 = v28;
      v69 = 0;
      v70 = &v33;
      ...
      v74 = v28;
      v75 = 0;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C019D962, 0LL, 0LL, 0xBu, &v54);
    }
  }
  if ( Buffer )
