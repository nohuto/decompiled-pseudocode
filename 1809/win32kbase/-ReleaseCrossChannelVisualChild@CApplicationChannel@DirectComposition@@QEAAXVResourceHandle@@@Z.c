/*
 * XREFs of ?ReleaseCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAXVResourceHandle@@@Z @ 0x1C0003CBC
 * Callers:
        ...
        unsigned int a2)
{
  ...
  {
    LODWORD(v2) = (*(__int64 (__fastcall **)(_QWORD *, _QWORD))(*(i - 45) + 288LL))(i - 45, a2);
    if ( (_BYTE)v2 )
    {
      LODWORD(v2) = DirectComposition::CApplicationChannel::ReleaseResource(
                      a1,
                      (struct DirectComposition::CResourceMarshaler *)(i - 45));
      return (int)v2;
    }
  }
  return (int)v2;
