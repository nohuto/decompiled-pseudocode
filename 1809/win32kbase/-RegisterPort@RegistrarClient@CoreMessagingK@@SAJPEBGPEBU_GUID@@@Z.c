/*
 * XREFs of ?RegisterPort@RegistrarClient@CoreMessagingK@@SAJPEBGPEBU_GUID@@@Z @ 0x1C0084554
 * Callers:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::RegisterPort(const unsigned __int16 *a1, const struct _GUID *a2)
{
  ...
  v14 = 0LL;
  v4 = CoreUICallSend(
         (struct IMessageCallSendHost *)v11,
         (__int64)&v10,
         1u,
         1u,
         7u,
  ...
  if ( dword_1C01C77B8 > 5u )
  {
    ...
    v18 = 16;
    v21 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C77B8, &unk_1C01A33E1, 0LL, 0LL, 5u, &pData);
  }
  return v6;
}
