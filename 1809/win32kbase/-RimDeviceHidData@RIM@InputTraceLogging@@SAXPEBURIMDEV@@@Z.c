/*
 * XREFs of ?RimDeviceHidData@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C010A880
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDeviceHidData(const struct RIMDEV *a1)
{
  ...
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
    {
      ...
      v12 = &v5;
      v13 = v2;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019E474, 0LL, 0LL, 5u, &pData);
    }
  }
}
