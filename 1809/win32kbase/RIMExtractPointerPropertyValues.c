/*
 * XREFs of RIMExtractPointerPropertyValues @ 0x1C0116740
 * Callers:
 ...
 *     SignExtendLong @ 0x1C011A1F0 (SignExtendLong.c)
        ...
        __int64 a7)
{
  ...
  if ( a1 )
  {
    if ( a5 <= *(_DWORD *)(a1 + 328) )
    {
      v14 = (struct _USAGE_AND_PAGE *)Win32AllocPoolZInit(4LL * *(unsigned int *)(a1 + 976), 0x78707355u);
      v46 = v14;
      if ( v14 )
      {
        ...
        {
          v30 = v7;
          if ( *(_DWORD *)(a1 + 348) == (unsigned __int8)*v42 )
          {
            v31[0] = 1;
            v18 = 28LL * v17;
            v45 = v18;
