/*
 * XREFs of ?DisplayPath@InputConfig@InputTraceLogging@@SAXAEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z @ 0x1C0094EB0
 * Callers:
 ...
 *     ?ScalingToString@InputTraceLogging@@CAPEBDW4DISPLAYCONFIG_SCALING@@@Z @ 0x1C0153804 (-ScalingToString@InputTraceLogging@@CAPEBDW4DISPLAYCONFIG_SCALING@@@Z.c)
 */
...
void __fastcall InputTraceLogging::InputConfig::DisplayPath(const struct DISPLAYCONFIG_PATH_INFO_INTERNAL *a1)
{
  ...
  if ( dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 2uLL) )
  {
    ...
    v162 = 4LL;
    v164 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C01A13DA, 0LL, 0LL, 0x38u, &pData);
  }
}
