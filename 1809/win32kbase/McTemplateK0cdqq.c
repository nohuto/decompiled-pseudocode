/*
 * XREFs of McTemplateK0cdqq @ 0x1C00E8B38
 * Callers:
...
ULONG __fastcall McTemplateK0cdqq(
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWrite(a1, &BeginAppMessageProcessing, (LPCGUID)&Context.Flags, 5u, &EventData);
}
