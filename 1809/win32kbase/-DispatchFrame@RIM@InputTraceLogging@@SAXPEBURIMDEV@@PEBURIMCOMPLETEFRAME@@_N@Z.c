/*
 * XREFs of ?DispatchFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMCOMPLETEFRAME@@_N@Z @ 0x1C0125CC4
 * Callers:
        ...
        char a3)
{
  ...
  if ( a3 && dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
  {
    v40 = 0;
    v38 = &v11;
    v11 = a1;
    v39 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019F7AF, 0LL, 0LL, 3u, &pData);
  }
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
    {
      ...
      v34 = &v11;
      v35 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019F7DB, 0LL, 0LL, 9u, &v15);
    }
  }
}
