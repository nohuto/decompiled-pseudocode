/*
 * XREFs of DrvDxgkUpgradeLegacyDpiSettings @ 0x1C0104930
 * Callers:
 *     <none>
 * Callees:
  ...
  *a2 = 0;
  ...
  if ( gppdevList )
  {
    while ( 1 )
    {
      ...
      v10 = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD, _DWORD *))qword_1C01CDD00)(
              a1,
              *(_QWORD *)(v9 + 240),
              *(unsigned int *)(v9 + 256),
              v27);
      ...
      if ( v27[2] != _mm_srli_si128(*v25, 8).m128i_i32[1] )
      {
        ...
        while ( (__int64)v14 < (__int64)&dword_1C01A4094 );
        ...
        while ( (__int64)v15 < (__int64)&dword_1C01A4094 );
        v17 = v13 - v16;
        v18 = v17;
        if ( (int)v26 > v17 )
          v18 = v26;
        ...
        v21 = ((__int64 (__fastcall *)(struct _LUID *, _QWORD, _QWORD, __m128i *))qword_1C01CDCE0)(
                v20,
                v19,
                (unsigned int)v17,
                v25);
