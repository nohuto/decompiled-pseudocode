/*
 * XREFs of McTemplateK0pqqxqttxx @ 0x1C00EA254
 * Callers:
 *     EtwTraceTokenStateChangedEvent @ 0x1C0079F40 (EtwTraceTokenStateChangedEvent.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0050EB8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00A63D0 (__security_check_cookie.c)
 */

ULONG McTemplateK0pqqxqttxx(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWrite(a1, &TokenStateChangedEvent, (LPCGUID)&Context.Flags, 0xAu, &EventData);
}
