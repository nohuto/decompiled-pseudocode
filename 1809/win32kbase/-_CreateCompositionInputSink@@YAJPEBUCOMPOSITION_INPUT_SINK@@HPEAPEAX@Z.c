/*
 * XREFs of ?_CreateCompositionInputSink@@YAJPEBUCOMPOSITION_INPUT_SINK@@HPEAPEAX@Z @ 0x1C0036FF8
 * Callers:
 *     NtCreateImplicitCompositionInputSink @ 0x1C0038AC0 (NtCreateImplicitCompositionInputSink.c)
 *     NtCreateCompositionInputSink @ 0x1C0038B00 (NtCreateCompositionInputSink.c)
 * Callees:
...
__int64 __fastcall _CreateCompositionInputSink(const struct COMPOSITION_INPUT_SINK *a1, unsigned __int8 a2, void **a3)
{
  int v6; // edi
  __int64 v7; // rsi
