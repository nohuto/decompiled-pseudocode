/*
 * XREFs of ?EmitUpdateFontNameCommand@CTextBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0179694
 * Callers:
 *     ?EmitUpdateCommands@CTextBrushMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0179570 (-EmitUpdateCommands@CTextBrushMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
...
char __fastcall DirectComposition::CTextBrushMarshaler::EmitUpdateFontNameCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x40) != 0 && *((_QWORD *)this + 9) )
  {
    v4 = *((_DWORD *)this + 20);
    if ( (v4 & 3) != 0 )
      v4 += 4 - (v4 & 3);
    ...
    *((_DWORD *)v8 + 3) = (*((_QWORD *)this + 10) >> 1) - 1;
    memmove(v8 + 16, *((const void **)this + 9), *((_QWORD *)this + 10));
    *((_DWORD *)this + 4) &= ~0x40u;
  }
  return 1;
}
