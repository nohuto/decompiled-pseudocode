/*
 * XREFs of ?SetHandleProperty@CCompiledEffectTemplateMarshaler@DirectComposition@@UEAAJIPEAXPEA_N@Z @ 0x1C005B650
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  if ( a3 )
  {
    ...
    if ( v8 )
    {
      if ( v8 != 1 )
        return 3221225485LL;
      v9 = (struct DirectComposition::CEvent **)((char *)this + 72);
    }
    else
    {
      v9 = (struct DirectComposition::CEvent **)((char *)this + 80);
    }
