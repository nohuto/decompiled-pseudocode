/*
 * XREFs of ?GetPointerPenInfo@Pointer@InputTraceLogging@@SAXPEBUtagPOINTER_PEN_INFO@@@Z @ 0x1C013D040
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::GetPointerPenInfo(const struct tagPOINTER_PEN_INFO *a1)
{
  ...
  if ( dword_1C01C7F10 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
    {
      ...
      v56 = 4LL;
      v55 = v4 + 29;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019FFB5, 0LL, 0LL, 0x16u, &pData);
    }
  }
}
