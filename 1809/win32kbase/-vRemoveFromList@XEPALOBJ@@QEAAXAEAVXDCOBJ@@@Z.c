/*
 * XREFs of ?vRemoveFromList@XEPALOBJ@@QEAAXAEAVXDCOBJ@@@Z @ 0x1C00632B8
 * Callers:
...
void __fastcall XEPALOBJ::vRemoveFromList(XEPALOBJ *this, struct XDCOBJ *a2, int a3)
{
  HDC v5; // rdx
  HDC v6; // rdx
  struct OBJECT *v7[2]; // [rsp+20h] [rbp-28h] BYREF
  struct OBJECT *v8[3]; // [rsp+30h] [rbp-18h] BYREF
  ...
  if ( *(struct PALETTE **)this != ppalDefault )
  {
    ...
    if ( v5 )
    {
      ...
      if ( v7[0] )
      {
        *((_QWORD *)v7[0] + 124) = *(_QWORD *)(*(_QWORD *)a2 + 992LL);
    ...
    if ( v6 )
    {
      ...
      if ( v8[0] )
      {
        *((_QWORD *)v8[0] + 123) = *(_QWORD *)(*(_QWORD *)a2 + 984LL);
