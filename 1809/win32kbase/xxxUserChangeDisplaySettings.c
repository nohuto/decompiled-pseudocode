/*
 * XREFs of xxxUserChangeDisplaySettings @ 0x1C004B2B0
 * Callers:
 ...
 *     _xxxUserChangeDisplaySettings_::_2_::_AUTO_KM::__AUTO_KM @ 0x1C004B8E8 (_xxxUserChangeDisplaySettings_--_2_--_AUTO_KM--__AUTO_KM.c)
...
LABEL_20:
  ...
  v19 = Win32AllocPoolZInit(0x90uLL, 0x64437355u);
  v21 = (__int64)v19;
  if ( v19 )
  {
    *v19 = 4;
    ...
    *(_DWORD *)(v21 + 52) = v18;
    ...
    ((void (__fastcall *)(__int64, __int64, char *))qword_1C01CD968)(v21, v25, v20);
    v58 = MEMORY[0xFFFFF78000000320];
    v54 = v58 * KeQueryTimeIncrement();
    EtwActivityIdControl(3u, &ActivityId);
    v30 = dword_1C01C3348;
    if ( dword_1C01C3348 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C3348, 0x200000000004uLL) )
    {
      ...
      v94 = &v33;
      v95 = 1LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C3348, &unk_1C019D871, &ActivityId, 0LL, 9u, &pData);
      v30 = dword_1C01C3348;
    }
    if ( (*(_DWORD *)(v21 + 140) & 1) != 0 && v30 > 5 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C3348, 0x200000000004uLL) )
      {
        v43 = *(_DWORD *)(v21 + 64);
        v62 = &v43;
        v63 = 4LL;
        ...
        v80 = &v52;
        v81 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C01C3348, &unk_1C019D7E4, &ActivityId, 0LL, 0xCu, &v61);
      }
    }
    Win32FreePool(v21);
  }
