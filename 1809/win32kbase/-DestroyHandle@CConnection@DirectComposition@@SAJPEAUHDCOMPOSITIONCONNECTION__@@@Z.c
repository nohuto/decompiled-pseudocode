/*
 * XREFs of ?DestroyHandle@CConnection@DirectComposition@@SAJPEAUHDCOMPOSITIONCONNECTION__@@@Z @ 0x1C0058B24
 * Callers:
 ...
 *     NtDCompositionDestroyConnection @ 0x1C01663C0 (NtDCompositionDestroyConnection.c)
 * Callees:
