/*
 * XREFs of GetMonitorPhysicalDimensions @ 0x1C0105910
 * Callers:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    {
      memset(v17, 0, 0x3A4uLL);
      v17[0] = 0x3A4FFFFFFF9LL;
      v17[1] = *(_QWORD *)(v13 + 20LL * v10 + 8);
      LODWORD(v17[2]) = *(_DWORD *)(v13 + 20LL * v10 + 4);
      if ( (int)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD *, _QWORD, _QWORD))qword_1C01CD938)(
                  v17[1],
                  LODWORD(v17[2]),
                  v17,
                  0LL,
