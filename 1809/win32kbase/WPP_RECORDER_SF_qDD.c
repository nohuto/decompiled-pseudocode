/*
 * XREFs of WPP_RECORDER_SF_qdd @ 0x1C0121E34
 * Callers:
...
__int64 WPP_RECORDER_SF_qdd(_DWORD a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  __int64 v6; // rdi
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(v6, 3LL, 21LL, &WPP_6348e708fd723b9140a504851f6d1be1_Traceguids, v8, (__int64 *)va);
}
