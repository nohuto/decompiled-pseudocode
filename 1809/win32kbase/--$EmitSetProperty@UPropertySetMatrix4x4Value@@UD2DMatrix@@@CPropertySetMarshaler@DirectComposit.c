/*
 * XREFs of ??$EmitSetProperty@UPropertySetMatrix4x4Value@@UD2DMatrix@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C0008ED8
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v3 = 0;
  v7 = 1;
  if ( (unsigned __int64)(4096LL - *(_QWORD *)(*((_QWORD *)*a2 + 17) + 40LL)) < 0x5C
    && !DirectComposition::CBatch::AllocateNewFragment(a2, (unsigned __int64 *)&v11) )
  {
    return 0;
  }
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x5CuLL, &v11);
  v8 = (char *)v11;
  *(_DWORD *)v11 = 92;
  *(_QWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 12) = 0LL;
  ...
  *((_DWORD *)v8 + 6) = v3;
  Property = (_OWORD *)PropertySetStorage<CDynamicArrayDefaultTag,PropertySetKernelModeAllocator>::GetPropertyValue<D2DVector3>(
                         a1 + 56,
                         a3);
  *(_OWORD *)(v8 + 28) = *Property;
  *(_OWORD *)(v8 + 44) = Property[1];
  *(_OWORD *)(v8 + 60) = Property[2];
  *(_OWORD *)(v8 + 76) = Property[3];
