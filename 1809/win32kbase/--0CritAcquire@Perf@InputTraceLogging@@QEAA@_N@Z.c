/*
 * XREFs of ??0CritAcquire@Perf@InputTraceLogging@@QEAA@_N@Z @ 0x1C0028B38
 * Callers:
  ...
  if ( LOBYTE(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink) )
  {
    ...
    *(_QWORD *)this = CurrentThreadWin32Thread;
    if ( CurrentThreadWin32Thread )
    {
      ...
      if ( v7 > 0 || *(_DWORD *)(*(_QWORD *)this + 48LL) )
      {
        EtwActivityIdControl(3u, v2);
        if ( dword_1C01C7F10 > 6u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x2000uLL) )
        {
          ...
          v12 = 4;
          v15 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019D532, v2, 0LL, 5u, &pData);
        }
      }
    }
  }
