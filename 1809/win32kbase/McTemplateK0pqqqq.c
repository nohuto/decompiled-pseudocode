/*
 * XREFs of McTemplateK0pqqqq @ 0x1C00EA1AC
 * Callers:
 *     EtwDirtyRectUpdate @ 0x1C0070AD0 (EtwDirtyRectUpdate.c)
 *     EtwTraceInternalSetTimer @ 0x1C0070C50 (EtwTraceInternalSetTimer.c)
 *     EtwTraceTimerProc @ 0x1C0072320 (EtwTraceTimerProc.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C0107CB0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C0107CF0 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C0108090 (EtwTranslationUpdate.c)
 * Callees:
