/*
 * XREFs of ?UnmarshalReceive@ReceiveProcessor@Calling@CoreMessaging@@QEAAJPEAUIMessageCallReceiveHost@@PEBUMsgCallTypeDefinition@@PEBEIPEBXI@Z @ 0x1C008CCE0
 * Callers:
      ...
      *((_QWORD *)this + 18) = v21;
      ...
      else
      {
        ...
        *((_DWORD *)this + 20) = v22;
        if ( v22 )
        {
          *(_QWORD *)this = Microsoft::CoreUI::MessageCall::CoreMessagingK_g_parameters_H5Wp72av4ZcH1gZZdHHu5eQzAOQ_IRegistrar;
          v23 = &Microsoft::CoreUI::MessageCall::CoreMessagingK_g_parameters_H5Wp72av4ZcH1gZZdHHu5eQzAOQ_IRegistrar[*(unsigned __int16 *)(v21 + 8)];
          *(_QWORD *)this = v23;
          if ( v23 >= byte_1C01943D4
            || v23 < Microsoft::CoreUI::MessageCall::CoreMessagingK_g_parameters_H5Wp72av4ZcH1gZZdHHu5eQzAOQ_IRegistrar )
          {
            *(_DWORD *)v11 = 202;
          }
          else
