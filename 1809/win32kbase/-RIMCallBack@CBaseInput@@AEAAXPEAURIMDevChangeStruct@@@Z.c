/*
 * XREFs of ?RIMCallBack@CBaseInput@@AEAAXPEAURIMDevChangeStruct@@@Z @ 0x1C004E0AC
 * Callers:
 *     ?_RIMCallBack@CBaseInput@@CAXPEAURIMDevChangeStruct@@@Z @ 0x1C004E090 (-_RIMCallBack@CBaseInput@@CAXPEAURIMDevChangeStruct@@@Z.c)
 * Callees:
...
void __fastcall CBaseInput::RIMCallBack(CBaseInput *this, struct RIMDevChangeStruct *a2)
{
  ...
  if ( (unsigned int)v7 < 5 )
  {
    ...
    if ( *((_DWORD *)&off_1C018DED0 + 4 * (unsigned int)v7 + 2) != *(_DWORD *)a2 )
    ...
    v17 = ((__int64 (__fastcall *)(CBaseInput *, unsigned __int64))*(&off_1C018DED0 + v8))(this, v2);
    if ( *(_DWORD *)a2 == 1 )
    {
      if ( v13 )
