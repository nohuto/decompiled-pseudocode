/*
 * XREFs of ?Shutdown@CApplicationChannel@DirectComposition@@MEAAXXZ @ 0x1C0059D70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DirectComposition::CApplicationChannel::Shutdown(DirectComposition::CApplicationChannel *this)
{
  ...
  *((_DWORD *)this + 6) = v3;
  ...
  if ( g_pInputManager )
  {
    ...
    v11 = g_pInputManager;
    for ( i = 0LL; (unsigned int)i < *((_DWORD *)g_pInputManager + 30); v11 = g_pInputManager )
    {
      v17 = (_QWORD *)((char *)v11 + 112);
