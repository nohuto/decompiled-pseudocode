/*
 * XREFs of ?Initialize@CApplicationChannel@DirectComposition@@IEAAJPEAIPEAPEAX@Z @ 0x1C005BCE4
 * Callers:
        ...
        void **a3)
{
  ...
  if ( v13 )
  {
    ...
    *((_DWORD *)this + 178) = v14;
    ...
    if ( Batch < 0 )
      goto LABEL_31;
    v15 = (PVOID *)((char *)this + 704);
    v25 = v14;
    Batch = MmCreateSection((char *)this + 704, 6LL, 0LL, &v25, 4, 138412032, 0LL, 0LL);
    if ( Batch < 0 )
      goto LABEL_31;
    Batch = MmMapViewInSessionSpace(*v15, (PVOID *)this + 90, &ViewSize);
    if ( Batch < 0 )
      goto LABEL_31;
    v16 = *((_QWORD *)this + 85);
    v17 = *v15;
