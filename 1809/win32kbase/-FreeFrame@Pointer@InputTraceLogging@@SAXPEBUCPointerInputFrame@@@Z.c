/*
 * XREFs of ?FreeFrame@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@@Z @ 0x1C0138B74
 * Callers:
...
void __fastcall InputTraceLogging::Pointer::FreeFrame(const struct CPointerInputFrame *a1)
{
  ...
  if ( dword_1C01C7F10 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x20uLL) )
    {
      ...
      v8 = 8LL;
      v10 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C01A040E, 0LL, 0LL, 5u, &pData);
    }
  }
}
