/*
 * XREFs of NtDCompositionSynchronize @ 0x1C000E9A0
 * Callers:
 *     <none>
 * Callees:
 *     ?Synchronize@CSynchronizationManager@DirectComposition@@SAJPEAVCBatch@2@@Z @ 0x1C000EA6C (-Synchronize@CSynchronizationManager@DirectComposition@@SAJPEAVCBatch@2@@Z.c)
