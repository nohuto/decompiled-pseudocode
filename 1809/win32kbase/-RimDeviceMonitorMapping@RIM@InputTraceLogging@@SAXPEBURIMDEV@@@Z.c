/*
 * XREFs of ?RimDeviceMonitorMapping@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C010A950
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimDeviceMonitorMapping(const struct RIMDEV *a1)
{
  ...
  if ( dword_1C01C7F10 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
  {
    ...
    TlgCreateWsz(&v22, (LPCWSTR)(v9 + 1212));
    TlgCreateWsz(&v23, (LPCWSTR)(v10 + 1468));
    v12 = v11[432];
    v24 = &v13;
    v14 = v11[431];
    v26 = &v14;
    ...
    v29 = 4LL;
    v31 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019E4C1, 0LL, 0LL, 0xAu, &pData);
  }
}
