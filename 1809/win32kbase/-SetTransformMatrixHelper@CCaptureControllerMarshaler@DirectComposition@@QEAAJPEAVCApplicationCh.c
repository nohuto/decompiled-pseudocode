/*
 * XREFs of ?SetTransformMatrixHelper@CCaptureControllerMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEBX_KPEA_N@Z @ 0x1C017C054
 * Callers:
 *     ?SetBufferProperty@CCaptureControllerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C017BDC0 (-SetBufferProperty@CCaptureControllerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2.c)
 * Callees:
        ...
        bool *a5)
{
  ...
  {
    v7 = 1;
    v12 = DirectComposition::CApplicationChannel::CreateInternalResource(a2, 0x62u, &v17);
    v11 = v17;
    v13 = v12;
    if ( v12 < 0 )
      goto LABEL_8;
