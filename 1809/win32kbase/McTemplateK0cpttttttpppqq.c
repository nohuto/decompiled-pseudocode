/*
 * XREFs of McTemplateK0cpttttttpppqq @ 0x1C00E9190
 * Callers:
...
ULONG __fastcall McTemplateK0cpttttttpppqq(
        ...
        char a16)
{
  ...
  v43 = 4LL;
  v45 = 4LL;
  return McGenEventWrite(a1, a2, (LPCGUID)&Context.Flags, 0xEu, &EventData);
}
