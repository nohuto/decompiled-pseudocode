/*
 * XREFs of ?DrvValidateAndApplyDevMode@@YAJPEAU_DISPLAYCONFIG_CDS_REQUEST@@PEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00496B8
 * Callers:
        ...
        __int64 a3)
{
  ...
  v43 = -2;
  v44 = -2;
  v7 = ((__int64 (__fastcall *)(int *))qword_1C01CD8D8)(&v39);
  v11 = v7;
  ...
  if ( v7 == -1073741266 )
  {
    *((_DWORD *)a1 + 13) = 2;
    *((_DWORD *)a1 + 12) = -2;
    v32 = (_QWORD *)WdLogNewEntry5_WdWarning(v9);
    v32[3] = -1073741266LL;
    v32[4] = *((_QWORD *)a1 + 4);
    v32[5] = *((int *)a1 + 13);
    v32[6] = *((int *)a1 + 12);
...
LABEL_15:
  ...
  if ( *((_DWORD *)a1 + 4) && v46 )
    ...
    v21 = 0;
  v39 = v21 | (v46 == 0 ? 0x10 : 0) | (*((_DWORD *)a1 + 2) != 0 ? 2 : 0);
  v40 = *(_QWORD *)(v5 + 248);
  v22 = *(_DWORD *)(v5 + 256);
  v42 = -1;
  v41 = v22;
  ...
  v45 = v23;
  if ( v24 || *((_DWORD *)a1 + 6) )
    v25 = ((__int64 (__fastcall *)(struct D3DKMT_GETPATHSMODALITY **, int *))qword_1C01CDCD8)(a2, &v39);
  else
    v25 = ((__int64 (__fastcall *)(int *))qword_1C01CD8D8)(&v39);
  v29 = v25;
  if ( v25 >= 0 )
    return 0LL;
  *((_DWORD *)a1 + 12) = -1;
