/*
 * XREFs of ?SetQFrameNonCoalescable@CTouchProcessor@@AEAAHPEBUCPointerInputFrame@@PEBUCPointerInfoNode@@@Z @ 0x1C014561C
 * Callers:
        ...
        const struct CPointerInfoNode *a3)
{
  ...
  result = 1LL;
  *(_DWORD *)(224LL * (unsigned int)v11 + v12 + 204) &= ~1u;
  return result;
}
