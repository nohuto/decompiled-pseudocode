/*
 * XREFs of McTemplateK0xqxq @ 0x1C0108600
 * Callers:
 *     EtwPhysicalSurfCreateEvent @ 0x1C007DC90 (EtwPhysicalSurfCreateEvent.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0050EB8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00A63D0 (__security_check_cookie.c)
 */

ULONG McTemplateK0xqxq(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite(a1, &PhysicalSurfCreateEvent, (LPCGUID)&Context.Flags, 5u, &EventData);
}
