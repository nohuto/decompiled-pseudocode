/*
 * XREFs of ?CitDPMemoizationInitialize@@YAXPEAU_CIT_DP_MEMOIZATION_CONTEXT@@PEBU_CIT_DP_CALC_CONTEXT@@II@Z @ 0x1C01838E8
 * Callers:
 ...
 *     ?CitpDPSampleBitWithProbability@@YAEN@Z @ 0x1C01846D4 (-CitpDPSampleBitWithProbability@@YAEN@Z.c)
 */
