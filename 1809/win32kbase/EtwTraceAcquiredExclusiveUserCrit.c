/*
 * XREFs of EtwTraceAcquiredExclusiveUserCrit @ 0x1C0028DCC
 * Callers:
...
__int64 EtwTraceAcquiredExclusiveUserCrit()
{
  ...
  if ( result )
  {
    ...
    v5 = PerformanceCounter.QuadPart - *(_QWORD *)(v1 + 8);
    QuadPart = (void *)PerformanceCounter.QuadPart;
    v7 = (W32kEtwEnabledKeyword & 0x200000010000000LL) == 0;
    *(LARGE_INTEGER *)(v1 + 8) = PerformanceCounter;
      ...
      && SBYTE2(Microsoft_Windows_Win32kEnableBits) < 0 )
    {
      ...
      McTemplateK0xqx(v3, (unsigned int)&AcquiredExclusiveUserCritEvent, v4, v5, 0, gullUserCritAcquireToken);
    }
    if ( v5 >= *((__int64 *)&WPP_MAIN_CB.Reserved + 1)
      && (signed __int64)((__int64)QuadPart - (unsigned __int64)WPP_MAIN_CB.Reserved) >= W32KEtwUserCritTelemetryThrottleQPC )
    {
      if ( (BYTE4(Microsoft_Windows_Win32kEnableBits) & 0x10) != 0 )
        McTemplateK0xqx(
          ...
          v4,
          v5,
          1000000 * v5 / gliQpcFreq.QuadPart,
          gullUserCritAcquireToken);
