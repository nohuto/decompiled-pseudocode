/*
 * XREFs of ?Initialize@?$CLookAsideTypeIsolation@$0JAAA@$0JA@@NSInstrumentation@@QEAA_NXZ @ 0x1C0066FF0
 * Callers:
...
bool __fastcall NSInstrumentation::CLookAsideTypeIsolation<36864,144>::Initialize(__int64 a1)
{
  ExInitializeLookasideListEx(
    ...
    lambda_6493bb42a6ebd8bb32b97ba0eb0d18a2_::_lambda_invoker_cdecl__enum__POOL_TYPE_unsigned___int64_unsigned_long__LOOKASIDE_LIST_EX_____ptr64_,
    lambda_4244bae6fa0a501e9e28a4e0afb3a818_::_lambda_invoker_cdecl__void_____ptr64__LOOKASIDE_LIST_EX_____ptr64_,
    (POOL_TYPE)512,
    2u,
    0x90uLL,
    0x616C6947u,
