/*
 * XREFs of ?xxxAdjustPushState@@YAXPEAUtagTHREADINFO@@EEPEAUtagKL@@1@Z @ 0x1C014E124
 * Callers:
        ...
        struct tagKL *a5)
{
  ...
  if ( a2 )
  {
    ...
    if ( ((unsigned __int8)v12 & gafRawKeyState[v11]) != 0
      ...
      || (*(_BYTE *)(*((_QWORD *)a1 + 54) + v11 + 228) & (unsigned __int8)v12) != 0 )
    {
  ...
  if ( a3 )
  {
    ...
    if ( ((unsigned __int8)v16 & gafRawKeyState[v15]) != 0
      ...
      || (*(_BYTE *)(*((_QWORD *)a1 + 54) + v15 + 228) & (unsigned __int8)v16) != 0 )
    {
