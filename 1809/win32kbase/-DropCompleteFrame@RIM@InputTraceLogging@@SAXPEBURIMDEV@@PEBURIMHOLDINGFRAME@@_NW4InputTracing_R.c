/*
 * XREFs of ?DropCompleteFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMHOLDINGFRAME@@_NW4InputTracing_RimCompletionReason@@@Z @ 0x1C0122860
 * Callers:
...
char __fastcall InputTraceLogging::RIM::DropCompleteFrame(__int64 a1, __int64 a2, unsigned __int8 a3, int a4)
{
  ...
  {
    LOBYTE(v4) = TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL);
    if ( (_BYTE)v4 )
    {
      v11 = *(_QWORD *)(a1 + 472);
      v25 = 0;
      ...
      LOBYTE(v4) = TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019F188, 0LL, 0LL, 0xAu, &pData);
    }
  }
  return (char)v4;
}
