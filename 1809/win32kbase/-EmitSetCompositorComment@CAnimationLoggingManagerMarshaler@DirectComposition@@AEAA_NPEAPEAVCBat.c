/*
 * XREFs of ?EmitSetCompositorComment@CAnimationLoggingManagerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C006E438
 * Callers:
 ...
 *     ?StringCchLengthW@@YAJPEBG_KPEA_K@Z @ 0x1C006E558 (-StringCchLengthW@@YAJPEBG_KPEA_K@Z.c)
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  {
    v5 = (const unsigned __int16 *)*((_QWORD *)this + 29);
    v6 = 0LL;
    v12 = 0LL;
    if ( v5 )
    {
      ...
      && (unsigned __int64)v12 >= v9 )
    {
      ...
      *((_DWORD *)v10 + 3) = (_DWORD)v6;
      memmove(v10 + 16, *((const void **)this + 29), 2LL * (_QWORD)v6);
      *((_BYTE *)this + 240) &= ~1u;
    }
    else
    {
