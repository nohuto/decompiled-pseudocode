/*
 * XREFs of CoreMsgObjectCallout @ 0x1C0089A1C
 * Callers:
...
__int64 __fastcall CoreMsgObjectCallout(unsigned int a1, _QWORD *a2)
{
  ...
  if ( dword_1C01C77B8 > 5u )
  {
    ...
    v13 = a1;
    v16 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C77B8, &unk_1C01A30BA, 0LL, 0LL, 3u, &pData);
  }
...
LABEL_9:
  ...
  if ( dword_1C01C77B8 > 5u )
  {
    ...
    v15 = &v13;
    v16 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C77B8, &unk_1C01A30EF, 0LL, 0LL, 3u, &pData);
  }
  if ( v12[0] )
    KeReleaseMutex(P, 0);
  return v7;
