/*
 * XREFs of rimGetCompleteFrameAndReleaseHoldingFrame @ 0x1C01238D0
 * Callers:
      ...
      *((_QWORD *)v17 + 11) = v17 + 24;
      ...
      while ( v22 )
      {
        while ( 1 )
        {
          ...
          *(_QWORD *)(v23 + 16) = 0LL;
          v22 = *(_QWORD *)(v22 + 16);
          v11 = (v25 & 0xFFFFFFF8) + 24;
          v26 = 0LL;
          if ( v22 )
          {
            v26 = v23 + (unsigned int)v11;
            *(_QWORD *)(v23 + 16) = v26;
            v22 = *(_QWORD *)v12;
          }
          v23 = v26;
        ...
        if ( !v22 )
          break;
LABEL_29:
        MicrosoftTelemetryAssertTriggeredNoArgsKM(v11, v12, v24);
      }
      *a3 = v17;
      v3 = 1;
    }
