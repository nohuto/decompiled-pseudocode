/*
 * XREFs of McTemplateK0tt @ 0x1C00EB4AC
 * Callers:
...
ULONG __fastcall McTemplateK0tt(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v12 = 0;
  v11 = 4;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)4, &StartWaitForVideoPortCalloutReady, (LPCGUID)&Context.Flags, 3u, &v6);
}
