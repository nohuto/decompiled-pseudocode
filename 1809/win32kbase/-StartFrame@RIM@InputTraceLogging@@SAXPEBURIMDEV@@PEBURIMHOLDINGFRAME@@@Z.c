/*
 * XREFs of ?StartFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMHOLDINGFRAME@@@Z @ 0x1C01229EC
 * Callers:
...
void __fastcall InputTraceLogging::RIM::StartFrame(const struct RIMDEV *a1, const struct RIMHOLDINGFRAME *a2)
{
  ...
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
    {
      ...
      v17 = &v7;
      v18 = v4;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019F143, 0LL, 0LL, 6u, &pData);
    }
  }
}
