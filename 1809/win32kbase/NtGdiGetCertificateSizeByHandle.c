/*
 * XREFs of NtGdiGetCertificateSizeByHandle @ 0x1C00A06B0
 * Callers:
 *     <none>
 * Callees:
 *     SafelyCopyKernelModeDataToUserModeData_unsigned_long_ @ 0x1C00A06EC (SafelyCopyKernelModeDataToUserModeData_unsigned_long_.c)
