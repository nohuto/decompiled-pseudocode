/*
 * XREFs of xxxODI_ColorInit @ 0x1C00467D0
 * Callers:
 *     InitUserScreen @ 0x1C0098FE4 (InitUserScreen.c)
 * Callees:
 *     xxxSetSysColors @ 0x1C0042B34 (xxxSetSysColors.c)
 *     ?CI_GetClrVal@@YAKPEAGK@Z @ 0x1C0046A3C (-CI_GetClrVal@@YAKPEAGK@Z.c)
...
__int64 __fastcall xxxODI_ColorInit(__int64 a1)
{
  ...
  *(_OWORD *)(v1 + 4584) = xmmword_1C0196B70;
  *(_OWORD *)(v1 + 4600) = xmmword_1C0196B80;
  *(_OWORD *)(v1 + 4616) = xmmword_1C0196B90;
  *(_OWORD *)(v1 + 4632) = xmmword_1C0196BA0;
  *(_OWORD *)(v1 + 4648) = xmmword_1C0196BB0;
  *(_OWORD *)(v1 + 4664) = xmmword_1C0196BC0;
