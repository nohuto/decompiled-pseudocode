/*
 * XREFs of ?SetLastAction@Telemetry@CPTPProcessor@@SAXW4tagPTP_ACTION@@@Z @ 0x1C014BE00
 * Callers:
...
char __fastcall CPTPProcessor::Telemetry::SetLastAction(int a1)
{
  ...
  v3 = (unsigned __int64)(1000
                        * (PerformanceCounter.QuadPart - _InterlockedCompareExchange64(&qword_1C01D1470, 0LL, 0LL)))
     / gliQpcFreq.QuadPart;
  v11 = v3;
  if ( v3 <= 500 )
  {
    _InterlockedCompareExchange64(&qword_1C01D1460, 0LL, 0LL);
    LOBYTE(v3) = _InterlockedCompareExchange64(&qword_1C01D1468, 0LL, 0LL);
    v9 = dword_1C01D147C;
    if ( hProvider > 5u )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v21 = &v13;
        v23 = &v9;
        LOBYTE(v3) = TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01A0C13, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  if ( dword_1C01CBCE8 || qword_1C01CBCD0 || gTPTelemTimings <= 0 )
    dword_1C01CBCEC = a1;
  else
    dword_1C01CBCE8 = a1;
  if ( a1 > 12 )
...
LABEL_57:
  if ( hProvider > 5u )
  {
    ...
    v26 = &v10;
    v27 = 4LL;
    LOBYTE(v3) = TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C01A0BEE, 0LL, 0LL, 3u, &v25);
  }
  return v3;
}
