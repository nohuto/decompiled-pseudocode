/*
 * XREFs of ?ulDispatchGFPEFunction@XEPALOBJ@@QEAAKW4GFPE_FUNCTION_ID@@K@Z @ 0x1C005D7E0
 * Callers:
 ...
 * Callees:
 *     ?ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z @ 0x1C005D90C (-ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z.c)
