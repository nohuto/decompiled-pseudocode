/*
 * XREFs of ?EmitUpdateCommands@CInteractionMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0047D80
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( !DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x18uLL, &v18) )
      return 0;
    v13 = (char *)v18;
    *(_DWORD *)v18 = 24;
    *(_QWORD *)(v13 + 4) = 0LL;
    ...
    *((_QWORD *)v13 + 2) = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 35) + 8 * v12) + 8LL);
