/*
 * XREFs of ?SetPointerImplicitCapture@CTouchProcessor@@AEAAH_KAEBVCInputDest@@HH@Z @ 0x1C0144B2C
 * Callers:
        ...
        int a5)
{
  ...
  return CTouchProcessor::SetPointerCapture((__int64)this, a2, a3, 1, a4, a5);
}
