/*
 * XREFs of ?ReleaseLockAndEntry@GdiHandleManager@@QEAAXPEAVOBJECT@@@Z @ 0x1C0020DB4
 * Callers:
...
void __fastcall GdiHandleManager::ReleaseLockAndEntry(GdiHandleManager *this, struct OBJECT *a2)
{
  ...
  v3 = gpHandleManager;
  v4 = GdiHandleManager::DecodeIndex(gpHandleManager, (unsigned __int16)*(_DWORD *)a2 | (*(_DWORD *)a2 >> 8) & 0xFF0000);
