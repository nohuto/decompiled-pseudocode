/*
 * XREFs of ?ProcessTapsFor3orMoreContacts@CPTPEngine@@AEAAHPEAUPTPInput@@K@Z @ 0x1C015D3F8
 * Callers:
 ...
 *     ?SuppressContactForMultiFingerTap@CPTPEngine@@AEAAHPEBUCContactState@@@Z @ 0x1C015F26C (-SuppressContactForMultiFingerTap@CPTPEngine@@AEAAHPEBUCContactState@@@Z.c)
 */
...
LABEL_34:
  ...
  {
    *((_DWORD *)this + 824) = v24 & 0xFEFFFFFF;
    return 0LL;
  }
