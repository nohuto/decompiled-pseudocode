/*
 * XREFs of ?ResolveInputSinkToINPUTDEST@CSpatialProcessor@@IEAA_NPEAXKPEAUtagINPUTDEST@@@Z @ 0x1C0001E68
 * Callers:
...
LABEL_7:
    ...
    *((_QWORD *)&v37[5] + 1) = v20;
    ...
    if ( v38 == 2 )
    {
      ...
      if ( Object[0] )
      {
        ...
        *((PVOID *)&v37[4] + 1) = Object[0];
        ...
        DWORD1(v37[5]) = 2;
        if ( (*(_DWORD *)(*(_QWORD *)(v22 + 424) + 820LL) & 0x800000) != 0 )
          v21 = 0;
        HIDWORD(v37[0]) = v21;
      }
      goto LABEL_12;
    ...
    if ( (unsigned int)(v38 - 3) <= 1 )
    {
      ...
      if ( Object[0] )
      {
        v35 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)Object[0] + 2) + 424LL) + 820LL);
        if ( (v35 & 0x400000) != 0 )
        {
          LODWORD(v37[0]) |= 4u;
          DWORD1(v37[5]) = 1;
