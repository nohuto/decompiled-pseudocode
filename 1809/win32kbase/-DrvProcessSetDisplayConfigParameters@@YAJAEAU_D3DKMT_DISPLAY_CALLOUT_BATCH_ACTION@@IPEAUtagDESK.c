/*
 * XREFs of ?DrvProcessSetDisplayConfigParameters@@YAJAEAU_D3DKMT_DISPLAY_CALLOUT_BATCH_ACTION@@IPEAUtagDESKTOP@@PEAEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0101D60
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a5)
{
  ...
  if ( !v5 )
  {
    v14 = (_QWORD *)WdLogNewEntry5_WdAssertion(v10, a2, a3);
    v14[3] = v6;
    v14[4] = v11;
    v14[5] = a3;
  ...
  v32 = 0;
  v15 = (a2 & 0x20F) != 0 ? 4 : 2;
  result = DrvGetDisplayConfigBufferSizes(v15, (__int64)&v32, (__int64)a3);
  if ( (int)result >= 0 )
  {
    v16 = v32;
    v31 = v32;
    ...
    if ( v17 )
    {
      v9 = (struct DISPLAYCONFIG_PATH_INFO_INTERNAL *)PALLOCMEM2((unsigned int)(200 * v17), 1936876615LL, 1);
      if ( !v9 )
        return 3221225495LL;
      v17 = v32;
      v16 = v31;
    ...
    {
      v19 = v16;
      DisplayConfig = DrvQueryDisplayConfig(v15, (__int64)&v26, (__int64)v9, v18);
      if ( DisplayConfig < 0 )
        break;
      if ( v26 != v31 )
      {
