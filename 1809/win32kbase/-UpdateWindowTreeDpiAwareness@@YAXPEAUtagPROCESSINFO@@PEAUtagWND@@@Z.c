/*
 * XREFs of ?UpdateWindowTreeDpiAwareness@@YAXPEAUtagPROCESSINFO@@PEAUtagWND@@@Z @ 0x1C0025C6C
 * Callers:
  ...
  if ( v4 )
  {
    for ( i = (unsigned __int64 *)(v4 + 32); ; ++i )
    {
      ...
      if ( (unsigned __int64)(unsigned __int16)v6 < *((_QWORD *)gpsi + 1) )
      {
        ...
        v10 = v6 >> 16;
        v11 = (char *)qword_1C01CBA58 + (unsigned int)(v8 * dword_1C01CBA60);
        v12 = 3 * ((__int64)(unsigned int)(v8 * dword_1C01CBA60) >> 5);
          ...
          && v11[24] == 1 )
        {
          ...
          if ( v13 )
          {
            if ( (int)IsUpdateWindowMonitorSupported() >= 0
              && *(struct tagPROCESSINFO **)(*(_QWORD *)(v13 + 16) + 424LL) == a1 )
            {
