/*
 * XREFs of ?IsMessageDelegated@CPointerInfoNode@@QEBAHI@Z @ 0x1C013F070
 * Callers:
 ...
 * Callees:
 *     ?IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z @ 0x1C013F04C (-IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z.c)
