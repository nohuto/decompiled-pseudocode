/*
 * XREFs of EtwTraceMouseInputApc @ 0x1C00E7940
 * Callers:
...
ULONG __fastcall EtwTraceMouseInputApc(struct _MCGEN_TRACE_CONTEXT *a1)
{
  ULONG result; // eax

  if ( (BYTE3(Microsoft_Windows_Win32kEnableBits) & 0x20) != 0 )
    return McTemplateK0(a1, &MouseInputApc, (const GUID *)&Context.Flags);
  return result;
}
