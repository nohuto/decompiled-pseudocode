/*
 * XREFs of RIMGetPointerDeviceProperties @ 0x1C0117A90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RIMGetPointerDeviceProperties(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (unsigned int)rimHidP_GetSpecificValueCaps(0, 0, v6, 0, 0LL, (__int64)v29, v33) != -1072627705 )
    return 0LL;
  v15 = Win32AllocPoolZInit(72LL * (v29[0] + (unsigned int)v7), 0x63767355u);
  if ( v15 )
  {
...
LABEL_20:
        ...
        else
        {
          ...
          v5 = Win32AllocPoolZInit(72 * v19, 0x63767355u);
          if ( v5 )
          {
            if ( *(_DWORD *)(a1 + 24) == 7 )
              v6 = 0;
