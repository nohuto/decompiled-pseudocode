/*
 * XREFs of ?CreateInstance@IOCPDispatcher@@SAJPEAPEAV1@@Z @ 0x1C0091E18
 * Callers:
 ...
 *     CreateKernelIocp @ 0x1C0092010 (CreateKernelIocp.c)
...
__int64 __fastcall IOCPDispatcher::CreateInstance(struct IOCPDispatcher **a1)
{
  ...
  *(_QWORD *)(v1 + 2744) = KernelIocp;
  ...
  if ( v4 )
  {
    WPP_MAIN_CB.Queue.Wcb.DeviceContext = (PVOID)v1;
    return 0LL;
  }
  else
  {
