/*
 * XREFs of ?EmitUpdateCommands@CGenericInkMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C016A640
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CGenericInkMarshaler::EmitSegmentUpdate(this, (struct DirectComposition::CBatch ***)a2) )
  {
    ...
    if ( (v7 & 0x80u) != 0 )
      return 1;
    if ( DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_4ff22403b6cb64976489fdfb95b87542___(
           (__int64)this,
           a2,
           (__int64)&v9) )
    {
