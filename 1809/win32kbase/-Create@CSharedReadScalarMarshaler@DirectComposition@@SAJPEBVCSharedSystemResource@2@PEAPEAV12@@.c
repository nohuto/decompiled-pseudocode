/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01819B0
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C0181B80 (CreateSharedReadScalarMarshaler.c)
 * Callees:
