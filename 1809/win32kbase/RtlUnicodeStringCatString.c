/*
 * XREFs of RtlUnicodeStringCatString @ 0x1C0113B74
 * Callers:
 *     RIMComputePTPCurtainRegions @ 0x1C01128C0 (RIMComputePTPCurtainRegions.c)
 * Callees:
 *     RtlUnicodeStringValidateDestWorker @ 0x1C0113C4C (RtlUnicodeStringValidateDestWorker.c)
 *     RtlWideCharArrayCopyStringWorker @ 0x1C0113CD0 (RtlWideCharArrayCopyStringWorker.c)
 */
