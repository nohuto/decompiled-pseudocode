/*
 * XREFs of RIMIDEAdoptOrphanedRimDevs @ 0x1C008D4EC
 * Callers:
 ...
 *     RIMIDEIsCompatibleDevice @ 0x1C011F83C (RIMIDEIsCompatibleDevice.c)
...
LABEL_47:
  ...
  while ( 1 )
  {
    ...
    *v13 = v13;
    ...
    {
      v25 = (_QWORD *)(v13[45] + 856LL);
      v26 = *v25;
      if ( *(_QWORD **)(*v25 + 8LL) != v25 )
        goto LABEL_47;
      v27 = *(_QWORD **)(v13[45] + 864LL);
      if ( (_QWORD *)*v27 != v25 )
        goto LABEL_47;
      *v27 = v26;
      *(_QWORD *)(v26 + 8) = v27;
    ...
    RIMRemoveHoldingFrame((__int64)v14, (__int64)v15);
    v14[14] = 0LL;
    ...
    *v12 = Object;
    ...
    if ( Object[80] || *((_DWORD *)Object + 216) )
      *((_DWORD *)v13 + 16) = v13[8] & 0xFF09FFFF | 0x20000;
    if ( (*((_DWORD *)v13 + 20) & 0x80u) != 0 )
    {
      v31 = Object[55];
      v32 = (_QWORD *)(v13[45] + 856LL);
      if ( *v31 != Object + 54 )
        goto LABEL_47;
      *v32 = Object + 54;
      v32[1] = v31;
