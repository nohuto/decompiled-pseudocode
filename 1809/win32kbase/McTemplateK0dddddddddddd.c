/*
 * XREFs of McTemplateK0dddddddddddd @ 0x1C00E95D8
 * Callers:
 *     EtwTraceTouchTargetingPointerEvent @ 0x1C00E84A0 (EtwTraceTouchTargetingPointerEvent.c)
 * Callees:
 *     McGenEventWrite @ 0x1C0050EB8 (McGenEventWrite.c)
 *     __security_check_cookie @ 0x1C00A63D0 (__security_check_cookie.c)
 */

ULONG __fastcall McTemplateK0dddddddddddd(
        ...
        char a15)
{
  ...
  v38 = 4LL;
  v40 = 4LL;
  return McGenEventWrite(a1, &TouchTargetingPointerEvent, (LPCGUID)&Context.Flags, 0xDu, &EventData);
}
