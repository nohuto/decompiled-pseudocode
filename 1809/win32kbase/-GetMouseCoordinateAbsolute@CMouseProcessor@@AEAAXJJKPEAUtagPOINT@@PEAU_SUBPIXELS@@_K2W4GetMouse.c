/*
 * XREFs of ?GetMouseCoordinateAbsolute@CMouseProcessor@@AEAAXJJKPEAUtagPOINT@@PEAU_SUBPIXELS@@_K2W4GetMouseCoordinateOptions@@@Z @ 0x1C003D07C
 * Callers:
        ...
        char a9)
{
  ...
  *(_QWORD *)(a1 + 76) = 0LL;
  if ( (a9 & 1) == 0 || (a4 & 0x20) != 0 )
  {
    ...
    if ( (int)result >= 0 )
      result = EditionMagnificationMousePosition(a5);
  }
  if ( (a9 & 4) == 0 )
  {
    v22 = gptInd;
