/*
 * XREFs of ?SetTransformParent@CVisualMarshaler@DirectComposition@@IEAAJPEAVCApplicationChannel@2@PEAVCResourceMarshaler@2@_NPEA_N@Z @ 0x1C000CB9C
 * Callers:
        ...
        bool *a5)
{
  ...
  if ( a3 != this[16] )
  {
    ...
    else
    {
      ...
      {
        v13 = 1;
        v17 = DirectComposition::CApplicationChannel::CreateInternalResource(a2, 0xA1u, &v18);
        v15 = v18;
        v6 = v17;
        if ( v17 < 0 )
          goto LABEL_20;
