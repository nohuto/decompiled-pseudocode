/*
 * XREFs of ?EmitBuffers@CCaptureRenderTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C017C300
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( i = *((_DWORD *)this + 4); ; i = *((_DWORD *)this + 4) )
  {
    ...
    *((_DWORD *)v10 + 2) = *((_DWORD *)this + 6);
    v11 = 0;
    *((_DWORD *)v10 + 3) = *((_QWORD *)this + 10) != 0LL;
    if ( v9 )
    {
      v12 = 0LL;
      do
      {
        v16 = (void *)-1LL;
        v13 = (struct _OBJECT_TYPE *)((__int64 (*)(void))qword_1C01CDAF8)();
        OpenDwmHandle(
