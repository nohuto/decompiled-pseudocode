/*
 * XREFs of ?CoalesceMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C0135190
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CoalesceMessage(const struct tagQMSG *a1)
{
  ...
  if ( (unsigned int)IsPointerInputMessage(*((unsigned int *)a1 + 6)) )
  {
    ...
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x10uLL) )
      {
        v5 = *(_QWORD *)(v4 + 136);
        v17 = 0;
        v20 = 0;
        ...
        v11 = v3;
        v28 = v2;
        TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019FDE2, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  else if ( ((unsigned int)(v1 - 512) <= 0xE || (unsigned int)(v1 - 160) <= 0xD)
         && dword_1C01C7F10 > 4u
         && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x10uLL) )
  {
    v9 = *(_QWORD *)(v8 + 136);
    v17 = 0;
    v20 = 0;
    ...
    v11 = v7;
    v19 = cData;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019FE4D, 0LL, 0LL, cData, &pData);
  }
}
