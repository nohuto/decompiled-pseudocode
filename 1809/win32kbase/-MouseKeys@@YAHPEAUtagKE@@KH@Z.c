/*
 * XREFs of ?MouseKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C01319B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MouseKeys(struct tagKE *a1)
{
  ...
  {
    if ( (dword_1C01CC974 & 4) != 0 && v1 == gNumLockVk && (*((_WORD *)a1 + 1) & 0x8000) == 0 && (_DWORD)v3 == 17 )
    {
  ...
  gMKPreviousVk = v1;
  return off_1C018EB80[v4](word_1C01A7660[v4]);
}
