/*
 * XREFs of ?SetVisualInputSink@CApplicationChannel@DirectComposition@@QEAAJIPEAX@Z @ 0x1C008162C
 * Callers:
        ...
        void *a3)
{
  ...
  if ( v6 && !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v6 + 120LL))(v6, 157LL) )
    v7 = -1073741811;
  v9 = 0LL;
  if ( v7 >= 0 )
  {
    LOBYTE(a3) = 1;
    v7 = (*(__int64 (__fastcall **)(__int64, DirectComposition::CApplicationChannel *, void *, const wchar_t *, struct DirectComposition::CResourceMarshaler **))(*(_QWORD *)v6 + 272LL))(
           v6,
           this,
           a3,
           L"SetInputSink",
