/*
 * XREFs of ?RemoveCrossChannelVisualChild@CApplicationChannel@DirectComposition@@SAJIIII@Z @ 0x1C0001464
 * Callers:
 *     NtDCompositionRemoveCrossDeviceVisualChild @ 0x1C0001450 (NtDCompositionRemoveCrossDeviceVisualChild.c)
 * Callees:
