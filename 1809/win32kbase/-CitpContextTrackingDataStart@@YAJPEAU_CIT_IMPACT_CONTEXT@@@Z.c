/*
 * XREFs of ?CitpContextTrackingDataStart@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0076FB8
 * Callers:
...
__int64 __fastcall CitpContextTrackingDataStart(struct _CIT_IMPACT_CONTEXT *a1, const char *a2)
{
  ...
  if ( !BYTE5(qword_1C01D0CE4) )
    return v2;
  v5 = -1;
  v6 = 96LL * (unsigned int)dword_1C01D0CC4;
  if ( v6 > 0xFFFFFFFF )
  {
    v7 = -1073741675;
    v8 = 455;
LABEL_6:
  ...
  *(_QWORD *)a1 = v9;
  ...
  v10 = (unsigned int)dword_1C01D0CC4;
  v11 = 0;
  if ( dword_1C01D0CC4 )
  {
    v12 = (char *)a1 + 8;
