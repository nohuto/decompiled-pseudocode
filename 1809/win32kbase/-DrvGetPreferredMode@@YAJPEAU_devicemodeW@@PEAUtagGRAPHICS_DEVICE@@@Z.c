/*
 * XREFs of ?DrvGetPreferredMode@@YAJPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C008CFD4
 * Callers:
  ...
  do
  {
    ...
    if ( (*(_BYTE *)(v18 + 20LL * v8) & 3) == 3 )
    {
      ...
      *((_DWORD *)v9 + 8) = *((_DWORD *)v10 + 8);
      ...
      DeviceInfo = DrvDisplayConfigGetDeviceInfo((struct _DISPLAYCONFIG_GET_MONITOR_INTERNAL_INFO *)&v23);
      ...
      if ( DeviceInfo < 0 )
      {
        ...
        if ( (int)DrvDisplayConfigGetDeviceInfo((struct _DISPLAYCONFIG_GET_MONITOR_INTERNAL_INFO *)&v23) < 0 )
          goto LABEL_23;
        v22[2] = v26;
        v22[3] = v27;
        v22[4] = v28;
      ...
      *(_QWORD *)&v22[0] = 197511LL;
      ...
      DWORD2(v22[6]) = 1;
      LODWORD(v22[6]) = 21;
      if ( (int)((__int64 (__fastcall *)(_OWORD *, _DWORD *))qword_1C01CDE18)(v22, v7) >= 0 )
      {
        v14 = v7[46];
        if ( v14 >= v6 )
          v14 = v6;
