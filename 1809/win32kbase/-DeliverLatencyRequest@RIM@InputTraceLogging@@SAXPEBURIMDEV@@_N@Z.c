/*
 * XREFs of ?DeliverLatencyRequest@RIM@InputTraceLogging@@SAXPEBURIMDEV@@_N@Z @ 0x1C011A394
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeliverLatencyRequest(const struct RIMDEV *a1)
{
  ...
  if ( dword_1C01C7F10 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C01C7F10, 0x100uLL) )
    {
      ...
      v8 = 8;
      v11 = cData;
      TlgWrite((TraceLoggingHProvider)&dword_1C01C7F10, &unk_1C019EE7F, 0LL, 0LL, cData, &pData);
    }
  }
}
