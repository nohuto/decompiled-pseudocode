/*
 * XREFs of ?Create@CSharedReadAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0181C1C
 * Callers:
 *     CreateSharedReadAnimationTriggerMarshaler @ 0x1C0181CF0 (CreateSharedReadAnimationTriggerMarshaler.c)
 * Callees:
