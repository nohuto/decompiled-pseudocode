/*
 * XREFs of ?EmitDcompTargetGroup@CDesktopTargetMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C008E2A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CDesktopTargetMarshaler::EmitDcompTargetGroup(
