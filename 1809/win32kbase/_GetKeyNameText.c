/*
 * XREFs of _GetKeyNameText @ 0x1C0066750
 * Callers:
 *     <none>
 * Callees:
 ...
 *     wcsncpycch @ 0x1C0066838 (wcsncpycch.c)
 */
...
__int64 __fastcall GetKeyNameText(unsigned int a1, _WORD *a2, int a3)
{
  ...
  v13 = InternalMapVirtualKeyEx((unsigned __int8)v5, 1, (__int64)v8);
  if ( !v13 )
    return 0LL;
  v14 = InternalMapVirtualKeyEx(v13, 2, (__int64)v8);
  if ( !v14 )
    return 0LL;
  if ( v14 < 0 )
  {
