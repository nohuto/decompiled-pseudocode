/*
 * XREFs of ?GetDispatcherHandleByName@CRIMBase@@IEBAPEAXW4DispatcherHandleName@1@W4HandleAccessMode@1@@Z @ 0x1C007AE84
 * Callers:
 ...
 *     ?DoEditionCoreMsgKSend@CBaseInput@@QEAAXXZ @ 0x1C0149840 (-DoEditionCoreMsgKSend@CBaseInput@@QEAAXXZ.c)
 ...
 *     ?HandleFlushDelayZonePalmRejectInputTimer@CHidInput@@QEAAX_NK@Z @ 0x1C014C800 (-HandleFlushDelayZonePalmRejectInputTimer@CHidInput@@QEAAX_NK@Z.c)
