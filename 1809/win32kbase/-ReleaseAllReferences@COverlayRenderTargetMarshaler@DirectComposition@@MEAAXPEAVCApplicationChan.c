/*
 * XREFs of ?ReleaseAllReferences@COverlayRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C017B8C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DirectComposition::COverlayRenderTargetMarshaler::ReleaseAllReferences(
