/*
 * XREFs of ?AddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@SAJIIIIHII@Z @ 0x1C0001780
 * Callers:
 *     NtDCompositionAddCrossDeviceVisualChild @ 0x1C0001750 (NtDCompositionAddCrossDeviceVisualChild.c)
 * Callees:
