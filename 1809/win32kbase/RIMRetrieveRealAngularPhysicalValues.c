/*
 * XREFs of RIMRetrieveRealAngularPhysicalValues @ 0x1C012FD54
 * Callers:
 *     RIMRetrieveNormalizationRange @ 0x1C012FC18 (RIMRetrieveNormalizationRange.c)
 * Callees:
 *     RIMComputePower @ 0x1C012FAEC (RIMComputePower.c)
      ...
      if ( v19 == 4 )
      {
        ...
        if ( v8 < -4 )
        {
          ...
          do
          {
            ...
            --v9;
            ++v3;
            v20 = dword_1C01A7470[v21] + 10 * v20;
          }
          while ( v9 > v8 );
          v23 = v20;
        }
