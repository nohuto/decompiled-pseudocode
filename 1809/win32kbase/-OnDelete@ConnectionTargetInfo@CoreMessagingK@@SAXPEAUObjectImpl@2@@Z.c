/*
 * XREFs of ?OnDelete@ConnectionTargetInfo@CoreMessagingK@@SAXPEAUObjectImpl@2@@Z @ 0x1C0085230
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CoreMessagingK::ConnectionTargetInfo::OnDelete(struct CoreMessagingK::ObjectImpl *a1)
{
  ...
  if ( dword_1C01C77B8 > 5u )
  {
    ...
    v11 = 4;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C01C77B8, &unk_1C01A361C, 0LL, 0LL, 6u, &pData);
    v2 = (CoreMessagingK::ClientPortInfo *)*((_QWORD *)a1 + 2);
  }
