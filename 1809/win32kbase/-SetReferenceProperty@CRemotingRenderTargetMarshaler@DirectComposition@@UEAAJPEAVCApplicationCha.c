/*
 * XREFs of ?SetReferenceProperty@CRemotingRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C016D7F0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( !a4
    || (*(unsigned int (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)a4 + 16LL))(a4) != 45 )
  {
    return (unsigned int)-1073741811;
  }
  if ( *((_QWORD *)this + 6) )
