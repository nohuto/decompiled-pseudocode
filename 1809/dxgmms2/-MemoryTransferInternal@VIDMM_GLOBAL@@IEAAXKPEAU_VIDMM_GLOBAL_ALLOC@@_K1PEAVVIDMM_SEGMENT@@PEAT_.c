/*
 * XREFs of ?MemoryTransferInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@_K1PEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@PEAU_MDL@@234U_DXGK_TRANSFERFLAGS@@@Z @ 0x1C007F7C8
 * Callers:
...
LABEL_55:
      ...
      VidMmRecordTransfer((VIDMM_GLOBAL *)((char *)this + 7168), a4, v33);
      v13 = a2;
LABEL_58:
