/*
 * XREFs of ?SetupBudgetState@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@K@Z @ 0x1C00C0F24
 * Callers:
 ...
 *     ?CalculateBudgetGroupTargetUsage@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@@Z @ 0x1C00C0D38 (-CalculateBudgetGroupTargetUsage@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUVIDMM_BUDGET.c)
 */
...
LABEL_21:
    ...
    if ( i )
    {
      ...
      {
        v14 = 3LL;
        v15 = *(_QWORD *)(368LL * *(unsigned int *)(*((_QWORD *)this + 3) + 208LL) + i[4] + 24);
        do
        {
