/*
 * XREFs of ?ReadPagingConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C00894E8
 * Callers:
...
void VIDMM_GLOBAL::ReadPagingConfiguration(void)
{
  ...
  _BYTE v137[56]; // [rsp+408h] [rbp+308h] BYREF
  ...
  qword_1C004D3A8 = 10000LL * v3;
  qword_1C004D3B0 = 10000LL * v4;
  qword_1C004D3B8 = 10000LL * v5;
  qword_1C004D3C0 = 10000LL * v6;
  qword_1C004D3E0 = v31;
  dword_1C004D3E8 = v9;
  qword_1C004D3C8 = 10000LL * v0;
  qword_1C004D3D0 = (unsigned int)(10000 * v7);
  qword_1C004D408 = (unsigned __int64)v10 << 20;
  dword_1C004D338 = v11;
  dword_1C004D3EC = v12;
  dword_1C004D3F0 = v13;
  dword_1C004D478 = v14;
  qword_1C004D3D8 = (unsigned int)(10000 * v8);
}
