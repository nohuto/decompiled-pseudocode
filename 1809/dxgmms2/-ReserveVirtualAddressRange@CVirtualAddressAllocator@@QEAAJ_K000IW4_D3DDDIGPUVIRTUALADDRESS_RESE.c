/*
 * XREFs of ?ReserveVirtualAddressRange@CVirtualAddressAllocator@@QEAAJ_K000IW4_D3DDDIGPUVIRTUALADDRESS_RESERVATION_TYPE@@_KEPEA_KPEAPEAUVIDMM_MAPPED_VA_RANGE@@E@Z @ 0x1C006C650
 * Callers:
        ...
        unsigned __int8 a12)
{
  ...
  if ( v19 >= 0 )
  {
    CVirtualAddressAllocator::InsertVadToReservedList(this, v32);
    v25 = a7;
...
LABEL_6:
    ...
    {
      v30 = WdLogNewEntry5_WdWarning((unsigned int)a7, v24);
  ...
  v29 = WdLogNewEntry5_WdWarning(v21, v20);
