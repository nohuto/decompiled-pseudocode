/*
 * XREFs of ?SetStatus@VIDMM_PAGING_QUEUE@@QEAAXW4VIDMM_PAGING_QUEUE_STATUS@@@Z @ 0x1C007C008
 * Callers:
 *     ?InsertPagingQueueList@VIDMM_DEVICE@@QEAAXPEAVVIDMM_PAGING_QUEUE@@@Z @ 0x1C00102D0 (-InsertPagingQueueList@VIDMM_DEVICE@@QEAAXPEAVVIDMM_PAGING_QUEUE@@@Z.c)
 *     ?Resume@VIDMM_PAGING_QUEUE@@QEAAXXZ @ 0x1C007BE3C (-Resume@VIDMM_PAGING_QUEUE@@QEAAXXZ.c)
 *     ?Suspend@VIDMM_PAGING_QUEUE@@QEAAXXZ @ 0x1C007BF80 (-Suspend@VIDMM_PAGING_QUEUE@@QEAAXXZ.c)
