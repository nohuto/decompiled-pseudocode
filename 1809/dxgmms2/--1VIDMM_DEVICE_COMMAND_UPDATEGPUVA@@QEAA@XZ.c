/*
 * XREFs of ??1VIDMM_DEVICE_COMMAND_UPDATEGPUVA@@QEAA@XZ @ 0x1C00A6A38
 * Callers:
 ...
 *     ?DecrementPagingPacketReferenceCount@VIDMM_ALLOC@@QEAAXXZ @ 0x1C0025A38 (-DecrementPagingPacketReferenceCount@VIDMM_ALLOC@@QEAAXXZ.c)
 */
        ...
        VIDMM_DEVICE_COMMAND_UPDATEGPUVA *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( *v7 == (char *)v7 )
      break;
    if ( *((char ***)v8 + 1) != v7 || (v9 = *(char **)v8, *(char **)(*(_QWORD *)v8 + 8LL) != v8) )
      __fastfail(3u);
    *v7 = v9;
    *((_QWORD *)v9 + 1) = v7;
    *((_QWORD *)v8 + 1) = 0LL;
    *(_QWORD *)v8 = 0LL;
    VIDMM_MAPPED_VA_RANGE::ReleaseVaRangeReference(v8 - 8);
  }
}
