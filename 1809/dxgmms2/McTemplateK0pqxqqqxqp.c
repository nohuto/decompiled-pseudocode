/*
 * XREFs of McTemplateK0pqxqqqxqp @ 0x1C002CE24
 * Callers:
...
ULONG McTemplateK0pqxqqqxqp(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventDmaIsrComplete, a3, 0xAu, &EventData);
}
