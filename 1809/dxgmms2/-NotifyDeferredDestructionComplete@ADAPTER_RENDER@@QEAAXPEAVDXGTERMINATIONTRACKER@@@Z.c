/*
 * XREFs of ?NotifyDeferredDestructionComplete@ADAPTER_RENDER@@QEAAXPEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C00154AC
 * Callers:
...
{
  ((void (__fastcall **)(__int64, struct DXGTERMINATIONTRACKER *))DxgCoreInterface)[56]((__int64)this, a2);
}
