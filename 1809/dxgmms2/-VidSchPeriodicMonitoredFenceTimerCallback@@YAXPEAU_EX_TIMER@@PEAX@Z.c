/*
 * XREFs of ?VidSchPeriodicMonitoredFenceTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C00311C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VidSchPeriodicMonitoredFenceTimerCallback(struct _EX_TIMER *a1, struct _VIDSCH_SYNC_OBJECT **a2)
{
  ...
  v3 = *((_QWORD *)*a2 + 1);
  v4 = *(_QWORD *)(v3 + 8LL * *((unsigned int *)a2 + 2) + 2576);
  KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v3 + 1648), &LockHandle);
  v5 = *(_QWORD *)(v4 + 33184);
  v6 = *(_QWORD *)(v4 + 33176);
  ...
  if ( (unsigned __int64)a2[7] < v19 )
  {
    ...
    if ( v10 > 0 )
    {
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0q(v9, &EventPerformanceWarning, v11, 25);
      v10 = -(__int64)a2[6];
    }
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x80u) != 0 )
    {
      v16 = *((_DWORD *)a2 + 6);
      v15 = *((_DWORD *)a2 + 2);
      McTemplateK0pqqiix(v13, v12, v14, *a2, v15, v16, v5, v10, v19);
    }
  }
  else
  {
    if ( bTracingEnabled )
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0q(v7, &EventPerformanceWarning, v8, 25);
    }
