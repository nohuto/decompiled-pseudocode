/*
 * XREFs of ?FreeDriverUpdateAddress@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@I_KPEAX@Z @ 0x1C0077F18
 * Callers:
        ...
        struct _MDL *a5)
{
  ...
  v5 = *((_QWORD *)a2 + 10);
  if ( (*(_BYTE *)(v5 + 40872) & 0x10) != 0 || (v6 = (int)(*(_DWORD *)this << 16) >> 29) == 0 )
  {
                                                ...
                                                + 40352) != a2 )
  {
    ...
    if ( *(_QWORD *)(*(_QWORD *)v7 + 8LL) != v7
      ...
      || (*(_QWORD *)v7 = v9,
          *(_QWORD *)(v9 + 8) = v7,
          v8[2] = *(_QWORD *)(v5 + 8LL * ((*(_DWORD *)this >> 7) & 0x1F) + 4944),
          v10 = 1560LL * ((*(_DWORD *)this >> 7) & 0x1F) + *(_QWORD *)(v5 + 40184) + 464LL,
          v11 = *(__int64 ***)(v10 + 8),
          *v11 != (__int64 *)v10) )
    {
      __fastfail(3u);
