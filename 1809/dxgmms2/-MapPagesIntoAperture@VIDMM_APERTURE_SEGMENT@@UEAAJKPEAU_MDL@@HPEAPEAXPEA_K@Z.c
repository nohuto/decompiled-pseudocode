/*
 * XREFs of ?MapPagesIntoAperture@VIDMM_APERTURE_SEGMENT@@UEAAJKPEAU_MDL@@HPEAPEAXPEA_K@Z @ 0x1C00B95A0
 * Callers:
 *     <none>
 * Callees:
        ...
        union _LARGE_INTEGER *a6)
{
  ...
  v8 = a2;
  if ( v7 > 0xFFFFFFFF )
    return v7 > 0xFFFFFFFF ? 0xC0000095 : 0;
  LOBYTE(a4) = 1;
  v10 = VIDMM_LINEAR_POOL::Allocate(this[19], (unsigned int)v7, 0LL, a4, 0LL, 0LL, 0, 0, 0LL, &v11, a5);
  if ( v10 >= 0 )
  {
    *a6 = v11;
