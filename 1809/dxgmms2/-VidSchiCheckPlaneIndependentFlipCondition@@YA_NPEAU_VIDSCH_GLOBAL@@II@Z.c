/*
 * XREFs of ?VidSchiCheckPlaneIndependentFlipCondition@@YA_NPEAU_VIDSCH_GLOBAL@@II@Z @ 0x1C0017578
 * Callers:
...
char __fastcall VidSchiCheckPlaneIndependentFlipCondition(struct _VIDSCH_GLOBAL *a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( a2 != -1 )
  {
    ...
    if ( v7 == 1 )
    {
      if ( *(_BYTE *)(v6 + 98) && !*(_DWORD *)(v4 + v3 + 168) && *(_BYTE *)(v6 + 96) && !*(_DWORD *)(v4 + v3 + 172) )
        return 1;
    }
    else if ( v7 == 2 )
    {
