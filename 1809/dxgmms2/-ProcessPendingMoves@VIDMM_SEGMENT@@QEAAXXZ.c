/*
 * XREFs of ?ProcessPendingMoves@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00BDBB8
 * Callers:
 ...
 *     ?SetVPRPaging@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C0028824 (-SetVPRPaging@VIDMM_GLOBAL@@QEAAX_N@Z.c)
...
LABEL_29:
  ...
  *((_QWORD *)this + 52) = v21;
  if ( (unsigned int)DXG_DEFERRED_WORK_QUEUE::GetNumWorkItems((DXG_DEFERRED_WORK_QUEUE *)(v23 + 41024)) )
  {
  ...
  if ( v15 < 0 )
  {
    ...
    {
      v30 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v19, v18);
      v30[3] = 270LL;
      v30[4] = 9LL;
      v30[5] = 0LL;
      v30[6] = 0LL;
