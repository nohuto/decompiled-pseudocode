/*
 * XREFs of ?RotateFrameBufferCopyCallback@VIDMM_MEMORY_SEGMENT@@KAJPEAU_MDL@@0PEAX@Z @ 0x1C007F330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VIDMM_MEMORY_SEGMENT::RotateFrameBufferCopyCallback(struct _MDL *a1, struct _MDL *a2, char *a3)
{
  ...
  if ( (*(_BYTE *)(1560LL * (*(_DWORD *)(*(_QWORD *)a3 + 76LL) & 0x3F) + *(_QWORD *)(v5 + 40184) + 436) & 4) == 0 )
    return 3221225473LL;
  if ( *(_BYTE *)(v5 + 40139)
    && (v9 = DpiMapIommuIdentityRange(*(_QWORD *)(*(_QWORD *)(v5 + 24) + 192LL), a2), v12 = v9, v9 < 0) )
  {
  ...
  else
  {
    ...
    *((_QWORD *)a3 + 4) += ByteCount;
    ...
    if ( *(_BYTE *)(v5 + 40139) )
      DpiUnmapIommuIdentityRange(*(_QWORD *)(*(_QWORD *)(v5 + 24) + 192LL), a2);
    return 0LL;
  }
}
