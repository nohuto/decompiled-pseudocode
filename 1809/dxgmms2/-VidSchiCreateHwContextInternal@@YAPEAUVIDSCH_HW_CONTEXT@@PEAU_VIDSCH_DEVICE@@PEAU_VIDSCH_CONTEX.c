/*
 * XREFs of ?VidSchiCreateHwContextInternal@@YAPEAUVIDSCH_HW_CONTEXT@@PEAU_VIDSCH_DEVICE@@PEAU_VIDSCH_CONTEXT_DATA@@PEAVDXGCONTEXT@@@Z @ 0x1C00342C4
 * Callers:
  ...
  *((_QWORD *)a1 + 12) = v20;
  ...
  else
  {
    ...
    *((_QWORD *)v11 + 4) = v21;
    ...
    v31 = *(_BYTE *)(v30 + *(_QWORD *)(*(_QWORD *)(v29 + 16) + 2416LL) + 40);
    v32 = *((_QWORD *)a1 + 2);
    ...
    *((_QWORD *)v11 + 6) = v47[0];
    if ( !v36 )
    {
      ...
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x100) == 0 )
        goto LABEL_25;
      v38 = *(_DWORD *)(*((_QWORD *)v11 + 1) + 48LL) >> 4;
      McTemplateK0pqqqqqqqqppp(
        v47[6],
        &EventCreateContext,
        (const GUID *)((2 * (v38 & 1)) | 1u),
        (__int64)v37,
        v47[1],
        SBYTE4(v47[1]),
        SBYTE4(v47[4]),
