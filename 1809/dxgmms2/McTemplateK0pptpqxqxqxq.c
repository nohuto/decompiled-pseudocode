/*
 * XREFs of McTemplateK0pptpqxqxqxq @ 0x1C00199A0
 * Callers:
...
ULONG McTemplateK0pptpqxqxqxq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v24 = 8LL;
  v26 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventPagingOpTransfer, a3, 0xCu, &EventData);
}
