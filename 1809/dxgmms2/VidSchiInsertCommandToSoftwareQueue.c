/*
 * XREFs of VidSchiInsertCommandToSoftwareQueue @ 0x1C0004B20
 * Callers:
...
__int64 __fastcall VidSchiInsertCommandToSoftwareQueue(__int64 a1, _DWORD *a2)
{
  ...
  _InterlockedIncrement((volatile signed __int32 *)(v6 + 1276));
  v8 = *(_DWORD *)(a1 + 48);
  ...
  if ( !v8 && (*(_DWORD *)(a1 + 72) & 4) != 0 )
    _InterlockedExchangeAdd(
      (volatile signed __int32 *)(*(_QWORD *)(v7 + 8LL * *(unsigned int *)(a1 + 160) + 2576) + 2332LL),
      1u);
              ...
              if ( (result & 0x80u) == 0LL )
              {
                ...
                if ( (result & 0x100) == 0 )
                {
                  ...
                  if ( (result & 0x20) == 0 )
                  {
                    ...
                    result = VidSchiUpdateContextStatus(v2, 5LL, 14580LL);
                    *a2 = result;
                  }
                }
              }
