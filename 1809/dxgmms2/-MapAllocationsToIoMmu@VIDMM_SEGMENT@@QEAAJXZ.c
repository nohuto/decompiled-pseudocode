/*
 * XREFs of ?MapAllocationsToIoMmu@VIDMM_SEGMENT@@QEAAJXZ @ 0x1C00BD3B0
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::MapAllocationsToIoMmu(VIDMM_SEGMENT *this)
{
  ...
  {
    v4 = i - 384;
    v5 = VIDMM_GLOBAL::IoMmuMapAllocation(*((VIDMM_GLOBAL **)this + 1), (struct _VIDMM_GLOBAL_ALLOC *)(i - 384));
    v8 = v5;
    if ( v5 < 0 )
    {
LABEL_6:
  ...
  {
    v4 = (char *)j - 384;
    v12 = VIDMM_GLOBAL::IoMmuMapAllocation(*((VIDMM_GLOBAL **)this + 1), (VIDMM_SEGMENT *)((char *)j - 384));
    v8 = v12;
    if ( v12 < 0 )
      goto LABEL_6;
  }
  v13 = DpiMapIommuIdentityRange(
          *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 24LL) + 192LL),
