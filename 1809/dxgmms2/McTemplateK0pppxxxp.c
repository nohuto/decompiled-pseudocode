/*
 * XREFs of McTemplateK0pppxxxp @ 0x1C0027A68
 * Callers:
...
ULONG McTemplateK0pppxxxp(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventAddDmaBuffer, a3, 8u, &EventData);
}
