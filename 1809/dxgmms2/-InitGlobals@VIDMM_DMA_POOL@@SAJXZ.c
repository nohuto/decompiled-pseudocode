/*
 * XREFs of ?InitGlobals@VIDMM_DMA_POOL@@SAJXZ @ 0x1C00879BC
 * Callers:
...
__int64 VIDMM_DMA_POOL::InitGlobals(void)
{
  ...
  qword_1C004D748 = (__int64)&VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_DmaPoolsListHead.Flink = &VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_MaxNbDmaBuffers = dword_1C004D288;
  VIDMM_DMA_POOL::_MaxNbCddDmaBuffers = dword_1C004D28C;
  VIDMM_DMA_POOL::_MaxDmaBufferBytes = (unsigned int)dword_1C004D290;
  VIDMM_DMA_POOL::_MaxAllocationListBytes = (unsigned int)dword_1C004D294;
  VIDMM_DMA_POOL::_MaxPatchLocationListBytes = (unsigned int)dword_1C004D294;
  v0 = (unsigned int)dword_1C004D290 / 0x64uLL;
  ...
  v1 = (unsigned int)dword_1C004D294 / 0x64uLL;
  ...
  if ( v2 )
  {
    ...
    {
      VIDMM_DMA_POOL::_NbDmaBufferLimitCompareWatermark = dword_1C004D298;
      return 0LL;
    }
  }
  else
