/*
 * XREFs of ?VidMmiClosePerfCounters@@YAXPEAUVIDMM_PARTITION_ADAPTER_INFO@@@Z @ 0x1C002803C
 * Callers:
 *     ?ResetAdapter@VIDMM_PARTITION@@QEAAXPEAVVIDMM_GLOBAL@@@Z @ 0x1C0028000 (-ResetAdapter@VIDMM_PARTITION@@QEAAXPEAVVIDMM_GLOBAL@@@Z.c)
...
void __fastcall VidMmiClosePerfCounters(struct VIDMM_PARTITION_ADAPTER_INFO *a1)
{
  ...
  for ( i = 0; i < *((_DWORD *)v1 + 1748); ++i )
  {
    ...
    v6 = (struct _PCW_INSTANCE *)*((_QWORD *)SegmentGroupStateForPartition + 40);
    if ( v6 )
    {
