/*
 * XREFs of VidSchiResetHwEngine @ 0x1C0038968
 * Callers:
...
bool __fastcall VidSchiResetHwEngine(__int64 a1, __int64 a2)
{
  ...
  struct _TDR_RECOVERY_CONTEXT *v49; // [rsp+80h] [rbp-88h] BYREF
  __int64 v50; // [rsp+88h] [rbp-80h] BYREF
  struct _TDR_RECOVERY_CONTEXT *v51; // [rsp+90h] [rbp-78h] BYREF
  __int64 v52; // [rsp+98h] [rbp-70h] BYREF
  struct _TDR_RECOVERY_CONTEXT *v53; // [rsp+A0h] [rbp-68h] BYREF
  ...
  *(_DWORD *)(a1 + 484) = v16;
  ...
  if ( (unsigned int)v15 < *(_DWORD *)(v2 + 688) )
    v17 += 8 * v15;
  HIDWORD(v43) = *(unsigned __int16 *)(*(_QWORD *)v17 + 6LL);
  v18 = *(_QWORD *)(v2 + 616);
  if ( (unsigned int)v15 < *(_DWORD *)(v2 + 688) )
    v18 += 8 * v15;
  LODWORD(v43) = *(unsigned __int16 *)(*(_QWORD *)v18 + 8LL);
  if ( hProvider > 5u
  ...
  *(_QWORD *)(a1 + 1744) = v9;
  *(_QWORD *)(a1 + 1736) = v5 + 4;
  v21 = ((__int64 (__fastcall *)(_QWORD, __int64 *))DxgCoreInterface[38])(*(_QWORD *)(v2 + 8), &v43);
  *(_QWORD *)(a1 + 1736) = 0LL;
  v23 = v21;
  *(_QWORD *)(a1 + 1744) = 0LL;
  if ( v21 )
  ...
  *(_DWORD *)(a1 + 16) = 0;
  if ( v24 )
  {
    ...
    if ( (unsigned int)v31 >= v33 )
      v34 = v32;
    HIDWORD(v44) = *(unsigned __int16 *)(*(_QWORD *)v34 + 6LL);
    if ( (unsigned int)v31 < v33 )
      v32 += 8 * v31;
    LODWORD(v44) = *(unsigned __int16 *)(*(_QWORD *)v32 + 8LL);
    v35 = ((__int64 (__fastcall *)(_QWORD, __int64 *))DxgCoreInterface[39])(*(_QWORD *)(v2 + 8), &v44);
    *((_BYTE *)v5 + 50) = 1;
    v5[11] = v35;
    v24 = v35 == 0;
  }
