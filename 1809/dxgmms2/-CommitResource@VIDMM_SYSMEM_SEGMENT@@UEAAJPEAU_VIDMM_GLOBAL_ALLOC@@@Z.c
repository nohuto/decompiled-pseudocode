/*
 * XREFs of ?CommitResource@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0070CF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_36:
  ...
  *v15 = v14;
  ...
  v16 = *((_DWORD *)a2 + 18);
  if ( !v16
    || (((_DWORD)this[10] & 0x1000) != 0 ? (v17 = 0) : (v17 = *((_DWORD *)this + 4) + 1),
        (*((_DWORD *)a2 + 18) & 0x1F) == v17
     || (((_DWORD)this[10] & 0x1000) != 0 ? (v18 = 0) : (v18 = *((_DWORD *)this + 4) + 1), ((v16 >> 6) & 0x1F) == v18)) )
  {
    v19 = 0x800000;
  }
  else
