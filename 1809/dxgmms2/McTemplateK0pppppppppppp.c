/*
 * XREFs of McTemplateK0pppppppppppp @ 0x1C002636C
 * Callers:
 ...
 *     VidMmReportMultiAlloc @ 0x1C00B42F0 (VidMmReportMultiAlloc.c)
 *     ?ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z @ 0x1C00B6EF8 (-ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z.c)
 * Callees:
