/*
 * XREFs of ?RecommitGpuVirtualAddresses@VIDMM_GLOBAL@@QEAAJ_K@Z @ 0x1C00AB714
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::RecommitGpuVirtualAddresses(VIDMM_GLOBAL *this, unsigned __int64 a2)
{
  ...
  LODWORD(v5) = 0;
  DXGPUSHLOCK::AcquireShared((VIDMM_GLOBAL *)((char *)this + 40968));
  v6 = (_QWORD *)*((_QWORD *)this + 5126);
  if ( v6 != (_QWORD *)((char *)this + 41008) )
  {
    v7 = (CVirtualAddressAllocator ***)v16;
    do
    {
      v8 = (CVirtualAddressAllocator ***)v6[59];
      if ( v8 && v6[2] != *((_QWORD *)this + 5040) )
      {
        if ( *v7 != &v15 )
          __fastfail(3u);
    ...
    while ( v6 != (_QWORD *)((char *)this + 41008) );
  }
