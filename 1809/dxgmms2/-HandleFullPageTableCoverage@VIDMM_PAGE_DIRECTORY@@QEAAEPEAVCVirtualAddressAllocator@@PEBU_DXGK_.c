/*
 * XREFs of ?HandleFullPageTableCoverage@VIDMM_PAGE_DIRECTORY@@QEAAEPEAVCVirtualAddressAllocator@@PEBU_DXGK_GPUMMUCAPS@@PEBUCOMMIT_VA_STATE@@PEBUVIDMM_PAGE_TABLE_LEVEL_DESC@@III_KPEAE@Z @ 0x1C00B53DC
 * Callers:
        ...
        unsigned __int8 *a10)
{
  ...
  if ( !v13 )
  {
    ...
    *(_QWORD *)(v19 + 16LL * a6) |= 1uLL;
    ++*((_DWORD *)this + 1);
    v20 = *((_QWORD *)this + 3);
    v21 = *(_QWORD *)(v20 + 16LL * a6);
    if ( v11 )
    {
      *(_QWORD *)(v20 + 16LL * a6) = v21 | 2;
    }
    else
    {
      *(_QWORD *)(v20 + 16LL * a6) = v21 | 0x400;
      v22 = *(_QWORD *)a4;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6 + 8) = a9 >> 12;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= (*(_DWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^ (32 * *((_DWORD *)a4 + 13))) & 0x3E0;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= (*(_DWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^ (unsigned int)v22) & 8;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= (*(_DWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^ (unsigned int)v22) & 0x10;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= (*(_DWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^ (unsigned int)v22) & 4;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= (*(_DWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^ (unsigned int)v22) & 0x1F800;
      v24[2] = *((_DWORD *)a4 + 12);
