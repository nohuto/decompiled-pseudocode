/*
 * XREFs of ?VidMmReserveGpuVirtualAddressRangeCb@VIDMM_GLOBAL@@QEAAJPEAU_DXGKARGCB_RESERVEGPUVIRTUALADDRESSRANGE@@@Z @ 0x1C006BE08
 * Callers:
 *     VidMmReserveGpuVirtualAddressRangeCb @ 0x1C000FEE0 (VidMmReserveGpuVirtualAddressRangeCb.c)
 * Callees:
