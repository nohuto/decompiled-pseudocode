/*
 * XREFs of ?InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBUDXGADAPTER_GPUMMUCAPS@@PEBUDXGK_PHYSICALADAPTERINFO@@I@Z @ 0x1C00A90B0
 * Callers:
...
LABEL_6:
    ...
    v14 = 352LL * a3;
    LOBYTE(v15) = (*((_BYTE *)this + 436) ^ (4 * *(_BYTE *)(*(_QWORD *)(v15 + 2416) + v14 + 40))) & 4;
    *((_BYTE *)this + 436) ^= v15;
