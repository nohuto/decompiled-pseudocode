/*
 * XREFs of ?UnlockAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_LOCAL_ALLOC@@_K1EE@Z @ 0x1C006F03C
 * Callers:
        ...
        unsigned __int8 a6)
{
  ...
  if ( (v10 & 0x1000) == 0 )
  {
    if ( !*(_BYTE *)(*((_QWORD *)this + 3) + 2471LL) && a6 )
    {
    ...
    else
    {
      ...
      if ( v11 )
      {
        (*(void (__fastcall **)(_QWORD, __int64, const GUID *, unsigned __int64, unsigned __int8))(**(_QWORD **)(*((_QWORD *)a2 + 1) + 24LL)
                                                                                                 + 40LL))(
