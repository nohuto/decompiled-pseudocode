/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00810E0
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x1C00256D0 (VidMmWaitOnAllocationPresentQueue.c)
