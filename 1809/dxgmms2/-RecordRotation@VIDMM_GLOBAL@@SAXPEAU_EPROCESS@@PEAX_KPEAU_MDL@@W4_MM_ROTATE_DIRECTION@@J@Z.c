/*
 * XREFs of ?RecordRotation@VIDMM_GLOBAL@@SAXPEAU_EPROCESS@@PEAX_KPEAU_MDL@@W4_MM_ROTATE_DIRECTION@@J@Z @ 0x1C0081038
 * Callers:
        ...
        int a6)
{
  ...
  {
    v8 = _InterlockedExchangeAdd((_DWORD *)&qword_1C004D488 + 1, 1u) % (unsigned int)qword_1C004D488;
    v9 = 6 * v8;
