/*
 * XREFs of ?VidSchiProcessIsrVSyncMultiPlaneOverlay2@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@PEAU_DXGKARGCB_NOTIFY_INTERRUPT_DATA@@PEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x1C002AAE0
 * Callers:
        ...
        struct _VIDSCH_VSYNC_COOKIE *a4)
{
  ...
  *((_QWORD *)a2 + 4146) = a3->MiracastEncodeChunkCompleted.pPrivateDriverData;
