/*
 * XREFs of VidSchiPropagatePresentHistoryToken @ 0x1C000F368
 * Callers:
 ...
 * Callees:
 *     ?PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@@_N1111@Z @ 0x1C000F4A8 (-PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@.c)
        ...
        __int64 a9)
{
  ...
  else
  {
    ...
    if ( a9 )
    {
      v16 = *(CRefCountedBuffer **)(a9 + 24);
      if ( v16 )
      {
        CRefCountedBuffer::RefCountedBufferRelease(v16);
        *(_QWORD *)(a9 + 24) = 0LL;
      }
      v17 = *(CRefCountedBuffer **)(a9 + 40);
      if ( v17 )
      {
