/*
 * XREFs of VidSchFlushDevice @ 0x1C007AD00
 * Callers:
...
__int64 __fastcall VidSchFlushDevice(__int64 a1, int *a2, __int64 a3, __int64 a4)
{
  ...
  if ( a1 && a2 )
  {
    ...
    {
      *(_DWORD *)(a1 + 1392) = 1;
      VidSchMarkDeviceAsError(a1, 14LL, 0);
    ...
    if ( (v7 & 1) != 0 )
    {
      ...
      v12 = (_DWORD *)((-(__int64)(((*a2 - 3) & 0xFFFFFFFD) != 0) & 0xFFFFFFFFFFFFFFFCuLL) + a1 + 1280);
      if ( *v12 )
      {
      ...
      if ( v7 != 5 )
      {
        ...
        VidSchiInterlockedReadUlong(v9 + 206, (_DWORD *)(a1 + 1268));
      }
    }
    LOBYTE(v4) = v7 >= 9;
    result = 0LL;
