/*
 * XREFs of ?VidMmFreeGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_FREEGPUVIRTUALADDRESS@@E@Z @ 0x1C006C7E4
 * Callers:
 *     VidMmFreeGpuVirtualAddress @ 0x1C0018350 (VidMmFreeGpuVirtualAddress.c)
