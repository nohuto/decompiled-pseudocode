/*
 * XREFs of McTemplateK0pqqqqUR4 @ 0x1C002C78C
 * Callers:
...
ULONG McTemplateK0pqqqqUR4(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v17 = 0;
  return McGenEventWrite(a1, &EventHistoryBuffer, 0LL, 7u, &EventData);
}
