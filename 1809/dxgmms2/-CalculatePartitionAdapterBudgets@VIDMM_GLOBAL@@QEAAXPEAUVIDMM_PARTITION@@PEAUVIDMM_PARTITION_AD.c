/*
 * XREFs of ?CalculatePartitionAdapterBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PARTITION@@PEAUVIDMM_PARTITION_ADAPTER_INFO@@@Z @ 0x1C00188DC
 * Callers:
        ...
        struct VIDMM_PARTITION_ADAPTER_INFO *a3)
{
  ...
  v3 = (unsigned int)dword_1C004D470;
  v4 = 0;
  v5 = *((_QWORD *)a2 + 5);
  if ( *((_DWORD *)a2 + 6) )
    v3 = (unsigned int)dword_1C004D474;
  v8 = v5 * v3 / 0x64;
  if ( v8 < (unsigned int)dword_1C004D468 )
  {
    if ( v5 > (unsigned int)dword_1C004D46C )
    {
      v8 = (v5 - (unsigned int)dword_1C004D46C) >> 1;
      if ( (unsigned int)dword_1C004D468 > v8 )
        v8 = (unsigned int)dword_1C004D468;
    }
    else
    {
      v8 = (unsigned int)dword_1C004D468;
  ...
  *((_QWORD *)a3 + 2) = v8;
  ...
  if ( qword_1C004D340 && v8 >= qword_1C004D340 )
    v8 = qword_1C004D340;
  if ( *((_DWORD *)this + 1748) )
  {
    do
