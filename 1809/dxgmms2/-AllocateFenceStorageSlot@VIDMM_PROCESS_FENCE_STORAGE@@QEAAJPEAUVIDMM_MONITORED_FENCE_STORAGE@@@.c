/*
 * XREFs of ?AllocateFenceStorageSlot@VIDMM_PROCESS_FENCE_STORAGE@@QEAAJPEAUVIDMM_MONITORED_FENCE_STORAGE@@@Z @ 0x1C0010148
 * Callers:
        ...
        struct VIDMM_MONITORED_FENCE_STORAGE *a2)
{
  ...
  if ( v7 )
    return 0LL;
  v9 = (VIDMM_FENCE_STORAGE_PAGE *)operator new[](0xA0uLL, 0x34346956u, (POOL_TYPE)512);
  if ( v9 )
