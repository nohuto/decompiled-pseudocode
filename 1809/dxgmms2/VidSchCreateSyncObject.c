/*
 * XREFs of VidSchCreateSyncObject @ 0x1C006DB10
 * Callers:
 ...
 *     VidSchiAddSyncObjectToAdapterList @ 0x1C002D744 (VidSchiAddSyncObjectToAdapterList.c)
 *     VidSchiAddSyncObjectToCrossAdapterInfo @ 0x1C002D7BC (VidSchiAddSyncObjectToCrossAdapterInfo.c)
...
LABEL_10:
    ...
    *v8 = v17;
    ...
    LODWORD(HandleInformation) = 0;
    McTemplateK0ppqqpx(a3[18], v40, v22, v26, v17, HandleInformation, a3[1], a3[18], *((_QWORD *)a3 + 1));
    return 0LL;
  }
  if ( (_DWORD)v23 == 3 )
  {
