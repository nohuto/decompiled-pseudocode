/*
 * XREFs of ??1VIDMM_PROCESS_ADAPTER_INFO@@QEAA@XZ @ 0x1C006AA44
 * Callers:
...
void __fastcall VIDMM_PROCESS_ADAPTER_INFO::~VIDMM_PROCESS_ADAPTER_INFO(void **this)
{
  ...
  for ( i = 0; i < *((_DWORD *)*this + 1748); ++i )
  {
    ...
    do
    {
      ...
      {
        v9 = *v7;
        v10 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v3, v2);
        v10[7] = 0LL;
        v10[3] = 270LL;
        v10[4] = 51LL;
        v10[5] = this;
    ...
    {
      v15 = v6[27];
      v16 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v3, v2);
      v16[7] = 0LL;
      v16[3] = 270LL;
      v16[4] = 51LL;
      v16[5] = this;
