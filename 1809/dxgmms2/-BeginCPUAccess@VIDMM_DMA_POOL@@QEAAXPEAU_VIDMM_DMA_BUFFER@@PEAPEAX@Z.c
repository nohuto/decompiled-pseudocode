/*
 * XREFs of ?BeginCPUAccess@VIDMM_DMA_POOL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@PEAPEAX@Z @ 0x1C007CE54
 * Callers:
 *     VidMmBeginDmaBufferCPUAccess @ 0x1C0014F80 (VidMmBeginDmaBufferCPUAccess.c)
