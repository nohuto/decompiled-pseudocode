/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00AE574
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C0025200 (VidMmCreateCompanionContext.c)
 * Callees:
