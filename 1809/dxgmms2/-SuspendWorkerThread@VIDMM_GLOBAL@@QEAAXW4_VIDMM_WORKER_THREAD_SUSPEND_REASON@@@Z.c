/*
 * XREFs of ?SuspendWorkerThread@VIDMM_GLOBAL@@QEAAXW4_VIDMM_WORKER_THREAD_SUSPEND_REASON@@@Z @ 0x1C007EBD4
 * Callers:
 *     VidMmSuspendWorkerThread @ 0x1C0015960 (VidMmSuspendWorkerThread.c)
 * Callees:
