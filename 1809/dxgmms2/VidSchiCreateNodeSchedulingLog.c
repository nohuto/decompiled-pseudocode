/*
 * XREFs of VidSchiCreateNodeSchedulingLog @ 0x1C0037C30
 * Callers:
 *     ?VidSchiProcessAsyncOperation@@YAXPEAX@Z @ 0x1C0035140 (-VidSchiProcessAsyncOperation@@YAXPEAX@Z.c)
...
__int64 __fastcall VidSchiCreateNodeSchedulingLog(struct _VIDSCH_NODE *a1, unsigned int a2)
{
  ...
  _QWORD v22[5]; // [rsp+30h] [rbp-50h] BYREF
  ...
  *((_QWORD *)v26 + 1) = v2;
  ...
  if ( (unsigned int)v10 < *(_DWORD *)(v4 + 688) )
    v11 += 8 * v10;
  HIDWORD(v22[0]) = *(unsigned __int16 *)(*(_QWORD *)v11 + 6LL);
  v12 = *(_QWORD *)(v4 + 616);
  if ( (unsigned int)v10 < *(_DWORD *)(v4 + 688) )
    v12 += 8 * v10;
  v13 = *(unsigned __int16 *)(*(_QWORD *)v12 + 8LL);
  LODWORD(v22[4]) = (unsigned int)(3 * v2) >> 2;
  v22[3] = v25;
  LODWORD(v22[0]) = v13;
  LODWORD(v22[1]) = v2;
  v22[2] = v9;
  v8 = ((__int64 (__fastcall *)(_QWORD, _QWORD *))DxgCoreInterface[20])(*(_QWORD *)(v4 + 8), v22);
  if ( v8 == -1073741822 )
    v8 = 0;
  if ( v8 < 0 )
  {
LABEL_16:
  ...
  {
    AcquireSpinLock::AcquireSpinLock((AcquireSpinLock *)v23, (unsigned __int64 *)(v4 + 1648), v14, 0);
    v15 = (void *)*((_QWORD *)a1 + 1386);
    v16 = *((_QWORD *)a1 + 1391);
    v17 = *((_QWORD *)a1 + 1392);
    v18 = *((_QWORD *)a1 + 1393);
    ...
    *((_QWORD *)a1 + 1390) = 0LL;
    ...
    {
      if ( bTracingEnabled )
        VidSchiSerializeSchedulingLog((_DWORD)a1, (_DWORD)v15, v16, v17, v18, (__int64)v26);
