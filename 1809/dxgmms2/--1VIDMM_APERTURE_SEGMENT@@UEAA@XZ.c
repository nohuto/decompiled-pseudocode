/*
 * XREFs of ??1VIDMM_APERTURE_SEGMENT@@UEAA@XZ @ 0x1C00B8B34
 * Callers:
 *     ??_GVIDMM_APERTURE_SEGMENT@@UEAAPEAXI@Z @ 0x1C0028380 (--_GVIDMM_APERTURE_SEGMENT@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?FreeGuardPages@VIDMM_APERTURE_SEGMENT@@IEAAXXZ @ 0x1C00B91A4 (-FreeGuardPages@VIDMM_APERTURE_SEGMENT@@IEAAXXZ.c)
