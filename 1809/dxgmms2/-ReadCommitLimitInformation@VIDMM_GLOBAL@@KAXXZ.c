/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@KAXXZ @ 0x1C008ABB4
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  dword_1C004D468 = v1;
  dword_1C004D46C = v8 << 20;
  dword_1C004D470 = v2;
  dword_1C004D474 = v4;
  if ( !v0 )
    qword_1C004D170 = (unsigned __int64)qword_1C004D158 >> 3;
}
