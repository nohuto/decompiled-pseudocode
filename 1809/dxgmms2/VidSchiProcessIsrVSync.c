/*
 * XREFs of VidSchiProcessIsrVSync @ 0x1C000AC10
 * Callers:
        ...
        __int64 a4)
{
  ...
  v9 = 0;
  v10 = 0;
  v11 = *(PSLIST_ENTRY *)(a1[1].Alignment + 2520);
  ...
  if ( Next )
  {
    ...
    if ( v10 != -1 && v10 < *((_DWORD *)&a1[2].HeaderX64 + 2) )
    {
      ...
      {
        LODWORD(v14) = 1;
        if ( _InterlockedExchange((volatile __int32 *)(v13 + 33216), 0) )
        {
          v79 = KeQueryPerformanceCounter(&PerformanceFrequency);
          if ( !*(_QWORD *)(v13 + 33208) )
            *(union _LARGE_INTEGER *)(v13 + 33208) = PerformanceFrequency;
          v23 = _InterlockedCompareExchange64((volatile signed __int64 *)(v13 + 33232), 0LL, 0LL);
          v15 = v79;
          v24 = v23;
          v25 = v79.QuadPart - *(_QWORD *)(v13 + 33152);
          if ( v24 )
          {
            if ( v25 > v24 )
            {
        ...
        *(_QWORD *)(v13 + 33160) += (unsigned int)v14;
        *(LARGE_INTEGER *)(v13 + 33152) = v15;
        if ( *(_BYTE *)(v13 + 8) && !LOBYTE(a1[9].Alignment) )
        {
          ...
          v82 = 0LL;
          v83 = 0;
          v27 = ((__int64 (__fastcall *)(ULONGLONG, _QWORD, _QWORD, __int64 *))DxgCoreInterface[60])(
                  Region,
                  0LL,
                  0LL,
                  &v80);
          ...
          if ( v27 >= 0 )
            v28 = v81;
          *(_QWORD *)(v13 + 33168) = v28;
        }
      }
LABEL_13:
      v16 = ExpInterlockedPopEntrySList((PSLIST_HEADER)(v13 + 33632));
      v11 = v16;
      if ( !v16 )
      {
LABEL_20:
      ...
      *((_DWORD *)&v18[5].Next + 2) = v10;
      ...
      v31 = 0;
      v32 = *(_BYTE *)(Alignment + 2430);
      v33 = *(_BYTE *)(Alignment + 2431);
      if ( !(_DWORD)EngineOrdinal )
      {
LABEL_17:
        if ( !v4 )
        {
          v18[5].Next = *(struct _SLIST_ENTRY **)(v13 + 33160);
          *((_QWORD *)&v18[3].Next + 1) = *(_QWORD *)(v13 + 33152);
          v18[4].Next = *(struct _SLIST_ENTRY **)(v13 + 33168);
        }
        *((_QWORD *)&v18[4].Next + 1) = a4;
        ExpInterlockedPushEntrySList(a1 + 106, v18 + 2);
        goto LABEL_20;
      }
      while ( 1 )
      {
