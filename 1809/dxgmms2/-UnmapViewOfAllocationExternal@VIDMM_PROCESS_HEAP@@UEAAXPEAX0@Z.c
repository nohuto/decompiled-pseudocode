/*
 * XREFs of ?UnmapViewOfAllocationExternal@VIDMM_PROCESS_HEAP@@UEAAXPEAX0@Z @ 0x1C00C4E40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VIDMM_PROCESS_HEAP::UnmapViewOfAllocationExternal(VIDMM_PROCESS_HEAP *this, PVOID *a2, GUID *a3)
{
  __int64 v5; // rbx
  __int64 v6; // rdx
  __int64 v7; // rcx
