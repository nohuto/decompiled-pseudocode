/*
 * XREFs of ?MergeRanges@VIDMM_RECYCLE_MULTIRANGE@@QEAAXPEAVVIDMM_RECYCLE_RANGE@@0@Z @ 0x1C005D770
 * Callers:
        ...
        struct VIDMM_RECYCLE_RANGE *a3)
{
  ...
  const GUID *v47; // [rsp+78h] [rbp-90h]
  ...
  do
  {
      ...
      if ( (_DWORD)v17 )
      {
        ...
        if ( (_DWORD)v18 )
        {
          if ( (_DWORD)v18 == 1 )
          {
            ...
            {
              v32 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v18, v14);
              v32[5] = 0LL;
              v32[6] = 0LL;
              v32[7] = 0LL;
              v32[3] = 270LL;
        ...
        else
        {
          if ( !v13 && g_IsInternalRelease )
          {
            v33 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v18, v14);
            v33[5] = 0LL;
            v33[6] = 0LL;
            v33[7] = 0LL;
            v33[3] = 270LL;
    ...
    {
      v34 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v17, v14);
      v34[3] = 270LL;
      v34[4] = 9LL;
      v34[5] = 0LL;
      v34[6] = 0LL;
