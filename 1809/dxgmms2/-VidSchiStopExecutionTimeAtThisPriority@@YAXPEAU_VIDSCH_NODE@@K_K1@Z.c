/*
 * XREFs of ?VidSchiStopExecutionTimeAtThisPriority@@YAXPEAU_VIDSCH_NODE@@K_K1@Z @ 0x1C00135F4
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( (_DWORD)v8 )
  {
    v9 = (unsigned __int64 *)((char *)a1 + 8 * v8 + 1952);
    do
    {
      if ( *(v9 - 8) )
      {
        ...
        *v9 = v11;
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        {
          ...
          McTemplateK0pqxq(v5, v12, v13, *(_QWORD *)(*((_QWORD *)a1 + 3) + 16LL), v8, v13, *((_WORD *)a1 + 2));
        }
      }
      --v9;
      LODWORD(v8) = v8 - 1;
