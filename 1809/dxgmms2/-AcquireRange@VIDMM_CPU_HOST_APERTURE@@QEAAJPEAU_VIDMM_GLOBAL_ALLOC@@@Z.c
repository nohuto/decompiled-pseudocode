/*
 * XREFs of ?AcquireRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00180EC
 * Callers:
...
__int64 __fastcall VIDMM_CPU_HOST_APERTURE::AcquireRange(VIDMM_CPU_HOST_APERTURE *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  struct _KAPC_STATE v30; // [rsp+58h] [rbp-70h] BYREF
    ...
    if ( v18 != v17 )
    {
      do
      {
        ...
        if ( v22 && (*(_BYTE *)(v22 + 32) & 1) != 0 )
        {
          ...
          VIDMM_PROCESS::SafeAttach(*(VIDMM_PROCESS **)(v22 + 8), &v30);
          ...
          *(_BYTE *)(v22 + 32) &= ~1u;
          VIDMM_PROCESS::SafeDetach(v26, &v30);
        }
