/*
 * XREFs of ?IoMmuUnmapAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C00A9824
 * Callers:
        ...
        struct _VIDMM_LOCAL_ALLOC *a3)
{
  ...
  if ( (*((_DWORD *)a2 + 20) & 0x400) == 0 )
  {
    ...
    DpiUnmapIommuIdentityRange(*(_QWORD *)(*((_QWORD *)this + 3) + 192LL), FullMDL);
  }
}
