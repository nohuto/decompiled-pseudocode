/*
 * XREFs of VidSchSetNodePowerState @ 0x1C0032A60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VidSchSetNodePowerState(__int64 a1, unsigned int a2, int a3, char a4)
{
  ...
  {
    if ( (*(_DWORD *)(v7 + 12) & 2) != 0 )
      VidSchiAsyncReCreateSchedulingLog((struct _VIDSCH_NODE *)v7);
    ...
    *(_BYTE *)(v7 + 11196) = 1;
    ...
    for ( i = 0; ; i = 1 )
    {
      ...
      if ( (_QWORD *)*v9 == v9 )
        break;
      *((_DWORD *)v11 + 44) &= ~0x80u;
      VidSchiUpdateContextStatus((__int64)(v11 - 1), (_QWORD *)5, 11610LL);
    }
    v12 = (_QWORD *)(v7 + 2600);
    v18 = &v17;
    v17 = (__int64)&v17;
