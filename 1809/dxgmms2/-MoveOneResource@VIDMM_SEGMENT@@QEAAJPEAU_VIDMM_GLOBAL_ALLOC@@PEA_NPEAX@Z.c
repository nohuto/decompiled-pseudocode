/*
 * XREFs of ?MoveOneResource@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@PEA_NPEAX@Z @ 0x1C00BD4D0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a4)
{
  ...
  if ( a2 && *((_QWORD *)a2 + 26) && *((_QWORD *)a2 + 28) == *((_QWORD *)a2 + 17) )
  {
      ...
      *(_QWORD *)(v10 + 24) = a2;
      ...
      while ( v11 != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 296) )
      {
        ...
        while ( v14 != v13 )
        {
          v15 = *(v14 - 4);
          v14 = (_QWORD *)*v14;
          VidSchMarkDeviceAsError(*(_QWORD *)(v15 + 32), 24LL, 0);
        }
      }
    }
    v16 = *((_QWORD *)a2 + 17);
    ...
    *((_QWORD *)a2 + 26) = 0LL;
    ...
    {
      LOBYTE(v23) = 1;
      VIDMM_GLOBAL::NotifyResidency((ADAPTER_RENDER **)this[1], a2, v23);
    }
    if ( IsNonOverlappingResourceCB )
