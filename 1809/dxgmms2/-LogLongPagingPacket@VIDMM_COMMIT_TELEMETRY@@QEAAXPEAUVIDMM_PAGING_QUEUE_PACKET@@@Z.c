/*
 * XREFs of ?LogLongPagingPacket@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z @ 0x1C00C1944
 * Callers:
        ...
        struct VIDMM_PAGING_QUEUE_PACKET *a2)
{
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 252LL)) <= 5 )
  {
      ...
      && (qword_1C004D060 & 0x400000000008LL) == qword_1C004D060 )
    {
      ...
      v15 = v11 - v5;
      v33 = 8;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0040861, &ActivityId, (LPCGUID)8, 8u, &pData);
    }
