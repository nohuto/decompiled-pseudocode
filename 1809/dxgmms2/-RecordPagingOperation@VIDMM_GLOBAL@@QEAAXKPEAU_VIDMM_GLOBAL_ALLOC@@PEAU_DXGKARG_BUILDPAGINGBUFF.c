/*
 * XREFs of ?RecordPagingOperation@VIDMM_GLOBAL@@QEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_DXGKARG_BUILDPAGINGBUFFER@@J_KHPEAX@Z @ 0x1C00723B4
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  if ( !bTracingEnabled )
    goto LABEL_11;
  v13 = (const GUID *)*((_QWORD *)this + (unsigned int)a2 + 143);
  v14 = *((_QWORD *)this + 3);
        ...
        if ( v18 )
        {
          ...
          if ( (_DWORD)v23 )
          {
            ...
            if ( (_DWORD)v26 )
            {
              ...
              if ( (_DWORD)v27 )
              {
                if ( (_DWORD)v27 == 1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
                  McTemplateK0pptpxx(
                    v27,
                    a2,
                    v13,
      ...
      if ( (_DWORD)v28 )
      {
        ...
        if ( (_DWORD)v28 )
        {
          ...
          if ( (_DWORD)v29 )
          {
            ...
            if ( (_DWORD)v30 )
            {
              if ( (_DWORD)v30 == 1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
        ...
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) == 0 )
          goto LABEL_11;
        v31 = (const EVENT_DESCRIPTOR *)&EventPagingOpWritePhysical;
      }
      else
      {
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) == 0 )
          goto LABEL_11;
        v31 = (const EVENT_DESCRIPTOR *)&EventPagingOpReadPhysical;
      }
      McTemplateK0pptqx(v28, v31, v13, v14, v13, a5 == -1071775743, a4->ReadPhysical.SegmentId, a4->Fill.FillSize);
      goto LABEL_11;
    }
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
...
LABEL_11:
  ...
  if ( v22 )
  {
    v32 = 360LL * *((unsigned int *)this + 1968);
    if ( a3 )
    {
      *(_QWORD *)(v32 + v22 + 8) = a3;
      *(_QWORD *)(360LL * *((unsigned int *)this + 1968) + *((_QWORD *)this + 983) + 16) = *((_QWORD *)a3 + 5);
    }
    else
    {
    ...
    *(_DWORD *)(360LL * *((unsigned int *)this + 1968) + *((_QWORD *)this + 983)) = v10;
    v33 = (_OWORD *)(360LL * *((unsigned int *)this + 1968) + *((_QWORD *)this + 983) + 24LL);
    do
    {
    ...
    *v33 = *(_OWORD *)&a4->pDmaBuffer;
    ...
    v33[2] = *(_OWORD *)&a4->MultipassOffset;
    v33[3] = *(_OWORD *)&a4->SpecialLockTransfer.TransferOffset;
    *(_DWORD *)(360LL * *((unsigned int *)this + 1968) + *((_QWORD *)this + 983) + 344) = a5;
    *(_QWORD *)(360LL * (unsigned int)(*((_DWORD *)this + 1968))++ + *((_QWORD *)this + 983) + 352) = a6;
