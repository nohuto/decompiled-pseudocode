/*
 * XREFs of ?SetAllocationPriority@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00AC108
 * Callers:
 *     VidMmSetAllocationPriority @ 0x1C00254F0 (VidMmSetAllocationPriority.c)
 * Callees:
