/*
 * XREFs of VidSchiIsQuantumLeft @ 0x1C001434C
 * Callers:
 ...
 * Callees:
 *     ?VidSchiSelectContextFromThisProcess@@YAXPEAU_VIDSCH_CONTEXT@@PEAPEAU1@@Z @ 0x1C0014450 (-VidSchiSelectContextFromThisProcess@@YAXPEAU_VIDSCH_CONTEXT@@PEAPEAU1@@Z.c)
...
__int64 __fastcall VidSchiIsQuantumLeft(__int64 a1, struct _VIDSCH_CONTEXT **a2)
{
  ...
  if ( _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 436), (*(_DWORD *)(a1 + 184) >> 1) & 1, 3) == 2 )
  {
    ...
    if ( v9[1] != a1 + 8
      ...
      || (*v10 = v9,
          v9[1] = (__int64)v10,
          v11 = 16LL * *(unsigned int *)(a1 + 404) + v3 + 2024,
          v12 = *(__int64 ***)(v11 + 8),
          *v12 != (__int64 *)v11) )
    {
      __fastfail(3u);
