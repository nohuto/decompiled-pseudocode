/*
 * XREFs of VidSchDdiNotifyInterrupt @ 0x1C000A1D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchDdiNotifyInterrupt(__int64 a1, unsigned int *a2)
{
  ...
  if ( (DpiGetSchedulerCallbackState(a1) & 2) == 0
    || ((DxgAdapter = DpiGetDxgAdapter(a1), (v6 = DxgAdapter) == 0)
      ? (v7 = 0LL)
      : (v7 = *(_QWORD *)(*(_QWORD *)(DxgAdapter + 2528) + 528LL)),
        !v7) )
  {
LABEL_11:
  ...
  if ( *a2 > 0xA || (v9 = 1160, !_bittest(&v9, *a2)) || *(_QWORD *)(v6 + 2520) )
  {
    VidSchDdiNotifyInterruptWorker(*(_QWORD *)(v6 + 2528), a2, 1LL);
    goto LABEL_11;
  }
