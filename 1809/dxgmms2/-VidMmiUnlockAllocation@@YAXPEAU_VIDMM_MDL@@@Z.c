/*
 * XREFs of ?VidMmiUnlockAllocation@@YAXPEAU_VIDMM_MDL@@@Z @ 0x1C006BD88
 * Callers:
 ...
 *     ?UnlockAllocation@VIDMM_PROCESS_HEAP@@UEAAXPEAX_K1E@Z @ 0x1C00C4CF0 (-UnlockAllocation@VIDMM_PROCESS_HEAP@@UEAAXPEAX_K1E@Z.c)
 * Callees:
...
void __fastcall VidMmiUnlockAllocation(PMDL *a1, __int64 a2, const GUID *a3)
{
  __int64 v4; // rcx
  const GUID *v5; // r8
  ...
  if ( (qword_1C004D010 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q((__int64)a1, &EventProfilerEnter, a3, 8001);
  }
  else
  {
    v8 = 0;
