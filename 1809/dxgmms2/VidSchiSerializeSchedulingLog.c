/*
 * XREFs of VidSchiSerializeSchedulingLog @ 0x1C00CA708
 * Callers:
 ...
 *     ?GetCpuVa@VIDMM_SCH_LOG@@QEAAPEAXXZ @ 0x1C003B328 (-GetCpuVa@VIDMM_SCH_LOG@@QEAAPEAXXZ.c)
 */
  ...
  if ( CpuVa[1] || (v18 = *CpuVa) != 0 )
  {
    do
    {
      ...
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x800000) != 0 )
      {
        ...
        LODWORD(v22) = v15;
        LODWORD(v21) = v12;
        LOBYTE(CpuVa) = McTemplateK0pqqxxxxqbr7(
                          (__int64)&v17[8 * v16 + 8],
                          v12,
                          v13,
                          *(_QWORD *)(v6 + 16),
