/*
 * XREFs of VidSchCreatePeriodicFrameNotification @ 0x1C0031E60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?VidSchCalculatePeriodicMonitoredFenceTimerDueTime@@YA_J_J00H@Z @ 0x1C0031118 (-VidSchCalculatePeriodicMonitoredFenceTimerDueTime@@YA_J_J00H@Z.c)
        ...
        _QWORD *a6)
{
  ...
  if ( (unsigned __int8)VidSchIsVSyncAvailable(a1, (unsigned int)v7) )
  {
    ...
    if ( (int)VidSchControlVSyncAdapter(a1, 3LL, v10) >= 0 )
    {
      ...
      if ( !PoolWithTag )
      {
        _InterlockedIncrement(&dword_1C004D6E8);
        v14 = WdLogNewEntry5_WdLowResource(v12);
        *(_QWORD *)(v14 + 24) = 12707LL;
...
LABEL_15:
      ...
      *((_BYTE *)v13 + 24) = v20;
      *(_QWORD *)(*(_QWORD *)(v9 + 66432) + 8LL * (unsigned __int8)*((_DWORD *)v13 + 6)) = v13;
      KeReleaseInStackQueuedSpinLock(&LockHandle);
      ...
      *((_DWORD *)v13 + 2) = v7;
      ...
      {
        v23 = *(_QWORD *)(a1 + 16);
        v24 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v23 + 2520) + 112LL) + 3760 * v7 + 1068);
        v40[2] = *(_QWORD *)(a5 + 16);
        LODWORD(v40[1]) = v24;
        LODWORD(v40[3]) = *((_DWORD *)v13 + 6);
        v25 = ((__int64 (__fastcall *)(_QWORD, _QWORD *))DxgCoreInterface[65])(*(_QWORD *)(v23 + 2520), v40);
        v15 = v25;
        if ( v25 >= 0 )
        {
          v22 = v40[4];
...
LABEL_30:
      ...
      if ( v27 == 2 )
      {
        ...
        *(_QWORD *)(v28 + 24) = v15;
        ...
        v15 = -1073741822;
LABEL_33:
        VidSchDestroyPeriodicFrameNotification(*(PVOID *)(*(_QWORD *)(v9 + 66432)
      ...
      v32 = VidSchCalculatePeriodicMonitoredFenceTimerDueTime(*(_QWORD *)(v9 + 33184), v13[6], v13[2], -1);
