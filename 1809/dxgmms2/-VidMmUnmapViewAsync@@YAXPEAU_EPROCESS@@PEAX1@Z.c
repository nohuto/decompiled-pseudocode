/*
 * XREFs of ?VidMmUnmapViewAsync@@YAXPEAU_EPROCESS@@PEAX1@Z @ 0x1C0059484
 * Callers:
 ...
 *     ?UnmapViewOfAllocation@VIDMM_PROCESS_HEAP@@UEAAXPEAX@Z @ 0x1C00C4D20 (-UnmapViewOfAllocation@VIDMM_PROCESS_HEAP@@UEAAXPEAX@Z.c)
 *     ?UnmapViewOfAllocationExternal@VIDMM_PROCESS_HEAP@@UEAAXPEAX0@Z @ 0x1C00C4E40 (-UnmapViewOfAllocationExternal@VIDMM_PROCESS_HEAP@@UEAAXPEAX0@Z.c)
 * Callees:
...
void __fastcall VidMmUnmapViewAsync(PVOID Object, PVOID a2, GUID *MappedBase)
{
  __int64 v6; // rcx
  const GUID *v7; // r8
  ...
  GUID *v12; // [rsp+68h] [rbp-10h]

  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0ppp((__int64)Object, &BeginVidMmUnmapViewAsync, MappedBase, Object, a2, MappedBase);
  if ( Object )
