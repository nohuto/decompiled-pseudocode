/*
 * XREFs of ?CalculateBudgetGroupTargetUsage@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@@Z @ 0x1C00C0D38
 * Callers:
        ...
        struct VIDMM_SEGMENT_GROUP_STATE *a4)
{
  ...
  {
    v7 = dword_1C004D440;
    v8 = (unsigned int)dword_1C004D444;
  }
  else
  {
    v6 = *(int *)a4;
    if ( (_DWORD)v6 )
    {
      ...
      {
        v7 = dword_1C004D450;
        v8 = (unsigned int)dword_1C004D454;
      }
      else
      {
    ...
    {
      v7 = dword_1C004D448;
      v8 = (unsigned int)dword_1C004D44C;
    }
  }
