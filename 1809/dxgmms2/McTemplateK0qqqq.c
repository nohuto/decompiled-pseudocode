/*
 * XREFs of McTemplateK0qqqq @ 0x1C002D394
 * Callers:
...
ULONG __fastcall McTemplateK0qqqq(__int64 a1, __int64 a2, const GUID *a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventDWMVsyncSignal, a3, 5u, &EventData);
}
