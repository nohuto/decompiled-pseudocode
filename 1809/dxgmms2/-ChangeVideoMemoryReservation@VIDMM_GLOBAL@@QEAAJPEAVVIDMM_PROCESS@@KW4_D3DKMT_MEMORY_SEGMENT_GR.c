/*
 * XREFs of ?ChangeVideoMemoryReservation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@KW4_D3DKMT_MEMORY_SEGMENT_GROUP@@_K@Z @ 0x1C00A7444
 * Callers:
 *     VidMmChangeVideoMemoryReservation @ 0x1C00251E0 (VidMmChangeVideoMemoryReservation.c)
 * Callees:
