/*
 * XREFs of ?DiscardAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C006FF70
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a3)
{
  ...
  do
  {
    ...
    v10 = this[2];
    v19.Transfer.TransferOffset = (IsPagingOperationPending == 0) | v19.Transfer.TransferOffset & 0xFFFFFFFE;
    ...
    VIDMM_GLOBAL::CompleteBuildPagingBufferIteration((VIDMM_GLOBAL *)this, v5, a2, &v19, v11, 0, 0LL);
  }
  while ( v11 < 0 );
}
