/*
 * XREFs of ?FlushGpuVaTlb@VIDMM_GLOBAL@@QEAAXIU_D3DGPU_PHYSICAL_ADDRESS@@PEAVVIDMM_PROCESS@@PEAX_K3@Z @ 0x1C0073CC0
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  if ( !*((_BYTE *)this + 7072) && (*((_BYTE *)this + 40872) & 0x10) == 0 )
  {
    ...
    v13 = *(_QWORD *)(*(_QWORD *)(FillPattern + 256) + 8 * v9);
    if ( v13 )
    {
      v15 = *(void **)(v13 + 48);
    }
...
LABEL_8:
    ...
    do
    {
      ...
      {
        v39 = (_QWORD *)WdLogNewEntry5_WdCriticalError(FillPattern, v11);
        v39[3] = 270LL;
        v39[4] = 29LL;
        v39[5] = v19;
        v39[6] = 0LL;
      ...
      *((_QWORD *)this + v9 + 399) = v25;
      ...
      v31 = -1LL;
      FillPattern = (unsigned int)(LODWORD(v63.pDmaBuffer) - *((_DWORD *)this + 2 * v9 + 670));
      ...
      *((_DWORD *)this + v9 + 414) += FillPattern;
      ...
      {
        v40 = (_QWORD *)WdLogNewEntry5_WdCriticalError(FillPattern, v29);
        v40[3] = 270LL;
        v40[4] = 18LL;
        v40[5] = 0LL;
        v40[6] = 0LL;
      ...
      *((_DWORD *)this + v9 + 542) += v32;
      ...
      {
        v41 = (_QWORD *)WdLogNewEntry5_WdCriticalError(FillPattern, v29);
        v41[3] = 270LL;
        v41[4] = 19LL;
        v41[5] = 0LL;
        v41[6] = 0LL;
      ...
      if ( bTracingEnabled )
      {
        ...
        if ( v63.Operation == DXGK_OPERATION_UPDATE_PAGE_TABLE )
        {
          ...
          {
            OffsetInPages = v63.MapApertureSegment.OffsetInPages;
            FillPattern = v63.Fill.FillPattern;
          }
          else if ( v63.Reserved.Reserved[20] > 1 )
          {
            OffsetInPages = 0LL;
          }
          else
          {
            OffsetInPages = v63.Transfer.TransferSize;
          }
      ...
      if ( v11 )
      {
        ...
        *(_QWORD *)(FillPattern + *((_QWORD *)this + 983) + 352) = v31;
      ...
      if ( (int)v33 < 0 )
      {
        ...
        v45 = *((_QWORD *)this + 3);
        v46 = (_QWORD *)WdLogNewEntry5_WdCriticalError(FillPattern, v11);
        v46[5] = &v63;
        v46[3] = 270LL;
        v46[4] = 11LL;
        v46[6] = v33;
