/*
 * XREFs of VidSchExitIndependentFlipInternal @ 0x1C00171B4
 * Callers:
        ...
        _QWORD *a8)
{
  ...
  *a7 = 0;
  ...
  while ( v15 )
  {
    ...
    v17 = a6;
    v13 = *(_QWORD *)(v12 + 88);
    v22 = *(_QWORD *)(v10 + 8LL * v50 + 2576) + 128LL + 216LL * *(unsigned int *)(v21 + 4 * v20);
  ...
  *a8 = v24;
  if ( (unsigned int)(v25 - 1) > 1 )
  {
    ...
    while ( v44 )
    {
      result = VidSchiCancelIndependentFlips((_DWORD)a1, v10, v43, *(_DWORD *)(v41 + 4LL * v42), (__int64)a7);
      while ( 1 )
      {
        v44 >>= 1;
        if ( !v44 || (v44 & 1) != 0 )
  ...
  else
  {
    ...
    *(_BYTE *)(v12 + 98) = 0;
    ...
    while ( v29 )
    {
      VidSchiCancelIndependentFlips((_DWORD)a1, v10, v28, *(_DWORD *)(v30 + 4LL * v27), (__int64)a7);
  ...
  *a7 = 0;
  ...
  if ( a6 )
  {
    ...
    while ( v36 )
    {
      *(_DWORD *)(216LL * *(unsigned int *)(v37 + 4LL * v38) + *(_QWORD *)(v10 + 8LL * v39 + 2576) + 164) = -1;
      while ( 1 )
      {
        v36 >>= 1;
        if ( !v36 || (v36 & 1) != 0 )
