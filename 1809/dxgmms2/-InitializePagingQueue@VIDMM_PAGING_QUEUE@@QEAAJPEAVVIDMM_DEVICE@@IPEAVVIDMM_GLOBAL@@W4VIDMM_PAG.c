/*
 * XREFs of ?InitializePagingQueue@VIDMM_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IPEAVVIDMM_GLOBAL@@W4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C006DEA4
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_QUEUE::InitializePagingQueue(__int64 a1, __int64 a2, int a3, __int64 a4, int a5)
{
  ...
  *(_DWORD *)(a1 + 132) = dword_1C004D3A4;
  *(_DWORD *)(a1 + 116) = a5;
  v6 = *(_QWORD *)(a4 + 24);
  if ( *(int *)(v6 + 2160) < 0x2000 )
    v7 = 1;
  else
    v7 = *(_DWORD *)(v6 + 256);
  if ( v7 > 1 )
