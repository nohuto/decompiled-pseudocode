/*
 * XREFs of McTemplateK0qqtqttp @ 0x1C0026E04
 * Callers:
...
ULONG __fastcall McTemplateK0qqtqttp(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventVidMmTryOperation, a3, 8u, &EventData);
}
