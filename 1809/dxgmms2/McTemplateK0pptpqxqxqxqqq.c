/*
 * XREFs of McTemplateK0pptpqxqxqxqqq @ 0x1C0019AB8
 * Callers:
 *     ?RecordPagingOperation@VIDMM_GLOBAL@@QEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_DXGKARG_BUILDPAGINGBUFFER@@J_KHPEAX@Z @ 0x1C00723B4 (-RecordPagingOperation@VIDMM_GLOBAL@@QEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@PEAU_DXGKARG_BUILDPAGINGBUFF.c)
...
ULONG McTemplateK0pptpqxqxqxqqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
