/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00AE2D8
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C00256B0 (VidMmValidateHistoryBuffers.c)
 * Callees:
  ...
  while ( 1 )
  {
    ...
    if ( v4[38] < 2 )
    {
      ...
      *(_QWORD *)(v7 + 32) = v4[38];
      ...
      VidSchMarkDeviceAsError(*(_QWORD *)(*((_QWORD *)v4 + 1) + 32LL), 17LL, 0);
      return 3221225473LL;
    }
  }
