/*
 * XREFs of McTemplateK0ppqPR2TR2 @ 0x1C00265D4
 * Callers:
...
ULONG McTemplateK0ppqPR2TR2(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v15 = 4 * v21;
  v10 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventReferenceAllocations, a3, 6u, &EventData);
}
