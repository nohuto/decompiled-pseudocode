/*
 * XREFs of VidMmReportContextAllocList @ 0x1C00B41E0
 * Callers:
 *     <none>
 * Callees:
 *     McTemplateK0pppppppppppp @ 0x1C002636C (McTemplateK0pppppppppppp.c)
 *     ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00B3CB4 (-VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z.c)
 */
