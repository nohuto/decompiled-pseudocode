/*
 * XREFs of ?Evict@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1C007CF94
 * Callers:
 *     ?VidMmEvict@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1C0015070 (-VidMmEvict@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z.c)
        ...
        unsigned __int64 *a6)
{
  ...
  for ( i = &v6[v7]; v6 != i; ++v6 )
  {
    ...
    if ( !((unsigned int)v14 | *((_DWORD *)v11 + 38)) && !*((_DWORD *)v11 + 39) )
    {
      ...
      v18[2] = v11;
      LODWORD(v18[4]) = a5;
      v16 = dword_1C004D3F0 || (*(_DWORD *)(v15[1] + 104LL) & 1) != 0;
