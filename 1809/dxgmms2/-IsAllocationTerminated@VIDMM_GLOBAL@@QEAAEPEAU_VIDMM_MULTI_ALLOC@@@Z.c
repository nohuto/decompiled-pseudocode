/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00A9A64
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C0025340 (VidMmIsAllocationTerminated.c)
 * Callees:
