/*
 * XREFs of McTemplateK0ppqqqPR4PR4 @ 0x1C002BCB0
 * Callers:
...
ULONG McTemplateK0ppqqqPR4PR4(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventSelectContext2, a3, 8u, &EventData);
}
