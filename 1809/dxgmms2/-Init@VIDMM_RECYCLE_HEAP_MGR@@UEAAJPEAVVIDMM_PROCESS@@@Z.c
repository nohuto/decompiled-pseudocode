/*
 * XREFs of ?Init@VIDMM_RECYCLE_HEAP_MGR@@UEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1C007D340
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  *((_QWORD *)this + 165) = v9;
  ...
  if ( v8 < 0 )
  {
    ...
    *(_QWORD *)(v16 + 24) = 9317LL;
    goto LABEL_14;
  }
  DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE(
    (DXGAUTOPUSHLOCKEXCLUSIVE *)v17,
    (struct _KTHREAD **)VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListLock);
  v12 = (_QWORD *)qword_1C004D730;
  v13 = (_QWORD *)((char *)this + 1592);
  if ( *(struct _LIST_ENTRY **)qword_1C004D730 != &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead )
    __fastfail(3u);
  *((_QWORD *)this + 200) = qword_1C004D730;
  *v13 = &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
  *v12 = v13;
  qword_1C004D730 = (__int64)this + 1592;
