/*
 * XREFs of ?LockAllocationRange@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@_K1EPEAEPEAPEAU_MDL@@@Z @ 0x1C0080450
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  if ( a5 )
  {
    ...
    if ( v20 )
    {
      memmove(*((void **)this + 32), v20, (size_t)a4);
      VidMmUnmapViewOfAllocation((struct _VIDMM_LOCAL_ALLOC *)v13, (GUID *)v25);
    }
    else
    {
