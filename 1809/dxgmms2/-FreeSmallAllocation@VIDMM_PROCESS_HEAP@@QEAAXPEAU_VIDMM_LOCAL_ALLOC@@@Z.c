/*
 * XREFs of ?FreeSmallAllocation@VIDMM_PROCESS_HEAP@@QEAAXPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C00C3B20
 * Callers:
...
void __fastcall VIDMM_PROCESS_HEAP::FreeSmallAllocation(VIDMM_PROCESS_HEAP *this, struct _VIDMM_LOCAL_ALLOC *a2)
{
  ...
  *(_QWORD *)(*((_QWORD *)v4 + 1) + 128LL) -= *(_QWORD *)(v3 + 56);
  ...
  {
    v11 = *(_QWORD *)(v3 + 8);
    v14 = (unsigned int)(*(_DWORD *)(v11 + 80) - 3) > 3 ? *(_QWORD *)(v11 + 32) : *(_QWORD *)(v11 + 88);
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
      McTemplateK0qpxp(
        *((_QWORD *)v4 + 1),
        &EventDestroyProcessAllocationDetails,
        v10,
        *(_DWORD *)(*((_QWORD *)v4 + 1) + 8LL),
        v3,
        *(_QWORD *)(v3 + 56),
        v14);
  }
