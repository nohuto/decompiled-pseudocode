/*
 * XREFs of VidSchSubmitCommand @ 0x1C0068C70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidMmFreeDeferredDmaBufferMapping @ 0x1C0015C10 (VidMmFreeDeferredDmaBufferMapping.c)
 *     VidSchiConvertDeferredWaits @ 0x1C0016A6C (VidSchiConvertDeferredWaits.c)
 ...
 *     VidSchiAllocateHistoryBufferStorage @ 0x1C00C6664 (VidSchiAllocateHistoryBufferStorage.c)
 */
...
__int64 __fastcall VidSchSubmitCommand(struct _VIDSCH_CONTEXT *a1, struct VIDSCH_SUBMIT_DATA2 *a2)
{
  ...
  char *v30; // rbx
  struct _VIDSCH_CONTEXT **v31; // rcx
  ...
  if ( !PoolWithTag )
  {
    ...
    do
    {
      ...
      if ( v12 )
        ...
        VidSchWaitForCompletionEvent(v7, (__int64)v40, (const GUID *)0x13);
    }
    while ( !PoolWithTag );
    VidSchiInterlockedRemoveEntryList((KSPIN_LOCK *)(v7 + 1664), v40, 0LL);
LABEL_24:
    if ( !PoolWithTag )
      goto LABEL_26;
  }
...
LABEL_26:
        ...
        if ( (((unsigned __int16)v17 | (unsigned __int16)(v17 >> 10)) & 0x3FF) != 0 )
        {
          ...
          do
          {
            ...
            if ( !v13 )
              v21 = v20;
            v22 = (char)v21;
            v23 = *(int *)(216LL * (unsigned int)(char)v21 + v19 + 164);
            if ( (int)v23 > -1 )
            {
              v24 = *(unsigned int *)(136 * v23 + *(_QWORD *)(v5 + 2704) + 112);
              if ( (_DWORD)v24 == 2 )
              {
                v38 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v21, v24);
                v38[5] = v22;
                v38[3] = 281LL;
                v38[4] = 0x100000LL;
                v38[6] = *((unsigned int *)a2 + 31);
                v38[7] = v5;
                WdLogEvent5_WdCriticalError(v38);
                VidMmFreeDeferredDmaBufferMapping(v39);
                JUMPOUT(0x1C006931CLL);
              }
            }
            v18 &= ~(1 << v21);
          }
  ...
  *((_QWORD *)PoolWithTag + 19) = *((_QWORD *)a2 + 14);
  ...
  {
    PoolWithTag[16] = (*(_DWORD *)(v5 + 1936) >> 5) & 4;
  }
  else
  {
    PoolWithTag[16] = 4;
  ...
  v25 = (void *)*((_QWORD *)PoolWithTag + 46);
  if ( v25 )
    ObfReferenceObject(v25);
  v26 = *((_QWORD *)PoolWithTag + 35);
  if ( v26 && (PoolWithTag[68] & 0x8000000) != 0 && !*((_QWORD *)PoolWithTag + 40) )
    *((_QWORD *)PoolWithTag + 40) = *(_QWORD *)(v26 + 96);
  if ( (PoolWithTag[152] & 1) != 0 )
    VidSchiConvertDeferredWaits((__int64)v3);
  if ( *((_DWORD *)a2 + 88) )
  {
    v27 = (const void *)*((_QWORD *)a2 + 43);
    result = VidSchiAllocateHistoryBufferStorage(PoolWithTag);
    if ( (int)result < 0 )
      return result;
    memmove(*((void **)PoolWithTag + 77), v27, 8LL * *((unsigned int *)a2 + 88));
  }
...
LABEL_71:
  v35 = *((unsigned int *)a2 + 31);
  if ( (unsigned int)v35 < *(_DWORD *)(v5 + 40) && (*(_BYTE *)a2 & 5) == 5 )
    _InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(v5 + 8 * v35 + 2576) + 66416LL), 2, 1);
  return 0LL;
}
