/*
 * XREFs of ?ReadBudgetConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C00888B0
 * Callers:
...
void VIDMM_GLOBAL::ReadBudgetConfiguration(void)
{
  ...
  v4 = 10000 * v26;
  v5 = 10000 * v24;
  dword_1C004D390 = 10000 * v26;
  dword_1C004D384 = 10000 * v2;
  dword_1C004D38C = 10000 * v24;
  dword_1C004D388 = 10000 * v3;
  if ( 10000 * v24 <= 0xEA60 )
  {
    if ( v5 < 0x10 )
    {
