/*
 * XREFs of ?OpenLocalAllocation@VIDMM_GLOBAL@@IEAAPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_PROCESS@@PEAXPEAE@Z @ 0x1C00631DC
 * Callers:
...
LABEL_42:
  ...
  while ( 1 )
  {
    if ( v10 == v9 )
    {
      ...
      _InterlockedIncrement(&dword_1C004D5B0);
      v29 = WdLogNewEntry5_WdLowResource(v13);
      *(_QWORD *)(v29 + 24) = 12226LL;
