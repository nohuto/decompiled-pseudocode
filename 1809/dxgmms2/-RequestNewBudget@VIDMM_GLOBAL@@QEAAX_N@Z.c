/*
 * XREFs of ?RequestNewBudget@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C007A5AC
 * Callers:
 ...
 *     ?NotifyProcessStatusChange@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C007A594 (-NotifyProcessStatusChange@VIDMM_GLOBAL@@QEAAXXZ.c)
      ...
      while ( 2 )
      {
        ...
        do
        {
          if ( (*v8 & 1) != 0 )
          {
            ...
            if ( i )
            {
              while ( !*(_BYTE *)(*(_QWORD *)(i[4] + 368LL * *(unsigned int *)(*((_QWORD *)this + 3) + 208LL) + 24)
                                + 328LL * v4
                                + 120) )
              {
                v11 = (_QWORD **)i[1];
