/*
 * XREFs of ?ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ @ 0x1C00B8428
 * Callers:
 *     ?ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ @ 0x1C00B8268 (-ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ.c)
 * Callees:
 *     McTemplateK0pppppppqq @ 0x1C00280F8 (McTemplateK0pppppppqq.c)
 *     McTemplateK0qpxp @ 0x1C0028290 (McTemplateK0qpxp.c)
 */

void __fastcall VIDMM_RECYCLE_BLOCK::ReportStates(VIDMM_RECYCLE_BLOCK *this, __int64 a2, const GUID *a3)
{
  char *v3; // r14
  char *i; // rsi
  char *v6; // rbx
  ...
  for ( i = (char *)*((_QWORD *)this + 9); i != v3; i = *(char **)i )
  {
    ...
    if ( v7 == 1 || v7 > 1 && v7 <= 5 )
    {
      ...
      {
        v8 = *((_QWORD *)this + 4);
        a3 = (const GUID *)((unsigned int)(*(_DWORD *)v8 - 3) > 3 ? *((_QWORD *)v6 + 4) : *((_QWORD *)this + 7));
