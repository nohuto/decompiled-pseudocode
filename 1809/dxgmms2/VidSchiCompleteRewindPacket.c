/*
 * XREFs of VidSchiCompleteRewindPacket @ 0x1C0013920
 * Callers:
 ...
 *     VidSchiSetNextRunPacket @ 0x1C0013B48 (VidSchiSetNextRunPacket.c)
    ...
    *(_QWORD *)(a1 + 648) = 0LL;
    if ( (v18 & 0x200) != 0 )
    {
      if ( (((unsigned __int8)(*(_DWORD *)(a1 + 184) >> 9) | *(_BYTE *)(a1 + 184)) & 2) == 0 )
        VidSchiUpdateContextStatus(a1, (_QWORD *)0xA, 14271LL);
    }
    ...
    {
      return (unsigned int)VidSchiUpdateContextStatus(a1, (_QWORD *)5, 14284LL);
    }
  }
  return v3;
}
