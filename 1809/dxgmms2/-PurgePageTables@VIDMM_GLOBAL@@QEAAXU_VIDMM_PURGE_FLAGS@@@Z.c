/*
 * XREFs of ?PurgePageTables@VIDMM_GLOBAL@@QEAAXU_VIDMM_PURGE_FLAGS@@@Z @ 0x1C00AB1F8
 * Callers:
...
void __fastcall VIDMM_GLOBAL::PurgePageTables(__int64 a1, char a2)
{
  ...
  if ( (*(_BYTE *)(a1 + 40872) & 2) != 0 )
  {
    for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 6992); *(_BYTE *)(v5 + 436) = v7 & 0x7F )
    {
      v5 = *(_QWORD *)(a1 + 40184) + 1560LL * (unsigned int)i;
      v6 = *(_BYTE *)(v5 + 436);
      v7 = v6;
      ...
      v12 = *(CVirtualAddressAllocator **)(a1 + 8 * i + 40352);
