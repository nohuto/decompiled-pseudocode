/*
 * XREFs of ?FlushScratchGpuVaRanges@VIDMM_GLOBAL@@QEAAXI@Z @ 0x1C0080114
 * Callers:
...
void __fastcall VIDMM_GLOBAL::FlushScratchGpuVaRanges(VIDMM_GLOBAL *this, unsigned int a2)
{
  ...
  v3 = a2;
  v4 = 1560LL * a2;
  if ( (*(_BYTE *)(*((_QWORD *)this + 5023) + v4 + 436) & 1) != 0 )
  {
        ...
        if ( (v5 & 1) == 0 )
        {
          *((_BYTE *)this + 40873) = v5 | 1;
          ...
          while ( 1 )
          {
            ...
            while ( 1 )
            {
              v8 = (_QWORD **)(v4 + *((_QWORD *)this + 5023) + 464LL);
              v9 = *v8;
