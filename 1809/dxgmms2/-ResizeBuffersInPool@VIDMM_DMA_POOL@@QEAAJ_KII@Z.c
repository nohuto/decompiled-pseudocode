/*
 * XREFs of ?ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z @ 0x1C00B3080
 * Callers:
 *     VidMmResizeBuffersInPool @ 0x1C00254B0 (VidMmResizeBuffersInPool.c)
 * Callees:
