/*
 * XREFs of ?PageInDeviceInternal@VIDMM_GLOBAL@@IEAAJPEAVVIDMM_DEVICE@@_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C006B6DC
 * Callers:
        ...
        struct VIDMM_ALLOC **a5)
{
  ...
  _QWORD *v16; // r14
  int v18; // eax
  struct VIDMM_ALLOC **v19; // [rsp+20h] [rbp-48h]
  bool v21; // [rsp+80h] [rbp+18h]
  bool *v22; // [rsp+88h] [rbp+20h]
  ...
  *a5 = 0LL;
  ...
  if ( (*((_DWORD *)v15 + 19) & 0x100) != 0 )
  {
    ...
    LOBYTE(a4) = a3;
    v18 = VIDMM_GLOBAL::PageInOneAllocation(v7, v11, 0LL, a4, v19, a5);
LABEL_35:
    v8 = v18;
    goto LABEL_36;
  }
