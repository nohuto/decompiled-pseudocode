/*
 * XREFs of LookUpTableFlushComplete @ 0x1C008D614
 * Callers:
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0059640 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(_DWORD *a1)
{
  ...
  if ( a1[64] )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C004D080 > 5
        && (qword_1C004D090 & 0x400000000000LL) != 0
        && (qword_1C004D098 & 0x400000000000LL) == qword_1C004D098 )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C004D080, &unk_1C00411A7, 0LL, v5, 0xBu, &pData);
      }
