/*
 * XREFs of ?VidSchiSelectContextFromThisPriority@@YAPEAU_VIDSCH_CONTEXT@@PEAU_VIDSCH_NODE@@K_N@Z @ 0x1C0008BD0
 * Callers:
 ...
 * Callees:
 *     VidSchiIsQuantumLeft @ 0x1C001434C (VidSchiIsQuantumLeft.c)
        ...
        char a3)
{
  ...
  v7 = v6 && a3;
  v8 = 2LL * a2;
  v9 = (_QWORD *)*((_QWORD *)a1 + 2 * a2 + 253);
  v10 = v9 - 1;
  v11 = *((_QWORD *)a1 + 2 * a2 + 254) - 8LL;
  if ( v9 - 1 == (_QWORD *)v11 )
  {
    if ( !v7 )
    {
    ...
    if ( !(unsigned int)VidSchiIsQuantumLeft(v9 - 1, &v20) )
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      {
        ...
        McTemplateK0qpiixi(v10[58], v17, v16, *((unsigned __int16 *)a1 + 2), v17, v10[58], v10[55], v10[57], v10[56]);
      }
      return 0LL;
    }
    return v20;
  ...
  do
  {
    ...
    if ( v7 )
    {
      ...
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      {
        ...
        McTemplateK0qpiixi(v19, v14, v15, *((unsigned __int16 *)a1 + 2), v19, v13[58], v13[55], v13[57], v13[56]);
      }
    }
    else
    {
  ...
  result = v20;
  if ( !v20 )
    return (struct _VIDSCH_CONTEXT *)(*((_QWORD *)a1 + v8 + 253) - 8LL);
  return result;
}
