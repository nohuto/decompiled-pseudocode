/*
 * XREFs of McTemplateK0pptpqxpxx @ 0x1C0019644
 * Callers:
...
ULONG McTemplateK0pptpqxpxx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventPagingOpFlushTlb, a3, 0xAu, &EventData);
}
