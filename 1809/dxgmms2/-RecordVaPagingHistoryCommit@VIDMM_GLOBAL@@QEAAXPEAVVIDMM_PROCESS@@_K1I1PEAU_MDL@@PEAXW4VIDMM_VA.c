/*
 * XREFs of ?RecordVaPagingHistoryCommit@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@_K1I1PEAU_MDL@@PEAXW4VIDMM_VAD_OWNER_TYPE@@@Z @ 0x1C00B5A3C
 * Callers:
        ...
        int a9)
{
  ...
  if ( *(_QWORD *)(a1 + 40920) )
  {
    ...
    *(_QWORD *)(v13 + 8) = KeGetCurrentThread();
    ...
    if ( v14 )
    {
      v15 = *(unsigned int *)(a1 + 40928);
      if ( (_DWORD)v15 == dword_1C004D32C )
      {
        *(_DWORD *)(a1 + 40928) = 0;
        v15 = 0LL;
      }
      v16 = *(void **)(*(_QWORD *)(a1 + 40920) + 24 * v15 + 16);
      if ( v16 )
        operator delete(v16);
      v14[15] = a9;
      *((_QWORD *)v14 + 5) = a7;
