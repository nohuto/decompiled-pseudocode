/*
 * XREFs of ?RotateCopyCallback@VIDMM_MEMORY_SEGMENT@@KAJPEAU_MDL@@0PEAX@Z @ 0x1C00BB6B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VIDMM_MEMORY_SEGMENT::RotateCopyCallback(struct _MDL *a1, struct _MDL *a2, char *a3)
{
  ...
  else
  {
    if ( *(_BYTE *)(v5 + 40139) )
    {
      v9 = DpiMapIommuIdentityRange(*(_QWORD *)(*(_QWORD *)(v5 + 24) + 192LL), a1);
      v12 = v9;
      if ( v9 < 0 )
      {
    ...
    *((_QWORD *)a3 + 4) += ByteCount;
    ...
    if ( *(_BYTE *)(v5 + 40139) )
      DpiUnmapIommuIdentityRange(*(_QWORD *)(*(_QWORD *)(v5 + 24) + 192LL), a1);
  }
  return 0LL;
}
