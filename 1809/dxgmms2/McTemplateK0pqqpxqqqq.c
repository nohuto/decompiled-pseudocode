/*
 * XREFs of McTemplateK0pqqpxqqqq @ 0x1C002C454
 * Callers:
...
ULONG McTemplateK0pqqpxqqqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventMMIOFlip, a3, 0xAu, &EventData);
}
