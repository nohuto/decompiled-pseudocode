/*
 * XREFs of ?QueryAllocationResidency@VIDMM_GLOBAL@@QEAA?AW4_D3DKMT_ALLOCATIONRESIDENCYSTATUS@@PEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00AB3E8
 * Callers:
 *     VidMmQueryAllocationResidency @ 0x1C00253B0 (VidMmQueryAllocationResidency.c)
 * Callees:
