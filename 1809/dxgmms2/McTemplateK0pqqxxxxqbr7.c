/*
 * XREFs of McTemplateK0pqqxxxxqbr7 @ 0x1C00369B8
 * Callers:
...
ULONG McTemplateK0pqqxxxxqbr7(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v23 = 0;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventSchedulingLog, 0LL, 0xAu, &EventData);
}
