/*
 * XREFs of ?ReadPhysicalAdapterConfiguration@VIDMM_GLOBAL@@IEAAXI@Z @ 0x1C008C104
 * Callers:
...
void __fastcall VIDMM_GLOBAL::ReadPhysicalAdapterConfiguration(VIDMM_GLOBAL *this, unsigned int a2)
{
  ...
  v2 = (unsigned __int64 *)(*((_QWORD *)this + 5023) + 1560LL * a2);
  DpiGetPnpRegistryKeyName(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 2416LL) + 352LL * a2 + 8));
  v3 = Source;
  v4 = 0;
