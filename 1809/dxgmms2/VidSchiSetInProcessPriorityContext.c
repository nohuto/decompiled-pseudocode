/*
 * XREFs of VidSchiSetInProcessPriorityContext @ 0x1C0015A90
 * Callers:
 *     VidSchSetInProcessPriorityContext @ 0x1C007EDD0 (VidSchSetInProcessPriorityContext.c)
 * Callees:
...
__int64 __fastcall VidSchiSetInProcessPriorityContext(__int64 a1, int a2)
{
  ...
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)(*(_QWORD *)(a1 + 96) + 24LL) + 1648LL), &LockHandle);
  v6 = *(_DWORD *)(a1 + 408);
  if ( v6 != a2 )
  {
    if ( bTracingEnabled )
