/*
 * XREFs of ?DestroyAllocation@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C005FD68
 * Callers:
 *     VidMmDestroyAllocation @ 0x1C0001950 (VidMmDestroyAllocation.c)
 * Callees:
