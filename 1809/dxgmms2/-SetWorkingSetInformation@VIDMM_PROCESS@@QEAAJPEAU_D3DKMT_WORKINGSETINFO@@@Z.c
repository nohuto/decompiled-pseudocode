/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C00B2740
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C0025530 (VidMmSetWorkingSetInformation.c)
 * Callees:
