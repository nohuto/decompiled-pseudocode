/*
 * XREFs of CopyNodeStatistics @ 0x1C00C7AB4
 * Callers:
 *     VidSchQueryNodeStatistics @ 0x1C00C87C0 (VidSchQueryNodeStatistics.c)
 *     VidSchQueryProcessNodeStatistics @ 0x1C00C88A0 (VidSchQueryProcessNodeStatistics.c)
 * Callees:
 *     <none>
 */
