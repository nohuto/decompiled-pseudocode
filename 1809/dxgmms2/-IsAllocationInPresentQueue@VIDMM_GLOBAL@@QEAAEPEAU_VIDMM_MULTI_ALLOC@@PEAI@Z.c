/*
 * XREFs of ?IsAllocationInPresentQueue@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@PEAI@Z @ 0x1C0081B44
 * Callers:
 *     VidMmIsAllocationInPresentQueue @ 0x1C0025320 (VidMmIsAllocationInPresentQueue.c)
        ...
        unsigned int *a3)
{
  ...
  char HasOutstandingPresentReferences; // al
  char v5; // r11
  char v6; // cl
  char v7; // r9
