/*
 * XREFs of ?EndCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKPEAU_VIDMM_REGION@@@Z @ 0x1C007E004
 * Callers:
 *     VidMmEndCPUAccess @ 0x1C00155F0 (VidMmEndCPUAccess.c)
 * Callees:
