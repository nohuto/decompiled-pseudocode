/*
 * XREFs of ?GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z @ 0x1C00B2AA8
 * Callers:
 *     VidMmGetNextBuffersContractedSize @ 0x1C00252A0 (VidMmGetNextBuffersContractedSize.c)
 * Callees:
 *     ?NeedToBeTrimmed@VIDMM_DMA_POOL@@IEAAHXZ @ 0x1C00B2B20 (-NeedToBeTrimmed@VIDMM_DMA_POOL@@IEAAHXZ.c)
 *     ?TrimPool@VIDMM_DMA_POOL@@QEAAXE@Z @ 0x1C00B3210 (-TrimPool@VIDMM_DMA_POOL@@QEAAXE@Z.c)
 */
