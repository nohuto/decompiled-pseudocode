/*
 * XREFs of ?TerminateOneAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C0065DBC
 * Callers:
        ...
        struct DXGTERMINATIONTRACKER *a5)
{
  ...
  __int64 v27; // rax
  __int64 v28; // rax
  _QWORD v29[4]; // [rsp+38h] [rbp-81h] BYREF
  _BYTE v30[8]; // [rsp+58h] [rbp-61h] BYREF
  __int64 v31; // [rsp+60h] [rbp-59h]
  int v32; // [rsp+68h] [rbp-51h]
  _QWORD v33[16]; // [rsp+78h] [rbp-41h] BYREF
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v13, 0LL) )
  {
    if ( bTracingEnabled )
    {
      ...
      if ( v26 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0q(v14, &EventBlockThread, v15, v26);
    }
