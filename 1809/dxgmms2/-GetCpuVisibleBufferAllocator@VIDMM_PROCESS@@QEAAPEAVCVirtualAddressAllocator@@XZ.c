/*
 * XREFs of ?GetCpuVisibleBufferAllocator@VIDMM_PROCESS@@QEAAPEAVCVirtualAddressAllocator@@XZ @ 0x1C00B2034
 * Callers:
...
struct CVirtualAddressAllocator *__fastcall VIDMM_PROCESS::GetCpuVisibleBufferAllocator(VIDMM_PROCESS *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(v3 + 323) & 8) == 0 )
      break;
    v4 = *(_QWORD *)(*(_QWORD *)(v3 + 456) + 72LL);
    if ( v4 )
      this = *(VIDMM_PROCESS **)(v4 + 8);
    else
      this = 0LL;
  }
  DXGAUTOPUSHLOCKEXCLUSIVE::DXGAUTOPUSHLOCKEXCLUSIVE((DXGAUTOPUSHLOCKEXCLUSIVE *)v17, (struct _KTHREAD **)this + 27);
  v5 = *((_QWORD *)this + 26);
  if ( v5 )
    goto LABEL_17;
  ...
  *((_QWORD *)this + 26) = v7;
  if ( v7 )
  {
    ...
    v11 = CVirtualAddressAllocator::InitializeVaAllocator(v7, *(_QWORD *)(*(_QWORD *)(v10 + 456) + 176LL), 0, 0LL, 0LL);
    v15 = (CVirtualAddressAllocator *)*((_QWORD *)this + 26);
    if ( v11 < 0 )
    {
      CVirtualAddressAllocator::DestroyVaAllocator(v15, v12, v13, v14);
      *((_QWORD *)this + 26) = 0LL;
      goto LABEL_18;
    }
