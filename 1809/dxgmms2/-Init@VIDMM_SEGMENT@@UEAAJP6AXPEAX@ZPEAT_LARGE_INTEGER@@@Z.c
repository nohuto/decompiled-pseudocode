/*
 * XREFs of ?Init@VIDMM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C0086DD0
 * Callers:
 *     ?Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C0086BB0 (-Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
 *     ?Init@VIDMM_APERTURE_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C0086C60 (-Init@VIDMM_APERTURE_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
...
__int64 __fastcall VIDMM_SEGMENT::Init(PHYSICAL_ADDRESS *this, void (*a2)(void *), union _LARGE_INTEGER *a3)
{
  ...
  else
  {
    ...
    if ( !v6 )
    {
      _InterlockedIncrement(&dword_1C004D5C0);
    ...
    || (LOBYTE(a2) = 6, result = VIDMM_SEGMENT::BlockMemoryRanges(this, a2, 12LL), (int)result >= 0) )
  {
      ...
      || (LOBYTE(a2) = 7, result = VIDMM_SEGMENT::BlockMemoryRanges(this, a2, 18LL), (int)result >= 0) )
    {
      if ( a3 )
        ...
        QuadPart = *(_QWORD *)(*(_QWORD *)(this[1].QuadPart + 24) + 1824LL);
      ...
      if ( (int)v10 >= 0 )
      {
        ...
        if ( PagesForMdl )
        {
          v15 = (unsigned int)dword_1C004D184;
          this[30].QuadPart = (unsigned int)dword_1C004D184;
          if ( (_DWORD)v15 )
          {
            v24 = v15;
            v23 = 16 * v15;
            ...
            {
              this[30].LowPart = 0;
              _InterlockedIncrement(dword_1C004D694);
        ...
        _InterlockedIncrement(&dword_1C004D658);
