/*
 * XREFs of ?InvalidateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C00A96A0
 * Callers:
 *     VidMmInvalidateAllocation @ 0x1C0025300 (VidMmInvalidateAllocation.c)
 * Callees:
