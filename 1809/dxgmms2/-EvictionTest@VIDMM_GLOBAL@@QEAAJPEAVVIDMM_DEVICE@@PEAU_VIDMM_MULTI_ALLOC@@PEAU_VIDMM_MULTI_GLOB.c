/*
 * XREFs of ?EvictionTest@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C00A87F0
 * Callers:
 *     ?VidMmEvictionTest@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C0024D00 (-VidMmEvictionTest@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MU.c)
 * Callees:
