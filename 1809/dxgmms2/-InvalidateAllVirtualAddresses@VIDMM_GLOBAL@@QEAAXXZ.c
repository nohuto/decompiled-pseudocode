/*
 * XREFs of ?InvalidateAllVirtualAddresses@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00A965C
 * Callers:
 *     VidMmInvalidateAllVirtualAddresses @ 0x1C00252E0 (VidMmInvalidateAllVirtualAddresses.c)
 * Callees:
