/*
 * XREFs of ?PinOneAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@@Z @ 0x1C00814F8
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::PinOneAllocation(VIDMM_GLOBAL *this, VIDMM_DEVICE **a2)
{
  ...
  if ( (int)result >= 0 && !v12 )
  {
    ...
    v11[2] = a2;
    v6 = *(_QWORD *)v5;
    LODWORD(v11[4]) = (**(_DWORD **)(*(_QWORD *)v5 + 504LL) & 0x20000) != 0 ? 5 : 0;
    v9 = VIDMM_GLOBAL::QueueDeferredCommand(
           this,
           (struct VIDMM_PAGING_QUEUE *)(*((_QWORD *)a2[1] + 9) + 176LL * (*(_DWORD *)(v6 + 76) & 0x3F)),
