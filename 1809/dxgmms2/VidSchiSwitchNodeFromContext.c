/*
 * XREFs of VidSchiSwitchNodeFromContext @ 0x1C007A720
 * Callers:
 *     VidSchiSwitchFromSuspendedDevices @ 0x1C0012610 (VidSchiSwitchFromSuspendedDevices.c)
 *     ?VidSchiSwitchNodeFromDevice@@YAXPEAX@Z @ 0x1C0031860 (-VidSchiSwitchNodeFromDevice@@YAXPEAX@Z.c)
 * Callees:
...
__int64 __fastcall VidSchiSwitchNodeFromContext(__int64 a1)
{
  ...
  {
    result = *(unsigned int *)(result + 2856);
    if ( !(_DWORD)result )
    {
      v2 = *(_QWORD *)(a1 + 96);
      ...
      *(_BYTE *)(v3 + 54) = 1;
      if ( *(_DWORD *)(v2 + 11192) != -1 )
      {
        v5 = *(void (__fastcall **)(_QWORD))(v3 + 2432);
        if ( v5 )
          v5(*(_QWORD *)(v3 + 2496));
      }
      *(_BYTE *)(v3 + 54) = 0;
