/*
 * XREFs of ?Free@VIDMM_LINEAR_POOL@@QEAAXPEAX@Z @ 0x1C007CB4C
 * Callers:
 ...
 *     ?FreeScratchRange@VIDMM_MEMORY_SEGMENT@@UEAAXPEAX@Z @ 0x1C00BAD00 (-FreeScratchRange@VIDMM_MEMORY_SEGMENT@@UEAAXPEAX@Z.c)
 ...
 * Callees:
 *     ?FindAdjacentBlocksOnFreeList@VIDMM_LINEAR_POOL@@IEAAXPEAU_VIDMM_POOL_BLOCK@@PEAPEAU2@1@Z @ 0x1C0076308 (-FindAdjacentBlocksOnFreeList@VIDMM_LINEAR_POOL@@IEAAXPEAU_VIDMM_POOL_BLOCK@@PEAPEAU2@1@Z.c)
  ...
  if ( v3 )
  {
    ...
    if ( *(_QWORD *)v3 == v14 + *(_QWORD *)v2 && *((_BYTE *)v3 + 56) == 2 )
    {
      *((_QWORD *)v2 + 1) = v14 + *((_QWORD *)v3 + 1);
      v15 = *((_QWORD *)v3 + 3);
      if ( *(struct _VIDMM_POOL_BLOCK **)(v15 + 8) == (struct _VIDMM_POOL_BLOCK *)((char *)v3 + 24) )
      {
        ...
        if ( *v16 == (struct _VIDMM_POOL_BLOCK *)((char *)v3 + 24) )
        {
          ...
          *(_QWORD *)(v15 + 8) = v16;
          v17 = *((_QWORD *)v3 + 5);
          if ( *(struct _VIDMM_POOL_BLOCK **)(v17 + 8) == (struct _VIDMM_POOL_BLOCK *)((char *)v3 + 40) )
          {
