/*
 * XREFs of ?FlushPendingAllocationAccess@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAUVIDMM_ALLOC@@E@Z @ 0x1C00A89EC
 * Callers:
    ...
    if ( *v5 != v5 )
    {
      do
      {
        ...
        for ( i = (_QWORD *)*(v8 - 2); i != v10; i = (_QWORD *)*i )
        {
          ...
          {
            v12 = *(i - 4);
            if ( !a4 || (v13 = *(_QWORD *)(v12 + 24)) != 0 && !*(_BYTE *)(*(_QWORD *)(v13 + 40) + 322LL) )
            {
              v9 = *(_QWORD *)(v12 + 32);
...
LABEL_13:
    ...
    v17 = 0LL;
    v16 = 5;
    VidSchFlushDevice(v9, &v16, v14, v15);
  }
}
