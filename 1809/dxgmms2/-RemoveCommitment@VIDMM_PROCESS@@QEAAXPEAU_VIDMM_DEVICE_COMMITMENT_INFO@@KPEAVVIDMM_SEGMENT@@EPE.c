/*
 * XREFs of ?RemoveCommitment@VIDMM_PROCESS@@QEAAXPEAU_VIDMM_DEVICE_COMMITMENT_INFO@@KPEAVVIDMM_SEGMENT@@EPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0072734
 * Callers:
...
LABEL_10:
  v17 = *(_QWORD *)(*((_QWORD *)this + 2) + 8 * v11);
  v18 = *(_QWORD *)(v17 + 48) + 296 * (*((_DWORD *)a6 + 19) & 0x3FLL);
  _InterlockedExchangeAdd64((volatile signed __int64 *)(v18 + 8LL * *((int *)a4 + 119) + 200), -v10);
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
    McTemplateK0xxpqhu(*(_QWORD *)(v17 + 40), &EventVidMmProcessCommitmentChange, *(const GUID **)v17);
