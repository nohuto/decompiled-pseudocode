/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@@Z @ 0x1C008ADF0
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C0018730 (VidMmInitializeAdapter.c)
 * Callees:
...
struct VIDMM_GLOBAL *__fastcall VidMmiInit(struct ADAPTER_RENDER *a1)
{
  ...
  if ( ZwQuerySystemInformation(SystemBasicInformation, SystemInformation, 0x40u, 0LL) < 0
    || *(_QWORD *)(v2 + 1824) < (unsigned __int64)v31 << 12 )
  {
...
LABEL_24:
  ...
  if ( v17 < 0 )
  {
    _InterlockedIncrement(&dword_1C004D600);
