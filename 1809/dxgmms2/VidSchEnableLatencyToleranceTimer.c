/*
 * XREFs of VidSchEnableLatencyToleranceTimer @ 0x1C00324D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VidSchEnableLatencyToleranceTimer(__int64 a1, char a2, const GUID *a3)
{
  ...
  *(_BYTE *)(a1 + 2528) = a2;
  if ( a2 )
  {
    ...
    *(_QWORD *)(a1 + 2512) = v5 + *(_QWORD *)(a1 + 2520);
    *(_QWORD *)(a1 + 1312) = MEMORY[0xFFFFF78000000320];
    KeSetEvent((PRKEVENT)(a1 + 1280), 0, 0);
  }
