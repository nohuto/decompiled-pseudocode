/*
 * XREFs of ?CleanupPrimaryAllocation@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00A74F4
 * Callers:
  ...
  while ( v4 != v2 )
  {
    ...
    while ( v8 != v7 )
    {
      ...
      if ( (v10 & 3) != 0 )
      {
        ...
        _InterlockedDecrement((volatile signed __int32 *)(*((_QWORD *)a2 + 63) + 12LL));
      }
    }
    v14 = *((_QWORD *)a2 + 17);
    if ( v14 && !*((_DWORD *)a2 + 40) )
