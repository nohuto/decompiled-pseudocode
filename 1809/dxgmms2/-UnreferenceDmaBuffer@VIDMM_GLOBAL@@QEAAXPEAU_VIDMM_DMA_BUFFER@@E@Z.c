/*
 * XREFs of ?UnreferenceDmaBuffer@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@E@Z @ 0x1C00261D8
 * Callers:
 *     VidMmUnreferenceDmaBuffer @ 0x1C0025610 (VidMmUnreferenceDmaBuffer.c)
