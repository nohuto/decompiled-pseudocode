/*
 * XREFs of ?SuspendCpuAccess@VIDMM_SEGMENT@@QEAAJXZ @ 0x1C00BF004
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::SuspendCpuAccess(VIDMM_SEGMENT *this, __int64 a2, VIDMM_DEVICE **a3)
{
  ...
  struct _KAPC_STATE v33; // [rsp+80h] [rbp-68h] BYREF
      ...
      while ( v22 != (VIDMM_SEGMENT *)((char *)this + 176) )
      {
        ...
        else
        {
          ...
          if ( v24 && (*(_BYTE *)(v24 + 32) & 1) != 0 )
          {
            ...
            KeStackAttachProcess(**(PRKPROCESS **)(*(_QWORD *)(v23 + 104) + 8LL), &v33);
            LODWORD(v31) = 1;
