/*
 * XREFs of ?LockInternal@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_LOCK2_DATA@@PEAUVIDMM_ALLOC@@PEAPEAXKPEA_NPEAPEAU3@@Z @ 0x1C0066700
 * Callers:
 ...
 *     ?LockAllocInCpuVisibleSegment@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@@Z @ 0x1C00A9C18 (-LockAllocInCpuVisibleSegment@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@@Z.c)
      ...
      if ( v21 )
      {
        ...
        if ( (_DWORD)v17 )
        {
          ...
          if ( (v22 & 0x20000000) != 0 )
          {
            ...
            CurrentProcess = PsGetCurrentProcess(0LL, v15);
