/*
 * XREFs of ?CreateReservedVaRange@CVirtualAddressAllocator@@AEAAPEAUVIDMM_MAPPED_VA_RANGE@@PEAUVIDMM_VAD@@I_K1U_D3DDDIGPUVIRTUALADDRESS_PROTECTION_TYPE@@1@Z @ 0x1C007F248
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  if ( v12 )
  {
    ...
    VIDMM_MAPPED_VA_RANGE::ReleaseVaRangeReference((char *)v12);
  }
  else
  {
    _InterlockedIncrement(&dword_1C004D6D4);
    v16 = WdLogNewEntry5_WdLowResource(v11);
    *(_QWORD *)(v16 + 24) = 1795LL;
