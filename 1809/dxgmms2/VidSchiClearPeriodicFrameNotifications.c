/*
 * XREFs of VidSchiClearPeriodicFrameNotifications @ 0x1C002D948
 * Callers:
...
void __fastcall VidSchiClearPeriodicFrameNotifications(__int64 a1, unsigned int a2)
{
  ...
  if ( *(_QWORD *)(v3 + 66432) )
  {
    ...
    ExFreePoolWithTag(*(PVOID *)(v3 + 66432), 0x62616956u);
    *(_QWORD *)(v3 + 66432) = 0LL;
