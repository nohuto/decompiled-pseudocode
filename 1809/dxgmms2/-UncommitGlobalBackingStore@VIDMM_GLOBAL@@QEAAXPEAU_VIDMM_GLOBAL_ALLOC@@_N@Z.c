/*
 * XREFs of ?UncommitGlobalBackingStore@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@_N@Z @ 0x1C005FD80
 * Callers:
...
LABEL_4:
  ...
  _InterlockedExchangeAdd64(
    (volatile signed __int64 *)(1560LL * (*((_DWORD *)a2 + 19) & 0x3F) + *((_QWORD *)v6 + 5023) + 1528),
    -*((_QWORD *)a2 + 1));
  *((_DWORD *)a2 + 23) &= ~1u;
}
