/*
 * XREFs of McTemplateK0pptpxqqx @ 0x1C0019DD0
 * Callers:
...
ULONG McTemplateK0pptpxqqx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&DxgkControlGuid_Context, &EventPagingOpFill, a3, 9u, &EventData);
}
