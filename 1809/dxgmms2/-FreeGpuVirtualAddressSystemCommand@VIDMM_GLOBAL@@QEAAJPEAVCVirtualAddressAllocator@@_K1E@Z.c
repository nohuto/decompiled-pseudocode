/*
 * XREFs of ?FreeGpuVirtualAddressSystemCommand@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@_K1E@Z @ 0x1C0079EA4
 * Callers:
 ...
 *     ?CompareVadByStartAddressAvl@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z @ 0x1C007EBB4 (-CompareVadByStartAddressAvl@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z.c)
 */
      ...
      if ( *((_QWORD *)this + 5115) )
      {
        ...
        if ( v19 )
        {
          ...
          *((_QWORD *)this + 5118) = KeGetCurrentThread();
          v20 = *((_DWORD *)this + 10232);
          if ( v20 == dword_1C004D32C )
          {
            *((_DWORD *)this + 10232) = 0;
            v20 = 0;
          }
          v21 = *(void **)(*((_QWORD *)this + 5115) + 24LL * v20 + 16);
          if ( v21 )
            operator delete(v21);
          *v19 = *v25;
          v19[1] = v25[4];
