/*
 * XREFs of ?CreateContextAllocation@VIDMM_GLOBAL@@QEAAJU_DXGK_CREATECONTEXTALLOCATIONFLAGS@@IPEAVDXGDEVICE@@PEAVDXGCONTEXT@@PEAX_KKKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXGK_SEGMENTBANKPREFERENCE@@U_DXGK_ALLOCATIONINFOFLAGS@@PEAPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C007DA00
 * Callers:
 *     ?VidMmCreateContextAllocation@@YAJPEAVVIDMM_GLOBAL@@IU_DXGK_CREATECONTEXTALLOCATIONFLAGS@@PEAVDXGDEVICE@@PEAVDXGCONTEXT@@PEAX_KKKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXGK_SEGMENTBANKPREFERENCE@@U_DXGK_ALLOCATIONINFOFLAGS@@PEAPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C0015410 (-VidMmCreateContextAllocation@@YAJPEAVVIDMM_GLOBAL@@IU_DXGK_CREATECONTEXTALLOCATIONFLAGS@@PEAVDX.c)
 * Callees:
        ...
        struct _VIDMM_CONTEXT_ALLOC **a14)
{
  ...
  v19 = 0LL;
  if ( a4 )
    v20 = (struct VIDMM_DEVICE *)*((_QWORD *)a4 + 81);
  else
    v20 = 0LL;
  v46 = v20;
  if ( !a4 || *(_BYTE *)(*((_QWORD *)a4 + 5) + 321LL) )
  {
    v42 = WdLogNewEntry5_WdAssertion(this, a2);
    *(_QWORD *)(v42 + 24) = 2012LL;
...
LABEL_39:
  ...
  {
    v39 = WdLogNewEntry5_WdAssertion(this, a2);
    *(_QWORD *)(v39 + 24) = 2019LL;
    goto LABEL_20;
  }
  v23 = -1;
  v24 = !_BitScanForward((unsigned int *)&v25, *((_DWORD *)a5 + 97));
  a4 = a5;
  if ( !v24 )
    v23 = v25;
  v15 = v23;
...
LABEL_10:
  ...
  v17 = v45;
  OneAllocation = VIDMM_GLOBAL::OpenOneAllocation(this, v46, v45, 0LL, 0, 0LL, &v44, (unsigned __int8 *)&a12);
  if ( OneAllocation < 0 )
  {
    v18 = v44;
LABEL_34:
...
LABEL_37:
  ...
  v18 = v44;
  OneAllocation = VidSchInsertContextAllocation(*((_QWORD *)this[2] + 66), v14, v21, (_DWORD)v44, (__int64)&v50);
  if ( OneAllocation < 0 )
  {
