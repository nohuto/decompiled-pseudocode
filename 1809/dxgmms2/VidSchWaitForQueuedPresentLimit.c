/*
 * XREFs of VidSchWaitForQueuedPresentLimit @ 0x1C0066D00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchWaitForQueuedPresentLimit(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( a1 )
  {
    ...
    else
    {
      ...
      if ( *(_DWORD *)(v7 + 1140) >= *(_DWORD *)(a1 + 244) )
      {
        if ( !a3 )
          return 3223191810LL;
        ...
        if ( *(_DWORD *)(v7 + 1140) >= *(_DWORD *)(a1 + 244) )
          v6 = VidSchWaitForCompletionEvent(v5, (__int64)v12, (const GUID *)2);
        VidSchiInterlockedRemoveEntryList((KSPIN_LOCK *)(v5 + 1664), v12, 0LL);
      }
      return v6;
    }
  }
