/*
 * XREFs of VidSchQueryLastCompletedPresentIdDWM @ 0x1C0014730
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall VidSchQueryLastCompletedPresentIdDWM(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a1 && a3 )
  {
    ...
    else
    {
      ...
      KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v6 + 1656), &v13);
      *(_DWORD *)a3 = *(_DWORD *)(a1 + 4 * v3 + 508);
      *(_DWORD *)(a3 + 4) = *(_DWORD *)(a1 + 8 * v3 + 576);
      *(_QWORD *)(a3 + 8) = *(_QWORD *)(a1 + 8 * v3 + 704);
      KeReleaseInStackQueuedSpinLockFromDpcLevel(&v13);
      *(_DWORD *)(a3 + 16) = *(_DWORD *)(*(_QWORD *)(v6 + 8 * v3 + 2576) + 33176LL);
      *(_QWORD *)(a3 + 24) = *(_QWORD *)(*(_QWORD *)(v6 + 8 * v3 + 2576) + 33184LL);
      v7 = 0;
      v8 = *(int *)(*(_QWORD *)(v6 + 8 * v3 + 2576) + 164LL);
      if ( (int)v8 > -1 )
        v9 = *(_QWORD *)(v6 + 2704) + 136 * v8;
      else
        v9 = 0LL;
      if ( v9 )
        v7 = *(_DWORD *)(v9 + 100);
