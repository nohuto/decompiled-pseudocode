/*
 * XREFs of ?VidMmUnmapViewOfAllocation@@YAXPEAU_VIDMM_LOCAL_ALLOC@@PEAX@Z @ 0x1C006C398
 * Callers:
...
void __fastcall VidMmUnmapViewOfAllocation(struct _VIDMM_LOCAL_ALLOC *a1, GUID *a2)
{
  __int64 v2; // rdi
      ...
      if ( (v6 & 8) == 0 )
      {
        ...
        if ( ((unsigned __int8)a1 & (*(_BYTE *)(v2 + 80) >= 0)) != 0 )
        {
          if ( (v6 & 0x20000000) != 0 )
          {
            ...
            {
              CurrentProcess = (void *)PsGetCurrentProcess(a1, v6);
            }
