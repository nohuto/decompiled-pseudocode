/*
 * XREFs of ?ReleaseResource@VIDMM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAX_K@Z @ 0x1C007CA20
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a3 )
  {
    ...
    if ( *((_DWORD *)this + 92) != -1 && v6 && (*((_DWORD *)v6 + 19) & 0x200) == 0 )
    {
      ...
      if ( v20 < a4 )
      {
        ...
        *(_QWORD *)(v22 + 24) = 1938LL;
        WdLogEvent5_WdAssertion(v22);
        v21 = this[29];
      }
      v23 = (unsigned __int64)v21 - a4;
      this[29] = (VIDMM_GLOBAL *)v23;
      if ( v20 > qword_1C004D400 && v23 <= qword_1C004D400 )
      {
