/*
 * XREFs of ?AddToAdapterList@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C008B600
 * Callers:
...
void __fastcall VIDMM_GLOBAL::AddToAdapterList(VIDMM_GLOBAL *this)
{
  ...
  v2 = (_QWORD *)qword_1C004D760;
  v3 = (_QWORD *)((char *)this + 41464);
  if ( *(struct _LIST_ENTRY **)qword_1C004D760 != &VIDMM_GLOBAL::_AdapterListHead )
    __fastfail(3u);
  v4 = v7 == 1;
  *v3 = &VIDMM_GLOBAL::_AdapterListHead;
  v3[1] = v2;
  *v2 = v3;
  qword_1C004D760 = (__int64)v3;
  if ( v4 )
  {
