/*
 * XREFs of ??0DXGAUTOEXPUSHLOCKEXCLUSIVE@@QEAA@QEAU_EX_PUSH_LOCK@@@Z @ 0x1C000168C
 * Callers:
 ...
 *     ?RemoveFromAdapterList@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00ABA38 (-RemoveFromAdapterList@VIDMM_GLOBAL@@QEAAXXZ.c)
 * Callees:
 *     <none>
 */
