/*
 * XREFs of ?Init@VIDMM_MEMORY_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C00BAD20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0VIDMM_CPU_HOST_APERTURE@@QEAA@XZ @ 0x1C0028E10 (--0VIDMM_CPU_HOST_APERTURE@@QEAA@XZ.c)
 *     ?BlockRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z @ 0x1C0028E68 (-BlockRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z.c)
...
__int64 __fastcall VIDMM_MEMORY_SEGMENT::Init(PHYSICAL_ADDRESS *this, void (*a2)(void *), union _LARGE_INTEGER *a3)
{
  ...
  if ( (v10 & 0x40) != 0 )
  {
    v11.QuadPart = (unsigned int)(qword_1C004D460 - 0x800000);
  ...
  if ( (v10 & 0x2000) != 0 )
  {
    ...
    if ( !v16 )
    {
      _InterlockedIncrement(&dword_1C004D6C4);
