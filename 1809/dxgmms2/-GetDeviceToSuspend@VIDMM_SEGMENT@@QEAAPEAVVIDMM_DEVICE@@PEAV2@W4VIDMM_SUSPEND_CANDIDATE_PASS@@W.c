/*
 * XREFs of ?GetDeviceToSuspend@VIDMM_SEGMENT@@QEAAPEAVVIDMM_DEVICE@@PEAV2@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_PRIORITY_BAND@@PEAPEAV2@@Z @ 0x1C00B1174
 * Callers:
 ...
 *     ?CanSuspendThisDevice@VIDMM_DEVICE@@QEAA_NPEAV1@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_PRIORITY_BAND@@@Z @ 0x1C00B07E0 (-CanSuspendThisDevice@VIDMM_DEVICE@@QEAA_NPEAV1@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_P.c)
 *     ?IsResumedRecently@VIDMM_DEVICE@@QEBA_NXZ @ 0x1C00B1554 (-IsResumedRecently@VIDMM_DEVICE@@QEBA_NXZ.c)
 */
        ...
        struct VIDMM_DEVICE **a5)
{
  ...
  if ( v7 != (_QWORD *)(a1 + 136) )
  {
    do
    {
      ...
      v10 = (_QWORD *)*(v7 - 3);
      v7 = (_QWORD *)*v7;
      if ( !(unsigned __int8)PsIsSystemProcess(*v10) && !*(_BYTE *)(*(_QWORD *)(*v8 + 32LL) + 320LL) )
      {
        v11 = v8 + 5;
        v12 = (_QWORD *)v8[5];
        while ( v12 != v11 )
