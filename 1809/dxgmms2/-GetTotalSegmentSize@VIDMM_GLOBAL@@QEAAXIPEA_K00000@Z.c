/*
 * XREFs of ?GetTotalSegmentSize@VIDMM_GLOBAL@@QEAAXIPEA_K00000@Z @ 0x1C0076880
 * Callers:
 *     VidMmGetTotalSegmentSize @ 0x1C0010B20 (VidMmGetTotalSegmentSize.c)
 * Callees:
        ...
        unsigned __int64 *a8)
{
  ...
  *a8 = v12;
  ...
  if ( Current )
    v26 = *(_QWORD *)(368LL * *(unsigned int *)(*((_QWORD *)this + 3) + 208LL) + *((_QWORD *)Current + 4) + 16);
  v28 = *a8;
  if ( *a8 > v26 )
  {
    *a8 = v26;
