/*
 * XREFs of ?LogLockAllocationBackingStoreToEtw@VIDMM_SEGMENT@@SAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C006F274
 * Callers:
  ...
  if ( bTracingEnabled )
  {
    ...
    if ( v5 )
    {
      ...
      for ( i = *((_QWORD *)v4 + 1) >> 12; (_DWORD)i; LODWORD(i) = i - v9 )
      {
        ...
        {
          LODWORD(v13) = v9;
          McTemplateK0xxqXR2(v12, (__int64)v10, 0LL, v3, v4, v13, v14);
        }
      }
    }
    else if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
    {
      McTemplateK0xxqXR2((__int64)a1, a2, a3, v3, v4, 0, 0LL);
    }
  }
}
