/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C007E0B0
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C0015610 (VidMmDestroyContextAllocation.c)
 * Callees:
