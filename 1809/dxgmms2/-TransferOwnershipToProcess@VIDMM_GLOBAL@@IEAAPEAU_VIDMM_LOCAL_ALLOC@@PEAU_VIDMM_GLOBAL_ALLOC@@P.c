/*
 * XREFs of ?TransferOwnershipToProcess@VIDMM_GLOBAL@@IEAAPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAU2@1@Z @ 0x1C0076B48
 * Callers:
        ...
        PRKPROCESS **a4)
{
        ...
        if ( (struct _VIDMM_GLOBAL_ALLOC *)((char *)v16 - 56) != a3 )
        {
          ...
          if ( v19 != v18 )
          {
            ...
            do
            {
              ...
              VidSchMarkDeviceAsError((__int64)v21, 13LL, 0);
  ...
  else if ( bTracingEnabled )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
    {
      ...
      McTemplateK0pqq(v10, &EventTransferAllocationOwnership, (const GUID *)a3, a2, v10, v5);
    }
  }
  return v6;
}
