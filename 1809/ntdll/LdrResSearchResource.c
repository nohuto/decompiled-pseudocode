        ...
        __int64 a8)
{
  ...
  int v31; // [rsp+68h] [rbp-110h] BYREF
  ...
  UNICODE_STRING UnicodeString; // [rsp+98h] [rbp-E0h] BYREF
  ...
  UNICODE_STRING DestinationString; // [rsp+D0h] [rbp-A8h] BYREF
  _BYTE v44[48]; // [rsp+E0h] [rbp-98h] BYREF
...
LABEL_37:
  ...
  if ( (v17 & 0x20000) != 0 )
  {
    if ( (v17 & 0x400) == 0 || (v22 = (__int64 *)v32) == 0LL || !*(_QWORD *)v32 )
    {
      v18 = -1073741811;
      v27 = -1073741811;
      goto LABEL_100;
  ...
  if ( (unsigned __int64)SourceString < 0x10000 )
  {
    ...
    if ( ((unsigned __int16)SourceString & 0x3FF) != 0 && SourceString != (PCWSTR)127 )
    {
      *(_QWORD *)&UnicodeString.Length = 0LL;
      ...
      LOBYTE(v23) = 1;
      if ( (int)RtlLcidToLocaleName((unsigned int)SourceString, &UnicodeString, 2LL, v23) >= 0 )
      {
...
LABEL_93:
      if ( v33 )
      {
        ...
        if ( (int)result < 0 )
          return result;
        v26 = LdrpResSearchResourceHandle((HANDLE)Handle, v36, v32, v35, v34);
      }
      else
      {
        v26 = LdrpResSearchResourceMappedFile((_DWORD)v30, v29, v17, (unsigned int)v45, v28, v36, v32, v35, v34);
      }
      v18 = v26;
      v27 = v26;
    }
LABEL_100:
  ...
  if ( (v17 & 0x1000) == 0
    || (result = ZwQueryVirtualMemory(-1LL, Handle & 0xFFFFFFFFFFFFFFFCuLL, 0LL, v44, 48LL, 0LL), (int)result >= 0) )
  {
LABEL_76:
