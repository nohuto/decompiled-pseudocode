/*
 * XREFs of RtlpHpVaMgrCtxAllocatorReference @ 0x1800644F4
 * Callers:
...
__int64 __fastcall RtlpHpVaMgrCtxAllocatorReference(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int64 a4)
{
  unsigned int v5; // edi
  unsigned int v7; // edi
  __int64 v8; // rax
