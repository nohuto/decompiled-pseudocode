/*
 * XREFs of LdrpLogFatalUserCallbackException @ 0x1800D14D0
 * Callers:
...
__int64 __fastcall LdrpLogFatalUserCallbackException(__int64 a1, __int64 a2)
{
  ...
  if ( v7 )
    ...
    result = RtlUnhandledExceptionFilter2(v20, &unk_18011CBC2);
  if ( (_DWORD)result != -1 )
  {
    if ( !(unsigned int)EtwEventRegister(UserLoaderGuid, 0LL, 0LL, &v19) )
    {
