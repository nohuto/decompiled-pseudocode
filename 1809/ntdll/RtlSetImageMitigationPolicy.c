/*
 * XREFs of RtlSetImageMitigationPolicy @ 0x1800E38F0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG BufferSize)
{
  ...
  if ( inited >= 0 )
  {
    ...
    if ( inited >= 0 )
    {
      ...
      if ( ImagePath )
      {
        v13 = RtlpOpenImageFileOptionsKeyEx(&v127.Length, 131087LL, v5 == 0, &KeyHandle);
      }
      else
      {
        ObjectAttributes.RootDirectory = 0LL;
        ObjectAttributes.ObjectName = (PUNICODE_STRING)&unk_180118B78;
