/*
 * XREFs of AVrfpQueryProcessVerifierOptions @ 0x1800DC638
 * Callers:
...
__int64 __fastcall AVrfpQueryProcessVerifierOptions(_QWORD *a1)
{
  ...
  if ( (NtCurrentPeb()->NtGlobalFlag & 0x2000100) == 0 )
    return 0LL;
  v3 = ((__int64 (__fastcall *)(_QWORD, unsigned int *, _QWORD))qword_18015F498)(0LL, &v7, 0LL);
  if ( v3 == -1073741820 )
  {
    ...
    if ( DebugInfo )
    {
      ...
      *(_DWORD *)DebugInfo = v6;
      v3 = ((__int64 (__fastcall *)(_QWORD, unsigned int *, char *))qword_18015F498)(0LL, &v8, DebugInfo);
      if ( v3 >= 0 )
        a1[18] = v5;
      else
