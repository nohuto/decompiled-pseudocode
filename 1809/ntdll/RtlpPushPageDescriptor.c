/*
 * XREFs of RtlpPushPageDescriptor @ 0x1800F73D8
 * Callers:
 *     RtlpLeakCallbackRoutine @ 0x1800F7260 (RtlpLeakCallbackRoutine.c)
 *     RtlpReadProcessHeaps @ 0x1800F7540 (RtlpReadProcessHeaps.c)
 * Callees:
 *     RtlAllocateHeap @ 0x18000F2A0 (RtlAllocateHeap.c)
 *     DbgPrint @ 0x18004F300 (DbgPrint.c)
 *     memmove @ 0x1800A6DC0 (memmove.c)
 *     RtlpGetBlockInfo @ 0x1800F7028 (RtlpGetBlockInfo.c)
    ...
    if ( (int)v8 > 0 )
    {
      ...
      do
      {
        ...
        *(_QWORD *)v9 = v9;
        if ( *(_QWORD *)(v9 + 16) != v13 )
        {
          v14 = (__int64 *)qword_180163B18;
          if ( *(__int64 **)qword_180163B18 != &RtlpLeakList )
            __fastfail(3u);
