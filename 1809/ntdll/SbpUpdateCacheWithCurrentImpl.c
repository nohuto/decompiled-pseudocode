/*
 * XREFs of SbpUpdateCacheWithCurrentImpl @ 0x180027EF0
 * Callers:
...
LABEL_6:
  if ( v6 == -1 )
    v9 = (char *)&SbSupportedOsList;
  else
    v9 = (char *)&SbSupportedOsList + 32 * v6;
  v10 = *(_DWORD **)(a2 + 24);
  v11 = 0LL;
  if ( !*v10 )
    return 1LL;
          ...
          do
          {
            ...
            if ( !v17 )
            {
              ...
              if ( !*(_QWORD *)(v18 + v12 + 80) && *(_DWORD *)(v18 + v12 + 88) == 2 )
                *(_QWORD *)(v18 + v12 + 80) = SbpResolveBasedOnName(*(_QWORD *)(v18 + v12 + 72));
      ...
      if ( (unsigned int)v14 >= v19 )
      {
        ...
        if ( v19 )
        {
          ...
          if ( !*(_QWORD *)(v23 + 80) && *(_DWORD *)(v23 + 88) == 2 )
            *(_QWORD *)(v23 + 80) = SbpResolveBasedOnName(*(_QWORD *)(v23 + 72));
