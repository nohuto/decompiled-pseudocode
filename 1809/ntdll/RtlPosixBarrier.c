/*
 * XREFs of RtlPosixBarrier @ 0x1800ED504
 * Callers:
 *     RtlBarrier @ 0x1800ED490 (RtlBarrier.c)
 *     RtlBarrierForDelete @ 0x1800ED4A0 (RtlBarrierForDelete.c)
 * Callees:
...
char __fastcall RtlPosixBarrier(__int64 a1, int a2)
{
  ...
  else
  {
    while ( (_DWORD)v13 == *v11 )
      RtlpWaitOnAddress((_QWORD *)(v2 + 4), &v13, 4LL, 0LL, RtlpWaitOnAddressSpinCount);
  }
  if ( v5 )
