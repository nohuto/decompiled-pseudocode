...
__int64 __fastcall RtlpWnfProcessCurrentDescriptor(unsigned __int64 a1, char *a2, __int64 a3, __int64 a4)
{
  ...
  v9 = (unsigned __int64 *)(qword_1801660D0 + 16);
  for ( i = *(unsigned __int64 **)(qword_1801660D0 + 16); ; i = (unsigned __int64 *)*i )
  {
    if ( i == v9 )
      goto LABEL_25;
    v11 = i - 4;
...
LABEL_28:
    ...
    v6 = 128;
LABEL_25:
    RtlReleaseSRWLockShared((volatile signed __int64 *)(qword_1801660D0 + 8));
    goto LABEL_23;
  }
  if ( v5 )
  {
  ...
  if ( v6 )
  {
    ...
    for ( *((_DWORD *)v11 + 32) = 2; v22 != v15; v22 = (__int64 *)*v22 )
    {
      if ( (*((_BYTE *)v22 + 52) & 4) != 0 && *((_DWORD *)v22 + 28) )
      {
        if ( !v24 || v24 > v22[15] )
          v24 = v22[15];
        if ( *((_DWORD *)v22 + 32) < *(_DWORD *)(qword_1801660D0 + 72) )
          v23 = 0;
      }
    }
    v11[17] = v24;
