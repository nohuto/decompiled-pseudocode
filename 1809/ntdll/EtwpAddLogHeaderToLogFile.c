...
__int64 __fastcall EtwpAddLogHeaderToLogFile(__int64 a1, void *a2, int a3, char a4)
{
  ...
  char v60[20]; // [rsp+140h] [rbp+40h] BYREF
  int v61; // [rsp+154h] [rbp+54h]
  _QWORD v62[6]; // [rsp+158h] [rbp+58h] BYREF
...
LABEL_37:
      ...
      *(_DWORD *)(v15 + 48) = v13 & 0xFFFFFFF8;
      ...
      else
      {
        ...
        *((_QWORD *)v16 + 2) = v19;
        v16[3] = v56;
        v16[2] = v57;
        v16[6] = v58[2] / (__int64)SystemInformation[1];
        v16[7] = v58[3] / (__int64)SystemInformation[1];
        v20 = NtCurrentPeb();
        ...
        *((_QWORD *)v16 + 2) = *(_QWORD *)(a1 + 8);
        ...
        if ( (unsigned int)(v23 + 80) <= *(_DWORD *)v15 )
        {
          ...
          *(_DWORD *)(v24 + 8) = v57;
          *(_DWORD *)(v24 + 12) = v56;
          *(_DWORD *)(v24 + 24) = v58[2] / (__int64)SystemInformation[1];
          v25 = v58[3] % (__int64)SystemInformation[1];
          *(_DWORD *)(v24 + 28) = v58[3] / (__int64)SystemInformation[1];
          if ( *(_DWORD *)(a1 + 16) == 2 )
          {
      ...
      {
        *(_DWORD *)(v15 + 44) = 3;
        if ( (int)ZwQueryVolumeInformationFile(v28, v52, v60, 24LL, 3) >= 0 )
        {
          v38 = *(_DWORD *)(v15 + 48) + 80;
          if ( !v18 )
            v38 = *(_DWORD *)(v15 + 48);
          LODWORD(v9) = -v61 & (v38 + v61 - 1);
          *(_DWORD *)v15 = v9;
        }
      }
  ...
  if ( File >= 0 )
  {
    ...
    if ( File >= 0 )
    {
      ...
      if ( File >= 0 )
      {
        File = NtQuerySystemInformation(SystemTimeOfDayInformation, v62, 0x30u, 0LL);
        if ( File >= 0 )
        {
