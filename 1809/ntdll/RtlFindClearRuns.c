/*
 * XREFs of RtlFindClearRuns @ 0x1800EC660
 * Callers:
 *     RtlFindLongestRunClear @ 0x1800EC950 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
  ...
  if ( !v11 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v19 )
      {
        ...
        v13 = v17 - v15 + 8;
        v43 = v13;
        v26 = *((_BYTE *)&unk_180129528 - v15) | byte_180129510[v20] | v19;
        if ( v26 != 0xFF )
        {
          do
          {
            ...
            v28 = 0;
            for ( j = byte_180129510[v27]; (j & v26) != 0; j *= 2 )
              ++v28;
            v30 = v6 + 1;
            if ( v6 >= a3 )
              v30 = v6;
            ...
            {
              v32 = (int)v31;
              for ( k = (_QWORD *)(a2 + 8 + 8LL * (int)v31);
                    v32 >= 0 && *((_DWORD *)k - 1) < (unsigned int)(unsigned __int8)v27;
                    --k )
              {
                --v31;
                --v32;
            ...
            v34 = (int)v31;
            v17 = v40;
            *(_DWORD *)(a2 + 8 * v34 + 12) = (unsigned __int8)v27;
