/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1800EE4E8
 * Callers:
 *     RtlSetDynamicTimeZoneInformation @ 0x1800EE440 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1800EE450 (RtlSetTimeZoneInformation.c)
 * Callees:
