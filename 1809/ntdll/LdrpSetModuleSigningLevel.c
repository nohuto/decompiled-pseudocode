/*
 * XREFs of LdrpSetModuleSigningLevel @ 0x18008F4D0
 * Callers:
 ...
 *     NtGetCachedSigningLevel @ 0x1800A2010 (NtGetCachedSigningLevel.c)
 *     ZwSetCachedSigningLevel @ 0x1800A3310 (ZwSetCachedSigningLevel.c)
 */
