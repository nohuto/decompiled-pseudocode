/*
 * XREFs of RtlReplaceSidInSd @ 0x1800E79E0
 * Callers:
 *     <none>
 * Callees:
 *     RtlGetDaclSecurityDescriptor @ 0x180078680 (RtlGetDaclSecurityDescriptor.c)
 *     RtlGetSaclSecurityDescriptor @ 0x18007BE00 (RtlGetSaclSecurityDescriptor.c)
 *     RtlGetOwnerSecurityDescriptor @ 0x18007E490 (RtlGetOwnerSecurityDescriptor.c)
 *     RtlGetGroupSecurityDescriptor @ 0x18007FE60 (RtlGetGroupSecurityDescriptor.c)
...
LABEL_29:
              ...
              {
                v20 = *((_BYTE *)OldSid + 1);
                if ( v19->Sbz1 == v20 || v19->Sbz1 == v20 + 1 )
                {
...
LABEL_47:
            ...
            {
              v26 = *((_BYTE *)OldSid + 1);
              if ( v25->Sbz1 == v26 || v25->Sbz1 == v26 + 1 )
              {
