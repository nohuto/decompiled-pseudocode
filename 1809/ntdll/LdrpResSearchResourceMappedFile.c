  ...
  if ( (v10 & 0x10) == 0 )
  {
    ...
    if ( a5 >= 1 && a5 <= 3 )
    {
      if ( a5 == 3 )
        ...
        v36 = 0;
      if ( ((*(_QWORD *)v57 - 16LL) & 0xFFFFFFFFFFFFFFF7uLL) != 0 && !v48
        || (~(_BYTE)v10 & 8) == 0
        || (v36 & 0xF3FF) != 0
        || v36 == 3072 )
      {
        ...
        if ( RCConfig >= 0 )
        {
          v15 = v13 | LdrIsResItemExist(DllHandle, v57, v38, v10);
        }
        else
        {
    ...
    if ( v58 && (~v15 & 0x40000) != 0 )
    {
      ...
      if ( v59 && v20 )
      {
        if ( v65 )
          ...
          LODWORD(v43) = v66;
        MappingSize = LdrpFindMessageInAlternateModule((_DWORD)ResourceDllBase, *v59, v43, *(_DWORD *)(v57 + 24), 1);
        v47 = MappingSize;
        if ( MappingSize < 0 )
        {
          *v59 = 0LL;
