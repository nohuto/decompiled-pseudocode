/*
 * XREFs of LdrpResSearchResourceMappedFile @ 0x180037AB4
 * Callers:
  ...
  if ( (v10 & 0x10) == 0 )
  {
    ...
    if ( a5 >= 1 && a5 <= 3 )
    {
      if ( a5 == 3 )
        ...
        v37 = 0;
      if ( ((*(_QWORD *)v58 - 16LL) & 0xFFFFFFFFFFFFFFF7uLL) != 0 && !v49
        || (~(_BYTE)v10 & 8) == 0
        || (v37 & 0xF3FF) != 0
        || v37 == 3072 )
      {
        ...
        if ( RCConfig >= 0 )
        {
          v15 = v13 | LdrIsResItemExist(v54, v58, v39, v10);
        }
        else
        {
    ...
    if ( v59 && (~v15 & 0x40000) != 0 )
    {
      ...
      if ( v60 && v21 )
      {
        if ( v66 )
          ...
          LODWORD(v44) = v67;
        MappingSize = LdrpFindMessageInAlternateModule(v56, *v60, v44, *(_DWORD *)(v58 + 24), 1);
        v48 = MappingSize;
        if ( MappingSize < 0 )
        {
          *v60 = 0LL;
...
LABEL_34:
      if ( v21 && (v10 & 0x200000) == 0 )
        LdrpResReportResourceAccessInternal(v56, v55, v58, (unsigned int)a5);
      if ( MappingSize >= 0 )
        goto LABEL_38;
      v17 = v53;
      if ( !v53 )
...
LABEL_37:
  ...
  if ( v47 )
  {
    v74 = Src;
    v73[1] = 172;
    MappingSize = RtlLcidToLocaleName(v47, v73, 2LL, 0LL);
    v48 = MappingSize;
    if ( MappingSize >= 0 )
    {
      v46 = v73[0] >> 1;
