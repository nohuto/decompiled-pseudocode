/*
 * XREFs of RtlUnicodeStringCopy @ 0x18006E910
 * Callers:
 ...
 * Callees:
 *     RtlWideCharArrayCopyWorker @ 0x18006E998 (RtlWideCharArrayCopyWorker.c)
 *     RtlUnicodeStringValidateSrcWorker @ 0x18006E9FC (RtlUnicodeStringValidateSrcWorker.c)
