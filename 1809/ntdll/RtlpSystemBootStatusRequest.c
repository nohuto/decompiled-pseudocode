/*
 * XREFs of RtlpSystemBootStatusRequest @ 0x180088800
 * Callers:
 *     RtlSetSystemBootStatus @ 0x1800887D0 (RtlSetSystemBootStatus.c)
 *     RtlGetSystemBootStatus @ 0x18008EFF0 (RtlGetSystemBootStatus.c)
