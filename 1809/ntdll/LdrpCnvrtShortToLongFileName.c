/*
 * XREFs of LdrpCnvrtShortToLongFileName @ 0x1800E25E8
 * Callers:
...
LABEL_10:
  ...
  DirectoryFile = RtlpDosPathNameToRelativeNtPathName_U(2, (__int64)SourceString, &DestinationString.Length, 0LL, &v15);
  if ( DirectoryFile >= 0 )
  {
