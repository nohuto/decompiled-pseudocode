/*
 * XREFs of EtwEventWriteString @ 0x18010EB70
 * Callers:
 *     <none>
 * Callees:
 *     EtwpReleasePrivateBuffers @ 0x18004DF78 (EtwpReleasePrivateBuffers.c)
...
ULONG __cdecl EtwEventWriteString(REGHANDLE RegHandle, UCHAR Level, ULONGLONG Keyword, PCWSTR String)
{
  ...
  if ( v7 || v9 )
  {
    ...
    *(_QWORD *)&v19 = 0LL;
    ...
    if ( v9 )
    {
      v4 = EtwpWriteToPrivateBuffers((unsigned __int16 *)v5, &v19, 0, 0, 4, &v20, 0LL, 1u, (__int64)&v14, (__int64)v26);
      if ( v4 )
        goto LABEL_35;
    }
    if ( v7 )
    ...
    if ( v9 )
LABEL_35:
      EtwpReleasePrivateBuffers(v4, (__int64)v26);
  }
  return v4;
}
