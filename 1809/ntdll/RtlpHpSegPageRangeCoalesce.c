/*
 * XREFs of RtlpHpSegPageRangeCoalesce @ 0x180020014
 * Callers:
  ...
  while ( 1 )
  {
    ...
    *(_BYTE *)(a2 + 24) |= 0x11u;
    ...
    if ( !a4 && (*(_BYTE *)(a1 + 13) & 8) == 0 )
    {
      ...
      if ( v21 > v19 )
      {
        if ( (RtlpHpLfhPerfFlags & 0x40) == 0 || byte_180165408 || !RtlpHpGCTimerInitialized )
          goto LABEL_33;
...
LABEL_33:
    ...
    RtlpHpSegPageRangeCommit((__int64 *)a1, a2, 0, -(*(unsigned __int8 *)(a2 + 31) << *(_BYTE *)(a1 + 9)), 0, &v28);
    if ( (a3 & 1) == 0 )
      RtlAcquireSRWLockExclusive(a1 + 64, v24, v25, v26);
    v27 = *(_BYTE *)(a2 + 24) & 0xEF;
    *v5 = -1;
    *(_BYTE *)(a2 + 24) = v27;
  }
