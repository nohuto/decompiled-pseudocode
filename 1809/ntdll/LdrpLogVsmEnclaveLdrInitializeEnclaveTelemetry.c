/*
 * XREFs of LdrpLogVsmEnclaveLdrInitializeEnclaveTelemetry @ 0x1800D1FFC
 * Callers:
...
char __fastcall LdrpLogVsmEnclaveLdrInitializeEnclaveTelemetry(unsigned int a1)
{
  struct _PEB *v1; // rax
  UINT32 cData; // r10d
  LPCGUID v4; // r8
  ...
  if ( v1->ProcessHeap )
  {
    ...
    if ( dword_18015F590 > 4u )
    {
      ...
      if ( (_BYTE)v1 )
      {
        ...
        TlgCreateSz(&pDesc, "LdrInitializeEnclave");
        v11 = 0;
