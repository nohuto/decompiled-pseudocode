...
__int64 __fastcall RtlpHpAllocateHeapInternal(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned int a4, int *a5)
{
  ...
  if ( (*(_QWORD *)(v10 + 8 * v12 + 128) & 1) == 0 || (unsigned int)RtlpHpLfhBucketUpdateStats(v10, v11, 1LL) )
  {
    ...
    v15 = *(unsigned __int8 *)(v10 + 56) - (unsigned __int64)((*(_BYTE *)(v10 + 56) - 1) & 7) + v20 + 7;
    if ( *(_BYTE *)(v14 + 2) == 1 )
    {
      v16 = 0;
    }
    ...
    v17 = (void *)RtlpHpLfhSlotAllocate(v10, v14, *(_QWORD *)(v15 + 8LL * v16 + v14), (unsigned int)a2, a4);
    v13 = (__int64)v17;
    if ( v17 && (a4 & 2) != 0 )
      memset(v17, 0, (unsigned int)a2);
  }
  else
  {
    v13 = -1LL;
...
LABEL_15:
    if ( a3 > 0x20000 )
    {
      if ( a3 > *(unsigned int *)(a1 + 464) )
        v18 = RtlpHpLargeAlloc(a1, a2, a3, a4);
      else
        v18 = RtlpHpSegAlloc(a1 + (*(unsigned int *)(a1 + 272) < a3 ? 448LL : 256LL), a2, a3, a3, a4);
    }
    else
    {
      v18 = RtlpHpVsContextAllocate(a1 + 640, (unsigned int)a2, (unsigned int)a3, a4);
    }
    v13 = v18;
  }
  else
