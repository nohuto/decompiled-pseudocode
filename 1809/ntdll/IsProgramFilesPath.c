...
NTSTATUS __fastcall IsProgramFilesPath(wchar_t *String1, size_t *a2)
{
  ...
  *a2 = 0LL;
  result = RtlQueryEnvironmentVariable_U(0LL, (PUNICODE_STRING)&stru_180118600, &Value);
  ...
  if ( !Heap )
    return -1073741637;
  v6 = RtlQueryEnvironmentVariable_U(0LL, (PUNICODE_STRING)&stru_180118600, &Value);
  Buffer = Value.Buffer;
  v8 = v6;
  if ( v6 >= 0 )
  {
