/*
 * XREFs of RtlpCrackActivationContextStringSectionHeader @ 0x180031CB0
 * Callers:
        ...
        _QWORD *a11)
{
  ...
  if ( a2 < 8 )
  {
    ...
    v20 = "SXS: %s() passed string section at %p only %Iu bytes long; that's not even enough for the 4-byte magic and 4-b"
          "yte header length!\n";
LABEL_29:
    DbgPrintEx(51LL, 0LL, v20, "RtlpCrackActivationContextStringSectionHeader", a1, v23);
...
LABEL_36:
    v25 = v14;
LABEL_38:
    DbgPrintEx(51LL, 0LL, v21, "RtlpCrackActivationContextStringSectionHeader", a1, v25, v26);
    return (unsigned int)-1072365565;
  }
  v15 = a1[6];
