/*
 * XREFs of AVrfpParseVerifierDllsString @ 0x1800DC4A4
 * Callers:
...
__int64 AVrfpParseVerifierDllsString()
{
  ...
  *(UNICODE_STRING *)(v2 + 16) = VerifierDllString;
  v3 = (__int64 *)qword_1801645F8;
  if ( *(__int64 **)qword_1801645F8 != &AVrfpVerifierProvidersList )
LABEL_19:
    __fastfail(3u);
  v4 = UseWOW64 == 0;
