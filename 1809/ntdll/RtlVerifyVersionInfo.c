...
__int64 __fastcall RtlVerifyVersionInfo(__int64 a1, int a2, signed __int64 a3)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( (v4 & 2) != 0 )
    {
      ...
      v15 = !RtlpVerCompare(v9, *(_DWORD *)(a1 + 4), v21[1], v20, 0);
      v8 = v20[0];
      if ( v15 )
      {
        if ( !v20[0] )
    ...
    v15 = !RtlpVerCompare(v9, *(_DWORD *)(a1 + 8), v21[2], v20, 1);
    v8 = v20[0];
    if ( v15 )
    {
      if ( !v20[0] )
...
LABEL_10:
    ...
    if ( v4 < 0 )
    {
      ...
      if ( !RtlpVerCompare(v10, *(unsigned __int8 *)(a1 + 282), BYTE2(v21[70]), v20, 0) )
        return 3221225561LL;
    }
    return 0LL;
  }
