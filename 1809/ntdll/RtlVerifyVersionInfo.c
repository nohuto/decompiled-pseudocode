/*
 * XREFs of RtlVerifyVersionInfo @ 0x180064C60
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONGLONG ConditionMask)
{
  ...
  if ( !result )
  {
        ...
        do
        {
          ...
          if ( (v13 & (1 << v12)) != 0 )
          {
            if ( (ConditionMask & 0x8000000000000000uLL) == 0LL )
              ...
              v16 = RtlpVerGetConditionMask(ConditionMask, 0x40u);
            v17 = v16 - 6;
            if ( v17 )
            {
              if ( v17 != 1 )
    ...
    if ( (v4 & 2) != 0 )
    {
      ...
      v15 = !RtlpVerCompare(v9, VersionInformation->dwMajorVersion, VersionInformationa.dwMajorVersion, v20, 0);
      v8 = v20[0];
      if ( v15 )
      {
        if ( !v20[0] )
    ...
    v15 = !RtlpVerCompare(v9, VersionInformation->dwMinorVersion, VersionInformationa.dwMinorVersion, v20, 1);
    v8 = v20[0];
    if ( v15 )
    {
      if ( !v20[0] )
...
LABEL_10:
    ...
    if ( v4 < 0 )
    {
      ...
      if ( !RtlpVerCompare(v10, VersionInformation->wProductType, VersionInformationa.wProductType, v20, 0) )
        return -1073741735;
    }
    return 0;
  }
