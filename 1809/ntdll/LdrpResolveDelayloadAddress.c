/*
 * XREFs of LdrpResolveDelayloadAddress @ 0x1800D0B9C
 * Callers:
        ...
        int *a6)
{
  ...
  unsigned __int64 v13; // [rsp+38h] [rbp-18h] BYREF
  __int64 v14; // [rsp+40h] [rbp-10h] BYREF
  const char *v15; // [rsp+48h] [rbp-8h] BYREF

  v13 = 0LL;
  LdrpGetDelayloadAPIInfo(a1, a3, a4, (__int64 *)&v15, &v12);
  v8 = LdrpResolveProcedureAddress(a2, v15, v12, 0, &v13);
  *a6 = v8;
  if ( v8 < 0 )
    return v13;
