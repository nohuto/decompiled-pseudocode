/*
 * XREFs of LdrpGetMUILangConfigNode @ 0x1800EE7C4
 * Callers:
 *     RtlpTraverseParents @ 0x1800343F8 (RtlpTraverseParents.c)
 * Callees:
 *     RtlpCompareConfigNodeWithSpec @ 0x1800EFB50 (RtlpCompareConfigNodeWithSpec.c)
 *     RtlpMuiRegGetLanginfoTypeNSpec @ 0x1800F0574 (RtlpMuiRegGetLanginfoTypeNSpec.c)
 */
