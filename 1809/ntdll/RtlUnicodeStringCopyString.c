/*
 * XREFs of RtlUnicodeStringCopyString @ 0x1800CE5F8
 * Callers:
 *     RtlGetFullPathName_Ustr @ 0x18000DB20 (RtlGetFullPathName_Ustr.c)
 * Callees:
 *     RtlWideCharArrayCopyStringWorker @ 0x18006E81C (RtlWideCharArrayCopyStringWorker.c)
 *     RtlUnicodeStringValidateDestWorker @ 0x18006EA38 (RtlUnicodeStringValidateDestWorker.c)
 */
