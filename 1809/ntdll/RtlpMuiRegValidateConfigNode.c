/*
 * XREFs of RtlpMuiRegValidateConfigNode @ 0x18010183C
 * Callers:
...
__int64 __fastcall RtlpMuiRegValidateConfigNode(__int64 a1, unsigned __int16 *a2)
{
  ...
  {
    v6 = *(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL) + 28LL * (__int16)i;
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        for ( i = a2[v7 + 3]; ; v12 = i )
        {
          v13 = (*(_WORD *)(v6 + 8) >> v11) & 3;
          v19 = 0LL;
          if ( RtlpMuiRegConfigMatchesInstalled(a1, v9, v12, v13, *(_WORD *)(v6 + 2LL * v10 + 12), &v19, &v17) )
          {
