/*
 * XREFs of RtlCheckHeldCriticalSections @ 0x1800819A0
 * Callers:
 *     RtlCheckForOrphanedCriticalSections @ 0x180081980 (RtlCheckForOrphanedCriticalSections.c)
 * Callees:
    ...
    for ( i = (_UNKNOWN **)RtlCriticalSectionList; i != &RtlCriticalSectionList; i = (_UNKNOWN **)*i )
    {
      ...
      *(_QWORD *)&v15[32] = *(_QWORD *)(v6 + 32);
      if ( *(_UNKNOWN ***)v15 == v5 )
      {
        ...
        {
          StackTraceAddress = RtlpGetStackTraceAddressEx(*((_WORD *)v5 + 1), *((_WORD *)v5 + 22));
      ...
      else
      {
        ...
        *(_OWORD *)&v15[72] = *(_OWORD *)(*(_QWORD *)v15 + 32LL);
        v9 = RtlpGetStackTraceAddressEx(*(unsigned __int16 *)&v15[42], *(unsigned __int16 *)&v15[84]);
        v10 = RtlpGetStackTraceAddressEx(*((_WORD *)i - 7), *((_WORD *)i + 14));
        RtlApplicationVerifierStop(
          515,
