/*
 * XREFs of PsspWalkHandleTable @ 0x1801137F0
 * Callers:
 ...
 *     ZwQueryObject @ 0x1800A04E0 (ZwQueryObject.c)
...
LABEL_19:
    ...
    if ( (a4 & 0x20) != 0 )
    {
      v15 = (const wchar_t **)&off_180119240;
      ...
      v16 = 3LL * v7;
      if ( ((int (__fastcall *)(HANDLE, _BYTE *, __int64, int *, _QWORD, _DWORD, int))*(&off_180119240 + v16 + 1))(
             Handle,
             v25,
             64LL,
             &v17,
