/*
 * XREFs of CsrCaptureMessageMultiUnicodeStringsInPlace @ 0x18005D000
 * Callers:
 *     <none>
 * Callees:
    ...
    do
    {
      ...
      if ( v13 )
      {
        if ( !v3 )
        {
          ...
          v14 = *v13;
          if ( v13[1] > *v13 && v13[1] - (unsigned __int64)v14 >= 2 )
            *(_WORD *)(*((_QWORD *)v13 + 1) + 2 * ((unsigned __int64)v14 >> 1)) = 0;
        }
      }
      ++v12;
    }
