/*
 * XREFs of RtlCompressBufferXpressLzMax @ 0x18010B9E8
 * Callers:
...
LABEL_6:
  ...
  if ( v18 < v20 )
  {
    ...
    {
      LOWORD(v22) = v22 + 1;
      v24 = (unsigned __int16)XpressHashFunction[v18[2] + 512] ^ (unsigned __int16)XpressHashFunction[*v18] ^ (unsigned __int64)(unsigned __int16)XpressHashFunction[v18[1] + 256];
...
LABEL_14:
  ...
  while ( 1 )
  {
    if ( v13 >= v21 )
    {
      ...
      XpressCallback = RtlpMakeXpressCallback(v60, v20, v13);
      v14 = (_DWORD *)v67;
      v19 = a6;
      v20 = v56;
      v54 = XpressCallback;
