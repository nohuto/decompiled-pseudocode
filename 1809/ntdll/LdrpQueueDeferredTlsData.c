/*
 * XREFs of LdrpQueueDeferredTlsData @ 0x180037354
 * Callers:
...
signed __int64 __fastcall LdrpQueueDeferredTlsData(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int64 a4)
{
