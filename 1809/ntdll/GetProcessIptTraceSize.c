/*
 * XREFs of GetProcessIptTraceSize @ 0x180114F78
 * Callers:
...
NTSTATUS __fastcall GetProcessIptTraceSize(__int64 a1, _DWORD *a2)
{
  ...
  struct _IO_STATUS_BLOCK IoStatusBlock; // [rsp+C0h] [rbp+7h] BYREF
  struct _IO_STATUS_BLOCK v12; // [rsp+D0h] [rbp+17h] BYREF
