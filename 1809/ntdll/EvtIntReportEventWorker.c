/*
 * XREFs of EvtIntReportEventWorker @ 0x18004D38C
 * Callers:
 *     EvtIntReportEventAndSourceAsync @ 0x18004D320 (EvtIntReportEventAndSourceAsync.c)
 *     EvtIntReportAuthzEventAndSourceAsync @ 0x18010FCC0 (EvtIntReportAuthzEventAndSourceAsync.c)
 * Callees:
        ...
        unsigned __int64 a11)
{
  ...
  int v39; // [rsp+74h] [rbp-264h]
  _EVENT_DATA_DESCRIPTOR *v40; // [rsp+78h] [rbp-260h]
  __int64 v41; // [rsp+80h] [rbp-258h] BYREF
  __int64 v42; // [rsp+88h] [rbp-250h]
  __int64 *v43; // [rsp+90h] [rbp-248h]
  ...
  *(_DWORD *)&EventDescriptor.Id = 0;
  ...
  if ( v13 )
  {
    ...
    {
      Win32Error = 87;
      local_unwind(v43, &loc_18004D6D7);
      goto LABEL_29;
    }
    v35 = 4 * v13[1] + 8;
  }
  v41 = MEMORY[0x7FFE0014];
  p_UserData->Ptr = (unsigned __int64)&v41;
  ...
  *(_QWORD *)&p_UserData[1].Size = 4LL;
  ...
  p_UserData[2].Ptr = (unsigned __int64)&v36;
  *(_QWORD *)&p_UserData[2].Size = 2LL;
  v19 = 2 * v36;
  p_UserData[3].Ptr = a3;
  p_UserData[3].Size = v19;
  p_UserData[3].Reserved = 0;
  p_UserData[4].Ptr = (unsigned __int64)&v35;
  ...
  *(_QWORD *)&p_UserData[v22].Size = 2LL;
  ...
  for ( i = 0; ; i = v24 )
  {
    ...
    p_UserData[v25].Ptr = v26;
    *(_QWORD *)&p_UserData[v25].Size = (unsigned int)(2 * v27 + 2);
    v33 = v23;
    ++v24;
  }
  p_UserData[v25].Ptr = (unsigned __int64)&a9;
  *(_QWORD *)&p_UserData[v25].Size = 4LL;
  v33 = v23;
  v28 = a9;
  if ( a9 )
  {
    v29 = v23;
    p_UserData[v29].Ptr = a11;
    p_UserData[v29].Size = v28;
    p_UserData[v29].Reserved = 0;
    v33 = ++v23;
  }
  if ( !v39 )
  {
    v30 = EtwpEventWriteFull(v42, (unsigned int)&EventDescriptor, 0, 0, 4, 0LL, 0LL, v23, (__int64)p_UserData);
    goto LABEL_30;
  }
LABEL_29:
  v30 = EtwWriteUMSecurityEvent(&EventDescriptor, 4u, v23, p_UserData);
LABEL_30:
  Win32Error = v30;
