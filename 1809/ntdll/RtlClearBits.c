/*
 * XREFs of RtlClearBits @ 0x180035B30
 * Callers:
 ...
 *     RtlFindSetBitsAndClear @ 0x1800EC990 (RtlFindSetBitsAndClear.c)
 * Callees:
...
void __cdecl RtlClearBits(PRTL_BITMAP BitMapHeader, ULONG StartingIndex, ULONG NumberToClear)
{
  ...
  if ( NumberToClear )
  {
    ...
    {
      v7 = ~(byte_180129510[NumberToClear] << v4);
LABEL_4:
      *v5 &= v7;
      return;
    }
