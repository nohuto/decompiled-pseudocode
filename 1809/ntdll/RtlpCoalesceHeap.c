/*
 * XREFs of RtlpCoalesceHeap @ 0x18008C1C4
 * Callers:
...
unsigned __int64 __fastcall RtlpCoalesceHeap(unsigned __int64 a1)
{
  ...
  do
  {
    ...
    if ( !v8 )
    {
      ...
      {
        RtlpLogHeapFailure(13, a1, (_DWORD)v6, v16, v17, 0LL);
        goto LABEL_31;
      }
      *(_QWORD *)(a1 + 192) -= v9;
      v18 = *(_QWORD *)(a1 + 312);
      if ( v18 )
      {
        ...
        v21 = *(_DWORD *)(v18 + 8) - 1;
LABEL_26:
        RtlpHeapRemoveListEntry(a1, v18, 1, v6, v21, *(unsigned __int16 *)(v5 + 8));
      }
      *v15 = (__int64)v3;
      v3[1] = (__int64)v15;
      if ( (*(_BYTE *)(v5 + 10) & 8) != 0 )
