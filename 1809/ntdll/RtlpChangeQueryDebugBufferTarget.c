/*
 * XREFs of RtlpChangeQueryDebugBufferTarget @ 0x18007DE48
 * Callers:
...
NTSTATUS __fastcall RtlpChangeQueryDebugBufferTarget(__int64 a1, void *a2, int a3, HANDLE *a4)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  if ( v4 )
  {
    ...
    result = NtOpenProcess(&Handle, 0x1FFFFFu, &ObjectAttributes, &v24);
    if ( result < 0 )
      return result;
    v10 = (__int64)Handle;
  }
  ...
  if ( a2 )
  {
    ...
    v17 = NtOpenProcess(&ProcessHandle, 0x1FFFFFu, &ObjectAttributes, &ClientId);
    v10 = (__int64)Handle;
    v18 = v17;
    if ( v17 < 0 )
    {
