/*
 * XREFs of _output_l @ 0x1800964A0
 * Callers:
...
LABEL_121:
                    ...
                    {
                      LOBYTE(v24) = 32;
                      write_multi_char(v24, v42, v61, &v56);
                    }
                    write_string(v57, v41, v61, &v56);
                    v44 = v61;
                    if ( (v7 & 0xC) == 8 )
                    {
                      LOBYTE(v43) = 48;
                      write_multi_char(v43, v42, v61, &v56);
                    }
                    v45 = SizeConverted;
                    if ( v60 && SizeConverted > 0 )
                    {
                      ...
                      while ( 1 )
                      {
                        ...
                        if ( wctomb_s(&v65, v71, 6uLL, v47) || !v65 )
                          break;
                        write_string(v71, (unsigned int)v65, v61, &v56);
                        if ( !v45 )
                          goto LABEL_135;
                      }
                      v11 = -1;
                    ...
                    {
                      write_string(v13, (unsigned int)SizeConverted, v44, &v56);
LABEL_135:
                      v11 = v56;
                    }
                    if ( v11 >= 0 && (v7 & 4) != 0 )
                    {
                      LOBYTE(v48) = 32;
                      write_multi_char(v48, v42, v61, &v56);
                      v11 = v56;
                    }
                    v5 = v66;
                    v10 = v55;
