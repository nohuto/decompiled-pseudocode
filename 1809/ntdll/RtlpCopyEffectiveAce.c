/*
 * XREFs of RtlpCopyEffectiveAce @ 0x18004494C
 * Callers:
...
LABEL_91:
  ...
  v44 = 8 * (*((_DWORD *)Src + 2) & 1LL);
  v26 = (unsigned __int16 *)((char *)&Src[v44] + ((*((_DWORD *)Src + 2) & 2) != 0 ? 28LL : 12LL));
  v27 = v44 * 2 + ((*((_DWORD *)Src + 2) & 2) != 0 ? 28 : 12);
  if ( (*((_DWORD *)Src + 2) & 2) != 0 )
    v24 = &Src[v44 + 6];
  else
    v24 = 0LL;
...
LABEL_58:
    ...
    while ( 1 )
    {
      v47 = *(_QWORD *)v24 - **(_QWORD **)v45;
      if ( *(_QWORD *)v24 == **(_QWORD **)v45 )
        v47 = *((_QWORD *)v24 + 1) - *(_QWORD *)(*(_QWORD *)v45 + 8LL);
      if ( !v47 )
        break;
      ++v46;
      v45 += 8LL;
...
LABEL_19:
  ...
  if ( *v65 && (unsigned int)v25 <= v67 + *(unsigned __int16 *)(v67 + 2) - (_QWORD)v35 )
  {
    ...
    v37 = &v36[4 * *((unsigned __int8 *)v26 + 1) + 8];
    if ( Srca && v62 > 0 )
    {
      memmove(v37, Srca, v62);
      LODWORD(v37) = v62 + (_DWORD)v37;
    }
    v23 = v65;
    v38 = (_DWORD)v37 - *(_DWORD *)v65;
