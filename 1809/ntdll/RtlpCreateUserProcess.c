/*
 * XREFs of RtlpCreateUserProcess @ 0x18008D5D0
 * Callers:
 ...
 *     NtCreateUserProcess @ 0x1800A1B50 (NtCreateUserProcess.c)
 *     memset @ 0x1800A7100 (memset.c)
 */

NTSTATUS __fastcall RtlpCreateUserProcess(unsigned __int16 *a1, _DWORD *a2, ULONG a3, ULONG a4, __int64 a5, HANDLE *a6)
{
