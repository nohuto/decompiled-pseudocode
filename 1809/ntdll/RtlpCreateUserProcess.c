/*
 * XREFs of RtlpCreateUserProcess @ 0x18008D5C0
 * Callers:
 ...
 *     NtCreateUserProcess @ 0x1800A1B30 (NtCreateUserProcess.c)
...
__int64 __fastcall RtlpCreateUserProcess(unsigned __int16 *a1, __int64 a2, int a3, int a4, __int64 a5, char *a6)
{
  ...
  *(_DWORD *)a6 = 104;
  ...
  v40 = 32LL * v10 + 8;
  return NtCreateUserProcess(a6 + 8, a6 + 16, 0x2000000LL, 0x2000000LL, &v33, &v27, a3, a4, a2, v39, &v40);
}
