...
__int64 __fastcall RtlpHpFreeWithExceptionProtection(__int64 a1, unsigned __int64 a2, int a3)
{
  ...
  __int64 ReservedBlockSize; // [rsp+88h] [rbp-F0h] BYREF
  unsigned __int64 v56; // [rsp+90h] [rbp-E8h]
  unsigned __int64 v57; // [rsp+98h] [rbp-E0h] BYREF
  int v58; // [rsp+A0h] [rbp-D8h]
  unsigned int v59; // [rsp+A4h] [rbp-D4h]
  char v60[8]; // [rsp+A8h] [rbp-D0h] BYREF
  _QWORD v61[4]; // [rsp+B0h] [rbp-C8h] BYREF
  struct _TEB *v62; // [rsp+D0h] [rbp-A8h]
  struct _TEB *v63; // [rsp+D8h] [rbp-A0h]
  struct _TEB *v64; // [rsp+E0h] [rbp-98h]
  struct _TEB *v65; // [rsp+E8h] [rbp-90h]
  __int64 v66; // [rsp+F0h] [rbp-88h]
  __int64 v67; // [rsp+F8h] [rbp-80h]
  signed __int64 v68; // [rsp+100h] [rbp-78h]
  __int128 v69; // [rsp+110h] [rbp-68h] BYREF
  int v70; // [rsp+128h] [rbp-50h]
  int v71; // [rsp+138h] [rbp-40h]
  int v72; // [rsp+148h] [rbp-30h]
  unsigned __int16 v73; // [rsp+198h] [rbp+20h] BYREF

  v4 = a2;
  if ( (RtlpHpHeapFeatures & 2) != 0 )
  {
    v9 = RtlpFreeHeapInternal(a1, a2, a3, (unsigned int)v61, (__int64)&v73);
    if ( v9 && v73 )
      _InterlockedExchangeAdd64(
        (volatile signed __int64 *)(*(_QWORD *)(qword_180163AB8 + 8LL * v73 - 8) + 32LL),
        -v61[0]);
    return v9;
  }
  v6 = 0;
  ...
  if ( *(_DWORD *)(a1 + 16) == -571548178 )
  {
    ...
    v9 = RtlpHpFreeHeap(a1, v4, v8 & 0x11000001, 0, 0LL);
    if ( v9 )
    {
      if ( (dword_180166388 & 1) != 0 && (dword_180166388 & 2) != 0 )
      {
        ...
        {
          v69 = RtlpHpEnvHandle;
          LOBYTE(v6) = a1 != *(_QWORD *)RtlpHpMetadataHeapCtxGet(&v69);
          v58 = v6;
          if ( v6 )
            goto LABEL_157;
        }
  ...
  {
LABEL_154:
    v49 = RtlpFreeHeap(a1, a3 | 2u, v7, v4);
    v9 = v49;
    if ( v49 )
      goto LABEL_155;
    return v9;
...
LABEL_50:
  ...
  if ( (a3 & 0x3C000102) == 0 )
  {
    ...
    v61[1] = v15;
    if ( (int)RtlpCallInterceptRoutine(*(_DWORD *)(v4 - 8), a1, v4, 3, v15) < 0 )
    {
      NtCurrentTeb()->LastStatusValue = -1073741811;
      v65 = NtCurrentTeb();
...
LABEL_129:
      ...
      if ( (*((_BYTE *)v16 + 38) & 3) != 0 )
      {
        v57 = (*((_QWORD *)v16 + 1) + 4151LL) & 0xFFFFFFFFFFFFF000uLL;
        ReservedBlockSize = (unsigned __int16)RtlpGetReservedBlockSize(v16, v31, v30, v32);
        ReservedBlockSize *= 16LL * *((unsigned __int16 *)v16 + 20);
        v9 = 1;
        HeapProtection = RtlpGetHeapProtection(*(_QWORD *)(v38 + 24), 1LL);
        ZwProtectVirtualMemory(-1LL, &v57, &ReservedBlockSize, HeapProtection, v60);
      }
      else
      {
        v9 = 1;
      ...
      *(_DWORD *)(*((_QWORD *)v16 + 1) + 20LL) = 0;
      ...
      do
      {
        v68 = v41[20];
        LODWORD(v53) = v68 - v40;
        HIDWORD(v53) = HIDWORD(v68) - 1;
        v42 = v68;
      }
      while ( v42 != _InterlockedCompareExchange64(v41 + 20, v53, v68) );
      *((_QWORD *)v16 + 1) = 0LL;
