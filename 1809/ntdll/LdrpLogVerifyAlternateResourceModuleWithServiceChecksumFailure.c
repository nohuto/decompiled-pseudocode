/*
 * XREFs of LdrpLogVerifyAlternateResourceModuleWithServiceChecksumFailure @ 0x1800D1CE8
 * Callers:
        ...
        __int64 a3)
{
  ...
  {
    LOBYTE(v6) = TlgKeywordOn((TraceLoggingHProvider)&dword_18015F520, 0x200000000000uLL);
    if ( (_BYTE)v6 )
    {
      v15 = 2LL;
      v11 = (_WORD)v9 + 4;
