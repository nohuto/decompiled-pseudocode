/*
 * XREFs of RtlpCheckRelativeDrive @ 0x1800582CC
 * Callers:
 ...
 *     RtlSetThreadErrorMode @ 0x180058450 (RtlSetThreadErrorMode.c)
...
NTSTATUS __fastcall RtlpCheckRelativeDrive(WCHAR a1)
{
  ...
  LODWORD(v4) = 34078720;
  v5 = (WCHAR *)&v14;
  if ( (int)RtlQueryEnvironmentVariable_U(0LL, &DestinationString.Length, &v4) < 0 )
  {
    *v5 = a1;
    v5[1] = 58;
    v5[2] = 92;
