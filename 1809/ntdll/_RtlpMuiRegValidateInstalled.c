/*
 * XREFs of _RtlpMuiRegValidateInstalled @ 0x180102F30
 * Callers:
 ...
 *     _RtlpMuiRegValidateLIPLanguage @ 0x180103304 (_RtlpMuiRegValidateLIPLanguage.c)
 *     _RtlpMuiRegValidatePartialLanguage @ 0x180103554 (_RtlpMuiRegValidatePartialLanguage.c)
...
LABEL_16:
  ...
  if ( *(_WORD *)(v18 + 6) )
  {
    ...
    do
    {
      ...
      {
        RtlpMuiRegValidatePartialLanguage(a1, (unsigned int)v20);
        v18 = *(_QWORD *)(a1 + 24);
        v23 = *(_QWORD *)(v18 + 16);
        v24 = *(_WORD *)(v23 + v22);
        v25 = v4 + 1;
  ...
  if ( *(_WORD *)(v18 + 6) )
  {
    ...
    do
    {
      ...
      {
        RtlpMuiRegValidateLIPLanguage(a1, (unsigned int)v31, v19, v26);
        v33 = *(_QWORD *)(a1 + 24);
      }
      ++v31;
      v32 += 28LL;
