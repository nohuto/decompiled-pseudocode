/*
 * XREFs of EtwpAllocateRegistration @ 0x180020DDC
 * Callers:
...
PSLIST_ENTRY __fastcall EtwpAllocateRegistration(struct _SLIST_ENTRY *a1, _SLIST_ENTRY *a2, __int64 a3, __int16 a4)
{
