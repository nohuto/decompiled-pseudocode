...
__int64 __fastcall RtlpGetPolicyValueForSystemCapability(__int16 *a1, UNICODE_STRING *a2)
{
  const void *Heap; // r14
...
LABEL_7:
  ...
  *(_QWORD *)&UnicodeString.Length = 0LL;
  ...
  appended = RtlAppendUnicodeStringToString(&UnicodeString.Length, L"68");
  if ( appended < 0 )
    goto LABEL_8;
