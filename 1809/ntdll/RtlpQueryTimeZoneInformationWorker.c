/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x180052E00
 * Callers:
 *     EtwpGetTimeZoneInformation @ 0x180052BC4 (EtwpGetTimeZoneInformation.c)
 *     RtlQueryTimeZoneInformation @ 0x180052DF0 (RtlQueryTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x1800EE2A0 (RtlQueryDynamicTimeZoneInformation.c)
 * Callees:
