/*
 * XREFs of RtlpOpenImageFileOptionsKeyEx @ 0x180079278
 * Callers:
 ...
 *     RtlOpenImageFileOptionsKey @ 0x1800E2F00 (RtlOpenImageFileOptionsKey.c)
  ...
  if ( (int)result >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    if ( a3 )
      ...
      v15 = NtOpenKey(&KeyHandle, v5, &ObjectAttributes);
    inited = v15;
    if ( v12 )
      NtClose(v14);
    if ( inited >= 0 )
    {
      *(_QWORD *)&Handle.Length = KeyHandle;
      ...
      {
        *(_QWORD *)&Handle.Length = 0LL;
        v19 = RtlpCreateIFEOKeyFilterKey(&Handle, KeyHandle, v5 | 0x10000);
        v18 = *(void **)&Handle.Length;
        inited = v19;
        if ( v19 >= 0 )
        {
