        ...
        __int64 a5)
{
  ...
  *(_QWORD *)&v21.Length = 0LL;
  ...
  if ( !a1 || !a2 || !a5 || !*(_QWORD *)a5 )
    return 3221225485LL;
  NameFromLangListNode = LdrpCreateLangFallbackList(&v20, a2, 25LL, 0LL);
...
LABEL_13:
      ...
      for ( i = 0; i < *(unsigned __int16 *)(v13 + 4); ++i )
      {
        ...
        String2 = (wchar_t *)v22;
        NameFromLangListNode = GetNameFromLangListNode(a2, *(_QWORD *)(v13 + 24) + 6LL * i, &v18);
        if ( NameFromLangListNode < 0 )
          break;
    ...
    while ( 1 )
    {
      ...
      *(_DWORD *)&v21.Length = 0;
      if ( (int)RtlpConsoleFallbackNameFromLocaleName(String2, a3, &v16, &v21, a2, a4) >= 0 && v16 )
        appended = LdrpLangFallbackListAppendNode((unsigned int)&v20, a2, 0, (unsigned int)v17, (__int64)v21.Buffer);
      else
