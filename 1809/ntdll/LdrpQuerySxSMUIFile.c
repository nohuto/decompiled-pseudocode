...
__int64 __fastcall LdrpQuerySxSMUIFile(__int128 *a1, unsigned __int16 a2, __int64 a3, UNICODE_STRING *a4, __int64 a5)
{
  ...
  _QWORD v25[14]; // [rsp+90h] [rbp-1B8h] BYREF
  ...
  if ( ActivationContextSectionString >= 0 )
  {
    if ( LdrpCreateActCtxLanguageW )
    {
      if ( (v18 & 1) == 0 )
      {
        ActivationContextSectionString = RtlFindActivationContextSectionString(7, 0LL, 2LL, (__int64)a1, v25);
        if ( ActivationContextSectionString >= 0 )
        {
          if ( HIDWORD(v25[0]) == 1 )
          {
            if ( (v25[8] & 0x100000000LL) == 0 )
            {
              v9 = v25[7];
              if ( (v25[8] & 0x200000000LL) != 0 )
                v9 = -4LL;
            }
            v25[7] = v9;
            v12 = *(_WORD *)(v25[9] + 92LL);
            v13 = (unsigned __int16 *)(v25[10] + *(unsigned int *)(v25[9] + 96LL));
            v22 = &v29;
            v21[1] = 170;
            ...
            if ( ActivationContextSectionString >= 0 )
            {
              ...
              {
                v15 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64 *))LdrpCreateActCtxLanguageW)(v9, a2, &v20);
                  ...
                  if ( v20 != -1 )
                  {
                    ...
                    if ( ActivationContextSectionString >= 0 )
                    {
                      ...
                      if ( ActivationContextSectionString >= 0 )
                      {
                        if ( HIDWORD(v25[0]) == 1 )
                        {
                          v16 = *(unsigned __int16 *)(v25[9] + 92LL);
                          WORD1(v23) = v16;
                          LOWORD(v23) = v16;
                          v24 = (unsigned __int16 *)(v25[10] + *(unsigned int *)(v25[9] + 96LL));
