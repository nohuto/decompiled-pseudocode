/*
 * XREFs of RtlInitializeHistoryTable @ 0x18000329C
 * Callers:
 *     LdrpInitializeProcess @ 0x1800D3FB4 (LdrpInitializeProcess.c)
 * Callees:
 *     RtlpFunctionAddressTableEntry @ 0x180003374 (RtlpFunctionAddressTableEntry.c)
...
__int64 RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v5 + 6] = v4;
    v9 = qword_180178418;
    if ( v7 < qword_180178418 )
      v9 = v7;
    qword_180178418 = v9;
    v10 = qword_180178420;
    if ( v8 > qword_180178420 )
      v10 = v8;
    qword_180178420 = v10;
  }
