/*
 * XREFs of RtlpWow64CtxFromAmd64 @ 0x180089DD0
 * Callers:
 *     RtlpWow64GetContextOnAmd64 @ 0x180077500 (RtlpWow64GetContextOnAmd64.c)
 * Callees:
 *     RtlFxToFnFrame @ 0x180089FB8 (RtlFxToFnFrame.c)
 */
