/*
 * XREFs of RtlWow64GetCpuAreaInfo @ 0x180003540
 * Callers:
 *     RtlWow64GetCurrentCpuArea @ 0x1800034C0 (RtlWow64GetCurrentCpuArea.c)
 * Callees:
 *     RtlpGetContextFlagsLocation @ 0x1800035D8 (RtlpGetContextFlagsLocation.c)
...
LABEL_3:
    ...
    v6 = ~(v15 - 1LL) & (a1 + v15 + 3LL);
    v7 = v14 + 7LL;
    *v8 = v6;
    v8[1] = (v6 + v7) & 0xFFFFFFFFFFFFFFF8uLL;
