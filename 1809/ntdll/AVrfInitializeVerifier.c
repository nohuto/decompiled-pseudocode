      ...
      if ( v31 < 0 )
      {
        if ( v31 == -2147483643 )
        {
          while ( 1 )
          {
            ...
            if ( !v34 )
              break;
            v35 = RtlAllocateHeap(v34, NtdllBaseTag + 1572864, Length);
            v32 = v35;
            if ( !v35 )
              break;
            v30 = (unsigned __int16 *)v35;
            v36 = NtQueryValueKey(a3, &ValueName, KeyValuePartialInformation, v35, v33, &Length);
            if ( v36 >= 0 )
            {
              v7 = a6;
              goto LABEL_77;
...
LABEL_77:
        ...
        if ( ((v37 - 3) & 0xFFFFFFFB) != 0 )
        {
          ...
          else if ( v37 == 1 && ((unsigned __int8)&AVrfpHandleTraces & 3) == 0 )
          {
            Length = 4;
...
LABEL_133:
  ...
  {
    v57[0] = 0;
    Dll = LdrpInitializeGraphRecurse((__int64)&unk_180164720, 0LL, v57);
    if ( Dll < 0 )
      return (unsigned int)Dll;
    return 0;
  }
...
LABEL_10:
    ...
    LoadedDllByName = LdrpFindLoadedDllByName((PUNICODE_STRING)&VrfcoreDllString, 0LL, 0LL, (__int64)&BaseAddress, 0LL);
    Dll = LoadedDllByName;
    if ( LoadedDllByName < 0 )
    {
      if ( LoadedDllByName != -1073741515 )
        return (unsigned int)Dll;
      v14 = (void *)qword_180164630;
    }
    else
    {
