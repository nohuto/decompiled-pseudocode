/*
 * XREFs of LdrpHandleInvalidUserCallTarget @ 0x180090140
 * Callers:
 ...
 *     LdrpDispatchUserCallTarget @ 0x1800902A0 (LdrpDispatchUserCallTarget.c)
 *     LdrpDispatchUserCallTargetES @ 0x1800902F0 (LdrpDispatchUserCallTargetES.c)
 * Callees:
