/*
 * XREFs of EtwProcessPrivateLoggerRequest @ 0x18004FE80
 * Callers:
...
__int64 __fastcall EtwProcessPrivateLoggerRequest(char *a1, unsigned __int64 a2, unsigned __int64 *a3, __int64 a4)
{
  __int128 v5; // xmm6
  int *v6; // rdi
...
LABEL_9:
  ...
  if ( !v18 )
  {
    started = EtwpStopUmLogger(v11, v10, v12, (__int64)v6);
    goto LABEL_9;
  }
  v19 = v18 - 1;
  if ( !v19 )
