 ...
 *     iswalnum @ 0x180093790 (iswalnum.c)
 *     iswalpha @ 0x1800937A0 (iswalpha.c)
 *     iswdigit @ 0x1800937D0 (iswdigit.c)
 *     iswgraph @ 0x1800937E0 (iswgraph.c)
 *     iswlower @ 0x1800937F0 (iswlower.c)
 *     iswprint @ 0x180093800 (iswprint.c)
 *     iswspace @ 0x180093810 (iswspace.c)
 *     iswxdigit @ 0x180093820 (iswxdigit.c)
