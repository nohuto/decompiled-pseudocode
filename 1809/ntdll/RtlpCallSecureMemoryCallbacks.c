...
char __fastcall RtlpCallSecureMemoryCallbacks(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int64 a4)
{
  ...
  if ( RtlpSecMemListHead != (_UNKNOWN *)&RtlpSecMemListHead )
  {
    do
    {
      ...
      if ( v13 )
      {
        if ( *((unsigned __int64 **)v7 + 1) != v9
          || (v14 = (unsigned __int64 **)v9[1], *v14 != v9)
          || (*v14 = (unsigned __int64 *)v7, *((_QWORD *)v7 + 1) = v14, v15 = v20, (unsigned __int64 *)*v20 != &v19) )
        {
LABEL_15:
          __fastfail(3u);
        }
