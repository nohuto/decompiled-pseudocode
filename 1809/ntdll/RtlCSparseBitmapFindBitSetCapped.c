/*
 * XREFs of RtlCSparseBitmapFindBitSetCapped @ 0x1800658C4
 * Callers:
 ...
 * Callees:
 *     RtlLengthCurrentClearRunForwardEx @ 0x1800ECDF8 (RtlLengthCurrentClearRunForwardEx.c)
 */
    ...
    if ( _bittest64((const signed __int64 *)a1, (unsigned __int64)a2 >> 30) )
    {
      if ( _bittest64(*(const signed __int64 **)(a1 + 8), (unsigned __int64)a2 >> 15) )
      {
        ...
        else if ( v8 <= 0 )
        {
          ...
          v15 = (a2 % 0x8000) & 0x1F;
          v16 = *(_DWORD *)v14 & dword_180121CE0[v15];
