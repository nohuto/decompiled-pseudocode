...
LABEL_57:
  ...
  if ( (a1 & 7) != 2 )
  {
    if ( (a1 & 7) == 4 )
    {
      ...
      if ( (unsigned __int64)ActivationContext < *((_QWORD *)&xmmword_180178500 + 1)
        || (unsigned __int64)ActivationContext >= *((_QWORD *)&xmmword_180178500 + 1)
...
LABEL_28:
  ...
  LoadedDllByHandle = LdrpFindLoadedDllByHandle(ActivationContext, &v25, &v26);
