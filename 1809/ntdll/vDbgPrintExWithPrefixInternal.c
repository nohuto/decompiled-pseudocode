 ...
 *     ZwQueryDebugFilterState @ 0x1800A2A10 (ZwQueryDebugFilterState.c)
 *     DbgBreakPointWithStatus @ 0x1800A3D20 (DbgBreakPointWithStatus.c)
 *     DebugPrint @ 0x1800A3D30 (DebugPrint.c)
