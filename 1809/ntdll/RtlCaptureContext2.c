/*
 * XREFs of RtlCaptureContext2 @ 0x1800A4450
 * Callers:
...
unsigned __int64 __fastcall RtlCaptureContext2(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 v6; // rbp
  ...
  *(_DWORD *)(a1 + 48) &= 0x100040u;
  if ( *(_DWORD *)(a1 + 48) == 1048640 )
  {
    ...
    if ( _RDX )
      _RDX += 8LL;
    result = (unsigned __int64)RtlpMergeContextXState(v17, _RDX);
    a1 = v17;
  }
