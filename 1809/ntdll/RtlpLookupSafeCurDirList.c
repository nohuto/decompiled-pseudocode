...
__int64 RtlpLookupSafeCurDirList()
{
  ...
  if ( qword_1801627D0 == -1 )
  {
      ...
      *Heap = Heap;
      ...
      if ( !qword_180166570 )
      {
        ...
        if ( v4 < 0 )
          v5 = -1LL;
        Handle = (HANDLE)v5;
        v3 = _InterlockedCompareExchange64(&qword_180166570, v5, 0LL);
        if ( v3 )
        {
          if ( v4 >= 0 )
            NtClose((HANDLE)v5);
      ...
      if ( (v3 != -1 && (int)NtQueryValueKey() >= 0 && v13 == 16 && v21 == 1
         || (int)RtlQueryEnvironmentVariable_U(0LL, word_1801194C8, &v15) >= 0
    ...
    v9 = _InterlockedCompareExchange64(&qword_1801627D0, (signed __int64)v2, -1LL);
    if ( v9 == -1 )
    {
      return (__int64)v2;
    }
