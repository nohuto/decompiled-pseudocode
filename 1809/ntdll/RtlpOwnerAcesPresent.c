 ...
 *     RtlOwnerAcesPresent @ 0x18008B0D0 (RtlOwnerAcesPresent.c)
 * Callees:
...
char __fastcall RtlpOwnerAcesPresent(unsigned __int8 a1, __int64 a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    if ( (*(_BYTE *)(v6 + 1) & 8) == 0 )
    {
      ...
      {
        v5 = (_WORD *)(v6 + ((8LL * (*(_DWORD *)(v6 + 8) & 2)) | 0xC) + 16LL * (*(_DWORD *)(v6 + 8) & 1));
      }
      else if ( (_BYTE)v5 == 4 )
      {
        v5 = (_WORD *)(v6 + 12);
      ...
      {
        v5 = (unsigned __int8)v5 < 0xBu || (unsigned __int8)((_BYTE)v5 - 13) <= 1u ? (_WORD *)(v6 + 8) : 0LL;
      }
      if ( v5
        && *v5 == v9
        && !memcmp(v5, &Buf2, 4 * ((unsigned __int64)(unsigned __int16)*v5 >> 8) + 8)
        && (!a1 || (a1 & *(_BYTE *)(v6 + 1)) != 0) )
      {
        break;
      }
