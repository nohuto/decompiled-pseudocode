/*
 * XREFs of RtlpGetLengthWithoutLastPathElement @ 0x180071BF4
 * Callers:
 *     RtlGetLengthWithoutLastFullDosOrNtPathElement @ 0x180071BE0 (RtlGetLengthWithoutLastFullDosOrNtPathElement.c)
 * Callees:
