/*
 * XREFs of SbUpdateSwitchContextBasedOnDll @ 0x1800279F0
 * Callers:
...
__int64 __fastcall SbUpdateSwitchContextBasedOnDll(__int64 a1, unsigned __int64 *a2, int a3)
{
  unsigned int v4; // ebx
  char *v5; // rdi
  ...
  int v27; // ecx
  int v28; // edx
  unsigned __int64 *v29; // [rsp+30h] [rbp-20h] BYREF
  __int64 v30; // [rsp+38h] [rbp-18h] BYREF
  __int64 v31; // [rsp+40h] [rbp-10h] BYREF
  unsigned __int64 *v32; // [rsp+88h] [rbp+38h] BYREF
    ...
    if ( a3 )
    {
      ...
      if ( a3 == 1 )
      {
        ...
        if ( v16 )
        {
          ...
          v18 = v32;
          v19 = 0LL;
          while ( *((_DWORD *)&SbDynamicContextDllCount + 2 * v19) != *(_DWORD *)v32 )
          {
...
LABEL_27:
    ...
    else
    {
      ...
      if ( v4 )
      {
        v10 = (signed int *)v32;
        v11 = 0LL;
        v12 = (unsigned __int64 *)((char *)v32 + 4);
        *(_QWORD *)(a1 + 192) = (char *)v32 + 4;
        v4 = 1;
