        ...
        __int64 a7)
{
  ...
  *a6 = 0LL;
  if ( (a4 & 0x20) != 0 )
  {
    if ( RtlEqualUnicodeString((PUNICODE_STRING)&stru_1801192E0, a2, 1u) )
    {
      if ( a5 == a1[14] || a5 == a1[15] )
        v9 = (_UNICODE_STRING *)&unk_180119320;
    }
    else
    {
      v11 = RtlPrefixUnicodeString((PUNICODE_STRING)&stru_1801192F0, v9, 1u);
      v12 = (_UNICODE_STRING *)&unk_180119320;
      if ( !v11 )
        v12 = v9;
      v9 = v12;
    }
