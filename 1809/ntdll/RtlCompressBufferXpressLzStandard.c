/*
 * XREFs of RtlCompressBufferXpressLzStandard @ 0x1800011AC
 * Callers:
 *     RtlCompressBufferXpressLz @ 0x180001150 (RtlCompressBufferXpressLz.c)
 * Callees:
        ...
        __int64 a6)
{
  ...
  unsigned __int64 v48; // [rsp+28h] [rbp-60h]
  ...
  unsigned __int64 v53; // [rsp+C0h] [rbp+38h]
  unsigned __int8 *v54; // [rsp+C8h] [rbp+40h]
  ...
  v51 = 0LL;
  v49[0] = 0LL;
  XpressCallback = v6 - 38;
  v49[1] = 0LL;
  if ( v6 < 0x26 )
    XpressCallback = (unsigned __int64)&a1[a2];
  v10 = 2;
  v53 = XpressCallback;
  v11 = 0LL;
  v12 = v7 - 41;
        ...
        *(_QWORD *)(v17 + 16 * v18) = v14;
        ...
        if ( v14[3] != v21 )
        {
          ...
          *(_QWORD *)(a6 + 8 * (v36 + v21) + 22448) = v19;
          if ( v14 - v37 >= 0x2000 || (v38 = *(unsigned int *)v14, (_DWORD)v38 != *(_DWORD *)v37) )
          {
            v14 += 3;
            goto LABEL_53;
          }
          v19 = v37;
          *(_QWORD *)(a6 + 8 * (v36 + (v38 >> 24)) + 22448) = v14;
        }
        v23 = v19[4];
        v24 = (char *)(v14 + 4);
        if ( v14[4] != v23 )
        {
          v39 = 2
              * ((unsigned __int8)__ROR1__(v14[1] ^ __ROL1__(*v22 + *v14, 3), 1)
               + 4LL * (unsigned __int8)__ROL1__(*v14 ^ __ROR1__(v14[1] + v14[2] + 97, 1), 3));
          v40 = *(unsigned __int8 **)(a6 + 8 * (v39 + (unsigned __int8)*v24) + 22448);
          *(_QWORD *)(a6 + 8 * (v39 + v23) + 22448) = v19;
          if ( v14 - v40 >= 0x2000 || *(_DWORD *)v14 != *(_DWORD *)v40 || *v24 != v40[4] || v14 == v40 )
          {
            v14 += 4;
          ...
          v19 = v40;
          *(_QWORD *)(a6 + 8 * (v39 + (unsigned __int8)*v24) + 22448) = v14;
        }
        v25 = v19[5];
        v26 = v14 + 5;
        if ( v14[5] != v25 )
        {
          v41 = 2
              * ((v14[2] ^ (unsigned __int64)(unsigned __int8)__ROL1__(*v14, *v24))
               + 4
               * ((unsigned __int8)__ROL1__(*v24 ^ (__ROR1__(*v14, 1) + 69), 3)
                + (unsigned __int64)(unsigned __int8)__ROR1__(v14[1] ^ __ROL1__(*v22, 3), 1)));
          v42 = *(unsigned __int8 **)(a6 + 8 * (v41 + (unsigned __int8)*v26) + 22448);
          *(_QWORD *)(a6 + 8 * (v41 + v25) + 22448) = v19;
          if ( v14 - v42 >= 0x2000 || *(_DWORD *)v14 != *(_DWORD *)v42 || *v24 != v42[4] || *v26 != v42[5] || v14 == v42 )
          {
            v14 += 5;
            v8 = v6 - 38;
          ...
          v19 = v42;
          *(_QWORD *)(a6 + 8 * (v41 + (unsigned __int8)*v26) + 22448) = v14;
        }
        v14 += 6;
        v8 = v6 - 38;
        for ( v19 += 6; ; v19 += 32 )
...
LABEL_39:
        ...
        if ( (unsigned __int64)v14 >= v53 )
        {
          if ( (unsigned __int64)v14 < v8 )
          {
            XpressCallback = RtlpMakeXpressCallback(v49, v8, v14);
            v53 = XpressCallback;
            goto LABEL_44;
          }
LABEL_81:
