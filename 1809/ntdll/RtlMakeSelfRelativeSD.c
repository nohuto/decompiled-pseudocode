/*
 * XREFs of RtlMakeSelfRelativeSD @ 0x180074130
 * Callers:
 *     RtlAbsoluteToSelfRelativeSD @ 0x180074110 (RtlAbsoluteToSelfRelativeSD.c)
 *     RtlpSysVolCheckOwnerAndSecurity @ 0x18008D104 (RtlpSysVolCheckOwnerAndSecurity.c)
 * Callees:
 *     RtlpQuerySecurityDescriptor @ 0x180074284 (RtlpQuerySecurityDescriptor.c)
