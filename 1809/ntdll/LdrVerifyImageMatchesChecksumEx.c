/*
 * XREFs of LdrVerifyImageMatchesChecksumEx @ 0x18008C7C0
 * Callers:
 ...
 *     NtMakeTemporaryObject @ 0x1800A2410 (NtMakeTemporaryObject.c)
...
NTSTATUS __cdecl LdrVerifyImageMatchesChecksumEx(HANDLE ImageFileHandle, PLDR_VERIFY_IMAGE_INFO VerifyInfo)
{
  ...
  if ( (VerifyInfo->Flags & 2) == 0 )
    p_SectionInfo = (LDR_SECTION_INFO *)&unk_18011D918;
...
LABEL_29:
    if ( v8 < 0 || p_SectionInfo == (LDR_SECTION_INFO *)&unk_18011D918 )
    {
