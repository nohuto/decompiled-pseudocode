/*
 * XREFs of ?QueueRequestFromForward@FxIoQueue@@QEAAJPEAVFxRequest@@@Z @ 0x1C0009B60
 * Callers:
...
__int64 __fastcall FxIoQueue::QueueRequestFromForward(FxIoQueue *this, FxRequest *pRequest, unsigned __int8 a3)
{
  ...
  unsigned int v9; // edx
  _IRP *m_Irp; // r9
  $A3173470F8A533D5F67D6DF0520578B2 *v11; // r10
  _LIST_ENTRY *v12; // rcx
  ...
  if ( (m_QueueState & 1) != 0 )
  {
    ...
    else if ( v4->m_Queue.m_RequestCount == 1 || v4->m_ForceTransitionFromEmptyWhenAddingNewRequest )
    {
      ...
      if ( v4->m_IsDevicePowerPolicyOwner )
      {
        ...
        {
          v15 = 0;
          v16 = *(_QWORD *)(*(_QWORD *)&v4->m_DeviceBase[3].m_SpinLock.m_DbgFlagIsInitialized + 880LL);
