/*
 * XREFs of ?GetPdoPackageFromDeviceHandle@@YAJPEAU_FX_DRIVER_GLOBALS@@PEAUWDFDEVICE__@@PEADPEAPEAVFxPkgPdo@@PEAPEAU1@PEAPEAVFxDevice@@@Z @ 0x1C003ADA0
 * Callers:
 *     imp_WdfPdoAddEjectionRelationsPhysicalDevice @ 0x1C003AFF0 (imp_WdfPdoAddEjectionRelationsPhysicalDevice.c)
 *     imp_WdfPdoClearEjectionRelationsDevices @ 0x1C003B060 (imp_WdfPdoClearEjectionRelationsDevices.c)
 *     imp_WdfPdoGetParent @ 0x1C003B0B0 (imp_WdfPdoGetParent.c)
 *     imp_WdfPdoMarkMissing @ 0x1C003B140 (imp_WdfPdoMarkMissing.c)
