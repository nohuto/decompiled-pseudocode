/*
 * XREFs of ?_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z @ 0x1C001A4B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall FxInterrupt::_InterruptDisableThunk(FxInterrupt **SyncContext)
{
  ...
  if ( (*SyncContext)->m_PassiveHandling )
  {
    ...
    if ( !v1->m_ObjectSize )
      v3 = 0LL;
    v7 = v1->m_EvtInterruptDisable((WDFINTERRUPT__ *)v3, (WDFDEVICE__ *)v11);
  ...
  else
  {
    ...
    if ( !v1->m_ObjectSize )
      v3 = 0LL;
    v7 = v1->m_EvtInterruptDisable((WDFINTERRUPT__ *)v3, (WDFDEVICE__ *)v6);
  }
  result = 1;
