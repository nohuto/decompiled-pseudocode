/*
 * XREFs of ?Initialize@FxDmaEnabler@@QEAAJPEAU_WDF_DMA_ENABLER_CONFIG@@PEAVFxDeviceBase@@@Z @ 0x1C0033BB0
 * Callers:
...
LABEL_61:
        ...
        if ( !m_ObjectSize )
          v39 = v36;
        WPP_IFR_SF_qL(v35, 2u, 0xFu, v37, WPP_FxDmaEnabler_cpp_Traceguids, v39, 0xC000000D);
        goto LABEL_32;
      }
