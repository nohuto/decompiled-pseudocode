/*
 * XREFs of ?AssignProperty@FxDevice@@QEAAJPEAXW4FxPropertyType@@KK0@Z @ 0x1C0052014
 * Callers:
        ...
        PVOID Data)
{
  ...
  if ( !this->m_ObjectSize )
    v15 = 0LL;
  WPP_IFR_SF_qL(this->m_Globals, 2u, v14, v13, WPP_FxDeviceKm_cpp_Traceguids, v15, v12);
  return (unsigned int)v12;
}
