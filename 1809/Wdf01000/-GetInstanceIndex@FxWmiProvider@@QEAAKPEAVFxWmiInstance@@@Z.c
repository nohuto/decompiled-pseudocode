/*
 * XREFs of ?GetInstanceIndex@FxWmiProvider@@QEAAKPEAVFxWmiInstance@@@Z @ 0x1C00401B0
 * Callers:
 *     ?FireEvent@FxWmiInstance@@QEAAJPEAXK@Z @ 0x1C0040A34 (-FireEvent@FxWmiInstance@@QEAAJPEAXK@Z.c)
 * Callees:
