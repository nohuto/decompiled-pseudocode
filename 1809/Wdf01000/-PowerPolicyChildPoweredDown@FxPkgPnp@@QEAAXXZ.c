/*
 * XREFs of ?PowerPolicyChildPoweredDown@FxPkgPnp@@QEAAXXZ @ 0x1C00182D8
 * Callers:
 *     ?PowerParentPowerDereference@FxPkgPdo@@EEAAXXZ @ 0x1C00182B0 (-PowerParentPowerDereference@FxPkgPdo@@EEAAXXZ.c)
 * Callees:
