/*
 * XREFs of ?GetDeviceControlOutputMemoryObject@FxRequest@@QEAAJPEAPEAVIFxMemory@@PEAPEAXPEA_K@Z @ 0x1C0003430
 * Callers:
        ...
        unsigned __int64 *Length)
{
  ...
  if ( !CurrentStackLocation->Parameters.Read.Length )
  {
    ...
    v19 = 34;
LABEL_22:
    WPP_IFR_SF_qL(this->m_Globals, 2u, 0x10u, v19, WPP_FxRequest_cpp_Traceguids, _a1, 0xC0000023);
    goto $Done_1;
  }
