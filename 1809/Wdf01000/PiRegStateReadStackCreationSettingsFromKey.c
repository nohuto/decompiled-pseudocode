/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C00C5068
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00C54B8 (SeUtilSecurityInfoFromSecurityDescriptor.c)
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C00C57B0 (CmRegUtilUcValueGetFullBuffer.c)
