/*
 * XREFs of ?ProcessIdleComplete@FxIoQueue@@AEAAXPEAE@Z @ 0x1C0018CF8
 * Callers:
 ...
 *     ?Invoke@FxIoQueueIoState@@QEAAXPEAUWDFQUEUE__@@PEAX@Z @ 0x1C0018DA4 (-Invoke@FxIoQueueIoState@@QEAAXPEAUWDFQUEUE__@@PEAX@Z.c)
 */
...
void __fastcall FxIoQueue::ProcessIdleComplete(FxIoQueue *this, unsigned __int8 *PreviousIrql, unsigned __int8 a3)
{
  ...
  if ( callback.Method )
  {
    if ( !this->m_ObjectSize )
      v10 = 0LL;
    FxIoQueueIoState::Invoke(&callback, v10, m_IdleCompleteContext);
  }
