/*
 * XREFs of ?PnpEventHardwareAvailable@FxPkgPnp@@KA?AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z @ 0x1C007CE50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreatePowerThreadIfNeeded@FxPkgPnp@@AEAAJXZ @ 0x1C008DA00 (-CreatePowerThreadIfNeeded@FxPkgPnp@@AEAAJXZ.c)
 */
