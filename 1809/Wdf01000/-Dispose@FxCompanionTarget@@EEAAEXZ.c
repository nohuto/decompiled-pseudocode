/*
 * XREFs of ?Dispose@FxCompanionTarget@@EEAAEXZ @ 0x1C0045190
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall FxCompanionTarget::Dispose(FxCompanionTarget *this, unsigned __int8 a2)
{
  ...
  {
    v5 = qword_1C00ABEB8;
    ((void (__fastcall *)(ICompanionLibrary *))qword_1C00ABEB8->m_RdCompanionLibrary->UnloadCompanion)(qword_1C00ABEB8->m_RdCompanionLibrary);
