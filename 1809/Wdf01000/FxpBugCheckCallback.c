/*
 * XREFs of FxpBugCheckCallback @ 0x1C0092C00
 * Callers:
 *     <none>
 * Callees:
 *     FxpBugCheckCallbackFilter @ 0x1C0092CB0 (FxpBugCheckCallbackFilter.c)
 */
...
LABEL_9:
        ...
        if ( !unk_1C00ABE70
          ...
          && *(_FX_DRIVER_GLOBALS **)((char *)&stru_1C00ABE58.m_DriverUsage->FxDriverGlobals
                                    + HIDWORD(KeGetPcr()[1].LockArray) * stru_1C00ABE58.m_EntrySize) == p_Checksum )
        {
          goto LABEL_9;
        }
      }
