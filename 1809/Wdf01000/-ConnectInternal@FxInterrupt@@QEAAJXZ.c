/*
 * XREFs of ?ConnectInternal@FxInterrupt@@QEAAJXZ @ 0x1C0013498
 * Callers:
...
__int64 __fastcall FxInterrupt::ConnectInternal(FxInterrupt *this)
{
  ...
  connectParams.Version = unk_1C00ABE50 != 0 ? 4 : 1;
  ...
  return (*(__int64 (__fastcall **)(_IO_CONNECT_INTERRUPT_PARAMETERS *))(v3 + 1136))(&connectParams);
}
