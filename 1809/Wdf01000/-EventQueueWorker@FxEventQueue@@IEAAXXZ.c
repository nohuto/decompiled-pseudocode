/*
 * XREFs of ?EventQueueWorker@FxEventQueue@@IEAAXXZ @ 0x1C008D6D4
 * Callers:
 *     ?_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z @ 0x1C008D930 (-_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z.c)
