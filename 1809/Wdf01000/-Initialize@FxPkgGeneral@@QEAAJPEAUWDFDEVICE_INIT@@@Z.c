/*
 * XREFs of ?Initialize@FxPkgGeneral@@QEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C0090654
 * Callers:
...
__int64 __fastcall FxPkgGeneral::Initialize(FxPkgGeneral *this, WDFDEVICE_INIT *DeviceInit)
{
  ...
  {
    v5 = (FxFileObjectInfo *)FxPoolAllocator(
                               m_Globals,
    ...
    if ( v5 )
    {
      FxFileObjectInfo::FxFileObjectInfo(v5);
      v7 = v6;
    }
    else
    {
...
LABEL_24:
  ...
  for ( i = DeviceInit->CxDeviceInitListHead.Flink; i != p_CxDeviceInitListHead; i = i->Flink )
  {
    if ( BYTE4(i[13].Flink) )
    {
      v14 = (FxFileObjectInfo *)FxPoolAllocator(
                                  m_Globals,
                                  &m_Globals->FxPoolFrameworks,
                                  ExDefaultNonPagedPoolType,
                                  0xA0uLL,
      ...
      if ( v14 )
      {
        FxFileObjectInfo::FxFileObjectInfo(v14);
        v16 = v15;
      }
      else
      {
