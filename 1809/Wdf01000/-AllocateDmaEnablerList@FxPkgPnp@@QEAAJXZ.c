/*
 * XREFs of ?AllocateDmaEnablerList@FxPkgPnp@@QEAAJXZ @ 0x1C0087990
 * Callers:
 *     ?AllocateDmaEnablerList@FxDevice@@UEAAJXZ @ 0x1C0051FF0 (-AllocateDmaEnablerList@FxDevice@@UEAAJXZ.c)
 * Callees:
