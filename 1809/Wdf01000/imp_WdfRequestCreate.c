/*
 * XREFs of imp_WdfRequestCreate @ 0x1C000A590
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **Request)
{
  ...
  _FX_DRIVER_GLOBALS *v43; // rax
  unsigned __int64 *Total; // [rsp+20h] [rbp-88h]
  FxIoTarget *pTarget; // [rsp+50h] [rbp-58h] BYREF
  void *PPObject; // [rsp+58h] [rbp-50h] BYREF
  FxObject **v47; // [rsp+60h] [rbp-48h] BYREF
  __int16 v48; // [rsp+68h] [rbp-40h]
  __int16 v49; // [rsp+6Ah] [rbp-3Eh]
      ...
      if ( !v23 )
      {
        ...
        if ( v25 )
        {
          ...
          if ( flags->m_Type != 4096 )
          {
            ...
            v49 = v26;
            v48 = 4096;
            if ( v27->QueryInterface(flags, (FxQueryInterfaceParams *)&v47) < 0 )
            {
              WPP_IFR_SF_qDqD(
                flags->m_Globals,
                (unsigned __int8)v21,
...
LABEL_44:
            ...
            v30 = KeAcquireSpinLockRaiseToDpc(&v22->m_SpinLock.m_Lock);
            ...
            if ( v23 )
            {
              ...
              {
                v32 = KeAcquireSpinLockRaiseToDpc(&flags->m_SpinLock.m_Lock);
                if ( flags->m_ObjectState == 1 )
                {
                  ...
                  KeReleaseSpinLock(&flags->m_SpinLock.m_Lock, v32);
                  v11 = 0;
