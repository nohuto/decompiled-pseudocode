/*
 * XREFs of imp_WdfDeviceInitRegisterPowerStateChangeCallback @ 0x1C0046610
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (int)result >= 0 )
  {
    ...
    else
    {
      ...
      if ( PowerStateCallbacks )
        goto LABEL_15;
      v13 = (FxPowerStateCallback *)FxPoolAllocator(
                                      v7,
                                      &v7->FxPoolFrameworks,
                                      ...
                                      v7->Tag,
                                      Caller);
      PowerStateCallbacks = v13;
      if ( v13 )
        memset(v13, 0, sizeof(FxPowerStateCallback));
      else
