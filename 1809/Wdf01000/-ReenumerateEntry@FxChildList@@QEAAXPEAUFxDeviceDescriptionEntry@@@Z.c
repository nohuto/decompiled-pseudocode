/*
 * XREFs of ?ReenumerateEntry@FxChildList@@QEAAXPEAUFxDeviceDescriptionEntry@@@Z @ 0x1C003DFA8
 * Callers:
 *     ?AskParentToRemoveAndReenumerate@FxPkgPdo@@EEAAJXZ @ 0x1C007B650 (-AskParentToRemoveAndReenumerate@FxPkgPdo@@EEAAJXZ.c)
 * Callees:
