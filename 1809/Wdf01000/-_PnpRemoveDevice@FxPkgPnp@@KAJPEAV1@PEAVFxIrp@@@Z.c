/*
 * XREFs of ?_PnpRemoveDevice@FxPkgPnp@@KAJPEAV1@PEAVFxIrp@@@Z @ 0x1C0085C80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::_PnpRemoveDevice(FxPkgPnp *This, FxIrp *Irp)
{
  ...
  FxObject::AddRef(This, Irp, 2477, "minkernel\\wdf\\framework\\shared\\irphandlers\\pnp\\fxpkgpnp.cpp");
  ...
  if ( !v7->m_ObjectSize )
    _a1 = 0LL;
  WPP_IFR_SF_qq(This->m_Globals, 4u, 0xCu, 0x29u, WPP_FxPkgPnp_cpp_Traceguids, _a1, v7->m_DeviceObject.m_DeviceObject);
  ...
  This->Release(This, Irp, 2513, "minkernel\\wdf\\framework\\shared\\irphandlers\\pnp\\fxpkgpnp.cpp");
  return v10;
}
