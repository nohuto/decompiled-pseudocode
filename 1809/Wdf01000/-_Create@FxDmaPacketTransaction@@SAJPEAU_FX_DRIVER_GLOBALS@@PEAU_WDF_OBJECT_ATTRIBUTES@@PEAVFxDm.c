/*
 * XREFs of ?_Create@FxDmaPacketTransaction@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDmaEnabler@@PEAPEAUWDFDMATRANSACTION__@@@Z @ 0x1C00361C8
 * Callers:
        ...
        WDFDMATRANSACTION__ **Transaction)
{
         ...
         FxObjectTypeExternal) )
  {
    if ( FxDmaEnabler::GetDmaDescription(DmaEnabler, WdfDmaDirectionReadFromDevice)->m_SimplexAdapterInfo.DeviceDescription.Version != 3 )
      v9 = 0;
    FxDmaPacketTransaction::FxDmaPacketTransaction(v11, FxDriverGlobals, 0x138u, v9, DmaEnabler);
    v13 = v12;
  }
  else
  {
