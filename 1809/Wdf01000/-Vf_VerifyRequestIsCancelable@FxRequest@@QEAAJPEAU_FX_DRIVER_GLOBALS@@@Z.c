/*
 * XREFs of ?Vf_VerifyRequestIsCancelable@FxRequest@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C00C2610
 * Callers:
...
__int64 __fastcall FxRequest::Vf_VerifyRequestIsCancelable(FxRequest *this, _FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  else
  {
    ...
    if ( !m_ObjectSize )
      _a1 = 0LL;
    WPP_IFR_SF_qL(FxDriverGlobals, 2u, 0x10u, 0x35u, WPP_FxRequest_cpp_Traceguids, _a1, 0xC0000010);
