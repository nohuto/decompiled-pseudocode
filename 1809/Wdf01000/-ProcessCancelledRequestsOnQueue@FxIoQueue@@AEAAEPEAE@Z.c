/*
 * XREFs of ?ProcessCancelledRequestsOnQueue@FxIoQueue@@AEAAEPEAE@Z @ 0x1C0078F1C
 * Callers:
 ...
 *     ?IsPowerStateNotifyingDriver@FxIoQueue@@AEAAEXZ @ 0x1C001308C (-IsPowerStateNotifyingDriver@FxIoQueue@@AEAAEXZ.c)
