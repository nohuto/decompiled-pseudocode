/*
 * XREFs of ?IsCorrectVersionRegistered@_FX_DRIVER_GLOBALS@@QEAAEPEBU_UNICODE_STRING@@@Z @ 0x1C005B5F8
 * Callers:
        ...
        _UNICODE_STRING *ServiceKeyName)
{
  ...
  _UNICODE_STRING parametersPath; // [rsp+38h] [rbp-71h] BYREF
  _UNICODE_STRING wdfMajorValue; // [rsp+48h] [rbp-61h] BYREF
  _UNICODE_STRING wdfMinorValue; // [rsp+58h] [rbp-51h] BYREF
  ...
  *(_DWORD *)&wdfMajorValue.Length = 2097182;
  *(_DWORD *)&wdfMinorValue.Length = 2097182;
