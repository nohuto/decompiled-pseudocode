/*
 * XREFs of ?_GetEffectiveLock@FxObject@@SAJPEAV1@PEAVIFxHasCallbacks@@EEPEAPEAVFxCallbackLock@@PEAPEAV1@@Z @ 0x1C000E458
 * Callers:
 ...
 *     ?IsPassiveCallbacks@FxObject@@QEAAEE@Z @ 0x1C005C1E0 (-IsPassiveCallbacks@FxObject@@QEAAEE@Z.c)
 */
