/*
 * XREFs of ?SaveState@FxPkgPnp@@IEAAXE@Z @ 0x1C000EDB8
 * Callers:
 ...
 *     ?_PowerStateCallback@FxPowerPolicyOwnerSettings@@KAXPEAX00@Z @ 0x1C000ECC0 (-_PowerStateCallback@FxPowerPolicyOwnerSettings@@KAXPEAX00@Z.c)
...
void __fastcall FxPkgPnp::SaveState(FxPkgPnp *this, unsigned __int8 UseCanSaveState)
{
  ...
  if ( m_Owner )
  {
    if ( UseCanSaveState && !m_Owner->m_CanSaveState )
    {
      ...
      if ( !m_ObjectSize )
        _a1 = 0LL;
      WPP_IFR_SF_q(m_Globals, 5u, 0xCu, 0x4Fu, WPP_FxPkgPnp_cpp_Traceguids, _a1);
    }
