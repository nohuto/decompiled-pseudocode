/*
 * XREFs of FxIoResourceRequirementsListInsertIoResList @ 0x1C005E8C8
 * Callers:
 *     imp_WdfIoResourceRequirementsListAppendIoResList @ 0x1C005F1A0 (imp_WdfIoResourceRequirementsListAppendIoResList.c)
 *     imp_WdfIoResourceRequirementsListInsertIoResList @ 0x1C005F2A0 (imp_WdfIoResourceRequirementsListInsertIoResList.c)
 * Callees:
