/*
 * XREFs of imp_WdfRegistryQueryMultiString @ 0x1C00609A0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFCOLLECTION__ *Collection)
{
  ...
  FxDeviceBase *v24; // [rsp+50h] [rbp-20h]
  ...
  FX_POOL_TRACKER *type; // [rsp+C0h] [rbp+50h] BYREF
            ...
            if ( v12 >= 0 )
            {
              ...
              if ( LOWORD(v15->Link.Flink) )
              {
                while ( 1 )
                {
                  ...
                  if ( v24 )
                    *(_QWORD *)(v19 + 96) = v24;
                  RtlInitUnicodeString(&DestinationString, (PCWSTR)type);
                  v12 = FxDuplicateUnicodeString(
                          *(_FX_DRIVER_GLOBALS **)(v19 + 16),
                          &DestinationString,
                          (_UNICODE_STRING *)(v19 + 104));
                  if ( v12 < 0 )
                    goto LABEL_31;
                  v12 = FxObject::Commit((FxObject *)v19, (_FX_DRIVER_GLOBALS *)Attributes, &dummy, 0LL, 1u);
                  if ( v12 < 0 )
                    goto LABEL_31;
                  ...
                  {
LABEL_31:
                    FxObject::ClearEvtCallbacks((FxObject *)v19);
