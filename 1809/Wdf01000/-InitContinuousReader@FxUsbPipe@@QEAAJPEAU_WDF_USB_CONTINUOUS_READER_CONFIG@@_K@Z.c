/*
 * XREFs of ?InitContinuousReader@FxUsbPipe@@QEAAJPEAU_WDF_USB_CONTINUOUS_READER_CONFIG@@_K@Z @ 0x1C006FA1C
 * Callers:
        ...
        unsigned __int64 TotalBufferLength)
{
  ...
  if ( this->m_Reader )
  {
    ...
    if ( !this->m_ObjectSize )
      v6 = 0LL;
    WPP_IFR_SF_qL(this->m_Globals, 2u, 0xEu, 0x1Cu, WPP_FxUsbPipe_cpp_Traceguids, v6, 0xC0000184);
    return 3221225860LL;
  }
  else
  {
