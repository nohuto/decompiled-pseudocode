/*
 * XREFs of ?RemoveNextIrpFromQueue@FxIrpQueue@@AEAAPEAU_IRP@@PEAXPEAPEAU_IO_CSQ_IRP_CONTEXT@@@Z @ 0x1C0018020
 * Callers:
        ...
        _IO_CSQ_IRP_CONTEXT **pCsqContext)
{
  ...
  while ( 1 )
  {
    ...
    if ( _InterlockedExchange64((volatile __int64 *)&p_m_RequestCount->CancelRoutine, 0LL) )
      break;
    p_m_RequestCount = FxIrpQueue::PeekNextIrpFromQueue(i, fxIrp.m_Irp, v5);
  }
