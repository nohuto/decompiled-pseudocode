/*
 * XREFs of ??_GFxDeviceText@@QEAAPEAXI@Z @ 0x1C0045D50
 * Callers:
 *     imp_WdfPdoInitAddDeviceText @ 0x1C0047B40 (imp_WdfPdoInitAddDeviceText.c)
 *     ?_CleanupList@FxDeviceText@@SAHPEAU_SINGLE_LIST_ENTRY@@@Z @ 0x1C0051EB8 (-_CleanupList@FxDeviceText@@SAHPEAU_SINGLE_LIST_ENTRY@@@Z.c)
 * Callees:
