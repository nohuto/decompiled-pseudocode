/*
 * XREFs of USBD_CreateHandle @ 0x1C0091800
 * Callers:
 ...
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C0091140 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
...
LABEL_37:
        ...
        if ( *((_DWORD *)v12 + 54) == 1536 )
        {
          ...
          *((_BYTE *)v12 + 224) = IsDeviceHighSpeed;
        ...
        if ( v10 < 0 )
        {
          if ( v20 )
          {
            v19 = (void (__fastcall *)(_QWORD))*((_QWORD *)v12 + 14);
            if ( v19 )
              v19(*((_QWORD *)v12 + 6));
          }
