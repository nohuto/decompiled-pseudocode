/*
 * XREFs of ?AllocateEnumInfo@FxPkgPnp@@QEAAJXZ @ 0x1C00821B8
 * Callers:
 *     ?AllocateEnumInfo@FxDevice@@UEAAJXZ @ 0x1C0053520 (-AllocateEnumInfo@FxDevice@@UEAAJXZ.c)
...
__int64 __fastcall FxPkgPnp::AllocateEnumInfo(FxPkgPnp *this, __int64 a2, unsigned __int8 a3)
{
  ...
  if ( !this->m_EnumInfo )
  {
    ...
    if ( !v7 )
    {
      ...
      if ( !m_ObjectSize )
        v11 = 0LL;
      WPP_IFR_SF_qL(this->m_Globals, 2u, 0xCu, 0x4Bu, WPP_FxPkgPnp_cpp_Traceguids, v11, 0xC000009A);
      goto LABEL_10;
    }
