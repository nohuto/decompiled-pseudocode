/*
 * XREFs of ?_PowerTimeoutDpcRoutine@FxPowerIdleMachine@@KAXPEAU_KDPC@@PEAX11@Z @ 0x1C0019CF0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *SystemArgument2)
{
  ...
  v5 = *(void (__fastcall **)(int (__fastcall **)(WDFDRIVER__ *, WDFDEVICE_INIT *), __int64, __int64, __int64, char))(unk_1C00ABE90 + 8LL);
  if ( v5 )
  {
    v6 = 2;
