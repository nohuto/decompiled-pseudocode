/*
 * XREFs of WPP_IFR_SF_dq @ 0x1C00307D4
 * Callers:
 ...
 *     ?FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ @ 0x1C0034DE0 (-FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ.c)
