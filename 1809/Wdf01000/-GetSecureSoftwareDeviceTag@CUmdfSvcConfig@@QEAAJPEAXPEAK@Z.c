/*
 * XREFs of ?GetSecureSoftwareDeviceTag@CUmdfSvcConfig@@QEAAJPEAXPEAK@Z @ 0x1C0090BE4
 * Callers:
        ...
        unsigned int a4)
{
  ...
  *(_DWORD *)&wudfKeyName.Length = 655368;
  wcscpy(softwareDeviceTagKeyName_buffer, L"SoftwareDeviceTag");
  *(_DWORD *)&softwareDeviceTagKeyName.Length = 2359330;
