/*
 * XREFs of ?DispatchStep1@FxPkgIo@@QEAAJPEAU_IRP@@PEAX@Z @ 0x1C0007060
 * Callers:
 *     ?Dispatch@FxPkgIo@@UEAAJPEAU_IRP@@@Z @ 0x1C0006FF0 (-Dispatch@FxPkgIo@@UEAAJPEAU_IRP@@@Z.c)
 ...
 *     ?Mj2Index@FxIrpDynamicDispatchInfo@@SAHE@Z @ 0x1C00775F8 (-Mj2Index@FxIrpDynamicDispatchInfo@@SAHE@Z.c)
...
LABEL_6:
      ...
      ReservedRequest = 0LL;
      PPObject = m_Globals;
      if ( v15 && *(_WORD *)(v15 + 8) == 4354 && *(_BYTE *)(v15 + 1691) )
      {
...
LABEL_50:
              ...
              if ( m_ObjectSize )
                ...
                v34 = 0LL;
              v35 = *((_QWORD *)p_RequestAttributes + 2);
              if ( v35 )
                *((_QWORD *)v34 + 3) = v35;
              v36 = *((_QWORD *)p_RequestAttributes + 1);
              if ( v36 )
              {
                *((_QWORD *)v34 + 2) = v36;
          ...
          {
            v38 = FxObject::Commit(v23, (_WDF_OBJECT_ATTRIBUTES *)p_RequestAttributes, 0LL, m_DeviceBase, 0);
          }
          if ( v38 >= 0 )
          {
            v27 = v98;
