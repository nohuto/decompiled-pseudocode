/*
 * XREFs of imp_WdfDeviceInitRegisterPnpStateChangeCallback @ 0x1C0046370
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (int)result >= 0 )
  {
    ...
    else
    {
      ...
      if ( PnpStateCallbacks )
        goto LABEL_15;
      v13 = (FxPnpStateCallback *)FxPoolAllocator(
                                    v7,
                                    &v7->FxPoolFrameworks,
                                    ...
                                    v7->Tag,
                                    Caller);
      PnpStateCallbacks = v13;
      if ( v13 )
        memset(v13, 0, sizeof(FxPnpStateCallback));
      else
