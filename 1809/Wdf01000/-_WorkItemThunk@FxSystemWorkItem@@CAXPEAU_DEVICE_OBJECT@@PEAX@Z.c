/*
 * XREFs of ?_WorkItemThunk@FxSystemWorkItem@@CAXPEAU_DEVICE_OBJECT@@PEAX@Z @ 0x1C000AC00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxSystemWorkItem::_WorkItemThunk(_DEVICE_OBJECT *DeviceObject, char *Context, unsigned __int8 a3)
{
  ...
  if ( v4->FxTrackDriverForMiniDumpLog )
    *(_FX_DRIVER_GLOBALS *volatile *)((char *)&stru_1C00ABE58.m_DriverUsage->FxDriverGlobals
                                    + stru_1C00ABE58.m_EntrySize * HIDWORD(KeGetPcr()[1].LockArray)) = v4;
  ...
  {
    v5 = (unsigned __int64 *)(Context + 112);
    v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)Context + 14);
    PreviousIrql = v6;
  }
  ...
  *((_QWORD *)Context + 17) = 0LL;
  Context[121] = 0;
  FxNonPagedObject::Unlock((FxNonPagedObject *)Context, v6);
  v7(v8);
