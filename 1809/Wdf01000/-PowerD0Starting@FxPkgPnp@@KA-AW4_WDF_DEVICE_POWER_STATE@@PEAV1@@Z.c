/*
 * XREFs of ?PowerD0Starting@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z @ 0x1C007FDD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SleepStudyResetBlockersForD0@FxPkgPnp@@QEAAXXZ @ 0x1C00815B8 (-SleepStudyResetBlockersForD0@FxPkgPnp@@QEAAXXZ.c)
 */
