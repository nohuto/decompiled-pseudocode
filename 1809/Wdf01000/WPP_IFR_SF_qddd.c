/*
 * XREFs of WPP_IFR_SF_qDDd @ 0x1C004B8D0
 * Callers:
 *     imp_WdfRequestForwardToParentDeviceIoQueue @ 0x1C004BDF0 (imp_WdfRequestForwardToParentDeviceIoQueue.c)
 *     ?ConfigureConstraints@FxIoQueue@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@@Z @ 0x1C0078238 (-ConfigureConstraints@FxIoQueue@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@@Z.c)
 * Callees:
