/*
 * XREFs of FxpLibraryBugCheckCallback @ 0x1C0092EB0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        unsigned int ReasonSpecificLength)
{
  ...
  v4 = 56 * dword_1C00ABE10;
  if ( *(_DWORD *)&ReasonSpecificData->Data4[4] < 56 * dword_1C00ABE10 )
    v4 = 56 * (*(_DWORD *)&ReasonSpecificData->Data4[4] / 0x38u);
  if ( v4 )
  {
    *(_QWORD *)&ReasonSpecificData[2].Data1 = P;
