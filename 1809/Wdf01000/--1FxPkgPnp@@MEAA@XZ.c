 ...
 *     ?SleepStudyStop@FxPkgPnp@@QEAAXXZ @ 0x1C00885F0 (-SleepStudyStop@FxPkgPnp@@QEAAXXZ.c)
...
void __fastcall FxPkgPnp::~FxPkgPnp(FxPkgPnp *this)
{
  ...
  if ( m_Resources )
  {
    m_Resources->Release(m_Resources, this, 357, "minkernel\\wdf\\framework\\shared\\irphandlers\\pnp\\fxpkgpnp.cpp");
