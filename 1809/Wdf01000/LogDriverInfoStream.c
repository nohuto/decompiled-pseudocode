/*
 * XREFs of LogDriverInfoStream @ 0x1C006255C
 * Callers:
 ...
 *     GetDriverInfo @ 0x1C0061FB4 (GetDriverInfo.c)
 *     GetFirstHardwareId @ 0x1C0062208 (GetFirstHardwareId.c)
...
void __fastcall LogDriverInfoStream(_FX_DRIVER_GLOBALS *DriverGlobals, FxDevice *Fdo)
{
  ...
  bool v20; // [rsp+39h] [rbp-C7h] BYREF
  ...
  char v26; // [rsp+3Fh] [rbp-C1h] BYREF
  ...
  *(_QWORD *)&manufacturer.m_UnicodeString.Length = 0LL;
  ...
  if ( Tlgg_TelemetryProviderProv.LevelPlus1 > 5 && TlgKeywordOn(v7, 0x200000000000uLL) )
  {
    ...
    *(_QWORD *)&_TlgData[27].Size = 1LL;
    ...
    TlgWrite(v8, (char *)&TlgEvent_2._TlgChannel, v9, v10, 0x20u, _TlgData);
  }
