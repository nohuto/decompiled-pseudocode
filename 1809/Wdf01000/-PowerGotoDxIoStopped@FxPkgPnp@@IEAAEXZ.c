/*
 * XREFs of ?PowerGotoDxIoStopped@FxPkgPnp@@IEAAEXZ @ 0x1C0012AE0
 * Callers:
 *     ?PowerGotoDNotZeroIoStopped@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z @ 0x1C0012AC0 (-PowerGotoDNotZeroIoStopped@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z.c)
 *     ?PowerGotoDxIoStoppedArmedForWake@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z @ 0x1C0014270 (-PowerGotoDxIoStoppedArmedForWake@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_STATE@@PEAV1@@Z.c)
 * Callees:
...
unsigned __int8 __fastcall FxPkgPnp::PowerGotoDxIoStopped(FxPkgPnp *this)
{
  ...
  if ( m_DmaEnablerList )
  {
    ...
    FxTransactionedList::UnlockFromEnum(v28, this->m_Globals);
    if ( !v8 )
      v2 = 1;
  }
  v9 = 0LL;
  ...
  if ( Blink != &this->m_InterruptListHead )
  {
    do
    {
      ...
      if ( v25 < 0 )
      {
        v32 = (const void *)((unsigned __int64)p_Blink ^ 0xFFFFFFFFFFFFFFF8uLL);
        if ( !*((_WORD *)p_Blink + 5) )
          v32 = 0LL;
        WPP_IFR_SF_qL(this->m_Globals, 2u, 0xCu, 0x51u, WPP_FxPkgPnp_cpp_Traceguids, v32, v25);
        v13 = v37;
      }
      Blink = Blink->Blink;
    }
  ...
  if ( m_Device->m_CxDeviceInfoListHead.Flink == &m_Device->m_CxDeviceInfoListHead )
  {
    ...
    if ( !m_CompanionTarget )
      goto LABEL_17;
    v33 = p_m_DeviceD0Exit->InvokeCompanionCallback(&this->m_DeviceD0Exit, m_CompanionTarget);
    if ( v19 < 0 )
      goto LABEL_48;
    goto LABEL_55;
  }
  v19 = FxPrePostCallback::IssuePreCxCallbacksStateless(v16, m_Device);
  v34 = p_m_DeviceD0Exit->InvokeClient(&this->m_DeviceD0Exit);
  if ( v19 >= 0 )
    v19 = v34;
  v35 = FxPrePostCallback::IssuePostCxCallbacks(&this->m_DeviceD0Exit, m_Device);
  if ( v19 >= 0 )
    v19 = v35;
  if ( m_CompanionTarget )
  {
