/*
 * XREFs of ?_Create@FxSystemWorkItem@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAXPEAPEAV1@@Z @ 0x1C000C224
 * Callers:
 ...
 *     ?Initialize@FxDisposeList@@QEAAJPEAX@Z @ 0x1C00574F4 (-Initialize@FxDisposeList@@QEAAJPEAX@Z.c)
