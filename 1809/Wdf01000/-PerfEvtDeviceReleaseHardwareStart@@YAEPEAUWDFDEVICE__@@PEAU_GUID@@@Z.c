/*
 * XREFs of ?PerfEvtDeviceReleaseHardwareStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x1C00459B0
 * Callers:
...
bool __fastcall PerfEvtDeviceReleaseHardwareStart(unsigned __int64 Handle, _GUID *pActivityId)
{
  ...
  if ( (*(_DWORD *)(v5 + 404) & 0xF00000) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DriverFrameworks_KernelMode_PerformanceEnableBits[0] & 1) != 0 )
      McTemplateK0pp(v8, &FX_POWER_HW_RELEASE_START, pActivityId, v7, (const void *)Handle);
  }
  return v6;
}
