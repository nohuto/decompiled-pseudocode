/*
 * XREFs of ?LoadReflectorServiceAndOpenInterfaceLocked@FxCompanionLibrary@@AEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C0044A4C
 * Callers:
 *     ?OpenCompanionLibraryInterface@FxCompanionLibrary@@AEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C0044D48 (-OpenCompanionLibraryInterface@FxCompanionLibrary@@AEAAJPEAU_FX_DRIVER_GLOBALS@@@Z.c)
 * Callees:
        ...
        _FX_DRIVER_GLOBALS *DriverGlobals)
{
  ...
  rdNonPnPFile = 0LL;
  rdNonPnPDevice = 0LL;
  *(_DWORD *)&wudfRdNonPnPSvcName.Length = 7733364;
  *(_DWORD *)&unicodeDeviceName.Length = 7602290;
