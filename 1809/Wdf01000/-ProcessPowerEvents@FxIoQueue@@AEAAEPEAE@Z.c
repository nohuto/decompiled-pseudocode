/*
 * XREFs of ?ProcessPowerEvents@FxIoQueue@@AEAAEPEAE@Z @ 0x1C0013650
 * Callers:
 ...
 *     ?Invoke@FxIoQueueIoStop@@QEAAXPEAUWDFQUEUE__@@PEAUWDFREQUEST__@@K@Z @ 0x1C0014790 (-Invoke@FxIoQueueIoStop@@QEAAXPEAUWDFQUEUE__@@PEAUWDFREQUEST__@@K@Z.c)
 *     ?SetVerifierFlags@FxRequestBase@@QEAAXF@Z @ 0x1C004B860 (-SetVerifierFlags@FxRequestBase@@QEAAXF@Z.c)
 *     ?Invoke@FxIoQueueIoResume@@QEAAXPEAUWDFQUEUE__@@PEAUWDFREQUEST__@@@Z @ 0x1C0078E40 (-Invoke@FxIoQueueIoResume@@QEAAXPEAUWDFQUEUE__@@PEAUWDFREQUEST__@@@Z.c)
 */
  ...
  switch ( this->m_PowerState )
  {
    ...
    case FxIoQueuePowerStoppingNotifyingDriver:
      ...
      if ( _mm_srli_si128((__m128i)stopCallback, 8).m128i_u64[0] && !v23->m_Canceled )
      {
        ...
        {
          while ( ($A3173470F8A533D5F67D6DF0520578B2 *)v25[-1].m_IoPkgListNode.m_ListEntry.Blink != &v23->120 )
          {
...
LABEL_83:
          ...
          {
            while ( ($A3173470F8A533D5F67D6DF0520578B2 *)v47[-1].m_IoPkgListNode.m_ListEntry.Blink != &v45->120 )
            {
...
LABEL_29:
    ...
    case FxIoQueuePowerRestartingNotifyingDriver:
      ...
      {
        v66 = (WDFREQUEST__ *)((unsigned __int64)v65 ^ 0xFFFFFFFFFFFFFFF8uLL);
        ...
        if ( !this->m_ObjectSize )
          v67 = 0LL;
        FxIoQueueIoResume::Invoke(&resumeCallback, v67, v66);
