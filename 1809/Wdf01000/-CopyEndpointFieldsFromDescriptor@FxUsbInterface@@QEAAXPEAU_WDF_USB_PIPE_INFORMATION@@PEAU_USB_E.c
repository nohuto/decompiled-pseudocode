/*
 * XREFs of ?CopyEndpointFieldsFromDescriptor@FxUsbInterface@@QEAAXPEAU_WDF_USB_PIPE_INFORMATION@@PEAU_USB_ENDPOINT_DESCRIPTOR@@E@Z @ 0x1C0073F54
 * Callers:
 *     ?GetEndpointInformation@FxUsbInterface@@QEAAXEEPEAU_WDF_USB_PIPE_INFORMATION@@@Z @ 0x1C0074448 (-GetEndpointInformation@FxUsbInterface@@QEAAXEEPEAU_WDF_USB_PIPE_INFORMATION@@@Z.c)
 * Callees:
        ...
        unsigned __int8 SettingIndex)
{
  ...
  *(_DWORD *)(v5 + 12) = v4;
  if ( v4 == 1 )
    ...
    v8 = (*(_DWORD *)(*(_QWORD *)(v7 + 120) + 484LL) & 4) != 0 ? 0x200000 : 0x40000;
  *(_DWORD *)(v5 + 16) = v8;
  *(_BYTE *)(v5 + 10) = v6;
}
