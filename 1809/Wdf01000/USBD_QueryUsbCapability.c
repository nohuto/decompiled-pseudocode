/*
 * XREFs of USBD_QueryUsbCapability @ 0x1C0091E94
 * Callers:
 *     ?QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z @ 0x1C00759E4 (-QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C001A980 (__security_check_cookie.c)
 *     memset @ 0x1C001C1C0 (memset.c)
 *     USBDInternal_BuildandSendIoctlSynchronously @ 0x1C0091424 (USBDInternal_BuildandSendIoctlSynchronously.c)
 */
