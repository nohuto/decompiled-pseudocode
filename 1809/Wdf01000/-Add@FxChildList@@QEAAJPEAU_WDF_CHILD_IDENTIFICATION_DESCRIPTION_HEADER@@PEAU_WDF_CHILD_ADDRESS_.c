/*
 * XREFs of ?Add@FxChildList@@QEAAJPEAU_WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER@@PEAU_WDF_CHILD_ADDRESS_DESCRIPTION_HEADER@@PEAK@Z @ 0x1C003C918
 * Callers:
 ...
 *     ?DuplicateAddress@FxChildList@@IEAAJPEAU_WDF_CHILD_ADDRESS_DESCRIPTION_HEADER@@0@Z @ 0x1C003D1A0 (-DuplicateAddress@FxChildList@@IEAAJPEAU_WDF_CHILD_ADDRESS_DESCRIPTION_HEADER@@0@Z.c)
 *     ?DuplicateId@FxChildList@@IEAAJPEAU_WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER@@0@Z @ 0x1C003D1F8 (-DuplicateId@FxChildList@@IEAAJPEAU_WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER@@0@Z.c)
        ...
        if ( v18->Flink == &this->m_ModificationListHead )
        {
          ...
          *(_QWORD *)(v17 + 48) = v18;
          ...
          if ( this->m_StaticList )
          {
            ...
            *(_QWORD *)(*(_QWORD *)(v20 + 648) + 1616LL) = v17;
            *(_BYTE *)(*(_QWORD *)(v20 + 648) + 1690LL) = 1;
          }
          goto LABEL_25;
        }
      }
