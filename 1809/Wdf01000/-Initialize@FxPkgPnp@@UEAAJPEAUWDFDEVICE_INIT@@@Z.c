/*
 * XREFs of ?Initialize@FxPkgPnp@@UEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C0083680
 * Callers:
...
LABEL_13:
      ...
      if ( result >= 0 )
      {
        ...
        if ( v13 >= 0 )
        {
          FxObject::AddRef(v14, this, 561, "minkernel\\wdf\\framework\\shared\\irphandlers\\pnp\\fxpkgpnp.cpp");
          ...
          if ( result >= 0 )
          {
            ...
            if ( v20 >= 0 )
            {
              FxObject::AddRef(v21, this, 590, "minkernel\\wdf\\framework\\shared\\irphandlers\\pnp\\fxpkgpnp.cpp");
