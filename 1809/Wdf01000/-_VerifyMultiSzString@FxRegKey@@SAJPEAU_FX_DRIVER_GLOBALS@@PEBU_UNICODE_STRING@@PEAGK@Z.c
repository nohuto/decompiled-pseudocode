/*
 * XREFs of ?_VerifyMultiSzString@FxRegKey@@SAJPEAU_FX_DRIVER_GLOBALS@@PEBU_UNICODE_STRING@@PEAGK@Z @ 0x1C00631C0
 * Callers:
 ...
 *     FxVerifierReadObjectDebugInfo @ 0x1C005A674 (FxVerifierReadObjectDebugInfo.c)
