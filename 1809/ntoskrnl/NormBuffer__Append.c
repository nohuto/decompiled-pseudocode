/*
 * XREFs of NormBuffer__Append @ 0x1402F4C9C
 * Callers:
 *     NormBuffer__AppendEx @ 0x1402F4D68 (NormBuffer__AppendEx.c)
 *     Normalization__Normalize @ 0x140898A98 (Normalization__Normalize.c)
