/*
 * XREFs of ObpInsertOrLocateNamedObject @ 0x1405C85A8
 * Callers:
  ...
  *(_QWORD *)Revision = v12;
  ...
  if ( Object != v44 )
  {
    ...
    else
    {
      ...
      *(_DWORD *)(a4 + 16) = v27;
      LOBYTE(v26) = a5;
      ObjectSecurity = ObpGrantAccess(1, v18, (struct _ACCESS_STATE *)a4, v26, *a6, v42);
      if ( ObjectSecurity < 0 )
      {
        if ( v19 )
          ObpDereferenceNamedObject((__int64)v19);
  ...
  if ( **(_QWORD **)Revision )
  {
    if ( (*(_DWORD *)(v22 + 336) & 8) != 0 || ObpObjectSecurityInheritance )
      LODWORD(Object) = 3;
    ObjectSecurity = ObpGetObjectSecurity(v22, &v39, MemoryAllocated);
    if ( ObjectSecurity < 0 )
      goto LABEL_55;
    v19 = v39;
...
LABEL_13:
    ...
    ObjectSecurity = ObpAssignSecurity(
                       ...
                       (_DWORD)v19,
                       (_DWORD)v44,
                       ObTypeIndexTable[(unsigned __int8)(ObHeaderCookie ^ v45 ^ *(v44 - 24))],
                       (_DWORD)Object,
                       v22);
    if ( v19 )
    {
