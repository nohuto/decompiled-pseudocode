 ...
 *     KiForegroundTimerCallback @ 0x14012DB90 (KiForegroundTimerCallback.c)
 *     KiEntropyQueueDpc @ 0x14012F4A0 (KiEntropyQueueDpc.c)
 *     ExpTimeRefreshCallback @ 0x14016A060 (ExpTimeRefreshCallback.c)
 ...
 *     KiEpfCompletionIsr @ 0x14029BE10 (KiEpfCompletionIsr.c)
 *     PpmPerfControlActionCallback @ 0x1402DB330 (PpmPerfControlActionCallback.c)
 *     PpmHeteroDispatchHgsInterrupt @ 0x1402E3BB0 (PpmHeteroDispatchHgsInterrupt.c)
 *     ExpSvmFaultRoutine @ 0x14031E530 (ExpSvmFaultRoutine.c)
 *     WheaDeferredRecoveryService @ 0x140320CC0 (WheaDeferredRecoveryService.c)
      ...
      else if ( *(_QWORD *)(v13 + 8) != *(_QWORD *)(v13 + 24) || *(_BYTE *)(v13 + 7) )
      {
          ...
          && KiVpThreadSystemWorkPriority >= 8 )
        {
          ...
          if ( (v43 & 0x40000) != 0 && (unsigned __int8)v43 < v32 )
          {
            ...
            if ( v44 )
              LODWORD(v46) = (unsigned __int8)byte_140545541[2 * (unsigned int)v46] | ((unsigned __int8)HvlpVirtualProcessorMapping[2 * v46] << 6);
            v45[2] = v46;
            v24 = 0LL;
