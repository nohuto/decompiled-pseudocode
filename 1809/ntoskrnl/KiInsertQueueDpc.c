 ...
 *     KiForegroundTimerCallback @ 0x14012DB70 (KiForegroundTimerCallback.c)
 *     KiEntropyQueueDpc @ 0x14012F480 (KiEntropyQueueDpc.c)
 *     ExpTimeRefreshCallback @ 0x14016A040 (ExpTimeRefreshCallback.c)
 ...
 *     KiEpfCompletionIsr @ 0x14029BD10 (KiEpfCompletionIsr.c)
 *     PpmPerfControlActionCallback @ 0x1402DB230 (PpmPerfControlActionCallback.c)
 *     PpmHeteroDispatchHgsInterrupt @ 0x1402E3AB0 (PpmHeteroDispatchHgsInterrupt.c)
 *     ExpSvmFaultRoutine @ 0x14031E430 (ExpSvmFaultRoutine.c)
 *     WheaDeferredRecoveryService @ 0x140320BC0 (WheaDeferredRecoveryService.c)
