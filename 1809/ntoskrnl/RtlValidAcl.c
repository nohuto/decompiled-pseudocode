 ...
 * Callees:
 *     RtlpValidAttributeAce @ 0x1406C33FC (RtlpValidAttributeAce.c)
 *     RtlpValidAccessFilterAce @ 0x14089331C (RtlpValidAccessFilterAce.c)
 *     RtlpValidCompoundAce @ 0x140893520 (RtlpValidCompoundAce.c)
 *     RtlpValidObjectAce @ 0x14089359C (RtlpValidObjectAce.c)
 */
