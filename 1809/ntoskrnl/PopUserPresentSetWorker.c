/*
 * XREFs of PopUserPresentSetWorker @ 0x14071F120
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall PopUserPresentSetWorker(unsigned int a1, char a2)
{
  ...
  if ( byte_140418111 )
  {
    _InterlockedExchange(&dword_140418118, 1);
    KeInitializeDpc(&PopAwayModeUserPresenceDpcObject, (PKDEFERRED_ROUTINE)PopAwayModeUserPresenceDpc, &dword_140418118);
  ...
  result = _InterlockedCompareExchange(&dword_140418114, 0, 0);
  if ( result )
