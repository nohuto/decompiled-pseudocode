/*
 * XREFs of PspDisassociateUmsThreadFromPrimary @ 0x14088EDF0
 * Callers:
 *     PspUmsUnInitThread @ 0x14088AE74 (PspUmsUnInitThread.c)
 *     PspRelinquishUmsThreadSpecialApc @ 0x14088F110 (PspRelinquishUmsThreadSpecialApc.c)
 * Callees:
 ...
 *     KeDoesTebMatchThread @ 0x14029F8CC (KeDoesTebMatchThread.c)
 *     KeGetCurrentUmsTeb @ 0x14029F8E8 (KeGetCurrentUmsTeb.c)
 ...
 *     KeRemoveUmsThreadCidOwnership @ 0x14084542C (KeRemoveUmsThreadCidOwnership.c)
 ...
 *     KeFixUserSwitchContext @ 0x140846A28 (KeFixUserSwitchContext.c)
...
LABEL_10:
    ...
    else
    {
      ...
      RtlGetExtendedContextLength((unsigned int)(v14 + 1048603));
      v15 = (unsigned int)v26 + 15LL;
      if ( v15 <= (unsigned int)v26 )
        v15 = 0xFFFFFFFFFFFFFF0LL;
      v16 = alloca(v15 & 0xFFFFFFFFFFFFFFF0uLL);
      memset(&v26, 0, (unsigned int)v26);
      RtlInitializeExtendedContext((__int64)&v26, v14 + 1048603);
      v17 = v27 - 1232;
      v26 = v27 - 1232;
      PspGetContextThreadInternal((__int64)Thread, v27 - 1232, 0, 1, 1);
      v27 = **(_QWORD **)(Object + 496);
      v18 = v27;
      KeFixUserSwitchContext(Object, v27, 0LL, v17);
