/*
 * XREFs of PerfDiagpSaveActiveDCLLogFileName @ 0x1408B0C30
 * Callers:
...
void PerfDiagpSaveActiveDCLLogFileName()
{
  ...
  if ( ValueData )
  {
    ...
    wcscpy(&xmmword_14040A76C, L"WdiContextLog");
    dword_14040A7DC = 0x20000;
    RtlInitUnicodeString(&DestinationString, &xmmword_14040A76C);
    qword_14040A838 = (__int64)ValueData;
    word_14040A832 = 520;
    dword_14040A7B0[0] = 176;
    if ( (int)NtTraceControl(3u, dword_14040A7B0, 0xB0u, dword_14040A7B0, 0xB0u, &v2) < 0
      || (unsigned __int16)word_14040A830 < 2u )
    {
      RtlDeleteRegistryValue(2u, L"Diagnostics\\Performance", L"ActiveShutdownDCL");
    }
    else
    {
      v1 = (unsigned __int16)word_14040A830 >> 1;
      ValueData[v1] = 0;
