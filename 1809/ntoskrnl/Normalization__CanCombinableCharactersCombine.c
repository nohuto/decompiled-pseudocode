/*
 * XREFs of Normalization__CanCombinableCharactersCombine @ 0x140897E5C
 * Callers:
 *     NormBuffer__LastStartBasePair @ 0x1402F4F0C (NormBuffer__LastStartBasePair.c)
 *     NormBuffer__RecheckStartCombinations @ 0x1402F4F58 (NormBuffer__RecheckStartCombinations.c)
 *     Normalization__CanCombineWithStartBase @ 0x140897FC0 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x14089800C (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__IsNormalized @ 0x1408983F4 (Normalization__IsNormalized.c)
