/*
 * XREFs of NtQueryInformationFile @ 0x14063AA10
 * Callers:
 ...
 *     RtlIsPartialPlaceholderFileHandle @ 0x140897B70 (RtlIsPartialPlaceholderFileHandle.c)
 * Callees:
 ...
 *     IopGetModeInformation @ 0x1406A4FD8 (IopGetModeInformation.c)
