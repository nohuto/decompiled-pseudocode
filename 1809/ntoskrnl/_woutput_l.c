/*
 * XREFs of _woutput_l @ 0x140198400
 * Callers:
 ...
 *     _safecrt_mbtowc @ 0x140196150 (_safecrt_mbtowc.c)
 *     write_char @ 0x140198D1C (write_char.c)
 *     write_multi_char @ 0x140198D70 (write_multi_char.c)
 *     write_string @ 0x140198DC8 (write_string.c)
 *     _get_printf_count_output @ 0x140199DEC (_get_printf_count_output.c)
 */
...
LABEL_119:
                    ...
                    v46 = v68 - v12 - v9;
                    if ( (v7 & 0xC) == 0 )
                      write_multi_char(32LL, v46, v64, &v60);
                    write_string(v67, v9, v45, &v60);
                    v47 = v64;
                    if ( (v7 & 0xC) == 8 )
                      write_multi_char(48LL, v46, v64, &v60);
                    if ( v63 || (int)v12 <= 0 )
                    {
                      write_string(v13, (unsigned int)v12, v47, &v60);
LABEL_134:
                      v11 = v60;
                    }
                    else
                    {
                      ...
                      {
                        --v49;
                        v50 = safecrt_mbtowc(&v66, v48, _mb_cur_max);
                        v51 = v50;
                        if ( v50 == 2 )
                          --v49;
                        if ( v50 <= 0 )
                          break;
                        write_char(v66, v64, &v60);
                        v48 += v51;
                        if ( v49 <= 0 )
                        {
                          v9 = v61;
                    ...
                    if ( v11 >= 0 && (v7 & 4) != 0 )
                    {
                      write_multi_char(32LL, v46, v47, &v60);
                      v11 = v60;
                    }
                    v8 = v62;
                    goto LABEL_166;
