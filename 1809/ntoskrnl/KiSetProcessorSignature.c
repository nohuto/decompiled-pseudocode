  ...
  while ( 1 )
  {
    ...
    if ( (v21 & 2) == 0 )
    {
      if ( !HIBYTE(v21) || (v22 = HIBYTE(v21), _bittest((const int *)&v22, *(unsigned __int8 *)(a1 + 141))) )
      {
        ...
        v28 = 0;
        v29 = *(int *)((char *)&unk_14035A9AC + v20);
        v30 = *(unsigned int *)((char *)&unk_14035A9A8 + v20);
        if ( ((unsigned int)v30 & *((_DWORD *)&v56 + v29)) == 0 )
        {
          if ( (v21 & 8) == 0
            || (v15 & *(_QWORD *)((_BYTE *)&unk_14035A9B8 + v20)) != *(_QWORD *)((char *)&unk_14035A9B8 + v20) )
          {
            if ( (v21 & 0x10) != 0
              && (BugCheckParameter2 & *(_QWORD *)((_BYTE *)&unk_14035A9B8 + v20)) == *(_QWORD *)((char *)&unk_14035A9B8
                                                                                                + v20) )
            {
              v28 = 1;
            }
            if ( !v28 )
            {
              if ( (v21 & 1) != 0 )
              {
                if ( !*(_DWORD *)(a1 + 36) )
                {
                  ...
                  LODWORD(v29) = *(_DWORD *)((char *)&unk_14035A9AC + v20);
                  v30 = *(unsigned int *)((char *)&unk_14035A9A8 + v20);
                }
              ...
              if ( (v21 & 4) != 0 && *(_DWORD *)(a1 + 36) )
              {
                ...
                if ( (v21 & 8) != 0 )
                {
                  LOBYTE(v31) = (KeFeatureBits & *(_QWORD *)((_BYTE *)&unk_14035A9B8 + v20)) == *(_QWORD *)((char *)&unk_14035A9B8 + v20);
                }
                else if ( (v21 & 0x10) != 0
                       && (KeFeatureBits2 & *(_QWORD *)((_BYTE *)&unk_14035A9B8 + v20)) == *(_QWORD *)((char *)&unk_14035A9B8 + v20) )
                {
LABEL_95:
                  KeBugCheckEx(
                    0x5Du,
        ...
        if ( (v21 & 8) != 0 )
        {
          v55 = *(_QWORD *)((char *)&unk_14035A9B8 + v20) | v15;
        }
        else if ( (v21 & 0x10) != 0 )
        {
          v16 = *(_QWORD *)((char *)&unk_14035A9B8 + v20) | BugCheckParameter2;
...
LABEL_33:
        ...
        if ( (v21 & 8) != 0 )
        {
          LOBYTE(v32) = (KeFeatureBits & *(_QWORD *)((_BYTE *)&unk_14035A9B8 + v20)) == *(_QWORD *)((char *)&unk_14035A9B8
                                                                                                  + v20);
        }
        else if ( (v21 & 0x10) != 0
               && (KeFeatureBits2 & *(_QWORD *)((_BYTE *)&unk_14035A9B8 + v20)) == *(_QWORD *)((char *)&unk_14035A9B8
                                                                                             + v20) )
        {
LABEL_42:
          v16 = BugCheckParameter2;
LABEL_43:
        ...
        if ( !v32 )
          KeBugCheckEx(
            ...
            0xFFFFFFFDuLL,
            *(unsigned int *)((char *)&KiCpuFeatureTable + v20),
            *(unsigned int *)((char *)&unk_14035A9A8 + v20),
            *(int *)((char *)&unk_14035A9AC + v20));
        goto LABEL_42;
      }
    }
...
LABEL_83:
  ...
  while ( *(_DWORD *)((char *)&KiCpuTable + v48) != *(unsigned __int8 *)(a1 + 141)
       || *(_DWORD *)((char *)&unk_14036A8A4 + v48) != a2 )
  {
    v46 = (unsigned int)(v46 + 1);
    v47 = (unsigned int)v46;
    v48 = 20 * v46;
    if ( *((_DWORD *)&unk_14036A8A8 + 5 * v46) == 19 )
      goto LABEL_90;
  }
  *(_DWORD *)(a1 + 1740) = dword_14036A8B0[5 * v47];
LABEL_90:
