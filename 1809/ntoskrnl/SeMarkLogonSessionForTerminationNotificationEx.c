/*
 * XREFs of SeMarkLogonSessionForTerminationNotificationEx @ 0x1406D0130
 * Callers:
 *     SeMarkLogonSessionForTerminationNotification @ 0x1406D0110 (SeMarkLogonSessionForTerminationNotification.c)
 * Callees:
