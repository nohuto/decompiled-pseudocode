/*
 * XREFs of VfPnpVerifyIrpStackDownward @ 0x140941620
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)result )
  {
    ...
    if ( *(__int64 (__fastcall **)(__int64, IRP *))(v15 + 328) == IopInvalidDeviceRequest )
    {
      *(_DWORD *)(a5 + 4) |= 0x1000000u;
      ...
      ViErrorReport1(0x21Fu, PristineDriverInit, v13);
      result = a6;
    ...
    if ( a3 )
    {
      if ( v14 < 0 )
      {
        if ( v14 == -1073741637 )
        {
          ...
          {
            result = ViErrorReport1(0x216u, a7, v13);
            *(_DWORD *)(a5 + 4) |= 0x2000000u;
          }
        }
        else if ( (*(_DWORD *)(a5 + 4) & 0x2000000) == 0 )
        {
          result = ViErrorReport1(0x215u, a7, v13);
          *(_DWORD *)(a5 + 4) |= 0x2000000u;
        }
      }
      if ( *(_QWORD *)(v12 + 48) )
