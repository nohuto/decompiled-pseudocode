/*
 * XREFs of PspSendReliableJobNotification @ 0x1406BA958
 * Callers:
...
__int64 __fastcall PspSendReliableJobNotification(PVOID Object, unsigned int a2)
{
  ...
  do
  {
    ...
    if ( (result & 8) == 0 )
      v7 = v4;
    v9 = result;
    result = (unsigned int)_InterlockedCompareExchange((volatile signed __int32 *)Object + 326, result | v7, result);
  }
