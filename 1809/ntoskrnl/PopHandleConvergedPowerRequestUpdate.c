/*
 * XREFs of PopHandleConvergedPowerRequestUpdate @ 0x140589D88
 * Callers:
 *     PopExecutionRequiredCallback @ 0x140588DE0 (PopExecutionRequiredCallback.c)
 *     PopSystemRequiredCallback @ 0x140589A00 (PopSystemRequiredCallback.c)
 * Callees:
