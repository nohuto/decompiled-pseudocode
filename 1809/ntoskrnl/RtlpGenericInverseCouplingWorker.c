/*
 * XREFs of RtlpGenericInverseCouplingWorker @ 0x1402F8054
 * Callers:
 *     RtlScrubMemory @ 0x1402F7D8C (RtlScrubMemory.c)
 * Callees:
 *     RtlpTestAndFillMemoryUp @ 0x1402F88FC (RtlpTestAndFillMemoryUp.c)
 *     RtlpTestMemory @ 0x1402F8924 (RtlpTestMemory.c)
 */
