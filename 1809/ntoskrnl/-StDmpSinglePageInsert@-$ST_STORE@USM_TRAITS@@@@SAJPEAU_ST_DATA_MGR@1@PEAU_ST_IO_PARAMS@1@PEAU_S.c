/*
 * XREFs of ?StDmpSinglePageInsert@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_IO_PARAMS@1@PEAU_ST_PAGE_RECORD@1@@Z @ 0x14014900C
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmpSinglePageInsert(__int64 a1, _DWORD *a2, __int64 a3)
{
  ...
  *(_DWORD *)(a1 + 184) = v11 & 0xFFFFFFFE;
  ...
  v26 = (unsigned __int64)((unsigned int)a3 - ((a3 & 0xFFFFF000) + *(_DWORD *)(a1 + 472))) / *(_DWORD *)(a1 + 464)
  ...
  if ( v13 >= 0 )
  {
    ...
    if ( !*(_BYTE *)(a1 + 776) )
    {
      v15 = *(_DWORD *)(a3 + 4) + 4096;
      *(_DWORD *)(a3 + 4) = v15;
      if ( (v15 & 0xFFFFF000) > 0x1000 )
        return 0;
      if ( v15 < 0x1000 )
        __int2c();
    }
