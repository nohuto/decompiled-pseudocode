/*
 * XREFs of BgpFwLibraryInitialize @ 0x14094F95C
 * Callers:
 ...
 *     BgpFwInitializeLock @ 0x1409FB9D0 (BgpFwInitializeLock.c)
 */
...
__int64 __fastcall BgpFwLibraryInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( (dword_140405AD0 & 1) != 0 && (dword_140405AD0 & 4) == 0 && (*(_DWORD *)(a1 + 120) & 0x100000) == 0 )
    return 3221225485LL;
  if ( (*(_DWORD *)(a1 + 120) & 0x100000) != 0 )
  {
    ...
    if ( a2 == -1 )
    {
      ...
      if ( v39 )
      {
        ...
        qword_140405B98 = ResFwConfigureDisplayStringResources(*(_QWORD *)(a1 + 256));
        qword_140405B90 = AnFwConfigureProgressResources(*(int **)(a1 + 264));
      }
      else
      {
        qword_140405B98 = 0LL;
  ...
  if ( a2 == -1 )
  {
    dword_140405AD0 = BgpFwInitializeLock(0x100000LL) | 0xC04;
    qword_140405BA8 = (__int64)&qword_140405BA0;
    qword_140405BA0 = (__int64)&qword_140405BA0;
    v40 = *(_QWORD *)(a1 + 240);
    if ( !v40 || !*(_DWORD *)(a1 + 248) )
      return 3221225626LL;
    BgpFwInitializeReservePool(v40, 0x4000LL, &unk_1404DB4D0);
    v5 = BgpFwLibraryEnable(a1 + 32);
    if ( v5 < 0 )
      goto LABEL_59;
    xmmword_140405B08 = *(_OWORD *)(a1 + 100);
    if ( *(_QWORD *)(a1 + 88) )
    {
    ...
    if ( *(_DWORD *)(a1 + 116) >= 3u )
    {
      qword_140405C50 = *(_QWORD *)(a1 + 404);
      dword_140405C58 = *(_DWORD *)(a1 + 412);
    }
    dword_140405C38 = *(_DWORD *)(a1 + 400);
  ...
  if ( v5 >= 0 )
  {
    *(PHYSICAL_ADDRESS *)&xmmword_140405AB0 = MmGetPhysicalAddress(qword_140405A80);
    DWORD2(xmmword_140405AB0) = DWORD2(BgInternal);
    HIDWORD(xmmword_140405AB0) = DWORD1(BgInternal);
    LODWORD(xmmword_140405AC0) = HIDWORD(BgInternal);
    if ( (_DWORD)xmmword_140405A70 == 4 )
    {
      DWORD2(xmmword_140405AC0) = 3;
    }
    else if ( (_DWORD)xmmword_140405A70 == 5 )
    {
      DWORD2(xmmword_140405AC0) = 4;
    }
    else
    {
      DWORD2(xmmword_140405AC0) = 0;
    }
    v6 = 0;
    v7 = 416;
    v8 = 0;
    xmmword_140405BB0 = *(_OWORD *)(a1 + 272);
    v9 = 0;
    xmmword_140405BC0 = *(_OWORD *)(a1 + 288);
    xmmword_140405BD0 = *(_OWORD *)(a1 + 304);
    xmmword_140405BE0 = *(_OWORD *)(a1 + 320);
    xmmword_140405BF0 = *(_OWORD *)(a1 + 336);
    xmmword_140405C00 = *(_OWORD *)(a1 + 352);
    xmmword_140405C10 = *(_OWORD *)(a1 + 368);
    xmmword_140405C20 = *(_OWORD *)(a1 + 384);
    if ( *(_QWORD *)(a1 + 72) )
    {
      v8 = 2;
      v9 = *(_DWORD *)(a1 + 84);
    ...
    if ( v15 )
    {
      ...
      *((_QWORD *)v16 + 54) = v21;
      dword_140405AD0 |= 0x800u;
      v22 = BgpFoInitialize(v16 + 26, 1LL);
      dword_140405AD0 &= ~0x800u;
      if ( v22 >= 0 )
        qword_140405B80 = (__int64)(v16 + 26);
      if ( !qword_140405B80 )
LABEL_76:
      ...
      memset(&qword_140405B18, 0, 0x58uLL);
      if ( *(_QWORD *)(a1 + 144) )
      {
        ...
        if ( v25 )
        {
          ...
          qword_140405B2C = *(_QWORD *)(a1 + 164);
        }
      }
      v26 = *(_QWORD *)(a1 + 184);
      if ( v26 && (int)BgpGxProcessQrCodeBitmap(v26, &qword_140405B58) < 0 )
        qword_140405B58 = 0LL;
      v27 = *(_QWORD *)(a1 + 216);
      if ( v27 )
      {
...
LABEL_35:
          ...
          v32 = *(_DWORD *)(a1 + 400);
          dword_140405AD0 |= 0x8000u;
          dword_140405C38 = v32;
          BgpBcInitializeCriticalMode(a1, a2);
          dword_140405AD0 = dword_140405AD0 & 0xFFFF77FF | 0x800;
          ...
          qword_140405B90 = AnFwConfigureProgressResources(*(int **)(a1 + 264));
          v37 = *(_DWORD *)(a1 + 124);
          dword_140405AD0 |= v4 | 0x80;
          dword_140405AD4 = v37;
          BgpFwReleaseLock();
          qword_140405B70 = *(_QWORD *)(a1 + 232);
LABEL_49:
          dword_140405AD0 |= 1u;
          v5 = 0;
          goto LABEL_50;
