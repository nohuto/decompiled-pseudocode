/*
 * XREFs of PopBatteryCheckCompositeCapacity @ 0x14071B88C
 * Callers:
...
LABEL_4:
  ...
  LODWORD(v14) = 100000;
  if ( HIDWORD(qword_140418A00) > (unsigned int)v13 )
  {
    if ( HIDWORD(qword_140418A00) )
      v14 = 100000 * v13 / (unsigned __int64)HIDWORD(qword_140418A00);
    else
      LODWORD(v14) = 0;
  }
  v15 = 0;
  if ( dword_140418B30 != -1 )
    v15 = v14 - dword_140418B30;
  v16 = ((int)v14 + 500) / 0x3E8u;
  v17 = (dword_140418B30 + 500) / 0x3E8u;
  if ( v16 != v17 )
    *a3 = v16 - v17;
  v6 = byte_140418B44;
  LOBYTE(v7) = byte_140418B28;
  dword_140418B30 = v14;
  if ( a2 == 1 )
  {
    v6 = 0;
...
LABEL_20:
  ...
  v18 = dword_140418B40;
  if ( dword_140418B40 < (unsigned int)v14 )
  {
    v18 = v14;
    dword_140418B40 = v14;
  }
  ...
  if ( byte_140418B44 != v6 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
      {
        ...
        v37 = (unsigned __int8)byte_140418B44;
        v38 = dword_1404189B4;
        if ( (v20 & 1) == 0 )
          v21 = "DC Power";
        ...
        if ( HIDWORD(qword_140418A00) )
        {
          v34 = (unsigned int)((HIDWORD(qword_140418A00) >> 1) + 100 * v22) / HIDWORD(qword_140418A00);
          v27 = 100000 * v22 / (unsigned __int64)HIDWORD(qword_140418A00);
        }
        else
        {
          v34 = 0;
        ...
        v68 = 4LL;
        v70 = 4LL;
        TlgWrite(&pCallbackContext, &unk_14036FB5A, 0LL, 0LL, 0x10u, &pData);
      }
    }
  }
  if ( byte_140418B28 != (_BYTE)v7 )
  {
    byte_140418B28 = v7;
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
      {
        ...
        v42 = (unsigned __int8)byte_140418B28;
        v41 = dword_1404189B4;
        if ( (v30 & 1) == 0 )
          v8 = "DC Power";
        if ( (v30 & 2) == 0 )
        ...
        if ( HIDWORD(qword_140418A00) )
        {
          v34 = (unsigned int)((HIDWORD(qword_140418A00) >> 1) + 100 * v31) / HIDWORD(qword_140418A00);
          v32 = 100000 * v31 / (unsigned __int64)HIDWORD(qword_140418A00);
        }
        else
        {
          v34 = 0;
        ...
        v68 = v33;
        v70 = v33;
        TlgWrite(&pCallbackContext, &unk_14036FEA8, 0LL, 0LL, 0x10u, &pData);
      }
    }
  }
}
