/*
 * XREFs of EtwpReferenceStackLookasideList @ 0x1408B8328
 * Callers:
...
_SLIST_ENTRY *EtwpReferenceStackLookasideList()
{
  ...
  v0 = 2 * KeNumberProcessors_0 * _InterlockedIncrement(&dword_140440AA0);
  do
  {
    ...
    result = (_SLIST_ENTRY *)(unsigned int)_InterlockedIncrement(&dword_140440AA4);
  }
  while ( (int)result < v0 );
  return result;
}
