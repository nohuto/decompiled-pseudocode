/*
 * XREFs of WdipSemReserveInstanceTableEntry @ 0x140716788
 * Callers:
 ...
 *     WdipSemQueryEnabledInstanceTable @ 0x140717698 (WdipSemQueryEnabledInstanceTable.c)
...
_QWORD *__fastcall WdipSemReserveInstanceTableEntry(__int64 a1, __int64 a2)
{
  ...
  if ( a1 && a2 )
  {
    if ( (unsigned int)dword_14040CAF0 >= 0x80 )
    {
    ...
    else if ( !WdipSemQueryEnabledInstanceTable(a2) )
    {
      ...
      if ( v3 )
      {
        v6 = (_QWORD *)qword_14040CAE8;
        if ( *(__int64 **)qword_14040CAE8 != &WdipSemEnabledInstanceTable )
          __fastfail(3u);
        *v3 = &WdipSemEnabledInstanceTable;
        v3[1] = v6;
        *v6 = v3;
        ++dword_14040CAF0;
        qword_14040CAE8 = (__int64)v3;
      }
    }
  }
