/*
 * XREFs of WdipSemReserveInstanceTableEntry @ 0x1407167A8
 * Callers:
...
_QWORD *__fastcall WdipSemReserveInstanceTableEntry(__int64 a1, __int64 a2)
{
  ...
  if ( a1 && a2 )
  {
    if ( (unsigned int)dword_14040CF30 >= 0x80 )
    {
    ...
    else if ( !WdipSemQueryEnabledInstanceTable(a2) )
    {
      ...
      if ( v3 )
      {
        v6 = (_QWORD *)qword_14040CF28;
        if ( *(__int64 **)qword_14040CF28 != &WdipSemEnabledInstanceTable )
          __fastfail(3u);
        *v3 = &WdipSemEnabledInstanceTable;
        v3[1] = v6;
        *v6 = v3;
        ++dword_14040CF30;
        qword_14040CF28 = (__int64)v3;
      }
    }
  }
