/*
 * XREFs of MiAdjustModifiedPageLoad @ 0x1400F063C
 * Callers:
 ...
 *     MiUpdateReserveClusterInfo @ 0x140188108 (MiUpdateReserveClusterInfo.c)
      ...
      do
      {
        ...
        if ( (*(_BYTE *)(*(_QWORD *)v15 + 204LL) & 0x40) == 0 )
        {
          ...
          if ( *(_DWORD *)(v17 + 132) != *(_DWORD *)(v17 + 128) )
            *(_DWORD *)(v17 + 124) = dword_14054018C;
          *(_DWORD *)(v17 + 136) = 4 * dword_14054018C;
          if ( v14 )
          {
            v24 = *(_BYTE *)(v17 + 207);
            if ( (v24 & 1) != 0 )
