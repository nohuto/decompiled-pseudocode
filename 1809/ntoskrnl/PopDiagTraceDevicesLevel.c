/*
 * XREFs of PopDiagTraceDevicesLevel @ 0x140569874
 * Callers:
...
char __fastcall PopDiagTraceDevicesLevel(int a1, int a2, char a3, char a4)
{
  ...
  if ( a2 )
  {
    v4 = (const EVENT_DESCRIPTOR *)&POP_ETW_EVENT_DEVICESWAKELEVEL_END;
    v5 = (const EVENT_DESCRIPTOR *)&POP_ETW_EVENT_DEVICESWAKELEVEL;
  }
  else
  {
    v4 = &POP_ETW_EVENT_DEVICESSUSPENDLEVEL_END;
    v5 = (const EVENT_DESCRIPTOR *)&POP_ETW_EVENT_DEVICESSUSPENDLEVEL;
  }
  if ( !a4 )
    v5 = v4;
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v9 = &v13;
      v10 = 1;
      LOBYTE(v4) = EtwWrite(v6, v5, 0LL, 2u, &UserData);
    }
  }
  return (char)v4;
}
