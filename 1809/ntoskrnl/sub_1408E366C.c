/*
 * XREFs of sub_1408E366C @ 0x1408E366C
 * Callers:
...
__int64 __fastcall sub_1408E366C(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  __int64 v6; // r13
  signed int v7; // ebx
...
LABEL_165:
          if ( v7 < 0 )
            goto LABEL_205;
          v70 = qword_14096D3E8 ? qword_14096D3E8(v92, P, v94, v57, v55, v95, v62, v6, v68) : -1073741637;
          v7 = v70;
          if ( v70 < 0 )
            goto LABEL_205;
          v71 = -1;
