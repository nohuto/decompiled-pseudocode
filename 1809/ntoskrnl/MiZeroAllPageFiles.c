/*
 * XREFs of MiZeroAllPageFiles @ 0x14057BD54
 * Callers:
...
__int64 MiZeroAllPageFiles()
{
  ...
  KeWaitForSingleObject(&unk_14043CC28, WrKernel, 0, 0, 0LL);
  v0 = Count;
  v1 = Count;
  if ( Count )
  {
    do
    {
      ...
      Object[v2] = v3;
      if ( (*(_BYTE *)(qword_14043E520[v2] + 204LL) & 0x40) != 0
      ...
      {
        PoolWithTag[1].List.Flink = (struct _LIST_ENTRY *)qword_14043E520[v2];
