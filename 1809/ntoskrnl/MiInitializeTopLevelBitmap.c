/*
 * XREFs of MiInitializeTopLevelBitmap @ 0x1409D2E8C
 * Callers:
...
void MiInitializeTopLevelBitmap()
{
  ...
  dword_14043A440 = (unsigned __int8)ExGenRandom(1);
  memset(dword_14043A420, 0, sizeof(dword_14043A420));
  BitMapHeader.SizeOfBitMap = 256;
  BitMapHeader.Buffer = dword_14043A420;
