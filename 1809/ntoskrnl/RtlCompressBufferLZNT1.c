/*
 * XREFs of RtlCompressBufferLZNT1 @ 0x140566C30
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  char v12; // di
  __int64 (__fastcall *v13)(unsigned __int8 *, __int64); // r12
  _WORD *v14; // rbx
  __int64 v15; // r13
  __int64 result; // rax
  ...
  if ( a1 )
  {
    if ( a1 != 256 )
      return 3221225659LL;
    v13 = (__int64 (__fastcall *)(unsigned __int8 *, __int64))LZNT1FindMatchMaximum;
  }
  else
  {
