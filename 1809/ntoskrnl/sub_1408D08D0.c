/*
 * XREFs of sub_1408D08D0 @ 0x1408D08D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1408D08D0(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // eax
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_140705868(a1, a2, a3, a4, 4);
  }
  else
  {
    v16 = -1073741772;
