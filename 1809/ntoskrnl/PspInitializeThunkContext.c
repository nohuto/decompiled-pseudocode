/*
 * XREFs of PspInitializeThunkContext @ 0x1406217DC
 * Callers:
  ...
  *(_QWORD *)&Context[8] = CurrentThread;
  ...
  if ( ExtendedContextLength >= 0 )
  {
    ...
    if ( ExtendedContextLength >= 0 )
    {
      ...
      *(_DWORD *)Context = ExtendedContextLength;
      if ( ExtendedContextLength >= 0 )
      {
        v7 = (CONTEXT *)((*(_QWORD *)&Context[152] - v3) & 0xFFFFFFFFFFFFFFF0uLL);
        *(_QWORD *)&Context[344] = (char *)v7 - 40;
        ...
        ExtendedContextLength = RtlInitializeExtendedContext(v7, v1, (PCONTEXT_EX *)&Context[24]);
        *(_DWORD *)Context = ExtendedContextLength;
        if ( ExtendedContextLength >= 0 )
        {
  ...
  if ( ExtendedContextLength < 0 )
  {
    ...
    *(_QWORD *)&Context[40] = 0LL;
    ...
    return KiDispatchException((PEXCEPTION_RECORD)&Context[32], BaseTrapFrame - 320, v13, 1u, 0);
  }
  return result;
}
