/*
 * XREFs of _woutput_s @ 0x14019CD44
 * Callers:
...
__int64 __fastcall woutput_s(__int64 a1, char *a2, int *a3)
{
  ...
  wchar_t DstCh[72]; // [rsp+70h] [rbp-90h] BYREF
          ...
          if ( v9 != 83 )
          {
            if ( v9 != 88 )
            {
              if ( v9 == 90 )
              {
                ...
                a3 += 2;
                if ( v17 && (v12 = (const char *)*((_QWORD *)v17 + 1)) != 0LL )
                {
                  if ( v17[1] < *v17 )
                    goto LABEL_195;
                  LODWORD(v11) = *v17;
