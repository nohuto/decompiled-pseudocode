/*
 * XREFs of ResFwGetContext @ 0x14094E080
 * Callers:
...
__int64 __fastcall ResFwGetContext(__int64 *a1)
{
  ...
  *a1 = 0LL;
  if ( (v3 & 1) == 0 )
    return 3221225473LL;
  v4 = dword_140405AEC;
  if ( dword_140405AF0 >= (unsigned int)dword_140405AEC )
    v4 = dword_140405AF0;
  v5 = (dword_140405AFC + v4 + dword_140405AF8 + 20479) & 0xFFFFF000;
  ...
  *(_QWORD *)(v10 + 240) = v1;
  BgpAnimationRegionSave = qword_140405B90;
  BgpTextRegionSave = qword_140405B98;
  result = 0LL;
  *a1 = v10;
  return result;
}
