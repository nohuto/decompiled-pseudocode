/*
 * XREFs of sub_1408E4AE4 @ 0x1408E4AE4
 * Callers:
...
__int64 __fastcall sub_1408E4AE4(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  signed int v6; // ebx
...
LABEL_56:
                ...
                if ( 2 * (_DWORD)v28 != -2 )
                {
                  ...
                  v42 = pcbLength;
                  v43 = ((__int64 (__fastcall *)(__int64, size_t, _QWORD, size_t))qword_14096D448)(
                          v41,
                          pcbLength,
                  ...
                  if ( v43 >= 0 )
                  {
                    v43 = qword_14096D3F0 ? qword_14096D3F0(v42) : -1073741637;
                    if ( v43 == -1073741198 )
                      v43 = 0;
                  }
                  *(_DWORD *)(a4 + 4) = 20;
