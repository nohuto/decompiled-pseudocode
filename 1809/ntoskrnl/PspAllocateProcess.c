/*
 * XREFs of PspAllocateProcess @ 0x14064BCD8
 * Callers:
 ...
 *     MmGetSessionSchedulingGroupByProcess @ 0x14064EA40 (MmGetSessionSchedulingGroupByProcess.c)
 ...
 *     PspSelectNodeForProcess @ 0x1406BDB08 (PspSelectNodeForProcess.c)
 *     PoEnergyContextInitialize @ 0x1406C0388 (PoEnergyContextInitialize.c)
 ...
 *     PspInheritQuota @ 0x1406C402C (PspInheritQuota.c)
 *     PspApplyWin32kFilterOptions @ 0x1406C5D5C (PspApplyWin32kFilterOptions.c)
...
LABEL_170:
        ...
        if ( (dword_14055B180 & 0xC) != 0 && !*((_WORD *)v23 + 727) && v91 )
          SmpKeyedStoreCreate((ULONG_PTR)&qword_14055B188);
        if ( (a9 & 0x80u) != 0
