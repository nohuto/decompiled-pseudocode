/*
 * XREFs of sub_140690AA4 @ 0x140690AA4
 * Callers:
...
__int64 __fastcall sub_140690AA4(
        int a1,
        _BYTE *a2,
        char *a3,
        unsigned int a4,
        ...
        _BYTE *a9)
{
  ...
  v18 = *a5;
  if ( a1 )
    sub_140001180((__int64)&v19, a2, a3, a4, v18, a6, a9);
  else
    sub_14010CD90((__int64)&v19, a2, a3, a4, v18, a6, a9);
  return 0LL;
}
