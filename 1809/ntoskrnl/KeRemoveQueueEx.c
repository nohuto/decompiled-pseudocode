 ...
 *     KeRemoveQueue @ 0x140136AF0 (KeRemoveQueue.c)
 *     ExpWorkerFactoryManagerThread @ 0x14017FE80 (ExpWorkerFactoryManagerThread.c)
 *     FsRtlWorkerThread @ 0x1401924C0 (FsRtlWorkerThread.c)
 *     IopPassiveInterruptRealtimeWorker @ 0x1401926C0 (IopPassiveInterruptRealtimeWorker.c)
 *     PopFxEmergencyWorker @ 0x140192DF0 (PopFxEmergencyWorker.c)
 ...
 *     KiTestForAlertPending @ 0x14011F860 (KiTestForAlertPending.c)
 *     KiAttemptFastRemoveQueue @ 0x140127794 (KiAttemptFastRemoveQueue.c)
...
LABEL_197:
    ...
    v77 = (struct _LIST_ENTRY *)KiCommitThreadWait((__int64)CurrentThread, (__int64 *)&CurrentThread->320, v71, v70);
    CurrentThread->WaitReason = 0;
    if ( v77 != (struct _LIST_ENTRY *)256 )
      break;
    i = KeGetCurrentIrql();
    __writecr8(2uLL);
  ...
  *EntryArray = v77;
  if ( Count > 1
    && v77 != (struct _LIST_ENTRY *)128
    && (unsigned __int64)&v77[-17].Blink + 7 > 1
    && v77 != (struct _LIST_ENTRY *)192
    && Queue->Header.SignalState )
  {
