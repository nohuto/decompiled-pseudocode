                  ...
                  *(_BYTE *)(PspCidTable + 44) |= 1u;
                  ...
                  if ( (int)PspInitializeSystemPartitionPhase0() >= 0 )
                  {
                    ...
                    if ( PspCreateProcess((__int64)PspSystemPartition + 112, 0x1FFFFF, 0LL, 0LL, 0, 0, 0LL, 0LL, 0LL) >= 0 )
                    {
                      ...
                      v26 = (struct _KPROCESS *)Object;
                      v24[13] = Object;
                      if ( v25 >= 0 )
                      {
                        PsInitialSystemProcess = v26;
                        _InterlockedOr((volatile signed __int32 *)&v26[2].UserTime, 0x40000000u);
                        _InterlockedOr((volatile signed __int32 *)&PsInitialSystemProcess[2].ReadyTime, 0x2000u);
                        _InterlockedOr(
