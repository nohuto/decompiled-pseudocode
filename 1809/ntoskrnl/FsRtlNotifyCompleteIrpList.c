/*
 * XREFs of FsRtlNotifyCompleteIrpList @ 0x1406A13CC
 * Callers:
 ...
 *     FsRtlCheckNotifyForDelete @ 0x1408168C0 (FsRtlCheckNotifyForDelete.c)
 *     FsRtlCheckNotifyForDeleteLite @ 0x140816920 (FsRtlCheckNotifyForDeleteLite.c)
 * Callees:
