/*
 * XREFs of RawInitiateDeleteVolume @ 0x14010C61C
 * Callers:
      ...
      if ( *(char **)(*(_QWORD *)p_FilterContexts + 8LL) == p_FilterContexts )
      {
        ...
        if ( (char *)Blink->Flink == p_FilterContexts )
        {
          ...
          *(_DWORD *)&AdvancedHeader[1].NodeTypeCode |= 6u;
          v16 = (struct _LIST_ENTRY *)qword_14040E188;
          if ( *(__int64 **)qword_14040E188 == &RawDismountedQueue )
          {
            *(_QWORD *)p_FilterContexts = &RawDismountedQueue;
            ...
            qword_14040E188 = (__int64)&AdvancedHeader[1].FilterContexts;
