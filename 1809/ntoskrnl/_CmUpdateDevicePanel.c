/*
 * XREFs of _CmUpdateDevicePanel @ 0x1406E85F8
 * Callers:
 ...
 *     _CmGetDevicePanelGroup @ 0x1407633D8 (_CmGetDevicePanelGroup.c)
...
LABEL_18:
            ...
            *(_OWORD *)v74 = DEVPKEY_Device_PhysicalDeviceLocationPanel;
            ...
            while ( 2 )
            {
              ...
              if ( v35 < 7 )
                v34 = (unsigned int)dword_140369638[v35];
              v65 = v34;
              if ( v5 )
              {
LABEL_154:
...
LABEL_221:
                        ...
                        if ( v70 || (v70 = ExAllocatePoolWithTag(PagedPool, 0x72uLL, 0x52504E50u), (v43 = v70) != 0LL) )
                        {
                          ...
                          if ( ((*(_DWORD *)v62 >> 20) & 7) != 7 )
                            v44 = (unsigned int)dword_140369638[(*(_DWORD *)v62 >> 20) & 7];
                          v54 = v44;
