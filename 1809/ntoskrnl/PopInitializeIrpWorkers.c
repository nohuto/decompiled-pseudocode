/*
 * XREFs of PopInitializeIrpWorkers @ 0x1409DC56C
 * Callers:
...
NTSTATUS PopInitializeIrpWorkers()
{
  ...
  qword_1404104E8 = (__int64)&PopIrpThreadList;
  PopIrpThreadList = (__int64)&PopIrpThreadList;
  qword_1404176A8 = (__int64)&PopIrpWorkerList;
  PopIrpWorkerList = (__int64)&PopIrpWorkerList;
  qword_1404176D0 = (__int64)&qword_1404176C8;
  qword_1404176C8 = (__int64)&qword_1404176C8;
