/*
 * XREFs of WheapGetPolicyValue @ 0x1408DC334
 * Callers:
 *     WheapWmiExecutePolicyManagementMethod @ 0x140321778 (WheapWmiExecutePolicyManagementMethod.c)
 *     WheapGetAllPolicyValues @ 0x1408DC2F0 (WheapGetAllPolicyValues.c)
 * Callees:
 *     <none>
 */
