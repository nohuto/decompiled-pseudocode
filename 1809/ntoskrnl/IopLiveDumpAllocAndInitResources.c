/*
 * XREFs of IopLiveDumpAllocAndInitResources @ 0x14081F700
 * Callers:
 ...
 *     HvlGetHypervisorEncryptionDomain @ 0x1401786E0 (HvlGetHypervisorEncryptionDomain.c)
 ...
 *     HvlPrepareLivedumpDescriptor @ 0x140277AC8 (HvlPrepareLivedumpDescriptor.c)
...
__int64 __fastcall IopLiveDumpAllocAndInitResources(__int64 a1)
{
  ...
  if ( stru_140400A78.LevelPlus1 > 5 && TlgKeywordOn(&stru_140400A78, 0x200000000000uLL) )
  {
    ...
    v6 = &v4;
    TlgWrite(&stru_140400A78, &unk_14036CFD9, (LPCGUID)(a1 + 624), (LPCGUID)(a1 + 608), 3u, &pData);
  }
