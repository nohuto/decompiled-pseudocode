/*
 * XREFs of sub_1408E5088 @ 0x1408E5088
 * Callers:
...
__int64 __fastcall sub_1408E5088(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  int v4; // ebx
  unsigned int v7; // r8d
...
LABEL_26:
    ...
    if ( v16 >= 0 && v16 != 192 )
    {
      ...
      do
      {
        v18 = KeWaitForSingleObject(&stru_140406460, UserRequest, 1, 1u, &Interval);
        v17 = v18;
      }
      while ( v18 == 257 );
