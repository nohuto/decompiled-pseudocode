/*
 * XREFs of ExInitializePagedLookasideListInternal @ 0x1400F38F0
 * Callers:
        ...
        int a8)
{
  ...
  *(_QWORD *)(a1 + 80) = 0LL;
  ...
  v13 = (_QWORD *)qword_1404070A8;
  v14 = (_QWORD *)(a1 + 64);
  if ( *(__int64 **)qword_1404070A8 != &ExPagedLookasideListHead )
    __fastfail(3u);
  *v14 = &ExPagedLookasideListHead;
  v14[1] = v13;
  *v13 = v14;
  qword_1404070A8 = (__int64)v14;
