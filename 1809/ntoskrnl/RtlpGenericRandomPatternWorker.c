/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x1402F8724
 * Callers:
 *     RtlScrubMemory @ 0x1402F807C (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x1402F81B0 (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x1402F8C38 (RtlpTestMemoryRandomUp.c)
 */
...
LABEL_12:
    ...
    if ( (unsigned __int8)RtlpTestMemoryRandomUp(a1, v16, v6, v5) )
    {
      ...
      v19 = v6;
      v20 = 0LL;
      v21 = (unsigned __int64)&v2[-a1 + 7] >> 3;
      if ( a1 > (unsigned __int64)v2 )
        v21 = 0LL;
      if ( v21 )
      {
      ...
      {
        _InterlockedOr(v40, 0);
        for ( k = (char *)(a1 & ~(v23 - 1)); k < v2; k += v23 )
          _mm_clflush(k);
      }
      ...
      {
        _InterlockedOr(v40, 0);
        for ( m = (char *)(a1 & ~(v26 - 1)); m < v2; m += v26 )
          _mm_clflush(m);
      }
      if ( (unsigned __int8)RtlpTestMemoryRandomUp(a1, v26, v6, v5) )
      {
        ...
        {
          _InterlockedOr(v40, 0);
          for ( n = (char *)(a1 & ~(v31 - 1)); n < v2; n += v31 )
            _mm_clflush(n);
        }
        v33 = v2;
        v34 = v6;
        ...
        {
          _InterlockedOr(v40, 0);
          for ( ii = (char *)(a1 & ~(v36 - 1)); ii < v2; ii += v36 )
            _mm_clflush(ii);
        }
        v38 = v2;
