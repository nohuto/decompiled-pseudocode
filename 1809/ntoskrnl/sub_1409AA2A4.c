/*
 * XREFs of sub_1409AA2A4 @ 0x1409AA2A4
 * Callers:
...
__int64 __fastcall sub_1409AA2A4(__int64 a1)
{
  ...
  *(_QWORD *)v10 = v10 + 24;
  ...
  {
    *(_DWORD *)(a1 + 2416) |= 0x2000000u;
    *(_QWORD *)(v10 + 8) = 1LL;
  }
  _InterlockedOr(v39, 0);
  __rdtsc();
  v33 = (unsigned __int8)(*(_BYTE *)(a1 + 2304) - 1);
  v34 = __rdtsc();
  v35 = __ROR8__(v34, 3);
  v36 = v33
