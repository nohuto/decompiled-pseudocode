/*
 * XREFs of RtlpCreateHashTable @ 0x14016A550
 * Callers:
 *     RtlCreateHashTableEx @ 0x14016A510 (RtlCreateHashTableEx.c)
 ...
 *     RtlpInitializeSecondLevelDir @ 0x14016A6CC (RtlpInitializeSecondLevelDir.c)
