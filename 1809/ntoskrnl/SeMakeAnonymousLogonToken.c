/*
 * XREFs of SeMakeAnonymousLogonToken @ 0x1409AE624
 * Callers:
...
__int64 SeMakeAnonymousLogonToken()
{
  ...
  struct _SID_AND_ATTRIBUTES v26; // [rsp+D8h] [rbp-50h] BYREF
  ...
  struct _SID_AND_ATTRIBUTES v33; // [rsp+118h] [rbp-10h] BYREF
