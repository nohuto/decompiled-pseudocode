/*
 * XREFs of PopPepTriggerActivity @ 0x1400FFCF8
 * Callers:
 ...
 *     PopPepTryPowerUpComponent @ 0x140100090 (PopPepTryPowerUpComponent.c)
 *     PopPepSurprisePowerOn @ 0x140158704 (PopPepSurprisePowerOn.c)
 * Callees:
 *     PopPepCancelActivities @ 0x1400FF500 (PopPepCancelActivities.c)
