/*
 * XREFs of PipInitComputerIds @ 0x1409C8C60
 * Callers:
 ...
 *     PipSmBiosFindStruct @ 0x1409C9EE8 (PipSmBiosFindStruct.c)
 */
...
__int64 __fastcall PipInitComputerIds(__int64 a1)
{
  ...
  unsigned int v103[60]; // [rsp+1A0h] [rbp+A0h] BYREF
...
LABEL_44:
      ...
      if ( UnicodeString[2].Buffer && UnicodeString[4].Buffer && UnicodeString[5].Buffer )
      {
        ...
        v52 = PipCreateComputerId(v2, v50, &v95, 6LL, &v103[4 * v51]);
        v53 = v51 + 1;
        v9 = v52;
        if ( v52 < 0 )
          goto LABEL_135;
        ...
        v54 = PipCreateComputerId(v2, v50, &v95, 5LL, &v103[4 * v53]);
        v55 = v53 + 1;
        v9 = v54;
        if ( v54 < 0 )
          goto LABEL_135;
      ...
      if ( UnicodeString[2].Buffer )
      {
        if ( UnicodeString[3].Buffer )
        {
          if ( UnicodeString[6].Buffer )
          {
            if ( UnicodeString[7].Buffer )
            {
              ...
              v56 = PipCreateComputerId(v2, v50, &v95, 6LL, &v103[4 * v55++]);
              v9 = v56;
              if ( v56 < 0 )
                goto LABEL_135;
            }
          ...
          v97 = &UnicodeString[2];
          v98 = &UnicodeString[3];
          v57 = PipCreateComputerId(v2, v50, &v95, 4LL, &v103[4 * v55++]);
          v9 = v57;
          if ( v57 < 0 )
            goto LABEL_135;
        }
        ...
        v96 = &UnicodeString[1];
        v97 = &UnicodeString[2];
        v58 = PipCreateComputerId(v2, v50, &v95, 3LL, &v103[4 * v55++]);
        v9 = v58;
        if ( v58 < 0 )
          goto LABEL_135;
        Buffer = UnicodeString[0].Buffer;
      ...
      if ( UnicodeString[3].Buffer )
      {
        if ( UnicodeString[6].Buffer )
        {
          if ( UnicodeString[7].Buffer )
          {
            ...
            v97 = &UnicodeString[6];
            v98 = &UnicodeString[7];
            v59 = PipCreateComputerId(v2, v50, &v95, 4LL, &v103[4 * v55++]);
            v9 = v59;
            if ( v59 < 0 )
              goto LABEL_135;
          }
        ...
        v95 = UnicodeString;
        v96 = &UnicodeString[3];
        v60 = PipCreateComputerId(v2, v50, &v95, 2LL, &v103[4 * v55++]);
        v9 = v60;
        if ( v60 < 0 )
          goto LABEL_135;
        Buffer = UnicodeString[0].Buffer;
      ...
      if ( UnicodeString[2].Buffer )
      {
        if ( UnicodeString[6].Buffer )
        {
          if ( UnicodeString[7].Buffer )
          {
            ...
            v97 = &UnicodeString[6];
            v98 = &UnicodeString[7];
            v61 = PipCreateComputerId(v2, v50, &v95, 4LL, &v103[4 * v55++]);
            v9 = v61;
            if ( v61 < 0 )
              goto LABEL_135;
          }
        ...
        v95 = UnicodeString;
        v96 = &UnicodeString[2];
        v62 = PipCreateComputerId(v2, v50, &v95, 2LL, &v103[4 * v55++]);
        v9 = v62;
        if ( v62 < 0 )
          goto LABEL_135;
        Buffer = UnicodeString[0].Buffer;
      ...
      if ( UnicodeString[1].Buffer )
      {
        if ( UnicodeString[7].Buffer )
        {
          if ( UnicodeString[6].Buffer )
          {
            ...
            v97 = &UnicodeString[6];
            v98 = &UnicodeString[7];
            v63 = PipCreateComputerId(v2, v50, &v95, 4LL, &v103[4 * v55++]);
            v9 = v63;
            if ( v63 < 0 )
              goto LABEL_135;
          }
        ...
        v95 = UnicodeString;
        v96 = &UnicodeString[1];
        v64 = PipCreateComputerId(v2, v50, &v95, 2LL, &v103[4 * v55++]);
        v9 = v64;
        if ( v64 < 0 )
          goto LABEL_135;
        Buffer = UnicodeString[0].Buffer;
      ...
      if ( v88 )
      {
        ...
        v95 = UnicodeString;
        v96 = &v94;
        v65 = PipCreateComputerId(v2, 0LL, &v95, 2LL, &v103[4 * v55++]);
        v9 = v65;
        if ( v65 < 0 )
          goto LABEL_135;
        Buffer = UnicodeString[0].Buffer;
      ...
      if ( !UnicodeString[7].Buffer
        ...
        || (v95 = UnicodeString,
            v96 = &UnicodeString[6],
            v97 = &UnicodeString[7],
            v66 = PipCreateComputerId(v2, 0LL, &v95, 3LL, &v103[4 * v55]),
            ++v55,
            v9 = v66,
            v66 >= 0) )
      {
        v95 = UnicodeString;
        v67 = PipCreateComputerId(v2, 0LL, &v95, 1LL, &v103[4 * v55++]);
        v9 = v67;
        if ( v67 >= 0 )
        {
LABEL_112:
          ...
          if ( PoolWithTag )
          {
            ...
            if ( v55 )
            {
              while ( 1 )
              {
                ...
                if ( v9 < 0 )
                  break;
                v9 = RtlStringFromGUIDEx(&v103[4 * v71], (__int64)&ValueName, 0);
                if ( v9 < 0 )
                  break;
