/*
 * XREFs of KiParkUmsThread @ 0x14029D5C0
 * Callers:
 ...
 *     KeRestoreLegacyFloatingPointControlWord @ 0x1401BC2B0 (KeRestoreLegacyFloatingPointControlWord.c)
 *     _alloca_probe @ 0x1401C5DA0 (_alloca_probe.c)
 *     KiUmsRestoreUch @ 0x1401D0A00 (KiUmsRestoreUch.c)
