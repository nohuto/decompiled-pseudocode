...
char __fastcall PnpTraceInterruptUsage(int a1)
{
  ...
  {
    LOBYTE(v1) = TlgKeywordOn(&stru_1403FFBC8, 0x400000000000uLL);
    if ( (_BYTE)v1 )
    {
      v17 = v3;
      v22 = &v17;
...
LABEL_21:
          LOBYTE(v1) = EtwWriteEx(stru_1403FFBC8.RegHandle, &EventDescriptor, 0LL, 0, 0LL, 0LL, 3u, &UserData);
      }
    }
  }
  return (char)v1;
