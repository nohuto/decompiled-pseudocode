/*
 * XREFs of sub_1408E3310 @ 0x1408E3310
 * Callers:
...
__int64 __fastcall sub_1408E3310(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  int v4; // edi
  unsigned int v7; // r8d
...
LABEL_26:
    ...
    v16 = KeWaitForSingleObject(&stru_140406460, UserRequest, 1, 0, &Timeout);
    if ( v16 >= 0 && v16 != 192 && v16 != 258 )
    {
      if ( stru_140406440.Header.SignalState || !dword_14096D17C )
      {
        v17 = MEMORY[0xFFFFF78000000320];
        TimeIncrement = KeQueryTimeIncrement();
        dword_14096D17C = 1;
        qword_14096D118 = v17 * TimeIncrement / 10000;
