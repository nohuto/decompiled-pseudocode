/*
 * XREFs of PopCheckAndHandleThermalConditions @ 0x14018BED4
 * Callers:
...
LABEL_4:
  ...
  if ( *(_BYTE *)(a1 + 72) != result )
  {
    ...
    *(_BYTE *)(a1 + 72) = v16;
    if ( v16 )
    {
      if ( ++dword_140417144 == 1 )
      {
        byte_14041714C = 1;
        ++dword_140417148;
        PopTraceCr3Tripped();
      }
      PopTraceZoneCr3Tripped((unsigned int)dword_140417148, a1);
    }
    else
    {
      PopTraceZoneCr3Mitigated((unsigned int)dword_140417148, a1);
      --dword_140417144;
    }
    if ( dword_140417144 )
    {
    ...
    else
    {
      ...
      PopTraceCr3Mitigated((unsigned int)dword_140417148);
