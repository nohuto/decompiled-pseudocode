  ...
  if ( !qword_14096D020 )
  {
    ...
    if ( Pool_0 )
    {
      ...
      if ( RtlFindMessage(*(PVOID *)(v6 + 48), 0xBu, 0, 0xB5u, &MessageResourceEntry) >= 0 )
      {
        ...
        RtlAnsiStringToUnicodeString(qword_14096D020, &SourceString, 1u);
        if ( qword_14096D020->Length > 4u )
        {
          v9 = (unsigned __int16)(qword_14096D020->Length - 4);
          Buffer = qword_14096D020->Buffer;
          qword_14096D020->Length = v9;
          Buffer[v9 >> 1] = 0;
        }
      }
      ...
      else
      {
        ...
        RtlAnsiStringToUnicodeString(qword_14096D020 + 1, &SourceString, 1u);
        v11 = qword_14096D020;
        Length = qword_14096D020[1].Length;
        if ( Length > 4u )
        {
          v13 = Length - 4;
          qword_14096D020[1].Length = v13;
