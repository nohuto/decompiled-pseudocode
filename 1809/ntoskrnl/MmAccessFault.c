 ...
 *     MiReleaseOutSwapReservations @ 0x1400E5BBC (MiReleaseOutSwapReservations.c)
 ...
 *     MmVirtualAccessFault @ 0x140859094 (MmVirtualAccessFault.c)
 * Callees:
 ...
 *     MiEmptyDeferredWorkingSetEntries @ 0x140128BD8 (MiEmptyDeferredWorkingSetEntries.c)
...
LABEL_161:
  ...
  while ( 1 )
  {
    ...
    v15 = v55[0];
    if ( v55[0] >= 0xFFFF800000000000uLL || v55[12] == qword_140439FF8 || qword_14043A000 && v55[12] == qword_14043A000 )
      goto LABEL_34;
    Address = v55[11];
    if ( !v55[11] )
    {
...
LABEL_86:
      ...
      if ( v55[15] )
      {
        MiReplenishSlabAllocator(
          v55[15],
          *(_QWORD *)(qword_14043A748 + 8LL * (*(_WORD *)(*(_QWORD *)v55[13] + 60LL) & 0x3FF)),
          v55[16]);
        v55[15] = 0LL;
      }
      else if ( (v55[2] & 1) != 0 && *(_BYTE *)(v55[2] & 0xFFFFFFFFFFFFFFFEuLL) == 5 )
      {
        ...
        if ( v38 )
          MiReplenishSlabAllocator(v38, *(_QWORD *)(qword_14043A748 + 8LL * *(unsigned __int16 *)(v55[7] + 174LL)), 1LL);
      }
      v39 = v55[7];
      ...
      v42 = *(_QWORD *)(qword_14043A748 + 8LL * *(unsigned __int16 *)(v39 + 174));
...
LABEL_113:
    if ( MiIsRetryIoStatus(FileExtents, v11) )
    {
      ...
      {
        v44 = *(_QWORD *)(qword_14043A748 + 8LL * *(unsigned __int16 *)(v55[7] + 174LL));
