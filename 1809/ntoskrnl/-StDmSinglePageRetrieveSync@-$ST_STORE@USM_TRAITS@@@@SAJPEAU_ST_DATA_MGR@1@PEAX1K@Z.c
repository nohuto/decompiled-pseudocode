/*
 * XREFs of ?StDmSinglePageRetrieveSync@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAX1K@Z @ 0x14030597C
 * Callers:
 *     ?StNpLeafPageIn@?$ST_STORE@USM_TRAITS@@@@SAJPEAUNP_CTX@NP_CONTEXT@@PEAX_K@Z @ 0x140305F10 (-StNpLeafPageIn@-$ST_STORE@USM_TRAITS@@@@SAJPEAUNP_CTX@NP_CONTEXT@@PEAX_K@Z.c)
 * Callees:
 ...
 *     ?StDeviceIoIssue@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_PF_QUEUE@@@Z @ 0x140303CF4 (-StDeviceIoIssue@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_PF_QUEUE@@@Z.c)
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmSinglePageRetrieveSync(__int64 a1, _DWORD *a2, __int64 a3, unsigned int a4)
{
  ...
  _BYTE v15[16]; // [rsp+58h] [rbp-18h] BYREF
  ...
  if ( (a4 & 2) != 0 )
    ...
    LODWORD(v14) = *a2;
  result = ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(a1, a1 + 912, (__int64)&v12, a4, (__int64)v15);
  if ( (int)result >= 1 )
  {
