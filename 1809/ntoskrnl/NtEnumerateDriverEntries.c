/*
 * XREFs of NtEnumerateDriverEntries @ 0x1408D3F40
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall NtEnumerateDriverEntries(PVOID Buffer, PULONG BufferLength)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v16 && (unsigned int)ExpTranslateDriverEntryNameToId((wint_t *)v15 + 16, &v36) && v15[2] >= 8 )
    {
      v17 = (char *)v15 + v15[1];
      ...
      if ( v18 != -1 )
        v18 = 2 * v18 + 2;
      if ( v18 != -1 && v21 < v20 && v20 >= v18 + v21 + 6 )
      {
        Size = v18;
