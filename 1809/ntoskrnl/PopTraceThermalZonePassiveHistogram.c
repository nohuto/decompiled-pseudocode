/*
 * XREFs of PopTraceThermalZonePassiveHistogram @ 0x1401425D0
 * Callers:
  ...
  if ( v4 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)DeviceAttachmentBaseRefWithTag )
      {
        ...
        v14 = 84;
        v17 = 21;
        LOBYTE(DeviceAttachmentBaseRefWithTag) = TlgWrite(&pCallbackContext, &unk_14037023A, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  if ( v3 )
