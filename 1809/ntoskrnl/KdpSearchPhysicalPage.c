/*
 * XREFs of KdpSearchPhysicalPage @ 0x140917E44
 * Callers:
...
__int64 __fastcall KdpSearchPhysicalPage(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, char a4, int a5)
{
  ...
  int v16; // edx
  int v17; // eax
  struct _SINGLE_LIST_ENTRY v18; // [rsp+30h] [rbp-48h] BYREF
  struct _SINGLE_LIST_ENTRY v19; // [rsp+38h] [rbp-40h] BYREF
  ...
  if ( KdpSearchPfnValue )
  {
    ...
    while ( 1 )
    {
      if ( (int)MmDbgCopyMemory((struct _SINGLE_LIST_ENTRY *)(v5 + v9), &v19, 8u, 8u, a5 | 2u) >= 0
        && (((unsigned __int64)v19.Next >> 12) & 0xFFFFFFFFFLL) == a2 )
      {
  ...
  else
  {
    ...
    while ( 1 )
    {
      if ( (int)MmDbgCopyMemory((struct _SINGLE_LIST_ENTRY *)(v5 + v13), &v18, v11, 0, a5 | 2u) >= 0 )
      {
        if ( (unsigned __int64)v18.Next >= a2 && (unsigned __int64)v18.Next <= a3 )
          goto LABEL_24;
        if ( !v10 )
        {
          v14 = a2 ^ (unsigned __int64)v18.Next;
          v15 = 64LL;
          v16 = 0;
          do
          {
