/*
 * XREFs of MiMirrorVerify @ 0x140152A0C
 * Callers:
...
__int64 __fastcall MiMirrorVerify(__int64 a1)
{
  ...
  do
  {
    v5 = v4 & -(__int64)(v4 < qword_14043A7B0);
    v6 = qword_14043A7B0 - 1;
    while ( 1 )
    {
      if ( v6 - v5 == -1LL )
        goto LABEL_7;
      v7 = (_QWORD *)(qword_14043A7B8 + 8 * (v5 >> 6));
      for ( i = ~*v7 | ((1LL << (v5 & 0x3F)) - 1); i == -1; i = ~*v7 )
      {
        if ( (unsigned __int64)++v7 > qword_14043A7B8 + 8 * (v6 >> 6) )
          goto LABEL_7;
      }
      _BitScanForward64(&v10, ~i);
      v9 = v10 + (((__int64)v7 - qword_14043A7B8) >> 3 << 6);
      if ( v9 > v6 )
      {
LABEL_7:
        v9 = -1LL;
    ...
    if ( v9 < v4 || v9 == -1LL )
      break;
    NextForwardRunClearCapped = RtlFindNextForwardRunClearCappedEx(&qword_14043A7B0, v9, v6, &v16);
    v13 = v16;
