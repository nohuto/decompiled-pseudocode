/*
 * XREFs of NtSetInformationProcess @ 0x140671C60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     MmGetMaximumUserAddress @ 0x1402A5464 (MmGetMaximumUserAddress.c)
 ...
 *     KeSetAutoAlignmentProcess @ 0x14067610C (KeSetAutoAlignmentProcess.c)
 ...
 *     PsIsSystemWideMitigationOptionSet @ 0x1406CF768 (PsIsSystemWideMitigationOptionSet.c)
 ...
 *     KeSetDisableBoostProcess @ 0x1406D6BAC (KeSetDisableBoostProcess.c)
 ...
 *     KeSetCheckStackExtentsProcess @ 0x1408433D8 (KeSetCheckStackExtentsProcess.c)
 ...
 *     PsIsGuiThread @ 0x140888764 (PsIsGuiThread.c)
    ...
    case 21:
      ...
      if ( result >= 0 )
      {
        ...
        if ( (_DWORD)v4 == 8 )
        {
          ...
          v45 = v297 & qword_1405416A8[GroupMaskProcess];
          if ( v45 != (_QWORD)v297 )
            goto LABEL_127;
          WORD4(v297) = v247;
          *(_QWORD *)&v297 = v45;
