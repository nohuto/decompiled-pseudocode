/*
 * XREFs of _CmRaiseCreateEvent @ 0x1406FD5C0
 * Callers:
 *     _CmCreateDeviceContainerWorker @ 0x1406E9FD8 (_CmCreateDeviceContainerWorker.c)
 ...
 *     _CmCreateDevicePanelWorker @ 0x1408FB558 (_CmCreateDevicePanelWorker.c)
 * Callees:
