/*
 * XREFs of AuthzBasepQueryInternalSecurityAttributesToken @ 0x1405BF698
 * Callers:
 ...
 * Callees:
 *     AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize @ 0x1405BF720 (AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize.c)
