/*
 * XREFs of IoFillTriageDumpBuffer @ 0x14027F794
 * Callers:
 ...
 *     IoGetLoadedDriverInfo @ 0x14027FE2C (IoGetLoadedDriverInfo.c)
 ...
 *     IopSizeTriageDumpDataBlocks @ 0x140281AE8 (IopSizeTriageDumpDataBlocks.c)
        ...
        _DWORD *a13)
{
  ...
  *((_DWORD *)a2 + 17) = v16;
  ...
  if ( (_DWORD)v45 && v45 + 32448 <= (unsigned __int64)(unsigned int)v22 )
  {
    memmove((char *)v34 + (unsigned int)v45, KeGetCurrentPrcb(), 0x7EC0uLL);
    v46 = (unsigned int)v22;
  }
  v47 = *((unsigned int *)a2 + 8);
  v48 = Src;
  if ( (_DWORD)v47 && v47 + 2136 <= v46 )
    memmove((char *)v34 + (unsigned int)v47, *((const void **)Src + 23), 0x858uLL);
  v49 = *((unsigned int *)a2 + 9);
  if ( (_DWORD)v49 )
  {
    v46 = (unsigned int)v22;
    if ( v49 + 2064 <= (unsigned __int64)(unsigned int)v22 )
      memmove((char *)v34 + (unsigned int)v49, v48, 0x810uLL);
  }
