/*
 * XREFs of PnpIsRangeWithin @ 0x14072DC1C
 * Callers:
 *     PnpNeedToReleaseBootResources @ 0x14072DAA0 (PnpNeedToReleaseBootResources.c)
 * Callees:
 *     RtlCmDecodeMemIoResource @ 0x140139400 (RtlCmDecodeMemIoResource.c)
 */
