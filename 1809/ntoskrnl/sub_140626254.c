/*
 * XREFs of sub_140626254 @ 0x140626254
 * Callers:
...
__int64 __fastcall sub_140626254(int a1, _QWORD *a2)
{
  __int64 result; // rax
  __int64 v4; // rcx
  ...
  v5 = 0LL;
  result = sub_1406262B8((unsigned int)&dword_140440AD0, a1, 8, (unsigned int)&v5, 0LL);
  if ( (int)result >= 0 && a2 )
  {
    v4 = v5;
    if ( v5 )
