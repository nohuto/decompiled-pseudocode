 ...
 *     PsReferenceImpersonationToken @ 0x1406A4880 (PsReferenceImpersonationToken.c)
 *     CmpGetVolumeLogFileSizeCap @ 0x1406C9AA4 (CmpGetVolumeLogFileSizeCap.c)
 *     SeTokenImpersonationLevel @ 0x1406F9610 (SeTokenImpersonationLevel.c)
 *     CmpOpenFileWithExtremePrejudice @ 0x1407F67FC (CmpOpenFileWithExtremePrejudice.c)
 *     PsRevertToSelf @ 0x140889350 (PsRevertToSelf.c)
 */
