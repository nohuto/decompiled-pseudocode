/*
 * XREFs of PfSetSuperfetchInformation @ 0x140665878
 * Callers:
...
LABEL_11:
    ...
    if ( (_DWORD)v25 == 2 && HIDWORD(v25) < 2 && (v18 & 0xFFFFFFFC) == 0 )
    {
      ...
      PfpScenCtxServiceThreadSet((ULONG_PTR)&qword_14043C0A0, HIDWORD(v25) == 0);
      goto LABEL_12;
    }
LABEL_86:
    v9 = -1073741811;
