/*
 * XREFs of FsRtlUninitializeSmallMcb @ 0x14034B8E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FsRtlUninitializeSmallMcb(__int64 a1)
{
  ...
  if ( *(_QWORD *)(CompleteDev + 2024) )
    return (*(__int64 (__fastcall **)(__int64, _QWORD))(CompleteDev + 616))(CompleteDev + 2024, 0LL);
  v2 = (__int64 (__fastcall *)())CompleteDev;
  v3 = *(_QWORD *)(CompleteDev + 1968);
  v4 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, unsigned __int64))(CompleteDev + 248);
  v5 = *(unsigned int *)(CompleteDev + 1996);
  v6 = *(_QWORD *)(CompleteDev + 1976);
  ...
  v9 = (unsigned __int64 *)&loc_14034B966;
  do
  {
    v10 = *v9 ^ v7;
    *v9 = v10;
