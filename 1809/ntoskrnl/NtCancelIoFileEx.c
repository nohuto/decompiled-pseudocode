/*
 * XREFs of NtCancelIoFileEx @ 0x1406A7B50
 * Callers:
 *     <none>
 * Callees:
        ...
        PIO_STATUS_BLOCK IoStatusBlock)
{
  ...
  if ( result >= 0 )
  {
    ...
    if ( !IoRequestToCancel || !v10 )
      v10 |= IopCancelIrpsInThreadListForCurrentProcess((__int64)v9, (__int64)IoRequestToCancel);
    IoStatusBlock->Status = v10 == 0 ? 0xC0000225 : 0;
    IoStatusBlock->Information = 0LL;
    ObfDereferenceObject(v9);
    return v10 == 0 ? 0xC0000225 : 0;
  }
  return result;
}
