/*
 * XREFs of FsRtlGetNextFileLock @ 0x14026EFF0
 * Callers:
 *     <none>
 * Callees:
...
PFILE_LOCK_INFO __stdcall FsRtlGetNextFileLock(PFILE_LOCK FileLock, BOOLEAN Restart)
{
  ...
  PRTL_SPLAY_LINKS Links; // [rsp+38h] [rbp-51h] BYREF
  __int128 v31; // [rsp+40h] [rbp-49h] BYREF
  __m256i v32; // [rsp+50h] [rbp-39h] BYREF
  __int128 v33; // [rsp+70h] [rbp-19h]
  ...
  v34 = v4;
  v31 = v4;
  v33 = *(_OWORD *)&FileLock->LastReturnedLockInfo.ExclusiveLock;
  *(_OWORD *)v32.m256i_i8 = v33;
  v35 = *(_OWORD *)&FileLock->LastReturnedLockInfo.ProcessId;
  *(_OWORD *)&v32.m256i_u64[2] = v35;
  ...
  if ( Restart )
  {
    ...
    if ( v22 )
    {
      ...
      v31 = v34;
      v33 = *(_OWORD *)&LastReturnedLock[1].RightChild;
      *(_OWORD *)v32.m256i_i8 = v33;
  ...
  if ( (_BYTE)v33 )
  {
    ...
    if ( FirstOverlappingExclusiveNode )
    {
      ...
      v10 = v32.m256i_i64[1];
      v11 = v32.m256i_i32[1];
      v12 = (_RTL_SPLAY_LINKS *)*((_QWORD *)&v31 + 1);
      v13 = (_RTL_SPLAY_LINKS *)v31;
...
LABEL_22:
    if ( FirstOverlappingExclusiveNode )
    {
      ...
      v31 = v34;
      v33 = *(_OWORD *)&FirstOverlappingExclusiveNode[1].RightChild;
      *(_OWORD *)v32.m256i_i8 = v33;
...
LABEL_34:
  ...
  while ( 1 )
  {
    ...
    {
      v20 = (_RTL_SPLAY_LINKS *)v31 < Parent->LeftChild;
      if ( (_RTL_SPLAY_LINKS *)v31 != Parent->LeftChild )
        goto LABEL_43;
      if ( (_RTL_SPLAY_LINKS *)*((_QWORD *)&v31 + 1) == Parent->RightChild
        && v32.m256i_i32[1] == HIDWORD(Parent[1].Parent)
        && *(_OWORD *)&v32.m256i_u64[1] == *(_OWORD *)&Parent[1].LeftChild )
      {
        break;
      }
    }
