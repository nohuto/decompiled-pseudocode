/*
 * XREFs of KeBugCheck2 @ 0x140291090
 * Callers:
 ...
 *     KdRefreshDebuggerNotPresent @ 0x140193E30 (KdRefreshDebuggerNotPresent.c)
 *     KiFilterBugCheckInfo @ 0x14019F7BC (KiFilterBugCheckInfo.c)
 *     KiMarkBugCheckRegions @ 0x1401A0110 (KiMarkBugCheckRegions.c)
 *     KiYieldWaitForDebugger @ 0x1401B4308 (KiYieldWaitForDebugger.c)
 ...
 *     KdDecodeDataBlock @ 0x14028BA74 (KdDecodeDataBlock.c)
 ...
 *     KiInvokeBugCheckAddTriageDumpDataCallbacks @ 0x140292960 (KiInvokeBugCheckAddTriageDumpDataCallbacks.c)
 *     KiInvokeBugCheckEntryCallbacks @ 0x140292B00 (KiInvokeBugCheckEntryCallbacks.c)
 *     KiPcToFileHeader @ 0x140292B9C (KiPcToFileHeader.c)
 *     KiSaveCurrentEtwTraceBuffer @ 0x140292C6C (KiSaveCurrentEtwTraceBuffer.c)
 *     KiScanBugCheckCallbackList @ 0x140292D8C (KiScanBugCheckCallbackList.c)
 *     KeSaveSupervisorState @ 0x140294178 (KeSaveSupervisorState.c)
