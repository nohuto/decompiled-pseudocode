/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x1402F5204
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x140898338 (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
