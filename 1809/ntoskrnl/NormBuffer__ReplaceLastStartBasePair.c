/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x1402F53F4
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x140899598 (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
