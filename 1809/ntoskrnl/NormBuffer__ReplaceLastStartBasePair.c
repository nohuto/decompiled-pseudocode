/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x1402F5104
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x140898358 (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
