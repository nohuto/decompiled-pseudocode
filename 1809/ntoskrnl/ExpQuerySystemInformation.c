/*
 * XREFs of ExpQuerySystemInformation @ 0x140626390
 * Callers:
 ...
 *     MmGetLowestPhysicalPage @ 0x14013BA04 (MmGetLowestPhysicalPage.c)
 ...
 *     HvlQueryActiveProcessors @ 0x140271340 (HvlQueryActiveProcessors.c)
 *     HvlQueryProcessorTopologyCount @ 0x140271530 (HvlQueryProcessorTopologyCount.c)
 ...
 *     SeCodeIntegrityQueryPolicyInformation @ 0x14068FD00 (SeCodeIntegrityQueryPolicyInformation.c)
 ...
 *     SeCodeIntegrityQueryInformation @ 0x1406BA7E8 (SeCodeIntegrityQueryInformation.c)
 ...
 *     IoQueryLowPriorityIoInformation @ 0x1406CBA58 (IoQueryLowPriorityIoInformation.c)
 ...
 *     HvlQueryEnlightenmentInfo @ 0x140762620 (HvlQueryEnlightenmentInfo.c)
 ...
 *     ExpGetSystemProcessorFeaturesInformation @ 0x1408CB9A4 (ExpGetSystemProcessorFeaturesInformation.c)
 ...
 *     ExpQueryNumaProximityNode @ 0x1408CC4D0 (ExpQueryNumaProximityNode.c)
 ...
 *     BgkQueryBootGraphicsInformation @ 0x14094F414 (BgkQueryBootGraphicsInformation.c)
 */
...
LABEL_176:
        ...
        case 0x24u:
          ...
          *(_DWORD *)(a4 + 8) = dword_140421CE8;
          *(_DWORD *)(a4 + 12) = dword_140421CE4;
          *(_DWORD *)(a4 + 16) = dword_140421CEC;
          *(_DWORD *)(a4 + 20) = dword_140421CF0;
          *(_DWORD *)(a4 + 24) = dword_140421CF8;
          *(_DWORD *)(a4 + 28) = dword_140421CF4;
          *(_DWORD *)(a4 + 32) = dword_140421CFC;
          *(_DWORD *)(a4 + 36) = dword_140421D00;
          *(_DWORD *)(a4 + 40) = dword_140421D04;
          *(_DWORD *)(a4 + 44) = dword_140421D08;
          v31 = 48;
LABEL_266:
          LODWORD(Size) = v31;
          SystemBasicInformation = HIDWORD(Size);
        ...
        case 0x48u:
          ...
          if ( v72 )
          {
            if ( v72 != 1 )
              return -1073741637;
            *(_DWORD *)a4 = 8;
            *(_DWORD *)(a4 + 4) = (unsigned __int8)off_1403FE610[0]();
          }
          else
          {
            *(_DWORD *)a4 = 7;
            LOBYTE(v9) = off_1403FE618[0] != xKdEnumerateDebuggingDevices;
            *(_DWORD *)(a4 + 4) = v9;
          }
          goto LABEL_113;
        case 0x49u:
...
LABEL_275:
        ...
        case 0x67u:
          ...
          goto LABEL_618;
        case 0x69u:
          SystemBasicInformation = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD, SIZE_T *))off_140400458[0])(
                                     23LL,
                                     0LL,
                                     0LL,
                                     NumberOfBytes);
          ...
          v86 = ((__int64 (__fastcall *)(__int64, __int64, _DWORD *, size_t *))off_140400458[0])(
                  23LL,
                  v84,
                  PoolWithQuotaTag,
                  &Size);
...
LABEL_303:
        ...
        case 0x7Au:
          ...
          SystemBasicInformation = ((__int64 (__fastcall *)(__int64, __int64, _DWORD *, size_t *))off_140400458[0])(
                                     26LL,
                                     8LL,
                                     PoolWithQuotaTag,
                                     &Size);
...
LABEL_254:
        ...
        case 0x99u:
          ...
          if ( Length >= 0x20 )
          {
            ...
            *(_QWORD *)(a4 + 16) = xmmword_1404195B0;
            *(_DWORD *)(a4 + 24) = DWORD2(xmmword_1404195B0);
LABEL_513:
            SystemBasicInformation = HIDWORD(Size);
            goto LABEL_618;
          }
...
LABEL_138:
        ...
        case 0x9Cu:
          ...
          goto LABEL_618;
        case 0x9Du:
          LODWORD(Size) = WORD1(qword_140409DE8) + 24;
          if ( Length >= (unsigned int)Size )
          {
            v92 = (void *)(a4 + 24);
            *(_QWORD *)a4 = 0LL;
            ...
            *(_DWORD *)(a4 + 8) = qword_140409DE8;
            if ( (_WORD)qword_140409DE8 )
            {
              *(_QWORD *)(a4 + 16) = v92;
              memmove(v92, qword_140409DF0, WORD1(qword_140409DE8));
            }
            SystemBasicInformation = HIDWORD(Size);
          }
          else
        ...
        case 0xB6u:
          ...
          *(_QWORD *)&Src[0] = *(_QWORD *)(*(_QWORD *)(qword_14043A748 + 8LL * v22) + 7120LL) << 12;
...
LABEL_59:
        ...
        case 0xB8u:
          ...
          *(_QWORD *)&Src[0] = *(_QWORD *)(*(_QWORD *)(qword_14043A748 + 8LL * v27) + 7120LL) << 12;
...
LABEL_94:
          ...
          v99 = ((__int64 (__fastcall *)(__int64, _QWORD, _DWORD *, size_t *))off_140400458[0])(
                  34LL,
                  v37,
                  PoolWithQuotaTag,
                  &Size);
...
LABEL_424:
        ...
        case 0xCAu:
          ...
          if ( Length == 1 )
          {
            SystemBasicInformation = ((__int64 (__fastcall *)(__int64, __int64, _OWORD *, int *))off_140400458[0])(
                                       47LL,
                                       1LL,
                                       Src,
                                       &v121);
