/*
 * XREFs of PpmGetIdleGenerationCounter @ 0x1402D3FD8
 * Callers:
...
__int64 __fastcall PpmGetIdleGenerationCounter(__int64 a1)
{
  ...
  if ( v2 && *(_DWORD *)(a1 + 24024) == 3 )
    return (*(_QWORD *)(*(_QWORD *)(a1 + 24656) + 8LL * DWORD2(xmmword_1404DDA68)) >> 1) & -(__int64)((*(_QWORD *)(*(_QWORD *)(a1 + 24656) + 8LL * DWORD2(xmmword_1404DDA68)) & 1) != 0);
  return v4;
}
