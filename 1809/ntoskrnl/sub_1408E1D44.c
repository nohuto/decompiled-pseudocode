/*
 * XREFs of sub_1408E1D44 @ 0x1408E1D44
 * Callers:
...
__int64 __fastcall sub_1408E1D44(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
...
LABEL_120:
  ...
  if ( qword_14096D390 )
  {
    ...
    if ( !v50 )
      v57 = v16;
    v58 = qword_14096D390(v134, pcbLength, v5, a3, v48, v46, v57, v49, &v135);
  }
  else
  {
    v58 = -1073741637;
