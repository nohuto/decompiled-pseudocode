/*
 * XREFs of PopBatteryTracePercentageRemaining @ 0x14086D5CC
 * Callers:
...
char __fastcall PopBatteryTracePercentageRemaining(int a1, int a2, int a3, int a4)
{
  ...
  EVENT_DATA_DESCRIPTOR pData; // [rsp+98h] [rbp-49h] BYREF
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v34 = 4;
      v37 = 4;
      LOBYTE(v4) = TlgWrite(&pCallbackContext, &unk_14036F03A, 0LL, 0LL, 6u, &pData);
    }
  }
  return (char)v4;
}
