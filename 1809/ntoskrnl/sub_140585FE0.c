/*
 * XREFs of sub_140585FE0 @ 0x140585FE0
 * Callers:
...
__int64 __fastcall sub_140585FE0(PVOID *a1, _DWORD *a2)
{
  int v4; // ebx
  PVOID *v5; // rdi
  __int64 v6; // rsi
...
LABEL_7:
      v7 = 0;
      v8 = (int (__fastcall **)(__int64, UNICODE_STRING *, __int64))&off_140400D70;
      while ( 1 )
      {
        v9 = *v8;
        v10 = *((_BYTE *)v8 - 16)
