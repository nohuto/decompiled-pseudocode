/*
 * XREFs of sub_1406884A0 @ 0x1406884A0
 * Callers:
...
__int64 __fastcall sub_1406884A0(__int64 a1, void *a2, unsigned int a3, __int64 a4)
{
  void *v6; // r12
  ...
  char *v162; // rdx
  __int64 v163; // rax
  int v164; // [rsp+28h] [rbp-D8h]
  int v165; // [rsp+30h] [rbp-D0h]
  PVOID v166; // [rsp+40h] [rbp-C0h]
  unsigned int Size; // [rsp+48h] [rbp-B8h] BYREF
  unsigned int Size_4; // [rsp+4Ch] [rbp-B4h]
  unsigned int v169; // [rsp+50h] [rbp-B0h]
  int v170; // [rsp+54h] [rbp-ACh] BYREF
  int v171; // [rsp+58h] [rbp-A8h] BYREF
  int v172; // [rsp+5Ch] [rbp-A4h]
  unsigned int v173; // [rsp+60h] [rbp-A0h]
  int v174; // [rsp+64h] [rbp-9Ch] BYREF
  int v175; // [rsp+68h] [rbp-98h] BYREF
  unsigned int NumberOfBytes; // [rsp+6Ch] [rbp-94h]
  unsigned int NumberOfBytes_4; // [rsp+70h] [rbp-90h]
  int v178; // [rsp+74h] [rbp-8Ch] BYREF
  char v179[8]; // [rsp+78h] [rbp-88h] BYREF
  HANDLE KeyHandle; // [rsp+80h] [rbp-80h] BYREF
  int v181; // [rsp+88h] [rbp-78h] BYREF
  int v182; // [rsp+8Ch] [rbp-74h] BYREF
  int v183; // [rsp+90h] [rbp-70h] BYREF
  unsigned int v184; // [rsp+94h] [rbp-6Ch]
  unsigned int v185; // [rsp+98h] [rbp-68h]
  PCWSTR SourceString; // [rsp+A0h] [rbp-60h]
  int v187; // [rsp+A8h] [rbp-58h]
  unsigned int v188; // [rsp+BCh] [rbp-44h]
  int v189; // [rsp+C0h] [rbp-40h]
  int v190; // [rsp+C4h] [rbp-3Ch]
  size_t pcbLength; // [rsp+C8h] [rbp-38h] BYREF
  void *Src; // [rsp+D0h] [rbp-30h]
  LARGE_INTEGER Timeout; // [rsp+D8h] [rbp-28h] BYREF
  unsigned __int64 v194; // [rsp+E0h] [rbp-20h]
  __int64 v195; // [rsp+E8h] [rbp-18h]
  __int64 v196; // [rsp+F0h] [rbp-10h]
  UNICODE_STRING DestinationString; // [rsp+F8h] [rbp-8h] BYREF
  __int64 *v198; // [rsp+108h] [rbp+8h]
  const wchar_t *v199; // [rsp+110h] [rbp+10h]
  int *v200; // [rsp+118h] [rbp+18h]
  unsigned int *v201; // [rsp+120h] [rbp+20h]
  UNICODE_STRING v202; // [rsp+128h] [rbp+28h] BYREF
  __int64 v203; // [rsp+138h] [rbp+38h] BYREF
...
LABEL_114:
          ...
          v47 = ((__int64 (__fastcall *)(UNICODE_STRING *, int *, _QWORD, _QWORD, unsigned int *))qword_14096D440)(
                  &DestinationString,
                  &v171,
                  0LL,
                  0LL,
...
LABEL_136:
              ...
              if ( v45 < 0xFFFFFFFC )
                v52 = v45 + 4;
              v185 = v45 >= 0xFFFFFFFC ? 0xC0000095 : 0;
              v18 = v185;
              if ( v45 + 4 < 4 )
                goto LABEL_150;
              v53 = v52 + 28;
...
LABEL_181:
              ...
              if ( Size_4 >= v77 && v48 >= 0 )
              {
                ...
                v81 = (v80 >> 63) + v80;
                v194 = v81;
                RtlInitUnicodeString(&v202, L"Security-SPP-GenuineLocalStatus");
                v82 = ((__int64 (__fastcall *)(UNICODE_STRING *, int *, int *, __int64, char *))qword_14096D440)(
                        &v202,
                        &v181,
                        &v182,
                        4LL,
                        v179);
                if ( v82 == -1073741772 || v82 >= 0 && (v181 != 4 || !v182) )
                  v79 = 0;
                v83 = (double)((int)v81 - (int)g_qwSystemInitTime);
                if ( (__int64)(v81 - g_qwSystemInitTime) < 0 )
                  v83 = v83 + 1.844674407370955e19;
                if ( !v79 && !g_bWNFEventFired && v83 >= 9000000.0 && dword_14096D0CC )
                {
                  v165 = 0;
                  v164 = 0;
                  g_bWNFEventFired = 1;
                  ZwUpdateWnfStateData((__int64)&WNF_OLIC_OS_LICENSE_NON_GENUINE, 0LL, 0LL);
                }
                if ( v81 - g_qwSystemInitTime >= 0xA4CBFB )
                {
                  v84 = KeWaitForSingleObject(&stru_140406460, UserRequest, 1, 0, &Timeout);
                  if ( v84 >= 0 && v84 != 192 && v84 != 258 )
                  {
                    if ( g_ulOldGenuineState != v79 )
                    {
                      ...
                      else
                      {
                        ...
                        v81 = v194;
                        qword_14096D118 = v86 / 10000;
                      }
                    }
                    v87 = v81 - qword_14096D118;
                    g_ulOldGenuineState = v79;
                    if ( v79 || v87 < 0xADF4FC || !dword_14096D0CC )
                      goto LABEL_229;
                    KeSetEvent(&stru_140406440, 1, 0);
                    v174 = 4;
                    v183 = 0;
                    KeyHandle = 0LL;
                    v88 = ZwOpenKey(&KeyHandle, 1u, &stru_14096D7B8);
                    if ( v88 < 0 )
                    {
                      v88 = ((__int64 (__fastcall *)(wchar_t *, int *, int *, __int64, int *, int, int))qword_14096D440)(
                              aBd,
                              &v174,
                              &v170,
                              4LL,
                    ...
                    if ( v88 < 0 || v174 != 4 || (unsigned int)(v89 - 1) > 2 )
                    {
                      v89 = 1;
                      v170 = 1;
                    }
                    ...
                    v204 = 0;
                    v175 = 0;
                    if ( (int)((__int64 (__fastcall *)(wchar_t *, int *, __int64 *, __int64, int *))qword_14096D440)(
                                aLn,
                                &v178,
                                &v203,
                                12LL,
                    ...
                    {
LABEL_226:
                      v92 = dword_14096D054 & 0xFFFF0000 | 0x3211;
                    }
                    dword_14096D054 = v92;
                    if ( v172 )
                      NumberOfBytes_4 = v92;
...
LABEL_352:
          ...
          if ( !v46 )
            goto LABEL_136;
LABEL_127:
          v166 = ExAllocatePoolWithTag(PagedPool, v45, 0x20534C53u);
          v6 = v166;
          if ( !v166 )
          {
            v18 = -1073741801;
          ...
          v50 = ((__int64 (__fastcall *)(UNICODE_STRING *, int *, PVOID, _QWORD, unsigned int *))qword_14096D440)(
                  &DestinationString,
                  &v171,
                  v166,
                  v45,
