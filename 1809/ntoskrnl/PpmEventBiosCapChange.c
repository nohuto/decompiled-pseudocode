/*
 * XREFs of PpmEventBiosCapChange @ 0x1402E55E4
 * Callers:
...
void __fastcall PpmEventBiosCapChange(__int64 a1, int a2)
{
  REGHANDLE v3; // rbx
  __int16 v4; // ax
  ...
  {
    v3 = PpmEtwHandle;
    if ( EtwEventEnabled(PpmEtwHandle, &PPM_ETW_BIOS_CAP_CHANGE) )
    {
      ...
      v8 = 1;
      v11 = 4;
      EtwWriteEx(v3, &PPM_ETW_BIOS_CAP_CHANGE, 0LL, 0, 0LL, 0LL, 3u, &UserData);
    }
  }
}
