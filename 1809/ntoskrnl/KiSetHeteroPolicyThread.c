/*
 * XREFs of KiSetHeteroPolicyThread @ 0x140298F5C
 * Callers:
 *     KeSetHeteroCpuPolicyThread @ 0x14028E160 (KeSetHeteroCpuPolicyThread.c)
 *     KeSetUserHeteroCpuPolicyThread @ 0x14028E17C (KeSetUserHeteroCpuPolicyThread.c)
 *     PopUpdateSingleThreadHeteroPolicies @ 0x140876480 (PopUpdateSingleThreadHeteroPolicies.c)
 * Callees:
