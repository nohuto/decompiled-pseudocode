/*
 * XREFs of MiUnloadSystemImage @ 0x140651AC4
 * Callers:
 ...
 *     LdrUnloadAlternateResourceModule @ 0x14016C8CC (LdrUnloadAlternateResourceModule.c)
 ...
 *     MiVaToSoftwareWsle @ 0x1402CB5A8 (MiVaToSoftwareWsle.c)
...
void __fastcall MiUnloadSystemImage(__int64 BugCheckParameter2, char a2)
{
  ...
  if ( MiIsImportOptimizationEnabled() && v7 && (v23 = MiSectionControlArea((__int64)v7), (v24 = v23) != 0) )
  {
      ...
      && (MiFlags & 0x10000) == 0 )
    {
      ...
      MiWalkEntireImage(v24, qword_140438E58, 0x10u, 0xFFFFFFFF);
    }
  }
  else
  {
  ...
  if ( v8 && (v2 & 1) != 0 )
  {
    ...
    if ( !(unsigned int)MI_IS_PHYSICAL_ADDRESS((unsigned __int64)v4) )
    {
      ...
      qword_140438EF8 = BugCheckParameter2;
      MiDeleteSystemPagableVm((__int64)AnyMultiplexedVm, v29, v52, v8, 5, v43);
      if ( v29 )
        MiWalkEntireImage(v29, (__int64)v47, 4u, 0xFFFFFFFF);
      qword_140438EF8 = 0LL;
      _InterlockedExchangeAdd((_DWORD *)&xmmword_140438F20 + 3, LODWORD(v43[0]) - LODWORD(v43[3]));
      v33 = v52;
      if ( !v7 )
      {
        MiReleasePrivilegedPtes(v52, (unsigned int)v40);
