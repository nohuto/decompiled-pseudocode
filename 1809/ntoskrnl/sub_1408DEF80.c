/*
 * XREFs of sub_1408DEF80 @ 0x1408DEF80
 * Callers:
...
__int64 __fastcall sub_1408DEF80(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // ebx
  __int64 v8; // r15
  signed int v9; // r8d
...
LABEL_45:
    if ( v9 >= 0 )
    {
      v24 = qword_14096D3B8 ? qword_14096D3B8(v8, v22, v61, 256LL) : -1073741637;
      v9 = v24;
      if ( v24 >= 0 )
      {
        v25 = -1;
