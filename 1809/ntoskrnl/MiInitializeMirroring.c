/*
 * XREFs of MiInitializeMirroring @ 0x1409BCF88
 * Callers:
...
__int64 MiInitializeMirroring()
{
  ...
  stru_14043A788.List.Flink = 0LL;
  stru_14043A770.Header.WaitListHead.Blink = &stru_14043A770.Header.WaitListHead;
  stru_14043A770.Header.WaitListHead.Flink = &stru_14043A770.Header.WaitListHead;
  LOWORD(stru_14043A770.Header.Lock) = 1;
  stru_14043A788.WorkerRoutine = (void (__fastcall *)(void *))MiFinishResume;
  stru_14043A770.Header.Size = 6;
  stru_14043A770.Header.SignalState = 1;
  ...
  if ( PoolWithTag )
  {
    ...
    while ( 1 )
    {
      v6 = MiReservePtes((__int64)&qword_14043AFA0, (unsigned __int64 *)0x200000);
      ...
      *(_OWORD *)v3 = v19[0];
      ...
      if ( v5 >= 2 )
      {
        if ( (dword_140540184 & 1) != 0 )
        {
          ...
          ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_14043C9F8, 0LL);
          MiUpdateMirrorBitmaps();
          if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_14043C9F8, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
            ExfTryToWakePushLock((volatile signed __int64 *)&qword_14043C9F8);
          v20 = 0;
          v8 = KeGetCurrentThread();
          if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)&qword_14043C9F8) == 1 )
          ...
          while ( 1 )
          {
            ...
            if ( (v16->AcquiredByte & 1) != 0
              ...
              && (*(_QWORD *)&v16->LockState.0 & 0x7FFFFFFFFFFFFFFCLL) == ((unsigned __int64)&qword_14043C9F8 & 0x7FFFFFFFFFFFFFFCLL)
...
LABEL_16:
            if ( (*((_DWORD *)&v8->0 + 1) & 0x10000) == 0 )
              KeBugCheckEx(0x162u, (ULONG_PTR)v8, (ULONG_PTR)&qword_14043C9F8, (unsigned int)SessionId, 0LL);
            goto LABEL_28;
          }
          v16->CrossThreadReleasableAndBusyByte |= 2u;
          if ( (__int64)v16->LockState.LockState < 0 )
            KiAbEntryRemoveFromTree((__int64)&v8->LockEntries[v15], SessionId);
          v20 = 0;
...
LABEL_28:
          ...
          KiAbThreadRemoveBoosts((ULONG_PTR)v8, (__int64)&qword_14043C9F8, (__int64)&v20);
