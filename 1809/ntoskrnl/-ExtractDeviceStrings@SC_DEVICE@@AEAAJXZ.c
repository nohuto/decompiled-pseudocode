/*
 * XREFs of ?ExtractDeviceStrings@SC_DEVICE@@AEAAJXZ @ 0x14032B538
 * Callers:
 ...
 *     ?ScAnsiToUnicodeString@@YAJPEADPEAU_UNICODE_STRING@@@Z @ 0x1406CF300 (-ScAnsiToUnicodeString@@YAJPEADPEAU_UNICODE_STRING@@@Z.c)
 */
