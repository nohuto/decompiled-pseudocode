/*
 * XREFs of MiDeleteAweInfoPages @ 0x140850F98
 * Callers:
...
__int64 __fastcall MiDeleteAweInfoPages(_RTL_BITMAP_EX *a1, __int64 a2, __int64 a3)
{
  ...
  v9 = v7 + 1;
  if ( (v7->SizeOfBitMap & 1) == 0 || KeGetCurrentThread()->ApcState.Process[2].Affinity.Bitmap[7] )
  {
    v10 = 0LL;
    v11 = v8;
    do
    ...
    if ( v5 )
    {
      ...
      if ( v18 == &MiSystemPartition )
        _InterlockedExchangeAdd64(&qword_14043C0D8, -v5);
    }
    if ( v6 )
    {
      if ( v18 == &MiSystemPartition )
