/*
 * XREFs of RtlpHpSegMgrCommitInitiate @ 0x14000C958
 * Callers:
        ...
        unsigned __int8 *a6)
{
  ...
  signed __int16 v30; // [rsp+A0h] [rbp+18h]
            ...
            *(_BYTE *)(v25 + 26) &= ~1u;
            if ( *(_QWORD *)(v25 + 32) )
            {
              if ( v25 )
              {
                ...
                *(_BYTE *)(v25 + 25) &= ~1u;
                *(_QWORD *)(v25 + 32) = 0LL;
                v26 = (v25 - (__int64)CurrentThread - 800) / 96;
                if ( v22 == 1 )
...
LABEL_49:
        ...
        KiAbThreadRemoveBoosts(CurrentThread, v7, &v29);
