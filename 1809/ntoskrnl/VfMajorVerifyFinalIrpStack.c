/*
 * XREFs of VfMajorVerifyFinalIrpStack @ 0x140935C34
 * Callers:
...
__int64 (__fastcall *__fastcall VfMajorVerifyFinalIrpStack(__int64 a1, unsigned __int8 *a2))(_QWORD, _QWORD)
{
  ...
  if ( *a2 > 0x1Bu )
    ...
    v5 = v2;
  v6 = (void (__fastcall *)(__int64))*((_QWORD *)&unk_140987C08 + 12 * v5);
  if ( v6 )
    v6(a1);
  result = qword_140988688;
  if ( qword_140988688 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD))qword_140988688(a1, a2);
  return result;
}
