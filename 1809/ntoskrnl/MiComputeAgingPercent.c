/*
 * XREFs of MiComputeAgingPercent @ 0x14011FF18
 * Callers:
...
unsigned __int64 __fastcall MiComputeAgingPercent(_QWORD *a1)
{
  ...
  while ( v7 );
  v9 = v5 >> 3;
  *(_QWORD *)(v2 + 2344) = (v4 + 7 * v9) >> 3;
  result = *(_DWORD *)(v2 + 128) & 7;
  *(_QWORD *)(v2 + 8 * result + 2280) = v4;
  ++*(_DWORD *)(v2 + 128);
  if ( v4 >= v9 )
  {
    v13 = 3600LL;
