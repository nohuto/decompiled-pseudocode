/*
 * XREFs of DbgkCaptureLiveDump @ 0x140811740
 * Callers:
 ...
 *     DbgkpLkmdSnapData @ 0x14026D950 (DbgkpLkmdSnapData.c)
 *     DbgkpLkmdSnapDataEx @ 0x14026D984 (DbgkpLkmdSnapDataEx.c)
 ...
 *     DbgkpLkmdSqmStatus @ 0x1408122D4 (DbgkpLkmdSqmStatus.c)
...
__int64 __fastcall DbgkCaptureLiveDump(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  {
    EtwRegister(&stru_14035A840, 0LL, 0LL, &RegHandle);
    v10 = RegHandle;
    if ( RegHandle )
