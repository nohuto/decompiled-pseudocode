/*
 * XREFs of sub_1408DDC38 @ 0x1408DDC38
 * Callers:
...
__int64 __fastcall sub_1408DDC38(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // ebx
  __int64 v7; // r13
  signed int v8; // r8d
...
LABEL_79:
  if ( v8 < 0 )
    return (unsigned int)v8;
  v38 = qword_14096D3C0
      ? ((__int64 (__fastcall *)(__int64, _QWORD, __int64, _QWORD, __int64, int, _OWORD *, int))qword_14096D430)(
          v71,
          v23,
          v32,
          v30,
