...
__int64 __fastcall MmCreatePartition(_QWORD *a1, char a2)
{
  ...
  if ( a2 )
  {
    *a1 = &MiSystemPartition;
    result = 0LL;
    qword_14043C9E8 = (__int64)a1;
    return result;
  }
  v4 = MiSizeMemoryListLocks();
  v5 = v4
     + ((1984LL * (unsigned __int16)KeNumberNodes + 11727 + 40LL * (unsigned int)(2 * dword_14043A08C)) & 0xFFFFFFFFFFFFFFF0uLL)
     + 24LL * dword_14043A6F8 * (unsigned int)(unsigned __int16)KeNumberNodes
     + 16LL * (unsigned int)(2 * dword_14043A08C);
  ...
  v7[264] = v9;
  v10 = v9 + 40LL * (unsigned int)dword_14043A08C;
  v7[265] = v10;
  v11 = (v10 + 40LL * (unsigned int)dword_14043A08C + 15) & 0xFFFFFFFFFFFFFFF0uLL;
  v7[517] = v11;
  v12 = v11 + 16LL * (unsigned int)dword_14043A08C;
  v7[518] = v12;
  v13 = 16LL * (unsigned int)dword_14043A08C + v12;
  v7[21] = a1;
  v7[621] = v13;
  v7[629] = v13 + v4;
