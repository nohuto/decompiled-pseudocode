/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x140314F44
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x140315038 (EtwpDequeueBufferPendingCompressionFromQueue.c)
