/*
 * XREFs of SepMaximumAccessCheckEx @ 0x14015C194
 * Callers:
 ...
 *     AuthzBasepSetAccessReasons @ 0x140114790 (AuthzBasepSetAccessReasons.c)
 ...
 *     AuthzBasepObjectInTypeList @ 0x140324E50 (AuthzBasepObjectInTypeList.c)
 */
