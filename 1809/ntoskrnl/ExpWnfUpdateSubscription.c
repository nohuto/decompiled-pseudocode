        ...
        _QWORD *a9)
{
  ...
  *a8 = 0;
  ...
  if ( (a5 & 1) != 0 )
  {
    if ( !(_BYTE)v18 && _InterlockedIncrement((volatile signed __int32 *)(a1 + 160)) == 1 )
      *a7 = 1;
  }
  else if ( (_BYTE)v18 && _InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 160), 0xFFFFFFFF) == 1 )
  {
    *a7 = -1;
  }
  v19 = *((_DWORD *)v13 + 30);
