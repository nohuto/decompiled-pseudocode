/*
 * XREFs of VfMajorIsValidIrpStatus @ 0x140935A9C
 * Callers:
...
__int64 __fastcall VfMajorIsValidIrpStatus(unsigned __int8 *a1, unsigned int a2)
{
  ...
  if ( *a1 > 0x1Bu )
    ...
    v5 = v2;
  v6 = (unsigned int (__fastcall *)(unsigned __int8 *))*((_QWORD *)&unk_140987BF0 + 12 * v5);
  if ( (!v6 || v6(a1)) && qword_140988670 )
    return qword_140988670(a1, a2);
  else
    return 0LL;
}
