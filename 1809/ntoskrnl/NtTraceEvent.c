/*
 * XREFs of NtTraceEvent @ 0x1400CB590
 * Callers:
 *     <none>
 * Callees:
 ...
 *     EtwpGetEventHeaderType @ 0x1400CC2C0 (EtwpGetEventHeaderType.c)
        ...
        PEVENT_TRACE_HEADER TraceHeader)
{
  ...
  return EtwpTraceMessageVa(v64, Data1 | 0x40, (int)v54 + 8, LOWORD(v54->Version), v56, 1);
}
