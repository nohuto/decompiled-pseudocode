/*
 * XREFs of ViDeadlockAddResource @ 0x14093C74C
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( v11 )
  {
    ...
    {
      ViDeadlockPreprocessOptions(byte_140405544, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(0xC4u, 0x1005uLL, a1, v11, 0LL, byte_140405544);
    }
    if ( *(_QWORD *)(v11 + 16) )
    {
      ViDeadlockPreprocessOptions(byte_140405548, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(0xC4u, 0x1005uLL, a1, v11, 1uLL, byte_140405548);
    }
