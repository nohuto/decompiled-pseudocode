...
LABEL_44:
  ...
  v20 = (_QWORD *)v19[2];
  if ( v17 != a3 || v16 != v7 || v20[3] != a2 || v20[4] != v6 )
  {
...
LABEL_31:
  ...
  RtlRbRemoveNode((__int64)(SpinLock + 2), v14);
  v19[5] = -1LL;
  v21 = *v19;
  v22 = (_QWORD *)v19[1];
  ...
  *(_QWORD *)(v21 + 8) = v22;
  ...
  {
    RtlRbRemoveNode((__int64)(SpinLock + 6), (unsigned __int64)v20);
    v20[2] = -1LL;
    v23 = *(_QWORD *)v12;
    v30 = v20;
    if ( (SpinLock[4] & 1) == 0 )
