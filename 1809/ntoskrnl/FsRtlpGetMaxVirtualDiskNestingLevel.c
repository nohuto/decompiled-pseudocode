/*
 * XREFs of FsRtlpGetMaxVirtualDiskNestingLevel @ 0x140192394
 * Callers:
 *     FsRtlQueryMaximumVirtualDiskNestingLevel @ 0x14016CDD0 (FsRtlQueryMaximumVirtualDiskNestingLevel.c)
 * Callees:
