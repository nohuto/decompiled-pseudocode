/*
 * XREFs of FsRtlpGetMaxVirtualDiskNestingLevel @ 0x140192374
 * Callers:
 *     FsRtlQueryMaximumVirtualDiskNestingLevel @ 0x14016CDB0 (FsRtlQueryMaximumVirtualDiskNestingLevel.c)
 * Callees:
