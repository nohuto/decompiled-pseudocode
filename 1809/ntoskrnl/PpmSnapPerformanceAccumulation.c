        ...
        LARGE_INTEGER *a5)
{
  ...
  if ( a3 )
  {
    ...
    if ( QuadPart )
    {
      ...
      {
        v27 = a1[3082];
        v10.QuadPart = *(_QWORD *)(v27.QuadPart + 8LL * DWORD2(xmmword_1404DDAA8)) >> 1;
        if ( (*(_QWORD *)(v27.QuadPart + 8LL * DWORD2(xmmword_1404DDAA8)) & 1) == 0 )
          v10.QuadPart = 0LL;
      }
    }
    if ( !v10.QuadPart )
  ...
  if ( result )
  {
    ...
    if ( v21 )
    {
      if ( a1[3003].LowPart == 3 )
      {
        v21 = *(_QWORD *)(a1[3082].QuadPart + 8LL * DWORD2(xmmword_1404DDAA8)) >> 1;
        if ( (*(_QWORD *)(a1[3082].QuadPart + 8LL * DWORD2(xmmword_1404DDAA8)) & 1) == 0 )
          v21 = 0LL;
      }
    }
    if ( v10.QuadPart == v21 )
