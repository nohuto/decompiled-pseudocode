/*
 * XREFs of MiInitializeDummyPages @ 0x1409B96DC
 * Callers:
...
unsigned __int64 MiInitializeDummyPages()
{
  ...
  *(_QWORD *)(v1 + 16) = v0;
  ...
  qword_14043ADE0 = (v2 >> 63) + v2;
  MiFillPhysicalPages(qword_14043ADE0, qword_14043ADE0, 0LL);
  qword_14043ADC0 = MiAllocateDummyPage();
  *(_QWORD *)(qword_14043ADC0 + 16) = v0;
  qword_14043ADC8 = (qword_14043ADC0 + 0x58000000000LL) / 48;
  MiFillPhysicalPages(qword_14043ADC8, qword_14043ADC8, 0xFFFFFFFFFFFFFFFFuLL);
  ...
  *(_QWORD *)(DummyPage + 16) = v0;
  ...
  qword_14043AE50 = ((qword_14043AE48 & 0xFFFFFFFFFLL) << 12) | MiMakeValidPte(
  ...
  *(_QWORD *)(v7 + 16) = v0;
  ...
  qword_14043AE58 = v8;
  v9 = MiMakeValidPte((((unsigned __int64)MmPfnDatabase >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL, qword_14043ADC8, 1);
  MiFillPhysicalPages(v8, v10, v9);
  result = ((qword_14043AE58 & 0xFFFFFFFFFLL) << 12) | MiMakeValidPte(
                                                         (((unsigned __int64)MmPfnDatabase >> 9) & 0x7FFFFFFFF8LL)
                                                       - 0x98000000000LL,
                                                         qword_14043ADC8,
                                                         134217729) & 0xFFFF000000000FFFuLL;
  qword_14043AE60 = result;
  return result;
}
