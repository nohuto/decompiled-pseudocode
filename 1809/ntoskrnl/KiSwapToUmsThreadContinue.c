/*
 * XREFs of KiSwapToUmsThreadContinue @ 0x14029DB20
 * Callers:
 *     KiUmsTrapEntryContinue @ 0x1401D0BC0 (KiUmsTrapEntryContinue.c)
 *     KiUmsCallEntryContinue @ 0x1401D0D80 (KiUmsCallEntryContinue.c)
