/*
 * XREFs of PropertyEval @ 0x140592A70
 * Callers:
 ...
 *     ArrayContains @ 0x140329BDC (ArrayContains.c)
 *     StringListContains @ 0x140590E1C (StringListContains.c)
 *     CompareFileTimeType @ 0x1409054DC (CompareFileTimeType.c)
              ...
              if ( a5 != 8 )
              {
                switch ( a5 )
                {
                  ...
                  case 3u:
                    ...
                    if ( !v418 )
                    {
                      v412 = *(unsigned __int8 *)Str2;
                      goto LABEL_911;
                    }
                    v419 = v418 - 1;
                    if ( !v419 )
                    {
                      v411 = *(unsigned __int8 *)Str2;
                      goto LABEL_908;
                    }
                    v420 = v419 - 1;
                    if ( !v420 )
...
LABEL_909:
                      ...
                      v412 = *Str2;
LABEL_911:
                      v402 = _mm_cvtsi32_si128(v412);
LABEL_912:
                      *(_QWORD *)&v393 = *(_OWORD *)&_mm_cvtepi32_pd(v402);
                      goto LABEL_949;
                    }
                    v404 = *Str2;
LABEL_865:
...
LABEL_866:
                    *(_QWORD *)&v394 = *(_OWORD *)&_mm_cvtepi32_pd(v403);
                    goto LABEL_853;
                  case 6u:
                    v395 = v14 - 2;
                    if ( v395 )
...
LABEL_925:
            ...
            if ( a5 == 9 )
            {
              ...
              if ( !v437 )
              {
                v394 = (double)(int)*(_QWORD *)Str2;
                if ( *(__int64 *)Str2 < 0 )
                  v394 = v394 + 1.844674407370955e19;
                goto LABEL_853;
              }
              v438 = v437 - 1;
              if ( !v438 )
              {
                v393 = (double)(int)*(_QWORD *)Str2;
                if ( *(__int64 *)Str2 < 0 )
                  v393 = v393 + 1.844674407370955e19;
                goto LABEL_949;
              }
              v439 = v438 - 1;
              if ( !v439 )
...
LABEL_1034:
                      ...
                      v465 = *Str2;
LABEL_1037:
                      v455 = _mm_cvtsi32_si128(v465);
                      goto LABEL_1038;
                    }
                    v466 = *Str2;
LABEL_1040:
                    v456 = _mm_cvtsi32_si128(v466);
                    goto LABEL_1041;
                  }
                  v458 = *Str2;
LABEL_994:
...
LABEL_1038:
                      LODWORD(v447) = _mm_cvtepi32_ps(v455).m128_u32[0];
                      goto LABEL_1064;
                    }
                    v456 = _mm_cvtsi32_si128(*(_DWORD *)Str2);
LABEL_1041:
                    LODWORD(v448) = _mm_cvtepi32_ps(v456).m128_u32[0];
                    goto LABEL_1066;
                  }
                  v457 = _mm_cvtsi32_si128(*(_DWORD *)Str2);
LABEL_995:
                  LODWORD(v114) = _mm_cvtepi32_ps(v457).m128_u32[0];
                  goto LABEL_227;
                case 7u:
                  v441 = v14 - 2;
                  if ( v441 )
...
LABEL_1032:
          ...
          if ( a5 == 9 )
          {
            ...
            if ( !v492 )
            {
              v448 = (float)(int)*(_QWORD *)Str2;
              if ( *(__int64 *)Str2 < 0 )
                v448 = v448 + 1.8446744e19;
              goto LABEL_1066;
            }
            v493 = v492 - 1;
            if ( !v493 )
...
LABEL_141:
          v71 = __OFSUB__(*(_QWORD *)a2, v536);
          v69 = *(_QWORD *)a2 == v536;
          v70 = *(_QWORD *)a2 - v536 < 0;
          goto LABEL_142;
        }
LABEL_1268:
        v561 = v14 - 2;
            ...
            if ( v566 )
            {
              ...
              if ( v567 )
              {
                ...
                if ( v568 )
                {
                  if ( v568 != 1 )
                    goto LABEL_384;
                  v569 = (unsigned int)CompareFileTimeType(a2, Str2) == -1;
                }
                else
                {
                  v569 = (unsigned int)CompareFileTimeType(a2, Str2) == 1;
                ...
                if ( v569 )
                  goto LABEL_14;
                v385 = CompareFileTimeType(a2, Str2);
                goto LABEL_841;
              }
...
LABEL_841:
    ...
    if ( a5 == 21 && v14 == 2 )
    {
      if ( *((_DWORD *)a2 + 4) != *((_DWORD *)Str2 + 4) )
        goto LABEL_13;
      v575 = *(_QWORD *)a2 - *(_QWORD *)Str2;
      if ( *(_QWORD *)a2 == *(_QWORD *)Str2 )
        v575 = *((_QWORD *)a2 + 1) - *((_QWORD *)Str2 + 1);
      v19 = v575 == 0;
      goto LABEL_34;
    }
  }
