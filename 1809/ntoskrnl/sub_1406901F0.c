/*
 * XREFs of sub_1406901F0 @ 0x1406901F0
 * Callers:
 ...
 *     MmProbeAndLockPagesPrivate @ 0x14010CD74 (MmProbeAndLockPagesPrivate.c)
...
__int64 __fastcall sub_1406901F0(__int64 a1, __int64 a2, void **a3)
{
  int v5; // ebx
  _DWORD *v6; // rbx
  __int64 v7; // rdx
  ...
  v34 = 0;
  v35 = 0;
  v43 = (unsigned int)dword_14043FA40;
