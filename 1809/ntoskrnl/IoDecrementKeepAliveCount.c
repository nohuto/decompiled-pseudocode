...
__int64 __fastcall IoDecrementKeepAliveCount(int a1, int a2)
{
  ...
  if ( v2 >= 0 && !v9 )
  {
    v3 = KeAcquireSpinLockRaiseToDpc(&qword_140435F70);
    v5 = v10;
    *(_QWORD *)(v10 + 48) = MEMORY[0xFFFFF78000000014] + 50000000LL;
    ...
    {
      if ( qword_140435FA0 )
        KeAlertThread(qword_140435FA0, 0LL, v4);
    }
    else
    {
      v6 = (__int64 *)qword_140435F68;
      if ( *(PVOID **)qword_140435F68 != &qword_140435F60 )
        __fastfail(3u);
      *(_QWORD *)v5 = &qword_140435F60;
      *(_QWORD *)(v5 + 8) = v6;
      *v6 = v5;
      qword_140435F68 = v5;
      *(_BYTE *)(v5 + 16) = 1;
