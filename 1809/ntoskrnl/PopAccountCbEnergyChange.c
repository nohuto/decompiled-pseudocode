/*
 * XREFs of PopAccountCbEnergyChange @ 0x14071A548
 * Callers:
...
int PopAccountCbEnergyChange()
{
  ...
  *((_QWORD *)&v23 + 1) = 0LL;
  ...
  if ( (__int64 *)qword_140417850 != &qword_140417850 )
  {
    ...
    while ( (__int64 *)v2 != &qword_140417850 );
    LODWORD(v23) = v3;
  }
  if ( v3 != (_DWORD)xmmword_140417A10 || v1 != *((_QWORD *)&xmmword_140417A10 + 1) )
  {
    v4 = v1 - *((_QWORD *)&xmmword_140417A10 + 1);
    xmmword_140417A10 = v23;
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      *(_QWORD *)&v23 = v4;
      ...
      if ( (unk_140417860 & 1) == 0 )
        v8 = "DC Power";
      if ( (unk_140417860 & 2) == 0 )
        v9 = "-";
      if ( (unk_140417860 & 4) == 0 )
        v10 = "-";
      if ( (unk_140417860 & 8) == 0 )
        v11 = "-";
      if ( (unk_140417860 & 0x10) == 0 )
        v12 = "-";
      if ( HIDWORD(qword_140417880) )
      {
        v16 = ((HIDWORD(qword_140417880) >> 1) + 100 * dword_140417864) / HIDWORD(qword_140417880);
        v13 = 100000 * (unsigned __int64)dword_140417864 / HIDWORD(qword_140417880);
      }
      else
      {
        v16 = 0;
      ...
      v50 = 4LL;
      v52 = 4LL;
      LODWORD(v1) = TlgWrite(&pCallbackContext, &unk_14036E90C, 0LL, 0LL, 0x14u, &pData);
    }
  }
  return v1;
}
