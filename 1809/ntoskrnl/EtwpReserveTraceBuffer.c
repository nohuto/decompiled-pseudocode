/*
 * XREFs of EtwpReserveTraceBuffer @ 0x1400C75E0
 * Callers:
 ...
 *     EtwpReserveWithPebsIndex @ 0x1403114D8 (EtwpReserveWithPebsIndex.c)
 ...
 *     EtwpUpdateEventsLostCount @ 0x1401138B4 (EtwpUpdateEventsLostCount.c)
