...
__int64 __fastcall SiGetEfiSystemDevice(int a1, __int64 a2, wchar_t **a3)
{
  ...
  int v30; // [rsp+4Ch] [rbp-75h]
  unsigned int v31; // [rsp+50h] [rbp-71h] BYREF
  PVOID P; // [rsp+58h] [rbp-69h] BYREF
  ULONG Context; // [rsp+60h] [rbp-61h] BYREF
  HANDLE DirectoryHandle; // [rsp+68h] [rbp-59h] BYREF
  wchar_t *v35; // [rsp+70h] [rbp-51h]
  wchar_t **v36; // [rsp+78h] [rbp-49h]
  UNICODE_STRING DestinationString; // [rsp+80h] [rbp-41h] BYREF
  OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+90h] [rbp-31h] BYREF
  _DWORD v39[4]; // [rsp+C0h] [rbp-1h] BYREF
  _BYTE v40[32]; // [rsp+D0h] [rbp+Fh] BYREF
...
LABEL_46:
  ...
  do
  {
    ...
    *(_QWORD *)&v39[1] = 0LL;
    ...
    v18 = 0;
    v39[0] = 1;
    if ( (int)SiIssueSynchronousIoctl(PoolWithTag, v19, v39, v20, v40, 0x20u) >= 0 )
    {
      if ( v40[24] == 15 )
        goto LABEL_34;
      v18 = v40[24] == 16;
