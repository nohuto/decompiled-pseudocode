/*
 * XREFs of RtlFindClearRunsEx @ 0x14016E6B4
 * Callers:
 *     RtlFindLongestRunClearEx @ 0x14016E67C (RtlFindLongestRunClearEx.c)
 * Callees:
 *     <none>
 */
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        ...
        v5 = v13 - v9 + 8;
        v17 = *((_BYTE *)&unk_140360C30 - v9) | byte_140362048[v15] | v14;
        if ( v17 != 0xFF )
        {
          do
          {
            if ( v8 && *(_DWORD *)(a2 + 8LL * (v8 - 1) + 4) >= (unsigned int)RtlpBitsClearAnywhere[v17] )
              break;
            v28 = RtlpBitsClearAnywhere[v17];
            v29 = 0;
            for ( j = byte_140362048[v28]; ((unsigned __int8)j & v17) != 0; j *= 2 )
              ++v29;
            ...
            {
              v31 = (unsigned __int8)v28;
              if ( *((_DWORD *)v35 - 1) >= (unsigned int)(unsigned __int8)v28 )
                break;
              --v33;
              --v34;
              *v35 = *(v35 - 1);
