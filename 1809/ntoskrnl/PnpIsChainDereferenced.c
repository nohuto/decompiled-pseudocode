/*
 * XREFs of PnpIsChainDereferenced @ 0x14015A758
 * Callers:
 ...
 *     PnpUpdateExtensionFlags @ 0x14015A87C (PnpUpdateExtensionFlags.c)
 *     PnpIsAnyDeviceInUse @ 0x14015A8AC (PnpIsAnyDeviceInUse.c)
