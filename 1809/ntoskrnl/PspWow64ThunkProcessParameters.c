/*
 * XREFs of PspWow64ThunkProcessParameters @ 0x140133788
 * Callers:
 *     PspWow64SetupUserProcessAddressSpace @ 0x1400F2994 (PspWow64SetupUserProcessAddressSpace.c)
 * Callees:
...
NTSTATUS __fastcall PspWow64ThunkProcessParameters(__int64 a1, unsigned int *a2, _DWORD *a3)
{
  ...
  if ( result >= 0 )
  {
    ...
    *v26 = v7;
    ...
    PspWow64CopyUnicodeString(&v28, v26 + 169, a2 + 260);
