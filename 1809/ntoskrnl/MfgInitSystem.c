...
__int64 __fastcall MfgInitSystem(__int64 a1)
{
  ...
  LODWORD(qword_140409DE8) = *(_DWORD *)(v2 + 2768);
  PoolWithTag = ExAllocatePoolWithTag(PagedPool, WORD1(qword_140409DE8), 0x5067664Du);
  qword_140409DF0 = PoolWithTag;
  if ( PoolWithTag )
  {
    inited = RtlStringCbCopyW((NTSTRSAFE_PWSTR)PoolWithTag, WORD1(qword_140409DE8), *(NTSTRSAFE_PCWSTR *)(v2 + 2776));
    if ( inited < 0 )
      goto LABEL_22;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&qword_140409DE8;
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    inited = ZwSetValueKey(KeyHandle, &ValueName, 0, 1u, qword_140409DF0, WORD1(qword_140409DE8));
    if ( inited < 0 )
      goto LABEL_22;
