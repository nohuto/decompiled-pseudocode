/*
 * XREFs of wil_details_FeaturePropertyCache_ReportUsageToServiceDirect @ 0x1400F2A68
 * Callers:
 ...
 * Callees:
 *     wil_details_RecordUsageInPropertyCache @ 0x1400F2AE4 (wil_details_RecordUsageInPropertyCache.c)
