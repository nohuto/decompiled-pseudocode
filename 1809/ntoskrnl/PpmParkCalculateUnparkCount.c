/*
 * XREFs of PpmParkCalculateUnparkCount @ 0x140120D00
 * Callers:
...
char PpmParkCalculateUnparkCount()
{
  ...
  do
  {
    ...
    {
      v10 = *(_BYTE *)(v9 + v6 + 120);
      if ( !v10 || ((unsigned __int8)(1 << (v7 + 1)) & *(_BYTE *)(v6 + 138)) != 0 )
        goto LABEL_48;
