/*
 * XREFs of NtSetSystemInformation @ 0x140663E10
 * Callers:
 ...
 *     MiGetThreadPartition @ 0x14013DB40 (MiGetThreadPartition.c)
 ...
 *     KeInitializeEntropySystem @ 0x1407615A4 (KeInitializeEntropySystem.c)
 *     WheaCrashDumpInitializationComplete @ 0x140763AAC (WheaCrashDumpInitializationComplete.c)
 *     CmSetRegistryQuotaInformation @ 0x1407EC634 (CmSetRegistryQuotaInformation.c)
 ...
 *     ExpSetProcessorMicrocodeUpdateInformation @ 0x1408CC92C (ExpSetProcessorMicrocodeUpdateInformation.c)
...
LABEL_407:
        if ( qword_14040DE28 )
          return qword_14040DE28((unsigned int)SystemInformationClass, SystemInformation, (unsigned int)v3);
        return -1073741637;
