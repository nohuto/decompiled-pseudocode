/*
 * XREFs of RtlpHpFixedVsFree @ 0x140141BC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RtlpHpFixedVsFree(unsigned __int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  {
    v20 = RtlpHpAcquireLockExclusive((volatile LONG *)(a1 + 24), *(_DWORD *)(a1 + 32));
    v6 = a3;
    v11 = v20;
  }
  v12 = *(__m128i *)(a1 + 48);
...
LABEL_28:
        if ( (*((_DWORD *)&CurrentThread->0 + 1) & 0x10000) == 0 )
          KeBugCheckEx(0x162u, (ULONG_PTR)CurrentThread, v21, (unsigned int)SessionId, 0LL);
        goto LABEL_40;
      }
      v29->CrossThreadReleasableAndBusyByte |= 2u;
      if ( (__int64)v29->LockState.LockState < 0 )
        KiAbEntryRemoveFromTree((__int64)&CurrentThread->LockEntries[v28], SessionId);
      v35 = 0;
...
LABEL_40:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v21, (__int64)&v35);
      i = CurrentThread->SpecialApcDisable++ == -1;
      if ( i && ($FFD56A4B518EFE5E17FDE2C5CC486782 *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
