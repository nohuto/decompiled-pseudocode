/*
 * XREFs of SepFilterToken @ 0x140657CEC
 * Callers:
 ...
 *     SepDuplicateTokenUserAndGroups @ 0x1408A214C (SepDuplicateTokenUserAndGroups.c)
        ...
        _QWORD *a11)
{
  ...
  struct _SID_AND_ATTRIBUTES *v40; // r14
  int v41; // eax
  unsigned int v42; // eax
  int v43; // r12d
  unsigned int v44; // ecx
  struct _SID_AND_ATTRIBUTES *v45; // r12
  __int64 v46; // r8
  ULONG v47; // r8d
  NTSTATUS v48; // eax
  unsigned int v49; // r13d
  struct _SID_AND_ATTRIBUTES *v50; // r14
  __int64 *v51; // rbx
  __int64 v52; // rdx
  __int64 v53; // rax
      ...
      if ( v22 >= 0 )
      {
        ...
        if ( v22 >= 0 )
        {
          ...
          *((_QWORD *)v29 + 142) = *(_QWORD *)(a1 + 1136);
          ...
          v40 = (struct _SID_AND_ATTRIBUTES *)(v29 + 1168);
          v41 = ((_BYTE)v29 - 112) & 7;
          if ( (((_BYTE)v29 - 112) & 7) != 0 )
          {
            v40 = (struct _SID_AND_ATTRIBUTES *)((char *)v40 + (unsigned int)(8 - v41));
            puResult[0] -= 8 - v41;
          }
          v42 = *(_DWORD *)(a1 + 128);
          v43 = *(_DWORD *)(a1 + 124);
            ...
            *((_DWORD *)v29 + 31) = *(_DWORD *)(a1 + 124);
            v48 = RtlCopySidAndAttributesArray(
                    ...
                    *(PSID_AND_ATTRIBUTES *)(a1 + 152),
                    ...
                    &RemainingSidArea,
                    puResult);
            v45 = (struct _SID_AND_ATTRIBUTES *)RemainingSidArea;
            v34 = v48;
          }
          v49 = 0;
          v50 = (struct _SID_AND_ATTRIBUTES *)((char *)v40 + (unsigned int)(16 * *(_DWORD *)(a1 + 124)));
          v79 = (__int64 **)(v29 + 160);
          *((_QWORD *)v29 + 20) = v50;
          if ( a8 )
          {
            ...
            do
            {
              ...
              if ( !(_DWORD)v52 || (unsigned __int8)SepSidInSidAndAttributes(*(_QWORD *)(a1 + 160), v52, v46, *v51) )
              {
                ...
                v45 = (struct _SID_AND_ATTRIBUTES *)RemainingSidArea;
                ++v50;
                LODWORD((*v79)[2 * (unsigned int)(*((_DWORD *)v25 + 32))++ + 1]) = 7;
              }
              ++v49;
              v51 += 2;
            }
                ...
                if ( v34 >= 0 )
                {
                  ...
                  if ( v34 >= 0 )
                  {
                    ...
                    *((_QWORD *)Object + 21) = &v56[v61];
                    ...
                    RtlSidHashInitialize(*v85, v67[31], (_QWORD *)v67 + 29);
                    RtlSidHashInitialize(*v59, *((_DWORD *)v25 + 32), (_QWORD *)v67 + 63);
                    ...
                    SeReleaseSubjectContext(&SubjectContext);
                    if ( *v86 )
                      RtlSidHashInitialize(*v86, *v88, v87);
