/*
 * XREFs of PfFbBufferListAllocateTemporary @ 0x1400E2A84
 * Callers:
 *     PfpEventHandleOutOfBuffers @ 0x1400E2A60 (PfpEventHandleOutOfBuffers.c)
 *     PfpSectInfoHandleOutOfBuffers @ 0x1406DC140 (PfpSectInfoHandleOutOfBuffers.c)
 * Callees:
