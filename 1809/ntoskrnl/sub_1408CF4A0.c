/*
 * XREFs of sub_1408CF4A0 @ 0x1408CF4A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1408CF4A0(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // ebx
          ...
          *(_QWORD *)&v20 = 0LL;
          ...
          if ( !updated )
          {
            if ( (_DWORD)v12 )
            {
              ...
              if ( v14 <= v11 )
                updated = ExpLicUpdateChecksum((__int64)qword_14096FD00, v12, &v18);
            }
          }
          if ( updated )
          {
