/*
 * XREFs of ?WritePartitionTable@SC_DISK@@QEAAJPEAVSC_DISK_LAYOUT@@@Z @ 0x140329CF0
 * Callers:
 ...
 *     ?Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z @ 0x14032AE0C (-Initialize@SC_MBR@@QEAAXPEAVSC_DISK@@@Z.c)
