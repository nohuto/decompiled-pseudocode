/*
 * XREFs of DbgkpQueueMessage @ 0x140810604
 * Callers:
...
__int64 __fastcall DbgkpQueueMessage(_QWORD *Object, char *a2, __int64 a3, int a4, PRKEVENT a5)
{
  __int64 v6; // r12
  ...
  if ( (a4 & 2) == 0 )
  {
    ...
    v14 = *(_DWORD *)(a3 + 40);
    a5 = (PRKEVENT)Object[132];
    if ( (unsigned int)(v14 - 1) <= 1 && (a2[1744] & 0x40) != 0 )
      a5 = 0LL;
    if ( v14 == 5 )
    {
      if ( ((unsigned __int8)a4 & (unsigned __int8)a2[1744] & 0x40) == 0 )
      {
LABEL_14:
    ...
    if ( (unsigned int)(v14 - 3) <= 1 && a2[1744] < 0 )
      a5 = 0LL;
    goto LABEL_14;
  }
