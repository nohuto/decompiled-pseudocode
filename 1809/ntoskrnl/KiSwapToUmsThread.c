/*
 * XREFs of KiSwapToUmsThread @ 0x140845790
 * Callers:
 *     KiUmsTrapEntry @ 0x1401D0A80 (KiUmsTrapEntry.c)
 *     KiUmsCallEntry @ 0x1401D0C80 (KiUmsCallEntry.c)
 ...
 *     RtlXSave @ 0x14012E75C (RtlXSave.c)
 *     __security_check_cookie @ 0x140193FF0 (__security_check_cookie.c)
 *     ZwTerminateProcess @ 0x1401B86F0 (ZwTerminateProcess.c)
 *     ZwTerminateThread @ 0x1401B8BD0 (ZwTerminateThread.c)
 *     KeResetLegacyFloatingPointState @ 0x1401BC290 (KeResetLegacyFloatingPointState.c)
 *     KeSaveLegacyFloatingPointControlWord @ 0x1401BC2A0 (KeSaveLegacyFloatingPointControlWord.c)
  ...
  if ( ThreadForTeb )
  {
    ...
    else
    {
      ...
      if ( SBYTE8(PerfGlobalGroupMask[0]) < 0 )
      {
        ...
        v32[3] = v23;
        v34 = v32;
        EtwTraceKernelEvent((__int64)&v34, 1u, 0x40000080u, 0x1920u, 0x401802u);
      }
      ...
      if ( SBYTE8(PerfGlobalGroupMask[0]) < 0 )
      {
        ...
        v37 = v33;
        v38 = 16;
        EtwTraceKernelEvent((__int64)&v37, 1u, 0x40000080u, 0x1921u, 0x401802u);
      }
