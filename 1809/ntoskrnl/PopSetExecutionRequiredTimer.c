/*
 * XREFs of PopSetExecutionRequiredTimer @ 0x140762C18
 * Callers:
...
__int64 PopSetExecutionRequiredTimer()
{
  ...
  if ( qword_140419238 && PopExecutionRequiredTimeout )
  {
    v0 = 10000000LL * (unsigned int)PopExecutionRequiredTimeout;
    if ( MEMORY[0xFFFFF78000000008] - qword_140419238 < v0 )
      v1 = MEMORY[0xFFFFF78000000008] - qword_140419238 - v0;
    else
      v1 = -10000000LL;
