/*
 * XREFs of sub_1401A1740 @ 0x1401A1740
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeCheckProcessorGroupAffinity @ 0x1400D5700 (KeCheckProcessorGroupAffinity.c)
 ...
 *     KiGetNtDdiVersion @ 0x14028F410 (KiGetNtDdiVersion.c)
...
__int64 __fastcall sub_1401A1740(__int64 a1, __int64 a2)
{
...
LABEL_1747:
        ...
        if ( v85 != 30 )
        {
          if ( v85 != 31 )
          {
            if ( v85 == 32 )
            {
              sub_1401AE904(v20, v53);
              goto LABEL_178;
            }
            if ( v85 == 33 )
            {
              sub_1401AD9DC(v20, v53);
              goto LABEL_178;
            }
            if ( v85 != 35 )
            {
...
LABEL_1128:
              ...
              if ( !(_DWORD)v754 )
                goto LABEL_178;
              sub_1401AD8FC(v20, *((_QWORD *)v53 + 1), v754, v2 + 1384);
              v755 = 16;
              v756 = (__int64 *)(v53 + 28);
