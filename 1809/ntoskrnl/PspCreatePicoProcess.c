/*
 * XREFs of PspCreatePicoProcess @ 0x14088C1C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PspCreatePicoProcess(__int64 a1, __int64 a2, HANDLE *a3)
{
  ...
  HANDLE *v24; // [rsp+B0h] [rbp+50h]
  PVOID v25; // [rsp+B8h] [rbp+58h] BYREF
...
LABEL_10:
    ...
    v14 = v25;
    v15 = PsCreateMinimalProcess((struct _KPROCESS *)v25, v12, v13, 0, v7, v11, 2, *(_QWORD *)(a1 + 16), 0LL, &Handle);
    v16 = Handle;
    v8 = v15;
    if ( v15 >= 0 )
    {
