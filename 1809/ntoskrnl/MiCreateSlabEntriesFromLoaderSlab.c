...
__int64 __fastcall MiCreateSlabEntriesFromLoaderSlab(unsigned __int64 a1, unsigned __int64 a2, __int64 a3)
{
  __int64 v3; // rbp
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v8 + 24) = v4;
    ...
    while ( v9 );
    if ( _bittest64((const signed __int64 *)qword_14043E218, v4 >> 9) )
      KeBugCheckEx(0x1Au, 0x3030311uLL, *(_QWORD *)(v8 + 24), 0LL, 0LL);
    _bittestandset64((signed __int64 *)qword_14043E218, v4 >> 9);
