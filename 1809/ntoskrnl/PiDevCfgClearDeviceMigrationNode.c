/*
 * XREFs of PiDevCfgClearDeviceMigrationNode @ 0x14082CDF0
 * Callers:
...
LABEL_5:
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( RegistryValues >= 0 )
    {
      ...
      v12 = (void *)a1[3];
      if ( v12 && RtlInitUnicodeStringEx(&DestinationString, a2) >= 0 )
      ...
      if ( v29.Buffer )
      {
        ...
        while ( *Buffer )
        {
          ...
          if ( (int)SysCtxRegOpenKey(v21, *v18, (__int64)Buffer, 0, 0xF003Fu, (__int64)&v31) >= 0 )
          {
            if ( RtlInitUnicodeStringEx(&DestinationString, a2) >= 0 )
              ZwDeleteValueKey(v31, &DestinationString);
            ZwClose(v31);
          }
