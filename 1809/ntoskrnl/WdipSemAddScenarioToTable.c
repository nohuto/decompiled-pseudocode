  ...
  if ( a1 )
  {
    ...
    if ( dword_14040AAA0 )
    {
      while ( 1 )
      {
        ...
        if ( (unsigned int)v3 >= dword_14040AAA0 )
          goto LABEL_7;
      }
...
LABEL_7:
      if ( (unsigned int)dword_14040AAA0 >= 0x40 )
        ...
        WdipSemScenarioTable[dword_14040AAA0++] = a1;
    }
  }
  else
  {
