  ...
  if ( a1 )
  {
    ...
    if ( dword_14040BF80 )
    {
      while ( 1 )
      {
        ...
        if ( (unsigned int)v3 >= dword_14040BF80 )
          goto LABEL_7;
      }
...
LABEL_7:
      if ( (unsigned int)dword_14040BF80 >= 0x40 )
        ...
        WdipSemScenarioTable[dword_14040BF80++] = a1;
    }
  }
  else
  {
