/*
 * XREFs of sub_1408E5698 @ 0x1408E5698
 * Callers:
...
__int64 __fastcall sub_1408E5698(__int64 *a1, int a2, _DWORD *a3)
{
  int v6; // edi
  void *v7; // rsi
  _DWORD *v8; // r14
  ...
  else
  {
    ...
    if ( v6 >= 0 )
    {
      v6 = sub_140584974(v7, a3[2] & 0xFFFFFFF, (*a3 & 2) == 0, (__int64)Mdl, (__int64)&v13);
      if ( v6 >= 0 )
      {
        v8 = v13;
        if ( !a2
