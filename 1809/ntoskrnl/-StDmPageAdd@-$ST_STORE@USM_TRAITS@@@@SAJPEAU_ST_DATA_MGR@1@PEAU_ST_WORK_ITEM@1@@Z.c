/*
 * XREFs of ?StDmPageAdd@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x140148AF8
 * Callers:
 ...
 *     StIoCountsMovePeriod @ 0x14030696C (StIoCountsMovePeriod.c)
 */
