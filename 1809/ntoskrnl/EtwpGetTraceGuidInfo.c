/*
 * XREFs of EtwpGetTraceGuidInfo @ 0x1408B5E98
 * Callers:
...
__int64 __fastcall EtwpGetTraceGuidInfo(__int64 a1, __int64 a2, int *a3, unsigned int *a4)
{
  ...
  if ( a1 == EtwpHostSiloState )
    ...
    v10 = *(_QWORD *)(*(_QWORD *)(a1 + 8) + 1120LL) + 550LL;
  for ( i = 0; i < 0xA; ++i )
  {
    v12 = 2LL * i;
    ...
    while ( 1 )
    {
      ...
      else if ( *(_BYTE *)(v23 + 100) || *(_BYTE *)(v23 + 101) )
      {
        for ( j = 0; j < 8; ++j )
        {
          ...
          v32 = *(_QWORD *)(v23 + 40);
          v51 = v32;
          if ( v32 && *(_DWORD *)(v30 * 8 + v32) && ((unsigned __int8)(1 << j) & *(_BYTE *)(v23 + 101)) != 0 )
          {
            v48 = v26 + 1;
            if ( RtlUIntAdd(v20, 0x20u, &uAugend) < 0 )
              goto LABEL_57;
      ...
      if ( v20 <= (unsigned int)v4 )
      {
        if ( v22 == 1 )
          v21[3] = 1;
        if ( (*v25 & 2) != 0 )
          v36 = *(_DWORD *)(*(_QWORD *)(v27 + 80) + 736LL);
        else
          v36 = 0;
        v21[2] = v36;
        v21[1] = v26;
