...
LONG PopNewWakeInfo()
{
  ...
  if ( v1 )
  {
    ...
    {
      v7 = (_QWORD *)qword_140418558;
      v8 = *(_QWORD **)(qword_140418558 + 8);
      if ( *(__int64 **)qword_140418558 == &PopWakeInfoList && *v8 == qword_140418558 )
      {
        qword_140418558 = *(_QWORD *)(qword_140418558 + 8);
        *v8 = &PopWakeInfoList;
        v7[1] = v7;
        *v7 = v7;
