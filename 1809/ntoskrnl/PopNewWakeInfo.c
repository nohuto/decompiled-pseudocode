/*
 * XREFs of PopNewWakeInfo @ 0x140566640
 * Callers:
...
LONG PopNewWakeInfo()
{
  ...
  if ( v1 )
  {
    ...
    {
      v7 = (_QWORD *)qword_140418538;
      v8 = *(_QWORD **)(qword_140418538 + 8);
      if ( *(__int64 **)qword_140418538 == &PopWakeInfoList && *v8 == qword_140418538 )
      {
        qword_140418538 = *(_QWORD *)(qword_140418538 + 8);
        *v8 = &PopWakeInfoList;
        v7[1] = v7;
        *v7 = v7;
