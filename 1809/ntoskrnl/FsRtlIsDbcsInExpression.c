/*
 * XREFs of FsRtlIsDbcsInExpression @ 0x140816C70
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)&Namea.Length = v63;
  ...
  do
  {
    ...
    else
    {
      Buffer = v4->Buffer;
      v23 = Buffer[v20];
      if ( (unsigned __int8)v23 >= 0x80u && (_BYTE)NlsMbOemCodePageTag && NlsOemLeadByteInfoTable[(unsigned __int8)v23] )
      {
        v24 = 2;
