/*
 * XREFs of PopDiagTraceDirectedDripsMarkDevice @ 0x1408731E4
 * Callers:
...
void __fastcall PopDiagTraceDirectedDripsMarkDevice(__int64 a1)
{
  REGHANDLE v1; // rbx
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_DIRECTED_DRIPS_MARK_DEVICE) )
    {
      ...
      v3 = &v6;
      v4 = 8;
      EtwWrite(v1, &POP_ETW_EVENT_DIRECTED_DRIPS_MARK_DEVICE, 0LL, 2u, &UserData);
    }
  }
}
