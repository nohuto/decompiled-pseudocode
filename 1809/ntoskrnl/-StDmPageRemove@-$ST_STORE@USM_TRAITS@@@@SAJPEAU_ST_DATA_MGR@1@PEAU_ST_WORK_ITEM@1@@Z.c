/*
 * XREFs of ?StDmPageRemove@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x140147D4C
 * Callers:
 ...
 *     ?SmEvictKeys@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KPEAU?$SMKM_STORE@USM_TRAITS@@@@@Z @ 0x1403082A0 (-SmEvictKeys@-$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KPEAU-$SMKM_STORE@USM_TRA.c)
 */
...
LABEL_103:
          ...
          if ( (__int64)v54->LockState.LockState < 0 )
            KiAbEntryRemoveFromTree((__int64)&CurrentThread->LockEntries[v53], v50);
          v58 = 0;
...
LABEL_67:
              ...
              *(_BYTE *)(v41 + 32) |= 2u;
              if ( *(__int64 *)(v41 + 32) < 0 )
                KiAbEntryRemoveFromTree(v41, v36);
              v57 = 0;
