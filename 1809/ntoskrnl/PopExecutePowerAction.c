/*
 * XREFs of PopExecutePowerAction @ 0x1406DE110
 * Callers:
 ...
 *     PopCriticalShutdown @ 0x14086C010 (PopCriticalShutdown.c)
 ...
 *     PopPromoteActionFlag @ 0x1406DE474 (PopPromoteActionFlag.c)
 *     PopCompareActions @ 0x1406DE4C4 (PopCompareActions.c)
...
LABEL_51:
    ...
    *(_DWORD *)(a1 + 4) = v12 | 2;
    ...
    if ( v10 )
    {
      ...
      if ( v10 == 4 )
        v14 = 6;
      v42 = v14;
      if ( (int)PopCompareActions(v10, (unsigned int)qword_140417704) < 0 )
      {
        v18 = 2;
      }
      else
      {
        ...
        if ( v22 > SHIDWORD(qword_140417704) )
        {
          v41 |= v21;
          HIDWORD(qword_140417704) = v22;
        }
      }
      LOBYTE(v16) = 1;
      ...
      else
      {
        ...
        if ( !(unsigned int)PopCompareActions(v32, v31) )
          v33 |= v18;
        LODWORD(qword_140417704) = v10;
        v34 = v33 | 5;
        v29 = v10;
        dword_140417714 = *(_DWORD *)a1;
        dword_140417718 = 0;
        v41 = v34;
        if ( !*(_DWORD *)a1 )
          dword_140417718 = *(_DWORD *)(a1 + 16);
      }
      if ( v29 == 3 )
        LODWORD(qword_140417704) = v18;
      if ( v34 )
      {
        v13 = 1;
        if ( (unsigned __int8)byte_140417701 < (unsigned __int8)v18 )
        {
  ...
  if ( (v36 & 0x20) != 0 )
  {
    if ( v13 )
    {
      v37 = (__int64 *)qword_140417FA8;
      v36 = *(_QWORD *)(a1 + 8) + 32LL;
      if ( *(__int64 **)qword_140417FA8 != &PopActionWaiters )
        __fastfail(3u);
