/*
 * XREFs of ?SmFeStoreEvictKeys@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KK@Z @ 0x140308344
 * Callers:
...
LABEL_26:
  ...
  if ( (__int64)v21->LockState.LockState < 0 )
    KiAbEntryRemoveFromTree((__int64)&v15->LockEntries[v20], SessionId);
  v27 = 0;
