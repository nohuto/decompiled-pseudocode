...
__int64 __fastcall sub_1400076D0(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, __int64 a5)
{
  ...
  if ( !(_DWORD)NumOfElements && byte_14096E4DB == 1 )
  {
    v13 = -1073741772;
    goto LABEL_11;
  }
  v10 = (unsigned int *)off_14096D030;
  if ( off_14096D030 || (v10 = (unsigned int *)Data) != 0LL )
  {
    v11 = *v10;
    if ( v11 == 24 )
    {
    ...
    if ( v11 >= 0x18 )
    {
      v13 = sub_1405A07B0(a1, a2, a3, a4, a5);
      goto LABEL_11;
    }
  }
  v13 = -1073741762;
LABEL_11:
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_14096E4E0, 0LL, 17LL) != 17 )
    ExfReleasePushLockShared(&qword_14096E4E0);
