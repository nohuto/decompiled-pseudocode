/*
 * XREFs of SymCryptParallelSha256AppendBlocks_xmm @ 0x1401B0D80
 * Callers:
  ...
  *a4 = v12;
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
                ...
                _mm_add_epi32(
                  _mm_add_epi32(
                    _mm_add_epi32(
                      ...
                      v46[7]),
                    v50),
                  _mm_xor_si128(_mm_and_si128(_mm_xor_si128(v55, v49), v57), v49)),
                _mm_shuffle_epi32(_mm_cvtsi32_si128(v44[1]), 0));
        v44 += 4;
      ...
      v59 = _mm_add_epi32(_mm_loadu_si128(a4 + 3), v43);
      a4[11] = v59;
      v60 = _mm_loadu_si128(a4 + 2);
      a4[3] = v59;
      v61 = _mm_add_epi32(v60, v45);
      a4[10] = v61;
      v62 = _mm_loadu_si128(a4 + 1);
      a4[2] = v61;
      v63 = _mm_add_epi32(v62, v47);
      a4[9] = v63;
      v64 = _mm_loadu_si128(a4);
      a4[1] = v63;
      v65 = _mm_add_epi32(v64, v48);
      a4[8] = v65;
      *a4 = v65;
      a4[7] = _mm_add_epi32(_mm_loadu_si128(a4 + 7), a4[71]);
      v66 = _mm_loadu_si128(a4 + 5);
      a4[6] = _mm_add_epi32(_mm_loadu_si128(a4 + 70), a4[6]);
      v67 = _mm_loadu_si128(a4 + 4);
      a4[5] = _mm_add_epi32(v66, a4[69]);
      a4[4] = _mm_add_epi32(v67, a4[68]);
      --v21;
    }
    while ( v21 );
  }
  v68 = _mm_loadu_si128(a4 + 10);
  v69 = _mm_loadu_si128(a4 + 11);
  v70 = _mm_loadu_si128(a4 + 9);
  v71 = _mm_unpacklo_epi32(v69, v68);
  v72 = _mm_unpackhi_epi32(v69, v68);
  v73 = _mm_loadu_si128(a4 + 8);
  v74 = _mm_unpackhi_epi32(v70, v73);
  v75 = _mm_unpacklo_epi32(v70, v73);
  **a1 = _mm_unpacklo_epi64(v71, v75);
  *a1[1] = _mm_unpackhi_epi64(v71, v75);
  *a1[2] = _mm_unpacklo_epi64(v72, v74);
  *a1[3] = _mm_unpackhi_epi64(v72, v74);
