/*
 * XREFs of CcMapAndCopyFromCache @ 0x140639780
 * Callers:
...
char __fastcall CcMapAndCopyFromCache(__int64 a1, __int64 a2, unsigned int a3, char a4, char *a5, _DWORD *a6, int a7)
{
  ...
  volatile signed __int32 *v21; // [rsp+A0h] [rbp+8h] BYREF
  ...
  while ( 1 )
  {
    VirtualAddress = CcGetVirtualAddress(v12, v10, &v21, &Size, 0, v13 == 0LL);
    v16 = v21;
...
LABEL_12:
  ...
  {
    LOBYTE(v15) = 1;
    CcUpdateSharedCacheMapFlag((_QWORD *)v12, 8LL, v15);
    RtlRaiseStatus(v11);
  }
LABEL_14:
  if ( (*(_DWORD *)(v12 + 152) & 8) != 0 )
    CcUpdateSharedCacheMapFlag((_QWORD *)v12, 8LL, 0LL);
  return 1;
}
