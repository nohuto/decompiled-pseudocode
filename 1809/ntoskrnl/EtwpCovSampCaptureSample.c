/*
 * XREFs of EtwpCovSampCaptureSample @ 0x140316DC4
 * Callers:
 *     EtwpCovSampProfileInterrupt @ 0x140317180 (EtwpCovSampProfileInterrupt.c)
 *     EtwpCoverageSamplerContextSwap @ 0x14031779C (EtwpCoverageSamplerContextSwap.c)
 *     EtwpCoverageSamplerPageFault @ 0x140317964 (EtwpCoverageSamplerPageFault.c)
 *     EtwpCoverageSamplerReadyThread @ 0x140317B74 (EtwpCoverageSamplerReadyThread.c)
 * Callees:
...
char __fastcall EtwpCovSampCaptureSample(unsigned __int64 a1, unsigned int a2)
{
  ...
  v5 = qword_140409E28;
  v6 = 0LL;
  v7 = (*(_QWORD *)(qword_140409E28 + 8) >> 4) & 0x1FFLL;
  v8 = ((unsigned int)*(_QWORD *)(qword_140409E28 + 8) >> 13) & 0x3FFFF;
  ...
  else
  {
    ...
    {
      v10 = EtwpCovSampCaptureBufferGet(qword_140409E28);
      v6 = v10;
      if ( v10 )
      {
