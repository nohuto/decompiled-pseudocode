        ...
        __int64 a10)
{
  ...
  *a1 = 0LL;
  ...
  v39 = v11;
  v36 = v12;
  v13 = v11.m128i_i64[0] & qword_1405416A8[(unsigned __int16)_mm_extract_epi16(v11, 4)];
  v14 = *(_BYTE *)(a10 + 16);
  v39.m128i_i64[0] = v13;
  v51 = v14;
  if ( !*(_DWORD *)(a10 + 8)
    && !((unsigned __int8 (__fastcall *)(_QWORD, _QWORD))off_1403FE4C0[0])(0LL, *(unsigned int *)(a10 + 64))
