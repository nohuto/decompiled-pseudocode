/*
 * XREFs of PiCMQueryRemove @ 0x140839894
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  *a6 = 0;
  ...
  v7 = SourceString;
  v14 = v39;
  if ( (byte_140406847 & 4) != 0 )
    McTemplateK0dz(v11, &KMPnPEvt_CfgMgr_QueryRemove_Start, v13, v39, SourceString);
  if ( !v7 || v37 != 1 )
  {
...
LABEL_33:
  ...
  if ( v36 )
    goto LABEL_24;
  v8 = 2;
  if ( (int)CmGetDeviceStatus(PiPnpRtlCtx, v7, 0, &v29, &v34, &v33, v24) < 0 )
  {
