/*
 * XREFs of IopDeleteIoCompletionInternal @ 0x1400FA85C
 * Callers:
 *     IopCloseIoCompletion @ 0x140685770 (IopCloseIoCompletion.c)
 *     IopDeleteIoCompletion @ 0x1406857A0 (IopDeleteIoCompletion.c)
 * Callees:
