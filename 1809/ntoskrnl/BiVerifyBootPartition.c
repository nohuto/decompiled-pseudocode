/*
 * XREFs of BiVerifyBootPartition @ 0x140715DA4
 * Callers:
...
__int64 __fastcall BiVerifyBootPartition(int *a1, _QWORD *a2, _QWORD *a3, _QWORD *a4, _QWORD *a5, unsigned int *a6)
{
  ...
  _DWORD *v30; // [rsp+30h] [rbp-58h] BYREF
...
LABEL_5:
  ...
  v22 = BiConvertBootEnvironmentDeviceToNt(v21, 0, 0, &v30, &v31);
  v7 = v30;
  v17 = v22;
  if ( v22 >= 0 )
  {
    if ( (unsigned int)v31 >= 0x2E && *v30 == 3 && (v23 = (unsigned int)v30[5], *(_DWORD *)((char *)v30 + v23) == 2) )
    {
      v24 = (char *)v30 + v23;
      v25 = -1LL;
      v26 = -1LL;
