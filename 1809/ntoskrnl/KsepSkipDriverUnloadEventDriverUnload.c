/*
 * XREFs of KsepSkipDriverUnloadEventDriverUnload @ 0x1402A196C
 * Callers:
 *     KseSkipDriverUnloadCallbackHookDriverUnload @ 0x1402A1810 (KseSkipDriverUnloadCallbackHookDriverUnload.c)
 *     KseSkipDriverUnloadHookDriverUntargeted @ 0x1402A1850 (KseSkipDriverUnloadHookDriverUntargeted.c)
 * Callees:
