/*
 * XREFs of IopCompleteRequest @ 0x1400BFD10
 * Callers:
 ...
 *     IopAbortRequest @ 0x140819360 (IopAbortRequest.c)
 * Callees:
 ...
 *     IopUpdateWriteTransferCount @ 0x14011ED38 (IopUpdateWriteTransferCount.c)
