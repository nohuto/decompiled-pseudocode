/*
 * XREFs of IopCallDriverReference @ 0x1400B6B90
 * Callers:
...
__int64 __fastcall IopCallDriverReference(PDEVICE_OBJECT DeviceObject, PIRP Irp, char a3, _QWORD *a4, int a5)
{
  ...
  else
  {
    ...
    if ( BaseIoPriorityThread < v10 && v12 == KeGetCurrentThread() && v12[1].Timer.DueTime.LowPart )
...
LABEL_10:
    ...
    && (*(_BYTE *)v18 & 2) != 0 )
  {
    ...
    CurrentThread[1].WaitBlock[0].SparePtr = &v26;
