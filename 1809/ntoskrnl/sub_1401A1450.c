/*
 * XREFs of sub_1401A1450 @ 0x1401A1450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1401A1450(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v7 = *(_QWORD *)(a1 + 32);
  v8 = 1;
  v9 = (unsigned __int64)&qword_140405648 ^ ((v7 ^ (v7 >> 4)) >> 4);
  v10 = v9;
  if ( (v9 & 0xF) != 0 )
    v8 = v9 & 0xF;
  for ( ; v8; --v8 )
