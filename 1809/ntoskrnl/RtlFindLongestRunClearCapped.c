/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x1402EE6B0
 * Callers:
...
LABEL_45:
    ...
    v16 = 8 * v14 - v15 + 8;
    for ( i = *((_BYTE *)&unk_140360C30 - v15) | byte_140362048[v21] | v18; ; i |= v25 )
    {
