/*
 * XREFs of RtlFindLongestRunClearCapped @ 0x1402EE9A0
 * Callers:
...
LABEL_45:
    ...
    v16 = 8 * v14 - v15 + 8;
    for ( i = *((_BYTE *)&unk_140361CD0 - v15) | byte_1403630E8[v21] | v18; ; i |= v25 )
    {
      if ( i == 0xFF || (v24 = RtlpBitsClearAnywhere[i], v11 >= (unsigned int)v24) )
      {
        v20 = v35;
        goto LABEL_22;
      }
      v25 = byte_1403630E8[v24];
      v26 = 0;
