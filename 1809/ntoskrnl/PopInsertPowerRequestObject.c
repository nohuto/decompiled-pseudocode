...
_QWORD *__fastcall PopInsertPowerRequestObject(_QWORD *a1, char a2)
{
  ...
  if ( !a2 )
  {
    result = (_QWORD *)qword_1404193F8;
    if ( *(__int64 **)qword_1404193F8 == &PopPowerRequestObjectList )
    {
      ++PopPowerRequestObjectCount;
      *a1 = &PopPowerRequestObjectList;
      a1[1] = result;
      *result = a1;
      qword_1404193F8 = (__int64)a1;
      return result;
    }
LABEL_6:
    __fastfail(3u);
  }
  result = (_QWORD *)qword_140419408;
  if ( *(__int64 **)qword_140419408 != &PopSpecialPowerRequestObjectList )
    goto LABEL_6;
  ++PopSpecialPowerRequestObjectCount;
  *a1 = &PopSpecialPowerRequestObjectList;
  a1[1] = result;
  *result = a1;
  qword_140419408 = (__int64)a1;
  return result;
}
