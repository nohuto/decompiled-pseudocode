/*
 * XREFs of KsepDbCacheQueryDevice @ 0x140720AD8
 * Callers:
...
__int64 __fastcall KsepDbCacheQueryDevice(PCWSTR SourceString, int a2, int a3, int a4, void *a5)
{
  ...
  v11 = KsepCacheLookup(qword_14043C8F8, (__int64)v15);
  if ( v11 )
    DeviceData = KsepDbCacheQueryDeviceData((int)v11, a2, a3, a4, a5);
  v12 = (volatile signed __int64 *)qword_14043C8F8;
  v13 = _InterlockedExchangeAdd64((volatile signed __int64 *)qword_14043C8F8, 0xFFFFFFFFFFFFFFFFuLL);
  if ( (v13 & 2) != 0 && (v13 & 4) == 0 )
