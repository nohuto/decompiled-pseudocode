/*
 * XREFs of PnpLogActionQueueEvent @ 0x14015F76C
 * Callers:
...
__int64 __fastcall PnpLogActionQueueEvent(__int64 a1, int a2, __int64 a3, char a4)
{
  ...
  if ( a2 == 8 )
  {
    ...
    if ( (_DWORD)a3 )
    {
      ...
      {
        if ( (_DWORD)a3 != 2 || (byte_140405847 & 8) == 0 )
          return result;
        if ( a1 )
          v6 = *(_QWORD *)(a1 + 48);
...
LABEL_9:
    ...
    if ( (_DWORD)a3 )
    {
      ...
      else if ( (_DWORD)a3 == 2 && (byte_140405847 & 8) != 0 )
      {
        if ( a1 )
          v5 = *(_QWORD *)(a1 + 48);
    ...
    if ( a2 != 14 )
    {
      if ( a2 > 20 && a2 <= 24 )
      {
        ...
        if ( (_DWORD)a3 )
        {
          ...
          else if ( (_DWORD)a3 == 2 && (byte_140405845 & 0x20) != 0 )
          {
            if ( a1 )
              v8 = *(_QWORD *)(a1 + 48);
  ...
  if ( (_DWORD)a3 )
  {
    ...
    else if ( (_DWORD)a3 == 2 && (byte_140405847 & 0x10) != 0 )
    {
      if ( a1 )
        v7 = *(_QWORD *)(a1 + 48);
