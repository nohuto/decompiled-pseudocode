/*
 * XREFs of SecureDump_Init @ 0x140180D40
 * Callers:
...
LABEL_4:
    ...
    if ( v2 >= 0 )
    {
      ...
      if ( v2 >= 0 )
      {
        a2 = (dword_1404389EC + pcbResult + 8279) & 0xFFFFF000;
        dword_140438A20 = a2;
        goto LABEL_4;
      }
    }
  ...
  switch ( SecureDmpEncryptionContext )
  {
    ...
    default:
      if ( v2 < 0 )
      {
        ...
        if ( qword_1404389F8 )
        {
          ExFreePoolWithTag(qword_1404389F8, 0);
          qword_1404389F8 = 0LL;
        }
        if ( qword_1404389F0 )
        {
          ExFreePoolWithTag(qword_1404389F0, 0);
          qword_1404389F0 = 0LL;
        }
        if ( pbInput )
        {
