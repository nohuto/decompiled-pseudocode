/*
 * XREFs of PopPublishAndPurgePowerRequestStats @ 0x14087AE3C
 * Callers:
 ...
 *     PoResetStopWatch @ 0x1402E916C (PoResetStopWatch.c)
  ...
  do
  {
    ...
    if ( StopWatchByRequestType )
    {
      ...
      if ( pCallbackContext.LevelPlus1 > 5 )
      {
        ...
        v40 = 4LL;
        v42 = 1LL;
        TlgWrite(&pCallbackContext, &unk_1403710E1, 0LL, 0LL, 7u, &pData);
      }
      if ( v13 )
      {
