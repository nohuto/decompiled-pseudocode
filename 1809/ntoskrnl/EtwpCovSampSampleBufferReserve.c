/*
 * XREFs of EtwpCovSampSampleBufferReserve @ 0x140317758
 * Callers:
...
__int64 __fastcall EtwpCovSampSampleBufferReserve(__int64 a1, __int16 a2, __int64 *a3)
{
  ...
  v4 = 0LL;
  v5 = ((unsigned int)*(_QWORD *)(a1 + 8) >> 13) & 0x3FFFF;
  v7 = (*(_QWORD *)(a1 + 8) >> 4) & 0x1FFLL;
  _BitScanReverse(&v8, v5);
  v9 = 0LL;
  v10 = *(_QWORD *)(*((_QWORD *)KeGetCurrentPrcb()->ExSaPageArray + v8 - 2) + 8LL * (v5 ^ (1 << v8)) + 8) + 8 * v7;
  v11 = 7 - ((a2 + 7) & 7) + a2 + 8;
