/*
 * XREFs of PnpRecordBlackboxDeviceCompletionQueueInformation @ 0x1406FF9B0
 * Callers:
...
void __fastcall PnpRecordBlackboxDeviceCompletionQueueInformation(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *v1 = 1;
      v1[1] = 72;
      *((_BYTE *)v1 + 8) = *(_BYTE *)(*(_QWORD *)(a1 + 120) + 137LL);
      v1[3] = (v4 - **(_QWORD **)(a1 + 120)) / 0x2710uLL;
      v1[4] = *(_DWORD *)(a1 + 32);
