/*
 * XREFs of sub_1408E6B44 @ 0x1408E6B44
 * Callers:
...
__int64 __fastcall sub_1408E6B44(__int64 a1, unsigned int *a2)
{
  unsigned int v2; // esi
  unsigned int v4; // r8d
  unsigned int v5; // edx
  ...
  if ( v8 >= 0 )
  {
    v8 = sub_140585974(v7, a2[2] & 0xFFFFFFF, (*a2 & 2) == 0, (__int64)&Mdl, (__int64)&v17);
    if ( v8 >= 0 )
    {
      v9 = *(_QWORD *)(a1 + 56);
      v10 = v17;
      ...
      v14 = a2[1] & 0xFFFFFFF;
      v16 = 0;
      v8 = sub_140691C44(1, v7, v17, v11, (__int64 *)(v9 + 72), v14, (__int128 *)(v9 + 80), v15, &v16);
      if ( v8 >= 0 )
      {
