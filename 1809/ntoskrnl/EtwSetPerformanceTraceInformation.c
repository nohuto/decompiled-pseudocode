/*
 * XREFs of EtwSetPerformanceTraceInformation @ 0x1408B9A6C
 * Callers:
 ...
 *     EtwpUpdatePmcCounters @ 0x1408BBE60 (EtwpUpdatePmcCounters.c)
 *     EtwpUpdatePmcEvents @ 0x1408BBF84 (EtwpUpdatePmcEvents.c)
 ...
 *     EtwpUpdateLastBranchTracingEvents @ 0x1408C9B78 (EtwpUpdateLastBranchTracingEvents.c)
 *     EtwpUpdateProcessorTraceConfiguration @ 0x1408C9CBC (EtwpUpdateProcessorTraceConfiguration.c)
 *     EtwpUpdateProcessorTraceEvents @ 0x1408C9D64 (EtwpUpdateProcessorTraceEvents.c)
