/*
 * XREFs of EtwpCoverageSamplerReadyThread @ 0x140317B74
 * Callers:
...
char __fastcall EtwpCoverageSamplerReadyThread(__int64 a1)
{
  ...
  if ( *(struct _KTHREAD **)qword_140409E28 != CurrentThread && *(_QWORD *)qword_140409E28 != a1 )
  {
    CurrentPrcb = KeGetCurrentPrcb();
    CurrentThread = KeGetCurrentThread();
    if ( CurrentThread != CurrentPrcb->IdleThread || CurrentPrcb->NestingLevel > 1u )
    {
      v3 = (*(_QWORD *)(qword_140409E28 + 8) >> 4) & 0x1FFLL;
      v4 = ((unsigned int)*(_QWORD *)(qword_140409E28 + 8) >> 13) & 0x3FFFF;
