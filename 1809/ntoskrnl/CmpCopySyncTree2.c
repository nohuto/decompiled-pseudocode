/*
 * XREFs of CmpCopySyncTree2 @ 0x1407FCC24
 * Callers:
        ...
        int a7)
{
  ...
  char v53; // al
  char v54; // r13
  __int64 v56; // [rsp+30h] [rbp-99h]
  char v57; // [rsp+48h] [rbp-81h]
  int v58; // [rsp+4Ch] [rbp-7Dh]
  int v59; // [rsp+50h] [rbp-79h]
  PVOID P; // [rsp+58h] [rbp-71h]
  unsigned int v61; // [rsp+60h] [rbp-69h]
  _DWORD *v62; // [rsp+68h] [rbp-61h]
  char v63; // [rsp+70h] [rbp-59h]
  int v64; // [rsp+74h] [rbp-55h]
  _DWORD v65[2]; // [rsp+78h] [rbp-51h] BYREF
  _DWORD v66[2]; // [rsp+80h] [rbp-49h] BYREF
  void *Src; // [rsp+88h] [rbp-41h]
  _DWORD v68[2]; // [rsp+90h] [rbp-39h] BYREF
  _DWORD v69[2]; // [rsp+98h] [rbp-31h] BYREF
  _DWORD v70[2]; // [rsp+A0h] [rbp-29h] BYREF
  unsigned int v71; // [rsp+A8h] [rbp-21h] BYREF
  unsigned int v72; // [rsp+ACh] [rbp-1Dh] BYREF
  _DWORD v73[2]; // [rsp+B0h] [rbp-19h] BYREF
  _DWORD v74[2]; // [rsp+B8h] [rbp-11h] BYREF
  _DWORD v75[2]; // [rsp+C0h] [rbp-9h] BYREF
  unsigned __int16 v76[32]; // [rsp+C8h] [rbp-1h] BYREF
  bool v78; // [rsp+120h] [rbp+57h]
  ...
  while ( 2 )
  {
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        v14 = (_DWORD *)(*(__int64 (__fastcall **)(__int64, _QWORD, _DWORD *))(a4 + 8))(a4, *v13, v69);
        v62 = v14;
        v11 = v14;
        if ( !v14 )
        {
        ...
        if ( (int)CmpFindSubKeyByNumber(a4, v14, v13[2], &v71) < 0 )
          goto LABEL_91;
        v15 = v71;
        ++v13[2];
        if ( (_DWORD)v15 != -1 && (v63 || (v15 & 0x80000000) == 0LL) )
          break;
        if ( v78 && a7 != 2 )
        {
        ...
        if ( (v28 & 1) != 0 )
        {
          ...
          v13[2] = 0;
          v35 = v59;
          v13[3] ^= ((unsigned __int8)v59 ^ (unsigned __int8)v34) & 7;
        ...
        else
        {
          ...
          {
            if ( (a6 & 0x40) != 0 )
              *(_DWORD *)(BugCheckParameter2 + 4816) = *(_DWORD *)(BugCheckParameter2 + 272);
            v43 = 0LL;
            v54 = 1;
            v17 = 0LL;
            goto LABEL_97;
          ...
          if ( v35 == (int)(*(_DWORD *)(v39 + 12) << 29) >> 29 )
          {
            ...
            v58 = v38;
            if ( v35 == 1 )
              *(_DWORD *)(BugCheckParameter2 + 4808) = v40;
            else
              *(_DWORD *)(BugCheckParameter2 + 4812) = v40;
          }
        }
        v11 = v62;
...
LABEL_17:
      if ( (a6 & 0x40) == 0 )
        goto LABEL_69;
      v20 = (*(__int64 (__fastcall **)(__int64, _QWORD, _DWORD *))(a4 + 8))(a4, (unsigned int)v15, v65);
      if ( !v20 )
        goto LABEL_91;
      v21 = *(_BYTE *)(v20 + 12);
      if ( (v21 & 2) != 0 )
      ...
      if ( v22 > (int)(v13[3] << 29) >> 29 )
      {
        v23(a4, v65);
LABEL_69:
        v19 = CmpCopyKeyPartial(a4, (unsigned int)v15, BugCheckParameter2, v13[1], a6 | 4u, v56, 2u);
        if ( v19 != -1 )
        {
          v45 = 1;
          if ( (v13[4] & 2) != 0 )
          ...
          if ( HvpMarkCellDirty(BugCheckParameter2, v13[1], 0) )
          {
            *((_BYTE *)v13 + 16) |= 2u;
LABEL_73:
            if ( CmpAddSubKeyEx(BugCheckParameter2, v13[1], v19, v62[(v15 >> 31) + 5]) )
            {
              v46 = v13[1];
              v68[0] = -1;
              v68[1] = 0;
              ...
              if ( v47 )
              {
                ...
                if ( v48 )
                {
                  ...
                  if ( *(_DWORD *)(v47 + 56) < v50 )
                    *(_DWORD *)(v47 + 56) = v50;
                  (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter2 + 16))(BugCheckParameter2, v75);
...
LABEL_26:
    ...
    v16 = (*(__int64 (__fastcall **)(__int64, _QWORD, _DWORD *))(a4 + 8))(a4, (unsigned int)v15, v66);
    v17 = v16;
    if ( !v16 )
      goto LABEL_89;
    ...
    if ( !v18 )
      goto LABEL_89;
    CmpFindSubKeyByNameWithStatus(BugCheckParameter2, v18, v76, &v72);
    v19 = v72;
    (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(BugCheckParameter2 + 16))(BugCheckParameter2, v73);
    if ( v19 == -1 )
    {
