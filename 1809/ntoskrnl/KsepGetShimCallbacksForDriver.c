/*
 * XREFs of KsepGetShimCallbacksForDriver @ 0x140681A38
 * Callers:
...
__int64 __fastcall KsepGetShimCallbacksForDriver(__int64 a1, _QWORD *a2)
{
  ...
  if ( !a2 )
  {
    ...
    dword_14041BCA4[2 * v6] = -1073740768;
  ...
  if ( !(unsigned int)KsepIsModuleShimmed((__int64)&KseEngine, a1, &v26) )
    ...
    while ( 1 )
    {
      if ( (*(_DWORD *)(*(_QWORD *)v9 + 28LL) & 4) == 0 )
      {
        ...
        if ( !v11 )
        {
          ...
          dword_14041BCA4[2 * v12] = -1073740768;
          KsepHistoryErrors[2 * v12] = 459558;
          if ( (KsepDebugFlag & 4) != 0 )
          {
      ...
      switch ( *(_DWORD *)(v18 + v19 + 8) )
      {
        ...
        default:
          ...
          if ( (unsigned int)v20 > 0x1B )
          {
            ...
            dword_14041BCA4[2 * v22] = -1073741811;
...
LABEL_40:
            dword_14041BCA4[2 * v21] = -1073741823;
            if ( (KsepDebugFlag & 2) != 0 )
