/*
 * XREFs of Normalization__NormalizeCharacter @ 0x140898C3C
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x140897D2C (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x140898A98 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x1402F4C04 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1402F4C34 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1402F4C68 (IsHangulLV.c)
 *     NormBuffer__Append @ 0x1402F4C9C (NormBuffer__Append.c)
 ...
 *     NormBuffer__ReplaceLastStartBasePair @ 0x1402F5204 (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x1402F5278 (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x140897D2C (Normalization__AppendDecomposedChar.c)
