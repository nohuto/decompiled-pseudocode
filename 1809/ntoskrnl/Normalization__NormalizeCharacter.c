/*
 * XREFs of Normalization__NormalizeCharacter @ 0x140898C5C
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x140897D4C (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x140898AB8 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x1402F4B04 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1402F4B34 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1402F4B68 (IsHangulLV.c)
 *     NormBuffer__Append @ 0x1402F4B9C (NormBuffer__Append.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x1402F5178 (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x140897D4C (Normalization__AppendDecomposedChar.c)
