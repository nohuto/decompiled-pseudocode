/*
 * XREFs of CmpStartRMLog @ 0x14070F5B4
 * Callers:
...
LABEL_47:
  ...
  *((_QWORD *)a1 + 15) = CLFS_LSN_INVALID_EXT;
  if ( v7 )
  {
    Source = &CmpLogPath;
    if ( a2 )
      *(_OWORD *)(*(_QWORD *)(qword_1403FFFF0 + 64) + 128LL) = *a2;
    started = RtlStringFromGUIDEx((PGUID)(*(_QWORD *)(qword_1403FFFF0 + 64) + 128LL), &GuidString, 1u);
    if ( started < 0 )
      goto LABEL_27;
    v10 = (__int64)(a1 + 72);
