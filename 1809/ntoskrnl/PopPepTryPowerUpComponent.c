/*
 * XREFs of PopPepTryPowerUpComponent @ 0x140100090
 * Callers:
 *     PopPepTriggerComponentActivatingActivity @ 0x1400FFE20 (PopPepTriggerComponentActivatingActivity.c)
 *     PopPepTriggerComponentIdleStateChangeActivity @ 0x140177630 (PopPepTriggerComponentIdleStateChangeActivity.c)
 * Callees:
