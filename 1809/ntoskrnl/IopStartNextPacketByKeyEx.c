/*
 * XREFs of IopStartNextPacketByKeyEx @ 0x1402841D8
 * Callers:
 *     IoStartNextPacket @ 0x140283850 (IoStartNextPacket.c)
 *     IoStartNextPacketByKey @ 0x140283890 (IoStartNextPacketByKey.c)
 * Callees:
