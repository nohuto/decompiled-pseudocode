/*
 * XREFs of IopStartNextPacketByKeyEx @ 0x1402842D8
 * Callers:
 *     IoStartNextPacket @ 0x140283950 (IoStartNextPacket.c)
 *     IoStartNextPacketByKey @ 0x140283990 (IoStartNextPacketByKey.c)
 * Callees:
