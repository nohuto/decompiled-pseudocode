/*
 * XREFs of ?StDmLazyWorkItemQueue@?$ST_STORE@USM_TRAITS@@@@SAKPEAU_ST_DATA_MGR@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x1401465D4
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmLazyWorkItemQueue(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_BYTE *)(a2 + 12) & 1) == 0 )
  {
    ...
    if ( (v4 & 1) == 0 )
    {
      SMKM_STORE<SM_TRAITS>::SmStWorkItemQueue(*(_QWORD *)(a1 + 800), a2, 2LL);
      return 1;
    }
  }
  return v2;
