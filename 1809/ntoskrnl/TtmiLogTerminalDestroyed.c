/*
 * XREFs of TtmiLogTerminalDestroyed @ 0x140885AB0
 * Callers:
 *     TtmpDeleteTerminal @ 0x14087F130 (TtmpDeleteTerminal.c)
 * Callees:
...
void TtmiLogTerminalDestroyed()
{
  ...
  if ( stru_14096D820.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&stru_14096D820, 1uLL) )
    {
      ...
      v1 = v0;
      v4 = 8;
      TlgWrite(&stru_14096D820, &unk_140371503, 0LL, 0LL, 3u, &pData);
    }
  }
}
