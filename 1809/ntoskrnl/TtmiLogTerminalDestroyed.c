/*
 * XREFs of TtmiLogTerminalDestroyed @ 0x140886CF0
 * Callers:
 *     TtmpDeleteTerminal @ 0x140880370 (TtmpDeleteTerminal.c)
 * Callees:
...
void TtmiLogTerminalDestroyed()
{
  ...
  if ( stru_14096E820.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&stru_14096E820, 1uLL) )
    {
      ...
      v1 = v0;
      v4 = 8;
      TlgWrite(&stru_14096E820, &unk_140372626, 0LL, 0LL, 3u, &pData);
    }
  }
}
