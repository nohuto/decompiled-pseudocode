/*
 * XREFs of PopUpdateOverThrottledCount @ 0x14086C800
 * Callers:
 ...
 *     PopDiagTraceThermalOverthrottleState @ 0x1402E1E38 (PopDiagTraceThermalOverthrottleState.c)
