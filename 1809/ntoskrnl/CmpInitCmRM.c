/*
 * XREFs of CmpInitCmRM @ 0x14067F2E8
 * Callers:
...
LABEL_69:
  ...
  *((_DWORD *)v10 + 17) = 0;
  ...
  while ( 1 )
  {
    ...
    v18 = *(void **)(v5 + 1536);
    v20 = RtlStringFromGUIDEx((unsigned int *)(*(_QWORD *)(v5 + 64) + 148LL), (__int64)&UnicodeString, 1);
    if ( v20 < 0 )
    {
      *(_DWORD *)(v5 + 4200) = 3;
      goto LABEL_104;
...
LABEL_51:
  ...
  v32 = (_QWORD *)qword_140437A58;
  if ( *(__int64 **)qword_140437A58 != &CmpRmListHead )
    __fastfail(3u);
  *v10 = &CmpRmListHead;
  v10[1] = v32;
  *v32 = v10;
  qword_140437A58 = (__int64)v10;
