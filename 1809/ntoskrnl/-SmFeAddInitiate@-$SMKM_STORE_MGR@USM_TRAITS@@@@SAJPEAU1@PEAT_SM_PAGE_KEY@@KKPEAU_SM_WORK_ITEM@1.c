/*
 * XREFs of ?SmFeAddInitiate@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAT_SM_PAGE_KEY@@KKPEAU_SM_WORK_ITEM@1@PEAU_SM_IO_CONTEXT@1@K@Z @ 0x14014E29C
 * Callers:
 ...
 *     ?BTreeIteratorFromSearchResult@?$B_TREE@T_SM_PAGE_KEY@@USMKM_FRONTEND_ENTRY@?$SMKM_STORE_MGR@USM_TRAITS@@@@$0BAAA@UB_TREE_DUMMY_NODE_POOL@@U?$B_TREE_KEY_COMPARATOR@T_SM_PAGE_KEY@@@@@@SAXPEAU1@PEAUITERATOR@1@PEAUSEARCH_RESULT@1@@Z @ 0x14014E71C (-BTreeIteratorFromSearchResult@-$B_TREE@T_SM_PAGE_KEY@@USMKM_FRONTEND_ENTRY@-$SMKM_STORE_MGR@USM.c)
...
LABEL_66:
      ...
      if ( (__int64)v45->LockState.LockState < 0 )
        KiAbEntryRemoveFromTree((__int64)&v38->LockEntries[v44], v39);
      v52 = 0;
        ...
        if ( v34->LockState.0 )
        {
          if ( v34 )
          {
            ...
            if ( (__int64)v34->LockState.LockState < 0 )
              KiAbEntryRemoveFromTree((__int64)&v26->LockEntries[v33], v29);
            v54 = 0;
