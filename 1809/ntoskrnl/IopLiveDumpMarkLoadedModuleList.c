/*
 * XREFs of IopLiveDumpMarkLoadedModuleList @ 0x140579EB4
 * Callers:
...
__int64 __fastcall IopLiveDumpMarkLoadedModuleList(__int64 (__fastcall **a1)(_QWORD, __int64, __int64, __int64))
{
  __int64 result; // rax
  PVOID *i; // rbx
