/*
 * XREFs of ?SetPartition@SC_GPT@@QEAAJKPEAU_SET_PARTITION_INFORMATION_EX@@@Z @ 0x14032A268
 * Callers:
...
__int64 __fastcall SC_GPT::SetPartition(SC_GPT *this, int a2, struct _SET_PARTITION_INFORMATION_EX *a3)
{
  unsigned int v6; // ebx
  int v7; // eax
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( (unsigned int)v9 < *((_DWORD *)v12 + 1) )
      {
        ...
        *((_QWORD *)v8 + v10 + 23) = *(_QWORD *)&a3->Gpt.Name[32];
        v6 = SC_GPT::WritePartitionTable(this, v8, 0);
      }
      else
      {
        v6 = -1073741811;
