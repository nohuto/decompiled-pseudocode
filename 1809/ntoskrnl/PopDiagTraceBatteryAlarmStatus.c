/*
 * XREFs of PopDiagTraceBatteryAlarmStatus @ 0x140870764
 * Callers:
  ...
  if ( (unsigned int)v3 <= 1 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v3 )
      {
        ...
        v18 = *(_DWORD *)(a1 + 4);
        v19 = *(_DWORD *)(a1 + 16);
        v20 = (unsigned __int8)byte_140417940;
        v14 = v7;
        v22 = v8;
        ...
        v49 = 4LL;
        v51 = 4LL;
        LOBYTE(v3) = TlgWrite(&pCallbackContext, &unk_14036FA7D, 0LL, 0LL, 0xFu, &pData);
      }
    }
    if ( (unsigned int)dword_140417834 > 1 )
    {
      v10 = qword_140417850;
      v3 = (unsigned __int64)&qword_140417850;
      while ( (__int64 *)v10 != &qword_140417850 )
      {
        ++v6;
        if ( *(_DWORD *)(v10 + 64) )
          v3 = (unsigned __int64)&qword_140417850;
        if ( pCallbackContext.LevelPlus1 > 5 )
        {
          if ( TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
          {
            ...
            v35 = 4LL;
            v37 = 4LL;
            TlgWrite(&pCallbackContext, &unk_14036F9E9, 0LL, 0LL, 8u, &pData);
          }
          v3 = (unsigned __int64)&qword_140417850;
        }
        v10 = *(_QWORD *)v10;
