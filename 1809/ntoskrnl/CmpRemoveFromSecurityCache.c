/*
 * XREFs of CmpRemoveFromSecurityCache @ 0x1406CB800
 * Callers:
...
char __fastcall CmpRemoveFromSecurityCache(__int64 a1, unsigned int a2)
{
  char result; // al
  unsigned int v4; // esi
  __int64 v5; // rbx
  ...
  result = CmpFindSecurityCellCacheIndexNew(a1, a2, &v9);
  if ( result )
  {
    v4 = v9;
    v5 = 16LL * v9;
    v6 = *(_QWORD *)(*(_QWORD *)(a1 + 1880) + v5 + 8);
    v7 = *(_QWORD *)(v6 + 8);
    ...
    *(_QWORD *)(v7 + 8) = v8;
    ...
    result = (unsigned __int8)memmove(
                                (void *)(v5 + *(_QWORD *)(a1 + 1880)),
                                (const void *)(*(_QWORD *)(a1 + 1880) + 16LL * (v4 + 1)),
                                16LL * (*(_DWORD *)(a1 + 1864) - v4 - 1));
    --*(_DWORD *)(a1 + 1864);
  }
  return result;
}
