/*
 * XREFs of AdtpPackageParameters @ 0x140188D7C
 * Callers:
 *     AdtpWriteToEtwEx @ 0x1403258D0 (AdtpWriteToEtwEx.c)
 *     AdtpWriteToEtw @ 0x14074D584 (AdtpWriteToEtw.c)
 * Callees:
 *     AdtpIsCorrectlyFormedUnicodeString @ 0x1401892A0 (AdtpIsCorrectlyFormedUnicodeString.c)
...
LABEL_35:
        ...
        if ( v21 != 5 )
        {
          if ( v21 == 6 )
          {
            v53 = 2LL * v10;
            v54 = v18 + v10;
            v55 = 4 * (unsigned __int8)byte_14096E931 + 8;
