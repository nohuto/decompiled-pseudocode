/*
 * XREFs of SepDeleteSessionLowboxEntries @ 0x14012A040
 * Callers:
      ...
      if ( v15 == -1 )
      {
        ...
        *(_QWORD *)(v25 + 8) = v26;
        ...
        if ( (*((_DWORD *)&v27->0 + 1) & 0x10000) == 0 )
          KeBugCheckEx(0x162u, (ULONG_PTR)v27, (ULONG_PTR)(i + 3), (unsigned int)SessionId, 0LL);
LABEL_61:
        --v27->AbAllocationRegionCount;
        KiAbThreadRemoveBoosts((ULONG_PTR)v27, (__int64)(i + 3), (__int64)&v43);
        v20 = v27->SpecialApcDisable++ == -1;
        if ( v20 && ($FFD56A4B518EFE5E17FDE2C5CC486782 *)v27->ApcState.ApcListHead[0].Flink != &v27->152 )
...
LABEL_34:
        ...
        KiAbThreadRemoveBoosts((ULONG_PTR)v16, v4, (__int64)&v42);
...
LABEL_87:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)v35, (__int64)&LowboxSessionMapLock, (__int64)&v44);
    v20 = v35->SpecialApcDisable++ == -1;
    if ( v20 && ($FFD56A4B518EFE5E17FDE2C5CC486782 *)v35->ApcState.ApcListHead[0].Flink != &v35->152 )
