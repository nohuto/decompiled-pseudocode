/*
 * XREFs of RtlpHpSegSubAllocate @ 0x14000B078
 * Callers:
 *     RtlpHpSegVsAllocate @ 0x14000ACC0 (RtlpHpSegVsAllocate.c)
 *     RtlpHpSegLfhAllocate @ 0x14000B050 (RtlpHpSegLfhAllocate.c)
 * Callees:
