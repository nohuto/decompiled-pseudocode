/*
 * XREFs of GxpReadFrameBufferPixels @ 0x14094E9FC
 * Callers:
 *     BgpGxReadRectangle @ 0x14094E98C (BgpGxReadRectangle.c)
 * Callees:
 *     BgpGetResolution @ 0x14013B8A0 (BgpGetResolution.c)
 *     GxpAdjustRectangleToFrameBuffer @ 0x14016F090 (GxpAdjustRectangleToFrameBuffer.c)
 *     BgpGetBitsPerPixel @ 0x14016F1C0 (BgpGetBitsPerPixel.c)
 *     _guard_dispatch_icall @ 0x1401C5EB0 (_guard_dispatch_icall.c)
 *     memmove @ 0x1401D1440 (memmove.c)
 *     GxpGetRotatedPixelOffset @ 0x14032782C (GxpGetRotatedPixelOffset.c)
 */
...
__int64 __fastcall GxpReadFrameBufferPixels(__int64 a1, unsigned int *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !(_BYTE)BgInternal )
    {
      ...
      v30[1] = *(_DWORD *)(a1 + 4);
      v30[3] = *(_DWORD *)(a1 + 12);
      v30[2] = xmmword_140405A70;
      v31 = *(_QWORD *)(a1 + 24);
      v13 = ((__int64 (__fastcall *)(_DWORD *, unsigned int *, __int64))qword_140405A80)(v30, v2, v12);
      goto LABEL_19;
    }
    v14 = *(char **)(a1 + 24);
    v15 = *(_DWORD *)a1;
    v21 = (char *)qword_140405A80;
    if ( BYTE2(BgInternal) )
    {
      HIDWORD(v35) = 0;
      if ( !v15 )
...
LABEL_30:
    ...
    {
      v16 = (char *)qword_140405A80 + v4 * (*v2 + v23 * v2[1]);
      if ( !v15 )
      {
LABEL_19:
