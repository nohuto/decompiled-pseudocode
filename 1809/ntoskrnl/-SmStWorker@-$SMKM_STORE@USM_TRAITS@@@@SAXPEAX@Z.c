/*
 * XREFs of ?SmStWorker@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAX@Z @ 0x14011E2C0
 * Callers:
                        ...
                        *(_BYTE *)(v13 + 26) &= ~1u;
                        if ( *(_QWORD *)(v13 + 32) )
                        {
                          if ( v13 )
                          {
                            *(_BYTE *)(v13 + 32) |= 2u;
                            if ( *(__int64 *)(v13 + 32) < 0 )
                              KiAbEntryRemoveFromTree(v13, SessionId);
                            v50 = 0;
                    ...
                    *(_BYTE *)(v33 + 26) &= ~1u;
                    if ( *(_QWORD *)(v33 + 32) )
                    {
                      if ( v33 )
                      {
                        *(_BYTE *)(v33 + 32) |= 2u;
                        if ( *(__int64 *)(v33 + 32) < 0 )
                          KiAbEntryRemoveFromTree(v33, v29);
                        v52 = 0;
              ...
              *(_BYTE *)(v42 + 26) &= ~1u;
              if ( *(_QWORD *)(v42 + 32) )
              {
                if ( v42 )
                {
                  *(_BYTE *)(v42 + 32) |= 2u;
                  if ( *(__int64 *)(v42 + 32) < 0 )
                    KiAbEntryRemoveFromTree(v42, v38);
                  v49 = 0;
