/*
 * XREFs of HvpViewMapPromoteRangeToMapping @ 0x1406BB750
 * Callers:
...
__int64 __fastcall HvpViewMapPromoteRangeToMapping(SIZE_T a1, int a2, unsigned int a3, __int64 *a4)
{
  ...
  if ( (__int64)ViewForFileOffset[2].Children[0] < v6 )
  {
    ...
    v12 = HvpViewMapCreateView(a1, (LARGE_INTEGER)(v4 & -MemoryAllocationGranularity), v6, &Node);
    v14 = Node;
    ViewRangeValid = v12;
    if ( v12 >= 0 )
    {
