/*
 * XREFs of MiResolveImageReferences @ 0x140678FD0
 * Callers:
 ...
 *     ApiSetResolveToHost @ 0x140136704 (ApiSetResolveToHost.c)
 ...
 *     MiPrepareImportList @ 0x1406C8870 (MiPrepareImportList.c)
