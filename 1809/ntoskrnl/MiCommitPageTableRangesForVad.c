/*
 * XREFs of MiCommitPageTableRangesForVad @ 0x1402BA05C
 * Callers:
...
__int64 __fastcall MiCommitPageTableRangesForVad(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 16) = 1LL;
  ...
  if ( (*((_DWORD *)&v11->0 + 1) & 0x10000) == 0 )
    KeBugCheckEx(0x162u, (ULONG_PTR)v11, v7, (unsigned int)SessionId, 0LL);
LABEL_27:
  --v11->AbAllocationRegionCount;
  KiAbThreadRemoveBoosts((ULONG_PTR)v11, v7, (__int64)&v22);
  v15 = v11->SpecialApcDisable++ == -1;
  if ( v15 && ($FFD56A4B518EFE5E17FDE2C5CC486782 *)v11->ApcState.ApcListHead[0].Flink != &v11->152 )
