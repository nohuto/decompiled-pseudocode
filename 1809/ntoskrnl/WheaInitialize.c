/*
 * XREFs of WheaInitialize @ 0x1409AFD68
 * Callers:
 ...
 *     WheapQueryPshedForErrorSources @ 0x1409B0110 (WheapQueryPshedForErrorSources.c)
 */
...
__int64 __fastcall WheaInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( a2 )
  {
    *(_QWORD *)&WheapDispatchPtr.DeviceLock.Header.Lock = &WheapDispatchPtr.SecurityDescriptor;
    ...
    v19 = KeAbPreAcquire((ULONG_PTR)&WheapDispatchPtr.Dpc.DpcData, 0LL, 0);
    v20 = _interlockedbittestandset64((volatile signed __int32 *)&WheapDispatchPtr.Dpc.DpcData, 0LL);
    v21 = v19;
    if ( v20 )
          ...
          *(_QWORD *)(*(_QWORD *)(Prcb + 24608) + 8LL) = &WheapErrorSourceTable )
    {
      ...
      *(_QWORD *)(*(_QWORD *)(Prcb + 24608) + 16LL) = &WheapDispatchPtr.DeviceLock.Header.WaitListHead;
    }
    for ( j = qword_1404C64A8; (__int64 *)j != &qword_1404C64A8; j = *(_QWORD *)j )
    {
      if ( *(_DWORD *)(j + 97) == 7 )
      {
    ...
    for ( k = qword_1404C64A8; (__int64 *)k != &qword_1404C64A8; ++v2 )
    {
      v13 = *(_DWORD *)(k + 97) == 7;
      *(_DWORD *)(k + 117) = v2;
      if ( !v13 && !*(_BYTE *)(k + 88) )
    ...
    *(_QWORD *)&WheapDispatchPtr.Type = WheaWmiDispatch;
    ...
    v15 = _InterlockedExchangeAdd64((volatile signed __int64 *)&WheapDispatchPtr.Dpc.DpcData, 0xFFFFFFFFFFFFFFFFuLL);
    if ( (v15 & 2) != 0 && (v15 & 4) == 0 )
  ...
  else
  {
    ...
    v8 = (int *)Address;
    qword_1404C64B0 = (__int64)&qword_1404C64A8;
    qword_1404C64A8 = (__int64)&qword_1404C64A8;
    v9 = 0;
    WheapErrorSourceTable = 1279410516LL;
    LOWORD(stru_1404C64B8.Header.Lock) = 1;
    stru_1404C64B8.Header.Size = 6;
    stru_1404C64B8.Header.SignalState = 1;
    stru_1404C64B8.Header.WaitListHead.Blink = &stru_1404C64B8.Header.WaitListHead;
    stru_1404C64B8.Header.WaitListHead.Flink = &stru_1404C64B8.Header.WaitListHead;
    if ( v32 )
    {
      do
      {
