/*
 * XREFs of CcRemoveVacbArray @ 0x14026AA3C
 * Callers:
...
unsigned int *__fastcall CcRemoveVacbArray(unsigned int *a1)
{
  ...
  v1 = 0;
  if ( a1[1] )
    KeBugCheckEx(0x34u, 0x1F2uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
  v3 = *a1;
  if ( *(unsigned int **)(CcVacbArrays + 8 * v3) != a1 )
    KeBugCheckEx(0x34u, 0x1F8uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
...
LABEL_10:
  ...
  *(_QWORD *)(CcVacbArrays + 8 * v3) = 0LL;
  if ( !v6 )
    KeBugCheckEx(0x34u, 0x214uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
