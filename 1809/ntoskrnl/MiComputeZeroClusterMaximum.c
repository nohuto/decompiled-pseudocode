/*
 * XREFs of MiComputeZeroClusterMaximum @ 0x14010FB04
 * Callers:
...
unsigned __int64 __fastcall MiComputeZeroClusterMaximum(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v11 = 20000LL;
  v12 = *(_QWORD **)(qword_14043B808 + 8 * v10);
  v13 = *(_QWORD *)(v12[878] + 2392LL);
  v14 = 20000LL;
  if ( v13 > 0x4E20 )
    v14 = *(_QWORD *)(v12[878] + 2392LL);
