...
void __fastcall ADD_MAP_REGISTERS(__int64 a1, unsigned int a2, char a3)
{
  ...
  if ( a2 > *(_DWORD *)(a1 + 152) )
  {
    ViHalPreprocessOptions(byte_14040547C, "Allocating too many map registers at a time: %x (max %x).", 12, a2);
    VfReportIssueWithOptions(0xE6u, 0xCuLL, a2, *(unsigned int *)(a1 + 152), 0LL, byte_14040547C);
  }
