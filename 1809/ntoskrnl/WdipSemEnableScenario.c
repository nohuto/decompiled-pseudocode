/*
 * XREFs of WdipSemEnableScenario @ 0x14071776C
 * Callers:
 ...
 *     WdipSemQueryScenarioTable @ 0x1407178B4 (WdipSemQueryScenarioTable.c)
 *     WdipSemGetLoggerIds @ 0x14071791C (WdipSemGetLoggerIds.c)
 *     WdipSemActivateInstance @ 0x140717A28 (WdipSemActivateInstance.c)
 *     WdipSemEnableContextProviders @ 0x140717BF8 (WdipSemEnableContextProviders.c)
