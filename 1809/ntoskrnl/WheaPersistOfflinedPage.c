/*
 * XREFs of WheaPersistOfflinedPage @ 0x140320794
 * Callers:
 *     EmpRemoveBadS3PageWorker @ 0x140814FE0 (EmpRemoveBadS3PageWorker.c)
 ...
 *     WheapCountBadPageExtents @ 0x1408DD2A8 (WheapCountBadPageExtents.c)
 *     WheapIsPageInList @ 0x1408DD2F0 (WheapIsPageInList.c)
 *     WheapSortBadPages @ 0x1408DD314 (WheapSortBadPages.c)
 *     BcdCreateObject @ 0x1408F1AA8 (BcdCreateObject.c)
 *     BcdGetElementData @ 0x1408F22A4 (BcdGetElementData.c)
 *     BcdSetElementData @ 0x1408F22C0 (BcdSetElementData.c)
 */
