/*
 * XREFs of DrvDbDispatchDriverInfFile @ 0x1406D2690
 * Callers:
 *     <none>
 * Callees:
 *     DrvDbGetDriverInfFileMappedProperty @ 0x1406D254C (DrvDbGetDriverInfFileMappedProperty.c)
 *     _PnpCtxGetObjectContext @ 0x1406D29D8 (_PnpCtxGetObjectContext.c)
 ...
 *     DrvDbGetObjectList @ 0x140901F60 (DrvDbGetObjectList.c)
...
LABEL_11:
  ...
  if ( v13 )
  {
    ...
    {
      DriverInfFileMappedProperty = DrvDbDeleteObjectRegKey(*(_QWORD *)v21, 3LL, a2);
    }
    goto LABEL_11;
  }
  v20 = *(_DWORD *)a5;
  v21[0] = 0;
  LODWORD(v8) = DrvDbOpenObjectRegKey(v9, 0, 3, a2, v20, 1, (__int64)(a5 + 1), (__int64)v21);
  if ( (int)v8 >= 0 )
    *((_BYTE *)a5 + 16) = v21[0] == 1;
  return (unsigned int)v8;
}
