/*
 * XREFs of MiMarkRetpolineBits @ 0x140853D70
 * Callers:
 ...
 *     RtlAreBitsClearEx @ 0x1401143A0 (RtlAreBitsClearEx.c)
 *     MiAddressToRetpolineBit @ 0x1402B8EF0 (MiAddressToRetpolineBit.c)
 */
