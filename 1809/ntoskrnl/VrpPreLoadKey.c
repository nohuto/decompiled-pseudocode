/*
 * XREFs of VrpPreLoadKey @ 0x14080C964
 * Callers:
...
__int64 __fastcall VrpPreLoadKey(_QWORD *a1, GUID *a2)
{
  ...
  *(_DWORD *)&GuidString.Length = 5111808;
  ...
  if ( stru_140400AD8.LevelPlus1 > 5 )
  {
    ...
    v70[0] = v9;
    v70[1] = 0;
    TlgWrite(&stru_140400AD8, &unk_14036DAF0, &ActivityId, 0LL, 4u, &pData);
  }
                        ...
                        NamespaceNodePlaceholderKey >= 0) )
                  {
                    ...
                    if ( NamespaceNodePlaceholderKey >= 0 )
                    {
                      ...
                      if ( stru_140400AD8.LevelPlus1 > 5 )
                      {
                        ...
                        v64 = &v37;
                        v65 = 4LL;
                        TlgWrite(&stru_140400AD8, &unk_14036DBFC, &ActivityId, 0LL, 7u, &v55);
                      }
                    }
                  }
                }
...
LABEL_58:
  ...
  if ( ((NamespaceNodePlaceholderKey + 0x80000000) & 0x80000000) == 0
    && NamespaceNodePlaceholderKey != -1073740541
    && stru_140400AD8.LevelPlus1 > 2 )
  {
    v38 = NamespaceNodePlaceholderKey;
    v72 = &v38;
    v73 = 4LL;
    TlgWrite(&stru_140400AD8, &unk_14036DAC6, &ActivityId, 0LL, 3u, &v71);
  }
  if ( v6 )
