/*
 * XREFs of PfpPrefetchFiles @ 0x140865268
 * Callers:
...
LABEL_12:
  ...
  if ( v4 )
  {
    PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, (unsigned int)(v4 << 6), 0x41536650u);
    if ( PoolWithTag )
    {
      v30 = (__int64)&PoolWithTag[56 * v4];
      memset(PoolWithTag, 0, (unsigned int)(v4 << 6));
      v16 = 0LL;
      if ( !*(_DWORD *)(v2 + 8) )
        goto LABEL_44;
      do
        ...
        if ( (*(_QWORD *)(((unsigned __int64)(unsigned int)v16 << 6) + v6[2] + 24) & 0x400000000LL) != 0 )
        {
          ...
          if ( (*(_DWORD *)(v17 + 40 * v16 + 12) & 0xFFFFFFFE) != 0 )
          {
            do
            {
              ...
              {
                v20 = &PoolWithTag[56 * v3];
                PfpReadSupportInitialize(v20);
                if ( (int)PfpFileBuildReadSupport(a1, v19, v16, a2, (__int64)v20) < 0 )
                {
                  PfpReadSupportCleanup(a1[5], (__int64)v20);
                  PfpReadSupportInitialize(v20);
                }
                else
                {
