/*
 * XREFs of PiDeviceDependencyInit @ 0x1409C8100
 * Callers:
...
__int64 PiDeviceDependencyInit()
{
  ...
  qword_1404367E8 = (__int64)&PiDependencyNodeListHead;
  PiDependencyNodeListHead = (__int64)&PiDependencyNodeListHead;
  qword_1404367F8 = (__int64)&PiDependencyNodeEmptyList;
  PiDependencyNodeEmptyList = (__int64)&PiDependencyNodeEmptyList;
  qword_140436808 = (__int64)&PiRebuildPowerRelationsQueue;
