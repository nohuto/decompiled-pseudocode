/*
 * XREFs of PpmCheckArmPeriod @ 0x140189D3C
 * Callers:
...
char PpmCheckArmPeriod()
{
  ...
  if ( (unsigned int)(10000 * HIDWORD(PpmCurrentProfile[341 * dword_14041810C + 7])) > (unsigned __int64)PpmCheckMinimumPeriod )
    v0 = (unsigned int)(10000 * HIDWORD(PpmCurrentProfile[341 * dword_14041810C + 7]));
  if ( !PpmCheckArmed )
    goto LABEL_7;
