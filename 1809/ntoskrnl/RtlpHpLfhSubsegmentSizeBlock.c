/*
 * XREFs of RtlpHpLfhSubsegmentSizeBlock @ 0x1400BED50
 * Callers:
 *     RtlpHpSegSizeInternal @ 0x1400BEC30 (RtlpHpSegSizeInternal.c)
 * Callees:
 *     RtlpHpLfhSubsegmentSizeBlockInternal @ 0x1400BF930 (RtlpHpLfhSubsegmentSizeBlockInternal.c)
 */
...
__int64 __fastcall RtlpHpLfhSubsegmentSizeBlock(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v7 = qword_14040E0A8 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
  v8 = a3 - HIWORD(v7) - a2;
  v9 = *(_QWORD *)(a1
