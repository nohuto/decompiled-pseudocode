...
LABEL_57:
  ...
  {
    v14 = v27[0] | 0x2000000;
    qword_1403FE830 = (__int64)EtwpTraceFileIo;
    v13 = *(_DWORD *)a2;
    v27[0] |= 0x2000000u;
  }
  if ( (v13 & 0x4000000) != 0 )
  {
    v14 |= 0x4000000u;
    qword_1403FE828 = (__int64)EtwpTraceFileIo;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x200) != 0 )
  {
    v14 |= 0x200u;
    qword_1403FE820 = (__int64)EtwpTraceFileName;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x100) != 0 )
  {
    ...
    qword_1403FE810 = (__int64)EtwpTraceRedirectedIo;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x400) != 0 )
  {
    v14 |= 0x400u;
    qword_140438700 = (__int64)EtwpTraceIoInit;
    v27[0] = v14;
  }
  v15 = *((_DWORD *)a2 + 4);
  v16 = v27[4];
  ...
  {
    v16 = v27[4] | 1;
    qword_140438708 = (__int64)EtwpTraceOpticalIo;
    v15 = *((_DWORD *)a2 + 4);
    v27[4] |= 1u;
  }
  if ( (v15 & 2) != 0 )
  {
    v16 |= 2u;
    qword_140438710 = (__int64)EtwpTraceOpticalIoInit;
    v27[4] = v16;
  }
  ...
  {
    v16 |= 0x400000u;
    qword_1403FE7F0 = (__int64)EtwpTraceFltIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x80000) != 0 )
  {
    v16 |= 0x80000u;
    qword_1403FE7F8 = (__int64)EtwpTraceFltIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x100000) != 0 )
  {
    v16 |= 0x100000u;
    qword_1403FE800 = (__int64)EtwpTraceFltTimedIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x200000) != 0 )
  {
    v16 |= 0x200000u;
    qword_1403FE808 = (__int64)EtwpTraceFltTimedIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x1000000) != 0 )
  {
    v16 |= 0x1000000u;
    qword_140404B30 = (__int64)EtwpTraceWdf;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x2000000) != 0 )
  {
    v16 |= 0x2000000u;
    qword_140404B38 = (__int64)EtwpTraceWdf;
    v27[4] = v16;
  }
  if ( (*((_DWORD *)a2 + 2) & 0x8000000) != 0 )
  {
    v27[2] |= 0x8000000u;
    qword_140404B40 = (__int64)EtwpSystemTraceWdf;
  }
  v18 = *(_DWORD *)a2;
