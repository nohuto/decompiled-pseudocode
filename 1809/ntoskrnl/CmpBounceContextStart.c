/*
 * XREFs of CmpBounceContextStart @ 0x1405D2F60
 * Callers:
...
__int64 __fastcall CmpBounceContextStart(__int64 a1, void *a2, size_t a3, __int64 a4, char a5)
{
  ...
  *(_QWORD *)a1 = a2;
  ...
  if ( !qword_140437C28 || !(_DWORD)a4 && (unsigned __int8)CmpIsBufferGloballyVisible(a2) )
  {
LABEL_9:
...
LABEL_14:
  ...
  if ( a3 <= 0x1000 )
  {
    ...
    if ( TransientPoolWithQuotaTag
      || (++dword_1404C6B18,
          (TransientPoolWithQuotaTag = (void *)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, union _SLIST_HEADER *))qword_1404C6B30)(
