/*
 * XREFs of MiApplyCompressedFixups @ 0x1405E0CA0
 * Callers:
        ...
        __int64 a4)
{
  ...
  v6 = 4;
  v7 = *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(BugCheckParameter2 + 96) + 32LL) + 68LL) & 0xF;
...
LABEL_7:
      ...
      else if ( v7 == 3 && ((unsigned __int16)result & 0xFFFu) <= 0xFFC )
      {
        *(_DWORD *)result += a4;
      }
      --v10;
