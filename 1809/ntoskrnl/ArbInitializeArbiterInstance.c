/*
 * XREFs of ArbInitializeArbiterInstance @ 0x14073913C
 * Callers:
 *     IopPortInitialize @ 0x140737940 (IopPortInitialize.c)
 *     IopMemInitialize @ 0x1407379D8 (IopMemInitialize.c)
 *     IopDmaInitialize @ 0x140737ABC (IopDmaInitialize.c)
 *     IopIrqInitialize @ 0x140737B30 (IopIrqInitialize.c)
 *     IopBusNumberInitialize @ 0x140737B98 (IopBusNumberInitialize.c)
 * Callees:
