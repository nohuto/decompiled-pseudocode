 ...
 *     IoSetIoPriorityHintIntoFileObject @ 0x1402837D0 (IoSetIoPriorityHintIntoFileObject.c)
 ...
 *     IoSetFileObjectIgnoreSharing @ 0x14081C960 (IoSetFileObjectIgnoreSharing.c)
