/*
 * XREFs of KsepSkipDriverUnloadEventDriverLoad @ 0x1402A186C
 * Callers:
 *     KseSkipDriverUnloadHookDriverTargeted @ 0x1402A1830 (KseSkipDriverUnloadHookDriverTargeted.c)
 * Callees:
...
char __fastcall KsepSkipDriverUnloadEventDriverLoad(unsigned __int16 *a1, __int64 a2, int a3, int a4, char a5)
{
  ...
  if ( KseEtwHandle )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      v21 = 4;
      v12 = 8;
      LOBYTE(v5) = EtwWriteEx(v6, &KseSkipDriverUnloadEventDriverLoad, 0LL, 0, 0LL, 0LL, 5u, &UserData);
    }
  }
  return (char)v5;
}
