/*
 * XREFs of PopCheckShutdownMarker @ 0x1409DE374
 * Callers:
...
char __fastcall PopCheckShutdownMarker(int a1)
{
  ...
  xmmword_140440F50 = xmmword_140440FA0;
  xmmword_140440F60 = xmmword_140440FB0;
  ...
  {
    v11 = WORD2(v3);
    v13 = WORD6(xmmword_140440F50);
    v16 = BYTE6(v3);
    v12 = v3;
    v14 = v3;
    v4 = HIBYTE(v3);
    v8 = v4 & 1;
    v15 = HIWORD(*((_QWORD *)&xmmword_140440F50 + 1));
    v21 = &PopBsdPhysicalPowerButtonInfoAtBoot;
    v23 = &v11;
    v25 = &v12;
    v27 = &xmmword_140440F50;
    v29 = &v13;
    v31 = &v14;
    v33 = &v15;
    v35 = &v16;
    ...
    v38 = 1LL;
    v40 = 1LL;
    TlgWrite(&pCallbackContext, &unk_14036F800, 0LL, 0LL, 0xCu, &pData);
  }
  PopBsdPowerTransitionExtensionAtBoot = PopBsdPowerTransitionExtension;
  xmmword_140440F80 = xmmword_14043D6C8;
  PopBsdPowerTransitionAtBoot = PopBsdPowerTransition;
  xmmword_140440FD0 = *(_OWORD *)&::Buffer;
