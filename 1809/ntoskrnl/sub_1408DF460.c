/*
 * XREFs of sub_1408DF460 @ 0x1408DF460
 * Callers:
...
__int64 __fastcall sub_1408DF460(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rsi
...
LABEL_59:
        ...
        if ( qword_14096D3D8 )
        {
          ...
          if ( !v31 )
            v39 = v32;
          v40 = qword_14096D3D8(v5, v6, v7, NumberOfBytes, v39, v30, &v116);
        }
        else
        {
          v40 = -1073741637;
