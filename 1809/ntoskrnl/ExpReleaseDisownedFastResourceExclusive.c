/*
 * XREFs of ExpReleaseDisownedFastResourceExclusive @ 0x14016471C
 * Callers:
 *     ExReleaseDisownedFastResource @ 0x140164BB0 (ExReleaseDisownedFastResource.c)
 *     ExReleaseDisownedFastResourceExclusive @ 0x14031B0C0 (ExReleaseDisownedFastResourceExclusive.c)
 ...
 *     ExpPrepareToWakeResourceExclusive @ 0x140166544 (ExpPrepareToWakeResourceExclusive.c)
