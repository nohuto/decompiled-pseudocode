/*
 * XREFs of PopDiagTraceFxDefaultPepWorkerEnd @ 0x140100504
 * Callers:
  ...
  if ( a4 == 2 )
  {
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v34 = &v24;
        v35 = 4LL;
        LOBYTE(v5) = TlgWriteEx(&pCallbackContext, &unk_14037070E, v13, v14, ActivityId, RelatedActivityId, v14, &pData);
      }
    }
  }
