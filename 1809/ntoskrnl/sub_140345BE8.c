/*
 * XREFs of sub_140345BE8 @ 0x140345BE8
 * Callers:
...
__int64 __fastcall sub_140345BE8(_QWORD *a1, __int64 a2, unsigned int a3)
{
  __int64 v3; // rax
  int *v4; // r8
  __int64 v5; // rsi
...
LABEL_471:
    ...
    if ( (v58 & 0x10) != 0 && !(unsigned int)sub_1403494B8(v10, BugCheckParameter2) )
    {
      v58 &= ~0x10u;
      v387 = v58;
    }
    ...
    {
      v33 = sub_14098EFA4(&v341, BugCheckParameter2, v58);
      goto LABEL_472;
    }
    ...
    {
      v348 = sub_1403485B4(v10, v71, v68);
      v72 = (_BYTE *)v348;
      if ( !v348 )
      {
        v33 = -1073741670;
...
LABEL_152:
        ...
        *(_DWORD *)(v108 + 240) = 48;
        ...
        if ( v108 == -96LL )
        {
          ...
          {
            v135 = (_BYTE *)sub_1403485B4(v107, v134, *((unsigned int *)v107 + 577));
            if ( !v135 )
              goto LABEL_194;
...
LABEL_275:
            ...
            {
              v348 = sub_1403485B4(v135, v195, *((unsigned int *)v135 + 577));
              v196 = (_BYTE *)v348;
              if ( !v348 )
              {
                v33 = -1073741670;
  ...
  if ( (v325 & 0x80000004) != 0x80000004 )
  {
    ...
    if ( (unsigned int)v328 >= 0x14 )
    {
      ...
      for ( n = v329 + v353; n != v332; n += 20LL )
      {
        ...
        if ( v335 )
        {
          result = sub_140345BE8(&v341, v335, v326);
          *a1 = v341;
