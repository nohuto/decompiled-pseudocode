/*
 * XREFs of ?Hash@MetroHash64@@SAXPEBE_KQEAE1@Z @ 0x140153560
 * Callers:
 ...
 *     MiValidateMdlTracker @ 0x1402A8918 (MiValidateMdlTracker.c)
 *     RtlHashBytes2 @ 0x1402FE1E8 (RtlHashBytes2.c)
