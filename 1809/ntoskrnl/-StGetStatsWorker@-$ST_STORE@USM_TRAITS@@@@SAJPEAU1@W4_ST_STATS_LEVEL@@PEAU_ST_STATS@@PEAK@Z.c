/*
 * XREFs of ?StGetStatsWorker@?$ST_STORE@USM_TRAITS@@@@SAJPEAU1@W4_ST_STATS_LEVEL@@PEAU_ST_STATS@@PEAK@Z @ 0x140134DC4
 * Callers:
 *     ?SmStGetStoreStats@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@W4_ST_STATS_LEVEL@@PEAU_ST_STATS@@PEAK@Z @ 0x140134DAC (-SmStGetStoreStats@-$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@W4_ST_STATS_LEVEL@@PEAU_ST_STATS@@PEAK@Z.c)
 ...
 *     StLcBucketsCopy @ 0x1403069DC (StLcBucketsCopy.c)
 */
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StGetStatsWorker(__int64 a1, int a2, __int64 a3, unsigned int *a4)
{
  ...
  else
  {
    ...
    *(_DWORD *)(a3 + 40) = *(_DWORD *)(a1 + 920) - RtlNumberOfSetBits((PRTL_BITMAP)(a1 + 920));
    v14 = (_DWORD *)(a3 + 44);
    v15 = 0;
    v16 = (unsigned __int8)*(_DWORD *)(a1 + 856) != 0 ? 1 : 8;
    v17 = a1 + 80 - (a3 + 28);
    do
    {
      ++v15;
      *v14 = *(_DWORD *)((char *)v14 + v17 + 1808);
      v14[1] = *(_DWORD *)((char *)v14 + v17 + 1812);
      v14 += 2;
    }
    while ( v15 < v16 );
    ...
    *(_DWORD *)(a3 + 120) = *(_DWORD *)(a1 + 2856) - RtlNumberOfSetBits((PRTL_BITMAP)(a1 + 2856));
    v18 = (_DWORD *)(a3 + 124);
    v19 = 0;
    v20 = (unsigned __int8)*(_DWORD *)(a1 + 2792) != 0 ? 1 : 8;
    v21 = a1 + 2016 - (a3 + 108);
    do
    {
      ++v19;
      *v18 = *(_DWORD *)((char *)v18 + v21 + 1808);
      v18[1] = *(_DWORD *)((char *)v18 + v21 + 1812);
      v18 += 2;
    }
    while ( v19 < v20 );
    if ( !a2 )
