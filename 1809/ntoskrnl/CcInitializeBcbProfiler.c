 ...
 *     KeInitializeTimer @ 0x14012FF50 (KeInitializeTimer.c)
...
char CcInitializeBcbProfiler()
{
  ...
  {
    v96 = 166;
    SubStr[0] = __ROL4__(166, 31);
    v97 = 65;
    SubStr[1] = __ROR4__(65, 32);
    v98 = 52769;
    SubStr[2] = __ROR4__(35840, 105);
    v74 = 1073741841;
    SubStr[3] = __ROL4__(1073741841, 34);
    v75 = 528;
    SubStr[4] = __ROR4__(528, 35);
    v76 = 20726308;
    SubStr[5] = __ROR4__(20709376, 114);
    v77 = 2013265922;
    SubStr[6] = __ROL4__(2013265922, 37);
    v78 = 5376;
    SubStr[7] = __ROR4__(5376, 38);
    v79 = -805289434;
    SubStr[9] = 0;
    SubStr[8] = __ROR4__(-805306367, 123);
...
LABEL_64:
        v91 = 1329594368;
        KeBugCheckEx(__ROL4__(1329594368, 10), 6uLL, (ULONG_PTR)v9, v19, 0LL);
      }
      v11 = 0LL;
      v12 = 0;
      v13 = v9[3];
