/*
 * XREFs of EtwpCoverageSamplerContextSwap @ 0x14031779C
 * Callers:
 *     EtwTraceContextSwap @ 0x14017C8E0 (EtwTraceContextSwap.c)
 * Callees:
...
void __fastcall EtwpCoverageSamplerContextSwap(_KTHREAD *a1)
{
  ...
  if ( a1 && a1 != *(_KTHREAD **)qword_140409E28 && a1 != KeGetCurrentPrcb()->IdleThread )
  {
    v1 = (*(_QWORD *)(qword_140409E28 + 8) >> 4) & 0x1FFLL;
    v2 = ((unsigned int)*(_QWORD *)(qword_140409E28 + 8) >> 13) & 0x3FFFF;
