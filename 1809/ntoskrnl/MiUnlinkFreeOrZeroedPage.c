...
__int64 __fastcall MiUnlinkFreeOrZeroedPage(ULONG_PTR a1, __int64 a2, __int16 a3)
{
  ...
  v52 = v7;
  v9 = v8;
  v10 = dword_14043A088 & (unsigned int)a1 | (((*(_QWORD *)(v5 + 40) >> 36) & 3) << byte_14043A04A) | ((_DWORD)v7 << byte_14043A049);
  v11 = *(_QWORD *)(qword_14043A748 + 8 * ((*(_QWORD *)(v5 + 40) >> 40) & 0x3FFLL));
  if ( a2 )
  {
    LODWORD(v7) = -1;
  }
  ...
  if ( dword_14043A76C == 1 )
  {
    v39 = v4 & 0x1F;
    LOBYTE(v40) = 1;
    v41 = (volatile signed __int32 *)(qword_14043A7C8 + 4 * (v4 >> 5));
    if ( v39 + 1 > 0x20 )
    {
      if ( (v4 & 0x1F) != 0 )
      {
    ...
    if ( v15 == 0xFFFFFFFFFLL )
    {
      _InterlockedAnd(
        (volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v11 + 16)
                                              + 1984 * ((unsigned __int64)(unsigned int)v10 >> byte_14043A049)
                                              + 16 * (v9 + 104)
                                              + 8)
                                  + 4 * ((unsigned __int64)((unsigned int)v10 & dword_14043A088) >> 5)),
        ~(1 << (v10 & dword_14043A088 & 0x1F)));
...
LABEL_15:
  v19 = *(_QWORD *)(v11 + 16) + 1984 * ((unsigned __int64)(unsigned int)v10 >> byte_14043A049);
  ...
  if ( (unsigned int)MmNumberOfChannels > 1 )
    _InterlockedDecrement64((volatile signed __int64 *)(v19
                                                      ...
                                                      * (v9
                                                       + 2LL
                                                       * (unsigned __int8)(MiChannelMaximumPowerOf2Mask & ((unsigned int)v10 >> byte_14043A04A)))
                                                      + 1824));
