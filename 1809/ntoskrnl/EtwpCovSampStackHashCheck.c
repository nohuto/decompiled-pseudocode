/*
 * XREFs of EtwpCovSampStackHashCheck @ 0x1408C89F4
 * Callers:
 ...
 *     EtwpCovSampStackHashLookup @ 0x1408C8C28 (EtwpCovSampStackHashLookup.c)
 */

__int64 __fastcall EtwpCovSampStackHashCheck(__int64 a1, volatile signed __int32 *a2, unsigned __int8 *a3, __int64 a4)
{
  unsigned int *v7; // rsi
  unsigned int v8; // ebp
  unsigned int *v9; // rdi
  ...
  if ( !*(_QWORD *)(a1 + 936) )
    return 0LL;
  v7 = *(unsigned int **)(a1 + 936);
  v8 = 0;
  v9 = *(unsigned int **)(a1 + 944);
  if ( v7 == v9 )
...
LABEL_32:
      if ( v22 )
      {
        ...
        *v9 = 0;
        _InterlockedExchange64((volatile __int64 *)(a1 + 936), (__int64)v9);
      }
    }
  }
  return v8;
