...
__int64 __fastcall sub_140586C3C(__int64 a1, __int64 a2)
{
  __int64 v2; // rcx
  __int64 v3; // rdx
  __int64 v4; // r8
  ...
  *(_BYTE *)(a1 + 34) = 0;
  *(_DWORD *)(a1 + 36) = 0;
  sub_140586C84(a1, a2, a1);
  sub_140586C84(v2 + 40, v3, v4);
  sub_140586C84(v5 + 56, v6, v5);
  return sub_140586C84(v7 + 72, v8, v7);
}
