...
__int64 __fastcall MiCoalescePageFileBitmapsCache(__int64 a1, int a2, unsigned int a3)
{
  ...
  __int64 v70; // [rsp+80h] [rbp+8h] BYREF
  int v71; // [rsp+98h] [rbp+20h]
    ...
    if ( j )
    {
      ...
      if ( v27 == (_DWORD)v5 )
      {
        if ( *(_DWORD *)(v19 + 48) == (_DWORD)v5 )
        {
          ...
          *(_DWORD *)(v19 + 52) = 0;
          RtlRbRemoveNode(v28 + 144, v9 - 24);
          RtlRbRemoveNode(v28 + 160, v9);
          v29 = v28 + 176;
...
LABEL_57:
        ...
        else
        {
          ...
          if ( v51 > 1 )
            *(_DWORD *)(v13 + 52) += RtlLengthCurrentClearRunForward(v67, (unsigned int)(v50 - 1), v51) - 1;
        }
      }
      return MiBitmapsCachedEntryLengthChanged(v4, v13, 1);
    }
    else
    {
      v52 = v18 - ((v18 != -1) + 1) - v5;
      ...
      if ( !v54 )
        return MiRescanPageFileBitmapPortion(v4, v67, (unsigned int)v5 - v54, v57, (__int64)&v70);
      v59 = v54 + 1;
      v60 = *(_DWORD **)(v68 + 8);
      v61 = &v60[v5 >> 5];
      v62 = v5 & 0x1F;
...
LABEL_83:
      ...
      {
LABEL_91:
        result = *(unsigned int *)(v4 + 140);
        if ( (unsigned int)result <= v57 )
          result = v57;
