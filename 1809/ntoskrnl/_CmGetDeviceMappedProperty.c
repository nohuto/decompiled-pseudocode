/*
 * XREFs of _CmGetDeviceMappedProperty @ 0x14059C184
 * Callers:
    ...
    *a9 = 0;
    if ( !a4 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          v23 = *(_QWORD *)a5 - *(_QWORD *)&v15->fmtid.Data1;
          if ( *(_QWORD *)a5 == *(_QWORD *)&v15->fmtid.Data1 )
            v23 = *(_QWORD *)(a5 + 8) - *(_QWORD *)v15->fmtid.Data4;
          if ( !v23 )
            break;
        }
        ++v14;
...
LABEL_9:
      ...
      while ( 1 )
      {
        ...
        {
          v24 = *(_QWORD *)a5 - *(_QWORD *)&v21->fmtid.Data1;
          if ( *(_QWORD *)a5 == *(_QWORD *)&v21->fmtid.Data1 )
            v24 = *(_QWORD *)(a5 + 8) - *(_QWORD *)v21->fmtid.Data4;
          if ( !v24 )
            break;
        }
        ++v20;
