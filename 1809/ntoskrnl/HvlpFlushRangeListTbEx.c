/*
 * XREFs of HvlpFlushRangeListTbEx @ 0x140279BCC
 * Callers:
 *     HvlFlushRangeListTb @ 0x140279648 (HvlFlushRangeListTb.c)
 * Callees:
 *     HvlpCountFlushVaList @ 0x1402797C8 (HvlpCountFlushVaList.c)
        ...
        unsigned __int64 *a7)
{
  ...
  if ( v10 + (((unsigned int)HvlpFlags >> 8) & 0xF) + 5 <= 0xE
  ...
  LOBYTE(v11) = v14;
  return (_UNKNOWN **)HvlpSlowFlushListTbEx((unsigned int)v16, a2, v11, v12, v13, (__int64)a7, v10);
}
