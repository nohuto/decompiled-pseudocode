/*
 * XREFs of RtlpHpLfhSubsegmentSizeBlockInternal @ 0x1400BF930
 * Callers:
...
__int64 __fastcall RtlpHpLfhSubsegmentSizeBlockInternal(__int64 a1, __int64 a2, int a3, int *a4)
{
  ...
  result = (unsigned __int16)qword_14040E0A8 ^ (unsigned int)v4;
  if ( ((*(_QWORD *)(a1 + 8 * ((unsigned __int64)(unsigned int)(2 * a3) >> 6) + 48) >> ((2 * a3) & 0x3F)) & 2) != 0 )
  {
    v8 = ((unsigned __int16)qword_14040E0A8 ^ v4) + a2;
    v9 = *(_WORD *)(v8 - 2);
