/*
 * XREFs of sub_1403495B4 @ 0x1403495B4
 * Callers:
...
__int64 __fastcall sub_1403495B4(_DWORD *a1, unsigned int a2, int a3)
{
  _DWORD *v4; // rdi
  __int64 v5; // rbx
  int v6; // r10d
  ...
  if ( a3 != 3 )
  {
    ...
    if ( v6 )
    {
      ...
      v10 += ((((unsigned int)(((v14 ^ v13) * (unsigned __int128)0x7010008004002001uLL) >> 64) ^ (67117057
           ...
           + 4096;
      v114 = v10 + a2;
      v15 = (_QWORD *)(*((__int64 (__fastcall **)(__int64, __int64))v4 + 67))(v114 + 8, 0xFFFFFFFFLL);
      if ( !v15 )
        goto LABEL_11;
      if ( !(*((unsigned __int8 (__fastcall **)(_QWORD *, _QWORD, __int64))v4 + 69))(
              v15,
              ((_DWORD)v114 + 4095) & 0xFFFFF000,
              64LL) )
      {
        (*((void (__fastcall **)(_QWORD *, __int64))v4 + 68))(v15, v114);
        goto LABEL_11;
      }
      *v15 = v114 + 8;
      v16 = (__int64)(v15 + 1);
    ...
    {
      v16 = (*((__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))v4 + 30))(v7 != 0 ? 0x200 : 0, v10 + a2, v113);
    }
    if ( v16 )
    {
      v17 = (_QWORD *)v16;
      ...
      if ( v34 )
      {
        ...
        *(_QWORD *)(v34 + 1968) = v16;
        if ( (v39 & 0x10000000) == 0 )
          *(_DWORD *)(v34 + 2416) = v39 | 0x20000000;
...
LABEL_11:
  ...
  *(_QWORD *)&v45 = __rdtsc();
  ...
  v51 = (*((__int64 (__fastcall **)(__int64, _QWORD, __int64))v4 + 30))(512LL, (unsigned int)(v49 + 32), v47);
  v102 = v51;
  if ( !v51 )
  {
    ++v4[638];
  ...
  *(_QWORD *)(v108 + 24) = v102;
  ...
  if ( !v74
    ...
    || (v68[1] = v75,
        ...
        !(*((unsigned __int8 (__fastcall **)(__int64, _QWORD, __int64))v4 + 69))(
           v104,
  ...
  if ( v104 + v106 )
  {
    ...
    v100 = *(_DWORD *)(v95 + 2416);
    *(_DWORD *)(v95 + 1996) = v87;
    *(_QWORD *)(v95 + 1968) = v68;
    *(_DWORD *)(v95 + 2308) = 3;
    if ( (v100 & 0x10000000) == 0 )
      *(_DWORD *)(v95 + 2416) = v100 | 0x20000000;
    return v95;
  }
  return 0LL;
}
