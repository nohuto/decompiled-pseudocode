/*
 * XREFs of KsepDsEventPoolAllocate @ 0x1402A10AC
 * Callers:
 *     KseDsHookExAllocatePool @ 0x1402A03C0 (KseDsHookExAllocatePool.c)
 *     KseDsHookExAllocatePoolWithTag @ 0x1402A0420 (KseDsHookExAllocatePoolWithTag.c)
 * Callees:
