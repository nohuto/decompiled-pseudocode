/*
 * XREFs of RtlpHpSegMgrVaCtxFree @ 0x1402FCD00
 * Callers:
 *     RtlpHpSegMgrRelease @ 0x14015472C (RtlpHpSegMgrRelease.c)
 * Callees:
        ...
        if ( v25->LockState.0 )
        {
          if ( v25 )
          {
            ...
            if ( (__int64)v25->LockState.LockState < 0 )
              KiAbEntryRemoveFromTree((__int64)&CurrentThread->LockEntries[v24], v20);
            v31 = 0;
...
LABEL_31:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v8, (__int64)&v31);
    v21 = CurrentThread->SpecialApcDisable++ == -1;
    if ( v21 && ($FFD56A4B518EFE5E17FDE2C5CC486782 *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
