...
__int64 __fastcall PpmPerfResizeHistory(__int64 a1)
{
  ...
  v4 = *(_DWORD **)(a1 + 24216);
  v5 = *((unsigned __int8 *)&PpmCurrentProfile[341 * dword_14041810C + 8] + PerfPolicyClass);
  v6 = v5;
  if ( v4 )
  {
    if ( *v4 == v5 )
