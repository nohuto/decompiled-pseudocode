 ...
 *     KeWakeProcessor @ 0x140293B90 (KeWakeProcessor.c)
 ...
 *     PpmIdleSetSynchronizationState @ 0x1402D5060 (PpmIdleSetSynchronizationState.c)
 ...
 *     PpmPerfFeedbackCounterUpdate @ 0x1402DB258 (PpmPerfFeedbackCounterUpdate.c)
  ...
  if ( !v30 )
  {
    ...
    *(_DWORD *)(v10 + 23860) = a2;
    ...
    if ( v9 || *(_BYTE *)(v152 + 6) || *(_BYTE *)(v152 + 7) )
    {
      ...
      if ( *(_BYTE *)(v152 + 7) )
      {
        v44 = HIDWORD(PpmCurrentProfile[341 * dword_14041810C + 23]);
    ...
    {
LABEL_96:
      v11 = ((__int64 (__fastcall *)(_QWORD))off_1403FE480[0])((unsigned int)SpinLock);
      v148 = v11;
      if ( *(_DWORD *)(v10 + 11800) )
      {
        v11 = -2147483631;
      ...
      *(_QWORD *)(v10 + 23888) = v66;
      ...
      if ( v11 >= 0 )
      {
        ...
        if ( a3 != -1 )
        {
          ...
          if ( !qword_14043C480 && a3 == dword_14043C4C0 )
            _InterlockedCompareExchange64(&qword_14043C480, MEMORY[0xFFFFF78000000008], 0LL);
          if ( a5 )
          {
          ...
          if ( *(_BYTE *)(v161 + 1056) >= 2u && (HvlEnlightenments & 4) == 0 )
          {
            ...
            if ( !v80 )
            {
              ...
              else
              {
                ...
                if ( !v91->DeepSleep )
                {
                  v93 = 8LL * ((unsigned int)KiProcessorIndexToNumberMappingTable[v91->Number] >> 6) + 4306024;
                  _InterlockedAnd64(
        ...
        *(_WORD *)(v10 + 1760) &= ~1u;
        if ( DeepSleep && *(_BYTE *)(v10 + 23450) )
        {
          ...
          v107->DeepSleep = 0;
          _InterlockedAnd64(
            &qword_14041B468[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[v108] >> 6],
...
LABEL_243:
  LOBYTE(v19) = 1;
  ((void (__fastcall *)(unsigned __int64))off_1403FE6E8[0])(v19);
  if ( v145 )
  {
    _interlockedbittestandreset64(
      (volatile signed __int32 *)(*(_QWORD *)(v10 + 192) + 72LL),
