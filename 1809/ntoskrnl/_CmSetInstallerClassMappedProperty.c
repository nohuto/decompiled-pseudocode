/*
 * XREFs of _CmSetInstallerClassMappedProperty @ 0x1408FF4A0
 * Callers:
 ...
 *     _CmSetInstallerClassMappedPropertyFromRegProp @ 0x1408FF748 (_CmSetInstallerClassMappedPropertyFromRegProp.c)
