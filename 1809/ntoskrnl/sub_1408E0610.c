/*
 * XREFs of sub_1408E0610 @ 0x1408E0610
 * Callers:
...
__int64 __fastcall sub_1408E0610(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  __int64 v6; // r13
  signed int v7; // ebx
...
LABEL_93:
      if ( v7 < 0 )
        goto LABEL_133;
      v43 = qword_14096D3B0 ? qword_14096D3B0(v30, v6, v35, v42, v40) : -1073741637;
      v7 = v43;
      if ( v43 < 0 )
        goto LABEL_133;
      v44 = -1;
