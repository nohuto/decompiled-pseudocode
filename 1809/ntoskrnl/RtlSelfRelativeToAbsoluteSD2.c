/*
 * XREFs of RtlSelfRelativeToAbsoluteSD2 @ 0x1408924C0
 * Callers:
 *     RtlpSysVolCheckOwnerAndSecurity @ 0x1406D6658 (RtlpSysVolCheckOwnerAndSecurity.c)
 * Callees:
 *     memmove @ 0x1401D1440 (memmove.c)
 *     RtlpQuerySecurityDescriptor @ 0x1406AFB90 (RtlpQuerySecurityDescriptor.c)
 */
...
NTSTATUS __stdcall RtlSelfRelativeToAbsoluteSD2(PSECURITY_DESCRIPTOR SelfRelativeSD, PULONG BufferSize)
{
  ...
  if ( v17 < 0x14 )
    return -1073741811;
  v6 = *((_WORD *)SelfRelativeSD + 1);
  if ( v6 >= 0 )
    return -1073741593;
  RtlpQuerySecurityDescriptor((__int64)SelfRelativeSD, &v18, &v22, &v19, &v23, &v20, &v24, &v21, &v16);
  v7 = v18;
  v8 = v19;
  if ( v18 <= v19 )
    v9 = v19 + v23;
  ...
  v12 = 40;
  if ( v9 )
    v12 = ((v9 - (_DWORD)SelfRelativeSD - 13) & 0xFFFFFFF8) + 40;
  if ( v12 <= v17 )
  {
    if ( v9 )
    {
      memmove((char *)SelfRelativeSD + 40, (char *)SelfRelativeSD + 20, v12 - 40LL);
      v7 = v18;
      v6 = *((_WORD *)SelfRelativeSD + 1);
    }
    v13 = v7 + 20;
    *((_WORD *)SelfRelativeSD + 1) = v6 & 0x7FFF;
    if ( !v7 )
      v13 = 0LL;
    *((_QWORD *)SelfRelativeSD + 1) = v13;
    v14 = v8 + 20;
    if ( !v8 )
      v14 = 0LL;
    *((_QWORD *)SelfRelativeSD + 2) = v14;
    v15 = v11 + 20;
    if ( !v11 )
      v15 = 0LL;
    *((_QWORD *)SelfRelativeSD + 3) = v15;
    if ( v10 )
      v2 = v10 + 20;
