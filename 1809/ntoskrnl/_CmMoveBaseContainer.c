/*
 * XREFs of _CmMoveBaseContainer @ 0x1408FA974
 * Callers:
...
__int64 __fastcall CmMoveBaseContainer(__int64 a1, const WCHAR *a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r14
  ...
  P = 0LL;
  DevicesInBaseContainerList = CmGetDevicesInBaseContainerList(*(__int64 *)&PiPnpRtlCtx, a3, (__int64)a2, &P);
  v9 = P;
  v10 = DevicesInBaseContainerList;
  if ( DevicesInBaseContainerList >= 0 )
  {
    for ( i = (const WCHAR *)P; *i; i += v12 + 1 )
    {
      v10 = CmRemoveDeviceFromContainer(v4, a3, a2, i);
      if ( v10 < 0 )
        break;
      v10 = CmAddDeviceToContainer(v4, a4, a2, i, 0LL);
      if ( v10 < 0 )
        break;
      v12 = -1LL;
      do
