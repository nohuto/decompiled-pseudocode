/*
 * XREFs of RtlLoadString @ 0x140892DF0
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG ReturnLanguageLen)
{
  ...
  ULONG *v21; // [rsp+58h] [rbp-60h] BYREF
  ...
  if ( DllHandle && ReturnString && (Flags & 0xFFFFFFFE) == 0 )
  {
    ...
    {
      v14 = LdrpSearchResourceSection_U((char *)DllHandle, v23, 4u, 1, (__int64 *)&v21);
      if ( v14 < 0 )
        return v14;
      v14 = LdrpAccessResourceData((unsigned __int64)DllHandle, v21, (unsigned __int64 *)&v20, 0LL);
    }
    if ( v14 >= 0 && v20 )
    {
      v15 = 0;
