        ...
        __int64 a8)
{
  ...
  if ( BaseAddress && a5 && (a4 & 0xFFFFFFFE) == 0 )
  {
    ...
    if ( v11 )
    {
      v14 = LdrResSearchResource((unsigned __int64)BaseAddress, v23, 4u, 1, &v20, &v18, a7, a8);
      if ( v14 >= 0 && v18 > 0xFFFF )
        v14 = -1073741701;
    }
    else
    {
      v14 = LdrpSearchResourceSection_U(BaseAddress, v23, 4u, 1, (__int64 *)&v21);
      if ( v14 < 0 )
        return (unsigned int)v14;
      v14 = LdrpAccessResourceData((unsigned __int64)BaseAddress, v21, (unsigned __int64 *)&v20, 0LL);
    }
    if ( v14 >= 0 && v20 )
    {
      v15 = 0;
