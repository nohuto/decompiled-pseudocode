/*
 * XREFs of CmShutdownSystem @ 0x1407EC8D4
 * Callers:
 ...
 *     TlgAggregateFlush @ 0x14032B904 (TlgAggregateFlush.c)
 ...
 *     CmCloseTmHandle @ 0x1406932A0 (CmCloseTmHandle.c)
 *     CmCloseRmHandle @ 0x1406932C4 (CmCloseRmHandle.c)
