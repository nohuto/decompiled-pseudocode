/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x1402E8130
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x14018D790 (PoFxPlatformRequestHandler.c)
 * Callees:
 ...
 *     PopFxAcpiValidateParameters @ 0x1402E8774 (PopFxAcpiValidateParameters.c)
