/*
 * XREFs of PopDiagTraceDirectedDripsInitialization @ 0x140760350
 * Callers:
...
char __fastcall PopDiagTraceDirectedDripsInitialization(int a1, int a2)
{
  ...
  if ( PopTriggerDiagHandleRegistered )
  {
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v2 )
      {
        ...
        v15 = 4;
        v18 = 4;
        LOBYTE(v2) = TlgWrite(&pCallbackContext, &unk_14036F773, 0LL, 0LL, 4u, &pData);
      }
    }
  }
  ...
  {
    v5 = PopDiagHandle;
    LOBYTE(v2) = EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_DIRECTED_DRIPS_INITIALIZATION);
    if ( (_BYTE)v2 )
    {
      UserData.Reserved = 0;
      v12 = 0;
      ...
      v10 = &v22;
      v11 = 4;
      LOBYTE(v2) = EtwWrite(v5, &POP_ETW_EVENT_DIRECTED_DRIPS_ENGAGED, 0LL, 2u, &UserData);
    }
  }
  return (char)v2;
}
