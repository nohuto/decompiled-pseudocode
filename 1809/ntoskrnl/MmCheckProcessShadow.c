...
__int64 MmCheckProcessShadow()
{
  ...
  ExAcquirePushLockSharedEx((ULONG_PTR)&qword_140439FA8, 0LL);
  Process += 1280LL;
  v2 = MiLockWorkingSetShared(Process);
  v5 = MiCheckProcessShadow(Process, 0x1Du, v3, v4);
  MiUnlockWorkingSetShared(Process, v2);
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140439FA8, 0LL, 17LL) != 17 )
    ExfReleasePushLockShared((signed __int64 *)&qword_140439FA8);
