...
unsigned __int64 __fastcall MiDeleteKernelStack(__int64 a1, char a2)
{
  ...
  if ( (a2 & 1) != 0 )
    ...
    v4 = (unsigned __int8)byte_14043AC7C;
  v5 = v4 + 1;
  v6 = v4;
  v7 = 0LL;
  v25 = v4 + 1;
  ...
  v10 = v9;
  v11 = v9 + 8 * v5;
  v12 = MiLockWorkingSetShared((__int64)&unk_14043B4C0);
  v24 = v12;
  if ( v9 >= v11 )
    goto LABEL_17;
  v13 = v9;
  do
  {
    if ( v7 )
    {
      if ( (v13 & 0xFFF) != 0 )
        goto LABEL_7;
      MiUnlockPageTableInternal(&unk_14043B4C0, v7);
    }
    v7 = ((v13 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
    MiLockPageTableInternal((__int64)&unk_14043B4C0, v7, 0);
LABEL_7:
    v14 = *(_QWORD *)v10;
    ...
    if ( (v14 & 1) != 0 )
    {
      if ( !v8 )
      {
        ...
        v8 = *(_QWORD *)(qword_14043A748 + 8 * ((*(_QWORD *)(v18 + 48 * (v17 & (v16 >> 12))) >> 40) & 0x3FFLL));
      }
      MiDeleteValidSystemPage(&unk_14043B4C0, v10, 0LL, v23);
      ++v23[0];
    }
    v10 += 8LL;
    v13 = v10;
  ...
  v12 = v24;
LABEL_17:
  MiUnlockWorkingSetShared((__int64)&unk_14043B4C0, v12);
  if ( (ULONG_PTR *)v8 == &MiSystemPartition )
  {
    _InterlockedExchangeAdd64(&qword_14043B030, -v6);
  ...
  MiReleasePtes((__int64)&unk_14043AC18, v9, v5);
