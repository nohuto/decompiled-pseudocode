/*
 * XREFs of FsRtlFastUnlockSingleShared @ 0x14008C1B8
 * Callers:
        ...
        char a9)
{
  ...
  unsigned __int64 v34; // [rsp+90h] [rbp+8h] BYREF
  ...
  if ( v14 )
  {
    ...
    if ( FirstOverlappingSharedNode )
    {
      ...
      if ( v21 )
      {
        ...
        while ( 1 )
        {
          if ( v21[4] == v35 && v21[5] == a5 && *((_DWORD *)v21 + 7) == a6 )
          {
            v26 = v21[1] <= v9;
            if ( v21[1] != v9 )
              goto LABEL_29;
            if ( v21[2] == *v37 )
            {
              ...
              *v22 = *v21;
              ...
              if ( v19 )
                FsRtlSplitLocks(v19, v22, v21 + 6, &v34);
              if ( !a8 && *(_QWORD *)(a1 + 16) )
              {
