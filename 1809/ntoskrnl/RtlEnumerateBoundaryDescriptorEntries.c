/*
 * XREFs of RtlEnumerateBoundaryDescriptorEntries @ 0x140654CC4
 * Callers:
 *     ObpLookupNamespaceEntry @ 0x140654668 (ObpLookupNamespaceEntry.c)
 ...
 *     ObpCompareEntryLevel1 @ 0x140654BE0 (ObpCompareEntryLevel1.c)
 * Callees:
