/*
 * XREFs of FsRtlNotifyFilterChangeDirectory @ 0x1406A0B20
 * Callers:
 *     FsRtlNotifyChangeDirectory @ 0x140816970 (FsRtlNotifyChangeDirectory.c)
 *     FsRtlNotifyFullChangeDirectory @ 0x140816B00 (FsRtlNotifyFullChangeDirectory.c)
 * Callees:
