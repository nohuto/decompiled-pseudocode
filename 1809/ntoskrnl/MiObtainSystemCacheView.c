...
_QWORD *__fastcall MiObtainSystemCacheView(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v84 = &qword_14043A558;
  v83 = 0LL;
  KxAcquireQueuedSpinLock((__int64)&v83, &qword_14043A558, a3);
  if ( *(_BYTE *)(a1 + 7132) )
    goto LABEL_3;
...
LABEL_55:
    ...
    v84 = &qword_14043A558;
    v83 = 0LL;
    KxAcquireQueuedSpinLock((__int64)&v83, &qword_14043A558, v51);
    if ( CurrentThread )
      *(_BYTE *)(a1 + 7132) = 1;
LABEL_3:
    ...
    if ( (unsigned int)CcUnmapInactiveViews(*(_QWORD *)(a1 + 168), v54, 0LL, &v86) == 1 )
    {
      ...
      if ( MiPteInShadowRange((unsigned __int64)v58) )
      {
        ...
        {
          if ( !HIBYTE(word_14043A1AC) && (v63 & 1) != 0 )
            v63 |= v65;
          *v58 = v63;
...
LABEL_102:
          if ( MiPteInShadowRange((unsigned __int64)(v58 + 1)) )
          {
            ...
            {
              if ( !HIBYTE(word_14043A1AC) && (v66 & 1) != 0 )
                v66 |= v68;
              v58[1] = v66;
...
LABEL_112:
              if ( MiPteInShadowRange((unsigned __int64)(v58 + 2)) )
              {
                ...
                {
                  if ( !HIBYTE(word_14043A1AC) && (v69 & 1) != 0 )
                    v69 |= v71;
                  v58[2] = v69;
    ...
    v84 = &qword_14043A558;
    v83 = 0LL;
    KxAcquireQueuedSpinLock((__int64)&v83, &qword_14043A558, v56);
            ...
            do
            {
              ...
              if ( qword_14043A0C0 )
              {
                if ( (v37 & 0x10) != 0 )
                  ...
                  LODWORD(v37) = ~(_DWORD)qword_14043A0C0 & v37;
              }
        ...
        do
        {
          ...
          if ( qword_14043A0C0 )
          {
            if ( (v43 & 0x10) != 0 )
              ...
              v44 = v43 & ~(_DWORD)qword_14043A0C0;
          }
