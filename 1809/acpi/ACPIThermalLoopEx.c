/*
 * XREFs of ACPIThermalLoopEx @ 0x1C0012518
 * Callers:
...
LABEL_87:
      ...
      do
      {
        v43 = *(_DWORD *)(v3 + 4LL * (unsigned int)v13 + 36);
        if ( !v43 )
          goto LABEL_95;
        v44 = *(_DWORD *)(v3 + 108);
        v45 = v44 <= v43;
      ...
      if ( *(_BYTE *)(v3 + 273) || (v15 & 2) != 0 )
      {
        ...
        else
        {
          *(_DWORD *)(a1 + 192) = v15 | 0x1000;
          ...
          v22 = (_QWORD *)qword_1C007FA28;
          v10 = v21;
          v23 = (_QWORD *)(a1 + 208);
          if ( *(__int64 **)qword_1C007FA28 != &AcpiThermalZoneList )
            __fastfail(3u);
          *(_QWORD *)(a1 + 216) = qword_1C007FA28;
          *v23 = &AcpiThermalZoneList;
          *v22 = v23;
          qword_1C007FA28 = a1 + 208;
