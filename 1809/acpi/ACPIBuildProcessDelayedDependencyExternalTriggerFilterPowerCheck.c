/*
 * XREFs of ACPIBuildProcessDelayedDependencyExternalTriggerFilterPowerCheck @ 0x1C002C4A4
 * Callers:
 ...
 *     ACPIBuildProcessDelayedDependencyShouldDelayRequest @ 0x1C002D314 (ACPIBuildProcessDelayedDependencyShouldDelayRequest.c)
