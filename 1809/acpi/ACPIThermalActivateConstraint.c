/*
 * XREFs of ACPIThermalActivateConstraint @ 0x1C000DFF0
 * Callers:
...
void __fastcall ACPIThermalActivateConstraint(__int64 a1)
{
  ...
  if ( *v5 != v4
    || (*(_QWORD *)a1 = v4,
        ...
        *v5 = a1,
        *(_QWORD *)(v4 + 8) = a1,
        v7 = (_QWORD *)qword_1C007F9F8,
        *(__int64 **)qword_1C007F9F8 != &AcpiThermalUnclaimedConstraintList) )
  {
    __fastfail(3u);
  }
  *(_QWORD *)(a1 + 24) = qword_1C007F9F8;
  *v6 = &AcpiThermalUnclaimedConstraintList;
  *v7 = v6;
  qword_1C007F9F8 = a1 + 16;
  KeReleaseSpinLock(&AcpiThermalConstraintLock, v3);
  v8 = *(_QWORD *)(a1 + 32);
  v14 = 0LL;
  v9 = AMLIGetNameSpaceObject((_BYTE *)(a1 + 56), *(__int64 **)(v8 + 712), (unsigned __int64 *)&v14, 0);
  v10 = v14;
  if ( v9 >= 0 )
  {
    if ( !v14 )
