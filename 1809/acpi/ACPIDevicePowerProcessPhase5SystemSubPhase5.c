/*
 * XREFs of ACPIDevicePowerProcessPhase5SystemSubPhase5 @ 0x1C004FBB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDevicePowerProcessPhase5SystemSubPhase5(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 212) = 8;
  ...
  {
    qword_1C0080078 = a1;
    qword_1C0080068 = (__int64)&AcpiPauseInterpreterEntry;
    qword_1C0080070 = (__int64)ACPIDeviceCompleteInterpreterRequest;
