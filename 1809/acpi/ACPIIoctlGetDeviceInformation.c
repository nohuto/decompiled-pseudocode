/*
 * XREFs of ACPIIoctlGetDeviceInformation @ 0x1C00561B0
 * Callers:
  ...
  if ( DeviceExtension )
  {
    ...
    if ( v3 >= v7 )
    {
      ...
      if ( (*(_QWORD *)(v9 + 8) & 0x200000000000LL) != 0 )
      {
        ...
        memmove(&MasterIrp->ThreadListEntry, (const void *)(*(_QWORD *)(v9 + 560) + 5LL), v19 + 1LL);
      ...
      if ( (*(_BYTE *)(v9 + 952) & 0x10) != 0 )
      {
        ...
        memmove((char *)MasterIrp + v6, *(const void **)(v9 + 576), (unsigned __int16)v20 + 1LL);
      ...
      if ( (*(_QWORD *)(v9 + 8) & 0x400000000000LL) != 0 )
      {
        ...
        *((_WORD *)&MasterIrp->Flags + 2) = v11;
        memmove((char *)MasterIrp + v6, *(const void **)(v9 + 568), (unsigned __int16)v11 + 1LL);
      }
      v21 = *(_QWORD *)(v9 + 952);
      if ( (v21 & 4) != 0 )
      {
