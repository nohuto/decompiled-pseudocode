/*
 * XREFs of ACPIBuildProcessDevicePhasePr3 @ 0x1C00152A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessDevicePhasePr3(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v5 = a1 + 80;
  v6 = 0;
  if ( *(_QWORD *)(v4 + 440) || *(_QWORD *)(v4 + 392) )
  {
    if ( !*(_QWORD *)(a1 + 56) )
      goto LABEL_6;
    dword_1C0080868 = 0;
...
LABEL_29:
  ...
  v8 = AMLIGetNamedChild(*(_QWORD *)(v4 + 712), 861098079LL, a3, a4);
  *(_QWORD *)(v4 + 440) = v8;
  if ( !v8 )
    *(_QWORD *)(v4 + 440) = *(_QWORD *)(v4 + 432);
  v9 = *(_QWORD *)(a1 + 56);
  if ( v9 )
  {
    if ( *(_WORD *)(v5 + 2) != 4 )
    ...
    v19 = ACPIBuildDevicePowerNodes(v4, v9);
    dword_1C0080868 = 0;
    v6 = v19;
    pszDest = 0;
    goto LABEL_29;
...
LABEL_6:
  ...
  if ( (*(_DWORD *)(v4 + 952) & 0x400040) == 0 )
  {
    ...
    _InterlockedOr64((volatile signed __int64 *)(v4 + 952), 0x400000uLL);
    *(_DWORD *)(a1 + 20) |= 0x20u;
    return ACPIBuildDelayedDependencyRequest(a1, &AcpiBuildDeviceList);
  }
LABEL_11:
