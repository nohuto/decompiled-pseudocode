/*
 * XREFs of IrqArbpSetDeviceProperties @ 0x1C008FF20
 * Callers:
 ...
 *     IrqPolicySetDeviceAffinity @ 0x1C008FBC8 (IrqPolicySetDeviceAffinity.c)
  ...
  *(_OWORD *)&Iterator.Current = v4;
  while ( 1 )
  {
    if ( a1->Owner == *p_Owner )
    {
      ...
      {
        IrqPolicySetDeviceAffinity((__int64)Owner, v30);
        v12 = v31;
        v5 = 1;
      }
