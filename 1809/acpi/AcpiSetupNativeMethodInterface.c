/*
 * XREFs of AcpiSetupNativeMethodInterface @ 0x1C009BF24
 * Callers:
    ...
    if ( AttachedDeviceReference )
    {
      ...
      *((_QWORD *)&OutputBuffer[5] + 1) = AcpiTranslatePepDeviceControlResources;
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_1C007FBB0 = OutputBuffer[1];
        unk_1C007FBC0 = OutputBuffer[2];
        xmmword_1C007FBD0 = OutputBuffer[3];
        xmmword_1C007FBE0 = OutputBuffer[4];
        xmmword_1C007FBF0 = OutputBuffer[5];
