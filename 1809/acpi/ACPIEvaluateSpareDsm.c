/*
 * XREFs of ACPIEvaluateSpareDsm @ 0x1C00AC57C
 * Callers:
...
__int64 __fastcall ACPIEvaluateSpareDsm(unsigned __int64 *a1, unsigned int a2, __int128 *a3, void *a4)
{
  __int64 v4; // rbx
  __int128 v8; // xmm0
  int v9; // eax
  ...
  return AMLIEvalNameSpaceObject(a1, a4, 4, v16, v12, v13, v14, v15);
}
