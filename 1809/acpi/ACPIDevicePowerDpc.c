/*
 * XREFs of ACPIDevicePowerDpc @ 0x1C001FAE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIInternalMovePowerList @ 0x1C00209AC (ACPIInternalMovePowerList.c)
 ...
 *     ACPIDevicePowerProcessBlockedItems @ 0x1C0028CA0 (ACPIDevicePowerProcessBlockedItems.c)
          ...
          if ( *(&v11->Next->Next + 1) != v11
            ...
            || (*v43 = Next,
                *((_QWORD *)&Next->Next + 1) = v43,
                ...
                v44 = (struct _SLIST_ENTRY **)qword_1C00800F8,
                *(__int64 **)qword_1C00800F8 != &AcpiPowerBlockedOnDependencyList) )
          {
LABEL_105:
            __fastfail(3u);
          }
        ...
        if ( v25 == 1 )
        {
          ...
          if ( v28 )
          {
            ...
            *((_QWORD *)&v39->Next + 1) = v40;
            ...
            v41 = (struct _SLIST_ENTRY **)qword_1C00800F8;
            if ( *(__int64 **)qword_1C00800F8 != &AcpiPowerBlockedOnDependencyList )
              goto LABEL_105;
            v24->Next = (_SLIST_ENTRY *)&AcpiPowerBlockedOnDependencyList;
            *((_QWORD *)&v24->Next + 1) = v41;
            *v41 = v24;
            qword_1C00800F8 = (__int64)v24;
          }
        }
