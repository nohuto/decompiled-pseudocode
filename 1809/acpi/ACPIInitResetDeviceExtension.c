/*
 * XREFs of ACPIInitResetDeviceExtension @ 0x1C002DD7C
 * Callers:
...
void __fastcall ACPIInitResetDeviceExtension(ULONG_PTR BugCheckParameter4)
{
  ...
  if ( (v4 & 0x40) != 0 )
  {
    if ( (v4 & 0x20) != 0 )
    {
      v11 = *(void **)(BugCheckParameter4 + 728);
      if ( v11 )
  ...
  v5 = *(void **)(BugCheckParameter4 + 640);
  if ( v5 )
    *(_QWORD *)(BugCheckParameter4 + 640) = 0LL;
  v6 = *(void **)(BugCheckParameter4 + 624);
  if ( v6 )
    *(_QWORD *)(BugCheckParameter4 + 624) = 0LL;
  v7 = *(void **)(BugCheckParameter4 + 632);
  if ( v7 )
    *(_QWORD *)(BugCheckParameter4 + 632) = 0LL;
  v8 = *(struct _DEVICE_OBJECT **)(BugCheckParameter4 + 720);
  v9 = 3LL;
  if ( !v8 )
    goto LABEL_13;
  ...
  *(_QWORD *)(BugCheckParameter4 + 720) = 0LL;
  if ( (*(_QWORD *)(BugCheckParameter4 + 8) & 0x2000000000LL) != 0 && *(_BYTE *)(BugCheckParameter4 + 184) )
  {
    ...
    do
    {
      *(_QWORD *)&v14[(_QWORD)v13 - BugCheckParameter4 - 192] = *v13;
      *v13++ = 0LL;
      --v12;
    }
    while ( v12 );
