/*
 * XREFs of ACPIBuildProcessDevicePhaseAdr @ 0x1C0014EA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessDevicePhaseAdr(__int64 a1)
{
  ...
  {
    v12 = ACPIVerifyAndCopyFirmwareDependencies(*(_QWORD *)(v1 + 712), a1 + 80, v1 + 600);
    dword_1C0080868 = 0;
    pszDest = 0;
    v3 = v12;
...
LABEL_3:
  ...
  {
    v7 = AMLIGetNamedChild(*(_QWORD *)(v1 + 712), 1380204895LL, v5, v6);
    if ( !v7 )
