/*
 * XREFs of PnpiBiosDmaToIoDescriptorV3 @ 0x1C00AFD7C
 * Callers:
...
__int64 __fastcall PnpiBiosDmaToIoDescriptorV3(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  _WORD *v5; // rcx
  _WORD *v6; // [rsp+30h] [rbp+8h] BYREF

  result = PnpiUpdateResourceList((const void **)(a2 + 8LL * (unsigned int)a3), &v6, a3);
  if ( (int)result >= 0 )
  {
    v5 = v6;
    *v6 = 1024;
