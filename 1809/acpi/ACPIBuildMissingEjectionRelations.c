/*
 * XREFs of ACPIBuildMissingEjectionRelations @ 0x1C004A010
 * Callers:
...
LABEL_24:
      ...
      v5 = AMLIEvalNameSpaceObject((unsigned __int64 *)v4, v16, 0, 0LL);
...
LABEL_20:
          *v9 = &AcpiUnresolvedEjectList;
          v9[1] = v8;
          *v8 = v9;
          qword_1C0080388 = (__int64)v9;
          goto LABEL_21;
        }
        if ( v17 != 2 )
          KeBugCheckEx(0xA5u, 0xAuLL, v2, (ULONG_PTR)v4, v17);
        v10 = AMLIGetNameSpaceObject(Src, 0LL, (unsigned __int64 *)&v19, 0);
        v7 = v19;
        if ( v10 < 0
          || (dword_1C0080868 = 0, pszDest = 0, FreeDataBuffs((__int64)v16, 1u), !v7)
