/*
 * XREFs of SleepQueueRequest @ 0x1C006508C
 * Callers:
...
__int64 __fastcall SleepQueueRequest(struct _SLIST_ENTRY *a1, unsigned int a2)
{
  ...
  if ( v4 >= 0 )
  {
    byte_1C0081128 = KeAcquireSpinLockRaiseToDpc(&gmutSleep);
    v5 = &SleepQueue;
    ...
    v15[6] = v8;
    v7[7] = a1;
    for ( i = (__int64 *)qword_1C0081118; ; i = (__int64 *)i[1] )
    {
      if ( i == &SleepQueue )
        goto LABEL_9;
      if ( v8 >= i[2] )
...
LABEL_9:
    ...
    KeReleaseSpinLock(&gmutSleep, byte_1C0081128);
  }
