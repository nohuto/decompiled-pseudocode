...
__int64 __fastcall ToDecStr(struct _SLIST_ENTRY *a1, __int64 a2)
{
  ...
  if ( !v4 )
  {
    v4 = ValidateTarget((__int64)a1, *(_QWORD *)(a2 + 80) + 40LL, 135LL, (__int64)&v28);
    if ( !v4 )
    {
      ...
      switch ( *(_WORD *)(v5 + 2) )
      {
        case 1:
          ...
          *(_DWORD *)(*(_QWORD *)(a2 + 88) + 24LL) = v8 + 1;
          ...
          v24 = HeapAlloc((struct _SLIST_ENTRY *)gpheapGlobal, 1381258056, *(_DWORD *)(*(_QWORD *)(a2 + 88) + 24LL));
          *(_QWORD *)(*(_QWORD *)(a2 + 88) + 32LL) = v24;
          if ( v24 )
          {
            ...
            {
              v26 = HTOALookupTable[v25 % 0xA];
              v25 /= 0xAuLL;
              *(_BYTE *)(i + *(_QWORD *)(*(_QWORD *)(a2 + 88) + 32LL)) = v26;
            }
            goto LABEL_33;
          }
          break;
        case 2:
          *(_DWORD *)(*(_QWORD *)(a2 + 88) + 24LL) = *(_DWORD *)(v5 + 24);
          ...
          v22 = HeapAlloc((struct _SLIST_ENTRY *)gpheapGlobal, 1381258056, *(_DWORD *)(*(_QWORD *)(a2 + 88) + 24LL));
          *(_QWORD *)(*(_QWORD *)(a2 + 88) + 32LL) = v22;
          if ( v22 )
          {
            ...
            return (unsigned int)WriteObject(a1, v28, *(_QWORD *)(a2 + 88), i);
          }
          break;
        case 3:
          v7 = *(_DWORD *)(v5 + 24);
          ...
          *(_DWORD *)(*(_QWORD *)(a2 + 88) + 24LL) = v8 + 1;
          ...
          v12 = HeapAlloc((struct _SLIST_ENTRY *)gpheapGlobal, 1381258056, *(_DWORD *)(*(_QWORD *)(a2 + 88) + 24LL));
          *(_QWORD *)(*(_QWORD *)(a2 + 88) + 32LL) = v12;
          if ( v12 )
          {
            v13 = *(_QWORD *)(a2 + 80);
            v14 = 0;
            for ( i = 0LL; v14 < *(_DWORD *)(v13 + 24); v13 = *(_QWORD *)(a2 + 80) )
            {
              v16 = *(_QWORD *)(a2 + 88);
              v17 = (unsigned int)i;
