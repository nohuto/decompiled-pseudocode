/*
 * XREFs of ArbInitializeArbiterInstance @ 0x1C009C5E4
 * Callers:
 *     AcpiInitializeBusNumberArbiter @ 0x1C00AA524 (AcpiInitializeBusNumberArbiter.c)
 *     AcpiInitializeMemoryArbiter @ 0x1C00AC418 (AcpiInitializeMemoryArbiter.c)
 *     AcpiInitializePortArbiter @ 0x1C00ADF64 (AcpiInitializePortArbiter.c)
 *     AcpiIrqLibInitializeGlobalState @ 0x1C00BB084 (AcpiIrqLibInitializeGlobalState.c)
 * Callees:
 *     RtlInitializeRangeList_0 @ 0x1C0030AE1 (RtlInitializeRangeList_0.c)
