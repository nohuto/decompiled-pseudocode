/*
 * XREFs of WPP_RECORDER_SF_dL @ 0x1C0016B38
 * Callers:
  ...
  if ( _bittest(&v10, ((_BYTE)a3 - 1) & 0x1F) && *((_BYTE *)&WPP_GLOBAL_Control->Timer + 80 * v8 + 1) >= a2 )
    ((void (__fastcall *)(_QWORD, __int64, void *, _QWORD, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      *((_QWORD *)&WPP_GLOBAL_Control->AttachedDevice + 10 * v8),
      43LL,
      &WPP_19c1b0bbd5523038c65c89ceb5c545fb_Traceguids,
      a4,
      (__int64 *)va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v12) = a4;
  return WppAutoLogTrace(a1, a2, a3, &WPP_19c1b0bbd5523038c65c89ceb5c545fb_Traceguids, v12, (__int64 *)va, 4LL, va1);
}
