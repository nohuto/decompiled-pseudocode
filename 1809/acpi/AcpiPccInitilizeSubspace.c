/*
 * XREFs of AcpiPccInitilizeSubspace @ 0x1C00ACD3C
 * Callers:
...
__int64 __fastcall AcpiPccInitilizeSubspace(char *DeferredContext)
{
  ...
  if ( v2 == 1 )
  {
    if ( (unsigned __int8)DeferredContext[83] > 0x20u )
      goto LABEL_3;
  }
  else if ( v2 )
  {
  ...
  if ( (*((_QWORD *)DeferredContext + 8) & *((_QWORD *)DeferredContext + 7)) == 0LL )
  {
    v4 = 516;
    if ( v2 )
      goto LABEL_12;
...
LABEL_12:
      v3 = HalGetMemoryCachingRequirements(
             ...
             *((unsigned int *)DeferredContext + 26),
             &v15);
      if ( v3 >= 0 )
      {
        v12 = v15;
