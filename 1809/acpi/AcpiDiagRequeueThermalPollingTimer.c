/*
 * XREFs of AcpiDiagRequeueThermalPollingTimer @ 0x1C0047AE0
 * Callers:
 *     AcpiDiagThermalPollingTimerRoutine @ 0x1C0047BA0 (AcpiDiagThermalPollingTimerRoutine.c)
 *     AcpiDiagThermalPollingTraceControlCallback @ 0x1C0047C20 (AcpiDiagThermalPollingTraceControlCallback.c)
