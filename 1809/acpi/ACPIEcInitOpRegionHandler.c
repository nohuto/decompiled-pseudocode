/*
 * XREFs of ACPIEcInitOpRegionHandler @ 0x1C0026218
 * Callers:
 ...
 *     RtlStringCchLengthA @ 0x1C0048A6C (RtlStringCchLengthA.c)
 ...
 *     ACPIEcDisconnectGpioInterrupt @ 0x1C00AAC14 (ACPIEcDisconnectGpioInterrupt.c)
 */
