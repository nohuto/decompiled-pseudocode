/*
 * XREFs of ACPIIoctlUnRegisterOpRegionHandler @ 0x1C00564CC
 * Callers:
...
__int64 __fastcall ACPIIoctlUnRegisterOpRegionHandler(ULONG_PTR a1, IRP *a2, __int64 a3)
{
  ...
  if ( v3 >= 0x10 )
    v6 = UnRegisterOperationRegionHandler(*(_QWORD *)(DeviceExtension + 712), a2->AssociatedIrp.MasterIrp->MdlAddress);
  else
    v6 = -1073741820;
