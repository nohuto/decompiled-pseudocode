/*
 * XREFs of InsertReadyQueue @ 0x1C0004270
 * Callers:
 ...
 *     RestartCtxtPassive @ 0x1C0029CC0 (RestartCtxtPassive.c)
 * Callees:
...
__int64 __fastcall InsertReadyQueue(PSLIST_ENTRY ListEntry, char a2)
{
  ...
  {
    v11 = _InterlockedExchangeAdd((_DWORD *)&qword_1C0080838 + 1, 1u);
    if ( (_DWORD)qword_1C0080838 == 204 )
      v12 = v11 % 0xCC;
    else
      v12 = v11 % (unsigned int)qword_1C0080838;
    v13 = 72LL * v12;
    *(_QWORD *)((char *)qword_1C0080840 + v13 + 8) = MEMORY[0xFFFFF78000000008];
    *(_DWORD *)((char *)qword_1C0080840 + v13) = 1229869905;
    *(_QWORD *)((char *)qword_1C0080840 + v13 + 16) = CurrentThread;
    *(_QWORD *)((char *)qword_1C0080840 + v13 + 24) = v9;
    *(_QWORD *)((char *)qword_1C0080840 + v13 + 32) = ListEntry;
    *(_QWORD *)((char *)qword_1C0080840 + v13 + 40) = v10;
    *(_QWORD *)((char *)qword_1C0080840 + v13 + 48) = ListEntry;
    *(_QWORD *)((char *)qword_1C0080840 + v13 + 56) = v6;
    *(_QWORD *)((char *)qword_1C0080840 + v13 + 64) = v8;
  }
    ...
    if ( (v16 & 0x10) == 0 || v17 )
    {
      if ( !a2 )
      {
        if ( (gdwfAMLI & 4) != 0 )
        {
          ...
          v39 = ListEntry + 2;
          v40 = (PSLIST_ENTRY *)qword_1C0080700;
          if ( *(__int64 **)qword_1C0080700 == &qword_1C00806F8 )
            goto LABEL_36;
        }
        else
        {
          ...
          if ( (__int64 *)RunningContextListHead == &RunningContextListHead && (gReadyQueue & 8) == 0 )
          {
            ...
            if ( (gDebugger & 0x8000) != 0 && qword_1C0080840 )
            {
              v24 = _InterlockedExchangeAdd((_DWORD *)&qword_1C0080838 + 1, 1u);
              if ( (_DWORD)qword_1C0080838 == 204 )
                v25 = v24 % 0xCC;
              else
                v25 = v24 % (unsigned int)qword_1C0080838;
              v26 = 72LL * v25;
              *(_QWORD *)((char *)qword_1C0080840 + v26 + 8) = MEMORY[0xFFFFF78000000008];
              *(_DWORD *)((char *)qword_1C0080840 + v26) = 1163280716;
              *(_QWORD *)((char *)qword_1C0080840 + v26 + 16) = v20;
              *(_QWORD *)((char *)qword_1C0080840 + v26 + 24) = v22;
              *(_QWORD *)((char *)qword_1C0080840 + v26 + 32) = ListEntry;
              *(_QWORD *)((char *)qword_1C0080840 + v26 + 40) = v23;
              *(_QWORD *)((char *)qword_1C0080840 + v26 + 48) = ListEntry;
              *(_QWORD *)((char *)qword_1C0080840 + v26 + 56) = v19;
              *(_QWORD *)((char *)qword_1C0080840 + v26 + 64) = v21;
            }
          ...
          if ( (gDebugger & 0x8000) != 0 && qword_1C0080840 )
          {
            v35 = _InterlockedExchangeAdd((_DWORD *)&qword_1C0080838 + 1, 1u);
            if ( (_DWORD)qword_1C0080838 == 204 )
              v36 = v35 % 0xCC;
            else
              v36 = v35 % (unsigned int)qword_1C0080838;
            v37 = 72LL * v36;
            *(_QWORD *)((char *)qword_1C0080840 + v37 + 8) = MEMORY[0xFFFFF78000000008];
            *(_DWORD *)((char *)qword_1C0080840 + v37) = 1363367000;
            *(_QWORD *)((char *)qword_1C0080840 + v37 + 16) = v31;
            *(_QWORD *)((char *)qword_1C0080840 + v37 + 24) = v33;
            *(_QWORD *)((char *)qword_1C0080840 + v37 + 32) = ListEntry;
            *(_QWORD *)((char *)qword_1C0080840 + v37 + 40) = v34;
            *(_QWORD *)((char *)qword_1C0080840 + v37 + 48) = ListEntry;
            *(_QWORD *)((char *)qword_1C0080840 + v37 + 56) = v30;
            *(_QWORD *)((char *)qword_1C0080840 + v37 + 64) = v32;
          }
          v38 = (int)ListEntry[4].Next;
          if ( (v38 & 0x40) != 0 )
          {
LABEL_37:
          ...
          {
LABEL_36:
            v39->Next = (_SLIST_ENTRY *)&qword_1C00806F8;
            *((_QWORD *)&v39->Next + 1) = v40;
            *v40 = v39;
            qword_1C0080700 = (__int64)v39;
            v38 = (int)ListEntry[4].Next;
            goto LABEL_37;
          }
        }
      ...
      if ( v42 == EvalMethodComplete )
      {
        ...
        if ( (gDebugger & 0x8000) != 0 && qword_1C0080840 )
        {
          ...
          *(_DWORD *)((char *)qword_1C0080840 + v50) = 1146048069;
          *(_QWORD *)((char *)qword_1C0080840 + v50 + 16) = v45;
          *(_QWORD *)((char *)qword_1C0080840 + v50 + 24) = v46;
          *(_QWORD *)((char *)qword_1C0080840 + v50 + 32) = ListEntry;
          *(_QWORD *)((char *)qword_1C0080840 + v50 + 40) = v47;
          *(_QWORD *)((char *)qword_1C0080840 + v50 + 48) = v43;
          *(_QWORD *)((char *)qword_1C0080840 + v50 + 56) = 32771LL;
          *(_QWORD *)((char *)qword_1C0080840 + v50 + 64) = v44;
        }
        *(_DWORD *)v44 = 32771;
