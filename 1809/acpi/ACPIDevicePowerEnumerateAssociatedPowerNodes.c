/*
 * XREFs of ACPIDevicePowerEnumerateAssociatedPowerNodes @ 0x1C001BC14
 * Callers:
 ...
 *     ACPIDeviceRecordBlockedOnPhase3List @ 0x1C002FD78 (ACPIDeviceRecordBlockedOnPhase3List.c)
 * Callees:
