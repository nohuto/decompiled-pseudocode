/*
 * XREFs of ACPITableNotifyFreeObject @ 0x1C005D540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPITableNotifyFreeObject(int a1, KIRQL *a2, int a3, int a4)
{
  ...
  switch ( a1 )
  {
    case 1:
      ...
      *a2 = KeAcquireSpinLockRaiseToDpc(&AcpiPowerLock);
    ...
    case 3:
      ...
      KeReleaseSpinLock(&AcpiPowerLock, *a2);
      return 0LL;
    case 6:
    ...
    default:
      ...
      v8 = a1 - 4;
      if ( !v8 )
        KeBugCheckEx(0xA5u, 0x13uLL, (ULONG_PTR)a2, 0LL, 0LL);
      if ( v8 == 1 )
        KeBugCheckEx(0xA5u, 0x13uLL, (ULONG_PTR)a2, 1uLL, 0LL);
      if ( a3 == 11 )
      {
        LOBYTE(v7) = 1;
LABEL_8:
        AMLIFinalizeObject(a2, v7);
        return 0LL;
      }
      if ( a3 == 10 )
      {
        v9 = *(_QWORD *)a2;
        if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)a2 + 96LL) + 12LL) == 2 )
        {
          v10 = *(_QWORD *)(v9 + 104);
          *(_QWORD *)(v9 + 104) = 0LL;
