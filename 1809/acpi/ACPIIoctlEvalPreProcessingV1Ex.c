/*
 * XREFs of ACPIIoctlEvalPreProcessingV1Ex @ 0x1C0028E9C
 * Callers:
        ...
        unsigned int *a8)
{
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( (unsigned int)(v9 - 1) <= 0x12 )
    return 3221225507LL;
  v14 = *(int **)(a2 + 24);
  v15 = *(__int64 **)(ACPIInternalGetDeviceExtension(a1) + 712);
  if ( !v15 )
    return 3221225486LL;
  _strupr((char *)v14 + 4);
  v16 = AMLIGetNameSpaceObject((_BYTE *)v14 + 4, v15, (unsigned __int64 *)&v30, 1u);
  if ( v16 >= 0 )
  {
