/*
 * XREFs of DeleteExternalTranslatorInterface @ 0x1C00AB878
 * Callers:
 *     AcpiExternalInterfaceUnload @ 0x1C00AB3E0 (AcpiExternalInterfaceUnload.c)
 *     NotifyExternalTranslationInterfaceChange @ 0x1C00ABAE0 (NotifyExternalTranslationInterfaceChange.c)
 * Callees:
 *     <none>
 */
