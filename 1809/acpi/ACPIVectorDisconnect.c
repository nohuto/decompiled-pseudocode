/*
 * XREFs of ACPIVectorDisconnect @ 0x1C005EAA0
 * Callers:
 *     ACPIVectorDisconnect2 @ 0x1C005EBB0 (ACPIVectorDisconnect2.c)
 *     ACPIEcDisconnectGpeVector @ 0x1C00AABE8 (ACPIEcDisconnectGpeVector.c)
 * Callees:
...
__int64 __fastcall ACPIVectorDisconnect(unsigned int *P)
{
  ...
  v4 = *(unsigned __int8 *)((unsigned int)ACPIGpeIndexToByteIndex(*P) + GpeMap);
  ...
  v6 = 0;
  if ( !ACPIGpeInstallRemoveIndex(*P, 2, 0, (char *)P + 25) )
    v6 = -1073741823;
