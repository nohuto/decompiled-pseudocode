/*
 * XREFs of ProcessorpReserveIdtEntriesApic @ 0x1C009D790
 * Callers:
 *     <none>
 * Callees:
        ...
        _OWORD *a9)
{
  ...
  struct _RTL_RANGE_LIST *v22; // r10
  struct _RTL_RANGE_LIST *v23; // rcx
  NTSTATUS v24; // r15d
...
LABEL_14:
  ...
  if ( v14 != 1 )
    v23 = v22;
  v24 = RtlAddRange(v23, (unsigned int)Start, a5 + (unsigned int)Start - 1LL, v19, 2 * (a7 & 1) + 1, UserData, Owner);
  if ( v24 >= 0 )
  {
    v14 = a8;
    *UserData |= 1LL << i;
