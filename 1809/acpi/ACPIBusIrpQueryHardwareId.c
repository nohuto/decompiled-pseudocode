/*
 * XREFs of ACPIBusIrpQueryHardwareId @ 0x1C008DA80
 * Callers:
...
__int64 __fastcall ACPIBusIrpQueryHardwareId(wchar_t **a1, size_t *a2, __int64 a3)
{
  ...
  v35 = 0LL;
  v38[0] = 0LL;
  v8 = ACPIGet((__int64 *)a3, 1145653343, 268959830, 0LL, 0, 0LL, 0LL, (__int64)&Src, (__int64)&v35);
  if ( v8 < 0 )
    goto LABEL_41;
...
LABEL_26:
    if ( v10 < v35 )
      goto LABEL_29;
    v25 = RtlStringCbPrintfExW(&v11[v35 >> 1], v10 - v35, &ppszDestEnd, &pcbRemaining, 0, &word_1C006E654);
    goto LABEL_28;
  }
  v13 = *(_QWORD *)(a3 + 8);
  ...
  if ( !v14 )
  {
    v25 = ACPIGet((__int64 *)a3, 1145653343, 268959782, 0LL, 0, 0LL, 0LL, (__int64)&P, (__int64)&Size);
LABEL_28:
    v8 = v25;
    goto LABEL_29;
  }
...
LABEL_29:
  ...
  if ( (v22 & 0x10) != 0 )
  {
    v8 = ACPIGet((__int64 *)a3, 1112888159, 268959764, 0LL, 0, 0LL, 0LL, (__int64)&v37, (__int64)v38);
    if ( v8 < 0 )
      goto LABEL_41;
    if ( (*(_BYTE *)(a3 + 952) & 8) != 0 )
    {
