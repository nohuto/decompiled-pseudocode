/*
 * XREFs of ACPIInitDeleteDeviceExtension @ 0x1C00545E8
 * Callers:
 ...
 *     ACPIInternalInterruptPolarityCacheCleanup @ 0x1C002DF84 (ACPIInternalInterruptPolarityCacheCleanup.c)
...
LABEL_45:
  ...
  *((_DWORD *)Entry + 212) = *(_DWORD *)(**((_QWORD **)Entry + 89) + 40LL);
  v28 = (_QWORD *)qword_1C00801A8;
  if ( *(__int64 **)qword_1C00801A8 != &AcpiDevicesWhichMightNeedEnumerationList )
    goto LABEL_45;
  *v27 = &AcpiDevicesWhichMightNeedEnumerationList;
  *((_QWORD *)Entry + 105) = v28;
  *v28 = v27;
  qword_1C00801A8 = (__int64)(Entry + 208);
