/*
 * XREFs of AcpiUpdateInterruptProperties @ 0x1C00AB7F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ProcessorUpdateInterruptProperties @ 0x1C00B2B84 (ProcessorUpdateInterruptProperties.c)
 *     IrqArbUpdateInterruptProperties @ 0x1C00B2F74 (IrqArbUpdateInterruptProperties.c)
 *     IcUpdateInterruptProperties @ 0x1C00B3418 (IcUpdateInterruptProperties.c)
 */
