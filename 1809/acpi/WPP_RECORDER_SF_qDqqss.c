/*
 * XREFs of WPP_RECORDER_SF_qDqqss @ 0x1C00504A8
 * Callers:
 *     ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum @ 0x1C00500F0 (ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum.c)
 * Callees:
        ...
        const char *a11)
{
  ...
  LOWORD(v24) = a4;
  return WppAutoLogTrace(a1, 4LL, 10LL, &WPP_ebbf6b4b528633821945452aad9f1fdf_Traceguids, v24, &a6);
}
