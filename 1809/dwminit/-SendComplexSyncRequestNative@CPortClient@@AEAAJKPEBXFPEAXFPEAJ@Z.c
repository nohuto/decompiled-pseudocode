/*
 * XREFs of ?SendComplexSyncRequestNative@CPortClient@@AEAAJKPEBXFPEAXFPEAJ@Z @ 0x180004B70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AssertW@@YAXPEBG000K@Z @ 0x180003C10 (-AssertW@@YAXPEBG000K@Z.c)
 *     ?CheckStatus@CPortClient@@AEAAJJ@Z @ 0x18000487C (-CheckStatus@CPortClient@@AEAAJJ@Z.c)
 *     memcpy_0 @ 0x180006609 (memcpy_0.c)
 */
        ...
        int *a7)
{
  ...
  if ( v14 )
  {
    ...
    if ( v17 >= 0 )
    {
      ...
      {
        v8 = a6 + 8 != v15->u1.s1.DataLength ? 0x80070018 : 0;
        if ( v15->u1.s1.DataLength == a6 + 8 )
          memcpy_0(a5, &v15[1].DoNotUseThisField, a6);
        else
          MilInstrumentationCheckHR_MaybeFailFast(1u, &CPortClient::MILINSTRUMENTATIONHRESULTLIST, 8LL, v8, 0xBAu);
      }
