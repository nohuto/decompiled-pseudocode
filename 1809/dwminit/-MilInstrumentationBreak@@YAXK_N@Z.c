/*
 * XREFs of ?MilInstrumentationBreak@@YAXK_N@Z @ 0x180003A10
 * Callers:
 ...
 * Callees:
 *     BreakForInstrumentation @ 0x1800039CC (BreakForInstrumentation.c)
 *     ?IsKernelDebuggerEnabled@@YAHXZ @ 0x180003B50 (-IsKernelDebuggerEnabled@@YAHXZ.c)
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x180003BA0 (-IsKernelDebuggerPresent@@YAHXZ.c)
