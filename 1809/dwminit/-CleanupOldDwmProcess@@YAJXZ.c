/*
 * XREFs of ?CleanupOldDwmProcess@@YAJXZ @ 0x180002714
 * Callers:
 ...
 *     ?GetPrimaryDisplayDeviceInfo@@YA_NPEAU_DISPLAY_DEVICEW@@@Z @ 0x1800022A8 (-GetPrimaryDisplayDeviceInfo@@YA_NPEAU_DISPLAY_DEVICEW@@@Z.c)
...
__int64 CleanupOldDwmProcess(void)
{
  ...
  else
  {
      ...
      && (qword_18000B018 & 0x400000000000LL) == qword_18000B018 )
    {
      ...
      v30 = 2LL;
      v32 = 2LL;
      TlgWrite(v3, &unk_1800085E9, v5, v6, 8u, &pData);
    }
  ...
  if ( restarted )
  {
      ...
      && (qword_18000B018 & 0x400000000000LL) == qword_18000B018 )
    {
      ...
      v30 = 2LL;
      v32 = 2LL;
      TlgWrite(v13, &unk_1800088A4, v14, v15, 8u, &pData);
    }
    _unnamed_type_gDwmInitTelemetryAggregator_::ReportAggregatedValues(v13, v12, (__int64)v14, v15);
