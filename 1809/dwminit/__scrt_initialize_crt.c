/*
 * XREFs of __scrt_initialize_crt @ 0x180005288
 * Callers:
 *     dllmain_crt_process_attach @ 0x180006078 (dllmain_crt_process_attach.c)
 * Callees:
 *     __isa_available_init @ 0x1800056F0 (__isa_available_init.c)
 *     __scrt_stub_for_acrt_uninitialize_critical @ 0x18000656C (__scrt_stub_for_acrt_uninitialize_critical.c)
 */
