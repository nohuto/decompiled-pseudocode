/*
 * XREFs of ?StartInactivityTimer@CProcess@@QEAAXXZ @ 0x18001620C
 * Callers:
  ...
  if ( !*((_QWORD *)this + 49) )
  {
    ...
    *((_QWORD *)this + 49) = v3;
    ...
    if ( v2 < 0 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Du, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids, v2);
      }
      AudPolicyLogError("CProcess::StartInactivityTimer", 3499, v2);
    }
  }
  if ( v6 )
