/*
 * XREFs of ?HasAccessibilityAudioStateChanged@CWindowsPolicyManager@@UEAA?AW4AccessibilityStateChange@@XZ @ 0x18000A320
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
     ...
     || (int)CWindowsPolicyManager::InitAccessibilityAudioSettings(v6, v5) >= 0) )
  {
    ...
    if ( !(unsigned int)TsSessionFromSessionId(v5, 1, 0LL, &v10) && (!*(_DWORD *)v10 || !*((_DWORD *)v10 + 84)) )
      v7 = 0;
    if ( v8 )
