/*
 * XREFs of ?TsSessionIdAddNotify@@YAJKKPEAPEAUAUDIOPROTOCOLNOTIFY@@@Z @ 0x180028AD8
 * Callers:
 *     TS_RegisterAudioProtocolNotification @ 0x18002AB10 (TS_RegisterAudioProtocolNotification.c)
 * Callees:
