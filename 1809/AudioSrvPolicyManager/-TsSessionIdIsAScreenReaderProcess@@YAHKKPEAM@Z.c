/*
 * XREFs of ?TsSessionIdIsAScreenReaderProcess@@YAHKKPEAM@Z @ 0x18002984C
 * Callers:
 *     ?CanBeRemoved@CProcess@@QEAAHXZ @ 0x180015D58 (-CanBeRemoved@CProcess@@QEAAHXZ.c)
 *     ?GetScreenReaderPolicyVolume@CProcess@@UEAAMXZ @ 0x180016FF0 (-GetScreenReaderPolicyVolume@CProcess@@UEAAMXZ.c)
 *     ?IsScreenReaderProcess@CProcess@@UEAA_NXZ @ 0x180017030 (-IsScreenReaderProcess@CProcess@@UEAA_NXZ.c)
