/*
 * XREFs of ?QueryInterface@CDuckingManager@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18000CF80
 * Callers:
 *     ?QueryInterface@CDuckingManager@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180010320 (-QueryInterface@CDuckingManager@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CDuckingManager@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180010370 (-QueryInterface@CDuckingManager@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
