/*
 * XREFs of ?NotifyPLM@CProcess@@QEAAXW4_PLM_EXEMPTION@@@Z @ 0x180016620
 * Callers:
...
LABEL_48:
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x34u, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids, Instance);
  }
  AudPolicyLogError("CProcess::NotifyPLM", 3695, Instance);
}
