/*
 * XREFs of ?QueryInterface@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UIEndpointVolumeStateManager@@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18002F5D0
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  if ( !*a2
    ...
    && a2[3] == *(_DWORD *)&GUID_59d5b9a9_5e6e_4cd4_baae_95ad8d257a28.Data4[4] )
  {
    *a3 = a1;
