/*
 * XREFs of ?OnStateChanged@CDuckingManager@@UEAAJPEAUIAudioSessionInfo@@W4_AudioSessionState@@1@Z @ 0x18000C790
 * Callers:
 ...
 *     WPP_SF_dddS @ 0x18000BDB4 (WPP_SF_dddS.c)
...
LABEL_92:
  ...
  if ( v24 >= *((_QWORD *)v6 + 8) )
    goto LABEL_99;
  v33 = *(_DWORD *)(*(_QWORD *)(*v32 + 8 * v24) + 8LL);
  v47 = v33;
  if ( !v33 )
    goto LABEL_61;
...
LABEL_61:
  ...
  if ( v58 && !v33 && v34 != (_DWORD *)&WPP_GLOBAL_Control && (v34[7] & 0x8000000) != 0 && *((_BYTE *)v34 + 25) >= 4u )
  {
    if ( v24 < *((_QWORD *)v6 + 8) )
    {
...
LABEL_69:
  if ( v24 >= *((_QWORD *)v6 + 8) )
    goto LABEL_99;
  operator delete(*(void **)(*v32 + 8 * v24), (const struct std::nothrow_t *)0x10);
