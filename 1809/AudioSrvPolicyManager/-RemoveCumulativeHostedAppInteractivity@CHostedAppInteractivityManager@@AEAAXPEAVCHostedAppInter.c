/*
 * XREFs of ?RemoveCumulativeHostedAppInteractivity@CHostedAppInteractivityManager@@AEAAXPEAVCHostedAppInteractivity@@@Z @ 0x180022F28
 * Callers:
...
LABEL_4:
  ...
  if ( v3 )
  {
    if ( v3 == qword_18004FD38 )
      qword_18004FD38 = *(_QWORD *)v3;
    else
      **(_QWORD **)(v3 + 8) = *(_QWORD *)v3;
    if ( v3 == (_QWORD)xmmword_18004FD40 )
      *(_QWORD *)&xmmword_18004FD40 = *(_QWORD *)(v3 + 8);
    else
      *(_QWORD *)(*(_QWORD *)v3 + 8LL) = *(_QWORD *)(v3 + 8);
    *(_QWORD *)v3 = *((_QWORD *)&xmmword_18004FD50 + 1);
    v4 = (*((_QWORD *)&xmmword_18004FD40 + 1))-- == 1LL;
    *((_QWORD *)&xmmword_18004FD50 + 1) = v3;
    if ( v4 )
