/*
 * XREFs of ??1?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@QEAA@XZ @ 0x18002CE88
 * Callers:
 *     _CGenericWorkItem::CGenericWorkItem_::_1_::dtor$2 @ 0x180039AF1 (_CGenericWorkItem--CGenericWorkItem_--_1_--dtor$2.c)
 * Callees:
