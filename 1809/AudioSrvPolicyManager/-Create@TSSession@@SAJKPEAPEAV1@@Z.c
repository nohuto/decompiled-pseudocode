/*
 * XREFs of ?Create@TSSession@@SAJKPEAPEAV1@@Z @ 0x180026068
 * Callers:
...
__int64 __fastcall TSSession::Create(int a1, struct TSSession **a2)
{
  ...
  v4 = operator new(0x158uLL, (const struct std::nothrow_t *)&std::nothrow);
  v5 = (TSSession *)v4;
  if ( v4 )
  {
    v4[2] = 0LL;
