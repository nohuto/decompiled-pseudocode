/*
 * XREFs of ?ProcessPendingSoundLevelNotification@CApplication@@IEAAXXZ @ 0x180011BC4
 * Callers:
...
void __fastcall CApplication::ProcessPendingSoundLevelNotification(CApplication *this)
{
  ...
  if ( !*((_DWORD *)this + 80) )
  {
    *((_DWORD *)this + 80) = 1;
    ...
    {
      v3 = *((_DWORD *)this + 81);
      if ( v3 == *((_DWORD *)this + 82) && !*((_DWORD *)this + 154) )
        break;
      *((_DWORD *)this + 82) = v3;
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids, v3);
        v5 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
      ...
      while ( v6 )
      {
        v7 = v6[2];
        v6 = (_QWORD *)*v6;
        if ( (*(_BYTE *)(v7 + 484) & 1) != 0 && !*(_DWORD *)(v7 + 448) )
        {
