/*
 * XREFs of ?ProcessTerminationWatcherCallback@CProcess@@SAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x180016D10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _TP_WAIT *a3)
{
  ...
  if ( v6 < 0 )
  {
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x37u, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids, v6);
    }
    AudPolicyLogError("CProcess::ProcessTerminationWatcherCallback", 3912, v6);
  }
}
