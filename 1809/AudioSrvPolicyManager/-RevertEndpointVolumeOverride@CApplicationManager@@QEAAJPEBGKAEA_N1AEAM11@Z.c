/*
 * XREFs of ?RevertEndpointVolumeOverride@CApplicationManager@@QEAAJPEBGKAEA_N1AEAM11@Z @ 0x180020A68
 * Callers:
        ...
        bool *a8)
{
  ...
  {
    WPP_SF_dS(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x34u, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, a3, a2);
  }
  v18 = 0LL;
  *a4 = 0;
  v12 = a5;
  ...
  *a7 = 0;
  ...
  {
    WPP_SF_dS(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x26u, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, a3, a2);
  }
  ...
  if ( v16 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x27u, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, v16);
    }
    AudPolicyLogError("TsSessionIdReleaseEndpointVolumeReference", 2488, v16);
  }
  if ( v14 )
