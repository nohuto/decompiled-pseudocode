/*
 * XREFs of ?ProcessPendingPLMExemptionChange@CApplication@@IEAAXXZ @ 0x180011D7C
 * Callers:
 ...
 *     ?SoundLevelChangeCompletionCallback@CApplication@@KAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x180012560 (-SoundLevelChangeCompletionCallback@CApplication@@KAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIME.c)
 * Callees:
    ...
    *((_DWORD *)this + 94) = 1;
    for ( i = *((_DWORD *)this + 95); i; i = *((_DWORD *)this + 95) )
    {
      *((_DWORD *)this + 95) = 0;
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x10u, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids, i);
      }
