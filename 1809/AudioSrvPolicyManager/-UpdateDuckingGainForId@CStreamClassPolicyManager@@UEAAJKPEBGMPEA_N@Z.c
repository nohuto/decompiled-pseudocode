/*
 * XREFs of ?UpdateDuckingGainForId@CStreamClassPolicyManager@@UEAAJKPEBGMPEA_N@Z @ 0x180025750
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, v7);
    }
    AudPolicyLogError("TsSessionUpdateDuckingGainForId", 2519, v7);
    goto LABEL_19;
  }
  if ( *v11 == a4 )
    v9 = 0;
