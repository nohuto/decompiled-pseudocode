/*
 * XREFs of ?GetProcessModuleNameAndAppId@@YAJPEAXPEAPEAG1@Z @ 0x18001BA54
 * Callers:
...
LABEL_11:
    v11 = _AllocStringWorker<CTCoAllocPolicy>(
            ...
            (__int64)a2,
            (const unsigned __int16 *)&word_18003EF40,
            0LL,
...
LABEL_19:
  ...
  if ( v11 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, v11);
    }
