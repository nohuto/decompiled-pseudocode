/*
 * XREFs of ?ResetReusedSessionGroupingParams@CProcess@@UEAAXXZ @ 0x180017A10
 * Callers:
 *     ?SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ @ 0x18001A060 (-SetApplicationHandlesGroupingParams@CProcess@@UEAAXXZ.c)
 * Callees:
