/*
 * XREFs of ?TsSessionIdDisplayNotificationCallback@@YAKPEAXK0@Z @ 0x180029CA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_ds @ 0x180025F68 (WPP_SF_ds.c)
...
LABEL_37:
    if ( v5 < 0 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x23u, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, v5);
      }
      AudPolicyLogError("TsSessionIdDisplayNotificationCallback", 2337, v5);
    }
    goto LABEL_43;
  }
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
  ...
  *((_DWORD *)v24 + 57) = v14;
  ...
  if ( *(_DWORD *)v15 > 4u )
  {
    ...
    v31 = v12;
    v32 = 4LL;
    TlgWrite(v15, &unk_18004492B, 0LL, v16, 4u, &pData);
  }
  if ( v13 != v14 && (*v12 || g_bLowPowerEpoch || !*((_DWORD *)v11 + 58) || g_bApmSuspended) )
  {
    ...
    if ( v22 && (int)QueueApplicationManagerWorkItem<ModernStandbyStateChangedContext>(v21, (__int64)v22) < 0 )
    {
      if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x22u, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids);
      }
