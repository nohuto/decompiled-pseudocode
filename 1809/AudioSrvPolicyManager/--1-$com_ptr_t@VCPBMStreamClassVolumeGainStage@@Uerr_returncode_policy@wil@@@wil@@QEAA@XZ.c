/*
 * XREFs of ??1?$com_ptr_t@VCPBMStreamClassVolumeGainStage@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x18002B3E0
 * Callers:
 *     _CStreamClassPolicyGains::UpdateStreamClassGainStage_::_1_::dtor$1 @ 0x180039B9F (_CStreamClassPolicyGains--UpdateStreamClassGainStage_--_1_--dtor$1.c)
 * Callees:
