/*
 * XREFs of ??1?$CSimpleMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAUDuckingDescriptor@@V?$CSimpleMapEqualHelper@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAUDuckingDescriptor@@@2@@ATL@@QEAA@XZ @ 0x180018084
 * Callers:
 *     ??1CProcess@@MEAA@XZ @ 0x1800157CC (--1CProcess@@MEAA@XZ.c)
 *     ??1TSSession@@QEAA@XZ @ 0x180026390 (--1TSSession@@QEAA@XZ.c)
 *     _CProcess::CProcess_::_1_::dtor$13 @ 0x180038E3F (_CProcess--CProcess_--_1_--dtor$13.c)
 *     _CProcess::CProcess_::_1_::dtor$14 @ 0x180038E58 (_CProcess--CProcess_--_1_--dtor$14.c)
 * Callees:
