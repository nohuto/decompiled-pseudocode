/*
 * XREFs of ?HasBackgroundAudioTask@CApplication@@QEAAHXZ @ 0x180013434
 * Callers:
...
__int64 __fastcall CApplication::HasBackgroundAudioTask(CApplication *this)
{
  ...
  if ( v2 )
  {
    while ( 1 )
    {
      ...
      v2 = (_QWORD *)*v2;
      if ( !*(_DWORD *)(v4 + 448)
        && (*(_QWORD *)&GUID_00000000_0000_0000_0000_000000000000.Data1 != *(_QWORD *)(v4 + 544)
         || *(_QWORD *)GUID_00000000_0000_0000_0000_000000000000.Data4 != *(_QWORD *)(v4 + 552)) )
      {
        break;
      }
      if ( !v2 )
