/*
 * XREFs of ?RpcCheckDataFlowAccess@CProcess@@UEAAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@K@Z @ 0x180015360
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  ...
  if ( *((_DWORD *)this + v7 + 58) != -2147023728 )
  ...
  if ( ActivationFactory >= 0 )
  {
    ...
    v25 = 3;
    v16 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v24 + 128LL))(v24, &v25);
    v12 = v16;
    if ( v16 < 0 )
    {
      v17 = 2971LL;
LABEL_21:
    ...
    *((_DWORD *)this + v3 + 58) = v25 != 3 ? 0x887C0076 : 0;
    v20 = v24;
    if ( v24 )
    {
      v24 = 0LL;
