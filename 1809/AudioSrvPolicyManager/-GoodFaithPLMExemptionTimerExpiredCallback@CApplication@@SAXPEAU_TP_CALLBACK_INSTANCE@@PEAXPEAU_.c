/*
 * XREFs of ?GoodFaithPLMExemptionTimerExpiredCallback@CApplication@@SAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x1800125B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _TP_TIMER *a3)
{
  ...
  if ( v6 < 0 )
  {
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x16u, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids, v6);
    }
    AudPolicyLogError("CApplication::GoodFaithPLMExemptionTimerExpiredCallback", 1390, v6);
  }
}
