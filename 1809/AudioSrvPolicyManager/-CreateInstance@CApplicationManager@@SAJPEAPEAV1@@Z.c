/*
 * XREFs of ?CreateInstance@CApplicationManager@@SAJPEAPEAV1@@Z @ 0x18001BC44
 * Callers:
...
__int64 __fastcall CApplicationManager::CreateInstance(struct CApplicationManager **a1)
{
  ...
  if ( v2 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, v2);
    }
