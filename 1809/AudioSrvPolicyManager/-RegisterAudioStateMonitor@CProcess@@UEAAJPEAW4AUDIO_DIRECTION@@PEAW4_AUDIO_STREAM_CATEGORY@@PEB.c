/*
 * XREFs of ?RegisterAudioStateMonitor@CProcess@@UEAAJPEAW4AUDIO_DIRECTION@@PEAW4_AUDIO_STREAM_CATEGORY@@PEBGPEA_K@Z @ 0x180017600
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a5)
{
  ...
  v5 = (AudioStateMonitorManager **)((char *)this + 712);
  v7 = (AudioStateMonitorManager *)*((_QWORD *)this + 89);
  if ( !v7 )
  {
    v15 = (char *)this - 16;
