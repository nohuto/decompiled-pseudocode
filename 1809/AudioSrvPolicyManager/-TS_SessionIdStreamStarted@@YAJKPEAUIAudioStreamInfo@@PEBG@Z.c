/*
 * XREFs of ?TS_SessionIdStreamStarted@@YAJKPEAUIAudioStreamInfo@@PEBG@Z @ 0x18002A840
 * Callers:
...
__int64 __fastcall TS_SessionIdStreamStarted(DWORD a1, struct IAudioStreamInfo *a2, const unsigned __int16 *a3)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Fu, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, a1);
  }
  ...
  if ( v6 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x30u, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, v4);
    }
    AudPolicyLogError("TS_SessionIdStreamStarted", 2758, v4);
  }
  if ( v5 )
