/*
 * XREFs of ?OnApplicationStateChanged@CApplicationManager@@QEAAJPEAUApplicationStateChangedContext@@@Z @ 0x180021240
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_Ss @ 0x18001B650 (WPP_SF_Ss.c)
        ...
        struct ApplicationStateChangedContext *a2)
{
  ...
  if ( Application < 0 )
  {
    ...
    AudPolicyLogError("CApplicationManager::OnApplicationStateChanged", 3294, v8);
  }
  else
  {
    v9 = *((_DWORD *)a2 + 3);
