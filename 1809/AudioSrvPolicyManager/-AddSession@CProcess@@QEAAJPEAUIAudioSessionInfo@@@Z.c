/*
 * XREFs of ?AddSession@CProcess@@QEAAJPEAUIAudioSessionInfo@@@Z @ 0x180015B58
 * Callers:
...
__int64 __fastcall CProcess::AddSession(CProcess *this, struct IAudioSessionInfo *a2)
{
  ...
  catch ( ATL::CAtlException *v8 )
  {
    ...
    if ( v11 < 0 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x29u, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids, v11);
      }
      AudPolicyLogError("CProcess::AddSession", 3081, v11);
    }
  }
  if ( v10 )
