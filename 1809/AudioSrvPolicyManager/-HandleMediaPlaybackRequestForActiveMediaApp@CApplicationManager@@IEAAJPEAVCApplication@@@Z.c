/*
 * XREFs of ?HandleMediaPlaybackRequestForActiveMediaApp@CApplicationManager@@IEAAJPEAVCApplication@@@Z @ 0x18001EB00
 * Callers:
...
LABEL_15:
  ...
  else
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      v7 = 37;
LABEL_19:
      WPP_SF_S(v6[2], v7, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, *((const wchar_t **)a2 + 3));
    }
  }
  return 0LL;
}
