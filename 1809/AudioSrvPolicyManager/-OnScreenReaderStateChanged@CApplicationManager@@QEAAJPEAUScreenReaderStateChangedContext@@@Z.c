/*
 * XREFs of ?OnScreenReaderStateChanged@CApplicationManager@@QEAAJPEAUScreenReaderStateChangedContext@@@Z @ 0x180020560
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_d @ 0x180008188 (WPP_SF_d.c)
 *     ?AudPolicyLogError@@YAXPEBDHJ@Z @ 0x180008498 (-AudPolicyLogError@@YAXPEBDHJ@Z.c)
 *     WPP_SF_Sddd @ 0x18001B450 (WPP_SF_Sddd.c)
        ...
        struct ScreenReaderStateChangedContext *a2)
{
  ...
  *((_DWORD *)a2 + 3) = v7;
  ...
  if ( v9 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x31u, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, v9);
    }
    AudPolicyLogError("CApplicationManager::OnScreenReaderStateChanged", 2907, v10);
  }
  else
  {
    v11 = *((_DWORD *)a2 + 2) == 0;
    v12 = *(_DWORD *)(*(_QWORD *)a2 + 520LL);
    *(_DWORD *)(*(_QWORD *)a2 + 520LL) = v11;
    if ( v14 || v12 != v11 )
