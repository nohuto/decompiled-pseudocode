/*
 * XREFs of ??_E?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIAudioPolicyManager@@UISessionInternalEvents@@UIAudioPolicyNotificationManager@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x18000AC80
 * Callers:
 *     <none>
 * Callees:
