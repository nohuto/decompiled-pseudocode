/*
 * XREFs of _lambda_e50a82f6d063143869e1d90b13f36ad1_::operator() @ 0x180029FD4
 * Callers:
...
__int64 __fastcall lambda_e50a82f6d063143869e1d90b13f36ad1_::operator()(__int64 a1)
{
  DWORD v1; // r15d
  __int64 v2; // rbx
    ...
    else
    {
      ...
      *((_DWORD *)v20 + 58) = v10;
      ...
      if ( *(_DWORD *)v11 > 4u )
      {
        ...
        v27 = v8;
        v28 = 4LL;
        TlgWrite(v11, &unk_1800448A2, 0LL, v12, 4u, &pData);
      }
      if ( v9 != v10
