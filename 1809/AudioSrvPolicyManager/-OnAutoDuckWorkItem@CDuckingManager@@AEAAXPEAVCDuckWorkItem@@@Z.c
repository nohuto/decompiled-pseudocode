/*
 * XREFs of ?OnAutoDuckWorkItem@CDuckingManager@@AEAAXPEAVCDuckWorkItem@@@Z @ 0x18000E1E4
 * Callers:
 ...
 *     ?NotifyUnfilteredClientsAutoDuck@CDuckingManager@@AEAAJPEBGK@Z @ 0x18000DC2C (-NotifyUnfilteredClientsAutoDuck@CDuckingManager@@AEAAJPEBGK@Z.c)
...
void __fastcall CDuckingManager::OnAutoDuckWorkItem(CDuckingManager *this, struct CDuckWorkItem *a2)
{
  ...
  if ( !(*(unsigned int (__fastcall **)(_QWORD))(**(_QWORD **)a2 + 48LL))(*(_QWORD *)a2) && !*((_DWORD *)a2 + 4) )
  {
    ...
    if ( *(_DWORD *)v5 > 4u )
    {
      ...
      v38 = 2 * v10 + 2;
      v39 = 0;
      TlgWrite(v5, &unk_18004486B, v7, v8, 3u, &pData);
    }
    ...
    if ( v16 >= 0 )
    {
      v16 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v31 + 40LL))(v31, v34);
      if ( v16 >= 0 )
      {
LABEL_27:
        if ( (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v31 + 24LL))(v31) )
        {
          ...
          {
            LOBYTE(cDataa) = 0;
            (*(void (__fastcall **)(__int64, __int64, _QWORD, __int64, int, _QWORD))(*(_QWORD *)v33 + 24LL))(
              v33,
              2LL,
              0LL,
              0xFFFFFFFFLL,
        ...
        if ( v17 )
          Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,CGainStage>::Release(v17);
LABEL_34:
        if ( v31 )
