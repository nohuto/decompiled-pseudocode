/*
 * XREFs of ?SendTrackStateNotification@CApplication@@QEAAJW4__MIDL___MIDL_itf_audiosrv_0000_0000_0003@@@Z @ 0x1800121C8
 * Callers:
...
__int64 __fastcall CApplication::SendTrackStateNotification(__int64 a1)
{
  ...
  while ( v3 )
  {
    v4 = v3[2];
    v3 = (_QWORD *)*v3;
    if ( !*(_DWORD *)(v4 + 448) && (*(_DWORD *)(v4 + 484) & 0x1000) != 0 )
    {
