/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x180003438
 * Callers:
 ...
 * Callees:
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1800016E4 (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
...
LABEL_20:
  ...
  if ( v19 >= 0 )
  {
    if ( !CloseHandle(v18) )
    {
      wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x90E, v22, v23);
      JUMPOUT(0x180003658LL);
    }
    *a3 = ((__int64)v27 << 31) | v28[0];
    goto LABEL_20;
  }
  wil::details::in1diag3::Return_Hr(retaddr, (void *)0xD6, (__int64)"wil", (const char *)(unsigned int)v19);
  if ( !CloseHandle(v18) )
  {
...
LABEL_21:
  ...
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x90E, v24, v25);
    __debugbreak();
  }
  return LastError;
}
