/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x18000B7E0
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x18000BAC0 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  const GUID *v70; // [rsp+178h] [rbp+70h]
  ...
  if ( *(_DWORD *)v2 > 5u )
  {
    ...
    v71 = v5 + 1;
    v72 = 0;
    TlgWrite(v2, &unk_180044711, v19, v3, 0x13u, &pData);
  }
}
