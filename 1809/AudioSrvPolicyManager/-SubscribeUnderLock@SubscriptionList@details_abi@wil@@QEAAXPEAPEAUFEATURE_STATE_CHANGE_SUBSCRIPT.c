/*
 * XREFs of ?SubscribeUnderLock@SubscriptionList@details_abi@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x180005A3C
 * Callers:
...
LABEL_5:
    ...
    *((_QWORD *)&v15 + 1) = a4;
    ...
    v12 = (*((_QWORD *)v4 + 2) - (_QWORD)v11) & -(__int64)((unsigned __int64)v11 < *((_QWORD *)v4 + 2));
    if ( v11 )
    {
      if ( v12 >= 0x10 )
      {
