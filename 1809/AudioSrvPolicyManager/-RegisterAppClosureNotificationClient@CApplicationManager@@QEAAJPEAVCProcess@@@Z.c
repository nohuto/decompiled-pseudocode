/*
 * XREFs of ?RegisterAppClosureNotificationClient@CApplicationManager@@QEAAJPEAVCProcess@@@Z @ 0x18001C284
 * Callers:
        ...
        struct CProcess *a2)
{
  ...
  if ( v5 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x14u, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, v5);
    }
