/*
 * XREFs of ?OnSoftNonInteractiveAppsSwitchToHardNonInteractive@CApplicationManager@@QEAAJK@Z @ 0x180021148
 * Callers:
        ...
        unsigned int a2)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Bu, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, a2);
  }
