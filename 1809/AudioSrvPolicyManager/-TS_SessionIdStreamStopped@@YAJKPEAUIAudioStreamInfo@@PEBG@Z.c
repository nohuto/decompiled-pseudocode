/*
 * XREFs of ?TS_SessionIdStreamStopped@@YAJKPEAUIAudioStreamInfo@@PEBG@Z @ 0x18002A950
 * Callers:
...
__int64 __fastcall TS_SessionIdStreamStopped(DWORD a1, struct IAudioStreamInfo *a2, const unsigned __int16 *a3)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x31u, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, a1);
  }
  ...
  if ( v6 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x32u, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, v4);
    }
    AudPolicyLogError("TS_SessionIdStreamStopped", 2780, v4);
  }
  if ( v5 )
