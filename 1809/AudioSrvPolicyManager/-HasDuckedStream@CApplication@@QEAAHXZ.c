/*
 * XREFs of ?HasDuckedStream@CApplication@@QEAAHXZ @ 0x180012B6C
 * Callers:
 ...
 *     ?SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ @ 0x180016F90 (-SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ.c)
