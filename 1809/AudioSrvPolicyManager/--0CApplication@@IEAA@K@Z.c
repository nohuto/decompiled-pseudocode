/*
 * XREFs of ??0CApplication@@IEAA@K@Z @ 0x180010E18
 * Callers:
...
CApplication *__fastcall CApplication::CApplication(CApplication *this, int a2)
{
  ...
  *((_QWORD *)this + 80) = 0LL;
  *((_QWORD *)this + 81) = 0LL;
  *((_QWORD *)this + 80) = std::_Tree_comp_alloc<std::_Tmap_traits<std::wstring,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,wil::com_ptr_t<IApplicationSpecificEndpointInfo,wil::err_returncode_policy>>>,0>>::_Buyheadnode(v4);
  *((_BYTE *)this + 656) = 0;
  return this;
}
