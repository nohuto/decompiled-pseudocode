/*
 * XREFs of _CProcess::GetActiveStreamCountStatsForEndpoint_::_1_::dtor$2 @ 0x180038F38
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CProcess::GetActiveStreamCountStatsForEndpoint_::_1_::dtor_2(__int64 a1, __int64 a2)
{
