/*
 * XREFs of ?OnHostedAppStateChanged@CApplicationManager@@QEAAJPEAVHostedAppStateChangedContext@@@Z @ 0x1800200C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    if ( *((_DWORD *)a2 + 3) )
      v7 = "HAC_INTERACTIVE";
    WPP_SF_Sis(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Du, a3, *(const wchar_t **)a2, *((_QWORD *)a2 + 2), v7);
  }
  v8 = *((_DWORD *)a2 + 3);
  v9 = *((_DWORD *)a2 + 2);
  v10 = *((_QWORD *)a2 + 2);
  ...
  if ( Application < 0 )
  {
    ...
    AudPolicyLogError("CApplicationManager::OnHostedAppStateChanged", 2741, Application);
  }
  else if ( v5 )
  {
