/*
 * XREFs of ?UpdateStreamCountAndProcessCategory@CProcess@@IEAAXPEBGKHHPEAHPEAW4_APPLICATION_CATEGORY@@@Z @ 0x180015FFC
 * Callers:
 ...
 * Callees:
 *     WPP_SF_dSS @ 0x180010C24 (WPP_SF_dSS.c)
        ...
        enum _APPLICATION_CATEGORY *a7)
{
  ...
  if ( (int)CProcess::GetActiveStreamCountStatsForEndpoint(this, a2, a5, (unsigned int **)&pftDueTime) >= 0 )
  {
    *(_DWORD *)(*(_QWORD *)&pftDueTime + 4LL * a3) += v11;
    ...
    {
      ThreadpoolTimer = (struct _TP_TIMER *)*((_QWORD *)this + 76);
      if ( ThreadpoolTimer
        || (ThreadpoolTimer = CreateThreadpoolTimer(
                                lambda_5ce815ae0cdec547ed542fdaed3a7314_::_lambda_invoker_cdecl_,
                                this,
                                0LL),
            (*((_QWORD *)this + 76) = ThreadpoolTimer) != 0LL) )
      {
