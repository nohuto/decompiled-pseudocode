/*
 * XREFs of ?CreateInstance@CApplication@@SAJPEBG_KKPEAPEAV1@@Z @ 0x180010CF0
 * Callers:
        ...
        struct CApplication **a4)
{
  ...
  v9 = (CApplication *)HeapAlloc(ProcessHeap, 0, 0x298uLL);
  if ( v9 )
...
LABEL_12:
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids, v11);
    }
