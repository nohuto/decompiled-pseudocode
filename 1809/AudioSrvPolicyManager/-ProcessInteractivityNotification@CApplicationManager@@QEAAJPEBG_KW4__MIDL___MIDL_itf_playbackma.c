/*
 * XREFs of ?ProcessInteractivityNotification@CApplicationManager@@QEAAJPEBG_KW4__MIDL___MIDL_itf_playbackmanagerrpc_0000_0000_0001@@K@Z @ 0x180020EE4
 * Callers:
 *     ?OnSoftNonInteractiveAppsSwitchToHardNonInteractive@CApplicationManager@@QEAAJK@Z @ 0x180021148 (-OnSoftNonInteractiveAppsSwitchToHardNonInteractive@CApplicationManager@@QEAAJK@Z.c)
 *     PbmReportAppInteractivityChange @ 0x180023CC0 (PbmReportAppInteractivityChange.c)
 * Callees:
 ...
 *     WPP_SF_Sis @ 0x18001B580 (WPP_SF_Sis.c)
        ...
        unsigned int a5)
{
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    WPP_SF_Sis(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x39u, v10, a2, a3, v12);
  }
...
LABEL_32:
    ...
    AudPolicyLogError("CApplicationManager::ProcessInteractivityNotification", 3169, Application);
  }
  if ( v9 )
    LeaveCriticalSection((LPCRITICAL_SECTION)v9);
