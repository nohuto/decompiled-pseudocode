/*
 * XREFs of __scrt_dllmain_after_initialize_c @ 0x180036CCC
 * Callers:
 *     dllmain_crt_process_attach @ 0x180036698 (dllmain_crt_process_attach.c)
 * Callees:
 *     ?AddRef@CStreamPolicyVolumeClient@@UEAAKXZ @ 0x18000AF90 (-AddRef@CStreamPolicyVolumeClient@@UEAAKXZ.c)
 *     __isa_available_init @ 0x1800374B0 (__isa_available_init.c)
 *     __scrt_is_ucrt_dll_in_use @ 0x180037670 (__scrt_is_ucrt_dll_in_use.c)
 *     _o__configure_narrow_argv_0 @ 0x180037716 (_o__configure_narrow_argv_0.c)
 *     _initialize_narrow_environment @ 0x18003773A (_initialize_narrow_environment.c)
 */
