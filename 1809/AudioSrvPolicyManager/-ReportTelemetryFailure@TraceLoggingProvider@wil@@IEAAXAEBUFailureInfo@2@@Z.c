/*
 * XREFs of ?ReportTelemetryFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x18000B548
 * Callers:
        ...
        const struct wil::FailureInfo *a2)
{
    ...
    && (*((_QWORD *)v2 + 3) & 0x200000000000LL) == *((_QWORD *)v2 + 3) )
  {
    ...
    v60 = 2 * v5 + 2;
    v61 = 0;
    TlgWrite(v2, &unk_18004460E, v17, (LPCGUID)v2, 0x10u, &pData);
  }
}
