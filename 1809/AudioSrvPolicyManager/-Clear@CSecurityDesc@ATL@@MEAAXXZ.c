/*
 * XREFs of ?Clear@CSecurityDesc@ATL@@MEAAXXZ @ 0x180034B40
 * Callers:
 *     ??_GCSecurityDesc@ATL@@UEAAPEAXI@Z @ 0x180034610 (--_GCSecurityDesc@ATL@@UEAAPEAXI@Z.c)
 *     ??1CSecurityDesc@ATL@@UEAA@XZ @ 0x180034654 (--1CSecurityDesc@ATL@@UEAA@XZ.c)
