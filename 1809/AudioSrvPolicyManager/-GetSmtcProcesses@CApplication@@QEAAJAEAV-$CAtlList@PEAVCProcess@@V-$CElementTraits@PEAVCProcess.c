/*
 * XREFs of ?GetSmtcProcesses@CApplication@@QEAAJAEAV?$CAtlList@PEAVCProcess@@V?$CElementTraits@PEAVCProcess@@@ATL@@@ATL@@@Z @ 0x180013554
 * Callers:
...
__int64 __fastcall CApplication::GetSmtcProcesses(__int64 a1, __int64 a2)
{
  ...
  while ( v5 )
  {
    ...
    v15 = v5;
    v12 = v6;
    if ( !*(_DWORD *)(v6 + 448) && *(_DWORD *)(v6 + 524) )
    {
      try
      {
