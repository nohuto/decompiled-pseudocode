/*
 * XREFs of _ATL::CAtlMap_IUnknown_____ptr64_ATL::CComPtr_IAudioProcessNotification__ATL::CElementTraits_IUnknown_____ptr64__ATL::CElementTraits_ATL::CComPtr_IAudioProcessNotification_____::SetAt_::_1_::catch$0 @ 0x1800390F9
 * Callers:
 *     <none>
 * Callees:
