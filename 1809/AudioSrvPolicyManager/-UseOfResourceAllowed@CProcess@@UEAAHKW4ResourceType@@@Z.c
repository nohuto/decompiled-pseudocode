/*
 * XREFs of ?UseOfResourceAllowed@CProcess@@UEAAHKW4ResourceType@@@Z @ 0x180014FE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcess::UseOfResourceAllowed(CProcess *this, unsigned int a2, enum ResourceType a3)
{
  ...
  if ( g_PlaybackManager )
  {
    ...
    {
      v3 = 1;
      if ( !*((_DWORD *)this + 109) && !*((_DWORD *)this + 115) && !*((_DWORD *)this + 116) )
      {
        pcbData = 4;
        if ( RegGetValueW(
               HKEY_LOCAL_MACHINE,
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_27554cd5659639419dce4f92de6452d1_Traceguids);
  }
  return v3;
}
