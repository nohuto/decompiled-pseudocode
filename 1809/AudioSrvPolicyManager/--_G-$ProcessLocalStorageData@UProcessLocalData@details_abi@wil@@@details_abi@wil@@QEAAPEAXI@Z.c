/*
 * XREFs of ??_G?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAPEAXI@Z @ 0x180007CF4
 * Callers:
 ...
 *     ??1ThreadLocalData@details_abi@wil@@QEAA@XZ @ 0x180003660 (--1ThreadLocalData@details_abi@wil@@QEAA@XZ.c)
 */
        ...
        _QWORD *a1)
{
  ...
  if ( v10 && !CloseHandle(v10) )
  {
    ...
    JUMPOUT(0x180007DD9LL);
  }
  v13 = (void *)a1[1];
  if ( v13 && !CloseHandle(v13) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x90E, v14, v15);
    __debugbreak();
  }
  return a1;
}
