/*
 * XREFs of ?HandleMediaPlaybackRequestForApp@CApplicationManager@@QEAAJPEBG_KK@Z @ 0x18001E908
 * Callers:
        ...
        unsigned int a4)
{
  ...
  struct TSSession *v21; // [rsp+70h] [rbp+8h] BYREF
  ...
  else
  {
    ...
    if ( v14 )
    {
      ...
      if ( active < 0 )
      {
        ...
        {
          WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x23u, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, active);
        }
        AudPolicyLogError("CApplicationManager::HandleMediaPlaybackRequestForApp", 1605, v7);
      }
    }
    else
    {
LABEL_26:
      ...
      {
        WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x22u, &WPP_923261a1bb273641e87551df4d2fda8d_Traceguids, a2);
      }
    }
    v13 = v7;
  }
