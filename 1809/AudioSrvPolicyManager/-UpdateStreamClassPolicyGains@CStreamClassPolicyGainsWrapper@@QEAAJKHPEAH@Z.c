/*
 * XREFs of ?UpdateStreamClassPolicyGains@CStreamClassPolicyGainsWrapper@@QEAAJKHPEAH@Z @ 0x180025408
 * Callers:
        ...
        int *a4)
{
  ...
  do
  {
    ...
    if ( v11 )
    {
      ...
      v10 = this;
      updated = CStreamClassPolicyGains::UpdateStreamClassGainStage(this, (char *)v7, 1, v13, a3, &v20);
      if ( updated < 0 )
      {
LABEL_24:
  ...
  do
  {
    ...
    if ( v16 )
    {
      ...
      v10 = this;
      updated = CStreamClassPolicyGains::UpdateStreamClassGainStage(this, (char *)v14, 0, v18, a3, &v21);
      if ( updated < 0 )
        goto LABEL_24;
      if ( v6 || v21 )
        v6 = 1;
