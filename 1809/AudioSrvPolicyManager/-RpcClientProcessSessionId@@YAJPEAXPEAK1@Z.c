/*
 * XREFs of ?RpcClientProcessSessionId@@YAJPEAXPEAK1@Z @ 0x180026B20
 * Callers:
 *     PbmReportAppInteractivityChange @ 0x180023CC0 (PbmReportAppInteractivityChange.c)
 *     PbmSwitchSoftNonInteractiveAppsToHardNonInteractive @ 0x180023D40 (PbmSwitchSoftNonInteractiveAppsToHardNonInteractive.c)
 *     PbmReportHostedAppStateChange @ 0x180023D90 (PbmReportHostedAppStateChange.c)
 *     PbmReportAppClosing @ 0x180023E20 (PbmReportAppClosing.c)
...
__int64 __fastcall RpcClientProcessSessionId(RPC_BINDING_HANDLE BindingHandle, unsigned int *a2, unsigned int *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, BindingHandle);
  }
  ...
  if ( !LastError )
  {
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, &WPP_d9c0975e425e34466e12797867bc6fac_Traceguids, v17);
    }
