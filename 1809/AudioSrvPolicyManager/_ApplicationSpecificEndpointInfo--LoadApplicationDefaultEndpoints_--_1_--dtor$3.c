/*
 * XREFs of _ApplicationSpecificEndpointInfo::LoadApplicationDefaultEndpoints_::_1_::dtor$3 @ 0x180039F0C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
