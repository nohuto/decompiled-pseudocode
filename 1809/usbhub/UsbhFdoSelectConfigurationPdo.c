/*
 * XREFs of UsbhFdoSelectConfigurationPdo @ 0x1C0029650
 * Callers:
        ...
        IRP *BugCheckParameter4)
{
  ...
  PortData = UsbhGetPortData((__int64)DeviceObject, *((_WORD *)v20 + 714));
  v8 = PortData;
  if ( !PortData )
  {
    v17 = -1073741811;
