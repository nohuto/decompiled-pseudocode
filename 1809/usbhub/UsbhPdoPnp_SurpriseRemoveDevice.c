/*
 * XREFs of UsbhPdoPnp_SurpriseRemoveDevice @ 0x1C00598F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbhPdoPnp_SurpriseRemoveDevice(PDEVICE_OBJECT Pdo, PIRP Irp)
{
  ...
  if ( (v4[358] & 0x40000) != 0 )
  {
    ...
    v8 = v6;
    v9 = 0;
    ZwUpdateWnfStateData(&WNF_USB_TYPE_C_PARTNER_STATE, &v8, 13LL, 0LL, 0LL, 0, 0);
    v4[358] &= ~0x40000u;
  }
  if ( *((_QWORD *)v4 + 301) )
    UsbhBillboardCleanup(Pdo);
  UsbhPdoRemoveCleanup(Pdo);
  Usbh_PdoSurpriseRemove_PdoEvent(*((_QWORD *)v4 + 148), Pdo, (__int64)(v4 + 236));
