/*
 * XREFs of UsbhEnumerate2 @ 0x1C002B118
 * Callers:
...
__int64 __fastcall UsbhEnumerate2(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( !v10 )
  {
    ...
    v16 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C0062B38[2 * v25];
LABEL_7:
    if ( v16 )
      return v16(a1, a4, a5);
    return v5;
  ...
  if ( !v11 )
  {
    ...
    v16 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C0062738[2 * v24];
    goto LABEL_7;
  }
  v12 = v11 - 2;
  if ( !v12 )
  {
    ...
    v16 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C0065F28[2 * v23];
    goto LABEL_7;
  }
  v13 = v12 - 4;
  if ( !v13 )
  ...
  if ( !v14 )
  {
    ...
    v16 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C00608F8[2 * v15];
    goto LABEL_7;
  }
  v19 = v14 - 65520;
  if ( !v19 )
  {
    ...
    v16 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C0062938[2 * v22];
    goto LABEL_7;
  }
  v20 = v19 - 0x10000;
  if ( !v20 )
