/*
 * XREFs of USBD_ValidateConfigurationDescriptorInternal @ 0x1C0042DB0
 * Callers:
 *     UsbhValidateConfigurationDescriptor @ 0x1C0025598 (UsbhValidateConfigurationDescriptor.c)
 * Callees:
...
LABEL_59:
                  ...
                  else
                  {
                    ...
                    {
                      v22 = v21;
                      if ( PoolWithTag[v21 + 2] == 1 || PoolWithTag[1] >= v21 )
                      {
LABEL_46:
                        v6 = -1072693245;
                        v10 = v15 + 3;
                    ...
                    {
                      if ( *((_BYTE *)v9 + v20) == 1 || *PoolWithTag > v20 )
                      {
                        v6 = -1072693245;
                        v10 = v15 + 2;
                        goto LABEL_30;
