/*
 * XREFs of Usbh_PCE_Resume_Action @ 0x1C0018A80
 * Callers:
...
LONG __fastcall Usbh_PCE_Resume_Action(__int64 a1, __int64 a2, int a3)
{
  ...
  unsigned int v96[4]; // [rsp+30h] [rbp-48h] BYREF
  ...
  *(_DWORD *)(a2 + 448) = 1;
  ...
  if ( (UsbhLogMask & 0x10) != 0 )
  {
    ...
    if ( v15 )
    {
      ...
      *(_QWORD *)(v16 + 24) = (unsigned __int16)v10;
      *(_QWORD *)(v16 + 8) = 0LL;
      *(_QWORD *)(v16 + 16) = v14;
    }
  }
  ...
  if ( (_DWORD)v19 == 6 )
  {
    ...
    if ( v54 )
    {
      ...
      *(_DWORD *)(32 * (*(unsigned int *)(a2 + 2400) + 43LL) + a2 + 24) = 10;
      ...
      UsbhInsertQueuePortChangeObject(a1, *(_WORD *)(a2 + 4), v96, 0, 0LL);
      v69 = *(int *)(a2 + 12);
      v70 = *(_DWORD *)(a2 + 12);
...
LABEL_98:
  ...
  switch ( (int)v19 )
  {
    ...
    case 10:
      ...
      UsbhRemoveQueuedSuspend(a1, a2, 0x1C0000000uLL, v10);
