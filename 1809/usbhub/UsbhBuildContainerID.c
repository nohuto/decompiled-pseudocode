/*
 * XREFs of UsbhBuildContainerID @ 0x1C0022D30
 * Callers:
 ...
 *     RtlStringCopyWorkerW @ 0x1C0025930 (RtlStringCopyWorkerW.c)
 *     RtlStringLengthWorkerW @ 0x1C0025988 (RtlStringLengthWorkerW.c)
...
LABEL_66:
  ...
  if ( v24 < 0 )
    goto LABEL_67;
  v27 = (const wchar_t *)*((_QWORD *)v7 + 267);
  if ( v27 )
  {
