/*
 * XREFs of UsbhPdoIdleCC_Worker @ 0x1C005B010
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall UsbhPdoIdleCC_Worker(ULONG_PTR a1, __int64 a2, __int64 a3)
{
  ...
  Log(a1, 0x10000, 1768189015, a3, *(unsigned __int16 *)(v6 + 1428));
  v7 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v6 + 2048));
  v8 = *(_DWORD *)(v6 + 1536);
  KeReleaseSpinLock((PKSPIN_LOCK)(v6 + 2048), v7);
  if ( v8 == 1 )
  {
    KeWaitForSingleObject((PVOID)(v6 + 2056), Executive, 0, 0, 0LL);
    v9 = IoCsqRemoveNextIrp((PIO_CSQ)(v6 + 1464), 0LL);
    Log(a1, 16, 1919764785, a3, (__int64)v9);
    if ( v9 )
    {
      UsbhIdleIrp_Event(a1, a3, v9, 2u, 0);
      ...
      KeWaitForSingleObject((PVOID)(v6 + 2056), Executive, 0, 0, 0LL);
      UsbhIdleIrp_Event(a1, a3, v9, 4u, *(_DWORD *)(v6 + 1440));
      KeSetEvent((PRKEVENT)(v6 + 2056), 0, 0);
    }
    else
    {
