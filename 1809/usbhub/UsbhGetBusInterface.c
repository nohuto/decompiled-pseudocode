/*
 * XREFs of UsbhGetBusInterface @ 0x1C0025F70
 * Callers:
        ...
        unsigned __int16 a5)
{
  ...
  v10 = a4;
  PoolWithTag = (unsigned __int16 *)ExAllocatePoolWithTag(PagedPool, a4, 0x42554855u);
  v12 = PoolWithTag;
  if ( !PoolWithTag )
    return 3221225626LL;
  ...
  if ( Irp )
  {
    ...
    *(_WORD *)&v15[-1].MajorFunction = 2075;
    ...
    v15[-1].Parameters.QueryInterface.Size = a4;
