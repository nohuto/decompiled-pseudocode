/*
 * XREFs of ndisSetRestorePacketFilter @ 0x1C0048C08
 * Callers:
 *     ndisOidPrePacketFilter @ 0x1C00C38B0 (ndisOidPrePacketFilter.c)
 * Callees:
 *     ndisUpdateLoopbackOpens @ 0x1C001B220 (ndisUpdateLoopbackOpens.c)
 *     XFilterAdjust @ 0x1C001B258 (XFilterAdjust.c)
...
char __fastcall ndisSetRestorePacketFilter(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x62u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, a1, a2);
  v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 96));
  v7 = *(_DWORD *)(a1 + 464) == 0;
  *(_QWORD *)(a1 + 520) = KeGetCurrentThread();
  v8 = *(_QWORD *)(a1 + 400);
  *(_DWORD *)(a1 + 1864) = 2301403;
  if ( v7 )
  {
  ...
  *a3 = 0;
  if ( *(_DWORD *)(a2 + 48) >= 4u )
  {
    ...
    *(_DWORD *)(a1 + 1864) = 0;
    ...
    if ( (unsigned __int8)byte_1C00A025A >= 4u )
      WPP_SF_qq(0x64u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, a1, a2);
    return 0;
  }
  else
  {
    ...
    *a3 = -1073676268;
    ...
    {
      v12 = -1073676268;
      WPP_SF_qqd(0x63u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, a1, a2, v12);
    }
    *(_QWORD *)(a1 + 520) = 0LL;
    *(_DWORD *)(a1 + 1864) = 0;
    KeReleaseSpinLock((PKSPIN_LOCK)(a1 + 96), v6);
