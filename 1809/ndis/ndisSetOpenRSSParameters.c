/*
 * XREFs of ndisSetOpenRSSParameters @ 0x1C001F030
 * Callers:
...
unsigned __int8 __fastcall ndisSetOpenRSSParameters(_NDIS_OPEN_BLOCK *a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqq(158LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, MiniportHandle, a1, a2);
  v6 = *(_DWORD *)(a2 + 48);
  *(_DWORD *)(a2 + 56) = 0;
  if ( v6 < 0x1C )
  {
    *(_DWORD *)(a2 + 56) = 28;
    ...
    v24 = a1;
LABEL_33:
    WPP_SF_qqd(v23, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, MiniportHandle, v24, -1073676268);
    goto LABEL_35;
  }
  v7 = *(_BYTE **)(a2 + 40);
  v8 = 40;
...
LABEL_40:
      ...
      v27 = 160LL;
LABEL_39:
      WPP_SF_qq(v27, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, MiniportHandle, a2);
      goto LABEL_40;
    }
    if ( v9 >= 3u )
    {
...
LABEL_51:
      ...
      v28 = 164LL;
LABEL_50:
      WPP_SF_qq(v28, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, MiniportHandle, a1);
      goto LABEL_51;
    }
    ...
    if ( v6 >= v14 )
    {
      ...
      NewIrql = v19;
      MiniportHandle->LockDbg = 2305520;
      if ( v15 )
      {
        v57 = v7[1];
...
LABEL_91:
  ...
  WPP_SF_qqd(v25, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, MiniportHandle, v26, v52);
LABEL_35:
  v21 = 1;
LABEL_36:
...
LABEL_27:
  *a3 = v12;
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqDD(167LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, MiniportHandle, a1, v21, v12);
  if ( v12 && (byte_1C00A2084 & 4) != 0 )
    McTemplateK0jqxqdq(
      MiniportHandle->IfIndex,
      (unsigned int)&SetOpenRSSCapsFailed,
      (_DWORD)MiniportHandle + 4040,
      (_DWORD)MiniportHandle + 4040,
      MiniportHandle->IfIndex,
