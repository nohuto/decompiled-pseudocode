/*
 * XREFs of ndisOidPostLinkSpeed @ 0x1C0046960
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostLinkSpeed(__int64 *a1)
{
  ...
  {
    WPP_SF_qq(0x51u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, v1);
    v4 = *a1;
  }
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x52u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, v1);
}
