/*
 * XREFs of ?ndisPauseFilterInner@@YAXPEAU_NDIS_FILTER_BLOCK@@K@Z @ 0x1C010AEB8
 * Callers:
...
void __fastcall ndisPauseFilterInner(struct _NDIS_FILTER_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xAu, &WPP_f8ff208bb2bd30b987d99581135aa705_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xCu, &WPP_f8ff208bb2bd30b987d99581135aa705_Traceguids, (__int64)a1);
}
