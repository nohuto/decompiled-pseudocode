/*
 * XREFs of ?ndisNsiSetAllCompartment@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C00405A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetAllCompartment(struct _NM_REQUEST_SET_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_q(0x7Du, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (__int64)a1);
...
LABEL_14:
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qD(0x7Eu, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (__int64)a1, v4);
  return v4;
}
