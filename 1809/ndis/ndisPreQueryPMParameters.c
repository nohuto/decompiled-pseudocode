/*
 * XREFs of ndisPreQueryPMParameters @ 0x1C00E76EC
 * Callers:
...
char __fastcall ndisPreQueryPMParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x30u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, MiniportFromReqTracker, v1);
  *(_DWORD *)(a1 + 40) = 0;
  v7 = *(_DWORD *)(v1 + 48);
  v8 = 16;
  if ( v7 < 0x10 )
...
LABEL_17:
  ...
  {
    v15 = 1;
    WPP_SF_qdD(0x31u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, v6, *(_DWORD *)(a1 + 40), v15);
  }
  return 1;
}
