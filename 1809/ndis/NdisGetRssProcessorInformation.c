/*
 * XREFs of NdisGetRssProcessorInformation @ 0x1C0021390
 * Callers:
 *     ndisGetAdapterRssInfo @ 0x1C00B99DC (ndisGetAdapterRssInfo.c)
 *     ndisGetHardwareInfo @ 0x1C00EE6DC (ndisGetHardwareInfo.c)
 * Callees:
 *     ndisCalculateRssProcessorCount @ 0x1C002149C (ndisCalculateRssProcessorCount.c)
 *     ndisPopulateRssProcessorSet @ 0x1C0021540 (ndisPopulateRssProcessorSet.c)
 */
        ...
        PSIZE_T Size)
{
  ...
  else
  {
    ...
    RssProcessorInfo->PreferredNumaNode = *((_WORD *)v6 + 2216);
    RssProcessorInfo->RssBaseProcessor = (PROCESSOR_NUMBER)*((_DWORD *)v6 + 1105);
    RssProcessorInfo[1].Header = (NDIS_OBJECT_HEADER)*((_DWORD *)v6 + 1106);
    RssProcessorInfo[1].Flags = *((_DWORD *)v6 + 1107);
    v8 = *((_DWORD *)v6 + 1104);
    if ( !v8 )
    {
      if ( *((_DWORD *)v6 + 380) == 1 )
      {
        if ( *((_BYTE *)v6 + 2000) )
          v8 = *((_QWORD *)v6 + 287) < 0x2540BE400uLL ? 8 : 16;
        else
          v8 = 4;
      }
      else
