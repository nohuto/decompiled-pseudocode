/*
 * XREFs of ?NdisPDAllocateBufferSet@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KGPEAKKPEAPEAUPD_BUFFER_SET_HANDLE__@@@Z @ 0x1C00FE5F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisPDInitializePDBuffers@@YAXPEAPEAU_PD_BUFFER@@KT_LARGE_INTEGER@@PEAEKKG@Z @ 0x1C0101770 (-ndisPDInitializePDBuffers@@YAXPEAPEAU_PD_BUFFER@@KT_LARGE_INTEGER@@PEAEKKG@Z.c)
 */
...
LABEL_5:
  ...
  v16 = *(_QWORD *)(*(_QWORD *)(v16 + 32) + 5536LL);
...
LABEL_24:
    ...
    *v30 = v21;
    ...
    {
      v29[0] = v33;
      WPP_SF_qqqL(0x50u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, a1, v31, v21, *(_QWORD *)v29);
    }
  }
  while ( v13 < v6 );
  v17 = 0;
  ...
  v32.m_Lock = (KPushLockBase *)qword_1C00A07C8;
