/*
 * XREFs of ndisQueryPowerCapabilities @ 0x1C00BC400
 * Callers:
...
__int64 __fastcall ndisQueryPowerCapabilities(char *NdisAdapterHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00A025D >= 4u )
    WPP_SF_q(0xDu, &WPP_42361dd9a74b3d276ab6054e0e6a2aa7_Traceguids, (__int64)NdisAdapterHandle);
  *((_DWORD *)NdisAdapterHandle + 31) &= ~1u;
  if ( *((_QWORD *)NdisAdapterHandle + 484) )
  {
    if ( IoGetDevicePropertyData(
           *((PDEVICE_OBJECT *)NdisAdapterHandle + 483),
    ...
    Irp = IoAllocateIrp(*(_BYTE *)(*((_QWORD *)NdisAdapterHandle + 484) + 76LL) + 1, 0);
    if ( Irp )
    {
      ...
      *(_WORD *)&v4->MajorFunction = 2331;
      ...
      v2 = IofCallDriver(*((PDEVICE_OBJECT *)NdisAdapterHandle + 484), Irp);
      if ( v2 == 259 )
        KeWaitForSingleObject(&Event, Executive, 0, 0, 0LL);
      if ( v18 < 0 )
      {
        if ( (unsigned __int8)byte_1C00A025D >= 4u )
          WPP_SF_qD(0xFu, &WPP_42361dd9a74b3d276ab6054e0e6a2aa7_Traceguids, (__int64)NdisAdapterHandle, v18);
        goto LABEL_19;
      }
      if ( (*(_DWORD *)(*((_QWORD *)NdisAdapterHandle + 474) + 120LL) & 8) != 0 )
      {
      ...
      *(_OWORD *)(NdisAdapterHandle + 1208) = v11;
      if ( *((_DWORD *)NdisAdapterHandle + 936) == 1 )
      {
        if ( !v6 || !v7 )
          goto LABEL_19;
      }
...
LABEL_19:
    ...
    if ( (unsigned __int8)byte_1C00A025D >= 2u )
      WPP_SF_q(0xEu, &WPP_42361dd9a74b3d276ab6054e0e6a2aa7_Traceguids, (__int64)NdisAdapterHandle);
    NdisWriteErrorLogEntry(NdisAdapterHandle, 0xC0001389, 0);
    v2 = -1073741670;
  }
LABEL_20:
  if ( (unsigned __int8)byte_1C00A025D >= 4u )
    WPP_SF_qD(0x10u, &WPP_42361dd9a74b3d276ab6054e0e6a2aa7_Traceguids, (__int64)NdisAdapterHandle, v2);
  return v2;
}
