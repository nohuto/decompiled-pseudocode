/*
 * XREFs of ndisReadPMRegistry @ 0x1C00C60B4
 * Callers:
...
__int64 __fastcall ndisReadPMRegistry(NDIS_HANDLE ConfigurationHandle, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 3944) ^= (*(_DWORD *)(a2 + 3944) ^ ndisReadPMAdminConfigState(ConfigurationHandle, &WakeOnPatternStr)) & 3;
  *(_DWORD *)(a2 + 3944) ^= (*(_DWORD *)(a2 + 3944) ^ (4
                                                     * ndisReadPMAdminConfigState(
                                                         ConfigurationHandle,
                                                         &WakeOnMagicPacketStr))) & 0xC;
  *(_DWORD *)(a2 + 3944) ^= (*(_DWORD *)(a2 + 3944) ^ (16
                                                     * ndisReadPMAdminConfigState(
                                                         ConfigurationHandle,
                                                         &DeviceSleepOnDisconnectStr))) & 0x30;
  *(_DWORD *)(a2 + 3944) ^= (*(_DWORD *)(a2 + 3944) ^ ((unsigned int)ndisReadPMAdminConfigState(
                                                                       ConfigurationHandle,
  ...
  *(_DWORD *)(a2 + 3944) ^= (*(_DWORD *)(a2 + 3944) ^ ((unsigned int)ndisReadPMAdminConfigState(
  ...
  result = (*(_DWORD *)(a2 + 3944) ^ ((unsigned int)ndisReadPMAdminConfigState(
                                                      ConfigurationHandle,
                                                      &NicAutoPowerSaverStr) << 14)) & 0xC000;
  *(_DWORD *)(a2 + 3944) ^= result;
  v5 = *(_DWORD *)(a2 + 3944);
  if ( (v5 & 0xC000) != 0 )
  {
