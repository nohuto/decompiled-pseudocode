/*
 * XREFs of ndisCancelIdleRequest @ 0x1C007469C
 * Callers:
 *     ndisCancelIdleRequestSync @ 0x1C00747D0 (ndisCancelIdleRequestSync.c)
 *     ndisIdleCancelWorkItem @ 0x1C0074B10 (ndisIdleCancelWorkItem.c)
 * Callees:
  ...
  if ( (*(_DWORD *)(v3 + 504) & 0x84) == 4 )
  {
    ...
    *(_QWORD *)(v3 + 656) = MEMORY[0xFFFFF78000000014];
    ...
    if ( (unsigned __int8)byte_1C00A025E >= 4u )
      WPP_SF_qD(0x1Au, &WPP_0cf0eaabdf4f3c4b779dfb88bb6a846b_Traceguids, (__int64)a1, a2);
    ndisLogMiniportEvent((__int64)a1, 0x10u);
    (*(void (__fastcall **)(_QWORD))(a1[474] + 848LL))(a1[3]);
    return 1;
  }
  else
  {
