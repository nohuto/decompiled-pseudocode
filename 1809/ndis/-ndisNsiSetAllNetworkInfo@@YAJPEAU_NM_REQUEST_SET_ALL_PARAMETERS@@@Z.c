/*
 * XREFs of ?ndisNsiSetAllNetworkInfo@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C0040670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetAllNetworkInfo(struct _NM_REQUEST_SET_ALL_PARAMETERS *a1)
{
  ...
  *(_DWORD *)&NewIrql[4] = 0;
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_q(0x6Du, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (__int64)a1);
  ...
  *(_OWORD *)&v7->Header.Type = *v6;
  ...
  if ( v13 != 3 )
  {
    ...
    v3 = (const wchar_t *)CompartmentBlock;
...
LABEL_45:
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qD(0x6Eu, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (__int64)a1, v2);
