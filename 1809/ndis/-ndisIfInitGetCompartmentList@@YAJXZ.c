/*
 * XREFs of ?ndisIfInitGetCompartmentList@@YAJXZ @ 0x1C0020084
 * Callers:
...
__int64 ndisIfInitGetCompartmentList(void)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_(26LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids);
...
LABEL_11:
    ...
    else
    {
      ...
      *(_OWORD *)&v21[135] = xmmword_1C008E208;
...
LABEL_24:
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_D(27LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (unsigned int)v1);
