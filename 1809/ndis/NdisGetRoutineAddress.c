/*
 * XREFs of NdisGetRoutineAddress @ 0x1C00CF5F0
 * Callers:
 *     ndisVerifierGetRoutineAddress @ 0x1C00F6B80 (ndisVerifierGetRoutineAddress.c)
 * Callees:
 *     FindExportedRoutineByName @ 0x1C00CF650 (FindExportedRoutineByName.c)
 */
