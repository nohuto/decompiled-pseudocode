/*
 * XREFs of _lambda_a13a88d06c7c63155a98f7d7ba7090a7_::_lambda_invoker_cdecl_ @ 0x1C01077B0
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_BIND_LINK_BASE *a2)
{
  ...
  {
    result = Ndis::BindStack::CreateDynamicBinding(a1 + 5040, a2, a1, TapiProxy);
    Miniport = a2->BindState.Miniport;
  }
  if ( Miniport )
  {
