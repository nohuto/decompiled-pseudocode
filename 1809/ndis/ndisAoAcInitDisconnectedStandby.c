/*
 * XREFs of ndisAoAcInitDisconnectedStandby @ 0x1C004FB6C
 * Callers:
 *     ndisDriverReinit @ 0x1C00D20A0 (ndisDriverReinit.c)
 * Callees:
...
LABEL_6:
  ...
  while ( v1 )
  {
    ...
    {
      v4 = *(_DWORD *)(i + 124);
      if ( (v4 & 0x200000) != 0 && ndisAoAcCapable || (*(_DWORD *)(i + 2700) & 0x200) != 0 )
      {
        *(_DWORD *)(i + 3896) |= 0x10u;
