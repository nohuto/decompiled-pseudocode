/*
 * XREFs of McTemplateK0xqx @ 0x1C0079FB0
 * Callers:
...
ULONG McTemplateK0xqx(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  va_copy(v9, va2);
  v8 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&NDIS_PROVIDER_ID_Context, &ComponentCsStats, a3, 4u, &EventData);
}
