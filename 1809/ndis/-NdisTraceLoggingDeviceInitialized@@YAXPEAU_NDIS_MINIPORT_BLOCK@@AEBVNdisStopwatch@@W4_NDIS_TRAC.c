/*
 * XREFs of ?NdisTraceLoggingDeviceInitialized@@YAXPEAU_NDIS_MINIPORT_BLOCK@@AEBVNdisStopwatch@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@H@Z @ 0x1C001CDC0
 * Callers:
 ...
 *     ?GetElapsedTimeInMilliseconds@NdisStopwatch@@QEBA_JXZ @ 0x1C001DC58 (-GetElapsedTimeInMilliseconds@NdisStopwatch@@QEBA_JXZ.c)
...
void __fastcall NdisTraceLoggingDeviceInitialized(__int64 a1, NdisStopwatch *a2, __int64 a3, int a4)
{
  ...
  if ( a4 )
  {
    if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
    {
      ...
      v28 = 1LL;
      v30 = 1LL;
      TlgWrite(&hProvider, &unk_1C008D364, v8, v9, 9u, &pData);
    }
  }
  else if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x400000000000uLL) )
    {
      ...
      v26 = 1LL;
      v28 = 1LL;
      TlgWrite(&hProvider, &unk_1C008C5AF, v6, v7, 8u, &pData);
    }
  }
}
