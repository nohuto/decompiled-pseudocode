/*
 * XREFs of ?ndisNsiChangeNetworkInfo@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@PEAU_NDIS_NSI_NETWORK_RW@@KKPEAK@Z @ 0x1C003F1CC
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qq(0x6Fu, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a2);
  v10 = a3;
  v34 = a3;
  v11 = a4;
  v12 = -1073741811;
...
LABEL_11:
  ...
  *a5 = v16;
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qqd(0x70u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a2, v9);
  return v9;
}
