/*
 * XREFs of ?ndisNsiGetIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C003FE90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetIfRcvAddress(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_q(0x56u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (__int64)a1);
...
LABEL_19:
  ...
  v12 = ndisIfReferenceMiniport((__int64)InterfaceByNetLuid, 4u);
  if ( !v12 )
  {
    IfRcvAddressRodInformation = 0;
    goto LABEL_40;
...
LABEL_42:
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qD(0x57u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (__int64)a1, IfRcvAddressRodInformation);
