/*
 * XREFs of ndisReferenceNextUnprocessedMiniport @ 0x1C0115730
 * Callers:
...
__int64 __fastcall ndisReferenceNextUnprocessedMiniport(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0x43u, &WPP_5d6c07f306e13ea2a30515e9b6bd8675_Traceguids, a1);
  ...
  while ( v3 )
  {
    if ( ndisIsMiniportReady((_DWORD *)v3) )
    {
      ...
      {
        _InterlockedOr((volatile signed __int32 *)(v3 + 4464), 0x80u);
        break;
      }
    }
    v3 = *(_QWORD *)(v3 + 8);
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0x44u, &WPP_5d6c07f306e13ea2a30515e9b6bd8675_Traceguids, a1);
  return v3;
}
