/*
 * XREFs of ndisGetPciDeviceCustomProperties @ 0x1C00BCA28
 * Callers:
...
LABEL_10:
      ...
      IoGetDevicePropertyData(*(PDEVICE_OBJECT *)(a1 + 3864), v8, 0, 0, 4u, Data, &RequiredSize, &Type);
      goto LABEL_10;
    }
    if ( (unsigned __int8)byte_1C00A0256 < 4u )
      return v6;
