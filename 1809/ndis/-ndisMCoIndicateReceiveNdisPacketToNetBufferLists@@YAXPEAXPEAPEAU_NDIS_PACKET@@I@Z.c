/*
 * XREFs of ?ndisMCoIndicateReceiveNdisPacketToNetBufferLists@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C0054890
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMCoIndicateReceiveNdisPacketToNetBufferLists(_QWORD *a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  while ( 1 )
  {
    ...
    v9 = v28 - v8;
    v32 = v28;
    v10 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v7 + 2008));
    *(_QWORD *)(v7 + 2024) = KeGetCurrentThread();
    v11 = *(_DWORD *)(v7 + 2016) - 5;
    *(_DWORD *)(v7 + 2032) = 2425268;
    v12 = v11 <= 1;
    v13 = (KSPIN_LOCK *)(v7 + 2008);
    if ( v12 )
      break;
    *(_DWORD *)(v7 + 2020) += v9;
    *(_QWORD *)(v7 + 2024) = 0LL;
      ...
      do
      {
        ...
        if ( *(unsigned int *)((char *)&v16->Private.Count + v16->Private.NdisPacketOobOffset) != -1073741670 )
        {
          if ( (v16[-1].Reserved[1] & 1) != 0 && *(_DWORD *)&v16[-1].ProtocolReserved[4] == -1 )
            ...
            (*(void (__fastcall **)(_QWORD, struct _NDIS_PACKET *))(v7 + 2176))(*(_QWORD *)(v7 + 24), v16);
        }
        v14 = Alignment;
      }
      while ( Alignment );
      v17 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v7 + 2008));
      *(_QWORD *)(v7 + 2024) = KeGetCurrentThread();
      v18 = *(_DWORD *)(v7 + 2020) - v9;
      *(_DWORD *)(v7 + 2032) = 2425343;
      *(_DWORD *)(v7 + 2020) = v18;
      if ( *(_DWORD *)(v7 + 2016) == 5 && !v18 )
      {
        *(_DWORD *)(v7 + 2016) = 6;
        *(_QWORD *)(v7 + 2024) = 0LL;
        *(_DWORD *)(v7 + 2032) = 0;
        KeReleaseSpinLock((PKSPIN_LOCK)(v7 + 2008), v17);
    ...
    do
    {
      ...
      if ( *(unsigned int *)((char *)&v22->Private.Count + v22->Private.NdisPacketOobOffset) != -1073741670 )
      {
        if ( (v22[-1].Reserved[1] & 1) != 0 && *(_DWORD *)&v22[-1].ProtocolReserved[4] == -1 )
          ...
          (*(void (__fastcall **)(_QWORD))(v7 + 2176))(*(_QWORD *)(v7 + 24));
      }
      --v21;
    }
    while ( v21 );
