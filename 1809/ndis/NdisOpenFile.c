/*
 * XREFs of NdisOpenFile @ 0x1C00EBB40
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_PHYSICAL_ADDRESS HighestAcceptableAddress)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_(0xEu, &WPP_8df08a1cf1a93f964e71fb8294d520a8_Traceguids);
  ...
  *((_DWORD *)PoolWithTag + 14) = *(_DWORD *)L"\\";
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_Z(0xFu, &WPP_8df08a1cf1a93f964e71fb8294d520a8_Traceguids, &Destination.Length);
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v10 < 0 )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_D(0x10u, &WPP_8df08a1cf1a93f964e71fb8294d520a8_Traceguids, v10);
    *Status = -1073676261;
    goto LABEL_32;
  }
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_D(0x11u, &WPP_8df08a1cf1a93f964e71fb8294d520a8_Traceguids, v11);
LABEL_16:
    ZwClose(FileHandlea);
    *Status = -1073676260;
    goto LABEL_32;
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_D(0x12u, &WPP_8df08a1cf1a93f964e71fb8294d520a8_Traceguids, NumberOfBytes);
    goto LABEL_16;
  }
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_(0x13u, &WPP_8df08a1cf1a93f964e71fb8294d520a8_Traceguids);
    goto LABEL_16;
  }
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_D(0x14u, &WPP_8df08a1cf1a93f964e71fb8294d520a8_Traceguids, v15);
    *Status = -1073676260;
  }
  ExFreePoolWithTag(v14, 0);
LABEL_32:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_D(0x15u, &WPP_8df08a1cf1a93f964e71fb8294d520a8_Traceguids, *Status);
}
