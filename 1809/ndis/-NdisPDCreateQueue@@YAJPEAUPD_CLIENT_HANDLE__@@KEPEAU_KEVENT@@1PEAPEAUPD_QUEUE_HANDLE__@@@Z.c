/*
 * XREFs of ?NdisPDCreateQueue@@YAJPEAUPD_CLIENT_HANDLE__@@KEPEAU_KEVENT@@1PEAPEAUPD_QUEUE_HANDLE__@@@Z @ 0x1C00FEF90
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *Size)
{
  ...
  *Size = 0LL;
    ...
    if ( v12 <= 0xFFFFFFFF )
    {
      ...
      if ( v16 >= v14 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          v21.m_Lock = (KPushLockBase *)qword_1C00A07C8;
          v18[13] = v8;
          *((_BYTE *)v18 + 24) = a3;
          *((_QWORD *)v18 + 4) = a5;
          *((_QWORD *)v18 + 5) = a4;
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_qqd(0x5Fu, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, a1, *Size, v15);
  return v15;
}
