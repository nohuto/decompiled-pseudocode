/*
 * XREFs of NdisQueryAdapterInstanceName @ 0x1C005E1D0
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisQueryAdapterInstanceName(PNDIS_STRING pAdapterInstanceName, NDIS_HANDLE NdisBindingHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00A0255 >= 4u )
    WPP_SF_q(0x32u, &WPP_5a25d62004233057cf64a29056d8f8be_Traceguids, (__int64)NdisBindingHandle);
  v6 = *(const UNICODE_STRING **)(v2 + 3888);
  if ( v6 )
  {
...
LABEL_10:
  if ( (unsigned __int8)byte_1C00A0255 >= 4u )
    WPP_SF_qZL(0x33u, &WPP_5a25d62004233057cf64a29056d8f8be_Traceguids, (__int64)NdisBindingHandle, &v6->Length, v5);
  return v5;
}
