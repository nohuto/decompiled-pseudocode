/*
 * XREFs of ndisIfAliasChange @ 0x1C00421A8
 * Callers:
...
__int64 __fastcall ndisIfAliasChange(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)&GuidString.Length = 0;
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( InterfaceByInterfaceGuid )
    {
      ...
      *(_WORD *)v9 = v10;
      ...
      ndisNsiNotifyClientInterfaceChange(v8, 0LL, v15, 0LL);
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_D(0xA1u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, v5);
