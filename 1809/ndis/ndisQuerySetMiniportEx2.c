/*
 * XREFs of ndisQuerySetMiniportEx2 @ 0x1C00206A0
 * Callers:
        ...
        UINT *a10)
{
  ...
  for ( i = ndisQuerySetMiniportEx(a1, 0LL, a3, 0, 0LL, 0LL); ; i = ndisQuerySetMiniportEx(a1, 0LL, a3, 0, 0LL, 0LL) )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C00A025A >= 2u )
        WPP_SF_dd(11LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, BytesNeeded, a3->DATA.QUERY_INFORMATION.Oid);
      v17 = -1073741670;
      break;
    }
