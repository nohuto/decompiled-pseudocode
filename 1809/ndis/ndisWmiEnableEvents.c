/*
 * XREFs of ndisWmiEnableEvents @ 0x1C00CFBD0
 * Callers:
...
__int64 __fastcall ndisWmiEnableEvents(__int64 a1, _QWORD *a2)
{
  ...
  if ( (unsigned __int8)byte_1C00A0261 >= 4u )
    WPP_SF_q(0x43u, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, a1);
...
LABEL_39:
  ...
  else
  {
    if ( (unsigned __int8)byte_1C00A0261 >= 2u )
      WPP_SF_q(0x44u, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, a1);
    v2 = -1073741811;
  }
  if ( (unsigned __int8)byte_1C00A0261 >= 4u )
    WPP_SF_qD(0x45u, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, a1, v2);
  return v2;
}
