/*
 * XREFs of ndisPreRemoveOpenWakeUpPattern @ 0x1C00E7998
 * Callers:
...
unsigned __int8 __fastcall ndisPreRemoveOpenWakeUpPattern(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x1Fu, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, a1, a2);
...
LABEL_12:
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqd(0x20u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, a1, a2, v4);
  return v4;
}
