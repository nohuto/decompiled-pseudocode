/*
 * XREFs of ?ndisOidPostOpenSetEncapsulation@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C00242D0
 * Callers:
...
void __fastcall ndisOidPostOpenSetEncapsulation(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqq(221LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, *(_QWORD *)(v3 + 16), v1, v3);
  v4 = *(_QWORD *)(v3 + 696);
  if ( v4 )
  {
    v5 = *(_DWORD *)(v4 + 64);
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(222LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, v1);
}
