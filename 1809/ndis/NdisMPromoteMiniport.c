/*
 * XREFs of NdisMPromoteMiniport @ 0x1C0060E00
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisMPromoteMiniport(NDIS_HANDLE MiniportHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x6Fu, &WPP_f453a6740ca1326a168191528118e90e_Traceguids, (__int64)MiniportHandle);
  ...
  *((_DWORD *)MiniportHandle + 466) = 727748;
  if ( v4
...
LABEL_16:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x70u, &WPP_f453a6740ca1326a168191528118e90e_Traceguids, (__int64)MiniportHandle);
