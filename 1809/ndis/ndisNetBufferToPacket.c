/*
 * XREFs of ndisNetBufferToPacket @ 0x1C004E0A0
 * Callers:
 *     ndisXlateRecvNetBufferListsToPacketArray @ 0x1C004E1F4 (ndisXlateRecvNetBufferListsToPacketArray.c)
...
__int64 __fastcall ndisNetBufferToPacket(__int64 a1, char a2, PNDIS_PACKET *a3)
{
  ...
  __int64 result; // rax
  PNDIS_PACKET v8; // rcx
  $E6466AAADC1FC7432E89A882EFB7BAF7 *ProtocolReserved; // r9
  _MDL *v10; // rdx
  __int64 v11; // r8
  ...
  *a3 = 0LL;
  ...
  if ( !Status )
  {
    ...
    ProtocolReserved = ($E6466AAADC1FC7432E89A882EFB7BAF7 *)v8->ProtocolReserved;
    if ( !a2 )
