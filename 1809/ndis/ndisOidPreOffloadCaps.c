/*
 * XREFs of ndisOidPreOffloadCaps @ 0x1C0047440
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_qqDD @ 0x1C003A8AC (WPP_SF_qqDD.c)
 *     WPP_SF_qqq @ 0x1C003A960 (WPP_SF_qqq.c)
 *     ndisQueryFilterOffloadCaps @ 0x1C004820C (ndisQueryFilterOffloadCaps.c)
 *     ndisQueryMiniportOffloadCaps @ 0x1C00482EC (ndisQueryMiniportOffloadCaps.c)
 */
...
unsigned __int8 __fastcall ndisOidPreOffloadCaps(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqq(0xEDu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v1, v4, v3);
  *((_DWORD *)a1 + 10) = -1073741637;
  ...
  if ( (*(_DWORD *)(v3 + 4) & 0xFFFFFFFD) == 0 )
  {
    if ( a1[2] )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v5 + 32) + 1864LL) = 2310934;
      v8 = *(_DWORD *)(v5 + 60);
      *(_QWORD *)(*(_QWORD *)(v5 + 32) + 520LL) = 0LL;
      *(_DWORD *)(*(_QWORD *)(v5 + 32) + 1864LL) = 0;
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
  {
    v11 = *((_DWORD *)a1 + 10);
    LODWORD(v10) = v6;
    WPP_SF_qqDD(0xEEu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v1, v4, v10, v11);
  }
  return v6;
}
