/*
 * XREFs of ?ndisVerifyNdisTryAcquireRWLockRead@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@E@Z @ 0x1C007F090
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryAcquireRWLockRead @ 0x1C007F2F0 (NdisTryAcquireRWLockRead.c)
 */
