/*
 * XREFs of ndisFindMiniportOnGlobalList @ 0x1C0118BB0
 * Callers:
...
wchar_t *__fastcall ndisFindMiniportOnGlobalList(PCUNICODE_STRING SourceString)
{
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0x63u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)SourceString);
  ...
  if ( result )
  {
    ...
    if ( (unsigned __int8)byte_1C00A025C >= 4u )
      WPP_SF_q(0x64u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)v5);
    return (wchar_t *)v5;
  }
  return result;
}
