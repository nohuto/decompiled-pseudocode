/*
 * XREFs of ndisReceiveWorkerThread @ 0x1C0020BC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisReceiveWorkerThread(ULONG a1)
{
  ...
  *(_QWORD *)&Affinity.Group = 0LL;
  ...
  if ( (unsigned __int8)byte_1C00A025B >= 4u )
    WPP_SF_D(11LL, &WPP_708561b8cd4433a8527d88173b1ed8eb_Traceguids, a1);
  Affinity.Mask = 1LL << ProcNumber.Number;
  v2 = (KSPIN_LOCK *)((char *)WPP_MAIN_CB.Dpc.DeferredRoutine + 64 * (unsigned __int64)a1);
...
LABEL_15:
  ...
  v7 = (struct _WORK_QUEUE_ITEM *)((char *)ndisPerCpuPoisonPills + 32 * a1);
  if ( (struct _WORK_QUEUE_ITEM *)v3 != v7 )
  {
    if ( (_BYTE)word_1C00A209C )
    {
      memset(v11, 0, sizeof(v11));
      *(_DWORD *)&v11[21] = 0x20000;
      WnodeEventItem = 56;
      *(_QWORD *)&v11[3] = qword_1C00A2090;
  ...
  if ( v4 != 2 )
    KeLowerIrql(v4);
  if ( (unsigned __int8)byte_1C00A025B >= 4u )
    WPP_SF_D(12LL, &WPP_708561b8cd4433a8527d88173b1ed8eb_Traceguids, a1);
}
