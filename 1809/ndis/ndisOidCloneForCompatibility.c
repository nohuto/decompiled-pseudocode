/*
 * XREFs of ndisOidCloneForCompatibility @ 0x1C000DB90
 * Callers:
...
LABEL_8:
  ...
  WPP_SF_qqd(v17, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, a2, *a4, *(_DWORD *)(a2 + 32));
LABEL_11:
  *(_DWORD *)&(*a4)->NdisReserved[16] |= 0x8000000u;
  if ( a3 && (*(_DWORD *)(a2 + 88) & 0x400) == 0 )
  {
    ...
    else
    {
      ...
      *((_DWORD *)v5 + 466) = 2298064;
      v5[278] = (KSPIN_LOCK)*a4;
      v5[65] = 0LL;
      *((_DWORD *)v5 + 466) = 0;
    }
