/*
 * XREFs of ?NdisTraceLoggingDeviceAdded@@YAXPEAU_NDIS_IF_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@PEAUNDIS_ADDDEVICE_PARAMETERS@@JPEB_WE@Z @ 0x1C001CC38
 * Callers:
...
char __fastcall NdisTraceLoggingDeviceAdded(__int64 a1, int a2, __int64 a3, int a4, __int64 a5, unsigned __int8 a6)
{
  ...
  if ( a4 < 0 )
  {
    if ( hProvider.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v6 )
      {
        ...
        v23 = a6;
        v35 = 4LL;
        LOBYTE(v6) = TlgWrite(&hProvider, &unk_1C008BDCE, v18, v19, 8u, &pData);
      }
    }
  }
  else if ( hProvider.LevelPlus1 > 5 )
  {
    ...
    if ( (_BYTE)v6 )
    {
      ...
      v22 = a6;
      v40 = 4LL;
      LOBYTE(v6) = TlgWrite(&hProvider, &unk_1C008CF86, v13, v14, 0xBu, &pData);
    }
  }
  return (char)v6;
}
