/*
 * XREFs of ndisGetPortList @ 0x1C001A1E8
 * Callers:
  ...
  *(_DWORD *)(a1 + 1864) = 2360576;
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)v7 + 8) = *(_QWORD *)(a1 + 800);
    v7[18] = *(_DWORD *)(*(_QWORD *)(a1 + 4072) + 532LL);
    v11 = v7;
    v7[19] = *(_DWORD *)(a1 + 3344);
    v7[20] = *(_DWORD *)(a1 + 3348);
    v7[21] = *(_DWORD *)(a1 + 3352);
    v7[22] = *(_DWORD *)(a1 + 3356);
    while ( v8 != (__int64 *)(a1 + 2736) && v10 < v5 )
    {
      if ( *((_DWORD *)v8 + 4) == 4 )
      {
        v11 = v9;
