/*
 * XREFs of ndisOidPreIovCreateVPort @ 0x1C00F9A20
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovCreateVPort(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qqq(0x2Bu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, *a1, a1[3], v1);
  if ( v1[1] != 12 )
    goto LABEL_4;
  VPort = 0;
  *((_DWORD *)a1 + 10) = 0;
...
LABEL_16:
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
  {
    v9 = *((_DWORD *)a1 + 10);
    LODWORD(v8) = VPort;
    WPP_SF_qqDD(0x2Cu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, *a1, a1[3], v8, v9);
  }
  return VPort;
}
