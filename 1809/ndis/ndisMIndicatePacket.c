/*
 * XREFs of ndisMIndicatePacket @ 0x1C0068450
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisGetFirstBufferFromPacket @ 0x1C005CE90 (NdisGetFirstBufferFromPacket.c)
...
void __fastcall ndisMIndicatePacket(ULONG_PTR BugCheckParameter2, ULONG_PTR a2, unsigned int a3)
{
  ...
  do
  {
    ...
    {
      v13 = *(_QWORD *)(BugCheckParameter2 + 3168);
      if ( v13 )
      {
        v14 = 112LL * KeGetPcr()->Prcb.Number;
        ++*(_QWORD *)(v14 + v13 + 32);
        v15 = *(_QWORD *)(BugCheckParameter2 + 3168);
        if ( v15 )
        {
          v16 = v38;
      ...
      do
      {
        ...
        *((_QWORD *)v23 + v26) = v9;
        ...
        else
        {
          ...
          {
            ndisNblTrackerTransferOwnershipSingleNbl(v28, v23, *(struct NDIS_NBL_TRACKER_HANDLE__ **)(v20 + 584), 0x9Au);
      ...
      if ( (*(_DWORD *)(BugCheckParameter2 + 120) & 0x40000) != 0 )
      {
        ...
        *((_DWORD *)v12 + 8) = 259;
        ...
        if ( *(_MDL **)((char *)&v9[1].Private.Head + v9->Private.NdisPacketOobOffset) )
          goto LABEL_40;
        (*(void (__fastcall **)(_QWORD, struct _NDIS_PACKET *, __int64))(*(_QWORD *)(BugCheckParameter2 + 3792) + 224LL))(
