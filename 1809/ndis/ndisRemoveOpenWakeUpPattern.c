/*
 * XREFs of ndisRemoveOpenWakeUpPattern @ 0x1C004B954
 * Callers:
...
void __fastcall ndisRemoveOpenWakeUpPattern(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqd(0x23u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
    v6 = *(_DWORD **)(a1 + 496);
    v7 = 0LL;
  ...
  {
    LODWORD(v15) = a3;
    WPP_SF_qqd(0x24u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, a1, a2, v15);
  }
}
