/*
 * XREFs of ndisUpdatePMCurrentCapabilities @ 0x1C001554C
 * Callers:
 ...
 *     ndisResetPMCapabilities @ 0x1C00B42F0 (ndisResetPMCapabilities.c)
 *     ndisComparePMCapabilities @ 0x1C00BD41C (ndisComparePMCapabilities.c)
 *     ?ndisConvertPMCapabilitiesToPnp@@YAXPEAU_NDIS_PM_CAPABILITIES@@PEAU_NDIS_PNP_CAPABILITIES@@@Z @ 0x1C00BD458 (-ndisConvertPMCapabilitiesToPnp@@YAXPEAU_NDIS_PM_CAPABILITIES@@PEAU_NDIS_PNP_CAPABILITIES@@@Z.c)
 */
  ...
  *(_DWORD *)(a1 + 1116) = v7;
    ...
    && *(_DWORD *)(a1 + 1268) )
  {
    ...
    if ( (v9 & 4) != 0 && !ndisDefaultNapsState )
    {
      v24 = *(_DWORD *)(a1 + 3944);
      if ( (v24 & 0xC000) == 0 )
        *(_DWORD *)(a1 + 3944) = v24 & 0xFFFF0FFF | 0xA000;
    }
    v10 = *(_BYTE *)(a1 + 32);
    if ( (v10 > 6u || v10 == 6 && *(_BYTE *)(a1 + 33) >= 0x1Eu)
      && (*(_DWORD *)(a1 + 120) & 0x20000) == 0
      && (v11 = *(_QWORD *)(a1 + 3792), *(_QWORD *)(v11 + 840))
      && *(_QWORD *)(v11 + 848)
      && (*(_DWORD *)(a1 + 3944) & 0x3000) == 0x2000
      && (v9 & 6) != 0
      || (*(_DWORD *)(a1 + 120) & 0x80u) != 0 && (*(_DWORD *)(a1 + 3944) & 0x3000) == 0x2000 && (v9 & 6) != 0 )
    {
        ...
        if ( (v9 & 0xC) == 0xC )
        {
          *(_DWORD *)(a1 + 1064) = v26 | 8;
          if ( (unsigned __int8)byte_1C00A0258 >= 4u )
            WPP_SF_qZ(143LL, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, a1, *(_QWORD *)(a1 + 3888));
        }
      }
    }
    ...
    *(_DWORD *)(a1 + 1088) = v16;
    ...
    {
      v28 = *(_DWORD *)(a1 + 3896);
      if ( (v28 & 0x10000000) != 0 && *(_DWORD *)(a1 + 3808) != 8 )
        *(_DWORD *)(a1 + 3896) = v28 | 0x100;
    }
    v17 = *(_DWORD *)(a1 + 3896);
    if ( (v17 & 0x10) == 0 )
    {
