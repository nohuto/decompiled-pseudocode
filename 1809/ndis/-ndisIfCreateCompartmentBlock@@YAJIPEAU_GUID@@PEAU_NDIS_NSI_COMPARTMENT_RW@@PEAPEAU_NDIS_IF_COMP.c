/*
 * XREFs of ?ndisIfCreateCompartmentBlock@@YAJIPEAU_GUID@@PEAU_NDIS_NSI_COMPARTMENT_RW@@PEAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@@Z @ 0x1C00202F0
 * Callers:
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a4)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_dq(117LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a3);
  *a4 = 0LL;
...
LABEL_16:
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_LqL(118LL, v10, v8, v11, v5);
