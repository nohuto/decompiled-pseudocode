/*
 * XREFs of McTemplateK0zq @ 0x1C0059EB4
 * Callers:
...
ULONG __fastcall McTemplateK0zq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, const wchar_t *a4, char a5)
{
  __int64 v5; // rax
  int v6; // ecx
  ...
  v9 = a4;
  v12 = &a5;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&NDIS_PROVIDER_ID_Context, a2, &NDIS_PROVIDER_ID, 3u, &EventData);
}
