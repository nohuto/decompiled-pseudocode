/*
 * XREFs of ndisGetPowerInfo @ 0x1C005FB2C
 * Callers:
 *     ndisDeviceControlHandler @ 0x1C00B5800 (ndisDeviceControlHandler.c)
 * Callees:
 *     memmove @ 0x1C0026E40 (memmove.c)
 *     memset @ 0x1C0027180 (memset.c)
 *     ?ndisXlateSSResume@@YA?AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z @ 0x1C005F424 (-ndisXlateSSResume@@YA-AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z.c)
 *     ndisGetListEntriesCount @ 0x1C00E66A0 (ndisGetListEntriesCount.c)
 *     ndisXlateMiniportFlags @ 0x1C00EEF68 (ndisXlateMiniportFlags.c)
 *     ndisXlatePnPFlags @ 0x1C00EEFCC (ndisXlatePnPFlags.c)
 */
  ...
  if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v5 + 48) + 24LL) + 24LL) )
  {
    ...
    if ( v8 >= 0x35C )
    {
      ...
      *((_BYTE *)v9 + 523) = *(_BYTE *)(a1 + 3165);
      ...
      if ( (v17 & 8) != 0 )
        v9[131] = v16 | 0x200000;
      v9[132] = *(_DWORD *)(a1 + 2264);
      v9[133] = *(_DWORD *)(a1 + 1520);
      v9[134] = *(_DWORD *)(a1 + 3900);
      ...
      *((_BYTE *)v9 + 624) = *(_BYTE *)(a1 + 1288);
      v9[148] = *(_DWORD *)(a1 + 3896);
      *((_WORD *)v9 + 298) = *(_WORD *)(a1 + 3708);
      v9[145] = ndisGetListEntriesCount(a1 + 960);
      v9[146] = ndisGetListEntriesCount(a1 + 968);
      v9[147] = ndisGetListEntriesCount(a1 + 976);
      v9[150] = *(_DWORD *)(a1 + 3944) & 3;
      v9[151] = (*(_DWORD *)(a1 + 3944) >> 2) & 3;
      v9[152] = (*(_DWORD *)(a1 + 3944) >> 4) & 3;
      v9[153] = (*(_DWORD *)(a1 + 3944) >> 6) & 3;
      v9[154] = (*(_DWORD *)(a1 + 3944) >> 8) & 3;
      v9[155] = (*(_DWORD *)(a1 + 3944) >> 10) & 3;
      v18 = *(_DWORD *)(a1 + 3944);
      v9[142] = 720;
      v9[169] = (v18 >> 12) & 3;
      ...
      *(_DWORD *)((char *)v9 + (unsigned int)v20 + 16) = *(_DWORD *)(a1 + 1136);
      v9[178] = *(_DWORD *)(a1 + 4504);
      v21 = *(_QWORD *)(a1 + 4488);
      if ( v21 )
      {
        v22 = (MEMORY[0xFFFFF78000000014] - *(_QWORD *)(a1 + 4616)) / 10000LL - *(_QWORD *)(a1 + 4632);
        KeAcquireSpinLockRaiseToDpc(*(PKSPIN_LOCK *)(a1 + 4488));
        v9[157] = *(_DWORD *)(v21 + 8);
      ...
      if ( v26 )
      {
        ...
        *((_BYTE *)v9 + 680) = *(_DWORD *)(v26 + 376) == 2;
        v9[171] = *(_DWORD *)(v26 + 52);
        *((_BYTE *)v9 + 688) = *(_DWORD *)(v26 + 380) != 0;
