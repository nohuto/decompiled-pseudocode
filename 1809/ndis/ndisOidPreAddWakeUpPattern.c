/*
 * XREFs of ndisOidPreAddWakeUpPattern @ 0x1C00E6850
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreAddWakeUpPattern(__int64 a1)
{
  ...
  else if ( v3[1] == 1 )
  {
    if ( (v3[22] & 0xC0000) != 0 )
      return 0;
    v3[38] = 0;
    if ( !v5 || (v8 = ndisSetOpenAddWakeUpPattern(v5, v3, &v13), v2 = v13, *(_DWORD *)(a1 + 40) = v8, v2 != 1) )
    {
      if ( *(_QWORD *)a1 )
      {
        v9 = *(_BYTE *)(v1 + 32);
        ...
        {
          v11 = ndisXlateAddPacketPatternToWolPatternOid(v3, &v13);
          v2 = v13;
          *(_DWORD *)(a1 + 40) = v11;
          if ( v2 == 1 )
            return v2;
        ...
        {
          v10 = ndisSetAddWakeUpPattern(v1, v3, &v13);
        }
        v2 = v13;
        *(_DWORD *)(a1 + 40) = v10;
      }
