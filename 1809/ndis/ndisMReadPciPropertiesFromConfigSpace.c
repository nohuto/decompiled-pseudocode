/*
 * XREFs of ndisMReadPciPropertiesFromConfigSpace @ 0x1C00BCDE0
 * Callers:
  ...
  if ( NdisMGetBusData(NdisMiniportHandle, 0, 0, Buffer, 0x40u) == 64 )
  {
    ...
    else if ( (Buffer[6] & 0x10) != 0 )
    {
      ...
      while ( v3 )
      {
        ...
        if ( Buffer[0] == 5 )
        {
          if ( NdisMGetBusData(NdisMiniportHandle, 0, v4, NdisMiniportHandle + 3648, 0x18u) != 24 )
          {
            v2 = -1073741823;
            *((_QWORD *)NdisMiniportHandle + 456) = 0LL;
            *((_QWORD *)NdisMiniportHandle + 457) = 0LL;
            *((_QWORD *)NdisMiniportHandle + 458) = 0LL;
          }
        }
        else if ( Buffer[0] == 17 && NdisMGetBusData(NdisMiniportHandle, 0, v4, NdisMiniportHandle + 3672, 0xCu) != 12 )
        {
          *((_QWORD *)NdisMiniportHandle + 456) = 0LL;
          *((_QWORD *)NdisMiniportHandle + 457) = 0LL;
          *((_QWORD *)NdisMiniportHandle + 458) = 0LL;
