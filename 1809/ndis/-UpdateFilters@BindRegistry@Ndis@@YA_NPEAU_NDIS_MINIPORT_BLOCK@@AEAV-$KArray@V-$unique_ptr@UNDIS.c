/*
 * XREFs of ?UpdateFilters@BindRegistry@Ndis@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@AEAV?$KArray@V?$unique_ptr@UNDIS_BIND_FILTER_LINK@@U?$default_delete@UNDIS_BIND_FILTER_LINK@@@wistd@@@wistd@@$00@Rtl@@1W4Flags@ReadBindingsOptions@2@@Z @ 0x1C00BDEC0
 * Callers:
...
char __fastcall Ndis::BindRegistry::UpdateFilters(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, int a4)
{
  char result; // al
  __int64 v9; // rax
