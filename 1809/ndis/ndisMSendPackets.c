/*
 * XREFs of ndisMSendPackets @ 0x1C0058440
 * Callers:
 *     ndisMSend @ 0x1C0057BE0 (ndisMSend.c)
 * Callees:
...
void __fastcall ndisMSendPackets(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_qqd(0xAu, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, a2, a3);
  v7 = 0;
  v21 = v4;
  v8 = 0;
  v18 = 0;
...
LABEL_17:
      ...
      if ( v7 )
      {
        ...
        *((_DWORD *)v12 + 2) = 0;
        ...
        if ( v8 )
        {
          (*(void (__fastcall **)(__int64, struct _NDIS_PACKET **, _QWORD))(v3 + 2040))(v3, v21, v8);
          v14 = v4 + 1;
          v8 = 0;
          v21 = v4 + 1;
        }
      ...
      if ( !--v17 )
      {
        v4 = a2;
        if ( v8 )
          (*(void (__fastcall **)(__int64, struct _NDIS_PACKET **, _QWORD))(v3 + 2040))(v3, v14, v8);
        goto LABEL_28;
      }
    }
    v7 = -1073741823;
...
LABEL_28:
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
  {
    ...
    WPP_SF_qqd(0xBu, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, v4, BugCheckOnFailure);
  }
}
