/*
 * XREFs of McTemplateK0jqxz @ 0x1C005DFB8
 * Callers:
...
ULONG __fastcall McTemplateK0jqxz(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        const wchar_t *a7)
{
  ...
  if ( !a7 )
    v7 = L"NULL";
  v18 = v7;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&NDIS_PROVIDER_ID_Context, &CloseAdapter, a3, 5u, &EventData);
}
