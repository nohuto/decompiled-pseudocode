/*
 * XREFs of NdisCoCreateVc @ 0x1C011C300
 * Callers:
 *     <none>
 * Callees:
...
LABEL_28:
  *((_QWORD *)v10 + 26) = *(_QWORD *)(v15[474].QuadPart + 280);
  if ( LOBYTE(v15[4].LowPart) < 6u )
    v16 = 0LL;
  else
    v16 = *(_QWORD *)(v15[474].QuadPart + 536);
  *((_QWORD *)v10 + 30) = v16;
  if ( !v7 )
  {
    *((_QWORD *)v10 + 27) = *(_QWORD *)(v15[474].QuadPart + 512);
    *((_QWORD *)v10 + 28) = *(_QWORD *)(v15[474].QuadPart + 520);
    *((_QWORD *)v10 + 29) = *(_QWORD *)(v15[474].QuadPart + 528);
  }
  *((_QWORD *)v10 + 24) = v15;
