/*
 * XREFs of ndisOidPreIovReadVFConfigBlock @ 0x1C00FA5A0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovReadVFConfigBlock(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0x3Fu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
  if ( *(_DWORD *)(v1 + 4) != 12 )
    goto LABEL_4;
  v4 = 0;
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_23:
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x40u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v4, v11);
  }
  return v4;
}
