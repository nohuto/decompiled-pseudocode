/*
 * XREFs of NdisIMVBusDeviceRemove @ 0x1C00EB330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisIMVBusDeviceRemove(_BYTE *a1, struct _NDIS_VBUS_DEVICE_CHARACTERISTICS *a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x1Eu, &WPP_b87f241b44683114d5775ca3de93698d_Traceguids, a1, a2);
  ...
  {
    v6 = v4;
    WPP_SF_qqd(0x1Fu, &WPP_b87f241b44683114d5775ca3de93698d_Traceguids, a1, a2, v6);
  }
  return v4;
}
