/*
 * XREFs of ndisHandleLegacyTransport @ 0x1C00CBB34
 * Callers:
...
__int64 __fastcall ndisHandleLegacyTransport(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0254 >= 4u )
    WPP_SF_q(0x26u, &WPP_5d6c07f306e13ea2a30515e9b6bd8675_Traceguids, a1);
  Context = 0LL;
...
LABEL_9:
          if ( (unsigned __int8)byte_1C00A0254 >= 4u )
            WPP_SF_(0x28u, &WPP_5d6c07f306e13ea2a30515e9b6bd8675_Traceguids);
  ...
  if ( (unsigned __int8)byte_1C00A0254 >= 4u )
    WPP_SF_(0x27u, &WPP_5d6c07f306e13ea2a30515e9b6bd8675_Traceguids);
  return 3221225473LL;
}
