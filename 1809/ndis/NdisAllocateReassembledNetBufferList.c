/*
 * XREFs of NdisAllocateReassembledNetBufferList @ 0x1C004D730
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG AllocateReassembleFlags)
{
  ...
  __int64 v35; // rax
  unsigned __int8 FreeMdlHandler; // [rsp+20h] [rbp-C8h]
  const struct _GUID *v38; // [rsp+28h] [rbp-C0h]
  struct _MDL *v40; // [rsp+50h] [rbp-98h]
  void *VirtualAddress; // [rsp+70h] [rbp-78h]
  char *VirtualAddressa; // [rsp+70h] [rbp-78h]
  ULONG Length[4]; // [rsp+80h] [rbp-68h] BYREF
  struct _GUID v45; // [rsp+90h] [rbp-58h] BYREF
