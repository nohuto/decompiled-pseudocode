/*
 * XREFs of ?ndisRequestNicQuiet@@YAJPEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C00FD784
 * Callers:
...
__int64 __fastcall ndisRequestNicQuiet(struct _NDIS_MINIPORT_BLOCK *a1, char a2)
{
  ...
  if ( v6 && AoAc->RemoteWakeEnabled )
  {
    if ( (unsigned __int8)byte_1C00A025D >= 4u )
      WPP_SF_q(0x1Fu, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, (__int64)a1);
    DeviceWake = a1->DeviceCaps.DeviceWake;
    ndisMInvokeDevicePowerNotify((__int64)a1, DeviceWake);
    if ( v7 )
    {
      if ( (unsigned __int8)byte_1C00A025D >= 4u )
        WPP_SF_q(0x21u, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, (__int64)a1);
    }
    else
    {
      ...
      if ( v8 != 259 )
      {
        ...
        if ( (unsigned __int8)byte_1C00A025D >= 2u )
          WPP_SF_dq(0x20u, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, v9, a1);
      }
    }
  }
  else if ( (unsigned __int8)byte_1C00A025D >= 4u )
  {
    WPP_SF_qdD(0x22u, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, (__int64)a1, v6, AoAc->RemoteWakeEnabled);
  }
  ...
  else
  {
    ...
    if ( (unsigned __int8)byte_1C00A025D >= 2u )
      WPP_SF_dq(0x23u, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, v11, a1);
  }
  return v11;
}
