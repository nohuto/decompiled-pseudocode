/*
 * XREFs of ndisOidPreIovSetVFPowerState @ 0x1C00FA920
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovSetVFPowerState(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0x45u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
  v4 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
  {
LABEL_4:
...
LABEL_12:
  ...
  {
    v7 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x46u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v4, v7);
  }
  return v4;
}
