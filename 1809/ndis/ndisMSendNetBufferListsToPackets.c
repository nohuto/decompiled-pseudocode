/*
 * XREFs of ndisMSendNetBufferListsToPackets @ 0x1C0058230
 * Callers:
...
void __fastcall ndisMSendNetBufferListsToPackets(__int64 a1, struct _NET_BUFFER_LIST *a2, __int64 a3, int a4)
{
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_qq(0x38u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, a2);
  LODWORD(v11) = 10;
  v10 = v17;
  ...
  do
  {
    ...
    if ( v14 )
    {
      (*(void (__fastcall **)(__int64, _BYTE *))(a1 + 2048))(a1, v17);
      if ( !v7 )
        break;
    }
  }
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_qq(0x39u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, a2, v10, v11);
}
