/*
 * XREFs of ndisWmiFindInstanceName @ 0x1C00F62C0
 * Callers:
  ...
  if ( a4 >= 0x30u && a3 && a3[5] == 58 )
  {
      ...
      if ( RtlEqualUnicodeString((PCUNICODE_STRING)(v9 - 3), &String2, 1u) )
      {
        if ( !(unsigned __int8)ndisReferenceVcPtr(v9 - 40, v10) )
        {
          if ( (unsigned __int8)byte_1C00A0261 >= 2u )
            WPP_SF_q(0xAu, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, a2);
          v4 = -1073741823;
        }
        break;
      }
    ...
    if ( v9 == v8 )
    {
      if ( (unsigned __int8)byte_1C00A0261 >= 4u )
        WPP_SF_qZ(0xBu, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, a2, &String2.Length);
      v4 = -1073741162;
    }
    if ( v4 >= 0 )
      *a1 = v5;
  }
  else if ( !RtlEqualUnicodeString(*(PCUNICODE_STRING *)(a2 + 3888), &String2, 1u) )
  {
    if ( (unsigned __int8)byte_1C00A0261 >= 2u )
      WPP_SF_q(0xCu, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, a2);
