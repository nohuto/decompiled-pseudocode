/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C0108D20
 * Callers:
 *     PpRegStateReadCreateClassCreationSettings @ 0x1C0108EF0 (PpRegStateReadCreateClassCreationSettings.c)
 * Callees:
 *     WdmlibRtlInitUnicodeStringEx @ 0x1C0082694 (WdmlibRtlInitUnicodeStringEx.c)
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00D28BC (SeUtilSecurityInfoFromSecurityDescriptor.c)
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C0109380 (CmRegUtilUcValueGetFullBuffer.c)
