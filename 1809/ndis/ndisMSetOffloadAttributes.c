/*
 * XREFs of ndisMSetOffloadAttributes @ 0x1C00C9B6C
 * Callers:
 ...
 *     ndisValidateOffloadCapability @ 0x1C00C9EE8 (ndisValidateOffloadCapability.c)
 *     ndisValidateConnectionOffload @ 0x1C00F752C (ndisValidateConnectionOffload.c)
 */
...
__int64 __fastcall ndisMSetOffloadAttributes(__int64 a1, __int64 a2, _WORD *a3, _WORD *a4, _WORD *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_qq(0xAu, &WPP_78f864c349013b9f055032bfbe98ff58_Traceguids, a1, a2);
  v8 = 188LL;
...
LABEL_31:
  ...
  v15 = *(_BYTE **)(a1 + 4128);
  if ( v15 || (v16 = ndisMAllocateMiniportOffload(a1)) == 0 && (v15 = *(_BYTE **)(a1 + 4128)) != 0LL )
  {
    if ( a2 )
    {
      *v15 = 1;
      v17 = *(_QWORD *)(a1 + 4128) + 384LL;
      v18 = v51[1];
      *(_OWORD *)v17 = v51[0];
      *(_OWORD *)(v17 + 16) = v18;
      v19 = v51[3];
...
LABEL_28:
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_qD(0xBu, &WPP_78f864c349013b9f055032bfbe98ff58_Traceguids, a1, v16);
  return v16;
}
