/*
 * XREFs of ndisQueryOpenRSSParameters @ 0x1C0048528
 * Callers:
...
__int64 __fastcall ndisQueryOpenRSSParameters(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x9Cu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v2, a2);
  v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v2 + 96));
  *(_QWORD *)(v2 + 520) = KeGetCurrentThread();
  *(_DWORD *)(v2 + 1864) = 2305263;
  if ( *(_WORD *)(v2 + 2710) )
  {
    v7 = *(_QWORD *)(a1 + 488);
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qD(0x9Du, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v2, v3);
  return v3;
}
