/*
 * XREFs of NdisMConfigMSIXTableEntry @ 0x1C0024E50
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_MSIX_CONFIG_PARAMETERS MSIXConfigParameters)
{
  ...
  {
    v5 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))v3[540];
    if ( !v5 )
      goto LABEL_9;
    v6 = v5(v3[539], MSIXConfigParameters->TableEntry, MSIXConfigParameters->MessageNumber);
    goto LABEL_8;
  }
  ...
  if ( (_DWORD)NdisMiniportHandle )
  {
    ...
    {
      v8 = (__int64 (__fastcall *)(_QWORD, _QWORD))v3[542];
      goto LABEL_17;
    }
LABEL_12:
    v4 = -1073741811;
  ...
  v8 = (__int64 (__fastcall *)(_QWORD, _QWORD))v3[541];
LABEL_17:
  if ( v8 )
  {
    v6 = v8(v3[539], MSIXConfigParameters->TableEntry);
LABEL_8:
    v4 = v6;
  }
LABEL_9:
