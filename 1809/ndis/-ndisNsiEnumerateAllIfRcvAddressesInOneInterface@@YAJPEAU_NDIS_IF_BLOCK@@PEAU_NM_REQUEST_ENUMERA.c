/*
 * XREFs of ?ndisNsiEnumerateAllIfRcvAddressesInOneInterface@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C003F7A4
 * Callers:
        ...
        struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a2)
{
  ...
  if ( a1->ifRcvAddressCount && ndisIfReferenceMiniport((__int64)a1, 9u) )
  {
    v5 = *((_DWORD *)a2 + 12) == 0;
    v6 = *((_DWORD *)a2 + 22);
