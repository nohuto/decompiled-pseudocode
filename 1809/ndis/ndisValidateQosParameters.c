/*
 * XREFs of ndisValidateQosParameters @ 0x1C004923C
 * Callers:
...
__int64 __fastcall ndisValidateQosParameters(__int64 a1, __int64 a2, _DWORD *a3, unsigned int a4, unsigned int *a5)
{
  ...
  v7 = a2;
  v8 = a1;
  if ( (unsigned __int8)byte_1C00A025A >= 5u )
  ...
  {
    if ( (unsigned __int8)byte_1C00A025A >= 5u )
      WPP_SF_(0x89u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids);
    return 3221225659LL;
  }
  v11 = a3[1];
  if ( (v11 & 2) != 0 )
  {
    ...
    if ( !v12 || v7 && v12 > v9[2] )
    {
      ...
      {
        if ( (unsigned __int8)byte_1C00A025A >= 5u )
          WPP_SF_(0x8Bu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids);
        return 3221291029LL;
      }
      if ( (unsigned __int8)byte_1C00A025A < 5u )
        return 3221291029LL;
      ...
      do
      {
        ...
        if ( *v18 >= 8u )
        {
          if ( (unsigned __int8)byte_1C00A025A >= 5u )
          {
            ...
            v20 = v17;
LABEL_41:
            WPP_SF_DDD(v25, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v20, v26);
          }
          return 3221291029LL;
        }
        if ( !_bittest(&v13, v19) )
        ...
        do
        {
          if ( _bittest(&v13, v20) )
          {
            ...
            if ( v21 )
            {
              ...
              {
                if ( (unsigned __int8)byte_1C00A025A >= 5u )
                  WPP_SF_dd(0x91u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v20, v20);
                return 3221291029LL;
              }
              v16 += v24;
            }
            else if ( v7 && (v9[1] & 1) == 0 || *((_BYTE *)a3 + a1 + 20) )
            {
              if ( v7 )
              {
                ...
                v23 = 143;
LABEL_46:
                WPP_SF_DDDD(v23, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v20, v22);
                return 3221291029LL;
              }
              if ( (unsigned __int8)byte_1C00A025A < 5u )
                return 3221291029LL;
        ...
        if ( (unsigned __int8)byte_1C00A025A >= 5u )
          WPP_SF_D(0x93u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v16);
        return 3221291029LL;
      }
      if ( v7 )
      {
    ...
    WPP_SF_dd(v28, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v12, v27);
    return 3221291029LL;
  }
LABEL_61:
  if ( (v11 & 0x20000) != 0 )
  {
    ...
    if ( a4 < v32 )
    {
      if ( a5 )
        *a5 = v32;
      if ( (unsigned __int8)byte_1C00A025A >= 5u )
        WPP_SF_dd(0x96u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, a4, v32);
      return 3221291028LL;
    }
    v35 = 0;
    if ( (_DWORD)v29 )
    {
      ...
      while ( *(_BYTE *)a1 == 0xB7 && *(_BYTE *)(a1 + 1) && *(_WORD *)(a1 + 2) >= 0x10u )
      {
        ...
        {
          if ( (unsigned __int8)byte_1C00A025A >= 5u )
            WPP_SF_DDDDDDDDDDD(0x98u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v35, v36);
          return 3221291029LL;
        }
        a1 += v30;
      ...
      if ( (unsigned __int8)byte_1C00A025A >= 5u )
        WPP_SF_D(0x97u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v35);
      return 3221291029LL;
    }
  }
LABEL_95:
