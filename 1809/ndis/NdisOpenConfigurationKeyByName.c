/*
 * XREFs of NdisOpenConfigurationKeyByName @ 0x1C00C52C0
 * Callers:
        ...
        PNDIS_HANDLE SubKeyHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00A0257 >= 4u )
    WPP_SF_q(0x14u, &WPP_9d4cd70f7fc237db66c5630c937009d5_Traceguids, (__int64)ConfigurationHandle);
  ...
  if ( (unsigned __int8)byte_1C00A0257 >= 4u )
    WPP_SF_q(0x15u, &WPP_9d4cd70f7fc237db66c5630c937009d5_Traceguids, (__int64)ConfigurationHandle);
}
