/*
 * XREFs of ndisOidPostIovVPortParameters @ 0x1C0070F10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovVPortParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x39u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
    v4 = *(_QWORD *)(a1 + 32);
  }
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0x3Au, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
}
