/*
 * XREFs of ndisMReenumerateFailedAdapterInternal @ 0x1C00690CC
 * Callers:
...
void __fastcall ndisMReenumerateFailedAdapterInternal(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  else
  {
    ...
    KeReleaseSpinLock(p_Lock, v4);
    if ( (unsigned __int8)byte_1C00A0260 >= 2u )
      WPP_SF_q(0x42u, &WPP_75e565b92a953e07dcf27d4fb26abe24_Traceguids, (__int64)a1);
