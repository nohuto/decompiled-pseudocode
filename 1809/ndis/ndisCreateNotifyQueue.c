/*
 * XREFs of ndisCreateNotifyQueue @ 0x1C01170F8
 * Callers:
...
__int64 __fastcall ndisCreateNotifyQueue(__int64 a1, __int64 a2, __int64 a3, _QWORD **a4)
{
  ...
  if ( (unsigned __int8)byte_1C00A0262 >= 4u )
    WPP_SF_qq(0xAu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids, a1, a2);
  *a4 = 0LL;
  if ( a2 )
  {
    ...
    if ( (*(_DWORD *)(a2 + 224) & 0x18000) == 0 )
    {
      ...
      while ( v9 )
      {
        ...
        if ( !PoolWithTag )
        {
          if ( (unsigned __int8)byte_1C00A0262 >= 2u )
            WPP_SF_(0xBu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
          v8 = -1073741670;
          break;
        }
      ...
      while ( 1 )
      {
        if ( *(_QWORD *)(*(_QWORD *)(v12 + 24) + 200LL) )
        {
          ...
          else
          {
            ...
            {
              if ( (unsigned __int8)byte_1C00A0262 >= 2u )
                WPP_SF_(0xCu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
              v8 = -1073741670;
...
LABEL_30:
  if ( (unsigned __int8)byte_1C00A0262 >= 4u )
    WPP_SF_qqd(0xDu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids, a1, a2, v8);
  return v8;
}
