/*
 * XREFs of ?ndisSetMiniportRSSv2Parameters@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1C0080FF8
 * Callers:
        ...
        int *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x1Eu, &WPP_3f6e3b5cccdc3bc25dcf36d3a561497f_Traceguids, a1, a2);
  ...
  if ( v7 )
  {
    if ( (unsigned __int8)byte_1C00A025A >= 2u )
    {
      ...
      LODWORD(v13) = v7;
LABEL_6:
      WPP_SF_qqd(v9, &WPP_3f6e3b5cccdc3bc25dcf36d3a561497f_Traceguids, a1, a2, v13);
    }
  }
  else
  {
...
LABEL_11:
  *a3 = v8;
  if ( v8 && (unsigned __int8)byte_1C00A025A >= 2u )
  {
    LODWORD(v13) = v8;
    WPP_SF_qqd(0x21u, &WPP_3f6e3b5cccdc3bc25dcf36d3a561497f_Traceguids, a1, a2, v13);
  }
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
  {
    LODWORD(v14) = *a3;
    LODWORD(v13) = v6;
    WPP_SF_qqDD(0x22u, &WPP_3f6e3b5cccdc3bc25dcf36d3a561497f_Traceguids, a1, a2, v13, v14);
  }
  return v6;
}
