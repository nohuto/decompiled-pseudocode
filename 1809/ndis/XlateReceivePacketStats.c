/*
 * XREFs of XlateReceivePacketStats @ 0x1C0068200
 * Callers:
...
void __fastcall XlateReceivePacketStats(__int64 a1, _BYTE *a2, unsigned int a3)
{
  ...
  if ( *(_BYTE *)(a1 + 32) < 6u )
  {
    v3 = (_QWORD *)(*(_QWORD *)(a1 + 3168) + 112LL * KeGetPcr()->Prcb.Number);
    *v3 += a3;
    if ( *(_DWORD *)(a1 + 464) )
      goto LABEL_12;
    if ( *a2 == 0xFF && a2[1] == 0xFF && a2[2] == 0xFF && a2[3] == 0xFF && a2[4] == 0xFF && a2[5] == 0xFF )
    {
      ++*(_QWORD *)(*(_QWORD *)(a1 + 3168) + 48LL);
      *(_QWORD *)(*(_QWORD *)(a1 + 3168) + 16LL) += a3;
      return;
    }
    if ( (*a2 & 1) == 0 )
    {
