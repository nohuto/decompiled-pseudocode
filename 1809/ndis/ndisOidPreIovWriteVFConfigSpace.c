/*
 * XREFs of ndisOidPreIovWriteVFConfigSpace @ 0x1C00FB0B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovWriteVFConfigSpace(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0x3Du, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
  v4 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
  {
LABEL_4:
...
LABEL_15:
  ...
  {
    v10 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x3Eu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v4, v10);
  }
  return v4;
}
