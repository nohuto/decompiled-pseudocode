/*
 * XREFs of ndisMShutdownMiniport @ 0x1C0119B2C
 * Callers:
...
__int64 __fastcall ndisMShutdownMiniport(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 120) = v3 & 0x7FFFFFFE | 0x80000000;
  ...
  if ( (*(_DWORD *)(a1 + 124) & 0x4004) == 0 && (unsigned int)(*(_DWORD *)(a1 + 3900) - 2) > 2 )
  {
    if ( *(_BYTE *)(a1 + 32) >= 6u )
    {
      if ( *(_QWORD *)(*(_QWORD *)(a1 + 3792) + 232LL) )
        ndisMInvokeShutdown(a1, 0);
    }
    else
    {
      v4 = *(void (__fastcall **)(_QWORD))(a1 + 2080);
      if ( v4 )
        v4(*(_QWORD *)(a1 + 2072));
    }
    *(_DWORD *)(a1 + 124) |= 0x800000u;
    if ( (unsigned __int8)byte_1C00A0258 >= 4u )
      WPP_SF_qZ(0x75u, &WPP_42361dd9a74b3d276ab6054e0e6a2aa7_Traceguids, a1, *(const wchar_t **)(a1 + 3888));
  }
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
