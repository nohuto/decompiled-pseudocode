/*
 * XREFs of ndisNdkPcwAddCounter @ 0x1C006BC90
 * Callers:
 ...
 *     ?ndisPcwGetMiniportName@@YAPEBU_UNICODE_STRING@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00F8538 (-ndisPcwGetMiniportName@@YAPEBU_UNICODE_STRING@@PEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
 */
...
__int64 __fastcall ndisNdkPcwAddCounter(__int64 a1)
{
  ...
  for ( i = v2; v3; v3 = v3->NextGlobalMiniport )
  {
    if ( v3->NDKBlock && ndisReferenceMiniport((__int64)v3) )
    {
      ...
      ndisDereferenceMiniport((__int64)v3, 0x5Cu);
    }
  }
  KeReleaseSpinLock(&ndisMiniportListLock, i);
