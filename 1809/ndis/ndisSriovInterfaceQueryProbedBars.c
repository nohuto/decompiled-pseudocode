/*
 * XREFs of ndisSriovInterfaceQueryProbedBars @ 0x1C00FB6B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceQueryProbedBars(void *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_q(0x61u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qD(0x62u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
