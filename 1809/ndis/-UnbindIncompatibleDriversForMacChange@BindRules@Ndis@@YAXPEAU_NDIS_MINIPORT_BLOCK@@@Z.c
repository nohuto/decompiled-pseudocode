/*
 * XREFs of ?UnbindIncompatibleDriversForMacChange@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00C2350
 * Callers:
...
LABEL_62:
    ...
    if ( v6 )
    {
      _m_prefetchw((char *)this + 4464);
      v7 = *((_DWORD *)this + 1116);
      do
      {
        v8 = v7;
        v7 = _InterlockedCompareExchange((volatile signed __int32 *)this + 1116, v7, v7);
      }
      while ( v8 != v7 );
      ...
      {
        v10 = v9;
        v9 = _InterlockedCompareExchange((volatile signed __int32 *)this + 1116, v9, v9);
      }
      while ( v10 != v9 );
...
LABEL_36:
      ...
      else
      {
        ...
        if ( v14 && (unsigned __int8)byte_1C00A026B >= 4u )
        {
          ndisGetBindLinkNameForTracing(
            *(struct NDIS_BIND_FILTER_LINK **)(v5 + 8 * i),
  ...
  for ( j = 0LL; j != v15; ++j )
  {
    ...
    {
      _m_prefetchw((char *)this + 4464);
      v19 = *((_DWORD *)this + 1116);
      do
      {
        v20 = v19;
        v19 = _InterlockedCompareExchange((volatile signed __int32 *)this + 1116, v19, v19);
      }
      while ( v20 != v19 );
      if ( (v19 & 0x20) != 0 && (*(_DWORD *)(v18 + 64) & 2) == 0 )
        goto LABEL_51;
      _m_prefetchw((char *)this + 4464);
      v21 = *((_DWORD *)this + 1116);
      do
      {
        v22 = v21;
        v21 = _InterlockedCompareExchange((volatile signed __int32 *)this + 1116, v21, v21);
      }
      while ( v22 != v21 );
...
LABEL_51:
      ...
      else
      {
        ...
        if ( (v25 != 0) != ((v25 & 0xFFBFFFFF) != 0) || !*(_QWORD *)v24 )
        {
          ...
          v26 = (unsigned __int8)byte_1C00A026B < 4u;
          *(_BYTE *)(*(_QWORD *)v24 + 5248LL) = 1;
          if ( !v26 )
            WPP_SF_Zq(
              0x18u,
              &WPP_28ccc015ff3a36b32c91c02afee3c661_Traceguids,
