/*
 * XREFs of NdisIfRegisterProvider @ 0x1C0025110
 * Callers:
        ...
        PNDIS_HANDLE pNdisIfProviderHandle)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_q(12LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, IfProviderContext);
  v6 = 0;
...
LABEL_14:
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qqd(13LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, IfProviderContext, pNdisIfProviderHandle, v6);
  return v6;
}
