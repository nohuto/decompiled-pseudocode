/*
 * XREFs of ndisMInitializeScatterGatherDma @ 0x1C00CF3A4
 * Callers:
 *     NdisMRegisterScatterGatherDma @ 0x1C00CF2D0 (NdisMRegisterScatterGatherDma.c)
 *     NdisMInitializeScatterGatherDma @ 0x1C00E9FB0 (NdisMInitializeScatterGatherDma_ea_1C00E9FB0.c)
 * Callees:
 *     NdisWriteErrorLogEntry @ 0x1C0014630 (NdisWriteErrorLogEntry.c)
 *     ndisAssignSGListLookasideList @ 0x1C0022F20 (ndisAssignSGListLookasideList.c)
        ...
        int a4)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qdD(0xAu, &WPP_b7380f6131c0382fffce9713ea39f3ba_Traceguids, (__int64)NdisAdapterHandle, a2, a4);
  v10 = *((_QWORD *)NdisAdapterHandle + 474);
  v11 = *(_BYTE *)(v10 + 24);
...
LABEL_39:
  ...
  *((_DWORD *)v4 + 13) = a4;
  ...
  v14 = *((_DWORD *)NdisAdapterHandle + 937);
  ...
  *(_DWORD *)DeviceDescription = a3;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
    WPP_SF_q(0xBu, &WPP_b7380f6131c0382fffce9713ea39f3ba_Traceguids, (__int64)NdisAdapterHandle);
  v22 = -1073741670;
  ExFreePoolWithTag(v4, 0);
  *((_QWORD *)NdisAdapterHandle + 63) = 0LL;
LABEL_27:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xDu, &WPP_b7380f6131c0382fffce9713ea39f3ba_Traceguids, (__int64)NdisAdapterHandle, v22);
  return v22;
}
