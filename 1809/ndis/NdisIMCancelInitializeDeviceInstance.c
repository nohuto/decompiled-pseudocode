/*
 * XREFs of NdisIMCancelInitializeDeviceInstance @ 0x1C00EAFD0
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisIMCancelInitializeDeviceInstance(NDIS_HANDLE DriverHandle, PNDIS_STRING DeviceInstance)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qZ(0x2Cu, &WPP_b87f241b44683114d5775ca3de93698d_Traceguids, (__int64)DriverHandle, &DeviceInstance->Length);
