/*
 * XREFs of ?ndisAllocateNumaStripedPages@@YAPEAXXZ @ 0x1C00CEA18
 * Callers:
 *     ndisAllocatePerProcessorPageDescriptor @ 0x1C0022E8C (ndisAllocatePerProcessorPageDescriptor.c)
 * Callees:
 *     memset @ 0x1C0027180 (memset.c)
 *     ?ndisFreeMappingAddress@@YAXPEAX@Z @ 0x1C006A108 (-ndisFreeMappingAddress@@YAXPEAX@Z.c)
 *     ndisGetNodeIdForProcessor @ 0x1C00CEC84 (ndisGetNodeIdForProcessor.c)
