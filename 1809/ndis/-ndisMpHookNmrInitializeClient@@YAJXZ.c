/*
 * XREFs of ?ndisMpHookNmrInitializeClient@@YAJXZ @ 0x1C012913C
 * Callers:
 ...
 *     ?FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QEAAXXZ @ 0x1C00CBF00 (-FillDefaultHandlers@MINIPORT_HOOK_DRIVER@@QEAAXXZ.c)
