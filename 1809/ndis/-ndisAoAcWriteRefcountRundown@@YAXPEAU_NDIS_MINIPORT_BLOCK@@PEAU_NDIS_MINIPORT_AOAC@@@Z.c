/*
 * XREFs of ?ndisAoAcWriteRefcountRundown@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_AOAC@@@Z @ 0x1C00779E8
 * Callers:
...
void __fastcall ndisAoAcWriteRefcountRundown(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_MINIPORT_AOAC *a2)
{
  ...
  do
  {
    ...
    if ( (int)v7 > 0 && (byte_1C00A2083 & 4) != 0 )
      McTemplateK0xqq(v7, (_DWORD)a2, (_DWORD)a1 + 4040, a1->NetLuid.Value, v5, *ComponentRefCounts);
    ++v5;
    ++ComponentRefCounts;
  }
  while ( v5 < 0x11 );
