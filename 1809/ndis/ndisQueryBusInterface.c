/*
 * XREFs of ndisQueryBusInterface @ 0x1C00D0574
 * Callers:
...
__int64 __fastcall ndisQueryBusInterface(__int64 a1)
{
  ...
  if ( Irp )
  {
    ...
    *(_DWORD *)(v5 + 16) = 65600;
    ...
    {
      v6 = 0;
      *(_QWORD *)(a1 + 3720) = v11[6];
      *(_QWORD *)(a1 + 3728) = v11[7];
      *(_QWORD *)(a1 + 3736) = v11[1];
    }
    ...
    *(_DWORD *)(v5 + 16) = 65608;
    ...
    {
      *(_QWORD *)(a1 + 4312) = v10[1];
      *(_QWORD *)(a1 + 4320) = v10[4];
      *(_QWORD *)(a1 + 4328) = v10[5];
      *(_QWORD *)(a1 + 4336) = v10[6];
    }
    IoReuseIrp(v4, -1073741637);
    *(_WORD *)v5 = 2075;
    *(_QWORD *)(v5 + 40) = v2;
