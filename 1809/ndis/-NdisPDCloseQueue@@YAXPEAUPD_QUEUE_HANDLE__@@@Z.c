/*
 * XREFs of ?NdisPDCloseQueue@@YAXPEAUPD_QUEUE_HANDLE__@@@Z @ 0x1C00FEDB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDCloseQueue(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_q(0x60u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, (__int64)P);
  v4.m_State = Unlocked;
  ...
  *P = 0LL;
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_q(0x61u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, (__int64)P);
}
