/*
 * XREFs of ndisSendPacketsWithPause @ 0x1C0059670
 * Callers:
...
void __fastcall ndisSendPacketsWithPause(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_qqd(0x30u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, a2, a3);
...
LABEL_18:
      ...
      if ( v10 )
      {
        ...
        *((_DWORD *)v15 + 2) = 0;
        ...
        if ( v7 )
        {
          (*(void (__fastcall **)(__int64, struct _NDIS_PACKET **, _QWORD))(v3 + 2040))(v3, v23, v7);
          v17 = v24;
          v7 = 0;
          v18 = v24 + 1;
          v23 = v24 + 1;
      ...
      {
        if ( v7 )
          (*(void (__fastcall **)(__int64, struct _NDIS_PACKET **, _QWORD))(v3 + 2040))(v3, v18, v7);
        v4 = a2;
        goto LABEL_37;
      }
    }
...
LABEL_17:
  ...
  if ( (_DWORD)v5 )
  {
    ...
    do
    {
      (*(void (__fastcall **)(_QWORD, _QWORD, __int64))(a1 + 680))(*(_QWORD *)(a1 + 528), *v21++, 3223519274LL);
      --v5;
    }
    while ( v5 );
  }
...
LABEL_37:
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
  {
    ...
    WPP_SF_qqd(0x31u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, v4, BugCheckOnFailure);
  }
}
