/*
 * XREFs of ?ndisCoSendPacketsToNdisPackets@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C00541F0
 * Callers:
...
void __fastcall ndisCoSendPacketsToNdisPackets(_QWORD *a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_qqd(0xBu, &WPP_4d0c893ac8ec3b5f26b43baabc605489_Traceguids, a1, *a2, a3);
  EthDB = v3->EthDB;
...
LABEL_25:
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_q(0xCu, &WPP_4d0c893ac8ec3b5f26b43baabc605489_Traceguids, (__int64)a1);
}
