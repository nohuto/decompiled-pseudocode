/*
 * XREFs of ?ndisNsiGetInterfaceRodInformation@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00B7170
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qqq(0x46u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a2, v5);
    v4 = v24;
    v7 = a2;
    v6 = a1;
  }
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qqqL(0x47u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, v6, v7, v5, v3);
  return v3;
}
