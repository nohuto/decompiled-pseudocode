/*
 * XREFs of ndisUpdateRcvFilterQueueParameters @ 0x1C003D0F0
 * Callers:
 ...
 *     ndisOidPostRcvFilterQueueParameters @ 0x1C003BB00 (ndisOidPostRcvFilterQueueParameters.c)
 * Callees:
...
char __fastcall ndisUpdateRcvFilterQueueParameters(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 1864) = 2688371;
  v5 = *(_DWORD *)(a2 + 12);
  if ( v5 )
    ReceiveQueueByQueueId = ndisFindReceiveQueueByQueueId(a1, v5);
  else
    ReceiveQueueByQueueId = *(__int64 **)(a1 + 4408);
