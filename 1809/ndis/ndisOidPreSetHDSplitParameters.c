/*
 * XREFs of ndisOidPreSetHDSplitParameters @ 0x1C00E4440
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreSetHDSplitParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0xD5u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v1, v3);
  v4 = 1;
  if ( *(_DWORD *)(v3 + 4) != 1 )
    goto LABEL_4;
  if ( !*(_QWORD *)a1 )
...
LABEL_20:
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qdD(0xD6u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v1, *(_DWORD *)(a1 + 40), v4);
  return v4;
}
