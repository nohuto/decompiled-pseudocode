/*
 * XREFs of ?ndisNblTrackerVerifyNoNblsHeld@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C006B9A4
 * Callers:
 ...
 *     ndisNblTrackerAreNblsOutstandingOnComponent @ 0x1C006B050 (ndisNblTrackerAreNblsOutstandingOnComponent.c)
 */
