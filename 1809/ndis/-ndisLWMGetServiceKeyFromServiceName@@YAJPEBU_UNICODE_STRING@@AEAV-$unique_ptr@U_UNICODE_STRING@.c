/*
 * XREFs of ?ndisLWMGetServiceKeyFromServiceName@@YAJPEBU_UNICODE_STRING@@AEAV?$unique_ptr@U_UNICODE_STRING@@U?$KFreePool@U_UNICODE_STRING@@@@@wistd@@@Z @ 0x1C00F10F8
 * Callers:
...
__int64 __fastcall ndisLWMGetServiceKeyFromServiceName(PCUNICODE_STRING Source, void **a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x76u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)Source);
    ...
    if ( !Buffer[(unsigned __int64)Source->Length >> 1] )
    {
      ...
      if ( v5 < 0 )
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
          WPP_SF_D(0x78u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, v5);
        goto LABEL_26;
      }
      ...
      *(_DWORD *)&Sourcea.Length = 6946920;
      ...
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
          WPP_SF_((_WORD)Destination + 121, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids);
        v7 = -1073741670;
        goto LABEL_26;
      }
      v11 = Destination;
...
LABEL_17:
      ...
      else if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      {
        v13 = 122;
LABEL_15:
        WPP_SF_D(v13, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, appended);
      }
      v14 = v10;
      goto LABEL_17;
    }
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
    WPP_SF_(0x77u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids);
  v7 = -1073741811;
LABEL_26:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x7Cu, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)Source, v7);
  return v7;
}
