/*
 * XREFs of ndisSriovInterfaceReadVFConfig @ 0x1C00FB830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVFConfig(void *a1, void *a2, __int16 a3, int a4, unsigned int Size)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_q(0x59u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qD(0x5Au, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
