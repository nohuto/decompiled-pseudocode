/*
 * XREFs of ?NdisPDPIAcquireReceiveQueues@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_ACQUIRE_QUEUES_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@PEAKPEAU_NDIS_PD_QUEUE_PARAMETERS@@33@Z @ 0x1C00FF430
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a7)
{
  ...
  v33.m_Lock = (KPushLockBase *)qword_1C00A07C8;
          ...
          while ( 1 )
          {
            ...
            if ( v20->CounterHandle )
            {
              ...
              if ( PoolWithTag )
              {
                ...
                *(_QWORD *)&v19[6].Length = 0LL;
                v19[6].MaximumLength = 0;
                v19[6].Buffer = 0LL;
                *(_QWORD *)&v19[7].Length = 0LL;
                v19[7].MaximumLength = 0;
                v19[7].Buffer = 0LL;
              }
              else
              {
...
LABEL_42:
              ...
              *(_DWORD *)&v19[4].Length = v29;
              *(_DWORD *)(&v19[4].MaximumLength + 1) = ndisGetNextPDCounterId();
              v16 = ndisPcwSetRssInstanceSuffix((struct NDIS_PD_COUNTER *)v19);
              if ( v16 < 0 )
              {
                NDIS_PD_COUNTER::`scalar deleting destructor'(v19);
LABEL_41:
                v8 = 1;
                goto LABEL_46;
              }
              ndisSetupPDCounter(
                ...
                1);
              v20->CounterHandle = (NDIS_PD_COUNTER_HANDLE__ *)v19;
            }
