/*
 * XREFs of ?NdisTraceLoggingStuckNbl@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C007E594
 * Callers:
 *     ?ndisNblTrackerWatchdogTimer@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C00096B0 (-ndisNblTrackerWatchdogTimer@@YAXPEAU_EX_TIMER@@PEAX@Z.c)
 * Callees:
...
LABEL_6:
      if ( hProvider.LevelPlus1 > 5 )
      {
        if ( TlgKeywordOn(&hProvider, 0x400000000000uLL) )
        {
          ...
          v27 = Context + 4040;
          v28 = 16LL;
          TlgWrite(&hProvider, &unk_1C008C3DD, v3, v4, 4u, &pData);
        }
      }
      return;
    case 1:
      ...
      if ( v12 )
      {
        if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
        {
          ...
          *(_DWORD *)&pActivityId.Data2 = 0;
          TlgWrite(&hProvider, &unk_1C008D080, &pActivityId, v13, 8u, &pData);
        }
      }
      else if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
      {
        ...
        v26 = 4LL;
        v28 = 16LL;
        TlgWrite(&hProvider, &unk_1C008D231, v19, v20, 4u, &pData);
      }
      break;
    case 2:
      if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
      {
        ...
        v28 = v10;
        v30[0] = v11;
        TlgWrite(&hProvider, &unk_1C008D269, v7, cData, (UINT32)cData, &pData);
      }
      break;
    default:
      if ( v1 <= 2 || v1 > 5 )
