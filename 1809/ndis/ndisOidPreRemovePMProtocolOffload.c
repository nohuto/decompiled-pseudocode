/*
 * XREFs of ndisOidPreRemovePMProtocolOffload @ 0x1C00BB1B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRemovePMProtocolOffload(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x67u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, v5, v1);
    v6 = *(_QWORD *)(a1 + 24);
  }
  if ( v6
    && (v24 = *(_QWORD *)(v6 + 24), v25 = *(_BYTE *)(v24 + 56), v25 <= 6u)
    && (v25 != 6 || *(_BYTE *)(v24 + 57) < 0x14u)
    || (v7 = *(_QWORD *)(a1 + 8), v8 = 0x4000, v7)
  ...
  *(_DWORD *)(v1 + 56) = 0;
  v11 = *v10;
  if ( *(_QWORD *)(a1 + 24) && !ndisFindPatternEntry(v3 + 512, v11) )
    goto LABEL_30;
  v12 = *(_QWORD *)(a1 + 8);
  if ( v12 )
  {
    if ( (v8 & *(_DWORD *)(v1 + 88)) == 0 && !ndisFindPatternEntry(v12 + 736, v11) )
      goto LABEL_30;
  }
  if ( !*(_QWORD *)a1 )
    goto LABEL_12;
...
LABEL_12:
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qD(0x68u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, *(_QWORD *)a1, *(_DWORD *)(a1 + 40));
  return v4;
}
