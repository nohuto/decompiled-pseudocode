/*
 * XREFs of ndisPostSetRemoveWakeUpPattern @ 0x1C004B670
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisPostSetRemoveWakeUpPattern(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqq(0x27u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, v1, v4, v3);
  if ( *(_DWORD *)(a1 + 40) )
  {
    v7 = *(_QWORD **)(v3 + 144);
    if ( v7 )
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqq(0x28u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, v1, v4, v3);
}
