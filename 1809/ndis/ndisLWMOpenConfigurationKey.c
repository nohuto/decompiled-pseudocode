/*
 * XREFs of ndisLWMOpenConfigurationKey @ 0x1C00F2BEC
 * Callers:
...
__int64 __fastcall ndisLWMOpenConfigurationKey(unsigned int *a1, KRegKey *a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF__guid_(0x82u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)a1);
  ...
  if ( v4 < 0 && (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
  {
    v6 = 132;
LABEL_9:
    WPP_SF_D(v6, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, v4);
  }
LABEL_10:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF__guid_d(0x85u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)a1, v5);
  return v5;
}
