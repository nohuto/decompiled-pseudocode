/*
 * XREFs of _lambda_55dd5fd2ac8d6f91724a8900c7ec63ca_::_lambda_invoker_cdecl_ @ 0x1C00FE090
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall lambda_55dd5fd2ac8d6f91724a8900c7ec63ca_::_lambda_invoker_cdecl_(struct NDIS_BIND_LINK_BASE *a1)
{
  ...
  Ndis::BindEngine::ApplyBindChanges(&Miniport->BindEngine, (enum CallRunMode)(byte_1C00A0218 != 0), 0);
}
