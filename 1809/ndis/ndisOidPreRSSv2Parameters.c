/*
 * XREFs of ndisOidPreRSSv2Parameters @ 0x1C0081AB0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreRSSv2Parameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqq(0x2Au, &WPP_3f6e3b5cccdc3bc25dcf36d3a561497f_Traceguids, v1, v5, v3);
  v6 = *(_DWORD *)(v3 + 4);
  if ( v6 == 2 )
  {
    if ( !*(_QWORD *)a1 )
...
LABEL_17:
  ...
  {
    LODWORD(v9) = v4;
    WPP_SF_qqDD(0x2Bu, &WPP_3f6e3b5cccdc3bc25dcf36d3a561497f_Traceguids, v1, v5, v9, *(_DWORD *)(a1 + 40));
  }
  return v4;
}
