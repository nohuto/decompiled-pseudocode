/*
 * XREFs of ndisNotifyMiniports @ 0x1C010C298
 * Callers:
...
void __fastcall ndisNotifyMiniports(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2, void *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_qLq(0x3Au, &WPP_5d6c07f306e13ea2a30515e9b6bd8675_Traceguids, (__int64)a1, 5);
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0x3Bu, &WPP_5d6c07f306e13ea2a30515e9b6bd8675_Traceguids, (__int64)a1);
}
