/*
 * XREFs of ndisIovInvalidateBlockCompletion @ 0x1C00F9190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisIovInvalidateBlockCompletion(__int64 a1, _IRP *a2, __int64 a3)
{
  ...
  if ( a2->IoStatus.Status < 0 || *(_BYTE *)(a3 + 4714) )
  {
    KeSetEvent((PRKEVENT)(a3 + 4688), 0, 0);
  }
  else
  {
    v5 = (void *)(a3 + 4680);
    ...
    *(_DWORD *)&v9[32] = 66153;
    ...
    CurrentStackLocation[-1].DeviceObject = *(_DEVICE_OBJECT **)(a3 + 3872);
    ...
    v7[-1].Control = -32;
    IofCallDriver(*(PDEVICE_OBJECT *)(a3 + 3872), a2);
  }
  return 3221225494LL;
}
