/*
 * XREFs of ?NdisTraceLoggingNicAutoPowerSaver@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E_K1K11KPEAU_NDIS_NAPS_TELEMETRY_REASON_DATA@@KPEAU_NDIS_NAPS_TELEMETRY_OID_DATA@@@Z @ 0x1C007D9B4
 * Callers:
 *     ndisTraceNicAutoPowerSaver @ 0x1C00766E4 (ndisTraceNicAutoPowerSaver.c)
 * Callees:
 *     _TlgWrite @ 0x1C0013A1C (_TlgWrite.c)
 *     _TlgCreateWsz @ 0x1C0014C14 (_TlgCreateWsz.c)
...
void __fastcall NdisTraceLoggingNicAutoPowerSaver(
        _NDIS_MINIPORT_AOAC *IfInBroadcastPackets,
        char a2,
        unsigned __int64 a3,
        __int64 a4,
        unsigned int a5,
        ...
        struct _NDIS_NAPS_TELEMETRY_OID_DATA *a11)
{
  ...
  v175 = a4;
  v174 = a3;
  v12 = (struct _NDIS_MINIPORT_BLOCK *)IfInBroadcastPackets;
  if ( (IfInBroadcastPackets->CsTrafficStats[2].IfInMulticastPackets & 0x400000000LL) != 0
    && IfInBroadcastPackets[3].CsTrafficStats[1].IfOutMulticastPackets
    && a3 >= 0x927C0 )
  {
    if ( a2 )
    {
    ...
    {
      IfInBroadcastPackets = (_NDIS_MINIPORT_AOAC *)IfInBroadcastPackets[3].CsTrafficStats[1].IfInBroadcastPackets;
      v13 = IfInBroadcastPackets->TotalCsActiveTime / 0x2710;
    }
    v14.QuadPart = 0LL;
    v55 = v13;
    v52.QuadPart = 0LL;
    if ( !a2 )
    {
      ndisConvertInterruptTimeToLocalTime((unsigned __int64)IfInBroadcastPackets, &v52);
      v14 = v52;
    }
    v54 = v14;
    if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
    {
      ...
      v171 = 4LL;
      v173 = 8LL;
      TlgWrite(&hProvider, &unk_1C008C063, v17, v18, 0x39u, &pData);
    }
  }
}
