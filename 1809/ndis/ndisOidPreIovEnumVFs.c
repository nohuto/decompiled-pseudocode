/*
 * XREFs of ndisOidPreIovEnumVFs @ 0x1C0071340
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumVFs(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0x29u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, a1, v1);
  *(_DWORD *)(v2 + 60) = 0;
...
LABEL_8:
  ...
  v10 = *(_QWORD *)(*(_QWORD *)v6 + 4648LL);
  if ( v10 && *(_QWORD *)(*(_QWORD *)v6 + 3592LL) && (*(_BYTE *)(v10 + 8) & 3) == 3 )
  {
    v8[15] = 0;
...
LABEL_47:
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qD(0x2Au, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v1, v6[10]);
  return v7;
}
