/*
 * XREFs of NdisMAllocateSharedMemoryAsync @ 0x1C0064D70
 * Callers:
 *     NdisMAllocateSharedMemoryAsyncEx @ 0x1C0064EE0 (NdisMAllocateSharedMemoryAsyncEx.c)
 * Callees:
        ...
        PVOID Context)
{
  ...
  if ( (unsigned __int8)byte_1C00A0264 >= 4u )
    WPP_SF_qD(0x20u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)MiniportAdapterHandle, Length);
  ...
  if ( *(_BYTE *)MiniportAdapterHandle == 17 )
  {
    ...
    if ( *((_BYTE *)MiniportAdapterHandle + 32) >= 6u
       ? *((_QWORD *)v10 + 5) == 0LL
       : *(_QWORD *)(*((_QWORD *)MiniportAdapterHandle + 474) + 240LL) == 0LL )
    {
      goto LABEL_11;
    }
  }
...
LABEL_13:
  if ( (unsigned __int8)byte_1C00A0264 >= 4u )
    WPP_SF_D(0x21u, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, v9);
  return v9;
}
