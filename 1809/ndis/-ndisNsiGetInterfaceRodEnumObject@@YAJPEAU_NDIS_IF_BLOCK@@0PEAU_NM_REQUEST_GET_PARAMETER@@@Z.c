/*
 * XREFs of ?ndisNsiGetInterfaceRodEnumObject@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00B68D0
 * Callers:
 ...
 *     ?ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z @ 0x1C00B7540 (-ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z.c)
 */
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qq(0x50u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a3);
    v4 = v32;
    v7 = v33;
    v6 = v34;
  }
...
LABEL_18:
        ...
        if ( v9 > 0x218 )
        {
          switch ( v9 )
          {
            ...
            case 0x282u:
              v14 = 1;
              p_ifOperStatusFlags = &v7->ifHideInterfaceInUi;
              v15 = 644;
              goto LABEL_13;
            case 0x284u:
              v14 = 4;
...
LABEL_51:
          ...
          if ( v7->IsNdisFilter )
          {
            ...
            v35 = Miniport;
            if ( (unsigned __int8)byte_1C00A0265 >= 4u )
              WPP_SF_qq(0xC5u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, Miniport, v37);
            ...
            v23 = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)&Miniport->Reserved4.Length + 4072LL) + 596LL);
            v24 = v37[0];
            ...
            if ( (unsigned __int8)byte_1C00A0265 >= 4u )
              WPP_SF_qq(0xC6u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, Miniport, v37);
            v8 = v31;
...
LABEL_17:
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qqd(0x51u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, v7, v5, v3);
  return v3;
}
