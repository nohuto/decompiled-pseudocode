/*
 * XREFs of NdisPDStartup @ 0x1C0101EF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisPDStartup(_NDIS_PROTOCOL_BLOCK *a1, __int64 a2, __int64 a3, __int64 **a4, _QWORD *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_qqq(0x13u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, a1, a2, a3);
  *a4 = 0LL;
  ...
  if ( v15 )
  {
    ...
    *a4 = v13;
    *a5 = &unk_1C0086C50;
    v22.m_Lock = (KPushLockBase *)qword_1C00A07C8;
    v22.m_State = Unlocked;
    v22.m_Region.m_Entered = 0;
    KLockHolder::AcquireExclusive(&v22);
    for ( i = *(__int64 **)(qword_1C00A07C8 + 8); i != (__int64 *)(qword_1C00A07C8 + 8); i = (__int64 *)*i )
    {
    ...
    ClearBitsAndSet = RtlFindClearBitsAndSet((PRTL_BITMAP)(qword_1C00A07C8 + 24), 1u, 0);
...
LABEL_22:
    ...
    *((_WORD *)v13 + 52) = ClearBitsAndSet;
    v18 = qword_1C00A07C8 + 8;
    v19 = *(__int64 ***)(qword_1C00A07C8 + 16);
    if ( *v19 != (__int64 *)(qword_1C00A07C8 + 8) )
      __fastfail(3u);
    *v13 = v18;
    v13[1] = (__int64)v19;
    *v19 = v13;
...
LABEL_31:
  ...
  {
    LODWORD(v21) = v10;
    WPP_SF_qqd(0x14u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, a1, *a4, v21);
  }
  return v10;
}
