/*
 * XREFs of ndisOidPreQosGetParameters @ 0x1C0047940
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreQosGetParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x86u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, v1);
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_6:
    ...
    else
    {
      ...
      *(_DWORD *)(v3 + 1864) = 2304652;
      if ( *(_DWORD *)(v1 + 32) == -66781180 )
        v6 = *(unsigned __int16 **)(v3 + 4960);
      else
        v6 = *(unsigned __int16 **)(v3 + 4976);
      if ( !v6 )
      {
...
LABEL_19:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x87u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, v4, v9);
  }
  return v4;
}
