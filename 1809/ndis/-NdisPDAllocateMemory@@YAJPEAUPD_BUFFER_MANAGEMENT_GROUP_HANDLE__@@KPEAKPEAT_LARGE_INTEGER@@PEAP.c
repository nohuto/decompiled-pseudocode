/*
 * XREFs of ?NdisPDAllocateMemory@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KPEAKPEAT_LARGE_INTEGER@@PEAPEAXPEAPEAUPD_MEMORY_HANDLE__@@@Z @ 0x1C00FE950
 * Callers:
 *     <none>
 * Callees:
        ...
        struct PD_MEMORY_HANDLE__ **a6)
{
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_qdD(0x56u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, (__int64)a1, *a3, a2);
  *a6 = 0LL;
  if ( a5 )
    *a5 = 0LL;
  if ( a4 )
  ...
  {
    v14 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v12 + 32) + 5536LL) + 72LL);
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
  {
    ...
    if ( v13 < 0 )
      ...
      v18 = v9[5];
    WPP_SF_qdqiqd(v18, v17, (__int64)a1, *a3);
  }
  if ( v9 && v13 < 0 )
