/*
 * XREFs of ndisMInvokeRestart @ 0x1C00BE8C4
 * Callers:
...
__int64 __fastcall ndisMInvokeRestart(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0xEDu, &WPP_f453a6740ca1326a168191528118e90e_Traceguids, a1);
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64))(v2 + 168))(*(_QWORD *)(a1 + 24), a2);
  v6 = v5;
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_qD(0xEEu, &WPP_f453a6740ca1326a168191528118e90e_Traceguids, a1, v5);
  return v6;
}
