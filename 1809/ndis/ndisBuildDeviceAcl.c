/*
 * XREFs of ndisBuildDeviceAcl @ 0x1C00CA7DC
 * Callers:
...
__int64 __fastcall ndisBuildDeviceAcl(ACL **a1, char a2)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v15 = RtlLengthSid(&unk_1C0088DA8);
    v16 = RtlLengthSid(&unk_1C0088D88) + v15;
    v17 = RtlLengthSid(&unk_1C0088D68) + v16;
    v6 += v17 + 32 + RtlLengthSid(&unk_1C0088D48);
  }
  v23 = a2 & 4;
  if ( (a2 & 4) != 0 )
  {
...
LABEL_14:
    v10 = a2 & 0x80;
    if ( v10 )
      v6 += RtlLengthSid(&unk_1C0088D08) + 8;
    ...
    if ( v11 )
    {
      ...
      else
      {
        ...
        if ( v22 )
        {
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0088D48);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0088D68);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0088D88);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0088DA8);
        }
        if ( v23 )
        ...
        if ( v10 )
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0088D08);
        *v26 = v12;
      }
      goto LABEL_33;
    }
