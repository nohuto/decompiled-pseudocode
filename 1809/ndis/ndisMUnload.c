/*
 * XREFs of ndisMUnload @ 0x1C0116CF0
 * Callers:
...
void __fastcall ndisMUnload(PDRIVER_OBJECT DriverObject)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x20u, &WPP_9a121bb7542c30cb70afea5376c1d156_Traceguids, (__int64)DriverObject);
...
LABEL_9:
    ...
    if ( !i )
      break;
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_q(0x21u, &WPP_9a121bb7542c30cb70afea5376c1d156_Traceguids, (__int64)i);
    i->Flags |= 0x8000u;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x22u, &WPP_9a121bb7542c30cb70afea5376c1d156_Traceguids, DriverObject, 0LL);
}
