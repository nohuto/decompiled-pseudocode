/*
 * XREFs of ndisPnPIrpSurpriseRemovalInner @ 0x1C00F4E5C
 * Callers:
 *     ndisPnPIrpSurpriseRemoval @ 0x1C00F4D34 (ndisPnPIrpSurpriseRemoval.c)
 *     ndisQueuedPnPIrpSurpriseRemoval @ 0x1C00F50E0 (ndisQueuedPnPIrpSurpriseRemoval.c)
 * Callees:
...
void __fastcall ndisPnPIrpSurpriseRemovalInner(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0x24u, &WPP_75e565b92a953e07dcf27d4fb26abe24_Traceguids, (__int64)a1);
  ...
  {
    if ( (unsigned __int8)byte_1C00A025C >= 4u )
      WPP_SF_q(0x25u, &WPP_75e565b92a953e07dcf27d4fb26abe24_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0x26u, &WPP_75e565b92a953e07dcf27d4fb26abe24_Traceguids, (__int64)a1);
}
