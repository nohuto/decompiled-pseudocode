/*
 * XREFs of ?ndisIfCreateNetworkBlock@@YAJPEAU_NDIS_IF_COMPARTMENT_BLOCK@@PEAU_GUID@@PEAU_NDIS_NSI_NETWORK_RW@@PEAPEAU_NDIS_IF_NETWORK_BLOCK@@@Z @ 0x1C001EE2C
 * Callers:
        ...
        struct _NDIS_IF_NETWORK_BLOCK **a4)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qq(119LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a2);
  if ( (*((_DWORD *)a1 + 10) & 1) != 0 || !a2 || !ndisIsValidIfStringParts(a1, a3->NetworkName.Length) )
  {
    v6 = -1073741811;
    goto LABEL_19;
  }
...
LABEL_16:
  ...
  if ( Blink->Flink->Blink != Blink
    || (*v11 = Flink,
        ...
        v21 = (_LIST_ENTRY *)(a1 + 12),
        Blink->Flink = (_LIST_ENTRY *)v11,
        v22 = (_LIST_ENTRY *)(v11 + 2),
        v23 = (_LIST_ENTRY *)*((_QWORD *)a1 + 3),
        (const wchar_t *)v23->Blink != a1 + 12) )
  {
    __fastfail(3u);
  }
  v22->Flink = v23;
...
LABEL_19:
  *a4 = v4;
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qqqL(120LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a2, v4, v6);
  return v6;
}
