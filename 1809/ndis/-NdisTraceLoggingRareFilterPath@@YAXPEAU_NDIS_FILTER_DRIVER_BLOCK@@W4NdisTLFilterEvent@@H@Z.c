/*
 * XREFs of ?NdisTraceLoggingRareFilterPath@@YAXPEAU_NDIS_FILTER_DRIVER_BLOCK@@W4NdisTLFilterEvent@@H@Z @ 0x1C01031E4
 * Callers:
...
void __fastcall NdisTraceLoggingRareFilterPath(__int64 a1)
{
  ...
  if ( a1 )
  {
    if ( hProvider.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&hProvider, 0x400000000000uLL) )
      {
        ...
        v11[0] = v2;
        v27 = 4;
        TlgWrite(&hProvider, &unk_1C008C54F, (LPCGUID)2, (LPCGUID)v1, 8u, &pData);
      }
    }
  }
  else if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
  {
    ...
    v10 = v8;
    v17 = 4;
    TlgWrite(&hProvider, &unk_1C008BD95, v6, v7, 4u, &pData);
  }
}
