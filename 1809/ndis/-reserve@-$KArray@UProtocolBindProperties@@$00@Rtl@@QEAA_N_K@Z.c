/*
 * XREFs of ?reserve@?$KArray@UProtocolBindProperties@@$00@Rtl@@QEAA_N_K@Z @ 0x1C0106B74
 * Callers:
 *     ?grow@?$KArray@UProtocolBindProperties@@$00@Rtl@@AEAA_N_K@Z @ 0x1C01054CC (-grow@-$KArray@UProtocolBindProperties@@$00@Rtl@@AEAA_N_K@Z.c)
 * Callees:
    ...
    if ( is_mul_ok(0x40uLL, a2) )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        for ( i = 0; i < v7; v7 = a1[1] )
        {
          ...
          *(_DWORD *)&PoolWithTag[v10 + 40] = *(_DWORD *)(v10 + v9 + 40);
