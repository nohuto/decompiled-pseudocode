/*
 * XREFs of ndisOidPostIovCreateNicSwitch @ 0x1C0070860
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovCreateNicSwitch(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0xEu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
    v7 = *(_QWORD *)a1;
  }
  if ( v7 )
  {
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0xFu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
}
