/*
 * XREFs of ndisOidPreIovEnumNicSwitches @ 0x1C0071140
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumNicSwitches(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_q(0x13u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, a1);
  *(_DWORD *)(*(_QWORD *)(a1 + 32) + 52LL) = 0;
  ...
  if ( v1 )
  {
    ...
    {
      v4 = *(_QWORD *)(v1 + 4648);
      if ( !v4 || !*(_QWORD *)(v1 + 3592) || (*(_BYTE *)(v4 + 8) & 3) != 3 )
      {
LABEL_4:
...
LABEL_19:
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qD(0x14u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v3;
}
