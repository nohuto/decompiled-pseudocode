/*
 * XREFs of ndisOidPostIovNicSwitchParameters @ 0x1C0070D30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovNicSwitchParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
  {
    WPP_SF_qq(
      0x1Bu,
      &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids,
      v3,
      v1,
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0x1Cu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
}
