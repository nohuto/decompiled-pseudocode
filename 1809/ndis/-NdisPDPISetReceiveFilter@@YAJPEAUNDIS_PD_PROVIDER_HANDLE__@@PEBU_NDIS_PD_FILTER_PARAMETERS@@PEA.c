/*
 * XREFs of ?NdisPDPISetReceiveFilter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_FILTER_PARAMETERS@@PEAPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C0100530
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v13 <= 0xFFFFFFFF )
        {
          ...
          if ( (unsigned int)v13 <= HeaderGroupMatchArrayTotalSize )
          {
            ...
            *((_QWORD *)v4 + 12) = a2->RxFilterContext;
            v25.m_Lock = (KPushLockBase *)qword_1C00A07C8;
...
LABEL_44:
  ...
  {
    LODWORD(v24) = v8;
    WPP_SF_qqd(0x31u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, a1, *a3, v24);
  }
