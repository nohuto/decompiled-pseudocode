/*
 * XREFs of ndisOidPreIovDeleteVPort @ 0x1C00F9C80
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovDeleteVPort(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0x33u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v1);
  v4 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
    goto LABEL_19;
  *(_DWORD *)(a1 + 40) = 0;
  ...
  if ( (ndisIovNicSwitchWithoutIovSupported(v3)
     || (v5 = *(_QWORD *)(v3 + 4648)) != 0 && *(_QWORD *)(v3 + 3592) && (*(_BYTE *)(v5 + 8) & 3) == 3)
...
LABEL_20:
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x34u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v3, v4, v11);
  }
  return v4;
}
