/*
 * XREFs of ndisOidPrePMProtocolOffloadList @ 0x1C00E6C30
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMProtocolOffloadList(__int64 *a1)
{
  ...
  {
    WPP_SF_qqq(0x69u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, v1, v3, v5);
    v8 = a1[3];
  }
  if ( v8
...
LABEL_32:
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqqL(0x6Au, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, v1, v3, v5, *((_DWORD *)a1 + 10));
  return v2;
}
