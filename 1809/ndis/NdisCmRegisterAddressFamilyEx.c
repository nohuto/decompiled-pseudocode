/*
 * XREFs of NdisCmRegisterAddressFamilyEx @ 0x1C0053340
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisCmRegisterAddressFamilyEx(NDIS_HANDLE NdisBindingHandle, PCO_ADDRESS_FAMILY AddressFamily)
{
  ...
  if ( (unsigned __int8)byte_1C00A0262 >= 4u )
    WPP_SF_qqq(0x40u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids, v3, v5, NdisBindingHandle);
  ndisReferencePackage(&ndisPkgs);
  v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v3 + 96));
  *(_QWORD *)(v3 + 520) = KeGetCurrentThread();
  v7 = v6;
  v15 = v6;
  *(_DWORD *)(v3 + 1864) = 1578762;
...
LABEL_26:
  ...
  *(_DWORD *)(v3 + 1864) = 0;
  ...
  if ( (unsigned __int8)byte_1C00A0262 >= 4u )
    WPP_SF_qqqL(0x41u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids, v3, v5, NdisBindingHandle, v8);
  return v8;
}
