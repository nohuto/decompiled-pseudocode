/*
 * XREFs of ?ndisNsiChangeInterfaceInfo@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_NSI_INTERFACE_INFORMATION_RW@@KKPEAK@Z @ 0x1C0022AB8
 * Callers:
        ...
        _IF_COUNTED_STRING_LH *a5)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qq(113LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a2);
  ifL2NetworkInfo = a5;
  v11 = 0;
  v12 = v6;
  v13 = a4;
...
LABEL_14:
  ...
  *(_DWORD *)&ifL2NetworkInfo->Length = v16;
  if ( !v16 )
    v9 = -1073741811;
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qqd(114LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a2, v9);
  return v9;
}
