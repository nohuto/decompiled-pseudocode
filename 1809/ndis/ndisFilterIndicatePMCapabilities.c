/*
 * XREFs of ndisFilterIndicatePMCapabilities @ 0x1C004A1D4
 * Callers:
 ...
 *     ndisUpdatePMCurrentParameters @ 0x1C004BBD0 (ndisUpdatePMCurrentParameters.c)
 */
...
__int64 __fastcall ndisFilterIndicatePMCapabilities(__int64 a1, __int64 a2)
{
  ...
  if ( v4 >= 0x34 )
  {
    ...
    if ( v4 >= v6 )
    {
      ...
      return ndisUpdatePMCurrentParameters(v11, a1 + 744);
    }
  }
  return result;
}
