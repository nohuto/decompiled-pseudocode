/*
 * XREFs of ndisOidTranslateBetweenOids @ 0x1C000E564
 * Callers:
...
__int64 __fastcall ndisOidTranslateBetweenOids(_BYTE *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_q(256LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, a3);
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    return WPP_SF_q(257LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, a3);
  return result;
}
