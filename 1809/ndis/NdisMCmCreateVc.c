/*
 * XREFs of NdisMCmCreateVc @ 0x1C011DA10
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisVcHandle)
{
  ...
  *NdisVcHandle = 0LL;
  ...
  v13 = *((_QWORD *)MiniportAdapterHandle + 474);
  ...
  v12[13].Blink = *(_LIST_ENTRY **)(*((_QWORD *)MiniportAdapterHandle + 474) + 512LL);
  v12[14].Flink = *(_LIST_ENTRY **)(*((_QWORD *)MiniportAdapterHandle + 474) + 520LL);
  v12[14].Blink = *(_LIST_ENTRY **)(*((_QWORD *)MiniportAdapterHandle + 474) + 528LL);
