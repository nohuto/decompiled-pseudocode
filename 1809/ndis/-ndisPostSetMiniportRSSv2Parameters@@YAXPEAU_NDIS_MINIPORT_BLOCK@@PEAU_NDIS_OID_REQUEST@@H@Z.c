/*
 * XREFs of ?ndisPostSetMiniportRSSv2Parameters@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@H@Z @ 0x1C0080340
 * Callers:
        ...
        int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqd(0x26u, &WPP_3f6e3b5cccdc3bc25dcf36d3a561497f_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
  ...
  {
    LODWORD(v9) = a3;
    WPP_SF_qqd(0x27u, &WPP_3f6e3b5cccdc3bc25dcf36d3a561497f_Traceguids, a1, a2, v9);
  }
}
