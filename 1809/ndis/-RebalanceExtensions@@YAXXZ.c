/*
 * XREFs of ?RebalanceExtensions@@YAXXZ @ 0x1C00D1A74
 * Callers:
...
void RebalanceExtensions(void)
{
  ...
  dword_1C00A0860 &= 0xFFFFFFF0;
  v9.m_State = Unlocked;
  dword_1C00A0864 = RecommendedSharedDataAlignment;
  v9.m_Lock = (KPushLockBase *)&unk_1C00A1EB8;
  KLockHolder::AcquireExclusive(&v9);
  v2 = (char *)qword_1C00A2050;
  v3 = &qword_1C00A2050;
  if ( qword_1C00A2050 )
  {
    do
  ...
  while ( 1 )
  {
    ...
    v8 = -*((_DWORD *)v5 + 5) & (*((_DWORD *)v5 + 5) + v1 - 1);
    *((_QWORD *)v5 + 3) = v8;
    v1 = v8 + *((_DWORD *)v5 + 2);
  }
LABEL_7:
