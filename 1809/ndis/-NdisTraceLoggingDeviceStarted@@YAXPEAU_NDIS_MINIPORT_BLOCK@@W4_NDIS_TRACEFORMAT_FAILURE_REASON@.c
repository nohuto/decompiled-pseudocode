/*
 * XREFs of ?NdisTraceLoggingDeviceStarted@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@J@Z @ 0x1C001CEF0
 * Callers:
...
void __fastcall NdisTraceLoggingDeviceStarted(__int64 a1, int a2, int a3)
{
  ...
  if ( a3 < 0 )
  {
    if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v29 = 4;
      v32 = 16;
      TlgWrite(&hProvider, &unk_1C008CD4D, v18, v19, (UINT32)v19, &pData);
    }
  }
...
LABEL_8:
    ...
    v32 = v6;
    v35 = 16;
    TlgWrite(&hProvider, &unk_1C008D47C, cData, (LPCGUID)v4, (UINT32)cData, &pData);
  }
}
