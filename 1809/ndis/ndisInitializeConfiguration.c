/*
 * XREFs of ndisInitializeConfiguration @ 0x1C00C598C
 * Callers:
...
__int64 __fastcall ndisInitializeConfiguration(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)&v40.Length = 2752552;
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0xAu, &WPP_b87f241b44683114d5775ca3de93698d_Traceguids, a2);
...
LABEL_69:
    if ( IntegerData == 1 )
    {
      v26 = IoGetDeviceProperty(*(PDEVICE_OBJECT *)(a2 + 3864), DevicePropertyLegacyBusType, 4u, &v29, &ResultLength);
      IntegerData = v29;
      DeviceProperty = v26;
    }
    goto LABEL_17;
...
LABEL_17:
  ...
  {
    *(_DWORD *)(a2 + 3744) = IntegerData;
    NdisReadConfiguration(&Status, &ParameterValue, ConfigurationHandle, &Keyword, NdisParameterInteger);
    if ( Status || (*(_DWORD *)(a2 + 120) & 0x80) != 0 )
    {
      if ( (*(_DWORD *)(a2 + 124) & 0x200000) != 0 )
      {
        *(_DWORD *)(a2 + 3896) = ndisDefaultPnPCapabilities;
        *(_DWORD *)(a2 + 3896) |= 0x10000000u;
      }
    }
    else
    {
      *(_DWORD *)(a2 + 3896) = ParameterValue->ParameterData.IntegerData;
    }
    if ( IoGetDeviceProperty(*(PDEVICE_OBJECT *)(a2 + 3864), DevicePropertyBusNumber, 4u, &v31, &ResultLength) >= 0
...
LABEL_41:
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_q(0xBu, &WPP_b87f241b44683114d5775ca3de93698d_Traceguids, a2);
  return v11;
}
