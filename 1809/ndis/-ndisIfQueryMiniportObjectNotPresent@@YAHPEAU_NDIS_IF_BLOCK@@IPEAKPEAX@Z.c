/*
 * XREFs of ?ndisIfQueryMiniportObjectNotPresent@@YAHPEAU_NDIS_IF_BLOCK@@IPEAKPEAX@Z @ 0x1C00B5FB0
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_LqL(0x30u, a2, a2, (__int64)a4);
  if ( v6 <= 0x10285 )
  {
    switch ( v6 )
    {
...
LABEL_9:
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_LqL(0x31u, a2, v6, (__int64)a4);
  return 0LL;
}
