/*
 * XREFs of ethDeleteOneOpenMulticastAddress @ 0x1C00F3D7C
 * Callers:
...
__int64 __fastcall ethDeleteOneOpenMulticastAddress(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_q(0xBu, &WPP_dea268cb493f372f092bdd50109326f3_Traceguids, a1);
...
LABEL_8:
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_dd(0xCu, &WPP_dea268cb493f372f092bdd50109326f3_Traceguids, (unsigned __int8)*a3, 0);
  return 0LL;
}
