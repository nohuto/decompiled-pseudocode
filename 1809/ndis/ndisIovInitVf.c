/*
 * XREFs of ndisIovInitVf @ 0x1C00F9080
 * Callers:
...
__int64 __fastcall ndisIovInitVf(__int64 a1)
{
  ...
  v2 = 0;
  Irp = IoAllocateIrp(*(_BYTE *)(*(_QWORD *)(a1 + 3872) + 76LL) + 1, 0);
  if ( Irp )
  {
    KeInitializeEvent((PRKEVENT)(a1 + 4688), NotificationEvent, 0);
    *(_QWORD *)(a1 + 4672) = Irp;
    CurrentStackLocation = Irp->Tail.Overlay.CurrentStackLocation;
    CurrentStackLocation[-1].MajorFunction = 15;
    CurrentStackLocation[-1].DeviceObject = *(_DEVICE_OBJECT **)(a1 + 3872);
    CurrentStackLocation[-1].Parameters.Read.ByteOffset.LowPart = 2801671;
    CurrentStackLocation[-1].Parameters.Read.Length = 8;
    Irp->UserBuffer = (void *)(a1 + 4680);
    ...
    v5[-1].Control = -32;
    if ( IofCallDriver(*(PDEVICE_OBJECT *)(a1 + 3872), Irp) != 259 )
      KeSetEvent((PRKEVENT)(a1 + 4688), 0, 0);
  }
  else
  {
