/*
 * XREFs of ndisReferenceProtocolByName @ 0x1C01179F0
 * Callers:
...
__int64 __fastcall ndisReferenceProtocolByName(PCUNICODE_STRING SourceString, __int64 *a2, char a3, unsigned __int8 a4)
{
  ...
  if ( (unsigned __int8)byte_1C00A0254 >= 4u )
    WPP_SF_Z(0x23u, &WPP_5a25d62004233057cf64a29056d8f8be_Traceguids, &SourceString->Length);
...
LABEL_24:
  if ( (unsigned __int8)byte_1C00A0254 >= 4u )
    WPP_SF_qD(0x24u, &WPP_5a25d62004233057cf64a29056d8f8be_Traceguids, *a2, v8);
  return v8;
}
