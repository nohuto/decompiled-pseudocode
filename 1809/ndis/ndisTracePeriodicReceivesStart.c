/*
 * XREFs of ndisTracePeriodicReceivesStart @ 0x1C0051188
 * Callers:
...
NTSTATUS __fastcall ndisTracePeriodicReceivesStart(__int64 a1)
{
  ...
  *(GUID *)&WnodeEventItem[3] = EtwGuidNdisReceive;
  ...
  if ( (byte_1C00A2085 & 2) != 0 )
    return McTemplateK0q(v4, &QueuedReceiveStart, (const GUID *)(a1 + 4040), (*(_QWORD *)(a1 + 4056) >> 24) & 0xFFFFFF);
  return result;
}
