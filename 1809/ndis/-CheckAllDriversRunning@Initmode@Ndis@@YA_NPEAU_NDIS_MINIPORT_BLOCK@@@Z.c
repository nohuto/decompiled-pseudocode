/*
 * XREFs of ?CheckAllDriversRunning@Initmode@Ndis@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00BE4E8
 * Callers:
...
LABEL_16:
      __fastfail(5u);
    v4 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 633) + 8 * i) + 80LL);
    if ( (*(_DWORD *)(v4 + 40) & 0x10) == 0 && !*(_QWORD *)(v4 + 56) )
      return 0;
  }
  v5 = *((unsigned int *)this + 1261);
  for ( j = 0LL; j != v5; ++j )
  {
    if ( j >= v5 )
      goto LABEL_16;
    v7 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 631) + 8 * j) + 80LL);
