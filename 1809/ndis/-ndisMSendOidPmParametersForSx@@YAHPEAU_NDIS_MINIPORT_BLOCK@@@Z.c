/*
 * XREFs of ?ndisMSendOidPmParametersForSx@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0069364
 * Callers:
...
__int64 __fastcall ndisMSendOidPmParametersForSx(char *MiniportAdapterHandle)
{
  int v1; // eax
  int v3; // edi
  __m128i v4; // xmm0
