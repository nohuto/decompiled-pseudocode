/*
 * XREFs of ndisMDeferredSendPackets @ 0x1C00566E0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSendPackets(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  {
    WPP_SF_q(0x16u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, (__int64)a1);
    MaxSendPackets = v29;
  }
...
LABEL_5:
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_q(0x17u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, (__int64)a1);
  return 0;
}
