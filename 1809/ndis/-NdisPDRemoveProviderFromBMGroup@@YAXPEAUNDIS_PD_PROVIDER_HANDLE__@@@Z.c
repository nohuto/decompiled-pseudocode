/*
 * XREFs of ?NdisPDRemoveProviderFromBMGroup@@YAXPEAUNDIS_PD_PROVIDER_HANDLE__@@@Z @ 0x1C0100880
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDRemoveProviderFromBMGroup(ULONG_PTR BugCheckParameter4)
{
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_q(0x4Bu, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, BugCheckParameter4);
  v6.m_State = Unlocked;
  ...
  *v3 = 0LL;
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_q(0x4Cu, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, BugCheckParameter4);
