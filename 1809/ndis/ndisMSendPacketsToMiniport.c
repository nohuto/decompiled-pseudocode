/*
 * XREFs of ndisMSendPacketsToMiniport @ 0x1C00588B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsToMiniport(struct _NDIS_MINIPORT_BLOCK *a1, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_qqd(0xCu, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, a2, a3);
  v18 = 0;
...
LABEL_27:
  ...
  {
    LODWORD(v17) = a3;
    WPP_SF_qqd(0xDu, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, a2, v17);
  }
}
