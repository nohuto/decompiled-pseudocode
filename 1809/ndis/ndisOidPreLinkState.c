/*
 * XREFs of ndisOidPreLinkState @ 0x1C00CFAC0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreLinkState(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0xBEu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v1, v4);
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0xBFu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v1, 1, v11);
  }
  return 1;
}
