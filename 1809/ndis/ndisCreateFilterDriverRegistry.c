/*
 * XREFs of ndisCreateFilterDriverRegistry @ 0x1C00CE414
 * Callers:
...
__int64 __fastcall ndisCreateFilterDriverRegistry(PCUNICODE_STRING Source, unsigned __int8 a2)
{
  ...
  *(_DWORD *)&DestinationString.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x51u, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, (__int64)Source);
  ...
  v7 = RegistryValues;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_dd(0x52u, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, RegistryValues, a2);
  if ( !v7 )
    goto LABEL_8;
  if ( v7 != -1073741772 )
  {
...
LABEL_10:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x53u, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, (__int64)Source, v3);
  return v3;
}
