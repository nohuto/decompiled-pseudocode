/*
 * XREFs of ndisOidPrePortState @ 0x1C00475A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePortState(__int64 a1)
{
  ...
  {
    WPP_SF_qD(0xD1u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v1, *(_DWORD *)(v3 + 8));
    v5 = *(_QWORD *)a1;
  }
  if ( v5 )
  {
      ...
      *(_DWORD *)(v1 + 1864) = 2307659;
      ...
      else
      {
        ...
        *((_QWORD *)v8 + 2) = *(_QWORD *)(v1 + 800);
        v8[6] = *(_DWORD *)(*(_QWORD *)(v1 + 4072) + 532LL);
        v8[7] = *(_DWORD *)(v1 + 3344);
        v8[8] = *(_DWORD *)(v1 + 3348);
        v8[9] = *(_DWORD *)(v1 + 3352);
        v9 = *(_DWORD *)(v1 + 3356);
...
LABEL_17:
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qD(0xD2u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v1, *(_DWORD *)(v3 + 8));
  return v4;
}
