...
void __stdcall NdisCancelDirectOidRequest(NDIS_HANDLE NdisBindingHandle, PVOID RequestId)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0xCDu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, NdisBindingHandle, RequestId);
  v7 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v2 + 96));
  *(_QWORD *)(v2 + 520) = KeGetCurrentThread();
  v8 = *(_QWORD *)(v2 + 2672);
  *(_DWORD *)(v2 + 1864) = 2307382;
  if ( *(_BYTE *)v8 == 5 )
  {
    v3 = v8;
  ...
  *(_DWORD *)(v2 + 1864) = 0;
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0xCEu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, NdisBindingHandle, RequestId);
}
