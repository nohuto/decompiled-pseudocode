/*
 * XREFs of NdisMRegisterInterruptEx @ 0x1C010F280
 * Callers:
 *     <none>
 * Callees:
 *     ?GetMsgDpc@@YAPEAU_KDPC@@PEAU_NDIS_INTERRUPT_BLOCK@@KK@Z @ 0x1C0009328 (-GetMsgDpc@@YAPEAU_KDPC@@PEAU_NDIS_INTERRUPT_BLOCK@@KK@Z.c)
        ...
        PNDIS_HANDLE NdisInterruptHandle)
{
  ...
  $4E5DFBA7BF8E698BAC994589913A218D *v33; // r15
  NTSTATUS v34; // eax
  _DWORD *Generic; // r15
  ...
  v10 = *((unsigned int *)MiniportAdapterHandle + 859);
  ...
  *NdisInterruptHandle = 0LL;
  ...
  else
  {
    ...
    *((_DWORD *)MiniportAdapterHandle + 466) = 0;
    ...
    _InterlockedAdd((volatile signed __int32 *)MiniportAdapterHandle + 478, 1u);
    ...
    *(_WORD *)&v7->SharedInterrupt = 257;
    ...
    v23 = v48 + v18;
    v7->MsgDpc = v22;
    if ( *((_DWORD *)MiniportAdapterHandle + 859) )
    {
      do
      {
      ...
      while ( v17 < *((_DWORD *)MiniportAdapterHandle + 859) );
    }
...
LABEL_35:
      ...
      if ( PoolWithTag )
      {
        ...
        *((_QWORD *)v38 + 6) = *((_QWORD *)Generic + 6);
        ...
        if ( v36 > 1 )
        {
          *((_BYTE *)MiniportAdapterHandle + 2000) = 1;
          if ( *((_WORD *)MiniportAdapterHandle + 1355) )
          {
            *((_DWORD *)MiniportAdapterHandle + 678) |= 0x8000000u;
            *((_DWORD *)MiniportAdapterHandle + 781) |= 0x8000000u;
          }
        }
        goto LABEL_35;
      }
  ...
  *((_DWORD *)MiniportAdapterHandle + 466) = 657287;
  while ( 1 )
  {
    v46 = *p_NextInterrupt;
    if ( !*p_NextInterrupt )
