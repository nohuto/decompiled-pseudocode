/*
 * XREFs of ndisPnPQuerySriovInterface @ 0x1C00FB1C0
 * Callers:
...
__int64 __fastcall ndisPnPQuerySriovInterface(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_q(0x57u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, a1);
  v5 = *(_QWORD *)(a2 + 184);
  if ( *(_WORD *)(v5 + 16) >= 0x78u && *(_WORD *)(v5 + 18) == 1 )
  {
    if ( ndisSystemSupportsSriov && (v6 = *(_QWORD *)(a1 + 4648)) != 0 && (*(_BYTE *)(v6 + 8) & 3) == 3 )
    {
      v7 = *(_QWORD **)(v5 + 24);
      memset(v7, 0, 0x78uLL);
      *(_DWORD *)v7 = 65656;
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qD(0x58u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, a1, v4);
  return v4;
}
