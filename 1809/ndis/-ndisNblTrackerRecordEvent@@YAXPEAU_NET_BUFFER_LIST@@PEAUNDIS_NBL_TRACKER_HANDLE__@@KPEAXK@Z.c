/*
 * XREFs of ?ndisNblTrackerRecordEvent@@YAXPEAU_NET_BUFFER_LIST@@PEAUNDIS_NBL_TRACKER_HANDLE__@@KPEAXK@Z @ 0x1C006B2B4
 * Callers:
 ...
 *     NdisNblTrackerRecordEvent @ 0x1C006BA40 (NdisNblTrackerRecordEvent.c)
 * Callees:
