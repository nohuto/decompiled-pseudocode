/*
 * XREFs of ndisCreateFilterAdapterRegistry @ 0x1C00CFF90
 * Callers:
...
__int64 __fastcall ndisCreateFilterAdapterRegistry(PCUNICODE_STRING Source, __int64 a2)
{
  ...
  *(_DWORD *)&Destination.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x54u, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, Source, a2);
  v5 = *(_QWORD *)(a2 + 16);
  if ( v5 )
  {
    if ( !RtlStringFromGUID((const GUID *const)(v5 + 4040), &GuidString) )
    {
...
LABEL_11:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    ...
    WPP_SF_qqd(0x55u, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, Source, a2, Environment);
  }
  return v2;
}
