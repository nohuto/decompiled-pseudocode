/*
 * XREFs of ndisAddWoLDirectedMAC @ 0x1C00E62FC
 * Callers:
...
__int64 __fastcall ndisAddWoLDirectedMAC(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A025D >= 4u )
    WPP_SF_q(0x91u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, a1);
    ...
    *(_DWORD *)&v10[48] = 268;
    ...
    if ( v7 )
    {
      if ( (unsigned __int8)byte_1C00A025D >= 2u )
        WPP_SF_D(0x93u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, v7);
    }
    else
    {
      *(_BYTE *)(v3 + 1096) = 1;
    ...
    if ( (unsigned __int8)byte_1C00A025D >= 4u )
      WPP_SF_qD(0x94u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, a1, v7);
    return v7;
  }
  else
  {
    if ( (unsigned __int8)byte_1C00A025D >= 3u )
      WPP_SF_qD(0x92u, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, a1, 0);
    return 0LL;
  }
}
