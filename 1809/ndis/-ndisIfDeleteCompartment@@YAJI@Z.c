/*
 * XREFs of ?ndisIfDeleteCompartment@@YAJI@Z @ 0x1C003EB04
 * Callers:
...
__int64 __fastcall ndisIfDeleteCompartment(unsigned int a1)
{
  ...
  PVOID v22; // rcx
  void **v23; // rax
  _QWORD v25[10]; // [rsp+38h] [rbp-D0h] BYREF
  struct _KEVENT Event; // [rsp+88h] [rbp-80h] BYREF
  _DWORD v27[132]; // [rsp+A8h] [rbp-60h] BYREF

  v1 = 0;
  v3 = 0;
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_D(151LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1);
...
LABEL_19:
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_dd(152LL, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, Flink_low);
  v1 = -1073740024;
LABEL_20:
