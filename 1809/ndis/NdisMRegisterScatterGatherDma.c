/*
 * XREFs of NdisMRegisterScatterGatherDma @ 0x1C00CF2D0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisMiniportDmaHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x10u, &WPP_b7380f6131c0382fffce9713ea39f3ba_Traceguids, MiniportAdapterHandle, DmaDescription);
  *NdisMiniportDmaHandle = 0LL;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x11u, &WPP_b7380f6131c0382fffce9713ea39f3ba_Traceguids, (__int64)MiniportAdapterHandle, v7);
  return v7;
}
