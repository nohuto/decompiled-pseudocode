/*
 * XREFs of NdisRegisterDeviceEx @ 0x1C0024440
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisDeviceHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(107LL, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, NdisHandle);
  *pDeviceObject = 0LL;
  ...
  else
  {
    switch ( v10 )
    {
      case 4:
        ...
        break;
      case 17:
        DriverObjectExtension = (char *)*((_QWORD *)NdisHandle + 474);
...
LABEL_32:
  ...
  v35 = (DeviceObjectAttributes->ExtensionSize + 1) & 0xFFFFFFFE;
  v13 = DeviceObjectAttributes->DeviceName->Length + 324 + v35 + DeviceObjectAttributes->SymbolicName->Length;
  DeviceName = DeviceObjectAttributes->DeviceName;
  v15 = DeviceName->Length + 324 + v35 + DeviceObjectAttributes->SymbolicName->Length;
...
LABEL_17:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(108LL, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, NdisHandle, (unsigned int)SymbolicLink);
  return SymbolicLink;
}
