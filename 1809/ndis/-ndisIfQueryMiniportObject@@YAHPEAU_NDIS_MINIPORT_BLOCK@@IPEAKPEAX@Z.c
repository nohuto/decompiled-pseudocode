/*
 * XREFs of ?ndisIfQueryMiniportObject@@YAHPEAU_NDIS_MINIPORT_BLOCK@@IPEAKPEAX@Z @ 0x1C00CCF04
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_LqL(0x34u, v10, a2, (__int64)a4);
  memset(&v22, 0, 0xF8uLL);
  IfBlock = a1->IfBlock;
...
LABEL_18:
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_LqL(0x35u, v12, a2, (__int64)a4);
  return v9;
}
