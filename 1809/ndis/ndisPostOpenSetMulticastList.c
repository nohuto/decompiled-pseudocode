/*
 * XREFs of ndisPostOpenSetMulticastList @ 0x1C0015D9C
 * Callers:
...
void __fastcall ndisPostOpenSetMulticastList(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqqL(128LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, a1, a2, a3);
  v8 = 0;
  if ( *(_DWORD *)(a2 + 160) )
  {
  ...
  *(_DWORD *)(a2 + 52) = v8;
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqqL(129LL, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, a1, a2, a3);
}
