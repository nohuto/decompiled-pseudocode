/*
 * XREFs of NdisFRegisterFilterDriver @ 0x1C00220A0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisFilterDriverHandle)
{
  ...
  NDIS_BIND_FILTER_DRIVER *v30; // rbx
  NDIS_BIND_FILTER_DRIVER *v31; // rcx
  _QWORD *v32; // rbx
  KIRQL v33; // al
  int v34; // r8d
  enum CallRunMode v35; // r8d
    ...
    if ( v13 == (OidRequestHandler == 0LL) )
    {
      if ( !OidRequestHandler && FilterDriverCharacteristics->CancelOidRequestHandler )
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
          WPP_SF_q(13LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, DriverObject);
      ...
      if ( MajorNdisVersion > 6u || MajorNdisVersion == 6 && FilterDriverCharacteristics->MinorNdisVersion )
      {
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(14LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, DriverObject);
          FilterDriverRegistry = -1073676283;
          if ( (byte_1C00A2082 & 4) != 0 )
            McTemplateK0zq(
              v13,
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(15LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, DriverObject);
          FilterDriverRegistry = -1073676283;
          if ( (byte_1C00A2082 & 4) != 0 )
            McTemplateK0zq(
              v13,
      ...
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
          WPP_SF_q(16LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, DriverObject);
        FilterDriverRegistry = -1073676283;
        if ( (byte_1C00A2082 & 4) != 0 )
          McTemplateK0zq(
            v13,
      ...
      else
      {
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_D(17LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, v16);
        ...
        else
        {
          ...
          if ( v19 <= 0xFFFF )
          {
            ...
            *(_WORD *)&v4->Header.Type = 260;
            ...
            v4->DefaultFilterCharacteristics.ServiceName.Buffer = (wchar_t *)(v27
            ...
            else
            {
              ...
              if ( p_Bind != FilterDriver )
              {
                ...
                *FilterDriver = 0LL;
                v31 = *p_Bind;
                if ( *p_Bind && !_InterlockedDecrement((volatile signed __int32 *)&v31[1].DriverReady) && v31 )
                  KRef<NDIS_BIND_FILTER_DRIVER>::KRefHolder::`scalar deleting destructor'(v31);
                *p_Bind = v30;
              }
              v32 = P;
              if ( P && !_InterlockedDecrement((volatile signed __int32 *)P + 16) && v32 )
              {
                v38 = (void *)v32[6];
                if ( v38 )
                  ExFreePoolWithTag(v38, 0x7274534Bu);
                v39 = v32[1];
                if ( *(_QWORD **)(v39 + 8) != v32 + 1 || (v40 = (_QWORD *)v32[2], (_QWORD *)*v40 != v32 + 1) )
                  __fastfail(3u);
                *v40 = v39;
                *(_QWORD *)(v39 + 8) = v40;
                ExFreePoolWithTag(v32, 0x446C4642u);
              }
              if ( *p_Bind )
              {
                *NdisFilterDriverHandle = v4;
                if ( !FilterDriverCharacteristics->SetOptionsHandler
                  || (v37 = ndisFInvokeSetOptions(v4), (FilterDriverRegistry = v37) == 0) )
                {
                  ...
                  NDIS_BIND_FILTER_DRIVER::SetRunningDriver(*p_Bind, v4, v35);
                  goto LABEL_36;
                }
                if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
                  WPP_SF_D(21LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, v37);
...
LABEL_97:
              ...
              if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
                WPP_SF__guid_(20LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, &Guid);
            }
...
LABEL_98:
          ...
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(18LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, DriverObject);
          FilterDriverRegistry = -1073741811;
          if ( (byte_1C00A2082 & 4) != 0 )
            McTemplateK0zq(
              v18,
    ...
    {
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
        WPP_SF_q(12LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, DriverObject);
      FilterDriverRegistry = -1073676283;
      if ( (byte_1C00A2082 & 4) != 0 )
        McTemplateK0zq(
          v13,
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_q(11LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, DriverObject);
    FilterDriverRegistry = -1073676283;
    if ( (byte_1C00A2082 & 4) != 0 )
    {
      McTemplateK0zq(
...
LABEL_36:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_D(22LL, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, FilterDriverRegistry);
