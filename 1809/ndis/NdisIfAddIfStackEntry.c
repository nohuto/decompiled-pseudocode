/*
 * XREFs of NdisIfAddIfStackEntry @ 0x1C0022C40
 * Callers:
 ...
 *     ?ndisIfStackTablePathExist@@YAEKKG@Z @ 0x1C0022E1C (-ndisIfStackTablePathExist@@YAEKKG@Z.c)
...
NDIS_STATUS __stdcall NdisIfAddIfStackEntry(NET_IFINDEX HigherLayerIfIndex, NET_IFINDEX LowerLayerIfIndex)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_dL(44LL, LowerLayerIfIndex, HigherLayerIfIndex, LowerLayerIfIndex);
...
LABEL_12:
  ...
  if ( v11 )
    ExFreePoolWithTag(v5, 0);
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_llL(v13, v12, (unsigned int)v3, (unsigned int)v2, v11);
  return v11;
}
