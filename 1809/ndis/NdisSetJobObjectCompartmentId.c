/*
 * XREFs of NdisSetJobObjectCompartmentId @ 0x1C00F8008
 * Callers:
 *     ndisNsiSetAllJobInformation @ 0x1C00F8270 (ndisNsiSetAllJobInformation.c)
 * Callees:
 ...
 *     ndisIfSetCompartmentJobObject @ 0x1C0042AEC (ndisIfSetCompartmentJobObject.c)
