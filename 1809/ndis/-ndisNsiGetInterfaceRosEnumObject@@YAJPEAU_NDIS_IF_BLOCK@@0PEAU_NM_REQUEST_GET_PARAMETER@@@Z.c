/*
 * XREFs of ?ndisNsiGetInterfaceRosEnumObject@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00B7E90
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  struct _NDIS_IF_BLOCK *v21; // [rsp+78h] [rbp+10h]
  ...
  {
    WPP_SF_qq(0x52u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, a1, a3);
    a2 = v21;
  }
  v6 = (char *)*((_QWORD *)v4 + 5);
  v7 = *((_DWORD *)v4 + 13);
        ...
        if ( v7 > 0x214 )
        {
          switch ( v7 )
          {
            ...
            case 0x230u:
              ...
              v10 = 4;
              v16 = ndisIfReferenceMiniport((__int64)a1, 0x18u);
              v17 = v16;
              if ( v16 )
              {
                _m_prefetchw((const void *)(v16 + 4464));
                v18 = *(_DWORD *)(v16 + 4464);
                do
                {
                  v19 = v18;
                  v18 = _InterlockedCompareExchange((volatile signed __int32 *)(v17 + 4464), v18, v18);
                }
                while ( v19 != v18 );
                if ( (v18 & 0x100) != 0 )
...
LABEL_26:
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qqd(0x53u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, v5, v4, v3);
  return v3;
}
