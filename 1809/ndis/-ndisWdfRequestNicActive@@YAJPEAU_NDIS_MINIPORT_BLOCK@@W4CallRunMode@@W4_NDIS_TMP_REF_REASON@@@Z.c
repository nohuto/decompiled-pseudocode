/*
 * XREFs of ?ndisWdfRequestNicActive@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4CallRunMode@@W4_NDIS_TMP_REF_REASON@@@Z @ 0x1C0079894
 * Callers:
  ...
  if ( (unsigned int)(ActiveState - 1) > 1 )
  {
    if ( ActiveState == NdisNicError )
    {
      if ( (unsigned __int8)byte_1C00A025D >= 2u )
        WPP_SF_q(0x10u, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, (__int64)MiniportAdapterHandle);
...
LABEL_7:
  ...
  else
  {
    if ( (unsigned __int8)byte_1C00A025E >= 2u )
      WPP_SF_qD(0xFu, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, (__int64)MiniportAdapterHandle, v14);
    v15 = -1073741823;
  }
