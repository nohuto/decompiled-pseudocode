/*
 * XREFs of ?RetryProtocolBindingsAfterMiniportChange@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00C222C
 * Callers:
...
LABEL_27:
      ...
      else
      {
        if ( (unsigned __int8)byte_1C00A026B >= 5u )
          WPP_SF_dd(0xEu, &WPP_a000b6aa13863dc28771f74e17683f6b_Traceguids, v7, v7 & 0xFFFBFFE3);
      ...
      if ( v8 && (unsigned __int8)byte_1C00A026B >= 4u )
      {
        ...
        if ( (unsigned __int8)byte_1C00A026B >= 4u )
          WPP_SF_Zq(0x19u, &WPP_28ccc015ff3a36b32c91c02afee3c661_Traceguids, (const wchar_t *)v15[1], v15[0]);
      }
    }
    ...
    for ( j = 0LL; j != v9; ++j )
    {
      ...
      {
        if ( (unsigned __int8)byte_1C00A026B >= 5u )
          WPP_SF_dd(0xEu, &WPP_a000b6aa13863dc28771f74e17683f6b_Traceguids, v13, v13 & 0xFFFBFFE3);
