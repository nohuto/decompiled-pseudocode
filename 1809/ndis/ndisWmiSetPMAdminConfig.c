/*
 * XREFs of ndisWmiSetPMAdminConfig @ 0x1C00E8F6C
 * Callers:
 ...
 *     ndisIsValidPMAdminConfigState @ 0x1C00E6788 (ndisIsValidPMAdminConfigState.c)
...
int __fastcall ndisWmiSetPMAdminConfig(_DWORD *a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)a2 != 0x80 || *(_BYTE *)(a2 + 1) != 1 || *(_WORD *)(a2 + 2) != 28 )
    return -1073741811;
  result = ndisIsValidPMAdminConfigState(*(_DWORD *)(a2 + 4), a1[986] & 3);
  if ( !result )
  {
