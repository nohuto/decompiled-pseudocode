/*
 * XREFs of ?NdisTraceLoggingDeviceRemoved@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_TRACEFORMAT_REMOVAL_REASON@@@Z @ 0x1C007D640
 * Callers:
...
void NdisTraceLoggingDeviceRemoved()
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x400000000000uLL) )
    {
      ...
      v6 = 4;
      v9 = 16;
      TlgWrite(&hProvider, &unk_1C008D018, v0, v1, 4u, &pData);
    }
  }
}
