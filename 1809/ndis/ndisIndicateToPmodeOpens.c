/*
 * XREFs of ndisIndicateToPmodeOpens @ 0x1C00263D8
 * Callers:
      ...
      do
      {
        ...
        if ( v10 )
        {
          if ( *(_QWORD *)(a1 + 8 * v8 + 56) != v5 )
            ndisMIndicateNetBufferListsToOpen(v5, v10, (unsigned __int8 *)v2, *(_DWORD *)(a1 + 40 * v9 + 80), v3);
        }
      }
