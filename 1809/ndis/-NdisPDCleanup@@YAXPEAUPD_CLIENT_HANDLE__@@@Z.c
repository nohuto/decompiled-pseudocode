/*
 * XREFs of ?NdisPDCleanup@@YAXPEAUPD_CLIENT_HANDLE__@@@Z @ 0x1C00FECD0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDCleanup(PVOID **P)
{
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_q(0x15u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, (__int64)P);
  v5.m_State = Unlocked;
  v5.m_Lock = (KPushLockBase *)qword_1C00A07C8;
  ...
  *P = 0LL;
  ...
  if ( (unsigned __int8)byte_1C00A026C >= 4u )
    WPP_SF_q(0x16u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, (__int64)P);
}
