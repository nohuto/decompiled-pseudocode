/*
 * XREFs of McTemplateK0qqqqqqqq @ 0x1C006D30C
 * Callers:
...
ULONG __fastcall McTemplateK0qqqqqqqq(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite((PMCGEN_TRACE_CONTEXT)&NDIS_PROVIDER_ID_Context, &RstLimitChange, a3, 9u, &EventData);
}
