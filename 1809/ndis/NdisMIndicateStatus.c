/*
 * XREFs of NdisMIndicateStatus @ 0x1C0060B30
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT StatusBufferSize)
{
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_qD(0xBBu, &WPP_f453a6740ca1326a168191528118e90e_Traceguids, (__int64)MiniportHandle, GeneralStatus);
  ...
  v15[2] = *((_QWORD *)MiniportHandle + 347);
  v15[3] = *((_QWORD *)MiniportHandle + 348);
  ...
  if ( !*((_QWORD *)MiniportHandle + 3) )
  {
    ...
    *((_DWORD *)MiniportHandle + 466) = 733330;
...
LABEL_11:
  ...
  NewIrql[0] = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)MiniportHandle + 12);
  *((_QWORD *)MiniportHandle + 65) = KeGetCurrentThread();
  *((_DWORD *)MiniportHandle + 466) = 733404;
  if ( GeneralStatus == 1073807371 )
  {
...
LABEL_25:
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_qD(0xBCu, &WPP_f453a6740ca1326a168191528118e90e_Traceguids, (__int64)MiniportHandle, GeneralStatus);
}
