/*
 * XREFs of ndisLWM5IndicateReceive @ 0x1C006D5E0
 * Callers:
 *     EthIndicateReceive @ 0x1C006D290 (EthIndicateReceive.c)
 * Callees:
...
LABEL_34:
  ...
  *(_QWORD *)Packet->ProtocolReserved = Head;
  ...
  v17 = (*(__int64 (__fastcall **)(PNDIS_PACKET, int *, _QWORD, __int64, _DWORD, _DWORD))(*(_QWORD *)(v7 + 3792) + 216LL))(
          v25,
          &v31,
          *(_QWORD *)(v7 + 24),
          v35,
