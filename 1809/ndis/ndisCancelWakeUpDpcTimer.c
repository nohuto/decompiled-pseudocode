/*
 * XREFs of ndisCancelWakeUpDpcTimer @ 0x1C0010DB8
 * Callers:
...
NTSTATUS __fastcall ndisCancelWakeUpDpcTimer(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 520) = CurrentThread;
  v4 = v2;
  *(_DWORD *)(a1 + 1864) = 1442710;
  if ( KeCancelTimer((PKTIMER)(a1 + 216)) )
    KeSetEvent((PRKEVENT)(a1 + 1920), 0, 0);
  *(_QWORD *)(a1 + 520) = 0LL;
  *(_DWORD *)(a1 + 1864) = 0;
  KeReleaseSpinLock((PKSPIN_LOCK)(a1 + 96), v4);
  return KeWaitForSingleObject((PVOID)(a1 + 1920), Executive, 0, 0, 0LL);
}
