/*
 * XREFs of ?NdisPDPIAllocateQueue@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_QUEUE_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@@Z @ 0x1C00FFB10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0NDIS_PD_QUEUE_TRACKER@@QEAA@XZ @ 0x1C00FE160 (--0NDIS_PD_QUEUE_TRACKER@@QEAA@XZ.c)
...
LABEL_33:
  ...
  {
    LODWORD(v15) = v8;
    WPP_SF_qqd(0x23u, &WPP_ab90398e33e23eea2eee39389267d473_Traceguids, a1, *a3, v15);
  }
