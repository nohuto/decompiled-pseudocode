/*
 * XREFs of ndisBindRequest @ 0x1C0068DCC
 * Callers:
 ...
 *     ?ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z @ 0x1C01074C8 (-ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z.c)
 */
        ...
        ULONG_PTR BugCheckParameter3)
{
  ...
  switch ( *(_DWORD *)(BugCheckParameter3 + 8) )
  {
    case 0x12:
      ...
      v11 = 55;
LABEL_28:
      WPP_SF_Zq(v11, &WPP_75e565b92a953e07dcf27d4fb26abe24_Traceguids, v15, v14);
      break;
    case 0x13:
    ...
    case 0x15:
      ...
      v9 = 58;
LABEL_23:
      WPP_SF_Zq(v9, &WPP_75e565b92a953e07dcf27d4fb26abe24_Traceguids, v15, v14);
LABEL_24:
      v7 = RunSynchronous;
      break;
  }
