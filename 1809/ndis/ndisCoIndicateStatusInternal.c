/*
 * XREFs of ndisCoIndicateStatusInternal @ 0x1C011E468
 * Callers:
...
void __fastcall ndisCoIndicateStatusInternal(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A0262 >= 4u )
    WPP_SF_(0x37u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
  v9 = (const void **)(a2 + 296);
  if ( !a2 )
    v9 = *(const void ***)(a1 + 3888);
  if ( v9 )
...
LABEL_12:
  ...
  if ( (unsigned __int8)byte_1C00A0262 >= 4u )
    WPP_SF_(0x38u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
}
