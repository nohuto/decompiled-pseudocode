/*
 * XREFs of ?ndisWdfAcquirePowerReferenceHelper@@YAXPEAU_NDIS_MINIPORT_BLOCK@@EE@Z @ 0x1C0072CB0
 * Callers:
...
void __fastcall ndisWdfAcquirePowerReferenceHelper(struct _NDIS_MINIPORT_BLOCK *a1, char a2, char a3)
{
  ...
  v8 = v6;
  if ( v6 < 0 && (unsigned __int8)byte_1C00A025E >= 2u )
    WPP_SF_qD(0x20u, &WPP_0cf0eaabdf4f3c4b779dfb88bb6a846b_Traceguids, (__int64)a1, v6);
  if ( v8 != 259 && (a2 || a3) )
