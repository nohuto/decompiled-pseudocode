/*
 * XREFs of ndisPreTaskOffloadQuery @ 0x1C0047F64
 * Callers:
...
char __fastcall ndisPreTaskOffloadQuery(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qqDD(0xE3u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v8, a1, 1, *v7);
  if ( !*(_QWORD *)(v8 + 4128) )
  {
    *v7 = -1073741637;
    goto LABEL_17;
...
LABEL_17:
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
  {
    LODWORD(v15) = *v7;
    LODWORD(v14) = 1;
    WPP_SF_qqDD(0xE4u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v8, a1, v14, v15);
  }
  return 1;
}
