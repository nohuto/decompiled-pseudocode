/*
 * XREFs of ndisOidPostMediaState @ 0x1C0046BB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostMediaState(__int64 *a1)
{
  ...
  {
    WPP_SF_qq(0x53u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, v1);
    v4 = *a1;
  }
  v5 = 0;
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x54u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v3, v1);
}
