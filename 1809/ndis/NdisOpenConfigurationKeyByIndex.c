/*
 * XREFs of NdisOpenConfigurationKeyByIndex @ 0x1C00D1100
 * Callers:
        ...
        PNDIS_HANDLE KeyHandle)
{
  ...
  *(_QWORD *)&SubKeyName.Length = 0LL;
  ...
  if ( (unsigned __int8)byte_1C00A0257 >= 4u )
    WPP_SF_q(0x16u, &WPP_9d4cd70f7fc237db66c5630c937009d5_Traceguids, (__int64)ConfigurationHandle);
  v9 = KeyHandle;
  *KeyHandle = 0LL;
  ...
  if ( (unsigned __int8)byte_1C00A0257 >= 4u )
    WPP_SF_q(0x17u, &WPP_9d4cd70f7fc237db66c5630c937009d5_Traceguids, (__int64)ConfigurationHandle);
}
