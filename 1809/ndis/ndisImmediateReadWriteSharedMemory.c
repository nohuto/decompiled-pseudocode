/*
 * XREFs of ndisImmediateReadWriteSharedMemory @ 0x1C00EC090
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00EBA70 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00EBB20 (NdisImmediateWriteSharedMemory.c)
 * Callees:
