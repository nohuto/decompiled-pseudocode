/*
 * XREFs of NdisIMRegisterLayeredMiniport @ 0x1C00F1530
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE DriverHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xCu, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)NdisWrapperHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xDu, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)*DriverHandle, v8);
  return v8;
}
