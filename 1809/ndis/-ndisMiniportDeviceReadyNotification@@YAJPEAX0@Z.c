/*
 * XREFs of ?ndisMiniportDeviceReadyNotification@@YAJPEAX0@Z @ 0x1C00C8330
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisFindMiniportByPdo@@YAPEAU_NDIS_MINIPORT_BLOCK@@PEAU_DEVICE_OBJECT@@@Z @ 0x1C001CB50 (-ndisFindMiniportByPdo@@YAPEAU_NDIS_MINIPORT_BLOCK@@PEAU_DEVICE_OBJECT@@@Z.c)
        ...
        if ( MiniportByPdo )
        {
          ...
          else
          {
            if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
              WPP_SF_q(0xAu, &WPP_5d6c07f306e13ea2a30515e9b6bd8675_Traceguids, (__int64)MiniportByPdo);
            LOBYTE(v7) = 1;
            ndisMSetMiniportReadyForBinding(v8, v7, 0x80000LL);
          }
        }
