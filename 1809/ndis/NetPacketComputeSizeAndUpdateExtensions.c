/*
 * XREFs of NetPacketComputeSizeAndUpdateExtensions @ 0x1C0082220
 * Callers:
 *     <none>
 * Callees:
 *     ?NetPacketAssignLayoutWithArray@@YAXPEAPEAUNET_PACKET_EXTENSION_PRIVATE@@KPEAK@Z @ 0x1C0108320 (-NetPacketAssignLayoutWithArray@@YAXPEAPEAUNET_PACKET_EXTENSION_PRIVATE@@KPEAK@Z.c)
 */
