/*
 * XREFs of ndisRejectUnsupportedPMOffloads @ 0x1C00E7E44
 * Callers:
...
LONG __fastcall ndisRejectUnsupportedPMOffloads(char *MiniportAdapterHandle)
{
  ...
  v9[0] = 0;
  KeWaitForSingleObject(MiniportAdapterHandle + 3984, Executive, 0, 0, 0LL);
LABEL_2:
  v9[0] = 0;
  for ( i = *((_QWORD *)MiniportAdapterHandle + 122); i; i = *v3 )
  {
    if ( !ndisIsPMProtocolOffloadSupported(*(_DWORD *)(i + 60), (__int64)MiniportAdapterHandle) )
    {
      ...
      v6 = *((_DWORD *)v3 + 11);
      if ( !v5 )
        return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 3984), 0, 1, 0);
      if ( v5 == v4 )
      {
        if ( (unsigned __int8)byte_1C00A025D >= 2u )
          WPP_SF_D(0x7Au, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, v5);
      }
      else
      {
        memset(v11, 0, sizeof(v11));
        ...
        *(_DWORD *)&v11[48] = 4;
        ...
        if ( (unsigned __int8)byte_1C00A025D >= 2u )
          WPP_SF_D(0x7Bu, &WPP_293c7713174a39067998d2cc62157da6_Traceguids, SetMiniport);
      }
      return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 3984), 0, 1, 0);
    }
  }
