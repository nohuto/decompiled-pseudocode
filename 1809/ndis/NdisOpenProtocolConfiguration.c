/*
 * XREFs of NdisOpenProtocolConfiguration @ 0x1C00C7010
 * Callers:
...
void __fastcall NdisOpenProtocolConfiguration(int *a1, _QWORD *a2, _UNICODE_STRING *a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_Z(0x28u, &WPP_5a25d62004233057cf64a29056d8f8be_Traceguids, &a3->Length);
...
LABEL_9:
  if ( KeyHandle )
    ZwClose(KeyHandle);
  if ( (unsigned __int8)byte_1C00A025C >= 4u )
    WPP_SF_(0x29u, &WPP_5a25d62004233057cf64a29056d8f8be_Traceguids);
}
