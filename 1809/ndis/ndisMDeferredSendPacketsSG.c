/*
 * XREFs of ndisMDeferredSendPacketsSG @ 0x1C0056B70
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSendPacketsSG(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_q(0x26u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1);
  v3 = *(_DWORD *)(a1 + 120);
  v4 = 0LL;
...
LABEL_8:
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_q(0x27u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1);
  return 0;
}
