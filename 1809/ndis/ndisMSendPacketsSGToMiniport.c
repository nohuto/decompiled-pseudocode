/*
 * XREFs of ndisMSendPacketsSGToMiniport @ 0x1C00586B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsSGToMiniport(__int64 a1, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C00A0252 >= 4u )
    WPP_SF_qqd(0x22u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, a2, a3);
  if ( (_DWORD)v3 )
  {
    v6 = a2;
    v7 = v3;
  ...
  {
    LODWORD(v16) = v3;
    WPP_SF_qqd(0x23u, &WPP_9311d8c63e523f0dc817929b0a257a44_Traceguids, a1, a2, v16);
  }
}
