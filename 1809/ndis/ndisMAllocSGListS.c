/*
 * XREFs of ndisMAllocSGListS @ 0x1C004C928
 * Callers:
 ...
 *     NdisAllocateBuffer @ 0x1C0051D80 (NdisAllocateBuffer.c)
...
void __fastcall ndisMAllocSGListS(__int64 a1, struct _NDIS_PACKET *a2)
{
  ...
  struct _MDL *v40; // [rsp+60h] [rbp-20h] BYREF
  ...
  v2 = *(_QWORD *)(a1 + 504);
  Buffer = 0LL;
  NdisQueryPacket(a2, &a2->Private.PhysicalCount, 0LL, &v40, (unsigned int *)&NumberOfBytes);
  if ( !v40 )
  {
    v5 = (KSPIN_LOCK *)(a1 + 96);
...
LABEL_50:
  ...
  v43 = (char *)v40->StartVa + v40->ByteOffset;
  v12 = *(_QWORD *)(v2 + 64);
  v13 = Number + 1;
  v14 = *(_DWORD *)v12 - 1;
  if ( v13 < *(_DWORD *)v12 )
...
LABEL_27:
  ...
  if ( v22 < 0 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      if ( Status )
        goto LABEL_35;
      ndisMCopyFromPacketToBuffer((_DWORD)a2, v31, Length, (_DWORD)v30, (__int64)&v46);
      if ( v46 == Length )
      {
        a2->Private.Flags |= 0x800u;
        v34 = (char *)v33->StartVa + v33->ByteOffset;
        *(_QWORD *)&a2->MacReserved[a2->Private.NdisPacketOobOffset + 24] = v33;
        v35 = KfRaiseIrql(2u);
        v36 = *(_QWORD *)(v2 + 24);
        LOBYTE(v39) = 1;
