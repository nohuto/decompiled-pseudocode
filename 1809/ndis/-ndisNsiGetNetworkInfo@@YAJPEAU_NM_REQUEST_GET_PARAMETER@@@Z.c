/*
 * XREFs of ?ndisNsiGetNetworkInfo@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0040110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetNetworkInfo(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_q(0x69u, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (__int64)a1);
...
LABEL_34:
  ...
  if ( (unsigned __int8)byte_1C00A0265 >= 4u )
    WPP_SF_qD(0x6Au, &WPP_f666f9a69dac3f1d24f4d94726ea9246_Traceguids, (__int64)a1, v3);
