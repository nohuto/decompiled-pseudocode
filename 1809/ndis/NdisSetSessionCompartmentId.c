/*
 * XREFs of NdisSetSessionCompartmentId @ 0x1C006C130
 * Callers:
 *     ndisNsiSetAllSessionInformation @ 0x1C00F8310 (ndisNsiSetAllSessionInformation.c)
 * Callees:
 ...
 *     ?ndisCmLazyInitializeCleanup@@YAXXZ @ 0x1C006C058 (-ndisCmLazyInitializeCleanup@@YAXXZ.c)
 */
