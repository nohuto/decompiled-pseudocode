/*
 * XREFs of ?ndisReadProtocolById@@YAJAEBU_GUID@@@Z @ 0x1C0106700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisReadProtocolById(const struct _GUID *a1)
{
  ...
  v12 = 0;
  v6 = v1;
  netsetupBuildObjectPath(4, &a1->Data1, 0, 1, v14);
  v2 = KRegKey::Open((KRegKey *)&Handle, 1u, v14, 0LL);
  if ( !v2 )
  {
    p_Handle = &Handle;
    v2 = ndisBlowStringListIntoAtoms(&p_Handle, (const struct _NETSETUPPROPKEY *)&unk_1C00915B0, (__int64)v8);
    if ( !v2 )
    {
      v2 = ndisBlowStringListIntoAtoms(&p_Handle, (const struct _NETSETUPPROPKEY *)&unk_1C00914C8, (__int64)v10);
      if ( !v2 )
      {
        v2 = NetSetupPropertyBag::ReadString(
               (NetSetupPropertyBag *)&p_Handle,
               (const struct _NETSETUPPROPKEY *)&unk_1C0091610,
               &v7);
        if ( !v2 )
        {
          v2 = NetSetupPropertyBag::ReadBoolean(&p_Handle, (const struct _NETSETUPPROPKEY *)&unk_1C0091598, &v12);
          if ( !v2 )
          {
