/*
 * XREFs of ndisSriovInterfaceWriteVFConfig @ 0x1C00FBDE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceWriteVFConfig(void *a1, const void *a2, __int16 a3, int a4, size_t Size)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_q(0x5Bu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qD(0x5Cu, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
