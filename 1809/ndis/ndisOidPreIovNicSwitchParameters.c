/*
 * XREFs of ndisOidPreIovNicSwitchParameters @ 0x1C00FA0B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovNicSwitchParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qq(0x19u, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v1, v3);
  v7 = *(_DWORD *)(v3 + 4);
  v8 = 548;
  if ( v7 != 12 )
  {
...
LABEL_52:
  if ( (unsigned __int8)byte_1C00A0269 >= 4u )
    WPP_SF_qqDD(0x1Au, &WPP_045c459e6c3833fc2a6b90252fda9676_Traceguids, v1, v4, v2, *(_DWORD *)(a1 + 40));
  return v2;
}
