/*
 * XREFs of ndisUpdateOffloadKeywords @ 0x1C00E56FC
 * Callers:
 ...
 *     ndisConvertOffloadValueToString @ 0x1C00E36B4 (ndisConvertOffloadValueToString.c)
...
__int64 __fastcall ndisUpdateOffloadKeywords(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_q(0xEFu, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, a1);
    v6 = 0;
    v9 = 0;
  }
  v10 = *(_BYTE *)(a2 + 1);
  ...
  v12 = *(_BYTE *)(a2 + 4);
  v13 = *(_DWORD *)(*(_QWORD *)(a1 + 4128) + 680LL) & 1;
  if ( v12 > 4u )
    goto LABEL_202;
  v14 = *(_BYTE *)(a2 + 5);
  if ( v14 > 4u )
...
LABEL_175:
  ...
  if ( v69 )
  {
    ...
    if ( v60 == 1 )
      v61 = 0x800000;
    *(_DWORD *)(a1 + 3704) = *(_DWORD *)(a1 + 3704) & 0xFF7FFFFF | v61;
  }
  if ( v77 )
  {
    v68.ParameterType = NdisParameterString;
    ...
    if ( v77 == 1 )
      v62 = 0x1000000;
    *(_DWORD *)(a1 + 3704) = *(_DWORD *)(a1 + 3704) & 0xFEFFFFFF | v62;
  }
  if ( v8 )
  {
    v68.ParameterType = NdisParameterString;
    ...
    if ( v8 == 2 && v75 == 3 || v8 == 1 )
    {
      ...
      if ( v8 == 2 )
        v63 = 0x2000000;
      *(_DWORD *)(a1 + 3704) = *(_DWORD *)(a1 + 3704) & 0xFDFFFFFF | v63;
    }
    if ( (v75 & 1) != 0 )
    {
      ...
      if ( v78 == 2 )
        v64 = 0x4000000;
      *(_DWORD *)(a1 + 3704) = *(_DWORD *)(a1 + 3704) & 0xFBFFFFFF | v64;
    }
    if ( (v75 & 2) != 0 )
    {
      ...
      if ( v70 == 2 )
        v65 = 0x8000000;
      *(_DWORD *)(a1 + 3704) = *(_DWORD *)(a1 + 3704) & 0xF7FFFFFF | v65;
    }
  }
  v18 = 0;
LABEL_203:
