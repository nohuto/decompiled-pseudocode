/*
 * XREFs of ndisMFinishClose @ 0x1C01168D0
 * Callers:
 ...
 *     ndisMCoFreeResources @ 0x1C011EAE0 (ndisMCoFreeResources.c)
 */
...
void __fastcall ndisMFinishClose(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0255 >= 4u )
    WPP_SF_q(0xCu, &WPP_9a121bb7542c30cb70afea5376c1d156_Traceguids, a1);
  ...
  *(_QWORD *)(a1 + 368) = a1;
  ...
  if ( (unsigned __int8)byte_1C00A0255 >= 4u )
    WPP_SF_q(0xDu, &WPP_9a121bb7542c30cb70afea5376c1d156_Traceguids, a1);
}
