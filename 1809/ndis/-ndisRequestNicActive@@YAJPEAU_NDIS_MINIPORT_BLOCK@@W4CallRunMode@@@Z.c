/*
 * XREFs of ?ndisRequestNicActive@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4CallRunMode@@@Z @ 0x1C0078D14
 * Callers:
  ...
  if ( ActiveState == NdisNicQuiet )
  {
    ...
    else
    {
      ...
      if ( (unsigned __int8)byte_1C00A025D >= 2u )
        WPP_SF_dq(0x11u, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, v17, a1);
    }
  }
  else
  {
    ...
    {
      if ( (unsigned __int8)byte_1C00A025D >= 2u )
        WPP_SF_q(0x12u, &WPP_68d7649c6d7b36189a1e4a9b4cf52062_Traceguids, (__int64)a1);
      KeReleaseSpinLock(&AoAc->Lock, v12);
