/*
 * XREFs of ndisSetFilterDefaultParameter @ 0x1C00ED57C
 * Callers:
...
__int64 __fastcall ndisSetFilterDefaultParameter(__int64 a1, const WCHAR *a2, __int64 a3, unsigned __int8 a4)
{
  ...
  *(_DWORD *)&String2.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x5Au, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, a1, a2, a3);
  ...
  v11 = RegistryValues;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_dd(0x5Bu, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, RegistryValues, a4);
  if ( v11 )
  {
    v5 = -1073741823;
  }
    ...
    if ( !Value )
    {
      ...
      if ( !DestinationString.Buffer )
      {
        if ( !String2.Buffer )
          goto LABEL_17;
        v13 = 0;
        while ( RtlCompareUnicodeString((PCUNICODE_STRING)((char *)&unk_1C0086F30 + 24 * v13), &String2, 1u) )
        {
          if ( ++v13 >= 6 )
            goto LABEL_17;
        }
        v14 = (const WCHAR *)&unk_1C008968C;
        if ( (unsigned int)(*((_DWORD *)&unk_1C0086F30 + 6 * v13 + 4) - 4) > 1 )
LABEL_17:
          v14 = L"0";
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    ...
    WPP_SF_qqqL(0x5Cu, &WPP_121f726d2db93de0e5803b82441184b1_Traceguids, a1, a2, a3, ValueLength);
  }
  return v5;
}
