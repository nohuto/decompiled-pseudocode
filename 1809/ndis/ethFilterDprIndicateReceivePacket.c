/*
 * XREFs of ethFilterDprIndicateReceivePacket @ 0x1C0067510
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( (*MappedSystemVa & 1) == 0 )
      {
        ...
        if ( *v5 )
        {
          do
          {
            ...
            {
              ++v79;
              *(_BYTE *)((Number << 12) + *(_QWORD *)(v36 + 720)) = 1;
              ...
              && (!v59 || v84[41]) )
            {
              ...
              if ( v66 && v62 == -1073741670 )
              {
                ndisNblTrackerTransferOwnershipSingleNbl(
                  v66,
                  v61,
                  *(struct NDIS_NBL_TRACKER_HANDLE__ **)(v56 + 584),
                  ByteCount);
      ...
      if ( (*(_DWORD *)(BugCheckParameter2 + 120) & 0x40000) != 0 )
      {
        ...
        *((_DWORD *)v73 + 8) = 259;
        ...
        if ( *(_MDL **)((char *)&v11[1].Private.Head + v11->Private.NdisPacketOobOffset) )
          goto LABEL_125;
        (*(void (__fastcall **)(_QWORD, struct _NDIS_PACKET *))(*(_QWORD *)(BugCheckParameter2 + 3792) + 224LL))(
