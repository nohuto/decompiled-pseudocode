/*
 * XREFs of ndisOidPreQosSetParameters @ 0x1C00E4260
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreQosSetParameters(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
    WPP_SF_qq(0x84u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v4, v2);
  if ( *(_DWORD *)(v2 + 4) != 12 )
  {
    v5 = 1;
...
LABEL_21:
  if ( (unsigned __int8)byte_1C00A025A >= 4u )
  {
    ...
    WPP_SF_qdD(0x85u, &WPP_3347f5d6e7de3bf7a7aa2b0281c0f110_Traceguids, v4, v5, v11);
  }
  return v5;
}
