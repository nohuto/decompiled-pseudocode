/*
 * XREFs of NdisMRegisterMiniport @ 0x1C00F2030
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT CharacteristicsLength)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xAu, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, (__int64)NdisWrapperHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xBu, &WPP_50d53b6be4163c1258975c6e797e4b92_Traceguids, v3, v7);
  return v7;
}
