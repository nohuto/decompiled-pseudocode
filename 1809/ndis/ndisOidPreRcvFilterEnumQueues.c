/*
 * XREFs of ndisOidPreRcvFilterEnumQueues @ 0x1C003C0D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumQueues(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C00A0268 >= 4u )
    WPP_SF_q(0x1Cu, &WPP_4e96cfa6cc7a3b71fc1adf7434706e83_Traceguids, a1);
  v6 = *(_QWORD *)(a1 + 32);
      ...
      if ( v11 <= *(_DWORD *)(v12 + 48) )
      {
        ...
        *v13 = 1048960;
        ...
        else
        {
          ...
          v18 = *(_QWORD **)(v1 + 3488);
          while ( v18 != (_QWORD *)(v1 + 3488) && v2 < v10 )
          {
...
LABEL_32:
  if ( (unsigned __int8)byte_1C00A0268 >= 4u )
    WPP_SF_qD(0x1Du, &WPP_4e96cfa6cc7a3b71fc1adf7434706e83_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v5;
}
