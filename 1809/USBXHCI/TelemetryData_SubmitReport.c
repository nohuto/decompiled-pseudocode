/*
 * XREFs of TelemetryData_SubmitReport @ 0x1C006338C
 * Callers:
 *     Controller_TelemetryReport @ 0x1C000E2D4 (Controller_TelemetryReport.c)
 * Callees:
 *     WerKernelCloseHandle @ 0x1C0043678 (WerKernelCloseHandle.c)
 *     WerKernelCreateReport @ 0x1C00436A0 (WerKernelCreateReport.c)
 *     WerKernelSubmitReport @ 0x1C004393C (WerKernelSubmitReport.c)
 *     TelemetryData_pDeleteDumpFile @ 0x1C0063624 (TelemetryData_pDeleteDumpFile.c)
