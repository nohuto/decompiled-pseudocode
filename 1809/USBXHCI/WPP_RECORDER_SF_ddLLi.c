/*
 * XREFs of WPP_RECORDER_SF_ddLLi @ 0x1C0002A10
 * Callers:
...
__int64 WPP_RECORDER_SF_ddLLi(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_cc93d32a3d3f360a569d7e7ab2fec42f_Traceguids,
      77LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 77;
  return WppAutoLogTrace(a1, 4LL, 13LL, &WPP_cc93d32a3d3f360a569d7e7ab2fec42f_Traceguids, v7, (__int64 *)va);
}
