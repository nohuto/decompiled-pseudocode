/*
 * XREFs of CommonBuffer_Create @ 0x1C0057658
 * Callers:
 ...
 *     XilCoreCommonBuffer_Create @ 0x1C00425CC (XilCoreCommonBuffer_Create.c)
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_QWORD *)(v8 + 56) = v8 + 56;
    ...
    if ( !Controller_IsSecureDevice(a1) )
    {
      ...
      v13[3] = 0x100000001LL;
      v12[0] = 24LL;
      v9 = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD *, _QWORD *, __int64))(WdfFunctions_01023 + 3032))(
             WPP_MAIN_CB.Dpc.ProcessorHistory,
             v12,
             v13,
             v8 + 72);
