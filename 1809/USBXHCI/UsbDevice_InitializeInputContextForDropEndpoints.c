/*
 * XREFs of UsbDevice_InitializeInputContextForDropEndpoints @ 0x1C0004B58
 * Callers:
...
__int64 __fastcall UsbDevice_InitializeInputContextForDropEndpoints(__int64 a1, __int64 a2)
{
  ...
  v4 = *(_QWORD *)((*(_BYTE *)(a1 + 649) != 0 ? 8 : 0) + a1 + 632);
  if ( v4 )
    v5 = *(_DWORD **)(v4 + 16);
  else
    v5 = 0LL;
  for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a2 + 40); i = (unsigned int)(i + 1) )
  {
    ...
    *v5 |= 1 << v8;
    ...
    else
    {
      ...
      {
        DeviceContextBufferVA = XilCoreUsbDevice_GetDeviceContextBufferVA(a1 + (v10 != 0 ? 608LL : 600LL));
      ...
      WPP_RECORDER_SF_dddddd(
        *(_QWORD *)(v9 + 72),
        (unsigned __int8)BYTE2(*(_DWORD *)v14),
