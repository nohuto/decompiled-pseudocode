/*
 * XREFs of Controller_WdfEvtDeviceArmWakeFromS0 @ 0x1C000FF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceArmWakeFromS0(__int64 a1)
{
  ...
  if ( *(_BYTE *)(v3 + 473) && KeGetCurrentIrql() )
    Debug_FreAssertMsg(
      ...
      2631LL);
  v4 = *(_QWORD *)(v3 + 152);
  WPP_RECORDER_SF_i(*(_QWORD *)(v3 + 72), 4u, 4u, 0x55u, (__int64)&Context.Logger + 4, a1);
  *(_BYTE *)(v3 + 404) = 1;
  if ( *(_DWORD *)(v4 + 16) )
  {
    do
    {
      ...
      v5 = *(_QWORD *)(v4 + 40) + 16LL * (unsigned int)v2;
      Ulong = XilRegister_ReadUlong(*(_QWORD *)(v3 + 88), v5);
      XilRegister_WriteUlong(*(_QWORD *)(v3 + 88), v5, Ulong & 0xC200 | 0xE000000u);
      DynamicLock_Release(*(_QWORD *)(*(_QWORD *)(v4 + 48) + 80 * v2 + 24));
