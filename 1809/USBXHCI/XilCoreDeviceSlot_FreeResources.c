/*
 * XREFs of XilCoreDeviceSlot_FreeResources @ 0x1C0042C28
 * Callers:
 ...
 *     XilCoreCommonBuffer_ReleaseBuffers @ 0x1C0042940 (XilCoreCommonBuffer_ReleaseBuffers.c)
 */
...
void __fastcall XilCoreDeviceSlot_FreeResources(__int64 a1)
{
  ...
  if ( *(_QWORD *)(a1 + 24) )
  {
    ...
    CommonBuffer_ReleaseBuffer(v4, *(_DWORD **)(a1 + 24));
    *(_QWORD *)(a1 + 24) = 0LL;
  }
  v6 = *(_DWORD **)(a1 + 32);
  if ( v6 )
