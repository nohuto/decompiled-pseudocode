/*
 * XREFs of Crashdump_CommonBufferAcquire @ 0x1C003A548
 * Callers:
 *     Crashdump_UcxEvtGetDumpData @ 0x1C003B6E0 (Crashdump_UcxEvtGetDumpData.c)
 *     Crashdump_EventRing_InitializeForDump @ 0x1C003C928 (Crashdump_EventRing_InitializeForDump.c)
 *     Crashdump_Endpoint_Initialize @ 0x1C003D4C4 (Crashdump_Endpoint_Initialize.c)
 *     Crashdump_UsbDevice_Initialize @ 0x1C003EAD4 (Crashdump_UsbDevice_Initialize.c)
 * Callees:
