/*
 * XREFs of Interrupter_PrepareHardware @ 0x1C005EB9C
 * Callers:
    ...
    *v20 = *(_QWORD *)(a1 + 40);
    ...
    if ( *(_DWORD *)(a1 + 20) && v7 > 1 && *v4 == 2 )
    {
      for ( i = 0;
            ...
            ++i )
      {
        v23 = (_BYTE *)(*(__int64 (__fastcall **)(unsigned __int64, __int64, _QWORD))(WdfFunctions_01023 + 2440))(
                         WPP_MAIN_CB.Dpc.ProcessorHistory,
                         a3,
                         i);
        if ( *v23 == 2 && (v23[2] & 3) == 3 )
          ...
          if ( v21 )
          {
            ...
            else
            {
              v24 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, _QWORD))(WdfFunctions_01023 + 2440))(
                      ...
                      a3,
                      i);
              v25 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, _QWORD))(WdfFunctions_01023 + 2440))(
                      WPP_MAIN_CB.Dpc.ProcessorHistory,
                      v36,
                      i);
...
LABEL_55:
    LODWORD(v34) = v18;
    WPP_RECORDER_SF_d(*(_QWORD *)(v3 + 72), 2u, 9u, v19, (__int64)&WPP_0662e7d5b0263a64b1494f18ba617a4b_Traceguids, v34);
    return (unsigned int)v8;
  }
  v8 = -1073741670;
  v9 = 16;
LABEL_3:
  WPP_RECORDER_SF_(*(_QWORD *)(v3 + 72), 2u, 9u, v9, (__int64)&WPP_0662e7d5b0263a64b1494f18ba617a4b_Traceguids);
  return (unsigned int)v8;
}
