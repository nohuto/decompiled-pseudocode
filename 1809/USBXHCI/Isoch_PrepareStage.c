...
__int64 __fastcall Isoch_PrepareStage(__int64 a1)
{
  ...
  *((_DWORD *)v1 + 10) = v4;
  ...
  if ( (*(_QWORD *)(*(_QWORD *)(v8 + 8) + 272LL) & 0x800000000000000LL) != 0 || (*(_DWORD *)(v8 + 100) & 0x800) == 0 )
  {
    v10 = *(_DWORD *)(a1 + 328);
    if ( (v10 & 0x20) != 0 )
    {
