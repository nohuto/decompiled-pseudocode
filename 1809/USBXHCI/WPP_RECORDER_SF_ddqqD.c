/*
 * XREFs of WPP_RECORDER_SF_DDqqD @ 0x1C002E7EC
 * Callers:
...
__int64 WPP_RECORDER_SF_DDqqD(__int64 a1, unsigned __int8 a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x2000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= a2 )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_f9b05a47faf934e5e949b6ffde11c420_Traceguids,
      a4,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v9) = a4;
  return WppAutoLogTrace(a1, a2, 14LL, &WPP_f9b05a47faf934e5e949b6ffde11c420_Traceguids, v9, (__int64 *)va);
}
