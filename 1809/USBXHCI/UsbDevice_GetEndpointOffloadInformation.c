/*
 * XREFs of UsbDevice_GetEndpointOffloadInformation @ 0x1C0035C6C
 * Callers:
...
__int64 __fastcall UsbDevice_GetEndpointOffloadInformation(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)(a2 + 24) )
  {
    ...
    DeviceContextBufferVA = XilCoreUsbDevice_GetDeviceContextBufferVA(a1 + (*(_BYTE *)(a1 + 649) != 0 ? 608LL : 600LL));
    v14 = *(_DWORD *)(*(_QWORD *)(a1 + 8) + 564LL);
    *(_DWORD *)(a3 + 10) = v14;
