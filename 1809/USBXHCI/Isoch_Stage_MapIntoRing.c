/*
 * XREFs of Isoch_Stage_MapIntoRing @ 0x1C002C518
 * Callers:
...
KIRQL __fastcall Isoch_Stage_MapIntoRing(__int64 a1, char a2)
{
  ...
  __int64 v79; // r8
  signed __int32 v80[8]; // [rsp+0h] [rbp-D9h] BYREF
  unsigned int v81; // [rsp+20h] [rbp-B9h]
  _OWORD *v82; // [rsp+28h] [rbp-B1h]
  int v83; // [rsp+30h] [rbp-A9h]
  unsigned int v84; // [rsp+60h] [rbp-79h]
  int v85; // [rsp+64h] [rbp-75h]
  unsigned int v86; // [rsp+68h] [rbp-71h]
  __int128 v87; // [rsp+70h] [rbp-69h]
  __int64 v88; // [rsp+80h] [rbp-59h]
  int v89; // [rsp+88h] [rbp-51h]
  unsigned int v90; // [rsp+8Ch] [rbp-4Dh]
  int v91; // [rsp+90h] [rbp-49h]
  unsigned int v92; // [rsp+94h] [rbp-45h]
  int v93; // [rsp+98h] [rbp-41h]
  int PacketCount; // [rsp+9Ch] [rbp-3Dh]
  __int64 v95; // [rsp+A0h] [rbp-39h]
  unsigned int v96; // [rsp+A8h] [rbp-31h]
  __int64 v97; // [rsp+B0h] [rbp-29h]
  int v98; // [rsp+B8h] [rbp-21h]
  __int64 v99; // [rsp+C0h] [rbp-19h]
  _DWORD *v100; // [rsp+C8h] [rbp-11h]
  __int64 v101; // [rsp+D0h] [rbp-9h]
  __int64 v102; // [rsp+D8h] [rbp-1h]
  _OWORD *v103; // [rsp+E0h] [rbp+7h]
  char v104; // [rsp+140h] [rbp+67h]
  unsigned int v106; // [rsp+158h] [rbp+7Fh]
  ...
  *(_DWORD *)(a1 + 88) = v95;
  ...
  v14 = *(_QWORD *)(v6 + 40);
  v15 = PacketLength;
  if ( (*(_QWORD *)(v14 + 272) & 0x20000000000LL) != 0 )
  {
    ...
    if ( FrameNumber - v91 >= 0 )
    {
      ...
      *(_DWORD *)(v6 + 328) |= 0x10u;
      ...
      {
        if ( *(_BYTE *)(*(_QWORD *)(v22 + 8) + 473LL) && KeGetCurrentIrql() )
          Debug_FreAssertMsg(
            (__int64)"Code Path Requires Passive Level",
            0,
            (int)"onecore\\drivers\\wdm\\usb\\usb3\\usbxhci\\sys\\xilusbdevice.c",
            600);
        result = XilUsbDevice_SendRequestToRingDoorbell(v22 + 600, v23, v21);
      }
      if ( *(_BYTE *)(v6 + 280) )
      {
        if ( a2 )
  ...
  v28 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v6 + 40) + 88LL) + 104LL) & 0x50;
  v98 = v28;
  do
  {
    ...
    *((_QWORD *)&v87 + 1) = 0LL;
    ...
    if ( v27 > 5 )
    {
      if ( v27 <= 7 )
      {
        ...
        *(_QWORD *)&v87 = 1LL;
        WORD1(v87) = v3;
        v32 = HIDWORD(v87) & 0xFFFF03DF | 0x1C20;
        DWORD1(v87) = *v100;
        HIDWORD(v87) = v32;
        v35 = v32;
        ++v106;
        ...
        else
        {
          if ( (v34 & 0x7F) != 0 )
          {
            v32 = v32 & 0xFFFFFDFF | ((unsigned __int8)v101 << 9);
            HIDWORD(v87) = v35 & 0xFFFFFDFF | ((unsigned __int8)v101 << 9);
          }
          v85 = 0;
...
LABEL_80:
    ...
    if ( v27 == 4 )
    {
      v36 = *v100 + v3 / *(_DWORD *)(v6 + 356);
      v37 = *(_WORD *)v100 + v3 / *(_DWORD *)(v6 + 356);
      v91 = v36;
      v38 = *(_QWORD *)(v6 + 56);
...
LABEL_68:
    ...
    HIDWORD(v87) = v32;
    v13 = 0LL;
    if ( (*(_QWORD *)(v55 + 272) & 0x800000000000LL) != 0 )
    {
      v56 = *(_QWORD *)(v6 + 48);
      if ( *(_DWORD *)(v56 + 20) == 1 )
      {
        if ( *(_DWORD *)(v56 + 40) )
        {
          if ( v27 == 6 )
          {
            if ( (unsigned int)(*(_DWORD *)(v6 + 196) - v102 - 1) >= *(_DWORD *)(v6 + 432) )
              goto LABEL_79;
            v27 = 10;
          }
          if ( v27 == 7 )
...
LABEL_83:
    if ( v103 != (_OWORD *)v26 )
      HIDWORD(v87) = (v32 ^ *(_DWORD *)(v6 + 200)) & 1 ^ v32;
    v57 = *(unsigned __int16 *)(v6 + 112);
    ++v89;
    DWORD2(v87) = v33 & 0x3FFFFF | (v57 << 22);
    *v103 = v87;
    v58 = ++*(_DWORD *)(v6 + 192);
    if ( v31 )
    {
    ...
    if ( v73 == *(_DWORD *)(v6 + 196) )
    {
      ...
      if ( v27 != 4 )
      {
        *(_DWORD *)(v6 + 192) = v71;
        ...
        v15 = Isoch_GetPacketLength(v99, v60);
        v27 = 4;
        v73 = v75;
      }
