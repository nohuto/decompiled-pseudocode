/*
 * XREFs of WPP_RECORDER_SF_dqdL @ 0x1C0038B30
 * Callers:
...
__int64 WPP_RECORDER_SF_dqdL(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_fc47e94f866b3ce951b07e0cf42a6662_Traceguids,
      25LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 25;
  return WppAutoLogTrace(a1, 2LL, 12LL, &WPP_fc47e94f866b3ce951b07e0cf42a6662_Traceguids, v7, (__int64 *)va);
}
