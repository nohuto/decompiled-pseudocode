/*
 * XREFs of Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C003EDE8
 * Callers:
 ...
 *     Crashdump_UsbDevice_SendResetDeviceCommand @ 0x1C003F40C (Crashdump_UsbDevice_SendResetDeviceCommand.c)
 */
