/*
 * XREFs of TelemetryData_pCreateDumpFile @ 0x1C0063414
 * Callers:
 *     TelemetryData_pWriteDumpFile @ 0x1C0063AA0 (TelemetryData_pWriteDumpFile.c)
 * Callees:
...
__int64 __fastcall TelemetryData_pCreateDumpFile(__int64 a1, void **a2)
{
  ...
  while ( 1 )
  {
    ...
    pszFormat = L"%ws-%04u%02u%02u-%02u%02u.dmp";
