/*
 * XREFs of XilCommand_AllocateSecureResources @ 0x1C0009CD4
 * Callers:
...
__int64 __fastcall XilCommand_AllocateSecureResources(__int64 a1)
{
  ...
  {
    v7 = v4;
    WPP_RECORDER_SF_d(*(_QWORD *)(v2 + 72), 2u, 7u, 0xDu, (__int64)&WPP_ea9f9fbd518637d468c1fcdb19474ea1_Traceguids, v7);
  }
  return v5;
}
