/*
 * XREFs of Bulk_PrepareStage @ 0x1C0030114
 * Callers:
 ...
 *     Bulk_Stage_AcquireMdl @ 0x1C00316DC (Bulk_Stage_AcquireMdl.c)
 *     Bulk_Stage_DetermineSize @ 0x1C0031878 (Bulk_Stage_DetermineSize.c)
 *     Bulk_Stage_EstimateRequiredSegments @ 0x1C0031940 (Bulk_Stage_EstimateRequiredSegments.c)
...
__int64 __fastcall Bulk_PrepareStage(__int64 a1)
{
  ...
  switch ( *(_DWORD *)(*v1 + 76) )
  {
    ...
    case 3:
      ...
      if ( (v5 <= 0x38u || v5 > 0x3Au) && (int)Bulk_Stage_AcquireMdl(v1) < 0 )
        goto LABEL_7;
      break;
  }
