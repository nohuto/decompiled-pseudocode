/*
 * XREFs of Controller_SetDeviceDescription @ 0x1C005AD68
 * Callers:
 ...
 *     RtlUnalignedStringCbLengthW @ 0x1C0011BAC (RtlUnalignedStringCbLengthW.c)
 *     RootHub_GetHighestUsbVersionSupported @ 0x1C001E424 (RootHub_GetHighestUsbVersionSupported.c)
...
LABEL_14:
           ...
           &v37) < 0 )
    {
      v10 = 142;
LABEL_16:
      WPP_RECORDER_SF_(a1[9], 2u, 4u, v10, (__int64)&Context.Logger + 4);
      return;
    }
    v11 = v37->Length - 4LL;
    pcbLength = v11;
    ...
    if ( RtlUnalignedStringCbLengthW((STRSAFE_PCUNZWCH)v37->Text, v11, &pcbLength) >= 0 )
    {
      ...
      if ( v2 )
      {
        ...
        if ( !v18 )
        {
          v19 = 145;
LABEL_31:
          WPP_RECORDER_SF_(a1[9], 2u, 4u, v19, (__int64)&Context.Logger + 4);
          goto LABEL_52;
        }
      ...
      {
        WPP_RECORDER_SF_(a1[9], 4u, 4u, 0x92u, (__int64)&Context.Logger + 4);
        if ( RtlFindMessage(
               *(PVOID *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 24LL),
               0xBu,
               0,
...
LABEL_52:
        ...
        if ( v34 >= 4 && *(_WORD *)&v3[2 * (v34 >> 1) - 2] == 10 )
        {
          ...
          if ( *(_WORD *)&v3[2 * v40] == 13 )
          {
            ...
            if ( !v22 )
            {
              WPP_RECORDER_SF_(a1[9], 2u, 4u, 0x95u, (__int64)&Context.Logger + 4);
LABEL_50:
        ...
        && RtlUnalignedStringCbLengthW((STRSAFE_PCUNZWCH)v18, v20, &v39) >= 0 )
      {
        ...
        {
          Size[0] = v25;
          WPP_RECORDER_SF_d(a1[9], 3u, 4u, 0x96u, (__int64)&Context.Logger + 4, *(_QWORD *)Size);
        }
      }
      goto LABEL_50;
    }
