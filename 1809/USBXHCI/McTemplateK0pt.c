/*
 * XREFs of McTemplateK0pt @ 0x1C0011964
 * Callers:
...
ULONG McTemplateK0pt(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 0;
  v9 = 4;
  return McGenEventWrite(a1, &USBXHCI_ETW_EVENT_CONTROLLER_WDF_POWER_REFERENCE_FOR_DEBUGGER, 0LL, 3u, &v4);
}
