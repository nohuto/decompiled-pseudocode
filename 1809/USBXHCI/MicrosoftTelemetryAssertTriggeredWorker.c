/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C000654C
 * Callers:
...
LABEL_38:
  ...
  if ( (unsigned int)hProvider > 5 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
  {
    ...
    TlgWrite(v24, &unk_1C0046E54, v25, v26, 0xBu, &pData);
  }
  if ( dword_1C0056078 && !v20 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)hProvider > 5 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
    {
      ...
      v60 = 4LL;
      v62 = 4LL;
      TlgWrite((TraceLoggingHProvider)&v45, &unk_1C0046DEB, v28, v29, cData, &v47);
    }
    if ( !v27 )
    {
