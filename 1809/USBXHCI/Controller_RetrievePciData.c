/*
 * XREFs of Controller_RetrievePciData @ 0x1C005A88C
 * Callers:
...
__int64 __fastcall Controller_RetrievePciData(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    LODWORD(v17) = v8;
    WPP_RECORDER_SF_d(a2, 2u, 4u, 0x83u, (__int64)&Context.Logger + 4, v17);
  }
  ...
  if ( v9 >= 0 )
  {
    ...
    v12 = HIWORD(v21);
    LOWORD(v16) = 64;
    v13 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, GUID *, _QWORD *, int, _DWORD, _QWORD))(WdfFunctions_01023 + 1048))(
            WPP_MAIN_CB.Dpc.ProcessorHistory,
            a1,
    ...
    if ( v13 >= 0 )
    {
      ...
      else
      {
        v10 = -1073741823;
        LODWORD(v19) = v14;
        WPP_RECORDER_SF_d(a2, 2u, 4u, 0x86u, (__int64)&Context.Logger + 4, v19);
      }
    }
    else
    {
      LODWORD(v19) = v13;
      WPP_RECORDER_SF_d(a2, 2u, 4u, 0x85u, (__int64)&Context.Logger + 4, v19);
    }
  }
  else
  {
    LODWORD(v18) = v9;
    WPP_RECORDER_SF_d(a2, 2u, 4u, 0x84u, (__int64)&Context.Logger + 4, v18);
  }
  return v10;
}
