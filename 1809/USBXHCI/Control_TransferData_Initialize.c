/*
 * XREFs of Control_TransferData_Initialize @ 0x1C00269CC
 * Callers:
...
signed int __fastcall Control_TransferData_Initialize(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  *(_DWORD *)(a3 + 36) = 0;
  ...
  {
    v9 = (*(__int64 (__fastcall **)(unsigned __int64, __int64))(WdfFunctions_01023 + 2280))(
