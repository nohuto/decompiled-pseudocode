/*
 * XREFs of Crashdump_Cleanup @ 0x1C003A2B0
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_Register_SaveStateForHybridSleep @ 0x1C003C30C (Crashdump_Register_SaveStateForHybridSleep.c)
 *     Crashdump_Register_StopController @ 0x1C003C4E8 (Crashdump_Register_StopController.c)
 *     Crashdump_Command_Stop @ 0x1C003D1D4 (Crashdump_Command_Stop.c)
