/*
 * XREFs of Controller_WdfEvtDeviceSelfManagedIoInit @ 0x1C0010F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceSelfManagedIoInit(__int64 a1)
{
  ...
  *(_BYTE *)(v2 + 16) = 1;
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_i(*(_QWORD *)(v2 + 72), 5u, 4u, 0x32u, (__int64)&Context.Logger + 4, a1);
  if ( Controller_InUseByDebugger((_QWORD *)v2) )
  {
    WPP_RECORDER_SF_i(*(_QWORD *)(v2 + 72), 4u, 4u, 0x33u, (__int64)&Context.Logger + 4, a1);
    ...
    {
      LODWORD(v6) = v3;
      WPP_RECORDER_SF_d(*(_QWORD *)(v2 + 72), 3u, 4u, 0x34u, (__int64)&Context.Logger + 4, v6);
    }
  }
  ...
  if ( (*(_QWORD *)(v2 + 272) & 0x400000000LL) != 0 )
  {
    ...
    *(_QWORD *)(v2 + 392) = v4;
    if ( !v4 )
      WPP_RECORDER_SF_i(*(_QWORD *)(v2 + 72), 3u, 4u, 0x35u, (__int64)&Context.Logger + 4, a1);
  }
  return 0LL;
}
