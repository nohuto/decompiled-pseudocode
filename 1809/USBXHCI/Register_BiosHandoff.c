/*
 * XREFs of Register_BiosHandoff @ 0x1C001C5AC
 * Callers:
...
__int64 __fastcall Register_BiosHandoff(_QWORD *a1)
{
  ...
  if ( v1 )
  {
    WPP_RECORDER_SF_(v3, 4u, 6u, 0x32u, (__int64)&WPP_292538a6e9223cc5bca970ef2a3b6db4_Traceguids);
    ...
    {
      LODWORD(v24) = 2000;
      WPP_RECORDER_SF_d(v10, 2u, 6u, 0x35u, (__int64)&WPP_292538a6e9223cc5bca970ef2a3b6db4_Traceguids, v24);
      v14 = 1LL;
      goto LABEL_13;
    }
    v11 = 52;
    ...
    v12 = 3;
LABEL_15:
    WPP_RECORDER_SF_d(v10, v12, 6u, v11, (__int64)&WPP_292538a6e9223cc5bca970ef2a3b6db4_Traceguids, v24);
  }
  else
  {
    WPP_RECORDER_SF_(v3, 3u, 6u, 0x31u, (__int64)&WPP_292538a6e9223cc5bca970ef2a3b6db4_Traceguids);
  }
...
LABEL_21:
  ...
  {
    WPP_RECORDER_SF_(v18, 2u, 6u, 0x37u, (__int64)&WPP_292538a6e9223cc5bca970ef2a3b6db4_Traceguids);
  ...
  WPP_RECORDER_SF_(v18, 2u, 6u, 0x36u, (__int64)&WPP_292538a6e9223cc5bca970ef2a3b6db4_Traceguids);
  v14 = 2LL;
LABEL_13:
