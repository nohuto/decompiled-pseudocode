/*
 * XREFs of Crashdump_Endpoint_SendBulkTransfer @ 0x1C003D6C4
 * Callers:
 *     Crashdump_DoBulkTransfer @ 0x1C003A69C (Crashdump_DoBulkTransfer.c)
 * Callees:
 *     Crashdump_Endpoint_CalculateTDSize @ 0x1C0005E3C (Crashdump_Endpoint_CalculateTDSize.c)
 *     Crashdump_Endpoint_GetPacketCount @ 0x1C0005E7C (Crashdump_Endpoint_GetPacketCount.c)
  ...
  *(_QWORD *)(a1 + 176) = a2;
  ...
  if ( v9 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(v16 + 12) = v17;
      *(_QWORD *)v16 = *v4;
      *(_DWORD *)(v16 + 8) ^= (*(_DWORD *)(v16 + 8) ^ v15) & 0x1FFFF;
      v18 = *(_DWORD *)(v16 + 8);
