/*
 * XREFs of Interrupter_IoResList_GetMessageCountAndType @ 0x1C005E918
 * Callers:
...
char *__fastcall Interrupter_IoResList_GetMessageCountAndType(__int64 a1, unsigned int *a2, unsigned int *a3, char *a4)
{
  ...
  v7 = 0;
  v8 = a1;
  while ( v7 < (*(unsigned int (__fastcall **)(unsigned __int64, __int64))(WdfFunctions_01023 + 2320))(
                 ...
                 v8) )
  {
    ...
    v12 = v9;
    for ( i = 0;
          i < (*(unsigned int (__fastcall **)(unsigned __int64, __int64))(WdfFunctions_01023 + 2384))(
                WPP_MAIN_CB.Dpc.ProcessorHistory,
                v12);
          ++i )
    {
      v14 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, _QWORD))(WdfFunctions_01023 + 2392))(
              WPP_MAIN_CB.Dpc.ProcessorHistory,
              v12,
              i);
