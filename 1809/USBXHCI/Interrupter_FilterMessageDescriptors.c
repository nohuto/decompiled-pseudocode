/*
 * XREFs of Interrupter_FilterMessageDescriptors @ 0x1C005E6BC
 * Callers:
...
__int64 __fastcall Interrupter_FilterMessageDescriptors(__int64 a1, __int64 a2, int a3, unsigned int a4)
{
  ...
  v7 = (*(__int64 (__fastcall **)(unsigned __int64))(WdfFunctions_01023 + 2328))(WPP_MAIN_CB.Dpc.ProcessorHistory);
      ...
      else
      {
        ...
        WPP_RECORDER_SF_dd(
          *(_QWORD *)(*(_QWORD *)(a1 + 8) + 72LL),
          ...
          v15,
          v16);
        result = (*(__int64 (__fastcall **)(unsigned __int64, __int64, _QWORD))(WdfFunctions_01023 + 2400))(
                   WPP_MAIN_CB.Dpc.ProcessorHistory,
                   v7,
                   v9--);
        --i;
