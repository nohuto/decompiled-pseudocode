/*
 * XREFs of Controller_RetrieveAcpiData @ 0x1C005A660
 * Callers:
...
__int64 __fastcall Controller_RetrieveAcpiData(__int64 a1, __int64 a2, char *a3)
{
  ...
  if ( v7 == -2147483643 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      v17 = v11;
      v18 = (unsigned int)v9;
      v12 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, _QWORD, __int64, _QWORD, __int64 *, _QWORD, _QWORD))(WdfFunctions_01023 + 1488))(
              WPP_MAIN_CB.Dpc.ProcessorHistory,
              v6,
              0LL,
              3325992LL,
    ...
    {
      LODWORD(v14) = v9;
      WPP_RECORDER_SF_d(a2, 2u, 4u, 0x8Bu, (__int64)&Context.Logger + 4, v14);
  ...
  {
    LODWORD(v14) = v7;
    WPP_RECORDER_SF_d(a2, 2u, 4u, 0x8Au, (__int64)&Context.Logger + 4, v14);
  }
  return v8;
}
