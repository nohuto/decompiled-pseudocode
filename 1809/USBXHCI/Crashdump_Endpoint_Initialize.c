/*
 * XREFs of Crashdump_Endpoint_Initialize @ 0x1C003D4C4
 * Callers:
 *     Crashdump_InitializeDeviceContext @ 0x1C003AB10 (Crashdump_InitializeDeviceContext.c)
 * Callees:
 *     Crashdump_CommonBufferAcquire @ 0x1C003A548 (Crashdump_CommonBufferAcquire.c)
 */
        ...
        __int64 a7)
{
  ...
  *(_QWORD *)(a1 + 168) = 1LL;
  ...
  if ( (*(_DWORD *)(*(_QWORD *)a2 + 100LL) & 4) != 0 )
    v9 = v8 << 6;
  else
    v9 = 32 * v8;
  *(_QWORD *)(a1 + 40) = a7 + v9;
  v10 = (unsigned int)(a4 - 1) + 1LL;
  if ( (*(_DWORD *)(*(_QWORD *)a2 + 100LL) & 4) != 0 )
    v11 = v10 << 6;
  else
    v11 = 32 * v10;
  ...
  *(_OWORD *)(a1 + 64) = *(_OWORD *)(v11 + a6 + 16);
  ...
  v13 = Crashdump_CommonBufferAcquire(*(_QWORD *)a1, v12, a1 + 80);
  if ( v13 >= 0 )
  {
