/*
 * XREFs of Crashdump_UcxEvtGetDumpData @ 0x1C003B6E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Crashdump_Register_Initialize @ 0x1C003BD44 (Crashdump_Register_Initialize.c)
...
LABEL_8:
        ...
        *((_DWORD *)v15 + 141) = *(_DWORD *)(v7 + 64);
        ...
        if ( *(_BYTE *)(*(_QWORD *)(v10[19] + 48LL) + 80LL * (unsigned int)(*((_DWORD *)v15 + 136) - 1) + 13) != 2 )
          v19 = 30;
        *((_DWORD *)v15 + 132) = v19;
