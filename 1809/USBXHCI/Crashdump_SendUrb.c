/*
 * XREFs of Crashdump_SendUrb @ 0x1C003B3A0
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_DoBulkTransfer @ 0x1C003A69C (Crashdump_DoBulkTransfer.c)
 *     Crashdump_ResetPipe @ 0x1C003B320 (Crashdump_ResetPipe.c)
