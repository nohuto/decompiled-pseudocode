/*
 * XREFs of UsbDevice_SendConfigureEndpointCommand @ 0x1C0005134
 * Callers:
...
__int64 __fastcall UsbDevice_SendConfigureEndpointCommand(__int64 a1, int a2)
{
  ...
  v5 = 0;
  v6 = *(_QWORD *)((*(_BYTE *)(a1 + 649) != 0 ? 640LL : 632LL) + a1);
  if ( v6 )
    v7 = *(_QWORD *)(v6 + 16);
  else
    v7 = 0LL;
  ...
  *(_BYTE *)(a1 + 495) = *(_BYTE *)(a1 + 135);
  v12 = *(_QWORD *)((*(_BYTE *)(a1 + 649) != 0 ? 640LL : 632LL) + a1);
  if ( v12 )
    v13 = *(_QWORD *)(v12 + 24);
  else
    v13 = 0LL;
  *(_QWORD *)(a1 + 480) = v13;
  *(_QWORD *)(a1 + 528) = v7;
  v14 = *(_QWORD *)((*(_BYTE *)(a1 + 649) != 0 ? 640LL : 632LL) + a1);
  if ( v14 )
    v5 = *(_DWORD *)(v14 + 44);
  v15 = *(_QWORD *)(a1 + 8);
  *(_DWORD *)(a1 + 536) = v5;
  *(_DWORD *)(a1 + 540) = 1;
  *(_QWORD *)(a1 + 544) = a1;
  return Command_SendCommand(*(_QWORD *)(v15 + 144), v3);
}
