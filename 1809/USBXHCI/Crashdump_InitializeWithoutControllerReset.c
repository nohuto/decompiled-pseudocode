/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x1C003AF60
 * Callers:
 *     Crashdump_Initialize @ 0x1C003A7E0 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_PrepareForHibernate @ 0x1C003BEF8 (Crashdump_Register_PrepareForHibernate.c)
 *     Crashdump_EventRing_PrepareForHibernate @ 0x1C003CDC4 (Crashdump_EventRing_PrepareForHibernate.c)
...
__int64 __fastcall Crashdump_InitializeWithoutControllerReset(char *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 77), 0x300uLL, 0x43434858u);
