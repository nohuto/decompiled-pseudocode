/*
 * XREFs of Bulk_ProcessTransferEventWithED0 @ 0x1C00307E8
 * Callers:
 ...
 *     Bulk_Stage_CalculateBytesTransferred @ 0x1C00317FC (Bulk_Stage_CalculateBytesTransferred.c)
...
char __fastcall Bulk_ProcessTransferEventWithED0(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( (unsigned __int8)(*(_BYTE *)(a1 + 11) - 26) > 2u || (*(_DWORD *)(*(_QWORD *)(a2 + 56) + 32LL) & 0x40) == 0 )
  {
    *(_BYTE *)(a2 + 104) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a2 + 96));
    if ( !Bulk_FindStage(a2, *(_QWORD *)a1, &v27, &v26) )
    {
      if ( !*(_DWORD *)(a2 + 64) )
    ...
    if ( v27 )
    {
      v10 = Bulk_Stage_CalculateBytesTransferred(v7, v27, a1);
      if ( v10 <= *(_DWORD *)(v9 + 40) )
      {
LABEL_13:
        if ( Endpoint_HaltedCompletionCode(*(__m128i ***)(a2 + 56), *(unsigned __int8 *)(a1 + 11)) )
        {
          ...
          {
            LOBYTE(v17) = a3;
            Bulk_ProcessTransferEventWithHaltedCompletion(a2, v9, *(unsigned __int8 *)(a1 + 11), v10, v17);
          }
          return 1;
        }
        if ( (unsigned __int8)(v12 - 26) <= 2u )
        {
          Bulk_ProcessTransferEventWithStoppedCompletion(a2, v9, v12, v10, v26);
          v13 = *(_QWORD *)(a2 + 56);
          LODWORD(v24) = *(_DWORD *)(a2 + 352);
          LODWORD(v22) = *(_DWORD *)(a2 + 64);
          LODWORD(v20) = *(_DWORD *)(v13 + 144);
          LODWORD(v18) = *(unsigned __int8 *)(*(_QWORD *)(a2 + 48) + 135LL);
...
LABEL_7:
      ...
      v23 = *(_DWORD *)(a2 + 64);
      v21 = *(_DWORD *)(v11 + 144);
      v19 = *(unsigned __int8 *)(*(_QWORD *)(a2 + 48) + 135LL);
