/*
 * XREFs of Endpoint_SetUpConfigureEndpointCommand @ 0x1C0018358
 * Callers:
        ...
        void *a8)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 88LL) + 100LL) & 4) != 0 )
  {
    ...
    if ( *(_BYTE *)(v14 + 650) )
    {
      DeviceContextBufferVA = (_OWORD *)XilCoreUsbDevice_GetDeviceContextBufferVA(v14 + (*(_BYTE *)(v14 + 649) != 0
                                                                                       ? 608LL
                                                                                       : 600LL));
  ...
  else
  {
    ...
    if ( *(_BYTE *)(v18 + 650) )
    {
      v19 = (_OWORD *)XilCoreUsbDevice_GetDeviceContextBufferVA(v18 + (*(_BYTE *)(v18 + 649) != 0 ? 608LL : 600LL));
      *v15 = *v19;
      *((_OWORD *)v12 + 3) = v19[1];
    }
    else
