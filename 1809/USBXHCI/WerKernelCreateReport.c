/*
 * XREFs of WerKernelCreateReport @ 0x1C00436A0
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C006338C (TelemetryData_SubmitReport.c)
 * Callees:
 *     CheckSpaceAvailable @ 0x1C0043488 (CheckSpaceAvailable.c)
 *     WerpCreateRegistryKey @ 0x1C0044258 (WerpCreateRegistryKey.c)
 */
