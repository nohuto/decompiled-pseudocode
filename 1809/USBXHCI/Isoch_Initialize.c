/*
 * XREFs of Isoch_Initialize @ 0x1C0061AC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Isoch_CalculatePacketsPerFrame @ 0x1C0028D70 (Isoch_CalculatePacketsPerFrame.c)
 */
...
__int64 __fastcall Isoch_Initialize(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 356) = Isoch_CalculatePacketsPerFrame(a1);
  ...
  LODWORD(v6[0]) = 56;
  v6[3] = 0x100000001LL;
  v2 = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD *, _QWORD *, __int64))(WdfFunctions_01023 + 2544))(
