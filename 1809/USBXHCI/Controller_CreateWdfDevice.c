/*
 * XREFs of Controller_CreateWdfDevice @ 0x1C00587E0
 * Callers:
...
__int64 __fastcall Controller_CreateWdfDevice(__int64 a1, __int64 a2, _QWORD *a3, unsigned int *a4)
{
  ...
  *(_DWORD *)&v33.Length = 5242880;
  ...
  LODWORD(v42[0]) = 64;
  (*(void (__fastcall **)(unsigned __int64, __int64, _QWORD *))(WdfFunctions_01023 + 448))(
    WPP_MAIN_CB.Dpc.ProcessorHistory,
    v31,
    v42);
  ...
  LOBYTE(v9) = 22;
  v28 = &v30;
  v10 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, __int64 (__fastcall *)(__int64, __int64), __int64))(WdfFunctions_01023 + 584))(
          WPP_MAIN_CB.Dpc.ProcessorHistory,
          v31,
...
LABEL_13:
  ...
  if ( *(_BYTE *)(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.Type + 28LL) )
  {
    LOBYTE(v11) = 15;
    LODWORD(v28) = 0;
    v10 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, __int64 (__fastcall *)(__int64, IRP *), __int64))(WdfFunctions_01023 + 584))(
            WPP_MAIN_CB.Dpc.ProcessorHistory,
            v31,
    ...
    if ( v10 < 0 )
    {
      v12 = 35;
LABEL_14:
      WPP_RECORDER_SF_d(a2, 2u, 4u, v12, (__int64)&Context.Logger + 4, v13);
  ...
  LODWORD(v34[0]) = 56;
  v34[3] = 0x100000001LL;
  (*(void (__fastcall **)(unsigned __int64, __int64, int *, _QWORD *))(WdfFunctions_01023 + 568))(
    WPP_MAIN_CB.Dpc.ProcessorHistory,
    v31,
    &v35,
    v34);
  ...
  while ( 1 )
  {
    ...
    v10 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, struct _UNICODE_STRING *))(WdfFunctions_01023 + 536))(
            WPP_MAIN_CB.Dpc.ProcessorHistory,
            v31,
            &DestinationString);
    v13 = v10;
    ...
    v10 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, const UNICODE_STRING *))(WdfFunctions_01023 + 544))(
            WPP_MAIN_CB.Dpc.ProcessorHistory,
            v31,
    ...
    (*(void (__fastcall **)(unsigned __int64, __int64, _QWORD *))(WdfFunctions_01023 + 576))(
      ...
      v31,
      v43);
    v15 = (*(__int64 (__fastcall **)(unsigned __int64, __int64 *, _QWORD *, _QWORD *))(WdfFunctions_01023 + 600))(
            WPP_MAIN_CB.Dpc.ProcessorHistory,
            &v31,
            v34,
            a3);
  ...
  v17 = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD, void *))(WdfFunctions_01023 + 1616))(
          WPP_MAIN_CB.Dpc.ProcessorHistory,
          *a3,
          off_1C004F3B0);
  *(_QWORD *)(v17 + 16) = a2;
  *(_QWORD *)(v17 + 32) = *a3;
  ...
  if ( v22 >= 0 )
  {
    v23 = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD, struct _UNICODE_STRING *))(WdfFunctions_01023 + 640))(
            WPP_MAIN_CB.Dpc.ProcessorHistory,
            *a3,
            &v33);
    v10 = v23;
    if ( v23 >= 0 )
    {
      ...
      (*(void (__fastcall **)(unsigned __int64, __int64, GUID *))(WdfFunctions_01023 + 680))(
        ...
        v25,
        &v46);
      v26 = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD, GUID *, _QWORD))(WdfFunctions_01023 + 616))(
              WPP_MAIN_CB.Dpc.ProcessorHistory,
              *a3,
      ...
      {
        LODWORD(v29) = v26;
        WPP_RECORDER_SF_d(a2, 2u, 4u, 0x2Cu, (__int64)&Context.Logger + 4, v29);
      }
    }
    else
    {
      WPP_RECORDER_SF_d(a2, 2u, 4u, 0x2Au, (__int64)&Context.Logger + 4, v23);
    }
  }
  else
  {
    WPP_RECORDER_SF_d(a2, 2u, 4u, 0x29u, (__int64)&Context.Logger + 4, v22);
  }
LABEL_15:
  *a4 = v8;
