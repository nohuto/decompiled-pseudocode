/*
 * XREFs of Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C003EC94
 * Callers:
 ...
 *     Crashdump_UsbDevice_SendEnableSlotCommand @ 0x1C003F358 (Crashdump_UsbDevice_SendEnableSlotCommand.c)
 */
