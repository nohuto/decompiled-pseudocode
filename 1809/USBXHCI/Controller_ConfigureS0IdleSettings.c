/*
 * XREFs of Controller_ConfigureS0IdleSettings @ 0x1C0057888
 * Callers:
...
__int64 __fastcall Controller_ConfigureS0IdleSettings(__int64 *a1)
{
  ...
  {
    *((_DWORD *)a1 + 100) = 1;
    WPP_RECORDER_SF_(a1[9], 3u, 4u, 0x15u, (__int64)&Context.Logger + 4);
  }
  else
  {
    ...
    v11 = 1;
    LOWORD(v9) = 72;
    v3 = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD, GUID *, _QWORD *, __int64, __int16, _QWORD))(WdfFunctions_01023 + 1048))(
    ...
    if ( v3 >= 0 )
    {
      ...
      if ( v14[5] )
      {
        ...
        {
          LODWORD(v12) = v4;
          WPP_RECORDER_SF_d(a1[9], 3u, 4u, 0x17u, (__int64)&Context.Logger + 4, v12);
        }
      }
      ...
      if ( v16 > 1 )
      {
        *((_DWORD *)a1 + 100) = 0;
        ...
        LODWORD(v12) = 5000;
        WPP_RECORDER_SF_d(a1[9], 4u, 4u, 0x19u, (__int64)&Context.Logger + 4, v12);
        memset(v15, 0, 0x48uLL);
        v6 = *a1;
        v15[1] = Controller_EvtPostPoFxRegisterDevice;
        v15[2] = Controller_EvtPrePoFxUnregisterDevice;
        LODWORD(v15[0]) = 72;
        v7 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, _QWORD *))(WdfFunctions_01023 + 3400))(
               WPP_MAIN_CB.Dpc.ProcessorHistory,
               v6,
               v15);
        if ( v7 < 0 )
        {
          LODWORD(v10) = v7;
          WPP_RECORDER_SF_d(a1[9], 2u, 4u, 0x1Au, (__int64)&Context.Logger + 4, v10);
        }
      }
      else
      {
        *((_DWORD *)a1 + 100) = 2;
        LODWORD(v13) = 1;
        LODWORD(v12) = v5;
        WPP_RECORDER_SF_dd(a1[9], 4u, 4u, 0x18u, (__int64)&Context.Logger + 4, v12, v13);
      }
    }
    else
    {
      LODWORD(v12) = v3;
      WPP_RECORDER_SF_d(a1[9], 4u, 4u, 0x16u, (__int64)&Context.Logger + 4, v12);
      *((_DWORD *)a1 + 100) = 2;
    }
  }
  LODWORD(v10) = *((_DWORD *)a1 + 100);
  return WPP_RECORDER_SF_d(a1[9], 4u, 4u, 0x1Bu, (__int64)&Context.Logger + 4, v10);
}
