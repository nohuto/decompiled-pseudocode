/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x1C003AD3C
 * Callers:
 *     Crashdump_Initialize @ 0x1C003A7E0 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_LogRHPortInfo @ 0x1C003BDAC (Crashdump_Register_LogRHPortInfo.c)
 *     Crashdump_Register_ResetController @ 0x1C003BF80 (Crashdump_Register_ResetController.c)
 *     Crashdump_Register_ResetPort @ 0x1C003C04C (Crashdump_Register_ResetPort.c)
 *     Crashdump_Register_StartController @ 0x1C003C420 (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x1C003C5AC (Crashdump_Register_UpdateDeviceSlotInfo.c)
 ...
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C003D3A0 (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_UsbDevice_GetPortType @ 0x1C003EA2C (Crashdump_UsbDevice_GetPortType.c)
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C003EC94 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ResetPort @ 0x1C003EEE4 (Crashdump_UsbDevice_ResetPort.c)
 *     Crashdump_UsbDevice_SetPortPower @ 0x1C003F500 (Crashdump_UsbDevice_SetPortPower.c)
 */
