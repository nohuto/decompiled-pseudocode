/*
 * XREFs of Controller_TelemetryOkToGenerateReport @ 0x1C005B5C0
 * Callers:
...
char __fastcall Controller_TelemetryOkToGenerateReport(_QWORD *a1, __int64 a2, int a3)
{
  ...
  {
    WPP_RECORDER_SF_d(a1[9], 4u, 4u, 0xD4u, (__int64)&Context.Logger + 4, a3);
    goto LABEL_24;
  }
  v6 = a3 - 4109;
  if ( !v6 )
  ...
  if ( v7 )
  {
    if ( v7 != 3 )
      return 1;
    v8 = (*(__int64 (__fastcall **)(unsigned __int64, _QWORD, __int64, __int64, _QWORD, __int64 *))(WdfFunctions_01023
                                                                                                  + 384))(
...
LABEL_14:
    ...
    if ( (int)(v10 + 0x80000000) >= 0 && v10 != -1073741772 )
    {
      ...
      LODWORD(v13) = v10;
LABEL_15:
      WPP_RECORDER_SF_d(a1[9], 3u, 4u, v9, (__int64)&Context.Logger + 4, v13);
      goto LABEL_24;
    }
  }
  else
  {
    ...
    v8 = (*(__int64 (__fastcall **)(unsigned __int64, __int64, struct _UNICODE_STRING *, __int64, __int64 *, _QWORD, _QWORD))(WdfFunctions_01023 + 1880))(
           WPP_MAIN_CB.Dpc.ProcessorHistory,
           v15,
           &DestinationString,
           8LL,
