/*
 * XREFs of Endpoint_SM_AcknowledgeControllerResetComplete @ 0x1C0017900
 * Callers:
 *     ESM_AcknowledgingControllerResetCompleteInDisabled @ 0x1C00404B0 (ESM_AcknowledgingControllerResetCompleteInDisabled.c)
 * Callees:
 *     <none>
 */
