/*
 * XREFs of Crashdump_Command_SendCommand @ 0x1C003D034
 * Callers:
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C003D3A0 (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x1C003DCFC (Crashdump_Endpoint_SetDequeuePointer.c)
 *     Crashdump_Endpoint_StopEndpoint @ 0x1C003DDD0 (Crashdump_Endpoint_StopEndpoint.c)
