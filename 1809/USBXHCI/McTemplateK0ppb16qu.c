/*
 * XREFs of McTemplateK0ppb16qu @ 0x1C0005878
 * Callers:
...
ULONG McTemplateK0ppb16qu(struct _MCGEN_TRACE_CONTEXT *a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 1LL;
  return McGenEventWrite(a1, a2, 0LL, 6u, &EventData);
}
