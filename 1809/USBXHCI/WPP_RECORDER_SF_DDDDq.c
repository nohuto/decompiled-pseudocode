/*
 * XREFs of WPP_RECORDER_SF_DDDDq @ 0x1C00338D4
 * Callers:
...
__int64 WPP_RECORDER_SF_DDDDq(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x2000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_e65a03fee1fe3b77277485fb27797cd8_Traceguids,
      a4,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 5LL, 14LL, &WPP_e65a03fee1fe3b77277485fb27797cd8_Traceguids, v8, (__int64 *)va);
}
