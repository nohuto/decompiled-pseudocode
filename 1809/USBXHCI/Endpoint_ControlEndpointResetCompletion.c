/*
 * XREFs of Endpoint_ControlEndpointResetCompletion @ 0x1C0014E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_ControlEndpointResetCompletion(_QWORD *a1, int a2, __int64 *a3)
{
  ...
  if ( a2 == 3 )
  {
    ...
    WPP_RECORDER_SF_dd(v3[10], 4u, 0xDu, 0x53u, (__int64)&WPP_cc93d32a3d3f360a569d7e7ab2fec42f_Traceguids, v13, v15);
  }
  else
  {
    v6 = *((_BYTE *)a1 + 60);
    if ( v6 == 1 )
    {
      ...
      *((_BYTE *)a1 + 39) = v11;
      ...
      a1[10] = 0LL;
      a1[11] = 0LL;
      WPP_RECORDER_SF_ddi(v3[10], 4u, v11, 0x55u, v12);
