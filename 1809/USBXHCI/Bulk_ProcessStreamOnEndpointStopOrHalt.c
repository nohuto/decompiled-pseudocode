/*
 * XREFs of Bulk_ProcessStreamOnEndpointStopOrHalt @ 0x1C0030478
 * Callers:
 *     Bulk_EP_EndpointHalted @ 0x1C002F350 (Bulk_EP_EndpointHalted.c)
 *     Bulk_EP_FSEReceived @ 0x1C002F3C0 (Bulk_EP_FSEReceived.c)
 * Callees:
