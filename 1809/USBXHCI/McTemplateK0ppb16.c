/*
 * XREFs of McTemplateK0ppb16 @ 0x1C00057F0
 * Callers:
...
ULONG McTemplateK0ppb16(struct _MCGEN_TRACE_CONTEXT *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v9 = v15;
  v10 = 16LL;
  return McGenEventWrite(a1, &USBXHCI_ETW_EVENT_COMMAND_SEND, 0LL, 4u, &EventData);
}
