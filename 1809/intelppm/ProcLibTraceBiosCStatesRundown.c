/*
 * XREFs of ProcLibTraceBiosCStatesRundown @ 0x1C0027C30
 * Callers:
...
char __fastcall ProcLibTraceBiosCStatesRundown(_QWORD *a1)
{
  ...
  if ( (_BYTE)ProcessorNumber )
  {
    ...
    if ( ProcessorNumber >= 0 )
    {
      ...
      if ( v6 )
      {
        PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, 19LL * v6, 0x72637250u);
        if ( !PoolWithTag )
        {
LABEL_15:
        ...
        for ( i = 0LL; (unsigned int)i < v15; v8 = v15 )
        {
          ...
          *(_QWORD *)v13 = v12;
          *((_DWORD *)v13 + 2) = v7[v10 + 3];
          v13[12] = v7[v10 + 4];
          *(_DWORD *)(v13 + 13) = v7[v10 + 5];
          *(_WORD *)(v13 + 17) = HIWORD(v7[v10 + 4]);
        }
        v5 = 7;
        v36 = 0;
        v34 = PoolWithTag;
