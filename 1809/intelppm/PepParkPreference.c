/*
 * XREFs of PepParkPreference @ 0x1C000F410
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  result = (unsigned int)dword_1C001A8D8;
  ...
  while ( v14 < v11 )
  {
    ...
    v13 = *((_QWORD *)&WPP_MAIN_CB.Queue.ListEntry.Flink->Flink + v21);
...
LABEL_22:
  ...
  if ( v14 && v13 )
  {
    ...
    v23[1] = v14;
    v24 = PepParkLists;
    v18 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C001A620)(*(_QWORD *)(v13 + 1088), v23);
    if ( v18 < 0 )
