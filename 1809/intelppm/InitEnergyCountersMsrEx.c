/*
 * XREFs of InitEnergyCountersMsrEx @ 0x1C0027A50
 * Callers:
 *     InitEnergyCounters @ 0x1C0024440 (InitEnergyCounters.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0003F30 (__security_check_cookie.c)
 *     GetCpuIdInfo @ 0x1C0004C40 (GetCpuIdInfo.c)
 *     ActivateFixedFunctionCounters @ 0x1C0006030 (ActivateFixedFunctionCounters.c)
 */
...
_DWORD *InitEnergyCountersMsrEx()
{
  ...
  if ( !v1 )
  {
    ...
    *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type |= 0x40u;
    qword_1C001AA30[0] = (__int64)SnapEnergyCounters;
    result = ComputeProcessorEnergyMsrEx;
    qword_1C001AA28[0] = (__int64)ComputeProcessorEnergyMsrEx;
  }
  return result;
}
