/*
 * XREFs of ProcLibTraceCoordinatedIdleStates @ 0x1C00284D8
 * Callers:
...
void __fastcall ProcLibTraceCoordinatedIdleStates(char a1)
{
  ...
  v1 = (unsigned int *)qword_1C001A8F0;
  PoolWithTag = 0LL;
  v4 = 0LL;
  if ( qword_1C001A8F0 )
  {
    ...
    if ( EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v5) )
    {
      ...
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v31 = PoolWithTag;
      v32 = 12 * v9;
      EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v5, 0LL, 2u, &UserData);
    }
    v10 = (const EVENT_DESCRIPTOR *)&PPM_ETW_GET_COORDINATED_DEPENDENCY;
    if ( a1 )
      v10 = &PPM_ETW_GET_COORDINATED_DEPENDENCY_RUNDOWN;
    if ( EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v10) )
    {
      i = 0;
      v11 = 0LL;
      if ( *v1 )
            ...
            if ( v1[v16 + 63] )
            {
              ...
              do
              {
                ...
                *(_QWORD *)&UserData.Size = 4LL;
                ...
                v43 = 0;
                v42 = v25;
                EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v10, 0LL, 7u, &UserData);
                v17 = v28 + 1;
                v28 = v17;
              }
              while ( v17 < v1[v16 + 63] );
