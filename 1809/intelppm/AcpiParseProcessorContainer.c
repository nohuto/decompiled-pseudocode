/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C002F150
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C002E610 (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     memset @ 0x1C0004FC0 (memset.c)
 *     GetDevExtByAcpiId @ 0x1C000830C (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C000B650 (RtlUnicodeStringCopyString.c)
