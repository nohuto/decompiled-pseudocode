/*
 * XREFs of InitPerfStatesInternal @ 0x1C0022910
 * Callers:
 *     RegisterKernelPerfStates @ 0x1C0023690 (RegisterKernelPerfStates.c)
 *     RegisterHvPerfStatesCounters @ 0x1C002D6A0 (RegisterHvPerfStatesCounters.c)
 * Callees:
 ...
 *     CalculatePercentageCap @ 0x1C0023290 (CalculatePercentageCap.c)
...
__int64 __fastcall InitPerfStatesInternal(__int64 a1, int (__fastcall *a2)(char *, _QWORD))
{
  ...
  if ( v15 )
  {
    ...
    *((_QWORD *)v4 + 8) = 100LL;
    if ( v8 && v5 )
    {
      *((_QWORD *)v4 + 34) = *(_QWORD *)(a1 + 328);
      *((_QWORD *)v4 + 35) = *(_QWORD *)(a1 + 336);
      *((_DWORD *)v4 + 5) = v5[2];
      v20 = v5[12 * v8 - 9];
      *v6 = *(_QWORD *)(a1 + 280);
      v6[3] = *(_QWORD *)(a1 + 296);
...
LABEL_46:
        ...
        *(_BYTE *)(v39 + 16) = v41;
        *(_BYTE *)(v39 + 17) = v41;
        DisplayKernelPerfStates((__int64)v4, (int)v36, v24);
        v42 = *((_QWORD *)v4 + 52);
