/*
 * XREFs of DeactivateFixedFunctionCounters @ 0x1C000666C
 * Callers:
 *     SnapEnergyCounters @ 0x1C00066E0 (SnapEnergyCounters.c)
 *     UnInitEnergyCounters @ 0x1C0027C10 (UnInitEnergyCounters.c)
 * Callees:
 *     <none>
 */
