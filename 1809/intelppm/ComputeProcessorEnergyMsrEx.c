/*
 * XREFs of ComputeProcessorEnergyMsrEx @ 0x1C00060B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
      ...
      do
      {
        ...
        ProcLibTracePackageEnergyCounterUpdate(
          *(unsigned int *)((char *)&WPP_MAIN_CB.Dpc.SystemArgument1 + v10 + 4),
          v12);
        *(_DWORD *)((char *)&WPP_MAIN_CB.DeviceQueue.Lock + v10) = *(_DWORD *)((char *)v78 + v10);
        v76[v10 / 4] = v12;
        v10 += 4LL;
        --SystemArgument1_low;
      }
    ...
    v80 = 0LL;
    v81 = 0LL;
    v74[0] = (__int64)&qword_1C001A3A8;
    v74[1] = (__int64)&qword_1C001A3A8;
    v74[2] = 0LL;
    ...
    while ( !(unsigned int)EnumerateNextDevice((__int64)v74, v82) )
    {
      ...
      v78[0] = 3LL;
      v22 = (unsigned __int64 *)(*(_QWORD *)(v82[0] + 344LL) + 24LL);
      do
      {
        v23 = *v22;
        v24 = *(v22 - 1);
    ...
    v26 = 1000000 * a3 / (qword_1C001AB40 * (unsigned __int64)(unsigned int)dword_1C001AB38);
    if ( !v26 || !v79 )
      goto LABEL_79;
    v27 = (double)(int)v80;
    if ( v80 < 0 )
...
LABEL_52:
    if ( HIDWORD(WPP_MAIN_CB.Dpc.DpcData) )
    {
      v47 = (double)((int)v26 * (int)qword_1C001AB48);
      if ( v26 * qword_1C001AB48 < 0 )
    ...
    do
    {
      v55 = *(double *)((char *)&WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink + v54 * 8) * v83[v54];
      ++v54;
      v53 = v53 + v55;
      --v38;
    }
