/*
 * XREFs of ProcLibTraceProcessorLpiRundown @ 0x1C0029980
 * Callers:
...
char __fastcall ProcLibTraceProcessorLpiRundown(__int64 a1)
{
  ...
  v2 = 0LL;
  LOBYTE(ProcessorNumber) = EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, &PPM_ETW_PROCESSOR_LPI_STATES);
...
LABEL_13:
      ...
      *(_QWORD *)&UserData[4].Size = 4LL;
      ...
      EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, &PPM_ETW_PROCESSOR_LPI_STATES, 0LL, 2 * v5 + 5, UserData);
LABEL_11:
