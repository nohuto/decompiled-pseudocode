/*
 * XREFs of wil_details_FeaturePropertyCache_ReportUsageToServiceDirect @ 0x1C0007550
 * Callers:
 ...
 *     wil_details_RecordUsageInPropertyCache @ 0x1C000772C (wil_details_RecordUsageInPropertyCache.c)
 */
