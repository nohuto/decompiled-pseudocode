/*
 * XREFs of PepIdlePrepare @ 0x1C000DF00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepIdleCancel @ 0x1C000DCA0 (PepIdleCancel.c)
 */
...
__int64 __fastcall PepIdlePrepare(_QWORD **a1)
{
  ...
  if ( dword_1C001A8D8 >= (unsigned int)dword_1C001A394 )
  {
    ...
    v19 = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C001A630)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C001A8E0 )
