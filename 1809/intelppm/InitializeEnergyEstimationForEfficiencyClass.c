/*
 * XREFs of InitializeEnergyEstimationForEfficiencyClass @ 0x1C0022300
 * Callers:
...
__int64 __fastcall InitializeEnergyEstimationForEfficiencyClass(unsigned int a1)
{
  ...
  v2 = &dword_1C001A938[64 * (unsigned __int64)a1];
  InitializeEnumerationContext((__int64)&qword_1C001A3A8, 32, (__int64)v11);
