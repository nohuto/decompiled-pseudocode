/*
 * XREFs of AcpiEval_CPC @ 0x1C002144C
 * Callers:
...
LABEL_15:
  ...
  if ( v10 )
  {
    ...
    if ( v11 )
    {
      v12 = 27;
      v13 = v11 != 1;
      v14 = (unsigned int *)&Cpc2RegisterTable;
    }
    else
    {
      v12 = 21;
      v13 = 0;
      v14 = (unsigned int *)&CpcRegisterTable;
      v3 = 15LL;
    }
    v5 = AcpiParseCore((unsigned int)v19, v12, (int)v6 + 12, v6[1] - 12, (__int64)v4, 236, (__int64)"_CPC", v13);
    if ( v5 < 0 )
    {
      v9 = 50;
      goto LABEL_15;
    ...
    do
    {
      AcpiTranslateAccessSize((char *)v4 + *v14, v15);
      v14 += 6;
      --v3;
    }
    while ( v3 );
