/*
 * XREFs of LpiTranslateCoordinatedIdleStates @ 0x1C0035A9C
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  v6 = 0LL;
  v7 = ValidateCoordinatedLpiStates((_DWORD *)qword_1C001A910, (__int64)a2);
  if ( v7 >= 0 )
  {
...
LABEL_25:
              ...
              while ( 1 )
              {
                ...
                *(_QWORD *)(Sizeb + 184) = *(_QWORD *)(v25 + 8);
                ...
                if ( v7 < 0 )
                  break;
                if ( (unsigned int)KeIsEqualAffinityEx(Sizeb, &unk_1C001A6A0) )
                {
                  *(_BYTE *)(Sizeb + 208) = 1;
                  v31 = 1;
                }
