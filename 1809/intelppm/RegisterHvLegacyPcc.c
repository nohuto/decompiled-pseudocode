/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C002CD60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C002D81C (DecodeDoorbellAddressIo.c)
 */
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  v17 = qword_1C001A818;
  v18 = dword_1C001A820;
  if ( (unsigned __int8)qword_1C001A818 <= 1u )
  {
    v4 = qword_1C001A810;
    v5 = qword_1C001A808;
    v15 = 0LL;
    if ( (_BYTE)qword_1C001A818 == 1 )
    {
  ...
  {
    LODWORD(v21[0]) = 0;
    HIDWORD(v21[0]) = dword_1C001A7C8;
    v21[2] = qword_1C001A7F8;
    LODWORD(v21[3]) = dword_1C001A800;
    v21[6] = v5 << v3;
    v21[5] = v4 << v3;
