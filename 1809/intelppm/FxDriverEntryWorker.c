/*
 * XREFs of FxDriverEntryWorker @ 0x1C00033D4
 * Callers:
 *     FxDriverEntry @ 0x1C0003560 (FxDriverEntry.c)
 * Callees:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_1C001AB70;
  ...
  if ( result >= 0 )
  {
    ...
    else
    {
      ...
      {
        DriverUnload = (void (__fastcall *)(_DRIVER_OBJECT *))qword_1C001A370;
        if ( DriverObject->DriverUnload )
          DriverUnload = DriverObject->DriverUnload;
        qword_1C001A370 = (__int64)DriverUnload;
