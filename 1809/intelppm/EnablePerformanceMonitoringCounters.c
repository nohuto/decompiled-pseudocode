/*
 * XREFs of EnablePerformanceMonitoringCounters @ 0x1C00349CC
 * Callers:
...
__int64 __fastcall EnablePerformanceMonitoringCounters(__int64 a1)
{
  ...
  v1 = (unsigned __int64)*(unsigned __int8 *)(a1 + 352) << 8;
  v3 = *(_DWORD *)((char *)&Globals[188] + v1);
  if ( v3 )
  {
    if ( v3 > 4 )
    ...
    v5 = 0;
    v6 = (int *)v14;
    for ( i = (int *)((char *)&Globals[188] + v1 + 4); ; i += 3 )
    {
      v8 = *i;
      *v6 = *i;
