/*
 * XREFs of InitAcpiCpc @ 0x1C0020470
 * Callers:
...
LABEL_36:
  ...
  if ( v12 )
  {
    v15 = (*(__int64 (__fastcall **)(_QWORD))(qword_1C001A8B0 + 88))(*(_QWORD *)(qword_1C001A8B0 + 56));
    v3 = v15;
    if ( v15 < 0 )
    {
      v16 = 14;
  ...
  if ( v12 )
  {
    v3 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(qword_1C001A8B0 + 104))(*(_QWORD *)(qword_1C001A8B0 + 56), 0LL);
    if ( v3 == -1073741435 )
      v3 = 0;
    if ( v3 < 0 )
    {
