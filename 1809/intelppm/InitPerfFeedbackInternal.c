/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C00311EC
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x1C002D1C0 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x1C0032AA0 (RegisterKernelPerfFeedback.c)
 * Callees:
