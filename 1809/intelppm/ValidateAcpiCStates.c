/*
 * XREFs of ValidateAcpiCStates @ 0x1C00208C0
 * Callers:
...
LABEL_25:
          ...
          case 1:
            goto LABEL_25;
          case 2:
            if ( !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001AD9C, v2, v4, v1) )
            {
              v16 = 26;
              goto LABEL_24;
            }
            break;
          default:
            if ( !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001ADB4, v2, v4, v1)
              || !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001AD84, v10, v11, v12)
              || !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001AD9C, v13, v14, v15) )
            {
              v16 = 27;
              goto LABEL_24;
            }
