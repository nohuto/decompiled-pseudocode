/*
 * XREFs of ?ProcessLPCCommand@CDwmAppHost@@AEAAJPEAVCPortMessage@@PEBUPORT_CONTEXT@@PEAH2@Z @ 0x140001040
 * Callers:
 *     ?s_LpcCommandHandler@CDwmAppHost@@CAJPEAVCPortMessage@@PEBUPORT_CONTEXT@@PEAH2@Z @ 0x140001020 (-s_LpcCommandHandler@CDwmAppHost@@CAJPEAVCPortMessage@@PEBUPORT_CONTEXT@@PEAH2@Z.c)
 * Callees:
  ...
  *a5 = 0;
  ...
  if ( (*(_WORD *)(v8 + 4) & 0x7FFF) == 1 )
  {
    ...
    if ( v18 )
    {
      ...
      else if ( *(_DWORD *)(v9 + 8) == (_DWORD)qword_14000B830 )
      {
        CSettingsManager::PropagateUserLogon((CSettingsManager *)qword_14000B858, 0LL, 0LL, 1);
...
LABEL_5:
    ...
    else if ( *(_DWORD *)(v9 + 8) == (_DWORD)qword_14000B830 )
    {
      CSettingsManager::PropagateUserLogon(
        (CSettingsManager *)qword_14000B858,
        *(HKEY *)(v9 + 52),
        *(HKEY *)(v9 + 60),
        *(_DWORD *)(v9 + 68) != 0);
    }
