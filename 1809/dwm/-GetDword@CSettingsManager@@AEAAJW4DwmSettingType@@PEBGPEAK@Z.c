/*
 * XREFs of ?GetDword@CSettingsManager@@AEAAJW4DwmSettingType@@PEBGPEAK@Z @ 0x1400023F0
 * Callers:
 ...
 *     ?ReadRegistryDwords@CSettingsManager@@UEAAJW4DwmSettingType@@PEAUDwordRegistrySetting@@I@Z @ 0x140002370 (-ReadRegistryDwords@CSettingsManager@@UEAAJW4DwmSettingType@@PEAUDwordRegistrySetting@@I@Z.c)
 *     ?GetPolicyDword@CSettingsManager@@UEAAJPEBGPEAK@Z @ 0x1400053D0 (-GetPolicyDword@CSettingsManager@@UEAAJPEBGPEAK@Z.c)
 * Callees:
 *     <none>
 */
