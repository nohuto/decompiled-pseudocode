...
LABEL_11:
    ...
    if ( v16 < dword_1C00E71A8 )
    {
      v10 = 0;
      v157 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E5B28);
      if ( v16 < dword_1C00E71A8 )
        v10 = *((_DWORD *)P + 6 * v16);
      KeReleaseSpinLock(&qword_1C00E5B28, v157);
      if ( !v10 )
        v10 = 1;
    }
    else
  ...
  if ( qword_1C00E5B38 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E5B38 )
  {
    while ( *((_DWORD *)v20 + 4) != v12 )
    {
      if ( *((_DWORD *)v20 + 4) <= v12 )
      {
        ...
        if ( v20 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E5B38 )
          continue;
      }
      goto LABEL_19;
    }
