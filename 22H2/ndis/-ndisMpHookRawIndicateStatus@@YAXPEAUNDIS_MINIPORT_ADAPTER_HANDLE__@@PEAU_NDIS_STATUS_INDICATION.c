/*
 * XREFs of ?ndisMpHookRawIndicateStatus@@YAXPEAUNDIS_MINIPORT_ADAPTER_HANDLE__@@PEAU_NDIS_STATUS_INDICATION@@@Z @ 0x1C00AD130
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMpHookRawIndicateStatus(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_STATUS_INDICATION *a2)
{
