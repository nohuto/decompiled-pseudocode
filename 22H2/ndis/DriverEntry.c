/*
 * XREFs of DriverEntry @ 0x1C01448F0
 * Callers:
 ...
 *     McGenEventRegister_EtwRegister @ 0x1C0032BBC (McGenEventRegister_EtwRegister.c)
 *     ?ndisDoesSystemSupportSriov@@YAXXZ @ 0x1C0032FA8 (-ndisDoesSystemSupportSriov@@YAXXZ.c)
 *     ?ndisRegisterPDCounterSets@@YAXXZ @ 0x1C00337E4 (-ndisRegisterPDCounterSets@@YAXXZ.c)
 ...
 *     ?ndisWppInitTracingEx@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z @ 0x1C0039804 (-ndisWppInitTracingEx@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z.c)
 *     ?ndisVerifierInitialization@@YAEXZ @ 0x1C003A1C4 (-ndisVerifierInitialization@@YAEXZ.c)
 *     __security_check_cookie @ 0x1C003D910 (__security_check_cookie.c)
 *     memset @ 0x1C0040B00 (memset.c)
 *     wil_UninitializeFeatureStaging @ 0x1C00F9328 (wil_UninitializeFeatureStaging.c)
 *     ?Initialize@KPushLockManualConstruct@@QEAAXXZ @ 0x1C00F9928 (-Initialize@KPushLockManualConstruct@@QEAAXXZ.c)
 *     ??0NDIS_PD_GLOBAL@@QEAA@XZ @ 0x1C0109794 (--0NDIS_PD_GLOBAL@@QEAA@XZ.c)
 ...
 *     ?ndisInitializeStackTraces@@YAXXZ @ 0x1C010C99C (-ndisInitializeStackTraces@@YAXXZ.c)
 ...
 *     ?ndisCreateGenericSD@@YAJPEAU_ACL@@PEAD@Z @ 0x1C0145344 (-ndisCreateGenericSD@@YAJPEAU_ACL@@PEAD@Z.c)
 ...
 *     ?ndisMiniportFdoInitializeSubsystem@@YAJXZ @ 0x1C01469F4 (-ndisMiniportFdoInitializeSubsystem@@YAJXZ.c)
 *     ?ndisVBusNmrInitializeClient@@YAJXZ @ 0x1C0146A4C (-ndisVBusNmrInitializeClient@@YAJXZ.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((ULONGLONG *)&dword_1C00E4108);
  ...
  if ( v6 >= 0 )
  {
    ...
    *((_QWORD *)ndisDriverObject + 10) = &unk_1C00C9870;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    KeInitializeSpinLock(&qword_1C00E6E68);
    qword_1C00E7100 = (__int64)&qword_1C00E70F8;
    qword_1C00E70F8 = (__int64)&qword_1C00E70F8;
    KeInitializeSpinLock(&qword_1C00E6E70);
    qword_1C00E7110 = (__int64)&qword_1C00E7108;
    qword_1C00E7108 = (__int64)&qword_1C00E7108;
    qword_1C00E7040 = (__int64)&ndisGlobalPacketPoolList;
    ndisGlobalPacketPoolList.Flink = &ndisGlobalPacketPoolList;
    qword_1C00E5D08 = (__int64)&ndisGlobalTimerList;
    ...
    *(_QWORD *)&Parameters.PoolTag = 1684948046LL;
    qword_1C00E5B08 = (__int64)&g_ndisWatchdogList;
    ...
    *(_QWORD *)&v41.PoolTag = 1684948046LL;
    ...
    if ( (int)ndisGetProcessorInfo() >= 0 )
    {
      ...
      qword_1C00E53F8 = (__int64)KeRegisterProcessorChangeCallback(
...
LABEL_43:
    ...
    *(_QWORD *)&Info.CounterCount = 10LL;
    ...
    qword_1C00E4EE8 = (__int64)&PktMonCompList;
    PktMonCompList = (__int64)&PktMonCompList;
    PktMonClientNotify.ClientRegistrationInstance.ModuleId = &NPI_MS_NDIS_MODULEID;
    qword_1C00E4FD8 = (__int64)ndisPktMonRegisterComponentsCallback;
    NmrRegisterClient(&PktMonClientNotify, &PktMon, &PktMon);
    ndisRegisterPDCounterSets();
    word_1C00E47FE = *(_WORD *)ndisNblTrackerMode;
    word_1C00E4800 = ndisMaxNumberOfProcessors;
    qword_1C00E4808 = (__int64)&qword_1C00E7108;
