/*
 * XREFs of ?ndisValidatePDCapsBuffer@@YAEKPEBU_NDIS_PD_CAPABILITIES@@@Z @ 0x1C001E7E8
 * Callers:
 *     ?ndisValidatePDConfigBuffer@@YAEKPEBU_NDIS_PD_CONFIG@@@Z @ 0x1C001E654 (-ndisValidatePDConfigBuffer@@YAEKPEBU_NDIS_PD_CONFIG@@@Z.c)
 * Callees:
 *     ?ndisValidateGFPExactMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_EXACT_MATCH_PROFILE@@@Z @ 0x1C001E6EC (-ndisValidateGFPExactMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_EXACT_MATCH_PROFILE@@@Z.c)
 ...
 *     ?ndisValidateGFPWildcardMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_WILDCARD_MATCH_PROFILE@@@Z @ 0x1C007EB48 (-ndisValidateGFPWildcardMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_WILDCARD_MATCH_PROFILE@@@Z.c)
 */

char __fastcall ndisValidatePDCapsBuffer(unsigned int a1, const struct _NDIS_PD_CAPABILITIES *a2)
{
  char v4; // bl
  unsigned int CapabilityFlags; // eax
  ...
  if ( !a2->Flags )
  {
    ...
    if ( (CapabilityFlags & 0xFFFFFFF0) == 0
      ...
      && ((CapabilityFlags & 2) != 0 || (CapabilityFlags & 0xC) == 0) )
    {
