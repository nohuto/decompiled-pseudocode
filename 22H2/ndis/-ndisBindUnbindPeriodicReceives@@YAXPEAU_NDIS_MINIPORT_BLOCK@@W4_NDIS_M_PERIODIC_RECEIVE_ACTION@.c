/*
 * XREFs of ?ndisBindUnbindPeriodicReceives@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_M_PERIODIC_RECEIVE_ACTION@@@Z @ 0x1C0020400
 * Callers:
    ...
    if ( a2 >= 0 )
    {
      if ( a2 > 2 )
      {
        ...
        *(_QWORD *)(a1 + 3184) = CurrentThread;
        if ( v6 && *(_DWORD *)(a1 + 3168) )
        {
          ...
          v7 = qword_1C00E50D8;
          if ( qword_1C00E50D8 == (void *)a1 )
          {
            qword_1C00E50D8 = (void *)*((_QWORD *)qword_1C00E50D8 + 395);
          }
          else
          {
            while ( v7 )
      ...
      else
      {
        ...
        *(_QWORD *)(a1 + 3184) = KeGetCurrentThread();
        ++*(_DWORD *)(a1 + 3216);
        if ( dword_1C00E50C4 != -1 && !*(_DWORD *)(a1 + 464) && byte_1C00E50C1 == 1 && !*(_DWORD *)(a1 + 3168) )
