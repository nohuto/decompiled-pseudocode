/*
 * XREFs of NdisWdfPnpPowerEventHandler @ 0x1C00629C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisWdfDeviceObjectCleanup@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C011F574 (-ndisWdfDeviceObjectCleanup@@YAJPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
