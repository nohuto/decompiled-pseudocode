/*
 * XREFs of ?ndisInitializePeriodicReceives@@YAHXZ @ 0x1C01441F0
 * Callers:
 ...
 *     NdisAllocateRWLock @ 0x1C002D290 (NdisAllocateRWLock.c)
...
__int64 ndisInitializePeriodicReceives(void)
{
  ...
  *(_WORD *)((char *)&Parameters.DataSize + 1) = 0;
  ...
  qword_1C00E5100 = ExAllocatePoolWithTag(NonPagedPoolNx, v4 << 6, 0x2020444Eu);
  if ( !qword_1C00E5100 )
    goto LABEL_15;
  v5 = ndisMaxNumberOfProcessors;
  for ( i = 0; i < ndisMaxNumberOfProcessors; ++i )
  {
    v7 = (char *)qword_1C00E5100 + 64 * (unsigned __int64)i;
    *((_QWORD *)v7 + 1) = v7;
    *(_QWORD *)v7 = v7;
  ...
  qword_1C00E50F0 = ExAllocatePoolWithTag(NonPagedPoolNx, v9 << 7, 0x2020444Eu);
  if ( !qword_1C00E50F0 )
    goto LABEL_15;
  for ( j = 0; j < ndisNumberOfActiveProcessorsAtBoot; ++j )
  {
    ...
    NdisInitializeTimer(
      (PNDIS_TIMER)((char *)qword_1C00E50F0 + v11),
      (PNDIS_TIMER_FUNCTION)ndisPeriodicReceivesTimer,
      0LL);
    KeSetTargetProcessorDpcEx((PKDPC)((char *)qword_1C00E50F0 + v11 + 64), &ProcNumber);
  }
