/*
 * XREFs of ?ndisAttachFilterInner@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_FILTER_DRIVER_BLOCK@@KPEAUNDIS_BIND_FILTER_LINK@@@Z @ 0x1C012E1DC
 * Callers:
 ...
 *     ?ndisCloseRef@@YAEPEAU_REFERENCE_EX@@@Z @ 0x1C002559C (-ndisCloseRef@@YAEPEAU_REFERENCE_EX@@@Z.c)
 ...
 *     ?ndisFilterXStateSetFlag@@YAXPEAU_NDIS_FILTER_BLOCK@@E@Z @ 0x1C00257A0 (-ndisFilterXStateSetFlag@@YAXPEAU_NDIS_FILTER_BLOCK@@E@Z.c)
 ...
 *     ?ndisOpenRef@@YAXPEAU_REFERENCE_EX@@@Z @ 0x1C0026144 (-ndisOpenRef@@YAXPEAU_REFERENCE_EX@@@Z.c)
 ...
 *     ?NDIS_RELEASE_FILTER_SPIN_LOCK@@YAXPEAU_NDIS_FILTER_BLOCK@@E@Z @ 0x1C003DA98 (-NDIS_RELEASE_FILTER_SPIN_LOCK@@YAXPEAU_NDIS_FILTER_BLOCK@@E@Z.c)
 ...
 *     ?Initialize@KString@Rtl@@SAPEAU12@PEB_W@Z @ 0x1C0102194 (-Initialize@KString@Rtl@@SAPEAU12@PEB_W@Z.c)
 ...
 *     ?AddBindContext@BindState@Ndis@@QEAA_NPEAX@Z @ 0x1C0103F8C (-AddBindContext@BindState@Ndis@@QEAA_NPEAX@Z.c)
 *     ?ndisInitializeRef@@YAXPEAU_REFERENCE_EX@@E@Z @ 0x1C0106F18 (-ndisInitializeRef@@YAXPEAU_REFERENCE_EX@@E@Z.c)
 *     ?ndisInitializeZeroBasedRef@@YAXPEAU_REFERENCE_EX@@E@Z @ 0x1C0107310 (-ndisInitializeZeroBasedRef@@YAXPEAU_REFERENCE_EX@@E@Z.c)
