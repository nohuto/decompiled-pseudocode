/*
 * XREFs of ?ndisMSetRssCapabilities@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RECEIVE_SCALE_CAPABILITIES@@@Z @ 0x1C0023B58
 * Callers:
 ...
 * Callees:
 *     ndisRssPmObjectHeaderFixup @ 0x1C0023BEC (ndisRssPmObjectHeaderFixup.c)
