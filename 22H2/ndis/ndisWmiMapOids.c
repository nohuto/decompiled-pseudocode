/*
 * XREFs of ndisWmiMapOids @ 0x1C0030B28
 * Callers:
 *     ndisQuerySupportedGuidToOidList @ 0x1C0030688 (ndisQuerySupportedGuidToOidList.c)
 *     ?ndisWdfGetGuidToOidList@@YAXPEBKGPEAU_NDIS_GUID@@PEAG@Z @ 0x1C008CEF8 (-ndisWdfGetGuidToOidList@@YAXPEBKGPEAU_NDIS_GUID@@PEAG@Z.c)
 * Callees:
 *     <none>
 */
