/*
 * XREFs of ?ndisNsiGetAllIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C00B4AF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisIfFindNextRcvAddress @ 0x1C01288D4 (ndisIfFindNextRcvAddress.c)
 *     ndisIfFindRcvAddress @ 0x1C0128964 (ndisIfFindRcvAddress.c)
