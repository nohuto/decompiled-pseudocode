/*
 * XREFs of ??0_NDIS_MINIPORT_BLOCK@@QEAA@XZ @ 0x1C0031CE4
 * Callers:
 ...
 * Callees:
 *     ??0BindEngine@Ndis@@QEAA@XZ @ 0x1C0109094 (--0BindEngine@Ndis@@QEAA@XZ.c)
 *     ??0BindStack@Ndis@@QEAA@XZ @ 0x1C0109124 (--0BindStack@Ndis@@QEAA@XZ.c)
 *     ??0KPushLock@@QEAA@XZ @ 0x1C0123340 (--0KPushLock@@QEAA@XZ.c)
 */
