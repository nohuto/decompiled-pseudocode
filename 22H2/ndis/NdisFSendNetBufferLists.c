/*
 * XREFs of NdisFSendNetBufferLists @ 0x1C0005B90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  if ( byte_1C00E4FD0 )
  {
    v32 = *((_QWORD *)NdisFilterHandle + 109);
    if ( v32 )
    {
      if ( (*(_DWORD *)(v32 + 52) & 1) != 0 )
        PktMonClientNblLogNdis((char *)NdisFilterHandle + 848, NetBufferList, *(_QWORD *)&PortNumber, 2LL);
    }
  }
