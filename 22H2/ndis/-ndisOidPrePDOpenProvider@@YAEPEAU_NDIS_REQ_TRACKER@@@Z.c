/*
 * XREFs of ?ndisOidPrePDOpenProvider@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C011DB80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z @ 0x1C011D738 (-ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z.c)
 */
...
LABEL_41:
  ...
  v30.m_Lock = (KPushLockBase *)qword_1C00E5528;
  ...
  *(_QWORD *)(v25 + 8) = v24;
  ...
  if ( (_UNKNOWN *)v2[10] == &unk_1C00C9980 )
    *((_BYTE *)v2 + 88) = 1;
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    v28 = L"PASS_THROUGH";
