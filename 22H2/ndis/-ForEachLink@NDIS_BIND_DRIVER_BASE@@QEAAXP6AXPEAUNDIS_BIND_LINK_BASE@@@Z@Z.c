/*
 * XREFs of ?ForEachLink@NDIS_BIND_DRIVER_BASE@@QEAAXP6AXPEAUNDIS_BIND_LINK_BASE@@@Z@Z @ 0x1C01065C8
 * Callers:
 *     NdisReEnumerateProtocolBindings @ 0x1C0099170 (NdisReEnumerateProtocolBindings.c)
 *     ?SetRunningDriverIsReady@NDIS_BIND_DRIVER_BASE@@IEAAX_NW4CallRunMode@@@Z @ 0x1C0106570 (-SetRunningDriverIsReady@NDIS_BIND_DRIVER_BASE@@IEAAX_NW4CallRunMode@@@Z.c)
 *     _lambda_9f85fcd2040f04b850747010404e3e47_::_lambda_invoker_cdecl_ @ 0x1C010C5A0 (_lambda_9f85fcd2040f04b850747010404e3e47_--_lambda_invoker_cdecl_.c)
 ...
 *     ?ReleaseShared@KLockHolder@@QEAAXXZ @ 0x1C010B2D0 (-ReleaseShared@KLockHolder@@QEAAXXZ.c)
 */
...
void __fastcall NDIS_BIND_DRIVER_BASE::ForEachLink(NDIS_BIND_DRIVER_BASE *this, void (__fastcall *a2)(_LIST_ENTRY *))
{
  ...
  v7.m_State = Unlocked;
  v7.m_Lock = (KPushLockBase *)(qword_1C00E5548 + 8);
