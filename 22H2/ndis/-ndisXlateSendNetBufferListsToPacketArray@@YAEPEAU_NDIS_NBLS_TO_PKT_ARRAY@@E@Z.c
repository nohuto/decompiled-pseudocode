/*
 * XREFs of ?ndisXlateSendNetBufferListsToPacketArray@@YAEPEAU_NDIS_NBLS_TO_PKT_ARRAY@@E@Z @ 0x1C0076508
 * Callers:
 ...
 *     NdisGetNetBufferListProtocolId @ 0x1C00AD930 (NdisGetNetBufferListProtocolId.c)
 */
