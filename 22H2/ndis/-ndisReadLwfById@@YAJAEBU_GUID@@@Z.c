/*
 * XREFs of ?ndisReadLwfById@@YAJAEBU_GUID@@@Z @ 0x1C01261E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?insertSorted@?$KArray@ULwfBindProperties@@$00@Rtl@@QEAA_N$$QEAULwfBindProperties@@P6A_NAEBU3@1@Z@Z @ 0x1C0125338 (-insertSorted@-$KArray@ULwfBindProperties@@$00@Rtl@@QEAA_N$$QEAULwfBindProperties@@P6A_NAEBU3@1@.c)
...
__int64 __fastcall ndisReadLwfById(const struct _GUID *a1)
{
  ...
  {
    m_ptr = (void **)&v7;
    FilterAltitude = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D4558, (__int64)&v10);
    if ( !FilterAltitude )
    {
      FilterAltitude = ndisBlowStringListIntoAtoms(
                         &m_ptr,
                         (const struct _NETSETUPPROPKEY *)&unk_1C00D4570,
                         (__int64)&v12);
      if ( !FilterAltitude )
      {
        ...
        if ( !FilterAltitude )
        {
          FilterAltitude = NetSetupPropertyBag::ReadBoolean(
                             &m_ptr,
                             (const struct _NETSETUPPROPKEY *)&unk_1C00D45A0,
                             &v15);
          if ( !FilterAltitude )
          {
            v5 = 0;
            NetSetupPropertyBag::ReadBoolean(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D4588, &v5);
            v3 = v5 ? (char *)qword_1C00E55C8 + 56 : (char *)qword_1C00E55C8 + 40;
