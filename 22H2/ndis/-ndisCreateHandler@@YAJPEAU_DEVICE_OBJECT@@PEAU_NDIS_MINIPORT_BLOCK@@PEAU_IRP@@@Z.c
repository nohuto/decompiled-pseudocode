/*
 * XREFs of ?ndisCreateHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C0006110
 * Callers:
 *     ?ndisCreateIrpHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z @ 0x1C00060F0 (-ndisCreateIrpHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z.c)
 *     NdisWdfCreateIrpHandler @ 0x1C0062600 (NdisWdfCreateIrpHandler.c)
 * Callees:
...
LABEL_19:
    ...
    {
      v19 = 0;
      v61 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E5B28);
      if ( ThreadSessionId < dword_1C00E71A8 )
        v19 = *((_DWORD *)P + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00E5B28, v61);
      if ( !v19 )
        v19 = 1;
    }
    else
  ...
  if ( qword_1C00E5B38 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E5B38 )
  {
    while ( *((_DWORD *)v26 + 4) != v20 )
    {
      if ( *((_DWORD *)v26 + 4) <= v20 )
      {
        ...
        if ( v26 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E5B38 )
          continue;
      }
      goto LABEL_27;
    }
