/*
 * XREFs of NdisClOpenAddressFamilyEx @ 0x1C00B6940
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)NdisBindingHandle + 130) = *(_QWORD *)(v25 + 8);
    *((_QWORD *)NdisBindingHandle + 131) = *(_QWORD *)(v25 + 16);
    *((_QWORD *)NdisBindingHandle + 143) = *(_QWORD *)(v25 + 32);
    *((_QWORD *)NdisBindingHandle + 144) = *(_QWORD *)(v25 + 24);
