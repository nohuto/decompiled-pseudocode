/*
 * XREFs of PktMonClientNblLog @ 0x1C004050C
 * Callers:
...
void __fastcall PktMonClientNblLog(__int64 a1, __int64 a2, int a3, __int64 a4, int a5, int a6)
{
  ...
  if ( byte_1C00E4FD0 )
  {
    ...
    if ( v9 )
    {
      if ( (*(_DWORD *)(v9 + 52) & 1) != 0 && (*(_DWORD *)(a2 + 128) & 0x8000) == 0 )
      {
        if ( ExAcquireRundownProtectionCacheAware(RunRefCacheAware) )
        {
          ...
          v16 = a3;
          v19 = 0LL;
          (*(void (__fastcall **)(_QWORD, __int64, __int16 *, _QWORD))(*((_QWORD *)&xmmword_1C00E4FE8 + 1) + 40LL))(
            xmmword_1C00E4FE8,
            v10,
            &v11,
            0LL);
