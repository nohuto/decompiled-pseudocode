/*
 * XREFs of ?ndisWmiQuerySingleInstance@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@PEAUtagWNODE_SINGLE_INSTANCE@@KPEAK@Z @ 0x1C00106E0
 * Callers:
 *     ndisWMIDispatch @ 0x1C0010BF0 (ndisWMIDispatch.c)
 *     NdisWdfQuerySingleInstance @ 0x1C0062C10 (NdisWdfQuerySingleInstance.c)
 * Callees:
