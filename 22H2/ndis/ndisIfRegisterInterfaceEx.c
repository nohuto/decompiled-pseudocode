/*
 * XREFs of ndisIfRegisterInterfaceEx @ 0x1C002B8BC
 * Callers:
 *     NdisIfRegisterInterface @ 0x1C00B2640 (NdisIfRegisterInterface.c)
 ...
 *     ?AllocateAnyBit@IfIndexRange@@QEAAJPEAK@Z @ 0x1C002BE70 (-AllocateAnyBit@IfIndexRange@@QEAAJPEAK@Z.c)
 *     ndisIfTryAllocatingSuggestedIndex @ 0x1C002BEF8 (ndisIfTryAllocatingSuggestedIndex.c)
...
LABEL_59:
  ...
  *(_OWORD *)(v12 + 135) = *(_OWORD *)(a4 + 52);
  ...
  if ( a1 == qword_1C00E7130 || a1 == qword_1C00E7128 )
  {
    v16 = 5LL;
    v17 = v12 + 144;
    v18 = (_OWORD *)(a4 + 96);
