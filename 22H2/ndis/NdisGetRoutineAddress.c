/*
 * XREFs of NdisGetRoutineAddress @ 0x1C003CCB0
 * Callers:
 *     ?ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z @ 0x1C00AC6F0 (-ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
 *     FindExportedRoutineByName @ 0x1C003CD18 (FindExportedRoutineByName.c)
 */
