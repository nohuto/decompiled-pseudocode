/*
 * XREFs of ?ndisReinitializeMiniportBlock@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0136F2C
 * Callers:
 ...
 *     ?ndisOpenULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z @ 0x1C00AC270 (-ndisOpenULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z.c)
