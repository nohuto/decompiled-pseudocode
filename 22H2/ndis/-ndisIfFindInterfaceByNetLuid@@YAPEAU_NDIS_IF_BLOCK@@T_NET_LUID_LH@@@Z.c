/*
 * XREFs of ?ndisIfFindInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z @ 0x1C002F0B4
 * Callers:
 ...
 *     NdisIfGetInterfaceIndexFromNetLuid @ 0x1C00B2530 (NdisIfGetInterfaceIndexFromNetLuid.c)
