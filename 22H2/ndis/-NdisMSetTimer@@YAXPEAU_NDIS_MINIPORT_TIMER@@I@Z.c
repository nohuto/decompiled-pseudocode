/*
 * XREFs of ?NdisMSetTimer@@YAXPEAU_NDIS_MINIPORT_TIMER@@I@Z @ 0x1C00177D0
 * Callers:
 *     NdisSetTimer @ 0x1C001A0B0 (NdisSetTimer.c)
 *     NdisSetPeriodicTimer @ 0x1C00BDF90 (NdisSetPeriodicTimer.c)
 *     NdisSetTimerEx @ 0x1C00BDFE0 (NdisSetTimerEx.c)
