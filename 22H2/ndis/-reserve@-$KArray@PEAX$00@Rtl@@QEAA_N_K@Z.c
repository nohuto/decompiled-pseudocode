/*
 * XREFs of ?reserve@?$KArray@PEAX$00@Rtl@@QEAA_N_K@Z @ 0x1C0104090
 * Callers:
 *     ?grow@?$KArray@PEAX$00@Rtl@@AEAA_N_K@Z @ 0x1C010404C (-grow@-$KArray@PEAX$00@Rtl@@AEAA_N_K@Z.c)
 *     ?resize@?$KArray@PEAX$00@Rtl@@QEAA_N_K@Z @ 0x1C010D5C4 (-resize@-$KArray@PEAX$00@Rtl@@QEAA_N_K@Z.c)
 * Callees:
