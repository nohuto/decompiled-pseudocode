/*
 * XREFs of ?ReadNetworkInterfaceV2@BindRegistry@Ndis@@YAJAEAVKRegKey@@0AEAUNdisNetworkInterfacePersistedState@@@Z @ 0x1C010228C
 * Callers:
        ...
        struct NdisNetworkInterfacePersistedState *a4)
{
  ...
  result = NetSetupPropertyBag::ReadString(
             ...
             (const struct _NETSETUPPROPKEY *)&unk_1C00CA450,
             &a3->m_ptr);
  if ( (int)result < 0 )
    return result;
  result = NetSetupPropertyBag::ReadString(
             (NetSetupPropertyBag *)&v19,
             (const struct _NETSETUPPROPKEY *)&unk_1C00CA420,
             &a3[1].m_ptr);
  if ( (int)result < 0 )
    return result;
  v18 = 0;
  Uint64 = NetSetupPropertyBag::ReadUint32(
             (NetSetupPropertyBag *)&v19,
             (const struct _NETSETUPPROPKEY *)&unk_1C00CA408,
             &v18);
  if ( Uint64 < 0 )
  {
...
LABEL_49:
  ...
  Uint64 = NetSetupPropertyBag::ReadUint64(
             (NetSetupPropertyBag *)&v19,
             (const struct _NETSETUPPROPKEY *)&unk_1C00CA390,
  ...
  if ( (int)NetSetupPropertyBag::ReadUint32(
              (NetSetupPropertyBag *)&v19,
              (const struct _NETSETUPPROPKEY *)&unk_1C00CA3A8,
              (unsigned int *)&a3[7]) < 0 )
    LODWORD(a3[7].m_ptr) = 0;
  if ( (int)NetSetupPropertyBag::ReadUint32(
              (NetSetupPropertyBag *)&v19,
              (const struct _NETSETUPPROPKEY *)&unk_1C00CA378,
              (unsigned int *)&a3[7].m_ptr + 1) < 0 )
    HIDWORD(a3[7].m_ptr) = 0;
  result = NetSetupPropertyBag::ReadBoolean(
             (NetSetupPropertyBag *)&v19,
             (const struct _NETSETUPPROPKEY *)&unk_1C00CA3F0,
             (bool *)&a3[16].m_ptr + 5);
  if ( (int)result >= 0 )
  {
    result = NetSetupPropertyBag::ReadBoolean(
               (NetSetupPropertyBag *)&v19,
               (const struct _NETSETUPPROPKEY *)&unk_1C00CA4B0,
               (bool *)&a3[16].m_ptr + 4);
    if ( (int)result >= 0 )
    {
      result = NetSetupPropertyBag::ReadUint32(
                 (NetSetupPropertyBag *)&v19,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00CA360,
                 (unsigned int *)&a3[4]);
      ...
      result = NetSetupPropertyBag::ReadBoolean(
                 (NetSetupPropertyBag *)&v19,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00CA438,
                 (bool *)&a3[16].m_ptr + 7);
      if ( (_DWORD)result == -1073741772 )
      {
        BYTE6(a3[16].m_ptr) = 0;
      ...
      result = NetSetupPropertyBag::ReadUint32(
                 (NetSetupPropertyBag *)&v19,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00CA498,
                 (unsigned int *)&a3[17]);
      if ( (_DWORD)result == -1073741772 )
      {
        BYTE6(a3[16].m_ptr) = 0;
      ...
      result = NetSetupPropertyBag::ReadUint32(
                 (NetSetupPropertyBag *)&v19,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00CA480,
      ...
      result = NetSetupPropertyBag::ReadUint32(
                 (NetSetupPropertyBag *)&v19,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00CA468,
                 (unsigned int *)&a3[18]);
      if ( (_DWORD)result == -1073741772 )
      {
        BYTE6(a3[16].m_ptr) = 0;
