/*
 * XREFs of ?ndisIfUpdateInterfaceIsolationNetworkIdLocked@@YAJPEAU_NDIS_IF_BLOCK@@AEBU_GUID@@E@Z @ 0x1C0025EAC
 * Callers:
  ...
  if ( Network )
  {
    ...
    if ( NetworkBlock )
    {
      if ( (*((_DWORD *)NetworkBlock + 18) & 3) == 0 )
      {
        ...
        if ( a1->ProviderHandle != qword_1C00E7130 || (a1->Flags & 2) == 0 )
          goto LABEL_24;
        v12 = 0;
        NetworkGuid = 0LL;
        if ( a1->IsNdisFilter )
