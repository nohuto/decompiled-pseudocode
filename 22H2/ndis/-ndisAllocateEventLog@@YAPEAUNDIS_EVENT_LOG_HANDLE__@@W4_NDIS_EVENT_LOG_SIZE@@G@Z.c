/*
 * XREFs of ?ndisAllocateEventLog@@YAPEAUNDIS_EVENT_LOG_HANDLE__@@W4_NDIS_EVENT_LOG_SIZE@@G@Z @ 0x1C010BBAC
 * Callers:
 ...
 *     ?ndisEventEntryCount@@YAKW4_NDIS_EVENT_LOG_SIZE@@@Z @ 0x1C010BD18 (-ndisEventEntryCount@@YAKW4_NDIS_EVENT_LOG_SIZE@@@Z.c)
 */
