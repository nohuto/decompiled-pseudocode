/*
 * XREFs of ?ndisPktMonFilterRegister@@YAJPEAU_NDIS_FILTER_BLOCK@@@Z @ 0x1C01019C4
 * Callers:
 ...
 *     ?ndisReferenceRef@@YAEPEAU_REFERENCE_EX@@E@Z @ 0x1C0026944 (-ndisReferenceRef@@YAEPEAU_REFERENCE_EX@@E@Z.c)
