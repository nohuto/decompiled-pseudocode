/*
 * XREFs of ?ndisCloseHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C006BA58
 * Callers:
 *     NdisWdfCloseIrpHandler @ 0x1C00625D0 (NdisWdfCloseIrpHandler.c)
 * Callees:
