/*
 * XREFs of ?ndisPDPcwCallback@@YAJW4_PCW_CALLBACK_TYPE@@PEAT_PCW_CALLBACK_INFORMATION@@PEAX@Z @ 0x1C007E2D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisPDPcwCallback(unsigned int a1, union _PCW_CALLBACK_INFORMATION *a2, void *a3)
{
  ...
  *(_QWORD *)&Data.Size = 0LL;
  if ( a1 <= 1 )
    return 0LL;
  v18.m_Lock = (KPushLockBase *)qword_1C00E5528;
  v18.m_State = Unlocked;
  v18.m_Region.m_Entered = 0;
  KLockHolder::AcquireExclusive(&v18);
  v6 = qword_1C00E5528;
  v7 = qword_1C00E5528 + 8;
  v8 = *(_QWORD **)(qword_1C00E5528 + 8);
  while ( 1 )
  {
    v16 = v8;
    if ( v8 == (_QWORD *)v7 )
