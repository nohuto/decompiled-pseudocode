/*
 * XREFs of ?NdisPDCreateBMGroup@@YAJPEAUPD_CLIENT_HANDLE__@@PEAPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@@Z @ 0x1C011B0B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisPDCreateBMGroup(struct PD_CLIENT_HANDLE__ *a1, struct PD_BUFFER_MANAGEMENT_GROUP_HANDLE__ **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v6 )
  {
    v10.m_Lock = (KPushLockBase *)qword_1C00E5528;
    *((_QWORD *)v6 + 2) = a1;
