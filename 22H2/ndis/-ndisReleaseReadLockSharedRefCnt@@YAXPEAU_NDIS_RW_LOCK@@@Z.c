/*
 * XREFs of ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C00A520C
 * Callers:
 *     ?ndisReleaseReadWriteLockX@@YAXPEAU_NDIS_RW_LOCK@@PEAU_LOCK_STATE@@E@Z @ 0x1C003D7F8 (-ndisReleaseReadWriteLockX@@YAXPEAU_NDIS_RW_LOCK@@PEAU_LOCK_STATE@@E@Z.c)
 * Callees:
 *     <none>
 */
...
void __fastcall ndisReleaseReadLockSharedRefCnt(PKSPIN_LOCK SpinLock)
{
  ...
  *((_DWORD *)SpinLock + 6) = v3;
  ...
  v4 = qword_1C00E72E8 + 520LL * KeGetPcr()->Prcb.Number;
  v5 = *(_DWORD *)(v4 + 512);
  if ( v5 )
  {
