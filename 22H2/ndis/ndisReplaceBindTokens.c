/*
 * XREFs of ndisReplaceBindTokens @ 0x1C01266E8
 * Callers:
...
__int64 __fastcall ndisReplaceBindTokens(__int64 a1, void ***a2)
{
  ...
  v2 = 0LL;
  if ( *((_QWORD *)qword_1C00E55C8 + 11) )
  {
    v12 = 0;
    result = NetSetupPropertyBag::ReadBoolean(a2, (const struct _NETSETUPPROPKEY *)&unk_1C00D4528, &v12);
    if ( (_DWORD)result )
      return result;
    if ( !v12 )
    {
      Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_1C00E55C8, L"ndis5");
      v6 = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_1C00E55C8, L"wlan");
      if ( !Atom || !v6 )
        return 3221225626LL;
