/*
 * XREFs of ?ndisReadProtocolById@@YAJAEBU_GUID@@@Z @ 0x1C0126550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisReadProtocolById(const struct _GUID *a1)
{
  ...
  {
    m_ptr = (void **)&v5;
    v2 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D45B8, (__int64)v9);
    if ( !v2 )
    {
      v2 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D44E0, (__int64)v11);
      if ( !v2 )
      {
        v2 = NetSetupPropertyBag::ReadString(
               (NetSetupPropertyBag *)&m_ptr,
               (const struct _NETSETUPPROPKEY *)&unk_1C00D4618,
               &v8);
        if ( !v2 )
        {
          v2 = NetSetupPropertyBag::ReadBoolean(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D45A0, &v13);
          if ( !v2 )
          {
            if ( Rtl::KArray<ProtocolBindProperties,1>::append((__int64)qword_1C00E55C8 + 24, (__int64)&v7) )
              v2 = 0;
            else
              v2 = -1073741670;
          }
