/*
 * XREFs of ?NdisTraceLoggingRareFilterPath@@YAXPEAU_NDIS_FILTER_DRIVER_BLOCK@@W4NdisTLFilterEvent@@H@Z @ 0x1C011FB88
 * Callers:
...
void __fastcall NdisTraceLoggingRareFilterPath(__int64 a1)
{
  ...
  else if ( (unsigned int)dword_1C00E4108 > 5 && tlgKeywordOn((__int64)&dword_1C00E4108, 0x400000000000LL) )
  {
    v21 = 0;
    v18 = 0;
    v19 = &v10;
    ...
    v10 = v7;
    v9 = v8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00E4108, (unsigned __int8 *)dword_1C00D055D, 0LL, 0LL, 4u, &v15);
  }
}
