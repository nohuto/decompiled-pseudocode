/*
 * XREFs of ndisMIndicateSplitNblChain @ 0x1C00A3984
 * Callers:
...
LABEL_11:
      ...
      *((_DWORD *)PoolWithTag + 11) = v13;
      ndisSortNetBufferLists((struct _NDIS_NBL_RCV_TRACKER *)PoolWithTag, v17, v16);
...
LABEL_24:
        if ( v20 )
        {
          if ( byte_1C00E4FD0 && (*(_DWORD *)&v12[1465] & 2) != 0 )
            PktMonClientNblDropNdis((_DWORD)v12 + 5808, (_DWORD)v20, (_DWORD)v16, 1, -1073676270, -536866809);
          if ( !v10 )
