/*
 * XREFs of ?ndisPcwGetMiniportDataBlockInternal@@YAPEAU_NDIS_PCW_DATA_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00FFEE4
 * Callers:
 ...
 *     ??$WritePointerRelease@U_NDIS_PCW_DATA_BLOCK@@@mem@@YAXPEAPEAU_NDIS_PCW_DATA_BLOCK@@PEAU1@@Z @ 0x1C00090E0 (--$WritePointerRelease@U_NDIS_PCW_DATA_BLOCK@@@mem@@YAXPEAPEAU_NDIS_PCW_DATA_BLOCK@@PEAU1@@Z.c)
 *     memset @ 0x1C0040B00 (memset.c)
 *     ?ndisPcwGetInstanceName@@YAJPEAU_NDIS_MINIPORT_BLOCK@@KPEAU_UNICODE_STRING@@@Z @ 0x1C01000B8 (-ndisPcwGetInstanceName@@YAJPEAU_NDIS_MINIPORT_BLOCK@@KPEAU_UNICODE_STRING@@@Z.c)
 *     ?ndisPcwGetMiniportInstanceId@@YAKPEAU_NDIS_MINIPORT_BLOCK@@K@Z @ 0x1C0100124 (-ndisPcwGetMiniportInstanceId@@YAKPEAU_NDIS_MINIPORT_BLOCK@@K@Z.c)
 */
