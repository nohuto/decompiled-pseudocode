/*
 * XREFs of ?ndisRefCountBlockFromRefCountHandle@@YAPEAU_NDIS_REFCOUNT_BLOCK@@PEAUNDIS_REFCOUNT_HANDLE__@@@Z @ 0x1C0040458
 * Callers:
 ...
 *     NdisGetRefCount @ 0x1C00BF240 (NdisGetRefCount.c)
 * Callees:
