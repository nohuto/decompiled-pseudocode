/*
 * XREFs of ?ndisVerifierInjectResourceFailure@@YAEE@Z @ 0x1C00AC768
 * Callers:
 ...
 *     ?ndisVerifierAllocatePacketPool@@YAXPEAHPEAPEAXII@Z @ 0x1C00AC570 (-ndisVerifierAllocatePacketPool@@YAXPEAHPEAPEAXII@Z.c)
