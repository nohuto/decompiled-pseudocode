/*
 * XREFs of KRegKey::QueryValueMultisz__lambda_145828208f54867cbf19e2ec96475ca0___lambda_669a078cee999b45033530b9c5ed1c6f___ @ 0x1C0124528
 * Callers:
...
LABEL_16:
  ...
  if ( !(unsigned __int8)Rtl::KArray<Rtl::_KStringAtom *,1>::reserve((char *)qword_1C00E55C8 + 72, v12 + 4LL) )
    goto LABEL_3;
  while ( *v11 )
  {
    v16 = v11;
    do
      ++v16;
    while ( *v16 );
    Atom = Rtl::KStringAtomTableBase<1>::GetAtom(qword_1C00E55C8, v11);
    if ( !Atom )
      goto LABEL_3;
    Rtl::KArray<Rtl::_KStringAtom *,1>::append((char *)qword_1C00E55C8 + 72, &Atom);
    v11 = v16 + 1;
  }
  v8 = 0;
LABEL_17:
