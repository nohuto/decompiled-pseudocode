/*
 * XREFs of ?ndisWmiChangeSingleInstance@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@QEAUtagWNODE_SINGLE_INSTANCE@@@Z @ 0x1C008D060
 * Callers:
 *     ndisWMIDispatch @ 0x1C0010BF0 (ndisWMIDispatch.c)
 *     NdisWdfChangeSingleInstance @ 0x1C00625B0 (NdisWdfChangeSingleInstance.c)
 * Callees:
