/*
 * XREFs of ?ReadBoolean@NetSetupPropertyBag@@QEAAJAEBU_NETSETUPPROPKEY@@AEA_N@Z @ 0x1C0102C30
 * Callers:
 ...
 *     ndisBindReadFilterDriverSettingsFromV3Registry @ 0x1C010284C (ndisBindReadFilterDriverSettingsFromV3Registry.c)
