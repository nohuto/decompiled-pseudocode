/*
 * XREFs of ?netsetupBuildObjectPath@@YAXW4_NETSETUP_OBJECT_TYPE@@AEBU_GUID@@W4NetSetupStoreType@@W4NetSetupSubkeyType@@PEA_W@Z @ 0x1C0103208
 * Callers:
        ...
        wchar_t *Dst)
{
  ...
  if ( *((_BYTE *)qword_1C00E55C8 + 96) && a4 == Writeback )
    a3 = 1;
  if ( a4 )
  {
    v6 = a4 - 1;
  ...
  {
    v7 = (const wchar_t *)&unk_1C00CA700;
  }
  if ( a3 )
  {
    if ( a3 == 1 )
