 ...
 * Callers:
 *     ?NdisTraceLoggingOffloadConfigRead@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00221E8 (-NdisTraceLoggingOffloadConfigRead@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
 *     ?NdisTraceLoggingMiniportWakeBufferTooLarge@@YAXPEAU_NDIS_MINIPORT_BLOCK@@K@Z @ 0x1C008C290 (-NdisTraceLoggingMiniportWakeBufferTooLarge@@YAXPEAU_NDIS_MINIPORT_BLOCK@@K@Z.c)
 * Callees:
        ...
        __int64 a6)
{
  ...
  v10 = 0;
  v9 = 16;
  return tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C00E4108, a2, 0, 0, 4u, &v7);
}
