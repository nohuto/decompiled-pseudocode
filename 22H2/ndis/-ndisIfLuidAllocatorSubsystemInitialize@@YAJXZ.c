/*
 * XREFs of ?ndisIfLuidAllocatorSubsystemInitialize@@YAJXZ @ 0x1C0146184
 * Callers:
...
NTSTATUS ndisIfLuidAllocatorSubsystemInitialize(void)
{
  ...
  Status = 0;
  qword_1C00E6F60 = (__int64)&qword_1C00E6F58;
  qword_1C00E6F58 = (__int64)&qword_1C00E6F58;
        ...
        *(_QWORD *)&Keyword.Length = 917516LL;
        ...
        if ( !Status )
        {
          ...
          *((_WORD *)PoolWithTag + 8) = Length;
          ...
          v5 = qword_1C00E6F58;
          if ( *(__int64 **)(qword_1C00E6F58 + 8) != &qword_1C00E6F58 )
            __fastfail(3u);
          *PoolWithTag = qword_1C00E6F58;
          PoolWithTag[1] = &qword_1C00E6F58;
          *(_QWORD *)(v5 + 8) = PoolWithTag;
          qword_1C00E6F58 = (__int64)PoolWithTag;
        }
      }
