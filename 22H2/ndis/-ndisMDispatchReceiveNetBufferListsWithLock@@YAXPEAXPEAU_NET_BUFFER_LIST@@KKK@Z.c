/*
 * XREFs of ?ndisMDispatchReceiveNetBufferListsWithLock@@YAXPEAXPEAU_NET_BUFFER_LIST@@KKK@Z @ 0x1C0036030
 * Callers:
 ...
 *     ?ndisIndicateAllNetBufferLists@@YAXPEAU_NDIS_NBL_RCV_TRACKER@@PEAU_NDIS_OPEN_BLOCK@@@Z @ 0x1C0099BB4 (-ndisIndicateAllNetBufferLists@@YAXPEAU_NDIS_NBL_RCV_TRACKER@@PEAU_NDIS_OPEN_BLOCK@@@Z.c)
        ...
        unsigned int a5)
{
  ...
  struct _NDIS_OPEN_BLOCK *v22; // rsi
  ...
  *(_WORD *)&LockState.OldIrql = 0;
  ...
  v22 = (struct _NDIS_OPEN_BLOCK *)v20[41];
  if ( v22 && v22->ProtocolHandle->MajorNdisVersion >= 6u )
  {
    ndisMIndicateNetBufferListsToOpen(v22, a2, (char *)a3, a4, a5);
  ...
  else
  {
    ...
    *((_DWORD *)PoolWithTag + 11) = a4;
    ndisSortNetBufferLists((struct _NDIS_NBL_RCV_TRACKER *)PoolWithTag, a5, v16);
    if ( *((_QWORD *)PoolWithTag + 8) || *((_DWORD *)PoolWithTag + 172) )
    {
      ...
      if ( !v22 )
      {
        v23 = (struct _NDIS_OPEN_BLOCK *)v20[1];
        if ( v23 )
        {
        ...
        v30 = (struct _NDIS_OPEN_BLOCK *)v20[2];
        if ( v30 )
        {
          if ( (a5 & 2) != 0 )
          {
...
LABEL_31:
    if ( a2 )
    {
      if ( byte_1C00E4FD0 && (*((_DWORD *)v6 + 1465) & 2) != 0 )
        PktMonClientNblDropNdis((_DWORD)v6 + 5808, (_DWORD)a2, (_DWORD)v16, 1, -1073676270, -536866809);
      if ( (v5 & 2) == 0 )
