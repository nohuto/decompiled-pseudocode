/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C00C6B3C
 * Callers:
 ...
 *     GetImageTuple @ 0x1C00C6ABC (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C00C709C (_tlgCreate1Sz_char.c)
 */
...
LABEL_35:
  ...
  v20 = "<unknown>";
  v21 = v36;
  if ( (unsigned int)dword_1C00F8040 > 5 && tlgKeywordOn((__int64)&dword_1C00F8040, 0x400000000000LL) )
  {
    v37 = 10;
    v67 = &v37;
    v23 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_1C00F8040,
      (unsigned __int8 *)dword_1C00D0E6B,
      0LL,
      v27,
      0xBu,
      &v66);
  }
  if ( dword_1C00F8078 && !v19 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C00F8040 > 5 && tlgKeywordOn((__int64)&dword_1C00F8040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C00F8040,
        (unsigned __int8 *)dword_1C00D0ED8,
        v30,
        0LL,
        v31,
        &v50);
