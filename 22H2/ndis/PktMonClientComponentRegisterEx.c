/*
 * XREFs of PktMonClientComponentRegisterEx @ 0x1C0026AE0
 * Callers:
    ...
    if ( (_QWORD)xmmword_1C00E4FE8 )
    {
      ...
      else
      {
        ...
        *((_QWORD *)&v13 + 1) = a3;
        ...
        {
          v9 = (*(__int64 (__fastcall **)(_QWORD, __int128 *, __int64))(*((_QWORD *)&xmmword_1C00E4FE8 + 1) + 8LL))(
                 xmmword_1C00E4FE8,
                 &v12,
                 a1 + 40);
          if ( !v9 )
