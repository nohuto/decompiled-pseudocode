/*
 * XREFs of ndisMQueueReceiveNetBufferLists @ 0x1C00A40D8
 * Callers:
 ...
 *     ndisMPeriodicPendingReceives @ 0x1C00A3DBC (ndisMPeriodicPendingReceives.c)
 *     ndisMPeriodicReceivesResources @ 0x1C00A3F2C (ndisMPeriodicReceivesResources.c)
 *     ?ndisQueuePeriodicReceivesTimer@@YAXXZ @ 0x1C00A45D8 (-ndisQueuePeriodicReceivesTimer@@YAXXZ.c)
