/*
 * XREFs of ?ndisMpHookGetHook@@YA?AV?$KRundownPtr@$$CBUNDIS_MINIPORT_HOOK_PROVIDER_INFO@@@@W4_NDIS_MINIPORT_HOOK_DRIVER_TYPE@@@Z @ 0x1C0127378
 * Callers:
 *     NdisMRegisterWdiMiniportDriver @ 0x1C0126F80 (NdisMRegisterWdiMiniportDriver.c)
 * Callees:
 *     ?TryAcquire@KRundownBase@@QEAA_NXZ @ 0x1C00ACE70 (-TryAcquire@KRundownBase@@QEAA_NXZ.c)
