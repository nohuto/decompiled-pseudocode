/*
 * XREFs of ?ndisQueryRSSv2ParametersHelper@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@K@Z @ 0x1C00896EC
 * Callers:
 ...
 *     ?ndisCalculateRssV2ParametersFlags@@YAKPEAU_NDIS_RECEIVE_SCALE_PARAMETERS@@@Z @ 0x1C00883F8 (-ndisCalculateRssV2ParametersFlags@@YAKPEAU_NDIS_RECEIVE_SCALE_PARAMETERS@@@Z.c)
