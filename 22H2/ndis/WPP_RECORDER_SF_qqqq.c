/*
 * XREFs of WPP_RECORDER_SF_qqqq @ 0x1C002C710
 * Callers:
 ...
 *     ?ndisOidPreIovInvalidateConfigBlock@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C007B490 (-ndisOidPreIovInvalidateConfigBlock@@YAEPEAU_NDIS_REQ_TRACKER@@@Z.c)
