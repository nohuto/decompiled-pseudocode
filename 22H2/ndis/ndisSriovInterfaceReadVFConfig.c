/*
 * XREFs of ndisSriovInterfaceReadVFConfig @ 0x1C0119700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVFConfig(
        ...
        size_t Size)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *(_QWORD *)&v13.RequestType = 12LL;
    v13.DATA.QUERY_INFORMATION.Oid = 66129;
    ...
    *(_QWORD *)&v13.DATA.METHOD_INFORMATION.OutputBufferLength = (unsigned int)(Size + 20);
    ...
    if ( !v10 )
      memmove(a2, (char *)v9 + (unsigned int)v9[4], (unsigned int)Size);
