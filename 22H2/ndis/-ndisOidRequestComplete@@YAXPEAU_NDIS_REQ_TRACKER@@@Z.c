/*
 * XREFs of ?ndisOidRequestComplete@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C000B3B0
 * Callers:
...
LABEL_11:
  ...
  {
    v15 = (void (__fastcall *)(struct _NDIS_REQ_TRACKER *))*((_QWORD *)&unk_1C00C8340 + 3 * (unsigned int)v11[23]);
    v14 = v11;
    if ( v15 )
    {
      v15(a1);
