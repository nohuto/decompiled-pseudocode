/*
 * XREFs of ?ReadString@NetSetupPropertyBag@@QEAAJAEBU_NETSETUPPROPKEY@@AEAV?$unique_ptr@UKString@Rtl@@U?$default_delete@UKString@Rtl@@@wistd@@@wistd@@@Z @ 0x1C0101F14
 * Callers:
        ...
        void **a3)
{
  ...
  if ( v5 == -1073741772 )
  {
    if ( (unsigned __int8)netsetupIsImpliedProperty(a2) )
    {
      ...
      if ( v7 )
      {
        v13.Buffer = (wchar_t *)&unk_1C00CA700;
        v13.Length = 2 * v9;
