/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1C011874C
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x1C0145FBC (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C003D910 (__security_check_cookie.c)
 *     memset @ 0x1C0040B00 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x1C0148310 (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
