/*
 * XREFs of ?ndisNsiEnumerateAllSessionInformation@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C00B1770
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall ndisNsiEnumerateAllSessionInformation(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( *((_DWORD *)a1 + 8) == 1 )
  {
    ...
    v6 = *((_QWORD *)a1 + 5);
    v7 = *((_DWORD *)a1 + 22);
    v8 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E5B28);
    v9 = dword_1C00E71A8;
    v10 = 0;
    if ( dword_1C00E71A8 )
    {
    ...
    KeReleaseSpinLock(&qword_1C00E5B28, v8);
    *((_DWORD *)a1 + 22) = v2;
