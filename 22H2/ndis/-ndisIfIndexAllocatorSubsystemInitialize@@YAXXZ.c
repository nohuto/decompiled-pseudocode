/*
 * XREFs of ?ndisIfIndexAllocatorSubsystemInitialize@@YAXXZ @ 0x1C0144828
 * Callers:
...
void __fastcall ndisIfIndexAllocatorSubsystemInitialize(struct _DRIVER_OBJECT *a1)
{
  ...
  v3[1] = dword_1C00E5A04;
  ndisReadRegistryKnobs(a1, (const struct NDIS_REGISTRY_KNOB *)v3, 1uLL);
  v1 = *(_DWORD *)dword_1C00E5A04;
  if ( (unsigned int)(*(_DWORD *)dword_1C00E5A04 - 1) > 0x7FFE )
  {
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      *(_DWORD *)v2 = *(_DWORD *)dword_1C00E5A04;
      WPP_RECORDER_SF_d(
    ...
    v1 = 1;
    *(_DWORD *)dword_1C00E5A04 = 1;
  }
  dword_1C00E5400 = 1;
  xmmword_1C00E5408 = 0LL;
  dword_1C00E5404 = v1;
  xmmword_1C00E5420 = 0LL;
  dword_1C00E5418 = v1;
  dword_1C00E541C = 0xFFFF;
}
