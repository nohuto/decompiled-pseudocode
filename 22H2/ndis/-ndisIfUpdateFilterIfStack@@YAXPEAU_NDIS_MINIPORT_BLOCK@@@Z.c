/*
 * XREFs of ?ndisIfUpdateFilterIfStack@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00259C4
 * Callers:
...
void __fastcall ndisIfUpdateFilterIfStack(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  {
LABEL_4:
    v4 = (PVOID *)qword_1C00E5B60;
    v5 = 0;
    if ( qword_1C00E5B60 != &qword_1C00E5B60 )
    {
