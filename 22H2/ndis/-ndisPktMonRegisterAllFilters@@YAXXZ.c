/*
 * XREFs of ?ndisPktMonRegisterAllFilters@@YAXXZ @ 0x1C003FB20
 * Callers:
 *     ?ndisPktMonRegisterComponentsCallback@@YAXXZ @ 0x1C008FE30 (-ndisPktMonRegisterComponentsCallback@@YAXXZ.c)
 * Callees:
