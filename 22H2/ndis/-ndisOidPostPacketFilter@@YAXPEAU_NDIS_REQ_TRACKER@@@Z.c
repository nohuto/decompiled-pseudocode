/*
 * XREFs of ?ndisOidPostPacketFilter@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C002DCA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostPacketFilter(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  char v8; // r8
  void (__fastcall *p_ifPromiscuousMode)(_NDIS_WORK_ITEM *, void *); // rdx
    ...
    if ( !*((_DWORD *)a1 + 10) )
    {
      ...
      else
      {
        *(_DWORD *)(*(_QWORD *)(v1 + 400) + 312LL) = **(_DWORD **)(v2 + 40);
        ...
        v8 = (v10 & 0x20) != 0;
        p_ifPromiscuousMode = (void (__fastcall *)(_NDIS_WORK_ITEM *, void *))&v7->ifPromiscuousMode;
        if ( v7->ifPromiscuousMode != v8 )
        {
          *(_BYTE *)p_ifPromiscuousMode = v8;
          ndisNsiScheduleIfBlockRodChangeNotification(v7, p_ifPromiscuousMode, 1, 640);
        }
      }
