/*
 * XREFs of ?ndisSelectiveSuspendFree@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0122120
 * Callers:
...
void __fastcall ndisSelectiveSuspendFree(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( *((_QWORD *)SelectiveSuspend + 75) )
  {
    ...
    do
    {
      v5 = (char *)*((_QWORD *)SelectiveSuspend + 75);
      if ( *(_QWORD *)&v5[v3 + 8] )
      {
        ExFreePoolWithTag(*(PVOID *)&v5[v3 + 8], 0);
        *(_QWORD *)(v3 + *((_QWORD *)SelectiveSuspend + 75) + 8) = 0LL;
        v5 = (char *)*((_QWORD *)SelectiveSuspend + 75);
      }
      v3 += 24LL;
      --v4;
