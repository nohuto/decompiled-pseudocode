...
__int64 WPP_RECORDER_SF_qdq(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x800000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(&WPP_45eb45ac1a9433561e49016f94f6e82a_Traceguids, a4, va, 8LL, va1, 4LL, va2, 8LL, 0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 4LL, 24LL, &WPP_45eb45ac1a9433561e49016f94f6e82a_Traceguids, v8, (__int64 *)va);
}
