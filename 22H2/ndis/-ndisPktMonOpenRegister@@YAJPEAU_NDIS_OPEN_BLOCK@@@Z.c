/*
 * XREFs of ?ndisPktMonOpenRegister@@YAJPEAU_NDIS_OPEN_BLOCK@@@Z @ 0x1C0101B20
 * Callers:
...
LABEL_4:
  ...
  {
    v5 = PktMonClientSetCompProperty((__int64)p_PktMonComp, 9, (__int64)v11, 1u);
    if ( v5 )
    {
      if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_5;
    ...
    v5 = PktMonClientSetCompProperty((__int64)p_PktMonComp, 2, (__int64)&a1->MiniportHandle->IfIndex, 4u);
    if ( v5 )
    {
      if ( *(int **)&WPP_RECORDER_INITIALIZED == &WPP_RECORDER_INITIALIZED )
        goto LABEL_5;
    ...
    if ( a1->FrameTypeArraySize )
    {
      while ( 1 )
      {
        v5 = PktMonClientSetCompProperty((__int64)p_PktMonComp, 7, (__int64)&a1->FrameTypeArray[v10], 2u);
        if ( v5 )
          break;
