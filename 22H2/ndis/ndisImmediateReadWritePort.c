/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00BE6E0
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00BEA20 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00BEA40 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00BEA60 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00BEAA0 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00BEAD0 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00BEB00 (NdisImmediateWritePortUshort.c)
 * Callees:
 ...
 *     ndisStartMapping @ 0x1C00BE940 (ndisStartMapping.c)
 */
