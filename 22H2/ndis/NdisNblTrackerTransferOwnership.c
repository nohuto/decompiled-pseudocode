/*
 * XREFs of NdisNblTrackerTransferOwnership @ 0x1C0074F60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z @ 0x1C007477C (-ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z.c)
 */
