/*
 * XREFs of ndisDriverSystemDispatch @ 0x1C00322E0
 * Callers:
...
LABEL_29:
      ...
      {
        qword_1C00E7190 = v6[1];
        byte_1C00E718C = BYTE2(qword_1C00E7190);
        ndisLogger = HIDWORD(qword_1C00E7190);
        if ( (qword_1C00E7190 & 0x800000000LL) != 0 )
          LOBYTE(dword_1C00E7198) = 1;
        if ( (qword_1C00E7190 & 0x100000000LL) != 0 )
          BYTE1(dword_1C00E7198) = 1;
        if ( (qword_1C00E7190 & 0x200000000LL) != 0 )
          BYTE2(dword_1C00E7198) = 1;
        if ( (qword_1C00E7190 & 0x400000000LL) != 0 )
          HIBYTE(dword_1C00E7198) = 1;
        if ( (qword_1C00E7190 & 0x1000000000LL) != 0 )
          LOBYTE(word_1C00E719C) = 1;
        if ( (qword_1C00E7190 & 0x2000000000LL) != 0 )
          HIBYTE(word_1C00E719C) = 1;
      }
      break;
    case 5:
      byte_1C00E718C = 0;
