/*
 * XREFs of ?ndisCheckIfDeviceNeedsPseudoMigration@@YAJAEAVKRegKey@@AEAV?$unique_ptr@UKString@Rtl@@U?$default_delete@UKString@Rtl@@@wistd@@@wistd@@AEA_N@Z @ 0x1C010928C
 * Callers:
 ...
 *     ?DeleteValue@KRegKey@@QEAAJPEB_W@Z @ 0x1C01231E8 (-DeleteValue@KRegKey@@QEAAJPEB_W@Z.c)
 */
