/*
 * XREFs of ?netsetupBuildStorePath@@YAXW4_NETSETUP_OBJECT_TYPE@@W4NetSetupStoreType@@PEA_W@Z @ 0x1C0109AE8
 * Callers:
 ...
 * Callees:
 *     netsetupGetPathForObjectType @ 0x1C0103350 (netsetupGetPathForObjectType.c)
 */
