/*
 * XREFs of ?ndisMInitializeScatterGatherDmaInternal@@YAHPEAXEKK@Z @ 0x1C0033B94
 * Callers:
 *     NdisMRegisterScatterGatherDma @ 0x1C0033A50 (NdisMRegisterScatterGatherDma.c)
 *     NdisMInitializeScatterGatherDma @ 0x1C00C1C00 (NdisMInitializeScatterGatherDma.c)
 * Callees:
