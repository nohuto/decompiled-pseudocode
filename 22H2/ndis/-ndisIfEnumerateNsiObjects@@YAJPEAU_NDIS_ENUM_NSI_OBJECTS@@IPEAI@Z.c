/*
 * XREFs of ?ndisIfEnumerateNsiObjects@@YAJPEAU_NDIS_ENUM_NSI_OBJECTS@@IPEAI@Z @ 0x1C012841C
 * Callers:
 *     ?ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z @ 0x1C012CDB8 (-ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z.c)
 * Callees:
 *     memset @ 0x1C0040B00 (memset.c)
 *     NdisIfGetNetLuidFromInterfaceIndex @ 0x1C00B25B0 (NdisIfGetNetLuidFromInterfaceIndex.c)
 */
