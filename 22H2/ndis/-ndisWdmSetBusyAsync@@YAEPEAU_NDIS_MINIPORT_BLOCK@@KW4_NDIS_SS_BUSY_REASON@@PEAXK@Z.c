/*
 * XREFs of ?ndisWdmSetBusyAsync@@YAEPEAU_NDIS_MINIPORT_BLOCK@@KW4_NDIS_SS_BUSY_REASON@@PEAXK@Z @ 0x1C00A952C
 * Callers:
...
char __fastcall ndisWdmSetBusyAsync(__int64 a1, int a2, unsigned int a3, __int64 a4, unsigned int a5)
{
  ...
  else
  {
    ...
    if ( v7 )
    {
      if ( byte_1C00E4FD0 && (*(_DWORD *)(a1 + 5860) & 2) != 0 )
