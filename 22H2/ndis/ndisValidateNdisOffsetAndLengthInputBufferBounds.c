/*
 * XREFs of ndisValidateNdisOffsetAndLengthInputBufferBounds @ 0x1C0118DF0
 * Callers:
 *     ndisValidateNdisOffsetAndLengthInputString @ 0x1C0118E54 (ndisValidateNdisOffsetAndLengthInputString.c)
...
char __fastcall ndisValidateNdisOffsetAndLengthInputBufferBounds(__int64 a1, unsigned int *a2, unsigned __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (unsigned __int64)a2 < v3 || (unsigned __int64)(a2 + 2) > v3 + v4 )
    ...
    return ndisValidateEmbeddedBufferBounds(v3, v4, (unsigned __int64)a2, 8u, *a2, a2[1], 0, a3);
}
