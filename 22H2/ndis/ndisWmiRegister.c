/*
 * XREFs of ndisWmiRegister @ 0x1C0029540
 * Callers:
  ...
  *a5 = 0;
  ...
  else
  {
    ...
    if ( (_WORD)v11 )
    {
      ...
      if ( !v25 )
        v7 = v26;
      v12 = 32 * v11 + 58 + *(unsigned __int16 *)v7;
      v33 = v12;
    }
    else
    {
    ...
    v13 = *(unsigned __int16 *)(a1 + 1386) - v11;
    ...
    else
    {
      *a5 = v16;
      ...
      if ( v14 && v7 )
      {
        ...
        *(_WORD *)v28 = *(_WORD *)v7;
        v31 = (char *)v28 + 2;
        memmove(v31, v7[1], *(unsigned __int16 *)v7);
        v32 = &v31[*(unsigned __int16 *)v7];
        a3[3] = (_DWORD)v31 + *(unsigned __int16 *)v7 - (_DWORD)a3;
        *(_WORD *)v32 = 30;
