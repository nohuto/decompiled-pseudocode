/*
 * XREFs of ?ndisWdfSelectiveSuspendResumeOperations@@YAXPEAU_NDIS_MINIPORT_BLOCK@@EE@Z @ 0x1C00A8CBC
 * Callers:
 ...
 *     NdisWdfAsyncPowerReferenceCompleteNotification @ 0x1C0122700 (NdisWdfAsyncPowerReferenceCompleteNotification.c)
 * Callees:
