/*
 * XREFs of WPP_RECORDER_SF_qLLLL @ 0x1C003C0CC
 * Callers:
...
__int64 WPP_RECORDER_SF_qLLLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x40) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_eeb71838b50e3a51e19c5b48ce25db7d_Traceguids,
      0x16u,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 22;
  return WppAutoLogTrace(a1, 4LL, 7LL, &WPP_eeb71838b50e3a51e19c5b48ce25db7d_Traceguids, v7, (__int64 *)va);
}
