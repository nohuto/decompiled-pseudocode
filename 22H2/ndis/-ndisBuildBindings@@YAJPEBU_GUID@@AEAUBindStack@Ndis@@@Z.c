/*
 * XREFs of ?ndisBuildBindings@@YAJPEBU_GUID@@AEAUBindStack@Ndis@@@Z @ 0x1C012589C
 * Callers:
 ...
 *     ??1NetworkInterfaceBindProperties@@QEAA@XZ @ 0x1C00ACCF8 (--1NetworkInterfaceBindProperties@@QEAA@XZ.c)
 ...
 *     ndisIsLwfBindable @ 0x1C0125E44 (ndisIsLwfBindable.c)
...
__int64 __fastcall ndisBuildBindings(struct _GUID *a1, struct Ndis::BindStack *a2)
{
  ...
  v5 = 0LL;
  v6 = 0LL;
  v7 = *((unsigned int *)qword_1C00E55C8 + 7);
  v15 = v7;
  while ( v5 != v7 )
  {
...
LABEL_18:
  ...
  else
  {
    ...
    v10 = 0LL;
    v11 = 0LL;
    v12 = *((unsigned int *)qword_1C00E55C8 + 11);
    while ( v10 != v12 )
    {
