/*
 * XREFs of NdisReadConfiguration @ 0x1C0028870
 * Callers:
 ...
 *     ?ndisReadPMAdminConfigState@@YA?AW4_NDIS_PM_ADMIN_CONFIG_STATE@@PEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_UNICODE_STRING@@@Z @ 0x1C0027AB0 (-ndisReadPMAdminConfigState@@YA-AW4_NDIS_PM_ADMIN_CONFIG_STATE@@PEAU_NDIS_CONFIGURATION_HANDLE@@.c)
 ...
 *     ?ndisReadSoftwareTimestampSettings@@YAXPEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0039FE0 (-ndisReadSoftwareTimestampSettings@@YAXPEAU_NDIS_CONFIGURATION_HANDLE@@PEAU_NDIS_MINIPORT_BLOCK@.c)
 *     ?NdisReadConfigShimHook@@YAXPEAHPEAPEAU_NDIS_CONFIGURATION_PARAMETER@@PEAXPEAU_UNICODE_STRING@@W4_NDIS_PARAMETER_TYPE@@@Z @ 0x1C003F940 (-NdisReadConfigShimHook@@YAXPEAHPEAPEAU_NDIS_CONFIGURATION_PARAMETER@@PEAXPEAU_UNICODE_STRING@@W.c)
 *     NdisWdfReadConfiguration @ 0x1C005FCC0 (NdisWdfReadConfiguration.c)
 ...
 *     ?ndisNDKGlobalDisabled@@YAEXZ @ 0x1C01008F4 (-ndisNDKGlobalDisabled@@YAEXZ.c)
 *     ?ndisReadNDKGlobalFlags@@YAKXZ @ 0x1C010093C (-ndisReadNDKGlobalFlags@@YAKXZ.c)
 */
        ...
        NDIS_PARAMETER_TYPE ParameterType)
{
  ...
  for ( i = 0; i < 3; ++i )
  {
    if ( RtlEqualUnicodeString(Keyword, (PCUNICODE_STRING)&unk_1C00C80A0 + i, 1u) )
    {
      RegistryValues = 0;
      v25 = (struct _NDIS_CONFIGURATION_PARAMETER *)((char *)&unk_1C00D2BA0 + 24 * i);
      goto LABEL_45;
    }
  }
  v10 = 0;
      ...
      if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(
          *((_QWORD *)WPP_GLOBAL_Control + 8),
          ...
          (struct _GUID *)&WPP_b81edc0eee5937abc1ca6eb1073cfaac_Traceguids);
      RegistryValues = 0;
      *ParameterValue = (PNDIS_CONFIGURATION_PARAMETER)&unk_1C00D2B88;
      goto LABEL_24;
    }
...
LABEL_30:
      ...
      if ( RtlEqualUnicodeString(Keyword, &stru_1C00C8000, 1u) )
      {
...
LABEL_48:
  ...
  if ( !RtlEqualUnicodeString(Keyword, &stru_1C00C80F0, 1u)
    || (*(_DWORD *)(*((_QWORD *)ConfigurationHandle + 2) + 16LL) & 1) != 0 )
  {
    do
    {
LABEL_9:
      if ( RtlEqualUnicodeString(Keyword, (PCUNICODE_STRING)&unk_1C00C8010 + v10, 1u) )
        break;
      ++v10;
    }
    while ( v10 < 9 );
    ...
    if ( v10 >= 9 )
    {
      if ( RtlEqualUnicodeString(Keyword, &stru_1C00C80E0, 1u) )
      {
        if ( ParameterType )
          goto LABEL_24;
        ...
        {
          RegistryValues = 0;
          v25 = (struct _NDIS_CONFIGURATION_PARAMETER *)&unk_1C00D2B88;
LABEL_45:
          *ParameterValue = v25;
          goto LABEL_24;
        }
      }
      if ( RtlEqualUnicodeString(Keyword, &stru_1C00C80D0, 1u) )
      {
        if ( ParameterType )
          goto LABEL_24;
        dword_1C00E5438 = ndisReadNDKGlobalFlags();
        RegistryValues = 0;
        v25 = (struct _NDIS_CONFIGURATION_PARAMETER *)&unk_1C00E5430;
        goto LABEL_45;
      }
