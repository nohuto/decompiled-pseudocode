 ...
 *     ?ndisCheckAccess@@YAEPEAU_IRP@@PEAU_IO_STACK_LOCATION@@PEAX@Z @ 0x1C001D6FC (-ndisCheckAccess@@YAEPEAU_IRP@@PEAU_IO_STACK_LOCATION@@PEAX@Z.c)
 ...
 *     ?ndisAoAcActiveRefSubtract@@YAJPEAU_NDIS_MINIPORT_AOAC@@W4_NDIS_PM_COMPONENT_ID@@K@Z @ 0x1C005AC90 (-ndisAoAcActiveRefSubtract@@YAJPEAU_NDIS_MINIPORT_AOAC@@W4_NDIS_PM_COMPONENT_ID@@K@Z.c)
...
LABEL_7:
      ...
      case 0x12u:
        ...
        _InterlockedDecrement(&dword_1C00E70DC);
        goto LABEL_7;
      case 0x17u:
  ...
  else
  {
    ...
    *((_BYTE *)PoolWithTag + 1) = ndisCheckAccess(a2, CurrentStackLocation, &unk_1C00E6E40);
    CurrentStackLocation->FileObject->FsContext = PoolWithTag;
    _InterlockedIncrement(&dword_1C00E70DC);
  }
  if ( v4 != 259 )
    goto LABEL_7;
LABEL_8:
