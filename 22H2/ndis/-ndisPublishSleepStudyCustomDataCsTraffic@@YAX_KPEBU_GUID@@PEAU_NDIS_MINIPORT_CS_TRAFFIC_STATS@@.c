/*
 * XREFs of ?ndisPublishSleepStudyCustomDataCsTraffic@@YAX_KPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_TRAFFIC_STATS@@2@Z @ 0x1C01152F0
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_TRAFFIC_STATS *a4)
{
  ...
  do
  {
    ndisPublishSleepStudyCustomData(a1, a2, off_1C00C9FC0[v4], v15[v4]);
    ++v4;
    --v14;
  }
  while ( v14 );
