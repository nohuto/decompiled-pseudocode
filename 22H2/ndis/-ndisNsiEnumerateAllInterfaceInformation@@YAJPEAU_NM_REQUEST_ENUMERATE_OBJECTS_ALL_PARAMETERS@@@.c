/*
 * XREFs of ?ndisNsiEnumerateAllInterfaceInformation@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C00099E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  {
    v9 = 0;
    v158 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E5B28);
    if ( ThreadSessionId < dword_1C00E71A8 )
      v9 = *((_DWORD *)P + 6 * ThreadSessionId);
    KeReleaseSpinLock(&qword_1C00E5B28, v158);
    if ( !v9 )
      v9 = 1;
    LODWORD(v221) = v9;
  }
