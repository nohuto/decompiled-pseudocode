 ...
 *     <none>
 * Callees:
 *     NdisSetThreadObjectCompartmentScope @ 0x1C00F9940 (NdisSetThreadObjectCompartmentScope.c)
 *     NdisSetThreadObjectCompartmentId @ 0x1C0100530 (NdisSetThreadObjectCompartmentId.c)
 */
