/*
 * XREFs of ?ndisGetFilterAltitude@@YAJAEAVNetSetupPropertyBag@@AEAK@Z @ 0x1C0125BA8
 * Callers:
...
__int64 __fastcall ndisGetFilterAltitude(struct NetSetupPropertyBag *a1, unsigned int *a2)
{
  ...
  P = 0LL;
  v3 = NetSetupPropertyBag::ReadString(a1, (const struct _NETSETUPPROPKEY *)&unk_1C00D4510, &P);
  v4 = v3;
  if ( v3 == -1073741772 )
  {
    *a2 = 0;
LABEL_18:
  ...
  if ( v3 )
    goto LABEL_14;
  Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_1C00E55C8, *((_WORD **)P + 1));
  if ( !Atom )
  {
    v4 = -1073741670;
    goto LABEL_14;
  ...
  v6 = 0;
  if ( *((_DWORD *)qword_1C00E55C8 + 19) )
  {
    v7 = *((unsigned int *)qword_1C00E55C8 + 19);
    while ( 1 )
    {
      v8 = v6;
      if ( v6 >= v7 )
        __fastfail(5u);
      ++v6;
      if ( *(char **)(*((_QWORD *)qword_1C00E55C8 + 10) + 8 * v8) == Atom )
        break;
