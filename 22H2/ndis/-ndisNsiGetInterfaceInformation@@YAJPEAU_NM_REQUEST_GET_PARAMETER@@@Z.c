/*
 * XREFs of ?ndisNsiGetInterfaceInformation@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C000F830
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisNsiGetTopIfBlockFromMiniport@@YAPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0017414 (-ndisNsiGetTopIfBlockFromMiniport@@YAPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
 ...
 *     ?ndisIfDeleteStackEntries@@YAXPEAU_NDIS_IF_BLOCK@@@Z @ 0x1C00B1AA0 (-ndisIfDeleteStackEntries@@YAXPEAU_NDIS_IF_BLOCK@@@Z.c)
 *     ?ndisIfFindNextInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z @ 0x1C00B23E4 (-ndisIfFindNextInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z.c)
 *     ?NETWORKBLOCK_DECREMENT_REF@@YAXPEAU_NDIS_IF_NETWORK_BLOCK@@@Z @ 0x1C00B50B0 (-NETWORKBLOCK_DECREMENT_REF@@YAXPEAU_NDIS_IF_NETWORK_BLOCK@@@Z.c)
 *     ?ndisIfFreeIfIndex@@YAXK@Z @ 0x1C00B60EC (-ndisIfFreeIfIndex@@YAXK@Z.c)
...
LABEL_13:
    ...
    {
      v9 = 0;
      v110 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E5B28);
      if ( ThreadSessionId < dword_1C00E71A8 )
        v9 = *((_DWORD *)P + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00E5B28, v110);
      if ( !v9 )
        v9 = 1;
    }
    else
  ...
  v17 = v15;
  v18 = qword_1C00E5B38;
  if ( qword_1C00E5B38 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E5B38 )
  {
    while ( *((_DWORD *)v18 + 4) != v10 )
    {
      if ( *((_DWORD *)v18 + 4) <= v10 )
      {
        ...
        if ( v18 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E5B38 )
          continue;
      }
      goto LABEL_21;
    }
