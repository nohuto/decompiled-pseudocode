/*
 * XREFs of ndisCsResiliencyCallback @ 0x1C005BDC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisCsResiliencyChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C005BED0 (-ndisCsResiliencyChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z.c)
 */
