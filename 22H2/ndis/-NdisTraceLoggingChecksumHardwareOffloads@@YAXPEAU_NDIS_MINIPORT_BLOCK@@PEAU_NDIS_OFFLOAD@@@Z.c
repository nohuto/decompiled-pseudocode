/*
 * XREFs of ?NdisTraceLoggingChecksumHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C002239C
 * Callers:
 *     ?NdisTraceLoggingOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@1@Z @ 0x1C0022258 (-NdisTraceLoggingOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@1@Z.c)
 * Callees:
...
void __fastcall NdisTraceLoggingChecksumHardwareOffloads(
        ...
        __int64 a3)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C00E4108, 0x200000000000LL, a3, a2) )
    {
      v6 = v4[8];
      v36 = (v6 >> 6) & 3;
      v37 = (v6 >> 4) & 3;
