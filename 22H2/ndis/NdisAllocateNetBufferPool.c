/*
 * XREFs of NdisAllocateNetBufferPool @ 0x1C00383C0
 * Callers:
...
LABEL_6:
    ...
    if ( Pool )
    {
      ...
      *((_QWORD *)v6 + 2) = (char *)v6 + 16;
      v11 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E6E68);
      v12 = qword_1C00E70F8;
      v13 = (_QWORD *)((char *)v6 + 72);
      if ( *(__int64 **)(qword_1C00E70F8 + 8) != &qword_1C00E70F8 )
        __fastfail(3u);
      *v13 = qword_1C00E70F8;
      *((_QWORD *)v6 + 10) = &qword_1C00E70F8;
      *(_QWORD *)(v12 + 8) = v13;
      qword_1C00E70F8 = (__int64)v6 + 72;
      KeReleaseSpinLock(&qword_1C00E6E68, v11);
      *((_QWORD *)v6 + 6) = retaddr;
    }
    goto LABEL_11;
  }
