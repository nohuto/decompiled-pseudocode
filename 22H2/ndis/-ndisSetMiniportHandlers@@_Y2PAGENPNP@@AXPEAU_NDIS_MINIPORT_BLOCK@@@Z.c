/*
 * XREFs of ?ndisSetMiniportHandlers@@_Y2PAGENPNP@@AXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C012D368
 * Callers:
 *     NdisMSetAttributesEx @ 0x1C012D0F0 (NdisMSetAttributesEx.c)
 * Callees:
 *     WPP_RECORDER_SF_q @ 0x1C000DE40 (WPP_RECORDER_SF_q.c)
 *     ndisMIsPowerSynchronizedDatapathRequired @ 0x1C00235B0 (ndisMIsPowerSynchronizedDatapathRequired.c)
