/*
 * XREFs of ?ndisNsiEnumerateAllIfRcvAddresses@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C00B4890
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisNsiEnumerateAllIfRcvAddressesInOneInterface @ 0x1C00B49DC (ndisNsiEnumerateAllIfRcvAddressesInOneInterface.c)
 */
