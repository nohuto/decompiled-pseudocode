/*
 * XREFs of ndisLoadNamedFilterAltitudes @ 0x1C0126054
 * Callers:
 ...
 *     KRegKey::QueryValueMultisz__lambda_145828208f54867cbf19e2ec96475ca0___lambda_669a078cee999b45033530b9c5ed1c6f____0 @ 0x1C0124718 (KRegKey--QueryValueMultisz__lambda_145828208f54867cbf19e2ec96475ca0___lambda_669a07_ea_1C0124718.c)
 ...
 *     ?append@?$KArray@PEAU_KStringAtom@Rtl@@$00@Rtl@@QEAA_NAEBQEAU_KStringAtom@2@@Z @ 0x1C01250B8 (-append@-$KArray@PEAU_KStringAtom@Rtl@@$00@Rtl@@QEAA_NAEBQEAU_KStringAtom@2@@Z.c)
 */
...
LABEL_8:
  ...
  else if ( !v0 )
  {
    ...
    {
      v2 = (const _UNICODE_STRING *)&off_1C00CA310;
      while ( 1 )
      {
        Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_1C00E55C8, *(_WORD **)&v2->Length);
        if ( !Atom || !Rtl::KArray<Rtl::_KStringAtom *,1>::append((__int64)qword_1C00E55C8 + 72, &Atom) )
          break;
