/*
 * XREFs of ?ndisReadRegistry@@YAXXZ @ 0x1C0145710
 * Callers:
 *     DriverEntry @ 0x1C01448F0 (DriverEntry.c)
 * Callees:
 *     __security_check_cookie @ 0x1C003D910 (__security_check_cookie.c)
 *     Feature_94813501__private_IsEnabledDeviceUsage @ 0x1C003DAC4 (Feature_94813501__private_IsEnabledDeviceUsage.c)
 *     Feature_NdisDatapathVerifier__private_ReportDeviceUsage @ 0x1C003DB14 (Feature_NdisDatapathVerifier__private_ReportDeviceUsage.c)
...
void ndisReadRegistry(void)
{
  ...
  void **p_DeferredContext; // [rsp+310h] [rbp+208h]
  ...
  if ( (unsigned int)(dword_1C00E50C8 - 1) > 0x1E )
    dword_1C00E50C8 = 8;
  ...
  if ( (unsigned int)Feature_94813501__private_IsEnabledDeviceUsage() )
    ndisSnapHeaderCheckPresent = 1;
}
