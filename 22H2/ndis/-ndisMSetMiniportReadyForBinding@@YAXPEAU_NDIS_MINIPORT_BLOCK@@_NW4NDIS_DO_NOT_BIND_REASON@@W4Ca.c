/*
 * XREFs of ?ndisMSetMiniportReadyForBinding@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_NW4NDIS_DO_NOT_BIND_REASON@@W4CallRunMode@@@Z @ 0x1C00FC7A4
 * Callers:
 ...
 *     NdisWdfMiniportStarted @ 0x1C0062960 (NdisWdfMiniportStarted.c)
