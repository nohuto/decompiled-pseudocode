/*
 * XREFs of ?ndisFLoopbackNetBufferLists@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NET_BUFFER_LIST@@KKPEAPEAU2@@Z @ 0x1C0068BE0
 * Callers:
...
LABEL_4:
    ...
    do
    {
      ndisFIsLoopbackNetBuffer(a1, FirstNetBuffer, v8, v16, &v18);
      if ( v16[0] == 1 )
      {
        v16[0] = 0;
        ndisFDoLoopbackNetBufferList(a1, FirstNetBuffer, v8, v14, a4);
      }
    ...
    if ( (a4 & 1) == 0 )
      v15 = v7;
    v7 = v15;
    NdisFSendNetBufferListsComplete(a1, v8, v15);
LABEL_5:
    v8 = Alignment;
  }
  while ( Alignment );
