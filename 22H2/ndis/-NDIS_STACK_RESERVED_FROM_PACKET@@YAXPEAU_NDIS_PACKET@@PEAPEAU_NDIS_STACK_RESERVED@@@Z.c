/*
 * XREFs of ?NDIS_STACK_RESERVED_FROM_PACKET@@YAXPEAU_NDIS_PACKET@@PEAPEAU_NDIS_STACK_RESERVED@@@Z @ 0x1C0032B38
 * Callers:
 ...
 *     NdisMatchPdoWithPacket @ 0x1C00C2310 (NdisMatchPdoWithPacket.c)
