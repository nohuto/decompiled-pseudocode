/*
 * XREFs of InitializeTelemetryAssertsKM @ 0x1C00393C0
 * Callers:
...
__int64 __fastcall InitializeTelemetryAssertsKM(const void **a1)
{
  ...
  qword_1C00E4F08 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
...
LABEL_9:
        ...
        TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C00F8040);
        TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&unk_1C00F8008);
        TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C00F8078);
