/*
 * XREFs of ?NdisReadConfigShimHook@@YAXPEAHPEAPEAU_NDIS_CONFIGURATION_PARAMETER@@PEAXPEAU_UNICODE_STRING@@W4_NDIS_PARAMETER_TYPE@@@Z @ 0x1C003F940
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _NDIS_PARAMETER_TYPE a5)
{
  ...
  {
    if ( RtlEqualUnicodeString(a4, &stru_1C00E4078, 1u) )
    {
