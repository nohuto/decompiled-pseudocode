/*
 * XREFs of ?ndisMInitializeMiniportBlockFront@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x1C0132568
 * Callers:
 ...
 * Callees:
 *     ?ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z @ 0x1C0031F9C (-ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z.c)
