/*
 * XREFs of ?ndisSetupDownwardHandlers@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C002B334
 * Callers:
...
void __fastcall ndisSetupDownwardHandlers(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( a1->XState )
  {
    v20 = (void (__fastcall *)(void *, void *))NdisQueryOffloadState;
  }
  else
  {
    a1->SendPathType = NdisFilterSendPath;
    v20 = (void (__fastcall *)(void *, void *))NdisCancelSendPackets;
