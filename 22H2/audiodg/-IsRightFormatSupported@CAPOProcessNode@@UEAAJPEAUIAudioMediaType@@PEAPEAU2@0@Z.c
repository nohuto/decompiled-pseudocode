/*
 * XREFs of ?IsRightFormatSupported@CAPOProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x140019260
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioMediaType *a4)
{
  ...
  if ( v8 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAPOProcessNode::IsRightFormatSupported", 0x2C7u, v9);
  }
  return v9;
}
