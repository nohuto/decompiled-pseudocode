/*
 * XREFs of ?AddValue@CRegParser@ATL@@IEAAJAEAVCRegKey@2@PEBGPEAG@Z @ 0x14005C3F8
 * Callers:
 ...
 *     _alloca_probe @ 0x140029CE0 (_alloca_probe.c)
 *     ??$AtlMultiplyThrow@_K@ATL@@YA_K_K0@Z @ 0x1400505EC (--$AtlMultiplyThrow@_K@ATL@@YA_K_K0@Z.c)
 ...
 *     ?AtlHresultFromWin32@ATL@@YAJK@Z @ 0x14005C9EC (-AtlHresultFromWin32@ATL@@YAJK@Z.c)
 ...
 *     ?SetMultiStringValue@CRegKey@ATL@@QEAAJPEBG0@Z @ 0x14005F1C4 (-SetMultiStringValue@CRegKey@ATL@@QEAAJPEBG0@Z.c)
 *     ?SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ @ 0x14005F2C0 (-SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ.c)
 *     ?VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z @ 0x14005F758 (-VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z.c)
 */
        ...
        unsigned __int16 *a4)
{
  ...
  _BYTE v34[264]; // [rsp+78h] [rbp-2150h] BYREF
