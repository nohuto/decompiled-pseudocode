/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x14000C6B0
 * Callers:
 ...
 * Callees:
 *     ??0CAudioMediaType@@IEAA@XZ @ 0x14000C998 (--0CAudioMediaType@@IEAA@XZ.c)
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x14000FE94 (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
