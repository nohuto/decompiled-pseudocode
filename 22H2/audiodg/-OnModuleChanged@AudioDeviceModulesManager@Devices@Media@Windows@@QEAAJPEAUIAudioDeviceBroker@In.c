/*
 * XREFs of ?OnModuleChanged@AudioDeviceModulesManager@Devices@Media@Windows@@QEAAJPEAUIAudioDeviceBroker@Internal@234@PEAUIAudioDeviceBrokerChangedEventArgs@6234@@Z @ 0x140058660
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetActivationFactory@UIDataReaderStatics@Streams@Storage@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIDataReaderStatics@Streams@Storage@1@@Z @ 0x140053BE0 (--$GetActivationFactory@UIDataReaderStatics@Streams@Storage@Windows@@@Foundation@Windows@@YAJPEA.c)
 ...
 *     ??1HString@Wrappers@WRL@Microsoft@@QEAA@XZ @ 0x140054B60 (--1HString@Wrappers@WRL@Microsoft@@QEAA@XZ.c)
 ...
 *     ?GetAddressOf@HString@Wrappers@WRL@Microsoft@@QEAAPEAPEAUHSTRING__@@XZ @ 0x140056888 (-GetAddressOf@HString@Wrappers@WRL@Microsoft@@QEAAPEAPEAUHSTRING__@@XZ.c)
        ...
        struct Windows::Media::Devices::Internal::IAudioDeviceBrokerChangedEventArgs *a3)
{
  ...
  struct Windows::Media::Devices::IAudioDeviceModule *v37; // [rsp+38h] [rbp-51h] BYREF
  __int64 *v38; // [rsp+40h] [rbp-49h] BYREF
  __int64 v39; // [rsp+48h] [rbp-41h] BYREF
  HSTRING v40; // [rsp+50h] [rbp-39h] BYREF
  struct Windows::Media::Devices::IAudioDeviceModule *v41; // [rsp+58h] [rbp-31h] BYREF
  __int64 v42; // [rsp+60h] [rbp-29h] BYREF
  __int64 v43; // [rsp+68h] [rbp-21h] BYREF
  _QWORD *v44; // [rsp+70h] [rbp-19h] BYREF
  struct Windows::Media::Devices::IAudioDeviceModule *v45; // [rsp+78h] [rbp-11h] BYREF
  ...
  cb_4 = 0;
  v5 = *(_QWORD *)a3;
  v6 = wil::com_ptr_t<Windows::Media::Devices::IAudioDeviceModule,wil::err_returncode_policy>::operator&(&v39);
  AllByIdAndInstance = (*(__int64 (__fastcall **)(struct Windows::Media::Devices::Internal::IAudioDeviceBrokerChangedEventArgs *, __int64 *))(v5 + 48))(
                         a3,
                         v6);
  v8 = AllByIdAndInstance;
  if ( AllByIdAndInstance < 0 )
  {
    v9 = 873LL;
LABEL_35:
    v12 = (unsigned int)AllByIdAndInstance;
    goto LABEL_36;
  }
  AllByIdAndInstance = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v39 + 56LL))(v39, &cb);
  v8 = AllByIdAndInstance;
  if ( AllByIdAndInstance < 0 )
  {
    v9 = 874LL;
  ...
  wistd::unique_ptr<KSMULTIPLE_ITEM,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>::reset(
    &v36,
    v10);
  if ( !wil::operator==<Windows::Media::Devices::IModuleCommandResult,wil::err_returncode_policy>(&v36) )
  {
    v13 = *Windows::Internal::StringReference::StringReference((HSTRING *)&string, (const unsigned __int16 (*)[35])v11);
    v14 = wil::com_ptr_t<Windows::Media::Devices::IAudioDeviceModule,wil::err_returncode_policy>::operator&((__int64 *)&v44);
    AllByIdAndInstance = Windows::Foundation::GetActivationFactory<Windows::Storage::Streams::IDataReaderStatics>(
                           (__int64)v13,
                           (__int64)v14);
    v8 = AllByIdAndInstance;
    if ( AllByIdAndInstance < 0 )
    ...
    v16 = v39;
    v17 = *v44;
    v18 = wil::com_ptr_t<Windows::Media::Devices::IAudioDeviceModule,wil::err_returncode_policy>::operator&(&v43);
    AllByIdAndInstance = (*(__int64 (__fastcall **)(_QWORD *, __int64, __int64 *))(v17 + 48))(v15, v16, v18);
    v8 = AllByIdAndInstance;
    if ( AllByIdAndInstance < 0 )
    {
      v9 = 885LL;
    ...
    v19 = v36;
    AllByIdAndInstance = (*(__int64 (__fastcall **)(__int64, _QWORD, void *))(*(_QWORD *)v43 + 112LL))(v43, cb, v36);
    v8 = AllByIdAndInstance;
    if ( AllByIdAndInstance < 0 )
    {
      v9 = 886LL;
    ...
    *(_OWORD *)&string.Reserved.Reserved1 = *((_OWORD *)v19 + 1);
    AddressOf = Microsoft::WRL::Wrappers::HString::GetAddressOf(&v40);
    AllByIdAndInstance = GuidToHString((struct _GUID *)&string, AddressOf);
    v8 = AllByIdAndInstance;
    if ( AllByIdAndInstance < 0 )
    {
      v9 = 890LL;
    ...
    v21 = v40;
    v22 = wil::com_ptr_t<Windows::Media::Devices::IAudioDeviceModule,wil::err_returncode_policy>::operator&((__int64 *)&v38);
    ...
    AllByIdAndInstance = (*(__int64 (__fastcall **)(__int64 *, int *))(*v38 + 56))(v38, &cb_4);
    v8 = AllByIdAndInstance;
    if ( AllByIdAndInstance < 0 )
    {
      v9 = 895LL;
    ...
    v23 = (__int64)v38;
    v24 = *v38;
    v25 = wil::com_ptr_t<Windows::Media::Devices::IAudioDeviceModule,wil::err_returncode_policy>::operator&((__int64 *)&v37);
    AllByIdAndInstance = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64 *))(v24 + 48))(v23, 0LL, v25);
    v8 = AllByIdAndInstance;
    if ( AllByIdAndInstance < 0 )
    {
      v9 = 899LL;
    ...
    if ( wil::operator==<Windows::Media::Devices::IModuleCommandResult,wil::err_returncode_policy>(&v37) )
    {
      v8 = -2147467259;
      v12 = 2147500037LL;
      v9 = 900LL;
    ...
    Microsoft::WRL::Wrappers::HStringReference::CreateReference(
      ...
      0x22u);
    v26 = v48;
    v27 = wil::com_ptr_t<Windows::Media::Devices::IAudioDeviceModule,wil::err_returncode_policy>::operator&((__int64 *)&v35);
    AllByIdAndInstance = Windows::Foundation::ActivateInstance<Windows::Storage::Streams::IDataWriter>(v26, v27);
    v8 = AllByIdAndInstance;
    if ( AllByIdAndInstance < 0 )
    {
      v9 = 904LL;
    ...
    if ( wil::com_ptr_t<Windows::Foundation::Collections::Internal::Vector<Windows::Media::Devices::Internal::AudioDeviceBrokerDevice *,Windows::Foundation::Collections::Internal::DefaultEqualityPredicate<Windows::Media::Devices::Internal::AudioDeviceBrokerDevice *>,Windows::Foundation::Collections::Internal::DefaultLifetimeTraits<Windows::Media::Devices::Internal::AudioDeviceBrokerDevice *>,Windows::Foundation::Collections::Internal::DefaultVectorOptions<Windows::Media::Devices::Internal::AudioDeviceBrokerDevice *>>,wil::err_returncode_policy>::operator bool(&v35) )
    {
      AllByIdAndInstance = (*(__int64 (__fastcall **)(__int64 *, _QWORD, __int64))(*v35 + 96))(
                             v35,
                             cb - 40,
                             (__int64)v19 + 40);
      v8 = AllByIdAndInstance;
      ...
      v28 = (__int64)v35;
      v29 = *v35;
      v30 = wil::com_ptr_t<Windows::Media::Devices::IAudioDeviceModule,wil::err_returncode_policy>::operator&(&v42);
      AllByIdAndInstance = (*(__int64 (__fastcall **)(__int64, __int64 *))(v29 + 248))(v28, v30);
      v8 = AllByIdAndInstance;
      if ( AllByIdAndInstance < 0 )
      {
        v9 = 909LL;
    ...
    *(_QWORD *)&v46 = v42;
    v45 = v37;
    v31 = Microsoft::WRL::Details::Make<Windows::Media::Devices::AudioDeviceModuleNotificationEventArgs,Windows::Media::Devices::IAudioDeviceModule *,Windows::Storage::Streams::IBuffer *>(
            (__int64 *)&string,
            &v45,
            (struct Windows::Storage::Streams::IBuffer **)&v46);
    wil::com_ptr_t<Windows::Media::Devices::AudioDeviceModuleNotificationEventArgs,wil::err_returncode_policy>::operator=<Windows::Media::Devices::AudioDeviceModuleNotificationEventArgs,void>(
      (__int64 *)&v41,
      v31);
    Microsoft::WRL::ComPtr<Windows::Media::Devices::AudioDeviceModuleNotificationEventArgs>::~ComPtr<Windows::Media::Devices::AudioDeviceModuleNotificationEventArgs>((__int64 *)&string);
    v45 = v41;
...
LABEL_36:
  wil::details::in1diag3::Return_Hr(
    ...
    (const char *)v12);
LABEL_38:
  Microsoft::WRL::Wrappers::HString::~HString(&v40);
  wistd::unique_ptr<_KSAUDIOMODULE_NOTIFICATION,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>::~unique_ptr<_KSAUDIOMODULE_NOTIFICATION,wil::function_deleter<void (*)(void *),&void CoTaskMemFree(void *)>>((__int64)&v36);
  wil::com_ptr_t<Windows::Media::Devices::AudioDeviceModuleNotificationEventArgs,wil::err_returncode_policy>::~com_ptr_t<Windows::Media::Devices::AudioDeviceModuleNotificationEventArgs,wil::err_returncode_policy>(&v41);
  ...
  wil::com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>::~com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>(&v42);
  wil::com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>::~com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>(&v39);
