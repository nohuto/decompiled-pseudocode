/*
 * XREFs of ?GetProtectedOutputController@CAudioDeviceGraph@@UEAAJIPEAPEAUIAudioProtectedOutputController@@@Z @ 0x140049B00
 * Callers:
 *     <none>
 * Callees:
    ...
    *a3 = 0LL;
    if ( *((_DWORD *)this + 62) )
    {
      if ( a2 != 4 || *((_DWORD *)this + 74) )
      {
        v9 = *((_QWORD *)this + 19);
        v12 = 0LL;
        Tail = ATL::CAtlList<CConnectionInstance *,ATL::CElementTraits<CConnectionInstance *>>::GetTail(v9 + 16);
