/*
 * XREFs of ?InitializeCpuManager@@YAJXZ @ 0x140013BCC
 * Callers:
...
__int64 InitializeCpuManager(void)
{
  ...
  return Microsoft::WRL::Details::MakeAndInitialize<CpuManager,CpuManager,>((CpuManager **)&qword_140090360);
}
