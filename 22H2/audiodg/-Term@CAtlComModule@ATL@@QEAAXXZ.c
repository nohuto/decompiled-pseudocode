/*
 * XREFs of ?Term@CAtlComModule@ATL@@QEAAXXZ @ 0x14001C920
 * Callers:
 *     ??1CAudioDGModule@@UEAA@XZ @ 0x14001CB28 (--1CAudioDGModule@@UEAA@XZ.c)
 *     ATL::_dynamic_atexit_destructor_for___AtlComModule__ @ 0x14002DB30 (ATL--_dynamic_atexit_destructor_for___AtlComModule__.c)
