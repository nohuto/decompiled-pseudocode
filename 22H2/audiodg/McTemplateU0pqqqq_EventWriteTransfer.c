/*
 * XREFs of McTemplateU0pqqqq_EventWriteTransfer @ 0x140063B04
 * Callers:
...
ULONG __fastcall McTemplateU0pqqqq_EventWriteTransfer(
        __int64 a1,
        ...
        char a7)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, a2, a3, 6u, &v8);
}
