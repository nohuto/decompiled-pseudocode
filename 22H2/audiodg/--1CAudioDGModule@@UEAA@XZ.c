/*
 * XREFs of ??1CAudioDGModule@@UEAA@XZ @ 0x14001CB28
 * Callers:
 *     _dynamic_atexit_destructor_for___AtlModule__ @ 0x14002DA90 (_dynamic_atexit_destructor_for___AtlModule__.c)
...
void __fastcall CAudioDGModule::~CAudioDGModule(CAudioDGModule *this, void *a2)
{
  ...
  *((_QWORD *)this + 13) = &CAudioDGModule::`vftable'{for `IAudioHealthMonitor'};
  ...
  {
    EtwUnregisterTraceGuids(qword_14006F020);
    qword_14006F020 = 0LL;
