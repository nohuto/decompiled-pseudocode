/*
 * XREFs of ??I?$com_ptr_t@VSendCommandAsyncOperation@Devices@Media@Windows@@Uerr_returncode_policy@wil@@@wil@@QEAAPEAPEAVSendCommandAsyncOperation@Devices@Media@Windows@@XZ @ 0x140021194
 * Callers:
