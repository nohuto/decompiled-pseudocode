/*
 * XREFs of ?AeServerConnectPortInternal@HandleSendReceiveClient@@AEAAJPEAGPEAPEAX@Z @ 0x140051364
 * Callers:
 *     ?Initialize@HandleSendReceiveClient@@QEAAJPEAG@Z @ 0x1400514E8 (-Initialize@HandleSendReceiveClient@@QEAAJPEAG@Z.c)
 * Callees:
