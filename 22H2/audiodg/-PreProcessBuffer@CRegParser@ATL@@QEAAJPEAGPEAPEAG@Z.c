/*
 * XREFs of ?PreProcessBuffer@CRegParser@ATL@@QEAAJPEAGPEAPEAG@Z @ 0x14005DB00
 * Callers:
 ...
 *     ?StrChrW@CRegParser@ATL@@KAPEAGPEAGG@Z @ 0x14005F2F8 (-StrChrW@CRegParser@ATL@@KAPEAGPEAGG@Z.c)
 *     ?StrFromMap@CRegObject@ATL@@QEAAPEBGPEAG@Z @ 0x14005F34C (-StrFromMap@CRegObject@ATL@@QEAAPEBGPEAG@Z.c)
 */
