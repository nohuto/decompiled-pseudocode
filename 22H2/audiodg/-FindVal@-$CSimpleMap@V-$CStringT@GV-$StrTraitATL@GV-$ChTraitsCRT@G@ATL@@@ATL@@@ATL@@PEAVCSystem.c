/*
 * XREFs of ?FindVal@?$CSimpleMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAVCSystemAudioDeviceBase@@V?$CSimpleMapEqualHelper@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAVCSystemAudioDeviceBase@@@2@@ATL@@QEBAHAEBQEAVCSystemAudioDeviceBase@@@Z @ 0x1400419F4
 * Callers:
        ...
        __int64 *a2)
{
  ...
  if ( (int)qword_140090378 <= 0 )
    return 0xFFFFFFFFLL;
  v3 = *a2;
  for ( i = qword_140090370; *i != v3; ++i )
  {
    result = (unsigned int)(result + 1);
    if ( (int)result >= (int)qword_140090378 )
      return 0xFFFFFFFFLL;
  }
  return result;
}
