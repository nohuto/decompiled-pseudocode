/*
 * XREFs of McTemplateU0pqpqqqqqq_EventWriteTransfer @ 0x1400510E8
 * Callers:
 *     ?AERTAllocate@@YAPEAX_KPEAX@Z @ 0x14000AF10 (-AERTAllocate@@YAPEAX_KPEAX@Z.c)
 *     ?AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z @ 0x140013AD0 (-AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z.c)
 ...
 *     ?AERTUnlockZoneHeap@@YAJPEAX@Z @ 0x140050EA0 (-AERTUnlockZoneHeap@@YAJPEAX@Z.c)
