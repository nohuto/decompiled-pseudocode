/*
 * XREFs of ?Allocate@CAtlStringMgr@ATL@@UEAAPEAUCStringData@2@HH@Z @ 0x140019D00
 * Callers:
 *     <none>
 * Callees:
 *     ??$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z @ 0x140019D8C (--$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z.c)
