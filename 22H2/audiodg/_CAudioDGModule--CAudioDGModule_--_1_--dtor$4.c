/*
 * XREFs of _CAudioDGModule::CAudioDGModule_::_1_::dtor$4 @ 0x14002D6AA
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioDGModule::CAudioDGModule_::_1_::dtor_4(__int64 a1, _QWORD *a2)
{
