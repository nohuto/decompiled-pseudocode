/*
 * XREFs of ?MoveNext@?$SimpleVectorIterator@PEAUIBuffer@Streams@Storage@Windows@@V?$Vector@PEAUIBuffer@Streams@Storage@Windows@@U?$DefaultEqualityPredicate@PEAUIBuffer@Streams@Storage@Windows@@@Internal@Collections@Foundation@4@U?$DefaultLifetimeTraits@PEAUIBuffer@Streams@Storage@Windows@@@6784@U?$DefaultVectorOptions@PEAUIBuffer@Streams@Storage@Windows@@@6784@@Internal@Collections@Foundation@4@U?$DefaultLifetimeTraits@PEAUIBuffer@Streams@Storage@Windows@@@6784@UIntVersionTag@XWinRT@@$0A@@Internal@Collections@Foundation@Windows@@UEAAJPEAE@Z @ 0x1400585A0
 * Callers:
 *     <none>
 * Callees:
 *     _lambda_ed38f1c9fab6ded12fecd945b1b9e25e_::operator() @ 0x140054E0C (_lambda_ed38f1c9fab6ded12fecd945b1b9e25e_--operator().c)
 */
        ...
        _BYTE *a2)
{
  ...
  *a2 = 0;
  ...
  if ( v2 >= 0 )
  {
    v5 = lambda_ed38f1c9fab6ded12fecd945b1b9e25e_::operator()(v7);
    v2 = v5;
