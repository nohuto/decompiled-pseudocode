/*
 * XREFs of ?GetFrameCount@CSpatialCrossProcessClientOutputEndpoint@@UEAAJPEAI@Z @ 0x14006C3B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  v4 = _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this + 159) + 44LL), 0, 0);
  v5 = *((_DWORD *)this + 67);
  v6 = v5;
  if ( v4 < v5 )
    v6 = v4;
