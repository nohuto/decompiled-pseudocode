        ...
        _QWORD *a3)
{
  ...
  v5 = (void *)_o__recalloc(qword_140090368, (int)qword_140090378 + 1, 8LL);
  if ( !v5 )
    return 0LL;
  qword_140090368 = v5;
  v6 = (char *)_o__recalloc(qword_140090370, (int)qword_140090378 + 1, 8LL);
  if ( !v6 )
    return 0LL;
  qword_140090370 = v6;
  v7 = qword_140090378;
  v8 = (int)qword_140090378;
  v9 = (char *)qword_140090368 + 8 * (int)qword_140090378;
  if ( v9 )
  {
    v10 = (char *)*a2;
    v11 = v10 - 24;
