/*
 * XREFs of ?GetPosition@CSpatialCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z @ 0x14006C710
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTimestampInitialized@CSpatialCrossProcessBaseEndpoint@@IEBA_NXZ @ 0x14006CC7C (-IsTimestampInitialized@CSpatialCrossProcessBaseEndpoint@@IEBA_NXZ.c)
 *     ?IsValidTimestamp@CSpatialCrossProcessBaseEndpoint@@IEBA_NXZ @ 0x14006CCB0 (-IsValidTimestamp@CSpatialCrossProcessBaseEndpoint@@IEBA_NXZ.c)
 */
...
LABEL_40:
  ...
  if ( (byte_140090541 & 4) != 0 )
  {
    ...
    if ( a3 )
      v26 = *a3;
    if ( v6 )
      v27 = *v6 * *((unsigned __int16 *)this - 504);
    else
      LOBYTE(v27) = v4;
    v28 = _InterlockedCompareExchange64((volatile signed __int64 *)(*((_QWORD *)this - 4) + 32LL), v4, 0LL);
    v29 = *((unsigned __int16 *)this - 504);
    v30 = (char *)this - 1320;
  ...
  if ( v6 )
  {
    v31 = *((_QWORD *)this - 148);
    v32 = *v6;
    if ( *v6 < v31 && ((unsigned __int8)a2 & 4) != 0 )
    {
      McTemplateU0pqxxxxffff_EventWriteTransfer(
        *v6,
        (__int64)a2,
