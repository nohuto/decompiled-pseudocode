/*
 * XREFs of ?GetAudioModules@AudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@UEAAJPEAU?$IVector@PEAVAudioDeviceModule@Devices@Media@Windows@@@Collections@Foundation@5@@Z @ 0x140022BB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StringCchLengthW@@YAJPEBG_KPEA_K@Z @ 0x14005090C (-StringCchLengthW@@YAJPEBG_KPEA_K@Z.c)
