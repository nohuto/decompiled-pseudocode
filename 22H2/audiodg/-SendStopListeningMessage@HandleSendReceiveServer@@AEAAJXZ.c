/*
 * XREFs of ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x1400515DC
 * Callers:
 *     ??1HandleSendReceiveServer@@UEAA@XZ @ 0x140018588 (--1HandleSendReceiveServer@@UEAA@XZ.c)
 * Callees:
 *     <none>
 */
