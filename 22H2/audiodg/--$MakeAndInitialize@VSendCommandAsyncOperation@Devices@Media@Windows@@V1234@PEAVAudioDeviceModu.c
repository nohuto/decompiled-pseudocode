/*
 * XREFs of ??$MakeAndInitialize@VSendCommandAsyncOperation@Devices@Media@Windows@@V1234@PEAVAudioDeviceModule@234@AEAPEAUIBuffer@Streams@Storage@4@@Details@WRL@Microsoft@@YAJPEAPEAVSendCommandAsyncOperation@Devices@Media@Windows@@$$QEAPEAVAudioDeviceModule@456@AEAPEAUIBuffer@Streams@Storage@6@@Z @ 0x140053F88
 * Callers:
    ...
    if ( v7 >= 0 )
    {
      if ( v8 )
      {
        ...
        while ( v9 >= 0 )
        {
          ...
          {
            v10 = v9;
            v9 = _InterlockedCompareExchange64(v8 + 20, v9 + 1, v9);
            if ( v10 != v9 )
              continue;
          }
          goto LABEL_11;
