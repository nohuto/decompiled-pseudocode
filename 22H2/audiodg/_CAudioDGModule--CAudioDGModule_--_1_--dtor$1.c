/*
 * XREFs of _CAudioDGModule::CAudioDGModule_::_1_::dtor$1 @ 0x14002D662
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioDGModule::CAudioDGModule_::_1_::dtor_1(__int64 a1, _QWORD *a2)
{
