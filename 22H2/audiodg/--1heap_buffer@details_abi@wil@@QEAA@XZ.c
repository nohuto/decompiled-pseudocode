/*
 * XREFs of ??1heap_buffer@details_abi@wil@@QEAA@XZ @ 0x1400210B4
 * Callers:
 *     _wil::details_abi::RawUsageIndex::RecordUsage_::_1_::dtor$0 @ 0x140025EF5 (_wil--details_abi--RawUsageIndex--RecordUsage_--_1_--dtor$0.c)
 * Callees:
