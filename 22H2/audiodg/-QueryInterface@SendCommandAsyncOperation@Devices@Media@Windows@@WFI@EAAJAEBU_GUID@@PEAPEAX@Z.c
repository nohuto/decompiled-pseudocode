/*
 * XREFs of ?QueryInterface@SendCommandAsyncOperation@Devices@Media@Windows@@WFI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14002ADA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall Windows::Media::Devices::SendCommandAsyncOperation::QueryInterface(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
