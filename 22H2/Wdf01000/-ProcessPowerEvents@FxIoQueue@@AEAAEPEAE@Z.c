/*
 * XREFs of ?ProcessPowerEvents@FxIoQueue@@AEAAEPEAE@Z @ 0x1C00143AC
 * Callers:
...
LABEL_83:
    ...
    {
      while ( ($55631384234A24007A0779E5E472941C *)v53[-1].m_IoPkgListNode.m_ListEntry.Blink != &v30->120 )
      {
...
LABEL_71:
          ...
          {
            while ( ($55631384234A24007A0779E5E472941C *)v31[-1].m_IoPkgListNode.m_ListEntry.Blink != &v30->120 )
            {
