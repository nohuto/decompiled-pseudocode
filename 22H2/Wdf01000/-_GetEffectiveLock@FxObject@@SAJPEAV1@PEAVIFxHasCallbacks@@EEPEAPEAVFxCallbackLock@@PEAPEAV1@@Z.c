/*
 * XREFs of ?_GetEffectiveLock@FxObject@@SAJPEAV1@PEAVIFxHasCallbacks@@EEPEAPEAVFxCallbackLock@@PEAPEAV1@@Z @ 0x1C0013ED8
 * Callers:
 ...
 *     ?IsPassiveCallbacks@FxObject@@QEAAEE@Z @ 0x1C005A0AC (-IsPassiveCallbacks@FxObject@@QEAAEE@Z.c)
 */
