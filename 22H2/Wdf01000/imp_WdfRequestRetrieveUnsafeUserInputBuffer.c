/*
 * XREFs of imp_WdfRequestRetrieveUnsafeUserInputBuffer @ 0x1C004AC90
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( CurrentStackLocation->MajorFunction == 3 )
    {
      if ( m_Globals->FxVerboseOn )
      {
        v18 = 29;
LABEL_17:
        WPP_IFR_SF_qL(m_Globals, 5u, 0x10u, v18, WPP_FxRequestApi_cpp_Traceguids, Request, 0xC0000010);
        return v13;
      }
      return v13;
    }
...
LABEL_34:
    ...
    WPP_IFR_SF_qL(m_Globals, 2u, 0x10u, 0x21u, WPP_FxRequestApi_cpp_Traceguids, Request, 0xC0000010);
