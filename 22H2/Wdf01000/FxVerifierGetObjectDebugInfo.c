/*
 * XREFs of FxVerifierGetObjectDebugInfo @ 0x1C0058184
 * Callers:
...
FxObjectDebugInfo *__fastcall FxVerifierGetObjectDebugInfo(void *Key, _FX_DRIVER_GLOBALS *FxDriverGlobals)
{
  ...
  *(_OWORD *)&valueName_buffer[40] = *(_OWORD *)L"ionLimit";
  ULong = FxRegKey::_QueryULong(Key, (_UNICODE_STRING *)&valueName.Buffer, (unsigned int *)&pInfo);
  v6 = (int)pInfo;
  if ( ULong < 0 )
    v6 = -1;
  LODWORD(pInfo) = v6;
  ...
  {
    *(_OWORD *)&FxVerifyLeakDetection->Enabled = 0LL;
