...
int __fastcall FxIoQueue::GetRequest(
        ...
        $55631384234A24007A0779E5E472941C **pOutRequest)
{
  _FX_DRIVER_GLOBALS *m_Globals; // rsi
  _FILE_OBJECT *v7; // rbx
  $55631384234A24007A0779E5E472941C *v9; // rbp
  ...
  $55631384234A24007A0779E5E472941C *v16; // rbx
  _LIST_ENTRY *v17; // rax
  $55631384234A24007A0779E5E472941C *v18; // rbx
  _LIST_ENTRY *v19; // rax
  ...
  $55631384234A24007A0779E5E472941C *v44; // [rsp+48h] [rbp-40h]
...
LABEL_35:
      ...
      v16 = ($55631384234A24007A0779E5E472941C *)i->Tail.Overlay.DriverContext[3];
    ...
    ((void (__fastcall *)($55631384234A24007A0779E5E472941C *, __int64, __int64, const char *))v19)(
      v18,
      1969583441LL,
      2102LL,
    ...
    v38 = 1123LL;
LABEL_79:
    ((void (__fastcall *)($55631384234A24007A0779E5E472941C *, __int64, __int64, const char *))v18->m_ListEntry.Flink[1].Flink)(
      v18,
      1886220099LL,
      v38,
...
LABEL_83:
  ...
  *((_BYTE *)&v18[14].m_ListEntry + 16) = 1;
  ((void (__fastcall *)($55631384234A24007A0779E5E472941C *, __int64, __int64, const char *))v27[1].Flink)(
    v18,
    1952543827LL,
    1193LL,
    "minkernel\\wdf\\framework\\shared\\irphandlers\\io\\fxioqueue.cpp");
