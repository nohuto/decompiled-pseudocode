 ...
 * Callers:
 *     ?UpdateInteractionSummary@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_NI@Z @ 0x1801612E8 (-UpdateInteractionSummary@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLate.c)
 * Callees:
        ...
        __int64 a9)
{
  ...
  v14 = 8LL;
  v12 = 8LL;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180344EB8, a2, 0LL, 0LL, 7u, &v10);
}
