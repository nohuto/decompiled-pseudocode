/*
 * XREFs of ?SetTangentData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1801C9CFC
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[18] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1222u, 0LL);
    }
    else
    {
