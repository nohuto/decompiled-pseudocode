/*
 * XREFs of ?ProcessSetSources@CExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EXPRESSION_SETSOURCES@@PEBXI@Z @ 0x180049288
 * Callers:
...
LABEL_14:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x64u, 0LL);
LABEL_21:
  if ( *((_DWORD *)a3 + 3) )
    *((_BYTE *)this + 456) |= 1u;
  return v17;
