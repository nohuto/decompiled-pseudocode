/*
 * XREFs of ?SetProperty@CVisual@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180098630
 * Callers:
...
LABEL_43:
    v11 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)a1, 0LL, 0, -2147024809, 0x988u, 0LL);
    return v11;
  }
  v8 = a4[2];
  v9 = a4[1];
