/*
 * XREFs of ?Release@CSpectreCallbackRenderer@@UEAAKXZ @ 0x1801D6CB0
 * Callers:
 *     ?Release@CSpectreCallbackRenderer@@W7EAAKXZ @ 0x18011DAA0 (-Release@CSpectreCallbackRenderer@@W7EAAKXZ.c)
 * Callees:
 *     <none>
 */
