/*
 * XREFs of ?_Change_array@?$vector@UInstance_Pos4_QRot_ColorDW_Size2@@V?$allocator@UInstance_Pos4_QRot_ColorDW_Size2@@@std@@@std@@AEAAXQEAUInstance_Pos4_QRot_ColorDW_Size2@@_K1@Z @ 0x18017377C
 * Callers:
