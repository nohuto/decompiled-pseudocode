/*
 * XREFs of ??1?$CTransform3DGroupGeneratedT@VCTransform3DGroup@@VCTransform3D@@@@MEAA@XZ @ 0x18016B79C
 * Callers:
 *     ??1CTransform3DGroup@@MEAA@XZ @ 0x1801B5DD0 (--1CTransform3DGroup@@MEAA@XZ.c)
 * Callees:
