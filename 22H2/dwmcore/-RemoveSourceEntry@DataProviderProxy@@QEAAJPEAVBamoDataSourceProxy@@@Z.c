/*
 * XREFs of ?RemoveSourceEntry@DataProviderProxy@@QEAAJPEAVBamoDataSourceProxy@@@Z @ 0x180181B08
 * Callers:
 *     ?OnDisconnected@DataSourceProxy@@MEAAJXZ @ 0x180180680 (-OnDisconnected@DataSourceProxy@@MEAAJXZ.c)
