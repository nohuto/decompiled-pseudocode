/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SpatialCompositionLabel@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801E9AD4
 * Callers:
 ...
 *     ?OnSceneFrameTick@CSceneWorld@@EEAAJPEAUISpectreRenderer@@_K@Z @ 0x18020B520 (-OnSceneFrameTick@CSceneWorld@@EEAAJPEAUISpectreRenderer@@_K@Z.c)
 * Callees:
