/*
 * XREFs of ?WindowNodeSetComposeOnce@CChannel@@UEAAJI_N@Z @ 0x1800DF170
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::WindowNodeSetComposeOnce(CChannel *this, unsigned int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
