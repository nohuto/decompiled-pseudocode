/*
 * XREFs of ?PreSubgraph@COcclusionContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x180085300
 * Callers:
...
LABEL_250:
    if ( v110 >= 0 )
      goto LABEL_251;
    MilInstrumentationCheckHR_MaybeFailFast(v112, 0LL, 0, v110, 0x6FAu, 0LL);
    goto LABEL_260;
  }
  ...
  if ( v137 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v112, 0LL, 0, v137, 0x7EFu, 0LL);
  }
  else
  {
  ...
  if ( v110 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v112, 0LL, 0, v110, 0x7B0u, 0LL);
    goto LABEL_250;
  }
LABEL_251:
  if ( !*(_QWORD *)(v113 + 120) )
  {
    ...
    v110 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v156, 0LL, 0, -2003292412, 0x6FFu, 0LL);
    v9 = -2003292412;
LABEL_258:
