/*
 * XREFs of ?RenderTexture@CHolographicInteropTarget@@AEAAJPEAVCDrawingContext@@PEAVCHolographicInteropTexture@@II@Z @ 0x180257E24
 * Callers:
 ...
 *     ?IsEmpty@CDirtyRegion@@QEBA_NXZ @ 0x18008F49C (-IsEmpty@CDirtyRegion@@QEBA_NXZ.c)
 *     ?EndFrame@CDrawingContext@@QEAAJXZ @ 0x18008FC84 (-EndFrame@CDrawingContext@@QEAAJXZ.c)
 *     ?GetFrameContainsMonitorSpecificContent@CDrawingContext@@QEBA_NXZ @ 0x1800DB3BC (-GetFrameContainsMonitorSpecificContent@CDrawingContext@@QEBA_NXZ.c)
 ...
 *     ?BeginFrame@CHolographicInteropTexture@@QEAAPEAVIRenderTargetBitmap@@II@Z @ 0x1802588C8 (-BeginFrame@CHolographicInteropTexture@@QEAAPEAVIRenderTargetBitmap@@II@Z.c)
 *     ?EndFrame@CHolographicInteropTexture@@QEAAXII_N@Z @ 0x180258B18 (-EndFrame@CHolographicInteropTexture@@QEAAXII_N@Z.c)
