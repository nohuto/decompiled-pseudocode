/*
 * XREFs of ?reserve_region@?$vector_facade@UFrameData@CDrawListEntry@@V?$buffer_impl@UFrameData@CDrawListEntry@@$00$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAUFrameData@CDrawListEntry@@_K0@Z @ 0x1801A26B8
 * Callers:
 *     ??$emplace@W4Enum@BlendMode@@MVCMILMatrix@@@?$vector_facade@UFrameData@CDrawListEntry@@V?$buffer_impl@UFrameData@CDrawListEntry@@$00$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAA?AV?$basic_iterator@UFrameData@CDrawListEntry@@@1@V?$basic_iterator@$$CBUFrameData@CDrawListEntry@@@1@W4Enum@BlendMode@@MVCMILMatrix@@@Z @ 0x1801A1394 (--$emplace@W4Enum@BlendMode@@MVCMILMatrix@@@-$vector_facade@UFrameData@CDrawListEntry@@V-$buffer.c)
 * Callees:
 *     ??$move_backward@V?$move_iterator@PEAUFrameData@CDrawListEntry@@@std@@V?$checked_array_iterator@PEAUFrameData@CDrawListEntry@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAUFrameData@CDrawListEntry@@@stdext@@V?$move_iterator@PEAUFrameData@CDrawListEntry@@@0@0V12@@Z @ 0x1801A14B0 (--$move_backward@V-$move_iterator@PEAUFrameData@CDrawListEntry@@@std@@V-$checked_array_iterator@.c)
 *     ??$move_backward_uninitialized@V?$basic_iterator@UFrameData@CDrawListEntry@@@detail@@V?$checked_array_iterator@PEAUFrameData@CDrawListEntry@@@stdext@@@detail@@YAXV?$basic_iterator@UFrameData@CDrawListEntry@@@0@0V?$checked_array_iterator@PEAUFrameData@CDrawListEntry@@@stdext@@@Z @ 0x1801A156C (--$move_backward_uninitialized@V-$basic_iterator@UFrameData@CDrawListEntry@@@detail@@V-$checked_.c)
