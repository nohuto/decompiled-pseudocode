/*
 * XREFs of ??1CWindowBackgroundTreatment@@UEAA@XZ @ 0x1800C0B1C
 * Callers:
 ...
 *     ?InvalidateDependentCachedTreatments@CWindowBackgroundTreatment@@AEAAXXZ @ 0x1800C1744 (-InvalidateDependentCachedTreatments@CWindowBackgroundTreatment@@AEAAXXZ.c)
