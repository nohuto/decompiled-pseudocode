/*
 * XREFs of ?CalculatePrediction@CInteractionContextTransformHelper@@QEAAXAEBUINTERACTION_CONTEXT_OUTPUT@@PEBUMANIPULATION_TRANSFORM@@PEBUtagRECT@@IMMPEAM3@Z @ 0x18026A8A0
 * Callers:
 ...
 *     _anonymous_namespace_::operator_ @ 0x18026A838 (_anonymous_namespace_--operator_.c)
