/*
 * XREFs of ?InternalCheckDirectFlipSupport@CDDisplaySwapChain@@MEBA_N_N0PEAUIUnknown@@AEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@2W4DXGI_COLOR_SPACE_TYPE@@I@Z @ 0x18028AE20
 * Callers:
 *     <none>
 * Callees:
