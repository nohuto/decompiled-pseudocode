/*
 * XREFs of ?UpdateRefreshRate@CLegacySwapChain@@UEAAJXZ @ 0x18029BC60
 * Callers:
 *     ?UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@BLA@EAAJXZ @ 0x18011FCC0 (-UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@BLA@EAAJXZ.c)
 *     ?UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@BLI@EAAJXZ @ 0x180120D60 (-UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@BLI@EAAJXZ.c)
 *     ?UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@DFI@EAAJXZ @ 0x180121420 (-UpdateRefreshRate@CLegacySwapChain@@$4PPPPPPPM@DFI@EAAJXZ.c)
 * Callees:
 ...
 *     ?GetCompositorClockBoost@CComposition@@QEBA_NXZ @ 0x1800C8C38 (-GetCompositorClockBoost@CComposition@@QEBA_NXZ.c)
 *     ?ValidateMinMaxVBlankDuration@@YAXAEBUDXGI_OUTPUT_DWM_DESC@@PEA_K1PEAI@Z @ 0x1800C8C70 (-ValidateMinMaxVBlankDuration@@YAXAEBUDXGI_OUTPUT_DWM_DESC@@PEA_K1PEAI@Z.c)
