/*
 * XREFs of ?RenderDirtyRegion@CLegacyRenderTarget@@IEAAJPEAVCDrawingContext@@AEBVCDirtyRegion@@IAEBV?$span@PEBVCVisual@@$0?0@gsl@@PEAVCComposeTop@@@Z @ 0x18008B5D8
 * Callers:
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    dword_1803E5A08 += (int)(float)((float)(v26 - v27) * (float)(v28 - v29));
