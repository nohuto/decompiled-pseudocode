/*
 * XREFs of ?GetDDisplayResource@CDxHandleBitmapRealization@@UEAAJPEAUIDisplayDeviceInterop@@PEAPEAUIDisplaySurface@Core@Display@Devices@Windows@@PEAI@Z @ 0x180264370
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  v9 = 0;
  if ( *((_QWORD *)this + 3) && *((_DWORD *)this + 8) == dword_18034B650 )
  {
LABEL_9:
    if ( a4 )
