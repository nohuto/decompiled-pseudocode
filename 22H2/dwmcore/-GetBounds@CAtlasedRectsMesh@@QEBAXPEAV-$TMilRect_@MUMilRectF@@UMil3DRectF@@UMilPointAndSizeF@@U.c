/*
 * XREFs of ?GetBounds@CAtlasedRectsMesh@@QEBAXPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800C9EF8
 * Callers:
 *     ?EnsureBounds@CAtlasedRectsGroup@@IEBAXXZ @ 0x1800C9E60 (-EnsureBounds@CAtlasedRectsGroup@@IEBAXXZ.c)
 * Callees:
