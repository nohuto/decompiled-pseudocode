/*
 * XREFs of ?VisualSetEffect@CChannel@@UEAAJII@Z @ 0x1800D2290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualSetEffect(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckOptionalHandle((__int64)this, a3, 54);
  v8[0] = 416;
  v8[1] = a2;
  v8[2] = a3;
