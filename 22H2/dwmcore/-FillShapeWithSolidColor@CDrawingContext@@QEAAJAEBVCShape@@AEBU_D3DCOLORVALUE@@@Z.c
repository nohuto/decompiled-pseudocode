/*
 * XREFs of ?FillShapeWithSolidColor@CDrawingContext@@QEAAJAEBVCShape@@AEBU_D3DCOLORVALUE@@@Z @ 0x1801D58F0
 * Callers:
  ...
  if ( (*(unsigned __int8 (__fastcall **)(const struct CShape *, unsigned __int64 *))(*(_QWORD *)a2 + 64LL))(a2, &v19) )
  {
    ...
    if ( v8 )
    {
      ...
      *((_QWORD *)&v17 + 1) = v10;
      ...
      v15 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x8CBu, 0LL);
      operator delete(v10);
    }
    else
    {
      v15 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, -2147024882, 0x8C6u, 0LL);
    }
  }
  else
  {
    v15 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, -2147024809, 0x8CFu, 0LL);
  }
  return v15;
}
