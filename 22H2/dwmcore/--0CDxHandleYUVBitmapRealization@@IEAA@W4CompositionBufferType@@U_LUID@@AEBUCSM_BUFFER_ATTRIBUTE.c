/*
 * XREFs of ??0CDxHandleYUVBitmapRealization@@IEAA@W4CompositionBufferType@@U_LUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@PEAVCDecodeBitmap@@@Z @ 0x1802B3798
 * Callers:
 ...
 *     ??0CDeviceResource@@IEAA@XZ @ 0x18003C504 (--0CDeviceResource@@IEAA@XZ.c)
