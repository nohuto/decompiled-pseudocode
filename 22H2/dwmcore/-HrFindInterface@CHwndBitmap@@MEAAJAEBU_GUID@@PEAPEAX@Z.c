/*
 * XREFs of ?HrFindInterface@CHwndBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801C4630
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CContent@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006CDC0 (-HrFindInterface@CContent@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */

__int64 __fastcall CHwndBitmap::HrFindInterface(CHwndBitmap *this, const struct _GUID *a2, void **a3)
{
  unsigned int v4; // ecx
  __int64 v5; // rcx
  __int64 v6; // rcx
