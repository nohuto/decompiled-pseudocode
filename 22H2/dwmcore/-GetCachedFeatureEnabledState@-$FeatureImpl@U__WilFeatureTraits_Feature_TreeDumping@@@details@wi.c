/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_TreeDumping@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18019791C
 * Callers:
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    if ( !v10 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_18034750C
        || (v12 = 0, v13 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_180347540, &v12, 0x10uLL)) )
      {
