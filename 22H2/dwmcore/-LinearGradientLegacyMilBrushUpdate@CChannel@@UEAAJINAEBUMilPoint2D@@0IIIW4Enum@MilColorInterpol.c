/*
 * XREFs of ?LinearGradientLegacyMilBrushUpdate@CChannel@@UEAAJINAEBUMilPoint2D@@0IIIW4Enum@MilColorInterpolationMode@@W43MilBrushMappingMode@@W43MilGradientSpreadMethod@@PEBUMilGradientStop@@I@Z @ 0x18014FE40
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a13)
{
  ...
  v16 = a6;
  CChannel::CheckOptionalHandle(a1, a6, 60);
  v17 = a7;
  CChannel::CheckOptionalHandle(a1, a7, 185);
  v18 = a8;
  CChannel::CheckOptionalHandle(a1, a8, 185);
  v27 = 488;
