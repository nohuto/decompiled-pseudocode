/*
 * XREFs of ??_ECParticleColorBehavior@@UEAAPEAXI@Z @ 0x1801C3470
 * Callers:
 *     ??_ECParticleVector3Behavior@@WHA@EAAPEAXI@Z @ 0x18011BCE0 (--_ECParticleVector3Behavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
