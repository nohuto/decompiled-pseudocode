/*
 * XREFs of ??_ECParticleColorBehavior@@UEAAPEAXI@Z @ 0x18016D280
 * Callers:
 *     ??_ECParticleColorBehavior@@WGI@EAAPEAXI@Z @ 0x1800F41B0 (--_ECParticleColorBehavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
