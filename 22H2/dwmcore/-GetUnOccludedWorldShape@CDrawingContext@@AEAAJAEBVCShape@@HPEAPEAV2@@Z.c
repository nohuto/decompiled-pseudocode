/*
 * XREFs of ?GetUnOccludedWorldShape@CDrawingContext@@AEAAJAEBVCShape@@HPEAPEAV2@@Z @ 0x18000F220
 * Callers:
          ...
          if ( CMILMatrix::Is2DAxisAlignedPreserving(TopByReference) )
          {
            ...
            if ( (*(int (__fastcall **)(const struct CShape *, __int128 *, _QWORD))(v12 + 48))(a2, &v18, 0LL) >= 0 )
            {
                                      ...
                                      (__int64)&v20) )
              {
                ...
                v9 = v16;
                if ( v16 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x1494u, 0LL);
              }
            }
          }
        }
