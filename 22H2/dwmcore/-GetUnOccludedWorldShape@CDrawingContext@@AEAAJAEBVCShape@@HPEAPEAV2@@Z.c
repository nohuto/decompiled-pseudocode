/*
 * XREFs of ?GetUnOccludedWorldShape@CDrawingContext@@AEAAJAEBVCShape@@HPEAPEAV2@@Z @ 0x18008D184
 * Callers:
  ...
  if ( *(_DWORD *)(v6 + 432) )
  {
    ...
    if ( v35 > 0.0 )
    {
      ...
      *(_OWORD *)v73 = v74;
      ...
      v9 = v60;
      if ( v60 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v61, 0LL, 0, v60, 0x13BBu, 0LL);
    }
  }
  return v9;
}
