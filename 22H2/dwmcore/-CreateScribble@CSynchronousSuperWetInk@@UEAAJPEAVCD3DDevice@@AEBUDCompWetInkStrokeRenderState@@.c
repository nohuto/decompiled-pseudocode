/*
 * XREFs of ?CreateScribble@CSynchronousSuperWetInk@@UEAAJPEAVCD3DDevice@@AEBUDCompWetInkStrokeRenderState@@PEAPEAVCComputeScribble@@@Z @ 0x1801EF4E0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v8 >= 0 )
      {
        ...
        *a4 = v17;
        if ( *((_BYTE *)v11 + 12) )
        {
          if ( !*((_BYTE *)this + 136) )
          {
            if ( (unsigned int)dword_180344EB8 > 4
              && (qword_180344EC8 & 8) != 0
              && (qword_180344ED0 & 8) == qword_180344ED0 )
            {
              v36 = 0;
              v34 = &v23;
              v23 = (char *)this - 112;
              ...
              tlgWriteTransfer_EventWriteTransfer(
                ...
                (unsigned __int8 *)dword_1802E9B6B,
                0LL,
                0LL,
                3u,
                &v33);
            ...
            && (qword_180344ED0 & 8) == qword_180344ED0 )
          {
            ...
            tlgWriteTransfer_EventWriteTransfer(
              (__int64)&dword_180344EB8,
              (unsigned __int8 *)dword_1802E9B21,
              0LL,
              0LL,
              3u,
              &v33);
