/*
 * XREFs of ?ProcessSetTemplate@CEffectBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EFFECTBRUSH_SETTEMPLATE@@@Z @ 0x18003E5A0
 * Callers:
...
LABEL_19:
  MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0xCAu, 0LL);
  return v9;
}
