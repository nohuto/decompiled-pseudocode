/*
 * XREFs of ?ScheduleCompositionPass@CPartitionVerticalBlankScheduler@@UEAAXKW4CompositionReason@@@Z @ 0x1800C2E10
 * Callers:
...
LABEL_2:
  ...
  v7 = a3 | dword_180347620;
  result = (unsigned int)~_InterlockedOr(&dword_180347620, a3);
