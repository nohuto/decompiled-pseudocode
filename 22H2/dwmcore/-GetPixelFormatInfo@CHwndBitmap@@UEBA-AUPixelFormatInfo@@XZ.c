/*
 * XREFs of ?GetPixelFormatInfo@CHwndBitmap@@UEBA?AUPixelFormatInfo@@XZ @ 0x1801C44A0
 * Callers:
 *     ?IsOpaque@CHwndBitmap@@UEBA_NXZ @ 0x1801C46D0 (-IsOpaque@CHwndBitmap@@UEBA_NXZ.c)
 * Callees:
