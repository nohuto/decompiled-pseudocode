/*
 * XREFs of ??$UnmarshalResourceArray@VCTransform@@@CResource@@SAJPEBXIIW4MIL_RESOURCE_TYPE@@PEAIPEAPEAPEAVCTransform@@PEAVCResourceTable@@_N@Z @ 0x180168D20
 * Callers:
        ...
        __int64 a7)
{
  ...
  result = CResource::UnmarshalResourceArray(a1, a2, a3, 0xB9u, a5, &v8, a7, 0);
  *a6 = v8;
  return result;
}
