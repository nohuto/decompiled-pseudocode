/*
 * XREFs of ??_ECHolographicFrameProcessor@@MEAAPEAXI@Z @ 0x18025C538
 * Callers:
 *     ??_ECHolographicFrameProcessor@@O7EAAPEAXI@Z @ 0x1800F7DC0 (--_ECHolographicFrameProcessor@@O7EAAPEAXI@Z.c)
 * Callees:
