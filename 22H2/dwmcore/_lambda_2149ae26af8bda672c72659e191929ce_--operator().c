/*
 * XREFs of _lambda_2149ae26af8bda672c72659e191929ce_::operator() @ 0x1801C77D8
 * Callers:
 *     ?InsertDependenciesForProperty@CInteractionTracker@@QEAAX_KW4Enum@InteractionTrackerProperty@@@Z @ 0x1801C9D4C (-InsertDependenciesForProperty@CInteractionTracker@@QEAAX_KW4Enum@InteractionTrackerProperty@@@Z.c)
 * Callees:
