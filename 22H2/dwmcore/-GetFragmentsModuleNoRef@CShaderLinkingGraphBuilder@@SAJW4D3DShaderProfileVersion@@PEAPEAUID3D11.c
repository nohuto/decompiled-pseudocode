/*
 * XREFs of ?GetFragmentsModuleNoRef@CShaderLinkingGraphBuilder@@SAJW4D3DShaderProfileVersion@@PEAPEAUID3D11Module@@@Z @ 0x18002836C
 * Callers:
...
__int64 __fastcall CShaderLinkingGraphBuilder::GetFragmentsModuleNoRef(char a1, struct ID3D11Module **a2)
{
  ...
  if ( !a1 )
  {
    ...
    if ( qword_1803EA7F0 )
      goto LABEL_4;
    v6 = D3DLoadModule(&unk_18039C670, 0x1B22BuLL, &qword_1803EA7F0);
    v2 = v6;
    if ( v6 >= 0 )
    {
      v4 = qword_1803EA7F0;
  ...
  if ( a1 == 1 )
  {
    ...
    if ( qword_1803E66C0 )
      goto LABEL_4;
    v6 = D3DLoadModule(&unk_1802EE460, 0x2CDEBuLL, &qword_1803E66C0);
    v2 = v6;
    if ( v6 >= 0 )
    {
      v4 = qword_1803E66C0;
...
LABEL_18:
  ...
  if ( !qword_1803E66B8 )
  {
    v6 = D3DLoadModule(&unk_18031B250, 0x20A4FuLL, &qword_1803E66B8);
    v2 = v6;
    if ( v6 >= 0 )
    {
      v4 = qword_1803E66B8;
