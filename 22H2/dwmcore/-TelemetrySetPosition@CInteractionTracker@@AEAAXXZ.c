/*
 * XREFs of ?TelemetrySetPosition@CInteractionTracker@@AEAAXXZ @ 0x1801CCD1C
 * Callers:
...
void __fastcall CInteractionTracker::TelemetrySetPosition(CInteractionTracker *this)
{
  ...
  if ( dword_180344EB8
    && (qword_180344EC8 & 0x400000000002LL) != 0
    && (qword_180344ED0 & 0x400000000002LL) == qword_180344ED0 )
  {
    v2 = 0LL;
