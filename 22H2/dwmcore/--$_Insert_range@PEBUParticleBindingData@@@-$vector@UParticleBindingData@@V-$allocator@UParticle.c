/*
 * XREFs of ??$_Insert_range@PEBUParticleBindingData@@@?$vector@UParticleBindingData@@V?$allocator@UParticleBindingData@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UParticleBindingData@@@std@@@std@@@1@PEBUParticleBindingData@@1Uforward_iterator_tag@1@@Z @ 0x1801BFA0C
 * Callers:
 ...
 *     ?_Change_array@?$vector@UParticleBindingData@@V?$allocator@UParticleBindingData@@@std@@@std@@AEAAXQEAUParticleBindingData@@_K1@Z @ 0x1801CAC0C (-_Change_array@-$vector@UParticleBindingData@@V-$allocator@UParticleBindingData@@@std@@@std@@AEA.c)
 */
