/*
 * XREFs of ??_GCHWDrawListEntry@@EEAAPEAXI@Z @ 0x180055370
 * Callers:
 *     ??_ECHWDrawListEntry@@GBA@EAAPEAXI@Z @ 0x1800F5CA0 (--_ECHWDrawListEntry@@GBA@EAAPEAXI@Z.c)
 * Callees:
 *     ?clear_region@?$vector_facade@UFrameData@CDrawListEntry@@V?$buffer_impl@UFrameData@CDrawListEntry@@$00$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x18001A524 (-clear_region@-$vector_facade@UFrameData@CDrawListEntry@@V-$buffer_impl@UFrameData@CDrawListEntr.c)
