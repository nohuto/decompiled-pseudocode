/*
 * XREFs of ?UpdateExpressions@CExpressionManager@@QEAAX_K0@Z @ 0x1800514E4
 * Callers:
 *     ?PreRender@CComposition@@IEAAJXZ @ 0x18004F2D0 (-PreRender@CComposition@@IEAAJXZ.c)
 * Callees:
 *     ?MustUpdateExpressions@CExpressionManager@@QEBA_NXZ @ 0x180052950 (-MustUpdateExpressions@CExpressionManager@@QEBA_NXZ.c)
 *     ?clear@?$_Hash@V?$_Uset_traits@PEAVCBaseExpression@@V?$_Uhash_compare@PEAVCBaseExpression@@U?$hash@PEAVCBaseExpression@@@std@@U?$equal_to@PEAVCBaseExpression@@@3@@std@@V?$allocator@PEAVCBaseExpression@@@3@$0A@@std@@@std@@QEAAXXZ @ 0x180053A84 (-clear@-$_Hash@V-$_Uset_traits@PEAVCBaseExpression@@V-$_Uhash_compare@PEAVCBaseExpression@@U-$ha.c)
 *     ?FlushQueuedSuspendAnimations@CExpressionManager@@AEAAXXZ @ 0x180053AB0 (-FlushQueuedSuspendAnimations@CExpressionManager@@AEAAXXZ.c)
 ...
 *     ?GetDurationAverage@CExpressionPerformanceCounter@@QEAANW4ExpressionPerformanceLabel@@@Z @ 0x180263324 (-GetDurationAverage@CExpressionPerformanceCounter@@QEAANW4ExpressionPerformanceLabel@@@Z.c)
 *     ?Reset@CExpressionPerformanceCounter@@QEAAXXZ @ 0x180263358 (-Reset@CExpressionPerformanceCounter@@QEAAXXZ.c)
 */
    ...
    if ( *((_DWORD *)this + 110) )
    {
      ...
      *((_BYTE *)this + 448) = *((_BYTE *)this + 448) & 0xF3 | (2 * (*((_BYTE *)this + 448) & 4));
      if ( (unsigned int)dword_1803E3798 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1803E3798, 4LL) )
        tlgWriteTransfer_EventWriteTransfer((int)&dword_1803E3798, (int)&dword_1803806A9, 0, 0, 2u, &v45);
