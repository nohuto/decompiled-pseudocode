/*
 * XREFs of ?ExecuteBlur@CRenderingTechnique@@QEAAJPEAVCDrawingContext@@AEBUEffectInput@@AEBUD2D_VECTOR_2F@@PEAU3@@Z @ 0x180037F24
 * Callers:
 ...
 *     ?HasMatchingParameters@CBlurRenderingGraph@@QEBA_NAEBUD2D_VECTOR_2F@@W4D2D1_GAUSSIANBLUR_OPTIMIZATION@@@Z @ 0x180038830 (-HasMatchingParameters@CBlurRenderingGraph@@QEBA_NAEBUD2D_VECTOR_2F@@W4D2D1_GAUSSIANBLUR_OPTIMIZ.c)
    ...
    if ( CBlurRenderingGraph::HasMatchingParameters(v36, &v37, v38[0]) )
    {
      if ( BackdropVisualImage )
      {
        ...
        if ( CBlurredBackdropCache::LookupCachedBlur(
               ...
               a5) )
        {
          v32 = DwmDbg::DbgString::DbgString((DwmDbg::DbgString *)&v41, word_18033C020);
        ...
        v17 = DwmDbg::DbgString::DbgString((DwmDbg::DbgString *)v43, word_18033C020);
    ...
    if ( CCommonRegistryData::EnableBackdropBlurCaching )
    {
      if ( CBackdropVisualImage::TranslateRenderTargetInfo(BackdropVisualImage, (struct RenderTargetInfo *)&v48) )
      {
        CBlurredBackdropCache::UpdateCachedBlur(
          ...
          a5);
        v26 = DwmDbg::DbgString::DbgString((DwmDbg::DbgString *)&v48, word_18033C020);
