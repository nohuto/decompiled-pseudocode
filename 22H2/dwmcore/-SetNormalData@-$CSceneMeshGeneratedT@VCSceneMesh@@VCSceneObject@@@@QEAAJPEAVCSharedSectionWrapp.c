/*
 * XREFs of ?SetNormalData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1801C7954
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[14] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x119Au, 0LL);
    }
    else
    {
