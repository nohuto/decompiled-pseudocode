/*
 * XREFs of ?UpdateRestrictToProcessId@BamoDataSourceProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180194320
 * Callers:
 *     ?Thunk_UpdateRestrictToProcessId_5@?$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180194300 (-Thunk_UpdateRestrictToProcessId_5@-$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@.c)
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoDataSourceProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x1801943D0 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoDataSourceProxyImpl@BamoImpl@@UEAAXPEAVBamoProxy.c)
 * Callees:
