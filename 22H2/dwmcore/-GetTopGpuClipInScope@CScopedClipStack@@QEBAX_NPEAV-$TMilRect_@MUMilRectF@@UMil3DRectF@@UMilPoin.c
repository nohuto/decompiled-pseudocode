/*
 * XREFs of ?GetTopGpuClipInScope@CScopedClipStack@@QEBAX_NPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800E01C4
 * Callers:
 *     ?PopCpuClip@CDrawingContext@@AEAAXXZ @ 0x180177648 (-PopCpuClip@CDrawingContext@@AEAAXXZ.c)
 * Callees:
 *     ?HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ @ 0x18006BF44 (-HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ.c)
 *     ?HasCpuClipsInScope@CScopedClipStack@@QEBA_NXZ @ 0x18006BF70 (-HasCpuClipsInScope@CScopedClipStack@@QEBA_NXZ.c)
