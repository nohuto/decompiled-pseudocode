/*
 * XREFs of ?GetPrimaryAdapter@CDisplayManager@@QEAAJPEAPEAUIDXGIAdapter1@@@Z @ 0x180030FC4
 * Callers:
...
__int64 __fastcall CDisplayManager::GetPrimaryAdapter(CDisplayManager *this, struct IDXGIAdapter1 **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( DXGIFactory < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, &dword_1802DCFC0, 2u, DXGIFactory, 0x5Bu, 0LL);
    goto LABEL_6;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1802DCFC0, 2u, v6, 0x5Eu, 0LL);
LABEL_6:
