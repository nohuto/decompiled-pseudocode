/*
 * XREFs of ?GenerateApproxBlurIntermediate@CProjectedShadow@@AEAAJPEAVCDrawingContext@@MAEBUD2D_SIZE_F@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x18024A0D4
 * Callers:
        ...
        struct IRenderTargetBitmap **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( !CProjectedShadow::s_cpMaskForBlur )
  {
    ...
    v10 = *(_QWORD *)(v9 + 328);
    v25 = 30;
    v11 = ShadowHelpers::GenerateMaskIntermediate(&v24, a2, &unk_1803B8788, v10, 0LL, 0, &v26, &v23);
    v13 = v11;
    if ( v11 < 0 )
    {
