/*
 * XREFs of ?CopyData@CRegion@FastRegion@@IEAAJPEBVCRgnData@Internal@2@@Z @ 0x180098D9C
 * Callers:
 ...
 *     ?Copy@CRgnData@Internal@FastRegion@@QEAAXAEBV123@@Z @ 0x18009A0F4 (-Copy@CRgnData@Internal@FastRegion@@QEAAXAEBV123@@Z.c)
