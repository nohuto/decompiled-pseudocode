/*
 * XREFs of ?DrawDirtyRegionVisualizationForCurrentNode@CDrawingContext@@AEAAJXZ @ 0x1801D3AE0
 * Callers:
 ...
 *     ?CurrentRedrawRegionColor@CComposition@@QEAA?AU_D3DCOLORVALUE@@XZ @ 0x1801B4AB8 (-CurrentRedrawRegionColor@CComposition@@QEAA-AU_D3DCOLORVALUE@@XZ.c)
 *     ??$?0$0?0V?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@$0A@@?$span@UMilRectF@@$0?0@gsl@@QEAA@AEAV?$vector@UMilRectF@@V?$allocator@UMilRectF@@@std@@@std@@@Z @ 0x1801D27CC (--$-0$0-0V-$vector@UMilRectF@@V-$allocator@UMilRectF@@@std@@@std@@$0A@@-$span@UMilRectF@@$0-0@gs.c)
