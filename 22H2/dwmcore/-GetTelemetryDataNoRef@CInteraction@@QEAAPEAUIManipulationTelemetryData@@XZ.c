/*
 * XREFs of ?GetTelemetryDataNoRef@CInteraction@@QEAAPEAUIManipulationTelemetryData@@XZ @ 0x1801C6034
 * Callers:
 ...
 *     ??0CManipulationTelemetryData@@QEAA@PEAVCComposition@@I@Z @ 0x1801C5ADC (--0CManipulationTelemetryData@@QEAA@PEAVCComposition@@I@Z.c)
