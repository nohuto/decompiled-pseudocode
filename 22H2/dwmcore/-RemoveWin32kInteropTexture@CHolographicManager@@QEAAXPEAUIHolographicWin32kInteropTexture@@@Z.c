/*
 * XREFs of ?RemoveWin32kInteropTexture@CHolographicManager@@QEAAXPEAUIHolographicWin32kInteropTexture@@@Z @ 0x180254348
 * Callers:
 *     ?Remove@CHolographicFrameProcessor@@UEAAXXZ @ 0x18025CD70 (-Remove@CHolographicFrameProcessor@@UEAAXXZ.c)
 * Callees:
