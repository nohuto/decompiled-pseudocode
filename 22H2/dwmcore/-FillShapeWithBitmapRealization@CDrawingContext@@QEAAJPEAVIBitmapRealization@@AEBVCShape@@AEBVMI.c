/*
 * XREFs of ?FillShapeWithBitmapRealization@CDrawingContext@@QEAAJPEAVIBitmapRealization@@AEBVCShape@@AEBVMILMatrix3x2@@_N@Z @ 0x180078054
 * Callers:
        ...
        bool a5)
{
  ...
  {
    v19 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, -2147024809, 0x8B3u, 0LL);
    return v19;
  }
  v23 = 0LL;
  v24 = a2;
  ...
  {
    v19 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2147024882, 0x8A9u, 0LL);
    goto LABEL_15;
  }
  for ( i = v13; v10; --v10 )
  {
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x8AFu, 0LL);
    operator delete(v15);
LABEL_15:
