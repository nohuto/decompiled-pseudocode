/*
 * XREFs of ?RenderContent@CVisual@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x18007A550
 * Callers:
 ...
 *     ?GetWindowBackgroundTreatmentVisual@CWindowBackgroundTreatment@@SAPEBVCVisual@@PEBV2@@Z @ 0x180014034 (-GetWindowBackgroundTreatmentVisual@CWindowBackgroundTreatment@@SAPEBVCVisual@@PEBV2@@Z.c)
...
LABEL_15:
          ...
          v20 = (*(__int64 (__fastcall **)(__int64, struct CDrawingContext *, char *, struct CDrawListCache *))(*(_QWORD *)v19 + 16LL))(
                  ...
                  v13);
          if ( v20 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v21, &dword_18033BD18, 3u, v20, 0x1035u, 0LL);
          goto LABEL_17;
        }
LABEL_42:
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)p_Blink, &dword_18033BD18, 3u, v15, 0x1030u, 0LL);
        v3 = v44;
LABEL_17:
        if ( v13 )
        {
