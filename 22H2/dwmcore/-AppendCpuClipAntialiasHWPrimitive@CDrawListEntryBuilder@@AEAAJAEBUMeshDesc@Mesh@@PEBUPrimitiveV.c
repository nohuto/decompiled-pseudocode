/*
 * XREFs of ?AppendCpuClipAntialiasHWPrimitive@CDrawListEntryBuilder@@AEAAJAEBUMeshDesc@Mesh@@PEBUPrimitiveVertexAttributesDesc@@_N2PEA_N@Z @ 0x18007D930
 * Callers:
 ...
 *     ?CalcOutlinePosition@CCpuClipAntialiasSink@@QEBAMGAEBUD2D_POINT_2F@@@Z @ 0x18007E788 (-CalcOutlinePosition@CCpuClipAntialiasSink@@QEBAMGAEBUD2D_POINT_2F@@@Z.c)
 ...
 *     ?clear_region@?$vector_facade@UPrimitiveUVDesc@@V?$buffer_impl@UPrimitiveUVDesc@@$03$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x1800DA3F8 (-clear_region@-$vector_facade@UPrimitiveUVDesc@@V-$buffer_impl@UPrimitiveUVDesc@@$03$00Vliberal_.c)
