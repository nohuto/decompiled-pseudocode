/*
 * XREFs of ?DrawPolygon@CDrawingContext@@QEAAJPEAVCPolygon@@@Z @ 0x180175944
 * Callers:
 ...
 *     ?Pop@?$CWatermarkStack@M$0EA@$01$09@@QEAA_NPEAM@Z @ 0x1800410BC (-Pop@-$CWatermarkStack@M$0EA@$01$09@@QEAA_NPEAM@Z.c)
 ...
 *     ?GetOpacity@CDrawingContext@@QEBAMXZ @ 0x1800EB7A4 (-GetOpacity@CDrawingContext@@QEBAMXZ.c)
 ...
 *     ?GetRenderOptions@CPolygon@@QEBAXPEAUMilRenderOptions@@@Z @ 0x1801F7808 (-GetRenderOptions@CPolygon@@QEBAXPEAUMilRenderOptions@@@Z.c)
 */
...
__int64 __fastcall CDrawingContext::DrawPolygon(CDrawingContext *this, struct CPolygon *a2)
{
  ...
  if ( *((_QWORD *)a2 + 31) )
  {
    ...
    if ( (_DWORD)v41 )
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x533u, 0LL);
        goto LABEL_34;
      }
      v36 = 1;
    }
    *(float *)&v38 = CDrawingContext::GetOpacity(this) * *((float *)a2 + 56);
    v10 = CWatermarkStack<float,64,2,10>::Push((unsigned int *)this + 808, &v38);
    v4 = v10;
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x538u, 0LL);
      goto LABEL_34;
    }
    v7 = 1;
    if ( !CMILMatrix::IsIdentity<0>((__int64)a2 + 144) )
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x53Eu, 0LL);
        goto LABEL_34;
      }
      v5 = 1;
    }
    if ( *(_BYTE *)(84LL * (unsigned int)(*((_DWORD *)this + 240) - 1) + *((_QWORD *)this + 117) + 80) )
    {
      if ( v5 )
      {
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x548u, 0LL);
LABEL_34:
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x552u, 0LL);
    }
    else
    {
      if ( !v39 )
...
LABEL_25:
        *((_QWORD *)this + 435) = a2;
        ...
        v4 = v32;
        if ( v32 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0, v32, 0x56Fu, 0LL);
        goto LABEL_32;
      }
      v38 = 0LL;
      v35 = 1;
      ...
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x55Du, 0LL);
      }
      else
      {
        if ( v35 )
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, v30, 0x567u, 0LL);
      }
      wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>((__int64 *)&v38);
    }
    CShapePtr::Release((CShapePtr *)&v39);
