/*
 * XREFs of ?ApplyRenderStateInternal@CDrawingContext@@AEAAJ_N@Z @ 0x1800803D0
 * Callers:
 ...
 *     ?ApplyRenderState@CDrawingContext@@UEAAJXZ @ 0x180020070 (-ApplyRenderState@CDrawingContext@@UEAAJXZ.c)
...
__int64 __fastcall CDrawingContext::ApplyRenderStateInternal(CDrawingContext *this, char a2)
{
  ...
  if ( !v2 )
  {
    ...
    if ( *((_DWORD *)this + 140) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v54, 0LL, 0, v53, 0xFDBu, 0LL);
    }
    else
    {
LABEL_50:
    ...
    if ( (v3 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v44, 0LL, 0, v3, 0xFC6u, 0LL);
    }
