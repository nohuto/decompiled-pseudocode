/*
 * XREFs of ?ApplyRenderStateInternal@CDrawingContext@@AEAAJ_N@Z @ 0x180074A70
 * Callers:
 *     ?ApplyRenderState@CDrawingContext@@UEAAJXZ @ 0x180076490 (-ApplyRenderState@CDrawingContext@@UEAAJXZ.c)
...
__int64 __fastcall CDrawingContext::ApplyRenderStateInternal(__m128 *this, char a2)
{
  ...
  if ( !v2 )
  {
    ...
    if ( v33 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v33, 0x1B9u, 0LL);
      return v3;
    }
  }
