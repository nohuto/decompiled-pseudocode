/*
 * XREFs of ??$_Uninitialized_move@PEAVAdapterInfo@CGlobalSurfaceManager@@PEAV12@V?$allocator@VAdapterInfo@CGlobalSurfaceManager@@@std@@@std@@YAPEAVAdapterInfo@CGlobalSurfaceManager@@QEAV12@0PEAV12@AEAV?$allocator@VAdapterInfo@CGlobalSurfaceManager@@@0@@Z @ 0x18002E888
 * Callers:
...
char *__fastcall std::_Uninitialized_move<CGlobalSurfaceManager::AdapterInfo *,CGlobalSurfaceManager::AdapterInfo *,std::allocator<CGlobalSurfaceManager::AdapterInfo>>(
        _QWORD *a1,
        _QWORD *a2,
        char *a3)
{
