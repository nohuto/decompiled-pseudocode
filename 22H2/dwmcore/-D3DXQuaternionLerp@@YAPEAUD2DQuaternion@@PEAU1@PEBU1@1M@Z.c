/*
 * XREFs of ?D3DXQuaternionLerp@@YAPEAUD2DQuaternion@@PEAU1@PEBU1@1M@Z @ 0x18021D76C
 * Callers:
...
struct D2DQuaternion *__fastcall D3DXQuaternionLerp(struct D2DQuaternion *a1, __m128 *a2, __m128 *a3, double a4)
{
  ...
  v7 = _mm_mul_ps(*a3, _mm_shuffle_ps(*(__m128 *)&a4, *(__m128 *)&a4, 0));
  v8 = *a2;
  ...
  if ( (float)((float)((float)((float)(a2->m128_f32[1] * a3->m128_f32[1]) + (float)(a2->m128_f32[0] * a3->m128_f32[0]))
    ...
    v10 = _mm_sub_ps(_mm_mul_ps(v8, v9), v7);
  else
    v10 = _mm_add_ps(v7, _mm_mul_ps(v8, v9));
  *(__m128 *)a1 = v10;
  v5.m128_f32[0] = 1.0
                 / sqrtf_0(
  ...
  result = a1;
  *(__m128 *)a1 = _mm_mul_ps(_mm_shuffle_ps(v5, v5, 0), v10);
  return result;
}
