/*
 * XREFs of ?CreateLegacyStereoSwapChain@CD3DDevice@@QEAAJPEAUIDXGIOutput@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVCLegacyStereoSwapChain@@@Z @ 0x180290044
 * Callers:
 ...
 *     ?UseSwapchainAsShaderInput@CD3DDevice@@QEBA_NXZ @ 0x180104AD4 (-UseSwapchainAsShaderInput@CD3DDevice@@QEBA_NXZ.c)
...
LABEL_18:
    ...
    v20 = v16;
LABEL_30:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1803BA120, v20, v19, v23, 0LL);
  }
