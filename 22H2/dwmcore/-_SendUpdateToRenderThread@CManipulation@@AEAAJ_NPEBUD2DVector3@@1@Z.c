/*
 * XREFs of ?_SendUpdateToRenderThread@CManipulation@@AEAAJ_NPEBUD2DVector3@@1@Z @ 0x1801D5538
 * Callers:
 *     ?CompleteManipulation@CManipulation@@UEAAJW4InteractionState@@@Z @ 0x1801D3DE0 (-CompleteManipulation@CManipulation@@UEAAJW4InteractionState@@@Z.c)
        ...
        const struct D2DVector3 *a4)
{
  ...
  if ( v16 )
  {
    ...
    v78 = v25;
    v79 = v26;
    ManipulationManager = CoreUICallSend(v30, &v64, 1LL, 10LL, 0, &unk_1802CE766);
    v14 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
