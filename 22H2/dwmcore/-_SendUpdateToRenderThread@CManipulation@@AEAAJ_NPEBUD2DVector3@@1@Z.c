/*
 * XREFs of ?_SendUpdateToRenderThread@CManipulation@@AEAAJ_NPEBUD2DVector3@@1@Z @ 0x18020F1BC
 * Callers:
 *     ?CompleteManipulation@CManipulation@@UEAAJW4InteractionState@@@Z @ 0x18020D960 (-CompleteManipulation@CManipulation@@UEAAJW4InteractionState@@@Z.c)
        ...
        const struct D2DVector3 *a4)
{
  ...
  if ( v18 )
  {
    ...
    v80 = v27;
    v81 = v28;
    ManipulationManager = CoreUICallSend(v32, &v66, 1LL, 12LL, 0, &unk_18033C49C, &v69);
    v16 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
