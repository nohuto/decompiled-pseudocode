/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCInteractionTracker@@@?$vector@PEAVCInteractionTracker@@V?$allocator@PEAVCInteractionTracker@@@std@@@std@@QEAAPEAPEAVCInteractionTracker@@QEAPEAV2@AEBQEAV2@@Z @ 0x1802365F0
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCInteractionTracker@@V?$allocator@PEAVCInteractionTracker@@@std@@@std@@AEAAXQEAPEAVCInteractionTracker@@_K1@Z @ 0x1802395E4 (-_Change_array@-$vector@PEAVCInteractionTracker@@V-$allocator@PEAVCInteractionTracker@@@std@@@st.c)
 */
