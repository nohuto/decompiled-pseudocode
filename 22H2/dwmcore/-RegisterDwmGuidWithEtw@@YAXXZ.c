/*
 * XREFs of ?RegisterDwmGuidWithEtw@@YAXXZ @ 0x1800AE450
 * Callers:
 *     ?DwmCoreDllMain@@YAHPEAUHINSTANCE__@@K@Z @ 0x1800ADEE8 (-DwmCoreDllMain@@YAHPEAUHINSTANCE__@@K@Z.c)
 * Callees:
 *     McGenEventRegister_EventRegister @ 0x1800AE62C (McGenEventRegister_EventRegister.c)
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1800AE9B8 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
 *     ??$Write@U?$_tlgWrapperByRef@$0BA@@@U?$_tlgWrapSz@G@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByRef@$0BA@@@AEBU?$_tlgWrapSz@G@@@Z @ 0x1800AEA54 (--$Write@U-$_tlgWrapperByRef@$0BA@@@U-$_tlgWrapSz@G@@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider.c)
 *     _tlgKeywordOn @ 0x1800BB1F8 (_tlgKeywordOn.c)
 *     TraceLoggingRegisterEx_EventRegister_EventSetInformation @ 0x1800FE9F8 (TraceLoggingRegisterEx_EventRegister_EventSetInformation.c)
...
void __fastcall RegisterDwmGuidWithEtw(__int64 a1, __int64 a2)
{
  ...
  McGenEventRegister_EventRegister(
    ...
    &Microsoft_Windows_Dwm_Compositor_Context);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803E3798);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803E37D0);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803E3B40);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803E3728);
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_1803E3760);
  ...
  if ( ProcessIdToSessionId(CurrentProcessId, &pSessionId) )
  {
    ...
    if ( StringCchPrintfW(Value, 0x22uLL, L"%s_%08X", L"DwmInitSessionActivityId", pdwType) >= 0 )
    {
      ...
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1803E3B40, 0x400000000000LL) )
        {
