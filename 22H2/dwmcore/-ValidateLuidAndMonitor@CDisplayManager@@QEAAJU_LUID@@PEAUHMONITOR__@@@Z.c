/*
 * XREFs of ?ValidateLuidAndMonitor@CDisplayManager@@QEAAJU_LUID@@PEAUHMONITOR__@@@Z @ 0x18028F6F4
 * Callers:
...
__int64 __fastcall CDisplayManager::ValidateLuidAndMonitor(CDisplayManager *this, struct _LUID a2, HMONITOR a3)
{
  ...
  if ( Adapter < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v5, &dword_1803BA088, 2u, Adapter, 0x18u, 0LL);
LABEL_5:
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1803BA088, 2u, v7, 0x1Cu, 0LL);
    goto LABEL_5;
  }
LABEL_6:
