/*
 * XREFs of ?AddDirtyRect@CBitmap@@UEAAJPEBUtagRECT@@@Z @ 0x1800CFFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBitmap::AddDirtyRect(CBitmap *this, struct tagRECT *a2)
{
  ...
  if ( a2 )
  {
    if ( a2->left < 0
      ...
      || (unsigned int)right > *((_DWORD *)this + 38)
      || (bottom = a2->bottom, bottom <= a2->top)
      || (unsigned int)bottom > *((_DWORD *)this + 39) )
    {
      v4 = -2147024809;
  ...
  if ( !*((_DWORD *)this + 16) )
    goto LABEL_9;
  if ( *((_BYTE *)this + 204) || *((_DWORD *)this + 50) != *((_DWORD *)this + 24) )
  {
    *((_DWORD *)this + 48) = 0;
    *((_BYTE *)this + 204) = 0;
  }
  if ( !a2 || a2->right - a2->left == *((_DWORD *)this + 38) && a2->bottom - a2->top == *((_DWORD *)this + 39) )
  {
    *((_DWORD *)this + 48) = 0;
  }
  else
  {
    ...
    {
      *((_DWORD *)this + 49) = *((_DWORD *)this + 24);
    }
    if ( v11 >= 5 )
    {
      do
      {
        v15 = (_DWORD *)*((_QWORD *)this + 23);
        *((_DWORD *)this + 48) = v11 - 1;
      ...
      while ( v11 > 1 );
      TMilRect<unsigned int,MilRectU,Mil3DRectU,RectUniqueness::NotNeeded>::IsEmpty(*((_DWORD **)this + 23));
