/*
 * XREFs of ?Release@?$CMILRefCountBaseT@VCRenderingEffect@@@@UEAAKXZ @ 0x1800D55C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILRefCountBaseT<CRenderingEffect>::Release(volatile signed __int32 *a1)
{
...
LABEL_4:
  ...
  if ( !v2 )
  {
    v4 = *(_QWORD *)a1;
    --*((_DWORD *)a1 + 2);
    (*(void (__fastcall **)(volatile signed __int32 *, __int64))(v4 + 88))(a1, 1LL);
  }
  return v2;
}
