/*
 * XREFs of ?ShouldChainForAxis@CInteractionTracker@@QEBA_NW4ScrollAxis@@PEBVCManipulation@@_N@Z @ 0x1801CCAB0
 * Callers:
 ...
 *     _lambda_f7bd61b0100483a4d5791bc237b79594_::operator() @ 0x1801C786C (_lambda_f7bd61b0100483a4d5791bc237b79594_--operator().c)
 */
...
char __fastcall CInteractionTracker::ShouldChainForAxis(__int64 a1, int a2, __int64 a3, unsigned __int8 a4)
{
  ...
  if ( v14 == 1 )
  {
    ...
    if ( v15 )
    {
      v16 = v31;
LABEL_14:
      if ( lambda_f7bd61b0100483a4d5791bc237b79594_::operator()((__int64)v18, v16) )
        return 1;
    }
  }
  return v4;
