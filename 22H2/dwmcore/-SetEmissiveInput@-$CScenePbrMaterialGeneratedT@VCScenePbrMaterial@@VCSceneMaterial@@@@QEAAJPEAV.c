/*
 * XREFs of ?SetEmissiveInput@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJPEAVCSceneMaterialInput@@@Z @ 0x1801C6B28
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[15] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1463u, 0LL);
    }
    else
    {
