/*
 * XREFs of ?Present@CD3DDevice@@QEAAJPEAUIDXGISwapChain1@@IIAEBUDXGI_PRESENT_PARAMETERS@@@Z @ 0x180240078
 * Callers:
        ...
        const struct DXGI_PRESENT_PARAMETERS *a5)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_180306928, 2u, v5, 0xC70u, 0LL);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180306928, 2u, v7, 0xC7Eu, 0LL);
    }
    else
    {
