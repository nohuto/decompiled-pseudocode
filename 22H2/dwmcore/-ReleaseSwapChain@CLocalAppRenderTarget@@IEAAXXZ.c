/*
 * XREFs of ?ReleaseSwapChain@CLocalAppRenderTarget@@IEAAXXZ @ 0x18018A9FC
 * Callers:
 *     ?EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ @ 0x18018A58C (-EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ.c)
 *     ?NotifyInvalidResource@CLocalAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z @ 0x18018A7A0 (-NotifyInvalidResource@CLocalAppRenderTarget@@UEAAXPEBVIDeviceResource@@@Z.c)
 * Callees:
