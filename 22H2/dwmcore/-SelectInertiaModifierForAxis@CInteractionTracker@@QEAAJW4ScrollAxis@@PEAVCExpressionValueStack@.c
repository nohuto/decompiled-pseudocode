/*
 * XREFs of ?SelectInertiaModifierForAxis@CInteractionTracker@@QEAAJW4ScrollAxis@@PEAVCExpressionValueStack@@_KPEAPEAUIScalarForce@@@Z @ 0x1801CAE80
 * Callers:
 ...
 *     ?GetSampledConditionAnimation@CConditionalExpression@@QEBAXPEAPEAVCBaseExpression@@@Z @ 0x1801BD874 (-GetSampledConditionAnimation@CConditionalExpression@@QEBAXPEAPEAVCBaseExpression@@@Z.c)
 ...
 *     ??$?4VCExpressionForce@@@?$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@PEAVCExpressionForce@@@Z @ 0x1801C7104 (--$-4VCExpressionForce@@@-$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@PEAVCExpressionForc.c)
 *     ??$?4VCScalarForce@@@?$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@AEBV?$ComPtr@VCScalarForce@@@12@@Z @ 0x1801C71A4 (--$-4VCScalarForce@@@-$ComPtr@UIScalarForce@@@WRL@Microsoft@@QEAAAEAV012@AEBV-$ComPtr@VCScalarFo.c)
...
LABEL_16:
  ...
  if ( !v20 )
  {
    Value = CConditionalExpression::GetValue((MatrixSubchannelMaskInfo **)v9, v57, a4, &v50);
    v14 = Value;
    if ( Value < 0 )
    {
...
LABEL_35:
  ...
  {
    v14 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, -2147467259, 0xEF5u, 0LL);
    goto LABEL_37;
  }
  v52 = 0LL;
  ...
  if ( v10 != 1 )
  {
    ...
    if ( ForceForAxis < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, ForceForAxis, 0xEEAu, 0LL);
      goto LABEL_28;
    }
    goto LABEL_32;
  }
...
LABEL_32:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0xEE1u, 0LL);
LABEL_28:
  if ( v22 )
    (*(void (__fastcall **)(struct CBaseExpression *))(*(_QWORD *)v22 + 16LL))(v22);
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v52);
