/*
 * XREFs of ?UnpinResources@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJ_N@Z @ 0x1801F8F50
 * Callers:
 ...
 *     ?UnpinResources@CGlobalCompositionSurfaceInfo@@UEAAJ_N@Z @ 0x1801F9040 (-UnpinResources@CGlobalCompositionSurfaceInfo@@UEAAJ_N@Z.c)
 * Callees:
