/*
 * XREFs of ?ProcessInsertChild@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_INSERTCHILD@@@Z @ 0x18009C184
 * Callers:
...
LABEL_7:
  ...
  if ( v13 )
  {
    ...
    v18 = inserted;
    if ( inserted < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, inserted, 0xC63u, 0LL);
  }
  else
  {
    v18 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(this, 0LL, 0, -2003303421, 0xC60u, 0LL);
  }
  return v18;
}
