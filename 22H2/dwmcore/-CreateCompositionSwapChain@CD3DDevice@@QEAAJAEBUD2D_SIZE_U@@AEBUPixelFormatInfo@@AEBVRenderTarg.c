/*
 * XREFs of ?CreateCompositionSwapChain@CD3DDevice@@QEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@IPEAPEAVICompositionSwapChain@@@Z @ 0x18023DA80
 * Callers:
...
LABEL_12:
    v18 = v11;
LABEL_18:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802F0CF8, 2u, v18, v21, 0LL);
  }
