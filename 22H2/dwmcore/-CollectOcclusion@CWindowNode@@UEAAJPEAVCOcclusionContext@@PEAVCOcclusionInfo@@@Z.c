/*
 * XREFs of ?CollectOcclusion@CWindowNode@@UEAAJPEAVCOcclusionContext@@PEAVCOcclusionInfo@@@Z @ 0x18005E950
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  if ( v5 )
  {
    ...
    if ( v66 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, v66, 0xF38u, 0LL);
      v92 = 958;
LABEL_151:
      v89 = EffectiveBounds;
      goto LABEL_152;
