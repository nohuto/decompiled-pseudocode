/*
 * XREFs of ?CalculateValue@CBaseExpression@@QEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180053F60
 * Callers:
 ...
 *     ?CalculateValue@CBaseExpression@@QEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180053F60 (-CalculateValue@CBaseExpression@@QEAAJPEAVCExpressionValueStack@@_KPEA_N@Z.c)
 *     ?IsExpressionValueValid@CBaseExpression@@AEAA_NPEAVCExpressionValue@@@Z @ 0x1800549A0 (-IsExpressionValueValid@CBaseExpression@@AEAA_NPEAVCExpressionValue@@@Z.c)
  ...
  *((_QWORD *)this + 21) = v68;
  ...
  if ( (*((_BYTE *)this + 232) & 2) == 0 )
  {
    ...
    if ( *((_DWORD *)this + 66) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x316u, 0LL);
      MilInstrumentationCheckHR_MaybeFailFast(v28, &dword_18033D680, 2u, v13, 0x48Bu, 0LL);
      goto LABEL_96;
    }
LABEL_23:
    *((_BYTE *)this + 232) |= 2u;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v22, &dword_18033D680, 2u, v13, 0x492u, 0LL);
    goto LABEL_96;
  }
  v23 = 1;
  if ( v4.QuadPart )
  ...
  if ( !v26 )
  {
    ...
    v13 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v27, &dword_18033D680, 2u, -2147467259, 0x4ABu, 0LL);
LABEL_96:
    v12 = v65;
LABEL_97:
    v59 = *((_DWORD *)a2 + 4);
...
LABEL_37:
    ...
    *(_OWORD *)Name = 0LL;
    ...
    {
      v13 = -2147024890;
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v22, &dword_18033D680, 2u, -2147024890, 0x4B5u, 0LL);
      goto LABEL_44;
    }
    ...
    if ( v33 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v34, &dword_18033D680, 2u, v33, 0x4B7u, 0LL);
      goto LABEL_44;
    }
    v35 = *((_QWORD *)this + 25);
    if ( v35 )
    {
      if ( *(_BYTE *)(v35 + 4) )
      {
        ...
        if ( v36 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v34, &dword_18033D680, 2u, v36, 0x4BDu, 0LL);
LABEL_44:
    ...
    {
      v13 = -2147024809;
      MilInstrumentationCheckHR_MaybeFailFast(v34, &dword_18033D680, 2u, -2147024809, 0x4C2u, 0LL);
      goto LABEL_44;
    }
    if ( v23 )
    {
      ...
      if ( v37 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v38, &dword_18033D680, 2u, v37, 0x4C7u, 0LL);
        goto LABEL_44;
      }
    }
    else
  ...
  {
    v13 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v22, &dword_18033D680, 2u, -2147467259, 0x4DBu, 0LL);
    goto LABEL_96;
  }
  v12 = v65;
  if ( v65 )
...
LABEL_74:
  ...
  if ( v44 )
  {
    ...
    if ( v49 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v50, 0LL, 0, v49, 0x249u, 0LL);
      goto LABEL_91;
    }
  ...
  if ( (*((_BYTE *)this + 216) & 3) == 3 )
  {
    ...
    if ( !v53 || (v54 = *(struct CResource **)(v53 + 16)) == 0LL )
    {
      v13 = -2147024890;
      v51 = -2147024890;
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v22, 0LL, 0, -2147024890, 0x25Au, 0LL);
      goto LABEL_91;
    }
    ...
    if ( v55 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v56, 0LL, 0, v55, 0x25Bu, 0LL);
LABEL_91:
      MilInstrumentationCheckHR_MaybeFailFast(v57, &dword_18033D680, 2u, v51, 0x4E8u, 0LL);
      goto LABEL_97;
    }
  }
  if ( v4.QuadPart )
