/*
 * XREFs of ?RenderDirtyRegion@CDDisplayRenderTarget@@IEAAJPEAVCDrawingContext@@AEBVCDirtyRegion@@IAEBV?$span@PEBVCVisual@@$0?0@gsl@@PEAVCComposeTop@@@Z @ 0x1801E90F4
 * Callers:
...
LABEL_36:
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)&v47 + 1) = __PAIR64__(LODWORD(v34), LODWORD(v35));
    dword_1803E5A08 += (int)(float)((float)(v35 - v37) * (float)(v34 - v36));
