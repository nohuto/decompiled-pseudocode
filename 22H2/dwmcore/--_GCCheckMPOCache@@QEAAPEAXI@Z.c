/*
 * XREFs of ??_GCCheckMPOCache@@QEAAPEAXI@Z @ 0x1800F0DDC
 * Callers:
 *     ??4?$unique_ptr@VCCheckMPOCache@@U?$default_delete@VCCheckMPOCache@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800F1720 (--4-$unique_ptr@VCCheckMPOCache@@U-$default_delete@VCCheckMPOCache@@@std@@@std@@QEAAAEAV01@$$QEA.c)
