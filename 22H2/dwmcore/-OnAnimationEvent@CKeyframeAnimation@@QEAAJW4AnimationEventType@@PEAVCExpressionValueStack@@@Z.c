/*
 * XREFs of ?OnAnimationEvent@CKeyframeAnimation@@QEAAJW4AnimationEventType@@PEAVCExpressionValueStack@@@Z @ 0x1800AC820
 * Callers:
 ...
 *     ?IsWaiting@CKeyframeAnimation@@QEBA_NXZ @ 0x1800ACDE8 (-IsWaiting@CKeyframeAnimation@@QEBA_NXZ.c)
    ...
    if ( *(_DWORD *)(a1 + 264) == 4 && (*(_BYTE *)(a1 + 208) & 2) != 0 )
    {
      *(_DWORD *)(a1 + 264) = 2;
        ...
        || CPtrArrayBase::GetCount((CPtrArrayBase *)(v12 + 24)) )
      {
        ...
        v8 = v14;
        if ( v14 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, v14, 0x4EDu, 0LL);
      }
    }
    if ( v8 >= 0 )
      return 0;
