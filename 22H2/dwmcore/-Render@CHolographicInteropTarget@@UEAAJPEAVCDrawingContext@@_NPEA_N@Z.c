/*
 * XREFs of ?Render@CHolographicInteropTarget@@UEAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1800F2130
 * Callers:
 *     ?Render@CHolographicInteropTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1800F7D50 (-Render@CHolographicInteropTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 * Callees:
 ...
 *     ?GetTextureAtIndex@CHolographicManager@@QEAAPEAVCHolographicInteropTexture@@I@Z @ 0x1802538B0 (-GetTextureAtIndex@CHolographicManager@@QEAAPEAVCHolographicInteropTexture@@I@Z.c)
 *     ?PostInteropTextureUpdate@CHolographicManager@@QEAAXIPEAX0@Z @ 0x180253CD8 (-PostInteropTextureUpdate@CHolographicManager@@QEAAXIPEAX0@Z.c)
        ...
        bool *a4)
{
  ...
  LODWORD(v4) = 0;
  v5 = qword_1803474E0 + 1;
  *a4 = 0;
  qword_1803474E0 = v5;
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20000) != 0 )
    McTemplateU0xx_EventWriteTransfer(this, &EVTDESC_HOLOGRAPHICINTEROPTARGET_RENDER, v5, qword_1803474E8);
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20000) != 0 )
    McTemplateU0xxxx_EventWriteTransfer(
      ...
      qword_1803474E0,
      qword_1803474E8,
      qword_1803474E0 - qword_1803474E8,
      v4);
  return 0LL;
}
