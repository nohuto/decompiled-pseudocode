/*
 * XREFs of ??2CPrimitiveGroupLayerClip@@KAPEAX_K@Z @ 0x18016C0DC
 * Callers:
...
LPVOID __fastcall CPrimitiveGroupLayerClip::operator new()
{
  LPVOID result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = DefaultHeap::AllocClear(0x2E0uLL);
  if ( !result )
