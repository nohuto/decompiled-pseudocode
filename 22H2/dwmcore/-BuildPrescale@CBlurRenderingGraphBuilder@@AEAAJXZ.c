/*
 * XREFs of ?BuildPrescale@CBlurRenderingGraphBuilder@@AEAAJXZ @ 0x1800D2364
 * Callers:
 ...
 *     ?GetShaderCache@CPassthroughEffect@@QEBAPEAVCShaderCache@@XZ @ 0x1800D24FC (-GetShaderCache@CPassthroughEffect@@QEBAPEAVCShaderCache@@XZ.c)
...
LABEL_12:
  ...
  *(_QWORD *)&v22 = *(_QWORD *)this + 1588LL;
  v12 = *(_QWORD *)(v11 + 520);
  v13 = dword_18033C038[5 * *(int *)(v11 + 1584)] == 3;
  v11 += 512LL;
