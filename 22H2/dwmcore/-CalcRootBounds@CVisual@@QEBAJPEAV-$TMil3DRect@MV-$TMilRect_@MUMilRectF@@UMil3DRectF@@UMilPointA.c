/*
 * XREFs of ?CalcRootBounds@CVisual@@QEBAJPEAV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800C3790
 * Callers:
 ...
 *     ?Initialize@CSubVisualTree@@MEAAJXZ @ 0x180259020 (-Initialize@CSubVisualTree@@MEAAJXZ.c)
 * Callees:
