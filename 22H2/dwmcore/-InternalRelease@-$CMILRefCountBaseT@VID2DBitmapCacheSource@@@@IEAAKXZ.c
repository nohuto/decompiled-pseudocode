/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VID2DBitmapCacheSource@@@@IEAAKXZ @ 0x180100D40
 * Callers:
 ...
 *     ?Release@CSecondarySysmemBitmap@@UEAAKXZ @ 0x180100D30 (-Release@CSecondarySysmemBitmap@@UEAAKXZ.c)
 * Callees:
