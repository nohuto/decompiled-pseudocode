/*
 * XREFs of ?SetPositionData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x180172010
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[12] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xA00u, 0LL);
    }
    else
    {
