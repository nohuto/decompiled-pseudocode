/*
 * XREFs of ?WaitForWork@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x18006FEAC
 * Callers:
 ...
 *     ?UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z @ 0x180162B1C (-UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z.c)
  ...
  if ( (char *)hObject - 1 > (char *)0xFFFFFFFFFFFFFFFDLL )
  {
    if ( qword_18034B5C8 )
    {
      ...
      else
      {
        ...
        {
          if ( EventW != (char *)-1LL
            && (*(int (__fastcall **)(CDisplayManager *, char *, int *))(*(_QWORD *)qword_18034B5C8 + 176LL))(
                 qword_18034B5C8,
                 EventW,
                 &dword_18034B5D8) >= 0 )
          {
