/*
 * XREFs of ??$?0VCNaturalAnimation@@@?$ComPtr@VCNaturalAnimation@@@WRL@Microsoft@@QEAA@PEAVCNaturalAnimation@@@Z @ 0x180230334
 * Callers:
...
_QWORD *__fastcall Microsoft::WRL::ComPtr<CNaturalAnimation>::ComPtr<CNaturalAnimation>(_QWORD *a1, __int64 a2)
{
  *a1 = a2;
  if ( a2 )
