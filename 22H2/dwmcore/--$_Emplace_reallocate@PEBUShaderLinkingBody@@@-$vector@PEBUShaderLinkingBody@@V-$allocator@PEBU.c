/*
 * XREFs of ??$_Emplace_reallocate@PEBUShaderLinkingBody@@@?$vector@PEBUShaderLinkingBody@@V?$allocator@PEBUShaderLinkingBody@@@std@@@std@@QEAAPEAPEBUShaderLinkingBody@@QEAPEBU2@$$QEAPEBU2@@Z @ 0x1800269A8
 * Callers:
 ...
 * Callees:
 *     ?_Change_array@?$vector@PEBUShaderLinkingBody@@V?$allocator@PEBUShaderLinkingBody@@@std@@@std@@AEAAXQEAPEBUShaderLinkingBody@@_K1@Z @ 0x180026A94 (-_Change_array@-$vector@PEBUShaderLinkingBody@@V-$allocator@PEBUShaderLinkingBody@@@std@@@std@@A.c)
