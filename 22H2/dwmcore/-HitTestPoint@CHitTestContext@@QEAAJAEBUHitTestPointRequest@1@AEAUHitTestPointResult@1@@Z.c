/*
 * XREFs of ?HitTestPoint@CHitTestContext@@QEAAJAEBUHitTestPointRequest@1@AEAUHitTestPointResult@1@@Z @ 0x18004E624
 * Callers:
 ...
 * Callees:
 *     ?GetInputLuid@CVisual@@QEBA?AU_LUID@@XZ @ 0x180017D6C (-GetInputLuid@CVisual@@QEBA-AU_LUID@@XZ.c)
 ...
 *     ?GetInputType@CInputSinkStruct@@SA?AW4CompositionInputType@@W4InputType@@@Z @ 0x18001D958 (-GetInputType@CInputSinkStruct@@SA-AW4CompositionInputType@@W4InputType@@@Z.c)
 *     ?HasInputSink@CInteraction@@QEBA_NXZ @ 0x18004EA60 (-HasInputSink@CInteraction@@QEBA_NXZ.c)
 ...
 *     ?AdjustInputTypeForInteraction@CHitTestContext@@AEBA?AW4InputType@@W42@PEBVCInteraction@@@Z @ 0x18004EAC8 (-AdjustInputTypeForInteraction@CHitTestContext@@AEBA-AW4InputType@@W42@PEBVCInteraction@@@Z.c)
 ...
 *     ?EvaluateHitTestAttributesAndInputType@CHitTestContext@@AEAAXW4DIT_HITTESTATTRIBUTES@@K@Z @ 0x18004ED64 (-EvaluateHitTestAttributesAndInputType@CHitTestContext@@AEAAXW4DIT_HITTESTATTRIBUTES@@K@Z.c)
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x18005D958 (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ?GetInputHandle@CVisual@@QEBAPEAXXZ @ 0x18009F298 (-GetInputHandle@CVisual@@QEBAPEAXXZ.c)
...
LABEL_11:
  ...
  *((_QWORD *)v5 + 3) = v15;
  ...
  {
    v17 = v33 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v34, &dword_1802DCF90, 2u, v33 | 0x10000000, 0x29Eu, 0LL);
  }
  else
  {
    v35 = *((_DWORD *)v4 + 424);
