/*
 * XREFs of ?SetBackdropVisualImage@CTreeData@@IEAAXAEBVCVisualTreePath@@PEAVCBackdropVisualImage@@@Z @ 0x1800EE288
 * Callers:
      ...
      *((_QWORD *)a3 + 248) = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 33) + 16LL) + 496LL);
      ...
      if ( ((v3[1] - *v3) & 0xFFFFFFFFFFFFFFF8uLL) != 0 )
      {
        ...
        while ( v9 != *((_QWORD *)this + 22) )
        {
          ...
          {
            v15 = (void **)DwmDbg::DbgString::DbgString(&v18, word_18033C020);
