/*
 * XREFs of ?_Change_array@?$vector@Ufloat2@Numerics@Foundation@Windows@@V?$allocator@Ufloat2@Numerics@Foundation@Windows@@@std@@@std@@AEAAXQEAUfloat2@Numerics@Foundation@Windows@@_K1@Z @ 0x1801CAC94
 * Callers:
