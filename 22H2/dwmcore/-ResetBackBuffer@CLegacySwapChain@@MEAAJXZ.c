/*
 * XREFs of ?ResetBackBuffer@CLegacySwapChain@@MEAAJXZ @ 0x180101830
 * Callers:
...
__int64 __fastcall CLegacySwapChain::ResetBackBuffer(CLegacySwapChain *this)
{
  ...
  *((_BYTE *)this + 345) = 0;
  if ( v5 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802EE2F0, 2u, v7, 0x5B0u, 0LL);
    }
    else
    {
      v10 = *((_QWORD *)this + 29);
      *((_QWORD *)this + 29) = 0LL;
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802EE2F0, 2u, v11, 0x5B2u, 0LL);
      }
      else
      {
        v13 = *v1;
        ...
        *v1 = 0LL;
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802EE2F0, 2u, DeviceTextureTarget, 0x5BAu, 0LL);
        }
        else
        {
  ...
  {
    v9 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, &dword_1802EE2F0, 2u, -2003304307, 0x5C2u, 0LL);
  }
  return v9;
}
