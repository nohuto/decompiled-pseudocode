/*
 * XREFs of ?UpdateCpuClippingData@CVisual@@IEAAJPEBVCVisualTree@@W4Enum@CpuClippingMode@@_N@Z @ 0x18001BD4C
 * Callers:
...
__int64 __fastcall CVisual::UpdateCpuClippingData(CVisual **a1, const struct CVisualTree *a2, unsigned int a3, char a4)
{
  ...
  v11 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x810u, 0LL);
  return v11;
}
