/*
 * XREFs of ?PrepareShadows@CProjectedShadowScene@@AEAAJPEAVCDrawingContext@@PEAVCProjectedShadowReceiver@@@Z @ 0x18000A740
 * Callers:
 ...
 *     ?CalculateOpacity@CProjectedShadowScene@@AEBAMM@Z @ 0x18000C1F8 (-CalculateOpacity@CProjectedShadowScene@@AEBAMM@Z.c)
 ...
 *     ?CalculateBlurRadius@CProjectedShadowScene@@AEBAMM@Z @ 0x18000C4E4 (-CalculateBlurRadius@CProjectedShadowScene@@AEBAMM@Z.c)
