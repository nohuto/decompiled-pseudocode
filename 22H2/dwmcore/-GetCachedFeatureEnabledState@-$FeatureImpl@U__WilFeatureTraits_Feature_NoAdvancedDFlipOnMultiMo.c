/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_NoAdvancedDFlipOnMultiMon_Ni@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180118A60
 * Callers:
