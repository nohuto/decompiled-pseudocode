/*
 * XREFs of ?CreateAndStartKeyframeAnimation@CInteractionTracker@@AEAAJW4Enum@InteractionTrackerProperty@@W4DCOMPOSITION_EXPRESSION_TYPE@@AEBUD2DVector4@@MPEAPEAVCScrollKeyframeAnimation@@@Z @ 0x1801C8C18
 * Callers:
        ...
        __int64 *a6)
{
  ...
  if ( a2 == 1 )
  {
    v12 = (CScrollPositionKeyframeAnimation *)DefaultHeap::AllocClear(0x2E8uLL);
    if ( v12 )
  ...
  else
  {
    ...
    v10 = (CScrollKeyframeAnimation *)DefaultHeap::AllocClear(0x2E0uLL);
    v11 = v10;
    if ( v10 )
    {
