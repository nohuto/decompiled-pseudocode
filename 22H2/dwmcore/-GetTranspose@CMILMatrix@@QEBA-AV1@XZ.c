/*
 * XREFs of ?GetTranspose@CMILMatrix@@QEBA?AV1@XZ @ 0x180210D0C
 * Callers:
 ...
 * Callees:
 *     ?transpose@Numerics@Foundation@Windows@@YA?AUfloat4x4@123@AEBU4123@@Z @ 0x1801A7420 (-transpose@Numerics@Foundation@Windows@@YA-AUfloat4x4@123@AEBU4123@@Z.c)
 */
