/*
 * XREFs of ?FillShapeWithBrush@CDrawingContext@@QEAAJAEBVCShape@@PEAUID2D1Brush@@@Z @ 0x18005A7A4
 * Callers:
        ...
        struct ID2D1Brush *a3)
{
  ...
  else
  {
    ...
    if ( v11 != *((_QWORD *)this + 112) && *(_QWORD *)(v11 - 160) )
    {
      ...
      if ( v27 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v27, 0xA2Bu, 0LL);
        goto LABEL_20;
      }
      v48 = 0LL;
      v47 = v46;
      ...
      if ( v29 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0, v29, 0xA2Du, 0LL);
        v5 = v42;
        goto LABEL_18;
      }
      v5 = v42;
...
LABEL_52:
          MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v16, 0xA36u, 0LL);
          goto LABEL_18;
        }
        if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x10) != 0 )
