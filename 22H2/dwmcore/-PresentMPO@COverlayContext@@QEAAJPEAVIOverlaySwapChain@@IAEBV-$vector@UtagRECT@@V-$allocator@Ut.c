/*
 * XREFs of ?PresentMPO@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@IAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@PEAI@Z @ 0x1800C9D60
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( *(_BYTE *)(v34 + v33 + 184) )
      {
        ...
        *v35 = v32;
        ...
        if ( v36 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v36, 0xACCu, 0LL);
          goto LABEL_22;
        }
        v37 = *((_QWORD *)this + 913);
...
LABEL_77:
    ...
    *v79 = v9;
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v22, 0xB7Fu, 0LL);
      goto LABEL_22;
    }
    v10 = (unsigned int *)((char *)this + 11280);
  }
