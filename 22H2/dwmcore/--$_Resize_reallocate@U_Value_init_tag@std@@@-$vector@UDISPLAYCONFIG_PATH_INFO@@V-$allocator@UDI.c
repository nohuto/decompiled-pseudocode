/*
 * XREFs of ??$_Resize_reallocate@U_Value_init_tag@std@@@?$vector@UDISPLAYCONFIG_PATH_INFO@@V?$allocator@UDISPLAYCONFIG_PATH_INFO@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x180202460
 * Callers:
 *     CalculateDisplayBlankTime @ 0x180202AEC (CalculateDisplayBlankTime.c)
 * Callees:
 *     ??$_Get_size_of_n@$0EI@@std@@YA_K_K@Z @ 0x18003EDA4 (--$_Get_size_of_n@$0EI@@std@@YA_K_K@Z.c)
