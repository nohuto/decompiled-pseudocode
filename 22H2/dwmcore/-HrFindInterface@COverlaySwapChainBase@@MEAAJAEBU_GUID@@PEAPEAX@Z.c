/*
 * XREFs of ?HrFindInterface@COverlaySwapChainBase@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180102FE0
 * Callers:
 *     ?HrFindInterface@CLegacySwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180102F90 (-HrFindInterface@CLegacySwapChain@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
