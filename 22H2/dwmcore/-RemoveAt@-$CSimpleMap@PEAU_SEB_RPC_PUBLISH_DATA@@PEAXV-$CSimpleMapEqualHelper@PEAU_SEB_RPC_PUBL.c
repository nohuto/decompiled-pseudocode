/*
 * XREFs of ?RemoveAt@?$CSimpleMap@PEAU_SEB_RPC_PUBLISH_DATA@@PEAXV?$CSimpleMapEqualHelper@PEAU_SEB_RPC_PUBLISH_DATA@@PEAX@ATL@@@ATL@@QEAAHH@Z @ 0x1800FDF24
 * Callers:
        ...
        int a2)
{
  ...
  if ( a2 < 0 )
    return 0LL;
  v3 = qword_1803E6508;
  if ( a2 >= (int)qword_1803E6508 )
    return 0LL;
  if ( a2 != (_DWORD)qword_1803E6508 - 1 )
  {
    v4 = qword_1803E6508 - a2;
    v5 = 8LL * ((int)qword_1803E6508 - a2);
    v6 = 8LL * ((int)qword_1803E6508 - a2 - 1);
    v7 = Block + 8 * v2;
    if ( v6 )
    {
      if ( !v7 || v7 == -8 )
...
LABEL_14:
  ...
  if ( v10 || (_DWORD)qword_1803E6508 == 1 )
    Block = v10;
  v11 = _recalloc(*(&Block + 1), (int)qword_1803E6508 - 1, 8uLL);
  if ( v11 || (_DWORD)qword_1803E6508 == 1 )
    *(&Block + 1) = v11;
  result = 1LL;
