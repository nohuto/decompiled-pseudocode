/*
 * XREFs of ??$_Emplace_reallocate@PEBVCVisual@@@?$vector@PEBVCVisual@@V?$allocator@PEBVCVisual@@@std@@@std@@QEAAPEAPEBVCVisual@@QEAPEBV2@$$QEAPEBV2@@Z @ 0x1801DADD0
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEBVCVisual@@V?$allocator@PEBVCVisual@@@std@@@std@@AEAAXQEAPEBVCVisual@@_K1@Z @ 0x1801DEB50 (-_Change_array@-$vector@PEBVCVisual@@V-$allocator@PEBVCVisual@@@std@@@std@@AEAAXQEAPEBVCVisual@@.c)
 */

char *__fastcall std::vector<CVisual const *>::_Emplace_reallocate<CVisual const *>(_QWORD *a1, _BYTE *a2, _QWORD *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
