/*
 * XREFs of ?Present@CDDARenderTarget@@UEAAJ_N@Z @ 0x1801F9760
 * Callers:
 *     ?Present@CDDARenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x18011D9E0 (-Present@CDDARenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
