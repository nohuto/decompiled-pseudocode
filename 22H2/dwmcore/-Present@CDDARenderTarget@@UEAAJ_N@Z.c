/*
 * XREFs of ?Present@CDDARenderTarget@@UEAAJ_N@Z @ 0x18019900C
 * Callers:
 *     ?Present@CDDARenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800F5640 (-Present@CDDARenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
