/*
 * XREFs of ??1CPartitionVerticalBlankScheduler@@UEAA@XZ @ 0x180153704
 * Callers:
 ...
 *     ?ClearAllLongtermScenarios@CAnimationTracking@@AEAAXXZ @ 0x180156954 (-ClearAllLongtermScenarios@CAnimationTracking@@AEAAXXZ.c)
