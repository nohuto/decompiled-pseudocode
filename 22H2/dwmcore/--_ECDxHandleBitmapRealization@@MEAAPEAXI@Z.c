/*
 * XREFs of ??_ECDxHandleBitmapRealization@@MEAAPEAXI@Z @ 0x180038610
 * Callers:
 *     ??_ECDxHandleBitmapRealization@@OBCA@EAAPEAXI@Z @ 0x1800F8220 (--_ECDxHandleBitmapRealization@@OBCA@EAAPEAXI@Z.c)
 * Callees:
