/*
 * XREFs of ??_GCParallelModeGroup@@QEAAPEAXI@Z @ 0x1801E68B0
 * Callers:
 *     ??$?4U?$default_delete@VCSyncLockGroup@@@std@@$0A@@?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1801E6600 (--$-4U-$default_delete@VCSyncLockGroup@@@std@@$0A@@-$unique_ptr@VCSyncLockGroup@@U-$default_dele.c)
 *     ?GetGroup@CSyncLockGroup@@SAPEAV1@I@Z @ 0x1801E692C (-GetGroup@CSyncLockGroup@@SAPEAV1@I@Z.c)
