/*
 * XREFs of ?CalcTransform@CVisual@@QEBAXPEBVCVisualTree@@PEBVCMILMatrix@@PEA_NPEAV3@3@Z @ 0x1800707C0
 * Callers:
 ...
 *     ?RoundOffsets@CMILMatrix@@QEAAXXZ @ 0x1800E3670 (-RoundOffsets@CMILMatrix@@QEAAXXZ.c)
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@U?$_tlgWrapperByVal@$03@@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@3AEBU?$_tlgWrapperByVal@$03@@444444444444444@Z @ 0x18021015C (--$Write@U-$_tlgWrapperByVal@$07@@U1@U-$_tlgWrapperByVal@$03@@U2@U2@U2@U2@U2@U2@U2@_ea_18021015C.c)
...
LABEL_29:
  ...
  {
    v91 = dword_1803E3798;
    if ( (unsigned int)dword_1803E3798 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1803E3798, 2LL) )
    {
      v92 = *((_DWORD *)a5 + 14);
      v136 = *((_DWORD *)a5 + 15);
      v93 = *((_DWORD *)a5 + 13);
    ...
    if ( a3 && v91 > 4 )
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_1803E3798, 2LL) )
      {
        v110 = *((_DWORD *)a3 + 14);
