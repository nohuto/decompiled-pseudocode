/*
 * XREFs of ?EnsureHolographicClient@CHolographicManager@@AEAAJXZ @ 0x1802534C0
 * Callers:
 ...
 *     ?HolographicClientCreated_@CompositorTracing@@QEAAXXZ @ 0x180253928 (-HolographicClientCreated_@CompositorTracing@@QEAAXXZ.c)
