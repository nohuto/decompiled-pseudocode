/*
 * XREFs of ?CleanTree@CHolographicInteropTarget@@AEAAJXZ @ 0x1802577F8
 * Callers:
 *     ?PreRender@CHolographicInteropTarget@@UEAAJXZ @ 0x180257BA0 (-PreRender@CHolographicInteropTarget@@UEAAJXZ.c)
 * Callees:
