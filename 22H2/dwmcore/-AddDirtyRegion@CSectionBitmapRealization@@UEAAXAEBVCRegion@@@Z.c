/*
 * XREFs of ?AddDirtyRegion@CSectionBitmapRealization@@UEAAXAEBVCRegion@@@Z @ 0x180043ED8
 * Callers:
 *     ?AddDirtyRegion@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXAEBVCRegion@@@Z @ 0x1800F7E60 (-AddDirtyRegion@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXAEBVCRegion@@@Z.c)
 *     ?AddDirtyRegion@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXAEBVCRegion@@@Z @ 0x1800F7E70 (-AddDirtyRegion@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXAEBVCRegion@@@Z.c)
...
void __fastcall CSectionBitmapRealization::AddDirtyRegion(CSectionBitmapRealization *this, const struct CRegion *a2)
{
  ...
  CBitmapRealization::AddDirtyRegion((CSectionBitmapRealization *)((char *)this - 80), a2);
}
