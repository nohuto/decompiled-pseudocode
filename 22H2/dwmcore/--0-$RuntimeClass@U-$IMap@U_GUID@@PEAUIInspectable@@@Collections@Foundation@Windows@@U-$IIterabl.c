/*
 * XREFs of ??0?$RuntimeClass@U?$IMap@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@U?$IIterable@PEAU?$IKeyValuePair@U_GUID@@PEAUIInspectable@@@Collections@Foundation@Windows@@@234@VFtmBase@WRL@Microsoft@@@WRL@Microsoft@@QEAA@XZ @ 0x180241AC8
 * Callers:
        ...
        _QWORD *a1)
{
  ...
  *a1 = &Windows::Foundation::Collections::IMap<_GUID,IInspectable *>::`vftable';
  a1[2] = &ILegacyStereoSwapChain::`vftable'{for `IDeviceResource'};
