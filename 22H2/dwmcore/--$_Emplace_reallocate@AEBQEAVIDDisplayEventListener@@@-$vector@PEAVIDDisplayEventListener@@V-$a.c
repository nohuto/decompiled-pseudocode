/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVIDDisplayEventListener@@@?$vector@PEAVIDDisplayEventListener@@V?$allocator@PEAVIDDisplayEventListener@@@std@@@std@@QEAAPEAPEAVIDDisplayEventListener@@QEAPEAV2@AEBQEAV2@@Z @ 0x18029158C
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVIDDisplayEventListener@@V?$allocator@PEAVIDDisplayEventListener@@@std@@@std@@AEAAXQEAPEAVIDDisplayEventListener@@_K1@Z @ 0x1802987EC (-_Change_array@-$vector@PEAVIDDisplayEventListener@@V-$allocator@PEAVIDDisplayEventListener@@@st.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<IDDisplayEventListener *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
