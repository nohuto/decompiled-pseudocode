/*
 * XREFs of ?CleanTrees@CComposition@@IEAAJXZ @ 0x180066690
 * Callers:
 ...
 *     ??A?$span@$$CBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@$0?0@gsl@@QEBAAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@_K@Z @ 0x180021F80 (--A-$span@$$CBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness.c)
 ...
 *     ?SetRedrawRects@CDirtyRegion@@AEAAXXZ @ 0x1801CE2B8 (-SetRedrawRects@CDirtyRegion@@AEAAXXZ.c)
...
LABEL_96:
  ...
  if ( ::CycleTime )
  {
    ...
    v3 = CycleTime;
    if ( v79 )
      qword_1803E5A68 += CycleTime - ::CycleTime;
  }
  ::CycleTime = v3;
