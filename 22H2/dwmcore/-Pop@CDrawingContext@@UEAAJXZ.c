/*
 * XREFs of ?Pop@CDrawingContext@@UEAAJXZ @ 0x18008EB10
 * Callers:
 *     <none>
 * Callees:
 *     ?PopLight@CDrawingContext@@AEAAJXZ @ 0x18000DF64 (-PopLight@CDrawingContext@@AEAAJXZ.c)
 *     ?PopClipBounds@CDrawingContext@@AEAAXXZ @ 0x1800216FC (-PopClipBounds@CDrawingContext@@AEAAXXZ.c)
...
LABEL_62:
        ...
        case 7:
          ...
          v8 = v58;
          if ( v58 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v59, 0LL, 0, v58, 0x12AEu, 0LL);
          return v8;
        case 8:
          v53 = *((_DWORD *)this + 88);
          if ( v53 )
        ...
        case 0xA:
          ...
          v8 = v61;
          if ( v61 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v62, 0LL, 0, v61, 0x12C2u, 0LL);
          return v8;
        default:
          return v8;
      }
