/*
 * XREFs of ?EnsureCursorState@CCursorManager@@AEAAJ_KPEAPEAVCCursorState@@@Z @ 0x180277D34
 * Callers:
 ...
 *     ?_FailFast_NullAlloc@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x1801BC0C8 (-_FailFast_NullAlloc@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 ...
 *     ??0CCursorState@@QEAA@XZ @ 0x1802790E8 (--0CCursorState@@QEAA@XZ.c)
 */
        ...
        struct CCursorState **a3)
{
  ...
  if ( a2 )
  {
    std::_Tree<std::_Tmap_traits<unsigned __int64,std::shared_ptr<unsigned char [0]>,std::less<unsigned __int64>,std::allocator<std::pair<unsigned __int64 const,std::shared_ptr<unsigned char [0]>>>,0>>::_Find_lower_bound<unsigned __int64>(
      (__int64 *)&xmmword_1803E64E8,
      (__int64)v11,
      &v15);
    v6 = v12;
    if ( *(_BYTE *)(v12 + 25) || a2 < *(_QWORD *)(v12 + 32) )
      v6 = xmmword_1803E64E8;
    if ( v6 == (_QWORD)xmmword_1803E64E8 )
    {
