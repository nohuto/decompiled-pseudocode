/*
 * XREFs of ?TelemetrySetPosition@InteractionSourceManager@@QEAAX_K@Z @ 0x180213CDC
 * Callers:
 *     ?TelemetrySetPosition@CInteractionTracker@@AEAAXXZ @ 0x1801CCD1C (-TelemetrySetPosition@CInteractionTracker@@AEAAXXZ.c)
 * Callees:
