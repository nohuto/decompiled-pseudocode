/*
 * XREFs of ?AddLatencyData@CTelemetryComputeScribbleAggregator@@SAXAEBV?$vector@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@@Z @ 0x180163020
 * Callers:
 ...
 * Callees:
 *     ??$insert@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UComputeScribbleLatencyData@@@std@@@std@@@std@@X@?$list@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@QEAA?AV?$_List_iterator@V?$_List_val@U?$_List_simple_types@UComputeScribbleLatencyData@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@UComputeScribbleLatencyData@@@std@@@std@@@1@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UComputeScribbleLatencyData@@@std@@@std@@@1@1@Z @ 0x180162F00 (--$insert@V-$_Vector_const_iterator@V-$_Vector_val@U-$_Simple_types@UComputeScribbleLatencyData@.c)
...
void __fastcall CTelemetryComputeScribbleAggregator::AddLatencyData(__int64 *a1)
{
  ...
  v3 = *a1;
  v4 = v2 - v3;
  if ( (unsigned __int64)(*((_QWORD *)&xmmword_18034B470 + 1) + (v2 - v3) / 56) > 0xA )
  {
    while ( v3 != v2 )
    {
