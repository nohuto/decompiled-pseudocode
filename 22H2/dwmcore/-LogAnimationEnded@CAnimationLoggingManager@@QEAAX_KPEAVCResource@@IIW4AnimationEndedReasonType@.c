/*
 * XREFs of ?LogAnimationEnded@CAnimationLoggingManager@@QEAAX_KPEAVCResource@@IIW4AnimationEndedReasonType@@@Z @ 0x1801B0158
 * Callers:
        ...
        int a6)
{
  ...
  {
    v14 = qword_180344E98 & 1;
    if ( v14 == qword_180344E98 )
    {
