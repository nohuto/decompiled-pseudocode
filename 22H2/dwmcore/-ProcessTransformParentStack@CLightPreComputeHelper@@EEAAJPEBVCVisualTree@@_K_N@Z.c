/*
 * XREFs of ?ProcessTransformParentStack@CLightPreComputeHelper@@EEAAJPEBVCVisualTree@@_K_N@Z @ 0x18019A790
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateRelativeLayout@CPreComputeHelper@@IEAAXPEAVCVisual@@@Z @ 0x18019AB10 (-UpdateRelativeLayout@CPreComputeHelper@@IEAAXPEAVCVisual@@@Z.c)
 */
        ...
        char a4)
{
  ...
  while ( 1 )
  {
    ...
    if ( v17 < v7 )
    {
      updated = CVisual::UpdateWorldTransform(v8, a2, v16, v10, (const struct CTreeData *)TreeData);
      v13 = updated;
      if ( updated < 0 )
      {
