/*
 * XREFs of WithinEpsilon_0 @ 0x1800C79AC
 * Callers:
 ...
 *     ?D3DXQuaternionInverse@@YAPEAUD2DQuaternion@@PEAU1@PEBU1@@Z @ 0x18021D6A8 (-D3DXQuaternionInverse@@YAPEAUD2DQuaternion@@PEAU1@PEBU1@@Z.c)
