/*
 * XREFs of ?SendSetBootstrapProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x1801BB120
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v4 = CoreUICallSend(v3, v7, 2LL, 1LL, 8, &unk_18035672A, v6);
  if ( v4 < 0 )
