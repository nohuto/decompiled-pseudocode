/*
 * XREFs of McTemplateU0qxqxxxqxxxxqxxxxxxxxxxqqqxqxxxx_EventWriteTransfer @ 0x1801561B4
 * Callers:
...
ULONG __fastcall McTemplateU0qxqxxxqxxxxqxxxxxxxxxxqqqxqxxxx_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        int a3,
        __int64 a4,
