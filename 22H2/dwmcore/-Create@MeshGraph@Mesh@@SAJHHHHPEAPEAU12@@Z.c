/*
 * XREFs of ?Create@MeshGraph@Mesh@@SAJHHHHPEAPEAU12@@Z @ 0x180063720
 * Callers:
 ...
 *     ??0MeshLine@Mesh@@QEAA@XZ @ 0x1800E25A4 (--0MeshLine@Mesh@@QEAA@XZ.c)
 *     ??0MeshVertex@Mesh@@QEAA@XZ @ 0x1800E25BC (--0MeshVertex@Mesh@@QEAA@XZ.c)
