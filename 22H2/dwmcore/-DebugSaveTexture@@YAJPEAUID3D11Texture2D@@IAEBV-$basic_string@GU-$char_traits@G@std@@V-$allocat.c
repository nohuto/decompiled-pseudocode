/*
 * XREFs of ?DebugSaveTexture@@YAJPEAUID3D11Texture2D@@IAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@Z @ 0x180210184
 * Callers:
 ...
 *     ??$make_unique@VCBitmapSaver@@AEAIAEAIAEAEAEAIAEAPEAX$0A@@std@@YA?AV?$unique_ptr@VCBitmapSaver@@U?$default_delete@VCBitmapSaver@@@std@@@0@AEAI0AEAE0AEAPEAX@Z @ 0x18020F928 (--$make_unique@VCBitmapSaver@@AEAIAEAIAEAEAEAIAEAPEAX$0A@@std@@YA-AV-$unique_ptr@VCBitmapSaver@@.c)
