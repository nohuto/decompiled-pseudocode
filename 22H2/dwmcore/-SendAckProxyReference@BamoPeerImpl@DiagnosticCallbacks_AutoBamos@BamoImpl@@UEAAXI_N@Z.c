/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x1801667B0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoImpl::DiagnosticCallbacks_AutoBamos::BamoPeerImpl *this)
{
  ...
  v3 = CoreUICallSend(v2, v4, 2LL, 1LL, 4, &unk_1802DA36D);
  if ( v3 < 0 )
  {
