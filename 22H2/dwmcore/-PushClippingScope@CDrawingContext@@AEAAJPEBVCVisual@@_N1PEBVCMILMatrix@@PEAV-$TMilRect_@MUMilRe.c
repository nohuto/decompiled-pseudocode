/*
 * XREFs of ?PushClippingScope@CDrawingContext@@AEAAJPEBVCVisual@@_N1PEBVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801D6424
 * Callers:
...
__int64 __fastcall CDrawingContext::PushClippingScope(__int64 a1, __int64 a2, char a3, char a4, struct CMILMatrix *a5)
{
  ...
  if ( !a4 )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0xC09u, 0LL);
      return v5;
    }
  }
  ...
  if ( a2 )
  {
    ...
    *((_QWORD *)&v16 + 1) = a2;
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xC17u, 0LL);
      return v5;
    }
    v6 = 1;
  }
