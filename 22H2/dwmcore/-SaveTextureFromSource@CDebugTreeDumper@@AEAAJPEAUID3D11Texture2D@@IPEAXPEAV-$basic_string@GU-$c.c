/*
 * XREFs of ?SaveTextureFromSource@CDebugTreeDumper@@AEAAJPEAUID3D11Texture2D@@IPEAXPEAV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@Z @ 0x180197B84
 * Callers:
 ...
 *     ??$_UIntegral_to_buff@G_K@std@@YAPEAGPEAG_K@Z @ 0x18019737C (--$_UIntegral_to_buff@G_K@std@@YAPEAGPEAG_K@Z.c)
