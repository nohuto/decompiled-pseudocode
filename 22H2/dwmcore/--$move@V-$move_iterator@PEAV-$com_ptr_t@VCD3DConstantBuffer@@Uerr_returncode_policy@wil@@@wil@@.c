...
LABEL_3:
  ...
  while ( v4 != a3 )
  {
    ...
    *v11 = v12;
    if ( v13 )
      CMILRefCountBaseT<IDeviceResource>::InternalRelease(v13);
    ++v11;
    ++v4;
  }
  result = a1;
