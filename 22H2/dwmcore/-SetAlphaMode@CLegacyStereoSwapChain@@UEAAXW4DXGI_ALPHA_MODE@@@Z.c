/*
 * XREFs of ?SetAlphaMode@CLegacyStereoSwapChain@@UEAAXW4DXGI_ALPHA_MODE@@@Z @ 0x1802A0680
 * Callers:
 *     ?SetAlphaMode@CLegacyStereoSwapChain@@$4PPPPPPPM@BLI@EAAXW4DXGI_ALPHA_MODE@@@Z @ 0x180120C40 (-SetAlphaMode@CLegacyStereoSwapChain@@$4PPPPPPPM@BLI@EAAXW4DXGI_ALPHA_MODE@@@Z.c)
 * Callees:
