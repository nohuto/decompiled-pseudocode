/*
 * XREFs of ?InsertChildAt@CVisual@@IEAAJPEAV1@I_N@Z @ 0x1800A1A70
 * Callers:
...
__int64 __fastcall CVisual::InsertChildAt(CVisual *this, struct CVisual *a2, unsigned int a3, char a4)
{
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024809, 0x231u, 0LL);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x234u, 0LL);
    }
    else
    {
