/*
 * XREFs of ??1CExpressionManager@@UEAA@XZ @ 0x1801AADEC
 * Callers:
 ...
 *     ??$_Free_non_head@V?$allocator@U?$_List_node@U?$pair@QEAVCChannelContext@@M@std@@PEAX@std@@@std@@@?$_List_node@U?$pair@QEAVCChannelContext@@M@std@@PEAX@std@@SAXAEAV?$allocator@U?$_List_node@U?$pair@QEAVCChannelContext@@M@std@@PEAX@std@@@1@PEAU01@@Z @ 0x1801AAB00 (--$_Free_non_head@V-$allocator@U-$_List_node@U-$pair@QEAVCChannelContext@@M@std@@PEAX@std@@@std@.c)
 */
