/*
 * XREFs of ?PreRender@CLocalAppRenderTarget@@UEAAJXZ @ 0x18018A918
 * Callers:
 *     ?PreRender@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F52E0 (-PreRender@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
