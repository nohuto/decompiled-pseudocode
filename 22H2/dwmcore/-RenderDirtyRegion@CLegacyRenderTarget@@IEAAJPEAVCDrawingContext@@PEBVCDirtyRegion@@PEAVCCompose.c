/*
 * XREFs of ?RenderDirtyRegion@CLegacyRenderTarget@@IEAAJPEAVCDrawingContext@@PEBVCDirtyRegion@@PEAVCComposeTop@@@Z @ 0x180091458
 * Callers:
 ...
 *     ?UseSuperSample@CLegacyRenderTarget@@AEBA_NXZ @ 0x180091E4C (-UseSuperSample@CLegacyRenderTarget@@AEBA_NXZ.c)
    ...
    *((_QWORD *)&v86 + 1) = __PAIR64__(v36, v35);
                             ...
                             &v86) )
    {
      ...
      *((float *)&v86 + 3) = (float)v38;
      ...
      v8 = CDrawingContext::Clear((struct CDrawingContext *)((char *)a2 + 16), &stru_1802F0A50);
    ...
    *((_QWORD *)&v80 + 1) = v82;
    ...
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 8) != 0 )
      McTemplateU0qdffff_EventWriteTransfer(
        ...
        SLOBYTE(v91),
        SLOBYTE(v92));
    dword_180347298 += (int)(float)((float)(v50 - v51) * (float)(v52 - v53));
