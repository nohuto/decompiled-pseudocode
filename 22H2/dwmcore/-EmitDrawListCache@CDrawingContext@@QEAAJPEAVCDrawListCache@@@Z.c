/*
 * XREFs of ?EmitDrawListCache@CDrawingContext@@QEAAJPEAVCDrawListCache@@@Z @ 0x180078E18
 * Callers:
 ...
 * Callees:
 *     ?FromMilCompositingMode@BlendMode@@YA?AW4Enum@1@W42MilCompositingMode@@@Z @ 0x180079328 (-FromMilCompositingMode@BlendMode@@YA-AW4Enum@1@W42MilCompositingMode@@@Z.c)
...
__int64 __fastcall CDrawingContext::EmitDrawListCache(CDrawingContext *this, struct CDrawListCache *a2)
{
  ...
  if ( COERCE_FLOAT(v7 & _xmm) >= 0.0000011920929 )
  {
    ...
    if ( *((_QWORD *)this + 428) )
    {
      ...
      if ( updated < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, updated, 0x3ACu, 0LL);
        goto LABEL_11;
      }
    ...
    do
    {
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x3BEu, 0LL);
        goto LABEL_11;
      }
...
LABEL_21:
    ...
    while ( v17 >= 0 );
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x3B8u, 0LL);
  }
LABEL_11:
  if ( v6 != -2003304441 )
    return v6;
