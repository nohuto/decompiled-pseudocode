/*
 * XREFs of ?BspHitTest@CHitTestContext@@AEAAJAEBVCMILMatrix@@PEAVCPolygon@@@Z @ 0x18022897C
 * Callers:
        ...
        struct CPolygon *a3)
{
  ...
  if ( !*(_QWORD *)&this[14] )
  {
    ...
    if ( (*(unsigned __int8 (__fastcall **)(struct D2D_POINT_2F))(**(_QWORD **)&v7 + 272LL))(v7) )
    {
      v13 = 0;
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x12Bu, 0LL);
      }
      else if ( v13 )
      {
        this[14] = v7;
