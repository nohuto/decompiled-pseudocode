/*
 * XREFs of ?Create@CBackdropVisualImage@@SAJPEAVCComposition@@PEBVCVisual@@AEBVCVisualTreePath@@_NPEAPEAV1@@Z @ 0x1800A61F4
 * Callers:
 ...
 *     ?Initialize@CBackdropVisualImage@@EEAAJXZ @ 0x1800A6560 (-Initialize@CBackdropVisualImage@@EEAAJXZ.c)
