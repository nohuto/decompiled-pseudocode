/*
 * XREFs of ?Present@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@IAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I_N@Z @ 0x1800EBBD8
 * Callers:
 ...
 * Callees:
 *     ?LegacyPresentRequired@COverlayContext@@AEBA_NXZ @ 0x18002FC44 (-LegacyPresentRequired@COverlayContext@@AEBA_NXZ.c)
