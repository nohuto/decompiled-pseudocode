/*
 * XREFs of ?EnsureSwapChain@CLegacyStereoRenderTarget@@MEAAJPEA_N@Z @ 0x1801F1300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLegacyStereoRenderTarget::EnsureSwapChain(CLegacyStereoRenderTarget *this, bool *a2)
{
  ...
  *a2 = 0;
  ...
  if ( v4 )
  {
    ...
    if ( v7 >= 0 )
      return DXGIOutput;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180386EF8, 3u, v7, 0x54u, 0LL);
...
LABEL_29:
    v29 = v14;
LABEL_32:
    MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_180386EF8, 3u, v29, v32, 0LL);
  ...
  if ( Device < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_180386EF8, 3u, Device, 0x6Du, 0LL);
    v28 = v34;
    if ( !v34 )
      goto LABEL_24;
    goto LABEL_23;
  ...
  *((_QWORD *)this + 2338) = 0LL;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v24, &dword_180386EF8, 3u, LegacyStereoSwapChain, 0x74u, 0LL);
    goto LABEL_21;
  }
  ...
  if ( v25 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v26, &dword_180386EF8, 3u, v25, 0x78u, 0LL);
LABEL_21:
    if ( !v22 )
    {
LABEL_24:
