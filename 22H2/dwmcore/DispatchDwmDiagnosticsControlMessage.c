/*
 * XREFs of DispatchDwmDiagnosticsControlMessage @ 0x180212244
 * Callers:
 *     McGenControlCallbackV2 @ 0x1800D6230 (McGenControlCallbackV2.c)
 * Callees:
 ...
 *     ?HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z @ 0x180212324 (-HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z.c)
 */
