/*
 * XREFs of ?DuplicateSharedResource@CChannel@@UEAAJPEAXW4Enum@DwmResourceType@@PEAI@Z @ 0x18005FB60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::DuplicateSharedResource(__int64 a1, __int64 a2, unsigned int a3, _DWORD *a4)
{
  ...
  {
    v10 = v12 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802DB2E8, 2u, v10, 0x2FCu, 0LL);
    goto LABEL_4;
  }
  ...
  if ( v8 < 0 )
  {
    v14 = 771;
LABEL_8:
    MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802DB2E8, 2u, v8, v14, 0LL);
  }
LABEL_4:
