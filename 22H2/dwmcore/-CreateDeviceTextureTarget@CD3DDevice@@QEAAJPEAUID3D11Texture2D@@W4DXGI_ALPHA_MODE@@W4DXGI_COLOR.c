/*
 * XREFs of ?CreateDeviceTextureTarget@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@M_NPEAPEAVIDeviceTextureTarget@@@Z @ 0x1801019C8
 * Callers:
        ...
        __int64 *a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( (v25 & 0x20) == 0 )
  {
    ...
    v19 = 1249;
LABEL_10:
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802EE2F0, 2u, v11, v19, 0LL);
  ...
  v11 = v15;
  if ( v15 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802EE2F0, 2u, v15, 0x4F7u, 0LL);
  return (unsigned int)v11;
}
