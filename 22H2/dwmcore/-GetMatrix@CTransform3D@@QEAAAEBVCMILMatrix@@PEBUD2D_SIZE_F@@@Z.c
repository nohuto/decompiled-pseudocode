/*
 * XREFs of ?GetMatrix@CTransform3D@@QEAAAEBVCMILMatrix@@PEBUD2D_SIZE_F@@@Z @ 0x18007B128
 * Callers:
 ...
 *     ?PushTransform@CRenderDataBounds@@UEAAJPEAVCTransform@@@Z @ 0x1800D23B0 (-PushTransform@CRenderDataBounds@@UEAAJPEAVCTransform@@@Z.c)
