/*
 * XREFs of ??$AddProperty@M@?$PropertySetStorage@VDynArrayNoZero@@VPropertySetUserModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBMPEAI@Z @ 0x1800DD520
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  *a4 = -1;
  ...
  else
  {
    ...
    {
LABEL_5:
      v12 = DynArrayImpl<0>::Grow(a1 + 32, 1u, 4, 1, 0LL);
      if ( v12 >= 0 )
      {
        *(_DWORD *)(a1 + 56) += 4;
