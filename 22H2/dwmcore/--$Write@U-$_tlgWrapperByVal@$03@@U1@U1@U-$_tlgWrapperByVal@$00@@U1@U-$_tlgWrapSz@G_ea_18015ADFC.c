 ...
 * Callers:
 *     ?FirstFrameRenderGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_KI@Z @ 0x18015DAB4 (-FirstFrameRenderGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatenc.c)
 *     ?SteadyStateFrameRenderGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_KI@Z @ 0x180160B58 (-SteadyStateFrameRenderGlitch@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouch.c)
 * Callees:
