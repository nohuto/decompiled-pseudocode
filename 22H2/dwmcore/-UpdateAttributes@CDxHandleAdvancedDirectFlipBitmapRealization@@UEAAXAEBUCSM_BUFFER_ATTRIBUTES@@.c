/*
 * XREFs of ?UpdateAttributes@CDxHandleAdvancedDirectFlipBitmapRealization@@UEAAXAEBUCSM_BUFFER_ATTRIBUTES@@@Z @ 0x180263F40
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CSM_BUFFER_ATTRIBUTES *a2)
{
  ...
  v3 = *((_DWORD *)this - 47);
  v5 = (char *)this + *(int *)(*((_QWORD *)this - 39) + 16LL) - 312;
  ...
  if ( v6 )
  {
    ...
    v8 = (char *)this + *(int *)(*((_QWORD *)this - 39) + 16LL) - 312;
    ...
    if ( v14 != *v9 )
    {
      ...
      v12 = (char *)this + *(int *)(*((_QWORD *)this - 39) + 16LL) - 312;
