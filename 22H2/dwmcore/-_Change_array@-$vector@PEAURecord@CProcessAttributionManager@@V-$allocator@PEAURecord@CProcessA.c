/*
 * XREFs of ?_Change_array@?$vector@PEAURecord@CProcessAttributionManager@@V?$allocator@PEAURecord@CProcessAttributionManager@@@std@@@std@@AEAAXQEAPEAURecord@CProcessAttributionManager@@_K1@Z @ 0x1800FA3C0
 * Callers:
