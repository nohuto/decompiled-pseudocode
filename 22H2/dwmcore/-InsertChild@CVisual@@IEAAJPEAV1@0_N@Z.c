/*
 * XREFs of ?InsertChild@CVisual@@IEAAJPEAV1@0_N@Z @ 0x18009BBF8
 * Callers:
...
__int64 __fastcall CVisual::InsertChild(CVisual *this, struct CVisual *a2, struct CVisual *a3, char a4)
{
  ...
  {
    v31 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, -2147024809, 0x235u, 0LL);
  }
  else
  {
    v8 = *((_QWORD *)this + 10);
...
LABEL_110:
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x253u, 0LL);
    }
    else
    {
