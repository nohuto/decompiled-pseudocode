/*
 * XREFs of ?GenerateTriangles@Mesh@@AEBAJPEAGHPEAH@Z @ 0x1800BE1C8
 * Callers:
 ...
 *     ?GetNext@PolygonPathIterator@Mesh@@QEAAPEAUMeshVertex@2@XZ @ 0x1800BE3F4 (-GetNext@PolygonPathIterator@Mesh@@QEAAPEAUMeshVertex@2@XZ.c)
 *     ?IsCycle@PolygonPathIterator@Mesh@@CA_NPEBUMeshEdge@2@0@Z @ 0x1800BE580 (-IsCycle@PolygonPathIterator@Mesh@@CA_NPEBUMeshEdge@2@0@Z.c)
                ...
                if ( v24 )
                {
                  ...
                  do
                  {
                    if ( v23 != Next && v24 != Next )
                    {
                      ...
                      {
                        v11 = -2147024882;
                        MilInstrumentationCheckHR_MaybeFailFast((__int64)v24, 0LL, 0, -2147024882, 0xBB8u, 0LL);
                        return v11;
                      }
                      v27 = v20;
                      v28 = v37 + 3;
