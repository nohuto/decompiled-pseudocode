/*
 * XREFs of ?BuildGrid@Mesh@@AEAAJHHH@Z @ 0x1800BA7A0
 * Callers:
 ...
 *     ?SetDirection@Line2d@Mesh@@QEAAXAEBUD2D_VECTOR_2F@@@Z @ 0x1800BB1AC (-SetDirection@Line2d@Mesh@@QEAAXAEBUD2D_VECTOR_2F@@@Z.c)
