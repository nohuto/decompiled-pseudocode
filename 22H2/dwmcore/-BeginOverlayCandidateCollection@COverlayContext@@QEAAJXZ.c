/*
 * XREFs of ?BeginOverlayCandidateCollection@COverlayContext@@QEAAJXZ @ 0x1800910E0
 * Callers:
...
__int64 __fastcall COverlayContext::BeginOverlayCandidateCollection(COverlayContext *this)
{
  ...
  *((_BYTE *)this + 11422) = v7;
  ...
  v10 = dword_18034B2C4;
  v11 = dword_18034B2BC;
  if ( TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::sc_rcEmpty >= dword_18034B2C0
    || dword_18034B2BC >= dword_18034B2C4 )
  {
    **((_DWORD **)this + 1413) = 0;
  }
  else
