/*
 * XREFs of ?BeginOverlayCandidateCollection@COverlayContext@@QEAAJXZ @ 0x180086D88
 * Callers:
...
__int64 __fastcall COverlayContext::BeginOverlayCandidateCollection(COverlayContext *this)
{
  ...
  *((_WORD *)this + 5651) = 0;
  ...
  v11 = dword_1803EA0A4;
  v12 = dword_1803EA09C;
  if ( TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::sc_rcEmpty >= dword_1803EA0A0
    || dword_1803EA09C >= dword_1803EA0A4 )
  {
    **((_DWORD **)this + 1397) = 0;
  }
  else
