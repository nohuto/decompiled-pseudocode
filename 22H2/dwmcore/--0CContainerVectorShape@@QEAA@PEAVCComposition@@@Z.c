/*
 * XREFs of ??0CContainerVectorShape@@QEAA@PEAVCComposition@@@Z @ 0x1800B8F04
 * Callers:
 ...
 *     ??0CShapeTree@@QEAA@PEAVCComposition@@@Z @ 0x1800B8604 (--0CShapeTree@@QEAA@PEAVCComposition@@@Z.c)
 * Callees:
