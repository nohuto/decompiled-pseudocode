/*
 * XREFs of ?SendInteractionSummary@CTelemetryTouchLatencyAnalysis@@AEAAJXZ @ 0x18015FFB8
 * Callers:
...
LABEL_39:
        ...
        *(_OWORD *)v67 = 0LL;
        v53 = qword_180347410 / 0x3E8uLL;
        v54 = *((unsigned __int8 *)this + 4216);
        v55 = (PerformanceCount.QuadPart - *((_QWORD *)this + 526)) / (qword_180347410 / 0x3E8uLL);
        v68 = 0;
        if ( (_BYTE)v54 )
        {
          v56 = v67;
