/*
 * XREFs of ?Get3DBounds@CSceneWorld@@QEAAJPEBUD2D_SIZE_F@@PEAV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18020B388
 * Callers:
...
__int64 __fastcall CSceneWorld::Get3DBounds(_QWORD **a1, __int64 a2, __m128 *a3)
{
  ...
  else
  {
    ...
    CMILMatrix::Transform3DBoundsHelper<1>((__int64)v6, v10, a3);
  }
  return 0LL;
}
