/*
 * XREFs of ??$_Insert_range@PEBUMilPoint3F@@@?$vector@UMilPoint3F@@V?$allocator@UMilPoint3F@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UMilPoint3F@@@std@@@std@@@1@PEBUMilPoint3F@@1Uforward_iterator_tag@1@@Z @ 0x1801BF7B4
 * Callers:
 ...
 *     ?_Change_array@?$vector@UMilPoint3F@@V?$allocator@UMilPoint3F@@@std@@@std@@AEAAXQEAUMilPoint3F@@_K1@Z @ 0x1801CAB84 (-_Change_array@-$vector@UMilPoint3F@@V-$allocator@UMilPoint3F@@@std@@@std@@AEAAXQEAUMilPoint3F@@.c)
 */
