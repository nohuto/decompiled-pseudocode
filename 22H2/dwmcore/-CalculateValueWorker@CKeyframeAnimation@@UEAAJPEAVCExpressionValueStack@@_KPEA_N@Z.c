/*
 * XREFs of ?CalculateValueWorker@CKeyframeAnimation@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180056390
 * Callers:
 ...
 *     ?Pause@CKeyframeAnimation@@AEAAXXZ @ 0x1800EE77C (-Pause@CKeyframeAnimation@@AEAAXXZ.c)
