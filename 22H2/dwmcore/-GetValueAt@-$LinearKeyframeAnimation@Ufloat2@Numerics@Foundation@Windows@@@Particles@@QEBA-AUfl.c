/*
 * XREFs of ?GetValueAt@?$LinearKeyframeAnimation@Ufloat2@Numerics@Foundation@Windows@@@Particles@@QEBA?AUfloat2@Numerics@Foundation@Windows@@MAEBV?$span@M$0?0@gsl@@AEAV78@@Z @ 0x1801DB8A4
 * Callers:
 ...
 * Callees:
 *     ?FindFirstFrameIndex@?$LinearKeyframeAnimation@Ufloat2@Numerics@Foundation@Windows@@@Particles@@IEBAIM@Z @ 0x1801DB694 (-FindFirstFrameIndex@-$LinearKeyframeAnimation@Ufloat2@Numerics@Foundation@Windows@@@Particles@@.c)
 */
