/*
 * XREFs of ??$_Emplace_reallocate@AEA_K@?$vector@_KV?$allocator@_K@std@@@std@@QEAAPEA_KQEA_KAEA_K@Z @ 0x1801E3F94
 * Callers:
 ...
 *     ?_Change_array@?$vector@_KV?$allocator@_K@std@@@std@@AEAAXQEA_K_K1@Z @ 0x1801E5368 (-_Change_array@-$vector@_KV-$allocator@_K@std@@@std@@AEAAXQEA_K_K1@Z.c)
 */
