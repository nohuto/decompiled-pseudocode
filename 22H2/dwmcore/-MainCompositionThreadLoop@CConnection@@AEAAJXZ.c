/*
 * XREFs of ?MainCompositionThreadLoop@CConnection@@AEAAJXZ @ 0x1800D6788
 * Callers:
...
LABEL_12:
  ...
  *((_BYTE *)this + 24) = 1;
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
    McGenEventWrite_EventWriteTransfer(&Microsoft_Windows_Dwm_Core_Provider_Context, "O", v11, 1LL, v16);
  do
  {
