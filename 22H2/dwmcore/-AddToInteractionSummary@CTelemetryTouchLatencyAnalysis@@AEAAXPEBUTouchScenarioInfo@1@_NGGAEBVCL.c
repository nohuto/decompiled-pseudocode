/*
 * XREFs of ?AddToInteractionSummary@CTelemetryTouchLatencyAnalysis@@AEAAXPEBUTouchScenarioInfo@1@_NGGAEBVCLatencyInfo@1@I@Z @ 0x18015C8E0
 * Callers:
 ...
 *     ?compare@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEBAHAEBV12@@Z @ 0x180034E58 (-compare@-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@QEBAHAEBV12@@Z.c)
...
LABEL_17:
  ...
  if ( (unsigned int)((PerformanceCount.QuadPart - *((_QWORD *)v10 + 526)) / (qword_180347410 / 0x3E8uLL)) >= 0xEA60
    || *((_BYTE *)v10 + 4216) == 5 )
  {
    CTelemetryTouchLatencyAnalysis::SendInteractionSummary(v10);
