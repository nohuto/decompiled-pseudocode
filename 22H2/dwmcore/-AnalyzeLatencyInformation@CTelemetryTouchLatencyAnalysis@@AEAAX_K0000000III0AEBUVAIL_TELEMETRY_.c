/*
 * XREFs of ?AnalyzeLatencyInformation@CTelemetryTouchLatencyAnalysis@@AEAAX_K0000000III0AEBUVAIL_TELEMETRY_TOUCH_INFO@1@@Z @ 0x180022FA8
 * Callers:
 ...
 *     ?FrameLatencies@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@II_KAEBVCLatencyInfo@3@@Z @ 0x18015DD7C (-FrameLatencies@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysi.c)
 ...
 *     ?TryGetDataForInteraction@CTelemetryComputeScribbleAggregator@@SA_NIPEAUComputeScribbleLatencyData@@_N_K@Z @ 0x1801630EC (-TryGetDataForInteraction@CTelemetryComputeScribbleAggregator@@SA_NIPEAUComputeScribbleLatencyDa.c)
 *     MicrosoftTelemetryAssertTriggeredNoArgs @ 0x180216E08 (MicrosoftTelemetryAssertTriggeredNoArgs.c)
 */
  ...
  if ( a8 >= a3 )
  {
    if ( a8 )
    {
      ...
      if ( Scenario )
      {
        ...
        v43 = 0LL;
        v44 = 0LL;
        v27 = qword_180347410 / 0x3E8uLL;
        v28 = (a7 - a6) % (qword_180347410 / 0x3E8uLL);
        v29 = *((_DWORD *)Scenario + 24) == 2;
        HIDWORD(v45) = (a7 - a6) / (qword_180347410 / 0x3E8uLL);
        if ( !v29 )
        {
          LODWORD(v43) = (v14 - a3) / v27;
          DWORD1(v43) = (a4 - a3) / (qword_180347410 / 0xF4240uLL);
          HIDWORD(v44) = (a5 - a4) / (qword_180347410 / 0xF4240uLL);
          ...
          if ( v30 )
          {
            v26 = qword_180347410 / 0xF4240uLL;
            DWORD2(v43) = (*(_QWORD *)a14 - a3) / (qword_180347410 / 0xF4240uLL);
            HIDWORD(v43) = (*((_QWORD *)a14 + 1) - *(_QWORD *)a14) / (qword_180347410 / 0xF4240uLL);
            v28 = (a4 - *((_QWORD *)a14 + 1)) % (qword_180347410 / 0xF4240uLL);
            LODWORD(v44) = (a4 - *((_QWORD *)a14 + 1)) / (qword_180347410 / 0xF4240uLL);
          }
        }
        v31 = v40;
        if ( v40 )
