/*
 * XREFs of ?OnChanged@CSharedSectionBase@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1800F9170
 * Callers:
 *     <none>
 * Callees:
 *     ?UnmapSharedMemory@CSharedSectionBase@@IEBAXXZ @ 0x1800F6990 (-UnmapSharedMemory@CSharedSectionBase@@IEBAXXZ.c)
 *     ?MapSharedMemory@CSharedSectionBase@@KAPEAXPEAX_K@Z @ 0x1800F91BC (-MapSharedMemory@CSharedSectionBase@@KAPEAXPEAX_K@Z.c)
 */
