/*
 * XREFs of ??$_Insert_range@PEAPEAVCCompositionTextLine@@@?$vector@PEAVCCompositionTextLine@@V?$allocator@PEAVCCompositionTextLine@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCCompositionTextLine@@@std@@@std@@@1@PEAPEAVCCompositionTextLine@@1Uforward_iterator_tag@1@@Z @ 0x1801BE650
 * Callers:
 *     ??$insert@PEAPEAVCCompositionTextLine@@$0A@@?$vector@PEAVCCompositionTextLine@@V?$allocator@PEAVCCompositionTextLine@@@std@@@std@@QEAA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCCompositionTextLine@@@std@@@std@@@1@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCCompositionTextLine@@@std@@@std@@@1@PEAPEAVCCompositionTextLine@@1@Z @ 0x1801BFE04 (--$insert@PEAPEAVCCompositionTextLine@@$0A@@-$vector@PEAVCCompositionTextLine@@V-$allocator@PEAV.c)
 * Callees:
 ...
 *     ?_Change_array@?$vector@PEAVCCompositionTextLine@@V?$allocator@PEAVCCompositionTextLine@@@std@@@std@@AEAAXQEAPEAVCCompositionTextLine@@_K1@Z @ 0x1801CA78C (-_Change_array@-$vector@PEAVCCompositionTextLine@@V-$allocator@PEAVCCompositionTextLine@@@std@@@.c)
 */

void __fastcall std::vector<CCompositionTextLine *>::_Insert_range<CCompositionTextLine * *>(
        __int64 a1,
        _BYTE *a2,
        const void *a3,
        __int64 a4)
{
  ...
  if ( v7 )
  {
    ...
    else
    {
      ...
      std::vector<CCompositionTextLine *>::_Change_array(a1, v17, v25, v11);
    }
  }
}
