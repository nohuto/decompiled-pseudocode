/*
 * XREFs of ?DrawBspPolygonList@CDrawingContext@@QEAAJPEAVCVisual@@0@Z @ 0x1801D3818
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawBspPolygonList(CDrawingContext *this, struct CVisual *a2, struct CVisual *a3)
{
  ...
  for ( i = 0LL; ; i += 8LL )
  {
    ...
    if ( (v5 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v5, 0x52Du, 0LL);
      goto LABEL_22;
    }
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x52Fu, 0LL);
      goto LABEL_22;
    }
    v19 = *(_OWORD *)(v11 + 160);
    v30 = *(_DWORD *)(v11 + 208);
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0x546u, 0LL);
