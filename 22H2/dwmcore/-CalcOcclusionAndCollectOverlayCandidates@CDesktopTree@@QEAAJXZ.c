/*
 * XREFs of ?CalcOcclusionAndCollectOverlayCandidates@CDesktopTree@@QEAAJXZ @ 0x180090D48
 * Callers:
 *     ?CollectOverlayCandidates@CLegacyRenderTarget@@UEBAPEAVCOverlayContext@@XZ @ 0x180090D10 (-CollectOverlayCandidates@CLegacyRenderTarget@@UEBAPEAVCOverlayContext@@XZ.c)
 *     ?CollectOverlayCandidates@CDDisplayRenderTarget@@UEBAPEAVCOverlayContext@@XZ @ 0x18016E020 (-CollectOverlayCandidates@CDDisplayRenderTarget@@UEBAPEAVCOverlayContext@@XZ.c)
 * Callees:
 ...
 *     ??9?$basic_iterator@PEAVCOverlayContext@@@detail@@QEBA_NAEBV01@@Z @ 0x1800910CC (--9-$basic_iterator@PEAVCOverlayContext@@@detail@@QEBA_NAEBV01@@Z.c)
 ...
 *     ?clear_region@?$vector_facade@VCVIRenderList@@V?$buffer_impl@VCVIRenderList@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x1800CDFF8 (-clear_region@-$vector_facade@VCVIRenderList@@V-$buffer_impl@VCVIRenderList@@$0BA@$00Vliberal_ex.c)
...
LABEL_45:
          ...
          if ( ::CycleTime )
          {
            ...
            v1 = CycleTime;
            if ( v26 )
              qword_180347308 += CycleTime - ::CycleTime;
          }
          ::CycleTime = v1;
          return v4;
        }
