/*
 * XREFs of ?CreateD2DBitmap@CD3DDevice@@QEAAJPEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MMPEAPEAVCD2DBitmap@@@Z @ 0x18003B5FC
 * Callers:
...
LABEL_7:
    v17 = v12;
LABEL_9:
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802EE2F0, 2u, v17, v18, 0LL);
  }
