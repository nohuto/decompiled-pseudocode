/*
 * XREFs of ?DrawInk@CDrawingContext@@UEAAJPEAUID2D1Ink@@AEBU_D3DCOLORVALUE@@PEAUID2D1InkStyle@@@Z @ 0x1801D4130
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1InkStyle *a4)
{
  ...
  {
    v11 = -2147467263;
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, -2147467263, 0x2D2u, 0LL);
    goto LABEL_22;
  }
