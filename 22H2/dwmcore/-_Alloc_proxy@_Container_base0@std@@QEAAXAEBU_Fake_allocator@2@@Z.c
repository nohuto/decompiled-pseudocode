/*
 * XREFs of ?_Alloc_proxy@_Container_base0@std@@QEAAXAEBU_Fake_allocator@2@@Z @ 0x1801A2864
 * Callers:
...
void __fastcall std::_Container_base0::_Alloc_proxy(std::_Container_base0 *this, const struct std::_Fake_allocator *a2)
{
  ;
}
