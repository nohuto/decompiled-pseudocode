/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_TestConfNum@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180118DA8
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_TestConfNum@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801193A0 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_TestConfNum@@@details@wil@@QEAAX_NW4Repor.c)
 * Callees:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_TestConfNum@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180119140 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_TestConfNum@@@details@w.c)
 */
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_TestConfNum>::GetCurrentFeatureEnabledState(a1, &v14, &v13);
    for ( i = *a2; ; i = v9 )
    {
      v7 = v13 == 0;
      v8 = i;
