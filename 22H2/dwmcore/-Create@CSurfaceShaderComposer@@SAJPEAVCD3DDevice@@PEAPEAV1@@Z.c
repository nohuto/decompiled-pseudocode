/*
 * XREFs of ?Create@CSurfaceShaderComposer@@SAJPEAVCD3DDevice@@PEAPEAV1@@Z @ 0x1800CF540
 * Callers:
...
__int64 __fastcall CSurfaceShaderComposer::Create(struct CD3DDevice *a1, struct CSurfaceShaderComposer **a2)
{
  ...
  v7 = v6(v2, &unk_18033DAA0, 832LL, 0LL, &v22);
  v9 = v7;
  if ( v7 < 0 )
  {
    v18 = 134;
  ...
  v7 = v10(v2, &v29, 3LL, &unk_18033DAA0, 832LL, &v21);
  v9 = v7;
  if ( v7 < 0 )
  {
    v18 = 143;
