/*
 * XREFs of ?AffectsVisual@CCompositionSpotLight@@UEAA_NPEBVCVisualTree@@PEAVCVisual@@@Z @ 0x1802262B0
 * Callers:
 *     <none>
 * Callees:
 *     ?Contains@?$DynArray@PEAVCVisual@@$0A@@@QEBA_NAEBQEAVCVisual@@@Z @ 0x180011E7C (-Contains@-$DynArray@PEAVCVisual@@$0A@@@QEBA_NAEBQEAVCVisual@@@Z.c)
 ...
 *     ?GetEffectiveOffset@CVisual@@QEBA_NPEAM00@Z @ 0x180210BB8 (-GetEffectiveOffset@CVisual@@QEBA_NPEAM00@Z.c)
 */
