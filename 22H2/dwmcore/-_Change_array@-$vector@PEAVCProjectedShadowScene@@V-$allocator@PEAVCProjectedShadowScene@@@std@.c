/*
 * XREFs of ?_Change_array@?$vector@PEAVCProjectedShadowScene@@V?$allocator@PEAVCProjectedShadowScene@@@std@@@std@@AEAAXQEAPEAVCProjectedShadowScene@@_K1@Z @ 0x18001C26C
 * Callers:
