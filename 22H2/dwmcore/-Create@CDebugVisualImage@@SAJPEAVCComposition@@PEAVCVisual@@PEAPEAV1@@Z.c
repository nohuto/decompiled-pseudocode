/*
 * XREFs of ?Create@CDebugVisualImage@@SAJPEAVCComposition@@PEAVCVisual@@PEAPEAV1@@Z @ 0x1802185AC
 * Callers:
 ...
 *     ??1?$com_ptr_t@VCDebugVisualImage@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x18019D9E0 (--1-$com_ptr_t@VCDebugVisualImage@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ.c)
 *     ??0CDebugVisualImage@@AEAA@PEAVCComposition@@@Z @ 0x180218448 (--0CDebugVisualImage@@AEAA@PEAVCComposition@@@Z.c)
