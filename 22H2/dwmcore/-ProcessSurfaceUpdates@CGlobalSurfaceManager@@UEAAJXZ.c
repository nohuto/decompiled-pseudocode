/*
 * XREFs of ?ProcessSurfaceUpdates@CGlobalSurfaceManager@@UEAAJXZ @ 0x18009C570
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
  {
    McTemplateU0qq_EventWriteTransfer(&Microsoft_Windows_Dwm_Core_Provider_Context, "A", v5, v6);
    v15 = Microsoft_Windows_Dwm_CoreEnableBits;
  }
  dword_18034732C += v5;
  if ( v8 < 0 )
