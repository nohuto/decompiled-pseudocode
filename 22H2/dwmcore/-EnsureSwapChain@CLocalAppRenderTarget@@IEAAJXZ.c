/*
 * XREFs of ?EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ @ 0x18018A58C
 * Callers:
 ...
 *     ?SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z @ 0x18018AC2C (-SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z.c)
