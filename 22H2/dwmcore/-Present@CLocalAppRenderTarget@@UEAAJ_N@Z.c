/*
 * XREFs of ?Present@CLocalAppRenderTarget@@UEAAJ_N@Z @ 0x18018A998
 * Callers:
 *     ?Present@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800F52F0 (-Present@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
