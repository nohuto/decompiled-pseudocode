/*
 * XREFs of ??1CAnimationController@@UEAA@XZ @ 0x180022DA4
 * Callers:
 *     ??_GCAnimationController@@UEAAPEAXI@Z @ 0x180022D60 (--_GCAnimationController@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?UnRegisterBatchProcessingCompleteListener@CExpressionManager@@QEAAXPEAVIBatchProcessingCompleteListener@@@Z @ 0x180023664 (-UnRegisterBatchProcessingCompleteListener@CExpressionManager@@QEAAXPEAVIBatchProcessingComplete.c)
 */
