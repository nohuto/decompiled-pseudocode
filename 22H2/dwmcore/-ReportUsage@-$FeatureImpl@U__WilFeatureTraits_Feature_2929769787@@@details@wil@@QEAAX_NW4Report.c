/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_2929769787@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800EFCB0
 * Callers:
...
_UNKNOWN **wil::details::FeatureImpl<__WilFeatureTraits_Feature_2929769787>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v3 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_2929769787>::GetCachedFeatureEnabledState(
                      a1,
                      (signed __int32 *)&v7);
    v7 = v3;
  }
