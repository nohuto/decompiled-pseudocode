/*
 * XREFs of ??0CD3DDevice@@AEAA@W4D3D_FEATURE_LEVEL@@W4_QAI_DRIVERVERSION@@T_LARGE_INTEGER@@@Z @ 0x1800CF0C0
 * Callers:
 ...
 *     ??0CD2DContext@@IEAA@XZ @ 0x1800CF310 (--0CD2DContext@@IEAA@XZ.c)
 */
