/*
 * XREFs of ??$PropertyUpdated@_N@CPropertySet@@AEAAJIIPEB_N@Z @ 0x18001EB1C
 * Callers:
...
__int64 __fastcall CPropertySet::PropertyUpdated<bool>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 v8; // rcx
  unsigned int v9; // ebx
  ...
  if ( (unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId((char *)this + 88) )
  {
    ...
    else
    {
      ...
      CPropertySet::LogValueUpdate<bool>((_DWORD)this, v4, v13, a3, a4);
