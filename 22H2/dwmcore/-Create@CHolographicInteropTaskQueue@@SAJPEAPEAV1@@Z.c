/*
 * XREFs of ?Create@CHolographicInteropTaskQueue@@SAJPEAPEAV1@@Z @ 0x18025A518
 * Callers:
 ...
 *     ??0CHolographicInteropTaskQueue@@AEAA@XZ @ 0x18025A3BC (--0CHolographicInteropTaskQueue@@AEAA@XZ.c)
