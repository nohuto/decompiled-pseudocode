/*
 * XREFs of ?Create@CHolographicInteropTaskQueue@@SAJPEAPEAV1@@Z @ 0x1802AC334
 * Callers:
 ...
 *     ??0CHolographicInteropTaskQueue@@AEAA@XZ @ 0x1802AC1C8 (--0CHolographicInteropTaskQueue@@AEAA@XZ.c)
