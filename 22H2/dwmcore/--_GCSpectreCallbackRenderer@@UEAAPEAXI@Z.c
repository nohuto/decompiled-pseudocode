/*
 * XREFs of ??_GCSpectreCallbackRenderer@@UEAAPEAXI@Z @ 0x18019EB88
 * Callers:
 *     ??_ECSpectreCallbackRenderer@@W7EAAPEAXI@Z @ 0x1800F5C10 (--_ECSpectreCallbackRenderer@@W7EAAPEAXI@Z.c)
 * Callees:
