/*
 * XREFs of ?GdiSpriteBitmapNotifyDirty@CChannel@@UEAAJI_K@Z @ 0x1800D7A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::GdiSpriteBitmapNotifyDirty(CChannel *this, unsigned int a2, __int64 a3)
{
  unsigned int v6; // ebx
