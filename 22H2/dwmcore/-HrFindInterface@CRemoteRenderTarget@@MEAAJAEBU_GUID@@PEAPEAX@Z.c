/*
 * XREFs of ?HrFindInterface@CRemoteRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010A6B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRemoteRenderTarget::HrFindInterface(CRemoteRenderTarget *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v5 )
    {
      v6 = *(_QWORD *)&a2->Data1 - *(_QWORD *)&GUID_3426b083_3cb1_4ffc_9ad5_931f482bb72e.Data1;
      if ( *(_QWORD *)&a2->Data1 == *(_QWORD *)&GUID_3426b083_3cb1_4ffc_9ad5_931f482bb72e.Data1 )
        v6 = *(_QWORD *)a2->Data4 - *(_QWORD *)GUID_3426b083_3cb1_4ffc_9ad5_931f482bb72e.Data4;
      if ( v6 )
