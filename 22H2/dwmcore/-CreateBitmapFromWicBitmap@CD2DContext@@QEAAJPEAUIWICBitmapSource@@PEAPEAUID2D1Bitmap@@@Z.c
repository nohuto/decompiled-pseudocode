/*
 * XREFs of ?CreateBitmapFromWicBitmap@CD2DContext@@QEAAJPEAUIWICBitmapSource@@PEAPEAUID2D1Bitmap@@@Z @ 0x180286538
 * Callers:
        ...
        struct ID2D1Bitmap **a3)
{
  ...
  v6 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_1803B9F60, 0xAu, v4, 0x10Eu, 0LL);
