/*
 * XREFs of ?Compute@COcclusionContext@@IEAAJPEBVCVisualTree@@AEBV?$span@$$CBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@$0?0@gsl@@MAEBV?$span@PEAVCOverlayContext@@$0?0@4@@Z @ 0x180086EC0
 * Callers:
 ...
 *     ?CheckOverlayCandidateCollectionEnabled@COcclusionContext@@AEAAXXZ @ 0x180086A74 (-CheckOverlayCandidateCollectionEnabled@COcclusionContext@@AEAAXXZ.c)
