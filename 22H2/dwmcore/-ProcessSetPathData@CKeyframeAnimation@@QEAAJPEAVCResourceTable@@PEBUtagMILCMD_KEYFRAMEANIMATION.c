/*
 * XREFs of ?ProcessSetPathData@CKeyframeAnimation@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_KEYFRAMEANIMATION_SETPATHDATA@@PEBXI@Z @ 0x1801D1520
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( !*((_DWORD *)a3 + 3)
    ...
    || (v9 = *((unsigned int *)a3 + 3),
        v10 = (__int64 *)(this + 432),
        v11 = *(_QWORD *)(this + 440),
        v8 + ((v11 - *(_QWORD *)(this + 432)) >> 3) > v9)
