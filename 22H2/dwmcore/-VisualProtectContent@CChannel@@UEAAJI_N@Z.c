/*
 * XREFs of ?VisualProtectContent@CChannel@@UEAAJI_N@Z @ 0x1801D1220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::VisualProtectContent(CChannel *this, unsigned int a2, unsigned __int8 a3)
{
  unsigned int v6; // ebx
