/*
 * XREFs of ?PreRender@CDDisplayRenderTarget@@UEAAJXZ @ 0x18018C334
 * Callers:
 *     ?PreRender@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F49D0 (-PreRender@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
