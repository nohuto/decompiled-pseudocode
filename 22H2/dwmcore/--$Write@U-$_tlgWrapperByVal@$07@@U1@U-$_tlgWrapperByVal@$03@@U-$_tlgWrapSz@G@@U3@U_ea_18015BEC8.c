        ...
        __int64 a30)
{
  ...
  v43 = 8LL;
  v41 = 8LL;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180344EB8, a2, 0LL, 0LL, 0x1Cu, &v39);
}
