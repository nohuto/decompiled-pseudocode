/*
 * XREFs of ?TryGetDataForInteraction@CTelemetryComputeScribbleAggregator@@SA_NIPEAUComputeScribbleLatencyData@@_N_K@Z @ 0x1801630EC
 * Callers:
 ...
 * Callees:
 *     ?erase@?$list@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@QEAA?AV?$_List_iterator@V?$_List_val@U?$_List_simple_types@UComputeScribbleLatencyData@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@UComputeScribbleLatencyData@@@std@@@std@@@2@@Z @ 0x180163228 (-erase@-$list@UComputeScribbleLatencyData@@V-$allocator@UComputeScribbleLatencyData@@@std@@@std@.c)
 */
        ...
        __int64 a4)
{
  ...
  v9 = (__int64 *)xmmword_18034B470;
  v10 = 0;
  v11 = *(__int64 **)xmmword_18034B470;
  v12 = *(_QWORD *)xmmword_18034B470;
  if ( a3 )
  {
    while ( v12 != (_QWORD)xmmword_18034B470 )
    {
      if ( a4 == *(_QWORD *)(v12 + 56) )
      {
        v10 = 1;
