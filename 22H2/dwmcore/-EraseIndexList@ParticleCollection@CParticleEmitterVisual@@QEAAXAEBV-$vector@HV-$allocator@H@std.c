/*
 * XREFs of ?EraseIndexList@ParticleCollection@CParticleEmitterVisual@@QEAAXAEBV?$vector@HV?$allocator@H@std@@@std@@@Z @ 0x1802455F4
 * Callers:
 *     ?RemoveDeadParticles@CParticleEmitterVisual@@IEAAXM@Z @ 0x180246074 (-RemoveDeadParticles@CParticleEmitterVisual@@IEAAXM@Z.c)
 * Callees:
 *     ??$EraseIndexList@MV?$allocator@M@std@@@ParticleCollection@CParticleEmitterVisual@@AEAAXAEAV?$vector@MV?$allocator@M@std@@@std@@AEBV?$vector@HV?$allocator@H@std@@@3@@Z @ 0x180241B54 (--$EraseIndexList@MV-$allocator@M@std@@@ParticleCollection@CParticleEmitterVisual@@AEAAXAEAV-$ve.c)
