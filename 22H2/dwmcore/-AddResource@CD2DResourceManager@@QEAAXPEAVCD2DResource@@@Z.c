/*
 * XREFs of ?AddResource@CD2DResourceManager@@QEAAXPEAVCD2DResource@@@Z @ 0x1800EB790
 * Callers:
 ...
 *     ?Initialize@CD2DResource@@MEAAJXZ @ 0x1800EB770 (-Initialize@CD2DResource@@MEAAJXZ.c)
 *     ?Initialize@CSecondaryD2DBitmap@@MEAAJXZ @ 0x1800EDFA0 (-Initialize@CSecondaryD2DBitmap@@MEAAJXZ.c)
 ...
 *     ?AddHwProtectedResource@CD2DContext@@IEAAXXZ @ 0x1802864F8 (-AddHwProtectedResource@CD2DContext@@IEAAXXZ.c)
 */
