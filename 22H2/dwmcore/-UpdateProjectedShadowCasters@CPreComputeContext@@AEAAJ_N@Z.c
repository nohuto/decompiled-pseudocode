/*
 * XREFs of ?UpdateProjectedShadowCasters@CPreComputeContext@@AEAAJ_N@Z @ 0x1800D95C4
 * Callers:
...
__int64 __fastcall CPreComputeContext::UpdateProjectedShadowCasters(const struct CVisualTree **this, char a2)
{
  ...
  __int64 v14; // rbp
  CProjectedShadowCaster **v15; // r14
  ...
  while ( v5 != v6 )
  {
    ...
    if ( CVisualTree::_IsInTree((const struct CVisual **)*this, *v5, 1) )
    {
      ...
      if ( (**((_DWORD **)v8 + 28) & 0x40000) != 0 )
      {
        ...
        v15 = *(CProjectedShadowCaster ***)ProjectedShadowCasters;
