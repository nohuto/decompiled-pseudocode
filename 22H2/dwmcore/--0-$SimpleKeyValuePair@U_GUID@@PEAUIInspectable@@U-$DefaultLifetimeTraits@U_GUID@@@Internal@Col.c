/*
 * XREFs of ??0?$SimpleKeyValuePair@U_GUID@@PEAUIInspectable@@U?$DefaultLifetimeTraits@U_GUID@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUIInspectable@@@4567@$00@Internal@Collections@Foundation@Windows@@QEAA@Upermission@01234@@Z @ 0x180241BD0
 * Callers:
        ...
        __int64 a1)
{
  ...
  v2 = (_QWORD *)(a1 + 16);
  *(_QWORD *)a1 = &Windows::Foundation::Collections::IKeyValuePair<_GUID,IInspectable *>::`vftable';
