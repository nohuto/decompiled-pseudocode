/*
 * XREFs of ?PreSubgraph@CPreComputeContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x18006B570
 * Callers:
 ...
 *     ?GetParent@SubTreeContext@CPreComputeContext@@QEBAPEAVCVisual@@PEAV3@@Z @ 0x18006DA30 (-GetParent@SubTreeContext@CPreComputeContext@@QEBAPEAVCVisual@@PEAV3@@Z.c)
 ...
 *     ?FindData@AllocatedStorage@?$CSparseAlignedStorage@$07$07@@QEBAAEAT?$_Align_type@N$07@std@@I@Z @ 0x1800D80F4 (-FindData@AllocatedStorage@-$CSparseAlignedStorage@$07$07@@QEBAAEAT-$_Align_type@N$07@std@@I@Z.c)
 ...
 *     ?AdjustNodeWorldBounds@CVisual@@QEBA_NPEAV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@_N@Z @ 0x1800DB854 (-AdjustNodeWorldBounds@CVisual@@QEBA_NPEAV-$TMil3DRect@MV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UM.c)
 ...
 *     ?GetTopByReference@?$CWatermarkStack@UD2D_VECTOR_2F@@$01$01$09@@QEBAPEBUD2D_VECTOR_2F@@XZ @ 0x1801008C8 (-GetTopByReference@-$CWatermarkStack@UD2D_VECTOR_2F@@$01$01$09@@QEBAPEBUD2D_VECTOR_2F@@XZ.c)
 ...
 *     ?GetTopByReference@?$CWatermarkStack@W4Enum@MilDepthMode@@$0EA@$01$09@@QEBAPEBW4Enum@MilDepthMode@@XZ @ 0x1801B6354 (-GetTopByReference@-$CWatermarkStack@W4Enum@MilDepthMode@@$0EA@$01$09@@QEBAPEBW4Enum@MilDepthMod.c)
...
LABEL_139:
      ...
      {
        v370 = DwmDbg::DbgString::DbgString((DwmDbg::DbgString *)&v399, word_18033C020);
