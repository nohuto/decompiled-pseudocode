/*
 * XREFs of ?SetInteraction@CVisual@@IEAAJPEAVCInteraction@@@Z @ 0x1800E8904
 * Callers:
    ...
    if ( a2 )
    {
      ...
      if ( v7 )
      {
        ...
        if ( v11 )
        {
          ...
          if ( v12 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0xDB0u, 0LL);
            return v4;
          }
        }
      }
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0xDB4u, 0LL);
        return v4;
      }
