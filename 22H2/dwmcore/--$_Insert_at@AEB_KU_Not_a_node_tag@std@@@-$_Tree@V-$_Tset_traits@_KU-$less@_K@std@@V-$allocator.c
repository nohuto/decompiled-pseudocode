/*
 * XREFs of ??$_Insert_at@AEB_KU_Not_a_node_tag@std@@@?$_Tree@V?$_Tset_traits@_KU?$less@_K@std@@V?$allocator@_K@2@$0A@@std@@@std@@IEAA?AV?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@_K@std@@@std@@@1@_NPEAU?$_Tree_node@_KPEAX@1@AEB_KU_Not_a_node_tag@1@@Z @ 0x18004FF74
 * Callers:
 *     _lambda_5fcd38f73916aa9cc2ab190da74b00ea_::operator() @ 0x180034690 (_lambda_5fcd38f73916aa9cc2ab190da74b00ea_--operator().c)
 * Callees:
 ...
 *     ?_Lrotate@?$_Tree_val@U?$_Tree_simple_types@_K@std@@@std@@QEAAXPEAU?$_Tree_node@_KPEAX@2@@Z @ 0x1800D1F28 (-_Lrotate@-$_Tree_val@U-$_Tree_simple_types@_K@std@@@std@@QEAAXPEAU-$_Tree_node@_KPEAX@2@@Z.c)
