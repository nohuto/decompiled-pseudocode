/*
 * XREFs of ?RemoveLogicalSurfaceEntry@CLogicalSurfaceHandleMap@@QEAAXPEBVCGdiSpriteBitmap@@PEAX@Z @ 0x1800D1C10
 * Callers:
 *     ??1CRedirectedGDISurface@@MEAA@XZ @ 0x1800D1A64 (--1CRedirectedGDISurface@@MEAA@XZ.c)
 * Callees:
 *     <none>
 */
