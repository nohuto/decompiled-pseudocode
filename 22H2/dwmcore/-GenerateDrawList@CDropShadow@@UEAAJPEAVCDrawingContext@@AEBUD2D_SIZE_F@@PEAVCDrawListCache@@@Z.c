/*
 * XREFs of ?GenerateDrawList@CDropShadow@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x180229C30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CDrawListCache *a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v16, &dword_1803B8478, 3u, ShadowOpacityBrush, 0x163u, 0LL);
    if ( v44 )
  ...
  *(_QWORD *)&v45.left = &v44;
  ...
  if ( ShadowOpacityBrush < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v34, &dword_1803B8478, 3u, ShadowOpacityBrush, 0x186u, 0LL);
LABEL_40:
    if ( v44 )
  ...
  *(_QWORD *)&v45.left = v44;
  ...
  if ( ShadowOpacityBrush < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v37, &dword_1803B8478, 3u, ShadowOpacityBrush, 0x18Eu, 0LL);
    goto LABEL_40;
  }
...
LABEL_36:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v41, &dword_1803B8478, 3u, DrawList, 0x1A2u, 0LL);
  CDrawListEntryBuilder::~CDrawListEntryBuilder((CDrawListEntryBuilder *)v61);
LABEL_45:
