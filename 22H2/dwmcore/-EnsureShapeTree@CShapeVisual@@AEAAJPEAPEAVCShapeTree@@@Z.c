/*
 * XREFs of ?EnsureShapeTree@CShapeVisual@@AEAAJPEAPEAVCShapeTree@@@Z @ 0x1801EC4D0
 * Callers:
 ...
 *     ??0CShapeTree@@QEAA@PEAVCComposition@@@Z @ 0x1801EC41C (--0CShapeTree@@QEAA@PEAVCComposition@@@Z.c)
 */
