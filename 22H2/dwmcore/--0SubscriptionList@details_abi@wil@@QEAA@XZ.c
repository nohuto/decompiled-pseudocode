/*
 * XREFs of ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x1800AED54
 * Callers:
 ...
 *     ??0FeatureStateManager@details@wil@@QEAA@XZ @ 0x1800AECB4 (--0FeatureStateManager@details@wil@@QEAA@XZ.c)
 * Callees:
 *     <none>
 */
