/*
 * XREFs of ?Create@CColorKeyBitmap@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV1@@Z @ 0x1802B6C30
 * Callers:
 ...
 *     ??0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z @ 0x1802B6710 (--0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z.c)
