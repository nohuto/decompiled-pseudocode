/*
 * XREFs of GetLPCreateDCompositionDirectInkFactoryPartner @ 0x18024CFEC
 * Callers:
...
__int64 __fastcall GetLPCreateDCompositionDirectInkFactoryPartner(FARPROC *a1)
{
  ...
  v1 = dword_18034BD70;
  if ( dword_18034BD70 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0, dword_18034BD70, 0x18u, 0LL);
    goto LABEL_13;
  }
  ProcAddress = (FARPROC)qword_18034BD68;
  if ( qword_18034BD68 )
    goto LABEL_11;
  SetLastError(0);
  ...
  if ( LibraryW )
  {
    ...
    qword_18034BD68 = (__int64)ProcAddress;
    if ( !ProcAddress )
    {
      v1 = -2147467261;
