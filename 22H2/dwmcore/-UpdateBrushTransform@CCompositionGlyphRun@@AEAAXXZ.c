/*
 * XREFs of ?UpdateBrushTransform@CCompositionGlyphRun@@AEAAXXZ @ 0x1801B9C60
 * Callers:
 *     ?NotifyOnChanged@CCompositionGlyphRun@@UEAAXW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1801B9C20 (-NotifyOnChanged@CCompositionGlyphRun@@UEAAXW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
 * Callees:
      ...
      if ( *(_QWORD *)(v6 + 104) )
      {
        ...
        *(float *)&v14[5] = 0.0 - (float)(v9 * 0.0);
        ...
        D2D1::Matrix3x2F::SetProduct(
          ...
          (const struct D2D1::Matrix3x2F *)&v15);
        ((void (__fastcall *)(_QWORD, void *, _DWORD *))xmmword_1803441D8)(
          *(_QWORD *)(v13 + 104) + SDWORD2(xmmword_1803441D8),
