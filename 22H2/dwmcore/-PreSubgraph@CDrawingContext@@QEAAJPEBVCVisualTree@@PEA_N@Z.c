/*
 * XREFs of ?PreSubgraph@CDrawingContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x180067A20
 * Callers:
 ...
 *     ?NotifyWindowBackgroundTreatmentCacheHitOrMiss@FRAME_TIME_INFO@@QEBAX_N@Z @ 0x18001AFCC (-NotifyWindowBackgroundTreatmentCacheHitOrMiss@FRAME_TIME_INFO@@QEBAX_N@Z.c)
 ...
 *     ??0?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@QEAA@XZ @ 0x18003A25C (--0-$TMil3DRect@MV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniquen.c)
 ...
 *     ?GetBounds@CVisualTree@@QEBAAEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@XZ @ 0x1800876C8 (-GetBounds@CVisualTree@@QEBAAEBV-$TMil3DRect@MV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAnd.c)
 ...
 *     ?ULongLongToUInt@@YAJ_KPEAI@Z @ 0x1800DF5F0 (-ULongLongToUInt@@YAJ_KPEAI@Z.c)
 *     ??Y?$checked_array_iterator@PEAUClippingScopeState@CScopedClipStack@@@stdext@@QEAAAEAV01@_J@Z @ 0x1800E2DF0 (--Y-$checked_array_iterator@PEAUClippingScopeState@CScopedClipStack@@@stdext@@QEAAAEAV01@_J@Z.c)
 ...
 *     ?SetWorldTransform@CWindowBackgroundTreatment@@QEAAXAEBVCMILMatrix@@W4WalkReason@@@Z @ 0x1800E35EC (-SetWorldTransform@CWindowBackgroundTreatment@@QEAAXAEBVCMILMatrix@@W4WalkReason@@@Z.c)
 *     ??0DbgString@DwmDbg@@QEAA@AEBUMilRectF@@@Z @ 0x1800E5248 (--0DbgString@DwmDbg@@QEAA@AEBUMilRectF@@@Z.c)
 *     ??8CBackdropVisualImageKey@@QEBA_NAEBV0@@Z @ 0x1800E99C8 (--8CBackdropVisualImageKey@@QEBA_NAEBV0@@Z.c)
 *     ?HasValidBounds@CWindowBackgroundTreatment@@QEBA_NXZ @ 0x1800EC6C8 (-HasValidBounds@CWindowBackgroundTreatment@@QEBA_NXZ.c)
 ...
 *     ?GetHeatMapProperties@CVisual@@QEBA?AUHeatMapProperty@1@XZ @ 0x1801D5E24 (-GetHeatMapProperties@CVisual@@QEBA-AUHeatMapProperty@1@XZ.c)
 ...
 *     ?GetTopByReference@?$CWatermarkStack@UStackBackfaceVisibilityEntry@CDrawingContext@@$0EA@$01$09@@QEBAPEBUStackBackfaceVisibilityEntry@CDrawingContext@@XZ @ 0x1801D5EF4 (-GetTopByReference@-$CWatermarkStack@UStackBackfaceVisibilityEntry@CDrawingContext@@$0EA@$01$09@.c)
...
LABEL_71:
  ...
  if ( v62 )
  {
    ...
    *((_QWORD *)&v460 + 1) = 0LL;
    ...
    if ( ShapeData < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v130, 0LL, 0, ShapeData, 0x95Cu, 0LL);
LABEL_548:
      v136 = v454;
      if ( v131 == -2003304438 )
      {
...
LABEL_550:
      ...
      if ( v131 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v136, 0LL, 0, v131, 0x1645u, 0LL);
        goto LABEL_146;
      }
      goto LABEL_74;
    }
...
LABEL_628:
        MilInstrumentationCheckHR_MaybeFailFast(v130, 0LL, 0, v133, 0x95Du, 0LL);
        goto LABEL_548;
      }
      v132 = v454;
    }
...
LABEL_785:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v188, 0LL, 0, v186, 0xC17u, 0LL);
      v301 = v186;
      LODWORD(Size) = v186;
LABEL_787:
      MilInstrumentationCheckHR_MaybeFailFast(v301, 0LL, 0, v186, 0x16A0u, 0LL);
      goto LABEL_146;
    }
...
LABEL_521:
  MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v78, 0LL, 0, v177, 0x109Au, 0LL);
  MilInstrumentationCheckHR_MaybeFailFast(v300, 0LL, 0, v177, 0xC09u, 0LL);
  v158 = (unsigned __int64)v6 + 368;
  v186 = v442;
  LODWORD(Size) = v442;
  if ( v442 < 0 )
...
LABEL_524:
  ...
  if ( v304 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v306, 0LL, 0, v304, 0xBC9u, 0LL);
    goto LABEL_784;
  }
...
LABEL_534:
  ...
  if ( v304 < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v415, 0LL, 0, v442, 0xBCEu, 0LL);
    CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop(v158, 0LL, v416);
    v308 = v304;
    v442 = v304;
LABEL_784:
    LODWORD(Size) = v308;
    MilInstrumentationCheckHR_MaybeFailFast(v417, 0LL, 0, v304, 0x16A6u, 0LL);
    goto LABEL_146;
  }
...
LABEL_107:
  ...
  if ( v123 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v124, 0LL, 0, v123, 0xB06u, 0LL);
    LODWORD(Size) = v126;
    MilInstrumentationCheckHR_MaybeFailFast(v414, 0LL, 0, v126, 0x16BBu, 0LL);
    goto LABEL_146;
  }
  *(_OWORD *)v495 = v507;
...
LABEL_274:
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v159, 0LL, 0, v158, 0xC17u, 0LL);
      LODWORD(Size) = v158;
      goto LABEL_731;
    }
    v162 = 1LL;
...
LABEL_568:
                ...
                MilInstrumentationCheckHR_MaybeFailFast(v405, 0LL, 0, v442, 0xBCEu, 0LL);
                CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop(v79, 0LL, v406);
                v323 = v320;
                v442 = v320;
LABEL_748:
                LODWORD(Size) = v323;
                MilInstrumentationCheckHR_MaybeFailFast(v407, 0LL, 0, v320, 0x16EEu, 0LL);
                goto LABEL_146;
              }
              v438 = 109;
            }
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v321, 0LL, 0, v320, 0xBC9u, 0LL);
          goto LABEL_748;
        }
LABEL_722:
        v166 = v162;
...
LABEL_555:
  MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v78, 0LL, 0, v148, 0x109Au, 0LL);
  MilInstrumentationCheckHR_MaybeFailFast(v316, 0LL, 0, v148, 0xC09u, 0LL);
  v79 = (unsigned int *)((char *)v6 + 368);
  LODWORD(v158) = v442;
  LODWORD(Size) = v442;
  if ( v442 >= 0 )
...
LABEL_731:
  MilInstrumentationCheckHR_MaybeFailFast(v317, 0LL, 0, v158, 0x16E8u, 0LL);
LABEL_146:
  v94 = v448;
LABEL_147:
  if ( *((_BYTE *)v6 + 8172) )
