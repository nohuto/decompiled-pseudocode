/*
 * XREFs of ?RetireFrame@CPartitionVerticalBlankScheduler@@AEAAJPEAVCFrameInfo@@IPEA_N_N@Z @ 0x18006CE20
 * Callers:
...
LABEL_6:
  ...
  if ( *((_BYTE *)a2 + 142) || a5 )
  {
    ...
    *((_QWORD *)a2 + 11) = v15;
    ...
    v24 = 0;
    v25 = _InterlockedExchange64(&qword_180347408, 0LL);
    dword_18034727C += v25;
    dword_180347280 += HIDWORD(v25);
    if ( *((_DWORD *)a2 + 50) )
    {
      do
      {
