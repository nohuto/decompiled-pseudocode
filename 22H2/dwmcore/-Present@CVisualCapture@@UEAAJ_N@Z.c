/*
 * XREFs of ?Present@CVisualCapture@@UEAAJ_N@Z @ 0x1801F1F00
 * Callers:
 *     ?Present@CVisualCapture@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800F63E0 (-Present@CVisualCapture@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
