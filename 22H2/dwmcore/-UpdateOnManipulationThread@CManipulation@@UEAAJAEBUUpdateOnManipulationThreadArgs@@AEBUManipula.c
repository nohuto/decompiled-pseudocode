/*
 * XREFs of ?UpdateOnManipulationThread@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadArgs@@AEBUManipulationThreadTelemetryData@@PEAVIDCompositionInteractionStats@@@Z @ 0x18020E9A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _anonymous_namespace_::StoreIfChanged_float_ @ 0x18020CFF8 (_anonymous_namespace_--StoreIfChanged_float_.c)
 *     _anonymous_namespace_::StoreIfChanged_D2DVector3_ @ 0x18020D014 (_anonymous_namespace_--StoreIfChanged_D2DVector3_.c)
