/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_dwmcore_DXGIFactoryLeak@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18011A5D0
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_dwmcore_DXGIFactoryLeak>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_dwmcore_DXGIFactoryLeak>::GetCurrentFeatureEnabledState(
      a1,
      &v14,
      &i);
    v6 = *a2;
