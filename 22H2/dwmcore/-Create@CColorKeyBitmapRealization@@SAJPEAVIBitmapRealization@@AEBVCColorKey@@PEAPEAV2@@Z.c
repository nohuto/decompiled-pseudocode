/*
 * XREFs of ?Create@CColorKeyBitmapRealization@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV2@@Z @ 0x180262344
 * Callers:
 ...
 *     ??0CColorKeyBitmapRealization@@QEAA@XZ @ 0x1802621D0 (--0CColorKeyBitmapRealization@@QEAA@XZ.c)
