/*
 * XREFs of ?_Reallocate_exactly@?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@AEAAX_K@Z @ 0x1800EE2F0
 * Callers:
 ...
 *     ?allocate@?$allocator@UtagRECT@@@std@@QEAAPEAUtagRECT@@_K@Z @ 0x180173B70 (-allocate@-$allocator@UtagRECT@@@std@@QEAAPEAUtagRECT@@_K@Z.c)
 */
