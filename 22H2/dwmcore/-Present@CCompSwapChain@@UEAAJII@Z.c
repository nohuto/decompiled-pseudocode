/*
 * XREFs of ?Present@CCompSwapChain@@UEAAJII@Z @ 0x180251460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompSwapChain::Present(CCompSwapChain *this, unsigned int a2, unsigned int a3)
{
  ...
  if ( !v7 )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_180306928, 2u, v8, 0x13Du, 0LL);
      goto LABEL_20;
    }
    if ( **((_DWORD **)this + 13) )
    {
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_180306928, 2u, v17, 0x14Cu, 0LL);
  }
  else if ( !v7 )
  {
    if ( *((_DWORD *)this + 25) == 3 )
