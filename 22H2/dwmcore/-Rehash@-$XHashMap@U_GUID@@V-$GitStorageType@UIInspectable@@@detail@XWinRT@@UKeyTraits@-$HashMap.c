        ...
        unsigned int a2)
{
  ...
  if ( *(_QWORD *)(a1 + 8) )
  {
    v5 = DefaultHeap::Alloc(saturated_mul(v2, 8uLL));
    v6 = v5;
    if ( !v5 )
      return 2147942414LL;
    if ( v2 > 0x1FFFFFFF )
