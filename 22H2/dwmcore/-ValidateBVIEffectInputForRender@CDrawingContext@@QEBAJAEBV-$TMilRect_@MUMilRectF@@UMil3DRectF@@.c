/*
 * XREFs of ?ValidateBVIEffectInputForRender@CDrawingContext@@QEBAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEA_N@Z @ 0x18008850C
 * Callers:
 ...
 *     ??8Matrix3x3@@QEBA_NAEBV0@@Z @ 0x1800DEA98 (--8Matrix3x3@@QEBA_NAEBV0@@Z.c)
...
__int64 __fastcall CDrawingContext::ValidateBVIEffectInputForRender(__int64 a1, struct MilRectF *a2, bool *a3)
{
  ...
  if ( *(_QWORD *)(a1 + 200) && BackdropVisualImage && CBackdropVisualImage::CanUseAsEffectInput(BackdropVisualImage) )
  {
    ...
    v45 = (void **)DwmDbg::DbgString::DbgString((DwmDbg::DbgString *)&lpMem, word_18033C020);
