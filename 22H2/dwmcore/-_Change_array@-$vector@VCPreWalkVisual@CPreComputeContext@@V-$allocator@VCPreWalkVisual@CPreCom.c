/*
 * XREFs of ?_Change_array@?$vector@VCPreWalkVisual@CPreComputeContext@@V?$allocator@VCPreWalkVisual@CPreComputeContext@@@std@@@std@@AEAAXQEAVCPreWalkVisual@CPreComputeContext@@_K1@Z @ 0x18000BD9C
 * Callers:
