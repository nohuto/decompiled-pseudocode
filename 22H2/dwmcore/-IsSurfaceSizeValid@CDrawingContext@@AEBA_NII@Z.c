/*
 * XREFs of ?IsSurfaceSizeValid@CDrawingContext@@AEBA_NII@Z @ 0x18000EEB0
 * Callers:
 ...
 * Callees:
 *     ?GetMaxTextureSize@CDrawingContext@@QEBAI_N@Z @ 0x18000EEDC (-GetMaxTextureSize@CDrawingContext@@QEBAI_N@Z.c)
 */
