/*
 * XREFs of ??_ECParticleVector2Behavior@@UEAAPEAXI@Z @ 0x1801C3680
 * Callers:
 *     ??_ECParticleVector2Behavior@@WHA@EAAPEAXI@Z @ 0x18011BD20 (--_ECParticleVector2Behavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
