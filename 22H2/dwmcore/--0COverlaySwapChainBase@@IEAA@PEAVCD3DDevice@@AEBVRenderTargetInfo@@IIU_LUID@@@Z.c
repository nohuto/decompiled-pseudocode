/*
 * XREFs of ??0COverlaySwapChainBase@@IEAA@PEAVCD3DDevice@@AEBVRenderTargetInfo@@IIU_LUID@@@Z @ 0x1800CAF5C
 * Callers:
 ...
 *     ??0IOverlaySwapChain@@QEAA@XZ @ 0x1800CB3A8 (--0IOverlaySwapChain@@QEAA@XZ.c)
 */
