/*
 * XREFs of ?CheckForMajorityScreenVideoNotifications@CLegacyRenderTarget@@AEAAXXZ @ 0x18008C39C
 * Callers:
...
LABEL_11:
  ...
  if ( !*((_QWORD *)this + 2335) )
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180356B50, 2u, v16, 0x6Fu, 0LL);
      return;
    }
  }
  ...
  if ( !*((_QWORD *)this + 2336) )
  {
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_180356B50, 2u, v18, 0x75u, 0LL);
      return;
    }
  }
  if ( !v11 )
