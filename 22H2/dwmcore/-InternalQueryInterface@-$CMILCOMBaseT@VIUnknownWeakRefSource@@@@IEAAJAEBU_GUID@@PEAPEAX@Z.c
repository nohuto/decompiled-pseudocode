/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIUnknownWeakRefSource@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801035EC
 * Callers:
 ...
 *     ?QueryInterface@?$CMILCOMBaseT@VIUnknownWeakRefSource@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18028BBA0 (-QueryInterface@-$CMILCOMBaseT@VIUnknownWeakRefSource@@@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
