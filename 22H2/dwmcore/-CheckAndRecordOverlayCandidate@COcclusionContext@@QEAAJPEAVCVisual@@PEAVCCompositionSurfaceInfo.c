/*
 * XREFs of ?CheckAndRecordOverlayCandidate@COcclusionContext@@QEAAJPEAVCVisual@@PEAVCCompositionSurfaceInfo@@PEBVCMILMatrix@@PEBVCShape@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@@Z @ 0x180068964
 * Callers:
        ...
        int a6)
{
  ...
  if ( v9 )
  {
      ...
      && (v16 = *(_QWORD **)(a1 + 1576), v17 = &v16[*(_QWORD *)(a1 + 1568)], v16 != v17) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x704u, 0LL);
