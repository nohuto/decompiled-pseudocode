/*
 * XREFs of ??_GCParticleVector4Behavior@@UEAAPEAXI@Z @ 0x18016D590
 * Callers:
 *     ??_ECParticleVector4Behavior@@WGI@EAAPEAXI@Z @ 0x1800F41E0 (--_ECParticleVector4Behavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
