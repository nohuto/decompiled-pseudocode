/*
 * XREFs of ?ProcessTransformParentStack@CTransformParentPreComputeHelper@@EEAAJPEBVCVisualTree@@_K_N@Z @ 0x180022010
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
      if ( !UnusedTreeData )
      {
        ...
        else
        {
          ...
          {
            v15 = -2147024882;
            MilInstrumentationCheckHR_MaybeFailFast(v48, 0LL, 0, -2147024882, 0x135Bu, 0LL);
