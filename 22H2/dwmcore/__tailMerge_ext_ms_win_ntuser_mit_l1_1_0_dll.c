/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_mit_l1_1_0_dll @ 0x1800E8FDE
 * Callers:
 *     __imp_load_MITGetCursorUpdateHandle @ 0x1800E8FD2 (__imp_load_MITGetCursorUpdateHandle.c)
 * Callees:
