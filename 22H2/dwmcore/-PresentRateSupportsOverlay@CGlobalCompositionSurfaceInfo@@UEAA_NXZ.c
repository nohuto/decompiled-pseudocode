/*
 * XREFs of ?PresentRateSupportsOverlay@CGlobalCompositionSurfaceInfo@@UEAA_NXZ @ 0x1800F0BD0
 * Callers:
 *     <none>
 * Callees:
 *     ?CalcCurrentPresentCount@CPresentRate@@IEBAIPEBVCGlobalCompositionSurfaceInfo@@@Z @ 0x18020CD7C (-CalcCurrentPresentCount@CPresentRate@@IEBAIPEBVCGlobalCompositionSurfaceInfo@@@Z.c)
 *     ?IsSufficientIntervalForStats@CPresentRate@@IEBA_N_N@Z @ 0x18020CE48 (-IsSufficientIntervalForStats@CPresentRate@@IEBA_N_N@Z.c)
 *     ?IsSufficientPresentCount@CPresentRate@@IEAA_NI_N@Z @ 0x18020CF40 (-IsSufficientPresentCount@CPresentRate@@IEAA_NI_N@Z.c)
 */
