/*
 * XREFs of ?GetValueAt@?$LinearKeyframeAnimation@Ufloat4@Numerics@Foundation@Windows@@@Particles@@QEBA?AUfloat4@Numerics@Foundation@Windows@@MAEBV?$span@M$0?0@gsl@@AEAV78@@Z @ 0x1801DBB4C
 * Callers:
 ...
 * Callees:
 *     ?FindFirstFrameIndex@?$LinearKeyframeAnimation@Ufloat4@Numerics@Foundation@Windows@@@Particles@@IEBAIM@Z @ 0x1801DB75C (-FindFirstFrameIndex@-$LinearKeyframeAnimation@Ufloat4@Numerics@Foundation@Windows@@@Particles@@.c)
 */
