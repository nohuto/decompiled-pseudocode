/*
 * XREFs of ?PreRender@CComposition@@IEAAJXZ @ 0x18004F2D0
 * Callers:
 *     ?ProcessComposition@CComposition@@IEAAXPEA_N@Z @ 0x18004F0DC (-ProcessComposition@CComposition@@IEAAXPEA_N@Z.c)
 * Callees:
 *     ?RemoveResourceNotifier@CD3DResource@@UEAAXPEBVIDeviceResourceNotify@@@Z @ 0x1800293B0 (-RemoveResourceNotifier@CD3DResource@@UEAAXPEBVIDeviceResourceNotify@@@Z.c)
...
__int64 __fastcall CComposition::PreRender(RTL_SRWLOCK *this)
{
  ...
  if ( v3 < 0 )
  {
    v96 = 3214;
LABEL_162:
    MilInstrumentationCheckHR_MaybeFailFast(v4, &dword_1803566F0, 3u, v3, v96, 0LL);
    goto LABEL_55;
  }
  v6 = *((_QWORD *)v2 + 53);
  ...
  if ( v13 < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v74, &dword_1803566F0, 3u, v5, 0xC9Eu, 0LL);
    goto LABEL_55;
  }
  v15 = 0LL;
  v112[0] = 0LL;
  if ( ::CycleTime )
  {
    ...
    v15 = v112[0];
    if ( ThreadCycleTime )
      qword_1803E5A58 += v112[0] - ::CycleTime;
  }
  ::CycleTime = v15;
  ...
  v5 = v18;
  if ( v18 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v20, &dword_1803566F0, 3u, v18, 0xCACu, 0LL);
...
LABEL_34:
  ...
  if ( ::CycleTime )
  {
    ...
    v37 = v112[0];
    if ( v39 )
      qword_1803E5A60 += v112[0] - ::CycleTime;
  }
  ::CycleTime = v37;
  ...
  v46 = v44;
  if ( v44 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v45, &dword_1803566F0, 3u, v44, 0xCD6u, 0LL);
  if ( !v5 || v5 >= 0 && v46 < 0 )
    v5 = v46;
  v1 = (RTL_SRWLOCK *)((char *)v2 + 672);
LABEL_55:
  ...
  if ( *((_BYTE *)v2 + 1280) )
  {
    ...
    v72 = v71;
    if ( v71 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v45, &dword_1803566F0, 3u, v71, 0xCF5u, 0LL);
    if ( !v5 || v5 >= 0 && v72 < 0 )
      v5 = v72;
  }
