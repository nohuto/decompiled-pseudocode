/*
 * XREFs of ?PreRender@CComposition@@IEAAJXZ @ 0x180072020
 * Callers:
 ...
 *     ??$emplace@AEBQEAVCRenderTarget@@@?$vector@PEAVCRenderTarget@@V?$allocator@PEAVCRenderTarget@@@std@@@std@@QEAA?AV?$_Vector_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCRenderTarget@@@std@@@std@@@1@V?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@PEAVCRenderTarget@@@std@@@std@@@1@AEBQEAVCRenderTarget@@@Z @ 0x180163710 (--$emplace@AEBQEAVCRenderTarget@@@-$vector@PEAVCRenderTarget@@V-$allocator@PEAVCRenderTarget@@@s.c)
...
__int64 __fastcall CComposition::PreRender(RTL_SRWLOCK *this)
{
  ...
  *(_OWORD *)((char *)v169 + 12) = *(_OWORD *)&v2[144].Ptr;
  ...
  v2[44].Ptr = v150;
  if ( DWORD1(v169[1]) )
    dword_1803472A0 |= 0x40u;
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v11, &dword_1802DB4C8, 3u, v10, 0xCB6u, 0LL);
    goto LABEL_161;
  }
  ...
  {
LABEL_216:
    MilInstrumentationCheckHR_MaybeFailFast(v18, &dword_1802DB4C8, 3u, v10, 0xCB9u, 0LL);
    goto LABEL_161;
  }
  if ( v19 < 0 )
LABEL_31:
  ...
  if ( ::CycleTime )
  {
    ...
    v23 = CycleTime;
    if ( v25 )
      qword_1803472E0 += CycleTime - ::CycleTime;
  }
  ...
  v143 = 0;
  v144 = 0;
  wil::details::ReportUsageToService(&unk_18034B838, 13330426LL, (v26 >> 10) & 1, (v26 >> 11) & 1, &v143, 0, 3);
  if ( LOBYTE(v2[36].Ptr) )
  {
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v29, &dword_1802DB4C8, 3u, v10, 0xCC9u, 0LL);
  }
  else
  {
    v31 = 0LL;
    ...
    if ( ::CycleTime )
    {
      ...
      v31 = v151;
      if ( v33 )
        qword_1803472E8 += v151 - ::CycleTime;
    }
    ::CycleTime = v31;
    v34 = 0LL;
    v35 = (char *)v2[11].Ptr;
    ...
    *((_QWORD *)v35 + 8) = v51;
    ...
    if ( v143 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v40, &dword_1802DB4C8, 3u, v143, 0xCCEu, 0LL);
    }
    else
    {
      if ( (v55 & 2) != 0 )
      ...
      v61 = (_BYTE *)qword_18034B618;
      if ( qword_18034B618 != (_QWORD)xmmword_18034B620 )
      {
        v62 = (_BYTE *)xmmword_18034B620;
        do
        {
          v63 = 0;
          ...
          if ( qword_18034B618 != (_QWORD)xmmword_18034B620 )
          {
            while ( 1 )
            {
              ...
              if ( __PAIR64__(HIDWORD(v148), (unsigned int)v64) == *(_QWORD *)(*(_QWORD *)v65 + 936LL) )
                break;
              v65 += 16LL;
              if ( v65 == (_QWORD)xmmword_18034B620 )
                goto LABEL_113;
            }
            if ( !*(_BYTE *)(v66 + 500) && !byte_18034B630 && *(_DWORD *)(v66 + 496) )
              v63 = 1;
          }
LABEL_113:
      ...
      if ( !v84[132] || v84[133] )
      {
        ...
        if ( ::CycleTime )
        {
          ...
          v103 = v152;
          if ( v105 )
            qword_1803472F0 += v152 - ::CycleTime;
        }
        ::CycleTime = v103;
        v106 = v2[19].Ptr;
        v107 = v106[3];
        ...
        *(_QWORD *)v154 = 0LL;
        if ( ::CycleTime )
        {
          ...
          v125 = *(_QWORD *)v154;
          if ( ThreadCycleTime )
            qword_1803472F8 += *(_QWORD *)v154 - ::CycleTime;
        }
        ::CycleTime = v125;
        if ( v10 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v125, &dword_1802DB4C8, 3u, v10, 0xCF4u, 0LL);
      }
      else
      {
