/*
 * XREFs of ?CreateRenderingEffect@CCommonRenderingEffectFactory@@UEAAJV?$span@PEBVCDrawListBrush@@$0?0@gsl@@PEAPEAVCRenderingEffect@@@Z @ 0x1800547E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CDrawListBitmap@@QEAA@XZ @ 0x180057F90 (--0CDrawListBitmap@@QEAA@XZ.c)
 ...
 *     ??0SamplerMode@@QEAA@XZ @ 0x1800E26C0 (--0SamplerMode@@QEAA@XZ.c)
...
__int64 __fastcall CCommonRenderingEffectFactory::CreateRenderingEffect(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  char v85[16]; // [rsp+138h] [rbp+38h] BYREF
  ...
  if ( v10 || (v10 = (char *)DefaultHeap::Alloc(0x78uLL)) != 0LL )
  {
    ...
    *((_QWORD *)v10 + 3) = v29;
    if ( v29 )
    {
      v31 = (__int64)v29 + *(int *)(v29[1] + 4LL) + 8;
    ...
    *(_WORD *)(v10 + 115) = *v42;
    ...
    v43 = !v28 && !v29
       ...
       && !*(_DWORD *)(CDrawListBitmap::GetPixelFormatInfo(v65, v85) + 8);
    v10[118] = v43;
    if ( !*(_QWORD *)v35 && !*((_QWORD *)v35 + 1) || (v44 = IsWhitePixelOptimizationCandidate(v35, 1LL)) != 0 )
      v44 = 1;
    v10[118] &= v44;
  ...
  if ( (v5 & 1) != 0 )
  {
    ...
    wil::com_ptr_t<ID2DBitmap,wil::err_returncode_policy>::~com_ptr_t<ID2DBitmap,wil::err_returncode_policy>(v83);
  }
  if ( v10 )
  {
    *v4 = v10;
  ...
  {
    v3 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v42, 0LL, 0, -2147024882, 0x31u, 0LL);
  }
  return v3;
}
