/*
 * XREFs of ??$AddOrUpdateProperty@UD2DVector4@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DVector4@@@Z @ 0x18001C4A4
 * Callers:
...
__int64 __fastcall CPropertySet::AddOrUpdateProperty<D2DVector4>(CResource *a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_BYTE *)(a2 + 20) )
  {
    updated = CPropertySet::AddProperty<D2DVector4>(a1, *(_DWORD *)(a2 + 8), a3);
    v5 = updated;
    if ( updated < 0 )
    {
      v10 = 326;
LABEL_10:
  ...
  {
    updated = CPropertySet::UpdateProperty<D2DVector4>(v7);
    v5 = updated;
    if ( updated < 0 )
    {
      v10 = 336;
