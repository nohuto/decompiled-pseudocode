/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCD3DDevice@@@?$vector@PEAVCD3DDevice@@V?$allocator@PEAVCD3DDevice@@@std@@@std@@QEAAPEAPEAVCD3DDevice@@QEAPEAV2@AEBQEAV2@@Z @ 0x180285CD4
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCD3DDevice@@V?$allocator@PEAVCD3DDevice@@@std@@@std@@AEAAXQEAPEAVCD3DDevice@@_K1@Z @ 0x1802860F4 (-_Change_array@-$vector@PEAVCD3DDevice@@V-$allocator@PEAVCD3DDevice@@@std@@@std@@AEAAXQEAPEAVCD3.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<CD3DDevice *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
