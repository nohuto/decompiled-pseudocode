/*
 * XREFs of ?DumpBitmapRealization@CDebugTreeDumper@@AEAAJPEAVIBitmapRealization@@PEAX@Z @ 0x18019769C
 * Callers:
 *     ?Dump@CDebugTreeDumper@@QEAAXPEAVIBitmapRealization@@@Z @ 0x1801975FC (-Dump@CDebugTreeDumper@@QEAAXPEAVIBitmapRealization@@@Z.c)
 * Callees:
 ...
 *     ??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@QEBD$$QEAV10@@Z @ 0x18019618C (--$-HDU-$char_traits@D@std@@V-$allocator@D@1@@std@@YA-AV-$basic_string@DU-$char_traits@D@std@@V-.c)
 ...
 *     ??$_UIntegral_to_buff@DI@std@@YAPEADPEADI@Z @ 0x180197340 (--$_UIntegral_to_buff@DI@std@@YAPEADPEADI@Z.c)
      ...
      if ( v12 >= 0 )
      {
        ...
        if ( v14 < 0 )
        {
          ...
          *v18 = 45;
          ...
          v19 = std::operator+<char>((__int64)v24, (__int64)"Failed to save texture with error: ", v25);
