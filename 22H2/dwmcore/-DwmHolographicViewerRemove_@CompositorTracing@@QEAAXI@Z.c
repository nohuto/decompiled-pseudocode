/*
 * XREFs of ?DwmHolographicViewerRemove_@CompositorTracing@@QEAAXI@Z @ 0x1802A5368
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicViewerRemove_(CompositorTracing *this, int a2)
{
  ...
  if ( *v3 > 4u )
  {
    if ( tlgKeywordOn((__int64)v3, 0x400000000000LL) )
    {
      ...
      v5 = a2;
      v8 = 4;
      tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_180382ABD, 0LL, 0LL, 3u, &v6);
    }
  }
}
