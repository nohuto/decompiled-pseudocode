/*
 * XREFs of ?Create@CDrawListPrimitive@@SAJ_NAEBV?$StridedSpan@$$CBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@AEBV?$StridedSpan@$$CBUVertexAAFixup_UVxN@@@@IV?$span@G$0?0@gsl@@AEBUD2D_VECTOR_2F@@0PEAPEAV1@@Z @ 0x180067378
 * Callers:
 ...
 *     ?AlignVertexCount@@YAXPEAUGeometryCounts@CDrawListPrimitive@@@Z @ 0x180067478 (-AlignVertexCount@@YAXPEAUGeometryCounts@CDrawListPrimitive@@@Z.c)
 */
        ...
        PrimitiveStorage::CInlineStorageBase **a8)
{
  ...
  if ( v15 )
  {
    CDrawListPrimitive::Initialize((__int64)v15, a1, a2, a3, a4, *(void **)(a5 + 8), v12, a6, a7);
    *a8 = v15;
  }
  else
  {
