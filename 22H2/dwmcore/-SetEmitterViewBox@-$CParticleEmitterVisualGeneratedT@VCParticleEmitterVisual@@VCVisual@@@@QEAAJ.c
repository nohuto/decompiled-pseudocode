/*
 * XREFs of ?SetEmitterViewBox@?$CParticleEmitterVisualGeneratedT@VCParticleEmitterVisual@@VCVisual@@@@QEAAJPEAVCViewBox@@@Z @ 0x180170B0C
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[92] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1C01u, 0LL);
    }
    else
    {
