/*
 * XREFs of ?SetSDRBoost@CLegacyStereoSwapChain@@UEAAXM@Z @ 0x1802A07B4
 * Callers:
 *     ?SetSDRBoost@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EAAXM@Z @ 0x180120D00 (-SetSDRBoost@CLegacyStereoSwapChain@@$4PPPPPPPM@A@EAAXM@Z.c)
 * Callees:
