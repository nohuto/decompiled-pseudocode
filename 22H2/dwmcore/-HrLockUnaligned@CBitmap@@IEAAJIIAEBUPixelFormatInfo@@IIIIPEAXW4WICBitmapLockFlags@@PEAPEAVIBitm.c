/*
 * XREFs of ?HrLockUnaligned@CBitmap@@IEAAJIIAEBUPixelFormatInfo@@IIIIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x180217D88
 * Callers:
 ...
 *     ??0CBitmapLockUnaligned@@QEAA@XZ @ 0x180218544 (--0CBitmapLockUnaligned@@QEAA@XZ.c)
