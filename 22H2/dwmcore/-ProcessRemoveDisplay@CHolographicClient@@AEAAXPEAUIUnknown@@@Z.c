/*
 * XREFs of ?ProcessRemoveDisplay@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x1802ADE20
 * Callers:
 ...
 *     ?Remove@?$DynArray@PEAUIHolographicDisplayInfo@@$0A@@@QEAAHAEBQEAUIHolographicDisplayInfo@@@Z @ 0x1802AE4A4 (-Remove@-$DynArray@PEAUIHolographicDisplayInfo@@$0A@@@QEAAHAEBQEAUIHolographicDisplayInfo@@@Z.c)
 */
