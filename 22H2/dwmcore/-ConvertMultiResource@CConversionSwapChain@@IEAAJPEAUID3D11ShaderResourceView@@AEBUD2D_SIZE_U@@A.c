/*
 * XREFs of ?ConvertMultiResource@CConversionSwapChain@@IEAAJPEAUID3D11ShaderResourceView@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@012AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@W4DXGI_MODE_ROTATION@@33@Z @ 0x18024EA2C
 * Callers:
...
{
  __int64 v12; // rdx
  CSurfaceShaderComposer **v14; // r14
  char v16; // si
  ...
  v30 = a3;
  v12 = *(_QWORD *)(a1 + 80);
  v14 = *(CSurfaceShaderComposer ***)(a1 + 64);
  v16 = *(_BYTE *)(a1 + 164);
  v17 = *(_DWORD *)(a1 + 140);
  v27 = *(_QWORD *)a11;
  v28 = *(_DWORD *)(a11 + 8);
  ...
  v20 = (int *)(**v19)(v19, &v30);
  v21 = *(int *)(*(_QWORD *)(*(_QWORD *)(a1 + 80) + 8LL) + 24LL) + *(_QWORD *)(a1 + 80) + 8LL;
  ...
  v25 = v23;
  if ( v23 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x38Au, 0LL);
  return v25;
}
