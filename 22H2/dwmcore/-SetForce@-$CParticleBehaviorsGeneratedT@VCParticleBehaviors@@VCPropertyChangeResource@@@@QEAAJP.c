/*
 * XREFs of ?SetForce@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleVector3Behavior@@@Z @ 0x180170B98
 * Callers:
...
__int64 __fastcall CParticleBehaviorsGeneratedT<CParticleBehaviors,CPropertyChangeResource>::SetForce(
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[16] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x2A6u, 0LL);
    }
    else
    {
