/*
 * XREFs of ?SetForce@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleVector3Behavior@@@Z @ 0x1801C6ECC
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[17] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x9BAu, 0LL);
    }
    else
    {
