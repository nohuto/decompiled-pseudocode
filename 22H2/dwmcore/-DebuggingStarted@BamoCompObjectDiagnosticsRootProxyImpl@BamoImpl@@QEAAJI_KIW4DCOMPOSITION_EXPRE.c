/*
 * XREFs of ?DebuggingStarted@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x1801E5AB8
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      LODWORD(v12) = a2;
      return CoreUICallSend(v10, v14, 2LL, 0LL, 1, &unk_18035670A, v12);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
