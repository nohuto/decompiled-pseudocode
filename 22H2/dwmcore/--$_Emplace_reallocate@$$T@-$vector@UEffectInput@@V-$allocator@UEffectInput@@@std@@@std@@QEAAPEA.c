/*
 * XREFs of ??$_Emplace_reallocate@$$T@?$vector@UEffectInput@@V?$allocator@UEffectInput@@@std@@@std@@QEAAPEAUEffectInput@@QEAU2@$$QEA$$T@Z @ 0x180202B18
 * Callers:
 ...
 *     ??0EffectInput@@QEAA@AEBU0@@Z @ 0x180202CC0 (--0EffectInput@@QEAA@AEBU0@@Z.c)
 */
