/*
 * XREFs of ?get@?$static_lazy@VCompositorTracing@@@details@wil@@QEAAPEAVCompositorTracing@@P6AXXZ@Z @ 0x1800FB924
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<CompositorTracing>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`CompositorTracing::Instance'::`2'::wrapper, 0, (PBOOL)&v6, (LPVOID *)&v7) && (_DWORD)v6 )
  {
    ...
    v7 = &qword_1803E9F48;
    qword_1803E9F48 = (__int64)&CompositorTracing::`vftable';
    qword_1803E9F60 = (__int64)&`CompositorTracing::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
