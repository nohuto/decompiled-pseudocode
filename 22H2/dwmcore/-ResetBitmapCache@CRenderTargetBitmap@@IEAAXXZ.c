/*
 * XREFs of ?ResetBitmapCache@CRenderTargetBitmap@@IEAAXXZ @ 0x1800656E0
 * Callers:
 ...
 *     ?SetProtected@CRenderTargetBitmap@@UEAAX_N@Z @ 0x1800DE1F0 (-SetProtected@CRenderTargetBitmap@@UEAAX_N@Z.c)
 * Callees:
