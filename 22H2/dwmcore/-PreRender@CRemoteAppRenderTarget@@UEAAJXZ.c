/*
 * XREFs of ?PreRender@CRemoteAppRenderTarget@@UEAAJXZ @ 0x1801862C4
 * Callers:
 *     ?PreRender@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F5230 (-PreRender@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
