/*
 * XREFs of ?Matrix4x4FromRotationX@CExpressionValueStack@@QEAAJI@Z @ 0x1801FE7A4
 * Callers:
  ...
  if ( a2 != 1 )
  {
    if ( a2 == 2 )
    {
      ...
      if ( v14[18] == 18 && v12[18] == 52 )
      {
        ...
        v24 = *(_QWORD *)v12;
        v25 = v16;
        D2DMatrixRotationX(&v26, v10, &v24);
        v17 = v26;
        v18 = v27;
        v14[18] = 265;
        *(_OWORD *)v14 = v17;
...
LABEL_20:
  ...
  if ( v6[18] != 18 )
    goto LABEL_20;
  D2DMatrixRotationX((struct D2DMatrix *)&v26, *(float *)v6);
  v7 = v27;
  *(_OWORD *)v6 = v26;
  v6[18] = 265;
  v8 = v28;
