        ...
        __int64 *a3)
{
  ...
  *(_QWORD *)(v13 + v15) = v14;
  ...
  std::vector<std::unique_ptr<CD2DBitmapCache::CCachedBitmap>>::_Change_array(a1, v16, v8, v11);
