/*
 * XREFs of ?Clear@CTreeData@@MEAAXXZ @ 0x1800437F0
 * Callers:
 ...
 *     ?Clear@CVisualTreeData@@MEAAXXZ @ 0x180210AD0 (-Clear@CVisualTreeData@@MEAAXXZ.c)
 * Callees:
 ...
 *     ??1CpuClipRealization@CCpuClippingData@@QEAA@XZ @ 0x1800F2BE0 (--1CpuClipRealization@CCpuClippingData@@QEAA@XZ.c)
