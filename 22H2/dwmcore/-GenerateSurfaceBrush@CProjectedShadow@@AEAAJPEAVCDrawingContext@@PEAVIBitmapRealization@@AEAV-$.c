/*
 * XREFs of ?GenerateSurfaceBrush@CProjectedShadow@@AEAAJPEAVCDrawingContext@@PEAVIBitmapRealization@@AEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAVCSurfaceBrush@@@Z @ 0x18024AAA0
 * Callers:
  ...
  if ( v17 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *((_DWORD *)v13 + 24) = 0;
      ...
      LODWORD(v17) = 0;
      ((void (__fastcall *)(char *, void *, CSurfaceBrush **))xmmword_1803E4BA0)(
        (char *)v13 + SDWORD2(xmmword_1803E4BA0),
        &CSurfaceBrush::sc_HorizontalAlignment,
        &v17);
      LODWORD(v17) = 0;
      ((void (__fastcall *)(char *, void *, CSurfaceBrush **))xmmword_1803E4BD8)(
        (char *)v13 + SDWORD2(xmmword_1803E4BD8),
