/*
 * XREFs of ?GenerateGridAntialiasBorder@Mesh@@AEBAX_NAEBV?$StridedSpan@UVertexXYW_ColorDW@@@@AEBV?$StridedSpan@UVertexAAFixupBase@@@@PEAHPEAGH3@Z @ 0x1800BF7F4
 * Callers:
 ...
 * Callees:
 *     OffsetBaseVertices @ 0x1800BFD9C (OffsetBaseVertices.c)
 *     CopyBaseVertices @ 0x1800BFE54 (CopyBaseVertices.c)
