/*
 * XREFs of ?CheckOcclusionState@CCaptureRenderTarget@@UEAAJXZ @ 0x1800ED5A4
 * Callers:
 *     ?CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F4520 (-CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 *     ?CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@EI@EAAJXZ @ 0x1800F4530 (-CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@EI@EAAJXZ.c)
 * Callees:
