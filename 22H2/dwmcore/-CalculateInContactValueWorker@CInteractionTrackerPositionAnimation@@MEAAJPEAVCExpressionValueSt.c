/*
 * XREFs of ?CalculateInContactValueWorker@CInteractionTrackerPositionAnimation@@MEAAJPEAVCExpressionValueStack@@_KMPEAM@Z @ 0x180266A50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z @ 0x18026F7F8 (-CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z.c)
