/*
 * XREFs of ?CalculateInContactValueWorker@CInteractionTrackerPositionAnimation@@MEAAJPEAVCExpressionValueStack@@_KMPEAM@Z @ 0x180205410
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z @ 0x18020F060 (-CalculateInContactValue@CPositionMotion@@QEAAMMMMMMM@Z.c)
