/*
 * XREFs of ?DebugDump@CWindowBackdropBrush@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x18016E0E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CWindowBackdropBrush::DebugDump(CWindowBackdropBrush *this, void **a2)
{
  _QWORD *v3; // rdx
  _QWORD v4[4]; // [rsp+20h] [rbp-38h] BYREF

  CBrush::DebugDump(this, a2);
  std::string::string(v4, (__int64)"CWindowBackdropBrush");
  if ( a2 != v4 )
  {
    v3 = v4;
    if ( v4[3] >= 0x10uLL )
