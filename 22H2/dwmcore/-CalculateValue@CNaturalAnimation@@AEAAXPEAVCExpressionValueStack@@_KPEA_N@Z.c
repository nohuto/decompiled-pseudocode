/*
 * XREFs of ?CalculateValue@CNaturalAnimation@@AEAAXPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1801D717C
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U1@U1@U1@U1@U?$_tlgWrapperByVal@$00@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@3333333AEBU?$_tlgWrapperByVal@$00@@@Z @ 0x1801D6DB0 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U1@U1@U1@U1@U-$_tlgWrapperByVal@$00@@@-$_tlgWriteTemp.c)
 ...
 *     ?IsInMotion@CScalarForceEvaluator@@QEBA_NXZ @ 0x180215768 (-IsInMotion@CScalarForceEvaluator@@QEBA_NXZ.c)
 *     ?Update@CVector3Force@@QEAA?AUD2DVector3@@MPEAVCExpressionValueStack@@_K@Z @ 0x1802158D8 (-Update@CVector3Force@@QEAA-AUD2DVector3@@MPEAVCExpressionValueStack@@_K@Z.c)
 *     ?ChangeBasis@CVector3ForceEvaluator@@QEAAXAEBUD2DMatrix@@@Z @ 0x180215ABC (-ChangeBasis@CVector3ForceEvaluator@@QEAAXAEBUD2DMatrix@@@Z.c)
    ...
    if ( v8 == 18 || v8 == 35 || v8 == 52 )
    {
      ...
      *a4 = v14;
      ...
      if ( *(int *)(*((_QWORD *)this + 38) + 4LL) < 0 )
      {
        ...
        if ( (unsigned int)dword_180344E80 > 4 && (qword_180344E90 & 4) != 0 && (qword_180344E98 & 4) == qword_180344E98 )
        {
          v26[0] = *a4;
          v30 = v22[2];
          v31 = v22[1];
