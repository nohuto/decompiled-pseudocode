/*
 * XREFs of ??1CCursorManager@@QEAA@XZ @ 0x18010EBD4
 * Callers:
 *     _dynamic_atexit_destructor_for__g_CursorManager__ @ 0x1801245E0 (_dynamic_atexit_destructor_for__g_CursorManager__.c)
 * Callees:
