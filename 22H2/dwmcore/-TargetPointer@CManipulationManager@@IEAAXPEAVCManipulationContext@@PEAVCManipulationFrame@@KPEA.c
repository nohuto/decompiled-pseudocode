/*
 * XREFs of ?TargetPointer@CManipulationManager@@IEAAXPEAVCManipulationContext@@PEAVCManipulationFrame@@KPEAPEAX@Z @ 0x18022765C
 * Callers:
 ...
 *     ?IsRoute@TargetingInfo@@QEBA_NXZ @ 0x180224D20 (-IsRoute@TargetingInfo@@QEBA_NXZ.c)
