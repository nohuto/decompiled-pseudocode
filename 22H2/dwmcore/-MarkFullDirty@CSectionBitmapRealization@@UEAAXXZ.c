/*
 * XREFs of ?MarkFullDirty@CSectionBitmapRealization@@UEAAXXZ @ 0x180267034
 * Callers:
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXXZ @ 0x1800F8000 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXXZ.c)
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXXZ @ 0x1800F8010 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXXZ.c)
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@EA@EAAXXZ @ 0x1800F81F0 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@EA@EAAXXZ.c)
 * Callees:
