/*
 * XREFs of ?AddInvalidRects@CLegacyRenderTarget@@UEAAXPEBVCVisualTree@@PEAVCDirtyRegion@@@Z @ 0x180049720
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z @ 0x180072158 (-invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z.c)
        ...
        struct CDirtyRegion *a3)
{
  ...
  for ( i = qword_1803EA158; i != (_QWORD)xmmword_1803EA160; i += 16LL )
  {
    ...
    {
      if ( i && !*(_BYTE *)(*(_QWORD *)i + 452LL) && !byte_1803EA170 && *(_DWORD *)(*(_QWORD *)i + 448LL) )
        v7 = 1;
      break;
    }
  }
