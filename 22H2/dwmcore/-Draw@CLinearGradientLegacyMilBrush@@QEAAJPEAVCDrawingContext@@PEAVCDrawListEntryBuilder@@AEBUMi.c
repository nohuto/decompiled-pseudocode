/*
 * XREFs of ?Draw@CLinearGradientLegacyMilBrush@@QEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@AEBUMilRectF@@@Z @ 0x18021E5CC
 * Callers:
 ...
 *     ?GetGradientColorData@CGradientLegacyMilBrush@@IEAAXPEAVCGradientColorData@@@Z @ 0x18021ED88 (-GetGradientColorData@CGradientLegacyMilBrush@@IEAAXPEAVCGradientColorData@@@Z.c)
 */
  ...
  *(_OWORD *)v49 = *(_OWORD *)a4;
  if ( operator!=((float *)this + 42, (float *)v49) || *((_BYTE *)this + 216) )
  {
    ...
    *((float *)v49 + 1) = v14;
    ...
    ((void (__fastcall *)(_QWORD, void *, _DWORD *))xmmword_1803E4970)(
      *((_QWORD *)this + 24) + SDWORD2(xmmword_1803E4970),
      &CLinearGradientBrush::sc_StartPoint,
      v42);
    ((void (__fastcall *)(_QWORD, void *, struct CGeometryOnlyDrawListBrush **))xmmword_1803E49A8)(
      *((_QWORD *)this + 24) + SDWORD2(xmmword_1803E49A8),
      &CLinearGradientBrush::sc_EndPoint,
      v49);
    v18 = *((_QWORD *)&v43[1] + 1);
    v19 = *((_QWORD *)this + 25) + SDWORD2(xmmword_1803E42F0);
    v48[0].width = *(FLOAT *)*((_DWORD **)&v43[1] + 1);
    ((void (__fastcall *)(__int64, void *, struct D2D_SIZE_F *))xmmword_1803E42F0)(
      v19,
      &CColorGradientStop::sc_Offset,
      v48);
    v20 = *(const __m128i **)&v43[0];
    v21 = *((_QWORD *)this + 25) + SDWORD2(xmmword_1803E4328);
    ...
    ((void (__fastcall *)(__int64, void *, struct D2D_SIZE_F *))xmmword_1803E4328)(
      v21,
      &CColorGradientStop::sc_Color,
      v48);
    v23 = *((_QWORD *)this + 26) + SDWORD2(xmmword_1803E42F0);
    ...
    v25 = *((_QWORD *)this + 26) + SDWORD2(xmmword_1803E4328);
