/*
 * XREFs of ??$_Emplace_reallocate@AEBUD2D1_GRADIENT_STOP@@@?$vector@UD2D1_GRADIENT_STOP@@V?$allocator@UD2D1_GRADIENT_STOP@@@std@@@std@@QEAAPEAUD2D1_GRADIENT_STOP@@QEAU2@AEBU2@@Z @ 0x1801E64C4
 * Callers:
 *     ?FlattenStops@CGradientBrush@@AEAAXXZ @ 0x1801E6948 (-FlattenStops@CGradientBrush@@AEAAXXZ.c)
 * Callees:
