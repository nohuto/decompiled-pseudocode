/*
 * XREFs of ?SetNotificationMode@CCursorVisual@@QEAAXXZ @ 0x180228F58
 * Callers:
 *     ?EndUpdateCursors@CGlobalComposition@@UEAAXXZ @ 0x1800E9C10 (-EndUpdateCursors@CGlobalComposition@@UEAAXXZ.c)
 * Callees:
