/*
 * XREFs of ?GenerateDrawListPrimitive@CBrushDrawListGenerator@@AEBAJPEAUGenerateDrawListParameters@1@@Z @ 0x180060C80
 * Callers:
 ...
 *     ?TryInvert@Matrix3x3@@SA_NAEBV1@PEAV1@@Z @ 0x1800D59BC (-TryInvert@Matrix3x3@@SA_NAEBV1@PEAV1@@Z.c)
