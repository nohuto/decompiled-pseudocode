/*
 * XREFs of ?PinResources@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJU_LUID@@@Z @ 0x1801F8A34
 * Callers:
 *     ?PinResources@CGlobalCompositionSurfaceInfo@@UEAAJU_LUID@@@Z @ 0x1801F8CF0 (-PinResources@CGlobalCompositionSurfaceInfo@@UEAAJU_LUID@@@Z.c)
 * Callees:
        ...
        struct _LUID a2)
{
  ...
  {
    v2 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_180305428, 3u, -2003292412, 0x3A8u, 0LL);
    return v2;
  }
  ...
  if ( ((*((_QWORD *)this + 11) - *((_QWORD *)this + 10)) & 0xFFFFFFFFFFFFFFF8uLL) == 0 )
  {
    ...
    if ( ExistingDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_180305428, 3u, ExistingDevice, 0x383u, 0LL);
    }
    else
    {
      ...
      if ( v8 != v9 )
      {
        do
        {
          ...
          if ( v10 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180305428, 3u, v10, 0x38Du, 0LL);
        ...
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180305428, 3u, v16, 0x398u, 0LL);
        }
        else
        {
          if ( v4 != &v21 )
...
LABEL_24:
      v2 = -2147467259;
      MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_180305428, 3u, -2147467259, 0x3A0u, 0LL);
    }
LABEL_26:
    v18 = v24;
    if ( v24 )
