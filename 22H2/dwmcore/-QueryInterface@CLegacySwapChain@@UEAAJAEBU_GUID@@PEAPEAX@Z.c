/*
 * XREFs of ?QueryInterface@CLegacySwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006E3E0
 * Callers:
 *     ?QueryInterface@CLegacySwapChain@@$4PPPPPPPM@BCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F6E80 (-QueryInterface@CLegacySwapChain@@$4PPPPPPPM@BCA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
