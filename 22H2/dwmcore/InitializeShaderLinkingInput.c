/*
 * XREFs of InitializeShaderLinkingInput @ 0x1800463D8
 * Callers:
 ...
 *     GetHlslNameAndSemantic @ 0x180046550 (GetHlslNameAndSemantic.c)
...
__int64 __fastcall InitializeShaderLinkingInput(struct ID3D11Linker **ppLinker, __int64 a2, VertexShaderDesc *a3)
{
  ...
  v6 = *((_QWORD *)&unk_18027B3A0 + 2 * (v4 & 0xFFFFFFEF));
  v7 = v6;
  v8 = *((_QWORD *)&unk_18027B3A0 + 2 * (v4 & 0xFFFFFFEF) + 1);
  if ( (_DWORD)v6 )
  {
    while ( 1 )
    {
      ...
      if ( v9 >= v6 )
        break;
      v10 = *(_WORD *)(*((_QWORD *)&unk_18027B3A0 + 2 * (v4 & 0xFFFFFFEF) + 1) + 12 * v9);
