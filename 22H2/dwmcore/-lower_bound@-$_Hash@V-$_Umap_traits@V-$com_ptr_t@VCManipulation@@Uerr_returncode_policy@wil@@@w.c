        ...
        __int64 *a3)
{
  ...
  v3 = *a3;
  v10 = *a3;
  v5 = *(_QWORD *)(a1 + 48) & std::_Fnv1a_append_bytes(a1, (const unsigned __int8 *const)&v10, 8uLL);
  while ( 1 )
  {
