/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x1800FF510
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  v8 = v2;
  v5 = CoreUICallSend(v4, v7, 2LL, 7LL, 0, &unk_180353E7B, &v8);
  if ( v5 < 0 )
