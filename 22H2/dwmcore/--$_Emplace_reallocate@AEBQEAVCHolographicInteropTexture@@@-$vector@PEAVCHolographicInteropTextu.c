/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAVCHolographicInteropTexture@@@?$vector@PEAVCHolographicInteropTexture@@V?$allocator@PEAVCHolographicInteropTexture@@@std@@@std@@QEAAPEAPEAVCHolographicInteropTexture@@QEAPEAV2@AEBQEAV2@@Z @ 0x1802A4400
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCHolographicInteropTexture@@V?$allocator@PEAVCHolographicInteropTexture@@@std@@@std@@AEAAXQEAPEAVCHolographicInteropTexture@@_K1@Z @ 0x1802A66C8 (-_Change_array@-$vector@PEAVCHolographicInteropTexture@@V-$allocator@PEAVCHolographicInteropText.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<CHolographicInteropTexture *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
