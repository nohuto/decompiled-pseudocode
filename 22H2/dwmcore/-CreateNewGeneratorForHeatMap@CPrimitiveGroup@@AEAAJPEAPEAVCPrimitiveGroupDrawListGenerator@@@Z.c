/*
 * XREFs of ?CreateNewGeneratorForHeatMap@CPrimitiveGroup@@AEAAJPEAPEAVCPrimitiveGroupDrawListGenerator@@@Z @ 0x1801E31B0
 * Callers:
        ...
        struct CPrimitiveGroupDrawListGenerator **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x2CCu, 0LL);
    if ( v12 )
