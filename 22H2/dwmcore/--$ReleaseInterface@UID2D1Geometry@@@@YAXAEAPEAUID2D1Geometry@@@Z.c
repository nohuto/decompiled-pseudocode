/*
 * XREFs of ??$ReleaseInterface@UID2D1Geometry@@@@YAXAEAPEAUID2D1Geometry@@@Z @ 0x180017820
 * Callers:
 ...
 *     ?ReleaseD2DResources@CD2DEffect@@UEAAXXZ @ 0x18024D450 (-ReleaseD2DResources@CD2DEffect@@UEAAXXZ.c)
