/*
 * XREFs of ?Release@BamoImplObject@BamoImpl@Microsoft@@UEAAKXZ @ 0x1800D7310
 * Callers:
 ...
 *     ?Release@BufferingMessageCallHost@BamoImpl@Microsoft@@UEAAKXZ @ 0x1800D7300 (-Release@BufferingMessageCallHost@BamoImpl@Microsoft@@UEAAKXZ.c)
