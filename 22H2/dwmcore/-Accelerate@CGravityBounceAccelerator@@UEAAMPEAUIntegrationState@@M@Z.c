/*
 * XREFs of ?Accelerate@CGravityBounceAccelerator@@UEAAMPEAUIntegrationState@@M@Z @ 0x180277810
 * Callers:
 *     <none>
 * Callees:
        ...
        float a3)
{
  ...
  v8 = *((_DWORD *)this + 12);
  if ( v8 && (unsigned int)dword_1803E3798 > 4 && tlgKeywordOn((__int64)&dword_1803E3798, 4LL) )
  {
    v21 = *(_DWORD *)(v11 + 28);
    v23 = *(_DWORD *)(v11 + 20);
    v15 = v22;
