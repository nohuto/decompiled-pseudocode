/*
 * XREFs of KeyboardClassWaitWakeComplete @ 0x1C0005BC0
 * Callers:
 *     <none>
 * Callees:
 *     KeyboardToggleWaitWake @ 0x1C0005DD8 (KeyboardToggleWaitWake.c)
 *     WPP_RECORDER_SF_qd @ 0x1C0006534 (WPP_RECORDER_SF_qd.c)
