/*
 * XREFs of ?DdiRecommendMonitorModes@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDMONITORMODES@@@Z @ 0x1C0181A2C
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5037LL);
  ...
  v14[4] = v15;
  v14[5] = a2->VideoPresentTargetId;
  v14[6] = a2->hMonitorSourceModeSet;
  pMonitorSourceModeSetInterface = a2->pMonitorSourceModeSetInterface;
  v14[7] = pMonitorSourceModeSetInterface;
  if ( (_DWORD)v12 != -1073741801 && (_DWORD)v12 )
  {
    v25 = WdLogNewEntry5_WdError(pMonitorSourceModeSetInterface, v15);
    *(_QWORD *)(v25 + 24) = v12;
