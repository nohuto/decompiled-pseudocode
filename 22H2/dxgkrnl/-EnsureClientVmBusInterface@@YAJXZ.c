/*
 * XREFs of ?EnsureClientVmBusInterface@@YAJXZ @ 0x1C023A8F4
 * Callers:
...
LABEL_14:
  ...
  ((void (__fastcall *)(__int64))qword_1C00B42F0)(qword_1C00B42E8);
