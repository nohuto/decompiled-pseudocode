/*
 * XREFs of MonitorGetMonitorDeviceInterfaceName @ 0x1C014CA9C
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C0019664 (-RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
...
__int64 __fastcall MonitorGetMonitorDeviceInterfaceName(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  __int64 v5; // rbp
  __int64 v6; // rsi
  __int64 v8; // rax
