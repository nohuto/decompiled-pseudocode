/*
 * XREFs of ?PinContentRotation@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@@Z @ 0x1C000B8A4
 * Callers:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a2)
{
  ...
  __int64 v4; // rdx
  __int64 v5; // rcx
  enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION v6; // eax
  __int64 v7; // rdx
  __int64 v8; // rcx
  __int64 v9; // r8
  __int32 v10; // eax
  ...
  v6 = D3DKMDT_VPPR_GET_CONTENT_ROTATION((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)v2);
  v9 = 251LL;
  v10 = v6 - 1;
  if ( !v10 )
  {
...
LABEL_6:
  v12 = D3DKMDT_VPPR_GET_OFFSET_ROTATION((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)v2) - 1;
  if ( !v12 )
  {
