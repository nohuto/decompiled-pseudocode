/*
 * XREFs of ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x1C0161B88
 * Callers:
 ...
 *     _anonymous_namespace_::_UpdateTimestampTopologySetCallback @ 0x1C0161B70 (_anonymous_namespace_--_UpdateTimestampTopologySetCallback.c)
 * Callees:
 *     <none>
 */
