/*
 * XREFs of ?SmmIommuSwitchToPassthrough@@YAJPEAUSYSMM_ADAPTER@@@Z @ 0x1C03D5C28
 * Callers:
...
LABEL_4:
  ...
  v2 = SmmSwapDomains(a1, qword_1C0140CC8, *((_QWORD *)a1 + 14));
  if ( v2 < 0 )
    goto LABEL_4;
  if ( *((_QWORD *)a1 + 44) )
  ...
  v3 = *((_QWORD *)a1 + 14);
  SmmAssignDomain((__int64)a1, qword_1C0140CC8, 1);
  if ( v3 )
