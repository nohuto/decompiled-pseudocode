/*
 * XREFs of _BmlLogDiagnosticsPacket @ 0x1C016D720
 * Callers:
 ...
 *     ?GetFirstPath@DMMVIDPNTOPOLOGY@@QEBAPEAVDMMVIDPNPRESENTPATH@@XZ @ 0x1C0013210 (-GetFirstPath@DMMVIDPNTOPOLOGY@@QEBAPEAVDMMVIDPNPRESENTPATH@@XZ.c)
      ...
      if ( (*(_QWORD *)v16 & 0x700000000000LL) == 0x700000000000LL )
      {
        ...
        *v23 = 0x700000000000LL;
        ...
        if ( FirstPath )
        {
          ...
          _BmlFillOnePathModalityFromVidPn<_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR3>(FirstPath, v23);
        }
      }
      else
      {
