/*
 * XREFs of ?SysMmMapLogicalAddressRange@@YAJPEAUSYSMM_ADAPTER@@PEAU_IOMMU_DMA_DOMAIN@@_K22PEBU_DXGK_ADL@@_N@Z @ 0x1C03D6750
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  v16 = 0LL;
  return ((__int64 (__fastcall *)(__int64, _QWORD, _DWORD *, __int64 *, _QWORD, _QWORD, __int64 *))qword_1C0140C28)(
           v9,
           2 * !a7 + 1,
           v17,
           &v20,
