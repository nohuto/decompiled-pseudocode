/*
 * XREFs of ?WriteDxgDiagnosticsEvent_QDC@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0002E3C
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_QDC(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 304480) )
  {
    if ( (unsigned int)dword_1C013F8E0 > 1
      && (unsigned __int8)tlgKeywordOn(&dword_1C013F8E0, 0x200000000001LL)
...
LABEL_11:
  ...
  else if ( (unsigned int)dword_1C013F8E0 > 4
         && (unsigned __int8)tlgKeywordOn(&dword_1C013F8E0, 0x200000000001LL)
         && (unsigned __int8)tlgKeywordOn(&dword_1C013F8E0, v2) )
  {
    v7 = &unk_1C00A84D1;
    goto LABEL_11;
  }
