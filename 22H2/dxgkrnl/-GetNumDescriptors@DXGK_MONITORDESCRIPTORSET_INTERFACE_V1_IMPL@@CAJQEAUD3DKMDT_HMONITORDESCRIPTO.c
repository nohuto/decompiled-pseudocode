/*
 * XREFs of ?GetNumDescriptors@DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORDESCRIPTORSET__@@QEA_K@Z @ 0x1C020C4D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v17, 7027);
    ...
    *a2 = 0LL;
    ...
    else
    {
      ...
      RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>::RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>(
        ...
        0);
      v12 = Resource;
      *a2 = DxgMonitor::MonitorDescriptorState::GetNumMonitorDescriptors((DxgMonitor::MonitorDescriptorState *)Resource);
      v13 = 0;
      if ( v12 )
      {
