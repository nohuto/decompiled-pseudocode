/*
 * XREFs of _lambda_6c91b3c659723331424fe42952e4f114_::operator() @ 0x1C02F3DC4
 * Callers:
        ...
        int a5)
{
  ...
  *(_DWORD *)(a3 + 96) = 21;
  v5 = ConvertDmmToDisplayConfigRotation((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)*(_DWORD *)(a4 + 40));
  v6[26] = v5;
  v6[28] = 1;
  v6[27] = 1;
  v6[29] = v7[3];
