/*
 * XREFs of ?Initialize@CTTMDEVICE@@AEAAJPEAU_DEVICE_OBJECT@@PEAVDXGADAPTER@@IK@Z @ 0x1C0185A28
 * Callers:
        ...
        unsigned int a5)
{
  ...
  __int64 v20; // rdx
  __int64 v21; // rcx
  struct HDXGMONITOR__ *v22; // [rsp+60h] [rbp+8h] BYREF
  ...
  *((_QWORD *)this + 77) = v6;
  if ( v10 )
    LODWORD(CCDMonitorID) = MonitorGetMonitorDeviceInterfaceName((__int64)a3, (unsigned int)v9, 0x104u, (__int64)v6);
  else
    LODWORD(CCDMonitorID) = -1073741632;
  if ( (_DWORD)CCDMonitorID == -1073741632 )
  {
    MonitorHandle = MonitorGetMonitorHandle((__int64)a3, (unsigned int)v9, 0, this, &v22);
    ...
    CCDMonitorID = (int)MonitorGetCCDMonitorID(v22, 0x103u, v6);
    MonitorReleaseMonitorHandle((__int64)a3, (__int64)v22, this);
    if ( (int)CCDMonitorID < 0 )
    {
      v19 = (_QWORD *)WdLogNewEntry5_WdError(v21, v20);
      v19[6] = 0LL;
      goto LABEL_12;
    }
LABEL_5:
    v12 = RtlStringCbLengthW(*((const unsigned __int16 **)this + 77), *((unsigned __int16 *)this + 305), &v23);
    CCDMonitorID = v12;
    if ( v12 >= 0 )
    {
      *((_WORD *)this + 304) = v23;
