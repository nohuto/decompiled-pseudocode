/*
 * XREFs of ?TdrResetFromTimeout@@YAJPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C0266610
 * Callers:
 ...
 *     ?Start@CVP_SYSTEM_THREAD@@QEAAJXZ @ 0x1C0264E18 (-Start@CVP_SYSTEM_THREAD@@QEAAJXZ.c)
...
__int64 __fastcall TdrResetFromTimeout(ULONG_PTR BugCheckParameter1)
{
  ...
  {
    *(_QWORD *)(BugCheckParameter1 + 96) = -1LL;
    TdrBugcheckOnTimeout(BugCheckParameter1);
  }
  v2 = *(struct _KTHREAD **)(BugCheckParameter1 + 2896);
  if ( (!v2 || KeGetCurrentThread() == v2) && *(_QWORD *)(*(_QWORD *)(BugCheckParameter1 + 32) + 2696LL) )
  {
