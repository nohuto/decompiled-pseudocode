/*
 * XREFs of BmlCompareTargetModesWithConstraint @ 0x1C01762D4
 * Callers:
 ...
 *     ??$DIFF@I@@YAIII@Z @ 0x1C006A354 (--$DIFF@I@@YAIII@Z.c)
...
LABEL_36:
                ...
                (v4 = BmlCompareValues<bool>(v30, v29)) == 0) )
          {
            if ( (*(_BYTE *)v9 & 8) != 0 )
            {
              DoesTargetModeSupportWireFormat = BmlDoesTargetModeSupportWireFormat(a3, *(_DWORD *)(v9 + 204));
              LOBYTE(v32) = BmlDoesTargetModeSupportWireFormat(a4, *(_DWORD *)(v9 + 204));
