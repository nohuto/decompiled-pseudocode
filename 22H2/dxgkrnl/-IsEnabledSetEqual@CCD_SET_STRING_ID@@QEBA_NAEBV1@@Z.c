/*
 * XREFs of ?IsEnabledSetEqual@CCD_SET_STRING_ID@@QEBA_NAEBV1@@Z @ 0x1C01812BC
 * Callers:
 ...
 * Callees:
 *     ?QueryMonitorId@CCD_SET_STRING_ID@@QEBAJIPEAU_STRING@@@Z @ 0x1C017D58C (-QueryMonitorId@CCD_SET_STRING_ID@@QEBAJIPEAU_STRING@@@Z.c)
...
char __fastcall CCD_SET_STRING_ID::IsEnabledSetEqual(CCD_SET_STRING_ID *this, const struct CCD_SET_STRING_ID *a2)
{
  ...
  if ( v2 == *((_WORD *)a2 + 16) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)CCD_SET_STRING_ID::_StringCompare(&v10, &v9) )
        break;
