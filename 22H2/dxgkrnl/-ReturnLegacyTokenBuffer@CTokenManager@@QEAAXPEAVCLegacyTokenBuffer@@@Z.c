/*
 * XREFs of ?ReturnLegacyTokenBuffer@CTokenManager@@QEAAXPEAVCLegacyTokenBuffer@@@Z @ 0x1C0012DCC
 * Callers:
 *     ?Discard@CCompositionFrame@@UEAAXXZ @ 0x1C0012CE0 (-Discard@CCompositionFrame@@UEAAXXZ.c)
 *     ?ReturnLegacyTokenBuffer@CCompositionFrame@@IEAAXXZ @ 0x1C0013CD4 (-ReturnLegacyTokenBuffer@CCompositionFrame@@IEAAXXZ.c)
 * Callees:
