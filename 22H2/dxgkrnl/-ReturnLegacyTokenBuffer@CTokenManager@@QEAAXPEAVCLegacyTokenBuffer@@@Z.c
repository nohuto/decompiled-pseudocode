/*
 * XREFs of ?ReturnLegacyTokenBuffer@CTokenManager@@QEAAXPEAVCLegacyTokenBuffer@@@Z @ 0x1C0018038
 * Callers:
 *     ?Discard@CCompositionFrame@@UEAAXXZ @ 0x1C0017BA0 (-Discard@CCompositionFrame@@UEAAXXZ.c)
 *     ?ReturnLegacyTokenBuffer@CCompositionFrame@@IEAAXXZ @ 0x1C0017EBC (-ReturnLegacyTokenBuffer@CCompositionFrame@@IEAAXXZ.c)
 * Callees:
