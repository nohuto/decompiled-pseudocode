/*
 * XREFs of ?AcquireBuffer@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_ACQUIRESWAPCHAIN@@PEAI@Z @ 0x1C02AA584
 * Callers:
 ...
 *     ?Remove@DXGFIXEDQUEUE@@QEAAJPEAI@Z @ 0x1C004BF6C (-Remove@DXGFIXEDQUEUE@@QEAAJPEAI@Z.c)
