/*
 * XREFs of ?UpdateCollection@CAdapterCollection@@QEAA_NPEAUCSM_TOKEN_ADAPTER_INFO@@PEAPEAXI@Z @ 0x1C0012950
 * Callers:
        ...
        unsigned int a4)
{
  ...
  __int64 v12; // rdi
  int v13; // eax
  _DWORD v15[2]; // [rsp+20h] [rbp-78h] BYREF
  ...
  if ( a4 )
  {
    ...
    do
    {
      ...
      if ( v13 )
      {
        ...
        v18 = 0LL;
        v16 = 1LL;
        if ( (int)DxgkGetDeviceStateInternal(v15, 0LL) < 0 || (_DWORD)v16 != 1 )
          goto LABEL_13;
      }
