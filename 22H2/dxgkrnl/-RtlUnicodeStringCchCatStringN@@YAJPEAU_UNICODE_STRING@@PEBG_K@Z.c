/*
 * XREFs of ?RtlUnicodeStringCchCatStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z @ 0x1C0041060
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C004121C (RtlWideCharArrayCopyStringWorker.c)
 */
