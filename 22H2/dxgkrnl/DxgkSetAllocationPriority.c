/*
 * XREFs of DxgkSetAllocationPriority @ 0x1C022B2A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetAllocationPriority(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _QWORD v39[2]; // [rsp+58h] [rbp-F0h] BYREF
  _D3DKMT_SETALLOCATIONPRIORITY v40; // [rsp+68h] [rbp-E0h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v35, 2007LL);
...
LABEL_13:
  ...
  v40 = *v3;
  v38 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v34, v40.hDevice, Current, &v38);
  v15 = v38;
  if ( !v38 )
  {
    v16 = WdLogNewEntry5_WdError(v14, v13);
    *(_QWORD *)(v16 + 24) = v40.hDevice;
  ...
  DXGDEVICEACCESSLOCKEXCLUSIVE::DXGDEVICEACCESSLOCKEXCLUSIVE((DXGDEVICEACCESSLOCKEXCLUSIVE *)v39, v38);
  COREDEVICEACCESS::COREDEVICEACCESS((__int64)v41, (__int64)v15, 0, v20, 0);
  v21 = COREDEVICEACCESS::AcquireShared((COREDEVICEACCESS *)v41, 0LL);
  v25 = v21;
  if ( v21 >= 0 )
  {
    v30 = DXGDEVICE::SetAllocationPriority(v15, &v40, 1);
