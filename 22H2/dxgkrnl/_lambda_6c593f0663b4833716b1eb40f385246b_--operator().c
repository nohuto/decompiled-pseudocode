/*
 * XREFs of _lambda_6c593f0663b4833716b1eb40f385246b_::operator() @ 0x1C00267DC
 * Callers:
...
char __fastcall lambda_6c593f0663b4833716b1eb40f385246b_::operator()(__int64 a1, __int64 a2)
{
  _DWORD *v4; // rcx
  _DWORD *Pool2; // rax
  int v6; // edx
