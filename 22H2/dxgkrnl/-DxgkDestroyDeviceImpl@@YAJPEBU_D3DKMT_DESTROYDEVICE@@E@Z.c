/*
 * XREFs of ?DxgkDestroyDeviceImpl@@YAJPEBU_D3DKMT_DESTROYDEVICE@@E@Z @ 0x1C0189B0C
 * Callers:
 *     DxgkDestroyDevice @ 0x1C0189AB0 (DxgkDestroyDevice.c)
 *     DxgkDestroyDeviceInternal @ 0x1C01EEAB8 (DxgkDestroyDeviceInternal.c)
