/*
 * XREFs of ?SetPrimaryPath@ADAPTER_DISPLAY@@QEAAXIIW4_DXGK_PRIMARY_TARGET_TYPE@@@Z @ 0x1C0168010
 * Callers:
 ...
 *     DxgkSetPostDeviceCandidateTarget @ 0x1C001A3F8 (DxgkSetPostDeviceCandidateTarget.c)
 */
