/*
 * XREFs of DxgkOpenNtHandleFromName @ 0x1C0279B90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkOpenNtHandleFromName(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (qword_1C00B19B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer(a1, &EventProfilerEnter, a3, 2075);
  }
  else
  {
    v14 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v12, 2075LL);
  v5 = a1;
