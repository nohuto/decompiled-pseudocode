/*
 * XREFs of ??1DXGCONTEXT@@QEAA@XZ @ 0x1C00EFE34
 * Callers:
...
LABEL_44:
  ...
  *((_QWORD *)this + 62) = 0LL;
  if ( (_DWORD)v18 )
  {
    DXGPROCESS::FreeResourceHandleNoRefSafe(*(DXGPROCESS **)(*((_QWORD *)this + 2) + 40LL), v18);
    *((_DWORD *)this + 6) = 0;
  }
  if ( *v15 != v15 )
  {
