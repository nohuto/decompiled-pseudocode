/*
 * XREFs of ?DestroyAllDeviceSyncObjects@DXGDEVICE@@QEAAXXZ @ 0x1C018B02C
 * Callers:
...
void __fastcall DXGDEVICE::DestroyAllDeviceSyncObjects(DXGDEVICE *this)
{
  ...
  {
    WdLogSingleEntry1(1LL, 2559LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsDeviceLockExclusiveOwner()", 2559LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_QWORD *)this + 240) )
  {
