/*
 * XREFs of DpiQuerySystemFirmwareTables @ 0x1C019C4C8
 * Callers:
 *     DpiReadSystemFirmwareTable @ 0x1C019C450 (DpiReadSystemFirmwareTable.c)
 *     DpiEnumSystemFirmwareTables @ 0x1C02C8660 (DpiEnumSystemFirmwareTables.c)
 * Callees:
