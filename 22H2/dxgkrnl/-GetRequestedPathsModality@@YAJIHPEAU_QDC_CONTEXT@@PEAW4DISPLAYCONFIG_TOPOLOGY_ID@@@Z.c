/*
 * XREFs of ?GetRequestedPathsModality@@YAJIHPEAU_QDC_CONTEXT@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x1C01460CC
 * Callers:
        ...
        enum DISPLAYCONFIG_TOPOLOGY_ID *a4)
{
  ...
  if ( (a1 & 0x200000) != 0 )
  {
    ...
    DisplayConfigBufferSizes = DxgkGetDisplayConfigBufferSizes(v17, &v27, (__int64)a3);
