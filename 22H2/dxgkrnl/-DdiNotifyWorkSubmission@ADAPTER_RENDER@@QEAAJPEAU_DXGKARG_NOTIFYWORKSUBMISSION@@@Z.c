/*
 * XREFs of ?DdiNotifyWorkSubmission@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_NOTIFYWORKSUBMISSION@@@Z @ 0x1C02C8D54
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C013F870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5166);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5166);
  ...
  v10 = (*(int (__fastcall **)(struct _DXGKARG_NOTIFYWORKSUBMISSION *))(*((_QWORD *)this + 2) + 1552LL))(a2);
  if ( v19[0] )
