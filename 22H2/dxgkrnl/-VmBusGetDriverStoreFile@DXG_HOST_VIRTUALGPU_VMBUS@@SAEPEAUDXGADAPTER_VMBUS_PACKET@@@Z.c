/*
 * XREFs of ?VmBusGetDriverStoreFile@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C02423C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CDriverStoreCopy@@QEAA@XZ @ 0x1C0261FF0 (--0CDriverStoreCopy@@QEAA@XZ.c)
