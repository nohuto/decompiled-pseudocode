/*
 * XREFs of ?ReadVirtualFunctionConfig@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_READVIRTUALFUNCTIONCONFIG@@@Z @ 0x1C0230FE8
 * Callers:
 *     DxgkDdiReadVirtualFunctionConfig @ 0x1C0232268 (DxgkDdiReadVirtualFunctionConfig.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::ReadVirtualFunctionConfig(__int64 a1, int a2, __int64 a3)
{
  ...
  {
    v10 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, __int64))(*(_QWORD *)VirtualGpuByIndex + 48LL))(
            VirtualGpuByIndex,
            a3);
  }
  else
