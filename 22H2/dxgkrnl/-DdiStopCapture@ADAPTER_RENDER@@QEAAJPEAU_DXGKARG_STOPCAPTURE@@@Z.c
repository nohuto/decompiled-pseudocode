/*
 * XREFs of ?DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C02204C8
 * Callers:
 *     ?ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C00424E0 (-ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiStopCapture(ADAPTER_RENDER *this, struct _DXGKARG_STOPCAPTURE *a2, __int64 a3)
{
  ...
  _QWORD *v16; // rax
  __int64 v17; // rcx
  struct _DXGKARG_STOPCAPTURE *v18; // rax
  void *v19; // rdx
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5039LL);
  ...
  v12 = (void *)(*(int (__fastcall **)(_QWORD, struct _DXGKARG_STOPCAPTURE *))(*((_QWORD *)this + 2) + 592LL))(
  ...
  v18 = (struct _DXGKARG_STOPCAPTURE *)WdLogNewEntry5_WdTrace(v13, v11);
  v18[3].hAllocation = v12;
  v19 = *(void **)(*((_QWORD *)this + 2) + 272LL);
  v18[4].hAllocation = v19;
  hAllocation = a2->hAllocation;
  v18[5].hAllocation = a2->hAllocation;
  if ( (_DWORD)v12 )
  {
    v21 = WdLogNewEntry5_WdError(hAllocation, v19);
    *(_QWORD *)(v21 + 24) = v12;
