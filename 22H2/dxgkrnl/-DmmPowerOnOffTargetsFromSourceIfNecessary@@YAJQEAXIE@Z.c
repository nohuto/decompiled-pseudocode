/*
 * XREFs of ?DmmPowerOnOffTargetsFromSourceIfNecessary@@YAJQEAXIE@Z @ 0x1C00E5A90
 * Callers:
...
__int64 __fastcall DmmPowerOnOffTargetsFromSourceIfNecessary(PERESOURCE *a1, __int64 a2, char a3)
{
  __int64 v3; // rsi
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  __int64 v17; // rax
  _QWORD *v18; // rax
  char v19[8]; // [rsp+50h] [rbp-138h] BYREF
...
LABEL_11:
  ...
  if ( Address )
  {
    ...
    v19[0] = 0;
    v10 = VIDPN_MGR::SetTimingsFromVidPn(Address, 0LL, 4LL, 0LL, v21, v19, a3, 0LL, 0LL);
    v13 = v10;
    if ( v10 < 0 )
    {
