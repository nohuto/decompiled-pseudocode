/*
 * XREFs of ?DdiGetDisplayStateNonIntrusive@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETDISPLAYSTATE_NONINTRUSIVE@@@Z @ 0x1C021C0D4
 * Callers:
        ...
        __int64 a3)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rcx
  __int64 (__fastcall *v13)(_QWORD, struct _DXGKARG_GETDISPLAYSTATE_NONINTRUSIVE *); // rax
  int v14; // ebx
  _QWORD *v15; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5147LL);
  ...
  if ( v12
    && (v13 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETDISPLAYSTATE_NONINTRUSIVE *))(v12 + 32)) != 0LL )
  {
