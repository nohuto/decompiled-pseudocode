/*
 * XREFs of DpiDxgkDdiQueryChildStatus @ 0x1C01785EC
 * Callers:
...
__int64 __fastcall DpiDxgkDdiQueryChildStatus(__int64 a1, __int64 a2, __int64 a3, unsigned __int8 a4)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
  {
    ...
    v20 = 0;
    v18 = 0;
    McTemplateK0pdqttq_EtwWriteTransfer(a1, &EventEnterDdiQueryChildStatus, a3, a2, v18, v20, v22, v24, v26);
  }
  LOBYTE(a3) = v5;
  ...
  if ( bTracingEnabled )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    {
      ...
      LODWORD(v19) = v10;
      LODWORD(v17) = v4;
      McTemplateK0pdqttq_EtwWriteTransfer(
        (unsigned __int8)v11,
