/*
 * XREFs of ?UpdatePostComposition@@YAXIEIIPEAVADAPTER_DISPLAY@@@Z @ 0x1C01593F0
 * Callers:
...
void __fastcall UpdatePostComposition(__int64 a1, __int64 a2, int a3, int a4, struct ADAPTER_DISPLAY *a5)
{
  ...
  struct _KTHREAD **v44; // [rsp+20h] [rbp-38h] BYREF
  char v45; // [rsp+28h] [rbp-30h]

  v5 = 0;
  v7 = (unsigned int)a1;
  v45 = 0;
  v9 = a2;
  v44 = (struct _KTHREAD **)((char *)a5 + 400);
  if ( a5 == (struct ADAPTER_DISPLAY *)-400LL )
  {
  ...
  *((_DWORD *)v22 + 6) = v24;
  ...
  if ( v5 )
  {
    ...
    if ( v37 )
    {
      ...
      *((_DWORD *)v38 + 4) = v7;
      Current = DXGPROCESS::GetCurrent(v40, v39, v41, v42);
