/*
 * XREFs of ?CommitVidPn@VIDPN_MGR@@QEAAJPEBVDMMVIDPN@@QEAXIW4_D3DKMDT_MONITOR_CONNECTIVITY_CHECKS@@EEAEBU_DMM_COMMITVIDPNREQUEST_DIAGINFO@@PEAE@Z @ 0x1C03ABF4C
 * Callers:
        ...
        unsigned __int8 *a9)
{
  ...
  *(_QWORD *)&v27.Flags = a6 & 1 | (2 * (v14 & 1u));
  if ( !*((_QWORD *)this + 1) )
    WdLogSingleEntry0(1LL);
  if ( (int)MonitorIsUsingSimulatedMonitor(*(DXGADAPTER **)(*((_QWORD *)this + 1) + 16LL), &a7, (__int64)a3, a4) < 0 )
    WdLogSingleEntry0(1LL);
  if ( (_BYTE)a7 || v14 )
