/*
 * XREFs of ?VmBusChannelProcessPacketCblt@DXG_HOST_VIRTUALGPU_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C0027130
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v9 = 0;
  v33 = 0LL;
  v34 = ((__int64 (*)(void))qword_1C00B4348)();
  Next = 0;
  v13 = *(_QWORD *)(v34 + 104);
