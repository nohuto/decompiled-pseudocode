/*
 * XREFs of DpiFdoStartAdapter @ 0x1C0200110
 * Callers:
 ...
 *     ?DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z @ 0x1C001D4D0 (-DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z.c)
 ...
 *     DpiHybridInternalPanelOverride @ 0x1C005ED64 (DpiHybridInternalPanelOverride.c)
                ...
                3) >= 0 )
    {
      if ( a6 )
      {
        ...
        if ( v12 )
        {
          ...
          if ( v13 < 0 )
          {
            v15 = *((_QWORD *)DeviceExtension + 131);
LABEL_9:
            WdLogSingleEntry2(2LL, v15, started);
            goto LABEL_10;
          }
        }
      }
  ...
  if ( DeviceExtension[1152] == 1 )
  {
    ...
    if ( v9 )
    {
      ...
      *(_BYTE *)(v9 + 3920) = (4 * (!v31 && !v32)) | *(_BYTE *)(v9 + 3920) & 0xFB;
    }
  }
  while ( 1 )
  {
  ...
  if ( (int)started < 0 )
  {
    ...
    if ( (_DWORD)started != -1071775735 )
    {
      if ( (_DWORD)started == -1071774944 && DeviceExtension[1152] )
        WdLogSingleEntry5(0LL, 275LL, 26LL, v11, (unsigned __int8)byte_1C0140495, 0LL);
      goto LABEL_10;
    }
    P = 0LL;
...
LABEL_28:
  ...
  {
    v54 = (_BYTE *)(v9 + 2692);
    if ( *(_BYTE *)(v9 + 2692) && (v53 & 1) != 0 && !(_BYTE)word_1C014049C )
      qword_1C01404B0 = (__int64)a1;
  }
  else
  {
    if ( (v53 & 1) != 0
  ...
  if ( (*v44 & 0x40) != 0 )
  {
    if ( qword_1C01404A8 && (struct _DEVICE_OBJECT *)qword_1C01404A8 != a1 )
    {
      if ( !*v54 || (_BYTE)word_1C014049C )
      {
        *v44 &= ~0x40u;
        goto LABEL_147;
      }
      *(_BYTE *)(*(_QWORD *)(qword_1C01404A8 + 64) + 3920LL) &= ~0x40u;
    }
    qword_1C01404A8 = (__int64)a1;
    HIBYTE(word_1C014049C) = (*(_BYTE *)(v9 + 3921) & 2) != 0;
  }
LABEL_147:
  if ( qword_1C01404B0 && qword_1C01404A8 && !(_BYTE)word_1C014049C )
  {
    v55 = *(_BYTE *)(*(_QWORD *)(qword_1C01404B0 + 64) + 2692LL);
    if ( *(_BYTE *)(*(_QWORD *)(qword_1C01404A8 + 64) + 2692LL) )
    {
      if ( !v55 )
        goto LABEL_152;
    }
...
LABEL_272:
  ...
  if ( v9 )
  {
    ...
    if ( DeviceExtension[1152] )
    {
      if ( qword_1C0140748 )
      {
        v111 = *(_QWORD *)(qword_1C0140748 + 64);
        if ( v111 )
        {
          v112 = *(_QWORD *)(v111 + 40);
          if ( v112 )
