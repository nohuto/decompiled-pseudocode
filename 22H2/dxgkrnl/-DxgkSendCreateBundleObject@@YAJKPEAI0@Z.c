/*
 * XREFs of ?DxgkSendCreateBundleObject@@YAJKPEAI0@Z @ 0x1C028AFF8
 * Callers:
...
__int64 __fastcall DxgkSendCreateBundleObject(__int64 a1, unsigned int *a2, unsigned int *a3, __int64 a4)
{
...
LABEL_15:
    ...
    {
      BundleObject = DXGSESSIONDATA::VailSendCreateBundleObject(SessionDataForSpecifiedSession, v6, a2, a3);
      v7 = BundleObject;
      if ( BundleObject < 0 )
        goto LABEL_15;
    }
