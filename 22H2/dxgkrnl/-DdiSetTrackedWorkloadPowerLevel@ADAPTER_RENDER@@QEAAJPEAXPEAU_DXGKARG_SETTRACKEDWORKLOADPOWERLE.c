/*
 * XREFs of ?DdiSetTrackedWorkloadPowerLevel@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_SETTRACKEDWORKLOADPOWERLEVEL@@@Z @ 0x1C021F974
 * Callers:
        ...
        struct _DXGKARG_SETTRACKEDWORKLOADPOWERLEVEL *a3)
{
  ...
  if ( *(_QWORD *)(*((_QWORD *)this + 2) + 1304LL) )
  {
    ...
    v15 = 0LL;
    if ( CurrentIrql < 2u && (v16 = DXGTHREAD::GetCurrent(v13, v12), (v15 = v16) != 0LL) )
      v17 = *((_DWORD *)v16 + 8);
    else
      v17 = 0;
    ...
    v10 = (*(int (__fastcall **)(void *, struct _DXGKARG_SETTRACKEDWORKLOADPOWERLEVEL *))(*((_QWORD *)this + 2) + 1304LL))(
            a2,
            a3);
    if ( v34[0] )
    ...
    v23 = WdLogNewEntry5_WdTrace(v19, v18);
    *(_QWORD *)(v23 + 24) = v10;
    *(_QWORD *)(v23 + 32) = a2;
