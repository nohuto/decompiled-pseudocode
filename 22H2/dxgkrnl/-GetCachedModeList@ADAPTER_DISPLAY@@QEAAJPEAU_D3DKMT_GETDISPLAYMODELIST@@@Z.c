/*
 * XREFs of ?GetCachedModeList@ADAPTER_DISPLAY@@QEAAJPEAU_D3DKMT_GETDISPLAYMODELIST@@@Z @ 0x1C01AB8D8
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::GetCachedModeList(ADAPTER_DISPLAY *this, struct _D3DKMT_GETDISPLAYMODELIST *a2)
{
  ...
  if ( !a2 )
  {
    WdLogSingleEntry1(1LL, 6393LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pOutputDisplayModeList != NULL", 6393LL, 0LL, 0LL, 0LL, 0LL);
  }
