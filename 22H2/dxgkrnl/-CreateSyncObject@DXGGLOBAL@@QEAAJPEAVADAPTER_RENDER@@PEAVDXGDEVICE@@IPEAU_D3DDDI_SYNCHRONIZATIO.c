/*
 * XREFs of ?CreateSyncObject@DXGGLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAVDXGDEVICE@@IPEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@_NPEAVDXGPAGINGQUEUE@@PEAPEAVDXGSYNCOBJECT@@PEAPEAVDXGDEVICESYNCOBJECT@@PEAIPEAPEAVDXGADAPTERSYNCOBJECT@@@Z @ 0x1C01A6A78
 * Callers:
 ...
 *     ??0DXGADAPTERSYNCOBJECT@@QEAA@PEAVADAPTER_RENDER@@@Z @ 0x1C01A6C98 (--0DXGADAPTERSYNCOBJECT@@QEAA@PEAVADAPTER_RENDER@@@Z.c)
 *     ??0DXGSYNCOBJECT@@IEAA@PEAVDXGGLOBAL@@PEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@@Z @ 0x1C01A6CBC (--0DXGSYNCOBJECT@@IEAA@PEAVDXGGLOBAL@@PEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJE.c)
        ...
        struct DXGADAPTERSYNCOBJECT **a12)
{
  ...
  if ( !a5 )
  {
    WdLogSingleEntry1(1LL, 2661LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pObjectInfo != NULL", 2661LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( a9 )
  {
    *a9 = 0LL;
...
LABEL_11:
      *(_DWORD *)(v16 + 284) ^= (*(_DWORD *)(v16 + 284) ^ (2 * *(unsigned __int8 *)(*((_QWORD *)a2 + 2) + 209LL))) & 2;
      ...
      if ( v19 >= 0 )
      {
        ...
        {
          DXGSYNCOBJECT::AddReference((DXGSYNCOBJECT *)v16);
          goto LABEL_16;
        }
