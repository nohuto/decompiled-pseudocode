/*
 * XREFs of ?_ProcessDisplayIDBlob@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02FB38C
 * Callers:
 ...
 *     ?SetPhysicalDimensionOfInternalPanel@EDIDCACHE@@QEAAXJJE@Z @ 0x1C017D970 (-SetPhysicalDimensionOfInternalPanel@EDIDCACHE@@QEAAXJJE@Z.c)
...
LABEL_19:
  ...
  if ( !*((_DWORD *)this + 52) )
    DXGMONITOR::_CreateDefaultMonitorProfileForWDDMv1_0(this);
