/*
 * XREFs of ?RemoveUsb4HRPowerRef@Usb4HostRouterPoFxRef@DxgMonitor@@QEAAJXZ @ 0x1C03CAB34
 * Callers:
...
__int64 __fastcall DxgMonitor::Usb4HostRouterPoFxRef::RemoveUsb4HRPowerRef(DxgMonitor::Usb4HostRouterPoFxRef *this)
{
  ...
  if ( *((_BYTE *)this + 24) )
  {
    ...
    *((_BYTE *)this + 24) = 0;
    ...
    {
      if ( tlgKeywordOn((__int64)&dword_1C013F8A8, 0x8000LL) )
      {
        v7 = *((_DWORD *)this + 2);
        v14 = 0;
        v10 = v7;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)dword_1C00AAE25,
          0LL,
          0LL,
          3u,
          &v11);
