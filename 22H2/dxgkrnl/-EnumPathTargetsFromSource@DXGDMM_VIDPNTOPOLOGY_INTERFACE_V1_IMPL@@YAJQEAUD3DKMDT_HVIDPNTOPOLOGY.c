/*
 * XREFs of ?EnumPathTargetsFromSource@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTOPOLOGY__@@I_KPEAI@Z @ 0x1C01E2C60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  if ( a4 )
  {
    *a4 = -1;
    ...
    {
      v23 = -1;
      v10 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v8, (char *)(unsigned int)v7, a3, &v23);
      v6 = v10;
      if ( v10 < 0 )
      {
