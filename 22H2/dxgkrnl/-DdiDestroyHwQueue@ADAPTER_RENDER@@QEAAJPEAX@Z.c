/*
 * XREFs of ?DdiDestroyHwQueue@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C02C6B30
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyHwQueue@@YAJPEAVADAPTER_RENDER@@QEAX@Z @ 0x1C0048C30 (-ADAPTER_RENDER_DdiDestroyHwQueue@@YAJPEAVADAPTER_RENDER@@QEAX@Z.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyHwQueue(ADAPTER_RENDER *this, void *a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v19, 5111);
  ...
  v12 = *(__int64 (__fastcall **)(void *))(*((_QWORD *)this + 2) + 1104LL);
  if ( v12 )
    v13 = v12(a2);
  else
    v13 = -1073741822;
  ...
  if ( (_BYTE)v8 != KeGetCurrentIrql() )
  {
    ...
    WdLogSingleEntry5(0LL, 275LL, 16LL, this, v8, v14);
  }
  if ( v9 )
  {
    v15 = *((int *)v9 + 12);
    if ( (_DWORD)v15 != v11 )
      WdLogSingleEntry5(0LL, 275LL, 38LL, v15, v11, 0LL);
  }
