/*
 * XREFs of ?TokenThread@CTokenManager@@UEAAJPEAXPEAUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x1C0019E20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z @ 0x1C0019EEC (-ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z.c)
