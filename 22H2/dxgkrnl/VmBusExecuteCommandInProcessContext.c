/*
 * XREFs of VmBusExecuteCommandInProcessContext @ 0x1C00D9364
 * Callers:
...
char __fastcall VmBusExecuteCommandInProcessContext(_QWORD *a1, __int64 (__fastcall *a2)(unsigned __int64))
{
  __int64 v2; // rbp
  __int64 v3; // rdi
  __int64 v6; // rdx
  ...
  if ( *(_DWORD *)(v3 + 8) )
  {
    ...
    v10 = (*(_DWORD *)(v3 + 8) >> 6) & 0xFFFFFF;
    if ( (unsigned int)v10 < *(_DWORD *)(v2 + 256) )
    {
      v11 = *(_QWORD *)(v2 + 240);
      v12 = *(_DWORD *)(v11 + 16 * v10 + 8);
      if ( ((*(_DWORD *)(v3 + 8) >> 25) & 0x60) == (*(_BYTE *)(v11 + 16 * v10 + 8) & 0x60)
        && (v12 & 0x2000) == 0
        && (v12 & 0x1F) != 0 )
      {
        v13 = v12 & 0x1F;
        ...
        {
          v14 = WdLogNewEntry5_WdError(v13, (*(_DWORD *)(v3 + 8) >> 25) & 0x60);
          *(_QWORD *)(v14 + 24) = 316LL;
        }
...
LABEL_13:
  ...
  if ( !_bittest64(&v7, v18) )
    goto LABEL_26;
  v15 = (struct _EX_RUNDOWN_REF *)a1[12];
LABEL_18:
  if ( !v15 )
  {
LABEL_26:
    v23 = WdLogNewEntry5_WdError(v7, v6);
    *(_QWORD *)(v23 + 24) = *(unsigned int *)(v3 + 8);
  ...
  {
    a1[11] = v15;
    v8 = a2((unsigned __int64)(a1 + 5) & -(__int64)(a1 != 0LL));
  }
  else
  {
