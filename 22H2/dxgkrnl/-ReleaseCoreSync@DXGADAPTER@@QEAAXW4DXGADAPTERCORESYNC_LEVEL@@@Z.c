/*
 * XREFs of ?ReleaseCoreSync@DXGADAPTER@@QEAAXW4DXGADAPTERCORESYNC_LEVEL@@@Z @ 0x1C012E224
 * Callers:
 *     ?DXGADAPTER_ReleaseCoreSync@@YAXPEAVDXGADAPTER@@W4DXGADAPTERCORESYNC_LEVEL@@@Z @ 0x1C0042580 (-DXGADAPTER_ReleaseCoreSync@@YAXPEAVDXGADAPTER@@W4DXGADAPTERCORESYNC_LEVEL@@@Z.c)
...
LABEL_11:
    v8 = *(_QWORD *)(a1 + 2704);
    if ( v8 )
      ADAPTER_RENDER::FlushScheduler(v8, v6, 0xFFFFFFFF, 0);
    if ( *(_DWORD *)(a1 + 160) == 1 )
    {
