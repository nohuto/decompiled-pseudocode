/*
 * XREFs of ?Initialize@CFlipExBuffer@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SWAPCHAIN_BUFFER_INFO@@_N@Z @ 0x1C0011FD4
 * Callers:
 ...
 *     DxgkGetSharedSyncObjectType @ 0x1C0156140 (DxgkGetSharedSyncObjectType.c)
 */
