/*
 * XREFs of ?DxgkHandleDiagnosticNotifications@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C004CA00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( (Value & 1) != 0 )
  {
    ...
    {
      v11 = (unsigned __int8 *)&unk_1C00800CE;
      v35 = a1->TargetId;
...
LABEL_24:
  ...
  else
  {
    ...
    {
      v11 = (unsigned __int8 *)&unk_1C007FFD1;
      v35 = a1->TargetId;
      v36 = a1->SequenceNumber;
      p_TargetId = v32;
      v34 = v19;
