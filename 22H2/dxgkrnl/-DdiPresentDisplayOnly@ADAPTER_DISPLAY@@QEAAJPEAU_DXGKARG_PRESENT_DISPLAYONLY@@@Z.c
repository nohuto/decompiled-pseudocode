/*
 * XREFs of ?DdiPresentDisplayOnly@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_PRESENT_DISPLAYONLY@@@Z @ 0x1C02C9564
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v20, 5048);
  ...
  v16[3] = v10;
  v16[4] = a2->VidPnSourceId;
  v16[5] = a2->pSource;
  v16[6] = a2->NumMoves;
  v16[7] = a2->NumDirtyRects;
