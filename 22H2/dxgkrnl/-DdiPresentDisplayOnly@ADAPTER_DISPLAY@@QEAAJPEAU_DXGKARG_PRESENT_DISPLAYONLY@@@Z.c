/*
 * XREFs of ?DdiPresentDisplayOnly@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_PRESENT_DISPLAYONLY@@@Z @ 0x1C021CEE4
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5048LL);
  ...
  {
    v21 = WdLogNewEntry5_WdError(NumDirtyRects, v19);
    *(_QWORD *)(v21 + 24) = v12;
