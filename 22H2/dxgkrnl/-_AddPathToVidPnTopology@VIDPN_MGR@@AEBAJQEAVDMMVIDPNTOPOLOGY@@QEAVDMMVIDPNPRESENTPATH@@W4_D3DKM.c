/*
 * XREFs of ?_AddPathToVidPnTopology@VIDPN_MGR@@AEBAJQEAVDMMVIDPNTOPOLOGY@@QEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_MONITOR_CONNECTIVITY_CHECKS@@E@Z @ 0x1C019A714
 * Callers:
        ...
        unsigned __int8 a5)
{
  ...
  else
  {
    ...
    v28 = -1;
    v20 = Container + 88;
    v21 = VIDPN_MGR::FormalizeVidPnChange(this, v19 & -(__int64)(v19 != -88), 1LL, v18, &v27, 1LL);
    LODWORD(v16) = v21;
    if ( v21 >= 0 )
      return 0LL;
    if ( v21 == -1071774975 )
