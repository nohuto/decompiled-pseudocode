/*
 * XREFs of ?EnsureServerVmBusInterface@@YAJXZ @ 0x1C0375418
 * Callers:
...
__int64 EnsureServerVmBusInterface(void)
{
  ...
  {
    ((void (__fastcall *)(__int64))qword_1C0141EB0)(qword_1C0141EA8);
  ...
  else
  {
    ...
    if ( DeviceObjectPointer >= 0 )
    {
      ...
      if ( v5 )
      {
        ...
        {
          v9 = Status;
          WdLogSingleEntry2(2LL, Status, 16522LL);
      ...
      {
        WdLogSingleEntry2(2LL, -1073741670LL, 16494LL);
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
