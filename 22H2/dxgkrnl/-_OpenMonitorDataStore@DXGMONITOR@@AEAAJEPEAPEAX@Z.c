/*
 * XREFs of ?_OpenMonitorDataStore@DXGMONITOR@@AEAAJEPEAPEAX@Z @ 0x1C018464C
 * Callers:
 ...
 *     ?_RetrieveMonitorConfigurationFromMonitorStore@DXGMONITOR@@AEAAJXZ @ 0x1C0184028 (-_RetrieveMonitorConfigurationFromMonitorStore@DXGMONITOR@@AEAAJXZ.c)
 ...
 *     ?_SaveWCGEnforcedToMonitorStore@DXGMONITOR@@AEAAJE@Z @ 0x1C02F6BB0 (-_SaveWCGEnforcedToMonitorStore@DXGMONITOR@@AEAAJE@Z.c)
 *     ?_SetAppOverride@DXGMONITOR@@QEAAJU_GUID@@I_K@Z @ 0x1C02F6C80 (-_SetAppOverride@DXGMONITOR@@QEAAJU_GUID@@I_K@Z.c)
 *     ?_UpdateMonitorConfigurationToMonitorStore@DXGMONITOR@@AEAAJK@Z @ 0x1C02F6E3C (-_UpdateMonitorConfigurationToMonitorStore@DXGMONITOR@@AEAAJK@Z.c)
 * Callees:
...
__int64 __fastcall DXGMONITOR::_OpenMonitorDataStore(DXGMONITOR *this, __int64 a2, void **a3)
{
  ...
  if ( !(_WORD)v7 )
  {
    v23 = WdLogNewEntry5_WdError(this, v7);
    *(_QWORD *)(v23 + 24) = this;
  ...
  if ( (*(_DWORD *)(v9 + 348) & 0x40000) != 0 )
  {
    ...
    v24 = WdLogNewEntry5_WdTrace(v26, v25);
    *(_QWORD *)(v24 + 24) = this;
