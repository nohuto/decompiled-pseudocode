/*
 * XREFs of HOSTVMMONITORMAPPING::RemoveMappingInternal__lambda_410e6522bb99cf0c876cbe7a3c34b555___ @ 0x1C0026628
 * Callers:
        ...
        __int64 *a2)
{
  ...
  v4 = -1073741275;
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v24, (struct DXGSPINLOCK *const)(a1 + 16), 1u);
  v5 = *(_QWORD **)a1;
  while ( v5 != (_QWORD *)a1 )
  {
    v6 = *a2;
