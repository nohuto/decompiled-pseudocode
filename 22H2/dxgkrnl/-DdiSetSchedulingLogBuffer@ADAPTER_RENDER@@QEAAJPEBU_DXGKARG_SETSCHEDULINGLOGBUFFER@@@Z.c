/*
 * XREFs of ?DdiSetSchedulingLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETSCHEDULINGLOGBUFFER@@@Z @ 0x1C021EB14
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetSchedulingLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETSCHEDULINGLOGBUFFER@@@Z @ 0x1C0042460 (-ADAPTER_RENDER_DdiSetSchedulingLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETSCHEDULINGLOGB.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  __int64 v16; // rdx
  __int64 v17; // rcx
  __int64 (__fastcall *v18)(_QWORD, const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *); // rax
  int v19; // ebx
  __int64 v20; // rcx
  _QWORD *v21; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v30, 5114LL);
  ...
  v17 = *((_QWORD *)this + 2);
  v18 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *))(v17 + 1192);
  if ( v18 )
