/*
 * XREFs of ?DxgkSubmitCommandInternal@@YAJPEBU_D3DKMT_SUBMITCOMMAND@@PEAVDXGPROCESS@@@Z @ 0x1C01C6A40
 * Callers:
...
__int64 __fastcall DxgkSubmitCommandInternal(const struct _D3DKMT_SUBMITCOMMAND *a1, struct DXGPROCESS *a2, __int64 a3)
{
  ...
  struct _EX_RUNDOWN_REF **v104; // [rsp+108h] [rbp-3F0h]
  ...
  else
  {
    if ( !ExAcquireResourceExclusiveLite(*(PERESOURCE *)(v18 + 136), 0) )
    {
      ...
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
        McTemplateK0q_EtwWriteTransfer(v51, &EventBlockThread, v52, 40);
...
LABEL_121:
    if ( !v56 || (v57 = *(_DWORD *)(v56 + 404), (v57 & 8) != 0) || *(_QWORD *)(v56 + 16) != *((_QWORD *)v17 + 2) )
    {
      ...
      DxgkLogInternalTriageEvent(
        ...
        0LL);
LABEL_134:
      DXGPROCESSDDILOCK::~DXGPROCESSDDILOCK((DXGPROCESSDDILOCK *)v111);
LABEL_136:
...
LABEL_47:
    ...
    if ( v65 && v66 )
    {
      ...
      while ( v67 < v5->NumHistoryBuffers )
      {
        ...
        v101 = v69;
        v70 = v69;
        v104 = (struct _EX_RUNDOWN_REF **)(v105 + 8LL * v67);
        AllocationSafe = (struct _EX_RUNDOWN_REF **)DXGPROCESS::GetAllocationSafe(
                                                      (__int64)v102,
                                                      (DXGALLOCATIONREFERENCE *)v108,
                                                      v69);
        ...
        v32[v67++] = (struct _VIDMM_MULTI_ALLOC *)v72[3].Count;
        v103 = v67;
      }
