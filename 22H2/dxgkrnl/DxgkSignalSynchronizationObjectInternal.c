/*
 * XREFs of DxgkSignalSynchronizationObjectInternal @ 0x1C016B0D0
 * Callers:
 *     ?AddSignalToContext@CAdapter@@UEAAJII_K@Z @ 0x1C0078D60 (-AddSignalToContext@CAdapter@@UEAAJII_K@Z.c)
 *     ?DxgkCddSignalSynchronizationObject@@YAJPEBU_D3DKMT_SIGNALSYNCHRONIZATIONOBJECT2@@@Z @ 0x1C016ADA0 (-DxgkCddSignalSynchronizationObject@@YAJPEBU_D3DKMT_SIGNALSYNCHRONIZATIONOBJECT2@@@Z.c)
 *     DxgkSignalSynchronizationObject @ 0x1C0353A00 (DxgkSignalSynchronizationObject.c)
 *     DxgkWslSignalSynchronizationObject @ 0x1C0354770 (DxgkWslSignalSynchronizationObject.c)
 * Callees:
