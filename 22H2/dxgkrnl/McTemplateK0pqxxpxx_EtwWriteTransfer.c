/*
 * XREFs of McTemplateK0pqxxpxx_EtwWriteTransfer @ 0x1C0071F04
 * Callers:
...
NTSTATUS McTemplateK0pqxxpxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(SysMmControlGuid_Context, &MapAddress, a3, 8u, &v4);
}
