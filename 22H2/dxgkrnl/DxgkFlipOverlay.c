/*
 * XREFs of DxgkFlipOverlay @ 0x1C027BFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkFlipOverlay(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _D3DKMT_FLIPOVERLAY v45; // [rsp+58h] [rbp-B0h] BYREF
  _BYTE v46[16]; // [rsp+78h] [rbp-90h] BYREF
  _BYTE v47[24]; // [rsp+88h] [rbp-80h] BYREF
  _BYTE v48[80]; // [rsp+A0h] [rbp-68h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v40, 2024LL);
...
LABEL_28:
  ...
  v45 = *v3;
  v43 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v39, v45.hDevice, (struct _KTHREAD **)Current, &v43);
  v15 = (struct ADAPTER_RENDER **)v43;
  if ( !v43 )
  {
    v16 = WdLogNewEntry5_WdError(v14, v13);
    *(_QWORD *)(v16 + 24) = v45.hDevice;
...
LABEL_25:
  ...
  v20 = (v45.hOverlay >> 6) & 0xFFFFFF;
  if ( (unsigned int)v20 >= *((_DWORD *)Current + 64) )
    goto LABEL_17;
  v19 = *((_QWORD *)Current + 30);
  v17 = *(unsigned int *)(v19 + 16 * v20 + 8);
  v18 = (v45.hOverlay >> 25) & 0x60;
  if ( ((v45.hOverlay >> 25) & 0x60) != (*(_BYTE *)(v19 + 16 * v20 + 8) & 0x60)
    || (v17 & 0x2000) != 0
    || (v17 & 0x1F) == 0 )
  {
    goto LABEL_17;
...
LABEL_23:
  ...
  if ( v27 >= 0 )
  {
    ...
    DXGOVERLAYMUTEX::DXGOVERLAYMUTEX((DXGOVERLAYMUTEX *)v46, v15[2]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v46);
    v34 = DXGOVERLAY::FlipOverlay(v22, &v45);
    DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v46, v35);
