/*
 * XREFs of ?_GetColorPrimariesType@MonitorColorState@DxgMonitor@@AEBA?AW4ColorPrimaryType@12@XZ @ 0x1C020BE18
 * Callers:
 ...
 * Callees:
 *     ?_GetColorGamutTriangleArea@MonitorColorState@DxgMonitor@@CANNNNNNN@Z @ 0x1C020BC9C (-_GetColorGamutTriangleArea@MonitorColorState@DxgMonitor@@CANNNNNNN@Z.c)
 *     ?_GetDeltaBetweenPoints@MonitorColorState@DxgMonitor@@CANNNNN@Z @ 0x1C020C078 (-_GetDeltaBetweenPoints@MonitorColorState@DxgMonitor@@CANNNNN@Z.c)
 */
