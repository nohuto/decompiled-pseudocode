/*
 * XREFs of ?NotifyVSync@ADAPTER_DISPLAY@@QEAAXIAEA_K@Z @ 0x1C000BF4C
 * Callers:
      ...
      if ( v10 )
      {
        ...
        if ( v12 - v11 > (unsigned __int64)*((unsigned int *)this + 20 * v7 + 226) )
        {
          ...
          else if ( !*((_BYTE *)this + 80 * v8 + 880) )
          {
            ...
            {
              if ( tlgKeywordOn((__int64)&dword_1C013F8E0, 0x4000LL) )
              {
                v15 = 0;
                v17 = &v15;
                v18 = 2LL;
                tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C013F8E0, (int)&dword_1C00A70FC, 0, 0, 3u, &v16);
                v12 = *a3;
              }
            }
          }
