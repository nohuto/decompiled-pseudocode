/*
 * XREFs of ?_GetDeltaBetweenPoints@MonitorColorState@DxgMonitor@@CANNNNN@Z @ 0x1C020C078
 * Callers:
 ...
 * Callees:
 *     ?_GetSqrt@MonitorColorState@DxgMonitor@@CANN@Z @ 0x1C020C0C4 (-_GetSqrt@MonitorColorState@DxgMonitor@@CANN@Z.c)
 */
