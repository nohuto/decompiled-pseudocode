/*
 * XREFs of ?_CreateDefaultMonitorProfileForWDDMv1_0@MonitorModes@DxgMonitor@@AEAAJXZ @ 0x1C03CCEE8
 * Callers:
...
__int64 __fastcall DxgMonitor::MonitorModes::_CreateDefaultMonitorProfileForWDDMv1_0(DxgMonitor::MonitorModes *this)
{
  ...
  *((_QWORD *)&v17 + 1) = 8LL;
  while ( 2 )
  {
    ...
    do
    {
      v6 = word_1C011AC90[2 * v3 + 1];
      v7 = *v5;
      v8 = word_1C011AC90[2 * v3];
      memset(&v18, 0, sizeof(v18));
      VideoModeDescriptor = GTF_GetVideoModeDescriptor(v8, v6, v7, 1u, 0, &v18);
      v10 = VideoModeDescriptor;
      if ( VideoModeDescriptor < 0 )
      {
        WdLogSingleEntry4(2LL, word_1C011AC90[2 * v3], word_1C011AC90[2 * v3 + 1], aFhku[v4], VideoModeDescriptor);
        goto LABEL_20;
      }
