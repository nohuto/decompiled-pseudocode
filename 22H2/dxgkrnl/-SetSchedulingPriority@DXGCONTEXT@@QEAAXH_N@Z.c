/*
 * XREFs of ?SetSchedulingPriority@DXGCONTEXT@@QEAAXH_N@Z @ 0x1C00E51F0
 * Callers:
 ...
 *     ?UpdatePriorityClass@DXGDEVICE@@QEAAX_N@Z @ 0x1C00E519C (-UpdatePriorityClass@DXGDEVICE@@QEAAX_N@Z.c)
 * Callees:
