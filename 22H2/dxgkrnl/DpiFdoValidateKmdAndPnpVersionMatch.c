/*
 * XREFs of DpiFdoValidateKmdAndPnpVersionMatch @ 0x1C018AE6C
 * Callers:
 *     DpiFdoInitializeFdo @ 0x1C018DAEC (DpiFdoInitializeFdo.c)
 * Callees:
 *     _tlgKeywordOn @ 0x1C000C284 (_tlgKeywordOn.c)
 *     ?RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z @ 0x1C0022C5C (-RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z.c)
 ...
 *     IsKnownMismatchedVersionedDriver @ 0x1C02C8A50 (IsKnownMismatchedVersionedDriver.c)
 */
...
LABEL_59:
        ...
        while ( 1 )
        {
          ...
          if ( v23 > 3 )
          {
            ...
            {
              if ( (unsigned int)dword_1C00B1A90 > 5 && tlgKeywordOn((__int64)&dword_1C00B1A90, 0x400000000100LL) )
              {
                v45 = *(_DWORD *)(a1 + 1140);
                v46 = *(_DWORD *)(a1 + 1136);
                v47 = *(_DWORD *)(a1 + 1132);
