/*
 * XREFs of ?Destroy@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXXZ @ 0x1C01E85B8
 * Callers:
 *     ??1DXGPRESENTHISTORYTOKENQUEUE@@QEAA@XZ @ 0x1C01E85A0 (--1DXGPRESENTHISTORYTOKENQUEUE@@QEAA@XZ.c)
 * Callees:
