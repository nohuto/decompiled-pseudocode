/*
 * XREFs of ?CreateGpadlFromBuffer@DXG_GUEST_GLOBAL_VMBUS@@QEAAJPEAXIPEAI@Z @ 0x1C02385B8
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  v8 = *this;
  v12 = 1;
  LODWORD(a4) = ((__int64 (__fastcall *)(struct _KTHREAD *, _QWORD, void *, _QWORD, unsigned int *))qword_1C00B4310)(
                  v8,
                  0LL,
                  a2,
                  a3,
