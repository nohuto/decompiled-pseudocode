/*
 * XREFs of ?Initialize@DXGSYNCOBJECT@@QEAAJPEAVDXGPAGINGQUEUE@@PEAVDXGDEVICE@@@Z @ 0x1C00DCAA8
 * Callers:
 ...
 *     ?Initialize@DXGSYNCOBJECTCA@@QEAAJXZ @ 0x1C0291454 (-Initialize@DXGSYNCOBJECTCA@@QEAAJXZ.c)
 */
