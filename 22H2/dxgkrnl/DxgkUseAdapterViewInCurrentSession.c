/*
 * XREFs of DxgkUseAdapterViewInCurrentSession @ 0x1C016463C
 * Callers:
 ...
 *     ?AddDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z @ 0x1C016483C (-AddDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z.c)
