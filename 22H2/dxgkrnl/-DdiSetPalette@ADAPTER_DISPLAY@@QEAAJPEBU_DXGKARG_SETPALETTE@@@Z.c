/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C021E6D0
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5017LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPALETTE *))(*((_QWORD *)this + 2) + 456LL))(
  ...
  if ( (_DWORD)v12 )
  {
    v21 = WdLogNewEntry5_WdError(VidPnSourceId, v19);
    *(_QWORD *)(v21 + 24) = v12;
