/*
 * XREFs of ?DdiSetInterruptTargetPresentId@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_SETINTERRUPTTARGETPRESENTID@@@Z @ 0x1C0044D58
 * Callers:
 *     ?ADAPTER_DISPLAY_DdiSetInterruptTargetPresentId@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_SETINTERRUPTTARGETPRESENTID@@@Z @ 0x1C0048AB0 (-ADAPTER_DISPLAY_DdiSetInterruptTargetPresentId@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_SETINTERRU.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C013F870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5155);
  }
  else
  {
    v21 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v19, 5155);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETINTERRUPTTARGETPRESENTID *))(*((_QWORD *)this + 2) + 1424LL))(
