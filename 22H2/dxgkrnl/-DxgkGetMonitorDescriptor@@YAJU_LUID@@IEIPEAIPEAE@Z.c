/*
 * XREFs of ?DxgkGetMonitorDescriptor@@YAJU_LUID@@IEIPEAIPEAE@Z @ 0x1C01D8850
 * Callers:
 *     DxgkGetMonitorEdid @ 0x1C01D8820 (DxgkGetMonitorEdid.c)
 *     DxgkGetMonitorDisplayId @ 0x1C02FCC30 (DxgkGetMonitorDisplayId.c)
 * Callees:
        ...
        unsigned __int8 *a6)
{
  ...
  v10 = DxgkConvertLegacyQDCAdapterAndIdToActual(&v39, (unsigned int)v9, &v38, &v37);
  v11 = v10;
  if ( v10 < 0 )
  {
    v27 = v9;
  ...
  else
  {
    ...
    if ( MonitorHandle >= 0 )
    {
      ...
      {
        DisplayIDFromMonitor = MonitorGetDisplayIDFromMonitor(v19, (unsigned int)v8, v42, v41);
