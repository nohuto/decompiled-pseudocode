/*
 * XREFs of ?VmBusCreateDevice@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023E970
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1DXGADAPTERDEVICECREATIONLOCKCDD@@QEAA@XZ @ 0x1C003BC2C (--1DXGADAPTERDEVICECREATIONLOCKCDD@@QEAA@XZ.c)
 *     ??1DXGPROCESSDEVICECREATIONLOCK@@QEAA@XZ @ 0x1C003BC64 (--1DXGPROCESSDEVICECREATIONLOCK@@QEAA@XZ.c)
