/*
 * XREFs of ?DdiDestroyPeriodicFrameNotification@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_DESTROYPERIODICFRAMENOTIFICATION@@@Z @ 0x1C021A94C
 * Callers:
 *     ?ADAPTER_DISPLAY_DdiDestroyPeriodicFrameNotification@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_DESTROYPERIODICFRAMENOTIFICATION@@@Z @ 0x1C0042160 (-ADAPTER_DISPLAY_DdiDestroyPeriodicFrameNotification@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_DESTR.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5075LL);
  ...
  v18 = WdLogNewEntry5_WdTrace(v13, v11);
  *(_QWORD *)(v18 + 24) = v12;
  hNotification = a2->hNotification;
  *(_QWORD *)(v18 + 32) = a2->hNotification;
  if ( (_DWORD)v12 != -1073741811 && (_DWORD)v12 )
  {
    v21 = WdLogNewEntry5_WdError(hNotification, v19);
    *(_QWORD *)(v21 + 24) = v12;
