/*
 * XREFs of ?EdidSupportsHDR@DXGMONITOR@@QEAAEXZ @ 0x1C01834E4
 * Callers:
 ...
 * Callees:
 *     ?EdidColorDepthMoreThanSDR@DXGMONITOR@@QEAAEXZ @ 0x1C0022570 (-EdidColorDepthMoreThanSDR@DXGMONITOR@@QEAAEXZ.c)
 */
