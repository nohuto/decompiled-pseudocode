/*
 * XREFs of ?PrepareStagingBuffer@BLTQUEUE@@QEAAJPEAVDXGDEVICE@@IPEAVCOREDEVICEACCESS@@@Z @ 0x1C03D20D0
 * Callers:
...
LABEL_18:
    if ( !*((_DWORD *)this + 704) )
    {
      *((_QWORD *)this + 354) = 0LL;
      ...
      if ( v20 < 0 )
      {
        WdLogSingleEntry2(2LL, v20, 4440LL);
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
    ...
    *((_DWORD *)this + 697) = *((_DWORD *)v36 + 5);
    ...
    if ( Resident >= 0 )
    {
      ...
      if ( (int)v8 < 0 )
      {
        ...
        DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"VmBusSendLock2 failed", 4511LL, 0LL, 0LL, 0LL, 0LL);
      }
