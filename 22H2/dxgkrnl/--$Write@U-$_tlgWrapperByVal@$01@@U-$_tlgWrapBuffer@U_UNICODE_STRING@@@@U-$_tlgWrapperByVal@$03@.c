        ...
        __int64 a22)
{
  ...
  v35[1] = 0;
  v31 = 2LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00B1A90, a2, 0LL, 0LL, 0x15u, &v29);
}
