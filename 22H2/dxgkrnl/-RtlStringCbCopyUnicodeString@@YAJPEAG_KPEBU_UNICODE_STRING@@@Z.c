/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C00471AC
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker_0 @ 0x1C004725C (RtlUnicodeStringValidateSrcWorker_0.c)
 */
