/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C003F1AC
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x1C003F268 (RtlUnicodeStringValidateSrcWorker.c)
 */
