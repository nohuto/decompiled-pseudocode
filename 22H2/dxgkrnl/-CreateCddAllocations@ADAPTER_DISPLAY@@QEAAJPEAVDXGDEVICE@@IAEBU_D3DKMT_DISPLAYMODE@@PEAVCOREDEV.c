/*
 * XREFs of ?CreateCddAllocations@ADAPTER_DISPLAY@@QEAAJPEAVDXGDEVICE@@IAEBU_D3DKMT_DISPLAYMODE@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C016A4FC
 * Callers:
  ...
  if ( v28 )
  {
    ...
    *(_QWORD *)(*((_QWORD *)this + 16) + v13 + 600) = *(_QWORD *)(*((_QWORD *)this + 16) + v13 + 88);
    if ( !v66 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"0 != DoDShadowPitch", 1157LL, 0LL, 0LL, 0LL, 0LL);
    }
    goto LABEL_114;
  }
  v77 = 0LL;
  ...
  *(_QWORD *)((char *)&v77 + 4) = __PAIR64__(Format, v34);
  ...
  if ( v36 >= 0 )
  {
    ...
    if ( !HIDWORD(v77) )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"0 != ShadowSurfaceData.Pitch", 1103LL, 0LL, 0LL, 0LL, 0LL);
      v37 = HIDWORD(v77);
    }
    v55 = v69;
...
LABEL_36:
            ...
            *(_QWORD *)(*((_QWORD *)this + 16) + v13 + 88) = *(_QWORD *)(*((_QWORD *)this + 16) + v13 + 600);
            if ( !v66 )
            {
              WdLogSingleEntry1(1LL, 1133LL);
              DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"0 != DoDShadowPitch", 1133LL, 0LL, 0LL, 0LL, 0LL);
            }
LABEL_114:
