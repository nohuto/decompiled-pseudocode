/*
 * XREFs of ?_GetColorPrimariesType@DXGMONITOR@@AEAA?AW4ColorPrimaryType@1@XZ @ 0x1C0183508
 * Callers:
 *     ?_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ @ 0x1C0183448 (-_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ.c)
 * Callees:
 *     ?_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z @ 0x1C018378C (-_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z.c)
 *     ?_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z @ 0x1C0183848 (-_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z.c)
 */
...
__int64 __fastcall DXGMONITOR::_GetColorPrimariesType(_DWORD *a1)
{
    ...
    && DXGMONITOR::_GetDeltaBetweenPoints(v15, v10, v12, 0.1500000059604645, 0.07500000298023224) <= 0.07000000029802322 )
  {
    ...
    {
      if ( v19 * 0.949999988079071 > ColorGamutTriangleArea )
        return 1;
      else
        return 2;
    }
