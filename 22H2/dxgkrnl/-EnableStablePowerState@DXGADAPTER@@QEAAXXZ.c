/*
 * XREFs of ?EnableStablePowerState@DXGADAPTER@@QEAAXXZ @ 0x1C02B771C
 * Callers:
 ...
 *     ?AddStablePowerReference@ADAPTER_RENDER@@QEAAXXZ @ 0x1C02C07B0 (-AddStablePowerReference@ADAPTER_RENDER@@QEAAXXZ.c)
 */
