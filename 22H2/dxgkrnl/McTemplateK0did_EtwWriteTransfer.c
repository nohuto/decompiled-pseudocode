/*
 * XREFs of McTemplateK0did_EtwWriteTransfer @ 0x1C005F490
 * Callers:
...
NTSTATUS __fastcall McTemplateK0did_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
