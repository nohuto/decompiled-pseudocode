/*
 * XREFs of ??0OUTPUTDUPL_SESSION_MGR@@QEAA@XZ @ 0x1C01EB5B4
 * Callers:
 *     ??0DXGSESSIONDATA@@QEAA@K@Z @ 0x1C01EB010 (--0DXGSESSIONDATA@@QEAA@K@Z.c)
 * Callees:
 *     ?InitializeMaxActiveOutputDuplApps@OUTPUTDUPL_SESSION_MGR@@AEAAXXZ @ 0x1C01EB6B4 (-InitializeMaxActiveOutputDuplApps@OUTPUTDUPL_SESSION_MGR@@AEAAXXZ.c)
 */
