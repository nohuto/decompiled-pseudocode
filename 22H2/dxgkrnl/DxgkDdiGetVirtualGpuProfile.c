/*
 * XREFs of DxgkDdiGetVirtualGpuProfile @ 0x1C0231E5C
 * Callers:
 ...
 *     ?GetVirtualGpuProfile@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETVIRTUALGPUPROFILE@@@Z @ 0x1C0230B58 (-GetVirtualGpuProfile@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETVIRTUALGPUPRO.c)
 */
...
__int64 __fastcall DxgkDdiGetVirtualGpuProfile(ADAPTER_RENDER **a1, int a2, int *a3)
{
  ...
  VirtualGpuProfile = ADAPTER_RENDER::GetVirtualGpuProfile(a1[338], a2, (__int64)a3);
  if ( bTracingEnabled )
  {
    v7 = *a3;
