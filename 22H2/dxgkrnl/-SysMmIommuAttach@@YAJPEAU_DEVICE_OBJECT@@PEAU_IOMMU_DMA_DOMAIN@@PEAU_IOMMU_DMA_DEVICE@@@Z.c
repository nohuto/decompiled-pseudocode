/*
 * XREFs of ?SysMmIommuAttach@@YAJPEAU_DEVICE_OBJECT@@PEAU_IOMMU_DMA_DOMAIN@@PEAU_IOMMU_DMA_DEVICE@@@Z @ 0x1C03D6494
 * Callers:
        ...
        struct _IOMMU_DMA_DEVICE *a3)
{
  ...
  {
    v7 = (__int64 (__fastcall *)(struct _IOMMU_DMA_DOMAIN *, __int64))qword_1C0140C00;
    v8 = v5;
LABEL_3:
    v9 = v7(v8, v6);
    goto LABEL_6;
  ...
  if ( !v10 )
    goto LABEL_3;
  v9 = qword_1C0140C00(a2, a1, 0LL, 1LL);
LABEL_6:
  v11 = v9;
  if ( v9 < 0 )
  {
