/*
 * XREFs of DpiGetMonitorColorimetryOverride @ 0x1C0222DA4
 * Callers:
 *     ?GetDriverColorimetryOverride@KernelDriver@@UEBAJAEAU_DXGK_COLORIMETRY@@@Z @ 0x1C0222D70 (-GetDriverColorimetryOverride@KernelDriver@@UEBAJAEAU_DXGK_COLORIMETRY@@@Z.c)
 * Callees:
