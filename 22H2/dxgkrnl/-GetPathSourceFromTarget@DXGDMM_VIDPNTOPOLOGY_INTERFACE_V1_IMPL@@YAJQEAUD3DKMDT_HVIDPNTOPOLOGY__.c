/*
 * XREFs of ?GetPathSourceFromTarget@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTOPOLOGY__@@IPEAI@Z @ 0x1C02E3E00
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v19, 6020LL);
  if ( a3 )
  {
    *a3 = -1;
    ...
    if ( v12 )
    {
      *a3 = DMMVIDPNTOPOLOGY::GetPathSourceFromTarget(v12, (unsigned int)v6);
      v11 = 0;
    }
    else
    {
