/*
 * XREFs of ?Acquire@DXGSWAPCHAINLOCKWITHDEVICE@@QEAAJPEAPEAVDXGDEVICE@@_N@Z @ 0x1C02AA14C
 * Callers:
        ...
        char a3)
{
  ...
  *((_BYTE *)this + 40) = 1;
  ...
  if ( *(_BYTE *)this == 1 )
  {
    v13 = *((_BYTE *)this + 16) != 0 ? 0x30 : 0;
    v14 = *(_QWORD *)(v13 + v10 + 104);
    if ( PsGetCurrentProcess(v13, v6, v8, v9) != v14 )
    {
