/*
 * XREFs of ?RequestAsyncDisplaySwitchCallout@ADAPTER_DISPLAY@@QEAAJPEAU_DXGK_WIN32K_PARAM_DATA@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02BF624
 * Callers:
 ...
 *     ?RequestAsyncDisplaySwitchCallout@MONITOR_MGR@@UEBAJPEAU_DXGK_WIN32K_PARAM_DATA@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C03C7440 (-RequestAsyncDisplaySwitchCallout@MONITOR_MGR@@UEBAJPEAU_DXGK_WIN32K_PARAM_DATA@@PEAU_DXGK_DISPL.c)
 * Callees:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  {
    WdLogSingleEntry1(1LL, 8792LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceSharedOwner()", 8792LL, 0LL, 0LL, 0LL, 0LL);
  }
