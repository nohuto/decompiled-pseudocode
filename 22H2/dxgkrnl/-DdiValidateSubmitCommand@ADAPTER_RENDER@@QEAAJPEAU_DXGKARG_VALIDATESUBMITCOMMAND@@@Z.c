/*
 * XREFs of ?DdiValidateSubmitCommand@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_VALIDATESUBMITCOMMAND@@@Z @ 0x1C015CBF8
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5136LL);
  ...
  v14[3] = v12;
  v15 = *(_QWORD *)(*((_QWORD *)this + 2) + 272LL);
  v14[4] = v15;
  Commands = a2->Commands;
  v14[5] = a2->Commands;
  if ( (_DWORD)v12 != -1073741592 && (_DWORD)v12 )
  {
    v25 = WdLogNewEntry5_WdError(Commands, v15);
    *(_QWORD *)(v25 + 24) = v12;
