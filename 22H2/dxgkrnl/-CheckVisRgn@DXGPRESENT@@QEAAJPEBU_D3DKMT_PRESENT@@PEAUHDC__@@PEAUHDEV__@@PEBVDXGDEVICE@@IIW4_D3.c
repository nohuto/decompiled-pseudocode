/*
 * XREFs of ?CheckVisRgn@DXGPRESENT@@QEAAJPEBU_D3DKMT_PRESENT@@PEAUHDC__@@PEAUHDEV__@@PEBVDXGDEVICE@@IIW4_D3DDDIFORMAT@@H@Z @ 0x1C016EF10
 * Callers:
...
LABEL_88:
        ...
        v39 = *((_DWORD *)this + 10);
        v40 = (unsigned int)(v39 + *((_DWORD *)this + 6));
        v41 = (unsigned int)(v39 + *((_DWORD *)this + 8));
        ...
        v107 = v43;
        v108 = v44;
        if ( (_DWORD)v40 != (_DWORD)v41 && (_DWORD)v43 != v44 )
        {
          CurrentProcess = PsGetCurrentProcess(v42, v43, v41, v40);
