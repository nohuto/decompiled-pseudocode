/*
 * XREFs of REMOTEVSYNCMAPPING::RemoveMappingInternal__lambda_1780769ec5f9365cce61534bff2f229f___ @ 0x1C004F028
 * Callers:
...
LABEL_15:
  ...
  while ( v15 != (REMOTE_VYSNC_MAPPING_ENTRY *)v21 )
  {
    ...
    DXGADAPTER::DecrementVSyncWaiter(*((DXGADAPTER **)v16 + 7), *((_DWORD *)v16 + 12));
