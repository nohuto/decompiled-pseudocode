/*
 * XREFs of ?SmmAllocateLogicalAddressAt@@YAJPEAUSYSMM_LOGICAL_ALLOCATOR@@_K1PEBXPEAPEAUSYSMM_LOGICAL_BLOCK@@@Z @ 0x1C03D6CFC
 * Callers:
 ...
 *     SmmGetOrderBlockSizeInBytes @ 0x1C00710A4 (SmmGetOrderBlockSizeInBytes.c)
 *     SmmNotifyBytesAllocate @ 0x1C0071114 (SmmNotifyBytesAllocate.c)
