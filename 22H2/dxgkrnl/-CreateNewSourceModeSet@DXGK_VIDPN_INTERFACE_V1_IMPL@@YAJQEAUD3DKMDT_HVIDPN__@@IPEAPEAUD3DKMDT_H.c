/*
 * XREFs of ?CreateNewSourceModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_DXGK_VIDPNSOURCEMODESET_INTERFACE@@@Z @ 0x1C0141FD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNSOURCEMODESET__ **a4)
{
  ...
  struct DMMVIDPNSOURCEMODESET *v36; // [rsp+80h] [rbp+40h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v32, 7045LL);
  ...
  if ( a3 && a4 )
  {
    ...
    *a4 = 0LL;
    ...
    if ( v13 )
    {
      v15 = *(struct D3DKMDT_HVIDPNSOURCEMODESET__ **)(*(_QWORD *)(v13 + 48) + 384LL);
      v16 = (DMMVIDPNSOURCE *)IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(*(_QWORD *)(v13 + 304), v7);
      v19 = v16;
      if ( v16 )
      {
        v35 = 0LL;
        v36 = 0LL;
        v20 = DMMVIDPNSOURCE::CreateNewCofuncModeSet(v16, &v36);
        v6 = v20;
        if ( v20 < 0 )
        {
        ...
        {
          auto_rc<DMMVIDPNSOURCEMODESET>::reset(&v35, (__int64)v36);
          v22 = v35;
          v23 = -(__int64)(v35 != -137);
          v35 = 0LL;
          *a3 = v22 & v23;
