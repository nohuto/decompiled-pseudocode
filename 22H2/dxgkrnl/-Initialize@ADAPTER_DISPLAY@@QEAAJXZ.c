/*
 * XREFs of ?Initialize@ADAPTER_DISPLAY@@QEAAJXZ @ 0x1C018850C
 * Callers:
 ...
 *     ?Initialize@DISPLAY_SOURCE@@AEAAJPEAVADAPTER_DISPLAY@@I@Z @ 0x1C0189180 (-Initialize@DISPLAY_SOURCE@@AEAAJPEAVADAPTER_DISPLAY@@I@Z.c)
...
__int64 __fastcall ADAPTER_DISPLAY::Initialize(ADAPTER_DISPLAY *this)
{
  ...
  *((_QWORD *)this + 14) = v12;
  ...
  {
LABEL_11:
    result = MonitorCreateMonitorManager(this, (MONITOR_MGR **)this + 12);
    if ( (int)result < 0 )
      return result;
