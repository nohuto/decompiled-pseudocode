/*
 * XREFs of ?DpiBrightness3GetNitRanges@@YAJPEAXKPEAU_DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT@@@Z @ 0x1C02D01A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT *a3)
{
  ...
  __int64 v11; // rax
  __int64 v12; // r9
  __int64 (__fastcall *v13)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT *); // rax
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( v12 )
    {
      v13 = *(__int64 (__fastcall **)(_QWORD, _QWORD, struct _DXGK_BRIGHTNESS_GET_NIT_RANGES_OUT *))(v12 + 56);
      if ( v13 )
