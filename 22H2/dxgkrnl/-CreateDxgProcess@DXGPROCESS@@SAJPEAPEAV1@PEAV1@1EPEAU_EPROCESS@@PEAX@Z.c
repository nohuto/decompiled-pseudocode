/*
 * XREFs of ?CreateDxgProcess@DXGPROCESS@@SAJPEAPEAV1@PEAV1@1EPEAU_EPROCESS@@PEAX@Z @ 0x1C0125434
 * Callers:
 ...
 *     ??0DXGPROCESSVMWP@@QEAA@PEAVDXGGLOBAL@@QEAU_EPROCESS@@@Z @ 0x1C00488F0 (--0DXGPROCESSVMWP@@QEAA@PEAVDXGGLOBAL@@QEAU_EPROCESS@@@Z.c)
 *     ??2?$DXGQUOTAALLOCATOR@$00$0FAGHHIEE@@@SAPEAX_K@Z @ 0x1C00489BC (--2-$DXGQUOTAALLOCATOR@$00$0FAGHHIEE@@@SAPEAX_K@Z.c)
 *     ?Initialize@DXGPROCESS@@QEAAJPEAX@Z @ 0x1C0116BE8 (-Initialize@DXGPROCESS@@QEAAJPEAX@Z.c)
 *     ??0DXGPROCESS@@IEAA@PEAVDXGGLOBAL@@QEAU_EPROCESS@@@Z @ 0x1C0125804 (--0DXGPROCESS@@IEAA@PEAVDXGGLOBAL@@QEAU_EPROCESS@@@Z.c)
 */
        ...
        void *a6)
{
  ...
  _QWORD *v57; // rax
  __int64 v58; // rbx
  struct _KTHREAD **v59; // [rsp+30h] [rbp-28h] BYREF
  char v60; // [rsp+38h] [rbp-20h]
  ...
  v60 = 0;
  v59 = (struct _KTHREAD **)((char *)Global + 320);
...
LABEL_28:
    ...
    *((_BYTE *)v36 + 348) = ((unsigned __int8)PsIsHostSilo(ProcessServerSilo) != 0 ? 0 : 4) | *((_BYTE *)v36 + 348) & 0xFB;
    v48 = DXGPROCESS::Initialize((unsigned __int64)v36, ProcessId, v44, v45);
    if ( v48 < 0 )
    {
    ...
    if ( !*((_BYTE *)v36 + 345) )
    {
      v49 = DXGGLOBAL::GetGlobal(v47, v46);
      v50 = (char *)v49 + 376;
      KeEnterCriticalRegion();
      ExAcquirePushLockExclusiveEx((char *)v49 + 376, 0LL);
      v51 = (_QWORD *)((char *)v36 + 8);
      v52 = (char *)v49 + 360;
      *((_QWORD *)v50 + 1) = KeGetCurrentThread();
      v53 = *(_QWORD *)v52;
      if ( *(char **)(*(_QWORD *)v52 + 8LL) != v52 )
        goto LABEL_42;
      *v51 = v53;
      *((_QWORD *)v36 + 2) = v52;
      *(_QWORD *)(v53 + 8) = v51;
...
LABEL_44:
    ...
    v54 = (_QWORD *)((char *)v36 + 512);
    v55 = *(_QWORD *)(*((_QWORD *)v36 + 62) + 496LL);
    v56 = v55 + 96;
    DXGPUSHLOCK::AcquireExclusive((DXGPUSHLOCK *)(v55 + 96));
    v57 = *(_QWORD **)(v55 + 32);
    v58 = v55 + 24;
    if ( *v57 == v58 )
    {
...
LABEL_21:
  ...
  *a1 = v23;
LABEL_45:
  DXGGLOBALSHAREMUTEX::~DXGGLOBALSHAREMUTEX((DXGGLOBALSHAREMUTEX *)&v59, v24);
  return v13;
}
