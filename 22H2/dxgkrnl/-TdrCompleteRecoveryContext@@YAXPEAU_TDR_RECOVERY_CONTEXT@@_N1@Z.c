/*
 * XREFs of ?TdrCompleteRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N1@Z @ 0x1C0265E90
 * Callers:
...
void __fastcall TdrCompleteRecoveryContext(char *P, struct _LUID *a2, bool a3)
{
  ...
  if ( P )
  {
    ...
    if ( *((_DWORD *)P + 4) != 6 )
    {
      ...
      v7 = 5LL * (((unsigned __int8)_InterlockedExchangeAdd(dword_1C00B3554, 1u) + 1) & 0x3F);
