/*
 * XREFs of ?ApplyPresentAttributeMetadataToUpdateToken@CContentResourceState@@IEAAXPEAVCFlipPropertySet@@PEAVCFlipContentToken@@@Z @ 0x1C006E3F0
 * Callers:
 ...
 *     ??$FindProperty@UPresentAttributeFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentAttributeFlags@@@Z @ 0x1C006E2C0 (--$FindProperty@UPresentAttributeFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentAttributeFlags.c)
 *     ??$ReadData@I@CFlipBlobPropertyReader@@QEAA_NPEAI@Z @ 0x1C006E324 (--$ReadData@I@CFlipBlobPropertyReader@@QEAA_NPEAI@Z.c)
 *     ??$ReadData@UtagRECT@@@CFlipBlobPropertyReader@@QEAA_NPEAUtagRECT@@@Z @ 0x1C006E350 (--$ReadData@UtagRECT@@@CFlipBlobPropertyReader@@QEAA_NPEAUtagRECT@@@Z.c)
 *     ??$ReadData@_N@CFlipBlobPropertyReader@@QEAA_NPEA_N@Z @ 0x1C006E380 (--$ReadData@_N@CFlipBlobPropertyReader@@QEAA_NPEA_N@Z.c)
 *     ?FindBlobProperty@CFlipPropertySetBase@@QEAA_NPEAVCFlipBlobPropertyReader@@@Z @ 0x1C006E8A0 (-FindBlobProperty@CFlipPropertySetBase@@QEAA_NPEAVCFlipBlobPropertyReader@@@Z.c)
 */
