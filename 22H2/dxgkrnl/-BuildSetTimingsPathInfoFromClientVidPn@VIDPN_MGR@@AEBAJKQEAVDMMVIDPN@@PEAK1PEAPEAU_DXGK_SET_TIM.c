/*
 * XREFs of ?BuildSetTimingsPathInfoFromClientVidPn@VIDPN_MGR@@AEBAJKQEAVDMMVIDPN@@PEAK1PEAPEAU_DXGK_SET_TIMING_PATH_INFO@@PEAPEAIPEAUD3DKMT_VIDPN_SOURCE_MASKS@@3@Z @ 0x1C00E90D0
 * Callers:
 ...
 *     ?GetTargetModeRefreshRate@DMMVIDPNPRESENTPATH@@QEBAJAEAU_D3DDDI_RATIONAL@@@Z @ 0x1C02E984C (-GetTargetModeRefreshRate@DMMVIDPNPRESENTPATH@@QEBAJAEAU_D3DDDI_RATIONAL@@@Z.c)
      ...
      if ( v45 != (_QWORD *)((char *)v20 + 24) )
      {
        ...
        if ( v45 != (_QWORD *)8 )
        {
          while ( 1 )
          {
            ...
            v40[v46] = v48;
            v49 = *(DMMVIDEOPRESENTTARGET **)(v43 + 96);
            v50 = 1 << v48;
            v181 |= 1 << v48;
            v180 = v48;
            v51 = 1 << v48;
