/*
 * XREFs of ?BmlGetPathModeListForAdapterWithCoreAccessHeld@@YAJPEAUD3DKMT_GETPATHSMODALITY@@PEAX_NW4DXGK_DIAG_CCD_BML_ORIGIN@@IAEAVCCD_MODE_RESULT_SET@@@Z @ 0x1C03BD55C
 * Callers:
        ...
        __int64 a6)
{
  ...
  v6 = (unsigned __int16 *)&unk_1C0140300;
  v11 = 0;
  do
  {
    v12 = v6[1];
