/*
 * XREFs of ?DisplayID_GetNativeLuminance@@YAJPEBUDisplayIDObj@@PEAK11PEAI@Z @ 0x1C00611FC
 * Callers:
 ...
 *     ?IsValidBlock@DisplayID_DisplayParameters_Parser@@QEBA_NXZ @ 0x1C0060F18 (-IsValidBlock@DisplayID_DisplayParameters_Parser@@QEBA_NXZ.c)
 *     ?ConvertHalfToFloat@@YAMG@Z @ 0x1C0060F74 (-ConvertHalfToFloat@@YAMG@Z.c)
 */
