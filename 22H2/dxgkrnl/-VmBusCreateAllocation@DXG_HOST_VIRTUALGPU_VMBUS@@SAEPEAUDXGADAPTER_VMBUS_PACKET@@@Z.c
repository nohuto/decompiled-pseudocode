/*
 * XREFs of ?VmBusCreateAllocation@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0379BF0
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        if ( ++v16 >= (unsigned int)v6 )
        {
          ...
          {
            v67 = v33;
            WdLogSingleEntry2(2LL, v33, 1547LL);
            DxgkLogInternalTriageEvent(
              0LL,
              0x40000,
              -1,
