/*
 * XREFs of ?DdiResetVirtualFunction@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_RESETVIRTUALFUNCTION@@@Z @ 0x1C0234B8C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiResetVirtualFunction(
        ADAPTER_RENDER *this,
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C00B19B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5093);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5093LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RESETVIRTUALFUNCTION *))(*(_QWORD *)(*((_QWORD *)this + 2) + 952LL)
                                                                              + 88LL))(
