/*
 * XREFs of ?RtlUnicodeStringCopy@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z @ 0x1C0003B8C
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateDestWorker @ 0x1C0003B20 (RtlUnicodeStringValidateDestWorker.c)
