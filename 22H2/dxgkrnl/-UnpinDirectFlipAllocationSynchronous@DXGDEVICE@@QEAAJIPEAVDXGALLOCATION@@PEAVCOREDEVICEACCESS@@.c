/*
 * XREFs of ?UnpinDirectFlipAllocationSynchronous@DXGDEVICE@@QEAAJIPEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C0257490
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  if ( DXGDEVICE::RemoveDirectFlipAllocationFromList((struct _KTHREAD **)this, a2, a3) )
  {
    ...
    DXGDEVICE::TestAndSetDisplayedPrimary((struct _KTHREAD **)this, a2, a3, v10);
    if ( a4 )
