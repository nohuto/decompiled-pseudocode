/*
 * XREFs of DpiGetMonitorDescriptor @ 0x1C0210214
 * Callers:
 *     ?GetMonitorDescriptor@KernelDriver@@UEBAJKKPEAX@Z @ 0x1C02101F0 (-GetMonitorDescriptor@KernelDriver@@UEBAJKKPEAX@Z.c)
 * Callees:
