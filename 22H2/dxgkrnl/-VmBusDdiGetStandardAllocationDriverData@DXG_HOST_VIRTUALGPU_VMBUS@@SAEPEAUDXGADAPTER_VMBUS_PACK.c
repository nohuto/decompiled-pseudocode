/*
 * XREFs of ?VmBusDdiGetStandardAllocationDriverData@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C037C280
 * Callers:
 *     <none>
 * Callees:
    ...
    switch ( *(_DWORD *)(v5 + 24) )
    {
      ...
      case 4:
        ...
        if ( !*(_DWORD *)(v5 + 44)
          ...
          || *(_DWORD *)(v5 + 56) )
        {
          WdLogSingleEntry1(3LL, 3032LL);
          goto LABEL_69;
        }
        break;
      default:
        WdLogSingleEntry1(2LL, 3063LL);
