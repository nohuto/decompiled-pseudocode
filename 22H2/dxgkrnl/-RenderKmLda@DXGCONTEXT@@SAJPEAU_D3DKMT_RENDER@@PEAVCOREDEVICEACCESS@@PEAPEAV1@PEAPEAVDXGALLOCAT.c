/*
 * XREFs of ?RenderKmLda@DXGCONTEXT@@SAJPEAU_D3DKMT_RENDER@@PEAVCOREDEVICEACCESS@@PEAPEAV1@PEAPEAVDXGALLOCATION@@PEAPEAVDXGHWQUEUE@@@Z @ 0x1C028F10C
 * Callers:
        ...
        struct DXGHWQUEUE **a5)
{
  ...
  v97 = *((_QWORD *)v114 + 80);
  v107 = *((_QWORD *)v114 + 77);
  Current = DXGPROCESS::GetCurrent((__int64)v114, (__int64)a2, (__int64)a3, (__int64)a4);
