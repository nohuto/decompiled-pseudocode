/*
 * XREFs of ?DmmGetTargetIdFromCcdMonitorId@@YAJQEAXPEBU_UNICODE_STRING@@IPEAIPEAW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@3PEAE44@Z @ 0x1C017BE84
 * Callers:
      ...
      if ( !v46 )
      {
        ...
        *a6 = *((enum _D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY *)NextTarget + 21);
        ...
        if ( (_DWORD)v30 != -1 )
        {
          ...
          {
            v45 = 0;
            IsMonitorVirtualModeDisabled = MonitorIsMonitorVirtualModeDisabled(this, v30, &v45);
