/*
 * XREFs of DxgkHardwareContentProtectionTeardownCB @ 0x1C0042EF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?NotifyHardwareContentProtectionTeardown@DXGADAPTER@@QEAAXI@Z @ 0x1C0037BDC (-NotifyHardwareContentProtectionTeardown@DXGADAPTER@@QEAAXI@Z.c)
 */
