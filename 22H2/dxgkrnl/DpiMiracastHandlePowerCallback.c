/*
 * XREFs of DpiMiracastHandlePowerCallback @ 0x1C039F1F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiMiracastHandlePowerCallback(LPCGUID SettingGuid, _DWORD *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      if ( *Value )
      {
        if ( byte_1C0140499 && KeCancelTimer(&Timer) )
        {
          _InterlockedIncrement(&dword_1C01408D8);
          v13 = 0LL;
          v8 = 6;
          v11 = 0LL;
          v10 = 0LL;
      ...
      {
        byte_1C0140499 = 1;
        if ( byte_1C0140497 && dword_1C01408C0 )
        {
