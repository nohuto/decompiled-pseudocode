/*
 * XREFs of ?SetCachedModeList@ADAPTER_DISPLAY@@QEAAJPEAU_D3DKMT_GETDISPLAYMODELIST@@@Z @ 0x1C0227D54
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::SetCachedModeList(PERESOURCE **this, struct _D3DKMT_GETDISPLAYMODELIST *a2)
{
  ...
  {
    WdLogSingleEntry1(1LL, 6436LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceExclusiveOwner()", 6436LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a2 )
  {
    WdLogSingleEntry1(1LL, 6438LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pInputDisplayModeList != NULL", 6438LL, 0LL, 0LL, 0LL, 0LL);
  }
