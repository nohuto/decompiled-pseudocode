/*
 * XREFs of DpiFdoHandleStartDevice @ 0x1C0205110
 * Callers:
 *     <none>
 * Callees:
 *     DpiCheckForOutstandingD3Requests @ 0x1C0005C0C (DpiCheckForOutstandingD3Requests.c)
 *     WindowsQueryLicenseDWORD @ 0x1C001D6AC (WindowsQueryLicenseDWORD.c)
 ...
 *     DpiDetermineResourceListSize @ 0x1C0220DA8 (DpiDetermineResourceListSize.c)
...
LABEL_55:
  ...
  *(_DWORD *)(DeviceExtension + 236) = 1;
  ...
  {
LABEL_20:
    if ( !(_BYTE)word_1C01404E0 )
      goto LABEL_21;
    goto LABEL_39;
  }
  if ( !*(_BYTE *)(DeviceExtension + 2693) )
  {
    HIBYTE(word_1C01404E0) = 1;
    goto LABEL_20;
  }
  LOBYTE(word_1C01404E0) = 1;
LABEL_39:
  if ( HIBYTE(word_1C01404E0) )
    KeSetEvent(&stru_1C01404E8, 0, 0);
LABEL_21:
  if ( !byte_1C01404E2 || *(_BYTE *)(DeviceExtension + 1159) )
    goto LABEL_22;
  ThreadHandle = 0LL;
