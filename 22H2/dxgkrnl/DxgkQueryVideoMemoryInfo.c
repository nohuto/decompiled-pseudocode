/*
 * XREFs of DxgkQueryVideoMemoryInfo @ 0x1C00DF030
 * Callers:
...
LABEL_39:
  ...
  if ( v5->hProcess )
  {
    ...
    Process = DXGPROCESSMUTEXBYHANDLE::GetProcess((DXGPROCESSMUTEXBYHANDLE *)v63);
  }
  v60 = 0LL;
  ...
  if ( *((_BYTE *)v18 + 209) )
  {
    ...
    VideoMemoryInfo = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendQueryVideoMemoryInfo(
                        (struct DXGADAPTER *)((char *)v18 + 4240),
                        HostProcess,
                        v50,
                        v5);
  }
  ...
  {
    VideoMemoryInfo = ADAPTER_RENDER::QueryVideoMemoryInfo(*((ADAPTER_RENDER **)v18 + 338), Process, v5);
  }
