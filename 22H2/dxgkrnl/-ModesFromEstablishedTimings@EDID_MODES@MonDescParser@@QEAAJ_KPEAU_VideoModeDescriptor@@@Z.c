...
LABEL_6:
  ...
  while ( v11 < a2 )
  {
    if ( (v13 & 1) != 0 )
    {
      ...
      v15 = 56LL * v12;
      ++v11;
      v16 = *(_OWORD *)((char *)&unk_1C00A4090 + v15 + 16);
      *(_OWORD *)&a3[v14].PixelClockRate = *(_OWORD *)((char *)&unk_1C00A4090 + v15);
      v17 = *(_OWORD *)((char *)&unk_1C00A4090 + v15 + 32);
      *(_OWORD *)&a3[v14].HorizontalRefreshRateDenominator = v16;
      *(_QWORD *)&v16 = *(_QWORD *)((char *)&unk_1C00A4090 + v15 + 48);
