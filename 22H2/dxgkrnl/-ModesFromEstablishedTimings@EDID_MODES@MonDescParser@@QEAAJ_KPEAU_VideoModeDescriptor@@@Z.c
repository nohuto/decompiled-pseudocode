/*
 * XREFs of ?ModesFromEstablishedTimings@EDID_MODES@MonDescParser@@QEAAJ_KPEAU_VideoModeDescriptor@@@Z @ 0x1C001FAB8
 * Callers:
        ...
        struct _VideoModeDescriptor *a3)
{
  ...
  do
  {
    ...
    if ( (v13 & 1) != 0 )
    {
      ...
      v15 = 56LL * v6;
      ++v12;
      v16 = *(_OWORD *)((char *)&unk_1C007C460 + v15 + 16);
      *(_OWORD *)&a3[v14].PixelClockRate = *(_OWORD *)((char *)&unk_1C007C460 + v15);
      v17 = *(_OWORD *)((char *)&unk_1C007C460 + v15 + 32);
      *(_OWORD *)&a3[v14].HorizontalRefreshRateDenominator = v16;
      *(_QWORD *)&v16 = *(_QWORD *)((char *)&unk_1C007C460 + v15 + 48);
