/*
 * XREFs of ?VmBusCddGdiCommand@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023C830
 * Callers:
 *     <none>
 * Callees:
...
LABEL_135:
  ...
  {
    v13 = WdLogNewEntry5_WdError(v14, v17);
    *(_QWORD *)(v13 + 24) = 2079LL;
    goto LABEL_135;
  }
  if ( (*(_DWORD *)(v10 + 48) & 0x20) == 0 )
  {
    v13 = WdLogNewEntry5_WdError(v14, v17);
    *(_QWORD *)(v13 + 24) = 2084LL;
    goto LABEL_135;
  }
  v18 = *(_DWORD *)(v10 + 24);
  v103 = 0LL;
