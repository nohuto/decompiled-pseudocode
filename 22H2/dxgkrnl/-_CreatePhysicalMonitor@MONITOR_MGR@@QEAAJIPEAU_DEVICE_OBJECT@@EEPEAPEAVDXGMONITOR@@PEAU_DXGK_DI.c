/*
 * XREFs of ?_CreatePhysicalMonitor@MONITOR_MGR@@QEAAJIPEAU_DEVICE_OBJECT@@EEPEAPEAVDXGMONITOR@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0184BD8
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a7)
{
  ...
  *v7 = 0LL;
  ...
  if ( v15 )
  {
    ...
    v23 = (int)DXGMONITOR::_InitializeMonitor((__int64)v15, (unsigned int)v9, (__int64)a3, a4, a5, 1, 0LL, a7);
    if ( v19 )
      v19[55] = 0LL;
    else
