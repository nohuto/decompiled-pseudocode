/*
 * XREFs of ?AcquireSync@DXGKEYEDMUTEX@@SAJI_KHPEAT_LARGE_INTEGER@@PEA_KPEAXI2_N@Z @ 0x1C034E76C
 * Callers:
        ...
        bool a9)
{
  ...
  if ( !a5 )
  {
    WdLogSingleEntry1(1LL, 4126LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pFenceValue", 4126LL, 0LL, 0LL, 0LL, 0LL);
  }
  *v10 = 0LL;
  v11 = 0;
