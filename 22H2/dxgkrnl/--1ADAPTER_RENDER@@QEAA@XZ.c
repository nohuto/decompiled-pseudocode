/*
 * XREFs of ??1ADAPTER_RENDER@@QEAA@XZ @ 0x1C0215D10
 * Callers:
 ...
 *     ??1?$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ @ 0x1C003BBF4 (--1-$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ.c)
