/*
 * XREFs of ?SetVidPnSourceActive@ADAPTER_DISPLAY@@QEAAJIEEE@Z @ 0x1C00E5CCC
 * Callers:
        ...
        unsigned __int8 a5)
{
  ...
  if ( v14[338] )
  {
    ...
    if ( a3 )
    {
      ...
      LinkInfoFromTarget = MonitorGetLinkInfoFromTarget(v14, (unsigned int)v16, &v73);
    ...
    v23 = v12[78];
    v24 = v12[77];
    DisplayModeInfo = ADAPTER_DISPLAY::GetDisplayModeInfo((ADAPTER_DISPLAY *)this, v7);
    LOBYTE(v26) = a3;
...
LABEL_20:
  if ( ((_DWORD)this[55] & 2) != 0
    || a4 && (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType((ADAPTER_DISPLAY *)this, v7) == 1 )
  {
    v62 = this[2];
...
LABEL_49:
  ...
  v42 = ADAPTER_DISPLAY::SetVidPnSourceVisibility((ADAPTER_DISPLAY *)this, v7, 1u, 0x800u, a5);
  v45 = v42;
  if ( v42 < 0 )
  {
