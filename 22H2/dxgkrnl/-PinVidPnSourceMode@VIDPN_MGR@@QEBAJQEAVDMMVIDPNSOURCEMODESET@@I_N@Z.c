/*
 * XREFs of ?PinVidPnSourceMode@VIDPN_MGR@@QEBAJQEAVDMMVIDPNSOURCEMODESET@@I_N@Z @ 0x1C012E69C
 * Callers:
        ...
        char a4)
{
  ...
  else
  {
    ...
    v44.VidPnSourceId = *(_DWORD *)(v13 + 24);
    v44.VidPnTargetId = -1;
    ...
    if ( v16 < 0 )
    {
      ...
      if ( v8 )
        v40 = DMMVIDPNSOURCEMODESET::PinMode(a2, *(_DWORD *)(v8 + 24));
      else
        v40 = DMMVIDPNTARGETMODESET::UnpinMode(a2, v39);
      if ( v40 < 0 )
      {
