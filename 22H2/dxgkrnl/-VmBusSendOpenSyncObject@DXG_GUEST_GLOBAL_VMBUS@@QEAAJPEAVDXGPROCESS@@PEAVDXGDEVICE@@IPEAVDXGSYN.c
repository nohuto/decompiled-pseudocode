/*
 * XREFs of ?VmBusSendOpenSyncObject@DXG_GUEST_GLOBAL_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGDEVICE@@IPEAVDXGSYNCOBJECT@@PEAVDXGDEVICESYNCOBJECT@@IU_D3DDDI_SYNCHRONIZATIONOBJECT_FLAGS@@@Z @ 0x1C038C0EC
 * Callers:
...
LABEL_14:
  ...
  if ( a6 )
  {
    ...
    *((_QWORD *)a6 + 6) = v25;
    ...
    if ( v17 < 0 )
    {
      WdLogSingleEntry2(2LL, v17, 13690LL);
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        -1,
