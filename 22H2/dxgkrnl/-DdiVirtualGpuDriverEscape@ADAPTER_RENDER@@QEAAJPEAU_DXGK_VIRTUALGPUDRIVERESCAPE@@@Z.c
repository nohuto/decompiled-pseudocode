/*
 * XREFs of ?DdiVirtualGpuDriverEscape@ADAPTER_RENDER@@QEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C02356AC
 * Callers:
 *     ?VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C0238290 (-VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiVirtualGpuDriverEscape(
        ADAPTER_RENDER *this,
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C00B19B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5105);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5105LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGK_VIRTUALGPUDRIVERESCAPE *))(*(_QWORD *)(*((_QWORD *)this + 2) + 968LL)
                                                                             + 112LL))(
  ...
  {
    v15 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v14, v11);
    v15[3] = 275LL;
    v15[4] = 16LL;
    v15[5] = this;
    v15[6] = CurrentIrql;
  ...
  if ( (_DWORD)v12 != -1073741823 && (_DWORD)v12 != -1073741811 )
  {
    v19 = (int)v12 < 0;
    if ( !(_DWORD)v12 )
      goto LABEL_21;
    v20 = WdLogNewEntry5_WdError(v14, v11);
    *(_QWORD *)(v20 + 24) = v12;
...
LABEL_21:
  if ( v19 )
  {
    v21 = WdLogNewEntry5_WdWarning(v14, v11, v13);
    *(_QWORD *)(v21 + 24) = v12;
