/*
 * XREFs of ?CreateNewCofuncModeSet@DMMVIDPNSOURCE@@QEAAJPEAPEAVDMMVIDPNSOURCEMODESET@@@Z @ 0x1C000A5CC
 * Callers:
  ...
  *a2 = 0LL;
  ...
  else
  {
    ...
    if ( v6 )
      ...
      v7 = 0LL;
    auto_rc<DMMVIDPNSOURCEMODESET>::reset(&v22, v7);
    v12 = v22;
    if ( v22 )
    {
      ...
      {
        v22 = 0LL;
        auto_rc<DMMVIDPNSOURCEMODESET>::reset((char *)this + 120, v12);
