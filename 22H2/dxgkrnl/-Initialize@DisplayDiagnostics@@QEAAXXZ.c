/*
 * XREFs of ?Initialize@DisplayDiagnostics@@QEAAXXZ @ 0x1C0021A10
 * Callers:
 *     ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C017B444 (-Initialize@DXGGLOBAL@@QEAAJXZ.c)
 * Callees:
 *     ?Stop@LongPowerButtonHoldListener@@QEAAXXZ @ 0x1C00509C8 (-Stop@LongPowerButtonHoldListener@@QEAAXXZ.c)
