/*
 * XREFs of ?ReleaseModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@QEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C0157E30
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE *const a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 7004LL);
  ...
  *(_QWORD *)(v8 + 32) = this;
  if ( a2 )
  {
    ...
    if ( *(_DWORD *)v11 == 305419896 )
    {
      ...
      if ( v12 )
      {
        v13 = (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)*((_QWORD *)this + 6);
        v14 = (char *)this + 48;
        if ( v13 == (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)((char *)this + 48) || (v15 = (char *)v13 - 8) == 0LL )
        {
LABEL_21:
