/*
 * XREFs of DxgkCheckOcclusion @ 0x1C0163B90
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Current )
  {
    ...
    if ( v12 )
    {
      ...
      if ( (*(unsigned int (**)(void))(v13 + 208))() )
      {
        ...
        if ( (*(unsigned int (__fastcall **)(__int64, struct tagRECT *))(v13 + 360))(v12, &v34) == 1 )
        {
    ...
    v26 = WdLogNewEntry5_WdWarning(MmUserProbeAddress, v8, v10);
