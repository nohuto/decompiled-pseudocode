/*
 * XREFs of MonitorRemovePhysicalMonitor @ 0x1C02F4814
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a4)
{
  ...
  *(_QWORD *)(v8 + 32) = a1;
  ...
  v18 = MONITOR_MGR::_HandleRemovePhysicalMonitor(*(struct _FAST_MUTEX **)(v14 + 96), (unsigned int)v5, a3, a4);
  ...
  {
    v19 = DmmPowerOnOffTargetsFromSourceIfNecessary((PERESOURCE *)a1, v24, 1);
    v22 = v19;
    if ( v19 < 0 )
    {
