/*
 * XREFs of ?Unlock@DXGDEVICE@@QEAAJPEBU_D3DKMT_UNLOCK@@E@Z @ 0x1C018763C
 * Callers:
...
__int64 __fastcall DXGDEVICE::Unlock(DXGDEVICE *this, const struct _D3DKMT_UNLOCK *a2, char a3)
{
  ...
  _D3DKMT_UNLOCK2 v27; // [rsp+C8h] [rbp+20h] BYREF

  v26 = a3;
  NumAllocations = a2->NumAllocations;
  if ( !NumAllocations || (phAllocations = (D3DKMT_HANDLE *)a2->phAllocations) == 0LL )
  {
