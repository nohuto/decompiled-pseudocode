/*
 * XREFs of ?DxgkCddMakeResident@@YAJIEPEAUD3DDDI_MAKERESIDENT@@PEAD@Z @ 0x1C0154130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddMakeResident(__int64 a1, char a2, struct D3DDDI_MAKERESIDENT *a3, char *a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v64, 3060LL);
  v68[0] = 0LL;
  v69 = 0;
  if ( !a2 )
    goto LABEL_4;
