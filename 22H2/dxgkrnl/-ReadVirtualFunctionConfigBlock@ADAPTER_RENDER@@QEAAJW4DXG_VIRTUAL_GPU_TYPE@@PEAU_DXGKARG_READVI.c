/*
 * XREFs of ?ReadVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C02310C4
 * Callers:
 *     DxgkDdiReadVirtualFunctionConfigBlock @ 0x1C0232318 (DxgkDdiReadVirtualFunctionConfigBlock.c)
 * Callees:
