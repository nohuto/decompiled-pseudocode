/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C015A690
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ *const a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v39, 7049LL);
  ...
  *(_QWORD *)(v7 + 32) = this;
  ...
  if ( v14 == v10 )
  {
    ...
    {
      if ( v11 == *(struct D3DKMDT_HVIDPN__ **)(v12 + 112) )
      {
        v33 = WdLogNewEntry5_WdDmmEvent(v9);
        *(_QWORD *)(v33 + 24) = v11;
        *(_QWORD *)(v33 + 32) = *(unsigned int *)(v12 + 24);
        WdLogEvent5_WdDmmEvent(v33);
        auto_rc<DMMVIDPNTARGETMODESET>::reset((__int64 *)(v12 + 112), 0LL);
        if ( *((_DWORD *)v11 + 24) != 1 )
        {
