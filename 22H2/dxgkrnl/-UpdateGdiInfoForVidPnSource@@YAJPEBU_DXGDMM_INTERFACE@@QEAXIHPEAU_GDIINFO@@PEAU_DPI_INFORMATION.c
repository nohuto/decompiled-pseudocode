/*
 * XREFs of ?UpdateGdiInfoForVidPnSource@@YAJPEBU_DXGDMM_INTERFACE@@QEAXIHPEAU_GDIINFO@@PEAU_DPI_INFORMATION@@@Z @ 0x1C014BAF4
 * Callers:
 ...
 *     ?AvgXY@DpiInternal@@YAJUtagSIZE@@@Z @ 0x1C000D034 (-AvgXY@DpiInternal@@YAJUtagSIZE@@@Z.c)
...
LABEL_41:
      ...
      *(_QWORD *)&v159[32] = 0LL;
      ...
      v154 = 0;
      PreferredMonitorSourceModeOnTarget = DmmGetPreferredMonitorSourceModeOnTarget((DXGADAPTER *)a2, v157.cx, &v164);
