/*
 * XREFs of ?AppendMonitorId@DpiPersistence@@YAJIAEBU_LUID@@PEAVVIDPN_MGR@@GPEAG2@Z @ 0x1C014AB3C
 * Callers:
        ...
        unsigned __int16 *a6)
{
  ...
  __int64 v15; // rax
  _QWORD *v16; // rax
  unsigned __int64 v17[3]; // [rsp+30h] [rbp-18h] BYREF

  v7 = (unsigned __int16)a4;
  LODWORD(v10) = DpiPersistence::GetMonitorIdFromTargetId(this, a2, a3, (struct VIDPN_MGR *)(unsigned __int16)a4, a6);
  if ( (int)v10 < 0 )
  {
  ...
  {
    v17[0] = 0LL;
    v11 = RtlStringCchLengthW(a6, (unsigned int)v7, v17);
    v10 = v11;
    if ( v11 < 0 )
    {
