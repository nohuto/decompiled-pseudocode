/*
 * XREFs of DxgkUpdateCddDevmodeExtraData @ 0x1C03B07E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetD3dFormatFromGdiBitsPerPixel@@YA?AW4_D3DDDIFORMAT@@K@Z @ 0x1C03AF170 (-GetD3dFormatFromGdiBitsPerPixel@@YA-AW4_D3DDDIFORMAT@@K@Z.c)
 */
