/*
 * XREFs of ?GetConnectedMonitorHandle@VIDPN_MGR@@QEAAJIPEAPEAUHDXGMONITOR__@@@Z @ 0x1C014A020
 * Callers:
...
__int64 __fastcall VIDPN_MGR::GetConnectedMonitorHandle(VIDPN_MGR *this, __int64 a2, struct HDXGMONITOR__ **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(v6, v3) )
  {
    ...
    MonitorHandle = MonitorGetMonitorHandle(*(_QWORD *)(v9 + 16), (unsigned int)v3, 0, (void *)0x4E506456, a3);
  }
  else
  {
