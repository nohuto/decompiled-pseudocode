/*
 * XREFs of ?ApplyCsFunctionAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C02847E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z @ 0x1C0048BD4 (-SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z.c)
