/*
 * XREFs of ?GetTrackedWorkloadUserStatistics@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEAU_D3DKMT_GETTRACKEDWORKLOADSTATISTICS@@@Z @ 0x1C02BD068
 * Callers:
 *     NtDxgkGetTrackedWorkloadStatistics @ 0x1C02BE380 (NtDxgkGetTrackedWorkloadStatistics.c)
 * Callees:
 *     memset @ 0x1C0028FC0 (memset.c)
 *     ?GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z @ 0x1C006EF94 (-GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z.c)
 *     ?IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ @ 0x1C006F1D8 (-IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ.c)
 */
