/*
 * XREFs of ?GetTrackedWorkloadUserStatistics@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEAU_D3DKMT_GETTRACKEDWORKLOADSTATISTICS@@@Z @ 0x1C035E2F4
 * Callers:
 *     NtDxgkGetTrackedWorkloadStatistics @ 0x1C035FC60 (NtDxgkGetTrackedWorkloadStatistics.c)
 * Callees:
 *     memset @ 0x1C0028640 (memset.c)
 *     ?GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z @ 0x1C0088FA4 (-GetStats@CumulativeStats@@QEAAXPEAN000PEA_K@Z.c)
 *     ?IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ @ 0x1C0089228 (-IsSaturated@TrackedWorkloadMonitor@@QEAA_NXZ.c)
 */
