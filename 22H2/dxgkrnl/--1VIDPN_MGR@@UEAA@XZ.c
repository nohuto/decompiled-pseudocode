/*
 * XREFs of ??1VIDPN_MGR@@UEAA@XZ @ 0x1C005B120
 * Callers:
 *     ??_GVIDPN_MGR@@UEAAPEAXI@Z @ 0x1C005BCF0 (--_GVIDPN_MGR@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1?$Queue@UDISPMODECHANGEREQUEST@VIDPN_MGR@@@@UEAA@XZ @ 0x1C005AF1C (--1-$Queue@UDISPMODECHANGEREQUEST@VIDPN_MGR@@@@UEAA@XZ.c)
