/*
 * XREFs of ?AddUsb4HRPowerRefFromContext@Usb4HostRouterPoFxRef@DxgMonitor@@SAJPEAUUSB4_POFXREF_CONTEXT@@@Z @ 0x1C03CA3E4
 * Callers:
...
__int64 __fastcall DxgMonitor::Usb4HostRouterPoFxRef::AddUsb4HRPowerRefFromContext(struct USB4_POFXREF_CONTEXT *a1)
{
  ...
  else
  {
    ...
    *(_QWORD *)(v9 + 32) = v12;
    ...
    if ( (unsigned int)dword_1C013F8A8 > 5 && tlgKeywordOn((__int64)&dword_1C013F8A8, 0x8000LL) )
    {
      v13 = *((_DWORD *)a1 + 2);
      v21 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C013F8A8,
        (unsigned __int8 *)dword_1C00AAE5E,
        0LL,
        0LL,
        3u,
        &v18);
