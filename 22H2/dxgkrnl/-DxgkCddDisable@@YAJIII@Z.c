/*
 * XREFs of ?DxgkCddDisable@@YAJIII@Z @ 0x1C00E68A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddDisable(__int64 a1, int a2, __int64 a3)
{
  ...
  struct DXGDEVICE *v64; // [rsp+38h] [rbp-C8h] BYREF
...
LABEL_62:
  ...
  if ( (a2 & 0x40000000) == 0 )
  {
    ...
    if ( a2 == 1 && ADAPTER_DISPLAY::HasAnyVidPnSourceOwner(*(DXGADAPTER ***)(v20 + 2696)) )
      ADAPTER_DISPLAY::ReleaseAllVidPnSourceOwners(*(PERESOURCE ***)(v20 + 2696), *(PERESOURCE ***)(v15 + 16));
    if ( *(_DWORD *)(v20 + 200) == 1 )
...
LABEL_20:
  ...
  else
  {
    ...
    if ( SessionViewFromSource )
    {
            ...
            else
            {
              if ( *(_QWORD *)(v45 + 2704) )
              {
                if ( DXGADAPTER::IsLegacyDisplayStateSynchronization(*(DXGADAPTER **)(*((_QWORD *)v64 + 2) + 16LL)) )
                  ADAPTER_RENDER::FlushScheduler(v50, 8LL, v44, 0LL);
                else
              ...
              {
                v51 = v64;
                v52 = ADAPTER_DISPLAY::DestroyCddAllocations(*(PERESOURCE ***)(v45 + 2696), v64, v44);
              }
      ...
      if ( ((a2 - 0x40000000) & 0xFFFFFFFB) == 0 )
        DxgkRemoveSessionViewForCurrentSession(v38, v4, 1u);
      if ( v63[0] )
