/*
 * XREFs of DpiFdoHandleDevicePower @ 0x1C01F0390
 * Callers:
 ...
 *     DxgkReportDeviceDirectedPowerDown @ 0x1C0043044 (DxgkReportDeviceDirectedPowerDown.c)
...
LABEL_108:
      ...
      LOBYTE(v24) = v42;
LABEL_95:
      if ( (struct _DEVICE_OBJECT *)qword_1C0140740 == v5 )
      {
        if ( (_BYTE)v24 )
        {
          if ( dword_1C01407F0 == 3 && byte_1C0140810 )
          {
            LOBYTE(v23) = 1;
            DpiAcquirePostDisplayInfoFromBgfx(&xmmword_1C0140750, v23, 0LL);
            byte_1C0140810 = 0;
            dword_1C014083C = 1;
          }
        }
