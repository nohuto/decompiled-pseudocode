/*
 * XREFs of ?GetCddDeviceAndContext@SESSION_ADAPTER@@QEAAJPEAPEAVDXGDEVICE@@PEAPEAVDXGCONTEXT@@PEAPEAVDXGHWQUEUE@@E@Z @ 0x1C00E44B8
 * Callers:
        ...
        unsigned __int8 a5)
{
  ...
  *(_QWORD *)(v9 + 8) = KeGetCurrentThread();
  ...
  while ( 1 )
  {
    ...
    PairingAdapters = DxgkpGetPairingAdapters(this[2], 0, v12, &v39, 0LL, 0LL, a5);
    ...
    *(_QWORD *)(v17 + 56) = KeGetCurrentThread();
    ...
    if ( v38 != this[2] )
    {
      ...
      CddDevice = DxgkpGetPairingAdapters(this[2], 0, v30, &v41, 0LL, 0LL, a5);
      if ( CddDevice < 0 )
      {
