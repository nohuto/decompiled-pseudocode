/*
 * XREFs of ?AssignTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IQEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C01D9D00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ *const a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v21, 7051);
  ...
  {
    v12 = (struct DMMVIDPNTARGETMODESET *)ExposedViaHandle<DMMVIDPNTARGETMODESET,D3DKMDT_HVIDPNTARGETMODESET__ *>::GetFromHandle(v4);
    if ( v12 )
    {
      v14 = (struct DMMVIDPNTARGETMODESET **)IndexedSet<DMMVIDPNTARGET>::FindById(*(_QWORD *)(v13 + 312), v6);
      v16 = v14;
      if ( v14 )
      {
        v17 = DMMVIDPNTARGET::SetCofuncModeSet(v14, v12);
        v4 = v17;
        if ( v17 < 0 )
        {
          if ( v17 != -1071774958 )
