/*
 * XREFs of ?VmBusChannelProcessPacketCblt@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C0026D80
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v9 = 1;
  v39 = 1;
  v11 = *(_QWORD *)(((__int64 (*)(void))qword_1C00B4348)() + 496);
  Next = 0;
  v37 = v11;
