/*
 * XREFs of REMOTEVSYNCMAPPING::RemoveMappingInternal__lambda_ed8f9bca20cd5704cf0fee5400ab1066___ @ 0x1C004F1F4
 * Callers:
...
LABEL_11:
  ...
  while ( v12 != (REMOTE_VYSNC_MAPPING_ENTRY *)v18 )
  {
    ...
    DXGADAPTER::DecrementVSyncWaiter(*((DXGADAPTER **)v13 + 7), *((_DWORD *)v13 + 12));
