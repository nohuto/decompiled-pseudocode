/*
 * XREFs of ?VSyncTelemetryBucket@ADAPTER_DISPLAY@@QEAAXXZ @ 0x1C0041D50
 * Callers:
 *     ?VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z @ 0x1C00420C0 (-VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
LABEL_14:
  if ( v4 )
  {
    if ( (*((_DWORD *)this + 242) || *((_DWORD *)this + 241))
      && (unsigned int)dword_1C013F8E0 > 4
      && tlgKeywordOn((__int64)&dword_1C013F8E0, 0x400000002000LL)
      && v11 > 5
      && tlgKeywordOn((__int64)&dword_1C013F8E0, v10) )
    {
      v15 = *((_QWORD *)this + 127);
      if ( v15 )
