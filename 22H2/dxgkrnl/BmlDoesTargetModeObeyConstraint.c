/*
 * XREFs of BmlDoesTargetModeObeyConstraint @ 0x1C017793C
 * Callers:
 ...
 *     BmlAreRawModesEnabled @ 0x1C0177AD8 (BmlAreRawModesEnabled.c)
...
bool __fastcall BmlDoesTargetModeObeyConstraint(__int64 a1, unsigned __int16 a2, __int64 a3)
{
  ...
  if ( (*(_BYTE *)v6 & 8) == 0 || (v6[1] & 8) == 0 )
    return 1;
  return BmlDoesTargetModeSupportWireFormat(a3, *((_DWORD *)v6 + 51));
}
