/*
 * XREFs of ?GetMonitorDescriptorSet@DXGK_MONITOR_INTERFACE_V1_IMPL@@KAJQEAXIPEAPEAUD3DKMDT_HMONITORDESCRIPTORSET__@@PEAPEBU_DXGK_MONITORDESCRIPTORSET_INTERFACE@@@Z @ 0x1C02F7DB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGK_MONITORDESCRIPTORSET_INTERFACE **a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v31, 7055LL);
  ...
  if ( *(_QWORD *)(v18 + 2696) )
  {
    ...
    else if ( MonitorHandle >= 0 )
    {
      ...
      *a4 = &DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL::DxgMonitorDescriptorSetInterfaceV1;
      MonitorReleaseMonitorHandle(v18, v6, DXGK_MONITOR_INTERFACE_V1_IMPL::GetMonitorDescriptorSet);
      LODWORD(v6) = 0;
    }
    else
    {
