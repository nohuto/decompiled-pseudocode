/*
 * XREFs of ?PollDisplayChildrenAll@DXGGLOBAL@@QEAAJPEBU_D3DKMT_POLLDISPLAYCHILDREN@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0313C80
 * Callers:
...
LABEL_33:
  ...
  while ( v12 != v4 && v12 )
  {
    if ( v5 >= v6 )
    {
      ...
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NumAdapters < MaxNumAdapters", 3903LL, 0LL, 0LL, 0LL, 0LL);
    }
    v13 = v12;
    v12 = (_QWORD *)*v12;
    _m_prefetchw(v13 + 3);
