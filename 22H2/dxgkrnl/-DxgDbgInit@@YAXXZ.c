/*
 * XREFs of ?DxgDbgInit@@YAXXZ @ 0x1C0228014
 * Callers:
...
void DxgDbgInit(void)
{
  ...
  xmmword_1C0140B48 = WdDxgkSecondaryDataGUID;
  strcpy((char *)&Component, "\\Device\\DxgKrnl");
  byte_1C0140B31 = KeRegisterBugCheckReasonCallback(
                     &CallbackRecord,
...
LABEL_13:
  ...
  byte_1C0140B30 = KeRegisterBugCheckReasonCallback(
                     P,
