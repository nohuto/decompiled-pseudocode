/*
 * XREFs of ?SmmCreateLogicalAllocator@@YAJ_KPEAPEAUSYSMM_LOGICAL_ALLOCATOR@@@Z @ 0x1C03D6E6C
 * Callers:
 ...
 *     SmmAddBlockToPool @ 0x1C0070AF8 (SmmAddBlockToPool.c)
 *     SmmAllocateBlock @ 0x1C0070B28 (SmmAllocateBlock.c)
 *     SmmGetLogicalPool @ 0x1C0071084 (SmmGetLogicalPool.c)
 *     SmmGetLowerOrderFromPageCount @ 0x1C0071098 (SmmGetLowerOrderFromPageCount.c)
 *     SmmGetOrderBlockSizeInPages @ 0x1C00710B4 (SmmGetOrderBlockSizeInPages.c)
 *     SmmInitializeLogicalBlock @ 0x1C00710C4 (SmmInitializeLogicalBlock.c)
...
__int64 __fastcall SmmCreateLogicalAllocator(unsigned __int64 a1, struct SYSMM_LOGICAL_ALLOCATOR **a2)
{
  ...
  if ( !v5 )
  {
    _InterlockedIncrement(&dword_1C0140D38);
...
LABEL_11:
  ...
  *(_DWORD *)(v6 + 1320) ^= (*(_DWORD *)(v6 + 1320) ^ ((unsigned int)dword_1C0140CD0 >> 6)) & 1;
  result = 0LL;
