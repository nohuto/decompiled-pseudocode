/*
 * XREFs of DpiAcpiCallAcpiEventHandler @ 0x1C00660C4
 * Callers:
 *     ?DpiAcpiPowerStateCallback@@YAXPEAX00@Z @ 0x1C001CF30 (-DpiAcpiPowerStateCallback@@YAXPEAX00@Z.c)
 *     DpiTryLidStateRecovery @ 0x1C005E78C (DpiTryLidStateRecovery.c)
 *     ?DpiAcpiEventCallback@@YAXPEAXK@Z @ 0x1C0066070 (-DpiAcpiEventCallback@@YAXPEAXK@Z.c)
 *     DpiAcpiDockEventCallback @ 0x1C03A6880 (DpiAcpiDockEventCallback.c)
 * Callees:
  ...
  *(_DWORD *)ActivityId[1].Data4 = 4;
  ...
  if ( Pool2 )
  {
    ...
    *((_QWORD *)Pool2 + 13) = *(_QWORD *)&v11.Data1;
    ...
    v13 = (_QWORD *)qword_1C0140668;
    if ( *(__int64 **)qword_1C0140668 != &qword_1C0140660 )
      __fastfail(3u);
    *(_QWORD *)Pool2 = &qword_1C0140660;
    *((_QWORD *)Pool2 + 1) = v13;
    *v13 = Pool2;
    qword_1C0140668 = (__int64)Pool2;
    if ( !IoWorkItem )
    {
