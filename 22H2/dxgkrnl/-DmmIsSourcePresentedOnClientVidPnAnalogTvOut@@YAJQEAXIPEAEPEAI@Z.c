/*
 * XREFs of ?DmmIsSourcePresentedOnClientVidPnAnalogTvOut@@YAJQEAXIPEAEPEAI@Z @ 0x1C02DE058
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  __int64 v39[6]; // [rsp+28h] [rbp-30h] BYREF
...
LABEL_5:
  ...
  if ( v16 )
  {
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(v39, v16);
    v18 = *(_QWORD *)(v16 + 88);
    v38 = 0LL;
    if ( v18 )
    {
    ...
    auto_rc<DMMVIDPN const>::reset(&v38, v19);
    if ( v38 )
    {
      v25 = (char **)(v38 + 96);
      ...
      {
        v40 = -1;
        v28 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v25, (unsigned int)v5, i, &v40);
        v24 = v28;
        if ( v28 < 0 )
          break;
        v31 = v40;
...
LABEL_23:
        ...
        {
          v34 = WdLogNewEntry5_WdError(v33, v29);
          *(_QWORD *)(v34 + 24) = v31;
          *(_QWORD *)(v34 + 32) = v26;
          WdLogEvent5_WdError(v34);
        }
      }
      v35 = (_QWORD *)WdLogNewEntry5_WdTrace(v30, v29);
      v35[3] = i;
      v35[4] = v5;
      v35[5] = v25;
      v35[6] = v24;
      if ( v26 )
        ReferenceCounted::Release((ReferenceCounted *)(v26 + 64), v36);
    }
    else
    {
...
LABEL_30:
    ...
    DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v39[0] + 40), v37);
    return v4;
  }
  else
  {
