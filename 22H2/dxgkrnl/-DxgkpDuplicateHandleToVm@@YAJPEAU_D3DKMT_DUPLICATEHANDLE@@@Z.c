/*
 * XREFs of ?DxgkpDuplicateHandleToVm@@YAJPEAU_D3DKMT_DUPLICATEHANDLE@@@Z @ 0x1C0277CDC
 * Callers:
 ...
 *     ??0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z @ 0x1C02382EC (--0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z.c)
...
__int64 __fastcall DxgkpDuplicateHandleToVm(struct _D3DKMT_DUPLICATEHANDLE *a1)
{
  ...
  if ( *((_DWORD *)v1 + 88) >= 0x14u )
  {
    ...
    if ( v40 )
    {
      DXGPROCESS::FreeResourceHandleNoRefSafe(v1[7], v49);
