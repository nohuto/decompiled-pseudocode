/*
 * XREFs of ?VmBusSendAsyncMessage@@YAJPEAUVMBCHANNEL__@@PEAUDXGKVMB_COMMAND_BASE@@IPEAU_MDL@@@Z @ 0x1C004195C
 * Callers:
        ...
        struct _MDL *a4)
{
  ...
  if ( v4 - 24 <= 0x1FFE7 )
  {
    v10 = _InterlockedIncrement64(&qword_1C00B46C8);
...
LABEL_17:
    ...
    v28 = 0LL;
    v14 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, struct DXGKVMB_COMMAND_BASE *, _QWORD, _QWORD, _DWORD, _QWORD, _QWORD, struct _MDL **))qword_1C00B43B0)(
            a1,
            a2,
            v4,
            0LL,
