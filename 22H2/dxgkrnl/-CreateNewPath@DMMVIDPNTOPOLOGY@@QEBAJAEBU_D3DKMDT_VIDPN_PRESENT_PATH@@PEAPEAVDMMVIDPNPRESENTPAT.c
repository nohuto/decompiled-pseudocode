/*
 * XREFs of ?CreateNewPath@DMMVIDPNTOPOLOGY@@QEBAJAEBU_D3DKMDT_VIDPN_PRESENT_PATH@@PEAPEAVDMMVIDPNPRESENTPATH@@@Z @ 0x1C01519B8
 * Callers:
        ...
        struct DMMVIDPNPRESENTPATH **a3)
{
  ...
  __int64 v50; // rax
  _QWORD *v51; // rax
  __int64 (__fastcall ***v52)(_QWORD, __int64); // [rsp+20h] [rbp-1C8h] BYREF
  __int64 v53; // [rsp+28h] [rbp-1C0h]
  struct _D3DKMDT_VIDPN_PRESENT_PATH v54; // [rsp+30h] [rbp-1B8h] BYREF
  ...
  *a3 = 0LL;
  ...
  if ( v11 )
  {
    ...
    v53 = IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(*(_QWORD *)(v12 + 312), VidPnTargetId);
    v15 = (struct DMMVIDPNTARGET *)v53;
    if ( v53 )
    {
      ...
      else
      {
        ...
        *(_QWORD *)&v18->CopyProtection.OEMCopyProtection[20] = v33;
        if ( v27 )
        {
          LowestAvailImportanceOrdinal = DMMVIDPNTOPOLOGY::GetLowestAvailImportanceOrdinal(this, &v54.ImportanceOrdinal);
          v39 = LowestAvailImportanceOrdinal;
          if ( LowestAvailImportanceOrdinal < 0 )
          {
            v49 = WdLogNewEntry5_WdTrace(v48, v47);
            *(_QWORD *)(v49 + 24) = this;
            *(_QWORD *)(v49 + 32) = v39;
            goto LABEL_14;
          }
        ...
        if ( v34 )
          v34 = DMMVIDPNPRESENTPATH::DMMVIDPNPRESENTPATH(v34, v11, v15, &v54);
        auto_ptr<DMMVIDPNPRESENTPATH>::reset(&v52, (__int64 (__fastcall ***)(_QWORD, __int64))v34);
        v39 = (__int64)v52;
        if ( v52 )
        {
          if ( ((unsigned __int8 (__fastcall *)(__int64 (__fastcall ***)(_QWORD, __int64)))*v52[7])(v52 + 7) )
          {
            v52 = 0LL;
          ...
          {
            v51 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v40);
            v51[3] = a2->VidPnSourceId;
            v51[4] = a2->VidPnTargetId;
            v51[5] = this;
            v51[6] = *(int *)(v39 + 64);
        ...
        {
          v50 = WdLogNewEntry5_WdLowResource(v36, v35, v37, v38);
          *(_QWORD *)(v50 + 24) = this;
...
LABEL_14:
  auto_ptr<DMMVIDPNPRESENTPATH>::~auto_ptr<DMMVIDPNPRESENTPATH>(&v52);
