/*
 * XREFs of ?Enable@DXGVMBUSCHANNEL@@QEAAJ_N@Z @ 0x1C02B5904
 * Callers:
...
__int64 __fastcall DXGVMBUSCHANNEL::Enable(DXGVMBUSCHANNEL *this, char a2)
{
  ...
  if ( v6 )
  {
    if ( !*((_BYTE *)this + 26) && (!*((_BYTE *)this + 24) || *((_BYTE *)this + 25)) )
    {
      ...
      *((_BYTE *)this + 24) = 1;
      *((_BYTE *)this + 26) = 1;
      v8 = ((__int64 (__fastcall *)(__int64))qword_1C00B4330)(v6);
      v4 = v8;
      if ( v8 < 0 )
      {
      ...
      {
        ((void (__fastcall *)(_QWORD))qword_1C00B43E0)(*((_QWORD *)this + 2));
      }
    }
