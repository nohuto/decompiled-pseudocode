/*
 * XREFs of ?WriteDxgDiagnosticsEvent_OUTPUTDUPL@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C00461C4
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_OUTPUTDUPL(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C00B1A20 > 4 && tlgKeywordOn((__int64)&dword_1C00B1A20, 0x200000000200LL) )
  {
    v4 = *(_DWORD *)(v2 + 48);
    if ( !v4 )
    {
      if ( !tlgKeywordOn(v3, v1) )
        return;
      v9 = (unsigned __int8 *)&unk_1C007F480;
      goto LABEL_12;
    }
    v5 = v4 - 1;
    if ( !v5 )
    {
      if ( !tlgKeywordOn(v3, v1) )
        return;
      v9 = (unsigned __int8 *)&unk_1C007F418;
      goto LABEL_12;
    }
    if ( v5 == 10 && tlgKeywordOn(v3, v1) )
    {
      v9 = (unsigned __int8 *)&unk_1C007F449;
LABEL_12:
      v11 = *(_WORD *)(v8 + 4);
      v10 = v8;
      v12 = 5;
