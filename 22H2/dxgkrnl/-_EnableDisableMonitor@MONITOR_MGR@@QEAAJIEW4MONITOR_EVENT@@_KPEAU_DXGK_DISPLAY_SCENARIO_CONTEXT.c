/*
 * XREFs of ?_EnableDisableMonitor@MONITOR_MGR@@QEAAJIEW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0148E90
 * Callers:
 ...
 *     ?_EnableDisableMonitorInternal@MONITOR_MGR@@QEAAJIEW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0177544 (-_EnableDisableMonitorInternal@MONITOR_MGR@@QEAAJIEW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO.c)
 */
...
__int64 __fastcall MONITOR_MGR::_EnableDisableMonitor(__int64 a1, __int64 a2, char a3, int a4, unsigned __int64 a5)
{
  ...
  __int64 v50; // r12
  _QWORD *v51; // rax
  _OWORD v52[2]; // [rsp+30h] [rbp-48h] BYREF
  ...
  *((_QWORD *)&v52[0] + 1) = a5;
  ...
  LODWORD(v52[0]) = v12 & 0xFFFFFF8F | (16 * (v15 | (2 * (v13 & 1 | (2 * (v14 & 1))))));
  MONITOR_MGR::_LogMonitorPresentEvent(a1, 14LL, 0xFFFFFFFF, 0, v52);
  v19 = 0;
