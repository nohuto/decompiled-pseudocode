/*
 * XREFs of ?InvalidatePrimaryAllocations@DXGDEVICE@@QEAAXI@Z @ 0x1C02559F4
 * Callers:
...
void __fastcall DXGDEVICE::InvalidatePrimaryAllocations(DXGDEVICE *this, __int64 a2)
{
  ...
  DXGPUSHLOCK *v20; // [rsp+38h] [rbp-20h]
  ...
  if ( !DXGADAPTER::IsCoreResourceExclusiveOwner(*((PERESOURCE **)this + 231)) )
  {
    ...
    *(_QWORD *)(v10 + 24) = 3693LL;
    WdLogEvent5_WdAssertion(v10);
  }
  if ( *((_DWORD *)this + 108) )
  {
    v11 = WdLogNewEntry5_WdAssertion(v9, v8);
    *(_QWORD *)(v11 + 24) = 3694LL;
    WdLogEvent5_WdAssertion(v11);
  }
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v19, (struct _KTHREAD **)this + 42, 0);
  DXGPUSHLOCK::AcquireExclusive(v20);
  *((_DWORD *)this + v3 + 302) &= ~0x200u;
  v14 = 0LL;
  for ( i = 2; (unsigned int)v14 < *((_DWORD *)this + v3 + 238); v14 = (unsigned int)(v14 + 1) )
  {
    if ( *(_QWORD *)(*((_QWORD *)this + v3 + 103) + 8 * v14) )
    {
      v15 = (_QWORD *)WdLogNewEntry5_WdTrace(v13, v12);
      v15[3] = *(_QWORD *)(*((_QWORD *)this + v3 + 103) + 8 * v14);
      v15[4] = (unsigned int)v14;
      v15[5] = v3;
      v16 = *((_QWORD *)this + v3 + 103);
      v17 = *(_QWORD *)(*(_QWORD *)(v16 + 8 * v14) + 48LL);
      if ( (*(_DWORD *)(v17 + 4) & 0x10) != 0 )
      {
        v18 = WdLogNewEntry5_WdAssertion(v17, v16);
        *(_QWORD *)(v18 + 24) = 3706LL;
        WdLogEvent5_WdAssertion(v18);
        v16 = *((_QWORD *)this + v3 + 103);
      }
      (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 640LL) + 8LL) + 200LL))(
        *(_QWORD *)(*((_QWORD *)this + 2) + 648LL),
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v16 + 8 * v14) + 48LL) + 8LL));
      v13 = *(_QWORD *)(*((_QWORD *)this + v3 + 103) + 8 * v14);
      *(_DWORD *)(*(_QWORD *)(v13 + 48) + 4LL) |= 0x10u;
      *(_QWORD *)(*((_QWORD *)this + v3 + 103) + 8 * v14) = 0LL;
