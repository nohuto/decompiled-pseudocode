/*
 * XREFs of DpiKsrRestoreAdapterDriverState @ 0x1C02D33DC
 * Callers:
 ...
 *     ??1DXGK_ENUMERATE_KSR_MEMORY_CONTEXT@@QEAA@XZ @ 0x1C02D22E8 (--1DXGK_ENUMERATE_KSR_MEMORY_CONTEXT@@QEAA@XZ.c)
