/*
 * XREFs of _pReadDetailTimingFromReg @ 0x1C03C8C94
 * Callers:
 *     _pLoadAdditinalMode @ 0x1C01D6DA4 (_pLoadAdditinalMode.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0023E40 (__security_check_cookie.c)
 *     ?IsValidVideoStandardType@@YAJW4_D3DKMDT_VIDEO_SIGNAL_STANDARD@@@Z @ 0x1C006CCE4 (-IsValidVideoStandardType@@YAJW4_D3DKMDT_VIDEO_SIGNAL_STANDARD@@@Z.c)
 */
...
__int64 __fastcall pReadDetailTimingFromReg(HANDLE KeyHandle, int a2, unsigned int a3, __int64 a4)
{
  ...
  for ( i = KeyHandle; ; v9 = i )
  {
    v10 = ZwQueryValueKey(
            v9,
            (PUNICODE_STRING)&unk_1C008EDE0 + v5,
