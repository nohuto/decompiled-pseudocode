/*
 * XREFs of ?CreatePeriodicFrameNotification@BLTQUEUE@@QEAAJPEAVDXGADAPTER@@PEAU_VIDSCH_SYNC_OBJECT@@_KIPEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@PEA_K@Z @ 0x1C03D102C
 * Callers:
        ...
        unsigned __int64 *a7)
{
  ...
  *a7 = 0LL;
  if ( !this[362] )
  {
    FenceValueCPUVirtualAddress = 3625LL;
    WdLogSingleEntry1(2LL, 3625LL);
