/*
 * XREFs of DpiAddDevice @ 0x1C018BAE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiQueryBusInterface @ 0x1C018E6B0 (DpiQueryBusInterface.c)
 ...
 *     DpiGetAgpStatus @ 0x1C019DA74 (DpiGetAgpStatus.c)
 ...
 *     DpiSetDeviceUsageType @ 0x1C02C8904 (DpiSetDeviceUsageType.c)
        ...
        __int64 a3)
{
  ...
  struct _DEVICE_OBJECT *v175; // r14
  int v176; // eax
  __int64 v177; // rcx
  __int64 v178; // r8
  BOOLEAN Exclusive[8]; // [rsp+28h] [rbp-D8h]
  char v181; // [rsp+41h] [rbp-BFh]
  char v182; // [rsp+43h] [rbp-BDh]
  PDEVICE_OBJECT DeviceObjecta; // [rsp+48h] [rbp-B8h] BYREF
  char v184; // [rsp+50h] [rbp-B0h]
  char v185; // [rsp+51h] [rbp-AFh]
  char v186; // [rsp+52h] [rbp-AEh]
  char v187; // [rsp+53h] [rbp-ADh]
  char v188; // [rsp+54h] [rbp-ACh]
  char v189; // [rsp+55h] [rbp-ABh]
  char v190; // [rsp+56h] [rbp-AAh] BYREF
  char v191; // [rsp+57h] [rbp-A9h]
  char v192; // [rsp+58h] [rbp-A8h]
  char v193; // [rsp+59h] [rbp-A7h]
  ULONG ResultLength; // [rsp+5Ch] [rbp-A4h] BYREF
  int v195; // [rsp+60h] [rbp-A0h]
  PDEVICE_OBJECT TargetDevice; // [rsp+68h] [rbp-98h]
  unsigned int v197; // [rsp+70h] [rbp-90h] BYREF
  int v198; // [rsp+74h] [rbp-8Ch]
  int v199; // [rsp+78h] [rbp-88h] BYREF
  ...
  __int64 v204; // [rsp+98h] [rbp-68h] BYREF
  PDRIVER_OBJECT DriverObject; // [rsp+A0h] [rbp-60h]
  int v206; // [rsp+A8h] [rbp-58h]
  int v207; // [rsp+ACh] [rbp-54h]
  const wchar_t *v208; // [rsp+B0h] [rbp-50h] BYREF
  _DWORD v209[2]; // [rsp+B8h] [rbp-48h]
  UNICODE_STRING String1; // [rsp+C0h] [rbp-40h] BYREF
  UNICODE_STRING v211; // [rsp+D0h] [rbp-30h] BYREF
  UNICODE_STRING v212; // [rsp+E0h] [rbp-20h] BYREF
  UNICODE_STRING v213; // [rsp+F0h] [rbp-10h] BYREF
  UNICODE_STRING v214; // [rsp+100h] [rbp+0h] BYREF
  UNICODE_STRING v215; // [rsp+110h] [rbp+10h] BYREF
  __int64 v216; // [rsp+120h] [rbp+20h] BYREF
  _QWORD v217[14]; // [rsp+130h] [rbp+30h] BYREF
  int v218[4]; // [rsp+1A0h] [rbp+A0h] BYREF
  __int64 v219; // [rsp+1B0h] [rbp+B0h]
  __int64 v220; // [rsp+1B8h] [rbp+B8h] BYREF
  int v221; // [rsp+1C0h] [rbp+C0h]
  _DWORD v222[2]; // [rsp+1D0h] [rbp+D0h] BYREF
  _BYTE v223[24]; // [rsp+1D8h] [rbp+D8h] BYREF
  __int64 v224; // [rsp+1F0h] [rbp+F0h]
  int v225; // [rsp+1F8h] [rbp+F8h]
  int v226; // [rsp+1FCh] [rbp+FCh]
  int v227; // [rsp+200h] [rbp+100h]
  int v228; // [rsp+204h] [rbp+104h]
  int v229; // [rsp+208h] [rbp+108h]
  int v230; // [rsp+20Ch] [rbp+10Ch]
  _DWORD VersionInformation[72]; // [rsp+210h] [rbp+110h] BYREF
  _DWORD v232[2]; // [rsp+330h] [rbp+230h]
  const wchar_t *v233; // [rsp+338h] [rbp+238h] BYREF
  int v234; // [rsp+340h] [rbp+240h]
  const wchar_t *v235; // [rsp+348h] [rbp+248h]
  int v236; // [rsp+350h] [rbp+250h]
  const wchar_t *v237; // [rsp+358h] [rbp+258h]
  int v238; // [rsp+360h] [rbp+260h]
  const wchar_t *v239; // [rsp+368h] [rbp+268h]
  int v240; // [rsp+370h] [rbp+270h]
  const wchar_t *v241; // [rsp+378h] [rbp+278h]
  __int128 v242; // [rsp+380h] [rbp+280h] BYREF
  __int128 v243; // [rsp+390h] [rbp+290h]
  int v244; // [rsp+3A0h] [rbp+2A0h]
  __int128 v245; // [rsp+3A8h] [rbp+2A8h] BYREF
  __int64 v246; // [rsp+3B8h] [rbp+2B8h]
  wchar_t v247; // [rsp+3C0h] [rbp+2C0h]
  _OWORD v248[2]; // [rsp+3C8h] [rbp+2C8h] BYREF
  __int64 v249; // [rsp+3E8h] [rbp+2E8h]
  wchar_t v250; // [rsp+3F0h] [rbp+2F0h]
  _OWORD v251[2]; // [rsp+3F8h] [rbp+2F8h] BYREF
  wchar_t v252; // [rsp+418h] [rbp+318h]
  _OWORD v253[2]; // [rsp+420h] [rbp+320h] BYREF
  __int64 v254; // [rsp+440h] [rbp+340h]
  int v255; // [rsp+448h] [rbp+348h]
  _OWORD v256[2]; // [rsp+450h] [rbp+350h] BYREF
  __int64 v257; // [rsp+470h] [rbp+370h]
  _OWORD v258[4]; // [rsp+480h] [rbp+380h] BYREF
  int v259; // [rsp+4C0h] [rbp+3C0h]

  v220 = 0LL;
  v221 = 0;
  DeviceExtension = 0LL;
  v245 = *(_OWORD *)L"\\Driver\\VGPU";
  v247 = aDriverVgpu[12];
  v6 = 0LL;
  v246 = *(_QWORD *)L"VGPU";
  v214.Buffer = (wchar_t *)&v245;
  v251[0] = *(_OWORD *)L"\\Driver\\WddmWarp";
  v252 = aDriverWddmwarp[16];
  v211.Buffer = (wchar_t *)v251;
  String1.Buffer = (wchar_t *)v256;
  v256[0] = *(_OWORD *)L"\\Driver\\BasicRender";
  v250 = aDriverBasicdis[20];
  v257 = *(_QWORD *)L"der";
  v215.Buffer = (wchar_t *)v248;
  v248[0] = *(_OWORD *)L"\\Driver\\BasicDisplay";
  v255 = *(_DWORD *)L"r";
  v251[1] = *(_OWORD *)L"WddmWarp";
  TargetDevice = DeviceObject;
  DriverObject = ClientIdentificationAddress;
  v249 = *(_QWORD *)L"play";
  v201 = 0LL;
  v256[1] = *(_OWORD *)L"BasicRender";
  v193 = 0;
  DeviceObjecta = 0LL;
  v253[0] = *(_OWORD *)L"\\Driver\\VirtualRender";
  ResultLength = 0;
  v248[1] = *(_OWORD *)L"BasicDisplay";
  v182 = 1;
  LOBYTE(v198) = 0;
  v254 = *(_QWORD *)L"ender";
  v258[0] = *(_OWORD *)L"\\Driver\\VirtualComputeAccelerator";
  v191 = 0;
  v192 = 0;
  v181 = 0;
  v187 = 0;
  ...
  v184 = 0;
  v195 = 3;
  *(_QWORD *)&v214.Length = 1703960LL;
  *(_QWORD *)&v211.Length = 2228256LL;
  *(_QWORD *)&String1.Length = 2621478LL;
  *(_QWORD *)&v215.Length = 2752552LL;
  v253[1] = *(_OWORD *)L"VirtualRender";
  *(_QWORD *)&v212.Length = 2883626LL;
  v212.Buffer = (wchar_t *)v253;
  v258[1] = *(_OWORD *)L"VirtualComputeAccelerator";
  v259 = *(_DWORD *)L"r";
  v258[3] = *(_OWORD *)L"celerator";
  v258[2] = *(_OWORD *)L"omputeAccelerator";
  *(_QWORD *)&v213.Length = 4456514LL;
  v213.Buffer = (wchar_t *)v258;
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0ppq_EtwWriteTransfer(64LL, &EventEnterDpiAddDevice, a3, ClientIdentificationAddress, DeviceObject, 0);
  v216 = MEMORY[0xFFFFF78000000320];
  ...
  if ( !DriverObjectExtension || DriverObjectExtension[4] != 1953656900 || DriverObjectExtension[5] != 1 )
  {
    ...
    v169 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v9, v8);
    v169[3] = 275LL;
    v169[4] = 21LL;
    v169[5] = -1073741811LL;
  ...
  v11 = DpiDxgkDdiAddDevice(DriverObjectExtension, DeviceObject, &v201);
  started = v11;
  if ( v11 < 0 )
  {
...
LABEL_270:
  ...
  if ( !RtlCompareUnicodeString(&v211, p_DriverName, 1u) )
  {
    v185 = 1;
LABEL_15:
    v20 = 0;
  ...
  if ( !RtlCompareUnicodeString(&v212, p_DriverName, 1u) || !RtlCompareUnicodeString(&v213, p_DriverName, 1u) )
  {
    v184 = 1;
    goto LABEL_15;
  }
  if ( !RtlCompareUnicodeString(&v214, p_DriverName, 1u) )
  {
    v188 = 1;
    goto LABEL_15;
  }
  if ( RtlCompareUnicodeString(&v215, p_DriverName, 1u) )
  {
    ...
    LODWORD(v217[1]) = 292;
    v217[3] = &v197;
    LODWORD(v217[4]) = 67108868;
    LODWORD(v217[6]) = 4;
    RegistryValues = RtlQueryRegistryValuesEx(0LL, v39, v217, 0LL, 0LL);
...
LABEL_16:
  if ( v201 )
  {
    ...
    if ( *(_QWORD *)(v10 + 616) )
    {
      ...
      v42 = DpiDxgkDdiLinkDevice(v10, (__int64)TargetDevice, v201, (int *)&v220);
      started = v42;
      if ( v42 < 0 )
      {
...
LABEL_19:
  ...
  v44 = IoCreateDevice(DriverObject, v21, 0LL, 0x23u, v186 == 0 ? 0x100 : 0, 0, &DeviceObjecta);
  started = v44;
  if ( v44 < 0 )
  {
LABEL_63:
  ...
  v195 |= (unsigned int)DeviceObjecta & 0xFFFF00;
  ...
  *((_QWORD *)DeviceExtension + 6) = v201;
  DeviceExtension[480] = v181;
  v45 = v184;
  ...
  *((_DWORD *)DeviceExtension + 70) = 1;
  ...
  v6 = DeviceExtension;
  DeviceExtension[2693] = v185;
  DeviceExtension[1154] = v187;
  DeviceExtension[1158] = v186;
  DeviceExtension[2694] = v188;
  DeviceExtension[2695] = v189;
  ...
  *(_QWORD *)(DeviceExtension + 500) = v220;
  *((_DWORD *)DeviceExtension + 127) = v221;
  ...
  if ( !v181 )
  {
    v76 = DpiFdoDetectPostDevice((__int64)DeviceObjecta, &v190);
    started = v76;
    if ( v76 < 0 )
    {
LABEL_95:
  ...
  v199 = 0;
  v79 = (int)DpiReadPnpRegistryValue((__int64)DeviceObjecta, L"SoftGPUAdapter", (char *)&v199, 4u, 2u) >= 0 && v199;
...
LABEL_144:
    ...
    *((_DWORD *)DeviceExtension + 280) = 2;
    ...
    BYTE1(v218[2]) = 0;
    HIWORD(v218[2]) = 0;
    strcpy((char *)v218, "AeiC_HID");
    v218[3] = 0;
    v242 = 0LL;
    v243 = 0LL;
    v112 = DpEvalAcpiMethod((__int64)DeviceObjecta, 0xFFFFFFFFLL, v218, 0x18u, &v242, 0x24u);
    v115 = v112;
    if ( v112 >= 0 )
    {
      *(_QWORD *)(DeviceExtension + 1124) = v243;
    }
    else
    {
    ...
    v244 = 0;
    strcpy((char *)v218, "AeiC_SUB");
    BYTE1(v218[2]) = 0;
    HIWORD(v218[2]) = 0;
    v218[3] = 0;
    v242 = 0LL;
    v243 = 0LL;
    if ( (int)DpEvalAcpiMethod((__int64)DeviceObjecta, 0xFFFFFFFFLL, v218, 0x18u, &v242, 0x24u) >= 0 )
    {
      *(_QWORD *)(DeviceExtension + 1132) = v243;
    }
    else
    {
    ...
    v244 = 0;
    strcpy((char *)v218, "AeiC_HRV");
    BYTE1(v218[2]) = 0;
    HIWORD(v218[2]) = 0;
    v218[3] = 0;
    v242 = 0LL;
    v243 = 0LL;
    LODWORD(started) = DpEvalAcpiMethod((__int64)DeviceObjecta, 0xFFFFFFFFLL, v218, 0x18u, &v242, 0x24u);
    if ( (int)started >= 0 )
    {
      *((_DWORD *)DeviceExtension + 285) = (unsigned __int16)v243;
    }
    else
    {
  ...
  else
  {
    ...
    else
    {
      ...
      *((_DWORD *)DeviceExtension + 280) = 3;
      ...
      {
        P = 0LL;
        v125 = DpiGetDevicePropertyString(v72, DevicePropertyCompatibleIDs, PagedPool, &P, &ResultLength);
        started = v125;
        if ( v125 >= 0 && (v128 = (char *)P) != 0LL )
        {
          ...
          if ( DeviceExtension[2692] )
          {
            *((_DWORD *)DeviceExtension + 281) = 5140;
            v130 = *(_WORD *)v128;
            v131 = &v233;
            v233 = L"SoftGPU_Full_D3D12";
            v235 = L"SoftGPU_Full_D3D9L";
            v237 = L"SoftGPU_Rod";
            v239 = L"SoftGPU_Dod";
            v241 = L"SoftGPU_MCDM";
            v232[0] = 135;
...
LABEL_184:
            *((_DWORD *)DeviceExtension + 282) = v232[4 * v129];
          }
          else
          {
            v134 = *(_WORD *)P;
            v208 = L"MCDMTestDevice";
            v135 = &v208;
            v206 = 5140;
            v207 = 256;
            v209[0] = 2697;
...
LABEL_194:
            *((_DWORD *)DeviceExtension + 281) = *(&v206 + 6 * (int)v129);
            *((_DWORD *)DeviceExtension + 282) = *(&v207 + 6 * (int)v129);
            DeviceExtension[v209[6 * v129]] = 1;
LABEL_195:
...
LABEL_203:
  ...
  *((_DWORD *)DeviceExtension + 681) = 49156;
  if ( *(_DWORD *)(v10 + 28) >= 0xB003u
    ...
    && !DeviceExtension[480] )
  {
    v143 = *((_DWORD *)DeviceExtension + 281);
    if ( v143 == 4098 )
    {
  ...
  if ( *((_DWORD *)DeviceExtension + 4) == 1953656900 )
  {
    ...
    {
      v144 = DpiFdoInitializeFdo(DeviceObjecta);
      started = v144;
      if ( v144 < 0 )
        goto LABEL_95;
      v191 = 1;
...
LABEL_228:
  ...
  if ( v6 )
  {
    if ( *((_DWORD *)v6 + 126) )
    {
      v145 = DpiLdaLinkDeviceToChain(DeviceObjecta);
      started = v145;
      if ( v145 < 0 )
      {
        v148 = WdLogNewEntry5_WdError(v147, v146);
        *(_QWORD *)(v148 + 24) = started;
  ...
  *((_QWORD *)DeviceExtension + 1) = v149;
  *v149 = DeviceExtension;
  *(_QWORD *)(v10 + 64) = DeviceExtension;
  ++*(_DWORD *)(v10 + 128);
  v56 = 1;
  if ( !*((_QWORD *)DeviceExtension + 21) )
  {
    v150 = ExAllocatePoolWithTag((POOL_TYPE)512, 0x70uLL, 0x74727044u);
    v154 = 0LL;
    *((_QWORD *)DeviceExtension + 21) = v150;
    if ( !v150 )
    {
LABEL_235:
      LODWORD(started) = -1073741801;
      v155 = WdLogNewEntry5_WdLowResource(v154, v151, v152, v153);
      *(_QWORD *)(v155 + 24) = -1073741801LL;
      WdLogEvent5_WdLowResource(v155);
      goto LABEL_273;
    }
    v150[26] = 1;
    *(_BYTE *)(*((_QWORD *)DeviceExtension + 21) + 108LL) = 0;
    v156 = ExInitializeResourceLite(*((PERESOURCE *)DeviceExtension + 21));
    started = v156;
    if ( v156 < 0 )
    {
      v159 = WdLogNewEntry5_WdError(v158, v157);
      *(_QWORD *)(v159 + 24) = started;
LABEL_238:
  ...
  if ( v6 )
  {
    if ( !*((_QWORD *)v6 + 182) )
    {
      v160 = ExAllocatePoolWithTag((POOL_TYPE)512, 0x10uLL, 0x74727044u);
      *((_QWORD *)v6 + 182) = v160;
      if ( !v160 )
        goto LABEL_235;
      v160[2] = 1;
  ...
  *((_QWORD *)DeviceExtension + 16) = DpiFdoDispatchPnp;
    ...
    if ( v6[1152] )
    {
      *(_BYTE *)(*((_QWORD *)v6 + 21) + 108LL) = 1;
      ...
      if ( qword_1C00B2DB8 && qword_1C00B2DB8 != qword_1C00B2DC0 )
      {
        ...
        *(_QWORD *)(v166 + 24) = DeviceObjecta;
        *(_QWORD *)(v166 + 32) = (int)started;
        WdLogEvent5_WdError(v166);
      }
      qword_1C00B2DB8 = (__int64)DeviceObjecta;
      v167 = *((_QWORD *)v6 + 6);
      v204 = 0LL;
      started = (int)DpiDxgkDdiExchangePreStartInfo(v10, v167, &v204);
      _InterlockedExchange64(&qword_1C00B2B50, 0LL);
      KeReleaseMutex(Mutex, 0);
      if ( (int)started < 0 )
      {
        v159 = WdLogNewEntry5_WdError(v163, v162);
        *(_QWORD *)(v159 + 24) = *(_QWORD *)(v10 + 1144);
        *(_QWORD *)(v159 + 32) = started;
        goto LABEL_238;
      }
      if ( *((_DWORD *)v6 + 4) == 1953656900 && *((_DWORD *)v6 + 5) == 2 )
      {
        v162 = 1LL;
        v163 = HIDWORD(v204) >> 1;
        LOBYTE(v163) = (v204 & 0x200000000LL) != 0;
        v6[2741] = BYTE4(v204) & 1;
        v6[2742] = v163;
      }
    }
  }
  ...
  v168 = WdLogNewEntry5_WdEvent(v163, v162);
  *(_QWORD *)(v168 + 24) = DeviceObjecta;
  WdLogEvent5_WdEvent(v168);
LABEL_271:
  if ( (int)started >= 0 )
    goto LABEL_291;
  if ( v56 == 1 )
...
LABEL_273:
    ...
    KeWaitForSingleObject((PVOID)(v10 + 72), Executive, 0, 0, 0LL);
    v170 = *(_QWORD **)DeviceExtension;
    if ( *(char **)(*(_QWORD *)DeviceExtension + 8LL) == DeviceExtension )
    {
      v171 = (PVOID *)*((_QWORD *)DeviceExtension + 1);
      if ( *v171 == DeviceExtension )
      {
        *v171 = v170;
        v170[1] = v171;
        --*(_DWORD *)(v10 + 128);
...
LABEL_21:
  ...
  if ( v193 == 1 )
  {
    DpiDxgkDdiRemoveDevice(v10, v201);
    v35 = v182;
  }
  else
  {
    ...
    if ( *(_QWORD *)(v10 + 1344) )
    {
      ...
      v173 = DiagnosticInfoArgs;
      if ( DiagnosticInfoArgs )
      {
        v174 = *(_DWORD *)(DiagnosticInfoArgs + 216);
        v175 = TargetDevice;
        *(_QWORD *)DiagnosticInfoArgs = v201;
        if ( (*(int (__fastcall **)(struct _DEVICE_OBJECT *, __int64))(v10 + 1344))(v175, DiagnosticInfoArgs) >= 0 )
        {
          if ( *(_DWORD *)(v173 + 220) > v174 )
            *(_DWORD *)(v173 + 220) = 0;
          DxgCreateLiveDumpWithDriverBlob(
            ...
            *(int *)(v173 + 8),
            ...
            0LL,
            0LL,
            (struct _DXGKARG_COLLECTDIAGNOSTICINFO *)v173);
          v35 = 0;
        }
        DxgFreeDiagnosticInfoArgs((struct _DXGKARG_COLLECTDIAGNOSTICINFO *)v173);
      }
    }
  }
...
LABEL_291:
  ...
  v226 = 0;
  v176 = DxgkDiagCalcDuration1us(&v216);
  v222[0] = 6;
  v228 = v195;
  v222[1] = 64;
  v225 = 0;
  ...
  v229 = v176;
  v230 = started;
  DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v222, 0x100000000LL);
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
  {
