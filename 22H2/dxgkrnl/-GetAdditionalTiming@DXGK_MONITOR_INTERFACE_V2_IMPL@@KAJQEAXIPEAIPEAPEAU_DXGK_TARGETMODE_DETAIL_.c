/*
 * XREFs of ?GetAdditionalTiming@DXGK_MONITOR_INTERFACE_V2_IMPL@@KAJQEAXIPEAIPEAPEAU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z @ 0x1C01D6970
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _pGetAdditionalModeEntry @ 0x1C02337E4 (_pGetAdditionalModeEntry.c)
 */
    ...
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v15 + 88, 0LL) )
    {
      if ( bTracingEnabled )
      {
        ...
        if ( v40 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
          McTemplateK0q_EtwWriteTransfer(v19, &EventBlockThread, v17, v40);
      }
...
LABEL_89:
  ...
  KeEnterCriticalRegion();
  ExAcquirePushLockSharedEx(&qword_1C01410C0, 0LL);
  if ( (_DWORD)v34 == -2 )
    WdLogSingleEntry0(1LL);
  AdditionalModeEntry = qword_1C01421E0;
  if ( qword_1C01421E0 )
  {
...
LABEL_48:
  ExReleasePushLockEx(&qword_1C01410C0, 0LL);
  ExAcquirePushLockExclusiveEx(&qword_1C01410C0, 0LL);
  if ( (_DWORD)v34 == -2 )
    WdLogSingleEntry0(1LL);
  AdditionalModeEntry = qword_1C01421E0;
  if ( qword_1C01421E0 )
