/*
 * XREFs of BmlPinPathContentScaling @ 0x1C0143D30
 * Callers:
...
__int64 __fastcall BmlPinPathContentScaling(__int64 a1, __int64 a2, unsigned __int16 a3)
{
  ...
  else
  {
    ...
    {
      if ( (dword_1C00B483C & 1) == 0 )
      {
        v24 = *(VIDPN_MGR **)(a2 + 48);
        dword_1C00B483C |= 1u;
        dword_1C00B47F0[0] = VIDPN_MGR::GetAdapterDefaultScaling(v24);
        dword_1C00B47F4 = 3;
        dword_1C00B47F8 = 4;
        dword_1C00B47FC = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v25 >= 4 )
          break;
        v11 = dword_1C00B47F0;
        v12 = (unsigned int)dword_1C00B47F0[v25];
