/*
 * XREFs of ?Augment@CDS_JOURNAL@@QEAAJPEAUD3DKMT_AUGMENT_CDSJ@@@Z @ 0x1C0150390
 * Callers:
 ...
 *     ?_FillEntry@CDS_JOURNAL@@CAXPEAU_ENTRY@1@AEBUD3DKMT_AUGMENT_CDSJ@@PEAVDXGADAPTER@@@Z @ 0x1C014FE00 (-_FillEntry@CDS_JOURNAL@@CAXPEAU_ENTRY@1@AEBUD3DKMT_AUGMENT_CDSJ@@PEAVDXGADAPTER@@@Z.c)
...
__int64 __fastcall CDS_JOURNAL::Augment(CDS_JOURNAL *this, struct D3DKMT_AUGMENT_CDSJ *a2)
{
  ...
  _DWORD v29[9]; // [rsp+E0h] [rbp-20h] BYREF
  __int64 v30; // [rsp+104h] [rbp+4h]
  __int128 v31; // [rsp+10Ch] [rbp+Ch]
  __int128 v32; // [rsp+11Ch] [rbp+1Ch]
  __int64 v33; // [rsp+12Ch] [rbp+2Ch]

  if ( (*(_DWORD *)a2 & 4) != 0 )
    return CDS_JOURNAL::_PreVerify(a2);
  CCD_TOPOLOGY::CCD_TOPOLOGY((CCD_TOPOLOGY *)v27, 8u, 0);
  LODWORD(v5) = CDS_JOURNAL::_FillTopology((struct CCD_TOPOLOGY *)v27, a2, 64);
  if ( (int)v5 >= 0 )
  {
    if ( *((_DWORD *)a2 + 4) == -1 )
    {
    ...
    else
    {
      ...
      {
        LODWORD(v5) = CCD_TOPOLOGY::VerifyConnectivityHash((CCD_TOPOLOGY *)v27, this, (__int64)v6);
      ...
      *((_DWORD *)this + 4) = *((_DWORD *)v8 + 4);
      if ( (*(_DWORD *)a2 & 1) != 0 )
      {
        ...
        *(_OWORD *)&v29[5] = 0LL;
        v31 = 0LL;
        v32 = 0LL;
        CDS_JOURNAL::_FillEntry((struct CDS_JOURNAL::_ENTRY *)v29, a2, v6);
        CCD_TOPOLOGY::CCD_TOPOLOGY((CCD_TOPOLOGY *)v25, 8u, 0);
        LODWORD(v5) = CDS_JOURNAL::_FillTopology((struct CCD_TOPOLOGY *)v25, a2, 15);
        if ( (int)v5 >= 0 )
        {
          v19 = CDS_JOURNAL::_CommitEntry((const struct CDS_JOURNAL::_ENTRY *)v29, (struct CCD_TOPOLOGY *)v25);
          v5 = v19;
          if ( v19 < 0
            || (CCD_TOPOLOGY::FillScalingIntent((CCD_TOPOLOGY *)v25),
                v22 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v25, 1LL),
                v5 = v22,
                v22 < 0) )
          {
          ...
          {
            LODWORD(v5) = CDS_JOURNAL::_PurgeRelatedEntries(this, (const struct CDS_JOURNAL::_ENTRY *)v29);
          }
        }
...
LABEL_8:
        ...
        if ( !v14 )
        {
          v24 = WdLogNewEntry5_WdLowResource(0LL, v11, v12, v13);
          *(_QWORD *)(v24 + 24) = 88LL;
