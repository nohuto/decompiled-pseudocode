/*
 * XREFs of ?DdiQueryDiagnosticTypesSupport@DXGADAPTER@@QEAAJPEAU_DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT@@@Z @ 0x1C021D658
 * Callers:
        ...
        __int64 a3)
{
  ...
  v17 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDIAGNOSTICTYPESSUPPORT *))this + 158))(
          *((_QWORD *)this + 34),
          a2);
  if ( v35[0] )
