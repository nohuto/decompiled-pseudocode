/*
 * XREFs of DxgkPresentMultiPlaneOverlay2 @ 0x1C02A82B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay2(struct _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 *a1)
{
  ...
  struct _D3DKMT_MULTIPLANE_OVERLAY2 *v96[2]; // [rsp+B0h] [rbp-50h] BYREF
  ...
  _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 v104; // [rsp+130h] [rbp+30h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v97, 2163LL);
  ...
  *(_OWORD *)v96 = 0LL;
  v88 = CapturePresentMultiPlaneOverlayArgs2(a1, &v104, v96, (struct tagRECT **)&v96[1]);
  if ( v88 < 0 )
  {
