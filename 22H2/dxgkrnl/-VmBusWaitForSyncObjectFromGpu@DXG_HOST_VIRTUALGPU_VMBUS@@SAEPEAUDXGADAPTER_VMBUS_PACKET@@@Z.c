/*
 * XREFs of ?VmBusWaitForSyncObjectFromGpu@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0395380
 * Callers:
 *     <none>
 * Callees:
...
LABEL_36:
    ...
    else
    {
      ...
      if ( v35 )
      {
        ...
        {
          WdLogSingleEntry1(3LL, 4301LL);
          goto LABEL_6;
        }
        v21 = 0LL;
        if ( !*(_BYTE *)(v5 + 32) )
          v21 = (const unsigned __int64 *)(v5 + 40);
