/*
 * XREFs of ?_ValidateMipiDsiPackets@MonitorMipiDsiState@DxgMonitor@@AEAAJPEAU_DXGK_DSI_TRANSMISSION@@@Z @ 0x1C03CFBB0
 * Callers:
 ...
 * Callees:
 *     ?_IsValidPacket@MonitorMipiDsiState@DxgMonitor@@AEAA_NPEBU_DXGK_DSI_PACKET@@_NI@Z @ 0x1C03CFA54 (-_IsValidPacket@MonitorMipiDsiState@DxgMonitor@@AEAA_NPEBU_DXGK_DSI_PACKET@@_NI@Z.c)
 */
