/*
 * XREFs of McTemplateK0xqq_EtwWriteTransfer @ 0x1C0056B24
 * Callers:
...
NTSTATUS McTemplateK0xqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  return McGenEventWrite_EtwWriteTransfer(
           ...
           &EventMiracastDeviceStateChange,
           a3,
           4u,
           &v4);
}
