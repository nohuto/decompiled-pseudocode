/*
 * XREFs of McTemplateK0ppqxqxqqqqqqqqquuuuqqqqqQR23qqp_EtwWriteTransfer @ 0x1C003A0C4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0ppqxqxqqqqqqqqquuuuqqqqqQR23qqp_EtwWriteTransfer(
        __int64 a1,
        ...
        char a31)
{
  ...
  v89 = &a31;
  v90 = 8LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, a2, a3, 0x1Du, &v33);
}
