/*
 * XREFs of ?DxgkAllocateMdlMemoryTracker@@YAJQEAXPEAU_MDL@@W4DXG_DRIVER_MEMORY_TRACKER_TYPE@@PEAPEAUDXG_DRIVER_MEMORY_TRACKER@@@Z @ 0x1C0042608
 * Callers:
 *     DxgkAllocatePagesForMdlCB @ 0x1C0042BD0 (DxgkAllocatePagesForMdlCB.c)
 *     DxgkMapMdlToIoMmuCB @ 0x1C00430B0 (DxgkMapMdlToIoMmuCB.c)
 * Callees:
