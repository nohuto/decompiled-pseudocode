/*
 * XREFs of ?PrepareUpdateTokensForDwm@CEndpointResourceStateManager@@QEAAJPEAUFlipManagerObject@@PEAVCFlipPropertySet@@AEAU_LIST_ENTRY@@@Z @ 0x1C006D1B8
 * Callers:
 ...
 *     ??$FindProperty@UPresentedContentUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedContentUpdateFlags@@@Z @ 0x1C006BF48 (--$FindProperty@UPresentedContentUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedConten.c)
