/*
 * XREFs of ?DisplayID_GetPreferredMode@@YAJPEBUDisplayIDObj@@PEAUDISPLAY_PREFERRED_MODE_INFO@@@Z @ 0x1C0060650
 * Callers:
 *     MonitorGetDpiInfoFromDescriptor @ 0x1C014D558 (MonitorGetDpiInfoFromDescriptor.c)
 * Callees:
 *     ?DisplayID_GetFirstType7Desc@@YAJAEBUDisplayIDObj@@AEAPEAU_DISPLAYID_TYPE7_TIMING_BLOCK@@@Z @ 0x1C0060400 (-DisplayID_GetFirstType7Desc@@YAJAEBUDisplayIDObj@@AEAPEAU_DISPLAYID_TYPE7_TIMING_BLOCK@@@Z.c)
