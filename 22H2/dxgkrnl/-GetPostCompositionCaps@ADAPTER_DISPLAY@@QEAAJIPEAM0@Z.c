/*
 * XREFs of ?GetPostCompositionCaps@ADAPTER_DISPLAY@@QEAAJIPEAM0@Z @ 0x1C015E248
 * Callers:
 ...
 *     ?SupportGetPostCompositionCaps@DXGADAPTER@@QEBAEXZ @ 0x1C003B064 (-SupportGetPostCompositionCaps@DXGADAPTER@@QEBAEXZ.c)
