/*
 * XREFs of ?DxgkNotifyWorkSubmissionInternal@@YAJPEAU_D3DKMT_NOTIFY_WORK_SUBMISSION@@_N@Z @ 0x1C0318C24
 * Callers:
 *     NtDxgkNotifyWorkSubmission @ 0x1C0320510 (NtDxgkNotifyWorkSubmission.c)
 * Callees:
