/*
 * XREFs of ?DxgkOpenAdapter@@YAJPEAU_D3DKMT_OPENADAPTER@@@Z @ 0x1C01B2620
 * Callers:
    ...
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)Current + 248, 0LL) )
    {
      if ( bTracingEnabled )
      {
        ...
        if ( v37 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
          McTemplateK0q_EtwWriteTransfer(v16, &EventBlockThread, v17, v37);
      }
...
LABEL_24:
        *(_QWORD *)(v23 + 80) = 0LL;
        ...
        if ( v24 < 0 )
        {
          DXGPROCESS::CloseAdapter(Current, (struct DXGADAPTER *const *)v23);
