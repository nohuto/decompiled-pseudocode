/*
 * XREFs of ?DxgkDestroySynchronizationObjectImpl@@YAJPEBU_D3DKMT_DESTROYSYNCHRONIZATIONOBJECT@@H@Z @ 0x1C01174F4
 * Callers:
 ...
 *     DxgkDestroySynchronizationObject @ 0x1C0163B70 (DxgkDestroySynchronizationObject.c)
