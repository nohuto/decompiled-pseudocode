/*
 * XREFs of ?PostNewMessage@CDWMBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z @ 0x1C006D800
 * Callers:
 *     <none>
 * Callees:
 *     ??$FindProperty@UPresentConfirmedStatistics@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentConfirmedStatistics@@@Z @ 0x1C006D5DC (--$FindProperty@UPresentConfirmedStatistics@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentConfirmed.c)
 *     ?PostNewMessage@CBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z @ 0x1C006D9C0 (-PostNewMessage@CBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z.c)
 */
