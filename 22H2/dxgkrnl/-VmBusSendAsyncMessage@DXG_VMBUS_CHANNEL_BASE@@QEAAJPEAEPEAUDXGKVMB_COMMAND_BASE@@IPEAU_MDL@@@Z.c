/*
 * XREFs of ?VmBusSendAsyncMessage@DXG_VMBUS_CHANNEL_BASE@@QEAAJPEAEPEAUDXGKVMB_COMMAND_BASE@@IPEAU_MDL@@@Z @ 0x1C005D000
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( a4 - 24 <= 0x1FFE7 )
  {
    v9 = _InterlockedIncrement64(&qword_1C0142458);
...
LABEL_17:
    v13 = *((_QWORD *)this + 1);
    v28 = 0LL;
    v14 = ((__int64 (__fastcall *)(__int64, unsigned __int8 *, _QWORD, _QWORD, _DWORD, _QWORD, _QWORD, __int64 *))qword_1C0141F70)(
            v13,
            a2,
            a4,
            0LL,
