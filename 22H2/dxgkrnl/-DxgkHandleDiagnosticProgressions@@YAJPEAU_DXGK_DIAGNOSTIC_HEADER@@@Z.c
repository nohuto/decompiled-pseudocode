/*
 * XREFs of ?DxgkHandleDiagnosticProgressions@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C004F720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkHandleDiagnosticProgressions(struct _DXGK_DIAGNOSTIC_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C013F950 > 4 && tlgKeywordOn((__int64)&dword_1C013F950, 1LL) )
  {
    if ( (v14 & 1) != 0 )
    {
      ...
      if ( (unsigned int)dword_1C013F950 <= 4 || !tlgKeywordOn((__int64)&dword_1C013F950, 1LL) )
        return 0LL;
      v18 = (unsigned __int8 *)&unk_1C00A7BA8;
      v19 = *(_BYTE *)&a1[1].Category.0 & 1;
      goto LABEL_23;
    }
    if ( tlgKeywordOn((__int64)&dword_1C013F950, v13) )
    {
      LOBYTE(v17) = v17 & 1;
      v18 = (unsigned __int8 *)&unk_1C00A7B5C;
      v19 = v17;
LABEL_23:
