/*
 * XREFs of ?SendCreateBundleObject@DXG_GUEST_REMOTEOBJECTCHANNEL@@QEAAJKPEAI0@Z @ 0x1C028BD98
 * Callers:
        ...
        struct _EX_RUNDOWN_REF *a4)
{
  ...
  if ( !v4 || !v5 || (unsigned int)(v6 - 1) > 0xF )
  {
...
LABEL_58:
  ...
  v26 = v5;
  v60 = v69;
  v27 = (char *)((char *)v68 - v5);
  v28 = (_BYTE *)(&v77[4] - v5);
  v65 = (char *)((char *)v68 - v5);
  v64 = (_BYTE *)(&v77[4] - v5);
  while ( 1 )
  {
    v29 = *(_DWORD *)((char *)v26 + (_QWORD)v27);
    if ( v29 == 4 )
      break;
    if ( v29 != 11 )
    {
      v45 = (_QWORD *)WdLogNewEntry5_WdWarning(v28, v23, v24);
      v49 = *(unsigned int *)&v5[4 * v25];
      LODWORD(v5) = -1073741811;
      v45[3] = v49;
      v45[4] = (int)v68[v25];
      v45[5] = -1073741811LL;
    ...
    v28 = (_BYTE *)*(unsigned int *)(v24 + 16 * v31 + 8);
    if ( (_BYTE)v30 != (*(_BYTE *)(v24 + 16 * v31 + 8) & 0x60)
      || ((unsigned __int16)v28 & 0x2000) != 0
      || ((unsigned __int8)v28 & 0x1F) == 0 )
    {
      goto LABEL_50;
    }
    v28 = (_BYTE *)((unsigned __int8)v28 & 0x1F);
    if ( (_BYTE)v28 != 11 )
    {
...
LABEL_45:
    ...
    v60 = v23;
    *(_DWORD *)((char *)v26++ + (_QWORD)v64) = v34;
  ...
  if ( (unsigned int)v36 < *((_DWORD *)Current + 64) )
  {
    ...
    if ( ((*v26 >> 25) & 0x60) == (*(_BYTE *)(v37 + 16 * v36 + 8) & 0x60) && (v38 & 0x2000) == 0 && (v38 & 0x1F) != 0 )
    {
      v39 = v38 & 0x1F;
      if ( (_BYTE)v39 == 4 )
      {
      ...
      v40 = WdLogNewEntry5_WdError(v39, (*v26 >> 25) & 0x60);
      *(_QWORD *)(v40 + 24) = 316LL;
