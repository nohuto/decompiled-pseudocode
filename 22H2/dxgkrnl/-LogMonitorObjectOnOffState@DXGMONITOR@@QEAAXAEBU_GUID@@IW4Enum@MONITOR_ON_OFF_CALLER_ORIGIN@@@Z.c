/*
 * XREFs of ?LogMonitorObjectOnOffState@DXGMONITOR@@QEAAXAEBU_GUID@@IW4Enum@MONITOR_ON_OFF_CALLER_ORIGIN@@@Z @ 0x1C01DD314
 * Callers:
...
void __fastcall DXGMONITOR::LogMonitorObjectOnOffState(__int64 a1, __int64 a2, int a3, char a4)
{
  ...
  if ( (unsigned int)dword_1C013F8A8 > 5 && tlgKeywordOn((__int64)&dword_1C013F8A8, 0x400000000010LL) )
  {
    v10 = (unsigned int)dword_1C01403F8;
    v20 = *v5;
    v16 = *(_QWORD *)(a1 + 144);
    v15 = *(_DWORD *)(a1 + 180);
    v18 = v14;
