/*
 * XREFs of ?CreateVidMmAllocations@DXGDEVICE@@QEAAJPEAU_D3DKMT_CREATEALLOCATION@@PEAU_D3DDDI_ALLOCATIONINFO2@@PEAU_DXGK_ALLOCATIONINFO@@PEAVDXGALLOCATION@@PEBU_D3DKM_CREATESTANDARDALLOCATION@@EPEAVCOREDEVICEACCESS@@@Z @ 0x1C0155200
 * Callers:
...
LABEL_152:
  ...
  while ( 1 )
  {
    ...
    if ( !*(_QWORD *)(v25 + 16) && (*(_DWORD *)&v9->Flags & 0x100000) == 0 )
    {
      ...
      *(_QWORD *)(v32 + 24) = 3964LL;
      WdLogEvent5_WdAssertion(v32);
      v9 = a2;
    }
    Value = v29->Flags.Value;
    if ( (Value & 0x4000) != 0 )
    {
    ...
    if ( (*(_DWORD *)&v35 & 0x10000) != 0 )
    {
      ...
      if ( (*(_BYTE *)&v35 & 0x20) != 0 )
      {
        ...
        Value = (unsigned int)Value | 0x10;
        v113 = hSection;
        v29->Flags.Value = Value;
        goto LABEL_44;
      }
      v37 = *(void **)(v15 + 8);
      v122 = 0LL;
...
LABEL_43:
    ...
    if ( (*((_BYTE *)DXGPROCESS::GetCurrent(v36, v15, Value, (__int64)v9) + 347) & 0x20) != 0 )
    {
      hSection = a3[v26].hSection;
...
LABEL_53:
    ...
    LOBYTE(Object) = (*((_BYTE *)DXGPROCESS::GetCurrent((__int64)a2, v15, Value, (__int64)v9) + 347) & 0x20) != 0;
