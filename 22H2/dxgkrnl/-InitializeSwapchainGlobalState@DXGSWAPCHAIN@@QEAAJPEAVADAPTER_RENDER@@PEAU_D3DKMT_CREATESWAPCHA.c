/*
 * XREFs of ?InitializeSwapchainGlobalState@DXGSWAPCHAIN@@QEAAJPEAVADAPTER_RENDER@@PEAU_D3DKMT_CREATESWAPCHAIN@@@Z @ 0x1C02AB590
 * Callers:
...
LABEL_6:
  ...
  *((_QWORD *)this + 26) = v15;
  ...
  if ( v20 >= 0 )
  {
    ...
    *(_QWORD *)(v26 + 24) = this;
    *(_QWORD *)(v26 + 32) = DXGPROCESS::GetCurrent(v28, v27, v29, v30);
