/*
 * XREFs of BmlFillPreferredMonitorMode @ 0x1C0143668
 * Callers:
 ...
 * Callees:
 *     MonitorGetNextMonitorSourceMode @ 0x1C01439E0 (MonitorGetNextMonitorSourceMode.c)
 ...
 *     BmlIsLowResAnalogTvOutput @ 0x1C0143D10 (BmlIsLowResAnalogTvOutput.c)
 ...
 *     BmlIsEDIDCapableOutputTechonology @ 0x1C016B310 (BmlIsEDIDCapableOutputTechonology.c)
 */
      ...
      while ( 1 )
      {
        ...
        if ( NextMonitorSourceMode == 1075708748 )
        {
          ...
          if ( (unsigned __int8)BmlIsLowResAnalogTvOutput(a3) )
          {
            ...
            if ( v6 < 0x300 )
              v6 = 768;
            v20 = BmlCompareModeExtents(&qword_1C007BDF0, &v24);
            v21 = v24;
            if ( v20 == 1 )
              v21 = 0x30000000400LL;
            v24 = v21;
