/*
 * XREFs of ?PinMode@DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@I@Z @ 0x1C02E8D60
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v20, 7015LL);
  ...
  *(_QWORD *)(v7 + 32) = this;
  ...
  if ( v9 )
  {
    v14 = DMMVIDPNTARGETMODESET::PinMode(v9, v4);
    if ( v14 >= 0 )
    {
      v14 = 0;
    }
