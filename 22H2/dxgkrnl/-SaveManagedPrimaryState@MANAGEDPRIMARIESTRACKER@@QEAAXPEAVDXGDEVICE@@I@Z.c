/*
 * XREFs of ?SaveManagedPrimaryState@MANAGEDPRIMARIESTRACKER@@QEAAXPEAVDXGDEVICE@@I@Z @ 0x1C00E46BC
 * Callers:
  ...
  if ( (v10 & 0xFFFFFFFC) != 0 )
  {
    do
    {
      *((_QWORD *)this + v9 + 3) = 0LL;
      if ( (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(*(ADAPTER_DISPLAY **)this, v9) - 1 <= 1 )
      {
