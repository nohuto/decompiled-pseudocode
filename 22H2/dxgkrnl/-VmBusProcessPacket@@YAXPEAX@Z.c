/*
 * XREFs of ?VmBusProcessPacket@@YAXPEAX@Z @ 0x1C0383490
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  if ( (unsigned int)v11 > 1 )
  {
    ...
    {
      v16 = 525LL;
      WdLogSingleEntry2(2LL, v15, 525LL);
...
LABEL_72:
    ...
    v16 = 535LL;
    WdLogSingleEntry2(2LL, *((int *)v3 + 4), 535LL);
    goto LABEL_70;
  }
  v21 = *((_DWORD *)a1 + 36);
  if ( (_DWORD)v11 == 1 )
...
LABEL_31:
    ...
    {
      v16 = 452LL;
      WdLogSingleEntry2(2LL, *((int *)v3 + 4), 452LL);
...
LABEL_71:
  ...
  else
  {
    ...
    {
      v16 = 468LL;
      WdLogSingleEntry2(2LL, *((int *)v3 + 4), 468LL);
LABEL_70:
    ...
    if ( !*((_QWORD *)a1 + 10) )
    {
      ...
      if ( !v24 )
      {
        WdLogSingleEntry1(2LL, 482LL);
        DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Invalid extended header", 482LL, 0LL, 0LL, 0LL, 0LL);
        goto LABEL_73;
      }
      v25 = (__int64 *)&v24[1];
      ...
      *((_QWORD *)a1 + 10) = v26;
      if ( !v26 )
      {
        WdLogSingleEntry2(2LL, *v25, 488LL);
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
...
LABEL_59:
    ...
    {
      WdLogSingleEntry2(2LL, (unsigned int)*v14, 545LL);
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        -1,
