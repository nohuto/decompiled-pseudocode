/*
 * XREFs of DxgkCheckVidPnExclusiveOwnership @ 0x1C0157B60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_38:
  ...
  if ( !v64 )
  {
    v46 = WdLogNewEntry5_WdWarning(v16, v15, v17);
    *(_QWORD *)(v46 + 24) = v14;
  ...
  {
    v34 = -1071775738;
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v20, v19) + 24) = -1071775738LL;
    if ( v58 )
  ...
  if ( !*((_QWORD *)v18 + 337) )
  {
    v48 = WdLogNewEntry5_WdWarning(v20, v19, v21);
    *(_QWORD *)(v48 + 24) = v18;
...
LABEL_37:
  ...
  {
    v27 = HIDWORD(v66);
    if ( HIDWORD(v66) < *(_DWORD *)(*((_QWORD *)v18 + 337) + 80LL) )
    {
      v28 = v64;
      v65 = v64;
      ...
      if ( (int)v29 <= 0 )
      {
        v54 = (_QWORD *)WdLogNewEntry5_WdTrace(v29, v24);
        v34 = -1071775738;
        v54[3] = -1071775738LL;
        v54[4] = v64;
        v54[5] = HIDWORD(v66);
      ...
      else
      {
        ...
        {
          v55 = WdLogNewEntry5_WdAssertion(v29, v24);
        ...
        if ( *(_BYTE *)(*(_QWORD *)(v30 + 112) + 3968 * v31 + 722) )
        {
          ...
          {
            v57 = WdLogNewEntry5_WdAssertion(v29, v24);
        ...
        {
          v56 = (_QWORD *)WdLogNewEntry5_WdTrace(v29, v24);
          v56[3] = -1071775739LL;
          v56[4] = v64;
          v56[5] = v31;
          v34 = -1071775739;
...
LABEL_27:
    ...
    v52 = WdLogNewEntry5_WdWarning(v25, v24, v26);
    *(_QWORD *)(v52 + 24) = v27;
