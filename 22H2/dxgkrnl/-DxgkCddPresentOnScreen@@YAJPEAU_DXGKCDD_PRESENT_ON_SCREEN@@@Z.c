/*
 * XREFs of ?DxgkCddPresentOnScreen@@YAJPEAU_DXGKCDD_PRESENT_ON_SCREEN@@@Z @ 0x1C00DE810
 * Callers:
 *     <none>
 * Callees:
...
LABEL_46:
                  ...
                  {
                    if ( !(unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(*(ADAPTER_DISPLAY **)(v30 + 2696), v31) )
                    {
