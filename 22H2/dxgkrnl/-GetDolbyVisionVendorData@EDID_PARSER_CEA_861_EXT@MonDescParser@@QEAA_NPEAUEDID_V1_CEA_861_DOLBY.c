/*
 * XREFs of ?GetDolbyVisionVendorData@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAA_NPEAUEDID_V1_CEA_861_DOLBY_VISION_DATABLOCK@@@Z @ 0x1C0027B50
 * Callers:
 ...
 * Callees:
 *     Feature_DolbyVisionV1Fix__private_IsEnabledDeviceUsage @ 0x1C0027D08 (Feature_DolbyVisionV1Fix__private_IsEnabledDeviceUsage.c)
  ...
  while ( 1 )
  {
    ...
    if ( v10 == 1 )
    {
      if ( v2 )
        return 0;
      v2 = *((_BYTE *)v17 + 5) >> 5;
      IsEnabledDeviceUsage = Feature_DolbyVisionV1Fix__private_IsEnabledDeviceUsage();
      v7 = *(_BYTE *)v6;
      v13 = IsEnabledDeviceUsage == 0;
      v12 = *(_BYTE *)v6;
      if ( v13 )
      {
        v13 = (v12 & 0x1F) == 4;
...
LABEL_16:
    ...
    if ( v10 == 2 )
    {
      if ( v2 )
        return 0;
      v2 = 1;
      if ( !(unsigned int)Feature_DolbyVisionV1Fix__private_IsEnabledDeviceUsage() )
        goto LABEL_31;
      v7 = *(_BYTE *)v6;
      v12 = *(_BYTE *)v6;
      goto LABEL_15;
