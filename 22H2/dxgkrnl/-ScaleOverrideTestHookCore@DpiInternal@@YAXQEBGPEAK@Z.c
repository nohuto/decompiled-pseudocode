/*
 * XREFs of ?ScaleOverrideTestHookCore@DpiInternal@@YAXQEBGPEAK@Z @ 0x1C0003984
 * Callers:
...
LABEL_14:
    McTemplateK0zqqzxxxxx_EtwWriteTransfer(v15, v14, v16, 0, 2, -1, (__int64)v17, v13, v6, 0, 0, 0);
    return;
  }
