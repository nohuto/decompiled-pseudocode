/*
 * XREFs of ?ScaleOverrideTestHookCore@DpiInternal@@YAXQEBGPEAK@Z @ 0x1C000D140
 * Callers:
 *     ?ScaleOverrideTestHook@@YAXQEBGPEAK@Z @ 0x1C000D11C (-ScaleOverrideTestHook@@YAXQEBGPEAK@Z.c)
 * Callees:
