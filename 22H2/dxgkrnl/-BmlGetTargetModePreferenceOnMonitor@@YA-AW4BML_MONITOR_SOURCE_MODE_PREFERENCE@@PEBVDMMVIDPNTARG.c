/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1C0178168
 * Callers:
 *     BmlCompareTargetModesWithMonitor @ 0x1C0176264 (BmlCompareTargetModesWithMonitor.c)
 * Callees:
 ...
 *     MonitorGetNextMonitorSourceMode @ 0x1C01782F0 (MonitorGetNextMonitorSourceMode.c)
