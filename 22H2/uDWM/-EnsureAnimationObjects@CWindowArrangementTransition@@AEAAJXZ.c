/*
 * XREFs of ?EnsureAnimationObjects@CWindowArrangementTransition@@AEAAJXZ @ 0x18009C448
 * Callers:
...
__int64 __fastcall CWindowArrangementTransition::EnsureAnimationObjects(struct CAnimatedGlassSheet **this)
{
  ...
  if ( dword_1800E6FF8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E6FF8);
    if ( dword_1800E6FF8 == -1 )
    {
      dword_1800E6F50 = -2147023728;
      Init_thread_footer(&dword_1800E6FF8);
    }
  }
  v2 = 0;
  if ( *this || (v3 = CAnimatedGlassSheet::Create(this), v2 = v3, v3 >= 0) )
  {
    if ( !this[1] )
    {
      ...
      if ( BitmapsFromAtlasImageStrip >= 0 )
      {
        ...
        v2 = v6;
        if ( v6 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F50, 1LL, v6, 0x45u);
      }
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F50, 1LL, BitmapsFromAtlasImageStrip, 0x3Fu);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F50, 1LL, v3, 0x2Du);
  }
  return v2;
}
