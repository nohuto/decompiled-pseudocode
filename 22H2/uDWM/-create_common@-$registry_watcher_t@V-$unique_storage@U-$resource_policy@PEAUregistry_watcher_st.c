 ...
 *     ?GetLastErrorFailHr@details@wil@@YAJXZ @ 0x18007E69C (-GetLastErrorFailHr@details@wil@@YAJXZ.c)
 ...
 *     ?Return_Win32@in1diag3@details@wil@@YAJPEAXIPEBDK@Z @ 0x180080E18 (-Return_Win32@in1diag3@details@wil@@YAJPEAXIPEBDK@Z.c)
 */
...
LABEL_17:
  ...
  if ( v14 )
  {
    LastError = wil::details::in1diag3::Return_Win32(retaddr, v15, v16, (const char *)v14, fAsynchronous);
  }
  else
  {
