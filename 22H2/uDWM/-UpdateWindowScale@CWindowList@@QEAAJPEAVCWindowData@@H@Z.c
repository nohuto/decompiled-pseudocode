/*
 * XREFs of ?UpdateWindowScale@CWindowList@@QEAAJPEAVCWindowData@@H@Z @ 0x18000B750
 * Callers:
 ...
 *     ?EstablishPixelAlignedScale@CWindowData@@QEAAXPEA_N@Z @ 0x18001F9D8 (-EstablishPixelAlignedScale@CWindowData@@QEAAXPEA_N@Z.c)
