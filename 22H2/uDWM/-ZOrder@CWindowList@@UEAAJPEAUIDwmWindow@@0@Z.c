/*
 * XREFs of ?ZOrder@CWindowList@@UEAAJPEAUIDwmWindow@@0@Z @ 0x18001A2C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateAccentState@CWindowList@@QEAAXPEAVCWindowData@@W4ACCENT_STATE@@@Z @ 0x18002A73C (-UpdateAccentState@CWindowList@@QEAAXPEAVCWindowData@@W4ACCENT_STATE@@@Z.c)
...
LABEL_2:
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v45, 0x88Fu);
    v9 = v64;
  }
  v10 = v8;
  if ( v8 < 0 )
...
LABEL_62:
  ...
  {
    v10 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024890, 0xC2Du);
    goto LABEL_29;
  }
  v11 = *((_QWORD *)v9 + 15);
  v52 = 0LL;
  ...
  if ( a3 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0xC36u);
      goto LABEL_29;
    }
    v13 = v65;
    if ( !v65 )
    {
      v10 = -2147024890;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024890, 0xC39u);
      goto LABEL_29;
    }
  }
...
LABEL_23:
  ...
  if ( inserted < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0xC63u);
    goto LABEL_29;
  }
  ...
  if ( v29 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v29, 0xC64u);
    goto LABEL_29;
  }
...
LABEL_26:
  ...
  if ( v30 && (*(_BYTE *)(v30 + 241) & 0x20) != 0 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, ProjectedShadowSceneForDesktop, 0xC71u);
      Microsoft::WRL::ComPtr<CSecondaryWindowRepresentation>::InternalRelease(&v65);
      goto LABEL_29;
    }
