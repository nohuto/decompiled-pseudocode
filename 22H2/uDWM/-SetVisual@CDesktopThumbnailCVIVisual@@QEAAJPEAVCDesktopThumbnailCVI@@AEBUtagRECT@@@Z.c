/*
 * XREFs of ?SetVisual@CDesktopThumbnailCVIVisual@@QEAAJPEAVCDesktopThumbnailCVI@@AEBUtagRECT@@@Z @ 0x1800B6E58
 * Callers:
        ...
        const struct tagRECT *a3)
{
  ...
  struct CRectResourceProxy *v12; // rax
  struct CBaseLegacyMilBrushProxy *v14; // [rsp+30h] [rbp-10h] BYREF
  struct CDrawGeometryInstruction *v15; // [rsp+38h] [rbp-8h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+68h] [rbp+28h]
  CBaseObject *v17; // [rsp+70h] [rbp+30h] BYREF
  struct CRectResourceProxy *v18; // [rsp+88h] [rbp+48h] BYREF
...
LABEL_9:
  ...
  Microsoft::WRL::ComPtr<CDrawGeometryInstruction>::InternalRelease(&v15);
  v5 = (volatile signed __int32 *)v17;
  v11 = v14;
