/*
 * XREFs of ?SLGetHelper@@YA_NPEBG@Z @ 0x18004EE54
 * Callers:
 ...
 *     RtlULongLongAdd @ 0x18004EF2C (RtlULongLongAdd.c)
 *     RtlUIntAdd @ 0x18004EF50 (RtlUIntAdd.c)
 *     ?Reset@?$SP@EV?$SP_HLOCAL@E@@@@QEAAXXZ @ 0x1800525D0 (-Reset@-$SP@EV-$SP_HLOCAL@E@@@@QEAAXXZ.c)
 *     ?MemoryAlloc@@YAPEAX_K@Z @ 0x1800531C0 (-MemoryAlloc@@YAPEAX_K@Z.c)
