/*
 * XREFs of ?D2DMatrixTransformation2D@@YAPEAUD2DMatrix@@PEAU1@PEBUD2DVector2@@M11M1@Z @ 0x180005C50
 * Callers:
 ...
 *     ?D2DMatrixRotationZ@@YAPEAUD2DMatrix@@PEAU1@M@Z @ 0x1800BFFC0 (-D2DMatrixRotationZ@@YAPEAUD2DMatrix@@PEAU1@M@Z.c)
 *     ?D2DMatrixTranspose@@YAPEAUD2DMatrix@@PEAU1@PEBU1@@Z @ 0x1800C0040 (-D2DMatrixTranspose@@YAPEAUD2DMatrix@@PEAU1@PEBU1@@Z.c)
 */
        ...
        const struct D2DVector2 *a7)
{
  ...
  float *v18; // r9
  float v19; // xmm0_4
  _DWORD v20[16]; // [rsp+28h] [rbp-B1h] BYREF
  _BYTE v21[64]; // [rsp+68h] [rbp-71h] BYREF
  _BYTE v22[64]; // [rsp+A8h] [rbp-31h] BYREF
    ...
    *(_QWORD *)((char *)a1 + 4) = 0LL;
    if ( a2 )
    {
      ...
      *((float *)a1 + 12) = (float)(1.0 - *(float *)a4) * *(float *)a2;
      v9 = (float)(1.0 - *((float *)a4 + 1)) * *((float *)a2 + 1);
      *((_DWORD *)a1 + 14) = 0;
      *((float *)a1 + 13) = v9;
LABEL_5:
...
LABEL_11:
  ...
  v20[10] = 1065353216;
  v20[15] = 1065353216;
  D2DMatrixRotationZ((struct D2DMatrix *)v21, a3);
  if ( a2 )
  {
    D2DMatrixTranspose((struct D2DMatrix *)v22, (const struct D2DMatrix *)v21);
    *(_QWORD *)((char *)a1 + 52) = 0LL;
    *(_QWORD *)((char *)a1 + 44) = 0LL;
    *((_DWORD *)a1 + 15) = 1065353216;
    *((_DWORD *)a1 + 10) = 1065353216;
    ...
    *((float *)a1 + 13) = 0.0 - *((float *)a2 + 1);
    ...
    D2DMatrixMultiply(a1, v13, (const struct D2DMatrix *)v20);
  ...
  {
    D2DMatrixTranspose(a1, (const struct D2DMatrix *)v21);
    D2DMatrixMultiply(v16, a1, (const struct D2DMatrix *)v20);
    D2DMatrixMultiply(a1, v17, (const struct D2DMatrix *)v21);
  }
LABEL_6:
  if ( a6 != 0.0 )
  {
    D2DMatrixRotationZ((struct D2DMatrix *)v21, a6);
    if ( a5 )
    {
