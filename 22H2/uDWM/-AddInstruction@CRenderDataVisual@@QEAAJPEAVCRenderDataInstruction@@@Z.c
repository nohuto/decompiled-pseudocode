/*
 * XREFs of ?AddInstruction@CRenderDataVisual@@QEAAJPEAVCRenderDataInstruction@@@Z @ 0x180016F14
 * Callers:
...
__int64 __fastcall CRenderDataVisual::AddInstruction(CRenderDataVisual *this, struct CRenderDataInstruction *a2)
{
  int v2; // ebx
  char *v4; // rdi
  __int64 v5; // rax
  unsigned int v6; // r8d
  struct CRenderDataInstruction *v8; // [rsp+48h] [rbp+10h] BYREF
  struct CRenderDataInstruction **v9; // [rsp+50h] [rbp+18h] BYREF
  ...
  if ( a2 )
  {
    ...
    else
    {
      ...
      {
        *(_QWORD *)(*(_QWORD *)v4 + 8 * v5) = v8;
        *((_DWORD *)this + 68) = v6;
        goto LABEL_6;
      }
      v9 = &v8;
      v2 = DynArrayImpl<0>::Grow((int)this + 248, 8, 1, 0, (__int64)&v9);
      if ( v2 >= 0 )
      {
        *(_QWORD *)((unsigned int)(8 * (*((_DWORD *)v4 + 6))++) + *(_QWORD *)v4) = *v9;
LABEL_6:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x2Eu);
  }
  return (unsigned int)v2;
}
