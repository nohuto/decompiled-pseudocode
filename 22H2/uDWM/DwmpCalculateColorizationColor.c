/*
 * XREFs of DwmpCalculateColorizationColor @ 0x18003E5F8
 * Callers:
 *     ?ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z @ 0x18003E57C (-ApplyColorizationParameters@CDesktopManager@@QEAAXPEBVCGlassColorizationParameters@@@Z.c)
 * Callees:
