/*
 * XREFs of ?OnWindowCloakChange@CAnimationScheduler@@QEAAJPEBVCWindowData@@_N1PEA_N@Z @ 0x180012464
 * Callers:
        ...
        bool *a5)
{
  ...
  CTopLevelWindow *v18; // [rsp+48h] [rbp-39h] BYREF
  char v19[16]; // [rsp+50h] [rbp-31h] BYREF
  CTopLevelWindow **v20; // [rsp+60h] [rbp-21h]
  ...
  for ( *a5 = 0; (unsigned int)v11 < *((_DWORD *)this + 10); v11 = (unsigned int)(v11 + 1) )
  {
    ...
    {
      v10 = CWindowPropertyTracker::OnWindowCloakChange((CAnimationScheduler *)((char *)this + 48), v13, a2, v6, a4);
      LOBYTE(v8) = v10 >= 0;
      *a5 |= v10 >= 0;
    }
    else if ( (_BYTE)v6 )
