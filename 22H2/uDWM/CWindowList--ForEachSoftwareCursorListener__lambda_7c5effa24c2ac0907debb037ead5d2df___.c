/*
 * XREFs of CWindowList::ForEachSoftwareCursorListener__lambda_7c5effa24c2ac0907debb037ead5d2df___ @ 0x180095C34
 * Callers:
        ...
        __int64 a2)
{
  ...
  {
    v5 = *(void (__fastcall ****)(_QWORD, _QWORD))(*(_QWORD *)(a1 + 608) + 8 * i);
    (**v5)(v5, *(_QWORD *)(**(_QWORD **)a2 + 384LL));
  }
