/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x180086498
 * Callers:
...
LABEL_18:
  ...
  if ( WindowInBand )
  {
    ...
    *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 85) = ForegroundWindow;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D2ED0, 2LL, v12, 0xB5Cu);
    }
    goto LABEL_18;
  }
  v7 = -2147024890;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D2ED0, 2LL, -2147024890, 0xB4Bu);
LABEL_19:
  if ( a1 )
