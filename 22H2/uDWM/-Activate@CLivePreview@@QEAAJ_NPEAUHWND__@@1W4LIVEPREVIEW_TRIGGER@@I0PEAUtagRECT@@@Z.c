/*
 * XREFs of ?Activate@CLivePreview@@QEAAJ_NPEAUHWND__@@1W4LIVEPREVIEW_TRIGGER@@I0PEAUtagRECT@@@Z @ 0x18003FA3C
 * Callers:
 ...
 *     ?_IsImmersiveAppOnTaskbar@CLivePreview@@AEAA_NXZ @ 0x1800836E4 (-_IsImmersiveAppOnTaskbar@CLivePreview@@AEAA_NXZ.c)
 ...
 *     ?EnableLivePreviewInputHooks@CDesktopManager@@SAJ_N0@Z @ 0x18008678C (-EnableLivePreviewInputHooks@CDesktopManager@@SAJ_N0@Z.c)
