/*
 * XREFs of ?UnregisterForGlobalTimeChangeNotification@CDesktopManager@@SA_NPEAVCVisual@@@Z @ 0x18003E00C
 * Callers:
 ...
 *     ?UnRegisterGlobalTimer@CAnimatedGlassSheet@@AEAAJXZ @ 0x18009B93C (-UnRegisterGlobalTimer@CAnimatedGlassSheet@@AEAAJXZ.c)
