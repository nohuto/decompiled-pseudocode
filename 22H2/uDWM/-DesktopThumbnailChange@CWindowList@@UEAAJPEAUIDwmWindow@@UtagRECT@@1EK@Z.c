/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x180097240
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x11D1u);
    goto LABEL_35;
  }
  v12 = v32;
  if ( !v32 )
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x11DBu);
    goto LABEL_35;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopThumbnail, 0x11DFu);
LABEL_27:
    v15 = v29;
    goto LABEL_28;
  }
  ...
  *((_QWORD *)v29 + 34) = *((_QWORD *)v12 + 15);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x11E0u);
    goto LABEL_28;
  }
  v35 = *a4;
      ...
      if ( v23 >= 0 )
      {
        ...
        *((_BYTE *)v25 + 337) = 0;
        ...
        if ( v26 >= 0 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v27, 0x1201u);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, 0x11FEu);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v23, 0x11F8u);
        v10 = (volatile signed __int32 *)v30;
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, PerMonitorDesktopThumbnail, 0x11E1u);
  }
LABEL_28:
  if ( v15 )
