/*
 * XREFs of ?_CreateMonitorSnapshot@CVirtualDesktopSwitch@@AEAAJPEAVCWindowData@@UtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800B160C
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  if ( v15 >= 0 )
  {
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v17, 0x12BAu);
      goto LABEL_22;
    }
    ...
    if ( a4
      && (v19 = *(CCachedVisualImageProxy ***)(v5 + 40),
          *(_BYTE *)(v5 + 67) = 1,
          ...
          v20 < 0) )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v20, 0x12C5u);
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v15, 0x12B9u);
  }
  v16 = v22;
LABEL_22:
