/*
 * XREFs of ?DestroyWindow@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180013FD0
 * Callers:
...
LABEL_3:
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x88Fu);
    v6 = v16;
  }
  if ( v5 < 0 )
  {
LABEL_23:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x911u);
    goto LABEL_6;
  }
  if ( v6 )
  {
