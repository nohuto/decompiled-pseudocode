/*
 * XREFs of ??$UsePropertyFactory@V_lambda_20cc25e9e6e64aaab66070ee3f3626ad_@@@?$EffectBase@UIGaussianBlurEffect@Effects@Composition@UI@Microsoft@@@Effects@Composition@UI@Microsoft@@KAJAEBV_lambda_20cc25e9e6e64aaab66070ee3f3626ad_@@@Z @ 0x18003E8FC
 * Callers:
 *     ?GetProperty@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJIPEAPEAUIPropertyValue@Foundation@Windows@@@Z @ 0x18003E8D0 (-GetProperty@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAJIPEAPEAUIPropertyValue@Fo.c)
 * Callees:
