/*
 * XREFs of ?GetSize@CCompoundBitmapLock@@UEAAJPEAI0@Z @ 0x1800536E0
 * Callers:
 *     ?GetSize@CCompoundBitmapLock@@W7EAAJPEAI0@Z @ 0x180058150 (-GetSize@CCompoundBitmapLock@@W7EAAJPEAI0@Z.c)
 * Callees:
 *     <none>
 */
