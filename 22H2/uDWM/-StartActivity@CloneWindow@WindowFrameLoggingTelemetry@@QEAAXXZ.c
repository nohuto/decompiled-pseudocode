/*
 * XREFs of ?StartActivity@CloneWindow@WindowFrameLoggingTelemetry@@QEAAXXZ @ 0x18002CA00
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::CloneWindow::StartActivity(WindowFrameLoggingTelemetry::CloneWindow *this)
{
  ...
  *(_DWORD *)v2 = 1;
  ...
  if ( *v5 > 5u )
  {
    ...
    v12 = &v10;
    v13 = 8;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v5, byte_1800D0EE8, v8 + 8, v7, 4, (__int64)v11);
  }
  if ( !*((_DWORD *)this + 8) )
