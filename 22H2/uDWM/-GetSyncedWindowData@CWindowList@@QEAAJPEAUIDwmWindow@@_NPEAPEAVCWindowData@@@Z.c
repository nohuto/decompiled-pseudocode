/*
 * XREFs of ?GetSyncedWindowData@CWindowList@@QEAAJPEAUIDwmWindow@@_NPEAPEAVCWindowData@@@Z @ 0x180018B34
 * Callers:
        ...
        struct CWindowData **a4)
{
  ...
  v8 = 0;
  v9 = (CWindowData *)(*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 8LL))(a2);
  ...
  *((_QWORD *)v9 + 5) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 24LL))(a2);
  v12 = CWindowList::SyncWindowData(this, a2, v9);
  v8 = v12;
  if ( v12 >= 0 )
LABEL_2:
    *a4 = v9;
  else
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x88Fu);
  return v8;
}
