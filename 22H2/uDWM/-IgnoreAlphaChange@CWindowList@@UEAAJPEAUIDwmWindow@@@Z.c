/*
 * XREFs of ?IgnoreAlphaChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800122C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::IgnoreAlphaChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x1367u);
  }
  else
  {
    v6 = v10;
    if ( v10 )
    {
      if ( (*(unsigned __int8 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 216LL))(a2) != *((_BYTE *)v6 + 609) >> 7 )
      {
        ...
        if ( v7 )
        {
          ...
          v5 = updated;
          if ( updated < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x1372u);
        }
      }
    }
  }
