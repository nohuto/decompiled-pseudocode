/*
 * XREFs of ?CalculateOutsideMargins@CTopLevelWindow@@SAXPEAVCWindowData@@IPEAU_MARGINS@@@Z @ 0x180094470
 * Callers:
...
void __fastcall CTopLevelWindow::CalculateOutsideMargins(struct CWindowData *this, char a2, struct _MARGINS *a3)
{
  ...
  *a3 = 0LL;
  if ( CTopLevelWindow::HasRenderedBorder(a2)
    ...
    && *((_DWORD *)this + 17) >= dword_1800E3ECC
    && *((_DWORD *)this + 18) >= dword_1800E3ED0
    && *((_DWORD *)this + 19) >= dword_1800E3ED4
