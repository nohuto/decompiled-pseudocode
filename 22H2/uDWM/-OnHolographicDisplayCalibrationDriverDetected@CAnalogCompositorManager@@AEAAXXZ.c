/*
 * XREFs of ?OnHolographicDisplayCalibrationDriverDetected@CAnalogCompositorManager@@AEAAXXZ @ 0x180080BEC
 * Callers:
 ...
 *     ?IsEnabled@UDwmTrace@@SA_NE_K@Z @ 0x180080BBC (-IsEnabled@UDwmTrace@@SA_NE_K@Z.c)
 ...
 *     ?get@?$static_lazy@VUDwmTrace@@@details@wil@@QEAAPEAVUDwmTrace@@P6AXXZ@Z @ 0x1800812A8 (-get@-$static_lazy@VUDwmTrace@@@details@wil@@QEAAPEAVUDwmTrace@@P6AXXZ@Z.c)
 */
