/*
 * XREFs of _CRT_INIT @ 0x18005476C
 * Callers:
 *     __DllMainCRTStartup @ 0x1800549E8 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x180054C46 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x180054CB0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x180054E1E (_initterm_0.c)
