/*
 * XREFs of ?ValidateVisual@CLivePreview@@UEAAJXZ @ 0x180081AD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCurrentOpacity@CLivePreviewTimeline@@QEAANXZ @ 0x180085110 (-GetCurrentOpacity@CLivePreviewTimeline@@QEAANXZ.c)
