/*
 * XREFs of ?AddSinusoidal@CAnimationResource@@UEAAJNMMMM@Z @ 0x1800B9C20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_ConvertDoubleToQPC@CAnimationResource@@KA_KN@Z @ 0x1800061CC (-_ConvertDoubleToQPC@CAnimationResource@@KA_KN@Z.c)
