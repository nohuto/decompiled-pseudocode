/*
 * XREFs of ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NPEBUtagRECT@@0@Z @ 0x180094284
 * Callers:
 ...
 * Callees:
 *     ?s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z @ 0x18009424C (-s_IsCloseEnoughToReuse@CThumbnailVisual@@CA_NNN@Z.c)
 */
