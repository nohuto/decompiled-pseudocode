/*
 * XREFs of ?ValidateDevice@UdwmDcompVisual@@QEAAJPEA_N@Z @ 0x1800119F4
 * Callers:
 ...
 *     ?ReleaseDCompResources@SharedDwmDcompVisual@@QEAAXXZ @ 0x180013970 (-ReleaseDCompResources@SharedDwmDcompVisual@@QEAAXXZ.c)
