/*
 * XREFs of ?EndTransition@CAccent@@QEAAJXZ @ 0x180004A8C
 * Callers:
 *     ?StartTransition@CAccent@@QEAAJXZ @ 0x180004A24 (-StartTransition@CAccent@@QEAAJXZ.c)
 *     ?StopAnimation@CAccentTransition@@QEAAXXZ @ 0x1800B5D54 (-StopAnimation@CAccentTransition@@QEAAXXZ.c)
 * Callees:
 ...
 *     ?_UpdateAccentBackground@CAccent@@IEAAXK@Z @ 0x18000A33C (-_UpdateAccentBackground@CAccent@@IEAAXK@Z.c)
