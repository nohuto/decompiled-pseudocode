/*
 * XREFs of ?OnGesture@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_RENDERGESTURE@@@Z @ 0x18009E71C
 * Callers:
 ...
 *     ?IsCurrentSessionRemotable@CDesktopManager@@SA_NXZ @ 0x18009E140 (-IsCurrentSessionRemotable@CDesktopManager@@SA_NXZ.c)
