/*
 * XREFs of McTemplateU0pq_EtwEventWriteTransfer @ 0x180095754
 * Callers:
 *     ?ShouldDelayTransition@CTopLevelWindow3D@@AEAA_N_N@Z @ 0x18000F41C (-ShouldDelayTransition@CTopLevelWindow3D@@AEAA_N_N@Z.c)
...
__int64 __fastcall McTemplateU0pq_EtwEventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  return McGenEventWrite_EtwEventWriteTransfer(
           ...
           (__int64)&UdwmSystemAnimation_DelayShowHide,
           a3,
           3LL,
           (__int64)v5);
}
