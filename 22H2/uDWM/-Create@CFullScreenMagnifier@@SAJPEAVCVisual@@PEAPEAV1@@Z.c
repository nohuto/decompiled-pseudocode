/*
 * XREFs of ?Create@CFullScreenMagnifier@@SAJPEAVCVisual@@PEAPEAV1@@Z @ 0x180047960
 * Callers:
 ...
 *     ??0CFullScreenMagnifier@@AEAA@PEAVCVisual@@@Z @ 0x1800479F0 (--0CFullScreenMagnifier@@AEAA@PEAVCVisual@@@Z.c)
