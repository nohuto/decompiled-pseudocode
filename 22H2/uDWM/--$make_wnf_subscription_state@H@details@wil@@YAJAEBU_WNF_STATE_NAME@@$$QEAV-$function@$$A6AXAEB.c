/*
 * XREFs of ??$make_wnf_subscription_state@H@details@wil@@YAJAEBU_WNF_STATE_NAME@@$$QEAV?$function@$$A6AXAEBH@Z@wistd@@KPEAPEAU?$wnf_subscription_state@H@01@@Z @ 0x18004ACF0
 * Callers:
...
__int64 __fastcall wil::details::make_wnf_subscription_state<int>(__int64 a1, __int64 a2, int a3, _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v19 = 0;
    v10 = NtQueryWnfStateData(&WNF_IMSN_TRANSPARENCYPOLICY, 0LL, 0LL, &v14, 0LL, &v19) | 0x10000000;
