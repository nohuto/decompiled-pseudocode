/*
 * XREFs of ??0?$EffectBase@UIGaussianBlurEffect@Effects@Composition@UI@Microsoft@@@Effects@Composition@UI@Microsoft@@QEAA@XZ @ 0x180043748
 * Callers:
 *     ??0GaussianBlurEffect@Effects@Composition@UI@Microsoft@@QEAA@XZ @ 0x1800436DC (--0GaussianBlurEffect@Effects@Composition@UI@Microsoft@@QEAA@XZ.c)
 * Callees:
