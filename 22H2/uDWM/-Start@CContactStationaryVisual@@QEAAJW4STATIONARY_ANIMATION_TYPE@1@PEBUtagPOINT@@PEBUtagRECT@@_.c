/*
 * XREFs of ?Start@CContactStationaryVisual@@QEAAJW4STATIONARY_ANIMATION_TYPE@1@PEBUtagPOINT@@PEBUtagRECT@@_N@Z @ 0x1800A19A0
 * Callers:
 ...
 *     ?GetBoundedContactWidth@CContactManager@@QEAAHHUtagPOINT@@@Z @ 0x1800482F8 (-GetBoundedContactWidth@CContactManager@@QEAAHHUtagPOINT@@@Z.c)
        ...
        char a5)
{
  ...
  *(_DWORD *)(a1 + 348) = v11;
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0q_EtwEventWriteTransfer(a1, (__int64)&UdwmContactStationaryVisual_Start, a2);
  v12 = *(_DWORD *)(a1 + 308);
  if ( v12 == 1
    && *(_DWORD *)(a1 + 312) == 2
    && *(_BYTE *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 24) + 324LL) )
  {
    *(_DWORD *)(a1 + 312) = 7;
    *(_DWORD *)(a1 + 320) = 1;
  }
