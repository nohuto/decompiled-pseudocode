/*
 * XREFs of ?GetLocal@?$ThreadLocalStorage@UThreadLocalData@details_abi@wil@@@details_abi@wil@@QEAAPEAUThreadLocalData@23@_N@Z @ 0x180009E4C
 * Callers:
        ...
        char a2)
{
  ...
  if ( !a2 )
    return 0LL;
  v8 = wil::details::ProcessHeapAlloc(0, 0x38uLL, 10 * (CurrentThreadId / 0xAuLL));
