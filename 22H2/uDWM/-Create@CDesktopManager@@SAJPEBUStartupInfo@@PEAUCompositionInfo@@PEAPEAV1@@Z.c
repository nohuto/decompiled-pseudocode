/*
 * XREFs of ?Create@CDesktopManager@@SAJPEBUStartupInfo@@PEAUCompositionInfo@@PEAPEAV1@@Z @ 0x18004BA28
 * Callers:
 ...
 *     ??0CDesktopManager@@AEAA@XZ @ 0x18004BADC (--0CDesktopManager@@AEAA@XZ.c)
        ...
        struct CDesktopManager **a3)
{
  ...
  if ( v6 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBFC8, 1LL, v7, 0x693u);
    }
    else
    {
      g_pdmInstance = v6;
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBFC8, 1LL, -2147024882, 0x68Fu);
  }
