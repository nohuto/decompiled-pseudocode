/*
 * XREFs of ?ValidateVisual@CTopLevelWindow@@UEAAJXZ @ 0x18001C0C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?NotifySWROfMarginOrSizeChange@CWindowData@@QEAAX_N0@Z @ 0x18003E83C (-NotifySWROfMarginOrSizeChange@CWindowData@@QEAAX_N0@Z.c)
