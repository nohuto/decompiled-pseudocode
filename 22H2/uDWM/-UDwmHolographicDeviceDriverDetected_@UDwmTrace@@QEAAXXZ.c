/*
 * XREFs of ?UDwmHolographicDeviceDriverDetected_@UDwmTrace@@QEAAXXZ @ 0x180080F6C
 * Callers:
...
void __fastcall UDwmTrace::UDwmHolographicDeviceDriverDetected_(UDwmTrace *this)
{
  ...
  {
    tlgWriteTransfer_EtwEventWriteTransfer(v1, byte_1800D00DA, 0LL, 0LL, 2, (__int64)v2);
  }
}
