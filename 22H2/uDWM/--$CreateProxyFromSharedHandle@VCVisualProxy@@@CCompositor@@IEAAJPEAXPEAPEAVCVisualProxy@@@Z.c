/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCVisualProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCVisualProxy@@@Z @ 0x1800252B0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxyFromSharedHandle<CVisualProxy>(
        __int64 a1,
        __int64 a2,
        volatile signed __int32 **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 )
  {
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle((__int64)v7, 0x26u, *(__int64 **)(a1 + 16), a2);
    v9 = v8;
    if ( v8 < 0 )
