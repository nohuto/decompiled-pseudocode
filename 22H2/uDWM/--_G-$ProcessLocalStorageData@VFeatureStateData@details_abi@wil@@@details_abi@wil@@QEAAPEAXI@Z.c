/*
 * XREFs of ??_G?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAAPEAXI@Z @ 0x18007DDB8
 * Callers:
 ...
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x18007EC70 (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 */
