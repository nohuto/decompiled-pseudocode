/*
 * XREFs of ?StyleChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18000ED30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x1D11u);
  }
  else
  {
    ...
    if ( v18 )
    {
      ...
      v7 = v31;
      if ( v31 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v31, 0x1D16u);
    }
  }
  if ( v7 < 0 )
  {
