/*
 * XREFs of ?GetNCAreaHelper@CTopLevelWindow@@CAJPEAXPEBH1PEAUWindowFrame@1@2@Z @ 0x180048BAC
 * Callers:
 ...
 *     ?SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z @ 0x1800493EC (-SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z.c)
        ...
        struct CTopLevelWindow::WindowFrame *a5)
{
  ...
  v6 = a1;
  v43 = a1;
  if ( dword_1800E6DB8 > *(_DWORD *)(ThreadLocalStoragePointer[tls_index] + 4LL) )
  {
    Init_thread_header(&dword_1800E6DB8);
    if ( dword_1800E6DB8 == -1 )
    {
      dword_1800E3FF4 = -2147023728;
      Init_thread_footer(&dword_1800E6DB8);
    }
  }
