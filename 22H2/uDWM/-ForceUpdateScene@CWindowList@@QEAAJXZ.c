/*
 * XREFs of ?ForceUpdateScene@CWindowList@@QEAAJXZ @ 0x1800978F0
 * Callers:
 *     ?HandleScreenRotation@CWindowList@@QEAAJHH@Z @ 0x180098514 (-HandleScreenRotation@CWindowList@@QEAAJHH@Z.c)
 *     ?SetCompSyncHandle@CTabSwitch@@UEAAXPEAX@Z @ 0x1800B0930 (-SetCompSyncHandle@CTabSwitch@@UEAAXPEAX@Z.c)
 * Callees:
