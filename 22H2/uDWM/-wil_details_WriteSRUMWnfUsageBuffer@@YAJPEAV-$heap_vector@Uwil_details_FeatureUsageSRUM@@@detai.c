/*
 * XREFs of ?wil_details_WriteSRUMWnfUsageBuffer@@YAJPEAV?$heap_vector@Uwil_details_FeatureUsageSRUM@@@details_abi@wil@@@Z @ 0x18007FF6C
 * Callers:
 *     _lambda_5035b992506f4af81a770c5842624510_::_lambda_invoker_cdecl_ @ 0x18007CE30 (_lambda_5035b992506f4af81a770c5842624510_--_lambda_invoker_cdecl_.c)
 * Callees:
 ...
 *     _alloca_probe @ 0x180057ED0 (_alloca_probe.c)
 */
...
LABEL_12:
        ...
        updated = wil_details_NtUpdateWnfStateData((__int64)&unk_1800D23A0, (__int64)v18, v7, v7, v15, v17[0], 1);
      }
      ++v6;
    }
