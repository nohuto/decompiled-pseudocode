/*
 * XREFs of ?InsertRelative@VisualCollection@@QEAAJPEAVCVisual@@0_N1@Z @ 0x180024380
 * Callers:
 ...
 *     ?_FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x18007FEA4 (-_FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
        ...
        bool a5)
{
  ...
  struct CVisual **v41; // [rsp+70h] [rbp+8h] BYREF
  struct CVisual *v42; // [rsp+78h] [rbp+10h] BYREF
  ...
  if ( a3 )
  {
    v29 = *((_BYTE *)a2 + 84) & 0x10;
    v30 = *((_BYTE *)a3 + 84) & 0x10;
    if ( (v29 != 0) != (v30 != 0) )
    {
      if ( a4 )
      {
...
LABEL_7:
    ...
    if ( a4 )
    {
      if ( (*((_BYTE *)v17 + 84) & 0x10) != 0 || (*((_BYTE *)v10 + 84) & 0x10) == 0 )
        goto LABEL_7;
    }
    else if ( (*((_BYTE *)v10 + 84) & 0x10) != 0 || (*((_BYTE *)v17 + 84) & 0x10) == 0 )
    {
      goto LABEL_7;
    }
LABEL_34:
...
LABEL_8:
  ...
  if ( v7 == v9 )
  {
    ...
    else
    {
      ...
      if ( v13 < v5 - 1 )
      {
        ...
        {
          v33 = v13++;
          *(_QWORD *)(v32 + 8 * v33) = *(_QWORD *)(v32 + 8LL * v13);
          v31 = *((_DWORD *)this + 10);
        }
        while ( v13 < v31 - 1 );
        v10 = v42;
  ...
  {
    v18 = (*(__int64 (__fastcall **)(struct CVisual *, __int64))(*(_QWORD *)v10 + 72LL))(v10, v9);
    v14 = v18;
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0xDAu);
      return (unsigned int)v14;
    }
    _InterlockedIncrement((volatile signed __int32 *)v42 + 2);
  }
  v19 = (unsigned int)(v8 + v11);
  if ( (unsigned int)v19 > *((_DWORD *)this + 10) )
  {
    v14 = -2147024809;
  ...
  {
    v41 = &v42;
    v20 = DynArrayImpl<0>::Grow((int)this + 16, 8, 1, 0, (__int64)&v41);
    v14 = v20;
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v20, 0x1CDu);
    }
    else
    {
      ...
      *((_DWORD *)this + 10) = v21 + 1;
      if ( (unsigned int)v21 > (unsigned int)v19 )
      {
        ...
        do
        {
          ...
          v28 -= 8;
          *((_QWORD *)v28 + 1) = *(_QWORD *)&v22[8 * v21];
        }
        while ( (unsigned int)v21 > (unsigned int)v19 );
      }
      v23 = v41;
      v24 = (struct CVisual **)&v22[8 * v19];
      if ( v41 >= v24 && v41 < (struct CVisual **)&v22[8 * *((unsigned int *)this + 10) - 8] )
        v23 = v41 + 1;
      *v24 = *v23;
    }
  }
  ...
  if ( a5 )
  {
    if ( v7 == v9 )
    {
      ...
      v35 = *((_QWORD *)v42 + 2);
      if ( v35 && ((_DWORD)v19 == -1 || (unsigned int)v19 > *(_DWORD *)(*((_QWORD *)this + 1) + 72LL)) )
      {
        wil::details::in1diag3::_FailFast_Unexpected(
          retaddr,
          (void *)0x44,
      ...
      v36 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 16LL) + 16LL);
      v37 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))(**(_QWORD **)(v36 + 16) + 456LL))(
              *(_QWORD *)(v36 + 16),
              *(unsigned int *)(v36 + 24),
              *(unsigned int *)(*(_QWORD *)(v35 + 16) + 24LL),
              (unsigned int)v19);
      v14 = v37;
      if ( v37 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v37, 0x46u);
      if ( v14 >= 0 )
        goto LABEL_28;
      v39 = 237;
    }
    else
    {
      ...
      v25 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 16LL) + 16LL);
      v26 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD))(**(_QWORD **)(v25 + 16) + 448LL))(
              *(_QWORD *)(v25 + 16),
              *(unsigned int *)(v25 + 24),
              *(unsigned int *)(*(_QWORD *)(*((_QWORD *)v42 + 2) + 16LL) + 24LL),
              (unsigned int)v19);
      v14 = v26;
      if ( v26 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, 0x33u);
      if ( v14 >= 0 )
      {
LABEL_28:
        *((_BYTE *)v42 + 84) |= 4u;
...
LABEL_89:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, v39);
    return (unsigned int)v14;
  }
  if ( v7 == v9 )
  {
    v38 = CVisualProxy::RemoveChild(
            *(CVisualProxy **)(*((_QWORD *)this + 1) + 16LL),
            *((struct CVisualProxy **)v42 + 2));
    v14 = v38;
    if ( v38 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v38, 0x25u);
    if ( v14 < 0 )
    {
      v39 = 242;
      goto LABEL_89;
