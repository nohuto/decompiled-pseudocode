/*
 * XREFs of ?Start@CFlickVisual@@QEAAJPEBUtagPOINT@@W4FLICK_TYPE@@I@Z @ 0x1800A6154
 * Callers:
 ...
 *     ?MonitorDpiFromPoint@CDesktopManager@@SAIUtagPOINT@@@Z @ 0x180048368 (-MonitorDpiFromPoint@CDesktopManager@@SAIUtagPOINT@@@Z.c)
...
__int64 __fastcall CFlickVisual::Start(__int64 a1, POINT *a2, __int64 a3, int a4)
{
  ...
  *(_DWORD *)(a1 + 296) = a4;
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 2) != 0 )
    McTemplateU0q_EtwEventWriteTransfer(a1, (__int64)&UdwmFlickVisual_Start, a3);
  v7 = *(_QWORD *)(a1 + 352);
  if ( v7 )
  {
    v8 = (*(_DWORD *)(v7 + 8))-- == 1;
...
LABEL_40:
    ...
    if ( BitmapFromAtlas >= 0 )
    {
      ...
      *(_DWORD *)(a1 + 316) = top + *(_DWORD *)(a1 + 340) + v26;
      CContactManager::PostFlickFeedbackUpdate(*((_QWORD *)v27 + 24), v29, v28, (_QWORD *)(a1 + 312), 1u);
    }
    else
    {
