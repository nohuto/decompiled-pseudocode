/*
 * XREFs of ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x18002E784
 * Callers:
 *     ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x18002CEB0 (--0UsageIndexes@details_abi@wil@@QEAA@XZ.c)
