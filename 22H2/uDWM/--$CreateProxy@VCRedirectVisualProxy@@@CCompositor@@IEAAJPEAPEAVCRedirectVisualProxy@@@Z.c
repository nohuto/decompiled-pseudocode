/*
 * XREFs of ??$CreateProxy@VCRedirectVisualProxy@@@CCompositor@@IEAAJPEAPEAVCRedirectVisualProxy@@@Z @ 0x18003FEC0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRedirectVisualProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
