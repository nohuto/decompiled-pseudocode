/*
 * XREFs of ?CreateMonitorRenderTargetsLegacy@CDesktopManager@@AEAAJXZ @ 0x18003720C
 * Callers:
 ...
 *     ?IsTsDisplay@CDWMDisplay@@QEBA_NXZ @ 0x180039094 (-IsTsDisplay@CDWMDisplay@@QEBA_NXZ.c)
 ...
 *     ?IsWarpAdapterLuid@CDWMDXGIEnumeration@@QEBA_NU_LUID@@@Z @ 0x180052E9C (-IsWarpAdapterLuid@CDWMDXGIEnumeration@@QEBA_NU_LUID@@@Z.c)
