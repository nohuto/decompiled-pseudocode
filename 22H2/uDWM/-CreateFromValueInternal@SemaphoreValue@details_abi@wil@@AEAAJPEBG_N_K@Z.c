/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x18007E008
 * Callers:
 ...
 *     ?_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ @ 0x18007FE64 (-_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ.c)
 */
