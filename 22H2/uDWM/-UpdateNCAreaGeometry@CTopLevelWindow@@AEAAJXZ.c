/*
 * XREFs of ?UpdateNCAreaGeometry@CTopLevelWindow@@AEAAJXZ @ 0x180020970
 * Callers:
 ...
 *     ?CheckGUIHandleQuota@@YAJKJJ@Z @ 0x1800BF2BC (-CheckGUIHandleQuota@@YAJKJJ@Z.c)
 */
...
__int64 __fastcall CTopLevelWindow::UpdateNCAreaGeometry(CTopLevelWindow *this)
{
  ...
  *(_QWORD *)&v64.left = *(_QWORD *)(v7 + CTopLevelWindow::s_rgpwfWindowFrames);
  ...
  v60 = (int)((double)dword_1800E3ED0 * *((double *)CDesktopManager::s_pDesktopManagerInstance + 60));
  if ( v19 )
  {
    v20 = *((_QWORD *)this + 91);
...
LABEL_18:
  ...
  if ( RoundRectRgn )
  {
    ...
    if ( v33 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CC0D8, 11LL, v33, 0x1206u);
      goto LABEL_68;
    }
    ...
    if ( v35 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CC0D8, 11LL, v35, 0x120Cu);
      goto LABEL_97;
    }
    SetLastError(0);
    v36 = hrgnDst;
...
LABEL_61:
      ...
      if ( !RectRgn )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CC0D8, 11LL, v34, 0x121Bu);
LABEL_122:
        if ( v36 )
LABEL_67:
          DeleteObject(v36);
...
LABEL_121:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CC0D8, 11LL, v50, w);
        goto LABEL_122;
      }
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CC0D8, 11LL, v43, 0x1223u);
LABEL_97:
      v36 = hrgnDst;
      goto LABEL_122;
    }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CC0D8, 11LL, v34, 0x1204u);
  return (unsigned int)v34;
}
