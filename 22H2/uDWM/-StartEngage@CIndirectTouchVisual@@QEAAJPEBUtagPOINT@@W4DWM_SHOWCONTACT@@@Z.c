/*
 * XREFs of ?StartEngage@CIndirectTouchVisual@@QEAAJPEBUtagPOINT@@W4DWM_SHOWCONTACT@@@Z @ 0x1800ADA60
 * Callers:
...
LABEL_16:
  ...
  if ( v9 >= 0 )
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x5Du);
  if ( v10 < 0 )
    goto LABEL_16;
  return 0LL;
}
