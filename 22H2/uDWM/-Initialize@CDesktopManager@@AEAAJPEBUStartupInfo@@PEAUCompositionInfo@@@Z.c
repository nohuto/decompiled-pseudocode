/*
 * XREFs of ?Initialize@CDesktopManager@@AEAAJPEBUStartupInfo@@PEAUCompositionInfo@@@Z @ 0x18004A3B8
 * Callers:
 ...
 *     ?UpdateRemotingMode@CDesktopManager@@AEAA_NXZ @ 0x18003936C (-UpdateRemotingMode@CDesktopManager@@AEAA_NXZ.c)
 *     ?ReadProductType@CDesktopManager@@AEAAXXZ @ 0x18004AA70 (-ReadProductType@CDesktopManager@@AEAAXXZ.c)
 *     ?_InitializeWnf@CDesktopManager@@AEAAJXZ @ 0x18004AADC (-_InitializeWnf@CDesktopManager@@AEAAJXZ.c)
 ...
 *     ??0CProjectionBorderManager@@QEAA@XZ @ 0x18004AF04 (--0CProjectionBorderManager@@QEAA@XZ.c)
 ...
 *     ??0CAnimationClockCoordinator@@QEAA@XZ @ 0x18004B6D4 (--0CAnimationClockCoordinator@@QEAA@XZ.c)
 *     ??0CTransitionVisualController@@QEAA@XZ @ 0x18004B71C (--0CTransitionVisualController@@QEAA@XZ.c)
 *     ??0CContactManager@@QEAA@XZ @ 0x18004B7A8 (--0CContactManager@@QEAA@XZ.c)
 *     ??0CWindowList@@QEAA@XZ @ 0x18004B8AC (--0CWindowList@@QEAA@XZ.c)
 *     ?reset@?$unique_storage@U?$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1?RegCloseKey@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUHKEY__@@@Z @ 0x18004E704 (-reset@-$unique_storage@U-$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1-RegCloseKey@@YAJ0@ZU-$inte.c)
