/*
 * XREFs of ?ProcessAsyncDwmMessage@CWindowList@@UEAAJW4DWMCMD@@PEBXI_N@Z @ 0x1800157E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_84:
  ...
  if ( a2 > 1073741920 )
  {
    if ( a2 > 1073741929 )
    {
      ...
      if ( v60 )
      {
        ...
        if ( v61 )
        {
          ...
          if ( v62 )
          {
            ...
            if ( v63 )
            {
              ...
              {
                v7 = -2003303421;
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x245u);
                return v7;
              }
              ...
              if ( MagnifierControlForDesktop )
              {
                ...
                v7 = v68;
                if ( v68 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v68, 0x24Fu);
              }
            }
            else
            {
              ...
              {
                v7 = -2003303421;
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x232u);
                return v7;
              }
              v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
              EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
              ...
              if ( v69 )
              {
                ...
                v7 = v71;
                if ( v71 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v71, 0x23Cu);
              }
            }
          }
          else
          {
            ...
            {
              v7 = -2003303421;
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x220u);
              return v7;
            }
            v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
            EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
            ...
            if ( v72 )
            {
              ...
              v7 = v74;
              if ( v74 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v74, 0x22Au);
            }
          }
        }
        else
        {
          ...
          {
            v7 = -2003303421;
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x210u);
            return v7;
          }
          v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
          EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
          ...
          if ( v75 )
          {
            ...
            v7 = v77;
            if ( v77 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v77, 0x219u);
          }
        }
      }
      else
      {
        ...
        {
          v7 = -2003303421;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x200u);
          return v7;
        }
        v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
        ...
        if ( v78 )
        {
          ...
          v7 = v80;
          if ( v80 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v80, 0x209u);
        }
      }
      goto LABEL_70;
    }
    if ( a2 == 1073741929 )
    {
      ...
      {
        v7 = -2003303421;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x1F0u);
        return v7;
      }
      v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
      EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
      ...
      if ( v57 )
      {
        ...
        v7 = v59;
        if ( v59 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v59, 0x1F9u);
      }
      goto LABEL_70;
    }
    v35 = a2 - 1073741921;
    if ( !v35 )
    {
      ...
      {
        v7 = -2003303421;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x19Fu);
        return v7;
      }
      v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
      EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
      ...
      if ( v54 )
      {
        ...
        v7 = v56;
        if ( v56 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v56, 0x1A8u);
      }
      goto LABEL_70;
    }
    v36 = v35 - 1;
    if ( !v36 )
    {
      ...
      {
        v7 = -2003303421;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x1AFu);
        return v7;
      }
      v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
      EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
      ...
      if ( v51 )
      {
        ...
        v7 = v53;
        if ( v53 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v53, 0x1B8u);
      }
      goto LABEL_70;
    }
    v37 = v36 - 1;
    if ( !v37 )
    {
      ...
      if ( v48 )
      {
        ...
        v7 = v50;
        if ( v50 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v50, 0x1C8u);
      }
      goto LABEL_70;
    }
    v38 = v37 - 3;
    if ( !v38 )
    {
      ...
      if ( v45 )
      {
        ...
        v7 = v47;
        if ( v47 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v47, 0x1D8u);
      }
      goto LABEL_70;
    }
    v39 = v38 - 1;
    if ( !v39 )
    {
      ...
      if ( v42
        && (LOBYTE(v43) = a5,
            ...
            v44 < 0) )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v44, 0x1E8u);
      }
      else
      {
    ...
    if ( v40 )
    {
      ...
      if ( (_DWORD)v41 )
      {
        ...
        {
          v7 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x264u);
          return v7;
        }
...
LABEL_82:
  ...
  if ( a2 == 1073741920 )
  {
    ...
    {
      v7 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x18Fu);
      return v7;
    }
    v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
    EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
    ...
    if ( v32 )
    {
      ...
      v7 = v34;
      if ( v34 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v34, 0x198u);
    }
    goto LABEL_70;
  }
  if ( a2 == 1073741868 )
  ...
  if ( a2 > 1073741868 )
  {
    ...
    if ( !v27 )
    {
      ...
      {
        v7 = -2003303421;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x26Au);
      }
      return v7;
    }
    if ( v27 != 15 )
    ...
    {
      v7 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2003303421, 0x17Fu);
      return v7;
    }
    v83[0] = (unsigned __int64)&CDesktopManager::s_csDwmInstance;
    EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
    ...
    if ( v28 )
    {
      ...
      v7 = v30;
      if ( v30 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v30, 0x188u);
    }
LABEL_70:
