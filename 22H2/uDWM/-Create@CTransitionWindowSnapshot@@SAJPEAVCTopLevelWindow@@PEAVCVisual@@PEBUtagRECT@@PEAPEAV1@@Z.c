/*
 * XREFs of ?Create@CTransitionWindowSnapshot@@SAJPEAVCTopLevelWindow@@PEAVCVisual@@PEBUtagRECT@@PEAPEAV1@@Z @ 0x180003070
 * Callers:
        ...
        struct CTransitionWindowSnapshot **a4)
{
  ...
  if ( dword_1800E6A60 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E6A60);
    if ( dword_1800E6A60 == -1 )
    {
      dword_1800E3F38 = -2147023434;
      Init_thread_footer(&dword_1800E6A60);
    }
  }
  *a4 = 0LL;
  ...
  if ( v9 )
  {
    v10 = (struct tagRECT *)*((_QWORD *)a1 + 91);
    if ( a3 )
    {
      rc = *a3;
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E3F38, 1u, v11, 0x30u, v14);
    }
    else
    {
  ...
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E3F38, 1u, -2147024882, 0x22u, v14);
  }
  return v12;
}
