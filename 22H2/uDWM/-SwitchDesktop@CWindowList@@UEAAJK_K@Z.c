/*
 * XREFs of ?SwitchDesktop@CWindowList@@UEAAJK_K@Z @ 0x180036360
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x196Du);
    goto LABEL_7;
  }
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x1971u);
    goto LABEL_7;
  }
  if ( *((_QWORD *)this + 65) )
    goto LABEL_18;
