/*
 * XREFs of ?IncrementStrongReference@StrongReference@Details@WRL@Microsoft@@QEAAKXZ @ 0x1800C1D48
 * Callers:
 *     ?AddRef@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAKXZ @ 0x180041920 (-AddRef@GaussianBlurEffect@Effects@Composition@UI@Microsoft@@UEAAKXZ.c)
