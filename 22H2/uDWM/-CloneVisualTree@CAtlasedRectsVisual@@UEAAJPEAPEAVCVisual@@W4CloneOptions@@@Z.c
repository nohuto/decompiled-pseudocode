/*
 * XREFs of ?CloneVisualTree@CAtlasedRectsVisual@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x180027460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAtlasedRectsVisual::CloneVisualTree(__int64 a1, CBaseObject **a2, unsigned int a3)
{
  ...
  *a2 = 0LL;
  ...
  {
    v6 = CAtlasedRectsVisual::InitializeVisualTreeClone(a1, (__int64)v13, a3);
    v8 = v6;
    if ( v6 >= 0 )
    {
      v9 = v7;
