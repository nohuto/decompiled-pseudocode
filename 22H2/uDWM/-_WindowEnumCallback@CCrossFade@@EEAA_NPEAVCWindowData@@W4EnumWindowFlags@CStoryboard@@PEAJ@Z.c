/*
 * XREFs of ?_WindowEnumCallback@CCrossFade@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800B4520
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v9 != 18 )
  {
    switch ( *(_DWORD *)(a2 + 616) & 0xFFF )
    {
      ...
      case 61:
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v15, 0x6ABu);
          goto LABEL_15;
        }
LABEL_9:
...
LABEL_21:
  ...
  if ( v17 >= 0 )
    goto LABEL_9;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v17, 0x6A3u);
LABEL_15:
  if ( v19 )
