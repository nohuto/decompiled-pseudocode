        ...
        struct CAnimationComponent **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v6, 0x1543u, v11);
    goto LABEL_7;
  }
...
LABEL_7:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v10, 0x1547u, v11);
LABEL_8:
  if ( v8 )
