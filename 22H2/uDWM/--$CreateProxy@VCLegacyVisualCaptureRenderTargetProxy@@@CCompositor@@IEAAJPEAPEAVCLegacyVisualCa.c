/*
 * XREFs of ??$CreateProxy@VCLegacyVisualCaptureRenderTargetProxy@@@CCompositor@@IEAAJPEAPEAVCLegacyVisualCaptureRenderTargetProxy@@@Z @ 0x1800BD84C
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CLegacyVisualCaptureRenderTargetProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  int v6; // eax
  ...
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v6 = CResource::Create(0x13u, *(_QWORD *)(a1 + 16), (__int64 *)(v5 + 16));
    v7 = v6;
    if ( v6 >= 0 )
      v7 = 0;
    else
