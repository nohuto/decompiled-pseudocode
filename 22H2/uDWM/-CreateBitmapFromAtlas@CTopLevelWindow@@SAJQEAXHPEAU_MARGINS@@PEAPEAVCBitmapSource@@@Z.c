/*
 * XREFs of ?CreateBitmapFromAtlas@CTopLevelWindow@@SAJQEAXHPEAU_MARGINS@@PEAPEAVCBitmapSource@@@Z @ 0x1800496E8
 * Callers:
        ...
        struct CBitmapSource **a4)
{
  ...
  if ( dword_1800E6DAC > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E6DAC);
    if ( dword_1800E6DAC == -1 )
    {
      dword_1800E4000 = -2147023728;
      Init_thread_footer(&dword_1800E6DAC);
    }
  }
