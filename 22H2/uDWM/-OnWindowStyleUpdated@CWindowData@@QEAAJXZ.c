/*
 * XREFs of ?OnWindowStyleUpdated@CWindowData@@QEAAJXZ @ 0x180028158
 * Callers:
...
__int64 __fastcall CWindowData::OnWindowStyleUpdated(CWindowData *this)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x1D11u);
  }
  else
  {
    ...
    if ( v5 )
    {
      ...
      v2 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x1D16u);
    }
  }
  return v2;
}
