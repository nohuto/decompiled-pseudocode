/*
 * XREFs of ?EnsureThumbnailVisual@CThumbnailData@@UEAAJXZ @ 0x18000D6A0
 * Callers:
...
LABEL_8:
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x218Cu);
  }
  else
  {
    *((_QWORD *)v1 + 46) = this;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x2190u);
    }
    else
    {
      *((_QWORD *)this + 11) = v1;
