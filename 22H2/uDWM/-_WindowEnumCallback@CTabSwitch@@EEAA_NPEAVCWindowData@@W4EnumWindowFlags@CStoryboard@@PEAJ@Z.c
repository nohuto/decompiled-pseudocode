/*
 * XREFs of ?_WindowEnumCallback@CTabSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800B5190
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CTabSwitch::_WindowEnumCallback(CStoryboard *a1, struct CWindowData *a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) != 0 && (*((_DWORD *)a2 + 154) & 0xFFFu) - 2 <= 1 )
  {
    ...
    v4 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v9, 0x13DDu);
    if ( v11 )
