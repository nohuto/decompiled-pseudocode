/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VAnimationClockLogging@@$0A@$0A@$03$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x1800BA220
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?get@?$static_lazy@VAnimationClockLogging@@@details@wil@@QEAAPEAVAnimationClockLogging@@P6AXXZ@Z @ 0x18002D8E4 (-get@-$static_lazy@VAnimationClockLogging@@@details@wil@@QEAAPEAVAnimationClockLogging@@P6AXXZ@Z.c)
        ...
        int *a2)
{
  ...
  if ( *v4 > 2u )
  {
    v14 = (const unsigned __int16 *)*((_QWORD *)a2 + 5);
    ...
    v26 = a2[24];
    v17 = (wchar_t *)*((_QWORD *)a2 + 11);
    v18 = (const unsigned __int16 *)*((_QWORD *)a2 + 10);
    v27 = a2[18];
    v19 = (const unsigned __int16 *)*((_QWORD *)a2 + 8);
    v10 = a2[6];
    v20 = (wchar_t *)*((_QWORD *)a2 + 2);
    v11 = *a2;
    v21 = (const unsigned __int16 *)*((_QWORD *)a2 + 15);
    v12 = a2[14];
    v22 = (const unsigned __int16 *)*((_QWORD *)a2 + 6);
    v13 = a2[1];
    v23[0] = 0x1000000LL;
