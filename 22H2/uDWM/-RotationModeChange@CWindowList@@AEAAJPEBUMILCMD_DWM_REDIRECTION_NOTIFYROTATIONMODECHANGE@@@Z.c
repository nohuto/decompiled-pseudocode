/*
 * XREFs of ?RotationModeChange@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYROTATIONMODECHANGE@@@Z @ 0x18009964C
 * Callers:
  ...
  if ( *((_DWORD *)a2 + 1) )
  {
    if ( v5 || (v6 = CScreenRotation::Create((struct CScreenRotation **)this + 62), v4 = v6, v6 >= 0) )
    {
      ...
      if ( v8 >= 0 )
      {
        ...
        v4 = v9;
        if ( v9 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x19BDu);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x19BBu);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x19B2u);
    }
  }
