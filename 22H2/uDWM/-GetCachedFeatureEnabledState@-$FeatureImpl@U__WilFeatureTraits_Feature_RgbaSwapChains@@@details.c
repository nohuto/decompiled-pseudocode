/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_RgbaSwapChains@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18004D6C0
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_RgbaSwapChains@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180038A24 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_RgbaSwapChains@@@details@wil@@QEAAX_NW4Re.c)
 * Callees:
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_RgbaSwapChains>::GetCurrentFeatureEnabledState(a1, &v15, &i);
    v7 = *a2;
    v8 = v6 != 0 ? i : 0;
    for ( i = v8; ; v8 = i )
    {
