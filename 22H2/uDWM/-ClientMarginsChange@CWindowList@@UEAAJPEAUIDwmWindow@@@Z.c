/*
 * XREFs of ?ClientMarginsChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180015020
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x88Fu);
  if ( v5 < 0 )
  {
LABEL_15:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0xBF7u);
    goto LABEL_8;
  }
  if ( v4 )
  {
