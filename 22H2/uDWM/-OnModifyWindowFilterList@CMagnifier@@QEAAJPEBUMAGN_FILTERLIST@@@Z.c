/*
 * XREFs of ?OnModifyWindowFilterList@CMagnifier@@QEAAJPEBUMAGN_FILTERLIST@@@Z @ 0x18008B730
 * Callers:
        ...
        const struct MAGN_FILTERLIST *a2)
{
  ...
  v5 = 0LL;
  if ( dword_1800E6FE0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E6FE0);
    if ( dword_1800E6FE0 == -1 )
    {
      dword_1800E6F14 = -2147023728;
      Init_thread_footer(&dword_1800E6FE0);
    }
  }
  v6 = this + 6;
  if ( this[6]
        ...
        v7 >= 0) )
  {
    if ( !v4 || *(_DWORD *)a2 == 1 && this[7] == *((CMagnifierRenderTargetProxy **)a2 + 1) )
    {
      ...
      v8 = v21;
      if ( v21 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F14, 1LL, v21, 0xE6u);
    }
    else
    {
      v9 = 0;
      ...
      if ( (unsigned int)v11 < v4 )
      {
        ...
        while ( (unsigned int)v11 < 0x19 )
        {
          if ( this[7] != *v15 )
          {
            ...
            {
              v8 = -2147023728;
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F14, 1LL, -2147023728, 0x115u);
              return v8;
            }
      ...
      if ( v19 >= 0 )
      {
        ...
        v8 = v20;
        if ( v20 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F14, 1LL, v20, 0x127u);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F14, 1LL, v19, 0x125u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E6F14, 1LL, v7, 0xE0u);
  }
  return v8;
}
