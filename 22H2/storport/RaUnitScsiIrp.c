/*
 * XREFs of RaUnitScsiIrp @ 0x1C0009B50
 * Callers:
 ...
 *     RaUnitCheckRemoveStateForDisabled @ 0x1C0047588 (RaUnitCheckRemoveStateForDisabled.c)
 ...
 *     RaUnitSwallowStopUnitCommand @ 0x1C0049C48 (RaUnitSwallowStopUnitCommand.c)
...
LABEL_5:
  ...
  if ( (SecurityQos & 0x100000) != 0 )
  {
    if ( (v15 = *(PDEVICE_OBJECT *)(a1 + 24), (v32 = *(_QWORD *)&v15[15].Flags) != 0)
      ...
      || HIDWORD(v15->DeviceLock.Header.WaitListHead.Flink) != 1 )
    {
...
LABEL_24:
    ...
    && (v39 = RaUnitSwallowStopUnitCommand(a1)) != 0 )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_c0fbeaa32f6432859fb1821fd44520a7_Traceguids, a1, a2);
    }
    return v40;
  }
  else
  {
    if ( StorEtwLoggingEnabled && (byte_1C0069841 & 0x3C) != 0 && ((LOBYTE(v16->SecurityQos) - 8) & 0x5D) == 0 )
    {
