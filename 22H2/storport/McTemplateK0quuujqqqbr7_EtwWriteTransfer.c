/*
 * XREFs of McTemplateK0quuujqqqbr7_EtwWriteTransfer @ 0x1C004E7EC
 * Callers:
 *     StorEtwMiniportBugAbortTimeoutEvent @ 0x1C0050054 (StorEtwMiniportBugAbortTimeoutEvent.c)
 * Callees:
...
NTSTATUS __fastcall McTemplateK0quuujqqqbr7_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        __int64 a12)
{
  ...
  v27 = 4LL;
  v29 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventUnitAbortTimeout, a3, 0xAu, &v13);
}
