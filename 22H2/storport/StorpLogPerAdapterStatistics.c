/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C000E648
 * Callers:
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
    ...
    && tlgKeywordOn(v2, 0x400000000000LL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v5, (int)&dword_1C005F265, v6, v7, 0x13u, &v27);
  }
    ...
    && tlgKeywordOn(v3, 0x400000000000LL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v8, (int)&dword_1C00601E5, v9, v10, 0x13u, &v27);
  }
