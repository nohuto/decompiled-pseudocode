/*
 * XREFs of RaUnitDeviceUsageNotificationIrp @ 0x1C0014D94
 * Callers:
 ...
 *     RaSendIrpSynchronous @ 0x1C00116A0 (RaSendIrpSynchronous.c)
 ...
 *     RaidSecondaryDumpRegister @ 0x1C0058128 (RaidSecondaryDumpRegister.c)
 *     RaidNotifyPoAboutSpecialDevice @ 0x1C0058FC0 (RaidNotifyPoAboutSpecialDevice.c)
 */
        ...
        if ( Lock )
        {
          ...
          *(_BYTE *)(v2 + 104) |= 0x80u;
          ...
          if ( (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(v10, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer((int)&v37, (int)&dword_1C005DD8A, v14, v15, 0xBu, &v37);
          }
        }
        else
        {
