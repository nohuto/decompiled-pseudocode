/*
 * XREFs of McTemplateK0quuujjqzsssztuqquuuuuuqqi_EtwWriteTransfer @ 0x1C000D0D0
 * Callers:
 *     StorpTelemetrySendUnitUniqueErrorData @ 0x1C000CB4C (StorpTelemetrySendUnitUniqueErrorData.c)
 * Callees:
