/*
 * XREFs of StorpFreeContiguousMemorySpecifyCacheEx @ 0x1C003B558
 * Callers:
        ...
        __int64 a5)
{
  ...
  v5 = *(_QWORD *)(a1 - 16);
  if ( *(_BYTE *)(*(_QWORD *)v5 + 736LL) && *(_DWORD *)(*(_QWORD *)v5 + 756LL) == 3 )
  {
    v7 = 1;
    (*(void (__fastcall **)(_QWORD, _QWORD, __int64, void *, char))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v5 + 728LL) + 8LL)
                                                                  + 24LL))(
      *(_QWORD *)(*(_QWORD *)v5 + 728LL),
      (unsigned int)a3,
      a5,
      a2,
      v7);
