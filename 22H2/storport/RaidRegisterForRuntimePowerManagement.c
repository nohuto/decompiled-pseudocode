/*
 * XREFs of RaidRegisterForRuntimePowerManagement @ 0x1C003F0F8
 * Callers:
...
LABEL_42:
  ...
  if ( v44 >= 0 )
  {
    ...
    if ( v46 == 1 )
    {
      ...
      if ( (unsigned int)dword_1C0069058 > 5 )
      {
        if ( tlgKeywordOn(v45, 0x400000000000LL) )
        {
          ...
          LODWORD(v65) = v51;
          v92 = 4LL;
          tlgWriteTransfer_EtwWriteTransfer(v52, byte_1C005D89E, v48, v49, 0xEu, &v68);
        }
      }
    }
    else if ( !v46 && (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn((unsigned int)*a2, 0x400000000000LL) )
    {
      ...
      v61 = v56;
      v80 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v53, (unsigned __int8 *)dword_1C005D965, v54, v55, 8u, &v68);
    }
  }
