/*
 * XREFs of StorCreateSystemLogEntry @ 0x1C0046054
 * Callers:
 ...
 *     RtlStringCchLengthW @ 0x1C0033328 (RtlStringCchLengthW.c)
 *     RaidScsiErrorToIoError @ 0x1C0045B6C (RaidScsiErrorToIoError.c)
 */
