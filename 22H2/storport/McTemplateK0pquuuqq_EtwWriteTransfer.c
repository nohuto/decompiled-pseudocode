/*
 * XREFs of McTemplateK0pquuuqq_EtwWriteTransfer @ 0x1C003DCA4
 * Callers:
...
NTSTATUS McTemplateK0pquuuqq_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, 0LL, 8u, &v4);
}
