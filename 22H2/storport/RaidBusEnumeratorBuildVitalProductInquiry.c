/*
 * XREFs of RaidBusEnumeratorBuildVitalProductInquiry @ 0x1C001850C
 * Callers:
 *     RaidBusEnumeratorGenericInquiry @ 0x1C0017F1C (RaidBusEnumeratorGenericInquiry.c)
 * Callees:
 *     RaidInitializeInquirySrb @ 0x1C0072F04 (RaidInitializeInquirySrb.c)
 */
        ...
        _QWORD *a6)
{
  ...
  v11 = 0;
  v12 = 0LL;
  RaidInitializeInquirySrb(v6, a2, a2 >> 8, HIWORD(a2), a3[4], a5, *(_BYTE *)(*a1 + 426));
  if ( *(_BYTE *)(v8 + 426) == 1 )
  {
