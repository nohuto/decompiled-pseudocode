/*
 * XREFs of RaidUnitCompleteRequest @ 0x1C0007A00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     StorpTelemetryCollectPerfData @ 0x1C0009110 (StorpTelemetryCollectPerfData.c)
 ...
 *     RaidAdapterReleaseCryptoKeyResources @ 0x1C002DE7C (RaidAdapterReleaseCryptoKeyResources.c)
 *     RaidUnitPoFxIdleComponentFromMiniport @ 0x1C0032FE4 (RaidUnitPoFxIdleComponentFromMiniport.c)
 *     WPP_SF_qqD @ 0x1C00337B0 (WPP_SF_qqD.c)
 *     StorRemoveEventQueue @ 0x1C0034984 (StorRemoveEventQueue.c)
 *     StorRemoveEventQueueInternal @ 0x1C0034A40 (StorRemoveEventQueueInternal.c)
 *     McTemplateK0pquuqqd_EtwWriteTransfer @ 0x1C0034AD4 (McTemplateK0pquuqqd_EtwWriteTransfer.c)
 *     RaidIsUnresponsiveBlockedCmd @ 0x1C0036694 (RaidIsUnresponsiveBlockedCmd.c)
 *     RaidSrbExGetBidirectionalData @ 0x1C0042C0C (RaidSrbExGetBidirectionalData.c)
 *     TranslateResultToScsiRequestBlock @ 0x1C0042D34 (TranslateResultToScsiRequestBlock.c)
