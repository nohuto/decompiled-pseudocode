 ...
 *     RaidAllocateDeviceProperty @ 0x1C0030690 (RaidAllocateDeviceProperty.c)
 ...
 *     StorpInitializeAdapterTelemetry @ 0x1C0052704 (StorpInitializeAdapterTelemetry.c)
    ...
    if ( (unsigned int)dword_1C0069058 > 5 )
    {
      if ( tlgKeywordOn(v41, 0x400000000000LL) )
      {
        ...
        *(_QWORD *)&v66[12].Size = 1LL;
        tlgWriteTransfer_EtwWriteTransfer(v42, (unsigned __int8 *)dword_1C005D481, v43, v44, 0xDu, v66);
      }
    }
    KeInitializeDpc(
