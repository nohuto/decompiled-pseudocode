/*
 * XREFs of McTemplateK0quuuqqtt_EtwWriteTransfer @ 0x1C003E2F4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0quuuqqtt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventUnitIdleTimeoutValue, 0LL, 9u, &v12);
}
