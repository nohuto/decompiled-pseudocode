/*
 * XREFs of RaidAdapterConnectInterrupt @ 0x1C002BF54
 * Callers:
 *     RaidAdapterStartMiniport @ 0x1C00300D8 (RaidAdapterStartMiniport.c)
 * Callees:
 *     WPP_SF_ @ 0x1C00334DC (WPP_SF_.c)
 *     RaidGetResourceListInterrupt @ 0x1C00429F4 (RaidGetResourceListInterrupt.c)
...
__int64 __fastcall RaidAdapterConnectInterrupt(__int64 a1)
{
  ...
  if ( !v3 && *(_QWORD *)(a1 + 312) )
  {
    ...
    WPP_SF_(v8->AttachedDevice, v9, &WPP_1af4e391bf1d3e2526011607efd76594_Traceguids);
    return ResourceListInterrupt;
  }
  return 0LL;
}
