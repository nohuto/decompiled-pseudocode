/*
 * XREFs of StorpTelemetryLogUnitQosDataMeasures @ 0x1C0054E50
 * Callers:
 *     StorpTelemetrySendUnitQos @ 0x1C0057B8C (StorpTelemetrySendUnitQos.c)
 * Callees:
...
char __fastcall StorpTelemetryLogUnitQosDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0069058 > 5 )
  {
    ...
    if ( (_BYTE)v1 )
    {
      ...
      v77 = 4LL;
      v79 = 4LL;
      LOBYTE(v1) = tlgWriteTransfer_EtwWriteTransfer(v8, (unsigned __int8 *)dword_1C0060752, v11, v12, 0x1Bu, &v33);
    }
  }
  return (char)v1;
}
