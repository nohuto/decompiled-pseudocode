/*
 * XREFs of StorpTelemetrySendUnitErrorDataSummary @ 0x1C00032C4
 * Callers:
 *     StorpLogPerUnitStatistics @ 0x1C000CA50 (StorpLogPerUnitStatistics.c)
 * Callees:
 *     StorpAreTelemetryErrorsEqual @ 0x1C0006ECC (StorpAreTelemetryErrorsEqual.c)
...
__int64 __fastcall StorpTelemetrySendUnitErrorDataSummary(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 2328) )
  {
    ...
    do
    {
      ...
      v6 = StorpAreTelemetryErrorsEqual(a1 + 8 * ((unsigned __int8)v4 + 4 * ((unsigned __int8)v4 + 87LL)), v12, v4, v5);
      if ( v6 == (_BYTE)v7 )
        break;
      LOWORD(v5) = v7 + v5;
      LOBYTE(v4) = v7 + v4;
