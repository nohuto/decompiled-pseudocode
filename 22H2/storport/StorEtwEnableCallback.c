/*
 * XREFs of StorEtwEnableCallback @ 0x1C004F140
 * Callers:
 ...
 *     RaidGetPortData @ 0x1C000E01C (RaidGetPortData.c)
 *     memset @ 0x1C0020480 (memset.c)
 *     StorEtwAdapterNeedsUpdate @ 0x1C004F09C (StorEtwAdapterNeedsUpdate.c)
