/*
 * XREFs of PortPassThroughExMarshalResultsFromSrbEx @ 0x1C0059E40
 * Callers:
 *     PortpCompleteRequestIrp @ 0x1C005A640 (PortpCompleteRequestIrp.c)
 * Callees:
 *     memmove @ 0x1C00201C0 (memmove.c)
 *     PortPassThroughExApplyNormalizedRequest @ 0x1C0059C84 (PortPassThroughExApplyNormalizedRequest.c)
