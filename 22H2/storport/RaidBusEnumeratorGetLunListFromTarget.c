/*
 * XREFs of RaidBusEnumeratorGetLunListFromTarget @ 0x1C0017C34
 * Callers:
 ...
 *     RaidSelectDeviceDumpCollectionMode @ 0x1C00191C4 (RaidSelectDeviceDumpCollectionMode.c)
...
LABEL_12:
  ...
  {
    v17 = 8 * *(unsigned __int8 *)(*a1 + 474LL) + 8;
    result = RaidBusEnumeratorIssueReportLuns((_DWORD)a1, a2, a3, (unsigned int)&v17, (__int64)&v18);
  }
  LOWORD(v11) = 0;
  if ( (int)result >= 0 )
