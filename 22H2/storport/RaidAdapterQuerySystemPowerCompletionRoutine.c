/*
 * XREFs of RaidAdapterQuerySystemPowerCompletionRoutine @ 0x1C0015F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterQuerySystemPowerCompletionRoutine(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 34LL, &WPP_e79642d899e13d0104d95ec0ec72addd_Traceguids, v2, a2);
  }
  if ( *(_BYTE *)(a2 + 65) )
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 35LL, &WPP_e79642d899e13d0104d95ec0ec72addd_Traceguids, v2, a2, v4);
  }
