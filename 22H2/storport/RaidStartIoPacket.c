/*
 * XREFs of RaidStartIoPacket @ 0x1C0009FB0
 * Callers:
 ...
 *     RaidUpdateZoneIoReceiveWithStatus @ 0x1C0034D90 (RaidUpdateZoneIoReceiveWithStatus.c)
...
LABEL_53:
        ...
        (IoResource = (PSLIST_ENTRY)RaAllocateIoResource((PSLIST_HEADER)(v23 + 64))) != 0LL) )
  {
    ...
    *((_DWORD *)&v28[48].Next + 2) = 0;
    v28[49].Next = Next;
    (*(void (__fastcall **)(_QWORD, __int64, __int128 *, _QWORD))(a1 + 648))(*(_QWORD *)(a1 + 640), a2, &v112, 0LL);
    v33 = 1;
    goto LABEL_60;
  }
  KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)v23, &v109);
