/*
 * XREFs of StorpTelemetryLogUnitErrorDataCriticalData @ 0x1C00547D4
 * Callers:
...
void __fastcall StorpTelemetryLogUnitErrorDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0069058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v67 = 2LL;
      v69[1] = 0;
      tlgWriteTransfer_EtwWriteTransfer(v10, (unsigned __int8 *)dword_1C005E0CD, v11, v12, 0x1Bu, &v26);
    }
  }
}
