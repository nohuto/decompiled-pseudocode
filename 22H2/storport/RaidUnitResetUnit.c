/*
 * XREFs of RaidUnitResetUnit @ 0x1C004B6C0
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C0051A98 (StorpAggregateHierarchicalResetLun.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0069058 > 5 )
      {
        ...
        v29[0] = v18;
        v46 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v22, (unsigned __int8 *)dword_1C005DC33, v18, v19, 0xAu, &v30);
      }
