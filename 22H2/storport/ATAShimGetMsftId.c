/*
 * XREFs of ATAShimGetMsftId @ 0x1C0058490
 * Callers:
 *     ATADeviceIdShimStorageDeviceIdCompletionHook @ 0x1C0058420 (ATADeviceIdShimStorageDeviceIdCompletionHook.c)
 * Callees:
 *     __security_check_cookie @ 0x1C001D5B0 (__security_check_cookie.c)
 *     RaidAddATADeviceIdMapping @ 0x1C0035334 (RaidAddATADeviceIdMapping.c)
 *     RaidCheckATADeviceIdMapping @ 0x1C0035620 (RaidCheckATADeviceIdMapping.c)
 *     RaidSaveATADeviceIdMapping @ 0x1C0035BC8 (RaidSaveATADeviceIdMapping.c)
 *     TrimString @ 0x1C0058C40 (TrimString.c)
 */
