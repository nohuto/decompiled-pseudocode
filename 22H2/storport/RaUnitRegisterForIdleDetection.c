 ...
 *     RaidUnitPoFxSetDeviceIdleTimeout @ 0x1C0005F30 (RaidUnitPoFxSetDeviceIdleTimeout.c)
 ...
 *     RaidAdapterIsRegisteredForIdleDetection @ 0x1C002D324 (RaidAdapterIsRegisteredForIdleDetection.c)
...
LABEL_47:
  ...
  if ( !*((_QWORD *)Context + 218) )
  {
    if ( (*(_BYTE *)(v2 + 104) & 0x20) != 0 || *(char *)(v2 + 110) < 0 )
    {
      ...
      *((_DWORD *)v14 + 40) = 1;
      *((_DWORD *)v14 + 41) = 32;
      *((_OWORD *)v14 + 11) = xmmword_1C005D3B0;
      *((_DWORD *)v14 + 48) = 1;
      *((_DWORD *)v14 + 49) = 32;
      v14[25] = 0LL;
      v14[26] = 0LL;
