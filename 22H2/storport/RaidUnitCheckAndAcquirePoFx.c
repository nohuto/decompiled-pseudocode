/*
 * XREFs of RaidUnitCheckAndAcquirePoFx @ 0x1C0006370
 * Callers:
 ...
 *     RaidUnitCancelWaitWakeIrp @ 0x1C0013EAC (RaidUnitCancelWaitWakeIrp.c)
 ...
 *     RaidUnitPoFxActivateComponentFromMiniport @ 0x1C0037FC8 (RaidUnitPoFxActivateComponentFromMiniport.c)
 *     RaidUnitEndMaintenanceTime @ 0x1C003F930 (RaidUnitEndMaintenanceTime.c)
 *     RaidUnitIoCoalescingCallback @ 0x1C003FA80 (RaidUnitIoCoalescingCallback.c)
 *     RaidUnitMaintenanceTime @ 0x1C003FB14 (RaidUnitMaintenanceTime.c)
 *     RaidUnitPowerSettingCallback @ 0x1C003FCD0 (RaidUnitPowerSettingCallback.c)
 *     StorPortUnitDirectedPowerDown @ 0x1C0041350 (StorPortUnitDirectedPowerDown.c)
 *     StorPortUnitDirectedPowerDownCompletion @ 0x1C0041470 (StorPortUnitDirectedPowerDownCompletion.c)
 ...
 *     StorPortUnitPoFxWaitWakeCompletion @ 0x1C0041FE0 (StorPortUnitPoFxWaitWakeCompletion.c)
