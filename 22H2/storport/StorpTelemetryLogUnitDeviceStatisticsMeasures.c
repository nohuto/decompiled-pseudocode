/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsMeasures @ 0x1C0054300
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsMeasures(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // r11
  ...
  if ( (unsigned int)dword_1C0069058 > 5 && tlgKeywordOn(a1, 0x400000000000LL) )
  {
    v2 = *(_QWORD *)(v1 + 24);
    v46 = 16LL;
    v48 = 16LL;
    ...
    v111 = &v32;
    v112 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v26, (unsigned __int8 *)dword_1C005EB77, v6, v23, 0x26u, &v44);
  }
}
