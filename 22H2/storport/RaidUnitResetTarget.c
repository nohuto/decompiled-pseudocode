/*
 * XREFs of RaidUnitResetTarget @ 0x1C004B408
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C0051AEC (StorpAggregateHierarchicalResetTarget.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0069058 > 5 )
      {
        ...
        v28 = v18;
        v42 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(8LL, (unsigned __int8 *)dword_1C005DBC1, v18, v19, 8u, &v30);
      }
