/*
 * XREFs of RaDeleteDriver @ 0x1C007A168
 * Callers:
 *     RaDriverUnload @ 0x1C00344C0 (RaDriverUnload.c)
 *     StorPortInitialize @ 0x1C0035ED0 (StorPortInitialize.c)
 * Callees:
 *     RaidReleasePortData @ 0x1C000DFFC (RaidReleasePortData.c)
 *     _guard_dispatch_icall_nop @ 0x1C0020190 (_guard_dispatch_icall_nop.c)
 *     McGenEventUnregister_EtwUnregister @ 0x1C00341B8 (McGenEventUnregister_EtwUnregister.c)
 *     RaFreeDriverInitData @ 0x1C00345A0 (RaFreeDriverInitData.c)
 *     RaidRemovePortDriver @ 0x1C0035B48 (RaidRemovePortDriver.c)
