/*
 * XREFs of RaDriverPnpIrp @ 0x1C000BC70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaDriverPnpIrp(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_BYTE *)(a2 + 141) = -88;
  ...
  {
    v6 = RaidAdapterPnpIrp(v5, (PIRP)a2);
  }
  v7 = v6;
LABEL_7:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 21LL, &WPP_c75ef678420536b919220fd58d40bf93_Traceguids, a1, a2, v7);
  }
  return v7;
}
