...
__int64 __fastcall MdlToPrp(__int64 a1, __int64 a2)
{
  ...
  __int64 v31; // rax
  __m128i v32; // xmm0
  _QWORD *v33; // [rsp+20h] [rbp-38h]
  unsigned int *v34; // [rsp+28h] [rbp-30h]
  _QWORD v35[2]; // [rsp+40h] [rbp-18h] BYREF
  unsigned int v36; // [rsp+98h] [rbp+40h] BYREF
  unsigned int v37; // [rsp+A0h] [rbp+48h] BYREF
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( !(_DWORD)result )
    {
      ...
      {
        v37 = 0;
        SrbScsiData = GetSrbScsiData(a2, (unsigned int)&v37, 0, 0, 0LL);
        if ( GetLbaFromCdb(SrbScsiData, v37, SrbScsiData) )
        {
          v15 = *v11;
      ...
      if ( !v23 || v5 + v23 > v38 )
        return 3238002689LL;
      *(_QWORD *)(v4 + 4120) = v22 + (*(_QWORD *)(v35[0] + 8LL * v5) << 12);
      if ( v23 != 1 )
      {
        if ( v23 == 2 )
        {
          *(_QWORD *)(v4 + 4128) = *(_QWORD *)(v35[0] + 8LL * (v5 + 1)) << 12;
        ...
        else
        {
          ...
          if ( (unsigned int)v25 < 8 )
            goto LABEL_46;
          v27 = v35[0];
          if ( v4 + 8 <= v35[0] + 8 * (unsigned __int64)((unsigned int)v25 + v5)
            && v4 + 8 * v25 >= v35[0] + 8 * (unsigned __int64)(v5 + 1) )
          {
            goto LABEL_47;
          }
          v28 = v35[0];
...
LABEL_47:
          ...
          *(_QWORD *)(v4 + 4128) = StorPortGetPhysicalAddress(a1, a2, v4, &v37, v33, v34, &v36);
        }
      }
      return 0LL;
    }
