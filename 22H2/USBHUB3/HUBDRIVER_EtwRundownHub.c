/*
 * XREFs of HUBDRIVER_EtwRundownHub @ 0x1C007585C
 * Callers:
...
__int64 __fastcall HUBDRIVER_EtwRundownHub(const GUID *a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    ...
    if ( v5 )
    {
      if ( v5 == 2 && (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 1) != 0 )
    ...
    else if ( (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 1) != 0 )
    {
  ...
  while ( a2 + 2360 != result )
  {
    ...
    {
      if ( v8 != 5000 || (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 1) == 0 )
        goto LABEL_42;
      v9 = *(_DWORD *)(a2 + 168);
      if ( v9 == 1 )
      {
    ...
    McTemplateK0pquuxqqqqqqqsss_EtwWriteTransfer(
      ...
      *(_QWORD *)(v7 + 1416),
      ...
      v37);
LABEL_42:
    if ( (*(_DWORD *)(v7 + 204) & 2) != 0 && (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 1) != 0 )
    {
      LODWORD(v26) = 12;
      LODWORD(v25) = *(unsigned __int16 *)(v7 + 200);
    ...
    if ( (*(_DWORD *)(v7 + 204) & 4) != 0 && (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 1) != 0 )
    {
      LODWORD(v26) = 16;
      LODWORD(v25) = *(unsigned __int16 *)(v7 + 200);
      McTemplateK0pqn_EtwWriteTransfer(
