/*
 * XREFs of HUBREG_QueryHubErrataFlags @ 0x1C0083F98
 * Callers:
...
LABEL_36:
  ...
  if ( (unsigned int)Feature_USB4PowerImprovements__private_IsEnabled() && (v11 & 0x1000000000000LL) != 0 )
  ...
  if ( (*(_DWORD *)(a1 + 40) & 0x800000) != 0 )
  {
    if ( (unsigned int)dword_1C00691F8 > 5
      && (qword_1C0069208 & 0x200000000004LL) != 0
      && (qword_1C0069210 & 0x200000000004LL) == qword_1C0069210 )
    {
      v34 = 1LL;
      v37 = &v34;
      v17 = -1LL;
