/*
 * XREFs of HUBPDO_InvokePortPLDRRecovery @ 0x1C00807C8
 * Callers:
  ...
  if ( DeviceResetInterface >= 0 )
  {
    if ( v19[4] )
    {
      ...
      else
      {
        ...
        v24 = 2LL;
        v21 = v18;
        v8 = (unsigned __int8 *)&unk_1C0065979;
        v16[0] = *(_WORD *)(v4 + 1996);
        v23 = v16;
        v15[0] = *(_WORD *)(v4 + 1998);
        v25 = v15;
    ...
    v18[0] = 16779264LL;
    v30 = 12LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00691F8, v8, v10, 0LL, v13, &v20);
LABEL_29:
