/*
 * XREFs of _tlgWriteAgg @ 0x1C00446AC
 * Callers:
 ...
 * Callees:
 *     InsertEventEntryInLookUpTable @ 0x1C00440F8 (InsertEventEntryInLookUpTable.c)
 */
        ...
        struct _EVENT_DATA_DESCRIPTOR *UserData)
{
  ...
  *(_DWORD *)&EventDescriptor.Level = *(unsigned __int16 *)(a2 + 1);
  ...
  UserData->Ptr = (unsigned __int64)off_1C0069200;
  UserData->Size = *(unsigned __int16 *)off_1C0069200;
  UserData->Reserved = 2;
  UserData[1].Ptr = (unsigned __int64)v6;
  UserData[1].Size = *v6;
  UserData[1].Reserved = 1;
  result = -1073741811;
  if ( (void (__fastcall *)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))qword_1C0069220 == TlgAggregateInternalRegisteredProviderEtwCallback )
  {
    Ptr = UserData[1].Ptr;
    v9 = 0;
...
LABEL_17:
    if ( v9 )
      ...
      return EtwWriteTransfer(qword_1C0069218, &EventDescriptor, 0LL, 0LL, a4, UserData);
  }
  return result;
}
