/*
 * XREFs of HUBDTX_GetConfigDescriptorWithDefaultSizeUsingControlTransfer @ 0x1C002A894
 * Callers:
 *     HUBDSM_GettingConfigDescriptorWhileRenuemrating @ 0x1C00211E0 (HUBDSM_GettingConfigDescriptorWhileRenuemrating.c)
 * Callees:
