/*
 * XREFs of HUBMISC_LogDescriptorValidationWarningForHub @ 0x1C0033FF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBMISC_LogDescriptorValidationWarningForHub(__int64 a1)
{
  ...
  if ( a1 )
  {
    result = BYTE2(WPP_MAIN_CB.Queue.Wcb.NumberOfChannels);
    if ( (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 0x800000) != 0 )
