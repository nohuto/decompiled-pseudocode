/*
 * XREFs of HUBPDO_ReportDeviceFailure @ 0x1C001B478
 * Callers:
 *     HUBDSM_MarkingUnknownDeviceAsFailed @ 0x1C00233D0 (HUBDSM_MarkingUnknownDeviceAsFailed.c)
 * Callees:
 ...
 *     _tlgWriteAgg @ 0x1C00446AC (_tlgWriteAgg.c)
...
LABEL_55:
  if ( LOBYTE(v70[0]) )
  {
    if ( (unsigned int)dword_1C00691F8 > 5
      && (qword_1C0069208 & 0x400000000002LL) != 0
      && (qword_1C0069210 & 0x400000000002LL) == qword_1C0069210 )
    {
      LOWORD(v73) = v11;
      v84 = &v81;
      v81 = 1LL;
...
LABEL_150:
  ...
  else if ( (unsigned int)dword_1C00691F8 > 5
         && (qword_1C0069208 & 0x200000000002LL) != 0
         && (qword_1C0069210 & 0x200000000002LL) == qword_1C0069210 )
  {
    LOWORD(v73) = v11;
    v84 = &v82;
    v82 = 1LL;
