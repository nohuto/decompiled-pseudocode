/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1C0041338
 * Callers:
...
__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
  ...
  if ( Pool2 )
  {
    ...
    qword_1C006CDA8 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0073040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0073008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0073078);
