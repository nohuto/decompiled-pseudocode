/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionAttributes @ 0x1C007520C
 * Callers:
...
LABEL_9:
  ...
  {
    v19 = v10;
    WPP_RECORDER_SF_d(v9[315], 2u, 3u, 0x2Au, (__int64)&WPP_40970fddd6f13ebcbe770d49258f843c_Traceguids, v19);
  }
LABEL_10:
