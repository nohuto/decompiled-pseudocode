/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSContainerIdDescriptorHeader @ 0x1C002C4E0
 * Callers:
 *     HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor @ 0x1C0021DC0 (HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor.c)
 * Callees:
