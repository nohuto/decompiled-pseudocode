/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSExtendedConfigDescriptor @ 0x1C002C858
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedConfigDescriptor @ 0x1C0021EE0 (HUBDSM_ValidatingMSOSExtendedConfigDescriptor.c)
 * Callees:
