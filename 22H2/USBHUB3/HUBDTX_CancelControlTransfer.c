/*
 * XREFs of HUBDTX_CancelControlTransfer @ 0x1C002A820
 * Callers:
 *     HUBDSM_CancellingControlTransferOnHubStopInRemainingDescriptors @ 0x1C0020F90 (HUBDSM_CancellingControlTransferOnHubStopInRemainingDescriptors.c)
 * Callees:
