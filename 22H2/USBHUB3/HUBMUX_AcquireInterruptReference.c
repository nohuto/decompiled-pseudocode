/*
 * XREFs of HUBMUX_AcquireInterruptReference @ 0x1C0010E0C
 * Callers:
 *     HUBPSM30_AcquiringInterruptReferenceOnHSMInEnabled @ 0x1C0011940 (HUBPSM30_AcquiringInterruptReferenceOnHSMInEnabled.c)
 * Callees:
 *     <none>
 */
