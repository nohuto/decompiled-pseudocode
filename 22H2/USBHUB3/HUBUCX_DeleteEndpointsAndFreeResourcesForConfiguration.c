/*
 * XREFs of HUBUCX_DeleteEndpointsAndFreeResourcesForConfiguration @ 0x1C00286A8
 * Callers:
 *     HUBDSM_CleaningUpAnyExistingConfigurationOnStart @ 0x1C001F1A0 (HUBDSM_CleaningUpAnyExistingConfigurationOnStart.c)
 *     HUBDSM_CompletingClientUnconfigureRequest @ 0x1C001F2D0 (HUBDSM_CompletingClientUnconfigureRequest.c)
 *     HUBDSM_CompletingClientUnconfigureRequestWithFailure @ 0x1C001F310 (HUBDSM_CompletingClientUnconfigureRequestWithFailure.c)
 ...
 *     HUBDSM_DeletingEndpointsForOldConfiguration @ 0x1C0023BA0 (HUBDSM_DeletingEndpointsForOldConfiguration.c)
 * Callees:
