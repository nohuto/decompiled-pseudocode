/*
 * XREFs of WerKernelCreateReport @ 0x1C0041D1C
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C0086794 (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpCreateRegistryKey @ 0x1C0041768 (WerpCreateRegistryKey.c)
 *     CheckSpaceAvailable @ 0x1C0041BBC (CheckSpaceAvailable.c)
 */
