/*
 * XREFs of HUBIDLE_AddEvent @ 0x1C003E9A4
 * Callers:
 ...
 *     HUBIDLE_CancelIdle @ 0x1C003EEB0 (HUBIDLE_CancelIdle.c)
    ...
    if ( v20 )
    {
      ...
      if ( v21 )
      {
        ...
        if ( v22 )
        {
          ...
          {
            if ( a3 && *(_QWORD *)&WPP_MAIN_CB.AlignmentRequirement )
              (*(void (__fastcall **)(IRP *, GUID *))&WPP_MAIN_CB.AlignmentRequirement)(a3, &v38);
...
LABEL_56:
  if ( v6 )
  {
    ...
    if ( *(_QWORD *)&WPP_MAIN_CB.AlignmentRequirement )
      (*(void (__fastcall **)(IRP *, GUID *))&WPP_MAIN_CB.AlignmentRequirement)(v6, &v38);
    if ( (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 0x400) != 0 )
    {
      LODWORD(v31) = v9;
