/*
 * XREFs of USBD_CreateHandle @ 0x1C004236C
 * Callers:
 *     HUBFDO_SetupHubPostErrataQuery @ 0x1C000EF38 (HUBFDO_SetupHubPostErrataQuery.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C0041BA8 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
