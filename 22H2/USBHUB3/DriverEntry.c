/*
 * XREFs of DriverEntry @ 0x1C0092234
 * Callers:
 ...
 *     InitializeTelemetryAssertsKMByDriverObject @ 0x1C004140C (InitializeTelemetryAssertsKMByDriverObject.c)
      ...
      if ( v4 >= 0 )
      {
        ...
        *(_QWORD *)(v6 + 16) = v6 + 16;
        ...
        if ( v4 >= 0 )
        {
          ...
          *(_QWORD *)&WPP_MAIN_CB.AlignmentRequirement = MmGetSystemRoutineAddress(&DestinationString);
          ...
          {
            ((void (__fastcall *)(const wchar_t *, const wchar_t *, __int64 *))WPP_MAIN_CB.Queue.ListEntry.Blink)(
          ...
          imp_WppRecorderGetTriageInfo(WPP_GLOBAL_Control, &WPP_MAIN_CB.Queue.Wcb.DeviceObject);
          qword_1C006C700 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 3448))(WdfDriverGlobals);
          dword_1C006C6D0 = (int)WPP_MAIN_CB.Queue.Wcb.DeviceObject;
          qword_1C006C6D4 = (__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp;
          dword_1C006C6DC = HIDWORD(WPP_MAIN_CB.Queue.Wcb.DeviceObject);
          dword_1C006C6E0 = (int)WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc;
