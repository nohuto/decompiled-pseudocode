/*
 * XREFs of ??1?$unique_ptr@VCEndpointVolumeState@@U?$default_delete@VCEndpointVolumeState@@@std@@@std@@QEAA@XZ @ 0x18002F3B8
 * Callers:
 *     _CEndpointVolumeStateManager::AddEndpointVolumeReference_::_1_::dtor$3 @ 0x18003C96B (_CEndpointVolumeStateManager--AddEndpointVolumeReference_--_1_--dtor$3.c)
 * Callees:
