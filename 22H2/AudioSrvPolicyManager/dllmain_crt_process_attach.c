/*
 * XREFs of dllmain_crt_process_attach @ 0x180039388
 * Callers:
 ...
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18003A284 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x18003A2AC (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18003A2D0 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18003A2F0 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18003A444 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18003A686 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18003A692 (_initterm_e_0.c)
