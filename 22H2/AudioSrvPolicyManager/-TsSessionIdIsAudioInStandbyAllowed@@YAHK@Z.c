/*
 * XREFs of ?TsSessionIdIsAudioInStandbyAllowed@@YAHK@Z @ 0x1800298F4
 * Callers:
 *     ?GetSessionDisplayPolicyVolume@CProcess@@UEAAMXZ @ 0x180016AA0 (-GetSessionDisplayPolicyVolume@CProcess@@UEAAMXZ.c)
 * Callees:
...
__int64 __fastcall TsSessionIdIsAudioInStandbyAllowed(DWORD a1)
{
  ...
  if ( !(unsigned int)TsSessionFromSessionId(a1, 0, 0LL, &v13) )
  {
    ...
    if ( *v5 > 4u )
    {
      ...
      v15 = &v12;
      v16 = 4LL;
      tlgWriteTransfer_EventWriteTransfer((__int64)v5, (unsigned __int8 *)dword_1800465B8, 0LL, 0LL, 8u, &v14);
    }
  }
  if ( v3 )
