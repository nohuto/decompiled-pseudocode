/*
 * XREFs of ?OnPowerResumeSuspend@CWindowsPolicyManager@@UEAAJH@Z @ 0x180008510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowsPolicyManager::OnPowerResumeSuspend(CWindowsPolicyManager *this, int a2)
{
  ...
  if ( a2 != g_bApmSuspended )
  {
    ...
    if ( *v5 > 4u )
    {
      ...
      v14 = 4;
      v11 = 4;
      tlgWriteTransfer_EventWriteTransfer((__int64)v5, (unsigned __int8 *)dword_180045DC9, 0LL, 0LL, 4u, &v9);
    }
