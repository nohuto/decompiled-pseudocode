/*
 * XREFs of ?UpdateEndpointVolume@CApplicationManager@@QEAAJPEBGHMHH@Z @ 0x1800203F4
 * Callers:
 ...
 *     WPP_SF_Sg @ 0x18001A700 (WPP_SF_Sg.c)
...
LABEL_17:
  ...
  if ( a5 )
  {
    ...
    {
      v16 = a6;
      WPP_SF_Sd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x38u, &WPP_386a857d2e283c5fe15986819513c374_Traceguids, a2, v16);
    }
