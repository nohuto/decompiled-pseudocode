/*
 * XREFs of ?Log_CaughtException@in1diag3@details@wil@@YAJPEAXIPEBD@Z @ 0x18001A1BC
 * Callers:
 *     _CApplication::NotifyVolumePolicyChange_::_1_::catch$3 @ 0x18003BA7A (_CApplication--NotifyVolumePolicyChange_--_1_--catch$3.c)
 * Callees:
