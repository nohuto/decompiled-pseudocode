/*
 * XREFs of ?NotifyPLM@CProcess@@QEAAXW4_PLM_EXEMPTION@@@Z @ 0x180015E4C
 * Callers:
...
LABEL_48:
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x35u, &WPP_8ab93343ef2e3d885d031f030701e2ed_Traceguids, Instance);
  }
  AudPolicyLogError("CProcess::NotifyPLM", 3727, Instance);
}
