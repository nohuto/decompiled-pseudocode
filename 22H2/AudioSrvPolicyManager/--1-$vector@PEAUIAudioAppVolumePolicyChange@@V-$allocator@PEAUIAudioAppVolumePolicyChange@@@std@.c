/*
 * XREFs of ??1?$vector@PEAUIAudioAppVolumePolicyChange@@V?$allocator@PEAUIAudioAppVolumePolicyChange@@@std@@@std@@QEAA@XZ @ 0x1800177C8
 * Callers:
 *     _CApplication::NotifyVolumePolicyChange_::_1_::dtor$0 @ 0x18003BA56 (_CApplication--NotifyVolumePolicyChange_--_1_--dtor$0.c)
 * Callees:
