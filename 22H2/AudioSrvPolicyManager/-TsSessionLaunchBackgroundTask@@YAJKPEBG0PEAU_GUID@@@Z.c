/*
 * XREFs of ?TsSessionLaunchBackgroundTask@@YAJKPEBG0PEAU_GUID@@@Z @ 0x180029174
 * Callers:
...
LABEL_3:
    *a4 = GUID_00000000_0000_0000_0000_000000000000;
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_e1a7a5e290533704050c869bb9bcb4b5_Traceguids, v10);
    }
    goto LABEL_7;
  }
