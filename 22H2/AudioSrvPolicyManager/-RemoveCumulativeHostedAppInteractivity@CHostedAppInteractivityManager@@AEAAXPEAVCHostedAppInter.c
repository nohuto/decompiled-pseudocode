...
LABEL_4:
  ...
  if ( v3 )
  {
    if ( v3 == qword_18004FF68 )
      qword_18004FF68 = *(_QWORD *)v3;
    else
      **(_QWORD **)(v3 + 8) = *(_QWORD *)v3;
    if ( v3 == (_QWORD)xmmword_18004FF70 )
      *(_QWORD *)&xmmword_18004FF70 = *(_QWORD *)(v3 + 8);
    else
      *(_QWORD *)(*(_QWORD *)v3 + 8LL) = *(_QWORD *)(v3 + 8);
    *(_QWORD *)v3 = *((_QWORD *)&xmmword_18004FF80 + 1);
    v4 = (*((_QWORD *)&xmmword_18004FF70 + 1))-- == 1LL;
    *((_QWORD *)&xmmword_18004FF80 + 1) = v3;
    if ( v4 )
      ATL::CAtlList<CHostedAppInteractivity *,ATL::CElementTraits<CHostedAppInteractivity *>>::RemoveAll(&qword_18004FF68);
    if ( a2 )
    {
      if ( *a2 )
      {
