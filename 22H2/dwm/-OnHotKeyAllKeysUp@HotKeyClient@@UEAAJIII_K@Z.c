/*
 * XREFs of ?OnHotKeyAllKeysUp@HotKeyClient@@UEAAJIII_K@Z @ 0x14000AF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HotKeyClient::OnHotKeyAllKeysUp(
        HotKeyClient *this,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        unsigned __int64 a5)
{
  ...
  v5 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 6) + 32LL))(*((_QWORD *)this + 6));
  if ( v5 < 0 )
