/*
 * XREFs of ??0CWatsonErrorReporting@BlackScreenDiagnostics@@QEAA@PEBG00@Z @ 0x140009B04
 * Callers:
        ...
        const unsigned __int16 *a4)
{
  ...
  *((_BYTE *)this + 8) = IsWerReportCreatePresent() != 0;
  std::wstring::wstring((char *)this + 16, L"WindowsBlackScreenDiagnosticsV1", v5);
  std::wstring::wstring((char *)this + 48, L"Black Screen - User Reported", v6);
  std::wstring::wstring(
    (char *)this + 80,
