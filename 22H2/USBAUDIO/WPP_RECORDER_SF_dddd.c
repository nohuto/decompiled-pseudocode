/*
 * XREFs of WPP_RECORDER_SF_DDDD @ 0x1C0007878
 * Callers:
...
__int64 WPP_RECORDER_SF_DDDD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10) != 0 )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, __int64, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v7) = 10;
  return WppAutoLogTrace(a1, 0LL, 5LL, a5, v7, (__int64 *)va);
}
