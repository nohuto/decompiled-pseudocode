/*
 * XREFs of ?GetMutePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000C0D0
 * Callers:
 ...
 *     PropertyGetBooleanBasicSupportSideband @ 0x1C0028F78 (PropertyGetBooleanBasicSupportSideband.c)
 */
