/*
 * XREFs of USBHwSelectStreamingAudioInterfaceSideband @ 0x1C002D75C
 * Callers:
 ...
 *     USBD_GetEndpointOffloadInformationForIndex @ 0x1C0011540 (USBD_GetEndpointOffloadInformationForIndex.c)
