/*
 * XREFs of USBDeviceStop @ 0x1C002C5B0
 * Callers:
 *     USBDeviceSurpriseRemove @ 0x1C002C690 (USBDeviceSurpriseRemove.c)
 * Callees:
 ...
 *     USBHwStopAllMIDIPipes @ 0x1C002E364 (USBHwStopAllMIDIPipes.c)
 */
