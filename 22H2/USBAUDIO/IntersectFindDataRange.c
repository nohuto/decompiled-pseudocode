/*
 * XREFs of IntersectFindDataRange @ 0x1C0025B8C
 * Callers:
 *     PinDataFormatIntersection @ 0x1C0024E10 (PinDataFormatIntersection.c)
 * Callees:
 *     IntersectFindBestMatch @ 0x1C00259FC (IntersectFindBestMatch.c)
 */
