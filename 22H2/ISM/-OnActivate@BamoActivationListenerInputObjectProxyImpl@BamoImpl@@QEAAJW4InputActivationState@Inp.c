/*
 * XREFs of ?OnActivate@BamoActivationListenerInputObjectProxyImpl@BamoImpl@@QEAAJW4InputActivationState@Input@UI@Windows@@@Z @ 0x1800E8AFC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoActivationListenerInputObjectProxyImpl::OnActivate(__int64 a1, int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v9[0] = v11;
      v9[1] = v12;
      return CoreUICallSend(v7, v9, 2LL, 5LL, 0, &unk_1801C01C0, a2);
    }
    else
    {
