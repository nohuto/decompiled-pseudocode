/*
 * XREFs of ??$reset@VSpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@@?$shared_ptr@VSpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@@std@@QEAAXPEAVSpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@@Z @ 0x180156608
 * Callers:
