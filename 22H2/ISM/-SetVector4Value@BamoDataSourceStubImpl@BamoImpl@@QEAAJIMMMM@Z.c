/*
 * XREFs of ?SetVector4Value@BamoDataSourceStubImpl@BamoImpl@@QEAAJIMMMM@Z @ 0x1801448C8
 * Callers:
 *     ?CallSetVector4ValueOnStub@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@IMMMM@Z @ 0x1801427B0 (-CallSetVector4ValueOnStub@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@.c)
...
LABEL_3:
  ...
  v11[1] = v9;
  v8 = 4;
  return CoreUICallSend(v10, v11, 2LL, 5LL, v8, &unk_1801C18C8, a2);
}
