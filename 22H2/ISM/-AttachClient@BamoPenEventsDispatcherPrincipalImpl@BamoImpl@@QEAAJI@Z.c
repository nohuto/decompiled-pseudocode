/*
 * XREFs of ?AttachClient@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180132ABC
 * Callers:
 *     ?Thunk_AttachClient_10@?$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180134C80 (-Thunk_AttachClient_10@-$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipal.c)
 * Callees:
