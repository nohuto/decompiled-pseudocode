/*
 * XREFs of ?EnableGamepadExclusivityForProcess@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180107C0C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerProxyImpl::EnableGamepadExclusivityForProcess(
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 3;
      return CoreUICallSend(v8, v10, 2LL, 3LL, v9, &unk_1801C2969, a2);
    }
    else
    {
