/*
 * XREFs of ?Materialize_BamoSystemButtonEventControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E8410
 * Callers:
 *     ?Thunk_Materialize_BamoSystemButtonEventControllerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED0D0 (-Thunk_Materialize_BamoSystemButtonEventControllerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receiv.c)
 * Callees:
