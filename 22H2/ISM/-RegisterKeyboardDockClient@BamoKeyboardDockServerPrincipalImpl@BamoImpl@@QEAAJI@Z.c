/*
 * XREFs of ?RegisterKeyboardDockClient@BamoKeyboardDockServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1801275B8
 * Callers:
 *     ?Thunk_RegisterKeyboardDockClient_10@?$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128280 (-Thunk_RegisterKeyboardDockClient_10@-$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockSer.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoKeyboardDockServerPrincipalImpl::RegisterKeyboardDockClient(
        BamoImpl::BamoKeyboardDockServerPrincipalImpl *this,
        unsigned int a2)
{
  int v4; // ecx
  _QWORD *i; // rbx
  ...
  v12 = (*(__int64 (__fastcall **)(char *, __int64, char *))(*((_QWORD *)this - 2) + 72LL))((char *)this - 16, v6, v11);
  if ( v12 < 0 )
