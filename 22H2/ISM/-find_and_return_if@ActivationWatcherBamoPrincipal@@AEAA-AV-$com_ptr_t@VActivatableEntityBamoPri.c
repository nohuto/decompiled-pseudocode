/*
 * XREFs of ?find_and_return_if@ActivationWatcherBamoPrincipal@@AEAA?AV?$com_ptr_t@VActivatableEntityBamoPrincipal@@Uerr_exception_policy@wil@@@wil@@V?$function@$$A6A_NPEAVActivatableEntityBamoPrincipal@@@Z@std@@@Z @ 0x180047070
 * Callers:
 ...
 *     ?GetForegroundThreadId@ForegroundManager@@UEAAIXZ @ 0x180104A50 (-GetForegroundThreadId@ForegroundManager@@UEAAIXZ.c)
