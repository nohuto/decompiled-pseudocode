/*
 * XREFs of ??1ControllerNavigationManager@@UEAA@XZ @ 0x18011C8D0
 * Callers:
 *     ??_GControllerNavigationManager@@UEAAPEAXI@Z @ 0x18011CA60 (--_GControllerNavigationManager@@UEAAPEAXI@Z.c)
 * Callees:
