/*
 * XREFs of ??1?$list@U?$pair@QEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@V?$allocator@U?$pair@QEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@@2@@std@@QEAA@XZ @ 0x18012ED30
 * Callers:
 *     _std::_Hash_std::_Umap_traits_void___wil::com_ptr_t_PenDevice_wil::err_exception_policy__std::_Uhash_compare_void___std::hash_void____std::equal_to_void______std::allocator_std::pair_void___const_wil::com_ptr_t_PenDevice_wil::err_exception_policy______0___::_Hash_std::_Umap_traits_void___wil::com_ptr_t_PenDevice_wil::err_exception_policy__std::_Uhash_compare_void___std::hash_void____std::equal_to_void______std::allocator_std::pair_void___const_wil::com_ptr_t_PenDevice_wil::err_exception_policy______0____::_1_::dtor$0 @ 0x18012EB80 (_std--_Hash_std--_Umap_traits_void___wil--com_ptr_t_PenDevice_wil--err_exception_po_ea_18012EB80.c)
 * Callees:
