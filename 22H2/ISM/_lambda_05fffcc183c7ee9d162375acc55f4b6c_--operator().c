/*
 * XREFs of _lambda_05fffcc183c7ee9d162375acc55f4b6c_::operator() @ 0x1801583C8
 * Callers:
...
LARGE_INTEGER __fastcall lambda_05fffcc183c7ee9d162375acc55f4b6c_::operator()(__int64 a1, _QWORD *a2)
{
  ...
  *(_BYTE *)(v5[0] + 104LL) = ***(_BYTE ***)a1 != 0;
  QueryPerformanceCounter(&PerformanceCount);
  result = PerformanceCount;
  v3[14] = PerformanceCount;
  return result;
}
