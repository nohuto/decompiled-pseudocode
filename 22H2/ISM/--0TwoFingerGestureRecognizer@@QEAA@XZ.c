/*
 * XREFs of ??0TwoFingerGestureRecognizer@@QEAA@XZ @ 0x1801855C4
 * Callers:
 *     ??0GestureSession@@AEAA@XZ @ 0x180182AD4 (--0GestureSession@@AEAA@XZ.c)
 * Callees:
 *     ?StaticInitConfig@GestureRecognizer@@KAXXZ @ 0x180185AA4 (-StaticInitConfig@GestureRecognizer@@KAXXZ.c)
 *     ??0TwoFingerClickRecognizer@@QEAA@XZ @ 0x1801862BC (--0TwoFingerClickRecognizer@@QEAA@XZ.c)
 */
