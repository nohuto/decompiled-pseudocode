/*
 * XREFs of ??1?$_Tree_node_scoped_ptr@V?$allocator@U?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UDisplayOcclusionRect@@@std@@PEAX@std@@@std@@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBUDockInputIdentity@@UDisplayOcclusionRect@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x180146DC0
 * Callers:
 *     _std::variant_std::monostate_InputConfigContextMessage_DisplayOcclusionContextMessage_VirtualTouchpadContextMessage_::operator__DisplayOcclusionContextMessage_&_0__::_1_::dtor$12 @ 0x180146282 (_std--variant_std--monostate_InputConfigContextMessage_DisplayOcclusionContextMessage_VirtualTou.c)
 * Callees:
