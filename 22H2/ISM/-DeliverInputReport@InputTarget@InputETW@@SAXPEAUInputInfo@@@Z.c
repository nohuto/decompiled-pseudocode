/*
 * XREFs of ?DeliverInputReport@InputTarget@InputETW@@SAXPEAUInputInfo@@@Z @ 0x1800B6CE8
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@U?$_tlgWrapperByVal@$03@@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@3AEBU?$_tlgWrapperByVal@$03@@3@Z @ 0x18008709C (--$Write@U-$_tlgWrapperByVal@$07@@U1@U-$_tlgWrapperByVal@$03@@U1@@-$_tlgWriteTemplate@$$A6AJPEBU.c)
 */
  ...
  if ( InputETW::IsVerboseEnabled(1LL) )
  {
    ...
    if ( InputETW::IsVerboseEnabled(2LL) )
    {
      ...
      if ( *v8 > 5u && tlgKeywordOn(v7[1], 1LL) )
      {
        ...
        v16 = &v12;
        tlgWriteTransfer_EventWriteTransfer((__int64)v8, (unsigned __int8 *)dword_1801CB817, 0LL, 0LL, 3u, &v15);
      }
    }
  }
}
