/*
 * XREFs of ?UpdateLastInputTimestamp@InputStateManager@@AEAAXPEAUInputInfo@@@Z @ 0x180087EC4
 * Callers:
 ...
 *     ?TranslateInputType@InputStateManager@@AEAA?AW4_LINP_SOURCE@@W4InputType@@@Z @ 0x180087E70 (-TranslateInputType@InputStateManager@@AEAA-AW4_LINP_SOURCE@@W4InputType@@@Z.c)
 */
...
void __fastcall InputStateManager::UpdateLastInputTimestamp(InputStateManager *this, struct InputInfo *a2)
{
  ...
  v9 = ((*(_DWORD *)a2 & *((_DWORD *)this + 46)) != 0 ? 3 : 1) | 4;
  if ( (*(_DWORD *)a2 & *((_DWORD *)this + 47)) == 0 )
    v9 = (*(_DWORD *)a2 & *((_DWORD *)this + 46)) != 0 ? 3 : 1;
  if ( *((_BYTE *)a2 + 49) )
  {
    v9 &= ~1u;
  }
