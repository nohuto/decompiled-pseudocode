/*
 * XREFs of ?UpdateDeviceTransformsFromInputConfig@GazeProcessor@@IEAAJPEAUInputConfigContextMessage@@@Z @ 0x180189380
 * Callers:
 *     ?OnDeviceUpdate@GazeProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x180188D00 (-OnDeviceUpdate@GazeProcessor@@UEAAJPEAUDeviceInfo@@@Z.c)
 *     ?OnSystemContextNotification@GazeProcessor@@UEAAJPEAV?$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusionContextMessage@@UVirtualTouchpadContextMessage@@@std@@@Z @ 0x1801890B0 (-OnSystemContextNotification@GazeProcessor@@UEAAJPEAV-$variant@Umonostate@std@@UInputConfigConte.c)
 * Callees:
