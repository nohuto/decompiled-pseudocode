/*
 * XREFs of ?SetVector2Value@BamoDataSourceStubImpl@BamoImpl@@QEAAJIMM@Z @ 0x18014456C
 * Callers:
 *     ?CallSetVector2ValueOnStub@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@IMM@Z @ 0x180142710 (-CallSetVector2ValueOnStub@BamoDataSourcePrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@.c)
...
LABEL_3:
  ...
  v11[1] = v9;
  v8 = 2;
  return CoreUICallSend(v10, v11, 2LL, 5LL, v8, &unk_1801C18BD, a2);
}
