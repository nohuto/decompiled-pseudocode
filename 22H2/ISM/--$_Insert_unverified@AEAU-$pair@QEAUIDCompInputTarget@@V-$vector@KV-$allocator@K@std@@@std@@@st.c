/*
 * XREFs of ??$_Insert_unverified@AEAU?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@@std@@@std@@@2@@?$_Hash@V?$_Umap_traits@PEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@V?$_Uhash_compare@PEAUIDCompInputTarget@@UDCompTargetHash@@UDCompTargetEqual@@@3@V?$allocator@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@@3@$0A@@std@@@std@@IEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@@std@@@std@@@std@@_N@1@AEAU?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@1@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@QEAUIDCompInputTarget@@V?$vector@KV?$allocator@K@std@@@std@@@std@@@std@@@std@@@1@@Z @ 0x1800ADB10
 * Callers:
 ...
 *     ??R?$_Uhash_compare@PEAUIDCompInputTarget@@UDCompTargetHash@@UDCompTargetEqual@@@std@@QEBA_NAEBQEAUIDCompInputTarget@@0@Z @ 0x1800AF0E0 (--R-$_Uhash_compare@PEAUIDCompInputTarget@@UDCompTargetHash@@UDCompTargetEqual@@@std@@QEBA_NAEBQ.c)
        ...
        __int64 *a4)
{
  ...
  __int64 v23; // r8
  __int64 v24; // rax
  __int64 v25; // [rsp+20h] [rbp-A8h] BYREF
  _QWORD *v26; // [rsp+28h] [rbp-A0h]
  _BYTE v27[40]; // [rsp+30h] [rbp-98h] BYREF
  _BYTE v28[40]; // [rsp+58h] [rbp-70h] BYREF

  v26 = a1;
  v8 = *a3;
  LODWORD(v25) = *(_DWORD *)(*(__int64 (__fastcall **)(_QWORD, _BYTE *))(*(_QWORD *)*a3 + 72LL))(*a3, v27);
  appended = std::_Fnv1a_append_bytes((unsigned int)v25, (const unsigned __int8 *const)&v25, 4uLL);
  LODWORD(v25) = *(_DWORD *)((*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v8 + 72LL))(v8, v28) + 4);
  v10 = (appended ^ (2 * std::_Fnv1a_append_bytes((unsigned int)v25, (const unsigned __int8 *const)&v25, 4uLL))) & a1[6];
