/*
 * XREFs of ?GetDevices@BamoPenDeviceManagerPrincipal@@UEAAPEAVBamoList_PenDevicePrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@XZ @ 0x18001B820
 * Callers:
 *     ?GetWindowId@MPCFocusTarget@@WEA@EAA_KXZ @ 0x18004BB10 (-GetWindowId@MPCFocusTarget@@WEA@EAA_KXZ.c)
 * Callees:
 *     <none>
 */
