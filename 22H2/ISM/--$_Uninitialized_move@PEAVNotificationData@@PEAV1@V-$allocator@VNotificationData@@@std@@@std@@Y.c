/*
 * XREFs of ??$_Uninitialized_move@PEAVNotificationData@@PEAV1@V?$allocator@VNotificationData@@@std@@@std@@YAPEAVNotificationData@@QEAV1@0PEAV1@AEAV?$allocator@VNotificationData@@@0@@Z @ 0x180068A2C
 * Callers:
