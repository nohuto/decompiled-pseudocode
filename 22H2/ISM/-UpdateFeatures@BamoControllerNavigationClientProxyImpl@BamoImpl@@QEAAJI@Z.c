/*
 * XREFs of ?UpdateFeatures@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18011ECE4
 * Callers:
 ...
 *     ?Thunk_UpdateFeatures_10@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011EAA0 (-Thunk_UpdateFeatures_10@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationCli.c)
 * Callees:
