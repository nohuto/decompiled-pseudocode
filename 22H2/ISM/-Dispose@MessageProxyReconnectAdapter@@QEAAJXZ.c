/*
 * XREFs of ?Dispose@MessageProxyReconnectAdapter@@QEAAJXZ @ 0x1800BEB98
 * Callers:
 *     ?UnInitialize@InputServiceProxy@@UEAAJXZ @ 0x180104410 (-UnInitialize@InputServiceProxy@@UEAAJXZ.c)
 *     ??1CursorManager@@MEAA@XZ @ 0x180186CF8 (--1CursorManager@@MEAA@XZ.c)
 *     ?Dispose@TextInputStateAdapter@@UEAAJXZ @ 0x1801A2900 (-Dispose@TextInputStateAdapter@@UEAAJXZ.c)
 * Callees:
