/*
 * XREFs of ??0InfoMetadata@@QEAA@XZ @ 0x1801A457C
 * Callers:
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_ce8a15022103a02b96acfc2f7dcf1bbe_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x1801A40B0 (--$_Callback_once@V-$tuple@$$QEAV_lambda_ce8a15022103a02b96acfc2f7dcf1bbe_@@AEAVexception_ptr@st.c)
 * Callees:
