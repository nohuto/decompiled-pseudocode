/*
 * XREFs of ??_GMPCFocusTarget@@UEAAPEAXI@Z @ 0x1800BA0E0
 * Callers:
 *     ??_EMPCFocusTarget@@W7EAAPEAXI@Z @ 0x18004BAB0 (--_EMPCFocusTarget@@W7EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1MPCTarget@@UEAA@XZ @ 0x1800BA948 (--1MPCTarget@@UEAA@XZ.c)
 */
