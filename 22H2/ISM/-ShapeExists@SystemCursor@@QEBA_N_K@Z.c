/*
 * XREFs of ?ShapeExists@SystemCursor@@QEBA_N_K@Z @ 0x18013D180
 * Callers:
 ...
 *     ?GetAndValidateDefaultShapeId@SystemCursor@@QEAA_KXZ @ 0x18013FE50 (-GetAndValidateDefaultShapeId@SystemCursor@@QEAA_KXZ.c)
