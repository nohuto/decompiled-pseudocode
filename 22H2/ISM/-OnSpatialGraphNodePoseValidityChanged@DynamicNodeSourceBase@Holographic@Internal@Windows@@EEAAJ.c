/*
 * XREFs of ?OnSpatialGraphNodePoseValidityChanged@DynamicNodeSourceBase@Holographic@Internal@Windows@@EEAAJAEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_VALIDITY_FLAGS@@@Z @ 0x180161750
 * Callers:
 *     <none>
 * Callees:
