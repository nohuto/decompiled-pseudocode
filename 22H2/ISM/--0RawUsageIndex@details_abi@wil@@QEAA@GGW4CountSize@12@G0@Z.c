/*
 * XREFs of ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x180011ECC
 * Callers:
 ...
 * Callees:
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x180011F50 (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
 */
