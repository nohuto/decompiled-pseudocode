/*
 * XREFs of ??$MakeAndInitialize@VTextInputStateAdapter@@UITextInputStateAdapter@@AEAPEAUITextInputStateAdapterOwner@@@Details@WRL@Microsoft@@YAJPEAPEAUITextInputStateAdapter@@AEAPEAUITextInputStateAdapterOwner@@@Z @ 0x1801A26A0
 * Callers:
 ...
 *     ??0TextInputStateAdapter@@QEAA@XZ @ 0x1801A2760 (--0TextInputStateAdapter@@QEAA@XZ.c)
