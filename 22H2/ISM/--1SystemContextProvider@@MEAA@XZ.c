/*
 * XREFs of ??1SystemContextProvider@@MEAA@XZ @ 0x180147964
 * Callers:
 *     ??_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z @ 0x180145A90 (--_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z.c)
 *     _VirtualTouchpadContextProvider::Create_::_1_::dtor$2 @ 0x180145C8C (_VirtualTouchpadContextProvider--Create_--_1_--dtor$2.c)
