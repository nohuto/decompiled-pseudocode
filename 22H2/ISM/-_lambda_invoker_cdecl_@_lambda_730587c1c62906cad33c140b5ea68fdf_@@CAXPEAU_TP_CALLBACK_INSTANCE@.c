/*
 * XREFs of ?_lambda_invoker_cdecl_@_lambda_730587c1c62906cad33c140b5ea68fdf_@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x1801682A0
 * Callers:
 *     <none>
 * Callees:
 *     ??R?$_Func_class@X$$V@std@@QEBAXXZ @ 0x1800757C0 (--R-$_Func_class@X$$V@std@@QEBAXXZ.c)
 *     ?EnsureWorkerTimer@KeepAliveTimer@ThreadpoolTimerHelpers@@AEAAX_K@Z @ 0x1800CFE30 (-EnsureWorkerTimer@KeepAliveTimer@ThreadpoolTimerHelpers@@AEAAX_K@Z.c)
 */
