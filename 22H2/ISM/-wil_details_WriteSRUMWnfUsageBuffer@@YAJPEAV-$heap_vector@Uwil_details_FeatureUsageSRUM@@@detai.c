/*
 * XREFs of ?wil_details_WriteSRUMWnfUsageBuffer@@YAJPEAV?$heap_vector@Uwil_details_FeatureUsageSRUM@@@details_abi@wil@@@Z @ 0x18006878C
 * Callers:
 *     _lambda_5035b992506f4af81a770c5842624510_::_lambda_invoker_cdecl_ @ 0x180063930 (_lambda_5035b992506f4af81a770c5842624510_--_lambda_invoker_cdecl_.c)
 * Callees:
...
LABEL_12:
        ...
        updated = wil_details_NtUpdateWnfStateData((__int64)&unk_1801D4020, (__int64)v18, v7, v7, v15, v17[0], 1);
      }
      ++v6;
    }
