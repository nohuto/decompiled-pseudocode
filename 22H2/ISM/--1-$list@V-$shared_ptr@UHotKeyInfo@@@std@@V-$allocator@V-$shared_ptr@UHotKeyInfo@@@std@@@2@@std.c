/*
 * XREFs of ??1?$list@V?$shared_ptr@UHotKeyInfo@@@std@@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@QEAA@XZ @ 0x18019F2DC
 * Callers:
 *     _HotKeyProcessor::RegisterHotKey_::_1_::dtor$1 @ 0x1801A15F4 (_HotKeyProcessor--RegisterHotKey_--_1_--dtor$1.c)
 * Callees:
