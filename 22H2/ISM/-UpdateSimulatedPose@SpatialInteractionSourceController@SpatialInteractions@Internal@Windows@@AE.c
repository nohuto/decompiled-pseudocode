/*
 * XREFs of ?UpdateSimulatedPose@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAX_JAEBUPoseData@SpatialInteractionDevices@@PEAUISpatialGraphNodeReference@Holographic@34@AEBUMatrix4x4@Numerics@Foundation@4@3@Z @ 0x180170230
 * Callers:
 ...
 *     ?XMMatrixRTInverse@DirectX@@YQ?AUXMMATRIX@1@U21@@Z @ 0x180166E60 (-XMMatrixRTInverse@DirectX@@YQ-AUXMMATRIX@1@U21@@Z.c)
        ...
        const struct Windows::Foundation::Numerics::Matrix4x4 *a6)
{
  ...
  else
  {
    ...
    v43[0] = a2;
    v12 = (__m128)xmmword_1801C7490;
    v44 = 3;
    v13 = (__m128)xmmword_1801C74A0;
    v47 = xmmword_1801C74B0;
    v45 = xmmword_1801C7490;
    v46 = xmmword_1801C74A0;
  }
