 ...
 *     ??1?$unordered_multimap@IV?$com_ptr_t@VPenEventsClientCustomProxy@@Uerr_exception_policy@wil@@@wil@@U?$hash@I@std@@U?$equal_to@I@4@V?$allocator@U?$pair@$$CBIV?$com_ptr_t@VPenEventsClientCustomProxy@@Uerr_exception_policy@wil@@@wil@@@std@@@4@@std@@QEAA@XZ @ 0x180132890 (--1-$unordered_multimap@IV-$com_ptr_t@VPenEventsClientCustomProxy@@Uerr_exception_policy@wil@@@w.c)
 *     ??1PenEventsDispatcherPrincipal@@UEAA@XZ @ 0x180132904 (--1PenEventsDispatcherPrincipal@@UEAA@XZ.c)
 *     ??_EKeyboardModifierState@@EEAAPEAXI@Z @ 0x180136C10 (--_EKeyboardModifierState@@EEAAPEAXI@Z.c)
 *     ??1?$unordered_map@UtagMsgRoutingInfo@@PEAUIInputTarget@@URoutingInfoHash@@U?$equal_to@UtagMsgRoutingInfo@@@std@@V?$allocator@U?$pair@$$CBUtagMsgRoutingInfo@@PEAUIInputTarget@@@std@@@5@@std@@QEAA@XZ @ 0x180137A28 (--1-$unordered_map@UtagMsgRoutingInfo@@PEAUIInputTarget@@URoutingInfoHash@@U-$equal_to@UtagMsgRo.c)
 ...
 *     ?_Destroy@?$_Ref_count_obj@VCustomCursorApplication@@@std@@EEAAXXZ @ 0x18013D330 (-_Destroy@-$_Ref_count_obj@VCustomCursorApplication@@@std@@EEAAXXZ.c)
 *     ??_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z @ 0x180145A90 (--_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z.c)
 ...
 *     ??_ETouchInfoAdapter@@UEAAPEAXI@Z @ 0x180199F50 (--_ETouchInfoAdapter@@UEAAPEAXI@Z.c)
