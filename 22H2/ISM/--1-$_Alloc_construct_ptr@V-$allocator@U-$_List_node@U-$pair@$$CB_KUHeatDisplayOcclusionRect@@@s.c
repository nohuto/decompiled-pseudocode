/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_List_node@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18012C438
 * Callers:
 *     _std::list_std::pair_unsigned___int64_const__HeatDisplayOcclusionRect__std::allocator_std::pair_unsigned___int64_const__HeatDisplayOcclusionRect_____::_Insert_unsigned___int64_&_HeatDisplayOcclusionRect__::_1_::dtor$0 @ 0x18012B26E (_std--list_std--pair_unsigned___int64_const__HeatDisplayOcclusionRect__std--allocator_std--pair_.c)
 * Callees:
