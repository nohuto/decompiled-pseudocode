/*
 * XREFs of ?UpdateEnabled@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x18011EC40
 * Callers:
 ...
 *     ?Thunk_UpdateEnabled_13@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011EA90 (-Thunk_UpdateEnabled_13@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClie.c)
 * Callees:
