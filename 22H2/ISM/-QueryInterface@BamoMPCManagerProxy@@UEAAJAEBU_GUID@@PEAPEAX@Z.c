/*
 * XREFs of ?QueryInterface@BamoMPCManagerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010A7A0
 * Callers:
 *     ?QueryInterface@BamoMPCManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C4F0 (-QueryInterface@BamoMPCManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
