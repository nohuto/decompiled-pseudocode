 ...
 *     ?UnregisterKeyboardDockClient@KeyboardDockServer@@QEAAJPEAVBamoKeyboardDockClientProxy@@@Z @ 0x180128290 (-UnregisterKeyboardDockClient@KeyboardDockServer@@QEAAJPEAVBamoKeyboardDockClientProxy@@@Z.c)
 ...
 *     ?GetResult@V2PropertyRequest@Holographic@Internal@Windows@@QEBAJXZ @ 0x18015E6F4 (-GetResult@V2PropertyRequest@Holographic@Internal@Windows@@QEBAJXZ.c)
 ...
 *     ?OnInput@InteractionContext@EdgyProcessorTarget@@QEAAXPEBUPointerInputInfo@@@Z @ 0x18017B13C (-OnInput@InteractionContext@EdgyProcessorTarget@@QEAAXPEBUPointerInputInfo@@@Z.c)
 *     ?OnSwipe@EdgyProcessorTarget@@AEAA?AW4State@1@_NH@Z @ 0x18017B1A4 (-OnSwipe@EdgyProcessorTarget@@AEAA-AW4State@1@_NH@Z.c)
 *     ?QualifyEdgyInputReport@EdgyProcessorTarget@@IEAA_NPEBUPointerInputInfo@@PEAUEdgyPointerInfo@@@Z @ 0x18017B4F0 (-QualifyEdgyInputReport@EdgyProcessorTarget@@IEAA_NPEBUPointerInputInfo@@PEAUEdgyPointerInfo@@@Z.c)
 ...
 *     ?SetInteractionObject@EdgyInputTarget@@UEAAJI@Z @ 0x18017BF70 (-SetInteractionObject@EdgyInputTarget@@UEAAJI@Z.c)
 *     ?DeliverInput@ShellGesturesTarget@@UEAAJPEAUInputInfo@@@Z @ 0x18017EDB0 (-DeliverInput@ShellGesturesTarget@@UEAAJPEAUInputInfo@@@Z.c)
 *     ?GetRoutingInfo@ShellGesturesTarget@@UEBA?AUtagMsgRoutingInfo@@XZ @ 0x18017EE00 (-GetRoutingInfo@ShellGesturesTarget@@UEBA-AUtagMsgRoutingInfo@@XZ.c)
 *     ?IsSameAsTarget@ShellGesturesTarget@@UEBA_NAEBUtagMsgRoutingInfo@@@Z @ 0x18017EE30 (-IsSameAsTarget@ShellGesturesTarget@@UEBA_NAEBUtagMsgRoutingInfo@@@Z.c)
 *     ?IsSameAsTarget@ShellGesturesTarget@@UEBA_NAEBUtagMsgRoutingInfo@@PEAX@Z @ 0x18017EE60 (-IsSameAsTarget@ShellGesturesTarget@@UEBA_NAEBUtagMsgRoutingInfo@@PEAX@Z.c)
 *     ?IsSameByLuid@ShellGesturesTarget@@UEBA_NQEAX@Z @ 0x18017EE90 (-IsSameByLuid@ShellGesturesTarget@@UEBA_NQEAX@Z.c)
 *     ?SetInteractionObject@ShellGesturesTarget@@UEAAJI@Z @ 0x18017EEC0 (-SetInteractionObject@ShellGesturesTarget@@UEAAJI@Z.c)
 *     ?ShouldRedirectToManipulationThread@ShellGesturesTarget@@UEBA_NXZ @ 0x18017EEF0 (-ShouldRedirectToManipulationThread@ShellGesturesTarget@@UEBA_NXZ.c)
 *     ?OnInterestedPropertyChanged@HotkeyContextualProcessor@@UEAAJGPEBXI@Z @ 0x180180630 (-OnInterestedPropertyChanged@HotkeyContextualProcessor@@UEAAJGPEBXI@Z.c)
 ...
 *     ?Create@MPCEyeGazeProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x1801977B0 (-Create@MPCEyeGazeProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z.c)
 *     ?Create@MPCHeadProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180197D20 (-Create@MPCHeadProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z.c)
 *     ?ShouldAttachDevice@MPCHeadProcessor@@UEAA_NPEAUDeviceInfo@@@Z @ 0x180198010 (-ShouldAttachDevice@MPCHeadProcessor@@UEAA_NPEAUDeviceInfo@@@Z.c)
 ...
 *     ?OnInputReport@PTPProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x180199B40 (-OnInputReport@PTPProcessor@@UEAAJPEAUInputInfo@@@Z.c)
