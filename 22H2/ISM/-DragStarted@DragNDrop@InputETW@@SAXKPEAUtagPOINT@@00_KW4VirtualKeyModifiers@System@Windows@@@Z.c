/*
 * XREFs of ?DragStarted@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@00_KW4VirtualKeyModifiers@System@Windows@@@Z @ 0x1800F91A4
 * Callers:
...
char __fastcall InputETW::DragNDrop::DragStarted(__int64 a1, int *a2, int *a3, int *a4, __int64 a5, unsigned int a6)
{
  __int64 v7; // r14
  _QWORD *v10; // rax
  __int64 v11; // rcx
