/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_0768ca99b5f0498451ffc3dbd3bcf85b_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180197630
 * Callers:
 *     <none>
 * Callees:
