/*
 * XREFs of ??_G?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIInputServiceProxy@@UIMessageProxyReconnectAdapterOwner@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x1800AF170
 * Callers:
 *     <none>
 * Callees:
