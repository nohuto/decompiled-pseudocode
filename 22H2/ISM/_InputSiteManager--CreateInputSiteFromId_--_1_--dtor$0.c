/*
 * XREFs of _InputSiteManager::CreateInputSiteFromId_::_1_::dtor$0 @ 0x18004E481
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall InputSiteManager::CreateInputSiteFromId_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  _QWORD *result; // rax
