/*
 * XREFs of ??_GGameControllerRawInputProvider@@UEAAPEAXI@Z @ 0x180088704
 * Callers:
 *     ??_EGameControllerRawInputProvider@@WBI@EAAPEAXI@Z @ 0x18004B5B0 (--_EGameControllerRawInputProvider@@WBI@EAAPEAXI@Z.c)
 * Callees:
