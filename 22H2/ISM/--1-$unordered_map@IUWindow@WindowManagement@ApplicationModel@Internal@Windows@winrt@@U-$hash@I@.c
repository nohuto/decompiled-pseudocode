/*
 * XREFs of ??1?$unordered_map@IUWindow@WindowManagement@ApplicationModel@Internal@Windows@winrt@@U?$hash@I@std@@U?$equal_to@I@8@V?$allocator@U?$pair@$$CBIUWindow@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@std@@@8@@std@@QEAA@XZ @ 0x1800BD904
 * Callers:
 *     _ViewHierarchyWithWindowManager::ViewHierarchyWithWindowManager_::_1_::dtor$2 @ 0x18004FA58 (_ViewHierarchyWithWindowManager--ViewHierarchyWithWindowManager_--_1_--dtor$2.c)
 *     _ViewHierarchyWithWindowManager::ViewHierarchyWithWindowManager_::_1_::dtor$3 @ 0x18004FA6E (_ViewHierarchyWithWindowManager--ViewHierarchyWithWindowManager_--_1_--dtor$3.c)
 * Callees:
