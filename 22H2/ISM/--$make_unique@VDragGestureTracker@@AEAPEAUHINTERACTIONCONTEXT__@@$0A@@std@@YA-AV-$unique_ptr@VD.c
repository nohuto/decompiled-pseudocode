/*
 * XREFs of ??$make_unique@VDragGestureTracker@@AEAPEAUHINTERACTIONCONTEXT__@@$0A@@std@@YA?AV?$unique_ptr@VDragGestureTracker@@U?$default_delete@VDragGestureTracker@@@std@@@0@AEAPEAUHINTERACTIONCONTEXT__@@@Z @ 0x1800F7E88
 * Callers:
