/*
 * XREFs of ?SetForegroundActivatableEntity@ForegroundManager@@UEAAJ_KW4ACTIVATIONOBJECTSTATECHANGE_REASON@@@Z @ 0x180046CC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ConfigureForegroundOnActivationObject@ForegroundManager@@AEAAXAEBU_LUID@@_NW4ACTIVATIONOBJECTSTATECHANGE_REASON@@@Z @ 0x180046C98 (-ConfigureForegroundOnActivationObject@ForegroundManager@@AEAAXAEBU_LUID@@_NW4ACTIVATIONOBJECTST.c)
 ...
 *     ?TryFindActivatableEntity@ActivationWatcherBamoPrincipal@@QEAA?AV?$com_ptr_t@VActivatableEntityBamoPrincipal@@Uerr_exception_policy@wil@@@wil@@_K@Z @ 0x1801054B8 (-TryFindActivatableEntity@ActivationWatcherBamoPrincipal@@QEAA-AV-$com_ptr_t@VActivatableEntityB.c)
 */
