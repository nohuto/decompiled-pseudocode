/*
 * XREFs of ?UpdateInputDeliveryServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE934
 * Callers:
 ...
 *     ?Thunk_UpdateInputDeliveryServer_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED310 (-Thunk_UpdateInputDeliveryServer_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
