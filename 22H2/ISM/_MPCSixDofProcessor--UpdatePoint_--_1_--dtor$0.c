/*
 * XREFs of _MPCSixDofProcessor::UpdatePoint_::_1_::dtor$0 @ 0x180190108
 * Callers:
 *     <none>
 * Callees:
 *     ??1?$shared_ptr@VSystemCursor@@@std@@QEAA@XZ @ 0x18007D4F0 (--1-$shared_ptr@VSystemCursor@@@std@@QEAA@XZ.c)
 */
