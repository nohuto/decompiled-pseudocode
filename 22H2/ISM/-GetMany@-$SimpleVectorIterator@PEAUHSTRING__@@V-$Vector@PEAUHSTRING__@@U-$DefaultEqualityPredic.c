/*
 * XREFs of ?GetMany@?$SimpleVectorIterator@PEAUHSTRING__@@V?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$DefaultVectorOptions@PEAUHSTRING__@@@3456@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@UIntVersionTag@XWinRT@@$0A@@Internal@Collections@Foundation@Windows@@UEAAJIPEAPEAUHSTRING__@@PEAI@Z @ 0x180115620
 * Callers:
 *     <none>
 * Callees:
 *     _lambda_89c47fb2dbc65534a5fcd0a819bb7b31_::operator() @ 0x180111818 (_lambda_89c47fb2dbc65534a5fcd0a819bb7b31_--operator().c)
 *     _lambda_7642901e62d777eca27bf09ee4162e23_::operator() @ 0x180111890 (_lambda_7642901e62d777eca27bf09ee4162e23_--operator().c)
 */
