/*
 * XREFs of ??1ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ @ 0x180157A7C
 * Callers:
 ...
 *     ?GetWorkThreadId@ChainedThreadpoolWorker@ThreadHelpers@@QEAAKXZ @ 0x180049C8C (-GetWorkThreadId@ChainedThreadpoolWorker@ThreadHelpers@@QEAAKXZ.c)
 ...
 *     ?_Tidy@?$deque@V?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@V?$allocator@V?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@@2@@std@@AEAAXXZ @ 0x1801676A0 (-_Tidy@-$deque@V-$shared_ptr@V-$function@$$A6AXXZ@std@@@std@@V-$allocator@V-$shared_ptr@V-$funct.c)
 */
