/*
 * XREFs of ??1?$pair@QEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@QEAA@XZ @ 0x18012ED8C
 * Callers:
 *     _PenDeviceManager::RepopulateActiveBamoForId_::_1_::dtor$2 @ 0x180130811 (_PenDeviceManager--RepopulateActiveBamoForId_--_1_--dtor$2.c)
 * Callees:
 *     <none>
 */
