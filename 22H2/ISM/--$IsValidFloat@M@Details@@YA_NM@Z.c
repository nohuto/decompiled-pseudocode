/*
 * XREFs of ??$IsValidFloat@M@Details@@YA_NM@Z @ 0x1800C4738
 * Callers:
 ...
 *     ??$AreValidFloats@UXMFLOAT3@DirectX@@@@YA_NAEBUXMFLOAT3@DirectX@@@Z @ 0x18014E3C0 (--$AreValidFloats@UXMFLOAT3@DirectX@@@@YA_NAEBUXMFLOAT3@DirectX@@@Z.c)
