/*
 * XREFs of ??1?$map@KV?$list@UHotKeyInfo@@V?$allocator@UHotKeyInfo@@@std@@@std@@U?$less@K@2@V?$allocator@U?$pair@$$CBKV?$list@UHotKeyInfo@@V?$allocator@UHotKeyInfo@@@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x18019F308
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$9 @ 0x18019F23D (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$9.c)
 * Callees:
