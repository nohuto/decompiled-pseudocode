/*
 * XREFs of ??1?$list@UKeyEventData@VirtualHotKeyTracker@@V?$allocator@UKeyEventData@VirtualHotKeyTracker@@@std@@@std@@QEAA@XZ @ 0x1800F84A0
 * Callers:
 *     _std::_Hash_std::_Umap_traits_unsigned_long_DragNDropProcessor::PointerCache_std::_Uhash_compare_unsigned_long_std::hash_unsigned_long__std::equal_to_unsigned_long____std::allocator_std::pair_unsigned_long_const__DragNDropProcessor::PointerCache____0___::_Hash_std::_Umap_traits_unsigned_long_DragNDropProcessor::PointerCache_std::_Uhash_compare_unsigned_long_std::hash_unsigned_long__std::equal_to_unsigned_long____std::allocator_std::pair_unsigned_long_const__DragNDropProcessor::PointerCache____0____::_1_::dtor$0 @ 0x1800F8028 (_std--_Hash_std--_Umap_traits_unsigned_long_DragNDropProcessor--PointerCache_std--__ea_1800F8028.c)
 *     _VirtualHotKeyTracker::VirtualHotKeyTracker_::_1_::dtor$2 @ 0x18018019E (_VirtualHotKeyTracker--VirtualHotKeyTracker_--_1_--dtor$2.c)
 * Callees:
