/*
 * XREFs of ?XMQuaternionRotationMatrix@DirectX@@YQ?AT__m128@@UXMMATRIX@1@@Z @ 0x1800E2278
 * Callers:
...
__m128 __fastcall DirectX::XMQuaternionRotationMatrix(double a1, double a2, double a3)
{
  ...
  v7 = _mm_cmple_ps(v6, DirectX::g_XMZero);
  v8 = _mm_cmple_ps(_mm_add_ps(v5, v3), DirectX::g_XMZero);
  v9 = _mm_cmple_ps(_mm_sub_ps(v5, v3), DirectX::g_XMZero);
  v10 = _mm_add_ps(
