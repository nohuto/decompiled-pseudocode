/*
 * XREFs of ?DragEndedLegacy@DragNDrop@InputETW@@SAXKUtagPOINT@@_K010W4VirtualKeyModifiers@System@Windows@@@Z @ 0x180174EC4
 * Callers:
...
char __fastcall InputETW::DragNDrop::DragEndedLegacy(
        unsigned int a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
