/*
 * XREFs of ??1?$_List_node_insert_op@V?$allocator@U?$_List_node@UKeyEventData@VirtualHotKeyTracker@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18018127C
 * Callers:
 ...
 *     _std::list_VirtualHotKeyTracker::KeyEventData_std::allocator_VirtualHotKeyTracker::KeyEventData___::_Construct_range_unchecked_std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_VirtualHotKeyTracker::KeyEventData____std::_Iterator_base0____::_1_::dtor$0 @ 0x180180B00 (_std--list_VirtualHotKeyTracker--KeyEventData_std--allocator_VirtualHotKeyTracker--_ea_180180B00.c)
 * Callees:
