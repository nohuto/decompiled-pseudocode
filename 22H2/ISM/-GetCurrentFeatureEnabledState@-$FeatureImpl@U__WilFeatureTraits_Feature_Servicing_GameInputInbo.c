/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_GameInputInbox@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180043348
 * Callers:
