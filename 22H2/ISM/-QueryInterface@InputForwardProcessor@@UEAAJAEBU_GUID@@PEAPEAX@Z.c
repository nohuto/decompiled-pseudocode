/*
 * XREFs of ?QueryInterface@InputForwardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180177060
 * Callers:
 *     ?QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004D960 (-QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
LABEL_11:
  ...
  {
    (*(void (__fastcall **)(InputForwardProcessor *))(*(_QWORD *)this + 8LL))(this);
    v4 = (InputForwardProcessor *)((char *)v4 + 8);
    goto LABEL_11;
  }
  return 2147500034LL;
}
