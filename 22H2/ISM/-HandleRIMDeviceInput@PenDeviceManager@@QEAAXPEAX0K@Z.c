/*
 * XREFs of ?HandleRIMDeviceInput@PenDeviceManager@@QEAAXPEAX0K@Z @ 0x18012F868
 * Callers:
 ...
 *     ?ProcessPenUpdatePayload@PenDevice@@QEAAXPEAXKPEAU_GUID@@@Z @ 0x1801317F4 (-ProcessPenUpdatePayload@PenDevice@@QEAAXPEAXKPEAU_GUID@@@Z.c)
 */
