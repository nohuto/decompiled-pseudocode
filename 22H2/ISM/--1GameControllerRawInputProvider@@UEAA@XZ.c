/*
 * XREFs of ??1GameControllerRawInputProvider@@UEAA@XZ @ 0x1800885E4
 * Callers:
 ...
 *     ??1?$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAA@XZ @ 0x1800417CC (--1-$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAA@XZ.c)
 */
