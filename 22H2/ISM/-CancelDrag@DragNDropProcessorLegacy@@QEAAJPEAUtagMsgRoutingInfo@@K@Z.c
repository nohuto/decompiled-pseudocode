/*
 * XREFs of ?CancelDrag@DragNDropProcessorLegacy@@QEAAJPEAUtagMsgRoutingInfo@@K@Z @ 0x180174A18
 * Callers:
 *     ?Thunk_CancelDrag_0@?$IDragNDrop_Receive@VDragNDropProcessorLegacy@@@DragNDropMessageCall@@SAJPEAXPEAPEAX@Z @ 0x1801762E0 (-Thunk_CancelDrag_0@-$IDragNDrop_Receive@VDragNDropProcessorLegacy@@@DragNDropMessageCall@@SAJPE.c)
 * Callees:
...
LABEL_14:
        if ( v15 != *((_QWORD *)this + 11) )
        {
          ...
          v27 = v19;
          v28 = v16;
          CoreUICallSend(v22, v30, 1LL, 1LL, v24, &unk_1801C741E, v25);
