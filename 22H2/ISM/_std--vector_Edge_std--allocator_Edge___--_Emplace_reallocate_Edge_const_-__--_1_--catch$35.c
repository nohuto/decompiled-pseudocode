/*
 * XREFs of _std::vector_Edge_std::allocator_Edge___::_Emplace_reallocate_Edge_const_&__::_1_::catch$35 @ 0x1801787D9
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?deallocate@?$allocator@VEdge@@@std@@QEAAXQEAVEdge@@_K@Z @ 0x180177C9C (-deallocate@-$allocator@VEdge@@@std@@QEAAXQEAVEdge@@_K@Z.c)
 */
