/*
 * XREFs of ?what@ResultException@wil@@UEBAPEBDXZ @ 0x1800686B0
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x18003C220 (__security_check_cookie.c)
 *     _alloca_probe @ 0x18004B180 (_alloca_probe.c)
 *     ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x180065624 (-GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z.c)
 *     ?StringCchPrintfA@details@wil@@YAJPEAD_KPEBDZZ @ 0x180067CD0 (-StringCchPrintfA@details@wil@@YAJPEAD_KPEBDZZ.c)
