/*
 * XREFs of ?PredictFromPoses@ComputeVelocityFallbackPosePredictionModel@Holographic@Internal@Windows@@UEAAJPEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@_K_J0@Z @ 0x180161F80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$SE3_mult_a_binv@M@ST@@YAXAEAU?$SE3@M@0@AEBU10@1@Z @ 0x1801A55BC (--$SE3_mult_a_binv@M@ST@@YAXAEAU-$SE3@M@0@AEBU10@1@Z.c)
 */
