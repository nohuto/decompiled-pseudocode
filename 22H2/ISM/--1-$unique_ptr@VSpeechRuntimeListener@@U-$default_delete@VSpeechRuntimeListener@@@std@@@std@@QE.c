/*
 * XREFs of ??1?$unique_ptr@VSpeechRuntimeListener@@U?$default_delete@VSpeechRuntimeListener@@@std@@@std@@QEAA@XZ @ 0x18008B978
 * Callers:
 *     _SpectrumListener::SpectrumListener_::_1_::dtor$2 @ 0x18008B91B (_SpectrumListener--SpectrumListener_--_1_--dtor$2.c)
 * Callees:
