/*
 * XREFs of ??1?$ActivityBase@VHolographicDriverClientTrace@@$0A@$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAA@XZ @ 0x1801574A4
 * Callers:
 *     ??1OpenHolographicDevice@HolographicDriverClientTrace@@QEAA@XZ @ 0x180157D90 (--1OpenHolographicDevice@HolographicDriverClientTrace@@QEAA@XZ.c)
