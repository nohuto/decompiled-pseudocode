/*
 * XREFs of ?RegisterClient@ControllerNavigationManager@@MEAAJPEAVBamoControllerNavigationManagerStub@@PEAVBamoControllerNavigationClientProxy@@@Z @ 0x18011D8D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Try_emplace@AEBK$$V@?$unordered_map@KV?$ComPtr@VBamoControllerNavigationClientProxy@@@WRL@Microsoft@@U?$hash@K@std@@U?$equal_to@K@5@V?$allocator@U?$pair@$$CBKV?$ComPtr@VBamoControllerNavigationClientProxy@@@WRL@Microsoft@@@std@@@5@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKV?$ComPtr@VBamoControllerNavigationClientProxy@@@WRL@Microsoft@@@std@@@std@@@std@@@std@@_N@1@AEBK@Z @ 0x18011C69C (--$_Try_emplace@AEBK$$V@-$unordered_map@KV-$ComPtr@VBamoControllerNavigationClientProxy@@@WRL@Mi.c)
