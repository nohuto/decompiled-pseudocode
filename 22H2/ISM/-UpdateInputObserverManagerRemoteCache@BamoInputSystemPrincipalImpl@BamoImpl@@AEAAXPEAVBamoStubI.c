/*
 * XREFs of ?UpdateInputObserverManagerRemoteCache@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800088E0
 * Callers:
 ...
 *     ?UpdateInputObserverManagerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x1800F0730 (-UpdateInputObserverManagerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoS.c)
 * Callees:
...
LABEL_8:
    ...
    v26[0] = v20;
    v26[1] = v19;
    v22 = CoreUICallSend(v21, v26, 2LL, 43LL, 6, &unk_1801C01BA, v5);
