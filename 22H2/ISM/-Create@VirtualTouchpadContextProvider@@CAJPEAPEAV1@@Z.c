/*
 * XREFs of ?Create@VirtualTouchpadContextProvider@@CAJPEAPEAV1@@Z @ 0x180145BEC
 * Callers:
 ...
 *     ??0critical_section@wil@@QEAA@K@Z @ 0x18006463C (--0critical_section@wil@@QEAA@K@Z.c)
 *     ??0?$unordered_map@_KUtagRECT@@U?$hash@_K@std@@U?$equal_to@_K@3@V?$allocator@U?$pair@$$CB_KUtagRECT@@@std@@@3@@std@@QEAA@XZ @ 0x180145A20 (--0-$unordered_map@_KUtagRECT@@U-$hash@_K@std@@U-$equal_to@_K@3@V-$allocator@U-$pair@$$CB_KUtagR.c)
 */
