/*
 * XREFs of ?ProcessResult@DragManagerHost@@MEAAJPEAVBamoDragNDropContextualProcessorStub@@IAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientProxy@@@Z @ 0x1800F6080
 * Callers:
 *     <none>
 * Callees:
