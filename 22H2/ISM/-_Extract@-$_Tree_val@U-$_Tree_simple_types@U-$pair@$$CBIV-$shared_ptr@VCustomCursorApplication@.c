 ...
 *     ?OnDockDeviceRemoval@KeyboardDockServer@@QEAAJPEAUDockDeviceInfo@@@Z @ 0x1801269F8 (-OnDockDeviceRemoval@KeyboardDockServer@@QEAAJPEAUDockDeviceInfo@@@Z.c)
 ...
 *     ?erase@?$_Tree@V?$_Tset_traits@IU?$less@I@std@@V?$allocator@I@2@$0A@@std@@@std@@QEAA_KAEBI@Z @ 0x1801A2440 (-erase@-$_Tree@V-$_Tset_traits@IU-$less@I@std@@V-$allocator@I@2@$0A@@std@@@std@@QEAA_KAEBI@Z.c)
 * Callees:
