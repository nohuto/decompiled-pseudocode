/*
 * XREFs of ?QueryInterface@InputServiceProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180028A40
 * Callers:
 *     ?QueryInterface@InputServiceProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C140 (-QueryInterface@InputServiceProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
