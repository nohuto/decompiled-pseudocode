/*
 * XREFs of ?TelemetrySetStaticNodeDurability_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_STATIC_NODE_DURABILITY@@@Z @ 0x1801662EC
 * Callers:
        ...
        int a5)
{
  ...
  if ( **(_DWORD **)(v8 + 8) > 4u )
  {
    ...
    if ( (_BYTE)v8 )
    {
      ...
      v18 = 16LL;
      v16 = 8LL;
      LOBYTE(v8) = tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801D02B4, 0LL, 0LL, 7u, &v14);
    }
  }
  return v8;
}
