/*
 * XREFs of ?ControllerHapticsStatistics_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKJJN@Z @ 0x18016B86C
 * Callers:
 *     ??$ControllerHapticsStatistics@AEAKAEAJAEAJAEAN@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEAKAEAJ1AEAN@Z @ 0x18016848C (--$ControllerHapticsStatistics@AEAKAEAJAEAJAEAN@SpatialInteractionTrace@SpatialInteractionDevice.c)
 * Callees:
        ...
        double a5)
{
  ...
  if ( **((_DWORD **)v8 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v8 + 1), 0x400000000000LL) )
  {
    v14 = a5;
    v21 = v9;
    v22 = &v14;
    ...
    v13 = a2;
    v23 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801D1FEA, 0LL, 0LL, 6u, &v15);
  }
}
