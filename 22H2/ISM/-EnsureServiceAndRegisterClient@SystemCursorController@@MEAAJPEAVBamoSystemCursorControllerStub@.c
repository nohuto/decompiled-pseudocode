/*
 * XREFs of ?EnsureServiceAndRegisterClient@SystemCursorController@@MEAAJPEAVBamoSystemCursorControllerStub@@PEAVBamoSystemCursorControllerClientProxy@@@Z @ 0x18013CC60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$make_shared@VSystemCursorService@@PEAVSystemCursorController@@AEAK@std@@YA?AV?$shared_ptr@VSystemCursorService@@@0@$$QEAPEAVSystemCursorController@@AEAK@Z @ 0x18013B404 (--$make_shared@VSystemCursorService@@PEAVSystemCursorController@@AEAK@std@@YA-AV-$shared_ptr@VSy.c)
