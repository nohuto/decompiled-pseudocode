/*
 * XREFs of ?CreateCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x18013BDB4
 * Callers:
 *     ?Thunk_CreateCursorShapeAnimation_253@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013D1F0 (-Thunk_CreateCursorShapeAnimation_253@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCurs.c)
 * Callees:
