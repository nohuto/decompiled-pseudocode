/*
 * XREFs of ?UnregisterKeyboardDockClient@KeyboardDockServer@@QEAAJPEAVBamoKeyboardDockClientProxy@@@Z @ 0x180128290
 * Callers:
 *     ?OnDisconnected@KeyboardDockClientProxy@@MEAAJXZ @ 0x180128C50 (-OnDisconnected@KeyboardDockClientProxy@@MEAAJXZ.c)
 * Callees:
