/*
 * XREFs of ?QueueBackgroundSRUMUsageReporting@FeatureStateManager@details@wil@@QEAAXIGI@Z @ 0x180066344
 * Callers:
 ...
 *     ??0last_error_context@wil@@QEAA@XZ @ 0x1800646A4 (--0last_error_context@wil@@QEAA@XZ.c)
        ...
        int a4)
{
  ...
  if ( *(_BYTE *)pv && !wil::ProcessShutdownInProgress((wil *)pv) )
  {
    ...
    v10 = a3;
    v12 = a4;
    wil::details_abi::heap_buffer::push_back((void **)pv + 31, &v9, 0xCuLL);
    if ( !*((_BYTE *)pv + 64) )
    {
      if ( !*((_QWORD *)pv + 7) )
      {
