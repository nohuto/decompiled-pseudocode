/*
 * XREFs of ?Materialize_Microsoft_Bamo_Lib_ISMBamos_AutoBamos_BamoList_ActivatableEntityPrincipal_Proxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E88A8
 * Callers:
 *     ?Thunk_Materialize_Microsoft_Bamo_Lib_ISMBamos_AutoBamos_BamoList_ActivatableEntityPrincipal_Proxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED170 (-Thunk_Materialize_Microsoft_Bamo_Lib_ISMBamos_AutoBamos_BamoList_ActivatableEntityPrincipal_Pro.c)
 * Callees:
