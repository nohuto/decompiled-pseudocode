/*
 * XREFs of ?UpdateInputSiteManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EEB64
 * Callers:
 ...
 *     ?Thunk_UpdateInputSiteManager_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED330 (-Thunk_UpdateInputSiteManager_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@.c)
 * Callees:
