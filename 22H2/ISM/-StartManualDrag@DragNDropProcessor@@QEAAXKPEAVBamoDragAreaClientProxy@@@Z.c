/*
 * XREFs of ?StartManualDrag@DragNDropProcessor@@QEAAXKPEAVBamoDragAreaClientProxy@@@Z @ 0x1800FB858
 * Callers:
 *     ?StartManualDrag@DragAreaClientProxy@@MEAAJI@Z @ 0x1800F5AA0 (-StartManualDrag@DragAreaClientProxy@@MEAAJI@Z.c)
 * Callees:
