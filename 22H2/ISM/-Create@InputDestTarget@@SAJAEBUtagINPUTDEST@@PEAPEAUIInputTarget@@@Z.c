/*
 * XREFs of ?Create@InputDestTarget@@SAJAEBUtagINPUTDEST@@PEAPEAUIInputTarget@@@Z @ 0x18013A7EC
 * Callers:
 ...
 *     ??0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z @ 0x18013A664 (--0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z.c)
 */
