/*
 * XREFs of ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z @ 0x1800ACB20
 * Callers:
 ...
 * Callees:
 *     ?InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z @ 0x1800ACAA8 (-InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z.c)
 */
