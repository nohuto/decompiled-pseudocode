/*
 * XREFs of ?Materialize_BamoDockableDeviceProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7184
 * Callers:
 *     ?Thunk_Materialize_BamoDockableDeviceProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECE50 (-Thunk_Materialize_BamoDockableDeviceProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerIm.c)
 * Callees:
