/*
 * XREFs of ?DeviceAdded@BamoSystemCursorControllerClientProxyImpl@BamoImpl@@QEAAJAEBUCursorDeviceInfo@@_K1@Z @ 0x1800E539C
 * Callers:
...
LABEL_3:
  ...
  v12 = v9;
  return CoreUICallSend(v7, v11, 2LL, 64LL, 0, &unk_1801C02B4, (unsigned int)&v12);
}
