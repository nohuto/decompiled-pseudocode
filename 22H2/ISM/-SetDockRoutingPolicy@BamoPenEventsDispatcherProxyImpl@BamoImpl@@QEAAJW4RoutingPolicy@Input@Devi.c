/*
 * XREFs of ?SetDockRoutingPolicy@BamoPenEventsDispatcherProxyImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x1800EC95C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoPenEventsDispatcherProxyImpl::SetDockRoutingPolicy(__int64 a1, int a2)
{
  char *v2; // rbx
  int v6; // eax
  unsigned int v7; // esi
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 2;
      return CoreUICallSend(v8, v10, 2LL, 54LL, v9, &unk_1801C01C0, a2);
    }
    else
    {
