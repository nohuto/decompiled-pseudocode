/*
 * XREFs of ?OnSpatialNavigationCompleted@MPCSpatialGestureRecognizerHandler@@AEAAJPEAUISpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAUISpatialNavigationCompletedEventArgs@3456@@Z @ 0x180081920
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)(*((_QWORD *)this + 13) + 656LL) = 2;
  if ( *((_DWORD *)this + 42) == 1 )
  {
    if ( ISMTracing::IsEnabled((__int64)this) )
    {
      ...
      ISMTracing::GestureRecognizer_GestureDetected_(v5, L"ScrollCompleted");
    }
  }
  else
  {
