/*
 * XREFs of ?Initialize@?$KernelInputConnection@UtagQMSGINPUTREPORT@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBUtagQMSGINPUTREPORT@@@Z@std@@@Z @ 0x18002CB3C
 * Callers:
...
__int64 __fastcall KernelInputConnection<tagQMSGINPUTREPORT>::Initialize(
        _QWORD *a1,
        _QWORD *a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    wil::unique_com_token<IMessageSession,unsigned __int64,void (IMessageSession *,unsigned __int64),&void wil::details::IMessageSessionCloseEndpointFunction(IMessageSession *,unsigned __int64),0>::reset(
      ...
      a1[1]);
    v20 = (_DWORD)a1 + 16;
    v15 = v14(v13, KernelInputConnection<tagQMSGINPUTREPORT>::s_OnKernelInputEventStatic, a1, *a1);
    if ( v15 < 0 )
    {
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
    ...
    v17 = NtMITCoreMsgKOpenConnectionTo(2LL, a1 + 3);
    if ( v17 < 0 )
    {
