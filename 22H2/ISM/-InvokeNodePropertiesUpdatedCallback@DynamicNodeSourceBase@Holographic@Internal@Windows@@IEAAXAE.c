/*
 * XREFs of ?InvokeNodePropertiesUpdatedCallback@DynamicNodeSourceBase@Holographic@Internal@Windows@@IEAAXAEBUSPATIAL_NODE_ID@@W4SpatialGraphNodePropertyFlags@234@@Z @ 0x1801600F8
 * Callers:
 *     ?OnSpatialGraphNodePoseValidityChanged@DynamicNodeSourceBase@Holographic@Internal@Windows@@EEAAJAEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_VALIDITY_FLAGS@@@Z @ 0x180161750 (-OnSpatialGraphNodePoseValidityChanged@DynamicNodeSourceBase@Holographic@Internal@Windows@@EEAAJ.c)
