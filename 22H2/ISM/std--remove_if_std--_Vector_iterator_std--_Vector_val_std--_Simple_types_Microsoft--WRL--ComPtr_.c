/*
 * XREFs of std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_EdgyControllerClientProxy_________lambda_bf8165f59c1feaeab7cdf7a46b73aec9___ @ 0x18004A22C
 * Callers:
