/*
 * XREFs of ??1?$map@U_GUID@@V?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@UGUIDComparer@PenDeviceManager@@V?$allocator@U?$pair@$$CBU_GUID@@V?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@@std@@QEAA@XZ @ 0x18012ED5C
 * Callers:
 *     _PenDeviceManager::PenDeviceManager_::_1_::dtor$2 @ 0x18012ECED (_PenDeviceManager--PenDeviceManager_--_1_--dtor$2.c)
 * Callees:
