/*
 * XREFs of ?Parse@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEAAJPEADKPEAUISpatialGraphNodeReference@Holographic@34@_JAEBUMatrix4x4@Numerics@Foundation@4@3PEA_NPEAW4MPCAugmentedInputGestureType@@44@Z @ 0x1800DC190
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( (int)result >= 0 )
  {
    ...
    *((_BYTE *)this + 1248) = 0;
    v29 = v15 & 2;
    v30 = v28 % qword_180209328;
    v31 = v15 & 1;
    *((_QWORD *)this + 152) = 10 * (v28 / qword_180209328);
