/*
 * XREFs of ?MPCInputRouter_Update3DFocusWNF_@ISMTracing@@QEAAX_K0KKKK@Z @ 0x1800B8E88
 * Callers:
        ...
        unsigned int a7)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( **((_DWORD **)v11 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v11 + 1), 1LL) )
    {
      ...
      v19 = a3;
      v20 = a2;
      tlgWriteTransfer_EventWriteTransfer(v14, (unsigned __int8 *)dword_1801CB9B8, 0LL, 0LL, v12 + 7, &v21);
    }
  }
}
