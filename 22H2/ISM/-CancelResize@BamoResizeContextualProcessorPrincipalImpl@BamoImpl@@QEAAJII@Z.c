/*
 * XREFs of ?CancelResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800FCBEC
 * Callers:
 *     ?Thunk_CancelResize_112@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FD1B0 (-Thunk_CancelResize_112@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProce.c)
 * Callees:
