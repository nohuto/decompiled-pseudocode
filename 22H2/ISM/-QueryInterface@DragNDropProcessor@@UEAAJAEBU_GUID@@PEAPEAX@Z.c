/*
 * XREFs of ?QueryInterface@DragNDropProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FAD60
 * Callers:
 *     ?QueryInterface@DragNDropProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C090 (-QueryInterface@DragNDropProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
