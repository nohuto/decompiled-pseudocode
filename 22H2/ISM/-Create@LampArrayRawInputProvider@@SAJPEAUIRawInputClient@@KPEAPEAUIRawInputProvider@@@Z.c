/*
 * XREFs of ?Create@LampArrayRawInputProvider@@SAJPEAUIRawInputClient@@KPEAPEAUIRawInputProvider@@@Z @ 0x180034220
 * Callers:
 *     <none>
 * Callees:
 *     ?Release@LampArrayRawInputProvider@@UEAAKXZ @ 0x180010500 (-Release@LampArrayRawInputProvider@@UEAAKXZ.c)
 ...
 *     ??0LampArrayRawInputProvider@@AEAA@XZ @ 0x180034374 (--0LampArrayRawInputProvider@@AEAA@XZ.c)
