/*
 * XREFs of ?CalculateZoomDelta@ControllerProcessor@@AEAAJM@Z @ 0x180120994
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculateZoomDelta(ControllerProcessor *this, float a2)
{
  ...
  if ( COERCE_FLOAT(LODWORD(a2) & _xmm) > 0.00000011920929 )
  {
    ...
    v4 = (float)(int)(GetTickCount() - *((_DWORD *)this + 104));
    if ( v4 < 2500.0 )
    ...
    if ( v5 >= 0.0 )
      ...
      v6 = 1.0 / (float)(1.0 - v5);
    *((float *)this + 103) = v6 + *((float *)this + 103);
  }
  else
  {
    *((_DWORD *)this + 104) = GetTickCount();
  }
  return 0LL;
}
