/*
 * XREFs of ??0SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@AEAA@PEAUHSTRING__@@AEBU_GUID@@W4HandleWrapperDesiredAccess@123@_NPEAX@Z @ 0x180156EC4
 * Callers:
 ...
 *     ??0ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ @ 0x180156960 (--0ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ.c)
