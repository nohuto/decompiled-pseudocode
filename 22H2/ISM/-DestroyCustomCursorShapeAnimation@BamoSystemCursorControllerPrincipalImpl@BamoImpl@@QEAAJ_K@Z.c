/*
 * XREFs of ?DestroyCustomCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x18013C74C
 * Callers:
 *     ?Thunk_DestroyCustomCursorShapeAnimation_2@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013D250 (-Thunk_DestroyCustomCursorShapeAnimation_2@-$ISystemCursorControllerPrincipal_Receive@VBamoSyste.c)
 * Callees:
