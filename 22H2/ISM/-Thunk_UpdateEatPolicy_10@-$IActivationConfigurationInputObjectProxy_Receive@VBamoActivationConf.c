/*
 * XREFs of ?Thunk_UpdateEatPolicy_10@?$IActivationConfigurationInputObjectProxy_Receive@VBamoActivationConfigurationInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180011810
 * Callers:
 *     <none>
 * Callees:
