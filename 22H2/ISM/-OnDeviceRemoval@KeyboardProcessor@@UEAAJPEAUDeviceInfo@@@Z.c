/*
 * XREFs of ?OnDeviceRemoval@KeyboardProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x180135650
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OnKeyPress@KeyboardProcessorTelemetry@@QEAAX_N@Z @ 0x1801359C8 (-OnKeyPress@KeyboardProcessorTelemetry@@QEAAX_N@Z.c)
 */
