/*
 * XREFs of ?UpdateControllerNavigationManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EDC00
 * Callers:
 ...
 *     ?Thunk_UpdateControllerNavigationManager_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED1E0 (-Thunk_UpdateControllerNavigationManager_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImp.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 5) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 64LL))((char *)this - 16);
    if ( v9 < 0 )
