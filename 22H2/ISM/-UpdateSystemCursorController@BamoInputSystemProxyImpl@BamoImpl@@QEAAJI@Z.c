/*
 * XREFs of ?UpdateSystemCursorController@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EFB14
 * Callers:
 ...
 *     ?Thunk_UpdateSystemCursorController_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED4A0 (-Thunk_UpdateSystemCursorController_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@Bam.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 16) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 152LL))((char *)this - 16);
    if ( v9 < 0 )
