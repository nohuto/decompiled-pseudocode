/*
 * XREFs of ?UpdateHitTestConfiguration@BamoDragSourceClientProxyImpl@BamoImpl@@QEAAJW4DragHitTestConfiguration@Input@Internal@UI@Windows@@@Z @ 0x1800EE748
 * Callers:
 ...
 *     ?Thunk_UpdateHitTestConfiguration_16@?$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED2C0 (-Thunk_UpdateHitTestConfiguration_16@-$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxy.c)
 * Callees:
