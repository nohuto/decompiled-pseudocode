/*
 * XREFs of ?StartDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJI_KI@Z @ 0x1800F6324
 * Callers:
 *     ?Thunk_StartDrag_107@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F64F0 (-Thunk_StartDrag_107@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualPr.c)
 * Callees:
        ...
        unsigned int a4)
{
  ...
  Microsoft::BamoImpl::DropAndReacquireLock::DropAndReacquireLock(
    ...
    v12);
  v16 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, __int64, char *))(*((_QWORD *)this - 2) + 72LL))(
          (char *)this - 16,
          v10,
          a2,
          a3,
