/*
 * XREFs of ??0GestureSession@@AEAA@XZ @ 0x180182AD4
 * Callers:
 ...
 * Callees:
 *     ?Reset@GestureSession@@UEAAJXZ @ 0x180183700 (-Reset@GestureSession@@UEAAJXZ.c)
 *     ??0FlickRecognizer@@QEAA@XZ @ 0x18018384C (--0FlickRecognizer@@QEAA@XZ.c)
 *     ??0ClickRecognizer@@QEAA@XZ @ 0x180184300 (--0ClickRecognizer@@QEAA@XZ.c)
 *     ?ResetConfigValues@DragRecognizer@@UEAAXXZ @ 0x180185280 (-ResetConfigValues@DragRecognizer@@UEAAXXZ.c)
 *     ??0TwoFingerGestureRecognizer@@QEAA@XZ @ 0x1801855C4 (--0TwoFingerGestureRecognizer@@QEAA@XZ.c)
