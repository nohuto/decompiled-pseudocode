/*
 * XREFs of ?Thunk_UpdateActivatePolicy_10@?$IActivationConfigurationInputObjectProxy_Receive@VBamoActivationConfigurationInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180010380
 * Callers:
 *     <none>
 * Callees:
