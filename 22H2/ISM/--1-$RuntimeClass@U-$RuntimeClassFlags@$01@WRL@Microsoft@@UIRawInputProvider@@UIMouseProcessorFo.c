/*
 * XREFs of ??1?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIRawInputProvider@@UIMouseProcessorForwarding@@VMPCInputProviderBase@@@WRL@Microsoft@@UEAA@XZ @ 0x180194E88
 * Callers:
 *     _MPCMouseProcessor::MPCMouseProcessor_::_1_::dtor$0 @ 0x18004E96D (_MPCMouseProcessor--MPCMouseProcessor_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
