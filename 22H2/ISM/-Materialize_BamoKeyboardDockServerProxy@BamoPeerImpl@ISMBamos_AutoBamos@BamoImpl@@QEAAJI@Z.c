/*
 * XREFs of ?Materialize_BamoKeyboardDockServerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7D24
 * Callers:
 *     ?Thunk_Materialize_BamoKeyboardDockServerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECFC0 (-Thunk_Materialize_BamoKeyboardDockServerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPe.c)
 * Callees:
...
__int64 __fastcall BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl::Materialize_BamoKeyboardDockServerProxy(
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoKeyboardDockServerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoKeyboardDockServerProxy::`vftable'{for `IKeyboardDockServerProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
