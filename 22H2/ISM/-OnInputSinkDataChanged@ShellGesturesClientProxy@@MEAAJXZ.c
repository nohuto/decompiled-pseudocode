/*
 * XREFs of ?OnInputSinkDataChanged@ShellGesturesClientProxy@@MEAAJXZ @ 0x180101560
 * Callers:
 *     ?OnConnected@ShellGesturesClientProxy@@MEAAJXZ @ 0x180046760 (-OnConnected@ShellGesturesClientProxy@@MEAAJXZ.c)
 * Callees:
