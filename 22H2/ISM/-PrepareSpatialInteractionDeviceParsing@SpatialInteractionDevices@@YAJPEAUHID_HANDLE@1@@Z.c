/*
 * XREFs of ?PrepareSpatialInteractionDeviceParsing@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@@Z @ 0x1800C9BD0
 * Callers:
 ...
 *     SpatialInteractionDevices::GetUsageDesc_SpatialInteractionDevices::UsageMapping_SpatialInteractionDevices::UsageDesc_SpatialInteractionDevices::BitUsage_enum_SpatialInteractionDevices::ButtonFlags____1___ @ 0x1800C730C (SpatialInteractionDevices--GetUsageDesc_SpatialInteractionDevices--UsageMapping_SpatialInteracti.c)
 *     SpatialInteractionDevices::GetUsageDesc_SpatialInteractionDevices::UsageMapping_SpatialInteractionDevices::UsageDesc_SpatialInteractionDevices::ValueUsage__1___ @ 0x1800C73B8 (SpatialInteractionDevices--GetUsageDesc_SpatialInteractionDevices--UsageMapping_Spa_ea_1800C73B8.c)
 *     SpatialInteractionDevices::GetUsageDesc_SpatialInteractionDevices::UsageMapping_SpatialInteractionDevices::UsageDesc_SpatialInteractionDevices::ValueUsage__3___ @ 0x1800C7454 (SpatialInteractionDevices--GetUsageDesc_SpatialInteractionDevices--UsageMapping_Spa_ea_1800C7454.c)
 *     SpatialInteractionDevices::GetUsageDesc_SpatialInteractionDevices::UsageMapping_SpatialInteractionDevices::UsageDesc_SpatialInteractionDevices::ValueUsage__4___ @ 0x1800C7500 (SpatialInteractionDevices--GetUsageDesc_SpatialInteractionDevices--UsageMapping_Spa_ea_1800C7500.c)
 *     SpatialInteractionDevices::HasAllCaps_1_ @ 0x1800C7890 (SpatialInteractionDevices--HasAllCaps_1_.c)
 *     SpatialInteractionDevices::HasAllCaps_2_ @ 0x1800C78B0 (SpatialInteractionDevices--HasAllCaps_2_.c)
 *     SpatialInteractionDevices::HasAllCaps_4_ @ 0x1800C78D0 (SpatialInteractionDevices--HasAllCaps_4_.c)
 ...
 *     SpatialInteractionDevices::GetReportCaps @ 0x1800C97D0 (SpatialInteractionDevices--GetReportCaps.c)
 *     SpatialInteractionDevices::IsValidButtonUsage @ 0x1800C98BC (SpatialInteractionDevices--IsValidButtonUsage.c)
 */
  ...
  *(_BYTE *)(v8 + 237) = (_BYTE)v7;
  ...
  try
  {
    ...
    for ( j = 0; j < *((_DWORD *)this + 34); ++j )
    {
      ...
      LOBYTE(v52) = 0;
      v20 = SpatialInteractionDevices::StoreCapsIfMatches_1_((__int64)&off_1801B9E90, v18, v19, &v52);
      v21 = v20;
      if ( v20 < 0 )
      {
      ...
      if ( !(_BYTE)v52 )
      {
        v24 = SpatialInteractionDevices::StoreCapsIfMatches_4_((__int64)&off_1801B9E38, v18, v19 + 48, &v52);
        v25 = v24;
        if ( v24 < 0 )
        {
          wil::details::in1diag3::Return_Hr(
        ...
        if ( !(_BYTE)v52 )
        {
          ...
          if ( !(_BYTE)v52 )
          {
            v28 = SpatialInteractionDevices::StoreCapsIfMatches_2_((__int64)&off_1801B9ED0, v18, v19 + 8, &v52);
            v29 = v28;
            if ( v28 < 0 )
            {
              wil::details::in1diag3::Return_Hr(
