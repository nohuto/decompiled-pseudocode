/*
 * XREFs of ?SendCancelNotificationToGestureTargeting@Win32kInterop@@AEAAXAEAV?$unordered_set@KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@K@2@@std@@PEAUInputInfo@@@Z @ 0x1800B2BCC
 * Callers:
