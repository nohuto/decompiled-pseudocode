/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x1800064A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  v6 = 0;
  v9 = v2;
  v5 = CoreUICallSend(v4, v8, 2LL, 74LL, v6, &unk_1801C01CD, (unsigned int)&v9);
  if ( v5 < 0 )
  {
