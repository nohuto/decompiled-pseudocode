/*
 * XREFs of ??_EInputRedirectionProcessor@@UEAAPEAXI@Z @ 0x18017F098
 * Callers:
 *     ??_EInputRedirectionProcessor@@WBI@EAAPEAXI@Z @ 0x18004DA30 (--_EInputRedirectionProcessor@@WBI@EAAPEAXI@Z.c)
 * Callees:
