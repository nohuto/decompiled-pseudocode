/*
 * XREFs of ?GetWeakReference@?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UISpatialGraphDriverClient@Holographic@Internal@Windows@@U?$CloakedIid@UISpatialGraphDriverClientInternal@Holographic@Internal@Windows@@@23@VDynamicNodeSourceBase@567@VFtmBase@23@@Details@WRL@Microsoft@@UEAAJPEAPEAUIWeakReference@@@Z @ 0x18015F430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<3>,1,1,0,Windows::Internal::Holographic::ISpatialGraphDriverClient,Microsoft::WRL::CloakedIid<Windows::Internal::Holographic::ISpatialGraphDriverClientInternal>,Windows::Internal::Holographic::DynamicNodeSourceBase,Microsoft::WRL::FtmBase>::GetWeakReference(
        __int64 a1,
        struct IUnknown *a2)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    *(_DWORD *)(WeakReference + 16) = v2;
    ...
    v11 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 136), v9, v2);
    for ( i = v2 == v11; ; i = v11 == v12 )
    {
      ...
      v11 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 136), v9, v11);
    }
