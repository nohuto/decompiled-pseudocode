/*
 * XREFs of ?ParseInputReport@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEAUHID_REPORT@1@PEAUInputReport@1@@Z @ 0x1800C995C
 * Callers:
 ...
 *     SpatialInteractionDevices::ReadBatteryLevel @ 0x1800CA260 (SpatialInteractionDevices--ReadBatteryLevel.c)
 ...
 *     SpatialInteractionDevices::ReadTrigger @ 0x1800CA4A4 (SpatialInteractionDevices--ReadTrigger.c)
