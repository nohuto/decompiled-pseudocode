/*
 * XREFs of _lambda_a2967a5fef4bd4911d3370ff5cbae9e9_::operator() @ 0x180198440
 * Callers:
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_a2967a5fef4bd4911d3370ff5cbae9e9_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180198280 (--$_Callback_once@V-$tuple@$$QEAV_lambda_a2967a5fef4bd4911d3370ff5cbae9e9_@@AEAVexception_ptr@st.c)
 * Callees:
