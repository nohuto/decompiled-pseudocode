/*
 * XREFs of ?get@?$static_lazy@VSpatialInteractionTraceContinuous@SpatialInteractionDevices@@@details@wil@@QEAAPEAVSpatialInteractionTraceContinuous@SpatialInteractionDevices@@P6AXXZ@Z @ 0x1800D45BC
 * Callers:
 ...
 *     ?EffectiveHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXJKKE@Z @ 0x18016BCC4 (-EffectiveHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXJKK.c)
        ...
        void (__cdecl *a2)())
{
  ...
  {
    v5 = qword_180209610;
    qword_180209610[0] = &RawInputProvidersContinuousTracing::`vftable';
    qword_180209628 = (struct _tlgProvider_t *)&`SpatialInteractionDevices::SpatialInteractionTraceContinuous::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_180209610, qword_180209628, 0LL);
    InitOnceComplete(
      &`SpatialInteractionDevices::SpatialInteractionTraceContinuous::Instance'::`2'::wrapper,
      0,
      qword_180209610);
