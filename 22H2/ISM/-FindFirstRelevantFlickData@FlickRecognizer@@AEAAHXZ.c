/*
 * XREFs of ?FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ @ 0x180183CA4
 * Callers:
 *     ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x180183B70 (-CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z.c)
 * Callees:
 *     <none>
 */
