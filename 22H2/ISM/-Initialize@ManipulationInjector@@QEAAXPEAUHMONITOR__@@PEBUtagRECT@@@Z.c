/*
 * XREFs of ?Initialize@ManipulationInjector@@QEAAXPEAUHMONITOR__@@PEBUtagRECT@@@Z @ 0x1800C26A4
 * Callers:
  ...
  *((_DWORD *)this + 183) = v9;
  ...
  switch ( *(_DWORD *)this )
  {
    ...
    case 2:
      ...
      dword_1802084FC = (int)(float)((float)((float)((float)v13 * 100.0) / (float)*((int *)this + 193)) + 0.5);
      dword_18020851C = (int)v14;
      v28.x = *((_DWORD *)this + 5);
