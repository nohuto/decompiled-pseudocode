/*
 * XREFs of ?RegisterEdgyControllerClient@BamoEdgyControllerServerProxyImpl@BamoImpl@@QEAAJPEBGPEAVBamoEdgyControllerClientPrincipal@@@Z @ 0x1800EB2DC
 * Callers:
        ...
        struct BamoEdgyControllerClientPrincipal *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this[2] + 3) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      return CoreUICallSend(v8, v10, 2LL, 31LL, 0, &unk_1801C023E, v3);
    }
    else
    {
