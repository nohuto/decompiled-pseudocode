/*
 * XREFs of ?GetNearestSupportedProgrammableColorAndDeviceChannels@NearestColor@@CAXAEBUColor@UI@Windows@@AEBULampAttributes@@PEAU234@PEAULampColor@@@Z @ 0x1800A9104
 * Callers:
 ...
 * Callees:
 *     ?SnapChannelToNearest@NearestColor@@CANNN@Z @ 0x1800A93C8 (-SnapChannelToNearest@NearestColor@@CANNN@Z.c)
 */
