/*
 * XREFs of ?SetAllConstantsForInputTypeToDefault@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@QEAAJW4InputType@@PEAVBamoAsyncHRESULTPrincipal@@@Z @ 0x18010B29C
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v10 = 2;
      return CoreUICallSend(v9, v11, 2LL, 1LL, v10, &unk_1801C2965, a2);
    }
    else
    {
