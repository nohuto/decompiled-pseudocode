/*
 * XREFs of ?PostHitTestProcessing@MPCSixDofProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAUInputInfo@@@Z @ 0x18018E260
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsCapturing@MPCInputProviderBase@@UEBA_NXZ @ 0x18007E200 (-IsCapturing@MPCInputProviderBase@@UEBA_NXZ.c)
 ...
 *     ?HasMenuButtonReleased@MPCSixDofProcessor@@AEAA_NPEAUInputInfo@@@Z @ 0x18018CF88 (-HasMenuButtonReleased@MPCSixDofProcessor@@AEAA_NPEAUInputInfo@@@Z.c)
 *     ?PopulateDownLevelInfo@MPCSixDofProcessor@@AEAAXPEAUInputInfo@@@Z @ 0x18018DE34 (-PopulateDownLevelInfo@MPCSixDofProcessor@@AEAAXPEAUInputInfo@@@Z.c)
