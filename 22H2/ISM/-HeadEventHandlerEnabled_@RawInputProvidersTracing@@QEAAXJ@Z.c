/*
 * XREFs of ?HeadEventHandlerEnabled_@RawInputProvidersTracing@@QEAAXJ@Z @ 0x180093B74
 * Callers:
...
void __fastcall RawInputProvidersTracing::HeadEventHandlerEnabled_(RawInputProvidersTracing *this, int a2)
{
  ...
  if ( *(_DWORD *)v3[1] > 4u && tlgKeywordOn(v3[1], 2LL) )
  {
    ...
    v5 = a2;
    v8 = 4;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801CA7DD, 0LL, 0LL, 3u, &v6);
  }
}
