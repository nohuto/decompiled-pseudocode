/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_GameInputInbox@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180043280
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_GameInputInbox@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180043348 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_GameInputInbo.c)
 */

signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_GameInputInbox>::GetCachedFeatureEnabledState(
        wil::details *a1,
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_GameInputInbox>::GetCurrentFeatureEnabledState(
      v6,
      &v13,
      &v12);
    v7 = *a2;
