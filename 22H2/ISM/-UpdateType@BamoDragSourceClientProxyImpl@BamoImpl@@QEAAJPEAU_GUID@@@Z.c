/*
 * XREFs of ?UpdateType@BamoDragSourceClientProxyImpl@BamoImpl@@QEAAJPEAU_GUID@@@Z @ 0x1800EFD54
 * Callers:
 ...
 *     ?Thunk_UpdateType_29@?$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED4C0 (-Thunk_UpdateType_29@-$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@.c)
 * Callees:
