/*
 * XREFs of ??$_Try_emplace@AEBK$$V@?$unordered_map@KUMessageInfo@DragNDropProcessor@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKUMessageInfo@DragNDropProcessor@@@std@@@4@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKUMessageInfo@DragNDropProcessor@@@std@@@std@@@std@@@std@@_N@1@AEBK@Z @ 0x1800F76BC
 * Callers:
 ...
 *     ??$_Insert@AEBUpiecewise_construct_t@std@@V?$tuple@AEBK@2@V?$tuple@$$V@2@@?$list@U?$pair@$$CBKUMessageInfo@DragNDropProcessor@@@std@@V?$allocator@U?$pair@$$CBKUMessageInfo@DragNDropProcessor@@@std@@@2@@std@@QEAAXV?$_List_unchecked_const_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKUMessageInfo@DragNDropProcessor@@@std@@@std@@@std@@U_Iterator_base0@2@@1@AEBUpiecewise_construct_t@1@$$QEAV?$tuple@AEBK@1@$$QEAV?$tuple@$$V@1@@Z @ 0x1800F6C6C (--$_Insert@AEBUpiecewise_construct_t@std@@V-$tuple@AEBK@2@V-$tuple@$$V@2@@-$list@U-$pair@$$CBKUM.c)
...
__int64 __fastcall std::unordered_map<unsigned long,DragNDropProcessor::MessageInfo>::_Try_emplace<unsigned long const &,>(
        __int64 a1,
        __int64 a2,
...
LABEL_6:
  if ( (__int64 *)v9 == v11 )
  {
    v12 = *v11;
    v14 = a3;
    std::list<std::pair<unsigned long const,DragNDropProcessor::MessageInfo>>::_Insert<std::piecewise_construct_t const &,std::tuple<unsigned long const &>,std::tuple<>>(
      (__int64)v10,
      v12,
      v8,
      (_DWORD **)&v14);
