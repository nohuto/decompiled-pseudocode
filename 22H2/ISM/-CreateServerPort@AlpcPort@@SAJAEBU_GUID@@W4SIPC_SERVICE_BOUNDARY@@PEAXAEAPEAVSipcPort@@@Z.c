/*
 * XREFs of ?CreateServerPort@AlpcPort@@SAJAEBU_GUID@@W4SIPC_SERVICE_BOUNDARY@@PEAXAEAPEAVSipcPort@@@Z @ 0x180030F44
 * Callers:
 ...
 *     ??0AlpcPort@@AEAA@_N@Z @ 0x180031480 (--0AlpcPort@@AEAA@_N@Z.c)
...
__int64 __fastcall AlpcPort::CreateServerPort(__int64 a1, __int64 a2, __int64 a3, AlpcPort **a4)
{
  ...
  _OWORD v15[2]; // [rsp+28h] [rbp-D8h] BYREF
  __int128 v16; // [rsp+48h] [rbp-B8h]
  _BYTE v17[192]; // [rsp+60h] [rbp-A0h] BYREF
  ...
  *a4 = 0LL;
  ...
  if ( v8 < 0 )
    goto LABEL_20;
  AlpcPortString::AlpcPortString(v17, &xmmword_1801C13D0, 1LL);
  v15[0] = *(_OWORD *)&AlpcPort::ServerObjectAttributes.Length;
  v16 = unk_180226020;
  v15[1] = (unsigned __int64)v17;
...
LABEL_16:
  ...
  *(_QWORD *)&v16 = SecurityDescriptor;
  wil::details::unique_storage<wil::details::handle_null_resource_policy<int (*)(void *),&int CloseHandle(void *)>>::reset(
    (char *)v7 + 56,
    0LL);
  Port = NtAlpcCreatePort((char *)v7 + 56, v15, &AlpcPort::ServerPortAlpcAttributes);
  if ( Port < 0 )
  {
