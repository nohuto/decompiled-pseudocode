/*
 * XREFs of ?Thunk_UpdateInputForwardAreaInputObject_10@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000F2D0
 * Callers:
 *     <none>
 * Callees:
