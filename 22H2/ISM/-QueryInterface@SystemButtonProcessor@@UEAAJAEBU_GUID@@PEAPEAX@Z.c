/*
 * XREFs of ?QueryInterface@SystemButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800289D0
 * Callers:
 *     ?QueryInterface@SystemButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004DB30 (-QueryInterface@SystemButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
