/*
 * XREFs of ?SendMaterializeProxy@BamoPenDeviceManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801309D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v15, 2LL, 74LL, 38, &unk_1801C01BA, v13);
  if ( v8 < 0 )
  {
