/*
 * XREFs of ?Thunk_UpdateViewInstanceId_10@?$IInputAttemptedDeliveryClientProxy_Receive@VBamoInputAttemptedDeliveryClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180005360
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IInputAttemptedDeliveryClientProxy_Receive<BamoImpl::BamoInputAttemptedDeliveryClientProxyImpl>::Thunk_UpdateViewInstanceId_10(
        __int64 a1,
        _DWORD **a2)
{
  int v4; // eax
