/*
 * XREFs of ?ProcessProviderHitTest@MPCCursorManager@@QEAAJPEAUIMPCInputProviderBase@@AEBUHitTestResult3D@@AEA_N@Z @ 0x18007C70C
 * Callers:
 ...
 *     _lambda_2c96748461f4900de3746577f815c647_::operator() @ 0x18007C408 (_lambda_2c96748461f4900de3746577f815c647_--operator().c)
 *     ?Is2DCursorVisible@MPCCursorManager@@AEAA_NXZ @ 0x18007C4A0 (-Is2DCursorVisible@MPCCursorManager@@AEAA_NXZ.c)
 *     ?Is3DCursorVisible@MPCCursorManager@@AEAA_NXZ @ 0x18007C4C0 (-Is3DCursorVisible@MPCCursorManager@@AEAA_NXZ.c)
 */
