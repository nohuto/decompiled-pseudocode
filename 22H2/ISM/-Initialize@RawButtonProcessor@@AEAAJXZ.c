/*
 * XREFs of ?Initialize@RawButtonProcessor@@AEAAJXZ @ 0x1801825F4
 * Callers:
 ...
 *     ?Initialize@PrivateMessageSession@RawButtonProcessor@@QEAAXPEAV2@@Z @ 0x180182530 (-Initialize@PrivateMessageSession@RawButtonProcessor@@QEAAXPEAV2@@Z.c)
 */
