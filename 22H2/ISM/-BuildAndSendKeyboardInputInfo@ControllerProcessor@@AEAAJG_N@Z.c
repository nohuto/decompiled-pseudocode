/*
 * XREFs of ?BuildAndSendKeyboardInputInfo@ControllerProcessor@@AEAAJG_N@Z @ 0x1801203B8
 * Callers:
 ...
 *     ?StopAutoRepeatTimer@ControllerProcessor@@AEAAJXZ @ 0x180122DDC (-StopAutoRepeatTimer@ControllerProcessor@@AEAAJXZ.c)
