/*
 * XREFs of ?UpdateHaptics@BamoPenDeviceProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE518
 * Callers:
 ...
 *     ?Thunk_UpdateHaptics_10@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED2A0 (-Thunk_UpdateHaptics_10@-$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEA.c)
 * Callees:
