/*
 * XREFs of ?FindEdgeWithInteraction@Edges@@AEBAHPEBGI@Z @ 0x180178FC0
 * Callers:
 ...
 *     ?IsClientPresent@Edge@@QEBA_NW4EdgyClient@@@Z @ 0x1801795DC (-IsClientPresent@Edge@@QEBA_NW4EdgyClient@@@Z.c)
