/*
 * XREFs of ??1?$variant@PEAXV?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@@std@@QEAA@XZ @ 0x180044AD4
 * Callers:
 ...
 *     _LegacyInputSinkData::LegacyInputSinkData_::_1_::dtor$0 @ 0x180044D39 (_LegacyInputSinkData--LegacyInputSinkData_--_1_--dtor$0.c)
 *     _InputSiteHierarchyManager::UpdateHierarchyFromInputSinkTreeCache_::_1_::dtor$78 @ 0x1800501F0 (_InputSiteHierarchyManager--UpdateHierarchyFromInputSinkTreeCache_--_1_--dtor$78.c)
 *     _InputSiteManager::GetInputSiteListFromDITCallbackStruct_::_1_::dtor$18 @ 0x180050370 (_InputSiteManager--GetInputSiteListFromDITCallbackStruct_--_1_--dtor$18.c)
 *     _InputSiteManager::GetInputSiteFromInputSinkHandle_::_1_::dtor$0 @ 0x1800F1533 (_InputSiteManager--GetInputSiteFromInputSinkHandle_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
