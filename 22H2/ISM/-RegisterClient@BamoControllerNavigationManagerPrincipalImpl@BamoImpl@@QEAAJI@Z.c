/*
 * XREFs of ?RegisterClient@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18011D7A8
 * Callers:
 *     ?Thunk_RegisterClient_10@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011E290 (-Thunk_RegisterClient_10@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigati.c)
 * Callees:
