/*
 * XREFs of ??$_Setp@VSpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@@?$shared_ptr@VSpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@@std@@AEAAXPEAVSpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@U?$integral_constant@_N$0A@@1@@Z @ 0x1801559C8
 * Callers:
