/*
 * XREFs of ?UpdateHierarchyFromInputSinkTreeCache@InputSiteHierarchyManager@@UEAAXXZ @ 0x180015300
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RemoveInputSinkFromParentList@InputSiteHierarchyManager@@AEAAX_K0@Z @ 0x180013900 (-RemoveInputSinkFromParentList@InputSiteHierarchyManager@@AEAAX_K0@Z.c)
 ...
 *     ??0LegacyInputSinkData@@QEAA@$$QEAV0@@Z @ 0x180014B38 (--0LegacyInputSinkData@@QEAA@$$QEAV0@@Z.c)
 ...
 *     ??1?$variant@PEAXV?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@@std@@QEAA@XZ @ 0x180044AD4 (--1-$variant@PEAXV-$unique_any_t@V-$unique_storage@U-$handle_null_resource_policy@P6AJPEAX@Z$1-N.c)
 *     ?GetProcessId@InputSite@@QEBAKXZ @ 0x180044AE0 (-GetProcessId@InputSite@@QEBAKXZ.c)
...
void __fastcall InputSiteHierarchyManager::UpdateHierarchyFromInputSinkTreeCache(InputSiteHierarchyManager *this)
{
  ...
  v3 = qword_1802094A8;
  v115 = qword_1802094A8;
  v179 = qword_1802094A8;
  v4 = (_QWORD *)xmmword_1802094B0;
  v114 = xmmword_1802094B0;
  v5 = *((_QWORD *)&xmmword_1802094B0 + 1);
  v180 = xmmword_1802094B0;
  qword_1802094A8 = 0LL;
  xmmword_1802094B0 = 0uLL;
  v167 = &SRWLock;
