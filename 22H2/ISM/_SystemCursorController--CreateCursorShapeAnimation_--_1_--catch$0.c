/*
 * XREFs of _SystemCursorController::CreateCursorShapeAnimation_::_1_::catch$0 @ 0x18013BFC6
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SystemCursorController::CreateCursorShapeAnimation_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
