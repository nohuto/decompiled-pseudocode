/*
 * XREFs of ?OnTargetWithFocusChanged@InputStateManager@@UEAAJPEAUIInputTarget@@0@Z @ 0x180019070
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *(_BYTE *)(v13 + 228) != (_BYTE)v6 )
    {
      *(_BYTE *)(v13 + 228) = v6;
      ...
      if ( (_BYTE)v6 )
      {
        ...
        v17 = v57[0];
        if ( v57[0] != (LPVOID)qword_180209C28 )
        {
LABEL_17:
          v17[10] = v16;
          goto LABEL_18;
...
LABEL_31:
      if ( v33 == v35 )
      {
        ...
        if ( v37 && *v37 > 1u )
        {
          ...
          {
            tlgWriteTransfer_EventWriteTransfer(v38, (int)&dword_1801CF192, 0, 0, 2u, &v60);
          }
        }
        v39 = *(_QWORD **)(v13 + 72);
