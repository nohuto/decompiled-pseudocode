/*
 * XREFs of ?DisableGamepadExclusivity@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x1800723D4
 * Callers:
 *     ?Thunk_DisableGamepadExclusivity_41@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180074600 (-Thunk_DisableGamepadExclusivity_41@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@.c)
 * Callees:
