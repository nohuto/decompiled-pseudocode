/*
 * XREFs of ?UpdateEnabledRemoteCacheStatic@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x18000A590
 * Callers:
        ...
        struct BamoImpl::BamoControllerNavigationManagerPrincipalImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 2) + 32LL) + 56LL) )
  {
    ...
    v10 = 0;
    v12[1] = v5;
    v7 = CoreUICallSend(SendHost, v12, 2LL, 15LL, v10, &unk_1801C01BD, v3);
