/*
 * XREFs of std::call_once__lambda_64a1b3f60083f412cbdb681d3efb1364___ @ 0x18008D264
 * Callers:
...
void __fastcall std::call_once__lambda_64a1b3f60083f412cbdb681d3efb1364___(__int64 a1, __int64 a2)
{
  ...
  else
  {
    ...
    std::_XGetLastError();
    __debugbreak();
    std::call_once__lambda_64a1b3f60083f412cbdb681d3efb1364____::_1_::dtor_0();
  }
}
