/*
 * XREFs of ?StartActivity@CreateSpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@@Z @ 0x1801646A4
 * Callers:
        ...
        int a4)
{
  ...
  if ( *v9 > 5u )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      (__int64)v9,
      (unsigned __int8 *)dword_1801CF8F6,
      (const GUID *)(v11 + 8),
      v10,
      7u,
      &v15);
