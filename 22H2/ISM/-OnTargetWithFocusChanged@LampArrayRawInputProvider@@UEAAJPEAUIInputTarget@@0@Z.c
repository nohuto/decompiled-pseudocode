/*
 * XREFs of ?OnTargetWithFocusChanged@LampArrayRawInputProvider@@UEAAJPEAUIInputTarget@@0@Z @ 0x180019C60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( (unsigned int)dword_1802063F0 > 5 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Level = 5;
    ...
    UserData.Ptr = (ULONGLONG)off_1802063F8;
    UserData.Size = *(unsigned __int16 *)off_1802063F8;
    UserData.Reserved = 2;
    v23 = &unk_1801CAD3F;
    v24 = 91;
    v25 = 1;
