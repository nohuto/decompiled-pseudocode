/*
 * XREFs of std::remove_if_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_BamoControllerNavigationOverrideProxy_________lambda_9df4cfb49f9aeda31819750223cddec6___ @ 0x18011C79C
 * Callers:
 ...
 *     ??4?$ComPtr@VBamoInputAttemptedDeliveryClientProxy@@@WRL@Microsoft@@QEAAAEAV012@$$QEAV012@@Z @ 0x180103C3C (--4-$ComPtr@VBamoInputAttemptedDeliveryClientProxy@@@WRL@Microsoft@@QEAAAEAV012@$$QEAV012@@Z.c)
 *     _lambda_9df4cfb49f9aeda31819750223cddec6_::operator()_Microsoft::WRL::ComPtr_BamoControllerNavigationOverrideProxy___ @ 0x18011C440 (_lambda_9df4cfb49f9aeda31819750223cddec6_--operator()_Microsoft--WRL--ComPtr_BamoControllerNavig.c)
 */
