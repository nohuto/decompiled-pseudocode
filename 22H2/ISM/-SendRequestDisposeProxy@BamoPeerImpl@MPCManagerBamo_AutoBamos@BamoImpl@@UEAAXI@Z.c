/*
 * XREFs of ?SendRequestDisposeProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@UEAAXI@Z @ 0x1800740E0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v5 = 10;
  v4 = CoreUICallSend(v3, v6, 2LL, 1LL, v5, &unk_1801C2943, a2);
  if ( v4 < 0 )
  {
