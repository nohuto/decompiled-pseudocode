/*
 * XREFs of ?ReleasePrivateReference@SharedObjectBase@@IEAAIXZ @ 0x1800BEEF0
 * Callers:
 ...
 *     ?ReleasePrivateReference@SipcServer@@UEAAXXZ @ 0x1800C1A10 (-ReleasePrivateReference@SipcServer@@UEAAXXZ.c)
 * Callees:
