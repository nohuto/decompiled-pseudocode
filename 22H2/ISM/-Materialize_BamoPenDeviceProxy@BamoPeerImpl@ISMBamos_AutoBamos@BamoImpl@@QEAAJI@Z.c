/*
 * XREFs of ?Materialize_BamoPenDeviceProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7F70
 * Callers:
 *     ?Thunk_Materialize_BamoPenDeviceProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED030 (-Thunk_Materialize_BamoPenDeviceProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@IS.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoPenDeviceProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoPenDeviceProxy::`vftable'{for `IPenDeviceProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
  v9[2] = &BamoImpl::BamoPenDeviceProxyImpl::`vftable';
  *((_OWORD *)v9 + 3) = 0LL;
  v9[8] = 0LL;
