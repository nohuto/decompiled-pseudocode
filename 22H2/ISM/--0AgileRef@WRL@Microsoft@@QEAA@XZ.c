/*
 * XREFs of ??0AgileRef@WRL@Microsoft@@QEAA@XZ @ 0x18001BA10
 * Callers:
 *     ?Close@?$CMarshaledInterfaceResult@UIPropertyValue@Foundation@Windows@@@Internal@Windows@@QEAAXXZ @ 0x1801132AC (-Close@-$CMarshaledInterfaceResult@UIPropertyValue@Foundation@Windows@@@Internal@Windows@@QEAAXX.c)
