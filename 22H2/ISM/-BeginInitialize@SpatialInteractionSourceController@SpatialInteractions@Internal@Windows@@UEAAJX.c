/*
 * XREFs of ?BeginInitialize@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJXZ @ 0x18016AB40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??B_Atomic_llong@std@@QEBA_JXZ @ 0x18016A228 (--B_Atomic_llong@std@@QEBA_JXZ.c)
 */
