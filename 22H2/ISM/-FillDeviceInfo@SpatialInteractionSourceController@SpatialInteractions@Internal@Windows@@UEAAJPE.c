/*
 * XREFs of ?FillDeviceInfo@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJPEAUMPCSourceDeviceInfo@@@Z @ 0x18016C650
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StringCchCopyNW@@YAJPEA_W_KPEB_W1@Z @ 0x1800E2210 (-StringCchCopyNW@@YAJPEA_W_KPEB_W1@Z.c)
 */
