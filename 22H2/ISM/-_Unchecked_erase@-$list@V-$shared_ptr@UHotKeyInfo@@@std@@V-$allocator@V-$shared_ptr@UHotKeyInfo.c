/*
 * XREFs of ?_Unchecked_erase@?$list@V?$shared_ptr@UHotKeyInfo@@@std@@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@AEAA?AV?$_List_unchecked_const_iterator@V?$_List_val@U?$_List_simple_types@V?$shared_ptr@UHotKeyInfo@@@std@@@std@@@std@@U_Iterator_base0@2@@2@V32@0@Z @ 0x1801A234C
 * Callers:
 ...
 *     _lambda_139f71076f5ab0ecef881a1ffc08c112_::operator() @ 0x18019F618 (_lambda_139f71076f5ab0ecef881a1ffc08c112_--operator().c)
 ...
 *     ??_G?$shared_ptr@UHotKeyInfo@@@std@@QEAAPEAXI@Z @ 0x18019F9A8 (--_G-$shared_ptr@UHotKeyInfo@@@std@@QEAAPEAXI@Z.c)
 */
