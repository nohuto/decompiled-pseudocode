/*
 * XREFs of ?AllocateStub@BamoAsyncResult_PROPVARIANT_Principal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoAsyncResult_PROPVARIANT_Stub@@@Z @ 0x18011A830
 * Callers:
 *     <none>
 * Callees:
