/*
 * XREFs of ?Materialize_BamoResizeControllerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E81C0
 * Callers:
 *     ?Thunk_Materialize_BamoResizeControllerClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED0A0 (-Thunk_Materialize_BamoResizeControllerClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBa.c)
 * Callees:
