/*
 * XREFs of ?AugmentedInputDevice_DeviceRemoved_@RawInputProvidersTracing@@QEAAXI@Z @ 0x18008F694
 * Callers:
...
void __fastcall RawInputProvidersTracing::AugmentedInputDevice_DeviceRemoved_(RawInputProvidersTracing *this, int a2)
{
  ...
  if ( **(_DWORD **)(v3 + 8) > 4u && tlgKeywordOn(*(_QWORD *)(v3 + 8), 2LL) )
  {
    ...
    v5 = a2;
    v8 = 4;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801CA16B, 0LL, 0LL, 3u, &v6);
  }
}
