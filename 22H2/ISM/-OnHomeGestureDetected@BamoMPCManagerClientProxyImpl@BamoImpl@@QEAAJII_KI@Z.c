/*
 * XREFs of ?OnHomeGestureDetected@BamoMPCManagerClientProxyImpl@BamoImpl@@QEAAJII_KI@Z @ 0x180109620
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 5;
      return CoreUICallSend(v8, v11, 2LL, 5LL, v9, &unk_1801C2989, a2);
    }
    else
    {
