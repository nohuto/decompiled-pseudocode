/*
 * XREFs of ?PublishAdditionIfNeeded@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEAAJPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800DC650
 * Callers:
 *     <none>
 * Callees:
