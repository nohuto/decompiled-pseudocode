/*
 * XREFs of ?ResetState@MPCButtonHoldHelper@@QEAAXXZ @ 0x180085324
 * Callers:
 *     ?ResetState@MPCSlateDeadzoneHelper@@QEAAXXZ @ 0x180085148 (-ResetState@MPCSlateDeadzoneHelper@@QEAAXXZ.c)
