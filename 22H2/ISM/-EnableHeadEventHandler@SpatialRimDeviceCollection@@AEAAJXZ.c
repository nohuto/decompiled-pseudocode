/*
 * XREFs of ?EnableHeadEventHandler@SpatialRimDeviceCollection@@AEAAJXZ @ 0x1800933BC
 * Callers:
 ...
 *     ??0SpatialRimDeviceCollectionHeadEventHandler@@QEAA@XZ @ 0x180092650 (--0SpatialRimDeviceCollectionHeadEventHandler@@QEAA@XZ.c)
