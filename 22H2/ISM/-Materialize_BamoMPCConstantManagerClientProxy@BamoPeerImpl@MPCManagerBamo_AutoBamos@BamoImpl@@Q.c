/*
 * XREFs of ?Materialize_BamoMPCConstantManagerClientProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180072F4C
 * Callers:
 *     ?Thunk_Materialize_BamoMPCConstantManagerClientProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180074760 (-Thunk_Materialize_BamoMPCConstantManagerClientProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Rec.c)
 * Callees:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  v5 = (unsigned int)a2;
  BamoImpl::CreateMPCConstantManagerClientProxy(
