...
void __fastcall __noreturn std::_Tree_std::_Tmap_traits__GUID_wil::com_ptr_t_PenDevice_wil::err_exception_policy__PenDeviceManager::GUIDComparer_std::allocator_std::pair__GUID_const__wil::com_ptr_t_PenDevice_wil::err_exception_policy______0___::_Insert_nohint_std::pair__GUID_const__wil::com_ptr_t_PenDevice_wil::err_exception_policy______std::_Tree_node_std::pair__GUID_const__wil::com_ptr_t_PenDevice_wil::err_exception_policy____void_______::_1_::catch_19(
        __int64 a1,
        __int64 a2)
{
