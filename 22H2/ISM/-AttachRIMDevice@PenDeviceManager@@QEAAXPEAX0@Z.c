/*
 * XREFs of ?AttachRIMDevice@PenDeviceManager@@QEAAXPEAX0@Z @ 0x18012F164
 * Callers:
 ...
 *     ??$_Try_emplace@AEBQEAX$$V@?$unordered_map@PEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@U?$hash@PEAX@std@@U?$equal_to@PEAX@4@V?$allocator@U?$pair@QEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@@4@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@QEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@@std@@@std@@_N@1@AEBQEAX@Z @ 0x18012E78C (--$_Try_emplace@AEBQEAX$$V@-$unordered_map@PEAXV-$com_ptr_t@VPenDevice@@Uerr_exception_policy@wi.c)
