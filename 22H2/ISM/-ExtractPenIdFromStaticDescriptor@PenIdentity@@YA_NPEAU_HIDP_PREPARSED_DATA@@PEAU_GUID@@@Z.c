/*
 * XREFs of ?ExtractPenIdFromStaticDescriptor@PenIdentity@@YA_NPEAU_HIDP_PREPARSED_DATA@@PEAU_GUID@@@Z @ 0x180132210
 * Callers:
 ...
 *     ?CreatePenId@PenIdentity@@YA_NG_KPEAU_GUID@@@Z @ 0x180132028 (-CreatePenId@PenIdentity@@YA_NG_KPEAU_GUID@@@Z.c)
 */
