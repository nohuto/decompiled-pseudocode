/*
 * XREFs of ?GiveSpatialDataToPID@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180108BDC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerProxyImpl::GiveSpatialDataToPID(
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v9[0] = v11;
      v9[1] = v12;
      return CoreUICallSend(v7, v9, 2LL, 3LL, 0, &unk_1801C2969, a2);
    }
    else
    {
