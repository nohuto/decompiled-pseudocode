/*
 * XREFs of std::call_once__lambda_8c4ed463577f4da5b58359432c7ff390___ @ 0x1801976FC
 * Callers:
...
void __fastcall std::call_once__lambda_8c4ed463577f4da5b58359432c7ff390___(__int64 a1, __int64 a2)
{
  ...
  else
  {
    ...
    std::_XGetLastError();
    __debugbreak();
    std::call_once__lambda_8c4ed463577f4da5b58359432c7ff390____::_1_::dtor_0();
  }
}
