/*
 * XREFs of ?Create@ControllerProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180120B10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsPointerDevice@@YAHPEBUDeviceInfo@@@Z @ 0x1801493AC (-IsPointerDevice@@YAHPEBUDeviceInfo@@@Z.c)
 */
