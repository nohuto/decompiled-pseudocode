/*
 * XREFs of ?EnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18013CB3C
 * Callers:
 *     ?Thunk_EnsureServiceAndRegisterClient_10@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013D270 (-Thunk_EnsureServiceAndRegisterClient_10@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemC.c)
 * Callees:
