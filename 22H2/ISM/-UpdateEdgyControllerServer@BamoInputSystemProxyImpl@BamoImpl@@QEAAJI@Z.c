/*
 * XREFs of ?UpdateEdgyControllerServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE0C8
 * Callers:
 ...
 *     ?Thunk_UpdateEdgyControllerServer_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED230 (-Thunk_UpdateEdgyControllerServer_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoI.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 7) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 80LL))((char *)this - 16);
    if ( v9 < 0 )
