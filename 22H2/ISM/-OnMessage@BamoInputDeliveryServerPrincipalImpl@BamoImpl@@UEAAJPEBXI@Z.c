/*
 * XREFs of ?OnMessage@BamoInputDeliveryServerPrincipalImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x180001FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputDeliveryServerPrincipalImpl::OnMessage(
        ...
        const void *a2)
{
  ...
  result = CoreUICallReceive(
             *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 72LL),
             &IInputDeliveryServerPrincipal_Receive<BamoImpl::BamoInputDeliveryServerPrincipalImpl>::Type,
