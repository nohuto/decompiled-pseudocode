/*
 * XREFs of ?RequestGripStatusForPanel@BamoHeatGripServicePrincipalImpl@BamoImpl@@QEAAJPEAUHeatPanelInfo@@@Z @ 0x18012A8D8
 * Callers:
 *     ?Thunk_RequestGripStatusForPanel_146@?$IHeatGripServicePrincipal_Receive@VBamoHeatGripServicePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18012AA90 (-Thunk_RequestGripStatusForPanel_146@-$IHeatGripServicePrincipal_Receive@VBamoHeatGripServicePri.c)
 * Callees:
