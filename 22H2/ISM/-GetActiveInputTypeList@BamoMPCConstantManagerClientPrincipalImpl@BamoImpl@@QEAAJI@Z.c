/*
 * XREFs of ?GetActiveInputTypeList@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18006EA28
 * Callers:
 *     ?Thunk_GetActiveInputTypeList_25@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180070690 (-Thunk_GetActiveInputTypeList_25@-$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantMa.c)
 * Callees:
