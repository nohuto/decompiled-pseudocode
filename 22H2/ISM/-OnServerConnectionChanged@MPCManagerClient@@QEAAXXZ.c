/*
 * XREFs of ?OnServerConnectionChanged@MPCManagerClient@@QEAAXXZ @ 0x180109FD0
 * Callers:
 *     ?OnPeerDisconnected@MPCManagerClientConnection@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@_N@Z @ 0x18011A550 (-OnPeerDisconnected@MPCManagerClientConnection@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@_N@Z.c)
 *     ?SetBootstrapProxy@MPCManagerClientConnection@@MEAAJPEAVBamoProxy@Bamo@Microsoft@@@Z @ 0x18011A570 (-SetBootstrapProxy@MPCManagerClientConnection@@MEAAJPEAVBamoProxy@Bamo@Microsoft@@@Z.c)
 * Callees:
...
void __fastcall MPCManagerClient::OnServerConnectionChanged(RTL_SRWLOCK *this)
{
  ...
  LOBYTE(v7) = *((_QWORD *)this[203].Ptr + 23) != 0LL;
  ...
  *(_QWORD *)v5 = &v7;
  v7 = this;
  *(_QWORD *)&v5[2] = &v8;
  v4 = Microsoft::WRL::EventSource<Windows::Foundation::ITypedEventHandler<Windows::Internal::Input::MPCManager::MPCManagerClient *,Windows::Internal::Input::MPCManager::HomeGestureEventArgs *>,Microsoft::WRL::InvokeModeOptions<-2>>::DoInvoke<_lambda_d0f00b216f9e073402124dc24bf27ba2_>(
         this + 213,
         (__int128 *)v5);
  if ( v4 < 0 )
  {
