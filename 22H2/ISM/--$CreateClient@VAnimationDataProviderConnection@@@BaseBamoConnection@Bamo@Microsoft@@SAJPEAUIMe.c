/*
 * XREFs of ??$CreateClient@VAnimationDataProviderConnection@@@BaseBamoConnection@Bamo@Microsoft@@SAJPEAUIMessageSession@@UMsgScopeID@@PEBGPEAPEAVAnimationDataProviderConnection@@@Z @ 0x180031888
 * Callers:
 *     ?RuntimeClassInitialize@AnimationDataProvider@@UEAAJXZ @ 0x1800317D0 (-RuntimeClassInitialize@AnimationDataProvider@@UEAAJXZ.c)
 * Callees:
 *     ?_Get@?$_Func_impl_no_alloc@V?$_Binder@U_Unforced@std@@P8MPCRawInputProvider@@EAAX_N@ZPEAV3@AEBU?$_Ph@$00@2@@std@@X_N@std@@EEBAPEBXXZ @ 0x18001B810 (-_Get@-$_Func_impl_no_alloc@V-$_Binder@U_Unforced@std@@P8MPCRawInputProvider@@EAAX_N@ZPEAV3@AEBU.c)
