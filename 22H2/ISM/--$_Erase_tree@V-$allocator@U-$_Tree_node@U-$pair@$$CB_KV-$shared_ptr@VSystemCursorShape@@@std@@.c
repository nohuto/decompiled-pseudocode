 ...
 *     ??_GSystemCursorController@@UEAAPEAXI@Z @ 0x18013B7B0 (--_GSystemCursorController@@UEAAPEAXI@Z.c)
 ...
 *     ?_Destroy@?$_Ref_count_obj@VSystemCursor@@@std@@EEAAXXZ @ 0x180140BC0 (-_Destroy@-$_Ref_count_obj@VSystemCursor@@@std@@EEAAXXZ.c)
 * Callees:
