/*
 * XREFs of ?UpdateStartPosition@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJPEAUtagPOINT@@@Z @ 0x18011EF78
 * Callers:
 ...
 *     ?Thunk_UpdateStartPosition_19@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011EAE0 (-Thunk_UpdateStartPosition_19@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigati.c)
 * Callees:
