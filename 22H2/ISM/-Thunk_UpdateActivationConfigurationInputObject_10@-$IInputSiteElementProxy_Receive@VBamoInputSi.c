/*
 * XREFs of ?Thunk_UpdateActivationConfigurationInputObject_10@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000BAD0
 * Callers:
 *     <none>
 * Callees:
