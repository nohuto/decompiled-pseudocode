/*
 * XREFs of ?GetClientsForProcess@PenEventsDispatcherPrincipal@@AEAA?AV?$vector@V?$com_ptr_t@VPenEventsClientCustomProxy@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VPenEventsClientCustomProxy@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@I@Z @ 0x180133320
 * Callers:
...
__int64 *__fastcall PenEventsDispatcherPrincipal::GetClientsForProcess(__int64 a1, __int64 *a2, int a3)
{
  ...
  *a2 = 0LL;
  ...
  {
    if ( !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)(i[3] + 8) + 120LL))(i[3] + 8) )
    {
      if ( a2[2] == a2[1] )
      {
