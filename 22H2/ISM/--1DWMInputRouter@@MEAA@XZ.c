/*
 * XREFs of ??1DWMInputRouter@@MEAA@XZ @ 0x180137ADC
 * Callers:
 *     _MPCInputRouter::MPCInputRouter_::_1_::dtor$0 @ 0x18004F225 (_MPCInputRouter--MPCInputRouter_--_1_--dtor$0.c)
 *     ??1MPCInputRouter@@EEAA@XZ @ 0x1800B79E0 (--1MPCInputRouter@@EEAA@XZ.c)
 *     ??_EDWMInputRouter@@MEAAPEAXI@Z @ 0x180138020 (--_EDWMInputRouter@@MEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ?RemoveTarget@DWMInputRouter@@AEAA?AV?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBUtagMsgRoutingInfo@@PEAUIInputTarget@@@std@@@std@@@std@@@std@@V23@@Z @ 0x180139238 (-RemoveTarget@DWMInputRouter@@AEAA-AV-$_List_iterator@V-$_List_val@U-$_List_simple_types@U-$pair.c)
 */
