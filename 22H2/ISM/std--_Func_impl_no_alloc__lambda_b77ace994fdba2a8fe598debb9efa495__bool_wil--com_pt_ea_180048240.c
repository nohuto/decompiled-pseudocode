/*
 * XREFs of std::_Func_impl_no_alloc__lambda_b77ace994fdba2a8fe598debb9efa495__bool_wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy__bool_::_Do_call @ 0x180048240
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall std::_Func_impl_no_alloc__lambda_b77ace994fdba2a8fe598debb9efa495__bool_wil::com_ptr_t_PenEventsClientCustomProxy_wil::err_exception_policy__bool_::_Do_call(
        __int64 a1,
        __int64 *a2,
        char *a3)
{
  ...
  *a2 = 0LL;
  v10 = v4;
  v11 = &v10;
  if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)(v4 + 8) + 80LL))(v4 + 8) )
  {
    LOBYTE(v6) = v3;
    v7 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(v10 + 8) + 24LL))(v10 + 8, v6);
    if ( v7 < 0 )
