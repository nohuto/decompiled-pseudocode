/*
 * XREFs of ?MPCManager_InitializationFailed_@ISMTracing@@QEAAXJ@Z @ 0x1800729F8
 * Callers:
...
void __fastcall ISMTracing::MPCManager_InitializationFailed_(ISMTracing *this, int a2)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( **((_DWORD **)v4 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v4 + 1), 1LL) )
    {
      ...
      v6 = a2;
      v9 = 4;
      tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_1801C88DF, 0LL, 0LL, 3u, &v7);
    }
  }
}
