/*
 * XREFs of ??1PenEventsDispatcherPrincipal@@UEAA@XZ @ 0x180132904
 * Callers:
 *     ??_EPenEventsDispatcherPrincipal@@UEAAPEAXI@Z @ 0x180132A80 (--_EPenEventsDispatcherPrincipal@@UEAAPEAXI@Z.c)
 * Callees:
