/*
 * XREFs of ??$Make@VHomeGestureReadyChangedEventArgs@@AEA_NAEAIAEAIAEA_KAEAIAEAI@Details@WRL@Microsoft@@YA?AV?$ComPtr@VHomeGestureReadyChangedEventArgs@@@12@AEA_NAEAI1AEA_K11@Z @ 0x1801062A4
 * Callers:
 ...
 *     ??0HomeGestureReadyChangedEventArgs@@QEAA@_NII_KII@Z @ 0x180106864 (--0HomeGestureReadyChangedEventArgs@@QEAA@_NII_KII@Z.c)
 */
