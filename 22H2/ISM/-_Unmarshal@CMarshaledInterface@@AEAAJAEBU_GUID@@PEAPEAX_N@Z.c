/*
 * XREFs of ?_Unmarshal@CMarshaledInterface@@AEAAJAEBU_GUID@@PEAPEAX_N@Z @ 0x180119E14
 * Callers:
 ...
 *     ?Unmarshal@CMarshalStream@CMarshaledInterface@@QEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180119160 (-Unmarshal@CMarshalStream@CMarshaledInterface@@QEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
