/*
 * XREFs of ?OnHitTest@EdgyProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x180178080
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EnsureEdgeMetricsForDisplay@EdgyProcessor@@IEAAXPEBUHitTestInfo@@@Z @ 0x180177F04 (-EnsureEdgeMetricsForDisplay@EdgyProcessor@@IEAAXPEBUHitTestInfo@@@Z.c)
 *     ?QualifyEdgyHitTestInputReport@EdgyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@@Z @ 0x180178328 (-QualifyEdgyHitTestInputReport@EdgyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@@Z.c)
