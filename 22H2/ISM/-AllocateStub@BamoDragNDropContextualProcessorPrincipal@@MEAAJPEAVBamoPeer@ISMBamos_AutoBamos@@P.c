/*
 * XREFs of ?AllocateStub@BamoDragNDropContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoDragNDropContextualProcessorStub@@@Z @ 0x180010010
 * Callers:
 *     <none>
 * Callees:
