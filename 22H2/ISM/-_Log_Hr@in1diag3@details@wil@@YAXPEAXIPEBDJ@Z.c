 ...
 *     ?OnConnected@HotKeyClient@@UEAAJPEAUIMessageProxy@@@Z @ 0x180148390 (-OnConnected@HotKeyClient@@UEAAJPEAUIMessageProxy@@@Z.c)
 *     ?OnHotKeyAllKeysUp@HotKeyClient@@UEAAJIII_K@Z @ 0x1801485D0 (-OnHotKeyAllKeysUp@HotKeyClient@@UEAAJIII_K@Z.c)
 *     ?OnHotKeyDetected@HotKeyClient@@UEAAJIII_K@Z @ 0x180148620 (-OnHotKeyDetected@HotKeyClient@@UEAAJIII_K@Z.c)
 *     ?OnProxyCreated@HotKeyClient@@UEAAJPEAUIMessageProxy@@@Z @ 0x180148670 (-OnProxyCreated@HotKeyClient@@UEAAJPEAUIMessageProxy@@@Z.c)
 ...
 *     ?Cancel@SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@UEAAXXZ @ 0x18016AEC0 (-Cancel@SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@UEAAXXZ.c)
 ...
 *     ?SetLocked@DWMCursorBroker@@UEAAJUCursorIdInfo@@_N@Z @ 0x18019C2D0 (-SetLocked@DWMCursorBroker@@UEAAJUCursorIdInfo@@_N@Z.c)
