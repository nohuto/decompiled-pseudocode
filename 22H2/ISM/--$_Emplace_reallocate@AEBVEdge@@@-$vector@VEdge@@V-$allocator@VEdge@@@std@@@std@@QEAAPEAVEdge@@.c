/*
 * XREFs of ??$_Emplace_reallocate@AEBVEdge@@@?$vector@VEdge@@V?$allocator@VEdge@@@std@@@std@@QEAAPEAVEdge@@QEAV2@AEBV2@@Z @ 0x18017862C
 * Callers:
 ...
 *     ??$_Get_size_of_n@$0IA@@std@@YA_K_K@Z @ 0x18004A110 (--$_Get_size_of_n@$0IA@@std@@YA_K_K@Z.c)
