/*
 * XREFs of ?GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAA_NXZ @ 0x18015EEF0
 * Callers:
 *     ?GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAA_NXZ @ 0x18004D670 (-GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAA_NXZ.c)
 * Callees:
