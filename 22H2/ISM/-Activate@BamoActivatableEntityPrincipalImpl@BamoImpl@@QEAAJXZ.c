/*
 * XREFs of ?Activate@BamoActivatableEntityPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x180105800
 * Callers:
 *     ?Thunk_Activate_0@?$IActivatableEntityPrincipal_Receive@VBamoActivatableEntityPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180105BD0 (-Thunk_Activate_0@-$IActivatableEntityPrincipal_Receive@VBamoActivatableEntityPrincipalImpl@Bamo.c)
 * Callees:
