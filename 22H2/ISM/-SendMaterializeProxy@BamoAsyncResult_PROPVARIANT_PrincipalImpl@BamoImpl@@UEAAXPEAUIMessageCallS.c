/*
 * XREFs of ?SendMaterializeProxy@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18011AAE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v15, 2LL, 1LL, 2, &unk_1801C2943, v13);
  if ( v8 < 0 )
  {
