/*
 * XREFs of ??1?$unordered_map@_KV?$shared_ptr@VSystemCursor@@@std@@U?$hash@_K@2@U?$equal_to@_K@2@V?$allocator@U?$pair@$$CB_KV?$shared_ptr@VSystemCursor@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x18013B604
 * Callers:
 *     _SystemCursorService::SystemCursorService_::_1_::dtor$2 @ 0x18013E752 (_SystemCursorService--SystemCursorService_--_1_--dtor$2.c)
 * Callees:
