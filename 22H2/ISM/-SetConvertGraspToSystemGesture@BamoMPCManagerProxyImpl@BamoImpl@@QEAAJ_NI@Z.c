/*
 * XREFs of ?SetConvertGraspToSystemGesture@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18010B86C
 * Callers:
        ...
        unsigned __int8 a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 6;
      return CoreUICallSend(v8, v10, 2LL, 3LL, v9, &unk_1801C297B, v3);
    }
    else
    {
