/*
 * XREFs of ?UpdateType@BamoDropTargetClientProxyImpl@BamoImpl@@QEAAJPEAU_GUID@@@Z @ 0x1800EFDFC
 * Callers:
 ...
 *     ?Thunk_UpdateType_29@?$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED4D0 (-Thunk_UpdateType_29@-$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@.c)
 * Callees:
