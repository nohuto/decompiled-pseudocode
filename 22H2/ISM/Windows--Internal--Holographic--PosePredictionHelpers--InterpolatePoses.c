/*
 * XREFs of Windows::Internal::Holographic::PosePredictionHelpers::InterpolatePoses @ 0x18015FBC0
 * Callers:
 *     ?InterpolatePoses@ConstantVelocityPosePredictionModel@Holographic@Internal@Windows@@UEAAJAEBUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@0_JPEAU5@@Z @ 0x18015FBA0 (-InterpolatePoses@ConstantVelocityPosePredictionModel@Holographic@Internal@Windows@@UEAAJAEBUSPA.c)
 * Callees:
