 ...
 *     UsbDevice_DropEndpointsCompletion @ 0x1C0046120 (UsbDevice_DropEndpointsCompletion.c)
 ...
 * 00000001C0010D0F: jb      loc_1C0024FFC
 ...
 * 00000001C0024FFC: lea     rcx, [rdi+rdi*4]
 * 00000001C0025000: add     rcx, rcx
 * 00000001C0025003: cmp     [r10+rcx*8+29h], sil
 * 00000001C0025008: jb      loc_1C0010D15
 * 00000001C002500E: and     [rsp+68h+var_28], 0
 * 00000001C0025014: lea     rdx, [rsp+68h+arg_30]
 * 00000001C002501C: mov     rax, cs:WPP_MAIN_CB.Reserved
 * 00000001C0025023: mov     r9d, ebp
 * 00000001C0025026: mov     r8, [rsp+68h+arg_20]
 * 00000001C002502E: mov     rcx, [r10+rcx*8+18h]
 * 00000001C0025033: mov     [rsp+68h+var_30], rbx
 * 00000001C0025038: mov     [rsp+68h+var_38], rdx
 * 00000001C002503D: lea     rdx, [rsp+68h+arg_28]
 * 00000001C0025045: mov     [rsp+68h+var_40], 4
 * 00000001C002504E: mov     [rsp+68h+var_48], rdx
 * 00000001C0025053: mov     edx, 2Bh ; '+'
 * 00000001C0025058: call    cs:__guard_dispatch_icall_fptr
 * 00000001C002505E: nop
 * 00000001C002505F: jmp     loc_1C0010D15
 */
