/*
 * XREFs of DriverEntry @ 0x1C00743A0
 * Callers:
 *     FxDriverEntryWorker @ 0x1C001CE04 (FxDriverEntryWorker.c)
 * Callees:
 *     McGenEventRegister_EtwRegister @ 0x1C001D070 (McGenEventRegister_EtwRegister.c)
 *     InitializeTelemetryAssertsKMByDriverObject @ 0x1C001D0A4 (InitializeTelemetryAssertsKMByDriverObject.c)
 ...
 *     Counter_Register @ 0x1C00748B8 (Counter_Register.c)
 *     WppLoadTracingSupport @ 0x1C00749C8 (WppLoadTracingSupport.c)
 *     TraceLoggingRegister_EtwRegister_EtwSetInformation @ 0x1C0079998 (TraceLoggingRegister_EtwRegister_EtwSetInformation.c)
