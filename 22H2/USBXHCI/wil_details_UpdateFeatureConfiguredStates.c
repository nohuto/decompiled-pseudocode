/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x1C006D2C0
 * Callers:
 *     wil_details_OnFeatureConfigurationChange @ 0x1C006D240 (wil_details_OnFeatureConfigurationChange.c)
 * Callees:
 ...
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x1C006D038 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
...
volatile signed __int32 **wil_details_UpdateFeatureConfiguredStates()
{
  ...
  for ( i = &Feature_USB4PowerImprovements__private_descriptor; ; i = v4 + 6 )
  {
