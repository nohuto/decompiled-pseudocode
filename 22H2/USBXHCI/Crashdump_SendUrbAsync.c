/*
 * XREFs of Crashdump_SendUrbAsync @ 0x1C004CEB0
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_DoBulkTransfer @ 0x1C004C10C (Crashdump_DoBulkTransfer.c)
 *     Crashdump_ResetPipe @ 0x1C004CD40 (Crashdump_ResetPipe.c)
