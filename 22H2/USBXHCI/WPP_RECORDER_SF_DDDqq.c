 ...
 * 00000001C000CFF5: jnz     loc_1C001EA9E
 ...
 * 00000001C001EA9E: cmp     [rcx+29h], bl
 * 00000001C001EAA1: jb      loc_1C000CFFB
 * 00000001C001EAA7: and     [rsp+88h+var_18], 0
 * 00000001C001EAAD: lea     rdx, [rsp+88h+arg_48]
 * 00000001C001EAB5: mov     rax, cs:WPP_MAIN_CB.Reserved
 * 00000001C001EABC: lea     r8, WPP_f900c8e8530d3ebbc4303e7a1e3d0cbe_Traceguids
 * 00000001C001EAC3: mov     rcx, [rcx+18h]
 * 00000001C001EAC7: mov     r9d, edi
 * 00000001C001EACA: mov     [rsp+88h+var_20], r14
 * 00000001C001EACF: mov     [rsp+88h+var_28], rdx
 * 00000001C001EAD4: lea     rdx, [rsp+88h+arg_40]
 * 00000001C001EADC: mov     [rsp+88h+var_30], r14
 * 00000001C001EAE1: mov     [rsp+88h+var_38], rdx
 * 00000001C001EAE6: lea     rdx, [rsp+88h+arg_38]
 * 00000001C001EAEE: mov     [rsp+88h+var_40], rbp
 * 00000001C001EAF3: mov     [rsp+88h+var_48], rdx
 * 00000001C001EAF8: lea     rdx, [rsp+88h+arg_30]
 * 00000001C001EB00: mov     [rsp+88h+var_50], rbp
 * 00000001C001EB05: mov     [rsp+88h+var_58], rdx
 * 00000001C001EB0A: lea     rdx, [rsp+88h+arg_28]
 * 00000001C001EB12: mov     [rsp+88h+var_60], rbp
 * 00000001C001EB17: mov     [rsp+88h+var_68], rdx
 * 00000001C001EB1C: mov     edx, 2Bh ; '+'
 * 00000001C001EB21: call    cs:__guard_dispatch_icall_fptr
 * 00000001C001EB27: nop
 * 00000001C001EB28: jmp     loc_1C000CFFB
 */
