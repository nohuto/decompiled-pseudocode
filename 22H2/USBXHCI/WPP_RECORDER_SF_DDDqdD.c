 ...
 * 00000001C000CAF1: jnz     loc_1C001E58A
 ...
 * 00000001C001E58A: cmp     [rcx+29h], dil
 * 00000001C001E58E: jb      loc_1C000CAF7
 * 00000001C001E594: and     [rsp+90h+var_10], 0
 * 00000001C001E59D: lea     rdx, [rbp+1Fh+arg_50]
 * 00000001C001E5A1: mov     rax, cs:WPP_MAIN_CB.Reserved
 * 00000001C001E5A8: lea     r8, WPP_f900c8e8530d3ebbc4303e7a1e3d0cbe_Traceguids
 * 00000001C001E5AF: mov     rcx, [rcx+18h]
 * 00000001C001E5B3: mov     [rsp+90h+var_18], rdi
 * 00000001C001E5B8: mov     [rsp+90h+var_20], rdx
 * 00000001C001E5BD: lea     rdx, [rbp+1Fh+arg_48]
 * 00000001C001E5C1: mov     [rsp+90h+var_28], rdi
 * 00000001C001E5C6: mov     [rsp+90h+var_30], rdx
 * 00000001C001E5CB: lea     rdx, [rbp+1Fh+arg_40]
 * 00000001C001E5CF: mov     [rsp+90h+var_38], 8
 * 00000001C001E5D8: mov     [rsp+90h+var_40], rdx
 * 00000001C001E5DD: lea     rdx, [rbp+1Fh+arg_38]
 * 00000001C001E5E1: mov     [rsp+90h+var_48], rdi
 * 00000001C001E5E6: mov     [rsp+90h+var_50], rdx
 * 00000001C001E5EB: lea     rdx, [rbp+1Fh+arg_30]
 * 00000001C001E5EF: mov     [rsp+90h+var_58], rdi
 * 00000001C001E5F4: mov     [rsp+90h+var_60], rdx
 * 00000001C001E5F9: lea     rdx, [rbp+1Fh+arg_28]
 * 00000001C001E5FD: mov     [rsp+90h+var_68], rdi
 * 00000001C001E602: mov     [rsp+90h+var_70], rdx
 * 00000001C001E607: mov     edx, 2Bh ; '+'
 * 00000001C001E60C: movzx   r9d, r14w
 * 00000001C001E610: call    cs:__guard_dispatch_icall_fptr
 * 00000001C001E616: nop
 * 00000001C001E617: jmp     loc_1C000CAF7
 */
