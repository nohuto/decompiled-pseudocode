/*
 * XREFs of Controller_WdfEvtDevicePrepareHardware @ 0x1C006D0A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDevicePrepareHardware(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0x2000000LL;
  ...
  {
    LOBYTE(v7) = 4;
    WPP_RECORDER_SF_i(*(_QWORD *)(v6 + 72), v7, 4, 46, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, a1);
  }
...
LABEL_32:
  ...
  {
    LOBYTE(v21) = 1;
    WPP_RECORDER_SF_d(*(_QWORD *)(v6 + 72), v21, 4, 50, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, v11);
  }
