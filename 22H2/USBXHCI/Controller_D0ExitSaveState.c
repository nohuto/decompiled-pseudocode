/*
 * XREFs of Controller_D0ExitSaveState @ 0x1C0030E1C
 * Callers:
...
__int64 __fastcall Controller_D0ExitSaveState(__int64 a1, char a2, __int64 a3, int a4)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 124, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids);
  ...
  if ( (Ulong & 1) != 0 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 128, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids);
  ...
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v12 = 125;
LABEL_14:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2, 4, v12, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids);
  }
LABEL_35:
  v4 = -1073741630;
LABEL_36:
