 ...
 *     UsbDevice_HandleAddEndpointsState @ 0x1C00465BC (UsbDevice_HandleAddEndpointsState.c)
 *     UsbDevice_HandleDropEndpointsState @ 0x1C00467AC (UsbDevice_HandleDropEndpointsState.c)
 * Callees:
...
LABEL_4:
  if ( a3 > 1 || (v6 = UsbDevice_InitializeInputContextForDropEndpoints(a1, a2), v6 >= 0) )
  {
    ...
    if ( v8 )
      ...
      v9 = 0LL;
    v10 = -(__int64)((*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 8) + 88LL) + 104LL) & 4) != 0);
    *(_DWORD *)(a1 + 152) &= ~*v9;
    v11 = v10 & 0x20;
    *(_DWORD *)(a1 + 152) |= v9[1];
    do
