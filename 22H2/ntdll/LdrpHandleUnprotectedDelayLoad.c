/*
 * XREFs of LdrpHandleUnprotectedDelayLoad @ 0x1800880CC
 * Callers:
        ...
        unsigned int a6)
{
  ...
  v10 = 0LL;
  DelayloadExportDll = LdrpGetDelayloadExportDll(a1, a2, (volatile signed __int32 **)&BaseAddress, a6, (__int64)a5);
