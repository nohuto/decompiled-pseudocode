/*
 * XREFs of LdrpAddRedirectedFunction @ 0x1800D4B24
 * Callers:
 ...
 *     LdrpCompareRedirectedFunction @ 0x1800D50EC (LdrpCompareRedirectedFunction.c)
 *     LdrpHashAsciizString @ 0x1800D555C (LdrpHashAsciizString.c)
 */
