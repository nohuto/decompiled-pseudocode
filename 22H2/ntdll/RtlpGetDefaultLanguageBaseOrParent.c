/*
 * XREFs of RtlpGetDefaultLanguageBaseOrParent @ 0x1800F05F0
 * Callers:
 ...
 *     RtlpMuiRegGetString @ 0x18010504C (RtlpMuiRegGetString.c)
 */
  ...
  while ( v12 < 4 )
  {
    ...
    if ( ((*(_WORD *)(a2 + 8) >> (2 * v12)) & 3) == 1 )
    {
      ...
      if ( (int)RtlULongToUShort(2 * (unsigned int)(unsigned __int16)a5, &v20) < 0
        || !RtlLCIDToCultureName(v14, (__int64)v19) )
      {
        goto LABEL_25;
      }
    }
    else if ( ((*(_WORD *)(a2 + 8) >> (2 * v12)) & 3) == 2 )
    {
      ...
      if ( a3 )
        *a3 = *(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL) + 28 * v14;
           ...
           && ((*(_BYTE *)a2 & 4) != 0
            || (int)RtlpMuiRegGetString(v11, (unsigned __int16)v14, a4, a5) < 0
            || (*(_WORD *)a2 & 0x1000) != 0) )
    {
      goto LABEL_25;
    }
