...
_WORD *RtlpHeapTrkTrackStack()
{
  ...
  v3 = v1 & 0xF;
  RtlAcquireSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_18016DBD8 + 8 * v3));
  v4 = qword_18016DA60;
  v5 = (_QWORD *)(qword_18016DA60 + 16LL * v1);
  v6 = (_QWORD *)*v5;
  if ( (_QWORD *)*v5 == v5 )
  {
LABEL_6:
    if ( Heap )
    {
      ...
      *(_QWORD *)v8 = Heap;
      ...
      RtlReleaseSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_18016DBD8 + 8 * v3));
      return Heap;
    }
    else
    {
