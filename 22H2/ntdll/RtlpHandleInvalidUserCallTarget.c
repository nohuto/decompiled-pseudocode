/*
 * XREFs of RtlpHandleInvalidUserCallTarget @ 0x1800FD7D0
 * Callers:
 *     LdrpHandleInvalidUserCallTarget @ 0x18008CBA0 (LdrpHandleInvalidUserCallTarget.c)
 * Callees:
 ...
 *     RtlpGuardIsSuppressedAddress @ 0x1800FD7A0 (RtlpGuardIsSuppressedAddress.c)
