 ...
 *     RtlpGetReservedBlockSize @ 0x18010B860 (RtlpGetReservedBlockSize.c)
...
LABEL_105:
    ...
    {
      v37 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016DC30, 2 * ((v8 - qword_18016DC28) >> 20));
...
LABEL_32:
    if ( v23 )
    {
      if ( a4 )
        *a4 -= v95;
      if ( (dword_18016D568 & 1) != 0 && (dword_18016D568 & 2) != 0 )
      {
