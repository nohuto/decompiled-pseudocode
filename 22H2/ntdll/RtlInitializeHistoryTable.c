/*
 * XREFs of RtlInitializeHistoryTable @ 0x180079C5C
 * Callers:
 ...
 *     RtlpFunctionAddressTableEntry @ 0x180079D34 (RtlpFunctionAddressTableEntry.c)
 */
...
void RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v5 + 6] = v4;
    v9 = qword_180181428;
    if ( v7 < qword_180181428 )
      v9 = v7;
    qword_180181428 = v9;
    v10 = qword_180181430;
    if ( v8 > qword_180181430 )
      v10 = v8;
    qword_180181430 = v10;
  }
