/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x1800769E0
 * Callers:
...
ULONG __cdecl RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_1801304D4[8 * v5] )
        {
          v8 = (unsigned __int16)word_1801304D6[4 * v5];
          if ( byte_1801304D5[8 * v5] == 1 )
