...
__int64 __fastcall RtlpFlsFree(struct _RTLP_FLS_CONTEXT *a1, unsigned __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  while ( 2 )
  {
    ...
    for ( i = (__int64 *)qword_18016D338; i != &qword_18016D338 && (unsigned int)v15 < 0x10; i = (__int64 *)*i )
    {
      if ( !v10 )
        goto LABEL_17;
...
LABEL_17:
  ...
  *(_QWORD *)(v9 + 8) = 0LL;
  RTL_BINARY_ARRAY<RTLP_FLS_CALLBACK_ENTRY,8,4>::SlotFree(&xmmword_18016D2F8, v4);
