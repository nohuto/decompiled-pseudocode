/*
 * XREFs of Normalization__CanCombineWithStartFirstPair @ 0x1800FFF00
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x18010018C (Normalization__GetSecondDecomposedCharPlane0.c)
 */
