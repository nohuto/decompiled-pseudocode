/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1800EE828
 * Callers:
 *     RtlSetDynamicTimeZoneInformation @ 0x1800EE780 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1800EE790 (RtlSetTimeZoneInformation.c)
 * Callees:
