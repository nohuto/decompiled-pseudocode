/*
 * XREFs of _output_l @ 0x180092E80
 * Callers:
 ...
 *     write_multi_char @ 0x180093730 (write_multi_char.c)
 *     write_string @ 0x180093788 (write_string.c)
 *     _get_printf_count_output @ 0x180096680 (_get_printf_count_output.c)
 *     wctomb_s @ 0x180096758 (wctomb_s.c)
 */
