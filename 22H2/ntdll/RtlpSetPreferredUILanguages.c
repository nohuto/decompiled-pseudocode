/*
 * XREFs of RtlpSetPreferredUILanguages @ 0x1800F1100
 * Callers:
 ...
 *     RtlpGetMultiStringLength @ 0x1800F0880 (RtlpGetMultiStringLength.c)
 *     RtlpSetInstallLanguage @ 0x1800F0A50 (RtlpSetInstallLanguage.c)
 *     RtlpSetMachineUILanguagesImmediate @ 0x1800F0F38 (RtlpSetMachineUILanguagesImmediate.c)
 *     RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId @ 0x18010460C (RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId.c)
 */
...
LABEL_103:
  ...
  if ( v13 >= 0 )
  {
    if ( !v4 )
    {
      v33 = 2;
      LODWORD(v51) = 262146;
      v34 = (WCHAR *)&unk_18013835C;
      v3 = v12;
      *((_QWORD *)&v51 + 1) = &unk_18013835C;
      v39 = 4;
      goto LABEL_133;
    }
    v15 = 4LL;
