/*
 * XREFs of RtlDecompressBufferXpressHuff @ 0x180059F60
 * Callers:
 *     <none>
 * Callees:
 *     XpressBuildHuffmanDecodingTable @ 0x18005A490 (XpressBuildHuffmanDecodingTable.c)
 */
...
LABEL_53:
    v25 = v39 + 3;
    v26 = (1LL << v38) + ((unsigned __int64)v18 >> (31 - (unsigned __int8)v38) >> 1);
    v18 <<= v38;
    v13 -= v38;
    if ( v13 < 0 )
    {
