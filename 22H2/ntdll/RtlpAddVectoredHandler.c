/*
 * XREFs of RtlpAddVectoredHandler @ 0x180082080
 * Callers:
 *     RtlAddVectoredExceptionHandler @ 0x180082070 (RtlAddVectoredExceptionHandler.c)
 *     RtlAddVectoredContinueHandler @ 0x1800D9600 (RtlAddVectoredContinueHandler.c)
 * Callees:
