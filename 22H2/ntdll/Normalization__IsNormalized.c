/*
 * XREFs of Normalization__IsNormalized @ 0x180100228
 * Callers:
 *     RtlIsNormalizedString @ 0x180100710 (RtlIsNormalizedString.c)
 * Callees:
 ...
 *     Normalization__CanCombineWithStartBase @ 0x1800FFEB4 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x1800FFF00 (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__GetLastChar @ 0x1800FFFF4 (Normalization__GetLastChar.c)
 */
