  ...
  *(_DWORD *)(a1 + 280) = v7;
  ...
  if ( (*(_DWORD *)(a3 + 144) & 0x1000) != 0 )
  {
    *(_DWORD *)(a1 + 104) |= 0x8000u;
    ...
    {
      v8 = RtlpImageDirectoryEntryToDataEx(*(PVOID *)(a1 + 48), (__int64)&v24);
      v9 = v24;
      if ( v8 < 0 )
        v9 = 0LL;
      if ( v9 )
...
LABEL_35:
      if ( !v14
        || *v14 != LdrpValidateUserCallTarget && *v14 != LdrpValidateUserCallTargetES
