/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x180051B08
 * Callers:
 *     DbgPrintEx @ 0x180051450 (DbgPrintEx.c)
 *     DbgPrint @ 0x180051AC0 (DbgPrint.c)
 *     LdrpLogDbgPrint @ 0x1800CDB18 (LdrpLogDbgPrint.c)
 *     DbgPrintReturnControlC @ 0x1800E0870 (DbgPrintReturnControlC.c)
 *     vDbgPrintEx @ 0x1800E0930 (vDbgPrintEx.c)
 *     vDbgPrintExWithPrefix @ 0x1800E0960 (vDbgPrintExWithPrefix.c)
 * Callees:
 *     RtlRaiseException @ 0x1800520D0 (RtlRaiseException.c)
 *     __security_check_cookie @ 0x18008C910 (__security_check_cookie.c)
 *     _vsnprintf @ 0x18008E170 (_vsnprintf.c)
 *     ZwQueryDebugFilterState @ 0x18009FD10 (ZwQueryDebugFilterState.c)
 *     DbgBreakPointWithStatus @ 0x1800A1040 (DbgBreakPointWithStatus.c)
 *     DebugPrint @ 0x1800A1050 (DebugPrint.c)
