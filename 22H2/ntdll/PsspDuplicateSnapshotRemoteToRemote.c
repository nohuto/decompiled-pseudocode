/*
 * XREFs of PsspDuplicateSnapshotRemoteToRemote @ 0x1801176A0
 * Callers:
 *     PssNtDuplicateSnapshot @ 0x180114040 (PssNtDuplicateSnapshot.c)
 * Callees:
 ...
 *     NtWriteVirtualMemory @ 0x18009DC20 (NtWriteVirtualMemory.c)
      ...
      if ( v11 <= 0xFFFFFFFF )
      {
        ...
        if ( (unsigned int)v11 < 0xFFFFFB88 )
        {
          ...
          *((_OWORD *)v13 + 6) = v28;
          ...
          v30 = 0LL;
          v10 = NtWriteVirtualMemory(SourceProcessHandle, BaseAddressa, v40, v9, 0LL);
          if ( v10 < 0 )
            goto LABEL_44;
          if ( v45 )
          {
