        ...
        unsigned __int64 a8)
{
  ...
  __int64 v29; // rcx
  __int16 v30; // ax
  __int64 v31[2]; // [rsp+30h] [rbp-10h] BYREF
  ...
  if ( v13 + 80 >= a7 )
  {
    if ( v13 + 80 < v9 )
    {
      ...
      v31[0] = (v13 - a7 + 4111) & 0xFFFFFFFFFFFFF000uLL;
      if ( (unsigned int)RtlpHpHeapCheckCommitLimit(v31[0], v25, a1, (unsigned __int64 *)(a1 + 376)) )
      {
        HeapProtection = RtlpGetHeapProtection(a1, 1LL);
        if ( (int)ZwAllocateVirtualMemory(-1LL, &a7, 0LL, v31, 4096, HeapProtection) >= 0 )
        {
          if ( (unsigned int)RtlGetCurrentServiceSessionId(v28, v27) )
            v29 = (__int64)NtCurrentPeb()->SharedData + 550;
          else
            v29 = 2147353472LL;
          if ( *(_BYTE *)v29 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
            RtlpLogHeapCommit(a1, a7, v31[0], 3LL);
          v12 = v31[0] + a7;
          a7 += v31[0];
          goto LABEL_3;
        }
...
LABEL_3:
  ...
  *(_WORD *)(a2 + 12) = *(_WORD *)(a1 + 140);
  ...
  {
    v30 = RtlLogStackBackTraceEx(1LL, v15 % 4096);
    LODWORD(v12) = a7;
    *(_WORD *)(a2 + 88) = v30;
  }
  v17 = a8;
  ...
  *(_BYTE *)(v13 + 14) = v20;
  RtlpCreateUCREntry(a1, a2, v12 - 48, (_DWORD)v16 << 12, v13, (__int64)v31);
  if ( *(_DWORD *)(a1 + 124) )
  {
