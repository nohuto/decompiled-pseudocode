/*
 * XREFs of ApiSetResolveToHost @ 0x18001A728
 * Callers:
 ...
 *     ApiSetQueryApiSetPresence @ 0x180077EA0 (ApiSetQueryApiSetPresence.c)
 * Callees:
    ...
    if ( v11 == 0x2D004900500041LL || v11 == 0x2D005400580045LL )
    {
      ...
      if ( v15 )
      {
        ...
        if ( v16 )
        {
          ...
          {
            v17 = ApiSetpSearchForApiSetHost(v16, *(_WORD **)(a3 + 8), *(_WORD *)a3 >> 1, a1);
            goto LABEL_13;
          }
          if ( *(_DWORD *)(v16 + 20) )
          {
