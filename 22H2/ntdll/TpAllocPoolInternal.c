/*
 * XREFs of TpAllocPoolInternal @ 0x180062D04
 * Callers:
 ...
 *     NtCreateIoCompletion @ 0x18009EA70 (NtCreateIoCompletion.c)
 *     NtCreateWorkerFactory @ 0x18009EE70 (NtCreateWorkerFactory.c)
