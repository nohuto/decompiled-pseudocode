/*
 * XREFs of RtlpSetInstallLanguage @ 0x1800F0A50
 * Callers:
 ...
 *     RtlStringCchCopyW @ 0x180047134 (RtlStringCchCopyW.c)
 ...
 *     NtFlushInstallUILanguage @ 0x18009F1D0 (NtFlushInstallUILanguage.c)
 ...
 *     RtlpGetCompleteLanguageFallback @ 0x1800F049C (RtlpGetCompleteLanguageFallback.c)
 *     RtlpGetDefaultLanguageBaseOrParent @ 0x1800F05F0 (RtlpGetDefaultLanguageBaseOrParent.c)
 *     RtlpGetInstalledLanguageType @ 0x1800F07E0 (RtlpGetInstalledLanguageType.c)
 *     RtlpSetPreferredUILanguages @ 0x1800F1100 (RtlpSetPreferredUILanguages.c)
 */
...
LABEL_22:
  ...
  InstalledLanguageType = RtlpGetCompleteLanguageFallback((__int64)v6, v15, v21, v22, 0xACu);
  if ( InstalledLanguageType < 0 )
    return (unsigned int)InstalledLanguageType;
  if ( (*(_BYTE *)v7 & 2) != 0 )
  {
