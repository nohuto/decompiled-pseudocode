/*
 * XREFs of RtlpEnsureBufferSize @ 0x18006ED00
 * Callers:
 *     sxsisol_SearchActCtxForDllName @ 0x18001C2B4 (sxsisol_SearchActCtxForDllName.c)
 *     RtlMultiAppendUnicodeStringBuffer @ 0x18006EBF0 (RtlMultiAppendUnicodeStringBuffer.c)
 *     RtlNtPathNameToDosPathName @ 0x1800CC350 (RtlNtPathNameToDosPathName.c)
