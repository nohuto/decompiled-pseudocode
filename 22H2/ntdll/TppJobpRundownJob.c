/*
 * XREFs of TppJobpRundownJob @ 0x18007FCA8
 * Callers:
 *     TpWaitForJobNotification @ 0x18007FC00 (TpWaitForJobNotification.c)
 *     TpReleaseJobNotification @ 0x18007FC40 (TpReleaseJobNotification.c)
 *     TppJobpStopCallbackGeneration @ 0x180111B60 (TppJobpStopCallbackGeneration.c)
 * Callees:
 *     RtlReleaseSRWLockExclusive @ 0x180012C70 (RtlReleaseSRWLockExclusive.c)
 *     RtlAcquireSRWLockExclusive @ 0x1800290A0 (RtlAcquireSRWLockExclusive.c)
 *     NtQueryInformationJobObject @ 0x18009FE30 (NtQueryInformationJobObject.c)
 *     ZwSetInformationJobObject @ 0x1800A07F0 (ZwSetInformationJobObject.c)
