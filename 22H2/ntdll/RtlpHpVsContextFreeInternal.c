/*
 * XREFs of RtlpHpVsContextFreeInternal @ 0x18010FAC8
 * Callers:
...
LABEL_10:
  ...
  if ( (((unsigned __int16)(*(_WORD *)(v15 + 32) ^ *(_WORD *)(v15 + 34)) ^ 0x2BED) & 0x7FFF) != 0 )
  {
    ...
    v16 = 18;
LABEL_12:
    RtlpLogHeapFailure(v16, a1 ^ *(_QWORD *)(a1 + 128), a3, 0LL, 0LL, 0LL);
    return v6;
  }
  ...
  v17 = RtlpHpVsChunkFree(a1, v15, (_WORD *)a3, a4, a5);
  if ( v17 )
  {
    if ( (a4 & 1) == 0 )
    {
    ...
    RtlpHpVsSubsegmentFree(a1, v17, a4);
    if ( (a4 & 1) == 0 )
    {
      *(_QWORD *)a5 = 0LL;
      *(_QWORD *)(a5 + 16) = 0LL;
      *(_QWORD *)(a5 + 8) = a1;
      RtlAcquireSRWLockExclusive(a1, v18, v19, v20);
    }
  }
  return 1;
}
