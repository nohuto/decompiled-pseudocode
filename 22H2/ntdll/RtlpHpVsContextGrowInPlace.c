/*
 * XREFs of RtlpHpVsContextGrowInPlace @ 0x180071EE8
 * Callers:
 ...
 *     RtlpHpVsCalculateChunkRequiredSize @ 0x18007218C (RtlpHpVsCalculateChunkRequiredSize.c)
 *     RtlpHpVsChunkSetUnusedBytes @ 0x1800721AC (RtlpHpVsChunkSetUnusedBytes.c)
