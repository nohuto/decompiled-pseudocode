 ...
 *     EtwEnumerateProcessRegGuids @ 0x1801104C0 (EtwEnumerateProcessRegGuids.c)
 * Callees:
 *     RtlReleaseSRWLockExclusive @ 0x180012C70 (RtlReleaseSRWLockExclusive.c)
 *     RtlReleaseSRWLockShared @ 0x180021920 (RtlReleaseSRWLockShared.c)
 *     RtlAcquireSRWLockExclusive @ 0x1800290A0 (RtlAcquireSRWLockExclusive.c)
 *     RtlTryAcquireSRWLockShared @ 0x180077D90 (RtlTryAcquireSRWLockShared.c)
 */
        ...
        unsigned __int64 a4)
{
  ...
  else if ( (qword_18016D600 & 1) != 0 )
  {
    if ( qword_18016D600 == 1 )
      j = 0LL;
    else
      j = qword_18016D600 ^ ((unsigned __int64)&EtwpRegistrationTable + 1);
  }
  else
  {
    j = qword_18016D600;
