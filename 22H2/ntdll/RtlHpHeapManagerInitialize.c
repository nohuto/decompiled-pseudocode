/*
 * XREFs of RtlHpHeapManagerInitialize @ 0x18010DDF4
 * Callers:
...
_QWORD *__fastcall RtlHpHeapManagerInitialize(__int64 a1, __int64 *a2)
{
  ...
  memset(&qword_18016DC28, 0, 0x50uLL);
  qword_18016DC50 = -1LL;
  dword_18016DC64 = 16;
  memset(&unk_18016DC78, 0, 0x3840uLL);
  qword_18016DCB8 = -1LL;
  v3 = &unk_18016E4F0;
  dword_18016DCCC = 2056;
  v4 = 255LL;
  do
  {
    *(v3 - 1) = 0LL;
