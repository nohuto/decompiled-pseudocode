/*
 * XREFs of __C_specific_handler @ 0x18008CDB0
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x18009D074 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x180030600 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x180092B40 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x180092B70 (__NLG_Return2.c)
 *     __except_validate_context_record @ 0x180092B78 (__except_validate_context_record.c)
 */
