/*
 * XREFs of RtlpFcUpdateUsageSubscriptions @ 0x180101D98
 * Callers:
 *     RtlSubscribeForFeatureUsageNotification @ 0x180101C90 (RtlSubscribeForFeatureUsageNotification.c)
 *     RtlUnsubscribeFromFeatureUsageNotifications @ 0x180101CA0 (RtlUnsubscribeFromFeatureUsageNotifications.c)
 * Callees:
