/*
 * XREFs of RtlNumberOfSetBitsEx @ 0x1800ECFB0
 * Callers:
 *     RtlNumberOfClearBitsEx @ 0x1800ECF50 (RtlNumberOfClearBitsEx.c)
 * Callees:
 *     <none>
 */
