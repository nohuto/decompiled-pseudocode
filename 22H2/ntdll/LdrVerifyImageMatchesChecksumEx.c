/*
 * XREFs of LdrVerifyImageMatchesChecksumEx @ 0x18008B160
 * Callers:
 *     LdrVerifyImageMatchesChecksum @ 0x1800CE620 (LdrVerifyImageMatchesChecksum.c)
 * Callees:
 ...
 *     NtMakeTemporaryObject @ 0x18009F6D0 (NtMakeTemporaryObject.c)
 ...
 *     LdrVerifyMappedImageMatchesChecksum @ 0x1800F599C (LdrVerifyMappedImageMatchesChecksum.c)
 */
...
NTSTATUS __cdecl LdrVerifyImageMatchesChecksumEx(HANDLE ImageFileHandle, PLDR_VERIFY_IMAGE_INFO VerifyInfo)
{
  ...
  if ( (VerifyInfo->Flags & 2) == 0 )
    p_SectionInfo = (LDR_SECTION_INFO *)&unk_180123568;
...
LABEL_30:
    if ( v8 < 0 || p_SectionInfo == (LDR_SECTION_INFO *)&unk_180123568 )
    {
