/*
 * XREFs of LdrpLogVsmEnclaveLdrCreateEnclaveTelemetry @ 0x1800CFD40
 * Callers:
...
char __fastcall LdrpLogVsmEnclaveLdrCreateEnclaveTelemetry(__int64 a1, int a2)
{
  ...
  if ( v2->ProcessHeap )
  {
    ...
    {
      LOBYTE(v2) = tlgKeywordOn((__int64)&dword_180166590, 0x400000000000LL);
      if ( (_BYTE)v2 )
      {
        v14 = 0;
        v17 = 0;
        ...
        v9 = a2;
        v19 = 4;
        LOBYTE(v2) = tlgWriteTransfer_EtwEventWriteTransfer(v5, (unsigned __int8 *)dword_180131BE0, v6, v7, 5u, &v11);
      }
    }
  }
  return (char)v2;
