/*
 * XREFs of LZNT1CompressChunk @ 0x18010C3B4
 * Callers:
 *     RtlCompressBufferLZNT1 @ 0x18010C830 (RtlCompressBufferLZNT1.c)
 * Callees:
        ...
        __int64 a7)
{
  ...
  *(_QWORD *)(a7 + 8) = v14;
  ...
  if ( (unsigned __int64)a2 >= v14 )
    goto LABEL_25;
  v19 = (unsigned int *)&unk_18013FA7C;
  v20 = a4 + 2;
  v31 = (unsigned int *)&unk_18013FA7C;
  v35 = (char *)(a4 + 2);
  v16 = (char *)(a4 + 1);
  do
  {
