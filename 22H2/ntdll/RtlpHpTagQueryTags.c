/*
 * XREFs of RtlpHpTagQueryTags @ 0x1800753C4
 * Callers:
    ...
    if ( (v8 & 1) != 0 )
    {
      ...
      *((_WORD *)a1 + 1) = v10;
      ...
      else
      {
        ...
        v13 = &v11[24 * v12];
        RtlAcquireSRWLockShared(&RtlpHpTagContext);
        if ( (unsigned int)dword_18016AB08 > v12 )
        {
          v7 = -1073741789;
          *a3 = 8 * (3LL * (unsigned int)dword_18016AB08 + 3);
          RtlReleaseSRWLockShared(&RtlpHpTagContext);
        }
        else
        {
          v14 = qword_18016AB10;
          for ( i = (_QWORD *)qword_18016AB10; v11 < v13; v11 += 24 )
          {
            if ( !i )
              goto LABEL_20;
            v16 = (_QWORD *)*i;
...
LABEL_20:
              for ( j = (_QWORD **)(v14 + 8);
                    (unsigned __int64)j < qword_18016AB10 + 8 * ((unsigned __int64)(unsigned int)dword_18016AB0C >> 5);
                    ++j )
              {
                if ( (*(_BYTE *)j & 1) == 0 )
                {
