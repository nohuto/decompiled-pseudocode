/*
 * XREFs of TimeToDaysAndFraction @ 0x18007BD28
 * Callers:
 *     RtlTimeToElapsedTimeFields @ 0x18007BC90 (RtlTimeToElapsedTimeFields.c)
 * Callees:
 *     RtlExtendedMagicDivide @ 0x18007BDC0 (RtlExtendedMagicDivide.c)
 */
