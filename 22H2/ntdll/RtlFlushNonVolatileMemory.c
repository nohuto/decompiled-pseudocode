/*
 * XREFs of RtlFlushNonVolatileMemory @ 0x1800FBC30
 * Callers:
 ...
 *     RtlWriteNonVolatileMemory @ 0x1800FC410 (RtlWriteNonVolatileMemory.c)
 * Callees:
 *     RtlDrainNonVolatileFlush @ 0x1800FBC00 (RtlDrainNonVolatileFlush.c)
 */
