/*
 * XREFs of PssNtQuerySnapshot @ 0x180114490
 * Callers:
 *     <none>
 * Callees:
 *     PssNtValidateDescriptor @ 0x180114740 (PssNtValidateDescriptor.c)
 *     PsspQueryInfoClass_PSS_QUERY_PROCESS_INFORMATION @ 0x180116AA0 (PsspQueryInfoClass_PSS_QUERY_PROCESS_INFORMATION.c)
 */
