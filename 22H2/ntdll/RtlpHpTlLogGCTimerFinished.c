/*
 * XREFs of RtlpHpTlLogGCTimerFinished @ 0x18010B4D4
 * Callers:
...
__int64 __fastcall RtlpHpTlLogGCTimerFinished(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_180166698 > 5 )
    return tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_180166698, byte_180132040, a3, a4, 2, (__int64)v5);
  return result;
}
