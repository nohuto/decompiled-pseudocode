/*
 * XREFs of LdrpGetMUILangConfigNode @ 0x1800EEAF8
 * Callers:
 *     RtlpTraverseParents @ 0x18005884C (RtlpTraverseParents.c)
 * Callees:
 *     RtlpCompareConfigNodeWithSpec @ 0x1800EFF54 (RtlpCompareConfigNodeWithSpec.c)
 *     RtlpMuiRegGetLanginfoTypeNSpec @ 0x1800F09E4 (RtlpMuiRegGetLanginfoTypeNSpec.c)
 */
