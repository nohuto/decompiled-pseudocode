/*
 * XREFs of TppPoolpDereferenceGlobalPool @ 0x180013E60
 * Callers:
 ...
 *     TpUnreserveTaskPost @ 0x180070EC0 (TpUnreserveTaskPost.c)
...
signed __int64 __fastcall TppPoolpDereferenceGlobalPool(const void **a1, volatile signed __int64 *a2)
{
