/*
 * XREFs of RtlpWalkHeap @ 0x1800F4DBC
 * Callers:
 ...
 *     RtlpGetExtraStuffPointerUnsafe @ 0x1800F3EB4 (RtlpGetExtraStuffPointerUnsafe.c)
 *     RtlDebugWalkHeap @ 0x1800FA2C8 (RtlDebugWalkHeap.c)
 *     RtlpLogHeapWalkEvent @ 0x18010A898 (RtlpLogHeapWalkEvent.c)
 *     RtlpWalkLFHBlock @ 0x18010BD28 (RtlpWalkLFHBlock.c)
 *     RtlpWalkLowFragHeapSegment @ 0x18010C360 (RtlpWalkLowFragHeapSegment.c)
 */
...
__int64 __fastcall RtlpWalkHeap(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( (*(_DWORD *)(a1 + 116) & 0x1000000) != 0 )
    return ((__int64 (*)(void))qword_180166438)();
...
LABEL_166:
        ...
        if ( v39 != 1 )
        {
          ...
          *(_WORD *)(a2 + 18) = 1;
          ...
          {
            v48 = *(unsigned __int16 *)(v12 + 16LL * (v47 & 0x3F) + 12);
          }
...
LABEL_29:
      ...
      if ( (*(_BYTE *)(a2 + 18) & 1) != 0 )
      {
        ...
        v20 = *(unsigned __int8 *)(v17 + 14);
        if ( (_BYTE)v20 )
          v21 = (v17 & 0xFFFFFFFFFFFF0000uLL) - (v20 << 16) + 0x10000;
        else
          v21 = a1;
        if ( !v21 )
        {
...
LABEL_83:
      ...
      else
      {
        ...
        v26 = *(unsigned __int8 *)(v17 + 14);
        if ( (_BYTE)v26 )
          v21 = (v17 & 0xFFFFFFFFFFFF0000uLL) - (v26 << 16) + 0x10000;
        else
          v21 = a1;
        if ( !v21 )
          goto LABEL_191;
