/*
 * XREFs of write_char_1 @ 0x1800990DC
 * Callers:
 *     _output_s @ 0x180098684 (_output_s.c)
 *     write_multi_char_1 @ 0x18009912C (write_multi_char_1.c)
 *     write_string_1 @ 0x180099184 (write_string_1.c)
 * Callees:
 *     _flsbuf_s @ 0x18009B930 (_flsbuf_s.c)
 */
