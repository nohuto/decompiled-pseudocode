/*
 * XREFs of LdrpGetProcedureAddress @ 0x1800321C0
 * Callers:
 ...
 *     LdrpBuildImportRedirection @ 0x1800D4E54 (LdrpBuildImportRedirection.c)
 ...
 *     RtlpImageDirectoryEntryToData32 @ 0x1800EB0E0 (RtlpImageDirectoryEntryToData32.c)
 */
...
LABEL_44:
  ...
  if ( Magic == 267 )
  {
    v11 = RtlpImageDirectoryEntryToData32(v10, OutHeaders, (__int64)&v27);
    v4 = (char *)v27;
    goto LABEL_46;
  }
  if ( Magic != 523 )
...
LABEL_19:
      ...
      v25 = *(unsigned __int16 *)(BaseOfImage + *((unsigned int *)v4 + 9) + 2LL * v18);
      goto LABEL_31;
    }
LABEL_25:
    if ( (v15 & 3) != 0 )
...
LABEL_31:
  ...
  {
    v26 = (char *)(BaseOfImage + *(unsigned int *)(BaseOfImage + *((unsigned int *)v4 + 7) + 4LL * (int)v25));
    *a4 = v26;
