/*
 * XREFs of LdrpLogRelativePathWithAlteredSearchError @ 0x18007E294
 * Callers:
...
__int64 __fastcall LdrpLogRelativePathWithAlteredSearchError(__int64 a1)
{
  ...
  if ( (unsigned int)dword_180166558 > 5 && CentennialIssueTracker_InitializedState == 2 )
  {
    ...
    return tlgWriteTransfer_EtwEventWriteTransfer((int)&dword_180166558, (int)&dword_180131D9E, v6, v7, 4u, &v8);
  }
  return result;
}
