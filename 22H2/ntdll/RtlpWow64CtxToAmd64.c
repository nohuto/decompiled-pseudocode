/*
 * XREFs of RtlpWow64CtxToAmd64 @ 0x180103638
 * Callers:
 *     RtlpWow64SetContextOnAmd64 @ 0x18006F1E0 (RtlpWow64SetContextOnAmd64.c)
 * Callees:
 *     RtlFnToFxFrame @ 0x1800FCE28 (RtlFnToFxFrame.c)
 */
