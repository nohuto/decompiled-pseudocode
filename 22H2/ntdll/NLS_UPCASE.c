 ...
 *     RtlFindUnicodeSubstring @ 0x1800877F0 (RtlFindUnicodeSubstring.c)
 *     WerEscalationLazyInit @ 0x1800DE048 (WerEscalationLazyInit.c)
 *     RtlUpcaseUnicodeToCustomCPN @ 0x1800E5750 (RtlUpcaseUnicodeToCustomCPN.c)
 *     UpcaseUnicodeToMultiByteNHelper @ 0x1800E58A4 (UpcaseUnicodeToMultiByteNHelper.c)
