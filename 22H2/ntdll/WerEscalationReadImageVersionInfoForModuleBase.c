/*
 * XREFs of WerEscalationReadImageVersionInfoForModuleBase @ 0x18006BE00
 * Callers:
 *     WerEscalationReadImageVersionInfoForModuleBaseSafe @ 0x18006BD44 (WerEscalationReadImageVersionInfoForModuleBaseSafe.c)
 * Callees:
 *     RtlCompareUnicodeString @ 0x180016090 (RtlCompareUnicodeString.c)
 *     RtlImageNtHeaderEx @ 0x180032AD0 (RtlImageNtHeaderEx.c)
 *     RtlInitUnicodeString @ 0x18003BA40 (RtlInitUnicodeString.c)
 *     GetResourceDirectoryEntry @ 0x18006BDBC (GetResourceDirectoryEntry.c)
 *     ValidatePointer @ 0x18006C044 (ValidatePointer.c)
 *     FindDirectoryEntry @ 0x18006C084 (FindDirectoryEntry.c)
 *     StringCbLengthW @ 0x18006C0E8 (StringCbLengthW.c)
 */
