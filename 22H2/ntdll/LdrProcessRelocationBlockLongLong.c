/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x180084998
 * Callers:
 *     LdrRelocateImageWithBias @ 0x18008489C (LdrRelocateImageWithBias.c)
 *     LdrProcessRelocationBlock @ 0x1800E3AD0 (LdrProcessRelocationBlock.c)
 *     LdrProcessRelocationBlockEx @ 0x1800E3B00 (LdrProcessRelocationBlockEx.c)
 * Callees:
