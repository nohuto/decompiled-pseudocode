/*
 * XREFs of RtlpMuiRegGetInstalledLangInfoIndex @ 0x18007AAA8
 * Callers:
 *     LdrpConvertLangFallbackListToMultiSz @ 0x18003681C (LdrpConvertLangFallbackListToMultiSz.c)
 *     _RtlpMuiRegValidateLIPLanguage @ 0x1801076AC (_RtlpMuiRegValidateLIPLanguage.c)
 *     _RtlpMuiRegValidatePartialLanguage @ 0x1801078EC (_RtlpMuiRegValidatePartialLanguage.c)
 * Callees:
 *     <none>
 */
