/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x180047EA4
 * Callers:
 *     RtlQueryTimeZoneInformation @ 0x1800482A0 (RtlQueryTimeZoneInformation.c)
 *     EtwpGetTimeZoneInformation @ 0x180049C68 (EtwpGetTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x1800EE5F0 (RtlQueryDynamicTimeZoneInformation.c)
 * Callees:
