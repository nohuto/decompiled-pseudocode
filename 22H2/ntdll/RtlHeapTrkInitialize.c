...
__int64 __fastcall RtlHeapTrkInitialize(void *a1)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( qword_18016D738 )
    {
      dword_18016DA68 = *(_DWORD *)(v19 + 56);
      RtlpHeapTrkGenerateHashRandoms((unsigned int)dword_18016DA68, v3, v4, v5, 0LL, &v21);
      ...
      if ( Heap )
      {
        ...
        if ( (unsigned __int8)RtlpHeapTrkAllocCacheAligned(&qword_18016D740, &qword_18016DBF0, 32LL) )
        {
          if ( (unsigned __int8)RtlpHeapTrkAllocCacheAligned(&qword_18016DBC0, &qword_18016DBB8, 8LL) )
          {
            ...
            {
              qword_18016DA50 = RtlAllocateHeap(qword_18016DBE0, 0, 126704LL);
              if ( qword_18016DA50 )
              {
                v7 = RtlAllocateHeap(qword_18016DBE0, 0, 126704LL);
                qword_18016DA60 = v7;
                if ( v7 )
                {
                  v8 = (_QWORD *)qword_18016DA50;
                  v9 = 7919LL;
                  Handle = a1;
                  v10 = qword_18016DA50 - v7;
                  dword_18016DA58 = 0;
                  v11 = v7 - qword_18016DA50;
                  do
                  {
                    v12 = (char *)v8 + v11;
                    *v8 = v8;
        ...
        RtlDestroyHeap(qword_18016DBE0);
        qword_18016DBE0 = 0LL;
        qword_18016DBF0 = 0LL;
        qword_18016DA50 = 0LL;
        qword_18016DBC0 = 0LL;
