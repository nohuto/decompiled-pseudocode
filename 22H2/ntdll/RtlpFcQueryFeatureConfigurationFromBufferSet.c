/*
 * XREFs of RtlpFcQueryFeatureConfigurationFromBufferSet @ 0x18011B1A4
 * Callers:
 *     RtlQueryFeatureConfiguration @ 0x18005E0C0 (RtlQueryFeatureConfiguration.c)
 * Callees:
 *     RtlpFcValidateFeatureConfigurationType @ 0x18005E168 (RtlpFcValidateFeatureConfigurationType.c)
