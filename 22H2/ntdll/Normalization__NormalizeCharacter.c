/*
 * XREFs of Normalization__NormalizeCharacter @ 0x180080D5C
 * Callers:
 *     Normalization__Normalize @ 0x180080C28 (Normalization__Normalize.c)
 *     Normalization__AppendDecomposedChar @ 0x1800FFC3C (Normalization__AppendDecomposedChar.c)
 * Callees:
 *     NormBuffer__AppendEx @ 0x180080E90 (NormBuffer__AppendEx.c)
 *     NormBuffer__Append @ 0x180080EDC (NormBuffer__Append.c)
 *     ComposeHangulLV @ 0x1800FF468 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1800FF498 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1800FF4CC (IsHangulLV.c)
 *     NormBuffer__GetLastChar @ 0x1800FF5F4 (NormBuffer__GetLastChar.c)
 *     NormBuffer__Insert @ 0x1800FF68C (NormBuffer__Insert.c)
 *     NormBuffer__IsBlocked @ 0x1800FF754 (NormBuffer__IsBlocked.c)
 *     NormBuffer__LastStartBase @ 0x1800FF7FC (NormBuffer__LastStartBase.c)
 *     NormBuffer__LastStartBasePair @ 0x1800FF828 (NormBuffer__LastStartBasePair.c)
 *     NormBuffer__RecheckStartCombinations @ 0x1800FF878 (NormBuffer__RecheckStartCombinations.c)
 *     NormBuffer__ReplaceLastStartBase @ 0x1800FF9F4 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x1800FFA6C (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x1800FFB2C (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1800FFC3C (Normalization__AppendDecomposedChar.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x1800FFD50 (Normalization__CanCombinableCharactersCombine.c)
 */
