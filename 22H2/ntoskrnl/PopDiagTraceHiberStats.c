/*
 * XREFs of PopDiagTraceHiberStats @ 0x14098F8D8
 * Callers:
...
char PopDiagTraceHiberStats()
{
  ...
  v3 = qword_140C3D470;
  qword_140C3D478 = ResumeTimestamp;
  dword_140C3D57C = dword_140C3D044;
  dword_140C3D578 = dword_140C3D0C8;
  v19 = qword_140C3D470;
  LODWORD(qword_140C3D528) = PopQpcTimeInMs(&qword_140C3D358, &qword_140C3D360);
  qword_140C3D3D8 = (unsigned int)PopQpcTimeInMs(&qword_140C3D328, &qword_140C3D3E0);
  PopComputeDerivedHiberStats((unsigned __int64 *)&qword_140C3D398, v3, (__int64)&v20);
  ...
  do
  {
    ...
    if ( (*(_DWORD *)v7 & 0x40000000) != 0 )
      ...
      v9 = (unsigned __int64 *)((char *)&qword_140C3D398 + v8);
    if ( (*(_DWORD *)v7 & 2) != 0 )
      v10 = *v9;
    else
      v10 = *(unsigned int *)v9;
  ...
  qword_140C3D4F0 /= v3;
  qword_140C3D3A0 /= v3;
  v14 = 1000 * qword_140C3D478 / PopQpcFrequency - (unsigned int)qword_140C3D3E8 - (unsigned int)dword_140C3D3F0;
  qword_140C3D580 = v14;
  if ( v1 )
  {
    RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"KernelResumeIoCpuTime");
    ZwSetValueKey(v1, (PUNICODE_STRING)&DestinationString[1], 0, 4u, &qword_140C3D4F0, 4u);
    RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"HiberIoCpuTime");
    ZwSetValueKey(v1, (PUNICODE_STRING)&DestinationString[1], 0, 4u, &qword_140C3D3A0, 4u);
    if ( qword_140C3D518 )
    {
      dword_140C3D024 += PopQpcTimeInMs(&qword_140C3D348, &qword_140C3D520);
      RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"HybridBootAnimationTime");
      ZwSetValueKey(v1, (PUNICODE_STRING)&DestinationString[1], 0, 4u, &dword_140C3D024, 4u);
    }
    qword_140C3D588 = (((unsigned __int64)MEMORY[0xFFFFF78000000004] << 32)
                     * (unsigned __int128)(unsigned __int64)(MEMORY[0xFFFFF78000000320] << 8)) >> 64;
    RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"ResumeCompleteTimestamp");
    ZwSetValueKey(DestinationString[0], (PUNICODE_STRING)&DestinationString[1], 0, 0xBu, &qword_140C3D588, 8u);
