/*
 * XREFs of MiMirrorPerformBrownWrites @ 0x140381BF8
 * Callers:
...
LABEL_10:
    ...
    if ( qword_140C4E710 > v12 )
    {
      ...
      if ( i != SchedulerAssist && (*(_DWORD *)i | *((_DWORD *)qword_1400127A0 + (v12 & 0x1F))) == -1 )
      {
      ...
      {
        a2 = *(unsigned int *)i;
        if ( ((unsigned int)a2 & ~*((_DWORD *)qword_1400127A0 + (v13 & 0x1F))) == 0 )
        {
          v14 = 32 - (v13 & 0x1F);
          if ( v14 == -1 )
            goto LABEL_26;
