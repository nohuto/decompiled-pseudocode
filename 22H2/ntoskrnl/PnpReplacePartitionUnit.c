/*
 * XREFs of PnpReplacePartitionUnit @ 0x1408AC2C0
 * Callers:
 ...
 *     KeFindFirstSetLeftAffinityEx @ 0x140513490 (KeFindFirstSetLeftAffinityEx.c)
 ...
 *     PnprMmConstruct @ 0x1408AE638 (PnprMmConstruct.c)
