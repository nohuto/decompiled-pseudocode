/*
 * XREFs of PnpReplacePartitionUnit @ 0x140964BA0
 * Callers:
 ...
 *     KeFindFirstSetLeftAffinityEx @ 0x140338120 (KeFindFirstSetLeftAffinityEx.c)
 ...
 *     PnprMmConstruct @ 0x140966DB8 (PnprMmConstruct.c)
