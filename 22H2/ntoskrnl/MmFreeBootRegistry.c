/*
 * XREFs of MmFreeBootRegistry @ 0x14079FC8C
 * Callers:
 *     CmpFreeBootRegistry @ 0x1404EDE18 (CmpFreeBootRegistry.c)
...
void MmFreeBootRegistry()
{
  ...
  v0 = (size_t *)_InterlockedCompareExchange64(&qword_140C4EED0, 1LL, 0LL);
  v1 = v0;
  if ( v0 )
  {
    v2 = *v0;
