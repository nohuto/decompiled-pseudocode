/*
 * XREFs of ExpInitSystemPhase0 @ 0x140B61954
 * Callers:
 ...
 *     Feature_FastResource2__private_IsEnabledDeviceUsage @ 0x1404122DC (Feature_FastResource2__private_IsEnabledDeviceUsage.c)
...
char ExpInitSystemPhase0()
{
  ...
  *(_WORD *)(MmWriteableSharedUserData + 726) = 10;
  qword_140C2D668 = (__int64)&ExpSystemResourcesList;
  ...
  qword_140C2D628 = (__int64)&ExNPagedLookasideListHead;
  ExNPagedLookasideListHead = (__int64)&ExNPagedLookasideListHead;
  qword_140C2D648 = (__int64)&ExPagedLookasideListHead;
  ExPagedLookasideListHead = (__int64)&ExPagedLookasideListHead;
  qword_140C31BD8 = (__int64)&ExpFirmwareTableProviderListHead;
