 ...
 * Callees:
 *     WheapInitializeInUsePageOfflineNotifications @ 0x1407C7D48 (WheapInitializeInUsePageOfflineNotifications.c)
 */
...
PVOID *WheaInitializeServices()
{
  ...
  qword_140CF4B88 = (__int64)&WheapPfaList;
