...
unsigned __int64 __fastcall MiObtainRelocationBits(__int64 a1, unsigned __int16 a2, unsigned __int64 a3)
{
  ...
  v7 = KeAbPreAcquire((__int64)&qword_140C65840, 0LL);
  v8 = v7;
  if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65840, 0LL) )
    ExfAcquirePushLockExclusiveEx(&qword_140C65840, v7, (__int64)&qword_140C65840);
  if ( v8 )
    *(_BYTE *)(v8 + 18) = 1;
