/*
 * XREFs of KiProcessControlProtection @ 0x1405126A0
 * Callers:
 *     KiControlProtectionFault @ 0x14040F880 (KiControlProtectionFault.c)
 * Callees:
 *     KiFixupControlProtectionUserModeReturnMismatch @ 0x1403F22D8 (KiFixupControlProtectionUserModeReturnMismatch.c)
 *     KiLogControlProtectionUserModeReturnMismatch @ 0x1403F22FC (KiLogControlProtectionUserModeReturnMismatch.c)
