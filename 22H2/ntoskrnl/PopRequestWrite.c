/*
 * XREFs of PopRequestWrite @ 0x140994594
 * Callers:
 *     PopWriteHiberImage @ 0x140994454 (PopWriteHiberImage.c)
 *     PopCompressCallback @ 0x140994570 (PopCompressCallback.c)
 * Callees:
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( v8 == 1 )
      {
        BugCheckParameter4 = (*(int (__fastcall **)(__int64, ULONG_PTR, __int64))(*(_QWORD *)(v7 + 168) + 128LL))(
                               ...
                               v6);
        v31 = __rdtsc();
        qword_140C23FA0 += (((unsigned __int64)HIDWORD(v31) << 32) | (unsigned int)v31) - v19;
      ...
      {
        qword_140C23F98 += v18 - *(_QWORD *)(v7 + 336);
        ProducerConsumerBufferComplete(v5, v5 + 48, *(_QWORD *)(v7 + 384), *(unsigned int *)(v7 + 360));
        v20 = __rdtsc();
        qword_140C23FC0 += (((unsigned __int64)HIDWORD(v20) << 32) | (unsigned int)v20) - v19;
        qword_140C24168 += *(_QWORD *)(v7 + 360);
        dword_140C24170 += (unsigned __int64)(*(_QWORD *)(v7 + 352) + 4095LL) >> 12;
        v21 = *(_QWORD *)(v7 + 352);
        *(_QWORD *)(v7 + 376) += v21;
        *(_QWORD *)(v7 + 344) += v21;
        *(_QWORD *)(v7 + 352) = 0LL;
    ...
    *(_QWORD *)(v7 + 360) = v23;
    if ( v22 + v14 > qword_140C23E50 )
    {
      ...
      *(_QWORD *)MaxDataSize = MmGetNumberOfPhysicalPages(0);
      ...
      KeBugCheckEx(0xA0u, 0xBuLL, qword_140C23E50, *(unsigned int *)(v7 + 184), RemainingHibernateRangeDataSize);
    }
    ...
    *(_QWORD *)(v7 + 352) = v14;
    ...
    v32 = (*(int (__fastcall **)(__int64, ULONG_PTR, __int64, _QWORD))(*(_QWORD *)(v7 + 168) + 128LL))(
            ...
            0LL);
    v33 = __rdtsc();
    qword_140C23FA0 += (((unsigned __int64)HIDWORD(v33) << 32) | (unsigned int)v33) - v27;
...
LABEL_18:
      ...
      v29 = __rdtsc();
      qword_140C23FA0 += (((unsigned __int64)HIDWORD(v29) << 32) | (unsigned int)v29) - v27;
