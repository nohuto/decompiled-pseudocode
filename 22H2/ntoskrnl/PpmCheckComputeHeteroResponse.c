/*
 * XREFs of PpmCheckComputeHeteroResponse @ 0x140577B50
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x140228DF0 (KeGetPrcb.c)
 *     KeEnumerateNextProcessor @ 0x1402293C0 (KeEnumerateNextProcessor.c)
 *     PpmParkCalculateUnparkCount @ 0x14030DA70 (PpmParkCalculateUnparkCount.c)
 *     __security_check_cookie @ 0x1403CFD60 (__security_check_cookie.c)
 *     qsort @ 0x1403D23C0 (qsort.c)
 *     PpmHeteroUtilityGreaterThanOrEqualThreshold @ 0x1405782FC (PpmHeteroUtilityGreaterThanOrEqualThreshold.c)
 *     PpmHeteroUtilityToNormalizedUtility @ 0x14057834C (PpmHeteroUtilityToNormalizedUtility.c)
...
char PpmCheckComputeHeteroResponse()
{
  ...
  v32 = 0LL;
  v31 = 0LL;
  v0 = &PpmCurrentProfile[342 * dword_140C2334C];
