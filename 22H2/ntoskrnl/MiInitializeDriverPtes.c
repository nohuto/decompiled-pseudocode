/*
 * XREFs of MiInitializeDriverPtes @ 0x140B60F90
 * Callers:
...
LABEL_57:
  ...
  if ( (KiSpeculationFeatures & 0x40000000000LL) != 0 )
    qword_140C66F00 = (unsigned __int64)(((__int64)((*((_QWORD *)qword_140C65A40 + 1) << 25)
                                                  + ((unsigned __int64)*((unsigned int *)qword_140C65A40 + 4) << 28)) >> 16)
                                       - qword_140C66F08) >> 21;
  v43 = v51;
  k = 0LL;
  while ( v43 )
