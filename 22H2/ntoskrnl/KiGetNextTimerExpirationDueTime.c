/*
 * XREFs of KiGetNextTimerExpirationDueTime @ 0x140225560
 * Callers:
 ...
 * Callees:
 *     KiFindNextTimerDueTime @ 0x140225840 (KiFindNextTimerDueTime.c)
...
LABEL_7:
  if ( *(_BYTE *)(a1 + 33) )
  {
    ...
    do
    {
      v21 = qword_140C31CF0[3 * v12];
      if ( v12 == 2 )
      {
        if ( v21 < v8 )
          v8 = qword_140C31CF0[6];
      }
      else if ( v21 < v15 )
      {
        v15 = qword_140C31CF0[3 * v12];
        if ( v12 == 4 )
          LOBYTE(v16) = 1;
      }
      ++v12;
