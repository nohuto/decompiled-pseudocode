/*
 * XREFs of MmGetDumpRange @ 0x1406303F0
 * Callers:
 *     IoWriteCrashDump @ 0x1405513A0 (IoWriteCrashDump.c)
 *     IopAddKernelSpacePagesToPartialDump @ 0x14055C894 (IopAddKernelSpacePagesToPartialDump.c)
 * Callees:
...
void __fastcall MmGetDumpRange(__int64 a1, int a2, char a3)
{
  ...
  while ( 2 )
  {
    v13 = v12 < qword_140C674A8->SizeOfBitMap ? v12 : 0;
    v14 = qword_140C674A8->SizeOfBitMap - 1;
    v15 = ((__int64)qword_140C674A8->Buffer & 4) != 0LL ? 0x20 : 0;
    v16 = (char *)qword_140C674A8->Buffer - (((__int64)qword_140C674A8->Buffer & 4) != 0 ? 4 : 0);
    while ( 1 )
    {
      v17 = v15 + v14;
      if ( v14 - v13 == -1 )
...
LABEL_25:
      if ( !v13 )
        goto LABEL_30;
      SizeOfBitMap = v12 + 1;
      if ( v12 + 1 > qword_140C674A8->SizeOfBitMap )
...
LABEL_30:
    ...
    {
      v12 = v18 + 1;
      v23 = *(_QWORD *)(qword_140C674C8 + 8LL * v18);
      if ( (*(_DWORD *)(v23 + 4) & 2) != 0 )
      {
