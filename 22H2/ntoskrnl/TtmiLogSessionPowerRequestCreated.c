/*
 * XREFs of TtmiLogSessionPowerRequestCreated @ 0x1409A9B08
 * Callers:
...
void TtmiLogSessionPowerRequestCreated()
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v6 = v2;
      v11 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)byte_140032D55, 0LL, 0LL, 5u, &v7);
    }
  }
}
