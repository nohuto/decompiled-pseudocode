/*
 * XREFs of MiFindHotPatchRecord @ 0x140A36BEC
 * Callers:
...
__int64 __fastcall MiFindHotPatchRecord(__int64 *a1, int a2, int a3, int a4, PUNICODE_STRING StringOut)
{
  ...
  if ( !a2 )
  {
    ...
    v8 = KeAbPreAcquire((__int64)&xmmword_140C69948, 0LL);
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&xmmword_140C69948, 17LL, 0LL) )
      ExfAcquirePushLockSharedEx((signed __int64 *)&xmmword_140C69948, 0LL, v8, (__int64)&xmmword_140C69948);
    if ( v8 )
      *(_BYTE *)(v8 + 18) = 1;
  }
  v9 = *a1;
