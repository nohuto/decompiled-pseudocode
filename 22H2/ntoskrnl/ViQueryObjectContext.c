/*
 * XREFs of ViQueryObjectContext @ 0x1409C85B4
 * Callers:
 *     VfQueryDeviceContext @ 0x1405A0860 (VfQueryDeviceContext.c)
 *     VfQueryDriverContext @ 0x1405A08A0 (VfQueryDriverContext.c)
 *     VfQueryIrpContext @ 0x1405A08E0 (VfQueryIrpContext.c)
 *     VfQueryThreadContext @ 0x1405A0920 (VfQueryThreadContext.c)
 * Callees:
