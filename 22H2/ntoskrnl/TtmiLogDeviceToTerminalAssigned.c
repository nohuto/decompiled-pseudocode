/*
 * XREFs of TtmiLogDeviceToTerminalAssigned @ 0x1409A7F44
 * Callers:
...
void __fastcall TtmiLogDeviceToTerminalAssigned(int a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v6 = a1;
      v7 = a2;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)byte_14003346D, 0LL, 0LL, 5u, &v8);
    }
  }
}
