...
__int64 __fastcall MiUnlinkNodeLargePageHelper(_QWORD *a1, unsigned __int64 *a2, __int64 a3, unsigned int a4, char a5)
{
  ...
  v9 = (unsigned int)a3;
  v38 = (unsigned int)a3;
  v10 = *(_QWORD *)(qword_140C674C8 + 8LL * (unsigned int)v7);
  ...
  *v19 = v18;
  ...
  v26 = (unsigned int)dword_140C65C80[v9];
  if ( v26 == 16 )
    LODWORD(v25) = v25 & 0xF;
  else
    v25 %= v26;
  ...
  if ( dword_140C67F4C == 1 )
  {
    v33 = v20 & 0x1F;
    v34 = v12;
    v35 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67FA0 + 1) + 4 * (v20 >> 5));
    if ( v33 + v12 > 0x20 )
    {
      if ( (v20 & 0x1F) != 0 )
      {
