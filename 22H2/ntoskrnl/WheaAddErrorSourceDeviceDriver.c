/*
 * XREFs of WheaAddErrorSourceDeviceDriver @ 0x1407AF530
 * Callers:
 *     WheaAddErrorSourceDeviceDriverV1 @ 0x1403BA670 (WheaAddErrorSourceDeviceDriverV1.c)
 * Callees:
 *     WheapDeviceDriverGetPacketLength @ 0x1403BAA60 (WheapDeviceDriverGetPacketLength.c)
