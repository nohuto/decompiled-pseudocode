/*
 * XREFs of KiInsertSecondarySignalList @ 0x140519318
 * Callers:
 *     KeDispatchSecondaryInterrupt @ 0x140518DF0 (KeDispatchSecondaryInterrupt.c)
 * Callees:
...
void __fastcall KiInsertSecondarySignalList(_QWORD **a1)
{
  ...
  if ( *a1 != a1 )
  {
    ...
    *(_QWORD *)qword_140C2B508 = a1;
    qword_140C2B508 = (__int64)a1[1];
