/*
 * XREFs of MiCheckReservePageFileSpace @ 0x140282EC0
 * Callers:
...
LABEL_3:
  ...
  if ( !v6 || (LOBYTE(CurrentThread) = qword_140C65C40, !qword_140C65C40) || (qword_140C65C40 & v6) != 0 )
  {
    LODWORD(CurrentThread) = *(_DWORD *)(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL))
                                       + 1076LL);
