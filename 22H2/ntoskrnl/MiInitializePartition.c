/*
 * XREFs of MiInitializePartition @ 0x1407974EC
 * Callers:
 ...
 *     MiInitializePfnListHead @ 0x1403AAA4C (MiInitializePfnListHead.c)
 *     MiInitializeCombining @ 0x1403AAA74 (MiInitializeCombining.c)
