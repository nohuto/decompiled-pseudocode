/*
 * XREFs of PiDeviceDependencyInit @ 0x140B43154
 * Callers:
...
__int64 PiDeviceDependencyInit()
{
  ...
  qword_140C5D5D8 = (__int64)&PiDependencyNodeListHead;
  PiDependencyNodeListHead = (__int64)&PiDependencyNodeListHead;
  qword_140C5D5F8 = (__int64)&PiDependencyNodeEmptyList;
  PiDependencyNodeEmptyList = (__int64)&PiDependencyNodeEmptyList;
  qword_140C5D5E8 = (__int64)&PiRebuildPowerRelationsQueue;
