/*
 * XREFs of sub_1403DD530 @ 0x1403DD530
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_BYTE *)a1 != v17 )
  {
    do
    {
      ...
      if ( (unsigned int)v18 < 0x400 )
        ...
        *v16++ ^= v5[(unsigned __int8)(v20 + v5[v10 + 2]) + 2] ^ 0x82;
    }
    while ( v16 != v17 );
  }
  *v5 = v8;
  ...
  while ( (_BYTE *)a1 != v17 )
  {
    ...
    {
      LOBYTE(v26) = v30 + v9[v29];
      *(_BYTE *)a1++ ^= v9[(unsigned __int8)v26] ^ 0x82;
    }
  }
  return (char)v26;
}
