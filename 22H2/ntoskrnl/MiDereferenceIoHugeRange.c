/*
 * XREFs of MiDereferenceIoHugeRange @ 0x14061F9F8
 * Callers:
...
__int64 __fastcall MiDereferenceIoHugeRange(unsigned __int64 a1, __int64 a2)
{
  ...
  {
    v4 = (a1 >> 18) & 0x3FFFFF;
    v5 = (__int64 *)(qword_140C67EF0 + 8LL * (unsigned int)v4);
    v8 = *v5;
    ...
    *v5 = v8;
    ...
    result = qword_140C67EF8;
    _InterlockedAnd(
      (volatile signed __int32 *)(qword_140C67EF8 + 4 * (((((__int64)v5 - qword_140C67EF0) >> 3) & 0x3FFFFFuLL) >> 5)),
      ~(1 << ((((__int64)v5 - qword_140C67EF0) >> 3) & 0x1F)));
  }
  return result;
}
