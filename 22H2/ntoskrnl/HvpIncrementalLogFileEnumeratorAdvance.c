/*
 * XREFs of HvpIncrementalLogFileEnumeratorAdvance @ 0x1407FE728
 * Callers:
 ...
 *     HvpIsLogEntryHeaderCoherent @ 0x1407FE8B4 (HvpIsLogEntryHeaderCoherent.c)
 *     HvpLogEntryCheckDataChecksum @ 0x1407FE98C (HvpLogEntryCheckDataChecksum.c)
 *     HvpIsMetadataArrayCoherent @ 0x1407FE9E8 (HvpIsMetadataArrayCoherent.c)
 */
