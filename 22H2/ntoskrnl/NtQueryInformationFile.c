 ...
 *     RtlIsPartialPlaceholderFileHandle @ 0x140917500 (RtlIsPartialPlaceholderFileHandle.c)
 * Callees:
 ...
 *     IOP_INT_TO_EXT_PRIORITY @ 0x1403F09A0 (IOP_INT_TO_EXT_PRIORITY.c)
 ...
 *     IopGetModeInformation @ 0x140679178 (IopGetModeInformation.c)
...
LABEL_31:
      ...
      v30 = (IRP *)IopAllocateIrpExReturn();
      v31 = v30;
      Irp = v30;
      if ( !v30 )
      {
