/*
 * XREFs of _output_l @ 0x1403DC790
 * Callers:
 ...
 *     write_multi_char_0 @ 0x1403DD038 (write_multi_char_0.c)
 *     write_string_0 @ 0x1403DD090 (write_string_0.c)
 *     _get_printf_count_output @ 0x1403DD7EC (_get_printf_count_output.c)
