/*
 * XREFs of MiLogPeriodicTelemetryForSlabAllocator @ 0x1403D0440
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
        if ( v3 )
          InsertEventEntryInLookUpTable(v1, (__int64)&EventDescriptor, 19, (__int64)&UserData, v3);
        else
