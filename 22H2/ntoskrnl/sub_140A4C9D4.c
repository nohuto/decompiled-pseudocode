/*
 * XREFs of sub_140A4C9D4 @ 0x140A4C9D4
 * Callers:
 *     sub_1406EF620 @ 0x1406EF620 (sub_1406EF620.c)
 * Callees:
 *     StringCbLengthW @ 0x1402F51A8 (StringCbLengthW.c)
...
__int64 __fastcall sub_140A4C9D4(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rsi
  signed int v7; // ebx
