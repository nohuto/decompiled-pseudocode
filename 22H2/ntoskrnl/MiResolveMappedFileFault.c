/*
 * XREFs of MiResolveMappedFileFault @ 0x1402E05E0
 * Callers:
 ...
 *     MiSetInPagePrefetchPriority @ 0x1403676D4 (MiSetInPagePrefetchPriority.c)
...
LABEL_111:
  ...
  v15 = 0;
  v16 = 0;
  v70 = *(_QWORD **)(qword_140C674C8 + 8LL * (*(_WORD *)(v10 + 60) & 0x3FF));
