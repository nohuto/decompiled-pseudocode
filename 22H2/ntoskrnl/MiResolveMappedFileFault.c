/*
 * XREFs of MiResolveMappedFileFault @ 0x140299B10
 * Callers:
...
LABEL_12:
  if ( a2 >= v67 - 8LL * (*(_DWORD *)(v7 + 52) & 0x3FFFFFFF) + 8 * (unsigned __int64)*(unsigned int *)(v7 + 44) )
  {
LABEL_110:
    MiUnlockProtoPoolPage(v79, 0x11u);
    return 3221225477LL;
  ...
  else
  {
    ...
    if ( v62 )
    {
      ...
      v59 = MiComputeFaultCluster(v17, v21, Address, 0LL);
    }
...
LABEL_21:
  ...
  if ( MI_READ_PTE_LOCK_FREE(a2) == v20 )
  {
      ...
      || (*(_BYTE *)(v72 + 34) & 0x20) != 0 && (*(_DWORD *)(*(_QWORD *)v72 + 160LL) & 0x20) == 0 )
    {
      ...
      if ( v62 && *v62 == 1 )
        MiSetInPagePrefetchPriority(v62, v22);
      if ( v23 )
...
LABEL_34:
          if ( (unsigned int)MiObtainFaultCharges(v28, 1u, 1) )
          {
            ...
            if ( v23 && (unsigned int)MiUseSlabAllocator((__int64)v28, (_BYTE *)v7, v70, 0LL) )
              SlabPage = MiGetSlabPage((_DWORD)v28, v61, 0, v31, v31);
            else
            ...
            if ( SlabPage != -1 )
            {
              ...
              if ( v26 == 1 )
              {
                MiCopyImageExtentContents(v22, v7, a2, v68, SlabPage, v79, v71);
                *v81 = v22;
                return 3221435187LL;
              }
              v34 = a2;
...
LABEL_51:
              ...
              v52 = v79;
              v53 = MiCopyFileOnlyGlobalSubsectionPage(v22, v7, a2, v68, SlabPage, v79, v71);
              v54 = v53;
              if ( v53 >= 0 )
                goto LABEL_51;
              if ( v53 == -1073741739 )
...
LABEL_127:
            ...
            MiReturnFaultCharges(v28, 1LL, 1LL);
          }
          v34 = a2;
          v35 = v79;
LABEL_42:
...
LABEL_46:
      ...
      *(_QWORD *)(v22 + 160) = v35;
      *(_QWORD *)(v22 + 168) = v20;
      v40 = MiPickClusterForMappedFileFault((_DWORD)v28, v22, v38, v37, v57, v27, (__int64)&v75, (__int64)&v74);
      v41 = MiBuildMdlForMappedFileFault(v22, v75, v74, (__int64)v28, v40, v27, v69, v38, a1, (__int64)&v76);
      v42 = v41;
      if ( v41 != v40 )
        MiReturnFaultCharges(v28, v40 - v41, 1LL);
      if ( v42 )
      {
