/*
 * XREFs of PspThreadDelete @ 0x1407478D0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall PspThreadDelete(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( result >= qword_140C64BD0 )
  {
    v8 = qword_140C64BC0;
    if ( qword_140C64BC0 )
    {
      if ( (_DWORD)qword_140C64BD8 )
      {
        v9 = 0LL;
        v10 = &ObpObjectTypes;
        v11 = (unsigned int)qword_140C64BD8;
        do
        {
          v12 = *v10;
          if ( ((*(unsigned __int8 *)(*v10 + 66) >> 6) & 1) != _bittest64(&qword_140C64BE0, v9) && !qword_140C64B90 )
          {
            qword_140C64B90 = (unsigned int)__ROL4__(1207959560, 133);
            xmmword_140C64B98 = 0LL;
            qword_140C64BA8 = 268LL;
            qword_140C64BB0 = v12;
          }
          ++v9;
          ++v10;
      ...
      v13 = 64;
      v14 = (_QWORD *)(qword_140C64C00 + 112);
      v15 = (const char *)(qword_140C64C00 + 112);
      if ( qword_140C64C00 + 112 < (unsigned __int64)(qword_140C64C00 + 176) )
      {
        do
        {
          _mm_prefetch(v15, 0);
        ...
        while ( (unsigned __int64)v15 < qword_140C64C00 + 176 );
      }
      v16 = 8LL;
      do
      {
        v8 = __ROR8__(v8 - *v14++, qword_140C64BC8);
        v13 -= 8;
        --v16;
      }
      while ( v16 );
      for ( ; v13; --v13 )
      {
        ...
        v8 = __ROR8__(v8 - v17, qword_140C64BC8);
      }
      if ( qword_140C64C08 != v8 )
      {
        if ( qword_140C64B90 )
          goto LABEL_46;
        qword_140C64B90 = (unsigned int)__ROR4__(150994945, 152);
        xmmword_140C64B98 = 0LL;
        qword_140C64BA8 = 268LL;
        qword_140C64BB0 = qword_140C64C00;
      }
    }
    if ( !qword_140C64B90 )
    {
...
LABEL_32:
  ...
  if ( v18 )
  {
    ...
    if ( (*(_DWORD *)(BugCheckParameter2 + 1376) & 0x100000) != 0 )
      result = ((__int64 (__fastcall *)(ULONG_PTR))xmmword_140C38170)(BugCheckParameter2);
