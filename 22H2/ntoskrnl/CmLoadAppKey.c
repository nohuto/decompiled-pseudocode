/*
 * XREFs of CmLoadAppKey @ 0x140769B50
 * Callers:
        ...
        ULONG_PTR *a9)
{
  ...
  *(_QWORD *)&v89[16] = &v89[16];
  ...
  for ( j = CmpAppHiveLoadList; ; j = *(_QWORD *)j )
  {
    ...
    {
      if ( *(__int64 **)qword_140C13E48 == &CmpAppHiveLoadList )
      {
        *(_QWORD *)v89 = &CmpAppHiveLoadList;
        *(_QWORD *)&v89[8] = qword_140C13E48;
        *(_QWORD *)qword_140C13E48 = v89;
        qword_140C13E48 = (__int64)v89;
...
LABEL_43:
  ...
  *(_QWORD *)(v49 + 8) = v59;
  v61 = (_QWORD *)qword_140C13E48;
  if ( *(__int64 **)qword_140C13E48 != &CmpAppHiveLoadList )
    goto LABEL_81;
  *v60 = &CmpAppHiveLoadList;
  v60[1] = v61;
  *v61 = v60;
  qword_140C13E48 = (__int64)v60;
LABEL_46:
  CmpUnlockAppHiveLoadList();
    ...
    if ( *(_WORD *)(Pool + 8) || *(_WORD *)(Pool + 10) || *(_BYTE *)(Pool + 394) )
    {
      if ( (unsigned int)dword_140C04390 > 5 )
      {
        if ( tlgKeywordOn((__int64)&dword_140C04390, 0x400000000008LL) )
        {
          ...
          v80 = 0x1000000LL;
          v148 = 8LL;
          tlgWriteAgg((__int64)&dword_140C04390, (unsigned __int8 *)&unk_140036F68, Pool + 394, 0xEu, &v121);
          v51 = dword_140C04390;
        }
        if ( v51 > 5 && tlgKeywordOn((__int64)&dword_140C04390, 8LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)&word_14003718E,
            0LL,
            0LL,
            0xCu,
            &v97);
...
LABEL_123:
    if ( (unsigned int)dword_140C04390 > 5 && tlgKeywordOn((__int64)&dword_140C04390, 0x400000000008LL) )
    {
      ...
      v80 = 0x1000000LL;
      v103 = 8LL;
      tlgWriteAgg((__int64)&dword_140C04390, (unsigned __int8 *)&byte_1400370CB, v67, 5u, &v97);
    }
    goto LABEL_64;
  }
  if ( (unsigned int)dword_140C04390 > 5 && tlgKeywordOn((__int64)&dword_140C04390, 0x400000000008LL) )
  {
    ...
    v80 = 0x1000000LL;
    v105 = 8LL;
    tlgWriteAgg((__int64)&dword_140C04390, (unsigned __int8 *)&dword_140037124, v50, 6u, &v97);
  }
LABEL_65:
