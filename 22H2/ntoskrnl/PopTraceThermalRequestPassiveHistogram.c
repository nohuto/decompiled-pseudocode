/*
 * XREFs of PopTraceThermalRequestPassiveHistogram @ 0x14038A188
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x14038A704 (PopDiagSnapPassiveHistogram.c)
      ...
      if ( (int)PoStoreDiagnosticContext(*(_QWORD *)(a1 + 24), PoolWithTag, NumberOfBytes) >= 0 )
      {
          ...
          && tlgKeywordOn((__int64)&dword_140C02228, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_140028693,
            0LL,
            0LL,
            7u,
            &v9);
