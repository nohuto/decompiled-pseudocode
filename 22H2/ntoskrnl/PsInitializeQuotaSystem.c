 ...
 * Callees:
 *     PspRegisterResource @ 0x1403C8D14 (PspRegisterResource.c)
...
char __fastcall PsInitializeQuotaSystem(int a1)
{
  ...
  if ( a1 )
  {
    ...
    dword_140C1E198 = 0;
    qword_140C1E1A8 = 0LL;
    qword_140C1E190 = (__int64)&qword_140C1E188;
    qword_140C1E188 = (__int64)&qword_140C1E188;
    qword_140C1E1C8 = (__int64)&qword_140C1E1C0;
    qword_140C1E1C0 = (__int64)&qword_140C1E1C0;
    qword_140C1E168[0] = 0x10000LL;
    qword_140C1E178 = (__int64)MmRaisePoolQuota;
    qword_140C1E180 = (__int64)MmReturnPoolQuota;
    PspQuotaExpansionDescriptors[0] = 1;
    qword_140C1E1A0 = 0x80000LL;
    qword_140C1E1B0 = (__int64)MmRaisePoolQuota;
    qword_140C1E1B8 = (__int64)MmReturnPoolQuota;
LABEL_9:
