/*
 * XREFs of SepSecureBootSetRegistryKey @ 0x140B6DAA4
 * Callers:
  ...
  if ( (dword_140C7104C & 8) != 0 || a1 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v2 >= 0 )
    {
      ...
      ObjectAttributes.ObjectName = (PUNICODE_STRING)&qword_1400058A0;
      ObjectAttributes.Length = 48;
      ObjectAttributes.Attributes = 576;
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( v2 >= 0 )
      {
        if ( (dword_140C7104C & 8) != 0 )
        {
          Data = dword_140C7104C & 1;
          v2 = ZwSetValueKey(Handle, (PUNICODE_STRING)&stru_1400058B0, 0, 4u, &Data, 4u);
          if ( v2 < 0 )
            goto LABEL_9;
          if ( Data )
