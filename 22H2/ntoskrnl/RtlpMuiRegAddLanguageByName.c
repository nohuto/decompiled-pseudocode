/*
 * XREFs of RtlpMuiRegAddLanguageByName @ 0x140846910
 * Callers:
 ...
 *     RtlpIsALicensedLIPLanguage @ 0x140A74338 (RtlpIsALicensedLIPLanguage.c)
 *     _RtlpMuiRegInitLIPLanguage @ 0x140A7570C (_RtlpMuiRegInitLIPLanguage.c)
 *     _RtlpMuiRegInitPartialLanguage @ 0x140A7595C (_RtlpMuiRegInitPartialLanguage.c)
 */
