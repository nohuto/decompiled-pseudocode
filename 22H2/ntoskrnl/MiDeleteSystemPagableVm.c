/*
 * XREFs of MiDeleteSystemPagableVm @ 0x1402E9440
 * Callers:
...
LABEL_3:
  ...
  {
    if ( (a5 & 2) != 0 && dword_140C680E8 )
      v53 = 1;
    v15 = 2;
    v54 = 2;
  }
  v56 = *(_QWORD *)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(v9 + 174));
  v70 = 20LL;
  v67 = v15;
  v68 = 0;
  v71 = 0LL;
...
LABEL_58:
      ...
      if ( MiPteInShadowRange(a3) )
      {
        ...
        {
          if ( !HIBYTE(word_140C66DFC) && (v43 & 1) != 0 )
            v43 |= 0x8000000000000000uLL;
          *(_QWORD *)a3 = v43;
          MiWritePteShadow(a3, v43);
LABEL_137:
          Flink = qword_140C65C40;
          v47 = v55;
          if ( qword_140C65C40 && (v55 & 0x10) == 0 )
            v47 = v55 & ~qword_140C65C40;
