/*
 * XREFs of MiLogContinueTrim @ 0x140634E88
 * Callers:
...
void MiLogContinueTrim()
{
  ...
  {
    if ( tlgKeywordOn(*(__int64 *)&qword_140C699E8, 1LL) )
    {
      v4 = *v1;
      v13 = 0;
      v16 = 0;
      ...
      v24 = v0 + 7;
      v12 = 4;
      tlgWriteTransfer_EtwWriteTransfer(v2, (unsigned __int8 *)byte_1400388F3, 0LL, 0LL, 7u, &v10);
    }
  }
}
