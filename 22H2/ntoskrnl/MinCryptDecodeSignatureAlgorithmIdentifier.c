/*
 * XREFs of MinCryptDecodeSignatureAlgorithmIdentifier @ 0x140A6F290
 * Callers:
...
__int64 __fastcall MinCryptDecodeSignatureAlgorithmIdentifier(__int64 a1)
{
  ...
  result = (unsigned int)dword_140A79950[6 * v3];
  if ( (_DWORD)result == 11776 )
  {
    v5 = (unsigned int)v11;
    v6 = (const void **)&off_140A79978;
    v7 = 0LL;
    ...
    return (unsigned int)dword_140A79980[6 * v7];
  }
  return result;
}
