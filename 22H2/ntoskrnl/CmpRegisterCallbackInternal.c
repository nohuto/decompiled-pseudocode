/*
 * XREFs of CmpRegisterCallbackInternal @ 0x140681D48
 * Callers:
 *     CmRegisterInternalCallback @ 0x1405D2538 (CmRegisterInternalCallback.c)
 *     CmRegisterCallback @ 0x1407D54F0 (CmRegisterCallback.c)
 *     CmRegisterCallbackEx @ 0x140869C10 (CmRegisterCallbackEx.c)
 * Callees:
