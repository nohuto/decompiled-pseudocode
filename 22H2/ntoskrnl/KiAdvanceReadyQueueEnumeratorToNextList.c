 ...
 *     KiAdvanceReadyQueueEnumeratorToNextPhase @ 0x140242B10 (KiAdvanceReadyQueueEnumeratorToNextPhase.c)
 */
...
LABEL_13:
    ...
    *(_BYTE *)(a1 + 11) = v10;
    if ( !(_BYTE)v10 && (int)KiAdvanceReadyQueueEnumeratorToNextProcessor((unsigned int *)a1) < 0 )
      goto LABEL_6;
