/*
 * XREFs of PnpDeviceActionWorker @ 0x14036F9F0
 * Callers:
 ...
 *     PiConfigureDevice @ 0x14073028C (PiConfigureDevice.c)
 ...
 *     PiProcessRequeryDeviceState @ 0x14078CDE8 (PiProcessRequeryDeviceState.c)
