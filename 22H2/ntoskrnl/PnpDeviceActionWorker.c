/*
 * XREFs of PnpDeviceActionWorker @ 0x140358E30
 * Callers:
 ...
 *     PiProcessRequeryDeviceState @ 0x140855204 (PiProcessRequeryDeviceState.c)
...
LABEL_6:
    ...
    if ( v4 )
    {
      ...
      v10 = *(_BYTE *)(v4 + 88);
      ExReleasePushLockEx((__int64 *)(v4 + 80), 0LL);
      ...
      __writecr8(v12);
      v13 = KeAcquireSpinLockRaiseToDpc(&qword_140C38EF0);
      dword_140C38EFC = v11;
      if ( byte_140C38F70 )
...
LABEL_42:
      ...
      __writecr8(v26);
      v27 = KeAcquireSpinLockRaiseToDpc(&qword_140C38EF0);
      if ( byte_140C38F70 )
      {
      ...
      do
      {
        ...
        *(_QWORD *)(v30 + 8) = v4;
        ...
        v32 = KeAcquireSpinLockRaiseToDpc(&qword_140C3F3E8);
        v33 = dword_140C3F3F0-- == 1;
        v34 = v32;
        if ( v33 )
        ...
        __writecr8(v34);
        v35 = KeAcquireSpinLockRaiseToDpc(&qword_140C38EF0);
