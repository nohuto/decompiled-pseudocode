/*
 * XREFs of PopUpdateTimeouts @ 0x140725430
 * Callers:
...
__int64 __fastcall PopUpdateTimeouts(int a1, unsigned int *a2, unsigned int *a3)
{
  ...
  if ( a3 )
  {
    v10 = "Computed";
    if ( !*((_BYTE *)a3 + 4) )
      v10 = (const char *)qword_1407DD820;
  }
  else
  {
    v10 = "NULL";
  ...
  *(_QWORD *)((char *)&PopConsoleContext + 12) = *(_QWORD *)a2;
  ...
  if ( *((_BYTE *)a2 + 4) )
  {
    ...
    HIDWORD(xmmword_140C20570) = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  }
  return result;
}
