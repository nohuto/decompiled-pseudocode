/*
 * XREFs of WbAddWarbirdEncryptionSegment @ 0x1407D26B8
 * Callers:
...
__int64 __fastcall WbAddWarbirdEncryptionSegment(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( v10 )
    *(_BYTE *)(v10 + 18) = 1;
  v11 = sub_1407D2B34(a1, &v21, &v20, &v19);
  v13 = v11;
  if ( v11 )
  {
    if ( v11 == -1073741198 )
    {
      v13 = sub_140764214(a1 + 136, a2, v12, (__int64)&v21, 0x10u, v19);
      if ( v13 >= 0 )
        v13 = sub_1407D2D28(a2);
    }
  }
  else if ( a3 )
  {
