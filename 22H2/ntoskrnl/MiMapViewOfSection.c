/*
 * XREFs of MiMapViewOfSection @ 0x1407216D0
 * Callers:
        ...
        int a7)
{
  ...
  $115DCDF994C6370D29323EAB0E0C9502 v63; // [rsp+C8h] [rbp-70h] BYREF
      ...
      if ( (v40 & 0x20) != 0 )
      {
        ...
        while ( 1 )
        {
          ...
          *v13 &= ~0x20000000u;
          ...
          MiUnmapViewOfSection(BugCheckParameter1, (unsigned __int64)v47, 0, 0);
          v13 = v53;
        }
        if ( v38 >= 0 )
          *v51 = v47;
