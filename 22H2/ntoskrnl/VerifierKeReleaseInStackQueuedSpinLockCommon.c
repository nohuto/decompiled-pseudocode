/*
 * XREFs of VerifierKeReleaseInStackQueuedSpinLockCommon @ 0x1409DB000
 * Callers:
 *     VerifierKeReleaseInStackQueuedSpinLock @ 0x1409DAFC0 (VerifierKeReleaseInStackQueuedSpinLock.c)
 *     VerifierKeReleaseInStackQueuedSpinLockNoReboot @ 0x1409DB220 (VerifierKeReleaseInStackQueuedSpinLockNoReboot.c)
 * Callees:
