/*
 * XREFs of __C_specific_handler @ 0x1403CFD90
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x1403F913C (__GSHandlerCheck_SEH.c)
 * Callees:
 *     KeCheckStackAndTargetAddress @ 0x140309780 (KeCheckStackAndTargetAddress.c)
 *     RtlUnwindEx @ 0x14033EA40 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x1403D1260 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x1403D1290 (__NLG_Return2.c)
 */
