/*
 * XREFs of ?SmStOutSwapStore@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@@Z @ 0x14034FA48
 * Callers:
...
LABEL_6:
  while ( 1 )
  {
    ...
    if ( v15 != v14 && (*v15 | *((_DWORD *)qword_1400127A0 + (v10 & 0x1F))) == -1 )
    {
      v13 = v10 - (v10 & 0x1F) + 32;
    ...
    {
      v17 = v13 & 0x1F;
      if ( (*v15 & ~*((_DWORD *)qword_1400127A0 + (v13 & 0x1F))) == 0 )
      {
        v16 = 32 - v17;
        if ( v17 == 33 )
          goto LABEL_22;
