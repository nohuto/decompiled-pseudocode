/*
 * XREFs of IoRegisterFsRegistrationChangeMountAware @ 0x1408577F0
 * Callers:
 *     IoRegisterFsRegistrationChange @ 0x1409474B0 (IoRegisterFsRegistrationChange.c)
 * Callees:
...
LABEL_5:
  if ( (__int64 *)IopFsNotifyChangeQueueHead != &IopFsNotifyChangeQueueHead
    && *(PDRIVER_OBJECT *)(qword_140C5DB68 + 16) == DriverObject
    && *(PDRIVER_FS_NOTIFICATION *)(qword_140C5DB68 + 24) == DriverNotificationRoutine )
  {
...
LABEL_9:
  ...
  v10 = (_QWORD *)qword_140C5DB68;
  if ( *(__int64 **)qword_140C5DB68 != &IopFsNotifyChangeQueueHead )
    __fastfail(3u);
  *Pool2 = &IopFsNotifyChangeQueueHead;
  Pool2[1] = v10;
  *v10 = Pool2;
  qword_140C5DB68 = (__int64)Pool2;
