/*
 * XREFs of MiLogHotPatchOperation @ 0x140A38B6C
 * Callers:
        ...
        int a8)
{
  ...
  if ( *(_QWORD *)&qword_140C699E8 )
  {
    LOBYTE(v8) = MiFillLogProcessInfo(
                   ...
                   v38,
                   &v36);
    v13 = *(_QWORD *)&qword_140C699E8;
    if ( a8 )
    {
      if ( **(_DWORD **)&qword_140C699E8 > 5u )
      {
        LOBYTE(v8) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000020LL);
        if ( (_BYTE)v8 )
        {
          ...
          v43 = &v34;
          v16 = (unsigned __int8 *)&byte_140039029;
          v34 = a7;
          v45 = &v33;
          v47 = &v32;
          v31 = *(_DWORD *)(a1 + 56);
    ...
    else if ( **(_DWORD **)&qword_140C699E8 > 5u )
    {
      ...
      if ( (_BYTE)v8 )
      {
        ...
        tlgCreate1Sz_char((__int64)v42, v36);
        v43 = &v25;
        v16 = (unsigned __int8 *)byte_140038EF3;
        v25 = a7;
        v45 = &v26;
        v47 = &v27;
        v28 = *(_DWORD *)(a1 + 56);
