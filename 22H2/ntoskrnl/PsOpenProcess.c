/*
 * XREFs of PsOpenProcess @ 0x1406F3DB0
 * Callers:
 *     NtOpenProcess @ 0x1406F3D80 (NtOpenProcess.c)
...
LABEL_6:
  ...
  else
  {
    ...
    if ( v15 && (unsigned int)dword_140C03048 > 5 && tlgKeywordOn((__int64)&dword_140C03048, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140034125,
        0LL,
        0LL,
        8u,
        &v45);
