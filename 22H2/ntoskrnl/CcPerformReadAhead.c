/*
 * XREFs of CcPerformReadAhead @ 0x14027A470
 * Callers:
      ...
      while ( 1 )
      {
        ...
        if ( v5 < v11 )
        {
          ...
          if ( (xmmword_140CFC490 & 0x20000) != 0 )
          {
            ...
            v66[0] = v68;
            v66[1] = 32LL;
            EtwTraceKernelEvent((unsigned int)v66, 1, -2147352576, 5635, 4200706);
          }
          while ( v12 )
          {
            if ( v13 > v12 )
            ...
            if ( (xmmword_140CFC490 & 0x20000) != 0 )
            {
              ...
              v67[0] = v72;
              v67[1] = 32LL;
              EtwTraceKernelEvent((unsigned int)v67, 1, -2147352576, 5643, 4200706);
            }
