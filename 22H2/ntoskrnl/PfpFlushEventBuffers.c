/*
 * XREFs of PfpFlushEventBuffers @ 0x14074B1EC
 * Callers:
...
__int64 PfpFlushEventBuffers()
{
  ...
  v0 = 0LL;
  v1 = 0;
  PfFbBufferListFlushStandby((_SLIST_ENTRY *)&stru_140C653A0);
  v2 = RtlpInterlockedFlushSList(&stru_140C65420);
  if ( v2 )
  {
    do
    {
