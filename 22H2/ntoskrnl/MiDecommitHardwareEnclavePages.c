/*
 * XREFs of MiDecommitHardwareEnclavePages @ 0x140647550
 * Callers:
 ...
 *     MiGetExceptionInfo @ 0x140626908 (MiGetExceptionInfo.c)
          ...
          if ( v17 < 0 )
          {
            ...
            else
            {
              if ( !v10 )
              {
                while ( 1 )
                {
                  v19 = *(_DWORD *)qword_140C69998;
                  v20 = *(_QWORD *)(qword_140C69998 + 8);
                  v21 = (*(_DWORD *)(qword_140C69998 + 8) & 4) != 0LL ? 0x20 : 0;
                  v58 = 0;
                  v22 = v21 + v19 - 1;
                  v23 = v20 - ((v20 & 4) != 0 ? 4 : 0);
                  if ( !v19 )
...
LABEL_32:
                  ...
                  if ( v9 == -1 )
                    break;
                  if ( (unsigned int)RtlInterlockedSetClearRun(qword_140C69998, v9, 1u) )
                    goto LABEL_61;
                }
                MiFlushTbList((int *)v67);
                ...
                if ( v28->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v27, (__int64)v28)) != 0 )
                {
                  ...
                  if ( (unsigned __int64)&qword_140C699A0 - qword_140C65AE8 >= 0x8000000000LL )
                    SessionId = -1;
                  else
                    SessionId = MmGetSessionIdEx((__int64)v28->ApcState.Process);
                  *(_DWORD *)(v29 + 8) = SessionId;
                  *(_QWORD *)v29 = (unsigned __int64)&qword_140C699A0 & 0x7FFFFFFFFFFFFFFCLL;
                }
                if ( (_DWORD)v66 )
                  KiAbThreadRemoveBoostsSlow((ULONG_PTR)v28, (__int64)&qword_140C699A0, v66);
                if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C699A0, 0LL) )
                  ExfAcquirePushLockExclusiveEx(&qword_140C699A0, v29, (__int64)&qword_140C699A0);
                if ( v29 )
                  *(_BYTE *)(v29 + 18) = 1;
                v9 = 0;
                MiLockWorkingSetShared(v48);
...
LABEL_61:
        ...
        else
        {
          do
          {
            ExAcquireSpinLockShared(&dword_140C699A8);
            v37 = KeOutPageEnclavePage(v15, *(_QWORD *)(v57 + 88));
            ExReleaseSpinLockSharedFromDpcLevel(&dword_140C699A8);
          }
...
LABEL_67:
  ...
  if ( v10 )
  {
    ...
    {
      v41 = 1;
      v42 = (volatile signed __int32 *)(*(_QWORD *)(qword_140C69998 + 8) + 4 * ((unsigned __int64)v9 >> 5));
      v43 = v9 & 0x1F;
      LOBYTE(v38) = v43 + 1;
    ...
    {
      if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C699A0, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
        ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C699A0);
      LOBYTE(v38) = KeAbPostRelease((ULONG_PTR)&qword_140C699A0);
      v39 = CurrentThread;
