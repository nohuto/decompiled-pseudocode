/*
 * XREFs of KiParkUmsThread @ 0x140525E60
 * Callers:
 ...
 *     KeRestoreLegacyFloatingPointControlWord @ 0x1403FDC80 (KeRestoreLegacyFloatingPointControlWord.c)
 *     _alloca_probe @ 0x140407B20 (_alloca_probe.c)
 *     KiUmsRestoreUch @ 0x140412B00 (KiUmsRestoreUch.c)
...
LABEL_32:
  if ( SBYTE8(PerfGlobalGroupMask) < 0 )
  {
    ...
    v44[0] = v43;
    v44[1] = 12LL;
    EtwTraceKernelEvent((__int64)v44, 1u, 0x40000080u, 0x1922u, 0x400A02u);
  }
  if ( !IsPrimaryPresent )
  {
