/*
 * XREFs of PiUEventNotifyUserMode @ 0x140783EFC
 * Callers:
 ...
 *     PiUEventShouldQueueEvent @ 0x14031D6C0 (PiUEventShouldQueueEvent.c)
 ...
 *     PiUEventIsDeviceEventVetoable @ 0x140783CC8 (PiUEventIsDeviceEventVetoable.c)
...
LABEL_57:
    ...
    *(_DWORD *)(Pool2 + 64) = *(_DWORD *)(a1 + 148) + 8;
    ...
    v11 = (__int64 *)qword_140C5D068;
    v12 = (PVOID *)PiUEventUsermodeEventQueue;
    if ( *(PVOID **)qword_140C5D068 != &PiUEventUsermodeEventQueue )
      goto LABEL_58;
    *(_QWORD *)Pool2 = &PiUEventUsermodeEventQueue;
    *(_QWORD *)(Pool2 + 8) = v11;
    *v11 = Pool2;
    qword_140C5D068 = Pool2;
    v29 = 1;
