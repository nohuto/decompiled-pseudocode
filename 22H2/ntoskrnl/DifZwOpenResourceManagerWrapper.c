/*
 * XREFs of DifZwOpenResourceManagerWrapper @ 0x1405F2490
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenResourceManagerWrapper(
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(568);
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = ResourceManagerHandle;
  LODWORD(v23) = DesiredAccess;
  *((_QWORD *)&v22 + 1) = TmHandle;
  *(_QWORD *)&v22 = ResourceManagerGuid;
...
LABEL_17:
  result = ZwOpenResourceManager(ResourceManagerHandle, DesiredAccess, TmHandle, ResourceManagerGuid, ObjectAttributes);
  LODWORD(v24) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
