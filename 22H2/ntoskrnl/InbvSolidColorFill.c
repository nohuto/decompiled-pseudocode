/*
 * XREFs of InbvSolidColorFill @ 0x1404FED70
 * Callers:
...
__int64 (__fastcall *__fastcall InbvSolidColorFill(__int64 a1, __int64 a2, unsigned int a3))(__int64, __int64, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(__int64, __int64, _QWORD))qword_140C50B78;
  if ( qword_140C50B78 )
  {
    result = *(__int64 (__fastcall **)(__int64, __int64, _QWORD))(qword_140C50B78 + 32);
    if ( result )
