/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x14059D67C
 * Callers:
 *     SmKmKeyGenStart @ 0x14092BCC0 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x14059D738 (RtlUnicodeStringValidateSrcWorker.c)
 */
