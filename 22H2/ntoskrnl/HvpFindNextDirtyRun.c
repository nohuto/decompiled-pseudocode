/*
 * XREFs of HvpFindNextDirtyRun @ 0x1403300F8
 * Callers:
...
char __fastcall HvpFindNextDirtyRun(__int64 a1, unsigned int *a2, unsigned int *a3, unsigned int *a4)
{
  ...
  if ( v13 != v12 && (*v13 | *((_DWORD *)qword_1400127A0 + (v4 & 0x1F))) == -1 )
  {
    v11 = v4 - (v4 & 0x1F) + 32;
  ...
  {
    v15 = v11 & 0x1F;
    if ( (*v13 & ~*((_DWORD *)qword_1400127A0 + v15)) == 0 )
    {
      v14 = 32 - v15;
      if ( (_DWORD)v15 == 33 )
        goto LABEL_17;
...
LABEL_20:
  ...
  if ( v4 < v6 )
  {
    ...
    {
      v26 = v4 & 0x1F;
      if ( (*v25 | *((_DWORD *)qword_1400127A0 + v26)) == -1 )
      {
        v21 = v4 - v26 + 32;
    ...
    {
      v27 = v21 & 0x1F;
      if ( (*v25 & ~*((_DWORD *)qword_1400127A0 + v27)) == 0 )
      {
        v22 = 32 - v27;
        if ( (_DWORD)v27 == 33 )
        {
