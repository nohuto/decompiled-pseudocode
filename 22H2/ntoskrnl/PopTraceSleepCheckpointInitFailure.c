/*
 * XREFs of PopTraceSleepCheckpointInitFailure @ 0x1408EC708
 * Callers:
...
void PopTraceSleepCheckpointInitFailure()
{
  ...
  if ( (unsigned int)dword_140C02228 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02228, 0x400000000000LL) )
    {
      ...
      v1 = v0;
      v4 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02228, (unsigned __int8 *)byte_14002763D, 0LL, 0LL, 3u, &v2);
    }
  }
}
