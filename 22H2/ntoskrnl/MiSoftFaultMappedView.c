/*
 * XREFs of MiSoftFaultMappedView @ 0x1402E3540
 * Callers:
...
char __fastcall MiSoftFaultMappedView(__int64 a1)
{
  ...
  *(_QWORD *)&v39 = v9;
  ...
  while ( 1 )
  {
    ...
    if ( v36 )
    {
      if ( !(unsigned int)MiCompleteRestrictedImageFault((__int64)&v39, v37, (__int64)v45, v36) )
      {
        v7 = 0;
LABEL_41:
        v28 = v37;
LABEL_42:
        if ( v35[0] != 17 )
          MiUnlockProtoPoolPage(v41, v35[0]);
        if ( v7 )
          MiCompleteRestrictedImageFault((__int64)&v39, v28, (__int64)v45, v7);
        goto LABEL_46;
      }
      v31 = 0LL;
      v36 = 0;
    ...
    v33 = (*(_DWORD *)(v3 + 48) >> 12) & 0x3F;
    if ( v30 == 1 )
      MiLockWorkingSetShared(v42, v32, v16, v31);
    MiMakeSystemAddressValid(v13, 0LL, v33, BYTE12(v39), 0);
    v7 = v36;
...
LABEL_40:
  ...
  {
    v28 = v37;
    if ( !(unsigned int)MiCompleteRestrictedImageFault((__int64)&v39, v37, (__int64)v45, v7) )
    {
      v7 = 0;
      goto LABEL_42;
    }
  ...
  v41 = MiLockProtoPoolPage((unsigned __int64)v12, (__int64)v35);
  if ( !v41 )
  {
...
LABEL_38:
  ...
  *(_QWORD *)(v25 + 24) ^= (*(_QWORD *)(v25 + 24) ^ (*(_QWORD *)(v25 + 24) + 1LL)) & 0x3FFFFFFFFFFFFFFFLL;
  ...
  MiUnlockProtoPoolPage(v41, v35[0]);
  v35[0] = 17;
  if ( (unsigned int)MiCompleteRestrictedImageFault((__int64)&v39, v27, (__int64)v45, 0x10u) )
  {
    v17 = 0LL;
    v37 = v27;
    v36 = 0;
