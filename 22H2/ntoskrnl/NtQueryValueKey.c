/*
 * XREFs of NtQueryValueKey @ 0x140645200
 * Callers:
        ...
        PULONG ResultLength)
{
  ...
  *(_OWORD *)Src = 0LL;
  ...
  v13 = KeGetCurrentThread()->$6BEBF485330D18E60173AA6D991B35AC::gap0[10];
  v76 = 0LL;
  Object = 0LL;
...
LABEL_119:
  ...
  if ( !CmpCallBackCount )
  {
    v24 = v53;
LABEL_58:
    v14 = CmKeyBodyRemapToVirtualForEnum(&DmaAdapter, v13, 1LL, &v55);
    v41 = v14;
    if ( v14 < 0 )
      goto LABEL_72;
    ...
    if ( Length )
    {
        ...
        && (v13 || !(unsigned __int8)CmpIsBufferGloballyVisible(KeyValueInformation)) )
      {
        if ( (unsigned int)dword_140C02130 > 5 && (byte_140C02140 & 4) != 0 && (qword_140C02148 & 4) == qword_140C02148 )
        {
          ...
          v91 = &v61;
          v92 = 8LL;
          tlgWriteAgg((__int64)&dword_140C02130, (unsigned __int8 *)&dword_1400233A9 + 2, v27, 5u, &v86);
        }
        if ( Length > 0x40uLL )
        {
          if ( Length > 0x1000uLL )
          ...
          {
            ++dword_140CDB918;
            v33 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _SLIST_HEADER *))qword_140CDB930)(
...
LABEL_67:
    ...
    if ( v14 >= 0 )
    {
      ...
      ValueKey = CmQueryValueKey((__int64)v55, &v77.Length, v46, (_DWORD *)Src[1], Length, (__int64)&Size);
      v14 = ValueKey;
      v41 = ValueKey;
...
LABEL_69:
        ...
        v28 = CmQueryValueKey((__int64)DmaAdapter, &v78.Length, v46, (_DWORD *)Src[1], Length, (__int64)&Size);
        v14 = v28;
        v41 = v28;
