 ...
 *     RtlFindClearBitsEx @ 0x14029C340 (RtlFindClearBitsEx.c)
 *     ExfTryToWakePushLock @ 0x1402BD930 (ExfTryToWakePushLock.c)
 *     ExfAcquirePushLockExclusiveEx @ 0x1402FCE10 (ExfAcquirePushLockExclusiveEx.c)
 *     KiCheckForKernelApcDelivery @ 0x14030F640 (KiCheckForKernelApcDelivery.c)
 *     RtlCopyBitMapEx @ 0x14033E4B0 (RtlCopyBitMapEx.c)
 *     RtlMergeBitMapsEx @ 0x1403A4C10 (RtlMergeBitMapsEx.c)
 */
...
unsigned __int64 __fastcall MiSelectRelocationStartHint(__int64 a1, unsigned __int16 a2, unsigned __int64 a3, int a4)
{
  ...
  if ( !a4 )
  {
    ...
    v10 = KeAbPreAcquire((__int64)&qword_140C65840, 0LL);
    v11 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65840, 0LL);
    v12 = v10;
    if ( v11 )
      ExfAcquirePushLockExclusiveEx(&qword_140C65840, v10, (__int64)&qword_140C65840);
    if ( v12 )
      *(_BYTE *)(v12 + 18) = 1;
  }
  RtlCopyBitMapEx(*(_QWORD *)a1, &qword_140C658C8, 0LL);
  RtlMergeBitMapsEx((unsigned __int64 *)&qword_140C658C8, *(__int64 **)(a1 + 8));
  ClearBits = RtlFindClearBitsEx((unsigned __int64 *)&qword_140C658C8, v6, a3);
  if ( !a4 )
  {
