/*
 * XREFs of WmipGetSMBiosTableData @ 0x14065FBBC
 * Callers:
 *     WmipRawSMBiosTableHandler @ 0x1402E7A90 (WmipRawSMBiosTableHandler.c)
 ...
 *     WmipSMBiosHideMachine @ 0x14093223C (WmipSMBiosHideMachine.c)
 */
