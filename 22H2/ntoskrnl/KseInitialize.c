/*
 * XREFs of KseInitialize @ 0x140B4CCCC
 * Callers:
...
LABEL_12:
  ...
  v14 = _InterlockedCompareExchange(&dword_140C64E34, 1, 0);
  if ( v14 == 2 )
    return 0LL;
  if ( v14 == 1 )
    return 259LL;
