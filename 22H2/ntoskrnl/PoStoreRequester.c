/*
 * XREFs of PoStoreRequester @ 0x14032CD64
 * Callers:
...
__int64 __fastcall PoStoreRequester(__int64 a1, __int64 a2, unsigned __int64 *a3, char a4)
{
  ...
  if ( *(_DWORD *)a1 )
  {
    if ( v12 )
    {
      if ( (unsigned int)Feature_2932140347__private_IsEnabledDeviceUsage(a1, a2, a3, 0LL) )
        a1 = *(unsigned int *)(v7 + 32);
      else
        a1 = *(unsigned int *)(*(_QWORD *)(v7 + 8) + 1088LL);
      *(_DWORD *)(v5 + 24) = a1;
      *(_DWORD *)(v5 + 28) = *(_DWORD *)(v7 + 40);
    }
    if ( (unsigned int)Feature_2932140347__private_IsEnabledDeviceUsage(a1, a2, a3, v8) )
      v13 = (unsigned __int16 *)(v7 + 16);
    else
      v13 = *(unsigned __int16 **)(*(_QWORD *)(v7 + 8) + 1472LL);
    v14 = *v13;
