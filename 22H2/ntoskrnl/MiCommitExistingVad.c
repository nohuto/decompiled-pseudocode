/*
 * XREFs of MiCommitExistingVad @ 0x140276910
 * Callers:
 ...
 *     MiComputePreferredNode @ 0x140617800 (MiComputePreferredNode.c)
 ...
 *     MiGetVadLargePageMinimumIndex @ 0x140660C44 (MiGetVadLargePageMinimumIndex.c)
 ...
 *     MiReturnProcessPhysicalPages @ 0x140A43C90 (MiReturnProcessPhysicalPages.c)
 */
        ...
        _WORD *a11)
{
  ...
  if ( (v17 & 0xA00000) == 0xA00000 )
  {
    ...
    v22 = *(_QWORD *)(*(_QWORD *)(qword_140C674C8 + 8LL * v103[1].IdealProcessor[25]) + 200LL);
LABEL_134:
    v126 = v22;
    goto LABEL_106;
  }
...
LABEL_13:
    ...
    if ( v34->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v31, v34)) != 0 )
    {
      ...
      if ( v32 - qword_140C65AE8 < 0x8000000000LL )
...
LABEL_26:
      ...
      {
        if ( v45 == 2 )
          v46 = (volatile __int32 *)&unk_140C6A280;
        else
LABEL_29:
...
LABEL_177:
  ...
  else
  {
    ...
    v112 = *(volatile signed __int64 **)(qword_140C674C8 + 8LL * v103[1].IdealProcessor[25]);
  }
