/*
 * XREFs of EtwpWriteAppStateChangeSummary @ 0x1407543B0
 * Callers:
        ...
        unsigned __int16 *a6)
{
  ...
  if ( dword_140C042E8 )
  {
    v10 = tlgKeywordOn((__int64)&dword_140C042E8, 0x200000000000LL);
    v12 = *(_QWORD *)&v73[0];
    if ( v10 )
      v12 = v11;
    *(_QWORD *)&v73[0] = v12;
...
LABEL_10:
  ...
  {
    LOBYTE(v16) = tlgKeywordOn((__int64)&dword_140C042E8, 0x400000000000LL);
    if ( (_BYTE)v16 )
    {
      v19 = *a2;
      v20 = v18;
      ...
      v72 = 50331648LL;
      v140 = 8LL;
      LOBYTE(v16) = tlgWriteAgg((__int64)&dword_140C042E8, (unsigned __int8 *)&dword_14003503C, v44, 0x24u, &v74);
    }
  }
  return v16;
}
