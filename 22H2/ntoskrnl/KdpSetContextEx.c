/*
 * XREFs of KdpSetContextEx @ 0x14051142C
 * Callers:
...
__int64 __fastcall KdpSetContextEx(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int16)v4 < 0x500u && KiProcessorBlock[v4] && KdpContextSent )
  {
    ...
    if ( (unsigned int)v6 <= 0x1000
      ...
      && v7 + v8 <= v6 )
    {
      KdpQuickMoveMemory((char *)&unk_140CF6898 + (unsigned int)v7, *(_QWORD *)(a2 + 8), (unsigned int)v8);
      if ( v10 == v9 )
      {
        v11 = *(unsigned __int16 *)(a1 + 6);
        if ( (_WORD)v11 != (unsigned __int16)KeGetPcr()->Prcb.Number )
          a3 = *(_QWORD *)(KiProcessorBlock[v11] + 34240);
        KdpSanitizeContextFlags(&unk_140CF6898, (unsigned int)v9, &v14);
        KdpCopyContext(a3, v14, &unk_140CF6898);
      }
      *(_DWORD *)(a1 + 8) = 0;
      *(_DWORD *)(a1 + 24) = v8;
    }
