/*
 * XREFs of EtwpCoverageSamplerStart @ 0x1409471DC
 * Callers:
 ...
 *     ExReInitializeRundownProtection @ 0x14037E680 (ExReInitializeRundownProtection.c)
 ...
 *     PsSetLoadImageNotifyRoutine @ 0x140799820 (PsSetLoadImageNotifyRoutine.c)
