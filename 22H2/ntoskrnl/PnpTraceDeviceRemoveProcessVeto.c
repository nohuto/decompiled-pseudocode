/*
 * XREFs of PnpTraceDeviceRemoveProcessVeto @ 0x1408B1A64
 * Callers:
...
void PnpTraceDeviceRemoveProcessVeto()
{
  ...
  if ( (unsigned int)dword_140C02DC8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02DC8, 0x400000000000LL) )
    {
      ...
      v13 = 2LL;
      v15[1] = 0;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02DC8, (unsigned __int8 *)word_140025662, 0LL, 0LL, 8u, &v3);
    }
  }
}
