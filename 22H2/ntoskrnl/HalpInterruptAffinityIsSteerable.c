/*
 * XREFs of HalpInterruptAffinityIsSteerable @ 0x140320224
 * Callers:
 *     HalGetMessageRoutingInfo @ 0x140320040 (HalGetMessageRoutingInfo.c)
 * Callees:
 *     KeQueryInterruptPartitionInformation @ 0x140320370 (KeQueryInterruptPartitionInformation.c)
 *     KeQueryInterruptPartitionCount @ 0x1403203E0 (KeQueryInterruptPartitionCount.c)
 */
