/*
 * XREFs of PopConfigureHeteroPolicies @ 0x1407BB8BC
 * Callers:
 ...
 *     KeConfigureHeteroPolicy @ 0x1407BBED0 (KeConfigureHeteroPolicy.c)
 *     PpmHeteroComputeBias @ 0x1408F1588 (PpmHeteroComputeBias.c)
 */
  ...
  for ( i = 0; i < 5; ++i )
  {
    switch ( i )
    {
      ...
      case 3u:
        ...
        {
          v12 = &PpmCurrentProfile[342 * dword_140C2334C + 5];
          HIDWORD(v62) |= 0x1800u;
          goto LABEL_30;
        }
LABEL_28:
        v12 = (__int64 *)(v16 + 2736LL * dword_140C2334C + 40);
        v62 = *v12;
        goto LABEL_30;
      default:
        v12 = &PpmCurrentProfile[342 * dword_140C2334C + 5];
