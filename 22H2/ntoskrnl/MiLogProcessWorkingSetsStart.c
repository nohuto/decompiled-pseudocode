/*
 * XREFs of MiLogProcessWorkingSetsStart @ 0x14025FD4C
 * Callers:
...
void __fastcall MiLogProcessWorkingSetsStart(__int64 a1, __int64 a2, int a3)
{
  int v4; // edx
  int v5; // r8d
  __int64 v6; // r9
  ...
  if ( *(_QWORD *)&qword_140C4EEE0 && **(_DWORD **)&qword_140C4EEE0 > 5u )
  {
    if ( (unsigned __int8)tlgKeywordOn(*(_QWORD *)&qword_140C4EEE0, 1LL) )
    {
      ...
      v44 = 8;
      v29 = 4;
      tlgWriteEx_EtwWriteEx(v7, (int)&dword_140025D34, v5, v4, v12, v13, 0xAu, (__int64)v22);
    }
  }
}
