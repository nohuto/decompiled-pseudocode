/*
 * XREFs of WheapTranslateAddressInPlugin @ 0x140A08814
 * Callers:
 *     WheaAddrTranslateAndAddToDefectListInPlugin @ 0x140A07CDC (WheaAddrTranslateAndAddToDefectListInPlugin.c)
 * Callees:
