/*
 * XREFs of DifIoRaiseInformationalHardErrorWrapper @ 0x1405E0820
 * Callers:
 *     <none>
 * Callees:
        ...
        PKTHREAD Thread)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(198);
...
LABEL_17:
  result = IoRaiseInformationalHardError(ErrorStatus, String, Thread);
  BYTE12(v19) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
