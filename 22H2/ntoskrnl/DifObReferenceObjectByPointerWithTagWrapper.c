/*
 * XREFs of DifObReferenceObjectByPointerWithTagWrapper @ 0x1405E8850
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifObReferenceObjectByPointerWithTagWrapper(
        PVOID Object,
...
LABEL_10:
  ...
  *(_QWORD *)&v22 = ObjectType;
  BYTE12(v21) = AccessMode;
...
LABEL_17:
  result = ObReferenceObjectByPointerWithTag(Object, DesiredAccess, ObjectType, AccessMode, Tag);
  DWORD2(v23) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
