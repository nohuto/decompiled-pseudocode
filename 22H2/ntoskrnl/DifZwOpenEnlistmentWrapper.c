/*
 * XREFs of DifZwOpenEnlistmentWrapper @ 0x1405F16B0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenEnlistmentWrapper(
...
LABEL_10:
  ...
  *((_QWORD *)&v22 + 1) = RmHandle;
  *(_QWORD *)&v22 = EnlistmentGuid;
...
LABEL_17:
  result = ZwOpenEnlistment(EnlistmentHandle, DesiredAccess, RmHandle, EnlistmentGuid, ObjectAttributes);
  LODWORD(v24) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
