/*
 * XREFs of DifRtlCheckRegistryKeyWrapper @ 0x1405EAEC0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlCheckRegistryKeyWrapper(ULONG RelativeTo, PWSTR Path)
{
...
LABEL_17:
  result = RtlCheckRegistryKey(RelativeTo, Path);
  HIDWORD(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
