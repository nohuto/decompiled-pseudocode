/*
 * XREFs of _CmUpdateDevicePanel @ 0x14079920C
 * Callers:
 ...
 *     _CmGetDevicePanelGroup @ 0x140864968 (_CmGetDevicePanelGroup.c)
...
LABEL_97:
  ...
  else
  {
    if ( v13 )
    {
      PnpSetObjectProperty(v3, (__int64)a2, 1u, a3, 0LL, (__int64)DEVPKEY_Device_PanelRotationX, 0, 0LL, 0, 0);
      PnpSetObjectProperty(v3, (__int64)a2, 1u, a3, 0LL, (__int64)DEVPKEY_Device_PanelRotationY, 0, 0LL, 0, 0);
      PnpSetObjectProperty(v3, (__int64)a2, 1u, a3, 0LL, (__int64)DEVPKEY_Device_PanelRotationZ, 0, 0LL, 0, 0);
    }
    if ( !v5 )
      goto LABEL_15;
  }
...
LABEL_58:
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v34 < 7 )
      v33 = (unsigned int)dword_1400211C0[v34];
    v62 = v33;
    if ( !v5 )
    {
    ...
    {
      if ( !v54 )
        PnpSetObjectProperty(v3, (__int64)v5, 6u, (__int64)v6, 0LL, (__int64)DEVPKEY_DevicePanel_Color, 0, 0LL, 0, 0);
    }
    else
    {
...
LABEL_169:
    ...
    if ( (*v15 & 0x1F) == 0 )
    {
      if ( v54 )
        goto LABEL_232;
      PnpSetObjectProperty(v3, (__int64)v5, 6u, (__int64)v6, 0LL, (__int64)DEVPKEY_DevicePanel_JointType, 0, 0LL, 0, 0);
...
LABEL_231:
    ...
    v44 = 0LL;
    if ( ((*v15 >> 20) & 7) != 7 )
      v44 = (unsigned int)dword_1400211C0[(*v15 >> 20) & 7];
    v52 = v44;
    ...
    if ( ParentDeviceContainerId < 0 )
      goto LABEL_27;
    v52 = dword_14004CFC0[(unsigned __int64)(unsigned int)*v15 >> 31];
    ParentDeviceContainerId = PnpSetObjectProperty(
                                v3,
                                (__int64)v5,
                                6u,
