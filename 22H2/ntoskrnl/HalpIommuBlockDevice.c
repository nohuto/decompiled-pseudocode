/*
 * XREFs of HalpIommuBlockDevice @ 0x1404C8DA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpIommuDecreaseAliasTrack @ 0x1403EFA8C (HalpIommuDecreaseAliasTrack.c)
...
LABEL_10:
  ...
  if ( v2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v13 )
        break;
      v15 = (unsigned __int64)&CurrentThread->LockEntries[v14];
      v12 &= ~(1 << v14);
      if ( (*(_BYTE *)(v15 + 26) & 1) != 0
        && (*(_DWORD *)(v15 + 32) & 1) == 0
        ...
        *(_BYTE *)(v15 + 26) &= ~1u;
        if ( *(_QWORD *)(v15 + 32) )
        {
          if ( v15 )
          {
            ...
            *(_DWORD *)(v15 + 88) = v17;
            *(_QWORD *)(v15 + 32) = 0LL;
            v18 = (__int64)(v15 - (unsigned __int64)CurrentThread->LockEntries) / 96;
            if ( v11 == 1 )
