/*
 * XREFs of PnpQueuePendingSurpriseRemoval @ 0x140883540
 * Callers:
...
_QWORD *__fastcall PnpQueuePendingSurpriseRemoval(PVOID a1, unsigned int ***a2, int a3, int a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v4 == v10 )
  {
    ...
    v12 = (__int64 *)qword_140C5CB08;
    if ( *(PVOID **)qword_140C5CB08 != &IopPendingSurpriseRemovals )
LABEL_28:
      __fastfail(3u);
    *(_QWORD *)CriticalMemory = &IopPendingSurpriseRemovals;
    *(_QWORD *)(CriticalMemory + 8) = v12;
    *v12 = CriticalMemory;
    qword_140C5CB08 = CriticalMemory;
  }
  else
  {
  ...
  while ( IopEnumerateRelations(v10, (int *)&v22, &v23, 0LL, 0LL) )
  {
    if ( v23 )
      ...
      v14 = 0LL;
    if ( (*(_BYTE *)(v14 + 648) & 1) != 0 && IopIsDescendantNode(v10, v23) )
    {
      *(_QWORD *)(v15 + 648) &= ~1uLL;
