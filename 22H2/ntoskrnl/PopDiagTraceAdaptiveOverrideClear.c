/*
 * XREFs of PopDiagTraceAdaptiveOverrideClear @ 0x14098C64C
 * Callers:
 *     PopAdaptiveConsoleSessionOverrideClear @ 0x14099B830 (PopAdaptiveConsoleSessionOverrideClear.c)
 * Callees:
  ...
  if ( (unsigned int)dword_140C03950 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&word_14002FA16,
        0LL,
        0LL,
        5u,
        &v5);
