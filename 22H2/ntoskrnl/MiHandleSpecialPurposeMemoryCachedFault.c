/*
 * XREFs of MiHandleSpecialPurposeMemoryCachedFault @ 0x140660478
 * Callers:
        ...
        ULONG_PTR a4)
{
  ...
  v26 = 0LL;
  v6 = 0LL;
  v9 = **(_QWORD **)(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(a4 + 40) >> 43) & 0x3FFLL)) + 16944LL);
  if ( *(__int64 *)(a4 + 40) < 0 )
  {
    v10 = *(_QWORD *)(a4 + 16);
    if ( (v10 & 0x400) != 0 )
...
LABEL_30:
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v21 + 40) >> 43) & 0x3FFLL)) + 4LL) & 0x80u) == 0 )
    {
