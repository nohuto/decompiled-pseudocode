/*
 * XREFs of PopAccountCbEnergyChange @ 0x140870DF8
 * Callers:
...
int PopAccountCbEnergyChange()
{
  ...
  if ( (__int64 *)qword_140C3D110 != &qword_140C3D110 )
  {
    ...
    while ( (__int64 *)v2 != &qword_140C3D110 );
    LODWORD(v36) = v3;
  }
  if ( v3 != (_DWORD)xmmword_140C3D2E8 || v1 != *((_QWORD *)&xmmword_140C3D2E8 + 1) )
  {
    xmmword_140C3D2E8 = v36;
    if ( (unsigned int)dword_140C03950 > 5 )
    {
      ...
      *(_QWORD *)&v36 = v14;
      ...
      if ( (v31 & (unsigned __int8)byte_140C3D2F8) == 0 )
        v32 = "-";
      tlgCreate1Sz_char((__int64)v66, v32);
      if ( HIDWORD(qword_140C3D140) )
        v33 = (100 * dword_140C3D124 + (HIDWORD(qword_140C3D140) >> 1)) / HIDWORD(qword_140C3D140);
      else
        v33 = 0;
      v69 = 0;
      v38 = v33;
      ...
      v68 = v8;
      if ( HIDWORD(qword_140C3D140) )
        v34 = 100000 * (unsigned __int64)dword_140C3D124 / HIDWORD(qword_140C3D140);
      else
        LODWORD(v34) = 0;
      v72 = 0;
      v75 = 0;
      ...
      LODWORD(v1) = tlgWriteTransfer_EtwWriteTransfer(
                      ...
                      (unsigned __int8 *)&word_140030666,
                      0LL,
                      0LL,
                      0x17u,
                      &v45);
