/*
 * XREFs of RtlpHpLfhSubsegmentFreeBlock @ 0x140315AE0
 * Callers:
...
__int64 __fastcall RtlpHpLfhSubsegmentFreeBlock(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  v7 = qword_140C6B388 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
  v8 = a4;
  v9 = 0LL;
  if ( a3 )
  {
    v10 = a3 - (((unsigned int)qword_140C6B388 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12)) >> 16) - a2;
    v11 = *(_QWORD *)(a1
                    + 8LL
