/*
 * XREFs of IommuBeginDeviceReset @ 0x1404D7A50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IommuBeginDeviceReset(KSPIN_LOCK *a1, _DWORD *a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v16 )
      goto LABEL_33;
    v21 = (unsigned __int64)&CurrentThread->LockEntries[v22];
    v20 &= ~(1 << v22);
    if ( (*(_BYTE *)(v21 + 26) & 1) != 0
      && (*(_DWORD *)(v21 + 32) & 1) == 0
...
LABEL_33:
  ...
  *(_DWORD *)(v21 + 88) = v24;
  *(_QWORD *)(v21 + 32) = 0LL;
  v25 = (__int64)(v21 - (unsigned __int64)CurrentThread->LockEntries) / 96;
  if ( v19 == 1 )
