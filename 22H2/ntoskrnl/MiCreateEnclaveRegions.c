/*
 * XREFs of MiCreateEnclaveRegions @ 0x140B48B44
 * Callers:
...
__int64 __fastcall MiCreateEnclaveRegions(__int64 a1)
{
  ...
  v1 = 0;
  qword_140C699B8 = (__int64)&qword_140C699B0;
  qword_140C699B0 = (__int64)&qword_140C699B0;
  v2 = 0LL;
  qword_140C699C0 = 0LL;
  stru_140C699C8.Count = 0LL;
  v3 = *(_QWORD *)(a1 + 360);
  if ( (v3 & 1) == 0 )
  {
    v4 = *(_QWORD *)(a1 + 360);
...
LABEL_26:
      ...
      v12 = 1;
LABEL_22:
      RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C69988, (unsigned __int64)v13, v12, v2);
LABEL_23:
