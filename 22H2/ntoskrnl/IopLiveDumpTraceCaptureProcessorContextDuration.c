/*
 * XREFs of IopLiveDumpTraceCaptureProcessorContextDuration @ 0x14055A6FC
 * Callers:
  ...
  if ( (_BYTE)v3 )
  {
    if ( !v4[106] )
    {
      ...
      if ( (v3 & 1) != 0 )
      {
        ...
        v5 = (const EVENT_DESCRIPTOR *)LIVEDUMP_EVENT_SIZING_WORKFLOW_SYSTEM_QUIESCED_CAPTURE_PROCESSOR_CONTEXT;
        if ( (v4[20] & 1) == 0 )
          v5 = &LIVEDUMP_EVENT_CAPTURE_PAGES_WORKFLOW_SYSTEM_QUIESCED_CAPTURE_PROCESSOR_CONTEXT;
        UserData.Size = 8;
        ...
        if ( (unsigned int)dword_140C03870 > 5 )
        {
          ...
          if ( (_BYTE)v3 )
          {
            ...
            LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)byte_14002C205,
                           (const GUID *)(a1 + 968),
                           (const GUID *)(a1 + 952),
                           4u,
                           &v10);
