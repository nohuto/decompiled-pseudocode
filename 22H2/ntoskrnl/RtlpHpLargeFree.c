    ...
    if ( !v13 )
    {
      ...
      else
      {
        ...
        while ( 1 )
        {
          ...
          if ( v24 )
            goto LABEL_66;
          v40 = (unsigned __int64)&CurrentThread->LockEntries[v39];
          v38 &= ~(1 << v39);
          if ( (*(_BYTE *)(v40 + 26) & 1) != 0
            && (*(_DWORD *)(v40 + 32) & 1) == 0
...
LABEL_66:
        ...
        *(_BYTE *)(v40 + 25) &= ~1u;
        *(_QWORD *)(v40 + 32) = 0LL;
        v41 = (__int64)(v40 - (unsigned __int64)CurrentThread->LockEntries) / 96;
        if ( v37 == 1 )
