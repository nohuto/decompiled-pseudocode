/*
 * XREFs of DifZwQueryKeyWrapper @ 0x1405F51B0
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG ResultLength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(604);
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = KeyHandle;
  LODWORD(v23) = KeyInformationClass;
  *((_QWORD *)&v22 + 1) = KeyInformation;
  LODWORD(v22) = Length;
...
LABEL_17:
  result = ZwQueryKey(KeyHandle, KeyInformationClass, KeyInformation, Length, ResultLength);
  LODWORD(v24) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
