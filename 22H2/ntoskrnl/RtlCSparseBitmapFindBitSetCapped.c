/*
 * XREFs of RtlCSparseBitmapFindBitSetCapped @ 0x14024FB60
 * Callers:
 ...
 * Callees:
 *     RtlLengthCurrentClearRunBackwardEx @ 0x1405A8A2C (RtlLengthCurrentClearRunBackwardEx.c)
 *     RtlLengthCurrentClearRunForwardEx @ 0x1405A8AD0 (RtlLengthCurrentClearRunForwardEx.c)
 */
