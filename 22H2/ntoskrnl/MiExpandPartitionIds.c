/*
 * XREFs of MiExpandPartitionIds @ 0x1408DAEA8
 * Callers:
...
__int64 __fastcall MiExpandPartitionIds(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  v4 = 512;
  if ( (__int64 *)qword_140C4E648 != &qword_140C4E640 )
    v4 = qword_140C4E628->SizeOfBitMap + 512;
  if ( v4 <= qword_140C4E628->SizeOfBitMap || v4 > 0x400 )
  {
    v6 = 0LL;
    v7 = 0LL;
  }
  ...
  if ( (__int64 *)qword_140C4E648 == &qword_140C4E640 )
  {
    v9 = MiReservePtes((__int64)&qword_140C4EF40, 2u, qword_140C4E648, a4);
    if ( !v9 )
      goto LABEL_18;
  ...
  {
    v10 = qword_140C4E648 + 8LL * qword_140C4E628->SizeOfBitMap;
  }
...
LABEL_18:
  ...
  if ( (__int64 *)qword_140C4E648 == &qword_140C4E640 )
  {
    *(_QWORD *)v10 = *(_QWORD *)qword_140C4E648;
    qword_140C4E648 = v10;
  }
  RtlClearAllBits(v7);
  SizeOfBitMap = qword_140C4E628->SizeOfBitMap;
  LOBYTE(v6) = (SizeOfBitMap & 0x3F) != 0;
  memmove(v7->Buffer, qword_140C4E628->Buffer, 8 * ((SizeOfBitMap >> 6) + v6));
  if ( qword_140C4E628 != (PRTL_BITMAP)&dword_140C4E630 )
    ExFreePoolWithTag(qword_140C4E628, 0);
  qword_140C4E628 = v7;
  return 1LL;
}
