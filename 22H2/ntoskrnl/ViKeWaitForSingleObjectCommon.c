/*
 * XREFs of ViKeWaitForSingleObjectCommon @ 0x1409DC568
 * Callers:
 *     VerifierKeWaitForSingleObject @ 0x1409DBA20 (VerifierKeWaitForSingleObject.c)
 *     VerifierKeWaitForSingleObjectNoReboot @ 0x1409DBA90 (VerifierKeWaitForSingleObjectNoReboot.c)
 * Callees:
