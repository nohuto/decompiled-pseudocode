/*
 * XREFs of IopLiveDumpEstimateMemoryPages @ 0x1409AC3CC
 * Callers:
 ...
 *     HvlCalculateLivedumpSize @ 0x1404F87E0 (HvlCalculateLivedumpSize.c)
...
__int64 __fastcall IopLiveDumpEstimateMemoryPages(__int64 a1)
{
        ...
        *(_DWORD *)(a1 + 80) |= 0x10u;
        ...
        if ( (unsigned int)dword_140C044D8 > 5 && tlgKeywordOn((__int64)&dword_140C044D8, 0x200000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)word_140024992,
            (const GUID *)(a1 + 864),
            (const GUID *)(a1 + 848),
            4u,
            &v43);
  ...
  *(_DWORD *)(a1 + 80) &= ~1u;
  if ( (unsigned int)dword_140C044D8 > 5 && tlgKeywordOn((__int64)&dword_140C044D8, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140C044D8,
      (unsigned __int8 *)&word_1400249DE,
      (const GUID *)(a1 + 864),
      (const GUID *)(a1 + 848),
      8u,
      &v30);
