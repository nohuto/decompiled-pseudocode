/*
 * XREFs of CmpRemoveSubKey @ 0x1406E474C
 * Callers:
...
char __fastcall CmpRemoveSubKey(ULONG_PTR BugCheckParameter2, __int64 a2, unsigned int a3)
{
  ...
  v10 = -1;
  v11 = 0;
  v5 = (*(__int64 (__fastcall **)(ULONG_PTR, __int64, int *))(BugCheckParameter2 + 8))(BugCheckParameter2, a2, &v10);
  v6 = v5;
  if ( !v5 )
    return 0;
  v7 = (unsigned __int64)a3 >> 31;
  v8 = CmpRemoveSubKeyFromList(BugCheckParameter2, (int *)(v5 + 4 * v7 + 28), a3);
  if ( v8 )
  {
    --*(_DWORD *)(v6 + 4 * v7 + 20);
    v8 = 1;
