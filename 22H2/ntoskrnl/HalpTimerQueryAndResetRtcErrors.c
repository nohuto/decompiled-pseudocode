/*
 * XREFs of HalpTimerQueryAndResetRtcErrors @ 0x1404FEEE0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall HalpTimerQueryAndResetRtcErrors(char a1)
{
  ...
  if ( a1 )
  {
    if ( (unsigned int)dword_140C04BB0 > 5 && tlgKeywordOn((__int64)&dword_140C04BB0, 0x400000000000LL) )
    {
      ...
      v8 = v1;
      v11 = 4;
      tlgWriteEx_EtwWriteEx((__int64)&dword_140C04BB0, (unsigned __int8 *)&byte_1400293B1, v2, 1u, v6, v7, 3u, v9);
    }
    v3 = 9;
  }
  else
  {
    if ( (unsigned int)dword_140C04BB0 > 5 && tlgKeywordOn((__int64)&dword_140C04BB0, 0x400000000000LL) )
    {
      ...
      v8 = v1;
      v11 = 4;
      tlgWriteEx_EtwWriteEx((__int64)&dword_140C04BB0, (unsigned __int8 *)&word_140029376, v4, 1u, v6, v7, 3u, v9);
    }
    v3 = 31;
  }
  return (v3 & v1) != 0;
