/*
 * XREFs of HvUnCOWReconciledPages @ 0x140361C30
 * Callers:
...
void __fastcall HvUnCOWReconciledPages(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 160) & 0x20000) != 0 )
  {
    ...
    if ( (_DWORD)v9 )
    {
      ...
      {
        v9 = v11 & 0x1F;
        if ( (*v10 & ~*((_DWORD *)qword_1400127A0 + v9)) == 0 )
        {
          v13 = 32 - v9;
          if ( (_DWORD)v9 == 33 )
            goto LABEL_26;
...
LABEL_26:
          ...
          if ( v19 != (_DWORD *)v9 && (*v19 | *((_DWORD *)qword_1400127A0 + (v11 & 0x1F))) == -1 )
          {
            v11 = v11 - (v11 & 0x1F) + 32;
          ...
          {
            v21 = v11 & 0x1F;
            if ( (*v19 & ~*((_DWORD *)qword_1400127A0 + (v11 & 0x1F))) == 0 )
              break;
          }
LABEL_42:
