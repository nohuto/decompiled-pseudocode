        ...
        char a12)
{
  ...
  struct _SECURITY_SUBJECT_CONTEXT *v52; // r13
...
LABEL_51:
            ...
            || (*((_DWORD *)v43 + 2) & 4) != 0 )
          {
            if ( *(_DWORD *)(PrimaryToken + 128) )
              v44 = SepSidInTokenSidHash((PSID_AND_ATTRIBUTES_HASH)(PrimaryToken + 504), 1, 0, a12);
            else
              v44 = 1;
          }
          else
...
LABEL_166:
  ...
  if ( PrimaryToken )
  {
      ...
      && !v145 )
    {
      v77 = *v59 >= 0;
      v78 = v132 | v14;
      v79 = SepLocateTokenTrustLevel(v52, v60, v57);
