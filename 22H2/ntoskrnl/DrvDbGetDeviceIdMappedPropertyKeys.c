/*
 * XREFs of DrvDbGetDeviceIdMappedPropertyKeys @ 0x14097D320
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  if ( CompositeMappedPropertyKeys >= 0 && v13 )
    CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(v10, (_OWORD **)off_140C0F0F8, 3u, a4, a5, v6);
LABEL_7:
  if ( Handle[0] )
    ZwClose(Handle[0]);
