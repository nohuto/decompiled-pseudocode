/*
 * XREFs of CmpTryAcquireIXLockWithRollbackPacket @ 0x14076D8E0
 * Callers:
 *     CmpTryAcquireKcbIXLocks @ 0x14076D874 (CmpTryAcquireKcbIXLocks.c)
 * Callees:
 *     CmpSnapshotTxOwnerArrayToRollbackPacket @ 0x14087519C (CmpSnapshotTxOwnerArrayToRollbackPacket.c)
 */
