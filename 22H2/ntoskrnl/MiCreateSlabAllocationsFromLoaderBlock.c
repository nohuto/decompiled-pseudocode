/*
 * XREFs of MiCreateSlabAllocationsFromLoaderBlock @ 0x140B48744
 * Callers:
...
LABEL_28:
      while ( i )
      {
        ...
        if ( v5 == 29 || v5 == 36 )
        {
          ...
          do
          {
            ...
            BootSlabEntries = MiCreateBootSlabEntries(qword_140C6B510 + 23920 + 25408LL * v12, v7, v11, 0LL);
  ...
  if ( (MiFlags & 0x4000) != 0 )
  {
    ...
    v16[1] = ((unsigned int)dword_140C6B504 >> 3) & 1;
