/*
 * XREFs of CcWorkerThread @ 0x140273870
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CcOkToAddWriteBehindThread @ 0x1404E9CCC (CcOkToAddWriteBehindThread.c)
 */
...
LABEL_16:
    ...
    if ( (xmmword_140CFC490 & 0x20000) != 0 )
    {
      ...
      if ( (xmmword_140CFC490 & 0x20000) != 0 )
      {
        ...
        v49[0] = v45;
        v49[1] = 8LL;
        EtwTraceKernelEvent((unsigned int)v49, 1, -2147352576, 5633, 4200706);
      }
    }
    ...
    else
    {
      if ( (xmmword_140CFC490 & 0x20000) != 0 )
      {
        ...
        v50[0] = &v46;
        v50[1] = 8LL;
        EtwTraceKernelEvent((unsigned int)v50, 1, -2147352576, 5634, 4200706);
      }
