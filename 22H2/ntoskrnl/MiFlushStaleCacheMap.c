/*
 * XREFs of MiFlushStaleCacheMap @ 0x14062E004
 * Callers:
...
__int64 __fastcall MiFlushStaleCacheMap(__int64 a1)
{
  ...
  {
    v8 = (2
        * (((unsigned __int8)v2 & (unsigned __int8)((1LL << ((unsigned __int8)dword_140C65BE0 - 12)) - 1)) - (_BYTE)v7)) & 0x1F;
    v9 = (unsigned int)(*(_DWORD *)(a1
                                  + 4
                                  * ((unsigned __int64)(2
                                                      * (((unsigned int)v2 & ((unsigned int)(1LL << ((unsigned __int8)dword_140C65BE0 - 12))
                                                                            - 1))
                                                       - (unsigned int)v7)) >> 5)
                                  + 44) >> v8);
    LOBYTE(v9) = v9 & 3;
