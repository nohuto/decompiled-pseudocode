/*
 * XREFs of MiReferenceActiveSubsection @ 0x140288C80
 * Callers:
    ...
    if ( v12 > 1 )
    {
      ...
      if ( v12 == 2 && (a2 & 0x20) != 0 && v41 )
      {
        ...
        MiReturnCrossPartitionSectionCharges(
          *(_QWORD *)(qword_140C674C8 + 8LL * (*(_WORD *)(v3 + 60) & 0x3FF)),
          v42,
          v41);
        if ( !v5 )
...
LABEL_17:
    if ( (a2 & 0x20) != 0 )
    {
      ...
      __writecr8(v6);
      MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140C674C8 + 8LL * (*(_WORD *)(v3 + 60) & 0x3FF)), v9, v4);
      if ( !v5 )
        ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(v3 + 72));
      return 3221225773LL;
    }
