/*
 * XREFs of BgpDisplaySafeToPowerOffScreen @ 0x1405C53BC
 * Callers:
 *     BgDisplaySafeToPowerOffScreen @ 0x1405C417C (BgDisplaySafeToPowerOffScreen.c)
 * Callees:
...
__int64 BgpDisplaySafeToPowerOffScreen()
{
  ...
  if ( (dword_140C134F0 & 2) != 0 )
  {
    ...
    *(_DWORD *)(*(_QWORD *)(qword_140C53EF0 + 24) + 40LL) = -16777216;
    ...
    v0 = 0;
    v3 = &dword_140C10F00[18 * DisplayType + 5];
    LODWORD(BcpCursor) = dword_140C10F00[18 * DisplayType + 4];
    v4 = *v3;
    HIDWORD(BcpCursor) = *v3;
    if ( v3 )
      dword_140C4C5E0 = v4;
    BcpDisplayCriticalString(&stru_140C53EE0.Length, dword_140C10F00[18 * DisplayType + 2], v2, DisplayType);
  }
  else
  {
