/*
 * XREFs of PopFanWorker @ 0x140802170
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Status >= 0 )
  {
    if ( (unsigned int)dword_140C03950 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_140031724,
        0LL,
        0LL,
        4u,
        v29);
...
LABEL_34:
      ...
      if ( !v13 )
      {
        if ( (unsigned int)dword_140C03950 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03950,
            (unsigned __int8 *)&word_14003169E,
            0LL,
            0LL,
            5u,
            v34);
...
LABEL_17:
      ...
      if ( !(_DWORD)v8 )
      {
        if ( (unsigned int)dword_140C03950 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03950,
            (unsigned __int8 *)word_1400316DA,
            0LL,
            0LL,
            5u,
            v34);
  ...
  if ( (unsigned int)dword_140C03950 > 5 )
  {
    ...
    v37 = &v23;
    v38 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03950, (unsigned __int8 *)byte_140031923, 0LL, 0LL, 4u, v34);
  }
  ...
  if ( *(_BYTE *)(a1 + 64) != 2 )
  {
    if ( *(_BYTE *)(a1 + 64) == 3 )
    {
      if ( (unsigned int)dword_140C03950 > 2 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03950,
          (unsigned __int8 *)byte_14003188B,
          0LL,
          0LL,
          3u,
          v29);
...
LABEL_18:
    if ( (unsigned int)dword_140C03950 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03950,
        (unsigned __int8 *)&word_1400318BE,
        0LL,
        0LL,
        4u,
        v34);
    ...
    switch ( v5 )
    {
      ...
      default:
        if ( (unsigned int)dword_140C03950 > 2 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03950,
            (unsigned __int8 *)byte_140031801,
            0LL,
            0LL,
            4u,
            v29);
