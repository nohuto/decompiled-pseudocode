/*
 * XREFs of HalpInterruptRemap @ 0x140378050
 * Callers:
 ...
 *     HaliAddInterruptRemapping @ 0x140762230 (HaliAddInterruptRemapping.c)
 * Callees:
 *     HalpPopulateMsiMessages @ 0x140377E14 (HalpPopulateMsiMessages.c)
