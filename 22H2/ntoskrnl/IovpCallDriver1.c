/*
 * XREFs of IovpCallDriver1 @ 0x1409CFC5C
 * Callers:
 ...
 *     VfPendingStartLogging @ 0x1409D5AE0 (VfPendingStartLogging.c)
 ...
 *     IovpSessionDataReference @ 0x1409E19A8 (IovpSessionDataReference.c)
