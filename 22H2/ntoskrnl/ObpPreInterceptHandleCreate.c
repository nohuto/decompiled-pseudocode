/*
 * XREFs of ObpPreInterceptHandleCreate @ 0x1406FA348
 * Callers:
...
__int64 __fastcall ObpPreInterceptHandleCreate(__int64 a1, char a2, int *a3, __int64 a4)
{
  int v7; // r8d
  __int64 v8; // rcx
  int v9; // esi
  ...
  v13 = 0LL;
  v16 = v8;
  result = ObpCallPreOperationCallbacks(v8, v14, a4);
  if ( (int)result >= 0 && !a2 )
    *a3 &= v10 | v12[0];
  return result;
}
