/*
 * XREFs of MmOutSwapVirtualAddresses @ 0x140652CBC
 * Callers:
 ...
 *     MiValidateMemoryRangeEntries @ 0x1407A4BCC (MiValidateMemoryRangeEntries.c)
 *     MiFreeReservationRuns @ 0x1407B76A8 (MiFreeReservationRuns.c)
 *     EtwTraceWorkingSetSwap @ 0x1407B7758 (EtwTraceWorkingSetSwap.c)
 *     MiExtendWorkingSetSwapPagefile @ 0x140A43204 (MiExtendWorkingSetSwapPagefile.c)
...
__int64 __fastcall MmOutSwapVirtualAddresses(PEPROCESS Process, unsigned __int64 *a2, __int64 a3, _QWORD *a4)
{
  ...
  v58 = a4;
  v55 = a3;
  v9 = *(_QWORD *)(qword_140C674C8 + 8 * v8);
  v53 = v9;
  ...
  if ( v14->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v12, (__int64)v14)) != 0 )
  {
    ...
    if ( v13 - qword_140C65AE8 >= 0x8000000000LL )
      SessionId = -1;
    else
