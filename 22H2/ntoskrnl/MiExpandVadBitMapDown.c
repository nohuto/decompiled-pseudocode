/*
 * XREFs of MiExpandVadBitMapDown @ 0x140A3C3F0
 * Callers:
...
__int64 __fastcall MiExpandVadBitMapDown(_QWORD *a1, unsigned __int64 a2)
{
  ...
  if ( a2 > (unsigned __int64)(-524288 * qword_140C67168 + (v3 << 19)) >> 16 )
    return 0LL;
  v5 = (a2 >> 6) + ((a2 & 0x3F) != 0);
  ...
  *a1 += v6 << 15;
  ...
  a1[4] = v8;
  a1[3] = 0LL;
  MiUpdateVadBits((a1[1] - qword_140C67168) << 19, ((a1[1] - qword_140C67168) << 19) + (v6 << 31));
  return 1LL;
}
