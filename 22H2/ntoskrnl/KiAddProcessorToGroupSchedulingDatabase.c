/*
 * XREFs of KiAddProcessorToGroupSchedulingDatabase @ 0x1409AFDD4
 * Callers:
 ...
 *     KiAddProcessorToGroupSchedulingList @ 0x14052370C (KiAddProcessorToGroupSchedulingList.c)
 *     KiInitializeProcessorGroupSchedulingData @ 0x1405237A8 (KiInitializeProcessorGroupSchedulingData.c)
 */
