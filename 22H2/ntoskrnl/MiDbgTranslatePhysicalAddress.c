/*
 * XREFs of MiDbgTranslatePhysicalAddress @ 0x140546130
 * Callers:
...
unsigned __int64 __fastcall MiDbgTranslatePhysicalAddress(unsigned __int64 a1, char a2, __int64 a3)
{
  ...
  *(_BYTE *)(a3 + 4) = CurrentIrql;
  ...
  v18 = (_QWORD *)*((_QWORD *)&xmmword_140C4EC48 + 1);
  v19 = 3;
  while ( v18 )
  {
    v20 = v18[5];
...
LABEL_67:
  ...
  ValidPte = MiMakeValidPte(qword_140C4E888, v11, v28, v17);
  if ( (a2 & 0x41) != 0 )
    byte_140C4E880 = 1;
