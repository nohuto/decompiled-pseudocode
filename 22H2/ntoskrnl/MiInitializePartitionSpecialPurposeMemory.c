/*
 * XREFs of MiInitializePartitionSpecialPurposeMemory @ 0x140A473DC
 * Callers:
 *     MiInitializePartitionSpecialPurposeMemoryCallout @ 0x140660760 (MiInitializePartitionSpecialPurposeMemoryCallout.c)
...
LABEL_25:
  ...
  if ( Pool )
  {
    ...
    *((_QWORD *)Pool + 2) = _InterlockedIncrement64(&qword_140C66DF0);
    v16 = Handle;
    *(_OWORD *)(Pool + 24) = *a2;
    v17 = a2[1];
    *((_QWORD *)Pool + 7) = v16;
