/*
 * XREFs of MiCreateSectionCommon @ 0x140722780
 * Callers:
 *     NtCreateSection @ 0x140722710 (NtCreateSection.c)
 *     NtCreateSectionEx @ 0x140A2F840 (NtCreateSectionEx.c)
 * Callees:
...
LABEL_24:
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( PreviousMode == 1 )
    {
      v32 = BYTE1(Process[2].Header.WaitListHead.Flink);
    ...
    else
    {
      ...
      result = ObInsertObjectEx(v20, 0LL, 0, 0LL, (__int64)&v26);
      if ( (int)result >= 0 )
        *v30 = v26;
    }
  }
