/*
 * XREFs of HalpBlkApicInitializeLocalUnit @ 0x140B16FB0
 * Callers:
 *     HalpBlkProcessorStartup @ 0x140B15010 (HalpBlkProcessorStartup.c)
 * Callees:
 *     HalpBlkApicRead @ 0x140B17104 (HalpBlkApicRead.c)
