/*
 * XREFs of MiMakeDriverPagesPrivate @ 0x140291930
 * Callers:
 ...
 *     MiSplitDriverPage @ 0x140A2B71C (MiSplitDriverPage.c)
 * Callees:
...
__int64 __fastcall MiMakeDriverPagesPrivate(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, char a4)
{
  ...
  {
    v57 = 0LL;
    SessionVm = (unsigned __int16 *)&unk_140C69C40;
  }
  v53 = (__int64)SessionVm;
  v10 = 0LL;
  v64 = *(_QWORD *)(qword_140C674C8 + 8LL * SessionVm[87]);
  ...
  if ( v17->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v10, v17)) != 0 )
  {
    ...
    if ( v11 - qword_140C65AE8 < 0x8000000000LL )
...
LABEL_92:
  ...
  if ( dword_140C6997C && v57 && ((*(_DWORD *)(v28 + 16) >> 5) & 2) != 0 )
  {
