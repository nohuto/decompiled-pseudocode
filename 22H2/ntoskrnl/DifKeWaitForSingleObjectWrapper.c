/*
 * XREFs of DifKeWaitForSingleObjectWrapper @ 0x1405E64E0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifKeWaitForSingleObjectWrapper(
        PVOID Object,
        ...
        PLARGE_INTEGER Timeout)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(320);
...
LABEL_17:
  result = KeWaitForSingleObject(Object, WaitReason, WaitMode, Alertable, Timeout);
  LODWORD(v23) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
