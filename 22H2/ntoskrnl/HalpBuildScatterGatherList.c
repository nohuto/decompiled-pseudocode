/*
 * XREFs of HalpBuildScatterGatherList @ 0x14039ED34
 * Callers:
 *     HalGetScatterGatherList @ 0x14030D990 (HalGetScatterGatherList.c)
 *     HalBuildScatterGatherListV3 @ 0x14039ECB0 (HalBuildScatterGatherListV3.c)
 *     HalBuildScatterGatherListEx @ 0x1404C5D40 (HalBuildScatterGatherListEx.c)
 *     HalGetScatterGatherListEx @ 0x1404C61F0 (HalGetScatterGatherListEx.c)
 * Callees:
