/*
 * XREFs of RtlpHpSegContextInitialize @ 0x14037AC44
 * Callers:
        ...
        ...)
{
  ...
  *((_DWORD *)a1 + 4) = (((((_DWORD)v12 - 1) & (unsigned int)(v12 + 0x1FFF)) - (unsigned int)v12 + v15 - 8190) >> 1)
                      - ((v12 - 1) & (((((_DWORD)v12 - 1) & (unsigned int)(v12 + 0x1FFF))
                                     - (unsigned int)v12
                                     + v15
                                     - 8190) >> 1));
  *((_BYTE *)a1 + 13) = a8;
