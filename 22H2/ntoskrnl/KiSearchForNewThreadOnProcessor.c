/*
 * XREFs of KiSearchForNewThreadOnProcessor @ 0x1402C7A00
 * Callers:
 ...
 *     KiMayStealStandbyThread @ 0x1402C7F50 (KiMayStealStandbyThread.c)
...
__int64 __fastcall KiSearchForNewThreadOnProcessor(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  _QWORD *v74; // [rsp+30h] [rbp-48h] BYREF
...
LABEL_42:
  if ( v7 )
  {
    if ( (*(_BYTE *)(ReadyThread + 2) & 4) == 0
      || (IsThreadRankNonZero = KiIsThreadRankNonZero(ReadyThread, (struct _KPRCB *)a1), v29 = 1, !IsThreadRankNonZero) )
    {
