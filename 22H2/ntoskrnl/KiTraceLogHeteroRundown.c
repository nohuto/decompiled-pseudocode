/*
 * XREFs of KiTraceLogHeteroRundown @ 0x1403AFF7C
 * Callers:
...
NTSTATUS __fastcall KiTraceLogHeteroRundown(_DWORD *a1, __int64 a2)
{
  ...
  if ( KeHeteroSystem )
  {
    if ( *a1 > 5u )
    {
      ...
      v52 = 4LL;
      v51 = &v28;
      tlgWriteTransfer_EtwWriteTransfer((__int64)a1, (unsigned __int8 *)&byte_14002D6F7, 0LL, 0LL, 7u, &v40);
    }
    *(_OWORD *)v31 = 0LL;
    v4 = 0;
          ...
          do
          {
            ...
            if ( *a1 > 5u )
            {
              ...
              result = tlgWriteTransfer_EtwWriteTransfer(
                         (__int64)a1,
                         (unsigned __int8 *)byte_14002D620,
                         0LL,
                         0LL,
                         0xBu,
                         v53);
      ...
      else
      {
        ...
        do
        {
          ...
          if ( *a1 > 5u )
          {
            ...
            result = tlgWriteTransfer_EtwWriteTransfer(
                       (__int64)a1,
                       (unsigned __int8 *)&word_14002D78E,
                       0LL,
                       0LL,
                       7u,
                       v53);
