/*
 * XREFs of EtwpCovSampContextGetModule @ 0x1409F133C
 * Callers:
 ...
 *     EtwCovSampHash @ 0x140469648 (EtwCovSampHash.c)
 *     ProcessForExeModule @ 0x14046A11A (ProcessForExeModule.c)
 *     EtwpCheckDebugInfoEqual @ 0x140602DD8 (EtwpCheckDebugInfoEqual.c)
 *     EtwpFindDebugId @ 0x14077E3DC (EtwpFindDebugId.c)
 *     EtwpCovSampCheckForSegments @ 0x1408A8E8C (EtwpCovSampCheckForSegments.c)
 *     EtwpCovSampContextFastFindModule @ 0x1408A92D8 (EtwpCovSampContextFastFindModule.c)
