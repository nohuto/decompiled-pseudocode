/*
 * XREFs of EtwpCovSampContextGetModule @ 0x140943470
 * Callers:
 ...
 *     EtwCovSampHash @ 0x1405AE254 (EtwCovSampHash.c)
 *     EtwpCheckDebugInfoEqual @ 0x1405AE310 (EtwpCheckDebugInfoEqual.c)
 ...
 *     EtwpCovSampContextFastFindModule @ 0x140943324 (EtwpCovSampContextFastFindModule.c)
...
__int64 __fastcall EtwpCovSampContextGetModule(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 *a6)
{
  ...
  *a6 = 0LL;
  ...
  LODWORD(v89) = *(_DWORD *)(v12 + 88);
  DWORD1(v89) = *(_DWORD *)(v12 + 8);
...
LABEL_17:
  ...
  *((_DWORD *)v10 + 30) ^= (*((_DWORD *)v10 + 30) ^ (*(_DWORD *)(a5 + 8) << 9)) & 0x20000;
  ...
  v76 = (__m128i *)v91;
  v95 = 1;
  if ( (int)EtwpFindDebugId(*(_QWORD *)(a5 + 16), v20, 1, (void **)v10 + 6, (_DWORD *)v10 + 14) >= 0 )
  {
    v21 = *((_QWORD *)v10 + 6);
