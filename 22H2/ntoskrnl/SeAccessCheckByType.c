/*
 * XREFs of SeAccessCheckByType @ 0x140346F70
 * Callers:
 *     NtAccessCheckByType @ 0x140310A70 (NtAccessCheckByType.c)
 *     NtAccessCheck @ 0x1403477F0 (NtAccessCheck.c)
 *     NtAccessCheckByTypeResultList @ 0x140595C60 (NtAccessCheckByTypeResultList.c)
 * Callees:
