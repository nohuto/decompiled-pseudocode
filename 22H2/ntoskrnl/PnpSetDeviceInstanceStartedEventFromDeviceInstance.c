/*
 * XREFs of PnpSetDeviceInstanceStartedEventFromDeviceInstance @ 0x14036F458
 * Callers:
 *     PnpSetDeviceInstanceStartedEvent @ 0x14036F524 (PnpSetDeviceInstanceStartedEvent.c)
 * Callees:
