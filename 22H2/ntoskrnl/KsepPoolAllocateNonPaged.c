/*
 * XREFs of KsepPoolAllocateNonPaged @ 0x1405270C4
 * Callers:
 *     KseSetCompletionHook @ 0x140526CD0 (KseSetCompletionHook.c)
...
PVOID __fastcall KsepPoolAllocateNonPaged(size_t Size)
{
  ...
  if ( PoolWithTag )
  {
    _InterlockedIncrement(&dword_140C2AA88);
    memset(PoolWithTag, 0, Size);
  }
  else
  {
    _InterlockedIncrement(&dword_140C2AA94);
  }
  return v3;
}
