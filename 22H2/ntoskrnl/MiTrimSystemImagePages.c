/*
 * XREFs of MiTrimSystemImagePages @ 0x1403174C0
 * Callers:
...
LABEL_35:
    ...
    v7 = 48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v27) >> 12) & 0xFFFFFFFFFLL)
       - 0x58000000000LL;
    ...
    else
    {
      ...
      v12 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v27);
