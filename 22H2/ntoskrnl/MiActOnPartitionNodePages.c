/*
 * XREFs of MiActOnPartitionNodePages @ 0x1405607E0
 * Callers:
 ...
 *     MiHotAddHugeRange @ 0x1408C6A08 (MiHotAddHugeRange.c)
 *     MiFreePartitionPageRun @ 0x1408DB084 (MiFreePartitionPageRun.c)
 *     MiHotRemovePartitionPageRun @ 0x1408DB59C (MiHotRemovePartitionPageRun.c)
 */
...
LABEL_44:
    ...
    if ( (char *)v10 != v18 && (*(_DWORD *)v10 | *((_DWORD *)qword_1400127A0 + (v11 & 0x1F))) == -1 )
    {
    ...
    while ( v17 < v15 && _bittest64(v8, v17) )
      ++v17;
    SchedulerAssist = 0LL;
    if ( (char *)v10 != v18 && (*(_DWORD *)v10 & ~*((_DWORD *)qword_1400127A0 + (v17 & 0x1F))) == 0 )
    {
