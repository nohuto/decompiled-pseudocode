/*
 * XREFs of KiCompleteKernelInit @ 0x14099D610
 * Callers:
...
__int64 __fastcall KiCompleteKernelInit(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    qword_140C31F98 = 0LL;
    qword_140C31F90 = (__int64)&qword_140C31F88;
    qword_140C31F88 = (__int64)&qword_140C31F88;
    KeInitializeTimer2((__int64)&KiForegroundState, (__int64)KiForegroundTimerCallback, 0LL, 8LL);
    KeInitializeDpc((PRKDPC)&stru_140C31F08, (PKDEFERRED_ROUTINE)KiProcessPendingForegroundBoosts, 0LL);
    KeInitializeDpc(&stru_140C31F48, (PKDEFERRED_ROUTINE)KiTriggerForegroundBoostDpc, 0LL);
    ...
    qword_140C32018 = (__int64)&KiUpdateVpThreadPriorityListHead;
