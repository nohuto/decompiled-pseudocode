/*
 * XREFs of MiAllocateContiguousMemory @ 0x1402E808C
 * Callers:
 *     MmAllocateContiguousNodeMemory @ 0x1402E7FF0 (MmAllocateContiguousNodeMemory.c)
 *     MmAllocateContiguousMemory @ 0x140531620 (MmAllocateContiguousMemory.c)
 * Callees:
...
LABEL_20:
      v49 = 135266304;
      v25 = (unsigned int *)(qword_140C4DE98 + 4LL * v22 * (unsigned __int16)KeNumberNodes);
