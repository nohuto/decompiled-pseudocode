/*
 * XREFs of MiAllocateContiguousMemory @ 0x1403B9674
 * Callers:
 ...
 *     MmAllocateContiguousMemory @ 0x14061E160 (MmAllocateContiguousMemory.c)
 * Callees:
...
LABEL_9:
  v25 = (_DWORD *)(qword_140C65B98 + 4LL * v24 * (unsigned __int16)KeNumberNodes);
...
LABEL_22:
  ...
  v30 = v20;
  v31 = v19;
  v32 = (_DWORD *)(qword_140C65B98 + 4LL * v24 * (unsigned __int16)KeNumberNodes);
...
LABEL_38:
  if ( !v39 && v56 == (unsigned __int16 *)&MiSystemPartition )
    _InterlockedExchangeAdd64(&qword_140C69AB8, v16);
  v40 = a1;
  *a1 = v28;
  v11 = a3;
LABEL_42:
