/*
 * XREFs of MiPurgingPageFromLookaside @ 0x140331310
 * Callers:
 ...
 *     MiGetStandbyLookaside @ 0x14026EA50 (MiGetStandbyLookaside.c)
...
__int64 __fastcall MiPurgingPageFromLookaside(int a1, __int64 a2)
{
  ...
  if ( (v5 & 0x400) == 0 )
    v6 = -134217729LL;
  v7 = v5 & v6;
  v8 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v4 + 40) >> 43) & 0x3FFLL));
...
LABEL_8:
  ...
  else
  {
    ...
    while ( 1 )
    {
      result = MiGetStandbyLookaside(&v19, v16);
      if ( v17 != a1 )
        break;
LABEL_15:
      v16 = v17 + 1;
