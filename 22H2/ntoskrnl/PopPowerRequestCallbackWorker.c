/*
 * XREFs of PopPowerRequestCallbackWorker @ 0x14034B5B0
 * Callers:
...
__int64 PopPowerRequestCallbackWorker()
{
  ...
  while ( 1 )
  {
    ...
    {
      v0 = *(_QWORD **)(qword_140C250D8 + 8);
      if ( *(__int64 **)qword_140C250D8 != &PopPowerRequestCallbacks || *v0 != qword_140C250D8 )
        __fastfail(3u);
      v1 = qword_140C250D8 - 56;
      qword_140C250D8 = *(_QWORD *)(qword_140C250D8 + 8);
      v2 = 0;
