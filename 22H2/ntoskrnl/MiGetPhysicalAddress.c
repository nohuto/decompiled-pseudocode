/*
 * XREFs of MiGetPhysicalAddress @ 0x14028BE00
 * Callers:
...
__int64 __fastcall MiGetPhysicalAddress(unsigned __int64 a1, _QWORD *a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  memset(v27, 0, 32);
  MiFillPteHierarchy(a1, (unsigned __int64 *)v27);
  ...
  else
  {
    ...
    while ( v11 != 1 );
    v28 = MI_READ_PTE_LOCK_FREE(*(unsigned __int64 *)&v27[0]);
    v14 = v28;
    ...
    if ( SystemRegionType == 5 )
    {
      ...
      v25 = MI_READ_PTE_LOCK_FREE(*(unsigned __int64 *)&v27[0]);
      LOWORD(v14) = v25;
      v28 = v25;
    }
    v17 = ((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v28) >> 12) & 0xFFFFFFFFFFLL;
    v18 = (v14 & 0x800) == 0;
  }
  if ( !v18 )
    *a3 = 1;
