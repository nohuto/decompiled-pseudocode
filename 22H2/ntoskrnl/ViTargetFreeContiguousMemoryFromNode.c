/*
 * XREFs of ViTargetFreeContiguousMemoryFromNode @ 0x140ACCB68
 * Callers:
 *     ViTargetFreeContiguousMemory @ 0x140ACCAC0 (ViTargetFreeContiguousMemory.c)
 *     ViTargetFreeContiguousMemoryCallback @ 0x140ACCB40 (ViTargetFreeContiguousMemoryCallback.c)
 * Callees:
 *     VfUtilFreePoolDispatchLevel @ 0x1405CE3B0 (VfUtilFreePoolDispatchLevel.c)
 */
