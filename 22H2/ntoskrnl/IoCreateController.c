/*
 * XREFs of IoCreateController @ 0x140893950
 * Callers:
 *     <none>
 * Callees:
...
PCONTROLLER_OBJECT __stdcall IoCreateController(ULONG Size)
{
  ...
  v5[2] = 0LL;
  v8 = 0LL;
  if ( (int)ObCreateObjectEx(0, (_DWORD *)IoControllerObjectType, (int)v5, 0, v4, Size + 72, 0, 0, &DmaAdapter, 0LL) >= 0
    && (int)ObInsertObjectEx(DmaAdapter, 0LL, 3u, 1, 0, (__int64)&DmaAdapter, (unsigned __int64 *)&Handle) >= 0 )
  {
