/*
 * XREFs of RtlpNewSecurityObject @ 0x14064CD10
 * Callers:
        ...
        __int64 a10)
{
  ...
  char v205; // [rsp+90h] [rbp-80h]
  KPROCESSOR_MODE AccessMode; // [rsp+91h] [rbp-7Fh]
  bool v207; // [rsp+92h] [rbp-7Eh]
  unsigned __int16 *v208; // [rsp+98h] [rbp-78h]
  char v209; // [rsp+A0h] [rbp-70h] BYREF
  void *Src; // [rsp+A8h] [rbp-68h]
  char v211; // [rsp+B0h] [rbp-60h]
  _DWORD v212[3]; // [rsp+B4h] [rbp-5Ch] BYREF
  __int16 v213; // [rsp+C0h] [rbp-50h] BYREF
  char v214; // [rsp+C2h] [rbp-4Eh] BYREF
  bool v215; // [rsp+C3h] [rbp-4Dh]
  ...
  _DWORD v223[3]; // [rsp+CCh] [rbp-44h] BYREF
  _WORD v224[2]; // [rsp+D8h] [rbp-38h] BYREF
  unsigned int v225; // [rsp+DCh] [rbp-34h] BYREF
  __int64 v226; // [rsp+E0h] [rbp-30h] BYREF
  _OWORD *v227; // [rsp+E8h] [rbp-28h]
  void *v228; // [rsp+F0h] [rbp-20h]
  int v229; // [rsp+F8h] [rbp-18h] BYREF
  void *v230; // [rsp+100h] [rbp-10h]
  PGENERIC_MAPPING v231; // [rsp+108h] [rbp-8h]
  ...
  void *v255; // [rsp+1B0h] [rbp+A0h] BYREF
  unsigned __int8 *v256; // [rsp+1B8h] [rbp+A8h]
  _QWORD *v257; // [rsp+1C0h] [rbp+B0h]
  _OWORD v258[2]; // [rsp+1C8h] [rbp+B8h] BYREF
  __int64 v259; // [rsp+1E8h] [rbp+D8h]
  int v260; // [rsp+1F0h] [rbp+E0h]
  unsigned __int16 v261; // [rsp+1F4h] [rbp+E4h]
  struct _PRIVILEGE_SET RequiredPrivileges; // [rsp+1F8h] [rbp+E8h] BYREF
  int v263[2]; // [rsp+210h] [rbp+100h] BYREF
  _BYTE v264[120]; // [rsp+218h] [rbp+108h] BYREF
...
LABEL_279:
  if ( ServerAcl >= 0 )
  {
    ...
    if ( (v223[0] & 0x1000) != 0 )
      ...
      v184 = 0;
    v11 = v227;
    v212[0] = v183 | v184 | (2 * (v223[0] & 0x400));
    goto LABEL_60;
  }
...
LABEL_68:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)&v223[1] = v176;
    ...
    if ( ServerAcl >= 0 )
      break;
    ExFreePoolWithTag(*(PVOID *)&v223[1], 0);
    *(_QWORD *)&v223[1] = 0LL;
...
LABEL_72:
  ...
  while ( 2 )
  {
    ...
    AceByType = RtlFindAceByType(v72, 20, &v225);
    v75 = AceByType;
    if ( AceByType
      && AceByType != (unsigned __int8 *)-8LL
      && !RtlpValidTrustSubjectContext(v70, (__int64)(AceByType + 8), v74, &v242) )
    {
LABEL_423:
...
LABEL_78:
  ...
  do
  {
    ...
    v196 = RtlFindAceByType(v194, 20, &v225);
    ++v225;
    if ( !v196 )
    {
      if ( v70 )
  ...
  v198 = *((_DWORD *)v196 + 1);
  v199 = v196[1];
  if ( !v254 || (v198 & *(_DWORD *)(v254 + 4)) != v198 || v196 == (unsigned __int8 *)-8LL )
  {
LABEL_438:
    v139 = (unsigned __int16 *)Src;
    ServerAcl = -1073741811;
...
LABEL_443:
  ...
  if ( ServerAcl < 0
    || (LOBYTE(PreviouslyGrantedAccess) = 20,
        ServerAcl = RtlAddProcessTrustLabelAce(&Acl, 2LL, v199, v197, PreviouslyGrantedAccess, v198, GenericMapping),
        ServerAcl < 0)
    || (v78 = v227,
        v79 = v230,
        ServerAcl = RtlpComputeMergedAcl(
                      v223[1],
                      (*((_WORD *)v227 + 1) & 0x800 | (*((unsigned __int16 *)v227 + 1) >> 1) & 0x18u) >> 1,
                      (int)&Acl,
                      4,
                      (__int64)v228,
                      (__int64)v230,
...
LABEL_79:
  ...
  while ( 2 )
  {
    v82 = RtlFindAceByType(v81, 21, &v235);
    v84 = v82;
    if ( !v82 )
      goto LABEL_83;
    ...
    if ( (v82[1] & 0x40) != 0 )
    {
      if ( !RtlpValidTrustSubjectContext(v70, (__int64)(v82 + 8), v83, &v241) )
        goto LABEL_423;
      goto LABEL_83;
    }
    v200 = *(_DWORD *)(v82 + 10) - v260;
    if ( !v200 )
      v200 = *((unsigned __int16 *)v82 + 7) - v261;
    if ( v200 )
      goto LABEL_438;
...
LABEL_113:
            ...
            if ( (a7 & 8) == 0 )
            {
              ...
              if ( v110 )
              {
                ...
                ServerAcl = RtlSidDominates((char *)Sid, v110, (bool *)&v209);
                if ( ServerAcl < 0 )
                  goto LABEL_483;
                v108 = a7;
                v102 = 0LL;
...
LABEL_148:
                ...
                if ( (v108 & 0x1000) == 0 && v216 && SubjectSecurityContext && v237 )
                {
                  GrantedAccess = 0;
                  AccessStatus = 0;
                ...
                if ( v124 == 1 )
                {
                  ...
                  if ( (_BYTE)v213 && !v229 && v126 )
                  {
                    ...
                    SePrivilegedServiceAuditAlarm(0, (__int64 *)v123, (__int64)&RequiredPrivileges, v201);
                    if ( !v201 )
                    {
                  ...
                  if ( v217 && !v127 )
                  {
                    ...
                    SePrivilegedServiceAuditAlarm(0, (__int64 *)v123, (__int64)&RequiredPrivileges, v202);
                    if ( !v202 )
                    {
                      ServerAcl = -1073741727;
                      goto LABEL_483;
                  ...
                  if ( HIBYTE(v213)
                    && (v108 & 0x10) == 0
                    && !(unsigned __int8)SepValidOwnerSubjectContext(v123, v228, v207, v102) )
                  {
                    ServerAcl = -1073741734;
                    goto LABEL_483;
                  }
                  if ( v214 && v207 )
                  {
                    ServerAcl = RtlpCreateServerAcl((_DWORD)v125, v218, v232, (unsigned int)&v248, (__int64)&v219);
                    if ( ServerAcl < 0 )
                      goto LABEL_483;
                    if ( v122 && v208 )
                      ExFreePoolWithTag(v208, 0);
                    v125 = (unsigned __int16 *)v248;
                    v208 = (unsigned __int16 *)v248;
                    v248 = 0LL;
                  }
                }
                v128 = 4 * *((unsigned __int8 *)v228 + 1) + 8;
                if ( v230 )
                  v129 = 4 * *((unsigned __int8 *)v230 + 1) + 8;
                else
                  v129 = 0;
                v130 = v121 & 0x10;
                if ( (v121 & 0x10) != 0 && Src )
                ...
                v134 = ExAllocatePoolWithTag(
                         PagedPool,
                         v129 + v133 + v131 + 4 * *((unsigned __int8 *)v228 + 1) + 28,
                         0x64536553u);
                *(_QWORD *)&v212[1] = v134;
                v135 = v134;
                if ( !v134 )
                ...
                *(_BYTE *)v134 = 1;
                ...
                if ( !v138 && Src )
                {
                  ...
                  if ( !v211 )
                    RtlpApplyAclToObject(v137, v231);
                  v135 = *(_DWORD **)&v212[1];
                  *(_DWORD *)(*(_QWORD *)&v212[1] + 12LL) = (_DWORD)v137 - v212[1];
                  v140 = v139[1];
                ...
                if ( !v138 )
                {
                  if ( v208 )
                  {
                    memmove(v137, v208, v208[1]);
                    v142 = v205;
                    if ( !v205 )
                      RtlpApplyAclToObject(v137, v231);
                    *(_DWORD *)(*(_QWORD *)&v212[1] + 16LL) = (_DWORD)v137 - v212[1];
                    v143 = v208[1];
                ...
                v142 = v205;
LABEL_183:
                memmove(v137, v228, v128);
                v12 = *(_QWORD *)&v212[1];
                *(_DWORD *)(*(_QWORD *)&v212[1] + 4LL) = (_DWORD)v137 - v212[1];
                v144 = &v137[v128];
                if ( v230 )
                {
                  memmove(v144, v230, v129);
...
LABEL_499:
  ...
  *(_QWORD *)v263 = 8388610LL;
  ServerAcl = RtlAddMandatoryAce(v263, v90, v89, v239);
  if ( ServerAcl >= 0 )
  {
    v91 = v263;
    goto LABEL_101;
