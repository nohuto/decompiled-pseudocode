/*
 * XREFs of RtlpIsFrameInBoundsEx @ 0x140340838
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  unsigned __int64 v20; // [rsp+20h] [rbp-18h] BYREF
  struct _KPRCB *v21; // [rsp+28h] [rbp-10h] BYREF
  ...
  if ( (a2 & 7) == 0 )
  {
    ...
    {
      KeQueryCurrentStackInformation((char *)&v22, &v21, &v20);
