/*
 * XREFs of IommuRegisterInterfaceStateChangeCallback @ 0x140526460
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      if ( v9 )
      {
        ...
        *(_DWORD *)(v10 + 40) = *a4;
        ...
        a1(v10 + 40, a2);
        v12 = (__int64 *)qword_140C60198;
        if ( *(__int64 **)qword_140C60198 != &IommuInterfaceStateChangeCallbackListHead )
          __fastfail(3u);
