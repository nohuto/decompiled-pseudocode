...
unsigned __int64 __fastcall RtlpHpVaMgrAlloc(ULONG_PTR BugCheckParameter2, unsigned __int64 *a2, unsigned __int64 a3)
{
  ...
  if ( v13 )
  {
    RtlRbRemoveNode((unsigned __int64 *)(BugCheckParameter2 + 8), v13);
    v16 = v47;
    if ( v47 != v15 )
    {
      *(_OWORD *)v15 = 0LL;
    ...
    *(_BYTE *)(v15 + 1) = *(_BYTE *)(BugCheckParameter2 + 44);
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        if ( v22 )
          break;
        v24 = (unsigned __int64)&CurrentThread->LockEntries[v23];
        v21 &= ~(1 << v23);
        if ( (*(_BYTE *)(v24 + 26) & 1) != 0
          && (*(_DWORD *)(v24 + 32) & 1) == 0
          ...
          *(_BYTE *)(v24 + 26) &= ~1u;
          if ( *(_QWORD *)(v24 + 32) )
          {
            if ( v24 )
            {
              ...
              *(_BYTE *)(v24 + 25) &= ~1u;
              *(_QWORD *)(v24 + 32) = 0LL;
              v25 = (__int64)(v24 - (unsigned __int64)CurrentThread->LockEntries) / 96;
              if ( v20 == 1 )
...
LABEL_34:
  ...
  else
  {
    ...
    while ( 1 )
    {
      v40 = (unsigned __int64)&v31->LockEntries[v39];
      v38 &= ~(1 << v39);
      if ( (*(_BYTE *)(v40 + 26) & 1) != 0
        && (*(_DWORD *)(v40 + 32) & 1) == 0
...
LABEL_65:
    ...
    else
    {
      ...
      *(_BYTE *)(v40 + 25) &= ~1u;
      *(_QWORD *)(v40 + 32) = 0LL;
      v41 = 1 << ((__int64)(v40 - (unsigned __int64)v31->LockEntries) / 96);
      if ( v37 == 1 )
