/*
 * XREFs of BcpDisplayProgress @ 0x1405C4E80
 * Callers:
 ...
 *     BcpCursorLessThan @ 0x1405C4798 (BcpCursorLessThan.c)
...
__int64 __fastcall BcpDisplayProgress(unsigned int a1, unsigned int a2, __int64 a3)
{
  ...
  BcpDisplayCriticalString((unsigned __int16 *)v28, dword_140C10F00[2 * v6 + 2], v10, a2);
  v12 = &stru_140C53E40;
  if ( a1 != 1 )
    v12 = &stru_140C53E60;
  BcpDisplayCriticalString(&v12->Length, dword_140C10F00[2 * v6 + 2], v11, a2);
  v13 = BcpCursor;
  v14 = dword_140C4C5E0;
  v26 = BcpCursor;
  v27 = dword_140C4C5E0;
  if ( BcpCursorLessThan(&v26) )
  {
    ...
    if ( BcpTextBoxLeftEdgeOverride )
      ...
      v18 = dword_140C10F00[2 * v6 + 8] + dword_140C10F00[2 * v6 + 4];
    if ( BcpTextBoxRightEdgeOverride )
      v19 = *(_DWORD *)BcpTextBoxRightEdgeOverride;
    else
      v19 = dword_140C10F00[2 * v6 + 8] + dword_140C10F00[2 * v6 + 6] + dword_140C10F00[2 * v6 + 4];
