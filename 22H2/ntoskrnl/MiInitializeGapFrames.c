/*
 * XREFs of MiInitializeGapFrames @ 0x140B455F8
 * Callers:
...
__int64 __fastcall MiInitializeGapFrames(__int64 a1, __int64 *a2)
{
  ...
  v5 = (__int64 *)MiReservePtes((__int64)&qword_140C69A40, 3u);
...
LABEL_17:
      *v7 = v4;
      ...
      if ( v6 >= 4 )
      {
        MiReleasePtes((__int64)&qword_140C69A40, v5, 3u);
        return 1LL;
      }
    }
...
LABEL_9:
      *(_QWORD *)v11 = ValidPte;
      ...
      if ( (MiFlags & 0x2000000) == 0 && ((unsigned __int8)(1 << (v6 - 1)) & (unsigned __int8)byte_140C65B8F) != 0 )
        v18 &= ~0x20uLL;
      v2 = 0;
    ...
    {
      v2 = 1;
      if ( HIBYTE(word_140C66DFC) != (_BYTE)v15 )
        goto LABEL_9;
      v20 = (ValidPte & 1) == 0;
    }
    else
