/*
 * XREFs of PopRequestRead @ 0x140AA3C40
 * Callers:
 *     PopDecompressCallback @ 0x140AA23D0 (PopDecompressCallback.c)
  ...
  while ( *(_QWORD *)(BugCheckParameter3 + 400) )
  {
    ...
    if ( v8 )
    {
      if ( v8 != 1 )
      {
        ...
        v9 = __rdtsc();
        qword_140C3D4C8 += v9 - *(_QWORD *)(BugCheckParameter3 + 336);
        ...
        v10 = __rdtsc();
        qword_140C3D4F8 += (((unsigned __int64)HIDWORD(v10) << 32) | (unsigned int)v10) - v9;
      ...
      v17 = __rdtsc();
      qword_140C3D4F0 += (((unsigned __int64)HIDWORD(v17) << 32) | (unsigned int)v17) - v14;
...
LABEL_34:
      ...
      v29 = __rdtsc();
      qword_140C3D4F0 += (((unsigned __int64)HIDWORD(v29) << 32) | (unsigned int)v29)
