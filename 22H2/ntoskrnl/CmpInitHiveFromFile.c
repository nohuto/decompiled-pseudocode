 ...
 *     CmpIsHiveLoadUnloadRundownActive @ 0x140AF606C (CmpIsHiveLoadUnloadRundownActive.c)
        ...
        void *a10)
{
  ...
  *(_OWORD *)v32 = 0LL;
  if ( (unsigned int)dword_140C04390 > 4 && tlgKeywordOn((__int64)&dword_140C04390, 8LL) )
  {
    ...
    v46[0] = *a1;
    v43 = 2;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04390, (unsigned __int8 *)byte_140037D25, 0LL, 0LL, 4u, v41);
  }
  v14 = a2;
  v24 = (__int64)a10;
  v25[0] = *a4;
...
LABEL_9:
  ...
  if ( (unsigned int)dword_140C04390 > 4 && tlgKeywordOn((__int64)&dword_140C04390, 8LL) )
  {
    ...
    v27 = v16;
    v43 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04390, (unsigned __int8 *)qword_140037D50, 0LL, 0LL, 3u, v41);
  }
  return v16;
}
