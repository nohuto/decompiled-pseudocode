/*
 * XREFs of PopPowerRequestCleanUp @ 0x14034B808
 * Callers:
 *     PoDeletePowerRequest @ 0x1406A6180 (PoDeletePowerRequest.c)
 *     PspExitThread @ 0x1406C35F8 (PspExitThread.c)
 *     PopDeletePowerRequestObject @ 0x1406F56E0 (PopDeletePowerRequestObject.c)
 *     PopClosePowerRequestObject @ 0x1406F73A0 (PopClosePowerRequestObject.c)
 * Callees:
