...
__int64 __fastcall KeLoadMTRR(__int64 a1)
{
  ...
  if ( byte_140C41970 )
  {
    ...
    if ( qword_140C41980 )
    {
      ...
      {
        v2 = 0LL;
        v3 = (PVOID)((_BYTE *)qword_140C41980 - v24);
        v23 = v24;
...
LABEL_6:
    ...
    if ( (_BYTE)qword_140C41968 )
    {
      ...
      do
      {
        v14 = qword_140C41978;
        v15 = 2 * v12;
        __writemsr(v13 - 1, *((_QWORD *)qword_140C41978 + v15));
        v10 = HIDWORD(v14[v15 + 1]);
        __writemsr(v13, v14[v15 + 1]);
        v12 = ++v11;
        v13 += 2;
      }
      while ( v11 < (unsigned __int64)(unsigned __int8)qword_140C41968 );
    }
    if ( qword_140C41980 )
      KiWriteFixedMtrr(qword_140C41980, v10);
