/*
 * XREFs of KeLoadMTRR @ 0x140999750
 * Callers:
 *     HalpPostSleepMP @ 0x140995854 (HalpPostSleepMP.c)
 *     KiLoadMTRRTarget @ 0x1409A16C0 (KiLoadMTRRTarget.c)
 * Callees:
 *     KeFlushCurrentTbImmediately @ 0x1403A0380 (KeFlushCurrentTbImmediately.c)
 *     __security_check_cookie @ 0x1403CFD60 (__security_check_cookie.c)
 *     KiLockStepExecution @ 0x140999934 (KiLockStepExecution.c)
 *     KiWriteFixedMtrr @ 0x14099997C (KiWriteFixedMtrr.c)
 *     KiReadFixedMtrr @ 0x140999A88 (KiReadFixedMtrr.c)
 *     KiCompareVarMtrr @ 0x140999B94 (KiCompareVarMtrr.c)
 */
...
__int64 __fastcall KeLoadMTRR(__int64 a1)
{
  ...
  if ( byte_140C2B3D0 )
  {
    ...
    if ( qword_140C2B3E0 )
    {
      ...
      {
        v2 = 0LL;
        v3 = (PVOID)((_BYTE *)qword_140C2B3E0 - v18);
        v17 = v18;
...
LABEL_6:
    ...
    if ( (_BYTE)qword_140C2B3C8 )
    {
      ...
      do
      {
        v12 = qword_140C2B3D8;
        v13 = 2 * v10;
        __writemsr(v11 - 1, *((_QWORD *)qword_140C2B3D8 + v13));
        v8 = HIDWORD(v12[v13 + 1]);
        __writemsr(v11, v12[v13 + 1]);
        v10 = ++v9;
        v11 += 2;
      }
      while ( v9 < (unsigned __int64)(unsigned __int8)qword_140C2B3C8 );
    }
    if ( qword_140C2B3E0 )
      KiWriteFixedMtrr(qword_140C2B3E0, v8);
