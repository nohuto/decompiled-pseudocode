/*
 * XREFs of PopEtEnergyTrackerQuery @ 0x1407B897C
 * Callers:
 ...
 *     PopEtDataSectionReserve @ 0x1407B96B0 (PopEtDataSectionReserve.c)
 *     PopEtDataSectionStart @ 0x1407B9700 (PopEtDataSectionStart.c)
