/*
 * XREFs of TtmiLogSessionMonitorControl @ 0x1409A9738
 * Callers:
...
void __fastcall TtmiLogSessionMonitorControl(int a1)
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v15 = 4LL;
      v17 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)byte_140033141, 0LL, 0LL, 6u, &v9);
    }
  }
}
