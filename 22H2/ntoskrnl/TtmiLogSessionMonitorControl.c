/*
 * XREFs of TtmiLogSessionMonitorControl @ 0x140903CB8
 * Callers:
...
void __fastcall TtmiLogSessionMonitorControl(int a1)
{
  ...
  if ( (unsigned int)dword_140D2D8C8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8C8, 1LL) )
    {
      ...
      v15 = 4LL;
      v17 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8C8, (unsigned __int8 *)word_14002B2A2, 0LL, 0LL, 6u, &v9);
    }
  }
}
