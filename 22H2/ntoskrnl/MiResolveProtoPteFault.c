/*
 * XREFs of MiResolveProtoPteFault @ 0x140267DB0
 * Callers:
...
__int64 __fastcall MiResolveProtoPteFault(struct _LIST_ENTRY *a1, __int64 a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  else
  {
    ...
    {
      v21 = *(void **)(qword_140C674C8 + 8 * (((unsigned __int64)v14 >> 43) & 0x3FF));
      goto LABEL_22;
    }
  }
  v18 = 1;
...
LABEL_37:
  ...
  CurrentPrcb = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v30 + 40) >> 43) & 0x3FFLL));
...
LABEL_43:
  ...
  if ( (v32 & 1) == 0 )
  {
    ...
    if ( (v57 & 0x400) == 0 )
      goto LABEL_92;
    v58 = v57;
    if ( qword_140C65C40 && (v57 & 0x10) == 0 )
      v58 = v57 & ~qword_140C65C40;
    v55 = 0xFFFFFFFFLL;
        ...
        if ( *((char *)MiReadWrite + ((unsigned __int8)v32 >> 5)) - v60 >= 10 )
        {
          if ( (_DWORD)v16 == 2 && (!v104 || *(_BYTE *)(v102 & 0xFFFFFFFFFFFFFFFEuLL) != 1) )
          {
            ...
            if ( (v31 & 0xC00) == 0x800 )
            {
              ...
              {
                if ( HIBYTE(word_140C66DFC) || (v31 & 1) == 0 )
                  goto LABEL_308;
                goto LABEL_307;
              }
              if ( (HIDWORD(KeGetCurrentThread()->ApcState.Process[2].Header.WaitListHead.Flink) & 0x1000) == 0
...
LABEL_65:
            ...
            else
            {
              ...
              v50 = *(_QWORD *)(qword_140C674C8 + 8 * v49);
              ...
              {
                MiReturnCommit(*(_QWORD *)(qword_140C674C8 + 8 * v49), 1LL);
                v46 = 1LL;
              }
