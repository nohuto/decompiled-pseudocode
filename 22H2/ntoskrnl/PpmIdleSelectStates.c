/*
 * XREFs of PpmIdleSelectStates @ 0x140394E80
 * Callers:
 ...
 *     PpmCheckPreConditionsForDeepSleep @ 0x1403909EC (PpmCheckPreConditionsForDeepSleep.c)
 ...
 *     PpmIdleUpdateSelectionStatistics @ 0x140567008 (PpmIdleUpdateSelectionStatistics.c)
...
LABEL_9:
  ...
  *(_DWORD *)(v11 + 528) = v22;
  ...
  {
    v23 = BYTE6(PpmCurrentProfile[342 * dword_140C2334C + 24]);
    *(_BYTE *)(v11 + 542) = v23;
    if ( v23 )
