/*
 * XREFs of MiCopyVirtualMemory @ 0x1406F79C0
 * Callers:
...
LABEL_7:
    ...
    while ( 1 )
    {
      ...
      if ( (v10 & 0xFFFFFFFFFFFFF000uLL) != 0x7FFE0000 && (v40 != qword_140C65B38 || !qword_140C65B38)
...
LABEL_45:
          ...
          if ( ((unsigned __int64)v63 & 0xFFFFFFFFFFFFF000uLL) != 0x7FFE0000
            && (v29 != qword_140C65B38 || !qword_140C65B38)
            || (*(_DWORD *)(v50 + 2172) & 1) != 0 )
          {
