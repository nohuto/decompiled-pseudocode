/*
 * XREFs of PiDqIrpQueryCreate @ 0x1406A7E9C
 * Callers:
 ...
 *     PiDqConvertObjectTypeToString @ 0x1408A4690 (PiDqConvertObjectTypeToString.c)
 *     PiDqConvertQueryFlagsToString @ 0x1408A4758 (PiDqConvertQueryFlagsToString.c)
 *     FilterConvertToString @ 0x14097FC60 (FilterConvertToString.c)
  ...
  else
  {
    if ( CurrentStackLocation->Parameters.Read.Length >= 0x10 )
    {
      ...
      if ( ValidateQueryData < 0 )
        goto LABEL_14;
      v10 = (void **)(v3 + 24);
      NdrMesTypeDecode3(*(_QWORD *)(v3 + 16), "TP 3\a", &off_140003F60, &off_140C01A50, 0, v3 + 24);
