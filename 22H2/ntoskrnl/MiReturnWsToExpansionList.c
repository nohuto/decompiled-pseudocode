/*
 * XREFs of MiReturnWsToExpansionList @ 0x14022247C
 * Callers:
...
_QWORD *__fastcall MiReturnWsToExpansionList(__int64 a1, int a2)
{
  ...
  v2 = (_QWORD *)(a1 + 24);
  v3 = (_QWORD *)(*(_QWORD *)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(a1 + 174)) + 16928LL);
  if ( a2 )
  {
    result = (_QWORD *)*v3;
    if ( *(_QWORD **)(*v3 + 8LL) == v3 )
...
LABEL_8:
  ...
  result = *(_QWORD **)(*(_QWORD *)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(a1 + 174)) + 16936LL);
  if ( (_QWORD *)*result != v3 )
    goto LABEL_8;
  *v2 = v3;
  *(_QWORD *)(a1 + 32) = result;
