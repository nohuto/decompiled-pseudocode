/*
 * XREFs of MiMapViewOfImageSection @ 0x14061D2D0
 * Callers:
        ...
        char a8)
{
  ...
  _QWORD v107[11]; // [rsp+E0h] [rbp-20h] BYREF
  ...
  v102 = v13;
  if ( dword_140C4CC90
    && dword_140C4CC94 == *(_DWORD *)(v13 + 60)
    && dword_140C4CC98 == *(_DWORD *)(*(_QWORD *)(v10 + 56) + 68LL) )
  {
    __debugbreak();
  }
...
LABEL_96:
                ...
                if ( (v54 & 0x10) == 0 || (PerSessionProtos = MiCommitVadCfgBits(v23, 0LL, 0LL), PerSessionProtos >= 0) )
                {
                  if ( *(_QWORD *)(a2 + 80) )
                  {
                    ...
                    if ( PerSessionProtos < 0 )
                      goto LABEL_241;
                    **(_QWORD **)(a2 + 80) = v101 ^ qword_140C4DE50 ^ v11;
                    v59 = 0LL;
                  }
                  else
                  {
                    ...
                    || (v59 = MiAddSecureEntry(v23, (_DWORD)v97 << 12, ((_DWORD)v41 << 12) | 0xFFFu, -2147483647, 0)) != 0 )
                  {
                    ...
                    if ( v59 )
                      MmUnsecureVirtualMemory((HANDLE)(v59 ^ qword_140C4DE50 ^ v11));
                    goto LABEL_96;
                  }
                  PerSessionProtos = -1073741670;
                }
