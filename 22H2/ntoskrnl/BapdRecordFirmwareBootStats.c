/*
 * XREFs of BapdRecordFirmwareBootStats @ 0x140A88E78
 * Callers:
...
void BapdRecordFirmwareBootStats()
{
  ...
  Tag[0] = 0;
  Data = 0LL;
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((char *)&dword_140C06758, 0LL, 0LL);
  if ( !ExIsSoftBoot() )
  {
