/*
 * XREFs of VfInitVerifierComponents @ 0x1409C6E80
 * Callers:
 ...
 *     VfAvlInitializeTree @ 0x1405A252C (VfAvlInitializeTree.c)
 ...
 *     VfMajorRegisterHandlers @ 0x1409D7B6C (VfMajorRegisterHandlers.c)
