/*
 * XREFs of ExpLoadAndSortLicensingCacheDescriptors @ 0x140811DEC
 * Callers:
...
LABEL_18:
          ...
          {
            LOBYTE(v6) = 1;
            v8 = sub_1408120C4(v7, v6, a1 + 24, 2925LL, a1 + 46824);
            v11 = v8;
          }
          if ( v8 < 0 )
          {
          ...
          {
            qsort((void *)(a1 + 24), (unsigned int)*v9, 0x10uLL, sub_1408314D0);
            *(_BYTE *)(a1 + 46828) = 1;
          }
          else
          {
