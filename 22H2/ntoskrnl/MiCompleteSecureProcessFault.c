/*
 * XREFs of MiCompleteSecureProcessFault @ 0x140645C08
 * Callers:
...
__int64 __fastcall MiCompleteSecureProcessFault(__int64 *a1, __int64 *a2, __int64 a3)
{
  ...
  if ( *(__int64 *)(*a1 + 40) >= 0 )
  {
    ...
    v5 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v3 + 40) >> 43) & 0x3FFLL));
    ...
    if ( (*(_DWORD *)(v5 + 4) & 8) != 0 && !(unsigned int)MiCheckSlabPfnBitmap(v3, 1LL, 0) && v7 < 0xFFFF800000000000uLL )
    {
      ...
      SlabPage = MiGetSlabPage(
                   v5,
                   2u,
                   (PfnChannel << byte_140C65B8E) | dword_140C65BF8 & (-1431655765
                                                                     * ((__int64)(v3 + 0x220000000000LL) >> 4)) | (v9 << byte_140C65B8D),
                   0LL,
                   v11);
      if ( SlabPage == -1 )
      {
