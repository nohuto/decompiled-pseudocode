  ...
  if ( (_DWORD)BugCheckParameter2 )
  {
    if ( (_DWORD)BugCheckParameter2 == 1 )
    {
      ...
      *(_BYTE *)(KiProcessorBlock[(unsigned int)KiClockTimerOwner] + 33) = 1;
      ...
      dword_140C3161C = KeMaximumIncrement;
...
LABEL_33:
      ...
      dword_140C31690 = KeTimeIncrement;
      dword_140C31694 = KeTimeIncrement;
      result = KiLastRequestedTimeIncrement;
      dword_140C31698 = KiLastRequestedTimeIncrement;
      dword_140C3169C = KiLastRequestedTimeIncrement;
    }
    else
    {
