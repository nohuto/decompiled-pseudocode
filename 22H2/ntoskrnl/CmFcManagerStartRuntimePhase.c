...
__int64 CmFcManagerStartRuntimePhase()
{
  ...
  *(_OWORD *)&DestinationString[1] = 0LL;
  ...
  if ( SectionFromBuffer >= 0 )
  {
    ...
    RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C481F0, (__int64)&v30, DestinationString);
    v6 = v30;
    v7 = v33;
    v8 = 3LL;
    do
          ...
          SectionFromBuffer >= 0) )
    {
      ...
      while ( 1 )
      {
        ...
        if ( ++v12 >= 3 )
        {
          ...
          while ( v16 != 1 );
          RtlpFcBufferManagerUpdateBuffers(qword_140C481F0, v30, (__int64)v32);
          memset(v32, 0, 0x48uLL);
