/*
 * XREFs of MiRelinkDecayClusterTimer @ 0x14021A9BC
 * Callers:
...
unsigned __int64 __fastcall MiRelinkDecayClusterTimer(__int64 a1, unsigned int a2)
{
  ...
  *(_BYTE *)(a1 + 34) = ((_BYTE)a2 << 6) | *(_BYTE *)(a1 + 34) & 0x3F;
  v3 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL));
  result = *(_QWORD *)(v3 + 8LL * a2 + 15744);
  v5 = 0xAAAAAAAAAAAAAAABuLL * ((a1 + 0x220000000000LL) >> 4) - qword_140C68260;
  v6 = result >> 1;
  ...
  *(_QWORD *)(a1 + 8) = 2 * (((unsigned int)result >> 1) | 0xFFFFFFFF00000000uLL);
  ...
  if ( v6 == 0x7FFFFFFF )
    ...
    *(_QWORD *)(48 * (qword_140C68260 + v6) - 0x220000000000LL + 8) = v7 | *(_QWORD *)(48 * (qword_140C68260 + v6)
                                                                                     - 0x220000000000LL
                                                                                     + 8) & 0x1FFFFFFFFLL;
