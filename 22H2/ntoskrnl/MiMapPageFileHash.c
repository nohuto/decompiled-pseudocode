/*
 * XREFs of MiMapPageFileHash @ 0x14066635C
 * Callers:
...
void __fastcall MiMapPageFileHash(__int64 a1, __int64 a2, __int64 a3, int a4, unsigned int a5)
{
  ...
  if ( !v24 )
  {
    ...
    while ( 1 )
    {
      ...
      v12 = *(_QWORD *)(v8 + 216);
      v13 = v11;
      v14 = v12 + dword_140C6974C * v5;
      v15 = a5;
      v16 = (((v12 + (unsigned __int64)(unsigned int)(dword_140C6974C * v5)) >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
      if ( (4096 - (v14 & 0xFFFu)) / dword_140C6974C <= a5 )
        v15 = (4096 - (v14 & 0xFFFu)) / dword_140C6974C;
      v86 = v15;
...
LABEL_83:
          ...
          *(_QWORD *)v16 = v59;
          ...
          if ( KiIrqlFlags )
          {
            ...
            if ( (KiIrqlFlags & 1) != 0 && v62 <= 0xFu && (unsigned __int8)v38 <= 0xFu && v62 >= 2u )
            {
...
LABEL_130:
        ...
        if ( MiPteInShadowRange(v36 + 16) )
        {
          ...
          {
            v71 = 1;
            if ( !HIBYTE(word_140C66DFC) && (v68 & 1) != 0 )
...
LABEL_114:
            ...
            *(_QWORD *)v16 = v74;
            ...
            if ( KiIrqlFlags && (v78 = KeGetCurrentIrql(), (KiIrqlFlags & 1) != 0) && v78 <= 0xFu )
            {
              v79 = v84;
              if ( v84 <= 0xFu && v78 >= 2u )
              {
...
LABEL_68:
    ...
    if ( KiIrqlFlags )
    {
      ...
      if ( (KiIrqlFlags & 1) != 0 && v43 <= 0xFu && v37 <= 0xFu && v43 >= 2u )
      {
...
LABEL_66:
    _InterlockedDecrement64(&qword_140C6A328);
    goto LABEL_67;
  }
}
