/*
 * XREFs of KiCollectTriageDumpDataBlocks @ 0x140569D34
 * Callers:
...
LABEL_27:
      ...
      else if ( qword_140C42808 == 4 || qword_140C42808 == 100 )
      {
        goto LABEL_16;
      }
    }
    ...
    {
      KiMarkBugCheckRegions(qword_140C42808, qword_140C42810, qword_140C42818, qword_140C42820);
      if ( qword_140C42820 == 47 )
      {
        v10 = qword_140C42818;
        if ( MmIsAddressValidEx(qword_140C42818 + 1928) )
        {
          v8 = *(_QWORD *)(v10 + 1928);
          v9 = 4096LL;
          goto LABEL_27;
  ...
  else
  {
    ...
    if ( CriticalProcessExceptionData )
    {
      ...
      if ( (_WORD)xmmword_140C31B30 )
      {
        LODWORD(v8) = DWORD2(xmmword_140C31B30);
        v9 = (unsigned __int16)xmmword_140C31B30;
        goto LABEL_27;
      }
    }
  }
