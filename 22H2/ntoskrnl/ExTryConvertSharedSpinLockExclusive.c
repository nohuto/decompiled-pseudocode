/*
 * XREFs of ExTryConvertSharedSpinLockExclusive @ 0x140381450
 * Callers:
 *     ExpAddTagForBigPages @ 0x1402BC450 (ExpAddTagForBigPages.c)
 *     ViDeadlockDetectionTryConvertSharedToExclusive @ 0x1405A2138 (ViDeadlockDetectionTryConvertSharedToExclusive.c)
 * Callees:
