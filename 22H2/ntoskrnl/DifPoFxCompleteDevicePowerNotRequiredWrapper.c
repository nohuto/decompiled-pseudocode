/*
 * XREFs of DifPoFxCompleteDevicePowerNotRequiredWrapper @ 0x1405E92F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
  result = (_QWORD *)PoFxCompleteDevicePowerNotRequired(BugCheckParameter2);
  if ( v7 )
  {
    v12 = v7 + 6;
    for ( j = (_QWORD *)v7[6]; j != v12; j = (_QWORD *)*j )
    {
      result = j - 2;
      if ( j != (_QWORD *)16 )
        result = (_QWORD *)((__int64 (__fastcall *)(__int128 *))result[1])(&v14);
    }
  }
  return result;
}
