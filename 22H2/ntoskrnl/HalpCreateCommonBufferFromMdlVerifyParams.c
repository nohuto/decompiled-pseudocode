/*
 * XREFs of HalpCreateCommonBufferFromMdlVerifyParams @ 0x14050FE34
 * Callers:
 ...
 * Callees:
 *     HalpParseCommonBufferExtendedConfigurations @ 0x14050FF7C (HalpParseCommonBufferExtendedConfigurations.c)
 */
