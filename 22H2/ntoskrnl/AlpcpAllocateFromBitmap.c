/*
 * XREFs of AlpcpAllocateFromBitmap @ 0x14066FA5C
 * Callers:
 *     AlpcpAllocateCompletionBuffer @ 0x14066F990 (AlpcpAllocateCompletionBuffer.c)
 * Callees:
 *     AlpcpFreeBitmap @ 0x1408C368C (AlpcpFreeBitmap.c)
 */
