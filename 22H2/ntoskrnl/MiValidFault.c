/*
 * XREFs of MiValidFault @ 0x140333340
 * Callers:
 ...
 *     MI_IS_PTE_SHADOW_STACK @ 0x1406457A0 (MI_IS_PTE_SHADOW_STACK.c)
...
LABEL_9:
        ...
        if ( v11 <= qword_140C65CA0 && _bittest64((const signed __int64 *)(48 * v11 - 0x21FFFFFFFFD8LL), 0x36u) )
        {
          ...
          if ( (v13 & 1) == 0
            && (!v13 || (!qword_140C65C40 || (qword_140C65C40 & v13) != 0) && (v13 & 0x400) == 0)
            && (v13 & 4) != 0 )
          {
...
LABEL_40:
    ...
    if ( (v4 & 0x10) != 0 )
    {
      if ( v9 < 0 )
      {
        ...
        if ( v35 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * v35 - 0x21FFFFFFFFD8LL), 0x36u) )
          return (unsigned int)-1073741819;
