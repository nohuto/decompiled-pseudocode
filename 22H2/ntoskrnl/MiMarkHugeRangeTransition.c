/*
 * XREFs of MiMarkHugeRangeTransition @ 0x14062E94C
 * Callers:
...
LABEL_2:
  ...
  for ( i = &xmmword_140C69680; (__int64)i < (__int64)&xmmword_140C69690; i = (__int128 *)((char *)i + 8) )
  {
    j = *(_QWORD *)i;
    if ( !*(_QWORD *)i )
      continue;
...
LABEL_23:
  ...
  {
    if ( v4 )
      *(_QWORD *)(qword_140C67EF0 + 8 * ((a1 >> 18) & 0x3FFFFF)) = *(_DWORD *)(qword_140C67EF0
