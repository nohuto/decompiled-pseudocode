/*
 * XREFs of PfpPrefetchSharedStart @ 0x14074C32C
 * Callers:
...
__int64 __fastcall PfpPrefetchSharedStart(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 68) ^= (*(_DWORD *)(a1 + 68) ^ (2 * PsSetCurrentThreadPrefetching(1u))) & 2;
  v3 = 0;
  if ( !ExAcquireRundownProtection_0(&stru_140C651D0) )
    return (unsigned int)-1073741127;
  *(_DWORD *)(a1 + 68) |= 1u;
  v4 = KeGetCurrentThread();
  --v4->KernelApcDisable;
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_140C651E0, 0LL);
  if ( (dword_140C651F8 & 1) == 0 )
  {
    v5 = qword_140C651E8;
    if ( *(__int64 **)(qword_140C651E8 + 8) != &qword_140C651E8 )
      __fastfail(3u);
    *(_QWORD *)a1 = qword_140C651E8;
    *(_QWORD *)(a1 + 8) = &qword_140C651E8;
    *(_QWORD *)(v5 + 8) = a1;
    qword_140C651E8 = a1;
  }
