/*
 * XREFs of MiLogPeriodicTelemetry @ 0x14021F674
 * Callers:
 ...
 *     ExtractAggregateFieldTypes @ 0x14021345C (ExtractAggregateFieldTypes.c)
...
__int64 __fastcall MiLogPeriodicTelemetry(unsigned __int16 *a1)
{
  ...
  if ( *(_QWORD *)&qword_140C699E8 )
  {
    ...
    result = 6000000000LL;
    if ( (unsigned __int64)(UnbiasedInterruptTime - *((_QWORD *)v2 + 2126)) >= 0x165A0BC00LL )
    {
      ...
      if ( *((_DWORD *)v2 + 4229) )
      {
        v12 = *(_QWORD *)&qword_140C699E8;
        if ( **(_DWORD **)&qword_140C699E8 > 5u )
        {
          if ( tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000400LL) )
          {
            v34 = v14;
            v54 = &v34;
            v28 = *v2;
      ...
      if ( *((_QWORD *)v2 + 2032) )
      {
        v17 = *(_QWORD *)&qword_140C699E8;
        if ( **(_DWORD **)&qword_140C699E8 > 5u )
        {
          if ( tlgKeywordOn(*(__int64 *)&qword_140C699E8, v5) )
          {
            v36 = v20;
            v64 = &v36;
            v29 = *v2;
            ...
            *(_DWORD *)&v32.Id = 184549376;
            ...
            if ( *(void (__fastcall **)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))(v17 + 40) == TlgAggregateInternalRegisteredProviderEtwCallback )
            {
              ...
              if ( v22 )
                InsertEventEntryInLookUpTable(v17, (__int64)&v32, 5, (__int64)&v60, v22);
              else
      ...
      if ( **(_DWORD **)&qword_140C699E8 > 5u )
      {
        if ( tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000400LL) )
        {
          ...
          v43 = *((_QWORD *)v2 + 2039);
          v84 = &v43;
          v44 = *((unsigned int *)v2 + 4080);
          v86 = &v44;
          v45 = *((unsigned int *)v2 + 4081);
          v88 = &v45;
          v46 = *((unsigned int *)v2 + 4082);
          v90 = &v46;
          v47 = *((unsigned int *)v2 + 4083);
          v92 = &v47;
          v48 = *((_QWORD *)v2 + 2042);
          v94 = &v48;
          v30 = *v2;
          ...
          *(_DWORD *)&v33.Id = 184549376;
          ...
          if ( *(void (__fastcall **)(const struct _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, void *))(v6 + 40) == TlgAggregateInternalRegisteredProviderEtwCallback )
          {
            ...
            if ( v9 )
              InsertEventEntryInLookUpTable(v6, (__int64)&v33, 15, (__int64)&v70, v9);
            else
      ...
      *((_QWORD *)v2 + 2126) = UnbiasedInterruptTime;
    }
  }
  return result;
}
