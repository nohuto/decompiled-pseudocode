/*
 * XREFs of HalpIommuCreateDevice @ 0x140864A14
 * Callers:
 ...
 *     HalpIommuCheckDpptException @ 0x1404C9030 (HalpIommuCheckDpptException.c)
...
LABEL_21:
  ...
  *v31 = v17;
  *(_DWORD *)(v13 + 32) = 1;
  v20 = (__int64 *)qword_140C49E78;
  if ( *(__int64 **)qword_140C49E78 != &HalpIommuDeviceCreatedList )
    __fastfail(3u);
