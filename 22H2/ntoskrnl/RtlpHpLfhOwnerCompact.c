/*
 * XREFs of RtlpHpLfhOwnerCompact @ 0x140287294
 * Callers:
...
__int64 __fastcall RtlpHpLfhOwnerCompact(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (*(_BYTE *)a2 & 1) != 0 && *(_BYTE *)(a2 + 2) )
  {
    ...
    do
    {
      RtlpHpLfhOwnerCompact(a1, *(_QWORD *)(*(_QWORD *)(a2 + 96) + v6), a3);
      v6 += 8LL;
      --v7;
    }
    while ( v7 );
  ...
  if ( *v8 != v8 || (result = a2 + 40, *(_QWORD *)result != result) )
  {
    ...
    v10 = RtlpHpAcquireLockShared(v9, *(unsigned __int8 *)(a1 + 57));
    v11 = *v8;
    v12 = v10;
    while ( v11 != v8 )
    {
      RtlpHpLfhSubsegmentDecommitPages(a1, (_DWORD)v11, -1, 1, a3);
      v11 = (_QWORD *)*v11;
    }
    if ( *(_BYTE *)(a1 + 57) )
    {
