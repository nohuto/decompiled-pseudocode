/*
 * XREFs of KiModifySystemAllowedCpuSetsWithLock @ 0x14039D200
 * Callers:
...
__int64 __fastcall KiModifySystemAllowedCpuSetsWithLock(unsigned int a1, char *a2, _WORD *a3, int a4, int a5)
{
  char *v5; // rsi
  __int64 v6; // r14
  __int64 v9; // rbx
  ...
  if ( (int)result >= 0 )
  {
    if ( !a3 || (unsigned int)KeIsSubsetAffinityEx((__int64)a3, (__int64)KeActiveProcessors) )
    {
      v11 = 32;
      if ( a1 < 0x20 )
        v11 = a1;
