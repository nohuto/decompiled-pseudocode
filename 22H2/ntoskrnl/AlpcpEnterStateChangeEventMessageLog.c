/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x14097AAC0
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x14097A87C (AlpcpAllocateSnapshotMessageLog.c)
 *     AlpcpLocateMessageLog @ 0x14097AC6C (AlpcpLocateMessageLog.c)
 */
