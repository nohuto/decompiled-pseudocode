/*
 * XREFs of AlpcpEnterStateChangeEventMessageLog @ 0x1408C2C24
 * Callers:
 ...
 *     AlpcpAllocateSnapshotMessageLog @ 0x1408C29E0 (AlpcpAllocateSnapshotMessageLog.c)
