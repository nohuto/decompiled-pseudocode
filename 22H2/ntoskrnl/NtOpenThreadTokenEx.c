/*
 * XREFs of NtOpenThreadTokenEx @ 0x140653590
 * Callers:
 *     NtOpenThreadToken @ 0x140653570 (NtOpenThreadToken.c)
 * Callees:
...
LABEL_9:
    ...
    if ( v27 )
    {
      ...
      *((_QWORD *)&v41 + 1) = 0LL;
      v22 = SepDuplicateToken((__int64)v16, (int)&v39, v28, 2, v18, 0, 0, &v33);
      if ( v22 < 0 )
        goto LABEL_22;
      if ( v26 )
      ...
      inserted = ObInsertObjectEx((PADAPTER_OBJECT)v33, 0LL, DesiredAccess, 0, 0, 0LL, (unsigned __int64 *)&Handle);
    }
    else
    {
