 ...
 *     KiReadFixedMtrr @ 0x140999A88 (KiReadFixedMtrr.c)
...
void __fastcall KiInitializeMTRR(char a1)
{
  ...
  {
    qword_140C2B3C8 = __readmsr(0xFEu);
    KiMtrrInfo = __readmsr(0x2FFu);
    CurrentPrcb = KeGetCurrentPrcb();
    byte_140C2B3D1 = 0;
    if ( CurrentPrcb->CpuVendor == 1 )
      byte_140C2B3D1 = (__readmsr(0xC0010010) & 0x40000) != 0;
    if ( (((_BYTE)qword_140C2B3C8 != 0) & _bittest64(&KiMtrrInfo, 0xBu)) != 0 )
    {
      if ( (KeFeatureBits & 0x40) == 0 && (qword_140C2B3C8 & 0x400) != 0 )
        qword_140C2B3C8 &= ~0x400uLL;
      PoolWithTag = qword_140C2B3D8;
      v15 = 16 * (unsigned int)(unsigned __int8)qword_140C2B3C8;
      if ( qword_140C2B3D8
        || (PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)v15, 0x2020654Bu),
            (qword_140C2B3D8 = PoolWithTag) != 0LL) )
      {
        memset(PoolWithTag, 0, v15);
      }
      v16 = qword_140C2B3E0;
      if ( qword_140C2B3E0
        || (qword_140C2B3C8 & 0x100) != 0
        && (v16 = ExAllocatePoolWithTag(NonPagedPoolNx, 0x58uLL, 0x2020654Bu), (qword_140C2B3E0 = v16) != 0LL) )
      {
  ...
  if ( qword_140C2B3D8 && (qword_140C2B3E0 || (qword_140C2B3C8 & 0x100) == 0) )
  {
    v3 = __readmsr(0xFEu);
    if ( (KeFeatureBits & 0x40) == 0 && (v3 & 0x400) != 0 )
      v3 &= ~0x400uLL;
    if ( v3 != qword_140C2B3C8 )
  ...
  {
    if ( qword_140C2B3E0 )
      KiReadFixedMtrr(qword_140C2B3E0);
    ...
    if ( (_BYTE)v3 )
    {
      ...
      do
      {
        ...
        if ( (v9 & 0x800) != 0 )
        {
          ...
          v12 = 2 * v6;
          *((_QWORD *)qword_140C2B3D8 + v12) = v8;
          *((_QWORD *)qword_140C2B3D8 + v12 + 1) = v11;
        }
        ++v5;
        v7 += 2;
        v6 = v5;
...
LABEL_50:
    if ( qword_140C2B3D8 )
    {
      ExFreePoolWithTag(qword_140C2B3D8, 0);
      qword_140C2B3D8 = 0LL;
    }
    if ( qword_140C2B3E0 )
    {
      ExFreePoolWithTag(qword_140C2B3E0, 0);
      qword_140C2B3E0 = 0LL;
    }
  }
}
