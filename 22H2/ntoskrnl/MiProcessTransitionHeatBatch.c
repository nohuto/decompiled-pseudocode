/*
 * XREFs of MiProcessTransitionHeatBatch @ 0x1406546A4
 * Callers:
...
char __fastcall MiProcessTransitionHeatBatch(unsigned int *a1)
{
  ...
  if ( v3->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries((__int64)a1, (__int64)v3)) != 0 )
  {
    ...
    *(_QWORD *)v4 = (unsigned __int64)&qword_140C6B5D8 & 0x7FFFFFFFFFFFFFFCLL;
  }
  if ( !_InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C6B5D8, 17LL, 0LL)
    || (LOBYTE(v12) = ExfTryAcquirePushLockSharedEx((signed __int64 *)&qword_140C6B5D8, 0), (_BYTE)v12) )
  {
    if ( v4 )
      *(_BYTE *)(v4 + 18) = 1;
    for ( i = a1 + 4; ; i += 2 )
...
LABEL_26:
    ...
    while ( v14 <= qword_140C65CA0 && _bittest64(v18, 0x36u) )
    {
      ++v14;
      v18 += 6;
      if ( v14 >= v17 )
...
LABEL_29:
    ...
    LOBYTE(v12) = KeAbPostRelease((ULONG_PTR)&qword_140C6B5D8);
  }
  else if ( v4 )
  {
    LOBYTE(v12) = KeAbPostReleaseEx((ULONG_PTR)&qword_140C6B5D8, v4);
  }
