/*
 * XREFs of EtwpCoverageResetCP @ 0x1409E86F0
 * Callers:
...
__int64 __fastcall EtwpCoverageResetCP(__int64 a1, __int64 a2)
{
  ...
  v4 = 0;
  *(_DWORD *)(a2 + 12) = 0;
  if ( (unsigned int)dword_140C093C4 < MEMORY[0xFFFFF7800000037C] )
  {
    if ( !dword_140C093C0 )
      dword_140C093C0 = TelemetryCoverageStringHashInternal(off_140C093B8, &v23);
    EtwTelemetryCoverageReport((__int64 *)&off_140C093B8);
  }
