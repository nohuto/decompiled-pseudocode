/*
 * XREFs of PspCaptureUserProcessParameters @ 0x140606D2C
 * Callers:
 ...
 *     PspCaptureAndValidateUnicodeString @ 0x1406073E8 (PspCaptureAndValidateUnicodeString.c)
 *     PspValidateEnvironmentBlock @ 0x140607460 (PspValidateEnvironmentBlock.c)
