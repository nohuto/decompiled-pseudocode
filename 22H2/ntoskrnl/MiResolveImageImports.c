/*
 * XREFs of MiResolveImageImports @ 0x14075C7B4
 * Callers:
...
__int64 __fastcall MiResolveImageImports(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _BYTE *a5)
{
  ...
  if ( !v10 || (v14 = v29) == 0 )
  {
    ...
    do
    {
      ...
      v14 = 8 * i;
      v29 = v14;
      if ( !(unsigned int)MiSetImageProtection(a1, v20, v14) )
      {
  ...
  if ( (unsigned int)MiSetImageProtection(a1, v10, v29) )
  {
    v9 = 1;
LABEL_5:
    v15 = v30;
    *(_DWORD *)(a1 + 104) |= 0x1000u;
    ...
    if ( *(_QWORD *)(MiSectionControlArea(*(_QWORD *)(a1 + 112)) + 144) )
    {
      if ( v13 )
      {
        MiSetImageProtection(a1, v13, v14);
      }
      else
      {
        for ( j = &v12[-5 * v9]; j; j += 5 )
        {
          ...
          MiSetImageProtection(a1, v5 + j[4], 8 * v27);
        }
      }
    }
    *(_DWORD *)(a1 + 104) &= ~0x1000u;
