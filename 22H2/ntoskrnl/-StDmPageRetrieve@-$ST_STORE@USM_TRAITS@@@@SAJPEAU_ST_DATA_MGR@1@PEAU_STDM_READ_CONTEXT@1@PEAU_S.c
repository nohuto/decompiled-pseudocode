/*
 * XREFs of ?StDmPageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x14026CB7C
 * Callers:
 ...
 *     MmAreMdlPagesCached @ 0x1403046B0 (MmAreMdlPagesCached.c)
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmPageRetrieve(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_BYTE *)(a3 + 8) = 0;
  ...
  v11 = &v25;
  for ( i = ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(a1, a2, (__int64)&v23, a3, (__int64)&v25);
        ;
        i = ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(a1, a2, (__int64)&v23, a3, (__int64)v11) )
  {
    v16 = i;
    if ( i < 0 )
    {
