/*
 * XREFs of MinCryptVerifyCertificateWithPolicy2 @ 0x140A6F8C8
 * Callers:
 ...
 *     I_MinCryptIsCertificateHashRevokedV2 @ 0x140677480 (I_MinCryptIsCertificateHashRevokedV2.c)
 ...
 *     I_MinCryptGetCertificateEKUs @ 0x140A6F7E0 (I_MinCryptGetCertificateEKUs.c)
 *     I_MinCryptGetCommonName @ 0x140A6F87C (I_MinCryptGetCommonName.c)
 ...
 *     MinAsn1DecodeTime @ 0x140A7145C (MinAsn1DecodeTime.c)
...
LABEL_11:
    ...
    v68 = I_MinCryptCheckEKU((const void **)&qword_140A787E0, v43, (__int64)v10);
    ...
    if ( !g_IgnoreLifetimeSigningEKU && I_MinCryptCheckEKU((const void **)&qword_140A787D0, v43, (__int64)v10) )
    {
      v14 = 0;
      v41 = 0;
