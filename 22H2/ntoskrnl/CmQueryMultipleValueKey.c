/*
 * XREFs of CmQueryMultipleValueKey @ 0x1406CFBE8
 * Callers:
...
LABEL_63:
    ...
    CmpUnlockKcb(v12);
    v55 = CmpTransSearchAddTransFromKeyBody(a1, &v71);
    if ( v55 < 0 )
    {
...
LABEL_62:
  ...
  {
    ExfAcquirePushLockSharedEx((signed __int64 *)(v13 + 72), 0LL, v15, v13 + 72);
    v15 = (unsigned __int64)v78;
  }
  if ( v15 )
    *(_BYTE *)(v15 + 18) = 1;
