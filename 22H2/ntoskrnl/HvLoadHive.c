/*
 * XREFs of HvLoadHive @ 0x14074F254
 * Callers:
...
LABEL_90:
  ...
  if ( (unsigned int)dword_140C04390 > 5 && tlgKeywordOn((__int64)&dword_140C04390, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&dword_140037994 + 3,
      0LL,
      0LL,
      v29,
      v48);
  ...
  *(_DWORD *)(BugCheckParameter2 + 220) = *((_DWORD *)v13 + 6) - 4096 + (*((_DWORD *)v13 + 5) << 12);
    ...
    && (BYTE2(NlsMbOemCodePageTag) || (CmpBootType & 6) != 0) )
  {
    if ( (unsigned int)dword_140C04390 > 5 && tlgKeywordOn((__int64)&dword_140C04390, 0x200000000000LL) )
    {
      ...
      v38 = 0x1000000LL;
      v54 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04390, (unsigned __int8 *)byte_140037931, 0LL, 0LL, 5u, v48);
    }
