/*
 * XREFs of ?SmStTrimWsStore@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@_K@Z @ 0x140599900
 * Callers:
...
LABEL_41:
      ...
      if ( v17 != v16 && (*v17 | *((_DWORD *)qword_1400127A0 + (v13 & 0x1F))) == -1 )
      {
        v12 = v13 - (v13 & 0x1F) + 32;
      ...
      {
        v19 = v12 & 0x1F;
        if ( (*v17 & ~*((_DWORD *)qword_1400127A0 + (v12 & 0x1F))) == 0 )
        {
          v18 = 32 - v19;
          if ( v19 == 33 )
            goto LABEL_32;
