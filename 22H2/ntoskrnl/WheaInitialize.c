/*
 * XREFs of WheaInitialize @ 0x140B4C7E8
 * Callers:
 ...
 *     WheapQueryPshedForErrorSources @ 0x140B4CC20 (WheapQueryPshedForErrorSources.c)
...
__int64 __fastcall WheaInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( a2 )
  {
    qword_140C2CB58 = (__int64)&WheapPrevErrList;
      ...
      || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v14, (__int64)CurrentThread)) != 0 )
    {
      ...
      if ( (unsigned __int64)&WheapConfigTableLock - qword_140C65AE8 >= 0x8000000000LL )
        SessionId = -1;
      else
    ...
    for ( j = qword_140CF7B28; (__int64 *)j != &qword_140CF7B28; j = *(_QWORD *)j )
    {
      if ( *(_DWORD *)(j + 104) == 7 )
      {
        *(_DWORD *)(j + 108) = 2;
    ...
    v27 = qword_140CF7B28;
    v28 = 1;
    while ( (__int64 *)v27 != &qword_140CF7B28 )
    {
  ...
  else
  {
    ...
    stru_140CF7B38.Header.WaitListHead.Blink = &stru_140CF7B38.Header.WaitListHead;
    qword_140CF7B30 = (__int64)&qword_140CF7B28;
    qword_140CF7B28 = (__int64)&qword_140CF7B28;
    stru_140CF7B38.Header.WaitListHead.Flink = &stru_140CF7B38.Header.WaitListHead;
    dword_140CF7B20 = 1;
    LOWORD(stru_140CF7B38.Header.Lock) = 1;
    stru_140CF7B38.Header.Size = 6;
    stru_140CF7B38.Header.SignalState = 1;
    ...
    if ( v49 )
    {
      do
      {
        v9 = qword_140D16DC8[8 * (__int64)v8[2]](0LL, v8, 0LL);
        if ( v9 < 0 )
