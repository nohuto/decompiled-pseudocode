/*
 * XREFs of MiLogReserveVaFailed @ 0x140A2E914
 * Callers:
...
char __fastcall MiLogReserveVaFailed(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_QWORD *)&qword_140C699E8 )
  {
    ...
    if ( ((unsigned __int16)v4 & 0x800) == 0 )
    {
      ...
      {
        LOBYTE(v4) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000000LL);
        if ( (_BYTE)v4 )
        {
          v30 = 0;
          v33 = 0;
          ...
          v21 = a3;
          v22 = a4;
          LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v12, (unsigned __int8 *)&word_140038422, v11, 1u, v14, v15, 0xAu, &v27);
        }
      }
    }
  }
