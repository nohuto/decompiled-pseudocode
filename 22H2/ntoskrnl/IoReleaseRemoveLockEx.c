/*
 * XREFs of IoReleaseRemoveLockEx @ 0x140303900
 * Callers:
 *     ViFilterDeviceUsageNotificationCompletion @ 0x1409E50D0 (ViFilterDeviceUsageNotificationCompletion.c)
 *     ViFilterGenericCompletionRoutine @ 0x1409E56C0 (ViFilterGenericCompletionRoutine.c)
 *     ViFilterStartCompletionRoutine @ 0x1409E5730 (ViFilterStartCompletionRoutine.c)
 * Callees:
