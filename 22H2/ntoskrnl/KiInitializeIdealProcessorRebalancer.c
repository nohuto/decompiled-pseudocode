/*
 * XREFs of KiInitializeIdealProcessorRebalancer @ 0x1403B4088
 * Callers:
...
__int64 KiInitializeIdealProcessorRebalancer()
{
  ...
  KiInitializeTimer2(
    ...
    0LL,
    8);
  stru_140C418A8.WorkerRoutine = (void (__fastcall *)(void *))KiIdealProcessorRebalancerWorker;
  result = (unsigned int)KiCacheAwareScheduling;
  stru_140C418A8.Parameter = 0LL;
  stru_140C418A8.List.Flink = 0LL;
  qword_140C418C8 = 0LL;
