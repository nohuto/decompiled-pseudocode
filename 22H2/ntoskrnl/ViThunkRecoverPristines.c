/*
 * XREFs of ViThunkRecoverPristines @ 0x1409D91A4
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x1409D88C4 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x1409D9698 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x1409D9780 (ViThunkReplaceSpecialPristine.c)
 */
