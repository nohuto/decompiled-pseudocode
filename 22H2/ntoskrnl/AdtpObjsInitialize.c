/*
 * XREFs of AdtpObjsInitialize @ 0x14079E8F0
 * Callers:
...
int AdtpObjsInitialize()
{
  ...
  unsigned int v41; // [rsp+E8h] [rbp+6Fh]
        ...
        *(_DWORD *)(v8 - 2) = 1572864;
        ...
        if ( v7 > 0xF )
        {
          ...
          *((_QWORD *)&v37 + 1) = 0LL;
          DWORD2(v38) = 576;
          v39 = 0LL;
          v9 = CmOpenKey(&v43, 131097, (__int64)&v37, 0LL, 0LL);
          v10 = v9;
          if ( v9 == -1073741772 )
            return 0;
          v11 = 0;
          for ( i = v9 < 0; ; i = v10 < 0 )
          {
            ...
            v14 = v43;
            LODWORD(Length) = 0;
            v10 = NtEnumerateKey(v43, v11, 0, 0LL, Length, &NumberOfBytes);
            if ( v10 == -1073741789 )
            {
              ...
              if ( !PoolWithTag )
                return -1073741801;
              LODWORD(Length) = NumberOfBytes;
              v10 = NtEnumerateKey(v14, v11, 0, PoolWithTag, Length, &NumberOfBytes);
              if ( v10 >= 0 )
              {
                v2 = 1;
                ...
                *((_QWORD *)&v37 + 1) = v14;
                DWORD2(v38) = 576;
                v39 = 0LL;
                result = CmOpenKey(&Handle, 131097, (__int64)&v37, 0LL, 0LL);
                if ( result < 0 )
                  return result;
                ...
                *(_QWORD *)&v38 = &SourceString;
                DWORD2(v38) = 576;
                v39 = 0LL;
                v10 = CmOpenKey(&v42, 131097, (__int64)&v37, 0LL, 0LL);
                NtClose(v23);
                v1 = v42;
                if ( v10 == -1073741772 )
                {
            ...
            if ( v10 >= 0 )
            {
              do
              {
                if ( !v2 )
                  break;
                LODWORD(Length) = 0;
                v25 = NtEnumerateValueKey(v1, v24, 1u, 0LL, Length, &NumberOfBytes);
                if ( v25 == -1073741789 )
                {
                  ...
                  if ( !v26 )
                    return -1073741801;
                  LODWORD(Length) = NumberOfBytes;
                  v25 = NtEnumerateValueKey(v1, v24, 1u, v26, Length, &NumberOfBytes);
                  if ( v25 >= 0 )
                  {
