/*
 * XREFs of PnpTraceSecureDeviceEnumeration @ 0x1408B21A0
 * Callers:
...
void PnpTraceSecureDeviceEnumeration()
{
  ...
  if ( (unsigned int)dword_140C02DC8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02DC8, 0x400000000000LL) )
    {
      ...
      v4 = v1;
      v13 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02DC8, (unsigned __int8 *)byte_1400256C1, 0LL, 0LL, 6u, &v5);
    }
  }
}
