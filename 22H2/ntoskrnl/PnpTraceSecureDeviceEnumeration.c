/*
 * XREFs of PnpTraceSecureDeviceEnumeration @ 0x14096C520
 * Callers:
...
void PnpTraceSecureDeviceEnumeration()
{
  ...
  if ( (unsigned int)dword_140C03918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03918, 0x400000000000LL) )
    {
      ...
      v4 = v1;
      v16 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03918, (unsigned __int8 *)word_14002CB92, 0LL, 0LL, 7u, &v6);
    }
  }
}
