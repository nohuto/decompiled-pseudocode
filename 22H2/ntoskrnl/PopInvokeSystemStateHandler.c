/*
 * XREFs of PopInvokeSystemStateHandler @ 0x14099324C
 * Callers:
...
__int64 __fastcall PopInvokeSystemStateHandler(int a1, __int64 a2)
{
  ...
  struct _SLIST_ENTRY v38[9]; // [rsp+110h] [rbp+10h] BYREF
  ...
  if ( a2 )
  {
    ...
    qword_140C50680 = DeferredContext[4];
    dword_140C50688 = DeferredContext[5];
    byte_140C5068C = BYTE4(DeferredContext[5]);
    dword_140C50690 = DeferredContext[6];
    qword_140C50668 = (__int64)v7;
    v9 = &PopHibernateSystemContext;
    qword_140C50670 = v8;
    qword_140C50678 = v6;
    qword_140C50698 = DeferredContext[7];
    RtlpInterlockedPushEntrySList(&stru_140C506A0, &v38[8]);
  }
  else
  {
  ...
  if ( (xmmword_140CFC490 & 0x8000) != 0 )
  {
    ...
    v37[1] = v10;
    v34 = 16;
    EtwTraceKernelEvent((__int64)&v33, 1u, 0x80008000, 0x1230u, 0x401802u);
  }
  ...
  if ( SLODWORD(v38[7].Next) >= 0 )
  {
    *((_BYTE *)v9 + 44) = 1;
    ...
    if ( a2 )
    {
      ...
      MmInvalidateDumpAddresses(qword_140C23E68, 19LL);
      v13 = *(_QWORD *)(a2 + 304);
      if ( v13 )
  ...
  if ( a2 )
  {
    ...
    v23 = qword_140C23180 == 0;
    *v9 = (__int64)&unk_140C23178;
    v9[3] = 0LL;
    if ( !v23 )
      PopIssueNextState(v9, v38, 6LL);
...
LABEL_49:
  ...
  if ( Next >= 0 )
  {
    if ( dword_140C23A60 != 4 || PoResumeFromHibernate )
    {
      v15 = 0;
      v28 = KeQueryPerformanceCounter(0LL);
      ((void (__fastcall *)(void *, __int64 *))off_140C006A0[0])(&unk_140C24088, &qword_140C24090);
    }
    else
    {
      v15 = 1;
    ...
    if ( (xmmword_140CFC490 & 0x8000) != 0 )
    {
      ...
      v36[1] = 8LL;
      v36[0] = &v30;
      EtwTraceKernelEvent((__int64)v36, 1u, 0x80008000, 0x1231u, 0x401802u);
    }
    if ( v15 )
    {
      v28.QuadPart = v28.QuadPart / (1000 * (unsigned __int64)KeGetCurrentPrcb()->MHz) * (PopQpcFrequency / 0x3E8);
      qword_140C23F68 = v28.QuadPart - PerformanceCounter.QuadPart;
    }
  }
  ...
  if ( a2 )
  {
    if ( !byte_140C23E81 && Next == 1073742484 )
    {
      if ( byte_140C50650 )
        BgLibraryInitialize(qword_140C50648, 0LL);
    }
  }
  else
  {
