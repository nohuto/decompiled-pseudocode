/*
 * XREFs of CcCopyWriteEx @ 0x1402C8CF0
 * Callers:
 *     CcCopyWrite @ 0x1403A8970 (CcCopyWrite.c)
 *     CcFastCopyWrite @ 0x1405377E0 (CcFastCopyWrite.c)
...
char __fastcall CcCopyWriteEx(__int64 a1, __int64 *a2, unsigned int a3, char a4, __int64 a5, __int64 a6)
{
  ...
  if ( !byte_140C5F961 )
  {
    ...
    {
      if ( v29 )
        v24 = 1000000 * (*(_QWORD *)&KeQueryPerformanceCounter(0LL) - v29) / stru_140C5F928.QuadPart;
      else
        v24 = v30;
      v25 = 122LL;
      if ( !a4 )
