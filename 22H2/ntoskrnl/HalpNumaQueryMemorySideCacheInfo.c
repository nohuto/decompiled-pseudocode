/*
 * XREFs of HalpNumaQueryMemorySideCacheInfo @ 0x1407D5410
 * Callers:
 *     <none>
 * Callees:
 *     HalpNumaCompareMemorySideCacheNodeAndLevel @ 0x140866044 (HalpNumaCompareMemorySideCacheNodeAndLevel.c)
 */
