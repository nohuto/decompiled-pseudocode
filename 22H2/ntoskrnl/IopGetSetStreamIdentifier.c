/*
 * XREFs of IopGetSetStreamIdentifier @ 0x1405064A4
 * Callers:
 *     IoAllocateSfioStreamIdentifier @ 0x140505530 (IoAllocateSfioStreamIdentifier.c)
 *     IoGetSfioStreamIdentifier @ 0x140505890 (IoGetSfioStreamIdentifier.c)
 * Callees:
