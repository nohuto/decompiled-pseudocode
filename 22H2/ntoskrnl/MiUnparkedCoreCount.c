/*
 * XREFs of MiUnparkedCoreCount @ 0x140220E8C
 * Callers:
...
__int64 __fastcall MiUnparkedCoreCount(__int64 a1, unsigned int a2)
{
  ...
  v3 = 0;
  v4 = 0;
  ExAcquireSpinLockSharedAtDpcLevel(&dword_140C66CC0);
  if ( *(_DWORD *)a1 )
  {
    v6 = *(_DWORD *)(a1 + 20);
    for ( i = 0; i < v6; ++i )
    {
      ...
      while ( 1 )
      {
        *(_QWORD *)&v15 = v9;
        ...
        if ( (WORD4(v15) >= (unsigned __int16)word_140C66CC8
           || (*(_QWORD *)(v11 + 34912) & qword_140C66CD0[WORD4(v15)]) != *(_QWORD *)(v11 + 34912))
          && ++v4 >= a2 )
        {
          i = v6 - 1;
          break;
  ...
  else if ( (_DWORD)KeNumberProcessors_0 )
  {
    do
    {
      ...
      if ( ((unsigned __int16)v14 >= (unsigned __int16)word_140C66CC8
         || (*(_QWORD *)(v13 + 34912) & qword_140C66CD0[v14]) != *(_QWORD *)(v13 + 34912))
        && ++v4 >= a2 )
      {
        break;
      }
