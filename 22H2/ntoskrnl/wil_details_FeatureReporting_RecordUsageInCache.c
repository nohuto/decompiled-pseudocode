/*
 * XREFs of wil_details_FeatureReporting_RecordUsageInCache @ 0x140252984
 * Callers:
 ...
 * Callees:
 *     wil_atomic_uint32_compare_exchange_relaxed @ 0x14032C618 (wil_atomic_uint32_compare_exchange_relaxed.c)
 *     wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x140508420 (wil_details_FeatureReporting_IncrementOpportunityInCache.c)
 *     wil_details_FeatureReporting_IncrementUsageInCache @ 0x140508514 (wil_details_FeatureReporting_IncrementUsageInCache.c)
 */
