/*
 * XREFs of PopFanUpdateSpeed @ 0x1408023F0
 * Callers:
 ...
 *     PopFanFindBucketIndex @ 0x14099731C (PopFanFindBucketIndex.c)
...
LABEL_4:
    if ( (unsigned int)dword_140C03950 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)word_140031572,
        0LL,
        0LL,
        7u,
        &v27);
...
LABEL_16:
    if ( dword_140C3C9CC != v5 )
    {
      if ( (unsigned int)dword_140C03950 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03950,
          (unsigned __int8 *)&byte_14003147F,
          0LL,
          0LL,
          5u,
          v20);
  ...
  else if ( (unsigned int)dword_140C03950 > 2 )
  {
    ...
    v23 = &v13;
    v24 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03950, (unsigned __int8 *)byte_1400313D7, 0LL, 0LL, 4u, v20);
  }
  ...
  if ( (unsigned int)dword_140C03950 > 5 )
  {
    ...
    v42 = 4LL;
    v44 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03950, (unsigned __int8 *)byte_140031431, 0LL, 0LL, 5u, &v38);
    goto LABEL_4;
  }
  return v4;
}
