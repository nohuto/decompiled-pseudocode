/*
 * XREFs of MiLogBadMapper @ 0x140630E68
 * Callers:
...
char __fastcall MiLogBadMapper(__int64 a1, int a2, EVENT_DESCRIPTOR *a3)
{
  ...
  v7 = **(_DWORD **)&qword_140C699E8 <= 5u;
  EventDescriptor_8 = 0LL;
  if ( !v7 )
  {
    LOBYTE(v3) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 128LL);
    if ( (_BYTE)v3 )
    {
      v36 = 0;
      v39 = 0;
      ...
      EventDescriptor = a2;
      v38 = 4;
      LOBYTE(v3) = tlgWriteEx_EtwWriteEx(v9, (unsigned __int8 *)&dword_14003860C, v8, 1u, v22, v23, 4u, &UserData);
    }
  }
  if ( **(_DWORD **)&qword_140C699E8 > 5u )
  {
    LOBYTE(v3) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000080LL);
    if ( (_BYTE)v3 )
    {
      v36 = 0;
      v39 = 0;
      ...
      *(_QWORD *)&EventDescriptor_8.Id = 0x50B000000LL;
      ...
      {
        v12 = 0;
        v13 = (char *)&unk_140038658;
        do
          v14 = *v13++;
        while ( v14 < 0 );
        while ( *v13++ )
          ;
        while ( v13 < &byte_1400386CF )
        {
          while ( *v13++ )
            ;
          if ( *v13 >= 0 )
