/*
 * XREFs of KeOptimizeSpecCtrlSettings @ 0x1403C7210
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiIsRfdsMitigationDesired @ 0x1403F29FC (KiIsRfdsMitigationDesired.c)
 *     KiIsRfdsMitigationSupported @ 0x1403F2A14 (KiIsRfdsMitigationSupported.c)
 *     KiIsSrsoMitigationDesired @ 0x1403F2A58 (KiIsSrsoMitigationDesired.c)
 *     KiIsSrsoMitigationSupported @ 0x1403F2B00 (KiIsSrsoMitigationSupported.c)
 ...
 *     HvlIsCoreSharingPossible @ 0x1404F1790 (HvlIsCoreSharingPossible.c)
 *     HvlIsStibpPairingRecommended @ 0x1404F17FC (HvlIsStibpPairingRecommended.c)
 *     KiAddSpecCtrlSsbdBit @ 0x14051B500 (KiAddSpecCtrlSsbdBit.c)
