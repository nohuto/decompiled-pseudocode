/*
 * XREFs of RtlApplyHotPatch @ 0x1409B2884
 * Callers:
 ...
 *     MiApplyImageHotPatchDpc @ 0x1409B0A30 (MiApplyImageHotPatchDpc.c)
 * Callees:
 ...
 *     RtlpDetermineHotPatchExtent @ 0x14091B36C (RtlpDetermineHotPatchExtent.c)
