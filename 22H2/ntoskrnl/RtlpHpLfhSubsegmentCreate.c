/*
 * XREFs of RtlpHpLfhSubsegmentCreate @ 0x1402FF000
 * Callers:
 ...
 *     RtlpHpLfhBucketComputeNewSubsegmentBlockCount @ 0x1402FF2C8 (RtlpHpLfhBucketComputeNewSubsegmentBlockCount.c)
