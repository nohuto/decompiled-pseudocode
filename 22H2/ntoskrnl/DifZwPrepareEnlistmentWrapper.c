/*
 * XREFs of DifZwPrepareEnlistmentWrapper @ 0x1405F33A0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwPrepareEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
...
LABEL_17:
  result = ZwPrepareEnlistment(EnlistmentHandle, TmVirtualClock);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
