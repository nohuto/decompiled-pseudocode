/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x14096BB54
 * Callers:
...
void PnpTraceDeviceRemovalForResetComplete()
{
  ...
  if ( dword_140C03918 && tlgKeywordOn((__int64)&dword_140C03918, 0x400000000000LL) && v1 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03918, v0) )
    {
      v8 = 0x1000000LL;
      v11 = &v8;
      v12 = 8LL;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&byte_14002CCB7,
        0LL,
        0LL,
        0xEu,
        &v10);
