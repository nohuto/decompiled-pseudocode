/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x1408B1890
 * Callers:
...
void PnpTraceDeviceRemovalForResetComplete()
{
  ...
  if ( dword_140C02DC8 && tlgKeywordOn((__int64)&dword_140C02DC8, 0x400000000000LL) && v1 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02DC8, v0) )
    {
      v12 = 0;
      v14[1] = 0;
      v17 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&word_1400257B6,
        0LL,
        0LL,
        0xDu,
        &v9);
