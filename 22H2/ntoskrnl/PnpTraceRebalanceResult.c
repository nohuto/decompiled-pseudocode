/*
 * XREFs of PnpTraceRebalanceResult @ 0x14096BFFC
 * Callers:
...
char __fastcall PnpTraceRebalanceResult(unsigned int a1, int a2, __int64 a3)
{
  ...
  {
    LOBYTE(v8) = tlgKeywordOn((__int64)&dword_140C03918, 0x400000000000LL);
    if ( (_BYTE)v8 )
    {
      v24 = 0x1000000LL;
      v28 = &v24;
      ...
      LOBYTE(v8) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)word_14002CD5A,
                     0LL,
                     0LL,
                     0x12u,
                     &v27);
