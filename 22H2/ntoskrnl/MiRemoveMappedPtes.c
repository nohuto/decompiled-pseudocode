/*
 * XREFs of MiRemoveMappedPtes @ 0x1402E65E0
 * Callers:
...
void __fastcall MiRemoveMappedPtes(__int64 a1, __int64 a2)
{
  ...
  v9 = *v6;
  v10 = *(_QWORD *)(a1 + 32) >> 12;
  v46 = *(_QWORD *)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(a2 + 174));
  v43 = (unsigned int *)v6;
  v48 = v9;
  v11 = *(_DWORD *)(v9 + 56);
  ...
  if ( (v11 & 0x400) != 0 )
    ...
    v14 = *(void **)(qword_140C674C8 + 8LL * (*(_WORD *)(v9 + 60) & 0x3FF));
  v47 = v14;
  if ( (v11 & 0x420) != 0 )
  {
    v15 = 0LL;
  ...
  do
  {
    ...
    if ( (v19 & 0x400) == 0 )
    {
      if ( (v19 & 0x800) == 0 )
      {
        ...
        {
LABEL_77:
          if ( HIBYTE(word_140C66DFC) || (v20 & 1) == 0 )
            goto LABEL_67;
LABEL_66:
