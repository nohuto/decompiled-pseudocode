/*
 * XREFs of MiCreatePfnDatabase @ 0x140A42AEC
 * Callers:
 *     MiInitNucleus @ 0x140A42364 (MiInitNucleus.c)
 * Callees:
 *     MiGetPartitionLargePageListCount @ 0x1403F6118 (MiGetPartitionLargePageListCount.c)
 ...
 *     MiInitializeColors @ 0x140A44524 (MiInitializeColors.c)
 */
