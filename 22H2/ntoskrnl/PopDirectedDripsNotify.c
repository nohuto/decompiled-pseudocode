/*
 * XREFs of PopDirectedDripsNotify @ 0x14078DA18
 * Callers:
 ...
 *     PopDirectedDripsEngage @ 0x1405687F4 (PopDirectedDripsEngage.c)
 ...
 *     PopDirectedDripsSendSessionData @ 0x1408E39B4 (PopDirectedDripsSendSessionData.c)
  ...
  if ( a1 <= 5 )
  {
    ...
    else
    {
      ...
      if ( !v12 )
      {
        v15 = *(_QWORD *)a2;
        ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_140C24D28, 0LL);
        *(_DWORD *)(v15 + 200) = dword_140C24D1C;
        qword_140C24EB0 = 0LL;
        if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C24D28, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
          ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C24D28);
        KeAbPostRelease((ULONG_PTR)&qword_140C24D28);
...
LABEL_23:
    ...
    v16 = v6 | 0x1000;
    ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_140C24D28, 0LL);
    if ( qword_140C24EB0 == *(_QWORD *)a2 )
    {
      if ( dword_140C24EB8 )
      {
        _m_prefetchw(&PopDirectedDripsState);
        v17 = v16 | PopDirectedDripsState.HandleAttributes;
        if ( (v16 & _InterlockedOr((volatile signed __int32 *)&PopDirectedDripsState, v16)) != v16 || dword_140C24CD4 )
          PopQueueDirectedDripsWork(v17, 0x800uLL);
      }
    }
    v11 = (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C24D28, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2;
    goto LABEL_37;
  }
...
LABEL_11:
        v10 = _InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C24D28, 0xFFFFFFFFFFFFFFFFuLL);
        if ( (v10 & 2) == 0 )
        {
LABEL_12:
          LOBYTE(HandleAttributes) = KeAbPostRelease((ULONG_PTR)&qword_140C24D28);
          return HandleAttributes;
        }
        v11 = (v10 & 4) == 0;
LABEL_37:
    ...
    else
    {
      ...
      if ( (HandleAttributes & 0x800) != 0 )
        LOBYTE(HandleAttributes) = PopDirectedDripsNotifyAppsAndServices(&PopDirectedDripsState, &dword_140C24CD8, 0LL);
    }
  }
  else
  {
