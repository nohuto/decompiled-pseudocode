/*
 * XREFs of HalpIommuInitSystem @ 0x14099EB40
 * Callers:
 *     <none>
 * Callees:
 *     HalpIommuGetRootIommuFaultPolicy @ 0x14032D2FC (HalpIommuGetRootIommuFaultPolicy.c)
 ...
 *     HalpInterruptSetX2ApicPolicy @ 0x1404BC828 (HalpInterruptSetX2ApicPolicy.c)
...
__int64 __fastcall HalpIommuInitSystem(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( !a1 || HalIommuDispatch && (*(unsigned __int8 (**)(void))HalIommuDispatch)() )
  {
    ...
    if ( !a1 )
    {
      qword_140C49E38 = (__int64)&HalpIommuList;
      HalpIommuList = (__int64)&HalpIommuList;
      qword_140C49E18 = (__int64)&HalpIommuExceptionList;
