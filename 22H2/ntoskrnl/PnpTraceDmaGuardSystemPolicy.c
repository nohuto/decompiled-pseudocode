/*
 * XREFs of PnpTraceDmaGuardSystemPolicy @ 0x1408644B8
 * Callers:
...
void PnpTraceDmaGuardSystemPolicy()
{
  ...
  if ( (unsigned int)dword_140C03918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03918, 0x400000000000LL) )
    {
      ...
      v1 = 2048LL;
      v4 = 8;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03918, (unsigned __int8 *)byte_14002CC00, 0LL, 0LL, 4u, &v2);
    }
  }
}
