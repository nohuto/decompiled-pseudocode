/*
 * XREFs of ExAllocateHeapPool @ 0x1402BC8A0
 * Callers:
...
LABEL_201:
      ...
      if ( v9 <= 0xFE0 )
      {
        ...
        if ( (v12 & 4) != 0 )
        {
          v18 += *(unsigned int *)((char *)&Mm64BitPhysicalAddress + 3);
          if ( v18 > 0xFE0 )
          {
            v18 -= *(unsigned int *)((char *)&Mm64BitPhysicalAddress + 3);
        ...
        if ( !Internal )
        {
          ...
          if ( v84 )
          {
            v86 = RtlpHpVsContextMultiAlloc((int)v17 + 640, v19, v84 + 1, v13, (__int64)&v125, (__int64)&ListEnd);
            if ( v86 )
            {
...
LABEL_128:
                  ...
                  else
                  {
                    ...
                    Internal = RtlpHpVsContextAllocateInternal(
                                 ...
                                 (__int64)&v123);
                    if ( v123 && (v22 & 1) == 0 )
                      RtlpHpReleaseQueuedLockExclusive(*(_DWORD *)(v17 + 648), (__int64)&v132);
                  }
                }
                if ( !Internal )
                  goto LABEL_181;
                    ...
                    *(_BYTE *)(v106 + 2) ^= (*(_BYTE *)(v106 + 2) ^ v113) & 0xF;
                    if ( (_WORD)v113 != 1
                      || (int)((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))RtlpInterceptorRoutines)(
                                ...
                                v106 + 16) < 0 )
                    {
                      RtlpHpFreeHeap(v17, Internal, v22);
                      goto LABEL_181;
                    }
                  }
                }
...
LABEL_65:
                  ...
                  {
                    *(_BYTE *)(Internal + 3) &= ~4u;
                    v54 = (*(_DWORD *)((char *)&Mm64BitPhysicalAddress + 3) - 1) & (-16 - Internal);
                    if ( v54 )
                    {
                      v55 = Internal + v54;
                      v56 = (__int64)v54 >> 4;
...
LABEL_112:
      ...
      else
      {
        ...
        if ( v122 && (v62 & 1) == 0 )
        {
          RtlpHpReleaseQueuedLockExclusive(*(_DWORD *)(v17 + 648), (__int64)&v130);
          v67 = v111;
        }
      }
      goto LABEL_112;
