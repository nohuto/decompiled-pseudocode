/*
 * XREFs of PopPepPlatformStateRegistered @ 0x1405753FC
 * Callers:
...
LABEL_14:
    ...
    while ( 1 )
    {
      ...
      if ( v8 )
        goto LABEL_36;
      v18 = (unsigned __int64)&v15->LockEntries[v19];
      v17 &= ~(1 << v19);
      if ( (*(_BYTE *)(v18 + 26) & 1) != 0
        && (*(_DWORD *)(v18 + 32) & 1) == 0
...
LABEL_36:
    ...
    *(_DWORD *)(v18 + 88) = v21;
    *(_QWORD *)(v18 + 32) = 0LL;
    v22 = (__int64)(v18 - (unsigned __int64)v15->LockEntries) / 96;
    if ( v16 == 1 )
...
LABEL_43:
    ...
    if ( v8 && ($C459BD0D405E8E46662177FB3D0A143F *)v15->ApcState.ApcListHead[0].Flink != &v15->152 )
  ...
  else
  {
    ...
    while ( 1 )
    {
      v31 = (unsigned __int64)&v25->LockEntries[v30];
      v29 &= ~(1 << v30);
      if ( (*(_BYTE *)(v31 + 26) & 1) != 0
        && (*(_DWORD *)(v31 + 32) & 1) == 0
...
LABEL_60:
    ...
    else
    {
      ...
      *(_DWORD *)(v31 + 88) = v33;
      *(_QWORD *)(v31 + 32) = 0LL;
      v34 = 1 << ((__int64)(v31 - (unsigned __int64)v25->LockEntries) / 96);
      if ( v28 == 1 )
    ...
    if ( v8 && ($C459BD0D405E8E46662177FB3D0A143F *)v25->ApcState.ApcListHead[0].Flink != &v25->152 )
    ...
    while ( 1 )
    {
      ...
      if ( v8 )
        goto LABEL_99;
      v49 = (unsigned __int64)&v46->LockEntries[v50];
      v48 &= ~(1 << v50);
      if ( (*(_BYTE *)(v49 + 26) & 1) != 0
        && (*(_DWORD *)(v49 + 32) & 1) == 0
...
LABEL_99:
    ...
    *(_DWORD *)(v49 + 88) = v52;
    *(_QWORD *)(v49 + 32) = 0LL;
    v53 = (__int64)(v49 - (unsigned __int64)v46->LockEntries) / 96;
    if ( v47 == 1 )
