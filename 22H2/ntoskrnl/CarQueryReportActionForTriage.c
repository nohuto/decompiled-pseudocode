/*
 * XREFs of CarQueryReportActionForTriage @ 0x1405D3FF0
 * Callers:
 *     CarQueryReportAction @ 0x1405D3FC0 (CarQueryReportAction.c)
 ...
 * Callees:
 *     CarFindRuleOverrideEntryByGlobalRuleId @ 0x1405D3D4C (CarFindRuleOverrideEntryByGlobalRuleId.c)
 *     CarOverrideReportAction @ 0x1405D3FA0 (CarOverrideReportAction.c)
 */
...
__int64 __fastcall CarQueryReportActionForTriage(int a1, unsigned int a2, _DWORD *a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      v5 = CarTriageContext;
      *(_QWORD *)a3 = qword_140046E20[CarTriageContext];
