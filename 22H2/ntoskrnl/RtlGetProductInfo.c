        ...
        PULONG ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  ...
  if ( (int)CompareVersions(v16, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_140003E90, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_140003E80, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
