/*
 * XREFs of Feature_1697191224__private_IsEnabledFallback @ 0x1404122C0
 * Callers:
...
__int64 __fastcall Feature_1697191224__private_IsEnabledFallback(__int64 a1, unsigned int a2)
{
