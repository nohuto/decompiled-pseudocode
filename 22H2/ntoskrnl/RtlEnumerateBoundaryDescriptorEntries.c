/*
 * XREFs of RtlEnumerateBoundaryDescriptorEntries @ 0x1406EC41C
 * Callers:
 *     ObpCompareEntryLevel1 @ 0x1406EBB90 (ObpCompareEntryLevel1.c)
 ...
 *     ObpCheckDuplicateEntries @ 0x140718DE4 (ObpCheckDuplicateEntries.c)
