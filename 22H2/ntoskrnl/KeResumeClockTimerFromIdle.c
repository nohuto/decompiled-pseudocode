/*
 * XREFs of KeResumeClockTimerFromIdle @ 0x140224BA0
 * Callers:
 ...
 *     KiGetPendingTick @ 0x140315B90 (KiGetPendingTick.c)
 ...
 *     ExRecordOneTimerExpiry @ 0x1405B6670 (ExRecordOneTimerExpiry.c)
 */
...
void __fastcall KeResumeClockTimerFromIdle(_DWORD *a1)
{
  ...
  KiClockLatencyMeasurementEnabled = 0;
  if ( v9 - KiClockTimerOneShotStartTime < qword_140C31688 )
    qword_140C31688 = v9 - KiClockTimerOneShotStartTime;
  if ( v9 - KiClockTimerOneShotStartTime > qword_140C31680 )
    qword_140C31680 = v9 - KiClockTimerOneShotStartTime;
