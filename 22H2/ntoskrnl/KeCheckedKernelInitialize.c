/*
 * XREFs of KeCheckedKernelInitialize @ 0x140B18B50
 * Callers:
 ...
 *     sub_140B35828 @ 0x140B35828 (sub_140B35828.c)
  ...
  if ( result >= 0 && !*(_QWORD *)&MaxDataSize )
  {
    ...
    if ( result )
    {
      ...
      if ( result )
      {
        ...
        v9 = v5;
        v10 = 0;
        result = KeExpandKernelStackAndCallout(sub_140B35090, Parameter, 0xC000uLL);
        if ( v6 >= 0 )
