/*
 * XREFs of SepSecureBootFindMatchingRegistryRule @ 0x1409D0C40
 * Callers:
 *     SeQuerySecureBootPolicyValue @ 0x140866060 (SeQuerySecureBootPolicyValue.c)
 * Callees:
 *     SepEqualAsciiWideStringCaseInSensitive @ 0x1409D0990 (SepEqualAsciiWideStringCaseInSensitive.c)
 */
...
_DWORD *__fastcall SepSecureBootFindMatchingRegistryRule(__int64 a1, unsigned __int16 *a2, unsigned __int16 *a3)
{
  ...
  v3 = (_DWORD *)qword_140D1BF98;
  v10 = 0LL;
  v6 = qword_140D1BF98 + 16LL * *((unsigned __int16 *)qword_140D17F28 + 19);
  while ( 1 )
  {
    ...
    if ( *v3 == -2130706432 )
    {
      v7 = (_WORD *)(qword_140D1BF90 + (unsigned int)v3[1]);
      *((_QWORD *)&v10 + 1) = v7 + 1;
      LOWORD(v10) = *v7;
      WORD1(v10) = v10 + 2;
      if ( SepEqualAsciiWideStringCaseInSensitive(a2, (unsigned __int16 *)&v10) )
      {
        v8 = (_WORD *)(qword_140D1BF90 + (unsigned int)v3[2]);
        *((_QWORD *)&v10 + 1) = v8 + 1;
        LOWORD(v10) = *v8;
        WORD1(v10) = v10 + 2;
