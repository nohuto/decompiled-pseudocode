/*
 * XREFs of DifZwWriteFileWrapper @ 0x1405F84F0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwWriteFileWrapper(
        HANDLE FileHandle,
        HANDLE Event,
        ...
        PULONG Key)
{
  ...
  APIThunkContextById = DifGetAPIThunkContextById(658);
...
LABEL_17:
  result = ZwWriteFile(FileHandle, Event, ApcRoutine, ApcContext, IoStatusBlock, Buffer, Length, ByteOffset, Key);
