/*
 * XREFs of MiMarkHotPatchesForHiberPhase @ 0x1406428A0
 * Callers:
...
__int64 __fastcall MiMarkHotPatchesForHiberPhase(__int64 a1)
{
  ...
  if ( qword_140C69970 == v1 )
    return MiMarkNonPagedHiberPhasePages(
             *(_QWORD *)(qword_140C69968 + 48),
             v2 + *(_QWORD *)(qword_140C69968 + 48) + *(unsigned int *)(qword_140C69968 + 64) - 1LL,
             0LL);
  return result;
}
