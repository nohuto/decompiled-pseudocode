/*
 * XREFs of PopHiberCheckResume @ 0x140AA2F60
 * Callers:
 *     PopSaveHiberContextWrapper @ 0x140428590 (PopSaveHiberContextWrapper.c)
 * Callees:
 *     __security_check_cookie @ 0x1403D7680 (__security_check_cookie.c)
 *     _guard_dispatch_icall @ 0x140429560 (_guard_dispatch_icall.c)
 *     memset @ 0x140435400 (memset.c)
 *     HalInitializeOnResume @ 0x1405066F0 (HalInitializeOnResume.c)
...
char PopHiberCheckResume()
{
  ...
  if ( *(_DWORD *)v2 )
  {
    ...
    v9 = &qword_140C3D398;
    v10 = 4LL;
    qword_140C31AF8 = *(_QWORD *)(v2 + 1008);
    v11 = (_OWORD *)(v2 + 136);
    do
    {
      *(_OWORD *)v9 = *v11;
