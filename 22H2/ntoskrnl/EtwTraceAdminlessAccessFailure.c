/*
 * XREFs of EtwTraceAdminlessAccessFailure @ 0x14093FC88
 * Callers:
...
char __fastcall EtwTraceAdminlessAccessFailure(int a1, __int64 a2, __int64 a3, char a4)
{
  ...
  if ( !(_DWORD)a3 )
  {
    if ( a4 )
    {
      ...
      v19 = v12;
      v47 = &v19;
      v10 = (unsigned __int8 *)byte_14002D999;
      v48 = 4LL;
      v49 = v52;
      v51 = *((_QWORD *)v5 + 1);
      v52[0] = *v5;
    ...
    else
    {
      ...
      v17 = v9;
      v38 = &v17;
      v10 = (unsigned __int8 *)&word_14002D94E;
      v39 = 4LL;
      v40 = v43;
      v42 = *((_QWORD *)v5 + 1);
      v43[0] = *v5;
    ...
    LOBYTE(v7) = tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BF0, v10, 0LL, 0LL, 6u, v11);
    goto LABEL_15;
  }
  if ( (unsigned int)dword_140C02BF0 > 5 )
  {
    ...
    if ( (_BYTE)v7 )
    {
      ...
      LOBYTE(v7) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)word_14002D8E2,
                     0LL,
                     0LL,
                     7u,
                     &v26);
