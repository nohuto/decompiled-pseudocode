/*
 * XREFs of KiDeferredReadySingleThread @ 0x1402C4550
 * Callers:
 ...
 *     KiHvEnlightenedGuestPriorityKick @ 0x14022F800 (KiHvEnlightenedGuestPriorityKick.c)
 ...
 *     KiGetThreadScb @ 0x140259B60 (KiGetThreadScb.c)
 ...
 *     KiIsThreadRankBiased @ 0x1405237DC (KiIsThreadRankBiased.c)
 *     EtwTraceIdealProcessor @ 0x1405A7784 (EtwTraceIdealProcessor.c)
 */

__int64 __fastcall KiDeferredReadySingleThread(__int64 a1, ULONG_PTR a2, __int64 p_AbPropagateBoostsList, __int64 a4)
{
  ...
  __int64 v135; // r9
  __int64 v136; // r8
  char v137; // [rsp+30h] [rbp-1B8h] BYREF
...
LABEL_219:
  ...
  if ( v102 != v104 )
  {
    ...
    v106 = *(_BYTE *)(v105 + 824);
    if ( v106 == -1 )
      KeBugCheckEx(0x157u, a2, (char)v102, 1uLL, 0LL);
    *(_BYTE *)(v105 + 824) = v106 + 1;
    *(_DWORD *)(a2 + 856) |= 1 << v102;
    if ( v104 != 32 )
    {
      v107 = (char)v104 + a2;
      v108 = *(_BYTE *)(v107 + 824);
      if ( !v108 )
        KeBugCheckEx(0x157u, a2, (char)v104, 2uLL, 0LL);
      v109 = v108 - 1;
      *(_BYTE *)(v107 + 824) = v109;
      if ( !v109 )
        *(_DWORD *)(a2 + 856) ^= 1 << v104;
    }
    *(_DWORD *)(a2 + 1024) = v102;
  }
  v110 = v103;
  if ( v103 == 32 )
    v110 = v102;
  v111 = KiComputePriorityFloor(a2, v110);
  v112 = *(char *)(a2 + 195);
  v113 = v111;
  ...
  {
LABEL_243:
    KiSetBasePriorityAndClearDecrement(a2, 0LL, 0LL);
    KiUpdateThreadPriority(0LL, a2, (_SINGLE_LIST_ENTRY *)v113, 0);
  }
LABEL_244:
  if ( (*(_DWORD *)(a2 + 120) & 0x400000) != 0 )
...
LABEL_7:
  ...
  if ( *(char *)(a2 + 195) < 16 )
  {
    ...
    if ( v12 >= 4u || *(char *)(a2 + 563) >= 14 || v13 >= 2 && !*(_BYTE *)(a2 + 564) )
    {
      ...
      if ( v48 < 16 )
      {
        if ( KiForegrounBoostVelocityFlag
          ...
          && (p_AbPropagateBoostsList = *(unsigned __int8 *)(a2 + 564),
              v114 = p_AbPropagateBoostsList & 0xF,
              (p_AbPropagateBoostsList & 0xF) != 0 && (*(_DWORD *)(a2 + 120) & 8) == 0) )
        {
          v115 = v114 + *(_BYTE *)(a2 + 563);
          *(_BYTE *)(a2 + 564) = v114;
      ...
      if ( !v10 )
      {
        ...
        *(_BYTE *)(a2 + 195) = v48;
        if ( !v5 )
        {
          ...
          KiSetSchedulerAssistPriority(*(_QWORD *)(a2 + 968), (unsigned int)v48, p_AbPropagateBoostsList);
        }
      }
    }
    ...
    {
      v14 = (_SINGLE_LIST_ENTRY *)(unsigned int)*(char *)(a2 + 195);
      if ( *(char *)(a2 + 195) > 0 )
      {
        v15 = *(_BYTE *)(a2 + 564);
        if ( !v15 )
...
LABEL_19:
          ...
          if ( v18 > (int)v14 )
          {
            ...
            if ( v18 > v17 + v7 )
              v72 = v18 - v17 - v7;
            *(_BYTE *)(a2 + 564) = v15 ^ (v72 ^ v15) & 0xF;
            v73 = KeGetCurrentPrcb();
            if ( (char)v18 > (char)v14 )
            {
              if ( *(_BYTE *)(a2 + 793) )
              {
                v93 = (struct _SINGLE_LIST_ENTRY *)(a2 + 808);
                if ( *(_QWORD *)(a2 + 808) == 1LL )
                {
  ...
  if ( v54 > 0 )
  {
    ...
    if ( v54 < v55 && v54 < 13 )
    {
      ...
      if ( (v56 & 8) == 0 )
      {
        ...
        if ( v55 < 13 )
          v57 = *(_BYTE *)(a2 + 567);
        *(_BYTE *)(a2 + 564) += 16 * (v57 - v54);
        v59 = KeGetCurrentPrcb();
        if ( v57 > v54 )
        {
          if ( *(_BYTE *)(a2 + 793) )
          {
            v118 = (struct _SINGLE_LIST_ENTRY *)(a2 + 808);
            if ( *(_QWORD *)(a2 + 808) == 1LL )
            {
        ...
        *(_BYTE *)(a2 + 195) = v57;
        ...
        {
          LOBYTE(v56) = 1;
          KiSetSchedulerAssistPriority(*(_QWORD *)(a2 + 968), (unsigned int)v57, v56);
        }
        v60 = *(_QWORD *)(a2 + 32);
...
LABEL_34:
    if ( ((v25 - 1) & v25) != 0 )
    {
      if ( *(_BYTE *)(a2 + 125) )
      {
        v27 = KiHeteroChooseTargetProcessor(v141, a2, &v144, &v140);
      }
      else
      {
        v26 = v141;
        if ( KiPerfIsoEnabled && (unsigned __int8)KiIsThreadRankBiased(a2, v141, 0x140000000uLL) && !v21 )
          v22 = 1;
        v27 = KiChooseTargetProcessor(v26, a2, (unsigned int)&v144, (unsigned int)&v140, v22);
      }
    }
    else
    {
...
LABEL_65:
        ...
        v136 = v138;
        v135 = v38;
        return EtwTraceIdealProcessor(a2, 1350LL, v136, v135);
      }
LABEL_286:
      LODWORD(v131) = (unsigned __int8)byte_140D006C1[2 * v131] | ((unsigned __int8)HvlpVirtualProcessorMapping[2 * v131] << 6);
      goto LABEL_287;
    }
    if ( v22 )
      goto LABEL_141;
      ...
      else
      {
        ...
        if ( !v5 && (unsigned __int8)KiTryToAcquireThreadLock(v62, v139) )
        {
          if ( (*(_DWORD *)(v62 + 120) & 0x400000) != 0 )
            KiUpdateVPBackingThreadPriority(v62, v27, 0);
          KiReleaseThreadLockSafe(v62);
        }
      }
      if ( !KiGroupSchedulingEnabled )
      {
        if ( *(_BYTE *)(a2 + 195) > *(_BYTE *)(v62 + 195) )
        {
LABEL_105:
          if ( *(_BYTE *)(v62 + 388) == 2 )
            *(_BYTE *)(v62 + 565) = 1;
          ...
          if ( v23 )
            v63 = 6;
          if ( (*(_BYTE *)(a2 + 2) & 4) == 0 || (v84 = KiIsThreadRankNonZero(a2, (struct _KPRCB *)v27), v64 = 1, !v84) )
            v64 = *(_BYTE *)(a2 + 195);
          **(_BYTE **)(v27 + 56) = v64;
          if ( *(_QWORD *)(v27 + 33976) )
          {
          ...
          *(_QWORD *)(v27 + 16) = a2;
          ...
          if ( v65 )
            *(_BYTE *)(v65 + 16) = a2 == *(_QWORD *)(v27 + 24);
          if ( *(_BYTE *)(a2 + 388) == 1 || (v63 & 4) != 0 )
            *(_DWORD *)(a2 + 132) = *(_DWORD *)(a2 + 132) - *(_DWORD *)(a2 + 436) + MEMORY[0xFFFFF78000000320];
          *(_BYTE *)(a2 + 388) = 3;
          _InterlockedAnd64((volatile signed __int64 *)(v27 + 48), 0LL);
          ...
          *(_QWORD *)(a2 + 64) = 0LL;
          ...
          v154 = 0LL;
          DWORD2(v153) = v29;
          HalpInterruptSendIpi(&v153, 0x2Fu);
          result = (unsigned int)KiVelocityFlags;
          if ( (KiVelocityFlags & 2) == 0 )
            goto LABEL_65;
          result = *(_QWORD *)(v27 + 33976);
      ...
      if ( KiEvaluateGroupSchedulingPreemption((struct _KPRCB *)v27, (_KTHREAD *)v62, a2, &v143) )
        goto LABEL_105;
      goto LABEL_160;
    }
    ...
    if ( KiGroupSchedulingEnabled )
    {
      if ( !KiEvaluateGroupSchedulingPreemption((struct _KPRCB *)v27, v61, a2, &v143) )
      {
LABEL_160:
        ThreadScb = v143;
LABEL_141:
    ...
    else if ( *(_BYTE *)(a2 + 195) <= v61->Priority )
    {
      goto LABEL_141;
    }
    v61->Preempted = 1;
    ...
    if ( v23 )
      v88 = 6;
    if ( (*(_BYTE *)(a2 + 2) & 4) == 0 || (v97 = KiIsThreadRankNonZero(a2, (struct _KPRCB *)v27), v89 = 1, !v97) )
      v89 = *(_BYTE *)(a2 + 195);
    **(_BYTE **)(v27 + 56) = v89;
    if ( *(_QWORD *)(v27 + 33976) )
    {
    ...
    *(_QWORD *)(v27 + 16) = a2;
    ...
    if ( v90 )
      *(_BYTE *)(v90 + 16) = a2 == *(_QWORD *)(v27 + 24);
    if ( *(_BYTE *)(a2 + 388) == 1 || (v88 & 4) != 0 )
      *(_DWORD *)(a2 + 132) = *(_DWORD *)(a2 + 132) - *(_DWORD *)(a2 + 436) + MEMORY[0xFFFFF78000000320];
    v91 = v152;
    *(_BYTE *)(a2 + 388) = 3;
  ...
  if ( !(unsigned int)KiPrcbInGroupAffinity(v27, &v144) )
  {
    ...
    v147 = v123;
    v120 = *(unsigned int *)(v122 + 4LL * ((unsigned int)v123 + (WORD4(v144) << 6)) + 13640912);
    v27 = *(_QWORD *)(v122 + 8 * v120 + 13622464);
  }
...
LABEL_142:
  ...
  *(_BYTE *)(a2 + 388) = 1;
  v137 = 0;
  if ( v74 && (*(_DWORD *)(a2 + 120) & 0xC00) == 0 )
  {
    if ( (unsigned int)KiGetThreadEffectiveRankNonZero(a2, v74, v28, 0, (bool *)&v137) )
    {
      KiAddThreadToScbQueue(v27, v87, a2, v142);
      goto LABEL_151;
    }
    v76 = v137;
  }
  KiAddThreadToPrcbQueue(v27, a2, *(char *)(a2 + 195), v142, v76);
LABEL_151:
  _InterlockedAnd64((volatile signed __int64 *)(v27 + 48), 0LL);
  result = KiSetVpThreadSpinLockCount(KeGetCurrentPrcb(), 0LL);
  v77 = *(_DWORD *)(a2 + 588);
