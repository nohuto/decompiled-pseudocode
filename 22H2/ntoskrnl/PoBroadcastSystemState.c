/*
 * XREFs of PoBroadcastSystemState @ 0x140992AC4
 * Callers:
 ...
 *     PopSetupSleepNotifies @ 0x140995250 (PopSetupSleepNotifies.c)
 *     PopHandleWakeSources @ 0x140998400 (PopHandleWakeSources.c)
 *     PopBootLoaderSiData @ 0x140998F24 (PopBootLoaderSiData.c)
...
__int64 __fastcall PoBroadcastSystemState(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = (char *)qword_140C23A30;
  v29 = *(_BYTE *)(a1 + 25);
  v4 = v29;
  *(_BYTE *)qword_140C23A30 = *(_BYTE *)(a1 + 26);
...
LABEL_37:
    ...
    v15 = *(_DWORD *)(a1 + 16);
    if ( v15 == 4 && (PopShutdownPowerOffPolicy || *(_QWORD *)&qword_140C23A70) )
    {
      v16 = 4LL;
    }
    else
    ...
    *((_DWORD *)v6 + 1) = 1;
    ...
    do
    {
      ...
      if ( v22 == 1 && *(_BYTE *)(a1 + 26) == 2 && !v11 )
      {
        ...
        {
          if ( qword_140C23A80 && *(_QWORD *)(qword_140C23A80 + 216) )
            PopBootLoaderSiData();
          PopUpdateSmbiosData(
            *(_BYTE *)(*(_QWORD *)(qword_140C23A80 + 200) + 980LL),
            *(_BYTE *)(*(_QWORD *)(qword_140C23A80 + 200) + 981LL),
            *(_DWORD *)(*(_QWORD *)(qword_140C23A80 + 200) + 976LL),
            *(_QWORD *)(*(_QWORD *)(qword_140C23A80 + 200) + 968LL));
        }
        if ( dword_140C23A68 == 5 )
