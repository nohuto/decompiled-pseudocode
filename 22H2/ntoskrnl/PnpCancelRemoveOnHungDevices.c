/*
 * XREFs of PnpCancelRemoveOnHungDevices @ 0x1408A22D0
 * Callers:
...
__int64 __fastcall PnpCancelRemoveOnHungDevices(__int64 a1, unsigned int a2, char a3, unsigned int **a4, _QWORD *a5)
{
  int v8; // ebx
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( RelationList )
    {
      ...
      *((_BYTE *)RelationList + 8) = 1;
      ...
      v16 = PnpCompileDeviceInstancePaths(a2, (__int64)RelationList, 0, (char)v13, P);
      v17 = P[0];
      v8 = v16;
      if ( v16 >= 0 )
