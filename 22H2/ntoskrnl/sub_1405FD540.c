...
__int64 __fastcall sub_1405FD540(__int64 a1, void *a2, unsigned int a3, __int64 a4)
{
...
LABEL_128:
      ...
      if ( Size_4 >= v62 && v45 >= 0 )
      {
        ...
        {
          v72 = KeWaitForSingleObject(&Mutex, UserRequest, 1, 0, &Timeout);
