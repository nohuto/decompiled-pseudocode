 ...
 *     MmGetPagedPoolCommitPointer @ 0x14032D328 (MmGetPagedPoolCommitPointer.c)
  ...
  else
  {
    ...
    if ( !KdpDebuggerDataListHead )
    {
      *((_QWORD *)&KdpContext + 1) = KdDebugDevice;
      ...
      qword_140C40898 = (__int64)&KdpPowerListHead;
      KdpPowerListHead = (__int64)&KdpPowerListHead;
      qword_140C408A8 = (__int64)&KdpDebuggerDataListHead;
      ...
      *((_QWORD *)&xmmword_140C0F410 + 1) = &PsLoadedModuleList;
      *(_WORD *)((char *)&KdVersionBlock + 11) = 13059;
      qword_140C0F420 = (__int64)&KdpDebuggerDataListHead;
    }
    ...
    {
      v13 = 1;
      *(_QWORD *)&xmmword_140C0F410 = PsNtosImageBase;
    }
    qword_140C00B38 = xmmword_140C0F410;
    if ( !v8 )
    {
