/*
 * XREFs of HalpPciGetHpetInterruptSource @ 0x140B93B50
 * Callers:
 *     HalpTimerRegister @ 0x140379104 (HalpTimerRegister.c)
 * Callees:
 *     HalSocGetAcpiTable @ 0x1403A447C (HalSocGetAcpiTable.c)
 *     HalpPciGetHpetInterruptSourceAmd @ 0x140B93C1C (HalpPciGetHpetInterruptSourceAmd.c)
 *     HalpPciGetHpetInterruptSourceIntel @ 0x140B93D08 (HalpPciGetHpetInterruptSourceIntel.c)
 */
