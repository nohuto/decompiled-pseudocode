/*
 * XREFs of EtwpLogKernelEvent @ 0x1402D0790
 * Callers:
 ...
 *     EtwpSystemImageEnumCallback @ 0x1407B8D10 (EtwpSystemImageEnumCallback.c)
  ...
  if ( v14 )
  {
    ...
    if ( (a6 & 0x100) != 0 )
    {
      ...
      else
      {
        ...
        v47 = EtwpReserveTraceBuffer(v14, v15 + 32, (unsigned int)&v59, (unsigned int)&v55, a6);
        if ( !v47 )
          goto LABEL_34;
        v34 = v56;
