/*
 * XREFs of EtwpSendDataBlock @ 0x1407178F4
 * Callers:
...
__int64 __fastcall EtwpSendDataBlock(__int64 a1, __int64 a2)
{
  ...
  if ( (v2 & 1) != 0 )
  {
    ...
    if ( *(_QWORD *)(a1 + 88) )
    {
      ...
      {
        SessionById = (_KPROCESS *)MmGetSessionById(*(unsigned int *)(a1 + 56), v9);
        v6 = (struct _DMA_ADAPTER *)SessionById;
        if ( !SessionById )
          return (unsigned int)-1073741275;
        v7 = MmAttachSession(SessionById, (__int64)v40);
        if ( v7 < 0 )
        {
          HalPutDmaAdapter(v6);
...
LABEL_10:
        ...
        && tlgKeywordOn((__int64)&dword_140C02BF0, 0x200000000800LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_14002D891,
          0LL,
          0LL,
          5u,
          &v41);
