/*
 * XREFs of HalpParseCommonBufferExtendedConfigurations @ 0x14050FF7C
 * Callers:
 *     HalpCreateCommonBufferFromMdlVerifyParams @ 0x14050FE34 (HalpCreateCommonBufferFromMdlVerifyParams.c)
 * Callees:
 *     <none>
 */
