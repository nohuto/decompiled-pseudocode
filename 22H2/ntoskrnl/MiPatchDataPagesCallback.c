/*
 * XREFs of MiPatchDataPagesCallback @ 0x140A3A7A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlAreBitsSetEx @ 0x140463680 (RtlAreBitsSetEx.c)
 */
  ...
  *a6 = 0;
  ...
  if ( RtlAreBitsSetEx((unsigned __int64 *)(a1 + 48), a2 >> 12, (unsigned int)v9) )
  {
    *a6 = 1;
    ...
    {
      MiSetImageProtection(*(_QWORD *)a1, *(_QWORD *)(*(_QWORD *)a1 + 48LL) + (v7 << 12), (_DWORD)v9 << 12, 4u);
