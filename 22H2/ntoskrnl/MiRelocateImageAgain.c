/*
 * XREFs of MiRelocateImageAgain @ 0x1406AA700
 * Callers:
...
__int64 __fastcall MiRelocateImageAgain(__int64 a1, int a2)
{
  ...
  {
    v10 = *(_QWORD *)(v6 + 32);
    v7 = (__int64 *)MiReservePtes((__int64)&qword_140C69A40, 1u);
    if ( !v7 )
    {
...
LABEL_13:
        ...
        if ( qword_140C37A40 )
        {
          updated = qword_140C37A40(*(_QWORD *)(v2 + 40) & 0xFFFFFFFFFFFFFFF8uLL);
          if ( updated >= 0 )
            goto LABEL_13;
        }
        else
...
LABEL_3:
  ...
  if ( v7 )
    MiReleasePtes((__int64)&qword_140C69A40, v7, 1u);
