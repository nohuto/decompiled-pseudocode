/*
 * XREFs of EmpRuleUpdateWorkerThread @ 0x1403C5E80
 * Callers:
 *     <none>
 * Callees:
...
char EmpRuleUpdateWorkerThread()
{
  ...
  __int64 v33; // rdx
  $C459BD0D405E8E46662177FB3D0A143F *v34; // rax
  __int64 v35; // rcx
...
LABEL_36:
    ...
    if ( v7 && ($C459BD0D405E8E46662177FB3D0A143F *)v15->ApcState.ApcListHead[0].Flink != &v15->152 )
