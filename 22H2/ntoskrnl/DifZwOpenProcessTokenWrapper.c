/*
 * XREFs of DifZwOpenProcessTokenWrapper @ 0x1405F2220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwOpenProcessTokenWrapper(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(566);
...
LABEL_17:
  result = ZwOpenProcessToken(a1, a2);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
