/*
 * XREFs of EtwpCoverageEnsureContext @ 0x1407C9F5C
 * Callers:
            ...
            if ( v9 >= 0 )
            {
              ...
              *(_DWORD *)(v14 + 16) = 4 * *(_DWORD *)(v14 + 4) + 52;
              ...
              if ( EtwpCoverageCoreTracingEnabled && (unsigned int)dword_140C0EFDC < MEMORY[0xFFFFF7800000037C] )
              {
                ...
                {
                  v25 = 0;
                  dword_140C0EFD8 = TelemetryCoverageStringHashInternal(off_140C0EFD0, &v25);
                }
                EtwTelemetryCoverageReport((__int64 *)&off_140C0EFD0);
              }
              v9 = 0;
            }
          }
