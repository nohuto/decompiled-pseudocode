/*
 * XREFs of EtwpCoverageEnsureContext @ 0x1408579E4
 * Callers:
...
LABEL_43:
  ...
  *(_DWORD *)(v15 + 16) = 4 * *(_DWORD *)(v15 + 4) + 52;
  ...
  if ( (unsigned int)dword_140C06704 < MEMORY[0xFFFFF7800000037C] )
  {
    if ( !dword_140C06700 )
    {
      v24 = 0;
      dword_140C06700 = TelemetryCoverageStringHashInternal(off_140C066F8, &v24);
    }
    EtwTelemetryCoverageReport((__int64 *)&off_140C066F8);
  }
  if ( EtwpCoverageCoreTracingEnabled && (unsigned int)dword_140C093AC < MEMORY[0xFFFFF7800000037C] )
  {
    if ( !dword_140C093A8 )
    {
      v24 = 0;
      dword_140C093A8 = TelemetryCoverageStringHashInternal(off_140C093A0, &v24);
    }
    EtwTelemetryCoverageReport((__int64 *)&off_140C093A0);
  }
  v10 = 0;
  if ( v2 )
    goto LABEL_43;
