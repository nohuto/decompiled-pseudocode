/*
 * XREFs of KeBugCheck2 @ 0x140516A10
 * Callers:
 ...
 *     KiFilterBugCheckInfo @ 0x1403DB73C (KiFilterBugCheckInfo.c)
 ...
 *     KiBugCheckUnicodeToAnsi @ 0x140517F80 (KiBugCheckUnicodeToAnsi.c)
 ...
 *     MmLocateUnloadedDriver @ 0x14053580C (MmLocateUnloadedDriver.c)
...
LABEL_14:
  ...
  *(_QWORD *)&xmmword_140C2B550 = a3;
  if ( v67 == -1073741103 )
    v29 = 195;
  *((_QWORD *)&xmmword_140C2B550 + 1) = a4;
  ...
  switch ( v29 )
  {
    ...
    case 0x4Cu:
      ...
      *(_QWORD *)&KiBugCheckData = (unsigned int)a2;
      ...
      while ( (__int64)v36 < (__int64)&KiCurrentErrLogBufferOffset );
      v33 = CurrentThread;
      goto LABEL_115;
  }
  if ( v29 != 80 )
...
LABEL_66:
    v70 = *(_QWORD *)(v8 + 360);
    *((_QWORD *)&xmmword_140C2B550 + 1) = v70;
  ...
  if ( !CurrentPrcb->NmiActive )
  {
    DbgPrintEx(
      ...
      *((const void **)&KiBugCheckData + 1),
      (const void *)xmmword_140C2B550,
      *((const void **)&xmmword_140C2B550 + 1),
      (const void *)qword_140C2B560);
    if ( KiBugCheckDriver )
    ...
    if ( v46 )
    {
      if ( v67 == 265 )
      {
        KiMarkBugCheckRegions(
          *((__int64 *)&KiBugCheckData + 1),
          xmmword_140C2B550,
          *((unsigned __int64 *)&xmmword_140C2B550 + 1),
          qword_140C2B560);
        if ( qword_140C2B560 == 47 )
        {
          v56 = *((_QWORD *)&xmmword_140C2B550 + 1);
          if ( MmIsAddressValid((PVOID)(*((_QWORD *)&xmmword_140C2B550 + 1) + 1928LL)) )
