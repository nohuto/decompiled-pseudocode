/*
 * XREFs of PpmInstallNewIdleStates @ 0x1403C3E70
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x1403C3E50 (PpmIdleInstallDefaultStates.c)
 * Callees:
 *     KeAddProcessorAffinityEx @ 0x140229340 (KeAddProcessorAffinityEx.c)
 *     KxAcquireSpinLock @ 0x140229570 (KxAcquireSpinLock.c)
 *     KxReleaseSpinLock @ 0x1402295E0 (KxReleaseSpinLock.c)
 *     PpmDeepestHardwareIdleState @ 0x1403C43BC (PpmDeepestHardwareIdleState.c)
 *     PpmResetIdlePolicy @ 0x1403C43F8 (PpmResetIdlePolicy.c)
 *     PpmUpdateProcessorIdleAccounting @ 0x1403C4588 (PpmUpdateProcessorIdleAccounting.c)
