/*
 * XREFs of PpmInstallPlatformIdleStates @ 0x1408E22F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PpmIdleUpdatePlatformDependencies @ 0x1408F68E8 (PpmIdleUpdatePlatformDependencies.c)
...
LABEL_11:
  ...
  if ( v7 )
  {
    ...
    if ( (_DWORD)KeNumberProcessors_0 )
    {
      while ( 1 )
      {
        v12 = *(_QWORD *)(KeGetPrcb(v11) + 0x8000);
        if ( !v12 )
          goto LABEL_5;
        v9 += *(_DWORD *)(v12 + 32);
        if ( ++v11 >= v5 )
        ...
        *(_OWORD *)(v29 + v13 + 296) = v30;
        if ( v5 )
        {
          ...
          do
          {
            ...
            v35 = *(_QWORD *)(KeGetPrcb(v33) + 0x8000);
            *(_DWORD *)(v34 + v32) = v33++;
            v32 += 24LL;
            v36 = *(_DWORD *)(v35 + 32);
