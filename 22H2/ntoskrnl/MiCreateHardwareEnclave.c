/*
 * XREFs of MiCreateHardwareEnclave @ 0x140A3D7F8
 * Callers:
...
__int64 __fastcall MiCreateHardwareEnclave(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4, _DWORD *a5)
{
  ...
  if ( !ExAcquireRundownProtection_0(&stru_140C699C8) )
    return 3221225738LL;
  if ( !a3 || (v13 = MiReserveEnclavePages(a2, VmPartition, (a3 >> 12) + ((a3 & 0xFFF) != 0)), v13 >= 0) )
  {
    ...
    ValidPte = MiMakeValidPte(v17, v18, 2684354564LL);
    v20 = 0;
    ...
    *(_QWORD *)v17 = ValidPte;
    ...
    if ( v13 >= 0 )
    {
      ...
      *(_QWORD *)(a2 + 112) = Process;
      ...
      v25 = KeAbPreAcquire((__int64)&qword_140C699C0, 0LL);
      v26 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C699C0, 0LL);
      v27 = v25;
      if ( v26 )
        ExfAcquirePushLockExclusiveEx(&qword_140C699C0, v25, (__int64)&qword_140C699C0);
      if ( v27 )
        *(_BYTE *)(v27 + 18) = 1;
      v28 = (_QWORD *)qword_140C699B8;
      v29 = (_QWORD *)(a2 + 120);
      if ( *(__int64 **)qword_140C699B8 != &qword_140C699B0 )
        __fastfail(3u);
      v29[1] = qword_140C699B8;
      *v29 = &qword_140C699B0;
      *v28 = v29;
      qword_140C699B8 = (__int64)v29;
...
LABEL_36:
  ExReleaseRundownProtection_0(&stru_140C699C8);
