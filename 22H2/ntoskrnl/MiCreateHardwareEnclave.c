/*
 * XREFs of MiCreateHardwareEnclave @ 0x1408D2920
 * Callers:
...
__int64 __fastcall MiCreateHardwareEnclave(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4, _DWORD *a5)
{
  ...
  if ( !ExAcquireRundownProtection((PEX_RUNDOWN_REF)&stru_140C4EEC0) )
    return 3221225738LL;
...
LABEL_32:
  ExReleaseRundownProtection((PEX_RUNDOWN_REF)&stru_140C4EEC0);
