/*
 * XREFs of InbvSetFunction @ 0x140387188
 * Callers:
...
__int64 __fastcall InbvSetFunction(int a1)
{
  ...
  result = (unsigned int)dword_140C6AC48;
  if ( (unsigned int)(dword_140C6AC48 - 3) <= 1 )
  {
    if ( qword_140C6AC58 )
    {
      v3 = *(void (__fastcall **)(_QWORD))(qword_140C6AC58 + 136);
      if ( v3 )
        v3(0LL);
    }
    v4 = off_140C04540;
    result = 4 - (unsigned int)(a1 != 4);
    dword_140C6AC48 = 4 - (a1 != 4);
    if ( a1 != 4 )
      v4 = off_140C04600;
    qword_140C6AC58 = (__int64)v4;
  }
  return result;
}
