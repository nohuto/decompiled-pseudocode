/*
 * XREFs of HalpAcpiPostSleep @ 0x140995B1C
 * Callers:
...
char __fastcall HalpAcpiPostSleep(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (HalpPlatformFlags & 1) != 0 )
  {
    ...
    {
      HalpAcpiPmRegisterRead(0, (unsigned __int8)byte_140C4A058 >> 1, (__int64)v17, 2u, 0LL);
      v4 = v17[0];
      v16[0] = v17[0];
      if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
      {
        HalpAcpiPmRegisterRead(3, (unsigned __int8)byte_140C4A058 >> 1, (__int64)v17, 2u, 0LL);
        v4 = v17[0] | v16[0];
      }
      v16[0] = v4 & 0xFBFF;
      HalpAcpiPmRegisterWrite(0, (unsigned __int8)byte_140C4A058 >> 1, (__int64)v16, 2u, 0LL);
      if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
        HalpAcpiPmRegisterWrite(3, (unsigned __int8)byte_140C4A058 >> 1, (__int64)v16, 2u, 0LL);
    }
  }
  v19 = -1;
  v20 = 0;
