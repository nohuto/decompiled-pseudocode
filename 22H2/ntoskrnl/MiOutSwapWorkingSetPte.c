/*
 * XREFs of MiOutSwapWorkingSetPte @ 0x140215680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiOutSwapWorkingSetPte(__int64 a1, ULONG_PTR a2, int a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( (v9 & 1) != 0 )
    {
      ...
      if ( v22 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * v22 - 0x21FFFFFFFFD8LL), 0x36u) )
        return 0LL;
...
LABEL_7:
  ...
  if ( (unsigned int)MiPteInShadowRange(a2) )
  {
    ...
    {
      v5 = 1;
      if ( HIBYTE(word_140C66DFC) || (v29 & 1) == 0 )
        goto LABEL_61;
LABEL_60:
