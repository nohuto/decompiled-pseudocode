/*
 * XREFs of Xp10BuildHuffmanEncodings @ 0x1409C460C
 * Callers:
            ...
            if ( *((unsigned __int8 *)a1 + v52 + 38176) == v47 )
            {
              ...
              if ( v47 > 8 )
              {
                ...
                do
                {
                  ...
                  v53 -= 8;
                  v54 >>= 8;
                  v55 = *((unsigned __int8 *)qword_14001BC90 + v57) | (v55 << 8);
                  --v56;
                }
                while ( v56 );
              }
              if ( v53 )
                v55 = (*((unsigned __int8 *)qword_14001BC90 + (unsigned __int8)v54) | (v55 << 8)) >> (8 - v53);
