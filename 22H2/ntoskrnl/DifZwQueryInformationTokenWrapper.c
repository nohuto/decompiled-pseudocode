/*
 * XREFs of DifZwQueryInformationTokenWrapper @ 0x1405F4C80
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG ReturnLength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(600);
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = TokenHandle;
  LODWORD(v23) = TokenInformationClass;
  *((_QWORD *)&v22 + 1) = TokenInformation;
  LODWORD(v22) = TokenInformationLength;
