/*
 * XREFs of MiBuildDynamicRegion @ 0x14037685C
 * Callers:
...
ULONG_PTR __fastcall MiBuildDynamicRegion(__int64 *a1, __int64 a2, unsigned __int64 a3)
{
  ...
  a1[3] = v5;
  if ( a1 == &qword_140C66EA0 )
    a1[3] = v5 & 0xFFF;
  a1[2] = v4;
  if ( a1 == &qword_140C66EA0 && (v11 = a1[1]) != 0 )
  {
    v9 = 0LL;
  ...
  {
    v6 = 8 * ((v4 >> 6) + ((v4 & 0x3F) != 0));
    result = MiReservePtes((__int64)&qword_140C69A40, (unsigned int)(v6 >> 12) + ((v6 & 0xFFF) != 0));
    v8 = result;
    if ( !result )
      return result;
    v9 = 1LL;
