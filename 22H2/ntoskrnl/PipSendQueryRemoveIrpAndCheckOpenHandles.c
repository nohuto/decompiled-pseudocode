/*
 * XREFs of PipSendQueryRemoveIrpAndCheckOpenHandles @ 0x140971D4C
 * Callers:
 *     PipProcessQueryRemovalInKernelMode @ 0x140971C2C (PipProcessQueryRemovalInKernelMode.c)
 * Callees:
 *     PnpDeleteLockedDeviceNodes @ 0x1408685F8 (PnpDeleteLockedDeviceNodes.c)
 *     PnpCollectOpenHandles @ 0x14096416C (PnpCollectOpenHandles.c)
