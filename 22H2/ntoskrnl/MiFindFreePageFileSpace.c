/*
 * XREFs of MiFindFreePageFileSpace @ 0x140333724
 * Callers:
 ...
 *     MiFindFreePageFileSpaceForward @ 0x14030F7CC (MiFindFreePageFileSpaceForward.c)
 *     MiSetPageFileAllocationBits @ 0x140329EE8 (MiSetPageFileAllocationBits.c)
 *     RtlLengthCurrentClearRunForward @ 0x14033124C (RtlLengthCurrentClearRunForward.c)
