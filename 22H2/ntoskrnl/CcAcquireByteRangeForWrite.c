/*
 * XREFs of CcAcquireByteRangeForWrite @ 0x1402905C0
 * Callers:
  ...
  *a6 = 0;
  ...
  if ( v16 && *(_DWORD *)(v16 + 8) && (*(_DWORD *)(v16 + 4) || a3) )
  {
    if ( !a2 )
    {
      ...
      v40 = *(unsigned int *)(BitmapRangeToClean + 28);
      v41 = *(_QWORD *)(BitmapRangeToClean + 16);
      if ( v38 > (__int64)(v40 + v41) )
        v38 = v41 + *(unsigned int *)(BitmapRangeToClean + 24);
    ...
    v41 = *(_QWORD *)(v59 + 16);
    if ( v14 >= v41 + *(unsigned int *)(v59 + 24) )
    {
      v40 = *(unsigned int *)(v59 + 28);
      if ( v38 <= (__int64)(v40 + v41) )
      {
        v42 = *(_QWORD *)(v59 + 40);
        v39 = v76;
...
LABEL_71:
        v75 = v43;
        v44 = v38;
        v45 = v41 + *(unsigned int *)(BitmapRangeToClean + 24);
        if ( v44 >= v45 )
          v45 = v44;
        v74 = v45;
        v46 = (unsigned int)(v45 - *(_DWORD *)(BitmapRangeToClean + 16));
        v47 = v45 - *(_DWORD *)(BitmapRangeToClean + 16);
        v78 = v46;
        v12 = (int *)(v42 + 4 * (v46 >> 5));
        v13 = -1 << (v45 % 32);
        v48 = *v12;
        if ( (*v12 & v13) == 0 )
        {
          ...
          do
          {
            ...
            {
              if ( !v27 )
                *(_DWORD *)(BitmapRangeToClean + 28) = v47 - 1;
              do
              {
                BitmapRangeToClean = *(_QWORD *)BitmapRangeToClean;
                if ( BitmapRangeToClean == v39 + 16 )
                {
                  if ( v27 )
                    goto LABEL_6;
                  BitmapRangeToClean = *(_QWORD *)BitmapRangeToClean;
              ...
              v62 = *(unsigned int *)(BitmapRangeToClean + 24);
              v63 = *(_QWORD *)(BitmapRangeToClean + 16);
              ...
              v74 = v45;
              v47 = *(_DWORD *)(BitmapRangeToClean + 24);
...
LABEL_76:
          ...
          *(_DWORD *)(BitmapRangeToClean + 32) -= v49;
          v53 = Partition;
          ...
          *(_DWORD *)(v53 + 496) = v55;
          ...
          {
            v58 = *v83;
            if ( *(_DWORD *)(BitmapRangeToClean + 24) == (_DWORD)v78 )
              *(_DWORD *)(BitmapRangeToClean + 24) = v58 + v45 - *(_DWORD *)(BitmapRangeToClean + 16);
            if ( a3 )
              goto LABEL_95;
            v57 = v58 + v45;
          }
          else
          {
            ...
            *(_DWORD *)(BitmapRangeToClean + 28) = 0;
            v57 = *(_QWORD *)(BitmapRangeToClean + 16) + 0x2000LL;
          }
          *(_QWORD *)(v76 + 32) = v57;
LABEL_95:
