/*
 * XREFs of MiIncrementAweMapCount @ 0x14054C5B4
 * Callers:
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      *((_QWORD *)&v77 + 1) = a2;
      ...
      while ( 1 )
      {
        v30 = (unsigned __int64)&v25->LockEntries[v29];
        v28 &= ~(1 << v29);
        if ( (*(_BYTE *)(v30 + 26) & 1) != 0
          && (*(_DWORD *)(v30 + 32) & 1) == 0
...
LABEL_34:
      ...
      else
      {
        ...
        *(_DWORD *)(v30 + 88) = v33;
        *(_QWORD *)(v30 + 32) = 0LL;
        v34 = (__int64)(v30 - (unsigned __int64)v25->LockEntries) / 96;
        if ( v27 == 1 )
        ...
        *(_BYTE *)(v56 + 26) &= ~1u;
        if ( *(_QWORD *)(v56 + 32) )
        {
          if ( v56 )
          {
            ...
            *(_DWORD *)(v56 + 88) = v58;
            *(_QWORD *)(v56 + 32) = 0LL;
            v59 = (__int64)(v56 - (unsigned __int64)v51->LockEntries) / 96;
            if ( v53 == 1 )
...
LABEL_90:
    ...
    if ( v14 && ($C459BD0D405E8E46662177FB3D0A143F *)v51->ApcState.ApcListHead[0].Flink != &v51->152 )
