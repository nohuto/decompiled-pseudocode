/*
 * XREFs of MiLogHotPatchOperationStatus @ 0x1408CBA90
 * Callers:
...
char __fastcall MiLogHotPatchOperationStatus(int a1, int a2, UNICODE_STRING *a3, int a4, int a5)
{
  ...
  if ( *(_QWORD *)&qword_140C4EEE0 )
  {
    ...
    if ( a5 )
    {
      ...
      LOBYTE(v5) = tlgWriteEx_EtwWriteEx(v15, (unsigned __int8 *)v16, v13, v14, v19, v20, 8u, v17);
      return (char)v5;
    }
    ...
    if ( **(_DWORD **)&qword_140C4EEE0 > 5u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v67[1] = 0;
        v69 = 8LL;
        LOBYTE(v5) = tlgWriteEx_EtwWriteEx(v10, (unsigned __int8 *)byte_140026541, v12, 1u, v19, v20, 0xAu, &v54);
      }
    }
  }
  return (char)v5;
