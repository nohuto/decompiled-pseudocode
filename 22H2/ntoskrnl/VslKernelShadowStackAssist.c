/*
 * XREFs of VslKernelShadowStackAssist @ 0x14054BAE0
 * Callers:
 ...
 *     KiProcessDeferredDpcWatchdogViolation @ 0x14057B298 (KiProcessDeferredDpcWatchdogViolation.c)
 *     KeKernelShadowStackRestoreContext @ 0x14057BAF0 (KeKernelShadowStackRestoreContext.c)
 *     KiProcessControlProtectionFromKernelMode @ 0x14057C3D8 (KiProcessControlProtectionFromKernelMode.c)
 * Callees:
