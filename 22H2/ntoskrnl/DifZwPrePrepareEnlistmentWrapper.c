/*
 * XREFs of DifZwPrePrepareEnlistmentWrapper @ 0x1405F3160
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwPrePrepareEnlistmentWrapper(HANDLE EnlistmentHandle, PLARGE_INTEGER TmVirtualClock)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(579);
...
LABEL_8:
  ...
  *(_QWORD *)&v16 = 0LL;
LABEL_10:
  *(_QWORD *)&v17 = EnlistmentHandle;
  *((_QWORD *)&v16 + 1) = TmVirtualClock;
...
LABEL_17:
  result = ZwPrePrepareEnlistment(EnlistmentHandle, TmVirtualClock);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
