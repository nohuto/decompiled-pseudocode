 ...
 * Callers:
 *     HalpFirmwareInitSystem @ 0x1409A12F0 (HalpFirmwareInitSystem.c)
 * Callees:
...
__int64 __fastcall HalpFirmwareInitDiscard(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 264) & 1) != 0 )
  {
    ...
    xmmword_140C49F90 = *(_OWORD *)(a1 + 280);
    xmmword_140C49FA0 = *(_OWORD *)(a1 + 296);
    xmmword_140C49FB0 = *(_OWORD *)(a1 + 312);
    HalpEfiTimeCalls = 0;
    HalpEfiTimeWrites = 0;
