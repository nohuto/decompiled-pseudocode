/*
 * XREFs of ViDeadlockAnalyze @ 0x1409DEBA4
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x1409DE814 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x1409DEBA4 (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x1409DEE8C (ViDeadlockCertify.c)
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)ViDeadlockGlobals + 4107) = a1;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(0xC4u, 0x1001uLL, a1, a2, 0LL, byte_140C12F4C);
      return 0LL;
    }
    v8 = 0;
    goto LABEL_30;
