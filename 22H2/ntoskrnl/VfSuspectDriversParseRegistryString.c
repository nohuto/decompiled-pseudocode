/*
 * XREFs of VfSuspectDriversParseRegistryString @ 0x140B97D8C
 * Callers:
...
LABEL_26:
    ...
    else
    {
      ...
      {
        VfDriverLock();
        v11 = (_QWORD *)qword_140C36EB8;
        if ( *(__int64 **)qword_140C36EB8 != &VfExcludedDriversList )
          __fastfail(3u);
        *v10 = &VfExcludedDriversList;
        v10[1] = v11;
        *v11 = v10;
        qword_140C36EB8 = (__int64)v10;
        goto LABEL_26;
      }
    }
    v4 = 0x100002601LL;
