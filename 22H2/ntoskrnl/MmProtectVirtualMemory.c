/*
 * XREFs of MmProtectVirtualMemory @ 0x1406F9820
 * Callers:
 ...
 *     MiGetVadPageSize @ 0x140275554 (MiGetVadPageSize.c)
 ...
 *     xHalUnmaskInterrupt @ 0x140371920 (xHalUnmaskInterrupt.c)
        ...
        _DWORD *a6)
{
  ...
  __int64 v61[10]; // [rsp+D8h] [rbp-50h] BYREF
  char v66; // [rsp+150h] [rbp+28h]
  ...
  *a6 = 1;
  ...
  v51 = 24;
LABEL_5:
  v16 = ((unsigned __int64)v12 + v11 - 1) | 0xFFF;
  v60 = v16;
  ...
  P = v18;
  if ( v16 >> 12 > (*((unsigned int *)v18 + 7) | ((unsigned __int64)*((unsigned __int8 *)v18 + 33) << 32)) )
  {
    v31 = -1073741800;
    goto LABEL_118;
  }
  if ( (v18[6] & 0x2200000) == 0x2200000 )
  {
    if ( !v45 )
    {
      v31 = -1073741755;
  ...
  if ( (v44 & 2) != 0 )
  {
    v31 = MiAllowProtectionChange(a2, a1, (ULONG_PTR)v18, v44, v17, v16);
    if ( v31 < 0 )
      goto LABEL_118;
    v34 = *(_DWORD *)(v19 + 48);
    if ( (v34 & 0x100) == 0 && v42 )
...
LABEL_49:
        if ( v9 )
        {
          if ( (v34 & 8) != 0 )
          {
            v31 = MiCheckSecuredVad(v19, v54, (_DWORD)v56, v44, KeGetCurrentThread()->PreviousMode);
            if ( v31 < 0 )
              goto LABEL_118;
            v66 = 1;
            v49 = (_QWORD *)v50;
...
LABEL_13:
  ...
  {
    v31 = MiCheckSecuredVad(v19, v54, (_DWORD)v56, v21, KeGetCurrentThread()->PreviousMode);
    if ( v31 < 0 )
      goto LABEL_118;
    v27 = v50;
    v21 = v44;
...
LABEL_117:
  ...
  v31 = MiProtectPrivateMemory(v19, v17, v16, v21, v14, v45, &v46, (__int64)&v48);
  if ( v31 >= 0 )
  {
    if ( v27 )
    {
