/*
 * XREFs of TtmiLogInitCurrentSessionStart @ 0x1409A8800
 * Callers:
...
void TtmiLogInitCurrentSessionStart()
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v4 = 4;
      v3 = &v1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)&unk_140033C00, 0LL, 0LL, 3u, &v2);
    }
  }
}
