/*
 * XREFs of MiHandleBootImage @ 0x140B4A1A8
 * Callers:
 ...
 *     MiGetBootImagePageProtection @ 0x140B4A488 (MiGetBootImagePageProtection.c)
 ...
 *     MiFindLoaderAppliedHotPatchEntry @ 0x140B9AAC8 (MiFindLoaderAppliedHotPatchEntry.c)
...
__int64 __fastcall MiHandleBootImage(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v5 = dword_140C65944;
  v6 = a2;
  v7 = (unsigned int)dword_140C6997C >> 12;
  ...
  v13 = 4;
  if ( dword_140C6997C && (LoaderAppliedHotPatchEntry = MiFindLoaderAppliedHotPatchEntry(v6, a1)) != 0 )
  {
    ...
    if ( !v29 )
    {
      ...
      if ( v44 == PsNtosImageBase || v44 == PsHalImageBase )
        ...
        _InterlockedExchangeAdd(&dword_140C69AD0, v31 - v14);
      v5 = v45;
      v12 = v47;
      v7 = v58;
    }
