/*
 * XREFs of Amd64ConfigureCounter @ 0x1404DD74C
 * Callers:
 *     Amd64DisableMonitoring @ 0x1404DD7C0 (Amd64DisableMonitoring.c)
 *     Amd64EnableMonitoring @ 0x1404DD860 (Amd64EnableMonitoring.c)
 *     Amd64RestartProfiling @ 0x1409A99A0 (Amd64RestartProfiling.c)
 * Callees:
 *     <none>
 */
