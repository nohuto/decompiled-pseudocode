/*
 * XREFs of HvlGetPpmStatsForProcessor @ 0x1403C7EEC
 * Callers:
...
__int64 __fastcall HvlGetPpmStatsForProcessor(struct _KPRCB *a1, _QWORD *a2, _QWORD *a3)
{
  ...
  {
    v6 = HIDWORD(xmmword_140D17A38);
    StatisticsPage = a1->StatisticsPage;
    do
    {
      v8 = StatisticsPage[v6];
      *a3 = a1->StatisticsPage[(unsigned int)xmmword_140D17A48];
    }
    while ( v8 != StatisticsPage[v6] );
    v9 = DWORD1(xmmword_140D17A48);
  ...
  else
  {
    ...
    v14 = (unsigned int)xmmword_140D17A48;
    *a2 = v12 - a1->StatisticsPage[DWORD1(xmmword_140D17A38)];
