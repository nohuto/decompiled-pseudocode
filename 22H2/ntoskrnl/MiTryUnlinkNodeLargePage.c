/*
 * XREFs of MiTryUnlinkNodeLargePage @ 0x1402EF1FC
 * Callers:
...
__int64 __fastcall MiTryUnlinkNodeLargePage(__int64 a1, ULONG_PTR a2, unsigned int a3, char a4, BOOL *a5)
{
  ...
  v15 = *(_QWORD *)(qword_140C4E648 + 8 * ((*(_QWORD *)(v10 + 40) >> 39) & 0x3FFLL));
  if ( v15 != a1 )
  {
LABEL_29:
    ...
    if ( KiIrqlFlags )
    {
      if ( (KiIrqlFlags & 1) != 0 )
      {
        ...
        if ( CurrentIrql <= 0xFu && v14 <= 0xFu && CurrentIrql >= 2u )
        {
          ...
          v37 = ~(unsigned __int16)(-1LL << (v14 + 1));
    ...
    *v5 = v21;
    ...
    else
    {
      ...
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
        {
          ...
          if ( v31 <= 0xFu && v14 <= 0xFu && v31 >= 2u )
          {
            ...
            v28 = -1LL << (v14 + 1);
            v30 = v32->SchedulerAssist;
            v33 = ~(unsigned __int16)v28;
            v27 = (v33 & v30[5]) == 0;
            v29 = (unsigned int)v33 & v30[5];
            v30[5] = v29;
            if ( v27 )
      ...
      while ( *(_DWORD *)(v19 + 4284) )
        KeYieldProcessorEx(&v50, v28, v29, (__int64)v30);
    }
    v14 = MiLockPageInline(v10, v28, v29, v30);
    v15 = *(_QWORD *)(qword_140C4E648 + 8 * ((*(_QWORD *)(v10 + 40) >> 39) & 0x3FFLL));
    v16 = v44;
    if ( v15 != a1 )
      goto LABEL_29;
  }
  if ( (unsigned int)MiUnlinkNodeLargePageHelper((_QWORD *)v19, (__int64 *)v10, v51, PfnChannel, a4) )
  {
    if ( (a4 & 0x20) != 0 )
...
LABEL_43:
  ...
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
      ...
      if ( v39 <= 0xFu && v14 <= 0xFu && v39 >= 2u )
      {
        v40 = KeGetCurrentPrcb();
        v41 = v40->SchedulerAssist;
        v42 = ~(unsigned __int16)(-1LL << (v14 + 1));
        v27 = (v42 & v41[5]) == 0;
        v41[5] &= v42;
        if ( v27 )
