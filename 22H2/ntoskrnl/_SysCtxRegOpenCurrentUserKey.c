/*
 * XREFs of _SysCtxRegOpenCurrentUserKey @ 0x14072E318
 * Callers:
 ...
 *     _SysCtxGetCachedContextBaseKey @ 0x140695DA0 (_SysCtxGetCachedContextBaseKey.c)
            ...
            if ( appended >= 0 )
            {
              ...
              if ( appended >= 0 )
              {
                ...
                if ( PoolWithTag )
                {
                  ...
                  appended = RtlAppendUnicodeStringToString(&Destination, &stru_140009DD0);
                  if ( appended >= 0 )
                  {
