/*
 * XREFs of KiInitializeBootStructures @ 0x14099BA20
 * Callers:
 ...
 *     HalInitializeProcessor @ 0x1403A8930 (HalInitializeProcessor.c)
 ...
 *     KiSaveInitialProcessorControlState @ 0x1403FD7A0 (KiSaveInitialProcessorControlState.c)
