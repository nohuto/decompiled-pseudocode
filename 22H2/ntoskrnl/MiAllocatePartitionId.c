/*
 * XREFs of MiAllocatePartitionId @ 0x140A2F8F0
 * Callers:
...
__int64 __fastcall MiAllocatePartitionId(__int64 a1)
{
  ...
  do
  {
    ClearBitsAndSet = RtlFindClearBitsAndSet(qword_140C674A8, 1u, 0);
    v7 = ClearBitsAndSet;
    if ( ClearBitsAndSet != 0xFFFFFFFFLL )
    {
      byte_140C67ED4 = 1;
      *(_QWORD *)(qword_140C674C8 + 8LL * (unsigned __int16)ClearBitsAndSet) = a1;
