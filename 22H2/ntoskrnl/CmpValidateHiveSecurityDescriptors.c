/*
 * XREFs of CmpValidateHiveSecurityDescriptors @ 0x1406E6268
 * Callers:
...
LABEL_70:
  ...
  v24 = v38;
  if ( !HvIsCellAllocated(BugCheckParameter2, *(_DWORD *)(v38 + 44), 0LL) )
  {
    v33 = 32;
    goto LABEL_70;
  }
...
LABEL_58:
  ...
  else
  {
    ...
    if ( HvpMarkCellDirty(BugCheckParameter2, *(unsigned int *)(v24 + 44), 0) )
    {
      v28 = *(_DWORD *)(v24 + 44);
      v7[2] = v28;
      v7[1] = v28;
