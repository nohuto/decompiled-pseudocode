/*
 * XREFs of MiAgeWorkingSet @ 0x14025B650
 * Callers:
 *     MiTrimOrAgeWorkingSet @ 0x14025B380 (MiTrimOrAgeWorkingSet.c)
 *     MiForceAgeWorkingSet @ 0x140634910 (MiForceAgeWorkingSet.c)
 * Callees:
...
__int64 __fastcall MiAgeWorkingSet(__int64 a1, char a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( v8 > v10 )
  {
    ...
    HIDWORD(v43[1]) = v11;
    Pool = 0LL;
    v16 = *(_QWORD *)(*(_QWORD *)(qword_140C674C8 + 8 * v13) + 16920LL);
    if ( (a3 & 3) != 0 )
    {
      AvailablePagesBelowPriority = MiGetAvailablePagesBelowPriority(*(_QWORD *)(qword_140C674C8 + 8 * v13), 5LL);
...
LABEL_44:
  ...
  if ( *(_QWORD *)&qword_140C699E8 )
  {
      ...
      && (*(_QWORD *)(v23 + 24) & 1LL) == *(_QWORD *)(v23 + 24) )
    {
      ...
      v36 = a3;
      v60 = 4LL;
      tlgWriteEx_EtwWriteEx(v29, (int)&dword_140038873 + 3, v28, 1, v30, v31, 0xAu, (__int64)v47);
    }
  }
  LOBYTE(v9) = v7 == 5;
  return v9;
