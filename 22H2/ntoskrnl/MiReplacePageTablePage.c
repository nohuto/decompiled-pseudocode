/*
 * XREFs of MiReplacePageTablePage @ 0x1403634C0
 * Callers:
  ...
  *(_DWORD *)(a1 + 56) = -1073741823;
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v22 >= 0xFFFFF68000000000uLL && v22 <= 0xFFFFF6FFFFFFFFFFuLL && !MiIsPdeOrAboveAccessible(v15) )
        goto LABEL_84;
      v23 = MiLockTransitionLeafPage(v15);
      if ( v23 )
      {
