/*
 * XREFs of NtCreateTokenEx @ 0x1405DC930
 * Callers:
 *     NtCreateToken @ 0x140922760 (NtCreateToken.c)
 * Callees:
        ...
        __int64 a17)
{
  ...
  unsigned int *v58; // [rsp+160h] [rbp-B8h]
  ...
  result = SeCaptureSecurityQos(v63, v19, &v33, &v66);
  if ( (int)result >= 0 )
  {
    if ( v33 || v21 != 2 )
    {
      ...
      {
        v40 = *v58;
        v24 = SeCaptureLuidAndAttributesArray(v58 + 1, PoolType, v30, v32, (__int64)&v50, (__int64)&v52 + 4);
        v36 = v24;
      }
      if ( a14 && v24 >= 0 )
      {
        v24 = SeCaptureSid(*a14, PoolType, 1, (__int64)&v51);
        v36 = v24;
      }
      if ( v24 >= 0 )
      {
        v24 = SeCaptureSid(*v59, PoolType, 1, (__int64)&v43);
        v36 = v24;
      }
      if ( a16 && v24 >= 0 && *a16 )
      {
        v24 = SeCaptureAcl(*a16, PreviousMode, v25, v26, NonPagedPoolNx, v30, (PVOID *)&v44, (unsigned int *)&v53);
        v36 = v24;
      }
      v71 = *(_OWORD *)v60;
      if ( a12 && v24 >= 0 )
