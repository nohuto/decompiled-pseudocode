  ...
  if ( result >= 0 )
  {
    if ( v33 || v21 != 2 )
    {
      ...
      if ( v24 >= 0 )
      {
        ...
        v24 = SeCaptureLuidAndAttributesArray(v58->Privileges, PoolType, v30, v32, (__int64)&v50, (__int64)&v52 + 4);
        v36 = v24;
      }
      if ( Owner && v24 >= 0 )
      {
        v24 = SeCaptureSid(Owner->Owner, PoolType, 1, (__int64)&v51);
        v36 = v24;
      }
      if ( v24 >= 0 )
      {
        v24 = SeCaptureSid(v59->PrimaryGroup, PoolType, 1, (__int64)&v43);
        v36 = v24;
      }
