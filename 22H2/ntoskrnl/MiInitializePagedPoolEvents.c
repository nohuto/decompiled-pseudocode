...
char MiInitializePagedPoolEvents()
{
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(v9 + 26) & 1) != 0
      && (*(_DWORD *)(v9 + 32) & 1) == 0
      && (*(_QWORD *)(v9 + 32) & 0x7FFFFFFFFFFFFFFCLL) == ((unsigned __int64)&qword_140C4EF18 & 0x7FFFFFFFFFFFFFFCLL)
...
LABEL_20:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v3, (__int64)&qword_140C4EF18, &v15);
