/*
 * XREFs of AuthzBasepCopyoutSecurityAttributes @ 0x14033DDA8
 * Callers:
          ...
          if ( a2 )
          {
            ...
            for ( i = (_DWORD *)(v14 + 24); ; i += 10 )
            {
              ...
              if ( !SecurityAttribute )
                break;
              *((_WORD *)i - 4) = SecurityAttribute[3].Length;
              *i = HIDWORD(SecurityAttribute[3].Buffer);
              *((_WORD *)i - 3) = 0;
              *(i - 1) = *(_DWORD *)(&SecurityAttribute[3].MaximumLength + 1);
              Length = SecurityAttribute[2].Length;
              v20 = (char *)((unsigned __int64)(v16 + 1) & 0xFFFFFFFFFFFFFFFEuLL);
              pullResult = Length;
              v21 = &v20[Length];
              if ( (unsigned __int64)&v20[Length] > v11 )
                goto LABEL_24;
              *((_WORD *)i - 12) = Length;
              *((_WORD *)i - 11) = Length;
              *((_QWORD *)i - 2) = v20;
              memmove(v20, SecurityAttribute[2].Buffer, Length);
