/*
 * XREFs of SdbpCheckPackageAttributes @ 0x140965630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SdbpCheckPackageAttributes(int *a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5, __int64 a6)
{
  ...
  *a1 = 0;
  while ( 1 )
  {
    FirstTag = SdbFindFirstTag(*(_QWORD *)(a2 + 8), a5, *(_WORD *)((char *)&unk_140C12FB8 + v10));
    if ( FirstTag )
      break;
LABEL_33:
    v10 += 4LL;
  ...
  if ( v13 )
  {
    do
    {
      ...
      if ( *(_WORD *)v15 == *(_WORD *)((char *)&unk_140C12FB8 + v10 + 2) )
        break;
      ++v14;
      v15 = 0LL;
    }
    ...
    if ( v15 )
    {
      v18 = *(_WORD *)((char *)&unk_140C12FB8 + v10);
      if ( v18 == 16453 )
      {
