/*
 * XREFs of MiZeroCfgSystemWideBitmapWorker @ 0x140347C78
 * Callers:
 *     MiZeroCfgSystemWideBitmap @ 0x140347C20 (MiZeroCfgSystemWideBitmap.c)
 * Callees:
...
void __fastcall MiZeroCfgSystemWideBitmapWorker(unsigned int *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  v87 = (a2 >> 3) & 0xFFF;
  v74 = *(_QWORD *)(qword_140C674C8 + 8 * v7);
  v85 = ((a2 >> 3) + v4) & 0xFFF;
  v81 = ((a2 >> 3) + v4 - 1) >> 12;
...
LABEL_50:
        ...
        if ( !v55 )
          goto LABEL_29;
        v63 = v55;
        v64 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v23 + 40) >> 43) & 0x3FFLL));
        goto LABEL_79;
      }
      if ( (v24 & 0x400) != 0 )
        goto LABEL_29;
      if ( (v24 & 0x800) == 0 )
      {
        ...
        if ( v24 && v16 != v19 && v16 != v22 )
        {
          ...
          if ( v46 )
          {
            ...
            {
              v45 = 1;
              if ( HIBYTE(word_140C66DFC) != (_BYTE)v12 )
                goto LABEL_46;
              v71 = (v44 & 1) == 0;
            }
            else
...
LABEL_55:
          ...
          if ( dword_140C67F4C == 1 )
          {
            v66 = v26 & 0x1F;
            LOBYTE(v67) = 1;
            v68 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67FA0 + 1) + 4 * (v26 >> 5));
            if ( v66 + 1 > 0x20 )
            {
              if ( (v26 & 0x1F) == 0 )
                goto LABEL_102;
...
LABEL_79:
      ...
      else if ( (MiUnlinkPageFromListEx(v23, 0LL) & 3) == 0 )
      {
        ...
        if ( v34 )
        {
          ...
          v39 = 1;
          if ( HIBYTE(word_140C66DFC) == (_BYTE)v38 && (v31 & 1) != 0 )
            v31 |= 0x8000000000000000uLL;
        }
        else
        {
