/*
 * XREFs of IopStartNextPacketByKeyEx @ 0x140557C7C
 * Callers:
 *     IoStartNextPacket @ 0x1405572E0 (IoStartNextPacket.c)
 *     IoStartNextPacketByKey @ 0x140557330 (IoStartNextPacketByKey.c)
 * Callees:
