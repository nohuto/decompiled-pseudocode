/*
 * XREFs of IopStartNextPacketByKeyEx @ 0x140506988
 * Callers:
 *     IoStartNextPacket @ 0x140506020 (IoStartNextPacket.c)
 *     IoStartNextPacketByKey @ 0x140506070 (IoStartNextPacketByKey.c)
 * Callees:
