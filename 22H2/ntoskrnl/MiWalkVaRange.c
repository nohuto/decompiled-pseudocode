/*
 * XREFs of MiWalkVaRange @ 0x140293C34
 * Callers:
...
LABEL_64:
        ...
        if ( ((v16 & 0xFFFFFFFFFFFFF000uLL) == 0x7FFE0000
           || (v16 & 0xFFFFFFFFFFFFF000uLL) == qword_140C65B38 && qword_140C65B38)
