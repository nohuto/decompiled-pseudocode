/*
 * XREFs of IvtAttachDeviceDomainInternal @ 0x1404DF508
 * Callers:
 *     IvtAttachDeviceDomain @ 0x1404DF4F0 (IvtAttachDeviceDomain.c)
 *     IvtDetachDeviceDomain @ 0x1404DF970 (IvtDetachDeviceDomain.c)
 * Callees:
 ...
 *     IvtGetDomainId @ 0x1404DFED8 (IvtGetDomainId.c)
