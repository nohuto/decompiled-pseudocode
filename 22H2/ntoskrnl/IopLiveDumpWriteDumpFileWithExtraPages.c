/*
 * XREFs of IopLiveDumpWriteDumpFileWithExtraPages @ 0x14094FA08
 * Callers:
 ...
 *     IopLiveDumpGetExtraMergePages @ 0x14094E4F0 (IopLiveDumpGetExtraMergePages.c)
 *     IopLiveDumpGetNtMergePages @ 0x14094E800 (IopLiveDumpGetNtMergePages.c)
