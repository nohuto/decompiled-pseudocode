/*
 * XREFs of sub_1403DD750 @ 0x1403DD750
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeAreApcsDisabled @ 0x140349ED0 (KeAreApcsDisabled.c)
 *     KeVerifyGroupAffinity @ 0x140377C24 (KeVerifyGroupAffinity.c)
 *     KeCheckProcessorGroupAffinity @ 0x1403990E0 (KeCheckProcessorGroupAffinity.c)
 ...
 *     KiGetNtDdiVersion @ 0x140514A98 (KiGetNtDdiVersion.c)
...
__int64 __fastcall sub_1403DD750(__int64 a1, __int64 a2)
{
  __int64 v2; // r12
  __int64 v4; // r14
  int v6; // eax
...
LABEL_1769:
        ...
        if ( v77 != 30 )
        {
          if ( v77 != 31 )
          {
            if ( v77 == 32 )
            {
              sub_1403EADD8(v17, v56);
              goto LABEL_236;
            }
            if ( v77 == 33 )
            {
              sub_1403E9E6C(v17, v56);
              goto LABEL_236;
            }
            if ( v77 != 35 )
            {
...
LABEL_1148:
                ...
                if ( !(_DWORD)v714 )
                  goto LABEL_236;
                sub_1403E9D8C(v17, *((_QWORD *)v56 + 1), v714, v1742);
                v715 = 16LL;
                v716 = (__int64 *)(v56 + 28);
                v717 = v1742;
                do
...
LABEL_714:
        ...
        *((_DWORD *)v355 + 522) += v431;
        ...
        if ( (*((_DWORD *)v355 + 612) & 0x40000000) != 0 && (_DWORD)i7 )
          sub_1403E9D8C(v355, v465, (unsigned int)i7, v1610 + 7);
        v1590 = v355;
        v478 = 4294967294LL;
        v1610[6] = 0;
        v1610[6] |= 1u;
