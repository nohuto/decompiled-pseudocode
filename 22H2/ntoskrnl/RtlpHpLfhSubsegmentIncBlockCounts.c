/*
 * XREFs of RtlpHpLfhSubsegmentIncBlockCounts @ 0x140303A38
 * Callers:
  ...
  if ( v7 )
  {
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        if ( v27 )
          break;
        v31 = (unsigned __int64)&CurrentThread->LockEntries[v30];
        v29 &= ~(1 << v30);
        if ( (*(_BYTE *)(v31 + 26) & 1) != 0
          && (*(_DWORD *)(v31 + 32) & 1) == 0
          ...
          *(_BYTE *)(v31 + 26) &= ~1u;
          if ( *(_QWORD *)(v31 + 32) )
          {
            if ( v31 )
            {
              ...
              *(_BYTE *)(v31 + 25) &= ~1u;
              *(_QWORD *)(v31 + 32) = 0LL;
              v32 = (__int64)(v31 - (unsigned __int64)CurrentThread->LockEntries) / 96;
              if ( v28 == 1 )
