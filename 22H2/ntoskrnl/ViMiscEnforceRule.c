/*
 * XREFs of ViMiscEnforceRule @ 0x140AE2528
 * Callers:
 *     VfMiscMmAllocateContiguousMemoryEx_Entry @ 0x140AE11A0 (VfMiscMmAllocateContiguousMemoryEx_Entry.c)
 *     VfMiscMmAllocateContiguousMemory_Entry @ 0x140AE11D0 (VfMiscMmAllocateContiguousMemory_Entry.c)
 * Callees:
