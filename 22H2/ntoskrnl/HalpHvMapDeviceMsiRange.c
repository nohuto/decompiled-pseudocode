/*
 * XREFs of HalpHvMapDeviceMsiRange @ 0x140A959FC
 * Callers:
 *     HalpInterruptRemap @ 0x14037C728 (HalpInterruptRemap.c)
 * Callees:
 *     __security_check_cookie @ 0x1403D7680 (__security_check_cookie.c)
 *     _guard_dispatch_icall @ 0x140429560 (_guard_dispatch_icall.c)
 *     HalpHvBuildDeviceId @ 0x140A95954 (HalpHvBuildDeviceId.c)
 */
        ...
        unsigned int a6)
{
  ...
  v20 = 0LL;
  v21 = a6;
  v10 = ((__int64 (__fastcall *)(__int64, __int64 *, __int64, __int128 *))qword_140C625A8)(v18, &v20, a5 + 24, &v19);
  if ( v10 >= 0 && a6 )
  {
    v11 = HIDWORD(v19);
    v12 = a5 + 52;
