/*
 * XREFs of SpiSend16 @ 0x14067D61C
 * Callers:
 *     SpiMax311GetByte @ 0x14067D2D0 (SpiMax311GetByte.c)
 *     SpiMax311PutByte @ 0x14067D3A0 (SpiMax311PutByte.c)
 *     SpiMax311RxReady @ 0x14067D430 (SpiMax311RxReady.c)
 *     SpiMax311SetBaud @ 0x14067D490 (SpiMax311SetBaud.c)
 *     SpiMax311TxEmpty @ 0x14067D5E4 (SpiMax311TxEmpty.c)
 * Callees:
...
__int64 __fastcall SpiSend16(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  SpiInit(*a1, a2, a3, word_140D1B228);
