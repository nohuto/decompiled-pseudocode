/*
 * XREFs of PnpLogActionQueueEvent @ 0x14035949C
 * Callers:
  ...
  if ( a2 > 16 )
  {
    if ( a2 == 21 || a2 == 22 || (unsigned int)(a2 - 23) <= 1 )
    {
      ...
      if ( (_DWORD)a3 )
      {
        ...
        else if ( (_DWORD)a3 == 2 && (byte_140C0E209 & 0x20) != 0 )
        {
          if ( a1 )
            v10 = *(_QWORD *)(a1 + 48);
    ...
    if ( a2 != 16 )
    {
      if ( a2 == 8 )
      {
        ...
        if ( (_DWORD)a3 )
        {
          ...
          {
            if ( (_DWORD)a3 != 2 || (byte_140C0E20B & 8) == 0 )
              return result;
            if ( a1 )
              v5 = *(_QWORD *)(a1 + 48);
...
LABEL_14:
        ...
        if ( (_DWORD)a3 )
        {
          ...
          else if ( (_DWORD)a3 == 2 && (byte_140C0E20B & 8) != 0 )
          {
            if ( a1 )
              v6 = *(_QWORD *)(a1 + 48);
    ...
    if ( (_DWORD)a3 )
    {
      ...
      else if ( (_DWORD)a3 == 2 && (byte_140C0E20B & 0x10) != 0 )
      {
        if ( a1 )
          v7 = *(_QWORD *)(a1 + 48);
