/*
 * XREFs of TtmiLogSessionDisplayRequiredPowerRequestUpdated @ 0x1409A95AC
 * Callers:
...
void TtmiLogSessionDisplayRequiredPowerRequestUpdated()
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v6 = v2;
      v11 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)byte_14003340D, 0LL, 0LL, 5u, &v7);
    }
  }
}
