/*
 * XREFs of PopIrpWorker @ 0x14039F770
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopAcquireIrpWorkerLock @ 0x140577B10 (PopAcquireIrpWorkerLock.c)
...
NTSTATUS __fastcall PopIrpWorker(struct _KSEMAPHORE **Entry)
{
  ...
  *(_OWORD *)v34.m256i_i8 = (unsigned __int64)KeGetCurrentThread();
  ...
  ++PopIrpWorkerCount;
  if ( *(__int64 **)qword_140C20C68 != &PopIrpThreadList )
LABEL_61:
    __fastfail(3u);
  *(_QWORD *)&v33 = &PopIrpThreadList;
  *((_QWORD *)&v33 + 1) = qword_140C20C68;
  *(_QWORD *)qword_140C20C68 = &v33;
  qword_140C20C68 = (__int64)&v33;
LABEL_7:
