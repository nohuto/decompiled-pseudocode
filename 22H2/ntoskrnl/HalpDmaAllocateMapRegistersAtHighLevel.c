/*
 * XREFs of HalpDmaAllocateMapRegistersAtHighLevel @ 0x1404C6C2C
 * Callers:
 *     HalDmaAllocateCrashDumpRegistersEx @ 0x1403A5C80 (HalDmaAllocateCrashDumpRegistersEx.c)
 *     HalAllocateCrashDumpRegisters @ 0x1404B8C90 (HalAllocateCrashDumpRegisters.c)
 * Callees:
 ...
 *     HalpDmaForceAllocation @ 0x1404C78B4 (HalpDmaForceAllocation.c)
 *     HalpDmaPrependTranslations @ 0x1404C7CB0 (HalpDmaPrependTranslations.c)
