/*
 * XREFs of x86BiosWriteIoSpace @ 0x1403C2310
 * Callers:
 *     XmOutOp @ 0x1403B8430 (XmOutOp.c)
 *     XmOutsOp @ 0x140533C90 (XmOutsOp.c)
 * Callees:
 *     x86BiosWritePciAddressPort @ 0x1403AE7D0 (x86BiosWritePciAddressPort.c)
 *     x86BiosWriteCmosPort @ 0x1405083B8 (x86BiosWriteCmosPort.c)
