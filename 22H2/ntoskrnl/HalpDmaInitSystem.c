 ...
 *     HalpDmaInitEarly @ 0x140B6401C (HalpDmaInitEarly.c)
...
__int64 __fastcall HalpDmaInitSystem(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      ...
      qword_140C61D48 = (__int64)&HalpDmaControllers;
      HalpDmaControllers = (__int64)&HalpDmaControllers;
      qword_140C64418 = (__int64)&HalpDmaHibernateAdapters;
      HalpDmaHibernateAdapters = (__int64)&HalpDmaHibernateAdapters;
      qword_140C64428 = (__int64)&HalpDmaShadowDumpAdapters;
      HalpDmaShadowDumpAdapters = (__int64)&HalpDmaShadowDumpAdapters;
      qword_140C643F8 = (__int64)&HalpDmaPdoList;
