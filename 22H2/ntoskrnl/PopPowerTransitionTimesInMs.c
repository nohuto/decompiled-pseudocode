/*
 * XREFs of PopPowerTransitionTimesInMs @ 0x140382A80
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  if ( a1 )
  {
    result = PopQpcTimeInMs(&qword_140C23F28, &qword_140C23F30);
    *a1 = result;
  }
  if ( a2 )
  {
  ...
  {
    v13 = 0LL;
    result = PopQpcTimeInMs(&v13, &qword_140C23F68);
    *v12 = result;
    if ( dword_140C24170 )
    {
      result = (unsigned int)(qword_140C23FE8 + result);
      *v12 = result;
    }
  }
  if ( a3 )
  {
    ...
    *a3 = qword_140C23FB0 / v11;
  }
  if ( a4 )
  {
    result = (qword_140C240E8 + qword_140C24020) / v11;
    *a4 = result;
  }
  if ( a6 )
  {
    result = qword_140C23F90 / v11;
    *a6 = qword_140C23F90 / v11;
  }
  return result;
}
