/*
 * XREFs of MiResetAccessBitPte @ 0x14027B900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiResetAccessBitPte(__int64 a1, unsigned __int64 a2, int a3)
{
  ...
  if ( a3 )
  {
    if ( (*(_QWORD *)(v10 + 24) & 0x3FFFFFFFFFFFFFFFLL) != 1 || (unsigned int)MiIsPageTableLocked(v5, a2) )
      return 0LL;
  }
  ...
  if ( !v12 || v13 > 0x7FFFFFFEFFFFLL )
  {
    ...
    if ( v16 == 7 && (unsigned int)MiGetPfnPriority(v10) < dword_140C680EC )
    {
      v17 = 0;
    }
    else
