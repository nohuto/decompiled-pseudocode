/*
 * XREFs of MiLogCommitRequestFailed @ 0x1408D7434
 * Callers:
 ...
 *     PsQueryJobMemoryUsageByProcess @ 0x140908908 (PsQueryJobMemoryUsageByProcess.c)
 */
    ...
    if ( (v3 & 0x400) == 0 )
    {
      ...
      if ( **(_DWORD **)&qword_140C4EEE0 > 5u )
      {
        ...
        if ( (_BYTE)v3 )
        {
          ...
          v32 = v15;
          v63 = 8LL;
          LOBYTE(v3) = tlgWriteEx_EtwWriteEx(v14, (unsigned __int8 *)&word_140026796, 0LL, 1u, 0, 0, 0xFu, &v37);
        }
      }
    }
  }
