/*
 * XREFs of DifKeInsertByKeyDeviceQueueWrapper @ 0x1405E3AA0
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall DifKeInsertByKeyDeviceQueueWrapper(
        ...
        ULONG SortKey)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(268);
