/*
 * XREFs of PsConvertToGuiThread @ 0x1407C6820
 * Callers:
 ...
 *     EtwTimLogProhibitWin32kSystemCalls @ 0x1409EA6E4 (EtwTimLogProhibitWin32kSystemCalls.c)
 */
...
__int64 PsConvertToGuiThread()
{
  ...
  {
    v5 = (char)qword_140C37A00;
    if ( qword_140C37A00 )
    {
      LOBYTE(v4) = v15;
      LOBYTE(v3) = 12;
      v5 = qword_140C37A00(v4, v3);
    }
