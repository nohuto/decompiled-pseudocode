/*
 * XREFs of ExTryAcquireSpinLockSharedAtDpcLevel @ 0x1405B5A40
 * Callers:
 *     MmReadProcessPageTables @ 0x140547D40 (MmReadProcessPageTables.c)
 * Callees:
 *     KiRemoveSystemWorkPriorityKick @ 0x1403F2D04 (KiRemoveSystemWorkPriorityKick.c)
 *     ExpTryAcquireSpinLockSharedAtDpcLevelInstrumented @ 0x1405B5DBC (ExpTryAcquireSpinLockSharedAtDpcLevelInstrumented.c)
 */
