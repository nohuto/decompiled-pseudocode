/*
 * XREFs of MiFreePrivateFixupEntryForSystemImage @ 0x14020B168
 * Callers:
...
__int64 *__fastcall MiFreePrivateFixupEntryForSystemImage(ULONG_PTR BugCheckParameter2, int a2)
{
  ...
  v3 = 0LL;
  v5 = ExAcquireSpinLockExclusive(&dword_140C659E4);
  v6 = (__int64 *)qword_140C659C0;
  v7 = v5;
  while ( v6 != &qword_140C659C0 )
  {
    v3 = (PVOID *)v6;
