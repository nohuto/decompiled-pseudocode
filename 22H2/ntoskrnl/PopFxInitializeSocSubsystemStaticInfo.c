/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x1408E4770
 * Callers:
...
LABEL_18:
      ...
      if ( v3 )
        goto LABEL_29;
      v22 = (unsigned int **)qword_140C24AD8;
      if ( *(__int64 **)qword_140C24AD8 != &SocSubsystemsList )
        __fastfail(3u);
      *(_QWORD *)v5 = &SocSubsystemsList;
      *((_QWORD *)v5 + 1) = v22;
      *v22 = v5;
      qword_140C24AD8 = (__int64)v5;
    }
    else
    {
