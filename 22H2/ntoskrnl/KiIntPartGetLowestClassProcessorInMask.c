/*
 * XREFs of KiIntPartGetLowestClassProcessorInMask @ 0x140221BD4
 * Callers:
 *     KiIntSteerCalculateDistribution @ 0x1402216B0 (KiIntSteerCalculateDistribution.c)
 *     KiIntSteerGetNextProcessorTarget @ 0x140221B94 (KiIntSteerGetNextProcessorTarget.c)
 ...
 *     KiIntSteerCalculateFallbackDistribution @ 0x140579F6C (KiIntSteerCalculateFallbackDistribution.c)
 * Callees:
 *     KeFindFirstSetRightGroupAffinity @ 0x140221D10 (KeFindFirstSetRightGroupAffinity.c)
 *     KeFindFirstSetLeftGroupAffinity @ 0x140355130 (KeFindFirstSetLeftGroupAffinity.c)
 */
