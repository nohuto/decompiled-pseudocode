...
__int64 __fastcall PopBatteryApplyCompositeState(_DWORD *a1, int a2)
{
  ...
  if ( byte_140C23C38 )
  {
    ...
    v25 = 0LL;
    v6 = 0LL;
    while ( (__int64 *)v24 != &qword_140C23C40 )
    {
      v26 = *(_DWORD *)(v24 + 104);
      if ( v26 == 2 )
      {
    ...
    if ( PopCachedValidBatteryCount == -1 || PopCachedValidBatteryCount != dword_140C23C34 )
    {
      ...
      PopDiagTraceBatteryCountChange((unsigned int)dword_140C23C34, v6, v25, &qword_140C23C40);
    }
    v37 = 1;
  }
  ...
  do
  {
    ...
    if ( (unsigned __int8)PopBatteryCheckTrigger(v18) )
    {
      if ( PopBatteryCachedFlags[v15] != v17 )
      {
        ...
        v12 = v38;
        if ( dword_140C23D4C[6 * v38] == 128 )
        {
          PopDiagTraceBatteryTriggerMet(0x140000000LL + 24LL * v38 + 12729672, (char *)PopPolicy + 24 * v38 + 96, &v38);
          v12 = v38;
        }
      }
      if ( !byte_140C23D40 )
  ...
  if ( dword_140C23C34 )
  {
    ...
    *((_QWORD *)&xmmword_140C23E10 + 1) = unk_140C23C88;
    BYTE3(xmmword_140C23E00) = byte_140C23DA8 != 0 || (unk_140C23C60 & 2) != 0;
  }
  PopAccountCbEnergyChange();
  PopReleaseRwLock((ULONG_PTR)&xmmword_140C23DF0);
  if ( v40 )
  {
    v39 = (dword_140C23DAC + 500) / 0x3E8u;
    ...
    if ( dword_140C23DAC == -1 )
      v32 = (MEMORY[0xFFFFF78000000008] - qword_140C23DB0 + 5000) / 0x2710uLL;
    if ( PopPlatformAoAc )
    {
