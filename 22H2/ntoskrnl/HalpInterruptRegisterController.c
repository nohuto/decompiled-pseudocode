/*
 * XREFs of HalpInterruptRegisterController @ 0x1403B29D4
 * Callers:
 ...
 *     HalpInterruptBuildKnownResourceIdString @ 0x1403B2D3C (HalpInterruptBuildKnownResourceIdString.c)
      ...
      && ((v6 & 0x400) == 0 || *(_QWORD *)(a1 + 176)) )
    {
      ...
      if ( MemoryInternal )
      {
        ...
        *(_WORD *)(v11 + 330) = Length + 2;
        ...
        v16 = (__int64 *)qword_140C4BB18;
        if ( *(ULONG_PTR **)qword_140C4BB18 != &HalpRegisteredInterruptControllers )
          __fastfail(3u);
