/*
 * XREFs of HvlpReadPerfRegister @ 0x1404F3040
 * Callers:
 *     HvlReadPerfIoPort @ 0x1404F2230 (HvlReadPerfIoPort.c)
 *     HvlReadPerfMsr @ 0x1404F22B0 (HvlReadPerfMsr.c)
 * Callees:
...
__int64 __fastcall HvlpReadPerfRegister(int a1, __int64 a2, _QWORD *a3)
{
  ...
  v8 = a2;
  v7[1] = 0;
  v5 = HvcallFastExtended(65564LL, (__int64)v7, 16LL, (__int64)v9, 0x10u);
  if ( v5 )
