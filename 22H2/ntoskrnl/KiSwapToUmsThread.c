/*
 * XREFs of KiSwapToUmsThread @ 0x1408BD970
 * Callers:
 ...
 *     KeResetLegacyFloatingPointState @ 0x1403FDC60 (KeResetLegacyFloatingPointState.c)
 *     KeSaveLegacyFloatingPointControlWord @ 0x1403FDC70 (KeSaveLegacyFloatingPointControlWord.c)
