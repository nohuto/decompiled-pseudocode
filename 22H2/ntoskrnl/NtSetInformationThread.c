/*
 * XREFs of NtSetInformationThread @ 0x14064A5A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PspSetThreadPpmPolicy @ 0x140773A40 (PspSetThreadPpmPolicy.c)
        ...
        ULONG ThreadInformationLength)
{
  ...
  NTSTATUS v106; // [rsp+48h] [rbp-230h]
  ...
  _QWORD *v115; // [rsp+70h] [rbp-208h]
  LONG v116; // [rsp+78h] [rbp-200h]
  struct _KTHREAD *v117; // [rsp+80h] [rbp-1F8h]
  unsigned int v118; // [rsp+88h] [rbp-1F0h]
  PVOID P; // [rsp+90h] [rbp-1E8h]
  __int128 v120; // [rsp+98h] [rbp-1E0h]
  unsigned __int64 v121; // [rsp+A8h] [rbp-1D0h]
  PVOID v122; // [rsp+B0h] [rbp-1C8h] BYREF
  HANDLE v123; // [rsp+B8h] [rbp-1C0h]
  __int64 v124; // [rsp+C0h] [rbp-1B8h] BYREF
  PADAPTER_OBJECT DmaAdapter; // [rsp+C8h] [rbp-1B0h] BYREF
  void *Src[2]; // [rsp+D0h] [rbp-1A8h]
  KPRIORITY v127; // [rsp+E0h] [rbp-198h]
  LONG v128; // [rsp+E4h] [rbp-194h]
  LONG v129; // [rsp+E8h] [rbp-190h]
  LONG v130; // [rsp+ECh] [rbp-18Ch]
  int v131; // [rsp+F0h] [rbp-188h]
  LONG v132; // [rsp+F4h] [rbp-184h]
  unsigned int v133; // [rsp+F8h] [rbp-180h]
  LONG v134; // [rsp+FCh] [rbp-17Ch]
  LONG v135; // [rsp+100h] [rbp-178h]
  unsigned __int64 v136; // [rsp+108h] [rbp-170h]
  __int64 v137; // [rsp+120h] [rbp-158h]
  __int128 v138; // [rsp+130h] [rbp-148h]
  unsigned int v139; // [rsp+140h] [rbp-138h]
  __int128 v140; // [rsp+148h] [rbp-130h] BYREF
  __int64 v141; // [rsp+158h] [rbp-120h]
  __int64 v142; // [rsp+160h] [rbp-118h]
  HANDLE v143; // [rsp+168h] [rbp-110h]
  __int64 v144; // [rsp+170h] [rbp-108h]
  __int128 v145; // [rsp+178h] [rbp-100h] BYREF
  char v146[160]; // [rsp+190h] [rbp-E8h] BYREF
...
LABEL_4:
  ...
  if ( ThreadInformationClass == ThreadWorkOnBehalfTicket )
  {
    if ( ThreadHandle == (HANDLE)-2LL )
    {
      ...
      if ( v16 )
      {
        v18 = PspThreadFromTicket(&v124, (__int64 *)&DmaAdapter);
        if ( v18 >= 0 )
        {
...
LABEL_41:
      ...
      case ThreadIdealProcessor:
        ...
        if ( result >= 0 )
        {
          ...
          if ( (v67[29] & 0x400) == 0 )
            PspWriteTebIdealProcessor(CurrentThread, v67);
...
LABEL_42:
      ...
      case ThreadWow64Context:
        ...
        if ( result >= 0 )
        {
          ...
          {
            v70 = PspWow64SetContextThread((PETHREAD)v69, v5);
      ...
      case ThreadGroupInformation:
        ...
        if ( result >= 0 )
        {
          ...
          if ( !v75
            ...
            || (v87 = *(_QWORD *)(v76 + 8LL * WORD4(v145) + 624)) != 0 && ((unsigned __int64)v145 & v87) == (_QWORD)v145 )
          {
            v77 = Object;
      ...
      case ThreadUmsInformation:
        if ( ThreadInformationLength != 24 )
          return -1073741820;
        v140 = *(_OWORD *)ThreadInformation;
        v141 = *((_QWORD *)ThreadInformation + 2);
        if ( ThreadHandle == (HANDLE)-2LL )
        {
          v91 = CurrentThread;
        }
        ...
        if ( v91 != CurrentThread )
          return -1073741811;
        if ( (_DWORD)v140 == 1 )
          return PspAttachThreadToUmsCompletionList(v91, (__int64)&v140, v9, *(__int64 *)&ThreadInformationLength);
        if ( (_DWORD)v140 != 2 )
          return -1073741811;
      ...
      case ThreadCounterProfiling:
        ...
        *(_BYTE *)(v88 + 447) = *(_BYTE *)(v88 + 447);
        ...
        if ( result >= 0 )
        {
          ...
          {
            if ( HIDWORD(v120) )
              v90 = KeEnableProfiling(Object, DWORD2(v120), v120, v121);
            else
              v90 = KeDisableProfiling((__int64)Object, v121);
          }
          else
          {
            v90 = -1073741637;
      ...
      case ThreadIdealProcessorEx:
        ...
        if ( result < 0 )
          return result;
        v32 = Object;
        v18 = KeSetIdealProcessorThreadByNumber((struct _KTHREAD *)Object, &v110, &v110);
        if ( v18 >= 0 )
        {
      ...
      case ThreadCpuAccountingInformation:
        ...
        if ( v143 )
        {
          result = ObReferenceObjectByHandleWithTag(v143, 2u, MmSessionObjectType, v9, 0x79517350u, &v122, 0LL);
          if ( result < 0 )
            return result;
          v7 = (struct _LIST_ENTRY *)v122;
          v93 = *((_QWORD *)v122 + 4);
          if ( !v93 )
          {
...
LABEL_88:
      ...
      case ThreadSelectedCpuSets:
        ...
        if ( result < 0 )
          return result;
        v14 = KeSetSelectedCpuSetsThread((__int64)Object, ThreadInformationLength >> 3, v146);
        goto LABEL_21;
...
LABEL_220:
      ...
      case ThreadAttachContainer:
        ...
        if ( v123 )
        {
          ...
          {
            result = ObReferenceObjectByHandleWithTag(v123, 0x20u, (POBJECT_TYPE)PsJobType, v9, 0x6D497350u, &v113, 0LL);
            if ( result < 0 )
              return result;
            v99 = (struct _LIST_ENTRY *)v113;
            if ( (*((_DWORD *)v113 + 331) & 2) != 0 )
            {
            ...
            ObfDereferenceObjectWithTag(v113, 0x6D497350u);
          }
        }
...
LABEL_50:
      ...
      case ThreadPowerThrottlingState:
        ...
        if ( (_DWORD)v137 != 1 || (v137 & 0xFFFFFFFE00000000uLL) != 0 || (~HIDWORD(v137) & v84) != 0 )
          return -1073741811;
        if ( (v137 & 0x100000000LL) != 0 )
        {
          if ( (v84 & 1) != 0 )
            v10 = 1;
        }
      ...
      case ThreadWorkloadClass:
        ...
        *((_DWORD *)&v85[1].SwapListEntry + 3) ^= (*((_DWORD *)&v85[1].SwapListEntry + 3) ^ (v133 << 11)) & 0x800;
