/*
 * XREFs of IoWriteCrashDump @ 0x140502950
 * Callers:
 ...
 *     VfDisableHalVerifier @ 0x1405A0ED8 (VfDisableHalVerifier.c)
 */
...
LABEL_11:
    ...
    ((void (__fastcall *)(__int64, _QWORD, _QWORD))qword_140C50CB0)(1LL, 0LL, v35);
    VfDisableHalVerifier();
    LOBYTE(v16) = 1;
    v30 = ((__int64 (__fastcall *)(__int64))qword_140C50CE0)(v16);
    ...
    *(_QWORD *)(CrashdmpDumpBlock + 1344) = v24 & 0xFFFFFFFFFFFFF000uLL;
    ...
    if ( v10 >= 0 )
      v10 = ((__int64 (__fastcall *)(__int64, __int64))qword_140C50CB8)(CrashdmpDumpBlock, a8);
    if ( v10 != -1073741267 )
      goto LABEL_46;
    if ( (*(_DWORD *)(CrashdmpDumpBlock + 1368) & 4) != 0 )
    {
      ...
      *(_DWORD *)(CrashdmpDumpBlock + 1368) |= 8u;
      ...
      if ( v10 < 0 )
        goto LABEL_46;
      v28 = ((__int64 (__fastcall *)(__int64, __int64))qword_140C50CB8)(CrashdmpDumpBlock, a8);
      v29 = 38;
    }
    else
    {
