/*
 * XREFs of sub_140B19070 @ 0x140B19070
 * Callers:
...
__int64 __fastcall sub_140B19070(__int64 a1, ULONG_PTR a2, char a3)
{
  _BYTE *v3; // rbx
  __int64 v5; // r13
  int v6; // esi
          ...
          if ( (_DWORD)v115 )
          {
            ...
            else
            {
              ...
              do
              {
                ...
                v136 = v210;
                v119 = v225;
                sub_1403F1588((__int64)v22, v225, v120);
                v137 = v233;
...
LABEL_235:
  ...
  if ( v237 )
  {
    ...
    if ( (_DWORD)v204 )
    {
      ...
      {
        v173 = sub_140B12020(v22, v172, *((_DWORD *)v22 + 585));
        if ( !v173 )
          return 3221225626LL;
        v175 = *((_DWORD *)v22 + 612);
        if ( (v175 & 4) == 0 )
      ...
      *(_DWORD *)(v173 + 2088) += v168;
      ...
      {
        if ( (_DWORD)v168 )
          sub_1403F152C(v173, v39, v168, v181 + 28);
      }
      *(_DWORD *)(v181 + 24) = 1;
      *(_QWORD *)a1 = v173;
    }
