/*
 * XREFs of PopNewWakeInfo @ 0x140AA1168
 * Callers:
...
LONG PopNewWakeInfo()
{
  ...
  if ( Pool2 )
  {
    ...
    *(_QWORD *)Pool2 = Pool2;
    ...
    {
      v2 = (_QWORD *)qword_140C3E7A8;
      v3 = *(_QWORD **)(qword_140C3E7A8 + 8);
      if ( *(__int64 **)qword_140C3E7A8 != &PopWakeInfoList || *v3 != qword_140C3E7A8 )
        __fastfail(3u);
      qword_140C3E7A8 = *(_QWORD *)(qword_140C3E7A8 + 8);
      *v3 = &PopWakeInfoList;
      v2[1] = v2;
      *v2 = v2;
