/*
 * XREFs of PopNewWakeInfo @ 0x14099851C
 * Callers:
...
LONG PopNewWakeInfo()
{
  ...
  if ( v1 )
  {
    ...
    {
      v7 = (_QWORD *)qword_140C24398;
      v8 = *(_QWORD **)(qword_140C24398 + 8);
      if ( *(__int64 **)qword_140C24398 == &PopWakeInfoList && *v8 == qword_140C24398 )
      {
        qword_140C24398 = *(_QWORD *)(qword_140C24398 + 8);
        *v8 = &PopWakeInfoList;
        v7[1] = v7;
        *v7 = v7;
