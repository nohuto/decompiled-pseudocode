/*
 * XREFs of PopPowerAggregatorHandleIntentUnsafe @ 0x140776874
 * Callers:
 ...
 *     PopPowerAggregatorHandleSystemTransitionStartIntent @ 0x140726350 (PopPowerAggregatorHandleSystemTransitionStartIntent.c)
 ...
 *     PopPowerAggregatorIsAtTargetState @ 0x140776E24 (PopPowerAggregatorIsAtTargetState.c)
 *     PopPowerAggregatorHandleSystemTransitionEndIntent @ 0x14077A520 (PopPowerAggregatorHandleSystemTransitionEndIntent.c)
 *     PopPowerAggregatorCachePoPolicy @ 0x14078E27C (PopPowerAggregatorCachePoPolicy.c)
 *     PopPowerAggregatorHandleActiveIntent @ 0x1408EE2E0 (PopPowerAggregatorHandleActiveIntent.c)
 *     PopPowerAggregatorHandleDirectedDripsIntent @ 0x1408EE320 (PopPowerAggregatorHandleDirectedDripsIntent.c)
 *     PopPowerAggregatorHandleModernStandbyIntent @ 0x1408EE3B0 (PopPowerAggregatorHandleModernStandbyIntent.c)
 *     PopPowerAggregatorHandleModernStandbyResumeIntent @ 0x1408EE470 (PopPowerAggregatorHandleModernStandbyResumeIntent.c)
 *     PopPowerAggregatorHandleModernStandbySuspendIntent @ 0x1408EE4D0 (PopPowerAggregatorHandleModernStandbySuspendIntent.c)
 */
