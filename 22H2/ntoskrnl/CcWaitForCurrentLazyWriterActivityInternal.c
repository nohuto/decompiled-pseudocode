/*
 * XREFs of CcWaitForCurrentLazyWriterActivityInternal @ 0x140380DCC
 * Callers:
 *     CcWaitForCurrentLazyWriterActivityHelper @ 0x140380DA0 (CcWaitForCurrentLazyWriterActivityHelper.c)
