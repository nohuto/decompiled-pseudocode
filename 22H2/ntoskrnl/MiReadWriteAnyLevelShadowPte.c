/*
 * XREFs of MiReadWriteAnyLevelShadowPte @ 0x140301240
 * Callers:
...
ULONG_PTR __fastcall MiReadWriteAnyLevelShadowPte(unsigned __int64 a1, __int64 a2, int a3, unsigned __int64 a4)
{
  ...
  unsigned __int8 v35; // [rsp+A8h] [rbp+48h] BYREF
  ...
  *(_OWORD *)BugCheckParameter2 = 0LL;
  ...
  do
  {
    ...
    else
    {
      ...
      v16 = MiMapPageInHyperSpaceWorker((v13 >> 12) & 0xFFFFFFFFFLL, &v35, 0x80000000, v15);
      v9 = v35;
      Flink = v16;
      v7 = v32;
