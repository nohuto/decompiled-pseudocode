/*
 * XREFs of KiGetPastDueIRTimerInfo @ 0x1405239B4
 * Callers:
...
__int64 __fastcall KiGetPastDueIRTimerInfo(unsigned __int64 a1, _BYTE *a2, _BYTE *a3)
{
  ...
  if ( a1 < qword_140C31D50 )
    return 0LL;
  if ( (qword_140C31D48 & 1) != 0 )
  {
    if ( qword_140C31D48 == 1 )
      v3 = 0LL;
    else
      v3 = qword_140C31D48 ^ ((unsigned __int64)&unk_140C31D40 + 1);
  }
  else
  {
    v3 = qword_140C31D48;
