/*
 * XREFs of FsRtlpReleaseIrpsWaitingForRH @ 0x1403607E4
 * Callers:
...
NTSTATUS __fastcall FsRtlpReleaseIrpsWaitingForRH(__int64 a1)
{
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v21 = 8;
    v24 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)&word_140029E76, 0LL, 0LL, 4u, v19);
    result = 0;
    v3 = 0;
    v4 = 0;
  }
...
LABEL_11:
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    return tlgWriteTransfer_EtwWriteTransfer(
             ...
             (unsigned __int8 *)word_140029D12,
             0LL,
             0LL,
             8u,
             v19);
