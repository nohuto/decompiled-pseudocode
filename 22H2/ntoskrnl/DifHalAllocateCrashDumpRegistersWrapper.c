/*
 * XREFs of DifHalAllocateCrashDumpRegistersWrapper @ 0x1405DA8F0
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifHalAllocateCrashDumpRegistersWrapper(PADAPTER_OBJECT AdapterObject, PULONG NumberOfMapRegisters)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(125);
...
LABEL_8:
  ...
  *(_QWORD *)&v16 = 0LL;
LABEL_10:
  *(_QWORD *)&v17 = AdapterObject;
  *((_QWORD *)&v16 + 1) = NumberOfMapRegisters;
...
LABEL_17:
  result = HalAllocateCrashDumpRegisters(AdapterObject, NumberOfMapRegisters);
  *((_QWORD *)&v17 + 1) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
