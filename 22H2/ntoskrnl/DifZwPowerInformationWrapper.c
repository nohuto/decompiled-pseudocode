/*
 * XREFs of DifZwPowerInformationWrapper @ 0x1405F3010
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG OutputBufferLength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(577);
...
LABEL_8:
  ...
  *(_QWORD *)&v21 = 0LL;
LABEL_10:
  DWORD2(v21) = OutputBufferLength;
  DWORD2(v23) = InformationLevel;
  *(_QWORD *)&v23 = InputBuffer;
  DWORD2(v22) = InputBufferLength;
  *(_QWORD *)&v22 = OutputBuffer;
...
LABEL_17:
  result = ZwPowerInformation(InformationLevel, InputBuffer, InputBufferLength, OutputBuffer, OutputBufferLength);
  HIDWORD(v23) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
