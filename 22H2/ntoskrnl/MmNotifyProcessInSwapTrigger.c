/*
 * XREFs of MmNotifyProcessInSwapTrigger @ 0x14034D754
 * Callers:
...
char __fastcall MmNotifyProcessInSwapTrigger(__int64 a1)
{
  ...
  if ( result == 64 && *(_QWORD *)&qword_140C699E8 && **(_DWORD **)&qword_140C699E8 > 5u )
  {
    result = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000008LL);
    if ( result )
    {
      ...
      v10 = 0x1000000LL;
      v17 = 8;
      return tlgWriteEx_EtwWriteEx(v6, (int)&word_140038152, v5, 1, v7, v8, 5u, (__int64)v11);
    }
  }
  return result;
}
