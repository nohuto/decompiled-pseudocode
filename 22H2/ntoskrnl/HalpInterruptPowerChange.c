/*
 * XREFs of HalpInterruptPowerChange @ 0x1404D18B4
 * Callers:
 *     HalpInterruptPowerComponentActiveCallback @ 0x1404D1950 (HalpInterruptPowerComponentActiveCallback.c)
 *     HalpInterruptPowerComponentIdleCallback @ 0x1404D1970 (HalpInterruptPowerComponentIdleCallback.c)
 *     HalpInterruptPowerCriticalTransitionCallback @ 0x1404D19B0 (HalpInterruptPowerCriticalTransitionCallback.c)
 * Callees:
