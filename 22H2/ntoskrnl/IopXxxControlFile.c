/*
 * XREFs of IopXxxControlFile @ 0x1406E5590
 * Callers:
 *     PfpVolumePrefetchMetadata @ 0x140684C04 (PfpVolumePrefetchMetadata.c)
 *     NtDeviceIoControlFile @ 0x1406E5520 (NtDeviceIoControlFile.c)
 *     PfpPrefetchEntireDirectory @ 0x14075EDDC (PfpPrefetchEntireDirectory.c)
 *     NtFsControlFile @ 0x1407BB4C0 (NtFsControlFile.c)
 ...
 *     IopIsStandardFsctlIoControlCode @ 0x140555B0C (IopIsStandardFsctlIoControlCode.c)
 ...
 *     AstAddBloomFilter @ 0x1407AE674 (AstAddBloomFilter.c)
 *     AstTestBloomFilter @ 0x1407AE700 (AstTestBloomFilter.c)
          ...
          if ( (unsigned int)dword_140C038E0 > 5 )
          {
            if ( tlgKeywordOn((__int64)&dword_140C038E0, 0x200000000000LL) )
            {
              ...
              tlgWriteTransfer_EtwWriteTransfer(
                ...
                (unsigned __int8 *)byte_14002C675,
                0LL,
                0LL,
                5u,
                &v108);
