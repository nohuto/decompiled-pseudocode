/*
 * XREFs of DifZwFlushVirtualMemoryWrapper @ 0x1405F0860
 * Callers:
 *     <none>
 * Callees:
        ...
        PIO_STATUS_BLOCK IoStatus)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(544);
...
LABEL_17:
  result = ZwFlushVirtualMemory(ProcessHandle, BaseAddress, RegionSize, IoStatus);
  DWORD2(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
