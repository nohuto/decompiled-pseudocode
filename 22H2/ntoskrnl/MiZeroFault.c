/*
 * XREFs of MiZeroFault @ 0x1402CF5F0
 * Callers:
...
__int64 __fastcall MiZeroFault(__int64 a1, _BYTE *a2, unsigned int *a3, __int64 *a4)
{
  ...
  _KPROCESS *v35; // [rsp+38h] [rbp-51h]
  _KPROCESS *v36; // [rsp+40h] [rbp-49h]
  _QWORD v37[2]; // [rsp+50h] [rbp-39h] BYREF
  __int128 v38; // [rsp+60h] [rbp-29h]
  __int128 v39; // [rsp+70h] [rbp-19h]
  __int64 v40; // [rsp+80h] [rbp-9h]
  unsigned __int64 v41; // [rsp+88h] [rbp-1h]
...
LABEL_14:
        ...
        if ( (v18 & 0x100000) == 0 )
        {
          ...
          {
            ProtoPteAddress = MiGetProtoPteAddress(v14, v12 >> 12, 4, &v34);
            if ( ProtoPteAddress )
            {
...
LABEL_119:
  ...
  *((_QWORD *)&v38 + 1) = ProtoPteAddress;
  v42 = v14;
  if ( !ProtoPteAddress )
    return MiResolvePrivateZeroFault((int *)v37);
  if ( (v7 & 2) == 0 )
  {
    if ( v14 )
    {
      ...
      {
        v4 = MiCheckVadSequential(v37, v13, v5, Process);
        if ( v4 == -1073741280 )
        {
  ...
  *a3 = v20;
  *a4 = ProtoPteAddress;
  MiResolveSharedZeroFault((unsigned int *)v37);
  return v4;
}
