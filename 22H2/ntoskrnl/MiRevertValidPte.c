/*
 * XREFs of MiRevertValidPte @ 0x140278960
 * Callers:
...
__int64 __fastcall MiRevertValidPte(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4, __int64 a5)
{
  ...
  if ( a4 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * a4 - 0x21FFFFFFFFD8LL), 0x36u) )
  {
    v16 = 0LL;
LABEL_106:
    v59 = v16;
...
LABEL_22:
    ...
    {
      if ( LeafVa < qword_140C6A658 || (v21 = HIBYTE(word_140C66DFC), LeafVa > qword_140C67170) )
        v21 = (unsigned __int8)word_140C66DFC;
      v7 = a1;
      v12 = v55;
      goto LABEL_22;
    }
...
LABEL_24:
  ...
  if ( (v8 & 0x20000000) != 0 )
  {
    v18 ^= ((unsigned __int16)v18 ^ (unsigned __int16)((unsigned __int8)word_140C66DFC << 8)) & 0x100;
    v22 = v19;
  }
  if ( (v8 & 0x8000000) != 0 )
  {
    ...
    if ( v16 )
    {
      if ( (*(_DWORD *)(v7 + 48) & 0x70) != 0x40 || (result = MiRotatedToFrameBuffer(v36), (_DWORD)result) )
      {
        ...
        *(_BYTE *)(v16 + 34) |= 0x10u;
        if ( v5 )
        {
          v52 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v16 + 40) >> 43) & 0x3FFLL));
