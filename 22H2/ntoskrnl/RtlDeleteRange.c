/*
 * XREFs of RtlDeleteRange @ 0x1408179D0
 * Callers:
 *     ArbBacktrackAllocation @ 0x1409361B0 (ArbBacktrackAllocation.c)
 *     IopPortBacktrackAllocation @ 0x14095A170 (IopPortBacktrackAllocation.c)
 * Callees:
