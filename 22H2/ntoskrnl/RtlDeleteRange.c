/*
 * XREFs of RtlDeleteRange @ 0x140760A20
 * Callers:
 *     ArbBacktrackAllocation @ 0x1407D1F60 (ArbBacktrackAllocation.c)
 *     IopPortBacktrackAllocation @ 0x1408A3150 (IopPortBacktrackAllocation.c)
 * Callees:
