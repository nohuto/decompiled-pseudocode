/*
 * XREFs of ObWaitForMultipleObjects @ 0x1405FCDC0
 * Callers:
 ...
 *     ExFastReplenishHandleTableEntry @ 0x140322930 (ExFastReplenishHandleTableEntry.c)
...
LABEL_5:
      ...
      while ( 2 )
      {
        ...
        if ( (v19 & 0x3FC) != 0 )
        {
          v21 = (__int64 *)ExpLookupHandleTableEntry(v20, v19);
          v22 = v21;
          if ( v21 )
          {
            _m_prefetchw(v21);
...
LABEL_61:
        ...
        if ( v14 == 1 )
        {
          ...
          {
            v52 = v18 - *(unsigned __int8 *)((*(_BYTE *)(v18 + 26) & 0x7F) + v17 + 12738624);
        ...
        if ( WaitType != WaitAny
          && *(POBJECT_TYPE *)(v17
                             ...
                             * ((unsigned __int8)ObHeaderCookie ^ (unsigned __int8)v30 ^ (unsigned __int64)*(unsigned __int8 *)(v18 + 24))
                             + 13618784) == IoCompletionObjectType )
        {
          goto LABEL_60;
        }
        if ( ExCrossVmMutantObjectType
          && *(POBJECT_TYPE *)(v17
                             + 8
                             * ((unsigned __int8)ObHeaderCookie ^ (unsigned __int8)v30 ^ (unsigned __int64)*(unsigned __int8 *)(v18 + 24))
                             + 13618784) == ExCrossVmMutantObjectType )
        {
          v38 = -1073741788;
          goto LABEL_61;
        }
...
LABEL_28:
        ...
        if ( (unsigned int)v15 >= Count )
        {
          ...
          {
            v62 = 0;
            ExReleaseRundownProtection(v67 + 139);
          }
          CurrentThread = v68;
