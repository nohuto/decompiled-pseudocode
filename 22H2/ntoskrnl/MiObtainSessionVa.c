/*
 * XREFs of MiObtainSessionVa @ 0x14030B904
 * Callers:
...
LABEL_13:
  ...
  if ( ClearBitsAndSet == -1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v24 )
        goto LABEL_118;
      v55 = (unsigned __int64)&v50->LockEntries[v54];
      v53 &= ~(1 << v54);
      if ( (*(_BYTE *)(v55 + 26) & 1) != 0
        && (*(_DWORD *)(v55 + 32) & 1) == 0
...
LABEL_118:
    ...
    *(_BYTE *)(v55 + 25) &= ~1u;
    *(_QWORD *)(v55 + 32) = 0LL;
    v56 = (__int64)(v55 - (unsigned __int64)v50->LockEntries) / 96;
    if ( v52 == 1 )
      ...
      *(_BYTE *)(v26 + 26) &= ~1u;
      if ( *(_QWORD *)(v26 + 32) )
      {
        if ( v26 )
        {
          ...
          *(_BYTE *)(v26 + 25) &= ~1u;
          *(_QWORD *)(v26 + 32) = 0LL;
          v27 = (__int64)(v26 - (unsigned __int64)v20->LockEntries) / 96;
          if ( v22 == 1 )
