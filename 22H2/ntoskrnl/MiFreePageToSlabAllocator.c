/*
 * XREFs of MiFreePageToSlabAllocator @ 0x140338DB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     MiFreePageToSlabEntry @ 0x140338FBC (MiFreePageToSlabEntry.c)
...
LABEL_17:
    ...
    MiUpdateSlabPagePlaceholderState(a2, 0xAAAAAAAAAAAAAAABuLL * ((a3 + 0x220000000000LL) >> 4), 1LL, 1);
