/*
 * XREFs of CcChangeBackingFileObject @ 0x1404E8A28
 * Callers:
...
LABEL_29:
  ...
  if ( !v21 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v9 )
        goto LABEL_54;
      v31 = (unsigned __int64)&v27->LockEntries[v32];
      v30 &= ~(1 << v32);
      if ( (*(_BYTE *)(v31 + 26) & 1) != 0
        && (*(_DWORD *)(v31 + 32) & 1) == 0
...
LABEL_54:
    ...
    *(_DWORD *)(v31 + 88) = v34;
    *(_QWORD *)(v31 + 32) = 0LL;
    v35 = (__int64)(v31 - (unsigned __int64)v27->LockEntries) / 96;
    if ( v29 == 1 )
  ...
  if ( (*(_DWORD *)(v21 + 152) & 0x100000) == 0 )
  {
    ...
    if ( !a1 || v53 == a1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v9 )
          goto LABEL_147;
        v76 = (unsigned __int64)&v72->LockEntries[v77];
        v75 &= ~(1 << v77);
        if ( (*(_BYTE *)(v76 + 26) & 1) != 0
          && (*(_DWORD *)(v76 + 32) & 1) == 0
...
LABEL_147:
      ...
      *(_DWORD *)(v76 + 88) = v79;
      *(_QWORD *)(v76 + 32) = 0LL;
      v80 = (__int64)(v76 - (unsigned __int64)v72->LockEntries) / 96;
      if ( v74 == 1 )
...
LABEL_154:
      ...
      if ( v9 && ($C459BD0D405E8E46662177FB3D0A143F *)v72->ApcState.ApcListHead[0].Flink != &v72->152 )
    ...
    while ( 1 )
    {
      ...
      if ( v9 )
        goto LABEL_117;
      v62 = (unsigned __int64)&v27->LockEntries[v63];
      v61 &= ~(1 << v63);
      if ( (*(_BYTE *)(v62 + 26) & 1) != 0
        && (*(_DWORD *)(v62 + 32) & 1) == 0
...
LABEL_117:
    ...
    *(_DWORD *)(v62 + 88) = v65;
    *(_QWORD *)(v62 + 32) = 0LL;
    v66 = (__int64)(v62 - (unsigned __int64)v27->LockEntries) / 96;
    if ( v60 == 1 )
...
LABEL_124:
    ...
    if ( !v9 )
      return 0LL;
LABEL_125:
    if ( ($C459BD0D405E8E46662177FB3D0A143F *)v27->ApcState.ApcListHead[0].Flink != &v27->152 )
  ...
  while ( 1 )
  {
    ...
    if ( v9 )
      goto LABEL_84;
    v46 = (unsigned __int64)&v42->LockEntries[v47];
    v45 &= ~(1 << v47);
    if ( (*(_BYTE *)(v46 + 26) & 1) != 0
      && (*(_DWORD *)(v46 + 32) & 1) == 0
...
LABEL_84:
  ...
  *(_DWORD *)(v46 + 88) = v49;
  *(_QWORD *)(v46 + 32) = 0LL;
  v50 = (__int64)(v46 - (unsigned __int64)v42->LockEntries) / 96;
  if ( v44 == 1 )
...
LABEL_91:
  ...
  if ( v9 && ($C459BD0D405E8E46662177FB3D0A143F *)v42->ApcState.ApcListHead[0].Flink != &v42->152 )
