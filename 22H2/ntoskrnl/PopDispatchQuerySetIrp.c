/*
 * XREFs of PopDispatchQuerySetIrp @ 0x1403980A4
 * Callers:
  ...
  if ( a1 == (_QWORD *)PopInrushIrp )
  {
    ...
    if ( *(__int64 **)(PopIrpWorkerList + 8) == &PopIrpWorkerList )
    {
      ...
      *(_QWORD *)(v7 + 8) = v4;
      ...
      return KeReleaseSemaphoreEx((__int64)&PopIrpWorkerSemaphore, 0LL, 1LL, v3, 0);
    }
LABEL_7:
    __fastfail(3u);
  }
  v5 = (_QWORD *)qword_140C23A08;
  if ( *(__int64 **)qword_140C23A08 != &PopIrpWorkerList )
    goto LABEL_7;
  *v4 = &PopIrpWorkerList;
  a1[22] = v5;
  *v5 = v4;
  qword_140C23A08 = (__int64)(a1 + 21);
  return KeReleaseSemaphoreEx((__int64)&PopIrpWorkerSemaphore, 0LL, 1LL, v3, 0);
}
