/*
 * XREFs of SepDeleteSessionLowboxEntries @ 0x14034CFD4
 * Callers:
      ...
      if ( v15 == -1 )
      {
        ...
        *(_QWORD *)(v25 + 8) = v26;
        ...
        while ( 1 )
        {
          ...
          if ( v20 )
            break;
          v32 = (unsigned __int64)&v27->LockEntries[v31];
          v30 &= ~(1 << v31);
          if ( (*(_BYTE *)(v32 + 26) & 1) != 0
            && (*(_DWORD *)(v32 + 32) & 1) == 0
            ...
            *(_BYTE *)(v32 + 26) &= ~1u;
            if ( *(_QWORD *)(v32 + 32) )
            {
              if ( v32 )
              {
                ...
                *(_BYTE *)(v32 + 25) &= ~1u;
                *(_QWORD *)(v32 + 32) = 0LL;
                v33 = (__int64)(v32 - (unsigned __int64)v27->LockEntries) / 96;
                if ( v29 == 1 )
            ...
            *(_BYTE *)(v22 + 26) &= ~1u;
            if ( *(_QWORD *)(v22 + 32) )
            {
              if ( v22 )
              {
                ...
                *(_BYTE *)(v22 + 25) &= ~1u;
                *(_QWORD *)(v22 + 32) = 0LL;
                v23 = (__int64)(v22 - (unsigned __int64)v16->LockEntries) / 96;
                if ( v18 == 1 )
...
LABEL_34:
    ...
    while ( 1 )
    {
      ...
      if ( v20 )
        break;
      v39 = (unsigned __int64)&v35->LockEntries[v38];
      v37 &= ~(1 << v38);
      if ( (*(_BYTE *)(v39 + 26) & 1) != 0
        && (*(_DWORD *)(v39 + 32) & 1) == 0
        ...
        *(_BYTE *)(v39 + 26) &= ~1u;
        if ( *(_QWORD *)(v39 + 32) )
        {
          if ( v39 )
          {
            ...
            *(_BYTE *)(v39 + 25) &= ~1u;
            *(_QWORD *)(v39 + 32) = 0LL;
            v40 = (__int64)(v39 - (unsigned __int64)v35->LockEntries) / 96;
            if ( v36 == 1 )
