/*
 * XREFs of EtwpCovSampCaptureSample @ 0x1405AF118
 * Callers:
 *     EtwpCovSampProfileInterrupt @ 0x1405AF500 (EtwpCovSampProfileInterrupt.c)
 *     EtwpCoverageSamplerContextSwap @ 0x1405AFBFC (EtwpCoverageSamplerContextSwap.c)
 ...
 * Callees:
 *     EtwpCovSampCaptureBufferAddIP @ 0x1405AE4D8 (EtwpCovSampCaptureBufferAddIP.c)
