/*
 * XREFs of RtlpHpSegMgrVaCtxAlloc @ 0x1402FD80C
 * Callers:
      ...
      *((_WORD *)v10 - 3) = v14;
      ...
      else
      {
        ...
        while ( 1 )
        {
          ...
          if ( v20 )
            goto LABEL_55;
          v34 = (unsigned __int64)&CurrentThread->LockEntries[v33];
          v32 &= ~(1 << v33);
          if ( (*(_BYTE *)(v34 + 26) & 1) != 0
            && (*(_DWORD *)(v34 + 32) & 1) == 0
...
LABEL_55:
        ...
        *(_BYTE *)(v34 + 25) &= ~1u;
        *(_QWORD *)(v34 + 32) = 0LL;
        v35 = 1 << ((__int64)(v34 - (unsigned __int64)CurrentThread->LockEntries) / 96);
        if ( v31 == 1 )
