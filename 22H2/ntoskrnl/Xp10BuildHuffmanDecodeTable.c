/*
 * XREFs of Xp10BuildHuffmanDecodeTable @ 0x1409C4378
 * Callers:
            ...
            do
            {
              ...
              if ( v22 > 8 )
              {
                ...
                do
                {
                  ...
                  v32 -= 8;
                  v31 >>= 8;
                  v30 = *((unsigned __int8 *)qword_14001BC90 + v34) | (v30 << 8);
                  --v33;
                }
                while ( v33 );
                v22 = v41;
              ...
              if ( v32 )
                v30 = (*((unsigned __int8 *)qword_14001BC90 + (unsigned __int8)v31) | (v30 << 8)) >> (8 - v32);
