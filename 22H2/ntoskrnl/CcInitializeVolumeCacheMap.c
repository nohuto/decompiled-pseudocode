/*
 * XREFs of CcInitializeVolumeCacheMap @ 0x14030C890
 * Callers:
...
__int64 __fastcall CcInitializeVolumeCacheMap(__int64 a1, __int64 **a2)
{
  ...
  *(_DWORD *)v6 = 13632248;
  ...
  v13 = (_QWORD *)qword_140C488D8;
  v14 = v6 + 2;
  if ( *(__int64 **)qword_140C488D8 != &CcVolumeCacheMapList )
    __fastfail(3u);
  v6[3] = qword_140C488D8;
  *v14 = &CcVolumeCacheMapList;
  *v13 = v14;
  qword_140C488D8 = (__int64)(v6 + 2);
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
