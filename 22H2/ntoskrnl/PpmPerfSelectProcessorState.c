/*
 * XREFs of PpmPerfSelectProcessorState @ 0x1402E4770
 * Callers:
 *     PpmPerfSelectProcessorStates @ 0x1402E46E0 (PpmPerfSelectProcessorStates.c)
 * Callees:
...
char __fastcall PpmPerfSelectProcessorState(__int64 *a1)
{
  ...
  if ( (unsigned int)PpmMfBufferingThreshold > 0x64 )
    v3 = 100;
  v7 = &PpmCurrentProfile[342 * dword_140C2334C + 5];
  if ( v6 && PpmCurrentProfile == (__int64 *)PpmLowPowerProfile && byte_140C2338C && *(_BYTE *)(v6 + 329) < v3 )
  {
    v2 = 4096;
    v7 = (__int64 *)((char *)&unk_140C1EE68 + 2736 * dword_140C2334C);
    v48 = 4096;
  }
