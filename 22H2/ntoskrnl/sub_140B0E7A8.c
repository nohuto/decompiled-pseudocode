/*
 * XREFs of sub_140B0E7A8 @ 0x140B0E7A8
 * Callers:
...
__int64 __fastcall sub_140B0E7A8(_QWORD *a1, ULONG_PTR a2, unsigned int a3)
{
  ULONG_PTR v3; // r13
  _QWORD *v4; // rdi
  __int64 v5; // r15
...
LABEL_96:
  ...
  if ( (v34 & 0x10) != 0 && !(unsigned int)sub_140B130E0(v10, v38, v65, v66) )
  {
    v34 &= ~0x10u;
    v373 = v34;
  }
...
LABEL_112:
  ...
  {
    v40 = sub_140B19070(&v330, v38, v34);
    goto LABEL_303;
  }
  ...
  v339 = sub_140B12020(v70, v90, v89);
  v92 = (_BYTE *)v339;
  if ( !v339 )
  {
LABEL_238:
...
LABEL_165:
  ...
  {
    v119[8] |= 1u;
    if ( (unsigned int)sub_140B130E0(v92, v120, v111, v91) )
      v119[8] |= 4u;
  }
LABEL_166:
  v340 = v92;
  v330 = v92;
  v40 = sub_140B10838((unsigned int)&v340, (_DWORD)v333, v332, v120, v121, v373, (__int64)&v343, (__int64)&v348);
  if ( v40 < 0 )
  {
    v122 = a1;
    v68 = v330;
  ...
  *((_DWORD *)v126 + 60) = 48;
  ...
  v68 = (_BYTE *)sub_140B12020(v124, v149, *((unsigned int *)v124 + 585));
  if ( !v68 )
    goto LABEL_238;
...
LABEL_233:
  if ( (*((_DWORD *)v68 + 612) & 0x40000000) != 0 && (_DWORD)v160 )
    sub_1403F152C((__int64)v68, v159, v160, (__int64)(v146 + 28));
  v26 = (_DWORD)v337 == 0;
...
LABEL_294:
      ...
      {
        v339 = sub_140B12020(v68, v206, *((unsigned int *)v68 + 585));
        v207 = (_BYTE *)v339;
        if ( !v339 )
        {
          v40 = -1073741670;
  ...
  if ( (a3 & 0x80000004) != 0x80000004 )
  {
    ...
    if ( (unsigned int)v323 >= 0x14 )
    {
      ...
      for ( ii = v324 + v321; ii != v325; ii += 20LL )
      {
        ...
        if ( v328 )
        {
          result = sub_140B0E7A8(&v330, v328, a3 & 0x7FFFFFEF | 0x80000000);
          *v122 = v330;
