...
int __fastcall FsRtlpOplockCleanup(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v58 = &v31;
    v59 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)&byte_14002ADC7, 0LL, 0LL, 4u, &v55);
  }
  ...
  if ( (*(_DWORD *)(a1 + 144) & 0x1000000) != 0 )
  {
    ...
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&byte_14002AED7,
        0LL,
        0LL,
        5u,
        &v48);
...
LABEL_13:
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    LODWORD(v5) = tlgWriteTransfer_EtwWriteTransfer(
                    (__int64)&dword_140C03768,
                    (unsigned __int8 *)&byte_14002AE5F,
                    0LL,
                    0LL,
                    6u,
                    &v39);
