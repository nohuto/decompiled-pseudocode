/*
 * XREFs of SLGetSubscriptionPfn @ 0x1409FA3D8
 * Callers:
...
__int64 __fastcall SLGetSubscriptionPfn(__int64 a1, PVOID *a2)
{
  ...
  if ( *(_BYTE *)(a1 + 46856) )
  {
    ...
    if ( *(_BYTE *)(a1 + 46856) )
    {
      ...
      {
        v11 = -1073741595;
        local_unwind((ULONG_PTR)v14, (__int64)&loc_1409FA4A6);
      }
  ...
  {
    v11 = sub_140374F20(a1, (__int64)&qword_140A781A0, 0LL, 0LL, 0, (__int64)&v15);
    if ( v11 == -1073741789 )
    {
      v4 = v15;
      ...
      v11 = sub_140374F20(a1, (__int64)&qword_140A781A0, 0LL, (__int64)v5, v4, (__int64)&v15);
    }
