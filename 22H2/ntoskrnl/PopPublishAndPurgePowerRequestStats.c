/*
 * XREFs of PopPublishAndPurgePowerRequestStats @ 0x1408F646C
 * Callers:
 ...
 *     PoQueryStopWatch @ 0x14034CE3C (PoQueryStopWatch.c)
 ...
 *     PoResetStopWatch @ 0x14057FA84 (PoResetStopWatch.c)
