/*
 * XREFs of MmAcquireLoadLock @ 0x140704660
 * Callers:
...
struct _KTHREAD *MmAcquireLoadLock()
{
  ...
  if ( CurrentThread == (struct _KTHREAD *)qword_140C659D8 )
  {
    ++dword_140C659E0;
  }
  else
  {
    ...
    v2 = v1;
    if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C659D0, 0LL) )
      ExfAcquirePushLockExclusiveEx(&qword_140C659D0, v1, (__int64)&qword_140C659D0);
    if ( v2 )
      *(_BYTE *)(v2 + 18) = 1;
    qword_140C659D8 = (__int64)CurrentThread;
    dword_140C659E0 = 1;
  }
