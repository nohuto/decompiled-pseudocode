/*
 * XREFs of KiRemoveAndFreeCpuPartitionAssignmentProcess @ 0x14035C1DC
 * Callers:
 *     PspProcessDelete @ 0x1407615C0 (PspProcessDelete.c)
 * Callees:
 *     KxReleaseSpinLock @ 0x1402504E0 (KxReleaseSpinLock.c)
 *     KeAcquireSpinLockRaiseToDpc @ 0x140250D60 (KeAcquireSpinLockRaiseToDpc.c)
 *     KiRemoveCpuPartitionAssignmentProcess @ 0x14035C264 (KiRemoveCpuPartitionAssignmentProcess.c)
