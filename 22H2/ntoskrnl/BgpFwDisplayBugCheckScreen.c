/*
 * XREFs of BgpFwDisplayBugCheckScreen @ 0x1405C5644
 * Callers:
 ...
 *     BcpGetComponentOffsets @ 0x1405C508C (BcpGetComponentOffsets.c)
...
LABEL_43:
  ...
  LODWORD(BcpCursor) = dword_140C10F00[18 * DisplayType + 4];
  v14 = &dword_140C10F00[18 * DisplayType + 5];
  v15 = *v14;
  ...
  if ( (dword_140C134F0 & 0x20000) == 0 )
  {
    ...
    BcpDisplayCriticalString(
      ...
      dword_140C10F00[18 * DisplayType + 3],
      v13,
      (unsigned int)DisplayType);
  }
  v17 = dword_140C10F00[18 * DisplayType + 8];
  v18 = dword_140C10F00[18 * DisplayType + 4];
  v19 = (unsigned int)dword_140C10F00[18 * DisplayType + 2];
  HIDWORD(BcpCursor) = dword_140C4C5E0 + dword_140C10F00[18 * DisplayType + 9];
  if ( a1 == 456 )
  {
  ...
  BcpDisplayCriticalCharacter(v21, dword_140C10F00[18 * DisplayType + 2]);
  v23 = 1;
  if ( a1 == 456 )
  {
    v24 = &stru_140C53ED0;
  ...
  BcpDisplayCriticalString(&v24->Length, dword_140C10F00[18 * DisplayType + 2], v22, (unsigned int)DisplayType);
LABEL_28:
  v26 = 0;
  if ( !qword_140C13578
  ...
  if ( ComponentOffsets >= 0 )
  {
    ...
    dword_140C4C5E0 = dword_140C13428;
    if ( a1 != 456 )
    {
