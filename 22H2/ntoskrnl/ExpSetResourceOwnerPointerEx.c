/*
 * XREFs of ExpSetResourceOwnerPointerEx @ 0x1402DCAE0
 * Callers:
  ...
  if ( *(char *)(BugCheckParameter1 + 26) >= 0 )
  {
    ...
    else
    {
      ...
      if ( v16 && (v20 = *(_QWORD *)(BugCheckParameter1 + 16) + 16LL, v18 < v19) )
      {
        ...
        KeGetCurrentThread()->ResourceIndex = (v20 - v16) >> 4;
      }
      else
      {
LABEL_16:
    ...
    if ( (CurrentThread & 3) != 0 )
      ...
      v23 = *(unsigned __int8 *)(CurrentThread + 1032);
...
LABEL_94:
        ...
        KeGetCurrentThread()->ResourceIndex = ((__int64)v15 - v39) >> 4;
      }
    }
    v27 = a3 & 1;
    if ( !v20 )
