/*
 * XREFs of HalpIommuAllocateRemappingTableEntry @ 0x1404C5258
 * Callers:
 *     HalpIrtAllocateIndex @ 0x1408659D4 (HalpIrtAllocateIndex.c)
 * Callees:
 *     HalpIommuConvertPciBusMasterDescriptorToDeviceId @ 0x1403EF8CC (HalpIommuConvertPciBusMasterDescriptorToDeviceId.c)
