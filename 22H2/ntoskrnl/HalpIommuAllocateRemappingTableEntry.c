/*
 * XREFs of HalpIommuAllocateRemappingTableEntry @ 0x14050D8C8
 * Callers:
 *     HalpIrtAllocateIndex @ 0x140820818 (HalpIrtAllocateIndex.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x140429560 (_guard_dispatch_icall.c)
 *     HalpIommuConvertPciBusMasterDescriptorToDeviceId @ 0x14050DA34 (HalpIommuConvertPciBusMasterDescriptorToDeviceId.c)
 */
