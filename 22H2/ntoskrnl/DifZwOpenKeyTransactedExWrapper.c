/*
 * XREFs of DifZwOpenKeyTransactedExWrapper @ 0x1405F1D10
 * Callers:
 *     <none>
 * Callees:
        ...
        HANDLE TransactionHandle)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(564);
...
LABEL_17:
  result = ZwOpenKeyTransactedEx(KeyHandle, DesiredAccess, ObjectAttributes, OpenOptions, TransactionHandle);
  LODWORD(v24) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
