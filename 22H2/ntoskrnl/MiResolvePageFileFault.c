/*
 * XREFs of MiResolvePageFileFault @ 0x14066B52C
 * Callers:
...
__int64 MiResolvePageFileFault(unsigned __int64 *a1, unsigned __int64 a2, ...)
{
  ...
  v13 = *(unsigned __int16 **)(qword_140C674C8 + 8 * v11);
LABEL_15:
  v151 = 0LL;
  v14 = v3;
  v160 = 0LL;
  ...
  if ( v16 && *(_BYTE *)v15 == 4 )
  {
    ...
    LODWORD(v148) = 8;
    v151 = (_QWORD *)v15;
    v21 = *(unsigned __int16 **)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(v19 + 544) + 1838LL));
    v149 = v21;
LABEL_41:
    v22 = v150;
    goto LABEL_42;
  ...
  if ( v23 )
    v21 = *(unsigned __int16 **)(qword_140C674C8 + 8LL * *((unsigned __int16 *)v23 + 20));
  else
...
LABEL_309:
  ...
  if ( !v20
    ...
    || v170
    || *(volatile signed __int32 **)(qword_140C674C8 + 8 * ((*(_QWORD *)(v86 + 40) >> 43) & 0x3FFLL)) != v83
        ...
        *(unsigned __int8 *)(PageChain + 34) >> 6 != (unsigned int)MiProtectionToCacheAttribute(v162)) )
  {
    if ( (v140 & 0x20) == 0 )
      goto LABEL_204;
    if ( v83 == *(volatile signed __int32 **)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(v161 + 174))
  ...
  while ( 2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (v40 & 0x10) != 0
        ...
        && (v109 & 0x400) == 0
        && (v109 & 0x800) == 0
        && ((v111 = v109, !qword_140C65C40)
          ? (v112 = v10)
          : ((v109 & 0x10) != 0 ? (v111 = v109 & 0xFFFFFFFFFFFFFFEFuLL) : (v111 = v109 & ~qword_140C65C40),
             (v10 & 0x10) != 0 ? (v112 = v10) : (v112 = v10 & ~qword_140C65C40)),
