/*
 * XREFs of VfSettingsCheckForChanges @ 0x140ADBDA4
 * Callers:
 *     VfSetVerifierInformation @ 0x140ADE7E8 (VfSetVerifierInformation.c)
 * Callees:
 *     VfPendingCheckForChanges @ 0x140AD27C0 (VfPendingCheckForChanges.c)
 ...
 *     ViSettingsIoCheckForChanges @ 0x140ADBF18 (ViSettingsIoCheckForChanges.c)
 */
