/*
 * XREFs of DifRtlDowncaseUnicodeStringWrapper @ 0x1405EB460
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlDowncaseUnicodeStringWrapper(
...
LABEL_17:
  result = RtlDowncaseUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
