  ...
  if ( IsMinTCB >= 0 || (IsMinTCB = SeQuerySigningPolicyWorker(a1, (__int64)a2, a3, a4, v7, a5, a6, a7), IsMinTCB >= 0) )
  {
    ...
    if ( (*a5 & 0xF) != 8 )
    {
      if ( qword_140C37A00 )
      {
        LOBYTE(v11) = 8;
        LOBYTE(v13) = *a5;
        if ( (unsigned int)qword_140C37A00(v13, v11) )
        {
          if ( (SeCiDebugOptions & 4) != 0
            || (SeCiDebugOptions & 2) != 0 && (_BYTE)KdDebuggerEnabled && !(_BYTE)KdDebuggerNotPresent )
          {
            if ( qword_140C37A00 && (LOBYTE(v15) = 8, LOBYTE(v16) = v7, (unsigned int)qword_140C37A00(v16, v15))
              || (*a7 & 7) == 0 )
            {
              v14 = v7 & 0xF;
              *a5 = v7 & 0xF | *a5 & 0x30;
              v18 = (unsigned int (__fastcall *)(__int64, __int64))qword_140C37A00;
              if ( !qword_140C37A00 )
                goto LABEL_22;
              LOBYTE(v16) = v7;
            }
