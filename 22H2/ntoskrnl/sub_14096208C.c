/*
 * XREFs of sub_14096208C @ 0x14096208C
 * Callers:
...
__int64 __fastcall sub_14096208C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  unsigned int v7; // r8d
  unsigned int *v8; // rax
...
LABEL_19:
  if ( (v7 & 0x80000000) == 0 )
  {
    ...
    {
      if ( stru_140C13E60.Header.SignalState || !dword_140D2D1B4 )
      {
