/*
 * XREFs of SymCryptIntExtendedGcd @ 0x1403FD704
 * Callers:
 ...
 * Callees:
 *     KeReadStateSemaphore @ 0x1402F8730 (KeReadStateSemaphore.c)
 *     SymCryptDivisorCreate @ 0x1403F8BF8 (SymCryptDivisorCreate.c)
 *     SymCryptIntAddMixedSize @ 0x1403F8C28 (SymCryptIntAddMixedSize.c)
 ...
 *     SymCryptIntCopyMixedSize @ 0x1403F8CD0 (SymCryptIntCopyMixedSize.c)
 *     SymCryptIntCreate @ 0x1403F8CE8 (SymCryptIntCreate.c)
 *     SymCryptIntDivMod @ 0x1403F8D00 (SymCryptIntDivMod.c)
 *     SymCryptIntFromDivisor @ 0x1403F8D44 (SymCryptIntFromDivisor.c)
 *     SymCryptIntGetValueLsbits32 @ 0x1403F8DA4 (SymCryptIntGetValueLsbits32.c)
 *     SymCryptIntIsEqualUint32 @ 0x1403F8DBC (SymCryptIntIsEqualUint32.c)
 *     SymCryptIntMulMixedSize @ 0x1403F8E04 (SymCryptIntMulMixedSize.c)
 *     SymCryptIntSetValueUint32 @ 0x1403F8E54 (SymCryptIntSetValueUint32.c)
 *     SymCryptIntShr1 @ 0x1403F8E84 (SymCryptIntShr1.c)
 *     SymCryptIntSubMixedSize @ 0x1403F8E9C (SymCryptIntSubMixedSize.c)
 *     SymCryptIntSubSameSize @ 0x1403F8EB4 (SymCryptIntSubSameSize.c)
 *     SymCryptIntToDivisor @ 0x1403F8EE4 (SymCryptIntToDivisor.c)
