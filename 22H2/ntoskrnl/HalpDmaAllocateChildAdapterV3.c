/*
 * XREFs of HalpDmaAllocateChildAdapterV3 @ 0x1407C3E68
 * Callers:
 ...
 *     HalpDmaIsThinApiCapable @ 0x1403C6AC0 (HalpDmaIsThinApiCapable.c)
 ...
 *     HalpIommuCheckExceptionList @ 0x1404C5380 (HalpIommuCheckExceptionList.c)
        ...
        _DWORD *a12)
{
  ...
  if ( a11 || !a10 || SecurityPolicy != 1 )
  {
    ...
    if ( ObReferenceObjectByPointer(v13, 0x20000u, HalpDmaAdapterObjectType, 0) < 0
      || (int)ObInsertObjectEx((PADAPTER_OBJECT)v13, 0LL, 0x20000u, 0, 0, 0LL, (unsigned __int64 *)&Handle) < 0 )
    {
      goto LABEL_25;
    }
    ZwClose(Handle);
