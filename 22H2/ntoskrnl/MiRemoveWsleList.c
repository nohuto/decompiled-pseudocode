/*
 * XREFs of MiRemoveWsleList @ 0x1402E4B70
 * Callers:
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  if ( v73 )
  {
    ...
    if ( v58 )
    {
      ...
      if ( v57 )
        LODWORD(xmmword_140C4CD48) = xmmword_140C4CD48 - v57;
      if ( v59 )
        DWORD1(xmmword_140C4CD48) -= v59;
      v24 = 0LL;
      *(_QWORD *)(v3 + 136) -= v60;
      v25 = a2 - (_QWORD)a3;
      v71 = a2 - (_QWORD)a3;
        ...
        if ( v29 == 7 )
        {
          ...
          if ( *(_QWORD *)(a1 + 96) < *(_QWORD *)(v38 + 56) )
          {
            ...
            if ( *(_QWORD *)(a1 + 24) )
            {
              ...
              {
                v67.LockQueue.Lock = &SpinLock;
                v67.LockQueue.Next = 0LL;
                KxAcquireQueuedSpinLock((__int64)&v67, (volatile __int64 *)&SpinLock);
