/*
 * XREFs of HvpGenerateLogEntryChecksums @ 0x140705728
 * Callers:
 ...
 *     SymCryptMarvin32Init @ 0x1403F5BFC (SymCryptMarvin32Init.c)
 *     SymCryptMarvin32Result @ 0x1403F5C18 (SymCryptMarvin32Result.c)
 */
