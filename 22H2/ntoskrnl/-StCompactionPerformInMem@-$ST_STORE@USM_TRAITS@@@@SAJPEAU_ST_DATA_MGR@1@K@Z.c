/*
 * XREFs of ?StCompactionPerformInMem@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z @ 0x14034E9A0
 * Callers:
 ...
 *     ?StUnlockAndUnmapRegion@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KPEAD@Z @ 0x14034EDAC (-StUnlockAndUnmapRegion@-$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KPEAD@Z.c)
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StCompactionPerformInMem(__int64 a1, int a2)
{
  ...
  _OWORD v21[2]; // [rsp+40h] [rbp-158h] BYREF
  _BYTE v22[256]; // [rsp+60h] [rbp-138h] BYREF
  ...
  Emptiest = ST_STORE<SM_TRAITS>::StCompactionFindEmptiest(a1, v22, 32LL, v5);
  v8 = ST_STORE<SM_TRAITS>::StCompactionPickPriority(a1, v22, Emptiest, v21);
  v9 = (__int64)(*(_QWORD *)&v21[0] - *(_QWORD *)(a1 + 1032)) >> 1;
  v19 = v8;
...
LABEL_28:
          ...
          else
          {
            ...
            ST_STORE<SM_TRAITS>::StReleaseRegion(a1, v6, v17);
          }
          if ( v12 < 0 )
            goto LABEL_19;
          ++v13;
