/*
 * XREFs of HalpUpdateCoolingPacket @ 0x1404DC940
 * Callers:
...
char __fastcall HalpUpdateCoolingPacket(__int64 a1)
{
  ...
  if ( a1 && !HalpAcquiredInterface )
  {
    ...
    xmmword_140C48CB0 = *(_OWORD *)(a1 + 16);
    xmmword_140C48CC0 = *(_OWORD *)(a1 + 32);
    xmmword_140C48CD0 = *(_OWORD *)(a1 + 48);
    xmmword_140C48CE0 = *(_OWORD *)(a1 + 64);
    xmmword_140C48CF0 = *(_OWORD *)(a1 + 80);
    xmmword_140C48D00 = *(_OWORD *)(a1 + 96);
    xmmword_140C48D10 = *(_OWORD *)(a1 + 112);
    qword_140C48D20 = *(_QWORD *)(a1 + 72);
  }
