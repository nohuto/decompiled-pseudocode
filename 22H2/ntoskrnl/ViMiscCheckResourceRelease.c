/*
 * XREFs of ViMiscCheckResourceRelease @ 0x140AE24BC
 * Callers:
 *     VfMiscExReleaseResourceLite_Entry @ 0x140AC1830 (VfMiscExReleaseResourceLite_Entry.c)
 *     VfMiscExReleaseResourceForThreadLite_Entry @ 0x140AE0C50 (VfMiscExReleaseResourceForThreadLite_Entry.c)
 * Callees:
