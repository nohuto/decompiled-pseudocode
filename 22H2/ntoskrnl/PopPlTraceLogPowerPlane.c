/*
 * XREFs of PopPlTraceLogPowerPlane @ 0x14057EB14
 * Callers:
...
int __fastcall PopPlTraceLogPowerPlane(unsigned __int16 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned int)dword_140C02228 > 5 )
  {
    ...
    v68 = 4LL;
    v70 = 4LL;
    tlgWriteEx_EtwWriteEx((__int64)&dword_140C02228, (unsigned __int8 *)&byte_14002A0D1, a3, 1u, v13, v14, 7u, &v60);
  }
  v4 = *((_QWORD *)a1 + 6);
  for ( i = 0LL; i < v4; ++i )
  {
    ...
    if ( (unsigned int)dword_140C02228 > 5 )
    {
      ...
      tlgWriteEx_EtwWriteEx(
        ...
        (unsigned __int8 *)&dword_14002A1BC,
        a3,
        1u,
        v13,
        v14,
        ...
        do
        {
          ...
          if ( (unsigned int)dword_140C02228 > 5 )
          {
            ...
            LODWORD(v4) = tlgWriteEx_EtwWriteEx(
                            (__int64)&dword_140C02228,
                            (unsigned __int8 *)&byte_14002A12F,
                            a3,
                            1u,
                            v13,
                            v14,
