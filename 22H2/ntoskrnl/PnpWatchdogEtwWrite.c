/*
 * XREFs of PnpWatchdogEtwWrite @ 0x140560B10
 * Callers:
 *     PnpWatchdogSecondChanceCallback @ 0x140560F50 (PnpWatchdogSecondChanceCallback.c)
 ...
 *     PnpWatchdogExtractTriageInformation @ 0x140560E3C (PnpWatchdogExtractTriageInformation.c)
...
char __fastcall PnpWatchdogEtwWrite(__int64 a1, int a2)
{
  ...
  if ( a2 )
  {
    if ( a2 == 1 )
    {
      ...
      {
        case 1:
          LOBYTE(CurrentThread) = byte_140C0E20B;
          if ( byte_140C0E20B < 0 )
