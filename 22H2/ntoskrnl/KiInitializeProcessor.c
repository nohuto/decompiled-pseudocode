/*
 * XREFs of KiInitializeProcessor @ 0x140A8F178
 * Callers:
 ...
 *     KeInitializeThreadedDpc @ 0x1403875F0 (KeInitializeThreadedDpc.c)
 *     KiCreateDpcLimitsProcessorConfiguration @ 0x140387610 (KiCreateDpcLimitsProcessorConfiguration.c)
