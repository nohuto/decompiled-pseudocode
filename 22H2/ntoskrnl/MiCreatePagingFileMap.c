/*
 * XREFs of MiCreatePagingFileMap @ 0x14061C968
 * Callers:
...
LABEL_115:
      if ( v8 )
      {
        MiFreeLargeZeroPages((int)v12, (char *)v67, 0);
        if ( v10 )
...
LABEL_121:
              ...
              MiUpdateLargePageSectionPfns(v49, (unsigned __int64)v46, *(unsigned int *)(v2 + 32));
              v46 += 8 * v54;
              v70 += v54;
            }
