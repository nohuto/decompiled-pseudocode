/*
 * XREFs of ViKeWaitForMultipleObjectsCommon @ 0x1409DC480
 * Callers:
 *     VerifierKeWaitForMultipleObjects @ 0x1409DB8F0 (VerifierKeWaitForMultipleObjects.c)
 *     VerifierKeWaitForMultipleObjectsNoReboot @ 0x1409DB9D0 (VerifierKeWaitForMultipleObjectsNoReboot.c)
 * Callees:
