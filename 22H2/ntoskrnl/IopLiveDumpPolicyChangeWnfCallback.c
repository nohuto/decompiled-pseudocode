/*
 * XREFs of IopLiveDumpPolicyChangeWnfCallback @ 0x14094EB30
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)(&ValueName.MaximumLength + 1) = 0;
  ...
  if ( v2 )
  {
    ...
    if ( (unsigned int)dword_140C03870 > 5 && tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL) )
    {
      ...
      v20 = 4LL;
      v22 = 1LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03870, (unsigned __int8 *)byte_14002BA18, 0LL, 0LL, 5u, v16);
    }
    if ( KeyHandle )
      ZwClose(KeyHandle);
  ...
  else
  {
    ...
    if ( (unsigned int)dword_140C03870 > 5 && tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL) )
    {
      ...
      v17 = &v9;
      v18 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03870, (unsigned __int8 *)byte_14002B9DB, 0LL, 0LL, 3u, v16);
    }
    return 3221225485LL;
  }
}
