/*
 * XREFs of EtwSetPerformanceTraceInformation @ 0x1409385B0
 * Callers:
 ...
 *     EtwpUpdateLastBranchTracingEvents @ 0x140948244 (EtwpUpdateLastBranchTracingEvents.c)
 *     EtwpUpdateProcessorTraceConfiguration @ 0x14094838C (EtwpUpdateProcessorTraceConfiguration.c)
 *     EtwpUpdateProcessorTraceEvents @ 0x140948434 (EtwpUpdateProcessorTraceEvents.c)
