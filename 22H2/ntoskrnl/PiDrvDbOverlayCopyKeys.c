/*
 * XREFs of PiDrvDbOverlayCopyKeys @ 0x140970238
 * Callers:
        ...
        __int64 a8)
{
  ...
  ULONG v29; // r13d
  __int64 v30; // r14
  unsigned int v32; // [rsp+40h] [rbp-69h] BYREF
  ULONG v33; // [rsp+44h] [rbp-65h] BYREF
  unsigned int v34; // [rsp+48h] [rbp-61h] BYREF
  unsigned int v35; // [rsp+4Ch] [rbp-5Dh] BYREF
  ...
  if ( Key >= 0 )
  {
    ...
    if ( Key >= 0 )
    {
      if ( (int)PnpCtxRegQueryInfoKey(v13, KeyHandle, 0LL, &v32, 0LL, &v35, &v33) < 0 )
      {
        v15 = 0;
      }
      else
          ...
          if ( v17 == -2147483622 )
          {
            if ( Key >= 0 )
            {
              ...
              while ( 1 )
              {
                v34 = v15 >> 1;
                v33 = v29;
                v17 = PnpCtxRegEnumValue(v18, KeyHandle, v12, Pool2, &v34, &v43, v10, &v33);
                if ( v17 == -2147483622 )
                  break;
                if ( v17 == -1073741789 )
                {
...
LABEL_75:
          ...
          Key = PnpCtxRegQueryInfoKey(v26, Handle, &v41, 0LL, 0LL, 0LL, 0LL);
          if ( Key >= 0 )
          {
            if ( !v41 )
            {
