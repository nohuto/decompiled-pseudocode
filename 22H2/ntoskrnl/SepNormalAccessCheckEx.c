/*
 * XREFs of SepNormalAccessCheckEx @ 0x1403744CC
 * Callers:
...
LABEL_21:
            v33 = a2;
LABEL_22:
            if ( SepSidInToken(v33, 0LL, v32, 0, v25, a12, a15) )
              AuthzBasepAddAccessTypeList(v22, v20, 0, v26, *((_DWORD *)v27 + 1), 0);
            goto LABEL_24;
          }
          if ( *v27 != 9 )
            goto LABEL_24;
        ...
        switch ( v30 )
        {
          case 5:
            v38 = *((_DWORD *)v27 + 2);
            v39 = v38 & 1;
            v40 = (unsigned __int64)(v27 + 12) & -(__int64)((v38 & 1) != 0);
            if ( v40 )
            {
              if ( a10
                && SepSidInToken(a2, 0LL, &v27[16 * v39 + ((8LL * (v38 & 2)) | 0xC)], 0, a11, a12, a15)
                && (unsigned __int8)AuthzBasepObjectInTypeList(v40, v22, v20, &v62) )
              {
                AuthzBasepAddAccessTypeList(v22, v20, v62, v26, *((_DWORD *)v27 + 1), 0);
              }
              goto LABEL_42;
            }
            v25 = a11;
            v32 = &v27[16 * v39 + ((8LL * (v38 & 2)) | 0xC)];
            goto LABEL_21;
          case 4:
            if ( !SepSidInToken(a2, 0LL, &v27[4 * (unsigned __int8)v27[13] + 20], 0, v25, a12, a15) )
              break;
            v33 = v63;
            v32 = v27 + 12;
            goto LABEL_22;
          case 1:
LABEL_60:
            if ( SepSidInToken(a2, 0LL, v27 + 8, 1, v25, a12, 0) && (*(_DWORD *)(v22 + 24) & *((_DWORD *)v27 + 1)) != 0 )
            {
              result = AuthzBasepSetAccessReasons(
                         *(_DWORD *)(v22 + 24) & *((_DWORD *)v27 + 1),
                         0x20000,
                         v26,
                         *(_QWORD *)(v22 + 40),
                         0);
          ...
          case 9:
            ...
            if ( *((unsigned __int16 *)v27 + 1) - v43 == 8 )
              goto LABEL_42;
            if ( a5 && !*a6 )
            ...
            if ( v44 )
              ...
              v48 = 0LL;
            v49 = *((unsigned __int16 *)v27 + 1) - v43 - 8;
            v50 = v43;
            v25 = a11;
          ...
          default:
            if ( a13 && v30 == 10 && KeGetCurrentIrql() < 2u )
            {
              ...
              if ( *((unsigned __int16 *)v27 + 1) - v51 == 8 )
                goto LABEL_42;
              if ( a5 && !*a6 )
                AuthzBasepInitializeResourceClaimsFromSacl(a5, a6);
              v52 = *(_QWORD **)(a2 + 1096);
              ...
              v55 = v52 ? v52[74] : 0LL;
              v56 = v52 ? v52[72] : 0LL;
              v57 = *((unsigned __int16 *)v27 + 1) - v51 - 8;
              v58 = v51;
              v25 = a11;
              AuthzBasepEvaluateAceCondition(
                a2,
