/*
 * XREFs of SshpAlpcProcessAlpcMessage @ 0x14084D7DC
 * Callers:
...
__int64 __fastcall SshpAlpcProcessAlpcMessage(__int64 a1, __int64 a2)
{
  ...
  switch ( v2 & 0xFFFF00FF )
  {
    ...
    case 10LL:
      ...
      ExAcquirePushLockExclusiveEx((ULONG_PTR)&stru_140C38568, 0LL);
      v9 = v16;
      if ( (int)ZwAlpcAcceptConnectPort((__int64)&qword_140C38570, SshpAlpcContext) < 0 )
      {
        ZwAlpcAcceptConnectPort((__int64)&qword_140C38570, SshpAlpcContext);
      }
      else
      {
        v10[0] = 0;
        ...
        {
          LOBYTE(v9) = 0;
          SshpAlpcSendMessage(192 * v7, 2 - (unsigned int)(dword_140C38578[48 * v7] != 0), 4LL, v10, (_DWORD)v9);
