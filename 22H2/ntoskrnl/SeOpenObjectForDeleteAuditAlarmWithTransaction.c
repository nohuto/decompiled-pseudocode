/*
 * XREFs of SeOpenObjectForDeleteAuditAlarmWithTransaction @ 0x1409CE210
 * Callers:
 *     SeOpenObjectForDeleteAuditAlarm @ 0x1409CE1B0 (SeOpenObjectForDeleteAuditAlarm.c)
 * Callees:
...
LABEL_49:
            ...
            {
              v33 = (__int128 *)TransactionId;
              if ( !TransactionId )
                v33 = (__int128 *)(AuxData + 4);
