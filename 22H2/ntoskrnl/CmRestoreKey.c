/*
 * XREFs of CmRestoreKey @ 0x14087BF80
 * Callers:
...
__int64 __fastcall CmRestoreKey(_QWORD *a1, void *a2, int a3, char a4)
{
  ...
  __int64 v23; // r13
  __int64 v24; // rcx
  void (__fastcall *v25)(ULONG_PTR, _DWORD *); // rax
  char v26; // bl
  __int64 v27; // rdx
  __int64 v28; // r8
  __int64 v29; // r8
  ...
  _DWORD v76[3]; // [rsp+BCh] [rbp-44h] BYREF
  unsigned int v77; // [rsp+C8h] [rbp-38h]
  unsigned int v78; // [rsp+CCh] [rbp-34h] BYREF
  _DWORD v79[2]; // [rsp+D0h] [rbp-30h] BYREF
  _DWORD v80[2]; // [rsp+D8h] [rbp-28h] BYREF
  __int128 v81; // [rsp+E0h] [rbp-20h] BYREF
  __int128 v82; // [rsp+F0h] [rbp-10h] BYREF
  _WORD *v83; // [rsp+100h] [rbp+0h]
  _OWORD v84[2]; // [rsp+108h] [rbp+8h] BYREF
  _BYTE v85[432]; // [rsp+130h] [rbp+30h] BYREF
  ...
  *(_QWORD *)&v76[1] = 0xFFFFFFFFLL;
  ...
  v81 = 0LL;
  v74 = 0LL;
  CmpInitializeDelayDerefContext(&v81);
  v9 = a1[1];
  v10 = *(_QWORD *)(v9 + 32);
...
LABEL_8:
  ...
  *(_QWORD *)&v82 = &v82;
  ...
  Hive = CmpCreateHive((ULONG_PTR *)&P, 2u, 0x8000, 0, 0LL, v84, 0LL, 18415617, 0LL, 0LL, 0LL, (__int64)v85);
  if ( Hive < 0 )
    goto LABEL_119;
...
LABEL_117:
  ...
  v19 = HvReallocateCell(v10, v18, (unsigned int)*(unsigned __int16 *)(v8 + 72) + 76, 1, &v72, (__int64 *)&v76[1]);
  BugCheckParameter3_4 = v19;
  v20 = v19;
  if ( v19 == -1 )
  {
    Hive = -1073741670;
...
LABEL_115:
  ...
  v25 = *(void (__fastcall **)(ULONG_PTR, _DWORD *))(v10 + 16);
  v67 = 0LL;
  v8 = 0LL;
  v25(v10, &v76[1]);
  v72 = 0LL;
...
LABEL_111:
    ...
    if ( Hive < 0 )
      goto LABEL_111;
    LOBYTE(v29) = a4;
    Hive = CmpDoAccessCheckOnSubtree(v10, BugCheckParameter3, v29, (struct _LOOKASIDE_LIST_EX *)0x10000, 2);
    if ( Hive < 0 )
      goto LABEL_111;
    if ( (v68 & 8) == 0 )
      break;
    ...
    if ( v30 != -1073741267 )
    {
      ...
      if ( !v26 )
      {
        CmpInvalidateAllHigherLayerKcbs(v9, 1, 0, (__int64)&v81);
        CmpInvalidateSubtree(v9, 1, 0, (__int64)&v81, 0LL);
        CmpDrainDelayDerefContext((_QWORD **)&v81);
        goto LABEL_62;
      }
    }
    CmpLogTransactionAbortedForRollbackPacket(v9, 7u);
...
LABEL_62:
  ...
  v72 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(v10 + 8))(v10, BugCheckParameter3, &v76[1]);
  if ( !v72 )
  {
LABEL_65:
    Hive = -1073741670;
  ...
  if ( v32 )
  {
    ...
    if ( !v37 )
      goto LABEL_65;
    v38 = *(_DWORD *)(v37 + 4LL * v77 + 28);
    v39 = *(void (__fastcall **)(ULONG_PTR, _DWORD *))(v10 + 16);
    v78 = v38;
    v39(v10, v70);
    v40 = (_WORD *)(*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(v10 + 8))(v10, v38, v80);
    v83 = v40;
    if ( !v40 )
    {
LABEL_68:
      ...
      while ( 1 )
      {
        ...
        if ( ((*v43 - 26220) & 0xFDFF) != 0 )
        {
          if ( v43[1] )
          {
            ...
            v31 = BugCheckParameter3_4;
            *(_DWORD *)&v43[2 * v47 + 2] = BugCheckParameter3_4;
LABEL_104:
        ...
        else if ( v43[1] )
        {
          ...
          v31 = BugCheckParameter3_4;
          *(_DWORD *)&v43[4 * v47 + 2] = BugCheckParameter3_4;
          goto LABEL_104;
        }
LABEL_92:
...
LABEL_94:
  ...
  else
  {
    ...
    if ( !v34 )
      goto LABEL_68;
    *(_DWORD *)(v34 + 28) = BugCheckParameter3_4;
    (*(void (__fastcall **)(__int64, _DWORD *))(CmpMasterHive + 16))(CmpMasterHive, v70);
    v35 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(v10 + 8))(v10, BugCheckParameter3_4, v69);
    v8 = v35;
    if ( !v35 )
    {
LABEL_70:
  ...
  *(_DWORD *)(v9 + 40) = v31;
  ...
  v79[1] = 0;
  v54 = (*(__int64 (__fastcall **)(__int64, __int64, _DWORD *))(v52 + 8))(v52, v53, v79);
  v8 = 0LL;
  v55 = v54;
  if ( !v54 )
    goto LABEL_70;
  ...
  *(_BYTE *)(v9 + 185) = *(_BYTE *)(v55 + 55);
  (*(void (__fastcall **)(__int64, _DWORD *))(v58 + 16))(v58, v79);
  *(_WORD *)(v9 + 8) = 64;
  if ( (unsigned __int8)CmpDeleteTree(v10) )
    CmpFreeKeyByCell(v10, BugCheckParameter3, 0);
  CmpReportNotify(v9, 0, 1, (__int64)&v82);
  if ( !CmpProfileLoaded )
  {
  ...
  P = 0LL;
  CmpSignalDeferredPosts((_QWORD **)&v82);
LABEL_119:
  CmpDrainDelayDerefContext((_QWORD **)&v81);
  if ( v4 )
    CmpUnlockRegistry();
  ...
  if ( v8 )
    (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(v10 + 16))(v10, v69);
  if ( v72 )
    (*(void (__fastcall **)(ULONG_PTR, _DWORD *))(v10 + 16))(v10, &v76[1]);
  CmpCleanupRollbackPacket((__int64)&v74);
