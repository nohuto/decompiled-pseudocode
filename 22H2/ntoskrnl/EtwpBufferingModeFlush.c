/*
 * XREFs of EtwpBufferingModeFlush @ 0x1408A7F08
 * Callers:
 ...
 *     EtwpFindAndLockBufferForFlushing @ 0x1408A8584 (EtwpFindAndLockBufferForFlushing.c)
 */
...
__int64 __fastcall EtwpBufferingModeFlush(unsigned int *a1)
{
  ...
  if ( (a1[3] & 0x40000) != 0 )
  {
    ...
    GuidEntryByGuid = EtwpFindGuidEntryByGuid(CurrentServerSiloGlobals[108], qword_140015120, 0);
