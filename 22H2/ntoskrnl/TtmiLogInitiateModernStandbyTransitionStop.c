/*
 * XREFs of TtmiLogInitiateModernStandbyTransitionStop @ 0x1409A8A6C
 * Callers:
...
void __fastcall TtmiLogInitiateModernStandbyTransitionStop(int a1)
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v9 = &v4;
      v4 = a1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)byte_140033570, 0LL, 0LL, 4u, &v5);
    }
  }
}
