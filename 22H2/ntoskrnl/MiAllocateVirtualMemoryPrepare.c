/*
 * XREFs of MiAllocateVirtualMemoryPrepare @ 0x1406F6C60
 * Callers:
...
__int64 MiAllocateVirtualMemoryPrepare(ULONG_PTR a1, unsigned __int64 a2, ...)
{
  ...
  *(_QWORD *)(v55 + 96) = Process;
  ...
  if ( a1 != -1LL )
  {
    v14 = ObpReferenceObjectByHandleWithTag(a1, 8, (__int64)PsProcessType, v51, 0x6D566D4Du, &Object, 0LL, 0LL);
    if ( v14 < 0 )
      goto LABEL_84;
    Process = Object;
    v4 = v47;
  ...
  if ( v14 >= 0 )
  {
    if ( !v11 || (v14 = xHalUnmaskInterrupt(), v14 >= 0) )
    {
      ...
      if ( *(_QWORD *)(v5 + 24)
        ...
        && ((v8 & 0x20400000) != 0x20400000 || (*(_BYTE *)(v5 + 56) & 2) == 0) )
      {
        goto LABEL_83;
      }
      v16 = *(_QWORD *)(v5 + 56);
      ...
      else
      {
        ...
        {
LABEL_18:
          if ( ((v8 & 0x2000) == 0 || v6) && (*(_QWORD *)v5 || *(_QWORD *)(v5 + 8) || *(_QWORD *)(v5 + 16)) )
            goto LABEL_83;
          if ( v45 )
          {
            ...
            if ( v14 < 0 )
              goto LABEL_84;
            if ( (v8 & 0x2000) != 0 && !v6 )
              *(_QWORD *)(v5 + 8) = MiGetUserReservationHighestAddress(v41, v45);
            v15 = v47;
            v18 = v8 & 0x20400000;
            v20 = v55;
          }
                ...
                if ( ((v26 - 1) & *(_QWORD *)v5) == 0 )
                {
                  ...
                  else
                  {
                    if ( (v8 & 0x2000) != 0 && !v24 && (v8 & 0x4000) == 0 )
                    {
                      ...
                      *(_QWORD *)(v5 + 8) = UserReservationHighestAddress;
                      if ( v29 && (v29 & 2) == 0 )
                      {
                        if ( (v29 & 8) != 0 )
                        {
