/*
 * XREFs of ObpCreateDirectoryObject @ 0x1406868E0
 * Callers:
 *     NtCreateDirectoryObjectEx @ 0x1406868A0 (NtCreateDirectoryObjectEx.c)
...
LABEL_7:
  if ( !a4
    || (v19 = 0LL,
        ...
        inserted >= 0) )
  {
    inserted = ObCreateObjectEx(PreviousMode, ObpDirectoryObjectType, a3, PreviousMode, Object, 344, 0, 0, &v18, 0LL);
    if ( inserted >= 0 )
    {
      v12 = v18;
