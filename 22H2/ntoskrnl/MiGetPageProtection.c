/*
 * XREFs of MiGetPageProtection @ 0x140272900
 * Callers:
 ...
 *     MiGetValidAweProtection @ 0x14064AAF4 (MiGetValidAweProtection.c)
 */
  ...
  *a4 = 0;
  ...
  if ( (v9 & 1) == 0 )
  {
    if ( (v9 & 0x400) == 0 )
    {
      ...
      {
        v23 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v22 + 40) >> 43) & 0x3FFLL));
      ...
      {
        *v5 = **(_WORD **)(qword_140C674C8 + 8LL * KeGetCurrentThread()->ApcState.Process[1].IdealProcessor[25]);
      }
      v24 = (v9 >> 5) & 0x1F;
    ...
    if ( !(unsigned int)MiIsPrototypePteVadLookup(v9, 0LL, a3) )
    {
      ...
      else
      {
        ...
        if ( !Process[1].Affinity.StaticBitmap[12] || (CloneAddress = MiLocateCloneAddress(Process, v28, v26)) == 0 )
        {
          ...
          *v5 = **(_WORD **)(qword_140C674C8 + 8LL * (*(_WORD *)(**(_QWORD **)(BugCheckParameter2 + 72) + 60LL) & 0x3FF));
  ...
  if ( v12 == 16 )
  {
    if ( v13 <= qword_140C65CA0 && ((*(_QWORD *)(48 * v13 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
