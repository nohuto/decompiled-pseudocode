/*
 * XREFs of KeMarkHiberPhase @ 0x1409AF0C8
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( qword_140C2B3D8 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C2B3D8, 16 * (unsigned int)(unsigned __int8)qword_140C2B3C8, 0x7272744Du);
  if ( qword_140C2B3E0 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C2B3E0, 0x58uLL, 0x7272744Du);
  v13 = *(_QWORD **)(v1 + 8);
