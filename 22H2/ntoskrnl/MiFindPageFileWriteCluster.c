/*
 * XREFs of MiFindPageFileWriteCluster @ 0x140639960
 * Callers:
 ...
 *     RtlFindLongestRunClearCapped @ 0x1405A80B0 (RtlFindLongestRunClearCapped.c)
...
_DWORD *__fastcall MiFindPageFileWriteCluster(__int64 a1, unsigned int *a2, unsigned int *a3, int a4)
{
  ...
  FreePageFileSpace = MiFindFreePageFileSpace(v9, (__int64 *)&v30, v4, v10 != 0 ? 38 : 32);
  if ( FreePageFileSpace )
  {
    v12 = v30;
    if ( qword_140C65C40 && (v30 & 0x10) == 0 )
      v12 = v30 & ~qword_140C65C40;
    v13 = HIDWORD(v12);
  }
  else
  {
