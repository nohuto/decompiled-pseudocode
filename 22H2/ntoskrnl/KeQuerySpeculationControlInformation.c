/*
 * XREFs of KeQuerySpeculationControlInformation @ 0x14097485C
 * Callers:
 ...
 *     HvlQueryL1tfMitigationInformation @ 0x14053FBF8 (HvlQueryL1tfMitigationInformation.c)
 *     KiIsFbClearSupported @ 0x1405792F0 (KiIsFbClearSupported.c)
 */
