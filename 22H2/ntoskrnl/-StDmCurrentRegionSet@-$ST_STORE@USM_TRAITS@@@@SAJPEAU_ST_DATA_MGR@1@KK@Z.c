/*
 * XREFs of ?StDmCurrentRegionSet@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@KK@Z @ 0x14034EC64
 * Callers:
 ...
 *     ?StDmUpdateRegionsToCompactBitmap@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KKK@Z @ 0x14026A608 (-StDmUpdateRegionsToCompactBitmap@-$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KKK@Z.c)
...
LABEL_3:
    *v5 = -1;
    if ( (_DWORD)v3 != (_DWORD)v6 && (_DWORD)v6 != -1 )
    {
      ...
      if ( (v10 & 0x1FFF) != 0 )
        ...
        ST_STORE<SM_TRAITS>::StReleaseRegion(a1, v6, a3);
    }
    if ( (_DWORD)v3 != -1 )
    {
      if ( v8 )
  ...
  v11 = *(_QWORD *)(a1 + 1032);
  v12 = ST_STORE<SM_TRAITS>::StMapAndLockRegion(a1, (unsigned int)a3, a2, 0LL);
  v7 = v12;
  if ( !v12 )
    return 3221225514LL;
  if ( v12 == -1 )
