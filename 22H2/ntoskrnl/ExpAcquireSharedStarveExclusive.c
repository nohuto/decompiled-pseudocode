/*
 * XREFs of ExpAcquireSharedStarveExclusive @ 0x14029EDE0
 * Callers:
 ...
 *     ExpGetThreadResourceHint @ 0x14029EB90 (ExpGetThreadResourceHint.c)
...
LABEL_10:
    ...
    if ( v20 )
    {
      EmptyEntry = ExpFindEmptyEntry(a1, &LockHandle, 1LL);
    }
    else
    {
  ...
  {
    v24 = *(_DWORD *)(EmptyEntry + 8) + 8;
    *(_DWORD *)(EmptyEntry + 8) = v24;
    v25 = v24 >> 3;
    KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
