/*
 * XREFs of ExInitializeSessionHeapManager @ 0x14039CEC4
 * Callers:
 ...
 *     MiSessionPoolTrackTable @ 0x1406A68B0 (MiSessionPoolTrackTable.c)
 *     MiSessionPoolTrackTableSize @ 0x1407D4E08 (MiSessionPoolTrackTableSize.c)
