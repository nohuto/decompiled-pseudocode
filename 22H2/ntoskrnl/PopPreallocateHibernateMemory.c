/*
 * XREFs of PopPreallocateHibernateMemory @ 0x14079B89C
 * Callers:
...
__int64 PopPreallocateHibernateMemory()
{
        ...
        (int)result >= 0) )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        qword_140C23EA8 = (__int64)(v12 + 4096);
        Length = v10;
        qword_140C23E90 = v12;
        qword_140C23EA0 = (__int64)v12;
        if ( dword_140C197B0 == 2 )
          qword_140C23EF8 = (__int64)&v12[v0];
        else
          qword_140C23EF8 = 0LL;
        LODWORD(xmmword_140C23EC0) = v4;
        *((_QWORD *)&xmmword_140C23EC0 + 1) = &v12[v16];
        LODWORD(xmmword_140C23EB0) = v4;
        *((_QWORD *)&xmmword_140C23EB0 + 1) = &v12[v17];
        qword_140C23ED0 = (__int64)&v12[v18];
        if ( dword_140C197B0 == 2 )
          qword_140C23F00 = (__int64)&v12[v7];
        else
          qword_140C23F00 = 0LL;
        qword_140C23ED8 = &v12[v9];
        Address = &v12[((_DWORD)v9 + 4159) & 0xFFFFF000];
        qword_140C23EE8 = &v12[v8];
        qword_140C23EF0 = (__int64)&v12[v19];
        return 0LL;
      }
