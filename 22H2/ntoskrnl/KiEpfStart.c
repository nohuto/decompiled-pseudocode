/*
 * XREFs of KiEpfStart @ 0x140524194
 * Callers:
...
LABEL_6:
  ...
  if ( v5 )
  {
    _InterlockedIncrement(&dword_140C2B150);
    v6 = _InterlockedIncrement(&dword_140C2B154);
    do
      v9 = dword_140C2B158;
    while ( dword_140C2B158 < v6 && v9 != _InterlockedCompareExchange(&dword_140C2B158, v6, dword_140C2B158) );
    v10 = KeSetKernelStackSwapEnable(0);
    KeWaitForGate((__int64)&v14, 39);
    KeSetKernelStackSwapEnable(v10);
    _InterlockedDecrement(&dword_140C2B154);
  }
}
