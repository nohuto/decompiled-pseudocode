/*
 * XREFs of RtlpGenericInverseCouplingWorker @ 0x140590770
 * Callers:
 *     RtlScrubMemory @ 0x1405904A8 (RtlScrubMemory.c)
 * Callees:
 *     RtlpTestAndFillMemoryUp @ 0x140590FEC (RtlpTestAndFillMemoryUp.c)
 *     RtlpTestMemory @ 0x140591014 (RtlpTestMemory.c)
 */
