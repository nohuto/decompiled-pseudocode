/*
 * XREFs of MiSectionDelete @ 0x140721C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiSectionDelete(__int64 a1)
{
  ...
  if ( *(_QWORD *)(v3 + 24) )
  {
    ...
    v8 = KeAbPreAcquire((__int64)&qword_140C65650, 0LL);
    v9 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65650, 0LL);
    v10 = v8;
    if ( v9 )
      ExfAcquirePushLockExclusiveEx(&qword_140C65650, v8, (__int64)&qword_140C65650);
    if ( v10 )
      *(_BYTE *)(v10 + 18) = 1;
    RtlAvlRemoveNode((unsigned __int64 *)&qword_140C65648, (unsigned __int64 *)a1);
