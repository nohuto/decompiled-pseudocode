/*
 * XREFs of PopDecompressHiberBlocks @ 0x140AA23F4
 * Callers:
 ...
 *     RtlDecompressBufferProgress @ 0x1405B3604 (RtlDecompressBufferProgress.c)
 *     MmMapMemoryDumpMdlEx2 @ 0x140630718 (MmMapMemoryDumpMdlEx2.c)
 ...
 *     PopReadProducerConsumerBuffer @ 0x140AA3ADC (PopReadProducerConsumerBuffer.c)
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  v8 = (char *)qword_140C3D098;
  v9 = 0;
  v49 = 0;
  v52 = 0LL;
  v46 = 0;
  v47 = (char *)qword_140C3D098;
  while ( 1 )
  {
    PopHiberCheckForDebugBreak();
    if ( !qword_140C3D518 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_140C3D040 )
      qword_140C3D518 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_140C3D041
      && (!byte_140C3D040 || (unsigned int)dword_140C3D024 > 0x640) )
    {
      v12 = __rdtsc();
      if ( byte_140D17FB8 )
      {
      ...
      v13 = __rdtsc();
      qword_140C3D500 += (((unsigned __int64)HIDWORD(v13) << 32) | (unsigned int)v13) - v12;
    }
    v45 = 4;
