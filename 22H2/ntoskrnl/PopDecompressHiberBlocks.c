/*
 * XREFs of PopDecompressHiberBlocks @ 0x140995054
 * Callers:
 ...
 *     RtlDecompressBufferProgress @ 0x140591DF0 (RtlDecompressBufferProgress.c)
 ...
 *     PopReadProducerConsumerBuffer @ 0x1409B1830 (PopReadProducerConsumerBuffer.c)
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  LODWORD(v8) = (_DWORD)qword_140C23ED8;
  v9 = 0;
  v43 = 0;
  v47 = 0LL;
  v41 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( !qword_140C24118 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_140C23E80 )
      qword_140C24118 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_140C23E81
      && (!byte_140C23E80 || (unsigned int)dword_140C23E64 > 0x640) )
    {
      v15 = __rdtsc();
      if ( byte_140C50650 )
      {
      ...
      v16 = __rdtsc();
      qword_140C24100 += (((unsigned __int64)HIDWORD(v16) << 32) | (unsigned int)v16) - v15;
    }
    v40 = 4;
