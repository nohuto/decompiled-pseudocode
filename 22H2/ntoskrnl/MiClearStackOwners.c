/*
 * XREFs of MiClearStackOwners @ 0x14033D41C
 * Callers:
...
__int64 __fastcall MiClearStackOwners(__int64 a1, char a2)
{
  ...
  else
  {
    ...
    v5 = 3;
    if ( v4 )
      v5 = (unsigned __int8)byte_140C685BC;
  }
  v6 = a1 - 8LL * v5;
  v7 = v6 + 8LL * (v5 + 1);
  v8 = v6 + 8;
  while ( v8 < v7 )
  {
    ...
    if ( (v13 & 1) != 0 )
    {
      v9 = 48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v13) >> 12) & 0xFFFFFFFFFFLL);
      v14 = 0;
