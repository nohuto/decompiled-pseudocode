/*
 * XREFs of AnFwDisplayFade @ 0x140AED9AC
 * Callers:
 ...
 *     BgpTxtGetRegionContext @ 0x140AED6D0 (BgpTxtGetRegionContext.c)
...
__int64 AnFwDisplayFade()
{
  ...
  if ( (dword_140C0E4B0 & 0x2000) != 0 )
    return (unsigned int)SubRectangle;
  if ( (dword_140C0E4B0 & 0x200000) == 0 )
  {
    RegionContext = BgpTxtGetRegionContext(qword_140C0E570);
    v7 = BgpTxtGetRegionContext(qword_140C0E578);
    v8 = v7;
    if ( !RegionContext || !v7 )
    {
LABEL_39:
    ...
    xmmword_140C0B520 = *(_OWORD *)RegionContext;
    xmmword_140C0B530 = *(_OWORD *)(RegionContext + 16);
    dword_140C0B540 = *(_DWORD *)(RegionContext + 32);
    xmmword_140C0B560 = *(_OWORD *)v7;
    xmmword_140C0B570 = *(_OWORD *)(v7 + 16);
    dword_140C0B580 = *(_DWORD *)(v7 + 32);
    ...
    if ( !qword_140C0E4F8 )
    {
      v36 = 1;
LABEL_13:
      v19 = BgpGxReadRectangle(&v40, (__int64)&xmmword_140C0B520);
      v0 = v40;
      SubRectangle = v19;
      if ( v19 < 0 )
        goto LABEL_34;
...
LABEL_15:
      if ( !v35 )
      {
        v23 = BgpGxReadRectangle(&v50, (__int64)&xmmword_140C0B560);
        v2 = (unsigned int *)v50;
        SubRectangle = v23;
        if ( v23 < 0 )
          goto LABEL_34;
      ...
      v25 = qword_140C0E50C;
      v26 = HIDWORD(qword_140C0E630);
      v40 = (unsigned int *)qword_140C0E50C;
      if ( !v36 )
      {
        SubRectangle = BgpGxFindSubRectangle(
                         (unsigned int *)v1,
                         SHIDWORD(qword_140C0E630),
                         (__int64)&v42,
                         (unsigned int *)&v39,
                         &v33);
        if ( SubRectangle >= 0 )
      ...
      if ( !v34 )
      {
        ...
        if ( SubRectangle >= 0 )
        {
          ...
          *((_QWORD *)v51 + v37) = v41;
          ...
          {
            v41 = v42;
            LODWORD(xmmword_140C0B520) = v39 + xmmword_140C0B520;
            DWORD1(xmmword_140C0B520) += HIDWORD(v39);
          }
        }
      }
      if ( !v35 )
      {
        ...
        if ( SubRectangle >= 0 )
        {
          ...
          *((_QWORD *)v51 + v37) = v2;
          ...
          {
            LODWORD(xmmword_140C0B560) = v39 + xmmword_140C0B560;
            DWORD1(xmmword_140C0B560) += HIDWORD(v39);
            v2 = v42;
          }
        }
      }
      ...
      dword_140C0B500 = 100;
      qword_140C0B508 = v25;
      qword_140C0B518 = (__int64)v0;
      qword_140C0B550 = v1;
      qword_140C0B588 = (__int64)v2;
      KeResetEvent(&stru_140D16AC0);
      KeInitializeTimerEx(&stru_140D16A80, NotificationTimer);
      KeInitializeDpc(&stru_140D16A00, AnFwpFadeAnimationTimer, 0LL);
      byte_140CF7BA9 = 1;
      LogFwStat(1LL, 7LL, 0LL);
      KeSetCoalescableTimer(&stru_140D16A80, 0LL, 0x1Eu, 0, &stru_140D16A00);
...
LABEL_37:
    ...
    v36 = 0;
    v9 = BgpGxParseBitmap((__int64)qword_140C0E4F8, (__int64 *)&v44);
    v1 = (__int64)v44;
    SubRectangle = v9;
    if ( v9 < 0 )
      goto LABEL_37;
    ...
    v13 = qword_140C0E50C + dword_140C0E514;
    v14 = HIDWORD(qword_140C0E50C) + dword_140C0E518;
    v15 = xmmword_140C0B520 + DWORD2(xmmword_140C0B520);
    v5 += ((v12 + 15) & 0xFFFFFFF0) + 32 + 2 * (((v12 + 15) & 0xFFFFFFF0) + 32);
    v16 = DWORD1(xmmword_140C0B520) + HIDWORD(xmmword_140C0B520);
    if ( (unsigned int)xmmword_140C0B520 <= (int)qword_140C0E50C + dword_140C0E514
      && (unsigned int)xmmword_140C0B520 >= (unsigned int)qword_140C0E50C
      && DWORD1(xmmword_140C0B520) >= HIDWORD(qword_140C0E50C)
      && DWORD1(xmmword_140C0B520) <= v14 )
    {
      if ( v15 < (unsigned int)qword_140C0E50C || v15 > v13 || v16 < HIDWORD(qword_140C0E50C) || v16 > v14 )
        goto LABEL_49;
      v34 = 1;
    }
    v17 = xmmword_140C0B560 + DWORD2(xmmword_140C0B560);
    v18 = DWORD1(xmmword_140C0B560) + HIDWORD(xmmword_140C0B560);
    if ( (unsigned int)xmmword_140C0B560 < (unsigned int)qword_140C0E50C
      || (unsigned int)xmmword_140C0B560 > v13
      || DWORD1(xmmword_140C0B560) < HIDWORD(qword_140C0E50C)
      || DWORD1(xmmword_140C0B560) > v14 )
    {
LABEL_12:
      if ( v34 )
        goto LABEL_15;
    ...
    if ( v17 >= (unsigned int)qword_140C0E50C && v17 <= v13 && v18 >= HIDWORD(qword_140C0E50C) && v18 <= v14 )
    {
      v35 = 1;
      goto LABEL_12;
    }
