 ...
 *     BgpGxRectangleSize @ 0x14039B648 (BgpGxRectangleSize.c)
...
__int64 AnFwDisplayFade()
{
  ...
  xmmword_140C10E90 = *(_OWORD *)RegionContext;
  qword_140C10EA0 = *(_QWORD *)(RegionContext + 16);
  dword_140C10EA8 = *(_DWORD *)(RegionContext + 24);
  xmmword_140C10EC8 = *(_OWORD *)v7;
  qword_140C10ED8 = *(_QWORD *)(v7 + 16);
  dword_140C10EE0 = *(_DWORD *)(v7 + 24);
...
LABEL_10:
  ...
  v15 = xmmword_140C10E90 + DWORD2(xmmword_140C10E90);
  v5 += ((v12 + 15) & 0xFFFFFFF0) + 32 + 2 * (((v12 + 15) & 0xFFFFFFF0) + 32);
  v16 = DWORD1(xmmword_140C10E90) + HIDWORD(xmmword_140C10E90);
  if ( (unsigned int)xmmword_140C10E90 <= (int)qword_140C1354C + dword_140C13554
    && (unsigned int)xmmword_140C10E90 >= (unsigned int)qword_140C1354C
    && DWORD1(xmmword_140C10E90) >= HIDWORD(qword_140C1354C)
    && DWORD1(xmmword_140C10E90) <= v14 )
  {
    if ( v15 < (unsigned int)qword_140C1354C || v15 > v13 || v16 < HIDWORD(qword_140C1354C) || v16 > v14 )
      goto LABEL_51;
    v34 = 1;
  }
  v17 = xmmword_140C10EC8 + DWORD2(xmmword_140C10EC8);
  v18 = DWORD1(xmmword_140C10EC8) + HIDWORD(xmmword_140C10EC8);
  if ( (unsigned int)xmmword_140C10EC8 >= (unsigned int)qword_140C1354C
    && (unsigned int)xmmword_140C10EC8 <= v13
    && DWORD1(xmmword_140C10EC8) >= HIDWORD(qword_140C1354C)
    && DWORD1(xmmword_140C10EC8) <= v14 )
  {
...
LABEL_12:
  ...
  {
LABEL_13:
    v19 = BgpGxReadRectangle(&v40, (__int64)&xmmword_140C10E90);
    v0 = (__int64)v40;
    SubRectangle = v19;
    if ( v19 < 0 )
      goto LABEL_36;
  ...
  if ( !v35 )
  {
    v23 = BgpGxReadRectangle(&v50, (__int64)&xmmword_140C10EC8);
    v2 = v50;
    SubRectangle = v23;
    if ( v23 < 0 )
      goto LABEL_36;
  ...
  if ( !v34 )
  {
    ...
    if ( SubRectangle >= 0 )
    {
      ...
      *((_QWORD *)v51 + v37) = v41;
      ...
      {
        v41 = v42;
        LODWORD(xmmword_140C10E90) = v39 + xmmword_140C10E90;
        DWORD1(xmmword_140C10E90) += HIDWORD(v39);
      }
    }
  }
  if ( !v35 )
  {
    ...
    if ( SubRectangle >= 0 )
    {
      ...
      *((_QWORD *)v51 + v37) = v2;
      ...
      {
        LODWORD(xmmword_140C10EC8) = v39 + xmmword_140C10EC8;
        DWORD1(xmmword_140C10EC8) += HIDWORD(v39);
        v2 = v42;
      }
    }
  }
...
LABEL_35:
    ...
    qword_140C10E78 = v25;
    qword_140C10E88 = v0;
    qword_140C10EB8 = (__int64)v1;
    qword_140C10EE8 = (__int64)v2;
