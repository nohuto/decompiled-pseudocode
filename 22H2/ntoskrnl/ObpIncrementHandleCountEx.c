/*
 * XREFs of ObpIncrementHandleCountEx @ 0x140643680
 * Callers:
 ...
 *     ObpLockHandleDataBaseEntry @ 0x1406F7700 (ObpLockHandleDataBaseEntry.c)
...
LABEL_79:
  ...
  if ( !v26 )
  {
    v23 = ObpLockHandleDataBaseEntry(v8, a3, &v53);
    if ( v23 >= 0 )
    {
      v25 = a3;
      goto LABEL_25;
