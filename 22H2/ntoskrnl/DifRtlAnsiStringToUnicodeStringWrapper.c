/*
 * XREFs of DifRtlAnsiStringToUnicodeStringWrapper @ 0x1405EAD90
 * Callers:
 *     <none>
 * Callees:
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(413);
...
LABEL_17:
  result = RtlAnsiStringToUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
