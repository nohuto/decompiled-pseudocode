/*
 * XREFs of PopCompleteNotifyTransitionCommon @ 0x1403880B8
 * Callers:
 ...
 *     PopPrepChildWake @ 0x1403883F4 (PopPrepChildWake.c)
 *     PopReadyParentSleep @ 0x140388460 (PopReadyParentSleep.c)
 *     PopReadyChildWake @ 0x1403884E0 (PopReadyChildWake.c)
...
LONG __fastcall PopCompleteNotifyTransitionCommon(__int64 a1, __int64 *a2, int a3, __int64 a4)
{
  ...
  v9 = 0;
  v10 = 0;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)qword_140C23A30 + 1, &LockHandle);
  v13 = v5 + 48;
  v14 = (__int64 *)*a2;
