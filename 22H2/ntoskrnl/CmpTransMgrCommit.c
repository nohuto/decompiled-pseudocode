/*
 * XREFs of CmpTransMgrCommit @ 0x140769178
 * Callers:
...
__int64 __fastcall CmpTransMgrCommit(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  ...
  if ( (unsigned int)dword_140C04390 > 5 && tlgKeywordOn((__int64)&dword_140C04390, 1LL) )
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04390, (unsigned __int8 *)qword_140037A88, 0LL, 0LL, 2u, v13);
  ...
  if ( (unsigned int)dword_140C04390 > 5 && tlgKeywordOn((__int64)&dword_140C04390, 1LL) )
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04390, (unsigned __int8 *)&word_140037A66, 0LL, 0LL, 2u, v13);
