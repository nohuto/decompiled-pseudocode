/*
 * XREFs of MiDeleteSystemPageTable @ 0x14021DE10
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v5 == 1 )
    {
      if ( *(_DWORD *)(v3 + 24) == 2 )
      {
        ...
        do
        {
          ...
          if ( qword_140C65C40 && (v25 & 0x10) == 0 )
            v25 &= ~qword_140C65C40;
          v26 = HIDWORD(v25);
          if ( v26 && (unsigned __int8)MiTbFlushTimeStampMayNeedFlush(v26, v20, 0xFFFFFFFFLL) )
            MiInsertTbFlushEntry(v21, (v10 + (v23 << 25) - v19) >> 16, 1LL, 0LL);
          v24 += 8LL;
          v10 += 0x10000000LL;
          --v22;
        }
...
LABEL_17:
  ...
  {
    MiInsertTbFlushEntry(v9, (v17 - v18) >> 16, 1LL, 0LL);
    if ( v5 == 1 && !v11 )
    {
      LeafVa = MiGetLeafVa(v6);
      MiInsertTbFlushEntry(v9, LeafVa, 512LL, 0LL);
    }
  }
  if ( !(_DWORD)v10 )
  {
