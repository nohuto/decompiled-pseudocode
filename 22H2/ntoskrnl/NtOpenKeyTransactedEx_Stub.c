/*
 * XREFs of NtOpenKeyTransactedEx_Stub @ 0x14097CC3C
 * Callers:
...
__int64 __fastcall NtOpenKeyTransactedEx_Stub(__int64 a1)
{
  ...
  if ( byte_140CFA470 )
  {
    v1 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, HANDLE))qword_140CFA478;
  }
  else
  {
    v1 = ZwOpenKeyTransactedEx;
    byte_140CFA470 = 1;
    qword_140CFA478 = (__int64)ZwOpenKeyTransactedEx;
  }
  if ( v1 )
