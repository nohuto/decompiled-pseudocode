/*
 * XREFs of KiMoveScbThreadsToNewReadylist @ 0x14030884C
 * Callers:
  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      else
      {
        if ( !v7 )
          continue;
        KiGetThreadEffectiveRankNonZero(v14, a1, 0, (bool *)&v23);
        LODWORD(v11) = KiAddThreadToPrcbQueue(a3, v14, *(char *)(v14 + 195), 0, v23);
        v4 = 0LL;
      }
      v7 = v29;
      v9 = v28;
