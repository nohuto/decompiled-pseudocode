/*
 * XREFs of CmpCopyValue @ 0x140878D70
 * Callers:
...
LABEL_14:
  ...
  else
  {
    ...
    LOBYTE(v29) = 0;
    v27[0] = -1;
    ValueData = CmpGetValueData(a1, v30, v9, &Size_4, (__int64)&P, (__int64)&v29, (__int64)v27);
    v16 = a3;
    if ( !ValueData )
    {
LABEL_13:
    ...
    v18 = P;
    v12 = Size_4;
    if ( (int)CmpSetValueDataNew(a3, (char *)P, Size_4, v31, &Size) < 0 )
    {
      if ( (_BYTE)v29 == 1 )
