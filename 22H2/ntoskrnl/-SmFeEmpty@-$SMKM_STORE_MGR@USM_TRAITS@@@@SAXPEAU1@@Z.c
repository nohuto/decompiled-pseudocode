/*
 * XREFs of ?SmFeEmpty@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@@Z @ 0x140598C94
 * Callers:
...
char __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmFeEmpty(__int64 a1)
{
  ...
  *(_OWORD *)(a1 + 448) = 0LL;
  ...
  while ( 1 )
  {
    ...
    if ( v10 )
      goto LABEL_15;
    v9 = (unsigned __int64)&v5->LockEntries[v11];
    v8 &= ~(1 << v11);
    if ( (*(_BYTE *)(v9 + 26) & 1) != 0
      && (*(_DWORD *)(v9 + 32) & 1) == 0
...
LABEL_15:
  ...
  *(_BYTE *)(v9 + 25) &= ~1u;
  *(_QWORD *)(v9 + 32) = 0LL;
  v12 = (__int64)(v9 - (unsigned __int64)v5->LockEntries) / 96;
  if ( v7 == 1 )
