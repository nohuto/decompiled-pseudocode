/*
 * XREFs of ObInitSystem @ 0x140A3D968
 * Callers:
 ...
 *     ObpLookupDirectoryEntry @ 0x140790F8C (ObpLookupDirectoryEntry.c)
 ...
 *     ObpInitInfoBlockOffsets @ 0x140A6887C (ObpInitInfoBlockOffsets.c)
...
char ObInitSystem()
{
  ...
  if ( !(_DWORD)InitializationPhase )
  {
    ...
    while ( v3 );
    ObpDefaultObject = 0;
    qword_140C25B70 = (__int64)&qword_140C25B68;
    qword_140C25B68 = (__int64)&qword_140C25B68;
    byte_140C25B62 = 6;
    dword_140C25B64 = 1;
    ...
    qword_140C25BB8 = (__int64)ObpProcessRemoveObjectDpcWorker;
    ...
    qword_140CFCE68 = (__int64)MmBadPointer;
    LODWORD(v25[1]) = 256;
    LOWORD(v25[0]) = 120;
    HIDWORD(v25[4]) = 512;
