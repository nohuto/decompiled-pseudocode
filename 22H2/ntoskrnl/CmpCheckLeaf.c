/*
 * XREFs of CmpCheckLeaf @ 0x1406DCB70
 * Callers:
...
LABEL_31:
            ...
            *((_QWORD *)&v39 + 1) = v22 + 76;
            if ( *a3 == 26732 )
            {
                ...
                for ( i = 0; v24; --v24 )
                {
                  ...
                  if ( (unsigned __int8)v28 >= 0x61u )
                  {
                    if ( (unsigned __int8)v28 > 0x7Au )
                    {
                      ...
                      v28 = NLS_UPCASE(CurrentServerSiloGlobals[154], v31);
                    }
                    else
                    {
                      v28 -= 32;
              ...
              v32 = CmpHashUnicodeComponent(&v39);
            }
            else
            {
              if ( v26 )
...
LABEL_59:
              ...
              v32 = CmpGenerateFastLeafHintForUnicodeString(&v39);
            }
            i = v32;
            goto LABEL_30;
          }
