/*
 * XREFs of RtlpHpCustomVaCallbacksRegistrarRegister @ 0x1405B5FB0
 * Callers:
 *     RtlpHpRegisterEnvironment @ 0x140397DFC (RtlpHpRegisterEnvironment.c)
 * Callees:
 ...
 *     RtlpHpCustomVaCallbacksEncodedComparison @ 0x1405B5F30 (RtlpHpCustomVaCallbacksEncodedComparison.c)
 */
...
__int64 __fastcall RtlpHpCustomVaCallbacksRegistrarRegister(__int64 a1, char *a2, __int64 *a3, __int128 *a4)
{
  ...
  *(_QWORD *)&v30 = a4;
  ...
  v13 = RtlpHpMetadataAlloc(0x38uLL, 0x38uLL, 0, &v33);
...
LABEL_7:
  ...
  if ( v13 )
  {
    ...
    *((_QWORD *)v13 + 6) = 1LL;
    v24 = *(_DWORD *)(v23 + 4);
    *(_QWORD *)&v30 = *((_QWORD *)v13 + 1) & (-1LL << (v24 & 0x1F));
    v25 = *(_QWORD *)(v23 + 8);
    v26 = (37
         * (BYTE6(v30)
          + 37
