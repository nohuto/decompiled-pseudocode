/*
 * XREFs of RtlpHpHeapExtendContext @ 0x140326BBC
 * Callers:
 *     RtlpHpSegLfhExtendContext @ 0x140326BA0 (RtlpHpSegLfhExtendContext.c)
 * Callees:
...
LABEL_93:
    ...
    if ( v21 && ($C459BD0D405E8E46662177FB3D0A143F *)v44->ApcState.ApcListHead[0].Flink != &v44->152 )
