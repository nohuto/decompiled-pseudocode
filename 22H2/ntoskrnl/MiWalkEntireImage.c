/*
 * XREFs of MiWalkEntireImage @ 0x140239E20
 * Callers:
...
__int64 __fastcall MiWalkEntireImage(ULONG_PTR a1, __int64 a2, int a3, unsigned int a4)
{
  ...
  ULONG_PTR v103; // [rsp+78h] [rbp-88h] BYREF
...
LABEL_81:
  ...
  if ( (v97 & 2) != 0 )
  {
    v45 = *(_QWORD *)(v103 + 16);
    v46 = v103 + 16;
    if ( (unsigned int)MiPteInShadowRange(v103 + 16, v39) && (MiFlags & 0xC00000) != 0 )
    {
  ...
  if ( (unsigned int)MiRemoveLockedPageCharge(v44) )
  {
    ...
    {
      MiInsertAndUnlockStandbyPages(BugCheckParameter2, &v103, 1LL, (unsigned __int8)v42);
      v95[0] = 17;
    }
  }
