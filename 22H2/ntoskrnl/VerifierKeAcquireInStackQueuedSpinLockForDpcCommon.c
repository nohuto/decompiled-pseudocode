/*
 * XREFs of VerifierKeAcquireInStackQueuedSpinLockForDpcCommon @ 0x1409DA778
 * Callers:
 *     VerifierKeAcquireInStackQueuedSpinLockForDpc @ 0x1409DA730 (VerifierKeAcquireInStackQueuedSpinLockForDpc.c)
 *     VerifierKeAcquireInStackQueuedSpinLockForDpcNoReboot @ 0x1409DA7F0 (VerifierKeAcquireInStackQueuedSpinLockForDpcNoReboot.c)
 * Callees:
