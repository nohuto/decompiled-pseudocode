/*
 * XREFs of MmEncodeExportSection @ 0x14034B668
 * Callers:
...
char MmEncodeExportSection()
{
  ...
  if ( (_DWORD)v0 )
  {
    ...
    if ( v3->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v1, (__int64)v3)) != 0 )
    {
      ...
      if ( (unsigned __int64)&qword_140C659E8 - qword_140C65AE8 < 0x8000000000LL )
        SessionId = MmGetSessionIdEx((__int64)v3->ApcState.Process);
      else
        SessionId = -1;
      *(_DWORD *)(v4 + 8) = SessionId;
      *(_QWORD *)v4 = (unsigned __int64)&qword_140C659E8 & 0x7FFFFFFFFFFFFFFCLL;
    }
    if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C659E8, 0LL) )
      ExfAcquirePushLockExclusiveEx(&qword_140C659E8, v4, (__int64)&qword_140C659E8);
    if ( v4 )
      *(_BYTE *)(v4 + 18) = 1;
    ++dword_140C659F0;
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C659E8, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C659E8);
    LOBYTE(v0) = KeAbPostRelease((ULONG_PTR)&qword_140C659E8);
