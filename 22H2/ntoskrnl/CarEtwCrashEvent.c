/*
 * XREFs of CarEtwCrashEvent @ 0x1405D28AC
 * Callers:
...
char CarEtwCrashEvent()
{
  ...
  if ( CarLogInitialized )
  {
    if ( dword_140C09368 )
    {
      result = tlgKeywordOn((__int64)&dword_140C09368, 0x800000000000LL);
      if ( result )
      {
        if ( v2 > 5 )
        {
          result = tlgKeywordOn((__int64)&dword_140C09368, v1);
          if ( result )
          {
            v8 = 0;
            v16 = 0;
            ...
            return tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)&word_1400343E6,
                     0LL,
                     0LL,
                     0xBu,
                     &v13);
