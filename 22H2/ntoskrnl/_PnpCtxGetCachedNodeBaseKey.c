/*
 * XREFs of _PnpCtxGetCachedNodeBaseKey @ 0x1406CEFEC
 * Callers:
 ...
 *     _SysCtxGetCachedContextBaseKey @ 0x1407D13EC (_SysCtxGetCachedContextBaseKey.c)
...
LABEL_9:
  ...
  CachedContextBaseKey = SysCtxGetCachedContextBaseKey(v14, v15, &v47);
...
LABEL_64:
  CachedContextBaseKey = SysCtxGetCachedContextBaseKey(a2[7], v10, &v48);
  if ( CachedContextBaseKey >= 0 )
  {
    CachedContextBaseKey = SysCtxRegCreateTree(a2[7], v48, v28, 0LL, 0x2000000, 0LL);
    if ( CachedContextBaseKey >= 0 )
    {
      if ( a3 <= 8 )
      {
