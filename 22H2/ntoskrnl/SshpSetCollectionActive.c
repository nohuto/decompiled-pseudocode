/*
 * XREFs of SshpSetCollectionActive @ 0x14057FD7C
 * Callers:
 *     PdcPoSleepStudyHelperSetPhaseActive @ 0x1407D51C0 (PdcPoSleepStudyHelperSetPhaseActive.c)
 *     SshpPowerSettingCallback @ 0x1408FBB40 (SshpPowerSettingCallback.c)
 * Callees:
