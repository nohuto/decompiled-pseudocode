/*
 * XREFs of MiReduceUnusedSubsectionCount @ 0x14021BA20
 * Callers:
...
signed __int64 __fastcall MiReduceUnusedSubsectionCount(unsigned int *a1)
{
  ...
  v1 = *(_QWORD *)(qword_140C674C8 + 8LL * (*(_WORD *)(*(_QWORD *)a1 + 60LL) & 0x3FF));
  v2 = a1[11];
  v3 = 8 * v2;
...
LABEL_4:
  result = _InterlockedExchangeAdd64(&qword_140C65658, -(__int64)v5);
  *(_QWORD *)(v1 + 1760) -= v5;
  return result;
}
