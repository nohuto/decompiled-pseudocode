/*
 * XREFs of MmGetCacheAttributeEx @ 0x14061ED10
 * Callers:
 *     HalCreateCommonBufferFromMdl @ 0x140511F50 (HalCreateCommonBufferFromMdl.c)
 *     MmGetCacheAttribute @ 0x14061ECF0 (MmGetCacheAttribute.c)
 * Callees:
...
__int64 __fastcall MmGetCacheAttributeEx(unsigned __int64 a1, int a2, _DWORD *a3)
{
  ...
  if ( (a2 & 0xFFFFFFFE) != 0 )
    return 3221225712LL;
  v5 = a1 >> 12;
  if ( a1 >> 12 <= qword_140C65CA0 && ((*(_QWORD *)(48 * v5 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
  {
    if ( !*(_WORD *)(48 * v5 - 0x21FFFFFFFFE0LL) && (struct _KTHREAD *)qword_140C67F88 != KeGetCurrentThread() )
