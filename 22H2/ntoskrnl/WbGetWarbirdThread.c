/*
 * XREFs of WbGetWarbirdThread @ 0x1407636B4
 * Callers:
...
__int64 __fastcall WbGetWarbirdThread(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( v8 )
    *(_BYTE *)(v8 + 18) = 1;
  v21 = 0LL;
  v9 = sub_140763DD0((int)a1 + 88, (_DWORD)CurrentThread, 8, (unsigned int)&v21, 0LL);
  if ( v9 >= 0 )
  {
    v10 = (_QWORD *)v21;
    if ( v21 )
  ...
  if ( v9 == -1073741198 )
  {
    v9 = sub_1407E9E3C(a1, CurrentThread, &v22);
    if ( v9 < 0 )
    {
LABEL_32:
      v7 = v22;
    ...
    if ( v17 )
      *(_BYTE *)(v17 + 18) = 1;
    v18 = v22;
    v9 = sub_140764214((int)a1 + 88, (_DWORD)v22, v16, *v22, 8, -1);
    if ( v9 >= 0 )
