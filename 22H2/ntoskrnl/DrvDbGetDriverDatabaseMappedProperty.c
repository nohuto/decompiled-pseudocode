/*
 * XREFs of DrvDbGetDriverDatabaseMappedProperty @ 0x1408664C0
 * Callers:
 ...
 *     DrvDbGetDriverDatabaseCompositeMappedPropertyKeys @ 0x140A6B654 (DrvDbGetDriverDatabaseCompositeMappedPropertyKeys.c)
 * Callees:
...
LABEL_51:
  ...
  do
  {
    ...
    if ( *((_DWORD *)*v15 + 4) == v13 )
    {
      ...
      if ( !v31 )
      {
        DatabaseNode = DrvDbFindDatabaseNode(a1, a2, &v52);
...
LABEL_109:
  ...
  v26 = a1;
  RegValueMappedProperty = DrvDbFindDatabaseNode(a1, a2, &v52);
