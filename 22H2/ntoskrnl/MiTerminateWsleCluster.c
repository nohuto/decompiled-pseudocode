/*
 * XREFs of MiTerminateWsleCluster @ 0x140279080
 * Callers:
 ...
 *     MiCanMergeTbFlushEntryBackwards @ 0x140347B24 (MiCanMergeTbFlushEntryBackwards.c)
    ...
    if ( a1[2] )
    {
      while ( 2 )
      {
        ...
        if ( (*v29 & 4) != 0 )
        {
          ...
          {
            if ( !HIBYTE(word_140C66DFC) && (v41 & 1) != 0 )
...
LABEL_56:
          ...
          if ( MiPteInShadowRange(v2) )
          {
            ...
            if ( !HIBYTE(word_140C66DFC) && (v44 & 1) != 0 )
              v44 |= 0x8000000000000000uLL;
            *(_QWORD *)v2 = v44;
...
LABEL_58:
          ...
          v48 = v61;
          if ( qword_140C65C40 && (v61 & 0x10) == 0 )
            v48 = v61 & ~qword_140C65C40;
