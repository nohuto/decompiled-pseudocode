/*
 * XREFs of ?StDmPageAdd@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x1405C66C0
 * Callers:
 ...
 *     StIoCountsMovePeriod @ 0x1405CAAE8 (StIoCountsMovePeriod.c)
