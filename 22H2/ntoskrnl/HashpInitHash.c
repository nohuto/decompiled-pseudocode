/*
 * XREFs of HashpInitHash @ 0x140A776CC
 * Callers:
 *     HashpHashMemory @ 0x140A7708C (HashpHashMemory.c)
 * Callees:
 *     SymCryptSha256Init @ 0x1403F4880 (SymCryptSha256Init.c)
 *     SymCryptSha384Init @ 0x1403F9EB0 (SymCryptSha384Init.c)
 *     SymCryptSha512Init @ 0x1403FB69C (SymCryptSha512Init.c)
 *     SymCryptSha1Init @ 0x1403FCA40 (SymCryptSha1Init.c)
 *     SymCryptMd5Init @ 0x1403FD480 (SymCryptMd5Init.c)
 */
