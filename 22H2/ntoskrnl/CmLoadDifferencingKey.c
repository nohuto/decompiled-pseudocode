/*
 * XREFs of CmLoadDifferencingKey @ 0x1406E737C
 * Callers:
 ...
 *     NtLoadKey2 @ 0x140781A20 (NtLoadKey2.c)
                  ...
                  if ( v17 >= 0 )
                  {
                    ...
                    else
                    {
                      ...
                      if ( (a3 & 0x10) != 0 )
                      {
                        ...
                        v31 = CmLoadAppKey(v58, &v51, a3, DmaAdapter, v45, v44, Handle, v41, &BugCheckParameter2);
                      }
                      else
                      {
                        v31 = CmLoadKey(
