/*
 * XREFs of ?vSrcOpaqCopyS1D8@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1C0294880
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  {
    v41 = dword_1C0328A80[2 * (v10 & 3)] & dword_1C0328B20[2 * (v11 & 3)];
  ...
  {
    v47 = &v46[v17];
    v48 = dword_1C0328B20[2 * (v11 & 7)] & dword_1C0328A80[2 * v38];
    v49 = dword_1C0328B24[2 * (v11 & 7)] & dword_1C0328A84[2 * v38];
    v50 = ~(dword_1C0328B20[2 * v37] & dword_1C0328A80[2 * v38]);
    do
    {
      v51 = *v40;
      v40 += v12;
