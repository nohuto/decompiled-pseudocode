/*
 * XREFs of ReadTiltCalibrationData @ 0x1C01CEE1C
 * Callers:
 *     CheckPointerDeviceConfiguration @ 0x1C0009978 (CheckPointerDeviceConfiguration.c)
 * Callees:
 ...
 *     ?GetTiltKeyName@@YAJU_UNICODE_STRING@@PEAPEAGH@Z @ 0x1C01CDFA8 (-GetTiltKeyName@@YAJU_UNICODE_STRING@@PEAPEAGH@Z.c)
    ...
    if ( TiltKeyName >= 0 )
    {
      ...
      for ( j = 0LL; j < 4; ++j )
      {
        *(_QWORD *)&v13.Length = 91750400LL;
        ...
        TiltKeyName = RtlUnicodeStringCatString(&v13, off_1C02E3078[j]);
        if ( TiltKeyName >= 0 )
        {
          v11 = v19[j];
          v12 = v20[j];
