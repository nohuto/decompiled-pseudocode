/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C0106CE0
 * Callers:
 *     CheckImeHotKey @ 0x1C0106A7C (CheckImeHotKey.c)
 * Callees:
 *     GetActiveHKL @ 0x1C0106D98 (GetActiveHKL.c)
 *     ?GetHotKeyLangID@@YAGK@Z @ 0x1C01172AC (-GetHotKeyLangID@@YAGK@Z.c)
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C021D370 (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
