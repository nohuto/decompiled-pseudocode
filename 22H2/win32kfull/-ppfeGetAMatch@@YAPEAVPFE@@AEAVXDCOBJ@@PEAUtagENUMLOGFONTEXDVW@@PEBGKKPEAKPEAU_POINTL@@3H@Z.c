/*
 * XREFs of ?ppfeGetAMatch@@YAPEAVPFE@@AEAVXDCOBJ@@PEAUtagENUMLOGFONTEXDVW@@PEBGKKPEAKPEAU_POINTL@@3H@Z @ 0x1C005F890
 * Callers:
        ...
        int a9)
{
  ...
  {
    v18 = *(struct PFT **)(*(_QWORD *)a1 + 256LL);
  ...
  if ( gpPFTPrivate )
  {
    ...
    {
      v28 &= ~0x80u;
      if ( (unsigned int)MAPPER::bFoundExactMatch((MAPPER *)v21, gpPFTPrivate, 0)
        || (unsigned int)MAPPER::bFoundExactMatch((MAPPER *)v21, gpPFTPrivate + 1, 0) )
      {
        return v23;
      }
    }
  ...
  if ( (v28 & 0x200) != 0 )
  {
    ...
    if ( v14 )
    {
      ...
      if ( (unsigned int)MAPPER::bFoundExactMatch((MAPPER *)v21, (struct _FONTHASH **)v14 + 14, 0)
        || (unsigned int)MAPPER::bFoundExactMatch((MAPPER *)v21, (struct _FONTHASH **)v15 + 13, 0) )
      {
        return v23;
      }
      v10 = v28;
  ...
  v11 = gpPFTPublic;
  v28 = v10 & 0xFFFFFF7F;
  if ( (unsigned int)MAPPER::bFoundExactMatch((MAPPER *)v21, gpPFTPublic, 1)
    || (unsigned int)MAPPER::bFoundExactMatch((MAPPER *)v21, v11 + 1, 1) )
  {
    return v23;
  }
  result = v23;
...
LABEL_32:
          ...
          *v26 = 1;
          ...
          v28 &= ~0x80u;
          v22 = -2;
          if ( (unsigned int)MAPPER::bFoundExactMatch((MAPPER *)v21, v11, 0)
            || (unsigned int)MAPPER::bFoundExactMatch((MAPPER *)v21, v11 + 1, 0) )
          {
            return v23;
          }
          result = v23;
