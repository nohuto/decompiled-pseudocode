/*
 * XREFs of ?OnFirstActivationAttempted@ForegroundLaunch@@YAXXZ @ 0x1C005D334
 * Callers:
 ...
 *     _anonymous_namespace_::AppStarting_Clear @ 0x1C00E3840 (_anonymous_namespace_--AppStarting_Clear.c)
...
void __fastcall ForegroundLaunch::OnFirstActivationAttempted(ForegroundLaunch *this)
{
  ...
  v3 = *(int *)(v2 + 56);
  CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v10, (struct _EX_PUSH_LOCK *)&unk_1C035F3C8);
  v5 = 5LL;
  v6 = &unk_1C035E238;
  v7 = 1;
  while ( *v6 != v3 )
  ...
  *(_OWORD *)&qword_1C035E1C0[v8] = 0LL;
  qword_1C035E1C0[v8 + 2] = 0LL;
LABEL_8:
