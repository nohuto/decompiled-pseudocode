/*
 * XREFs of xxxInternalKeyEventDirect @ 0x1C000A61C
 * Callers:
...
char __fastcall xxxInternalKeyEventDirect(unsigned __int8 a1, __int16 a2, char a3, int a4, __int64 a5)
{
  int v9; // eax
  __int64 v10; // rdx
  __int64 v11; // r11
  ...
  if ( *(_QWORD *)(gptiCurrent + 456LL) == grpdeskRitInput
    && (PsGetCurrentProcess() == gpepCSRSS || RtlAreAllAccessesGranted(*(_DWORD *)(gptiCurrent + 896LL), 0x20u)) )
  {
    ...
    if ( !v9 )
    {
      ...
      if ( (_BYTE)v19 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_AND_TRACE_SF_(
          ...
          20,
          11,
          (__int64)&WPP_db67ad8999663b27858f7508445b01ce_Traceguids);
      }
      return 1;
    }
    if ( (unsigned int)dword_1C0359080 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0359080, 0x4000LL) )
    {
