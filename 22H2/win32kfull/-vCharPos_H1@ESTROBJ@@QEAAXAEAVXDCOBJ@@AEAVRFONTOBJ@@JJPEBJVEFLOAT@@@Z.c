/*
 * XREFs of ?vCharPos_H1@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJPEBJVEFLOAT@@@Z @ 0x1C0095D10
 * Callers:
        ...
        int a7)
{
  ...
  {
    result = (struct _GLYPHDATA *)RFONTOBJ::bGetGlyphMetrics(a3, v16, v8, v10, a2, v11);
    if ( (_DWORD)result )
      goto LABEL_14;
    return result;
  }
...
LABEL_8:
      ...
      if ( !*v27 )
      {
        result = (struct _GLYPHDATA *)RFONTOBJ::bInsertMetricsPlus(a3, v27, *v15);
        if ( !(_DWORD)result )
          return result;
    ...
    result = RFONTOBJ::wpgdGetLinkMetricsPlus(a3, v59, (struct ESTROBJ *)a1, v15, v10, v54, &a7, 1);
    v28 = result;
    if ( !result )
      return result;
LABEL_10:
    if ( !v28->gdf.pgb
      ...
      && !(unsigned int)RFONTOBJ::bInsertGlyphbits(a3, v28, v15 == v10) )
    {
      *(float *)&a7 = 0.0;
    }
    ++v15;
