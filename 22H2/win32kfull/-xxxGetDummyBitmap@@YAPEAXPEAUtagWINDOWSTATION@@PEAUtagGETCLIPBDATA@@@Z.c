/*
 * XREFs of ?xxxGetDummyBitmap@@YAPEAXPEAUtagWINDOWSTATION@@PEAUtagGETCLIPBDATA@@@Z @ 0x1C01FCE8C
 * Callers:
...
HSURF __fastcall xxxGetDummyBitmap(struct tagWINDOWSTATION *a1, struct tagGETCLIPBDATA *a2)
{
  ...
  if ( ClipFormat
    ...
    && (result = (HSURF)xxxGetClipboardData(a1, 0x11u, a2), (v2 = (__int64)result) != 0) )
  {
    *(_DWORD *)a2 = 17;
