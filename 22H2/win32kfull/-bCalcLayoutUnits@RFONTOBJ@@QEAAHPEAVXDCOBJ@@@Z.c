/*
 * XREFs of ?bCalcLayoutUnits@RFONTOBJ@@QEAAHPEAVXDCOBJ@@@Z @ 0x1C0084B58
 * Callers:
...
__int64 __fastcall RFONTOBJ::bCalcLayoutUnits(RFONTOBJ *this, struct XDCOBJ *a2)
{
  ...
  EXFORMOBJ::vQuickInit((EXFORMOBJ *)&v13, a2, 0x204u);
  v4 = *(float *)v13;
  v5 = *(float *)(v13 + 12);
  if ( *(float *)v13 < 0.0 )
    LODWORD(v4) ^= _xmm;
  ...
  v15 = 0LL;
  EXFORMOBJ::vQuickInit((EXFORMOBJ *)v12, a2, 0x402u);
  if ( v12[0] )
  {
