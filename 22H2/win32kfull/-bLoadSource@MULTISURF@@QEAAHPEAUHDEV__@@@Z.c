/*
 * XREFs of ?bLoadSource@MULTISURF@@QEAAHPEAUHDEV__@@@Z @ 0x1C015C0F6
 * Callers:
 ...
 * Callees:
 *     ?bLoadSourceNotMetaDEVBITMAP@MULTISURF@@AEAAHPEAUHDEV__@@@Z @ 0x1C02B2BD0 (-bLoadSourceNotMetaDEVBITMAP@MULTISURF@@AEAAHPEAUHDEV__@@@Z.c)
 */
