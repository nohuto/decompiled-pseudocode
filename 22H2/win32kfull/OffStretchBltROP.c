/*
 * XREFs of OffStretchBltROP @ 0x1C0157328
 * Callers:
        ...
        int a16)
{
  ...
  __int64 (__fastcall *v35)(__int64, __int64, __int64, struct _CLIPOBJ *, __int64, __int64, __int64 *, __int128 *, __int128 *, __int64, int, __int64, int); // [rsp+B8h] [rbp-31h]
  __int128 v36; // [rsp+C0h] [rbp-29h] BYREF
  __int128 v37; // [rsp+D0h] [rbp-19h] BYREF
  ...
  if ( a12 )
  {
    LODWORD(v37) = x + *(_DWORD *)a12;
    DWORD2(v37) = x + *((_DWORD *)a12 + 2);
    DWORD1(v37) = y + *((_DWORD *)a12 + 1);
    v21 = &v37;
    HIDWORD(v37) = y + *((_DWORD *)a12 + 3);
  }
  v26 = 0LL;
  if ( a10 )
  {
