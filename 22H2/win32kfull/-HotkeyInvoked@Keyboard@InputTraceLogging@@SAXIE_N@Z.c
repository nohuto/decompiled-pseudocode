/*
 * XREFs of ?HotkeyInvoked@Keyboard@InputTraceLogging@@SAXIE_N@Z @ 0x1C0010CC4
 * Callers:
...
void __fastcall InputTraceLogging::Keyboard::HotkeyInvoked()
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C0359080, 0x4000LL) )
    {
      v3 = v1;
      v4 = v0 ^ 1;
      v11 = &v4;
      ...
      v10 = 1LL;
      v8 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0359080, (int)&dword_1C031B712, 0, 0, 5u, &v6);
    }
  }
}
