/*
 * XREFs of ?vPlgWriteAND@@YAXPEAU_PLGRUN@@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C0301EE0
 * Callers:
 *     <none>
 * Callees:
                ...
                do
                {
                  ...
                  if ( !v32 )
                  {
                    if ( v34 )
                      *v31 = v33;
                    ++v31;
                    v32 = *((_BYTE *)&dword_1C0329EE8 + (v27 & 7));
                    if ( v27 < 0
                      || v27 >= *((_DWORD *)a3 + 14)
    ...
    else if ( a1 < a2 )
    {
      ...
      do
      {
        ...
        for ( j = *((_QWORD *)a3 + 10) + v12; v11; --v11 )
        {
          ...
          v18 = *((_BYTE *)&dword_1C0329EE8 + (*(_DWORD *)v7 & 7));
              ...
              if ( !v18 )
              {
                *v17++ = v19;
                if ( (unsigned __int64)v17 < v8 || (unsigned __int64)v17 > v9 )
                  ...
                  v19 = *v17;
                v18 = *((_BYTE *)&dword_1C0329EE8 + (v15 & 7));
              }
              if ( v16 < 0 )
                goto LABEL_23;
            }
