/*
 * XREFs of ?iSelectTightenRao@DC@@QEAAHPEAVREGION@@H@Z @ 0x1C00B5CE8
 * Callers:
 ...
 *     ?vGet_sizlWindow@DC@@QEBAXPEAUtagSIZE@@@Z @ 0x1C015F578 (-vGet_sizlWindow@DC@@QEBAXPEAUtagSIZE@@@Z.c)
