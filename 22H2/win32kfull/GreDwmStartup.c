/*
 * XREFs of GreDwmStartup @ 0x1C000CD48
 * Callers:
 *     zzzDwmStartRedirection @ 0x1C00E942C (zzzDwmStartRedirection.c)
 * Callees:
 *     GreSfmDwmStartup @ 0x1C000CF88 (GreSfmDwmStartup.c)
...
__int64 __fastcall GreDwmStartup(__int64 a1)
{
  ...
  unsigned int v16; // [rsp+D8h] [rbp+60h] BYREF
  ...
  {
    *(_QWORD *)(v6 + 176) = a1;
    LOBYTE(v2) = (int)GrepDwmCreateComposedEvent((struct DwmState *)v6) >= 0;
