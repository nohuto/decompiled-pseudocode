/*
 * XREFs of ?xxxProgrammaticSemiMaximize@@YAHPEAU_MOVESIZEDATA@@PEAUtagMONITOR@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C020F3BC
 * Callers:
...
LABEL_8:
      ...
      *(_OWORD *)v11 = *(_OWORD *)(a1 + 40);
      Prop = GetProp(v7, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
      *(_DWORD *)(Prop + 48) &= ~2u;
    }
