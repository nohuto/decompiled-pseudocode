/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C020875C
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1C02088B0 (EditionFindNodeQueuedMessage.c)
 * Callees:
