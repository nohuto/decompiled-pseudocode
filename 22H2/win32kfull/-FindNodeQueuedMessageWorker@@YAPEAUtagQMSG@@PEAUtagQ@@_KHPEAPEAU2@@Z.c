/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C0155D8C
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1C0155DF0 (EditionFindNodeQueuedMessage.c)
 * Callees:
