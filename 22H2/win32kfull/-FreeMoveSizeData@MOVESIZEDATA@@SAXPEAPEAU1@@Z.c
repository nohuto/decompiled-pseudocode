/*
 * XREFs of ?FreeMoveSizeData@MOVESIZEDATA@@SAXPEAPEAU1@@Z @ 0x1C023A380
 * Callers:
 *     ?xxxMoveSize@@YAXPEAUtagWND@@IK@Z @ 0x1C01EFC00 (-xxxMoveSize@@YAXPEAUtagWND@@IK@Z.c)
 *     EditionFreeMoveSizeDataOnThreadDestroy @ 0x1C01F21B0 (EditionFreeMoveSizeDataOnThreadDestroy.c)
 * Callees:
 *     <none>
 */
