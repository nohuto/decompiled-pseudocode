/*
 * XREFs of InitializeDPIINFO @ 0x1C00BE1D0
 * Callers:
...
char __fastcall InitializeDPIINFO(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)(a1 + 16) = *(_QWORD *)GetMonitorRectForDpiContext(&v20, a3, a2);
  MonitorRectForDpiContext = (__int64)GetMonitorRectForDpiContext(&v21, a3, 0x12u);
  *(_DWORD *)(a1 + 36) = 0;
  ...
  *(_QWORD *)(a1 + 24) = v9;
  if ( v8 != 96 )
  {
    MonitorRectForDpiContext = W32GetThreadWin32Thread((__int64)KeGetCurrentThread());
    if ( MonitorRectForDpiContext )
    {
      MonitorRectForDpiContext = W32GetThreadWin32Thread((__int64)KeGetCurrentThread());
      if ( *(_QWORD *)(MonitorRectForDpiContext + 456) )
      {
        v15 = (*(_BYTE *)(**(_QWORD **)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 456) + 8LL)
                        + 64LL) & 1) != 0;
