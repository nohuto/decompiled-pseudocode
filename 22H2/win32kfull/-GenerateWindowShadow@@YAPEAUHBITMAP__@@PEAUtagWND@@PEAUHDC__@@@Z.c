/*
 * XREFs of ?GenerateWindowShadow@@YAPEAUHBITMAP__@@PEAUtagWND@@PEAUHDC__@@@Z @ 0x1C013E05C
 * Callers:
 ...
 *     ?DrawRoundedRectangularShadow@@YAXPEAXJJHJ@Z @ 0x1C013E5E8 (-DrawRoundedRectangularShadow@@YAXPEAXJJHJ@Z.c)
 *     ?DrawRegionalShadow@@YAXPEAXJJ@Z @ 0x1C0141ACC (-DrawRegionalShadow@@YAXPEAXJJ@Z.c)
