/*
 * XREFs of ?PostRawKeyboardInputToSinks@@YAXKPEAXPEAU_KEYBOARD_INPUT_DATA@@IGH@Z @ 0x1C01558CC
 * Callers:
  ...
  for ( i = SGDGetUserSessionState(v12) + 408; v11 != (__int64 *)i; v11 = (__int64 *)*v11 )
  {
    if ( (*((_DWORD *)v11 + 25) & 0x40) != 0 )
    {
      ...
      if ( v14 )
      {
        ...
        {
          if ( !v6
            || (unsigned __int8)CheckAccess(*(_QWORD *)(v14[2] + 424LL) + 888LL, &v19)
          ...
          {
            EtwTraceUIPIInputError(v16, 0LL, gpqForeground, v19);
          }
        }
      }
    }
