/*
 * XREFs of NtGdiBRUSHOBJ_pvAllocRbrush @ 0x1C02B1AE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?BRUSHOBJ_pvAllocRbrushUMPD@@YAPEAXPEAU_BRUSHOBJ@@K@Z @ 0x1C026CA28 (-BRUSHOBJ_pvAllocRbrushUMPD@@YAPEAXPEAU_BRUSHOBJ@@K@Z.c)
 */
