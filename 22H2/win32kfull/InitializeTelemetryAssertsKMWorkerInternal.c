/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1C00B7BE4
 * Callers:
 *     InitializeWin32kFullTelemetryAsserts @ 0x1C00B7B90 (InitializeWin32kFullTelemetryAsserts.c)
 * Callees:
 *     UninitializeTelemetryAssertsLocks @ 0x1C00B7D24 (UninitializeTelemetryAssertsLocks.c)
...
__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
        ...
        (g_ModuleName = v4) != 0LL) )
  {
    ...
    qword_1C035A4F8 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0398040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0398008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0398078);
