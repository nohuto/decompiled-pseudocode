/*
 * XREFs of ?xxxInitializeMoveSizeDataProgrammaticArrangement@@YAXPEAUtagWND@@W4_WARR_ACTIONS@@W4_WARR_STATES@@W4_WINDOW_ARRANGEMENT_SCENARIO@@PEAU_MOVESIZEDATA@@PEAJ@Z @ 0x1C020E724
 * Callers:
        ...
        int *a6)
{
  ...
  *((_DWORD *)a5 + 49) = v10 | 0x30000;
  if ( a3 == 5 )
    v11 = *(_OWORD *)GetProp(a1, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
  else
