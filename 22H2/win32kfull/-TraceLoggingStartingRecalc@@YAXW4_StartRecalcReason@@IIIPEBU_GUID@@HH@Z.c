/*
 * XREFs of ?TraceLoggingStartingRecalc@@YAXW4_StartRecalcReason@@IIIPEBU_GUID@@HH@Z @ 0x1C003E7AC
 * Callers:
...
__int64 __fastcall TraceLoggingStartingRecalc(int a1, __int64 a2, int a3, int a4, __int64 a5, int a6, int a7)
{
  ...
  v34 = 0LL;
  result = qword_1C035E348;
  qword_1C035E348 = (((unsigned __int64)MEMORY[0xFFFFF78000000004] << 32)
