/*
 * XREFs of SfnGESTURE @ 0x1C0206610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfnGESTURE(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v8; // r12d
  ...
  *(_QWORD *)(*((_QWORD *)v11 + 60) + 80LL) = v18;
  ...
  v19 = KeUserModeCallback(113LL, &v32, 48LL, &v29, v28);
