/*
 * XREFs of UserRemoveWindowedSwapChain @ 0x1C021C300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UserRemoveWindowedSwapChain(__int64 a1, int a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( (_DWORD)v7 != 669 )
    {
      ...
      {
        v11 = (CSwapChainProp *)InternalRemoveProp(v5, *((unsigned __int16 *)&WPP_MAIN_CB.AlignmentRequirement + 2), 1u);
        v12 = v11;
        if ( v11 )
        {
          *((_QWORD *)v11 + 2) = 0LL;
          ...
          RemoveVisRgnTracker((__int64)v10, 2);
        }
      }
      v4 = 1;
    }
