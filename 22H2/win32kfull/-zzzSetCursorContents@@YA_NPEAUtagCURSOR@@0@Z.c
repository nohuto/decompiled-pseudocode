/*
 * XREFs of ?zzzSetCursorContents@@YA_NPEAUtagCURSOR@@0@Z @ 0x1C01685C0
 * Callers:
...
char __fastcall zzzSetCursorContents(struct tagCURSOR *a1, struct tagCURSOR *a2)
{
  ...
  if ( a1 != a2 )
  {
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTellMeIf", 0x20000LL, 1192LL);
