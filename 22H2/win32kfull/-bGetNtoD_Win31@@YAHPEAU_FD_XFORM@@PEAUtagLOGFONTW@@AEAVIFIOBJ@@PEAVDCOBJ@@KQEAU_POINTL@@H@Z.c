/*
 * XREFs of ?bGetNtoD_Win31@@YAHPEAU_FD_XFORM@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@KQEAU_POINTL@@H@Z @ 0x1C005EB68
 * Callers:
 ...
 *     ?bParityViolatingXform@@YAHPEAVDCOBJ@@@Z @ 0x1C012D284 (-bParityViolatingXform@@YAHPEAVDCOBJ@@@Z.c)
