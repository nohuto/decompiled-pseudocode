/*
 * XREFs of ?bGetNtoD_Win31@@YAHPEAU_FD_XFORM@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@KQEAU_POINTL@@H@Z @ 0x1C01116A4
 * Callers:
 ...
 * Callees:
 *     ?bParityViolatingXform@@YAHPEAVDCOBJ@@@Z @ 0x1C0016908 (-bParityViolatingXform@@YAHPEAVDCOBJ@@@Z.c)
    ...
    if ( (v12 & 0x3000010) == 0 )
    {
            ...
            v32) )
      {
        ...
        if ( !v33 )
        {
          ...
          LODWORD(a1->eXY) = dword_1C03198D0[a6->y];
          return 1LL;
        }
        v34 = v33 - 1;
        if ( v34 )
        {
          if ( v34 == 1 )
          {
            ...
            LODWORD(a1->eYX) = dword_1C03198A8[a6->x];
          }
          return 1LL;
        }
        v36 = a6->x;
        *(_QWORD *)&a1->eXY = 0LL;
        LODWORD(a1->eXX) = dword_1C03198D0[v36];
        v26 = dword_1C03198A8[a6->y];
      }
      else
      {
        v25 = a6->x;
        *(_QWORD *)&a1->eXY = 0LL;
        LODWORD(a1->eXX) = dword_1C03198A8[v25];
        v26 = dword_1C03198D0[a6->y];
      }
      LODWORD(a1->eYY) = v26;
      return 1LL;
    }
