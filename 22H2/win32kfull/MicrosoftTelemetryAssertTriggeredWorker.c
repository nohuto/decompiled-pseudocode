/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C03076A8
 * Callers:
 ...
 *     GetImageTuple @ 0x1C0307628 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C0307DC4 (_tlgCreate1Sz_char.c)
 */
...
LABEL_45:
  ...
  if ( v37 )
  {
    if ( (unsigned int)dword_1C0398040 > 5 && tlgKeywordOn((__int64)&dword_1C0398040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C031EA3B,
        0LL,
        0LL,
        0xEu,
        &v79);
  ...
  else if ( (unsigned int)dword_1C0398040 > 5 && tlgKeywordOn((__int64)&dword_1C0398040, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0398040, byte_1C031EAE5, 0LL, 0LL, 0xBu, &v102);
  }
  if ( dword_1C0398078 && !v55 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C0398040 > 5 && tlgKeywordOn((__int64)&dword_1C0398040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C0398040,
        (unsigned __int8 *)dword_1C031EB52,
        0LL,
        0LL,
        v32,
        &v63);
