/*
 * XREFs of ?prunPlgRead4@@YAPEAU_PLGRUN@@PEAU_PLGDDA@@PEAU1@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C03007C0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a7 )
    {
      ...
      while ( 1 )
      {
        if ( (v22 & dword_1C0329F30[v24]) != 0 )
        {
          v25 = (v13 & (unsigned int)dword_1C0329F10[v23]) >> dword_1C0329EF0[v23];
          if ( a5 )
            v25 = a5->pulXlate[v25];
          *(_DWORD *)v9 = v25;
          prunPumpDDA(a1, v9);
  ...
  else if ( v8 < a7 )
  {
    ...
    while ( 1 )
    {
      v15 = (v13 & (unsigned int)dword_1C0329F10[v14]) >> dword_1C0329EF0[v14];
      if ( a5 )
        v15 = a5->pulXlate[v15];
      *(_DWORD *)v9 = v15;
      prunPumpDDA(a1, v9);
