/*
 * XREFs of ?DelegateCapturePointersMitOn@@YAHIPEAI0@Z @ 0x1C01F59E4
 * Callers:
 *     NtUserDelegateCapturePointers @ 0x1C01F7480 (NtUserDelegateCapturePointers.c)
 * Callees:
...
LABEL_16:
  ...
  if ( v16 >= 0x2710000 || (v17 = Win32AllocPoolZInit(v16, 1885631317LL), (v18 = (void *)v17) == 0LL) )
  {
    v12 = 8LL;
    goto LABEL_16;
  }
  if ( (unsigned int)ValidateDelegatePointerList(v5, (__int64)a2, (__int64)a3, v17) )
    v11 = DelegateCapturePointers((unsigned int)v5, (__int64)v18, v20);
  else
