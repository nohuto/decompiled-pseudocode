/*
 * XREFs of SetWindowCompositionAllowNCPaint @ 0x1C0213C04
 * Callers:
...
__int64 __fastcall SetWindowCompositionAllowNCPaint(__int64 *a1, __int128 *a2)
{
  ...
  {
    if ( -__CFSHR__(v11[0], 2) == v5 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFFFD | (2 * v5);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v9, *a1, 4, a2);
    }
  }
  return v6;
}
