/*
 * XREFs of ?xxxUserReinitializeAutoRotation@CLegacyRotationMgr@@UEAAXXZ @ 0x1C0126750
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CLegacyRotationMgr::xxxUserReinitializeAutoRotation(CLegacyRotationMgr *this)
{
  ...
  dword_1C0335608 = AutoRotationRegistrySetting;
  if ( (unsigned int)dword_1C032A3D8 > 5 && (qword_1C032A3E8 & 0x400000000001LL) != 0 )
  {
    v3 = (CLegacyRotationMgr *)(qword_1C032A3F0 & 0x400000000001LL);
  ...
  dword_1C0335638 = CLegacyRotationMgr::QueryAutoRotationRegistrySetting(
                      v3,
                      L"SlateEnable",
                      1u,
                      L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\CurrentVersion\\AutoRotation");
  ...
  if ( v9 > 3 )
    v9 = 0;
  dword_1C0335604 = v9;
  dword_1C0335618 = IsNativeOrientationPortrait();
  dword_1C033561C = 0;
