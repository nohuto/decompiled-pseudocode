/*
 * XREFs of ?draw_clrt_f_ntb_o_to_temp_start@@YAXPEAU_GLYPHPOS@@KPEAEKKKK@Z @ 0x1C0270CB0
 * Callers:
 *     <none>
 * Callees:
 *     ?vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x1C0271694 (-vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z.c)
 */
