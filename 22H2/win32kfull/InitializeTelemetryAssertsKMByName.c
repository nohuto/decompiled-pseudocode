/*
 * XREFs of InitializeTelemetryAssertsKMByName @ 0x1C0131F08
 * Callers:
 *     InitializeWin32kFullTelemetryAsserts @ 0x1C0131ED0 (InitializeWin32kFullTelemetryAsserts.c)
 * Callees:
 *     InitializeTelemetryAssertsLocks @ 0x1C0131FE0 (InitializeTelemetryAssertsLocks.c)
...
__int64 InitializeTelemetryAssertsKMByName()
{
  ...
  {
    qword_1C03354D8 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0379040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0379008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0379078);
