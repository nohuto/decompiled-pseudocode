/*
 * XREFs of ?_OnInput@Edgy@@YA?AUtagSTATE_TRANSITION_DATA@1@AEAUtagEDGY_DATA@@PEAX@Z @ 0x1C01E8714
 * Callers:
 *     ?ProcessInput@Edgy@@YAHPEAXPEAPEAX@Z @ 0x1C0155B88 (-ProcessInput@Edgy@@YAHPEAXPEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall Edgy::_OnInput(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v6 = *(int *)(a2 + 16);
  v7 = 4;
  v8 = dword_1C0320B18[v6];
  v9 = *(_OWORD *)(ArcData + 16);
  v10 = dword_1C0320B1C[v6];
  ...
  {
    v12 = 16LL * v8;
    while ( (DWORD2(v14[0]) & *(_DWORD *)((_BYTE *)&unk_1C0320B38 + v12)) != *(_DWORD *)((char *)&unk_1C0320B3C + v12) )
    {
      ++v8;
      v12 += 16LL;
      if ( v8 >= v10 )
    ...
    v7 = *(_DWORD *)((char *)&unk_1C0320B34 + v12);
  }
LABEL_7:
  *(_DWORD *)(a1 + 4) = 0;
  *(_QWORD *)(a1 + 8) = 0LL;
