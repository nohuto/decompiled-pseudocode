/*
 * XREFs of ?RedirPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C02A5450
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG iMode)
{
        ...
        if ( (*(_DWORD *)(HDEV + 40) & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(HDEV + 1768); i; i = *(struct _DISPSURF **)i )
          {
            ...
            if ( v23 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v23 + 1760) + 624LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, __int64, struct _SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, POINTFIX *, RECTL *, POINTL *, ULONG))(*(_QWORD *)(v23 + 1760) + 624LL))(
                    v25,
                    v26,
                    DevBitmap,
                    pco,
  ...
  v27 = EngPlgBlt(a1, a2, a3, pco, pxlo, pca, pptlBrushOrg, pptfx, prcl, pptl, iMode);
  if ( v30 )
    bMakeOpaque(v30);
  if ( v31 )
    bMakeOpaque(v31);
