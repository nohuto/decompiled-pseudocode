/*
 * XREFs of _WOWModuleUnload @ 0x1C0227890
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?PseudoDestroyClassWindows@@YAXPEAUtagWND@@AEBV?$SmartObjStackRef@UtagCLS@@@@@Z @ 0x1C02276D0 (-PseudoDestroyClassWindows@@YAXPEAUtagWND@@AEBV-$SmartObjStackRef@UtagCLS@@@@@Z.c)
 */
    ...
    while ( *v4 )
    {
      ...
      if ( HIWORD(*(_DWORD *)(*(_QWORD *)(*v4 + 8) + 64LL)) != v1 )
      {
                            ...
                            + 94LL) )
        {
          ...
          v9 = 868LL;
          v10 = 0LL;
          while ( !*((_QWORD *)&WPP_MAIN_CB.Dpc.DpcData + v10)
          ...
          *(_QWORD *)(*(_QWORD *)(*v4 + 8) + 32LL) = *((_QWORD *)&WPP_MAIN_CB.Dpc.DpcData + v10);
LABEL_25:
