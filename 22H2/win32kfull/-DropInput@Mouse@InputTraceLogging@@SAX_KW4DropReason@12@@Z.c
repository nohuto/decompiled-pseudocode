/*
 * XREFs of ?DropInput@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z @ 0x1C0212EBC
 * Callers:
 *     ?QueuePTPMouseEvent@@YAXPEAXUtagPOINT@@K_K2PEAU_PTPMouseLatencyTracker@@@Z @ 0x1C0212F28 (-QueuePTPMouseEvent@@YAXPEAXUtagPOINT@@K_K2PEAU_PTPMouseLatencyTracker@@@Z.c)
 * Callees:
...
int __fastcall InputTraceLogging::Mouse::DropInput(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C032FB20 > 4 && (qword_1C032FB30 & 0x40) != 0 )
  {
    v4 = qword_1C032FB38 & 0x40;
    if ( v4 == qword_1C032FB38 )
    {
      v7 = a1;
      v6 = "PTPQueueFull";
