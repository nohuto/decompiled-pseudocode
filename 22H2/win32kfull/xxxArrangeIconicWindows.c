/*
 * XREFs of xxxArrangeIconicWindows @ 0x1C015DED0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  do
  {
    ...
    if ( v11 == v67 )
      goto LABEL_6;
    Prop = GetProp(v11, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
    if ( !Prop )
      goto LABEL_6;
    v15 = *(_DWORD *)(Prop + 48);
    v16 = (_DWORD *)(Prop + 32);
    ...
    while ( 2 )
    {
      if ( v28 )
      {
        ...
        if ( v29 )
        {
          v30 = v26;
          v31 = 0;
          v32 = *(_QWORD *)(GetProp(v29, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL) + 32);
          *(_QWORD *)&v69 = v32;
          if ( v26 < v27 )
          {
            v33 = DWORD1(v69);
...
LABEL_90:
            ...
            v35 = *(_QWORD *)(GetProp(v34, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL) + 32);
...
LABEL_103:
  ...
  if ( *v66 != 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v51 )
        goto LABEL_114;
      v52 = GetProp(v51, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
      if ( v52 )
      {
        *(_DWORD *)(v52 + 48) |= 0x20u;
        *(_QWORD *)(v52 + 32) = v60;
  ...
  if ( v53 )
  {
    while ( 1 )
    {
      ...
      if ( v59 )
      {
        ...
        if ( v54 )
        {
          v56 = GetProp(v54, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
