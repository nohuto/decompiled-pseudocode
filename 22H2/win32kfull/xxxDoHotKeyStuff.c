/*
 * XREFs of xxxDoHotKeyStuff @ 0x1C0104F50
 * Callers:
 ...
 *     ?xxxHandleVolumeUpDownCombo@@YAXXZ @ 0x1C01EA8BC (-xxxHandleVolumeUpDownCombo@@YAXXZ.c)
 ...
 *     ?TraceLoggingPenHotkey@@YAXII@Z @ 0x1C0224E20 (-TraceLoggingPenHotkey@@YAXII@Z.c)
 *     ?TraceLoggingYieldedHotkey@@YAXII@Z @ 0x1C0225528 (-TraceLoggingYieldedHotkey@@YAXII@Z.c)
...
LABEL_58:
      ...
      if ( !v21 )
      {
        ...
        if ( v20 )
        {
          if ( !v31 || v30 != qword_1C0339AC0 )
          {
            if ( qword_1C0339AC0 != v30 )
...
LABEL_70:
        ...
        if ( v21 != *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v21 + 24) + 8LL) + 168LL) || v22 != 61744 )
        {
          ...
          if ( (v19 & 0x4000) != 0 && v25 == (struct _LARGE_STRING *)qword_1C0339AC0 )
          {
            v26 = v60;
          }
          else
          {
            v26 = v60;
            if ( (struct _LARGE_STRING *)qword_1C0339AC0 != v25 )
