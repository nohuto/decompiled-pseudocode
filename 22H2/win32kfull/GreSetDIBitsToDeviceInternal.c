/*
 * XREFs of GreSetDIBitsToDeviceInternal @ 0x1C00AF240
 * Callers:
 *     NtGdiSetDIBitsToDeviceInternal @ 0x1C00AC7C0 (NtGdiSetDIBitsToDeviceInternal.c)
 ...
 *     ?vGetSurfaceBoundsRect@@YAXPEAU_SURFOBJ@@PEAU_RECTL@@@Z @ 0x1C00B1288 (-vGetSurfaceBoundsRect@@YAXPEAU_SURFOBJ@@PEAU_RECTL@@@Z.c)
 *     ??1DCOBJ@@QEAA@XZ @ 0x1C00B2890 (--1DCOBJ@@QEAA@XZ.c)
 *     ??0DCOBJ@@QEAA@PEAUHDC__@@@Z @ 0x1C00B2938 (--0DCOBJ@@QEAA@PEAUHDC__@@@Z.c)
 *     ?prgnRao@DC@@QEBAPEAVREGION@@XZ @ 0x1C00B2DA8 (-prgnRao@DC@@QEBAPEAVREGION@@XZ.c)
