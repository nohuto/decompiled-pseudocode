/*
 * XREFs of ?xxxShowWindowEx@@YAHPEAUtagWND@@EW4MinMaxOptions@@@Z @ 0x1C002678C
 * Callers:
 ...
 *     _FChildVisible @ 0x1C002706C (_FChildVisible.c)
...
LABEL_106:
  ...
  {
    xxxSetWindowPos((struct tagWND *)a1, 0, 0, v32);
    if ( (v32 & 0x100000) != 0 )
    {
      if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) == 0
  ...
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 40) + 16LL) & 0x10) != 0 )
  {
    ...
    xxxSendTransformableMessageTimeout(a1, 0, 0, 0LL, 1, 0);
  }
  if ( !v23 )
  {
