/*
 * XREFs of xxxProcessNotifyWinEvent @ 0x1C00E7CDC
 * Callers:
...
__int64 __fastcall xxxProcessNotifyWinEvent(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !(unsigned __int8)Enforced(1LL) )
  {
    ...
    if ( (*(_DWORD *)(v10 + 772) != *(_DWORD *)(v12 + 772) || *(_DWORD *)(v10 + 776) != *(_DWORD *)(v12 + 776))
  ...
  if ( (unsigned __int16)PsGetProcessMachine(**v13) != ProcessMachine )
    goto LABEL_18;
  if ( !(unsigned __int8)CheckAccess(*((_QWORD *)*v15 + 53) + 888LL, *v13 + 111) )
  {
    v8 = 1;
LABEL_18:
    v18 = (__int64 *)(v11 + 16);
...
LABEL_19:
  ...
  {
    v34 = *((_QWORD *)*v15 + 53);
    if ( *(int *)(v34 + 12) >= 0 && (_QWORD *)v34 != *v13 && (*(_DWORD *)(v34 + 816) & 0x100) == 0 )
    {
