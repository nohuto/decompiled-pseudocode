/*
 * XREFs of ?vNextPoint@LINER@@AEAAXXZ @ 0x1C02F2BD0
 * Callers:
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C02F2A80 (-vNextEvent@LINER@@QEAAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0138430 (__security_check_cookie.c)
 *     ?bNextPoint@READER@@IEAAHAEAU_POINTFIX@@@Z @ 0x1C015DAE4 (-bNextPoint@READER@@IEAAHAEAU_POINTFIX@@@Z.c)
 *     ?bNextFigure@READER@@IEAAHXZ @ 0x1C02F18A0 (-bNextFigure@READER@@IEAAHXZ.c)
