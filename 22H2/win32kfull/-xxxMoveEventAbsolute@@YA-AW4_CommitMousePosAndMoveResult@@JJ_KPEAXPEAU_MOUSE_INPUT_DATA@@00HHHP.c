/*
 * XREFs of ?xxxMoveEventAbsolute@@YA?AW4_CommitMousePosAndMoveResult@@JJ_KPEAXPEAU_MOUSE_INPUT_DATA@@00HHHPEAU_MousePacketPerf@@@Z @ 0x1C00313BC
 * Callers:
 *     EditionCommitMousePosAndMove @ 0x1C0030D00 (EditionCommitMousePosAndMove.c)
 * Callees:
        ...
        LARGE_INTEGER *a11)
{
  ...
  if ( !gProtocolType )
  {
    if ( LODWORD(WPP_MAIN_CB.DeviceQueue.Lock) )
      _InterlockedExchange(&gMouseTrailsToHide, LODWORD(WPP_MAIN_CB.DeviceQueue.Lock) + 1);
  }
  return v15;
}
