/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C0152C5C
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x1C0152D0A (RtlUnicodeStringValidateSrcWorker.c)
 */
