/*
 * XREFs of NtGdiDoPalette @ 0x1C009D6F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiDoPalette(HPALETTE a1, __int64 a2, __int64 a3, char *a4, unsigned int a5)
{
  ...
  if ( a5 > 5 )
    return v7;
  if ( !*((_DWORD *)&off_1C03092D0 + 4 * a5 + 2) )
  {
    if ( a4 )
    {
      if ( (_WORD)a3 )
    ...
    if ( v8 )
    {
      v10 = (*(&off_1C03092D0 + 2 * a5))(a1, (unsigned __int16)a2, v6, v9);
      v7 = v10;
      if ( (int)v6 < v10 )
        v10 = v6;
      if ( v10 > 0 && a4 )
  ...
  v7 = (*(&off_1C03092D0 + 2 * a5))(a1, (unsigned __int16)a2, (unsigned __int16)v6, v9);
LABEL_10:
  if ( v9 )
