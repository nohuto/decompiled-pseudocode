/*
 * XREFs of ?crSpGetShapePixel@@YAKPEAU_SURFOBJ@@HHH@Z @ 0x1C026E4CC
 * Callers:
...
__int64 __fastcall crSpGetShapePixel(struct _SURFOBJ *a1, int a2, int a3, int a4)
{
  ...
  if ( v17[0] )
  {
    ...
    {
      v14 = *(_DWORD *)((char *)a1->pvScan0 + 4 * a2 + (__int64)(a3 * a1->lDelta));
      v6 = v14 & 0xFF00 | ((unsigned __int8)v14 << 16) | BYTE2(v14);
    }
    else
    {
      v6 = *(_DWORD *)((char *)a1->pvScan0 + 4 * a2 + (__int64)(a3 * a1->lDelta));
    }
  }
