/*
 * XREFs of ValidateCalibrationData @ 0x1C01CF2C8
 * Callers:
 ...
 *     _SetCalibrationData @ 0x1C01D57E8 (_SetCalibrationData.c)
 * Callees:
 *     <none>
 */
  ...
  if ( a1 >= 0x40 && a2 && *(_DWORD *)(a2 + 4) == 2 && *(_DWORD *)a2 < 0xFFFFu )
  {
    ...
    if ( a1 == 8 * v4 + 32 )
    {
      ...
      for ( i = 0LL; (unsigned int)i < v4; i = (unsigned int)(i + 1) )
      {
        ...
        v12 = *(_WORD *)(a2 + 8 * i + 32);
        if ( v12 <= 0x8000u
          && (v13 = *(unsigned __int16 *)(a2 + 8 * i + 34), (unsigned __int16)v13 <= 0x8000u)
