/*
 * XREFs of ?NtGdiDrawStreamInternal@@YAHAEAVXDCOBJ@@AEAVEXFORMOBJ@@PEAVSURFACE@@PEAU_XLATEOBJ@@PEAU_RECTL@@4JPEADPEAU_DRAWSTREAMINFO@@@Z @ 0x1C00F3A70
 * Callers:
        ...
        struct _DRAWSTREAMINFO *a9)
{
  ...
  __m128i v47; // xmm1
  XDCOBJ *v48; // rsi
  __int64 (__fastcall *v49)(__int64, __int64, __int64, __int64, int, int *, unsigned int, char *, struct _DRAWSTREAMINFO *); // rdi
  __int64 v50; // rax
  bool v51; // al
  __int64 v52; // r14
  bool v53; // zf
  ...
  *(__int64 *)((char *)v73.m128i_i64 + 4) = __PAIR64__(right, top);
  ...
  if ( (v22 & 0x800) != 0 )
  {
    v23 = UserSurfaceAccessCheck(*(_QWORD *)(v17 + 648));
  }
  else
  {
    if ( (v22 & 0x10000000) == 0 )
...
LABEL_68:
  ...
  if ( left != right && top != bottom )
  {
    ...
    if ( (unsigned __int64)((int)v66 + (__int64)left + 0x80000000LL) <= 0xFFFFFFFF
      && (unsigned __int64)((int)v66 + (__int64)right + 0x80000000LL) <= 0xFFFFFFFF )
    {
      v31 = (int)v30[1];
...
LABEL_45:
                ...
                else
                {
                  ...
                  ++*(_DWORD *)(v39 + 92);
                  v49 = (__int64 (__fastcall *)(__int64, __int64, __int64, __int64, int, int *, unsigned int, char *, struct _DRAWSTREAMINFO *))EngDrawStream;
                  v50 = *(_QWORD *)(v39 + 48);
                  if ( *(_QWORD *)(v50 + 3384) )
                    v49 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, int *, unsigned int, char *, struct _DRAWSTREAMINFO *))(v50 + 3384);
                  ...
                  if ( v69[0] )
                  {
                    ...
                    if ( v52 )
                      v55 = v52 + 24;
                    if ( (unsigned int)v49(v39 + 24, v55, v44, (__int64)v72, (int)&v73, (int *)&v64, v65, v68, v71) )
                      v10 = 1;
                  }
            ...
            v48 = v70[0];
            v44 = (__int64)(v45 + 1768);
            v57 = XDCOBJ::prgnEffRao((DC **)v70[0]);
