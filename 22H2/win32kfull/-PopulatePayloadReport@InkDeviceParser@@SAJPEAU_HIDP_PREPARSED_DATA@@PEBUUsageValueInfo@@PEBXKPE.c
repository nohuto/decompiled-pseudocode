/*
 * XREFs of ?PopulatePayloadReport@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEBUUsageValueInfo@@PEBXKPEAXK@Z @ 0x1C024FAF4
 * Callers:
  ...
  *a5 = *((_BYTE *)a2 + 6);
  v6 = HidP_SetUsageValueArray(
         ...
         *((_WORD *)a2 + 30),
         ...
         ReportLength);
  v7 = v6;
  if ( v6 < 0 && (unsigned int)dword_1C032A288 > 2 )
  {
    v13 = 0;
    v9 = v6;
    v12 = 4;
    v11 = &v9;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032A288, (unsigned __int8 *)dword_1C02F1ECC, 0LL, 0LL, 3u, &v10);
  }
  return v7;
}
