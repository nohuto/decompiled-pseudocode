/*
 * XREFs of HT_CreateDeviceHalftoneInfo @ 0x1C0112328
 * Callers:
 ...
 *     GetCIEPrims @ 0x1C0112AE8 (GetCIEPrims.c)
 *     ComputeHTCell @ 0x1C0112CE4 (ComputeHTCell.c)
 *     MulDivFD6Pairs @ 0x1C011B080 (MulDivFD6Pairs.c)
 *     ComputeInverseMatrix3x3 @ 0x1C011B23C (ComputeInverseMatrix3x3.c)
 *     CleanUpDHI @ 0x1C0120910 (CleanUpDHI.c)
...
__int64 __fastcall HT_CreateDeviceHalftoneInfo(_DWORD *Src, _QWORD *a2)
{
  ...
  _DWORD v87[2]; // [rsp+E8h] [rbp-18h] BYREF
  ...
  *((_BYTE *)v4 + 74) = v84[0];
  ...
  if ( (v4[28] & 4) != 0 )
  {
    ...
    if ( (v64 & 4) != 0 )
    {
      ...
      v90 = 1000000;
      v87[0] = 1000000;
      ComputeInverseMatrix3x3(v87, (char *)v4 + 148);
      v65 = *((_DWORD *)v4 + 56);
      if ( (v65 & 1) == 0 )
      {
        v88 = *((_DWORD *)v4 + 37);
      ...
      *((_DWORD *)v4 + 128) = 0xFFFF;
      ...
      if ( v46 <= 6 && (v72 = *((_QWORD *)Src + 4)) != 0 && *(_WORD *)(v72 + 16) == 0xFFFE )
      {
        ...
        *((_DWORD *)v4 + 146) = DivFD6((unsigned int)(unsigned __int8)*(_WORD *)(v73 + 34) + 1, 256);
        ...
        if ( (unsigned __int16)v74 < 0x2710u )
        {
          if ( (_WORD)v74 )
