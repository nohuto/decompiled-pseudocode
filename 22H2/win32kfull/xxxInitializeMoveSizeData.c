/*
 * XREFs of xxxInitializeMoveSizeData @ 0x1C021184C
 * Callers:
 ...
 *     ?AreDockTargetsActive@@YAEPEAU_MOVESIZEDATA@@@Z @ 0x1C020A18C (-AreDockTargetsActive@@YAEPEAU_MOVESIZEDATA@@@Z.c)
...
LABEL_100:
  ...
  *((_DWORD *)v7 + 45) = dword_1C02F6248[a3];
  *((_DWORD *)v7 + 46) = dword_1C02F6218[a3];
  v67 = dword_1C02F62A8[a3];
  if ( v67 != -1 )
    *((_DWORD *)v7 + 42) = *((_DWORD *)v7 + (__int16)v67 + 30) - v21;
  v68 = dword_1C02F6278[a3];
  if ( v68 != -1 )
