/*
 * XREFs of NtUserfnGETWINDOWDATA @ 0x1C0100690
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C016DB10 (_guard_dispatch_icall_nop.c)
 *     ?GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z @ 0x1C01F5BF4 (-GetWindowData@@YA_JPEAUtagWND@@_JH_N@Z.c)
 */
        ...
        int a6)
{
  ...
  if ( a6 == 689 && a4 < 3 )
  {
    ...
    else
    {
      ...
      {
        WindowData = ((__int64 (__fastcall *)(struct tagWND *, _QWORD, __int64, __int64, ULONG64))qword_1C03390C8)(
                       a1,
                       a2,
                       a3,
                       a4,
        ...
        if ( a4 == 2 && (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 424LL) + 12LL) & 0x80u) != 0 )
        {
          if ( (*(_BYTE *)(*((_QWORD *)a1 + 5) + 18LL) & 1) == 0 || a3 )
            ...
            v15 = 17LL;
          return (((__int64 (__fastcall *)(struct tagWND *, _QWORD, __int64))qword_1C03390C8)(a1, a2, v15) << 32) | WindowData;
        }
      }
