/*
 * XREFs of ?InternalInvalidate2@@YAHPEAUtagWND@@PEAUHRGN__@@1PEAUtagRECT@@K@Z @ 0x1C00328E0
 * Callers:
...
LABEL_28:
  ...
  {
    Prop = GetProp(v8, (unsigned __int16)atomLayer, 1LL);
    v50 = Prop;
    if ( Prop )
    {
...
LABEL_60:
    ...
    *(_QWORD *)&v59.left = v57;
    ...
    if ( v32 )
    {
      LogicalToPhysicalInPlaceRect(v20, &v61);
      v35 = v53;
    }
    v29 = v56;
    v21 = v54;
