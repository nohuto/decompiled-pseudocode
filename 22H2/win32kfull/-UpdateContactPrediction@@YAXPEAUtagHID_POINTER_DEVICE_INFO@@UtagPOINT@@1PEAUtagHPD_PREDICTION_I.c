/*
 * XREFs of ?UpdateContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x1C01C1FA8
 * Callers:
 *     DoPrediction @ 0x1C0152D80 (DoPrediction.c)
 * Callees:
 *     ?DeltaOvershootCompensation@Prediction@@YA_J_J0@Z @ 0x1C0152AD0 (-DeltaOvershootCompensation@Prediction@@YA_J_J0@Z.c)
 ...
 *     ?Smooth@tagExpoSmoother@Prediction@@QEAA?AVCFixPred@2@V32@@Z @ 0x1C01C1E1C (-Smooth@tagExpoSmoother@Prediction@@QEAA-AVCFixPred@2@V32@@Z.c)
 */
