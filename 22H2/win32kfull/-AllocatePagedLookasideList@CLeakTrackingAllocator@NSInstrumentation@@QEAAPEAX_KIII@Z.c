/*
 * XREFs of ?AllocatePagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_KIII@Z @ 0x1C01278F4
 * Callers:
 *     Win32AllocPagedLookasideListImpl @ 0x1C01278D0 (Win32AllocPagedLookasideListImpl.c)
