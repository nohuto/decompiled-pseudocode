/*
 * XREFs of ?SetShape@SFMLOGICALSURFACE@@QEAAHPEAUHDEV__@@PEAU_SURFOBJ@@@Z @ 0x1C0015C80
 * Callers:
 ...
 *     vSpDwmMigrateLSurfShapeReferenceWrap @ 0x1C01355B0 (vSpDwmMigrateLSurfShapeReferenceWrap.c)
 * Callees:
