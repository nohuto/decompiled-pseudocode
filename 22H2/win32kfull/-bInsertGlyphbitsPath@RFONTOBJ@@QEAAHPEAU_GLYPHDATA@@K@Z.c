/*
 * XREFs of ?bInsertGlyphbitsPath@RFONTOBJ@@QEAAHPEAU_GLYPHDATA@@K@Z @ 0x1C02D50D4
 * Callers:
...
__int64 __fastcall RFONTOBJ::bInsertGlyphbitsPath(struct _FONTOBJ **this, struct _GLYPHDATA *a2, int a3)
{
  ...
  if ( v17 )
  {
    ...
    v15 = *(_QWORD *)&(*this)[2].iUniq;
    if ( (unsigned int)PFFOBJ::QueryFontData((PFFOBJ *)&v15, pvConsumer, v8, 2u, a2->hg, 0LL, v16, 0) != -1 )
    {
