/*
 * XREFs of _anonymous_namespace_::UpdateThresholdFromMetric @ 0x1C0041364
 * Callers:
        ...
        BOOL a6)
{
  ...
  {
    result = a6;
    *((_BYTE *)&unk_1C03591E0 + 4 * a6) = a5;
    *((_BYTE *)&unk_1C03591E0 + 4 * a6 + 1) = a5;
    *((_BYTE *)&unk_1C03591E0 + 4 * a6 + 2) = a5;
    *((_BYTE *)&unk_1C03591E0 + 4 * a6 + 3) = a5;
  }
  return result;
}
