/*
 * XREFs of ??0BOUNDCLIPRGNTOSURFACE@@QEAA@PEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C0149140
 * Callers:
  ...
  *((_DWORD *)this + 40) = 1;
  if ( a3 )
  {
    if ( *a3 )
    {
      ...
      *(_QWORD *)&v12.left = 0LL;
      v9 = *(struct _RECTL *)(*(_QWORD *)p_top + 96LL);
      if ( !(unsigned int)ERECTL::bContain((ERECTL *)&v12, &v9) )
      {
        ...
        *((_QWORD *)this + 19) = *(_QWORD *)&v9.left;
        if ( v7
          && v10[0]
          && v11[0]
          && (RGNOBJ::vSet((RGNOBJ *)v11, &v12), RGNOBJ::bMerge((RGNOBJ *)v10, p_top, (struct RGNOBJ *)v11, 8u))
