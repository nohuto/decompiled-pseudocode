/*
 * XREFs of ?CreateHLSURFClone@SFMLOGICALSURFACE@@SAPEAUHLSURF__@@PEAUHDEV__@@PEAV1@HHH@Z @ 0x1C00152CC
 * Callers:
 *     SFMLOGICALSURFACE_CreateHLSURFCloneWrap @ 0x1C0012960 (SFMLOGICALSURFACE_CreateHLSURFCloneWrap.c)
...
LABEL_20:
                       ...
                       *((_DWORD *)a2 + 72)) )
  {
    ...
    *(_DWORD *)(v12 + 240) = *((_DWORD *)a2 + 60);
    ...
    if ( HmgInsertObjectHelper::Insert((HmgInsertObjectHelper *)v28, (struct OBJECT *)v12, 0x12u, 8u) )
    {
      v8 = *(HLSURF *)v12;
      v13 = (v9 & 0x10 | 0x40u) >> 4;
