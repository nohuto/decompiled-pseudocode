/*
 * XREFs of GreResetDCInternal @ 0x1C02ADB48
 * Callers:
 *     NtGdiResetDC @ 0x1C02C4750 (NtGdiResetDC.c)
 * Callees:
  ...
  *(_QWORD *)(v16 + 1680) = 0LL;
  ...
  if ( (*((_DWORD *)v39[0] + 9) & 0x100) == 0 && *((_DWORD *)v39[0] + 8) != 1 && (*(_DWORD *)(v16 + 40) & 0x80u) != 0 )
  {
    ...
    if ( XDCOBJ::bCleanDC((XDCOBJ *)v39, 0) )
    {
      if ( *(_DWORD *)(v16 + 8) == 1 )
      {
        v20 = (HDC)hdcOpenDCW(&word_1C030D60C, a2, 0LL, 0LL, *(_QWORD *)(v16 + 2536), v36, a4, a5, 0);
        v9 = v20;
        if ( v20 )
        {
          *(_QWORD *)(v16 + 2536) = 0LL;
