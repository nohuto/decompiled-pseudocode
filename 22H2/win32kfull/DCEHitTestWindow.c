/*
 * XREFs of DCEHitTestWindow @ 0x1C01E4674
 * Callers:
 ...
 *     ?DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z @ 0x1C01E3928 (-DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z.c)
 *     BuildVertexList @ 0x1C01E4454 (BuildVertexList.c)
