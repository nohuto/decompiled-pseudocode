/*
 * XREFs of ?SendDeviceIOControl@SimpleHapticsController@@QEAAJKPEAXK0KPEAK@Z @ 0x1C025A65C
 * Callers:
 ...
 *     ??0LeaveEnterUserCritIfAcquired@@QEAA@XZ @ 0x1C02594A8 (--0LeaveEnterUserCritIfAcquired@@QEAA@XZ.c)
 */
