/*
 * XREFs of ?bSrcCopySRLE4D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02CCEC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSrcCopySRLE4D1(struct BLTINFO *a1)
{
  ...
  if ( v9 >= (int)v13 )
  {
    if ( v9 < v8 )
    {
      v15 = acBits[(v9 & 7) + 24] & *(_BYTE *)((unsigned int)(v9 >> 3) + v3);
      goto LABEL_10;
    }
    goto LABEL_8;
  }
  ...
  for ( i = v21 <= v11; ; i = v21 <= v67 )
  {
    ...
    if ( v23 )
    {
      ...
      else
      {
        ...
        if ( (int)v53 < (int)v56 )
        {
          *(_BYTE *)(v25 + v3) = v15 | ((unsigned __int8)(v51 & acBits[v53 + 25]) >> v76);
          LODWORD(v52) = v68;
          if ( (v68 & 1) == 0 )
          {
            v51 *= 2;
    ...
    if ( !(_DWORD)v26 )
    {
      ...
      if ( v5 < v63 && (v9 & 7) != 0 )
      {
        ...
        {
          *(_BYTE *)(v25 + v3) = v15 | *(_BYTE *)(v25 + v3) & ~acBits[(v9 & 7) + 24];
          goto LABEL_72;
        }
    ...
    if ( (_DWORD)v26 != 2 )
    {
      ...
      else
      {
        ...
        else
        {
          ...
          v25 = (unsigned int)(v60 >> 3);
          v9 = v60;
          v30 = acBits[(unsigned __int8)(7 - (v60 & 7)) + 40];
          if ( (v29 & 1) != 0 )
          {
            v31 = v15 | v30;
            v30 >>= 1;
