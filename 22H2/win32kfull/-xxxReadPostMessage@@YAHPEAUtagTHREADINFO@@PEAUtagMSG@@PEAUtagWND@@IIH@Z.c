/*
 * XREFs of ?xxxReadPostMessage@@YAHPEAUtagTHREADINFO@@PEAUtagMSG@@PEAUtagWND@@IIH@Z @ 0x1C012A920
 * Callers:
        ...
        unsigned int a6)
{
  ...
  *((_DWORD *)a1 + 192) = *(_DWORD *)(v17 + 56);
  ...
  if ( (unsigned __int64)(unsigned __int16)v41 >= *(_QWORD *)(gpsi + 8LL) )
    goto LABEL_37;
  v42 = gSharedInfo[1] + LODWORD(gSharedInfo[2]) * (unsigned int)(unsigned __int16)v41;
  ...
  {
    if ( v27 || !PsGetCurrentProcessWow64Process(v42, v26, 0x7FFFLL) )
      goto LABEL_37;
    v28 = v42;
    v26 = v44;
  }
