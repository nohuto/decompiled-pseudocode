/*
 * XREFs of UmfdFontManagement @ 0x1C02DE310
 * Callers:
 ...
 *     ?GetDrvType@FontManagementRequest@@UEBA?AW4FontDriverType@@XZ @ 0x1C02DE1E0 (-GetDrvType@FontManagementRequest@@UEBA-AW4FontDriverType@@XZ.c)
 */
