/*
 * XREFs of WPP_RECORDER_SF_qiqdd @ 0x1C00585D0
 * Callers:
...
__int64 WPP_RECORDER_SF_qiqdd(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x20000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, __int64, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(v5, 4LL, 18LL, a5, v8, (__int64 *)va, 8LL, (__int64 *)va1, 8LL, (__int64 *)va2);
}
