/*
 * XREFs of ??0UMPDSURFOBJ@@QEAA@PEAU_SURFOBJ@@PEAVUMPDOBJ@@@Z @ 0x1C02C6DC8
 * Callers:
 ...
 *     ?ValidateAndReferencePDEV@@YAPEAUHDEV__@@PEAU1@@Z @ 0x1C02C7658 (-ValidateAndReferencePDEV@@YAPEAUHDEV__@@PEAU1@@Z.c)
 */
