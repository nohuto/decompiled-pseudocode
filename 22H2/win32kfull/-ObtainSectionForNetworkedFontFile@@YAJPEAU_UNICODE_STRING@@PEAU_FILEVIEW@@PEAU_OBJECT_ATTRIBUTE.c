/*
 * XREFs of ?ObtainSectionForNetworkedFontFile@@YAJPEAU_UNICODE_STRING@@PEAU_FILEVIEW@@PEAU_OBJECT_ATTRIBUTES@@PEAT_LARGE_INTEGER@@_N@Z @ 0x1C02891AC
 * Callers:
        ...
        bool a5)
{
  ...
  NTSTATUS SectionRetainHandle; // esi
  const WCHAR *v9; // rdx
  void **v10; // rax
