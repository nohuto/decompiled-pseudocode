/*
 * XREFs of ?xxxTrackInitSize@@YAHPEAUtagWND@@I_K_JPEAU_MOVESIZEDATA@@@Z @ 0x1C02106D4
 * Callers:
...
LABEL_14:
    ...
    if ( !v14 )
    {
      if ( (unsigned int)(v10 - 10) <= 7 )
      {
        ...
        *((_DWORD *)a5 + 49) &= ~1u;
        v15 = dword_1C02F6224[v10];
        v16 = dword_1C02F61F4[v10];
        *((_DWORD *)a5 + 45) = v15;
        v17 = v16 + v15;
        *((_DWORD *)a5 + 46) = v16;
        *((_DWORD *)a5 + 44) = v17;
        v18 = dword_1C02F6278[v17];
        *((_DWORD *)a5 + 42) = *((_DWORD *)a5 + dword_1C02F62A8[v17] + 30) - v19;
