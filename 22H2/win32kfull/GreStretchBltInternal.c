/*
 * XREFs of GreStretchBltInternal @ 0x1C00B49B0
 * Callers:
 ...
 *     NtGdiStretchBlt @ 0x1C010AEB0 (NtGdiStretchBlt.c)
 ...
 *     ??1UNDORENDERLOCKCOUNTS@@QEAA@XZ @ 0x1C012B864 (--1UNDORENDERLOCKCOUNTS@@QEAA@XZ.c)
 ...
 *     ?TrgPlg@BLTRECORD@@QEAAHHHHH@Z @ 0x1C028F780 (-TrgPlg@BLTRECORD@@QEAAHHHHH@Z.c)
 */
...
LABEL_37:
    ...
    if ( (a13 & 2) == 0 || !HIDWORD(WPP_MAIN_CB.DeviceQueue.Lock) )
