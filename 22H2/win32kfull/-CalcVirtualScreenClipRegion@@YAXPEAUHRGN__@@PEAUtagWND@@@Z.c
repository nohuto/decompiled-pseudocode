/*
 * XREFs of ?CalcVirtualScreenClipRegion@@YAXPEAUHRGN__@@PEAUtagWND@@@Z @ 0x1C0214F34
 * Callers:
...
void __fastcall CalcVirtualScreenClipRegion(HRGN a1, struct tagWND *a2)
{
    ...
    && (v5 = (*(_DWORD *)(*((_QWORD *)a2 + 5) + 288LL) >> 8) & 0x1FF) != 0 )
  {
    ...
    if ( *(_DWORD *)*gpDispInfo == 1 )
    {
      ...
      MonitorRectForDpi = (__m128i *)GetMonitorRectForDpi(v13.m128i_i64, *(_QWORD *)(DispInfo + 96), v5);
LABEL_6:
    ...
    if ( !EmptyRgn )
    {
      MonitorRectForDpi = GetScreenRectForWindow(&v13, a2);
      goto LABEL_6;
    }
    for ( i = *(_QWORD *)(gpDispInfo + 104LL); i; i = *(_QWORD *)(i + 56) )
    {
      ...
      {
        v14 = *(__m128i *)GetMonitorRectForDpi(v13.m128i_i64, i, v5);
