/*
 * XREFs of GreSetDIBits @ 0x1C02DE7F8
 * Callers:
 ...
 * Callees:
 *     pbmiConvertInfo @ 0x1C02C4F68 (pbmiConvertInfo.c)
...
__int64 __fastcall GreSetDIBits(HDC a1, HSURF a2, __int64 a3, __int64 a4, __int64 a5, unsigned int *a6)
{
  unsigned int v6; // esi
  unsigned int *v9; // rdi
  ...
  if ( !a6 )
    goto LABEL_7;
  if ( *a6 == 12 )
    v9 = (unsigned int *)pbmiConvertInfo((unsigned __int16 *)a6, (__int64)a2, a3, a4);
  if ( *a6 >= 0x28 && a6[4] - 4 <= 1 )
  {
