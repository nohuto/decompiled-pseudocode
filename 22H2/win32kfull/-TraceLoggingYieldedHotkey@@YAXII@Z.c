/*
 * XREFs of ?TraceLoggingYieldedHotkey@@YAXII@Z @ 0x1C0225528
 * Callers:
...
void __fastcall TraceLoggingYieldedHotkey(__int64 a1, int a2)
{
  ...
  {
    v7 = 0x400000000000LL;
    if ( (qword_1C032A3E8 & 0x400000000000LL) != 0 && (qword_1C032A3F0 & 0x400000000000LL) == qword_1C032A3F0 )
    {
      if ( CurrentProcessWin32Process )
        ProcessImageFileName = (void *)PsGetProcessImageFileName(*CurrentProcessWin32Process);
      else
        ProcessImageFileName = &unk_1C02F5020;
