/*
 * XREFs of ?CreateW32Job@@YAPEAUtagW32JOB@@PEAU_EJOB@@@Z @ 0x1C0113EE4
 * Callers:
...
struct tagW32JOB *__fastcall CreateW32Job(struct _EJOB *a1)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_q((_DWORD)a1, 4, 13, 15, (__int64)&WPP_8a8a5c1bf24e3db582f892aeb1cd1399_Traceguids, (char)a1);
  ...
  *v3 = gpJobsList;
  ...
  v3[1] = a1;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_qq(gpJobsList, 4u, 0xDu, 0x10u, (__int64)&WPP_8a8a5c1bf24e3db582f892aeb1cd1399_Traceguids, v3, a1);
