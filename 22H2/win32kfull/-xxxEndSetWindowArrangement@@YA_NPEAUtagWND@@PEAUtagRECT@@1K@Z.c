/*
 * XREFs of ?xxxEndSetWindowArrangement@@YA_NPEAUtagWND@@PEAUtagRECT@@1K@Z @ 0x1C020D970
 * Callers:
 ...
 *     ?ArrangementStyleFromOverlap@@YAKK@Z @ 0x1C020A29C (-ArrangementStyleFromOverlap@@YAKK@Z.c)
 ...
 *     ?IsEqualRectToArrangedWindow@@YAHPEAUtagWND@@QEBUtagRECT@@@Z @ 0x1C020B148 (-IsEqualRectToArrangedWindow@@YAHPEAUtagWND@@QEBUtagRECT@@@Z.c)
...
LABEL_58:
  ...
  if ( v29 )
  {
    ...
    if ( !v4 )
    {
      if ( a3 )
      {
        Prop = (struct tagRECT *)GetProp((__int64)a1, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
        if ( Prop )
          *Prop = *a3;
      }
    }
