/*
 * XREFs of ?GreGetGlyphOutlineInternal@@YAKPEAUHDC__@@GIPEAU_GLYPHMETRICS@@KPEAXPEAU_MAT2@@HW4EntryPoint@RFONTOBJ@@@Z @ 0x1C00745D4
 * Callers:
 ...
 *     ?bSkipCHSFontSegUISymFallback@RFONTOBJ@@QEAAHGPEAVPFF@@0@Z @ 0x1C015C570 (-bSkipCHSFontSegUISymFallback@RFONTOBJ@@QEAAHGPEAVPFF@@0@Z.c)
        ...
        int a8)
{
  ...
  _GLYPHDATA v79; // [rsp+100h] [rbp+0h] BYREF
...
LABEL_87:
  ...
  if ( v61 )
  {
    ...
    else
    {
      v59 = 0;
      v58 = v10;
      RFONTOBJ::vXlatGlyphArray((RFONTOBJ *)&v61, &v58, 1u, &v59, 0, 0);
      v11 = v59;
      v18 = v61;
      v66 = v59;
    }
        ...
        if ( v20 )
        {
          ...
          *(_DWORD *)(v19 + 712) |= 1u;
          ...
          if ( v24 )
          {
            ...
            v27 = v65;
            RFONTOBJ::vXlatGlyphArray((RFONTOBJ *)&v65, &v58, 1u, &v59, 0, 0);
          ...
          if ( v31 )
          {
            ...
            v69 = v31;
            v58 = v10;
            RFONTOBJ::vXlatGlyphArray((RFONTOBJ *)&v69, &v58, 1u, &v59, 0, 0);
...
LABEL_38:
          ...
          v68 = v40;
          v58 = v10;
          RFONTOBJ::vXlatGlyphArray((RFONTOBJ *)&v68, &v58, 1u, &v59, 0, 0);
          v42 = v59;
...
LABEL_46:
  ...
  if ( v44 )
  {
    ...
    if ( !LODWORD(v74[0]) )
    {
      EngSetLastError(0x3EBu);
LABEL_80:
      RESETFCOBJ::~RESETFCOBJ((RFONTOBJ **)v74);
LABEL_82:
      if ( v60 )
