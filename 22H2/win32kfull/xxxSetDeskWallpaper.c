/*
 * XREFs of xxxSetDeskWallpaper @ 0x1C0049544
 * Callers:
 ...
 *     DwmAsyncNotifyWallpaperChange @ 0x1C0049A08 (DwmAsyncNotifyWallpaperChange.c)
 *     ?SetGlobalWallpaperSettings@@YAHPEBUtagWALLPAPERSETTINGS@@@Z @ 0x1C0049D3C (-SetGlobalWallpaperSettings@@YAHPEBUtagWALLPAPERSETTINGS@@@Z.c)
...
__int64 __fastcall xxxSetDeskWallpaper(__int64 a1, size_t *a2)
{
  ...
  if ( g_pWallpaperSettings )
    RtlStringCchCopyW(v22, 0x100uLL, (size_t *)(g_pWallpaperSettings + 4LL));
  else
