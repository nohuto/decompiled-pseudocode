/*
 * XREFs of ?GdiAdjustSpriteDirtyAccum@@YAHPEAUHDEV__@@PEAUHWND__@@PEAU_RECTL@@2PEAU_POINTL@@3@Z @ 0x1C0279E5C
 * Callers:
        ...
        struct _POINTL *a6)
{
  ...
  if ( *((_DWORD *)v23 + 35) )
  {
    ...
    if ( MetaSprite && v13 )
    {
      ...
      do
      {
        ...
        v17 = v14->x - *(_DWORD *)(v15 + 2560);
        v18 = (struct _RECTL *)*(unsigned int *)(v15 + 2564);
        LODWORD(v15) = v14->y - (_DWORD)v18;
        v22.x = v17;
        v22.y = v15;
  ...
  else
  {
    ...
    if ( Sprite )
      vSpAdjustSpriteDirtyAccum(Sprite, (struct _RECTL *)a6, a3, a5, a6);
  }
