/*
 * XREFs of IsWindowGDIScaledDpiMessageEnabledX @ 0x1C01E5338
 * Callers:
 *     NtUserIsWindowGDIScaledDpiMessageEnabled @ 0x1C01FDE40 (NtUserIsWindowGDIScaledDpiMessageEnabled.c)
 * Callees:
