/*
 * XREFs of InitializeWin32PoolTracking @ 0x1C0135AF0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsWin32kRefreshed@@YA_NXZ @ 0x1C021F454 (-IsWin32kRefreshed@@YA_NXZ.c)
 *     ?LoadWin32PoolTrackingSettings@@YAXXZ @ 0x1C021F6BC (-LoadWin32PoolTrackingSettings@@YAXXZ.c)
 *     ?StopWin32PoolTracking@@YAXXZ @ 0x1C021F89C (-StopWin32PoolTracking@@YAXXZ.c)
 */
...
__int64 InitializeWin32PoolTracking()
{
  ...
  {
    *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels = &unk_1C033C380;
    return 0LL;
  }
}
