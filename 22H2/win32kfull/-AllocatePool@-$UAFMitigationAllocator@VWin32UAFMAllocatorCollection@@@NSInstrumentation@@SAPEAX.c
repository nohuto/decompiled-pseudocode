/*
 * XREFs of ?AllocatePool@?$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@SAPEAXW4_POOL_TYPE@@_KIPEAI@Z @ 0x1C021F37C
 * Callers:
 *     Win32UAFMAllocPagedLookasideListImpl @ 0x1C021FBE0 (Win32UAFMAllocPagedLookasideListImpl.c)
 *     Win32UAFMAllocPoolImpl @ 0x1C021FC60 (Win32UAFMAllocPoolImpl.c)
 * Callees:
