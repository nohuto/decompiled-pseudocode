/*
 * XREFs of LookUpTableFlushComplete @ 0x1C039981C
 * Callers:
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0399F50 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C039A8A0 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 * Callees:
 *     _tlgKeywordOn @ 0x1C0041D94 (_tlgKeywordOn.c)
 *     FlushLookUpTableBucket @ 0x1C00B3DCC (FlushLookUpTableBucket.c)
 ...
 *     UpdateInternalStatsOnFlush @ 0x1C0399908 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C0354188 > 5 && tlgKeywordOn((__int64)&dword_1C0354188, 0x200000000000LL) )
      {
        v7 = *(_QWORD *)(a1 + 344);
        v49 = 32;
        v8 = *(_QWORD *)(v7 + 8);
