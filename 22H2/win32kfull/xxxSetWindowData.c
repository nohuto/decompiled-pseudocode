/*
 * XREFs of xxxSetWindowData @ 0x1C008A1A8
 * Callers:
 ...
 *     ?LockPointer@@YA?AU_LOCKASSIGNPAIR@@PEAV?$SharedUserObjPointerFieldspwndOwner@UtagWND@@@tagWND@@PEAX@Z @ 0x1C0038900 (-LockPointer@@YA-AU_LOCKASSIGNPAIR@@PEAV-$SharedUserObjPointerFieldspwndOwner@UtagWND@@@tagWND@@.c)
 ...
 *     MapClientToServerPfn @ 0x1C00FC538 (MapClientToServerPfn.c)
 ...
 *     ValidateOwnerDepth @ 0x1C011B824 (ValidateOwnerDepth.c)
...
LABEL_42:
      ...
      if ( v42 && GetProp((__int64)a1, (unsigned __int16)WPP_MAIN_CB.DeviceQueue.Type, 1LL) )
        goto LABEL_97;
      ...
      if ( v36 == (struct tagWND *)v71 )
      {
        if ( !v42 )
          goto LABEL_55;
        if ( GetProp(v42, (unsigned __int16)WPP_MAIN_CB.DeviceQueue.Type, 1LL) )
          goto LABEL_97;
      }
      if ( v42 )
      {
