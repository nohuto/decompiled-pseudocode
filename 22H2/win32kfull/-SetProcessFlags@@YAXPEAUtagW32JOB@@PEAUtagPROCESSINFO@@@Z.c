/*
 * XREFs of ?SetProcessFlags@@YAXPEAUtagW32JOB@@PEAUtagPROCESSINFO@@@Z @ 0x1C00A2F0C
 * Callers:
...
void __fastcall SetProcessFlags(struct tagW32JOB *a1, struct tagW32JOB **a2)
{
  ...
  __int64 v10; // rdx
  __int64 v11; // r8
  char v12[8]; // [rsp+60h] [rbp-98h] BYREF
  struct tagW32JOB *v13; // [rsp+68h] [rbp-90h]
  struct tagW32JOB **v14; // [rsp+88h] [rbp-70h]
  _DWORD *v15; // [rsp+90h] [rbp-68h]
