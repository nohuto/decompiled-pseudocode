/*
 * XREFs of ?UpdateIntObjUsage@@YAXPEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYPE@@_K@Z @ 0x1C025858C
 * Callers:
...
__int64 __fastcall UpdateIntObjUsage(__int64 a1, __int64 a2, __int16 a3, int a4, unsigned __int64 a5)
{
  ...
  else
  {
    ...
    if ( (v5 & 4) != 0 && (a3 & 0x1000) != 0 )
    {
      ...
      v14 = DOUBLE_1_0;
      v15 = 2;
      for ( i = (double)((int)v23 - (int)qword_1C03409B4); ; i = i * i )
      {
        if ( (v15 & 1) != 0 )
          v14 = v14 * i;
        v15 >>= 1;
      ...
      for ( j = (double)(HIDWORD(v23) - HIDWORD(qword_1C03409B4)); ; j = j * j )
      {
        if ( (v8 & 1) != 0 )
          v13 = v13 * j;
        v8 >>= 1;
    ...
    if ( (a3 & 0x400) != 0 )
    {
      gmsInputEndTime = a5;
      if ( a5 > gmsInputStartTime && gmsInputStartTime )
        qword_1C0340A18 += a5 - gmsInputStartTime;
      gmsInputStartTime = a5;
    ...
    if ( (a3 & 0x800) != 0 )
    {
      ...
      {
        if ( gmsInputStartTime )
          qword_1C0340A48 += a5 - gmsInputStartTime;
      }
      gmsInputStartTime = a5;
    }
  }
  ...
  dword_1C03409C0 = result;
  *(__int64 *)((char *)&qword_1C03409B4 + 4) = v22;
  return result;
}
