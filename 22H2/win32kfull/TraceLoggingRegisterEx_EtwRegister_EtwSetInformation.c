/*
 * XREFs of TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x1C0399AD8
 * Callers:
 *     ??0InteractiveControlManager@@AEAA@XZ @ 0x1C003D6E4 (--0InteractiveControlManager@@AEAA@XZ.c)
 *     ??0InkProcessor@@AEAA@XZ @ 0x1C003DD20 (--0InkProcessor@@AEAA@XZ.c)
 *     EnableUserkTraceLogging @ 0x1C00B46B0 (EnableUserkTraceLogging.c)
