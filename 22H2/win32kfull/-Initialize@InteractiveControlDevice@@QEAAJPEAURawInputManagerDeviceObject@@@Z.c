/*
 * XREFs of ?Initialize@InteractiveControlDevice@@QEAAJPEAURawInputManagerDeviceObject@@@Z @ 0x1C0256DD0
 * Callers:
 ...
 *     ?InitializeWaveformOrdinalForDevice@InteractiveControlDevice@@QEAAJXZ @ 0x1C02571DC (-InitializeWaveformOrdinalForDevice@InteractiveControlDevice@@QEAAJXZ.c)
...
__int64 __fastcall InteractiveControlDevice::Initialize(InteractiveControlDevice *this, char *Object)
{
  ...
  {
    v6 = dword_1C033340C;
    *((_DWORD *)this + 2) = dword_1C033340C;
    *(_QWORD *)this = Object;
    dword_1C033340C = v6 + 1;
