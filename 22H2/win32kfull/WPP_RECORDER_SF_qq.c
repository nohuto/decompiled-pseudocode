/*
 * XREFs of WPP_RECORDER_SF_qq @ 0x1C004F2B4
 * Callers:
 ...
 *     ?JobCalloutAddProcess@@YAHPEAUtagW32JOB@@PEAUtagPROCESSINFO@@@Z @ 0x1C0113FCC (-JobCalloutAddProcess@@YAHPEAUtagW32JOB@@PEAUtagPROCESSINFO@@@Z.c)
