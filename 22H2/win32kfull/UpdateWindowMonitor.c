/*
 * XREFs of UpdateWindowMonitor @ 0x1C00D16E0
 * Callers:
...
void __fastcall UpdateWindowMonitor(struct tagWND *a1, __int64 *a2)
{
  ...
  __int64 v42; // rdx
  __int64 v43; // r8
  __int64 v44; // [rsp+30h] [rbp-98h] BYREF
  _BYTE v45[136]; // [rsp+40h] [rbp-88h] BYREF
  char v46; // [rsp+D8h] [rbp+10h] BYREF
  char v47; // [rsp+E0h] [rbp+18h] BYREF
...
LABEL_56:
      ...
      else
      {
        ...
        if ( WindowCoordinateSpaceDpi == GetWindowCoordinateSpaceDpi(*v9) )
        {
          ...
          if ( v36 )
          {
            GetMonitorRectForDpi(&v44, v36, (*(_DWORD *)(*(_QWORD *)v7 + 288LL) >> 8) & 0x1FF);
            v27 = *(_QWORD *)(*(_QWORD *)(v36 + 40) + 28LL) != v44;
          }
          v6 = v48;
        }
        else
      ...
      else if ( (*(_DWORD *)(v28 + 232) & 2) != 0 )
      {
        if ( IsChildWindowCoordinateSpaceBoundary(a1) )
        {
          ...
          if ( GetTopLevelWindow((__int64)a1) )
          {
            ...
            AtomicExecutionCheck::Disarm((AtomicExecutionCheck *)&v46, v38, v39);
          }
        }
      }
      if ( (!*v9
      ...
      if ( (*(_BYTE *)(*(_QWORD *)v7 + 26LL) & 8) != 0 )
      {
        ...
        InitializeMonitorInfo(v45, *(unsigned int *)(v32 + 288), a2, a1);
        GreDwmNotifySpriteMonitorChange(v37, *(_QWORD *)a1, 0LL, v45);
      }
    ...
    if ( (*(_BYTE *)(*(_QWORD *)v7 + 26LL) & 8) != 0 )
      UpdateWindowSpriteMonitor(a1, a2);
  }
}
