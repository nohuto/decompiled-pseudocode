/*
 * XREFs of ?IsCompositeAppOrSelfDisabled@CoreWindowProp@@SAHPEBUtagWND@@@Z @ 0x1C00D72C8
 * Callers:
 ...
 *     EditionIsCompositeAppOrSelfDisabled @ 0x1C0208B30 (EditionIsCompositeAppOrSelfDisabled.c)
