/*
 * XREFs of zzzAttachThreadInput @ 0x1C005BB64
 * Callers:
...
__int64 __fastcall zzzAttachThreadInput(__int64 a1, __int64 a2, __int16 a3)
{
  ...
  if ( a1 != a2 )
  {
    if ( (a3 & 0x8000) == 0 )
    {
      ...
      {
        if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 424LL) + 888LL, *(_QWORD *)(a2 + 432) + 432LL)
...
LABEL_9:
        ...
        if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 424LL) + 888LL, *(_QWORD *)(a1 + 432) + 432LL)
          && *(int *)(*(_QWORD *)(gptiCurrent + 424LL) + 12LL) >= 0
          ...
          && (*(_DWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 816LL) & 0x100) == 0 )
        {
          v8 = *(_QWORD *)(a1 + 432);
          v9 = a1;
          goto LABEL_9;
