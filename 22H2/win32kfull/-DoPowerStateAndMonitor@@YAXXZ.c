/*
 * XREFs of ?DoPowerStateAndMonitor@@YAXXZ @ 0x1C00519F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DoPowerStateAndMonitor(__int64 a1)
{
  ...
  if ( v7 <= 0
    || !CInputGlobals::IsTimeFromLastInputEvent(gpInputGlobals, v7)
    || CInputGlobals::IsTimeFromLastInputEvent(gpInputGlobals, dword_1C035E190 + 10000) )
  {
    v9 = 0;
    dword_1C035E190 = 0;
  }
    ...
    && !v9 )
  {
    ...
    {
      if ( !gpqForeground || (v15 = *(struct tagWND **)(gpqForeground + 128LL)) == 0LL )
      {
        *((_QWORD *)&v27 + 1) = v26;
LABEL_40:
        *(_QWORD *)&v27 = 5LL;
    ...
    PostTransformableMessage(v15, 0x112u, 0xF170uLL, 2LL, 0);
  }
LABEL_41:
