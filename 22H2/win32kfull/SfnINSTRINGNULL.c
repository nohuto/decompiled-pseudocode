/*
 * XREFs of SfnINSTRINGNULL @ 0x1C004FDF0
 * Callers:
...
__int64 __fastcall SfnINSTRINGNULL(__int64 *a1, int a2, __int64 a3, int *a4, __int64 a5, __int64 a6, char a7)
{
  ...
  *(_QWORD *)&v39 = ThreadWin32Thread;
  ...
  if ( v12 )
  {
    v9 = AllocCallbackMessage(88, v12, (unsigned int)v13, v49, 1, 0x200uLL);
    v35 = v9;
    if ( !v9 )
      return 0LL;
  }
  ...
  if ( v9 != (unsigned __int8 *)v48 && v9 != v49 )
    PushW32ThreadLock(v9, &v45, Win32FreePool);
  *((_QWORD *)v9 + 5) = v11;
  *((_DWORD *)v9 + 12) = v36;
  *((_QWORD *)v9 + 7) = v38;
  if ( v12 )
...
LABEL_13:
  ...
  *((_QWORD *)v9 + 2) = 0LL;
  v20 = KeUserModeCallback(27LL, v9, *(unsigned int *)v9, &v37, &v34);
