/*
 * XREFs of zzzUpdateCursorImage @ 0x1C0080E90
 * Callers:
 ...
 *     ?SetCursorImage@Cursor@InputTraceLogging@@SAXPEAUtagCURSOR@@0IW4CursorImageReason@12@KK@Z @ 0x1C002A628 (-SetCursorImage@Cursor@InputTraceLogging@@SAXPEAUtagCURSOR@@0IW4CursorImageReason@12@KK@Z.c)
 ...
 *     ?FCursorShadowed@@YAHPEAU_CURSINFO@@@Z @ 0x1C00820A0 (-FCursorShadowed@@YAHPEAU_CURSINFO@@@Z.c)
    ...
    if ( v0 && (*(_DWORD *)(v0 + 80) & 8) != 0 && *(_QWORD *)(v0 + 112) )
    {
      if ( !*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.1 )
      {
        *(_DWORD *)(v0 + 120) = 0;
        ...
        WPP_MAIN_CB.DeviceQueue.1 = (struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C)SetRITTimer(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.1, 100 * *v27 / 6u, zzzAnimateCursor, 1LL);
      }
    }
...
LABEL_49:
  ...
  if ( gpcurPhysCurrent != AnimatedCursorFrame )
  {
    ...
    if ( AnimatedCursorFrame )
    {
      ...
      if ( !v19 )
        v21 = v20;
      if ( HIDWORD(WPP_MAIN_CB.DeviceQueue.Lock) == 1 )
        v21 |= 0x20u;
