/*
 * XREFs of ?CanCoalesceRawInputPayload@@YA_NPEAUtagPROCESS_HID_TABLE@@PEAXPEBUtagRAWMOUSE@@@Z @ 0x1C01AAB4C
 * Callers:
...
char __fastcall CanCoalesceRawInputPayload(struct tagPROCESS_HID_TABLE *a1, void *a2, const struct tagRAWMOUSE *a3)
{
  ...
  if ( *((_DWORD *)a1 + 28) != 2 )
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 349);
