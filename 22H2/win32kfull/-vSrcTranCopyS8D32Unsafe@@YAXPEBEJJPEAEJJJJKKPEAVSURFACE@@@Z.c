/*
 * XREFs of ?vSrcTranCopyS8D32Unsafe@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1C003A220
 * Callers:
 *     ?vSrcTranCopyS8D32@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z @ 0x1C0039F30 (-vSrcTranCopyS8D32@@YAXPEBEJJPEAEJJJJKKPEAVSURFACE@@@Z.c)
 * Callees:
        ...
        else
        {
          ...
          else
          {
            ...
            v32 = v44 & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v31
                                                                          + ((dword_1C0316F10[*(unsigned __int8 *)(v30 + v29)]
                                                                            * (v47 - v31)
                                                                            + 0x80000) >> 20))
                                                           + v22) << v39) >> v38);
