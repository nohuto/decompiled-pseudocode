/*
 * XREFs of xxxInitSendValidateMinMaxInfoEx @ 0x1C0064CA0
 * Callers:
...
__int64 __fastcall xxxInitSendValidateMinMaxInfoEx(struct tagWND *a1, __int64 a2, struct tagMONITOR *a3, int a4)
{
  ...
  *(_DWORD *)(a2 + 4) = v7;
  ...
  v18 = v17 + HIDWORD(v71);
  *(_DWORD *)(a2 + 8) = v16;
  v19 = WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc);
  *(_DWORD *)(a2 + 12) = v18;
  Prop = GetProp(a1, v19, 1LL);
  ...
  *(_DWORD *)(a2 + 4) = v30;
  if ( v12 )
  {
    ...
    else
    {
      ...
      v38 = GetProp(a1, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
      if ( v38 )
      {
        v56 = *(_DWORD *)(v38 + 48);
