/*
 * XREFs of HT_HalftoneBitmap @ 0x1C001A9EC
 * Callers:
 *     EngHTBlt @ 0x1C0019E98 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C001AC98 (SanityCheckDimension.c)
 *     AAHalftoneBitmap @ 0x1C001ACC8 (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x1C001C170 (pDCIAdjClr.c)
 *     CheckABInfo @ 0x1C0260AAC (CheckABInfo.c)
 */
