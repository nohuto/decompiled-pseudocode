/*
 * XREFs of ?GreGetTextExtentExW@@YAHPEAUHDC__@@PEAGKKPEAK2PEAUtagSIZE@@KW4EntryPoint@RFONTOBJ@@@Z @ 0x1C007D494
 * Callers:
  ...
  if ( (a2 || !a3) && a7 )
  {
    if ( a3 )
    {
      ...
      if ( v19[0] )
      {
        ...
        EXFORMOBJ::vQuickInit((EXFORMOBJ *)v21, (struct XDCOBJ *)v19, 0x204u);
        v16 = 0LL;
