/*
 * XREFs of ?xxxMoveDragRectFromMaximize@@YAXPEAUMOVESIZEDATA@@UtagPOINT@@AEBUtagRECT@@W4THRESHOLD_MARGIN_DIRECTION@@PEAU3@PEAI@Z @ 0x1C01EF7DC
 * Callers:
...
__int64 __fastcall xxxMoveDragRectFromMaximize(__int64 a1, __int64 a2, _DWORD *a3, int a4, _DWORD *a5, _DWORD *a6)
{
  unsigned int v8; // edx
  int v10; // edx
  int v11; // ecx
  ...
  _QWORD v27[3]; // [rsp+80h] [rbp-78h] BYREF
  int v28; // [rsp+98h] [rbp-60h]
  char v29; // [rsp+9Ch] [rbp-5Ch]
...
LABEL_32:
  ...
  *a5 = a2 + v20;
  ...
  if ( (result & 0x20) != 0 )
  {
    ...
    v28 = 0;
    *a6 = 532;
    v25 = *(struct tagWND **)(a1 + 16);
    v27[1] = a5;
    v29 = 0;
    v30 = 0LL;
    return xxxMinMaximizeEx(v25, 9u, 12, (__int64)v27);
  }
  return result;
}
