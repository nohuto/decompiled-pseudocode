/*
 * XREFs of ?ReadTabletButtonConfig@@YAJIQEBGPEAUtagTABLET_BUTTON_DESK_CONFIG@@@Z @ 0x1C01D843C
 * Callers:
 *     ?ReadTabletButtonSettings@@YAXXZ @ 0x1C01D8864 (-ReadTabletButtonSettings@@YAXXZ.c)
 * Callees:
