/*
 * XREFs of ?vFillGRectDIB16_565@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02F72B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    do
    {
      ...
      if ( v19 < &v19[*((int *)v2 + 10)] )
      {
        ...
        do
        {
          ...
          v26 = HIDWORD(v15);
          v15 += v32;
          v27 = byte_1C03297A0[(unsigned __int64)(v23 + ((unsigned int)v26 >> 2)) >> 16] | (unsigned __int16)(v25 << 6);
          v28 = HIDWORD(v17);
          v17 += v33;
