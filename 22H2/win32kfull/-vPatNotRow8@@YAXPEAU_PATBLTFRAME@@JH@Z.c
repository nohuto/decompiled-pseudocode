/*
 * XREFs of ?vPatNotRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02E75E0
 * Callers:
 *     <none>
 * Callees:
 *     vFetchNotAndCopy @ 0x1C030411C (vFetchNotAndCopy.c)
 *     vFetchShiftNotAndCopy @ 0x1C030428C (vFetchShiftNotAndCopy.c)
 */
