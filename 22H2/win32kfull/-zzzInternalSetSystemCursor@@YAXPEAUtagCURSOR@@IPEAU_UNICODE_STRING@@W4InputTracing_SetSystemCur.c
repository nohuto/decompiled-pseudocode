/*
 * XREFs of ?zzzInternalSetSystemCursor@@YAXPEAUtagCURSOR@@IPEAU_UNICODE_STRING@@W4InputTracing_SetSystemCursorReason@@@Z @ 0x1C0024CFC
 * Callers:
 ...
 *     ?GetCursorOrFrame@InputTraceLogging@@CAPEAUtagCURSOR@@PEAU2@@Z @ 0x1C01A8914 (-GetCursorOrFrame@InputTraceLogging@@CAPEAUtagCURSOR@@PEAU2@@Z.c)
 */
  ...
  if ( (unsigned int)dword_1C0359080 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0359080, 8LL) )
  {
    if ( a3 )
    {
      ...
      if ( ((unsigned __int64)v22 & 0xFFFFFFFFFFFF0000uLL) == 0 )
      {
        ...
        RtlStringCchPrintfW(&gStrBufSetSystemCursorPath, 0x104uLL, L"ResourceID %i", v23);
      }
    }
    else
    {
