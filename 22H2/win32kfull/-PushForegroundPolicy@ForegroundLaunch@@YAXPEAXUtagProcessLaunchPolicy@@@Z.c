/*
 * XREFs of ?PushForegroundPolicy@ForegroundLaunch@@YAXPEAXUtagProcessLaunchPolicy@@@Z @ 0x1C0012878
 * Callers:
 *     EditionPushProcessLaunchForegroundPolicy @ 0x1C0012860 (EditionPushProcessLaunchForegroundPolicy.c)
 * Callees:
...
__int64 __fastcall ForegroundLaunch::PushForegroundPolicy(__int64 a1, __int64 a2)
{
  ...
  v22 = HIDWORD(a2);
  v2 = a2;
  CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v23, (struct _EX_PUSH_LOCK *)&unk_1C035F3C8);
  if ( v2 == 4 )
  {
    ...
    if ( v5 >= 0xF )
    {
      ...
      if ( v7 < 0xF )
      {
        ...
        *((_QWORD *)&v20 + 1) = __PAIR64__(v10, v2);
        ...
        v21 = TimeQuadPart;
        v13 = 3LL * v7;
        *(_OWORD *)&qword_1C035E1C0[v13] = v20;
        qword_1C035E1C0[v13 + 2] = TimeQuadPart;
        if ( Process )
