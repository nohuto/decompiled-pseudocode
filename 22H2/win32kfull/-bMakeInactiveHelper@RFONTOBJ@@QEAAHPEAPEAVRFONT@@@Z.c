/*
 * XREFs of ?bMakeInactiveHelper@RFONTOBJ@@QEAAHPEAPEAVRFONT@@@Z @ 0x1C009D0D0
 * Callers:
 ...
 *     TraceGreReleaseSemaphore @ 0x1C0165574 (TraceGreReleaseSemaphore.c)
...
__int64 __fastcall RFONTOBJ::bMakeInactiveHelper(RFONTOBJ *this, struct RFONT **a2)
{
  ...
  _QWORD *v37; // r8
  _QWORD *v38; // rax
  __int64 v39; // [rsp+20h] [rbp-68h] BYREF
  _QWORD v40[2]; // [rsp+28h] [rbp-60h] BYREF
  _OWORD v41[2]; // [rsp+38h] [rbp-50h] BYREF
  struct RFONT *v42; // [rsp+A0h] [rbp+18h] BYREF
  struct RFONT *v43; // [rsp+A8h] [rbp+20h] BYREF
    ...
    if ( RFONTOBJ::bActive(this, v7) )
    {
      ...
      if ( !RFONTOBJ::bActive(v9, v8) )
      {
        ...
        if ( *(_DWORD *)(v28 + 56) || *(_DWORD *)(v28 + 60) || *(_QWORD *)(v28 + 144) )
        {
          ...
          {
            v31 = PDEVOBJ::prfntInactive((PDEVOBJ *)&v39);
            for ( j = v31; j; j = (struct RFONT *)*((_QWORD *)j + 84) )
              v6 = j;
            v42 = v6;
            v43 = v31;
            RFONTOBJ::vRemove(&v42, &v43, 1LL);
            PDEVOBJ::prfntInactive((PDEVOBJ *)&v39, v43);
            v42 = 0LL;
      ...
      if ( v6 )
      {
        ...
        PushThreadGuardedObject(v41, v6, RestartInactiveHelper);
        RFONTOBJ::vDeleteRFONT((RFONTOBJ *)&v42, 0LL, (struct PFFOBJ *)v40, 1);
        PopThreadGuardedObject(v41);
        v42 = 0LL;
        RFONTOBJ::~RFONTOBJ((RFONTOBJ *)&v42);
      }
      result = v3;
