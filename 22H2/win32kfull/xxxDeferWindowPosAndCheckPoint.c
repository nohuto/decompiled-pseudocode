/*
 * XREFs of xxxDeferWindowPosAndCheckPoint @ 0x1C003E8DC
 * Callers:
 ...
 * Callees:
 *     ?_ShouldMaximizeWindow@@YAHPEAUtagWND@@@Z @ 0x1C003E2A0 (-_ShouldMaximizeWindow@@YAHPEAUtagWND@@@Z.c)
        ...
        char a7)
{
  ...
  v9 = (char *)a2 + 40;
  v10 = 1;
  if ( (dword_1C032FBFC & 1) != 0 && (*(_BYTE *)(*(_QWORD *)v9 + 233LL) & 3) != 0 )
  {
    v11 = 3;
  ...
  Prop = GetProp(a2, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
