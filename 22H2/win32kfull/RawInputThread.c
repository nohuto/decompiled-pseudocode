  ...
  *(_DWORD *)(gpsi + 2196LL) = 0;
  ...
  if ( !InkProcessor::s_pInstance )
  {
    ...
    if ( !v5 && (unsigned int)dword_1C032A288 > 2 )
    {
      ...
      v60 = &v39;
      v61 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C032A288, (int)&dword_1C02F1ECC, 0, 0, 3u, &v59);
    }
  }
...
LABEL_144:
      ...
      else
      {
        if ( ((v20 - 1) & 0xFFFFFFFD) == 0 )
        {
          ...
          UserSessionSwitchLeaveCrit();
          v21 = dword_1C033C580;
          if ( gnRetryReadInput != dword_1C033C580 )
        ...
        while ( 1 )
        {
          while ( 1 )
          {
            ...
            if ( (unsigned int)dword_1C032FB20 > 4
              && (qword_1C032FB30 & 2) != 0
              && (qword_1C032FB38 & 2) == qword_1C032FB38 )
            {
              switch ( v37[0] )
              {
                case 1u:
      ...
      if ( v22 == 64 )
      {
          ...
          && (qword_1C032A3F0 & 0x200000000000LL) == qword_1C032A3F0 )
        {
          ...
          _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapperByVal<4>>(
            (unsigned int)&dword_1C032A3D8,
            (unsigned int)&unk_1C02F2489,
            v29,
            v30,
            (__int64)&v51,
            (__int64)&v42);
