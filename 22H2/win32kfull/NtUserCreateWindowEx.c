/*
 * XREFs of NtUserCreateWindowEx @ 0x1C0091DF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$SmartObjStackRef@UtagMENU@@@@QEAA@PEAUHMENU__@@@Z @ 0x1C013BF0C (--0-$SmartObjStackRef@UtagMENU@@@@QEAA@PEAUHMENU__@@@Z.c)
...
LABEL_15:
    ...
    if ( !SmartObjStackRef<tagMENU>::operator==((__int64)v69) )
    {
      v65 = v70;
      if ( !v70 )
        v65 = *(_QWORD *)v69[0];
