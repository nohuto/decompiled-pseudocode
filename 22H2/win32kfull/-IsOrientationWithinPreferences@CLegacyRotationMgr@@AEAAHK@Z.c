/*
 * XREFs of ?IsOrientationWithinPreferences@CLegacyRotationMgr@@AEAAHK@Z @ 0x1C01A7000
 * Callers:
  ...
  if ( ActivePpiPreference != 0x80000000 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 )
      {
        if ( v7 != 1 )
          return v3;
        v8 = dword_1C035A5E8 != 0 ? 1 : 8;
      }
      else
      {
        v8 = dword_1C035A5E8 != 0 ? 8 : 4;
      }
    }
    else
    {
      v8 = dword_1C035A5E8 != 0 ? 4 : 2;
    }
