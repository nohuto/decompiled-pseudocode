/*
 * XREFs of _ScheduleDispatchNotification @ 0x1C0053AC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1?$CLockExclusiveInUserCrit@VDLT_QUEUE@@@@QEAA@XZ @ 0x1C01DF9A0 (--1-$CLockExclusiveInUserCrit@VDLT_QUEUE@@@@QEAA@XZ.c)
 */
