/*
 * XREFs of ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C00E17E8
 * Callers:
...
_BOOL8 __fastcall GetFlickMap(struct tagFLICK_MAP *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v20[12] = (char *)a1 + 96;
  v20[14] = (char *)a1 + 112;
  if ( (unsigned int)RIMIsDefaultUILanguageRTL(a1, a2, a3, a4) != dword_1C032A024 )
  {
    v15 = xmmword_1C032A718;
    xmmword_1C032A718 = xmmword_1C032A6B8;
    dword_1C032A024 = dword_1C032A024 == 0;
    xmmword_1C032A6B8 = v15;
  }
...
LABEL_2:
    ...
    *(_OWORD *)a1 = xmmword_1C032A6B8;
    *((_OWORD *)a1 + 1) = xmmword_1C032A6D0;
    *((_OWORD *)a1 + 2) = xmmword_1C032A6E8;
    *((_OWORD *)a1 + 3) = xmmword_1C032A700;
    *((_OWORD *)a1 + 4) = xmmword_1C032A718;
    *((_OWORD *)a1 + 5) = xmmword_1C032A730;
    *((_OWORD *)a1 + 6) = xmmword_1C032A748;
    *((_OWORD *)a1 + 7) = xmmword_1C032A760;
  }
