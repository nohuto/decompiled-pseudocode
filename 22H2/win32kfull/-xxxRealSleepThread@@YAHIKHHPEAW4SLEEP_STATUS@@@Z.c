/*
 * XREFs of ?xxxRealSleepThread@@YAHIKHHPEAW4SLEEP_STATUS@@@Z @ 0x1C0058830
 * Callers:
...
LABEL_8:
    ...
    if ( *(_DWORD *)(v12 + 400) != gcSysExpunge )
    {
      *(_DWORD *)(v12 + 400) = gcSysExpunge;
      if ( (*(_DWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 404LL) & (__int64)WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink) != 0 )
...
LABEL_29:
    ...
    {
      v21 = 1;
      Object[1] = WPP_MAIN_CB.DeviceQueue.DeviceListHead.Flink;
      v20 = 2;
      v40 = 2;
    }
    else
...
LABEL_50:
    if ( v21 )
    {
      ...
      if ( *(_DWORD *)(&WPP_MAIN_CB.DeviceQueue.Size + 1) )
      {
        WakeDIT(2LL);
        if ( !v29 )
          KeClearEvent((PRKEVENT)WPP_MAIN_CB.DeviceQueue.DeviceListHead.Flink);
      }
    }
    if ( (*(_DWORD *)(gptiCurrent + 488LL) & 0x1000) == 0 )
    {
