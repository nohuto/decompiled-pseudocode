/*
 * XREFs of xxxSBWndProc @ 0x1C022AA50
 * Callers:
 ...
 *     _SBGetParms @ 0x1C00A48F0 (_SBGetParms.c)
...
unsigned __int64 __fastcall xxxSBWndProc(struct tagWND *a1, unsigned int a2, _DWORD *a3, struct tagSCROLLINFO *a4)
{
  ...
  v9 = 1;
  if ( !(unsigned int)xxxValidateClassAndSize((__int64)a1, a2, (__int64)a3, (__int64)a4, 666, 1, &v81) )
    return v81;
      ...
      if ( a2 <= 0x14 )
      {
        if ( a2 != 20 )
        {
          if ( a2 != 1 )
          {
            ...
            xxxCreateCaret((__int64)*v12, 1uLL, v21, v22 - 4);
...
LABEL_64:
      ...
      xxxDoScrollMenu((struct tagWND *)(*v12)[13], (struct tagWND *)*v12, *((_DWORD *)v12 + 2), (int)a4);
LABEL_77:
...
LABEL_111:
        ...
        if ( (_DWORD)v16 )
        {
          ...
          v56 = *(_BYTE *)(v55 + 30) & 4;
          if ( (*(_BYTE *)(v55 + 30) & 4) == 0 )
            SetOrClrWF(1, (struct tagWND *)*v12, 0xE04u, 1);
          DrawSize((__int64)*v12, v53, 0, 0);
          if ( !v56 )
            SetOrClrWF(0, (struct tagWND *)*v12, 0xE04u, 1);
        }
        else
        {
          SBCtlSetup((__int64)v12);
  ...
  {
    case 0xEBu:
      LODWORD(result) = xxxGetScrollBarInfo((ULONG_PTR)a1, 0xFFFFFFFC, (__int64)a4);
      return (int)result;
    case 0xE3u:
      *a3 = *((_DWORD *)v12 + 4);
...
LABEL_91:
  ...
  if ( v44 )
  {
    ...
    SBCtlSetup((__int64)v12);
    zzzSetSBCaretPos((struct tagSBWND *)v12);
    if ( (unsigned int)FChildVisible((__int64)*v12) )
    {
      ...
      ColorObjects = (HBRUSH)xxxGetColorObjects((struct tagWND *)*v12, DCEx);
      v52 = GreSelectBrush(DCEx, ColorObjects);
      DrawThumb2((__int64)*v12, (_DWORD *)v12 + 4, DCEx, ColorObjects, *((_DWORD *)v12 + 2), *((_DWORD *)v12 + 3));
