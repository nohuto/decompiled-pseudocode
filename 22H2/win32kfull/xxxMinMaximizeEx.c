/*
 * XREFs of xxxMinMaximizeEx @ 0x1C002B69C
 * Callers:
 ...
 *     NtUserMinMaximize @ 0x1C01FF5A0 (NtUserMinMaximize.c)
 ...
 *     ?CalcMinZOrder@@YAPEAUtagWND@@PEAU1@@Z @ 0x1C002C080 (-CalcMinZOrder@@YAPEAUtagWND@@PEAU1@@Z.c)
...
__int64 __fastcall xxxMinMaximizeEx(struct tagWND *a1, unsigned int a2, int a3, __int64 a4, _OWORD *a5, __int64 a6)
{
  ...
  *(_QWORD *)&v102.left = a4;
  ...
  if ( (a3 & 4) != 0 )
    Prop = (_OWORD *)GetProp(a1, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
  else
