/*
 * XREFs of ?QueuePTPMouseEvent@@YAXPEAXUtagPOINT@@K_K2PEAU_PTPMouseLatencyTracker@@@Z @ 0x1C0212F28
 * Callers:
 *     SendPTPAsMouse @ 0x1C0213840 (SendPTPAsMouse.c)
 * Callees:
 *     ?DropInput@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z @ 0x1C0212EBC (-DropInput@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z.c)
 */
