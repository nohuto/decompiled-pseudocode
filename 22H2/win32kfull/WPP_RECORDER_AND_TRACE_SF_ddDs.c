/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_ddds @ 0x1C01BA440
 * Callers:
        ...
        const char *a12)
{
  ...
  if ( a2 )
  {
    ...
    ((void (__fastcall *)(__int64, __int64, void *, __int64, char *, __int64, char *, __int64, char *, __int64, const char *, __int64, _QWORD))pfnWppTraceMessage)(
      a1,
      43LL,
      &WPP_9ad731d3d3593c130ed182ea31b981ea_Traceguids,
      14LL,
      &a9,
      4LL,
      &a10,
  ...
  if ( a3 )
  {
    ...
    LOWORD(v20) = 14;
    WppAutoLogTrace(v13, 5LL, 15LL, &WPP_9ad731d3d3593c130ed182ea31b981ea_Traceguids, v20, &a9, 4LL, &a10);
  }
}
