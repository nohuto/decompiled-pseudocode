/*
 * XREFs of ??0HmgInsertObjectHelper@@QEAA@XZ @ 0x1C026CE38
 * Callers:
 ...
 * Callees:
 *     ??0?$UnexpectedThreadTerminationHandler@VHmgInsertObjectHelper@@@@QEAA@XZ @ 0x1C0169920 (--0-$UnexpectedThreadTerminationHandler@VHmgInsertObjectHelper@@@@QEAA@XZ.c)
 */
