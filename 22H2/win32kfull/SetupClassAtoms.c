/*
 * XREFs of SetupClassAtoms @ 0x1C012A5C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 SetupClassAtoms()
{
  ...
  *(_WORD *)(gpsi + 1378LL) = UserAddAtomEx(L"SysFrostedWindow", 1LL, 2LL);
  ...
  WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc) = UserAddAtomEx(L"SysCP", 1LL, 2LL);
  if ( WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc) )
    v8 = v7 != 0 ? v6 : 0;
  else
    LOBYTE(v8) = 0;
  ...
  if ( atomDWMProp )
    ...
    v16 = 0;
  WORD2(WPP_MAIN_CB.Queue.Wcb.CurrentIrp) = UserAddAtomEx(L"SysSwapChain", 1LL, 2LL);
  v17 = (WORD2(WPP_MAIN_CB.Queue.Wcb.CurrentIrp) != 0) & v16;
  v18 = UserAddAtomEx(L"SysDCompHwndTargets", 1LL, 2LL);
  CHwndTargetProp::s_atom = v18;
  LOWORD(WPP_MAIN_CB.Queue.Wcb.CurrentIrp) = UserAddAtomEx(L"SysVisRgnTracker", 1LL, 2LL);
  if ( LOWORD(WPP_MAIN_CB.Queue.Wcb.CurrentIrp) )
    v19 = v18 != 0 ? v17 : 0;
  else
    v19 = 0;
  ...
  *(_WORD *)(gpsi + 914LL) = gatomShadow;
  ...
  WPP_MAIN_CB.DeviceQueue.Type = UserAddAtomEx(L"BrokeredForeground", 1LL, 2LL);
