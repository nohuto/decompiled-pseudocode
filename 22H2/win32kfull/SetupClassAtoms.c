/*
 * XREFs of SetupClassAtoms @ 0x1C00B0540
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 SetupClassAtoms()
{
  ...
  *(&WPP_MAIN_CB.DeviceQueue.Size + 1) = UserAddAtomEx(L"SysCP", 1LL, 2LL);
  ...
  LOWORD(WPP_MAIN_CB.Dpc.TargetInfoAsUlong) = UserAddAtomEx(L"SysDWM", 1LL, 2LL);
  v16 = LOWORD(WPP_MAIN_CB.Dpc.TargetInfoAsUlong) != 0 ? v15 : 0;
  ...
  *(_WORD *)(gpsi + 914LL) = gatomShadow;
  ...
  LOWORD(WPP_MAIN_CB.DeviceLock.Header.Lock) = UserAddAtom(L"SysFeedbackSettings", 1LL);
  v32 = LOWORD(WPP_MAIN_CB.DeviceLock.Header.Lock) != 0 ? v31 : 0;
  ...
  LOWORD(WPP_MAIN_CB.DeviceLock.Header.SignalState) = UserAddAtomEx(L"BrokeredForeground", 1LL, 2LL);
  v34 = LOWORD(WPP_MAIN_CB.DeviceLock.Header.SignalState) != 0 ? v33 : 0;
