/*
 * XREFs of ?NeedsMigration@CRecalcState@@AEBA_NPEBUtagWND@@@Z @ 0x1C00C3680
 * Callers:
 ...
 * Callees:
 *     ?Compare@MonitorData@CMonitorTopology@@SA_NAEBU12@0@Z @ 0x1C00C0AFC (-Compare@MonitorData@CMonitorTopology@@SA_NAEBU12@0@Z.c)
 *     WPP_RECORDER_AND_TRACE_SF_qd @ 0x1C00C0F08 (WPP_RECORDER_AND_TRACE_SF_qd.c)
 *     ?MonitorDataFromId@CMonitorTopology@@QEBAPEBUMonitorData@1@AEBUMonitorId@1@@Z @ 0x1C00C3798 (-MonitorDataFromId@CMonitorTopology@@QEBAPEBUMonitorData@1@AEBUMonitorId@1@@Z.c)
 */
...
char __fastcall CRecalcState::NeedsMigration(CRecalcState *this, PETHREAD **a2)
{
  ...
  if ( v2 )
  {
    ...
    v6 = qword_1C035E338;
    v7 = CMonitorTopology::MonitorDataFromId(qword_1C035E338, (const struct CMonitorTopology::MonitorId *)(v2 + 44));
    if ( v7 )
    {
      if ( !*((_DWORD *)this + 7)
        && !*((_DWORD *)this + 8)
