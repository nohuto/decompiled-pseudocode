/*
 * XREFs of ?bWiden@EPATHOBJ@@QEAAHAEAV1@PEAU_XFORMOBJ@@PEAU_LINEATTRS@@@Z @ 0x1C013F1FC
 * Callers:
 ...
 * Callees:
 *     ?vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z @ 0x1C013F2A4 (-vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z.c)
