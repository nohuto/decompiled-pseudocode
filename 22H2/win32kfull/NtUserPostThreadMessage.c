/*
 * XREFs of NtUserPostThreadMessage @ 0x1C0115410
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 424LL) + 888LL, v13[53] + 888LL) )
  {
...
LABEL_4:
  ...
  if ( v15 != v16 )
  {
    if ( a2 == 717 )
      goto LABEL_6;
    if ( !(unsigned int)IsMessageAllowedByFilterEx(*(void *const **)(v15 + 864), a2, 0LL, 0LL)
      && !(unsigned int)IsMessageAlwaysAllowedAcrossIL(a2)
      && (a2 != 274 || ((a3 - 61472) & 0xFFFFFFFFFFFFFEBFuLL) != 0 || a3 == 61792) )
    {
      v20 = *(_QWORD *)v15 == gpepCSRSS ? 0x2000LL : *(_QWORD *)(v15 + 888);
      if ( !(unsigned __int8)CheckAccess(v16 + 888, &v20) )
      {
