/*
 * XREFs of ?GreExtTextOutWLocked@@YAHAEAVXDCOBJ@@HHIPEAUtagRECT@@PEAGHPEAHKPEAXKAEBUTag@RFONTOBJ@@@Z @ 0x1C010BA70
 * Callers:
 ...
 *     ?vMopUp@TXTCLEANUP@@QEAAXXZ @ 0x1C02D7C14 (-vMopUp@TXTCLEANUP@@QEAAXXZ.c)
