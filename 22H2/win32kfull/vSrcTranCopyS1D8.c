/*
 * XREFs of vSrcTranCopyS1D8 @ 0x1C0138280
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        unsigned __int8 a9)
{
  ...
  if ( (a6 & 0xFFFFFFF8) != (a5 & 0xFFFFFFF8) )
  {
    ...
    do
    {
      ...
      {
        v38 = dword_1C02EFBC0[(unsigned __int64)(unsigned __int8)(v17 & *v21) >> 4] | ((unsigned __int64)dword_1C02EFBC0[(unsigned __int8)v17 & *v21 & 0xF] << 32);
        *v15 = v14 & v38 | *v15 & ~v38;
      }
      v24 = v15 + 1;
      v25 = v21 + 1;
      ...
      if ( v27 )
      {
        do
        {
          ...
          if ( (_BYTE)v28 )
          {
            v37 = dword_1C02EFBC0[v28 >> 4] | ((unsigned __int64)dword_1C02EFBC0[v28 & 0xF] << 32);
            *v24 = v14 & v37 | *v24 & ~v37;
          }
          ++v25;
          ++v24;
