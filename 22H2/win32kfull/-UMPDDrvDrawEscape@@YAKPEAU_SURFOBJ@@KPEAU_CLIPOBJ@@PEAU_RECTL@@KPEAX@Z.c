/*
 * XREFs of ?UMPDDrvDrawEscape@@YAKPEAU_SURFOBJ@@KPEAU_CLIPOBJ@@PEAU_RECTL@@KPEAX@Z @ 0x1C02B94B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bNeedThunk@UMPDOBJ@@QEBAHPEAX@Z @ 0x1C0299AC4 (-bNeedThunk@UMPDOBJ@@QEBAHPEAX@Z.c)
