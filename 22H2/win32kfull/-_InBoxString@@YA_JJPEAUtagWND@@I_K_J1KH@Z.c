/*
 * XREFs of ?_InBoxString@@YA_JJPEAUtagWND@@I_K_J1KH@Z @ 0x1C0030A80
 * Callers:
 *     NtUserfnINLBOXSTRING @ 0x1C00309A0 (NtUserfnINLBOXSTRING.c)
 *     NtUserfnINCBOXSTRING @ 0x1C0161540 (NtUserfnINCBOXSTRING.c)
 * Callees:
