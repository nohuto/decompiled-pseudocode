/*
 * XREFs of ?SetPreviewInsertAfter@DWM_ARRANGEMENT_DATA@@QEAAXPEAUHWND__@@PEBUMOVESIZEDATA@@@Z @ 0x1C023B000
 * Callers:
 ...
 *     DwmAsyncSendSnapPreviewInsertAfter @ 0x1C026D728 (DwmAsyncSendSnapPreviewInsertAfter.c)
 */
