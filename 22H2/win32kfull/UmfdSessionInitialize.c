/*
 * XREFs of UmfdSessionInitialize @ 0x1C00A5360
 * Callers:
 *     <none>
 * Callees:
 *     ?Create@?$CSortedVector@_K_K@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00A5454 (-Create@-$CSortedVector@_K_K@NSInstrumentation@@SAPEAV12@XZ.c)
 ...
 *     ?SessionInitialize@UmfdHostLifeTimeManager@@CA_NXZ @ 0x1C00A5E00 (-SessionInitialize@UmfdHostLifeTimeManager@@CA_NXZ.c)
