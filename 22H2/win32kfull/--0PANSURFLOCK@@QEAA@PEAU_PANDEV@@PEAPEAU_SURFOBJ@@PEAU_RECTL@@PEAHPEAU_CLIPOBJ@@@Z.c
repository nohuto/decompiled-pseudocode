/*
 * XREFs of ??0PANSURFLOCK@@QEAA@PEAU_PANDEV@@PEAPEAU_SURFOBJ@@PEAU_RECTL@@PEAHPEAU_CLIPOBJ@@@Z @ 0x1C02943CC
 * Callers:
 ...
 * Callees:
 *     ?vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ @ 0x1C02967C4 (-vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ.c)
