/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C00E14BC
 * Callers:
 *     GreFlush @ 0x1C00E14A0 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C02A79B0 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
