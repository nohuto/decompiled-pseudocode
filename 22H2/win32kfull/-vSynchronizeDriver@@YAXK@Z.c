/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C0082DCC
 * Callers:
 *     GreFlush @ 0x1C0082DB0 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C029E660 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
