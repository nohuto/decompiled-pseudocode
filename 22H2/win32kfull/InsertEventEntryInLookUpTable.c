/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x1C025CB44
 * Callers:
 ...
 * Callees:
 *     CompareEventEntry @ 0x1C025C5AC (CompareEventEntry.c)
 *     ComputeEventEntryHash @ 0x1C025C638 (ComputeEventEntryHash.c)
