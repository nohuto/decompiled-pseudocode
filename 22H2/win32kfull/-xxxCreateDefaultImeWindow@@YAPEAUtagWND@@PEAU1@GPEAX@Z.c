/*
 * XREFs of ?xxxCreateDefaultImeWindow@@YAPEAUtagWND@@PEAU1@GPEAX@Z @ 0x1C006224C
 * Callers:
...
struct tagWND *__fastcall xxxCreateDefaultImeWindow(struct tagWND *a1, __int16 a2, void *a3)
{
  ...
  if ( !v12 )
    return 0LL;
  *(_OWORD *)v12 = xmmword_1C0317008;
  *(_QWORD *)(v12 + 16) = 0x45004D0049LL;
  RtlInitLargeUnicodeString(&v25, v12);
  PushW32ThreadLock((__int64)v10, &v26, UserDereferenceObject);
  if ( v10 )
...
LABEL_15:
  ...
  PopAndFreeW32ThreadLock((__int64)&v26);
