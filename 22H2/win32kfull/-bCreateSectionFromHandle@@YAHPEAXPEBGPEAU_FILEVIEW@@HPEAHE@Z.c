/*
 * XREFs of ?bCreateSectionFromHandle@@YAHPEAXPEBGPEAU_FILEVIEW@@HPEAHE@Z @ 0x1C0078E78
 * Callers:
 ...
 *     ?bIsFileInSystemFontsDir@@YAHPEAX@Z @ 0x1C0079284 (-bIsFileInSystemFontsDir@@YAHPEAX@Z.c)
 *     ?TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z @ 0x1C00793DC (-TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z.c)
