/*
 * XREFs of ?bCreateSectionFromHandle@@YAHPEAXPEBGPEAU_FILEVIEW@@HPEAHE@Z @ 0x1C00A85CC
 * Callers:
 ...
 *     ?TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z @ 0x1C00A8AE4 (-TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z.c)
