/*
 * XREFs of xxxClientGetDDEFlags @ 0x1C021281C
 * Callers:
...
__int64 __fastcall xxxClientGetDDEFlags(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // ebx
  __int64 v5; // rdx
  __int64 v6; // r8
  ...
  v4 = KeUserModeCallback(70LL, &v9, 16LL, &v14, &v12);
