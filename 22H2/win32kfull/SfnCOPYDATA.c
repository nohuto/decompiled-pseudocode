/*
 * XREFs of SfnCOPYDATA @ 0x1C0022620
 * Callers:
...
__int64 __fastcall SfnCOPYDATA(__int64 *a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  {
    v12 = *(_DWORD *)(a4 + 8);
    v13 = (unsigned __int8 *)AllocCallbackMessage(0x70u, 1u, v12, v40, 1, 0x200uLL);
