/*
 * XREFs of ?OnInput@InputTransform@@YAHPEAUtagWND@@_K@Z @ 0x1C010FF40
 * Callers:
 ...
 *     InputTransformOnInput @ 0x1C01F5360 (InputTransformOnInput.c)
...
LABEL_6:
    ...
    if ( InputTraceLogging::Enabled(0)
      ...
      && (qword_1C032FB30 & 4) != 0
      && (qword_1C032FB38 & 4) == qword_1C032FB38 )
    {
      v37 = *((_DWORD *)v6 + 21);
      v39 = *((_DWORD *)v6 + 20);
      v40 = *((_DWORD *)v6 + 19);
