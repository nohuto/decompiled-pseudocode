/*
 * XREFs of ?xxxCloneWindowPosAndArrangement@@YAXPEAUtagWND@@AEBUWINDOWPOSANDCHECKPOINT@@@Z @ 0x1C01CFF5C
 * Callers:
...
void __fastcall xxxCloneWindowPosAndArrangement(struct tagWND *a1, const struct WINDOWPOSANDCHECKPOINT *a2)
{
  ...
  *(_QWORD *)(ThreadWin32Thread + 416) = v37;
  ...
  else
  {
    ...
    {
      Prop = GetProp((__int64)a1, WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc), 1LL);
      if ( Prop )
