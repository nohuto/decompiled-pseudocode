/*
 * XREFs of ?CreateGroup@CWindowGroupManager@@QEAAJPEAUWINDOW_GROUP_ID@@@Z @ 0x1C023FBB8
 * Callers:
 *     NtUserCreateWindowGroup @ 0x1C01F71E0 (NtUserCreateWindowGroup.c)
 * Callees:
 *     _anonymous_namespace_::HashTableAllocator @ 0x1C0240090 (_anonymous_namespace_--HashTableAllocator.c)
 *     _anonymous_namespace_::HashTableDeallocator @ 0x1C02400B4 (_anonymous_namespace_--HashTableDeallocator.c)
 */
