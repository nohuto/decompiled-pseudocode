/*
 * XREFs of xxxSetNCFonts @ 0x1C0078690
 * Callers:
...
__int64 __fastcall xxxSetNCFonts(struct _UNICODE_STRING *a1, __int64 a2)
{
  ...
  _BYTE v41[16]; // [rsp+A8h] [rbp-60h] BYREF
  ...
  *((_DWORD *)v8 + 6) = v40.lfOrientation;
  ...
  if ( !(unsigned int)GreExtGetObjectW((HBRUSH)*SessionDpiMetrics, 92LL, (__int64)v41) )
    return 0LL;
  v25 = v42;
  if ( v42 <= 700 )
    v25 = 700;
  v42 = v25;
  SessionDpiMetrics[6] = (struct HLFONT__ *)GreCreateFontIndirectW(v41, 136LL);
  ...
  if ( !(unsigned int)GreExtGetObjectW((HBRUSH)*v8, 92LL, (__int64)v41) )
    return 0LL;
  v27 = v42;
  if ( v42 <= 700 )
    v27 = 700;
  v42 = v27;
  v8[6] = GreCreateFontIndirectW(v41, 136LL);
  v28 = a2 + 316;
  if ( !a2 )
    v28 = v38;
