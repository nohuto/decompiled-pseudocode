/*
 * XREFs of ?SmartRectInRegion@@YAIPEAUHRGN__@@PEAUtagRECT@@@Z @ 0x1C007137C
 * Callers:
...
__int64 __fastcall SmartRectInRegion(HRGN a1, struct tagRECT *a2)
{
  ...
  if ( RgnBox != 2 )
  {
    ...
    if ( (unsigned int)GreGetRgnBox(ghrgnInv2, &v10) )
    {
      ...
      if ( *(_QWORD *)&a2->left == (_QWORD)v10 )
        v9 = *(_QWORD *)&a2->right - *((_QWORD *)&v10 + 1);
      v6 = v9 == 0;
      goto LABEL_8;
    }
    return 3LL;
  ...
  if ( *(_QWORD *)&a2->left == (_QWORD)v10 )
    v5 = *(_QWORD *)&a2->right - *((_QWORD *)&v10 + 1);
  v6 = v5 == 0;
LABEL_8:
  if ( !v6 )
    return 1LL;
