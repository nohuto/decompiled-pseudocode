/*
 * XREFs of ??0?$UnexpectedThreadTerminationHandler@VDWMSPRITEREF@@@@QEAA@XZ @ 0x1C0169E84
 * Callers:
 ...
 *     ??0SFMLOGICALSURFACEREF@@QEAA@XZ @ 0x1C026D180 (--0SFMLOGICALSURFACEREF@@QEAA@XZ.c)
