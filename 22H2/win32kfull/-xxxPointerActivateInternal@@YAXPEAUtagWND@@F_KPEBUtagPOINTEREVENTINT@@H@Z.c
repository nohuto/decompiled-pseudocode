/*
 * XREFs of ?xxxPointerActivateInternal@@YAXPEAUtagWND@@F_KPEBUtagPOINTEREVENTINT@@H@Z @ 0x1C01F1438
 * Callers:
 *     EditionPointerActivate @ 0x1C01F1C40 (EditionPointerActivate.c)
 * Callees:
