/*
 * XREFs of ?xxxPointerActivateInternal@@YAXPEAUtagWND@@F_KPEBUtagPOINTEREVENTINT@@H@Z @ 0x1C01C645C
 * Callers:
 *     EditionPointerActivate @ 0x1C0153670 (EditionPointerActivate.c)
 * Callees:
 ...
 *     IsModalMenuStarted @ 0x1C01C6AB8 (IsModalMenuStarted.c)
