/*
 * XREFs of ?GreSetDeviceGammaRampInternal@@YAHPEAUHDEV__@@PEAXHHPEAW4_SETGAMMARAMP_FAILED_REASON@@PEAK@Z @ 0x1C0028978
 * Callers:
 ...
 *     ?ComposeDeviceGammaRampsUnsafe@PDEVOBJ@@QEAAXXZ @ 0x1C02B5630 (-ComposeDeviceGammaRampsUnsafe@PDEVOBJ@@QEAAXXZ.c)
 */
...
LABEL_26:
  if ( v13 )
  {
    v25 = (void *)*((_QWORD *)a1 + 211);
    *((_QWORD *)a1 + 211) = 0LL;
    Win32FreePool(v25);
    v26 = (void *)*((_QWORD *)a1 + 213);
    if ( v26 )
    {
      *((_QWORD *)a1 + 213) = 0LL;
      Win32FreePool(v26);
