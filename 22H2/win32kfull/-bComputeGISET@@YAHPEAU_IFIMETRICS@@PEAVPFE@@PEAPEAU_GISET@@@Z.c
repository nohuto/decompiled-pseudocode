/*
 * XREFs of ?bComputeGISET@@YAHPEAU_IFIMETRICS@@PEAVPFE@@PEAPEAU_GISET@@@Z @ 0x1C00A2D34
 * Callers:
 ...
 *     ?cComputeGISET@@YAKPEBGKPEAU_GISET@@K@Z @ 0x1C00A3CE8 (-cComputeGISET@@YAKPEBGKPEAU_GISET@@K@Z.c)
...
__int64 __fastcall bComputeGISET(struct _IFIMETRICS *a1, struct PFE *a2, struct _GISET **a3)
{
  ...
  *a3 = 0LL;
  ...
  v6 = 1;
  v7 = 0LL;
  if ( *(struct PDEV **)(v29 + 88) != qword_1C0340AC0 || *(_DWORD *)(*(_QWORD *)(v29 + 80) + 8LL) )
  {
    v8 = 0;
    v7 = PFEOBJ::pfdg(&v32);
    if ( !v7 )
