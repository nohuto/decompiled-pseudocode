/*
 * XREFs of SetWindowCompositionExcludeFromLivePreview @ 0x1C0128B90
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludeFromLivePreview(__int64 *a1, __int128 *a2)
{
  bool v3; // zf
  int v5; // edi
  unsigned int v6; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 5) == v5 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFFEF | (16 * v5);
