/*
 * XREFs of ?draw_gray_f_ntb_o_to_temp_start@@YAXPEAU_GLYPHPOS@@KPEAEKKKK@Z @ 0x1C0270D50
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a7)
{
  ...
  if ( a1 < v11 )
  {
    ...
    {
      pgb = v10->pgdf->pgb;
      (*(&off_1C030A9E8[2 * (((_BYTE)v8 + LOBYTE(pgb->ptlOrigin.x)) & 1u)] + (pgb->sizlBitmap.cx & 1)))(
        pgb,
