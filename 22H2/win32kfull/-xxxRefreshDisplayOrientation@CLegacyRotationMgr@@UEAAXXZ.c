/*
 * XREFs of ?xxxRefreshDisplayOrientation@CLegacyRotationMgr@@UEAAXXZ @ 0x1C002EAC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CLegacyRotationMgr::xxxRefreshDisplayOrientation(CLegacyRotationMgr *this, __int64 a2, int a3, int a4)
{
    ...
    && (qword_1C032A3F0 & 0x200000000001LL) == qword_1C032A3F0 )
  {
    ...
    v13 = 4;
    v12 = &v10;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C032A3D8, (int)&dword_1C02F0082, 0, 0, 3u, &v11);
    v5 = qword_1C032A3F0;
  }
  v6 = *(_DWORD *)(gpsi + 2236LL) & 8;
  if ( (unsigned int)dword_1C032A3D8 > 5 && (qword_1C032A3E8 & 0x200000000001LL) != 0 && (v5 & 0x200000000001LL) == v5 )
  {
    v9 = dword_1C0335614;
    v8 = v6 != 0;
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
      gpsi,
      (unsigned int)&unk_1C02F00C9,
      a3,
      a4,
      (__int64)&v9,
      (__int64)&v8);
  ...
  if ( (unsigned int)dword_1C032A3D8 > 5 && (qword_1C032A3E8 & 0x200000000001LL) != 0 && (v5 & 0x200000000001LL) == v5 )
  {
    ...
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
      gpsi,
      (unsigned int)&unk_1C02F0122,
      a3,
      a4,
      (__int64)&v8,
      (__int64)&v9);
  }
  if ( dword_1C0335610 && !v7 && !dword_1C0335614 )
    CLegacyRotationMgr::xxxRestoreSlateAutorotationPreferences(this);
  dword_1C0335610 = v7 != 0;
  if ( dword_1C0335614 || v7 )
