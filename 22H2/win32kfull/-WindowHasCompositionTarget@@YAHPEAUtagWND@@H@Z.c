/*
 * XREFs of ?WindowHasCompositionTarget@@YAHPEAUtagWND@@H@Z @ 0x1C00ECD24
 * Callers:
 *     ?TestWindowForCompositionTarget@@YAJPEAUHWND__@@H@Z @ 0x1C00ECC0C (-TestWindowForCompositionTarget@@YAJPEAUHWND__@@H@Z.c)
 * Callees:
