/*
 * XREFs of ?xxxDWPPrint@@YAHPEAUtagWND@@PEAUHDC__@@_J@Z @ 0x1C0222580
 * Callers:
...
__int64 __fastcall xxxDWPPrint(struct tagWND *a1, Gre::Base *a2, char a3)
{
  ...
  {
    v3 = v3 & 0xF4 | 0xA;
    v15 = BuildHwndList(*((ShellWindowManagement **)v5 + 14), (const struct tagWND *)2, 0LL, 1LL);
    v16 = v15;
    if ( v15 )
    {
  ...
  v25 = BuildHwndList(*(ShellWindowManagement **)(DesktopWindow + 112), (const struct tagWND *)2, 0LL, 1LL);
  v26 = v25;
  if ( !v25 )
    return 1LL;
