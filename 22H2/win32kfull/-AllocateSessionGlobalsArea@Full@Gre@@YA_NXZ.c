/*
 * XREFs of ?AllocateSessionGlobalsArea@Full@Gre@@YA_NXZ @ 0x1C00B3148
 * Callers:
 *     AllocateEditionSessionGlobalsArea @ 0x1C00B3130 (AllocateEditionSessionGlobalsArea.c)
 * Callees:
