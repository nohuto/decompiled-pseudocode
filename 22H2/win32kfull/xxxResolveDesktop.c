/*
 * XREFs of xxxResolveDesktop @ 0x1C0067670
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( ProcessLuid >= 0 )
          {
            ...
            *((_QWORD *)BaseAddress + 5) = 0LL;
            ...
            if ( (_DWORD)v34 )
              ...
              Desktop = OpenDesktop((struct _OBJECT_ATTRIBUTES *)BaseAddress, v34, 0LL, 0x2000000, &SourceHandle);
            ProcessLuid = Desktop;
          }
          goto LABEL_56;
        }
