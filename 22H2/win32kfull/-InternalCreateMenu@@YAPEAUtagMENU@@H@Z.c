/*
 * XREFs of ?InternalCreateMenu@@YAPEAUtagMENU@@H@Z @ 0x1C00A1618
 * Callers:
 ...
 *     NtUserCreateMenu @ 0x1C00ACAE0 (NtUserCreateMenu.c)
 *     NtUserCreatePopupMenu @ 0x1C00B5610 (NtUserCreatePopupMenu.c)
 * Callees:
 *     CheckGrantedAccess @ 0x1C00A1770 (CheckGrantedAccess.c)
 *     ??$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z @ 0x1C00A179C (--$InitLookAsideRef@UtagMENU@@@@YAEPEAUtagMENU@@@Z.c)
 */
