/*
 * XREFs of ?TraceLoggingSPISetMenuDropAlignmentEvent@@YAXHH@Z @ 0x1C003F008
 * Callers:
...
void __fastcall TraceLoggingSPISetMenuDropAlignmentEvent()
{
  ...
  if ( (unsigned int)dword_1C0354098 > 5 )
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C0354098, 0x200000000000LL) )
    {
      ...
      v9 = 1LL;
      v7 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0354098, (int)&dword_1C031CAE0, 0, 0, 5u, &v5);
    }
  }
}
