/*
 * XREFs of ?TraceLoggingSPISetMenuDropAlignmentEvent@@YAXHH@Z @ 0x1C00DB414
 * Callers:
...
void __fastcall TraceLoggingSPISetMenuDropAlignmentEvent(char a1, char a2)
{
    ...
    && (qword_1C032A3F0 & 0x200000000000LL) == qword_1C032A3F0 )
  {
    ...
    v9 = 1LL;
    v7 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C032A3D8, (int)&dword_1C02F26CF, 0, 0, 5u, &v5);
  }
}
