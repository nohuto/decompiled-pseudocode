/*
 * XREFs of NtGdiFastPolyPolyline @ 0x1C01429F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiFastPolyPolyline(HDC a1, struct _VECTORL *a2, unsigned int *a3, unsigned int a4)
{
  ...
  int v59; // [rsp+13Ch] [rbp-33Ch]
  __int64 v60; // [rsp+140h] [rbp-338h]
  __int64 v61; // [rsp+148h] [rbp-330h]
  __m128i v62; // [rsp+150h] [rbp-328h] BYREF
  _BYTE v63[112]; // [rsp+160h] [rbp-318h] BYREF
  char v64; // [rsp+1D0h] [rbp-2A8h] BYREF
  struct _PATHRECORD *v65; // [rsp+1F0h] [rbp-288h]
  struct _PATHRECORD *v66; // [rsp+1F8h] [rbp-280h] BYREF
  __int64 plResult; // [rsp+200h] [rbp-278h] BYREF
  int v68; // [rsp+208h] [rbp-270h]
  int v69; // [rsp+20Ch] [rbp-26Ch]
  __int64 v70; // [rsp+218h] [rbp-260h]
  int v71; // [rsp+220h] [rbp-258h]
  __int64 v72; // [rsp+310h] [rbp-168h] BYREF
  int v73; // [rsp+318h] [rbp-160h]
  int v74; // [rsp+31Ch] [rbp-15Ch]
  _BYTE v75[112]; // [rsp+320h] [rbp-158h] BYREF
  _BYTE v76[4]; // [rsp+390h] [rbp-E8h] BYREF
  __m128i v77[9]; // [rsp+394h] [rbp-E4h] BYREF
...
LABEL_63:
  ...
  {
    v17 = (struct _PATHRECORD *)v75;
  }
  DEVLOCKOBJ::DEVLOCKOBJ((DEVLOCKOBJ *)v63, (struct XDCOBJ *)v47, 0);
  if ( (v63[24] & 1) == 0 )
  {
  ...
  else
  {
    ...
    {
      v43 = 0;
      v41 = EXFORMOBJ::bXform((EXFORMOBJ *)v52, a2, v23, v7);
  ...
  v53[0] = v43 != 0 ? 4 : 0;
  v25 = bMakePathRecords(v17, v24, v7, (struct _POINTL *)v23, v4, v21, v22, (LONG *)&plResult, &v66) & v20;
  if ( v43 )
  {
    v72 = plResult;
    v26 = v68;
  ...
  if ( v25 )
  {
    ...
    {
      XDCOBJ::vAccumulate((XDCOBJ *)v47, v47[0], (struct ERECTL *)&v72);
      v28 = v47[0];
    }
    ...
    ECLIPOBJ::ECLIPOBJ((ECLIPOBJ *)v76, v36, (struct ERECTL *)&v72, v42);
    if ( ERECTL::bEmpty((ERECTL *)v77) )
    {
LABEL_69:
      v8 = 1;
      goto LABEL_60;
    ...
    {
      v62 = v77[0];
      XDCOBJ::vAccumulateTight((XDCOBJ *)v47, v37, &v62);
    }
    v38 = *(_QWORD *)(v29 + 48);
    ++*(_DWORD *)(v29 + 92);
