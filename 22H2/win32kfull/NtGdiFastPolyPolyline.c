...
__int64 __fastcall NtGdiFastPolyPolyline(HDC a1, struct _VECTORL *a2, unsigned int *a3, unsigned int a4)
{
  ...
  int v59; // [rsp+138h] [rbp-330h]
  int v60; // [rsp+13Ch] [rbp-32Ch]
  __int64 v61; // [rsp+140h] [rbp-328h]
  __int64 v62; // [rsp+148h] [rbp-320h]
  _BYTE v63[112]; // [rsp+150h] [rbp-318h] BYREF
  char v64; // [rsp+1C0h] [rbp-2A8h] BYREF
  struct _PATHRECORD *v65; // [rsp+1E0h] [rbp-288h]
  struct _PATHRECORD *v66; // [rsp+1E8h] [rbp-280h] BYREF
  __int64 plResult; // [rsp+1F0h] [rbp-278h] BYREF
  unsigned int v68; // [rsp+1F8h] [rbp-270h]
  unsigned int v69; // [rsp+1FCh] [rbp-26Ch]
  __int64 v70; // [rsp+208h] [rbp-260h]
  int v71; // [rsp+210h] [rbp-258h]
  __int64 v72; // [rsp+300h] [rbp-168h] BYREF
  int v73; // [rsp+308h] [rbp-160h]
  int v74; // [rsp+30Ch] [rbp-15Ch]
  _BYTE v75[112]; // [rsp+310h] [rbp-158h] BYREF
  _BYTE v76[4]; // [rsp+380h] [rbp-E8h] BYREF
  _OWORD v77[9]; // [rsp+384h] [rbp-E4h] BYREF
...
LABEL_61:
  ...
  {
    v18 = (struct _PATHRECORD *)v75;
  }
  DEVLOCKOBJ::DEVLOCKOBJ((DEVLOCKOBJ *)v63, (struct XDCOBJ *)v48, 0);
  if ( (v63[24] & 1) == 0 )
  {
  ...
  else
  {
    ...
    {
      v44 = 0;
      v42 = EXFORMOBJ::bXform((EXFORMOBJ *)v53, a2, v24, v7);
  ...
  v54[0] = v44 != 0 ? 4 : 0;
  v26 = bMakePathRecords(v18, v25, v7, (struct _POINTL *)v24, v4, v22, v23, (LONG *)&plResult, &v66) & v21;
  if ( v44 )
  {
    v72 = plResult;
    v27 = v68;
  ...
  {
    LODWORD(v72) = (int)plResult >> 4;
    HIDWORD(v72) = SHIDWORD(plResult) >> 4;
    v27 = (unsigned int)((int)(v68 + 15) >> 4);
    v73 = (int)(v68 + 15) >> 4;
    v28 = (unsigned int)((int)(v69 + 15) >> 4);
    v74 = (int)(v69 + 15) >> 4;
    v43 = ((v27 ^ v68 | v28 ^ v69) & 0x80000000) != 0LL;
  }
  ...
  if ( v26 )
  {
    ...
    if ( ((unsigned __int8)v29 & 0xE0) != 0 )
      XDCOBJ::vAccumulate((XDCOBJ *)v48, (struct ECLIPOBJ *)v27, (struct ERECTL *)&v72);
    ...
    ECLIPOBJ::ECLIPOBJ((ECLIPOBJ *)v76, v39, (struct ERECTL *)&v72, v43);
