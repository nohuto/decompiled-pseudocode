/*
 * XREFs of ?xxxProcessPointerInputAsMouse@PointerPromotion@@YAXAEBUtagPOINTER_INFO@@GG@Z @ 0x1C0219068
 * Callers:
 *     EditionProcessPointerInputAsMouse @ 0x1C0219630 (EditionProcessPointerInputAsMouse.c)
 * Callees:
 *     ?CancelAutoPromotion@@YAXXZ @ 0x1C0217FEC (-CancelAutoPromotion@@YAXXZ.c)
 *     ?CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z @ 0x1C02180C8 (-CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z.c)
 *     ?CreateMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagPOINTER_INFO@@GG@Z @ 0x1C02181B8 (-CreateMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagPOINTER_INFO@@GG@Z.c)
 ...
 *     ?WantDirectPromotion@@YAHAEBUtagPOINTER_INFO@@PEAK@Z @ 0x1C0218DC0 (-WantDirectPromotion@@YAHAEBUtagPOINTER_INFO@@PEAK@Z.c)
        ...
        __int16 a3)
{
  ...
  *(__m128i *)v22 = v3;
  ...
  if ( v12 )
  {
    v13 = dword_1C0339BD8 & 0xFFFFFFF7;
    dword_1C0339BD8 &= ~8u;
  }
  v14 = v22[2];
  if ( v22[2] != word_1C0339AD0[0] || (a3 & 0x10) != 0 )
  {
    if ( (v13 & 2) != 0 )
    {
      CancelAutoPromotion();
    ...
    dword_1C0339BD8 = v13 & 0xFFFFFFF7;
  ...
  qword_1C0339BC8 = v23.m128i_i64[1];
  dword_1C0339AD4 = v10;
  if ( MousePromotionEntry )
  {
    v16 = dword_1C0339BD8;
    if ( (dword_1C0339BD8 & 2) != 0 )
    {
      if ( (dword_1C0339BD8 & 4) != 0 )
      {
      ...
      QueueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0339B50, MousePromotionEntry);
      if ( (*((_DWORD *)MousePromotionEntry + 5) & 0x40000) != 0 )
        dword_1C0339BD8 &= 0xFFFFFFE9;
      goto LABEL_31;
    }
    QueueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&unk_1C0339AE0, MousePromotionEntry);
  }
  if ( v15 || MousePromotionEntry )
  {
    v28 = 0;
    if ( (dword_1C0339BD8 & 8) != 0 )
    {
      v17 = DetectPromotionType(0LL, qword_1C0339AE8);
      if ( v17 == 0x10000000 )
        goto LABEL_31;
      v19 = v17;
      v20 = v10;
