/*
 * XREFs of xxxDDETrackGetMessageHook @ 0x1C01FB134
 * Callers:
 ...
 *     ?xxxCopyDDEOut@@YAPEAXPEAUtagINTDDEINFO@@PEAPEAX@Z @ 0x1C01FA454 (-xxxCopyDDEOut@@YAPEAXPEAUtagINTDDEINFO@@PEAPEAX@Z.c)
