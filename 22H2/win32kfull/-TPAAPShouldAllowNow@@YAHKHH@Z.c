/*
 * XREFs of ?TPAAPShouldAllowNow@@YAHKHH@Z @ 0x1C0213040
 * Callers:
 *     EditionLegacyTouchPadMouseAllowTap @ 0x1C0213590 (EditionLegacyTouchPadMouseAllowTap.c)
 * Callees:
 *     ?TPAAPSqmBlockedCount@@YAXH@Z @ 0x1C021317C (-TPAAPSqmBlockedCount@@YAXH@Z.c)
 */
