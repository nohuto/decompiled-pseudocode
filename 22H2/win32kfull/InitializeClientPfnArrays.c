/*
 * XREFs of InitializeClientPfnArrays @ 0x1C0131104
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C0131010 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( dword_1C0339ED8 || !a1 )
    return 0LL;
  if ( PsGetCurrentProcess(a1, a2, a3) == gpepCSRSS )
  {
    v8 = *a1;
    WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink = (struct _LIST_ENTRY *)4;
    ...
    *(_QWORD *)(gpsi + 856LL) = *(_QWORD *)(a3 + 80);
    WPP_MAIN_CB.Dpc.DpcData = *(PVOID *)(gpsi + 640LL);
    *(_QWORD *)&WPP_MAIN_CB.ActiveThreadCount = *(_QWORD *)(gpsi + 616LL);
    WPP_MAIN_CB.SecurityDescriptor = *(PSECURITY_DESCRIPTOR *)(gpsi + 696LL);
    *(_QWORD *)&WPP_MAIN_CB.DeviceLock.Header.Lock = *(_QWORD *)(gpsi + 680LL);
    WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink = *(struct _LIST_ENTRY **)(gpsi + 648LL);
    qword_1C0338F10 = *(_QWORD *)(gpsi + 664LL);
    qword_1C0338F28 = *(_QWORD *)(gpsi + 592LL);
    *(_QWORD *)&WPP_MAIN_CB.SectorSize = *(_QWORD *)(gpsi + 688LL);
    WPP_MAIN_CB.DeviceObjectExtension = *(struct _DEVOBJ_EXTENSION **)(gpsi + 656LL);
    qword_1C0338F08 = 1LL;
    qword_1C0338F18 = 3LL;
    qword_1C0338F20 = 2LL;
    qword_1C0338F30 = 5LL;
