/*
 * XREFs of ??1CPhysicalMonitorHandle@@UEAA@XZ @ 0x1C0268AE8
 * Callers:
 *     ??_GCPhysicalMonitorHandle@@UEAAPEAXI@Z @ 0x1C0268B40 (--_GCPhysicalMonitorHandle@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?Destroy@CPhysicalMonitorHandle@@UEAAJXZ @ 0x1C0269C90 (-Destroy@CPhysicalMonitorHandle@@UEAAJXZ.c)
 */
