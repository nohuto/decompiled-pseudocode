/*
 * XREFs of ?vExpandAndCopyText@@YAXPEAVSURFACE@@PEAU_FONTOBJ@@PEAU_GLYPHPOS@@KPEAEKK00PEAU_RECTL@@4HHK44KPEAU_BRUSHOBJ@@PEAU_POINTL@@@Z @ 0x1C0055DA0
 * Callers:
        ...
        struct _POINTL *a19)
{
  ...
  Gre::Base *v63; // [rsp+D8h] [rbp-440h] BYREF
...
LABEL_48:
  ...
  {
    off_1C030A080[a14 & 0xFFFFFF4F](v65, a4, a5, v29, a6, a7, top);
  }
  v30 = a10;
  if ( a16 )
  {
...
LABEL_16:
    ...
    else
    {
      ...
      v33 = (void (__fastcall *)(const unsigned __int8 *, int, int, unsigned __int8 *, int, int, int, int))*(&off_1C0309F00 + v31);
    }
    for ( j = &v64->left; ; j += 4 )
    {
      v35 = j[3];
...
LABEL_39:
  ...
  if ( v63 )
  {
    ...
    {
      _InterlockedDecrement((volatile signed __int32 *)Gre::Base::Globals(v44) + 8 * *((int *)v63 + 9) + 1658);
    }
  }
}
