/*
 * XREFs of zzzSetWindowsHookEx @ 0x1C001FC48
 * Callers:
 *     NtUserSetWindowsHookEx @ 0x1C001FB00 (NtUserSetWindowsHookEx.c)
 *     NtUserSetWindowsHookAW @ 0x1C0203130 (NtUserSetWindowsHookAW.c)
 * Callees:
...
__int64 __fastcall zzzSetWindowsHookEx(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5, char a6)
{
  ...
  _DWORD v29[2]; // [rsp+38h] [rbp-80h] BYREF
...
LABEL_40:
  ...
  if ( !a3 )
  {
    if ( !a1 && (*((_BYTE *)&unk_1C02EA908 + a4 + 1) & 0x24) == 0 )
      goto LABEL_46;
    goto LABEL_10;
  }
  v9 = *((_BYTE *)&unk_1C02EA908 + a4 + 1);
  if ( (v9 & 2) == 0 )
  {
    v23 = 1429LL;
    goto LABEL_40;
...
LABEL_50:
    ...
    if ( (*(_DWORD *)(v7 + 488) & 0xC) != 0 && (*((_BYTE *)&unk_1C02EA908 + v6 + 1) & 0x10) == 0 )
    {
      v23 = 1458LL;
      goto LABEL_40;
    }
...
LABEL_10:
  v34 = v6;
  if ( (*((_BYTE *)&unk_1C02EA908 + v6 + 1) & 4) != 0
    && !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 424LL) + 880LL, v29)
  ...
  *v19 = v16;
  if ( (*((_BYTE *)&unk_1C02EA908 + v6 + 1) & 4) != 0 )
  {
    ...
    *((_QWORD *)&v30 + 1) = v16;
    ...
    v16 = ThreadUnlock1(v26);
    if ( !v16 )
      return 0LL;
  }
  if ( (*(_DWORD *)(v16 + 64) & 1) != 0 && (*((_BYTE *)&unk_1C02EA908 + v6 + 1) & 0x10) != 0 )
  {
