/*
 * XREFs of ?xxxFrostCrashedWindow@@YAPEAUHWND__@@PEAUtagWND@@PEAU1@@Z @ 0x1C01F4680
 * Callers:
 ...
 *     ?xxxSendSyncGHOSTINFO@@YAHPEAU_GHOSTINFO@@@Z @ 0x1C01F5650 (-xxxSendSyncGHOSTINFO@@YAHPEAU_GHOSTINFO@@@Z.c)
 */
  ...
  if ( (unsigned int)_ShouldFrostCrashedWindow(a1) )
  {
    ...
    if ( v12 )
    {
      if ( v13 )
      {
        ...
        {
          if ( GetProp(v14, *(unsigned __int16 *)(gpsi + 1378LL), 1LL, v14) )
          {
            v15 = v24;
            if ( v24 )
            {
              ...
              if ( v16 )
              {
                if ( !(unsigned int)IsWindowBeingDestroyed(v16)
                  && GetProp(v17, *(unsigned __int16 *)(gpsi + 1378LL), 1LL, v17) )
                {
                  return v15;
                }
              }
