/*
 * XREFs of xxxGetDeviceChangeInfo @ 0x1C01DE120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxGetDeviceChangeInfo(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v4 = qword_1C033A250;
    v5 = *(_QWORD **)(qword_1C033A250 + 8);
    if ( *(struct _LIST_ENTRY **)qword_1C033A250 != &gMediaChangeList || *v5 != qword_1C033A250 )
      __fastfail(3u);
    qword_1C033A250 = *(_QWORD *)(qword_1C033A250 + 8);
    *v5 = &gMediaChangeList;
  }
