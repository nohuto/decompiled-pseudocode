/*
 * XREFs of xxxGetDeviceChangeInfo @ 0x1C01B2A4C
 * Callers:
 *     NtUserGetDeviceChangeInfo @ 0x1C01D1090 (NtUserGetDeviceChangeInfo.c)
 * Callees:
...
__int64 __fastcall xxxGetDeviceChangeInfo(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v4 = qword_1C035E528;
    v5 = *(_QWORD **)(qword_1C035E528 + 8);
    if ( *(struct _LIST_ENTRY **)qword_1C035E528 != &gMediaChangeList || *v5 != qword_1C035E528 )
      __fastfail(3u);
    qword_1C035E528 = *(_QWORD *)(qword_1C035E528 + 8);
    *v5 = &gMediaChangeList;
  }
