/*
 * XREFs of ?ProcessInkFeedbackCommand@InkProcessor@@QEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C024F3AC
 * Callers:
...
__int64 __fastcall InkProcessor::ProcessInkFeedbackCommand(__int64 a1)
{
  ...
  else if ( (unsigned int)dword_1C032A288 > 2 )
  {
    ...
    v13 = 4;
    v12 = &v9;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032A288, (unsigned __int8 *)dword_1C02F1ECC, 0LL, 0LL, 3u, &v11);
  }
  return v3;
}
