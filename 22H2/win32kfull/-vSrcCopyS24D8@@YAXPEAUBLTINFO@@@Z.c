/*
 * XREFs of ?vSrcCopyS24D8@@YAXPEAUBLTINFO@@@Z @ 0x1C02EB170
 * Callers:
 *     <none>
 * Callees:
 *     ?XLATEOBJ_RGB32ToPalSurf@@YAEPEAU_XLATEOBJ@@PEBEK@Z @ 0x1C02DC380 (-XLATEOBJ_RGB32ToPalSurf@@YAEPEAU_XLATEOBJ@@PEBEK@Z.c)
