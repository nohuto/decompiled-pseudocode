/*
 * XREFs of xxxRemotePassthruEnable @ 0x1C0226C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 xxxRemotePassthruEnable()
{
  ...
  if ( PsGetCurrentProcess(v1, v0, v3) != gpepCSRSS )
    return 3221225506LL;
  dword_1C0340AF4 = gapulCvt_VK != gapulCvt_VK_84;
  ZwDeviceIoControlFile(ghRemoteKeyboardChannel, 0LL, 0LL, 0LL, &IoStatusBlock, 0x38080Fu, &dword_1C0340AF4, 4u, 0LL, 0);
  v6 = guKbdTblSize;
  if ( guKbdTblSize )
