/*
 * XREFs of _DrawIconEx @ 0x1C0028030
 * Callers:
      ...
      if ( a8 )
      {
        ...
        if ( v28 )
        {
          ...
          if ( CompatibleBitmapInternal )
          {
            ...
            BltIcon(v28, 0, 0, DpiDependentMetric, v19, CompatibleDC, (__int64)AnimatedCursorFrame, v30, v31);
            NtGdiBitBltInternal(a1, a2, a3, DpiDependentMetric, v19, (__int64)v28, 0, 0, 13369376, -1, 0);
      ...
      else
      {
        ...
        else
        {
          ...
          if ( v22 )
          {
            ...
            BltIcon(a1, a2, a3, DpiDependentMetric, v19, CompatibleDC, (__int64)AnimatedCursorFrame, 1, v24);
            v21 = CompatibleDC;
            v22 = a9;
          }
          if ( v23 )
          {
            ...
            BltIcon(a1, a2, a3, DpiDependentMetric, v19, v21, (__int64)AnimatedCursorFrame, 2, v32);
          }
        }
        v10 = 1;
      }
