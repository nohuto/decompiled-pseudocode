/*
 * XREFs of ?IsWindowHolographicForHitTest@@YAHQEAUtagWND@@@Z @ 0x1C0122140
 * Callers:
...
_BOOL8 __fastcall IsWindowHolographicForHitTest(struct tagWND *const a1)
{
  ...
  __int64 v9; // r9
  __int64 v10; // rsi
  __int64 TargetInfoAsUlong_low; // r14
  __int64 v12; // rdx
  __int64 v13; // rcx
  __int64 v14; // r8
  __int64 v15; // r9
  ...
  Prop = (_DWORD *)RealGetProp(*((_QWORD *)v1 + 18), TargetInfoAsUlong_low, 1LL);
  if ( v23 && v22 )
  {
    v7 = v21;
    if ( (_QWORD)v21 )
