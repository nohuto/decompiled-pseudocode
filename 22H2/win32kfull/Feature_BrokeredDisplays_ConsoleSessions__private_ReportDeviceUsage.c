/*
 * XREFs of Feature_BrokeredDisplays_ConsoleSessions__private_ReportDeviceUsage @ 0x1C01689EC
 * Callers:
...
void Feature_BrokeredDisplays_ConsoleSessions__private_ReportDeviceUsage()
{
  __int64 v0; // [rsp+30h] [rbp+8h]

  v0 = (unsigned int)Feature_BrokeredDisplays_ConsoleSessions__private_featureState;
  if ( (Feature_BrokeredDisplays_ConsoleSessions__private_featureState & 0x10) == 0 )
  {
    LODWORD(v0) = Feature_BrokeredDisplays_ConsoleSessions__private_featureState & 0xFFFFFFFE;
