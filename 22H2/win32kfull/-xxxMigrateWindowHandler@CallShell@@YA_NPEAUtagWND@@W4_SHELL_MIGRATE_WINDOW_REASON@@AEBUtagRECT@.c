/*
 * XREFs of ?xxxMigrateWindowHandler@CallShell@@YA_NPEAUtagWND@@W4_SHELL_MIGRATE_WINDOW_REASON@@AEBUtagRECT@@2GU4@PEAUtagMONITOR@@PEAU4@PEAW4State@AdvancedWindowPos@@PEAK@Z @ 0x1C021E2F8
 * Callers:
...
LABEL_116:
    ...
    if ( v20 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_AND_TRACE_SF_(
        ...
        v31,
        v32,
        (unsigned int)&WPP_8ba1c0058de53c07630bf97a274bc62e_Traceguids,
        2,
        4,
        32,
        (__int64)&WPP_8ba1c0058de53c07630bf97a274bc62e_Traceguids);
