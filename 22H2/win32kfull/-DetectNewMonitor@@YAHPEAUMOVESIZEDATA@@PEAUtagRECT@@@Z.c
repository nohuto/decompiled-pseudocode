/*
 * XREFs of ?DetectNewMonitor@@YAHPEAUMOVESIZEDATA@@PEAUtagRECT@@@Z @ 0x1C01B8A28
 * Callers:
...
__int64 __fastcall DetectNewMonitor(struct tagWND **a1, struct tagRECT *a2)
{
  ...
  if ( v39 && v9 && v39 != (struct tagWND *)v9 )
  {
    ...
    else
    {
      ...
      MonitorRectForWindow = (struct tagRECT *)GetMonitorRectForWindow((__int64)&v44, v38, a1[2]);
      v22 = a1[2];
      v40 = *MonitorRectForWindow;
      v44 = *(struct tagRECT *)GetMonitorRectForWindow((__int64)&v44, (__int64)v39, v22);
