/*
 * XREFs of GreGetGlyphOutlineInternal @ 0x1C009C154
 * Callers:
 ...
 *     ?vReleaseCache@RFONTOBJ@@QEAAXXZ @ 0x1C009FE14 (-vReleaseCache@RFONTOBJ@@QEAAXXZ.c)
 ...
 *     ?bSkipCHSFontSegUISymFallback@RFONTOBJ@@QEAAHGPEAVPFF@@0@Z @ 0x1C00E77DC (-bSkipCHSFontSegUISymFallback@RFONTOBJ@@QEAAHGPEAVPFF@@0@Z.c)
 ...
 *     ?bIsPerFontEUDC@PFFOBJ@@QEBAHXZ @ 0x1C016CAF4 (-bIsPerFontEUDC@PFFOBJ@@QEBAHXZ.c)
        ...
        int a8)
{
  ...
  struct _MAT2 *v71; // [rsp+B8h] [rbp-48h]
  struct tagTTPOLYGONHEADER *v72; // [rsp+C0h] [rbp-40h]
  _QWORD v73[2]; // [rsp+C8h] [rbp-38h] BYREF
  char v74[32]; // [rsp+D8h] [rbp-28h] BYREF
  __int64 v75[3]; // [rsp+F8h] [rbp-8h] BYREF
  _GLYPHDATA v76; // [rsp+110h] [rbp+10h] BYREF
  ...
  v57 = 0LL;
  if ( (unsigned int)RFONTOBJ::bInit((RFONTOBJ *)&v57, (struct XDCOBJ *)v73, 0, 2u) )
  ...
  RFONTOBJ::vInitEUDC((RFONTOBJ *)&v57, (struct XDCOBJ *)v73);
  ...
  *(_DWORD *)(v18 + 712) |= 1u;
  ...
  if ( v22 )
  {
    ...
    if ( v56 != *(_DWORD *)(v25 + 460) )
    {
      ...
      v62 = v26;
      if ( v26
        && (v75[0] = *(_QWORD *)(v26 + 128), (unsigned int)PFFOBJ::bIsPerFontEUDC((PFFOBJ *)v75))
...
LABEL_52:
  if ( v14 )
  {
    ...
    if ( *(_QWORD *)&sizLogResPpi
      ...
      && (RESETFCOBJ::RESETFCOBJ((RESETFCOBJ *)&v69, (struct DCOBJ *)v73, (struct RFONTOBJ *)&v58, v71, a8, v67),
          (_DWORD)v69) )
    {
      if ( !v15 )
      {
        v50 = PFFOBJ::QueryFontData((PFFOBJ *)v64, 0LL, v58, 4u, v11, &v76, 0LL, 0);
        goto LABEL_76;
      }
      if ( v15 == 1 )
        goto LABEL_61;
      if ( v15 <= 3 )
      {
        ...
        if ( !v68 )
          v49 = v48;
        v50 = PFFOBJ::QueryTrueTypeOutline((PFFOBJ *)v64, v44, v58, v11, v49, &v76, a5, v72);
LABEL_76:
        v61 = v50;
        if ( v50 != -1 )
        {
          ...
          *(_DWORD *)(v12 + 8) = v76.rclInk.left;
          *(_DWORD *)v12 = v52;
          *(_DWORD *)(v12 + 4) = v76.rclInk.bottom - top;
          v53 = (v76.ptqD.x.HighPart >> 3) + 1;
          *(_DWORD *)(v12 + 12) = -top;
          *(_WORD *)(v12 + 16) = v53 >> 1;
          *(_WORD *)(v12 + 18) = ((v76.ptqD.y.HighPart >> 3) + 1) >> 1;
        }
      }
      else if ( v15 <= 6 )
      {
LABEL_61:
        ...
        v50 = PFFOBJ::QueryFontData((PFFOBJ *)v64, 0LL, v58, v60, v11, &v76, v72, a5);
        goto LABEL_76;
      }
      if ( !HIDWORD(v69) )
      {
