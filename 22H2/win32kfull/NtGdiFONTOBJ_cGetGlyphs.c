/*
 * XREFs of NtGdiFONTOBJ_cGetGlyphs @ 0x1C02B40C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CacheGlyphPath@UMPDOBJ@@QEAAPEAU_PATHOBJ@@PEAU2@@Z @ 0x1C02933FC (-CacheGlyphPath@UMPDOBJ@@QEAAPEAU_PATHOBJ@@PEAU2@@Z.c)
 */
