/*
 * XREFs of NtGdiFONTOBJ_cGetGlyphs @ 0x1C02CC810
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CacheGlyphPath@UMPDOBJ@@QEAAPEAU_PATHOBJ@@PEAU2@@Z @ 0x1C0298BD8 (-CacheGlyphPath@UMPDOBJ@@QEAAPEAU_PATHOBJ@@PEAU2@@Z.c)
