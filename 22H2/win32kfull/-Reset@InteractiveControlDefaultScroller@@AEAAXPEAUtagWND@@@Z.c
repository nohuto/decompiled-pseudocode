/*
 * XREFs of ?Reset@InteractiveControlDefaultScroller@@AEAAXPEAUtagWND@@@Z @ 0x1C0258D48
 * Callers:
...
void __fastcall InteractiveControlDefaultScroller::Reset(InteractiveControlDefaultScroller *this, struct tagWND *a2)
{
  ...
  dword_1C0340A70 = 0;
  dword_1C0340A60 = v4;
  dword_1C0340A5C = *((_DWORD *)InteractiveControlManager::Instance() + 59);
  dword_1C0340A64 = *((_DWORD *)InteractiveControlManager::Instance() + 61);
  dword_1C0340A6C = *((_DWORD *)InteractiveControlManager::Instance() + 63);
  dword_1C0340A74 = *((_DWORD *)InteractiveControlManager::Instance() + 65);
