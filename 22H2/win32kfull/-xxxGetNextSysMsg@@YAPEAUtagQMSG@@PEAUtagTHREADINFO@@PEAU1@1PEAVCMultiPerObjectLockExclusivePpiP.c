/*
 * XREFs of ?xxxGetNextSysMsg@@YAPEAUtagQMSG@@PEAUtagTHREADINFO@@PEAU1@1PEAVCMultiPerObjectLockExclusivePpiPtiQ@@@Z @ 0x1C0166FE8
 * Callers:
        ...
        struct CMultiPerObjectLockExclusivePpiPtiQ *a4)
{
  ...
  if ( PhkFirstGlobalValid((__int64)a1, 1) && a1[57] == (struct tagQ *)grpdeskRitInput )
  {
    if ( !a2 )
    {
      ...
      if ( v7 != -1 )
      {
        if ( !v7 )
        {
          WakeSomeone(a1[54], 0LL, *((_DWORD *)a3 + 6), 0LL);
          CInputGlobals::MarkLastInputAsJournalling(gpInputGlobals);
          return 1LL;
        }
        *((_WORD *)a1[56] + 3) &= 0xE3F8u;
        *((_WORD *)a1[56] + 2) &= 0xE3F8u;
        *(_DWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 400LL) = *((_DWORD *)a3 + 6);
        qword_1C0339F28 = InternalSetTimer(0LL, qword_1C0339F28, v7, (__int64)JournalTimer, 32, 276);
      }
    }
    return 0LL;
  }
...
LABEL_21:
    ...
    {
      v14 = *((_QWORD *)v12 + 13);
      if ( v14 && (struct tagQ **)v14 != a1 && (*(_DWORD *)(v14 + 488) & 0x10000) != 0 )
