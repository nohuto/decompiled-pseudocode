/*
 * XREFs of Generate_HTSC_WORD @ 0x1C0129E08
 * Callers:
 ...
 *     RotateHTPatXY @ 0x1C015C128 (RotateHTPatXY.c)
 *     RotateHTPat45 @ 0x1C015DDD4 (RotateHTPat45.c)
 */
...
__int64 __fastcall Generate_HTSC_WORD(__m128i *a1)
{
  ...
  {
    EngAcquireSemaphore(qword_1C0339F78);
    v2 = 0;
    ...
    {
LABEL_14:
      EngReleaseSemaphore(qword_1C0339F78);
    ...
    v20 = 16 * (v5 >> 1);
    v9 = (v8 << 24) + 808539208;
    v10 = *(__int64 *)((char *)&off_1C02E02C8 + v20);
    v11 = v10;
