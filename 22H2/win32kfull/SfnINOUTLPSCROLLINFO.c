/*
 * XREFs of SfnINOUTLPSCROLLINFO @ 0x1C010E000
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  __int64 v42; // [rsp+E8h] [rbp-60h]
  int v43; // [rsp+F0h] [rbp-58h]
  int v44; // [rsp+F4h] [rbp-54h]
  ...
  *(_QWORD *)(*(_QWORD *)(v13 + 480) + 80LL) = v18;
  ...
  v19 = KeUserModeCallback(19LL, &v37, 72LL, &v32, v31);
  ...
  *(_QWORD *)(v21 + 80) = v34;
  if ( v19 >= 0 && v31[0] == 24 )
  {
    ...
    {
      v25 = *(_QWORD *)(v32 + 16);
      if ( v25 + 28 < v25 || v25 + 28 > MmUserProbeAddress )
