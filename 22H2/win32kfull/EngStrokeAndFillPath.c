/*
 * XREFs of EngStrokeAndFillPath @ 0x1C0289760
 * Callers:
 ...
 *     ??0RGNMEMOBJTMPIFNEEDED@@QEAA@AEAVEPATHOBJ@@W4PRECOMPUTETYPE@@KPEAU_RECTL@@@Z @ 0x1C0284BDC (--0RGNMEMOBJTMPIFNEEDED@@QEAA@AEAVEPATHOBJ@@W4PRECOMPUTETYPE@@KPEAU_RECTL@@@Z.c)
 *     ??1RGNMEMOBJTMPIFNEEDED@@QEAA@XZ @ 0x1C028933C (--1RGNMEMOBJTMPIFNEEDED@@QEAA@XZ.c)
        ...
        FLONG flOptions)
{
  ...
  _BYTE v48[152]; // [rsp+1D0h] [rbp+D0h] BYREF
  BRUSHOBJ *v49; // [rsp+268h] [rbp+168h]
  int v50; // [rsp+270h] [rbp+170h]
...
LABEL_14:
    ...
    if ( !v37[0] || !v34[0] || !v30 || !RGNOBJ::bMerge((RGNOBJ *)&v30, (struct RGNOBJ *)v37, (struct RGNOBJ *)v34, 4u) )
      goto LABEL_41;
    BOUNDCLIPRGNTOSURFACE::BOUNDCLIPRGNTOSURFACE((BOUNDCLIPRGNTOSURFACE *)v48, pso, &v35);
    if ( !v50 )
    {
      pbo = v49;
