/*
 * XREFs of ?bStretch@BLTRECORD@@QEAAHAEAVDCOBJ@@0KE@Z @ 0x1C00DC33C
 * Callers:
 ...
 *     ?vOrderStupid@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1C00DCB18 (-vOrderStupid@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
 ...
 *     ?bBitBlt@BLTRECORD@@QEAAHAEAVDCOBJ@@0KJJ@Z @ 0x1C02933AC (-bBitBlt@BLTRECORD@@QEAAHAEAVDCOBJ@@0KJJ@Z.c)
        ...
        unsigned __int8 a5)
{
  ...
  __m128i v83[3]; // [rsp+B4h] [rbp-4Ch] BYREF
...
LABEL_12:
  ...
  if ( v24 != v25 && !v22 )
  {
    ...
    if ( !v26 || v27 )
    {
      ...
      if ( *((_WORD *)v37 + 50) || *((_QWORD *)v37 + 3) )
      {
        ...
        {
          if ( v40 && (unsigned int)dword_1C0354098 > 5 && tlgKeywordOn((__int64)&dword_1C0354098, 0x400000000000LL) )
          {
            v75 = 0;
            v76 = 1;
  ...
  *v44 += *(_DWORD *)(*(_QWORD *)v46 + 8 * v52 + 1016);
  ...
  {
    v74 = v83[0];
    XDCOBJ::vAccumulateTight(a2, v55, &v74);
  }
  v57 = *((_QWORD *)this + 8);
  v58 = *((_QWORD *)this + 9);
  v59 = *(_DWORD **)(v58 + 48);
...
LABEL_93:
  ...
  if ( v68 != 52428 && (*((_DWORD *)this + 53) & 0x10000) != 0 && *v66 )
    v19 = *v66 + 24LL;
  return ((__int64 (__fastcall *)(__int64, __int64, __int64, _BYTE *, __int64, __int64, __int64, struct ERECTL *, char *, char *, _DWORD, __int64, int))v60)(
