/*
 * XREFs of ?bStretch@BLTRECORD@@QEAAHAEAVDCOBJ@@0KE@Z @ 0x1C00B853C
 * Callers:
 ...
 *     ?vOrderStupid@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1C00B8CE8 (-vOrderStupid@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
  ...
  if ( v26 != v27 && !v24 )
  {
    ...
    if ( !v28 || v29 )
    {
      ...
      if ( *((_WORD *)v39 + 50) || *((_QWORD *)v39 + 3) )
      {
        ...
        {
          if ( v42 && (unsigned int)dword_1C032A3D8 > 5 && tlgKeywordOn((__int64)&dword_1C032A3D8, 0x400000000000LL) )
          {
            v72 = 0;
            v73 = 1;
