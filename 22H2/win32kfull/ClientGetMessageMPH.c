/*
 * XREFs of ClientGetMessageMPH @ 0x1C000359C
 * Callers:
...
__int64 __fastcall ClientGetMessageMPH(_OWORD *a1, __int64 a2, int a3, int a4, int a5, int a6)
{
  ...
  v23 = a5;
  v24 = a6;
  v7 = (PERESOURCE *)SGDCRITTYPEgpresUser<_ERESOURCE *>::operator _ERESOURCE * &();
  if ( ExIsResourceAcquiredExclusiveLite(*v7) == 1 || (v8 = 1, !IS_USERCRIT_OWNED_AT_ALL()) )
    v8 = 0;
