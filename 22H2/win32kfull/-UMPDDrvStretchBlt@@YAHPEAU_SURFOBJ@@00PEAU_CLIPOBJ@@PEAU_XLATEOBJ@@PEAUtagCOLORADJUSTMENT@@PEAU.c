/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C014DF70
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v17, (UMPDOBJ *)((char *)v17 + 112), (const void **)&v48[6], 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::pxlo(v17, (struct _XLATEOBJ **)&v48[7]) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v48[8], 0x18u) )
            {
              ...
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v48[10], 0x10u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v48[11], 0x10u) )
                  {
                    ...
                    {
                      LODWORD(Size) = 4;
                      if ( (unsigned int)UMPDOBJ::Thunk(v17, v48, 0x80u, &v24, Size) != -1 )
                      {
                        if ( v24 )
                          v21 = 1;
                      }
