/*
 * XREFs of ?_GetCursorFrameInfo@@YAPEAUtagCURSOR@@PEAU1@HPEAKPEAH@Z @ 0x1C0161C90
 * Callers:
...
struct tagCURSOR *__fastcall _GetCursorFrameInfo(struct tagCURSOR *a1, int a2, unsigned int *a3, int *a4)
{
  __int64 v5; // rbp
