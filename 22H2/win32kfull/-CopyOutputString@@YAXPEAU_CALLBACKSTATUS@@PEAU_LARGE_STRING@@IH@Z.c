/*
 * XREFs of ?CopyOutputString@@YAXPEAU_CALLBACKSTATUS@@PEAU_LARGE_STRING@@IH@Z @ 0x1C002452C
 * Callers:
 ...
 *     MBToWCSEx @ 0x1C00D31A0 (MBToWCSEx.c)
 *     WCSToMBEx @ 0x1C00D3208 (WCSToMBEx.c)
 *     strncpycch @ 0x1C025DCB4 (strncpycch.c)
 */
