/*
 * XREFs of ?TraceLoggingScreenOrientationChangeEvent@@YAXKW4arInitiatedBy@@HW4arFailureReason@@@Z @ 0x1C0202550
 * Callers:
...
void __fastcall TraceLoggingScreenOrientationChangeEvent(int a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C0354098, 0x400000000001LL) )
    {
      v7 = v4;
      v8 = v5;
      v9 = v6;
