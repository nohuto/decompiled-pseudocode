/*
 * XREFs of ?TraceLoggingScreenOrientationChangeEvent@@YAXKW4arInitiatedBy@@HW4arFailureReason@@@Z @ 0x1C02250B8
 * Callers:
...
NTSTATUS __fastcall TraceLoggingScreenOrientationChangeEvent(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C032A3D8 > 5 && (qword_1C032A3E8 & 0x400000000001LL) != 0 )
  {
    result = qword_1C032A3F0 & 1;
    if ( (qword_1C032A3F0 & 0x400000000001LL) == qword_1C032A3F0 )
    {
      v7 = a2;
      v5 = a4;
      v6 = a3;
