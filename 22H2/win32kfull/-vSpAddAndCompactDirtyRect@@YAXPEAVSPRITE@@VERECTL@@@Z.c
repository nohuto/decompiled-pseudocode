/*
 * XREFs of ?vSpAddAndCompactDirtyRect@@YAXPEAVSPRITE@@VERECTL@@@Z @ 0x1C01654C8
 * Callers:
 ...
 *     ?bContain@RGNOBJ@@QEAAHAEAU_RECTL@@@Z @ 0x1C010FA60 (-bContain@RGNOBJ@@QEAAHAEAU_RECTL@@@Z.c)
