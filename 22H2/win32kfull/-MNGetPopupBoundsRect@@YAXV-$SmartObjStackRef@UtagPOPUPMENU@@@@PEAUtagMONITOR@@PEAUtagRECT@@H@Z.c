/*
 * XREFs of ?MNGetPopupBoundsRect@@YAXV?$SmartObjStackRef@UtagPOPUPMENU@@@@PEAUtagMONITOR@@PEAUtagRECT@@H@Z @ 0x1C0215550
 * Callers:
...
_QWORD *__fastcall MNGetPopupBoundsRect(int ***a1, __int64 a2, struct tagRECT *a3, int a4)
{
  ...
  char v21[16]; // [rsp+28h] [rbp-31h] BYREF
  ...
  v8 = *(_OWORD *)GetMonitorRectForWindow((__int64)v21, a2, *((const struct tagWND **)**a1 + 2));
  v9 = *a1;
  v23 = v8;
  if ( **v9 >= 0 )
  {
