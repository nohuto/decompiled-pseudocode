/*
 * XREFs of _GetRegisteredRawInputDevices @ 0x1C01AA238
 * Callers:
 *     NtUserGetRegisteredRawInputDevices @ 0x1C01D3D60 (NtUserGetRegisteredRawInputDevices.c)
 * Callees:
 *     UserSetLastError @ 0x1C00F04CC (UserSetLastError.c)
 *     ?SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z @ 0x1C01A9BD0 (-SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z.c)
 */
...
LABEL_44:
          ...
          v42 = *(__int64 **)(v35 + 48);
          while ( v42 != (__int64 *)(*(_QWORD *)(v7 + 848) + 48LL) && v16 < v19 )
          {
            v43 = 2LL * v16;
