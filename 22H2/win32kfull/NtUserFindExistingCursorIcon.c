/*
 * XREFs of NtUserFindExistingCursorIcon @ 0x1C008F910
 * Callers:
 *     <none>
 * Callees:
 *     UserSetLastStatus @ 0x1C00132A8 (UserSetLastStatus.c)
 *     HMValidateHandle @ 0x1C002D0F8 (HMValidateHandle.c)
 *     ?ResStrCmp@@YAHPEAU_UNICODE_STRING@@0@Z @ 0x1C008FE08 (-ResStrCmp@@YAHPEAU_UNICODE_STRING@@0@Z.c)
...
LABEL_35:
  *v20 = 0;
  ...
  {
    Atom = UserFindAtom(v40, v19, v18, v22);
    if ( Atom )
    {
      i = 0LL;
      if ( DWORD2(v32) )
      {
        ...
        if ( (*(_DWORD *)(v26 + 1272) & 0x8000000) != 0 )
          v26 = *(_QWORD *)(v26 + 1520);
        for ( i = *(_QWORD *)(*(_QWORD *)(v26 + 424) + 728LL); i; i = *(_QWORD *)(i + 32) )
        {
          if ( v34 && i == v34 )
          {
            i = v34;
