/*
 * XREFs of ?vInit@ESTROBJ@@QEAAXPEAGJAEAVXDCOBJ@@AEAVRFONTOBJ@@AEAVEXFORMOBJ@@PEAJHJJJJJJK4PEAXK@Z @ 0x1C00951E0
 * Callers:
        ...
        unsigned int a18)
{
  ...
  int v155; // edx
  __int64 v156; // r8
  unsigned int v157; // [rsp+50h] [rbp-88h]
  ...
  *((_QWORD *)this + 8) = v30;
  ...
  {
    ESTROBJ::vCharPos_H3(this, v22, a5, v34, v33, a10, a11, a12, LODWORD(v25), 0LL);
    goto LABEL_48;
  }
