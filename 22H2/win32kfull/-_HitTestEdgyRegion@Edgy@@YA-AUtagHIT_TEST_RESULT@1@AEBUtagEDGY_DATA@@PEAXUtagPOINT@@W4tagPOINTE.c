/*
 * XREFs of ?_HitTestEdgyRegion@Edgy@@YA?AUtagHIT_TEST_RESULT@1@AEBUtagEDGY_DATA@@PEAXUtagPOINT@@W4tagPOINTER_DEVICE_TYPE@@H@Z @ 0x1C0207D7C
 * Callers:
 ...
 *     ?_GetRectForLocation@Edgy@@YA?AUtagRECT@@AEBU2@W4tagEDGY_LOCATION@@K@Z @ 0x1C0207C6C (-_GetRectForLocation@Edgy@@YA-AUtagRECT@@AEBU2@W4tagEDGY_LOCATION@@K@Z.c)
 */
