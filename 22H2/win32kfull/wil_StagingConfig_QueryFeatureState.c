/*
 * XREFs of wil_StagingConfig_QueryFeatureState @ 0x1C037A0CC
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C0165E6C (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 *     __security_check_cookie @ 0x1C01655A0 (__security_check_cookie.c)
 *     wil_details_StagingConfig_Load @ 0x1C01660C0 (wil_details_StagingConfig_Load.c)
 *     wil_details_StagingConfig_QueryFeatureState @ 0x1C01663BC (wil_details_StagingConfig_QueryFeatureState.c)
