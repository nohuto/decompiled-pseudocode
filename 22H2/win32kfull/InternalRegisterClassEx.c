/*
 * XREFs of InternalRegisterClassEx @ 0x1C0079D30
 * Callers:
 ...
 *     _InnerGetClassPtr @ 0x1C007A5B0 (_InnerGetClassPtr.c)
    ...
    if ( (*(_WORD *)(*(_QWORD *)(*(_QWORD *)v49[0] + 8LL) + 6LL) & 1) == 0 )
    {
      ...
      if ( v20 )
      {
        ...
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v49[0] + 8LL) + 32LL) = v20;
        ...
        v45 = 6LL * v43;
        v46 = dword_1C02E0A88[2 * v45];
        if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v49[0] + 8LL) + 80LL) >= v46 )
        {
          *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v49[0] + 8LL) + 84LL) = v46;
          *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v49[0] + 8LL) + 80LL) -= dword_1C02E0A88[2 * v45];
        }
      }
    }
LABEL_25:
