/*
 * XREFs of ?UmfdInsertFontFileViewForLookup@@YAHPEAPEAU_FONTFILEVIEW@@I@Z @ 0x1C01144C8
 * Callers:
...
LABEL_10:
    ...
    while ( 1 )
    {
      ...
      if ( v17 )
      {
        v18 = NSInstrumentation::CSortedVector<unsigned int,_FONTFILEVIEW *>::LowerBound(v16, v10 + 23456);
        if ( v18 < v17 )
        {
