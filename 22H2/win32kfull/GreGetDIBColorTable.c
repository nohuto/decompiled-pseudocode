/*
 * XREFs of GreGetDIBColorTable @ 0x1C0116BE0
 * Callers:
 *     <none>
 * Callees:
 *     ?vFill_rgbquads@XEPALOBJ@@QEAAXPEAUtagRGBQUAD@@KK@Z @ 0x1C00A4DD8 (-vFill_rgbquads@XEPALOBJ@@QEAAXPEAUtagRGBQUAD@@KK@Z.c)
