/*
 * XREFs of ?HapticsDeviceNotify@SimpleHapticsController@@KAJPEAU_PLUGPLAY_NOTIFY_HDR@@PEAX@Z @ 0x1C0248490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsValidSimpleHapticsController@InteractiveControlManager@@QEBA_NPEBVSimpleHapticsController@@@Z @ 0x1C013DE3C (-IsValidSimpleHapticsController@InteractiveControlManager@@QEBA_NPEBVSimpleHapticsController@@@Z.c)
 ...
 *     ?CloseHapticsWriteDevice@SimpleHapticsController@@IEAAJH@Z @ 0x1C024820C (-CloseHapticsWriteDevice@SimpleHapticsController@@IEAAJH@Z.c)
