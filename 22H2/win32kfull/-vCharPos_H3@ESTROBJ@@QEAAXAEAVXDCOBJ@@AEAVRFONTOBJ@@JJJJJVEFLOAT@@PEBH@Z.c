/*
 * XREFs of ?vCharPos_H3@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJJJJVEFLOAT@@PEBH@Z @ 0x1C01119D8
 * Callers:
        ...
        int *a10)
{
  ...
  if ( a7 | a6 )
  {
    ...
    *(_DWORD *)(a1 + 4) = v40;
    ...
    v42 = (_DWORD *)(a1 + 120);
    if ( bCalcBreakExtra((unsigned int)_mm_cvtsi128_si32(v39), a7, a8, a1 + 120) )
    {
      v43 = *(_DWORD *)(a1 + 116);
