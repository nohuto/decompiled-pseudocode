/*
 * XREFs of EditionUpdateInputTransformFromHitTest @ 0x1C0002F00
 * Callers:
 *     <none>
 * Callees:
 *     ?SetCompositionInput@InputTransform@@YAHPEAUtagWND@@PEAX@Z @ 0x1C0002FB4 (-SetCompositionInput@InputTransform@@YAHPEAUtagWND@@PEAX@Z.c)
