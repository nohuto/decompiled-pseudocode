/*
 * XREFs of ?Cleanup@CWindowGroupManager@@QEAAXW4CleanupType@1@@Z @ 0x1C023FA94
 * Callers:
 *     ?CleanupShellWindowManagement@@YAXPEAUtagDESKTOP@@@Z @ 0x1C00D761C (-CleanupShellWindowManagement@@YAXPEAUtagDESKTOP@@@Z.c)
 *     ?Uninitialize@CWindowGroupManager@@SAXXZ @ 0x1C0240628 (-Uninitialize@CWindowGroupManager@@SAXXZ.c)
 * Callees:
