/*
 * XREFs of ?bAddEntry@PFFMEMOBJ@@QEAAHKPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@1PEAU_UNIVERSAL_FONT_ID@@PEAU_EUDCLOAD@@@Z @ 0x1C0081B40
 * Callers:
 ...
 *     ?IsCHSBaseFont@@YAHPEBGI@Z @ 0x1C0082708 (-IsCHSBaseFont@@YAHPEBGI@Z.c)
 *     ?bCheckFamilyName@PFEOBJ@@QEAAHPEBGHPEAH@Z @ 0x1C008288C (-bCheckFamilyName@PFEOBJ@@QEAAHPEBGHPEAH@Z.c)
 */
...
LABEL_9:
      ...
      if ( v20 )
      {
        if ( a2 != 1 )
        {
          ...
          if ( !PFEOBJ::bCheckFamilyName((PFEOBJ *)&v25, v20, 1, 0LL) )
            goto LABEL_8;
          v22 = 0LL;
          if ( v21 == 64 )
            v22 = 1LL;
