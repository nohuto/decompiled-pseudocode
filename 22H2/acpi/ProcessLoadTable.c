/*
 * XREFs of ProcessLoadTable @ 0x1C006A1F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_43:
        ...
        RtlStringCchCopyNA(PoolWithTag, (unsigned int)(v16 + v15 + 2), pszSrc, (unsigned int)v16);
      ...
      else
      {
        v24 = v29 + 64;
        FreeObjData(v29 + 64);
        v25 = DupObjData((struct _SLIST_ENTRY *)gpheapGlobal, v24, *(_QWORD *)(v6 + 80) + 200LL);
        v3 = v25;
        if ( v25 )
        {
          LogError(v25);
  ...
  *(_QWORD *)(BugCheckParameter2 + 416) = v22[1];
  HeapFree(v22);
