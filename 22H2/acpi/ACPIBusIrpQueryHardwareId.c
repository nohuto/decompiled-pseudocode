/*
 * XREFs of ACPIBusIrpQueryHardwareId @ 0x1C008F720
 * Callers:
...
LABEL_26:
    if ( v9 < v35 )
      goto LABEL_29;
    v24 = RtlStringCbPrintfExW(&v10[v35 >> 1], v9 - v35, &ppszDestEnd, &pcbRemaining, 0, &word_1C006F7EC);
    goto LABEL_28;
  }
  v12 = *(_QWORD *)(a3 + 8);
...
LABEL_28:
  ...
  memmove(P, v17, v16);
  if ( !(unsigned __int8)ACPIValidateStringVendorDeviceIdFormat(P, Size) && (*(_BYTE *)(a3 + 960) & 0x1C) == 0 )
  {
LABEL_24:
    if ( v9 > v35 )
    {
