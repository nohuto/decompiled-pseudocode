/*
 * XREFs of RegisterOperationRegionHandler @ 0x1C008BB34
 * Callers:
 ...
 *     ACPIEcInstallOpRegionHandler @ 0x1C008370C (ACPIEcInstallOpRegionHandler.c)
 *     RegisterOpRegionHandler @ 0x1C008BAD0 (RegisterOpRegionHandler.c)
 *     OSInitializeCallbacks @ 0x1C00A8170 (OSInitializeCallbacks.c)
 * Callees:
