/*
 * XREFs of CreateNativeNameSpaceObject @ 0x1C0049D58
 * Callers:
 ...
 *     SetClearAssociatedNativeObject @ 0x1C004A24C (SetClearAssociatedNativeObject.c)
 *     GetNextNameSegment @ 0x1C004BABC (GetNextNameSegment.c)
