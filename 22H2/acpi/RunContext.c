/*
 * XREFs of RunContext @ 0x1C0004DD0
 * Callers:
 *     InsertReadyQueue @ 0x1C00047A0 (InsertReadyQueue.c)
 *     DispatchCtxtQueue @ 0x1C0028960 (DispatchCtxtQueue.c)
 * Callees:
...
LABEL_158:
  ...
  *((_QWORD *)&ListEntry[2].Next + 1) = ListEntry + 2;
    ...
    && (unsigned __int8)tlgKeywordOn(&dword_1C007F0E8) )
  {
    ...
    v78 = v73;
    v96 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C007F0E8, (int)&dword_1C0072650, v73, v74, 5u, &v90);
  }
  ...
  if ( v39 )
  {
    do
    {
      v57 = *(_QWORD *)(v39 + 24);
      ++dword_1C0082F5C;
      if ( ExQueryDepthSList(&AMLIContextLookAsideList) >= (unsigned __int16)word_1C0082F50 )
      {
        ++dword_1C0082F60;
        ((void (__fastcall *)(__int64))qword_1C0082F78)(v39);
      }
      else
      {
  ...
  {
    ++dword_1C0082F60;
    ((void (__fastcall *)(PSLIST_ENTRY))qword_1C0082F78)(ListEntry);
  }
  else
  {
