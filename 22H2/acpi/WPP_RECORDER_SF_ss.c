/*
 * XREFs of WPP_RECORDER_SF_ss @ 0x1C005A65C
 * Callers:
        ...
        const char *a7)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    ...
    pfnWppTraceMessage(
      ...
      43LL,
      &WPP_ae57f2233dfb3a91da68ac54a8788e80_Traceguids,
      11LL,
      v14,
      v13,
      v11);
  ...
  if ( !a6 )
    v8 = "NULL";
  LOWORD(v17) = 11;
  return WppAutoLogTrace(a1, 2LL, 21LL, &WPP_ae57f2233dfb3a91da68ac54a8788e80_Traceguids, v17, v8);
}
