/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C0036570
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x1C0031E30 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x1C0038090 (RegisterKernelPerfFeedback.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(__int64 a1, __int64 (__fastcall *a2)(char *, _QWORD))
{
  ...
  v4(WdfDriverGlobals, qword_1C001C3E8, 0LL);
