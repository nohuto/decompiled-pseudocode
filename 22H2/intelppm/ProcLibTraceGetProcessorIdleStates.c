/*
 * XREFs of ProcLibTraceGetProcessorIdleStates @ 0x1C002CCA4
 * Callers:
    ...
    if ( *(_QWORD *)(a1 + 1128) )
    {
      ...
      if ( ProcessorNumber >= 0 )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
          ...
          *(_QWORD *)(a1 + 208),
          0LL);
        v5 = (unsigned int)(13 * *(_DWORD *)(a1 + 1116));
        v15 = *(_DWORD *)(a1 + 1116);
        ...
        if ( PoolWithTag )
        {
          ...
          UserData.Size = 2;
          v19 = 1;
          EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v2, 0LL, 5u, &UserData);
