/*
 * XREFs of InitCpcStatesInternal @ 0x1C0035000
 * Callers:
 *     RegisterHvCpcCounters @ 0x1C00311D0 (RegisterHvCpcCounters.c)
 *     RegisterKernelCpc @ 0x1C0036FB0 (RegisterKernelCpc.c)
 * Callees:
 ...
 *     ClearEnumerationContext @ 0x1C000866C (ClearEnumerationContext.c)
 ...
 *     GetPackageAffinity @ 0x1C0034E2C (GetPackageAffinity.c)
 */
...
__int64 __fastcall InitCpcStatesInternal(_QWORD *a1, __int64 (__fastcall *a2)(_QWORD *, _QWORD))
{
  ...
  _DWORD *v114; // r14
  _BYTE *v115; // rdi
  struct _GROUP_AFFINITY *v116; // rdx
  ...
  BOOL v152; // [rsp+ACh] [rbp-54h]
  unsigned __int64 v153; // [rsp+B0h] [rbp-50h]
  _QWORD v154[2]; // [rsp+B8h] [rbp-48h] BYREF
  __int64 v155; // [rsp+C8h] [rbp-38h]
  __int64 v156; // [rsp+D0h] [rbp-30h] BYREF
  __int64 (__fastcall *v157)(__int64, unsigned int, unsigned int, unsigned int, int, int, int, _DWORD *, __int64); // [rsp+D8h] [rbp-28h] BYREF
  _QWORD *v158; // [rsp+E0h] [rbp-20h]
  char *v159; // [rsp+E8h] [rbp-18h]
  __int64 v160; // [rsp+F0h] [rbp-10h] BYREF
  __int64 v161; // [rsp+F8h] [rbp-8h] BYREF
  __int64 (__fastcall *v162)(_QWORD *, _QWORD); // [rsp+100h] [rbp+0h]
  struct _GROUP_AFFINITY Affinity; // [rsp+108h] [rbp+8h] BYREF
  struct _GROUP_AFFINITY PreviousAffinity; // [rsp+118h] [rbp+18h] BYREF
  _BYTE v165[176]; // [rsp+130h] [rbp+30h] BYREF
  _BYTE v166[176]; // [rsp+1E0h] [rbp+E0h] BYREF
  ...
  LOBYTE(v139) = v3[41] != 0LL;
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    WdfDriverGlobals,
    qword_1C001C3E8,
    0LL);
  PerfDomain = GetPerfDomain((__int64)v3, (__int64)v146, &v151);
...
LABEL_8:
  ...
  v136 = 0;
  v155 = 0LL;
  KeInitializeAffinityEx(v165);
  ResetEnumerationContext((__int64 *)v146);
  while ( !(unsigned int)EnumerateNextDevice((__int64 *)v146, &DeferredContext) )
  {
  ...
  while ( !(unsigned int)EnumerateNextDevice((__int64 *)v146, &DeferredContext) )
  {
    ...
    {
      v155 = *((_QWORD *)DeferredContext + 72);
      if ( (int)GetPackageAffinity((__int64)DeferredContext, (__int64)v166) >= 0 )
        v152 = KeIsEqualAffinityEx(v166, v165) != 0;
      break;
    }
  }
  ResetEnumerationContext((__int64 *)v146);
  v15 = EnumerateNextDevice((__int64 *)v146, &DeferredContext);
  if ( v15 )
  {
    v45 = v143;
    goto LABEL_82;
  ...
  do
  {
    ...
    *v16 = IsSupported;
    ...
    v138 = CpcRegisterIsSupportedEx(v21);
    v22 = CpcRegisterIsSupportedEx((__int64)(v19 + 416));
    v24 = (unsigned __int8)v147;
    if ( v22 )
      v24 = 1;
    v16[4] = v22;
    v147 = v24;
    ...
    v139 = v29;
    v5 = 0LL;
    if ( !qword_1C001C590 || !(unsigned __int8)qword_1C001C590(v19) )
      v132 = 0;
    v32 = 0;
    memset(v154, 0, 12);
    v33 = 0LL;
    while ( 1 )
    {
      ...
      if ( CpcRegisterIsSupported((__int64)v154) )
        break;
      v33 = *v38;
      v37 = *((_DWORD *)v38 + 2);
      v154[0] = *v38;
...
LABEL_66:
    ...
    if ( LOBYTE(v154[0]) == v40
      && *(_QWORD *)((char *)v154 + 4) == *(__int64 *)((char *)v38 + 4)
      && v39 == *((_BYTE *)v38 + 3) )
    {
      goto LABEL_66;
    }
...
LABEL_70:
    if ( qword_1C001C5A8 )
    {
      ...
      if ( (int)qword_1C001C5A8(v16 - 92, &v156, &v160, &v161, &v157, &v133, &v149) < 0 )
        v18 = 0;
    }
    LOBYTE(v41) = v143;
...
LABEL_82:
  ...
  if ( v45 )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      0LL);
    ResetEnumerationContext((__int64 *)v146);
    if ( (unsigned int)EnumerateNextDevice((__int64 *)v146, &DeferredContext) )
      goto LABEL_100;
    v46 = (_QWORD *)v145;
    v47 = v12 + 112;
    do
    {
      if ( *(v47 - 20) )
      {
        ...
        {
          started = StartPccCommand(v46[31]);
          if ( started < 0 )
          {
            v3 = v46;
            goto LABEL_147;
...
LABEL_144:
    ...
    v144 = v84 + 24 * v83;
    v141 = v144 + 8 * PerfDomain * v83;
    v85 = v141;
    v86 = ExAllocatePoolWithTag(NonPagedPoolNx, v141, 0x72637250u);
    v158 = v86;
    v5 = v86;
    if ( !v86 )
      goto LABEL_8;
...
LABEL_211:
        ...
        *((_DWORD *)v5 + 8) = v101;
        ...
        {
          *((_BYTE *)v5 + 11) = 1;
          if ( (*(_QWORD *)(v87 + 272) & 0x400000000LL) == 0 || (v103 = 0, v133) )
            v103 = 1;
          *((_BYTE *)v5 + 12) = v103;
          *((_DWORD *)v5 + 12) = v149;
        }
        ...
        *((_DWORD *)v92 + 3) = 1;
        ...
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v146, &DeferredContext) )
        {
          ...
          do
          {
            v112 = *((_QWORD *)v82 + 10);
            v113 = 100;
            v114 = DeferredContext;
            v155 = v112;
            if ( v82[67] )
            {
              v115 = (_BYTE *)(v112 + 104);
              if ( *(_BYTE *)(v112 + 104) == 127 && !*((_DWORD *)DeferredContext + 20) )
              {
                KeProcessorGroupAffinity(&Affinity, *((unsigned int *)DeferredContext + 14));
                v116 = &PreviousAffinity;
                if ( v126 )
                  v116 = 0LL;
                KeSetSystemGroupAffinityThread(&Affinity, v116);
                v126 = 1;
              }
              GenAddrMaybeHidden = ReadGenAddrMaybeHiddenEx((__int64)v114, v115);
              v118 = *((_QWORD *)v82 - 2);
              if ( GenAddrMaybeHidden > v118 )
              {
              ...
              *((_QWORD *)v82 + 3) = GenAddrMaybeHidden;
              v119 = 100 * GenAddrMaybeHidden / v118;
              if ( (unsigned int)v119 > v113 )
                v113 = v119;
              *((_DWORD *)v82 + 13) = v113;
              if ( v113 != v114[181] )
                ProcLibCapChange(v111, v114[112], v114[124], v113);
              v110 = v153;
            }
            else
            {
              *((_QWORD *)v82 + 3) = *((_QWORD *)v82 - 2);
            }
            InitCommonPerfStateContext(v114, (_QWORD *)v82 - 4, v110, v113, v113 < 0x64 ? 2 : 0);
            *v109 = v82 + 128;
            *((_QWORD *)v82 + 22) = GetCpcDifferentialFeedback;
            *((_QWORD *)v82 + 23) = v120;
            v122 = *(_BYTE *)(v120 + 297);
            if ( v122 < 0x40u )
              *((_QWORD *)v82 + 20) = (1LL << v122) - 1;
            v123 = *(_BYTE *)(v120 + 273);
            if ( v123 < 0x40u )
              *((_QWORD *)v82 + 21) = (1LL << v123) - 1;
            ++v109;
            if ( (_BYTE)v139 )
            {
              *v109++ = v82 + 192;
              *((_QWORD *)v82 + 30) = *((_QWORD *)v114 + 41);
            }
            v153 = v121 + 32;
            v82 += 368;
          }
        ...
        if ( started >= 0 )
        {
          ...
          if ( (*(_QWORD *)(v145 + 272) & 0x4000000000LL) != 0 )
          {
            ResetEnumerationContext((__int64 *)v146);
            while ( !(unsigned int)EnumerateNextDevice((__int64 *)v146, &DeferredContext) )
            {
...
LABEL_210:
    ...
    if ( v127 )
    {
      ...
      else
      {
        ...
        v94 = (void *)qword_1C001C560;
        if ( !qword_1C001C560 || !CpcHiddenProcessorMitigationReported )
        {
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v58 - 60) = ReadGenAddrMaybeHiddenEx((__int64)v60, (_BYTE *)(v59 + 440));
    ...
    {
      v136 = ReadGenAddrMaybeHiddenEx((__int64)v60, (_BYTE *)(v59 + 368)) != 0;
      v137 = *(_BYTE *)(v59 + 368) != 126;
    }
    if ( v58 - 100 == v12 )
      goto LABEL_167;
    v73 = *(_QWORD *)(v58 - 92);
...
LABEL_167:
  ...
  if ( v132 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      WPP_RECORDER_SF_iii((__int64)WPP_GLOBAL_Control->DeviceExtension, v70, v71, v72, v125);
      v76 = *((_QWORD *)v12 + 3);
    }
    *(_QWORD *)(v58 - 76) = v76;
    goto LABEL_167;
