/*
 * XREFs of sub_18002EF10 @ 0x18002EF10
 * Callers:
...
__int64 *__fastcall sub_18002EF10(__int64 **a1, __int64 *a2)
{
  __int64 v2; // r9
  __int64 *v3; // r8
  __int64 **v4; // r11
...
LABEL_4:
    ...
    if ( (__int64 *)**v4 == v5 )
    {
      if ( *(_BYTE *)(v2 + 25) )
        ...
        v9 = std::_Tree_val<std::_Tree_simple_types<std::pair<void * const,`anonymous namespace'::_Mutex_count_pair>>>::_Min(
               v2,
               a2,
               v3);
      *v3 = v9;
