/*
 * XREFs of sub_1800F1DF0 @ 0x1800F1DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800F1DF0(__int64 a1, unsigned int a2, _QWORD *a3)
{
  __int64 *v5; // rax
  __int64 v6; // r8
  int v7; // eax
  ...
  sub_1800085F0(pv, (struct _TP_TIMER *)v5[1], v6, (struct _TP_TIMER *)L"asm_GetApplicationSubmixContextFromPID");
  v16 = 0LL;
  sub_1800CB144(&v16);
