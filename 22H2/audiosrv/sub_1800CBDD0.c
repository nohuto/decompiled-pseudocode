/*
 * XREFs of sub_1800CBDD0 @ 0x1800CBDD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800CBDD0(__int64 a1, __int64 a2, __int64 a3, __int128 *a4)
{
  int v5; // edi
  __int64 v7; // rax
  int v8; // ecx
  ...
  {
    sub_1800CD21C(*((_QWORD *)off_18019C348 + 2), 20, (unsigned int)&unk_18015DF00, 0, a3);
  }
    ...
    if ( v13 )
    {
      ...
      *(_OWORD *)(v14 + 7) = v16;
        ...
        && *((_BYTE *)off_18019C348 + 25) >= 4u )
      {
        ...
        sub_1800BD8A8(*((_QWORD *)off_18019C348 + 2), 0x15u, (__int64)&unk_18015DF00, v14, v20);
      }
      v5 = MMDevAPI_12(v14, *(unsigned int *)(a1 + 80), v17, v18);
      sub_180033A70(v14);
      if ( v5 < 0 )
        sub_18005E8F8((__int64)"CServerAudioSessionControl::OnIconPathChanged", 488, v5);
    }
  }
  if ( a1 != -32 )
