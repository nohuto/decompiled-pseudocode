/*
 * XREFs of sub_1800EA1F4 @ 0x1800EA1F4
 * Callers:
...
__int64 __fastcall sub_1800EA1F4(__int64 *a1, __int64 a2, char *a3)
{
  __int64 *v6; // rax
...
LABEL_20:
    v18 = a3;
    v16 = (_QWORD *)sub_1800EA2C8((_DWORD)a1, (unsigned int)&v19, (_DWORD)v6, v7, (__int64)&v18);
    *(_BYTE *)(a2 + 8) = 1;
    *(_QWORD *)a2 = *v16;
    return a2;
  }
