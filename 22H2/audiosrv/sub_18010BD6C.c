/*
 * XREFs of sub_18010BD6C @ 0x18010BD6C
 * Callers:
...
ULONG __fastcall sub_18010BD6C(__int64 a1, unsigned __int8 *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  v9 = 4;
  v10 = 0;
  return sub_180109634(a1, a2, 0LL, 0LL, 4u, &v7);
}
