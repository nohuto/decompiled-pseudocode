/*
 * XREFs of sub_180038420 @ 0x180038420
 * Callers:
...
__int64 __fastcall sub_180038420(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  unsigned int v3; // ebx
  __int64 v4; // r9
  int v5; // edi
  ...
  *a3 = 0LL;
  ...
  if ( *a2 == 268444433 && a2[1] == 1087688139 && a2[2] == 2062258583 && a2[3] == -1644131936 )
  {
    *a3 = a1;
  }
  else
