/*
 * XREFs of sub_1800F8C10 @ 0x1800F8C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800F8C10(__int64 a1, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
  __int64 *v7; // rax
  __int64 v8; // r8
  ...
  sub_1800085F0(pv, (struct _TP_TIMER *)v7[1], v8, (struct _TP_TIMER *)L"s_pbmRegisterPlaybackManagerNotifications");
  ...
  else if ( !a2 && qword_18019E618 )
  {
    ...
    if ( v11 >= 0 )
    {
      v13 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v16 + 328LL))(v16);
      v12 = v16;
      v6 = v13;
    }
    if ( v12 )
