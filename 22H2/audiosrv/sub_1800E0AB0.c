/*
 * XREFs of sub_1800E0AB0 @ 0x1800E0AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800E0AB0(__int64 a1)
{
  __int64 v2; // rcx
  __int64 *v3; // rax
  __int64 v4; // r8
  ...
  sub_1800085F0(pv, (struct _TP_TIMER *)v3[1], v4, (struct _TP_TIMER *)L"AudioServerStartStreamAborted");
  v5 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a1 + 96LL))(a1);
  v8 = v5;
  if ( v5 >= 0 )
    v8 = 0;
  else
    sub_18004BD84((int)retaddr, 3259, (int)"avcore\\audiocore\\server\\audiosrv\\dll\\vadserver.cpp", v5);
