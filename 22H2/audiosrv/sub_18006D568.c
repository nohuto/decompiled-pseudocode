 ...
 * Callees:
 *     sub_18006D394 @ 0x18006D394 (sub_18006D394.c)
 *     sub_18006D47C @ 0x18006D47C (sub_18006D47C.c)
 */

int *__fastcall sub_18006D568(__int64 a1, volatile signed __int32 *a2, __int64 a3, int a4)
{
  int *v6; // r9
  int v7; // r10d
  int v8; // edx
  ...
  *(_QWORD *)(a1 + 16) = 0LL;
  ...
  {
LABEL_33:
    sub_18006D394(a2, a3, a3, (_DWORD *)a1);
    return v6;
  }
  if ( (int)a3 <= 1 )
    goto LABEL_25;
...
LABEL_8:
  ...
  {
LABEL_34:
    sub_18006D47C(a2, a3, a3, (_DWORD *)a1);
    return v6;
  }
  if ( (_DWORD)a3 == 5 )
    goto LABEL_33;
