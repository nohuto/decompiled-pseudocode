/*
 * XREFs of sub_1801108E4 @ 0x1801108E4
 * Callers:
...
__int64 __fastcall sub_1801108E4(_QWORD *a1, _QWORD *a2, _QWORD *a3)
{
  LPVOID v6; // rax
  LPVOID v7; // rbx
  int v8; // edi
  ...
  *a1 = 0LL;
  ...
  {
    sub_180110F18(v6);
    *(_QWORD *)v7 = &off_18014AEB0;
    v8 = ((__int64 (__fastcall *)(LPVOID, _QWORD, _QWORD))sub_180114F70)(v7, *a2, *a3);
    if ( v8 >= 0 )
