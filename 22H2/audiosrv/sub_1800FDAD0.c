/*
 * XREFs of sub_1800FDAD0 @ 0x1800FDAD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800FDAD0(__int64 a1, const wchar_t *a2)
{
  __int64 result; // rax
  __int64 v5; // rcx
    ...
    || (result = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v6 + 24LL))(v6, &v8), (int)result < 0) )
  {
    ...
    {
      result = sub_1800BB4E0(*((_QWORD *)off_18019C348 + 2), 0x2Du, (__int64)&unk_180172650, result);
    }
  }
  else
  {
    ...
    if ( v7 )
    {
      result = sub_180102314(*(_QWORD *)(v7 + 200), v9);
      v5 = v7;
    }
    if ( v5 )
