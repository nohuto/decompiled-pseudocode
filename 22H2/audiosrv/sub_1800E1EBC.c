/*
 * XREFs of sub_1800E1EBC @ 0x1800E1EBC
 * Callers:
...
__int64 __fastcall sub_1800E1EBC(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  v10 = 0;
  v9 = 4;
  return sub_18000F730(a1, (__int64)&unk_18016D440, a3, 3LL, (__int64)v5);
}
