/*
 * XREFs of sub_1800F1BE0 @ 0x1800F1BE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800F1BE0(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 *v5; // rax
  __int64 v6; // r8
  int v7; // eax
  ...
  sub_1800085F0(pv, (struct _TP_TIMER *)v5[1], v6, (struct _TP_TIMER *)L"asm_GetApplicationSubmixContext");
  v16 = 0LL;
  sub_1800CB144(&v16);
  ...
  {
    v13 = 0LL;
    v7 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, __int64 *))(*(_QWORD *)qword_18019EE60 + 32LL))(
           qword_18019EE60,
           a2,
           v16,
           &v13);
