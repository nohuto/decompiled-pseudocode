/*
 * XREFs of sub_1800FFEA8 @ 0x1800FFEA8
 * Callers:
...
__int64 __fastcall sub_1800FFEA8(__int64 a1, __int64 a2, int a3, const wchar_t *a4, const wchar_t *a5)
{
  __int64 v5; // rax
  __int64 v6; // r8
  __int64 v7; // rcx
  ...
  v18 = v9;
  v20 = 0;
  return sub_18000F730((__int64)v9, (__int64)&unk_18016D490, v6, 4LL, (__int64)v12);
}
