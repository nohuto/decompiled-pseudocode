/*
 * XREFs of sub_180128490 @ 0x180128490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180128490(__int64 a1, int a2, _DWORD *a3, _DWORD *a4, _DWORD *a5)
{
  ...
  if ( a3 && a4 && (v13 = a5) != 0LL && (unsigned int)(a2 - 2) <= 0x1FFFE )
  {
    ...
    *a4 = *(_DWORD *)(v14 + 8 * v15 + 4);
    *v13 = *(_DWORD *)(v14 + 8 * v15 + 8);
  }
  else
  {
    if ( (unsigned int)dword_18019C480 > 2 )
    {
      ...
      v17 = (__int64)"SpatialAudioDevicePropertyReader::GetStaticObjectPosition";
      LODWORD(v19) = 613;
      sub_180109778(
