/*
 * XREFs of sub_18013FAA0 @ 0x18013FAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18013FAA0(__int64 a1, __int64 a2, _DWORD *a3)
{
  unsigned int v6; // esi
  __int64 v7; // rdi
  _DWORD *v8; // rbx
...
LABEL_5:
  ...
  v9 = (*(__int64 (__fastcall **)(__int64, _DWORD *))(*(_QWORD *)v16 + 56LL))(v16, a3);
  if ( v9 < 0 )
LABEL_7:
    v6 = v9;
LABEL_19:
