/*
 * XREFs of sub_180138870 @ 0x180138870
 * Callers:
...
__int64 __fastcall sub_180138870(__int64 *a1, __int64 a2, __int64 a3, char *a4, __int64 a5)
{
  _QWORD *v8; // r15
  __int64 v9; // r9
  __int64 v10; // rax
...
LABEL_13:
  ...
  if ( (_BYTE)v11 )
  {
    if ( v9 == *v8 )
    {
      *(_QWORD *)a2 = *sub_180138224(a1, &v38, 1, (_QWORD *)v9, v37, a5);
      *(_BYTE *)(a2 + 8) = 1;
      return a2;
    }
    if ( *(_BYTE *)(v9 + 25) )
...
LABEL_51:
    if ( !v33 )
      goto LABEL_52;
LABEL_57:
    *(_QWORD *)a2 = *sub_180138224(a1, &v38, v11, (_QWORD *)v9, v37, a5);
    *(_BYTE *)(a2 + 8) = 1;
    return a2;
  }
  if ( v28 < v27 )
...
LABEL_52:
  ...
  v35 = *(_QWORD *)(a5 + 88);
  if ( v35 >= 8 )
    sub_1800472E0(*(_QWORD *)(a5 + 64), 2 * v35 + 2);
  *(_QWORD *)(v34 + 80) = 0LL;
  *(_QWORD *)(v34 + 88) = 7LL;
  *(_WORD *)(v34 + 64) = 0;
  v36 = *(_QWORD *)(v34 + 56);
  if ( v36 >= 8 )
    sub_1800472E0(*(_QWORD *)(v34 + 32), 2 * v36 + 2);
  *(_QWORD *)(v34 + 48) = 0LL;
  *(_QWORD *)(v34 + 56) = 7LL;
  *(_WORD *)(v34 + 32) = 0;
  sub_1800472E0(v34, 0x60uLL);
  *(_QWORD *)a2 = v20;
  *(_BYTE *)(a2 + 8) = 0;
  return a2;
}
