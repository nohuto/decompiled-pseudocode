...
__int64 __fastcall sub_18004DF90(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v5; // r13
  int v6; // ebx
  __int64 v7; // rdi
  ...
  __int64 v33; // rdx
  __int64 (__fastcall ***v34)(_QWORD, void *, __int64 *); // rdx
  __int64 v36; // rax
  _QWORD *v37; // r14
  __int64 *v38; // rdi
  __int64 v39; // rdx
  ...
  signed int v46; // eax
  signed int v47; // eax
  unsigned __int16 **v48; // [rsp+28h] [rbp-240h]
  __int64 v49; // [rsp+30h] [rbp-238h] BYREF
  __int64 (__fastcall ***v50)(_QWORD, void *, __int64 *); // [rsp+38h] [rbp-230h] BYREF
  ...
  __int64 v76[2]; // [rsp+1B0h] [rbp-B8h] BYREF
  __m128i si128; // [rsp+1C0h] [rbp-A8h]
  unsigned __int16 *v78; // [rsp+1D0h] [rbp-98h] BYREF
  ...
  v51 = 0LL;
  v52 = 0LL;
  if ( (*(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)a3 + 32LL))(a3, &v52) >= 0 )
  {
    if ( v52 )
    {
      v51 = 0LL;
      if ( (*(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)a3 + 24LL))(a3, &v51) >= 0 )
      {
        if ( v52 )
        {
          Context = 0LL;
          ...
          if ( *(_DWORD *)v5 > 4u )
          {
            ...
            v82 = 62;
            v83 = 1;
            v54 = (unsigned int)&unk_18016D102 - (unsigned int)&unk_180165C78;
            v48 = &v78;
  ...
  v49 = 0LL;
  v50 = 0LL;
  v11 = (*(__int64 (__fastcall **)(__int64, __int64 (__fastcall ****)(_QWORD, void *, __int64 *)))(*(_QWORD *)a2 + 80LL))(
          a2,
          &v50);
  v12 = v11;
  if ( v11 < 0 )
  {
    sub_18004BD84((int)retaddr, 1618, (int)"avcore\\audiocore\\server\\audiosrv\\dll\\audioresourcemanager.cpp", v11);
    sub_1800461B8((__int64 *)&v50);
    sub_18000F708(&v49);
    sub_18000F708(&v51);
    sub_18000F708(&v52);
    return v12;
  ...
  v49 = 0LL;
  ((void (__fastcall *)(__int64 (__fastcall ***)(_QWORD, void *, __int64 *), __int64 *))(*v50)[24])(v50, &v49);
  v55 = 0LL;
  (**(void (__fastcall ***)(__int64, void *, __int64 *))a2)(a2, &unk_18015B820, &v55);
  if ( v49 )
  {
...
LABEL_21:
  if ( v55 )
    ...
    v15 = 0;
  v53 = v15;
  v16 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)a2 + 32LL))(a2, a3);
  v54 = v16;
  v17 = v49;
  if ( v49 )
  {
...
LABEL_29:
  if ( v13 && !v18 || v14 && v19 )
  {
    v36 = ((__int64 (__fastcall *)(__int64 (__fastcall ***)(_QWORD, void *, __int64 *)))(*v50)[16])(v50);
    sub_180060060(v76, v36);
    v37 = v61;
    sub_1800EA1F4(v61 + 6, &v74, v76);
    v38 = (__int64 *)(v74 + 64);
    v39 = si128.m128i_i64[1];
    if ( si128.m128i_i64[1] >= 8uLL )
      sub_1800472E0(v76[0], 2 * si128.m128i_i64[1] + 2);
    si128 = _mm_load_si128((const __m128i *)&xmmword_180178FC0);
    LOWORD(v76[0]) = 0;
    v40 = *v38;
    *v38 = 0LL;
    if ( v40 )
      sub_1800EA8B0(v40, v39);
    v62 = ((__int64 (__fastcall *)(__int64 (__fastcall ***)(_QWORD, void *, __int64 *)))(*v50)[16])(v50);
    sub_1800E3140(&v64, &v62);
    v61 = v75;
    v41 = v65;
    if ( v65 )
    {
    ...
    v75[3] = v41;
    v75[7] = v75;
    v42 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)qword_18019E678 + 120LL))(qword_18019E678);
    v43 = sub_180052E04(v42, 10000LL, 0LL, v75, v38, v48);
    if ( v43 < 0 )
      sub_18006D26C(
        retaddr,
        1651LL,
  ...
  {
    v60 = 0LL;
    if ( (int)sub_1800274A0(v50, &v60) < 0 )
    {
LABEL_66:
      if ( v60 )
...
LABEL_60:
    ...
    if ( v26 )
    {
      ...
      *v26 = v29 + 2;
      ...
      if ( v24 < 0 )
        goto LABEL_58;
      ThreadpoolWork = CreateThreadpoolWork((PTP_WORK_CALLBACK)pfnwk, v26, (PTP_CALLBACK_ENVIRON)(v23 + 8));
      if ( ThreadpoolWork )
      {
        v24 = 0;
      }
...
LABEL_69:
  ...
  {
    v50 = 0LL;
    ((void (__fastcall *)(__int64 (__fastcall ***)(_QWORD, void *, __int64 *)))(*v34)[2])(v34);
    v17 = v49;
  }
  if ( v17 )
