...
__int64 __fastcall sub_180031C90(__int64 a1, __int64 a2, char a3, int a4, __int64 a5, int a6)
{
  bool v9; // al
  ...
  v19 = a1;
  *(_DWORD *)(a1 + 40) = 1;
  *(_QWORD *)a1 = off_18014A130;
  *(_QWORD *)(a1 + 8) = off_180147E00;
  *(_QWORD *)(a1 + 16) = off_180147DA8;
  *(_QWORD *)(a1 + 24) = off_180147D78;
  *(_QWORD *)(a1 + 32) = off_18014A108;
  *(_DWORD *)(a1 + 48) = 1;
  *(_BYTE *)(a1 + 52) = a3;
  *(_BYTE *)(a1 + 53) = a4 & 1;
  ...
  *(_DWORD *)(a1 + 416) = 0;
  do
  {
    v10 = _InterlockedExchangeAdd64(&qword_18019E858, 1uLL);
    *(_QWORD *)(a1 + 328) = v10 + 1;
  }
  while ( v10 == -1 );
  Context = 0LL;
  ...
  if ( *(_DWORD *)v11 > 4u )
  {
    ...
    v29 = 66;
    v30 = 1;
    LODWORD(v19) = (unsigned int)&unk_18016D102 - (unsigned int)&unk_180165C78;
