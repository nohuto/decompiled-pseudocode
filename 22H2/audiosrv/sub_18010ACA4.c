/*
 * XREFs of sub_18010ACA4 @ 0x18010ACA4
 * Callers:
 *     sub_18010AE90 @ 0x18010AE90 (sub_18010AE90.c)
 * Callees:
 *     __security_check_cookie @ 0x180069A70 (__security_check_cookie.c)
 *     sub_180109634 @ 0x180109634 (sub_180109634.c)
 */

ULONG __fastcall sub_18010ACA4(
        __int64 a1,
        unsigned __int8 *a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a14)
{
  ...
  v20 = 16LL;
  v18 = 8LL;
  return sub_180109634((__int64)&CallbackContext, a2, 0LL, 0LL, 0xCu, &v16);
}
