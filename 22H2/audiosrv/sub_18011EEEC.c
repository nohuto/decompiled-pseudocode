/*
 * XREFs of sub_18011EEEC @ 0x18011EEEC
 * Callers:
...
__int64 __fastcall sub_18011EEEC(__int64 a1, unsigned int *a2, _QWORD *a3)
{
  __int64 v3; // r15
  unsigned int v4; // ebp
  int v5; // edi
  ...
  if ( *(int *)(a1 + 8) > 0 )
  {
    ...
    do
    {
      ...
      {
        a1 = *(unsigned __int16 *)(**(_QWORD **)sub_18004B9B4(v7 + 16, i) + 16LL);
        v4 += a1 + 38;
      }
      ++v5;
      v6 += 8LL;
