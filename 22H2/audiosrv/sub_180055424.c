/*
 * XREFs of sub_180055424 @ 0x180055424
 * Callers:
...
__int64 __fastcall sub_180055424(__int64 a1, __int64 a2, _QWORD *a3)
{
  int v4; // eax
  unsigned int v5; // ebx
  ...
  if ( a3 )
  {
    *a3 = 0LL;
    ...
    {
      v5 = (**(__int64 (__fastcall ***)(__int64, void *, _QWORD *))(v7 + 568))(v7 + 568, &unk_18015B8C0, a3);
    }
  }
  else
  {
