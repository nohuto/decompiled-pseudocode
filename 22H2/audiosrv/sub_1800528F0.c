/*
 * XREFs of sub_1800528F0 @ 0x1800528F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800528F0(__int64 *a1)
{
  __int64 *v2; // rax
  __int64 v3; // r8
  __int64 v4; // rdi
  ...
  sub_1800085F0(pv, (struct _TP_TIMER *)v2[1], v3, (struct _TP_TIMER *)L"AudioVolumeDeleteMasterVolumeNotification");
  v4 = *a1;
