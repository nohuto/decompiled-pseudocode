/*
 * XREFs of sub_1800B4610 @ 0x1800B4610
 * Callers:
...
__int64 __fastcall sub_1800B4610(__int64 a1, __int64 a2, _BYTE *a3, _QWORD *a4)
{
  ...
  if ( a1 != a2 && a3 && *a3 && (v6 = sub_1800B56D8(a3), v9 = v8 - a1, v10 = v6, v9 >= v6) )
  {
