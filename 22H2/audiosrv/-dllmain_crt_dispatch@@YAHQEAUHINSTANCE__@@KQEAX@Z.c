/*
 * XREFs of ?dllmain_crt_dispatch@@YAHQEAUHINSTANCE__@@KQEAX@Z @ 0x1800696E0
 * Callers:
 *     ?dllmain_dispatch@@YAHQEAUHINSTANCE__@@KQEAX@Z @ 0x1800698E0 (-dllmain_dispatch@@YAHQEAUHINSTANCE__@@KQEAX@Z.c)
 * Callees:
 *     sub_180069DC4 @ 0x180069DC4 (sub_180069DC4.c)
 *     __scrt_dllmain_crt_thread_detach @ 0x180069DF4 (__scrt_dllmain_crt_thread_detach.c)
 */
...
__int64 __fastcall dllmain_crt_dispatch(HINSTANCE a1, int a2, void *const a3)
{
  ...
  {
    LOBYTE(result) = sub_180069DC4(a1, v4, a3);
  }
