/*
 * XREFs of sub_180102314 @ 0x180102314
 * Callers:
...
void __fastcall sub_180102314(__int64 a1, __int64 a2)
{
  int v4; // eax
  ...
  {
    sub_1800BD8A8(*((_QWORD *)off_18019C348 + 2), 0x1Eu, (__int64)&unk_1801726D0, a1, *(_DWORD *)(a1 + 56));
  }
  if ( (unsigned int)(*(_DWORD *)(a1 + 56) - 2) <= 2 )
  {
    *(_OWORD *)pvar = 0LL;
    ...
    if ( v4 < 0 )
      goto LABEL_13;
    v4 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v9 + 40LL))(v9, &unk_180160798, pvar);
    if ( v4 < 0 )
      goto LABEL_13;
    if ( LOWORD(pvar[0]) == 31 )
      v4 = (*(__int64 (__fastcall **)(_QWORD, PROPVARIANT, _QWORD))(**(_QWORD **)(a1 + 224) + 56LL))(
             *(_QWORD *)(a1 + 224),
             pvar[1],
             0LL);
    if ( v4 < 0 )
...
LABEL_13:
      ...
      {
        sub_1800BB4E0(*((_QWORD *)off_18019C348 + 2), 0x1Fu, (__int64)&unk_1801726D0, v4);
      }
    }
