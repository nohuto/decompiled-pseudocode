/*
 * XREFs of sub_1800F8F20 @ 0x1800F8F20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800F8F20(__int64 a1)
{
  int v2; // ebx
  __int64 *v3; // rax
  __int64 v4; // r8
  ...
  sub_1800085F0(pv, (struct _TP_TIMER *)v3[1], v4, (struct _TP_TIMER *)L"s_pbmUnregisterAppManagerNotification");
  ...
  else if ( qword_18019E618 )
  {
    ...
    v2 = (*(__int64 (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)qword_18019E618 + 32LL))(
           ...
           &v9);
    if ( v2 >= 0 )
      v2 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)qword_18019E618 + 112LL))(qword_18019E618, v9);
    if ( v9 )
