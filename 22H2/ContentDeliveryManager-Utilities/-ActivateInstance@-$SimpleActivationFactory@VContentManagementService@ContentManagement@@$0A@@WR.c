/*
 * XREFs of ?ActivateInstance@?$SimpleActivationFactory@VContentManagementService@ContentManagement@@$0A@@WRL@Microsoft@@UEAAJPEAPEAUIInspectable@@@Z @ 0x180028950
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0ContentManagementService@ContentManagement@@QEAA@XZ @ 0x180029330 (--0ContentManagementService@ContentManagement@@QEAA@XZ.c)
