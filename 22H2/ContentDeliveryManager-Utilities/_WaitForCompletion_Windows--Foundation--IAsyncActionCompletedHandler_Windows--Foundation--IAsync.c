/*
 * XREFs of _WaitForCompletion_Windows::Foundation::IAsyncActionCompletedHandler_Windows::Foundation::IAsyncAction__::_2_::FTMEventDelegate::_scalar_deleting_destructor_ @ 0x18001AC40
 * Callers:
 *     <none>
 * Callees:
