/*
 * XREFs of ??$YourPhoneTaskbarIconCreated@AEAW4TaskbarPinReason@Pinning@Mobility@@@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@SAXAEAW4TaskbarPinReason@Pinning@Mobility@@@Z @ 0x1800194F8
 * Callers:
        ...
        int *a1)
{
  ...
  if ( *(_DWORD *)v2 > 5u )
  {
      ...
      && (*(_QWORD *)(v3 + 24) & 0x800000000000LL) == *(_QWORD *)(v3 + 24) )
    {
      ...
      v9 = 4;
      v8 = &v6;
      LODWORD(v2) = tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_180178789, 0LL, 0LL, 3u, &v7);
    }
  }
  return (int)v2;
}
