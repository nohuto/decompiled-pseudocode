/*
 * XREFs of _Towlower @ 0x1800B3AD0
 * Callers:
 *     ?do_tolower@?$ctype@_W@std@@MEBA_W_W@Z @ 0x18002AC40 (-do_tolower@-$ctype@_W@std@@MEBA_W_W@Z.c)
 *     ?do_tolower@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x18002AC60 (-do_tolower@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800BBC6C (_GetLocaleHandleByColl.c)
 *     __crtLCMapStringW_Stub @ 0x1800BBD50 (__crtLCMapStringW_Stub.c)
 */
