/*
 * XREFs of _FXp_addh @ 0x1800BA550
 * Callers:
 *     _FXp_addx @ 0x1800BA898 (_FXp_addx.c)
 *     _FXp_mulh @ 0x1800BA9C4 (_FXp_mulh.c)
 *     _FXp_setn @ 0x1800BACB4 (_FXp_setn.c)
 * Callees:
 *     _FDscale @ 0x1800BA380 (_FDscale.c)
 *     _Feraise @ 0x1800CE7B8 (_Feraise.c)
 *     _FDtest @ 0x1800CE7EC (_FDtest.c)
 *     _FDint @ 0x1800CE83C (_FDint.c)
