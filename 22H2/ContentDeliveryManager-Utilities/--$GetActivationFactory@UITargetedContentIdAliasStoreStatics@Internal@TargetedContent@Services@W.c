/*
 * XREFs of ??$GetActivationFactory@UITargetedContentIdAliasStoreStatics@Internal@TargetedContent@Services@Windows@@@wil@@YA?AV?$com_ptr_t@UITargetedContentIdAliasStoreStatics@Internal@TargetedContent@Services@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x18008BCB8
 * Callers:
        ...
        const WCHAR *a1)
{
  ...
  v5[3] = a1;
  v5[0] = L"Windows.Services.TargetedContent.Internal.TargetedContentIdAliasStore";
  *(_QWORD *)a1 = 0LL;
  v2 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v6, v5);
  ActivationFactory = RoGetActivationFactory(v2[1].Reserved.Reserved1, &GUID_42d1d3ce_0c01_4982_819d_07ab08924e8e, a1);
