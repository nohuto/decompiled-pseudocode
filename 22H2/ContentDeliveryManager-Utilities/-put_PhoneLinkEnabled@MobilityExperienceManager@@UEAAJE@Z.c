/*
 * XREFs of ?put_PhoneLinkEnabled@MobilityExperienceManager@@UEAAJE@Z @ 0x18009FDF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MobilityExperienceManager::put_PhoneLinkEnabled(MobilityExperienceManager *this, char a2)
{
  LSTATUS v2; // eax
  signed int v3; // ebx
