/*
 * XREFs of ?GetEntitlementForRecord@Actions@CreativeFramework@@YAXV?$com_ptr_t@UIAppManager@ContentManagement@@Uerr_exception_policy@wil@@@wil@@AEBQEB_W111_N@Z @ 0x180085394
 * Callers:
 *     ?InstallAppByStoreId@Actions@CreativeFramework@@YAXPEB_W0_N1110000@Z @ 0x180085750 (-InstallAppByStoreId@Actions@CreativeFramework@@YAXPEB_W0_N1110000@Z.c)
 *     ?InstallAppByProductAndSku@Actions@CreativeFramework@@YAXPEB_W00_N11100@Z @ 0x180085A10 (-InstallAppByProductAndSku@Actions@CreativeFramework@@YAXPEB_W00_N11100@Z.c)
 * Callees:
 ...
 *     ??$ReportEntitlementAcquisitionState@AEBQEB_WAEBQEB_WAEA_NIAEBQEB_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEBQEB_W0AEA_N$$QEAI0@Z @ 0x180086E64 (--$ReportEntitlementAcquisitionState@AEBQEB_WAEBQEB_WAEA_NIAEBQEB_W@ContentDeliveryManagerTeleme.c)
 *     __security_check_cookie @ 0x1800CF780 (__security_check_cookie.c)
 *     _Init_thread_footer @ 0x1800D0AAC (_Init_thread_footer.c)
 *     _Init_thread_header @ 0x1800D0B1C (_Init_thread_header.c)
        ...
        char a6)
{
  ...
  if ( a6 )
    goto LABEL_5;
  if ( dword_18019D610 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18019D610);
    if ( dword_18019D610 == -1 )
    {
      byte_18019D614 = CreativeFramework::Actions::IsMsaConnected(v24);
      Init_thread_footer(&dword_18019D610);
    }
  }
  if ( !byte_18019D614 )
LABEL_5:
