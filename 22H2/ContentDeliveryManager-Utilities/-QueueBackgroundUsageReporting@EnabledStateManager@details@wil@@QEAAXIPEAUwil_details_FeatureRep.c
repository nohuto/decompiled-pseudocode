/*
 * XREFs of ?QueueBackgroundUsageReporting@EnabledStateManager@details@wil@@QEAAXIPEAUwil_details_FeatureReportingCache@@@Z @ 0x18000C4F0
 * Callers:
        ...
        struct wil_details_FeatureReportingCache *a3)
{
  ...
  struct wil_details_FeatureReportingCache *v14; // [rsp+28h] [rbp-20h]
