/*
 * XREFs of __GSHandlerCheck_EH @ 0x1800CFE6C
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler3_0 @ 0x1800CF766 (__CxxFrameHandler3_0.c)
 *     __GSHandlerCheckCommon @ 0x1800CFDE4 (__GSHandlerCheckCommon.c)
 */
