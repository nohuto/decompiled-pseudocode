/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_SettingsHomeProgrammableMultiPromoCard@@@wil@@SA_NXZ @ 0x180033B60
 * Callers:
 *     <none>
 * Callees:
...
char wil::Feature<__WilFeatureTraits_Feature_SettingsHomeProgrammableMultiPromoCard>::IsEnabled()
{
  ...
  if ( (`wil::Feature<__WilFeatureTraits_Feature_SettingsHomeProgrammableMultiPromoCard>::GetImpl'::`2'::impl & 4) == 0 )
  {
  ...
  wil::details::ReportUsageToService(
    (volatile signed __int32 *)&unk_18019D160,
    0x101C1CCu,
    (v0 >> 10) & 1,
    (v0 >> 11) & 1,
    (__int64)&v2,
