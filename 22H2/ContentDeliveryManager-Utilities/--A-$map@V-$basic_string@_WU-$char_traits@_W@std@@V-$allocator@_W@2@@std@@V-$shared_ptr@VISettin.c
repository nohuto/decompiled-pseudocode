        ...
        void **a2)
{
  ...
  __int64 v5; // rcx
  __int64 v6; // rax
  void **v8; // [rsp+38h] [rbp-49h] BYREF
  __int128 v9; // [rsp+40h] [rbp-41h]
  void *v10[5]; // [rsp+50h] [rbp-31h] BYREF
  void *v11[2]; // [rsp+78h] [rbp-9h] BYREF
  __int64 v12; // [rsp+88h] [rbp+7h]
  __int64 v13; // [rsp+90h] [rbp+Fh]
  __int64 v14; // [rsp+98h] [rbp+17h]
  __int64 v15; // [rsp+A0h] [rbp+1Fh]
  ...
  v10[2] = 0LL;
  LOWORD(v10[0]) = 0;
  std::wstring::assign(v10, v4 + 4, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  v13 = 7LL;
  v12 = 0LL;
  LOWORD(v11[0]) = 0;
  std::wstring::assign(v11, a2, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  if ( CreativeFramework::CommonHelper::Details::less::operator()(v5, (__int64)v11, (const WCHAR *)v10) )
  {
LABEL_3:
    v9 = 0LL;
    v13 = 7LL;
    ...
    std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::_Insert_hint<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>> &,std::_Tree_node<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>,void *> *>(
      ...
      v6);
    v4 = v8;
    std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>::~pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>((__int64)v11);
  }
  return v4 + 8;
}
