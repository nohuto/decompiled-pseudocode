/*
 * XREFs of ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x180005FB0
 * Callers:
 *     ?Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ @ 0x180006098 (-Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ.c)
 ...
 *     ??1?$unique_any_t@V?$mutex_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@@wil@@QEAA@XZ @ 0x180017950 (--1-$unique_any_t@V-$mutex_t@V-$unique_storage@U-$resource_policy@PEAXP6AXPEAX@Z$1-CloseHandle@d.c)
 *     _wil::details::WaitForCompletion_Windows::Foundation::IAsyncOperation_Windows::Services::TargetedContent::TargetedContentSubscription_______::_2_::CompletionDelegate::_scalar_deleting_destructor_ @ 0x180023F20 (_wil--details--WaitForCompletion_Windows--Foundation--IAsyncOperation_Windows--Serv_ea_180023F20.c)
 ...
 *     ??_EActivityToastNotificationCallback@ToastNotification@@UEAAPEAXI@Z @ 0x180051150 (--_EActivityToastNotificationCallback@ToastNotification@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?_FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x180005EE0 (-_FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 */
