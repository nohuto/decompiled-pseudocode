/*
 * XREFs of ?GetSubscriptionBehavior@TargetedContent@CreativeFramework@@YA?AW4TargetedContentSubscriptionBehavior@12@PEBG@Z @ 0x18002CC70
 * Callers:
...
__int64 __fastcall CreativeFramework::TargetedContent::GetSubscriptionBehavior(__int64 a1)
{
  ...
  v7 = -2LL;
  v5 = a1;
  v8 = *(_OWORD *)&off_1800ECEF8;
  v9 = xmmword_1800ECF08;
  v10 = 3600LL;
  *(_QWORD *)&v6 = &v5;
  *((_QWORD *)&v6 + 1) = &v8;
  v12 = 0LL;
