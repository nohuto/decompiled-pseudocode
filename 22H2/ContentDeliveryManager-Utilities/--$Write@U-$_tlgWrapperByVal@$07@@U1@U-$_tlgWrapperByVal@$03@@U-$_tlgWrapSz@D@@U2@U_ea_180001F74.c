        ...
        const unsigned __int16 **a23)
{
  ...
  const WCHAR *v70; // [rsp+C0h] [rbp-40h]
  ...
  const WCHAR *v83; // [rsp+110h] [rbp+10h]
  ...
  const WCHAR *v91; // [rsp+140h] [rbp+40h]
