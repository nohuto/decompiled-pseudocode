/*
 * XREFs of ?TryGetUpgradeOfferedStateAsync@IdentityManager@ContentManagement@@UEAAJPEAPEAU?$IAsyncOperation@W4SVUpgradeOfferedState@ContentManagement@@@Foundation@Windows@@@Z @ 0x1800119F0
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180005D58 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ??0?$AsyncOperation@U?$IAsyncOperation@W4SVUpgradeOfferedState@ContentManagement@@@Foundation@Windows@@U?$IAsyncOperationCompletedHandler@W4SVUpgradeOfferedState@ContentManagement@@@23@V?$CBasicResult@W4SVUpgradeOfferedState@ContentManagement@@$0A@@Internal@3@VComTaskPoolHandler@63@UINilDelegate@63@U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@QEAA@$$QEAVComTaskPoolHandler@12@QEBGW4TrustLevel@@@Z @ 0x18002377C (--0-$AsyncOperation@U-$IAsyncOperation@W4SVUpgradeOfferedState@ContentManagement@@@Foundation@Wi.c)
...
__int64 __fastcall ContentManagement::IdentityManager::TryGetUpgradeOfferedStateAsync(__int64 a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v4[1] = v3;
    *v4 = &Windows::Internal::COperationLambdaVar<0,_lambda_353eed16ddc6ae5524b08f91443a76fa_,Windows::Internal::CBasicResult<enum ContentManagement::SVUpgradeOfferedState,0>,>::`vftable';
    *((_DWORD *)v4 + 4) = 0;
