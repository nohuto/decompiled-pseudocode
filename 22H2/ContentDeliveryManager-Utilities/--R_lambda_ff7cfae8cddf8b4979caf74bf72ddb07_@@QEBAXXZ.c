/*
 * XREFs of ??R_lambda_ff7cfae8cddf8b4979caf74bf72ddb07_@@QEBAXXZ @ 0x18004CE9C
 * Callers:
 *     ?Run@?$functor_wrapper_void@AEAV_lambda_ff7cfae8cddf8b4979caf74bf72ddb07_@@@details@wil@@UEAAJXZ @ 0x1800518F0 (-Run@-$functor_wrapper_void@AEAV_lambda_ff7cfae8cddf8b4979caf74bf72ddb07_@@@details@wil@@UEAAJXZ.c)
 * Callees:
 ...
 *     ?LaunchUriWithFallback@ActivityToastNotificationCallback@ToastNotification@@AEAAXPEAUHSTRING__@@0@Z @ 0x18004DFD0 (-LaunchUriWithFallback@ActivityToastNotificationCallback@ToastNotification@@AEAAXPEAUHSTRING__@@.c)
