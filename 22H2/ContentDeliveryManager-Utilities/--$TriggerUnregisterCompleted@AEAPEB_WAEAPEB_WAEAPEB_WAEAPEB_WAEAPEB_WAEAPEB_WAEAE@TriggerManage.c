/*
 * XREFs of ??$TriggerUnregisterCompleted@AEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAE@TriggerManagerUnregisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEAPEB_W00000AEAEPEBD@Z @ 0x18006CB88
 * Callers:
        ...
        const unsigned __int16 *a8)
{
  ...
  if ( *(_DWORD *)v12 > 5u )
  {
      ...
      && (*(_QWORD *)(v13 + 24) & 0x200000000000LL) == *(_QWORD *)(v13 + 24) )
    {
      ...
      v38 = v18;
      v40 = 0;
      LODWORD(v12) = tlgWriteTransfer_EventWriteTransfer(v13, (unsigned __int8 *)dword_18017B2B4, 0LL, 0LL, 0xAu, &v37);
    }
  }
  return (int)v12;
}
