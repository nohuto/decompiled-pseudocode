/*
 * XREFs of _Getctype @ 0x1800B3B68
 * Callers:
 ...
 *     ?_Getcat@?$ctype@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B519C (-_Getcat@-$ctype@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
