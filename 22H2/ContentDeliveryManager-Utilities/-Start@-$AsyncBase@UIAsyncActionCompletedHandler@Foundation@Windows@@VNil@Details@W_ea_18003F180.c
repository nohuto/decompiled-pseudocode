/*
 * XREFs of ?Start@?$AsyncBase@UIAsyncActionCompletedHandler@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncCausalityOptions@$1?EnableContextualSuggestionsOperationName@?A0xb8965cb7@@3QBGB$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@MEAAJXZ @ 0x18003F180
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a1)
{
  ...
  if ( v9 == -1 && (v3 = _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 48), 0, -1), v3 == v9) )
  {
      ...
      && Microsoft::WRL::gCausality )
    {
      ...
      v10 = L"ContentManagement.ContentManagementService.EnableContextualSuggestionsAsync";
