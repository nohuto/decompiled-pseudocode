/*
 * XREFs of ??R_lambda_353eed16ddc6ae5524b08f91443a76fa_@@QEBAJAEAV?$CBasicResult@W4SVUpgradeOfferedState@ContentManagement@@$0A@@Internal@Windows@@@Z @ 0x180011B68
 * Callers:
 *     ?Run@?$COperationLambdaVar@$0A@V_lambda_353eed16ddc6ae5524b08f91443a76fa_@@V?$CBasicResult@W4SVUpgradeOfferedState@ContentManagement@@$0A@@Internal@Windows@@$$V@Internal@Windows@@UEAAJW4AsyncStage@23@JAEAV?$CBasicResult@W4SVUpgradeOfferedState@ContentManagement@@$0A@@23@@Z @ 0x18001CBC0 (-Run@-$COperationLambdaVar@$0A@V_lambda_353eed16ddc6ae5524b08f91443a76fa_@@V-$CBasicResult@W4SVU.c)
 * Callees:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_UpgradeEligibilitySessionContext@@@details@wil@@QEAA_NXZ @ 0x180017A98 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_UpgradeEligibilitySessionContext@.c)
 *     ??$CoCreateInstance@VUpdateSessionOrchestrator@@UIUpdateSessionOrchestrator@@Uerr_exception_policy@wil@@@wil@@YA?AV?$com_ptr_t@UIUpdateSessionOrchestrator@@Uerr_exception_policy@wil@@@0@K@Z @ 0x18001ABC0 (--$CoCreateInstance@VUpdateSessionOrchestrator@@UIUpdateSessionOrchestrator@@Uerr_exception_poli.c)
 *     __security_check_cookie @ 0x1800CF780 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x1800D0BC0 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=9
__int64 __fastcall _lambda_353eed16ddc6ae5524b08f91443a76fa_::operator()(__int64 a1, __int64 a2)
{
  const char *v3; // r9
  int v4; // eax
