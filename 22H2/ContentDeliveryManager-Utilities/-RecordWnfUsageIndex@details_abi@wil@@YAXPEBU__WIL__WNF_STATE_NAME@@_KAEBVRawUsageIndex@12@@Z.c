/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x18000A808
 * Callers:
 *     ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x18000ACD4 (-Record@UsageIndexes@details_abi@wil@@QEAAXXZ.c)
 * Callees:
 *     ?NtStatusToHr@details@wil@@YAJJ@Z @ 0x1800048EC (-NtStatusToHr@details@wil@@YAJJ@Z.c)
 ...
 *     wil_details_NtUpdateWnfStateData @ 0x1800082B4 (wil_details_NtUpdateWnfStateData.c)
 *     ?Read@UsageIndexProperty@details_abi@wil@@QEAA_NAEAPEAEPEAE@Z @ 0x1800099F4 (-Read@UsageIndexProperty@details_abi@wil@@QEAA_NAEAPEAEPEAE@Z.c)
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  __int16 v42; // [rsp+B8h] [rbp-48h] BYREF
  ...
  v4 = a3;
  v5 = this;
  v6 = (wil::details_abi *)((char *)this + 8 * a2);
  v7 = 0LL;
  v40 = 0LL;
  while ( 1 )
  {
    ...
    *((_QWORD *)&v55 + 1) = &v40;
    ...
    v58 = &v59;
    v28[0] = (unsigned __int8 *)(*(_QWORD *)(v4 + 24) + 10LL);
    v13 = *(_BYTE *)(v4 + 4);
    v42 = *(_WORD *)(v4 + 2);
    v43 = v13;
    v44 = 0;
...
LABEL_27:
    if ( (_BYTE)v37 )
    {
      updated = wil_details_NtUpdateWnfStateData((__int64)v5, v34, (int)v35 - (int)v34, v15, (int)v24, v27, 1);
      ...
      if ( updated )
        wil_details_NtUpdateWnfStateData((__int64)v5, v34, v35 - v34, v19, v25, 0, 0);
    }
