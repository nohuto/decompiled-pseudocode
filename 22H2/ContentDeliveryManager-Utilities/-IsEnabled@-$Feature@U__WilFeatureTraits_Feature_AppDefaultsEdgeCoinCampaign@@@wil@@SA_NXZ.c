/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@wil@@SA_NXZ @ 0x180033FD0
 * Callers:
 *     <none>
 * Callees:
...
char wil::Feature<__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign>::IsEnabled()
{
  ...
  if ( (`wil::Feature<__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign>::GetImpl'::`2'::impl & 4) == 0 )
  {
  ...
  wil::details::ReportUsageToService(
    (volatile signed __int32 *)&unk_18019D1C0,
    0xD53A25u,
    (v0 >> 10) & 1,
    (v0 >> 11) & 1,
    (__int64)&v2,
