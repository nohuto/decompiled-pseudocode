/*
 * XREFs of ??1?$list@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V?$allocator@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@@std@@QEAA@XZ @ 0x18008C700
 * Callers:
 *     _CreativeFramework::NotificationManager::ToastHelpers::GetMacros_::_1_::dtor$3 @ 0x1800D8BD5 (_CreativeFramework--NotificationManager--ToastHelpers--GetMacros_--_1_--dtor$3.c)
 * Callees:
