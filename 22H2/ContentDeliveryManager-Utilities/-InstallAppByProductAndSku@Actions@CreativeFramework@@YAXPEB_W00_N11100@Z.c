/*
 * XREFs of ?InstallAppByProductAndSku@Actions@CreativeFramework@@YAXPEB_W00_N11100@Z @ 0x180085A10
 * Callers:
...
LABEL_13:
  ...
  Reserved1 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v28, v27)[1].Reserved.Reserved1;
  v16 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v29, &v23)[1].Reserved.Reserved1;
  v17 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v30, &v24);
  LOBYTE(v20) = a7;
  LOBYTE(v18) = v9;
  v19 = v14(v13, v17[1].Reserved.Reserved1, v16, v18, v20, Reserved1, 0LL);
  if ( v19 < 0 )
  {
    wil::details::in1diag3::Throw_Hr(
      retaddr,
