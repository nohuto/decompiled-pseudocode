/*
 * XREFs of ??$_Getloctxt@DV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@YAHAEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@0@0_KPEBD@Z @ 0x1800BC8E4
 * Callers:
 *     ?do_get@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x1800C59B0 (-do_get@-$time_get@GV-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@MEBA-AV-$istreambu.c)
 * Callees:
...
LABEL_31:
      ...
      if ( std::istreambuf_iterator<wchar_t>::equal((__int64)a1, a2)
        || (char)a4[v12] != *(unsigned __int16 *)std::istreambuf_iterator<unsigned short>::operator*((__int64)a1) )
      {
        goto LABEL_26;
      }
      v19 = 1;
...
LABEL_32:
      if ( ++v13 >= a3 )
      {
        if ( v19 && !std::istreambuf_iterator<wchar_t>::equal((__int64)a1, a2) )
        {
          ++v9;
