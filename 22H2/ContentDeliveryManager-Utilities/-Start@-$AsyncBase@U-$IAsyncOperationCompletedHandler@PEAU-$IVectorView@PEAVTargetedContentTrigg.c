        ...
        __int64 a1)
{
  ...
  if ( v9 == -1 && (v3 = _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 48), 0, -1), v3 == v9) )
  {
      ...
      && Microsoft::WRL::gCausality )
    {
      ...
      v10 = L"Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.Ser"
             "vices.TargetedContent.Internal.TargetedContentTriggerInternal>>";
