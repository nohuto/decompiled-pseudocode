/*
 * XREFs of ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_UpgradeEligibilitySessionContext@@@details@wil@@QEAA_NXZ @ 0x180017A98
 * Callers:
...
unsigned __int8 __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_UpgradeEligibilitySessionContext>::__private_IsEnabled(
        int *a1)
{
  unsigned int v2; // r8d
  ...
  v5 = 0;
  v6 = 2;
  wil::details::ReportUsageToService(a1 + 2, 0x1E5DFFDu, (v2 >> 10) & 1, (v2 >> 11) & 1, (__int64)&v5, v3, 3);
  return v3;
}
