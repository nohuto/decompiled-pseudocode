/*
 * XREFs of ?StartBatchInstalls@AppManager@ContentManagement@@UEAAJPEAU?$IVector@PEAVAppInstallInfoRecord@ContentManagement@@@Collections@Foundation@Windows@@PEAPEAU?$IVectorView@PEAVAppInstallInfoRecord@ContentManagement@@@456@@Z @ 0x18005AC40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ContentManagement::AppManager::StartBatchInstalls(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (`wil::Feature<__WilFeatureTraits_Feature_AppInstallBatching>::GetImpl'::`2'::impl & 4) == 0 )
  {
  ...
  wil::details::ReportUsageToService(
    (volatile signed __int32 *)&unk_18019D5C0,
    0x68C9CDu,
    (v6 >> 10) & 1,
    (v6 >> 11) & 1,
    (__int64)&v36,
