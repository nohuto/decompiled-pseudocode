/*
 * XREFs of ?Revert@AddTileToCollectionService@Actions@CreativeFramework@@UEAAXXZ @ 0x18008A280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RemoveCollectionProperties@AddTileToCollectionService@Actions@CreativeFramework@@AEAAXPEAUICuratedTileCollection@CuratedTileCollections@UnifiedTile@Shell@WindowsInternal@@@Z @ 0x18008B04C (-RemoveCollectionProperties@AddTileToCollectionService@Actions@CreativeFramework@@AEAAXPEAUICura.c)
 ...
 *     CreativeFramework::Actions::EnumerateCollectionItems__lambda_d6cc9bbba6eee700d8b52555e0ea8f6d___ @ 0x18008C088 (CreativeFramework--Actions--EnumerateCollectionItems__lambda_d6cc9bbba6eee700d8b52555e0ea8f6d___.c)
