/*
 * XREFs of ??R_lambda_202903ed4d45c4cc137b94f1aa6350ce_@@QEBAJXZ @ 0x18000F788
 * Callers:
 ...
 *     ??$?0PEBG@StringReference@Internal@Windows@@QEAA@AEBQEBGUdummy_t@_StringDetail@12@@Z @ 0x180019850 (--$-0PEBG@StringReference@Internal@Windows@@QEAA@AEBQEBGUdummy_t@_StringDetail@12@@Z.c)
 *     __security_check_cookie @ 0x1800CF780 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x1800D0BC0 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=6
__int64 __fastcall _lambda_202903ed4d45c4cc137b94f1aa6350ce_::operator()(__int64 a1)
{
  int v2; // ebx
  int v3; // eax
  PCWSTR v4; // rcx
  ...
  const WCHAR *v9; // rbx
  __int64 (__fastcall *v10)(const WCHAR *, _QWORD, _QWORD *); // rdi
  _QWORD *v11; // rax
  int v12; // eax
  HSTRING v13; // rbx
  __int64 v14; // rcx
  ...
  WCHAR *v24; // [rsp+40h] [rbp-11h] BYREF
  __int64 v25; // [rsp+48h] [rbp-9h] BYREF
  const WCHAR *v26; // [rsp+50h] [rbp-1h] BYREF
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( v2 >= 0 )
    {
      ...
      ActivationFactory = RoGetActivationFactory(v6, &GUID_44a9796f_723e_4fdf_a218_033e75b0c084, &v26);
      v2 = ActivationFactory;
      if ( ActivationFactory >= 0 )
      {
        v28[0] = 0LL;
        v9 = v26;
        v10 = *(__int64 (__fastcall **)(const WCHAR *, _QWORD, _QWORD *))(*(_QWORD *)v26 + 48LL);
        ...
        if ( v12 >= 0 )
        {
          ...
          {
            v27 = 0LL;
            v16 = (*(__int64 (__fastcall **)(__int64, _QWORD, WCHAR *, __int64 *))(*(_QWORD *)v25 + 72LL))(
                    v25,
                    v28[0],
                    v24,
                    &v27);
...
LABEL_45:
  ...
  {
    v24 = 0LL;
    (*(void (__fastcall **)(WCHAR *, _QWORD))(*(_QWORD *)v21 + 16LL))(v21, *(_QWORD *)v21);
  }
  return (unsigned int)v2;
}
