 ...
 *     ?_AfterExecute@?$AsyncOperation@U?$IAsyncOperation@W4SVUpgradeOfferedState@ContentManagement@@@Foundation@Windows@@U?$IAsyncOperationCompletedHandler@W4SVUpgradeOfferedState@ContentManagement@@@23@V?$CBasicResult@W4SVUpgradeOfferedState@ContentManagement@@$0A@@Internal@3@VComTaskPoolHandler@63@UINilDelegate@63@U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@AEAAXJ@Z @ 0x180022E4C (-_AfterExecute@-$AsyncOperation@U-$IAsyncOperation@W4SVUpgradeOfferedState@ContentManagement@@@F.c)
        ...
        __int64 a1)
{
  ...
  *(_DWORD *)(a1 + 312) = CurrentThreadId;
  v2 = SHTaskPoolQueueTask(v7, v6, CurrentThreadId, 0LL, (a1 + 192) & -(__int64)(a1 != 8), 0LL);
  if ( v2 < 0 )
  {
    if ( *(_DWORD *)(a1 + 240) )
    {
    ...
    else
    {
      if ( _InterlockedIncrement((volatile signed __int32 *)(v4 + 248)) != 1 )
        goto LABEL_12;
      v8 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, __int64))(**(_QWORD **)(v4 + 256) + 8LL))(
             *(_QWORD *)(v4 + 256),
             1LL,
             (unsigned int)v2,
             v4 + 280);
      if ( v8 >= 0 && *(_BYTE *)(v4 + 289) )
      {
        if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v4 + 272), 0xFFFFFFFF) != 1 )
          goto LABEL_12;
        v9 = *(unsigned int *)(v4 + 276);
      }
      else
      {
        v9 = (unsigned int)v8;
