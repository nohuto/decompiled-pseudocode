/*
 * XREFs of ??$use_facet@V?$messages@_W@std@@@std@@YAAEBV?$messages@_W@0@AEBVlocale@0@@Z @ 0x1800BD41C
 * Callers:
 ...
 *     ?_Getcat@?$messages@_W@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800BF634 (-_Getcat@-$messages@_W@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
