/*
 * XREFs of ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x18000ACD4
 * Callers:
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x18000B040 (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  if ( *((_BYTE *)this + 56) )
  {
    ...
    wil::details_abi::RecordWnfUsageIndex((wil::details_abi *)&v5, 3LL, (__int64)this, a4);
  }
  if ( *((_BYTE *)this + 120) )
  {
    ...
    wil::details_abi::RecordWnfUsageIndex((wil::details_abi *)&v5, 3LL, (__int64)this + 64, a4);
  }
  if ( *((_BYTE *)this + 184) )
  {
    ...
    wil::details_abi::RecordWnfUsageIndex((wil::details_abi *)&v5, 6LL, (__int64)this + 128, a4);
  }
}
