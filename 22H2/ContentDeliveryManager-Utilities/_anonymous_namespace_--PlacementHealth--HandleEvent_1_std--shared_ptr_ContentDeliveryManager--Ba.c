/*
 * XREFs of _anonymous_namespace_::PlacementHealth::HandleEvent_1_std::shared_ptr_ContentDeliveryManager::Background::CorrelationVectorWrapper___ @ 0x18003D488
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::StartsWith @ 0x18002EB24 (_anonymous_namespace_--StartsWith.c)
        ...
        __int64 *a2)
{
  ...
  _QWORD v10[4]; // [rsp+38h] [rbp-49h] BYREF
  __int64 v11; // [rsp+58h] [rbp-29h] BYREF
  __int64 v12; // [rsp+68h] [rbp-19h] BYREF
  _QWORD v13[2]; // [rsp+78h] [rbp-9h] BYREF
  ...
  else if ( anonymous_namespace_::StartsWith(Src) )
  {
    ...
    if ( *(_WORD *)Src )
    {
      ...
      do
        ++v8;
      while ( *(_WORD *)&Src[2 * v8] );
    }
    else
    {
      v8 = 0LL;
    }
    std::wstring::assign(v14, Src, v8);
