/*
 * XREFs of _lambda_4da519507bbb1c7cbbe275d8da092dac_::operator() @ 0x1800B071C
 * Callers:
 ...
 *     ??$RegisterBackgroundTaskWithWnfTrigger@PEB_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEB_WPEBD@Z @ 0x1800B15E4 (--$RegisterBackgroundTaskWithWnfTrigger@PEB_W@ContentDeliveryManagerTelemetry@Background@Content.c)
