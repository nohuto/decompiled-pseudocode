/*
 * XREFs of wil::details::_dynamic_atexit_destructor_for__g_processLocalData__ @ 0x1800DABF0
 * Callers:
 *     <none>
 * Callees:
...
{
  if ( qword_18019B588 )
    wil::details_abi::ProcessLocalStorageData<wil::details_abi::ProcessLocalData>::Release((char *)qword_18019B588);
}
