/*
 * XREFs of ??$ReportLaunchStatus@_N_NPEBG@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@SAX$$QEA_N0$$QEAPEBG@Z @ 0x1800507D8
 * Callers:
        ...
        const WCHAR **a3)
{
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
      ...
      && (*(_QWORD *)(v7 + 24) & 0x400000000000LL) == *(_QWORD *)(v7 + 24) )
    {
      ...
      v18 = 1LL;
      v16 = 1LL;
      LODWORD(v6) = tlgWriteTransfer_EventWriteTransfer(v7, (unsigned __int8 *)dword_18017A3E8, 0LL, 0LL, 5u, &v14);
    }
  }
  return (int)v6;
}
