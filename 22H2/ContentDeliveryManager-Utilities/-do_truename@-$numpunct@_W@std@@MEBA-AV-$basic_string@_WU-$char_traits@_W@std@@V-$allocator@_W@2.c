/*
 * XREFs of ?do_truename@?$numpunct@_W@std@@MEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@XZ @ 0x1800977C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::numpunct<wchar_t>::do_truename(__int64 a1, __int64 a2)
{
