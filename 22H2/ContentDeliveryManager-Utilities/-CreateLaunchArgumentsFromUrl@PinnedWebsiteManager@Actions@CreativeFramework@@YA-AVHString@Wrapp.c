/*
 * XREFs of ?CreateLaunchArgumentsFromUrl@PinnedWebsiteManager@Actions@CreativeFramework@@YA?AVHString@Wrappers@WRL@Microsoft@@PEB_W@Z @ 0x18009B8F8
 * Callers:
        ...
        const WCHAR *a2)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  v4 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v9, (const WCHAR **)off_1800FD5E0);
