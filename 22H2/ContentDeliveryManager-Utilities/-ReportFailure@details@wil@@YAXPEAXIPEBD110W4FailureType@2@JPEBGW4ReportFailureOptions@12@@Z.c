/*
 * XREFs of ?ReportFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@JPEBGW4ReportFailureOptions@12@@Z @ 0x1800056A0
 * Callers:
 ...
 * Callees:
 *     ?RethrowCaughtException@wil@@YAXXZ @ 0x18000503C (-RethrowCaughtException@wil@@YAXXZ.c)
 *     ?ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z @ 0x180005060 (-ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z.c)
