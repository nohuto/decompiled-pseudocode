/*
 * XREFs of _lambda_c3bf47982beeb92429b0310f4e2c5f50_::operator() @ 0x1800550E0
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_c3bf47982beeb92429b0310f4e2c5f50__Windows::Internal::CNoResult_::Run @ 0x180056B80 (Windows--Internal--COperationLambdaVar_0__lambda_c3bf47982beeb92429b0310f4e2c5f50__Windows--Inte.c)
 * Callees:
 ...
 *     ??1?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAA@XZ @ 0x1800438FC (--1-$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAA.c)
 ...
 *     ?StartActivity@ActionCommittedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBG00@Z @ 0x180053034 (-StartActivity@ActionCommittedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliver.c)
...
__int64 __fastcall lambda_c3bf47982beeb92429b0310f4e2c5f50_::operator()(__int64 *a1)
{
  __int64 v2; // rbx
  __int64 v3; // rax
  ...
  v36 = 0LL;
  v37 = 0LL;
  v23[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionCommittedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionCommittedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionCommittedActivity *)v23,
    v10,
    v7,
    v4);
  if ( v16 >= 8 )
