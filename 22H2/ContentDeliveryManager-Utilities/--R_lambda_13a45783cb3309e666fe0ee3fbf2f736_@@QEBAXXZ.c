/*
 * XREFs of ??R_lambda_13a45783cb3309e666fe0ee3fbf2f736_@@QEBAXXZ @ 0x18000E454
 * Callers:
 *     ?Run@?$functor_wrapper_void@AEAV_lambda_13a45783cb3309e666fe0ee3fbf2f736_@@@details@wil@@UEAAJXZ @ 0x18001F620 (-Run@-$functor_wrapper_void@AEAV_lambda_13a45783cb3309e666fe0ee3fbf2f736_@@@details@wil@@UEAAJXZ.c)
 * Callees:
 ...
 *     ?IsInRestrictedRegion@Pinning@Mobility@@YA_NXZ @ 0x18000E07C (-IsInRestrictedRegion@Pinning@Mobility@@YA_NXZ.c)
 *     ?IsSystemProductValidForTaskbarIcon@Pinning@Mobility@@YA_NXZ @ 0x18000E260 (-IsSystemProductValidForTaskbarIcon@Pinning@Mobility@@YA_NXZ.c)
...
LABEL_47:
      ...
      if ( v31[0] )
      {
        ...
        {
          v15 = string;
          v16 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(v38, off_1800ECEE0);
          LOBYTE(ppv) = 1;
          LOBYTE(v17) = 1;
            ...
            && (*((_QWORD *)v25 + 3) & 0x400000000000LL) == *((_QWORD *)v25 + 3) )
          {
            ...
            *(_QWORD *)pdwValue = L"Microsoft.YourPhone_8wekyb3d8bbwe!App";
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<unsigned short>,_tlgWrapperByVal<8>>(
              (__int64)v25,
              (unsigned __int8 *)dword_1801788FC,
              v26,
              v27,
