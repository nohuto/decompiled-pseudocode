/*
 * XREFs of ??1LaunchUriActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAA@XZ @ 0x18002BD38
 * Callers:
 *     _ContentManagement::ContentManagementService::ProcessCreativeEvent_::_1_::dtor$1 @ 0x1800D20D8 (_ContentManagement--ContentManagementService--ProcessCreativeEvent_--_1_--dtor$1.c)
 * Callees:
