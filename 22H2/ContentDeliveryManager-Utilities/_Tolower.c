/*
 * XREFs of _Tolower @ 0x1800B3C30
 * Callers:
 *     ?do_tolower@?$ctype@D@std@@MEBADD@Z @ 0x1800B98C0 (-do_tolower@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_tolower@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x1800B98E0 (-do_tolower@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
