/*
 * XREFs of SmpPagefileInitialize @ 0x140008088
 * Callers:
 *     SmpAsyncMemoryConfiguration @ 0x14000A1C0 (SmpAsyncMemoryConfiguration.c)
 * Callees:
 *     SmpQueryFilterPagesDumpSetting @ 0x140008280 (SmpQueryFilterPagesDumpSetting.c)
 *     SmpQueryCrashDumpType @ 0x1400082D0 (SmpQueryCrashDumpType.c)
 ...
 *     SmpQueryCopyDumpSetting @ 0x14000ECE0 (SmpQueryCopyDumpSetting.c)
...
NTSTATUS SmpPagefileInitialize()
{
  ...
  qword_140028E78 = (__int64)&SmpPagingFileDescriptorList;
  SmpPagingFileDescriptorList = &SmpPagingFileDescriptorList;
  qword_140028E58 = (__int64)&SmpVolumeDescriptorList;
