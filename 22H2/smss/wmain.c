 ...
 *     WppInitUm @ 0x140001E9C (WppInitUm.c)
  ...
  if ( a1 <= 1 )
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      if ( v16 >= 0 )
      {
        ...
        xmmword_1400285E8 = 0LL;
        qword_1400285F8 = 0LL;
        xmmword_140028600 = 0LL;
        qword_140028610 = 0LL;
        dword_140028618 = 0;
        dword_14002861C = 1;
        dword_140028620 = 72;
        *(_QWORD *)&xmmword_1400285E8 = *((_QWORD *)&v36 + 1);
        v17 = SmpInit();
