/*
 * XREFs of SmpSavePageFile @ 0x1400161E4
 * Callers:
 *     SmpCheckForCrashDump @ 0x14000A4B8 (SmpCheckForCrashDump.c)
 *     SmpSaveOldPageFile @ 0x140016014 (SmpSaveOldPageFile.c)
 * Callees:
 *     RtlStringCbCopyW @ 0x14000D940 (RtlStringCbCopyW.c)
 ...
 *     SmpSetEndOfFile @ 0x1400165B0 (SmpSetEndOfFile.c)
 */
