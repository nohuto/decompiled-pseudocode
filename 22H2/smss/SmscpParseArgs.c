/*
 * XREFs of SmscpParseArgs @ 0x140005388
 * Callers:
 *     SmscMain @ 0x140003F5C (SmscMain.c)
 * Callees:
 *     SmpGetFirstSessionId @ 0x140005640 (SmpGetFirstSessionId.c)
 *     SmscpSetupSharedSpace @ 0x140005674 (SmscpSetupSharedSpace.c)
 *     SmscpIsDebuggerPresent @ 0x140018780 (SmscpIsDebuggerPresent.c)
 */
...
LABEL_16:
              ...
              && (SystemInformation[0] & 0x4000004) != 0 )
            {
              ...
              {
                RtlAppendUnicodeStringToString(a4, &stru_140019D00);
                v32 = SystemInformation[0];
                if ( (SystemInformation[0] & 0x20000) != 0 )
                {
                  RtlAppendUnicodeStringToString(a4, &stru_140019CF0);
                  v32 = SystemInformation[0];
                }
                if ( (v32 & 0x4000000) != 0 )
                  RtlAppendUnicodeStringToString(a4, &stru_140019CE0);
              }
            }
LABEL_17:
            v20 = v4;
