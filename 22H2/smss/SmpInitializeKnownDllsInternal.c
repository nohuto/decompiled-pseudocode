/*
 * XREFs of SmpInitializeKnownDllsInternal @ 0x140008770
 * Callers:
 *     SmpInitializeKnownDlls @ 0x140008450 (SmpInitializeKnownDlls.c)
 * Callees:
 *     SmpRandomizeDllList @ 0x140008EE0 (SmpRandomizeDllList.c)
...
LABEL_55:
      ...
      if ( *((PVOID **)v32 + 1) != &v32
        || *v33 != &v32
        || (*v33 = v32, v22[1] = v23, v24 = qword_140028B28, *((PVOID **)SmpKnownDllsList + 1) != &SmpKnownDllsList)
        || *(PVOID **)qword_140028B28 != &SmpKnownDllsList
        || *(_QWORD **)(*v22 + 8LL) != v22
        || *v23 != v22 )
      {
LABEL_71:
      ...
      *(_QWORD *)qword_140028B28 = v22;
      qword_140028B28 = v22[1];
