/*
 * XREFs of SmpComputeDesiredPfSizeForCrashDump @ 0x140014730
 * Callers:
...
LABEL_18:
      ...
      {
        v0 = 0x40000000LL;
        v3 = (unsigned int)~(dword_140028BA8 - 1) & (((SmpHighestPhysicalAddress
                                                     / (unsigned __int64)(unsigned int)dword_140028BA8
                                                     + 7) >> 3)
                                                   + (unsigned int)(dword_140028BA8 - 1)
                                                   + 8256LL);
