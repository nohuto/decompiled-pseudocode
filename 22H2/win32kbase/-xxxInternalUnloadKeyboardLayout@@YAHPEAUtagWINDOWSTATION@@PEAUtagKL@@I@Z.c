/*
 * XREFs of ?xxxInternalUnloadKeyboardLayout@@YAHPEAUtagWINDOWSTATION@@PEAUtagKL@@I@Z @ 0x1C00090AC
 * Callers:
 ...
 *     xxxUnloadKeyboardLayout @ 0x1C01AB0F0 (xxxUnloadKeyboardLayout.c)
 * Callees:
 ...
 *     ?LockKbdLayoutListHead@@YAPEAUtagKL@@PEAUtagWINDOWSTATION@@PEAU1@@Z @ 0x1C000BCE4 (-LockKbdLayoutListHead@@YAPEAUtagKL@@PEAUtagWINDOWSTATION@@PEAU1@@Z.c)
...
__int64 __fastcall xxxInternalUnloadKeyboardLayout(struct tagWINDOWSTATION *a1, struct tagKL *a2, int a3)
{
  ...
  *((_DWORD *)a2 + 8) |= 0x20000000u;
  ...
  ThreadUnlock1();
  if ( qword_1C0256128 )
    qword_1C0256128(0x80000000LL, 0LL, 0LL, 0LL, 0);
