/*
 * XREFs of VideoPortCallout @ 0x1C011A560
 * Callers:
 *     Win32kBaseVideoPortCallout @ 0x1C011BA10 (Win32kBaseVideoPortCallout.c)
 * Callees:
 ...
 *     CSTRemove @ 0x1C011DAB0 (CSTRemove.c)
 */
              ...
              && (*(_DWORD *)(v70 + 48) || *(int *)(v70 + 24) > 0) )
            {
              ...
              *(GUID *)(v70 + 28) = v72;
              if ( (unsigned int)dword_1C024AA90 > 6 )
              {
                ...
                if ( v40 > 6 && tlgKeywordOn((__int64)&dword_1C024AA90, 0x2000LL) )
                {
                  LODWORD(v61) = v71;
                  v90 = 4LL;
                  v89 = &v61;
