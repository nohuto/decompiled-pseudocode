/*
 * XREFs of SynthesizeTouchInputContainer @ 0x1C01B3B90
 * Callers:
 *     ?OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ @ 0x1C01AA1F0 (-OnTouchSynthesizeNotification@CHidInput@@EEAAJXZ.c)
 * Callees:
