/*
 * XREFs of ?CitpContextTrackingDataStart@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C00B65E0
 * Callers:
...
__int64 __fastcall CitpContextTrackingDataStart(struct _CIT_IMPACT_CONTEXT *a1, const char *a2)
{
  ...
  if ( !*((_BYTE *)&qword_1C0293D24 + 5) )
    return v2;
  v5 = 96LL * (unsigned int)xmmword_1C0293D14;
  if ( v5 > 0xFFFFFFFF )
  {
    v29 = -1073741675;
    v30 = 336;
...
LABEL_28:
  v15 = (unsigned int)xmmword_1C0293D14;
  a2 = 0LL;
  if ( (_DWORD)xmmword_1C0293D14 )
  {
    v16 = (char *)a1 + 8;
    do
    {
    ...
    while ( (unsigned int)a2 < (unsigned int)xmmword_1C0293D14 );
  }
  *((_DWORD *)a1 + 14) = v15;
