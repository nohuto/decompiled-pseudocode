/*
 * XREFs of ?IVSerializeRimDevForIVPnpCreatePacket@@YAJPEAURIMDEV@@AEBU_UNICODE_STRING@@AEAUCIVSerializer@@@Z @ 0x1C01B5BD0
 * Callers:
 ...
 *     ?Serialize@CIVSerializer@@QEAAJAEAU_IV_KEYBOARD_DEVICE_INFO@@AEAUtagKEYBOARD_DEVICE_INFO@@_N@Z @ 0x1C01B6F40 (-Serialize@CIVSerializer@@QEAAJAEAU_IV_KEYBOARD_DEVICE_INFO@@AEAUtagKEYBOARD_DEVICE_INFO@@_N@Z.c)
