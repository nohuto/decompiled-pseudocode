/*
 * XREFs of ?SendFrameToContainer@Pointer@InputTraceLogging@@SAXQEAURIMDEV@@PEBUCPointerInputFrame@@@Z @ 0x1C01BB268
 * Callers:
    ...
    if ( (unsigned int)(v2 - 5) > 1 )
    {
      if ( v2 == 7 )
      {
        if ( (unsigned int)dword_1C024AA90 <= 4 || !tlgKeywordOn((__int64)&dword_1C024AA90, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C021F67C;
      }
      else
      {
        if ( (unsigned int)dword_1C024AA90 <= 4 || !tlgKeywordOn((__int64)&dword_1C024AA90, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C021F7B0;
      }
    }
    else
    {
      if ( (unsigned int)dword_1C024AA90 <= 4 || !tlgKeywordOn((__int64)&dword_1C024AA90, 32LL) )
        return;
      v7 = (unsigned __int8 *)&unk_1C021F6E2;
    }
    v10 = *(_DWORD *)(v5 + 48);
    v11 = *(_DWORD *)(v5 + 40);
    v12 = *(_QWORD *)(v5 + 72);
