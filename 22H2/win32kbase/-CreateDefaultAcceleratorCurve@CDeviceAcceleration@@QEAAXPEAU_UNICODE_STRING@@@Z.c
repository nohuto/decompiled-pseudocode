/*
 * XREFs of ?CreateDefaultAcceleratorCurve@CDeviceAcceleration@@QEAAXPEAU_UNICODE_STRING@@@Z @ 0x1C000F254
 * Callers:
 *     ReadDefaultAccelerationCurves @ 0x1C000E6D0 (ReadDefaultAccelerationCurves.c)
 * Callees:
        ...
        struct _UNICODE_STRING *a2)
{
  ...
  else
  {
    if ( *((_BYTE *)this + 8) )
      goto LABEL_6;
    *((_OWORD *)this + 1) = xmmword_1C024E9E8;
    *((_OWORD *)this + 2) = xmmword_1C024E9F8;
    *((_QWORD *)this + 6) = qword_1C024EA08;
    *(_OWORD *)((char *)this + 56) = xmmword_1C024EA10;
    *(_OWORD *)((char *)this + 72) = xmmword_1C024EA20;
    v10 = qword_1C024EA30;
  }
  *((_QWORD *)this + 11) = v10;
LABEL_6:
