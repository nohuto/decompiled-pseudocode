/*
 * XREFs of ?EmitCreationCommand@?$CSharedResourceMarshaler@VCMatrixTransform3DMarshaler@DirectComposition@@$01@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1C020E100
 * Callers:
 *     <none>
 * Callees:
