/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapperByVal@$00@@U?$_tlgWrapperByRef@$0BA@@@U2@U3@U3@U?$_tlgWrapperByVal@$03@@U?$_tlgWrapperByVal@$01@@U5@U5@U5@U2@U5@U2@U4@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapperByVal@$00@@AEBU?$_tlgWrapperByRef@$0BA@@@455AEBU?$_tlgWrapperByVal@$03@@AEBU?$_tlgWrapperByVal@$01@@77747463@Z @ 0x1C009012C
 * Callers:
        ...
        __int64 a20)
{
  ...
  v27 = 1LL;
  v25 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0249250, a2, 0, 0, 0x12u, &v23);
}
