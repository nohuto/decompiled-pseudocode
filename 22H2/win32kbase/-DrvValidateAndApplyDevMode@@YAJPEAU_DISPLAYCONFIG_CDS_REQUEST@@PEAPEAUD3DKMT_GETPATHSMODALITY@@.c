/*
 * XREFs of ?DrvValidateAndApplyDevMode@@YAJPEAU_DISPLAYCONFIG_CDS_REQUEST@@PEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C001761C
 * Callers:
        ...
        struct D3DKMT_GETPATHSMODALITY **a2)
{
  ...
  v39 = -2;
  v40 = -2;
  v6 = ((__int64 (__fastcall *)(int *))qword_1C0250950)(&v35);
  v9 = v6;
...
LABEL_15:
  ...
  v42 = v21;
  if ( v22 || *((_DWORD *)a1 + 6) )
    v23 = ((__int64 (__fastcall *)(struct D3DKMT_GETPATHSMODALITY **, int *))qword_1C0250AF0)(a2, &v35);
  else
    v23 = ((__int64 (__fastcall *)(int *))qword_1C0250950)(&v35);
  v26 = v23;
  if ( v23 >= 0 )
    return 0LL;
  *((_DWORD *)a1 + 12) = -1;
