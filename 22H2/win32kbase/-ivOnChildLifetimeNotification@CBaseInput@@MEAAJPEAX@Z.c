/*
 * XREFs of ?ivOnChildLifetimeNotification@CBaseInput@@MEAAJPEAX@Z @ 0x1C01B9620
 * Callers:
 *     <none>
 * Callees:
 ...
 *     UserSleep @ 0x1C00AFD20 (UserSleep.c)
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v77 && (*(_DWORD *)(v77 + 48) || *(int *)(v77 + 24) > 0) )
    {
      ...
      *(GUID *)(v77 + 28) = v79;
      if ( (unsigned int)dword_1C024AA90 > 6 )
      {
        ...
        if ( v48 > 6 && tlgKeywordOn((__int64)&dword_1C024AA90, 0x2000LL) )
        {
          LODWORD(v74) = v78;
          v94 = 4LL;
          v93 = &v74;
