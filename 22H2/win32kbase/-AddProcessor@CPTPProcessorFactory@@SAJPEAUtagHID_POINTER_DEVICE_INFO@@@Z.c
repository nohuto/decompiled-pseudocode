/*
 * XREFs of ?AddProcessor@CPTPProcessorFactory@@SAJPEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01DE204
 * Callers:
...
__int64 __fastcall CPTPProcessorFactory::AddProcessor(struct tagHID_POINTER_DEVICE_INFO *a1)
{
  ...
  {
    Pool2 = ExAllocatePool2(260LL, 2504LL, 1919964227LL);
    if ( Pool2 )
  ...
  if ( v3 != 1 )
  {
    if ( v3 == 2 )
    {
      ...
      Pool2 = ExAllocatePool2(v6, 2520LL, 1919964227LL);
      if ( Pool2 )
      {
  ...
  if ( !NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(gpLeakTrackingAllocator, 0x72705443u) )
    return 3221225495LL;
  v5 = (_QWORD *)ExAllocatePool2(v15 & 0xFFFFFFFFFFFFFFFDuLL, 2520LL, v13);
  Pool2 = (__int64)v5;
  if ( !v5
    || (_InterlockedIncrement64((volatile signed __int64 *)v1 + 14),
        *v5 = 1919964227LL,
