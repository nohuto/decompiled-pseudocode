/*
 * XREFs of ?UnregisterPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@@Z @ 0x1C0074AA0
 * Callers:
 *     ?UninitializeServerPort@ServerPorts@CoreMessagingK@@SAXPEAUServerPortInfo@2@@Z @ 0x1C00753D4 (-UninitializeServerPort@ServerPorts@CoreMessagingK@@SAXPEAUServerPortInfo@2@@Z.c)
 * Callees:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::UnregisterPort(const struct _GUID *a1)
{
  ...
  if ( (unsigned int)dword_1C0249450 > 5 )
  {
    ...
    v11 = a1;
    v12 = 16;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0249450, (int)&dword_1C022248F, 0, 0, 4u, &v10);
  }
  return v5;
}
