/*
 * XREFs of ?Accelerate@CDeviceAcceleration@@QEAAXPEAH0PEAU_SUBPIXELS@@@Z @ 0x1C006FDE8
 * Callers:
  ...
  *((_DWORD *)a4 + 1) = 0;
  if ( v9 )
  {
    ...
    if ( v19 )
    {
      ...
      if ( dword_1C0250E50 < (unsigned int)v21 )
        v22 = (*(_QWORD *)(v35 + 8LL * (unsigned int)dword_1C0250E50)
             + (*(_QWORD *)(v34 + 8LL * (unsigned int)dword_1C0250E50) << 16) / v19
             + v22) >> 1;
      dword_1C0250E50 = v21;
      v23 = qword_1C0250E58 + ((v22 * v13) >> 16);
      v24 = -v23;
      v25 = qword_1C0250E60 + ((v22 * v12) >> 16);
      if ( v23 < 0 )
      {
        v27 = v23;
