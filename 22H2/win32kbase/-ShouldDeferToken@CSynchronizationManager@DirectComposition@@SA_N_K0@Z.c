/*
 * XREFs of ?ShouldDeferToken@CSynchronizationManager@DirectComposition@@SA_N_K0@Z @ 0x1C00850D8
 * Callers:
 *     DCompositionShouldDeferToken @ 0x1C00850C0 (DCompositionShouldDeferToken.c)
 * Callees:
