/*
 * XREFs of ?Create@CSharedCompositionSpotLightMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00A5780
 * Callers:
 *     CreateSharedCompositionSpotLightMarshaler @ 0x1C00A5740 (CreateSharedCompositionSpotLightMarshaler.c)
 * Callees:
