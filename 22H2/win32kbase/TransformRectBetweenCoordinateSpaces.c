/*
 * XREFs of TransformRectBetweenCoordinateSpaces @ 0x1C0070D00
 * Callers:
 ...
 *     IsDpiAwarenessBoundaryInParentChain @ 0x1C0137584 (IsDpiAwarenessBoundaryInParentChain.c)
 */
...
LABEL_31:
  ...
  if ( a3 )
  {
    v22 = (int)Is_GetTopLevelWindowSupported(v14, a2, 1LL) >= 0 && qword_1C0256AA0 ? qword_1C0256AA0(a3) : 0LL;
    if ( v22 )
    {
      if ( v22 != a3 )
      {
