/*
 * XREFs of Feature_Servicing_GdiTelemetry_37785927__private_IsEnabledFallback @ 0x1C00CA170
 * Callers:
...
__int64 __fastcall Feature_Servicing_GdiTelemetry_37785927__private_IsEnabledFallback(__int64 a1, unsigned int a2)
{
