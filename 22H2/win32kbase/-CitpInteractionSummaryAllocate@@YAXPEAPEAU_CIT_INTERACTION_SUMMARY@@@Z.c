/*
 * XREFs of ?CitpInteractionSummaryAllocate@@YAXPEAPEAU_CIT_INTERACTION_SUMMARY@@@Z @ 0x1C00B3F7C
 * Callers:
...
void __fastcall CitpInteractionSummaryAllocate(struct _CIT_INTERACTION_SUMMARY **a1, const char *a2)
{
  ...
  v2 = (unsigned __int16)dword_1C0293D2C;
  v3 = gpLeakTrackingAllocator;
  v16 = 1231254357;
  v18 = 260LL;
  v5 = (unsigned __int16)dword_1C0293D2C;
  v13 = (unsigned __int16)dword_1C0293D2C;
  ...
  UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64 = ExAllocatePool2(
                                                                                     260LL,
                                                                                     (unsigned __int16)dword_1C0293D2C,
                                                                                     1231254357LL);
  if ( UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64 )
    _InterlockedIncrement64((volatile signed __int64 *)v3 + 14);
LABEL_4:
...
LABEL_25:
  CitpLogFailureWorker(-1073741670, a2, 0x7EFu);
}
