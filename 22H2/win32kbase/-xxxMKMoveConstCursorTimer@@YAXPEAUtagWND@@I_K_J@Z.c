/*
 * XREFs of ?xxxMKMoveConstCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01B6D00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxMKMoveConstCursorTimer(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (v4 & 3) == 0 )
  {
    if ( (v4 & 0xC) != 0 )
    {
      v5 = 4 * (unsigned __int8)byte_1C0290512[0];
      goto LABEL_7;
    }
LABEL_6:
    a1 = (unsigned __int8)byte_1C0290511;
    a2 = giMouseMoveTable % (unsigned int)(unsigned __int8)byte_1C0290511;
    v5 = (unsigned __int8)byte_1C0290512[a2];
