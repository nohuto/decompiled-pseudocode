/*
 * XREFs of ?ulDispatchGFPEFunction@XEPALOBJ@@QEAAKW4GFPE_FUNCTION_ID@@K@Z @ 0x1C0067EB0
 * Callers:
 ...
 * Callees:
 *     ?ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z @ 0x1C0067FB0 (-ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z.c)
