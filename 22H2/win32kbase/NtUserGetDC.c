/*
 * XREFs of NtUserGetDC @ 0x1C0036B40
 * Callers:
 *     <none>
 * Callees:
...
HDC __fastcall NtUserGetDC(__int64 a1)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v31 && (*(int *)(v31 + 24) > 0 || *(_DWORD *)(v43 + 48)) )
    {
      ...
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 0x2000LL, v32, v33) )
        {
          v42 = v44;
          v48 = 4LL;
          v47 = &v42;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C0217FD7, (int)&ActivityId, 0, 3u, &v46);
        }
      }
    }
  }
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v37 )
    {
      ...
      if ( (*(_DWORD *)(v40 + 44) || *(_DWORD *)(v40 + 48) || v41 > 0)
        ...
        && (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 0x2000LL, v38, v39) )
      {
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C0217F61, v40 + 28, 0, 2u, &v49);
      }
      *(_DWORD *)(v40 + 44) = 0;
      *(_OWORD *)(v40 + 28) = 0LL;
    }
