/*
 * XREFs of ?xxxDownlevelInput@CPTPProcessor@@CAJPEBUCPointerInputFrame@@AEBUtagPTP_DOWNLEVELED_INPUT@@@Z @ 0x1C01A7C5C
 * Callers:
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v45 && (*(_DWORD *)(v45 + 48) || *(int *)(v45 + 24) > 0) )
  {
    ...
    *(GUID *)(v45 + 28) = ActivityId;
    if ( (unsigned int)dword_1C024AA90 > 6 )
    {
      ...
      if ( v24 > 6 && tlgKeywordOn((__int64)&dword_1C024AA90, 0x2000LL) )
      {
        LODWORD(v42) = v46;
        v58 = 4LL;
        v57 = &v42;
