/*
 * XREFs of ?FlushMouseReports@CMouseSensor@@AEAAJXZ @ 0x1C01B22C8
 * Callers:
 ...
 *     ?HandleMouseReportRateLimitingTimer@MouseRateLimitHoldingFrame@CMouseSensor@@AEAAJ_NK@Z @ 0x1C01B2368 (-HandleMouseReportRateLimitingTimer@MouseRateLimitHoldingFrame@CMouseSensor@@AEAAJ_NK@Z.c)
