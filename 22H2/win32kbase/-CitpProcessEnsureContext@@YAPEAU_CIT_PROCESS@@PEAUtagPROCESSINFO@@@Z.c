/*
 * XREFs of ?CitpProcessEnsureContext@@YAPEAU_CIT_PROCESS@@PEAUtagPROCESSINFO@@@Z @ 0x1C0033220
 * Callers:
...
struct _CIT_PROCESS *__fastcall CitpProcessEnsureContext(struct tagPROCESSINFO *a1, const char *a2)
{
  ...
  result = (struct _CIT_PROCESS *)*((_QWORD *)a1 + 117);
  if ( !result )
    return 0LL;
      ...
      if ( v5 != 1 )
      {
           ...
           + 16 >= 0x1000 )
        {
          if ( (unsigned __int8)NSInstrumentation::CLeakTrackingAllocator::AssociateAllocationWithBacktrace<0>(
                                  ...
                                  BackTrace) )
          {
            *((_QWORD *)a1 + 117) = UntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64;
            goto LABEL_9;
          }
        }
...
LABEL_25:
    *((_QWORD *)a1 + 117) = 52976LL;
    CitpLogFailureWorker(-1073741670, a2, 0xA59u);
    return 0LL;
  }
