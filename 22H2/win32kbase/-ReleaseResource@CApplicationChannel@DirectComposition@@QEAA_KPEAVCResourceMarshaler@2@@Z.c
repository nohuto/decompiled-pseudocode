/*
 * XREFs of ?ReleaseResource@CApplicationChannel@DirectComposition@@QEAA_KPEAVCResourceMarshaler@2@@Z @ 0x1C002FD60
 * Callers:
 ...
 *     ?ReleaseAllReferences@CEffectGroupMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C000F1B0 (-ReleaseAllReferences@CEffectGroupMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z.c)
 ...
 *     ?ReleaseAllReferences@CProxyGeometryClipMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C000F440 (-ReleaseAllReferences@CProxyGeometryClipMarshaler@DirectComposition@@UEAAXPEAVCApplicationChanne.c)
 *     ?ReleaseAllReferences@CProjectedShadowReceiverMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C000F5D0 (-ReleaseAllReferences@CProjectedShadowReceiverMarshaler@DirectComposition@@MEAAXPEAVCApplication.c)
 *     ?ReleaseAllReferences@CDropShadowMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C000F750 (-ReleaseAllReferences@CDropShadowMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z.c)
 ...
 *     ?ReleaseAllReferences@CSpriteShapeMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0030CB0 (-ReleaseAllReferences@CSpriteShapeMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z.c)
 *     ?ReleaseAllReferences@CSurfaceBrushMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0030EA0 (-ReleaseAllReferences@CSurfaceBrushMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@.c)
 ...
 *     ?ReleaseAllReferences@CPathGeometryMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00ADA30 (-ReleaseAllReferences@CPathGeometryMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@.c)
 ...
 *     ?ReleaseAllReferences@CAnimationMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00B3020 (-ReleaseAllReferences@CAnimationMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z.c)
 *     ?ReleaseAllReferences@CNineGridBrushMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00B37B0 (-ReleaseAllReferences@CNineGridBrushMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@.c)
 ...
 *     ?ReleaseAllReferences@CLegacyRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00C51E0 (-ReleaseAllReferences@CLegacyRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChann.c)
 *     ?ReleaseAllReferences@CRemoteRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00CC8B0 (-ReleaseAllReferences@CRemoteRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChann.c)
 ...
 *     ?SetInput@CEffectInputSet@DirectComposition@@QEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@@Z @ 0x1C020EF58 (-SetInput@CEffectInputSet@DirectComposition@@QEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarsha.c)
 *     ?ReleaseAllReferences@CGenericInkMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0211D80 (-ReleaseAllReferences@CGenericInkMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z.c)
 *     ?ReleaseAllReferences@CManipulationMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C02133D0 (-ReleaseAllReferences@CManipulationMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@.c)
 ...
 *     ?ReleaseAllReferences@CParticleBehaviorsMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C021CF60 (-ReleaseAllReferences@CParticleBehaviorsMarshaler@DirectComposition@@UEAAXPEAVCApplicationChanne.c)
 ...
 *     ?ReleaseAllReferences@CSceneMeshMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C021D170 (-ReleaseAllReferences@CSceneMeshMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z.c)
 ...
 *     ?ReleaseAllReferences@CScenePbrMaterialMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C021D310 (-ReleaseAllReferences@CScenePbrMaterialMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel.c)
 ...
 *     ?ReleaseAllReferences@CSynchronousSuperWetInkMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C021D3F0 (-ReleaseAllReferences@CSynchronousSuperWetInkMarshaler@DirectComposition@@UEAAXPEAVCApplicationC.c)
 *     ?EmitUpdate@CSnapshotMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0223CA0 (-EmitUpdate@CSnapshotMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z.c)
 *     ?ReleaseAllReferences@CSnapshotMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0223DD0 (-ReleaseAllReferences@CSnapshotMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z.c)
 ...
 *     ?ReleaseAllReferences@CDDisplayRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0227B60 (-ReleaseAllReferences@CDDisplayRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationCha.c)
 ...
 *     ?ReleaseAllReferences@CVisualCaptureMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C022C220 (-ReleaseAllReferences@CVisualCaptureMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@.c)
 *     ?ReleaseAllReferences@CCompositionCubeMapMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C022D060 (-ReleaseAllReferences@CCompositionCubeMapMarshaler@DirectComposition@@MEAAXPEAVCApplicationChann.c)
 *     ?ReleaseAllReferences@CCompositionSkyBoxBrushMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C022D700 (-ReleaseAllReferences@CCompositionSkyBoxBrushMarshaler@DirectComposition@@MEAAXPEAVCApplicationC.c)
 *     ?ReleaseAllReferences@CCaptureRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C022DF10 (-ReleaseAllReferences@CCaptureRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChan.c)
 *     ?ReleaseAllReferences@CVirtualMonitorCaptureRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C022E640 (-ReleaseAllReferences@CVirtualMonitorCaptureRenderTargetMarshaler@DirectComposition@@MEAAXPEAVCA.c)
 ...
 *     ?ReleaseAllReferences@CCompositionMipmapSurfaceMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C022F780 (-ReleaseAllReferences@CCompositionMipmapSurfaceMarshaler@DirectComposition@@MEAAXPEAVCApplicatio.c)
 *     ?ReleaseAllReferences@CSceneMeshRendererComponentMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C022FD40 (-ReleaseAllReferences@CSceneMeshRendererComponentMarshaler@DirectComposition@@UEAAXPEAVCApplicat.c)
 ...
 *     ?FindAndDequeue@CApplicationChannel@DirectComposition@@KAXPEAVCResourceMarshaler@2@PEAPEAV32@@Z @ 0x1C00A23BC (-FindAndDequeue@CApplicationChannel@DirectComposition@@KAXPEAVCResourceMarshaler@2@PEAPEAV32@@Z.c)
        ...
        struct DirectComposition::CResourceMarshaler *a2)
{
  ...
  if ( !a2 )
    return v2;
  v5 = DirectComposition::CResourceMarshaler::PrivateRelease(a2);
  v2 = v5;
  if ( v5 == 1 )
  {
    if ( !(*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)v3 + 8LL))(v3) )
      return v2;
  ...
  else
  {
    ...
    if ( (*((_DWORD *)v3 + 4) & 4) != 0 )
    {
      v19 = DirectComposition::CGenericTable<DirectComposition::CResourceMarshaler *,DirectComposition::CWeakReferenceBase,1953973060,1>::RemoveObject((PRTL_GENERIC_TABLE)((char *)this + 264));
      *((_DWORD *)v3 + 4) &= ~4u;
      *(_QWORD *)(v19 + 16) = 0LL;
    }
    if ( *((_QWORD *)v3 + 5) )
    ...
    if ( (v7 & 1) != 0 )
    {
      if ( (v7 & 2) != 0 )
      {
        ...
        if ( IsDerivedResourceType )
          v9 = 424LL;
        v10 = *(struct DirectComposition::CResourceMarshaler **)((char *)this + v9);
        v11 = (_QWORD *)((char *)this + v9);
        if ( v10 )
        {
          while ( v10 != v3 )
          {
            v11 = (_QWORD *)((char *)v10 + 8);
            v10 = (struct DirectComposition::CResourceMarshaler *)*((_QWORD *)v10 + 1);
            if ( !v10 )
              goto LABEL_22;
          }
          *v11 = *((_QWORD *)v3 + 1);
...
LABEL_22:
    ...
    v12 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *))(*(_QWORD *)v3 + 80LL))(v3);
    if ( v12 )
    {
      v21 = *(_QWORD *)(v12 + 80);
      if ( v21 )
      {
        ...
        if ( (v22 & 1) != 0 && (v22 & 2) == 0 )
        {
          v26 = (_QWORD *)((char *)this + 440);
          for ( i = *((_QWORD *)this + 55); i != v21; i = *(_QWORD *)(i + 8) )
            v26 = (_QWORD *)(i + 8);
          *v26 = *(_QWORD *)(v21 + 8);
          *(_QWORD *)(v21 + 8) = 0LL;
          DirectComposition::CAnimationTimeList::Release((DirectComposition::CAnimationTimeList *)v21);
        }
      }
    }
    v13 = *((_DWORD *)v3 + 8);
    v14 = (unsigned int)(v13 - 1);
    if ( v13 && v14 < *((_QWORD *)this + 17) )
    {
      v15 = *((_QWORD *)this + 18);
      Src = 0LL;
      memmove((void *)(*((_QWORD *)this + 14) + v14 * v15), &Src, v15);
      --*((_QWORD *)this + 19);
    }
    v16 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, unsigned __int64))(*(_QWORD *)v3 + 104LL))(
            v3,
            v14);
    if ( v16 )
    {
      ...
      do
      {
        ...
        *((_QWORD *)this + 58) = *((_QWORD *)v3 + 1);
        ...
        else
        {
          ...
          v18 = *(_QWORD *)v3;
          *((_QWORD *)v3 + 1) = 0LL;
          (*(void (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64))(v18 + 72))(v3, 1LL);
        }
