/*
 * XREFs of ??0CLegacyAnimationTriggerMarshaler@DirectComposition@@QEAA@XZ @ 0x1C020B62C
 * Callers:
...
DirectComposition::CLegacyAnimationTriggerMarshaler *__fastcall DirectComposition::CLegacyAnimationTriggerMarshaler::CLegacyAnimationTriggerMarshaler(
        DirectComposition::CLegacyAnimationTriggerMarshaler *this)
{
  DirectComposition::CResourceMarshaler::CResourceMarshaler(this, 94LL);
  *(_QWORD *)this = &DirectComposition::CLegacyAnimationTriggerMarshaler::`vftable';
  return this;
}
