/*
 * XREFs of ?SendLeftDownFromPhysical@CPTPEngine@@AEAAXPEAUPTPInput@@PEAUtagPOINT@@W4tagPTP_ACTION@@@Z @ 0x1C01C83BC
 * Callers:
...
__int64 __fastcall CPTPEngine::SendLeftDownFromPhysical(CPTPEngine *a1, __int64 a2, _QWORD *a3, int a4)
{
  __int64 result; // rax
  __int64 v8; // r8
