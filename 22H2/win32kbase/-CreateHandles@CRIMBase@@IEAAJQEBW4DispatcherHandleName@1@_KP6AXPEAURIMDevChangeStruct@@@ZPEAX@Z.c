/*
 * XREFs of ?CreateHandles@CRIMBase@@IEAAJQEBW4DispatcherHandleName@1@_KP6AXPEAURIMDevChangeStruct@@@ZPEAX@Z @ 0x1C0088F08
 * Callers:
  ...
  if ( a3 )
  {
    do
    {
      ...
      if ( (unsigned int)v9 >= 0x11 )
        return 3221225485LL;
      if ( dword_1C020E280[3 * v9] != (_DWORD)v9 )
      ...
      DispatcherHandles = CRIMBase::SensorDispatcherObject::CreateDispatcherHandles(
                            ...
                            (const struct CRIMBase::DispatcherCreation *)&dword_1C020E280[3 * v9]);
