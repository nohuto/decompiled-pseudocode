/*
 * XREFs of ?OnProcessDestruction@CProcessData@DirectComposition@@SAXPEAU_W32PROCESS@@@Z @ 0x1C00338AC
 * Callers:
 *     DCompositionProcessCallout @ 0x1C00336A0 (DCompositionProcessCallout.c)
 * Callees:
