/*
 * XREFs of ?CitpPostUpdateUseInfoLog@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z @ 0x1C008DF28
 * Callers:
 ...
 *     ?CitUpdateInputTypeCoverage@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C008EADC (-CitUpdateInputTypeCoverage@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z.c)
...
void __fastcall CitpPostUpdateUseInfoLog(struct _CIT_IMPACT_CONTEXT *a1, int a2)
{
  ...
  if ( *((_WORD *)a1 + 172) )
  {
    ...
    if ( (unsigned int)dword_1C0249250 > 5 && tlgKeywordOn((__int64)&dword_1C0249250, 0x800000000800LL) )
    {
      v5 = *((_DWORD *)a1 + 133);
    ...
    HIDWORD(Data[6]) += v35;
    if ( v2 == 2 || v34 >= HIDWORD(xmmword_1C0254564) )
    {
      if ( v36 >= HIDWORD(xmmword_1C0254564) / 0x3E8 )
        HIDWORD(Data[6]) = HIDWORD(xmmword_1C0254564) / 0x3E8 - 1;
      if ( (unsigned int)dword_1C0249418 > 5 && tlgKeywordOn((__int64)&dword_1C0249418, 0x400000000000LL) )
      {
