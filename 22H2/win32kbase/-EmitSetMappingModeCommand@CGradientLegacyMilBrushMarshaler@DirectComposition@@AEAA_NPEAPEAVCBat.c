/*
 * XREFs of ?EmitSetMappingModeCommand@CGradientLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0218228
 * Callers:
...
char __fastcall DirectComposition::CGradientLegacyMilBrushMarshaler::EmitSetMappingModeCommand(
