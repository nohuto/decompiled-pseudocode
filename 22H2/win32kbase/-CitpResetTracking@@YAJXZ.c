/*
 * XREFs of ?CitpResetTracking@@YAJXZ @ 0x1C01FE900
 * Callers:
...
__int64 CitpResetTracking(void)
{
  ...
  v0 = xmmword_1C0254590;
  if ( !xmmword_1C0254590 )
    goto LABEL_2;
  CitpContextFlush(xmmword_1C0254590, (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24);
  ...
  CitpParametersLoad((struct _CIT_PARAMETERS *)&xmmword_1C0254564, v4);
