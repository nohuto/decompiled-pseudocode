/*
 * XREFs of _anonymous_namespace_::UpdateKeyState @ 0x1C0093C10
 * Callers:
 *     UpdateKeyStateForMessage @ 0x1C0093B30 (UpdateKeyStateForMessage.c)
 * Callees:
 *     _anonymous_namespace_::ApplyKeyStateToQueue @ 0x1C0093CA8 (_anonymous_namespace_--ApplyKeyStateToQueue.c)
 */
