/*
 * XREFs of ?RegisterThreadDispatcherObjectWithCallback@IOCPDispatcher@@QEAAXPEAXP6AX0@Z0@Z @ 0x1C00842E0
 * Callers:
 *     AddThreadWakeEventDispatcherToIOCP @ 0x1C0083F30 (AddThreadWakeEventDispatcherToIOCP.c)
