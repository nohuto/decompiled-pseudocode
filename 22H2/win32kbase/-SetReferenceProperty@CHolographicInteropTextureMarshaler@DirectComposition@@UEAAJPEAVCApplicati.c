/*
 * XREFs of ?SetReferenceProperty@CHolographicInteropTextureMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01ED760
 * Callers:
 *     <none>
 * Callees:
