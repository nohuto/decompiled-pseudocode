/*
 * XREFs of ?UpdatePointerDeviceSystemMetrics@CInputSystemMetrics@@QEAAXPEBUDEVICEINFO@@_N@Z @ 0x1C01BDAC8
 * Callers:
 ...
 *     UpdatePointerDeviceSystemMetrics @ 0x1C01AF4C0 (UpdatePointerDeviceSystemMetrics.c)
 * Callees:
