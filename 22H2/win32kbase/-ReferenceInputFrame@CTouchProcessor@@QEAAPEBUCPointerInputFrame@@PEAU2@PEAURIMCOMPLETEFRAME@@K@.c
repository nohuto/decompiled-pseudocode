/*
 * XREFs of ?ReferenceInputFrame@CTouchProcessor@@QEAAPEBUCPointerInputFrame@@PEAU2@PEAURIMCOMPLETEFRAME@@K@Z @ 0x1C01D21A0
 * Callers:
        ...
        unsigned int a4)
{
  ...
  v9 = (struct RIMCOMPLETEFRAME *)&WPP_2c5ea56a6e6f31fa38ff36b2483c7d67_Traceguids;
  if ( (_BYTE)a2 || v8 )
