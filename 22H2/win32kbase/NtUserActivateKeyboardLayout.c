/*
 * XREFs of NtUserActivateKeyboardLayout @ 0x1C000A590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserActivateKeyboardLayout(__int64 a1)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v27 && (*(int *)(v27 + 24) > 0 || *(_DWORD *)(v38 + 48)) )
    {
      ...
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 0x2000LL, v28, v29) )
        {
          v35 = v39;
          v43 = 4LL;
          v42 = &v35;
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v38 && (*(_DWORD *)(v38 + 48) || *(int *)(v38 + 24) > 0) )
  {
    ...
    *(GUID *)(v38 + 28) = ActivityId;
    if ( (unsigned int)dword_1C024AA90 > 6 )
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 0x2000LL, (unsigned int)dword_1C024AA90, v10) )
      {
        v34 = v39;
        v46 = 4LL;
        v45 = &v34;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C0217F80, (int)&ActivityId, 0, 3u, &v44);
        v30 = (unsigned int)dword_1C024AA90;
      }
      if ( (unsigned int)v30 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 0x2000LL, v30, v31) )
      {
        v36 = v39;
        v49 = 4LL;
        v48 = &v36;
