/*
 * XREFs of ?vDisableSurface@PDEVOBJ@@QEAAXW4_CLEANUPTYPE@@E@Z @ 0x1C00A8C50
 * Callers:
...
void __fastcall PDEVOBJ::vDisableSurface(_QWORD *a1, unsigned int a2, char a3)
{
  ...
  v3 = *a1;
  if ( (*(_DWORD *)(*a1 + 40LL) & 0x80000) == 0 && qword_1C02556E8 )
    qword_1C02556E8(*a1);
  if ( qword_1C02557B0 )
    v7 = qword_1C02557B0();
  else
    v7 = -1073741637;
  if ( v7 >= 0 && qword_1C02557B8 )
    qword_1C02557B8(*a1, a2);
