/*
 * XREFs of ?GetHandleObject@?$CMonitorHandleTable@VCOPMProtectedOutput@@PEAX@OPM@@QEAAJPEAXPEAPEAVCOPMProtectedOutput@@@Z @ 0x1C015BC88
 * Callers:
 ...
 * Callees:
 *     ?DoesCurrentProcessOwnProtectedOutput@CMonitorPDO@OPM@@QEBAEXZ @ 0x1C01514A0 (-DoesCurrentProcessOwnProtectedOutput@CMonitorPDO@OPM@@QEBAEXZ.c)
