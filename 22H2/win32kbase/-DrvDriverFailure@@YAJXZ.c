/*
 * XREFs of ?DrvDriverFailure@@YAJXZ @ 0x1C013F7C8
 * Callers:
 ...
 *     CollectDriverFailureData @ 0x1C01653F8 (CollectDriverFailureData.c)
 *     ExistsInGraphicsDeviceList @ 0x1C0168224 (ExistsInGraphicsDeviceList.c)
 */
