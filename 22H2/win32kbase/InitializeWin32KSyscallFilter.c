/*
 * XREFs of InitializeWin32KSyscallFilter @ 0x1C0069460
 * Callers:
...
LABEL_22:
  ...
  v6 = (v4 & 7) == 0;
  qword_1C024FD18 = 0LL;
  qword_1C024FD28 = 550LL;
  qword_1C024FD38 = 320LL;
  v7 = (v4 >> 3) + 1;
  qword_1C024FD48 = 1LL;
  if ( v6 )
    v7 = v5;
  qword_1C024FD58 = 440LL;
  qword_1C024FD20 = (__int64)&Win32KSyscallFilterList::Rs1RestrictedAppcontainer;
  v8 = v7;
  qword_1C024FD68 = 276LL;
  qword_1C024FD30 = (__int64)&Win32KSyscallFilterList::Rs1RestrictedAppcontainerPlugin;
  qword_1C024FD40 = (__int64)&Win32KSyscallFilterList::FontDrvHost;
  qword_1C024FD50 = (__int64)&Win32KSyscallFilterList::Rs1RestrictedAppcontainerMiniPlugin;
  qword_1C024FD60 = (__int64)&Win32KSyscallFilterList::Rs3RestrictedAppcontainer;
  qword_1C024FD70 = (__int64)&Win32KSyscallFilterList::Rs3HvsiRdpClient;
  dword_1C024FD78 = 383;
  dword_1C024FD7C = 1;
...
LABEL_31:
  v10 = 0;
  v11 = (unsigned int *)&qword_1C024FD18;
