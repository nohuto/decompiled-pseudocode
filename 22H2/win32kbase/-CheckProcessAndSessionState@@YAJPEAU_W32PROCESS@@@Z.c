/*
 * XREFs of ?CheckProcessAndSessionState@@YAJPEAU_W32PROCESS@@@Z @ 0x1C0073324
 * Callers:
...
__int64 __fastcall CheckProcessAndSessionState(struct _W32PROCESS *a1)
{
  ...
  {
    if ( qword_1C0255A58 ? qword_1C0255A58() : 0 )
      return 0LL;
  }
    ...
    *(&ObjectAttributes.Attributes + 1) = 0;
    ...
    if ( ProcessInheritedFromUniqueProcessId )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( InformationProcess >= 0 )
      {
        v8 = qword_1C02563B0 ? qword_1C02563B0() : -1073741637;
        if ( v8 >= 0 && !(qword_1C02563B8 ? qword_1C02563B8(ProcessInformation[8]) : 0) )
...
LABEL_28:
        ...
        if ( InformationProcess < 0 && v3 )
        {
          ...
          if ( qword_1C0255A78 )
            InformationProcess = qword_1C0255A78();
          else
            ...
            && (*(_DWORD *)(v43 + 48) || *(int *)(v43 + 24) > 0) )
          {
            ...
            *(GUID *)(v43 + 28) = ActivityId;
            if ( (unsigned int)dword_1C024AA90 > 6 )
            {
              ...
              if ( v30 > 6 && tlgKeywordOn((__int64)&dword_1C024AA90, 0x2000LL) )
              {
                LODWORD(v39) = v44;
                v54 = 4LL;
                v53 = &v39;
