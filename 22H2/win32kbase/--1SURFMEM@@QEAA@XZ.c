/*
 * XREFs of ??1SURFMEM@@QEAA@XZ @ 0x1C0031B30
 * Callers:
...
LABEL_244:
  ...
  if ( v140 )
  {
    ...
    if ( v84 == 5 )
    {
      ...
      if ( v85 && qword_1C024B3F8 )
        NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C024B3F8, v85, 0);
    }
    else if ( v84 == 16 )
    {
      TrackObjectReferenceDecrement(
