/*
 * XREFs of ApiSetEditionFinalizeKoreanImeCompStrOnMouseClick @ 0x1C00A3B68
 * Callers:
...
__int64 __fastcall ApiSetEditionFinalizeKoreanImeCompStrOnMouseClick(__int64 a1, unsigned int a2)
{
  ...
  if ( qword_1C0257898 )
    result = qword_1C0257898();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C02578A0;
    if ( qword_1C02578A0 )
      result = qword_1C02578A0(a1, v2);
  }
