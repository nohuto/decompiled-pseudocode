/*
 * XREFs of ?RefreshRegions@DeadzoneJumping@CCursorClip@@QEAA_NXZ @ 0x1C00633EC
 * Callers:
...
char __fastcall CCursorClip::DeadzoneJumping::RefreshRegions(CCursorClip::DeadzoneJumping *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v9 )
      break;
    QuotaZInit = NSInstrumentation::CLeakTrackingAllocator::AllocateQuotaZInit(v7, v6, 0x28uLL, 0x6A637A44u);
    ...
    *(_WORD *)(QuotaZInit + 32) = *((_WORD *)v9 + 10);
    *(_QWORD *)QuotaZInit = 0LL;
    *(_QWORD *)(QuotaZInit + 24) = 0LL;
    if ( v4 )
      *v4 = QuotaZInit;
    else
      *(_QWORD *)this = QuotaZInit;
    v8 = (_QWORD *)*v8;
    v4 = (_QWORD *)QuotaZInit;
  }
  ExReleaseResourceLite(CInputConfig::slock);
  KeLeaveCriticalRegion();
