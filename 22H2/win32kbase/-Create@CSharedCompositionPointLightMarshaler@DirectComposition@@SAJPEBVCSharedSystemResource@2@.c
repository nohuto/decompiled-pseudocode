/*
 * XREFs of ?Create@CSharedCompositionPointLightMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F98C4
 * Callers:
 *     CreateSharedCompositionPointLightMarshaler @ 0x1C01F9A70 (CreateSharedCompositionPointLightMarshaler.c)
 * Callees:
