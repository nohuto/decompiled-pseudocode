/*
 * XREFs of ?ResetOrg@@YAXPEAUHRGN__@@PEAUtagDCE@@H@Z @ 0x1C0037720
 * Callers:
...
void __fastcall ResetOrg(HRGN a1, unsigned __int64 a2, int a3)
{
  ...
  v14 = -1073741637;
  if ( qword_1C0256678 )
    v15 = qword_1C0256678(v6, a2, 0LL);
  else
    v15 = -1073741637;
  if ( v15 >= 0 && (v6 = *(_QWORD *)(v5 + 16), qword_1C0256680) )
    v16 = qword_1C0256680(v6, a2, 0LL);
  else
    v16 = 0LL;
  if ( v16 )
  {
    ...
    {
      if ( qword_1C0256688 )
        v14 = qword_1C0256688(v6, a2, 0LL);
      if ( v14 >= 0 )
      {
        if ( qword_1C0256690 ? qword_1C0256690(v16, a2, 0LL) : 0LL )
        {
          v18 = *(_QWORD *)(v16 + 40);
          v19 = *(_QWORD *)(v5 + 88);
          v20 = *(_DWORD *)(v18 + 88);
