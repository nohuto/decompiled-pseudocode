/*
 * XREFs of CoreMsgOpenConnection @ 0x1C0072D4C
 * Callers:
 ...
 *     UserCoreMsgOpenConnectionHandle @ 0x1C01B1E60 (UserCoreMsgOpenConnectionHandle.c)
 * Callees:
