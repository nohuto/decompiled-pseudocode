/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0094204
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C00941C0 (CreateSharedReadTransformMarshaler.c)
 * Callees:
