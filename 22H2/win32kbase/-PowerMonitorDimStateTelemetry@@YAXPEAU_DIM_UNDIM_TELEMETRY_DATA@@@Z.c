/*
 * XREFs of ?PowerMonitorDimStateTelemetry@@YAXPEAU_DIM_UNDIM_TELEMETRY_DATA@@@Z @ 0x1C0079258
 * Callers:
...
void __fastcall PowerMonitorDimStateTelemetry(struct _DIM_UNDIM_TELEMETRY_DATA *a1)
{
  ...
  if ( *((_BYTE *)a1 + 5) )
  {
    if ( (unsigned int)dword_1C0245378 > 5 && tlgKeywordOn((__int64)&dword_1C0245378, 0x400000000100LL) )
    {
      v5 = *((_BYTE *)v3 + 6);
  ...
  else
  {
    ...
    if ( (dword_1C0250F00 & 1) == 0 )
    {
      dword_1C0250F00 |= 1u;
      qword_1C0250F08 = MEMORY[0xFFFFF78000000008] + 36000000000LL;
    }
    if ( MEMORY[0xFFFFF78000000008] > (unsigned __int64)qword_1C0250F08 )
    {
      qword_1C0250F08 = MEMORY[0xFFFFF78000000008] + 36000000000LL;
      TlgAggregateFlush();
    }
