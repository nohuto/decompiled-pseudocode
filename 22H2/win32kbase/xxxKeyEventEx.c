/*
 * XREFs of xxxKeyEventEx @ 0x1C004CFD0
 * Callers:
 *     ?xxxNumpadCursor@@YAHPEAUtagKE@@@Z @ 0x1C009FEE0 (-xxxNumpadCursor@@YAHPEAUtagKE@@@Z.c)
 *     ?xxxICO_00@@YAHPEAUtagKE@@@Z @ 0x1C00A3780 (-xxxICO_00@@YAHPEAUtagKE@@@Z.c)
 ...
 *     xxxKeyEvent @ 0x1C01B1100 (xxxKeyEvent.c)
 ...
 *     GetKeyEventInputSource @ 0x1C004DD80 (GetKeyEventInputSource.c)
        ...
        struct _KEYBOARD_VIRTUAL_DEVICE_INFO *a10)
{
  ...
  *(_QWORD *)v27 = 0LL;
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C024AA90, 0x4000LL) )
    {
      LODWORD(v38) = a8;
      v29 = v39;
      v33 = (__int64)a5;
