/*
 * XREFs of ?GetPointerDataQPCTimeList@CTouchProcessor@@QEAAH_KIPEA_KPEAH@Z @ 0x1C01C7A20
 * Callers:
        ...
        int *a5)
{
  ...
  if ( !v6 )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5491);
  ...
  if ( *((_DWORD *)v14 + 8) >= *((_DWORD *)FrameById + 12) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5510);
  v19 = *((_QWORD *)v18 + 30) + 480LL * *((unsigned int *)v14 + 8);
  if ( !(unsigned int)CPointerInfoNode::IsValid((CPointerInfoNode *)v19) )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5512);
  ...
  if ( v6 > 1 )
  {
    ...
    do
    {
      ...
      if ( !(unsigned int)CPointerInfoNode::IsValid((CPointerInfoNode *)v24) )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5559);
      v25 = v21++;
      a4[v25] = *(_QWORD *)(v24 + 248);
      if ( (unsigned int)CPointerInfoNode::GetHistoryCount((CPointerInfoNode *)v24) != HistoryCount - 1 )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5569);
