/*
 * XREFs of HMAllocObject @ 0x1C0034080
 * Callers:
...
LABEL_6:
  ...
  if ( (v9 & 0x10) != 0 && a2 )
  {
    ...
    v27 = qword_1C02567F0;
    if ( qword_1C02567F0 )
      v27 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C02567F0(
                                                              a2,
  ...
  else
  {
    ...
    else
    {
      ...
      if ( qword_1C0256D10 && (int)qword_1C0256D10() >= 0 )
      {
        if ( qword_1C0256D18 )
          v13 = (_QWORD *)qword_1C0256D18(33LL, v11, v12);
        else
          v13 = 0LL;
        if ( !v13 )
          goto LABEL_75;
...
LABEL_75:
  ...
  if ( !v13 )
    goto LABEL_75;
  v14 = *v10;
  v15 = (char *)qword_1C024FA38 + 32 * *v10;
  ...
  *v17 = (__int64)v13;
  ...
  v20 = (int)v14 | (unsigned __int64)(*(unsigned __int16 *)((char *)qword_1C024FA38
                                                          + v14 * (unsigned int)dword_1C024FA40
                                                          + 26) << 16);
  *v13 = v20;
  if ( *(_DWORD *)((char *)&gahti + v39 + 16) )
  {
