/*
 * XREFs of ?SetForegroundPriority@ForegroundBoost@@YAXPEBUtagTHREADINFO@@W4ForegroundPriorityClass@1@@Z @ 0x1C0065CC0
 * Callers:
...
_UNKNOWN **__fastcall ForegroundBoost::SetForegroundPriority(__int64 a1, int a2)
{
  ...
  CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v14, (struct _EX_PUSH_LOCK *)&unk_1C0291DD0);
  v7 = (*(_DWORD *)(v2 + 816) >> 17) & 3;
  anonymous_namespace_::SetForegroundPriorityProcess(v2, a1, v6);
  v8 = (*(_DWORD *)(v2 + 816) >> 17) & 3;
