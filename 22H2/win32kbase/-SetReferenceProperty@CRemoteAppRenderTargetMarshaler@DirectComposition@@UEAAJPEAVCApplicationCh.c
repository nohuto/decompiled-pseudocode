/*
 * XREFs of ?SetReferenceProperty@CRemoteAppRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C0225F80
 * Callers:
 *     <none>
 * Callees:
