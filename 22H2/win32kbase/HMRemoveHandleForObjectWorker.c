/*
 * XREFs of HMRemoveHandleForObjectWorker @ 0x1C00B3E1C
 * Callers:
...
__int64 __fastcall HMRemoveHandleForObjectWorker(__int64 a1)
{
  ...
  v3 = 3LL * (unsigned int)((a1 - (__int64)qword_1C028FE68) >> 5);
  ...
  *(_OWORD *)&v2[v3] = 0LL;
  v2[v3 + 2] = 0LL;
  *(_WORD *)(a1 + 26) = v4;
  v5 = (a1 - (__int64)qword_1C028FE68) >> 5;
  if ( (v5 & 1) != 0 )
  {
    *((_QWORD *)gpKernelHandleTable + 3 * v5) = qword_1C028FDB0;
    qword_1C028FDB0 = v5;
  }
  else
  {
    *((_QWORD *)gpKernelHandleTable + 3 * v5) = qword_1C028FDA8;
    qword_1C028FDA8 = v5;
  }
  return 1LL;
}
