/*
 * XREFs of HMRemoveHandleForObjectWorker @ 0x1C00098D8
 * Callers:
...
__int64 __fastcall HMRemoveHandleForObjectWorker(__int64 a1)
{
  ...
  --giheCount;
  v2 = *(_WORD *)(a1 + 26) + 1;
  v3 = 3LL * (unsigned int)((a1 - (__int64)qword_1C024FA38) >> 5);
  ...
  *(_OWORD *)&v4[v3] = 0LL;
  ...
  if ( v2 != -1 )
    v5 = v2;
  *(_WORD *)(a1 + 26) = v5;
  v6 = (a1 - (__int64)qword_1C024FA38) >> 5;
  if ( (v6 & 1) != 0 )
  {
    *((_QWORD *)gpKernelHandleTable + 3 * v6) = qword_1C024ECF0;
    qword_1C024ECF0 = v6;
  }
  else
  {
    *((_QWORD *)gpKernelHandleTable + 3 * v6) = qword_1C024ECE8;
    qword_1C024ECE8 = v6;
  }
  return 1LL;
}
