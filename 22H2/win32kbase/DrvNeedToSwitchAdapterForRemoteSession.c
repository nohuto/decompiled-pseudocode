/*
 * XREFs of DrvNeedToSwitchAdapterForRemoteSession @ 0x1C01677DC
 * Callers:
 ...
 *     ?DrvIsUsedByRemoteGraphicsDevices@@YAHPEAX@Z @ 0x1C01617B8 (-DrvIsUsedByRemoteGraphicsDevices@@YAHPEAX@Z.c)
 */
