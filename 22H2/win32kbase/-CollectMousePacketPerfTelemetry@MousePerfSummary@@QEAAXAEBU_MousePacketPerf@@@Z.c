/*
 * XREFs of ?CollectMousePacketPerfTelemetry@MousePerfSummary@@QEAAXAEBU_MousePacketPerf@@@Z @ 0x1C0042AD4
 * Callers:
        ...
        const struct _MousePacketPerf *a2)
{
  ...
  *(_QWORD *)(v11 + 448) = v10;
  ...
  if ( (unsigned int)dword_1C0249170 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0249170, 16LL, v12, v13) )
  {
    v27 = *((_QWORD *)a2 + 5);
    v28 = *((_QWORD *)a2 + 4);
    v29 = *((_QWORD *)a2 + 3);
