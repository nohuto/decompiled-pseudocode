/*
 * XREFs of ?InitializeWin32CrossSessionGlobals@@YAJW4XSessionGlobalAccess@@@Z @ 0x1C00C0050
 * Callers:
 *     Win32kBaseDriverEntry @ 0x1C02DEBC0 (Win32kBaseDriverEntry.c)
 * Callees:
 *     ZwWin32CreateSectionRetainHandle @ 0x1C00C0180 (ZwWin32CreateSectionRetainHandle.c)
 */
