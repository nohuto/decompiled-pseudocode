/*
 * XREFs of ?vInitBrush@EBRUSHOBJ@@QEAAXPEAVDC@@PEAVBRUSH@@VXEPALOBJ@@2PEAVSURFACE@@H@Z @ 0x1C00679D0
 * Callers:
 ...
 *     rgbFromColorref @ 0x1C0067DE0 (rgbFromColorref.c)
 *     ?ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z @ 0x1C0067E24 (-ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z.c)
 ...
 *     ?hFindIcmDIB@BRUSH@@QEAAPEAUHBITMAP__@@PEAX@Z @ 0x1C013BFB0 (-hFindIcmDIB@BRUSH@@QEAAPEAUHBITMAP__@@PEAX@Z.c)
 */
...
LABEL_21:
  ...
  *((_QWORD *)a1 + 13) = *(_QWORD *)(v27 + 1808);
  ...
  if ( (v30 & 0x10) != 0 )
  {
    ...
    else if ( (struct _LIST_ENTRY *)a3 == WPP_MAIN_CB.Queue.ListEntry.Blink )
    {
      v41 = a1[18];
