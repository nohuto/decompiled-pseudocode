/*
 * XREFs of ?DispatchFrame@RIM@InputTraceLogging@@SAXPEBURIMDEV@@PEBURIMCOMPLETEFRAME@@W4DispatchType@12@@Z @ 0x1C01738E4
 * Callers:
...
char __fastcall InputTraceLogging::RIM::DispatchFrame(__int64 a1, __int64 a2, int a3)
{
  ...
  v3 = &retaddr;
  if ( a3 == 1 && (unsigned int)dword_1C024AA90 > 4 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)dword_1C021BDF7,
                     0LL,
                     0LL,
                     3u,
                     &v23);
