/*
 * XREFs of ?RegisterWinSqmProvider@@YAKXZ @ 0x1C00B17AC
 * Callers:
...
__int64 RegisterWinSqmProvider(void)
{
  ...
  v0 = _InterlockedCompareExchange64(&qword_1C02548A0, 255LL, 0LL);
  if ( v0 )
  {
    switch ( v0 )
    {
      ...
      case 255LL:
        ...
        for ( i = 0; i < 10; ++i )
        {
          ...
          v4 = _InterlockedExchange64(&qword_1C02548A0, qword_1C02548A0);
          if ( v4 != 255 )
            break;
        }
        if ( i == 10 )
          v4 = _InterlockedCompareExchange64(&qword_1C02548A0, 204LL, 255LL);
  ...
  else
  {
    ...
    if ( (unsigned int)IsSessionDisabled(0LL, 0) )
      dword_1C0250868 |= 1u;
    _InterlockedExchange64(&qword_1C02548A0, v1 != 0 ? 238LL : 221LL);
  }
  return v1;
}
