/*
 * XREFs of DEC_SHARE_REF_CNT @ 0x1C002F510
 * Callers:
 ...
 *     ?OnUnexpectedThreadTerminationStatic@?$UnexpectedThreadTerminationHandler@VCOLORSPACEREF@@@@SAXPEAX@Z @ 0x1C00C8140 (-OnUnexpectedThreadTerminationStatic@-$UnexpectedThreadTerminationHandler@VCOLORSPACEREF@@@@SAXP.c)
 ...
 * Callees:
 *     ?ReleaseEntryLock@GdiHandleEntryDirectory@@QEAAXI@Z @ 0x1C0030930 (-ReleaseEntryLock@GdiHandleEntryDirectory@@QEAAXI@Z.c)
