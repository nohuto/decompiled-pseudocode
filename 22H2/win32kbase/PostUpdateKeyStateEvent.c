/*
 * XREFs of PostUpdateKeyStateEvent @ 0x1C00075C0
 * Callers:
 *     NtUserGetKeyState @ 0x1C0006DA0 (NtUserGetKeyState.c)
 *     UpdateAsyncKeyState @ 0x1C004D680 (UpdateAsyncKeyState.c)
 *     ?ApplyFullKeyboardStates@@YAXPEAX0@Z @ 0x1C01B3CB0 (-ApplyFullKeyboardStates@@YAXPEAX0@Z.c)
 * Callees:
...
LABEL_5:
      ...
      if ( *(_DWORD *)(v4 + 96) == 4 )
      {
        ...
        *v6 = gafAsyncKeyState;
        v9 = v6 + 4;
        v6[1] = xmmword_1C024F630;
        v6[2] = xmmword_1C024F640;
        v6[3] = xmmword_1C024F650;
        do
        {
          ++v7;
          *v9++ |= *v8++;
        ...
        while ( v7 < 8 );
        result = (__int64)qword_1C0256118;
        if ( qword_1C0256118 )
          result = qword_1C0256118(*(_QWORD *)(a1 + 96), 8256LL, v8);
        goto LABEL_5;
      }
      ...
      if ( result )
      {
        ...
        v3 = (_OWORD *)(a1 + 196);
        *v5 = gafAsyncKeyState;
        v5[1] = xmmword_1C024F630;
        v5[2] = xmmword_1C024F640;
        v5[3] = xmmword_1C024F650;
        v5[4] = *(_OWORD *)(a1 + 196);
        v5[5] = *(_OWORD *)(a1 + 212);
