/*
 * XREFs of ?DrvChangeDisplaySettingsInternal@@YAJPEAUtagGRAPHICS_DEVICE@@PEAU_devicemodeW@@PEAUD3DKMT_GETPATHSMODALITY@@PEAXHHPEAU_MDEV@@PEAPEAU4@KHHHU_CDS_INTERNAL_FLAGS@@@Z @ 0x1C0013A90
 * Callers:
 ...
 *     ?apalResetColorTable@XEPALOBJ@@QEAAXXZ @ 0x1C00B378C (-apalResetColorTable@XEPALOBJ@@QEAAXXZ.c)
        ...
        char a13)
{
  ...
  *a8 = 0LL;
  ...
  {
    updated = DrvUpdateDisplayDriverParameters((struct tagGRAPHICS_DEVICE *)a1, v123, v124, Src);
    v20 = 0;
    if ( updated < 0 )
    {
      v17 = -2;
      ...
      if ( v17 == 2 )
      {
        ...
        *((_QWORD *)MDEV + 1) = *((_QWORD *)a7 + 1);
        if ( !v72 )
        {
          ...
          ++*((_DWORD *)v116 + 3);
          ++*((_DWORD *)v116 + 2);
          TrackObjectReferenceIncrement(1LL, *((_QWORD *)v116 + 443));
...
LABEL_88:
          ...
          if ( v32 )
          {
            v114 = WdLogNewEntry5_WdError(v37, v19);
            WdLogEvent5_WdError(v114);
            DrvBackoutMDEV(MDEV, v115);
            Win32FreePool(MDEV);
            *a8 = 0LL;
            if ( a7 )
              DrvEnableMDEV(a7, 0LL, 0LL);
...
LABEL_229:
    ...
    v38 = 0LL;
    if ( v41 >= 0 && qword_1C0255408 )
    {
      qword_1C0255408(*(_QWORD *)a7, 1LL);
      v38 = 0LL;
    }
...
LABEL_48:
        ...
        if ( v34 )
        {
          ...
          if ( (unsigned int)PDEVOBJ::bLddmDriver((PDEVOBJ *)&v131) )
          {
            ...
            {
              v37 = (unsigned int)-((unsigned int)bDynamicProcessAllDriverRealizations((__int64)v34, 0LL, 1) != 0);
              v32 &= v37;
            }
          }
        }
...
LABEL_70:
          if ( a7 )
          {
            ...
            *(_QWORD *)v120 = *(_QWORD *)a7;
            ...
            if ( (int)IsGreHideSpritesSupported(v37, v19, v38, v39) >= 0 && qword_1C0255408 )
            {
              v48 = MDEV;
              if ( v32 )
                v48 = a7;
              qword_1C0255408(*(_QWORD *)v48, 0LL);
            }
            v49 = v127;
            if ( v127 )
            {
