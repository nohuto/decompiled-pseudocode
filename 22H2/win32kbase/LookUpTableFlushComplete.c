/*
 * XREFs of LookUpTableFlushComplete @ 0x1C027EA34
 * Callers:
 *     TlgAggregateFlush @ 0x1C01FFFA4 (TlgAggregateFlush.c)
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C027F720 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C01FFAE8 (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C027F80C (UpdateInternalStatsOnFlush.c)
 */
...
void __fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v3 + 288) )
    {
      if ( (unsigned int)dword_1C02496E0 > 5 && tlgKeywordOn((__int64)&dword_1C02496E0, 0x400000000000LL) )
      {
