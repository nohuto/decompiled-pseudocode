/*
 * XREFs of LookUpTableFlushComplete @ 0x1C02BF8EC
 * Callers:
 *     TlgAggregateFlush @ 0x1C02358C4 (TlgAggregateFlush.c)
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C02BFCF0 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C02C09A0 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 * Callees:
 *     _tlgKeywordOn @ 0x1C0053E90 (_tlgKeywordOn.c)
 *     FlushLookUpTableBucket @ 0x1C00B69A4 (FlushLookUpTableBucket.c)
 ...
 *     UpdateInternalStatsOnFlush @ 0x1C02BFA78 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C0288748 > 5 && tlgKeywordOn((__int64)&dword_1C0288748, 0x200000000000LL) )
      {
        v7 = *(_QWORD *)(a1 + 344);
        v49 = 32;
        v8 = *(_QWORD *)(v7 + 8);
