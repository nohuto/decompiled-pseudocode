/*
 * XREFs of ?SatisfyNonPointerInputSinkInfoRequest@CSpatialProcessor@@KAXAEBU_InputHitTestResult@@@Z @ 0x1C01F26EC
 * Callers:
  ...
  if ( v4 )
  {
    ...
    else
    {
      ...
      if ( (gInputSinkInfoRetrieval & 1) != 0 )
        qword_1C0296F14 = *((_QWORD *)Object + 2);
      if ( (gInputSinkInfoRetrieval & 4) != 0 )
      {
        xmmword_1C0296F28 = *((_OWORD *)a1 + 1);
        xmmword_1C0296F38 = *((_OWORD *)a1 + 2);
        xmmword_1C0296F48 = *((_OWORD *)a1 + 3);
        xmmword_1C0296F58 = *((_OWORD *)a1 + 4);
      }
      if ( (gInputSinkInfoRetrieval & 8) != 0 )
        dword_1C0296F68 = *((_DWORD *)a1 + 22);
      if ( (gInputSinkInfoRetrieval & 2) != 0 && dword_1C0296F0C == 6 )
      {
        Object = 0LL;
        ...
        if ( Object )
        {
          qword_1C0296F20 = (__int64)Object;
