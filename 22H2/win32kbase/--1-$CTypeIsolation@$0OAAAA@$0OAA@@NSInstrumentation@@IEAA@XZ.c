/*
 * XREFs of ??1?$CTypeIsolation@$0OAAAA@$0OAA@@NSInstrumentation@@IEAA@XZ @ 0x1C00D34C8
 * Callers:
...
void __fastcall NSInstrumentation::CTypeIsolation<917504,3584>::~CTypeIsolation<917504,3584>(__int64 a1)
{
