/*
 * XREFs of ??$SyncMessage@$07@DispBrokerClient@DispBroker@@QEAAJPEAU?$AlpcRequest@$07@1@PEAU?$AlpcReply@$07@1@@Z @ 0x1C0115A10
 * Callers:
...
__int64 __fastcall DispBroker::DispBrokerClient::SyncMessage<8>(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v37 = *(_QWORD *)(a1 + 16);
  v38 = 72LL;
  v6 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD, __int64, __int64 *, _QWORD, unsigned __int64))qword_1C0250BA8)(
         1179648LL,
         a2,
         0LL,
         a3,
