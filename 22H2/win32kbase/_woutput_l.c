/*
 * XREFs of _woutput_l @ 0x1C00C6450
 * Callers:
 ...
 *     write_multi_char_0 @ 0x1C00C6D90 (write_multi_char_0.c)
 *     write_string_0 @ 0x1C00C6DE8 (write_string_0.c)
 *     _get_printf_count_output @ 0x1C00C6E74 (_get_printf_count_output.c)
