/*
 * XREFs of ?DxgkEngSetDisplayModeCallback@@YAJU_LUID@@I@Z @ 0x1C000D900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkEngSetDisplayModeCallback(struct _LUID a1, unsigned int a2)
{
    ...
    if ( v26 && (*(int *)(v26 + 24) > 0 || *(_DWORD *)(v38 + 48)) )
    {
      ...
      if ( (unsigned int)dword_1C024AA90 > 6 )
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 0x2000LL, v27, v28) )
        {
          ...
          v43 = 4LL;
          v42 = &v34;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C0217FD7, (int)&ActivityId, 0, 3u, &v41);
        }
      }
    }
  }
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v38 && (*(_DWORD *)(v38 + 48) || *(int *)(v38 + 24) > 0) )
  {
    ...
    *(GUID *)(v38 + 28) = ActivityId;
    if ( (unsigned int)dword_1C024AA90 > 6 )
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 0x2000LL, (unsigned int)dword_1C024AA90, v11) )
      {
        v33 = v39;
        v46 = 4LL;
        v45 = &v33;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C0217F80, (int)&ActivityId, 0, 3u, &v44);
      ...
      if ( (unsigned int)v29 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 0x2000LL, v29, v30) )
      {
        ...
        v49 = 4LL;
        v48 = &v35;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C0217FAD, (int)&ActivityId, 0, 3u, &v47);
      }
    }
  }
  ...
  if ( (int)IsUserResetPointerSupported() >= 0 && qword_1C0255038 )
    qword_1C0255038();
