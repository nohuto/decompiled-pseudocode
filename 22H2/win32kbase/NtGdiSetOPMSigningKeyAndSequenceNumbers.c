/*
 * XREFs of NtGdiSetOPMSigningKeyAndSequenceNumbers @ 0x1C015CCD0
 * Callers:
 *     <none>
 * Callees:
 *     SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_ENCRYPTED_PARAMETERS_ @ 0x1C015AF4C (SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_ENCRYPTED_PARAMETERS_.c)
