/*
 * XREFs of ?InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z @ 0x1C00B17F8
 * Callers:
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    v4 = v5;
    if ( v5 < 0
      || (v7 = RtlAddAccessAllowedAce(Acl, 2u, 1u, &unk_1C0249948), v6 = Acl, v4 = v7, v7 < 0)
