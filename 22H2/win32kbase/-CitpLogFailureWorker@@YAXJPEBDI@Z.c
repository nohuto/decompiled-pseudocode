/*
 * XREFs of ?CitpLogFailureWorker@@YAXJPEBDI@Z @ 0x1C01FDFC0
 * Callers:
 ...
 *     ?CitpProgramIdCopy@@YAJPEAU_CIT_PROGRAM_ID@@PEBU1@@Z @ 0x1C01FE750 (-CitpProgramIdCopy@@YAJPEAU_CIT_PROGRAM_ID@@PEBU1@@Z.c)
 * Callees:
...
void __fastcall CitpLogFailureWorker(__int64 a1, const char *a2)
{
  ...
  v7 = a2;
  if ( (unsigned int)dword_1C0249250 > 5 && tlgKeywordOn((__int64)&dword_1C0249250, 0x200000000800LL) )
  {
    LODWORD(v7) = v3;
