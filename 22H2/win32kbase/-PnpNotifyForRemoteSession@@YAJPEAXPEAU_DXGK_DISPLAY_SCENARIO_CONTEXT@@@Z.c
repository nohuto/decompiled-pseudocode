/*
 * XREFs of ?PnpNotifyForRemoteSession@@YAJPEAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01186D0
 * Callers:
...
LABEL_9:
    ...
    if ( (unsigned int)UserRemoteConnectedSessionUsingXddm() )
    {
      ...
      {
        if ( qword_1C0256628 )
          qword_1C0256628(&v4, 0LL);
      }
    }
    return 0LL;
  }
  if ( (int)IsxxxSetCsrssThreadDesktopSupported() < 0
    || (!qword_1C0256618 ? (result = 3221225659LL) : (result = qword_1C0256618(grpdeskRitInput, &v4)), (int)result >= 0) )
  {
