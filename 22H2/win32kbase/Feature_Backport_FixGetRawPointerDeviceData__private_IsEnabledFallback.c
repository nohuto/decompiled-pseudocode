/*
 * XREFs of Feature_Backport_FixGetRawPointerDeviceData__private_IsEnabledFallback @ 0x1C00D3F2C
 * Callers:
...
{
  return wil_details_IsEnabledFallback(a1, a2, &Feature_Backport_FixGetRawPointerDeviceData__private_descriptor);
}
