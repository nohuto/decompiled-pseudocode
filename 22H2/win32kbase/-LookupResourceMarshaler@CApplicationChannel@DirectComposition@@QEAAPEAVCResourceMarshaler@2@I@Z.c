/*
 * XREFs of ?LookupResourceMarshaler@CApplicationChannel@DirectComposition@@QEAAPEAVCResourceMarshaler@2@I@Z @ 0x1C002EB40
 * Callers:
        ...
        int a2)
{
  ...
  if ( a2 && v2 < *((_QWORD *)this + 10) )
    v3 = *(DirectComposition::CResourceMarshaler **)(*((_QWORD *)this + 11) * v2 + *((_QWORD *)this + 7));
  else
    v3 = 0LL;
  if ( (unsigned int)Feature_29159638__private_IsEnabledDeviceUsage() && v3 )
