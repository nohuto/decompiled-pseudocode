/*
 * XREFs of ?EmitSetMaxScale@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01EFC8C
 * Callers:
...
char __fastcall DirectComposition::CInteractionTrackerMarshaler::EmitSetMaxScale(
