/*
 * XREFs of ?RemoveEdgeZonesForDevice@DelayZonePalmRejection@@QEAA_NPEAX@Z @ 0x1C01E71EC
 * Callers:
 *     RemoveAllEdgePalmRejectionZonesForDevice @ 0x1C01E75D0 (RemoveAllEdgePalmRejectionZonesForDevice.c)
 * Callees:
