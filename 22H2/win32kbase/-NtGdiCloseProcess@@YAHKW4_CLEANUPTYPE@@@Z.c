/*
 * XREFs of ?NtGdiCloseProcess@@YAHKW4_CLEANUPTYPE@@@Z @ 0x1C0073B1C
 * Callers:
...
__int64 __fastcall NtGdiCloseProcess(GdiHandleManager *a1, unsigned int a2)
{
  ...
  if ( a2 == 2 )
  {
    ...
    v5 = qword_1C0255960 ? qword_1C0255960() : -1073741637;
    if ( v5 >= 0 && qword_1C0255968 )
      qword_1C0255968(2LL);
  }
  vCleanupDCs(v3);
  if ( a2 == 2 )
  ...
  else
  {
    ...
    v20 = qword_1C02559A0 ? qword_1C02559A0() : -1073741637;
    if ( v20 < 0 )
      goto LABEL_78;
    v19 = (void (*)(void))qword_1C02559A8;
  }
  if ( v19 )
    v19();
LABEL_78:
