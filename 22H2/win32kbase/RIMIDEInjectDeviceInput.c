/*
 * XREFs of RIMIDEInjectDeviceInput @ 0x1C0168A78
 * Callers:
 ...
 *     ?RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z @ 0x1C0166BEC (-RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z.c)
