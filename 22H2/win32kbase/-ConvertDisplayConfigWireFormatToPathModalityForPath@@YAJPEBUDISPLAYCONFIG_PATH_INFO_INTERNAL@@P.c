/*
 * XREFs of ?ConvertDisplayConfigWireFormatToPathModalityForPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C0143678
 * Callers:
      ...
      if ( (_DWORD)v13 )
      {
        ...
        if ( (_DWORD)v13 )
        {
          ...
          if ( (_DWORD)v13 )
          {
            if ( (_DWORD)v13 != 1 )
            {
              v6 = WdLogNewEntry5_WdError(v13, v10);
              v7 = *((int *)a1 + 44);
              goto LABEL_9;
            }
