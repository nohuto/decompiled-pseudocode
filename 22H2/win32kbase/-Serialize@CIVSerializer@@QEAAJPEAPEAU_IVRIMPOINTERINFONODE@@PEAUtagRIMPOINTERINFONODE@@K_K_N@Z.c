/*
 * XREFs of ?Serialize@CIVSerializer@@QEAAJPEAPEAU_IVRIMPOINTERINFONODE@@PEAUtagRIMPOINTERINFONODE@@K_K_N@Z @ 0x1C01B7174
 * Callers:
  ...
  *v10 = v11;
  if ( v8 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(v14 + 68) = _mm_cvtsi128_si32(_mm_srli_si128(v20, 8));
      v14 += 176LL;
      --v13;
    }
    while ( v13 );
