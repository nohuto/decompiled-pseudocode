/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C020008C
 * Callers:
 ...
 *     GetImageTuple @ 0x1C020000C (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C0200788 (_tlgCreate1Sz_char.c)
 */
...
LABEL_45:
  ...
  if ( v40 )
  {
    if ( (unsigned int)dword_1C027D040 > 5 && tlgKeywordOn((__int64)&dword_1C027D040, 0x400000000000LL) )
    {
      v41 = 10;
      v83 = &v41;
      v25 = "<unknown>";
      ...
      tlgWriteTransfer_EtwWriteTransfer(v28, (unsigned __int8 *)dword_1C0222721, 0LL, v27, 0xEu, &v82);
    }
  }
  else if ( (unsigned int)dword_1C027D040 > 5 && tlgKeywordOn((__int64)&dword_1C027D040, 0x400000000000LL) )
  {
    v51 = 10;
    v105 = &v51;
    v30 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer(v33, byte_1C02227CB, 0LL, v32, 0xBu, &v104);
  }
  if ( dword_1C027D078 && !v58 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C027D040 > 5 && tlgKeywordOn((__int64)&dword_1C027D040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C027D040,
        (unsigned __int8 *)dword_1C0222838,
        0LL,
        0LL,
        v35,
        &v66);
