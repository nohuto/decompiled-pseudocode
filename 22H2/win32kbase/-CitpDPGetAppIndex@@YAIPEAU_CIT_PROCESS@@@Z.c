/*
 * XREFs of ?CitpDPGetAppIndex@@YAIPEAU_CIT_PROCESS@@@Z @ 0x1C0097300
 * Callers:
...
__int64 __fastcall CitpDPGetAppIndex(struct _CIT_PROCESS *a1)
{
  ...
  v7 = 0;
  v8 = (PCUNICODE_STRING *)&unk_1C0203E40;
  ...
  if ( *(_DWORD *)v8 > 6u )
  {
    ...
    {
      case 7u:
        if ( (unsigned int)dword_1C024AC7C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C024AC70;
          goto LABEL_25;
        }
        break;
      case 8u:
        if ( (unsigned int)dword_1C02493DC < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C02493D0;
          goto LABEL_25;
        }
        break;
      case 9u:
        if ( (unsigned int)dword_1C024ACAC < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C024ACA0;
          goto LABEL_25;
        }
        break;
      default:
        if ( v1 == 10 && (unsigned int)dword_1C024AC94 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C024AC88;
          goto LABEL_25;
        }
  ...
  else
  {
    ...
    {
      case 6u:
        if ( (unsigned int)dword_1C024AC64 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C024AC58;
          goto LABEL_25;
        }
        break;
      case 1u:
        if ( (unsigned int)dword_1C024940C < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C0249400;
LABEL_25:
        ...
        break;
      case 2u:
        if ( (unsigned int)dword_1C02493F4 >= MEMORY[0xFFFFF7800000037C] )
          break;
        v10 = &off_1C02493E8;
        goto LABEL_25;
      case 3u:
        if ( (unsigned int)dword_1C024ACC4 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C024ACB8;
          goto LABEL_25;
        }
        break;
      case 4u:
        if ( (unsigned int)dword_1C02493AC < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C02493A0;
          goto LABEL_25;
        }
        break;
      default:
        if ( v1 == 5 && (unsigned int)dword_1C02493C4 < MEMORY[0xFFFFF7800000037C] )
        {
          v10 = &off_1C02493B8;
          goto LABEL_25;
        }
