/*
 * XREFs of ?EmitUpdateCommands@CAnimationLoggingManagerMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0022A90
 * Callers:
 *     <none>
 * Callees:
 *     DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_b5cb463a5da8e155d664ecb81f54d32f___ @ 0x1C002171C (DirectComposition--CResourceMarshaler--EmitUpdateCommand__lambda_b5cb463a5da8e155d664ecb81f54d32.c)
 *     DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_c3840c43712c8b40effe27ed20e64dbf___ @ 0x1C002179C (DirectComposition--CResourceMarshaler--EmitUpdateCommand__lambda_c3840c43712c8b40effe27ed20e64db.c)
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (v4 & 2) == 0 )
  {
    ...
    v4 = (2
        * DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_c3840c43712c8b40effe27ed20e64dbf___(
            (__int64)this,
            a2,
            (__int64)&v8)) | *((_BYTE *)this + 256) & 0xFD;
    *((_BYTE *)this + 256) = v4;
  }
  v5 = 0;
  if ( (v4 & 2) != 0
    ...
    && DirectComposition::CAnimationLoggingManagerMarshaler::EmitSetCompositorComment(this, a2) )
  {
    ...
    if ( (v6 & 0x20) == 0 )
    {
      if ( !DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_b5cb463a5da8e155d664ecb81f54d32f___(
              (__int64)this,
              a2,
              (__int64)&v8) )
        return v5;
