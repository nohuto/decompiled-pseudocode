/*
 * XREFs of NtUserCreatePalmRejectionDelayZone @ 0x1C0143570
 * Callers:
 *     <none>
 * Callees:
 ...
 *     AddPalmRejectionDelayZone @ 0x1C01E7534 (AddPalmRejectionDelayZone.c)
 */

__int64 __fastcall NtUserCreatePalmRejectionDelayZone(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  void *v5; // r15
