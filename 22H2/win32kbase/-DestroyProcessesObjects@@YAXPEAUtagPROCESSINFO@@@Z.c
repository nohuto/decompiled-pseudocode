/*
 * XREFs of ?DestroyProcessesObjects@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C0034600
 * Callers:
 ...
 *     FixupGlobalCursor @ 0x1C00AA470 (FixupGlobalCursor.c)
...
void __fastcall DestroyProcessesObjects(struct tagPROCESSINFO *a1)
{
  ...
  if ( qword_1C0252F18 )
  {
    ...
    if ( (unsigned int)GreGetObjectOwner((unsigned int)qword_1C0252F10, 1) == (CurrentProcessId & 0xFFFFFFFC) )
    {
      if ( qword_1C0256BF0 )
        qword_1C0256BF0();
    }
  ...
  v8 = (struct _HANDLEENTRY *)((char *)qword_1C024FA38 + 32 * (unsigned int)giheLast);
  if ( qword_1C024FA38 <= v8 )
  {
    do
    {
      v9 = *((unsigned __int8 *)v6 + 24);
      if ( (_BYTE)v9 && (*((_BYTE *)&unk_1C020946C + 24 * v9) & 2) != 0 && (struct tagPROCESSINFO *)v7[1] == a1 )
      {
        if ( v2 && (_BYTE)v9 == 3 )
        ...
        if ( v10 && gptiRit )
        {
          if ( v10 == 3 )
          {
            if ( qword_1C0256868 && (int)qword_1C0256868() >= 0 )
            {
              if ( qword_1C0256870 )
                qword_1C0256870(*v7);
            }
