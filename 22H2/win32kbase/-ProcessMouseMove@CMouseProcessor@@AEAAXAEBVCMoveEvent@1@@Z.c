/*
 * XREFs of ?ProcessMouseMove@CMouseProcessor@@AEAAXAEBVCMoveEvent@1@@Z @ 0x1C0040034
 * Callers:
 ...
 *     ?AnalyzeNewMousePosition@CMouseProcessor@@AEBA?AW4MoveNewPosResult@1@AEBVCMouseEvent@1@@Z @ 0x1C009FF80 (-AnalyzeNewMousePosition@CMouseProcessor@@AEBA-AW4MoveNewPosResult@1@AEBVCMouseEvent@1@@Z.c)
...
LABEL_5:
    ...
    if ( (unsigned int)dword_1C024AA90 > 4
      && (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 64LL, v6, *((_QWORD *)v2 + 1)) )
    {
      ...
      v42 = 4LL;
      v40 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C021FB61, 0, 0, 6u, &v38);
    }
    if ( !v37[0] )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
