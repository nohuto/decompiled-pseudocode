/*
 * XREFs of ?Grow@?$CDynamicArray@E$0HHHAHDFF@@@IEAAJI@Z @ 0x1C0029CDC
 * Callers:
 ...
 *     ??$AddProperty@UD2DQuaternion@@@?$PropertySetStorage@VCDynamicArrayDefaultTag@@VPropertySetKernelModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DQuaternion@@PEAI@Z @ 0x1C0224DD0 (--$AddProperty@UD2DQuaternion@@@-$PropertySetStorage@VCDynamicArrayDefaultTag@@VPropertySetKerne.c)
 * Callees:
...
__int64 __fastcall CDynamicArray<unsigned char,2003858261>::Grow(__int64 a1, unsigned int a2)
{
  ...
  unsigned int v16; // [rsp+118h] [rbp+6Fh] BYREF
  ...
  if ( v3 <= *(_DWORD *)(a1 + 12) )
    return v4;
  v13[0] = (v3 * (unsigned __int128)1u) >> 64;
  v5 = v3;
  ...
  {
    Pool2 = ExAllocatePool2(262LL, v3, 2003858261LL);
    if ( Pool2 )
...
LABEL_7:
  ...
  if ( v7 == 1 )
  {
    if ( !NSInstrumentation::CLeakTrackingAllocator::EnsurePoolTagIncrement(gpLeakTrackingAllocator, 0x77707355u)
      || (unsigned __int64)v3 + 16 < v3 )
    {
      return (unsigned int)-1073741801;
    }
    v10 = (_QWORD *)ExAllocatePool2(v17 | 2, v3 + 16LL, v16);
    Pool2 = (__int64)v10;
    if ( !v10
      || (_InterlockedIncrement64((volatile signed __int64 *)v6 + 14),
          *v10 = 2003858261LL,
  ...
  if ( v7 != 2 )
    return (unsigned int)-1073741801;
  v15 = 0LL;
  if ( !NSInstrumentation::CLeakTrackingAllocator::IsTagTracked(gpLeakTrackingAllocator, 0x77707355u, &v15) )
  {
    v13[0] = &v17;
    v13[1] = &v16;
  ...
  v12 = 0;
  if ( v3 < 0x1000uLL || (v3 & 0xFFF) != 0 )
  {
    v5 = v3 + 16LL;
    v12 = 1;
    v18 = v5;
  }
  Pool2 = ExAllocatePool2(262LL, v5, v11);
  if ( !Pool2 )
    return (unsigned int)-1073741801;
...
LABEL_8:
  if ( *(_QWORD *)a1 )
  {
    memmove((void *)Pool2, *(const void **)a1, *(unsigned int *)(a1 + 8));
    if ( *(_QWORD *)a1 )
