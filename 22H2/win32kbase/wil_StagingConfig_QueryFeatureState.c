/*
 * XREFs of wil_StagingConfig_QueryFeatureState @ 0x1C027F248
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C011467C (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00C5400 (__security_check_cookie.c)
 *     memset @ 0x1C00CF8C0 (memset.c)
 *     wil_details_StagingConfig_Load @ 0x1C0114818 (wil_details_StagingConfig_Load.c)
 *     wil_details_StagingConfig_QueryFeatureState @ 0x1C0114B14 (wil_details_StagingConfig_QueryFeatureState.c)
 */
