/*
 * XREFs of ?ProcessInput@CPTPProcessor@@QEAAXPEAX0HHH@Z @ 0x1C01A6D70
 * Callers:
 ...
 *     ?UpdateEnvironment@CPTPProcessor@@AEAAXW4EnvironmentUpdateOptions@@PEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01A7C24 (-UpdateEnvironment@CPTPProcessor@@AEAAXW4EnvironmentUpdateOptions@@PEAUtagHID_POINTER_DEVICE_INF.c)
  ...
  *((LARGE_INTEGER *)this + 285) = KeQueryPerformanceCounter(0LL);
  ...
  if ( v10 )
  {
    ...
    *(_QWORD *)((char *)this + 956) = *(_QWORD *)(*((_QWORD *)v12 + 17) + 248LL);
    ...
    v18 = qword_1C0254EF0;
    if ( qword_1C0254EF0 != *((_QWORD *)this + 278) )
    {
      *((_QWORD *)this + 278) = qword_1C0254EF0;
      if ( v18 )
      {
        v19 = *(_QWORD *)v16;
    ...
    v24 = qword_1C0254EF8;
    if ( qword_1C0254EF8 != *((_QWORD *)this + 279) )
    {
      *((_QWORD *)this + 279) = qword_1C0254EF8;
      if ( v24 )
      {
        v25 = *(_QWORD *)v16;
