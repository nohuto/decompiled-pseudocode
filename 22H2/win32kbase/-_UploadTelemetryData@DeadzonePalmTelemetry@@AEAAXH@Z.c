/*
 * XREFs of ?_UploadTelemetryData@DeadzonePalmTelemetry@@AEAAXH@Z @ 0x1C01B193C
 * Callers:
 ...
 *     ?RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z @ 0x1C01B1178 (-RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z.c)
...
void __fastcall DeadzonePalmTelemetry::_UploadTelemetryData(DeadzonePalmTelemetry *this, int a2)
{
  ...
  if ( a2 || (unsigned int)(v4 - *((_DWORD *)this + 2)) >= 0x2710 )
  {
    ...
    do
    {
      ...
      {
        if ( (unsigned int)dword_1C0288330 > 5 && tlgKeywordOn((__int64)&dword_1C0288330, 0x400000000000LL) )
        {
          v16 = (__int64)v2;
          _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>>(
            (__int64)&dword_1C0288330,
            byte_1C025ACF1,
            0LL,
            0LL,
            (void **)&v16);
