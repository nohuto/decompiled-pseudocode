/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0OAAAA@$0OAA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1C00C8AFC
 * Callers:
 ...
 *     ?Create@?$CSectionEntry@$0OAAAA@$0OAA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00C8DAC (-Create@-$CSectionEntry@$0OAAAA@$0OAA@@NSInstrumentation@@SAPEAV12@XZ.c)
...
PSLIST_ENTRY __fastcall NSInstrumentation::CTypeIsolation<917504,3584>::Allocate(__int64 a1)
{
