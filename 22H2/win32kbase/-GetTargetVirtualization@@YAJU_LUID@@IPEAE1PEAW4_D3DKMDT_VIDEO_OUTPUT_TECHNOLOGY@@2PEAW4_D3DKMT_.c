/*
 * XREFs of ?GetTargetVirtualization@@YAJU_LUID@@IPEAE1PEAW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@2PEAW4_D3DKMT_DISPLAY_TARGET_USAGE@@@Z @ 0x1C014581C
 * Callers:
        ...
        enum _D3DKMT_DISPLAY_TARGET_USAGE *a7)
{
  ...
  v17 = a2;
  v16 = a1;
  v9 = ((__int64 (__fastcall *)(struct _LUID *, __int64, struct _LUID *, unsigned int *))qword_1C0250AC0)(
         &v16,
         a2,
         &v16,
         &v17);
  v12 = v9;
  if ( v9 < 0
    || (v13 = ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))qword_1C0250AD0)(
                v16,
                v17,
                a3,
                a4,
