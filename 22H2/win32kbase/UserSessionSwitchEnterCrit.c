/*
 * XREFs of UserSessionSwitchEnterCrit @ 0x1C0087EE0
 * Callers:
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v66 && (*(_DWORD *)(v66 + 48) || *(int *)(v66 + 24) > 0) )
  {
    ...
    *(GUID *)(v66 + 28) = ActivityId_8;
    if ( (unsigned int)dword_1C024AA90 > 6 )
    {
      ...
      if ( v50 > 6 && tlgKeywordOn((__int64)&dword_1C024AA90, 0x2000LL) )
      {
        v62 = ActivityId_4;
        v80 = 4LL;
        v79 = &v62;
  ...
  while ( gfSwitchInProgress )
  {
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v53 )
      {
        ...
        {
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C0217F61, v54 + 28, 0, 2u, &v90);
        }
        *(_DWORD *)(v54 + 44) = 0;
        *(_OWORD *)(v54 + 28) = 0LL;
      }
