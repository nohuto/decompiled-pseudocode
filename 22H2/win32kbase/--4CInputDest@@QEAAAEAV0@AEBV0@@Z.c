/*
 * XREFs of ??4CInputDest@@QEAAAEAV0@AEBV0@@Z @ 0x1C009F1DC
 * Callers:
 ...
 *     ?SetForeground@CForegroundInfo@@QEAAXAEBVCInputDest@@@Z @ 0x1C01A3550 (-SetForeground@CForegroundInfo@@QEAAXAEBVCInputDest@@@Z.c)
 * Callees:
