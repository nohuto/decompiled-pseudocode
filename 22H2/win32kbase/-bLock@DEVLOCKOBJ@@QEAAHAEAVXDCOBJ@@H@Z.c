/*
 * XREFs of ?bLock@DEVLOCKOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C003B780
 * Callers:
...
__int64 __fastcall DEVLOCKOBJ::bLock(DEVLOCKOBJ *this, DC **a2, int a3)
{
  ...
  *((_QWORD *)this + 13) = *(_QWORD *)*a2;
  ...
  {
    if ( !qword_1C0255880
      || (int)qword_1C0255880() < 0
      || !qword_1C0255888
      || (v7 = qword_1C0255888(a2, (char *)this + 96, (char *)this + 88, (char *)this + 28), v7 != 1) )
    {
      LOBYTE(v7) = 0;
    }
    if ( !(_BYTE)v7 )
  ...
  if ( qword_1C0255310 && (int)qword_1C0255310() >= 0 && qword_1C0255318 )
    qword_1C0255318(this, 0LL);
  if ( a3 == 1 )
