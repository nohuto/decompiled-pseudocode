/*
 * XREFs of ?CitpSetAudioInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1C00A8630
 * Callers:
...
__int64 __fastcall CitpSetAudioInfo(union _CIT_SI_INFOFLAGS *a1, union _CIT_SI_INFO *a2)
{
  ...
  if ( v4 )
  {
    if ( (unsigned int)dword_1C024AB14 < MEMORY[0xFFFFF7800000037C] )
      EtwTelemetryCoverageReport(&off_1C024AB08);
    v11 = (char *)(v7 + 11);
    v12 = 10LL;
    if ( v10 )
      v9 = (char *)v10 + 116;
  ...
  {
    if ( (unsigned int)dword_1C024934C < MEMORY[0xFFFFF7800000037C] )
      EtwTelemetryCoverageReport(&off_1C0249340);
    v11 = (char *)v7 + 89;
    v12 = 11LL;
    if ( v10 )
      v9 = (char *)v10 + 124;
