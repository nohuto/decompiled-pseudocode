/*
 * XREFs of ApiSetEditionPostAccessibility @ 0x1C01CD030
 * Callers:
 *     ?FKActivationTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01831C0 (-FKActivationTimer@@YAXPEAUtagWND@@I_K_J@Z.c)
 *     ?MKButtonSelect@@YAHG@Z @ 0x1C01836A0 (-MKButtonSelect@@YAHG@Z.c)
...
__int64 __fastcall ApiSetEditionPostAccessibility(unsigned int a1)
{
  ...
  if ( qword_1C02571D8 )
    result = qword_1C02571D8();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C02571E0;
    if ( qword_1C02571E0 )
      result = qword_1C02571E0(a1);
  }
