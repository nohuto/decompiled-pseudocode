/*
 * XREFs of GreCreateBitmap @ 0x1C0028610
 * Callers:
  ...
  else
  {
    ...
    if ( v14 )
    {
      *(_DWORD *)(v14 + 112) |= 0x4000000u;
      ...
      {
        v22 = 0;
        v13 = qword_1C02558D0 ? qword_1C02558D0() : -1073741637;
        if ( v13 >= 0 && qword_1C02558D8 )
          qword_1C02558D8(*(_QWORD *)(v14 + 32), (unsigned int)v7, a5, &v22);
      }
      if ( v8 != 1 )
      {
