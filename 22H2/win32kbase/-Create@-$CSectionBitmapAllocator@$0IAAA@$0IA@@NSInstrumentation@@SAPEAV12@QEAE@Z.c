/*
 * XREFs of ?Create@?$CSectionBitmapAllocator@$0IAAA@$0IA@@NSInstrumentation@@SAPEAV12@QEAE@Z @ 0x1C000B970
 * Callers:
 ...
 * Callees:
 *     ?Initialize@?$CSectionBitmapAllocator@$0IAAA@$0IA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C000B9E8 (-Initialize@-$CSectionBitmapAllocator@$0IAAA@$0IA@@NSInstrumentation@@AEAA_NPEAE@Z.c)
 */

__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<32768,128>::Create(__int64 a1)
{
  __int64 Pool2; // rax
  __int64 v3; // rbx
