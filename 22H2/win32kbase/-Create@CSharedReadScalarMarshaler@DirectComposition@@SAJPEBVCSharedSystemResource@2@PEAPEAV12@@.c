/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F8C58
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C01F8E30 (CreateSharedReadScalarMarshaler.c)
 * Callees:
