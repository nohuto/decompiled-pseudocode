/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@K@Z @ 0x1C00055C0
 * Callers:
 ...
 *     ?InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z @ 0x1C0193084 (-InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z.c)
 */
...
void __fastcall InputTraceLogging::RIM::InjectInput(__int64 a1)
{
  ...
  {
    if ( (unsigned int)dword_1C0289810 > 4 && v2 == 1 && (unsigned __int8)tlgKeywordOn(&dword_1C0289810, 256LL) )
    {
LABEL_21:
      LODWORD(v21) = v14;
      v22 = v15;
