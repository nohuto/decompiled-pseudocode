/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@K@Z @ 0x1C0166948
 * Callers:
 ...
 *     ?InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z @ 0x1C0166B7C (-InjectionSourceToString@InputTraceLogging@@CAPEBDW4InputTracing_RimInjectionSource@@@Z.c)
 */
...
char __fastcall InputTraceLogging::RIM::InjectInput(__int64 a1)
{
  ...
  if ( (_BYTE)v1 != 2 )
  {
    if ( (_BYTE)v1 )
    {
      ...
      v24 = (unsigned __int8 *)&unk_1C021AD91;
    }
    else
    {
      if ( (unsigned int)dword_1C024AA90 <= 4 )
      ...
      v24 = (unsigned __int8 *)&unk_1C021ACE6;
    }
    v32 = v21;
  ...
  else if ( (unsigned int)dword_1C024AA90 > 4 )
  {
    ...
    if ( (_BYTE)v1 )
    {
      ...
      LOBYTE(v1) = _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
                     (__int64)&dword_1C024AA90,
                     (unsigned __int8 *)dword_1C021AD23,
                     v11,
                     v10,
                     (__int64)&v32,
                     (void **)&v31,
