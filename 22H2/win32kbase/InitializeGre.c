...
char __fastcall InitializeGre(Gre::Base *a1)
{
  ...
  if ( Gre::Base::AllocateSessionGlobalsArea(a1)
    && (!qword_1C0294F08 || (int)qword_1C0294F08() < 0 || qword_1C0294F10 && (unsigned int)qword_1C0294F10()) )
  {
    ...
    *(_BYTE *)(v2 + 2380) = (RtlGetSuiteMask() & 0x10) != 0;
    ...
    {
      if ( qword_1C0294A08 && (int)qword_1C0294A08() >= 0 && qword_1C0294A10 )
        qword_1C0294A10();
      if ( (unsigned int)GreEngLoadModuleTrackInit()
        && (!qword_1C0294A18 || (int)qword_1C0294A18() < 0 || qword_1C0294A20 && (unsigned int)qword_1C0294A20()) )
      {
        *(_DWORD *)(v2 + 180) = bLockEtwEnabled();
        if ( (unsigned int)HmgCreate(v4) )
        {
          ...
          {
            *(_DWORD *)(v2 + 6384) = 1;
            if ( qword_1C0294A28 && (int)qword_1C0294A28() >= 0 )
            {
              v6 = 0LL;
              v32 = 0LL;
              BitMapBuffer = 0LL;
              ...
              if ( qword_1C0294A30 )
              {
                qword_1C0294A30(&v32, &BitMapBuffer, &BitMapHeader, &v34);
                v6 = v32;
              }
                                                ...
                                                if ( (unsigned int)bInitPALOBJ() )
                                                {
                                                  ...
                                                  if ( (unsigned int)bInitBMOBJ() )
                                                  {
                                                    if ( (unsigned int)bInitBRUSHOBJ(v24)
                                                      ...
                                                      && (!qword_1C0294A48
                                                       || (int)qword_1C0294A48() < 0
                                                       || qword_1C0294A50 && (unsigned int)qword_1C0294A50()) )
                                                    {
                                                      if ( qword_1C0294A58 && (int)qword_1C0294A58() >= 0 )
                                                      {
                                                        if ( qword_1C0294A60 )
                                                          qword_1C0294A60();
                                                      }
