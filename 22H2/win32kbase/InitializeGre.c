/*
 * XREFs of InitializeGre @ 0x1C02990FC
 * Callers:
 ...
 *     ?bUseActualGDIScale@@YAHXZ @ 0x1C00A0580 (-bUseActualGDIScale@@YAHXZ.c)
 *     ?Initialize@SfmState@@QEAAHXZ @ 0x1C00A0624 (-Initialize@SfmState@@QEAAHXZ.c)
 *     GreCreateRectRgn @ 0x1C00A07E0 (GreCreateRectRgn.c)
 *     bLockEtwEnabled @ 0x1C00A08F8 (bLockEtwEnabled.c)
 *     GreCreateSemaphoreNonTracked @ 0x1C00A09AC (GreCreateSemaphoreNonTracked.c)
 *     ?InitializeDefaultDCAttributes@@YAXXZ @ 0x1C00A0A00 (-InitializeDefaultDCAttributes@@YAXXZ.c)
...
char InitializeGre()
{
  ...
  RtlGetSuiteMask();
  qword_1C0254330 = (__int64)&MultiUserGreEngAllocList;
  ...
  if ( MultiUserEngAllocListLock )
  {
    ...
    if ( qword_1C02555F0 )
      ...
      v1 = -1073741637;
    if ( v1 >= 0 && qword_1C02555F8 )
      qword_1C02555F8();
    qword_1C0254340 = (__int64)&GreEngLoadModuleAllocList;
    ...
    {
      v2 = qword_1C0255600 ? qword_1C0255600() : -1073741637;
      if ( v2 < 0 || (!qword_1C0255608 ? (v3 = 0) : (v3 = qword_1C0255608()), v3) )
      {
        ...
        if ( (unsigned int)HmgCreate() )
        {
          if ( RGNMEMOBJ::InitializeScanLookAsideList() )
          {
            ...
            if ( v4 >= 0 )
            {
              ...
              if ( qword_1C0255618 )
              {
                qword_1C0255618(&v19, &BitMapBuffer, &BitMapHeader, &v21);
                v5 = v19;
              }
                                              ...
                                              if ( v17[0] )
                                              {
                                                ...
                                                if ( (unsigned int)bInitPALOBJ() )
                                                {
                                                  ...
                                                  if ( (unsigned int)bInitBMOBJ() )
                                                  {
                                                    ...
                                                    {
                                                      v8 = qword_1C0255620 ? qword_1C0255620() : -1073741637;
                                                      if ( v8 < 0
                                                        || (!qword_1C0255628 ? (v9 = 0) : (v9 = qword_1C0255628()), v9) )
                                                      {
                                                        v10 = qword_1C0255630 ? qword_1C0255630() : -1073741637;
                                                        if ( v10 < 0
                                                          || (!qword_1C0255638 ? (v11 = 0) : (v11 = qword_1C0255638()),
                                                              v11) )
                                                        {
                                                          if ( qword_1C0255640 )
                                                            v0 = qword_1C0255640();
