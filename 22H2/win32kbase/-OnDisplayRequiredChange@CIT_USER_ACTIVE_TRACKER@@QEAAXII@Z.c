/*
 * XREFs of ?OnDisplayRequiredChange@CIT_USER_ACTIVE_TRACKER@@QEAAXII@Z @ 0x1C00B27D0
 * Callers:
 *     CitDisplayRequestChange @ 0x1C00B2724 (CitDisplayRequestChange.c)
 * Callees:
...
LABEL_3:
  ...
  if ( *(_DWORD *)this && (unsigned int)(DWORD1(xmmword_1C0254564) + *((_DWORD *)this + 1)) < *((_DWORD *)this + 2) )
  {
    v5 = 0;
    goto LABEL_3;
  }
