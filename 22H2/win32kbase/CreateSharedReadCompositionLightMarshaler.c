/*
 * XREFs of CreateSharedReadCompositionLightMarshaler @ 0x1C0093FF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsCompositionLight@CSharedReadCompositionLightMarshaler@DirectComposition@@SA_NI@Z @ 0x1C00943C8 (-IsCompositionLight@CSharedReadCompositionLightMarshaler@DirectComposition@@SA_NI@Z.c)
 */
