/*
 * XREFs of McTemplateK0qqhhh_EtwWriteTransfer @ 0x1C013D688
 * Callers:
 *     EtwTraceDisplayChange @ 0x1C0138F20 (EtwTraceDisplayChange.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x1C0073658 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x1C00CDBD0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0qqhhh_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  v18 = &a8;
  v19 = 2LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &PowerDisplayEvent, &W32kControlGuid, 6u, &v9);
}
