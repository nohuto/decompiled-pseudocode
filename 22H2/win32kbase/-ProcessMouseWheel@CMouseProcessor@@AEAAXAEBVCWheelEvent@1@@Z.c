/*
 * XREFs of ?ProcessMouseWheel@CMouseProcessor@@AEAAXAEBVCWheelEvent@1@@Z @ 0x1C01C16DC
 * Callers:
 ...
 *     _anonymous_namespace_::ResolveApplicationFrameChildThread @ 0x1C01C1F14 (_anonymous_namespace_--ResolveApplicationFrameChildThread.c)
