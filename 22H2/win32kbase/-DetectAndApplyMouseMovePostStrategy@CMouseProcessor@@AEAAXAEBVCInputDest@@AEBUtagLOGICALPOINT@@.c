/*
 * XREFs of ?DetectAndApplyMouseMovePostStrategy@CMouseProcessor@@AEAAXAEBVCInputDest@@AEBUtagLOGICALPOINT@@AEBVCMoveEvent@1@PEAU_mouseCursorEvent@@@Z @ 0x1C0045EF8
 * Callers:
 ...
 *     ?GetUserWindow@CInputDest@@QEBAPEAUtagWND@@XZ @ 0x1C00CCC08 (-GetUserWindow@CInputDest@@QEBAPEAUtagWND@@XZ.c)
        ...
        struct _mouseCursorEvent *a5)
{
  ...
  if ( (unsigned int)dword_1C024AA90 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C024AA90, 64LL, v16, v17) )
  {
    v34 = Queue;
