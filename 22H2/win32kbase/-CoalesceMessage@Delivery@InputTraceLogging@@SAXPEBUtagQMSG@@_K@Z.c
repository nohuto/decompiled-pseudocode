/*
 * XREFs of ?CoalesceMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@_K@Z @ 0x1C01BCEB4
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CoalesceMessage(const struct tagQMSG *a1)
{
  ...
  {
    if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 16LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C025AE72,
        0LL,
        0LL,
        v2 - 8,
        &v18);
  ...
  else if ( (unsigned int)(v1 - 256) > 9 )
  {
    if ( ((unsigned int)(v1 - 512) <= 0xE || (unsigned int)(v1 - 160) <= 0xD)
      && (unsigned int)dword_1C0289810 > 4
      && tlgKeywordOn((__int64)&dword_1C0289810, 16LL) )
    {
      v15 = *(_QWORD *)(v10 + 136);
      v16 = v11;
      v12 = v9;
  ...
  else if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 16LL) )
  {
