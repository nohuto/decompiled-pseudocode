/*
 * XREFs of RIMIDE_InitializePointerDeviceInjection @ 0x1C0198FE0
 * Callers:
 *     NtUserInitializePointerDeviceInjectionEx @ 0x1C0146E70 (NtUserInitializePointerDeviceInjectionEx.c)
 *     ?CreateInjectionDevice@@YAHXZ @ 0x1C01EFB2C (-CreateInjectionDevice@@YAHXZ.c)
 * Callees:
        ...
        _QWORD *a7)
{
  ...
  if ( a7 )
    *a7 = 0LL;
  memmove(v21, &unk_1C0264EE0, 0xA0uLL);
  if ( a1 == 2 )
  {
    v12 = (char *)&unk_1C0264E00;
    v13 = 4;
    v14 = 10;
  }
  else
