/*
 * XREFs of TlgUnregisterAggregateProvider @ 0x1C027E8D8
 * Callers:
 *     ?Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x1C011BB50 (-Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z.c)
 * Callees:
 *     DestroyAggregateSession @ 0x1C027E9D0 (DestroyAggregateSession.c)
...
NTSTATUS __fastcall TlgUnregisterAggregateProvider(__int64 a1)
{
  ...
  {
    v2 = 0LL;
    ExAcquirePushLockExclusiveEx(&unk_1C02548D0, 0LL);
    v3 = qword_1C02548C8;
    v4 = &qword_1C02548C8;
    while ( v3 )
    {
