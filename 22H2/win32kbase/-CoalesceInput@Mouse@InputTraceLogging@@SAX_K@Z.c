/*
 * XREFs of ?CoalesceInput@Mouse@InputTraceLogging@@SAX_K@Z @ 0x1C00B7860
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::CoalesceInput()
{
  ...
  if ( (unsigned int)dword_1C024AA90 > 4 && tlgKeywordOn((__int64)&dword_1C024AA90, 64LL) )
  {
    ...
    v1 = v0;
    v4 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024AA90, (unsigned __int8 *)dword_1C021FE70, 0LL, 0LL, 3u, &v2);
  }
}
