/*
 * XREFs of rimObsObserveNextInput @ 0x1C01AE654
 * Callers:
 *     NtRIMObserveNextInput @ 0x1C0174ED0 (NtRIMObserveNextInput.c)
 *     RIMObserveNextInput @ 0x1C0179C50 (RIMObserveNextInput.c)
 * Callees:
