/*
 * XREFs of ?CitpInteractionSummaryStopTracking@@YAXPEAU_CIT_INTERACTION_SUMMARY@@I@Z @ 0x1C008F278
 * Callers:
 ...
 *     ?OnlyCompositionMetrics@@YAHPEBU_CIT_INTERACTION_SUMMARY@@U_CIT_INPUT_TIMES@@@Z @ 0x1C008F864 (-OnlyCompositionMetrics@@YAHPEBU_CIT_INTERACTION_SUMMARY@@U_CIT_INPUT_TIMES@@@Z.c)
 ...
 *     ?CitpAudioStatSnapDelta@@YAXPEAU_CIT_AUDIO_STATS@@@Z @ 0x1C00C0714 (-CitpAudioStatSnapDelta@@YAXPEAU_CIT_AUDIO_STATS@@@Z.c)
...
void __fastcall CitpInteractionSummaryStopTracking(struct _CIT_INTERACTION_SUMMARY *a1, int a2)
{
  ...
  *(_QWORD *)v2 = v2;
  ...
  while ( v9 );
  if ( ((xmmword_1C0254574 & 0x10) == 0
     || *((_WORD *)v2 + 57) != 4
     || *((_WORD *)v2 + 54)
     && *((_WORD *)v2 + 55)
     && ((*((_BYTE *)v2 + 100) & 1) != 0 || (v10 = **(PVOID **)(*((_QWORD *)v2 + 3) + 8LL)) == 0LL || v10 != g_pepDwm))
    && ((xmmword_1C0254574 & 0x20) == 0
     || (*((_WORD *)v2 + 57) & 0xFFF3) != 0
     || (*((_WORD *)v2 + 57) & 8) == 0
     || *((_WORD *)v2 + 53) >= 3u
     || *((_WORD *)v2 + 54) && *((_WORD *)v2 + 55)) )
  {
    v11 = xmmword_1C0254590;
    v12 = a2 - *((_DWORD *)v2 + 23);
    v13 = a2 - *((_DWORD *)xmmword_1C0254590 + 218);
    v14 = *((_QWORD *)xmmword_1C0254590 + 105) + 1LL;
    v15 = *((_QWORD *)xmmword_1C0254590 + 108);
    *((_QWORD *)xmmword_1C0254590 + 105) = v14;
    if ( (*((_BYTE *)v2 + 100) & 1) != 0 )
    {
      v29 = *((_QWORD *)v2 + 3);
      v30 = &word_1C020FC54;
      ...
      if ( !(unsigned int)OnlyCompositionMetrics(v2, &v86, 0LL, v15)
        ...
        && tlgKeywordOn((__int64)&dword_1C0249250, 0x800000000800LL) )
      {
        v97 = *(_QWORD *)(v38 + 16);
        ...
        v50 = *(_WORD *)(v38 + 104);
        v74 = *((_DWORD *)v11 + 219);
        v75 = xmmword_1C0254574;
        v76 = DWORD2(xmmword_1C0254574);
        v71 = DWORD1(xmmword_1C0254574);
        v77 = DWORD1(xmmword_1C0254564);
        v51 = *(_WORD *)(v38 + 70);
        v99 = *(_BYTE *)(v38 + 72);
        v52 = *(_WORD *)(v38 + 68);
        v53 = *(_WORD *)(v38 + 66);
    ...
    else
    {
        ...
        && tlgKeywordOn((__int64)&dword_1C0249250, 0x800000000800LL) )
      {
        ...
        v64 = *(_WORD *)(v22 + 104);
        v80 = *((_DWORD *)v11 + 219);
        v79 = xmmword_1C0254574;
        v78 = *(_QWORD *)((char *)&xmmword_1C0254574 + 4);
        v77 = DWORD1(xmmword_1C0254564);
        v63 = *(_WORD *)(v22 + 70);
        v99 = *(_BYTE *)(v22 + 72);
        v62 = *(_WORD *)(v22 + 68);
