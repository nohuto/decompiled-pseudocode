/*
 * XREFs of ?CitpInteractionSummaryStopTracking@@YAXPEAU_CIT_INTERACTION_SUMMARY@@I@Z @ 0x1C007928C
 * Callers:
 ...
 *     ?OnlyCompositionMetrics@@YAHPEBU_CIT_INTERACTION_SUMMARY@@U_CIT_INPUT_TIMES@@@Z @ 0x1C0079890 (-OnlyCompositionMetrics@@YAHPEBU_CIT_INTERACTION_SUMMARY@@U_CIT_INPUT_TIMES@@@Z.c)
 ...
 *     ?CitpAudioStatSnapDelta@@YAXPEAU_CIT_AUDIO_STATS@@@Z @ 0x1C00B8888 (-CitpAudioStatSnapDelta@@YAXPEAU_CIT_AUDIO_STATS@@@Z.c)
...
void __fastcall CitpInteractionSummaryStopTracking(struct _CIT_INTERACTION_SUMMARY *a1, int a2)
{
  ...
  *(_QWORD *)v2 = v2;
  ...
  if ( ((*(&xmmword_1C0293D14 + 8) & 0x10) == 0
    ...
    && ((*(&xmmword_1C0293D14 + 8) & 0x20) == 0
     || (*((_WORD *)v2 + 57) & 0xFFF3) != 0
     || (*((_WORD *)v2 + 57) & 8) == 0
     || *((_WORD *)v2 + 53) >= 3u
     || *((_WORD *)v2 + 54) && *((_WORD *)v2 + 55)) )
  {
    v10 = xmmword_1C0293D30;
    v11 = a2 - *((_DWORD *)v2 + 23);
    v12 = a2 - *((_DWORD *)xmmword_1C0293D30 + 72);
    v13 = *((_QWORD *)xmmword_1C0293D30 + 32) + 1LL;
    v14 = *((_QWORD *)xmmword_1C0293D30 + 35);
    *((_QWORD *)xmmword_1C0293D30 + 32) = v13;
    if ( (*((_BYTE *)v2 + 100) & 1) != 0 )
    {
      v25 = *((_QWORD *)v2 + 3);
      v26 = &word_1C0248490;
      ...
      if ( !(unsigned int)OnlyCompositionMetrics(v2, &v80, 0LL, v14)
        ...
        && tlgKeywordOn((__int64)&dword_1C02883D8, 0x800000000800LL) )
      {
        v86 = *(_QWORD *)(v35 + 16);
        ...
        v43 = *(_WORD *)(v35 + 104);
        v67 = *((_DWORD *)v10 + 73);
        v68 = *(&xmmword_1C0293D14 + 2);
        v64 = qword_1C0293D24;
        v69 = *(&xmmword_1C0293D14 + 3);
        v70 = *(&xmmword_1C0293D14 + 1);
        v44 = *(_WORD *)(v35 + 70);
        v93 = *(_BYTE *)(v35 + 72);
        v45 = *(_WORD *)(v35 + 68);
        v46 = *(_WORD *)(v35 + 66);
    ...
    else
    {
        ...
        && tlgKeywordOn((__int64)&dword_1C02883D8, 0x800000000800LL) )
      {
        ...
        v58 = *(_WORD *)(v21 + 104);
        v74 = *((_DWORD *)v10 + 73);
        v73 = *(&xmmword_1C0293D14 + 2);
        v72 = qword_1C0293D24;
        v71 = *(&xmmword_1C0293D14 + 3);
        v70 = *(&xmmword_1C0293D14 + 1);
        v57 = *(_WORD *)(v21 + 70);
        v93 = *(_BYTE *)(v21 + 72);
        v56 = *(_WORD *)(v21 + 68);
