/*
 * XREFs of ?bDeleteRGNOBJAPI@RGNOBJAPI@@QEAAHXZ @ 0x1C0032950
 * Callers:
    ...
    if ( v7 < v10 + ((*(unsigned __int16 *)(v8 + 2) + 0xFFFF) << 16) )
    {
      ...
      if ( v13 )
      {
        ...
        if ( (v17 & 0x40) != 0 )
        {
          v53 = *(_DWORD *)v13;
          v54 = gpHandleManager;
          v55 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)gpHandleManager, v53 & 0xFFFFFF);
          v56 = *((_QWORD *)v54 + 2);
          v57 = v55;
          v58 = *(_DWORD *)(v56 + 2056);
...
LABEL_89:
        ...
        v27 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)v19, v22);
        v28 = *(_DWORD *)(v21 + 2056);
        v29 = v27;
...
LABEL_85:
        ...
        v34 = gpHandleManager;
        v35 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)gpHandleManager, *(_DWORD *)v62 & 0xFFFFFF);
        v36 = *((_QWORD *)v34 + 2);
        v37 = v35;
        v38 = *(_DWORD *)(v36 + 2056);
...
LABEL_54:
  ...
  if ( v48 == (struct HOBJ__ *)hrgnDefault )
    return 0LL;
  v49 = HmgRemoveObjectImpl(v48, 1, 0, 0, 4, 0LL);
  v50 = *this;
  if ( (struct HOBJ__ *)v49 != *this )
    return 0LL;
  this[5] = 0LL;
