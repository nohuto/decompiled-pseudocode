/*
 * XREFs of ?OpenInternalSharedResource@CApplicationChannel@DirectComposition@@QEAAJPEAXI_NPEAPEAVCResourceMarshaler@2@@Z @ 0x1C004BF3C
 * Callers:
 ...
 *     GetSharedResourceData @ 0x1C004C518 (GetSharedResourceData.c)
