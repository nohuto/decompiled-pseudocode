          ...
          *((_DWORD *)i + 16) = *(_DWORD *)(a1 + 64) & 0x947F9 | 0x1002;
            ...
            && (v18 = qword_1C0295AC0(i[2], 2848LL), (v8 = (_QWORD *)v18) != 0LL) )
          {
            if ( (*(_BYTE *)(*(_QWORD *)(v18 + 40) + 26LL) & 0x20) == 0 && (int)IsGetRedirectionBitmapSupported() >= 0 )
            {
              ...
              {
                v20 = (HDC)i[1];
                if ( !qword_1C0294EA0 || (v21 = qword_1C0294EA0(v20, v19), v20 = (HDC)i[1], !v21) )
          ...
          if ( (int)IsGreHintDCWndSupported() >= 0 && qword_1C0294EC0 )
            qword_1C0294EC0(i[1], *(_QWORD *)i[2], 0LL, 0LL, 0);
          if ( v8 && (*(_BYTE *)(v8[5] + 26LL) & 8) != 0 && (int)IsGreHintDCWndSupported() >= 0 && qword_1C0294EC0 )
            qword_1C0294EC0(
              i[1],
              *(_QWORD *)i[2],
              *v8,
