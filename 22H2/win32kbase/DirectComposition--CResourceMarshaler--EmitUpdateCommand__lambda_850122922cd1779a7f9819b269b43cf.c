/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_850122922cd1779a7f9819b269b43cf1___ @ 0x1C002BEAC
 * Callers:
...
LABEL_4:
      ...
      *((_DWORD *)v10 + 2) = *(_DWORD *)(*(_QWORD *)a3 + 32LL);
      result = 1;
      *((_DWORD *)v10 + 3) = *(_DWORD *)(*(_QWORD *)a3 + 260LL);
      return result;
    }
  }
