/*
 * XREFs of ?ReadLayoutFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@PEAXII@Z @ 0x1C006A5D4
 * Callers:
 ...
 *     strcmp_0 @ 0x1C00CEA01 (strcmp_0.c)
...
LABEL_126:
                                if ( a4 )
                                {
                                  ...
                                  v78 = qword_1C0257478 ? qword_1C0257478() : -1073741637;
                                  if ( v78 >= 0 && !(qword_1C0257480 ? qword_1C0257480(v6) : 0) )
                                    break;
                                  *((_QWORD *)a1 + 6) = v6;
                                }
                                if ( v30 )
