/*
 * XREFs of ?ReadLayoutFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@PEAXII@Z @ 0x1C0012F08
 * Callers:
 ...
 *     strcmp_0 @ 0x1C00D6931 (strcmp_0.c)
 ...
 *     ValidateKbdNLSTable @ 0x1C01EC7EC (ValidateKbdNLSTable.c)
 */
