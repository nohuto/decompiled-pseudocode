/*
 * XREFs of ?WaitForMessagesOrCustomInputEventsAndDispatch@LegacyInputDispatcher@@QEAAJXZ @ 0x1C01DD720
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall LegacyInputDispatcher::WaitForMessagesOrCustomInputEventsAndDispatch(LegacyInputDispatcher *this)
{
  ...
  **((_QWORD **)this + 2) = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 1456);
  while ( 1 )
  {
    ...
    {
LABEL_8:
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3053);
      v3 = 0;
    }
    else
    {
