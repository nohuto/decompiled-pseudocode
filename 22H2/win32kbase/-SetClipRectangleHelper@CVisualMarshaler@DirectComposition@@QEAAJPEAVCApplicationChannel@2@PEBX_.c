/*
 * XREFs of ?SetClipRectangleHelper@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEBX_KPEA_N@Z @ 0x1C00A518C
 * Callers:
...
LABEL_13:
  ...
  v13 = DirectComposition::CApplicationChannel::SetResourceBufferProperty(a2, v12, 16LL, a3, a4);
  v14 = v13;
  if ( v7 )
  {
    if ( v13 >= 0 )
