/*
 * XREFs of RIMApplyPTPConfigRemedy @ 0x1C018188C
 * Callers:
 ...
 *     IsPTPInputEnabled @ 0x1C011C2A8 (IsPTPInputEnabled.c)
    ...
    if ( (unsigned int)IsPTPInputEnabled() && (*(_DWORD *)(a2 + 184) & 0x4000000) != 0 )
    {
      ...
      if ( v5 % 0x19 == 1 && (v7 = *(_BYTE *)(a2 + 206), *(_BYTE *)(a2 + 206) = v7 + 1, v7 < 0x14u) )
      {
        ...
        if ( *(_BYTE *)(a2 + 206) == 1
          ...
          && tlgKeywordOn((__int64)&dword_1C0249250, 0x800000000000LL) )
        {
          v19 = v8 + 148;
      ...
      else
      {
        ...
        if ( v14 > 5 && tlgKeywordOn((__int64)&dword_1C0249250, 0x800000000000LL) )
        {
          v20[0] = v17;
