/*
 * XREFs of ?ApplyFullKeyboardStates@@YAXPEAX0@Z @ 0x1C01B3CB0
 * Callers:
...
void __fastcall ApplyFullKeyboardStates(_OWORD *a1, __int128 *a2)
{
  ...
  *(_OWORD *)gafRawKeyState = *a1;
  xmmword_1C024F5F0 = a1[1];
  unk_1C024F600 = a1[2];
  xmmword_1C024F610 = a1[3];
  gafAsyncKeyState = *a2;
  xmmword_1C024F630 = a2[1];
  xmmword_1C024F640 = a2[2];
  xmmword_1C024F650 = a2[3];
  if ( grpdeskRitInput )
  {
