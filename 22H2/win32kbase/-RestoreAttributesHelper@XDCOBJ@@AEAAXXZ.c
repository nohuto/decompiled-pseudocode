/*
 * XREFs of ?RestoreAttributesHelper@XDCOBJ@@AEAAXXZ @ 0x1C003FDC4
 * Callers:
 *     ?vUnlockNoNullSet@XDCOBJ@@IEAAXXZ @ 0x1C004005C (-vUnlockNoNullSet@XDCOBJ@@IEAAXXZ.c)
 * Callees:
 *     ?RestoreAttributes@DC@@QEAAXPEAU_DC_ATTR@@@Z @ 0x1C003F990 (-RestoreAttributes@DC@@QEAAXPEAU_DC_ATTR@@@Z.c)
...
void __fastcall XDCOBJ::RestoreAttributesHelper(DC **this)
{
  ...
  if ( !*((_DWORD *)this + 3) )
  {
    ...
    v5 = GdiHandleManager::DecodeIndex(v4, (unsigned __int16)*(_DWORD *)*this | (*(_DWORD *)*this >> 8) & 0xFF0000);
    v6 = *((_QWORD *)v4 + 2);
    v7 = v5;
    Entry = GdiHandleEntryDirectory::GetEntry((GdiHandleEntryDirectory *)v6, v5, 0);
    v9 = GdiHandleManager::DecodeIndex(v4, v7);
    v10 = v9;
    v11 = *(_DWORD *)(v6 + 2056);
