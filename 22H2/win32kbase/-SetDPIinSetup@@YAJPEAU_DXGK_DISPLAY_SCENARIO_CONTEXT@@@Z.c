/*
 * XREFs of ?SetDPIinSetup@@YAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0137CE4
 * Callers:
...
LABEL_4:
  ...
  if ( CurrentDpiInfoFromHDev >= 0 )
  {
    ...
    if ( qword_1C0256898 )
      ...
      v7 = -1073741637;
    if ( v7 >= 0 && qword_1C02568A0 )
      qword_1C02568A0(1LL, &v26);
    if ( v26 != v5 )
    {
      v8 = qword_1C02568B8 ? qword_1C02568B8() : -1073741637;
      if ( v8 >= 0 )
      {
        v9 = qword_1C02568C0 ? qword_1C02568C0(1LL, v5) : -1073741637;
        if ( v9 >= 0 )
        {
          v10 = qword_1C02568A8 ? qword_1C02568A8() : -1073741637;
          if ( v10 >= 0 )
          {
            if ( qword_1C02568B0 )
              v6 = qword_1C02568B0(1LL, v4 / 0x64 > 0x78);
            if ( v6 >= 0 )
            {
              v25 = 0;
              gDrvDpiWin8Style = 0;
