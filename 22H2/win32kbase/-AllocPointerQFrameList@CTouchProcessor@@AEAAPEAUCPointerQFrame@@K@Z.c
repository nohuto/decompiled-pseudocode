/*
 * XREFs of ?AllocPointerQFrameList@CTouchProcessor@@AEAAPEAUCPointerQFrame@@K@Z @ 0x1C00E3B12
 * Callers:
...
struct CPointerQFrame *__fastcall CTouchProcessor::AllocPointerQFrameList(struct _KTHREAD **this, unsigned int a2)
{
  ...
  {
    v17 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 7733);
  }
  if ( (_DWORD)v2 )
  {
    v3 = 160 * v2;
