/*
 * XREFs of ?CitpProgramIdCopy@@YAJPEAU_CIT_PROGRAM_ID@@PEBU1@@Z @ 0x1C02345C8
 * Callers:
 ...
 *     Feature_3071079736__private_IsEnabledDeviceUsage @ 0x1C00D660C (Feature_3071079736__private_IsEnabledDeviceUsage.c)
...
__int64 __fastcall CitpProgramIdCopy(struct _CIT_PROGRAM_ID *a1, const struct _CIT_PROGRAM_ID *a2)
{
  ...
  *((_QWORD *)a1 + 1) = 0LL;
  ...
  {
    v6 = -1073741637;
    if ( (unsigned int)Feature_3071079736__private_IsEnabledDeviceUsage() )
    {
