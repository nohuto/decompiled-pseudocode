/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1C016BB44
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C00AAF90 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C00BB590 (EtwDevLockEndTightUpdate.c)
 * Callees:
