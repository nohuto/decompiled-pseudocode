/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1C014CBD4
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C0085B40 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C009D2F0 (EtwDevLockEndTightUpdate.c)
 * Callees:
