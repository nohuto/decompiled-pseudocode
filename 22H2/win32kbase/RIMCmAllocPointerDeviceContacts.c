/*
 * XREFs of RIMCmAllocPointerDeviceContacts @ 0x1C017FF10
 * Callers:
...
__int64 __fastcall RIMCmAllocPointerDeviceContacts(__int64 a1, unsigned int a2)
{
  ...
  if ( v4 < v7 )
  {
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 79);
    v4 = *(_DWORD *)(a1 + 720);
    v6 = *(_DWORD *)(a1 + 24);
  }
  v8 = v4 - 1;
  ...
  if ( v4 > v8 + 1 )
  {
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 80);
    v4 = *(_DWORD *)(a1 + 720);
  }
  if ( !v4 )
  {
