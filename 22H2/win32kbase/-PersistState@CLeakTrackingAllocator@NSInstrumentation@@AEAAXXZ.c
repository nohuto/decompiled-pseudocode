/*
 * XREFs of ?PersistState@CLeakTrackingAllocator@NSInstrumentation@@AEAAXXZ @ 0x1C00C5A00
 * Callers:
 ...
 *     ?PlatformPersistConfig32@NSInstrumentation@@YAXPEAGQEAPEBGPEBIPEA_N_K@Z @ 0x1C00C58DC (-PlatformPersistConfig32@NSInstrumentation@@YAXPEAGQEAPEBGPEBIPEA_N_K@Z.c)
