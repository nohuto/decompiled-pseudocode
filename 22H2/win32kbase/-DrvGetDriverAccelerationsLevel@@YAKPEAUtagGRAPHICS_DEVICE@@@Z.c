/*
 * XREFs of ?DrvGetDriverAccelerationsLevel@@YAKPEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C00BD52C
 * Callers:
  ...
  if ( a1 != (struct tagGRAPHICS_DEVICE *)-4LL )
  {
    ...
    if ( (v5 & 0x800000) == 0 )
    {
      if ( (v5 & 0x4000000) == 0
        ...
        || !*(_QWORD *)(v8 + 3096)
        || (PVOID)PsGetCurrentProcess(v8, 65533LL, v9) == gpepCSRSS
        || UserIsCurrentProcessDwm(v11, v10, v12) )
      {
