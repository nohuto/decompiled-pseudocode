/*
 * XREFs of DrvSetDisplayConfig @ 0x1C001A4C0
 * Callers:
 ...
 *     ?DispBrokerGetCurrentMode@@YA?AW4DISPBROKER_MODE@@XZ @ 0x1C009ADB4 (-DispBrokerGetCurrentMode@@YA-AW4DISPBROKER_MODE@@XZ.c)
 ...
 *     ?DrvChangeDisplayFallback@@YAJPEAXEEPEAU_MDEV@@PEAPEAU1@PEAW4_DXGK_DIAG_SDC_STAGE@@PEAEPEAJ@Z @ 0x1C00B438C (-DrvChangeDisplayFallback@@YAJPEAXEEPEAU_MDEV@@PEAPEAU1@PEAW4_DXGK_DIAG_SDC_STAGE@@PEAEPEAJ@Z.c)
 ...
 *     ?DrvCreatePathModalityFromAllPaths@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@I0@Z @ 0x1C0144244 (-DrvCreatePathModalityFromAllPaths@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@I0@Z.c)
      ...
      if ( v154 )
      {
        ...
        if ( v121 < 0 )
        {
          ...
          if ( !byte_1C0250C74 )
          {
            LOBYTE(v144) = 0;
            byte_1C0250C74 = 1;
            ((void (__fastcall *)(__int64, __int64, __int64, _QWORD, _QWORD, int))qword_1C0250B80)(
              400LL,
              22LL,
              v32,
              v156,
...
LABEL_239:
    ...
    LOBYTE(v29) = v35 == 4;
    v36 = 1;
    ((void (__fastcall *)(__int64, __int64))qword_1C0250AA8)(v30, v29);
    if ( v35 == 4 )
    {
      v147 = 1;
      LODWORD(v32) = 0;
  ...
  if ( (int)v17 >= 0 )
  {
    if ( (v17 & 0xF) != 0xF || (a4 & 0x20) != 0 && *(_DWORD *)(a8 + 20) != (_DWORD)v28 )
    {
        ...
        || (v17 & 0x1F) != 0 && (v17 & 0x40) == 0 )
      {
        v36 = v28;
        v148 = v28;
        ((void (__fastcall *)(_QWORD))qword_1C0250AA8)(0LL);
      }
      else
      {
        v36 = ((__int64 (*)(void))qword_1C0250AB0)();
        v148 = v36;
      }
      goto LABEL_46;
    }
    v148 = ((__int64 (*)(void))qword_1C0250AB0)();
    v36 = v148;
    if ( !v148 )
    {
LABEL_46:
      ...
      if ( (v17 & 0x10000) != 0 )
      {
        LODWORD(v32) = ((__int64 (__fastcall *)(__int64, _QWORD, void **))qword_1C0250B88)(
                         a7,
      ...
      LODWORD(v32) = ((__int64 (*)(void))qword_1C02509A0)();
      if ( (int)v32 < 0 )
      {
        v18 = 6;
        v146 = 12;
      ...
      if ( (v17 & 0x80) != 0 )
      {
        ...
        if ( !v36 && (v17 & 0xF) != 0 && (v158 & 0x20) == 0 )
          v37 = 3LL;
        v38 = ((__int64 (__fastcall *)(__int64))qword_1C02509B8)(v37);
        v32 = v38;
        if ( v38 < 0 )
        {
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v41 + 32) = (int)v32;
        ...
        if ( v153 )
        {
          ...
          v46 = v161;
          v47 = (const struct _RETRY_MODE *)((char *)&unk_1C020FF30 + 12 * v161);
...
LABEL_73:
        ...
        if ( (v17 & 0x10) != 0 )
        {
          ...
          LODWORD(v32) = ((__int64 (__fastcall *)(__int64, struct D3DKMT_GETPATHSMODALITY *, _QWORD))qword_1C0250920)(
                           v17 & 0x2000 | 0x2F,
                           v174[0],
                           0LL);
          if ( (int)v32 < 0 )
...
LABEL_111:
        if ( (v17 & 0x800) != 0 )
        {
          ...
          v74 = ((__int64 (__fastcall *)(__int64, struct D3DKMT_GETPATHSMODALITY *))qword_1C0250940)(
                  0x80000000LL,
                  v174[0]);
          v32 = v74;
          if ( v74 == -1073741266 )
        ...
        if ( !v163 )
          v82 = v81;
        v83 = ((__int64 (__fastcall *)(__int64, struct D3DKMT_GETPATHSMODALITY *))qword_1C0250928)(v82, v174[0]);
        v32 = v83;
        if ( v83 < 0 )
        {
        ...
        if ( v179 )
        {
          ...
          if ( v87 )
          {
            LODWORD(v32) = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *, _QWORD))qword_1C0250920)(
                             v87,
                             v174[0],
                             0LL);
            if ( (int)v32 < 0 )
...
LABEL_217:
        ...
        if ( !v40 )
          goto LABEL_204;
        v105 = ((__int64 (__fastcall *)(BOOL, struct D3DKMT_GETPATHSMODALITY *))qword_1C0250940)(v43, v174[0]);
        v32 = v105;
        if ( !a6 )
        {
          if ( v105 < 0 )
...
LABEL_38:
  ...
  v148 = 0;
  v36 = 0;
  if ( (unsigned __int8)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C0250AA8)(0LL, 0LL) )
  {
    LODWORD(v17) = 2191;
    goto LABEL_38;
  }
