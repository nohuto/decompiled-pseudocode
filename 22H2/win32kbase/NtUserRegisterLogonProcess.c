/*
 * XREFs of NtUserRegisterLogonProcess @ 0x1C00BDF70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserRegisterLogonProcess(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v4; // esi
  ...
  v10 = (int)RegisterLogonProcess(v4, a2);
