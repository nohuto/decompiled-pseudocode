/*
 * XREFs of bDynamicProcessAllDriverRealizations @ 0x1C000EE10
 * Callers:
...
__int64 __fastcall bDynamicProcessAllDriverRealizations(__int64 a1, __int64 a2, int a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( *(_QWORD *)(Objt + 48) == a1
      ...
      && !pProcessDfbSurfaces2((SURFACE *)Objt, v5) )
    {
      v6 = 0;
    }
  }
  ...
  if ( v6 )
  {
    ...
    if ( *(_QWORD *)(a1 + 1512) && (int)IsPDEVOBJ_bDisableHalftoneSupported() >= 0 && qword_1C02556D8 )
      qword_1C02556D8(&v18);
  }
  return v6;
}
