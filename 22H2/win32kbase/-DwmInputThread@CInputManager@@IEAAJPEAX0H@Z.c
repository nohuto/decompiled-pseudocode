/*
 * XREFs of ?DwmInputThread@CInputManager@@IEAAJPEAX0H@Z @ 0x1C01F9F74
 * Callers:
 ...
 *     ?ValidateUserEvent@CInputManager@@CAJPEAXPEAPEAX@Z @ 0x1C01FA878 (-ValidateUserEvent@CInputManager@@CAJPEAXPEAPEAX@Z.c)
 */
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( !v9 || (CurrentThread = KeGetCurrentThread(), (struct _KTHREAD *)v9 == CurrentThread) )
      {
        ...
        *((_QWORD *)v4 + 4) = v10;
        ...
        v40 = 0LL;
        if ( qword_1C0256E08 )
          v7 = qword_1C0256E08((char *)v4 + 16);
        else
          v7 = -1073741822;
        if ( v7 >= 0 )
        {
          if ( qword_1C0256E10 )
            v7 = qword_1C0256E10((char *)v4 + 16);
          else
            v7 = -1073741822;
        }
          ...
          && (*(_DWORD *)(v42 + 48) || *(int *)(v42 + 24) > 0) )
        {
          ...
          *(GUID *)(v42 + 28) = ActivityId;
          if ( (unsigned int)dword_1C024AA90 > 6 )
          {
            ...
            if ( v21 > 6 && tlgKeywordOn((__int64)&dword_1C024AA90, 0x2000LL) )
            {
              LODWORD(v41) = v43;
              v53 = 4LL;
              v52 = &v41;
