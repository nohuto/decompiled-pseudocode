/*
 * XREFs of ?PopulateCustomDispatcherObjectsArray@LegacyInputDispatcher@@UEAAJIPEAPEAX@Z @ 0x1C01DCFD0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v24 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 3068);
  }
  if ( *((_QWORD *)this + 2) )
    goto LABEL_25;
