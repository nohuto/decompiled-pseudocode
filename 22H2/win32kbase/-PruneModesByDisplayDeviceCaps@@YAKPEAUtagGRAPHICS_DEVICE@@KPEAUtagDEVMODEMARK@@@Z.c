/*
 * XREFs of ?PruneModesByDisplayDeviceCaps@@YAKPEAUtagGRAPHICS_DEVICE@@KPEAUtagDEVMODEMARK@@@Z @ 0x1C0091528
 * Callers:
 ...
 *     ?PruneMode@@YAHPEAU_devicemodeW@@PEAUtagModeCap@@HPEAU_FREQUENCY_RAGE@@K@Z @ 0x1C0091838 (-PruneMode@@YAHPEAU_devicemodeW@@PEAUtagModeCap@@HPEAU_FREQUENCY_RAGE@@K@Z.c)
    ...
    while ( 1 )
    {
      *(_DWORD *)(v11 + 4 * v14) = 0;
      ...
      if ( (*(_BYTE *)(v18 + 20 * v14) & 3) == 3 )
      {
        ...
        v42 = 0LL;
        v41 = 0LL;
        if ( (int)((__int64 (__fastcall *)(__int64, __int64, PVOID *, struct _DEVICE_OBJECT **))qword_1C0250A58)(
                    v18 + 8 + 20 * v14,
                    v20,
                    &Object,
                    &v39) < 0 )
