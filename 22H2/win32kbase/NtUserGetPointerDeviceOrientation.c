/*
 * XREFs of NtUserGetPointerDeviceOrientation @ 0x1C0144E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetPointerDeviceOrientation(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  _DWORD *v4; // r14
  int v6; // esi
  int v7; // edi
