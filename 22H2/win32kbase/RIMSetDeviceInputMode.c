/*
 * XREFs of RIMSetDeviceInputMode @ 0x1C00BF684
 * Callers:
 ...
 *     ?InputModeToString@InputTraceLogging@@CAPEBDW4_WIN32K_INPUT_MODE@@@Z @ 0x1C0172FD0 (-InputModeToString@InputTraceLogging@@CAPEBDW4_WIN32K_INPUT_MODE@@@Z.c)
