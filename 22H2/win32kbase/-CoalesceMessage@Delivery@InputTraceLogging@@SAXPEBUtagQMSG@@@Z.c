/*
 * XREFs of ?CoalesceMessage@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C0189EE4
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::CoalesceMessage(const struct tagQMSG *a1, __int64 a2)
{
  ...
  {
    if ( (unsigned int)dword_1C024AA90 > 4 && tlgKeywordOn((__int64)&dword_1C024AA90, 16LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C021CD6A,
        0LL,
        0LL,
        7u,
        &v12);
         ...
         && (unsigned int)dword_1C024AA90 > 4
         && tlgKeywordOn((__int64)&dword_1C024AA90, 16LL) )
  {
    v10 = *(_QWORD *)(v6 + 136);
    v8 = v5;
