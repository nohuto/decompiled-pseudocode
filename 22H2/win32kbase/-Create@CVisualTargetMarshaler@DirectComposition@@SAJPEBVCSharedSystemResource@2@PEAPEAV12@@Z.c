/*
 * XREFs of ?Create@CVisualTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0094308
 * Callers:
 *     CreateVisualTargetMarshaler @ 0x1C00942B0 (CreateVisualTargetMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CVisualTargetMarshaler **a2)
{
  ...
  v4 = (struct DirectComposition::CVisualTargetMarshaler *)Win32AllocPoolWithQuotaZInit(0x50uLL, 0x74764344u);
  v5 = v4;
  if ( v4 )
  {
    memset(v4, 0, 0x50uLL);
