/*
 * XREFs of ?Create@CSharedReadLegacyAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F8ED0
 * Callers:
 *     CreateSharedReadLegacyAnimationTriggerMarshaler @ 0x1C01F8FB0 (CreateSharedReadLegacyAnimationTriggerMarshaler.c)
 * Callees:
