/*
 * XREFs of ?CopyPTPPointerInputFrame@CTouchProcessor@@IEAAPEAUCPointerInputFrame@@PEAU2@PEAX@Z @ 0x1C018BEFC
 * Callers:
 ...
 *     ??4CPointerInfoNode@@QEAAAEAU0@AEBU0@@Z @ 0x1C018747C (--4CPointerInfoNode@@QEAAAEAU0@AEBU0@@Z.c)
 *     ??4CPointerQFrame@@QEAAAEAU0@AEBU0@@Z @ 0x1C018781C (--4CPointerQFrame@@QEAAAEAU0@AEBU0@@Z.c)
