/*
 * XREFs of ?ProcessAndUnreferencePreviousInput@CTouchProcessor@@IEAAXPEBUCPointerInfoNode@@_KKHH@Z @ 0x1C01CF30C
 * Callers:
    ...
    if ( v17 )
    {
      ...
      if ( (*(_DWORD *)v8 & 0x1000) == 0 )
      {
        ...
        if ( (*(_DWORD *)v8 & 0x40) != 0 )
        {
          ...
          {
            MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 6966);
          }
          if ( (*(_DWORD *)v8 & 0x400) != 0 )
          {
            v26 = v6 | 4;
...
LABEL_88:
      if ( (NonConstMsgData[9] & 0x40) != 0 )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 6989);
    }
    v15 = WPP_GLOBAL_Control;
    if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      || (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) == 0
