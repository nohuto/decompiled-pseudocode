/*
 * XREFs of ?QueryTargetStats@CConnection@DirectComposition@@QEAA_N_KAEBUtagCOMPOSITION_TARGET_ID@@PEAUtagCOMPOSITION_TARGET_STATS@@@Z @ 0x1C0003354
 * Callers:
 *     NtDCompositionGetTargetStatistics @ 0x1C0003190 (NtDCompositionGetTargetStatistics.c)
 * Callees:
 *     ??8tagCOMPOSITION_TARGET_ID@@QEBA_NAEBU0@@Z @ 0x1C000389C (--8tagCOMPOSITION_TARGET_ID@@QEBA_NAEBU0@@Z.c)
