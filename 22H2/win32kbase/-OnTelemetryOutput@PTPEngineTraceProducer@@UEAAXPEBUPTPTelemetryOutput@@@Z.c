/*
 * XREFs of ?OnTelemetryOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPTelemetryOutput@@@Z @ 0x1C01C9EB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct PTPTelemetryOutput *a2)
{
  ...
  if ( (unsigned int)dword_1C0249170 > 5 && tlgKeywordOn((__int64)&dword_1C0249170, 9LL) )
  {
    v8 = a2;
    v9 = v4 + 23;
    v11 = *((_QWORD *)this + 67);
