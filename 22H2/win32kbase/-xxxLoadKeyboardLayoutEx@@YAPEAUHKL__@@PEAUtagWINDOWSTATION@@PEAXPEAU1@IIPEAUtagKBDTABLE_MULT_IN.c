/*
 * XREFs of ?xxxLoadKeyboardLayoutEx@@YAPEAUHKL__@@PEAUtagWINDOWSTATION@@PEAXPEAU1@IIPEAUtagKBDTABLE_MULT_INTERNAL@@PEBGII@Z @ 0x1C0009AD8
 * Callers:
        ...
        unsigned int a9)
{
  ...
  if ( v14 )
  {
    ...
    if ( (v16 & 0x20000000) != 0 )
    {
      ...
      v17 = (char *)qword_1C024FA38 + dword_1C024FA40 * (unsigned int)(unsigned __int16)*(_DWORD *)v14;
      v17[25] &= ~1u;
...
LABEL_37:
  if ( qword_1C02573E8 )
    v21 = qword_1C02573E8(v11, v15);
  else
    v21 = -1073741637;
  if ( v21 < 0 || (!qword_1C02573F0 ? (v22 = 0) : (v22 = qword_1C02573F0((unsigned int)a8, v13, &v44)), v22) )
  {
