/*
 * XREFs of ?Create@CSharedClientProjectedShadowCasterMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F9AB0
 * Callers:
 *     CreateSharedClientProjectedShadowCasterMarshaler @ 0x1C01F9CA0 (CreateSharedClientProjectedShadowCasterMarshaler.c)
 * Callees:
