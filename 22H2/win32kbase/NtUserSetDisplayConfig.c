/*
 * XREFs of NtUserSetDisplayConfig @ 0x1C0133700
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    if ( (_DWORD)v7 )
    {
      ...
      if ( v20 )
      {
        ...
        if ( qword_1C0255FC0 )
          qword_1C0255FC0(v22, &v38, Win32FreePool);
      }
      v11 = v29;
      v35 = v29;
      v16 = 0LL;
...
LABEL_63:
  if ( v9 >= 0 )
  {
    v24 = qword_1C0256C60 ? qword_1C0256C60(v10, v16, v11, v12) : -1073741637;
    if ( v24 >= 0 && qword_1C0256C68 )
      qword_1C0256C68();
  }
  if ( v29 && qword_1C02560E8 )
    qword_1C02560E8(&v38);
