/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_ss @ 0x1C01ACB68
 * Callers:
        ...
        const char *a10)
{
  ...
  if ( a2 )
  {
    ...
    if ( !a9 )
      v22 = "NULL";
    result = (_UNKNOWN **)((__int64 (__fastcall *)(__int64, __int64, void *, __int64, const char *, __int64, const char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
                            a1,
                            43LL,
