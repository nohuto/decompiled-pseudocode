/*
 * XREFs of ??_GCCompClockInfo@DirectComposition@@AEAAPEAXI@Z @ 0x1C02092F0
 * Callers:
 ...
 *     ??1CCompClockInfo@DirectComposition@@AEAA@XZ @ 0x1C02092C4 (--1CCompClockInfo@DirectComposition@@AEAA@XZ.c)
 */
