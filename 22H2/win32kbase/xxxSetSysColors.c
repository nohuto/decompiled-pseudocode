/*
 * XREFs of xxxSetSysColors @ 0x1C00205DC
 * Callers:
...
__int64 __fastcall xxxSetSysColors(__int64 a1, unsigned int a2, char *a3, char *a4, unsigned int a5)
{
  ...
  if ( (a5 & 1) != 0 )
  {
    v19 = qword_1C0256AA8 ? qword_1C0256AA8() : -1073741637;
    if ( v19 >= 0 )
    {
      v20 = (int)qword_1C0256AB0;
      if ( qword_1C0256AB0 )
        v20 = qword_1C0256AB0(16LL);
      if ( !v20 )
        return 0LL;
    }
  }
...
LABEL_12:
  ...
  if ( (v5 & 1) != 0 )
  {
    if ( qword_1C0256AB8 )
      ...
      v21 = -1073741637;
    if ( v21 >= 0 && qword_1C0256AC0 )
      qword_1C0256AC0();
    if ( (int)IsCreateBitmapStripSupported() >= 0 && qword_1C0256B60 )
      qword_1C0256B60();
    if ( qword_1C0256AC8 )
      v22 = qword_1C0256AC8();
    else
      v22 = -1073741637;
    if ( v22 >= 0 && qword_1C0256AD0 )
      qword_1C0256AD0(-1LL, 21LL, 0LL);
    if ( qword_1C0256AD8 )
      v9 = qword_1C0256AD8();
    if ( v9 >= 0 )
    {
      ...
      if ( v23 )
        ...
        v24 = 0LL;
      if ( qword_1C0256AE0 )
        qword_1C0256AE0(v24, 1LL, 66693LL);
      if ( *((struct tagDESKTOP **)gptiCurrent + 57) != grpdeskRitInput )
      {
        ...
        if ( (*(_DWORD *)(*v25 + 64LL) & 1) == 0 )
        {
          ...
          {
            if ( qword_1C0256AE0 )
              qword_1C0256AE0(v26, 1LL, 66693LL);
          }
        }
      }
    }
