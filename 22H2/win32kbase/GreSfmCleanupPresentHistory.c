/*
 * XREFs of GreSfmCleanupPresentHistory @ 0x1C0076510
 * Callers:
...
void GreSfmCleanupPresentHistory()
{
  ...
  LOBYTE(v1) = 1;
  v2 = v8;
  if ( (int)((__int64 (__fastcall *)(__int64 *, _QWORD, __int64, _QWORD))qword_1C02508D8)(&v5, 0LL, v1, 0LL) >= 0 )
  {
    v3 = (unsigned int)v5;
    if ( (_DWORD)v5 )
    {
      if ( (unsigned int)v5 <= 8 || (v2 = PALLOCMEM2((unsigned int)(20 * v5), 1886221383LL, 1)) != 0LL )
      {
        ...
        v6 = v2;
        LOBYTE(v4) = 1;
        if ( (int)((__int64 (__fastcall *)(__int64 *, _QWORD, __int64, _QWORD))qword_1C02508D8)(&v5, 0LL, v4, 0LL) >= 0
          && (_DWORD)v5
          && (unsigned int)v5 <= (unsigned int)v3 )
        {
          do
          {
            ...
            ((void (__fastcall *)(_DWORD *, _QWORD))qword_1C02508E8)(v7, 0LL);
            ++v0;
          }
