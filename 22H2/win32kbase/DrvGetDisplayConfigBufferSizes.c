/*
 * XREFs of DrvGetDisplayConfigBufferSizes @ 0x1C00203A0
 * Callers:
...
__int64 __fastcall DrvGetDisplayConfigBufferSizes(unsigned int a1, __int64 a2)
{
  ...
  *(_QWORD *)(v4 + 24) = v3;
  ...
  if ( (unsigned int)DrvIsWddmDriverPresent(v6, v5) )
  {
    if ( (v3 & 7) == 4 )
    {
      v10 = (unsigned __int8)((__int64 (*)(void))qword_1C0250AB0)() != 0;
    ...
    v7 = ((__int64 (__fastcall *)(_QWORD, __int64))qword_1C0250960)((unsigned int)v3, a2);
  }
  else
  {
    v7 = -1073741637;
