/*
 * XREFs of ?vInit@EXFORMOBJ@@QEAAXAEAVXDCOBJ@@KH@Z @ 0x1C00245D0
 * Callers:
 ...
 *     ?vMarkTransformDirty@DC@@QEAAXXZ @ 0x1C013C050 (-vMarkTransformDirty@DC@@QEAAXXZ.c)
...
void __fastcall EXFORMOBJ::vInit(float **this, DC **a2, int a3, int a4)
{
  int v8; // eax
  DC *v9; // rcx
  __int64 v10; // rdx
  ...
  if ( (unsigned int)EXFORMOBJ::bInverse(this, (DC *)((char *)*a2 + 320)) )
  {
    *(_DWORD *)(*((_QWORD *)*a2 + 122) + 340LL) &= ~0x10u;
    if ( !(unsigned int)DC::bDpiScaleTransform(*a2) )
    {
      v16 = *this;
      v17 = *(_QWORD *)(v15 + 976);
      *(_OWORD *)(v17 + 68) = *(_OWORD *)*this;
      *(_OWORD *)(v17 + 84) = *((_OWORD *)v16 + 1);
      *(float *)(v17 + 100) = v16[8];
    }
  }
  else
