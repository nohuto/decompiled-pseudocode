/*
 * XREFs of ?DownlevelInput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@AEBUtagPTP_DOWNLEVELED_INPUT@@_K@Z @ 0x1C01DEAD0
 * Callers:
 ...
 *     ?PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z @ 0x1C01E037C (-PTPDownlevelActionToString@InputTraceLogging@@CAPEBDW4tagPTP_DOWNLEVEL_ACTION@@@Z.c)
 */
        ...
        const struct tagPTP_DOWNLEVELED_INPUT *a2)
{
  ...
  if ( *(_DWORD *)a2 < 2u )
  {
    if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 128LL) )
    {
  ...
  else if ( *(_DWORD *)a2 == 2 && (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 128LL) )
  {
    LODWORD(v18) = *((_DWORD *)a2 + 1);
    v14 = v4;
