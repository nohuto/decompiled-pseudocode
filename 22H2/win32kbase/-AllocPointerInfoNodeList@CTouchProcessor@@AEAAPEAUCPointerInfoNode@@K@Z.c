/*
 * XREFs of ?AllocPointerInfoNodeList@CTouchProcessor@@AEAAPEAUCPointerInfoNode@@K@Z @ 0x1C01BA644
 * Callers:
...
struct CPointerInfoNode *__fastcall CTouchProcessor::AllocPointerInfoNodeList(struct _KTHREAD **this, unsigned int a2)
{
  ...
  {
    v15 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 7705);
  }
  if ( (_DWORD)v2 )
  {
    v3 = 480 * v2;
