/*
 * XREFs of ?SetupFromInputDestAndWindow@CInputDest@@QEAA_NAEBV1@PEAUHWND__@@W4HandleValidationType@1@@Z @ 0x1C01B5824
 * Callers:
...
bool __fastcall CInputDest::SetupFromInputDestAndWindow(__int64 *a1, __int64 a2, HWND a3, int a4)
{
  ...
  *((_OWORD *)a1 + 6) = *(_OWORD *)(a2 + 96);
  ...
  if ( v8 == 2 )
  {
    if ( a4 == 2 )
    {
      v9 = (__int64 *)ValidateHwndEx((__int64)a3, 1, 0);
      goto LABEL_20;
    }
    if ( a4 != 1 )
...
LABEL_22:
    ...
    if ( a4 == 2 )
    {
      v9 = (__int64 *)ValidateHbwnd((int)a3);
      goto LABEL_20;
    }
    if ( a4 != 1 )
  ...
  v9 = (__int64 *)HMValidateHandleNoSecure((int)a3, v10);
LABEL_20:
  if ( !v9 )
    goto LABEL_22;
  v12[0] = a1 + 10;
  v12[1] = v9;
  HMAssignmentLock(v12, 0);
  return a1[10] != 0;
}
