/*
 * XREFs of ?HandlePTPInertiaTimer@CHidInput@@QEAAX_NKPEAX@Z @ 0x1C01E2548
 * Callers:
 *     ?CacheInertia@CPTPProcessor@@AEAAXXZ @ 0x1C01DE780 (-CacheInertia@CPTPProcessor@@AEAAXXZ.c)
 *     ?CancelInertiaTimer@CPTPProcessor@@AEAAXXZ @ 0x1C01DE8EC (-CancelInertiaTimer@CPTPProcessor@@AEAAXXZ.c)
