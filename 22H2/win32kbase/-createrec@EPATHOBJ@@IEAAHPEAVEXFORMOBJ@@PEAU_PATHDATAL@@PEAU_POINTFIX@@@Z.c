/*
 * XREFs of ?createrec@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@PEAU_POINTFIX@@@Z @ 0x1C00818E4
 * Callers:
 ...
 *     ?vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z @ 0x1C013D414 (-vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z.c)
 */
