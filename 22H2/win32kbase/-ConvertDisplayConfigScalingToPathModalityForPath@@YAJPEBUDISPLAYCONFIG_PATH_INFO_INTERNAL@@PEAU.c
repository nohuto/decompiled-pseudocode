/*
 * XREFs of ?ConvertDisplayConfigScalingToPathModalityForPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@PEA_N@Z @ 0x1C014353C
 * Callers:
        ...
        bool *a3)
{
  ...
  if ( (*(_DWORD *)a1 & 0x10000) != 0 )
  {
    ...
    else if ( (int)((__int64 (__fastcall *)(__int64, char *, _DWORD *))qword_1C02509D0)(v4, (char *)a2 + 16, v5) < 0 )
    {
      return 3221225485LL;
    }
    *((_DWORD *)a2 + 34) = *v5;
