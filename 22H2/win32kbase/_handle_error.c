/*
 * XREFs of _handle_error @ 0x1C00CF224
 * Callers:
 *     exp @ 0x1C00CEA28 (exp.c)
 *     log @ 0x1C00CEE10 (log.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00C5400 (__security_check_cookie.c)
 *     _call_matherr @ 0x1C00CF0F0 (_call_matherr.c)
 *     _exception_enabled @ 0x1C00CF160 (_exception_enabled.c)
 *     _raise_exc @ 0x1C00CF420 (_raise_exc.c)
