/*
 * XREFs of ?SpeedBumpCornerLock@Cursor@InputTraceLogging@@SAXAEBUtagPOINT@@@Z @ 0x1C01DC4A8
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::SpeedBumpCornerLock(const struct tagPOINT *a1)
{
  ...
  if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 8LL) )
  {
    v3 = v1[1];
    v4 = *v1;
