/*
 * XREFs of ?ReadComplete@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@PEBURIMDEV@@@Z @ 0x1C0173C14
 * Callers:
...
void __fastcall InputTraceLogging::RIM::ReadComplete(const struct RawInputManagerObject *a1, const struct RIMDEV *a2)
{
  ...
  if ( v2 )
  {
    ...
    {
      v5 = (unsigned __int8 *)&unk_1C021C14E;
      goto LABEL_17;
    }
  }
  else if ( (unsigned int)dword_1C024AA90 > 4 && tlgKeywordOn((__int64)&dword_1C024AA90, 256LL) )
  {
    v5 = (unsigned __int8 *)&unk_1C021C040;
LABEL_17:
