/*
 * XREFs of ?Duplicate@InputSink@InputTraceLogging@@SAXPEBUCompositionInputObject@@PEAX1_N@Z @ 0x1C004C218
 * Callers:
...
void __fastcall InputTraceLogging::InputSink::Duplicate(const struct CompositionInputObject *a1, void *a2, void *a3)
{
  ...
  if ( (unsigned int)dword_1C024AA90 > 5 && tlgKeywordOn((__int64)&dword_1C024AA90, 4LL) )
  {
    ...
    v10 = v6;
    v11 = v7;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C0220948, 0, 0, 6u, &v12);
  }
}
