/*
 * XREFs of ?InputCoreProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0138810
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?TraceCurrentState@CCursorClip@@SAXXZ @ 0x1C01DC510 (-TraceCurrentState@CCursorClip@@SAXXZ.c)
 *     TraceRawMouseThrottlingThresholds @ 0x1C01E9238 (TraceRawMouseThrottlingThresholds.c)
