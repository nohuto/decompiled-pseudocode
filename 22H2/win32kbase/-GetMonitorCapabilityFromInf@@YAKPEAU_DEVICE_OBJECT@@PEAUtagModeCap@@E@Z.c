/*
 * XREFs of ?GetMonitorCapabilityFromInf@@YAKPEAU_DEVICE_OBJECT@@PEAUtagModeCap@@E@Z @ 0x1C0091BF8
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1C00C5440 (__report_rangecheckfailure.c)
