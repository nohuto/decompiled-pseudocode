/*
 * XREFs of ?TraceCurrentConfig@InputConfig@@SAXXZ @ 0x1C006317C
 * Callers:
 ...
 *     ?OrientationToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C01E4094 (-OrientationToString@InputTraceLogging@@CAPEBDK@Z.c)
 */
  ...
  if ( gpInputConfig )
  {
    ...
    for ( i = **(CInputConfig ***)v0; ; i = *(CInputConfig **)i )
    {
      ...
      if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 2LL) )
      {
        ...
        v41 = 4;
        v38 = 8;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0289810, (int)&dword_1C025DC43, 0, 0, 6u, &v36);
      }
      v4 = v3 + 182;
      KeEnterCriticalRegion();
      ExAcquireResourceSharedLite(CInputConfig::slock, 1u);
      for ( j = v3[182]; ; j = (_QWORD *)*j )
      {
        ...
        else if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 2LL) )
        {
