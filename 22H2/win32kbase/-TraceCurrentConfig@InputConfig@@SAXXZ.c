/*
 * XREFs of ?TraceCurrentConfig@InputConfig@@SAXXZ @ 0x1C006F2A4
 * Callers:
  ...
  if ( gpInputConfig )
  {
    ...
    for ( i = **(CInputConfig ***)v0; v1 != v0; i = *(CInputConfig **)i )
    {
      ...
      if ( (unsigned int)dword_1C024AA90 > 4 && tlgKeywordOn((__int64)&dword_1C024AA90, 2LL) )
      {
        ...
        v37 = 4;
        v34 = 8;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024AA90, (int)&dword_1C021F387, 0, 0, 6u, &v32);
      }
      v4 = v3 + 178;
      KeEnterCriticalRegion();
      ExAcquireResourceSharedLite(CInputConfig::slock, 1u);
      for ( j = v3[178]; j != v4; j = (_QWORD *)*j )
      {
        ...
        else if ( (unsigned int)dword_1C024AA90 > 4 && tlgKeywordOn((__int64)&dword_1C024AA90, 2LL) )
        {
