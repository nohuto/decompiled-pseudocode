/*
 * XREFs of ?AssignPointerId@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@@Z @ 0x1C01883E8
 * Callers:
        ...
        const struct tagPOINTEREVENTINT *a2)
{
  ...
  if ( (unsigned int)dword_1C024AA90 > 4 && tlgKeywordOn((__int64)&dword_1C024AA90, 32LL) )
  {
    ...
    v12 = 8LL;
    v10 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024AA90, (unsigned __int8 *)dword_1C021E0D1, 0LL, 0LL, 6u, &v8);
  }
}
