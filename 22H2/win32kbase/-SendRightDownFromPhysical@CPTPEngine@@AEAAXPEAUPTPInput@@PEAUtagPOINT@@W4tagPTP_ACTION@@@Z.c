/*
 * XREFs of ?SendRightDownFromPhysical@CPTPEngine@@AEAAXPEAUPTPInput@@PEAUtagPOINT@@W4tagPTP_ACTION@@@Z @ 0x1C01C85F4
 * Callers:
 ...
 * Callees:
 *     ?DoTPButtonWarpBack@CPTPEngine@@AEAA?AUtagPOINT@@PEAUPTPInput@@@Z @ 0x1C01C4ACC (-DoTPButtonWarpBack@CPTPEngine@@AEAA-AUtagPOINT@@PEAUPTPInput@@@Z.c)
...
unsigned __int64 __fastcall CPTPEngine::SendRightDownFromPhysical(CPTPEngine *a1, __int64 a2, _QWORD *a3, int a4)
{
  ...
  *((_DWORD *)a1 + 958) |= 0x100u;
  result = *((unsigned int *)a1 + 958);
  if ( (result & 0x10) == 0 )
  {
    v9 = 0LL;
    LODWORD(v9) = a4;
