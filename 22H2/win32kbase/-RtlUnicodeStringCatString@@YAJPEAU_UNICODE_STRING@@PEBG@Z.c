/*
 * XREFs of ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C0181D94
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C0181E90 (RtlWideCharArrayCopyStringWorker.c)
 */
