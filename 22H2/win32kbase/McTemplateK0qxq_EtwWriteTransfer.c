/*
 * XREFs of McTemplateK0qxq_EtwWriteTransfer @ 0x1C013C5EC
 * Callers:
 ...
 *     EtwTraceFlipManagerCanceledPresentShown @ 0x1C0139730 (EtwTraceFlipManagerCanceledPresentShown.c)
 *     EtwTraceFlipManagerPresentIFlipSubmitted @ 0x1C0139F30 (EtwTraceFlipManagerPresentIFlipSubmitted.c)
 *     EtwTraceFlipManagerPresentSignaled @ 0x1C013A490 (EtwTraceFlipManagerPresentSignaled.c)
 *     EtwTraceFlipManagerUpdateExpectedConsumerPresentId @ 0x1C013A950 (EtwTraceFlipManagerUpdateExpectedConsumerPresentId.c)
 * Callees:
