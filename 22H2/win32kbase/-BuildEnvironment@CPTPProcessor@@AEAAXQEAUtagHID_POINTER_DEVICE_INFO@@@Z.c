/*
 * XREFs of ?BuildEnvironment@CPTPProcessor@@AEAAXQEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01A525C
 * Callers:
...
void __fastcall CPTPProcessor::BuildEnvironment(CPTPProcessor *this, struct tagHID_POINTER_DEVICE_INFO *const a2)
{
  ...
  *(_QWORD *)((char *)this + 852) = *(_QWORD *)&qword_1C024ED38;
  *(_OWORD *)((char *)this + 860) = gAapState;
  *(_OWORD *)((char *)this + 876) = xmmword_1C0257CA0;
  *(_OWORD *)((char *)this + 892) = xmmword_1C0257CB0;
  *(_OWORD *)((char *)this + 908) = xmmword_1C0257CC0;
  *(_OWORD *)((char *)this + 924) = xmmword_1C0257CD0;
  *(_OWORD *)((char *)this + 940) = xmmword_1C0257CE0;
