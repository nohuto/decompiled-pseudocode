/*
 * XREFs of _PopulatePropertyUsageValues @ 0x1C015B190
 * Callers:
        ...
        __int64 a9)
{
  ...
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3486);
  }
  v14 = a9;
  if ( !a9 )
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3487);
  }
  if ( !a1 )
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3488);
  }
  v15 = a6;
  if ( !a6 )
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3489);
  }
  if ( !a2 )
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3490);
  }
  if ( !v10 )
  {
    LODWORD(a8) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3491);
  }
  v16 = a7;
  if ( !a7 )
  {
    a7 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3492);
  }
  a8 = *(_QWORD *)(a1 + 16);
  if ( !a8 )
  {
    a7 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3495);
  }
  if ( !v10 || !v16 )
    return 0LL;
  v17 = *a2;
  ...
  {
    a7 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 3510);
  }
  if ( SpecificValueCaps >= 0 )
  {
    ...
    if ( v17 < v16 )
    {
      ...
      while ( 1 )
      {
        if ( v19 >= v10 )
          goto LABEL_42;
        if ( *(_BYTE *)(a1 + 776) == *(_BYTE *)(v15 + 72LL * v19 + 2) && v17 < a3 )
          break;
LABEL_41:
        ++v19;
        if ( v17 >= v16 )
