/*
 * XREFs of ??0PDEVOBJ@@QEAA@PEAU_LDEV@@PEAU_devicemodeW@@PEAG22PEAXPEAUtagREMOTETYPEONENODE@@PEAU_GDIINFO@@PEAUtagDEVINFO@@HKK@Z @ 0x1C0154FD0
 * Callers:
 ...
 *     ?GeneratePDEVUniqueUMPDHandle@@YAPEAUHDEV__@@XZ @ 0x1C0155C14 (-GeneratePDEVUniqueUMPDHandle@@YAPEAUHDEV__@@XZ.c)
...
LABEL_85:
        ...
        *(_QWORD *)(v63 + 1776) = v52;
          ...
          || v65 == 4 )
        {
          ...
          {
            if ( qword_1C0294B58 && (int)qword_1C0294B58() >= 0 )
            {
...
LABEL_95:
          ...
          else if ( qword_1C0294B68 && (int)qword_1C0294B68() >= 0 )
          {
            v66 = (unsigned int (__fastcall *)(PDEVOBJ *))qword_1C0294B70;
            goto LABEL_95;
          }
        }
        ...
        *(_QWORD *)(*(_QWORD *)this + 1744LL) = *(_QWORD *)(v17 + 3360);
        if ( qword_1C0294B78 && (int)qword_1C0294B78() >= 0 )
        {
          v68 = qword_1C0294B80 ? (_DWORD *)qword_1C0294B80() : 0LL;
          *(_QWORD *)(v36 + 6064) = v68;
          if ( *v68 )
          {
            if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 1760LL) + 24LL) == 1 )
            {
              if ( qword_1C0294B88 && (int)qword_1C0294B88() >= 0 && qword_1C0294B90 )
                qword_1C0294B90(*(unsigned int *)(*(_QWORD *)this + 2148LL));
              **(_DWORD **)(v36 + 6064) = 0;
            }
          }
        }
        ...
        *(_DWORD *)(*(_QWORD *)this + 3568LL) = 0;
        ...
        else if ( qword_1C0294BA8 )
        {
          if ( (int)qword_1C0294BA8() >= 0 )
          {
