/*
 * XREFs of ?GatherKeyboardDeviceSummaryInfo@CKeyboardProcessor@@QEAAXPEAUDEVICEINFO@@PEAK@Z @ 0x1C00C4C4C
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  if ( !v3 || wcsncmp(v3, L"\\??\\Root#RDP", 0xCuLL) )
  {
    ...
    if ( (unsigned __int8)(v6 - 7) <= 1u || v6 == 4 && *((_BYTE *)a2 + 465) != 0xFF )
    {
      ...
      qword_1C024BB10 = *((_QWORD *)a2 + 60);
      dword_1C024BB18 = *((_DWORD *)a2 + 122);
