/*
 * XREFs of ?DrvProbeAndCaptureDevmode@@YAJPEAUtagGRAPHICS_DEVICE@@PEAPEAU_devicemodeW@@PEAH2PEAU2@HHHH3@Z @ 0x1C0017868
 * Callers:
 ...
 *     ?GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z @ 0x1C00B019C (-GetClosestMode@@YAPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@PEAU1@HH@Z.c)
...
LABEL_62:
    ...
    else
    {
      ...
      else
      {
        ...
        v67 = !v66;
        v68 = 8LL * !v66;
        v69 = (DWORD *)((char *)&unk_1C0224BE8 + v68 + 4);
        if ( v84 )
        {
          do
          {
        ...
        v16->dmPelsWidth = *(_DWORD *)((char *)&unk_1C0224BE8 + v68);
        v71 = *v69;
        v25 = a1;
...
LABEL_117:
          ...
          if ( (*((_DWORD *)v25 + 40) & 0x800000) != 0 && v56 + v39->dmSize == 244 )
            ((void (__fastcall *)(struct _devicemodeW *, struct _devicemodeW *))qword_1C0250978)(v39, v39);
          if ( v87 )
          {
