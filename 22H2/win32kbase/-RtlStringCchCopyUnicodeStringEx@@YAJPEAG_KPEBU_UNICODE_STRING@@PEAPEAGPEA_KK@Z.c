/*
 * XREFs of ?RtlStringCchCopyUnicodeStringEx@@YAJPEAG_KPEBU_UNICODE_STRING@@PEAPEAGPEA_KK@Z @ 0x1C016485C
 * Callers:
 *     LogDiagSDCAccessDenied @ 0x1C0168854 (LogDiagSDCAccessDenied.c)
 * Callees:
 *     RtlStringCopyWideCharArrayWorker @ 0x1C01648D8 (RtlStringCopyWideCharArrayWorker.c)
 *     RtlUnicodeStringValidateSrcWorker_0 @ 0x1C016494C (RtlUnicodeStringValidateSrcWorker_0.c)
 */
