/*
 * XREFs of ?StopAndEndInertia@CTouchProcessor@@QEAAHIPEAX@Z @ 0x1C019EF38
 * Callers:
...
__int64 __fastcall CTouchProcessor::StopAndEndInertia(CTouchProcessor *this, int a2, void *a3)
{
  ...
  CInpLockGuard *v21[8]; // [rsp+30h] [rbp-58h] BYREF
  ...
  v6 = *((_QWORD *)v3 + 8);
  v7 = (char *)v3 + 56;
  if ( (CTouchProcessor *)v6 == (CTouchProcessor *)((char *)v3 + 56) )
    goto LABEL_9;
  v8 = 1;
  while ( 1 )
  {
...
LABEL_9:
  ...
  if ( !v19 )
  {
    ...
    LOBYTE(v11) = 2;
LABEL_14:
    WPP_RECORDER_SF_((_DWORD)DeviceExtension, v11, 7, v13, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
LABEL_15:
    v8 = 0;
  }
