/*
 * XREFs of ?SetTransformParent@CVisualMarshaler@DirectComposition@@IEAAJPEAVCApplicationChannel@2@PEAVCResourceMarshaler@2@_NPEA_N@Z @ 0x1C005B0B8
 * Callers:
...
LABEL_18:
    ...
    v17 = DirectComposition::CApplicationChannel::SetResourceReferenceProperty(a2, v16, 0LL, a3);
    v6 = v17;
    if ( !v13 )
      goto LABEL_13;
    if ( v17 >= 0 )
