/*
 * XREFs of ?Win32kNtUserCleanupInternal@@YAXXZ @ 0x1C007CD3C
 * Callers:
...
void Win32kNtUserCleanupInternal(void)
{
  ...
  if ( v11 >= 0 )
  {
    if ( qword_1C0255BA8 )
    {
      qword_1C0255BA8(&gWndsMonitorSnapshotHead);
      if ( qword_1C0255BA8 )
    ...
    if ( gsmsList )
    {
      while ( 1 )
      {
        ...
        *(_QWORD *)(v26 + 8) = &gsmsList;
        if ( qword_1C0255BE8 )
          qword_1C0255BE8(v15, 0LL);
      }
    }
    qword_1C0252B78 = (__int64)&gsmsList;
    gsmsList = &gsmsList;
  }
  if ( qword_1C0255BF0 )
    v16 = qword_1C0255BF0();
  ...
  if ( qword_1C024F5D8 )
  {
    if ( (int)IsFreeMessageListSupported() >= 0 && qword_1C0256148 )
      qword_1C0256148(qword_1C024F5D8 + 24);
    Win32FreeToPagedLookasideList((__int64)QLookaside, qword_1C024F5D8);
    qword_1C024F5D8 = 0LL;
  }
  if ( QLookaside )
  {
