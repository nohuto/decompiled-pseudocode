/*
 * XREFs of ?ResumeDevice@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C01513E4
 * Callers:
...
void __fastcall InputTraceLogging::RIM::ResumeDevice(const struct RIMDEV *a1)
{
  ...
  if ( (unsigned int)dword_1C024AA90 > 4 && tlgKeywordOn((__int64)&dword_1C024AA90, 256LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024AA90, (unsigned __int8 *)dword_1C0219DB8, 0LL, 0LL, 3u, &v3);
  }
}
