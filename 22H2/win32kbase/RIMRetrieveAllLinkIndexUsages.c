/*
 * XREFs of RIMRetrieveAllLinkIndexUsages @ 0x1C018B6DC
 * Callers:
        ...
        char **a6)
{
  ...
  {
    LODWORD(a6) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1610);
  }
  if ( *v6 )
  {
    LODWORD(a6) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1611);
  }
...
LABEL_35:
  ...
  if ( SpecificButtonCaps == -1072627705 )
  {
    ...
    {
      v51 = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1656);
    }
