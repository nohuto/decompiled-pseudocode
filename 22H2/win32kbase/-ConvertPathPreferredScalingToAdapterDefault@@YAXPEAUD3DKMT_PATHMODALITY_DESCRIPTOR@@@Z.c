/*
 * XREFs of ?ConvertPathPreferredScalingToAdapterDefault@@YAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C0143884
 * Callers:
...
void __fastcall ConvertPathPreferredScalingToAdapterDefault(struct D3DKMT_PATHMODALITY_DESCRIPTOR *a1, __int64 a2)
{
  ...
  if ( *((_DWORD *)a1 + 35) == 253 )
  {
    ...
    ((void (__fastcall *)(char *, char *))qword_1C02509C8)((char *)a1 + 16, (char *)a1 + 140);
  }
