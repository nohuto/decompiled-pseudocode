/*
 * XREFs of ?bDeleteSurface@SURFACE@@QEAAHW4_CLEANUPTYPE@@H@Z @ 0x1C000DEF0
 * Callers:
      ...
      else
      {
        if ( !(_DWORD)v63 )
        {
          if ( qword_1C02558B0 )
            ...
            v36 = -1073741637;
          if ( v36 >= 0 && qword_1C02558B8 )
            qword_1C02558B8(BaseAddress);
          goto LABEL_80;
        }
        v35 = HIDWORD(v62);
      }
    ...
    else
    {
      ...
      if ( (v23 & 0x40000) != 0 )
      {
        if ( !a2 )
        {
          ...
          if ( v26 >= 0 && qword_1C02558A8 )
            qword_1C02558A8(*(_QWORD *)(v18 + 1800), v24);
        }
        goto LABEL_59;
      }
    }
