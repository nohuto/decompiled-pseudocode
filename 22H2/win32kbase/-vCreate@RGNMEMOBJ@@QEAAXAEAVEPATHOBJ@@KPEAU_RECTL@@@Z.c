/*
 * XREFs of ?vCreate@RGNMEMOBJ@@QEAAXAEAVEPATHOBJ@@KPEAU_RECTL@@@Z @ 0x1C0026170
 * Callers:
 ...
 *     ?vCloseAllFigures@EPATHOBJ@@QEAAXXZ @ 0x1C0026820 (-vCloseAllFigures@EPATHOBJ@@QEAAXXZ.c)
 ...
 *     bConstructGET @ 0x1C00BC9E0 (bConstructGET.c)
 *     vAdvanceAETEdges @ 0x1C00BCF00 (vAdvanceAETEdges.c)
 *     vXSortAETEdges @ 0x1C00BD5F0 (vXSortAETEdges.c)
 *     vMoveNewEdges @ 0x1C00BDDE0 (vMoveNewEdges.c)
