/*
 * XREFs of EngUnlockSurface @ 0x1C0091EE0
 * Callers:
...
void __stdcall EngUnlockSurface(SURFOBJ *pso)
{
  ...
  if ( pso )
  {
    ...
    v6 = *(_QWORD *)(*(_QWORD *)(SGDGetSessionState(pso) + 24) + 8008LL);
    v7 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)v6, v5);
    v8 = *(_QWORD *)(v6 + 16);
    ...
    if ( Entry )
    {
      ...
      {
        v10 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)v6, v5);
        v11 = *(_DWORD *)(v8 + 2056);
        v12 = v10;
    ...
    if ( p_pvScan0 == (PVOID *)v4 )
    {
      ...
      if ( v32 )
      {
        ...
        if ( v19 == 5 )
        {
          v20 = (struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer *)p_pvScan0[85];
          v21 = 0LL;
        }
        else
        {
          if ( v19 != 16 )
            goto LABEL_17;
          v20 = (struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer *)p_pvScan0[17];
          v21 = 2LL;
        }
...
LABEL_17:
        ...
        v24 = *(_QWORD *)(*(_QWORD *)(SGDGetSessionState(v22) + 24) + 8008LL);
        v25 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)v24, *v18 & 0xFFFFFF);
        v26 = *(_QWORD *)(v24 + 16);
        v27 = v25;
        v28 = *(_DWORD *)(v26 + 2056);
