/*
 * XREFs of McTemplateK0pqqpxp_EtwWriteTransfer @ 0x1C0038924
 * Callers:
...
NTSTATUS McTemplateK0pqqpxp_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventWaitQueueSubmit, a3, 7u, &v4);
}
