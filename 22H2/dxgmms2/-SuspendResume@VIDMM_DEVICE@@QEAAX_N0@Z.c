/*
 * XREFs of ?SuspendResume@VIDMM_DEVICE@@QEAAX_N0@Z @ 0x1C0088314
 * Callers:
 *     ?VidMmSuspendResumeDevice@@YAXPEAVVIDMM_DEVICE@@_N1@Z @ 0x1C0015B20 (-VidMmSuspendResumeDevice@@YAXPEAVVIDMM_DEVICE@@_N1@Z.c)
 * Callees:
