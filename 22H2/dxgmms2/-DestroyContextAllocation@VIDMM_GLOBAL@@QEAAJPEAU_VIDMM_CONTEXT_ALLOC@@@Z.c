/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C008B274
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C0016B20 (VidMmDestroyContextAllocation.c)
 * Callees:
