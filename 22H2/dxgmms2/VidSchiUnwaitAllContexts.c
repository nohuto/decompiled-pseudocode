/*
 * XREFs of VidSchiUnwaitAllContexts @ 0x1C0032100
 * Callers:
 *     VidSchiReportHwHang @ 0x1C003D024 (VidSchiReportHwHang.c)
 *     VidSchFlushAdapter @ 0x1C00CFF30 (VidSchFlushAdapter.c)
 * Callees:
 *     ?VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z @ 0x1C002CD90 (-VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z.c)
 */
