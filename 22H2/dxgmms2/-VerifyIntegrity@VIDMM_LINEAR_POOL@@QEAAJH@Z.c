/*
 * XREFs of ?VerifyIntegrity@VIDMM_LINEAR_POOL@@QEAAJH@Z @ 0x1C0102AD8
 * Callers:
 *     ?VerifyIntegrity@VIDMM_SEGMENT@@UEAAJXZ @ 0x1C01004B0 (-VerifyIntegrity@VIDMM_SEGMENT@@UEAAJXZ.c)
 * Callees:
