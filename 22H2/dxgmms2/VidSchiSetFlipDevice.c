/*
 * XREFs of VidSchiSetFlipDevice @ 0x1C0006310
 * Callers:
 ...
 *     ?InitializeFlipQueueEntry@_VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z @ 0x1C00175AC (-InitializeFlipQueueEntry@_VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z.c)
 ...
 *     ?GetFlipQueueRef@VIDSCH_FLIP_QUEUE_ITERATOR@@QEAAPEAPEAUVIDSCH_FLIP_QUEUE@@XZ @ 0x1C0018830 (-GetFlipQueueRef@VIDSCH_FLIP_QUEUE_ITERATOR@@QEAAPEAPEAUVIDSCH_FLIP_QUEUE@@XZ.c)
 *     ??_GVIDSCH_FLIP_QUEUE@@QEAAPEAXI@Z @ 0x1C0018860 (--_GVIDSCH_FLIP_QUEUE@@QEAAPEAXI@Z.c)
 *     VidSchiClearPeriodicFrameNotifications @ 0x1C00188E8 (VidSchiClearPeriodicFrameNotifications.c)
 ...
 *     VidSchIsVSyncAvailable @ 0x1C00B4540 (VidSchIsVSyncAvailable.c)
 */
