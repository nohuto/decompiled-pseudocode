/*
 * XREFs of ??1VIDMM_RECYCLE_HEAP_MGR@@UEAA@XZ @ 0x1C0078BC4
 * Callers:
 *     ??_EVIDMM_RECYCLE_HEAP_MGR@@UEAAPEAXI@Z @ 0x1C00023F0 (--_EVIDMM_RECYCLE_HEAP_MGR@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1VIDMM_RECYCLE_HEAP@@QEAA@XZ @ 0x1C0078FCC (--1VIDMM_RECYCLE_HEAP@@QEAA@XZ.c)
