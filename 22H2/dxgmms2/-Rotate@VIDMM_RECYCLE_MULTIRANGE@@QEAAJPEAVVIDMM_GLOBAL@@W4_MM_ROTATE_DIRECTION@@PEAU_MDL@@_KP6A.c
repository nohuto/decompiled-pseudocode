/*
 * XREFs of ?Rotate@VIDMM_RECYCLE_MULTIRANGE@@QEAAJPEAVVIDMM_GLOBAL@@W4_MM_ROTATE_DIRECTION@@PEAU_MDL@@_KP6AJ22PEAX@Z4TVIDMM_ROTATE_FLAGS@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00F676C
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( bTracingEnabled )
      {
        if ( (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer(v27, (__int64)&EventPerformanceWarning, v28, 12);
      }
      v25 -= NumberOfBytes;
  ...
  if ( v12 == MmToRegularMemoryNoCopy )
  {
    ...
    while ( 1 )
    {
      ...
      if ( bTracingEnabled && (byte_1C0076981 & 1) != 0 )
        McTemplateK0q_EtwWriteTransfer(v30, (__int64)&EventPerformanceWarning, v31, 12);
      v32 = Context;
      v33 = CopyFunction;
