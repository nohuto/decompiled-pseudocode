/*
 * XREFs of ?MoveOneResource@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@PEA_NPEAX@Z @ 0x1C00FDB40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchiUpdateFlipQueueEntriesForMove @ 0x1C003CCE8 (VidSchiUpdateFlipQueueEntriesForMove.c)
      ...
      if ( v9 != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 272) )
      {
        do
        {
          ...
          while ( v12 != v11 )
          {
            v13 = *(v12 - 4);
            v12 = (_QWORD *)*v12;
            VidSchMarkDeviceAsError(*(_QWORD *)(v13 + 32), 24, 0LL);
          }
        }
