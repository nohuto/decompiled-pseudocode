/*
 * XREFs of VidSchiSwitchContextWithCheck @ 0x1C000B640
 * Callers:
...
LABEL_85:
        ...
        {
          v49 = (__int64 *)(a1 + 40);
          v50 = *(_QWORD *)(*(_QWORD *)(a1 + 96) + 24LL) + 3520LL;
          v51 = *(__int64 ***)(*(_QWORD *)(*(_QWORD *)(a1 + 96) + 24LL) + 3528LL);
          if ( *v51 != (__int64 *)v50 )
            goto LABEL_97;
          *v49 = v50;
          *(_QWORD *)(a1 + 48) = v51;
        ...
        do
        {
            ...
            || (v23 & 0x100) != 0 )
          {
            ...
            if ( v24 )
            {
              ...
              if ( !*(_BYTE *)(v47 + 28) )
              {
                v48 = *(unsigned __int64 **)(v47 + 64);
                if ( *(_BYTE *)(v47 + 29) )
                {
                  if ( *v48 < v8 )
                    goto LABEL_85;
                }
                else if ( *(_DWORD *)v48 - (int)v8 < 0 )
                {
                  goto LABEL_85;
                }
              }
          ...
          if ( *v31 == v16 + 24 )
          {
            ...
            *(_QWORD *)(v30 + 8) = v31;
            ...
            if ( (*(_DWORD *)(v16 + 112) & 0x100) != 0 )
            {
              while ( 1 )
              {
                v52 = VidSchiInterlockedRemoveHeadListIfExist(v32, (_QWORD **)(v16 + 736), (_DWORD *)(v16 + 752));
                if ( !v52 )
                  break;
            ...
            if ( bTracingEnabled )
              VidSchiFlushGpuWorkEntries((struct _VIDSCH_CONTEXT *)v16, v34, v35);
            v46 = *(void **)(v16 + 992);
            if ( v46 )
              ExFreePoolWithTag(v46, 0);
            VidSchiDecrementDeviceReference(*(char **)(v16 + 104), 1);
  ...
  if ( !(unsigned int)VidSchiCheckPreemptionPolicy(a1, &v55, v8) )
  {
    ...
    if ( v55 != -1 )
    {
      ...
      if ( is_mul_ok(v41.QuadPart, 0x989680uLL) )
        ...
        v43 = 10000000 * (v41.QuadPart / (unsigned __int64)v53.QuadPart)
            + 10000000 * (v41.QuadPart % (unsigned __int64)v53.QuadPart) / v53.QuadPart;
      v44 = v43 + v12;
      v45 = *(_QWORD *)(v1 + 96);
      *(_QWORD *)(v1 + 136) = v45;
      *(_QWORD *)(v1 + 128) = v44;
      WdLogSingleEntry2(4LL, *(unsigned __int16 *)(v1 + 4), v45);
    }
    ...
    if ( v12 == -1 && !*(_DWORD *)(v1 + 2896) && (*(_DWORD *)(v1 + 2876) > 1u || v13 && a1 != v13) )
    {
      ...
      if ( is_mul_ok(v36.QuadPart, 0x989680uLL) )
        v37 = (unsigned __int64)v36.QuadPart
            * (unsigned __int128)0x989680uLL
            / (unsigned __int64)PerformanceFrequency.QuadPart;
      else
        v37 = 10000000 * (v36.QuadPart / (unsigned __int64)PerformanceFrequency.QuadPart)
            + 10000000
            * (v36.QuadPart % (unsigned __int64)PerformanceFrequency.QuadPart)
            / PerformanceFrequency.QuadPart;
      v38 = v37 + *(_QWORD *)(a1 + 480);
      v39 = *(_QWORD *)(v1 + 96);
      *(_QWORD *)(v1 + 144) = v39;
      *(_QWORD *)(v1 + 128) = v38;
      WdLogSingleEntry2(4LL, *(unsigned __int16 *)(v1 + 4), v39);
    }
    ...
    if ( (unsigned __int8)RtlAreBitsClearEx(v4 + 536, 0LL, *(_QWORD *)(v4 + 536)) )
    {
      if ( v10 != -1 && (*(_DWORD *)(*(_QWORD *)(a1 + 648) + 80LL) & 0x10) == 0 )
      {
        ...
        {
          v40 = *(void (__fastcall **)(_QWORD))(v4 + 3080);
          if ( v40 )
            v40(*(_QWORD *)(v4 + 3120));
        }
