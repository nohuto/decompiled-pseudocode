/*
 * XREFs of ?Lock@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KPEAPEAX@Z @ 0x1C00943E0
 * Callers:
 *     ?VidMmLock@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@KPEAPEAX@Z @ 0x1C0005180 (-VidMmLock@@YAJPEAVVIDMM_GLOBAL@@PEAU_VIDMM_MULTI_ALLOC@@KPEAPEAX@Z.c)
 * Callees:
 ...
 *     ?NeedsApertureForLock@VIDMM_GLOBAL@@IEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00E5F68 (-NeedsApertureForLock@VIDMM_GLOBAL@@IEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@@Z.c)
 */
  ...
  if ( v10[3] )
  {
    ...
    else
    {
      if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v11 + 304, 0LL) )
      {
        ...
        {
          v28 = *(_DWORD *)(v11 + 332);
          if ( v28 != -1 && (byte_1C0076981 & 1) != 0 )
            McTemplateK0q_EtwWriteTransfer(v26, (__int64)&EventBlockThread, v27, v28);
        }
