/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00C3F60
 * Callers:
 *     VidMmReportMultiGlobalAlloc @ 0x1C00C4240 (VidMmReportMultiGlobalAlloc.c)
...
void __fastcall VidMmReportGlobalAlloc(struct DXGDEVICE *a1, struct _VIDMM_GLOBAL_ALLOC *a2, __int64 a3)
{
  ...
  v19 = *((_QWORD *)a2 + 67);
  if ( *(_WORD *)(v19 + 4) && bTracingEnabled && (byte_1C0076981 & 1) != 0 )
  {
