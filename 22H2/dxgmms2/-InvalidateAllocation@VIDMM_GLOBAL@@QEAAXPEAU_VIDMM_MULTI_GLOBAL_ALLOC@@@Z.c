/*
 * XREFs of ?InvalidateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C00AF330
 * Callers:
 *     VidMmInvalidateAllocation @ 0x1C0022D80 (VidMmInvalidateAllocation.c)
 * Callees:
