/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00AF7B0
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C0022DC0 (VidMmIsAllocationTerminated.c)
 * Callees:
