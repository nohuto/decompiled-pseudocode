/*
 * XREFs of McTemplateK0pptpxxqqxxxqqxxx_EtwWriteTransfer @ 0x1C0027AB8
 * Callers:
...
NTSTATUS McTemplateK0pptpxxqqxxxqqxxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v39; // [rsp+180h] [rbp+80h] BYREF
  ...
  __int64 v57; // [rsp+1C8h] [rbp+C8h] BYREF
  va_list va10; // [rsp+1C8h] [rbp+C8h]
  __int64 v59; // [rsp+1D0h] [rbp+D0h] BYREF
  va_list va11; // [rsp+1D0h] [rbp+D0h]
  __int64 v61; // [rsp+1D8h] [rbp+D8h] BYREF
  va_list va12; // [rsp+1D8h] [rbp+D8h]
  __int64 v63; // [rsp+1E0h] [rbp+E0h] BYREF
  va_list va13; // [rsp+1E0h] [rbp+E0h]
  __int64 v65; // [rsp+1E8h] [rbp+E8h] BYREF
  va_list va14; // [rsp+1E8h] [rbp+E8h]
  va_list va15; // [rsp+1F0h] [rbp+F0h] BYREF
  ...
  va_copy(va13, va12);
  v61 = va_arg(va13, _QWORD);
  va_copy(va14, va13);
  v63 = va_arg(va14, _QWORD);
  va_copy(va15, va14);
  v65 = va_arg(va15, _QWORD);
  v6 = 8LL;
  va_copy(v5, va);
  v8 = 8LL;
  va_copy(v7, va1);
  ...
  v34 = 8LL;
  v36 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpVirtualTransfer, a3, 0x11u, &v4);
}
