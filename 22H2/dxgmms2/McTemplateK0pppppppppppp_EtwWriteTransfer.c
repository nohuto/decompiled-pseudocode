/*
 * XREFs of McTemplateK0pppppppppppp_EtwWriteTransfer @ 0x1C0023F90
 * Callers:
 ...
 *     VidMmReportContextAllocList @ 0x1C00BAF70 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiAlloc @ 0x1C00BB080 (VidMmReportMultiAlloc.c)
 *     ?ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z @ 0x1C00BDD08 (-ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z.c)
 * Callees:
