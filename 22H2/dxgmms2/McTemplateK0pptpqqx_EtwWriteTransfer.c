/*
 * XREFs of McTemplateK0pptpqqx_EtwWriteTransfer @ 0x1C0026DFC
 * Callers:
...
NTSTATUS McTemplateK0pptpqqx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpDiscard, a3, 8u, &v4);
}
