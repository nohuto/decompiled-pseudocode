/*
 * XREFs of ?BeginCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKIPEAU_VIDMM_REGION@@PEAPEAX@Z @ 0x1C0069A20
 * Callers:
 *     VidMmBeginCPUAccess @ 0x1C00015D0 (VidMmBeginCPUAccess.c)
 * Callees:
 ...
 *     ?WaitOnAllocForceSync@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C00802C0 (-WaitOnAllocForceSync@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z.c)
        ...
        if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v21, 0LL) )
        {
          if ( bTracingEnabled )
          {
            ...
            if ( v57 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
              McTemplateK0q_EtwWriteTransfer(v26, (const EVENT_DESCRIPTOR *)"g", v27, v57);
          }
