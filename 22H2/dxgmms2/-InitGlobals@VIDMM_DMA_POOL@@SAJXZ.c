/*
 * XREFs of ?InitGlobals@VIDMM_DMA_POOL@@SAJXZ @ 0x1C00912B4
 * Callers:
...
__int64 VIDMM_DMA_POOL::InitGlobals(void)
{
  ...
  qword_1C0050820 = (__int64)&VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_DmaPoolsListHead.Flink = &VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_MaxNbDmaBuffers = dword_1C0050308;
  VIDMM_DMA_POOL::_MaxNbCddDmaBuffers = dword_1C005030C;
  VIDMM_DMA_POOL::_MaxDmaBufferBytes = (unsigned int)dword_1C0050310;
  VIDMM_DMA_POOL::_MaxAllocationListBytes = (unsigned int)dword_1C0050314;
  VIDMM_DMA_POOL::_MaxPatchLocationListBytes = (unsigned int)dword_1C0050314;
  v0 = (unsigned int)dword_1C0050310 / 0x64uLL;
  ...
  v1 = (unsigned int)dword_1C0050314 / 0x64uLL;
  ...
  if ( v2 )
  {
    ...
    {
      VIDMM_DMA_POOL::_NbDmaBufferLimitCompareWatermark = dword_1C0050318;
      return 0LL;
    }
  }
  else
