/*
 * XREFs of ?MapVadVaRange@CVirtualAddressAllocator@@AEAAPEAUVIDMM_MAPPED_VA_RANGE@@PEAUVIDMM_VAD@@IW4VIDMM_VAD_OWNER_TYPE@@PEAX_KU_D3DDDIGPUVIRTUALADDRESS_PROTECTION_TYPE@@333@Z @ 0x1C0076264
 * Callers:
        ...
        unsigned __int64 a10)
{
  ...
  if ( v19 )
  {
    ...
    VIDMM_MAPPED_VA_RANGE::ReleaseVaRangeReference(v19, v25);
  }
  else
  {
    _InterlockedIncrement(&dword_1C0050794);
    v23 = WdLogNewEntry5_WdLowResource(v18);
    *(_QWORD *)(v23 + 24) = 1868LL;
