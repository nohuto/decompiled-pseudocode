/*
 * XREFs of ?FreeDeferredMapping@VIDMM_GLOBAL@@SAXPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C00AE94C
 * Callers:
 *     VidMmFreeDeferredMapping @ 0x1C0022D00 (VidMmFreeDeferredMapping.c)
 * Callees:
...
void __fastcall VIDMM_GLOBAL::FreeDeferredMapping(struct _VIDMM_LOCAL_ALLOC *a1, __int64 a2)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)(*(_QWORD *)a1 + 372LL), 0xFFFFFFFF) == 1 )
  {
    if ( (v6 & 0x4000000) != 0 )
    {
      ...
      VidMmDereferenceObjectAsync(*(struct _LIST_ENTRY **)(*(_QWORD *)a1 + 352LL));
