/*
 * XREFs of ?VidMmTerminateCompanionContext@VIDMM_GLOBAL@@SAXPEAUVIDMM_COMPANION_CONTEXT@@@Z @ 0x1C00B5348
 * Callers:
 *     VidMmTerminateCompanionContext @ 0x1C00230D0 (VidMmTerminateCompanionContext.c)
 * Callees:
