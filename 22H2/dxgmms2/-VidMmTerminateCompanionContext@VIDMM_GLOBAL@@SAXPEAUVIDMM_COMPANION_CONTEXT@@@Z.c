/*
 * XREFs of ?VidMmTerminateCompanionContext@VIDMM_GLOBAL@@SAXPEAUVIDMM_COMPANION_CONTEXT@@@Z @ 0x1C00EA75C
 * Callers:
 *     VidMmTerminateCompanionContext @ 0x1C002D400 (VidMmTerminateCompanionContext.c)
 * Callees:
