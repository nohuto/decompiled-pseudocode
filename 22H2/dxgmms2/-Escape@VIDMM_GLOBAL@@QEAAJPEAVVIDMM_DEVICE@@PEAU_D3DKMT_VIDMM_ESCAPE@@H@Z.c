/*
 * XREFs of ?Escape@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_D3DKMT_VIDMM_ESCAPE@@H@Z @ 0x1C00AE018
 * Callers:
 *     VidMmEscape @ 0x1C0022CE0 (VidMmEscape.c)
 * Callees:
 ...
 *     ?Flush@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C00B7A10 (-Flush@VIDMM_WORKER_THREAD@@QEAAXXZ.c)
...
LABEL_22:
  ...
  if ( Type != D3DKMT_VIDMMESCAPETYPE_SUSPEND_CPU_ACCESS_TEST )
  {
    if ( Type == D3DKMT_VIDMMESCAPETYPE_SET_TRIM_INTERVALS )
    {
      ...
      v10 = dword_1C0050414;
      v11 = dword_1C005040C;
      dword_1C0050418 = a3->Wake.bFlush;
      dword_1C0050414 = a3->Evict.AllocationHandle;
      dword_1C005040C = a3->SuspendProcess.bAllowWakeOnSubmission;
