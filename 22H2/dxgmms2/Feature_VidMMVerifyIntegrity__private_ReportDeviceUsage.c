/*
 * XREFs of Feature_VidMMVerifyIntegrity__private_ReportDeviceUsage @ 0x1C0017994
 * Callers:
 ...
 *     ?VerifyIntegrity@VIDMM_SEGMENT@@UEAAJXZ @ 0x1C00C8990 (-VerifyIntegrity@VIDMM_SEGMENT@@UEAAJXZ.c)
 * Callees:
 *     wil_details_FeatureReporting_ReportUsageToService @ 0x1C0017DB0 (wil_details_FeatureReporting_ReportUsageToService.c)
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x1C0018020 (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
