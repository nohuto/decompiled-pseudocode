/*
 * XREFs of ?ForceDecommitOffer@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C00AE758
 * Callers:
...
void __fastcall VIDMM_GLOBAL::ForceDecommitOffer(VIDMM_GLOBAL *this, struct VIDMM_ALLOC *a2)
{
  ...
  _QWORD v7[10]; // [rsp+30h] [rbp-58h] BYREF
  ...
  v7[1] = *((_QWORD *)a2 + 1);
  v6 = (struct VIDMM_PAGING_QUEUE *)(*(_QWORD *)(v7[1] + 80LL) + 176 * v5);
  LODWORD(v7[0]) = 215;
  v7[4] = v4;
