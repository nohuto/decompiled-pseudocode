/*
 * XREFs of ?CreateVidMmObjects@VIDMM_PAGE_TABLE_BASE@@QEAAJPEAVCVirtualAddressAllocator@@II@Z @ 0x1C0061028
 * Callers:
        ...
        int a4)
{
  ...
  if ( OneAllocation < 0 )
  {
    _InterlockedIncrement(&dword_1C0050698);
    v23 = WdLogNewEntry5_WdLowResource(v17);
    *(_QWORD *)(v23 + 24) = 3962LL;
  ...
  else
  {
    ...
    v20 = VIDMM_GLOBAL::OpenOneAllocation(v4, v6, *v16, 0LL, 0, 0LL, (struct VIDMM_ALLOC **)this + 3, v25);
    KeUnstackDetachProcess(&ApcState);
    if ( v20 < 0 )
    {
      _InterlockedIncrement(&dword_1C005069C);
