/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00B48B0
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C00231F0 (VidMmValidateHistoryBuffers.c)
 * Callees:
