/*
 * XREFs of ?EvictResource@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@EEEPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C00868C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPriorityClass@VIDMM_SEGMENT@@SA?AW4_VIDMM_ALLOCATION_PRIORITY_CLASS@@K@Z @ 0x1C00B45B4 (-GetPriorityClass@VIDMM_SEGMENT@@SA-AW4_VIDMM_ALLOCATION_PRIORITY_CLASS@@K@Z.c)
  ...
  *(_QWORD *)(*((_QWORD *)a2 + 15) + 8LL * PriorityClass + 328) += *((_QWORD *)a2 + 2);
  ...
  while ( v23 != v22 )
  {
    CommitmentInformation = VIDMM_PROCESS::GetCommitmentInformation(
                              ...
                              *((_DWORD *)this + 5));
    VidMmRecordEviction(v28 + 7184, (char *)CommitmentInformation + 56, *((_QWORD *)a2 + 2), *(unsigned int *)(v28 + 8));
  }
