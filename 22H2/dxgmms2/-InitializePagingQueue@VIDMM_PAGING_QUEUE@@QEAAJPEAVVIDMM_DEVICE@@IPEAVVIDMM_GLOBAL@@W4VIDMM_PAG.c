/*
 * XREFs of ?InitializePagingQueue@VIDMM_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IPEAVVIDMM_GLOBAL@@W4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C00790D8
 * Callers:
 ...
 *     ?InsertPagingQueueList@VIDMM_DEVICE@@QEAAXPEAVVIDMM_PAGING_QUEUE@@@Z @ 0x1C00158E4 (-InsertPagingQueueList@VIDMM_DEVICE@@QEAAXPEAVVIDMM_PAGING_QUEUE@@@Z.c)
...
__int64 __fastcall VIDMM_PAGING_QUEUE::InitializePagingQueue(__int64 a1, __int64 a2, int a3, __int64 a4, int a5)
{
  ...
  *(_DWORD *)(a1 + 132) = dword_1C005043C;
  *(_DWORD *)(a1 + 116) = a5;
  v6 = *(_QWORD *)(a4 + 24);
  if ( *(int *)(v6 + 2328) < 0x2000 )
    v7 = 1;
  else
    v7 = *(_DWORD *)(v6 + 280);
  if ( v7 > 1 )
