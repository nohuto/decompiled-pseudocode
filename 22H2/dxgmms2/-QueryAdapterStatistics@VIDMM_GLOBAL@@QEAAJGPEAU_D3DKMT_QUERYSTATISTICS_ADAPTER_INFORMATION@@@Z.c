/*
 * XREFs of ?QueryAdapterStatistics@VIDMM_GLOBAL@@QEAAJGPEAU_D3DKMT_QUERYSTATISTICS_ADAPTER_INFORMATION@@@Z @ 0x1C00EDDAC
 * Callers:
 *     VidMmQueryAdapterStatistics @ 0x1C002D1B0 (VidMmQueryAdapterStatistics.c)
 * Callees:
 *     <none>
 */
