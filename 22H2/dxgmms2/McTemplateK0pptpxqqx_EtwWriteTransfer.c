/*
 * XREFs of McTemplateK0pptpxqqx_EtwWriteTransfer @ 0x1C003197C
 * Callers:
...
NTSTATUS McTemplateK0pptpxqqx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpFill, a3, 9u, &v4);
}
