/*
 * XREFs of ?AddData@VIDMM_TELEMETRY_PAGING_COSTS@@QEAAX_KI00I0I0I0I0I0I@Z @ 0x1C00F3A94
 * Callers:
 *     ?EndOperation@VIDMM_WORKER_THREAD@@AEAAX_N0@Z @ 0x1C00ECC38 (-EndOperation@VIDMM_WORKER_THREAD@@AEAAX_N0@Z.c)
 * Callees:
        ...
        unsigned int a16)
{
  ...
  v18 = a3;
  BucketIdForAllocationSizePow2 = (unsigned int)GetBucketIdForAllocationSizePow2(a2, a2, a3, a4);
