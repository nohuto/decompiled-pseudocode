/*
 * XREFs of ?QueryAllocationResidency@VIDMM_GLOBAL@@QEAA?AW4_D3DKMT_ALLOCATIONRESIDENCYSTATUS@@PEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00B13BC
 * Callers:
 *     VidMmQueryAllocationResidency @ 0x1C0022EA0 (VidMmQueryAllocationResidency.c)
 * Callees:
