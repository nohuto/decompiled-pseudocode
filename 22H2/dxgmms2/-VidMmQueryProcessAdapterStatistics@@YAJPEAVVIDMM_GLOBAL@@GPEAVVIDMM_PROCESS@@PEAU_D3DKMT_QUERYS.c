/*
 * XREFs of ?VidMmQueryProcessAdapterStatistics@@YAJPEAVVIDMM_GLOBAL@@GPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_ADAPTER_INFORMATION@@@Z @ 0x1C002CC10
 * Callers:
 *     <none>
 * Callees:
