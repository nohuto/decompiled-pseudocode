/*
 * XREFs of ?Init@VIDMM_RECYCLE_HEAP_MGR@@UEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1C0075FF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
  ...
  else
  {
    ...
    *((_DWORD *)this + 403) = 4;
    ...
    v24 = (_QWORD *)qword_1C00507F0;
    v25 = (_QWORD *)((char *)this + 1592);
    v31 = 2;
    if ( *(struct _LIST_ENTRY **)qword_1C00507F0 != &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead )
      __fastfail(3u);
    *v25 = &VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
    v25[1] = v24;
    *v24 = v25;
    qword_1C00507F0 = (__int64)v25;
