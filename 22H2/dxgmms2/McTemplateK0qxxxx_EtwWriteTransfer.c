/*
 * XREFs of McTemplateK0qxxxx_EtwWriteTransfer @ 0x1C0039C70
 * Callers:
        ...
        char a8)
{
  ...
  v18 = &a8;
  v19 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventVSyncSmoothenedTime, a3, 6u, &v9);
}
