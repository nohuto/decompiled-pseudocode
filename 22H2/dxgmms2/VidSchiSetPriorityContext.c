/*
 * XREFs of VidSchiSetPriorityContext @ 0x1C0011234
 * Callers:
 ...
 *     VidSchSetAbsolutePriorityContext @ 0x1C00D11B0 (VidSchSetAbsolutePriorityContext.c)
 * Callees:
 ...
 *     ?VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C002CE04 (-VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z.c)
 */
