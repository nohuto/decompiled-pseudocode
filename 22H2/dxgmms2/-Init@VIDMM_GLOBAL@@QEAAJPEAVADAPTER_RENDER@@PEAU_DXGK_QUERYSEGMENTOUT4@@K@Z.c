/*
 * XREFs of ?Init@VIDMM_GLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAU_DXGK_QUERYSEGMENTOUT4@@K@Z @ 0x1C0094AA8
 * Callers:
 ...
 *     ?InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBUDXGADAPTER_GPUMMUCAPS@@PEBUDXGK_PHYSICALADAPTERINFO@@I@Z @ 0x1C00AED48 (-InitializeGpuVaState@VIDMM_PHYSICAL_ADAPTER@@QEAAJPEAVVIDMM_GLOBAL@@IPEBQEAVVIDMM_SEGMENT@@PEBU.c)
...
LABEL_84:
      ...
      _InterlockedIncrement(&dword_1C00506F4);
      v86 = WdLogNewEntry5_WdLowResource(v49);
      *(_QWORD *)(v86 + 24) = 1661LL;
...
LABEL_86:
  ...
  _InterlockedIncrement(&dword_1C00506BC);
  v82 = WdLogNewEntry5_WdLowResource(v15);
  *(_QWORD *)(v82 + 24) = 1493LL;
