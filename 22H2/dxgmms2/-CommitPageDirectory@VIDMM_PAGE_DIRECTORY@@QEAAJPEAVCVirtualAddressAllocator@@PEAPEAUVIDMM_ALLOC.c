/*
 * XREFs of ?CommitPageDirectory@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C005FCC8
 * Callers:
  ...
  *(_BYTE *)(v7 + 89) = 0;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v12 + 128) + 80LL) & 0x1000) != 0 )
      *(_QWORD *)(*((_QWORD *)this + 2) + 136LL) = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)(*(_QWORD *)(v12 + 96) + 8LL) + 24LL)
                                                                                             + 104LL))(
