/*
 * XREFs of ?DestroyAllocation@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C0069DA8
 * Callers:
 *     VidMmDestroyAllocation @ 0x1C0001610 (VidMmDestroyAllocation.c)
 * Callees:
