/*
 * XREFs of ?DelayExecution@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@IPEAVVIDMM_PAGING_QUEUE@@KPEA_K@Z @ 0x1C00AD8C0
 * Callers:
 *     ?VidMmDelayExecution@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@IPEAVVIDMM_PAGING_QUEUE@@KPEA_K@Z @ 0x1C0022690 (-VidMmDelayExecution@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@IPEAVVIDMM_PAGING_QUEUE@@KPEA_K@Z.c)
 * Callees:
        ...
        unsigned __int64 *a6)
{
  ...
  v6 = a4;
  if ( !a4 )
    v6 = (struct VIDMM_PAGING_QUEUE *)(*((_QWORD *)a2 + 9) + 176LL * a3);
  memset(v8, 0, 0x50uLL);
  v8[1] = *((_QWORD *)v6 + 17);
  LODWORD(v8[4]) = a5;
  LODWORD(v8[0]) = 217;
