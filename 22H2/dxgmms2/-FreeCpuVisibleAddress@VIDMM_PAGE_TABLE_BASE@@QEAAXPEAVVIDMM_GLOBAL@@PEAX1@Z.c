/*
 * XREFs of ?FreeCpuVisibleAddress@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVVIDMM_GLOBAL@@PEAX1@Z @ 0x1C0072350
 * Callers:
        ...
        struct _MDL *a4)
{
  ...
  if ( (v10 & 0x1001) == 0 )
  {
    ...
    else
    {
      ...
      VIDMM_CPU_HOST_APERTURE::ReleaseRange(v12, *((struct _VIDMM_GLOBAL_ALLOC **)this + 2));
