/*
 * XREFs of ?ExpandZeroPte@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@II_K222PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00BB97C
 * Callers:
...
LABEL_13:
  ...
  *(_QWORD *)(*((_QWORD *)this + 5) + 16LL * (unsigned int)v10) &= ~2uLL;
