/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00B62B8
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x1C0023210 (VidMmWaitOnAllocationPresentQueue.c)
...
__int64 __fastcall VIDMM_GLOBAL::WaitOnAllocationPresentQueue(VIDMM_GLOBAL *this, struct _VIDMM_MULTI_ALLOC *a2)
{
  ...
  __int64 v13; // rax
  _QWORD v14[20]; // [rsp+20h] [rbp-B8h] BYREF
  ...
  else
  {
    ...
    while ( (*((int *)a2 + 26) > 0 || _VIDMM_GLOBAL_ALLOC_NONPAGED::HasOutstandingPresentReferences(v2)) && v4 >= 0 )
      v4 = VidSchWaitForCompletionEvent(v6, (__int64)v14, 2LL);
    VidSchiInterlockedRemoveEntryList((KSPIN_LOCK *)(v6 + 1728), v14, 0LL);
