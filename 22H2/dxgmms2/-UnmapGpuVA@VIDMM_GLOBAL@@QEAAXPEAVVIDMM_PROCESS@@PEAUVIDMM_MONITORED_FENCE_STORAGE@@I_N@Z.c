/*
 * XREFs of ?UnmapGpuVA@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@I_N@Z @ 0x1C00844B8
 * Callers:
 *     ?VidMmUnmapGpuVA@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_PROCESS@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@@Z @ 0x1C0012BF0 (-VidMmUnmapGpuVA@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_PROCESS@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@@Z.c)
 *     ?VidMmUnmapPagingProcessGpuVA@@YAXPEAVVIDMM_GLOBAL@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@I@Z @ 0x1C0022A80 (-VidMmUnmapPagingProcessGpuVA@@YAXPEAVVIDMM_GLOBAL@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@I@Z.c)
