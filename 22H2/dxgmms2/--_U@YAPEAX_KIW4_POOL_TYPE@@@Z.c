/*
 * XREFs of ??_U@YAPEAX_KIW4_POOL_TYPE@@@Z @ 0x1C0001FC0
 * Callers:
 ...
 *     ?Init@VIDMM_WORKER_THREAD@@QEAAJPEAPEAU_KEVENT@@@Z @ 0x1C00952FC (-Init@VIDMM_WORKER_THREAD@@QEAAJPEAPEAU_KEVENT@@@Z.c)
 ...
 *     ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00B4A54 (-VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PE.c)
 ...
 *     ?Init@VIDMM_PROCESS_HEAP@@UEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1C00CBC30 (-Init@VIDMM_PROCESS_HEAP@@UEAAJPEAVVIDMM_PROCESS@@@Z.c)
 * Callees:
 *     <none>
 */
