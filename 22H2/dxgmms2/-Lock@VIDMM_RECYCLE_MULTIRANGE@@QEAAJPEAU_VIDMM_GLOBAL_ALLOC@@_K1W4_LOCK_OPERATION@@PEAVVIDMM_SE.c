/*
 * XREFs of ?Lock@VIDMM_RECYCLE_MULTIRANGE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@_K1W4_LOCK_OPERATION@@PEAVVIDMM_SEGMENT@@E@Z @ 0x1C00A17C0
 * Callers:
 ...
 *     ?Unlock@VIDMM_RECYCLE_RANGE@@QEAAXXZ @ 0x1C00F6EA8 (-Unlock@VIDMM_RECYCLE_RANGE@@QEAAXXZ.c)
 */
        ...
        switch ( (_DWORD)v13 )
        {
          case 1:
            ...
            if ( (qword_1C0076010 & 2) != 0 )
            {
              ...
              v63 = 8000;
              if ( byte_1C0076981 < 0 )
                McTemplateK0q_EtwWriteTransfer(v13, (__int64)&EventProfilerEnter, a3, 8000);
            }
            else
            {
              v65 = 0;
            ...
            if ( v15 < 0 )
            {
              ...
              if ( v65 && byte_1C0076981 < 0 )
                McTemplateK0q_EtwWriteTransfer(v54, (__int64)&EventProfilerExit, v55, v63);
              goto LABEL_94;
            }
            ++*((_DWORD *)i + 23);
...
LABEL_22:
      ...
      *((_DWORD *)this + 54) = 4;
      ...
      if ( *v31 == 1LL && !*((_DWORD *)this + 54) )
      {
        ...
        if ( !*((_DWORD *)v53 + 16) )
        {
          VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree(v31[4], 2, (__int64)this);
