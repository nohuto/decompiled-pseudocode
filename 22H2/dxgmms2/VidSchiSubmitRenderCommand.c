/*
 * XREFs of VidSchiSubmitRenderCommand @ 0x1C00CF04C
 * Callers:
 ...
 *     ?UpdateHistoryBuffer@_VIDSCH_QUEUE_PACKET@@QEAAXXZ @ 0x1C0006AF0 (-UpdateHistoryBuffer@_VIDSCH_QUEUE_PACKET@@QEAAXXZ.c)
