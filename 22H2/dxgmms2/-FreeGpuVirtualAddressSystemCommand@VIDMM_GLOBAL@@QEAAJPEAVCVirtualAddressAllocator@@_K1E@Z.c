/*
 * XREFs of ?FreeGpuVirtualAddressSystemCommand@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@_K1E@Z @ 0x1C0062290
 * Callers:
        ...
        char a5)
{
  ...
  if ( v8 )
  {
    if ( (*((_DWORD *)v8 + 18) & 0x800) == 0 || a5 )
    {
      ...
      DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v25, a2 + 7, 0);
