/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@KAXXZ @ 0x1C009466C
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  dword_1C0050500 = v2;
  dword_1C0050504 = v8 << 20;
  dword_1C0050508 = v3;
  dword_1C005050C = v4;
  if ( !v1 )
    qword_1C00501F0 = (unsigned __int64)qword_1C00501D8 >> 3;
}
