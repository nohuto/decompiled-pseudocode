/*
 * XREFs of ?VidMmMapGpuVirtualAddressInternal@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_ALLOC@@PEAUD3DDDI_MAPGPUVIRTUALADDRESS@@E@Z @ 0x1C0097030
 * Callers:
 ...
 *     ?UncommitVirtualAddressRange@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@PEAUVIDMM_MAPPED_VA_RANGE@@EPEAUVIDMM_VAD_PENDING_OPERATION@@@Z @ 0x1C008C5DC (-UncommitVirtualAddressRange@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@PEAUVIDMM_MAPPED_V.c)
...
LABEL_63:
  ...
  v60[0] = -4294967183LL;
  v60[6] = v25;
  *(_OWORD *)&v60[7] = xmmword_1C004F1D0;
  v60[5] = v22;
  v60[9] = v56[0];
  ...
  *(_OWORD *)&v56[7] = xmmword_1C004F1D0;
