/*
 * XREFs of ?DefragmentSegment@VIDMM_WORKER_THREAD@@AEAAXPEAVVIDMM_SEGMENT@@@Z @ 0x1C00EC510
 * Callers:
 ...
 *     ?VidMmiTickCountTo100ns@@YA_K_K@Z @ 0x1C00F1798 (-VidMmiTickCountTo100ns@@YA_K_K@Z.c)
