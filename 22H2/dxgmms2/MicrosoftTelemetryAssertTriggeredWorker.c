/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C004C594
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1C004C564 (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 * Callees:
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C0004D90 (_tlgWriteTransfer_EtwWriteTransfer.c)
 *     _tlgKeywordOn @ 0x1C0004E2C (_tlgKeywordOn.c)
 *     __security_check_cookie @ 0x1C0019900 (__security_check_cookie.c)
 *     GetImageTuple @ 0x1C004C514 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C004CAB8 (_tlgCreate1Sz_char.c)
 *     TakeTelemetryAssertsLock @ 0x1C004CAEC (TakeTelemetryAssertsLock.c)
 */
...
LABEL_33:
  ...
  if ( (unsigned int)dword_1C0084040 > 5 && tlgKeywordOn((__int64)&dword_1C0084040, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)dword_1C00571AD,
      0LL,
      0LL,
      0xBu,
      &v62);
  ...
  if ( dword_1C0084078 && !v19 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C0084040 > 5 )
    {
      ...
      if ( v26 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_1C0084040,
          (unsigned __int8 *)dword_1C005721A,
          v27,
          0LL,
          v28,
          &v46);
