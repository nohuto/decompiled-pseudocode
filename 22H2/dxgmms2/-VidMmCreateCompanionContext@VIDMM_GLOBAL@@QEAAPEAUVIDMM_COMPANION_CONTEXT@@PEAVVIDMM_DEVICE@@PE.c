/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00B4A54
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C0022C80 (VidMmCreateCompanionContext.c)
 * Callees:
