/*
 * XREFs of ??_GVIDMM_PARTITION@@QEAAPEAXI@Z @ 0x1C0026C6C
 * Callers:
 *     ?VidMmiClosePartition@@YAXPEAUVIDMM_PARTITION@@@Z @ 0x1C0001810 (-VidMmiClosePartition@@YAXPEAUVIDMM_PARTITION@@@Z.c)
