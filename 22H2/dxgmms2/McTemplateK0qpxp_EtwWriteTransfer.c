/*
 * XREFs of McTemplateK0qpxp_EtwWriteTransfer @ 0x1C0028014
 * Callers:
 ...
 *     ?ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ @ 0x1C00C05C8 (-ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ.c)
...
NTSTATUS __fastcall McTemplateK0qpxp_EtwWriteTransfer(
        __int64 a1,
