/*
 * XREFs of McTemplateK0pppttxqx_EtwWriteTransfer @ 0x1C0032A48
 * Callers:
 *     ?ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00FED5C (-ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ.c)
 * Callees:
