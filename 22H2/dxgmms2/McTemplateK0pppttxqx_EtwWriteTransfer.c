/*
 * XREFs of McTemplateK0pppttxqx_EtwWriteTransfer @ 0x1C00287A8
 * Callers:
 *     ?ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00C7454 (-ReportSegmentState@VIDMM_SEGMENT@@QEAAXXZ.c)
 * Callees:
