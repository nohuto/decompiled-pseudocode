/*
 * XREFs of ?ProcessDebounceList@VIDMM_RECYCLE_HEAP_MGR@@QEAAX_N0@Z @ 0x1C00747C8
 * Callers:
 ...
 * Callees:
 *     ?IsOverLimits@VIDMM_RECYCLE_HEAP_MGR@@SA_NXZ @ 0x1C0001E24 (-IsOverLimits@VIDMM_RECYCLE_HEAP_MGR@@SA_NXZ.c)
...
void __fastcall VIDMM_RECYCLE_HEAP_MGR::ProcessDebounceList(VIDMM_RECYCLE_HEAP_MGR *this, char a2, char a3)
{
  ...
  if ( v5 != (VIDMM_RECYCLE_HEAP_MGR *)((char *)this + 1536) )
  {
    while ( 1 )
    {
      ...
      LOBYTE(v32) = 0;
      v17 = VIDMM_RECYCLE_RANGE::DebouncedUnlock(v12, (bool *)&v32);
      v20 = v17;
      if ( v17 < 0 )
      {
        v24 = (_QWORD *)WdLogNewEntry5_WdWarning(v19, v18);
        v24[3] = v12;
        v24[4] = v20;
        v24[5] = **((_QWORD **)this + 1);
      ...
      if ( !(_BYTE)v32 )
      {
        v21 = (VIDMM_RECYCLE_MULTIRANGE *)*((_QWORD *)v12 + 17);
        if ( v21 )
          VIDMM_RECYCLE_MULTIRANGE::MergeSubrangesWherePossible(v21, v18);
      }
      v4 = v33;
      if ( v5 == v3 )
      {
