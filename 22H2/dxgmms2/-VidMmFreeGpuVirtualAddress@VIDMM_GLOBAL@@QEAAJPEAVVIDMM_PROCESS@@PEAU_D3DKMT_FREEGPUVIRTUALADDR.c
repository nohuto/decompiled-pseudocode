/*
 * XREFs of ?VidMmFreeGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_FREEGPUVIRTUALADDRESS@@E@Z @ 0x1C0087A5C
 * Callers:
 *     VidMmFreeGpuVirtualAddress @ 0x1C002D0B0 (VidMmFreeGpuVirtualAddress.c)
