/*
 * XREFs of ?PurgeAllSegments@VIDMM_GLOBAL@@QEAAXU_VIDMM_PURGE_FLAGS@@PEAVVIDMM_PROCESS@@@Z @ 0x1C00B0F18
 * Callers:
 *     VidMmPurgeAllSegments @ 0x1C0022E80 (VidMmPurgeAllSegments.c)
 * Callees:
 ...
 *     ?AddData@VIDMM_PURGE_TELEMETRY@@QEAAX_K0@Z @ 0x1C00BE268 (-AddData@VIDMM_PURGE_TELEMETRY@@QEAAX_K0@Z.c)
