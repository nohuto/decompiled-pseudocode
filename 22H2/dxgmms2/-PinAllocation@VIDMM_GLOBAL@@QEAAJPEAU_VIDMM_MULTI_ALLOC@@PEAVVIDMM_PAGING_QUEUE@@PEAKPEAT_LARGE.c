/*
 * XREFs of ?PinAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAVVIDMM_PAGING_QUEUE@@PEAKPEAT_LARGE_INTEGER@@PEA_K@Z @ 0x1C00B0BB8
 * Callers:
 *     VidMmPinAllocation @ 0x1C0022E30 (VidMmPinAllocation.c)
 * Callees:
