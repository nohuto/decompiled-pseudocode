/*
 * XREFs of VidSchiSubmitMmIoFlipCommand @ 0x1C0002FF0
 * Callers:
...
LABEL_111:
          ...
          if ( v95 )
            VidSchiUpdateFlipQueueHistory(0, v6, v149, v14, v66);
          goto LABEL_78;
        }
LABEL_183:
...
LABEL_110:
        ...
        *(_DWORD *)(v18 + 1052) = 4;
        v95 = 0;
        VidSchiUpdateFlipQueueHistory(0, v6, v94, v14, v66);
...
LABEL_165:
  ...
  v76 = v149;
  VidSchiUpdateFlipQueueHistory(0, v6, v149, v14, v120);
LABEL_80:
  *((_DWORD *)v2 + 16) |= 2u;
  if ( v147 )
