/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@@Z @ 0x1C00948A4
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C0017410 (VidMmInitializeAdapter.c)
 * Callees:
...
LABEL_24:
  ...
  if ( v18 < 0 )
  {
    _InterlockedIncrement(&dword_1C00506C0);
