/*
 * XREFs of ?AllocateVirtualAddressRange@CVirtualAddressAllocator@@QEAAJPEAU_RTL_AVL_TREE@@_K111IPEAPEAUVIDMM_VAD@@E@Z @ 0x1C00A47E0
 * Callers:
 ...
 *     ?FindNodeInFreeList@CVirtualAddressAllocator@@IEAAPEAUVIDMM_VAD@@PEAX@Z @ 0x1C00A4C20 (-FindNodeInFreeList@CVirtualAddressAllocator@@IEAAPEAUVIDMM_VAD@@PEAX@Z.c)
        ...
        unsigned __int8 a9)
{
  ...
  struct _RTL_AVL_TREE *Vad; // [rsp+D8h] [rbp+10h] BYREF
...
LABEL_46:
          ...
          _InterlockedIncrement(&dword_1C007689C);
