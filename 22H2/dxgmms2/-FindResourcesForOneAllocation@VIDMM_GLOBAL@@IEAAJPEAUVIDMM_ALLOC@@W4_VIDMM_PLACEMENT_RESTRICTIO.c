/*
 * XREFs of ?FindResourcesForOneAllocation@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@_NI_K@Z @ 0x1C0095D8C
 * Callers:
...
LABEL_8:
  ...
  if ( (v13 & 0x4000000) != 0 && v12 >= 0 )
  {
    ...
    if ( v16 )
    {
      BucketIdForAllocationSizePow2 = GetBucketIdForAllocationSizePow2(v17, v13, v15, v17);
    ...
    {
      v24 = GetBucketIdForAllocationSizePow2(v17, v13, v15, v17);
