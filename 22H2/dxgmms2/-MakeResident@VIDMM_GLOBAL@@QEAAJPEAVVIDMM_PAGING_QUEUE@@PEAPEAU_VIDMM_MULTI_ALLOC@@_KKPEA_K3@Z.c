/*
 * XREFs of ?MakeResident@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PAGING_QUEUE@@PEAPEAU_VIDMM_MULTI_ALLOC@@_KKPEA_K3@Z @ 0x1C0097B70
 * Callers:
 *     ?VidMmMakeResident@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PAGING_QUEUE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K3@Z @ 0x1C0005280 (-VidMmMakeResident@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PAGING_QUEUE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPE.c)
 ...
 *     VidMmiShouldChargeAllocationAgainstBudget @ 0x1C0098068 (VidMmiShouldChargeAllocationAgainstBudget.c)
        ...
        unsigned __int64 *a7)
{
  ...
  *a7 = 0LL;
  ...
  if ( *a7 )
  {
    ...
    if ( (a5 & 2) != 0 )
      VidSchMarkDeviceAsError(*(_QWORD *)(v11 + 32), 12, 0LL);
    return 3221225495LL;
  }
  else
  {
