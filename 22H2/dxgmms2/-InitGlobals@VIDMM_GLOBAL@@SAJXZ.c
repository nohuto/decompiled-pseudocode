/*
 * XREFs of ?InitGlobals@VIDMM_GLOBAL@@SAJXZ @ 0x1C00BD954
 * Callers:
 ...
 *     McGenEventRegister_EtwRegister @ 0x1C00195E4 (McGenEventRegister_EtwRegister.c)
...
__int64 VIDMM_GLOBAL::InitGlobals(void)
{
  ...
  if ( VIDMM_PROCESS::_pDxProcessPerAdapterCount )
  {
    ...
    qword_1C0076918 = (__int64)&VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
    ...
    if ( v5 )
    {
      ...
      *(_DWORD *)(v5 + 24) = -1;
      ...
      qword_1C0076938 = (__int64)&VIDMM_GLOBAL::_AdapterListHead;
