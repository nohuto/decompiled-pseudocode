/*
 * XREFs of McTemplateK0pxqqt_EtwWriteTransfer @ 0x1C00321E4
 * Callers:
...
NTSTATUS McTemplateK0pxqqt_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, a2, a3, 6u, &v4);
}
