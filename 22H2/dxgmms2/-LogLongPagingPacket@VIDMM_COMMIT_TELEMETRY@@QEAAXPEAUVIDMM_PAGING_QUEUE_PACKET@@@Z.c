/*
 * XREFs of ?LogLongPagingPacket@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAUVIDMM_PAGING_QUEUE_PACKET@@@Z @ 0x1C00BEA40
 * Callers:
        ...
        struct VIDMM_PAGING_QUEUE_PACKET *a2)
{
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 260LL)) <= 5 )
  {
    ...
    if ( (unsigned int)dword_1C0050048 > 5 && tlgKeywordOn((__int64)&dword_1C0050048, 0x400000000008LL) )
    {
      v5 = *((_QWORD *)a2 + 17);
      v6 = *((_QWORD *)a2 + 19);
      v15 = **(_QWORD **)(*((_QWORD *)this + 1) + 8LL);
      v11[0] = 2;
      v12 = v6 - v5;
      v7 = *((_QWORD *)a2 + 18);
      v8 = v6 - v7;
