/*
 * XREFs of ?VidSchiUpdateNodeYieldStatus@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x1C0014C24
 * Callers:
 *     VidSchiSelectContext @ 0x1C000B3E0 (VidSchiSelectContext.c)
 * Callees:
 *     VidSchiStartNodeYield @ 0x1C0014D00 (VidSchiStartNodeYield.c)
 *     VidSchiMonitorRefreshPeriodFromNode @ 0x1C0014DBC (VidSchiMonitorRefreshPeriodFromNode.c)
 *     ?VidSchiStopNodeYield@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x1C0014FC4 (-VidSchiStopNodeYield@@YAXPEAU_VIDSCH_NODE@@@Z.c)
