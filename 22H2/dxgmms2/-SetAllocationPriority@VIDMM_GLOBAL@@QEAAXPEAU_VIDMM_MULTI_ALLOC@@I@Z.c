/*
 * XREFs of ?SetAllocationPriority@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00E754C
 * Callers:
 *     VidMmSetAllocationPriority @ 0x1C002D330 (VidMmSetAllocationPriority.c)
 * Callees:
