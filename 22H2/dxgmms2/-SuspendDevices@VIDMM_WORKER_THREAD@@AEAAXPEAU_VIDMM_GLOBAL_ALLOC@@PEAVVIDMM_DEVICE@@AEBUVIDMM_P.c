/*
 * XREFs of ?SuspendDevices@VIDMM_WORKER_THREAD@@AEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_DEVICE@@AEBUVIDMM_PAGE_IN_POLICY_PER_COMBINATION@@W4VIDMM_BUDGET_PRIORITY_BAND@@W4_VIDMM_PLACEMENT_RESTRICTION@@PEA_NPEAPEAV3@@Z @ 0x1C00B8728
 * Callers:
...
LABEL_8:
  v20 = *v13;
  v14 &= ~(1 << v18);
  v21 = (unsigned int)(*(_DWORD *)(1584LL * v11 + *(_QWORD *)(v20 + 40216) + 20) + v18);
  v35 = v21;
  if ( (**(_DWORD **)(a2 + 496) & 0x20000) != 0 )
  {
    v10 = *(_DWORD *)(v9 + 4);
    v22 = *(_QWORD *)(*(_QWORD *)(v20 + 3712) + 8 * v21);
    v30[1] = (struct _LIST_ENTRY *)v30;
    v30[0] = (struct _LIST_ENTRY *)v30;
    DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v31, (struct _KTHREAD **)(v20 + 44472), 0);
      ...
      if ( *(_DWORD *)(v22 + 412) )
      {
        ...
        if ( (struct _LIST_ENTRY **)v30[0] != v30 )
        {
          *a7 = 1;
          ...
          {
            v25 = v24;
            p_Blink = (VIDMM_GLOBAL **)&v24[-12].Blink;
            v24 = v24->Flink;
