/*
 * XREFs of ??1VIDMM_MEMORY_SEGMENT@@UEAA@XZ @ 0x1C00F8B78
 * Callers:
 *     ??_EVIDMM_MEMORY_SEGMENT@@UEAAPEAXI@Z @ 0x1C0032620 (--_EVIDMM_MEMORY_SEGMENT@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1VIDMM_CPU_HOST_APERTURE@@QEAA@XZ @ 0x1C0032E6C (--1VIDMM_CPU_HOST_APERTURE@@QEAA@XZ.c)
