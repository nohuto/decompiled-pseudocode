/*
 * XREFs of ?VidMmiAddTriageData@@YAXPEAU_KBUGCHECK_TRIAGE_DUMP_DATA@@PEAU_KTRIAGE_DUMP_DATA_ARRAY@@@Z @ 0x1C002FBB0
 * Callers:
 *     DxgMmsDbgTriageDumpCallback @ 0x1C002D580 (DxgMmsDbgTriageDumpCallback.c)
 * Callees:
 *     <none>
 */
