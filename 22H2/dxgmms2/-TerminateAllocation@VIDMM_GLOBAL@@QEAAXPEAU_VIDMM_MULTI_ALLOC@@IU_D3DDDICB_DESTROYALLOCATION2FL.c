/*
 * XREFs of ?TerminateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C007DBF0
 * Callers:
 *     VidMmTerminateAllocation @ 0x1C0006070 (VidMmTerminateAllocation.c)
 * Callees:
        ...
        struct DXGTERMINATIONTRACKER *a5)
{
  ...
  *((_DWORD *)a2 + 8) |= 1u;
  ...
  v13 = **a2;
  v14 = *(_QWORD *)(v13 + 16);
  if ( (**(_DWORD **)(v13 + 496) & 0x20000000) != 0 )
  {
    ++*((_DWORD *)this + 1938);
    *((_QWORD *)this + 970) += v14;
  }
  ...
  v25[6] = v23;
  LODWORD(v25[0]) = (v5 & 1) == 0 || (**(_DWORD **)(v8 + 496) & 0x4000) != 0;
  v16 = a2[1][4];
