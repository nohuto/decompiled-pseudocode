/*
 * XREFs of VidSchWaitForSingleSyncObject @ 0x1C0003B60
 * Callers:
 ...
 *     ?GetCurrentPagingFenceId@VIDMM_PAGING_QUEUE@@QEAA_KXZ @ 0x1C00900E4 (-GetCurrentPagingFenceId@VIDMM_PAGING_QUEUE@@QEAA_KXZ.c)
