/*
 * XREFs of sub_180091D48 @ 0x180091D48
 * Callers:
...
__int64 __fastcall sub_180091D48(_DWORD *a1, __int64 a2, char a3)
{
  __int64 result; // rax
  char v6; // bl
  BOOL v7; // r14d
  ...
  if ( !(_DWORD)result || (_DWORD)result == 3 )
  {
    ...
    if ( v8 )
    {
      v9 = (__int64 *)sub_18009265C(a1, v34, 0LL);
      v10 = *v9;
      v22 = *v9;
    ...
    {
      v12 = (__int64 *)sub_18009265C(a1, v32, 0LL);
      v10 = *v12;
    ...
    *v11 = 0LL;
    ...
    v27 = v26;
    v26 = 0LL;
    v17 = sub_1800926EC(a1, v36, 0LL);
    v18 = sub_1800926BC(a1, v37, 0LL);
    result = sub_180110BC8(v18, v17, a1[30], (unsigned int)&v27, a1[28], v8, v7, a3, (__int64)v38, 0LL, (__int64)&v28);
