/*
 * XREFs of sub_18001C744 @ 0x18001C744
 * Callers:
...
__m128 __fastcall sub_18001C744(__m128 *a1, double a2, double a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm13
  __m128 v6; // xmm14
  ...
  if ( a1 )
    *a1 = v23;
  return _mm_mul_ps(_mm_div_ps((__m128)xmmword_180139A80, v23), v19);
}
