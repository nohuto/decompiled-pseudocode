/*
 * XREFs of sub_1800B7D78 @ 0x1800B7D78
 * Callers:
...
__m128 *__fastcall sub_1800B7D78(__m128 *a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  __m128 v3; // xmm6
  __m128 v4; // xmm3
  __m128 v5; // xmm2
  ...
  v7 = _mm_or_ps(
         _mm_andnot_ps((__m128)xmmword_180139B80, _mm_sub_ps((__m128)0LL, _mm_shuffle_ps(v5, v5, 0))),
         _mm_and_ps((__m128)xmmword_180139B80, v4));
  if ( !a1 )
