/*
 * XREFs of sub_180096B80 @ 0x180096B80
 * Callers:
 ...
 *     sub_1800688C4 @ 0x1800688C4 (sub_1800688C4.c)
...
unsigned __int64 __fastcall sub_180096B80(__int64 a1, __int64 *a2, __int64 a3, __int64 *a4)
{
  __int64 v5; // r13
  __int64 v8; // rcx
  _QWORD *v9; // r8
  ...
  {
    v9 = sub_180068240((_QWORD *)*a2, &v74);
    v90 = 0LL;
    v10 = v9[1];
    if ( v10 )
    {
    ...
    if ( (_QWORD)v90 )
    {
      ...
      v76 = v13;
      v77 = v14;
      v17 = sub_18007FCB4(v13, &v72);
      v18 = (char *)sub_18002C274((const void **)&Src, (_QWORD *)(*a4 + 24), "_");
      v19 = (_QWORD *)sub_180093CE8((__int64)&v68, v18, v17);
      ...
      v20->m128i_i8[0] = 0;
      v21 = (unsigned __int64 *)sub_1800D02F0(v90, v78, &v65, a2);
      v22 = *v21;
      v23 = v21[1];
      *v21 = 0LL;
      v21[1] = 0LL;
  ...
  v87 = v34[2];
  v88 = v34[3];
  sub_180084024(*(double *)&v85, *(double *)&v86, *(double *)&v87, *(double *)&v88);
  ...
  if ( v37 / 88 )
  {
    v39 = 0LL;
    v61 = 0LL;
    while ( !sub_180095D24(a1, v36) || v36 < 0x20 && ((1 << v36) & dword_18020C618) == 0 )
    {
LABEL_104:
      ++v36;
      v39 += 88LL;
...
LABEL_100:
    ...
    sub_18008C298(v63, (__int64)&v92, v5, a2, v35);
    v41 = v92;
    v42 = *(_DWORD *)(v92 + 128);
    if ( v42 )
    {
...
LABEL_95:
    ...
    if ( !v43 )
    {
      ...
      *((_QWORD *)&v67 + 1) = v44;
      if ( v45 )
      {
        v46 = (_QWORD *)sub_1800A4A30(v45, v82);
        ...
        if ( v50 )
          sub_1800EEDE8(v50, a2, v94);
        sub_1800688C4(*a2, *(_BYTE *)(a1 + 168));
        v84 = *(_OWORD *)(a1 + 172);
        sub_1800686A4(*a2, &v84);
        v51 = v61;
        v52 = *(_QWORD *)(v61 + v48 + 40);
        if ( v52 )
        {
          sub_1800EEDE8(v52, a2, v49);
          v51 = v61;
        }
        v53 = *(_QWORD *)(v51 + v48 + 56);
        if ( v53 )
        {
          sub_1800EEDE8(v53, a2, v49);
          v51 = v61;
        }
        v54 = *(_QWORD *)(v51 + v48 + 72);
        if ( v54 )
          sub_1800EEDE8(v54, a2, v49);
        sub_1800928C0(*(_QWORD *)(a1 + 88), a2, *(_QWORD *)(v41 + 136));
        v5 = v64;
      }
      if ( v44 )
      {
