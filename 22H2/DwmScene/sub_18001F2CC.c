/*
 * XREFs of sub_18001F2CC @ 0x18001F2CC
 * Callers:
...
int __fastcall sub_18001F2CC(__int64 a1)
{
...
LABEL_6:
    ...
    JUMPOUT(0x18001F3B8LL);
  }
  v9 = _std_type_info_hash(&qword_18020FD38);
  sub_180020D3C(a1, v6, &v9);
  v7[0] = &std::_Func_impl_no_alloc<_lambda_1bf4f65eb3aa0df8ad84d0734f8c2df8_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v8 = v7;
