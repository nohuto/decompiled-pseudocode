...
__int64 __fastcall sub_1800BD2B0(__int64 a1, int a2)
{
  ...
  *(_WORD *)v19 = 0;
  ...
  (*(void (__fastcall **)(__int64, __int64 *, void *, char *))(*(_QWORD *)v4 + 96LL))(v4, v32, &unk_18020A308, v19);
  sub_18001EF80(Buf1);
  v5 = &qword_18020D608;
  if ( *((_QWORD *)&xmmword_18020D618 + 1) >= 0x10uLL )
    v5 = (void **)qword_18020D608;
  v6 = Buf1;
  v7 = (char *)Buf1[0];
  v8 = Size[1];
  if ( Size[1] >= 0x10 )
    v6 = (void **)Buf1[0];
  if ( Size[0] == (_QWORD)xmmword_18020D618 && !memcmp(v6, v5, Size[0]) )
  {
    v28 = 0LL;
...
LABEL_19:
    ...
    *(_WORD *)v22 = 0;
    ...
    (*(void (__fastcall **)(__int64, __int64 *, void *, char *))(*(_QWORD *)v4 + 96LL))(v4, v31, &unk_18020A2E8, v22);
    if ( v31[2] )
    {
      sub_18001EF80(v29);
      v14 = v29;
