/*
 * XREFs of sub_1800C5C50 @ 0x1800C5C50
 * Callers:
...
__m128 __fastcall sub_1800C5C50(double a1)
{
  __m128 v1; // xmm2
  __m128 v2; // xmm1
  __m128 v3; // xmm2
  ...
  if ( (_mm_movemask_ps(_mm_cmpeq_ps(*(__m128 *)&a1, (__m128)0LL)) & 7) == 7 )
    wassert(
      ...
      0x758u);
  if ( _mm_movemask_ps(_mm_cmpeq_ps(_mm_and_ps((__m128)xmmword_180139B20, *(__m128 *)&a1), (__m128)xmmword_180139B00)) )
  ...
  v4 = _mm_and_ps(_mm_div_ps(*(__m128 *)&a1, _mm_sqrt_ps(v3)), _mm_cmpneq_ps((__m128)xmmword_180139B00, v3));
  return _mm_add_ps(
           _mm_mul_ps(_mm_shuffle_ps(v4, v4, 0), _mm_mul_ps((__m128)xmmword_1801D2350, v4)),
           (__m128)xmmword_1801399F0);
}
