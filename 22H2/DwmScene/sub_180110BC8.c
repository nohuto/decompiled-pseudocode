/*
 * XREFs of sub_180110BC8 @ 0x180110BC8
 * Callers:
...
__int64 __fastcall sub_180110BC8(
        size_t *a1,
        __int64 *a2,
        unsigned int a3,
        __int64 *a4,
        ...
        __int64 a11)
{
  ...
  v58 = a10;
  *(_QWORD *)&v46 = a11;
  if ( !(unsigned __int8)sub_1801118F8(a3, "ComputeTangentsAndNormals") )
  {
    v45 = 0LL;
    v46 = 0LL;
    v58 = a10;
...
LABEL_68:
  ...
  *(_OWORD *)v63 = 0LL;
  ...
  sub_18010FA8C(v63, v21);
  if ( !v63[0] )
    goto LABEL_68;
  memset(v63[0], 0, 16 * v12);
  v64 = 0LL;
  v65 = 0LL;
  sub_1800F5A84(&v64, (unsigned int)(2 * v12));
  *(_QWORD *)&v45 = v64;
  Size = 12 * v12;
  ...
  *(_OWORD *)v62 = 0LL;
  ...
  try
  {
    ...
    if ( a6 )
    {
      ...
      {
        sub_1801117C8(a5, a7);
        sub_18010F814(Size, v12, *a4, a5, v57, a7, (_QWORD *)v46, (__int64)v62[0], v45, v44);
      }
      else
      {
        sub_180111860((unsigned int)v12, a7);
        sub_18010FD74(Size, v12, v57, a7, (_QWORD *)v46, (__int64)v62[0], v45, v44);
      }
    }
    else
    {
      sub_1801117C8(a5, a7);
      sub_18010F63C(Size, v12, *a4, a5, v57, a7, (_QWORD *)v46, (__int64)v62[0], v45, v44);
    }
  }
  ...
  catch ( const Spectre::Framework::GeometryProcessingException *v53 )
  {
    ...
    if ( *((_QWORD *)v53 + 6) >= 0x10uLL )
      v37 = *(const char **)v37;
    sub_1801163DC(&unk_18020DAB0, 3LL, v37);
    v50 = 0LL;
    v44 = 0LL;
    Size = v58;
    v38 = *(_QWORD *)(a9 + 56);
  ...
  {
    sub_1801163DC(&unk_18020DAB0, 3LL, "ComputeTangentsAndNormals threw exception");
    v52 = 0LL;
    v51 = 0LL;
    v57 = v58;
    v41 = *(_QWORD *)(a9 + 56);
...
LABEL_44:
  ...
  sub_180111670(v63[0], v12, v62[0], v45, v44, a8);
  v24 = *(_QWORD *)(a9 + 56);
  if ( !v24 )
  {
    std::_Xbad_function_call();
    JUMPOUT(0x18011137ALL);
  }
  ...
  result = sub_1800F0948((__int64 *)&v64);
