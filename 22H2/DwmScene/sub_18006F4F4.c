/*
 * XREFs of sub_18006F4F4 @ 0x18006F4F4
 * Callers:
...
__int64 __fastcall sub_18006F4F4(__int64 **a1, __int64 a2, char a3, __int64 a4, _QWORD *a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rsi
  __int64 v10; // rax
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)*v8 )
      {
        *(_QWORD *)a2 = *sub_18006D638(a1, &v15, 1, v9, a4, a5);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180022400(&v15);
    ...
    {
      *(_QWORD *)a2 = *sub_18006D638(a1, &v15, v11, v9, a4, a5);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
