/*
 * XREFs of _setlocale_set_cat_0 @ 0x1800AA5C4
 * Callers:
...
__int64 __fastcall setlocale_set_cat_0(_QWORD *a1, __int64 *a2, _QWORD *a3)
{
  ...
  v6 = a1 + 212;
  result = _std_type_info_compare(a1[212] + 8LL, &unk_1802143D0);
  if ( (_DWORD)result )
  {
    sub_18002C274(Src, a1 + 3, " effect");
    v41 = 0LL;
    v9 = sub_18006AA58(*a2, v8);
    v41 = 0LL;
    v10 = *(_QWORD *)(v9 + 8);
    if ( v10 )
    ...
    *((_QWORD *)&v28 + 1) = v14;
    ...
    if ( (_QWORD)v43 != *((_QWORD *)&v43 + 1) )
    {
      ...
      {
        sub_18000FD48(v36);
        v25 = sub_18000FD48(v35);
        sub_180027FF4(v39, v25, 858, (__int64)v36, 0);
        throw (Spectre::Engine::EngineInvalidArgException *)v39;
      }
      if ( *(_DWORD *)(*(_QWORD *)v43 + 176LL) != 1 )
      {
        sub_18000FD48(v38);
        v24 = sub_18000FD48(v37);
        sub_180027FF4(pExceptionObject, v24, 865, (__int64)v38, 0);
      ...
      if ( *(_BYTE *)(*(_QWORD *)v43 + 136LL) )
      {
        ...
        *(_QWORD *)&v27 = *v15;
        *((_QWORD *)&v27 + 1) = v19;
        sub_1800D6570(v28, (unsigned int)&v42, (_DWORD)a3, (unsigned int)&v27, (__int64)&v26);
        if ( v16 )
        {
