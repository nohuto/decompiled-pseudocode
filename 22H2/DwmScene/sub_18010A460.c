...
__int64 __fastcall sub_18010A460(__int64 a1, __int64 a2, _QWORD *a3, unsigned __int16 a4)
{
  ...
  if ( a4 == (unsigned __int16)sub_18008C954(a2, (__int64)&qword_18020B4D8)
    && sub_18008CB4C(a2)
    && (*(_BYTE *)(*a3 + 160LL) & 2) != 0 )
  {
    sub_18008D1B8(a2, 1);
  ...
  result = sub_18008C954(a2, (__int64)&qword_18020B518);
  if ( a4 == (_WORD)result )
  {
    Src = xmmword_18021AB50;
    if ( *a3 )
    {
      if ( (*(_BYTE *)(*a3 + 160LL) & 2) != 0 )
        v10 = xmmword_1801D3390;
      else
        v10 = xmmword_1801D6600;
      Src = v10;
    }
