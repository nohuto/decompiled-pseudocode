/*
 * XREFs of sub_1800C5598 @ 0x1800C5598
 * Callers:
...
__int64 __fastcall sub_1800C5598(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // ebp
  ...
  v7 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)a4 + 72LL))(a4, &unk_180208848, 0LL);
  v8 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a2 + 64LL))(a2);
  if ( v7 != v8 )
    (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)a2 + 56LL))(a2, v7);
  result = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)a4 + 72LL))(a4, &unk_180208868, 0LL);
  if ( (_DWORD)result )
  {
    v10 = dword_1801D2670[(int)result];
