/*
 * XREFs of sub_18001FC2C @ 0x18001FC2C
 * Callers:
...
int __fastcall sub_18001FC2C(__int64 a1)
{
...
LABEL_6:
    ...
    JUMPOUT(0x18001FD18LL);
  }
  v9 = _std_type_info_hash(&qword_18020EBB8);
  sub_180020D3C(a1, v6, &v9);
  v7[0] = &std::_Func_impl_no_alloc<_lambda_4751ef0567697aa51a05750371275a1e_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v8 = v7;
