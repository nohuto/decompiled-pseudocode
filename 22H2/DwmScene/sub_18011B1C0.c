/*
 * XREFs of sub_18011B1C0 @ 0x18011B1C0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall sub_18011B1C0(__int64 a1, _QWORD *a2)
{
...
LABEL_7:
    ...
    JUMPOUT(0x18011B26DLL);
  }
  v6 = (char *)(*(__int64 (__fastcall **)(__int64, __int64 *, _QWORD *))(*(_QWORD *)a1 + 56LL))(a1, v12, a2);
  sub_18011A458((char **)(a1 + 144), (__int64)&v11, v6);
  v7 = v11;
  unknown_libname_101(v12);
  if ( a2[3] >= 8uLL )
    a2 = (_QWORD *)*a2;
  v8 = sub_18011CCD8(v7 + 64, a2);
  v9 = Mtx_unlock(v4);
  if ( v9 )
  {
