/*
 * XREFs of sub_18008DC38 @ 0x18008DC38
 * Callers:
...
__int64 __fastcall sub_18008DC38(__int64 a1, __int64 *a2, __int64 a3, unsigned __int8 a4)
{
  _QWORD *v6; // rcx
