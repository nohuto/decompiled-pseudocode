...
void __fastcall sub_1800C1360(__int64 a1, __int64 *a2)
{
  ...
  *((_QWORD *)&v58 + 1) = v5;
  ...
  v6 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208888, 0LL);
  sub_1800AC620((__int64)v69[0], 0, v6);
  if ( v6 )
    Concurrency::details::SchedulerProxy::SetQueueLength(v69[0], 0);
  LOBYTE(v7) = 1;
  v8 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v4 + 64LL))(v4, &unk_1802088A8, v7);
  v59 = v60;
  v64[4] = (__int64)v61;
  v60[2] = 0LL;
  v60[3] = 0LL;
  sub_18001CDF8(v60, (__int64)&qword_18020C098);
  v61[2] = 0LL;
  v61[3] = 0LL;
  sub_18001CDF8(v61, (__int64)&qword_18020C118);
  v62[2] = 0LL;
  v62[3] = 0LL;
  sub_18001CDF8(v62, (__int64)&qword_18020C0F8);
  sub_1800AC3C8((__int64)v69[0], v8 != 0, 0, v62, v61, v60);
  sub_1800AC604((__int64)v69[0], 1, v8);
  v9 = v69[0];
  LOBYTE(v10) = 1;
  v11 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v4 + 64LL))(v4, &unk_1802088C8, v10);
  sub_1800AC620((__int64)v9, 1, v11);
  v12 = v69[0];
  LOBYTE(v13) = 1;
  v14 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v4 + 64LL))(v4, &unk_1802088E8, v13);
  sub_1800AC620((__int64)v12, 2, v14);
  v15 = v69[0];
  LOBYTE(v16) = 1;
  v17 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208908, v16);
  sub_1800AC620((__int64)v15, 3, v17);
  LOBYTE(v18) = 1;
  v19 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208928, v18);
  sub_180097B34(0LL, v19);
  LOBYTE(v20) = 1;
  v21 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208948, v20);
  sub_180097B34(1uLL, v21);
  v22 = v69[0];
  v23 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208D48, 0LL);
...
LABEL_14:
  ...
  {
    v30 = *v29;
    v31 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_1802089C8, 0LL);
    sub_1800AC604(v30, 0x10000, v31);
    v32 = *(_QWORD *)v27[6];
    v33 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_1802089E8, 0LL);
    sub_1800AC604(v32, 0x20000, v33);
    v34 = *(_QWORD *)v27[6];
    v35 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208A08, 0LL);
    sub_1800AC604(v34, 0x40000, v35);
    v36 = *(_QWORD *)v27[6];
    v37 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208A28, 0LL);
    sub_1800AC604(v36, 0x80000, v37);
    v38 = *(_QWORD *)v27[6];
    v39 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208A48, 0LL);
    sub_1800AC604(v38, 0x100000, v39);
    v40 = *(_QWORD *)v27[6];
    v41 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208A68, 0LL);
    sub_1800AC604(v40, 0x200000, v41);
    v42 = *(_QWORD *)v27[6];
    v43 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208A88, 0LL);
    sub_1800AC604(v42, 0x400000, v43);
    v44 = *(_QWORD *)v27[6];
    v45 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208AA8, 0LL);
    sub_1800AC604(v44, 0x800000, v45);
    v46 = *(_QWORD *)v27[6];
    v47 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208AC8, 0LL);
    sub_1800AC604(v46, 0x10000000, v47);
    v48 = *(_QWORD *)v27[6];
    v49 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208AE8, 0LL);
    sub_1800AC604(v48, 0x20000000, v49);
  }
  LOBYTE(v24) = 1;
  v50 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208D88, v24);
  LOBYTE(v51) = 1;
  v52 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v4 + 64LL))(v4, &unk_180208DA8, v51);
  v63[2] = 0LL;
  v63[3] = 0LL;
  sub_18001269C(v63, (__int64)&unk_180208648);
  ...
  v64[2] = 0LL;
  v64[3] = 0LL;
  sub_18001269C(v64, (__int64)&unk_180208688);
