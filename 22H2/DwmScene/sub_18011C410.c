...
__int64 __fastcall sub_18011C410(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 80) = 0LL;
  ...
  if ( dword_18021AC7C > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021AC7C);
    if ( dword_18021AC7C == -1 )
    {
      dword_18021AC78 = 0;
      Init_thread_footer(&dword_18021AC7C);
    }
  }
  *(_DWORD *)(a1 + 20) = _InterlockedIncrement(&dword_18021AC78);
