...
void *sub_180115A74()
{
  if ( dword_18021ABE0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021ABE0);
    if ( dword_18021ABE0 == -1 )
    {
      Mtx_init_in_situ((_Mtx_t)&unk_18021AB90, 2);
      atexit(sub_180133AA0);
      Init_thread_footer(&dword_18021ABE0);
    }
  }
  return &unk_18021AB90;
}
