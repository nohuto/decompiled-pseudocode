/*
 * XREFs of sub_1800C8224 @ 0x1800C8224
 * Callers:
 *     sub_1800C9740 @ 0x1800C9740 (sub_1800C9740.c)
 * Callees:
...
_OWORD *__fastcall sub_1800C8224(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
