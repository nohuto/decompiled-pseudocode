/*
 * XREFs of sub_180022B2C @ 0x180022B2C
 * Callers:
 *     sub_180026A40 @ 0x180026A40 (sub_180026A40.c)
 * Callees:
...
_QWORD *__fastcall sub_180022B2C(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_1800211CC((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
