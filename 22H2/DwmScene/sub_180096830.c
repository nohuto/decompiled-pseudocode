/*
 * XREFs of sub_180096830 @ 0x180096830
 * Callers:
 *     <none>
 * Callees:
 *     sub_180083A6C @ 0x180083A6C (sub_180083A6C.c)
 *     sub_18008CB38 @ 0x18008CB38 (sub_18008CB38.c)
...
__int64 __fastcall sub_180096830(_QWORD *a1, __int64 a2)
{
  ...
  if ( (a1[14] - v5) / 88 )
  {
    ...
    do
    {
      ...
      if ( v8 && *(_BYTE *)(v5 + v7 + 16) )
      {
        ...
        v26 = *(_QWORD *)(v8 + 136);
        v27 = v9;
        v10 = (_QWORD *)sub_1800A4A30(v26, v28);
  ...
  v25 = 0LL;
  result = (__int64)sub_180095AEC((__int64)a1, &v25, 0LL);
  if ( (_QWORD)v25 )
  {
    v30 = 0LL;
    v13 = a1[8];
    ...
    v14 = v30;
LABEL_19:
    v15 = sub_18008CB38(v25, 9u);
    v16 = sub_18008CB38(v25, 8u);
    sub_180083A6C(v14);
    v17 = *(_QWORD *)(v14 + 448);
    if ( v16 )
      v18 = v17 | 0x100;
