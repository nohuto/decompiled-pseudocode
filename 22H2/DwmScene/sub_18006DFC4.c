/*
 * XREFs of sub_18006DFC4 @ 0x18006DFC4
 * Callers:
 ...
 *     sub_1800648D8 @ 0x1800648D8 (sub_1800648D8.c)
 *     sub_180064B64 @ 0x180064B64 (sub_180064B64.c)
 *     memcmp @ 0x18011E0BE (memcmp.c)
 */

_QWORD *__fastcall sub_18006DFC4(__int64 **a1, _QWORD *a2, __int64 *a3, size_t *a4, _QWORD *a5)
{
  _QWORD *v9; // r12
  __int64 *v10; // rax
  const void *v11; // rdx
  ...
  if ( a1[1] )
  {
    if ( a3 == (__int64 *)*v10 )
    {
      ...
      if ( v16 < 0 )
      {
        sub_1800648D8(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
      goto LABEL_90;
    }
    if ( a3 == v10 )
    {
      ...
      if ( v24 < 0 )
      {
        sub_1800648D8(a1, a2, 0, v49, (int)a4, a5);
        return a2;
      }
      goto LABEL_91;
    }
    ...
    if ( v31 < 0 )
    {
      ...
      {
        if ( *(_BYTE *)(v32[2] + 25) )
          sub_1800648D8(a1, a2, 0, v32, (int)a4, a5);
        else
          sub_1800648D8(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
...
LABEL_90:
        v9 = a5;
LABEL_91:
        *a2 = *(_QWORD *)sub_180064B64(a1, (__int64)&v53, 0, a4, v9);
        return a2;
      }
    }
    if ( v48 )
      sub_1800648D8(a1, a2, 0, a3, (int)a4, a5);
    else
      sub_1800648D8(a1, a2, 1, (_QWORD *)v40, (int)a4, a5);
    return a2;
  }
  else
  {
    try
    {
      sub_1800648D8(a1, a2, 1, v10, (int)a4, a5);
      result = a2;
    }
    catch ( ... )
    {
      sub_180067AAC((__int64)v53, (__int64)v52);
      throw;
    }
  }
  return result;
