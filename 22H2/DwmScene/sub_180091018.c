/*
 * XREFs of sub_180091018 @ 0x180091018
 * Callers:
...
__int64 __fastcall sub_180091018(__int64 *a1, __int64 a2, unsigned int a3, int a4, int a5, int a6, _QWORD *a7)
{
  __int64 v11; // rbx
  ...
  v13 = sub_180030CCC(5, a4);
  return sub_1800CD334(v11, a2, a3, v13, a6, 5);
}
