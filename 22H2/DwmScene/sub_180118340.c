/*
 * XREFs of sub_180118340 @ 0x180118340
 * Callers:
 ...
 *     sub_18011CBE4 @ 0x18011CBE4 (sub_18011CBE4.c)
 *     sub_18011CCD8 @ 0x18011CCD8 (sub_18011CCD8.c)
 *     ?IsContext@WorkItem@details@Concurrency@@QEBA_NXZ @ 0x18011CD58 (-IsContext@WorkItem@details@Concurrency@@QEBA_NXZ.c)
...
__int64 __fastcall sub_180118340(__int64 a1, _QWORD *a2, _DWORD *a3)
{
...
LABEL_27:
  ...
  if ( (unsigned __int8)sub_18011CCD8(v9 + 64, v10) )
  {
    ...
    v13 = (Concurrency::details::WorkItem *)sub_18011CB80(v9 + 64, v19);
    if ( (unsigned __int8)sub_18011CD60(v13) )
    {
      ...
      if ( (unsigned __int8)sub_18011CCD8(v13, v14)
        && (v20[2] = 0LL,
            ...
            v15 = (Concurrency::details::WorkItem *)sub_18011CB80(v13, v20),
            Concurrency::details::WorkItem::IsContext(v15)) )
      {
        *a3 = sub_18011CBE4(v15);
        v11 = 0;
      }
      else
      {
