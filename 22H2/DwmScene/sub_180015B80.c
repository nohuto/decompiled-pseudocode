/*
 * XREFs of sub_180015B80 @ 0x180015B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180015B80(__int64 a1, __int64 a2)
{
  __int64 v3; // r14
  _QWORD *v4; // rsi
  __int64 v5; // r8
  ...
  volatile signed __int32 *v47; // [rsp+F8h] [rbp-8h]
  ...
  *((_QWORD *)&v32 + 1) = v14;
  ...
  if ( (_QWORD)v49 != (_QWORD)v32 )
  {
    ...
    {
      sub_180075328(*(_QWORD *)(v3 + 56), &v43);
      ...
      v50 = 0LL;
      v18 = v34;
      sub_1800615B4(v34 + 16, &v50);
      v45[2] = 0LL;
      v45[3] = 0LL;
      sub_18001269C(v45, (__int64)&unk_180208688);
      v19 = (__int64 *)sub_180087A00(v18, v46, v45);
    ...
    if ( (_QWORD)v48 == (_QWORD)v34 )
    {
      ...
      *(_QWORD *)&v40 = *v4;
      *((_QWORD *)&v40 + 1) = v26;
      sub_180088C04(v48, &v40, &v42);
    }
    else
    {
      v52 = 0LL;
      sub_1800615B4(v34 + 16, &v52);
      v51 = 0LL;
      v41 = 0LL;
      if ( *((_QWORD *)&v32 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v32 + 1) + 8LL));
      v41 = v32;
      sub_18007EF38(*v4, &v51, 131075LL, &v41);
      v39 = 0LL;
      v24 = v4[1];
      if ( v24 )
      {
      ...
      *(_QWORD *)&v39 = *v4;
      *((_QWORD *)&v39 + 1) = v24;
      sub_18008866C(v48, &v39);
      std::shared_ptr<__ExceptionPtr>::operator=(v4, &v51);
