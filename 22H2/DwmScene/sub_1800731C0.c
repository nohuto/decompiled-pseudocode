...
__int64 __fastcall sub_1800731C0(__int64 a1)
{
  ...
  v3 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v2 + 64LL))(v2, &unk_180208BC8, 0LL);
  v4 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v2 + 64LL))(v2, &unk_180208BE8, 0LL);
  if ( v3 && v4 )
    sub_1800759EC(a1);
