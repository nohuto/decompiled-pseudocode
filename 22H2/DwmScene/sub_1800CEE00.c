/*
 * XREFs of sub_1800CEE00 @ 0x1800CEE00
 * Callers:
...
__int64 __fastcall sub_1800CEE00(__int64 *a1, __int64 a2, size_t *a3)
{
  __int64 *v6; // rax
  __int64 *v7; // rbx
  const void *v8; // rdx
...
LABEL_14:
    v14 = *a1;
    v17[0] = (__int64)a3;
    v15 = sub_1800CDED4((__int64)a1, v14, (__int64)&unk_1801D3148, v17);
    sub_1800CE62C((__int64 **)a1, v17, v7, v15 + 4, v15);
    *(_QWORD *)a2 = v17[0];
    *(_BYTE *)(a2 + 8) = 1;
    return a2;
  }
