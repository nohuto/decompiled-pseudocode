/*
 * XREFs of sub_1800EEAD4 @ 0x1800EEAD4
 * Callers:
...
__int64 __fastcall sub_1800EEAD4(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  void **v5; // rsi
  _QWORD *v6; // rax
  ...
  *(_QWORD *)(a1 + 128) = 0LL;
  *(_QWORD *)(a1 + 136) = 0LL;
  *(_DWORD *)(a1 + 144) = sub_1800625C8(*a2);
  *(_BYTE *)(a1 + 148) = *(_BYTE *)(*a2 + 1242);
  ...
  if ( (const void **)(a1 + 32) != v7 )
  {
    ...
    {
      sub_18001CD3C((__int64 *)(a1 + 32), v9 >> 2);
      v10 = (char *)*v5;
    }
    memmove(v10, v8, v9);
    *(_QWORD *)(a1 + 40) = &v10[v9];
  ...
  if ( (__int64 *)(a1 + 56) != v11 )
    sub_1800EE680((__int64 *)(a1 + 56), *v11, *(_QWORD *)(*a2 + 112));
  return a1;
}
