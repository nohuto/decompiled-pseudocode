/*
 * XREFs of sub_1800B38C0 @ 0x1800B38C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800B38C0(__int64 a1)
{
  __int64 *v1; // rsi
  _QWORD *v3; // rax
  ...
  if ( !*(_QWORD *)(a1 + 512) )
  {
    v3 = (_QWORD *)sub_1800EB244(a1);
    sub_180017634(v3, &v7, 1u);
    ...
    v10[3] = 15LL;
    LOBYTE(v10[0]) = 0;
    sub_18000FB34(v10, 0x13uLL, 0LL, "Light Probe Sampler");
    sub_1800628C4(*v1, v10);
    v11[1] = 0;
    v11[2] = 0;
    v11[3] = 0;
    v11[4] = 0;
    ...
    v11[0] = 3;
    v11[5] = 8;
    sub_18009B760(v5, v11, 0LL);
  }
  v9 = xmmword_18020DC60;
  return sub_1800B3A70(a1, &v9);
}
