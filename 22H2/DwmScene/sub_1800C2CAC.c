...
char __fastcall sub_1800C2CAC(_BYTE *a1, __int64 *a2, char a3)
{
  ...
  LOBYTE(v7) = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_180209048, 0LL);
  if ( !(_BYTE)v7 )
    return v7;
  v8 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180209028);
  LOBYTE(v9) = 1;
  (*(void (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v6 + 64LL))(v6, &unk_180209068, v9);
  v11 = v10;
  v12 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180209088);
  v13 = LODWORD(v12);
  v14 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_1802090A8);
  v15 = LODWORD(v14);
  v16 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_1802090C8);
  v17 = LODWORD(v16);
  v18 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_1802090E8);
  v19 = LODWORD(v18);
  v20 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180209108);
  v21 = LODWORD(v20);
  v22 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180209128);
  v23 = LODWORD(v22);
  (*(void (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180209148);
  v36 = 0LL;
  ...
  *(_DWORD *)(v24 + 152) = v53[2];
  v27 = _InterlockedIncrement64(&qword_180208640);
  v28 = v36;
  *(_QWORD *)(v36 + 208) = v27;
  v29 = *(_QWORD *)(v28 + 216);
  if ( v27 >= v29 )
...
LABEL_24:
      ...
      *(_QWORD *)(v28 + 172) = v39;
      *(_DWORD *)(v28 + 180) = v40;
      v32 = _InterlockedExchangeAdd64(&qword_180208640, 1uLL);
      v33 = v36;
