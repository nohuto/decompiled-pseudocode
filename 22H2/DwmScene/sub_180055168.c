...
{
  if ( dword_1802191E8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_1802191E8);
    if ( dword_1802191E8 == -1 )
    {
      ...
      Init_thread_footer(&dword_1802191E8);
    }
  }
