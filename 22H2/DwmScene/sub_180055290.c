...
int *sub_180055290()
{
  if ( dword_1802191D4 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_1802191D4);
    if ( dword_1802191D4 == -1 )
    {
      dword_1802082E0 = 1836409916;
      word_1802082E4 = 31085;
      byte_1802082E6 = 62;
      atexit(sub_18012B9F0);
      Init_thread_footer(&dword_1802191D4);
    }
  }
