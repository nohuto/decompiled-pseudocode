 ...
 *     sub_18006AAA4 @ 0x18006AAA4 (sub_18006AAA4.c)
...
void __fastcall sub_180079CB0(__int64 a1, unsigned __int64 *a2)
{
...
LABEL_3:
  if ( v5 )
  {
    ...
    sub_18007064C((__int64 **)(a1 + 1440), (__int64)&v37, &v48);
    *(_QWORD *)(v37 + 40) = v50;
    sub_18007059C((__int64 **)(a1 + 1424), (__int64)&v38, &v48);
    v6 = v38;
    v7 = (char *)(v38 + 64);
    v30 = 0LL;
    v31 = 0LL;
    sub_18001269C(v29, v38 + 64);
    v8 = v30;
    unknown_libname_101(v29);
    if ( !v8 )
    {
      ...
      if ( (_QWORD)v47 )
      {
        v15 = sub_18006AB0C(v47, v45);
        v16 = sub_18006AAD4(v14, v44);
        v17 = sub_18006AAA4(v14, v43);
        ...
        v18[3] = 7LL;
        *(_WORD *)v18 = 0;
        v19 = (_QWORD *)sub_18001DEEC((__int64)v42, &v34, (__int64)v16);
        ...
        v20[3] = 7LL;
        *(_WORD *)v20 = 0;
        v21 = sub_18001DEEC((__int64)v41, &v32, (__int64)v15);
        if ( v7 != (char *)v21 )
        {
          v22 = (const void *)v21;
        ...
        unknown_libname_101(v41);
        unknown_libname_101((__int64 *)&v32);
        unknown_libname_101(v42);
        unknown_libname_101((__int64 *)&v34);
        unknown_libname_101(v43);
        unknown_libname_101(v44);
        unknown_libname_101(v45);
      }
      if ( *((_QWORD *)&v47 + 1) )
      {
