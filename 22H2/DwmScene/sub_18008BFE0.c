/*
 * XREFs of sub_18008BFE0 @ 0x18008BFE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18008BFE0(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v5; // rdx
  __int64 v6; // r9
  ...
  *((_QWORD *)&v16 + 1) = v7;
  ...
  if ( *(_WORD *)(a1 + 24) != 511 )
  {
    ...
    if ( (_QWORD)v17 )
    {
      ...
      *(_QWORD *)&v14 = v6;
      *((_QWORD *)&v14 + 1) = v7;
      ((void (__fastcall *)(_QWORD, __int128 *, _QWORD, __int64))sub_18008CB54)(
        v17,
        &v14,
