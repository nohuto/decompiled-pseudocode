/*
 * XREFs of sub_180035060 @ 0x180035060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180035060(__int64 a1, __int64 *a2, unsigned int a3, __int128 *a4, unsigned __int8 a5)
{
  __int64 v8; // r15
  __int64 v9; // r14
  __int64 v10; // rdi
  ...
  {
    v22 = 0LL;
    sub_1800339E0((__int64 *)(v11 + 128), &v22, *(_DWORD *)(a1 + 88));
    v12 = v22;
    v8 = *(_QWORD *)sub_18003E15C(v22, &v19);
    v13 = v19;
    if ( v19 )
    {
      v19 = 0LL;
    ...
    v10 = *(_QWORD *)sub_18003DE80(v12, &v21);
    v15 = v21;
    if ( v21 )
    {
      v21 = 0LL;
  ...
  (*(void (__fastcall **)(_QWORD, __int64, __int128 *, _QWORD))(**(_QWORD **)(a1 + 144) + 280LL))(
    *(_QWORD *)(a1 + 144),
    ...
    a3);
  v17 = sub_1800CBBF8();
  return sub_1800CBBE0(v17, 4LL, 1LL, 1LL);
}
