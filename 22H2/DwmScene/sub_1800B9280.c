/*
 * XREFs of sub_1800B9280 @ 0x1800B9280
 * Callers:
...
__int64 __fastcall sub_1800B9280(__int64 a1, __int64 a2, _QWORD *a3, _QWORD *a4)
{
  __int64 v6; // r14
  char v7; // r12
  char v8; // r15
  ...
  v6 = sub_1800752B4(a1, *(_DWORD *)(*(_QWORD *)a2 + 112LL));
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a3 + 96LL))(*a3, 7LL) )
    v7 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_18020A028, 0LL);
  else
    v7 = 0;
  v8 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_18020A068, 0LL);
  if ( v8 && (*(unsigned int (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_180208FC8, 0LL) )
    v8 = 0;
  v23 = 0LL;
  ...
  *((_QWORD *)&v23 + 1) = v10;
  v22 = 0LL;
  sub_1800B5FEC(v23, &v22);
  if ( v8 )
  {
    v12 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_18020A0A8, 0LL);
    v13 = v12;
    v14 = 2;
    ...
    if ( v15 )
    {
      v17 = *((_QWORD *)&v22 + 1);
LABEL_31:
      *(float *)(v15 + 280) = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020A088);
      goto LABEL_33;
    }
LABEL_24:
    v18 = (__int64 *)sub_1800B7A60((__int64)v26);
...
LABEL_33:
  if ( v15 )
    *(_BYTE *)(v15 + 136) = v8;
  LOBYTE(v11) = v7;
  result = sub_1800D86A8(v23, a4, v11);
  if ( v17 )
  {
