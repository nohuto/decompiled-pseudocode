/*
 * XREFs of sub_18010FFA0 @ 0x18010FFA0
 * Callers:
...
__int64 __fastcall sub_18010FFA0(
        _QWORD *a1,
        unsigned int a2,
        __int64 *a3,
        unsigned int a4,
        ...
        _QWORD *a9)
{
  ...
  v46 = a8;
  v44 = a9;
  if ( !(unsigned __int8)sub_1801118F8(a2, "ComputeNormals") )
  {
    v39 = 0LL;
    v46 = a8;
    v13 = *(_QWORD *)(a7 + 56);
  ...
  *(_OWORD *)v49 = 0LL;
  ...
  try
  {
    ...
    if ( a5 )
    {
      if ( !*a3 )
      {
        sub_180111860((unsigned int)v11, a6);
        sub_18010FB74((int)v45, v11, a6, v44, (__int64)v49[0]);
        goto LABEL_74;
      }
      sub_1801117C8(a4, a6);
      sub_18010F17C((int)v45, v11, *a3, a4, a6, v44, (__int64)v49[0]);
    }
    else
    {
      sub_1801117C8(a4, a6);
      sub_18010F008((int)v45, v11, *a3, a4, a6, v44, (__int64)v49[0]);
    }
    v18 = v11;
  }
  ...
  catch ( const Spectre::Framework::GeometryProcessingException *v42 )
  {
    ...
    if ( *((_QWORD *)v42 + 6) >= 0x10uLL )
      v31 = *(const char **)v31;
    sub_1801163DC(&unk_18020DAB0, 3LL, v31);
    v40 = 0LL;
    v45 = v46;
    v32 = *(_QWORD *)(a7 + 56);
    if ( !v32 )
  ...
  {
    sub_1801163DC(&unk_18020DAB0, 3LL, "ComputeNormals threw unexpected exception");
    v41 = 0LL;
    v44 = v46;
    v34 = *(_QWORD *)(a7 + 56);
    if ( !v34 )
