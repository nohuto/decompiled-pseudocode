/*
 * XREFs of sub_1801104AC @ 0x1801104AC
 * Callers:
...
__int64 __fastcall sub_1801104AC(
        _QWORD *a1,
        __int64 *a2,
        __int64 *a3,
        unsigned int a4,
        ...
        _QWORD *a12)
{
  ...
  *(_QWORD *)&v42 = a5;
  ...
  v57 = a11;
  v55 = a11;
  if ( !(unsigned __int8)sub_1801118F8(a4, "ComputeTangents") )
  {
    v44 = 0LL;
    v55 = a11;
    v15 = *(_QWORD *)(a10 + 56);
...
LABEL_65:
  ...
  *(_OWORD *)v59 = 0LL;
  ...
  sub_18010FADC(v59, v20);
  if ( !v59[0] )
    goto LABEL_65;
  memset(v59[0], 0, 16 * v12);
  v60 = 0LL;
  v61 = 0LL;
  sub_1800F5A84(&v60, (unsigned int)(2 * v12));
  try
  {
    *(_QWORD *)&v44 = v60;
    *(_QWORD *)&v43 = v60 + 12 * v12;
    ...
    if ( a7 )
    {
      if ( *(_QWORD *)v42 )
      {
        sub_1801117C8(a6, a8);
        v14 = v42;
        sub_18010F494(v21, v12, *(_QWORD *)v42, a6, v54, a8, a12, v44, v43);
      }
      else
      {
        sub_180111860((unsigned int)v12, a8);
        sub_18010FC54(v21, v12, v22, a8, a12, v44, v43);
        v14 = v42;
      }
    }
    else
    {
      sub_1801117C8(a6, a8);
      v14 = v42;
      sub_18010F2F0(v21, v12, *(_QWORD *)v42, a6, v54, a8, a12, v44, v43);
    }
  }
  ...
  {
    sub_1801163DC(&unk_18020DAB0, 3LL, "ComputeTangents threw exception");
    v42 = 0LL;
    v54 = v55;
    v40 = *(_QWORD *)(a10 + 56);
    if ( !v40 )
...
LABEL_41:
  ...
  sub_180111670(v59[0], v12, v56, v44, v43, a9);
  v23 = *(_QWORD *)(a10 + 56);
  if ( !v23 )
  {
    std::_Xbad_function_call();
    JUMPOUT(0x180110BC6LL);
  }
