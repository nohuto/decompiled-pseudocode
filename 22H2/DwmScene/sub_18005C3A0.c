...
int *sub_18005C3A0()
{
  if ( dword_1802195F0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_1802195F0);
    if ( dword_1802195F0 == -1 )
    {
      dword_1802083C0 = 1836409916;
      word_1802083C4 = 31085;
      byte_1802083C6 = 62;
      atexit(sub_18012BA10);
      Init_thread_footer(&dword_1802195F0);
    }
  }
