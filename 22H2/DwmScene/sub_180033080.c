/*
 * XREFs of sub_180033080 @ 0x180033080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180033080(__int64 a1, __int64 *a2, __int64 a3)
{
  unsigned int v5; // eax
  __int64 v6; // rcx
  __int64 v7; // rax
  ...
  v6 = *a2;
  v18 = v5;
  sub_18003264C((__int64 **)(v6 + 120), (__int64)&v16, &v18);
  v7 = v16;
  v8 = *(_QWORD *)(v16 + 48);
  if ( v8 )
  {
  ...
  v15[0] = *(_QWORD *)(v7 + 40);
  v15[1] = v8;
  sub_1800186E0(&v14, v15);
  v17 = 0LL;
  sub_18002D46C(v14, &v17);
