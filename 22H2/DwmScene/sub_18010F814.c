/*
 * XREFs of sub_18010F814 @ 0x18010F814
 * Callers:
...
__int64 __fastcall sub_18010F814(
        int a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  if ( a4 != (_DWORD)result )
  {
    do
    {
      ...
      {
        sub_18000FD48(v26);
        sub_18010FB50(pExceptionObject, v26);
      ...
      if ( a6 != 1 || (v18 & 1) == 0 )
        v16 = 0;
      sub_18011137C(v12, v13, v20, v21, v22, v16, a9, a10);
      result = sub_18010FEB8(a1, v20, v21, v22, v16, a8);
