/*
 * XREFs of sub_1801140B0 @ 0x1801140B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1801140B0(__int64 a1, __int64 *a2, __int64 a3)
{
  void *v3; // rbx
  ...
  sub_1801147FC(v3);
  if ( (unsigned int)dword_18020DB10 > 5
    && (qword_18020DB20 & 0x400000000000LL) != 0
    && (qword_18020DB28 & 0x400000000000LL) == qword_18020DB28 )
  {
