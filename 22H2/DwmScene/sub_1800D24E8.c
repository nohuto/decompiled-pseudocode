/*
 * XREFs of sub_1800D24E8 @ 0x1800D24E8
 * Callers:
...
__int64 __fastcall sub_1800D24E8(__int64 a1, __int64 a2)
{
  __int64 i; // rbx
  __int128 v5; // xmm0
  __int64 v6; // rsi
    ...
    for ( i = a1 + 48; i != a2; i += 48LL )
    {
      ...
      *(_BYTE *)i = 0;
      ...
      if ( v12 || v13 )
      {
        ...
        if ( (__int128 *)v6 != &v24 )
        {
          sub_18001D08C((_QWORD *)v6, (__int64)&v24);
          v9 = v27;
          v8 = v26;
        }
        *(double *)(v6 + 32) = v8;
      ...
      else
      {
        ...
        if ( (__int128 *)a1 != &v24 )
        {
          sub_18001D08C((_QWORD *)a1, (__int64)&v24);
          v9 = v27;
          v8 = v26;
        }
        *(double *)(a1 + 32) = v8;
