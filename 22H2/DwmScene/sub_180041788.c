/*
 * XREFs of sub_180041788 @ 0x180041788
 * Callers:
...
__int64 __fastcall sub_180041788(__int64 a1, __int64 **a2)
{
  __int64 *v4; // r14
  __int64 *v5; // rbx
  ...
  while ( v5 != v4 )
  {
    ...
    *(_QWORD *)&v17 = v7;
    ...
    HIDWORD(v17) = dword_18013E090[6 * *((unsigned __int8 *)v5 + 40) - 6 + *((int *)v5 + 9)];
    v18 = *((unsigned int *)v5 + 11);
    v8 = *((_QWORD *)&v20 + 1);
    if ( v21 == *((_QWORD *)&v20 + 1) )
    {
      sub_180040E38((const void **)&v20, *((_BYTE **)&v20 + 1), &v17);
    }
    else
    {
      **((_OWORD **)&v20 + 1) = v17;
    ...
    v9 = sub_18002C274((const void **)&v17, v5, " ");
    v10 = v9;
  ...
  *(_QWORD *)(a1 + 40) = 0LL;
  *(_QWORD *)(a1 + 48) = 0LL;
  sub_18001CDF8((_QWORD *)(a1 + 24), (__int64)Src);
