...
_QWORD *__fastcall sub_1800CF05C(_QWORD *a1, unsigned int a2)
{
  ...
  v16 = HIDWORD(a1);
  v15 = a2;
  if ( dword_18021A358 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021A358);
    if ( dword_18021A358 == -1 )
    {
      ...
      *v12 = v12;
      ...
      v12[2] = v12;
      *((_WORD *)v12 + 12) = 257;
      qword_18021A348 = (__int64)v12;
      atexit(sub_180131250);
      Init_thread_footer(&dword_18021A358);
    }
  }
  ...
  *((_QWORD *)v8 + 2) = v7;
  *((_WORD *)v8 + 12) = 0;
  sub_1800CEC50(&qword_18021A348, (__int64)&v13, 0, v8 + 8, v8);
  v9 = v13;
  *a1 = 0LL;
  a1[1] = 0LL;
  v10 = *(_QWORD *)(v9 + 48);
