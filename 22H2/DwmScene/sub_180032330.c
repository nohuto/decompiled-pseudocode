/*
 * XREFs of sub_180032330 @ 0x180032330
 * Callers:
...
_QWORD *__fastcall sub_180032330(_QWORD *a1, _QWORD *a2, __int64 *a3, unsigned int *a4, _QWORD *a5)
{
  __int64 **v9; // rdi
  _QWORD *result; // rax
  __int64 *v11; // r9
  ...
  if ( a1[1] )
  {
    ...
    {
LABEL_30:
      *a2 = *(_QWORD *)sub_180032518((_DWORD)a1, (unsigned int)&v21, 0, (_DWORD)a4, (__int64)a5);
      return a2;
    }
    if ( v15 )
      sub_1800320A4(a1, a2, 0, a3, (int)a4, a5);
    else
      sub_1800320A4(a1, a2, 1, v14, (int)a4, a5);
    return a2;
  }
  else
  {
