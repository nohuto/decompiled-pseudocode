/*
 * XREFs of sub_180064480 @ 0x180064480
 * Callers:
...
__int64 __fastcall sub_180064480(_QWORD *a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r13
  __int64 v6; // rbx
  ...
  v12 = sub_180067C58(a1, v11);
  v27 = 152 * v6;
  v13 = 152 * v6 + v12;
  v14 = v13 + 152;
  sub_1800653B8(v13, a3);
  v15 = a1[1];
  v25 = v15;
  v16 = *a1;
  v24 = a1;
  ...
  else
  {
    ...
    while ( v4 != v19 )
    {
      sub_1800653B8(v14, v4);
      v14 += 152LL;
      v22 = v14;
      v4 += 152LL;
    }
  }
  sub_180067840(a1, v12, v26 + 1, v11, v21, v22, v24);
  return v27 + *a1;
}
