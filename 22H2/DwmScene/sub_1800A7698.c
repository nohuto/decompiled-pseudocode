/*
 * XREFs of sub_1800A7698 @ 0x1800A7698
 * Callers:
 ...
 *     sub_180129D11 @ 0x180129D11 (sub_180129D11.c)
 *     sub_180129D5B @ 0x180129D5B (sub_180129D5B.c)
 *     ?dtor$2@?0???R_lambda_8b695f9820225e821433c25f6ed27cb8_@@QEBA?AV?$task@_N@Concurrency@@_N@Z@4HA_1 @ 0x18012A293 (-dtor$2@-0---R_lambda_8b695f9820225e821433c25f6ed27cb8_@@QEBA-AV-$task@_N@Concurren_ea_18012A293.c)
 * Callees:
...
unsigned __int64 __fastcall sub_1800A7698(__int64 a1, __int64 a2)
{
  __int64 v3; // rdi
  __int64 v4; // rcx
  ...
  *(_QWORD *)a1 = &Spectre::Engine::Camera::`vftable';
  ...
  sub_1800A6544((__int64 *)(a1 + 1616), a1 + 1616);
  sub_18001FFEC((__int64 *)(a1 + 448), a1 + 448);
  sub_18006BB2C((__int64 **)(a1 + 416));
  if ( *(_BYTE *)(a1 + 388) )
    *(_BYTE *)(a1 + 388) = 0;
  v9 = *(_QWORD *)(a1 + 272);
  if ( v9 >= 0x10 )
...
LABEL_36:
  ...
  *(_BYTE *)(a1 + 184) = 0;
  ...
  sub_1800AE0CC(a1 + 104);
  return sub_18008A530((_QWORD *)a1);
}
