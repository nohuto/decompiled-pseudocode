/*
 * XREFs of sub_18009E044 @ 0x18009E044
 * Callers:
...
__int64 __fastcall sub_18009E044(__int64 *a1, __int64 a2, char a3, const void **a4)
{
  __int64 *v6; // rax
  __int64 *v7; // r13
  __int64 v8; // rbx
  ...
  if ( v9 )
  {
    if ( v7 == (__int64 *)*v6 )
    {
      *(_QWORD *)a2 = *sub_18009D000(a1, &v33, 1, v7, (__int64)a4);
      *(_BYTE *)(a2 + 8) = 1;
      return a2;
    }
    sub_180022400(&v31);
  ...
  {
    *(_QWORD *)a2 = *sub_18009D000(v33, &v32, v9, v32, (__int64)a4);
    *(_BYTE *)(a2 + 8) = 1;
  }
  return a2;
}
