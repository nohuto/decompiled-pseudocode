/*
 * XREFs of sub_180022678 @ 0x180022678
 * Callers:
 *     sub_180026960 @ 0x180026960 (sub_180026960.c)
 * Callees:
...
_QWORD *__fastcall sub_180022678(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180021774((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
