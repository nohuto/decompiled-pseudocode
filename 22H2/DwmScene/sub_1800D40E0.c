/*
 * XREFs of sub_1800D40E0 @ 0x1800D40E0
 * Callers:
 ...
 *     sub_1800D37CC @ 0x1800D37CC (sub_1800D37CC.c)
 ...
 *     snprintf @ 0x18011F920 (snprintf.c)
 *     _guard_dispatch_icall_nop @ 0x18011FBB0 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=9
_QWORD *__fastcall sub_1800D40E0(__int64 a1, __int64 a2, __int64 a3, __int64 *a4, int a5, float a6, float *a7)
{
  float v7; // xmm10_4
  __int128 v8; // xmm13
  _QWORD *v11; // rax
  ...
  *(_QWORD *)&v81 = v11;
  ...
  if ( v82[0] != v82[1] )
  {
    do
    {
      v76 = 0LL;
      v77 = 0LL;
      sub_18001CDF8(Src, (__int64)v12);
      sub_1800D3560(v84, Src);
      v15 = (__int64 *)v81;
      v16 = *(__int64 **)(v81 + 8);
      if ( *((_BYTE *)v16 + 25) )
        goto LABEL_9;
...
LABEL_9:
      ...
      if ( v15 == (__int64 *)v81 )
      {
        *(_QWORD *)&v69 = v87;
        DWORD2(v69) = 1;
        sub_1800D3294((__int64 **)&v81, (__int64)v74, (__int64)&v69);
      }
      else
      {
        sub_1800D2704((__int64 *)Buffer, *((_DWORD *)v15 + 10));
        v17 = (char *)sub_18002C274(v72, Src, "#");
        v18 = (__int64 *)sub_180093CE8((__int64)v70, v17, Buffer);
        if ( Src != v18 )
          sub_18001D08C(Src, (__int64)v18);
        if ( v71 >= 0x10 )
        {
          v19 = v70[0];
          if ( v71 + 1 >= 0x1000 )
...
LABEL_52:
  ...
  sub_1800D3004((unsigned __int64)v12, (unsigned __int64)v13, ((char *)v13 - (char *)v12) / 48, v68);
  v69 = xmmword_18020DC70;
  v7 = a6;
...
LABEL_53:
          v35 = 0LL;
        if ( sub_1800D37CC((__int64)v13, *(_QWORD *)(*(_QWORD *)(v35 + 8) + 8 * (v33 & (*(_QWORD *)(v35 + 16) - 1LL)))) )
          break;
        sub_180065AF4(
    ...
    sub_1800B3E3C(Src, v13, 0LL, v39 + (unsigned int)(int)v38);
    v69 = v8;
    v42 = Src;
    if ( v77 >= 0x10 )
      v42 = (__int64 *)Src[0];
    ...
    v43 = *((double *)v13 + 4);
    v44 = *((double *)v13 + 5);
    sub_1800D3560(v84, v13);
    v45 = (double *)sub_1800D48FC(a1, v84);
    v46 = *((_DWORD *)v45 + 41);
    if ( v46 )
    {
      *(double *)&v48 = *v45;
...
LABEL_88:
  ...
  *(_QWORD *)&v78 = 0LL;
  ...
  if ( !*((_BYTE *)v65 + 25) )
  {
    do
    {
      sub_1800270E0((__int64)&v81, (__int64)&v81, (__int64 *)v65[2]);
      v66 = v65;
      v65 = (__int64 *)*v65;
      j_j__o_free(v66);
    }
  ...
  j_j__o_free(v64);
  sub_1800CCED4((__int64 **)v82);
  return sub_1800D3738(a1);
}
