/*
 * XREFs of sub_18003CBD0 @ 0x18003CBD0
 * Callers:
 *     _expandlocale @ 0x18003BFEC (_expandlocale.c)
 * Callees:
 *     D3D11CreateDevice @ 0x18010E508 (D3D11CreateDevice.c)
...
HRESULT __fastcall sub_18003CBD0(
        ...
        ID3D11DeviceContext **a10)
{
  ...
  if ( dword_18021885C > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021885C);
    if ( dword_18021885C == -1 )
    {
      byte_180218858 = 1;
      Init_thread_footer(&dword_18021885C);
    }
    goto LABEL_4;
  }
  while ( 1 )
