/*
 * XREFs of sub_18001F59C @ 0x18001F59C
 * Callers:
...
int __fastcall sub_18001F59C(__int64 a1)
{
...
LABEL_6:
    ...
    JUMPOUT(0x18001F688LL);
  }
  v9 = _std_type_info_hash(&qword_18020FD78);
  sub_180020D3C(a1, v6, &v9);
  v7[0] = &std::_Func_impl_no_alloc<_lambda_53997277a49255653d15a2e9d753df18_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v8 = v7;
