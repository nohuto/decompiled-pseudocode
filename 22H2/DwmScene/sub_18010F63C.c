/*
 * XREFs of sub_18010F63C @ 0x18010F63C
 * Callers:
...
__int64 __fastcall sub_18010F63C(
        int a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  _QWORD v25[5]; // [rsp+78h] [rbp-A0h] BYREF
  ...
  if ( a4 != (_DWORD)result )
  {
    do
    {
      ...
      {
        sub_18000FD48(v25);
        sub_18010FB50(pExceptionObject, v25);
      ...
      if ( a6 != 1 || (v17 & 1) == 0 )
        v15 = 0;
      sub_18011137C(v12, a5, v19, v20, v21, v15, a9, a10);
      result = sub_18010FEB8(a1, v19, v20, v21, v15, a8);
