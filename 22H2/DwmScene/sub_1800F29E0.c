/*
 * XREFs of sub_1800F29E0 @ 0x1800F29E0
 * Callers:
...
__int64 __fastcall sub_1800F29E0(__int64 a1, _QWORD *a2)
{
  __int64 result; // rax
  volatile signed __int32 *v4; // rbx

  result = (__int64)std::shared_ptr<__ExceptionPtr>::operator=((_QWORD *)(a1 + 64), a2);
