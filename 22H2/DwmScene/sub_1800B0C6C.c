/*
 * XREFs of sub_1800B0C6C @ 0x1800B0C6C
 * Callers:
...
int __fastcall sub_1800B0C6C(__int64 a1)
{
...
LABEL_6:
    ...
    JUMPOUT(0x1800B0D58LL);
  }
  v9 = _std_type_info_hash(&qword_18020FAC0);
  sub_180020D3C((__int64 **)a1, (__int64)v6, (unsigned __int64 *)&v9);
  ...
  v8 = v7;
  sub_180026B88((__int64)v7, v6[0] + 40LL);
  if ( v8 )
  {
    v4 = v7;
    LOBYTE(v4) = v8 != v7;
