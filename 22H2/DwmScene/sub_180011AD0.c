/*
 * XREFs of sub_180011AD0 @ 0x180011AD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_18001D6D8 @ 0x18001D6D8 (sub_18001D6D8.c)
...
__int64 __fastcall sub_180011AD0(__int64 a1, __int64 a2)
{
  __int64 v4; // r13
  _QWORD *v5; // r15
  __int64 v6; // r8
  ...
  *((_QWORD *)&v41 + 1) = v15;
  ...
  if ( (_QWORD)v60 != (_QWORD)v41 )
  {
    ...
    else
    {
      ...
      sub_180075328(*(_QWORD *)(v4 + 56), &v52);
      ...
      v65 = 0LL;
      v21 = v43;
      sub_1800615B4(v43 + 16, &v65);
      v55 = 0LL;
      v56 = 0LL;
      sub_18001269C(v54, &qword_1802086E8);
      v22 = (__int64 *)sub_180087A00(v21, v57, v54);
    ...
    if ( (_QWORD)v59 == v21 )
    {
      ...
      *(_QWORD *)&v49 = *v5;
      *((_QWORD *)&v49 + 1) = v32;
      sub_180088C04(v59, &v49, &v51);
    }
    else
    {
      v67 = 0LL;
      sub_1800615B4(v21 + 16, &v67);
      if ( (*(_DWORD *)(a1 + 48) & 0xFFFFFFFB) != 0 && !v24 )
      {
        v61 = 0LL;
        v62 = 0LL;
        sub_180010E78(v21, (__int64)&v61);
      ...
      if ( *((_QWORD *)&v41 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v41 + 1) + 8LL));
      v50 = v41;
      sub_18007EF38(*v5, &v66, 131075LL, &v50);
      v48 = 0LL;
      v29 = v5[1];
      if ( v29 )
      {
    ...
    if ( (*(_DWORD *)(a1 + 48) & 0xFFFFFFFB) == 0 )
    {
      if ( (_QWORD)v60 )
      {
        v34 = sub_18001A238(v4);
        if ( v34 )
        {
          if ( *(_DWORD *)(a1 + 48) )
            sub_18001D6D8(v34, a1 + 72);
          else
            sub_18001D490(v34, a1 + 52);
        }
      }
      if ( (_QWORD)v41 )
      {
        v35 = sub_18001A238(v4);
        if ( v35 )
        {
          if ( *(_DWORD *)(a1 + 48) )
            sub_18001D6D8(v35, a1 + 72);
          else
            sub_18001D490(v35, a1 + 52);
        }
      }
    }
    if ( *((_QWORD *)&v43 + 1) )
