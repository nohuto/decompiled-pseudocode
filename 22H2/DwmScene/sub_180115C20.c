...
__int64 *__fastcall sub_180115C20(__int64 *a1)
{
  ...
  if ( dword_18021AB88 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021AB88);
    if ( dword_18021AB88 == -1 )
    {
      qword_18021AB80 = v5;
      Init_thread_footer(&dword_18021AB88);
    }
  }
  v6 = v5 - qword_18021AB80;
