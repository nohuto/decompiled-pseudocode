/*
 * XREFs of sub_18011AA30 @ 0x18011AA30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18011AA30(__int64 a1, __int64 *a2)
{
...
LABEL_13:
  ...
  sub_18011A308((__int64 **)(a1 + 240), (__int64)v14, &v17);
  v6 = v14[0];
  v16 = 0LL;
  v7 = (__int64 (__fastcall ***)(_QWORD, _BYTE *))a2[7];
  if ( v7 )
    v16 = (_BYTE *)(**v7)(v7, v15);
  sub_180026B88((__int64)v15, (__int64)(v6 + 5));
  if ( v16 )
  {
    v8 = v15;
    LOBYTE(v8) = v16 != v15;
