...
char __fastcall sub_1800C1DC0(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_180208768, 0LL)
  ...
  v7 = sub_1800DD558(a3);
  if ( v7 == 4 )
    sub_18011C2D4(v6, &unk_180209D68);
  if ( v7 == 5 )
    sub_18011C2D4(v6, &unk_180209E08);
  v8 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v6 + 72LL))(v6, &unk_180208FA8, 2LL);
  if ( v7 == 6 )
    (*(void (__fastcall **)(__int64, void *, _QWORD, __int64))(*(_QWORD *)v6 + 152LL))(
      ...
      1LL);
  (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020AD28);
  (*(void (__fastcall **)(__int64, void *, __int64, __int64))(*(_QWORD *)v6 + 168LL))(v6, &unk_18020AD28, v9, 1LL);
  if ( v7 == 9 )
    sub_18011C2D4(v6, &unk_180208EA8);
  if ( v7 == 11 )
    sub_18011C2D4(v6, &unk_180208F88);
  if ( v7 == 13 )
  {
    v10 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_180208FC8, 0LL);
    (*(void (__fastcall **)(__int64, void *, _QWORD, __int64))(*(_QWORD *)v6 + 152LL))(
      v6,
      &unk_180208FC8,
