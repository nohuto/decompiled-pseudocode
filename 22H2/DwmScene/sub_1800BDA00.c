...
void __fastcall sub_1800BDA00(__int64 a1, __int64 *a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v15 + 64LL))(v15, &unk_180208828, 0LL) )
  {
    *(double *)v4.m128_u64 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v15 + 88LL))(v15, &unk_1802087A8);
    v16 = v4;
    *(double *)v4.m128_u64 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v15 + 88LL))(v15, &unk_1802087C8);
    v17 = v4;
    *(double *)v4.m128_u64 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v15 + 88LL))(v15, &unk_1802087E8);
    v18 = v4;
    *(double *)v4.m128_u64 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v15 + 88LL))(v15, &unk_180208808);
  ...
  if ( v22 )
  {
    v4.m128_u64[1] = *((_QWORD *)&xmmword_18021AB60 + 1);
    *(_OWORD *)(v23 + 296) = xmmword_18021AB60;
  }
  if ( (*(_DWORD *)(v23 + 440) & 0x100) != 0 )
  {
    if ( (*(_DWORD *)(v23 + 440) & 0x2000000) != 0 )
    {
      v24 = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v15 + 88LL))(v15, &unk_18020ACA8);
      v25 = *a2;
      if ( v24 != *(float *)(*a2 + 328) )
      {
        *(float *)(v25 + 328) = v24;
