...
__int64 sub_180055318()
{
  ...
  if ( dword_1802191A8 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_1802191A8);
    if ( dword_1802191A8 == -1 )
    {
      ...
      *(_BYTE *)v3 = 0;
      ...
      v4[3] = 15LL;
      *(_BYTE *)v4 = 0;
      byte_1802191A4 = sub_1800CF3A0(&v34, &v36);
      ...
      Init_thread_footer(&dword_1802191A8);
    }
  }
  if ( dword_1802191B0 > *(_DWORD *)(v0 + 44) )
  {
    ...
    if ( dword_1802191B0 == -1 )
    {
      ...
      *(_BYTE *)v8 = 0;
      ...
      v9[3] = 15LL;
      *(_BYTE *)v9 = 0;
      byte_1802191AC = sub_1800CF3A0(&v34, &v36);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v10 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
