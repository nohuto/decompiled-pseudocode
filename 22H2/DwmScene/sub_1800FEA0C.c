...
__int64 __fastcall sub_1800FEA0C(__int64 a1, char *a2, size_t a3, size_t *a4)
{
  ...
  v27 = 0;
  v8 = &qword_18020D608;
  if ( *((_QWORD *)&xmmword_18020D618 + 1) >= 0x10uLL )
    v8 = (void **)qword_18020D608;
  v9 = a4;
  v10 = a4[3];
  if ( v10 >= 0x10 )
    v9 = (const void *)*a4;
  v11 = a4[2];
  if ( v11 == (_QWORD)xmmword_18020D618 && !memcmp(v9, v8, a4[2]) )
  {
  ...
  v13 = &qword_18020D5A8;
  if ( *((_QWORD *)&xmmword_18020D5B8 + 1) >= 0x10uLL )
    v13 = (void **)qword_18020D5A8;
  v14 = a4;
  if ( v10 >= 0x10 )
    v14 = (const void *)*a4;
  if ( v11 == (_QWORD)xmmword_18020D5B8 && !memcmp(v14, v13, v11) )
  {
  ...
  v16 = aCube;
  if ( *((_QWORD *)&xmmword_18020D5D8 + 1) >= 0x10uLL )
    v16 = (void **)aCube[0];
  v17 = a4;
  if ( v10 >= 0x10 )
    v17 = (const void *)*a4;
  if ( v11 != (_QWORD)xmmword_18020D5D8 || memcmp(v17, v16, v11) )
    v7 = 0;
  if ( v7 )
  {
  ...
  v18 = aLook;
  if ( *((_QWORD *)&xmmword_18020D5F8 + 1) >= 0x10uLL )
    v18 = (void **)aLook[0];
  if ( v10 >= 0x10 )
    a4 = (size_t *)*a4;
  if ( v11 == (_QWORD)xmmword_18020D5F8 && !memcmp(a4, v18, v11) )
