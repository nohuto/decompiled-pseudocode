...
void *sub_1800CBBF8()
{
  ...
  if ( dword_18021A330 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021A330);
    if ( dword_18021A330 == -1 )
    {
      v2 = 75LL;
      v1 = &unk_1802199E0;
      do
      ...
      while ( v2 );
      Init_thread_footer(&dword_18021A330);
    }
  }
  return &unk_1802199D0;
}
