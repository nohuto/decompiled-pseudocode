...
__int64 *sub_1801159EC()
{
  ...
  if ( dword_18021ABF8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021ABF8);
    if ( dword_18021ABF8 == -1 )
    {
      ...
      *v1 = v1;
      ...
      v1[2] = v1;
      *((_WORD *)v1 + 12) = 257;
      qword_18021ABE8 = (__int64)v1;
      atexit(sub_180133A50);
      Init_thread_footer(&dword_18021ABF8);
    }
  }
  return &qword_18021ABE8;
}
