/*
 * XREFs of UsbhQueueWorkItemWithRetry @ 0x1C000BEB0
 * Callers:
 *     UsbhSS_SignalPdoWake @ 0x1C00183BC (UsbhSS_SignalPdoWake.c)
 *     UsbhHubIsr @ 0x1C0019BF0 (UsbhHubIsr.c)
 *     UsbhIsrRetryTimer @ 0x1C0039660 (UsbhIsrRetryTimer.c)
 *     UsbhResetIrqPipeRetryTimer @ 0x1C0039D30 (UsbhResetIrqPipeRetryTimer.c)
 ...
 *     UsbhIdleIrpRetryTimer @ 0x1C00589D0 (UsbhIdleIrpRetryTimer.c)
 *     UsbhIdleIrp_NoIrp @ 0x1C0058F00 (UsbhIdleIrp_NoIrp.c)
 *     UsbhSS_WakeIrpRetryTimer @ 0x1C0059810 (UsbhSS_WakeIrpRetryTimer.c)
 * Callees:
