/*
 * XREFs of UsbhGetMsOsExtendedConfigDesc @ 0x1C0033CA0
 * Callers:
...
void *__fastcall UsbhGetMsOsExtendedConfigDesc(__int64 a1, __int64 a2)
{
  ...
  if ( (v3[358] & 0x400) == 0 )
    return 0LL;
  PoolWithTag = (unsigned int *)ExAllocatePoolWithTag(SHIDWORD(WPP_MAIN_CB.Dpc.ProcessorHistory), 0x10uLL, 0x42554855u);
  v7 = PoolWithTag;
  if ( !PoolWithTag )
    return 0LL;
