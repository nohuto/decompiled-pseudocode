/*
 * XREFs of Usbh_USB_RESET_ON_RESUME @ 0x1C0048D60
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_USB_RESET_ON_RESUME(__int64 a1, const wchar_t *a2, _BYTE *a3, int a4)
{
  _UNKNOWN **result; // rax
