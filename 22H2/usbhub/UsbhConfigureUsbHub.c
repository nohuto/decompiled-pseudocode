/*
 * XREFs of UsbhConfigureUsbHub @ 0x1C002A738
 * Callers:
...
__int64 __fastcall UsbhConfigureUsbHub(__int64 a1)
{
  ...
  {
    LOBYTE(v21) = 0;
    UsbhException(a1, 0, 34, (int)v5, v5[1], -1073741823, v22, usbfile_hub_c, 4345, v21);
...
LABEL_35:
  ...
  {
    LOBYTE(v21) = 0;
    UsbhException(a1, 0, 18, (int)v5, v5[1], -1073741823, 0, usbfile_hub_c, 4478, v21);
...
LABEL_37:
  ...
  ConfigurationRequest = UsbhCreateConfigurationRequestEx(v14, v5, v11, v10);
