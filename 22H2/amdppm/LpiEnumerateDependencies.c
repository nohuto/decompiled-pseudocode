/*
 * XREFs of LpiEnumerateDependencies @ 0x1C00361F8
 * Callers:
        ...
        if ( (_DWORD)i != (_DWORD)v25 )
        {
          ...
          if ( v17[10 * i + 8] == (_DWORD)v25 )
          {
            ...
            if ( v34 )
            {
              ...
              do
              {
                if ( *(_DWORD *)(v34 + 80 * v35 + 44) > v11 )
                {
                  if ( a11 )
                  {
                    KeOrAffinityEx(a11, 224LL * (unsigned int)(v35 + *(_DWORD *)(v36 + 4 * i)) + a5 + 48, a11);
                    LODWORD(v24) = v39;
                    v11 = a3;
                    v36 = a4;
                  }
                  if ( a10 )
                  {
                    *(_BYTE *)(a10 + 4LL * (unsigned int)v24) = v35 + *(_BYTE *)(v36 + 4 * i);
...
LABEL_23:
    ...
    v20 = *(_QWORD *)&v17[2 * v19 + 10];
    v42 = v12 + 1;
    DevExtFromIndex = GetDevExtFromIndex(*(_DWORD *)(v20 + 4 * v18));
    v23 = *(_QWORD *)(DevExtFromIndex + 528);
    if ( !v23 )
    {
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        return 3221225473LL;
