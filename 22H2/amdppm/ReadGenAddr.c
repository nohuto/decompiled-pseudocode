 ...
 *     SetPerfStateIO @ 0x1C000BE50 (SetPerfStateIO.c)
 *     C2Idle @ 0x1C000C0D0 (C2Idle.c)
 *     C3Idle @ 0x1C000C190 (C3Idle.c)
 *     C3IdleCheck @ 0x1C000C270 (C3IdleCheck.c)
 *     IoHaltC1Idle @ 0x1C000C5F0 (IoHaltC1Idle.c)
 * Callees:
