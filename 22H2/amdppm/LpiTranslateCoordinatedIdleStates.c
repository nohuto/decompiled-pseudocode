/*
 * XREFs of LpiTranslateCoordinatedIdleStates @ 0x1C0036620
 * Callers:
 ...
 *     ValidateCoordinatedLpiDependencies @ 0x1C002B710 (ValidateCoordinatedLpiDependencies.c)
...
__int64 __fastcall LpiTranslateCoordinatedIdleStates(__int64 a1, _DWORD *a2, unsigned int **a3, _QWORD *a4, _QWORD *a5)
{
  ...
  __int64 v47; // [rsp+88h] [rbp-61h] BYREF
  ...
  v6 = (_DWORD *)qword_1C00139C0;
  v7 = 0LL;
  if ( qword_1C00139C0 )
  {
    v9 = 0LL;
    if ( *(_DWORD *)qword_1C00139C0 )
    {
      while ( 1 )
      {
                  ...
                  for ( j = 0; (unsigned int)v30 < *(_DWORD *)(v29 + 16); j = v30 )
                  {
                    ...
                    *(_QWORD *)(v33 + 184) = *(_QWORD *)(v29 + 8);
                    ...
                    if ( v8 < 0 )
                      goto LABEL_42;
                    v36 = Size;
                    if ( (unsigned int)KeIsEqualAffinityEx(Size, &unk_1C0013718) )
                    {
                      *(_BYTE *)(v36 + 208) = 1;
                      v37 = 1;
                    }
