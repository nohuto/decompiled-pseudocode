/*
 * XREFs of InitAcpi1ThrottleStates @ 0x1C00318F4
 * Callers:
...
__int64 __fastcall InitAcpi1ThrottleStates(__int64 a1)
{
  ...
  if ( ((unsigned int)dword_1C00133F4 <= 1 || (*(_DWORD *)(a1 + 272) & 0x200000) != 0)
    ...
    && (unsigned __int8)(byte_1C0013C56 - 1) <= 3u
    && (unsigned __int8)byte_1C0013C56 + (unsigned int)(unsigned __int8)byte_1C0013C57 <= 0x20 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1088), 4u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1092), 4u);
    v4 = 1 << byte_1C0013C56;
    PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)(20 * (1 << byte_1C0013C56) + 4), 0x72637250u);
      ...
      **(_DWORD **)(a1 + 488) = v4;
      if ( v4 > 1 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)(v8 + v7 - 4) = (v9 << byte_1C0013C57) | 0x10;
        }
        while ( v6 < v4 );
      }
