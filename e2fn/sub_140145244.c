void __fastcall sub_140145244(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x800) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_140094FB8(Pool2, (__int64)L"net_adapter::NetAdapterTxQueue::InitChecksumOffloadExtension", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  v19[1] = 0;
  v6 = *(_QWORD *)(a1 + 360);
  v20 = L"ms_packet_checksum";
  v19[0] = 24;
  v21 = 1;
  v22 = 1;
  ((void (__fastcall *)(__int64, __int64, _DWORD *, __int64))qword_1400DF938)(qword_1400DF700, v6, v19, a1 + 648);
