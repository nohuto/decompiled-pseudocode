void __fastcall sub_140075EB0(__int64 a1, __int64 a2)
{
  char v2; // bp
  __int64 *v4; // r15
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x400) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_140074D50(Pool2, (__int64)L"net_adapter::NetAdapter::DestroyRxQueue", a1);
      if ( v7 )
        v4 = v7;
    }
  }
  ...
  if ( v8 < *(_QWORD *)(a1 + 608) && (v17 = *(_QWORD *)(a1 + 600), *(_QWORD *)(16 * v8 + v17) == a2) )
  {
    sub_14009BB54(*(_QWORD *)(v17 + 16 * v8));
    if ( v8 >= *(_QWORD *)(a1 + 608) )
      sub_140072758(100, 0x239u, v8, *(_DWORD *)(a1 + 608), 0);
    v18 = (_QWORD *)(16 * v8 + *(_QWORD *)(a1 + 600));
