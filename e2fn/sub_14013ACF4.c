__int64 __fastcall sub_14013ACF4(__int64 a1)
{
  char v1; // r14
  __int64 *v3; // r12
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x400) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_140074D50(Pool2, (__int64)L"net_adapter::NetAdapterWolPatterns::ArmWakeFromBitmapPatterns", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  if ( !*(_BYTE *)(a1 + 364) || !*(_QWORD *)(a1 + 496) )
  {
  ...
  v13 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(a1 + 520) + 88LL))(*(_QWORD *)(a1 + 520), a1 + 400);
  if ( !v13 )
  {
LABEL_58:
    v13 = 0;
  ...
  {
    v1 |= 0xCu;
    v14 = *(_QWORD *)(*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)(a1 + 56) + 16LL))(a1 + 56, v34);
    v15 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)(a1 + 56) + 24LL))(a1 + 56, v32);
    v16 = (const wchar_t *)&unk_1400D44E0;
    v17 = (const wchar_t *)&unk_1400D44E0;
    v18 = *(const wchar_t **)(*(_QWORD *)v15 + 16LL);
    if ( v18 )
      v17 = v18;
    if ( *(_QWORD *)(v14 + 16) )
    ...
    sub_1400A5E80(
      *(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL),
      ...
      v17,
      v16,
      L"m_hardwareWolPatterns->EnableWakeFromFlexibleFilters(m_flexibleFilterParameters)");
  }
  if ( (v1 & 8) != 0 )
  {
    v19 = v33;
  ...
  sub_14000F8F4(
    a1,
    (__int64)L"m_hardwareWolPatterns->EnableWakeFromFlexibleFilters(m_flexibleFilterParameters)",
    396,
    113,
    v13);
LABEL_59:
