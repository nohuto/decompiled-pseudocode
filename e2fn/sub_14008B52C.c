__int64 __fastcall sub_14008B52C(_QWORD *a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  __int64 v5; // rbx
  int v9; // ecx
  int v10; // ecx
  ...
  if ( !v17 )
  {
    v12 = sub_1400B2EBC((unsigned int)&v19, 808464434, a3, a2, (__int64)&v21, (__int64)&a5);
    if ( a1[14] )
      v13 = a1 + 9;
    else
      v13 = (_QWORD *)a1[10];
