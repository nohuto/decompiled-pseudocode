__int64 __fastcall sub_14000FA40(_QWORD *a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareReceiveScaling::DisableMultipleReceiveQueues",
             (__int64)a1);
      if ( v5 )
        v3 = v5;
    }
  ...
  else
  {
    ...
    {
      *(_DWORD *)(*(_QWORD *)(v6 + 8) + 22552LL) = (unsigned __int16)v8;
      _InterlockedOr(v20, 0);
      v9 = 0;
      goto LABEL_32;
    }
    (*(void (__fastcall **)(_QWORD, __int64))(*(_QWORD *)v6 + 8LL))(a1[59], 3LL);
    v9 = -1073741130;
  }
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    v23 = v9;
    v22 = L"m_mmioAccessor->UnsetMaskSafe(0x05818, 0xFFFF0000)";
    LOBYTE(v15) = 2;
    v21 = (__int64)v12;
  ...
  sub_14000F3C4((int)a1, (__int64)L"m_mmioAccessor->UnsetMaskSafe(0x05818, 0xFFFF0000)", 212, 54, v9);
LABEL_32:
  if ( v3 )
  {
    sub_14000BFA4(v3);
