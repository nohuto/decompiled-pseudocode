__int64 __fastcall sub_14010EF6C(_QWORD *a1, __int64 *a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 8) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_14005B310(Pool2, (__int64)L"os_resources::OsInterruptsPool::Bind", (__int64)a1);
      if ( v7 )
        v4 = v7;
    }
  }
  ...
  else
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v11 )
        v8 = v11;
      sub_1400A3320(*(_QWORD *)(a1[22] + 16LL), 2u, 4u, 0xAu, (__int64)&unk_1400D89D0, v8, v9, L"osServices");
      v2 = 3;
    }
    if ( (v2 & 2) != 0 )
    {
    ...
    sub_14000B87C((int)a1, (__int64)L"osServices", 56, 141);
    if ( v4 )
    {
      sub_14005B5AC(v4);
      ExFreePool(v4);
