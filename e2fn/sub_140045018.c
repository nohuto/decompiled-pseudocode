__int64 __fastcall sub_140045018(_QWORD *a1, __int64 *a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_1400045E8(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareCounters::Bind", (__int64)a1);
      if ( v7 )
        v4 = v7;
    }
  }
  ...
  else
  {
    ...
    sub_14000BA2C((int)a1, (__int64)L"mmioAccessor", 53, 157);
    if ( v4 )
    {
      sub_140005840(v4);
      ExFreePool(v4);
