__int64 __fastcall sub_140016F74(_QWORD *a1, unsigned int a2)
{
  char v2; // di
  __int64 *v4; // r15
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_14000BBDC(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareLatencyToleranceReporting::WriteMinimumThreshold",
             (__int64)a1);
      if ( v7 )
        v4 = v7;
    }
  ...
  if ( *(_DWORD *)(v20 + 23472) == -1 && *(_DWORD *)(*(_QWORD *)(v17 + 8) + 8LL) == -1 )
  {
...
LABEL_60:
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A5E80(
        ...
        (__int64)v36,
        (__int64)v35,
        (__int64)L"m_mmioAccessor->ReadRegisterSafe(0x05BB0, ltrValue)",
        v48);
      v2 = 12;
    }
    if ( (v2 & 8) != 0 )
    ...
    sub_1400142A4((int)a1, (__int64)L"m_mmioAccessor->ReadRegisterSafe(0x05BB0, ltrValue)", 287, 152, v16);
    goto LABEL_77;
  }
  if ( v22 == (*(_DWORD *)(v20 + 23472) & 0x3FF) )
  {
LABEL_37:
    v16 = 0;
    goto LABEL_77;
  ...
  if ( v24 && !*v25 )
  {
    *(_DWORD *)(v24 + 23472) = v22 | (((v18 > 0x3FF) + 34) << 10);
  ...
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    v48 = v16;
    v47 = L"m_mmioAccessor->WriteRegisterSafe(0x05BB0, ltrValue)";
    LOBYTE(v30) = 2;
    v46 = (__int64)v27;
  ...
  sub_14000D660((int)a1, (__int64)L"m_mmioAccessor->WriteRegisterSafe(0x05BB0, ltrValue)", 292, 152, v16);
LABEL_77:
  if ( v4 )
  {
    sub_14000BFA4(v4);
