__int64 *__fastcall sub_1400EFD90(__int64 a1, __int64 *a2, unsigned int a3)
{
  char v3; // di
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v9 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareAbstraction::GetTxQueue", a1 - 352);
      if ( v9 )
        v6 = v9;
    }
  }
  ...
  if ( v4 < *(_QWORD *)(a1 + 240) )
  {
    sub_1400A52C8(a2, (_QWORD *)(*(_QWORD *)(a1 + 232) + 16 * v4));
  }
  else
  {
