__int64 __fastcall sub_140072D88(__int64 a1, __int64 a2, __int64 (__fastcall ***a3)(PVOID P))
{
  _WORD *v5; // rdi
  ...
  __int16 v20; // dx
  __int64 (__fastcall **v22)(PVOID); // [rsp+20h] [rbp-30h] BYREF
  __int16 v23; // [rsp+28h] [rbp-28h]
  _WORD *v24; // [rsp+30h] [rbp-20h]
  ...
  *(_QWORD *)(a1 + 32) = 0LL;
  if ( a2 )
    sub_1400011A8((_QWORD *)a1, a2, 0x28uLL);
  v22 = &off_1400D41D0;
  v23 = 0;
  v5 = 0LL;
  v24 = 0LL;
  ...
  if ( &v22 != a3 )
  {
    sub_1400011A8(&v22, (__int64)a3[2], (unsigned __int64)a3[3]);
    v6 = v25;
    v5 = v24;
  }
  v7 = *(_QWORD *)(a1 + 16);
