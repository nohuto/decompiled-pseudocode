__int64 __fastcall sub_14014B864(__int64 a1)
{
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x800) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_140094FB8(Pool2, (__int64)L"net_adapter::NetAdapterSegmentationOffload::Initialize", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  *v6 = v9;
  ...
  if ( !*(_QWORD *)(a1 + 384) )
  {
    ...
    sub_14000B1BC(a1, (__int64)L"m_callbacksLock", 76, 111);
