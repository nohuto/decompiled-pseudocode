__int64 __fastcall sub_140058B4C(__int64 a1)
{
  char v1; // si
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(
             Pool2,
             (__int64)L"e1000_hardware::E1000HardwareReceiveControlRegister::E1000DiscardUnicastPromiscuous",
             a1);
      if ( v5 )
        v3 = v5;
    }
  ...
  if ( v14 )
  {
    ...
    sub_1400112A0(a1, (__int64)L"ClearMaskSafe((1 << 3))", 84, 121, v14);
  }
  else
  {
    v14 = 0;
