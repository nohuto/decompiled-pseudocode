__int64 __fastcall sub_140020AA0(_QWORD *a1, _QWORD *a2, __int64 *a3)
{
  char v6; // di
  __int64 *v7; // rsi
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v9 = sub_14000BBDC(Pool2, (__int64)L"e1000_hardware::E1000HardwareTransmitGate::Bind", (__int64)a1);
      if ( v9 )
        v7 = v9;
    }
  }
  ...
  *a2 = 0LL;
  ...
  if ( v10 )
  {
    ...
    sub_14000999C((int)a1, (__int64)L"HardwareTrafficGate::Bind(kstd::move(osServices))", 56, 125, v10);
    if ( v7 )
    {
      sub_14000BFA4(v7);
      ExFreePool(v7);
  ...
  else
  {
    ...
    sub_14000BA2C((int)a1, (__int64)L"mmioAccessor", 58, 125);
    if ( v7 )
    {
      sub_14000BFA4(v7);
      ExFreePool(v7);
