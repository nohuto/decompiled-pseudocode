__int64 __fastcall sub_14008D51C(__int64 a1)
{
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x400) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v6 = sub_140074D50(
             Pool2,
             (__int64)L"net_adapter::NetAdapterHardwareConfigurationFactory::GetLatencyToleranceReportingFromRegistry",
             a1);
      if ( v6 )
        v4 = v6;
    }
  ...
  v32 = 0LL;
  v33 = 0LL;
  sub_1400011A8(&v29, (__int64)L"LatencyToleranceReporting", 0x19uLL);
