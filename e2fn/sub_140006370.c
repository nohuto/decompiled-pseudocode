void __fastcall sub_140006370(_QWORD *a1, __int64 a2, int a3)
{
  ...
  PVOID v29[2]; // [rsp+20h] [rbp-89h] BYREF
  PVOID v30; // [rsp+30h] [rbp-79h]
  __int64 v31; // [rsp+38h] [rbp-71h]
  __int64 v32; // [rsp+48h] [rbp-61h] BYREF
  volatile signed __int32 *v33; // [rsp+50h] [rbp-59h]
  __int64 v34; // [rsp+58h] [rbp-51h] BYREF
  volatile signed __int32 *v35; // [rsp+60h] [rbp-49h]
  __int64 (__fastcall **v36)(PVOID); // [rsp+68h] [rbp-41h] BYREF
  __int16 v37; // [rsp+70h] [rbp-39h]
  PVOID v38; // [rsp+78h] [rbp-31h]
  __int64 v39; // [rsp+80h] [rbp-29h]
  __int64 v40; // [rsp+88h] [rbp-21h]
  __int64 v41; // [rsp+90h] [rbp-19h]
  __int64 (__fastcall **v42)(PVOID); // [rsp+98h] [rbp-11h] BYREF
  PVOID P; // [rsp+A8h] [rbp-1h]
  __int64 v44; // [rsp+B0h] [rbp+7h]
  char v45[64]; // [rsp+C0h] [rbp+17h] BYREF
  __int64 v47; // [rsp+128h] [rbp+7Fh]
  ...
  if ( !a3 )
  {
    ...
    if ( v14 != v15 )
    {
      while ( 1 )
      {
        ...
        v16 = v34;
        sub_140003EC0((__int64)v29, (__int64)qword_1400B7400, (__int64 (__fastcall ***)(PVOID))(v34 + 24));
        v17 = *(_QWORD *)(v16 + 48);
        if ( v17 < v3 )
        {
          v18 = v3 - v17;
...
LABEL_35:
        ...
        v25 = sub_1400A27D4(v45, v16 + 8);
        sub_140007CA0(&v42, v25);
        v26 = &unk_1400D44E0;
        if ( P )
          v26 = P;
        ...
        if ( v8 )
          v27 = v8;
        (*(void (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)a2 + 8LL))(a2, v27, v47);
        if ( v23 )
          ExFreePool(v23);
        if ( v35 )
        {
