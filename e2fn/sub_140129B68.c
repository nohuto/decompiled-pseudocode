__int64 __fastcall sub_140129B68(__int64 a1)
{
  char v1; // si
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400736C0(Pool2, (__int64)L"framework::DeviceD0ExitFlows::D0ExitToS4", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  if ( v14 )
  {
    ...
    sub_140008390(a1, (__int64)L"m_netAdapter->EvtD0Exit()", 220, 77, v14);
  }
  else
  {
