__int64 __fastcall sub_14009E7D4(__int64 a1, __int64 a2)
{
  _QWORD *Pool2; // rax
  __int64 *v5; // rax
  __int64 *v6; // rbx
  ...
  v11 = 0LL;
  v12 = 0LL;
  sub_1400011A8(&v8, (__int64)L"Link event viewer logger", 0x18uLL);
  ...
  *(_QWORD *)(a1 + 376) = 0LL;
  ...
  v11 = 0LL;
  v12 = 0LL;
  *(_QWORD *)(a1 + 352) = 0xA5A5A5A5A50000BEuLL;
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    Pool2 = (_QWORD *)ExAllocatePool2(64LL, 40LL, 1970304114LL);
    if ( Pool2 )
    {
      v5 = sub_1400736C0(Pool2, (__int64)L"framework::LinkEventViewerLogger::LinkEventViewerLogger", a1);
      v6 = v5;
      if ( v5 )
      {
        sub_140073F78(v5);
