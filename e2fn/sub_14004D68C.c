__int64 __fastcall sub_14004D68C(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnMsixInterruptDispatcher::EvtD0Entry", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  if ( v6 )
  {
    ...
    sub_14004BF58(a1, (__int64)L"Config()", 156, 64, v6);
  }
  else
  {
    v6 = 0;
