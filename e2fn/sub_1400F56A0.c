__int64 __fastcall sub_1400F56A0(__int64 a1)
{
  char v1; // di
  __int64 *v3; // r15
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareTxQueue::DisableQueue", a1);
      if ( v5 )
        v3 = v5;
    }
  }
...
LABEL_36:
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v25 )
        v21 = v25;
      sub_1400A5E80(*(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL), 2u, 0xAu, 0x19u, (__int64)&unk_1400D52E0, v21, v30, v31);
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
    {
  ...
  if ( !v11 || *v12 )
  {
    ...
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v17 )
        v13 = v17;
      sub_1400A5E80(*(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL), 2u, 0xAu, 0x1Au, (__int64)&unk_1400D52E0, v13, v30, v31);
      v1 = 12;
    }
    if ( (v1 & 8) != 0 )
    {
  ...
  {
    *(_DWORD *)((unsigned int)((*(_DWORD *)(a1 + 360) << 8) + 14376) + v11) = v8 & 0xFDFFFFFF;
