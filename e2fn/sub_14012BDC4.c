__int64 __fastcall sub_14012BDC4(__int64 a1)
{
  char v1; // r14
  __int64 *v3; // r12
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400736C0(Pool2, (__int64)L"framework::DeviceD0EntryFlows::D0EntryFromS4", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  v14 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 400) + 160LL))(*(_QWORD *)(a1 + 400));
  if ( v14 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A5E80(v15, 2u, 8u, 0x1Bu, (__int64)&unk_1400D9718, v18, v19, L"m_hardwareAbstraction->EvtD0EntryFromSx()");
    }
    if ( (v1 & 8) != 0 )
    {
      v20 = v33;
    ...
    sub_14000D514(a1, (__int64)L"m_hardwareAbstraction->EvtD0EntryFromSx()", 228, 76, v14);
  }
  else
  {
    ...
    if ( v14 )
    {
      ...
      sub_1400084DC(a1, (__int64)L"m_netAdapter->EvtD0Entry()", 229, 76, v14);
    }
    else
    {
      v14 = 0;
