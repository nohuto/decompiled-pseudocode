__int64 __fastcall sub_140028920(_QWORD *a1)
{
  char v1; // di
  __int64 *v3; // r14
  _QWORD *Pool2; // rax
  ...
  volatile signed __int32 *v17; // [rsp+60h] [rbp-49h]
  _BYTE v18[8]; // [rsp+68h] [rbp-41h] BYREF
  volatile signed __int32 *v19; // [rsp+70h] [rbp-39h]
  __int16 v20; // [rsp+80h] [rbp-29h] BYREF
  char v21; // [rsp+82h] [rbp-27h]
  char v22; // [rsp+83h] [rbp-26h]
  int v23; // [rsp+84h] [rbp-25h]
  __int16 v24; // [rsp+88h] [rbp-21h]
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400045E8(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnFirmware::WriteOffloadConfigurationToFirmware",
  ...
  if ( v6 )
  {
    ...
    sub_1400095B8((_DWORD)a1 + 8, (__int64)L"SendCommandToFirmware(fwCmd, sizeof(fwCmd))", 258, 45, v6);
  }
  else
  {
    v6 = 0;
