__int64 __fastcall sub_14005A3A0(__int64 a1, __int64 a2)
{
  __int64 Pool2; // rax
  int v5; // edx
  __int64 v6; // rax
  ...
  Pool2 = ExAllocatePool2(64LL, 32LL, 808466482LL);
  if ( !Pool2
    || (v6 = sub_1400ABC68(Pool2), (v7 = (volatile signed __int32 *)v6) == 0LL)
    || (v8 = *(_QWORD *)(v6 + 16)) == 0 )
  {
    v17 = 0LL;
    ...
    {
      LOBYTE(v5) = 2;
      sub_1400A3054(*(_QWORD *)(*((_QWORD *)P + 1) + 16LL), v5, 3, 12, (__int64)&unk_1400D78E8, (__int64)L"spinLock");
    }
    ...
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400ABCF8(
        *(_QWORD *)(*((_QWORD *)P + 1) + 16LL),
        ...
        (__int64)L"spinLock->Init(m_parentObject)",
        v10);
    }
    v18 = 0LL;
    sub_1400A27D4(a2, &v18);
    if ( !v7 )
      return a2;
