__int64 __fastcall sub_1400294F0(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareArpOffload::DisableArpOffload", a1 - 352);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  *(_BYTE *)(a1 + 64) = 0;
  ...
  else
  {
    ...
    {
      *(_DWORD *)(*(_QWORD *)(v6 + 8) + 22528LL) = v8 & 0xFFFFFFEF;
  ...
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    if ( v13 )
      v12 = v13;
    v14 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)(a1 - 296) + 24LL))(a1 - 296, v24);
    v23 = v9;
    v22 = L"m_mmioAccessor->UnsetMaskSafe(0x05800, (1 << 4))";
    LOBYTE(v15) = 2;
    v21 = (__int64)v12;
  ...
  sub_140009850(a1 - 352, (__int64)L"m_mmioAccessor->UnsetMaskSafe(0x05800, (1 << 4))", 87, 47, v9);
LABEL_32:
  if ( v3 )
  {
    sub_14000BFA4(v3);
