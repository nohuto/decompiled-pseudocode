__int64 __fastcall sub_140116720(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400736C0(Pool2, (__int64)L"framework::DeviceContext::CreateNetAdapter", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  v6 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(a1 + 440) + 32LL))(
         *(_QWORD *)(a1 + 440),
         *(_QWORD *)(a1 + 384));
  if ( v6 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A5E80(
        *(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL),
        ...
        v7,
        v8,
        L"m_netAdapter->CreateNetAdapter(m_device)");
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
    {
    ...
    sub_140009320(a1, (__int64)L"m_netAdapter->CreateNetAdapter(m_device)", 338, 74, v6);
  }
  else
  {
    v6 = 0;
