void *(__fastcall **__fastcall sub_14004B5C0(__int64 a1, __int64 a2))(CUnknown *__hidden this, unsigned int)
{
  __int64 v4; // rbx
  ...
  v22 = 0LL;
  v23 = 0LL;
  sub_1400011A8(&v19, (__int64)L"m_messageId", 0xBuLL);
  ...
  v17 = 0LL;
  v18 = 0LL;
  sub_1400011A8(&v14, (__int64)L"m_ivarIndex", 0xBuLL);
  v10 = *(unsigned int *)(a1 + 436);
