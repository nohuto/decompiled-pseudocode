void __fastcall sub_14009DF10(_QWORD *a1, __int64 *a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x800) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_140094FB8(
             Pool2,
             (__int64)L"net_adapter::NetAdapterSegmentationOffload::UnregisterConfigurationChangedCallback",
             (__int64)(a1 - 44));
      if ( v7 )
        v4 = v7;
    }
  ...
  else
  {
    ...
    sub_140022128((_DWORD)a1 - 352, (__int64)L"callback", 97, 111);
  }
  if ( v4 )
  {
    sub_1400953B8(v4);
