__int64 __fastcall sub_14005A598(__int64 a1, __int64 a2)
{
  int v2; // edx
  unsigned int v3; // ebx
  ...
  *(_QWORD *)&v7 = a2;
  v3 = (*(__int64 (__fastcall **)(__int64, __int128 *, __int64))(qword_1400DF678 + 2520))(qword_1400DF6A8, &v5, a1 + 16);
  if ( !v3 )
    return 0LL;
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    sub_1400A1CFC(
      *(_QWORD *)(*((_QWORD *)P + 1) + 16LL),
      ...
      3,
      10,
      (__int64)&unk_1400D78E8,
      (__int64)L"WdfSpinLockCreate(&attributes, &m_lock)",
      v3);
  }
  return v3;
}
