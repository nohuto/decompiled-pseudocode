__int64 __fastcall sub_1400103E8(_QWORD *a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareReceiveScaling::EnableReceiveScalingHashValue",
             (__int64)a1);
      if ( v5 )
        v3 = v5;
    }
  ...
  else
  {
    ...
    {
      *(_DWORD *)(*(_QWORD *)(v6 + 8) + 20480LL) = v8 | 0x2000;
  ...
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    v23 = v9;
    v22 = L"m_mmioAccessor->SetMaskSafe(0x05000, (1 << 13))";
    LOBYTE(v15) = 2;
    v21 = (__int64)v12;
  ...
  sub_14000F278((int)a1, (__int64)L"m_mmioAccessor->SetMaskSafe(0x05000, (1 << 13))", 127, 54, v9);
LABEL_32:
  if ( v3 )
  {
    sub_14000BFA4(v3);
