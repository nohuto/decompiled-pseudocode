__int64 __fastcall sub_140065240(__int64 a1, _QWORD *a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x10) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_14005A6E0(Pool2, (__int64)L"os_services::OsActivePowerScheme::RegisterMaxPowerCallback", a1 - 352);
      if ( v7 )
        v4 = v7;
    }
  }
  ...
  else
  {
    ...
    sub_140022128(a1 - 352, (__int64)L"callback", 88, 170);
    if ( v4 )
    {
      sub_14005A99C(v4);
      ExFreePool(v4);
