__int64 __fastcall sub_140100E20(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareWolPatterns::EnableWakeFromMagicPacket",
             a1 - 352);
      if ( v5 )
        v3 = v5;
    }
  ...
  else
  {
    ...
    {
      *(_DWORD *)(*(_QWORD *)(v6 + 8) + 22536LL) = v8 | 2;
  ...
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    v22 = v9;
    v21 = L"m_mmioAccessor->SetMaskSafe(0x05808, (1 << 1))";
    v20 = v12;
    v15 = *(const wchar_t **)(*(_QWORD *)v14 + 16LL);
    if ( v15 )
      v11 = v15;
    sub_1400A5E80(*(_QWORD *)(*(_QWORD *)(a1 - 176) + 16LL), 2u, 0xAu, 0x1Eu, (__int64)&unk_1400D64E8, v11, v20, v21);
    v1 = 3;
  }
  if ( (v1 & 2) != 0 )
  {
  ...
  sub_140009704(a1 - 352, (__int64)L"m_mmioAccessor->SetMaskSafe(0x05808, (1 << 1))", 423, 59, v9);
LABEL_32:
  if ( v3 )
  {
    sub_14000BFA4(v3);
