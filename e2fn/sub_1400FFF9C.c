void __fastcall sub_1400FFF9C(_QWORD *a1)
{
  char v1; // di
  __int64 *v2; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareWolPatterns::EnableAdvancedPowerManagement",
             (__int64)a1);
      if ( v5 )
        v2 = v5;
    }
  ...
  if ( v7 && !*(_DWORD *)(v6 + 20) )
  {
    ...
    {
      *(_DWORD *)(*(_QWORD *)(v6 + 8) + 22528LL) = v8 | 9;
