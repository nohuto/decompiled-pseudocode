__int64 __fastcall sub_140059CA8(__int64 a1)
{
  char v1; // si
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(
             Pool2,
             (__int64)L"e1000_hardware::E1000HardwareReceiveControlRegister::E1000PassMacControlFramesToHost",
             a1);
      if ( v5 )
        v3 = v5;
    }
  ...
  v14 = sub_14007D424(a1, 0x800000LL);
  if ( v14 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
    ...
    sub_1400080F8(a1, (__int64)L"SetMaskSafe((1 << 23))", 178, 121, v14);
  }
  else
  {
    v14 = 0;
