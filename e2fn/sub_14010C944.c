__int64 __fastcall sub_14010C944(_QWORD *a1, __int64 a2)
{
  char v2; // di
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x10) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_14005A6E0(Pool2, (__int64)L"os_services::OsTimerFactory::Bind", (__int64)a1);
      if ( v7 )
        v4 = v7;
    }
  }
  ...
  else
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v11 )
        v8 = v11;
      sub_1400A3320(*(_QWORD *)(a1[22] + 16LL), 2u, 5u, 0xCu, (__int64)&unk_1400D83F8, v8, v9, L"device");
      v2 = 3;
    }
    if ( (v2 & 2) != 0 )
    {
    ...
    sub_14000B00C((int)a1, (__int64)L"device", 160, 144);
    v14 = -1073741811;
  }
  if ( v4 )
  {
