__int64 __fastcall sub_1400F4044(_QWORD *a1)
{
  __int64 *v2; // rsi
  _QWORD *Pool2; // rax
  __int64 *v4; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v4 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareLink::EvtPrepareHardware", (__int64)a1);
      if ( v4 )
        v2 = v4;
    }
  }
  ...
  v17 = sub_14000E170;
  v6 = *v5;
  v7 = sub_14000DB1C(&v21, a1, (__int64)&v17);
  v8 = sub_1400A27D4(&v23, v7);
  v9 = (__int64 *)(*(__int64 (__fastcall **)(__int64 *, _BYTE *, _QWORD *, _QWORD *))(v6 + 24))(v5, v19, v8, a1);
  v10 = a1[58];
  a1[58] = v9[1];
  v11 = *v9;
  v9[1] = v10;
