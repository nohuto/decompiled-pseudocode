__int64 __fastcall sub_14007D134(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"hardware_abstraction::RegisterWrapper::Initialize", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  v6 = (__int64 *)(*(__int64 (__fastcall **)(_QWORD, _BYTE *))(**(_QWORD **)(a1 + 400) + 8LL))(
                    *(_QWORD *)(a1 + 400),
                    v21);
  v7 = *(_QWORD *)(a1 + 392);
  *(_QWORD *)(a1 + 392) = v6[1];
  ...
  *v6 = v9;
  ...
  else
  {
    ...
    sub_14000B00C(a1, (__int64)L"m_lock", 73, 114);
    v19 = -1073741801;
  }
  if ( v3 )
  {
