void __fastcall sub_140098714(__int64 a1, __int64 a2, int a3, int a4, unsigned int a5)
{
  PVOID v8; // rbx
  ...
  if ( a5 != -1073741130 )
  {
    ...
    v14 = 0LL;
    v15 = 0LL;
    if ( a2 && (sub_1400011A8(&v11, a2, 0xFBuLL), v13) )
    ...
    if ( v8 )
      ExFreePool(v8);
    sub_140071A6C(a1, 1u, (__int64)&v11, 0, a4, a3, a5);
    v11 = &off_1400D41D0;
    if ( v13 )
      ExFreePool(v13);
  }
