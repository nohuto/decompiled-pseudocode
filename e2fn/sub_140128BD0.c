__int64 __fastcall sub_140128BD0(_QWORD *a1, __int64 *a2, __int64 *a3, __int64 *a4, __int64 *a5, __int64 *a6)
{
  __int64 *v7; // rbx
  _QWORD *Pool2; // rax
  __int64 *v12; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v12 = sub_1400736C0(Pool2, (__int64)L"framework::DeviceD0ExitFlows::Bind", (__int64)(a1 - 44));
      if ( v12 )
        v7 = v12;
    }
  }
