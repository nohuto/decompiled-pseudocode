_QWORD *__fastcall sub_14003E63C(_QWORD *a1, int a2)
{
  int v4; // r9d
  _QWORD *Pool2; // rax
  __int64 *v6; // rax
  ...
  *a1 = &off_1400D7120;
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v6 = sub_1400045E8(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwarePhy::ProductE2fnHardwarePhy", (__int64)a1);
      v7 = v6;
      if ( v6 )
      {
        sub_140005840(v6);
