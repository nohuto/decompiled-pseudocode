__int64 __fastcall sub_14000C950(__int64 a1)
{
  char v2; // di
  unsigned int v3; // ebp
  void *v4; // rsi
  ...
  v2 = 0;
  v3 = sub_140046BD0(*(_QWORD *)(a1 + 144));
  if ( !v3 )
    return 0LL;
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    sub_1400A5E80(
      *(_QWORD *)(*(_QWORD *)(a1 - 176) + 16LL),
      ...
      (__int64)v4,
      (__int64)v5,
      (__int64)L"m_macAddress->GetCurrentMacAddress(macAddress)",
      v3);
    v2 = 3;
  }
  if ( (v2 & 2) != 0 )
  ...
  sub_140009704(a1 - 352, (__int64)L"m_macAddress->GetCurrentMacAddress(macAddress)", 615, 46, v3);
  return v3;
}
