__int64 __fastcall sub_140104E90(_QWORD *a1, __int64 *a2, __int64 *a3)
{
  char v3; // di
  __int64 *v5; // rsi
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v9 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareLowPowerLinkUp::Bind", (__int64)a1);
      if ( v9 )
        v5 = v9;
    }
  }
  if ( !*a2 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v13 )
        v10 = v13;
      sub_1400A3320(*(_QWORD *)(a1[22] + 16LL), 2u, 0xAu, 0xAu, (__int64)&unk_1400D7060, v10, v11, L"mmioAccessor");
      v3 = 3;
    }
    if ( (v3 & 2) != 0 )
    {
    ...
    sub_14000BA2C((int)a1, (__int64)L"mmioAccessor", 58, 159);
LABEL_42:
    if ( v5 )
    {
      sub_14000BFA4(v5);
  ...
  *a2 = v18;
  if ( !*a3 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      v21 = *(const wchar_t **)(*(_QWORD *)(*(__int64 (__fastcall **)(_QWORD *, _BYTE *))(a1[7] + 16LL))(a1 + 7, v39)
                              + 16LL);
      if ( v21 )
        v20 = v21;
      v22 = *(const wchar_t **)(*(_QWORD *)(*(__int64 (__fastcall **)(_QWORD *, _BYTE *))(a1[7] + 24LL))(a1 + 7, v37)
                              + 16LL);
      if ( v22 )
        v19 = v22;
      sub_1400A3320(*(_QWORD *)(a1[22] + 16LL), 2u, 0xAu, 0xBu, (__int64)&unk_1400D7060, v19, v20, L"phy");
      v3 = 12;
    }
    if ( (v3 & 8) != 0 )
    {
    ...
    sub_14000DA44((int)a1, (__int64)L"phy", 61, 159);
    goto LABEL_42;
  }
  v28 = a1[46];
  a1[46] = a3[1];
