__int64 __fastcall sub_140126490(__int64 a1)
{
  char v1; // r15
  __int64 *v3; // r12
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x400) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_140074D50(Pool2, (__int64)L"net_adapter::NetAdapter::InitializeRxQueuesContainer", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  v6 = *(_DWORD *)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 416) + 8LL))(*(_QWORD *)(a1 + 416)) + 24);
  v42 = v6;
  if ( v6 )
  {
    ...
    if ( *(_QWORD *)(a1 + 608) == v6 )
      goto LABEL_61;
    if ( !(unsigned int)sub_14000CDB4((_QWORD *)(a1 + 592), v6) )
      *(_QWORD *)(a1 + 608) = v6;
    if ( *(_QWORD *)(a1 + 608) == v6 )
    {
LABEL_61:
    ...
    else
    {
      ...
      if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
      {
        ...
        if ( v25 )
          v26 = v25;
        sub_1400A5E80(v24, 2u, 0xBu, 0x50u, (__int64)&unk_1400D9408, v22, v26, L"ResizeVector(m_rxQueues, numRxQueues)");
        v14 = -1073741801;
      }
      if ( (v1 & 0x20) != 0 )
      {
      ...
      sub_140008F3C(a1, (__int64)L"ResizeVector(m_rxQueues, numRxQueues)", 584, 100, 0xC0000017);
    }
  }
  else
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v11 )
        v7 = v11;
      sub_1400A3320(v10, 2u, 0xBu, 0x4Eu, (__int64)&unk_1400D9408, v8, v7, (const wchar_t *)qword_14014EC70);
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
    {
