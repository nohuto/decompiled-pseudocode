__int64 __fastcall sub_140121A40(__int64 a1, __int64 a2)
{
  char v3; // di
  __int64 v4; // r14
  unsigned int v5; // ebp
  ...
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    sub_1400A5E80(
      *(_QWORD *)(*(_QWORD *)(v4 + 176) + 16LL),
      ...
      v6,
      v7,
      L"_this->CreateRxQueue(rxQueueInit)");
    v3 = 3;
  }
  if ( (v3 & 2) != 0 )
  {
  ...
  sub_140008DF0(v4, (__int64)L"_this->CreateRxQueue(rxQueueInit)", 480, 100, v5);
  return v5;
}
