void *(__fastcall **__fastcall sub_14002C8A0(__int64 a1, __int64 a2))(CUnknown *__hidden this, unsigned int)
{
  ...
  v12 = 0LL;
  v13 = 0LL;
  sub_1400011A8(&v9, (__int64)L"m_nsOffloadEnabled", 0x12uLL);
