__int64 __fastcall sub_14012D810(_QWORD *a1, __int64 *a2, __int64 *a3)
{
  char v3; // di
  __int64 *v5; // rsi
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v9 = sub_14000BBDC(Pool2, (__int64)L"hardware_abstraction::HardwareAbstraction::Bind", (__int64)(a1 - 44));
      if ( v9 )
        v5 = v9;
    }
  }
  if ( !*a2 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v13 )
        v10 = v13;
      sub_1400A3320(*(_QWORD *)(*(a1 - 22) + 16LL), 2u, 0xAu, 0xEu, (__int64)&unk_1400D9790, v10, v11, L"osServices");
      v3 = 3;
    }
    if ( (v3 & 2) != 0 )
    {
    ...
    sub_14000B87C((_DWORD)a1 - 352, (__int64)L"osServices", 124, 81);
LABEL_42:
    if ( v5 )
    {
      sub_14000BFA4(v5);
  ...
  *a2 = v18;
  if ( !*a3 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v22 )
        v19 = v22;
      sub_1400A3320(*(_QWORD *)(*(a1 - 22) + 16LL), 2u, 0xAu, 0xFu, (__int64)&unk_1400D9790, v19, v20, L"osResources");
      v3 = 12;
    }
    if ( (v3 & 8) != 0 )
    {
    ...
    sub_14000B954((_DWORD)a1 - 352, (__int64)L"osResources", 127, 81);
    goto LABEL_42;
  }
  v28 = a1[5];
  a1[5] = a3[1];
