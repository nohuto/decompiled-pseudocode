__int64 __fastcall sub_1400813BC(__int64 a1, __int64 a2)
{
  __int64 Pool2; // rax
  __int64 v5; // rax
  ...
  Pool2 = ExAllocatePool2(64LL, 32LL, 808477490LL);
  if ( Pool2
    && (v5 = sub_1400B1DDC(Pool2, a2), (v6 = (volatile signed __int32 *)v5) != 0LL)
    && (v7 = *(_QWORD *)(v5 + 16)) != 0 )
  {
    *((_QWORD *)&v13 + 1) = v6;
    *(_QWORD *)&v13 = v7;
