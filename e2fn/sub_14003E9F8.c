__int64 __fastcall sub_14003E9F8(_QWORD *a1, __int64 *a2, _QWORD *a3, __int64 *a4)
{
  char v4; // bl
  __int64 *v6; // r15
  __int64 *v7; // rsi
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v10 = sub_1400045E8(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwarePhy::Bind", (__int64)a1);
      if ( v10 )
        v6 = v10;
    }
    a3 = v89;
  ...
  if ( !*a2 )
  {
    ...
    sub_14000BA2C((int)a1, (__int64)L"mmioAccessor", 67, 156);
LABEL_104:
    if ( v6 )
    {
      sub_140005840(v6);
  ...
  *a2 = v21;
  if ( !*a3 )
  {
    ...
    sub_14000B87C((int)a1, (__int64)L"osServices", 70, 156);
    goto LABEL_104;
  }
  ...
  *v30 = v33;
  ...
  if ( a1[49] )
  {
    if ( !*v7 )
    {
      if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
      {
        ...
        if ( v54 )
          v55 = v54;
        sub_1400A3320(v51, v53, 14, 13, (__int64)&unk_1400D71E0, (__int64)v49, (__int64)v55, (__int64)L"firmware");
        v7 = a4;
        v4 = -64;
      }
      if ( v4 < 0 )
      ...
      sub_140022128((int)a1, (__int64)L"firmware", 77, 156);
      v58 = v70;
      if ( v70 )
      {
  ...
  else
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v40 )
        v41 = v40;
      sub_1400A3320(v37, v39, 14, 12, (__int64)&unk_1400D71E0, (__int64)v35, (__int64)v41, (__int64)L"m_phyLock");
      v7 = a4;
      v4 = 48;
    }
    if ( (v4 & 0x20) != 0 )
    ...
    sub_14003B970((int)a1, (__int64)L"m_phyLock", 75, 156);
    v44 = v70;
    if ( v70 )
    {
      if ( _InterlockedExchangeAdd(v70 + 2, 0xFFFFFFFF) == 1 )
