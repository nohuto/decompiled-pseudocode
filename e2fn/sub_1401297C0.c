__int64 __fastcall sub_1401297C0(__int64 a1)
{
  char v1; // si
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400736C0(Pool2, (__int64)L"framework::DeviceD0ExitFlows::D0ExitToS3", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  v14 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 416) + 72LL))(*(_QWORD *)(a1 + 416));
  if ( v14 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
    ...
    sub_140008390(a1, (__int64)L"m_netAdapter->EvtD0Exit()", 204, 77, v14);
  }
  else
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 400) + 176LL))(*(_QWORD *)(a1 + 400));
