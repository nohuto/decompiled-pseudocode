__int64 __fastcall sub_1401234E0(__int64 a1)
{
  char v1; // di
  __int64 *v2; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x400) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_140074D50(Pool2, (__int64)L"net_adapter::NetAdapter::EvtD0ExitFinal", a1 - 352);
      if ( v5 )
        v2 = v5;
    }
  }
  ...
  ((void (__fastcall *)(__int64, _QWORD))qword_1400DF748)(qword_1400DF700, *(_QWORD *)(a1 + 16));
  if ( v2 )
  {
    sub_140075108(v2);
    ExFreePool(v2);
