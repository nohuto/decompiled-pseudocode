__int64 __fastcall sub_140069C90(__int64 a1)
{
  char v1; // si
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 8) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14005B310(Pool2, (__int64)L"os_resources::SystemPower::DisableD3ColdInS0Idle", a1 - 352);
      if ( v5 )
        v3 = v5;
    }
  }
  if ( !*(_DWORD *)(a1 + 272) || !*(_BYTE *)(a1 + 276) )
    goto LABEL_42;
  v6 = &unk_1400D44E0;
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    if ( v8 )
      v7 = v8;
    v9 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)(a1 - 296) + 24LL))(a1 - 296, v24);
    v10 = &unk_1400D44E0;
  ...
  v14 = sub_14006983C(a1 - 352, *(_DWORD *)(a1 + 272), 0);
  if ( v14 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v16 )
        v15 = v16;
      v17 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)(a1 - 296) + 24LL))(a1 - 296, v28);
      LOBYTE(v18) = 2;
      ...
      sub_1400A5E80(
        *(_QWORD *)(*(_QWORD *)(a1 - 176) + 16LL),
        ...
        (__int64)v6,
        (__int64)v15,
        (__int64)L"AssignS0IdleSettings(m_idleTimeoutMs, false )",
        v14);
    }
    if ( (v1 & 8) != 0 )
    {
    ...
    sub_1400190D0(a1 - 352, (__int64)L"AssignS0IdleSettings(m_idleTimeoutMs, false )", 171, 148, v14);
  }
  else
  {
LABEL_42:
