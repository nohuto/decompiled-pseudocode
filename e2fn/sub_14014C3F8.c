__int64 __fastcall sub_14014C3F8(__int64 a1)
{
  __int64 *v2; // rdi
  _QWORD *Pool2; // rax
  __int64 *v4; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v4 = sub_1400736C0(Pool2, (__int64)L"framework::WolPatternsEventViewerLogger::Initialize", a1);
      if ( v4 )
        v2 = v4;
    }
  }
  ...
  v14 = 0LL;
  v15 = 0LL;
  sub_1400011A8(&v11, (__int64)L"LogWolEvent", 0xBuLL);
