void __fastcall sub_14012E75C(__int64 a1)
{
  __int64 *v2; // rdi
  _QWORD *Pool2; // rax
  __int64 *v4; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v4 = sub_14000BBDC(Pool2, (__int64)L"hardware_abstraction::HardwareLowPowerIdle::Initialize", a1);
      if ( v4 )
        v2 = v4;
    }
  }
  ...
  v13 = 0LL;
  v14 = 0LL;
  sub_1400011A8(&v10, (__int64)L"*EEE", 4uLL);
  sub_1400A27D4(&v8, (__int64 *)(a1 + 112));
  v5 = sub_14003E2F0(v8, (__int64)&v10, v8 + 16);
  v6 = v9;
  *(_BYTE *)(a1 + 360) = v5;
  if ( v6 )
  {
