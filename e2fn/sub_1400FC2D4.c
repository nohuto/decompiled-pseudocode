__int64 __fastcall sub_1400FC2D4(_QWORD *a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnFirmware::NotifyFirmwareDriverIsUnloaded",
  ...
  else
  {
    ...
    {
      *(_DWORD *)(*(_QWORD *)(v6 + 8) + 24LL) = v8 & 0xEFFFFFFF;
  ...
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    v22 = v9;
    v21 = L"m_mmioAccessor->UnsetMaskSafe(0x00018, (1 << 28))";
    v20 = v12;
    v15 = *(const wchar_t **)(*(_QWORD *)v14 + 16LL);
    if ( v15 )
      v11 = v15;
    sub_1400A5E80(*(_QWORD *)(a1[23] + 16LL), 2u, 0xAu, 0x26u, (__int64)&unk_1400D6110, v11, v20, v21);
    v1 = 3;
  }
  if ( (v1 & 2) != 0 )
  {
  ...
  sub_14000999C((_DWORD)a1 + 8, (__int64)L"m_mmioAccessor->UnsetMaskSafe(0x00018, (1 << 28))", 501, 45, v9);
LABEL_32:
  if ( v3 )
  {
    sub_14000BFA4(v3);
