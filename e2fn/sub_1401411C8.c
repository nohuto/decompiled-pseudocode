__int64 __fastcall sub_1401411C8(_QWORD *a1, __int64 *a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x1000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_1400918DC(Pool2, (__int64)L"net_adapter::NetAdapterRxPacketFilter::Bind", (__int64)a1);
      if ( v7 )
        v4 = v7;
    }
  }
  ...
  else
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v11 )
        v8 = v11;
      sub_1400A3320(*(_QWORD *)(a1[22] + 16LL), 2u, 0xDu, 0xAu, (__int64)&unk_1400D9EC0, v8, v9, L"hardwareRxFilter");
      v2 = 3;
    }
    if ( (v2 & 2) != 0 )
    {
    ...
    sub_14000B294((int)a1, (__int64)L"hardwareRxFilter", 58, 109);
    if ( v4 )
    {
      sub_140091BA8(v4);
      ExFreePool(v4);
