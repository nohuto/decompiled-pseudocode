__int64 __fastcall sub_14014BF54(_QWORD *a1, __int64 *a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_1400736C0(Pool2, (__int64)L"framework::WolPatternsEventViewerLogger::Bind", (__int64)a1);
      if ( v7 )
        v4 = v7;
    }
  }
  ...
  else
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v11 )
        v8 = v11;
      sub_1400A3320(*(_QWORD *)(a1[22] + 16LL), 2u, 8u, 0xAu, (__int64)&unk_1400DA568, v8, v9, L"eventViewerLogger");
      v2 = 3;
    }
    if ( (v2 & 2) != 0 )
    {
    ...
    sub_14000B36C((int)a1, (__int64)L"eventViewerLogger", 57, 151);
    if ( v4 )
    {
      sub_140073F78(v4);
      ExFreePool(v4);
