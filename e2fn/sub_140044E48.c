_QWORD *__fastcall sub_140044E48(_QWORD *a1, int a2)
{
  int v4; // r9d
  _QWORD *Pool2; // rax
  __int64 *v6; // rax
  ...
  *a1 = &off_1400D7200;
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v6 = sub_1400045E8(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareCounters::ProductE2fnHardwareCounters",
             (__int64)a1);
      v7 = v6;
      if ( v6 )
      {
