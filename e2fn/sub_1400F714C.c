__int64 __fastcall sub_1400F714C(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareTxQueue::WriteToHwDescriptorLength", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  if ( !v7 || *(_DWORD *)(v6 + 20) )
  {
    ...
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      v20 = v8;
      v19 = L"m_mmioAccessor->WriteRegisterSafe((0x03808 + (m_queueId) * 0x100), m_queueLength * sizeof(HW_TX_DESCRIPTOR))";
      v18 = v10;
      v13 = *(const wchar_t **)(*(_QWORD *)v12 + 16LL);
      if ( v13 )
        v9 = v13;
      sub_1400A5E80(*(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL), 2u, 0xAu, 0x1Du, (__int64)&unk_1400D52E0, v9, v18, v19);
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
    {
    ...
    sub_140011D00(
      a1,
      (__int64)L"m_mmioAccessor->WriteRegisterSafe((0x03808 + (m_queueId) * 0x100), m_queueLength * sizeof(HW_TX_DESCRIPTOR))",
      445,
      58,
      v8);
  }
  ...
  {
    *(_DWORD *)((unsigned int)((*(_DWORD *)(a1 + 360) << 8) + 14344) + v7) = 16 * *(_DWORD *)(a1 + 476);
