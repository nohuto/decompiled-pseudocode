__int64 __fastcall sub_14007F9C0(__int64 a1, _QWORD *a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_14000BBDC(
             Pool2,
             (__int64)L"hardware_abstraction::HardwareLink::RegisterLinkStateChangedCallback",
             a1 - 352);
      if ( v7 )
        v4 = v7;
    }
  ...
  else
  {
    ...
    sub_140022128(a1 - 352, (__int64)L"callback", 64, 84);
    if ( v4 )
    {
      sub_14000BFA4(v4);
      ExFreePool(v4);
