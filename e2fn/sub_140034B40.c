_QWORD *__fastcall sub_140034B40(__int64 a1, _QWORD *a2, __int64 *a3)
{
  char v3; // si
  __int64 v5; // rcx
  void *v8; // rsi
  ...
  if ( v5 )
  {
    ...
    *a3 = 0LL;
    v20[0] = v18;
    (*(void (__fastcall **)(__int64, _QWORD *, _QWORD *))(*(_QWORD *)(v5 + 352) + 32LL))(v5 + 352, a2, v20);
  ...
  sub_14000B444(a1 - 352, (__int64)L"m_interruptsFactory", 119, 61);
  *a2 = 0LL;
  a2[1] = 0LL;
  v16 = (volatile signed __int32 *)a3[1];
  if ( v16 )
