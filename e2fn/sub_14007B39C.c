__int64 __fastcall sub_14007B39C(_QWORD *a1)
{
  char v1; // bp
  __int64 *v3; // rsi
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"hardware_abstraction::HardwareQueue::EnableTraffic", (__int64)a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  v10 = (*(__int64 (__fastcall **)(__int64 *, __int64))(v8 + 8))(v6, v9);
  if ( v10 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A5E80(
        *(_QWORD *)(a1[22] + 16LL),
        ...
        (__int64)v11,
        (__int64)v12,
        (__int64)L"m_trafficGate->Enable(GetName())",
        v10);
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
    ...
    sub_140008CA4((int)a1, (__int64)L"m_trafficGate->Enable(GetName())", 165, 87, v10);
  }
  else
  {
    v10 = 0;
