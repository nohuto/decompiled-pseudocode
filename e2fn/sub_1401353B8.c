__int64 __fastcall sub_1401353B8(_QWORD *a1)
{
  char v1; // di
  __int64 *v3; // r14
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x400) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_140074D50(Pool2, (__int64)L"net_adapter::NetAdapterLink::AllocateComponents", (__int64)a1);
      if ( v5 )
        v3 = v5;
    }
  }
  v6 = ExAllocatePool2(64LL, 32LL, 808477746LL);
  if ( !v6 || (v7 = sub_1400B4554(v6, (__int64)a1)) == 0 || (v8 = *(_QWORD *)(v7 + 16)) == 0 )
  {
    v8 = 0LL;
  ...
  else
  {
    ...
    sub_14008E02C((__int64)a1, (__int64)L"m_linkEventViewerLogger", 57, 104);
    v16 = -1073741801;
  }
  if ( v3 )
  {
