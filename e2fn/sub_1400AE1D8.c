__int64 __fastcall sub_1400AE1D8(__int64 a1, __int64 a2, int a3)
{
  char v6; // di
  __int64 Pool2; // rbp
  __int64 v8; // rax
  ...
  *(_QWORD *)(a1 + 16) = 0LL;
  v6 = 0;
  Pool2 = ExAllocatePool2(64LL, 384LL, 1685091442LL);
  if ( Pool2 )
  {
    v10 = &off_1400D41D0;
    v11 = 0;
    ...
    v14 = 0LL;
    if ( a2 )
      sub_1400011A8(&v10, a2, 5uLL);
    v8 = sub_14006B2B4(Pool2, (int)&v10, a3);
    v6 = 1;
  }
  else
  {
