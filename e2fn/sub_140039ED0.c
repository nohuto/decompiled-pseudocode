__int64 __fastcall sub_140039ED0(_QWORD *a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400045E8(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareLowPowerIdle::DisableEnergyEfficientEthernet",
             (__int64)a1);
      if ( v5 )
        v3 = v5;
    }
...
LABEL_40:
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      v35 = v9;
      v34 = L"m_mmioAccessor->UnsetMaskSafe(0x00E38, (1 << 4) | (1 << 3) | (1 << 2))";
      LOBYTE(v27) = 2;
      v33 = (__int64)v24;
    ...
    sub_14000F510(
      (int)a1,
      (__int64)L"m_mmioAccessor->UnsetMaskSafe(0x00E38, (1 << 4) | (1 << 3) | (1 << 2))",
      107,
      50,
      v9);
    goto LABEL_57;
  }
  *(_DWORD *)(*(_QWORD *)(v6 + 8) + 3640LL) = v8 & 0xFFFFFFE3;
  ...
  else
  {
    ...
    {
      *(_DWORD *)(*(_QWORD *)(v10 + 8) + 3632LL) = v12 & 0xFFF8FFFF;
      _InterlockedOr(v32, 0);
      v9 = 0;
      goto LABEL_57;
    }
  ...
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    v35 = v9;
    v34 = L"m_mmioAccessor->UnsetMaskSafe(0x00E30, (1 << 16) | (1 << 17) | (1 << 18))";
    LOBYTE(v18) = 2;
    v33 = (__int64)v15;
  ...
  sub_140039B9C(
    (int)a1,
    (__int64)L"m_mmioAccessor->UnsetMaskSafe(0x00E30, (1 << 16) | (1 << 17) | (1 << 18))",
    111,
    50,
    v9);
LABEL_57:
