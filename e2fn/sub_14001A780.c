_QWORD *__fastcall sub_14001A780(__int64 a1, _QWORD *a2, __int64 *a3, __int64 a4)
{
  char v4; // r14
  __int64 *v6; // r15
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v10 = sub_14000BBDC(
              Pool2,
              (__int64)L"product_e2fn::ProductE2fnMsixInterruptsFactory::AllocateFirmwareInterrupt",
              a1 - 352);
      if ( v10 )
        v6 = v10;
    }
  ...
  if ( a4 )
    v19 = a4;
  sub_1400A7694((unsigned int)&v47, 808477497, v19, a1 + 72, (__int64)&v46);
  v20 = v47;
  if ( v47 )
  {
    v30 = a3[1];
  ...
  else
  {
    ...
    sub_14000B294(v18, (__int64)L"interruptControl", 397, 65);
  }
  *a2 = 0LL;
  a2[1] = 0LL;
  if ( v48 )
