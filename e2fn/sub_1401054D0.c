__int64 __fastcall sub_1401054D0(_QWORD *a1, __int64 *a2, __int64 *a3, __int64 a4)
{
  __int64 *v5; // rsi
  char v8; // di
  __int64 *v9; // r14
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v11 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnMacPassthrough::Bind", (__int64)a1);
      if ( v11 )
        v9 = v11;
    }
  }
  if ( !*a2 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A3320(*(_QWORD *)(a1[22] + 16LL), 2u, 0xAu, 0xAu, (__int64)&unk_1400D7110, v15, v14, L"mmioAccessor");
      v8 = 3;
    }
    if ( (v8 & 2) != 0 )
    {
    ...
    sub_14000BA2C((int)a1, (__int64)L"mmioAccessor", 65, 63);
LABEL_25:
    if ( v9 )
    {
      sub_14000BFA4(v9);
  ...
  *a2 = v24;
  if ( !*a3 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v29 )
        v28 = v29;
      sub_1400A3320(*(_QWORD *)(a1[22] + 16LL), 2u, 0xAu, 0xBu, (__int64)&unk_1400D7110, v25, v28, L"deviceRestarter");
      v8 = 12;
    }
    if ( (v8 & 8) != 0 )
    {
    ...
    sub_14000B1BC((int)a1, (__int64)L"deviceRestarter", 68, 63);
    goto LABEL_25;
  }
  v32 = a1[46];
  a1[46] = a3[1];
  ...
  *a3 = v34;
  if ( !*v5 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A3320(v36, 2u, 0xAu, 0xCu, (__int64)&unk_1400D7110, v38, v39, L"firmware");
      v8 = 48;
    }
    if ( (v8 & 0x20) != 0 )
    {
    ...
    sub_140022128((int)a1, (__int64)L"firmware", 71, 63);
    if ( v9 )
    {
      sub_14000BFA4(v9);
      ExFreePool(v9);
