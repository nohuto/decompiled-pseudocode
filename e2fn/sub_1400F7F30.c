__int64 __fastcall sub_1400F7F30(__int64 a1)
{
  char v1; // di
  __int64 *v3; // r12
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareRxQueue::DisableQueue", a1);
      if ( v5 )
        v3 = v5;
    }
  }
...
LABEL_52:
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v33 )
        v29 = v33;
      sub_1400A5E80(*(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL), 2u, 0xAu, 0x18u, (__int64)&unk_1400D56F8, v29, v38, v39);
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
    {
  ...
  {
    *(_DWORD *)((unsigned int)((*(_DWORD *)(a1 + 360) << 8) + 10280) + v11) = v8 & 0xFDFFFFFF;
