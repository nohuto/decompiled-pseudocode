_QWORD *__fastcall sub_140035210(__int64 a1, _QWORD *a2, __int64 a3, __int64 *a4, __int64 a5)
{
  char v5; // si
  __int64 v7; // rcx
  void *v10; // rsi
  ...
  if ( v7 )
  {
    ...
    *a4 = 0LL;
    v22[0] = v20;
    (*(void (__fastcall **)(__int64, _QWORD *, __int64, _QWORD *, __int64))(*(_QWORD *)(v7 + 352) + 16LL))(
      v7 + 352,
      a2,
      a3,
      v22,
  ...
  sub_14000B444(a1 - 352, (__int64)L"m_interruptsFactory", 101, 61);
  *a2 = 0LL;
  a2[1] = 0LL;
  v18 = (volatile signed __int32 *)a4[1];
  if ( v18 )
