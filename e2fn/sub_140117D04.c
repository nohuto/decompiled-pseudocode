void __fastcall sub_140117D04(__int64 a1)
{
  __int64 *v2; // rbx
  _QWORD *Pool2; // rax
  __int64 *v4; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 4u )
  {
    ...
    if ( Pool2 )
    {
      v4 = sub_140073750(Pool2, (__int64)L"framework::DeviceContext::EvtDeviceDisarmWakeFromS0", a1);
      if ( v4 )
        v2 = v4;
    }
  }
  ...
  v8 = 0LL;
  v9 = 0LL;
  sub_1400011A8(&v5, (__int64)L"Disarm wake from S0", 0x13uLL);
