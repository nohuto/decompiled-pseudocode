__int64 __fastcall sub_1401178C4(__int64 a1, unsigned int a2)
{
  char v2; // si
  __int64 *v4; // r14
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 4u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_140073750(Pool2, (__int64)L"framework::DeviceContext::EvtDeviceD0Exit", a1);
      if ( v7 )
        v4 = v7;
    }
  }
  ...
  v12 = sub_140072960((__int64)&v41, (__int64)L"D0 Exit (target state = ", v49);
  ...
  if ( v52 )
    ExFreePool(v52);
  v16 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(a1 + 536) + 32LL))(
          *(_QWORD *)(a1 + 536),
          a2,
          v9);
  if ( v16 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A5E80(
        *(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL),
        ...
        v17,
        v18,
        L"m_d0ExitFlows->EvtD0Exit(targetState, powerAction)");
      v2 = 3;
    }
    if ( (v2 & 2) != 0 )
    {
    ...
    sub_14000F3C4(a1, (__int64)L"m_d0ExitFlows->EvtD0Exit(targetState, powerAction)", 664, 74, v16);
  }
  else
  {
    v16 = 0;
