_QWORD *__fastcall sub_140063358(_QWORD *a1, int a2)
{
  _QWORD *Pool2; // rax
  __int64 *v5; // rax
  __int64 *v6; // rbx
  ...
  v11 = 0LL;
  v12 = 0LL;
  sub_1400011A8(&v8, (__int64)L"OS Timer Factory", 0x10uLL);
  ...
  *a1 = &off_1400D84C8;
  ...
  v11 = 0LL;
  v12 = 0LL;
  a1[45] = 0xA5A5A5A5A50000ACuLL;
  if ( (HIDWORD(DeviceObject->Timer) & 0x10) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    Pool2 = (_QWORD *)ExAllocatePool2(64LL, 40LL, 1970304114LL);
    if ( Pool2 )
    {
      v5 = sub_14005A6E0(Pool2, (__int64)L"os_services::OsTimerFactory::OsTimerFactory", (__int64)a1);
      v6 = v5;
      if ( v5 )
      {
        sub_14005A99C(v5);
