__int64 __fastcall sub_140023D10(_QWORD *a1)
{
  char v1; // di
  __int64 *v3; // r14
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400045E8(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnFirmware::ClearArpOffloadTableInFirmware",
  ...
  if ( v6 )
  {
    ...
    sub_1400095B8((_DWORD)a1 + 8, (__int64)L"SendCommandToFirmware(fwCmd, sizeof(fwCmd))", 303, 45, v6);
  }
  else
  {
    v6 = 0;
