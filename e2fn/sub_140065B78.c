__int64 __fastcall sub_140065B78(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x10) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14005A6E0(Pool2, (__int64)L"os_services::OsActivePowerScheme::Uninitialize", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  v6 = PoUnregisterPowerSettingCallback(*(PVOID *)(a1 + 376));
  if ( v6 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A5E80(
        *(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL),
        ...
        (__int64)v7,
        (__int64)v8,
        (__int64)L"PoUnregisterPowerSettingCallback(m_activePowerschemeChangeCallbackHandle)",
        v6);
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
