__int64 __fastcall sub_14002BA70(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareNsOffload::DisableNsOffload", a1 - 352);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  *(_BYTE *)(a1 + 64) = 0;
  ...
  sub_140009850(a1 - 352, (__int64)L"m_mmioAccessor->UnsetMaskSafe(0x05800, (1 << 4))", 84, 52, v9);
LABEL_32:
  if ( v3 )
  {
    sub_14000BFA4(v3);
