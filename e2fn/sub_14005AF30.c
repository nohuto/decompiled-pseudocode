__int64 __fastcall sub_14005AF30(__int64 a1)
{
  char v2; // di
  unsigned int v3; // ebp
  void *v4; // rsi
  ...
  v2 = 0;
  v3 = sub_140065B78(*(_QWORD *)(a1 + 152));
  if ( !v3 )
    return 0LL;
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    sub_1400A5E80(
      *(_QWORD *)(*(_QWORD *)(a1 - 176) + 16LL),
      ...
      (__int64)v4,
      (__int64)v5,
      (__int64)L"m_osActivePowerScheme->Uninitialize()",
      v3);
    v2 = 3;
  }
  if ( (v2 & 2) != 0 )
  ...
  sub_140008F3C(a1 - 352, (__int64)L"m_osActivePowerScheme->Uninitialize()", 145, 143, v3);
  return v3;
}
