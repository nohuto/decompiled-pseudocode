__int64 __fastcall sub_1400FA3B0(__int64 a1)
{
  char v1; // di
  __int64 *v3; // r15
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareRxQueue::WriteToHwDescriptorBaseAddress",
             a1);
      if ( v5 )
        v3 = v5;
    }
  }
  v6 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 536) + 16LL))(*(_QWORD *)(a1 + 536));
  v7 = *(_QWORD *)(a1 + 392);
  v8 = HIDWORD(v6);
  v9 = v6;
  v10 = *(_QWORD *)(v7 + 8);
  if ( !v10 || *(_DWORD *)(v7 + 20) )
  {
    ...
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      v34 = v13;
      v33 = L"m_mmioAccessor->WriteRegisterSafe((0x02800 + (m_queueId) * 0x100), baseAddressLow)";
      v32 = v24;
      v27 = *(const wchar_t **)(*(_QWORD *)v26 + 16LL);
      if ( v27 )
        v23 = v27;
      sub_1400A5E80(*(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL), 2u, 0xAu, 0x1Bu, (__int64)&unk_1400D56F8, v23, v32, v33);
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
    {
    ...
    sub_140011538(
      a1,
      (__int64)L"m_mmioAccessor->WriteRegisterSafe((0x02800 + (m_queueId) * 0x100), baseAddressLow)",
      344,
      57,
      v13);
  }
  ...
  {
    *(_DWORD *)((unsigned int)((*(_DWORD *)(a1 + 360) + 40) << 8) + v10) = v6;
    ...
    if ( !v12 || *(_DWORD *)(v11 + 20) )
    {
      ...
      if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
      {
        ...
        v34 = v13;
        v33 = L"m_mmioAccessor->WriteRegisterSafe((0x02804 + (m_queueId) * 0x100), baseAddressHigh)";
        v32 = v16;
      ...
      sub_140011684(
        a1,
        (__int64)L"m_mmioAccessor->WriteRegisterSafe((0x02804 + (m_queueId) * 0x100), baseAddressHigh)",
        345,
        57,
        v13);
    }
    ...
    {
      *(_DWORD *)((unsigned int)((*(_DWORD *)(a1 + 360) << 8) + 10244) + v12) = v8;
      _InterlockedOr(v31, 0);
      v13 = 0;
    }
  }
