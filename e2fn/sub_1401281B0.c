__int64 __fastcall sub_1401281B0(__int64 a1, _QWORD *a2)
{
  char v3; // di
  __int64 v4; // rax
  __int64 v5; // r14
  ...
  v4 = (*(__int64 (__fastcall **)(__int64, __int64, void *))(qword_1400DF678 + 1616))(
         ...
         off_1400DF148);
  v5 = *(_QWORD *)v4;
  v6 = sub_140093400(*(_QWORD *)(*(_QWORD *)v4 + 544LL), a2);
  if ( !v6 )
    return 0LL;
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    sub_1400A5E80(
      *(_QWORD *)(*(_QWORD *)(v5 + 176) + 16LL),
      ...
      v7,
      v8,
      L"_this->m_receiveScaling->SetIndirectionEntries(indirectionEntries)");
    v3 = 3;
  }
  if ( (v3 & 2) != 0 )
  {
  ...
  sub_14000A2B0(v5, (__int64)L"_this->m_receiveScaling->SetIndirectionEntries(indirectionEntries)", 920, 100, v6);
  return v6;
}
