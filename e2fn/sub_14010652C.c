__int64 __fastcall sub_14010652C(__int64 a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400045E8(Pool2, (__int64)L"product_e2fn::ProductE2fnManageabilitySession::EvtD0EntryFromS0", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  if ( v6 )
  {
    ...
    sub_1400080F8(a1, (__int64)L"HandleD3ColdInS0Flow()", 99, 166, v6);
  }
  else
  {
    v6 = 0;
