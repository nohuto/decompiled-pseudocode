__int64 __fastcall sub_1400579E4(__int64 a1, int a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_14000BBDC(
             Pool2,
             (__int64)L"e1000_hardware::E1000HardwareReceiveControlRegister::E1000ConfigMulticastUnicastTableOffset",
             a1);
      if ( v7 )
        v4 = v7;
    }
  ...
  if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
  {
    ...
    if ( v10 )
      v9 = v10;
    v11 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)(a1 + 56) + 24LL))(a1 + 56, v26);
    v12 = &unk_1400D44E0;
  ...
  v16 = sub_14007E1AC(a1, 12288LL, (unsigned int)(a2 << 12));
  if ( v16 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      if ( v18 )
        v17 = v18;
      v19 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)(a1 + 56) + 24LL))(a1 + 56, v30);
      LOBYTE(v20) = 2;
      ...
      sub_1400A5E80(
        *(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL),
        ...
        (__int64)v8,
        (__int64)v17,
        (__int64)L"UpdateMaskedRegionSafe(0x00003000, offset)",
        v16);
    }
    if ( (v2 & 8) != 0 )
    {
    ...
    sub_14000946C(a1, (__int64)L"UpdateMaskedRegionSafe(0x00003000, offset)", 168, 121, v16);
  }
  else
  {
    v16 = 0;
