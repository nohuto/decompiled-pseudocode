void __fastcall sub_14009C200(_QWORD *a1, _QWORD *a2)
{
  char v2; // si
  __int64 *v4; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x400) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_140074D50(
             Pool2,
             (__int64)L"net_adapter::NetAdapterChecksumOffload::RegisterRxConfigurationChangedCallback",
             (__int64)(a1 - 44));
      if ( v7 )
        v4 = v7;
    }
  ...
  else
  {
    ...
    sub_140022128((_DWORD)a1 - 352, (__int64)L"callback", 301, 102);
    if ( v4 )
    {
      sub_140075108(v4);
      ExFreePool(v4);
