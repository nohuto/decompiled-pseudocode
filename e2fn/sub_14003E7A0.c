__int64 __fastcall sub_14003E7A0(__int64 a1)
{
  char v1; // si
  __int64 *v3; // r14
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400045E8(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwarePhy::AcquirePhyOwnership", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  v7 = (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(a1 + 360) + 120LL))(*(_QWORD *)(a1 + 360), 2LL);
  if ( v7 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A5E80(
        *(_QWORD *)(*(_QWORD *)(a1 + 176) + 16LL),
        ...
        (__int64)v8,
        (__int64)v9,
        (__int64)L"m_firmware->AcquireOwnership((1 << 1))",
        v7);
      v1 = 3;
    }
    if ( (v1 & 2) != 0 )
    ...
    sub_140009088(a1, (__int64)L"m_firmware->AcquireOwnership((1 << 1))", 449, 156, v7);
  }
  else
  {
    v7 = 0;
