__int64 __fastcall sub_14006A030(__int64 a1)
{
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 8) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14005B310(Pool2, (__int64)L"os_resources::SystemPower::EnableD3ColdInS0Idle", a1 - 352);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  v14 = sub_14006983C(a1 - 352, *(_DWORD *)(a1 + 272), 1u);
  if ( v14 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      sub_1400A5E80(
        *(_QWORD *)(*(_QWORD *)(a1 - 176) + 16LL),
        ...
        (__int64)v6,
        (__int64)v15,
        (__int64)L"AssignS0IdleSettings(m_idleTimeoutMs, true )",
        v14);
    }
    if ( (v1 & 8) != 0 )
    {
    ...
    sub_140021FDC(a1 - 352, (__int64)L"AssignS0IdleSettings(m_idleTimeoutMs, true )", 153, 148, v14);
  }
  else
  {
LABEL_42:
