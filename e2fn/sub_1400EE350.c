__int64 __fastcall sub_1400EE350(__int64 a1)
{
  char v1; // di
  __int64 *v3; // r12
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnHardwareAbstraction::EvtD0EntryFromSx", a1 - 352);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  if ( v6 )
  {
    ...
    sub_140007E60(a1 - 352, (__int64)L"m_phy->EvtD0Entry()", 490, 46, v6);
  }
  else
  {
    v13 = a1 - 352;
    ...
    if ( v6 )
    {
      ...
      sub_14000AD10(v13, (__int64)L"EvtD0Entry()", 492, 46, v6);
    }
    else
    {
      v6 = sub_1401015C4(*(_QWORD *)(a1 + 352));
      if ( v6 )
      {
        if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
        {
        ...
        sub_140008628(v13, (__int64)L"m_wolPatterns->EvtD0Entry()", 494, 46, v6);
      }
      else
      {
        ...
        if ( v6 )
        {
          ...
          sub_140008244(v13, (__int64)L"m_firmware->EvtD0Entry()", 497, 46, v6);
        }
        else
        {
          v6 = 0;
