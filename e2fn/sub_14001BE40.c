_QWORD *sub_14001BE40(__int64 a1, _QWORD *a2, unsigned int a3, __int64 *a4, ...)
{
  char v4; // r14
  __int64 *v6; // r15
  __int64 *v7; // rsi
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v11 = sub_14000BBDC(
              Pool2,
              (__int64)L"product_e2fn::ProductE2fnMsixInterruptsFactory::AllocateTxInterrupt",
              a1 - 352);
      if ( v11 )
        v6 = v11;
    }
  ...
  if ( v8 < 4 )
  {
    ...
    v96 = dword_1400D5968[v8];
    v95 = v96;
    LODWORD(v98) = 2 * v8 + 1;
    v64 = v63;
    v65 = 10;
    sub_1400042F0((__int64)v91, (int *)&v64);
    v27 = sub_140018CA0((__int64)&v71, (__int64)L"Tx Queue ", v91);
    v28 = sub_140018EB4((__int64)&v67, v27, (__int64)L" Interrupt Control");
    sub_1400A7708((unsigned int)&v61, 808465713, v19, v28, (__int64)&v95, (__int64)va);
    v67 = &off_1400D41D0;
    if ( P )
      ExFreePool(P);
    P = 0LL;
    ...
    else
    {
      ...
      sub_14000B294(a1 - 352, (__int64)L"interruptControl", 347, 65);
      *a2 = 0LL;
      a2[1] = 0LL;
    }
    if ( v62 )
