__int64 __fastcall sub_14004F970(__int64 a1, unsigned int a2)
{
  char v2; // bp
  __int64 *v4; // r14
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x200) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v7 = sub_14000BBDC(Pool2, (__int64)L"product_e2fn::ProductE2fnInterruptCauseRegister::EnableCause", a1 - 352);
      if ( v7 )
        v4 = v7;
    }
  }
  _InterlockedOr((volatile signed __int32 *)(a1 + 36), 1 << a2);
  v8 = *(_QWORD *)(a1 + 16);
  v9 = *(_QWORD *)(v8 + 8);
  if ( !v9 || *(_DWORD *)(v8 + 20) )
  {
