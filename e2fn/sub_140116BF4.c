__int64 __fastcall sub_140116BF4(__int64 a1)
{
  char v2; // di
  __int64 *v3; // r14
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 4u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_140073750(Pool2, (__int64)L"framework::DeviceContext::EvtDeviceArmWakeFromS0", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  v21 = 0LL;
  v22 = 0LL;
  sub_1400011A8(&v18, (__int64)L"Arm wake from S0", 0x10uLL);
  ...
  if ( v6 )
  {
    ...
    sub_140009088(a1, (__int64)L"m_netAdapter->EvtDeviceArmWakeFromSx()", 743, 74, v6);
  }
  else
  {
    v6 = 0;
