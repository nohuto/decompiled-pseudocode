void __fastcall sub_14014C534(__int64 a1, _BYTE *a2)
{
  __int64 *v4; // rbx
  _QWORD *Pool2; // rax
  __int64 *v6; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v6 = sub_1400736C0(Pool2, (__int64)L"framework::WolPatternsEventViewerLogger::PostArmWakeFromS5Event", a1);
      if ( v6 )
        v4 = v6;
    }
  }
  if ( *(_BYTE *)(a1 + 696) )
  {
    ...
    v10 = &off_1400D41D0;
    v14 = 0LL;
    if ( &v10 != (__int64 (__fastcall ***)(PVOID))(a1 + 400) )
      sub_1400011A8(&v10, *(_QWORD *)(a1 + 416), *(_QWORD *)(a1 + 424));
