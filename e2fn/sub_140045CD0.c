__int64 __fastcall sub_140045CD0(_QWORD *a1)
{
  char v1; // di
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x2000) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400045E8(
             Pool2,
             (__int64)L"product_e2fn::ProductE2fnHardwareMacAddress::ClearReceiveAddressTable",
             (__int64)a1);
      if ( v5 )
        v3 = v5;
    }
  ...
  if ( !*(_QWORD *)(v6 + 8) || *(_DWORD *)(v6 + 20) )
  {
    ...
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
      ...
      v22 = v9;
      v21 = L"m_mmioAccessor->ClearRegistersRangeSafe((0x05400 + (0) * 8), receiveAddressTableSize)";
      LOBYTE(v14) = 2;
      v20 = (__int64)v11;
    ...
    sub_14003E3A4(
      (int)a1,
      (__int64)L"m_mmioAccessor->ClearRegistersRangeSafe((0x05400 + (0) * 8), receiveAddressTableSize)",
      165,
      158,
      v9);
  }
