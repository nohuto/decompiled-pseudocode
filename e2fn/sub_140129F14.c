__int64 __fastcall sub_140129F14(__int64 a1)
{
  char v1; // si
  __int64 *v3; // rbp
  _QWORD *Pool2; // rax
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 0x80u) != 0 && BYTE1(DeviceObject->Timer) >= 8u )
  {
    ...
    if ( Pool2 )
    {
      v5 = sub_1400736C0(Pool2, (__int64)L"framework::DeviceD0ExitFlows::D0ExitToS5", a1);
      if ( v5 )
        v3 = v5;
    }
  }
  ...
  v14 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 416) + 80LL))(*(_QWORD *)(a1 + 416));
  if ( v14 )
  {
    if ( off_1400DF038 != (_UNKNOWN *)&off_1400DF038 )
    {
    ...
    sub_1400088C0(a1, (__int64)L"m_netAdapter->EvtD0ExitToS5()", 236, 77, v14);
  }
  else
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 400) + 184LL))(*(_QWORD *)(a1 + 400));
