/*
 * XREFs of HUBPDO_CreatePdoInternal @ 0x1C007DE24
 * Callers:
 *     HUBPDO_CreatePdo @ 0x1C007F0F0 (HUBPDO_CreatePdo.c)
 *     HUBPDO_CreateUnknownPdo @ 0x1C007F1B4 (HUBPDO_CreateUnknownPdo.c)
 * Callees:
...
LABEL_39:
  if ( a2 )
  {
    if ( (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 0x40) != 0 )
    {
  ...
  else if ( SLOBYTE(WPP_MAIN_CB.Queue.Wcb.NumberOfChannels) < 0 )
  {
    RemlockSize[0] = v11;
