/*
 * XREFs of HUBDTX_GetBOSDescriptorUsingControlTransfer @ 0x1C002AC5C
 * Callers:
 *     HUBDSM_GettingAlternateBOSDescriptor @ 0x1C0022520 (HUBDSM_GettingAlternateBOSDescriptor.c)
 * Callees:
