/*
 * XREFs of HUBDTX_ClearEndpointHaltUsingControlTransfer @ 0x1C002C6E8
 * Callers:
 *     HUBDSM_ClearingEndpointHaltOnClientResetPipe @ 0x1C001F1E0 (HUBDSM_ClearingEndpointHaltOnClientResetPipe.c)
 * Callees:
