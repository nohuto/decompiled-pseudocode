/*
 * XREFs of HUBUCX_NotifyDeviceResetUsingUCXIoctl @ 0x1C00265F8
 * Callers:
 *     HUBDSM_NotifyingDeviceResetToUCXAfterReset2 @ 0x1C0020B70 (HUBDSM_NotifyingDeviceResetToUCXAfterReset2.c)
 * Callees:
