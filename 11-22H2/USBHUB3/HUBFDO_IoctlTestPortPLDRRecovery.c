/*
 * XREFs of HUBFDO_IoctlTestPortPLDRRecovery @ 0x1C007AFE4
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlTestPortPLDRRecovery(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  ...
  _DWORD *v20; // [rsp+50h] [rbp-10h] BYREF
  __int64 SystemInformation; // [rsp+58h] [rbp-8h] BYREF
  ULONG ReturnLength; // [rsp+A8h] [rbp+48h] BYREF
      ...
      && (SystemInformation & 0x200000000LL) != 0 )
    {
      if ( a3 >= 4 )
      {
        ...
        if ( v7 >= 0 )
        {
          ...
          if ( v6 + 2360 == v8 )
            goto LABEL_20;
          while ( *(unsigned __int16 *)(v9 + 200) != *v20 )
          {
            v10 = *(_QWORD *)(v9 + 248);
            v9 = v10 - 248;
            if ( v6 + 2360 == v10 )
...
LABEL_20:
          ...
          else
          {
            ...
            if ( v14 )
            {
              ...
              {
                if ( (unsigned __int8)HUBREG_IsPortPLDRCapable(v6, *(unsigned __int16 *)v20) )
                {
                  *(_BYTE *)(v9 + 1472) = 1;
                  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                  {
                    LODWORD(v19) = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(v16 + 24) + 8LL) + 200LL);
                    LODWORD(v18) = *(_DWORD *)(v6 + 96);
                    WPP_RECORDER_SF_dD(
                      *(_QWORD *)(v6 + 2520),
                      4u,
                      3u,
