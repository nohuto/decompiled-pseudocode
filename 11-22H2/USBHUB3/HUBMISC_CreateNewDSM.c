/*
 * XREFs of HUBMISC_CreateNewDSM @ 0x1C00311F8
 * Callers:
 *     HUBPSM30_CreatingDeviceInConnectedWithResetInProgress @ 0x1C0011AE0 (HUBPSM30_CreatingDeviceInConnectedWithResetInProgress.c)
 * Callees:
