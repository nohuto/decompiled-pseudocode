/*
 * XREFs of HUBDTX_GetBOSDescriptorHeaderUsingControlTransfer @ 0x1C002B424
 * Callers:
 *     HUBDSM_GettingBOSDescriptorHeader @ 0x1C0022550 (HUBDSM_GettingBOSDescriptorHeader.c)
 * Callees:
