/*
 * XREFs of HUBDTX_ValidateAndCacheProductIdStringDescriptor @ 0x1C002CA04
 * Callers:
 *     HUBDSM_ValidatingLanguageSpecificProductIdString @ 0x1C0020720 (HUBDSM_ValidatingLanguageSpecificProductIdString.c)
 * Callees:
