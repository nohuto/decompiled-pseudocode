/*
 * XREFs of McTemplateK0ppp_EtwWriteTransfer @ 0x1C0040BE8
 * Callers:
...
NTSTATUS McTemplateK0ppp_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 8LL;
  va_copy(v9, va2);
  return McGenEventWrite_EtwWriteTransfer(a1, &USBHUB3_ETW_EVENT_HUB_OPENED_USB4_REMOTE_TARGET, 0LL, 4u, &v4);
}
