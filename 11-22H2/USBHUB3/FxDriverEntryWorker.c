/*
 * XREFs of FxDriverEntryWorker @ 0x1C0040F54
 * Callers:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_1C006CA40;
...
LABEL_10:
    ...
    if ( v7 < 0 )
    {
      ...
      if ( off_1C006C948 != &__KMDF_CLASS_BIND_START )
      {
        memset(v11, 0, 12);
    ...
    {
      DriverUnload = qword_1C006CC48;
      if ( DriverObject->DriverUnload )
        DriverUnload = (__int64 (*)(void))DriverObject->DriverUnload;
      qword_1C006CC48 = DriverUnload;
