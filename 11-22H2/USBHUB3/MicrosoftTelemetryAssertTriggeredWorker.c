/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C0041514
 * Callers:
...
LABEL_56:
  ...
  v24 = -1LL;
  v25 = "<unknown>";
  if ( (unsigned int)dword_1C0073040 > 5
    && (qword_1C0073050 & 0x400000000000LL) != 0
    && (qword_1C0073058 & 0x400000000000LL) == qword_1C0073058 )
  {
    v46 = 10;
    v51 = &v46;
    v52 = 4LL;
  ...
  if ( dword_1C0073078 && !v43 && !KeGetCurrentIrql() )
  {
