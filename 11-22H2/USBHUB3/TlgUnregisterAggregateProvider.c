/*
 * XREFs of TlgUnregisterAggregateProvider @ 0x1C008F720
 * Callers:
...
void TlgUnregisterAggregateProvider()
{
  ...
  if ( (void (__fastcall *)(const struct _GUID *, __int64, char, __int64, unsigned __int64, struct _EVENT_FILTER_DESCRIPTOR *, _QWORD *))qword_1C0069220 == TlgAggregateInternalRegisteredProviderEtwCallback )
  {
    v1 = 0LL;
