/*
 * XREFs of HUBDTX_LogAlternateMode @ 0x1C002D024
 * Callers:
 *     HUBDSM_CheckingIfAlternateModeStringDescriptorShouldBeQueried @ 0x1C0022210 (HUBDSM_CheckingIfAlternateModeStringDescriptorShouldBeQueried.c)
...
int __fastcall HUBDTX_LogAlternateMode(__int64 a1, _BYTE *a2)
{
  ...
  if ( v7 == 3 )
  {
    *((_BYTE *)v2 + 10) = 1;
    ...
    if ( (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 0x1000000) != 0 )
    {
      LOBYTE(v14) = 3;
