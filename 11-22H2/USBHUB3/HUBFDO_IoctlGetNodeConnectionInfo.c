/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionInfo @ 0x1C000E3BC
 * Callers:
...
LABEL_10:
  ...
  if ( a5 == 1 )
  {
    ...
    *(_OWORD *)SpinLock = 0LL;
    ...
    v37 = *(_QWORD *)&WPP_MAIN_CB.AlignmentRequirement
        ? (*(__int64 (__fastcall **)(__int64, PKSPIN_LOCK *))&WPP_MAIN_CB.AlignmentRequirement)(v36, SpinLock)
        : -1073741275;
    if ( (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 0x400) == 0 )
      return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2104))(
               WdfDriverGlobals,
  ...
  else
  {
    ...
    *(_OWORD *)SpinLock = 0LL;
    v36 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2280))(WdfDriverGlobals, a2);
    v40 = *(_QWORD *)&WPP_MAIN_CB.AlignmentRequirement
        ? (*(__int64 (__fastcall **)(__int64, PKSPIN_LOCK *))&WPP_MAIN_CB.AlignmentRequirement)(v36, SpinLock)
        : -1073741275;
    if ( (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 0x400) == 0 )
      return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2104))(
