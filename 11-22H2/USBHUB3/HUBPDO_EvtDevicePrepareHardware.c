/*
 * XREFs of HUBPDO_EvtDevicePrepareHardware @ 0x1C007BF50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_29:
    ...
    *(_OWORD *)Src = 0LL;
    ...
    if ( (*(int (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD, _QWORD, __int128 *, __int64 *))(WdfFunctions_01015 + 656))(
      ...
      v74 = (const wchar_t *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 1552))(
                               ...
                               0LL);
    v21 = *(_QWORD *)(v2 + 16);
    if ( (WPP_MAIN_CB.Queue.Wcb.NumberOfChannels & 8) != 0 )
    {
      v22 = v3[1];
      v81 = v22;
                ...
                + 92) )
  {
    ...
    v10 = *(_QWORD *)(v60 + 96);
    if ( !qword_1C006CD08 || (v47 = qword_1C006CD08(v10, v46, v43, v2 + 392), v47 == -1073741637) )
    {
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1C00691F8 > 4 )
    {
      if ( (qword_1C0069208 & 0x400000000001LL) != 0 && (qword_1C0069210 & 0x400000000001LL) == qword_1C0069210 )
      {
        v60 = 16779264LL;
        v97 = &v60;
      ...
      if ( v49 > 4 && (qword_1C0069208 & 0x400000000001LL) != 0 && (v10 & 0x400000000001LL) == v10 )
      {
        v60 = 16779264LL;
        v86 = &v60;
        LOWORD(v58) = *((_WORD *)v3 + 998);
        ...
        *(_WORD *)v57 = 6;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_1C00691F8,
          (unsigned __int8 *)dword_1C00659E6,
          (const GUID *)(v48 + 1480),
          0LL,
          7u,
          &v85);
