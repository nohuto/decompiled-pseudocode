/*
 * XREFs of HUBDTX_ValidateAndCacheConfigDescriptor @ 0x1C002B87C
 * Callers:
 *     HUBDSM_ValidatingAlternateConfigurationDescriptor @ 0x1C0021390 (HUBDSM_ValidatingAlternateConfigurationDescriptor.c)
 * Callees:
