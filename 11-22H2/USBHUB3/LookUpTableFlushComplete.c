/*
 * XREFs of LookUpTableFlushComplete @ 0x1C008F078
 * Callers:
 ...
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C008F470 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
...
__int64 __fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    *(_QWORD *)(a1 + 288) = v9;
    if ( !v8 )
    {
      if ( (unsigned int)dword_1C006C840 > 5
        && (qword_1C006C850 & 0x200000000000LL) != 0
        && (qword_1C006C858 & 0x200000000000LL) == qword_1C006C858 )
      {
        v10 = *(_QWORD *)(a1 + 344);
        v52 = 32;
        v11 = *(_QWORD *)(v10 + 8);
