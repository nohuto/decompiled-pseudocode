/*
 * XREFs of HUBUCX_AcquireAddress0OwnershipUsingUCXIoctl @ 0x1C0026544
 * Callers:
 *     HUBDSM_AcquiringAddressZeroOwnershipOnRenum @ 0x1C0020740 (HUBDSM_AcquiringAddressZeroOwnershipOnRenum.c)
 * Callees:
