/*
 * XREFs of __report_gsfailure @ 0x180005620
 * Callers:
 *     __security_check_cookie @ 0x180004F10 (__security_check_cookie.c)
 * Callees:
 *     __raise_securityfailure @ 0x1800055DC (__raise_securityfailure.c)
 *     capture_previous_context @ 0x1800056F8 (capture_previous_context.c)
 */
