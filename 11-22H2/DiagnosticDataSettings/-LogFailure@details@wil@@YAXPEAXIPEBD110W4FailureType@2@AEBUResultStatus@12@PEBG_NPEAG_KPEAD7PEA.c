/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEBG_NPEAG_KPEAD7PEAUFailureInfo@2@@Z @ 0x1800040A0
 * Callers:
 ...
 * Callees:
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x180001070 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x180003B4C (-RecordException@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x180003D20 (-RecordLog@details@wil@@YAHJ@Z.c)
        ...
        unsigned __int64 a15)
{
  ...
  *(_DWORD *)(a15 + 12) = *(_DWORD *)(a8 + 4);
  if ( a7 )
  {
    ...
    {
      case 1:
        v19 = wil::details::RecordReturn((wil::details *)v18);
        break;
      case 2:
        if ( (v18 & 0x80000000) == 0 )
        {
        ...
        v19 = wil::details::RecordLog((wil::details *)v18);
        break;
      case 3:
  ...
  {
    v19 = wil::details::RecordException((wil::details *)v18);
  }
  v17 = v19;
LABEL_12:
  *(_DWORD *)a15 = a7;
