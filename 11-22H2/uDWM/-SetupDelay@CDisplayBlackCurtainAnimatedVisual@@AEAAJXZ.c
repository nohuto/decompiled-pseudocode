/*
 * XREFs of ?SetupDelay@CDisplayBlackCurtainAnimatedVisual@@AEAAJXZ @ 0x1800BDC24
 * Callers:
...
__int64 __fastcall CDisplayBlackCurtainAnimatedVisual::SetupDelay(CDisplayBlackCurtainAnimatedVisual *this)
{
  __int64 v2; // rax
  _QWORD *v3; // r8
  _QWORD *v4; // rcx
  ...
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=((__int64 *)this + 55, (__int64)v3);
  if ( !*v4 )
  {
    v5 = -2147024882;
    v6 = 126LL;
