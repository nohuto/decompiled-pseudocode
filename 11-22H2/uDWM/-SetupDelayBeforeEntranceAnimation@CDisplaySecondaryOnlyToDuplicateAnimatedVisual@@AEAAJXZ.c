/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@AEAAJXZ @ 0x1800BE91C
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@EEAAJI@Z @ 0x1800BE7F0 (-OnAnimationCompleteImpl@CDisplaySecondaryOnlyToDuplicateAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
        ...
        CDisplaySecondaryOnlyToDuplicateAnimatedVisual *this)
{
  ...
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=((__int64 *)this + 56, (__int64)v3);
  if ( !*v4 )
  {
    v5 = -2147024882;
    v6 = 189LL;
