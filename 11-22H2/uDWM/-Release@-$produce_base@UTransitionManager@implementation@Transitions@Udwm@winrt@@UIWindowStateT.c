/*
 * XREFs of ?Release@?$produce_base@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIWindowStateTransitionManager@Private@345@X@impl@winrt@@UEAAIXZ @ 0x1800FEDE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
