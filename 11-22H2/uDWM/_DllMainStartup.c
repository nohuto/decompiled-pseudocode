/*
 * XREFs of _DllMainStartup @ 0x1800536D0
 * Callers:
 *     <none>
 * Callees:
 *     AvCreateProcessHeap @ 0x18005375C (AvCreateProcessHeap.c)
 *     _DllMainCRTStartup @ 0x18005E404 (_DllMainCRTStartup.c)
 *     AvDestroyProcessHeap @ 0x18010DBBC (AvDestroyProcessHeap.c)
 */
