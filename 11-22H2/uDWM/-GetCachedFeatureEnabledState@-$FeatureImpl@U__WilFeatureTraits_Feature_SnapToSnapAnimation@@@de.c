/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SnapToSnapAnimation@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18004C66C
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SnapToSnapAnimation@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18004C794 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_SnapToSnapAnimation@@@d.c)
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_SnapToSnapAnimation>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_SnapToSnapAnimation>::GetCurrentFeatureEnabledState(
      a1,
      &v14,
      &v13);
    v7 = v6 != 0 ? v13 : 0;
