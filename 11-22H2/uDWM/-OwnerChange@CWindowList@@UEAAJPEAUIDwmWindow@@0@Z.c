/*
 * XREFs of ?OwnerChange@CWindowList@@UEAAJPEAUIDwmWindow@@0@Z @ 0x180030330
 * Callers:
 *     <none>
 * Callees:
...
LABEL_94:
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v25, 0x1195u, 0LL);
              goto LABEL_9;
            }
            v12 = v19;
            v54 = 192;
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x1190u, 0LL);
          goto LABEL_9;
        }
        v35 = *(_QWORD *)(v13 + 496);
        ...
        if ( v53 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v53, 0x1183u, 0LL);
          goto LABEL_9;
        }
LABEL_13:
        v14 = v66;
