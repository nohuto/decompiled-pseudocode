/*
 * XREFs of ?GenerateMesh@CTetherVisual@@IEAAJPEAUMesh2D@@@Z @ 0x1800E3998
 * Callers:
...
LABEL_11:
  ...
  while ( 1 )
  {
    ...
    if ( v27 > *((_DWORD *)a2 + 21) )
    {
      v28 = DynArrayImpl<0>::AddMultipleAndSet((__int64)a2 + 64, 4, 1, v26);
      v22 = v28;
      if ( v28 < 0 )
      {
        v29 = 192;
...
LABEL_23:
  ...
  v31 = 195;
LABEL_24:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v23, v31);
  return v22;
}
