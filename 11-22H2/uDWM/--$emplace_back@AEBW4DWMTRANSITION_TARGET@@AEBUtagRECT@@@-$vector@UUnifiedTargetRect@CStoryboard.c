/*
 * XREFs of ??$emplace_back@AEBW4DWMTRANSITION_TARGET@@AEBUtagRECT@@@?$vector@UUnifiedTargetRect@CStoryboard@@V?$allocator@UUnifiedTargetRect@CStoryboard@@@std@@@std@@QEAA?A_TAEBW4DWMTRANSITION_TARGET@@AEBUtagRECT@@@Z @ 0x1800D94F0
 * Callers:
