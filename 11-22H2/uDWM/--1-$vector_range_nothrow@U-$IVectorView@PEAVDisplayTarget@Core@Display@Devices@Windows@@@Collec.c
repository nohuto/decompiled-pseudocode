/*
 * XREFs of ??1?$vector_range_nothrow@U?$IVectorView@PEAVDisplayTarget@Core@Display@Devices@Windows@@@Collections@Foundation@Windows@@@wil@@QEAA@XZ @ 0x1800A4C04
 * Callers:
 *     _CAnalogCompositorManager::OnMonitorChangedNotification_::_1_::dtor$2 @ 0x1800A5FA5 (_CAnalogCompositorManager--OnMonitorChangedNotification_--_1_--dtor$2.c)
 * Callees:
 *     <none>
 */
