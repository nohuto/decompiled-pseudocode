/*
 * XREFs of ?OnMagnifierCreate@CMagnifierControl@@AEAAJPEAUHWND__@@H@Z @ 0x1800CBA14
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierCreate(struct CVisual **this, HWND a2, int a3)
{
  ...
  {
    v8 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, -2147024809, 0x265u);
    return v8;
  }
...
LABEL_4:
    v9 = IsMagnifier;
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v9, v16);
    goto LABEL_17;
  }
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, -2147024882, 0x25Fu);
