/*
 * XREFs of ?InitDXGI@CDWMDXGIEnumeration@@AEAAJXZ @ 0x18003C8D4
 * Callers:
...
LABEL_45:
    v14 = v3;
LABEL_47:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F820, 1u, v14, v16, 0LL);
    goto LABEL_30;
  }
  while ( (*(unsigned int (__fastcall **)(void *, _QWORD, __int64 *))(*(_QWORD *)ppFactory + 96LL))(ppFactory, v2, &v24) != -2005270526 )
  {
    ...
    {
      v7 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 56, 8, 1, &v17);
      v4 = v7;
      if ( v7 < 0 )
      {
        v15 = 192;
LABEL_53:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F820, 1u, v7, 0x11Eu, 0LL);
        goto LABEL_30;
      }
    }
    else
