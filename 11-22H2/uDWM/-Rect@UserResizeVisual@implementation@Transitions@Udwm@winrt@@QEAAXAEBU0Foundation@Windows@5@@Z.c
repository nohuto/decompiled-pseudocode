/*
 * XREFs of ?Rect@UserResizeVisual@implementation@Transitions@Udwm@winrt@@QEAAXAEBU0Foundation@Windows@5@@Z @ 0x1801048DC
 * Callers:
 ...
 *     ?put_Rect@?$produce@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@345@@impl@winrt@@UEAAHURect@Foundation@Windows@3@@Z @ 0x180105130 (-put_Rect@-$produce@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@.c)
 * Callees:
 ...
 *     ?WFRectToDpiScaledMarginRect@Utils@Private@Transitions@Udwm@winrt@@YA?AUtagRECT@@URect@Foundation@Windows@5@@Z @ 0x180104DA4 (-WFRectToDpiScaledMarginRect@Utils@Private@Transitions@Udwm@winrt@@YA-AUtagRECT@@URect@Foundatio.c)
 */
