/*
 * XREFs of ?Initialize@CTransitionWindowSnapshot@@MEAAJPEAVCTopLevelWindow@@PEAVCVisual@@PEBUtagRECT@@@Z @ 0x18000E6C0
 * Callers:
        ...
        const struct tagRECT *a4)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129FC8, 1u, v8, 0x57u, 0LL);
    return v9;
  }
...
LABEL_19:
  v17 = v10;
LABEL_21:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129FC8, 1u, v17, v18, 0LL);
LABEL_13:
  if ( v19 )
