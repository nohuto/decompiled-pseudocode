/*
 * XREFs of ?_Tidy@?$list@V?$weak_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@V?$allocator@V?$weak_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@@2@@std@@AEAAXXZ @ 0x18005C1B4
 * Callers:
 *     _dynamic_atexit_destructor_for__CWindowBorder::CCachedBorderBrush::s_cache__ @ 0x1800691B0 (_dynamic_atexit_destructor_for__CWindowBorder--CCachedBorderBrush--s_cache__.c)
 * Callees:
