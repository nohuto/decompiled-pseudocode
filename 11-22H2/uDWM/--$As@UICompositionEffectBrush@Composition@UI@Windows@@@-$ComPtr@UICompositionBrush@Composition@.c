/*
 * XREFs of ??$As@UICompositionEffectBrush@Composition@UI@Windows@@@?$ComPtr@UICompositionBrush@Composition@UI@Windows@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UICompositionEffectBrush@Composition@UI@Windows@@@WRL@Microsoft@@@Details@12@@Z @ 0x18009EAF0
 * Callers:
