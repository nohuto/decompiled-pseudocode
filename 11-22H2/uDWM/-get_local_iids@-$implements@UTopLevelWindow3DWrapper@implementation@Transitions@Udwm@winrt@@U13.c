/*
 * XREFs of ?get_local_iids@?$implements@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@U1345@UITransitionAnimationVisualNative@34@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x180059840
 * Callers:
 *     <none>
 * Callees:
 *     <none>
