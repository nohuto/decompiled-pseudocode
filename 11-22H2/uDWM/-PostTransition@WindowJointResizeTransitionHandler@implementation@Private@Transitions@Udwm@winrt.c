/*
 * XREFs of ?PostTransition@WindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@QEAAXXZ @ 0x1800F9908
 * Callers:
 *     ?PostTransition@?$produce@UWindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@@impl@winrt@@UEAAHXZ @ 0x1800F98B0 (-PostTransition@-$produce@UWindowJointResizeTransitionHandler@implementation@Private@Transitions.c)
 * Callees:
