/*
 * XREFs of ??1CDisplayMixedModeAnimatedVisual@@MEAA@XZ @ 0x1800BBDA0
 * Callers:
        ...
        CDisplayMixedModeAnimatedVisual *this)
{
  ...
  *((_QWORD *)this + 36) = &CDisplayExtendToDuplicateAnimatedVisual::`vftable'{for `IAnimationListener'};
  ...
  if ( v6 )
  {
    std::_Deallocate<16,0>(v6, (*((_QWORD *)this + 63) - (_QWORD)v6) & 0xFFFFFFFFFFFFFFF0uLL);
    *((_QWORD *)this + 61) = 0LL;
    *((_QWORD *)this + 62) = 0LL;
    *((_QWORD *)this + 63) = 0LL;
  }
  ...
  if ( v8 )
  {
    ...
    std::_Deallocate<16,0>(
      *((void **)this + 55),
      (*((_QWORD *)this + 57) - *((_QWORD *)this + 55)) & 0xFFFFFFFFFFFFFFF8uLL);
    *((_QWORD *)this + 55) = 0LL;
    *((_QWORD *)this + 56) = 0LL;
    *((_QWORD *)this + 57) = 0LL;
  }
