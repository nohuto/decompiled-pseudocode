/*
 * XREFs of ?UpdateThumbnailsForNewWindow@CWindowList@@AEAAJPEAVCWindowData@@@Z @ 0x18002FF74
 * Callers:
  ...
  if ( *((_DWORD *)a2 + 140) )
  {
    while ( 1 )
    {
      ...
      else
      {
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x1A32u, 0LL);
          return v2;
        }
      }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x1A27u, 0LL);
  }
  else
  {
LABEL_2:
