/*
 * XREFs of ?_FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x18009B688
 * Callers:
 ...
 *     ?UpdateFloatProperties@?$produce@UWindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@@impl@winrt@@UEAAHPEAX@Z @ 0x1800F8760 (-UpdateFloatProperties@-$produce@UWindowMaximizeSnapTransitionHandler@implementation@Private@Tra.c)
 *     ?UpdateScene@?$produce@UWindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@@impl@winrt@@UEAAHXZ @ 0x1800F8790 (-UpdateScene@-$produce@UWindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@U.c)
 *     ?UpdateScene@?$produce@UWindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@@impl@winrt@@UEAAHXZ @ 0x1800FA3A0 (-UpdateScene@-$produce@UWindowJointResizeTransitionHandler@implementation@Private@Transitions@Ud.c)
 * Callees:
