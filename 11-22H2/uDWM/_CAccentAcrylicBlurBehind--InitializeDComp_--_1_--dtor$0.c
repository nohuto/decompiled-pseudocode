/*
 * XREFs of _CAccentAcrylicBlurBehind::InitializeDComp_::_1_::dtor$0 @ 0x1800A107D
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
int __fastcall CAccentAcrylicBlurBehind::InitializeDComp_::_1_::dtor_0(__int64 a1, __int64 a2)
{
