/*
 * XREFs of ?CreateRootVisual@CWindowList@@AEAAJXZ @ 0x180057BF4
 * Callers:
...
__int64 __fastcall CWindowList::CreateRootVisual(struct CVisual **this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0x6FDu, 0LL);
  }
  else
  {
    v4 = *v1;
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x700u, 0LL);
    }
    else
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x709u, 0LL);
      }
      else
      {
        ...
        v3 = v7;
        if ( v7 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x70Bu, 0LL);
      }
    }
  }
  return v3;
