/*
 * XREFs of ?get@?$static_lazy@VUDwmTrace@@@details@wil@@QEAAPEAVUDwmTrace@@P6AXXZ@Z @ 0x1800A66B4
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<UDwmTrace>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  if ( InitOnceBeginInitialize(&`UDwmTrace::Instance'::`2'::wrapper, 0, (PBOOL)&v8, (LPVOID *)&v9) && (_DWORD)v8 )
  {
    ...
    v9 = &qword_18014BCA0;
    qword_18014BCA0 = (__int64)&WindowFrameLogging::`vftable';
    qword_18014BCB8 = (__int64)&`UDwmTrace::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
