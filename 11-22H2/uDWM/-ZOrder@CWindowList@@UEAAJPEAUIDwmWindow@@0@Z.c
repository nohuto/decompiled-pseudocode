/*
 * XREFs of ?ZOrder@CWindowList@@UEAAJPEAUIDwmWindow@@0@Z @ 0x180029FC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_111:
      v9 = v7;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0xE4Bu, 0LL);
      goto LABEL_58;
    }
    *((_QWORD *)v73 + 3) = a2;
    ...
    *((_QWORD *)v8 + 5) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 24LL))(a2);
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x888u, 0LL);
      goto LABEL_111;
    }
  }
  v112 = v8;
  ...
  {
    v9 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024890, 0xE4Du, 0LL);
    goto LABEL_58;
  }
  v10 = *((_QWORD *)v8 + 17);
  ...
  {
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xE50u, 0LL);
    goto LABEL_58;
  }
  ...
  if ( a3 )
  {
    ...
    if ( !v14 && (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a3 + 16LL))(a3) )
    {
      ...
      *((_QWORD *)v14 + 5) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a3 + 24LL))(a3);
      ...
      if ( v76 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v76, 0x888u, 0LL);
        goto LABEL_120;
      }
    }
    v9 = v15;
    ...
    {
LABEL_120:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0xE58u, 0LL);
      goto LABEL_58;
    }
    if ( !v14 )
    {
      v9 = -2147024890;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024890, 0xE5Bu, 0LL);
      goto LABEL_58;
    }
  }
...
LABEL_72:
    ...
    wil::details::in1diag3::Return_Hr(
      ...
      v92);
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0xE69u, 0LL);
    goto LABEL_58;
  }
LABEL_16:
  v20 = v112;
...
LABEL_180:
      wil::details::in1diag3::Return_Hr(
        ...
        (const char *)v82,
        v92);
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0xE70u, 0LL);
      goto LABEL_58;
    }
LABEL_46:
    v20 = v112;
  ...
  if ( (unsigned int)(v45 - 1) <= 1 || (unsigned int)(v45 - 4) <= 0xE )
  {
    ...
    if ( *((_QWORD *)v68 + 3) )
    {
      ...
      if ( v70 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v70, 0x2ADu, 0LL);
        goto LABEL_183;
      }
      v20 = v112;
    }
  ...
  {
LABEL_183:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v44, 0xE74u, 0LL);
    goto LABEL_58;
  }
  if ( v20 == *((CWindowData **)this + 88) && *((_QWORD *)this + 68) )
  {
    ...
    if ( v88 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v88, 0xE79u, 0LL);
      goto LABEL_58;
    }
    v20 = v112;
  }
  ...
  if ( v46 )
  {
    ...
    if ( v89 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v89, 0xE7Fu, 0LL);
      goto LABEL_58;
    }
    v20 = v112;
  }
  ...
  if ( v47 && (*(_BYTE *)(v47 + 249) & 0x10) != 0 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ProjectedShadowSceneForDesktop, 0xE86u, 0LL);
      Microsoft::WRL::ComPtr<CAtlasedImage>::InternalRelease(&v93);
      goto LABEL_58;
    }
    v91 = v93;
