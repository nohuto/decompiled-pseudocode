/*
 * XREFs of ??1JSONOutputArchive@cereal@@UEAA@XZ @ 0x1800F167C
 * Callers:
 ...
 *     _tip::details::test_common_data_0_::data_::_1_::dtor$1 @ 0x1800F2DE6 (_tip--details--test_common_data_0_--data_--_1_--dtor$1.c)
 * Callees:
 *     _guard_xfg_dispatch_icall_nop @ 0x1800663A0 (_guard_xfg_dispatch_icall_nop.c)
 *     ??1?$deque@W4NodeType@JSONOutputArchive@cereal@@V?$allocator@W4NodeType@JSONOutputArchive@cereal@@@std@@@std@@QEAA@XZ @ 0x1800F1244 (--1-$deque@W4NodeType@JSONOutputArchive@cereal@@V-$allocator@W4NodeType@JSONOutputArchive@cereal.c)
