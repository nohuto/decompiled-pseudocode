/*
 * XREFs of ?GetSurfaceFromExistingAnimationComponent@CTransitionVisualController@@QEAAJPEAVCAnimationComponent@@PEBUtagRECT@@_NPEAPEAVCImageLegacyMilBrushProxy@@PEAPEAVCCachedVisualImageProxy@@PEA_NPEAUMilPoint3F@@@Z @ 0x18000C5BC
 * Callers:
    ...
    if ( v17 && !*(_BYTE *)(v17 + 975) && !*(_BYTE *)(v15 + 74) )
    {
      ...
      if ( v18 == *(_DWORD *)(v17 + 952) )
      {
        ...
        if ( v19 == HIDWORD(*(_QWORD *)(v17 + 952)) )
        {
          ...
          if ( v21 || (v21 = *(volatile signed __int32 **)(v17 + 592)) != 0LL )
