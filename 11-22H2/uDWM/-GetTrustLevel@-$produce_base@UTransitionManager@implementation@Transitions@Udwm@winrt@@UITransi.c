/*
 * XREFs of ?GetTrustLevel@?$produce_base@UTransitionManager@implementation@Transitions@Udwm@winrt@@UITransitionManager@345@X@impl@winrt@@UEAAHPEAW4TrustLevel@Foundation@Windows@3@@Z @ 0x1800FDB70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
