/*
 * XREFs of ?Create@CDesktopWindowReplacement@@SAJPEAPEAV1@@Z @ 0x18003EF8C
 * Callers:
...
__int64 __fastcall CDesktopWindowReplacement::Create(struct CDesktopWindowReplacement **a1)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x417u, 0LL);
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x417u, 0LL);
  *a1 = 0LL;
  if ( v3 )
