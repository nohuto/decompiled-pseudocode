/*
 * XREFs of ?GetNCAreaHelper@CTopLevelWindow@@CAJPEAXPEBH1PEAUWindowFrame@1@2@Z @ 0x18003AE14
 * Callers:
 ...
 *     ?SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z @ 0x18003B564 (-SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z.c)
        ...
        struct CTopLevelWindow::WindowFrame *a5)
{
  ...
  if ( ThemeMargins < 0 )
  {
    iPropId = 1111;
LABEL_52:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011FA00, 1u, ThemeMargins, iPropId, 0LL);
    return v11;
  }
