/*
 * XREFs of _winrt::impl::produce_winrt::Udwm::Transitions::Private::implementation::WindowMaximizeSnapTransitionHandler_winrt::Udwm::Transitions::ITransitionHandler_::PreTransition_::_1_::catch$1 @ 0x1800F83B5
 * Callers:
 *     <none>
 * Callees:
