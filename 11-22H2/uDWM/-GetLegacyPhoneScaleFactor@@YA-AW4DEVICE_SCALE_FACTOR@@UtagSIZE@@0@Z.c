/*
 * XREFs of ?GetLegacyPhoneScaleFactor@@YA?AW4DEVICE_SCALE_FACTOR@@UtagSIZE@@0@Z @ 0x1801105DC
 * Callers:
 ...
 *     ?CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z @ 0x180110500 (-CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z.c)
 */
