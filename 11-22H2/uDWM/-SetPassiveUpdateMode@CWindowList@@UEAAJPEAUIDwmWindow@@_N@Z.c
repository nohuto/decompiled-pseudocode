/*
 * XREFs of ?SetPassiveUpdateMode@CWindowList@@UEAAJPEAUIDwmWindow@@_N@Z @ 0x180030050
 * Callers:
...
__int64 __fastcall CWindowList::SetPassiveUpdateMode(CWindowList *this, struct IDwmWindow *a2, bool a3)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0xAF1u, 0LL);
  }
  else if ( v11 )
  {
    v8 = *((_QWORD *)v11 + 55);
      ...
      if ( a3 != ((*(_BYTE *)(v8 + 249) & 8) != 0) )
      {
        *(_BYTE *)(v8 + 249) = (8 * a3) | *(_BYTE *)(v8 + 249) & 0xF7;
        ...
        if ( updated < 0 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0xAF5u, 0LL);
        }
      }
    }
  }
