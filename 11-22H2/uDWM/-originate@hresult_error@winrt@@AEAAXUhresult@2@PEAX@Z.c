/*
 * XREFs of ?originate@hresult_error@winrt@@AEAAXUhresult@2@PEAX@Z @ 0x1800D8850
 * Callers:
 ...
 * Callees:
 *     WINRT_IMPL_GetProcAddress @ 0x18005D4C6 (WINRT_IMPL_GetProcAddress.c)
 *     LoadLibraryW_0 @ 0x18005DE77 (LoadLibraryW_0.c)
