/*
 * XREFs of ?LookupAndValidateMagnifier@CMagnifierControl@@AEAAJ_KPEAPEAVCMagnifier@@@Z @ 0x1800CB3D4
 * Callers:
        ...
        struct CMagnifier **a3)
{
  ...
  {
    v4 = -2147023728;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, -2147023728, 0x21Fu);
  }
  return v4;
}
