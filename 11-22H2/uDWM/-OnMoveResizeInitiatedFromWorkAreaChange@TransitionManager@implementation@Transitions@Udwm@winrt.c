/*
 * XREFs of ?OnMoveResizeInitiatedFromWorkAreaChange@TransitionManager@implementation@Transitions@Udwm@winrt@@QEAAX_K@Z @ 0x1800FE3E8
 * Callers:
 *     ?OnMoveResizeInitiatedFromWorkAreaChange@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIAnimationsTransitionManager@Private@345@@impl@winrt@@UEAAH_K@Z @ 0x1800FE390 (-OnMoveResizeInitiatedFromWorkAreaChange@-$produce@UTransitionManager@implementation@Transitions.c)
 * Callees:
