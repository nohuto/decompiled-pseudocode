/*
 * XREFs of ??1?$_TlgActivityBase@V?$ActivityData@VWindowFrameLogging@@U_TlgReflectorTag_Param0IsProviderType@@@?$ActivityBase@VWindowFrameLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@$0A@$04@@IEAA@XZ @ 0x180007CD0
 * Callers:
        ...
        _DWORD *a1)
{
  ...
  if ( *a1 == 1 )
  {
    *a1 = 2;
    ...
    _tlgWriteActivityAutoStop<0,5>(*(_QWORD *)(v2 + 8), a1 + 2);
  }
  *a1 = 3;
}
