/*
 * XREFs of ?HasAnimatingOwnerWindow@CStoryboard@@QEAA_NPEAVCWindowData@@H@Z @ 0x1800DB344
 * Callers:
...
char __fastcall CStoryboard::HasAnimatingOwnerWindow(CStoryboard *this, struct CWindowData *a2)
{
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v5 )
      {
        if ( CAnimationScheduler::IsWindowCurrentlyAnimating(*((CAnimationScheduler **)v4 + 23), v5, 83, 0x10000000) )
          break;
      }
