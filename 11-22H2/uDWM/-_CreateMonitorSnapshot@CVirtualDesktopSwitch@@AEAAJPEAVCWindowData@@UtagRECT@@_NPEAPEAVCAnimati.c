/*
 * XREFs of ?_CreateMonitorSnapshot@CVirtualDesktopSwitch@@AEAAJPEAVCWindowData@@UtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800DD658
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  v11 = 0LL;
  HIDWORD(v23) = v8;
  if ( !(unsigned int)GetDesktopID(1LL, v24, a3) )
  {
    v12 = -2147467259;
