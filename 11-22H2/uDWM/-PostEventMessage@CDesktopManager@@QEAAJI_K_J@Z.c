/*
 * XREFs of ?PostEventMessage@CDesktopManager@@QEAAJI_K_J@Z @ 0x1800B550C
 * Callers:
...
__int64 __fastcall CDesktopManager::PostEventMessage(HANDLE *this, UINT a2, WPARAM a3, LPARAM a4)
{
  ...
  if ( this[76] )
  {
    ...
    if ( !PostThreadMessageW(ThreadId, a2, a3, a4) )
    {
      ...
      if ( v4 >= 0 )
        v4 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180128C88, 1LL, v4, 0xA9Du);
    }
  }
  else
  {
    v4 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180128C88, 1LL, -2147467259, 0xA9Au);
  }
