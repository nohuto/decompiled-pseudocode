/*
 * XREFs of _winrt::impl::produce_winrt::Udwm::Transitions::implementation::TransitionManager_winrt::Udwm::Transitions::ITransitionManager_::PreTransition_::_1_::catch$1 @ 0x1800FE774
 * Callers:
 *     <none>
 * Callees:
