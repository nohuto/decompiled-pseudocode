/*
 * XREFs of ??$_tlgWriteActivityAutoStop@$0A@$03@@YAXPEBU_tlgProvider_t@@PEBU_GUID@@@Z @ 0x1800A9B70
 * Callers:
...
__int64 __fastcall _tlgWriteActivityAutoStop<0,4>(_DWORD *a1, __int64 a2)
{
  ...
  if ( *a1 > 4u )
    return tlgWriteTransfer_EtwEventWriteTransfer((__int64)a1, byte_180125F9A, a2, 0LL, 2, (__int64)v3);
  return result;
}
