/*
 * XREFs of ?release_ref@?$com_ptr@UTransitionManager@implementation@Transitions@Udwm@winrt@@@winrt@@AEAAXXZ @ 0x18005C310
 * Callers:
 *     _dynamic_atexit_destructor_for__winrt::Udwm::Transitions::implementation::TransitionManager::m_instance__ @ 0x1800689B0 (_dynamic_atexit_destructor_for__winrt--Udwm--Transitions--implementation--TransitionManager--m_i.c)
 * Callees:
