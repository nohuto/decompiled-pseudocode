/*
 * XREFs of ?OnModifyWindowFilterList@CMagnifier@@QEAAJPEBUMAGN_FILTERLIST@@@Z @ 0x1800CA624
 * Callers:
...
__int64 __fastcall CMagnifier::OnModifyWindowFilterList(CBaseObject **this, const struct MAGN_FILTERLIST *a2)
{
  ...
  if ( !this[6] )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v7, 0xE0u);
      return v8;
    }
  }
  if ( !v3 )
...
LABEL_30:
    ...
    v8 = v20;
    if ( v20 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v20, 0xE6u);
    return v8;
  }
  v10 = 0LL;
  if ( *(_DWORD *)a2 )
...
LABEL_16:
  if ( (unsigned int)v10 < v3 )
  {
    ...
    while ( (unsigned int)v10 < 0x19 )
    {
      if ( *v9 != *v14 )
      {
        ...
        {
          v8 = -2147023728;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, -2147023728, 0x115u);
          return v8;
        }
  ...
  if ( v18 >= 0 )
  {
    ...
    v8 = v19;
    if ( v19 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v19, 0x129u);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v18, 0x128u);
  }
  return v8;
}
