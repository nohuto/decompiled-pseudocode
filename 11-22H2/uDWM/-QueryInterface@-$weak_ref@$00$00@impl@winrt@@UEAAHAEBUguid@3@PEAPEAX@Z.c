/*
 * XREFs of ?QueryInterface@?$weak_ref@$00$00@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800EDE50
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall winrt::impl::weak_ref<1,1>::QueryInterface(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  ...
  v3 = *a2 - winrt::impl::guid_v<winrt::impl::IWeakReference>;
  if ( *a2 == winrt::impl::guid_v<winrt::impl::IWeakReference> )
...
LABEL_15:
    *a3 = a1;
    _InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 28), 1u);
    return 0LL;
  }
}
