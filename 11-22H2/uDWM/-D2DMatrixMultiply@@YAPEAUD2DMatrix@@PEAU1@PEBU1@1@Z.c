/*
 * XREFs of ?D2DMatrixMultiply@@YAPEAUD2DMatrix@@PEAU1@PEBU1@1@Z @ 0x180029740
 * Callers:
        ...
        const struct D2DMatrix *a3)
{
  ...
  *((float *)v3 + 3) = (float)((float)((float)(*((float *)a2 + 1) * *((float *)a3 + 7))
  ...
  *((float *)v3 + 9) = (float)((float)((float)(*((float *)a3 + 5) * *((float *)a2 + 9))
                                     + (float)(*((float *)a3 + 1) * *((float *)a2 + 8)))
                             + (float)(*((float *)a2 + 10) * *((float *)a3 + 9)))
                     + (float)(*((float *)a3 + 13) * *((float *)a2 + 11));
  *((float *)v3 + 10) = (float)((float)((float)(*((float *)a3 + 2) * *((float *)a2 + 8))
                                      + (float)(*((float *)a2 + 9) * *((float *)a3 + 6)))
                              + (float)(*((float *)a2 + 10) * *((float *)a3 + 10)))
                      + (float)(*((float *)a2 + 11) * *((float *)a3 + 14));
  *((float *)v3 + 11) = (float)((float)((float)(*((float *)a3 + 3) * *((float *)a2 + 8))
  ...
  *((float *)v3 + 13) = (float)((float)((float)(*((float *)a3 + 5) * *((float *)a2 + 13))
                                      + (float)(*((float *)a2 + 12) * *((float *)a3 + 1)))
                              + (float)(*((float *)a2 + 14) * *((float *)a3 + 9)))
                      + (float)(*((float *)a3 + 13) * *((float *)a2 + 15));
  *((float *)v3 + 14) = (float)((float)((float)(*((float *)a2 + 12) * *((float *)a3 + 2))
                                      + (float)(*((float *)a2 + 13) * *((float *)a3 + 6)))
                              + (float)(*((float *)a3 + 10) * *((float *)a2 + 14)))
                      + (float)(*((float *)a3 + 14) * *((float *)a2 + 15));
  *((float *)v3 + 15) = (float)((float)((float)(*((float *)a3 + 3) * *((float *)a2 + 12))
                                      + (float)(*((float *)a3 + 7) * *((float *)a2 + 13)))
