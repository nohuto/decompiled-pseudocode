/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayExtendToDuplicateAnimatedVisual@@AEAAJXZ @ 0x1800BB7F4
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayExtendToDuplicateAnimatedVisual@@EEAAJI@Z @ 0x1800BB630 (-OnAnimationCompleteImpl@CDisplayExtendToDuplicateAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayExtendToDuplicateAnimatedVisual::SetupDelayBeforeEntranceAnimation(
