/*
 * XREFs of ?ScreenDuplicationEnabled@WindowFrameLoggingTelemetry@@SAXXZ @ 0x1800D10C0
 * Callers:
...
void __fastcall WindowFrameLoggingTelemetry::ScreenDuplicationEnabled(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EtwEventWriteTransfer(v1, byte_18012735A, 0LL, 0LL, 2, (__int64)v2);
  }
}
