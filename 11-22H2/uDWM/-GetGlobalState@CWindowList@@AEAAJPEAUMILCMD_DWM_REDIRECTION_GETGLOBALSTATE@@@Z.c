/*
 * XREFs of ?GetGlobalState@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_GETGLOBALSTATE@@@Z @ 0x18010A40C
 * Callers:
 ...
 *     ?IsFeatureEnabled@CDesktopManager@@SA_NW4DwmFeature@1@@Z @ 0x1800381FC (-IsFeatureEnabled@CDesktopManager@@SA_NW4DwmFeature@1@@Z.c)
...
__int64 __fastcall CWindowList::GetGlobalState(CWindowList *this, struct MILCMD_DWM_REDIRECTION_GETGLOBALSTATE *a2)
{
  ...
  if ( *((_DWORD *)a2 + 1) == 16 )
  {
    ...
    if ( (*((_BYTE *)a2 + 8) & 1) != 0 )
    {
      if ( !CDesktopManager::IsFeatureEnabled(0) || *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 125) )
        v4 = 0;
      *((_DWORD *)a2 + 3) = v4;
    }
    if ( (*((_BYTE *)a2 + 8) & 2) != 0 )
