/*
 * XREFs of ?UpdateCaptionAccentColor@CTopLevelWindow@@AEAAJXZ @ 0x180023EB0
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdateCaptionAccentColor(CTopLevelWindow *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *((_DWORD *)this + 210) == 3 )
  {
    if ( !v6 )
    {
      Microsoft::WRL::ComPtr<CAtlasedImage>::InternalRelease((char *)this + 328);
  ...
  if ( v23 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
      ...
      v29);
    wil::com_ptr_t<Windows::UI::Composition::ICompositor,wil::err_returncode_policy>::~com_ptr_t<Windows::UI::Composition::ICompositor,wil::err_returncode_policy>(&v33);
    return v24;
  }
  v34 = 0LL;
