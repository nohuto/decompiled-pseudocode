/*
 * XREFs of ?ShowHide@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180037570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ShowHide(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0xA44u, 0LL);
  }
  else
  {
    v6 = v13;
      ...
      if ( v7 != (*((_BYTE *)v6 + 672) & 1) )
      {
        *((_BYTE *)v6 + 672) ^= (v7 ^ *((_BYTE *)v6 + 672)) & 1;
        ...
        if ( !(_BYTE)v13 )
        {
          ...
          v5 = v11;
          if ( v11 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0xA53u, 0LL);
        }
      }
    }
  }
