/*
 * XREFs of ?StartAnimationForMaximizeSnapTransition@CTopLevelWindow3D@@QEAAJW4WindowAnimationType@1@AEBUtagRECT@@@Z @ 0x1800E7734
 * Callers:
...
__int64 __fastcall CTopLevelWindow3D::StartAnimationForMaximizeSnapTransition(__int64 a1, unsigned int a2, int *a3)
{
  int v4; // r9d
  unsigned int v5; // eax
  __m128i v6; // xmm3
