/*
 * XREFs of ?AddRef@?$produce_base@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotationTransitionManager@Private@345@X@impl@winrt@@UEAAIXZ @ 0x1800FD2E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
