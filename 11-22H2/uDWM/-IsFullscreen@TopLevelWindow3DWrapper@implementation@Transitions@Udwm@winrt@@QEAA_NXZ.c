/*
 * XREFs of ?IsFullscreen@TopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@QEAA_NXZ @ 0x1800FB310
 * Callers:
 *     ?get_IsFullscreen@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHPEA_N@Z @ 0x1800FB7D0 (-get_IsFullscreen@-$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITo.c)
 * Callees:
 *     __security_check_cookie @ 0x18005C460 (__security_check_cookie.c)
 *     ??8Foundation@Windows@winrt@@YA_NAEBURect@012@0@Z @ 0x1800FAC40 (--8Foundation@Windows@winrt@@YA_NAEBURect@012@0@Z.c)
