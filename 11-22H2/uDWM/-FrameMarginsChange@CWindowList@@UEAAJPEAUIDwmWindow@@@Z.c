/*
 * XREFs of ?FrameMarginsChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18001A860
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
      v6 = v4;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0xE1Bu, 0LL);
      goto LABEL_5;
    }
    *((_QWORD *)v10 + 3) = a2;
  ...
  if ( v5 )
  {
    ...
    if ( *((_QWORD *)v5 + 55) )
    {
      ...
      v6 = v8;
      if ( v8 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xE26u, 0LL);
    }
  }
LABEL_5:
