/*
 * XREFs of ?PreTransition@WindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@QEAAXW4ShellTransition@456@AEBUTransitionState@456@@Z @ 0x1800F9B34
 * Callers:
 *     ?PreTransition@?$produce@UWindowJointResizeTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@@impl@winrt@@UEAAHHPEAX@Z @ 0x1800F9AD0 (-PreTransition@-$produce@UWindowJointResizeTransitionHandler@implementation@Private@Transitions@.c)
 * Callees:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_JointResizeIcons@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800FA000 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_JointResizeIcons@@@details@wil@@QEAAX_NW4.c)
        ...
        winrt::Windows::Foundation::IUnknown *a3)
{
  ...
  __int64 v15; // rax
  signed int v16; // eax
  __int64 (__fastcall ***v17)(_QWORD, __int64 *, __int64 *); // [rsp+20h] [rbp-40h] BYREF
  ...
  winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransitionHandler::Cleanup(
    (winrt::Udwm::Transitions::Private::implementation::WindowJointResizeTransitionHandler *)a1,
    a2);
  winrt::Windows::Foundation::IUnknown::operator=((winrt::Windows::Foundation::IUnknown *)(a1 + 8), a3);
  v5 = (float *)winrt::impl::consume_Udwm_Transitions_ITransitionState<winrt::Udwm::Transitions::ITransitionState>::TransferJointResizeVisuals(
                  a1 + 8,
                  &v17);
  v6 = a1 + 10;
  if ( a1 + 10 != v5 )
  {
    if ( *v6 )
      winrt::Windows::Foundation::IUnknown::unconditional_release_ref((winrt::Windows::Foundation::IUnknown *)(a1 + 10));
    v7 = *(_QWORD *)v5;
    *(_QWORD *)v5 = 0LL;
    *v6 = v7;
  }
  ...
  if ( (unsigned int)winrt::impl::consume_Windows_Foundation_Collections_IVector<winrt::Windows::Foundation::Collections::IVector<winrt::Udwm::Transitions::UserResizeVisual>,winrt::Udwm::Transitions::UserResizeVisual>::Size(a1 + 10) )
  {
    v9 = 0;
    v10 = winrt::impl::consume_Windows_Foundation_Collections_IVector<winrt::Windows::Foundation::Collections::IVector<winrt::Udwm::Transitions::UserResizeVisual>,winrt::Udwm::Transitions::UserResizeVisual>::Size(a1 + 10);
    while ( v9 != v10 )
    {
      ...
      winrt::impl::as<Udwm::Transitions::IUserResizeVisualNative,winrt::impl::abi<winrt::Windows::Foundation::IUnknown,void>::type,0>(
        ...
        v17);
      v12 = v19;
      v18 = (*(__int64 (__fastcall **)(__int64 *))(*v19 + 64))(v19);
      v13 = std::_Hash<std::_Umap_traits<HWND__ *,wil::com_ptr_t<CBitmapSource,wil::err_returncode_policy>,std::_Uhash_compare<HWND__ *,std::hash<HWND__ *>,std::equal_to<HWND__ *>>,std::allocator<std::pair<HWND__ * const,wil::com_ptr_t<CBitmapSource,wil::err_returncode_policy>>>,0>>::_Extract(
              a1 + 12,
              &v18);
      v14 = (_QWORD *)v13;
      if ( v13 )
      ...
      if ( v14 )
      {
        (*(void (__fastcall **)(__int64 *, _QWORD))(v15 + 56))(v12, v14[3]);
      }
      else
      {
        v18 = (*(__int64 (__fastcall **)(__int64 *))(v15 + 64))(v12);
        std::_Hash<std::_Umap_traits<HWND__ *,winrt::Udwm::Transitions::UserResizeVisual,std::_Uhash_compare<HWND__ *,std::hash<HWND__ *>,std::equal_to<HWND__ *>>,std::allocator<std::pair<HWND__ * const,winrt::Udwm::Transitions::UserResizeVisual>>,0>>::emplace<HWND__ *,winrt::Udwm::Transitions::UserResizeVisual const &>(
          a1 + 28,
          (__int64)v20,
          (unsigned __int8 *)&v18,
          &v17);
      ...
      if ( v14 )
      {
        std::pair<HWND__ * const,wil::com_ptr_t<CBitmapSource,wil::err_returncode_policy>>::`scalar deleting destructor'((__int64)(v14 + 2));
        std::_Deallocate<16,0>(v14, 0x20uLL);
        v21 = 0LL;
      }
      if ( v12 )
        winrt::com_ptr<Udwm::Transitions::ITransitionAnimationVisualNative>::unconditional_release_ref((__int64 *)&v19);
      v16 = ((__int64 (__fastcall *)(__int64 (__fastcall ***)(_QWORD, __int64 *, __int64 *)))(*v17)[9])(v17);
      if ( v16 < 0 )
        winrt::throw_hresult(v16);
      if ( v17 )
        winrt::Windows::Foundation::IUnknown::unconditional_release_ref((winrt::Windows::Foundation::IUnknown *)&v17);
      ++v9;
    }
