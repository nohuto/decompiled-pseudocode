/*
 * XREFs of ?CloneVisualTree@CDCompositionInteropVisual@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x1800B39C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDCompositionInteropVisual::CloneVisualTree(__int64 a1, _QWORD *a2, unsigned int a3)
{
  ...
  struct CDCompositionInteropVisual *v11; // [rsp+38h] [rbp+10h] BYREF
