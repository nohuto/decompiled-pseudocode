/*
 * XREFs of ??1UpdateWindowCapture@WindowFrameLoggingTelemetry@@QEAA@XZ @ 0x1800D0070
 * Callers:
 ...
 *     _CProjectionBorderManager::UpdateWindowCapture_::_1_::dtor$2 @ 0x1800D3B1F (_CProjectionBorderManager--UpdateWindowCapture_--_1_--dtor$2.c)
 * Callees:
