/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayExtendAnimatedVisual@@AEAAJXZ @ 0x1800BB13C
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayExtendAnimatedVisual@@EEAAJI@Z @ 0x1800BAEE0 (-OnAnimationCompleteImpl@CDisplayExtendAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayExtendAnimatedVisual::SetupDelayBeforeEntranceAnimation(CDisplayExtendAnimatedVisual *this)
{
  __int64 v2; // rax
  _QWORD *v3; // r8
  _QWORD *v4; // rcx
  ...
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=((__int64 *)this + 60, (__int64)v3);
  if ( !*v4 )
  {
    v5 = -2147024882;
    v6 = 255LL;
