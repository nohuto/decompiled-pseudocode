/*
 * XREFs of ?GetAnimationIds@CTopLevelWindow3D@@AEAAJW4WindowAnimationType@1@PEAH1@Z @ 0x18004BB38
 * Callers:
...
LABEL_25:
          v4 = -2147024809;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xBDu, 0LL);
          return v4;
        }
        LODWORD(v11) = 1;
        wil::details::FeatureImpl<__WilFeatureTraits_Feature_XTests>::ReportUsage(
