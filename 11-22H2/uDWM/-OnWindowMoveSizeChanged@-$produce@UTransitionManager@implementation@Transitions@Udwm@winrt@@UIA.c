/*
 * XREFs of ?OnWindowMoveSizeChanged@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIAnimationsTransitionManager@Private@345@@impl@winrt@@UEAAH_K@Z @ 0x1800FE580
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0ITransitionHandler@Transitions@Udwm@winrt@@QEAA@AEBU0123@@Z @ 0x1800FCB40 (--0ITransitionHandler@Transitions@Udwm@winrt@@QEAA@AEBU0123@@Z.c)
