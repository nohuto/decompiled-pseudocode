/*
 * XREFs of ?GetNCAreaHorizontalStripHelper@CTopLevelWindow@@CAJPEAXHHW4NCAreaPart@1@11PEAUWindowFrame@1@2@Z @ 0x180021980
 * Callers:
      ...
      while ( 2 )
      {
        ...
        do
        {
          ...
          if ( !v27 )
          {
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011FA00, 1u, -2147024882, 0x57Cu, 0LL);
            return 2147942414LL;
          }
          *(_DWORD *)(v27 + 8) = 1;
