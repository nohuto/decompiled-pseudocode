/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayDuplicateToExtendAnimatedVisual@@AEAAJXZ @ 0x1800BA504
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayDuplicateToExtendAnimatedVisual@@EEAAJI@Z @ 0x1800B9FC0 (-OnAnimationCompleteImpl@CDisplayDuplicateToExtendAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
...
__int64 __fastcall CDisplayDuplicateToExtendAnimatedVisual::SetupDelayBeforeEntranceAnimation(
        CDisplayDuplicateToExtendAnimatedVisual *this)
{
  ...
  if ( v2 )
  {
    CTimelineBase::CTimelineBase(v2, 0.3330000042915344, 0.0, 1.0, 0);
  ...
  wil::com_ptr_t<CTimeline<float>,wil::err_returncode_policy>::operator=((__int64 *)this + 63, (__int64)v3);
  if ( !*v4 )
  {
    v5 = -2147024882;
    v6 = 334LL;
