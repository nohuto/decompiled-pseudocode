/*
 * XREFs of ?RecordUsageInternal@RawUsageIndex@details_abi@wil@@AEAA_NPEAX_K01I@Z @ 0x180010C18
 * Callers:
 ...
 *     ?GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ @ 0x180011044 (-GetSize@UsageIndexProperty@details_abi@wil@@QEBA_KXZ.c)
