/*
 * XREFs of ??1CWindowList@@UEAA@XZ @ 0x1801089DC
 * Callers:
 ...
 *     ?IsEmpty@?$CGenericSet@PEAVCWindowData@@@@QEAA_NXZ @ 0x18010AC58 (-IsEmpty@-$CGenericSet@PEAVCWindowData@@@@QEAA_NXZ.c)
 */
...
void __fastcall CWindowList::~CWindowList(CWindowList *this)
{
  ...
  *(_QWORD *)this = &CWindowList::`vftable';
  ...
  try
  {
    winrt::Udwm::Transitions::implementation::TransitionManager::GetCurrent((__int64)&v30);
