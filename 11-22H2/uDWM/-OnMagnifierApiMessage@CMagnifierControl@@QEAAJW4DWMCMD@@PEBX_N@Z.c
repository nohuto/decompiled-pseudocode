/*
 * XREFs of ?OnMagnifierApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEBX_N@Z @ 0x1800CB438
 * Callers:
  ...
  if ( a2 > 1073741931 )
  {
    ...
    if ( !v30 )
    {
      ...
      if ( v48 >= 0 )
      {
        ...
        v8 = v49;
        if ( v49 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v49, 0x12Du);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v48, 0x12Bu);
      }
      goto LABEL_65;
    }
    v31 = v30 - 1;
    if ( !v31 )
    {
      ...
      if ( v46 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v46, 0x135u);
        goto LABEL_65;
      }
      goto LABEL_59;
    }
    ...
    if ( !v32 )
    {
      ...
      if ( v45 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v45, 0x13Fu);
        goto LABEL_65;
      }
      goto LABEL_59;
    }
    ...
    if ( v33 )
    {
      ...
      wil::details::FeatureImpl<__WilFeatureTraits_Feature_MagnifierWithinEdgesNoJitter>::ReportUsage(
        ...
        v9);
      v34 = *(_DWORD *)(a3 + 12);
      v35 = (struct CMagnifier *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                     + 8LL))(
                                   WPF::g_pProcessHeap,
                                   128LL);
      v51 = v35;
      ...
      v37 = a1 + 16;
      v38 = (CWindowList *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 54);
      v39 = a1;
      if ( v34 )
      {
        ...
        if ( v40 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v40, 0x177u);
          goto LABEL_65;
        }
        goto LABEL_48;
      }
    ...
    {
      v41 = *(_DWORD *)(a3 + 12);
      v42 = (struct CMagnifier *)(*(__int64 (__fastcall **)(WPF::HeapBase *, __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                     + 8LL))(
                                   WPF::g_pProcessHeap,
                                   128LL);
      v51 = v42;
      if ( v42 )
      {
        v55 = 0.0;
        v54 = 0;
        v43 = MagnifierExperienceHelper::MagnifierExperienceHelper(
                v42,
                (const double *)(a1 + 152),
                (const float *)&v54,
                &v55);
      ...
      if ( v41 )
      {
        ...
        if ( v44 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v44, 0x158u);
          goto LABEL_65;
        }
LABEL_48:
    ...
    v51 = (struct CMagnifier *)(v37 & ((unsigned __int128)-(__int128)v39 >> 64));
    v53[0] = &v51;
    v53[1] = v38;
  ...
  if ( a2 == 1073741931 )
  {
    ...
    if ( *(_BYTE *)(a1 + 128) )
    {
      if ( *(double *)(a1 + 152) == *v27 )
      {
        v54 = 0;
        LOBYTE(v55) = 0;
        if ( (int)wil::wnf_query_nothrow<unsigned int>(v10, (char *)&v55, &v54, v11) >= 0 && LOBYTE(v55) && !v54 )
          goto LABEL_65;
      }
      *(double *)(a1 + 152) = *v27;
      ...
      if ( v28 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v28, 0x116u);
        goto LABEL_65;
      }
    }
    else
    {
      ...
      if ( v29 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v29, 0x11Eu);
        goto LABEL_65;
      }
    }
    goto LABEL_59;
      ...
      if ( v14 )
      {
        ...
        if ( v15 )
        {
          ...
          if ( v16 )
          {
            ...
            if ( v17 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v17, 0xEFu);
              goto LABEL_65;
            }
LABEL_59:
            ...
            v8 = v47;
            if ( v47 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v47, 0x186u);
            goto LABEL_65;
          }
          v51 = 0LL;
          ...
          if ( v19 >= 0 )
          {
            ...
            v8 = v20;
            if ( v20 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v20, 0xE7u);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v19, 0xE3u);
          }
        }
        else
        {
          ...
          if ( v21 >= 0 )
          {
            v22 = CMagnifier::OnModifyWindowFilterList((CBaseObject **)v51, (const struct MAGN_FILTERLIST *)(a3 + 16));
            v8 = v22;
            if ( v22 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v22, 0xD9u);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v21, 0xD5u);
          }
        }
      }
      else
      {
        ...
        if ( v23 >= 0 )
        {
          ...
          v8 = v24;
          if ( v24 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v24, 0xCBu);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v23, 0xC9u);
        }
      }
    }
    else
    {
      *(_BYTE *)(a1 + 128) = 0;
      ...
      v8 = v25;
      if ( v25 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v25, 0xBFu);
    }
  }
  else
  {
    ...
    v8 = v26;
    if ( v26 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180129208, 1LL, v26, 0xB4u);
  }
LABEL_65:
  if ( v8 != -2147023728 )
    v7 = v8;
