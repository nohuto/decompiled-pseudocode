/*
 * XREFs of ?FreezeRepresentationChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180006890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::FreezeRepresentationChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0x1798u, 0LL);
  }
  else
  {
    v6 = v12;
        ...
        || CDesktopThumbnail::IsDesktopThumbnailInSnapshot() == v7 )
      {
        if ( ((*((_BYTE *)v6 + 676) & 8) != 0) != v7 )
        {
          ...
          *((_BYTE *)v6 + 676) = v9;
          ...
          v5 = v10;
          if ( v10 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x17AFu, 0LL);
        }
      }
      else
      {
