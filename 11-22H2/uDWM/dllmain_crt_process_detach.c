/*
 * XREFs of dllmain_crt_process_detach @ 0x18005E220
 * Callers:
 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x18005C79C (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x18005C93C (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x18005C968 (__scrt_uninitialize_crt.c)
 *     __scrt_fastfail @ 0x18005D060 (__scrt_fastfail.c)
 *     ?__scrt_uninitialize_type_info@@YAXXZ @ 0x18005E510 (-__scrt_uninitialize_type_info@@YAXXZ.c)
