/*
 * XREFs of ?GetErrorDetails@error_info_fallback@impl@winrt@@UEAAHPEAPEAGPEAH00@Z @ 0x1800D7570
 * Callers:
 *     <none>
 * Callees:
 *     WINRT_IMPL_SysAllocString @ 0x18005E66D (WINRT_IMPL_SysAllocString.c)
