/*
 * XREFs of ?SetHolographic@CWindowList@@UEAAJPEAUIDwmWindow@@_N@Z @ 0x180035450
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !v7 && (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 16LL))(a2) )
  {
    ...
    if ( v8 && (v9 = CWindowData::CWindowData(v8), (v7 = (__int64)v9) != 0) )
    {
      ...
      *(_QWORD *)(v7 + 40) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 24LL))(a2);
      ...
      if ( v6 >= 0 )
        goto LABEL_6;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x888u, 0LL);
    }
    else
    {
      v6 = -2147024882;
    ...
    v10 = v6;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0xA64u, 0LL);
    goto LABEL_9;
  }
LABEL_6:
  v10 = v6;
  if ( v7 )
  {
    *(_BYTE *)(v7 + 677) = (2 * a3) | *(_BYTE *)(v7 + 677) & 0xFD;
    ...
    if ( v11 )
    {
      ...
      v10 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0xA6Cu, 0LL);
    }
  }
LABEL_9:
