/*
 * XREFs of ?_Decref@_Ref_count_base@std@@QEAAXXZ @ 0x18001A708
 * Callers:
 ...
 *     ??1?$shared_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@QEAA@XZ @ 0x1800A28C0 (--1-$shared_ptr@VCCachedBorderBrush@CWindowBorder@@@std@@QEAA@XZ.c)
