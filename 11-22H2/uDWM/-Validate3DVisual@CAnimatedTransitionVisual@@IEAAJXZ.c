/*
 * XREFs of ?Validate3DVisual@CAnimatedTransitionVisual@@IEAAJXZ @ 0x1800A81B4
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::Validate3DVisual(CAnimatedTransitionVisual *this)
{
  ...
  if ( (v1 & 0x1000) != 0 )
  {
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x5DFu);
      return v2;
    }
    ...
    if ( v5 >= 0 )
    {
      ...
      if ( v6 >= 0 )
        *((_DWORD *)this + 24) &= ~0x2000u;
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x5E8u);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x5E7u);
    }
  }
  return v2;
}
