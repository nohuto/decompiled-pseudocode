/*
 * XREFs of ?Cancel@WindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@QEAAXXZ @ 0x1800F7968
 * Callers:
 ...
 *     ?Cancel@?$produce@UWindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@UITransitionHandler@456@@impl@winrt@@UEAAHXZ @ 0x1800F7910 (-Cancel@-$produce@UWindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@w.c)
