/*
 * XREFs of ?UpdateEnableClearForRenderTargets@CDesktopManager@@QEAAXXZ @ 0x1800B5B4C
 * Callers:
 ...
 *     ?ShouldClearRenderTargets@CWindowList@@QEBA_NXZ @ 0x18010CEF0 (-ShouldClearRenderTargets@CWindowList@@QEBA_NXZ.c)
 */
