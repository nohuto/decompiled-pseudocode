/*
 * XREFs of ?EnsureWorkAreaChangeTransitionRemoved@?$consume_Udwm_Transitions_Private_IAnimationsTransitionManager@UIAnimationsTransitionManager@Private@Transitions@Udwm@winrt@@@impl@winrt@@QEBA@_K@Z @ 0x1800E7594
 * Callers:
