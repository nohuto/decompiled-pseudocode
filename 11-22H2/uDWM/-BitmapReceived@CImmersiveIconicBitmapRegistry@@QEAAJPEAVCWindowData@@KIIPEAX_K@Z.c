/*
 * XREFs of ?BitmapReceived@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_K@Z @ 0x1800C3F20
 * Callers:
        ...
        unsigned __int64 a7)
{
    ...
    && v12 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801290A8, 1LL, v16, 0x172u);
    }
    if ( v17 )
  ...
  else
  {
    ...
    v18 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801290A8, 1LL, -2147024809, 0x16Eu);
  }
  return v18;
}
