/*
 * XREFs of ??1?$function@$$A6AXAEBH@Z@wistd@@QEAA@XZ @ 0x18004DC6C
 * Callers:
 ...
 *     _Windows::Mirage::HolographicDriverDetectedWatcher::CreateDetachWatcher_::_1_::dtor$0 @ 0x1800684C6 (_Windows--Mirage--HolographicDriverDetectedWatcher--CreateDetachWatcher_--_1_--dtor$0.c)
