/*
 * XREFs of ?_WindowEnumCallback@CWindowClose@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180015930
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CWindowClose::_WindowEnumCallback(CStoryboard *a1, struct CWindowData *a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) != 0 && (*((_DWORD *)a2 + 170) & 0xFFF) == 0x55 )
  {
    ...
    v9 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(a1, a2, 1, v8, 0LL, 0LL, 0xFFFFFFFF, 1, &v21);
    v10 = v21;
    v4 = v9;
    if ( v9 < 0 )
    {
