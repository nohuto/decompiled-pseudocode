/*
 * XREFs of ??1?$AnimatedTransitionVisualWrapper_base@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@UITransitionAnimationVisualNative@34@@implementation@Transitions@Udwm@winrt@@UEAA@XZ @ 0x1800ED2D8
 * Callers:
 *     _winrt::Udwm::Transitions::implementation::AnimatedTransitionVisualWrapper::AnimatedTransitionVisualWrapper_::_1_::dtor$0 @ 0x1800ED1E9 (_winrt--Udwm--Transitions--implementation--AnimatedTransitionVisualWrapper--AnimatedTransitionVi.c)
 *     _winrt::Udwm::Transitions::implementation::UserResizeVisual::UserResizeVisual_::_1_::dtor$0 @ 0x180104464 (_winrt--Udwm--Transitions--implementation--UserResizeVisual--UserResizeVisual_--_1_--dtor$0.c)
 * Callees:
