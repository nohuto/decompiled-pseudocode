...
__int64 __fastcall std::vector<cereal::JSONInputArchive::Iterator>::_Emplace_reallocate<tip_rapidjson::GenericValue<tip_rapidjson::UTF8<char>,tip_rapidjson::MemoryPoolAllocator<tip_rapidjson::CrtAllocator>> const *,tip_rapidjson::GenericValue<tip_rapidjson::UTF8<char>,tip_rapidjson::MemoryPoolAllocator<tip_rapidjson::CrtAllocator>> const *>(
        __int64 *a1,
        __int64 a2,
        __int64 *a3,
        __int64 *a4)
{
  ...
  *(_DWORD *)(v16 + 32) = 0;
  *(_QWORD *)(v16 + 24) = 0LL;
  v18 = ((v17 - v14) & 0xFFFFFFFFFFFFFFF0uLL) == 0;
  *(_QWORD *)(v16 + 16) = v14;
  v19 = *(_DWORD *)(v16 + 32);
  if ( v18 )
    v19 = 2;
