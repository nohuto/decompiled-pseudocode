/*
 * XREFs of _CAcrylicSystemBackdropVisual::CloneVisualTree_::_1_::dtor$0 @ 0x1800A43C2
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAcrylicSystemBackdropVisual::CloneVisualTree_::_1_::dtor_0(__int64 a1, __int64 a2)
{
