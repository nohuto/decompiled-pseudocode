/*
 * XREFs of ?CreateGlyphsFromAtlas@CTopLevelWindow@@CAJQEAX@Z @ 0x180022400
 * Callers:
...
LABEL_25:
  ...
  v4 = 0;
  v5 = (unsigned int *)&unk_18011D9F8;
  v28 = 0;
  v31 = (unsigned int *)&unk_18011D9F8;
  while ( 1 )
  {
    v6 = v1 - 4 <= 1 ? (char *)&unk_18011D9F0 + 8 * v4 + 4 * v4 + 4 : (char *)&unk_18011D9F0 + 12 * v4;
    if ( *v6 )
      break;
LABEL_24:
    v5 += 3;
  ...
  while ( 2 )
  {
    ...
    if ( v11 < 0 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011FA00, 1u, v12, 0x3E1u, 0LL);
      v27 = v12;
      goto LABEL_32;
    }
    *(_DWORD *)(v10 + 224) += 4;
...
LABEL_30:
  v27 = ThemeRect;
  v12 = ThemeRect;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011FA00, 1u, ThemeRect, 0x3E9u, 0LL);
LABEL_32:
