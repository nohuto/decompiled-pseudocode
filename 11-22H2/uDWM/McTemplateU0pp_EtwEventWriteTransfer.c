/*
 * XREFs of McTemplateU0pp_EtwEventWriteTransfer @ 0x1800D8CDC
 * Callers:
...
__int64 McTemplateU0pp_EtwEventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  v8 = 0;
  v7 = 8;
  return McGenEventWrite_EtwEventWriteTransfer(Microsoft_Windows_Dwm_Udwm_Provider_Context, a2, v10, 3LL, (__int64)v3);
}
