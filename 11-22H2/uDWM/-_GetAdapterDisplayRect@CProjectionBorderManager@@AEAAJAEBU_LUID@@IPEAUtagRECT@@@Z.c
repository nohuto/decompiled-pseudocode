/*
 * XREFs of ?_GetAdapterDisplayRect@CProjectionBorderManager@@AEAAJAEBU_LUID@@IPEAUtagRECT@@@Z @ 0x1800D44B4
 * Callers:
        ...
        struct tagRECT *a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DisplayConfigBufferSizes, 0x16u);
  }
LABEL_25:
