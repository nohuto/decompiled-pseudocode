/*
 * XREFs of ?_SlideWindowHorizontally@CSlide@@IEAAJPEAVCWindowData@@AEBUtagRECT@@_NPEBU3@PEAPEAVCAnimationComponent@@@Z @ 0x1800DE8C4
 * Callers:
        ...
        struct CAnimationComponent **a6)
{
  ...
  v12 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v11, 0LL, 0LL, 0xFFFFFFFF, 1, &v31);
  v13 = v12;
  if ( v12 < 0 )
  {
