/*
 * XREFs of ??$CreateProxy@VCScaleTransformProxy@@@CCompositor@@IEAAJPEAPEAVCScaleTransformProxy@@@Z @ 0x18003880C
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v4 = &CCombinedGeometryProxy::`vftable';
    ...
    v6 = CResource::Create(0x21u, *(_QWORD *)(a1 + 24), (CBaseObject **)(v4 + 16));
    v7 = v6;
    if ( v6 < 0 )
    {
