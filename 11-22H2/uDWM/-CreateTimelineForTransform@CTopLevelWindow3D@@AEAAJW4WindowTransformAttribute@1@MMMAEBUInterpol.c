/*
 * XREFs of ?CreateTimelineForTransform@CTopLevelWindow3D@@AEAAJW4WindowTransformAttribute@1@MMMAEBUInterpolationParameters@@@Z @ 0x180020700
 * Callers:
  ...
  *(_OWORD *)&v15[16] = *(_OWORD *)(a6 + 16);
  ...
  else
  {
    *(_QWORD *)(a1 + 8 * v6 + 392) = 0LL;
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xEAu, 0LL);
  }
  return v8;
}
