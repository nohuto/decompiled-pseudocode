/*
 * XREFs of ?ProcessAsyncDwmMessage@CWindowList@@UEAAJW4DWMCMD@@PEBXI_N@Z @ 0x1800321C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_32:
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x867u, 0LL);
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0xECFu, 0LL);
          goto LABEL_73;
        }
LABEL_33:
        v10 = v19;
...
LABEL_52:
              ...
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0xED5u, 0LL);
LABEL_73:
...
LABEL_51:
        ...
        if ( v29 >= 0 )
        {
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v39, 0xEDEu, 0LL);
          }
          else
          {
      ...
      case 0x68u:
        if ( a4 == 12 )
        {
          ...
          try
          {
            winrt::Udwm::Transitions::implementation::TransitionManager::GetCurrent(v82);
            v73 = v82[0];
            if ( v82[0] )
            {
              v78 = 0LL;
...
LABEL_157:
      ...
      case 0x6Fu:
        if ( a4 == 4 )
        {
          try
          {
            winrt::Udwm::Transitions::implementation::TransitionManager::GetCurrent(&v78);
            v44 = v78;
            if ( v78 )
            {
              v79 = 0LL;
