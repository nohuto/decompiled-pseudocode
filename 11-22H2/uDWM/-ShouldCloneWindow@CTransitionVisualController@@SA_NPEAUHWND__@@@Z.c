/*
 * XREFs of ?ShouldCloneWindow@CTransitionVisualController@@SA_NPEAUHWND__@@@Z @ 0x180004C84
 * Callers:
...
char __fastcall CTransitionVisualController::ShouldCloneWindow(HWND hWnd)
{
  ...
  int v12; // edx
  int v13; // ecx
  tagRECT Rect; // [rsp+20h] [rbp-248h] BYREF
    ...
    for ( i = 0; i < 6; ++i )
    {
      if ( CAnimationScheduler::IsWindowCurrentlyAnimating(
             *((CAnimationScheduler **)v3 + 23),
             0LL,
             *((_DWORD *)&off_180115EE0 + 4 * i + 2),
             0) )
      {
        v11 = ClassName;
        do
        {
          v12 = *(WCHAR *)((char *)v11 + (char *)(&off_180115EE0)[2 * i] - (char *)ClassName);
          v13 = *v11 - v12;
          if ( v13 )
            break;
          ++v11;
