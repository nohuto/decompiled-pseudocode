/*
 * XREFs of ?UpdateNCAreaGeometry@CTopLevelWindow@@AEAAJXZ @ 0x18001ACB4
 * Callers:
 ...
 *     ?CreateRoundRectRgnCoerceInvalid@@YAPEAUHRGN__@@HHHHHH@Z @ 0x1800C7088 (-CreateRoundRectRgnCoerceInvalid@@YAPEAUHRGN__@@HHHHHH@Z.c)
 *     ?EdgeBorderMustBeOpaque@CTopLevelWindow@@AEAAHXZ @ 0x1800E5B54 (-EdgeBorderMustBeOpaque@CTopLevelWindow@@AEAAHXZ.c)
 *     ?CheckGUIHandleQuota@@YAJKJJ@Z @ 0x18010DC10 (-CheckGUIHandleQuota@@YAJKJJ@Z.c)
 */
  ...
  *(_QWORD *)&Src.left = CTopLevelWindow::s_ChooseWindowFrameFromStyle(
  ...
  if ( !CDesktopManager::IsHighContrastMode() )
  {
    ...
    if ( (*(_DWORD *)(v9 + 96) || *(_DWORD *)(v9 + 100) || *(_DWORD *)(v9 + 108)) && (*(_BYTE *)(v9 + 673) & 4) == 0 )
    {
      ...
      if ( v49 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D8, 0xAu, v49, 0x138Cu, 0LL);
...
LABEL_98:
      ...
      if ( v20 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D8, 0xAu, v20, 0x13A3u, 0LL);
        v3 = hrgnDst;
        goto LABEL_27;
      }
      SetLastError(0);
...
LABEL_27:
    ...
    v54 = v19;
LABEL_99:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D8, 0xAu, v54, v57, 0LL);
    goto LABEL_27;
  }
  v23 = *((_QWORD *)this + 46);
  v24 = 0;
  ...
  if ( RoundRectRgnCoerceInvalid )
  {
    ...
    if ( v46 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D8, 0xAu, v46, 0x1379u, 0LL);
LABEL_62:
      DeleteObject(v21);
LABEL_31:
      if ( v2 )
    ...
    if ( v47 >= 0 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D8, 0xAu, v19, v56, 0LL);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D8, 0xAu, v47, 0x137Fu, 0LL);
      v3 = hrgnDst;
    }
LABEL_28:
    if ( v3 )
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F9D8, 0xAu, v19, 0x1377u, 0LL);
  return (unsigned int)v19;
}
