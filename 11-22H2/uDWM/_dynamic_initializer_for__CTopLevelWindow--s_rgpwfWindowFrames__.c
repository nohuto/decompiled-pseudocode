/*
 * XREFs of _dynamic_initializer_for__CTopLevelWindow::s_rgpwfWindowFrames__ @ 0x180001350
 * Callers:
 *     <none>
 * Callees:
 *     ??0?$DynArray@PEAUWindowFrame@CTopLevelWindow@@$0A@@@QEAA@XZ @ 0x1800580AC (--0-$DynArray@PEAUWindowFrame@CTopLevelWindow@@$0A@@@QEAA@XZ.c)
 */
