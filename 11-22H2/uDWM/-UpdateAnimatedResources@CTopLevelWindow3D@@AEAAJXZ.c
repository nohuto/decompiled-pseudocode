/*
 * XREFs of ?UpdateAnimatedResources@CTopLevelWindow3D@@AEAAJXZ @ 0x180029050
 * Callers:
...
LABEL_29:
    ...
    v52 = v51;
    if ( v51 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v51, 0x482u, 0LL);
  ...
  if ( (v76 == 2 || v76 == 12) && v75 > 0.0 )
  {
    ...
    if ( v52 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v52, 0x466u, 0LL);
      goto LABEL_67;
    }
  }
  else
  {
    ...
    if ( v52 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v52, 0x46Au, 0LL);
LABEL_67:
      if ( v82 )
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v80, 0x46Du, 0LL);
  if ( v79 )
    CBaseObject::Release(v79);
  return v81;
}
