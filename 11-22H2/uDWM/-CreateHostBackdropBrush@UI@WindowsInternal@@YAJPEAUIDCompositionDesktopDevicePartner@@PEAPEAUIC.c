/*
 * XREFs of ?CreateHostBackdropBrush@UI@WindowsInternal@@YAJPEAUIDCompositionDesktopDevicePartner@@PEAPEAUICompositionBrush@Composition@1Windows@@@Z @ 0x18004DF20
 * Callers:
 ...
 *     ??I?$ComPtr@UIPropertyValueStatics@Foundation@Windows@@@WRL@Microsoft@@QEAA?AV?$ComPtrRef@V?$ComPtr@UIPropertyValueStatics@Foundation@Windows@@@WRL@Microsoft@@@Details@12@XZ @ 0x18004E32C (--I-$ComPtr@UIPropertyValueStatics@Foundation@Windows@@@WRL@Microsoft@@QEAA-AV-$ComPtrRef@V-$Com.c)
 *     ?put_BlurAmount@GaussianBlurEffect@Effects@Composition@UI@Internal@Microsoft@@UEAAJM@Z @ 0x18004E340 (-put_BlurAmount@GaussianBlurEffect@Effects@Composition@UI@Internal@Microsoft@@UEAAJM@Z.c)
...
LABEL_21:
  ...
  v45 = 0LL;
  v13 = *v12;
  v14 = *(__int64 **)Microsoft::WRL::ComPtr<Windows::Foundation::IPropertyValueStatics>::operator&(&v45, &v51);
...
LABEL_25:
  ...
  v48 = 0LL;
  v19 = (_QWORD *)Microsoft::WRL::ComPtr<Windows::Foundation::IPropertyValueStatics>::operator&(&v48, &v51);
...
LABEL_30:
  ...
  *(_DWORD *)(v46 + 76) = 1;
  ...
  v50 = 0LL;
  v26 = *v25;
  v27 = *(__int64 **)Microsoft::WRL::ComPtr<Windows::Foundation::IPropertyValueStatics>::operator&(&v50, &v51);
...
LABEL_35:
  ...
  v34 = *(__int64 **)Microsoft::WRL::ComPtr<Windows::Foundation::IPropertyValueStatics>::operator&(&v47, &v51);
