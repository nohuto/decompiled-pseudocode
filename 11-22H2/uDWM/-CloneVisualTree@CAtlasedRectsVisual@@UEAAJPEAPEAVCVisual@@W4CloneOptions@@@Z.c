/*
 * XREFs of ?CloneVisualTree@CAtlasedRectsVisual@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x180012AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAtlasedRectsVisual::CloneVisualTree(__int64 a1, _QWORD *a2, unsigned int a3)
{
  ...
  *a2 = 0LL;
  ...
  {
    v6 = CAtlasedRectsVisual::InitializeVisualTreeClone(a1, (__int64)v12, a3);
    v7 = v6;
    if ( v6 >= 0 )
    {
      *a2 = v12;
