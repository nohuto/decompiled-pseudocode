/*
 * XREFs of ?AdjustSnapUIArrangementStartRect@CTopLevelWindow3D@@QEAA?AUMilPointAndSizeF@@AEBU2@@Z @ 0x1800E74AC
 * Callers:
 *     ?AdjustSnapUIArrangementStartRect@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHURect@Foundation@Windows@3@PEAU4563@@Z @ 0x1800FADD0 (-AdjustSnapUIArrangementStartRect@-$produce@UTopLevelWindow3DWrapper@implementation@Transitions@.c)
 * Callees:
 *     _o_roundf_0 @ 0x18005D2EC (_o_roundf_0.c)
