/*
 * XREFs of ?ChildContentChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180050860
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
      v7 = v5;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x16FAu, 0LL);
      goto LABEL_6;
    }
    *((_QWORD *)v13 + 3) = a2;
    ...
    *(_QWORD *)(v6 + 40) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 24LL))(a2);
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x888u, 0LL);
      goto LABEL_15;
    }
  }
  v7 = v5;
  if ( v6 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x1704u, 0LL);
    }
  }
LABEL_6:
