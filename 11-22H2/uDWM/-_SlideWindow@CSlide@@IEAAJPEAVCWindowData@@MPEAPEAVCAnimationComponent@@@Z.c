/*
 * XREFs of ?_SlideWindow@CSlide@@IEAAJPEAVCWindowData@@MPEAPEAVCAnimationComponent@@@Z @ 0x1800DE680
 * Callers:
        ...
        struct CAnimationComponent **a4)
{
  ...
  v8 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v7, 0LL, 0LL, 0xFFFFFFFF, 1, &v16);
  v9 = v8;
  if ( v8 >= 0 )
  {
