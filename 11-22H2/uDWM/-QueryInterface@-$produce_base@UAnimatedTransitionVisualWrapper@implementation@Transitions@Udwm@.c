/*
 * XREFs of ?QueryInterface@?$produce_base@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@UIAnimatedTransitionVisualWrapper@345@X@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800EDE20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
