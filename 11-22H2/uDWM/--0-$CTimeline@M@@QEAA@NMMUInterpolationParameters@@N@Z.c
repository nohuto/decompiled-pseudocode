/*
 * XREFs of ??0?$CTimeline@M@@QEAA@NMMUInterpolationParameters@@N@Z @ 0x1800A27A0
 * Callers:
 ...
 * Callees:
 *     ??0CTimelineBase@@QEAA@NNNUInterpolationParameters@@N@Z @ 0x1800E51E4 (--0CTimelineBase@@QEAA@NNNUInterpolationParameters@@N@Z.c)
 */
