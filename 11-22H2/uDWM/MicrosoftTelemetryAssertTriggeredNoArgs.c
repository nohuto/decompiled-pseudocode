/*
 * XREFs of MicrosoftTelemetryAssertTriggeredNoArgs @ 0x1801111D0
 * Callers:
 ...
 *     ?AdjustFinalRectToPreserveAspectRatio@WindowMaximizeSnapTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@AEAA?AURect@Foundation@Windows@6@AEBU7896@0@Z @ 0x1800F76C4 (-AdjustFinalRectToPreserveAspectRatio@WindowMaximizeSnapTransitionHandler@implementation@Private.c)
