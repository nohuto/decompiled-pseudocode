/*
 * XREFs of ?NotifyFailure@?$test_watcher@U_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transitions@Udwm@@@tip@@EEAA_NAEBUFailureInfo@wil@@@Z @ 0x1800F5890
 * Callers:
 *     <none>
 * Callees:
