/*
 * XREFs of ?_SlideWindowVertically@CSlide@@IEAAJPEAVCWindowData@@AEBUtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800DEB44
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  v11 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 1, v10, 0LL, 0LL, 0xFFFFFFFF, 1, &v30);
  v12 = v11;
  if ( v11 >= 0 )
  {
    top = a3->top;
