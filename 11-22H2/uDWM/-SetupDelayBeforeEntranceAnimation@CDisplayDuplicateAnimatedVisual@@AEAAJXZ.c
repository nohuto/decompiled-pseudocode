/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayDuplicateAnimatedVisual@@AEAAJXZ @ 0x1800B9758
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayDuplicateAnimatedVisual@@EEAAJI@Z @ 0x1800B95E0 (-OnAnimationCompleteImpl@CDisplayDuplicateAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
