/*
 * XREFs of ??1?$list@Ubase_class_id@detail@traits@cereal@@V?$allocator@Ubase_class_id@detail@traits@cereal@@@std@@@std@@QEAA@XZ @ 0x1800F1328
 * Callers:
 *     _std::_Hash_std::_Uset_traits_cereal::traits::detail::base_class_id_std::_Uhash_compare_cereal::traits::detail::base_class_id_cereal::traits::detail::base_class_id_hash_std::equal_to_cereal::traits::detail::base_class_id____std::allocator_cereal::traits::detail::base_class_id__0___::_Hash_std::_Uset_traits_cereal::traits::detail::base_class_id_std::_Uhash_compare_cereal::traits::detail::base_class_id_cereal::traits::detail::base_class_id_hash_std::equal_to_cereal::traits::detail::base_class_id____std::allocator_cereal::traits::detail::base_class_id__0____::_1_::dtor$0 @ 0x1800F0A74 (_std--_Hash_std--_Uset_traits_cereal--traits--detail--base_class_id_std--_Uhash_compare_cereal--.c)
 * Callees:
