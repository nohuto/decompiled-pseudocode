/*
 * XREFs of ?StartShowAnimation@?$produce@UUserResizeVisual@implementation@Transitions@Udwm@winrt@@UIUserResizeVisual@345@@impl@winrt@@UEAAHXZ @ 0x180104B70
 * Callers:
 *     <none>
 * Callees:
  ...
  try
  {
    CVisual::SetOpacity(
      *(CVisual **)(*(_QWORD *)(*(_QWORD *)(((a1 - 8) & ((unsigned __int128)-(__int128)a1 >> 64)) + 0x48) + 336LL)
                  + 440LL),
      0.0);
    CTopLevelWindow3D::StartAnimation(*(_QWORD *)(v1 + 72), 0xEu);
