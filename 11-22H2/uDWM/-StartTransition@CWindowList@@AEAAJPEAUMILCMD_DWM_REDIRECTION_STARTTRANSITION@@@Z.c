/*
 * XREFs of ?StartTransition@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_STARTTRANSITION@@@Z @ 0x18000DD18
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_STARTTRANSITION *a2)
{
  ...
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0d_EtwEventWriteTransfer(v3, &UdwmBeginTransitionRequest, *((unsigned int *)a2 + 1));
  v4 = (CAnimationScheduler *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 23);
  v5 = *((_DWORD *)a2 + 1);
  ...
  if ( v7 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x14C7u, 0LL);
