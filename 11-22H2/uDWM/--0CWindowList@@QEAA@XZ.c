/*
 * XREFs of ??0CWindowList@@QEAA@XZ @ 0x18004A1B4
 * Callers:
 *     ?Initialize@CDesktopManager@@AEAAJPEAUIUnknown@@@Z @ 0x1800493DC (-Initialize@CDesktopManager@@AEAAJPEAUIUnknown@@@Z.c)
 * Callees:
 *     ??0?$CGenericSet@PEAVCWindowData@@@@QEAA@XZ @ 0x18004A320 (--0-$CGenericSet@PEAVCWindowData@@@@QEAA@XZ.c)
 */
...
CWindowList *__fastcall CWindowList::CWindowList(CWindowList *this)
{
  ...
  *(_QWORD *)this = &CWindowList::`vftable';
  RtlInitializeGenericTable(
    ...
    CGenericTableMap<unsigned __int64,CWindowList::DESKTOP_WINDOWLIST_MAP_ENTRY>::CompareTableData,
