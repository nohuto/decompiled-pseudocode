/*
 * XREFs of ?StartDelayHideAnimation@CTopLevelWindow3D@@QEAAJXZ @ 0x1800E77D4
 * Callers:
  ...
  if ( v2 >= 0 )
  {
    if ( *((_DWORD *)this + 96) != 8 )
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        v5 = started;
        if ( started < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, started, 0x1C6u);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x1C5u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x1C1u);
  }
  return v5;
}
