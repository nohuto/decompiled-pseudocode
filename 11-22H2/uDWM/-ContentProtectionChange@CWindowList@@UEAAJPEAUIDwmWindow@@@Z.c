/*
 * XREFs of ?ContentProtectionChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1801096D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ContentProtectionChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( SyncedWindowData >= 0 )
  {
    ...
    if ( v13 )
    {
      ...
      {
        *((_BYTE *)v6 + 675) = v9 ^ (v9 ^ (32 * v7)) & 0x20 ^ (v9 ^ (v9 ^ (32 * v7)) & 0x20 ^ (v8 << 6)) & 0x40;
        ...
        v5 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x172Eu);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x171Au);
  }
