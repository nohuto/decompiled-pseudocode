/*
 * XREFs of ?HitTestQuery@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_HITTESTQUERY@@@Z @ 0x18010AB5C
 * Callers:
...
__int64 __fastcall CWindowList::HitTestQuery(CWindowList *this, struct MILCMD_DWM_REDIRECTION_HITTESTQUERY *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowDataByHwnd, 0x1A4Du);
  }
