/*
 * XREFs of _CDisplaySecondaryOnlyToDuplicateAnimatedVisual::Create_::_1_::dtor$0 @ 0x1800BD765
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDisplaySecondaryOnlyToDuplicateAnimatedVisual::Create_::_1_::dtor_0(__int64 a1, __int64 a2)
{
