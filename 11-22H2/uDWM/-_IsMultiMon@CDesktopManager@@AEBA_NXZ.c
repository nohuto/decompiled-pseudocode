/*
 * XREFs of ?_IsMultiMon@CDesktopManager@@AEBA_NXZ @ 0x180046B00
 * Callers:
...
bool __fastcall CDesktopManager::_IsMultiMon(CDesktopManager *this)
{
  ...
  v1 = *((_DWORD *)this + 98);
  rc1.left = *((_DWORD *)this + 97);
  rc1.right = *((_DWORD *)this + 99) + rc1.left;
  v2 = *((_DWORD *)this + 100);
  rc1.top = v1;
  rc1.bottom = v1 + v2;
  return !EqualRect(&rc1, (const RECT *)((char *)this + 404));
}
