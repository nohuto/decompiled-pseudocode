/*
 * XREFs of ?get_local_iids@?$implements@UScreenRotationResponsiveTransitionHandler@implementation@Private@Transitions@Udwm@winrt@@U13456@UIScreenRotationResponsiveTransitionHandler@3456@@winrt@@UEBA?AU?$pair@IPEBUguid@winrt@@@std@@XZ @ 0x1800597A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
