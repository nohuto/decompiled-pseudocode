/*
 * XREFs of ?Update@CTransform3dGroupProxy@@QEAAJPEAPEAVCMatrixTransform3dProxy@@I@Z @ 0x1800E9D1C
 * Callers:
...
__int64 __fastcall CTransform3dGroupProxy::Update(CTransform3dGroupProxy *this, struct CMatrixTransform3dProxy **a2)
{
  ...
  while ( v3 );
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64 *))(**(_QWORD **)(*((_QWORD *)this + 2) + 16LL) + 872LL))(
