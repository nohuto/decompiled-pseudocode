/*
 * XREFs of ??$wnf_query_nothrow@I@wil@@YAJAEBU_WNF_STATE_NAME@@PEA_NPEAIPEAUWNF_CHANGE_STAMP_STRUCT@0@@Z @ 0x1800CAF34
 * Callers:
 ...
 * Callees:
 *     ??$ZeroStateDataIfSizeInconsistent@I@details@wil@@YAXPEAIKK@Z @ 0x18005F308 (--$ZeroStateDataIfSizeInconsistent@I@details@wil@@YAXPEAIKK@Z.c)
