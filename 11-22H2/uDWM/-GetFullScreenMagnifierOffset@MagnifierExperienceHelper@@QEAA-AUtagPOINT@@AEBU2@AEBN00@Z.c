/*
 * XREFs of ?GetFullScreenMagnifierOffset@MagnifierExperienceHelper@@QEAA?AUtagPOINT@@AEBU2@AEBN00@Z @ 0x1800CC3D4
 * Callers:
 ...
 *     ?ClampToDesktopBounds@MagnifierExperienceHelper@@AEAAXAEAUtagPOINT@@@Z @ 0x1800CC23C (-ClampToDesktopBounds@MagnifierExperienceHelper@@AEAAXAEAUtagPOINT@@@Z.c)
 ...
 *     ?GetViewportDisplacement@MagnifierExperienceHelper@@AEBAHHHHH@Z @ 0x1800CCA0C (-GetViewportDisplacement@MagnifierExperienceHelper@@AEBAHHHHH@Z.c)
