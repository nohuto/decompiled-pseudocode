/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MicaDefaultBackdrop@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18004C228
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MicaDefaultBackdrop@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18004C350 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_MicaDefaultBackdrop@@@d.c)
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_MicaDefaultBackdrop>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v4 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_MicaDefaultBackdrop>::GetCurrentFeatureEnabledState(
      a1,
      &v14,
      &v13);
    v7 = v6 != 0 ? v13 : 0;
