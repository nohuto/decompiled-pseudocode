/*
 * XREFs of ?LoadTheme@CDesktopManager@@AEAAJXZ @ 0x180055510
 * Callers:
    ...
    else
    {
      ...
      if ( CurrentThemeName >= 0 )
      {
        if ( GetSystemMetrics(95) > 0 )
          CContactManager::ForceAtlasInitialize(v17, 0xFFFFFFFFFFFFFFFFuLL, v18);
        goto LABEL_20;
      }
      pszSizeBuff = 654;
    }
...
LABEL_33:
  v21 = v9;
LABEL_37:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7F0, 1u, v21, pszSizeBuff, 0LL);
LABEL_20:
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McGenEventWrite_EtwEventWriteTransfer(
      Microsoft_Windows_Dwm_Udwm_Provider_Context,
      (__int64)&UdwmLoadTheme_End,
      v18,
      1LL,
      (__int64)v30);
  if ( v9 < 0 )
  {
    ...
    {
      v9 = -2003302654;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011F7F0, 1u, -2003302654, 0x29Du, 0LL);
    }
  }
