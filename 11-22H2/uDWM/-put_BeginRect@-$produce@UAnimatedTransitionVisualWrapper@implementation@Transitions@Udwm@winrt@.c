/*
 * XREFs of ?put_BeginRect@?$produce@UAnimatedTransitionVisualWrapper@implementation@Transitions@Udwm@winrt@@UIAnimatedTransitionVisualWrapper@345@@impl@winrt@@UEAAHURect@Foundation@Windows@3@@Z @ 0x1800EEA50
 * Callers:
 *     <none>
 * Callees:
        ...
        const __m128i *a2)
{
  ...
  v3 = (struct tagPOINT **)((a1 - 8) & ((unsigned __int128)-(__int128)a1 >> 64));
  try
  {
