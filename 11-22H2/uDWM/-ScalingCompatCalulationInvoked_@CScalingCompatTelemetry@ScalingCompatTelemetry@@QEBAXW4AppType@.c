/*
 * XREFs of ?ScalingCompatCalulationInvoked_@CScalingCompatTelemetry@ScalingCompatTelemetry@@QEBAXW4AppType@2@II@Z @ 0x180110708
 * Callers:
 ...
 *     _tlgWriteTransfer_EventWriteTransfer @ 0x180110904 (_tlgWriteTransfer_EventWriteTransfer.c)
 */
        ...
        int a4)
{
  ...
  if ( *v8 > 5u )
  {
    ...
    v16 = 4LL;
    v14 = 4LL;
    return tlgWriteTransfer_EventWriteTransfer((int)v8, (int)&dword_180127ABE, 0, 0, 5u, &v12);
  }
  return result;
}
