/*
 * XREFs of ?QueryWindowThumbnailSourceSize@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_QUERYWINDOWTHUMBNAILSOURCESIZE@@@Z @ 0x180013AEC
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_QUERYWINDOWTHUMBNAILSOURCESIZE *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowDataByHwnd, 0x13DAu, 0LL);
    goto LABEL_13;
  }
  v6 = v29;
  if ( !v29 )
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x13E3u, 0LL);
    goto LABEL_13;
  }
  *(_OWORD *)v7 = 0LL;
  *((_QWORD *)v7 + 2) = 0LL;
  ...
  *((_QWORD *)v7 + 1) = &CSWRListener::`vftable'{for `CBaseObject'};
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x13EAu, 0LL);
    goto LABEL_10;
  }
  v11 = *((_DWORD *)v28 + 24);
  v12 = *((_DWORD *)v28 + 21);
