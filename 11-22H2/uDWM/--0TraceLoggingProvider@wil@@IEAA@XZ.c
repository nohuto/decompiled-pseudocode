/*
 * XREFs of ??0TraceLoggingProvider@wil@@IEAA@XZ @ 0x18009AA1C
 * Callers:
...
wil::TraceLoggingProvider *__fastcall wil::TraceLoggingProvider::TraceLoggingProvider(wil::TraceLoggingProvider *this)
{
