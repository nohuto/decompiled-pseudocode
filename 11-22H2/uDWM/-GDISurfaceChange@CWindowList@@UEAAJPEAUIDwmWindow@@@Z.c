/*
 * XREFs of ?GDISurfaceChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180036750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::GDISurfaceChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0x173Bu, 0LL);
  }
  else
  {
    v6 = v21;
    if ( v21 )
    {
      ...
      *((_BYTE *)v6 + 673) = v7;
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x1747u, 0LL);
      }
      else
      {
        v11 = *((_QWORD *)v6 + 17);
        ...
        if ( *((_QWORD **)v6 + 5) == v12 )
        {
          ...
          v5 = updated;
          if ( updated < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x174Cu, 0LL);
        }
      }
    }
  }
