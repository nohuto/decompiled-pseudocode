/*
 * XREFs of ?_SetupHighZOrderStaticWindows@CTransitionVisualController@@IEAAJXZ @ 0x18000EF34
 * Callers:
...
LABEL_64:
      if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
      {
        ...
        McTemplateU0pp_EtwEventWriteTransfer(v32, &UdwmSystemAnimation_ZOrderClone, *((_QWORD *)v38 + 5), v35, v36);
      }
LABEL_23:
