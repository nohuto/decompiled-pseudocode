/*
 * XREFs of ?ActivationChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180035B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ActivationChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0x1669u, 0LL);
  }
  else
  {
    v6 = v9;
    if ( v9 )
    {
      *((_BYTE *)v6 + 672) ^= (*((_BYTE *)v6 + 672) ^ (2
      ...
      v5 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x166Eu, 0LL);
    }
  }
