/*
 * XREFs of ?CreateMonitorRenderTargets@CDesktopManager@@AEAAJXZ @ 0x18003BBE8
 * Callers:
 ...
 *     ??A?$DynArray@PEAVCDWMDisplay@@$0A@@@QEBAAEAPEAVCDWMDisplay@@I@Z @ 0x18003C6F8 (--A-$DynArray@PEAVCDWMDisplay@@$0A@@@QEBAAEAPEAVCDWMDisplay@@I@Z.c)
 ...
 *     ??0?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x18003DB18 (--0-$unique_any_t@V-$unique_storage@U-$handle_null_resource_policy@P6AHPEAX@Z$1-CloseHandle@@YAH.c)
 ...
 *     ??1?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x18003DF00 (--1-$unique_any_t@V-$unique_storage@U-$handle_null_resource_policy@P6AHPEAX@Z$1-CloseHandle@@YAH.c)
 *     ?IsTsDisplay@CDWMDisplay@@QEBA_NXZ @ 0x18003E6CC (-IsTsDisplay@CDWMDisplay@@QEBA_NXZ.c)
 *     ?IsWarpAdapterLuid@CDWMDXGIEnumeration@@QEBA_NU_LUID@@@Z @ 0x18003E6F4 (-IsWarpAdapterLuid@CDWMDXGIEnumeration@@QEBA_NU_LUID@@@Z.c)
 ...
 *     ?IsModeChangeAnimationEnabled@CDesktopManager@@SA_NXZ @ 0x18005F2F4 (-IsModeChangeAnimationEnabled@CDesktopManager@@SA_NXZ.c)
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x18006610C (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     memmove_0 @ 0x180066364 (memmove_0.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x1800663A0 (_guard_xfg_dispatch_icall_nop.c)
 *     ??1?$ComPtr@UICompositionProjectedShadowCasterCollection@Composition@UI@Windows@@@WRL@Microsoft@@QEAA@XZ @ 0x18006B5A4 (--1-$ComPtr@UICompositionProjectedShadowCasterCollection@Composition@UI@Windows@@@WRL@Microsoft@.c)
 *     ??I?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@@wil@@QEAAPEAPEAXXZ @ 0x18009EEEC (--I-$unique_any_t@V-$unique_storage@U-$handle_null_resource_policy@P6AHPEAX@Z$1-CloseHandle@@YAH.c)
 *     ??B?$ComPtrRef@V?$ComPtr@UIDCompositionRenderTargetPartner@@@WRL@Microsoft@@@Details@WRL@Microsoft@@QEAAPEAPEAUIDCompositionRenderTargetPartner@@XZ @ 0x1800B4088 (--B-$ComPtrRef@V-$ComPtr@UIDCompositionRenderTargetPartner@@@WRL@Microsoft@@@Details@WRL@Microso.c)
...
__int64 __fastcall CDesktopManager::CreateMonitorRenderTargets(CDWMDXGIEnumeration **this)
{
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x4A8u, 0LL);
LABEL_3:
    v5 = v78;
    goto LABEL_110;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, AllDisplaysNoRef, 0x4AAu, 0LL);
    goto LABEL_3;
  }
  v5 = v78;
  if ( v78 )
  {
    ...
    {
      if ( (unsigned __int8)IsOpenThemeDataPresent(v7) )
      {
            ...
            if ( !pvParam )
            {
              *(_OWORD *)Src = 0LL;
              ...
              if ( HasChanged )
              {
                ...
                if ( v10 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x502u, 0LL);
                  if ( v78 )
                ...
                if ( v13 )
                {
                  *((_QWORD *)v13 + 40) = v5;
                  ...
                  if ( v17 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x509u, 0LL);
...
LABEL_21:
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x50Fu, 0LL);
      goto LABEL_21;
    }
    v19 = 0;
      ...
      do
      {
          ...
          && !CDWMDisplay::IsTsDisplay((CDWMDisplay *)v20) )
        {
          ...
          if ( *(_BYTE *)(v20 + 272) )
          {
            ...
            if ( v28 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v28, 0x530u, 0LL);
LABEL_68:
              CBitmapSourceArray::~CBitmapSourceArray((CBitmapSourceArray *)&v83);
              goto LABEL_108;
            }
          ...
          *((float *)&v78 + 1) = (float)*(int *)(v20 + 60);
          ...
          if ( v30 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v30, 0x537u, 0LL);
            goto LABEL_68;
          }
...
LABEL_97:
  ...
  while ( 1 )
  {
    ...
    if ( v44 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v44, 0x592u, 0LL);
      goto LABEL_74;
    }
LABEL_78:
    ...
    *((float *)&Src[1] + 1) = (float)*(int *)(v36 + 68);
    ...
    if ( v54 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v54, 0x5A4u, 0LL);
      goto LABEL_74;
    }
    ...
    if ( v55 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v55, 0x5A6u, 0LL);
      goto LABEL_74;
    }
    if ( *(_BYTE *)(v36 + 272) )
    {
      ...
      if ( v56 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v56, 0x5AAu, 0LL);
        goto LABEL_74;
      }
    }
...
LABEL_83:
  ...
  if ( v47 >= 0 )
  {
    ...
    if ( v52 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v52, 0x59Cu, 0LL);
      goto LABEL_94;
    }
    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v78);
    goto LABEL_78;
  }
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v47, 0x599u, 0LL);
LABEL_94:
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v78);
LABEL_74:
  Microsoft::WRL::ComPtr<Windows::UI::Composition::ICompositionProjectedShadowCasterCollection>::~ComPtr<Windows::UI::Composition::ICompositionProjectedShadowCasterCollection>(&v68);
