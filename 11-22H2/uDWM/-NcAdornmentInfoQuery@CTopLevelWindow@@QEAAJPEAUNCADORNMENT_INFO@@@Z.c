/*
 * XREFs of ?NcAdornmentInfoQuery@CTopLevelWindow@@QEAAJPEAUNCADORNMENT_INFO@@@Z @ 0x180011978
 * Callers:
 ...
 *     ?D3DXVec2TransformCoord@@YAPEAUD2DVector2@@PEAU1@PEBU1@PEBUD2DMatrix@@@Z @ 0x180011B34 (-D3DXVec2TransformCoord@@YAPEAUD2DVector2@@PEAU1@PEBU1@PEBUD2DMatrix@@@Z.c)
  ...
  if ( *(_DWORD *)a2 )
  {
    switch ( *(_DWORD *)a2 )
    {
      case 1:
        ...
        break;
      case 2:
        v4 = (unsigned int *)*((_QWORD *)this + 68);
        break;
      case 3:
        v4 = (unsigned int *)*((_QWORD *)this + 69);
        break;
      default:
        if ( *(_DWORD *)a2 != 4 || (*((_DWORD *)this + 156) & 0x10000) == 0 )
          goto LABEL_16;
        v4 = (unsigned int *)*((_QWORD *)this + 72);
        break;
    }
  }
  else
...
LABEL_16:
  ...
  CVisual::GetLocalToParentVisualTransform((CVisual *)v4, *((struct CVisual **)this + 34), (struct D2DMatrix *)v18);
  v5 = _mm_cvtsi32_si128(v4[32]);
  v6 = _mm_cvtsi32_si128(v4[33]);
  v15 = 0.0;
  v16 = 0.0;
  ...
  v10 = (_DWORD *)((char *)this + ((*((_BYTE *)this + 248) & 4) != 0 ? 676LL : 660LL));
