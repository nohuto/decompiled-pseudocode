/*
 * XREFs of ?HandleHardwareExpressionActivation@CWindowList@@AEAAJK@Z @ 0x18010A860
 * Callers:
...
__int64 __fastcall CWindowList::HandleHardwareExpressionActivation(CWindowList *this, int a2)
{
  ...
  v4 = (CScreenRotation **)((char *)this + 528);
  if ( *v4 || (v5 = CScreenRotation::Create(v4), v6 = v5, v5 >= 0) )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      *((float *)v9 + 95) = GammaLUT_sRGB_to_scRGB[BYTE2(a2)] / 255.0;
      ...
      if ( v10 >= 0 )
      {
        CScreenRotation::UpdateAngle(*v4);
        v11 = CScreenRotation::Start(*v4);
        v6 = v11;
        if ( v11 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x7DEu);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x7DAu);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x7D7u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x7D2u);
  }
