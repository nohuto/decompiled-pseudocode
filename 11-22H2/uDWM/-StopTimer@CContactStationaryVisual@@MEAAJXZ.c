/*
 * XREFs of ?StopTimer@CContactStationaryVisual@@MEAAJXZ @ 0x1800B31C0
 * Callers:
 ...
 *     ?Stop@CContactStationaryVisual@@UEAAXXZ @ 0x1800B3190 (-Stop@CContactStationaryVisual@@UEAAXXZ.c)
 * Callees:
