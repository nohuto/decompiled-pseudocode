/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DWriteTitlebarText@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180054FD8
 * Callers:
...
_UNKNOWN **__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_DWriteTitlebarText>::ReportUsage(
        _DWORD *a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
