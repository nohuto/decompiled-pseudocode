/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@UTransitionBitmap@CTransitionVisualController@@$0A@@@QEAAJPEFBUTransitionBitmap@CTransitionVisualController@@I@Z @ 0x1800EA5B0
 * Callers:
