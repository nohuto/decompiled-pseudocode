/*
 * XREFs of ?CreateBitmapsFromAtlasImageStrip@CTopLevelWindow@@SAJQEAXHIPEAU_MARGINS@@PEAPEAVCBitmapSource@@@Z @ 0x180021C60
 * Callers:
        ...
        struct CBitmapSource **a5)
{
  ...
  if ( ThemeRect < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011FA00, 1u, ThemeRect, 0x3B2u, 0LL);
  ...
  if ( a4 )
  {
    ...
    if ( ThemeRect < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011FA00, 1u, ThemeRect, 0x3B6u, 0LL);
      return (unsigned int)ThemeRect;
    }
  }
  top = pRect.top;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18011FA00, 1u, -2147024882, 0x3CDu, 0LL);
  return 2147942414LL;
}
