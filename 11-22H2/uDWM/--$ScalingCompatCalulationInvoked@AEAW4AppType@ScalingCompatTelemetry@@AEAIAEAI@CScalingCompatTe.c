/*
 * XREFs of ??$ScalingCompatCalulationInvoked@AEAW4AppType@ScalingCompatTelemetry@@AEAIAEAI@CScalingCompatTelemetry@ScalingCompatTelemetry@@SAXAEAW4AppType@1@AEAI1@Z @ 0x180110344
 * Callers:
  ...
  if ( result )
  {
           ...
           &Context) )
    {
      if ( fPending )
      {
        ...
        Context = &qword_18014BE48;
        wil::TraceLoggingProvider::TraceLoggingProvider((wil::TraceLoggingProvider *)&qword_18014BE48);
        qword_18014BE48 = &ScalingCompatTelemetry::CScalingCompatTelemetry::`vftable';
