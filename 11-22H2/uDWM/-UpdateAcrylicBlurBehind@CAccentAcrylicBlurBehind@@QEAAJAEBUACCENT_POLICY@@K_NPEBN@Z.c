/*
 * XREFs of ?UpdateAcrylicBlurBehind@CAccentAcrylicBlurBehind@@QEAAJAEBUACCENT_POLICY@@K_NPEBN@Z @ 0x1800A137C
 * Callers:
 ...
 *     ?GetLuminosityOpacity@TaskbarAcrylic@@YANK@Z @ 0x18006B5BC (-GetLuminosityOpacity@TaskbarAcrylic@@YANK@Z.c)
