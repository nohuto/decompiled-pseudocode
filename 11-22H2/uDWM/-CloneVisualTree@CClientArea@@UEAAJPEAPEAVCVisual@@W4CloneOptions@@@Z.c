/*
 * XREFs of ?CloneVisualTree@CClientArea@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x180012260
 * Callers:
 *     <none>
 * Callees:
  ...
  *a2 = 0LL;
  ...
  if ( (a3 & 4) != 0 )
  {
    ...
    *(float *)&v40[3] = (float)v39.bottom;
    ...
    {
      v7 = CCachedVisualImageProxy::Update(v36, v40, &v41, 0LL, 0LL, *(_QWORD *)(a1 + 16), 0);
      v8 = v7;
      if ( v7 < 0 )
      {
        v25 = 108LL;
...
LABEL_46:
  ...
  v18 = CVisual::InitializeVisualTreeClone(a1, (__int64 *)v37, a3);
  if ( v18 < 0 )
  {
    v30 = 146LL;
    goto LABEL_46;
