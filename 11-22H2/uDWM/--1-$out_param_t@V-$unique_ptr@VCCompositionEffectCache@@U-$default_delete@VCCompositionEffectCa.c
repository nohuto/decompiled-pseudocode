/*
 * XREFs of ??1?$out_param_t@V?$unique_ptr@VCCompositionEffectCache@@U?$default_delete@VCCompositionEffectCache@@@std@@@std@@@details@wil@@QEAA@XZ @ 0x1800B3B88
 * Callers:
 *     _CDesktopManager::Initialize_::_1_::dtor$11 @ 0x180068312 (_CDesktopManager--Initialize_--_1_--dtor$11.c)
 * Callees:
