/*
 * XREFs of ?_GetLegacyModernScaleFactor@@YA?AW4DEVICE_SCALE_FACTOR@@K@Z @ 0x1801107D8
 * Callers:
 ...
 * Callees:
 *     ?LoadScalingOverrides@@YAXXZ @ 0x180055F58 (-LoadScalingOverrides@@YAXXZ.c)
  ...
  if ( g_legacyCompatScalingOverride == DEVICE_SCALE_FACTOR_INVALID )
  {
    ...
    do
    {
      if ( a1 >= *(_DWORD *)((char *)&ModernScaleFactorCutoffs + v4) )
        v2 = *(_DWORD *)((char *)&unk_18012B23C + v4);
      ++v3;
      v4 += 4LL;
    }
    while ( v3 < 2 );
