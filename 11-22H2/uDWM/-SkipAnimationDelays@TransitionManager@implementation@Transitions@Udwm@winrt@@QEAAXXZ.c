/*
 * XREFs of ?SkipAnimationDelays@TransitionManager@implementation@Transitions@Udwm@winrt@@QEAAXXZ @ 0x1800FEF98
 * Callers:
 *     ?SkipAnimationDelays@?$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotationTransitionManager@Private@345@@impl@winrt@@UEAAHXZ @ 0x1800FEF40 (-SkipAnimationDelays@-$produce@UTransitionManager@implementation@Transitions@Udwm@winrt@@UIRotat.c)
 * Callees:
