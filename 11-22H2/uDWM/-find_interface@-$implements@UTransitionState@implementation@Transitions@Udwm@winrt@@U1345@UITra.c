/*
 * XREFs of ?find_interface@?$implements@UTransitionState@implementation@Transitions@Udwm@winrt@@U1345@UITransitionStateNative@34@UITransitionStateNativePrivate@34@@winrt@@UEBAPEAXAEBUguid@2@@Z @ 0x1800FFC70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
