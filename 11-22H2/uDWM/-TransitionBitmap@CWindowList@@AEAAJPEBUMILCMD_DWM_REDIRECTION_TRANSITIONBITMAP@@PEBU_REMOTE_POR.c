/*
 * XREFs of ?TransitionBitmap@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_TRANSITIONBITMAP@@PEBU_REMOTE_PORT_VIEW@@@Z @ 0x18010D078
 * Callers:
    ...
    if ( v8 > 0 )
    {
      ...
      if ( v9 > 0 && a3->ViewSize && a3->ViewBase )
      {
        ...
        if ( (unsigned int)(v10 - 95) <= 7 )
        {
          ...
          if ( v7 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x14FDu);
        }
        else
        {
          ...
          v7 = v11;
          if ( v11 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x1509u);
        }
      }
    }
  }
