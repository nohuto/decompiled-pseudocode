/*
 * XREFs of ?OnCaptureRTBitsWorker@CMagnifier@@AEAAJ_KKPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY@@@Z @ 0x1800CA53C
 * Callers:
        ...
        struct MILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY *a5)
{
  ...
  if ( *((_DWORD *)this + 42) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1801291E8, 8LL, v6, 0x1DEu);
    }
  }
  else
  {
