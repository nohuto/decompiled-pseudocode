/*
 * XREFs of ?EnsureSnapshot@CTransitionVisualController@@QEAAJPEAVCWindowData@@@Z @ 0x18000B844
 * Callers:
 ...
 *     ?CanUseCVIFromSnapshot@CTransitionWindowSnapshot@@SA_NPEBVCWindowData@@@Z @ 0x18000F8E4 (-CanUseCVIFromSnapshot@CTransitionWindowSnapshot@@SA_NPEBVCWindowData@@@Z.c)
...
LABEL_19:
  ...
  else
  {
    ...
    if ( Clone >= *((_DWORD *)this + 12) )
    {
      ...
      {
        v28 = v6;
        inserted = CTransitionVisualController::_StageCloneWithOwnedWindows(this, v13, v33, 0xFFFFFFFFLL);
        v9 = inserted;
        if ( inserted < 0 )
        {
          v30 = 2699;
