/*
 * XREFs of ?log_failure@?$test_common_data@$0A@@details@tip@@QEAAXAEBUFailureInfo@wil@@@Z @ 0x1800F32E8
 * Callers:
 *     ?NotifyFailure@?$test_watcher@U_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transitions@Udwm@@@tip@@EEAA_NAEBUFailureInfo@wil@@@Z @ 0x1800F5890 (-NotifyFailure@-$test_watcher@U_tip_ResponsiveScreenRotationAnimationTest@Tip@Private@Transition.c)
 * Callees:
