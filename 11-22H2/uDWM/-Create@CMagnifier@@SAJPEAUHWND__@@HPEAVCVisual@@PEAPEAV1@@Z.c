/*
 * XREFs of ?Create@CMagnifier@@SAJPEAUHWND__@@HPEAVCVisual@@PEAPEAV1@@Z @ 0x1800CA2F8
 * Callers:
 ...
 *     ??0CMagnifier@@AEAA@PEAUHWND__@@HPEAVCVisual@@@Z @ 0x1800CA168 (--0CMagnifier@@AEAA@PEAUHWND__@@HPEAVCVisual@@@Z.c)
