/*
 * XREFs of ?StartActivity@AnimationClockStateChange@AnimationClockLoggingTelemetry@@QEAAXU_GUID@@HH@Z @ 0x180005B10
 * Callers:
        ...
        int a4)
{
  ...
  if ( *v9 > 4u )
  {
    ...
    v20 = 4LL;
    v18 = 8LL;
    tlgWriteTransfer_EtwEventWriteTransfer((_DWORD)v9, (unsigned int)&unk_180125398, v11 + 8, v10, 7, (__int64)v16);
  }
