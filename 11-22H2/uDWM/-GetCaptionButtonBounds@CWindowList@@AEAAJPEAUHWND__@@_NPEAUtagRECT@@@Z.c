/*
 * XREFs of ?GetCaptionButtonBounds@CWindowList@@AEAAJPEAUHWND__@@_NPEAUtagRECT@@@Z @ 0x180013CF8
 * Callers:
...
__int64 __fastcall CWindowList::GetCaptionButtonBounds(CWindowList *this, HWND a2, bool a3, struct tagRECT *a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowDataByHwnd, 0x15D9u, 0LL);
    return v9;
  }
  v10 = v24;
  if ( !v24 )
