/*
 * XREFs of ?Initialize@CapturedWindowSWRVisual@@AEAAJPEAUHWND__@@PEAUISecondaryWindowRepresentationChangedListener@@@Z @ 0x1800D0A20
 * Callers:
...
LABEL_3:
  ...
  Microsoft::WRL::ComPtr<CAtlasedImage>::InternalRelease(v8);
  LODWORD(v9) = 100;
