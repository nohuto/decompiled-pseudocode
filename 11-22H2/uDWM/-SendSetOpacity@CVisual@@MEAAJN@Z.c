/*
 * XREFs of ?SendSetOpacity@CVisual@@MEAAJN@Z @ 0x1800512C0
 * Callers:
 *     ?SetOpacity@CImage@@UEAAXN@Z @ 0x1800C3E20 (-SetOpacity@CImage@@UEAAXN@Z.c)
...
__int64 __fastcall CVisual::SendSetOpacity(CVisualProxy **this, double a2)
{
  ...
  int v10; // eax
  CBaseObject *v11; // rcx
  CBaseObject *v12; // [rsp+60h] [rbp+18h] BYREF
