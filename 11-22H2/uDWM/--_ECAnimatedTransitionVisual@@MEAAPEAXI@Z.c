/*
 * XREFs of ??_ECAnimatedTransitionVisual@@MEAAPEAXI@Z @ 0x180042B5C
 * Callers:
 *     ??_ECAnimatedTransitionVisual@@O7EAAPEAXI@Z @ 0x1800664C0 (--_ECAnimatedTransitionVisual@@O7EAAPEAXI@Z.c)
 * Callees:
