/*
 * XREFs of ?IsFeatureConfigured@details@wil@@YA_NPEAUwil_FeatureState@@I_NW4wil_FeatureStore@@PEAH@Z @ 0x1800544D0
 * Callers:
 *     ?WilApiImpl_GetFeatureEnabledState@details@wil@@YA?AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_TIME@@PEAH@Z @ 0x180054460 (-WilApiImpl_GetFeatureEnabledState@details@wil@@YA-AW4FEATURE_ENABLED_STATE@@IW4FEATURE_CHANGE_T.c)
 * Callees:
 ...
 *     wil_QueryFeatureState @ 0x18005E6D4 (wil_QueryFeatureState.c)
...
bool __fastcall wil::details::IsFeatureConfigured(__int64 a1, unsigned int a2, unsigned __int8 a3, int a4, _DWORD *a5)
{
  ...
  if ( (*v8 & 2) != 0 )
    return (*v8 & 1) != 0 && (unsigned int)wil_QueryFeatureState(a1, a2, a3, a4, 0LL, (__int64)a5) != 0;
  v10 = dword_1801485FC;
  if ( !dword_1801485FC )
  ...
  *a5 = 1;
  ...
  {
    wil::srwlock::lock_exclusive(&SRWLock, &v13);
    if ( !v10
      || v10 != dword_1801485FC
      || (v14 = 0, v15 = v8, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_180148630, &v14, 0x10uLL)) )
    {
