/*
 * XREFs of ?ScheduleEntranceAnimation@CDisplaySecondaryOnlyToExtendAnimatedVisual@@AEAAJXZ @ 0x1800BF380
 * Callers:
...
LABEL_3:
  ...
  if ( (unsigned int)dword_180147058 > 5 && (byte_180147068 & 1) != 0 && (qword_180147070 & 1) == qword_180147070 )
  {
    ...
    v13 = 8;
    v12 = &v10;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_180147058, byte_180126561, 0LL, 0LL, 3, (__int64)v11);
  }
