/*
 * XREFs of ??1?$PrettyWriter@V?$BasicOStreamWrapper@V?$basic_ostream@DU?$char_traits@D@std@@@std@@@tip_rapidjson@@U?$UTF8@D@2@U32@VCrtAllocator@2@$01@tip_rapidjson@@QEAA@XZ @ 0x1800F10D0
 * Callers:
 *     _cereal::JSONOutputArchive::JSONOutputArchive_::_1_::dtor$1 @ 0x1800F0E8C (_cereal--JSONOutputArchive--JSONOutputArchive_--_1_--dtor$1.c)
 * Callees:
