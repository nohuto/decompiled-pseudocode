/*
 * XREFs of ?CancelPendingAnimations@?$produce@UTopLevelWindow3DWrapper@implementation@Transitions@Udwm@winrt@@UITopLevelWindow3DWrapper@345@@impl@winrt@@UEAAHXZ @ 0x1800FAF40
 * Callers:
 *     <none>
 * Callees:
 *     <none>
