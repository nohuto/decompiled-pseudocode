/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x180109CF0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  CTopLevelWindow *v13; // r15
  int DesktopThumbnail; // eax
  CDesktopThumbnailBase *v15; // r14
  int updated; // eax
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x152Eu);
    goto LABEL_35;
  }
  v12 = v28;
  if ( !v28 )
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0x1538u);
    goto LABEL_35;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopThumbnail, 0x153Cu);
LABEL_27:
    v15 = v25;
    goto LABEL_28;
  }
  ...
  *((_QWORD *)v25 + 35) = *((_QWORD *)v12 + 17);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0x153Du);
    goto LABEL_28;
  }
  v31 = *a4;
      ...
      if ( v21 >= 0 )
      {
        ...
        *((_BYTE *)v10 + 345) = 0;
        ...
        if ( v22 >= 0 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v23, 0x155Eu);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0x155Bu);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x1555u);
        v10 = v26;
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, PerMonitorDesktopThumbnail, 0x153Eu);
  }
LABEL_28:
  if ( v15 )
