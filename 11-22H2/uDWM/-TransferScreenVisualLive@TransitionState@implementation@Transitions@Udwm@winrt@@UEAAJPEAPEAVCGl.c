/*
 * XREFs of ?TransferScreenVisualLive@TransitionState@implementation@Transitions@Udwm@winrt@@UEAAJPEAPEAVCGlobalTimeTrackVisual@@PEAPEAVCAnimatedTransitionVisual@@@Z @ 0x180103300
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
  ...
  v8 = *((unsigned int *)CDesktopManager::s_pDesktopManagerInstance + 100);
