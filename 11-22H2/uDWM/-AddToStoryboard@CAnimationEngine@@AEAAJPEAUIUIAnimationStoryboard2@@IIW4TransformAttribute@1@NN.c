/*
 * XREFs of ?AddToStoryboard@CAnimationEngine@@AEAAJPEAUIUIAnimationStoryboard2@@IIW4TransformAttribute@1@NNPEAN2IPEAUTA_TIMINGFUNCTION@@W4TransformMode@@22I@Z @ 0x180045498
 * Callers:
        ...
        unsigned int a15)
{
  ...
  _QWORD v37[3]; // [rsp+A0h] [rbp-11h] BYREF
  ...
  if ( TransitionVisualSetIndex >= 0 )
  {
    ...
    else
    {
      ...
      {
        v26 = *(_QWORD *)(a1 + 16);
        v27 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD *))(*(_QWORD *)v26 + 40LL);
        ...
        v16 = a2;
        v21 = ((__int64 (__fastcall *)(struct IUIAnimationStoryboard2 *, _QWORD, _QWORD))a2->lpVtbl->AddTransition)(
                a2,
                *(_QWORD *)v19,
                v37[0]);
        v22 = v21;
