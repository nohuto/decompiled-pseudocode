/*
 * XREFs of ?StyleChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180047CF0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( !(_BYTE)v88 && ((v26 = v86, v23) || (_BYTE)v86 || v24 || v70) )
    {
      try
      {
        ...
        *((_QWORD *)this + 86) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 24LL))(a2);
        winrt::Udwm::Transitions::implementation::TransitionManager::GetCurrent((__int64)&v88);
        v28 = v88;
          ...
          if ( *(_QWORD *)(v64 + 24) )
          {
            ...
            if ( v65 )
            {
              if ( (*(unsigned __int8 (__fastcall **)(CWindowList *))(*(_QWORD *)v65 + 440LL))(v65) )
              {
                ...
                {
                  if ( (*(_BYTE *)(v63 + 677) & 0x10) == 0
                    && !*(_QWORD *)(v63 + 464)
                    && (*(_BYTE *)(v63 + 676) & 2) == 0 )
                  {
                    v66 = *(_QWORD *)(v63 + 600);
                    if ( (*(_BYTE *)(v66 + 672) & 1) != 0
                      && *(_QWORD *)(v66 + 440)
                      && (*(_BYTE *)(v66 + 678) & 0x10) == 0 )
                    {
