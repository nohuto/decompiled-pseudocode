/*
 * XREFs of ?GetBorderMargins@CTopLevelWindow@@QEAAXPEAU_MARGINS@@@Z @ 0x1800E5BB0
 * Callers:
 ...
 * Callees:
 *     ?_GetRightFrameThickness@CTopLevelWindow@@AEAAHXZ @ 0x1800E7008 (-_GetRightFrameThickness@CTopLevelWindow@@AEAAHXZ.c)
 */
