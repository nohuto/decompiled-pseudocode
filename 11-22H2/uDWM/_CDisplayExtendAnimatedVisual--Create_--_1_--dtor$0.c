/*
 * XREFs of _CDisplayExtendAnimatedVisual::Create_::_1_::dtor$0 @ 0x1800BD2F5
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDisplayExtendAnimatedVisual::Create_::_1_::dtor_0(__int64 a1, __int64 a2)
{
