/*
 * XREFs of ?PreDelayExpired@CScreenRotation@@AEAAJXZ @ 0x1800D7AB4
 * Callers:
...
__int64 __fastcall CScreenRotation::PreDelayExpired(CScreenRotation *this)
{
  ...
  *(_QWORD *)((char *)this + 356) = *((_QWORD *)this + 15);
  ...
  v2 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 100);
  v3 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 99);
  if ( v3 < 0 )
    v3 = 0;
  v19.cx = v3;
  if ( v2 < 0 )
  ...
  *((_BYTE *)this + 339) = 1;
  ...
  if ( v4 )
  {
    ...
    v6 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v16, 8, 1, &v19);
    v5 = v6;
    if ( v6 < 0 )
    {
...
LABEL_21:
  ...
  v5 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x18Du);
LABEL_28:
