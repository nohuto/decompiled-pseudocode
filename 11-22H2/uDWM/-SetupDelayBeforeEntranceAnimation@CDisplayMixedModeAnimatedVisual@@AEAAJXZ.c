/*
 * XREFs of ?SetupDelayBeforeEntranceAnimation@CDisplayMixedModeAnimatedVisual@@AEAAJXZ @ 0x1800BC728
 * Callers:
 *     ?OnAnimationCompleteImpl@CDisplayMixedModeAnimatedVisual@@EEAAJI@Z @ 0x1800BC480 (-OnAnimationCompleteImpl@CDisplayMixedModeAnimatedVisual@@EEAAJI@Z.c)
 * Callees:
