/*
 * XREFs of ?QueryTrueTypeTable@PFFOBJ@@QEAAJ_KKKJKPEAEPEAPEAEPEAK@Z @ 0x1C007EB2C
 * Callers:
 ...
 *     ?bCheckFntFileInfo@PFFOBJ@@QEAAHXZ @ 0x1C00806B8 (-bCheckFntFileInfo@PFFOBJ@@QEAAHXZ.c)
