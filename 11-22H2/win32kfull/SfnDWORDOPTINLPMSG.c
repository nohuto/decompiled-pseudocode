/*
 * XREFs of SfnDWORDOPTINLPMSG @ 0x1C0206310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfnDWORDOPTINLPMSG(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  int v8; // r12d
  ...
  BOOL v35; // [rsp+C8h] [rbp-70h]
  __int64 v36; // [rsp+D0h] [rbp-68h]
  __int64 v37; // [rsp+D8h] [rbp-60h]
  ...
  *(_QWORD *)(*((_QWORD *)v11 + 60) + 80LL) = v18;
  ...
  v19 = KeUserModeCallback(4LL, &v32, 96LL, &v43, &v41);
