/*
 * XREFs of InitProcessSystemDpi @ 0x1C008A280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InitProcessSystemDpi(__int64 a1)
{
  ...
  v13 = 0;
  v12 = 0;
  FastGetProfileDwordEx(0LL, 4LL, L"EnablePerProcessSystemDPI", 0LL, 0, &v13, &v12);
  if ( v6 )
    v9 = 0;
  else
    v9 = v7 || v12 || v13 != 0;
  if ( v9 )
  {
    v10 = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(GetDispInfo(v8) + 96) + 40LL) + 64LL);
    *(_WORD *)(a1 + 284) = v10;
    return GetDPIServerInfoForDpi(v10);
  }
  else
  {
