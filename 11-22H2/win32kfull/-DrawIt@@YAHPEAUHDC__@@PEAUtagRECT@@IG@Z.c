/*
 * XREFs of ?DrawIt@@YAHPEAUHDC__@@PEAUtagRECT@@IG@Z @ 0x1C0027B88
 * Callers:
...
__int64 __fastcall DrawIt(HDC a1, struct tagRECT *a2, __int16 a3, __int16 a4)
{
  ...
  __int16 v24; // [rsp+108h] [rbp+20h] BYREF
  ...
  GreExtTextOutWInternal(a1, v17, v14, 0LL, 0LL, &v24, 1, 0LL, 0LL, 0, 1025);
  ...
  if ( v12 )
  {
    ...
    GreExtTextOutW((_DWORD)a1, v17 - 1, v14 - 1, 0, 0LL, (__int64)&v24, 1);
  }
