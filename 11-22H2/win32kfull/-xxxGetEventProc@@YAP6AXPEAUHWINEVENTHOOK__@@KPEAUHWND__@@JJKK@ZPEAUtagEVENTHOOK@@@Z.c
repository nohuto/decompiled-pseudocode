/*
 * XREFs of ?xxxGetEventProc@@YAP6AXPEAUHWINEVENTHOOK__@@KPEAUHWND__@@JJKK@ZPEAUtagEVENTHOOK@@@Z @ 0x1C009E648
 * Callers:
...
LABEL_57:
  ...
  v19 = *((int *)a1 + 18);
  v20 = *((_QWORD *)v18 + 53);
  v21 = *((_QWORD *)a1 + 8) + *(_QWORD *)(v20 + 8 * v19 + 400);
  if ( (_DWORD)v19 != -1 )
    MakeExportSuppressedPfnValid(*((_QWORD *)a1 + 8) + *(_QWORD *)(v20 + 8 * v19 + 400));
