/*
 * XREFs of xxxWindowFromPoint @ 0x1C008C498
 * Callers:
 *     NtUserWindowFromPoint @ 0x1C008C450 (NtUserWindowFromPoint.c)
 *     NtUserWindowFromPhysicalPoint @ 0x1C01E02E0 (NtUserWindowFromPhysicalPoint.c)
 * Callees:
...
struct tagWND **__fastcall xxxWindowFromPoint(struct tagPOINT a1)
{
  ...
  v24 = 0LL;
  v25 = 0LL;
  result = (struct tagWND **)GetThreadDesktopWindow(0LL);
  v3 = result;
  if ( result )
  {
