/*
 * XREFs of ?DrawBottomLogicallyLeftCorner@@YAXPEAXJHJ@Z @ 0x1C02209A4
 * Callers:
...
void __fastcall DrawBottomLogicallyLeftCorner(_DWORD *a1, int a2, int a3, int a4)
{
  ...
  if ( a3 )
  {
    ...
    while ( (__int64)v7 < (__int64)dword_1C0321224 );
  }
  else
  {
    v13 = &unk_1C03211B0;
    ...
    while ( (__int64)v13 < (__int64)dword_1C0321214 );
  }
}
