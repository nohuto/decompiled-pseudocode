/*
 * XREFs of ?bSpUpdateSprite@@YAHPEAVSPRITE@@PEAUHDC__@@PEAU_POINTL@@PEAUtagSIZE@@12KPEAU_BLENDFUNCTION@@KPEAU_RECTL@@@Z @ 0x1C00F4380
 * Callers:
 ...
 *     ?bSpUpdateAlpha@@YAHPEAVSPRITE@@PEAU_BLENDFUNCTION@@H@Z @ 0x1C027EA7C (-bSpUpdateAlpha@@YAHPEAVSPRITE@@PEAU_BLENDFUNCTION@@H@Z.c)
...
LABEL_28:
    ...
    {
      cx = *(_DWORD *)(v18 + 32);
      if ( p_BitMapHeader->cx < cx )
        cx = p_BitMapHeader->cx;
      v23 = *(_DWORD *)(v18 + 36);
      LODWORD(BitMapHeader) = cx;
      cy = p_BitMapHeader->cy;
      p_BitMapHeader = (struct tagSIZE *)&BitMapHeader;
      if ( cy < v23 )
        v23 = cy;
