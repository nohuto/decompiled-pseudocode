/*
 * XREFs of ?xxxSPISetNCMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagNONCLIENTMETRICSW@@H@Z @ 0x1C01C8170
 * Callers:
...
LABEL_10:
  ...
  *((_DWORD *)a2 + 1) = v14;
  if ( a3 )
  {
    ...
    v24 = FastWriteProfileValue(a1, 23LL, 139LL, 3LL) & v23;
    v25 = FastWriteProfileValue(a1, 23LL, 142LL, 3LL) & v24;
    v26 = FastWriteProfileValue(a1, 23LL, 145LL, 3LL) & v25;
    v27 = FastWriteProfileValue(a1, 23LL, 156LL, 3LL) & v26;
    v28 = FastWriteProfileValue(a1, 23LL, 157LL, 3LL) & v27;
