/*
 * XREFs of ?xxxCommitMoveSize@@YAXPEAUtagWND@@PEAUMOVESIZEDATA@@@Z @ 0x1C01EBC7C
 * Callers:
 ...
 *     ?ShouldGoMonitorMaximizedMoveSizeData@@YA_NPEAUMOVESIZEDATA@@@Z @ 0x1C01EA8F4 (-ShouldGoMonitorMaximizedMoveSizeData@@YA_NPEAUMOVESIZEDATA@@@Z.c)
 *     ?SwapRect@@YAXPEAUtagRECT@@0@Z @ 0x1C01EAD3C (-SwapRect@@YAXPEAUtagRECT@@0@Z.c)
...
void __fastcall xxxCommitMoveSize(struct tagWND *a1, struct MOVESIZEDATA *a2)
{
  ...
  if ( (*v2 & 0x300) != 0 || v10 )
    v3 = 1;
  Prop = (_DWORD *)GetProp((__int64)a1, *((unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Size + 1), 1LL, v11);
  if ( Prop )
  {
    ...
    else if ( v12 || IsSemiMaximized(a1) )
    {
      ...
      if ( (*v2 & 0x300) == 0x300 )
      {
        ...
        if ( *Prop <= v19 && v19 < Prop[2] )
          v18 = (struct tagWND *)MonitorFromRect((__int64)Prop, 2u, 0);
      }
...
LABEL_82:
  ...
  {
    v28 = (struct tagRECT *)GetProp((__int64)a1, *((unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Size + 1), 1LL, v9);
    if ( v28 )
    {
      if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        || (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) == 0
