/*
 * XREFs of ?MNDeleteAdjustIndexes@@YAXPEAUtagMENUSTATE@@V?$SmartObjStackRef@UtagPOPUPMENU@@@@I@Z @ 0x1C023142C
 * Callers:
 ...
 *     ?NNDeleteAdjustIndex@@YAXPEAII@Z @ 0x1C02314B4 (-NNDeleteAdjustIndex@@YAXPEAII@Z.c)
 */
