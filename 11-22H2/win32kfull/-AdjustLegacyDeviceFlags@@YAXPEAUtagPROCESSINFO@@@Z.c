/*
 * XREFs of ?AdjustLegacyDeviceFlags@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C009EE00
 * Callers:
  ...
  if ( v6 )
  {
    ...
    *(_DWORD *)(v1 + 100) = v13;
    ...
    if ( gpqForeground )
    {
      ...
      if ( v14 )
      {
        if ( (unsigned int)HasHidTable(v14) && *(_QWORD *)(*(_QWORD *)(v15 + 424) + 848LL) == v1 )
    ...
    *(_DWORD *)(v1 + 100) &= 0xFFFFFFF3;
    if ( gpqForeground )
    {
      ...
      if ( v10 )
      {
        ...
        {
          if ( *(_QWORD *)(*(_QWORD *)(v11 + 424) + 848LL) == v1 )
            UpdateRawMouseMode(gpqForeground);
        }
      }
    }
