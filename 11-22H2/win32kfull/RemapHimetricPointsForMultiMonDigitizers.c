/*
 * XREFs of RemapHimetricPointsForMultiMonDigitizers @ 0x1C01B9DD8
 * Callers:
...
__int64 __fastcall RemapHimetricPointsForMultiMonDigitizers(__int64 a1, __int64 a2, _DWORD *a3, _DWORD *a4)
{
  ...
  _BYTE v33[24]; // [rsp+48h] [rbp-70h] BYREF
  ...
  *(_OWORD *)b = *(_OWORD *)a1;
  ...
  v17 = *(__m128i *)GetMonitorRect((__int64)&v32, a2);
  v32 = v17;
  ScreenRect = (__m128i *)GetScreenRect((__int64)v33);
