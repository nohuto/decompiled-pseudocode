/*
 * XREFs of ?xxxNotifyImeShowStatus@@YAXPEAUtagWND@@@Z @ 0x1C01B8308
 * Callers:
 *     ?xxxSetIMEShowStatus@@YAHHHPEAH@Z @ 0x1C00BC394 (-xxxSetIMEShowStatus@@YAHHHPEAH@Z.c)
 *     ?xxxBroadcastImeShowStatusChange@@YAHPEAUtagWND@@H@Z @ 0x1C01B7AF4 (-xxxBroadcastImeShowStatusChange@@YAHPEAUtagWND@@H@Z.c)
 * Callees:
