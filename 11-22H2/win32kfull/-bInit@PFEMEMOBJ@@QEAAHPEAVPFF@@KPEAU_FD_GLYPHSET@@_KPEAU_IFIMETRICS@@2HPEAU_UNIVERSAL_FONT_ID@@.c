/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C0081D2C
 * Callers:
 ...
 * Callees:
 *     IsAnyCharsetDbcs @ 0x1C008215C (IsAnyCharsetDbcs.c)
