/*
 * XREFs of xxxMNOpenHierarchy @ 0x1C0218BF0
 * Callers:
                ...
                if ( Window )
                {
                        ...
                        *v81[0]) )
                  {
                    ...
                    **(_DWORD **)v81[0] &= ~0x1000u;
                    ...
                    if ( _bittest((const signed __int32 *)(*(_QWORD *)(*((_QWORD *)Window + 2) + 424LL) + 816LL), 0x14u)
                      || (v42 = Window, (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(**a1 + 16) + 40LL) + 288LL) & 0xF) == 2)
                      && (_bittest((const signed __int32 *)(*(_QWORD *)(**a1 + 16) + 320LL), 0x14u)
                       || ((*(_DWORD *)**a1 & 2) != 0 || (*(_DWORD *)**a1 & 4) != 0)
                       && (v42 = Window, (*(_DWORD *)(*(_QWORD *)(**a1 + 16) + 320LL) & 0x80000) != 0)) )
                    {
...
LABEL_51:
                    ...
                    else if ( (*(_DWORD *)(v44 + 232) & 0x400) != 0 )
                    {
                      WindowDpiLastNotify = GetWindowDpiLastNotify((__int64)v42);
                           ...
                           && (v47 = *(_QWORD *)(*((_QWORD *)Window + 2) + 456LL)) != 0
                      ...
                      if ( *(_QWORD *)(v49 + 40) )
                      {
                        if ( (unsigned int)MNGetpItemIndex(*(_QWORD *)(**a1 + 40), (__int64)v15) != -1 )
                        {
                          ...
                          **(_DWORD **)v81[0] ^= (**(_DWORD **)v81[0] ^ (v53 << 23)) & 0xF800000;
                          ...
                          {
                            v83 = *(_QWORD *)v42;
                            xxxUserModeCallback(100LL, (__int64)&v83, 8LL, v69);
                          }
