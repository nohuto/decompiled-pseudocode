/*
 * XREFs of xxxMenuWindowProc @ 0x1C021A810
 * Callers:
 *     ?xxxWrapMenuWindowProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C0151390 (-xxxWrapMenuWindowProc@@YA_JPEAUtagWND@@I_K_J1@Z.c)
 * Callees:
 ...
 *     IsPointerParentNotify @ 0x1C0117FFC (IsPointerParentNotify.c)
 ...
 *     MNDrawEdge @ 0x1C0234820 (MNDrawEdge.c)
...
LABEL_277:
        ...
        if ( !(_DWORD)v24 )
        {
          ...
          if ( !a3 || (*(_DWORD *)(i + 8) & 0x10000) != 0 )
            ...
            v120 = 1LL;
          xxxDWP_DoNCActivate(*(_QWORD *)(*(_QWORD *)v140[0] + 8LL), v120, 1LL);
          goto LABEL_245;
        }
        ...
        if ( (_DWORD)v24 )
        {
          ...
          {
            v144[0] = (__int64)*a1;
            xxxUserModeCallback(101LL, (__int64)v144, 8LL, v18);
          }
    ...
    if ( v30 )
    {
      ...
      if ( (_DWORD)v24 )
      {
        if ( (_DWORD)v24 == 1 )
        {
          ...
          xxxShowWindowEx((ULONG_PTR)a1, BYTE1(*(_DWORD *)(i + 8)) & 1 | 4, 0);
          goto LABEL_305;
        }
LABEL_164:
        if ( v9 )
