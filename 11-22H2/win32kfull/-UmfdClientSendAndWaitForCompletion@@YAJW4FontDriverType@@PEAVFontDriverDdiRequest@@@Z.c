/*
 * XREFs of ?UmfdClientSendAndWaitForCompletion@@YAJW4FontDriverType@@PEAVFontDriverDdiRequest@@@Z @ 0x1C007FC30
 * Callers:
 ...
 *     ?QueueTryResurrectPffApc@UmfdHostLifeTimeManager@@SAX_K@Z @ 0x1C02E0CCC (-QueueTryResurrectPffApc@UmfdHostLifeTimeManager@@SAX_K@Z.c)
...
__int64 __fastcall UmfdClientSendAndWaitForCompletion(__int64 a1, struct _SLIST_ENTRY *a2)
{
  ...
  unsigned int v40; // [rsp+C8h] [rbp+58h] BYREF
...
LABEL_37:
      ...
      if ( (unsigned int)_InterlockedIncrement((volatile signed __int32 *)v22) > 8 )
      {
        ...
        CEventPool::CEventPoolEntry::Destroy((PVOID)v23);
      }
      else
      {
