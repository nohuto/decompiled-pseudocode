/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x1C00A98A8
 * Callers:
 ...
 * Callees:
 *     ComputeEventEntryHash @ 0x1C00A9AF0 (ComputeEventEntryHash.c)
 *     CreateNewEventEntry @ 0x1C00A9C3C (CreateNewEventEntry.c)
 *     EnableFlushTimer @ 0x1C00A9EA8 (EnableFlushTimer.c)
 *     CompareEventEntry @ 0x1C00A9F04 (CompareEventEntry.c)
 */
