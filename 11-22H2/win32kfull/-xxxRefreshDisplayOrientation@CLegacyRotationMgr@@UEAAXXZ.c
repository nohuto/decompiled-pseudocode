/*
 * XREFs of ?xxxRefreshDisplayOrientation@CLegacyRotationMgr@@UEAAXXZ @ 0x1C0041BB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CLegacyRotationMgr::xxxRefreshDisplayOrientation(CLegacyRotationMgr *this)
{
  ...
  if ( (unsigned int)dword_1C0354098 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0354098, 0x200000000001LL) )
  {
    v16 = 0;
    v12 = dword_1C035A5DC;
    v15 = 4;
    v14 = &v12;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0354098, (unsigned __int8 *)dword_1C0319C12, 0LL, 0LL, 3u, &v13);
  }
  ...
  if ( dword_1C035A5E0 && !v6 && !dword_1C035A5E4 )
    CLegacyRotationMgr::xxxRestoreSlateAutorotationPreferences(this);
  dword_1C035A5E0 = v6 != 0;
  if ( dword_1C035A5E4 || v6 )
