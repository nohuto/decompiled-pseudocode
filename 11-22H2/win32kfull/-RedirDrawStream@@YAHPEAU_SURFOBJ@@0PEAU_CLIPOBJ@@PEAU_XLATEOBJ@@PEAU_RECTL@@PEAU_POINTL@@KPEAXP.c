/*
 * XREFs of ?RedirDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C02A4890
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DSSTATE *a9)
{
        ...
        if ( (*(_DWORD *)(HDEV + 40) & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(HDEV + 1768); i; i = *(struct _DISPSURF **)i )
          {
            ...
            if ( v22 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v22 + 1760) + 784LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, __int64, struct _CLIPOBJ *, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *, unsigned int, _DWORD *, struct _DSSTATE *))(*(_QWORD *)(v22 + 1760) + 784LL))(
                    DevBitmap,
                    v24,
                    a3,
                    a4,
  ...
  v25 = EngDrawStream((__int64)a1, (__int64)a2, (__int64)a3, (__int64)a4, (int)a5, (int *)a6, a7, a8, v14);
  if ( v28 )
    bMakeOpaque(v28);
  if ( v29 )
    bMakeOpaque(v29);
