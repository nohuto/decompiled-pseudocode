/*
 * XREFs of NtUserShutdownBlockReasonCreate @ 0x1C0048B40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
  ...
  if ( a3 )
  {
    ...
    RtlStringCchCopyW(v14, a3 + 1, (size_t *)a2);
  }
  else
  {
    *v13 = 0;
  }
  v15 = (void *)InternalRemoveProp(v8, (unsigned __int16)gatomShutdownBlockingReason, 1LL);
  if ( v15 )
    Win32FreePool(v15);
