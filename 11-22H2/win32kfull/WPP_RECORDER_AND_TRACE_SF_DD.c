/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_Dd @ 0x1C01C8734
 * Callers:
        ...
        ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_de8dbbd74b6f3353e3dc754537999fe8_Traceguids,
               13LL,
               (__int64 *)va,
               4LL,
               va1,
  ...
  {
    LOWORD(v11) = 13;
    return WppAutoLogTrace(a4, 4LL, 2LL, &WPP_de8dbbd74b6f3353e3dc754537999fe8_Traceguids, v11, (__int64 *)va, 4LL, va1);
  }
  return result;
}
