/*
 * XREFs of ?vSpZorderSprite@@YAXPEAUHDEV__@@PEAVSPRITE@@1@Z @ 0x1C001D7E4
 * Callers:
 ...
 * Callees:
 *     ?vSpRenumberZOrder@@YAXPEAU_SPRITESTATE@@@Z @ 0x1C001D968 (-vSpRenumberZOrder@@YAXPEAU_SPRITESTATE@@@Z.c)
...
void __fastcall vSpZorderSprite(HDEV a1, struct SPRITE *a2, struct SPRITE *a3)
{
  ...
  __int64 v12; // rcx
  __int64 v13; // rax
  _BYTE v14[192]; // [rsp+20h] [rbp-D8h] BYREF
  ...
  SPRITEDDIACCESS::~SPRITEDDIACCESS((SPRITEDDIACCESS *)v14);
}
