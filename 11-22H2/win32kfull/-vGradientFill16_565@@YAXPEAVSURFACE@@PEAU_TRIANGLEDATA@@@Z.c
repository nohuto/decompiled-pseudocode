/*
 * XREFs of ?vGradientFill16_565@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02F9120
 * Callers:
 *     <none>
 * Callees:
 *     <none>
      ...
      if ( *((_QWORD *)v3 + 9) <= (unsigned __int64)(v15 + v7) && v15 < v10 )
      {
        ...
        if ( (unsigned __int64)v17 < v18 )
        {
          ...
          do
          {
            ...
            v25 = HIDWORD(v13);
            v13 += v31;
            v26 = byte_1C03297A0[(unsigned __int64)(v22 + ((unsigned int)v25 >> 10)) >> 16] | (unsigned __int16)(v24 << 6);
            v27 = HIDWORD(v12);
            v12 += v32;
