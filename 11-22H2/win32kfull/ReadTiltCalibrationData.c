/*
 * XREFs of ReadTiltCalibrationData @ 0x1C01A559C
 * Callers:
 ...
 *     ?GetTiltKeyName@@YAJU_UNICODE_STRING@@PEAPEAGH@Z @ 0x1C01A471C (-GetTiltKeyName@@YAJU_UNICODE_STRING@@PEAPEAGH@Z.c)
    ...
    if ( TiltKeyName >= 0 )
    {
      ...
      do
      {
        *(_QWORD *)&v14.Length = 91750400LL;
        ...
        TiltKeyName = RtlUnicodeStringCatString(&v14, off_1C030B848[v10]);
        if ( TiltKeyName >= 0 )
        {
          v12 = v20[v10];
          v13 = v21[v10];
