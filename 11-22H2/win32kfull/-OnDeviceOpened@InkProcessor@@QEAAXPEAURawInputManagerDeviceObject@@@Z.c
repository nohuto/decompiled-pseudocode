/*
 * XREFs of ?OnDeviceOpened@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C023E3D0
 * Callers:
 ...
 *     ?OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C0227DF0 (-OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
