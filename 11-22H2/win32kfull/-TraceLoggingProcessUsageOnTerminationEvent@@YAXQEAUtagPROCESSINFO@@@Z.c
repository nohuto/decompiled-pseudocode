/*
 * XREFs of ?TraceLoggingProcessUsageOnTerminationEvent@@YAXQEAUtagPROCESSINFO@@@Z @ 0x1C001396C
 * Callers:
 *     DestroyProcessInfoEditionRundown @ 0x1C00AB270 (DestroyProcessInfoEditionRundown.c)
 * Callees:
