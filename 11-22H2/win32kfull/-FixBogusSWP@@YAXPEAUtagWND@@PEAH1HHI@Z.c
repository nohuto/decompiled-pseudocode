/*
 * XREFs of ?FixBogusSWP@@YAXPEAUtagWND@@PEAH1HHI@Z @ 0x1C01A5DB4
 * Callers:
...
void __fastcall FixBogusSWP(struct tagWND **a1, int *a2, int *a3, int a4, int a5, char a6)
{
  ...
  if ( v10 != *(struct tagMONITOR **)(GetDispInfo(v11) + 96) )
  {
    ...
    {
      v21 = 0LL;
      v14 = *(_OWORD *)GetMonitorRect((__int64)v22, (__int64)v10);
      v15 = a1[15];
      v22[0] = v14;
      IntersectRect(&v21, (int *)v22, (int *)(*((_QWORD *)v15 + 5) + 88LL));
