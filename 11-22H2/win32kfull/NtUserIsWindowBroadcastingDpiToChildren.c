/*
 * XREFs of NtUserIsWindowBroadcastingDpiToChildren @ 0x1C00A7660
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall NtUserIsWindowBroadcastingDpiToChildren(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rax
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  if ( v4 )
  {
    ...
    *((_QWORD *)&v16 + 1) = v10;
    HMLockObject(v10);
    v9 = IsWindowBroadcastingDpiToChildrenX(v10);
