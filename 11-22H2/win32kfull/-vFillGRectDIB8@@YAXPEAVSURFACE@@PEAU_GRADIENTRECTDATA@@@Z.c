/*
 * XREFs of ?vFillGRectDIB8@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02F88B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vFillGRectDIB8(struct SURFACE *a1, struct _GRADIENTRECTDATA *a2)
{
  ...
  v5 = *((_DWORD *)v2 + 9);
  v6 = (unsigned __int8 *)&unk_1C0329CA0;
  v7 = byte_1C0329AE0;
  v8 = v4;
  v49 = v5;
  v9 = (unsigned __int8 *)&unk_1C0329820;
  v37 = *((_DWORD *)a1 + 22);
  v10 = (unsigned __int8 *)&unk_1C0329DA0;
  v51 = v5 + *((_DWORD *)v2 + 11);
  v35 = (unsigned __int8 *)&unk_1C0329CA0;
  ...
  {
    v9 = byte_1C0329AE0;
    v10 = (unsigned __int8 *)&unk_1C0329CA0;
  }
