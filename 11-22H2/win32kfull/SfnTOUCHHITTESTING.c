/*
 * XREFs of SfnTOUCHHITTESTING @ 0x1C020FF10
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v16 = 0LL;
  result = AllocCallbackMessage(88, 1u, 48LL, v51, 1, 0x200uLL);
  v22 = result;
  ...
  if ( result )
  {
    ...
    *((_DWORD *)v22 + 12) = a2;
    *((_QWORD *)v22 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v22, a4, 0x30u, (void **)v22 + 8) < 0 )
      goto LABEL_21;
    *((_QWORD *)v22 + 9) = a5;
    *((_QWORD *)v22 + 10) = a6;
    ThreadLock(a1, &v48);
    ...
    *((_QWORD *)v22 + 2) = 0LL;
    v29 = KeUserModeCallback(115LL, v22, *(unsigned int *)v22, &v41, &v39);
