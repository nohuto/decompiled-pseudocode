/*
 * XREFs of ?Free@?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C00AF42C
 * Callers:
 ...
 * Callees:
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0DJAAA@$0DJA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C00AF4F8 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0DJAAA@$0DJA@@NSInstrumentation@@QEAA-AW4Alloc.c)
