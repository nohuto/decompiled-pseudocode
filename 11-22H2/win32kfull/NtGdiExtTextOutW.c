/*
 * XREFs of NtGdiExtTextOutW @ 0x1C0118A60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
    if ( Src )
    {
      ...
      {
        v19 = &Src[v14];
        if ( (unsigned __int64)v19 > MmUserProbeAddress || v19 < Src )
    ...
    v26 = GreExtTextOutWInternal(a1, a2, a3, v20, v11, v22, a7, v13, v35, a9, 24);
    EUDCCountRegion::~EUDCCountRegion((EUDCCountRegion *)v37);
    if ( v17 )
