/*
 * XREFs of ?DestroyPhysicalMonitor@CMonitorAPI@@QEAAJPEAX@Z @ 0x1C0269DA0
 * Callers:
 *     DestroyPhysicalMonitor @ 0x1C026A200 (DestroyPhysicalMonitor.c)
 *     NtGdiDestroyPhysicalMonitor @ 0x1C026A600 (NtGdiDestroyPhysicalMonitor.c)
 * Callees:
