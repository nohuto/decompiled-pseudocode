/*
 * XREFs of ?xxxMouseActivate@@YAHPEAUtagTHREADINFO@@PEAUtagWND@@PEBUtagQMSG@@H@Z @ 0x1C0041F3C
 * Callers:
...
LABEL_45:
      if ( (v15 != *(struct tagWND **)(v18 + 128) || (*(_DWORD *)(v18 + 396) & 0x8000) != 0)
        && !(unsigned __int8)xxxActivateWindowWithOptions(v15, 3LL, 49LL, *(_DWORD *)(v18 + 156) != 0)
