/*
 * XREFs of ?hCreate@COLORTRANSFORMOBJ@@QEAAPEAXAEAVXDCOBJ@@PEAUtagLOGCOLORSPACEW@@PEAXK2K2K@Z @ 0x1C029A94C
 * Callers:
 ...
 *     ?bAddColorTransform@XDCOBJ@@QEAAHPEAX@Z @ 0x1C029A640 (-bAddColorTransform@XDCOBJ@@QEAAHPEAX@Z.c)
