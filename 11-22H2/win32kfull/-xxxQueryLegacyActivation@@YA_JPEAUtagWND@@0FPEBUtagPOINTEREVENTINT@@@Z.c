/*
 * XREFs of ?xxxQueryLegacyActivation@@YA_JPEAUtagWND@@0FPEBUtagPOINTEREVENTINT@@@Z @ 0x1C01C6724
 * Callers:
        ...
        const struct tagPOINTEREVENTINT *a4)
{
  ...
  v5 = a3;
  v7 = 3LL;
  if ( !*(_QWORD *)(*(_QWORD *)(BugCheckParameter2[2] + 432) + 112LL) )
  {
