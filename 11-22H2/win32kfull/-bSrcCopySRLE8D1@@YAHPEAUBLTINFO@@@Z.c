/*
 * XREFs of ?bSrcCopySRLE8D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02EDCF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSrcCopySRLE8D1(struct BLTINFO *a1)
{
  ...
  v57 = byte_1C0329620[v2 & 7];
  v58 = (unsigned int)(v7 - 1) >> 3;
  v56 = ~byte_1C0329620[v7 & 7];
  if ( v5 >= v10 )
    goto LABEL_10;
  if ( v8 < v2 )
  {
    if ( v8 < v7 )
    {
      v12 = byte_1C0329620[v2 & 7] & *(_BYTE *)(((unsigned int)v2 >> 3) + v4);
      goto LABEL_10;
    }
    goto LABEL_8;
  }
...
LABEL_8:
  ...
  v12 = byte_1C0329620[v8 & 7] & *(_BYTE *)((unsigned int)(v8 >> 3) + v4);
LABEL_10:
  v13 = 1;
  for ( i = 1LL; i < 256; ++i )
  {
  ...
  while ( 1 )
  {
    ...
    if ( v5 < v45 && v8 < v7 && (int)v16 + v8 > v2 )
    {
      ...
      if ( (unsigned __int8)(7 - v34) < (unsigned __int8)v16 )
      {
        ...
        v41 = *((_BYTE *)&unk_1C0329627 - (unsigned __int8)v36);
        if ( v37 )
          v42 = ~v41 | v12;
        else
          v42 = v41 & v12;
...
LABEL_90:
  ...
  if ( !(_DWORD)v19 )
  {
    if ( v5 < v45 && (v8 & 7) != 0 )
    {
      ...
      {
        *(_BYTE *)(v18 + v4) = v12 | *(_BYTE *)(v18 + v4) & ~byte_1C0329620[v8 & 7];
        goto LABEL_61;
      }
