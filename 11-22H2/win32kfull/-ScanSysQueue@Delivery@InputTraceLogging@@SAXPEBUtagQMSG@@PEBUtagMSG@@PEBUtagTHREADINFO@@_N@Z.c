/*
 * XREFs of ?ScanSysQueue@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@PEBUtagMSG@@PEBUtagTHREADINFO@@_N@Z @ 0x1C0116B00
 * Callers:
        ...
        unsigned __int8 a4)
{
  ...
  else if ( (unsigned int)dword_1C0359080 > 4 && v4 == 255 )
  {
    if ( tlgKeywordOn((__int64)&dword_1C0359080, 16LL) )
    {
