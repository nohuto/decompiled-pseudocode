/*
 * XREFs of _GetSendMessageReceiver @ 0x1C01FBCC4
 * Callers:
 *     NtUserGetSendMessageReceiver @ 0x1C01D3DE0 (NtUserGetSendMessageReceiver.c)
 * Callees:
...
LABEL_8:
  ...
  if ( (unsigned __int8)CheckAccess(v5 + 888, v4 + 888) )
    goto LABEL_8;
LABEL_5:
