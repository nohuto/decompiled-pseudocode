/*
 * XREFs of NtUserGetWindowProcessHandle @ 0x1C00AFD50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v7 )
  {
    ...
    if ( *(_QWORD *)(v11 + 456) == *((_QWORD *)v10 + 57) )
    {
      if ( v3 == 120 || (unsigned int)IsShellProcess(*((_QWORD *)v10 + 53)) && v3 == 4096 )
      {
        ...
        if ( v17 )
        {
          if ( !(unsigned __int8)CheckAccess(v19 + 888, v18 + 888) )
          {
        ...
        else if ( *(_DWORD *)(v18 + 772) != *(_DWORD *)(v19 + 772) || *(_DWORD *)(v18 + 776) != *(_DWORD *)(v19 + 776) )
        {
          goto LABEL_7;
        }
