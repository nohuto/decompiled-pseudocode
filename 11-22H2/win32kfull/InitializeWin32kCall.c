/*
 * XREFs of InitializeWin32kCall @ 0x1C00BEE7C
 * Callers:
 *     EditionBaseDriverEntryInitialize @ 0x1C00BEDF0 (EditionBaseDriverEntryInitialize.c)
 * Callees:
 *     ?SetWin32kSilo@@YAPEAU_EJOB@@AEAPEAX@Z @ 0x1C00BEF2C (-SetWin32kSilo@@YAPEAU_EJOB@@AEAPEAX@Z.c)
