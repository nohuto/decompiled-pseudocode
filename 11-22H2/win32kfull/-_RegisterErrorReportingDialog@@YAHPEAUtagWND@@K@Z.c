/*
 * XREFs of ?_RegisterErrorReportingDialog@@YAHPEAUtagWND@@K@Z @ 0x1C01F4150
 * Callers:
 *     NtUserRegisterErrorReportingDialog @ 0x1C01D9340 (NtUserRegisterErrorReportingDialog.c)
 * Callees:
