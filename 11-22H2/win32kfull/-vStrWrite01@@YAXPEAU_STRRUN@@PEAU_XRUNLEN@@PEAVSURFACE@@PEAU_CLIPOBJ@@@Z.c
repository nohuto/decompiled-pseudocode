/*
 * XREFs of ?vStrWrite01@@YAXPEAU_STRRUN@@PEAU_XRUNLEN@@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C0053D40
 * Callers:
 *     <none>
 * Callees:
    ...
    while ( 1 )
    {
      ...
      *v41 = v43;
      ...
      if ( v48 != v50 )
        break;
      v52 = *v40;
      v53 = dword_1C03294E0[v49] & ~dword_1C03294E0[v51];
      v54 = 1;
      v5 = a3;
      do
      {
