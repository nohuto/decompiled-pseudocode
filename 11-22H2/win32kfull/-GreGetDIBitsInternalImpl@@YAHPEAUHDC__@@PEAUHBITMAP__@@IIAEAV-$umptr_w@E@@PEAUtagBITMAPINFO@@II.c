/*
 * XREFs of ?GreGetDIBitsInternalImpl@@YAHPEAUHDC__@@PEAUHBITMAP__@@IIAEAV?$umptr_w@E@@PEAUtagBITMAPINFO@@III@Z @ 0x1C002F6C0
 * Callers:
 ...
 *     GreGetDIBitsInternal @ 0x1C02DE6B0 (GreGetDIBitsInternal.c)
 * Callees:
