/*
 * XREFs of ?greenloop@INVCMAP@@QEAAHH@Z @ 0x1C02A3B2C
 * Callers:
 *     ?redloop@INVCMAP@@QEAAHXZ @ 0x1C02A3F2C (-redloop@INVCMAP@@QEAAHXZ.c)
 * Callees:
 *     ?blueloop@INVCMAP@@QEAAHH@Z @ 0x1C02A3994 (-blueloop@INVCMAP@@QEAAHH@Z.c)
 */
