/*
 * XREFs of AdjustPwndPtiPqForDelegation @ 0x1C0060D1C
 * Callers:
 ...
 *     ?PostHidNotification@@YAHPEAUtagPROCESS_HID_REQUEST@@PEAUDEVICEINFO@@I_K@Z @ 0x1C009FEC0 (-PostHidNotification@@YAHPEAUtagPROCESS_HID_REQUEST@@PEAUDEVICEINFO@@I_K@Z.c)
 *     EditionHandleAltTab @ 0x1C00BDAD0 (EditionHandleAltTab.c)
 *     EditionPostMouseWheelToForeground @ 0x1C01B6750 (EditionPostMouseWheelToForeground.c)
