/*
 * XREFs of ?BltLnkRect@@YAXPEAU_BLTLNKINFO@@PEAU_RECTL@@@Z @ 0x1C0090C20
 * Callers:
 ...
 *     ?BltLnkAccel6666@@YAXPEAE0JJJJ@Z @ 0x1C030430C (-BltLnkAccel6666@@YAXPEAE0JJJJ@Z.c)
 *     ?BltLnkAccel8888@@YAXPEAE0JJJJ@Z @ 0x1C03043AC (-BltLnkAccel8888@@YAXPEAE0JJJJ@Z.c)
 *     ?BltLnkAccelEEEE@@YAXPEAE0JJJJ@Z @ 0x1C0304454 (-BltLnkAccelEEEE@@YAXPEAE0JJJJ@Z.c)
 */
...
LABEL_22:
    ...
    if ( *((_DWORD *)a1 + 55) )
    {
      if ( *((_DWORD *)a1 + 54) )
      {
        if ( *v109 )
        {
          v103 = off_1C030A1B0[*((_BYTE *)a1 + 228) & 0xF];
          v119 = off_1C030A1B0[(unsigned __int64)*((unsigned __int8 *)a1 + 228) >> 4];
          v95 = v17;
          v70 = v82;
          while ( v81-- )
          {
        ...
        else
        {
          ...
          v102 = off_1C030A1B0[*((_DWORD *)a1 + 51) & 0xF];
          v94 = v17;
          v66 = v82;
          while ( v81-- )
          {
      ...
      {
        v101 = off_1C030A1B0[*((_DWORD *)a1 + 52) & 0xF];
        v53 = v97;
        if ( !v97 )
        {
          if ( *(_DWORD *)(*(_QWORD *)v118 + 96LL) == 5 )
    ...
    {
      v100 = off_1C030A1B0[*((_BYTE *)a1 + 228) & 0xF];
