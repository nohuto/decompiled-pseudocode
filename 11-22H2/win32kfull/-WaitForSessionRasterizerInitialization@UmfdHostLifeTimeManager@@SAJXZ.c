/*
 * XREFs of ?WaitForSessionRasterizerInitialization@UmfdHostLifeTimeManager@@SAJXZ @ 0x1C01110BC
 * Callers:
 ...
 *     NtGdiWaitForTextReady @ 0x1C00BD7B0 (NtGdiWaitForTextReady.c)
 *     GreWaitForTextReady @ 0x1C00BE950 (GreWaitForTextReady.c)
