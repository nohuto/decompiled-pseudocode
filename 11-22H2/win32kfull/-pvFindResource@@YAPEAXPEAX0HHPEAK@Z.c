/*
 * XREFs of ?pvFindResource@@YAPEAXPEAX0HHPEAK@Z @ 0x1C00A716C
 * Callers:
 *     cParseFontResources @ 0x1C0074268 (cParseFontResources.c)
 *     ?LOADSTRING@@YAHPEAXIPEAGH@Z @ 0x1C0085F28 (-LOADSTRING@@YAHPEAXIPEAGH@Z.c)
 *     EngFindResource @ 0x1C0279600 (EngFindResource.c)
 * Callees:
 *     <none>
 */
