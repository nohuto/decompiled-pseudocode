/*
 * XREFs of ?vStrWrite04@@YAXPEAU_STRRUN@@PEAU_XRUNLEN@@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02E3430
 * Callers:
 *     <none>
 * Callees:
            ...
            do
            {
              ...
              if ( v49 < v51 )
              {
                ...
                do
                {
                  ...
                  if ( v49 >= si128.left && v49 < si128.right )
                    v55 = v55 & ~dword_1C0319768[v57] | dword_1C0319768[v57] & (*v58 << dword_1C0319748[v57]);
                  ++v53;
                  ++v57;
                  ++v58;
                  v62 = v53;
      ...
      for ( i = v8; v5 != (int *)a2; v66 = v5 )
      {
        ...
        if ( *v5 < v10 )
        {
          ...
          if ( (unsigned __int64)v11 < *((_QWORD *)a3 + 9) + (unsigned __int64)*((unsigned int *)a3 + 16) )
          {
            ...
            do
            {
              v18 = dword_1C0319768[v15];
              ++v13;
              v19 = *v16;
              ++v9;
              v20 = dword_1C0319748[v15];
              ++v16;
              ++v15;
          ...
          *v12 = v14;
          ...
          if ( v21 > 1 )
          {
            ...
            if ( v22 == v25 )
            {
              v28 = *v11;
              v29 = 1;
              v30 = dword_1C03294E0[v26] & ~dword_1C03294E0[v27];
              do
              {
                ++v29;
            ...
            else
            {
              ...
              {
                v31 = 1;
                v32 = dword_1C03294E0[(unsigned int)v26];
                v33 = *v11 & v32;
                v34 = ~v32;
                do
                {
