/*
 * XREFs of ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C0048044
 * Callers:
...
_BOOL8 __fastcall GetFlickMap(struct tagFLICK_MAP *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v20[14] = (char *)a1 + 112;
  v20[2] = (char *)a1 + 16;
  if ( (unsigned int)RIMIsDefaultUILanguageRTL(a1, a2, a3, a4) != dword_1C0354014 )
  {
    v16 = xmmword_1C0354268;
    xmmword_1C0354268 = xmmword_1C0354208;
    dword_1C0354014 = dword_1C0354014 == 0;
    xmmword_1C0354208 = v16;
  }
...
LABEL_2:
    ...
    *(_OWORD *)a1 = xmmword_1C0354208;
    *v4 = xmmword_1C0354220;
    *((_OWORD *)a1 + 2) = xmmword_1C0354238;
    *((_OWORD *)a1 + 3) = xmmword_1C0354250;
    *((_OWORD *)a1 + 4) = xmmword_1C0354268;
    *((_OWORD *)a1 + 5) = xmmword_1C0354280;
    *((_OWORD *)a1 + 6) = xmmword_1C0354298;
    *((_OWORD *)a1 + 7) = xmmword_1C03542B0;
  }
