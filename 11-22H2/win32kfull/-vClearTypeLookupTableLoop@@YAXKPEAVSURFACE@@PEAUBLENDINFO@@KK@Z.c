/*
 * XREFs of ?vClearTypeLookupTableLoop@@YAXKPEAVSURFACE@@PEAUBLENDINFO@@KK@Z @ 0x1C003A030
 * Callers:
  ...
  *(_QWORD *)(v25 + 464) = v10;
  ...
  do
  {
    ...
    v22 = *((_DWORD *)a3 + 6) & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v13
                                                                                  + ((dword_1C0316F10[*v20] * v14
                                                                                    + 0x80000) >> 20))
                                                                   + v21) << *((_DWORD *)a3 + 1)) >> *(_DWORD *)a3) | *((_DWORD *)a3 + 7) & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v15 + ((dword_1C0316F10[v20[1]] * v16 + 0x80000) >> 20)) + v21) << *((_DWORD *)a3 + 3)) >> *((_DWORD *)a3 + 2)) | *((_DWORD *)a3 + 8) & ((unsigned int)(*(unsigned __int8 *)((unsigned int)(v17 + ((dword_1C0316F10[v20[2]] * v19 + 0x80000) >> 20)) + v21) << *((_DWORD *)a3 + 5)) >> *((_DWORD *)a3 + 4));
    if ( v23 == 2 )
      *v9 = v22;
    else
      *v18 = v22;
