/*
 * XREFs of ?ImeCanDestroyDefIMEforChild@@YAHPEAUtagWND@@0@Z @ 0x1C00B2BC0
 * Callers:
 ...
 *     ?IsChildSameThread@@YAHPEAUtagWND@@0@Z @ 0x1C01B785C (-IsChildSameThread@@YAHPEAUtagWND@@0@Z.c)
 */
