/*
 * XREFs of ?GreLineTo@@YAHPEAUHDC__@@HH@Z @ 0x1C02AA938
 * Callers:
...
__int64 __fastcall GreLineTo(HDC a1, LONG a2, LONG a3)
{
  ...
  struct _XFORMOBJ v68[2]; // [rsp+B0h] [rbp-50h] BYREF
  ...
  if ( v62[0] )
  {
    if ( (*((_DWORD *)v62[0] + 9) & 0x10000) == 0 )
    {
      ...
      if ( (v9->fl & 0xB) != 0
        || (*((_DWORD *)v7 + 62) & 1) != 0
        || (*(_DWORD *)(*(_QWORD *)&v68[0].ulReserved + 32LL) & 2) == 0
...
LABEL_63:
              ...
              if ( (unsigned int)EPATHOBJ::bPolyLineTo((EPATHOBJ *)&ppo, (struct EXFORMOBJ *)v68, &v65, 1u) )
              {
                ...
                *(_DWORD *)(*((_QWORD *)v57 + 122) + 12LL) = *(_DWORD *)(*(_QWORD *)&Current + 4LL);
                if ( (*((_DWORD *)v62[0] + 62) & 1) == 0
                  && !(unsigned int)EPATHOBJ::bStrokeAndOrFill(&ppo, (POINTL **)v62, v9, v68, 1u) )
                {
                  v5 = 0;
                }
              }
        ...
        if ( (*(_DWORD *)(*(_QWORD *)&v68[0].ulReserved + 32LL) & 2) != 0 )
        {
          v17 = *((_QWORD *)v62[0] + 122);
          v18 = *(int *)(*(_QWORD *)&v68[0].ulReserved + 24LL) >> 4;
          v19 = *(int *)(*(_QWORD *)&v68[0].ulReserved + 28LL) >> 4;
          v20 = v19 + v4;
          v21 = v3 + v18;
