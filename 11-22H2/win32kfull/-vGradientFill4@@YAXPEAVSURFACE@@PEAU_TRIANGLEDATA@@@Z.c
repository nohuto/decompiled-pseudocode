/*
 * XREFs of ?vGradientFill4@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02F9FE0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Xlate555 )
  {
    ...
    if ( v5 < v13 )
    {
      ...
      do
      {
        ...
        v30 = v17;
        v21 = v33;
        v39 = (char *)&unk_1C0329CA0 + 16 * (((_BYTE)v5 + (_BYTE)v14) & 0xFu);
        if ( v16 < v17 )
        {
          ...
          do
          {
            ...
            v27 = *v23;
            v28 = v11[Xlate555[((unsigned __int64)byte_1C0329AE0[v26 + HIBYTE(v20)] >> 3) | (4
                                                                                           * (byte_1C0329AE0[v26 + HIBYTE(v19)] & 0xF8 | (32LL * (byte_1C0329AE0[v26 + HIBYTE(v18)] & 0xF8))))]];
            if ( v24 )
            {
              v24 = 0;
              ++v23;
