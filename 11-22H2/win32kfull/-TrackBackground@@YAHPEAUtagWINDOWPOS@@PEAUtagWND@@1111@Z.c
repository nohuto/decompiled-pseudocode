/*
 * XREFs of ?TrackBackground@@YAHPEAUtagWINDOWPOS@@PEAUtagWND@@1111@Z @ 0x1C0025CC8
 * Callers:
 ...
 *     ?IsLastTopMostWindow@@YAHPEBUtagWND@@@Z @ 0x1C00BD364 (-IsLastTopMostWindow@@YAHPEBUtagWND@@@Z.c)
