/*
 * XREFs of ?SetImeHotKey@@YAHKIIPEAUHKL__@@K@Z @ 0x1C00A2004
 * Callers:
 *     NtUserSetImeHotKey @ 0x1C00A1F90 (NtUserSetImeHotKey.c)
 * Callees:
 *     ?FindImeHotKeyByID@@YAPEAU_tagIMEHOTKEYOBJ@@PEBU1@K@Z @ 0x1C00A2194 (-FindImeHotKeyByID@@YAPEAU_tagIMEHOTKEYOBJ@@PEBU1@K@Z.c)
