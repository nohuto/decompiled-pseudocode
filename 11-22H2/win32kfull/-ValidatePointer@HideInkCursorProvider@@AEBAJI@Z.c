/*
 * XREFs of ?ValidatePointer@HideInkCursorProvider@@AEBAJI@Z @ 0x1C0242B9C
 * Callers:
        ...
        __int64 a4)
{
  ...
  __int64 v9; // r8
  __int64 v10; // r9
  const struct tagPOINTER_INFO *v12; // [rsp+50h] [rbp+10h] BYREF
  ...
  {
    v8 = *(_QWORD *)(HMValidateHandleNoSecure(*((_QWORD *)v12 + 2), 19) + 472);
    if ( *(_DWORD *)(v8 + 24) != 5 )
    {
      v7 = -1073741811;
  ...
  else if ( (unsigned int)dword_1C03540E0 > 2 )
  {
    ...
    v13 = (__int64)"Wrong thread (or invalid pointer id)";
