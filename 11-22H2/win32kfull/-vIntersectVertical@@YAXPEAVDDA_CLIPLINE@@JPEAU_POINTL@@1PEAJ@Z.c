/*
 * XREFs of ?vIntersectVertical@@YAXPEAVDDA_CLIPLINE@@JPEAU_POINTL@@1PEAJ@Z @ 0x1C02F4428
 * Callers:
 ...
 *     ?yCompute@DDA_CLIPLINE@@QEAAJJ@Z @ 0x1C02F47EC (-yCompute@DDA_CLIPLINE@@QEAAJJ@Z.c)
 */
