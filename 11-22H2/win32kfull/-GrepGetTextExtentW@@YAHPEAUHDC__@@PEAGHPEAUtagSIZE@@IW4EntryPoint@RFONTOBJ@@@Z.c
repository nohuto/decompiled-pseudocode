/*
 * XREFs of ?GrepGetTextExtentW@@YAHPEAUHDC__@@PEAGHPEAUtagSIZE@@IW4EntryPoint@RFONTOBJ@@@Z @ 0x1C00838A8
 * Callers:
  ...
  if ( a3 )
  {
    ...
    if ( v25[0] )
    {
      ...
      if ( v23 )
      {
        ...
        {
          EXFORMOBJ::vQuickInit((EXFORMOBJ *)v24, (struct XDCOBJ *)v25, 0x204u);
          ESTROBJ::vInit(
            (ESTROBJ *)v35,
            a2,
            a3,
