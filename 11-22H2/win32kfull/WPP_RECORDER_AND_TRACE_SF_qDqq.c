/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qDqq @ 0x1C01B6F34
 * Callers:
 *     ?_FindShellHandwritingDelegationQMsgFromMsg@@YAHQEAUtagTHREADINFO@@QEAUtagMSG@@PEAPEAUtagQMSG@@@Z @ 0x1C01B619C (-_FindShellHandwritingDelegationQMsgFromMsg@@YAHQEAUtagTHREADINFO@@QEAUtagMSG@@PEAPEAUtagQMSG@@@.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0141260 (_guard_dispatch_icall_nop.c)
 */

__int64 WPP_RECORDER_AND_TRACE_SF_qDqq(
        __int64 a1,
        char a2,
        char a3,
        _DWORD a4,
        ...
        ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
               &WPP_0bd01f6e78ca3341e624bb2278b12953_Traceguids,
               17LL,
               (__int64 *)va,
               8LL,
               (__int64 *)va1,
