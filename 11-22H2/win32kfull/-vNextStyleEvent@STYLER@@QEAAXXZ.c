/*
 * XREFs of ?vNextStyleEvent@STYLER@@QEAAXXZ @ 0x1C02F2F74
 * Callers:
 *     ?bWiden@WIDENER@@IEAAHXZ @ 0x1C015DC7A (-bWiden@WIDENER@@IEAAHXZ.c)
 * Callees:
 *     ?efNextStyleLength@STYLER@@IEAA?AVEFLOAT@@XZ @ 0x1C015DF06 (-efNextStyleLength@STYLER@@IEAA-AVEFLOAT@@XZ.c)
 ...
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C02F2A80 (-vNextEvent@LINER@@QEAAXXZ.c)
 */
