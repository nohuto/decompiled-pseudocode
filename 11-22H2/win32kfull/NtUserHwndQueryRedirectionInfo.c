/*
 * XREFs of NtUserHwndQueryRedirectionInfo @ 0x1C0154A60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
  ...
  {
    v33 = v39;
    DxSharedSurface = GreGetDxSharedSurface(*v17, v35, &v33, &v32, &v30, &v34);
...
LABEL_52:
  ...
  if ( v25 )
  {
    if ( v25 != 1 )
      goto LABEL_46;
    HwndUpdateIds = GreGetDxSharedSurface(*v17, v35, &v33, &v32, &v30, &v34);
