/*
 * XREFs of Win32kRIMDevChangeCallback @ 0x1C01A6A30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsPublicPointerDevice @ 0x1C01C3264 (IsPublicPointerDevice.c)
 *     UpdatePointerDeviceCount @ 0x1C01C34AC (UpdatePointerDeviceCount.c)
