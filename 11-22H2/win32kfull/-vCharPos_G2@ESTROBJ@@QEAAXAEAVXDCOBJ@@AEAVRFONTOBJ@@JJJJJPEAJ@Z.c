/*
 * XREFs of ?vCharPos_G2@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJJJJPEAJ@Z @ 0x1C02DA6F0
 * Callers:
        ...
        int *a9)
{
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a3 + 640LL) )
  {
    ...
    if ( bCalcBreakExtra(*(unsigned int *)(*(_QWORD *)a3 + 404LL), a7, a8, (__int64)this + 120) )
    {
