/*
 * XREFs of xxxRemotePassthruEnable @ 0x1C0204098
 * Callers:
 *     NtUserRemotePassthruEnable @ 0x1C01D9B40 (NtUserRemotePassthruEnable.c)
 * Callees:
...
__int64 xxxRemotePassthruEnable()
{
  ...
  if ( PsGetCurrentProcess(Timer_high, v0, v3) != gpepCSRSS )
    return 3221225506LL;
  dword_1C035F8F4 = *(_QWORD *)(SGDGetUserSessionState(gpepCSRSS) + 13760) != gapulCvt_VK_84;
