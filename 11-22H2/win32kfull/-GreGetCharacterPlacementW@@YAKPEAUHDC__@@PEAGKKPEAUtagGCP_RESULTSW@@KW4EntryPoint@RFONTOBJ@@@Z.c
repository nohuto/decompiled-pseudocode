/*
 * XREFs of ?GreGetCharacterPlacementW@@YAKPEAUHDC__@@PEAGKKPEAUtagGCP_RESULTSW@@KW4EntryPoint@RFONTOBJ@@@Z @ 0x1C02D72B0
 * Callers:
 ...
 *     ?nCalcJustInArray@@YAKPEAPEAIGPEAXHI@Z @ 0x1C02D7AD8 (-nCalcJustInArray@@YAKPEAPEAIGPEAXHI@Z.c)
 */
