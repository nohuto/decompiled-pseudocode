/*
 * XREFs of PostInputMessage @ 0x1C0117268
 * Callers:
        ...
        __int64 a15)
{
  ...
  __int64 v48; // rax
  struct tagTHREADINFO *v49; // [rsp+B0h] [rbp+8h]
  unsigned __int64 v50; // [rsp+C8h] [rbp+20h] BYREF

  v50 = a4;
  v15 = a13;
  v17 = a10;
  v49 = (struct tagTHREADINFO *)(a15 & -(__int64)(a13 != 0));
  ...
  {
    CoalesceableMouseMessage = (const struct tagQMSG *)GetCoalesceableMouseMessage(a3, &v50, v21, v17);
...
LABEL_15:
    ...
    *(_DWORD *)(v24 + 100) = v27 | (32 * v29);
    ...
    StoreQMessage((struct tagQMSG *)v24, a2, a3, v50, a5, a6, v22, 0, a8, a9, v17, v31, a11, a12);
    ...
    if ( !tagQ::AreMultipleThreadsAttached(a1) )
      goto LABEL_67;
    v42 = *((_QWORD *)PtiCurrentShared(v38, v37, v39, v40) + 58);
    if ( *(_QWORD *)(v42 + 48) || *(_QWORD *)(*((_QWORD *)PtiCurrentShared(v42, v41, v43, v44) + 58) + 56LL) )
      goto LABEL_67;
    if ( a2 && (v45 = (_QWORD *)*((_QWORD *)a2 + 2), a2 == (struct tagWND *)v45[179]) )
    {
      v30 = 1;
    }
    else
    ...
    if ( !v45 || (unsigned int)IsAdaptiveQueueDetachExempted((__int64)v45) )
    {
LABEL_67:
      WakeSomeone(a1, v49, a3, (struct tagQMSG *)v24);
      return 1LL;
    }
    if ( a3 != 260 && a3 != 513 && a3 != 516 && a3 != 519 && a3 != 522 && a3 != 523 && a3 != 526 )
    {
      if ( a3 == 581 )
      {
        if ( v30 )
        {
          v47 = *(struct _KEVENT **)(*((_QWORD *)a2 + 2) + 1424LL);
LABEL_66:
          KeSetEvent(v47, 1, 0);
          goto LABEL_67;
        }
        v48 = v45[84];
        if ( !v48 || (*(_DWORD *)(v48 + 200) & 0x80000) == 0 )
          goto LABEL_67;
      }
      else if ( a3 != 582 )
      {
