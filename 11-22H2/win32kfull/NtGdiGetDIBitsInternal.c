/*
 * XREFs of NtGdiGetDIBitsInternal @ 0x1C002E920
 * Callers:
 *     <none>
 * Callees:
 *     ?init_probe@?$umptr_w@E@@SA?AV1@PEAE_K1@Z @ 0x1C002C290 (-init_probe@-$umptr_w@E@@SA-AV1@PEAE_K1@Z.c)
...
LABEL_60:
              ...
              if ( *v19 < 0x28 || v19[4] - 1 > 1 || v19[5] )
              {
                ...
                if ( BitmapBitsSize )
                {
                  inited = umptr_w<unsigned char>::init_probe((__int64)v51, v9, BitmapBitsSize, 4u);
                  v42 = *(_QWORD *)inited;
                  v43 = *(_QWORD *)(inited + 8);
