 ...
 *     FractionToMantissa @ 0x1C0252CA8 (FractionToMantissa.c)
 */
...
__int64 __fastcall Log(int a1)
{
  ...
  v4 = a1 / 1000000;
  v5 = dword_1C0324480[a1 / 1000000];
  v6 = (unsigned int)(a1 % 1000000);
  if ( (_DWORD)v6 )
    v5 += FractionToMantissa(v6, (unsigned int)dword_1C03252A0[v4]);
