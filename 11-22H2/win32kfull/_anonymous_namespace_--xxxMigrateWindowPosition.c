/*
 * XREFs of _anonymous_namespace_::xxxMigrateWindowPosition @ 0x1C00C1C88
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v58 = v9;
  result = (__int64)CMonitorTopology::MonitorDataFromRect(a3, (const struct tagWND *)retstr, &v58);
  v14 = 0;
  ...
  if ( result )
  {
    ...
    v17 = 524308;
    v18 = 0;
    if ( (dword_1C03591FC & 1) != 0 && IsSemiMaximized((const struct tagWND *)retstr) )
    {
      v54 = v14;
      v53 = 1;
      v58 = 0LL;
      CMonitorTopology::MonitorData::LogicalWorkArea(v15, &v62, (const struct tagWND *)retstr);
      v31 = *((_WORD *)v15 + 20);
      v56 = v57;
      LOWORD(v47) = v31;
      ...
      if ( v32 )
      {
        if ( v54 != 3 )
        {
          ...
          Prop = (struct tagRECT *)GetProp(retstr, *((unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Size + 1), 1LL);
          if ( Prop )
          {
            v57 = *Prop;
            if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          ...
          *(struct tagRECT *)&v60[8] = v44;
          ...
          v45 = 2LL;
          return NotifyShell::ArrangementCompleted(retstr, a5, v45);
        }
        if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          || (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) == 0
          || (LOBYTE(v12) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 4u) )
      ...
      {
        v16 = anonymous_namespace_::GetArrangedOptions((struct tagWND *)&v57, (struct tagWND *)retstr, v15) | 1;
        v14 = 0;
      }
    }
    ...
    else
    {
      if ( !v18 )
      {
        v19 = anonymous_namespace_::xxxNormalizeRect((struct tagWND *)&v62, retstr, &v57.left, v55, v15, v16);
        LOWORD(v14) = 0;
    ...
    if ( v22 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      LODWORD(v49) = v29[23];
      LODWORD(v48) = v29[22];
      result = (__int64)WPP_RECORDER_AND_TRACE_SF_sdddddd(
