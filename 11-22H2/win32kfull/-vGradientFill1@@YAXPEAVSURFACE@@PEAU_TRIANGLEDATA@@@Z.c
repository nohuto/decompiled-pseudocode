/*
 * XREFs of ?vGradientFill1@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02F9390
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Xlate555 )
  {
    ...
    if ( v2 < v7 )
    {
      ...
      do
      {
        ...
        if ( v10 >= *((_DWORD *)v5 + 2) )
          v10 = *((_DWORD *)v5 + 2);
        v35 = (char *)&unk_1C0329CA0 + 16 * (((_BYTE)v8 + (_BYTE)v2) & 0xFu);
        if ( v9 < v10 )
        {
          ...
          do
          {
            ...
            ++v9;
            v11 += v28;
            LOBYTE(v19) = *v17 & ~(1 << (7 - v15)) | (byte_1C03299A0[Xlate555[(v21 >= 0xFF ? 0x7C00 : 0) | v20]] << (7 - v15));
            v22 = v15 + 1;
            v23 = v15;
            *v17 = v19;
            v15 = 0;
