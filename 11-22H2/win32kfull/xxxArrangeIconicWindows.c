/*
 * XREFs of xxxArrangeIconicWindows @ 0x1C0239A1C
 * Callers:
 *     NtUserArrangeIconicWindows @ 0x1C01CCB90 (NtUserArrangeIconicWindows.c)
 * Callees:
...
__int64 __fastcall xxxArrangeIconicWindows(__int64 a1)
{
  ...
  if ( !v62 )
    return 0LL;
  v59 = IsTrayWindow(*(struct tagWND **)(a1 + 112), 1);
  v4 = *(_DWORD *)(gpsi + 2084LL);
  v5 = *(_DWORD *)(gpsi + 2088LL);
  InternalGetRealClientRect(a1, (__int64)&v63, 1, 0LL, 1);
...
LABEL_116:
  ...
  do
  {
    ...
    if ( v11 == v10 )
      goto LABEL_10;
    Prop = GetProp(v11, *((unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Size + 1), 1LL, 0LL);
    if ( !Prop )
      goto LABEL_10;
    v14 = *(_DWORD *)(Prop + 48);
    v15 = (_DWORD *)(Prop + 32);
...
LABEL_11:
  ...
  if ( !v59 )
  {
    ...
    while ( 1 )
    {
      ...
      v29 = v26;
      v30 = 0;
      v31 = *(_QWORD *)(GetProp(v27, *((unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Size + 1), 1LL, 0LL) + 32);
      if ( v26 >= v24 )
        goto LABEL_88;
      do
      {
        ...
        if ( !v32 )
          goto LABEL_82;
        v33 = *(_QWORD *)(GetProp(v32, *((unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Size + 1), 1LL, 0LL) + 32);
...
LABEL_92:
  ...
  while ( 2 )
  {
    if ( v43 )
    {
      ...
      if ( v44 )
      {
        v45 = GetProp(v44, *((unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Size + 1), 1LL, 0LL);
        if ( v45 )
        {
          *(_DWORD *)(v45 + 48) |= 0x20u;
          *(_QWORD *)(v45 + 32) = v56;
    ...
    else
    {
      while ( 1 )
      {
        if ( v47 )
        {
          ...
          if ( v48 )
          {
            v51 = GetProp(v48, *((unsigned __int16 *)&WPP_MAIN_CB.DeviceQueue.Size + 1), 1LL, v49);
