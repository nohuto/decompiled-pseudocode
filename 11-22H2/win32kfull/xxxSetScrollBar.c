/*
 * XREFs of xxxSetScrollBar @ 0x1C00C6C68
 * Callers:
 ...
 *     ?SBSetParms@@YAHPEAUtagSBDATA@@PEAUtagSCROLLINFO@@PEAHPEAJ@Z @ 0x1C00C6E68 (-SBSetParms@@YAHPEAUtagSBDATA@@PEAUtagSCROLLINFO@@PEAHPEAJ@Z.c)
...
__int64 __fastcall xxxSetScrollBar(struct tagWND *a1, int a2, struct tagSCROLLINFO *a3, int a4)
{
  ...
  if ( a2 != 2 )
  {
    ...
    {
      SetOrClrWF(0LL, a1, v23, 1LL);
      v12 = v21;
      if ( v21 )
      {
        SetOrClrWF(1LL, a1, v23, 1LL);
      }
