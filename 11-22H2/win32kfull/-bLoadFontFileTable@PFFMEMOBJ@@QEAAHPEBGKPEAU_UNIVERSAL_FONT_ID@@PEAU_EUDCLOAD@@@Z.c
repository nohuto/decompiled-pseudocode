/*
 * XREFs of ?bLoadFontFileTable@PFFMEMOBJ@@QEAAHPEBGKPEAU_UNIVERSAL_FONT_ID@@PEAU_EUDCLOAD@@@Z @ 0x1C0081A30
 * Callers:
 ...
 *     ?bAllocPFEData@PFFMEMOBJ@@AEAAHK@Z @ 0x1C00825A0 (-bAllocPFEData@PFFMEMOBJ@@AEAAHK@Z.c)
