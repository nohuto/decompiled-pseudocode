/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C000AB14
 * Callers:
 *     ?CheckImeHotKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAUtagQ@@I_J@Z @ 0x1C00A3B40 (-CheckImeHotKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAUtagQ@@I_J@Z.c)
 * Callees:
 *     ?GetHotKeyLangID@@YAGK@Z @ 0x1C00A2234 (-GetHotKeyLangID@@YAGK@Z.c)
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C01FBAB4 (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
