/*
 * XREFs of ?CreateTopologySnapshot@CMonitorTopology@@SAPEAV1@XZ @ 0x1C00BF780
 * Callers:
...
struct CMonitorTopology *CMonitorTopology::CreateTopologySnapshot(void)
{
  ...
  {
    *v1 = 1;
    v4 = dword_1C0359168 + 100 * (*(_DWORD *)SGDGetUserSessionState(v2) - dword_1C0359168 / 0x64u);
    v5 = (unsigned int)(dword_1C0359168 + 1);
    v3[1] = v4;
    dword_1C0359168 = v5;
