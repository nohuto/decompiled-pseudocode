/*
 * XREFs of ?InitMapSharedSection@@YAJPEAU_EPROCESS@@PEAU_USERCONNECT@@@Z @ 0x1C00E3F84
 * Callers:
...
__int64 __fastcall InitMapSharedSection(struct _EPROCESS *a1, struct _USERCONNECT *a2)
{
  ...
  if ( (_BYTE)a2 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_AND_TRACE_SF_(
      ...
      (unsigned int)&WPP_1c171ce113663c9ff9c000b7a1ac03c0_Traceguids,
      4,
      3,
      14,
  ...
  *((_QWORD *)v2 + 2) = v17 + gSharedInfo[1] - gpvSharedBase;
