/*
 * XREFs of ?draw_gray_nf_ntb_o_to_temp_start@@YAXPEAU_GLYPHPOS@@KPEAEKKKK@Z @ 0x1C0270E30
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a7)
{
  ...
  if ( a1 < &a1[v9 / 3] )
  {
    ...
    do
    {
      ...
      (*(&off_1C030A9E8[2 * ((LOBYTE(v12->ptlOrigin.x) + LOBYTE(p_ptl->x) - (_BYTE)a4) & 1u)] + (v12->sizlBitmap.cx & 1)))(
        v12,
