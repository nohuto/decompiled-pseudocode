/*
 * XREFs of ?CreateForTopologyChange@CRecalcProp@@SA_NPEAUHWND__@@PEAVCMonitorTopology@@W4StartRecalcOption@@@Z @ 0x1C00C23C4
 * Callers:
 ...
 *     ?HasRestorableState@CRecalcProp@@AEAA_NXZ @ 0x1C00C3994 (-HasRestorableState@CRecalcProp@@AEAA_NXZ.c)
...
char __fastcall CRecalcProp::CreateForTopologyChange(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v27 = 0;
  v13 = (struct CRecalcState *)CRecalcState::CreateRecalcState(v8, v3, a3, &v27);
  if ( !v13 )
    return 0;
  ...
  if ( !CRecalcProp::HasRestorableState(v11) )
  {
    if ( v14 != 2 )
    {
      ...
      else
      {
        ...
        {
          v27 = 0x20000;
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 1995LL);
        }
        v17 = (_QWORD *)((char *)v11 + 32);
