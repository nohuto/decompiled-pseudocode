/*
 * XREFs of ?WindowPosAndStateApplied@NotifyShell@@YAXPEBUtagWND@@AEBUtagSHELL_REQUESTED_POS_APPLIED@@@Z @ 0x1C021DE1C
 * Callers:
        ...
        const struct tagSHELL_REQUESTED_POS_APPLIED *a3)
{
  ...
  *(_QWORD *)&v6 = *((_QWORD *)a2 + 6);
  ...
  anonymous_namespace_::NotifyIAMWindowManagementEvent((__int64)&v8, 0);
}
