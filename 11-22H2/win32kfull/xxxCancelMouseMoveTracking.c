/*
 * XREFs of xxxCancelMouseMoveTracking @ 0x1C00B6B88
 * Callers:
...
void __fastcall xxxCancelMouseMoveTracking(__int64 a1, struct tagWND *a2, int a3, unsigned __int16 a4)
{
  char v5; // si
  __int16 v8; // r14
  __int64 v9; // rcx
  ...
  v5 = a4 & a1;
  v8 = a1;
  if ( (a4 & (unsigned __int16)a1 & 0x400) != 0 )
    xxxHotTrack(a2, a3, 0);
  if ( (unsigned int)Feature_Backport_UserModeTooltips__private_IsEnabledDeviceUsage(a1, a2) )
  {
    if ( (a4 & 0x800) != 0 )
    {
      v9 = *((_QWORD *)a2 + 3);
