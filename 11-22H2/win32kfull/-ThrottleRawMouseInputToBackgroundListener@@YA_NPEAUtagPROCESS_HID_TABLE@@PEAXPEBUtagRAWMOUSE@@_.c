/*
 * XREFs of ?ThrottleRawMouseInputToBackgroundListener@@YA_NPEAUtagPROCESS_HID_TABLE@@PEAXPEBUtagRAWMOUSE@@_KK@Z @ 0x1C01AB2E4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( *((_DWORD *)a1 + 28) == 1 )
  {
    ...
    {
      if ( a4 > *((_QWORD *)a1 + 15) )
        MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 403);
    }
    else
    {
      *((_DWORD *)a1 + 28) = 0;
