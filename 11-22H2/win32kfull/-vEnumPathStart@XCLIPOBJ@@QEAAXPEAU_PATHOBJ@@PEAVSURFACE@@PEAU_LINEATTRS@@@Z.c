/*
 * XREFs of ?vEnumPathStart@XCLIPOBJ@@QEAAXPEAU_PATHOBJ@@PEAVSURFACE@@PEAU_LINEATTRS@@@Z @ 0x1C02D95B8
 * Callers:
 ...
 *     PATHOBJ_vEnumStartClipLines @ 0x1C02D97E0 (PATHOBJ_vEnumStartClipLines.c)
 * Callees:
