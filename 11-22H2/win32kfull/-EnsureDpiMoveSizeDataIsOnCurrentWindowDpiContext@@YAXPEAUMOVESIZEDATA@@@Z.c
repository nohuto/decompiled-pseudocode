/*
 * XREFs of ?EnsureDpiMoveSizeDataIsOnCurrentWindowDpiContext@@YAXPEAUMOVESIZEDATA@@@Z @ 0x1C01E955C
 * Callers:
 ...
 *     _lambda_dcff6b42735babe5bbfdec74d1bb422f_::operator() @ 0x1C01E8F58 (_lambda_dcff6b42735babe5bbfdec74d1bb422f_--operator().c)
