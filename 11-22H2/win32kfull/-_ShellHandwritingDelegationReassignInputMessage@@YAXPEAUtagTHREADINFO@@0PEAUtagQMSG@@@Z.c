/*
 * XREFs of ?_ShellHandwritingDelegationReassignInputMessage@@YAXPEAUtagTHREADINFO@@0PEAUtagQMSG@@@Z @ 0x1C01B64C4
 * Callers:
 ...
 *     DelegateChainingResetAndCoalescePointerMessage @ 0x1C01C68B8 (DelegateChainingResetAndCoalescePointerMessage.c)
 */
