/*
 * XREFs of ?ContactVisualizationWorker@@YAHKPEAX_KHK@Z @ 0x1C01AD114
 * Callers:
 *     EditionContactVisualization @ 0x1C014FFF0 (EditionContactVisualization.c)
 * Callees:
 ...
 *     DwmAsyncSendTouchContacts @ 0x1C0159D96 (DwmAsyncSendTouchContacts.c)
 ...
 *     ?PointerEventIntToDigitizerContactInfo@Feedback@@YAXPEBUtagPOINTEREVENTINT@@HHHPEAUtagDIGITIZER_CONTACT_INFO@@@Z @ 0x1C01AD7B8 (-PointerEventIntToDigitizerContactInfo@Feedback@@YAXPEBUtagPOINTEREVENTINT@@HHHPEAUtagDIGITIZER_.c)
