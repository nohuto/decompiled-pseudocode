/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@K@Z @ 0x1C01AF124
 * Callers:
 ...
 *     ?PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C01AF350 (-PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z.c)
 */
...
char __fastcall InputTraceLogging::RIM::InjectInput(__int64 a1, int a2, int a3)
{
  ...
  if ( (_BYTE)v3 != 2 )
  {
    if ( (_BYTE)v3 )
    {
      ...
      if ( (unsigned int)dword_1C0359080 <= 4 )
        return v3;
      LOBYTE(v3) = tlgKeywordOn((__int64)&dword_1C0359080, 256LL);
      if ( !(_BYTE)v3 )
        return v3;
      v17 = (unsigned __int8 *)&unk_1C031A3A1;
    }
    else
    {
      if ( (unsigned int)dword_1C0359080 <= 4 )
      ...
      if ( !(_BYTE)v3 )
        return v3;
      v16 = 1;
      v17 = (unsigned __int8 *)&unk_1C031A364;
    }
  ...
  else if ( (unsigned int)dword_1C0359080 > 4 )
  {
    LOBYTE(v3) = tlgKeywordOn((__int64)&dword_1C0359080, 256LL);
    if ( (_BYTE)v3 )
    {
      ...
      LOBYTE(v3) = _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
                     (__int64)&dword_1C0359080,
                     (unsigned __int8 *)dword_1C031A2B0,
                     v10,
                     v9,
                     (__int64)&v20,
                     (void **)&v19,
