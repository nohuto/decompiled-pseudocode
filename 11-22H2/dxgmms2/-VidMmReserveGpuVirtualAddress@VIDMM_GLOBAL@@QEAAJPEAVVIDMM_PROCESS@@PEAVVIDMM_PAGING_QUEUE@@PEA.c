/*
 * XREFs of ?VidMmReserveGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAVVIDMM_PAGING_QUEUE@@PEAUD3DDDI_RESERVEGPUVIRTUALADDRESS@@@Z @ 0x1C0088548
 * Callers:
 *     VidMmReserveGpuVirtualAddress @ 0x1C0001C30 (VidMmReserveGpuVirtualAddress.c)
 * Callees:
 ...
 *     ?CommitVirtualAddressRange@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@PEAVVIDMM_PAGING_QUEUE@@PEAUVIDMM_MAPPED_VA_RANGE@@EPEBU_DXGK_ADL@@PEA_KPEAUVIDMM_VAD_PENDING_OPERATION@@@Z @ 0x1C00B36A0 (-CommitVirtualAddressRange@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@PEAVVIDMM_PAGING_QUE.c)
  ...
  else
  {
    ...
    if ( a4->Reserved0 == 1 )
    {
      v12 = VIDMM_GLOBAL::CommitVirtualAddressRange(
              ...
              v15,
              0,
              (const struct _DXGK_ADL *)&xmmword_1C004F1D0,
              0LL,
              0LL);
      if ( v12 < 0 )
      {
