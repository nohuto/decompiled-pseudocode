/*
 * XREFs of ?VidSchiRundownUnorderedWaiterPacket@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C003657C
 * Callers:
 *     VidSchiRundownUnorderedWaiterContext @ 0x1C003C23C (VidSchiRundownUnorderedWaiterContext.c)
 *     VidSchiRundownUnorderedWaiterDevice @ 0x1C003C288 (VidSchiRundownUnorderedWaiterDevice.c)
 *     ?VidSchiRundownUnorderedWaiterHwQueue@@YAXPEAVHwQueueStagingList@@PEAUVIDSCH_HW_QUEUE@@@Z @ 0x1C003DAF4 (-VidSchiRundownUnorderedWaiterHwQueue@@YAXPEAVHwQueueStagingList@@PEAUVIDSCH_HW_QUEUE@@@Z.c)
 * Callees:
