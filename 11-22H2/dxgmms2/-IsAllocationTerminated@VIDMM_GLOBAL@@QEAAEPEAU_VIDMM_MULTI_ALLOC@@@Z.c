/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00E4360
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C002D120 (VidMmIsAllocationTerminated.c)
 * Callees:
