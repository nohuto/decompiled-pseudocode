/*
 * XREFs of ?GetRenderAdapterInfo@DXGPROCESS@@QEBAPEAUDXGPROCESS_RENDER_ADAPTER_INFO@@I@Z @ 0x1C002FDD8
 * Callers:
 ...
 *     VidSchQueryProcessAdapterStatistics @ 0x1C00C4690 (VidSchQueryProcessAdapterStatistics.c)
 * Callees:
