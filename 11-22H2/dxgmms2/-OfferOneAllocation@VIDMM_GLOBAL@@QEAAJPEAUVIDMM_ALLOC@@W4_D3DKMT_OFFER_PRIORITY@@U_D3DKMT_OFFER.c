/*
 * XREFs of ?OfferOneAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@W4_D3DKMT_OFFER_PRIORITY@@U_D3DKMT_OFFER_FLAGS@@@Z @ 0x1C00AEEF0
 * Callers:
        ...
        struct _D3DKMT_OFFER_FLAGS a4)
{
  ...
  else
  {
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v9 + 304, 0LL) )
    {
      ...
      {
        v44 = *(_DWORD *)(v9 + 332);
        if ( v44 != -1 && (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer(v11, (__int64)&EventBlockThread, v12, v44);
      }
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)v7 + 39976, 0LL) )
  {
    ...
    {
      v40 = *((_DWORD *)v7 + 10000);
      if ( v40 != -1 && (byte_1C0076981 & 1) != 0 )
        McTemplateK0q_EtwWriteTransfer(v15, (__int64)&EventBlockThread, v16, v40);
    }
        ...
        if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v9 + 304, 0LL) )
        {
          if ( bTracingEnabled )
          {
            ...
            if ( v50 != -1 && (byte_1C0076981 & 1) != 0 )
              McTemplateK0q_EtwWriteTransfer(v22, (__int64)&EventBlockThread, v21, v50);
          }
          _InterlockedIncrement64((volatile signed __int64 *)(v9 + 312));
          ExAcquirePushLockExclusiveEx(v9 + 304, 0LL);
        }
