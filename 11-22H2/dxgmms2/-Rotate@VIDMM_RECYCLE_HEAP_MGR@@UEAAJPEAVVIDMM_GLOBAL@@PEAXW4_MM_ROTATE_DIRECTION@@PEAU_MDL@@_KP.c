/*
 * XREFs of ?Rotate@VIDMM_RECYCLE_HEAP_MGR@@UEAAJPEAVVIDMM_GLOBAL@@PEAXW4_MM_ROTATE_DIRECTION@@PEAU_MDL@@_KP6AJ331@Z1TVIDMM_ROTATE_FLAGS@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00F6660
 * Callers:
 *     <none>
 * Callees:
        ...
        int a9)
{
  ...
  if ( (qword_1C0076010 & 2) != 0 )
  {
    ...
    v19 = 8005;
    if ( byte_1C0076981 < 0 )
      McTemplateK0q_EtwWriteTransfer(v11, (__int64)&EventProfilerEnter, v12, 8005);
  }
  else
  {
    v21 = 0;
