/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00E97A4
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C002D500 (VidMmValidateHistoryBuffers.c)
 * Callees:
