/*
 * XREFs of ?SetExistingSysMemStore@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@PEAX@Z @ 0x1C00E7564
 * Callers:
 *     VidMmSetExistingSysMemStore @ 0x1C002D380 (VidMmSetExistingSysMemStore.c)
 * Callees:
