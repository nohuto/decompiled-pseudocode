/*
 * XREFs of ?HandleTrimWnf@VIDMM_GLOBAL@@QEAAX_N@Z @ 0x1C008D640
 * Callers:
 ...
 *     ?SetTimeout@VIDMM_WORKER_THREAD@@QEAAX_JW4VIDMM_WORKER_THREAD_WAKE_REASON@@@Z @ 0x1C008DC90 (-SetTimeout@VIDMM_WORKER_THREAD@@QEAAX_JW4VIDMM_WORKER_THREAD_WAKE_REASON@@@Z.c)
...
LABEL_44:
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx(v76, 0LL) )
  {
    ...
    {
      v67 = *((_DWORD *)v76 + 6);
      if ( v67 != -1 && (byte_1C0076981 & 1) != 0 )
        McTemplateK0q_EtwWriteTransfer(v42, (__int64)&EventBlockThread, v43, v67);
    }
...
LABEL_94:
    ...
    if ( v46 )
    {
      ...
      v81 = 1;
      VIDMM_PROCESS_ADAPTER_INFO::GetNumBytesToTrim((VIDMM_PROCESS_ADAPTER_INFO *)(n - 3), &v73, 0, 1);
