/*
 * XREFs of ?QueryProcessSegmentStatistics@VIDMM_GLOBAL@@QEAAJGIPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_INFORMATION@@@Z @ 0x1C00EE5D4
 * Callers:
 *     ?VidMmQueryProcessSegmentStatistics@@YAJPEAVVIDMM_GLOBAL@@GIPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_INFORMATION@@@Z @ 0x1C002CC50 (-VidMmQueryProcessSegmentStatistics@@YAJPEAVVIDMM_GLOBAL@@GIPEAVVIDMM_PROCESS@@PEAU_D3DKMT_QUERY.c)
 * Callees:
 ...
 *     ?IsActive@VIDMM_POLICY@@QEAAHXZ @ 0x1C00C3D90 (-IsActive@VIDMM_POLICY@@QEAAHXZ.c)
 *     ?GetProcessWorkingSetInformation@VIDMM_PROCESS@@QEAAXPEAVVIDMM_SEGMENT@@PEA_K1@Z @ 0x1C00EEFD0 (-GetProcessWorkingSetInformation@VIDMM_PROCESS@@QEAAXPEAVVIDMM_SEGMENT@@PEA_K1@Z.c)
 */
