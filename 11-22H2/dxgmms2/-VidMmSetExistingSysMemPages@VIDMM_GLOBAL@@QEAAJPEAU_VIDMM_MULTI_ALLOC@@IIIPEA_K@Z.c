/*
 * XREFs of ?VidMmSetExistingSysMemPages@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@IIIPEA_K@Z @ 0x1C00EA500
 * Callers:
 *     VidMmSetExistingSysMemPages @ 0x1C002D350 (VidMmSetExistingSysMemPages.c)
 * Callees:
