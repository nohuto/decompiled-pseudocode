/*
 * XREFs of ?Reset@VIDMM_PROCESS_HEAP@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@PEAXE@Z @ 0x1C0104EC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    if ( AllocationInfo == -1071775472 && bTracingEnabled && (byte_1C0076981 & 1) != 0 )
      McTemplateK0q_EtwWriteTransfer(v9, (__int64)&EventPerformanceWarning, v11, 18);
    goto LABEL_12;
  }
