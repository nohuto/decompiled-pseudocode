/*
 * XREFs of ?AllocateLogEntry@DXGK_LOG@@AEAAPEAUDXGK_LOG_ENTRY@@II@Z @ 0x1C004CB58
 * Callers:
 *     ??2@YAPEAX_KPEAVDXGK_LOG@@II@Z @ 0x1C0005300 (--2@YAPEAX_KPEAVDXGK_LOG@@II@Z.c)
 *     ?AllocateLogEntry@DXGK_LOG@@AEAAPEAUDXGK_LOG_ENTRY@@II@Z @ 0x1C004CB58 (-AllocateLogEntry@DXGK_LOG@@AEAAPEAUDXGK_LOG_ENTRY@@II@Z.c)
 * Callees:
 *     ?AllocateLogEntry@DXGK_LOG@@AEAAPEAUDXGK_LOG_ENTRY@@II@Z @ 0x1C004CB58 (-AllocateLogEntry@DXGK_LOG@@AEAAPEAUDXGK_LOG_ENTRY@@II@Z.c)
 */
