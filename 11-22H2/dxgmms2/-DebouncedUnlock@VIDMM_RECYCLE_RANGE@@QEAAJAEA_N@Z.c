/*
 * XREFs of ?DebouncedUnlock@VIDMM_RECYCLE_RANGE@@QEAAJAEA_N@Z @ 0x1C00A2CB0
 * Callers:
  ...
  *a2 = 0;
  ...
  if ( (_DWORD)v6 )
  {
    ...
    if ( (qword_1C0076010 & 2) != 0 )
    {
      ...
      v16 = 8001;
      if ( byte_1C0076981 < 0 )
        McTemplateK0q_EtwWriteTransfer(v6, (__int64)&EventProfilerEnter, v2, 8001);
    }
    else
    {
      v18 = 0;
