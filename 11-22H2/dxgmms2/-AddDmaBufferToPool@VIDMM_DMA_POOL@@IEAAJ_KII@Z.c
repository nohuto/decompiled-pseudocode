/*
 * XREFs of ?AddDmaBufferToPool@VIDMM_DMA_POOL@@IEAAJ_KII@Z @ 0x1C00B2FC8
 * Callers:
...
LABEL_64:
  ...
  if ( (*((_BYTE *)this + 32) & 1) != 0 || (_DWORD)v5 )
  {
    ...
    if ( !v9 )
    {
      _InterlockedAdd(&dword_1C00767A0, 1u);
    ...
    if ( !v10 )
    {
      ...
      *((_DWORD *)v9 + 20) = 2;
      ...
      if ( !v53 )
      {
        _InterlockedAdd(&dword_1C00767B4, 1u);
...
LABEL_21:
      if ( (_DWORD)v5 )
      {
        ...
        if ( !v25 )
        {
          _InterlockedAdd(&dword_1C00767C0, 1u);
...
LABEL_34:
        ...
        {
          _InterlockedAdd(&dword_1C007681C, 1u);
