/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C00EF538
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C002D3A0 (VidMmSetWorkingSetInformation.c)
 * Callees:
