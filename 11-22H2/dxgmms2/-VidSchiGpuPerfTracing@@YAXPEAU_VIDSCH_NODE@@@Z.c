/*
 * XREFs of ?VidSchiGpuPerfTracing@@YAXPEAU_VIDSCH_NODE@@@Z @ 0x1C00359CC
 * Callers:
 *     ?VidSchiNodePerfTracingThread@@YAXPEAX@Z @ 0x1C0035D00 (-VidSchiNodePerfTracingThread@@YAXPEAX@Z.c)
 * Callees:
