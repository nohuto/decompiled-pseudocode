/*
 * XREFs of ?FreeGpuVirtualAddressSystemCommand@VIDMM_GLOBAL@@QEAAJPEAVCVirtualAddressAllocator@@_K1E@Z @ 0x1C008789C
 * Callers:
 ...
 *     ?CompareVadByStartAddressAvl@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z @ 0x1C00B4524 (-CompareVadByStartAddressAvl@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z.c)
 */
        ...
        unsigned __int8 a5)
{
  ...
  if ( v8 )
  {
    ...
    {
      WdLogSingleEntry3(3LL, a2, a3, 20833LL);
    }
    else
    {
