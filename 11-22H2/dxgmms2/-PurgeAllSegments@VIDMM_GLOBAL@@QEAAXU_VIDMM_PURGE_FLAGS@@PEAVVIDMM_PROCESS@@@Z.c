/*
 * XREFs of ?PurgeAllSegments@VIDMM_GLOBAL@@QEAAXU_VIDMM_PURGE_FLAGS@@PEAVVIDMM_PROCESS@@@Z @ 0x1C00B4910
 * Callers:
 *     VidMmPurgeAllSegments @ 0x1C0018C00 (VidMmPurgeAllSegments.c)
 * Callees:
 ...
 *     ?AddData@VIDMM_PURGE_TELEMETRY@@QEAAX_K0@Z @ 0x1C00F39C8 (-AddData@VIDMM_PURGE_TELEMETRY@@QEAAX_K0@Z.c)
 */
