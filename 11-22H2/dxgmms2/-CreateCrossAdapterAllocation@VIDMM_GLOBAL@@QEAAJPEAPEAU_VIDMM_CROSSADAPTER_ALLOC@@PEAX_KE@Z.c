/*
 * XREFs of ?CreateCrossAdapterAllocation@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAX_KE@Z @ 0x1C00E0E50
 * Callers:
 *     VidMmCreateCrossAdapterAllocation @ 0x1C002D070 (VidMmCreateCrossAdapterAllocation.c)
 * Callees:
