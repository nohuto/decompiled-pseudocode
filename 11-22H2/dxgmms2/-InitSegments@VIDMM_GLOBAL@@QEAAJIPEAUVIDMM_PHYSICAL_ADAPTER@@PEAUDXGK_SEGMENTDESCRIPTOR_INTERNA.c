/*
 * XREFs of ?InitSegments@VIDMM_GLOBAL@@QEAAJIPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@@Z @ 0x1C00BC400
 * Callers:
 ...
 *     ??0VIDMM_SEGMENT@@QEAA@PEAVVIDMM_GLOBAL@@IKKPEBUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@@Z @ 0x1C00BCD7C (--0VIDMM_SEGMENT@@QEAA@PEAVVIDMM_GLOBAL@@IKKPEBUDXGK_SEGMENTDESCRIPTOR_INTERNAL@@@Z.c)
 ...
 *     ?SetVprRange@VIDMM_SEGMENT@@QEAAJ_K0II0@Z @ 0x1C00FF588 (-SetVprRange@VIDMM_SEGMENT@@QEAAJ_K0II0@Z.c)
 */
...
LABEL_28:
    ...
    else
    {
      ...
      *(_QWORD *)(v34 + *v32) = v39;
      if ( !*(_QWORD *)(v34 + *v32) )
      {
        _InterlockedAdd(&dword_1C0076808, 1u);
LABEL_67:
  ...
  if ( *((_DWORD *)a3 + 8) )
  {
    while ( 2 )
    {
      ...
      *(_QWORD *)(v49 + 48) = v51;
      ...
      if ( v56 < 0 )
      {
        _InterlockedAdd(dword_1C0076830, 1u);
