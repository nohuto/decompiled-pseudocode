/*
 * XREFs of ?VidSchPeriodicMonitoredFenceTimerCallback@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C003D5A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchiCalculatePeriodicTargetFrameNumber @ 0x1C003A234 (VidSchiCalculatePeriodicTargetFrameNumber.c)
  ...
  if ( (unsigned __int64)a2[7] < v27 )
  {
    ...
    if ( v18 > 0 )
    {
      if ( bTracingEnabled && (byte_1C0076981 & 1) != 0 )
        McTemplateK0q_EtwWriteTransfer(v17, (__int64)&EventPerformanceWarning, v19, 25);
      v18 = -(__int64)v15;
    }
  ...
  else
  {
    if ( bTracingEnabled )
    {
      if ( (byte_1C0076981 & 1) != 0 )
        McTemplateK0q_EtwWriteTransfer(v27, (__int64)&EventPerformanceWarning, v16, 25);
    }
