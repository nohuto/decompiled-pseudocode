/*
 * XREFs of ?TerminateOneAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C00AEB20
 * Callers:
 ...
 *     ?TerminateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C00AEAF8 (-TerminateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FL.c)
 * Callees:
        ...
        struct DXGTERMINATIONTRACKER *a5)
{
  ...
  else
  {
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v8 + 304, 0LL) )
    {
      ...
      {
        v24 = *(_DWORD *)(v8 + 332);
        if ( v24 != -1 && (byte_1C0076981 & 1) != 0 )
          McTemplateK0q_EtwWriteTransfer(v9, (__int64)&EventBlockThread, v10, v24);
      }
  ...
  *(_BYTE *)(v12 + 56) = 1;
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx(v14, 0LL) )
  {
    ...
    {
      v23 = *(_DWORD *)(v14 + 24);
      if ( v23 != -1 && (byte_1C0076981 & 1) != 0 )
        McTemplateK0q_EtwWriteTransfer(v15, (__int64)&EventBlockThread, v16, v23);
    }
  ...
  *(_QWORD *)(v14 + 8) = 0LL;
  ...
  if ( bTracingEnabled && (byte_1C0076981 & 8) != 0 )
