/*
 * XREFs of ?DestroyAllocation@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C009C58C
 * Callers:
 *     VidMmDestroyAllocation @ 0x1C00055F0 (VidMmDestroyAllocation.c)
 * Callees:
