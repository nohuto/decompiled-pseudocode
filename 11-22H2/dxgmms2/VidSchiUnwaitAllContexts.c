/*
 * XREFs of VidSchiUnwaitAllContexts @ 0x1C003CA94
 * Callers:
 *     VidSchiReportHwHang @ 0x1C0047458 (VidSchiReportHwHang.c)
 *     VidSchFlushAdapter @ 0x1C01070F0 (VidSchFlushAdapter.c)
 * Callees:
 *     ?VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z @ 0x1C00377E8 (-VidSchiUnwaitAllContextsInList@@YAXPEAU_LIST_ENTRY@@@Z.c)
 */
