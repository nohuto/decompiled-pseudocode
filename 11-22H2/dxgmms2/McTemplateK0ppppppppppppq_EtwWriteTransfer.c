/*
 * XREFs of McTemplateK0ppppppppppppq_EtwWriteTransfer @ 0x1C002E430
 * Callers:
 ...
 *     VidMmReportContextAllocList @ 0x1C00F17B0 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiAlloc @ 0x1C00F18D0 (VidMmReportMultiAlloc.c)
 *     ?ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z @ 0x1C00F3390 (-ReportState@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@@Z.c)
 * Callees:
