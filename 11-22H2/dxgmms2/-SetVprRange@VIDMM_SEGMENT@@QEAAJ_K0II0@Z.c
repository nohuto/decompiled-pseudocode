/*
 * XREFs of ?SetVprRange@VIDMM_SEGMENT@@QEAAJ_K0II0@Z @ 0x1C00FF588
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( !a4 || ((a4 - 1) & a4) != 0 )
  {
    WdLogSingleEntry1(1LL, 5114LL);
    goto LABEL_22;
  }
  v7 = *((_QWORD *)this + 8);
  if ( a2 >= v7 )
  {
    WdLogSingleEntry1(1LL, 5119LL);
LABEL_22:
  ...
  {
    WdLogSingleEntry1(1LL, 5124LL);
    goto LABEL_22;
  }
  v10 = a4 - 1LL;
  if ( (v10 & a3) != 0 )
  {
    WdLogSingleEntry1(1LL, 5130LL);
    goto LABEL_22;
  }
  if ( (v10 & a2) != 0 )
  {
    WdLogSingleEntry1(1LL, 5135LL);
    goto LABEL_22;
  }
  if ( a5 > 1 )
  {
    WdLogSingleEntry1(1LL, 5144LL);
    goto LABEL_22;
  }
  if ( a6 && a5 != 1 )
  {
    WdLogSingleEntry1(1LL, 5154LL);
    goto LABEL_22;
  }
  *((_DWORD *)this + 102) = a4;
  *((_QWORD *)this + 48) = a2;
