/*
 * XREFs of ?DisableIoMmuIsolation@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00E17B4
 * Callers:
 *     ?VidMmDisableIoMmuIsolation@@YAXPEAVVIDMM_GLOBAL@@@Z @ 0x1C002C9D0 (-VidMmDisableIoMmuIsolation@@YAXPEAVVIDMM_GLOBAL@@@Z.c)
