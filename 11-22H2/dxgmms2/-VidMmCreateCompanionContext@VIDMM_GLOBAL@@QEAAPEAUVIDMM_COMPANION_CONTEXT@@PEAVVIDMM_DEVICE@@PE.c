/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00E9C0C
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C002D050 (VidMmCreateCompanionContext.c)
 * Callees:
