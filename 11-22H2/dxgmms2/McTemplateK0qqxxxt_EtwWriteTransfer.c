/*
 * XREFs of McTemplateK0qqxxxt_EtwWriteTransfer @ 0x1C0039AF4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqxxxt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 8LL;
  v22 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &SelectPresentAtFlip, a3, 7u, &v10);
}
