/*
 * XREFs of VidSchiUnwaitWaitQueuePacket @ 0x1C00021F0
 * Callers:
 ...
 *     ?VidSchiRundownUnorderedWaiterPacket@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C003657C (-VidSchiRundownUnorderedWaiterPacket@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@@Z.c)
...
int __fastcall VidSchiUnwaitWaitQueuePacket(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  *(_QWORD *)(a2 + 296) = 0LL;
  ...
  VidSchiReleaseSyncObjectReference(*(PVOID *)(a2 + 280));
    ...
    if ( *(_QWORD *)(v21 + 8) == a2 + 32 )
    {
      ...
      if ( (_QWORD *)*v22 == v20 )
      {
        ...
        *(_QWORD *)(a2 + 40) = 0LL;
        --*(_DWORD *)(v23 + 804);
        *(_DWORD *)(a2 + 64) &= ~0x10u;
        LODWORD(v19) = VidSchiFreeQueuePacket(*(_QWORD *)(a2 + 88), a2);
        return v19;
      }
    }
LABEL_37:
