/*
 * XREFs of VidSchSubmitCommand @ 0x1C00AD620
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VidSchiConvertDeferredWaits @ 0x1C003A61C (VidSchiConvertDeferredWaits.c)
 ...
 *     VidSchiAllocateHistoryBufferStorage @ 0x1C0105AA0 (VidSchiAllocateHistoryBufferStorage.c)
...
__int64 __fastcall VidSchSubmitCommand(struct _VIDSCH_CONTEXT *a1, struct VIDSCH_SUBMIT_DATA2 *a2)
{
  ...
  if ( !v10 )
  {
    ...
    VidSchRegisterCompletionEvent(v7, (__int64)v52);
    do
    {
      ...
      if ( v43 )
        ...
        VidSchWaitForCompletionEvent(v7, (__int64)v52, 19LL);
      Pool2 = (__int64)v14;
    }
    while ( !v14 );
