/*
 * XREFs of ?ndisXlateSendCompleteNetBufferListToPacket@@YAXPEAU_NET_BUFFER_LIST@@PEAPEAU_NDIS_PACKET@@PEAH@Z @ 0x1C007399C
 * Callers:
        ...
        int *a3)
{
  ...
  *(_QWORD *)v6 = 1297040182LL;
  ...
  if ( *(int *)ndisNblTrackerMode >= 3 )
    ndisNblTrackerRecordEventInternal((unsigned __int64)a1, 0LL, 0x16u, (unsigned __int64)a2, 0);
