/*
 * XREFs of ?UpdateBindings@BindEngine@Ndis@@AEAAXAEAVKLockThisExclusive@@@Z @ 0x1C01135EC
 * Callers:
 ...
 * Callees:
 *     ?SetIterations@UpdateBindings@BindingMetrics@@QEAAX_K@Z @ 0x1C0006C18 (-SetIterations@UpdateBindings@BindingMetrics@@QEAAX_K@Z.c)
