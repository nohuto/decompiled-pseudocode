/*
 * XREFs of ?ndisCopyNBLInfoToPacket@@YAXPEAU_NET_BUFFER_LIST@@PEAU_NDIS_PACKET@@W4_NDIS_XLATE_TYPE@@@Z @ 0x1C007301C
 * Callers:
 ...
 * Callees:
 *     ndisIPsecNblInfoToPktInfo @ 0x1C00731E0 (ndisIPsecNblInfoToPktInfo.c)
 */
