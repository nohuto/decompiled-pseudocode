/*
 * XREFs of ndisLwmCreateIrpHandler @ 0x1C00CBD40
 * Callers:
 ...
 *     ?ndisCheckAccess@@YAEPEAU_IRP@@PEAU_IO_STACK_LOCATION@@PEAX@Z @ 0x1C0026F84 (-ndisCheckAccess@@YAEPEAU_IRP@@PEAU_IO_STACK_LOCATION@@PEAX@Z.c)
