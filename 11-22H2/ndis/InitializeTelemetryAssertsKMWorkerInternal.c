/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1C0031BF0
 * Callers:
 *     InitializeTelemetryAssertsKMByDriverObject @ 0x1C0031AE8 (InitializeTelemetryAssertsKMByDriverObject.c)
 * Callees:
