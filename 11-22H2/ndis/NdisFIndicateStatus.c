/*
 * XREFs of NdisFIndicateStatus @ 0x1C0022AC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisIsStatusIndicationCloneable @ 0x1C0067FB0 (NdisIsStatusIndicationCloneable.c)
 *     ?ndisReferenceRefNoCheck@@YAXPEAU_REFERENCE_EX@@E@Z @ 0x1C00C4980 (-ndisReferenceRefNoCheck@@YAXPEAU_REFERENCE_EX@@E@Z.c)
