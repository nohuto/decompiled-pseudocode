/*
 * XREFs of ?ndisMSetRssCapabilities@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RECEIVE_SCALE_CAPABILITIES@@@Z @ 0x1C006E5B8
 * Callers:
 ...
 *     ndisRssPmObjectHeaderFixup @ 0x1C006EBA4 (ndisRssPmObjectHeaderFixup.c)
 */
