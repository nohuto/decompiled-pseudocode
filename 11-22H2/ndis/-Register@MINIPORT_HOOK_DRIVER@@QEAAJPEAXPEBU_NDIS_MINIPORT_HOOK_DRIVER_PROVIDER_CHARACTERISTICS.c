/*
 * XREFs of ?Register@MINIPORT_HOOK_DRIVER@@QEAAJPEAXPEBU_NDIS_MINIPORT_HOOK_DRIVER_PROVIDER_CHARACTERISTICS@@@Z @ 0x1C013DCA4
 * Callers:
 *     ?ndisMpHookNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z @ 0x1C01217D0 (-ndisMpHookNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z.c)
 * Callees:
        ...
        const struct _NDIS_MINIPORT_HOOK_DRIVER_PROVIDER_CHARACTERISTICS *a3)
{
  ...
  else
  {
    ...
    *((_QWORD *)this + 2) = a2;
    ...
    v6 = NmrClientAttachProvider(v8, v7, &off_1C00D7A70, (PVOID *)this + 3, (const void **)&ProviderDispatch);
    if ( v6 >= 0 )
    {
      v9 = ProviderDispatch;
