/*
 * XREFs of ??0BindState@Ndis@@QEAA@XZ @ 0x1C011CED8
 * Callers:
 *     ??0BindStack@Ndis@@QEAA@XZ @ 0x1C011BEDC (--0BindStack@Ndis@@QEAA@XZ.c)
 *     ??0NDIS_BIND_LINK_BASE@@QEAA@XZ @ 0x1C011CEAC (--0NDIS_BIND_LINK_BASE@@QEAA@XZ.c)
 * Callees:
