/*
 * XREFs of NdisAllocateRWLock @ 0x1C001B1C0
 * Callers:
 ...
 * Callees:
 *     ?ndisInitializeRWLock@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAX@Z @ 0x1C001B238 (-ndisInitializeRWLock@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAX@Z.c)
