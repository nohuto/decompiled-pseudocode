/*
 * XREFs of ?ndisVerifyNdisTryAcquireRWLockWrite@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@E@Z @ 0x1C00AC5D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryAcquireRWLockWrite @ 0x1C00AC890 (NdisTryAcquireRWLockWrite.c)
 */
