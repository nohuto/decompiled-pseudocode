/*
 * XREFs of ?ReadNetworkInterfaceV2@BindRegistry@Ndis@@YAJAEAVKRegKey@@0AEAUNdisNetworkInterfacePersistedState@@@Z @ 0x1C011D598
 * Callers:
        ...
        struct NdisNetworkInterfacePersistedState *a4)
{
  ...
  v20 = this;
  result = NetSetupPropertyBag::ReadString(&v20, &unk_1C00DA3E8, a3);
  v8 = 0;
  if ( (int)result < 0 )
    return result;
  result = NetSetupPropertyBag::ReadString(&v20, &unk_1C00DA478, &a3[1]);
  if ( (int)result < 0 )
    return result;
  v19 = 0;
  Uint64 = NetSetupPropertyBag::ReadUint32(
             (NetSetupPropertyBag *)&v20,
             (const struct _NETSETUPPROPKEY *)&unk_1C00DA3A0,
             &v19);
...
LABEL_47:
  ...
  Uint64 = NetSetupPropertyBag::ReadUint64(
             (NetSetupPropertyBag *)&v20,
             (const struct _NETSETUPPROPKEY *)&unk_1C00DA418,
  ...
  if ( (int)NetSetupPropertyBag::ReadUint32(
              (NetSetupPropertyBag *)&v20,
              (const struct _NETSETUPPROPKEY *)&unk_1C00DA490,
              (unsigned int *)&a3[7]) < 0 )
    LODWORD(a3[7].m_ptr) = 0;
  if ( (int)NetSetupPropertyBag::ReadUint32(
              (NetSetupPropertyBag *)&v20,
              (const struct _NETSETUPPROPKEY *)&unk_1C00DA448,
              (unsigned int *)&a3[7].m_ptr + 1) < 0 )
    HIDWORD(a3[7].m_ptr) = 0;
  result = NetSetupPropertyBag::ReadBoolean(
             (NetSetupPropertyBag *)&v20,
             (const struct _NETSETUPPROPKEY *)&unk_1C00DA388,
             (bool *)&a3[16].m_ptr + 5);
  if ( (int)result >= 0 )
  {
    result = NetSetupPropertyBag::ReadBoolean(
               (NetSetupPropertyBag *)&v20,
               (const struct _NETSETUPPROPKEY *)&unk_1C00DA370,
               (bool *)&a3[16].m_ptr + 4);
    if ( (int)result >= 0 )
    {
      result = NetSetupPropertyBag::ReadUint32(
                 (NetSetupPropertyBag *)&v20,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00DA430,
                 (unsigned int *)&a3[4]);
...
LABEL_53:
      ...
      result = NetSetupPropertyBag::ReadBoolean(
                 (NetSetupPropertyBag *)&v20,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00DA3D0,
                 (bool *)&a3[16].m_ptr + 7);
      if ( (_DWORD)result == -1073741772 )
      {
        BYTE6(a3[16].m_ptr) = 0;
      ...
      result = NetSetupPropertyBag::ReadUint32(
                 (NetSetupPropertyBag *)&v20,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00DA460,
                 (unsigned int *)&a3[17]);
      if ( (_DWORD)result == -1073741772 )
      {
        BYTE6(a3[16].m_ptr) = 0;
      ...
      result = NetSetupPropertyBag::ReadUint32(
                 (NetSetupPropertyBag *)&v20,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00DA400,
      ...
      Uint32 = NetSetupPropertyBag::ReadUint32(
                 (NetSetupPropertyBag *)&v20,
                 (const struct _NETSETUPPROPKEY *)&unk_1C00DA3B8,
                 (unsigned int *)&a3[18]);
