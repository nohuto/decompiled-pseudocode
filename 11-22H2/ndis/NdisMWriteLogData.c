/*
 * XREFs of NdisMWriteLogData @ 0x1C0071050
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisMWriteLogData(NDIS_HANDLE LogHandle, PVOID LogBuffer, UINT LogBufferSize)
{
  ...
  v14 = LogBufferSize + *((_DWORD *)LogHandle + 7);
  *((_DWORD *)LogHandle + 7) = v14;
  ...
  v15 = LogBufferSize + *((_DWORD *)LogHandle + 8);
  *((_DWORD *)LogHandle + 8) = v15;
  ...
  if ( v16 )
  {
    *((_QWORD *)LogHandle + 2) = 0LL;
    v17 = *(_QWORD *)(v16 + 8);
    if ( *(_DWORD *)(v17 + 40) <= v14 )
      v14 = *(_DWORD *)(v17 + 40);
    if ( v13 - *((_DWORD *)LogHandle + 9) < v14 )
    {
      if ( (*(_BYTE *)(v17 + 10) & 5) != 0 )
        v21 = *(char **)(v17 + 24);
      else
        v21 = (char *)MmMapLockedPagesSpecifyCache((PMDL)v17, 0, MmCached, 0LL, 0, 0x40000000u);
      if ( v21 )
      {
        memmove(
          v21,
        ...
        v20 = v14 + *((_DWORD *)LogHandle + 9) - (_DWORD)v22;
    ...
    else
    {
      if ( (*(_BYTE *)(v17 + 10) & 5) != 0 )
        ...
        v18 = (char *)MmMapLockedPagesSpecifyCache((PMDL)v17, 0, MmCached, 0LL, 0, 0x40000000u);
      if ( v18 )
      {
...
LABEL_27:
        ...
        *((_DWORD *)LogHandle + 7) -= v14;
        v24 = v14 + v23;
        v25 = *((_DWORD *)LogHandle + 6);
        *((_DWORD *)LogHandle + 9) = v24;
        if ( v24 >= v25 )
          *((_DWORD *)LogHandle + 9) = v24 - v25;
        *(_QWORD *)(v16 + 56) = v14;
