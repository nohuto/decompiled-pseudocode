/*
 * XREFs of ?ndisMSetMiniportReadyForBinding@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_NW4NDIS_DO_NOT_BIND_REASON@@W4CallRunMode@@@Z @ 0x1C0116700
 * Callers:
 ...
 *     NdisWdfMiniportStarted @ 0x1C0060610 (NdisWdfMiniportStarted.c)
