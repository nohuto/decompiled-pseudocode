/*
 * XREFs of ?ReadKnobFromKey@NetSetupKnobCollection@@EEAAJAEAVKRegKey@@AEBUKnobDescriptor@@AEAUKnobState@@@Z @ 0x1C01405D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?LookupNetSetupPropertyKey@@YAJPEB_WAEAU_NETSETUPPROPKEY@@@Z @ 0x1C0140418 (-LookupNetSetupPropertyKey@@YAJPEB_WAEAU_NETSETUPPROPKEY@@@Z.c)
 */
