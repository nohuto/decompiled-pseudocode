/*
 * XREFs of NdisMCmCreateVc @ 0x1C00BFEC0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisVcHandle)
{
  ...
  void (__fastcall *v29)(void *, struct _NDIS_PACKET **, unsigned int); // rax
  void (__fastcall *v30)(void *, struct _NET_BUFFER_LIST *, unsigned int, unsigned int); // rcx
  ...
  *NdisVcHandle = 0LL;
  ...
  v24 = (*(__int64 (__fastcall **)(__int64, _LIST_ENTRY *, _LIST_ENTRY **))(v22 + 1048))(v23, v12, &v12[1].Blink);
  if ( v24 )
  {
    ExFreePoolWithTag(v10, 0);
  ...
  v10[3] = v26;
  v12[6].Blink = v26;
  v12[6].Flink = *(_LIST_ENTRY **)(v25 + 1056);
  ExInterlockedInsertHeadList((PLIST_ENTRY)(v25 + 1112), v12 + 2, (PKSPIN_LOCK)(v25 + 232));
  Flink = v12[12].Flink;
  v10[5] = v12;
  ...
  if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)NdisAfHandle + 46) + 24LL) + 56LL) < 6u )
  {
    ...
    v29 = ndisMCoIndicateReceiveNdisPacketToNdisPacket;
  }
  else
  {
    if ( v28 < 6u )
    ...
    else
    {
      ...
      v31 = 0LL;
      v32 = (_LIST_ENTRY *)ndisMCoSendNetBufferListsCompleteToNetBufferLists;
