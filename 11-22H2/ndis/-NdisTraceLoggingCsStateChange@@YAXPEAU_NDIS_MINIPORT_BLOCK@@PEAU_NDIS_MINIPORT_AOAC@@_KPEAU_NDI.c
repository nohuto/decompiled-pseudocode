/*
 * XREFs of ?NdisTraceLoggingCsStateChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_AOAC@@_KPEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX@@PEAU_NDIS_MINIPORT_CS_TRAFFIC_STATS@@5@Z @ 0x1C008AA6C
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_TRAFFIC_STATS *a7)
{
  ...
  _OWORD v52[5]; // [rsp+1F0h] [rbp+70h] BYREF
  _BYTE v53[144]; // [rsp+240h] [rbp+C0h] BYREF

  memset(&v53[8], 0, 0x80uLL);
  memset(v52, 0, 0x48uLL);
  if ( MEMORY[0xFFFFF78000000008] - ndisLastCsEntryTime >= 0x165A0BC00LL )
  {
    v11 = v53;
    v12 = 17LL;
    v13 = (__int64 *)((char *)a2 + 536);
    do
    {
      v14 = *v13;
      v13 += 2;
    ...
    v15 = *(_OWORD *)a4;
    v16 = *((_OWORD *)a4 + 1);
    LODWORD(v52[3]) = *((_DWORD *)a4 + 12);
    v52[0] = v15;
    v17 = *((_OWORD *)a4 + 2);
    v52[1] = v16;
    v52[2] = v17;
    v18 = *(_OWORD *)a5;
    DWORD1(v52[4]) = *((_DWORD *)a5 + 4);
    *(_OWORD *)((char *)&v52[3] + 4) = v18;
