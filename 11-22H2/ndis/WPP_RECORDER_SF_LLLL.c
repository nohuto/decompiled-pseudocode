/*
 * XREFs of WPP_RECORDER_SF_LLLL @ 0x1C00A9204
 * Callers:
...
__int64 WPP_RECORDER_SF_LLLL(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x400) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 5u )
    ndisWppFastTraceMessage(
      &WPP_a9b9344cfcab39cb180cc205462f61f2_Traceguids,
      0x62u,
      va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 98;
  return WppAutoLogTrace(a1, 5LL, 11LL, &WPP_a9b9344cfcab39cb180cc205462f61f2_Traceguids, v7, (__int64 *)va);
}
