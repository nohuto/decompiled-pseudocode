/*
 * XREFs of ndisPeriodicReceivesTimer @ 0x1C003E710
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemSpecific3)
{
  ...
  v4 = 0LL;
  v5 = (char *)qword_1C00F5240 + 64 * (unsigned __int64)KeGetPcr()->Prcb.Number;
...
LABEL_12:
  ...
  if ( *(char **)v5 == v5 )
  {
    *((_DWORD *)qword_1C00F5238 + KeGetPcr()->Prcb.Number) = 0;
  }
  else
  {
    v8.QuadPart = qword_1C00F5228;
    if ( !qword_1C00F5228 )
      v8.QuadPart = -1LL;
    KeSetTimer(
  ...
  if ( v4 )
  {
    ...
    if ( (_BYTE)word_1C00F76B4 )
    {
      ...
      v10 = 48;
      *(_QWORD *)v12 = 0LL;
      *(_QWORD *)((char *)&v11 + 6) = qword_1C00F76A8;
