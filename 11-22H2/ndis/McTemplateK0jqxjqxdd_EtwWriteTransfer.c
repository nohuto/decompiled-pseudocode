/*
 * XREFs of McTemplateK0jqxjqxdd_EtwWriteTransfer @ 0x1C006307C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jqxjqxdd_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, &FilterChangedMediaType, a3, 9u, &v12);
}
