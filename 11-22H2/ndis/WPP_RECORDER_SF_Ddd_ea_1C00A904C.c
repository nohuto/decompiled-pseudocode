/*
 * XREFs of WPP_RECORDER_SF_Ddd @ 0x1C00A904C
 * Callers:
...
__int64 WPP_RECORDER_SF_Ddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x400) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 2u )
    ndisWppFastTraceMessage(&WPP_a9b9344cfcab39cb180cc205462f61f2_Traceguids, 0xAu, va, 4LL, va1, 4LL, va2, 4LL, 0LL);
  LOWORD(v7) = 10;
  return WppAutoLogTrace(a1, 2LL, 11LL, &WPP_a9b9344cfcab39cb180cc205462f61f2_Traceguids, v7, (__int64 *)va);
}
