/*
 * XREFs of ?SetKnobInStore@RegistryKnobCollection@@UEAAJAEBUKnobDescriptor@@_K@Z @ 0x1C0140340
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetValueUlong64@KRegKey@@QEAAJPEB_W_K@Z @ 0x1C0139AF0 (-SetValueUlong64@KRegKey@@QEAAJPEB_W_K@Z.c)
 */
