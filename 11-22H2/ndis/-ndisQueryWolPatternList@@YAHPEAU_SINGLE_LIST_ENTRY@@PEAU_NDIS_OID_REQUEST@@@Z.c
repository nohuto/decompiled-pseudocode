/*
 * XREFs of ?ndisQueryWolPatternList@@YAHPEAU_SINGLE_LIST_ENTRY@@PEAU_NDIS_OID_REQUEST@@@Z @ 0x1C0098B94
 * Callers:
 ...
 *     ?ndisOidPreWakeUpPatternList@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0096E20 (-ndisOidPreWakeUpPatternList@@YAEPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
...
__int64 __fastcall ndisQueryWolPatternList(struct _SINGLE_LIST_ENTRY *a1, struct _NDIS_OID_REQUEST *a2)
{
  ...
  if ( a2->DATA.QUERY_INFORMATION.InformationBufferLength >= v5 )
  {
    ...
    while ( v4 )
    {
      ...
      memmove(InformationBuffer, v13, v12);
      v6 += (v12 + 7) & 0xFFFFFFF8;
