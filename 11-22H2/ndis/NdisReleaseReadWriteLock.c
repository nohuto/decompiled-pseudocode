/*
 * XREFs of NdisReleaseReadWriteLock @ 0x1C0028CF0
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C00AC128 (-ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z.c)
 */
