/*
 * XREFs of ?ndisPublishSleepStudyNicAutoPowerSaverStats@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_KPEBU_GUID@@@Z @ 0x1C012B14C
 * Callers:
 ...
 *     ??$ReadAcquire@EX@mem@@YAEPEDE@Z @ 0x1C0057904 (--$ReadAcquire@EX@mem@@YAEPEDE@Z.c)
