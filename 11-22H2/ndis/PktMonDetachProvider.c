/*
 * XREFs of PktMonDetachProvider @ 0x1C00D3360
 * Callers:
 *     <none>
 * Callees:
...
__int64 PktMonDetachProvider()
{
  ...
  xmmword_1C00F53B0 = 0LL;
  KeWaitForSingleObject(&PktMonCompMutex, Executive, 0, 0, 0LL);
  while ( (__int64 *)PktMonCompList != &PktMonCompList )
  {
    v0 = qword_1C00F50A8;
    if ( *(__int64 **)qword_1C00F50A8 != &PktMonCompList
      || (v1 = (void **)*((_QWORD *)qword_1C00F50A8 + 1), *v1 != qword_1C00F50A8) )
    {
LABEL_18:
      __fastfail(3u);
    }
