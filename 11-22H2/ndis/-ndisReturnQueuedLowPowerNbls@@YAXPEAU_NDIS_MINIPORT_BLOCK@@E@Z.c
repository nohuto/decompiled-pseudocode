/*
 * XREFs of ?ndisReturnQueuedLowPowerNbls@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C009EC40
 * Callers:
...
void __fastcall ndisReturnQueuedLowPowerNbls(struct _NDIS_MINIPORT_BLOCK *a1, char a2)
{
  ...
  if ( LowPowerRcvReturnNbls )
  {
    if ( *(_DWORD *)ndisNblTrackerMode )
      ndisNblTrackerTransferOwnershipInternal(LowPowerRcvReturnNbls, 0LL, (unsigned __int64)a1->NblTracker, 141LL, 1u);
