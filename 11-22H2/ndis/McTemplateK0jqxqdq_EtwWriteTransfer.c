/*
 * XREFs of McTemplateK0jqxqdq_EtwWriteTransfer @ 0x1C0001008
 * Callers:
...
__int64 __fastcall McTemplateK0jqxqdq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a8)
{
  ...
  _BYTE v10[16]; // [rsp+40h] [rbp-51h] BYREF
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&NDIS_PROVIDER_ID_Context, a2, a3, 7LL, v10);
}
