/*
 * XREFs of ?ndisMInitializeScatterGatherDmaInternal@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_DEVICE_OBJECT@@EEKK@Z @ 0x1C00CD300
 * Callers:
 *     NdisMInitializeScatterGatherDma @ 0x1C00C5EF0 (NdisMInitializeScatterGatherDma.c)
 ...
 *     PplpCreateLookasideListEx @ 0x1C00CE63C (PplpCreateLookasideListEx.c)
 */
