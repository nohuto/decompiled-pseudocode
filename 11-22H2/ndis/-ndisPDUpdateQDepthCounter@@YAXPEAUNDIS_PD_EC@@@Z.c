/*
 * XREFs of ?ndisPDUpdateQDepthCounter@@YAXPEAUNDIS_PD_EC@@@Z @ 0x1C007C318
 * Callers:
...
void __fastcall ndisPDUpdateQDepthCounter(LARGE_INTEGER *a1)
{
  ...
  if ( !PerformanceFrequency.QuadPart )
  {
    ...
    qword_1C00F78E0 = PerformanceFrequency.QuadPart / 100;
  }
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  if ( PerformanceCounter.QuadPart - a1[18].QuadPart >= (unsigned __int64)qword_1C00F78E0 )
  {
    v8.m_State = Unlocked;
