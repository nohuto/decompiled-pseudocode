/*
 * XREFs of ?ndisRegisterProtocolDriverCommon@@YAXPEAU_NDIS_PROTOCOL_BLOCK@@@Z @ 0x1C002FFD4
 * Callers:
 ...
 *     ?ndisMDoesMiniportNeedCoNdisNdProxy@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00214B4 (-ndisMDoesMiniportNeedCoNdisNdProxy@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
 ...
 *     ?SetDirty@BindEngine@Ndis@@QEAAXXZ @ 0x1C013A2E0 (-SetDirty@BindEngine@Ndis@@QEAAXXZ.c)
 */
