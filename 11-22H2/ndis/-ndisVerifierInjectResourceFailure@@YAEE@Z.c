/*
 * XREFs of ?ndisVerifierInjectResourceFailure@@YAEE@Z @ 0x1C00B2D64
 * Callers:
 ...
 *     ?ndisVerifierAllocatePacketPoolEx@@YAXPEAHPEAPEAXIII@Z @ 0x1C00B2B90 (-ndisVerifierAllocatePacketPoolEx@@YAXPEAHPEAPEAXIII@Z.c)
 * Callees:
 *     <none>
 */
