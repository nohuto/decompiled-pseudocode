/*
 * XREFs of ?ndisIfNdisProvidedInterfaceSubsystemInitialize@@YAJXZ @ 0x1C011BD98
 * Callers:
...
__int64 ndisIfNdisProvidedInterfaceSubsystemInitialize(void)
{
  ...
  *(_OWORD *)&Src.Reserved1 = 0LL;
  v0 = ndisIfRegisterProviderInternal(&Src, &qword_1C00F7330, &qword_1C00F7330);
  if ( v0 )
  {
    v3 = v0;
  ...
  Src.SetObjectHandler = (int (__fastcall *)(void *, unsigned int, unsigned int, void *))NetSetupKnobCollection::SetKnobInStore;
  result = ndisIfRegisterProviderInternal(&Src, &qword_1C00F7328, &qword_1C00F7328);
  v2 = result;
  if ( (_DWORD)result )
  {
    NdisIfDeregisterProvider(&qword_1C00F7330);
    qword_1C00F7330 = 0LL;
    v3 = v2;
    return NdisConvertNdisStatusToNtStatus(v3);
  }
