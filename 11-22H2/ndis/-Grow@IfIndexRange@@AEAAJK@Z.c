/*
 * XREFs of ?Grow@IfIndexRange@@AEAAJK@Z @ 0x1C0035640
 * Callers:
 *     ?AllocateAnyBit@IfIndexRange@@QEAAJPEAK@Z @ 0x1C001C028 (-AllocateAnyBit@IfIndexRange@@QEAAJPEAK@Z.c)
 *     ndisIfTryAllocatingSuggestedIndex @ 0x1C001C0B0 (ndisIfTryAllocatingSuggestedIndex.c)
 * Callees:
