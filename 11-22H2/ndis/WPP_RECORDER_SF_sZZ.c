/*
 * XREFs of WPP_RECORDER_SF_sZZ @ 0x1C007496C
 * Callers:
...
LABEL_15:
  ...
  ndisWppFastTraceMessage(
    &WPP_f447471922483fea15b29c0a6cad7a3c_Traceguids,
    a4,
    v20,
    v19,
    v17,
...
LABEL_25:
  ...
  if ( !a6 )
    v8 = "NULL";
  LOWORD(v22) = a4;
  return WppAutoLogTrace(v10, 4LL, 13LL, &WPP_f447471922483fea15b29c0a6cad7a3c_Traceguids, v22, v8);
}
