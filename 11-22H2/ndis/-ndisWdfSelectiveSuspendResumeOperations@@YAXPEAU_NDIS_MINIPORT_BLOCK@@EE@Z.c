/*
 * XREFs of ?ndisWdfSelectiveSuspendResumeOperations@@YAXPEAU_NDIS_MINIPORT_BLOCK@@EE@Z @ 0x1C003F7E2
 * Callers:
 ...
 *     NdisWdfAsyncPowerReferenceCompleteNotification @ 0x1C01391E0 (NdisWdfAsyncPowerReferenceCompleteNotification.c)
 * Callees:
