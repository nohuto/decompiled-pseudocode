/*
 * XREFs of ?ndisAoAcCompleteQueuedIrps@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x1C0057D74
 * Callers:
 ...
 * Callees:
 *     ?ndisMoveLinkedList@@YAXPEAU_LIST_ENTRY@@0@Z @ 0x1C003F144 (-ndisMoveLinkedList@@YAXPEAU_LIST_ENTRY@@0@Z.c)
 */
