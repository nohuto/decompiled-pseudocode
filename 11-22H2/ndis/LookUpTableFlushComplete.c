/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0120524
 * Callers:
 *     ndisDmaTelemetryUpdateBucketSchema @ 0x1C0032D04 (ndisDmaTelemetryUpdateBucketSchema.c)
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0121800 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
