/*
 * XREFs of ?ndisMInitializeMiniportBlockFront@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x1C014D710
 * Callers:
 ...
 * Callees:
 *     ?ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z @ 0x1C00345FC (-ndisInitializeULongRef@@YAXPEAU_ULONG_REFERENCE@@@Z.c)
...
void __fastcall ndisMInitializeMiniportBlockFront(char *DeferredContext, int a2)
{
  ...
  *((_QWORD *)DeferredContext + 68) = &ndisGlobalTriageBlock;
  ...
  DeferredContext[32] = *(_BYTE *)(v2 + 24);
  v6 = *(_BYTE *)(v2 + 25);
