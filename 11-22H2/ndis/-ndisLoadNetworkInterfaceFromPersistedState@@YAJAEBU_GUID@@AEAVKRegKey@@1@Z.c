/*
 * XREFs of ?ndisLoadNetworkInterfaceFromPersistedState@@YAJAEBU_GUID@@AEAVKRegKey@@1@Z @ 0x1C0118BE0
 * Callers:
 ...
 * Callees:
 *     ??1NdisNetworkInterfacePersistedState@@QEAA@XZ @ 0x1C002A3A4 (--1NdisNetworkInterfacePersistedState@@QEAA@XZ.c)
