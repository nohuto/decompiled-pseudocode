/*
 * XREFs of ?ndisCloseHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C00681E8
 * Callers:
 *     NdisWdfCloseIrpHandler @ 0x1C00602F0 (NdisWdfCloseIrpHandler.c)
 * Callees:
