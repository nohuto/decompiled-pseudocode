...
{
  __int64 v36; // rcx
  _EVENT_DATA_DESCRIPTOR v38; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v42 = 4LL;
  v40 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00F4638, a2, 0LL, 0LL, 0x2Bu, &v38);
}
