/*
 * XREFs of NdisFreeNetBufferListPool @ 0x1C0015A40
 * Callers:
...
void __stdcall NdisFreeNetBufferListPool(NDIS_HANDLE PoolHandle)
{
  ...
  if ( PoolHandle )
  {
    v5.m_lock = (KSpinLockBase *)&qword_1C00F5E48;
    v2 = KeAcquireSpinLockRaiseToDpc(&qword_1C00F5E48);
    ...
    *v4 = v3;
    v3[1] = v4;
    KeReleaseSpinLock(&qword_1C00F5E48, v2);
    v5.m_oldIrql = -1;
