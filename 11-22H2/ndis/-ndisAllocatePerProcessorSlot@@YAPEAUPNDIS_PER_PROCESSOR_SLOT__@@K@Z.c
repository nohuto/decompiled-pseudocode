/*
 * XREFs of ?ndisAllocatePerProcessorSlot@@YAPEAUPNDIS_PER_PROCESSOR_SLOT__@@K@Z @ 0x1C001B288
 * Callers:
 ...
 * Callees:
 *     ndisAllocateFreeSlotFromDescriptor @ 0x1C001B328 (ndisAllocateFreeSlotFromDescriptor.c)
