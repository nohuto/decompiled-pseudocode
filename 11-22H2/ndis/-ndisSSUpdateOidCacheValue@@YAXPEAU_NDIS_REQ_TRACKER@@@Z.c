/*
 * XREFs of ?ndisSSUpdateOidCacheValue@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C00ADC34
 * Callers:
 *     ?ndisOidPostStatistics@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0005C50 (-ndisOidPostStatistics@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
