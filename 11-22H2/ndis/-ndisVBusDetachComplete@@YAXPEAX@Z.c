/*
 * XREFs of ?ndisVBusDetachComplete@@YAXPEAX@Z @ 0x1C0139560
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisVBusDetachComplete(void *a1)
{
  ...
  ndisBindEnumerateProtocolDrivers(
    (void (__fastcall *)(__int64, NDIS_BIND_PROTOCOL_DRIVER **))lambda_9f85fcd2040f04b850747010404e3e47_::_lambda_invoker_cdecl_,
    0LL);
