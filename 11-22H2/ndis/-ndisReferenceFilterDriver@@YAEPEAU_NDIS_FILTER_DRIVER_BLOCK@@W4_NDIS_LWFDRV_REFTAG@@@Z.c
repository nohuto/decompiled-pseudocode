/*
 * XREFs of ?ndisReferenceFilterDriver@@YAEPEAU_NDIS_FILTER_DRIVER_BLOCK@@W4_NDIS_LWFDRV_REFTAG@@@Z @ 0x1C001C510
 * Callers:
 ...
 *     ?ndisPDReferenceClientDriver@@YAEPEAX@Z @ 0x1C0134BD0 (-ndisPDReferenceClientDriver@@YAEPEAX@Z.c)
...
unsigned __int8 __fastcall ndisReferenceFilterDriver(struct _NDIS_FILTER_DRIVER_BLOCK *a1, unsigned __int8 a2)
{
