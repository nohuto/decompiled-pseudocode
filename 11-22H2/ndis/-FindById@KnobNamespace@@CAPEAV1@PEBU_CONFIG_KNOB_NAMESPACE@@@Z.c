/*
 * XREFs of ?FindById@KnobNamespace@@CAPEAV1@PEBU_CONFIG_KNOB_NAMESPACE@@@Z @ 0x1C013F8E8
 * Callers:
...
struct KnobNamespace *__fastcall KnobNamespace::FindById(const struct _CONFIG_KNOB_NAMESPACE *a1)
{
  ...
  v1 = (__int64 *)qword_1C00F5DC8;
  if ( (__int64 *)qword_1C00F5DC8 == &qword_1C00F5DC8 )
    return 0LL;
