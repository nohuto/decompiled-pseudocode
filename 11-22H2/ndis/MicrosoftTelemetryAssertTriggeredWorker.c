/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C00D2698
 * Callers:
 ...
 *     GetImageTuple @ 0x1C00D2618 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C00D2C10 (_tlgCreate1Sz_char.c)
 */
...
LABEL_35:
  ...
  v20 = "<unknown>";
  v21 = v31;
  if ( (unsigned int)dword_1C010B040 > 5 && tlgKeywordOn((__int64)&dword_1C010B040, 0x400000000000LL) )
  {
    v31 = 10;
    v56 = &v31;
    v22 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_1C010B040,
      (unsigned __int8 *)dword_1C00DFCE4,
      0LL,
      0LL,
      0xBu,
      &v55);
  }
  if ( dword_1C010B078 && !v19 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C010B040 > 5 && tlgKeywordOn((__int64)&dword_1C010B040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C010B040,
        (unsigned __int8 *)dword_1C00DFD51,
        v26,
        0LL,
        v27,
        &v39);
