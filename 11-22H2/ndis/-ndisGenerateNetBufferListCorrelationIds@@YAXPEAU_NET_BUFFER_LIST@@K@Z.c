/*
 * XREFs of ?ndisGenerateNetBufferListCorrelationIds@@YAXPEAU_NET_BUFFER_LIST@@K@Z @ 0x1C00B47B8
 * Callers:
 ...
 * Callees:
 *     ndisGenerateCorrelationIds @ 0x1C00402B4 (ndisGenerateCorrelationIds.c)
 */
