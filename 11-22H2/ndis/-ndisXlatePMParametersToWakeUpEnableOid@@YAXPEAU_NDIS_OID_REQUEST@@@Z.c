/*
 * XREFs of ?ndisXlatePMParametersToWakeUpEnableOid@@YAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1C009AD44
 * Callers:
 *     ?ndisOidPostEnableWakeUp@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0095420 (-ndisOidPostEnableWakeUp@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
