/*
 * XREFs of ?ndisWmiQueryAllData@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@PEAU_GUID@@PEAUtagWNODE_ALL_DATA@@KPEAK@Z @ 0x1C008EFB0
 * Callers:
 *     ndisWMIDispatch @ 0x1C000F9B0 (ndisWMIDispatch.c)
 *     NdisWdfQueryAllData @ 0x1C0060830 (NdisWdfQueryAllData.c)
 * Callees:
 ...
 *     ndisWmiGuidIsAdapterSpecific @ 0x1C008EE78 (ndisWmiGuidIsAdapterSpecific.c)
