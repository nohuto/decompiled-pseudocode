/*
 * XREFs of ??0NdisWatchdogState@@QEAA@XZ @ 0x1C0112724
 * Callers:
...
NdisWatchdogState *__fastcall NdisWatchdogState::NdisWatchdogState(char *DeferredContext)
{
  ...
  *((_QWORD *)DeferredContext + 19) = DeferredContext;
  ...
  v2 = (_QWORD *)qword_1C00F5CE0;
  v3 = DeferredContext + 272;
  if ( *(struct _LIST_ENTRY **)qword_1C00F5CE0 != &g_ndisWatchdogList )
    __fastfail(3u);
  *((_QWORD *)DeferredContext + 35) = qword_1C00F5CE0;
  *v3 = &g_ndisWatchdogList;
  *v2 = v3;
  qword_1C00F5CE0 = (__int64)(DeferredContext + 272);
