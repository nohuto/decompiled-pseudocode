    ...
    case 0u:
      ...
      if ( Pool2 )
      {
        ...
        *(_BYTE *)Pool2 = ndisCheckAccess(a2, CurrentStackLocation, v10);
        v9[1] = ndisCheckAccess(a2, CurrentStackLocation, &unk_1C00D81B0);
        v9[2] = ndisCheckAccess(a2, CurrentStackLocation, &unk_1C00F5D00);
        CurrentStackLocation->FileObject->FsContext = v9;
        _InterlockedIncrement(&dword_1C00F5C20);
      }
      else
      {
        v4 = -1073741670;
