/*
 * XREFs of ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C00AC128
 * Callers:
 *     NdisReleaseReadWriteLock @ 0x1C0028CF0 (NdisReleaseReadWriteLock.c)
...
void __fastcall ndisReleaseReadLockSharedRefCnt(PKSPIN_LOCK SpinLock)
{
  ...
  *((_DWORD *)SpinLock + 6) = v3;
  ...
  v4 = qword_1C00F7840 + 520LL * KeGetPcr()->Prcb.Number;
  v5 = *(_DWORD *)(v4 + 512);
  if ( v5 )
  {
