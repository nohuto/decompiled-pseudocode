/*
 * XREFs of ?NdisTraceLoggingDeviceInitialized@@YAXPEAU_NDIS_MINIPORT_BLOCK@@AEBVKStopwatch@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@H@Z @ 0x1C00230E8
 * Callers:
...
void __fastcall NdisTraceLoggingDeviceInitialized(__int64 a1, KStopwatch *a2, __int64 a3, int a4)
{
  __int64 v5; // r10
  int v6; // ecx
  int v7; // r8d
  ...
  if ( a4 )
  {
    if ( (unsigned int)dword_1C00F4210 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C00F4210, 0x400000000000LL) )
    {
      v20 = *(_BYTE *)(v12 + 33);
      v14[0] = *(_BYTE *)(v12 + 32);
