/*
 * XREFs of ??$ndisExpandDataPathStack@$02$$A6AXPEAXPEAU_NET_BUFFER_LIST@@K@Z@@YAJPEAU_NET_BUFFER_LIST@@KKKPEAX1P6AX10K@Z@Z @ 0x1C0064668
 * Callers:
 ...
 *     ?ndisExpandStackAllocationLikely@@YAJP6AXPEAX@Z0@Z @ 0x1C003FEA2 (-ndisExpandStackAllocationLikely@@YAJP6AXPEAX@Z0@Z.c)
 */
        ...
        void (__fastcall *a7)(__int64, __int64, _QWORD))
{
  ...
  v11 = *(_QWORD *)(v10 + qword_1C00F5720);
  LowLimit = v11;
  v12 = *(_QWORD *)(v10 + qword_1C00F5718);
  HighLimit = v12;
