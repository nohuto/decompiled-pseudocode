/*
 * XREFs of ?ndisOidPreMiniportStats@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C00A2280
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisOidGetStatisticAllProcessors@@YAEPEAU_NDIS_MINIPORT_STATS@@KPEA_K@Z @ 0x1C003E098 (-ndisOidGetStatisticAllProcessors@@YAEPEAU_NDIS_MINIPORT_STATS@@KPEA_K@Z.c)
 */
...
char __fastcall ndisOidPreMiniportStats(struct _NDIS_REQ_TRACKER *a1)
{
  __int64 v1; // rdi
  char v2; // bl
  struct _NDIS_REQ_TRACKER *v3; // rsi
  __int64 v4; // rax
  __int64 v5; // rcx
  unsigned int v6; // ebp
  __int64 v7; // rax
