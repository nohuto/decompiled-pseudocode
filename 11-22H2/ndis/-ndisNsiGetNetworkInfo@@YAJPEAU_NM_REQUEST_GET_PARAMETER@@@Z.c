/*
 * XREFs of ?ndisNsiGetNetworkInfo@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00BAFA0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v6 )
  {
    ...
    else
    {
      *v4 = 0LL;
      ...
      {
LABEL_12:
        v9 = (__int64 *)qword_1C00F5DB0;
        v1 = 0LL;
        if ( (__int64 *)qword_1C00F5DB0 != &qword_1C00F5DB0 )
        {
          while ( (int)ndisCompareGuid((__int64)(v9 + 4), (__int64)v4) <= 0 )
          {
            v9 = (__int64 *)*v9;
            if ( v9 == &qword_1C00F5DB0 )
              goto LABEL_20;
          }
          v1 = (char *)v9;
        }
