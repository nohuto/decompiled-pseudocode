/*
 * XREFs of NdisAllocateReassembledNetBufferList @ 0x1C00B4160
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NetioCopyOpaqueNetBufferListInformation @ 0x1C0040254 (NetioCopyOpaqueNetBufferListInformation.c)
