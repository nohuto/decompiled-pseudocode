/*
 * XREFs of ?ndisSetPerfTrackParameters@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z @ 0x1C006921C
 * Callers:
      ...
      if ( v10 == 1 )
      {
        ...
        if ( MiniportDataBlock )
        {
          ...
          if ( ndisMaxNumberOfProcessors )
          {
            ...
            do
              memset((char *)MiniportDataBlock + v14 + ndisPcwPerCpuDataStride * v13++, 0, 0x130uLL);
            while ( v13 < v12 );
          }
        }
