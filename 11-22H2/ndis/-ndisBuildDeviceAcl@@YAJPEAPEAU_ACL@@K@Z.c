/*
 * XREFs of ?ndisBuildDeviceAcl@@YAJPEAPEAU_ACL@@K@Z @ 0x1C0031F80
 * Callers:
 ...
 *     ?ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z @ 0x1C011FC3C (-ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z.c)
 * Callees:
...
__int64 __fastcall ndisBuildDeviceAcl(struct _ACL **a1, char a2)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v15 = RtlLengthSid(&unk_1C00DA658);
    v16 = RtlLengthSid(&unk_1C00DA638) + v15;
    v6 += v16 + 32 + RtlLengthSid(&unk_1C00DA618);
  }
  v22 = a2 & 4;
  if ( (a2 & 4) != 0 )
  {
...
LABEL_43:
  ...
  v10 = a2 & 0x80;
  if ( v10 )
    v6 += RtlLengthSid(&unk_1C00DA5F8) + 8;
  ...
  if ( v11 )
  {
    ...
    else
    {
      ...
      if ( v21 )
      {
        RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00DA618);
        RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00DA638);
        RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00DA658);
      }
      if ( v22 )
      ...
      if ( v10 )
        RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00DA5F8);
      Acl = 0;
      *v25 = v12;
    }
  }
