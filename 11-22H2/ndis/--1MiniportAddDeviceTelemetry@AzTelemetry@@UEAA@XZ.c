/*
 * XREFs of ??1MiniportAddDeviceTelemetry@AzTelemetry@@UEAA@XZ @ 0x1C00D13C0
 * Callers:
 *     ??_GMiniportAddDeviceTelemetry@AzTelemetry@@UEAAPEAXI@Z @ 0x1C0069B90 (--_GMiniportAddDeviceTelemetry@AzTelemetry@@UEAAPEAXI@Z.c)
