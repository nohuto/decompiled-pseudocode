/*
 * XREFs of ?ndisWdfUpdateAddDeviceParameters@@YAJAEAVKRegKey@@AEAUNDIS_MINIPORT_CREATION_CONFIG@@@Z @ 0x1C012CC44
 * Callers:
 ...
 *     ?IsIfBlockAvailable@@YA_NAEBU_GUID@@@Z @ 0x1C005D73C (-IsIfBlockAvailable@@YA_NAEBU_GUID@@@Z.c)
