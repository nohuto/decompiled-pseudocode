/*
 * XREFs of McTemplateK0jqxb6_EtwWriteTransfer @ 0x1C006ED84
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jqxb6_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        __int64 a7)
{
  ...
  v14 = 8LL;
  v16 = 6LL;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, &MiniportMacAddress, a3, 5u, &v8);
}
