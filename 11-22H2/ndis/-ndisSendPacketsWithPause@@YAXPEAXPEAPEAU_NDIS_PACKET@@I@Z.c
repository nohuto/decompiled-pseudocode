/*
 * XREFs of ?ndisSendPacketsWithPause@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C00CACD0
 * Callers:
 *     ?ndisSendWithPause@@YAHPEAXPEAU_NDIS_PACKET@@@Z @ 0x1C00CAFB0 (-ndisSendWithPause@@YAHPEAXPEAU_NDIS_PACKET@@@Z.c)
 * Callees:
