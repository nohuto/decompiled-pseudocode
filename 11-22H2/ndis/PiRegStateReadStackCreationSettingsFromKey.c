/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C014300C
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C0143498 (SeUtilSecurityInfoFromSecurityDescriptor.c)
