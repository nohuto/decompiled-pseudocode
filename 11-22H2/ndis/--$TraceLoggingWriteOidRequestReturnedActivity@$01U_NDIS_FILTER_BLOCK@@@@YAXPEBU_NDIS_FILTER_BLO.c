/*
 * XREFs of ??$TraceLoggingWriteOidRequestReturnedActivity@$01U_NDIS_FILTER_BLOCK@@@@YAXPEBU_NDIS_FILTER_BLOCK@@PEBU_NDIS_OID_REQUEST@@@Z @ 0x1C00D0A84
 * Callers:
...
void TraceLoggingWriteOidRequestReturnedActivity<2,_NDIS_FILTER_BLOCK>()
{
  __int64 v0; // r9
  __int64 v1; // r10
