/*
 * XREFs of ?ndisWmiQuerySingleInstance@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_GUID@@PEAUtagWNODE_SINGLE_INSTANCE@@KPEAK@Z @ 0x1C0025FE0
 * Callers:
 *     ndisWMIDispatch @ 0x1C000F9B0 (ndisWMIDispatch.c)
 *     NdisWdfQuerySingleInstance @ 0x1C0060860 (NdisWdfQuerySingleInstance.c)
 * Callees:
