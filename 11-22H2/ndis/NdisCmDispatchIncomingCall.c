/*
 * XREFs of NdisCmDispatchIncomingCall @ 0x1C00BDF00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z @ 0x1C00BE53C (-ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z.c)
 */
