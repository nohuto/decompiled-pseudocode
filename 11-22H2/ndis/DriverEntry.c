 ...
 *     McGenEventRegister_EtwRegister @ 0x1C0030FFC (McGenEventRegister_EtwRegister.c)
 ...
 *     ?ndisRegisterPDCounterSets@@YAXXZ @ 0x1C0034CA4 (-ndisRegisterPDCounterSets@@YAXXZ.c)
 *     ?ndisWppInitTracingEx@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z @ 0x1C0034E6C (-ndisWppInitTracingEx@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z.c)
 *     ?ndisVerifierInitialization@@YAEXZ @ 0x1C0035D50 (-ndisVerifierInitialization@@YAEXZ.c)
 ...
 *     ??0KLoader@@QEAA@XZ @ 0x1C011F494 (--0KLoader@@QEAA@XZ.c)
 ...
 *     ?ndisInitializeStackTraces@@YAXXZ @ 0x1C0121558 (-ndisInitializeStackTraces@@YAXXZ.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  KnobNamespace::KnobNamespace(&stru_1C00F5D30, v9, (const struct _CONFIG_KNOB_NAMESPACE *)&Parameters);
...
LABEL_23:
            ...
            qword_1C00F5E10 = (__int64)&ndisGlobalTimerList;
            ...
            if ( v13 >= 0 )
            {
              ...
              if ( v13 >= 0 )
              {
                ...
                *(_QWORD *)&Info.CounterCount = 10LL;
                ...
                qword_1C00F49E8 = (__int64)&qword_1C00F5E98;
                ...
                qword_1C00F51E0 = KLoader::KLoader((KLoader *)&unk_1C00F5DD8);
