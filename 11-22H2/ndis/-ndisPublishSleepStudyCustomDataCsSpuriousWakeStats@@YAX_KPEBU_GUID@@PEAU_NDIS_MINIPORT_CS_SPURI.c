/*
 * XREFs of ?ndisPublishSleepStudyCustomDataCsSpuriousWakeStats@@YAX_KPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX@@@Z @ 0x1C012AB4C
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX *a4)
{
  ...
  v5 = (const wchar_t **)off_1C00D7B10;
  v9 = 13LL;
  do
  {
    if ( *(_DWORD *)a3 )
  ...
  while ( v9 );
  v10 = (const wchar_t **)off_1C00D7AE8;
  v11 = 5LL;
  do
  {
    if ( *(_DWORD *)a4 )
