/*
 * XREFs of ?ndisWdfGetGuidToOidList@@YAXPEBKGPEAU_NDIS_GUID@@PEAG@Z @ 0x1C008D70C
 * Callers:
 *     NdisWdfGetGuidToOidMap @ 0x1C0060410 (NdisWdfGetGuidToOidMap.c)
 * Callees:
 *     ndisWmiMapOids @ 0x1C002D6A4 (ndisWmiMapOids.c)
 */
