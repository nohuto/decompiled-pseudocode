/*
 * XREFs of ?ndisReleaseReadWriteLockX@@YAXPEAU_NDIS_RW_LOCK@@PEAU_LOCK_STATE@@E@Z @ 0x1C003ECEE
 * Callers:
 *     NdisDprReleaseReadWriteLock @ 0x1C00AC1F0 (NdisDprReleaseReadWriteLock.c)
 * Callees:
