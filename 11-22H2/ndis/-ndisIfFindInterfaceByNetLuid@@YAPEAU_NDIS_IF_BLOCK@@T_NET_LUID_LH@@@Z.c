/*
 * XREFs of ?ndisIfFindInterfaceByNetLuid@@YAPEAU_NDIS_IF_BLOCK@@T_NET_LUID_LH@@@Z @ 0x1C0022DF8
 * Callers:
 ...
 *     ndisIfUpdateInterfaceFromPersistentStore @ 0x1C002A594 (ndisIfUpdateInterfaceFromPersistentStore.c)
 *     ndisIfUpdateLoopbackInterfaceOnNetwork @ 0x1C0035CEC (ndisIfUpdateLoopbackInterfaceOnNetwork.c)
 ...
 *     NdisIfGetInterfaceIndexFromNetLuid @ 0x1C00B76C0 (NdisIfGetInterfaceIndexFromNetLuid.c)
