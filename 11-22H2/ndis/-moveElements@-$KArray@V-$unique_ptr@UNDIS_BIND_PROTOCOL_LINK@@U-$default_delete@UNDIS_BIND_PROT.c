/*
 * XREFs of ?moveElements@?$KArray@V?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@$00@Rtl@@AEAAXKKK@Z @ 0x1C011F1C8
 * Callers:
...
NDIS_BIND_PROTOCOL_LINK **__fastcall Rtl::KArray<wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>,1>::moveElements(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        int a4)
{
  ...
  if ( (_DWORD)a2 != a3 )
  {
    result = (NDIS_BIND_PROTOCOL_LINK **)&retaddr;
    v7 = a2;
    if ( a4 )
    {
      if ( (unsigned int)a2 >= a3 )
      {
        ...
        if ( a3 < (unsigned int)a2 )
        {
          ...
          do
          {
            ...
            v20 = v19;
            ++v16;
            result = *(NDIS_BIND_PROTOCOL_LINK ***)(a2 + 8 * v19);
            *(_QWORD *)(a2 + 8 * v20) = 0LL;
        ...
        if ( v16 < v21 )
        {
          ...
          do
          {
            wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'(
              (NDIS_BIND_PROTOCOL_LINK **)(*(_QWORD *)(a1 + 8) + 8LL * v16),
              a2);
            a2 = *(_QWORD *)(a1 + 8);
            v23 = v16 + v17;
            v24 = v23;
            ++v16;
            result = *(NDIS_BIND_PROTOCOL_LINK ***)(a2 + 8 * v23);
            *(_QWORD *)(a2 + 8 * v24) = 0LL;
        ...
        if ( v16 < v7 + a4 )
        {
          ...
          do
          {
            result = wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'(
                       (NDIS_BIND_PROTOCOL_LINK **)(v27 + *(_QWORD *)(a1 + 8)),
                       a2);
            v27 += 8LL;
            --v26;
          }
      ...
      else
      {
        ...
        for ( i = a3 + a4 - 1; (unsigned int)i >= *(_DWORD *)(a1 + 4); i = v9 - 1 )
        {
          ...
          v12 = v9 - v10;
          --v9;
          result = (NDIS_BIND_PROTOCOL_LINK **)(unsigned int)(v12 - 1);
        ...
        if ( v9 > a3 )
        {
          do
          {
            v14 = v9 - 1;
            wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'(
              (NDIS_BIND_PROTOCOL_LINK **)(*(_QWORD *)(a1 + 8) + 8 * v14),
              a2);
            a2 = *(_QWORD *)(a1 + 8);
            v15 = v9 - v10 - 1;
            result = *(NDIS_BIND_PROTOCOL_LINK ***)(a2 + 8 * v15);
            *(_QWORD *)(a2 + 8 * v15) = 0LL;
            v9 = v14;
        ...
        while ( v9 > v7 )
          result = wistd::unique_ptr<NDIS_BIND_PROTOCOL_LINK,wistd::default_delete<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'(
                     (NDIS_BIND_PROTOCOL_LINK **)(*(_QWORD *)(a1 + 8) + 8LL * --v9),
                     a2);
      }
    }
  }
