/*
 * XREFs of ?ndisQueryReferenceBusInterface@@YAJPEAU_DEVICE_OBJECT@@PEAPEAUBUS_INTERFACE_REFERENCE@@@Z @ 0x1C005E2F4
 * Callers:
...
__int64 __fastcall ndisQueryReferenceBusInterface(PDEVICE_OBJECT DeviceObject, PVOID *a2)
{
  ...
  Pool2 = (struct BUS_INTERFACE_REFERENCE *)ExAllocatePool2(64LL, 56LL, 1768047694);
  *a2 = Pool2;
  if ( !Pool2 )
    return 3221225626LL;
