/*
 * XREFs of ??0NdisFreeSharedMemoryTelemetry@@QEAA@PEBU_NDIS_SHARED_MEMORY_BLOCK@@@Z @ 0x1C00CF660
 * Callers:
        ...
        const struct _NDIS_SHARED_MEMORY_BLOCK *a2)
{
  ...
  if ( (a2->Flags & 0x10) == 0
    || (unsigned int)dword_1C00F41D8 <= 4
    || (v4 = tlgKeywordOn((__int64)&dword_1C00F41D8, 2112LL) == 0, v5 = 1, v4) )
  {
    v5 = 0;
  }
  *(_BYTE *)this = v5;
