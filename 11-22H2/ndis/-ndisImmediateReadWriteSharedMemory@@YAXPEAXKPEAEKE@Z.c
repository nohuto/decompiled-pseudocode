/*
 * XREFs of ?ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z @ 0x1C00C3F10
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00C4150 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00C4200 (NdisImmediateWriteSharedMemory.c)
 * Callees:
