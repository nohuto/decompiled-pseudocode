/*
 * XREFs of TlgRegisterAggregateProviderEx @ 0x1C011F8A8
 * Callers:
 ...
 *     DestroyAggregateSession @ 0x1C0144108 (DestroyAggregateSession.c)
 */
...
__int64 __fastcall TlgRegisterAggregateProviderEx(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(TlgAggregateSession + 368) = ComputeFlushPeriod(TlgAggregateSession);
  ...
  {
    ExAcquirePushLockExclusiveEx(&unk_1C00F5C60, 0LL);
    v5 = qword_1C00F7588;
    if ( !qword_1C00F7588 )
    {
    ...
    *v6 = (__int64)v3;
LABEL_8:
    ExReleasePushLockExclusiveEx(&unk_1C00F5C60, 0LL);
    return 0LL;
  }
}
