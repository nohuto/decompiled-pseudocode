/*
 * XREFs of NdisAllocateNetBufferListPool @ 0x1C001AA50
 * Callers:
        ...
        PNET_BUFFER_LIST_POOL_PARAMETERS Parameters)
{
  ...
  if ( Pool )
  {
    ...
    *((_QWORD *)v4 + 2) = (char *)v4 + 16;
    v22.m_lock = (KSpinLockBase *)&qword_1C00F5E48;
    v17 = KeAcquireSpinLockRaiseToDpc(&qword_1C00F5E48);
    v18 = qword_1C00F5E98;
    v19 = (_QWORD *)((char *)v4 + 72);
    if ( *(__int64 **)(qword_1C00F5E98 + 8) != &qword_1C00F5E98 )
      __fastfail(3u);
    *v19 = qword_1C00F5E98;
    *((_QWORD *)v4 + 10) = &qword_1C00F5E98;
    *(_QWORD *)(v18 + 8) = v19;
    qword_1C00F5E98 = (__int64)v4 + 72;
    KeReleaseSpinLock(&qword_1C00F5E48, v17);
    v22.m_oldIrql = -1;
