/*
 * XREFs of NdisFRegisterFilterDriver @ 0x1C0030530
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisFilterDriverHandle)
{
  ...
  NDIS_STATUS v35; // eax
  PVOID v36; // rbx
  struct _UNICODE_STRING *v37; // [rsp+28h] [rbp-80h]
      ...
      else
      {
        ...
        if ( !FilterDriverRegistry )
        {
            ...
            && (FilterDriverCharacteristics->Flags & 0xFFFFFFF8) != 0 )
          {
            if ( *(unsigned int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
            {
              LODWORD(v37) = FilterDriverCharacteristics->Flags;
              WPP_RECORDER_SF_D(
                *((_QWORD *)WPP_GLOBAL_Control + 8),
                2u,
                1u,
          ...
          {
            v16 = FilterDriverCharacteristics->UniqueName.Length + p_ServiceName->Length;
