/*
 * XREFs of RtlUnicodeStringValidateWorker @ 0x1C0028924
 * Callers:
 *     RtlUnicodeStringValidateDestWorker @ 0x1C00287CC (RtlUnicodeStringValidateDestWorker.c)
 *     ?RtlUnicodeStringCat@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z @ 0x1C0028838 (-RtlUnicodeStringCat@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z.c)
 * Callees:
 *     <none>
 */
