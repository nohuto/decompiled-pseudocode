/*
 * XREFs of ?ndisNsiGetAllInterfaceInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C000AA30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  {
    v10 = 0;
    v173 = KeAcquireSpinLockRaiseToDpc(&qword_1C00F5D78);
    if ( v16 < dword_1C00F7620 )
      v10 = *((_DWORD *)qword_1C00F7628 + 6 * v16);
    KeReleaseSpinLock(&qword_1C00F5D78, v173);
    if ( !v10 )
      v10 = 1;
  }
  else
  ...
  if ( qword_1C00F5DA0 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA0 )
  {
    while ( *((_DWORD *)v20 + 4) != v11 )
    {
      if ( *((_DWORD *)v20 + 4) <= v11 )
      {
        ...
        if ( v20 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00F5DA0 )
          continue;
      }
      goto LABEL_19;
    }
