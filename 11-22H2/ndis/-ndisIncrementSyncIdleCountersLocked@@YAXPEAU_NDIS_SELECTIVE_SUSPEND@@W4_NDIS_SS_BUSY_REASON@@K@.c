/*
 * XREFs of ?ndisIncrementSyncIdleCountersLocked@@YAXPEAU_NDIS_SELECTIVE_SUSPEND@@W4_NDIS_SS_BUSY_REASON@@K@Z @ 0x1C003F042
 * Callers:
 ...
 * Callees:
 *     ?ndisSSInvalidateOidCache@@YAXPEAU_NDIS_SELECTIVE_SUSPEND@@@Z @ 0x1C003F4E8 (-ndisSSInvalidateOidCache@@YAXPEAU_NDIS_SELECTIVE_SUSPEND@@@Z.c)
 */
