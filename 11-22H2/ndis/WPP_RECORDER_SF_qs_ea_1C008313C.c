/*
 * XREFs of WPP_RECORDER_SF_qs @ 0x1C008313C
 * Callers:
        ...
        const char *a7)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x2000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
  {
    ...
    if ( !a7 )
      v13 = "NULL";
    ndisWppFastTraceMessage(&WPP_2cfafda6ad1d3851beeb62a61158407a_Traceguids, a4, &a6, 8LL, v13, v12, 0LL);
  }
  if ( v7 )
  {
    do
  ...
  LOWORD(v15) = a4;
  return WppAutoLogTrace(a1, 4LL, 14LL, &WPP_2cfafda6ad1d3851beeb62a61158407a_Traceguids, v15, &a6);
}
