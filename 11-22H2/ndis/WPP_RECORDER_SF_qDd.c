/*
 * XREFs of WPP_RECORDER_SF_qDd @ 0x1C000CFB0
 * Callers:
 ...
 *     ?ndisMFakeOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1C006B400 (-ndisMFakeOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 ...
 *     ?ndisMFakeDirectOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z @ 0x1C00B5780 (-ndisMFakeDirectOidRequest@@YAHPEAXPEAU_NDIS_OID_REQUEST@@@Z.c)
 * Callees:
