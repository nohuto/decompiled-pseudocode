/*
 * XREFs of ??$ndisIterativeDPAddNblsToTracker@$00@@YAXPEAU_NDIS_ITERATIVE_DATA_PATH_TRACKER_ENTRY@@PEAU_NET_BUFFER_LIST@@KKK@Z @ 0x1C0064898
 * Callers:
...
_QWORD *__fastcall ndisIterativeDPAddNblsToTracker<1>(_QWORD *a1, __int64 a2, int a3)
{
  _QWORD *result; // rax
  _QWORD *v4; // rcx
