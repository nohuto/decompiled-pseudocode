/*
 * XREFs of ??1MiniportFilterResourceRequirements@AzTelemetry@@UEAA@XZ @ 0x1C00D1564
 * Callers:
 *     ??_EMiniportFilterResourceRequirements@AzTelemetry@@UEAAPEAXI@Z @ 0x1C0069C30 (--_EMiniportFilterResourceRequirements@AzTelemetry@@UEAAPEAXI@Z.c)
