/*
 * XREFs of ?ndisReferenceFilterByHandle@@YAEPEAU_NDIS_FILTER_BLOCK@@W4_NDIS_LWF_REFTAG@@@Z @ 0x1C00154CC
 * Callers:
...
unsigned __int8 __fastcall ndisReferenceFilterByHandle(struct _NDIS_FILTER_BLOCK *a1, enum _NDIS_LWF_REFTAG a2)
{
  unsigned __int8 v3; // bl
  KIRQL v4; // si
  _NDIS_FILTER_BLOCK *i; // rax
