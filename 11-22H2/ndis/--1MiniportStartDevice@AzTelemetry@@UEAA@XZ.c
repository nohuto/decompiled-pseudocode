/*
 * XREFs of ??1MiniportStartDevice@AzTelemetry@@UEAA@XZ @ 0x1C00D16B4
 * Callers:
 ...
 *     ??_GMiniportStartDevice@AzTelemetry@@UEAAPEAXI@Z @ 0x1C0069CD0 (--_GMiniportStartDevice@AzTelemetry@@UEAAPEAXI@Z.c)
 * Callees:
