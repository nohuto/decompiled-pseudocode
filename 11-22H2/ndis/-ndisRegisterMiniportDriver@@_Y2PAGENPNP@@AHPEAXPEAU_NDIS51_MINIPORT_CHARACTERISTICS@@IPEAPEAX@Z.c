/*
 * XREFs of ?ndisRegisterMiniportDriver@@_Y2PAGENPNP@@AHPEAXPEAU_NDIS51_MINIPORT_CHARACTERISTICS@@IPEAPEAX@Z @ 0x1C0153954
 * Callers:
...
LABEL_16:
  ...
  else if ( IoAllocateDriverObjectExtension(*(PDRIVER_OBJECT *)a1, (PVOID)0x4E4D4944, 0x4A0u, &DriverObjectExtension) >= 0 )
  {
    ...
    *((_WORD *)DriverObjectExtension + 1) = 1184;
