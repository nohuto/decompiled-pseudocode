/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00C3D90
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00C40F0 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00C4110 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00C4130 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00C4170 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00C41A0 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00C41D0 (NdisImmediateWritePortUshort.c)
 * Callees:
 ...
 *     ndisStartMapping @ 0x1C00C4004 (ndisStartMapping.c)
 */
