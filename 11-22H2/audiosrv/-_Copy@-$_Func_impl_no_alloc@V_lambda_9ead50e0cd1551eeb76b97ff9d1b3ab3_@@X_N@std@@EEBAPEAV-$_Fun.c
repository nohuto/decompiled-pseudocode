/*
 * XREFs of ?_Copy@?$_Func_impl_no_alloc@V_lambda_9ead50e0cd1551eeb76b97ff9d1b3ab3_@@X_N@std@@EEBAPEAV?$_Func_base@X_N@2@PEAX@Z @ 0x1800F4220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc<_lambda_9ead50e0cd1551eeb76b97ff9d1b3ab3_,void,bool>::_Copy(
        __int64 a1,
        _QWORD *a2)
{
  __int64 v2; // r8
