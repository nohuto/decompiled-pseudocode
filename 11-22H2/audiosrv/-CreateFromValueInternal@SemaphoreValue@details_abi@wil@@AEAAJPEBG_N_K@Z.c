/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x18005FC50
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( (_DWORD)v18 )
    v8 = v18;
  v32 = (wil::details *)CreateSemaphoreExW(0LL, v18, v8, Name, 0, 0x1F0003u);
  if ( v32 )
  {
    _reset___unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__QEAAXPEAX_Z(
      this + 1,
