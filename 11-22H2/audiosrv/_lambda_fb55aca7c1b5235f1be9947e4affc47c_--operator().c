/*
 * XREFs of _lambda_fb55aca7c1b5235f1be9947e4affc47c_::operator() @ 0x18015664C
 * Callers:
 *     wil::details::lambda_call__lambda_fb55aca7c1b5235f1be9947e4affc47c___::_lambda_call__lambda_fb55aca7c1b5235f1be9947e4affc47c___ @ 0x1801563E8 (wil--details--lambda_call__lambda_fb55aca7c1b5235f1be9947e4affc47c___--_lambda_call__lambda_fb55.c)
...
char __fastcall lambda_fb55aca7c1b5235f1be9947e4affc47c_::operator()(signed int **a1)
{
  ...
  if ( *((_QWORD *)*a1 + 8) )
  {
    ...
    if ( *(_QWORD *)v1 )
    {
      v1 = (signed int *)(*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)v1 + 40LL))(*(_QWORD *)v1);
      v3 = v1;
    }
    v6 = (_DWORD *)*((_QWORD *)*a1 + 8);
    if ( *v6 > 4u )
    {
      LOBYTE(v1) = tlgKeywordOn(*((_QWORD *)*a1 + 8), 256LL);
      if ( (_BYTE)v1 )
      {
        v8 = *a1[4];
        v30 = (_WORD *)v3 + 9;
        ...
        v12 = a1[3];
        v33 = v8;
        v29 = ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[](v7 + 88, *v12);
        v28 = *a1[3];
