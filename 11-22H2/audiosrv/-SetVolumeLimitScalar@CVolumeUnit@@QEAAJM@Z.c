/*
 * XREFs of ?SetVolumeLimitScalar@CVolumeUnit@@QEAAJM@Z @ 0x1801298B8
 * Callers:
 ...
 *     ?ConvertScalarToDb@CVolumeUnit@@IEAANN@Z @ 0x1800EF970 (-ConvertScalarToDb@CVolumeUnit@@IEAANN@Z.c)
 */
