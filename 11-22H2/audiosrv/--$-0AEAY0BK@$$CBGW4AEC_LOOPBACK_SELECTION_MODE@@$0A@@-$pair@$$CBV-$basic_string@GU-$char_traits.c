/*
 * XREFs of ??$?0AEAY0BK@$$CBGW4AEC_LOOPBACK_SELECTION_MODE@@$0A@@?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@W4AEC_LOOPBACK_SELECTION_MODE@@@std@@QEAA@AEAY0BK@$$CBG$$QEAW4AEC_LOOPBACK_SELECTION_MODE@@@Z @ 0x1800559F0
 * Callers:
