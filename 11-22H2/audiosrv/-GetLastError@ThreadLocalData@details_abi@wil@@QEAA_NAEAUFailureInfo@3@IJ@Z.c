/*
 * XREFs of ?GetLastError@ThreadLocalData@details_abi@wil@@QEAA_NAEAUFailureInfo@3@IJ@Z @ 0x18011DEDC
 * Callers:
 ...
 * Callees:
 *     ?Get@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEAUFailureInfo@3@@Z @ 0x18011D1FC (-Get@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEAUFailureInfo@3@@Z.c)
 */
