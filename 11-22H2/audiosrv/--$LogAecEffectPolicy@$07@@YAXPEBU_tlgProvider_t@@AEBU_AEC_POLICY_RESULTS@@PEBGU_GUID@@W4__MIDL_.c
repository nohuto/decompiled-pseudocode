/*
 * XREFs of ??$LogAecEffectPolicy@$07@@YAXPEBU_tlgProvider_t@@AEBU_AEC_POLICY_RESULTS@@PEBGU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x180148F38
 * Callers:
...
void __fastcall LogAecEffectPolicy<8>(_DWORD *a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  const WCHAR *v25; // [rsp+F0h] [rbp-40h] BYREF
  __int64 v26; // [rsp+F8h] [rbp-38h] BYREF
  __int64 v27; // [rsp+100h] [rbp-30h] BYREF

  if ( *a1 > 4u )
  {
    if ( tlgKeywordOn((__int64)a1, 8LL) )
    {
      v10 = v8[16];
      v11 = v8[15];
      v24 = v8 + 11;
