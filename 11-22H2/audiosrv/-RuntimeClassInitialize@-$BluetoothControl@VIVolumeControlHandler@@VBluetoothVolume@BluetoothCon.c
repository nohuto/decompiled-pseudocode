/*
 * XREFs of ?RuntimeClassInitialize@?$BluetoothControl@VIVolumeControlHandler@@VBluetoothVolume@BluetoothControls@@@BluetoothControls@@QEAAJPEAUIMMDevice@@PEAUIControlChangeNotify@@@Z @ 0x1800F3608
 * Callers:
  ...
  try
  {
    ...
    *(_OWORD *)pvar = 0LL;
    ...
    if ( (int)BluetoothControls::TryGetResourceManager(&a1[6], &a1[17]) >= 0 )
    {
      ...
      v23[0] = &std::_Func_impl_no_alloc<_lambda_aaa43ca83dfd3d10ea8db9a45d6dafd8_,void,bool>::`vftable';
      v23[1] = a1;
      v23[2] = v18[0];
      v23[3] = v18[1];
      v23[7] = v23;
