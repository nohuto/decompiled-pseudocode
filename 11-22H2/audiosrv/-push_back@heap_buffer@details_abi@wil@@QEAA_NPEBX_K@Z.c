/*
 * XREFs of ?push_back@heap_buffer@details_abi@wil@@QEAA_NPEBX_K@Z @ 0x18005FAB4
 * Callers:
...
char __fastcall wil::details_abi::heap_buffer::push_back(wil::details_abi::heap_buffer *this, const void *Source)
{
  ...
  if ( *((_QWORD *)this + 1) - *(_QWORD *)this + 16LL >= v4 )
  {
    ...
    if ( 2 * v4 > 0x10 )
      v5 = 2 * v4;
    if ( !wil::details_abi::heap_buffer::reserve(this, v5) )
      return 0;
  }
  memcpy_s(
    *((void *const *)this + 1),
