/*
 * XREFs of ?Initialize@AudioDeviceMgr@@AEAAJPEAUIEndpointNotificationCallback@@@Z @ 0x18005AB54
 * Callers:
 ...
 *     ?CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ @ 0x18005B3F4 (-CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ.c)
