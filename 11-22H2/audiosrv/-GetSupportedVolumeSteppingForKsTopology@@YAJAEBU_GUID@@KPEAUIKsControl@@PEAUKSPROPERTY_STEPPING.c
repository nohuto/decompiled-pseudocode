/*
 * XREFs of ?GetSupportedVolumeSteppingForKsTopology@@YAJAEBU_GUID@@KPEAUIKsControl@@PEAUKSPROPERTY_STEPPING_LONG@@@Z @ 0x180166A9C
 * Callers:
 *     ?GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ @ 0x180166A54 (-GetSupportedVolumeStepping@TelephonyController@@AEAAJXZ.c)
 * Callees:
