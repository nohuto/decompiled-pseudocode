/*
 * XREFs of _std::vector_std::shared_ptr_CXvmPowerReferenceManager__std::allocator_std::shared_ptr_CXvmPowerReferenceManager_____::_Emplace_reallocate_std::shared_ptr_CXvmPowerReferenceManager__const_&__::_1_::catch$0 @ 0x18011951C
 * Callers:
 *     <none>
 * Callees:
