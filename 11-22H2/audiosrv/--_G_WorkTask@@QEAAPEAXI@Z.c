/*
 * XREFs of ??_G_WorkTask@@QEAAPEAXI@Z @ 0x1800DEFDC
 * Callers:
 ...
 *     ??1?$unique_ptr@U_WorkTask@@U?$default_delete@U_WorkTask@@@std@@@std@@QEAA@XZ @ 0x1800DEB4C (--1-$unique_ptr@U_WorkTask@@U-$default_delete@U_WorkTask@@@std@@@std@@QEAA@XZ.c)
 * Callees:
