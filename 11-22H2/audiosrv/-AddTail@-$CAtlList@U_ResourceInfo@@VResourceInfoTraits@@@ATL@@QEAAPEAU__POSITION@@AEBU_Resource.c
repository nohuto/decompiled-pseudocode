/*
 * XREFs of ?AddTail@?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@QEAAPEAU__POSITION@@AEBU_ResourceInfo@@@Z @ 0x18015F8B4
 * Callers:
 ...
 * Callees:
 *     ?NewNode@?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@AEAAPEAVCNode@12@AEBU_ResourceInfo@@PEAV312@1@Z @ 0x18016024C (-NewNode@-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@AEAAPEAVCNode@12@AEBU_ResourceInf.c)
 */
