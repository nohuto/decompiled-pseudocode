/*
 * XREFs of _EffectPack::CheckForPreferredStreamFormat_::_1_::dtor$1 @ 0x180079654
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall EffectPack::CheckForPreferredStreamFormat_::_1_::dtor_1(__int64 a1, __int64 a2)
{
