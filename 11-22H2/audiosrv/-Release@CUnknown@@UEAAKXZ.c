 ...
 *     ?Release@PhoneCallAudio@@UEAAKXZ @ 0x180065F70 (-Release@PhoneCallAudio@@UEAAKXZ.c)
 *     ?Release@AudioDeviceMgr@@UEAAKXZ @ 0x180065F90 (-Release@AudioDeviceMgr@@UEAAKXZ.c)
 * Callees:
