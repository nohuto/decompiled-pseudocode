/*
 * XREFs of ?OnExclusiveModeChange@CExclusiveModeListener@@AEAAXPEBUApplicationSpatialInformationWnf@@@Z @ 0x18013A544
 * Callers:
 *     ?SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x18013BA80 (-SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYP.c)
 * Callees:
  ...
  else
  {
    if ( (unsigned int)dword_1801CD178 > 4 )
    {
      ...
      tlgWriteTransfer_EventWriteTransfer(
        ...
        (unsigned __int8 *)dword_180194F84,
        0LL,
        0LL,
        3u,
        &v14);
