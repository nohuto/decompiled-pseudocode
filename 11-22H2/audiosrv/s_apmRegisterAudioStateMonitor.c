/*
 * XREFs of s_apmRegisterAudioStateMonitor @ 0x180111F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_apmRegisterAudioStateMonitor(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v7,
    (struct _TP_TIMER *)L"s_apmRegisterAudioStateMonitor",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64, __int64, __int64, __int64))(*(_QWORD *)g_PolicyManager + 288LL))(
                          g_PolicyManager,
                          a1,
                          a2,
                          a3,
