/*
 * XREFs of ?DisconnectHelper@CPolicyConfig@@SAXPEBG@Z @ 0x1800656FC
 * Callers:
 ...
 *     ?DisconnectSessions@CPolicyConfig@@UEAAJPEBG@Z @ 0x1800656E0 (-DisconnectSessions@CPolicyConfig@@UEAAJPEBG@Z.c)
