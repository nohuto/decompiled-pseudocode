/*
 * XREFs of ?ConfigureDolbyAtmosMATEncoder@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x18014591C
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  *(_DWORD *)((char *)this + 238) = 0;
  if ( IsGetDefaultSpatialRenderingModePresent() )
  {
    v15 = 0;
    v14 = 0;
    if ( (int)TryGetPlatformSpecificProcessingLimitsForSpatialFormat(&DOLBY_ATMOS_MAT_SPATIAL_ENCODER, &v15, &v14) >= 0 )
    {
      *((_DWORD *)this + 29) = v15;
      *((_WORD *)this + 62) = v14;
    }
