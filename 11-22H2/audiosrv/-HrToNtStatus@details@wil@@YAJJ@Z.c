/*
 * XREFs of ?HrToNtStatus@details@wil@@YAJJ@Z @ 0x1800406D0
 * Callers:
 ...
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x1800CD2E1 (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
