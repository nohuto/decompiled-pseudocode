/*
 * XREFs of ??1?$ThreadLocalStorage@UThreadLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x1800CC588
 * Callers:
 ...
 * Callees:
 *     ?Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ @ 0x1800CC7DC (-Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ.c)
 */
