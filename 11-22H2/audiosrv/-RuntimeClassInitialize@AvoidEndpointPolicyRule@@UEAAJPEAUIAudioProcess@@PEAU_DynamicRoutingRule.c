/*
 * XREFs of ?RuntimeClassInitialize@AvoidEndpointPolicyRule@@UEAAJPEAUIAudioProcess@@PEAU_DynamicRoutingRule@@@Z @ 0x180141DD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DynamicRoutingRule *a3)
{
  ...
  HRESULT v10; // eax
  LPVOID v11; // rbx
  __int64 (__fastcall *v12)(LPVOID, char *, __int64 *); // r12
  __int64 v13; // rcx
  __int64 v14; // r8
  _OWORD *v15; // rcx
