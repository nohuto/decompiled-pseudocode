/*
 * XREFs of ?GetOffloadStreamGroups@CDeviceGraphObjectsStore@@UEAAJAEAV?$vector@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@@std@@@std@@@Z @ 0x18010C3C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphObjectsStore::GetOffloadStreamGroups(__int64 a1, __int64 *a2)
{
  ...
  while ( v5 != *(__int64 **)(a1 + 72) )
  {
    try
    {
      ...
      v12 = 0LL;
      if ( (int)Microsoft::WRL::WeakRef::As<IInspectable>(&v13, &v12) >= 0 && v12 )
      {
        v11 = 0LL;
        if ( (int)Microsoft::WRL::ComPtr<IInspectable>::As<IStreamGroupProxy>(&v12, &v11) >= 0
          && (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v11 + 272LL))(v11) )
        {
          v8 = (__int64 *)a2[1];
          if ( v8 == (__int64 *)a2[2] )
          {
