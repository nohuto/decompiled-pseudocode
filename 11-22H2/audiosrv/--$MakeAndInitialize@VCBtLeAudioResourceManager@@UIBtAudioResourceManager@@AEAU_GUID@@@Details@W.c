/*
 * XREFs of ??$MakeAndInitialize@VCBtLeAudioResourceManager@@UIBtAudioResourceManager@@AEAU_GUID@@@Details@WRL@Microsoft@@YAJPEAPEAUIBtAudioResourceManager@@AEAU_GUID@@@Z @ 0x1800F4A18
 * Callers:
 ...
 *     ?RuntimeClassInitialize@CBtLeAudioResourceManager@@QEAAJU_GUID@@@Z @ 0x1800FD040 (-RuntimeClassInitialize@CBtLeAudioResourceManager@@QEAAJU_GUID@@@Z.c)
 */
