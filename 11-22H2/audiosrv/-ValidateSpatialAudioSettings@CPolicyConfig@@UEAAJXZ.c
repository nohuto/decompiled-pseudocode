/*
 * XREFs of ?ValidateSpatialAudioSettings@CPolicyConfig@@UEAAJXZ @ 0x180117410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPolicyConfig::ValidateSpatialAudioSettings(CPolicyConfig *this)
{
  ...
  v1 = (*(__int64 (__fastcall **)(struct IAudioService *))(*(_QWORD *)g_AudioService + 136LL))(g_AudioService);
  *(_QWORD *)v5 = &off_18017CA58;
  v6 = v5;
