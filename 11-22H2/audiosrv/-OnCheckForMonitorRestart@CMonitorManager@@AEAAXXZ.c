/*
 * XREFs of ?OnCheckForMonitorRestart@CMonitorManager@@AEAAXXZ @ 0x18012E0B8
 * Callers:
 *     ?OnCheckForMonitorRestartWorker@CMonitorManager@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x18012E1E0 (-OnCheckForMonitorRestartWorker@CMonitorManager@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER.c)
 * Callees:
...
void __fastcall CMonitorManager::OnCheckForMonitorRestart(CMonitorManager *this)
{
  ...
  CMonitorManager::CaptureMonitor *v8; // [rsp+40h] [rbp+8h] BYREF
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x35u, (__int64)&WPP_b5388cf61bd131ee0088e27738ffac5a_Traceguids);
  }
  if ( *((_QWORD *)this + 16) )
  {
