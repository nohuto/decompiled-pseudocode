/*
 * XREFs of ?ReleasePowerReference@CXvmPowerReferenceManager@@QEAAXXZ @ 0x18011A664
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCXvmPowerReference@@@std@@EEAAXXZ @ 0x18011A8A0 (-_Destroy@-$_Ref_count_obj2@VCXvmPowerReference@@@std@@EEAAXXZ.c)
 * Callees:
 *     <none>
 */
