 ...
 *     ?GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ @ 0x18015BBDC (-GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ.c)
 ...
 *     ?SetExpiryTimer@AtmosCheck@@AEAAX_K@Z @ 0x18015D80C (-SetExpiryTimer@AtmosCheck@@AEAAX_K@Z.c)
 */
