/*
 * XREFs of ??1?$com_ptr_t@UICrossProcessMemory@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x180015DEC
 * Callers:
 ...
 *     _InitializeStreamAndModeDescriptors_::_1_::dtor$4 @ 0x1800703F1 (_InitializeStreamAndModeDescriptors_--_1_--dtor$4.c)
 *     _InitializeStreamAndModeDescriptors_::_1_::dtor$7 @ 0x180070415 (_InitializeStreamAndModeDescriptors_--_1_--dtor$7.c)
 *     _InitializeStreamAndModeDescriptors_::_1_::dtor$9 @ 0x18007042D (_InitializeStreamAndModeDescriptors_--_1_--dtor$9.c)
 *     _CSharedStreamGroupProxy::RefreshAposEffectStates_::_1_::dtor$1 @ 0x180078B00 (_CSharedStreamGroupProxy--RefreshAposEffectStates_--_1_--dtor$1.c)
 *     _EffectPack::CanProcessingModeBeParameterized_::_1_::dtor$0 @ 0x180078B75 (_EffectPack--CanProcessingModeBeParameterized_--_1_--dtor$0.c)
 *     _IsFixedFormatApo_::_1_::dtor$1 @ 0x180079395 (_IsFixedFormatApo_--_1_--dtor$1.c)
 *     _CreateSaDevice_::_1_::dtor$0 @ 0x18007956F (_CreateSaDevice_--_1_--dtor$0.c)
 *     _CreateSaDevice_::_1_::dtor$1 @ 0x180079581 (_CreateSaDevice_--_1_--dtor$1.c)
 *     _CreateSaDevice_::_1_::dtor$9 @ 0x180079602 (_CreateSaDevice_--_1_--dtor$9.c)
 *     _CAudioStream::InitializeAPOs_::_1_::dtor$8 @ 0x18007AB58 (_CAudioStream--InitializeAPOs_--_1_--dtor$8.c)
 *     _BuildDeviceGraphForStream_::_1_::dtor$5 @ 0x18007C380 (_BuildDeviceGraphForStream_--_1_--dtor$5.c)
 *     _CBaseStreamGroupProxy::InitializeAPOs_::_1_::dtor$0 @ 0x18007C56C (_CBaseStreamGroupProxy--InitializeAPOs_--_1_--dtor$0.c)
 ...
 *     ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800D13D8 (--1-$_List_node_emplace_op2@V-$allocator@U-$_List_node@V-$com_ptr_t@UIProcessSubmixProxy@@Uerr_r.c)
 ...
 *     _CProcessSubmixManager::EnsureProcessSubmixInSubmixContext_::_1_::dtor$0 @ 0x1800D19B5 (_CProcessSubmixManager--EnsureProcessSubmixInSubmixContext_--_1_--dtor$0.c)
 ...
 *     asm_GetApplicationSubmixFromId$dtor$1 @ 0x1800D41B0 (asm_GetApplicationSubmixFromId$dtor$1.c)
 ...
 *     __lambda_b2b2edcacba8310f83e1be2040a50861_::operator()_::_1_::dtor$3 @ 0x18010B70E (__lambda_b2b2edcacba8310f83e1be2040a50861_--operator()_--_1_--dtor$3.c)
 * Callees:
 *     _guard_xfg_dispatch_icall_nop @ 0x180075A20 (_guard_xfg_dispatch_icall_nop.c)
 */

__int64 __fastcall wil::com_ptr_t<ICrossProcessMemory,wil::err_returncode_policy>::~com_ptr_t<ICrossProcessMemory,wil::err_returncode_policy>(
        __int64 *a1)
{
  __int64 v1; // rcx
  __int64 result; // rax
