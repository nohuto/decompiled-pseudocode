/*
 * XREFs of ??$_Destroy_range@V?$allocator@V?$shared_ptr@$$CBUEffectPackConfiguration@@@std@@@std@@@std@@YAXPEAV?$shared_ptr@$$CBUEffectPackConfiguration@@@0@QEAV10@AEAV?$allocator@V?$shared_ptr@$$CBUEffectPackConfiguration@@@std@@@0@@Z @ 0x1800EEC00
 * Callers:
 *     _std::vector_std::shared_ptr_EffectPackConfiguration_const___std::allocator_std::shared_ptr_EffectPackConfiguration_const______::_Emplace_reallocate_std::shared_ptr_EffectPackConfiguration_const___&__::_1_::catch$0 @ 0x18010D83F (_std--vector_std--shared_ptr_EffectPackConfiguration_const___std--allocator_std--shared_ptr_Effe.c)
 ...
 *     _std::vector_std::shared_ptr_CXvmPowerReferenceManager__std::allocator_std::shared_ptr_CXvmPowerReferenceManager_____::_Emplace_reallocate_std::shared_ptr_CXvmPowerReferenceManager__const_&__::_1_::catch$0 @ 0x18011951C (_std--vector_std--shared_ptr_CXvmPowerReferenceManager__std--allocator_std--shared_ptr_CXvmPower.c)
