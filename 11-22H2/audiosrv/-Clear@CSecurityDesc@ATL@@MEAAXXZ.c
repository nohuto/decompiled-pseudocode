/*
 * XREFs of ?Clear@CSecurityDesc@ATL@@MEAAXXZ @ 0x18005F290
 * Callers:
 *     ?GetADGProcessSD@CAudioDGProcess@@CAJPEAPEAX@Z @ 0x18005E944 (-GetADGProcessSD@CAudioDGProcess@@CAJPEAPEAX@Z.c)
 *     sub_1800C8D12 @ 0x1800C8D12 (sub_1800C8D12.c)
 *     ??1CSecurityDesc@ATL@@UEAA@XZ @ 0x1800CE4F4 (--1CSecurityDesc@ATL@@UEAA@XZ.c)
 *     ??_GCSecurityDesc@ATL@@UEAAPEAXI@Z @ 0x1800CE720 (--_GCSecurityDesc@ATL@@UEAAPEAXI@Z.c)
 * Callees:
