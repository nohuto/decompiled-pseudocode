/*
 * XREFs of _EffectPack::EffectPack_::_1_::dtor$17 @ 0x18007A272
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall EffectPack::EffectPack_::_1_::dtor_17(__int64 a1, __int64 a2)
{
  `eh vector destructor iterator'(
    (char *)(*(_QWORD *)(a2 + 96) + 1328LL),
    16LL,
    4LL,
