/*
 * XREFs of _CProcessSubmixManager::GetAppSubmixClientContext_::_1_::catch$0 @ 0x1800D1A8B
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcessSubmixManager::GetAppSubmixClientContext_::_1_::catch_0(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
