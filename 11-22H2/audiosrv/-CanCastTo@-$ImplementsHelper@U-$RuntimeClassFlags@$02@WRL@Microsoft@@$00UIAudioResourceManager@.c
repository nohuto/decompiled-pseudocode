/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00UIAudioResourceManager@@UIWeakReferenceSource@@UIAudioResourceControl@@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x180057AD8
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  if ( InlineIsEqualGUID(a2, &GUID_cb15cc76_6b1a_4953_b7ac_bfe78d2379e3) )
  {
    *v3 = v4;
    return 0LL;
  }
