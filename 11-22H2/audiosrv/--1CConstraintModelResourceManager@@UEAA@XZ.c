/*
 * XREFs of ??1CConstraintModelResourceManager@@UEAA@XZ @ 0x1800FEA30
 * Callers:
 *     ??_GCConstraintModelResourceManager@@UEAAPEAXI@Z @ 0x1800FECA0 (--_GCConstraintModelResourceManager@@UEAAPEAXI@Z.c)
 * Callees:
