/*
 * XREFs of ??1CExclusiveStreamGroupProxy@@MEAA@XZ @ 0x1801049C4
 * Callers:
 *     ??_ECExclusiveStreamGroupProxy@@MEAAPEAXI@Z @ 0x1801054EC (--_ECExclusiveStreamGroupProxy@@MEAAPEAXI@Z.c)
 * Callees:
