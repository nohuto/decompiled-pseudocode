/*
 * XREFs of s_setEmergencyCallbackMode @ 0x180113990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_setEmergencyCallbackMode(__int64 a1, unsigned int a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v4,
    (struct _TP_TIMER *)L"s_setEmergencyCallbackMode",
    pftDueTime);
  v6 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, _QWORD))(*(_QWORD *)g_PolicyManager + 264LL))(
         g_PolicyManager,
         a2);
  v7 = v6;
  if ( v6 >= 0 )
