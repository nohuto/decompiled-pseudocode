/*
 * XREFs of ??$_Emplace_reallocate@UAUDIO_EFFECT@@@?$vector@UAUDIO_EFFECT@@V?$allocator@UAUDIO_EFFECT@@@std@@@std@@QEAAPEAUAUDIO_EFFECT@@QEAU2@$$QEAU2@@Z @ 0x180103D18
 * Callers:
 ...
 *     ?_Change_array@?$vector@UAUDIO_EFFECT@@V?$allocator@UAUDIO_EFFECT@@@std@@@std@@AEAAXQEAUAUDIO_EFFECT@@_K1@Z @ 0x18010A96C (-_Change_array@-$vector@UAUDIO_EFFECT@@V-$allocator@UAUDIO_EFFECT@@@std@@@std@@AEAAXQEAUAUDIO_EF.c)
 */
