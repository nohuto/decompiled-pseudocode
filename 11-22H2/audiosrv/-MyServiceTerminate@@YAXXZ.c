/*
 * XREFs of ?MyServiceTerminate@@YAXXZ @ 0x180157F48
 * Callers:
 *     ?OnServiceShutdown@@YAXPEAXE@Z @ 0x180157CB0 (-OnServiceShutdown@@YAXPEAXE@Z.c)
 * Callees:
 *     _guard_xfg_dispatch_icall_nop @ 0x180075A20 (_guard_xfg_dispatch_icall_nop.c)
 *     ?Terminate@CAudioThreadPool@@QEAAJXZ @ 0x180132FD8 (-Terminate@CAudioThreadPool@@QEAAJXZ.c)
 *     McGenEventUnregister_EtwEventUnregister @ 0x1801581E4 (McGenEventUnregister_EtwEventUnregister.c)
 */
