/*
 * XREFs of ?SetRenderEndpoint@CBtAudioResourceManagerBase@@UEAAJPEAVCEndpointCharacteristics@@@Z @ 0x1800FAC40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBtAudioResourceManagerBase::SetRenderEndpoint(CBtAudioResourceManagerBase *this, LPCWCH *a2)
{
  void **v4; // rbx
  const WCHAR *v5; // rcx
  int v6; // ebx
...
LABEL_8:
  ...
  *((_QWORD *)this + 7) = 0LL;
  ...
  v6 = (*(__int64 (__fastcall **)(LPCWCH *, GUID *, __int64 *))v14)(
         ...
         &v17);
  if ( v6 >= 0 )
    v6 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v17 + 24LL))(v17, (char *)this + 56);
