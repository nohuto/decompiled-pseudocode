/*
 * XREFs of ?CreateBridgeSourceStreamForMicInjection@CBridgeStreamInstanceProxy@@UEAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIStreamInstanceProxy@@PEAUSystemAudioStream@@@Z @ 0x180073730
 * Callers:
 *     <none>
 * Callees:
