/*
 * XREFs of ?SetAudioEffect@CAudioStream@@QEAAJU_GUID@@H@Z @ 0x1800ED584
 * Callers:
 ...
 *     ??1?$vector@UAudioEffectInternal@@V?$allocator@UAudioEffectInternal@@@std@@@std@@QEAA@XZ @ 0x1800EB394 (--1-$vector@UAudioEffectInternal@@V-$allocator@UAudioEffectInternal@@@std@@@std@@QEAA@XZ.c)
