/*
 * XREFs of ??$AsWeak@UIAudioEffectsWatcher@@@WRL@Microsoft@@YAJPEAUIAudioEffectsWatcher@@PEAVWeakRef@01@@Z @ 0x1800D4F34
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AsWeak<IAudioEffectsWatcher>(
