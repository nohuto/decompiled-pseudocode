/*
 * XREFs of ??I?$com_ptr_t@UIStreamGroupProxy@@Uerr_returncode_policy@wil@@@wil@@QEAAPEAPEAUIStreamGroupProxy@@XZ @ 0x1800D1628
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<IStreamGroupProxy,wil::err_returncode_policy>::operator&(__int64 *a1)
{
  __int64 v2; // rcx
