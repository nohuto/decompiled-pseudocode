/*
 * XREFs of ?CacheDevicePipeFormat@CEndpointCharacteristics@@AEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEAUtWAVEFORMATEX@@@Z @ 0x1800651C0
 * Callers:
        ...
        struct tWAVEFORMATEX *a4)
{
  ...
  *(_OWORD *)v11 = 0LL;
  ...
  {
    ProcessingModeSpecificDevicePipeFormatKey = (*(__int64 (__fastcall **)(_QWORD, struct _tagpropertykey *, int *))(**((_QWORD **)this + 9) + 48LL))(
                                                  *((_QWORD *)this + 9),
                                                  &v14,
                                                  v11);
    if ( ProcessingModeSpecificDevicePipeFormatKey >= 0 )
