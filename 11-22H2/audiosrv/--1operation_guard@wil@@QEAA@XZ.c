/*
 * XREFs of ??1operation_guard@wil@@QEAA@XZ @ 0x1800F1DF4
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@Voperation_guard@wil@@@std@@EEAAXXZ @ 0x1800F4370 (-_Destroy@-$_Ref_count_obj2@Voperation_guard@wil@@@std@@EEAAXXZ.c)
 * Callees:
 ...
 *     ?close_reset@?$close_invoke_helper@$00P6AXPEAVoperation_guard@wil@@@_E$1?release_operation_guard_reference@details@2@YAX0@ZPEAV12@@details@wil@@SAXPEAVoperation_guard@3@@Z @ 0x1800F46F8 (-close_reset@-$close_invoke_helper@$00P6AXPEAVoperation_guard@wil@@@_E$1-release_operation_guard.c)
