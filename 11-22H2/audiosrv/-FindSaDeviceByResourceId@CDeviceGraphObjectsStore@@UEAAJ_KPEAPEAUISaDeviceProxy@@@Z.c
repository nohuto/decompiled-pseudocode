/*
 * XREFs of ?FindSaDeviceByResourceId@CDeviceGraphObjectsStore@@UEAAJ_KPEAPEAUISaDeviceProxy@@@Z @ 0x18010BBE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISaDeviceProxy **a3)
{
  ...
  v4[1] = a2;
  v4[0] = (__int64)off_18017C700;
  v4[7] = (__int64)v4;
  return CDeviceGraphObjectsStore::FindFirstMatchingSaDevice((__int64)this, v4, a3);
}
