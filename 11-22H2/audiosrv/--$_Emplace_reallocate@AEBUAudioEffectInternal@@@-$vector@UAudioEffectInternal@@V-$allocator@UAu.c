/*
 * XREFs of ??$_Emplace_reallocate@AEBUAudioEffectInternal@@@?$vector@UAudioEffectInternal@@V?$allocator@UAudioEffectInternal@@@std@@@std@@QEAAPEAUAudioEffectInternal@@QEAU2@AEBU2@@Z @ 0x1800EA770
 * Callers:
        ...
        __int64 a3)
{
  ...
  try
  {
    ...
    *((_QWORD *)v13 + 2) = *(_QWORD *)(a3 + 16);
    ...
    std::vector<AudioEffectInternal>::_Change_array(a1, v12, v8, v9);
    result = v13;
  }
  catch ( ... )
  {
