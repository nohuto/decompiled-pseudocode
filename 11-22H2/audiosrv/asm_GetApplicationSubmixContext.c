/*
 * XREFs of asm_GetApplicationSubmixContext @ 0x1800D3B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall asm_GetApplicationSubmixContext(__int64 a1, __int64 a2, _QWORD *a3, _QWORD *a4)
{
  ...
  {
    v17 = 0LL;
    v11 = (*(__int64 (__fastcall **)(struct IProcessSubmixManager *, __int64, __int64, __int64 *))(*(_QWORD *)g_ProcessSubmixManager
                                                                                                 + 32LL))(
