 ...
 * Callers:
 *     ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x1800CEF54 (-ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const CHAR **a22)
{
  ...
  const WCHAR *v66; // [rsp+B0h] [rbp-50h]
  ...
  const WCHAR *v79; // [rsp+100h] [rbp+0h]
