/*
 * XREFs of CreateAudioMediaTypeFromUncompressedAudioFormat @ 0x180069890
 * Callers:
        ...
        IAudioMediaType **ppIAudioMediaType)
{
  ...
  __int16 dwValidBitsPerSample; // [rsp+42h] [rbp-1Eh]
  DWORD dwChannelMask; // [rsp+44h] [rbp-1Ch]
  GUID v15; // [rsp+48h] [rbp-18h]
  ...
  else
  {
    ...
    v12.wFormatTag = -2;
    v12.cbSize = 22;
    dwValidBitsPerSample = pUncompressedAudioFormat->dwValidBitsPerSample;
    dwChannelMask = pUncompressedAudioFormat->dwChannelMask;
    v15 = guidFormatType;
  }
