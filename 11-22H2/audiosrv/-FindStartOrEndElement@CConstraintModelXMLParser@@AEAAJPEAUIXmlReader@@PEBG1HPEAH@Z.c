/*
 * XREFs of ?FindStartOrEndElement@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEBG1HPEAH@Z @ 0x180160F64
 * Callers:
...
LABEL_10:
    ...
    if ( !a5 )
      LogError(L"Was expecting start element %s or end element for %s - not found", a3, a4);
  }
LABEL_13:
