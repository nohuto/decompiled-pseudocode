/*
 * XREFs of _std::vector_AudioEffectInternal_std::allocator_AudioEffectInternal___::_Emplace_reallocate_AudioEffectInternal_const_&__::_1_::catch$19 @ 0x1800EA88C
 * Callers:
 *     <none>
 * Callees:
