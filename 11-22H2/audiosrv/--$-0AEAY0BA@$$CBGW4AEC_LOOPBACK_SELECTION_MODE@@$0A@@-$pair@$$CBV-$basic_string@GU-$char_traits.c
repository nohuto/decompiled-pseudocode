/*
 * XREFs of ??$?0AEAY0BA@$$CBGW4AEC_LOOPBACK_SELECTION_MODE@@$0A@@?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@W4AEC_LOOPBACK_SELECTION_MODE@@@std@@QEAA@AEAY0BA@$$CBG$$QEAW4AEC_LOOPBACK_SELECTION_MODE@@@Z @ 0x180055A60
 * Callers:
