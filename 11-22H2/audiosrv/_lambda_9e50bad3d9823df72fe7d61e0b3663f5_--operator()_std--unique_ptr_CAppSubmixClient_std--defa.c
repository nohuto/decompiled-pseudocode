/*
 * XREFs of _lambda_9e50bad3d9823df72fe7d61e0b3663f5_::operator()_std::unique_ptr_CAppSubmixClient_std::default_delete_CAppSubmixClient____const__ @ 0x1800CFE1C
 * Callers:
...
char __fastcall lambda_9e50bad3d9823df72fe7d61e0b3663f5_::operator()_std::unique_ptr_CAppSubmixClient_std::default_delete_CAppSubmixClient____const__(
        _QWORD **a1,
        _QWORD **a2)
{
  __int64 v3; // rbx
  ...
  CAppSubmixClient::NotifySubmixClient(v3, 1LL, v5);
