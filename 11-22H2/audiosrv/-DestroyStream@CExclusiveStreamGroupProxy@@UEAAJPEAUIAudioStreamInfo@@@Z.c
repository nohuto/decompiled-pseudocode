/*
 * XREFs of ?DestroyStream@CExclusiveStreamGroupProxy@@UEAAJPEAUIAudioStreamInfo@@@Z @ 0x180106B20
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioStreamInfo *a2)
{
  ...
  CBaseStreamGroupProxy::RemoveStreamAndResetAudioHandle(this, a2);
  return 0LL;
}
