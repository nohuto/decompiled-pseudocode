/*
 * XREFs of ??1?$RuntimeClass@U?$RuntimeClassFlags@$02@WRL@Microsoft@@UIMMNotificationClient@@@WRL@Microsoft@@UEAA@XZ @ 0x1800D572C
 * Callers:
 *     _AtmosCheck::AtmosCheck_::_1_::dtor$0 @ 0x18007D4B0 (_AtmosCheck--AtmosCheck_--_1_--dtor$0.c)
 *     _AudioEffectsWatcher::AudioEffectsWatcher_::_1_::dtor$0 @ 0x1800D5629 (_AudioEffectsWatcher--AudioEffectsWatcher_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
