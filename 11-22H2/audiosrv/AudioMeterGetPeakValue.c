/*
 * XREFs of AudioMeterGetPeakValue @ 0x180084230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioMeterGetPeakValue(_QWORD *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v4,
    (struct _TP_TIMER *)L"AudioMeterGetPeakValue",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a1 + 160LL))(*a1, a2);
