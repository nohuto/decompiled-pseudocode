/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1?RegCloseKey@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x1800D86C0
 * Callers:
 ...
 *     _GetContainerProperty_::_1_::dtor$1 @ 0x1800DB490 (_GetContainerProperty_--_1_--dtor$1.c)
 ...
 *     _CEndpointCharacteristics::CreateEffectPackContexts_::_1_::dtor$0 @ 0x18014BA73 (_CEndpointCharacteristics--CreateEffectPackContexts_--_1_--dtor$0.c)
 *     _EffectPackConfiguration::CreateGlobalEffectPackConfiguration_::_1_::dtor$1 @ 0x180154DB6 (_EffectPackConfiguration--CreateGlobalEffectPackConfiguration_--_1_--dtor$1.c)
