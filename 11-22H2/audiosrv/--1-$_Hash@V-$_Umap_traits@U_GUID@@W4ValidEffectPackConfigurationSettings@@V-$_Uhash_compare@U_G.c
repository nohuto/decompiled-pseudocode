/*
 * XREFs of ??1?$_Hash@V?$_Umap_traits@U_GUID@@W4ValidEffectPackConfigurationSettings@@V?$_Uhash_compare@U_GUID@@U?$hash@U_GUID@@@std@@U?$equal_to@U_GUID@@@3@@std@@V?$allocator@U?$pair@$$CBU_GUID@@W4ValidEffectPackConfigurationSettings@@@std@@@4@$0A@@std@@@std@@QEAA@XZ @ 0x180066188
 * Callers:
 *     _std::unordered_map__GUID_enum_ValidEffectPackConfigurationSettings_std::hash__GUID__std::equal_to__GUID__std::allocator_std::pair__GUID_const__enum_ValidEffectPackConfigurationSettings_____::unordered_map__GUID_enum_ValidEffectPackConfigurationSettings_std::hash__GUID__std::equal_to__GUID__std::allocator_std::pair__GUID_const__enum_ValidEffectPackConfigurationSettings______::_1_::dtor$0 @ 0x18007CC1A (_std--unordered_map__GUID_enum_ValidEffectPackConfigurationSettings_std--hash__GUID__std--equal_.c)
 *     _dynamic_atexit_destructor_for__s_validSettingsForSchema__ @ 0x18007E370 (_dynamic_atexit_destructor_for__s_validSettingsForSchema__.c)
 * Callees:
