/*
 * XREFs of ??1CSebNotifier@@QEAA@XZ @ 0x180119B54
 * Callers:
 *     _CPowerReferenceManager::CPowerReferenceManager_::_1_::dtor$1 @ 0x18007CDEE (_CPowerReferenceManager--CPowerReferenceManager_--_1_--dtor$1.c)
