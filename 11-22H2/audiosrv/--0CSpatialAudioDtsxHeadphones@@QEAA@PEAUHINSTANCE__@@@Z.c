/*
 * XREFs of ??0CSpatialAudioDtsxHeadphones@@QEAA@PEAUHINSTANCE__@@@Z @ 0x18005CE1C
 * Callers:
  ...
  *((_OWORD *)this + 1) = DTSX_HEADPHONES_SPATIAL_ENCODER;
  ...
  if ( LoadStringW(a2, 0x1B3u, (LPWSTR)this + 144, 256) <= 0 )
  {
    ...
    do
    {
      if ( v10 == -2147483390 )
        break;
      v12 = *(_WORD *)((char *)v11 + (char *)L"ms-windows-store://pdp/?productid=9PJ0NKL8MCSJ" - ((char *)this + 288));
      if ( !v12 )
        break;
      *v11++ = v12;
      --v10;
