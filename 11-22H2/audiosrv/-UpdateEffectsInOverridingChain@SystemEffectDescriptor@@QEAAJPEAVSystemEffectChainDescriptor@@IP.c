/*
 * XREFs of ?UpdateEffectsInOverridingChain@SystemEffectDescriptor@@QEAAJPEAVSystemEffectChainDescriptor@@IPEBU_GUID@@W4SED_APOPLACEMENT@@W4ConnectorSupportsMode@@@Z @ 0x18002CDB8
 * Callers:
        ...
        int a6)
{
  ...
  *(_QWORD *)v19 = 0LL;
  ...
  if ( (int)v23 > 0 )
  {
    if ( a6 == 1 && (v15 = *((_QWORD *)a1 + 2)) != 0 )
    {
      v13 = *(const struct _GUID **)(v15 + 56);
      v14 = *(_DWORD *)(v15 + 64);
    }
    else
    {
    ...
    v10 = SystemEffectChainDescriptor::ReplaceEffectChain(a2, v21[0], v20, v14, v13);
    v11 = v10;
    if ( v10 < 0 )
    {
      v16 = 398LL;
