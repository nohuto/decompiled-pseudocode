/*
 * XREFs of AudioMeterGetMeteringChannelCount @ 0x180084190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioMeterGetMeteringChannelCount(_QWORD *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v4,
    (struct _TP_TIMER *)L"AudioMeterGetMeteringChannelCount",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a1 + 168LL))(*a1, a2);
