/*
 * XREFs of ??1?$CAutoPtrList@VPhoneTopologyWorkItem@@@ATL@@QEAA@XZ @ 0x180163D0C
 * Callers:
 *     _PhoneTopology::PhoneTopology_::_1_::dtor$3 @ 0x18007A601 (_PhoneTopology--PhoneTopology_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
