/*
 * XREFs of ?IssueGrantToASAR@CStreamResource@Sarm@@AEAAJI_J@Z @ 0x180139254
 * Callers:
...
__int64 __fastcall Sarm::CStreamResource::IssueGrantToASAR(Sarm::CStreamResource *this, unsigned int a2, __int64 a3)
{
  ...
  if ( !*(_QWORD *)this )
    wil::details::in1diag3::_FailFast_Hr(
      ...
      v16);
  v17 = 0LL;
  v7 = *(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 120LL);
  wil::com_ptr_t<ISubmixProxy,wil::err_returncode_policy>::reset(&v17);
  v8 = v7(v6, &v17);
  v11 = v8;
  if ( v8 < 0 )
  {
...
LABEL_11:
  ...
  {
    v8 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v17 + 64LL))(
           v17,
           *(_QWORD *)this,
           a2,
           a3);
