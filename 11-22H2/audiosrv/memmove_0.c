/*
 * XREFs of memmove_0 @ 0x1800759E8
 * Callers:
 ...
 *     ?RemoveAt@?$CAtlArray@V?$CAutoPtr@VCAccessAce@CDacl@ATL@@@ATL@@V?$CAutoPtrElementTraits@VCAccessAce@CDacl@ATL@@@2@@ATL@@QEAAX_K0@Z @ 0x1800CEEA4 (-RemoveAt@-$CAtlArray@V-$CAutoPtr@VCAccessAce@CDacl@ATL@@@ATL@@V-$CAutoPtrElementTraits@VCAccess.c)
 ...
 *     _std::vector_AudioEffectInternal_std::allocator_AudioEffectInternal___::_Insert_range_AudioEffectInternal____::_1_::catch$68 @ 0x1800EADC6 (_std--vector_AudioEffectInternal_std--allocator_AudioEffectInternal___--_Insert_ran_ea_1800EADC6.c)
 *     _std::vector_AudioEffectInternal_std::allocator_AudioEffectInternal___::_Insert_range_AudioEffectInternal____::_1_::catch$70 @ 0x1800EAE5E (_std--vector_AudioEffectInternal_std--allocator_AudioEffectInternal___--_Insert_ran_ea_1800EAE5E.c)
 *     ?UpdatePMPEffectToggle@CAudioStream@@AEAAXU_GUID@@H@Z @ 0x1800EE410 (-UpdatePMPEffectToggle@CAudioStream@@AEAAXU_GUID@@H@Z.c)
 *     ??$_Emplace_reallocate@UAUDIO_EFFECT@@@?$vector@UAUDIO_EFFECT@@V?$allocator@UAUDIO_EFFECT@@@std@@@std@@QEAAPEAUAUDIO_EFFECT@@QEAU2@$$QEAU2@@Z @ 0x180103D18 (--$_Emplace_reallocate@UAUDIO_EFFECT@@@-$vector@UAUDIO_EFFECT@@V-$allocator@UAUDIO_EFFECT@@@std@.c)
