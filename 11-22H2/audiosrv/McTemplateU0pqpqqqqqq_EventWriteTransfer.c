/*
 * XREFs of McTemplateU0pqpqqqqqq_EventWriteTransfer @ 0x180169494
 * Callers:
 *     ?IncreaseProcessWorkingSet@@YAJ_K@Z @ 0x1801692C4 (-IncreaseProcessWorkingSet@@YAJ_K@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1800669A0 (__security_check_cookie.c)
 *     McGenEventWrite_EventWriteTransfer @ 0x18016942C (McGenEventWrite_EventWriteTransfer.c)
 */
