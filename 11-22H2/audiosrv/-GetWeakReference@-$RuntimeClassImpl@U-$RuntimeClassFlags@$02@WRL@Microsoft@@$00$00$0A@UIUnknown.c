/*
 * XREFs of ?GetWeakReference@?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIUnknown@@@Details@WRL@Microsoft@@UEAAJPEAPEAUIWeakReference@@@Z @ 0x180041CD0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v2 >= 0 )
  {
    ...
    *(_DWORD *)(WeakReference + 16) = v2;
    ...
    for ( i = v2 == v9; ; i = v9 == v2 )
    {
      ...
      v9 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 16), v7, v9);
    }
