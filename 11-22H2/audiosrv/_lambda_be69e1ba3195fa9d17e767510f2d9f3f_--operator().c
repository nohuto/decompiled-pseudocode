/*
 * XREFs of _lambda_be69e1ba3195fa9d17e767510f2d9f3f_::operator() @ 0x18010BA3C
 * Callers:
 *     ?GetStreamGroupsConnectedToSaDevice@CDeviceGraphObjectsStore@@UEAAJPEAUISaDeviceProxy@@PEAV?$vector@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@@std@@@std@@@Z @ 0x18010C670 (-GetStreamGroupsConnectedToSaDevice@CDeviceGraphObjectsStore@@UEAAJPEAUISaDeviceProxy@@PEAV-$vec.c)
 * Callees:
...
__int64 __fastcall lambda_be69e1ba3195fa9d17e767510f2d9f3f_::operator()(__int64 a1, _QWORD *a2)
{
  ...
  if ( (int)Microsoft::WRL::WeakRef::As<IInspectable>(a2, v9) >= 0 && v9[0] )
  {
    ...
    {
      v3 = v10;
      v4 = *(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v10 + 232LL);
  ...
  return Microsoft::WRL::ComPtr<IStreamGroupProxy>::InternalRelease((__int64 *)v9);
}
