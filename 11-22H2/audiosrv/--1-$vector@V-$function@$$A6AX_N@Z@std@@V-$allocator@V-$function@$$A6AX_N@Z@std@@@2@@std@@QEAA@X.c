/*
 * XREFs of ??1?$vector@V?$function@$$A6AX_N@Z@std@@V?$allocator@V?$function@$$A6AX_N@Z@std@@@2@@std@@QEAA@XZ @ 0x1800F54C8
 * Callers:
 *     _CBtAudioResourceManagerBase::NotifyStreamChange_::_1_::dtor$0 @ 0x1800F99BC (_CBtAudioResourceManagerBase--NotifyStreamChange_--_1_--dtor$0.c)
 * Callees:
