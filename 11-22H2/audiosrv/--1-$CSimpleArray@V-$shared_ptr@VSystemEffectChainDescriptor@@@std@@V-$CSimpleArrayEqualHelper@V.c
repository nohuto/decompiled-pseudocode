/*
 * XREFs of ??1?$CSimpleArray@V?$shared_ptr@VSystemEffectChainDescriptor@@@std@@V?$CSimpleArrayEqualHelper@V?$shared_ptr@VSystemEffectChainDescriptor@@@std@@@ATL@@@ATL@@QEAA@XZ @ 0x180154544
 * Callers:
 ...
 *     _SystemEffectDescriptor::ResolveAllOverridingChains_::_1_::dtor$1 @ 0x18007B000 (_SystemEffectDescriptor--ResolveAllOverridingChains_--_1_--dtor$1.c)
 * Callees:
