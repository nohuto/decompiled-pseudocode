/*
 * XREFs of ?QueryInterface@EndpointCollection@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18005AD10
 * Callers:
 *     ?QueryInterface@EndpointCollection@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180077EA0 (-QueryInterface@EndpointCollection@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
