/*
 * XREFs of ?LogExclusiveModeListenerUpdateSessionState@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@HH@Z @ 0x18013A228
 * Callers:
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_1801CD178 > 5 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_180195103,
      0LL,
      0LL,
      5u,
      &v6);
