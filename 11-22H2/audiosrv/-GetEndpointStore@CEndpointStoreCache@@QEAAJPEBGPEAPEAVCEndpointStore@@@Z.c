 ...
 *     ??$copy_to@VCEndpointStore@@@?$com_ptr_t@VCEndpointStore@@Uerr_returncode_policy@wil@@@wil@@QEBAJPEAPEAVCEndpointStore@@@Z @ 0x18010EEBC (--$copy_to@VCEndpointStore@@@-$com_ptr_t@VCEndpointStore@@Uerr_returncode_policy@wil@@@wil@@QEBA.c)
 */
