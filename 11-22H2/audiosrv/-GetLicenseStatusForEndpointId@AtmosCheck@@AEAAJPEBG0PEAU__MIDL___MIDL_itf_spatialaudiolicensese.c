/*
 * XREFs of ?GetLicenseStatusForEndpointId@AtmosCheck@@AEAAJPEBG0PEAU__MIDL___MIDL_itf_spatialaudiolicenseserver_0000_0000_0001@@@Z @ 0x18015B7A0
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapSz@G@@U?$_tlgWrapperByVal@$03@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@G@@AEBU?$_tlgWrapperByVal@$03@@@Z @ 0x18015982C (--$Write@U-$_tlgWrapSz@G@@U-$_tlgWrapperByVal@$03@@@-$_tlgWriteTemplate@$$A6AJPEBU__ea_18015982C.c)
        ...
        struct __MIDL___MIDL_itf_spatialaudiolicenseserver_0000_0000_0001 *a4)
{
  ...
  __int64 v11; // r12
  __int64 v12; // r14
  int InterfaceIdFromMMDeviceId; // eax
  __int64 v14; // r8
  __int64 v15; // r9
  int v16; // eax
  ...
  __int64 v25; // r8
  __int64 v26; // r9
  unsigned __int64 v27; // [rsp+50h] [rbp-59h] BYREF
  const unsigned __int16 *v28; // [rsp+58h] [rbp-51h] BYREF
  struct ISpatialAudioLicenseServer *v29; // [rsp+60h] [rbp-49h] BYREF
  LPVOID pv; // [rsp+68h] [rbp-41h] BYREF
  const WCHAR *v31; // [rsp+70h] [rbp-39h] BYREF
  void *v32; // [rsp+78h] [rbp-31h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v33; // [rsp+80h] [rbp-29h] BYREF
  unsigned __int64 v34; // [rsp+98h] [rbp-11h]
  unsigned __int64 *v35; // [rsp+A0h] [rbp-9h]
  ...
  if ( !*((_BYTE *)this + 217) )
  {
    if ( (unsigned int)dword_1801CD2B8 > 5 )
      tlgWriteTransfer_EventWriteTransfer(
        ...
        (unsigned __int8 *)dword_180198FB3,
        0LL,
        0LL,
        2u,
        &v33);
  ...
  wil::details::unique_storage<wil::details::resource_policy<unsigned short *,void (*)(void *),&void CoTaskMemFree(void *),wistd::integral_constant<unsigned __int64,0>,unsigned short *,unsigned short *,0,std::nullptr_t>>::reset(
    &pv,
    0LL);
  InterfaceIdFromMMDeviceId = mmdDevGetInterfaceIdFromMMDeviceId(a3, &pv);
  if ( InterfaceIdFromMMDeviceId >= 0 )
  {
    v29 = 0LL;
    v16 = CreateSpatialAudioLicenseServer(&v29);
    v17 = v16;
    v18 = -2147467238;
    if ( v16 == -2147467238 )
      goto LABEL_15;
...
LABEL_15:
    ...
    v6 = v28;
    v19 = (*(__int64 (__fastcall **)(struct ISpatialAudioLicenseServer *, _QWORD, _QWORD, const unsigned __int16 *, LPVOID, struct __MIDL___MIDL_itf_spatialaudiolicenseserver_0000_0000_0001 *))(*(_QWORD *)v29 + 32LL))(
            v29,
            *((_QWORD *)this + v12 + 38),
            *((_QWORD *)this + v12 + 39),
            v28,
    ...
    if ( (unsigned int)dword_1801CD2B8 > 5 )
    {
      ...
      tlgWriteTransfer_EventWriteTransfer(
        (__int64)&dword_1801CD2B8,
        (unsigned __int8 *)dword_180198E18,
        0LL,
        0LL,
        3u,
        &v33);
    ...
    if ( v34 >= 8 )
    {
      ...
      if ( v27 >= 0x1000 )
      {
        std::_Adjust_manually_vector_aligned(&v32, &v27);
        Ptr = v32;
      }
      operator delete(Ptr);
    }
    if ( v31 == *((const WCHAR **)this + 77) )
    {
      *((_DWORD *)a4 + 1) = 1;
      if ( (unsigned int)dword_1801CD2B8 > 5 )
      {
        ...
        tlgWriteTransfer_EventWriteTransfer(
          (__int64)&dword_1801CD2B8,
          (unsigned __int8 *)dword_18019906D,
          0LL,
          0LL,
          3u,
          &v33);
    ...
    v21 = *((_QWORD *)v31 + 6);
    if ( *(_BYTE *)(v21 + 24 * v11 + 1) )
    {
      *((_DWORD *)a4 + 1) = *(_DWORD *)(v21 + 24 * v11 + 4) >= 0;
      if ( (unsigned int)dword_1801CD2B8 > 5 )
      {
        v22 = *(_DWORD *)(v21 + 24 * v11 + 4);
        v23 = (unsigned __int8 *)&dword_180198B80;
LABEL_27:
        LODWORD(v27) = v22;
        v35 = &v27;
        v36 = 4LL;
        tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1801CD2B8, v23, 0LL, 0LL, 3u, &v33);
      }
    }
    else
    {
      if ( !IsMultiUserSKU() || v8 != -2147023584 )
        goto LABEL_36;
      v22 = 1;
      *((_DWORD *)a4 + 1) = 1;
      if ( (unsigned int)dword_1801CD2B8 > 5 )
      {
        v23 = (unsigned __int8 *)&unk_180199352;
        goto LABEL_27;
      }
    }
    v8 = 0;
...
LABEL_37:
  ...
  *((_DWORD *)a4 + 1) = 1;
  *(_DWORD *)a4 = 1;
  *((_QWORD *)a4 + 1) = 0x24C85A5ED1C03FFFLL;
  if ( (unsigned int)dword_1801CD2B8 > 5 )
  {
    LODWORD(v27) = InterfaceIdFromMMDeviceId;
    v31 = a3;
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<unsigned short>,_tlgWrapperByVal<4>>(
      (unsigned int)InterfaceIdFromMMDeviceId,
      byte_180198C0B,
      v14,
      v15,
      &v31,
