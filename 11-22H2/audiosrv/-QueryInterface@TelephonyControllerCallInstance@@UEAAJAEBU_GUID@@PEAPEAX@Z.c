/*
 * XREFs of ?QueryInterface@TelephonyControllerCallInstance@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801684A0
 * Callers:
 *     ?QueryInterface@TelephonyControllerCallInstance@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180078020 (-QueryInterface@TelephonyControllerCallInstance@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
