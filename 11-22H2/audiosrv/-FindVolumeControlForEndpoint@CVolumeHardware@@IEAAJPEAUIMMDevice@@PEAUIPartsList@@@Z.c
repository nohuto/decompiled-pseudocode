/*
 * XREFs of ?FindVolumeControlForEndpoint@CVolumeHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18001DB20
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_ae14f8769cc9386b95eddb3bc7f1f163_Traceguids, this);
  }
  if ( !a2 )
  {
    v6 = -2147467261;
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control )
  {
    if ( (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x10000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_qS(
        *((_QWORD *)WPP_GLOBAL_Control + 2),
        34,
        (unsigned int)&WPP_ae14f8769cc9386b95eddb3bc7f1f163_Traceguids,
        (_DWORD)this,
        (__int64)pv);
      v7 = WPP_GLOBAL_Control;
    }
    if ( v7 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)v7 + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)v7 + 2), 35LL, &WPP_ae14f8769cc9386b95eddb3bc7f1f163_Traceguids, this);
      v7 = WPP_GLOBAL_Control;
    }
  }
  v8 = v14;
  ...
  if ( v16 )
  {
    ...
    if ( v6 < 0 )
      goto LABEL_39;
    v10 = (*(__int64 (__fastcall **)(__int64, int *, _QWORD, _QWORD))(*(_QWORD *)v15 + 104LL))(v15, &v17, 0LL, 0LL);
    v11 = v17;
    if ( v10 < 0 )
      v11 = 1;
    v17 = v11;
...
LABEL_19:
    if ( v7 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)v7 + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)v7 + 2), 36LL, &WPP_ae14f8769cc9386b95eddb3bc7f1f163_Traceguids, this);
    }
...
LABEL_39:
  AudSrvTraceLoggingErrorHelper("CVolumeHardware::FindVolumeControlForEndpoint", 0x580u, v6);
LABEL_22:
