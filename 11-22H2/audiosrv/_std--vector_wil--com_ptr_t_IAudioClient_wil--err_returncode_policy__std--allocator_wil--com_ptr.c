/*
 * XREFs of _std::vector_wil::com_ptr_t_IAudioClient_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_IAudioClient_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_IAudioClient_wil::err_returncode_policy__const_&__::_1_::catch$0 @ 0x1800739BE
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?deallocate@?$allocator@V?$com_ptr_t@UIAudioClient@@Uerr_returncode_policy@wil@@@wil@@@std@@QEAAXQEAV?$com_ptr_t@UIAudioClient@@Uerr_returncode_policy@wil@@@wil@@_K@Z @ 0x180073F90 (-deallocate@-$allocator@V-$com_ptr_t@UIAudioClient@@Uerr_returncode_policy@wil@@@wil@@@std@@QEAA.c)
