/*
 * XREFs of ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x1800CDB50
 * Callers:
 *     ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x1800CC3D4 (--0ResultException@wil@@QEAA@AEBV01@@Z.c)
