/*
 * XREFs of ?Reevaluate@CPowerReference@@QEAAXPEAVCVADServer@@@Z @ 0x18011A610
 * Callers:
 *     ?ReevaluateTimerActivationRequest@CVADServer@@QEAAXXZ @ 0x18011EDAC (-ReevaluateTimerActivationRequest@CVADServer@@QEAAXXZ.c)
 * Callees:
