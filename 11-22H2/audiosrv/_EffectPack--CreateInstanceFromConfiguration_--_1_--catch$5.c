/*
 * XREFs of _EffectPack::CreateInstanceFromConfiguration_::_1_::catch$5 @ 0x18007A3CD
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EffectPack::CreateInstanceFromConfiguration_::_1_::catch_5(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
