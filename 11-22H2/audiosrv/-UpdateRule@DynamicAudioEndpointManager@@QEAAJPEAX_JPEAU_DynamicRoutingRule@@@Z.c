/*
 * XREFs of ?UpdateRule@DynamicAudioEndpointManager@@QEAAJPEAX_JPEAU_DynamicRoutingRule@@@Z @ 0x18014095C
 * Callers:
 *     PolicyConfigUpdateDynamicRoutingRule @ 0x180118E30 (PolicyConfigUpdateDynamicRoutingRule.c)
 * Callees:
