/*
 * XREFs of ?QueryInterface@PhoneTopology@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180165510
 * Callers:
 *     ?QueryInterface@PhoneTopology@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180077FA0 (-QueryInterface@PhoneTopology@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
