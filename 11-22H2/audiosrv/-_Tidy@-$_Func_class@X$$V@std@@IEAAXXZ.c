/*
 * XREFs of ?_Tidy@?$_Func_class@X$$V@std@@IEAAXXZ @ 0x18003F560
 * Callers:
 ...
 *     ?_Destroy@?$_Ref_count_obj2@V?$function@$$A6AXXZ@std@@@std@@EEAAXXZ @ 0x180045BF0 (-_Destroy@-$_Ref_count_obj2@V-$function@$$A6AXXZ@std@@@std@@EEAAXXZ.c)
