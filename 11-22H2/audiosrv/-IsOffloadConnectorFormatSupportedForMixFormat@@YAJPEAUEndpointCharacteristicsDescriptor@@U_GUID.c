/*
 * XREFs of ?IsOffloadConnectorFormatSupportedForMixFormat@@YAJPEAUEndpointCharacteristicsDescriptor@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@3@Z @ 0x18011646C
 * Callers:
        ...
        const struct tWAVEFORMATEX *Src)
{
  ...
  struct IAudioProcessingObject *v21[2]; // [rsp+60h] [rbp-10h] BYREF
