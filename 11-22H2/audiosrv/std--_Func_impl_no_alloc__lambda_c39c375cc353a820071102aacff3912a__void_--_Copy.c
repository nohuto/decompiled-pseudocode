/*
 * XREFs of std::_Func_impl_no_alloc__lambda_c39c375cc353a820071102aacff3912a__void_::_Copy @ 0x18011A7F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Func_impl_no_alloc__lambda_c39c375cc353a820071102aacff3912a__void_::_Copy(
        __int64 a1,
        __int64 a2)
{
  __int64 v2; // r8
