/*
 * XREFs of ?IsOffloadDisabled@@YAHPEAUIMMDevice@@@Z @ 0x18011E5C0
 * Callers:
...
__int64 __fastcall IsOffloadDisabled(struct IUnknown *a1)
{
  unsigned int v1; // ebx
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_l(*((_QWORD *)WPP_GLOBAL_Control + 2), 29LL, &WPP_09ae8f41bb453bc35d3b802f4338d8f9_Traceguids, v1);
  }
  return v1;
}
