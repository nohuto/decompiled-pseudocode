/*
 * XREFs of ?_Change_array@?$vector@ULockedListEntry@?$CLockedList@VCAudioSessionNotificationProcess@@$00$0A@@@V?$allocator@ULockedListEntry@?$CLockedList@VCAudioSessionNotificationProcess@@$00$0A@@@@std@@@std@@AEAAXQEAULockedListEntry@?$CLockedList@VCAudioSessionNotificationProcess@@$00$0A@@@_K1@Z @ 0x180053F64
 * Callers:
