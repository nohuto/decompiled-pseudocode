/*
 * XREFs of ?Find@?$CAtlList@U_tagKSTOPOLOGY_ENDPOINTIDPAIR@@VRoutingPairsTraits@@@ATL@@QEBAPEAU__POSITION@@AEBU_tagKSTOPOLOGY_ENDPOINTIDPAIR@@PEAU3@@Z @ 0x180166520
 * Callers:
 ...
 * Callees:
 *     ?CompareElements@RoutingPairsTraits@@SA_NAEBU_tagKSTOPOLOGY_ENDPOINTIDPAIR@@0@Z @ 0x1801661C0 (-CompareElements@RoutingPairsTraits@@SA_NAEBU_tagKSTOPOLOGY_ENDPOINTIDPAIR@@0@Z.c)
 */
