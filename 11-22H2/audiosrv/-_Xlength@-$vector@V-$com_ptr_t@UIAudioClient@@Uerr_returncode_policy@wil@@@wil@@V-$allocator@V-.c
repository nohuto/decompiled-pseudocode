/*
 * XREFs of ?_Xlength@?$vector@V?$com_ptr_t@UIAudioClient@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIAudioClient@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@CAXXZ @ 0x180073F70
 * Callers:
...
void __noreturn std::vector<wil::com_ptr_t<IAudioClient,wil::err_returncode_policy>>::_Xlength()
{
