 ...
 *     ?IsSessionStarted@PhoneCallAudio@@UEAAJPEAH@Z @ 0x18013CD20 (-IsSessionStarted@PhoneCallAudio@@UEAAJPEAH@Z.c)
 ...
 *     ?IsTimerStarted@RoutingTimer@@UEAAHXZ @ 0x18013DBB0 (-IsTimerStarted@RoutingTimer@@UEAAHXZ.c)
 ...
 *     ?IsCellularEnabled@PhoneTopology@@UEAAHXZ @ 0x180165150 (-IsCellularEnabled@PhoneTopology@@UEAAHXZ.c)
 ...
 *     ?s_WorkerThreadProc@PhoneTopology@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x180165FD0 (-s_WorkerThreadProc@PhoneTopology@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z.c)
 * Callees:
 *     <none>
 */
