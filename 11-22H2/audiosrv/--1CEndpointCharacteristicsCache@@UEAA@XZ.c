/*
 * XREFs of ??1CEndpointCharacteristicsCache@@UEAA@XZ @ 0x18014A7E8
 * Callers:
 *     ??_GCEndpointCharacteristicsCache@@UEAAPEAXI@Z @ 0x18014AD40 (--_GCEndpointCharacteristicsCache@@UEAAPEAXI@Z.c)
 * Callees:
