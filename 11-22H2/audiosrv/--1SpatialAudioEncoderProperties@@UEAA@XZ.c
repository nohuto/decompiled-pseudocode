/*
 * XREFs of ??1SpatialAudioEncoderProperties@@UEAA@XZ @ 0x180084920
 * Callers:
 *     ??_GSpatialAudioEncoderProperties@@UEAAPEAXI@Z @ 0x1800849A0 (--_GSpatialAudioEncoderProperties@@UEAAPEAXI@Z.c)
 * Callees:
