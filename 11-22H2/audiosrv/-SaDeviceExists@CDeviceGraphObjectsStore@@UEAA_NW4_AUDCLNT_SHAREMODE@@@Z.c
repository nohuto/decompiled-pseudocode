/*
 * XREFs of ?SaDeviceExists@CDeviceGraphObjectsStore@@UEAA_NW4_AUDCLNT_SHAREMODE@@@Z @ 0x180043FD0
 * Callers:
...
bool __fastcall CDeviceGraphObjectsStore::SaDeviceExists(CDeviceGraphObjectsStore *this, enum _AUDCLNT_SHAREMODE a2)
{
  ...
  v5 = off_18017AE28;
  v7 = &v5;
  LOBYTE(a2) = (int)CDeviceGraphObjectsStore::FindFirstMatchingSaDevice(this, &v5, &v8) >= 0;
  Microsoft::WRL::ComPtr<IStreamGroupProxy>::InternalRelease(&v8);
  return a2;
}
