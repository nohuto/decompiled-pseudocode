/*
 * XREFs of AudioVolumeStepUp @ 0x18012B690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioVolumeStepUp(_QWORD *a1, __int128 *a2, __int64 a3, __int64 a4)
{
  ...
  __int128 v14; // [rsp+78h] [rbp-40h] BYREF
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v8,
    (struct _TP_TIMER *)L"AudioVolumeStepUp",
    pftDueTime);
  LODWORD(pftDueTime) = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(*(_QWORD *)*a1 + 128LL))(*a1, a3, a4);
