  ...
  try
  {
    ...
    *v14 = v15;
    ...
    std::_Uninitialized_move<std::unique_ptr<CAppSubmixClient> *,std::allocator<std::unique_ptr<CAppSubmixClient>>>(
      ...
      v16,
      v17);
    std::vector<std::unique_ptr<CAppSubmixClient>>::_Change_array(a1, v13, v8, v7, v20);
    result = v14;
  }
  catch ( ... )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<CAppSubmixClient>>>(v22, v14 + 1);
