/*
 * XREFs of dllmain_crt_process_attach @ 0x180066638
 * Callers:
 ...
 *     __scrt_dllmain_before_initialize_c @ 0x180066CBC (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_crt @ 0x180066DE8 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x180066ECC (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x180066F6C (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180067494 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x1800674BC (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800674E0 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x180067500 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x180067654 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800678C6 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800678D2 (_initterm_e_0.c)
