/*
 * XREFs of ??1?$CAutoPtr@UPropertyChangedContext@@@ATL@@QEAA@XZ @ 0x18012BAE0
 * Callers:
 *     _CMonitorManager::OnPropertyValueChanged_::_1_::dtor$1 @ 0x180079A80 (_CMonitorManager--OnPropertyValueChanged_--_1_--dtor$1.c)
 * Callees:
