/*
 * XREFs of ??Rcase_insensitive_hash@@QEBA_KAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@Z @ 0x18005DF24
 * Callers:
...
__int64 case_insensitive_hash::operator()()
{
  __int64 v0; // rcx
  ...
  void *v15; // [rsp+28h] [rbp-38h] BYREF
  unsigned __int8 *v16[2]; // [rsp+30h] [rbp-30h] BYREF
  ...
  v5 = v17;
  v6 = (unsigned __int8 **)((char *)v4 + 2 * v17);
  v7 = v16;
  if ( v18 >= 8 )
    v7 = (unsigned __int8 **)v16[0];
  if ( v7 != v6 )
  {
    v8 = (char *)v1 - (char *)v7;
    do
    {
      *(_WORD *)((char *)v7 + v8) = _o_towlower(*(unsigned __int16 *)v7);
      v7 = (unsigned __int8 **)((char *)v7 + 2);
    }
    while ( v7 != v6 );
    v3 = v18;
    v5 = v17;
  ...
  appended = std::_Fnv1a_append_bytes(v0, (const unsigned __int8 *const)v9, 2 * v5);
  if ( v3 >= 8 )
  {
    v12 = 2 * v3 + 2;
    v14 = v12;
