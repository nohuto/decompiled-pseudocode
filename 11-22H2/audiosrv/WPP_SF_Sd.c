/*
 * XREFs of WPP_SF_Sd @ 0x1800E3B38
 * Callers:
 ...
 *     ?GetChannelCount@CAudioSession@@UEAAJPEAI@Z @ 0x1800DFB10 (-GetChannelCount@CAudioSession@@UEAAJPEAI@Z.c)
 *     ?GetMute@CAudioSession@@UEAAJPEAH@Z @ 0x1800E03E0 (-GetMute@CAudioSession@@UEAAJPEAH@Z.c)
