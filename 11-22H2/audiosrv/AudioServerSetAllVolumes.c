/*
 * XREFs of AudioServerSetAllVolumes @ 0x180050AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerSetAllVolumes(char *a1, unsigned int a2, const float *a3, int *a4)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    pftDueTime);
  v12 = CVADServer::SetAllVolumes((CVADServer *)a1, a2, a3, a4);
  v13 = v12;
  if ( v12 < 0 )
  {
