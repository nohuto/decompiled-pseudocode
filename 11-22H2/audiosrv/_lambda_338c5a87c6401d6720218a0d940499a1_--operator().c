/*
 * XREFs of _lambda_338c5a87c6401d6720218a0d940499a1_::operator() @ 0x1800732B8
 * Callers:
...
__int64 __fastcall lambda_338c5a87c6401d6720218a0d940499a1_::operator()(__int64 a1, char a2)
{
  unsigned int *v2; // r10
