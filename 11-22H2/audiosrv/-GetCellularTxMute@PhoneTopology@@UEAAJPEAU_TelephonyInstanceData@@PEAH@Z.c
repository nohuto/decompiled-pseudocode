/*
 * XREFs of ?GetCellularTxMute@PhoneTopology@@UEAAJPEAU_TelephonyInstanceData@@PEAH@Z @ 0x180164C90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v14 + 56LL))(v14, a3);
  if ( v8 < 0 )
LABEL_7:
    v6 = v8;
LABEL_16:
