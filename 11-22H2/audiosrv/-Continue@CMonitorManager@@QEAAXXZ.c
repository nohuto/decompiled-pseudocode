/*
 * XREFs of ?Continue@CMonitorManager@@QEAAXXZ @ 0x18012C4C4
 * Callers:
 *     ?ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ @ 0x18012EF70 (-ResumeAllMonitors@CStreamConnectionManagerImpl@@UEAAXXZ.c)
 * Callees:
