/*
 * XREFs of ?get@?$static_lazy@VNUIAudioTracing@@@details@wil@@QEAAPEAVNUIAudioTracing@@P6AXXZ@Z @ 0x18015917C
 * Callers:
 ...
 *     ??0TraceLoggingProvider@wil@@IEAA@XZ @ 0x1800CE3B0 (--0TraceLoggingProvider@wil@@IEAA@XZ.c)
