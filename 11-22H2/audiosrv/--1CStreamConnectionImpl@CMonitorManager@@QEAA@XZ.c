/*
 * XREFs of ??1CStreamConnectionImpl@CMonitorManager@@QEAA@XZ @ 0x18012BCCC
 * Callers:
 *     ??_GCStreamConnectionImpl@CMonitorManager@@QEAAPEAXI@Z @ 0x18012C1C4 (--_GCStreamConnectionImpl@CMonitorManager@@QEAAPEAXI@Z.c)
 * Callees:
