/*
 * XREFs of _CAudioSessionInstanceId::Initialize_::_1_::dtor$3_0 @ 0x180082F10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionInstanceId::Initialize_::_1_::dtor_3_0(__int64 a1, __int64 a2)
{
