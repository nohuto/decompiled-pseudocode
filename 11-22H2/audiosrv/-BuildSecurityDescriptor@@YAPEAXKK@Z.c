/*
 * XREFs of ?BuildSecurityDescriptor@@YAPEAXKK@Z @ 0x18005719C
 * Callers:
...
__int64 __fastcall BuildSecurityDescriptor()
{
  ...
  *(_WORD *)&pIdentifierAuthority.Value[4] = 256;
  ...
  if ( !v3 )
  {
    ...
    v11 = 10LL;
LABEL_24:
    WPP_SF_(*((_QWORD *)v10 + 2), v11, &WPP_ea4dc79131a5388790567eb319c308bd_Traceguids);
    goto LABEL_12;
  }
  if ( !InitializeSecurityDescriptor(v3, 1u) )
  {
    ...
    v13 = 11LL;
LABEL_62:
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), v13, &WPP_ea4dc79131a5388790567eb319c308bd_Traceguids, LastError);
    goto LABEL_12;
  }
  if ( !AllocateAndInitializeSid(&pIdentifierAuthority, 1u, 0, 0, 0, 0, 0, 0, 0, 0, &pSid) )
  {
    ...
    v15 = 12LL;
LABEL_33:
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), v15, &WPP_ea4dc79131a5388790567eb319c308bd_Traceguids, v14);
    goto LABEL_12;
  }
