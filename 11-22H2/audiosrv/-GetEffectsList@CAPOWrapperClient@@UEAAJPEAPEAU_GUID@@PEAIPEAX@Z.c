/*
 * XREFs of ?GetEffectsList@CAPOWrapperClient@@UEAAJPEAPEAU_GUID@@PEAIPEAX@Z @ 0x1800CF670
 * Callers:
 *     ?GetEffectsList@CAPOWrapperClient@@W7EAAJPEAPEAU_GUID@@PEAIPEAX@Z @ 0x180075B40 (-GetEffectsList@CAPOWrapperClient@@W7EAAJPEAPEAU_GUID@@PEAIPEAX@Z.c)
 * Callees:
