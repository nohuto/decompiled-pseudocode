/*
 * XREFs of BasepGetVolumeDosLetterNameFromNTName @ 0x140012818
 * Callers:
...
__int64 __fastcall BasepGetVolumeDosLetterNameFromNTName(const wchar_t *Src, _QWORD *a2)
{
  ...
  v4 = 0LL;
  LODWORD(v20) = _wcsnicmp(Src, L"\\Device\\MUP", 0xBuLL);
  if ( (_DWORD)v20 )
  {
    v9 = -1LL;
        ...
        *Heap = v14;
        ...
        while ( 1 )
        {
          ...
          if ( !v16 )
            goto LABEL_41;
          v17 = (WCHAR *)(v16 + 1);
          v7 = DeviceIoControl(FileW, 0x6D0030u, (__int64)(v16 + 1), v15 - 8, (__int64)&v20);
          v15 = *(_DWORD *)v17 + 16;
          if ( v7 )
            break;
...
LABEL_18:
          ...
          || DestinationString.Buffer[47] != 125 )
        {
          ...
          *((_WORD *)v4 + ((unsigned __int64)v18 >> 1) + 4) = 0;
          goto LABEL_18;
        }
