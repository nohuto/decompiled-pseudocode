/*
 * XREFs of SmpAsyncMemoryConfiguration @ 0x14000B010
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SmpCheckMemoryCoolingCompatibility @ 0x140010BF4 (SmpCheckMemoryCoolingCompatibility.c)
...
LABEL_6:
    ...
    if ( !SmpMiniNTBoot )
      LOBYTE(v1) = SmpCheckMemoryCoolingCompatibility(v3);
    if ( v0 == 1 )
    {
      if ( !SmpMiniNTBoot )
        SmpEnableCachingOnDedicatedMemory(v3);
