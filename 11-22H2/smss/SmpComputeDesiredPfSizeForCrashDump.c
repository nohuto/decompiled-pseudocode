/*
 * XREFs of SmpComputeDesiredPfSizeForCrashDump @ 0x140016D74
 * Callers:
...
LABEL_18:
      ...
      {
        v0 = 0x40000000LL;
        v3 = (unsigned int)~(dword_14002BC28 - 1) & (((SmpHighestPhysicalAddress
                                                     / (unsigned __int64)(unsigned int)dword_14002BC28
                                                     + 7) >> 3)
                                                   + (unsigned int)(dword_14002BC28 - 1)
                                                   + 8256LL);
