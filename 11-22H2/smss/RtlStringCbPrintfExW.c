/*
 * XREFs of RtlStringCbPrintfExW @ 0x140018CCC
 * Callers:
 ...
 *     RtlStringVPrintfWorkerW_0 @ 0x140018F5C (RtlStringVPrintfWorkerW_0.c)
 */
        ...
        ...)
{
  ...
  else
  {
    ...
    if ( (dwFlags & 0x100) != 0 )
    {
      v12 = (const wchar_t *)&unk_1400263D8;
      if ( pszFormat )
        v12 = pszFormat;
    }
    else
    ...
    else if ( v7 )
    {
      ...
      v13 = RtlStringVPrintfWorkerW_0(pszDest, v7, pcchNewDestLength, v12, argList);
      ...
      if ( v13 >= 0 )
      {
        if ( (dwFlags & 0x200) != 0 )
        {
          v15 = (cbDest & 1) + 2 * v7;
          if ( v15 > 2 )
            memset_0(v11 + 1, (unsigned __int8)dwFlags, v15 - 2);
        }
        goto LABEL_22;
      }
    }
