/*
 * XREFs of ??0?$CalloutWrapper@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoControllerNavigationManagerPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180029820
 * Callers:
 *     ?OnDisconnectedThunk@BamoControllerNavigationManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800297A0 (-OnDisconnectedThunk@BamoControllerNavigationManagerStubImpl@BamoImpl@@UEAAJXZ.c)
