/*
 * XREFs of ?QueryInterface@BamoSystemContextManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18015D7E0
 * Callers:
 *     ?QueryInterface@BamoSystemContextManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B8F0 (-QueryInterface@BamoSystemContextManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
