/*
 * XREFs of ?SendMaterializeProxy@BamoDataProviderPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800322A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  LOWORD(v12) = 1;
  v8 = CoreUICallSend(a2, &v13, 2LL, 7LL);
  if ( v8 < 0 )
  ...
  v14 = *(unsigned int *)(v3 + 40);
  LOWORD(v12) = 5;
  v10 = CoreUICallSend(a2, &v13, 2LL, 7LL);
  if ( v10 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
      (void *)0x28EF,
