/*
 * XREFs of ?OnDockableDeviceAdded@BamoDeviceDockClientProxyImpl@BamoImpl@@QEAAJIPEAVBamoDockableDevicePrincipal@@@Z @ 0x1801AE0BC
 * Callers:
        ...
        struct BamoDockableDevicePrincipal *a3)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      return CoreUICallSend(v12, v16, 2LL, 25LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
