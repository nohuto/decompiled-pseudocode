 ...
 * Callers:
 *     ?AddDeviceToCache@AugmentedInputDeviceCollection@@AEAAJKGGG@Z @ 0x1800E2DF0 (-AddDeviceToCache@AugmentedInputDeviceCollection@@AEAAJKGGG@Z.c)
 * Callees:
        ...
        unsigned int *a3)
{
  ...
  if ( *(_BYTE *)(v15 + 25) || *v6 < *(_DWORD *)(v15 + 28) )
  {
    ...
    v9 = std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<unsigned long const,AugmentedInputCacheState>,void *>>>::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<unsigned long const,AugmentedInputCacheState>,void *>>>(
           &v12,
           (__int64)a1,
           *a1,
           v6,
