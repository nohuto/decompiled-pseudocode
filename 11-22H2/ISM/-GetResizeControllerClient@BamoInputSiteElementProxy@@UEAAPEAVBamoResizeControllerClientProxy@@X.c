/*
 * XREFs of ?GetResizeControllerClient@BamoInputSiteElementProxy@@UEAAPEAVBamoResizeControllerClientProxy@@XZ @ 0x180011C20
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoResizeControllerClientProxy *)*((_QWORD *)this + 34);
}
