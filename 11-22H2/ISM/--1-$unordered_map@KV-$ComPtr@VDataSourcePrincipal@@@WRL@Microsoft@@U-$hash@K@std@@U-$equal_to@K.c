/*
 * XREFs of ??1?$unordered_map@KV?$ComPtr@VDataSourcePrincipal@@@WRL@Microsoft@@U?$hash@K@std@@U?$equal_to@K@5@V?$allocator@U?$pair@$$CBKV?$ComPtr@VDataSourcePrincipal@@@WRL@Microsoft@@@std@@@5@@std@@QEAA@XZ @ 0x18016A9B8
 * Callers:
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$9 @ 0x18016A714 (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$9.c)
 *     _ResizeProcessor::ResizeProcessor_::_1_::dtor$7 @ 0x1801717A6 (_ResizeProcessor--ResizeProcessor_--_1_--dtor$7.c)
 *     _EdgyProcessor::EdgyProcessor_::_1_::dtor$3 @ 0x1801751F4 (_EdgyProcessor--EdgyProcessor_--_1_--dtor$3.c)
 * Callees:
