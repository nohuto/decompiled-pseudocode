/*
 * XREFs of ?InputReportProcessed_@RawInputProvidersContinuousTracing@@QEAAXKJPEAUInputInfo@@@Z @ 0x1800E83E8
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U?$_tlgWrapperByVal@$00@@U2@U1@U2@U1@U2@U1@U1@U2@U1@U1@U2@U1@U2@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@333AEBU?$_tlgWrapperByVal@$00@@43434334334343@Z @ 0x1800E50D4 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U-$_tlgWrapperByVal@$00@@U2@U1@U2@U1@U2@U1@U1@U2@U1@U.c)
        ...
        struct InputInfo *a4)
{
  ...
  if ( a3 >= 0 )
  {
    v10 = *(_QWORD *)(wil::details::static_lazy<RawInputProvidersContinuousTracing>::get(
                        this,
    ...
    {
      v17 = *((_DWORD *)a4 + 585);
      LOBYTE(v30) = *((_BYTE *)a4 + 2369);
      v18 = *((_DWORD *)a4 + 589);
      LOBYTE(v29) = *((_BYTE *)a4 + 2368);
      v19 = *((_DWORD *)a4 + 575);
      v20 = *((_DWORD *)a4 + 574);
      v31 = *((_BYTE *)a4 + 2322);
      v21 = *((_DWORD *)a4 + 577);
  ...
  {
    v7 = *(_QWORD *)(wil::details::static_lazy<RawInputProvidersContinuousTracing>::get(
                       this,
                       _lambda_f655bc6deafeea110b0bcdbdac4bd35f_::_lambda_invoker_cdecl_)
                   + 8);
    if ( *(_DWORD *)v7 > 2u && (*(_BYTE *)(v7 + 16) & 2) != 0 && (*(_QWORD *)(v7 + 24) & 2LL) == *(_QWORD *)(v7 + 24) )
    {
      v30 = a3;
      LODWORD(v29) = a2;
