/*
 * XREFs of ?QueryInterface@BamoMPCManagerClientStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18018DA50
 * Callers:
 *     ?QueryInterface@BamoMPCManagerClientStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007C930 (-QueryInterface@BamoMPCManagerClientStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
