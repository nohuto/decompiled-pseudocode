/*
 * XREFs of ?EnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180110B8C
 * Callers:
 *     ?Thunk_EnsureServiceAndRegisterClient_8@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180111A00 (-Thunk_EnsureServiceAndRegisterClient_8@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCu.c)
 * Callees:
