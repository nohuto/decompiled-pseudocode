/*
 * XREFs of ?CheckForShellGesture@ShellGesturesRecognizer@@AEAAXAEAURecognitionState@1@_N@Z @ 0x18017B558
 * Callers:
      ...
      if ( *((_DWORD *)this + 20) == 1 )
      {
        if ( a3 )
        {
          ...
          if ( (int)((v20[4] - v21) * (v20[4] - v21)
                   + (HIDWORD(v20[4]) - HIDWORD(v21)) * (HIDWORD(v20[4]) - HIDWORD(v21))) >= (unsigned __int64)(unsigned int)(dword_180277010 * dword_180277010) )
          {
            *((_DWORD *)a2 + 1) = 2;
LABEL_43:
            *(_DWORD *)a2 = 1;
      ...
      else if ( *((_DWORD *)this + 20) == 2 )
      {
        if ( a3 )
        {
          ...
          {
            if ( k[6] - k[5] >= 1000000 * qword_180277018 )
            {
              *((_DWORD *)a2 + 1) = 3;
              goto LABEL_43;
            }
            v19 = k[3];
            if ( (int)((k[4] - v19) * (k[4] - v19) + (HIDWORD(k[4]) - HIDWORD(v19)) * (HIDWORD(k[4]) - HIDWORD(v19))) >= (unsigned __int64)(unsigned int)(dword_180277020 * dword_180277020) )
            {
              *((_DWORD *)a2 + 1) = 4;
              goto LABEL_43;
            }
