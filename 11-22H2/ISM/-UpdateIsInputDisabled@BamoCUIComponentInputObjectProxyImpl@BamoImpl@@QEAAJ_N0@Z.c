/*
 * XREFs of ?UpdateIsInputDisabled@BamoCUIComponentInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1801509B4
 * Callers:
 *     ?Thunk_UpdateIsInputDisabled_11@?$ICUIComponentInputObjectProxy_Receive@VBamoCUIComponentInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801506A0 (-Thunk_UpdateIsInputDisabled_11@-$ICUIComponentInputObjectProxy_Receive@VBamoCUIComponentInputOb.c)
