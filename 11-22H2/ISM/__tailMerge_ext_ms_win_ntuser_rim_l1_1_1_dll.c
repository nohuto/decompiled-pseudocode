/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_rim_l1_1_1_dll @ 0x180058B5A
 * Callers:
 *     __imp_load_InitializePointerDeviceInjectionEx @ 0x180058B4E (__imp_load_InitializePointerDeviceInjectionEx.c)
 * Callees:
