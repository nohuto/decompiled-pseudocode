/*
 * XREFs of ?UpdatePrimaryClickZone@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_NPEBUPhysicalClickZone@Input@Internal@UI@Windows@@@Z @ 0x180154330
 * Callers:
 *     ?Thunk_UpdatePrimaryClickZone_408@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800723A0 (-Thunk_UpdatePrimaryClickZone_408@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpad.c)
