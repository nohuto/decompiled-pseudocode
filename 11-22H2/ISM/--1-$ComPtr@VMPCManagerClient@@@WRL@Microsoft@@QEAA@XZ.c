/*
 * XREFs of ??1?$ComPtr@VMPCManagerClient@@@WRL@Microsoft@@QEAA@XZ @ 0x1801859DC
 * Callers:
 ...
 *     _Microsoft::WRL::Details::MakeAndInitialize_MPCManagerClient_Windows::Internal::Input::MPCManager::IMPCManagerClient__::_1_::dtor$2 @ 0x18018531D (_Microsoft--WRL--Details--MakeAndInitialize_MPCManagerClient_Windows--Internal--Inp_ea_18018531D.c)
 * Callees:
