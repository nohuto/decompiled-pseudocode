/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAUevent_watcher_state@details@wil@@P6AXPEAU123@@Z$1?delete_event_watcher_state@23@YAX0@ZU?$integral_constant@_K$01@wistd@@PEAU123@PEAU123@$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x1800E10EC
 * Callers:
 *     _MPCHeadUpdateListener::Initialize_::_1_::dtor$5 @ 0x1800E1454 (_MPCHeadUpdateListener--Initialize_--_1_--dtor$5.c)
 * Callees:
