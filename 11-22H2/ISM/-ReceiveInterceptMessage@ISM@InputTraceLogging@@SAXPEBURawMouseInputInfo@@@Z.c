/*
 * XREFs of ?ReceiveInterceptMessage@ISM@InputTraceLogging@@SAXPEBURawMouseInputInfo@@@Z @ 0x1801096C4
 * Callers:
...
void __fastcall InputTraceLogging::ISM::ReceiveInterceptMessage(const struct RawMouseInputInfo *a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v7 = 8;
    v6 = &v4;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180233A27, 0LL, 0LL, 3u, &v5);
  }
}
