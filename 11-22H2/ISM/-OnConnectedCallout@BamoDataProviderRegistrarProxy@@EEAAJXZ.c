/*
 * XREFs of ?OnConnectedCallout@BamoDataProviderRegistrarProxy@@EEAAJXZ @ 0x180054B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataProviderRegistrarProxy::OnConnectedCallout(
        ...
        __int64 a3)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    a3,
    0LL);
  LODWORD(v3) = (*(__int64 (__fastcall **)(BamoDataProviderRegistrarProxy *))(*(_QWORD *)v3 + 32LL))(v3);
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    v8,
    v4,
    v5,
