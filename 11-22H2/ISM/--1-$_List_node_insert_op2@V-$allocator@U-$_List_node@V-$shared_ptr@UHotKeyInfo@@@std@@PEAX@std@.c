/*
 * XREFs of ??1?$_List_node_insert_op2@V?$allocator@U?$_List_node@V?$shared_ptr@UHotKeyInfo@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1801FD8A0
 * Callers:
 ...
 *     _std::list_std::shared_ptr_HotKeyInfo__std::allocator_std::shared_ptr_HotKeyInfo_____::_Assign_cast_std::shared_ptr_HotKeyInfo__&_std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_std::shared_ptr_HotKeyInfo______std::_Iterator_base0____::_1_::dtor$0 @ 0x1801FC84B (_std--list_std--shared_ptr_HotKeyInfo__std--allocator_std--shared_ptr_HotKeyInfo_____--_Assign_c.c)
 ...
 *     _std::list_std::shared_ptr_HotKeyInfo__std::allocator_std::shared_ptr_HotKeyInfo_____::list_std::shared_ptr_HotKeyInfo__std::allocator_std::shared_ptr_HotKeyInfo______::_1_::dtor$6 @ 0x1801FD556 (_std--list_std--shared_ptr_HotKeyInfo__std--allocator_std--shared_ptr_HotKeyInfo_____--list_std-.c)
 * Callees:
