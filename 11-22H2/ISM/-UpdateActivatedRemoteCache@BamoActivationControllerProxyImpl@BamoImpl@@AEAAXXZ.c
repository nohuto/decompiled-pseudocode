/*
 * XREFs of ?UpdateActivatedRemoteCache@BamoActivationControllerProxyImpl@BamoImpl@@AEAAXXZ @ 0x1800B87BC
 * Callers:
 *     ?PushStateToPrincipal@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXXZ @ 0x1800B8560 (-PushStateToPrincipal@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXXZ.c)
