/*
 * XREFs of ?ProcessResult@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJIPEBUDragOperationResult@Input@Internal@UI@Windows@@I@Z @ 0x180161764
 * Callers:
 *     ?Thunk_ProcessResult_212@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180073A40 (-Thunk_ProcessResult_212@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@B.c)
 * Callees:
