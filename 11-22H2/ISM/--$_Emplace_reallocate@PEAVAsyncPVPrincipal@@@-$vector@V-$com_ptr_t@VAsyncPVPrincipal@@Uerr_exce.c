 ...
 *     ??0?$com_ptr_t@VAsyncPVPrincipal@@Uerr_exception_policy@wil@@@wil@@QEAA@PEAVAsyncPVPrincipal@@@Z @ 0x180191860 (--0-$com_ptr_t@VAsyncPVPrincipal@@Uerr_exception_policy@wil@@@wil@@QEAA@PEAVAsyncPVPrincipal@@@Z.c)
 */

char *__fastcall std::vector<wil::com_ptr_t<AsyncPVPrincipal,wil::err_exception_policy>>::_Emplace_reallocate<AsyncPVPrincipal *>(
        __int64 **a1,
        __int64 *a2,
        _QWORD *a3)
{
