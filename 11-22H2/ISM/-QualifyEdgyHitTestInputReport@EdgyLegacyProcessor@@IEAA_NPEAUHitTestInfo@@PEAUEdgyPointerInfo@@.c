/*
 * XREFs of ?QualifyEdgyHitTestInputReport@EdgyLegacyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@@Z @ 0x1801D60B8
 * Callers:
...
char __fastcall EdgyLegacyProcessor::QualifyEdgyHitTestInputReport(
