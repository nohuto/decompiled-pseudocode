/*
 * XREFs of ?GetRoutingMode@BamoEdgyNotificationSourceClientProxy@@UEAA?AW4EdgyRoutingMode@Input@Internal@UI@Windows@@XZ @ 0x180133760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoEdgyNotificationSourceClientProxy::GetRoutingMode(__int64 a1)
{
  __int64 v1; // rbx
  __int64 v2; // rdx
  __int64 v3; // r8
