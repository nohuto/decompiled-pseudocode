/*
 * XREFs of ?AllocateStub@BamoResizeContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoResizeContextualProcessorStub@@@Z @ 0x180017600
 * Callers:
 *     <none>
 * Callees:
