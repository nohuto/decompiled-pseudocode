/*
 * XREFs of ?ReadFeatureReport@SpatialRimDevice@SpatialInteractions@Internal@Windows@@UEAAJEPEAEK@Z @ 0x1800F4AB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReadFeatureReport_@RawInputProvidersTracing@@QEAAXJKE@Z @ 0x1800F4B4C (-ReadFeatureReport_@RawInputProvidersTracing@@QEAAXJKE@Z.c)
 */
        ...
        int a4)
{
  ...
  if ( a4 )
  {
    ...
    v10[1] = &v12;
    v10[3] = &v14;
    v5 = lambda_c4b5ac531e4df77abc1357e1027acfb6_::operator()((__int64)v10);
