/*
 * XREFs of ?CancelDrag@DragNDropProcessor@@QEAAJKPEAVBamoDragManagerClientProxy@@@Z @ 0x18016B020
 * Callers:
        ...
        struct BamoDragManagerClientProxy *a3)
{
  ...
  if ( v20 != *((_QWORD *)this + 15) )
  {
    ...
    Microsoft::WRL::ComPtr<BamoCustomCursorControllerClient2Proxy>::InternalRelease((__int64 *)&v26);
  }
  return 0LL;
}
