/*
 * XREFs of ?OnMPCInputObjectChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000D2E0
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    if ( v24 )
    {
      ...
      v12 = v26(v9, &GUID_9a5daf6a_38f8_287c_c758_186a8416bbfc, &v24);
    }
    else
    {
      v12 = v10(v9, &GUID_9a5daf6a_38f8_287c_c758_186a8416bbfc, &v24);
    }
    v13 = v12 >= 0;
    if ( v8 == this && v13 )
      break;
  ...
  v15 = *((_QWORD *)this + 41);
  v16 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 240LL))((char *)this + 8);
  if ( v16 )
  {
    v18 = v16 + 8;
    v24 = v16 + 8;
