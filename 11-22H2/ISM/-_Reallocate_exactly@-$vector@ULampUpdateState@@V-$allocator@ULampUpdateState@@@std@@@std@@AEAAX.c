/*
 * XREFs of ?_Reallocate_exactly@?$vector@ULampUpdateState@@V?$allocator@ULampUpdateState@@@std@@@std@@AEAAX_K@Z @ 0x1800FBEF4
 * Callers:
 *     ?reserve@?$vector@ULampUpdateState@@V?$allocator@ULampUpdateState@@@std@@@std@@QEAAX_K@Z @ 0x1800FBFCC (-reserve@-$vector@ULampUpdateState@@V-$allocator@ULampUpdateState@@@std@@@std@@QEAAX_K@Z.c)
 * Callees:
...
__int64 __fastcall std::vector<LampUpdateState>::_Reallocate_exactly(__int64 a1, unsigned __int64 a2)
{
  ...
  return std::vector<LampUpdateState>::_Change_array(v11, v10, v9, v8);
}
