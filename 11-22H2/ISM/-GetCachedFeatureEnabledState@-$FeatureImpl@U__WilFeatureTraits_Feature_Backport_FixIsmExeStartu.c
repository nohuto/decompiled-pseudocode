/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Backport_FixIsmExeStartupDuringSessionShutdown@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18007654C
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Backport_FixIsmExeStartupDuringSessionShutdown>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Backport_FixIsmExeStartupDuringSessionShutdown>::GetCurrentFeatureEnabledState(
      a1,
      &v12,
      &v11);
    for ( i = *a2; ; i = v9 )
