/*
 * XREFs of ?QueryInterface@BamoDragAreaClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013C7C0
 * Callers:
 *     ?QueryInterface@BamoDragAreaClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B010 (-QueryInterface@BamoDragAreaClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
