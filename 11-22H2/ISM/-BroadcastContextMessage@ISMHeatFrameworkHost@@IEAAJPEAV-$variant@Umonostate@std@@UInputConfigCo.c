/*
 * XREFs of ?BroadcastContextMessage@ISMHeatFrameworkHost@@IEAAJPEAV?$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusionContextMessage@@UVirtualTouchpadContextMessage@@UMIT_WIN32K_INPUTDESKTOP_STATE_MESSAGE@@@std@@PEAUIHeatSystemContextClient@@@Z @ 0x1801B1230
 * Callers:
        ...
        const char *a4)
{
  ...
  __int64 ***v17; // rdi
  __int64 **k; // rbx
  unsigned __int8 v20[16]; // [rsp+20h] [rbp-E0h] BYREF
  float v21; // [rsp+30h] [rbp-D0h] BYREF
  _QWORD *v22; // [rsp+38h] [rbp-C8h]
  ...
  _BYTE v33[160]; // [rsp+C0h] [rbp-40h] BYREF
...
LABEL_23:
  ...
  if ( *v7 != 2 )
  {
    if ( *v7 == 3 )
    {
      ...
      *(_DWORD *)v20 = 0;
      ...
      v28 = 5;
      v15 = *(_QWORD *)(a2 + 8);
      for ( i = *(_QWORD *)a2; i != v15; i += 24LL )
        std::_Hash<std::_Umap_traits<unsigned __int64,tagRECT,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,tagRECT>>,0>>::emplace<unsigned __int64 const &,tagRECT const &>(
          &v21,
          (__int64)v29,
          (unsigned __int8 *)i,
          (_OWORD *)(i + 8));
  ...
  *v9 = v9;
  ...
  v28 = 4;
  v10 = *(_QWORD *)(a2 + 8);
  for ( j = *(_QWORD *)a2; j != v10; j += 176LL )
  {
    HeatDisplayOcclusionRect::HeatDisplayOcclusionRect(
      (HeatDisplayOcclusionRect *)v33,
      (const struct tagRECT *)(j + 24),
      (const struct tagRECT *)(j + 40),
      (size_t *)(j + 56));
    ...
    {
      *(_QWORD *)v20 = a1[26];
      a1[26] = *(_QWORD *)v20 + 1LL;
      std::_Tree<std::_Tmap_traits<DockInputIdentity,unsigned __int64,std::less<DockInputIdentity>,std::allocator<std::pair<DockInputIdentity const,unsigned __int64>>,0>>::_Emplace<DockInputIdentity const &,unsigned __int64 &>(
        a1 + 24,
        (__int64)v32,
        v13,
        v20);
    ...
    {
      *(_QWORD *)v20 = *(_QWORD *)std::map<DockInputIdentity,unsigned __int64>::at(a1 + 24, j);
    }
...
LABEL_17:
  ...
  else
  {
    ...
    for ( k = *v17; k != (__int64 **)v17; k = (__int64 **)*k )
      (*(void (__fastcall **)(__int64 *, float *))*k[2])(k[2], &v21);
  }
  std::_Variant_raw_visit1<2>::_Visit<_lambda_b4317e4bff0ee715c22e12c77f4f8b58_,std::_Variant_storage_<0,std::monostate,HeatInputConfigContextMessage,HeatLowPowerStateContextMessage,HeatHingeAngleContextMessage,HeatDisplayOcclusionContextMessage,HeatVirtualTouchpadContextMessage,HeatTouchpadEnabledContextMessage,HeatTouchpadHapticConfigContextMessage> &>(
    v28 + 1,
    v8,
