/*
 * XREFs of ?GetLightDismissClient@BamoInputSiteElementProxy@@UEAAPEAVBamoLightDismissClientProxy@@XZ @ 0x180011EC0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoLightDismissClientProxy *)*((_QWORD *)this + 28);
}
