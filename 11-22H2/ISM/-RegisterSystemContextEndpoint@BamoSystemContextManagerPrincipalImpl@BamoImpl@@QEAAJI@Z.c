/*
 * XREFs of ?RegisterSystemContextEndpoint@BamoSystemContextManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18015D8E0
 * Callers:
 *     ?Thunk_RegisterSystemContextEndpoint_8@?$ISystemContextManagerPrincipal_Receive@VBamoSystemContextManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18015F7D0 (-Thunk_RegisterSystemContextEndpoint_8@-$ISystemContextManagerPrincipal_Receive@VBamoSystemConte.c)
 * Callees:
