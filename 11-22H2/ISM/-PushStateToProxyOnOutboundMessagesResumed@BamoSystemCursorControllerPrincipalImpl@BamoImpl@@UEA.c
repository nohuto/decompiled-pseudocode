/*
 * XREFs of ?PushStateToProxyOnOutboundMessagesResumed@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180111210
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::BamoSystemCursorControllerPrincipalImpl::PushStateToProxyOnOutboundMessagesResumed(
