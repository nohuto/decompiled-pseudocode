/*
 * XREFs of ?PopulateDeviceInfo@DockableDeviceCollection@@AEAAJPEAVHIDDevice@@PEAUDockableDeviceInfo@@@Z @ 0x1800F2AA4
 * Callers:
        ...
        struct DockableDeviceInfo *a3)
{
  ...
  DockableDeviceCollection *v25; // [rsp+98h] [rbp-68h] BYREF
  int v26; // [rsp+A0h] [rbp-60h]
  int v27; // [rsp+A4h] [rbp-5Ch]
  struct _HIDP_VALUE_CAPS v28; // [rsp+A8h] [rbp-58h]
...
LABEL_8:
  ...
  else
  {
    ...
    winrt::impl::factory_cache_entry<winrt::Windows::System::Threading::ThreadPool,winrt::Windows::System::Threading::IThreadPoolStatics>::call<_lambda_4e2f6834dae5c2d9676db4968b0ab11c_ &>(
      (void (__fastcall ***)(_QWORD, __int64 *, __int64 *))&qword_180278998,
      (__int64)&v16,
      &v20);
  }
  if ( v16 )
