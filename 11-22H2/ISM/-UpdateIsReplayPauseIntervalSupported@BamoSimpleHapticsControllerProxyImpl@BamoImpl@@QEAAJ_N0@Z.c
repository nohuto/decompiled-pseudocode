/*
 * XREFs of ?UpdateIsReplayPauseIntervalSupported@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1801468A8
 * Callers:
 *     ?Thunk_UpdateIsReplayPauseIntervalSupported_11@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180142090 (-Thunk_UpdateIsReplayPauseIntervalSupported_11@-$ISimpleHapticsControllerProxy_Receive@VBamoSimp.c)
