/*
 * XREFs of ??1?$vector@V?$ComPtr@UIGamepadInterceptionTarget@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIGamepadInterceptionTarget@@@WRL@Microsoft@@@std@@@std@@QEAA@XZ @ 0x18006A2E8
 * Callers:
 *     _GamepadInterceptionHelper::GamepadInterceptionHelper_::_1_::dtor$2 @ 0x180069F5F (_GamepadInterceptionHelper--GamepadInterceptionHelper_--_1_--dtor$2.c)
 * Callees:
