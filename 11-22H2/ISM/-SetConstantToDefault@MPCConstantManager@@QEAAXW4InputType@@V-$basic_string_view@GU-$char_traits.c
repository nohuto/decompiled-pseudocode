/*
 * XREFs of ?SetConstantToDefault@MPCConstantManager@@QEAAXW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x1800BF774
 * Callers:
 ...
 *     ?SetConstantToDefault@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEBGPEAVBamoAsyncHRESULTProxy@@@Z @ 0x1800BF870 (-SetConstantToDefault@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType.c)
 * Callees:
...
void __fastcall MPCConstantManager::SetConstantToDefault(__int64 a1, int a2, __m128i *a3)
{
  ...
  v14 = a2;
  v13[0] = *a3;
  if ( MPCConstantManager::CheckModifiedConstantExistence(a1, a2, v13) )
  {
    v5 = a1 + 72;
    ...
    v12 = (void *)std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>>::_Extract(
                    v8 + 40,
                    v10);
    std::wstring::_Tidy_deallocate((__int64)v12 + 32);
