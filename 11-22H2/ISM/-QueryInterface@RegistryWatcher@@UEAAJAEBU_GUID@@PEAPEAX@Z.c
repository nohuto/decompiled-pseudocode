/*
 * XREFs of ?QueryInterface@RegistryWatcher@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801240B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegistryWatcher::QueryInterface(RegistryWatcher *this, struct _GUID *a2, void **a3)
{
  __int64 result; // rax
