/*
 * XREFs of ?Materialize_BamoManualResizeAreaClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180135F8C
 * Callers:
 *     ?Thunk_Materialize_BamoManualResizeAreaClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801417F0 (-Thunk_Materialize_BamoManualResizeAreaClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBam.c)
 * Callees:
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  v5 = (unsigned int)a2;
  BamoImpl::CreateManualResizeAreaClientProxy(
