/*
 * XREFs of std::_Func_impl_no_alloc__lambda_0c5ce8ae284f99017ef76f49f6fd125b__void__MIT_INPUT_INTEROP_MESSAGE_const___::_Do_call @ 0x18010A140
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _MIT_INPUT_INTEROP_MESSAGE **a2)
{
  ...
  v3 = *a2;
  InputTraceLogging::PerfRegion::PerfRegion((InputTraceLogging::PerfRegion *)v6, "MIT_INPUT_INTEROP_MESSAGE", 0LL);
