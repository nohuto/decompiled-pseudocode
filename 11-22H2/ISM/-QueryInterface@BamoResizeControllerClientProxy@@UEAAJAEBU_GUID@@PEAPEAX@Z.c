/*
 * XREFs of ?QueryInterface@BamoResizeControllerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013D300
 * Callers:
 *     ?QueryInterface@BamoResizeControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B2B0 (-QueryInterface@BamoResizeControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
