/*
 * XREFs of _SystemCursorController2::DestroyCursorShape_::_1_::catch$7 @ 0x180110B51
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SystemCursorController2::DestroyCursorShape_::_1_::catch_7(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
