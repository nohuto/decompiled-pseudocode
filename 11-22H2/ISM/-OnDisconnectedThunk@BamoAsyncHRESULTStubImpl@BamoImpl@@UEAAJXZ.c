/*
 * XREFs of ?OnDisconnectedThunk@BamoAsyncHRESULTStubImpl@BamoImpl@@UEAAJXZ @ 0x18019D290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncHRESULTStubImpl::OnDisconnectedThunk(
