/*
 * XREFs of ?GetDragSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragSourceClientProxy@@XZ @ 0x180012240
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoDragSourceClientProxy *)*((_QWORD *)this + 20);
}
