/*
 * XREFs of ?QueryInterface@BamoWindowsMessageDeliveryProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180023010
 * Callers:
 *     ?QueryInterface@BamoWindowsMessageDeliveryProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B750 (-QueryInterface@BamoWindowsMessageDeliveryProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
