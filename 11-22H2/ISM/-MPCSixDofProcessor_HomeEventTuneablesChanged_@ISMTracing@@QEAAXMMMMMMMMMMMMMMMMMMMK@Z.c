/*
 * XREFs of ?MPCSixDofProcessor_HomeEventTuneablesChanged_@ISMTracing@@QEAAXMMMMMMMMMMMMMMMMMMMK@Z @ 0x1801EBC54
 * Callers:
        ...
        unsigned int a21)
{
  ...
  if ( *(_DWORD *)v21 > 4u
    && (*(_QWORD *)(v21 + 16) & 0x400000000001LL) != 0
    && (*(_QWORD *)(v21 + 24) & 0x400000000001LL) == *(_QWORD *)(v21 + 24) )
  {
    LODWORD(v44) = a21;
    v24 = a20;
    v25 = a19;
