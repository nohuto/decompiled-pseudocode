/*
 * XREFs of ??0?$CalloutWrapper@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputDeliveryServerPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180029950
 * Callers:
