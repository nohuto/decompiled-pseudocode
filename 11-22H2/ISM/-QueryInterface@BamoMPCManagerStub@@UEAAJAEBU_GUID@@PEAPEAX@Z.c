/*
 * XREFs of ?QueryInterface@BamoMPCManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C33E0
 * Callers:
 *     ?QueryInterface@BamoMPCManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180079870 (-QueryInterface@BamoMPCManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
