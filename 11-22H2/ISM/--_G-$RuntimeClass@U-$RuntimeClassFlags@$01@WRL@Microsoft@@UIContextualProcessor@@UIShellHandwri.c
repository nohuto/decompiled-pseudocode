/*
 * XREFs of ??_G?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIContextualProcessor@@UIShellHandwritingHostServerOwner@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x180077260
 * Callers:
 *     <none>
 * Callees:
