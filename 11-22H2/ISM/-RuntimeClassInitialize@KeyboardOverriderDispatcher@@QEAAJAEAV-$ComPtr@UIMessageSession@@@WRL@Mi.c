/*
 * XREFs of ?RuntimeClassInitialize@KeyboardOverriderDispatcher@@QEAAJAEAV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@@Z @ 0x18010D84C
 * Callers:
...
__int64 __fastcall KeyboardOverriderDispatcher::RuntimeClassInitialize(__int64 *a1, __int64 *a2)
{
  ...
  if ( !ConvertStringSecurityDescriptorToSecurityDescriptorW(
    ...
    return wil::details::in1diag3::Return_GetLastError(
             retaddr,
             (void *)0x47,
             (__int64)"onecoreuap\\windows\\moderncore\\inputv2\\systeminputhosts\\components\\win32kinterop\\lib\\keyboa"
                      "rdoverriderdispatcher.cpp",
             v5);
  v6 = *v2;
...
LABEL_7:
  ...
  Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease(a1 + 97);
