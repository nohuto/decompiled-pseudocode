/*
 * XREFs of ??$GetAttachedObject@UIDragAreaClientProxy@@VBamoDragAreaClientProxy@@@InputSite@@QEAA?AV?$ComPtr@VBamoDragAreaClientProxy@@@WRL@Microsoft@@XZ @ 0x1801687F8
 * Callers:
 ...
 *     ??$As@UIDragAreaClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIDragAreaClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18014DAC4 (--$As@UIDragAreaClientProxy@@@-$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV-$ComPtrRef@V-$ComPtr@UI.c)
 */
