/*
 * XREFs of ?GetInputForwardTargetInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoInputForwardTargetInputObjectProxy@@XZ @ 0x180011FA0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoInputForwardTargetInputObjectProxy *)*((_QWORD *)this + 26);
}
