/*
 * XREFs of ?GetPoints@MPCClickerProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAV?$vector@UPointData3D@@V?$allocator@UPointData3D@@@std@@@std@@@Z @ 0x1801F6FB0
 * Callers:
 *     <none>
 * Callees:
...
char *__fastcall MPCClickerProcessor::GetPoints(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // xmm0_8
  __int128 v6; // xmm1
  int v7; // eax
