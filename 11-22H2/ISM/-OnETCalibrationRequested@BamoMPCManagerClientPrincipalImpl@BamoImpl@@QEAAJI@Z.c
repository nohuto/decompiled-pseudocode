/*
 * XREFs of ?OnETCalibrationRequested@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18018CC90
 * Callers:
 *     ?Thunk_OnETCalibrationRequested_25@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018DCD0 (-Thunk_OnETCalibrationRequested_25@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPri.c)
 * Callees:
  ...
  if ( *((int *)this + 2) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
      ...
      *(_QWORD *)(v9 + 32),
      v7,
      0LL);
    v11 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD))(*((_QWORD *)this - 2) + 144LL))(
            (char *)this - 16,
            v8,
            a2);
    v4 = v11;
