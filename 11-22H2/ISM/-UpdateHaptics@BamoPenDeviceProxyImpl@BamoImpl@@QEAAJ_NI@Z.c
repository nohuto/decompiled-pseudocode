/*
 * XREFs of ?UpdateHaptics@BamoPenDeviceProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180145050
 * Callers:
 *     ?Thunk_UpdateHaptics_8@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141ED0 (-Thunk_UpdateHaptics_8@-$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAP.c)
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    if ( v13 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v16[0]);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoPenDeviceProxyImpl>::~CalloutWrapper<BamoImpl::BamoPenDeviceProxyImpl>((__int64)v16);
  }
  else
  {
    v12 = (char *)this - 16;
