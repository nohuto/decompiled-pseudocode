/*
 * XREFs of ?OnInputConfigChanged@BamoSystemContextEndpointPrincipalImpl@BamoImpl@@QEAAJPEBII@Z @ 0x1800B1610
 * Callers:
 *     ?Thunk_OnInputConfigChanged_372@?$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndpointPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18005AA40 (-Thunk_OnInputConfigChanged_372@-$ISystemContextEndpointPrincipal_Receive@VBamoSystemContextEndp.c)
 * Callees:
