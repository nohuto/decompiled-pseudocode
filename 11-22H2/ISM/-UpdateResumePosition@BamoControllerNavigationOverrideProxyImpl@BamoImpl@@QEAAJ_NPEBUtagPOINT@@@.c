/*
 * XREFs of ?UpdateResumePosition@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@@Z @ 0x1801A1F04
 * Callers:
 *     ?Thunk_UpdateResumePosition_23@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801A16B0 (-Thunk_UpdateResumePosition_23@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavig.c)
