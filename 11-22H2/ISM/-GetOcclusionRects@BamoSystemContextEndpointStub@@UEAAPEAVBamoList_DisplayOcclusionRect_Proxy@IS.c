/*
 * XREFs of ?GetOcclusionRects@BamoSystemContextEndpointStub@@UEAAPEAVBamoList_DisplayOcclusionRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@XZ @ 0x1800B1360
 * Callers:
 *     <none>
 * Callees:
