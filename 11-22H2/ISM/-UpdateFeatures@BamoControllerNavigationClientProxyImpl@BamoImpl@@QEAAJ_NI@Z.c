/*
 * XREFs of ?UpdateFeatures@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801A1B20
 * Callers:
 *     ?Thunk_UpdateFeatures_8@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801A1650 (-Thunk_UpdateFeatures_8@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClie.c)
