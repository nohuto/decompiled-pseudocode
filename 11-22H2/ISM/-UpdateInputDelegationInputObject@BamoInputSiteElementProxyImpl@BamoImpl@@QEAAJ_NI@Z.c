/*
 * XREFs of ?UpdateInputDelegationInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1800276F0
 * Callers:
 *     ?Thunk_UpdateInputDelegationInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A3C0 (-Thunk_UpdateInputDelegationInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElement.c)
