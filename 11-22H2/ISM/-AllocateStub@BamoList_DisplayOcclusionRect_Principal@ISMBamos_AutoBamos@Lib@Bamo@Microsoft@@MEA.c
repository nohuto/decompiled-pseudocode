/*
 * XREFs of ?AllocateStub@BamoList_DisplayOcclusionRect_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_DisplayOcclusionRect_Stub@2345@@Z @ 0x18015A8A0
 * Callers:
 *     <none>
 * Callees:
