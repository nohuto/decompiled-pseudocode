/*
 * XREFs of ?UpdateCUIHostInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010CE0
 * Callers:
 *     ?Thunk_UpdateCUIHostInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A4E0 (-Thunk_UpdateCUIHostInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImp.c)
    ...
    if ( *((_BYTE *)this + 28) )
    {
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        ...
        1LL);
      v8 = (char *)this - 16;
      v14 = (*(__int64 (__fastcall **)(char *, void (__fastcall ***)(_QWORD)))(*((_QWORD *)this - 2) + 280LL))(
              (char *)this - 16,
              v7);
      if ( v14 < 0 )
    ...
    if ( *((_BYTE *)this + 28) )
    {
      Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSiteElementProxyImpl>(
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL),
        this,
        2LL);
      v15 = (*(__int64 (__fastcall **)(char *))(*(_QWORD *)v8 + 288LL))(v8);
      if ( v15 < 0 )
        wil::details::in1diag3::FailFast_Hr(
          retaddr,
          (void *)0xBF19,
