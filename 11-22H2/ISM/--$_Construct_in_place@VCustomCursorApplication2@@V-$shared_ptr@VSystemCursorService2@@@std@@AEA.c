/*
 * XREFs of ??$_Construct_in_place@VCustomCursorApplication2@@V?$shared_ptr@VSystemCursorService2@@@std@@AEAIAEAPEAVBamoCustomCursorControllerClient2Proxy@@@std@@YAXAEAVCustomCursorApplication2@@$$QEAV?$shared_ptr@VSystemCursorService2@@@0@AEAIAEAPEAVBamoCustomCursorControllerClient2Proxy@@@Z @ 0x18010F608
 * Callers:
 *     ??$make_shared@VCustomCursorApplication2@@V?$shared_ptr@VSystemCursorService2@@@std@@AEAIAEAPEAVBamoCustomCursorControllerClient2Proxy@@@std@@YA?AV?$shared_ptr@VCustomCursorApplication2@@@0@$$QEAV?$shared_ptr@VSystemCursorService2@@@0@AEAIAEAPEAVBamoCustomCursorControllerClient2Proxy@@@Z @ 0x18010F87C (--$make_shared@VCustomCursorApplication2@@V-$shared_ptr@VSystemCursorService2@@@std@@AEAIAEAPEAV.c)
 * Callees:
