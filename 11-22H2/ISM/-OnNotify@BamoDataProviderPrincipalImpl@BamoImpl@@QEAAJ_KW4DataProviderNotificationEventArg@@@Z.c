/*
 * XREFs of ?OnNotify@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_KW4DataProviderNotificationEventArg@@@Z @ 0x18011F3EC
 * Callers:
 *     ?Thunk_OnNotify_8@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180122130 (-Thunk_OnNotify_8@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SA.c)
 * Callees:
