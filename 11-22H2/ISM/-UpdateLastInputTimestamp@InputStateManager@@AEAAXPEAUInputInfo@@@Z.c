/*
 * XREFs of ?UpdateLastInputTimestamp@InputStateManager@@AEAAXPEAUInputInfo@@@Z @ 0x1800DB828
 * Callers:
 ...
 *     ?TranslateInputType@InputStateManager@@AEAA?AW4_LINP_SOURCE@@W4InputType@@@Z @ 0x1800DB7D4 (-TranslateInputType@InputStateManager@@AEAA-AW4_LINP_SOURCE@@W4InputType@@@Z.c)
 */
...
void __fastcall InputStateManager::UpdateLastInputTimestamp(InputStateManager *this, struct InputInfo *a2)
{
  ...
  v9 = ((*(_DWORD *)a2 & *((_DWORD *)this + 48)) != 0 ? 3 : 1) | 4;
  if ( (*(_DWORD *)a2 & *((_DWORD *)this + 49)) == 0 )
    v9 = (*(_DWORD *)a2 & *((_DWORD *)this + 48)) != 0 ? 3 : 1;
  if ( *((_BYTE *)a2 + 49) )
  {
    v9 &= ~1u;
  }
