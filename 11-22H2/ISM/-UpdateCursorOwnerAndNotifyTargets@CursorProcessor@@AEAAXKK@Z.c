/*
 * XREFs of ?UpdateCursorOwnerAndNotifyTargets@CursorProcessor@@AEAAXKK@Z @ 0x180167818
 * Callers:
 ...
 *     ?GenerateCursorOwnerMessage@CursorProcessor@@AEAAXKUCursorId@@_N@Z @ 0x1801671BC (-GenerateCursorOwnerMessage@CursorProcessor@@AEAAXKUCursorId@@_N@Z.c)
 */
