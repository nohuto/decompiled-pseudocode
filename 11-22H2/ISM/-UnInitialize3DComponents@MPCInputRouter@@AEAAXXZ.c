/*
 * XREFs of ?UnInitialize3DComponents@MPCInputRouter@@AEAAXXZ @ 0x180119508
 * Callers:
...
void __fastcall MPCInputRouter::UnInitialize3DComponents(MPCInputRouter *this)
{
  ...
  if ( *((_BYTE *)this + 872) )
  {
    std::_Hash<std::_Umap_traits<unsigned __int64,IMPCTarget *,std::_Uhash_compare<unsigned __int64,std::hash<unsigned __int64>,std::equal_to<unsigned __int64>>,std::allocator<std::pair<unsigned __int64 const,IMPCTarget *>>,0>>::clear((char *)this + 912);
    ...
    *((_BYTE *)this + 872) = 0;
    *((_BYTE *)this + 880) = 0;
    _InterlockedExchange((volatile __int32 *)this + 221, 0);
    _InterlockedExchange64((volatile __int64 *)this + 111, 0LL);
