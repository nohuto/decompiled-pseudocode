/*
 * XREFs of ?UpdateGestureDirection@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NPEBUD2D_VECTOR_2F@@@Z @ 0x1801795B0
 * Callers:
 *     ?Thunk_UpdateGestureDirection_170@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180179500 (-Thunk_UpdateGestureDirection_170@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClient.c)
