/*
 * XREFs of ?UpdateCoordinateSystemForTick@MPCSpatialGestureRecognizerHandler@@AEAAJ_J@Z @ 0x1800D41E4
 * Callers:
 ...
 *     ??4?$ComPtr@UISpatialCoordinateSystem@Spatial@Perception@Windows@@@WRL@Microsoft@@QEAAAEAV012@AEBV012@@Z @ 0x1800D1B64 (--4-$ComPtr@UISpatialCoordinateSystem@Spatial@Perception@Windows@@@WRL@Microsoft@@QEAAAEAV012@AE.c)
 */
