/*
 * XREFs of ??1?$_Tree_head_scoped_ptr@V?$allocator@U?$_Tree_node@V?$shared_ptr@UHotKeyInfo@@@std@@PEAX@std@@@std@@V?$_Tree_val@U?$_Tree_simple_types@V?$shared_ptr@UHotKeyInfo@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1801FD8FC
 * Callers:
 ...
 *     _HotKeyProcessor::DetectAndProcessHotKey_::_1_::dtor$19 @ 0x1800791EA (_HotKeyProcessor--DetectAndProcessHotKey_--_1_--dtor$19.c)
 * Callees:
