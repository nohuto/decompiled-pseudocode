/*
 * XREFs of ?GetDropTargetClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDropTargetClientProxy@@XZ @ 0x1800121D0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoDropTargetClientProxy *)*((_QWORD *)this + 21);
}
