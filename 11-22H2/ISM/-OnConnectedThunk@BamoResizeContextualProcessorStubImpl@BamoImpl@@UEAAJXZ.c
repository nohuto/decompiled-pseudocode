/*
 * XREFs of ?OnConnectedThunk@BamoResizeContextualProcessorStubImpl@BamoImpl@@UEAAJXZ @ 0x1800189F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoResizeContextualProcessorStubImpl::OnConnectedThunk(
