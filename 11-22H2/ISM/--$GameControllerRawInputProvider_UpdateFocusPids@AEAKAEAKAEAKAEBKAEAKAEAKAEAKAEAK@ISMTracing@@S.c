/*
 * XREFs of ??$GameControllerRawInputProvider_UpdateFocusPids@AEAKAEAKAEAKAEBKAEAKAEAKAEAKAEAK@ISMTracing@@SAXAEAK00AEBK0000@Z @ 0x180060758
 * Callers:
        ...
        unsigned int *a8)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)a1) )
  {
    ...
    ISMTracing::GameControllerRawInputProvider_UpdateFocusPids_(v13, a1, a2, a3, a4, a5, a6, a7, a8);
  }
}
