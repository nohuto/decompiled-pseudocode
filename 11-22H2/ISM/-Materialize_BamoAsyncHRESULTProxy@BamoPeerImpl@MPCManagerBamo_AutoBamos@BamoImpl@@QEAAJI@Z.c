/*
 * XREFs of ?Materialize_BamoAsyncHRESULTProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800C2004
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncHRESULTProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800C45E0 (-Thunk_Materialize_BamoAsyncHRESULTProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPe.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  *v15 = &BamoAsyncHRESULTProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v15[1] = &BamoAsyncHRESULTProxy::`vftable'{for `IAsyncHRESULTProxy'};
  *((_DWORD *)v15 + 6) = 0;
  v15[4] = 0LL;
  *((_DWORD *)v15 + 10) = 0;
  *((_DWORD *)v15 + 11) = 0;
  v15[2] = &BamoImpl::BamoAsyncHRESULTProxyImpl::`vftable';
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    v13,
    v5,
    v6,
