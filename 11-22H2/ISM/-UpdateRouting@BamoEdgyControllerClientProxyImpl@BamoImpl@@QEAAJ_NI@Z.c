/*
 * XREFs of ?UpdateRouting@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180179858
 * Callers:
 *     ?Thunk_UpdateRouting_8@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180179540 (-Thunk_UpdateRouting_8@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@B.c)
