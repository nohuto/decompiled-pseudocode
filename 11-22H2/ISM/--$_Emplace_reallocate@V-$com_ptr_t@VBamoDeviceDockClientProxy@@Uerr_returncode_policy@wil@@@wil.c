/*
 * XREFs of ??$_Emplace_reallocate@V?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@@?$vector@V?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAAPEAV?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@QEAV23@$$QEAV23@@Z @ 0x1801A933C
 * Callers:
...
__int64 *__fastcall std::vector<wil::com_ptr_t<BamoDeviceDockClientProxy,wil::err_returncode_policy>>::_Emplace_reallocate<wil::com_ptr_t<BamoDeviceDockClientProxy,wil::err_returncode_policy>>(
        __int64 **a1,
        __int64 *a2,
        __int64 *a3)
{
