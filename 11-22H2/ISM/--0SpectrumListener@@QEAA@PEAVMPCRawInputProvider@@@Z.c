/*
 * XREFs of ??0SpectrumListener@@QEAA@PEAVMPCRawInputProvider@@@Z @ 0x1800DF184
 * Callers:
...
SpectrumListener *__fastcall SpectrumListener::SpectrumListener(SpectrumListener *this, struct MPCRawInputProvider *a2)
{
  ...
  int v22[4]; // [rsp+20h] [rbp-88h]
  SpeechRuntimeListener *v23; // [rsp+20h] [rbp-88h]
  SpectrumListener *v24; // [rsp+30h] [rbp-78h] BYREF
  SpectrumListener *v25; // [rsp+38h] [rbp-70h] BYREF
  ...
  *((_QWORD *)this + 2) = a2;
  v5 = (char *)this + 24;
  *((_QWORD *)this + 3) = 0LL;
  v6 = (SpectrumListener **)((char *)this + 32);
  *((_QWORD *)this + 4) = 0LL;
  *((_QWORD *)this + 5) = 0LL;
  *((_QWORD *)this + 6) = 0LL;
  *((_QWORD *)this + 7) = 0LL;
  ...
  *(_QWORD *)v22 = SpectrumListener::OnPhraseDetected;
  ...
  if ( v17 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v12);
  v23 = (SpeechRuntimeListener *)operator new(0x58uLL);
  v18 = SpeechRuntimeListener::SpeechRuntimeListener(v23, a2, *((_DWORD *)this + 20));
  if ( v6 == &v24 )
  {
    if ( v18 )
    {
