/*
 * XREFs of ?GetGamepadInterceptionEnabled@BamoInputDelegationInputObjectProxy@@UEAA_NXZ @ 0x1800719D0
 * Callers:
...
bool __fastcall BamoInputDelegationInputObjectProxy::GetGamepadInterceptionEnabled(
