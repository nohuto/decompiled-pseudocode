/*
 * XREFs of ?OnDeviceAttach@PenDeviceCollection@@MEAAJKPEAPEAUDeviceInfo@@@Z @ 0x1800F3990
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$com_ptr_t@VPenDeviceManager@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVPenDeviceManager@@@Z @ 0x1800F3870 (--4-$com_ptr_t@VPenDeviceManager@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVPenDeviceMana.c)
