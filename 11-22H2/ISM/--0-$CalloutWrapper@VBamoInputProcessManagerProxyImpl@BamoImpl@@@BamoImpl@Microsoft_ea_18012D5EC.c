/*
 * XREFs of ??0?$CalloutWrapper@VBamoInputProcessManagerProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputProcessManagerProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18012D5EC
 * Callers:
