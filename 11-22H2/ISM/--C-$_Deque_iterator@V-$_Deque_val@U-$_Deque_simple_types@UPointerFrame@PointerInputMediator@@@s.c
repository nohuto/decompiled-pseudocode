/*
 * XREFs of ??C?$_Deque_iterator@V?$_Deque_val@U?$_Deque_simple_types@UPointerFrame@PointerInputMediator@@@std@@@std@@@std@@QEBAPEAUPointerFrame@PointerInputMediator@@XZ @ 0x18010B8F0
 * Callers:
