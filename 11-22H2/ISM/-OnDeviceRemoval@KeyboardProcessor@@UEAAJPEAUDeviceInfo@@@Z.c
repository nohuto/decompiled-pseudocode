/*
 * XREFs of ?OnDeviceRemoval@KeyboardProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x1801BF530
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OnKeyPress@KeyboardProcessorTelemetry@@QEAAX_N@Z @ 0x1801BFBD8 (-OnKeyPress@KeyboardProcessorTelemetry@@QEAAX_N@Z.c)
 */
