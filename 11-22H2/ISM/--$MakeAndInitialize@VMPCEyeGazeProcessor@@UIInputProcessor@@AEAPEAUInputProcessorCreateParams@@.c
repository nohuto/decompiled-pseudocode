/*
 * XREFs of ??$MakeAndInitialize@VMPCEyeGazeProcessor@@UIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Details@WRL@Microsoft@@YAJPEAPEAUIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Z @ 0x1801F60AC
 * Callers:
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v5 + 3664) = 0;
    v11 = v5;
    v10 = 0LL;
    v6 = MPCEyeGazeProcessor::RuntimeClassInitialize((MPCEyeGazeProcessor *)v5, *a2);
    if ( v6 >= 0 )
    {
    ...
    Microsoft::WRL::ComPtr<MPCHandProcessor>::~ComPtr<MPCHandProcessor>(&v11, v7);
  }
  else
  {
    v6 = -2147024882;
