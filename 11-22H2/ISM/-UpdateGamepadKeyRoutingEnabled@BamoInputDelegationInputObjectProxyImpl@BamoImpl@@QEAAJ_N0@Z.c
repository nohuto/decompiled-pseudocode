/*
 * XREFs of ?UpdateGamepadKeyRoutingEnabled@BamoInputDelegationInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180072204
 * Callers:
 *     ?Thunk_UpdateGamepadKeyRoutingEnabled_11@?$IInputDelegationInputObjectProxy_Receive@VBamoInputDelegationInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800720A0 (-Thunk_UpdateGamepadKeyRoutingEnabled_11@-$IInputDelegationInputObjectProxy_Receive@VBamoInputDe.c)
