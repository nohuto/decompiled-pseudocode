/*
 * XREFs of ?UpdateStartPosition@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagPOINT@@@Z @ 0x1801A2058
 * Callers:
 *     ?Thunk_UpdateStartPosition_23@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801A16D0 (-Thunk_UpdateStartPosition_23@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigati.c)
