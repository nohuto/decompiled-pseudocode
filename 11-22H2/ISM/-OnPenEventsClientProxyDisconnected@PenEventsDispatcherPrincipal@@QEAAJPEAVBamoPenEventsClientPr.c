/*
 * XREFs of ?OnPenEventsClientProxyDisconnected@PenEventsDispatcherPrincipal@@QEAAJPEAVBamoPenEventsClientProxy@@@Z @ 0x1801BD0F0
 * Callers:
        ...
        struct BamoPenEventsClientProxy *a2)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1802374A6, 0LL, 0LL, 2u, &v9);
  }
