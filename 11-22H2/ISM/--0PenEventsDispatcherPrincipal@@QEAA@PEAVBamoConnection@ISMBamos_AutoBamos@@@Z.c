/*
 * XREFs of ??0PenEventsDispatcherPrincipal@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z @ 0x180038EA4
 * Callers:
  ...
  if ( IsEdition(0x224AuLL) )
  {
    ...
    if ( v4 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v16);
    hstringHeader.Reserved.Reserved1 = off_180206EB0;
