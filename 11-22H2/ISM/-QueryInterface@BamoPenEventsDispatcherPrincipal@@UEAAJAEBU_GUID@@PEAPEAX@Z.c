/*
 * XREFs of ?QueryInterface@BamoPenEventsDispatcherPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801BD900
 * Callers:
 *     ?QueryInterface@BamoPenEventsDispatcherPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007D950 (-QueryInterface@BamoPenEventsDispatcherPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
