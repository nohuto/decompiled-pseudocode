/*
 * XREFs of ?Initialize3DComponents@MPCGamepadProcessor@@UEAAXXZ @ 0x1801F0BF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$make_unique@VMPCButtonHoldHelper@@AEBM$0A@@std@@YA?AV?$unique_ptr@VMPCButtonHoldHelper@@U?$default_delete@VMPCButtonHoldHelper@@@std@@@0@AEBM@Z @ 0x1801E97B8 (--$make_unique@VMPCButtonHoldHelper@@AEBM$0A@@std@@YA-AV-$unique_ptr@VMPCButtonHoldHelper@@U-$de.c)
...
void __fastcall MPCGamepadProcessor::Initialize3DComponents(MPCGamepadProcessor *this)
{
  ...
  v6 = (__int64 *)std::make_unique<MPCButtonHoldHelper,float const &,0>(&fPending, &flt_18024018C);
  ...
  v8 = (__int64 *)std::make_unique<MPCButtonHoldHelper,float const &,0>(&fPending, &flt_18024018C);
