/*
 * XREFs of ?OnMessage@BamoWindowsMessageDeliveryProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x1800186A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoWindowsMessageDeliveryProxyImpl::OnMessage(
        ...
        const void *a2)
{
  ...
  v2 = CoreUICallReceive(
         *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 80LL),
         &IWindowsMessageDeliveryProxy_Receive<BamoImpl::BamoWindowsMessageDeliveryProxyImpl>::Type,
