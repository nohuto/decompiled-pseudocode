/*
 * XREFs of ?ProcessDeviceRemoval@Win32kInterop@InputETW@@SAXK@Z @ 0x180108B94
 * Callers:
...
void __fastcall InputETW::Win32kInterop::ProcessDeviceRemoval(__int64 a1)
{
  ...
  if ( InputETW::IsEnabled(a1) )
  {
    ...
    if ( *(_DWORD *)v3 > 5u && (*(_BYTE *)(v3 + 16) & 1) != 0 && (*(_QWORD *)(v3 + 24) & 1LL) == *(_QWORD *)(v3 + 24) )
    {
      ...
      v4 = v1;
      v7 = 8;
      tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_180233C2D, 0LL, 0LL, 3u, &v5);
    }
  }
}
