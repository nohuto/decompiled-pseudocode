/*
 * XREFs of ?DisableHeadEventHandler@SpatialRimDeviceCollection@@AEAAXXZ @ 0x1800E74A4
 * Callers:
 ...
 *     ?HeadEventHandlerDisabled_@RawInputProvidersTracing@@QEAAXXZ @ 0x1800E817C (-HeadEventHandlerDisabled_@RawInputProvidersTracing@@QEAAXXZ.c)
