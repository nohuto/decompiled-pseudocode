/*
 * XREFs of ?UnregisterClient@ShellGesturesProcessor@@SAXPEAVShellGesturesClientProxy@@@Z @ 0x18017DF78
 * Callers:
 *     ?OnDisconnected@ShellGesturesClientProxy@@MEAAJXZ @ 0x18017BDB0 (-OnDisconnected@ShellGesturesClientProxy@@MEAAJXZ.c)
 * Callees:
...
void __fastcall ShellGesturesProcessor::UnregisterClient(unsigned __int64 a1)
{
  ...
  if ( (_QWORD)ShellGesturesProcessor::s_clients )
    ...
    v3 = 0LL;
  while ( v1 != *((_QWORD *)&xmmword_180278530 + 1) + qword_180278540 )
  {
    a1 = v1 & 1;
