/*
 * XREFs of ?Get@EdgyConnection@@SAPEAV1@XZ @ 0x180037748
 * Callers:
 ...
 * Callees:
 *     ??4?$ComPtr@VEdgyConnection@@@WRL@Microsoft@@QEAAAEAV012@PEAVEdgyConnection@@@Z @ 0x180036AE8 (--4-$ComPtr@VEdgyConnection@@@WRL@Microsoft@@QEAAAEAV012@PEAVEdgyConnection@@@Z.c)
...
struct EdgyConnection *EdgyConnection::Get(void)
{
  ...
  if ( !EdgyConnection::s_spThis )
  {
    ...
    Microsoft::WRL::ComPtr<EdgyConnection>::operator=((__int64)v2, (__int64)v1);
