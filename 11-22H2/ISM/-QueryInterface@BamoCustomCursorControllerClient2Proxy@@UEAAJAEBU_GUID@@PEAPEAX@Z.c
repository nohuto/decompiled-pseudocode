/*
 * XREFs of ?QueryInterface@BamoCustomCursorControllerClient2Proxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013C580
 * Callers:
 *     ?QueryInterface@BamoCustomCursorControllerClient2Proxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007AF90 (-QueryInterface@BamoCustomCursorControllerClient2Proxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
