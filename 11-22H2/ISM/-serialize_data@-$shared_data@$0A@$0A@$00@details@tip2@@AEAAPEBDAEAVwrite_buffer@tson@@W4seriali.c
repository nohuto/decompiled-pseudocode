/*
 * XREFs of ?serialize_data@?$shared_data@$0A@$0A@$00@details@tip2@@AEAAPEBDAEAVwrite_buffer@tson@@W4serialize_options@23@@Z @ 0x18006CD10
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( (a3 & 4) != 0 && *v6 )
    {
      ...
      v13 = 7;
      v14 = v6;
      tson::output_archive::operator()<tson::nvp<unsigned char &>>((__int64)v22, (__int64 *)&v12, v7);
    }
    if ( (a3 & 1) != 0 )
    {
    ...
    (*(void (__fastcall **)(_QWORD, _BYTE *, _QWORD))(*(_QWORD *)*a1 + 8LL))(*a1, v22, a3);
