/*
 * XREFs of ?Materialize_BamoActivationControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18000B738
 * Callers:
 *     ?Thunk_Materialize_BamoActivationControllerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000B570 (-Thunk_Materialize_BamoActivationControllerProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)v15 + 4) = 0LL;
  *((_QWORD *)v15 + 5) = 0LL;
  *((_QWORD *)v15 + 2) = &BamoImpl::BamoActivationControllerProxyImpl::`vftable';
  *((_BYTE *)v15 + 48) = 0;
  *((_QWORD *)v15 + 7) = 0LL;
  *((_QWORD *)v15 + 8) = 0LL;
  *((_QWORD *)v15 + 9) = 0LL;
  *(_QWORD *)v15 = &ActivationControllerBamoProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v15 + 1) = &ActivationControllerBamoProxy::`vftable'{for `IActivationControllerProxy'};
