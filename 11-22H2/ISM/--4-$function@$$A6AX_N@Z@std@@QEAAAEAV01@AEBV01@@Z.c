/*
 * XREFs of ??4?$function@$$A6AX_N@Z@std@@QEAAAEAV01@AEBV01@@Z @ 0x18003F47C
 * Callers:
...
__int64 __fastcall std::function<void (bool)>::operator=(__int64 a1)
{
  ...
  {
    v7 = 0LL;
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Reset_move(v6, v2);
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Reset_move(v2, a1);
    std::_Func_class<void,_MIT_INPUT_INTEROP_MESSAGE const *>::_Reset_move(a1, v6);
