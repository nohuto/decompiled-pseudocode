/*
 * XREFs of ?UnregisterProcess@InputProcessManager@InputTraceLogging@@SAXPEBX@Z @ 0x1801C2440
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessManager::UnregisterProcess(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = a1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_18023785D, 0LL, 0LL, 3u, &v4);
  }
}
