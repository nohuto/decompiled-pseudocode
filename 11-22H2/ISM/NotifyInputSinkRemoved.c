/*
 * XREFs of NotifyInputSinkRemoved @ 0x1800AA880
 * Callers:
 *     <none>
 * Callees:
 *     ?GetInstance@InputSinkDataCache@@SAAEAV1@XZ @ 0x180009D90 (-GetInstance@InputSinkDataCache@@SAAEAV1@XZ.c)
 *     _anonymous_namespace_::GetLuidFromInputSinkHandle @ 0x1800AA440 (_anonymous_namespace_--GetLuidFromInputSinkHandle.c)
