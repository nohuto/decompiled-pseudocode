/*
 * XREFs of ??1?$vector@U?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@V?$allocator@U?$pair@KV?$ComPtr@UIRawInputProvider@@@WRL@Microsoft@@@std@@@2@@std@@QEAA@XZ @ 0x18006058C
 * Callers:
 ...
 *     _InputStateManager::SendDeviceCommand_::_1_::dtor$0 @ 0x1800DB7B4 (_InputStateManager--SendDeviceCommand_--_1_--dtor$0.c)
 * Callees:
