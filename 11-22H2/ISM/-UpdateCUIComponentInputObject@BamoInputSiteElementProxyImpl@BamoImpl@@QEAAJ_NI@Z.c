/*
 * XREFs of ?UpdateCUIComponentInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010DB0
 * Callers:
 *     ?Thunk_UpdateCUIComponentInputObject_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A500 (-Thunk_UpdateCUIComponentInputObject_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementPro.c)
