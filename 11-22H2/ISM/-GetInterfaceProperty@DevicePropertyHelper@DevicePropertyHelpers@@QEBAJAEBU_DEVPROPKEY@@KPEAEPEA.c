/*
 * XREFs of ?GetInterfaceProperty@DevicePropertyHelper@DevicePropertyHelpers@@QEBAJAEBU_DEVPROPKEY@@KPEAEPEAK@Z @ 0x1800E7F08
 * Callers:
 ...
 *     DevicePropertyHelpers::MapCrToHResult @ 0x1800E87D0 (DevicePropertyHelpers--MapCrToHResult.c)
 */
