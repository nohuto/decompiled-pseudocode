/*
 * XREFs of ?CancelResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x180170310
 * Callers:
 *     ?Thunk_CancelResize_19@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180170AF0 (-Thunk_CancelResize_19@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProces.c)
 * Callees:
