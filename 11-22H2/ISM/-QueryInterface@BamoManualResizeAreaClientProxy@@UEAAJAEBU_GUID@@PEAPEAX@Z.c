/*
 * XREFs of ?QueryInterface@BamoManualResizeAreaClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18016FF60
 * Callers:
 *     ?QueryInterface@BamoManualResizeAreaClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007BB50 (-QueryInterface@BamoManualResizeAreaClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
