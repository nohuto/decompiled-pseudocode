/*
 * XREFs of ?UpdateDeviceDockServerRemoteCache@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x18014AB14
 * Callers:
 ...
 *     ?UpdateDeviceDockServerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x18014ABEC (-UpdateDeviceDockServerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubI.c)
 * Callees:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::UpdateDeviceDockServerRemoteCache(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 64LL) )
  {
    ...
    if ( v4 < 0 || (v6[0] = v8, v6[1] = v9, LOWORD(v5) = 2, v4 = CoreUICallSend(v10, v6, 2LL, 59LL), v4 < 0) )
    {
      if ( v4 != -2018375675 )
