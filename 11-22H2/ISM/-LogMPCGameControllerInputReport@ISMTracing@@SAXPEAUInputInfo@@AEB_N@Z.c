/*
 * XREFs of ?LogMPCGameControllerInputReport@ISMTracing@@SAXPEAUInputInfo@@AEB_N@Z @ 0x1800D6140
 * Callers:
...
void __fastcall ISMTracing::LogMPCGameControllerInputReport(struct InputInfo *a1, const bool *a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u && (*(_BYTE *)(v4 + 16) & 1) != 0 && (*(_QWORD *)(v4 + 24) & 1LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v14 = 4LL;
    v12 = 4LL;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1802312EB, 0LL, 0LL, 7u, &v10);
  }
}
