/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoMPCManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800C3070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCManagerStubImpl::OnPropertiesRefreshedThunk(
        BamoImpl::BamoMPCManagerStubImpl *this,
        __int64 a2,
        __int64 a3)
{
  unsigned int v4; // ebx
