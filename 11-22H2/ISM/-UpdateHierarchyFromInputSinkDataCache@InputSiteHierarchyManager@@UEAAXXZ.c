/*
 * XREFs of ?UpdateHierarchyFromInputSinkDataCache@InputSiteHierarchyManager@@UEAAXXZ @ 0x1800209E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Unchecked_erase@?$_Hash@V?$_Umap_traits@_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@V?$_Uhash_compare@_KU?$hash@_K@std@@U?$equal_to@_K@2@@std@@V?$allocator@U?$pair@$$CB_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@@std@@@4@$0A@@std@@@std@@AEAAPEAU?$_List_node@U?$pair@$$CB_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@@std@@PEAX@2@PEAU32@@Z @ 0x18014CA44 (-_Unchecked_erase@-$_Hash@V-$_Umap_traits@_KUInputSiteHierarchyEntry@InputSiteHierarchyManager@@.c)
...
void __fastcall InputSiteHierarchyManager::UpdateHierarchyFromInputSinkDataCache(InputSiteHierarchyManager *this)
{
  ...
  v3 = *((_QWORD *)&xmmword_180277AA0 + 1);
  v65 = *((_QWORD *)&xmmword_180277AA0 + 1);
  v4 = (char *)qword_180277A98;
  v64 = (char *)qword_180277A98;
  qword_180277A98 = 0LL;
  v67 = v64;
  v68 = 0LL;
  v69 = *((_QWORD *)&xmmword_180277AA0 + 1);
  xmmword_180277AA0 = 0uLL;
