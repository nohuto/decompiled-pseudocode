/*
 * XREFs of ?OnInputReport@ButtonProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x1801E5EE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z @ 0x1801E5A54 (-ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z.c)
