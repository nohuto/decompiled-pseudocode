/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_UxConfTest@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18005C7B0
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_UxConfTest@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18005FC64 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_UxConfTest@@@details@wil@@QEAAX_NW4Report.c)
 * Callees:
