/*
 * XREFs of ?DockDeviceDetached@DeviceDock@InputTraceLogging@@SAXK@Z @ 0x1800F10AC
 * Callers:
...
void __fastcall InputTraceLogging::DeviceDock::DockDeviceDetached(__int64 a1)
{
  int v1; // ebx
  __int64 v2; // rcx
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = v1;
    v6 = 4;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180232C5C, 0LL, 0LL, 3u, &v4);
  }
}
