/*
 * XREFs of ??1?$test_watcher@V?$merged_data@U_tip_GamepadInterceptionUsageTipTest_attributes@@Vtest_data_basic@tip2@@@details@tip2@@@tip2@@QEAA@XZ @ 0x18006A240
 * Callers:
 ...
 *     _GamepadInterceptionHelper::InterceptGamepadInput_::_1_::dtor$0 @ 0x18006A98C (_GamepadInterceptionHelper--InterceptGamepadInput_--_1_--dtor$0.c)
 * Callees:
...
void __fastcall tip2::test_watcher<tip2::details::merged_data<_tip_GamepadInterceptionUsageTipTest_attributes,tip2::test_data_basic>>::~test_watcher<tip2::details::merged_data<_tip_GamepadInterceptionUsageTipTest_attributes,tip2::test_data_basic>>(
        __int64 a1)
{
  wil::com_ptr_t<tip2::details::merged_data<_tip_GamepadInterceptionUsageTipTest_attributes,tip2::test_data_basic>,wil::err_returncode_policy>::~com_ptr_t<tip2::details::merged_data<_tip_GamepadInterceptionUsageTipTest_attributes,tip2::test_data_basic>,wil::err_returncode_policy>((void **)(a1 + 48));
