/*
 * XREFs of ?Create@SystemButtonProcessor@@SAJPEAPEAV1@@Z @ 0x180037B60
 * Callers:
 ...
 *     ??1?$unique_ptr@VSystemButtonProcessor@@U?$default_delete@VSystemButtonProcessor@@@std@@@std@@QEAA@XZ @ 0x1801E0970 (--1-$unique_ptr@VSystemButtonProcessor@@U-$default_delete@VSystemButtonProcessor@@@std@@@std@@QE.c)
 */
