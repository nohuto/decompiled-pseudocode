        ...
        const unsigned __int8 *a2)
{
  ...
  if ( !v5 )
    return 0LL;
  v7 = qword_1802784F8;
  v8 = 2 * (v6 & qword_180278510);
  if ( *(_QWORD **)(qword_1802784F8 + 16 * (v6 & qword_180278510) + 8) == v5 )
  {
    if ( *(_QWORD **)(qword_1802784F8 + 16 * (v6 & qword_180278510)) == v5 )
    {
      v9 = qword_1802784E8;
      *(_QWORD *)(qword_1802784F8 + 16 * (v6 & qword_180278510)) = qword_1802784E8;
    }
    else
    {
      v9 = v5[1];
  ...
  else if ( *(_QWORD **)(qword_1802784F8 + 16 * (v6 & qword_180278510)) == v5 )
  {
    *(_QWORD *)(qword_1802784F8 + 16 * (v6 & qword_180278510)) = *v5;
  }
  v10 = *v5;
  --qword_1802784F0;
  *(_QWORD *)v5[1] = v10;
