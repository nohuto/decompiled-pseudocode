/*
 * XREFs of ??0HotKeyProcessor@@QEAA@XZ @ 0x1801FD574
 * Callers:
...
HotKeyProcessor *__fastcall HotKeyProcessor::HotKeyProcessor(HotKeyProcessor *this)
{
  ...
  *((_WORD *)v7 + 12) = 257;
  v9[0] = v7;
  *(_OWORD *)v11 = 0LL;
  std::shared_ptr<SystemCursor2>::operator=((_QWORD *)this + 40, (__int64 *)v11);
  if ( v11[1] )
