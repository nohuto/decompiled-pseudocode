/*
 * XREFs of ??$TryCastToInterface@V?$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@@?$InterfaceIterator@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@?$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@SAPEAXPEAV1@AEBU_GUID@@@Z @ 0x18006D63C
 * Callers:
