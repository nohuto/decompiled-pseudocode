/*
 * XREFs of ?UnregisterGestureDragClient@BamoGestureServicesProxyImpl@BamoImpl@@QEAAJ_KPEAVBamoDragManagerClientPrincipal@@@Z @ 0x18014245C
 * Callers:
  ...
  else
  {
    if ( a3 )
      Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteReference(
        ...
        a3);
    v9 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(this, v16, &v20, &v21);
    v10 = v9;
    if ( v9 >= 0 )
    {
      v11 = *((_BYTE *)this + 31) == 0;
      ...
      return CoreUICallSend(v12, v16, 2LL, 41LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
