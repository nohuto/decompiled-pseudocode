        ...
        _QWORD **a2)
{
  ...
  *a2[1] = 0LL;
  ...
  if ( *a2 )
  {
    ...
    {
      v3 = (_QWORD *)*v2;
      wil::com_ptr_t<BamoSimpleHapticsControllerProxy,wil::err_returncode_policy>::~com_ptr_t<BamoSimpleHapticsControllerProxy,wil::err_returncode_policy>(v2 + 3);
