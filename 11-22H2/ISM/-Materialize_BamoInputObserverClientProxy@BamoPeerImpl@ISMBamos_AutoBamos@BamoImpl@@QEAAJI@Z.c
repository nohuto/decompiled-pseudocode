/*
 * XREFs of ?Materialize_BamoInputObserverClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180135564
 * Callers:
 *     ?Thunk_Materialize_BamoInputObserverClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141670 (-Thunk_Materialize_BamoInputObserverClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPe.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  struct BamoInputObserverClientProxy *v18; // [rsp+60h] [rbp+8h] BYREF
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*((_QWORD *)this + 3) + 32LL),
    a3,
    0LL);
  v6 = CreateInputObserverClientProxy(v5, &v18);
  if ( v6 < 0 )
  ...
  if ( !v18 )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      (int)"onecoreuap\\windows\\moderncore\\inputv2\\Bamos\\codegen\\system\\objfre\\amd64\\ISMBamos.ISMBamos.bamo.h",
      v10);
  v11 = (*(__int64 (__fastcall **)(struct BamoInputObserverClientProxy *))(*(_QWORD *)v18 + 56LL))(v18);
