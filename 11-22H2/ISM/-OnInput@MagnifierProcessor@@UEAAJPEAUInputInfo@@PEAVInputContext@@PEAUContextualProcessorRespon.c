/*
 * XREFs of ?OnInput@MagnifierProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801DBA20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Active@MagnifierRecognizer@@QEAA_NXZ @ 0x1801DBF04 (-Active@MagnifierRecognizer@@QEAA_NXZ.c)
