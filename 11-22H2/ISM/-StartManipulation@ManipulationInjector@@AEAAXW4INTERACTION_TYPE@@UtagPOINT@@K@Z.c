/*
 * XREFs of ?StartManipulation@ManipulationInjector@@AEAAXW4INTERACTION_TYPE@@UtagPOINT@@K@Z @ 0x18012B5FC
 * Callers:
 ...
 *     ?ValidateInjectionRectForPanZoom@ManipulationInjector@@QEAAXXZ @ 0x18012BCB8 (-ValidateInjectionRectForPanZoom@ManipulationInjector@@QEAAXXZ.c)
 */
