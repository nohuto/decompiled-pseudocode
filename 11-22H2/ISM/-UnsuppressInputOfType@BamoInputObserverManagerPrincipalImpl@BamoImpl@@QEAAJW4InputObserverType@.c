/*
 * XREFs of ?UnsuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x18015653C
 * Callers:
 *     ?Thunk_UnsuppressInputOfType_258@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072460 (-Thunk_UnsuppressInputOfType_258@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverMana.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( *(int *)(a1 + 8) > 0 )
  {
    ...
    v20 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, char *))(*(_QWORD *)(a1 - 16) + 120LL))(
            a1 - 16,
            v24,
            a2,
            v15);
