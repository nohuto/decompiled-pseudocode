/*
 * XREFs of ?UpdateActuationClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010F50
 * Callers:
 *     ?Thunk_UpdateActuationClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A540 (-Thunk_UpdateActuationClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@B.c)
