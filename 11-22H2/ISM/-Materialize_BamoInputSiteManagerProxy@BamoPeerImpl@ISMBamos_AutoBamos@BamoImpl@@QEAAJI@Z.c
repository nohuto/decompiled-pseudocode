/*
 * XREFs of ?Materialize_BamoInputSiteManagerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180135900
 * Callers:
 *     ?Thunk_Materialize_BamoInputSiteManagerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801416F0 (-Thunk_Materialize_BamoInputSiteManagerProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerI.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v10 = &BamoInputSiteManagerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v10[1] = &BamoInputSiteManagerProxy::`vftable'{for `IInputSiteManagerProxy'};
  *((_DWORD *)v10 + 6) = 0;
  v10[4] = 0LL;
  *((_DWORD *)v10 + 10) = 0;
  *((_DWORD *)v10 + 11) = 0;
  v10[2] = &BamoImpl::BamoInputSiteManagerProxyImpl::`vftable';
