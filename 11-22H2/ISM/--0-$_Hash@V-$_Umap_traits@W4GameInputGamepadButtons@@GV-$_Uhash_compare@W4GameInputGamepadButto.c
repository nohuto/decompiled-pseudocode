/*
 * XREFs of ??0?$_Hash@V?$_Umap_traits@W4GameInputGamepadButtons@@GV?$_Uhash_compare@W4GameInputGamepadButtons@@U?$hash@W4GameInputGamepadButtons@@@std@@U?$equal_to@W4GameInputGamepadButtons@@@3@@std@@V?$allocator@U?$pair@$$CBW4GameInputGamepadButtons@@G@std@@@3@$0A@@std@@@std@@IEAA@AEBV?$_Uhash_compare@W4GameInputGamepadButtons@@U?$hash@W4GameInputGamepadButtons@@@std@@U?$equal_to@W4GameInputGamepadButtons@@@3@@1@AEBV?$allocator@U?$pair@$$CBW4GameInputGamepadButtons@@G@std@@@1@@Z @ 0x18003A5A8
 * Callers:
        ...
        int *a2)
{
  ...
  *v3 = v3;
  v3[1] = v3;
  qword_180278558 = (__int64)v3;
  qword_180278568 = 0LL;
  xmmword_180278570 = 0LL;
  qword_180278580 = 7LL;
  qword_180278588 = 8LL;
