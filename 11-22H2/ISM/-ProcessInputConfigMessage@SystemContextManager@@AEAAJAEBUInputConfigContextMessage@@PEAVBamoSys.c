/*
 * XREFs of ?ProcessInputConfigMessage@SystemContextManager@@AEAAJAEBUInputConfigContextMessage@@PEAVBamoSystemContextEndpointProxy@@@Z @ 0x18015D034
 * Callers:
 ...
 *     ?_Reallocate_exactly@?$vector@PEAVBamoInputSpacePayloadPrincipal@@V?$allocator@PEAVBamoInputSpacePayloadPrincipal@@@std@@@std@@AEAAX_K@Z @ 0x18015FA9C (-_Reallocate_exactly@-$vector@PEAVBamoInputSpacePayloadPrincipal@@V-$allocator@PEAVBamoInputSpac.c)
        ...
        __int64 a4)
{
  ...
  if ( *(_DWORD *)a2 )
  {
    std::vector<wil::com_ptr_t<BamoInputSpacePayloadPrincipal,wil::err_exception_policy>>::_Reallocate_exactly(&v33);
    v6 = v34;
  }
  v31 = 0LL;
  v7 = 0LL;
  ...
  if ( *(_DWORD *)a2 )
  {
    std::vector<BamoInputSpacePayloadPrincipal *>::_Reallocate_exactly(&v31);
    v7 = v32;
  }
  v8 = *(unsigned int *)a2;
  v9 = *((_QWORD *)a2 + 1);
  gsl::details::extent_type<-1>::extent_type<-1>(&v30, v8, (__int64)a3, a4);
  ...
  else
  {
    ...
    if ( v21 )
      std::_Deallocate<16,0>(v21, 8 * ((v7 - (_BYTE *)v21) >> 3));
    v27 = (void *)v33;
    if ( (_QWORD)v33 )
    {
