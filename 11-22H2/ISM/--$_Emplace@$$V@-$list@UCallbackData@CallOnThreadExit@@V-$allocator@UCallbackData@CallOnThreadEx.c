/*
 * XREFs of ??$_Emplace@$$V@?$list@UCallbackData@CallOnThreadExit@@V?$allocator@UCallbackData@CallOnThreadExit@@@std@@@std@@QEAAPEAU?$_List_node@UCallbackData@CallOnThreadExit@@PEAX@1@QEAU21@@Z @ 0x18014E980
 * Callers:
...
_QWORD *__fastcall std::list<CallOnThreadExit::CallbackData>::_Emplace<>(__int64 a1, __int64 a2)
{
  ...
  if ( *((_QWORD *)&xmmword_1802784D0 + 1) == 0x2AAAAAAAAAAAAAALL )
  ...
  std::_List_node_emplace_op2<std::allocator<std::_List_node<CallOnThreadExit::CallbackData,void *>>>::_List_node_emplace_op2<std::allocator<std::_List_node<CallOnThreadExit::CallbackData,void *>>>(
    &v6,
    (__int64)&xmmword_1802784D0);
  ++*((_QWORD *)&xmmword_1802784D0 + 1);
  v3 = *(_QWORD **)(a2 + 8);
  *v7 = a2;
  v7[1] = v3;
  v4 = v7;
