/*
 * XREFs of ?LogGamepadTaskSwitcherUnexpectedState@ControllerProcessorTelemetry@@SAXI@Z @ 0x1801A8A44
 * Callers:
...
void __fastcall ControllerProcessorTelemetry::LogGamepadTaskSwitcherUnexpectedState(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x400000000000LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = v1;
    v6 = 4;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180237206, 0LL, 0LL, 3u, &v4);
  }
}
