/*
 * XREFs of ?AllocateStub@BamoInputProcessPrincipalOwner@@UEAAJPEAVBamoInputProcessPrincipal@@PEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputProcessStub@@@Z @ 0x1800D9D20
 * Callers:
 *     <none>
 * Callees:
