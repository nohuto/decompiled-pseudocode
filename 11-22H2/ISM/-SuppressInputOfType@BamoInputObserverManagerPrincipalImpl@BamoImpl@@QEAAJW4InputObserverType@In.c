/*
 * XREFs of ?SuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x18015613C
 * Callers:
 *     ?Thunk_SuppressInputOfType_258@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072420 (-Thunk_SuppressInputOfType_258@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManage.c)
 * Callees:
