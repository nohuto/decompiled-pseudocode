/*
 * XREFs of ?GetIsInputDisabled@BamoCUIComponentInputObjectProxy@@UEAA_NXZ @ 0x18014FC30
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoCUIComponentInputObjectProxy::GetIsInputDisabled(BamoCUIComponentInputObjectProxy *this)
{
