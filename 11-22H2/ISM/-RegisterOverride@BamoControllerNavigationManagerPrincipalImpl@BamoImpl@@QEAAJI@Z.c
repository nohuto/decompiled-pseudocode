/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18019FEDC
 * Callers:
 *     ?Thunk_RegisterOverride_8@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801A0440 (-Thunk_RegisterOverride_8@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigat.c)
 * Callees:
