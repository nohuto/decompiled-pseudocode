/*
 * XREFs of ?SetGamepadInterceptionTarget@GamepadInterceptionHelper@@QEAA_NPEAUIGamepadInterceptionTarget@@@Z @ 0x18006AB68
 * Callers:
        ...
        struct IGamepadInterceptionTarget *a2)
{
  ...
  {
    v15 = a2;
    Microsoft::WRL::ComPtr<IGamepadInterceptionTarget>::InternalAddRef((__int64 *)&v15);
    ...
    {
      *v12 = (__int64)v2;
      Microsoft::WRL::ComPtr<IGamepadInterceptionTarget>::InternalAddRef(v12);
      *((_QWORD *)this + 4) += 8LL;
    }
    if ( v2 )
