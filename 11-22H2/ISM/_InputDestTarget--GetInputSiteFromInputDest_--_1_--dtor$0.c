/*
 * XREFs of _InputDestTarget::GetInputSiteFromInputDest_::_1_::dtor$0 @ 0x1800826A4
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall InputDestTarget::GetInputSiteFromInputDest_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  _QWORD *result; // rax
