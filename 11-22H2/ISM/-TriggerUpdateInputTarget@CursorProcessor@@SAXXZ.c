/*
 * XREFs of ?TriggerUpdateInputTarget@CursorProcessor@@SAXXZ @ 0x180167790
 * Callers:
...
void __fastcall CursorProcessor::TriggerUpdateInputTarget(__int64 a1)
{
  ...
  if ( *(_DWORD *)v1 > 4u && (*(_BYTE *)(v1 + 16) & 8) != 0 && (*(_QWORD *)(v1 + 24) & 8LL) == *(_QWORD *)(v1 + 24) )
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_18023584B, 0LL, 0LL, 2u, &v2);
