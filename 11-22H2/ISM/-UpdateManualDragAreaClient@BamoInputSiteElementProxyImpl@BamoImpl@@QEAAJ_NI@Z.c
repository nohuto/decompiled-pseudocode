/*
 * XREFs of ?UpdateManualDragAreaClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010180
 * Callers:
 *     ?Thunk_UpdateManualDragAreaClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A2A0 (-Thunk_UpdateManualDragAreaClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyI.c)
