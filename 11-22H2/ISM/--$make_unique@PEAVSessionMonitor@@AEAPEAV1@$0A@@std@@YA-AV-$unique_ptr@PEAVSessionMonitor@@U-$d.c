/*
 * XREFs of ??$make_unique@PEAVSessionMonitor@@AEAPEAV1@$0A@@std@@YA?AV?$unique_ptr@PEAVSessionMonitor@@U?$default_delete@PEAVSessionMonitor@@@std@@@0@AEAPEAVSessionMonitor@@@Z @ 0x180059630
 * Callers:
