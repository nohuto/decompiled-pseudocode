/*
 * XREFs of ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAH@Z @ 0x180105464
 * Callers:
 ...
 * Callees:
 *     ?InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z @ 0x1801053B0 (-InternalParseValue@HidChannelValueInfo@@AEAAI_KPEBE@Z.c)
 */
