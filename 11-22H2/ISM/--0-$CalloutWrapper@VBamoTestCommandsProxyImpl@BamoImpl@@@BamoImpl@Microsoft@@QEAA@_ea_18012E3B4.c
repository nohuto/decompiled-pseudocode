/*
 * XREFs of ??0?$CalloutWrapper@VBamoTestCommandsProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoTestCommandsProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18012E3B4
 * Callers:
