/*
 * XREFs of ??1CustomCursorApplication2@@QEAA@XZ @ 0x18010FA84
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj2@VCustomCursorApplication2@@@std@@EEAAXXZ @ 0x180111B00 (-_Destroy@-$_Ref_count_obj2@VCustomCursorApplication2@@@std@@EEAAXXZ.c)
 * Callees:
