/*
 * XREFs of ?UpdateShellGesturesClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x18000FC40
 * Callers:
 *     ?Thunk_UpdateShellGesturesClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A220 (-Thunk_UpdateShellGesturesClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyIm.c)
