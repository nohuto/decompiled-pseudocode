/*
 * XREFs of ?UpdateSupportedFeedback@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801485F4
 * Callers:
 *     ?Thunk_UpdateSupportedFeedback_8@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180142230 (-Thunk_UpdateSupportedFeedback_8@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsContr.c)
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    if ( v13 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v16[0]);
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSimpleHapticsControllerProxyImpl>::~CalloutWrapper<BamoImpl::BamoSimpleHapticsControllerProxyImpl>((__int64)v16);
  }
  else
  {
    v12 = (char *)this - 16;
