/*
 * XREFs of ?ResetAndInitializeInteractionContext@DragGestureTracker@@QEAAJXZ @ 0x1801C919C
 * Callers:
 *     ??0DragGestureTracker@@QEAA@_N@Z @ 0x1801C90F8 (--0DragGestureTracker@@QEAA@_N@Z.c)
