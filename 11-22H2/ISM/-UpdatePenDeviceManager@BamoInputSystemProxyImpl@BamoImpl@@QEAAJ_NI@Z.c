/*
 * XREFs of ?UpdatePenDeviceManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180146E2C
 * Callers:
 *     ?Thunk_UpdatePenDeviceManager_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180142110 (-Thunk_UpdatePenDeviceManager_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@.c)
