/*
 * XREFs of ?PushStateToPrincipalOnPropertiesRefresh@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBaseBamoPeerImpl@2Microsoft@@@Z @ 0x1800B8570
 * Callers:
 *     <none>
 * Callees:
