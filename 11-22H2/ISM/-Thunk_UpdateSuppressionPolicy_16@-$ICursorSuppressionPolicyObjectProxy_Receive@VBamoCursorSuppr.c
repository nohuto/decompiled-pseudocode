/*
 * XREFs of ?Thunk_UpdateSuppressionPolicy_16@?$ICursorSuppressionPolicyObjectProxy_Receive@VBamoCursorSuppressionPolicyObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180142250
 * Callers:
 *     <none>
 * Callees:
 *     <none>
