/*
 * XREFs of ?_Growmap@?$deque@PEAVShellGesturesClientProxy@@V?$allocator@PEAVShellGesturesClientProxy@@@std@@@std@@AEAAX_K@Z @ 0x180039400
 * Callers:
...
void std::deque<ShellGesturesClientProxy *>::_Growmap()
{
  ...
  v0 = 1LL;
  if ( (_QWORD)xmmword_180278530 )
    v0 = xmmword_180278530;
  while ( 1 )
  {
    v1 = v0 - xmmword_180278530;
    if ( v0 >= 8 )
    {
      if ( v1 )
        break;
  ...
  v2 = *((_QWORD *)&xmmword_180278530 + 1) >> 1;
  ...
  v7 = *((_QWORD *)&ShellGesturesProcessor::s_clients + 1) + 8 * xmmword_180278530 - (_QWORD)v6;
  ...
  if ( *((_QWORD *)&ShellGesturesProcessor::s_clients + 1) )
    std::_Deallocate<16,0>(*((void **)&ShellGesturesProcessor::s_clients + 1), 8 * xmmword_180278530);
  *(_QWORD *)&xmmword_180278530 = v1 + xmmword_180278530;
