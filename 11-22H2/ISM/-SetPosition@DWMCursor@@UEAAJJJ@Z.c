/*
 * XREFs of ?SetPosition@DWMCursor@@UEAAJJJ@Z @ 0x180049930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMCursor::SetPosition(DWMCursor *this, unsigned int a2, unsigned int a3)
{
  ...
  struct IDCompositionDevice *v21; // [rsp+90h] [rbp+30h] BYREF
  ...
  *((_DWORD *)this + 21) = a3;
  ...
  if ( !ISMTestMode::s_instance )
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v8);
  if ( *(_BYTE *)ISMTestMode::s_instance || !byte_180276FE4 && v9 == a2 && v10 == a3 )
    goto LABEL_10;
  if ( *((_QWORD *)this + 7) )
  {
    v21 = 0LL;
