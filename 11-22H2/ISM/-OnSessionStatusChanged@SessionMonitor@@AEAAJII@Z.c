/*
 * XREFs of ?OnSessionStatusChanged@SessionMonitor@@AEAAJII@Z @ 0x18005A7BC
 * Callers:
 *     ?WndProc@SessionMonitor@@CA_JPEAUHWND__@@I_K_J@Z @ 0x18005A870 (-WndProc@SessionMonitor@@CA_JPEAUHWND__@@I_K_J@Z.c)
 * Callees:
