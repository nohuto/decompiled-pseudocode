/*
 * XREFs of ?OnDisconnectedThunk@BamoInputDeliveryServerStubImpl@BamoImpl@@UEAAJXZ @ 0x1800298D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$CalloutWrapper@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputDeliveryServerPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180029950 (--0-$CalloutWrapper@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PE.c)
