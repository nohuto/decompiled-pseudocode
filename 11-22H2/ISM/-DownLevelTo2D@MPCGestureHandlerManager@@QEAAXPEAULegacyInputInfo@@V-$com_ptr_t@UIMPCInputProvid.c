/*
 * XREFs of ?DownLevelTo2D@MPCGestureHandlerManager@@QEAAXPEAULegacyInputInfo@@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x1800BB00C
 * Callers:
        ...
        const char *a4)
{
  ...
  MPCGestureHandler *v8; // rsi
  MPCGestureHandler *v9; // rbx
  __int64 *GestureHandlerForWorkspace; // rax
  __int64 v11; // rdx
  __int64 v12; // rax
  __int64 v13; // rsi
  __int64 v15[2]; // [rsp+20h] [rbp-20h] BYREF
  __int64 v16; // [rsp+30h] [rbp-10h]
  wil::details::in1diag3 *retaddr; // [rsp+68h] [rbp+28h]
  MPCGestureHandler *v18; // [rsp+88h] [rbp+48h] BYREF
  ...
  if ( v16 == *((_QWORD *)this + 3) )
    goto LABEL_11;
  v8 = *(MPCGestureHandler **)(*(_QWORD *)std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::_Try_emplace<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const &,>(
                                            (__int64 *)this + 3,
                                            (__int64)v15,
                                            a3)
                             + 40LL);
  ...
  if ( !v8 )
    goto LABEL_11;
  (*(void (__fastcall **)(MPCGestureHandler *))(*(_QWORD *)v8 + 8LL))(v8);
  wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>(
    v15,
    *a3);
  if ( !(unsigned __int8)MPCGestureHandler::IsInjecting(v8, v15) && *((_DWORD *)v8 + 228) != *(_DWORD *)(a2 + 896) )
  {
    wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>(
      v15,
      *a3);
    MPCGestureHandlerManager::DetachProvider(this, (unsigned __int64 *)v15);
    v9 = 0LL;
    v18 = 0LL;
  ...
  {
LABEL_11:
    GestureHandlerForWorkspace = (__int64 *)MPCGestureHandlerManager::GetGestureHandlerForWorkspace(this);
    v11 = *GestureHandlerForWorkspace;
    *GestureHandlerForWorkspace = 0LL;
    wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>::attach(&v18, v11);
    ...
    wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>(
      ...
      *a3);
    v9 = v18;
    MPCGestureHandler::AttachProvider(v18, v15);
    v12 = std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::_Try_emplace<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const &,>(
            (__int64 *)this + 3,
            (__int64)v15,
            a3);
    v13 = *(_QWORD *)(*(_QWORD *)v12 + 40LL);
    *(_QWORD *)(*(_QWORD *)v12 + 40LL) = v9;
    if ( v9 )
      (*(void (__fastcall **)(MPCGestureHandler *))(*(_QWORD *)v9 + 8LL))(v9);
    if ( v13 )
  ...
  wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>(
    v15,
    *a3);
  MPCGestureHandler::DownLevelTo2D(v9, (struct LegacyInputInfo *)a2);
  ...
  return wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>::~com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>((__int64 *)a3);
}
