/*
 * XREFs of ?StringToHstringVectorParser@@YA?AV?$com_ptr_t@U?$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@PEBG@Z @ 0x180199A60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?find@?$_WChar_traits@G@std@@SAPEBGPEBG_KAEBG@Z @ 0x1800EBA50 (-find@-$_WChar_traits@G@std@@SAPEBGPEBG_KAEBG@Z.c)
 *     ?Set@HString@Wrappers@WRL@Microsoft@@QEAAJPEBGI@Z @ 0x180125D28 (-Set@HString@Wrappers@WRL@Microsoft@@QEAAJPEBGI@Z.c)
 *     ??0?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$DefaultVectorOptions@PEAUHSTRING__@@@3456@@Internal@Collections@Foundation@Windows@@QEAA@AEBU?$DefaultEqualityPredicate@PEAUHSTRING__@@@1234@Upermission@01234@@Z @ 0x1801916EC (--0-$Vector@PEAUHSTRING__@@U-$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foun.c)
 *     ?substr@?$basic_string_view@GU?$char_traits@G@std@@@std@@QEBA?AV12@_K_K@Z @ 0x18019B7C0 (-substr@-$basic_string_view@GU-$char_traits@G@std@@@std@@QEBA-AV12@_K_K@Z.c)
 */
...
__int64 *__fastcall StringToHstringVectorParser(__int64 *a1, _WORD *a2)
{
  ...
  HSTRING v22; // [rsp+B0h] [rbp+58h] BYREF
  ...
  if ( v9 )
  {
    ...
    if ( v11 )
    {
      ...
      if ( v13 != -1 )
      {
        ...
        do
        {
          v14 = *(__m128i *)std::basic_string_view<unsigned short>::substr(v18, v19, v10, v13 - v10);
          string = 0LL;
  ...
  v16 = *(__m128i *)std::basic_string_view<unsigned short>::substr(v18, v19, v10, -1LL);
  v22 = 0LL;
  Microsoft::WRL::Wrappers::HString::Set(
    &v22,
