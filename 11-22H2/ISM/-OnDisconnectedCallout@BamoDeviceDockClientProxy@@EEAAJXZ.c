/*
 * XREFs of ?OnDisconnectedCallout@BamoDeviceDockClientProxy@@EEAAJXZ @ 0x1801AD9C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDeviceDockClientProxy::OnDisconnectedCallout(BamoDeviceDockClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoDeviceDockClientProxyImpl>::CalloutWrapper<BamoImpl::BamoDeviceDockClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoDeviceDockClientProxy *))(*(_QWORD *)v1 + 40LL))(v1);
