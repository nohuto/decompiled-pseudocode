/*
 * XREFs of wil::init_once_nothrow__lambda_ca82685424ac054990721f288eeb0943___ @ 0x1801C943C
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  if ( !__std_init_once_begin_initialize(&stru_180278BF0, 0, &fPending, 0LL) )
  ...
  if ( fPending )
  {
    ...
    if ( a3 )
      *a3 = 1;
    InitOnceComplete(&stru_180278BF0, 0, 0LL);
  }
  return 0LL;
}
