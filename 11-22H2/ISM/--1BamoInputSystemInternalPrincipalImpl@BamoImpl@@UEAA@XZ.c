/*
 * XREFs of ??1BamoInputSystemInternalPrincipalImpl@BamoImpl@@UEAA@XZ @ 0x18014AFB0
 * Callers:
 *     ??1BamoInputSystemInternalPrincipal@@MEAA@XZ @ 0x18014AFA0 (--1BamoInputSystemInternalPrincipal@@MEAA@XZ.c)
