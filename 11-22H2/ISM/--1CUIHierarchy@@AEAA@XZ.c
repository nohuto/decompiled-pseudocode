/*
 * XREFs of ??1CUIHierarchy@@AEAA@XZ @ 0x1800561C4
 * Callers:
 *     _CUIHierarchy::GetInstance_::_2_::_dynamic_atexit_destructor_for__instance__ @ 0x180083A70 (_CUIHierarchy--GetInstance_--_2_--_dynamic_atexit_destructor_for__instance__.c)
 * Callees:
