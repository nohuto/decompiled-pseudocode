/*
 * XREFs of ?RegisterDeviceDockClient@DeviceDockServer@@UEAAJPEAVBamoDeviceDockServerStub@@PEAVBamoDeviceDockClientProxy@@W4DockWatcherRoutingPolicy@Input@Internal@UI@Windows@@@Z @ 0x1801ABF00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVBamoDeviceDockClientProxy@@@Z @ 0x1801A9EA8 (--4-$com_ptr_t@VBamoDeviceDockClientProxy@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAVBamo.c)
