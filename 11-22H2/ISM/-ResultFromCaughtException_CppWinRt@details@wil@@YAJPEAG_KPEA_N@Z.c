/*
 * XREFs of ?ResultFromCaughtException_CppWinRt@details@wil@@YAJPEAG_KPEA_N@Z @ 0x1800F3280
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  wchar_t *v20; // [rsp+90h] [rbp+8h]
  wchar_t *v21; // [rsp+90h] [rbp+8h]
  wchar_t *v22; // [rsp+90h] [rbp+8h]
  wchar_t *v23; // [rsp+90h] [rbp+8h]
  const struct wil::ResultException *v24; // [rsp+90h] [rbp+8h]
  wchar_t *v25; // [rsp+90h] [rbp+8h]
  wchar_t *v26; // [rsp+90h] [rbp+8h]
  wchar_t *v27; // [rsp+90h] [rbp+8h]
  wchar_t *v28; // [rsp+90h] [rbp+8h]
  wchar_t *v29; // [rsp+90h] [rbp+8h]
