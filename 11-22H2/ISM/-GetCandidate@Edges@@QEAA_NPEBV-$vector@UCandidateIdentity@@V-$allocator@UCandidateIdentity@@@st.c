/*
 * XREFs of ?GetCandidate@Edges@@QEAA_NPEBV?$vector@UCandidateIdentity@@V?$allocator@UCandidateIdentity@@@std@@@std@@PEBUD2D_VECTOR_2F@@PEAW4EdgyExperienceRunState@Input@Internal@UI@Windows@@PEAPEAUCandidateIdentity@@@Z @ 0x1801D71EC
 * Callers:
 *     ?HasCandidates@EdgyImpl@@QEAA_NXZ @ 0x1801DA140 (-HasCandidates@EdgyImpl@@QEAA_NXZ.c)
 *     ?SelectCandidate@EdgyImpl@@QEAA_NPEBUD2D_VECTOR_2F@@@Z @ 0x1801DA310 (-SelectCandidate@EdgyImpl@@QEAA_NPEBUD2D_VECTOR_2F@@@Z.c)
 * Callees:
        ...
        _QWORD *a5)
{
  ...
  if ( a5 )
  {
    ...
    std::wstring::wstring(v16, (__int64)v9);
    v16[8] = *((_DWORD *)v9 + 8);
    *a5 = v16;
  }
  return 1;
