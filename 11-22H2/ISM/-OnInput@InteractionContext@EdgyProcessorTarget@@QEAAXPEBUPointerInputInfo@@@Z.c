/*
 * XREFs of ?OnInput@InteractionContext@EdgyProcessorTarget@@QEAAXPEBUPointerInputInfo@@@Z @ 0x1801D9408
 * Callers:
 ...
 *     ?Configure@InteractionContext@EdgyProcessorTarget@@QEAAXXZ @ 0x1801D86F0 (-Configure@InteractionContext@EdgyProcessorTarget@@QEAAXXZ.c)
 */
  ...
  if ( v5 )
  {
    if ( *((_DWORD *)a2 + 79) != 1 )
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        a4);
    if ( (int)ProcessPointerFramesInteractionContext(v5, 1LL, 1LL, (char *)a2 + 320) < 0 )
