/*
 * XREFs of ??0?$CalloutWrapper@VBamoHeatGripServicePrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoHeatGripServicePrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1800295C0
 * Callers:
 *     ?OnDisconnectedThunk@BamoHeatGripServiceStubImpl@BamoImpl@@UEAAJXZ @ 0x180029540 (-OnDisconnectedThunk@BamoHeatGripServiceStubImpl@BamoImpl@@UEAAJXZ.c)
