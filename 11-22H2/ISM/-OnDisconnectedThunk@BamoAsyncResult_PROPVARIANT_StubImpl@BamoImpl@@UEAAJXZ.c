/*
 * XREFs of ?OnDisconnectedThunk@BamoAsyncResult_PROPVARIANT_StubImpl@BamoImpl@@UEAAJXZ @ 0x18019BD70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_PROPVARIANT_StubImpl::OnDisconnectedThunk(
