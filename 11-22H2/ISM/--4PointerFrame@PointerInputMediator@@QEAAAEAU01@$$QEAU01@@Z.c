/*
 * XREFs of ??4PointerFrame@PointerInputMediator@@QEAAAEAU01@$$QEAU01@@Z @ 0x18010B80C
 * Callers:
 ...
 * Callees:
 *     ??4?$vector@IV?$allocator@I@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800FA5E0 (--4-$vector@IV-$allocator@I@std@@@std@@QEAAAEAV01@$$QEAV01@@Z.c)
