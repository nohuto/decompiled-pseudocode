/*
 * XREFs of ?QueryInterface@BamoSystemCursorControllerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801113D0
 * Callers:
 *     ?QueryInterface@BamoSystemCursorControllerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007A590 (-QueryInterface@BamoSystemCursorControllerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
