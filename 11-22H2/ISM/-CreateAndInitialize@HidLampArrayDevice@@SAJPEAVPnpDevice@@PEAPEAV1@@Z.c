/*
 * XREFs of ?CreateAndInitialize@HidLampArrayDevice@@SAJPEAVPnpDevice@@PEAPEAV1@@Z @ 0x1800FF678
 * Callers:
 ...
 *     ??0HidLampArrayDevice@@AEAA@XZ @ 0x1800FF11C (--0HidLampArrayDevice@@AEAA@XZ.c)
