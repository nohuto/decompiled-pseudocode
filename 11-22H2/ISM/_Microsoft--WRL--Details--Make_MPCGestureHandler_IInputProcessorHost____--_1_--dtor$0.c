/*
 * XREFs of _Microsoft::WRL::Details::Make_MPCGestureHandler_IInputProcessorHost____::_1_::dtor$0 @ 0x1800BA63D
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall Microsoft::WRL::Details::Make_MPCGestureHandler_IInputProcessorHost____::_1_::dtor_0(
        __int64 a1,
        __int64 a2)
{
  _QWORD *result; // rax
