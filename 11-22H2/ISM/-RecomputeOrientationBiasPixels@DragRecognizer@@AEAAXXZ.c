/*
 * XREFs of ?RecomputeOrientationBiasPixels@DragRecognizer@@AEAAXXZ @ 0x1801E33B0
 * Callers:
 *     ?ResetConfigValues@DragRecognizer@@UEAAXXZ @ 0x1801E3480 (-ResetConfigValues@DragRecognizer@@UEAAXXZ.c)
 *     ?SetConfigValue@DragRecognizer@@UEAA_NPEBUGestureRecognizerConfigValue@@@Z @ 0x1801E34D0 (-SetConfigValue@DragRecognizer@@UEAA_NPEBUGestureRecognizerConfigValue@@@Z.c)
 * Callees:
 *     _o_tan_0 @ 0x1800573D0 (_o_tan_0.c)
 */
