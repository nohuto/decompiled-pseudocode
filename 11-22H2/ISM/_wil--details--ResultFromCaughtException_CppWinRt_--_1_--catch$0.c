/*
 * XREFs of _wil::details::ResultFromCaughtException_CppWinRt_::_1_::catch$0 @ 0x1800F32E6
 * Callers:
 *     <none>
 * Callees:
 *     ?MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z @ 0x1800A643C (-MaybeGetExceptionString@details@wil@@YAXAEBVResultException@2@PEAG_K@Z.c)
 */
