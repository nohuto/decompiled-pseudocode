...
__int64 __fastcall std::unordered_map<unsigned long,InputInfoValidator::PointerState>::_Insert_or_assign<unsigned long,InputInfoValidator::PointerState &>(
        _QWORD *a1,
        __int64 a2,
        unsigned __int8 *a3,
        _QWORD *a4)
