/*
 * XREFs of ?MPCEyeGazeProcessor_DeviceAttached_@ISMTracing@@QEAAXK@Z @ 0x1800D6AC8
 * Callers:
...
void __fastcall ISMTracing::MPCEyeGazeProcessor_DeviceAttached_(ISMTracing *this, int a2)
{
  ...
  if ( *v3 > 4u )
  {
    ...
    v4 = a2;
    v7 = 4;
    tlgWriteTransfer_EventWriteTransfer((__int64)v3, (unsigned __int8 *)dword_18023197C, 0LL, 0LL, 3u, &v5);
  }
}
