/*
 * XREFs of ?Initialize@InputRedirectionProcessor@@IEAAJPEAUIInputDeviceInfoStore@@@Z @ 0x18003B494
 * Callers:
...
LABEL_12:
  ...
  Descriptor = InputSecurityDescriptor::QueryDescriptor((__int64)&v14, v5, (__int64)L"System\\TouchInputRedirection");
  v6 = Descriptor;
  if ( Descriptor < 0 )
  {
    v13 = 30LL;
  ...
  Descriptor = v8(v7, v14, L"System\\TouchInputRedirection", (char *)this + 56);
  v6 = Descriptor;
  if ( Descriptor < 0 )
  {
    v13 = 35LL;
