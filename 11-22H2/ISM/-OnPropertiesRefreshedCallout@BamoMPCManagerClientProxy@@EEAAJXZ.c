/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoMPCManagerClientProxy@@EEAAJXZ @ 0x18011F5B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCManagerClientProxy::OnPropertiesRefreshedCallout(
        ...
        __int64 a3)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    a3,
    0LL);
  LODWORD(v3) = (*(__int64 (__fastcall **)(BamoMPCManagerClientProxy *))(*(_QWORD *)v3 + 48LL))(v3);
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    v8,
    v4,
    v5,
