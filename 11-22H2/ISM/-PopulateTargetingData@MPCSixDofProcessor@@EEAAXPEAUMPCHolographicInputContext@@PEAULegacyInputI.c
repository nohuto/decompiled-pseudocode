/*
 * XREFs of ?PopulateTargetingData@MPCSixDofProcessor@@EEAAXPEAUMPCHolographicInputContext@@PEAULegacyInputInfo@@@Z @ 0x1801EC5C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?transform@Numerics@Foundation@Windows@@YA?AUfloat3@123@AEBU4123@AEBUquaternion@123@@Z @ 0x1800D0C7C (-transform@Numerics@Foundation@Windows@@YA-AUfloat3@123@AEBU4123@AEBUquaternion@123@@Z.c)
 */
        ...
        struct LegacyInputInfo *a3)
{
  ...
  *((_DWORD *)a3 + 21) = *((_DWORD *)this + 1036);
  if ( *((_BYTE *)a3 + 2492) && *((_BYTE *)a3 + 2493) )
  {
    ...
    *(float *)&v7 = v7[2];
    v26 = v6;
    v27 = *(float *)&v7;
    Windows::Foundation::Numerics::transform((float *)&v32, (float *)&v30, (float *)(v8 + 16));
  ...
  v17 = *(_OWORD *)((char *)v3 + 3160);
  v33[0] = *(_OWORD *)((char *)v3 + 3144);
  v18 = *(_OWORD *)((char *)v3 + 3176);
  v33[1] = v17;
  v19 = *(_OWORD *)((char *)v3 + 3192);
  v33[2] = v18;
  v33[3] = v19;
  v20 = Windows::Foundation::Numerics::transform(v28, (float *)&v30, (float *)v33);
  *((_QWORD *)this + 528) = *(_QWORD *)v20;
  *((float *)this + 1058) = v20[2];
  v21 = Windows::Foundation::Numerics::transform_normal(v28, (float *)&v26, (float *)v33);
  *(_QWORD *)((char *)this + 4236) = *(_QWORD *)v21;
  *((float *)this + 1061) = v21[2];
  v22 = _mm_movelh_ps((__m128)*(unsigned __int64 *)((char *)this + 4236), (__m128)*((unsigned int *)this + 1061));
  ...
  *(_QWORD *)((char *)this + 4236) = v25.m128_u64[0];
  v29 = _mm_shuffle_ps(v25, v25, 170).m128_u32[0];
  *((_DWORD *)this + 1061) = v29;
}
