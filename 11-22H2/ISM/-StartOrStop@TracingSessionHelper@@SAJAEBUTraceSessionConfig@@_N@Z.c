/*
 * XREFs of ?StartOrStop@TracingSessionHelper@@SAJAEBUTraceSessionConfig@@_N@Z @ 0x1800EABD8
 * Callers:
 ...
 *     ?StartTracingSession@SpatialRimDeviceCollection@@UEAAXXZ @ 0x1800EAF70 (-StartTracingSession@SpatialRimDeviceCollection@@UEAAXXZ.c)
 * Callees:
 ...
 *     ??1?$unique_storage@U?$resource_policy@_K$$A6AK_K@Z$1?CloseTrace@@YAK0@ZU?$integral_constant@_K$0A@@wistd@@_K_K$0?0$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x1800E69CC (--1-$unique_storage@U-$resource_policy@_K$$A6AK_K@Z$1-CloseTrace@@YAK0@ZU-$integral_constant@_K$.c)
