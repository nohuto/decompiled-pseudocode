/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_CSMValidity@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18006EFF4
 * Callers:
 ...
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_CSMValidity@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18006E4BC (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_CSMValidity@@@details@wi.c)
 */
