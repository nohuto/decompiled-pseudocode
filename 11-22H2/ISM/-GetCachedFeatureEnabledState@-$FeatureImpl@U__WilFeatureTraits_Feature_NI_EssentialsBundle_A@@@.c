/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_NI_EssentialsBundle_A@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180074420
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_NI_EssentialsBundle_A@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180074970 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_NI_EssentialsBundle_A@@@details@wil@@QEAA.c)
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_NI_EssentialsBundle_A@@@details@wil@@QEAA_NW4ReportingKind@3@@Z @ 0x180074DC0 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_NI_EssentialsBundle_A@@@details@w.c)
 * Callees:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_NI_EssentialsBundle_A>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_NI_EssentialsBundle_A>::GetCurrentFeatureEnabledState(
      a1,
      &v12,
      &v11);
    for ( i = *a2; ; i = v9 )
