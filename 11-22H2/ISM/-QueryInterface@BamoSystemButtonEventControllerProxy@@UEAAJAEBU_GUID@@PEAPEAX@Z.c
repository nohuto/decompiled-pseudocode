/*
 * XREFs of ?QueryInterface@BamoSystemButtonEventControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180021E50
 * Callers:
 *     ?QueryInterface@BamoSystemButtonEventControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007BE90 (-QueryInterface@BamoSystemButtonEventControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
