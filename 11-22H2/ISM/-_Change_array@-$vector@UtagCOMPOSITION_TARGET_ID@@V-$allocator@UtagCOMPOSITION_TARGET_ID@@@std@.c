/*
 * XREFs of ?_Change_array@?$vector@UtagCOMPOSITION_TARGET_ID@@V?$allocator@UtagCOMPOSITION_TARGET_ID@@@std@@@std@@AEAAXQEAUtagCOMPOSITION_TARGET_ID@@_K1@Z @ 0x180073B18
 * Callers:
