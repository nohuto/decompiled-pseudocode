/*
 * XREFs of ??1?$list@U?$pair@$$CBKV?$unique_ptr@ULegacyDeviceInfo@@U?$default_delete@ULegacyDeviceInfo@@@std@@@std@@@std@@V?$allocator@U?$pair@$$CBKV?$unique_ptr@ULegacyDeviceInfo@@U?$default_delete@ULegacyDeviceInfo@@@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800F6C5C
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$35 @ 0x1800810B5 (_Win32kInterop--Win32kInterop_--_1_--dtor$35.c)
 *     _InjectionRawInputProvider::InjectionRawInputProvider_::_1_::dtor$12 @ 0x1800F6B5E (_InjectionRawInputProvider--InjectionRawInputProvider_--_1_--dtor$12.c)
 * Callees:
