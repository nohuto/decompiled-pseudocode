        ...
        unsigned __int64 a2)
{
  ...
  v8 = v5 - 1;
  qword_180278518 = v5;
  qword_180278510 = v5 - 1;
  v9 = *(const unsigned __int8 **)qword_1802784E8;
  v10 = *(const unsigned __int8 **)qword_1802784E8;
  while ( v9 != (const unsigned __int8 *)v3 )
  {
    ...
    v13 = qword_1802784F8;
    v14 = 2 * (v8 & result);
    if ( *(_QWORD *)(qword_1802784F8 + 16 * (v8 & result)) == v3 )
    {
      *(_QWORD *)(qword_1802784F8 + 16 * (v8 & result)) = v12;
LABEL_7:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v12;
      goto LABEL_15;
    }
    result = *(_QWORD *)(qword_1802784F8 + 16 * (v8 & result) + 8);
    v7 = *v11;
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)(qword_1802784F8 + 8 * v14) == result )
        break;
      result = *v17;
