/*
 * XREFs of ?SendLampArrayControlReport@HidLampArrayDevice@@AEAAJPEBULampArrayControlDeviceReport@@@Z @ 0x18010156C
 * Callers:
        ...
        const struct LampArrayControlDeviceReport *a2)
{
  ...
  ReportBuffer = 0LL;
  v7 = HidLampArrayControlReportParser::CreateAndInitializeOutputBuffer(
         *((_QWORD *)this + 73),
         a2,
         &ReportBuffer,
         &ReportBufferLength);
