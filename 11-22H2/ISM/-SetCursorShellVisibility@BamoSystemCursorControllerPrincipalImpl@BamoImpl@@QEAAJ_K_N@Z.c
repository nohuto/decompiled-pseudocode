/*
 * XREFs of ?SetCursorShellVisibility@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K_N@Z @ 0x180111710
 * Callers:
 *     ?Thunk_SetCursorShellVisibility_376@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180068240 (-Thunk_SetCursorShellVisibility_376@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursor.c)
 * Callees:
        ...
        char a3)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    LOBYTE(v12) = a3;
    v13 = (*(__int64 (__fastcall **)(char *, __int64, __int64, __int64))(*((_QWORD *)this - 2) + 112LL))(
            (char *)this - 16,
            v9,
            a2,
            v12);
