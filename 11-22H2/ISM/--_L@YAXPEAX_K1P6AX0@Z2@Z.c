/*
 * XREFs of ??_L@YAXPEAX_K1P6AX0@Z2@Z @ 0x18005847C
 * Callers:
 ...
 * Callees:
 *     ?__ArrayUnwind@@YAXPEAX_K1P6AX0@Z@Z @ 0x1800576FC (-__ArrayUnwind@@YAXPEAX_K1P6AX0@Z@Z.c)
