/*
 * XREFs of ?RegisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x180155F3C
 * Callers:
 *     ?Thunk_RegisterObserverClientOfType_258@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180072400 (-Thunk_RegisterObserverClientOfType_258@-$IInputObserverManagerPrincipal_Receive@VBamoInputObser.c)
 * Callees:
