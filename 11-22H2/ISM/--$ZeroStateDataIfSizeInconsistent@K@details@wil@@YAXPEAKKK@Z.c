/*
 * XREFs of ??$ZeroStateDataIfSizeInconsistent@K@details@wil@@YAXPEAKKK@Z @ 0x180060250
 * Callers:
...
__int64 __fastcall wil::details::ZeroStateDataIfSizeInconsistent<unsigned long>(_DWORD *a1, int a2, int a3)
{
  __int64 result; // rax
