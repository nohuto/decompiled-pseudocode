/*
 * XREFs of ??1?$map@KV?$list@UHotKeyInfo@@V?$allocator@UHotKeyInfo@@@std@@@std@@U?$less@K@2@V?$allocator@U?$pair@$$CBKV?$list@UHotKeyInfo@@V?$allocator@UHotKeyInfo@@@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1801FDB38
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$8 @ 0x1801FD816 (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$8.c)
 * Callees:
