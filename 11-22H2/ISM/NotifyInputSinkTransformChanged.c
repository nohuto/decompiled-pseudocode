/*
 * XREFs of NotifyInputSinkTransformChanged @ 0x180009C70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ScheduleHierarchyUpdate@InputSinkDataCache@@QEAAXXZ @ 0x180009F00 (-ScheduleHierarchyUpdate@InputSinkDataCache@@QEAAXXZ.c)
 *     ??$emplace_back@AEA_KAEBUtagINPUT_TRANSFORM@@@?$vector@VNotificationData@@V?$allocator@VNotificationData@@@std@@@std@@QEAA?A_TAEA_KAEBUtagINPUT_TRANSFORM@@@Z @ 0x180009F54 (--$emplace_back@AEA_KAEBUtagINPUT_TRANSFORM@@@-$vector@VNotificationData@@V-$allocator@VNotifica.c)
 */
