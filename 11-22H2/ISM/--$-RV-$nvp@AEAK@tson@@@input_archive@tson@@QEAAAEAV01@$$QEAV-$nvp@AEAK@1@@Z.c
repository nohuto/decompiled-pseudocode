/*
 * XREFs of ??$?RV?$nvp@AEAK@tson@@@input_archive@tson@@QEAAAEAV01@$$QEAV?$nvp@AEAK@1@@Z @ 0x1800688F4
 * Callers:
...
__int64 __fastcall tson::input_archive::operator()<tson::nvp<unsigned long &>>(__int64 a1, __int64 a2)
{
  char v2; // r8
  _DWORD *v4; // rdi
  __int64 v5; // rdx
  ...
  *(_BYTE *)(a1 + 24) = v2;
  ...
  if ( tson::input_archive::search((tson::input_archive *)a1) )
  {
    ...
    tson::read_buffer::consume_n(*(tson::read_buffer **)a1, v4, 4uLL);
  }
  else
  {
    *v4 = 0;
