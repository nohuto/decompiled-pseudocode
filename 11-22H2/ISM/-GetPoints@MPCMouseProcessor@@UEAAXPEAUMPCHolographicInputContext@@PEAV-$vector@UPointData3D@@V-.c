/*
 * XREFs of ?GetPoints@MPCMouseProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAV?$vector@UPointData3D@@V?$allocator@UPointData3D@@@std@@@std@@@Z @ 0x1801F4390
 * Callers:
 *     <none>
 * Callees:
...
char *__fastcall MPCMouseProcessor::GetPoints(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v5; // eax
  int v6; // xmm1_4
  int v7; // xmm0_4
