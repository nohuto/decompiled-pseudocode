/*
 * XREFs of ?UpdateType@BamoEdgyDragSourceClientProxyImpl@BamoImpl@@QEAAJ_NPEBU_GUID@@@Z @ 0x18014920C
 * Callers:
 *     ?Thunk_UpdateType_47@?$IEdgyDragSourceClientProxy_Receive@VBamoEdgyDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180142310 (-Thunk_UpdateType_47@-$IEdgyDragSourceClientProxy_Receive@VBamoEdgyDragSourceClientProxyImpl@Bam.c)
