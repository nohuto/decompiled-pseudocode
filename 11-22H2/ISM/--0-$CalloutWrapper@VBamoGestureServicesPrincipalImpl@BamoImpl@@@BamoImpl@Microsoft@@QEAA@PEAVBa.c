/*
 * XREFs of ??0?$CalloutWrapper@VBamoGestureServicesPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoGestureServicesPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180026BA0
 * Callers:
 ...
 *     ?OnDisconnectedThunk@BamoGestureServicesStubImpl@BamoImpl@@UEAAJXZ @ 0x1800282E0 (-OnDisconnectedThunk@BamoGestureServicesStubImpl@BamoImpl@@UEAAJXZ.c)
 * Callees:
...
__int64 __fastcall Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoGestureServicesPrincipalImpl>::CalloutWrapper<BamoImpl::BamoGestureServicesPrincipalImpl>(
        __int64 a1,
