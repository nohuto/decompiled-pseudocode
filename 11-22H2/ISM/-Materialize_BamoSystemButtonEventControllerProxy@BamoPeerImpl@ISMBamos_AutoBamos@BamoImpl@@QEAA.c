/*
 * XREFs of ?Materialize_BamoSystemButtonEventControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800509A0
 * Callers:
 *     ?Thunk_Materialize_BamoSystemButtonEventControllerProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180050990 (-Thunk_Materialize_BamoSystemButtonEventControllerProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive.c)
 * Callees:
