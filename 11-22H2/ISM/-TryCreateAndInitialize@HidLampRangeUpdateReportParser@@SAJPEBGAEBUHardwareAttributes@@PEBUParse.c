/*
 * XREFs of ?TryCreateAndInitialize@HidLampRangeUpdateReportParser@@SAJPEBGAEBUHardwareAttributes@@PEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x180066BB8
 * Callers:
 ...
 *     ??0HidLampRangeUpdateReportParser@@AEAA@XZ @ 0x180104DCC (--0HidLampRangeUpdateReportParser@@AEAA@XZ.c)
