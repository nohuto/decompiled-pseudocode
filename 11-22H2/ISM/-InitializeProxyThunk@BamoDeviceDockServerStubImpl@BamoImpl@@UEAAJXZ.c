/*
 * XREFs of ?InitializeProxyThunk@BamoDeviceDockServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180019AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDeviceDockServerStubImpl::InitializeProxyThunk(
