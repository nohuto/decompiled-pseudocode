/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x1800A7258
 * Callers:
 ...
 *     ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x1800A4A1C (--0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z.c)
 *     ?Iterate@RawUsageIndex@details_abi@wil@@QEBA_NV?$function@$$A6A_NPEAX_K01I@Z@wistd@@@Z @ 0x1800A5F84 (-Iterate@RawUsageIndex@details_abi@wil@@QEBA_NV-$function@$$A6A_NPEAX_K01I@Z@wistd@@@Z.c)
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  while ( 1 )
  {
    wil::details_abi::RawUsageIndex::RawUsageIndex(
      ...
      *(_BYTE *)(a3 + 8));
    v23 = 4096;
    WnfStateData = wil_details_NtQueryWnfStateData((__int64)v5, v8, v9, (__int64)&v22, (__int64)v39, (__int64)&v23);
    ...
    *((_QWORD *)&v26 + 1) = &v25;
    ...
    if ( !v32 )
      goto LABEL_11;
    updated = wil_details_NtUpdateWnfStateData((__int64)v5, v29, v30 - (int)v29, v15, v20, v22, 1);
