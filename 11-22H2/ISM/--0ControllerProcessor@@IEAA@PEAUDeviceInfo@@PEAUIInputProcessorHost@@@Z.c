/*
 * XREFs of ??0ControllerProcessor@@IEAA@PEAUDeviceInfo@@PEAUIInputProcessorHost@@@Z @ 0x1801A2958
 * Callers:
 ...
 * Callees:
 *     ??0NonPointerProcessor@@IEAA@PEAUDeviceInfo@@PEAUIInputProcessorHost@@@Z @ 0x180051260 (--0NonPointerProcessor@@IEAA@PEAUDeviceInfo@@PEAUIInputProcessorHost@@@Z.c)
        ...
        struct IInputProcessorHost *a3)
{
  ...
  *((_DWORD *)this + 315) = 0;
  *((_WORD *)this + 632) = 0;
  InjectionDevice::InjectionDevice((__int64)this + 1272, (__int64)a3, 128);
  InjectionDevice::InjectionDevice((__int64)this + 2832, (__int64)a3, 66);
  InjectionDevice::InjectionDevice((__int64)this + 4392, (__int64)a3, 8);
  InjectionDevice::InjectionDevice((__int64)this + 5952, (__int64)a3, 4);
  *((_QWORD *)this + 939) = 0LL;
  *((_WORD *)this + 3760) = 0;
  LOBYTE(v7) = 0;
  *((_QWORD *)this + 943) = v7;
