/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAGP6AXPEAX@Z$1?FreeProcessHeap@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAGPEAG$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x1800C08C8
 * Callers:
 ...
 *     _Microsoft::BamoImpl::BaseBamoConnectionImpl::Join_::_1_::dtor$1 @ 0x180080202 (_Microsoft--BamoImpl--BaseBamoConnectionImpl--Join_--_1_--dtor$1.c)
