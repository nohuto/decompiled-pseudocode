/*
 * XREFs of ?UnregisterObserverClientOfType@BamoInputObserverManagerProxyImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientPrincipal@@@Z @ 0x1801426EC
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a3)
{
  ...
  else
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      return CoreUICallSend(v12, v16, 2LL, 53LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
