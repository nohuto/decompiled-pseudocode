/*
 * XREFs of ??$As@UIResizeControllerClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIResizeControllerClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18014DF70
 * Callers:
