/*
 * XREFs of ?OnHitTest@TipToGlassProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1800172A0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsTipToGlassRequired@PenEventsTipToGlassAdapter@@SA_NXZ @ 0x1801E80EC (-IsTipToGlassRequired@PenEventsTipToGlassAdapter@@SA_NXZ.c)
