/*
 * XREFs of ?InitializeProxyThunk@BamoSystemCursorControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x180019380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerStubImpl::InitializeProxyThunk(
