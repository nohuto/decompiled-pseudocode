 ...
 * Callers:
 *     ?Invoke@?$delegate@U?$TypedEventHandler@UIUniversalAppModelWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UUniversalPropertyChangedEventArgs@23456@@Foundation@Windows@winrt@@V_lambda_f7189cc794088eeaf33bed95e453010f_@@@impl@winrt@@UEAAHPEAX0@Z @ 0x18011B550 (-Invoke@-$delegate@U-$TypedEventHandler@UIUniversalAppModelWatcher@WindowManagement_ea_18011B550.c)
 * Callees:
