/*
 * XREFs of ?try_get_parent_path_range@wil@@YA_NPEBGPEA_K@Z @ 0x1800EBBF8
 * Callers:
 *     ?CreateDirectoryDeepNoThrow@wil@@YAJPEBG@Z @ 0x1800E7284 (-CreateDirectoryDeepNoThrow@wil@@YAJPEBG@Z.c)
 * Callees:
 *     ?find_last_path_segment@wil@@YAPEBGPEBG@Z @ 0x1800EBA7C (-find_last_path_segment@wil@@YAPEBGPEBG@Z.c)
 */
