/*
 * XREFs of _lambda_dd0ac130d9769d2b3db8f6249ecd131b_::operator() @ 0x1800C5B74
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_dd0ac130d9769d2b3db8f6249ecd131b__void_IMPCInputProviderBase___::_Do_call @ 0x1800C9ED0 (std--_Func_impl_no_alloc__lambda_dd0ac130d9769d2b3db8f6249ecd131b__void_IMPCInputPr_ea_1800C9ED0.c)
 * Callees:
 ...
 *     ?IsMultiplePrimariesWithGazeCommit@MPCHolographicInputManager@@AEAA_NPEAUIMPCInputProviderBase@@@Z @ 0x1800C6EA0 (-IsMultiplePrimariesWithGazeCommit@MPCHolographicInputManager@@AEAA_NPEAUIMPCInputProviderBase@@.c)
 */
