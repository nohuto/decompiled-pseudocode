/*
 * XREFs of ??1DWMInputRouter@@MEAA@XZ @ 0x1801C56F4
 * Callers:
 *     _MPCInputRouter::MPCInputRouter_::_1_::dtor$0 @ 0x1800830BF (_MPCInputRouter--MPCInputRouter_--_1_--dtor$0.c)
...
void __fastcall DWMInputRouter::~DWMInputRouter(DWMInputRouter *this)
{
  ...
  *((_QWORD *)this + 36) = 0LL;
  ...
  std::_Deallocate<16,0>(
    *((void **)this + 92),
    (*((_QWORD *)this + 93) - *((_QWORD *)this + 92)) & 0xFFFFFFFFFFFFFFF8uLL);
  *((_QWORD *)this + 92) = 0LL;
  *((_QWORD *)this + 93) = 0LL;
  *((_QWORD *)this + 94) = 0LL;
  std::_List_node<std::pair<tagMsgRoutingInfo const,Microsoft::WRL::ComPtr<IRemoteViewHitTestClient>>,void *>::_Free_non_head<std::allocator<std::_List_node<std::pair<tagMsgRoutingInfo const,Microsoft::WRL::ComPtr<IRemoteViewHitTestClient>>,void *>>>(
    v4,
    *((_QWORD ***)this + 90));
  std::_Deallocate<16,0>(*((void **)this + 90), 0x40uLL);
  v6 = (void *)*((_QWORD *)this + 86);
  if ( v6 )
  {
    std::_Deallocate<16,0>(v6, (*((_QWORD *)this + 88) - (_QWORD)v6) & 0xFFFFFFFFFFFFFFF8uLL);
    *((_QWORD *)this + 86) = 0LL;
    *((_QWORD *)this + 87) = 0LL;
    *((_QWORD *)this + 88) = 0LL;
  }
  ...
  if ( v7 )
  {
    std::_Deallocate<16,0>(v7, (*((_QWORD *)this + 85) - (_QWORD)v7) & 0xFFFFFFFFFFFFFFF8uLL);
    *((_QWORD *)this + 83) = 0LL;
    *((_QWORD *)this + 84) = 0LL;
    *((_QWORD *)this + 85) = 0LL;
  }
  ...
  if ( v8 )
  {
    std::_Deallocate<16,0>(v8, (*((_QWORD *)this + 82) - (_QWORD)v8) & 0xFFFFFFFFFFFFFFF8uLL);
    *((_QWORD *)this + 80) = 0LL;
    *((_QWORD *)this + 81) = 0LL;
    *((_QWORD *)this + 82) = 0LL;
  }
  ...
  KernelInputConnection<_MIT_INVALIDATE_INPUT_MESSAGE>::~KernelInputConnection<_MIT_INVALIDATE_INPUT_MESSAGE>(
    (__int64)this + 352,
    v9);
  Microsoft::WRL::ComPtr<InputDeliveryServer>::InternalRelease((__int64 *)this + 43);
  Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease((__int64 *)this + 42);
  Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease((__int64 *)this + 40);
  Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease((__int64 *)this + 39);
  Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::InternalRelease((__int64 *)this + 38);
  Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::InternalRelease((__int64 *)this + 37);
  Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::~ComPtr<HotkeyRegistrationForwarder>((__int64 *)this + 35);
  Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::~ComPtr<HotkeyRegistrationForwarder>((__int64 *)this + 34);
  Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease((__int64 *)this + 33);
