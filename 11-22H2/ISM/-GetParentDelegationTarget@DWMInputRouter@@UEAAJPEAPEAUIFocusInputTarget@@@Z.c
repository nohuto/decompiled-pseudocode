/*
 * XREFs of ?GetParentDelegationTarget@DWMInputRouter@@UEAAJPEAPEAUIFocusInputTarget@@@Z @ 0x180077340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMInputRouter::GetParentDelegationTarget(
        DWMInputRouter *this,
