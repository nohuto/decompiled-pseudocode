/*
 * XREFs of ??1?$CalloutWrapper@VBamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x180028DE0
 * Callers:
 ...
 *     _BamoImpl::ISMBamos_AutoBamos::BamoConnectionImpl::OnPeerRequestsConnectThunk_::_1_::dtor$0 @ 0x18007F960 (_BamoImpl--ISMBamos_AutoBamos--BamoConnectionImpl--OnPeerRequestsConnectThunk_--_1_--dtor$0.c)
 *     _BamoImpl::ISMBamos_AutoBamos::BamoConnectionImpl::OnPeerDisconnectedThunk_::_1_::dtor$0 @ 0x18007F9A0 (_BamoImpl--ISMBamos_AutoBamos--BamoConnectionImpl--OnPeerDisconnectedThunk_--_1_--dtor$0.c)
 ...
 *     _ISMBamos_AutoBamos::BamoConnection::SetBootstrapProxyCallout_::_1_::dtor$0 @ 0x180140409 (_ISMBamos_AutoBamos--BamoConnection--SetBootstrapProxyCallout_--_1_--dtor$0.c)
 * Callees:
