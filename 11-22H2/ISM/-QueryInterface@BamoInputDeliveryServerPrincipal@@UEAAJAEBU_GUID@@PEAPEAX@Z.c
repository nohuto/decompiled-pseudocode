/*
 * XREFs of ?QueryInterface@BamoInputDeliveryServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180181130
 * Callers:
 *     ?QueryInterface@BamoInputDeliveryServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007BF50 (-QueryInterface@BamoInputDeliveryServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
