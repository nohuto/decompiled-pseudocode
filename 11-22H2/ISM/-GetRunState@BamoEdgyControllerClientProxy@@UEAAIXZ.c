/*
 * XREFs of ?GetRunState@BamoEdgyControllerClientProxy@@UEAAIXZ @ 0x180179000
 * Callers:
 *     ?OnRunStateChanged@EdgyControllerClientProxy@@MEAAJXZ @ 0x1801793C0 (-OnRunStateChanged@EdgyControllerClientProxy@@MEAAJXZ.c)
