/*
 * XREFs of ?UpdateTypingDefensesEnabled@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180154914
 * Callers:
 *     ?Thunk_UpdateTypingDefensesEnabled_11@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180154070 (-Thunk_UpdateTypingDefensesEnabled_11@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouc.c)
