/*
 * XREFs of ?QueryInterface@BamoControllerNavigationManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18019F7C0
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007D550 (-QueryInterface@BamoControllerNavigationManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
