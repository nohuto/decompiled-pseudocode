/*
 * XREFs of ?Thunk_RegisterDeviceDockClient_68@?$IDeviceDockServerPrincipal_Receive@VBamoDeviceDockServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801ACD20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
