/*
 * XREFs of ??_GBamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@MEAAPEAXI@Z @ 0x1800B0C30
 * Callers:
 *     <none>
 * Callees:
...
Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerFeedback_Principal *__fastcall Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_SimpleHapticsControllerFeedback_Principal::`scalar deleting destructor'(
