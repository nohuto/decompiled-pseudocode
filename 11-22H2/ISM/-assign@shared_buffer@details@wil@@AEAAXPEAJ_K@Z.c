/*
 * XREFs of ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x1800A8BD4
 * Callers:
 *     ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x1800A4AA0 (--0ResultException@wil@@QEAA@AEBV01@@Z.c)
