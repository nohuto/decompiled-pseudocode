/*
 * XREFs of ?QueryInterface@BamoAnimationTargetClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180021ED0
 * Callers:
 *     ?QueryInterface@BamoAnimationTargetClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007BA70 (-QueryInterface@BamoAnimationTargetClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
