/*
 * XREFs of ?OnDisconnectedThunk@BamoSystemCursorControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x180029FE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$CalloutWrapper@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoSystemCursorControllerPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18002A060 (--0-$CalloutWrapper@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x1800793F0 (_guard_xfg_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall BamoImpl::BamoSystemCursorControllerStubImpl::OnDisconnectedThunk(
