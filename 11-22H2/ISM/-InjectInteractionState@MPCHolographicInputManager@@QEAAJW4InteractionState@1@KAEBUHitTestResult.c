/*
 * XREFs of ?InjectInteractionState@MPCHolographicInputManager@@QEAAJW4InteractionState@1@KAEBUHitTestResult3D@@PEAUIMPCTarget@@@Z @ 0x1800C6838
 * Callers:
...
LABEL_17:
        ...
        v22 = v18;
        v23 = v19;
        lambda_e9c1fc9d7cbe0868cf685a076fd687ae_::operator()(&v29, (__int64)Src, v17, a2, a3, &v21);
        if ( v25 == 3 )
        {
          v25 = 6;
          memcpy_0(v26, Src, sizeof(v26));
          lambda_d868253b3e20bfbc6991bfd75a08498f_::operator()(v20, (__int64)v26);
          v25 = 3;
        }
        memcpy_0(v27, Src, sizeof(v27));
        lambda_d868253b3e20bfbc6991bfd75a08498f_::operator()(v20, (__int64)v27);
        return 0LL;
      }
    }
    else if ( a2 == 1 )
    {
      ...
      v22 = v12;
      v23 = v13;
      lambda_e9c1fc9d7cbe0868cf685a076fd687ae_::operator()(&v29, (__int64)Src, 4u, 1, a3, &v21);
      memcpy_0(v26, Src, sizeof(v26));
      lambda_d868253b3e20bfbc6991bfd75a08498f_::operator()(v20, (__int64)v26);
      goto LABEL_9;
    }
