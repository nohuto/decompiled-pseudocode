/*
 * XREFs of ?SetForegroundActivatableEntity@ForegroundManagerServer@InputTraceLogging@@SAX_K@Z @ 0x1800B560C
 * Callers:
...
void __fastcall InputTraceLogging::ForegroundManagerServer::SetForegroundActivatableEntity(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x8000LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = a1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_18022FB39, 0LL, 0LL, 3u, &v4);
  }
}
