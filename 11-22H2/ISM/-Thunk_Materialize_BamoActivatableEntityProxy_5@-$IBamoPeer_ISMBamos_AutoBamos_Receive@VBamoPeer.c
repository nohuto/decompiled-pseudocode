/*
 * XREFs of ?Thunk_Materialize_BamoActivatableEntityProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141230
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn IBamoPeer_ISMBamos_AutoBamos_Receive<BamoImpl::ISMBamos_AutoBamos::BamoPeerImpl>::Thunk_Materialize_BamoActivatableEntityProxy_5(
        __int64 a1,
        __int64 a2,
        __int64 a3)
{
