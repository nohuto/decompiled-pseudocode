/*
 * XREFs of ?GetId@BamoAnimationTargetClientProxy@@UEAA_KXZ @ 0x180163F50
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall BamoAnimationTargetClientProxy::GetId(BamoAnimationTargetClientProxy *this)
{
  __int64 v2; // rbx
  __int64 v3; // rdx
  __int64 v4; // r8
