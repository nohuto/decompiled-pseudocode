/*
 * XREFs of ?UpdateContainerGuid@BamoContainerInfoInputObjectProxyImpl@BamoImpl@@QEAAJ_NPEBU_GUID@@@Z @ 0x180143030
 * Callers:
 *     ?Thunk_UpdateContainerGuid_47@?$IContainerInfoInputObjectProxy_Receive@VBamoContainerInfoInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141C30 (-Thunk_UpdateContainerGuid_47@-$IContainerInfoInputObjectProxy_Receive@VBamoContainerInfoInputOb.c)
