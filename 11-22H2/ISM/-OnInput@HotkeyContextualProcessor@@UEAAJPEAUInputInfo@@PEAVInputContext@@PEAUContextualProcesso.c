/*
 * XREFs of ?OnInput@HotkeyContextualProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1801DE4B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetUnhandedVirtualKey@KeyboardInputInfo@@QEAAGXZ @ 0x1801BF340 (-GetUnhandedVirtualKey@KeyboardInputInfo@@QEAAGXZ.c)
