/*
 * XREFs of ?SendMaterializeProxy@BamoAsyncResult_PROPVARIANT_PrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18019C050
 * Callers:
 *     <none>
 * Callees:
