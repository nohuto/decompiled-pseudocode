/*
 * XREFs of dllmain_crt_process_attach @ 0x1800565B8
 * Callers:
 *     dllmain_crt_dispatch @ 0x180056560 (dllmain_crt_dispatch.c)
 * Callees:
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800569F4 (-__scrt_initialize_type_info@@YAXXZ.c)
 ...
 *     __scrt_initialize_crt @ 0x180056BE8 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x180056CCC (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x180056D6C (__scrt_release_startup_lock.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180056E28 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x180056E48 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x180056F9C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x180057216 (_initterm_0.c)
 *     _initterm_e_0 @ 0x180057222 (_initterm_e_0.c)
