 ...
 *     ??1?$_Tree_temp_node@V?$allocator@U?$_Tree_node@U?$pair@$$CBW4InputType@@V?$map@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$variant@K_NM@2@U?$less@X@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$variant@K_NM@2@@std@@@2@@std@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x180051A38 (--1-$_Tree_temp_node@V-$allocator@U-$_Tree_node@U-$pair@$$CBW4InputType@@V-$map@V-$basic_string@.c)
        ...
        __int64 a3)
{
  ...
  std::_Tree<std::_Tmap_traits<enum InputType,std::map<std::wstring,std::variant<unsigned long,bool,float>>,std::less<enum InputType>,std::allocator<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>>,0>>::_Find_lower_bound<enum InputType>(
    ...
    &v20,
    a3);
  if ( !*(_BYTE *)(v22 + 25) && *v6 >= *(_DWORD *)(v22 + 32) )
  {
    *(_QWORD *)a2 = v22;
    *(_BYTE *)(a2 + 8) = 0;
    return a2;
  ...
  v7 = *a1;
  v23 = v6;
  v8 = std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>,void *>>>::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>,void *>>>(
         v19,
         (__int64)a1,
         v7,
         v5,
  ...
  v9 = v8[1];
  v8[1] = 0LL;
  std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>,void *>>>::~_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>,void *>>>(v19);
  v11 = (_QWORD *)*a1;
  v12 = v20;
  ++a1[1];
  *(_QWORD *)(v9 + 8) = v12;
