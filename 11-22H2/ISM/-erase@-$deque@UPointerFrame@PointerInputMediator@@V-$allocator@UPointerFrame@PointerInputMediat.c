/*
 * XREFs of ?erase@?$deque@UPointerFrame@PointerInputMediator@@V?$allocator@UPointerFrame@PointerInputMediator@@@std@@@std@@QEAA?AV?$_Deque_iterator@V?$_Deque_val@U?$_Deque_simple_types@UPointerFrame@PointerInputMediator@@@std@@@std@@@2@V?$_Deque_const_iterator@V?$_Deque_val@U?$_Deque_simple_types@UPointerFrame@PointerInputMediator@@@std@@@std@@@2@0@Z @ 0x18010C164
 * Callers:
        ...
        __int64 a4)
{
  ...
  v8 = (unsigned __int64)v5 - qword_1802780C8;
  ...
  else
  {
    ...
    if ( v8 >= qword_1802780C8 + qword_1802780D0 - (__int64)v6 )
    {
      v16 = (__int64)v5;
      v14 = qword_1802780C8 + qword_1802780D0;
