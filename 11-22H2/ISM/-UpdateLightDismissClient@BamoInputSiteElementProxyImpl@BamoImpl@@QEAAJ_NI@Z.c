/*
 * XREFs of ?UpdateLightDismissClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1800103F0
 * Callers:
 *     ?Thunk_UpdateLightDismissClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A300 (-Thunk_UpdateLightDismissClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImp.c)
