/*
 * XREFs of ?SendLampRangeUpdateReport@HidLampArrayDevice@@QEAAJPEBULampRangeUpdateDeviceReport@@@Z @ 0x180101A2C
 * Callers:
        ...
        const struct LampRangeUpdateDeviceReport *a2)
{
  ...
  ReportBuffer = 0LL;
  v7 = HidLampRangeUpdateReportParser::CreateAndInitializeOutputBuffer(
         *((_QWORD *)this + 77),
         a2,
         &ReportBuffer,
         &ReportBufferLength);
