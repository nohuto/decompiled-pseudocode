/*
 * XREFs of ?UpdateDragManagerClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180027FF0
 * Callers:
 *     ?Thunk_UpdateDragManagerClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A140 (-Thunk_UpdateDragManagerClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl.c)
