/*
 * XREFs of ?QueryInterface@BamoEdgyControllerServerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180179FF0
 * Callers:
 *     ?QueryInterface@BamoEdgyControllerServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007BC70 (-QueryInterface@BamoEdgyControllerServerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
