/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAUIGamepadInterceptionListener@@@?$vector@PEAUIGamepadInterceptionListener@@V?$allocator@PEAUIGamepadInterceptionListener@@@std@@@std@@QEAAPEAPEAUIGamepadInterceptionListener@@QEAPEAU2@AEBQEAU2@@Z @ 0x180068E8C
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAUIGamepadInterceptionListener@@V?$allocator@PEAUIGamepadInterceptionListener@@@std@@@std@@AEAAXQEAPEAUIGamepadInterceptionListener@@_K1@Z @ 0x18006ACD8 (-_Change_array@-$vector@PEAUIGamepadInterceptionListener@@V-$allocator@PEAUIGamepadInterceptionL.c)
        ...
        _QWORD *a3)
{
  ...
  try
  {
    ...
    *(_QWORD *)v15 = *a3;
    ...
    std::vector<IGamepadInterceptionListener *>::_Change_array(a1, v14, v9, v8);
    result = v15;
  }
  catch ( ... )
  {
    std::allocator<IGamepadInterceptionListener *>::deallocate(v20, v22, v8);
    throw;
  }
  return result;
}
