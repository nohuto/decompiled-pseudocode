/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_TestConfVar@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18005FAF0
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_TestConfVar>::ReportUsage(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v9 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_TestConfVar>::GetCachedFeatureEnabledState(
