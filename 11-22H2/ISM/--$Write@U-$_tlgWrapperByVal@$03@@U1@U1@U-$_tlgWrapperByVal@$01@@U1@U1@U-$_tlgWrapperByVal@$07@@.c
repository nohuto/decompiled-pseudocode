/*
 * XREFs of ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$01@@U1@U1@U?$_tlgWrapperByVal@$07@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$01@@33AEBU?$_tlgWrapperByVal@$07@@@Z @ 0x18018210C
 * Callers:
 *     ?SendKeyboardEvent@InputServiceProxy@@UEAAJPEBUKeyboardEvent@@K@Z @ 0x1801826F0 (-SendKeyboardEvent@InputServiceProxy@@UEAAJPEBUKeyboardEvent@@K@Z.c)
 * Callees:
        ...
        __int64 a11)
{
  ...
  v16 = 4LL;
  v14 = 4LL;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180275508, a2, 0LL, 0LL, 9u, &v12);
}
