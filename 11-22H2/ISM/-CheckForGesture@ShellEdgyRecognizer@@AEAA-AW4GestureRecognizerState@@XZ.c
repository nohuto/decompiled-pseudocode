/*
 * XREFs of ?CheckForGesture@ShellEdgyRecognizer@@AEAA?AW4GestureRecognizerState@@XZ @ 0x18017E39C
 * Callers:
...
__int64 __fastcall ShellEdgyRecognizer::CheckForGesture(__int64 a1)
{
  ...
  if ( 1000000 * qword_180277040 < *(_QWORD *)(a1 + 48) - *(_QWORD *)(a1 + 32) )
  {
    result = 1LL;
    *(_DWORD *)(a1 + 8) = 1;
    return result;
  ...
  if ( (int)((*(_QWORD *)(a1 + 40) - v3) * (*(_QWORD *)(a1 + 40) - v3)
           + (HIDWORD(*(_QWORD *)(a1 + 40)) - HIDWORD(v3)) * (HIDWORD(*(_QWORD *)(a1 + 40)) - HIDWORD(v3))) <= (unsigned __int64)(unsigned int)(dword_18027702C * dword_18027702C) )
    return 2LL;
  v6 = *(_DWORD *)(a1 + 4) - 1;
  if ( *(_DWORD *)(a1 + 4) == 1 )
  {
...
LABEL_14:
  *(_QWORD *)(a1 + 12) = __PAIR64__(v9, v4);
  if ( (float)((float)((float)v4 * *(float *)&dword_180277034)
             - (float)(COERCE_FLOAT(dword_180277030 ^ _xmm) * (float)v9)) < 0.0
    || (float)((float)((float)v4 * *(float *)&dword_18027703C) - (float)((float)v9 * *(float *)&dword_180277038)) > 0.0 )
  {
    *(_DWORD *)(a1 + 8) = 2;
    return 1LL;
  }
