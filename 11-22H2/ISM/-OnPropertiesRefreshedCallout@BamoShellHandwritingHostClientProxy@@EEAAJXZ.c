/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoShellHandwritingHostClientProxy@@EEAAJXZ @ 0x180075370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoShellHandwritingHostClientProxy::OnPropertiesRefreshedCallout(
        BamoShellHandwritingHostClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoShellHandwritingHostClientProxyImpl>::CalloutWrapper<BamoImpl::BamoShellHandwritingHostClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoShellHandwritingHostClientProxy *))(*(_QWORD *)v1 + 48LL))(v1);
