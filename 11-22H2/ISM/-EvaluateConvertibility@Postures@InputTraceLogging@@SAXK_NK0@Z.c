/*
 * XREFs of ?EvaluateConvertibility@Postures@InputTraceLogging@@SAXK_NK0@Z @ 0x18006E278
 * Callers:
...
void __fastcall InputTraceLogging::Postures::EvaluateConvertibility(int a1, char a2, int a3, char a4)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*((_BYTE *)v8 + 16) & 2) != 0 && (*((_QWORD *)v8 + 3) & 2LL) == *((_QWORD *)v8 + 3) )
  {
    ...
    v21 = 1LL;
    v17 = 1LL;
    tlgWriteTransfer_EventWriteTransfer((__int64)v8, (unsigned __int8 *)dword_180234A1F, 0LL, 0LL, 6u, &v13);
  }
}
