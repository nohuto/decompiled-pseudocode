/*
 * XREFs of ?OnHitTest@ShellHandwritingProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x180077E40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ContextualProcessorInitialState *a4)
{
  ...
  *(_DWORD *)a4 = 0;
  ...
  {
    v7 = 1;
    if ( (int)wil::wnf_query_nothrow<bool>((__int64)this, &v8, &v7, (__int64)a4) < 0 || !v8 || v7 )
    {
      *(_DWORD *)a4 = 1;
      *((_BYTE *)this + 48) = 0;
    }
