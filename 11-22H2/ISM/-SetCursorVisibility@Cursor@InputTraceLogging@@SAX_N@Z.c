/*
 * XREFs of ?SetCursorVisibility@Cursor@InputTraceLogging@@SAX_N@Z @ 0x180115214
 * Callers:
...
void __fastcall InputTraceLogging::Cursor::SetCursorVisibility(__int64 a1)
{
  ...
  if ( *(_DWORD *)v2 > 4u && (*(_BYTE *)(v2 + 16) & 8) != 0 && (*(_QWORD *)(v2 + 24) & 8LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = v1;
    v6 = 4;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180234122, 0LL, 0LL, 3u, &v4);
  }
}
