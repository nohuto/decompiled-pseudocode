/*
 * XREFs of _HotKeyProcessor::RegisterHotKey_::_1_::catch$43 @ 0x1801FF165
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HotKeyProcessor::RegisterHotKey_::_1_::catch_43(__int64 a1, __int64 a2)
{
