/*
 * XREFs of ?GetHidCapsAndPreparsedData@SpatialRimDevice@SpatialInteractions@Internal@Windows@@UEAAJPEAU_HIDP_CAPS@@PEAPEAU_HIDP_PREPARSED_DATA@@@Z @ 0x18002CEF0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
