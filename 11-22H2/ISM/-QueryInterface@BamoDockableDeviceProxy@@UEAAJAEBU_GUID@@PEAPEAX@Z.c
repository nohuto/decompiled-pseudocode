/*
 * XREFs of ?QueryInterface@BamoDockableDeviceProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013C730
 * Callers:
 *     ?QueryInterface@BamoDockableDeviceProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007AFF0 (-QueryInterface@BamoDockableDeviceProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
