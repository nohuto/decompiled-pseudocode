/*
 * XREFs of ??1?$list@U?$pair@$$CBKUMessageInfo@ResizeProcessor@@@std@@V?$allocator@U?$pair@$$CBKUMessageInfo@ResizeProcessor@@@std@@@2@@std@@QEAA@XZ @ 0x180171828
 * Callers:
 *     _ResizeProcessor::ResizeProcessor_::_1_::dtor$16 @ 0x18017171A (_ResizeProcessor--ResizeProcessor_--_1_--dtor$16.c)
 * Callees:
