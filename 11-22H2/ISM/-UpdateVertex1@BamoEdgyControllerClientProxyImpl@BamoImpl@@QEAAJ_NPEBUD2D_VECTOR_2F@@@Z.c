/*
 * XREFs of ?UpdateVertex1@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NPEBUD2D_VECTOR_2F@@@Z @ 0x180179CC8
 * Callers:
 *     ?Thunk_UpdateVertex1_170@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801795A0 (-Thunk_UpdateVertex1_170@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl.c)
