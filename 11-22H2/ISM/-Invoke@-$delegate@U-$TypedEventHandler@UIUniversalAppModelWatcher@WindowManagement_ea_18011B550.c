/*
 * XREFs of ?Invoke@?$delegate@U?$TypedEventHandler@UIUniversalAppModelWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UUniversalPropertyChangedEventArgs@23456@@Foundation@Windows@winrt@@V_lambda_f7189cc794088eeaf33bed95e453010f_@@@impl@winrt@@UEAAHPEAX0@Z @ 0x18011B550
 * Callers:
 *     <none>
 * Callees:
 *     ??$?RAEBUIUniversalAppModelWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@AEBUUniversalPropertyChangedEventArgs@12345@@_lambda_f7189cc794088eeaf33bed95e453010f_@@QEBA?A_PAEBUIUniversalAppModelWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@AEBUUniversalPropertyChangedEventArgs@23456@@Z @ 0x18011A7F8 (--$-RAEBUIUniversalAppModelWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@AEB.c)
 */
