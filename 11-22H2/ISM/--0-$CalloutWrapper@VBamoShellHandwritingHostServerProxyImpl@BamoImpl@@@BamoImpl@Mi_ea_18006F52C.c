/*
 * XREFs of ??0?$CalloutWrapper@VBamoShellHandwritingHostServerProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoShellHandwritingHostServerProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18006F52C
 * Callers:
