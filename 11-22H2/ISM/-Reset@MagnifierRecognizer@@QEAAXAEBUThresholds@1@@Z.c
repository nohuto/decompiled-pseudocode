/*
 * XREFs of ?Reset@MagnifierRecognizer@@QEAAXAEBUThresholds@1@@Z @ 0x1801DC1B4
 * Callers:
 ...
 *     ??0GestureState@MagnifierRecognizer@@QEAA@XZ @ 0x1801DB06C (--0GestureState@MagnifierRecognizer@@QEAA@XZ.c)
 *     ?_Move_assign@?$_Tree@V?$_Tmap_traits@KUContactState@MagnifierRecognizer@@U?$less@K@std@@V?$allocator@U?$pair@$$CBKUContactState@MagnifierRecognizer@@@std@@@4@$0A@@std@@@std@@AEAAXAEAV12@U_Equal_allocators@2@@Z @ 0x1801DC420 (-_Move_assign@-$_Tree@V-$_Tmap_traits@KUContactState@MagnifierRecognizer@@U-$less@K@std@@V-$allo.c)
 */
...
void __fastcall MagnifierRecognizer::Reset(MagnifierRecognizer *this, const struct MagnifierRecognizer::Thresholds *a2)
{
  ...
  *((_DWORD *)this + 2) = *((_DWORD *)v4 + 2);
  ...
  std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned long const,MagnifierRecognizer::ContactState>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<unsigned long const,MagnifierRecognizer::ContactState>,void *>>>(
    ...
    (__int64)&v6,
    *(_QWORD *)(v6 + 8));
  std::_Deallocate<16,0>((void *)v6, 0x48uLL);
