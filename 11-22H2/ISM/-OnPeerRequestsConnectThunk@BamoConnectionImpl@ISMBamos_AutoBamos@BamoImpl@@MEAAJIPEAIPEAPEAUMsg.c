/*
 * XREFs of ?OnPeerRequestsConnectThunk@BamoConnectionImpl@ISMBamos_AutoBamos@BamoImpl@@MEAAJIPEAIPEAPEAUMsgString@@@Z @ 0x180012810
 * Callers:
 *     <none>
 * Callees:
        ...
        struct MsgString **a4)
{
  ...
  if ( v12 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v16);
  v13 = (*(__int64 (__fastcall **)(__int64, _QWORD, unsigned int *, struct MsgString **))(*(_QWORD *)v8 + 104LL))(
          v8,
          a2,
          a3,
          a4);
