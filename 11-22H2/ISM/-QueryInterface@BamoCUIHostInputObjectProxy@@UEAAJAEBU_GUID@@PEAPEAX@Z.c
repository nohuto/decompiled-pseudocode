/*
 * XREFs of ?QueryInterface@BamoCUIHostInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18014F510
 * Callers:
 *     ?QueryInterface@BamoCUIHostInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B490 (-QueryInterface@BamoCUIHostInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
