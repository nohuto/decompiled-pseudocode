/*
 * XREFs of ?RegisterClient@BamoControllerNavigationManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoControllerNavigationClientPrincipal@@@Z @ 0x18013D74C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *(_QWORD *)&v16 = v19;
      *((_QWORD *)&v16 + 1) = v20;
      return CoreUICallSend(v11, &v16, 2LL, 19LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
