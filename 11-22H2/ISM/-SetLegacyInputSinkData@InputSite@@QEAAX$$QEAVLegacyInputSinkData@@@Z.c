/*
 * XREFs of ?SetLegacyInputSinkData@InputSite@@QEAAX$$QEAVLegacyInputSinkData@@@Z @ 0x180070C3C
 * Callers:
 ...
 *     ??0LegacyInputSinkData@@QEAA@$$QEAV0@@Z @ 0x1800709A4 (--0LegacyInputSinkData@@QEAA@$$QEAV0@@Z.c)
 ...
 *     ?GetProcessId@LegacyInputSinkData@@QEBAIXZ @ 0x18007175C (-GetProcessId@LegacyInputSinkData@@QEBAIXZ.c)
 */
