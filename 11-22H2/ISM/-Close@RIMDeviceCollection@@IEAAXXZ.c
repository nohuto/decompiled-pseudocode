/*
 * XREFs of ?Close@RIMDeviceCollection@@IEAAXXZ @ 0x1800E3D0C
 * Callers:
 *     ?OnFinalRelease@RIMDeviceCollection@@MEAAXXZ @ 0x1800E3440 (-OnFinalRelease@RIMDeviceCollection@@MEAAXXZ.c)
