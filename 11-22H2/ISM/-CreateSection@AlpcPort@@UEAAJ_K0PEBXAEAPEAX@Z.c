/*
 * XREFs of ?CreateSection@AlpcPort@@UEAAJ_K0PEBXAEAPEAX@Z @ 0x180127670
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z @ 0x1801274BC (-ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z.c)
      ...
      if ( PortSection >= 0 )
      {
        ...
        if ( v16 >= 0 )
        {
          ...
          *(_QWORD *)(v17 + 72) = *((_QWORD *)&v20 + 1);
          ...
          SipcPort::AddSectionListEntry(this, v17);
          *a5 = *(void **)(v17 + 24);
          return 0;
        }
