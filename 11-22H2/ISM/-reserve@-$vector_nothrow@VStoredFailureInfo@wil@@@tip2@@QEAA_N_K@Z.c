/*
 * XREFs of ?reserve@?$vector_nothrow@VStoredFailureInfo@wil@@@tip2@@QEAA_N_K@Z @ 0x18006C2F4
 * Callers:
    ...
    if ( *a1 )
    {
      ...
      if ( a1[2] )
      {
        ...
        do
        {
          ...
          *((_QWORD *)v11 + 19) = 0LL;
          *((_QWORD *)v11 + 20) = 0LL;
          wil::StoredFailureInfo::`scalar deleting destructor'((wil::StoredFailureInfo *)((char *)*a1 + (_QWORD)v8 + v9));
          ++v7;
          v8 += 21;
        }
