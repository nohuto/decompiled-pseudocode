/*
 * XREFs of ?GetSizeValid@BamoVirtualTouchpadControllerProxy@@UEAA_NXZ @ 0x180152A70
 * Callers:
...
bool __fastcall BamoVirtualTouchpadControllerProxy::GetSizeValid(BamoVirtualTouchpadControllerProxy *this)
{
