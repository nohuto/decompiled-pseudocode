/*
 * XREFs of ?_Change_array@?$vector@W4GameInputGamepadButtons@@V?$allocator@W4GameInputGamepadButtons@@@std@@@std@@AEAAXQEAW4GameInputGamepadButtons@@_K1@Z @ 0x1801A8C68
 * Callers:
