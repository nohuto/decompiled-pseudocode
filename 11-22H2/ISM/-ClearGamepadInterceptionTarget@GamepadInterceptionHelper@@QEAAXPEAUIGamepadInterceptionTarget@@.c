/*
 * XREFs of ?ClearGamepadInterceptionTarget@GamepadInterceptionHelper@@QEAAXPEAUIGamepadInterceptionTarget@@@Z @ 0x18006A6C0
 * Callers:
        ...
        struct IGamepadInterceptionTarget *a2)
{
  ...
  v10 = a2;
  Microsoft::WRL::ComPtr<IGamepadInterceptionTarget>::InternalAddRef(&v10);
