/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_InputServiceLogon@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18001AFD0
 * Callers:
 ...
 * Callees:
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_InputServiceLogon@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18001B078 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_InputServiceLogon@@@det.c)
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_InputServiceLogon>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_InputServiceLogon>::GetCurrentFeatureEnabledState(a1, &v12, &i);
    v7 = *a2;
    v8 = v6 != 0 ? i : 0;
    for ( i = v8; ; v8 = i )
    {
