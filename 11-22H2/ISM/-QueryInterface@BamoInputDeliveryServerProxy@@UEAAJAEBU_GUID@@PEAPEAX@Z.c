/*
 * XREFs of ?QueryInterface@BamoInputDeliveryServerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013CBB0
 * Callers:
 *     ?QueryInterface@BamoInputDeliveryServerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B110 (-QueryInterface@BamoInputDeliveryServerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
