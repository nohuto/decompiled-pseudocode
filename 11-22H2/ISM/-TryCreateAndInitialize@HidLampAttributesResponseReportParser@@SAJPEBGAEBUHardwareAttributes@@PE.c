/*
 * XREFs of ?TryCreateAndInitialize@HidLampAttributesResponseReportParser@@SAJPEBGAEBUHardwareAttributes@@PEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x180065CC0
 * Callers:
 ...
 *     ??0HidLampAttributesResponseReportParser@@AEAA@XZ @ 0x180104130 (--0HidLampAttributesResponseReportParser@@AEAA@XZ.c)
