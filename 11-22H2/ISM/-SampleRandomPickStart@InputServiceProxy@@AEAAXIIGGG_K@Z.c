/*
 * XREFs of ?SampleRandomPickStart@InputServiceProxy@@AEAAXIIGGG_K@Z @ 0x180182480
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  if ( LatencySampleStartData::MeasureDurationinMS(*((LatencySampleStartData **)this + 7), v23.QuadPart) > 60000.0 )
  {
    if ( (unsigned int)dword_180275508 > 5
      && (qword_180275518 & 0x400000000001LL) != 0
      && (qword_180275520 & 0x400000000001LL) == qword_180275520 )
    {
      v17 = *((_QWORD *)this + 7);
      v24 = *(_QWORD *)(v17 + 40);
