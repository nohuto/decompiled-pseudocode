/*
 * XREFs of ?MPCHolographicInputManager_FocusedAppDisabled3DGamepad_@ISMTracing@@QEAAXAEB_N@Z @ 0x1800C7118
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_FocusedAppDisabled3DGamepad_(ISMTracing *this, const bool *a2)
{
  ...
  if ( *(_DWORD *)v3 > 4u && (*(_BYTE *)(v3 + 16) & 1) != 0 && (*(_QWORD *)(v3 + 24) & 1LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v8 = 1;
    v7 = &v5;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_18023005F, 0LL, 0LL, 3u, &v6);
  }
}
