/*
 * XREFs of ?Materialize_BamoInputDelegationInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x18000B580
 * Callers:
 *     ?Thunk_Materialize_BamoInputDelegationInputObjectProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000B550 (-Thunk_Materialize_BamoInputDelegationInputObjectProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)v15 + 7) = &InputDelegationInputObjectProxy::`vftable'{for `IDelegateInformationProvider'};
  *((_QWORD *)v15 + 8) = &InputDelegationInputObjectProxy::`vftable'{for `IInputSiteClientPrivate'};
  *((_QWORD *)v15 + 9) = &InputDelegationInputObjectProxy::`vftable'{for `IGamepadInterceptionTarget'};
  *((_QWORD *)v15 + 10) = 0LL;
  *((_BYTE *)v15 + 88) = 0;
  *((_QWORD *)v15 + 12) = 0LL;
  *((_QWORD *)v15 + 13) = 0LL;
