/*
 * XREFs of ?OnMessage@BamoInputObserverClientProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x180155920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputObserverClientProxyImpl::OnMessage(
