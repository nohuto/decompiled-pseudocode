/*
 * XREFs of _std::vector_wil::com_ptr_t_BamoInputSpacePayloadPrincipal_wil::err_exception_policy__std::allocator_wil::com_ptr_t_BamoInputSpacePayloadPrincipal_wil::err_exception_policy_____::_Reallocate_exactly_::_1_::catch$0 @ 0x18015FBA1
 * Callers:
 *     <none>
 * Callees:
