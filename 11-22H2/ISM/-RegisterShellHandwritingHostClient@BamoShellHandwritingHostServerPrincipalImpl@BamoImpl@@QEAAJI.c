/*
 * XREFs of ?RegisterShellHandwritingHostClient@BamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180075F40
 * Callers:
 *     ?Thunk_RegisterShellHandwritingHostClient_8@?$IShellHandwritingHostServerPrincipal_Receive@VBamoShellHandwritingHostServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800762D0 (-Thunk_RegisterShellHandwritingHostClient_8@-$IShellHandwritingHostServerPrincipal_Receive@VBamo.c)
 * Callees:
