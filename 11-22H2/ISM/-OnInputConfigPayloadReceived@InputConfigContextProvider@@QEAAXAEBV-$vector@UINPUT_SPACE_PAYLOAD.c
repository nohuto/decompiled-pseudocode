/*
 * XREFs of ?OnInputConfigPayloadReceived@InputConfigContextProvider@@QEAAXAEBV?$vector@UINPUT_SPACE_PAYLOAD@@V?$allocator@UINPUT_SPACE_PAYLOAD@@@std@@@std@@@Z @ 0x180124224
 * Callers:
...
void __fastcall InputConfigContextProvider::OnInputConfigPayloadReceived(InputConfigContextProvider *this, __int64 *a2)
{
  ...
  for ( i = *a2; i != v6; i += 24LL )
  {
    ...
    if ( v9 == *((_QWORD *)v2 + 2) )
    {
      std::vector<INPUT_SPACE_PAYLOAD>::_Emplace_reallocate<INPUT_SPACE_PAYLOAD>((const void **)v2, (_BYTE *)v9, v8);
    }
    else
    {
      *(_OWORD *)v9 = *(_OWORD *)v8;
