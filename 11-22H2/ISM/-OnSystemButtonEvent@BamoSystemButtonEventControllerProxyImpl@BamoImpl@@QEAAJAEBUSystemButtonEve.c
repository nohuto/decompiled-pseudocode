/*
 * XREFs of ?OnSystemButtonEvent@BamoSystemButtonEventControllerProxyImpl@BamoImpl@@QEAAJAEBUSystemButtonEventInfo@@@Z @ 0x18017F56C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v13[1] = v17;
      v14 = v12;
      return CoreUICallSend(v10, v13, 2LL, 84LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
