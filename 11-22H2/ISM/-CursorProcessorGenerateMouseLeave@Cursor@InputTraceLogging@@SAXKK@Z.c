/*
 * XREFs of ?CursorProcessorGenerateMouseLeave@Cursor@InputTraceLogging@@SAXKK@Z @ 0x180166EB4
 * Callers:
 *     ?GenerateMouseLeaveEventMessage@CursorProcessor@@AEBAXKK@Z @ 0x180167200 (-GenerateMouseLeaveEventMessage@CursorProcessor@@AEBAXKK@Z.c)
 * Callees:
