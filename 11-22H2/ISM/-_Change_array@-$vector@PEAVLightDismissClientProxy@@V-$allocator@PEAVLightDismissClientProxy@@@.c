/*
 * XREFs of ?_Change_array@?$vector@PEAVLightDismissClientProxy@@V?$allocator@PEAVLightDismissClientProxy@@@std@@@std@@AEAAXQEAPEAVLightDismissClientProxy@@_K1@Z @ 0x18018052C
 * Callers:
...
__int64 __fastcall std::vector<LightDismissClientProxy *>::_Change_array(__int64 a1, void *a2, __int64 a3, __int64 a4)
{
  ...
  if ( LightDismissProcessor::s_clients )
    std::_Deallocate<16,0>(
      ...
      (qword_180278168 - (_QWORD)LightDismissProcessor::s_clients) & 0xFFFFFFFFFFFFFFF8uLL);
  LightDismissProcessor::s_clients = a2;
  qword_180278160 = (__int64)a2 + 8 * a3;
  result = (__int64)a2 + 8 * a4;
  qword_180278168 = result;
  return result;
}
