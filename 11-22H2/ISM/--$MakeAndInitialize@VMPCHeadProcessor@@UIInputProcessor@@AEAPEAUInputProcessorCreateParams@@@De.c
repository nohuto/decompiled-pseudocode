/*
 * XREFs of ??$MakeAndInitialize@VMPCHeadProcessor@@UIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Details@WRL@Microsoft@@YAJPEAPEAUIInputProcessor@@AEAPEAUInputProcessorCreateParams@@@Z @ 0x1801F6600
 * Callers:
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    *(_WORD *)(v5 + 3664) = 0;
    v11 = v5;
    v10 = 0LL;
    v6 = MPCHeadProcessor::RuntimeClassInitialize((MPCHeadProcessor *)v5, *a2);
    if ( v6 >= 0 )
    {
