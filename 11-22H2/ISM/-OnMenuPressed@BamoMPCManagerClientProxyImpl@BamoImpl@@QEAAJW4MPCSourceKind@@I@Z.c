/*
 * XREFs of ?OnMenuPressed@BamoMPCManagerClientProxyImpl@BamoImpl@@QEAAJW4MPCSourceKind@@I@Z @ 0x18018932C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerClientProxyImpl::OnMenuPressed(__int64 a1)
{
  __int64 v1; // r9
  __int64 v3; // r9
  int v5; // eax
  ...
  else
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      return CoreUICallSend(v7, v9, 2LL, 5LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
