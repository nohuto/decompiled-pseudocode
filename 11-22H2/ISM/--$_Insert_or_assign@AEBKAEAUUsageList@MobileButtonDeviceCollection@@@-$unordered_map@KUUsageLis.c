 ...
 *     ??$?0AEBKAEAUUsageList@MobileButtonDeviceCollection@@@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBKUUsageList@MobileButtonDeviceCollection@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@U?$pair@$$CBKUUsageList@MobileButtonDeviceCollection@@@std@@PEAX@std@@@1@AEBKAEAUUsageList@MobileButtonDeviceCollection@@@Z @ 0x1800EBCA0 (--$-0AEBKAEAUUsageList@MobileButtonDeviceCollection@@@-$_List_node_emplace_op2@V-$allocator@U-$_.c)
        ...
        _OWORD *a4)
{
  ...
  else
  {
    ...
    std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned long const,MobileButtonDeviceCollection::UsageList>,void *>>>::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned long const,MobileButtonDeviceCollection::UsageList>,void *>>>(
      &v19,
      (__int64)(a1 + 2),
      v9,
      a4);
