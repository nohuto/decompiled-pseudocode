/*
 * XREFs of ?OnPnpNotification@PnpDeviceWatcher@@CAXW4DeviceEventId@PnpApiWrapper@@PEAUHSTRING__@@PEAX@Z @ 0x18002AD90
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v6 )
    {
      ...
      *((_DWORD *)v6 + 6) = a1;
      ...
      if ( WindowsDuplicateString(a2, v7 + 4) < 0
        || QueueUserAPC((PAPCFUNC)PnpDeviceWatcher::PnpNotificationApc, *((HANDLE *)a3 + 3), (ULONG_PTR)v7) != 1 )
      {
