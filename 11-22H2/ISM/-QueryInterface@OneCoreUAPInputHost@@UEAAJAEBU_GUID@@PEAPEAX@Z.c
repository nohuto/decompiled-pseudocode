/*
 * XREFs of ?QueryInterface@OneCoreUAPInputHost@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180036DB0
 * Callers:
 *     ?QueryInterface@OneCoreUAPInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180079470 (-QueryInterface@OneCoreUAPInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@OneCoreUAPInputHost@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180079490 (-QueryInterface@OneCoreUAPInputHost@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
