/*
 * XREFs of ?UpdateActivationController@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180027860
 * Callers:
 *     ?Thunk_UpdateActivationController_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A580 (-Thunk_UpdateActivationController_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyI.c)
