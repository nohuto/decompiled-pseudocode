/*
 * XREFs of ?IsTargetHolographic@MPCInputRouter@@AEAA_NPEAUIInputTarget@@@Z @ 0x18011860C
 * Callers:
        ...
        __int64 (__fastcall ***a2)(struct IInputTarget *, GUID *, __int64 *))
{
  ...
  if ( ViewIdFromWindowId )
  {
    ...
    if ( !v12 )
    {
      ...
      v12 = (unsigned int)ViewHelper::GetPresentationModeFromViewId((unsigned __int64)v14, v13) == 1;
    }
  }
  else if ( v24 )
  {
