/*
 * XREFs of ?QueryInterface@BamoInputProcessManagerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013CDF0
 * Callers:
 *     ?QueryInterface@BamoInputProcessManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B190 (-QueryInterface@BamoInputProcessManagerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
