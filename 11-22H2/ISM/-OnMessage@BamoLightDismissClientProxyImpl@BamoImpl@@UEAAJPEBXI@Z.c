/*
 * XREFs of ?OnMessage@BamoLightDismissClientProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18017FEE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoLightDismissClientProxyImpl::OnMessage(
