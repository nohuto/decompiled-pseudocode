/*
 * XREFs of ??0Win32kInterop@@QEAA@XZ @ 0x18003A738
 * Callers:
...
Win32kInterop *__fastcall Win32kInterop::Win32kInterop(Win32kInterop *this)
{
  ...
  *((_QWORD *)this + 25) = 0LL;
  *((_QWORD *)this + 26) = 0LL;
  std::unordered_map<unsigned long,Win32kInterop::TargetingInfo>::unordered_map<unsigned long,Win32kInterop::TargetingInfo>((char *)this + 216);
  *((_QWORD *)this + 35) = 0LL;
  v5 = (char *)this + 288;
  LODWORD(v5) = 0;
