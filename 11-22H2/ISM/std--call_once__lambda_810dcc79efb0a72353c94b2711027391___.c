/*
 * XREFs of std::call_once__lambda_810dcc79efb0a72353c94b2711027391___ @ 0x1800BABA8
 * Callers:
 ...
 *     ??0MPCGestureHandlerManager@@QEAA@XZ @ 0x1800BACA0 (--0MPCGestureHandlerManager@@QEAA@XZ.c)
 */
