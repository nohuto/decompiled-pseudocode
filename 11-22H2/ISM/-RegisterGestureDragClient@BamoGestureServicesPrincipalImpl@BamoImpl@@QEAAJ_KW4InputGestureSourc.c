/*
 * XREFs of ?RegisterGestureDragClient@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJ_KW4InputGestureSourceType@Input@Internal@UI@Windows@@W4InputType@4567@I@Z @ 0x1800272C0
 * Callers:
 *     ?Thunk_RegisterGestureDragClient_219@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180073A60 (-Thunk_RegisterGestureDragClient_219@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesPri.c)
 * Callees:
