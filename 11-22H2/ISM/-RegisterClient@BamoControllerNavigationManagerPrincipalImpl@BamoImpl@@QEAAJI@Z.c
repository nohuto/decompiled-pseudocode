/*
 * XREFs of ?RegisterClient@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18019F84C
 * Callers:
 *     ?Thunk_RegisterClient_8@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801A0420 (-Thunk_RegisterClient_8@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigatio.c)
 * Callees:
