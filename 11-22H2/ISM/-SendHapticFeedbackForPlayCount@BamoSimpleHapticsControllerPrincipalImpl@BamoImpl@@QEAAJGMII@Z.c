/*
 * XREFs of ?SendHapticFeedbackForPlayCount@BamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@QEAAJGMII@Z @ 0x1801BA984
 * Callers:
 *     ?Thunk_SendHapticFeedbackForPlayCount_361@?$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpleHapticsControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180076480 (-Thunk_SendHapticFeedbackForPlayCount_361@-$ISimpleHapticsControllerPrincipal_Receive@VBamoSimpl.c)
 * Callees:
