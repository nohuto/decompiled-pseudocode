/*
 * XREFs of ?save_nothrow@tson@@YAXAEAVoutput_archive@1@AEAUtest_flag@tip2@@@Z @ 0x18006C660
 * Callers:
 ...
 *     ?make_string_tag@tson@@YA?AUstring_tag@1@PEBG@Z @ 0x18006C008 (-make_string_tag@tson@@YA-AUstring_tag@1@PEBG@Z.c)
