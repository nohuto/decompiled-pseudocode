/*
 * XREFs of ?Initialize@ButtonRecognizer@@IEAAJXZ @ 0x1801D3654
 * Callers:
...
LABEL_13:
  ...
  v13 = *v2;
  v14 = *(__int64 (__fastcall **)(wil::details *, __int64 (__fastcall *)(void *, const void *, int), ButtonRecognizer *, _QWORD, char *))(*(_QWORD *)*v2 + 104LL);
  wil::unique_com_token<IMessageSession,unsigned __int64,void (IMessageSession *,unsigned __int64),&void wil::details::IMessageSessionCloseEndpointFunction(IMessageSession *,unsigned __int64),0>::reset(
    (wil::details **)this + 21,
    *((wil::details **)this + 21),
    v12);
...
LABEL_18:
  ...
  Microsoft::WRL::ComPtr<HotkeyRegistrationForwarder>::InternalRelease(&v24);
  v19 = *v2;
  v20 = *(__int64 (__fastcall **)(wil::details *, __int64 (__fastcall *)(__int64), ButtonRecognizer *, char *))(*(_QWORD *)v19 + 144LL);
  Microsoft::WRL::ComPtr<IRawInputProvider>::InternalRelease((__int64 *)this + 19);
