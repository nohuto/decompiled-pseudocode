/*
 * XREFs of McGenEventUnregister_EventUnregister @ 0x1801DEA3C
 * Callers:
 *     _anonymous_namespace_::EtwLogRegistrar::_EtwLogRegistrar @ 0x1800563C4 (_anonymous_namespace_--EtwLogRegistrar--_EtwLogRegistrar.c)
 * Callees:
 *     <none>
 */
