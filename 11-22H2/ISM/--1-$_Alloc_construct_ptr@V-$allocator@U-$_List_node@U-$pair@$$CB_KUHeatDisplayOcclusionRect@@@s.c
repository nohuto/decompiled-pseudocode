/*
 * XREFs of ??1?$_Alloc_construct_ptr@V?$allocator@U?$_List_node@U?$pair@$$CB_KUHeatDisplayOcclusionRect@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1801B0E4C
 * Callers:
 *     _std::_List_node_emplace_op2_std::allocator_std::_List_node_std::pair_unsigned___int64_const__HeatDisplayOcclusionRect__void_______::_List_node_emplace_op2_std::allocator_std::_List_node_std::pair_unsigned___int64_const__HeatDisplayOcclusionRect__void________unsigned___int64_&_HeatDisplayOcclusionRect__::_1_::dtor$0 @ 0x1801AFC0F (_std--_List_node_emplace_op2_std--allocator_std--_List_node_std--pair_unsigned___int64_const__He.c)
 *     _std::_Hash_std::_Umap_traits_unsigned___int64_HeatDisplayOcclusionRect_std::_Uhash_compare_unsigned___int64_std::hash_unsigned___int64__std::equal_to_unsigned___int64____std::allocator_std::pair_unsigned___int64_const__HeatDisplayOcclusionRect____0___::emplace_unsigned___int64_&_HeatDisplayOcclusionRect__::_1_::dtor$0 @ 0x1801B065D (_std--_Hash_std--_Umap_traits_unsigned___int64_HeatDisplayOcclusionRect_std--_Uhash_compare_unsi.c)
 * Callees:
