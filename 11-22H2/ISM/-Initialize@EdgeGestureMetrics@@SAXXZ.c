/*
 * XREFs of ?Initialize@EdgeGestureMetrics@@SAXXZ @ 0x1801D8360
 * Callers:
 ...
 *     ??$make_shared@VEdgeGestureMetrics@@$$V@std@@YA?AV?$shared_ptr@VEdgeGestureMetrics@@@0@XZ @ 0x1801D8174 (--$make_shared@VEdgeGestureMetrics@@$$V@std@@YA-AV-$shared_ptr@VEdgeGestureMetrics@@@0@XZ.c)
