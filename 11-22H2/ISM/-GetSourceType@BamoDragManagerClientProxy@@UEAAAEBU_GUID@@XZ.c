/*
 * XREFs of ?GetSourceType@BamoDragManagerClientProxy@@UEAAAEBU_GUID@@XZ @ 0x180163A00
 * Callers:
 *     <none>
 * Callees:
...
const struct _GUID *__fastcall BamoDragManagerClientProxy::GetSourceType(BamoDragManagerClientProxy *this)
{
