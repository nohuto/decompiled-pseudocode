/*
 * XREFs of ?RemoteClear@?$ListProxyCommon@VBamoList_DisplayOcclusionRect_Proxy@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UDisplayOcclusionRect@@@Bamo@Microsoft@@MEAAJXZ @ 0x180157E90
 * Callers:
 *     <none>
 * Callees:
