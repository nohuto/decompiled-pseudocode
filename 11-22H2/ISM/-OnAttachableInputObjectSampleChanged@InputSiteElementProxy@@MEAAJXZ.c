/*
 * XREFs of ?OnAttachableInputObjectSampleChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000E540
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  for ( i = *(_QWORD *)(v5 + 488); i != v6; i += 16LL )
  {
    ...
    if ( v24 )
    {
      ...
      v12 = v26(v9, &GUID_0d0ff390_1722_d77a_3592_c63ca2dc2e3a, &v24);
    }
    else
    {
      v12 = v10(v9, &GUID_0d0ff390_1722_d77a_3592_c63ca2dc2e3a, &v24);
    }
    v13 = v12 >= 0;
    if ( v8 == this && v13 )
      break;
