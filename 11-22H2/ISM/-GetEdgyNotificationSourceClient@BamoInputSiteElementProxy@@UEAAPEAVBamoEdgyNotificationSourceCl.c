/*
 * XREFs of ?GetEdgyNotificationSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoEdgyNotificationSourceClientProxy@@XZ @ 0x1800120F0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoEdgyNotificationSourceClientProxy *)*((_QWORD *)this + 23);
}
