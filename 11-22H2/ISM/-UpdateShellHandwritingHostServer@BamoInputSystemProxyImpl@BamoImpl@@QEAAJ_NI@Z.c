/*
 * XREFs of ?UpdateShellHandwritingHostServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180070284
 * Callers:
 *     ?Thunk_UpdateShellHandwritingHostServer_8@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180070270 (-Thunk_UpdateShellHandwritingHostServer_8@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@.c)
