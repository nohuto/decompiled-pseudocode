/*
 * XREFs of ?OnMessage@BamoPenDeviceManagerPrincipalImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x1801B3620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenDeviceManagerPrincipalImpl::OnMessage(
