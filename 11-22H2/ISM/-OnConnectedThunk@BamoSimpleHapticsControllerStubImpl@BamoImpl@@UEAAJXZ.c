/*
 * XREFs of ?OnConnectedThunk@BamoSimpleHapticsControllerStubImpl@BamoImpl@@UEAAJXZ @ 0x1801B99D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSimpleHapticsControllerStubImpl::OnConnectedThunk(
