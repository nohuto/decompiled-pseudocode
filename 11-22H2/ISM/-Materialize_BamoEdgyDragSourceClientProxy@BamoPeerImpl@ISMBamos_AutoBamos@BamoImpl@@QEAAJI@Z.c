/*
 * XREFs of ?Materialize_BamoEdgyDragSourceClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180134CA0
 * Callers:
 *     ?Thunk_Materialize_BamoEdgyDragSourceClientProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141510 (-Thunk_Materialize_BamoEdgyDragSourceClientProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
