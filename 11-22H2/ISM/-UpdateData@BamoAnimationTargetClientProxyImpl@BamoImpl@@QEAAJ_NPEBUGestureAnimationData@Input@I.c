/*
 * XREFs of ?UpdateData@BamoAnimationTargetClientProxyImpl@BamoImpl@@QEAAJ_NPEBUGestureAnimationData@Input@Internal@UI@Windows@@@Z @ 0x180054FBC
 * Callers:
 *     ?Thunk_UpdateData_28@?$IAnimationTargetClientProxy_Receive@VBamoAnimationTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180055DB0 (-Thunk_UpdateData_28@-$IAnimationTargetClientProxy_Receive@VBamoAnimationTargetClientProxyImpl@B.c)
