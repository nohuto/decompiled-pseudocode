/*
 * XREFs of ?UpdateDragSourceClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1800108D0
 * Callers:
 *     ?Thunk_UpdateDragSourceClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A440 (-Thunk_UpdateDragSourceClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@.c)
