/*
 * XREFs of ??$emplace_back@AEAUINPUT_SPACE_PAYLOAD@@@?$vector@UInputSpacePayload@@V?$allocator@UInputSpacePayload@@@std@@@std@@QEAA?A_TAEAUINPUT_SPACE_PAYLOAD@@@Z @ 0x1801B0A3C
 * Callers:
