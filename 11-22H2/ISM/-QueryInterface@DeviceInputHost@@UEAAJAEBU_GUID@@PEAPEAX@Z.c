/*
 * XREFs of ?QueryInterface@DeviceInputHost@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A99D0
 * Callers:
 *     ?QueryInterface@DeviceInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180079530 (-QueryInterface@DeviceInputHost@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
