/*
 * XREFs of ?UpdateDevicesRemoteCache@BamoPenDeviceManagerPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801B41DC
 * Callers:
 *     ?PushStateToProxyOnOutboundMessagesResumed@BamoPenDeviceManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1801B3790 (-PushStateToProxyOnOutboundMessagesResumed@BamoPenDeviceManagerPrincipalImpl@BamoImpl@@UEAAXPEAU.c)
