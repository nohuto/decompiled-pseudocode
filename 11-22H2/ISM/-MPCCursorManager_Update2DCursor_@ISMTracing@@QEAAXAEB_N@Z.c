/*
 * XREFs of ?MPCCursorManager_Update2DCursor_@ISMTracing@@QEAAXAEB_N@Z @ 0x1800CD95C
 * Callers:
...
void __fastcall ISMTracing::MPCCursorManager_Update2DCursor_(ISMTracing *this, const bool *a2)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 1) != 0 && (*(_QWORD *)(v4 + 24) & 1LL) == *(_QWORD *)(v4 + 24) )
    {
      ...
      v9 = 1;
      v8 = &v6;
      tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_180230B33, 0LL, 0LL, 3u, &v7);
    }
  }
}
