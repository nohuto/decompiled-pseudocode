/*
 * XREFs of ?UpdateGestureTimeoutInMilliseconds@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180144F00
 * Callers:
 *     ?Thunk_UpdateGestureTimeoutInMilliseconds_8@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141EB0 (-Thunk_UpdateGestureTimeoutInMilliseconds_8@-$IEdgyGestureRecognitionConfigurationProxy_Receive@.c)
