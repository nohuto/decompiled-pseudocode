/*
 * XREFs of ?GetScaleOverride@BamoSystemCursorControllerClientProxy@@UEAAMXZ @ 0x1801337A0
 * Callers:
 *     <none>
 * Callees:
...
float __fastcall BamoSystemCursorControllerClientProxy::GetScaleOverride(BamoSystemCursorControllerClientProxy *this)
{
  float v2; // xmm6_4
  __int64 v3; // rdx
  __int64 v4; // r8
