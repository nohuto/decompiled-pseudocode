/*
 * XREFs of ?MPCHolographicInputManager_RequestForegroundChange_@ISMTracing@@QEAAX_K0KK_N@Z @ 0x1800C7960
 * Callers:
        ...
        bool a6)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
      ...
      && (*(_QWORD *)(v10 + 24) & 1LL) == *(_QWORD *)(v10 + 24) )
    {
      ...
      v15 = a2;
      v30 = 1;
      tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1802301B0, 0LL, 0LL, 7u, &v16);
    }
  }
}
