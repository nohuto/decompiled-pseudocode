/*
 * XREFs of ?GetToggleEnabled@BamoMagnifierControllerProxy@@UEAA_NXZ @ 0x18017A470
 * Callers:
...
bool __fastcall BamoMagnifierControllerProxy::GetToggleEnabled(BamoMagnifierControllerProxy *this)
{
