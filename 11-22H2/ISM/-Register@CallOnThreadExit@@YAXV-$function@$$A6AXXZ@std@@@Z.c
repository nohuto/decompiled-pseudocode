/*
 * XREFs of ?Register@CallOnThreadExit@@YAXV?$function@$$A6AXXZ@std@@@Z @ 0x18014EB38
 * Callers:
...
__int64 __fastcall CallOnThreadExit::Register(__int64 a1)
{
  ...
  v2 = _Mtx_lock((_Mtx_t)&unk_1802780E0);
  if ( v2 )
    std::_Throw_C_error(v2);
  std::list<CallOnThreadExit::CallbackData>::_Emplace<>(v3, xmmword_1802784D0);
  v5 = *(_QWORD *)(xmmword_1802784D0 + 8) + 16LL;
  if ( v5 != a1 )
  {
    std::_Func_class<void,_MIT_KEYBOARD_INPUT_MESSAGE const *>::_Tidy(*(_QWORD *)(xmmword_1802784D0 + 8) + 16LL, v4);
