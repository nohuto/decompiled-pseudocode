/*
 * XREFs of ??1?$list@U?$pair@$$CBW4EdgyLocation@ShellEdgyRecognizer@@V?$vector@UGestureRegistration@ShellGesturesProcessor@@V?$allocator@UGestureRegistration@ShellGesturesProcessor@@@std@@@std@@@std@@V?$allocator@U?$pair@$$CBW4EdgyLocation@ShellEdgyRecognizer@@V?$vector@UGestureRegistration@ShellGesturesProcessor@@V?$allocator@UGestureRegistration@ShellGesturesProcessor@@@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1801C5628
 * Callers:
 *     _ShellGesturesProcessor::ShellGesturesProcessor_::_1_::dtor$13 @ 0x180082251 (_ShellGesturesProcessor--ShellGesturesProcessor_--_1_--dtor$13.c)
 * Callees:
