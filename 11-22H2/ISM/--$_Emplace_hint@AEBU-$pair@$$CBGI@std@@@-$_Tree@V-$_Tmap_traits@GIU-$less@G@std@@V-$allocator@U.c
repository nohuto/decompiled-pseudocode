/*
 * XREFs of ??$_Emplace_hint@AEBU?$pair@$$CBGI@std@@@?$_Tree@V?$_Tmap_traits@GIU?$less@G@std@@V?$allocator@U?$pair@$$CBGI@std@@@2@$0A@@std@@@std@@IEAAPEAU?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@1@QEAU21@AEBU?$pair@$$CBGI@1@@Z @ 0x180064D98
 * Callers:
 ...
 * Callees:
 *     ??$?0AEBU?$pair@$$CBGI@std@@@?$_Tree_temp_node@V?$allocator@U?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@$$CBGI@std@@PEAX@1@AEBU?$pair@$$CBGI@1@@Z @ 0x180064D00 (--$-0AEBU-$pair@$$CBGI@std@@@-$_Tree_temp_node@V-$allocator@U-$_Tree_node@U-$pair@$$CBGI@std@@PE.c)
 ...
 *     ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CB_KUGestureAnimationData@Input@Internal@UI@Windows@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800650B4 (--1-$_List_node_emplace_op2@V-$allocator@U-$_List_node@U-$pair@$$CB_KUGestureAnimationData@Input.c)
        ...
        _QWORD *a3)
{
  ...
  if ( (_BYTE)v11 )
    return v10;
  if ( qword_180278030 == 0x666666666666666LL )
