/*
 * XREFs of ??$_Emplace_reallocate@AEBUDisplayOcclusionRect@@@?$vector@UDisplayOcclusionRect@@V?$allocator@UDisplayOcclusionRect@@@std@@@std@@QEAAPEAUDisplayOcclusionRect@@QEAU2@AEBU2@@Z @ 0x180157574
 * Callers:
 ...
 *     ?_Change_array@?$vector@UDisplayOcclusionRect@@V?$allocator@UDisplayOcclusionRect@@@std@@@std@@AEAAXQEAUDisplayOcclusionRect@@_K1@Z @ 0x180158860 (-_Change_array@-$vector@UDisplayOcclusionRect@@V-$allocator@UDisplayOcclusionRect@@@std@@@std@@A.c)
 */

char *__fastcall std::vector<DisplayOcclusionRect>::_Emplace_reallocate<DisplayOcclusionRect const &>(
        const void **a1,
        _BYTE *a2,
        _OWORD *a3)
{
