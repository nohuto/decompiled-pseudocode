/*
 * XREFs of ?RemoteInsert@BamoList_DisplayOcclusionRect_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJIAEBUDisplayOcclusionRect@@@Z @ 0x18015E04C
 * Callers:
 *     ?CallRemoteInsertOnStub@BamoList_DisplayOcclusionRect_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@CAJPEAVBamoStubImpl@36@IAEBUDisplayOcclusionRect@@@Z @ 0x18015B7E4 (-CallRemoteInsertOnStub@BamoList_DisplayOcclusionRect_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@.c)
        ...
        const char *a4)
{
  ...
  __int128 v16; // xmm0
  __int128 v17; // xmm1
  struct IMessageCallSendHost *v18; // [rsp+40h] [rbp-E8h] BYREF
  _QWORD v19[3]; // [rsp+48h] [rbp-E0h] BYREF
  ...
  __int128 v29; // [rsp+F0h] [rbp-38h]
  __int128 v30; // [rsp+100h] [rbp-28h]
  wil::details::in1diag3 *retaddr; // [rsp+128h] [rbp+0h]
  unsigned int v32; // [rsp+130h] [rbp+8h] BYREF
  unsigned int v33; // [rsp+148h] [rbp+20h] BYREF
