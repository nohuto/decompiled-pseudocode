/*
 * XREFs of ??0MPCHeadMovementDetector@@QEAA@XZ @ 0x1800DFCE8
 * Callers:
 ...
 *     ?ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ @ 0x1800E08E8 (-ScheduleNextTimerCallback@MPCHeadMovementDetector@@AEAAXXZ.c)
