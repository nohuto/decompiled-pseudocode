/*
 * XREFs of ?ServerCreated@VirtualTouchpad@InputTraceLogging@@SAXPEBX@Z @ 0x180153ACC
 * Callers:
...
void __fastcall InputTraceLogging::VirtualTouchpad::ServerCreated(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = a1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_180234EB2, 0LL, 0LL, 3u, &v4);
  }
}
