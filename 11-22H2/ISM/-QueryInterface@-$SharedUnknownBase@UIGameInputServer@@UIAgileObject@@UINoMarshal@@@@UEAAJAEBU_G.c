/*
 * XREFs of ?QueryInterface@?$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18006D9E0
 * Callers:
 *     ?QueryInterface@?$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007ADB0 (-QueryInterface@-$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@W7EAAJAEBU_.c)
 *     ?QueryInterface@?$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007ADD0 (-QueryInterface@-$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@WBA@EAAJAEB.c)
 * Callees:
 *     ?AddPublicReference@SharedObjectBase@@IEAAIXZ @ 0x18001B980 (-AddPublicReference@SharedObjectBase@@IEAAIXZ.c)
 *     ??$TryCastToInterface@V?$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@@?$InterfaceIterator@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@?$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@SAPEAXPEAV1@AEBU_GUID@@@Z @ 0x18006D63C (--$TryCastToInterface@V-$SharedUnknownBase@UIGameInputServer@@UIAgileObject@@UINoMarshal@@@@@-$I.c)
 */
