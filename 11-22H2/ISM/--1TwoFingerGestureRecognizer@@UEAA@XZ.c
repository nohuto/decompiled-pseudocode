/*
 * XREFs of ??1TwoFingerGestureRecognizer@@UEAA@XZ @ 0x1801E0CCC
 * Callers:
 *     _GestureSession::GestureSession_::_1_::dtor$4 @ 0x1801E0CB0 (_GestureSession--GestureSession_--_1_--dtor$4.c)
 * Callees:
 *     <none>
 */
