/*
 * XREFs of ?UpdateEdgyDragSourceClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010800
 * Callers:
 *     ?Thunk_UpdateEdgyDragSourceClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A400 (-Thunk_UpdateEdgyDragSourceClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyI.c)
