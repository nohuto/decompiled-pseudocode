/*
 * XREFs of ??$_Try_emplace@AEBI$$V@?$_Hash@V?$_Umap_traits@IUActiveContactData@ShellGesturesProcessor@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@U?$pair@$$CBIUActiveContactData@ShellGesturesProcessor@@@std@@@4@$0A@@std@@@std@@IEAA?AU?$pair@PEAU?$_List_node@U?$pair@$$CBIUActiveContactData@ShellGesturesProcessor@@@std@@PEAX@std@@_N@1@AEBI@Z @ 0x18017C574
 * Callers:
        ...
        unsigned __int8 *a3)
{
  ...
  else
  {
    ...
    v16 = a1 + 2;
    v17 = 0LL;
    v7 = std::_Allocate<16,std::_Default_allocate_traits,0>(0x80uLL);
    v17 = v7;
    v7[4] = *(_DWORD *)a3;
    memset_0(v7 + 6, 0, 0x68uLL);
    v8 = *((_QWORD *)a1 + 2) + 1LL;
    if ( v8 < 0 )
