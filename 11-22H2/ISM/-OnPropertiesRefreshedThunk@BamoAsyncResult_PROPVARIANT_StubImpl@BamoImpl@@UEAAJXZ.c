/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoAsyncResult_PROPVARIANT_StubImpl@BamoImpl@@UEAAJXZ @ 0x18019BEA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoAsyncResult_PROPVARIANT_StubImpl::OnPropertiesRefreshedThunk(
