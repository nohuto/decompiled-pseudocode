/*
 * XREFs of ?QueryInterface@BamoControllerNavigationClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A14D0
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007D570 (-QueryInterface@BamoControllerNavigationClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
