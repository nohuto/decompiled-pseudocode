/*
 * XREFs of wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x180059E1C
 * Callers:
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x18005A00C (wil_details_FeatureReporting_RecordUsageInCache.c)
 * Callees:
 *     <none>
 */
