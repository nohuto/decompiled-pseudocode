/*
 * XREFs of ?finishNode@output_archive@tson@@QEAAXXZ @ 0x18006BB90
 * Callers:
 ...
 *     ?set_position@write_buffer@tson@@QEAAX_K@Z @ 0x18006CEA8 (-set_position@write_buffer@tson@@QEAAX_K@Z.c)
