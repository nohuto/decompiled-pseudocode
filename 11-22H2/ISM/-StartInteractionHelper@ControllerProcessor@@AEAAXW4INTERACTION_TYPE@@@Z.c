/*
 * XREFs of ?StartInteractionHelper@ControllerProcessor@@AEAAXW4INTERACTION_TYPE@@@Z @ 0x1801A6620
 * Callers:
 ...
 *     ?SetZoomIncreasingThresholds@ManipulationInjector@@QEAAXJJ@Z @ 0x18012B5B8 (-SetZoomIncreasingThresholds@ManipulationInjector@@QEAAXJJ@Z.c)
 ...
 *     ?GetDisplaySizeScaleFactor@ControllerProcessor@@AEAAMXZ @ 0x1801A41E4 (-GetDisplaySizeScaleFactor@ControllerProcessor@@AEAAMXZ.c)
 */
