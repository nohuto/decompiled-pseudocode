/*
 * XREFs of ??1?$set@V?$shared_ptr@UHotKeyInfo@@@std@@U?$less@V?$shared_ptr@UHotKeyInfo@@@std@@@2@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@QEAA@XZ @ 0x1801FDBC8
 * Callers:
 ...
 *     _HotKeyProcessor::DetectAndProcessHotKey_::_1_::dtor$4 @ 0x1800791F6 (_HotKeyProcessor--DetectAndProcessHotKey_--_1_--dtor$4.c)
 * Callees:
