/*
 * XREFs of _std::vector_VirtualTouchpadRect_std::allocator_VirtualTouchpadRect___::_Emplace_reallocate_VirtualTouchpadRect_const_&__::_1_::catch$23 @ 0x180158A88
 * Callers:
 *     <none>
 * Callees:
