/*
 * XREFs of ?UpdateCursorVisibility@MPCCursorManager@@AEAAX_N00@Z @ 0x1800CDCCC
 * Callers:
 ...
 *     ?ProcessProviderDemoted@MPCCursorManager@@QEAAJPEAUIMPCInputProviderBase@@@Z @ 0x1800CDA00 (-ProcessProviderDemoted@MPCCursorManager@@QEAAJPEAUIMPCInputProviderBase@@@Z.c)
        ...
        char a4)
{
  ...
  v6 = (4 * a3) | ((*((_BYTE *)MPCHolographicInputManager::GetInstance() + 3366) | a2) != 0 ? 2 : 0) | (*((_BYTE *)this + 56) != 0 ? 8 : 0) | (*((_BYTE *)this + 65) != 0 ? 0x10 : 0);
