/*
 * XREFs of ?InitializeProxyThunk@BamoPenDeviceManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x180019530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenDeviceManagerStubImpl::InitializeProxyThunk(
