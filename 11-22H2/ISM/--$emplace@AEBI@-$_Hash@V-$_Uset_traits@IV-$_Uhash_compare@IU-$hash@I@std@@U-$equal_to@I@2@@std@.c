/*
 * XREFs of ??$emplace@AEBI@?$_Hash@V?$_Uset_traits@IV?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@I@2@$0A@@std@@@std@@QEAA?AU?$pair@V?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@I@std@@@std@@@std@@_N@1@AEBI@Z @ 0x18003A494
 * Callers:
 ...
 *     ?_Rehash_for_1@?$_Hash@V?$_Uset_traits@IV?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@I@2@$0A@@std@@@std@@IEAAXXZ @ 0x1801624D4 (-_Rehash_for_1@-$_Hash@V-$_Uset_traits@IV-$_Uhash_compare@IU-$hash@I@std@@U-$equal_to@I@2@@std@@.c)
 */
        ...
        const unsigned __int8 *a3)
{
  ...
  else
  {
    ...
    v11 = a1 + 1;
    v12 &= *((_QWORD *)&v10 + 1);
    size_of = std::_Get_size_of_n<24>((unsigned int)(DWORD2(v10) + 1));
    v8 = std::_Allocate<16,std::_Default_allocate_traits,0>(size_of);
    v12 = (unsigned __int64)v8;
    v8[4] = *(_DWORD *)a3;
    if ( std::_Hash<std::_Uset_traits<unsigned int,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<unsigned int>,0>>::_Check_rehash_required_1((__int64)a1) )
    {
