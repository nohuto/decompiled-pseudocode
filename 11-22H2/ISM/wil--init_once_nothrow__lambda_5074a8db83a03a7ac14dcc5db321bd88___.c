/*
 * XREFs of wil::init_once_nothrow__lambda_5074a8db83a03a7ac14dcc5db321bd88___ @ 0x180026FA0
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  if ( !__std_init_once_begin_initialize(&stru_180277F38, 0, &fPending, 0LL) )
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0x253, (unsigned int)"wil", v4);
  if ( fPending )
  {
    SystemInformation = 8LL;
    if ( NtQuerySystemInformation(MaxSystemInfoClass|SystemProcessInformation, &SystemInformation, 8u, 0LL) >= 0 )
      byte_180277920 = (SystemInformation & 0x200000000LL) != 0;
    if ( a3 )
      *a3 = 1;
    InitOnceComplete(&stru_180277F38, 0, 0LL);
  }
  return 0LL;
}
