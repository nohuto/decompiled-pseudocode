/*
 * XREFs of ?OnDisconnectedCallout@BamoInputSystemProxy@@EEAAJXZ @ 0x180138C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputSystemProxy::OnDisconnectedCallout(BamoInputSystemProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputSystemProxyImpl>::CalloutWrapper<BamoImpl::BamoInputSystemProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoInputSystemProxy *))(*(_QWORD *)v1 + 40LL))(v1);
