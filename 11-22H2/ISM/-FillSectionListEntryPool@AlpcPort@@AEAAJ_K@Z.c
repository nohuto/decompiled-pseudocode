/*
 * XREFs of ?FillSectionListEntryPool@AlpcPort@@AEAAJ_K@Z @ 0x180127F14
 * Callers:
 ...
 *     ?PushBack@?$NtList@UAlpcSectionListEntry@AlpcPort@@@@QEAAXPEAUAlpcSectionListEntry@AlpcPort@@@Z @ 0x180129014 (-PushBack@-$NtList@UAlpcSectionListEntry@AlpcPort@@@@QEAAXPEAUAlpcSectionListEntry@AlpcPort@@@Z.c)
 */
