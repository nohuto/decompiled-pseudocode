/*
 * XREFs of ?MPCHolographicInputManager_OnKeyboardKeyPress_@ISMTracing@@QEAAXJKK_N@Z @ 0x1800C7378
 * Callers:
        ...
        bool a5)
{
  ...
  if ( *(_DWORD *)v8 > 5u && (*(_BYTE *)(v8 + 16) & 1) != 0 && (*(_QWORD *)(v8 + 24) & 1LL) == *(_QWORD *)(v8 + 24) )
  {
    ...
    v17 = 4LL;
    v15 = 4LL;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_18022FFEB, 0LL, 0LL, 6u, &v13);
  }
}
