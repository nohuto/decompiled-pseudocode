  ...
  try
  {
    ...
    *((_QWORD *)v15 + 2) = v16;
    ...
    std::_Uninitialized_move<std::vector<HidChannelValueInfo> *,std::allocator<std::vector<HidChannelValueInfo>>>(
      ...
      v19,
      v20);
    std::vector<std::vector<HidChannelValueInfo>>::_Change_array(a1, v14, v9, v8, v23);
    result = v15;
  }
  catch ( ... )
  {
    std::_Destroy_range<std::allocator<std::vector<HidChannelValueInfo>>>(v25, (__int64)(v15 + 24));
    std::_Deallocate<16,0>(v24, 24 * v8);
    throw;
  }
  return result;
}
