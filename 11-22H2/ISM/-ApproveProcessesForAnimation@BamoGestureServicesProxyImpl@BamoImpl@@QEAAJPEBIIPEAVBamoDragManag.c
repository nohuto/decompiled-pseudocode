/*
 * XREFs of ?ApproveProcessesForAnimation@BamoGestureServicesProxyImpl@BamoImpl@@QEAAJPEBIIPEAVBamoDragManagerClientPrincipal@@@Z @ 0x18013050C
 * Callers:
  ...
  else
  {
    if ( a4 )
      Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteReference(
        ...
        a4);
    v9 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(this, v17, &v21, &v16);
    v10 = v9;
    if ( v9 >= 0 )
    {
      v11 = *((_BYTE *)this + 31) == 0;
