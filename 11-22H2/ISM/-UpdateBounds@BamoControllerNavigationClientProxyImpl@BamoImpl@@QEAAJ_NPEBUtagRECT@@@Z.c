/*
 * XREFs of ?UpdateBounds@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@@Z @ 0x1801A1724
 * Callers:
 *     ?Thunk_UpdateBounds_57@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801A15F0 (-Thunk_UpdateBounds_57@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClien.c)
