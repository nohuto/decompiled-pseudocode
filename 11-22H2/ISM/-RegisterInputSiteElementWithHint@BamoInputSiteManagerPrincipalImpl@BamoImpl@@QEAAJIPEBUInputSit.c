/*
 * XREFs of ?RegisterInputSiteElementWithHint@BamoInputSiteManagerPrincipalImpl@BamoImpl@@QEAAJIPEBUInputSiteId@@@Z @ 0x180025534
 * Callers:
 *     ?Thunk_RegisterInputSiteElementWithHint_262@?$IInputSiteManagerPrincipal_Receive@VBamoInputSiteManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800715C0 (-Thunk_RegisterInputSiteElementWithHint_262@-$IInputSiteManagerPrincipal_Receive@VBamoInputSiteM.c)
 * Callees:
