/*
 * XREFs of ?UpdateIsIntensitySupported@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x1801464B0
 * Callers:
 *     ?Thunk_UpdateIsIntensitySupported_11@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180142030 (-Thunk_UpdateIsIntensitySupported_11@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsC.c)
