/*
 * XREFs of ??_GBamoActivatableEntityPrincipalImpl@BamoImpl@@UEAAPEAXI@Z @ 0x1800B8B10
 * Callers:
 *     <none>
 * Callees:
...
BamoImpl::BamoActivatableEntityPrincipalImpl *__fastcall BamoImpl::BamoActivatableEntityPrincipalImpl::`scalar deleting destructor'(
