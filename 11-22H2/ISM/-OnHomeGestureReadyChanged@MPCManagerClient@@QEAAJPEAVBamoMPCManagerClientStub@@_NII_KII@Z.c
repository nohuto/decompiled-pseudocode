/*
 * XREFs of ?OnHomeGestureReadyChanged@MPCManagerClient@@QEAAJPEAVBamoMPCManagerClientStub@@_NII_KII@Z @ 0x180188FF4
 * Callers:
 *     ?OnHomeGestureReadyChanged@MPCManagerClientPrincipal@@UEAAJPEAVBamoMPCManagerClientStub@@_NII_KII@Z @ 0x18018D3E0 (-OnHomeGestureReadyChanged@MPCManagerClientPrincipal@@UEAAJPEAVBamoMPCManagerClientStub@@_NII_KI.c)
 * Callees:
 ...
 *     ??$Make@VHomeGestureReadyChangedEventArgs@@AEA_NAEAIAEAIAEA_KAEAIAEAI@Details@WRL@Microsoft@@YA?AV?$ComPtr@VHomeGestureReadyChangedEventArgs@@@12@AEA_NAEAI1AEA_K11@Z @ 0x180184ED0 (--$Make@VHomeGestureReadyChangedEventArgs@@AEA_NAEAIAEAIAEA_KAEAIAEAI@Details@WRL@Microsoft@@YA-.c)
 */
        ...
        ...)
{
  ...
  HomeGestureReadyChangedEventArgs *v13; // [rsp+40h] [rbp-20h] BYREF
  ...
  Microsoft::WRL::Details::Make<HomeGestureReadyChangedEventArgs,bool &,unsigned int &,unsigned int &,unsigned __int64 &,unsigned int &,unsigned int &>(
    (HomeGestureReadyChangedEventArgs **)&v16,
    &v17,
    &v18,
    &a5,
    &a6,
    &a7,
    (unsigned int *)va);
  v9 = (HomeGestureReadyChangedEventArgs *)v16;
  if ( !v16 )
    wil::details::in1diag3::_FailFast_NullAlloc(
      ...
      v8);
  v13 = (HomeGestureReadyChangedEventArgs *)v16;
  v16 = this;
  *(_QWORD *)&v14 = &v16;
  *((_QWORD *)&v14 + 1) = &v13;
  v10 = Microsoft::WRL::EventSource<Windows::Foundation::ITypedEventHandler<Windows::Internal::Input::MPCManager::MPCManagerClient *,Windows::Internal::Input::MPCManager::HomeGestureReadyChangedEventArgs *>,Microsoft::WRL::InvokeModeOptions<-2>>::DoInvoke<_lambda_9bde9d5cbf3970395896a777a7cc8107_>(
          this + 204,
          &v14);
  if ( v10 < 0 )
