/*
 * XREFs of ?OnActivationControllerChanged@InputSiteElementProxy@@MEAAJXZ @ 0x180024130
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$?RUAttachedInputObjectEntry@InputSite@@@_lambda_04d0ae44debf7fa40e3352da6740393b_@@QEBA?A_PAEBUAttachedInputObjectEntry@InputSite@@@Z @ 0x180024078 (--$-RUAttachedInputObjectEntry@InputSite@@@_lambda_04d0ae44debf7fa40e3352da6740393b_@@QEBA-A_PAE.c)
        ...
        const char *a4)
{
  ...
  v7 = *(__int64 **)(v5 + 488);
  v22 = v21;
  for ( i = &v20; v7 != v6; v7 += 2 )
  {
    if ( _lambda_04d0ae44debf7fa40e3352da6740393b_::operator()<InputSite::AttachedInputObjectEntry>(&v22, v7) )
      break;
  }
  if ( v7 != *(__int64 **)(v5 + 496) )
  {
    v19 = 0LL;
    if ( (int)Microsoft::WRL::ComPtr<IUnknown>::As<IInputSiteClientPrivate>(v7 + 1, &v19) >= 0 )
