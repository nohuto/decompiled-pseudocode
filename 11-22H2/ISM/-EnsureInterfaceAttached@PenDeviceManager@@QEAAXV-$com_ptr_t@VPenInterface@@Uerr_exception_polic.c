/*
 * XREFs of ?EnsureInterfaceAttached@PenDeviceManager@@QEAAXV?$com_ptr_t@VPenInterface@@Uerr_exception_policy@wil@@@wil@@AEBU_GUID@@@Z @ 0x1801B32A4
 * Callers:
 ...
 *     ??0?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@QEAA@PEAVPenDevice@@@Z @ 0x1801B294C (--0-$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@QEAA@PEAVPenDevice@@@Z.c)
