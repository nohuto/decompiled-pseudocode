/*
 * XREFs of __GSHandlerCheck_EH4 @ 0x1800792A8
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler4_0 @ 0x180057B3E (__CxxFrameHandler4_0.c)
 *     __GSHandlerCheckCommon @ 0x180079244 (__GSHandlerCheckCommon.c)
 */
