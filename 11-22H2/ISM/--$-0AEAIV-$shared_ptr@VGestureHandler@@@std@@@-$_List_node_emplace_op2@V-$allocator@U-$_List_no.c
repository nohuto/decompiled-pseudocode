/*
 * XREFs of ??$?0AEAIV?$shared_ptr@VGestureHandler@@@std@@@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBIV?$shared_ptr@VGestureHandler@@@std@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@U?$pair@$$CBIV?$shared_ptr@VGestureHandler@@@std@@@std@@PEAX@std@@@1@AEAI$$QEAV?$shared_ptr@VGestureHandler@@@1@@Z @ 0x180160910
 * Callers:
