/*
 * XREFs of ?Thunk_SetAllConstantsForInputTypeToDefault_21@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800BF9F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
