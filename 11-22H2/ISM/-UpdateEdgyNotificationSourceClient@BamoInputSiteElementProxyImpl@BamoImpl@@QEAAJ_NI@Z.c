/*
 * XREFs of ?UpdateEdgyNotificationSourceClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180010730
 * Callers:
 *     ?Thunk_UpdateEdgyNotificationSourceClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A3E0 (-Thunk_UpdateEdgyNotificationSourceClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteEleme.c)
