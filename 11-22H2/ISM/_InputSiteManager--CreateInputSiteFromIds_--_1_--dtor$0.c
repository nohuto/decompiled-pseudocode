/*
 * XREFs of _InputSiteManager::CreateInputSiteFromIds_::_1_::dtor$0 @ 0x18007F232
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall InputSiteManager::CreateInputSiteFromIds_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  _QWORD *result; // rax
