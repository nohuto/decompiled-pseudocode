/*
 * XREFs of ?OnReaderConnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x18011F7C0
 * Callers:
 *     ?Thunk_OnReaderConnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180122150 (-Thunk_OnReaderConnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoI.c)
 * Callees:
