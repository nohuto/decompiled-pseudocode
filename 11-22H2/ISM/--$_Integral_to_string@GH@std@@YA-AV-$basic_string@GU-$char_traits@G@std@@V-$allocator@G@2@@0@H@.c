/*
 * XREFs of ??$_Integral_to_string@GH@std@@YA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@0@H@Z @ 0x1800BCDFC
 * Callers:
 ...
 *     ??$_UIntegral_to_buff@GI@std@@YAPEAGPEAGI@Z @ 0x1800BD1F4 (--$_UIntegral_to_buff@GI@std@@YAPEAGPEAGI@Z.c)
 */
