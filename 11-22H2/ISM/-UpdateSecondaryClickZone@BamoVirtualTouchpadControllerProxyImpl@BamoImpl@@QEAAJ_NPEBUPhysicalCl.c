/*
 * XREFs of ?UpdateSecondaryClickZone@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJ_NPEBUPhysicalClickZone@Input@Internal@UI@Windows@@@Z @ 0x18015448C
 * Callers:
 *     ?Thunk_UpdateSecondaryClickZone_408@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800723C0 (-Thunk_UpdateSecondaryClickZone_408@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchp.c)
