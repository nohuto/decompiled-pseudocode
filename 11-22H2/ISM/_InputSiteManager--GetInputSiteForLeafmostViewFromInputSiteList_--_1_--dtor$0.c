/*
 * XREFs of _InputSiteManager::GetInputSiteForLeafmostViewFromInputSiteList_::_1_::dtor$0 @ 0x180071066
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall InputSiteManager::GetInputSiteForLeafmostViewFromInputSiteList_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  _QWORD *result; // rax
