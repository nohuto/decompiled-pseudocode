/*
 * XREFs of wil::details::_dynamic_initializer_for__g_featureStateManager__ @ 0x180001D30
 * Callers:
 *     <none>
 * Callees:
 *     ??0FeatureStateManager@details@wil@@QEAA@XZ @ 0x18004F1BC (--0FeatureStateManager@details@wil@@QEAA@XZ.c)
 */
