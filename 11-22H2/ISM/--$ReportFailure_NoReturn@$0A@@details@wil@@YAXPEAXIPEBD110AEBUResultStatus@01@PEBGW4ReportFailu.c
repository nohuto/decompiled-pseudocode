/*
 * XREFs of ??$ReportFailure_NoReturn@$0A@@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x1800A9B48
 * Callers:
 ...
 *     ?ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z @ 0x1800A85E4 (-ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z.c)
