/*
 * XREFs of ??1?$CalloutWrapper@VBamoPenEventsClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@XZ @ 0x180050784
 * Callers:
 *     ?OnConnectedCallout@BamoPenEventsClientProxy@@EEAAJXZ @ 0x180050650 (-OnConnectedCallout@BamoPenEventsClientProxy@@EEAAJXZ.c)
 ...
 *     _BamoImpl::BamoPenEventsClientProxyImpl::UpdateUndockedEventsRequired_::_1_::dtor$1 @ 0x1800835A3 (_BamoImpl--BamoPenEventsClientProxyImpl--UpdateUndockedEventsRequired_--_1_--dtor$1.c)
 *     ?OnDisconnectedCallout@BamoPenEventsClientProxy@@EEAAJXZ @ 0x1801BD010 (-OnDisconnectedCallout@BamoPenEventsClientProxy@@EEAAJXZ.c)
 *     _BamoPenEventsClientProxy::OnDisconnectedCallout_::_1_::dtor$0 @ 0x1801BD063 (_BamoPenEventsClientProxy--OnDisconnectedCallout_--_1_--dtor$0.c)
 *     ?OnPropertiesRefreshedCallout@BamoPenEventsClientProxy@@EEAAJXZ @ 0x1801BD410 (-OnPropertiesRefreshedCallout@BamoPenEventsClientProxy@@EEAAJXZ.c)
 *     _BamoPenEventsClientProxy::OnPropertiesRefreshedCallout_::_1_::dtor$0 @ 0x1801BD463 (_BamoPenEventsClientProxy--OnPropertiesRefreshedCallout_--_1_--dtor$0.c)
 * Callees:
