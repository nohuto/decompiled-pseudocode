/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoList_ActivatableEntityPrincipal_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAJXZ @ 0x1800B4D50
 * Callers:
 *     <none>
 * Callees:
