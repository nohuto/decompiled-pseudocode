/*
 * XREFs of ?RuntimeClassInitialize@TextInputStateAdapter@@QEAAJPEAUITextInputStateAdapterOwner@@@Z @ 0x1802022F4
 * Callers:
...
LABEL_18:
      ...
      else
      {
        ...
        FailFastWithHR(v7, retaddr, 0x390uLL);
      }
    }
    else if ( (Microsoft_WindowsPhone_InputEnableBits & 1) != 0 )
    {
      McTemplateU0sqq_EventWriteTransfer(v16, v15, "TextInputStateAdapter::RuntimeClassInitialize", 900LL, v7);
    }
  }
  else if ( (Microsoft_WindowsPhone_InputEnableBits & 1) != 0 )
  {
    McTemplateU0sqq_EventWriteTransfer(v12, v11, "TextInputStateAdapter::RuntimeClassInitialize", 897LL, v7);
  }
LABEL_26:
  v18 = v20;
  v20 = 0LL;
