/*
 * XREFs of ?RuntimeClassInitialize@MPCVoiceProcessor@@QEAAJPEBUInputProcessorCreateParams@@@Z @ 0x1801E88C0
 * Callers:
        ...
        const char *a4)
{
  ...
  {
    v15 = this;
    if ( !__std_init_once_begin_initialize(&stru_180277F80, 0, &fPending, 0LL) )
      abort();
    if ( fPending )
    {
      v11 = &stru_180277F80;
