/*
 * XREFs of ?ProcessShutDown@InputProcessManager@InputTraceLogging@@SAXK@Z @ 0x1801C1DA0
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessManager::ProcessShutDown(__int64 a1)
{
    ...
    && (*(_QWORD *)(v2 + 24) & 0x200LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v3 = v1;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_18023781F, 0LL, 0LL, 3u, &v4);
  }
}
