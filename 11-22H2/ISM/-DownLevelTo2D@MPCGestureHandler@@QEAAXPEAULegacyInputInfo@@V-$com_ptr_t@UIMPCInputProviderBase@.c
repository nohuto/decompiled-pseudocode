/*
 * XREFs of ?DownLevelTo2D@MPCGestureHandler@@QEAAXPEAULegacyInputInfo@@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x1800CC160
 * Callers:
 ...
 *     ?DownLevelSelectTo2D@MPCGestureHandler@@AEAAXPEAULegacyInputInfo@@KUtagPOINT@@@Z @ 0x1800CC110 (-DownLevelSelectTo2D@MPCGestureHandler@@AEAAXPEAULegacyInputInfo@@KUtagPOINT@@@Z.c)
 ...
 *     ?FeedRecognizer@MPCSpatialGestureRecognizerHandler@@QEAAXPEAULegacyInputInfo@@@Z @ 0x1800D2060 (-FeedRecognizer@MPCSpatialGestureRecognizerHandler@@QEAAXPEAULegacyInputInfo@@@Z.c)
...
__int64 __fastcall MPCGestureHandler::DownLevelTo2D(MPCGestureHandler *this, struct LegacyInputInfo *a2, __int64 *a3)
{
  ...
  unsigned int v7; // eax
  struct tagPOINT v9; // [rsp+40h] [rbp+8h]
    ...
    *((_DWORD *)this + 221) = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)*a3 + 368LL))(*a3);
    ...
    switch ( *((_DWORD *)a2 + 214) )
    {
      ...
      case 3:
        ...
        break;
      case 4:
        MPCGestureHandler::DownLevelHoverTo2D(this, (const RECT *)a2, v7, v9);
        break;
      case 5:
