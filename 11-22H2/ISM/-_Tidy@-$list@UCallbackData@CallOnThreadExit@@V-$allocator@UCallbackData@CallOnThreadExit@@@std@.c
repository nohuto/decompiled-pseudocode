/*
 * XREFs of ?_Tidy@?$list@UCallbackData@CallOnThreadExit@@V?$allocator@UCallbackData@CallOnThreadExit@@@std@@@std@@AEAAXXZ @ 0x18005615C
 * Callers:
 *     CallOnThreadExit::_dynamic_atexit_destructor_for__s_callbacks__ @ 0x180083C60 (CallOnThreadExit--_dynamic_atexit_destructor_for__s_callbacks__.c)
 * Callees:
