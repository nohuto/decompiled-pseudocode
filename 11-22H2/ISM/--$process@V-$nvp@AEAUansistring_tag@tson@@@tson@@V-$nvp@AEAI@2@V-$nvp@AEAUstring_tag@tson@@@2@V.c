/*
 * XREFs of ??$process@V?$nvp@AEAUansistring_tag@tson@@@tson@@V?$nvp@AEAI@2@V?$nvp@AEAUstring_tag@tson@@@2@V12@@output_archive@tson@@AEAAX$$QEAV?$nvp@AEAUansistring_tag@tson@@@1@$$QEAV?$nvp@AEAI@1@$$QEAV?$nvp@AEAUstring_tag@tson@@@1@0@Z @ 0x1800695D0
 * Callers:
        ...
        __int64 *a5)
{
  ...
  *((_BYTE *)this + 8) = v5;
  tson::output_archive::operator()<tson::ansistring_tag &>(this, *(_OWORD **)(a2 + 16), a3);
  LOBYTE(v9) = 16;
  v10 = *(_QWORD *)a3;
  ...
  *(_QWORD *)this = v15;
  tson::output_archive::operator()<tson::string_tag &>(this, (_OWORD *)a4[2], v14);
  v16 = (__int64)a5;
  v17 = *a5;
  *((_BYTE *)this + 8) = *((_BYTE *)a5 + 8);
  *(_QWORD *)this = v17;
  return tson::output_archive::operator()<tson::ansistring_tag &>(this, *(_OWORD **)(v16 + 16), v18);
}
