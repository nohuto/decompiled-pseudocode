/*
 * XREFs of ??1?$unique_ptr@UDockableDeviceInfo@@U?$default_delete@UDockableDeviceInfo@@@std@@@std@@QEAA@XZ @ 0x1800F1FCC
 * Callers:
 ...
 *     _DockableDeviceCollection::OnDeviceAttach_::_1_::dtor$0 @ 0x1800F27E4 (_DockableDeviceCollection--OnDeviceAttach_--_1_--dtor$0.c)
 * Callees:
