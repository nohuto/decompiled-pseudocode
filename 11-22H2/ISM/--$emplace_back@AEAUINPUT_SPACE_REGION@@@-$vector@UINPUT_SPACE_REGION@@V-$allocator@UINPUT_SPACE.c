/*
 * XREFs of ??$emplace_back@AEAUINPUT_SPACE_REGION@@@?$vector@UINPUT_SPACE_REGION@@V?$allocator@UINPUT_SPACE_REGION@@@std@@@std@@QEAA?A_TAEAUINPUT_SPACE_REGION@@@Z @ 0x1801B0AF8
 * Callers:
