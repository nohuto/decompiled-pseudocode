/*
 * XREFs of ?OnInput@InputServiceProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x18017ED70
 * Callers:
 *     <none>
 * Callees:
      ...
      *((_QWORD *)v9 + 4) = *((_QWORD *)KeyboardEvent + 4);
      ...
      if ( IsEdition(8778LL) )
      {
        ...
        *(_QWORD *)&v15.UnitId = 0LL;
        v11 = (__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))((char *)a3 + 16);
        if ( *v11 )
        {
          if ( (int)Microsoft::WRL::ComPtr<IInputTarget>::As<IFocusInputTarget>(v11, (__int64 *)&v15) >= 0 )
          {
