/*
 * XREFs of ?DetachProvider@MPCGestureHandler@@QEAAXV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x1800CBB8C
 * Callers:
 ...
 *     ?ResetGestureState@MPCSpatialGestureRecognizerHandler@@QEAAXXZ @ 0x1800D3EB0 (-ResetGestureState@MPCSpatialGestureRecognizerHandler@@QEAAXXZ.c)
