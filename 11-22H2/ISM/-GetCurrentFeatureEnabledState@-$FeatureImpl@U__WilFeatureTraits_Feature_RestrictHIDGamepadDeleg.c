/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_RestrictHIDGamepadDelegation@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x1800610D4
 * Callers:
...
LABEL_13:
  ...
  IsEnabled = wil::details::FeatureImpl<__WilFeatureTraits_Feature_TestLabVal>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_TestLabVal>::GetImpl'::`2'::impl);
  v10 = *(_DWORD *)a2;
  if ( v11 && !IsEnabled )
    v10 &= ~0x400u;
