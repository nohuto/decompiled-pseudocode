/*
 * XREFs of ?UpdatePrimaryUsagePage@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJ_NG@Z @ 0x180147398
 * Callers:
 *     ?Thunk_UpdatePrimaryUsagePage_80@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180142170 (-Thunk_UpdatePrimaryUsagePage_80@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@Bam.c)
