/*
 * XREFs of ?UpdateManualResizeAreaClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1800100B0
 * Callers:
 *     ?Thunk_UpdateManualResizeAreaClient_8@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001A280 (-Thunk_UpdateManualResizeAreaClient_8@-$IInputSiteElementProxy_Receive@VBamoInputSiteElementProx.c)
