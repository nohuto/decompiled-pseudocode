/*
 * XREFs of ??1?$pair@IUWindow@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@std@@QEAA@XZ @ 0x1800AB278
 * Callers:
 *     _ViewHierarchyWithWindowManager::OnWindowAdded_::_1_::dtor$3 @ 0x180081101 (_ViewHierarchyWithWindowManager--OnWindowAdded_--_1_--dtor$3.c)
 * Callees:
