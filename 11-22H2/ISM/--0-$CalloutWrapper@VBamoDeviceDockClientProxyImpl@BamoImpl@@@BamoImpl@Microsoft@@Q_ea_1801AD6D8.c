/*
 * XREFs of ??0?$CalloutWrapper@VBamoDeviceDockClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoDeviceDockClientProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x1801AD6D8
 * Callers:
