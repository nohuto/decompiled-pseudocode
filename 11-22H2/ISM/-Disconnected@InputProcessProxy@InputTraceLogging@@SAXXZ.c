/*
 * XREFs of ?Disconnected@InputProcessProxy@InputTraceLogging@@SAXXZ @ 0x1801C1264
 * Callers:
...
void __fastcall InputTraceLogging::InputProcessProxy::Disconnected(__int64 a1)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802375BD, 0LL, 0LL, 2u, &v2);
  }
}
