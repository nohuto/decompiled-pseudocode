/*
 * XREFs of ?RegisterEdgyControllerClient@BamoEdgyControllerServerPrincipalImpl@BamoImpl@@QEAAJPEBGI@Z @ 0x18017A070
 * Callers:
 *     ?Thunk_RegisterEdgyControllerClient_175@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18017A290 (-Thunk_RegisterEdgyControllerClient_175@-$IEdgyControllerServerPrincipal_Receive@VBamoEdgyContro.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( *((int *)this + 2) > 0 )
  {
    ...
    v20 = (*(__int64 (__fastcall **)(char *, __int64, const unsigned __int16 *, char *))(*((_QWORD *)this - 2) + 96LL))(
            (char *)this - 16,
            v24,
            a2,
            v15);
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoEdgyControllerServerPrincipalImpl>::~CalloutWrapper<BamoImpl::BamoEdgyControllerServerPrincipalImpl>((__int64)v22);
  }
  if ( v14 )
