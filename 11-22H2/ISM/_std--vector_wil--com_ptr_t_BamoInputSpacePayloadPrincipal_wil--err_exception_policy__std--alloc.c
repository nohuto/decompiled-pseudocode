/*
 * XREFs of _std::vector_wil::com_ptr_t_BamoInputSpacePayloadPrincipal_wil::err_exception_policy__std::allocator_wil::com_ptr_t_BamoInputSpacePayloadPrincipal_wil::err_exception_policy_____::_Emplace_reallocate_BamoInputSpacePayloadPrincipal____::_1_::catch$0 @ 0x180159C97
 * Callers:
 *     <none>
 * Callees:
