/*
 * XREFs of ?ToggleDetected@BamoMagnifierControllerProxyImpl@BamoImpl@@QEAAJAEBUPoint@Foundation@Windows@@@Z @ 0x18017AB6C
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v13[1] = v16;
      v17 = v12;
      return CoreUICallSend(v10, v13, 2LL, 64LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
