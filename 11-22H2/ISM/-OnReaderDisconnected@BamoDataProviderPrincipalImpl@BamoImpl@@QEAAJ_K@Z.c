/*
 * XREFs of ?OnReaderDisconnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x18011F8F4
 * Callers:
 *     ?Thunk_OnReaderDisconnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180122170 (-Thunk_OnReaderDisconnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@Ba.c)
 * Callees:
