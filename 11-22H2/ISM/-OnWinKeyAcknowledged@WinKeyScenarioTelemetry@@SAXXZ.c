/*
 * XREFs of ?OnWinKeyAcknowledged@WinKeyScenarioTelemetry@@SAXXZ @ 0x180125778
 * Callers:
 *     ?OnHotKeyAcknowledged@HotKeyProcessor@@UEAAJXZ @ 0x1801FEAD0 (-OnHotKeyAcknowledged@HotKeyProcessor@@UEAAJXZ.c)
 * Callees:
