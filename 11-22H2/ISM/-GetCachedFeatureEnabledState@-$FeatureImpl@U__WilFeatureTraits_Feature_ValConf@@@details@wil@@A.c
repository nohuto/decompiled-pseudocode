/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ValConf@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18005C968
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ValConf@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18005FD5C (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_ValConf@@@details@wil@@QEAAX_NW4Reporting.c)
 * Callees:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_ValConf@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18005E9C4 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_ValConf@@@details@wil@@.c)
 */
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_ValConf>::GetCurrentFeatureEnabledState(a1, &v12, &v11);
    for ( i = *a2; ; i = v9 )
    {
      v7 = v11 == 0;
      v8 = i;
