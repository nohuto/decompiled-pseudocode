/*
 * XREFs of ?Materialize_BamoInputSpacePayloadProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1801359E4
 * Callers:
 *     ?Thunk_Materialize_BamoInputSpacePayloadProxy_5@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141710 (-Thunk_Materialize_BamoInputSpacePayloadProxy_5@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeer.c)
 * Callees:
