/*
 * XREFs of ??1?$out_param_t@V?$unique_ptr@$$BY0A@IU?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@@details@wil@@QEAA@XZ @ 0x1800621D4
 * Callers:
 ...
 *     _LampArrayRawInputProvider::UpdateDeviceAmbientProcess_::_1_::dtor$3 @ 0x1800631E7 (_LampArrayRawInputProvider--UpdateDeviceAmbientProcess_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
