/*
 * XREFs of ?OnConnectedThunk@BamoShellHandwritingHostServerStubImpl@BamoImpl@@UEAAJXZ @ 0x180075BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoShellHandwritingHostServerStubImpl::OnConnectedThunk(
