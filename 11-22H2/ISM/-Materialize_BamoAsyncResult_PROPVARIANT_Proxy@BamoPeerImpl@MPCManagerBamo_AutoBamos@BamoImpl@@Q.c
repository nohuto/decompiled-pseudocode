/*
 * XREFs of ?Materialize_BamoAsyncResult_PROPVARIANT_Proxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800C2118
 * Callers:
 *     ?Thunk_Materialize_BamoAsyncResult_PROPVARIANT_Proxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800C4600 (-Thunk_Materialize_BamoAsyncResult_PROPVARIANT_Proxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Rec.c)
 * Callees:
