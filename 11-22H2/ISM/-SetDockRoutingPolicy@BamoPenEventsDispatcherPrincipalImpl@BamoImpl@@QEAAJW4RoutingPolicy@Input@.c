/*
 * XREFs of ?SetDockRoutingPolicy@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x18004FCE4
 * Callers:
 *     ?Thunk_SetDockRoutingPolicy_16@?$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18004FBA0 (-Thunk_SetDockRoutingPolicy_16@-$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherP.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoPenEventsDispatcherPrincipalImpl::SetDockRoutingPolicy(__int64 a1, unsigned int a2)
{
  int v4; // ebx
  _QWORD *v5; // rdi
  int v6; // ecx
  __int64 v7; // r14
  __int64 v8; // rcx
  Microsoft::BamoImpl::BaseBamoConnectionImpl *v9; // rdi
  int v10; // eax
  ...
  if ( *(int *)(a1 + 8) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoPenEventsDispatcherPrincipalImpl>::CalloutWrapper<BamoImpl::BamoPenEventsDispatcherPrincipalImpl>(
      ...
      *(_QWORD *)(v8 + 32),
      a1);
    v10 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)(a1 - 16) + 112LL))(a1 - 16, v7, a2);
    v4 = v10;
    if ( v10 == -2018375668 )
    {
