/*
 * XREFs of _Microsoft::WRL::Details::Make_ShellGesturesProcessor::Context__::_1_::dtor$0 @ 0x18017C1E3
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall Microsoft::WRL::Details::Make_ShellGesturesProcessor::Context__::_1_::dtor_0(__int64 a1, __int64 a2)
{
  _QWORD *result; // rax
