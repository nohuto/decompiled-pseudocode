/*
 * XREFs of ?IsDeviceConvertible@DevicePostureHelpers@@YA_NXZ @ 0x18006ECA0
 * Callers:
 ...
 *     ?HasCSMStateChanged@DevicePostureHelpers@@YA_NXZ @ 0x18006EBB0 (-HasCSMStateChanged@DevicePostureHelpers@@YA_NXZ.c)
