/*
 * XREFs of ?GetEnabled@BamoControllerNavigationClientProxy@@UEAA_NXZ @ 0x1801A0DBC
 * Callers:
 *     ?GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ @ 0x1801A0E00 (-GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ.c)
 * Callees:
