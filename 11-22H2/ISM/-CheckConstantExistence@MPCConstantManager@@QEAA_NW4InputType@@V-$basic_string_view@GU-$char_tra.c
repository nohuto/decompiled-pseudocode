/*
 * XREFs of ?CheckConstantExistence@MPCConstantManager@@QEAA_NW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x1800BDB44
 * Callers:
 ...
 *     ?VerifyConstantTypeMatches@MPCConstantManager@@QEAA_NW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@V?$variant@K_NM@4@@Z @ 0x1800BFC90 (-VerifyConstantTypeMatches@MPCConstantManager@@QEAA_NW4InputType@@V-$basic_string_view@GU-$char_.c)
...
char __fastcall MPCConstantManager::CheckConstantExistence(__int64 a1, int a2, __m128i *a3)
{
  ...
  if ( !MPCConstantManager::CheckTypeExistence(a1, a2) )
    return 0;
  v5 = (_QWORD *)std::map<enum InputType,std::map<std::wstring,std::variant<unsigned long,bool,float>>>::_Try_emplace<enum InputType const &,>(
                   (__int64 *)(a1 + 56),
                   (__int64)v11,
                   (__int64)&v12);
