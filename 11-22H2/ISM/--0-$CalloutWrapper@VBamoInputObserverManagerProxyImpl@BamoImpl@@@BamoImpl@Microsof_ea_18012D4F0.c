/*
 * XREFs of ??0?$CalloutWrapper@VBamoInputObserverManagerProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputObserverManagerProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18012D4F0
 * Callers:
