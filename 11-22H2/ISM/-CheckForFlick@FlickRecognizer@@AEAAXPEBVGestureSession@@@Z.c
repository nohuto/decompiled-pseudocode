/*
 * XREFs of ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x1801E1CD4
 * Callers:
 ...
 * Callees:
 *     ?FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ @ 0x1801E1E08 (-FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ.c)
 */
