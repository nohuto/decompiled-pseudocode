/*
 * XREFs of ?AllocateStub@BamoList_SimpleHapticsControllerFeedback_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_SimpleHapticsControllerFeedback_Stub@2345@@Z @ 0x1801B8B20
 * Callers:
 *     <none>
 * Callees:
