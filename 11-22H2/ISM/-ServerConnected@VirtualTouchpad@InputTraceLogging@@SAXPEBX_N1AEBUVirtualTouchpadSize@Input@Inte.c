/*
 * XREFs of ?ServerConnected@VirtualTouchpad@InputTraceLogging@@SAXPEBX_N1AEBUVirtualTouchpadSize@Input@Internal@UI@Windows@@@Z @ 0x18015398C
 * Callers:
        ...
        const struct Windows::UI::Internal::Input::VirtualTouchpadSize *a4)
{
    ...
    && (*(_QWORD *)(v8 + 24) & 0x200LL) == *(_QWORD *)(v8 + 24) )
  {
    ...
    v21 = 1LL;
    v19 = 1LL;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_180234E43, 0LL, 0LL, 8u, &v15);
  }
}
