/*
 * XREFs of ?DetectInOutIn@ShellEdgyRecognizer@@AEAA_NAEBV?$optional@ULastUpData@ShellEdgyRecognizer@@@std@@@Z @ 0x18017E4E8
 * Callers:
...
bool __fastcall ShellEdgyRecognizer::DetectInOutIn(__int64 a1, __int64 a2)
{
  return *(_BYTE *)(a2 + 24)
      ...
      && 1000000 * qword_180277048 >= *(_QWORD *)(a1 + 48) - *(_QWORD *)a2
      && (int)abs32(*(_DWORD *)(a1 + 40) - *(_DWORD *)(a2 + 16)) <= dword_180277050
      && (int)abs32(*(_DWORD *)(a1 + 44) - *(_DWORD *)(a2 + 20)) <= dword_180277054;
}
