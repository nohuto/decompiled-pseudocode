/*
 * XREFs of ??1?$map@UDockInputIdentity@@UDockInputInfo@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UDockInputInfo@@@std@@@4@@std@@QEAA@XZ @ 0x1801A9D34
 * Callers:
 *     _DeviceDockServer::DeviceDockServer_::_1_::dtor$5 @ 0x180080D10 (_DeviceDockServer--DeviceDockServer_--_1_--dtor$5.c)
 * Callees:
