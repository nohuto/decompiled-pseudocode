/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_BackportDisableEdgySettings@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800748EC
 * Callers:
...
void __fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_BackportDisableEdgySettings>::ReportUsage(
        __int64 a1,
        unsigned __int8 a2,
        __int64 a3,
        __int64 a4)
{
  ...
  if ( (*(_DWORD *)a1 & 4) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_BackportDisableEdgySettings>::GetCachedFeatureEnabledState(
