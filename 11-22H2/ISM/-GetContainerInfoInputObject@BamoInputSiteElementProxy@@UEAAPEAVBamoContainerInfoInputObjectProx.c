/*
 * XREFs of ?GetContainerInfoInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoContainerInfoInputObjectProxy@@XZ @ 0x180012390
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoContainerInfoInputObjectProxy *)*((_QWORD *)this + 14);
}
