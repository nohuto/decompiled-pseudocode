/*
 * XREFs of ?InjectPan@ManipulationInjector@@QEAAXMMK@Z @ 0x18012AE18
 * Callers:
 ...
 *     ?RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z @ 0x18012B47C (-RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z.c)
