/*
 * XREFs of ?GetTouchpadEnabled@BamoShellGesturesClientProxy@@UEAA_NXZ @ 0x18017BC80
 * Callers:
...
bool __fastcall BamoShellGesturesClientProxy::GetTouchpadEnabled(BamoShellGesturesClientProxy *this)
{
