/*
 * XREFs of ?GetShellGesturesClient@BamoInputSiteElementProxy@@UEAAPEAVBamoShellGesturesClientProxy@@XZ @ 0x180011BB0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoShellGesturesClientProxy *)*((_QWORD *)this + 35);
}
