/*
 * XREFs of ??0?$CalloutWrapper@VBamoUIAHitTestInputObjectProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoUIAHitTestInputObjectProxyImpl@1@W4PrologEpilogConfig@12@@Z @ 0x18012E4B0
 * Callers:
