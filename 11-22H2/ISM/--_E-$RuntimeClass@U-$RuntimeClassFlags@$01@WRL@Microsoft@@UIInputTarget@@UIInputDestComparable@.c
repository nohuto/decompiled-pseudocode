/*
 * XREFs of ??_E?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIInputTarget@@UIInputDestComparable@@UIInputSiteTarget@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x18010F400
 * Callers:
 *     <none>
 * Callees:
