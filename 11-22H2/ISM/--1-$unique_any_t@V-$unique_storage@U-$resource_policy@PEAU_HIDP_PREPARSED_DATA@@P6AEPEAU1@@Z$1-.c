/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAU_HIDP_PREPARSED_DATA@@P6AEPEAU1@@Z$1?HidD_FreePreparsedData@@YAE0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x1800FC270
 * Callers:
 *     _PenInterface::PenInterface_::_1_::dtor$2 @ 0x1801B490D (_PenInterface--PenInterface_--_1_--dtor$2.c)
 *     _HapticInterface::HapticInterface_::_1_::dtor$3 @ 0x1801B719D (_HapticInterface--HapticInterface_--_1_--dtor$3.c)
 * Callees:
 *     <none>
 */
