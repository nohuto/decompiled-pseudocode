/*
 * XREFs of ?OpenMobileButtonDriver@MobileButtonDeviceCollection@@AEAAPEAXXZ @ 0x1800ED63C
 * Callers:
 ...
 *     ?GetDevicePath@MobileButtonDeviceCollection@@AEAAPEAGXZ @ 0x1800EC800 (-GetDevicePath@MobileButtonDeviceCollection@@AEAAPEAGXZ.c)
 */
