/*
 * XREFs of ?UpdateState@MPCButtonHoldHelper@@QEAAX_N_K@Z @ 0x1800D7B90
 * Callers:
 ...
 * Callees:
 *     ?ResetState@MPCButtonHoldHelper@@QEAAXXZ @ 0x1800D7B74 (-ResetState@MPCButtonHoldHelper@@QEAAXXZ.c)
 */
