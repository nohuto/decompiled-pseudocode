/*
 * XREFs of ?StartWindowWatcher@ViewHierarchyWithWindowManager@@AEAAJXZ @ 0x180049418
 * Callers:
 ...
 *     ??$?0VViewHierarchyWithWindowManager@@P80@EAAJUWindowWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UWindowChangedEventArgs@23456@@Z@?$TypedEventHandler@UWindowWatcher@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UWindowChangedEventArgs@23456@@Foundation@Windows@winrt@@QEAA@PEAVViewHierarchyWithWindowManager@@P84@EAAJUWindowWatcher@WindowManagement@ApplicationModel@Internal@23@UWindowChangedEventArgs@67823@@Z@Z @ 0x18004951C (--$-0VViewHierarchyWithWindowManager@@P80@EAAJUWindowWatcher@WindowManagement@ApplicationModel@I.c)
