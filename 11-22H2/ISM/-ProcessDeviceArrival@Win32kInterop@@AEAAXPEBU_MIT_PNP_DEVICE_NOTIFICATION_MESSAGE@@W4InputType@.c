/*
 * XREFs of ?ProcessDeviceArrival@Win32kInterop@@AEAAXPEBU_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@W4InputType@@@Z @ 0x180040160
 * Callers:
  ...
  switch ( a3 )
  {
    case 2u:
      ...
      if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 8) != 0 && (*(_QWORD *)(v6 + 24) & 8LL) == *(_QWORD *)(v6 + 24) )
        tlgWriteTransfer_EventWriteTransfer(v6, (int)&dword_18023584B, 0, 0, 2u, &v14);
