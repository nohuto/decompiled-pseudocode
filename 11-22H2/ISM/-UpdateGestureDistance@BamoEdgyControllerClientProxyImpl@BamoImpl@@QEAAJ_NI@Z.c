/*
 * XREFs of ?UpdateGestureDistance@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x180179708
 * Callers:
 *     ?Thunk_UpdateGestureDistance_8@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180179520 (-Thunk_UpdateGestureDistance_8@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientPro.c)
