/*
 * XREFs of ?OnGamepadIsSupportedForProcess@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18018CF6C
 * Callers:
 *     ?Thunk_OnGamepadIsSupportedForProcess_25@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018DD00 (-Thunk_OnGamepadIsSupportedForProcess_25@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerCli.c)
 * Callees:
