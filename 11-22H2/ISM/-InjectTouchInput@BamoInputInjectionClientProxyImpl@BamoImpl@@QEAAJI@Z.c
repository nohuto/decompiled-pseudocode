/*
 * XREFs of ?InjectTouchInput@BamoInputInjectionClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1801C3CCC
 * Callers:
 *     ?Thunk_InjectTouchInput_8@?$IInputInjectionClientProxy_Receive@VBamoInputInjectionClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801C42B0 (-Thunk_InjectTouchInput_8@-$IInputInjectionClientProxy_Receive@VBamoInputInjectionClientProxyImp.c)
 * Callees:
