/*
 * XREFs of ?OnConnectedCallout@BamoSystemButtonEventControllerProxy@@EEAAJXZ @ 0x1800504B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoSystemButtonEventControllerProxy::OnConnectedCallout(BamoSystemButtonEventControllerProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSystemButtonEventControllerProxyImpl>::CalloutWrapper<BamoImpl::BamoSystemButtonEventControllerProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (char *)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoSystemButtonEventControllerProxy *))(*(_QWORD *)v1 + 32LL))(v1);
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSystemButtonEventControllerProxyImpl>::~CalloutWrapper<BamoImpl::BamoSystemButtonEventControllerProxyImpl>(v3);
