/*
 * XREFs of ?UpdateCalledGetDetectedSourcesAtTimestampRecently@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180142D94
 * Callers:
 *     ?Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_11@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180141BF0 (-Thunk_UpdateCalledGetDetectedSourcesAtTimestampRecently_11@-$IMPCInputObjectProxy_Receive@VBamo.c)
