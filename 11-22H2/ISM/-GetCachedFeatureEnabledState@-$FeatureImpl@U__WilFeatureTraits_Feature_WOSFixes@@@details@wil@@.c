/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_WOSFixes@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18005CA44
 * Callers:
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_WOSFixes>::GetCurrentFeatureEnabledState(a1, &v12, &v11);
    for ( i = *a2; ; i = v9 )
    {
      v7 = v11 == 0;
      v8 = i;
