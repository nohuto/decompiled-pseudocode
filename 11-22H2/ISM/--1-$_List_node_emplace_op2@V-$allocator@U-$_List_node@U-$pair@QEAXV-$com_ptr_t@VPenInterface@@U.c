/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@QEAXV?$com_ptr_t@VPenInterface@@Uerr_exception_policy@wil@@@wil@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x1800E1084
 * Callers:
 ...
 *     _std::_Hash_std::_Umap_traits_void___wil::com_ptr_t_PenInterface_wil::err_exception_policy__std::_Uhash_compare_void___std::hash_void____std::equal_to_void______std::allocator_std::pair_void___const_wil::com_ptr_t_PenInterface_wil::err_exception_policy______0___::emplace_void___&_wil::com_ptr_t_PenInterface_wil::err_exception_policy__&__::_1_::dtor$0 @ 0x1801B278F (_std--_Hash_std--_Umap_traits_void___wil--com_ptr_t_PenInterface_wil--err_exception_policy__std-.c)
 * Callees:
