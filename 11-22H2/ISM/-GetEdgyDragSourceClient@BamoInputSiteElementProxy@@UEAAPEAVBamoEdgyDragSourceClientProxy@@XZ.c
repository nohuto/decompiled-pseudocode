/*
 * XREFs of ?GetEdgyDragSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoEdgyDragSourceClientProxy@@XZ @ 0x180012160
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoEdgyDragSourceClientProxy *)*((_QWORD *)this + 22);
}
