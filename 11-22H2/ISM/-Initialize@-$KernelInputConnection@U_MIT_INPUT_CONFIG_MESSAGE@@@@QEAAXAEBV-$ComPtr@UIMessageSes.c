/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_INPUT_CONFIG_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_INPUT_CONFIG_MESSAGE@@@Z@std@@@Z @ 0x180044464
 * Callers:
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    if ( v19 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        ...
        v23);
    v20 = NtMITCoreMsgKOpenConnectionTo(6LL, a1 + 3);
    if ( v20 < 0 )
