/*
 * XREFs of _CUIHierarchy::OnUniversalPropertyChanged_::_1_::dtor$6 @ 0x1800AF111
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CUIHierarchy::OnUniversalPropertyChanged_::_1_::dtor_6(__int64 a1, __int64 a2)
{
