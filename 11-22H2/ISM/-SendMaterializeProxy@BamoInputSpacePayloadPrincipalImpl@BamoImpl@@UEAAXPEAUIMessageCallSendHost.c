/*
 * XREFs of ?SendMaterializeProxy@BamoInputSpacePayloadPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18015EF10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateRegionsRemoteCache@BamoInputSpacePayloadPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x18015F8D0 (-UpdateRegionsRemoteCache@BamoInputSpacePayloadPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Mi.c)
 */

void __fastcall BamoImpl::BamoInputSpacePayloadPrincipalImpl::SendMaterializeProxy(
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  if ( v9 < 0 )
    wil::details::in1diag3::FailFast_Hr(
      ...
      v12);
  BamoImpl::BamoInputSpacePayloadPrincipalImpl::UpdateInputSpaceRemoteCache(this, a3);
  BamoImpl::BamoInputSpacePayloadPrincipalImpl::UpdateRegionsRemoteCache(this, a3);
