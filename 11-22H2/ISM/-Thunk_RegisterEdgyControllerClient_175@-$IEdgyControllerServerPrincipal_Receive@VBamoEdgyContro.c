/*
 * XREFs of ?Thunk_RegisterEdgyControllerClient_175@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18017A290
 * Callers:
 *     <none>
 * Callees:
 *     <none>
