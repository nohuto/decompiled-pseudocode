/*
 * XREFs of ?QueryInterface@BamoCUIComponentInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180150468
 * Callers:
 *     ?QueryInterface@BamoCUIComponentInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B4D0 (-QueryInterface@BamoCUIComponentInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
