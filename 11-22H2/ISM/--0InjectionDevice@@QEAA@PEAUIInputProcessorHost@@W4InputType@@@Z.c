/*
 * XREFs of ??0InjectionDevice@@QEAA@PEAUIInputProcessorHost@@W4InputType@@@Z @ 0x1800513E8
 * Callers:
 *     ??0MouseProcessor@@IEAA@PEAUInputProcessorCreateParams@@@Z @ 0x1800512B4 (--0MouseProcessor@@IEAA@PEAUInputProcessorCreateParams@@@Z.c)
