        ...
        __int64 *a3)
{
  ...
  try
  {
    wil::com_ptr_t<PenInterface,wil::err_exception_policy>::com_ptr_t<PenInterface,wil::err_exception_policy>(v14, *a3);
    v20 = v14;
    v15 = a1[1];
    v16 = v13;
    v17 = *a1;
