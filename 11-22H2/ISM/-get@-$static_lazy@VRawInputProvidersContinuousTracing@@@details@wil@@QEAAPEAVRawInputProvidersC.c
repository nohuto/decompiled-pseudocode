/*
 * XREFs of ?get@?$static_lazy@VRawInputProvidersContinuousTracing@@@details@wil@@QEAAPEAVRawInputProvidersContinuousTracing@@P6AXXZ@Z @ 0x1800EBB00
 * Callers:
        ...
        void (__cdecl *a2)())
{
    ...
    && (_DWORD)v6 )
  {
    ...
    v7 = &qword_1802781A0;
    qword_1802781A0 = (__int64)&RawInputProvidersContinuousTracing::`vftable';
    qword_1802781B8 = (__int64)&`RawInputProvidersContinuousTracing::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v5 = 0;
