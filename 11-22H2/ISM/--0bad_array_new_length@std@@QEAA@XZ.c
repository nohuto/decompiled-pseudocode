/*
 * XREFs of ??0bad_array_new_length@std@@QEAA@XZ @ 0x1800AA338
 * Callers:
 *     ?__scrt_throw_std_bad_array_new_length@@YAXXZ @ 0x180057B18 (-__scrt_throw_std_bad_array_new_length@@YAXXZ.c)
 * Callees:
 *     <none>
 */
