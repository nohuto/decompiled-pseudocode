/*
 * XREFs of ??$As@UILightDismissClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UILightDismissClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x18014DDA4
 * Callers:
