/*
 * XREFs of ?MPCManager_SetConvertGraspToSystemGesture_@ISMTracing@@QEAAX_NI@Z @ 0x1800C1E7C
 * Callers:
...
void __fastcall ISMTracing::MPCManager_SetConvertGraspToSystemGesture_(ISMTracing *this, char a2, int a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 1) != 0 && (*(_QWORD *)(v5 + 24) & 1LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v6 = a2;
    v10 = 1;
    tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_18022FED3, 0LL, 0LL, 4u, &v8);
  }
}
