/*
 * XREFs of ?QueryInterface@BamoSystemCursorControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013D540
 * Callers:
 *     ?QueryInterface@BamoSystemCursorControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B350 (-QueryInterface@BamoSystemCursorControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
