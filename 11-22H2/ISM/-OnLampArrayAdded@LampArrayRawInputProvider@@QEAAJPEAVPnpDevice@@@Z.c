/*
 * XREFs of ?OnLampArrayAdded@LampArrayRawInputProvider@@QEAAJPEAVPnpDevice@@@Z @ 0x1800F804C
 * Callers:
 ...
 *     ?PushBack@?$NtList@ULampArrayDeviceListEntry@LampArrayRawInputProvider@@@@QEAAXPEAULampArrayDeviceListEntry@LampArrayRawInputProvider@@@Z @ 0x1800F86D0 (-PushBack@-$NtList@ULampArrayDeviceListEntry@LampArrayRawInputProvider@@@@QEAAXPEAULampArrayDevi.c)
      ...
      *((_QWORD *)v4 + 2) = 0LL;
        ...
        && !*((_BYTE *)this + 312) )
      {
        (*(void (__fastcall **)(_QWORD, __int64 (__fastcall *)(LampArrayRawInputProvider *), LampArrayRawInputProvider *, __int64))(**((_QWORD **)this + 7) + 152LL))(
          *((_QWORD *)this + 7),
          lambda_ca85b764199dcdb943f9219ecf8076c3_::_lambda_invoker_cdecl_,
          this,
          3LL);
        *((_BYTE *)this + 312) = 1;
      }
