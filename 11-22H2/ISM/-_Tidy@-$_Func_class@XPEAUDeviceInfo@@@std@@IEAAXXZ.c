/*
 * XREFs of ?_Tidy@?$_Func_class@XPEAUDeviceInfo@@@std@@IEAAXXZ @ 0x1800531C0
 * Callers:
 ...
 *     ??1?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@QEAA@XZ @ 0x1801DA3C0 (--1-$function@$$A6AXPEAUDeviceInfo@@@Z@std@@QEAA@XZ.c)
