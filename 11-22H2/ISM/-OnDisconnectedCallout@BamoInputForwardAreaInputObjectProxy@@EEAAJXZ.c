/*
 * XREFs of ?OnDisconnectedCallout@BamoInputForwardAreaInputObjectProxy@@EEAAJXZ @ 0x180138950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputForwardAreaInputObjectProxy::OnDisconnectedCallout(
        BamoInputForwardAreaInputObjectProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputForwardAreaInputObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoInputForwardAreaInputObjectProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoInputForwardAreaInputObjectProxy *))(*(_QWORD *)v1 + 40LL))(v1);
