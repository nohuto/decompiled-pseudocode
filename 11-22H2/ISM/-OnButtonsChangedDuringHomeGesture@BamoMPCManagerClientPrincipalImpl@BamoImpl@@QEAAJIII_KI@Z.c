/*
 * XREFs of ?OnButtonsChangedDuringHomeGesture@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJIII_KI@Z @ 0x18018CA4C
 * Callers:
 *     ?Thunk_OnButtonsChangedDuringHomeGesture_68@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18018DC80 (-Thunk_OnButtonsChangedDuringHomeGesture_68@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManager.c)
 * Callees:
