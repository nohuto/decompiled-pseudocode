/*
 * XREFs of ?SetMPCInputRouter@MPCHolographicInputManager@@QEAAXPEAUISystemInputRouter@@@Z @ 0x1800C9408
 * Callers:
        ...
        const char *a4)
{
  ...
  {
    Microsoft::WRL::ComPtr<ISystemInputRouter>::operator=((__int64 *)this + 410, (__int64)a2);
    v6 = *v5;
    v7 = **(__int64 (__fastcall ***)(struct ISystemInputRouter *, GUID *, char *))v6;
    Microsoft::WRL::ComPtr<Windows::UI::Input::Spatial::Internal::IInputPriv>::InternalRelease((__int64 *)this + 411);
