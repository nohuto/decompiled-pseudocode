/*
 * XREFs of ??$_Insert_or_assign@KAEAG@?$unordered_map@KGU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@U?$pair@$$CBKG@std@@@2@@std@@AEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKG@std@@@std@@@std@@@std@@_N@1@$$QEAKAEAG@Z @ 0x1801F8814
 * Callers:
 ...
 *     ??$?0KAEAG@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CBKG@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@U?$pair@$$CBKG@std@@PEAX@std@@@1@$$QEAKAEAG@Z @ 0x1801F87A0 (--$-0KAEAG@-$_List_node_emplace_op2@V-$allocator@U-$_List_node@U-$pair@$$CBKG@std@@PEAX@std@@@st.c)
 */
        ...
        _WORD *a4)
{
  ...
  else
  {
    ...
    std::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned long const,unsigned short>,void *>>>::_List_node_emplace_op2<std::allocator<std::_List_node<std::pair<unsigned long const,unsigned short>,void *>>>(
      &v19,
      (__int64)(a1 + 2),
      v9,
      a4);
