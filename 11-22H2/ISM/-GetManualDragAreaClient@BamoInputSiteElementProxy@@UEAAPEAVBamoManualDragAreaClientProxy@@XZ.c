/*
 * XREFs of ?GetManualDragAreaClient@BamoInputSiteElementProxy@@UEAAPEAVBamoManualDragAreaClientProxy@@XZ @ 0x180011D70
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoManualDragAreaClientProxy *)*((_QWORD *)this + 30);
}
