/*
 * XREFs of ?OnStreamEnded@ShellGesturesProcessor@@UEAAJPEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x1800746D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Unchecked_erase@?$list@U?$pair@$$CBIUActiveContactData@ShellGesturesProcessor@@@std@@V?$allocator@U?$pair@$$CBIUActiveContactData@ShellGesturesProcessor@@@std@@@2@@std@@AEAAPEAU?$_List_node@U?$pair@$$CBIUActiveContactData@ShellGesturesProcessor@@@std@@PEAX@2@QEAU32@@Z @ 0x18017E0CC (-_Unchecked_erase@-$list@U-$pair@$$CBIUActiveContactData@ShellGesturesProcessor@@@std@@V-$alloca.c)
 */
          ...
          i = std::list<std::pair<unsigned int const,ShellGesturesProcessor::ActiveContactData>>::_Unchecked_erase((char *)this + 128) )
    {
      ...
      InputTraceLogging::ShellGestures::StaleActiveContacts(
        ...
        *(unsigned int *)(v3 + 24),
        v8,
        v7);
      MicrosoftTelemetryAssertTriggeredArgs(v9, 0x20000, 722);
