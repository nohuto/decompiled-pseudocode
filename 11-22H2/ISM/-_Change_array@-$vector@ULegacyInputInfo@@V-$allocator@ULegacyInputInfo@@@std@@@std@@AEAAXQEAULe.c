/*
 * XREFs of ?_Change_array@?$vector@ULegacyInputInfo@@V?$allocator@ULegacyInputInfo@@@std@@@std@@AEAAXQEAULegacyInputInfo@@_K1@Z @ 0x1800DEEDC
 * Callers:
...
__int64 __fastcall std::vector<LegacyInputInfo>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = *(void **)a1;
  if ( v6 )
    std::_Deallocate<16,0>(v6, (__int64)(*(_QWORD *)(a1 + 16) - (_QWORD)v6) >> 6 << 6);
  *(_QWORD *)a1 = a2;
