/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_DWMCrashesInBamoPrincipalImplLoop@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180068290
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_DWMCrashesInBamoPrincipalImplLoop@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18006836C (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_DWMCrashesInB.c)
 */

signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_DWMCrashesInBamoPrincipalImplLoop>::GetCachedFeatureEnabledState(
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_DWMCrashesInBamoPrincipalImplLoop>::GetCurrentFeatureEnabledState(
      a1,
      &v12,
      &v11);
    for ( i = *a2; ; i = v9 )
