/*
 * XREFs of ??1?$unordered_map@KUTargetingInfo@Win32kInterop@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKUTargetingInfo@Win32kInterop@@@std@@@4@@std@@QEAA@XZ @ 0x180106B64
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$7 @ 0x180080FD4 (_Win32kInterop--Win32kInterop_--_1_--dtor$7.c)
 * Callees:
