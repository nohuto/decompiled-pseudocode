/*
 * XREFs of ?AllocateStub@BamoShellHandwritingHostServerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoShellHandwritingHostServerStub@@@Z @ 0x180075920
 * Callers:
 *     <none>
 * Callees:
