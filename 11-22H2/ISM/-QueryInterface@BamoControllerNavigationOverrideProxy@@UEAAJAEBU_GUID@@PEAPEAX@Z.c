/*
 * XREFs of ?QueryInterface@BamoControllerNavigationOverrideProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A1560
 * Callers:
 *     ?QueryInterface@BamoControllerNavigationOverrideProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007D590 (-QueryInterface@BamoControllerNavigationOverrideProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
