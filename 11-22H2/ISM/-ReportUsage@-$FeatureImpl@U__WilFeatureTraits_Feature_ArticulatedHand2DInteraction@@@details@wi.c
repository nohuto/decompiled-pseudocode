/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ArticulatedHand2DInteraction@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800D06B0
 * Callers:
 *     ?SupportsTouch@MPCHandProcessor@@UEAA_NXZ @ 0x1800D0AF0 (-SupportsTouch@MPCHandProcessor@@UEAA_NXZ.c)
 * Callees:
