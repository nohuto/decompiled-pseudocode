/*
 * XREFs of ?RegisterGestureSource@ShellGesturesProcessor@@QEAAX_KW4InputGestureSourceType@Input@Internal@UI@Windows@@W4InputType@3456@PEAVDragManagerClientProxy@@@Z @ 0x1800747CC
 * Callers:
 ...
 *     ??1GestureRegistration@ShellGesturesProcessor@@QEAA@XZ @ 0x18001B5E4 (--1GestureRegistration@ShellGesturesProcessor@@QEAA@XZ.c)
