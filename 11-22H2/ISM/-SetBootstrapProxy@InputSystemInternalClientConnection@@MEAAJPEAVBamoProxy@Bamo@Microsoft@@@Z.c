/*
 * XREFs of ?SetBootstrapProxy@InputSystemInternalClientConnection@@MEAAJPEAVBamoProxy@Bamo@Microsoft@@@Z @ 0x18014A370
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoProxy *a2)
{
  ...
  std::_Destroy_range<std::allocator<std::function<void (bool)>>>(*((_QWORD *)this + 32), *((_QWORD *)this + 33));
