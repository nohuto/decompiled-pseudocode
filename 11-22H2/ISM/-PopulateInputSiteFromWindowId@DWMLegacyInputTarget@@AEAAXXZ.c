/*
 * XREFs of ?PopulateInputSiteFromWindowId@DWMLegacyInputTarget@@AEAAXXZ @ 0x1801C8998
 * Callers:
 *     ??0DWMLegacyInputTarget@@IEAA@KKK_K@Z @ 0x1801C874C (--0DWMLegacyInputTarget@@IEAA@KKK_K@Z.c)
 * Callees:
