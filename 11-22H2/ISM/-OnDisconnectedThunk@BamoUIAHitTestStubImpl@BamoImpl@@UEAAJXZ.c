/*
 * XREFs of ?OnDisconnectedThunk@BamoUIAHitTestStubImpl@BamoImpl@@UEAAJXZ @ 0x180029080
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$CalloutWrapper@VBamoUIAHitTestPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoUIAHitTestPrincipalImpl@1@W4PrologEpilogConfig@12@@Z @ 0x180029100 (--0-$CalloutWrapper@VBamoUIAHitTestPrincipalImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBam.c)
