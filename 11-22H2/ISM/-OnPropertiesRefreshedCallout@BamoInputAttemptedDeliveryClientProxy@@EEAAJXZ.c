/*
 * XREFs of ?OnPropertiesRefreshedCallout@BamoInputAttemptedDeliveryClientProxy@@EEAAJXZ @ 0x180180C50
 * Callers:
 *     <none>
 * Callees:
 *     _guard_xfg_dispatch_icall_nop @ 0x1800793F0 (_guard_xfg_dispatch_icall_nop.c)
 *     ??0?$CalloutWrapper@VBamoInputAttemptedDeliveryClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QEAA@PEAVBaseBamoConnectionImpl@12@PEAVBamoInputAttemptedDeliveryClientProxyImpl@1@@Z @ 0x180180598 (--0-$CalloutWrapper@VBamoInputAttemptedDeliveryClientProxyImpl@BamoImpl@@@BamoImpl@Microsoft@@QE.c)
