/*
 * XREFs of ?AllocateStub@BamoList_uint_Principal@dataprovider_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_uint_Stub@2345@@Z @ 0x18011CA40
 * Callers:
 *     <none>
 * Callees:
