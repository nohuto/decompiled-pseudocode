/*
 * XREFs of ?UpdateBounds@BamoControllerNavigationOverrideProxyImpl@BamoImpl@@QEAAJ_NPEBUtagRECT@@@Z @ 0x1801A187C
 * Callers:
 *     ?Thunk_UpdateBounds_57@?$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOverrideProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801A1610 (-Thunk_UpdateBounds_57@-$IControllerNavigationOverrideProxy_Receive@VBamoControllerNavigationOve.c)
