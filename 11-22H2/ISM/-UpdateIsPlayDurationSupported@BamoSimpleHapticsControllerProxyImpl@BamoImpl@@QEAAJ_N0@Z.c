/*
 * XREFs of ?UpdateIsPlayDurationSupported@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJ_N0@Z @ 0x180146754
 * Callers:
 *     ?Thunk_UpdateIsPlayDurationSupported_11@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180142070 (-Thunk_UpdateIsPlayDurationSupported_11@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapti.c)
