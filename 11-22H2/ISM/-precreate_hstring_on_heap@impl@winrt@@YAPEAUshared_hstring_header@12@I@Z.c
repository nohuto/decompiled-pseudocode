/*
 * XREFs of ?precreate_hstring_on_heap@impl@winrt@@YAPEAUshared_hstring_header@12@I@Z @ 0x1800ACC70
 * Callers:
 ...
 * Callees:
 *     _o___std_exception_copy_0 @ 0x18005722E (_o___std_exception_copy_0.c)
 *     _CxxThrowException_0 @ 0x180057B56 (_CxxThrowException_0.c)
 *     WINRT_IMPL_HeapAlloc @ 0x180057D55 (WINRT_IMPL_HeapAlloc.c)
