/*
 * XREFs of ??$?0AEB_KAEBUtagRECT@@@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@$$CB_KUtagRECT@@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@U?$pair@$$CB_KUtagRECT@@@std@@PEAX@std@@@1@AEB_KAEBUtagRECT@@@Z @ 0x1801AFCCC
 * Callers:
