/*
 * XREFs of ?UpdateOrientationBiasInDegrees@BamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@QEAAJ_NM@Z @ 0x1801469FC
 * Callers:
 *     ?Thunk_UpdateOrientationBiasInDegrees_184@?$IEdgyGestureRecognitionConfigurationProxy_Receive@VBamoEdgyGestureRecognitionConfigurationProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801420B0 (-Thunk_UpdateOrientationBiasInDegrees_184@-$IEdgyGestureRecognitionConfigurationProxy_Receive@VB.c)
