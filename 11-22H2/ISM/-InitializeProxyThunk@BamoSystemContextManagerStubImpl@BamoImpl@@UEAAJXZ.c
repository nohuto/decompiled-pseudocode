/*
 * XREFs of ?InitializeProxyThunk@BamoSystemContextManagerStubImpl@BamoImpl@@UEAAJXZ @ 0x18015BE30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoSystemContextManagerStubImpl::InitializeProxyThunk(
