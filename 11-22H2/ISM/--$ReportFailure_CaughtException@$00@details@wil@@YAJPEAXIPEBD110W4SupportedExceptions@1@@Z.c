/*
 * XREFs of ??$ReportFailure_CaughtException@$00@details@wil@@YAJPEAXIPEBD110W4SupportedExceptions@1@@Z @ 0x1800E4D44
 * Callers:
 ...
 *     ?winrt_to_hresult@wil@@YAHPEAX@Z @ 0x1800F37F0 (-winrt_to_hresult@wil@@YAHPEAX@Z.c)
 * Callees:
