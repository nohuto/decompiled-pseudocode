/*
 * XREFs of ?OnTargetWithFocusChanged@InputStateManager@@UEAAJPEAUIInputTarget@@0@Z @ 0x180024320
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
      ...
      if ( !v23 || v23 == v21 )
      {
        ...
        if ( v24 && *v24 > 1u )
        {
          ...
          {
            tlgWriteTransfer_EventWriteTransfer(v25, (int)&dword_180236FBE, 0, 0, 2u, &v48);
          }
        }
        v26 = *(_QWORD **)(v13 + 72);
