/*
 * XREFs of ?RegisterSystemContextEndpoint@BamoSystemContextManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoSystemContextEndpointPrincipal@@@Z @ 0x18013F0AC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoSystemContextManagerProxyImpl::RegisterSystemContextEndpoint(
        BamoImpl::BamoSystemContextManagerProxyImpl *this,
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *(_QWORD *)&v16 = v19;
      *((_QWORD *)&v16 + 1) = v20;
      return CoreUICallSend(v11, &v16, 2LL, 87LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
