/*
 * XREFs of ?QueryInterface@BamoAsyncResult_string_Stub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18019CA50
 * Callers:
 *     ?QueryInterface@BamoAsyncResult_string_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007D490 (-QueryInterface@BamoAsyncResult_string_Stub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
