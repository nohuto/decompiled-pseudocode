/*
 * XREFs of _DockDeviceCollection::DockDeviceCollection_::_1_::dtor$2 @ 0x1800F0C76
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DockDeviceCollection::DockDeviceCollection_::_1_::dtor_2(__int64 a1, _QWORD *a2)
{
