/*
 * XREFs of std::make_shared_GestureHandler_enum_GestureProcessorType_&_unsigned_short_const___ISystemInputRouterHitTest____lambda_80df7c2b76f58973f9ddec3659020abd__&_ @ 0x1800728C0
 * Callers:
 ...
 *     std::_Ref_count_obj2_GestureHandler_::_Ref_count_obj2_GestureHandler__enum_GestureProcessorType_&_unsigned_short_const___ISystemInputRouterHitTest____lambda_80df7c2b76f58973f9ddec3659020abd__&_ @ 0x1800726DC (std--_Ref_count_obj2_GestureHandler_--_Ref_count_obj2_GestureHandler__enum_GestureProcessorType_.c)
 *     ?_Decwref@_Ref_count_base@std@@QEAAXXZ @ 0x1800D0BC8 (-_Decwref@_Ref_count_base@std@@QEAAXXZ.c)
 *     ??$?0VGestureHandler@@$0A@@?$weak_ptr@VGestureHandler@@@std@@QEAA@AEBV?$shared_ptr@VGestureHandler@@@1@@Z @ 0x1801609A0 (--$-0VGestureHandler@@$0A@@-$weak_ptr@VGestureHandler@@@std@@QEAA@AEBV-$shared_ptr@VGestureHandl.c)
 */
