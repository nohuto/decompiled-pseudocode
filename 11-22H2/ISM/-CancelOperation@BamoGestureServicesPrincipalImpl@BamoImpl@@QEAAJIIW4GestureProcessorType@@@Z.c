/*
 * XREFs of ?CancelOperation@BamoGestureServicesPrincipalImpl@BamoImpl@@QEAAJIIW4GestureProcessorType@@@Z @ 0x1801612DC
 * Callers:
 *     ?Thunk_CancelOperation_200@?$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180073A20 (-Thunk_CancelOperation_200@-$IGestureServicesPrincipal_Receive@VBamoGestureServicesPrincipalImpl.c)
 * Callees:
