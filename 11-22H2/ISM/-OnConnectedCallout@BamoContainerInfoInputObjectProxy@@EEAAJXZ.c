/*
 * XREFs of ?OnConnectedCallout@BamoContainerInfoInputObjectProxy@@EEAAJXZ @ 0x180137140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoContainerInfoInputObjectProxy::OnConnectedCallout(BamoContainerInfoInputObjectProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoContainerInfoInputObjectProxyImpl>::CalloutWrapper<BamoImpl::BamoContainerInfoInputObjectProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoContainerInfoInputObjectProxy *))(*(_QWORD *)v1 + 32LL))(v1);
