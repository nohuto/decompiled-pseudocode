/*
 * XREFs of ?_Throw_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800D101C
 * Callers:
 ...
 *     ?CreateCursorForDevice@SystemCursorController2@@MEAAJPEAVBamoSystemCursorControllerStub@@_K@Z @ 0x1801101A0 (-CreateCursorForDevice@SystemCursorController2@@MEAAJPEAVBamoSystemCursorControllerStub@@_K@Z.c)
 ...
 *     ?SetCursorShellMagnification@SystemCursorController2@@MEAAJPEAVBamoSystemCursorControllerStub@@_KM@Z @ 0x180111600 (-SetCursorShellMagnification@SystemCursorController2@@MEAAJPEAVBamoSystemCursorControllerStub@@_.c)
 *     ?SetCursorShellVisibility@SystemCursorController2@@MEAAJPEAVBamoSystemCursorControllerStub@@_K_N@Z @ 0x180111850 (-SetCursorShellVisibility@SystemCursorController2@@MEAAJPEAVBamoSystemCursorControllerStub@@_K_N.c)
 *     ?EstablishEndpointToSendMessagesFromRoutingInfo@TestCommandHost@@AEAAXPEBUtagMsgRoutingInfo@@@Z @ 0x180124964 (-EstablishEndpointToSendMessagesFromRoutingInfo@TestCommandHost@@AEAAXPEBUtagMsgRoutingInfo@@@Z.c)
