/*
 * XREFs of ?DestroyCursorShape@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1801106F8
 * Callers:
 *     ?Thunk_DestroyCursorShape_394@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180068200 (-Thunk_DestroyCursorShape_394@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorContro.c)
 * Callees:
