/*
 * XREFs of ?OnDisconnectedThunk@BamoSystemContextEndpointStubImpl@BamoImpl@@UEAAJXZ @ 0x1800B1590
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(int *)(v3 + 8) > 0 )
  {
    ...
    Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoSystemContextEndpointPrincipalImpl>::CalloutWrapper<BamoImpl::BamoSystemContextEndpointPrincipalImpl>(
      ...
      *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
      v3);
    v2 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v4 + 112LL))(v4, (char *)this - 16);
