/*
 * XREFs of ?OnPropertiesRefreshedThunk@BamoMPCConstantManagerClientStubImpl@BamoImpl@@UEAAJXZ @ 0x1800BEC80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCConstantManagerClientStubImpl::OnPropertiesRefreshedThunk(
  ...
  if ( *(int *)(v5 + 8) > 0 )
  {
    ...
    Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
      ...
      *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
      a3,
      0LL);
    v4 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v6 + 88LL))(v6, (char *)this - 16);
    Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
      v11,
      v7,
      v8,
