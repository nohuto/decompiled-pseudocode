/*
 * XREFs of ?QueryInterface@BamoInputSpacePayloadProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013CF10
 * Callers:
 *     ?QueryInterface@BamoInputSpacePayloadProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B1D0 (-QueryInterface@BamoInputSpacePayloadProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
