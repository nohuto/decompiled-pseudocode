/*
 * XREFs of ?QueryInterface@error_info_fallback@impl@winrt@@UEAAHAEBUguid@3@PEAPEAX@Z @ 0x1800ABB40
 * Callers:
 *     ?QueryInterface@error_info_fallback@impl@winrt@@W7EAAHAEBUguid@3@PEAPEAX@Z @ 0x180079590 (-QueryInterface@error_info_fallback@impl@winrt@@W7EAAHAEBUguid@3@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
