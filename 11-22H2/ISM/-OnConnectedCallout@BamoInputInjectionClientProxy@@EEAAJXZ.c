/*
 * XREFs of ?OnConnectedCallout@BamoInputInjectionClientProxy@@EEAAJXZ @ 0x1801C3FB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoInputInjectionClientProxy::OnConnectedCallout(BamoInputInjectionClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoInputInjectionClientProxyImpl>::CalloutWrapper<BamoImpl::BamoInputInjectionClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoInputInjectionClientProxy *))(*(_QWORD *)v1 + 32LL))(v1);
