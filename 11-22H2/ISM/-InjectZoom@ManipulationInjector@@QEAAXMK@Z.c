/*
 * XREFs of ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x18012B1E8
 * Callers:
 ...
 *     ?CheckOverlapAndEvent@ManipulationInjector@@AEAA_NXZ @ 0x180129AE8 (-CheckOverlapAndEvent@ManipulationInjector@@AEAA_NXZ.c)
 *     ?Clip@ManipulationInjector@@AEAA_NAEAUtagPOINT@@UtagRECT@@J@Z @ 0x180129B40 (-Clip@ManipulationInjector@@AEAA_NAEAUtagPOINT@@UtagRECT@@J@Z.c)
 ...
 *     ?TransitionZoomTypes@ManipulationInjector@@AEAAXXZ @ 0x18012B970 (-TransitionZoomTypes@ManipulationInjector@@AEAAXXZ.c)
 *     ?UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z @ 0x18012BB48 (-UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z.c)
 *     ?UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z @ 0x18012BBD4 (-UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z.c)
 */
