/*
 * XREFs of ?QueryInterface@BamoInputSystemInternalPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18014B650
 * Callers:
 *     ?QueryInterface@BamoInputSystemInternalPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B3F0 (-QueryInterface@BamoInputSystemInternalPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
