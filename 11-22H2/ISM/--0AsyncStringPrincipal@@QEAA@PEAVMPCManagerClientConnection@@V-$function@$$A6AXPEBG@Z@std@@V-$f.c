/*
 * XREFs of ??0AsyncStringPrincipal@@QEAA@PEAVMPCManagerClientConnection@@V?$function@$$A6AXPEBG@Z@std@@V?$function@$$A6AXJ@Z@3@@Z @ 0x18019C510
 * Callers:
 ...
 *     ??0?$function@$$A6AXJ@Z@std@@QEAA@AEBV01@@Z @ 0x18019B924 (--0-$function@$$A6AXJ@Z@std@@QEAA@AEBV01@@Z.c)
 */
