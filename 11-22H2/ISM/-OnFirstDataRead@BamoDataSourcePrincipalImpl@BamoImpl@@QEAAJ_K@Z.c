/*
 * XREFs of ?OnFirstDataRead@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x18011F060
 * Callers:
 *     ?Thunk_OnFirstDataRead_0@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180122110 (-Thunk_OnFirstDataRead_0@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@.c)
 * Callees:
