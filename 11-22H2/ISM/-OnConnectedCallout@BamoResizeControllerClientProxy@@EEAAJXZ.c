/*
 * XREFs of ?OnConnectedCallout@BamoResizeControllerClientProxy@@EEAAJXZ @ 0x180137D10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoResizeControllerClientProxy::OnConnectedCallout(BamoResizeControllerClientProxy *this)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<BamoImpl::BamoResizeControllerClientProxyImpl>::CalloutWrapper<BamoImpl::BamoResizeControllerClientProxyImpl>(
    ...
    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    (__int64)this + 16);
  LODWORD(v1) = (*(__int64 (__fastcall **)(BamoResizeControllerClientProxy *))(*(_QWORD *)v1 + 32LL))(v1);
