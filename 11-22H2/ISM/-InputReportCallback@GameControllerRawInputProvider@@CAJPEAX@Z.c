/*
 * XREFs of ?InputReportCallback@GameControllerRawInputProvider@@CAJPEAX@Z @ 0x1800DBFA0
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800334B8 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x1800793F0 (_guard_xfg_dispatch_icall_nop.c)
 *     ??1?$unique_ptr@UInputInfo@@P6AXPEAU1@@Z@std@@QEAA@XZ @ 0x1800DBAF4 (--1-$unique_ptr@UInputInfo@@P6AXPEAU1@@Z@std@@QEAA@XZ.c)
 */
...
__int64 __fastcall GameControllerRawInputProvider::InputReportCallback(void *a1)
{
  ...
  *(_QWORD *)v4 = lambda_31685d6d76905a19580e009ac071d915_::_lambda_invoker_cdecl_;
  ...
  if ( GameControllerRawInputProvider::s_instance
    && (v1 = (*(__int64 (__fastcall **)(_QWORD, void *))(**((_QWORD **)GameControllerRawInputProvider::s_instance + 6)
                                                       + 24LL))(
