/*
 * XREFs of ?ForcePrimaryInputType@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJW4InputType@@@Z @ 0x1800C1510
 * Callers:
 *     ?Thunk_ForcePrimaryInputType_5@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800C4420 (-Thunk_ForcePrimaryInputType_5@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoI.c)
 * Callees:
  ...
  if ( *(int *)(a1 + 8) > 0 )
  {
    Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
      ...
      *(_QWORD *)(v9 + 32),
      v7,
      0LL);
    v11 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)(a1 - 16) + 120LL))(a1 - 16, v8, a2);
    v4 = v11;
    v14 = 2276591628LL;
    if ( v11 == -2018375668 )
    {
