/*
 * XREFs of ??1heap_buffer@details_abi@wil@@QEAA@XZ @ 0x1800A522C
 * Callers:
 *     _wil::details_abi::RawUsageIndex::RecordUsage_::_1_::dtor$0 @ 0x1800A704F (_wil--details_abi--RawUsageIndex--RecordUsage_--_1_--dtor$0.c)
 * Callees:
