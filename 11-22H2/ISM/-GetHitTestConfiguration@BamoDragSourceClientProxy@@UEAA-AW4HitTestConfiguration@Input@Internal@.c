/*
 * XREFs of ?GetHitTestConfiguration@BamoDragSourceClientProxy@@UEAA?AW4HitTestConfiguration@Input@Internal@UI@Windows@@XZ @ 0x1801331A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDragSourceClientProxy::GetHitTestConfiguration(__int64 a1)
{
  __int64 v1; // rbx
  __int64 v2; // rdx
  __int64 v3; // r8
