/*
 * XREFs of ?ProcessResult@BamoGestureServicesProxy@@UEAAJIAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientPrincipal@@@Z @ 0x18013BF70
 * Callers:
 *     <none>
 * Callees:
