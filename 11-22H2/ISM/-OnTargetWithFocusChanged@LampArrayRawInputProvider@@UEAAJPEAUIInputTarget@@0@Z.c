/*
 * XREFs of ?OnTargetWithFocusChanged@LampArrayRawInputProvider@@UEAAJPEAUIInputTarget@@0@Z @ 0x180011020
 * Callers:
 *     <none>
 * Callees:
 *     ??9Iterator@?$NtList@ULampArrayClientListEntry@LampArrayRawInputProvider@@@@QEBA_NAEBV01@@Z @ 0x18001140C (--9Iterator@-$NtList@ULampArrayClientListEntry@LampArrayRawInputProvider@@@@QEBA_NAEBV01@@Z.c)
...
LABEL_17:
  if ( (unsigned int)dword_180275498 > 5 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Level = 5;
    ...
    UserData.Ptr = (ULONGLONG)off_1802754A0;
    UserData.Size = *(unsigned __int16 *)off_1802754A0;
    UserData.Reserved = 2;
    v36 = &unk_180232ED6;
    v37 = 91;
    v38 = 1;
