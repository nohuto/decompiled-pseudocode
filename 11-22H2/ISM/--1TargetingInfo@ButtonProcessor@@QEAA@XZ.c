/*
 * XREFs of ??1TargetingInfo@ButtonProcessor@@QEAA@XZ @ 0x1801E5960
 * Callers:
 *     _ButtonProcessor::OnInputReport_::_1_::dtor$2 @ 0x1801E6211 (_ButtonProcessor--OnInputReport_--_1_--dtor$2.c)
 * Callees:
