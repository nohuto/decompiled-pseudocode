/*
 * XREFs of ?QueryInterface@BamoGestureServicesProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013CB20
 * Callers:
 *     ?QueryInterface@BamoGestureServicesProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18007B0F0 (-QueryInterface@BamoGestureServicesProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
