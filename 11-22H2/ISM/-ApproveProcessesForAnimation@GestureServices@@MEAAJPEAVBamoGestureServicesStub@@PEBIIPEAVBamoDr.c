/*
 * XREFs of ?ApproveProcessesForAnimation@GestureServices@@MEAAJPEAVBamoGestureServicesStub@@PEBIIPEAVBamoDragManagerClientProxy@@@Z @ 0x180052AD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoDragManagerClientProxy *a5)
{
  ...
  if ( GestureServices::IsShellClient(this, a5) )
  {
    ...
    if ( a3 && (_DWORD)v7 )
    {
      ...
      while ( a3 != (const unsigned __int8 *)v9 )
      {
