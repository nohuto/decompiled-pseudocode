/*
 * XREFs of ?GetGestureTimeoutInMilliseconds@BamoEdgyGestureRecognitionConfigurationProxy@@UEAAIXZ @ 0x180133100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoEdgyGestureRecognitionConfigurationProxy::GetGestureTimeoutInMilliseconds(
