/*
 * XREFs of ?GetVirtualTouchpadController@BamoInputSiteElementProxy@@UEAAPEAVBamoVirtualTouchpadControllerProxy@@XZ @ 0x180011A60
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  return (struct BamoVirtualTouchpadControllerProxy *)*((_QWORD *)this + 38);
}
