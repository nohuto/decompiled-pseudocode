/*
 * XREFs of ?RegisterEdgyControllerClient@BamoEdgyControllerServerProxyImpl@BamoImpl@@QEAAJPEBGPEAVBamoEdgyControllerClientPrincipal@@@Z @ 0x18013DC5C
 * Callers:
  ...
  else
  {
    if ( a3 )
      Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteReference(
        ...
        a3);
    v8 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(this, v16, &v20, &v21);
    v9 = v8;
    if ( v8 >= 0 )
    {
      v10 = *((_BYTE *)this + 31) == 0;
      ...
      return CoreUICallSend(v11, v16, 2LL, 36LL);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
