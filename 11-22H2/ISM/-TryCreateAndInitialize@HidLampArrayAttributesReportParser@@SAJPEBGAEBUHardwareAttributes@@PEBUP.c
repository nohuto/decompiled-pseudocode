/*
 * XREFs of ?TryCreateAndInitialize@HidLampArrayAttributesReportParser@@SAJPEBGAEBUHardwareAttributes@@PEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x180065504
 * Callers:
 ...
 *     ??0HidLampArrayAttributesReportParser@@AEAA@XZ @ 0x180103C34 (--0HidLampArrayAttributesReportParser@@AEAA@XZ.c)
 */
