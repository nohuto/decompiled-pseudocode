/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x140008D1C
 * Callers:
 ...
 *     ?GetLastErrorFailHr@details@wil@@YAJXZ @ 0x1400094B0 (-GetLastErrorFailHr@details@wil@@YAJXZ.c)
