 ...
 *     ?RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x140001734 (-RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 ...
 *     ?Unsubscribe@SubscriptionList@details_abi@wil@@QEAAXAEAVsrwlock@3@PEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x14000B974 (-Unsubscribe@SubscriptionList@details_abi@wil@@QEAAXAEAVsrwlock@3@PEAUFEATURE_STATE_CHANGE_SUBSC.c)
 * Callees:
 *     <none>
 */
