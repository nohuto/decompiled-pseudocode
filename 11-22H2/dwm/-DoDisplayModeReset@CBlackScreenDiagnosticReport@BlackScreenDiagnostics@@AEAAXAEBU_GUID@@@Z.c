/*
 * XREFs of ?DoDisplayModeReset@CBlackScreenDiagnosticReport@BlackScreenDiagnostics@@AEAAXAEBU_GUID@@@Z @ 0x14000C774
 * Callers:
 ...
 *     BlackScreenDiagnostics::TriggerGraphicsCollection @ 0x14000D6B8 (BlackScreenDiagnostics--TriggerGraphicsCollection.c)
 *     _tlgKeywordOn @ 0x14000DB78 (_tlgKeywordOn.c)
 *     _tlgWriteTransfer_EventWriteTransfer @ 0x14000DBAC (_tlgWriteTransfer_EventWriteTransfer.c)
