/*
 * XREFs of ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x1400095A4
 * Callers:
 *     ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x140009130 (-GetCurrentModuleName@details@wil@@YAPEBDXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x140005510 (__security_check_cookie.c)
 *     ?StringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x14000A388 (-StringCchCopyA@@YAJPEAD_KPEBD@Z.c)
 */
