/*
 * XREFs of ?GetValueFromSemaphore@SemaphoreValue@details_abi@wil@@CAJPEAXPEAJ@Z @ 0x1400049D4
 * Callers:
 ...
 * Callees:
 *     ?Return_GetLastError@in1diag3@details@wil@@YAJPEAXIPEBD@Z @ 0x14000A074 (-Return_GetLastError@in1diag3@details@wil@@YAJPEAXIPEBD@Z.c)
