/*
 * XREFs of ?SetDword@CSettingsManager@@AEAAJW4DwmSettingType@@PEBGK@Z @ 0x14000BFFC
 * Callers:
 *     ?SetPreferenceDword@CSettingsManager@@UEAAJPEBGK@Z @ 0x14000C0B0 (-SetPreferenceDword@CSettingsManager@@UEAAJPEBGK@Z.c)
 * Callees:
