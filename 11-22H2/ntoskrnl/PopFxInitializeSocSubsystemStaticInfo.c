/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x140984CE0
 * Callers:
...
LABEL_20:
    ...
    v21 = (unsigned int **)qword_140C3EC38;
    v3 = 0;
    if ( *(__int64 **)qword_140C3EC38 != &SocSubsystemsList )
      __fastfail(3u);
    *(_QWORD *)v5 = &SocSubsystemsList;
    *((_QWORD *)v5 + 1) = v21;
    *v21 = v5;
    qword_140C3EC38 = (__int64)v5;
  }
  else
  {
