/*
 * XREFs of MiIsAnyPartOfRangeInHugePfn @ 0x140621350
 * Callers:
...
__int64 __fastcall MiIsAnyPartOfRangeInHugePfn(unsigned __int64 a1, __int64 a2)
{
  ...
  v4 = (a1 >> 18) & 0x3FFFFF;
  v5 = v3 - v4 + 1;
  if ( v4 >= stru_140C67EE0.SizeOfBitMap )
    return 1LL;
  if ( v5 <= 1 )
    return v3 != v4 || _bittest64((const signed __int64 *)&stru_140C67EE0.Buffer[v4 >> 6], v4 & 0x3F);
  if ( stru_140C67EE0.SizeOfBitMap - v4 < v5 )
    return 1LL;
  v7 = &stru_140C67EE0.Buffer[v4 >> 6];
  v8 = *v7;
  v9 = &stru_140C67EE0.Buffer[v3 >> 6];
  if ( v7 != v9 )
  {
