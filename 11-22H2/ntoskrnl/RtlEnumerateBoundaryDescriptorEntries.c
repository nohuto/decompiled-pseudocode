/*
 * XREFs of RtlEnumerateBoundaryDescriptorEntries @ 0x1407C9578
 * Callers:
 ...
 *     ObpCheckDuplicateEntries @ 0x1407C94BC (ObpCheckDuplicateEntries.c)
 *     ObpCompareEntryLevel1 @ 0x1407C9520 (ObpCompareEntryLevel1.c)
