/*
 * XREFs of RtlpHpSegPageRangeCommit @ 0x14024E2D0
 * Callers:
 *     RtlpHpSegAlloc @ 0x14024DB20 (RtlpHpSegAlloc.c)
 *     RtlpHpSegLfhVsCommit @ 0x14024E1D0 (RtlpHpSegLfhVsCommit.c)
 ...
 *     RtlpHpSegPageRangeHandleCommit @ 0x14024F3E0 (RtlpHpSegPageRangeHandleCommit.c)
 */
...
LABEL_17:
    ...
    if ( v24 )
    {
      ...
      result = RtlpHpSegMgrCommit(a1, v24, v36, v8);
      if ( (int)result >= 0 )
      {
        if ( v24 > 0 )
          RtlpHpSegPageRangeHandleCommit(a1, a2, (unsigned int)&v47, (unsigned int)&v48, 1);
