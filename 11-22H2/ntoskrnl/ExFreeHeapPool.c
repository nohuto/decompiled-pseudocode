/*
 * XREFs of ExFreeHeapPool @ 0x140322ED0
 * Callers:
...
LABEL_3:
  ...
  v38 = RtlCSparseBitmapBitmaskRead(&unk_140C711D0, 2 * ((BugCheckParameter2 - qword_140C711C8) >> 20));
  if ( v38 )
  {
    v2 = v38 - 1;
    if ( v2 != 2 )
...
LABEL_22:
        ...
        !(_DWORD)v31) )
  {
          ...
          (int)v31 >= 0) )
    {
      ...
      {
        v35 = RtlCSparseBitmapBitmaskRead(&unk_140C711D0, 2 * ((v5 - qword_140C711C8) >> 20));
