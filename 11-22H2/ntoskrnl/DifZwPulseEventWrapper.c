/*
 * XREFs of DifZwPulseEventWrapper @ 0x1405F3620
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwPulseEventWrapper(HANDLE EventHandle, PLONG PreviousState)
{
...
LABEL_17:
  result = ZwPulseEvent(EventHandle, PreviousState);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
