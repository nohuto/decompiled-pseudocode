/*
 * XREFs of HalpTimerTraceTimingHardware @ 0x140861740
 * Callers:
...
void HalpTimerTraceTimingHardware()
{
  ...
  if ( (unsigned int)dword_140C04BB0 > 5 && tlgKeywordOn((__int64)&dword_140C04BB0, 0x400000000000LL) )
  {
    ...
    v28 = 4LL;
    v27 = &v13;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04BB0, (unsigned __int8 *)byte_1400292E9, 0LL, 0LL, 9u, &v14);
  }
}
