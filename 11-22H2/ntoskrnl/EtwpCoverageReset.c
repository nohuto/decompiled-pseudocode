/*
 * XREFs of EtwpCoverageReset @ 0x1409E850C
 * Callers:
 ...
 *     EtwpCoverageResetWorkItemCallback @ 0x1409E89C0 (EtwpCoverageResetWorkItemCallback.c)
 * Callees:
...
struct _KTHREAD *__fastcall EtwpCoverageReset(__int64 a1, char a2)
{
  ...
  {
    if ( (unsigned int)dword_140C093F4 < MEMORY[0xFFFFF7800000037C] )
    {
      if ( !dword_140C093F0 )
        dword_140C093F0 = TelemetryCoverageStringHashInternal(off_140C093E8, &v7);
      EtwTelemetryCoverageReport((__int64 *)&off_140C093E8);
    }
