/*
 * XREFs of IommupHvFlushDomainTbs @ 0x140524C00
 * Callers:
...
__int64 __fastcall IommupHvFlushDomainTbs(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v16 = 0LL;
  v17[0] = 0LL;
  if ( qword_140C62780 && qword_140C62678 && a3 )
  {
    v5 = a2 + a3 - 1;
    if ( v5 >= a2 )
    {
    ...
    while ( v9 != (__int64 *)(a1 + 72) )
    {
      ...
      {
        LOBYTE(v15) = 1;
        qword_140C62678(0LL, v11, v6, v17, v15);
      }
      else if ( !v10 )
      {
        v16 = 0LL;
        ...
        BYTE4(v16) = 1;
        ((void (__fastcall *)(__int64 *))qword_140C62780)(&v16);
        v10 = 1;
      }
      v9 = (__int64 *)*v9;
    }
