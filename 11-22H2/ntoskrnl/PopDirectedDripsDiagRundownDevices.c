/*
 * XREFs of PopDirectedDripsDiagRundownDevices @ 0x14099E948
 * Callers:
...
void PopDirectedDripsDiagRundownDevices()
{
  ...
  while ( 1 )
  {
    v1 = (unsigned int *)qword_140C38ED0;
    if ( qword_140C38ED0 == &qword_140C38ED0 )
      break;
    if ( *((PVOID **)qword_140C38ED0 + 1) != &qword_140C38ED0
      || (v2 = *(_QWORD *)qword_140C38ED0, *(PVOID *)(*(_QWORD *)qword_140C38ED0 + 8LL) != qword_140C38ED0) )
    {
      __fastfail(3u);
    }
    qword_140C38ED0 = *(PVOID *)qword_140C38ED0;
    v3 = 0LL;
    *(_QWORD *)(v2 + 8) = &qword_140C38ED0;
    v4 = 0LL;
    v32 = 0;
    v5 = v1[39];
    if ( v5 )
    ...
    if ( (*v7 & 0x40000) != 0 )
    {
      ...
      if ( (unsigned int)dword_140D53980 > 5 && tlgKeywordOn((__int64)&dword_140D53980, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)word_140031D22,
          0LL,
          0LL,
          0x16u,
          &v46);
      ...
      if ( PopDiagHandleRegistered )
      {
        ...
        if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_DIRECTED_DRIPS_DEVICE_STATS) )
        {
          *(_QWORD *)&PopDirectedDripsDiagEventData.Size = 1LL;
          ...
          qword_140C39138 = 8LL;
          qword_140C39130 = (__int64)(v1 + 4);
          v34 = v8->Length >> 1;
          qword_140C39140 = (__int64)&v34;
          qword_140C39148 = 4LL;
          Length = v8->Length;
          qword_140C39150 = (__int64)v8->Buffer;
          dword_140C39158 = Length;
          dword_140C3915C = 0;
          v35 = v9->Length >> 1;
          qword_140C39160 = (__int64)&v35;
          qword_140C39168 = 4LL;
          v15 = v9->Length;
          qword_140C39170 = (__int64)v9->Buffer;
          dword_140C39178 = v15;
          dword_140C3917C = 0;
          v36 = v10->Length >> 1;
          qword_140C39180 = (__int64)&v36;
          qword_140C39188 = 4LL;
          v16 = v10->Length;
          qword_140C39190 = (__int64)v10->Buffer;
          dword_140C39198 = v16;
          dword_140C3919C = 0;
          LODWORD(v37) = v11->Length >> 1;
          qword_140C391A0 = (__int64)&v37;
          qword_140C391A8 = 4LL;
          v17 = v11->Length;
          qword_140C391B0 = (__int64)v11->Buffer;
          qword_140C391C0 = (__int64)(v1 + 37);
          qword_140C391D0 = (__int64)(v1 + 39);
          dword_140C391B8 = v17;
          qword_140C391E0 = (__int64)(v1 + 40);
          dword_140C391BC = 0;
          qword_140C391C8 = 4LL;
          qword_140C391D8 = 4LL;
          qword_140C391E8 = 4LL;
          qword_140C391F0 = (__int64)(v1 + 38);
          qword_140C391F8 = 4LL;
