/*
 * XREFs of KiEpfStart @ 0x1405790C4
 * Callers:
...
LABEL_14:
  ...
  if ( v5 )
  {
    _InterlockedIncrement(&dword_140C41770);
    v9 = _InterlockedIncrement(&dword_140C41774);
    do
      v10 = dword_140C41778;
    while ( dword_140C41778 < v9 && v10 != _InterlockedCompareExchange(&dword_140C41778, v9, dword_140C41778) );
    v11 = KeSetKernelStackSwapEnable(0);
    KeWaitForGate((__int64)&v15, 39, 0);
    result = KeSetKernelStackSwapEnable(v11);
    _InterlockedDecrement(&dword_140C41774);
  }
  return result;
}
