/*
 * XREFs of MiRemoveFromSystemSpace @ 0x1402137A0
 * Callers:
...
void __fastcall MiRemoveFromSystemSpace(ULONG_PTR BugCheckParameter1, int a2)
{
  ...
  if ( (BugCheckParameter1 & 0x3FFFFFFF) != 0 )
    goto LABEL_2;
  v30 = (volatile LONG *)((char *)&unk_140C68658 + 16 * (unsigned __int8)(BugCheckParameter1 >> 30));
...
LABEL_2:
    ...
    if ( v10->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v6, v10)) != 0 )
    {
      ...
      *(_QWORD *)v9 = (unsigned __int64)&qword_140C68640 & 0x7FFFFFFFFFFFFFFCLL;
    }
    if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C68640, 0LL) )
      ExfAcquirePushLockExclusiveEx(&qword_140C68640, v9, &qword_140C68640);
    if ( v9 )
      v9[18] = 1;
  ...
  if ( (v21[7] & 0x18) == 0x18 )
    MiReleasePtes(&unk_140C684B0, v4, (unsigned int)v27);
  else
