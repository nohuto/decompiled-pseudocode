/*
 * XREFs of MiInsertInSystemSpace @ 0x140213D30
 * Callers:
        ...
        ULONG_PTR *a6)
{
  ...
  *a6 = 0LL;
  ...
  v16 = (a1 >> 12) + v9;
  v86 = 16 * v14;
  v17 = *(_QWORD *)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(AnyMultiplexedVm + 174));
  v88 = v17;
...
LABEL_78:
  ...
  {
LABEL_6:
    v20 = MiReservePtes(&unk_140C684B0, (unsigned int)v86);
    v13 = v20;
    if ( !v20 )
    {
      ++dword_140C684D0;
...
LABEL_80:
          ...
          if ( !v13 )
            goto LABEL_85;
          if ( v11 >= 3 )
            MiReleasePtes(&unk_140C684B0, v13, (unsigned int)v86);
          else
  ...
  *(_QWORD *)(v10 + 64) = MiReferenceFileObjectForMap(a2);
  ...
  if ( v84 || (v48 = v83, (*(_DWORD *)(v83 + 56) & 0x400) != 0) )
  {
    ...
    if ( v31->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v28, v31)) != 0 )
    {
      ...
      if ( (unsigned __int64)&qword_140C68640 - qword_140C65AE8 < 0x8000000000LL )
        SessionId = MmGetSessionIdEx(v31->ApcState.Process);
      else
        SessionId = -1;
      *((_DWORD *)v32 + 2) = SessionId;
      *(_QWORD *)v32 = (unsigned __int64)&qword_140C68640 & 0x7FFFFFFFFFFFFFFCLL;
    }
    if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C68640, 0LL) )
      ExfAcquirePushLockExclusiveEx(&qword_140C68640, v32, &qword_140C68640);
    if ( v32 )
      v32[18] = 1;
    ...
    *(_DWORD *)(SharedVm + 4) = 0;
    ...
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C68640, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock(&qword_140C68640);
    KeAbPostRelease((ULONG_PTR)&qword_140C68640);
  ...
  {
    v63 = (volatile LONG *)((char *)&unk_140C68658 + 16 * (unsigned __int8)(v27 >> 30));
