/*
 * XREFs of KiUpdateGlobalCpuSetConfiguration @ 0x14039DBFC
 * Callers:
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(v4 + 64) = 0LL;
      if ( (xmmword_140D1EAD0 & 0x8000000) != 0 )
        EtwTraceIdealProcessor(v4, 1350LL, v5, v7);
      v9 = *(_QWORD *)(v3 + 16);
      if ( v9 )
      {
...
LABEL_10:
      ...
      if ( (unsigned int)v2 >= (unsigned int)KeNumberProcessors_0 )
        return KiFlushSoftwareInterruptBatch(&CurrentPrcb->DeferredDispatchInterrupts.Level);
    }
...
LABEL_37:
    ...
    KiCommitRescheduleContext((unsigned __int8 *)v31, (__int64)CurrentPrcb, 0, v30);
    goto LABEL_10;
  }
  return KiFlushSoftwareInterruptBatch(&CurrentPrcb->DeferredDispatchInterrupts.Level);
}
