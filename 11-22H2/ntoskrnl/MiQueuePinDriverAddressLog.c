...
void __fastcall MiQueuePinDriverAddressLog(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( !PoAllProcIntrDisabled && (KiBugCheckActive & 3) == 0 && !KdEnteredDebugger )
  {
    ...
    if ( (word_140C13032 & 1) != 0 )
    {
      ...
      {
        v7 = v6 + 1;
        v8 = v7 < dword_140C12EC0 ? v7 : 0;
        v9 = dword_140C12EC0 - 1;
        v10 = (qword_140C12EC8 & 4) != 0 ? 0x20 : 0;
        v11 = qword_140C12EC8 - ((qword_140C12EC8 & 4) != 0 ? 4 : 0);
        while ( 1 )
        {
          v35 = 0;
          v12 = v10 + v9;
...
LABEL_15:
        if ( v6 == -1 )
          break;
        if ( (unsigned int)RtlInterlockedSetClearRun(&dword_140C12EC0, v6, 1LL) )
        {
          if ( v6 >= 0x800 )
            break;
          v16 = MiFlags;
