/*
 * XREFs of MiQueuePinDriverAddressLog @ 0x14029589C
 * Callers:
...
void __fastcall MiQueuePinDriverAddressLog(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( !PoAllProcIntrDisabled && (KiBugCheckActive & 3) == 0 && !KdEnteredDebugger )
  {
    ...
    v6 = -1;
    if ( (word_140C13032 & 1) != 0 )
    {
      while ( 1 )
      {
        v7 = v6 + 1;
        v8 = v7 < stru_140C12EC0.SizeOfBitMap ? v7 : 0;
        v9 = stru_140C12EC0.SizeOfBitMap - 1;
        v10 = ((__int64)stru_140C12EC0.Buffer & 4) != 0LL ? 0x20 : 0;
        v11 = (char *)stru_140C12EC0.Buffer - (((__int64)stru_140C12EC0.Buffer & 4) != 0LL ? 4 : 0);
        while ( 1 )
        {
          v35 = 0;
          v12 = v10 + v9;
...
LABEL_58:
          if ( !v8 )
            goto LABEL_15;
          SizeOfBitMap = v7 + 1;
          if ( v7 + 1 > stru_140C12EC0.SizeOfBitMap )
            SizeOfBitMap = stru_140C12EC0.SizeOfBitMap;
          v9 = SizeOfBitMap - 1;
          v8 = 0;
        }
...
LABEL_15:
        if ( v6 == -1 )
          break;
        if ( (unsigned int)RtlInterlockedSetClearRun(&stru_140C12EC0, v6, 1LL) )
        {
          if ( v6 >= 0x800 )
            break;
          v16 = MiFlags;
    ...
    v27 = (char *)&unk_140C12FD8;
    if ( !(_BYTE)KdDebuggerEnabled )
      v27 = (char *)&unk_140C12FD0;
