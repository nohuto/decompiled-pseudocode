/*
 * XREFs of PopQueueQuerySetIrp @ 0x14028E8AC
 * Callers:
...
LABEL_24:
  ...
  if ( v2 )
  {
    v19 = (struct _LIST_ENTRY *)qword_140C3D638;
    if ( *(__int64 **)qword_140C3D638 != &PopInrushIrpList )
      goto LABEL_38;
    ...
    qword_140C3D638 = (__int64)&v3->Tail.Overlay.ListEntry;
  }
  v12 = v10[1];
  if ( v12 )
  {
