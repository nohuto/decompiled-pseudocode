/*
 * XREFs of CmpDoParseKey @ 0x1406E91B0
 * Callers:
 ...
 *     CmpGetComponentHashAtIndex @ 0x1407E6844 (CmpGetComponentHashAtIndex.c)
...
LABEL_230:
            ...
            if ( PsIsCurrentThreadInServerSilo() && (unsigned int)dword_140C04390 > 5 )
            {
              if ( tlgKeywordOn((__int64)&dword_140C04390, 0x200000010000LL) )
              {
                ...
                v450 = &v412;
                v451 = 8LL;
                tlgWriteAgg((__int64)&dword_140C04390, (unsigned __int8 *)&byte_140036BAD, v132, 3u, &v449);
                v133 = dword_140C04390;
              }
              if ( v133 > 5 )
                tlgWriteTransfer_EtwWriteTransfer(
                  (__int64)&dword_140C04390,
                  (unsigned __int8 *)&byte_140036BFF,
                  0LL,
                  0LL,
                  2u,
                  &v452);
