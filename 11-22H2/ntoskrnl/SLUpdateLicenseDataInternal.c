/*
 * XREFs of SLUpdateLicenseDataInternal @ 0x1409FA744
 * Callers:
 ...
 *     ExpLicUpdateChecksum @ 0x140609238 (ExpLicUpdateChecksum.c)
 ...
 *     ExpReducedLicenseData @ 0x1407EB2C0 (ExpReducedLicenseData.c)
 *     sub_1408120C4 @ 0x1408120C4 (sub_1408120C4.c)
 *     sub_1408314D0 @ 0x1408314D0 (sub_1408314D0.c)
...
LABEL_131:
  ...
  *(_OWORD *)BugCheckParameter1 = *(_OWORD *)a3;
  ...
  v52 = sub_1408120C4((__int64)v27, 1, 0LL, 0, (unsigned int *)&NumOfElements);
  if ( v52 == -1073741789 )
  {
...
LABEL_136:
    ...
    v52 = sub_1408120C4(BugCheckParameter1, 0, Pool2, NumOfElements, 0LL);
    if ( v52 >= 0 )
      qsort(v8, v31, 0x10uLL, (int (__cdecl *)(const void *, const void *))sub_1408314D0);
    v29 = 0;
  }
  else
  {
  ...
  if ( !v66 )
  {
    ...
    while ( v33 < (unsigned int)NumOfElements )
    {
      ...
      v36 = sub_1408314D0(&Src[2 * v33], (_QWORD *)(16 * v34 + a1 + 24));
      v75 = v36;
      v37 = Src[2 * v33 + 1];
      v78 = v37;
