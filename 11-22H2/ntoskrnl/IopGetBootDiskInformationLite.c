/*
 * XREFs of IopGetBootDiskInformationLite @ 0x140B55268
 * Callers:
 *     IoGetBootDiskInformationLite @ 0x140823950 (IoGetBootDiskInformationLite.c)
 * Callees:
 *     RtlInitAnsiString @ 0x1402F6C50 (RtlInitAnsiString.c)
 *     IopCheckDiskName @ 0x140387828 (IopCheckDiskName.c)
 *     IopAddBootDiskInformation @ 0x140387A18 (IopAddBootDiskInformation.c)
