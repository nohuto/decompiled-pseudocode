/*
 * XREFs of MiGetPageChain @ 0x14026C5E0
 * Callers:
        ...
        unsigned __int64 *a8)
{
  ...
  if ( a4 )
  {
    ...
    NodeShiftedColor = v11 << byte_140C65B8D;
  }
  else
  {
...
LABEL_15:
    ...
    {
      v90 = 15LL;
      if ( (unsigned int)dword_140C65BF8 < 0xFuLL )
        v90 = (unsigned int)dword_140C65BF8;
      v91 = v90 & v17;
    ...
    if ( v26 != a5 )
    {
      ...
      if ( ((unsigned __int8)v23 & (unsigned __int8)byte_140C65C98) != 0 )
      {
        v93 = v104;
        v123[v104] = Page;
        v104 = v93 + 1;
...
LABEL_117:
      ...
      v50 = ((((unsigned __int16)v49 | 0x42) ^ (unsigned __int16)((unsigned __int8)word_140C66DFC << 8)) & 0x100 ^ (v49 | 0x42)) & 0xF0FFFFFFFFFFFFFFuLL | 0xA00000000000000LL;
