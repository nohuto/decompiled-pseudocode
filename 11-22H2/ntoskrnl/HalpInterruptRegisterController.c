/*
 * XREFs of HalpInterruptRegisterController @ 0x140378D34
 * Callers:
 ...
 *     HalpInterruptBuildKnownResourceIdString @ 0x1403790B0 (HalpInterruptBuildKnownResourceIdString.c)
...
__int64 __fastcall HalpInterruptRegisterController(__int64 a1)
{
  ...
  if ( HalpInterruptRegistrationAllowed )
  {
      ...
      && ((v6 & 0x400) == 0 || *(_QWORD *)(a1 + 176)) )
    {
      ...
      if ( (*(_DWORD *)(a1 + 236) & 0x100) != 0 && HalpIsPartitionCpuManager(v8, v7) && qword_140C625A8 )
      ...
      if ( MemoryInternal )
      {
        ...
        *(_WORD *)(v12 + 354) = Length + 2;
        ...
        v17 = (__int64 *)qword_140C63FD8;
        if ( *(ULONG_PTR **)qword_140C63FD8 != &HalpRegisteredInterruptControllers )
          __fastfail(3u);
