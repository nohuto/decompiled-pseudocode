/*
 * XREFs of ObWaitForMultipleObjects @ 0x1406E3940
 * Callers:
...
LABEL_9:
      ...
      while ( 2 )
      {
        ...
        if ( (v20 & 0x3FC) != 0 )
        {
          v22 = (unsigned __int64 *)ExpLookupHandleTableEntry(v21, v20);
          v23 = v22;
          if ( v22 )
          {
            _m_prefetchw(v22);
            ...
            *((_QWORD *)&v63 + 1) = v23[1];
            while ( (v25 & 0x1FFFE) != 0 )
            {
              ...
              *((_QWORD *)&v27 + 1) = *((_QWORD *)&v63 + 1);
              v28 = _InterlockedCompareExchange128(
                      (volatile signed __int64 *)v23,
                      *((signed __int64 *)&v27 + 1),
                      v25 - 2,
                      (signed __int64 *)&v27);
              v26 = v27;
              v25 = v27;
              ...
              if ( v28 )
              {
                ...
                {
                  *(_QWORD *)&v63 = ((unsigned int)v25 ^ (2 * (unsigned int)(v26 >> 1) - 2)) & 0x1FFFE ^ v25;
                  HandlePointer = ExGetHandlePointer((__int64 *)&v63);
                  ObpIncrPointerCountEx((volatile signed __int64 *)HandlePointer, 32752);
                  v49 = ExFastReplenishHandleTableEntry((volatile signed __int64 *)v23, (signed __int64 *)&v63, 32752);
                  if ( v49 )
...
LABEL_21:
            ...
            if ( ExLockHandleTableEntry(v21, v23) )
            {
              ...
              _InterlockedExchangeAdd64((volatile signed __int64 *)v23, 1uLL);
