/*
 * XREFs of HalpBuildScatterGatherList @ 0x14050F9C0
 * Callers:
 *     HalGetScatterGatherList @ 0x1403D07A0 (HalGetScatterGatherList.c)
 *     HalBuildScatterGatherListEx @ 0x14050EE10 (HalBuildScatterGatherListEx.c)
 *     HalBuildScatterGatherListV3 @ 0x14050EED0 (HalBuildScatterGatherListV3.c)
 *     HalGetScatterGatherListEx @ 0x14050F2A0 (HalGetScatterGatherListEx.c)
 * Callees:
