/*
 * XREFs of MiActOnPte @ 0x140293FB4
 * Callers:
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( !v10 )
      {
        ...
        if ( v18 > qword_140C65CA0 || ((*(_QWORD *)(48 * v18 - 0x21FFFFFFFFD8LL) >> 54) & 1) == 0 )
          return 3221226548LL;
...
LABEL_14:
        ...
        if ( v17 != 1 )
        {
          ...
          *a8 = v25;
          if ( v25 )
            *a7 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v20 + 40) >> 43) & 0x3FFLL));
...
LABEL_46:
  ...
  if ( v14 )
  {
    v40 = *(_QWORD *)(qword_140C674C8 + 8LL * Process[1].IdealProcessor[25]);
    if ( v10 )
    {
      if ( a2 )
      {
      ...
      {
        v40 = *(_QWORD *)(qword_140C674C8 + 8LL * (*(_WORD *)(*(_QWORD *)v52 + 60LL) & 0x3FF));
      }
    }
