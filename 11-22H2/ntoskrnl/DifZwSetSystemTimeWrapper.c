/*
 * XREFs of DifZwSetSystemTimeWrapper @ 0x1405F79D0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwSetSystemTimeWrapper(PLARGE_INTEGER SystemTime, PLARGE_INTEGER PreviousTime)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(645);
...
LABEL_8:
  ...
  *(_QWORD *)&v16 = 0LL;
LABEL_10:
  *(_QWORD *)&v17 = SystemTime;
  *((_QWORD *)&v16 + 1) = PreviousTime;
...
LABEL_17:
  result = ZwSetSystemTime(SystemTime, PreviousTime);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
