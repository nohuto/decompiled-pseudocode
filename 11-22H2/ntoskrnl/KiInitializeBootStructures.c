/*
 * XREFs of KiInitializeBootStructures @ 0x140A8BDF0
 * Callers:
 ...
 *     KasanInitSystem @ 0x1403B5A90 (KasanInitSystem.c)
 *     strstr @ 0x1403D8B70 (strstr.c)
 *     atoi @ 0x1403D8C00 (atoi.c)
 *     KiSaveInitialProcessorControlState @ 0x14041E5C0 (KiSaveInitialProcessorControlState.c)
 ...
 *     InitializeBuildStrings @ 0x140B35CFC (InitializeBuildStrings.c)
