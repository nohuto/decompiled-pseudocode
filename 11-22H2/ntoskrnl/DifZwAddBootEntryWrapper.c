/*
 * XREFs of DifZwAddBootEntryWrapper @ 0x1405EC8B0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwAddBootEntryWrapper(PBOOT_ENTRY BootEntry, PULONG Id)
{
...
LABEL_17:
  result = ZwAddBootEntry(BootEntry, Id);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
