/*
 * XREFs of RtlpFlsAlloc @ 0x14084D2F0
 * Callers:
 ...
 *     ?SlotFree@?$RTL_BINARY_ARRAY@URTLP_FLS_CALLBACK_ENTRY@@$03$03@@SAXPEAU1@K@Z @ 0x1405B4A10 (-SlotFree@-$RTL_BINARY_ARRAY@URTLP_FLS_CALLBACK_ENTRY@@$03$03@@SAXPEAU1@K@Z.c)
 */
...
__int64 __fastcall RtlpFlsAlloc(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int *a5)
{
  ...
  if ( v11 < 0xF0 )
  {
    ...
    *(_QWORD *)v8 = a3;
    *(_QWORD *)v15 = a4;
    if ( v11 > dword_140D0C3C0 )
      dword_140D0C3C0 = v10 - 16;
