/*
 * XREFs of DifPsGetVersionWrapper @ 0x1405EA800
 * Callers:
 *     <none>
 * Callees:
 *     PsGetVersion @ 0x140368F80 (PsGetVersion.c)
        ...
        PUNICODE_STRING CSDVersion)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(401);
...
LABEL_8:
  ...
  *(_QWORD *)&v20 = 0LL;
LABEL_10:
  *(_QWORD *)&v22 = MajorVersion;
  *((_QWORD *)&v21 + 1) = MinorVersion;
  *(_QWORD *)&v21 = BuildNumber;
  *((_QWORD *)&v20 + 1) = CSDVersion;
...
LABEL_17:
  result = PsGetVersion(MajorVersion, MinorVersion, BuildNumber, CSDVersion);
  BYTE8(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
