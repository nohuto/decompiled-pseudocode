/*
 * XREFs of ExpGetProcessInformation @ 0x1407432D0
 * Callers:
 ...
 *     ExpSysInfoShouldSkipProcess @ 0x140742DE0 (ExpSysInfoShouldSkipProcess.c)
...
LABEL_135:
    ...
    else
    {
      ...
      *(_DWORD *)(v21 + 56) = 0;
      ...
      {
        v22 = qword_140C65CA8 << 12;
        *(_QWORD *)(v21 + 144) = qword_140C65CA8 << 12;
        *(_QWORD *)(v21 + 8) = v22;
      }
      if ( v11 < 0 )
      {
