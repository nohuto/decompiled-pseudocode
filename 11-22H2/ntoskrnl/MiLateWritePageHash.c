/*
 * XREFs of MiLateWritePageHash @ 0x140666138
 * Callers:
 ...
 *     MiReadEntirePageHashEntry @ 0x140666C80 (MiReadEntirePageHashEntry.c)
...
__int64 __fastcall MiLateWritePageHash(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  v12 = *(_QWORD *)(a1 + 216) + (unsigned int)(dword_140C6974C * a2);
