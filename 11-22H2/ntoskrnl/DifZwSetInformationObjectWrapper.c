/*
 * XREFs of DifZwSetInformationObjectWrapper @ 0x1405F7270
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwSetInformationObjectWrapper(
        HANDLE Handle,
        ...
        ULONG ObjectInformationLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(636);
...
LABEL_10:
  *(_QWORD *)&v22 = Handle;
  DWORD2(v21) = ObjectInformationClass;
  *(_QWORD *)&v21 = ObjectInformation;
  DWORD2(v20) = ObjectInformationLength;
...
LABEL_17:
  result = ZwSetInformationObject(Handle, ObjectInformationClass, ObjectInformation, ObjectInformationLength);
  DWORD2(v22) = result;
  if ( v13 )
  {
    v18 = (_QWORD **)(v13 + 6);
