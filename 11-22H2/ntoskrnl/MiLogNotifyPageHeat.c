/*
 * XREFs of MiLogNotifyPageHeat @ 0x140653F9C
 * Callers:
...
char MiLogNotifyPageHeat()
{
  ...
  if ( !*(_QWORD *)&qword_140C699E8 )
    return (char)v0;
  if ( !**(_DWORD **)&qword_140C699E8 )
    return (char)v0;
  LOBYTE(v0) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 64LL);
  if ( !(_BYTE)v0 )
    return (char)v0;
  ...
  if ( *v1 )
  {
    if ( **(_DWORD **)&qword_140C699E8 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140C699E8, 64LL) )
      goto LABEL_23;
    v20 = *v2;
    v16 = (unsigned __int8 *)&byte_140039567;
    v34 = *(_DWORD *)(v18 + 4);
    v45 = &v34;
    v47 = &v39;
    v40 = v20 >> 12;
  ...
  else
  {
    if ( **(_DWORD **)&qword_140C699E8 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140C699E8, 64LL) )
      goto LABEL_23;
    v15 = *v2;
    v16 = (unsigned __int8 *)&unk_1400394E0;
    v31 = *(_DWORD *)(v12 + 4);
    v41[4] = (__int64)&v31;
    v41[6] = (__int64)&v37;
    v38 = v15 >> 12;
