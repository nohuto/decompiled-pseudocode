/*
 * XREFs of PoFxSetTargetDripsDevicePowerState @ 0x140984960
 * Callers:
 *     <none>
 * Callees:
...
LABEL_25:
    ...
    v4 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(a1 + 240), 0LL, &byte_14088CDB0, 1u, 0x20u);
    if ( v4 < 0 )
      goto LABEL_26;
...
LABEL_26:
  ...
  if ( (unsigned int)dword_140C03950 > 5 && tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL) )
  {
    ...
    v14 = 0x1000000LL;
    v26 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03950, (unsigned __int8 *)&word_14002DA5E, 0LL, 0LL, 7u, &v16);
  }
  return (unsigned int)v4;
}
