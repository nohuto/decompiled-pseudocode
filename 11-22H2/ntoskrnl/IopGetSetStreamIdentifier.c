/*
 * XREFs of IopGetSetStreamIdentifier @ 0x14055777C
 * Callers:
 *     IoGetSfioStreamIdentifier @ 0x14045F110 (IoGetSfioStreamIdentifier.c)
 *     IoAllocateSfioStreamIdentifier @ 0x140556810 (IoAllocateSfioStreamIdentifier.c)
 * Callees:
