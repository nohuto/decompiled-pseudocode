/*
 * XREFs of MiUnlinkPageFromListEx @ 0x140266510
 * Callers:
...
__int64 __fastcall MiUnlinkPageFromListEx(ULONG_PTR BugCheckParameter2, unsigned __int64 a2)
{
  ...
  else if ( (*(_DWORD *)(*(_QWORD *)(qword_140C674C8 + 8 * (((unsigned __int64)*v3 >> 43) & 0x3FF)) + 4LL) & 0x80u) != 0 )
  {
  ...
  v123 = 0LL;
  v8 = *(_QWORD *)(qword_140C674C8 + 8 * (v7 & 0x3FF));
  v9 = *(_BYTE *)(v4 + 34);
  v98 = v8;
  v117 = 0LL;
  v118 = 0LL;
  ...
  if ( v13 < qword_140C68260 || v13 >= qword_140C68260 + 2048 )
  {
...
LABEL_114:
      ...
      v53 = *(_QWORD *)(qword_140C674C8 + 8 * v52);
      v100 = v53;
...
LABEL_32:
  ...
  else
  {
    ...
    v20 = *(_QWORD *)v4 & 0xFFFFFFFFFFLL;
    v21 = *(_QWORD *)(v4 + 24) & 0xFFFFFFFFFFLL;
    if ( v20 == 0x3FFFFFFFFFLL || v20 >= qword_140C68260 && v20 < qword_140C68260 + 2048 )
    {
      v14 = v86;
    }
    else
    ...
    if ( v21 != 0x3FFFFFFFFFLL && (v21 < qword_140C68260 || v21 >= qword_140C68260 + 2048) )
    {
...
LABEL_45:
  ...
  v107 = *(_QWORD *)(qword_140C674C8 + 8 * v29);
  v30 = dword_140C65B88;
  v31 = 0xAAAAAAAAAAAAAAABuLL * ((__int64)(48 * v13) >> 4);
  if ( dword_140C65B84 <= (unsigned int)dword_140C65B88 )
  {
    v32 = (char *)qword_140C65BC8 + 16 * dword_140C65B84;
    if ( v31 >= *(_QWORD *)v32 && (dword_140C65B84 == dword_140C65B88 || v31 < *((_QWORD *)v32 + 2)) )
      goto LABEL_59;
  }
  v65 = 0;
...
LABEL_192:
  ...
  {
    v66 = (v65 + v30) >> 1;
    v32 = (char *)qword_140C65BC8 + 16 * v66;
    if ( v31 < *(_QWORD *)v32 )
    {
      if ( !v66 )
        KeBugCheckEx(0x1Au, 0x6200uLL, v31, (ULONG_PTR)qword_140C65BC8, 0LL);
      v30 = v66 - 1;
      goto LABEL_191;
    }
    if ( v66 == dword_140C65B88 || v31 < *((_QWORD *)v32 + 2) )
      break;
    v65 = v66 + 1;
LABEL_191:
    if ( v30 < v65 )
  ...
  *(_QWORD *)v4 = 0LL;
  ...
  else
  {
    *(_QWORD *)(v4 + 24) &= 0xFFFFFF0000000000uLL;
    if ( !_bittest64(v3, 0x35u) && dword_140C67F4C == 1 )
    {
      v79 = v13 & 0x1F;
      v14 = 1LL;
      a2 = 1LL;
      v80 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67FA0 + 1) + 4 * (v13 >> 5));
      if ( v79 + 1 > 0x20 )
      {
        if ( (v13 & 0x1F) == 0 )
          goto LABEL_206;
