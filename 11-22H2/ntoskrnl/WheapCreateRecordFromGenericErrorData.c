/*
 * XREFs of WheapCreateRecordFromGenericErrorData @ 0x1406128C8
 * Callers:
 *     WheapDeviceDriverCreateRecord @ 0x1406117B0 (WheapDeviceDriverCreateRecord.c)
 *     WheapDefaultErrSrcCreateRecord @ 0x140612C30 (WheapDefaultErrSrcCreateRecord.c)
 * Callees:
