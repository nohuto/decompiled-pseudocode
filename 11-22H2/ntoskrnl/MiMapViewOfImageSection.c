/*
 * XREFs of MiMapViewOfImageSection @ 0x1406AEAC0
 * Callers:
 ...
 *     MiInitializeFixupVad @ 0x140705558 (MiInitializeFixupVad.c)
        ...
        char a8)
{
  ...
  v108 = v14;
  if ( dword_140C65988
    && dword_140C6598C == *(_DWORD *)(v14 + 60)
    && dword_140C65990 == *(_DWORD *)(*(_QWORD *)(v10 + 56) + 68LL) )
  {
    __debugbreak();
  }
...
LABEL_46:
      ...
      if ( dword_140C6997C )
      {
        ...
        if ( (v78 == -31132 || v78 == 332 || v78 == -21916)
          ...
          && (*(_DWORD *)(a2 + 64) & 4) == 0 )
        {
          if ( v99 + (unsigned int)dword_140C6997C < v99 )
          {
          ...
          v99 += (unsigned int)dword_140C6997C;
        }
      }
...
LABEL_109:
                ...
                if ( v93 == 4 || (unsigned int)(v93 - 1) <= 1 || v93 == -2147483647 )
                {
                  ...
                  {
                    v62 = 0LL;
                    **(_QWORD **)(a2 + 72) = v109 ^ qword_140C65B40 ^ v11;
LABEL_101:
                    if ( (v56 & 0x800) == 0
                      || (v62 = MiAddSecureEntry(v42, (_DWORD)v105 << 12, ((_DWORD)v43 << 12) | 0xFFFu, -2147483647, 0)) != 0 )
                    {
                      ...
                      if ( v62 )
                        MmUnsecureVirtualMemory((HANDLE)(v62 ^ qword_140C65B40 ^ v11));
                      goto LABEL_109;
                    }
                    v53 = Object;
