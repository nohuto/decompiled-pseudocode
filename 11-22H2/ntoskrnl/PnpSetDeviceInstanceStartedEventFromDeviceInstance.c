/*
 * XREFs of PnpSetDeviceInstanceStartedEventFromDeviceInstance @ 0x140321A6C
 * Callers:
 *     PnpSetDeviceInstanceStartedEvent @ 0x140322E90 (PnpSetDeviceInstanceStartedEvent.c)
 * Callees:
