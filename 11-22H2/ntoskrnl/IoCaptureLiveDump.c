/*
 * XREFs of IoCaptureLiveDump @ 0x14094BA98
 * Callers:
 ...
 *     KeGetSupervisorStateExtensionHost @ 0x1405726EC (KeGetSupervisorStateExtensionHost.c)
...
LABEL_35:
            ...
            else
            {
              ...
              if ( (unsigned int)dword_140C03870 > 5 && tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL) )
              {
                ...
                tlgWriteTransfer_EtwWriteTransfer(
                  ...
                  (unsigned __int8 *)&dword_14002BECC,
                  (const GUID *)(v11 + 968),
                  (const GUID *)(v11 + 952),
                  5u,
                  &v76);
      ...
      if ( (unsigned int)dword_140C03870 > 5 && tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03870,
          (unsigned __int8 *)&word_14002BDC6,
          v34,
          v33,
          0xEu,
          &v51);
    ...
    *(_QWORD *)(v11 + 1200) = v11 + 1200;
    ...
    if ( AllowLiveDump && ((*(_DWORD *)(v11 + 80) & 0x200) == 0 || *(_QWORD *)(v11 + 1144)) )
    {
      ...
      if ( (unsigned int)dword_140C03870 > 5 && tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03870,
          (unsigned __int8 *)&word_14002BC4E,
          (const GUID *)(v11 + 968),
          (const GUID *)(v11 + 952),
          3u,
          &v83);
