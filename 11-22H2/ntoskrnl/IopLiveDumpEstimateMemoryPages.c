/*
 * XREFs of IopLiveDumpEstimateMemoryPages @ 0x140A9B25C
 * Callers:
 ...
 *     HvlCalculateLivedumpSize @ 0x1405477F0 (HvlCalculateLivedumpSize.c)
...
__int64 __fastcall IopLiveDumpEstimateMemoryPages(__int64 a1)
{
        ...
        *(_DWORD *)(a1 + 80) |= 0x10u;
        ...
        if ( (unsigned int)dword_140C03870 > 5 && tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_14002C369,
            (const GUID *)(a1 + 968),
            (const GUID *)(a1 + 952),
            5u,
            v24);
  ...
  *(_DWORD *)(a1 + 80) &= ~1u;
  if ( (unsigned int)dword_140C03870 > 5 && tlgKeywordOn((__int64)&dword_140C03870, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_140C03870,
      (unsigned __int8 *)byte_14002C261,
      (const GUID *)(a1 + 968),
      (const GUID *)(a1 + 952),
      9u,
      v24);
