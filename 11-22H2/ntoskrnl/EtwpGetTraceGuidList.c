/*
 * XREFs of EtwpGetTraceGuidList @ 0x1409E7E54
 * Callers:
 *     NtTraceControl @ 0x140725C40 (NtTraceControl.c)
 * Callees:
 *     EtwpCopyMetaProviderGuids @ 0x14046AA1C (EtwpCopyMetaProviderGuids.c)
 *     EtwpMetaProviderCount @ 0x14046AAA6 (EtwpMetaProviderCount.c)
