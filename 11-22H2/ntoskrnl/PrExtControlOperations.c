/*
 * XREFs of PrExtControlOperations @ 0x1406155F8
 * Callers:
 *     HalpLoadMicrocode @ 0x140934BE0 (HalpLoadMicrocode.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x140429560 (_guard_dispatch_icall.c)
 *     MicrocodeSetProcMcLog @ 0x14061572C (MicrocodeSetProcMcLog.c)
  ...
  if ( !v6 )
  {
    if ( a3 == 44 )
    {
      ...
      if ( a2 )
      {
        ...
        xmmword_140C14910 = *(_OWORD *)(a2 + 16);
        qword_140C14920 = *(_QWORD *)(a2 + 32);
        dword_140C14928 = *(_DWORD *)(a2 + 40);
        return v7;
      }
    }
    return (unsigned int)-1073741811;
