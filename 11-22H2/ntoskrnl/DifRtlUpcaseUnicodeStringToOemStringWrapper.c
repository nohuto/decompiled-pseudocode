/*
 * XREFs of DifRtlUpcaseUnicodeStringToOemStringWrapper @ 0x1405EC330
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlUpcaseUnicodeStringToOemStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(443);
...
LABEL_17:
  result = RtlUpcaseUnicodeStringToOemString(DestinationString, SourceString, AllocateDestinationString);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
