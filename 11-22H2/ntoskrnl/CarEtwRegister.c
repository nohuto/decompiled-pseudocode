/*
 * XREFs of CarEtwRegister @ 0x1405D2A78
 * Callers:
...
NTSTATUS CarEtwRegister()
{
  ...
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140C09368);
  ...
  if ( result >= 0 )
  {
    if ( dword_140C09368 && tlgKeywordOn((__int64)&dword_140C09368, 0x800000000000LL) && v3 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_140C09368, 0x400000000000LL) )
      {
        v13 = 0;
        v9 = 0LL;
        v16 = 0;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C09368,
          (unsigned __int8 *)word_14003446A,
          0LL,
          0LL,
          9u,
          &v10);
