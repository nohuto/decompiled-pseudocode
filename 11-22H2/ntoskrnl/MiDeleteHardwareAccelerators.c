/*
 * XREFs of MiDeleteHardwareAccelerators @ 0x140654B90
 * Callers:
...
void MiDeleteHardwareAccelerators()
{
  ...
  v0 = ExAcquireSpinLockExclusive(&dword_140C69920);
  byte_140C69914 = 1;
  ...
  ExAcquireSpinLockExclusive(&dword_140C69920);
  v9 = qword_140C69900;
  if ( qword_140C69900 != &qword_140C69900 )
  {
    do
    {
      ...
      else
      {
        ...
        *v11 = v10;
        *(_QWORD *)(v10 + 8) = v11;
        v12 = *(_QWORD *)(qword_140C65BA0 + 376LL * (unsigned int)v9[6] + 368);
        --dword_140C69910;
        --*(_WORD *)(v12 + 10);
        --*(_WORD *)(v12 + 16);
