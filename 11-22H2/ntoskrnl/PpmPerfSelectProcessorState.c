/*
 * XREFs of PpmPerfSelectProcessorState @ 0x1402554C0
 * Callers:
 *     PpmPerfSelectProcessorStates @ 0x140255430 (PpmPerfSelectProcessorStates.c)
 * Callees:
...
__int64 __fastcall PpmPerfSelectProcessorState(__int64 *a1)
{
  ...
  if ( (unsigned int)PpmMfBufferingThreshold > 0x64 )
    LOBYTE(v2) = 100;
  v7 = &PpmCurrentProfile[55 * dword_140C3D90C + 5];
  if ( v6
    && PpmCurrentProfile == (__int64 *)PpmLowPowerProfile
    && byte_140C3D94C
    && *(_BYTE *)(v6 + 233) < (unsigned __int8)v2 )
  {
    v7 = (__int64 *)((char *)&unk_140C394C8 + 440 * dword_140C3D90C);
    v53 = 0;
  }
...
LABEL_33:
  v31 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD, int, _QWORD, _QWORD))(v4 + 376))(
          ...
          *((_DWORD *)v7 + 18),
          ...
          0LL);
  *(_DWORD *)(v1 + 56) = v31;
  return PpmEventPerfSelectProcessorState((_DWORD)a1, v3, v21, v31, v53);
}
