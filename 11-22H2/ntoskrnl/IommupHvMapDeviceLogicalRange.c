/*
 * XREFs of IommupHvMapDeviceLogicalRange @ 0x1405253E0
 * Callers:
 *     HalpIommuDomainMapLogicalRange @ 0x140517E44 (HalpIommuDomainMapLogicalRange.c)
        ...
        ULONG_PTR a5)
{
  ...
  v15 = a3 >> 12;
  v11 = 1;
  v8 = ((__int64 (__fastcall *)(int *, __int64, ULONG_PTR, unsigned __int64 *, unsigned __int64 *, char))qword_140C62728)(
         &v12,
         a2,
         a5,
         &v15,
  ...
  if ( v8 < 0 )
  {
    v9 = ((__int64 (__fastcall *)(int *, ULONG_PTR, unsigned __int64 *))qword_140C62730)(&v12, BugCheckParameter4, &v14);
    if ( v9 < 0 )
