/*
 * XREFs of PoBroadcastSystemState @ 0x140AA6B28
 * Callers:
 ...
 *     PopVerifierFlushMemoryBeforeSleep @ 0x140AA78F4 (PopVerifierFlushMemoryBeforeSleep.c)
...
__int64 __fastcall PoBroadcastSystemState(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = (char *)qword_140C3CDB0;
  v30 = *(_BYTE *)(a1 + 25);
  v4 = v30;
  *(_BYTE *)qword_140C3CDB0 = *(_BYTE *)(a1 + 26);
...
LABEL_66:
  ...
  if ( *((int *)v6 + 112) >= 0 )
  {
    ...
    if ( *v5 == 4 )
    {
      if ( PopShutdownPowerOffPolicy || *(_QWORD *)&qword_140C3CE50 )
      {
        v17 = 4LL;
LABEL_32:
        v18 = v6 + 352;
  ...
  *((_DWORD *)v6 + 1) = 1;
  if ( *(_BYTE *)(a1 + 26) != 2
    || (PopDiagTraceEventNoPayload(&POP_ETW_EVENT_DEVICESWAKE),
        qword_140C3D358 = KeQueryPerformanceCounter(0LL).QuadPart,
        *v6 == 2) )
  {
    if ( v12 )
      PopFxActivateDevicesForSx(1u);
  ...
  do
  {
    ...
    if ( v25 == 1 && *(_BYTE *)(a1 + 26) == 2 && !v12 )
    {
      ...
      if ( PoResumeFromHibernate )
      {
        if ( qword_140C3CE60 )
        {
          v28 = *(_QWORD *)(qword_140C3CE60 + 216);
          if ( v28 )
            PopBootLoaderSiData(v28);
        }
        PopUpdateSmbiosData(
          *(_BYTE *)(*(_QWORD *)(qword_140C3CE60 + 200) + 1084LL),
          *(_BYTE *)(*(_QWORD *)(qword_140C3CE60 + 200) + 1085LL),
          *(_DWORD *)(*(_QWORD *)(qword_140C3CE60 + 200) + 1080LL),
          *(_QWORD *)(*(_QWORD *)(qword_140C3CE60 + 200) + 1072LL));
      }
      if ( dword_140C3CE48 == 5 )
  ...
  {
    PopFxIdleDevicesFromSx();
    qword_140C3D360 = KeQueryPerformanceCounter(0LL).QuadPart;
