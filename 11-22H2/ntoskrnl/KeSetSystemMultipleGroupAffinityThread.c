/*
 * XREFs of KeSetSystemMultipleGroupAffinityThread @ 0x14036C524
 * Callers:
 *     PsSetSystemMultipleGroupAffinityThread @ 0x1405A4140 (PsSetSystemMultipleGroupAffinityThread.c)
