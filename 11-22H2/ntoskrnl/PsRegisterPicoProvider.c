/*
 * XREFs of PsRegisterPicoProvider @ 0x1409B5480
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140C38170 = *(_OWORD *)(a1 + 16);
  xmmword_140C38180 = *(_OWORD *)(a1 + 32);
  xmmword_140C38190 = *(_OWORD *)(a1 + 48);
  xmmword_140C381A0 = *(_OWORD *)(a1 + 64);
  qword_140C381B0 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_140C38190, 8).m128i_u64[0];
