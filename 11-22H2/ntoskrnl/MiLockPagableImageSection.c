/*
 * XREFs of MiLockPagableImageSection @ 0x14025A6C0
 * Callers:
 ...
 *     IopLiveDumpUnLockPages @ 0x14055B9E0 (IopLiveDumpUnLockPages.c)
 ...
 *     IopLiveDumpLockPages @ 0x14094EB00 (IopLiveDumpLockPages.c)
...
void __fastcall MiLockPagableImageSection(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  if ( BugCheckParameter2 != 1 )
  {
    ...
    if ( v3 )
      return;
LABEL_8:
    if ( BugCheckParameter2 < 0xFFFF800000000000uLL || byte_140C6A4D8[((BugCheckParameter2 >> 39) & 0x1FF) - 256] != 1 )
    {
      v8 = 0LL;
      v9 = 0LL;
