/*
 * XREFs of MiLocatePageCollisionNodeByPfn @ 0x14064F3F4
 * Callers:
...
_QWORD *__fastcall MiLocatePageCollisionNodeByPfn(ULONG_PTR *BugCheckParameter2)
{
  ...
  ExAcquireSpinLockSharedAtDpcLevel(&dword_140C67370);
  v2 = (_QWORD *)qword_140C67378;
  i = 0LL;
  while ( v2 )
  {
    i = v2;
  ...
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C67370);
  return i;
}
