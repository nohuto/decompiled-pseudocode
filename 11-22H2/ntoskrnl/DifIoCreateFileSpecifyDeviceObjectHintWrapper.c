/*
 * XREFs of DifIoCreateFileSpecifyDeviceObjectHintWrapper @ 0x1405DE3F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IoCreateFileSpecifyDeviceObjectHint @ 0x1407E1D30 (IoCreateFileSpecifyDeviceObjectHint.c)
 */
