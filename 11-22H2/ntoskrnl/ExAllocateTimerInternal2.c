/*
 * XREFs of ExAllocateTimerInternal2 @ 0x14031E1B0
 * Callers:
 *     ExAllocateTimer @ 0x14031E180 (ExAllocateTimer.c)
 *     ExAllocateTimerInternal @ 0x14060B570 (ExAllocateTimerInternal.c)
 * Callees:
 *     ExpExTimerAttributesAreValid @ 0x14031E2D8 (ExpExTimerAttributesAreValid.c)
