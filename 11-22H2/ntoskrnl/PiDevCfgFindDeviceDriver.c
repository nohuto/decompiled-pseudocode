/*
 * XREFs of PiDevCfgFindDeviceDriver @ 0x14087D884
 * Callers:
 ...
 *     PiDevCfgCompareDrivers @ 0x140561D6C (PiDevCfgCompareDrivers.c)
...
LABEL_90:
        ...
        v45 = v6 + 208;
        for ( j = (char *)*((_QWORD *)v6 + 26); ; j = *(char **)j )
        {
          if ( j == v45 )
            goto LABEL_116;
          v47 = *(_QWORD *)(j + 188) - *(_QWORD *)(v33 + 188);
          if ( !v47 )
            v47 = *(_QWORD *)(j + 196) - *(_QWORD *)(v33 + 196);
          if ( !v47 )
            break;
        }
        if ( *((_QWORD *)j + 18) )
...
LABEL_130:
    ...
    *(_QWORD *)(v51 + 8) = v54;
    P = v21;
    PiDevCfgFreeDriverNode((char *)v21);
  }
  while ( 1 )
  {
    v22 = v56[0];
