/*
 * XREFs of SeOpenObjectAuditAlarmWithTransaction @ 0x1406C0580
 * Callers:
...
LABEL_13:
  ...
  v63[0] = v11;
  v34 = SepAdtAuditThisEventWithContext(v11, AccessGranted, AccessGranted == 0, p_SubjectSecurityContext);
  v12 = SecurityDescriptor;
  if ( v34 )
  {
...
LABEL_14:
  ...
  v26 = (__int64 *)&AccessState->SubjectSecurityContext;
  v25 = SepAdtAuditThisEventWithContext(130LL, v23, v20, &AccessState->SubjectSecurityContext);
  v14 = v61;
  v15 = v62;
LABEL_22:
  AuxData[216] = v25;
...
LABEL_24:
  if ( AccessGranted )
  {
    ...
    if ( *(_QWORD *)AuxData )
    {
      if ( *v27 )
      {
        v28 = SepAdtAuditPrivilegeUseWithContext((_DWORD)v27, AccessGranted, 0, v17, (__int64)v63);
        v11 = v63[0];
        v14 = v61;
        v15 = v62;
        if ( v28 )
