/*
 * XREFs of ?RtlpGetFunctionOverrideIndex@@YAPEBU_RTL_FUNCTION_OVERRIDE_INDEX@@PEBU_RTL_FUNCTION_OVERRIDE_INFORMATION@@K@Z @ 0x14067BB98
 * Callers:
 *     RtlApplyFunctionOverrideFixups @ 0x14067BBC0 (RtlApplyFunctionOverrideFixups.c)
