/*
 * XREFs of PopTraceThermalRequestPassiveHistogram @ 0x140595A88
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x140591A60 (PopDiagSnapPassiveHistogram.c)
        ...
        if ( (int)PoStoreDiagnosticContext(*(_QWORD *)(a1 + 24), Pool2, v8) >= 0 )
        {
            ...
            && tlgKeywordOn((__int64)&dword_140C03950, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              (unsigned __int8 *)&dword_14002EBCC,
              0LL,
              0LL,
              7u,
              &v9);
