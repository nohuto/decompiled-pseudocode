/*
 * XREFs of PoFxInitPowerManagement @ 0x140B68E5C
 * Callers:
...
__int64 PoFxInitPowerManagement()
{
  ...
  *(_QWORD *)&PopFxResidentTimer.Header.Lock = 9LL;
  ...
  qword_140C3EEB8 = (__int64)&PopWorkOrderList;
  PopWorkOrderList = (__int64)&PopWorkOrderList;
  qword_140C3EC10 = (__int64)PopFxResidentTimeoutRoutine;
  qword_140C3EC50 = (__int64)&qword_140C3EC48;
  qword_140C3EC48 = (__int64)&qword_140C3EC48;
  stru_140C3EC60.Header.WaitListHead.Blink = &stru_140C3EC60.Header.WaitListHead;
  stru_140C3EC60.Header.WaitListHead.Flink = &stru_140C3EC60.Header.WaitListHead;
  ...
  qword_140C3EC88 = (__int64)&PopFxPluginList;
  ...
  LOWORD(stru_140C3EC60.Header.Lock) = 0;
  stru_140C3EC60.Header.SignalState = 1;
  ...
  memset(&byte_140C3EE41, 0, 0x6FuLL);
  ...
  qword_140C3EC38 = (__int64)&SocSubsystemsList;
  ...
  *(_QWORD *)&PopPepIdleTimer.Header.Lock = 9LL;
  qword_140C39358 = (__int64)&PopPepDeviceList;
  PopPepDeviceList = (__int64)&PopPepDeviceList;
  qword_140C39430 = (__int64)PopPepIdleTimeoutRoutine;
