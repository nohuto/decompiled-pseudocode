/*
 * XREFs of MiInitializeBootShadowStackPage @ 0x1406449D4
 * Callers:
 *     MiInitializeBootKernelShadowStacks @ 0x1403B595C (MiInitializeBootKernelShadowStacks.c)
 *     MiInitializeBootKernelShadowStack @ 0x140644970 (MiInitializeBootKernelShadowStack.c)
 * Callees:
...
LABEL_51:
  *(_QWORD *)a1 = v24;
  ...
  if ( v29 )
LABEL_62:
    _InterlockedExchangeAdd64(&qword_140C6F880, v29);
LABEL_63:
  MiReturnCommit((__int64)MiSystemPartition, 1LL);
  return --qword_140C69AA8;
}
