/*
 * XREFs of SepSecureBootCorrectBcd @ 0x1409D0A14
 * Callers:
            ...
            if ( ObjectCount )
            {
              while ( 1 )
              {
                ...
                if ( updated < 0 )
                  break;
                v6 = 0;
                for ( i = BcdObjectHandle; v6 < *((unsigned __int16 *)qword_140D17F28 + 18); ++v6 )
                {
                  v8 = (_DWORD *)(qword_140D1BF80 + 12LL * v6);
                  if ( !*v8 || *v8 == *(_DWORD *)(*(_QWORD *)&BufferSize[1].Data1 + 4LL) )
                  {
                    v9 = *(_WORD *)((unsigned int)v8[2] + qword_140D1BF90);
                    if ( ((v9 & 0x20) == 0 || (dword_140C7104C & 4) != 0)
                      && ((v9 & 0x40) == 0 || (dword_140C7104C & 0x10) != 0) )
                    {
                      updated = SepSecureBootUpdateBcdDataForRule(qword_140D1BF80 + 12LL * v6, i, &v15);
                      if ( updated < 0 )
                        goto LABEL_24;
                      if ( v15 )
                        *a1 = 1;
