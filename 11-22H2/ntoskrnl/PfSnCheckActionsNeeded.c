/*
 * XREFs of PfSnCheckActionsNeeded @ 0x14074E508
 * Callers:
...
__int64 __fastcall PfSnCheckActionsNeeded(unsigned __int8 *a1, int a2, __int64 a3, int *a4, int *a5)
{
  ...
  v22 = PfSnPrefetchCacheEntryGet(&unk_140C6A778, v33, v15, (char *)&v30 + 4);
  v23 = (_DWORD *)v22;
  if ( !v22 )
  {
    v8 = 3;
