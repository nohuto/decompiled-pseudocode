/*
 * XREFs of TtmiLogSessionPowerStateChange @ 0x1409A9C90
 * Callers:
...
void __fastcall TtmiLogSessionPowerStateChange(char a1)
{
  ...
  if ( (unsigned int)dword_140D53948 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D53948, 1LL) )
    {
      ...
      v9 = &v3;
      v10 = 1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D53948, (unsigned __int8 *)word_140033EDA, 0LL, 0LL, 4u, &v5);
    }
  }
}
