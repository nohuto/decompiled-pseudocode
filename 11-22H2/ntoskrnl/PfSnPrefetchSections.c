/*
 * XREFs of PfSnPrefetchSections @ 0x14074D088
 * Callers:
...
__int64 __fastcall PfSnPrefetchSections(_QWORD *a1, WORK_QUEUE_TYPE a2, int a3, __int64 a4, __int64 a5)
{
  ...
  *(_OWORD *)&RunRef_8[0].Count = 0LL;
  v33 = 0LL;
  v34 = 0LL;
  if ( v5 && qword_140C6A808 && EtwEventEnabled(qword_140C6A808, &PfSnEvt_PrefetchSections_Start) )
  {
    v23 = -1LL;
    do
      ++v23;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v46 = 4LL;
    v48 = 1LL;
    EtwWrite(qword_140C6A808, &PfSnEvt_PrefetchSections_Start, 0LL, 7u, &UserData);
  }
...
LABEL_23:
  ...
  LOBYTE(v24) = 0;
  LODWORD(v29) = v8;
  if ( v5 && qword_140C6A808 && EtwEventEnabled(qword_140C6A808, &PfSnEvt_PrefetchSections_Stop) )
  {
    do
      ++v7;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v50 = 8LL;
    v52 = 4LL;
    EtwWrite(qword_140C6A808, &PfSnEvt_PrefetchSections_Stop, 0LL, 9u, &UserData);
  }
  return v19;
}
