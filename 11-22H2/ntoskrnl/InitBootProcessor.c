...
__int64 __fastcall InitBootProcessor(ULONG_PTR a1)
{
  ...
  char v60[64]; // [rsp+B8h] [rbp-50h] BYREF
  ...
  *(_DWORD *)(v13 + 572) = 0;
  ...
  v59[1] = 1LL;
  v59[2] = 0LL;
  if ( (int)LdrFindResource_U(0x140000000LL, v59, 3u, &v56) >= 0
    && (int)LdrAccessResource(0x140000000LL, (unsigned __int64)v56, (__int64)DestinationString, (__int64)&Size) >= 0 )
  {
...
LABEL_59:
  ...
  *(_DWORD *)(v33 + 696) = 0x80000000;
  ...
  v42 = RtlStringCbPrintfA(v60, 0x40uLL, "%u.%u", 6, 3);
  if ( v42 < 0 )
    KeBugCheckEx(0x31u, v42, 0xAuLL, 0LL, 0LL);
  if ( !RtlCreateUnicodeStringFromAsciiz(&CmVersionString, v60) )
LABEL_88:
    KeBugCheck(0x31u);
  ...
  if ( !(unsigned __int8)PpInitSystem() )
    KeBugCheck(0x8Fu);
  v47 = MmWriteableSharedUserData;
  *(_WORD *)(MmWriteableSharedUserData + 618) = KeProcessorArchitecture;
  result = 0LL;
  *(_QWORD *)(v47 + 620) = 10LL;
  *(_DWORD *)(v47 + 608) = 22621;
  *(_DWORD *)(v47 + 44) = -2040232348;
  *(_DWORD *)(v47 + 932) = 0;
  return result;
}
