/*
 * XREFs of FsRtlFastUnlockSingleExclusive @ 0x140326F94
 * Callers:
 *     FsRtlFastUnlockSingle @ 0x140326EB0 (FsRtlFastUnlockSingle.c)
 *     FsRtlPrivateRemoveLock @ 0x14053DA08 (FsRtlPrivateRemoveLock.c)
 * Callees:
 ...
 *     FsRtlPrivateResetLowestLockOffset @ 0x140328140 (FsRtlPrivateResetLowestLockOffset.c)
        ...
        if ( i[1].Parent == v9 && i[1].LeftChild == *v37 )
        {
          ...
          *(_QWORD *)(v10 + 16) = RtlDelete(i);
          ...
          if ( (_DWORD)KiIrqlFlags )
          {
            ...
            if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v27 <= 0xFu && (unsigned __int8)v17 <= 0xFu && v27 >= 2u )
            {
