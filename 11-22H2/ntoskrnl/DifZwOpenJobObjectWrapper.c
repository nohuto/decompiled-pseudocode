/*
 * XREFs of DifZwOpenJobObjectWrapper @ 0x1405F1AA0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenJobObjectWrapper(
        PHANDLE JobHandle,
        ...
        POBJECT_ATTRIBUTES ObjectAttributes)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(560);
...
LABEL_17:
  result = ZwOpenJobObject(JobHandle, DesiredAccess, ObjectAttributes);
  LODWORD(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
