/*
 * XREFs of WbReleaseLeastRecentlyUsedHeapExecutedBlocks @ 0x140761CE0
 * Callers:
  ...
  if ( a2 > 0 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        v16 = v14[6];
        v20 = 0LL;
        if ( (int)sub_140761E88((int)a1 + 8, v16, 8, -1, (__int64)&v20) >= 0 )
          sub_140762FB4(a1, v20);
      }
