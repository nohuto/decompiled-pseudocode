/*
 * XREFs of PpmIdleExecuteTransition @ 0x1402C52F0
 * Callers:
      ...
      *(_QWORD *)(v13 + 33640) = v64;
      ...
      else
      {
        ...
        if ( v201 != -1 )
        {
          ...
          if ( !qword_140CF7E00 && v201 == dword_140CF7E40 )
            _InterlockedCompareExchange64(&qword_140CF7E00, MEMORY[0xFFFFF78000000008], 0LL);
          if ( a5 )
          {
