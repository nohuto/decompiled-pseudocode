/*
 * XREFs of NtQueueApcThreadEx2 @ 0x140779F90
 * Callers:
 *     NtQueueApcThread @ 0x140779F00 (NtQueueApcThread.c)
 *     NtQueueApcThreadEx @ 0x140779F40 (NtQueueApcThreadEx.c)
 * Callees:
...
LABEL_11:
        ...
        if ( (ApcFlags & 0x10000) != 0 )
          Pool2[1] |= 1u;
        if ( (unsigned __int8)KeInsertQueueApc((__int64)Pool2, (__int64)ApcArgument2, ApcArgument3, 0) )
        {
          v19 = 0;
        }
        else
