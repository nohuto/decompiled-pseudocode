...
LABEL_8:
    ...
    v15 = ((__int64 (__fastcall *)(_QWORD, HANDLE, __int64, wchar_t *))qword_140C37AA8)(
            *(_QWORD *)&Flags,
            TargetFile,
            v14,
            P);
    ...
    if ( (Flags & 4) == 0 )
    {
      ...
      if ( !qword_140C37A00
        || (v18 = (__int64)Process[2].Header.WaitListHead.Flink & 0xF,
            ...
            !(unsigned int)qword_140C37A00(Process, v18)) )
      {
        v10 = v17;
      }
      v7 = SourceFiles;
...
LABEL_74:
      ...
      v15 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, __int64, UNICODE_STRING *, ULONG, HANDLE, PCUNICODE_STRING))qword_140C379C8)(
              v8 & 0x807,
              v24,
              v21,
              v22,
