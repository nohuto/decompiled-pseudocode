/*
 * XREFs of MiInsertPartitionPages @ 0x14065A4F0
 * Callers:
...
LABEL_17:
  ...
  if ( updated < 0 )
  {
    ...
    if ( (v25 & 0x20) != 0 )
    {
      ...
      v29 = qword_140C67EF0 + 8 * v28;
      v30 = MiLockHugePfn(v29);
      MiInsertHugeRangeInList(0LL, v28, 0);
      _InterlockedAnd(
        (volatile signed __int32 *)(qword_140C67EF8 + 4 * ((((v29 - qword_140C67EF0) >> 3) & 0x3FFFFFuLL) >> 5)),
        ~(1 << (((v29 - qword_140C67EF0) >> 3) & 0x1F)));
...
LABEL_72:
    ...
    if ( !a5 )
    {
      ...
      if ( v44->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v24, (__int64)v44)) != 0 )
      {
        ...
        if ( (unsigned __int64)(v43 - qword_140C65AE8) >= 0x8000000000LL )
          SessionId = -1;
        else
      ...
      *(_DWORD *)(a3 + 24) |= 0x40u;
      ...
      else if ( (v72 & 0x800) == 0 )
      {
        ...
        if ( updated < 0 )
        {
          ...
          v77 = (v62 >> 18) & 0x3FFFFF;
          v78 = qword_140C67EF0 + 8LL * (unsigned int)v77;
          v96 = MiLockHugePfn(v78);
          MiInsertHugeRangeInList(0LL, (unsigned int)v77, 0);
          _InterlockedAnd(
            (volatile signed __int32 *)(qword_140C67EF8 + 4 * ((((v78 - qword_140C67EF0) >> 3) & 0x3FFFFFuLL) >> 5)),
            ~(1 << (((v78 - qword_140C67EF0) >> 3) & 0x1F)));
