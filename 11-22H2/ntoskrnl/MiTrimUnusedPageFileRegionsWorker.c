/*
 * XREFs of MiTrimUnusedPageFileRegionsWorker @ 0x14063B760
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MiTrimUnusedPageFileRegionsWorker(__int64 a1)
{
  ...
  if ( ExAcquireRundownProtection_0((PEX_RUNDOWN_REF)(a1 + 992)) )
  {
    ...
    if ( v6->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(1LL, (__int64)v6)) != 0 )
    {
