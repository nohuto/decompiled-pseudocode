/*
 * XREFs of IvtAttachDeviceDomainInternal @ 0x14052B8B8
 * Callers:
 *     IvtAttachDeviceDomain @ 0x14052B8A0 (IvtAttachDeviceDomain.c)
 *     IvtDetachDeviceDomain @ 0x14052C220 (IvtDetachDeviceDomain.c)
 * Callees:
 ...
 *     IvtGetDomainId @ 0x14052CABC (IvtGetDomainId.c)
