/*
 * XREFs of MiIterateOverPartitions @ 0x14062947C
 * Callers:
...
__int64 __fastcall MiIterateOverPartitions(void (__fastcall *a1)(__int64, __int64), __int64 a2)
{
  ...
  while ( 2 )
  {
    v5 = v2 < qword_140C674A8->SizeOfBitMap ? v2 : 0;
...
LABEL_11:
      if ( !v5 )
        goto LABEL_16;
      SizeOfBitMap = v2 + 1;
      if ( v2 + 1 > qword_140C674A8->SizeOfBitMap )
...
LABEL_16:
    ...
    {
      v2 = v11 + 1;
      v15 = *(_QWORD *)(qword_140C674C8 + 8LL * v11);
      if ( (*(_DWORD *)(v15 + 4) & 2) != 0 )
        a1(v15, a2);
      continue;
    }
