/*
 * XREFs of PopAdaptiveGetConsoleSessionState @ 0x1407A65C8
 * Callers:
 ...
 *     PopAdaptiveCalculateInputRelativeTimeout @ 0x14099B7CC (PopAdaptiveCalculateInputRelativeTimeout.c)
        ...
        _DWORD *a5)
{
  ...
  if ( v10 )
  {
    ...
    if ( v8 != 3 )
      goto LABEL_12;
    if ( *a2 > (unsigned __int64)qword_140C39CD0 )
    {
...
LABEL_12:
  ...
  *a4 = 256;
  v28 = v12;
  *a5 = 258;
  if ( qword_140C39CD0 != a2[2] )
  {
    qword_140C39CD0 = a2[2];
    v20 = &byte_140C39CE0;
    for ( j = 0; j < 2; ++j )
    {
