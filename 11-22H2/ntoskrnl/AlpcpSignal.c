/*
 * XREFs of AlpcpSignal @ 0x1402B6C40
 * Callers:
  ...
  if ( v4 )
  {
    if ( *(_BYTE *)(a1 + 58) )
    {
      ...
      if ( v10 >= *(_DWORD *)(v7 + 8) )
      {
        ...
        __writecr8(OldIrql);
        if ( !(unsigned int)AlpcpQueueIoCompletion(v8, *(_QWORD *)(v4 + 40), -(v9 != 0), 0, 0, 0) )
        {
          KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)v7, &LockHandle);
          if ( v9 )
            ++*(_DWORD *)(v7 + 20);
            ...
            || !(unsigned __int8)KiWakeQueueWaiter(v25, v8, MiniCompletionPacket) )
          {
            ...
            *(_QWORD *)(v8 + 32) = MiniCompletionPacket;
            if ( !v30 && (_QWORD *)*v21 != v21 )
              KiWakeOtherQueueWaiters(v25, v8);
          }
          else
          {
    ...
    {
      KeReleaseSemaphoreEx(*(_QWORD *)(v4 + 248), 1, 1, a4, (a2 != 0) + 8, (__int64)&v47);
    }
  }
  else
  {
