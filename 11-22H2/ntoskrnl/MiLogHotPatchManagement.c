/*
 * XREFs of MiLogHotPatchManagement @ 0x140A38728
 * Callers:
    ...
    if ( a1 )
    {
      if ( a1 != 3 )
      {
        if ( a1 == 1 )
        {
          if ( **(_DWORD **)&qword_140C699E8 <= 5u )
            return (char)v4;
          LOBYTE(v4) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 32LL);
          if ( !(_BYTE)v4 )
            return (char)v4;
          ProcessId = (unsigned int)PsGetProcessId(KeGetCurrentThread()->ApcState.Process);
          v13 = (unsigned __int8 *)&word_140038AA6;
          v25 = 4LL;
        ...
        else
        {
          if ( a1 == 4 )
          {
            ...
            if ( !(_BYTE)v4 )
              return (char)v4;
            ProcessId = (unsigned int)PsGetProcessId(KeGetCurrentThread()->ApcState.Process);
            v13 = (unsigned __int8 *)&unk_140038AF8;
            v31 = 4LL;
            p_ProcessId = &ProcessId;
            v26 = &v19;
            v18 = *(_DWORD *)(a2 + 4);
          ...
          else
          {
            ...
            if ( !(_BYTE)v4 )
              return (char)v4;
            ProcessId = (unsigned int)PsGetProcessId(KeGetCurrentThread()->ApcState.Process);
            v13 = (unsigned __int8 *)&word_140038B5A;
            v31 = 8LL;
            p_ProcessId = &ProcessId;
            v26 = &v19;
            v18 = *(_DWORD *)(a2 + 4);
      ...
      if ( **(_DWORD **)&qword_140C699E8 > 5u )
      {
        ...
        if ( (_BYTE)v4 )
        {
          ...
          v36 = 0;
          v39 = 0;
          LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)byte_140038A3B, v11, 1u, v15, v16, 9u, v23);
        }
      }
    }
    else if ( **(_DWORD **)&qword_140C699E8 > 5u )
    {
      LOBYTE(v4) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 32LL);
      if ( (_BYTE)v4 )
      {
        ...
        v33 = 2LL;
        v36 = 0;
        LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)qword_1400389E0, v9, 1u, v15, v16, 8u, v23);
      }
    }
  }
  return (char)v4;
