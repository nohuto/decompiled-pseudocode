/*
 * XREFs of MiGetSpecialPurposeMemoryPartitionForCaching @ 0x140660294
 * Callers:
...
__int64 __fastcall MiGetSpecialPurposeMemoryPartitionForCaching(__int64 a1, int a2)
{
  ...
  if ( v8->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(a1, (__int64)v8)) != 0 )
  {
    ...
    _enable();
    v7 = (unsigned __int64)(&v8[1].Process + 12 * v19);
    if ( v6 - qword_140C65AE8 < 0x8000000000LL )
  ...
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)v6, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)v6, 0LL, v7, v6);
  if ( v7 )
    *(_BYTE *)(v7 + 18) = 1;
  v16 = (_QWORD *)*v2;
  if ( (_QWORD *)*v2 != v2 )
