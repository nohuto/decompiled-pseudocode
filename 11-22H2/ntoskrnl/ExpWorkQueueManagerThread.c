/*
 * XREFs of ExpWorkQueueManagerThread @ 0x14083A910
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeSetMaximumCountPriQueue @ 0x14057EBA4 (KeSetMaximumCountPriQueue.c)
...
LABEL_23:
    ...
    if ( !(unsigned int)KeIsEqualAffinityEx((unsigned __int16 *)v36, &CurrentThread->UserAffinity->Count) )
      KeSetUserAffinityThread((__int64)CurrentThread, (__int64)v36);
