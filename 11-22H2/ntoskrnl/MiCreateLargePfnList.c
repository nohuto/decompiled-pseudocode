/*
 * XREFs of MiCreateLargePfnList @ 0x140667A5C
 * Callers:
        ...
        _QWORD *a9)
{
  ...
  v35 = *(_DWORD *)(a1 + 20);
  v37 = v15;
  v17 = *(_QWORD *)(qword_140C674C8 + 8LL * CurrentThread->ApcState.Process[1].IdealProcessor[25]);
  if ( !v11 )
    goto LABEL_11;
  if ( !a7 )
  {
...
LABEL_41:
    ...
    v36[2] = a3;
    v36[7] = a2;
    v25 = (_DWORD *)(qword_140C65B98 + 4LL * v24 * (unsigned int)(unsigned __int16)KeNumberNodes);
