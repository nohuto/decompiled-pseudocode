/*
 * XREFs of Xp10CompressBuffer @ 0x1409C4A68
 * Callers:
 *     RtlCompressBufferXp10 @ 0x1409C30B0 (RtlCompressBufferXp10.c)
 * Callees:
 *     memset @ 0x140435400 (memset.c)
 *     Xp10ComputeAndWriteCrc @ 0x1409C500C (Xp10ComputeAndWriteCrc.c)
 *     Xp10ExecuteHuffmanEncode @ 0x1409C5754 (Xp10ExecuteHuffmanEncode.c)
 *     Xp10ExecuteLz77PassMinMatchLen3 @ 0x1409C5BF0 (Xp10ExecuteLz77PassMinMatchLen3.c)
 *     Xp10ExecuteLz77PassMinMatchLen4 @ 0x1409C6334 (Xp10ExecuteLz77PassMinMatchLen4.c)
 *     Xp10ValidateParametersAndFillFrameHeader @ 0x1409C7A0C (Xp10ValidateParametersAndFillFrameHeader.c)
 */
...
LABEL_12:
          ...
          || (v24 = HIDWORD(v50) - DWORD2(v50), HIDWORD(v50) != DWORD2(v50)) )
        {
          ...
          if ( v28 >= v24 )
            v29 = v24;
          *v27 |= ((unsigned __int8)(BYTE8(v48) - BYTE8(v50)) & (unsigned __int8)byte_14001BD90[4 * v29]) << v26;
          ...
          if ( (_DWORD)v30 )
            *v32 |= (unsigned __int8)v31 & byte_14001BD90[4 * v30];
          v18 += v24;
        }
        v20 += v45;
        v14 = a3;
    ...
    if ( v35 <= v19 || (v38 = v19 - v34, v19 != v34) )
    {
      ...
      *v37++ |= (byte_14001BD90[4 * v40] & 1) << v36;
      v42 = 1u >> v39;
      ...
      if ( (_DWORD)v41 )
        *v37 |= (unsigned __int8)v42 & byte_14001BD90[4 * v41];
    }
    DWORD2(v49) = 0;
    *(_QWORD *)&v49 = a2;
    HIDWORD(v49) = v14;
