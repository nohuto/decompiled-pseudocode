/*
 * XREFs of ViDeadlockObjectAcquired @ 0x140ADA750
 * Callers:
 *     ViDeadlockKeWaitForMultipleObjects_Exit @ 0x140ADA500 (ViDeadlockKeWaitForMultipleObjects_Exit.c)
 *     ViDeadlockKeWaitForSingleObject_Exit @ 0x140ADA560 (ViDeadlockKeWaitForSingleObject_Exit.c)
 * Callees:
