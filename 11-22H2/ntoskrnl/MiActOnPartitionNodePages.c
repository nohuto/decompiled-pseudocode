/*
 * XREFs of MiActOnPartitionNodePages @ 0x1406580F0
 * Callers:
...
LABEL_39:
    ...
    if ( v6 - 11 > 1 )
    {
      if ( v33 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * v33 - 0x21FFFFFFFFD8LL), 0x36u) )
        v34 = 1;
      switch ( v6 )
      {
        case 7u:
...
LABEL_130:
  ...
  if ( v63 )
  {
    ...
    if ( (int)MiAddPhysicalMemoryChunks(
      ...
      && (v77 & 0x100000) == 0 )
    {
      _InterlockedExchangeAdd64(&qword_140C69AB0, v81 / 4096);
    }
  }
  else
  {
