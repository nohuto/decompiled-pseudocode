/*
 * XREFs of BgpTxtDisplayCharacter @ 0x140384188
 * Callers:
 ...
 *     TxtpGetCacheEntry @ 0x1403843C8 (TxtpGetCacheEntry.c)
...
LABEL_5:
    ...
    if ( (a3 & 1) != 0 || (dword_140C0E4B0 & 0x1000000) != 0 || (v13 = BgpGxDrawRectangle(v6, &v25), v13 >= 0) )
    {
      if ( v15 )
