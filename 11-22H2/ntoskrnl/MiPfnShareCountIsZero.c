/*
 * XREFs of MiPfnShareCountIsZero @ 0x1402817A0
 * Callers:
  ...
  if ( *(_WORD *)(a1 + 32) )
  {
    ...
    *(_BYTE *)(a1 + 34) = v30;
    if ( (*(_DWORD *)v4 & 0x400LL) == 0 && (unsigned int)MiGetPagingFileOffset(v4, a2, a3, a4) )
      *(_BYTE *)(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL)) + 715LL) = 1;
    return 3LL;
  }
  else
  {
    if ( (_DWORD)v8 )
    {
      ...
      v28 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL));
      v32 = *v4;
