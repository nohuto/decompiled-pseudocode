/*
 * XREFs of MmOutSwapWorkingSet @ 0x140341B10
 * Callers:
...
__int64 __fastcall MmOutSwapWorkingSet(PEPROCESS Process, int a2)
{
  ...
  v7 = *(_QWORD *)(qword_140C674C8 + 8LL * *((unsigned __int16 *)v2 + 87));
  v75 = v7;
  LODWORD(v83) = a2 != 0;
  *((_QWORD *)&v82[1] + 1) = v7;
  ...
  if ( BestOutswapPagefile != 16 || v6 == 2 )
  {
    ...
    if ( Pool )
    {
      ...
      if ( v11->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(0LL, (__int64)v11)) != 0 )
      {
        ...
        if ( (unsigned __int64)(v10 - qword_140C65AE8) < 0x8000000000LL )
          ...
          *(_QWORD *)&v82[1] = v19;
          ...
          else
          {
            ...
            if ( v30->AbEntrySummary || (v32 = KiAbTryReclaimOrphanedEntries(0LL, (__int64)v30)) != 0 )
            {
              ...
              if ( v29 - qword_140C65AE8 < 0x8000000000LL )
