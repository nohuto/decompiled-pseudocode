/*
 * XREFs of KiAcquirePrcbLocksForPreemptionAttempt @ 0x140333260
 * Callers:
 ...
 *     KiPopulateTrivialProcessorSelectionResult @ 0x1405776DC (KiPopulateTrivialProcessorSelectionResult.c)
 * Callees:
