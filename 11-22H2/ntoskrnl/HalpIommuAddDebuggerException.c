/*
 * XREFs of HalpIommuAddDebuggerException @ 0x1403A96C8
 * Callers:
...
__int64 HalpIommuAddDebuggerException()
{
  ...
  if ( MemoryInternal )
  {
    ...
    *((_DWORD *)MemoryInternal + 4) = *((unsigned __int16 *)v0 + 4);
    ...
    v2[3] = v4;
    v2[3] = v4 | (v0[1] >> 5) & 7;
    v5 = (_QWORD *)qword_140C61D78;
    if ( *(__int64 **)qword_140C61D78 != &HalpIommuExceptionList )
      __fastfail(3u);
    *v2 = &HalpIommuExceptionList;
    v2[1] = v5;
    *v5 = v2;
    qword_140C61D78 = (__int64)v2;
    return 0LL;
  }
  return 3221225626LL;
}
