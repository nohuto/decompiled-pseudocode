/*
 * XREFs of MiWritePageFileHash @ 0x14046EFA6
 * Callers:
...
_BOOL8 __fastcall MiWritePageFileHash(__int64 a1, _QWORD *a2, int a3, unsigned int a4)
{
  ...
  _QWORD v43[34]; // [rsp+50h] [rbp-158h] BYREF
  ...
  v7 = 17;
  v37 = 17;
  result = dword_140C69750 != 0;
  v10 = a1;
  v40 = dword_140C69750 != 0;
  v11 = a3;
  v12 = 0;
  while ( 1 )
  {
...
LABEL_53:
          LODWORD(v43[v13 + 2]) = 2;
          v43[2 * v4 + 3] = v16 | 1;
          HIDWORD(v43[2 * v4 + 2]) = MiGetPagingFileOffset((unsigned __int64)v43);
LABEL_16:
          ++v4;
...
LABEL_22:
    ...
    v20 = 0;
    v21 = *(_QWORD *)(a1 + 216) + (unsigned int)(dword_140C6974C * v11);
    if ( v4 )
    {
      v22 = v40;
      v23 = 1;
      do
      {
        if ( (*(_DWORD *)v21 > v23 || v22 && ((unsigned __int8)v23 & *(_BYTE *)(v21 + 8)) != 0) && !dword_140C68044 )
          MiPageHashBugCheck(0x60uLL, v11 + v20, (int)&v43[2 * v20 + 2]);
        MiWriteEntirePageHashEntry(v21, &v43[2 * v20 + 2]);
        v20 = v23 + v24;
        v21 = (unsigned int)dword_140C6974C + v25;
      }
      while ( v20 < v4 );
    }
