/*
 * XREFs of KiRemoveBoostThread @ 0x1402BB220
 * Callers:
 ...
 *     KiGetCurrentScheduledThreadProcessor @ 0x1405772F0 (KiGetCurrentScheduledThreadProcessor.c)
 *     KiGetThreadHeteroRunningType @ 0x140577308 (KiGetThreadHeteroRunningType.c)
 */
