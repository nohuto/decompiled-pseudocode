/*
 * XREFs of DifZwCreateEventWrapper @ 0x1405EE550
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  *(_QWORD *)&v21 = 0LL;
LABEL_10:
  BYTE8(v21) = InitialState;
  *(_QWORD *)&v23 = EventHandle;
  DWORD2(v22) = DesiredAccess;
  *(_QWORD *)&v22 = ObjectAttributes;
  HIDWORD(v21) = EventType;
...
LABEL_17:
  result = ZwCreateEvent(EventHandle, DesiredAccess, ObjectAttributes, EventType, InitialState);
  DWORD2(v23) = result;
  if ( v14 )
  {
    v19 = (_QWORD **)(v14 + 6);
