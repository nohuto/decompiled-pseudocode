/*
 * XREFs of MiIsPageEligibleForProtectedStandby @ 0x140334F50
 * Callers:
...
_BOOL8 __fastcall MiIsPageEligibleForProtectedStandby(__int64 a1, __int64 a2)
{
  ...
  if ( !_bittest64((const signed __int64 *)(a2 + 40), 0x35u) && !(unsigned int)MiCheckSlabPfnBitmap(a2, 1LL, 0) )
  {
    if ( a1 )
    {
      v4 = *(_BYTE *)(a2 + 35);
      if ( (v4 & 0x50) == 0
        && *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(a1 + 40) >> 43) & 0x3FFLL)) == *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(a2 + 40) >> 43) & 0x3FFLL))
        && (v4 & 7u) < 5 )
      {
        return 1;
      }
