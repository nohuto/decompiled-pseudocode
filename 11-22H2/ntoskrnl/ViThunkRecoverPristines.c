/*
 * XREFs of ViThunkRecoverPristines @ 0x140ADCD6C
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x140ADC020 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x140ADD0D8 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x140ADD1AC (ViThunkReplaceSpecialPristine.c)
 */
