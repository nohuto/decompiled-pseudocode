/*
 * XREFs of MiFreeUltraMapping @ 0x1403C5F48
 * Callers:
...
__int64 __fastcall MiFreeUltraMapping(unsigned __int64 a1)
{
  ...
  v2 = (a1 - qword_140C685F8) >> 30;
  KeAcquireInStackQueuedSpinLock(&qword_140C685F0, &v11);
  v3 = 0;
  _bittestandset64((signed __int64 *)qword_140C68620, v2);
  v4 = ZeroPte;
