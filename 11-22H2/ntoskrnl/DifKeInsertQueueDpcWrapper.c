/*
 * XREFs of DifKeInsertQueueDpcWrapper @ 0x1405E3CF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DifKeInsertQueueDpcWrapper(ULONG_PTR BugCheckParameter2, __int64 a2, __int64 a3)
{
...
LABEL_8:
  ...
  *(_QWORD *)&v18 = 0LL;
LABEL_10:
  *((_QWORD *)&v19 + 1) = BugCheckParameter2;
  *(_QWORD *)&v19 = a2;
  *((_QWORD *)&v18 + 1) = a3;
...
LABEL_17:
  result = KiInsertQueueDpc(BugCheckParameter2, a2, a3, 0LL, 0);
  LOBYTE(v20) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
