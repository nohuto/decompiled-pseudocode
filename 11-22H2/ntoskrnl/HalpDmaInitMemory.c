/*
 * XREFs of HalpDmaInitMemory @ 0x140B4BE64
 * Callers:
 *     HalpDmaInitDiscard @ 0x140B640C0 (HalpDmaInitDiscard.c)
 * Callees:
...
__int64 __fastcall HalpDmaInitMemory(__int64 a1)
{
  ...
  qword_140C64488 = (__int64)&HalpDmaAdapterList;
  ...
  v10 = 0x1000000LL;
  qword_140C640A8 = HalpAllocPhysicalMemory(a1, &v10, 16LL, 0x10000LL);
  dword_140C640A0 = qword_140C640A8 != 0 ? 0x10000 : 0;
  qword_140C64288 = HalpAllocPhysicalMemory(a1, &v10, 16LL, 0x10000LL);
  v2 = 32;
  dword_140C64280 = qword_140C64288 != 0 ? 0x10000 : 0;
  ...
  while ( v5 + 1 <= 0x20 );
  qword_140C64188 = v6;
  dword_140C64180 = v6 != 0 ? v3 : 0;
  if ( v2 >= 0x40 )
    qword_140C64150 = -1LL;
  else
    qword_140C64150 = (1LL << v2) - 1;
  v7 = 32;
  while ( 1 )
  {
    v8 = v7;
