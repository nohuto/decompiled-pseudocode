/*
 * XREFs of MiLogHotPatchOperationStatus @ 0x140A38FC8
 * Callers:
        ...
        int a5)
{
  ...
  if ( a5 )
  {
    if ( a5 == 1 || a5 == 7 )
    {
      if ( **(_DWORD **)&qword_140C699E8 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000020LL) )
        return;
      v25 = v26 == 7;
      v13 = (__int16 *)&byte_1400391F5;
    }
    else
    {
        ...
        else
        {
          if ( a5 == 4 )
          {
            ...
            if ( **(_DWORD **)&qword_140C699E8 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000020LL) )
            {
              ...
              v53 = 8LL;
              v55[0] = 8LL;
              tlgWriteEx_EtwWriteEx(v18, (unsigned __int8 *)byte_140039387, v20, 1u, v28, v29, 9u, v41);
            }
            return;
          }
          if ( **(_DWORD **)&qword_140C699E8 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000020LL) )
