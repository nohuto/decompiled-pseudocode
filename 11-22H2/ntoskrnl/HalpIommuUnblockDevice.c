/*
 * XREFs of HalpIommuUnblockDevice @ 0x140518860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpIommuCheckDpptException @ 0x14038F974 (HalpIommuCheckDpptException.c)
 ...
 *     HalpIommuCheckExceptionList @ 0x14050D9F0 (HalpIommuCheckExceptionList.c)
  ...
  if ( !HalpIommuCheckDpptException(Src) && !HalpIommuCheckExceptionList(v7) )
  {
    ...
    if ( Device >= 0 )
    {
      ...
      if ( HalpHvIommu )
      {
        v17 = *(_QWORD *)(v24 + 32);
        v20 = 0LL;
        v14 = ((__int64 (__fastcall *)(__int64, __int64 *))qword_140C62710)(v17, &v20);
      }
      else
      {
