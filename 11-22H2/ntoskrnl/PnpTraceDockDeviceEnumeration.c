/*
 * XREFs of PnpTraceDockDeviceEnumeration @ 0x14096BD14
 * Callers:
...
void PnpTraceDockDeviceEnumeration()
{
  ...
  if ( (unsigned int)dword_140C03918 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03918, 0x400000000000LL) )
    {
      ...
      v3 = v1;
      v15 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03918, (unsigned __int8 *)byte_14002CB2B, 0LL, 0LL, 7u, &v5);
    }
  }
}
