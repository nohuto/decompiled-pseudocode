/*
 * XREFs of KiChooseTargetProcessor @ 0x1402392C0
 * Callers:
 *     KiDeferredReadySingleThread @ 0x14023A2B0 (KiDeferredReadySingleThread.c)
 * Callees:
 *     KiTryLocalThreadSchedule @ 0x14023A060 (KiTryLocalThreadSchedule.c)
 ...
 *     KiFindRankBiasedIdleSmtSet @ 0x140577228 (KiFindRankBiasedIdleSmtSet.c)
            ...
            if ( v26 == v14 )
            {
                ...
                && !*(_DWORD *)(v116 + 32472) )
              {
                ...
                if ( !*(_BYTE *)(v116 + 32) )
                {
                  ...
                  KiStartThreadCycleAccumulation(v116, v29, 0LL);
...
LABEL_90:
      ...
      if ( !KeSoftParkedQueueThreshold || (unsigned __int8)KiAreSoftUnparkingElectionsEnabled(v54) )
        break;
      v121 = 0LL;
      KiAcquirePrcbLocksForIsolationUnit(v13, 0LL, &v121);
      if ( (*(_BYTE *)(v13 + 35) & 8) != 0 )
      {
      ...
      while ( _interlockedbittestandset64((volatile signed __int32 *)(v102 + 48), 0LL) )
      {
        do
        {
          if ( (++v103 & HvlLongSpinCountMask) == 0
            ...
            && (unsigned __int8)KiCheckVpBackingLongSpinWaitHypercall(v98) )
          {
