/*
 * XREFs of MiProtectSharedUserPage @ 0x140B703E4
 * Callers:
...
ULONG_PTR MiProtectSharedUserPage()
{
  ...
  result = MiReservePtes((__int64)&qword_140C69A40, 1u);
  v3 = result;
  if ( !result )
    return result;
...
LABEL_18:
  ...
  if ( v10 >= 0 || (BYTE1(v10) & 1) != (_BYTE)word_140C66DFC )
  {
    MiWriteValidPteNewProtection(
      0xFFFFF6FBC0000000uLL,
      v10 & 0xFFFFFFFFFFFFFEFFuLL | ((word_140C66DFC & 1 | 0xFF80000000000000uLL) << 8));
    MiInsertTbFlushEntry((__int64)v15, 0xFFFFF78000000000uLL, 1LL, 0);
  }
