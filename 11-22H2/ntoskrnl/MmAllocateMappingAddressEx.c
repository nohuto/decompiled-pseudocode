/*
 * XREFs of MmAllocateMappingAddressEx @ 0x14086C950
 * Callers:
 *     MmAllocateMappingAddress @ 0x14086C930 (MmAllocateMappingAddress.c)
 *     PnprInitializeMappingReserve @ 0x140966324 (PnprInitializeMappingReserve.c)
...
__int64 __fastcall MmAllocateMappingAddressEx(__int64 a1, unsigned int a2, int a3)
{
  ...
  if ( !Pool )
    return 0LL;
  v6 = MiReservePtes((__int64)&qword_140C69A40, v5);
  v7 = (_QWORD *)v6;
  if ( !v6 )
  {
