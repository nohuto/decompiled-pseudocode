/*
 * XREFs of VfFlushAdapterBuffers @ 0x140AC6DD0
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    if ( a5 )
    {
      ViHalPreprocessOptions(
        ...
        a3,
        a4);
      VfReportIssueWithOptions(0xE6u, 0x20uLL, (ULONG_PTR)a3, (ULONG_PTR)a4, a2, byte_140C0DE40);
    }
    return 0;
  }
}
