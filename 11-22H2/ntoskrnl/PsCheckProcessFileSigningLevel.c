/*
 * XREFs of PsCheckProcessFileSigningLevel @ 0x1409B08C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PsCheckProcessFileSigningLevel(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( qword_140C37A00 )
  {
    LOBYTE(v6) = v20;
    LOBYTE(v5) = v2;
    if ( (unsigned int)qword_140C37A00(v6, v5) )
    {
      v7 = 0;
      goto LABEL_25;
    }
...
LABEL_2:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (int)PsQuerySectionSignatureInformation((_KPROCESS *)a1, &v20) >= 0 )
  {
    if ( qword_140C37A00 && (LOBYTE(v13) = v20, LOBYTE(v12) = v2, (unsigned int)qword_140C37A00(v13, v12)) )
      v7 = 0;
    else
      v7 = -1073740760;
    goto LABEL_21;
