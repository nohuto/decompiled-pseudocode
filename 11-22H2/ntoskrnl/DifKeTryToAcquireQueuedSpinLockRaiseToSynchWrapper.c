/*
 * XREFs of DifKeTryToAcquireQueuedSpinLockRaiseToSynchWrapper @ 0x1405E6000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeTryToAcquireQueuedSpinLockRaiseToSynchWrapper(__int64 a1, unsigned __int8 *a2)
{
