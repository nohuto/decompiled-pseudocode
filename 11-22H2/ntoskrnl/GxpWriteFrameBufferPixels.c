/*
 * XREFs of GxpWriteFrameBufferPixels @ 0x1403844DC
 * Callers:
 *     BgpGxDrawRectangle @ 0x14038444C (BgpGxDrawRectangle.c)
 * Callees:
 *     BgpGetBitsPerPixel @ 0x140384700 (BgpGetBitsPerPixel.c)
 *     GxpAdjustRectangleToFrameBuffer @ 0x140384728 (GxpAdjustRectangleToFrameBuffer.c)
 ...
 *     GxpGetRotatedPixelOffset @ 0x140671F48 (GxpGetRotatedPixelOffset.c)
