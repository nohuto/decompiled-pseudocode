/*
 * XREFs of BcpDisplayProgress @ 0x140672970
 * Callers:
 ...
 *     BcpCursorLessThan @ 0x140672288 (BcpCursorLessThan.c)
...
__int64 __fastcall BcpDisplayProgress(unsigned int a1, int a2, __int64 a3)
{
  ...
  if ( a1 != 1 )
    v5 = &stru_140C70BC0;
  BcpDisplayCriticalString(&v5->Length, dword_140C0B5A0[18 * a2 + 2], a3, a2);
  v24 = 0x80000LL;
  v25 = &v26;
  BcpConvertProgressToString(a1, (__int64)&v24);
  BcpDisplayCriticalString((unsigned __int16 *)&v24, dword_140C0B5A0[2 * v6 + 2], v7, a2);
  v9 = &stru_140C70BB0;
  if ( a1 != 1 )
    v9 = &stru_140C70BD0;
  BcpDisplayCriticalString(&v9->Length, dword_140C0B5A0[2 * v6 + 2], v8, a2);
  v10 = BcpCursor;
  v11 = dword_140C64B30;
  v24 = BcpCursor;
  LODWORD(v25) = dword_140C64B30;
  if ( BcpCursorLessThan(&v24) )
  {
    v12 = BcpCursor;
    v13 = HIDWORD(BcpCursor);
    v14 = &dword_140C0B5A0[2 * v6];
    v15 = *(_DWORD *)(*(_QWORD *)(qword_140C70C60 + 24) + 40LL);
    ...
    if ( BcpTextBoxRightEdgeOverride )
      ...
      v17 = v14[8] + v14[4] + dword_140C0B5A0[2 * v6 + 6];
LABEL_12:
    v22 = __PAIR64__(v13, v12);
    while ( BcpCursorLessThan(&v22) )
    {
      if ( (int)BgpDisplayCharacterEx(0x20u, (__int64 *)qword_140C70C60, v12, v13, v15, v15, &v20, &v21, v19) < 0 )
        return 0LL;
      v12 += v20;
      LODWORD(v22) = v12;
      if ( v12 > v17 )
  ...
  if ( (dword_140C0E4B0 & 0x1000000) == 0 )
  {
    BcpProgressEnd = v10;
    dword_140C0E408 = v11;
  }
