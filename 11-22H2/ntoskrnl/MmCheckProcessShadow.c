/*
 * XREFs of MmCheckProcessShadow @ 0x1403CFBE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MmCheckProcessShadow(__int64 a1)
{
  ...
  if ( v3->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(a1, (__int64)v3)) != 0 )
  {
    ...
    if ( (unsigned __int64)&qword_140C65AE0 - qword_140C65AE8 < 0x8000000000LL )
      SessionId = MmGetSessionIdEx((__int64)v3->ApcState.Process);
    else
      SessionId = -1;
    *(_DWORD *)(v4 + 8) = SessionId;
    *(_QWORD *)v4 = (unsigned __int64)&qword_140C65AE0 & 0x7FFFFFFFFFFFFFFCLL;
  }
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C65AE0, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&qword_140C65AE0, 0LL, v4, (__int64)&qword_140C65AE0);
  if ( v4 )
    *(_BYTE *)(v4 + 18) = 1;
  ...
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C65AE0, 0LL, 17LL) != 17 )
    ExfReleasePushLockShared((signed __int64 *)&qword_140C65AE0);
