/*
 * XREFs of KiFreeProcessorNumber @ 0x1405709DC
 * Callers:
 *     KiFreeProcessorStateInitializationParameters @ 0x14056BED4 (KiFreeProcessorStateInitializationParameters.c)
 * Callees:
 *     KiFindSubNodeForProcessorNumber @ 0x140376DB8 (KiFindSubNodeForProcessorNumber.c)
 *     KiUncommitGroupSubNodeAssignments @ 0x140570B40 (KiUncommitGroupSubNodeAssignments.c)
