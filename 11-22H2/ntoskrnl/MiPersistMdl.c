/*
 * XREFs of MiPersistMdl @ 0x14063E684
 * Callers:
...
void __fastcall MiPersistMdl(PMDL MemoryDescriptorList)
{
  ...
  v6 = (__int64 *)qword_140C697E8;
  v7 = (__int64 *)&MemoryDescriptorList[1];
  v28[3] = 0LL;
  LODWORD(v28[1]) = 20;
  CurrentThread = KeGetCurrentThread();
  v9 = qword_140C697E8 << 25 >> 16;
  ...
  if ( v10->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(v2, (__int64)v10)) != 0 )
  {
    ...
    *(_QWORD *)v11 = (unsigned __int64)&qword_140C659B0 & 0x7FFFFFFFFFFFFFFCLL;
  }
  if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C659B0, 0LL) )
    ExfAcquirePushLockExclusiveEx(&qword_140C659B0, v11, (__int64)&qword_140C659B0);
  if ( v11 )
    *(_BYTE *)(v11 + 18) = 1;
  if ( v3 )
  {
