/*
 * XREFs of KeBugCheck2 @ 0x140568330
 * Callers:
 ...
 *     KiFilterBugCheckInfo @ 0x1403E318C (KiFilterBugCheckInfo.c)
 ...
 *     KiBugCheckUnicodeToAnsi @ 0x140569B48 (KiBugCheckUnicodeToAnsi.c)
 ...
 *     KiPcToFileHeader @ 0x14056AA34 (KiPcToFileHeader.c)
 ...
 *     MmLocateUnloadedDriver @ 0x14062CAE8 (MmLocateUnloadedDriver.c)
        ...
        __int64 a6)
{
  ...
  {
    v16 = KeQueryCurrentStackInformation(&v79, (char **)&Src, &v84);
    ...
    if ( v16 )
    {
      ...
      {
        v23 = v84 - (_QWORD)Src;
        if ( v84 - (unsigned __int64)Src > 0x6000 )
          v23 = 24576LL;
    ...
    if ( v31 != 10 )
    {
      if ( v31 != 59 )
      {
        if ( v31 == 76 )
        {
          ...
          v66 = 1;
          v71 = 1;
          v30 = (unsigned __int64)qword_140C42828;
          KiBugCheckData = (unsigned int)a2;
          v42 = a3 - (_QWORD)&qword_140C42808;
          v86 = (PCSTR)a5;
          do
          {
          ...
          while ( (__int64)v41 < (__int64)qword_140C42828 );
          v32 = v70;
          v35 = 1;
          goto LABEL_93;
        }
...
LABEL_66:
              if ( v31 != 142 )
              {
                ...
                if ( KeGetCurrentThread()->ApcStateIndex == 1
                  && (unsigned __int64)(v33 - qword_140C65AE8) < 0x8000000000LL
...
LABEL_86:
            if ( v76 != a2
              || (unsigned __int64)(a2 - qword_140C65AE8) >= 0x8000000000LL
        ...
        if ( KeGetCurrentThread()->ApcStateIndex == 1 )
        {
          v38 = (unsigned __int64)(v37 - qword_140C65AE8) < 0x8000000000LL;
          v24 = (__int64)CurrentPrcb;
          if ( v38 )
          {
...
LABEL_94:
  ...
  if ( v69 && (PartialDumpControl & 4) != 0 )
  {
    ...
    qword_140C42848 = (__int64)CurrentThread;
    qword_140C42850 = (__int64)v83;
    byte_140C42860 = v34;
    byte_140C42861 = v21;
  ...
  if ( CrashdmpDumpBlock )
    v47 = !v35;
  HvlLogGuestCrashInformation(KiBugCheckData, qword_140C42808, qword_140C42810, qword_140C42818, qword_140C42820, v47);
  if ( !KdPitchDebugger )
  ...
  if ( (unsigned __int8)KiBugCheckShouldEnterPostBugCheckDebugger(v75, 0LL) )
  {
    if ( !*(_BYTE *)(v24 + 32422) )
    {
      DbgPrintEx(
        ...
        KiBugCheckData,
        (const void *)qword_140C42808,
        (const void *)qword_140C42810,
        (const void *)qword_140C42818,
        (const void *)qword_140C42820);
      if ( KiBugCheckDriver )
...
LABEL_166:
  ...
  if ( v29 )
  {
    ...
    IoSaveInitialBugCheckProgress(KiBugCheckData, qword_140C42808);
