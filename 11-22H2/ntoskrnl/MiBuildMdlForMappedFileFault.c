        ...
        volatile signed __int32 **a10)
{
  ...
  volatile signed __int32 **v90; // [rsp+90h] [rbp-70h]
  ...
  else
  {
    ...
    if ( (v10 & 0x400) == 0 )
    {
      if ( qword_140C65C40 && (v10 & 0x10) == 0 )
        v22 = v10 & ~qword_140C65C40;
      v92 = 48 * ((v22 >> 12) & 0xFFFFFFFFFFLL) - 0x220000000000LL;
      v22 = *(_QWORD *)(v92 + 16);
    }
    v23 = a9;
    MiGetHardFaultPages(&v83, v20, v13, v91, a9, v85, v22, v90);
    v21 = v84;
  }
  if ( v21 != v11 )
  {
...
LABEL_57:
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(v44 + 16) = v48;
      ...
      v95 = v51;
      v52 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v95);
      LODWORD(v88) = 0;
      v53 = v52 >> 12;
      ...
      *(_BYTE *)(v44 + 34) = v62;
      if ( *(unsigned __int8 *)(v44 + 34) >> 6 != v61 )
        MiChangePageAttribute(v44, v61, 1LL);
      ...
      *(_QWORD *)(v44 + 24) &= 0xC000000000000000uLL;
      ...
      if ( MiPteInShadowRange(v40) )
      {
        ...
        {
          if ( !HIBYTE(word_140C66DFC) && (v63 & 1) != 0 )
