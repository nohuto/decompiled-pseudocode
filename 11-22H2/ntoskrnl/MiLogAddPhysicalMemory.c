/*
 * XREFs of MiLogAddPhysicalMemory @ 0x14061B97C
 * Callers:
...
char __fastcall MiLogAddPhysicalMemory(unsigned __int16 *a1, __int64 *a2, __int64 *a3, __int64 a4, __int64 a5)
{
  ...
  if ( *(_QWORD *)&qword_140C699E8 )
  {
    if ( a5 )
    {
      ...
      {
        LOBYTE(v5) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 256LL);
        if ( (_BYTE)v5 )
        {
          v18 = *a1;
          v14 = 4;
          ...
          v33 = 8;
          v36 = 8;
          v15 = (unsigned __int8 *)&word_1400383C2;
          v22 = 7;
          v23 = v16;
          v42 = 4;
          goto LABEL_9;
    ...
    else if ( **(_DWORD **)&qword_140C699E8 > 5u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v33 = v12 + 8;
        v36 = v12 + 8;
        v15 = (unsigned __int8 *)word_14003836A;
        v22 = 6;
        v24 = v10;
LABEL_9:
        v34 = 0;
