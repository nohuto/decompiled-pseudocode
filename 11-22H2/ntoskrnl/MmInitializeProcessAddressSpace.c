/*
 * XREFs of MmInitializeProcessAddressSpace @ 0x1406B2A9C
 * Callers:
 ...
 *     MiInitializeProcessPageTableCommitmentBitMaps @ 0x1402233E0 (MiInitializeProcessPageTableCommitmentBitMaps.c)
 *     MiInitializeWorkingSetList @ 0x140223444 (MiInitializeWorkingSetList.c)
 *     KiStackAttachProcess @ 0x14022D620 (KiStackAttachProcess.c)
 *     KiUnstackDetachProcess @ 0x14022D9E0 (KiUnstackDetachProcess.c)
 *     MiAllocatePool @ 0x1402DF1A0 (MiAllocatePool.c)
 *     ExInitializeAutoExpandPushLock @ 0x1403381B0 (ExInitializeAutoExpandPushLock.c)
 *     __security_check_cookie @ 0x1403D7680 (__security_check_cookie.c)
 *     memmove @ 0x140435100 (memmove.c)
 *     memset @ 0x140435400 (memset.c)
 *     MiInitializeVadBitMap @ 0x1406B2CE4 (MiInitializeVadBitMap.c)
    ...
    *(_DWORD *)(v12 + 280) = 1;
    ...
    if ( inserted >= 0 )
    {
      if ( a2
        ...
        || (P = (PVOID)MiAllocateProcessVads(BugCheckParameter1, v34)) != 0LL )
      {
          ...
          if ( inserted >= 0 )
          {
            if ( a3 )
            {
              if ( (*(_BYTE *)(BugCheckParameter1 + 992) & 1) != 0 )
                v15 = PsMapSystemDlls(BugCheckParameter1, 0LL);
              else
                ...
                *(_BYTE *)(v12 + 341) |= 2u;
                ...
                if ( inserted >= 0 )
                {
                  ...
                  if ( inserted >= 0 )
                  {
                    ...
                    if ( *((_QWORD *)&v37[2] + 1) )
                      MiReferenceCfgVad(CurrentThread, *(_QWORD *)&v37[2], 1LL);
                    if ( *((_QWORD *)&v37[0] + 1) )
                      MiReferenceCfgVad(CurrentThread, *(_QWORD *)&v37[0], 0LL);
                    KiUnstackDetachProcess(&v38);
                  }
                }
