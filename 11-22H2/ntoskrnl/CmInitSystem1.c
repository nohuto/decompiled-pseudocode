/*
 * XREFs of CmInitSystem1 @ 0x140B39964
 * Callers:
 ...
 *     CmpVolumeManagerInitialize @ 0x140865AE0 (CmpVolumeManagerInitialize.c)
 *     CmpInitializeFreezeThaw @ 0x140865D28 (CmpInitializeFreezeThaw.c)
 *     CmpInitializeGlobalKeyLockTracker @ 0x140865D60 (CmpInitializeGlobalKeyLockTracker.c)
 *     CmpValidateGlobalFlushControlFlags @ 0x1408662B8 (CmpValidateGlobalFlushControlFlags.c)
 ...
 *     CmpUpdateStateSeparationHiveOptions @ 0x140B99390 (CmpUpdateStateSeparationHiveOptions.c)
 */
...
char __fastcall CmInitSystem1(ULONG_PTR BugCheckParameter3)
{
  ...
  *(_QWORD *)v38 = 0LL;
  ...
  qword_140D54CA0 = (__int64)&CmpHiveListHead;
  CmpHiveListHead = (__int64)&CmpHiveListHead;
  qword_140C13E48 = (__int64)&CmpAppHiveLoadList;
