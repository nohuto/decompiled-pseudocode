/*
 * XREFs of PopSleepDeviceList @ 0x140590AA8
 * Callers:
 ...
 *     PopIsNotifyForDirectedPowerTransition @ 0x140590884 (PopIsNotifyForDirectedPowerTransition.c)
  ...
  *(_QWORD *)(a1 + 40) = v24;
  ...
  if ( v2 > 0 )
  {
    do
    {
      ...
      if ( *(int *)(a1 + 448) < 0 )
        break;
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)qword_140C3CDB0 + 1, &LockHandle);
      v9 = *v3;
      v10 = (_QWORD *)**v3;
