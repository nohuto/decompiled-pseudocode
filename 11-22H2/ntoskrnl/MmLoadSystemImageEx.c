/*
 * XREFs of MmLoadSystemImageEx @ 0x140703E70
 * Callers:
 ...
 *     IopLoadCrashdmpImage @ 0x140864CE0 (IopLoadCrashdmpImage.c)
 ...
 *     IoIsDeviceEjectable @ 0x14020ECB0 (IoIsDeviceEjectable.c)
 ...
 *     MiValidateStrongCodeDriverImage @ 0x14062CA40 (MiValidateStrongCodeDriverImage.c)
 ...
 *     MiFinalizeDriverCfgState @ 0x1407E35A8 (MiFinalizeDriverCfgState.c)
 *     MiBackSingleImageWithPagefile @ 0x1408720F4 (MiBackSingleImageWithPagefile.c)
...
LABEL_12:
    ...
    if ( (v10 & 2) == 0 || dword_140C6997C == v18 )
    {
      v22 = v64;
    }
    else if ( (v10 & 1) != 0 )
    ...
    if ( !v60 )
    {
      _InterlockedExchangeAdd(&dword_140C69AD0, v14);
      v17 = (unsigned int *)P;
      v8 = v62;
    }
    v24 = 0LL;
              ...
              if ( Image >= 0 )
              {
                ...
                if ( Image >= 0 )
                {
                  ...
                  if ( v63 )
                  {
                    ...
                    if ( (qword_140C69980 & 1) != 0 && (v17[49] & 0x400) == 0 )
                    {
                      RtlInitUnicodeString(&DestinationString, 0LL);
                      v53 = v17[39];
                      v68 = v17[30];
                      v60 = v53;
                      HotPatchRecord = MiFindHotPatchRecord((int)&xmmword_140C69930, 0, v68, v53, &DestinationString);
                      v55 = HotPatchRecord;
                      if ( HotPatchRecord >= 0 )
                      {
