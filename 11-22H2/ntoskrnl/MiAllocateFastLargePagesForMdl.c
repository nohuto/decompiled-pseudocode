/*
 * XREFs of MiAllocateFastLargePagesForMdl @ 0x140388FF4
 * Callers:
 ...
 *     MiTimeToWriteMemory @ 0x140351BD8 (MiTimeToWriteMemory.c)
 *     MiInsertDpcGang @ 0x1403892A0 (MiInsertDpcGang.c)
