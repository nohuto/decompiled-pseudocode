/*
 * XREFs of MiReturnImageBase @ 0x140721D10
 * Callers:
 ...
 * Callees:
 *     MiGetImageBitMapInfo @ 0x1402106F4 (MiGetImageBitMapInfo.c)
...
void __fastcall MiReturnImageBase(__int64 a1)
{
  ...
  if ( v1 != -1LL )
  {
    ...
    else
    {
      ...
      v4 = KeAbPreAcquire((__int64)&qword_140C65840, 0LL);
      v5 = _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65840, 0LL);
      v6 = v4;
      if ( v5 )
        ExfAcquirePushLockExclusiveEx(&qword_140C65840, v4, (__int64)&qword_140C65840);
      if ( v6 )
        *(_BYTE *)(v6 + 18) = 1;
      if ( *((_QWORD *)&v8 + 1) )
