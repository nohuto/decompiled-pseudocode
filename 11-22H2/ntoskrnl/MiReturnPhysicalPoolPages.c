/*
 * XREFs of MiReturnPhysicalPoolPages @ 0x14034000C
 * Callers:
...
__int64 __fastcall MiReturnPhysicalPoolPages(__int64 a1, unsigned int a2)
{
  ...
  v24 = 0LL;
  v30 = 0LL;
  v35 = *((_DWORD *)MiSearchNumaNodeTable(0xAAAAAAAAAAAAAAABuLL * ((a1 + 0x220000000000LL) >> 4)) + 2);
  v4 = 0LL;
  ...
  if ( v8 )
  {
    v11 = (_QWORD *)(qword_140C65BA0 + 376LL * v35);
