/*
 * XREFs of MiSharePages @ 0x1402161D0
 * Callers:
...
LABEL_69:
              ...
              if ( v36 == qword_140C69828 && (unsigned int)MiPageMightBeZero(v63, v27, v21) )
              {
                v75 = 0;
                while ( _interlockedbittestandset64((volatile signed __int32 *)(v27 + 24), 0x3FuLL) )
                {
