 ...
 *     MiLegacyImageArchitecture @ 0x14020EC88 (MiLegacyImageArchitecture.c)
 ...
 *     RtlGetFunctionOverrideRelocationMaxVpn @ 0x14067BDF4 (RtlGetFunctionOverrideRelocationMaxVpn.c)
    ...
    if ( (*(_BYTE *)(v14 + 62) & 0xC) != 4 || (Config = MiCreateFileOnlyImageFixupList(v14, v22, &P), Config >= 0) )
    {
      ...
      *(_DWORD *)(v14 + 92) |= 0x400000u;
      ...
      if ( (*(_DWORD *)(v14 + 92) & 0xC0000) == 0
        || (MiFlags & 0x2000) == 0
        || (qword_140C37A40
          ? (Config = qword_140C37A40(*(_QWORD *)(v38 + 40) & 0xFFFFFFFFFFFFFFF8uLL))
          : (Config = -1073741637),
            Config >= 0) )
      {
        if ( a4 )
