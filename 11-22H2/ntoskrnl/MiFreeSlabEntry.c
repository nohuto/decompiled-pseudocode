/*
 * XREFs of MiFreeSlabEntry @ 0x1403B8070
 * Callers:
...
void __fastcall MiFreeSlabEntry(__int64 a1, __int64 a2)
{
  ...
  if ( v6 <= v7 )
  {
    ...
    do
    {
      ...
      if ( !v4 )
        v4 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v8 + 16) >> 43) & 0x3FFLL));
      v10 = *(_DWORD *)(a1 + 80);
      if ( v10 <= 3 && v10 != 2 )
  ...
  v14 = *(_QWORD *)(v3 + 24) >> 9;
  v15 = v14 & 0x1F;
  v16 = (volatile signed __int32 *)(qword_140C6F430 + 4LL * (*(_QWORD *)(v3 + 24) >> 14));
