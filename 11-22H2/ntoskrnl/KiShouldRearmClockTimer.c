/*
 * XREFs of KiShouldRearmClockTimer @ 0x14034094C
 * Callers:
 ...
 *     KiGetClockTimerEarliestDeadline @ 0x140340A2C (KiGetClockTimerEarliestDeadline.c)
...
char __fastcall KiShouldRearmClockTimer(__int64 a1, char a2)
{
  ...
  if ( (unsigned int)dword_140C02F60 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)byte_14002D328,
      0LL,
      0LL,
      0xAu,
      &v25);
