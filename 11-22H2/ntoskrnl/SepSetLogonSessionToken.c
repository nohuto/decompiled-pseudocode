/*
 * XREFs of SepSetLogonSessionToken @ 0x1407E9FEC
 * Callers:
...
LONG_PTR __fastcall SepSetLogonSessionToken(__int64 a1)
{
  ...
  if ( !*(_QWORD *)(result + 48) )
  {
    ...
    if ( (result & 0x10) == 0 && (result & 8) == 0 )
    {
      ...
      v5[0] = 48;
      v10 = 0LL;
      result = SepDuplicateToken((__int128 *)a1, (__int64)v5, 0, 1, 0, 0, 0, (__int64 *)&Object);
      if ( (int)result >= 0 )
      {
        v3 = SepStopReferencingLogonSession(Object);
        v4 = Object;
        if ( v3 >= 0 )
        {
