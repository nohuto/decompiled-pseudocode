/*
 * XREFs of MiGetSlabPage @ 0x14023BD50
 * Callers:
...
__int64 __fastcall MiGetSlabPage(__int64 a1, unsigned int a2, unsigned int a3, __int64 SchedulerAssist, __int64 *a5)
{
  ...
  signed __int32 v86; // [rsp+20h] [rbp-68h]
  signed __int32 v87; // [rsp+24h] [rbp-64h]
  __int64 v88; // [rsp+30h] [rbp-58h]
  __int64 v89; // [rsp+38h] [rbp-50h]
  unsigned int *v90; // [rsp+40h] [rbp-48h]
  unsigned __int64 v91; // [rsp+48h] [rbp-40h]
  void *retaddr; // [rsp+88h] [rbp+0h]
  unsigned int v95; // [rsp+A8h] [rbp+20h]
  ...
  if ( a2 > 3 && *(_BYTE *)((int)a2 + a1 + 16200) && (SchedulerAssist & 4) == 0 )
    return -1LL;
  v10 = a3 >> byte_140C65B8D;
  while ( 1 )
  {
    v11 = (unsigned int *)(qword_140C65B98 + 4LL * v10 * (unsigned __int16)KeNumberNodes);
    v90 = v11;
...
LABEL_9:
  ...
  else
  {
    _m_prefetchw(v16);
    v85 = *v16 & 0x7FFFFFFF;
    v87 = _InterlockedCompareExchange(v16, v85 + 1, v85);
    if ( v87 != v85 )
    {
      while ( v87 >= 0 )
      {
        v86 = v87;
        v87 = _InterlockedCompareExchange(v16, v87 + 1, v87);
        if ( v87 == v86 )
          goto LABEL_14;
      }
...
LABEL_23:
  ...
  if ( SlabStandbyPage != -1 )
  {
    ...
    if ( (v95 & 0x10) != 0 && MiPfnZeroingNeeded(48 * SlabStandbyPage - 0x220000000000LL) )
    {
      MiZeroPhysicalPage(v28, SlabStandbyPage, 0LL, v27);
      *(_QWORD *)(v25 + 16) &= 0xFFFFFFFFFFFFFC1FuLL;
    }
    if ( (v95 & 8) != 0 && (*(_BYTE *)(v25 + 34) & 0xC0) != 0x40 )
      MiChangePageAttribute(48 * SlabStandbyPage - 0x220000000000LL, 1LL, 8LL);
