/*
 * XREFs of MiCreateSystemPageTable @ 0x1402E4410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiCreateSystemPageTable(__int64 a1, unsigned __int64 a2, int a3)
{
  ...
  PageTablePages = MiGetPageTablePages(v3, 1uLL, v5 == 0, &v12);
  if ( PageTablePages < 0 )
  {
  ...
  else
  {
    ...
    if ( (MiFlags & 0x80u) != 0LL && (++dword_140C68060 & MmPageValidationFrequency) == 0 )
      MiArePageContentsZero(0xAAAAAAAAAAAAAAABuLL * ((v12 + 0x220000000000LL) >> 4));
