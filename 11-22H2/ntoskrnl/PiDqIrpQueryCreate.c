/*
 * XREFs of PiDqIrpQueryCreate @ 0x1407F97F8
 * Callers:
 ...
 *     IoClearActivityIdThread @ 0x14031E4B0 (IoClearActivityIdThread.c)
 ...
 *     PiDqQueryGetNextIoctlInfo @ 0x1407FAA4C (PiDqQueryGetNextIoctlInfo.c)
 *     PnpConvertDevpropcompkeyArrayToString @ 0x1409588DC (PnpConvertDevpropcompkeyArrayToString.c)
 *     PiDqConvertObjectTypeToString @ 0x14095C09C (PiDqConvertObjectTypeToString.c)
 *     PiDqConvertQueryFlagsToString @ 0x14095C164 (PiDqConvertQueryFlagsToString.c)
 *     FilterConvertToString @ 0x140A6EDC8 (FilterConvertToString.c)
...
__int64 __fastcall PiDqIrpQueryCreate(_QWORD *a1)
{
  ...
  if ( ValidateQueryData < 0 )
    goto LABEL_13;
  NdrMesTypeDecode3(*(_QWORD *)(v3 + 16), "TP 3\a", &off_140002910, &off_140C02F40, 0, v3 + 24);
