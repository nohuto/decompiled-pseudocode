/*
 * XREFs of HalpIrtInitializeDeviceApertures @ 0x140934A94
 * Callers:
...
__int64 HalpIrtInitializeDeviceApertures()
{
  ...
  v1 = 0;
  qword_140C60E78 = (__int64)&HalpIrtAllocatedDeviceAperturesHead;
  HalpIrtAllocatedDeviceAperturesHead = (__int64)&HalpIrtAllocatedDeviceAperturesHead;
  qword_140C610A8 = (__int64)&HalpIrtFreeDeviceAperturesHead;
