/*
 * XREFs of MiLockCode @ 0x140282210
 * Callers:
...
LABEL_61:
      ...
      v28 = 0LL;
      v29 = *(_QWORD *)(qword_140C674C8 + 8 * (((unsigned __int64)v27 >> 43) & 0x3FF));
      v69 = v29;
      ...
      if ( DriverPage != -1 )
      {
        ...
        if ( v29 == *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v50 + 40) >> 43) & 0x3FFLL)) )
        {
          v33 = DriverPage;
          v34 = a4 & 2;
          v37 = v69;
