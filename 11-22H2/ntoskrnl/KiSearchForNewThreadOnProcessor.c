/*
 * XREFs of KiSearchForNewThreadOnProcessor @ 0x140240C70
 * Callers:
 *     KiSearchForNewThread @ 0x140240330 (KiSearchForNewThread.c)
 *     KiSearchForNewThreadOnSubNode @ 0x14057E83C (KiSearchForNewThreadOnSubNode.c)
 * Callees:
 ...
 *     KiMayStealStandbyThread @ 0x140241EC0 (KiMayStealStandbyThread.c)
