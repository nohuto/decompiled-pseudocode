/*
 * XREFs of MiLockDriverMappings @ 0x14020B4F8
 * Callers:
...
unsigned __int64 __fastcall MiLockDriverMappings(__int64 a1)
{
  ...
  if ( CurrentThread->AbEntrySummary || (result = KiAbTryReclaimOrphanedEntries(a1, CurrentThread), (_DWORD)result) )
  {
    ...
    if ( (unsigned __int64)&qword_140C65A38 - qword_140C65AE8 < 0x8000000000LL )
      SessionId = MmGetSessionIdEx(CurrentThread->ApcState.Process);
    else
      SessionId = -1;
    *(_DWORD *)(v2 + 8) = SessionId;
    result = (unsigned __int64)&qword_140C65A38 & 0x7FFFFFFFFFFFFFFCLL;
    *(_QWORD *)v2 = (unsigned __int64)&qword_140C65A38 & 0x7FFFFFFFFFFFFFFCLL;
  }
  if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C65A38, 0LL) )
    result = ExfAcquirePushLockExclusiveEx(&qword_140C65A38, v2, &qword_140C65A38);
  if ( v2 )
    *(_BYTE *)(v2 + 18) = 1;
  return result;
}
