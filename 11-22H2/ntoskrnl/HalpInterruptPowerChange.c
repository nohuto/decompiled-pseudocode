/*
 * XREFs of HalpInterruptPowerChange @ 0x14051A894
 * Callers:
 *     HalpInterruptPowerComponentActiveCallback @ 0x14051A930 (HalpInterruptPowerComponentActiveCallback.c)
 *     HalpInterruptPowerComponentIdleCallback @ 0x14051A950 (HalpInterruptPowerComponentIdleCallback.c)
 *     HalpInterruptPowerCriticalTransitionCallback @ 0x14051A990 (HalpInterruptPowerCriticalTransitionCallback.c)
 * Callees:
