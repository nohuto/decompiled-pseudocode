/*
 * XREFs of RtlpHpSegPageRangeAllocate @ 0x14024DCD0
 * Callers:
 ...
 *     RtlpHpSegHeapAddSegment @ 0x14035550C (RtlpHpSegHeapAddSegment.c)
 *     RtlpHpSegLargeRangeAllocate @ 0x1403C43E8 (RtlpHpSegLargeRangeAllocate.c)
    ...
    if ( (*(_DWORD *)(a1 + 40) & 1) != 0 )
    {
      ...
      else
      {
        ...
        if ( _interlockedbittestandset((volatile signed __int32 *)(a1 + 64), 0x1Fu) )
          v54 = ExpWaitForSpinLockExclusiveAndAcquire((int *)(a1 + 64), CurrentIrql);
