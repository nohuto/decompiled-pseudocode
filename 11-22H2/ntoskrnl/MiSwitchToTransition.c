/*
 * XREFs of MiSwitchToTransition @ 0x1406331FC
 * Callers:
 ...
 *     ExAcquireRundownProtectionCacheAware @ 0x140328D20 (ExAcquireRundownProtectionCacheAware.c)
...
__int64 __fastcall MiSwitchToTransition(ULONG_PTR a1, __int64 a2, unsigned int a3)
{
  ...
  v7 = 0x3FFFFFFFFFLL;
  v8 = 0LL;
  v9 = *(void **)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(v66 + 174));
  v63 = (__int64)v9;
...
LABEL_18:
    ...
    if ( v23 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * v23 - 0x21FFFFFFFFD8LL), 0x36u) )
      goto LABEL_36;
