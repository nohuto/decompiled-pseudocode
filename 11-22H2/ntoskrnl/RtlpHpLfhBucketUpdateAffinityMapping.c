/*
 * XREFs of RtlpHpLfhBucketUpdateAffinityMapping @ 0x140349CE8
 * Callers:
 ...
 *     KeGetCurrentProcessorNumberEx @ 0x1403262D0 (KeGetCurrentProcessorNumberEx.c)
...
void __fastcall RtlpHpLfhBucketUpdateAffinityMapping(__int64 a1, __int64 a2)
{
  ...
  v11 = RtlpHpAcquireLockExclusive((volatile LONG *)(a2 + 80), *(unsigned __int8 *)(a1 + 57));
...
LABEL_16:
  ...
  if ( *(_BYTE *)(a1 + 57) )
  {
    ...
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v27 <= 0xFu && (unsigned __int8)v13 <= 0xFu && v27 >= 2u )
      {
