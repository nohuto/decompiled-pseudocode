/*
 * XREFs of PopInvokeSystemStateHandler @ 0x140AA865C
 * Callers:
 ...
 *     KeResumeDynamicTracing @ 0x14057ECE8 (KeResumeDynamicTracing.c)
 *     KeSuspendDynamicTracing @ 0x14057ECF8 (KeSuspendDynamicTracing.c)
...
__int64 __fastcall PopInvokeSystemStateHandler(int a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    qword_140D185E8 = DeferredContext[1];
    qword_140D185F0 = DeferredContext[2];
    qword_140D185F8 = DeferredContext[3];
    qword_140D18600 = DeferredContext[4];
    dword_140D18608 = DeferredContext[5];
    byte_140D1860C = BYTE4(DeferredContext[5]);
    dword_140D18610 = DeferredContext[6];
    qword_140D18618 = DeferredContext[7];
    RtlpInterlockedPushEntrySList(&stru_140D18620, &v36[9]);
  }
  else
  {
  ...
  if ( (xmmword_140D1EAD0 & 0x8000) != 0 )
  {
    ...
    v35[1] = v14;
    v32 = 16;
    EtwTraceKernelEvent((int)&v31, 1, 0x80008000, 4656, 4200450);
  }
  ...
  if ( *((int *)&v36[7].Next + 2) >= 0 )
  {
    *((_BYTE *)v12 + 44) = 1;
    ...
    if ( a2 )
    {
      ...
      MmInvalidateDumpAddresses(qword_140C3D028, 19LL);
      v16 = *(_QWORD *)(a2 + 304);
      if ( v16 )
  ...
  if ( a2 )
  {
    if ( v5 == -1073741632 )
    {
      ...
      *(_BYTE *)a2 = 1;
LABEL_71:
      v18 = qword_140C3DA80 == 0;
      *v12 = (__int64)&unk_140C3DA78;
      v12[3] = 0LL;
      if ( !v18 )
        PopIssueNextState(v12, v36, 6LL);
  ...
  if ( v5 >= 0 )
  {
    if ( dword_140C3CE40 != 4 || PoResumeFromHibernate )
    {
      v19 = 0;
      v26 = KeQueryPerformanceCounter(0LL);
      qword_140C3D488 = *(_QWORD *)&KeQueryPerformanceCounter(0LL) - qword_140C39450;
    }
    else
    {
      v19 = 1;
    ...
    if ( (xmmword_140D1EAD0 & 0x8000) != 0 )
    {
      ...
      v34[1] = 8LL;
      v34[0] = &v28;
      EtwTraceKernelEvent((int)v34, 1, 0x80008000, 4657, 4200450);
    }
    if ( v19 )
    {
      v26.QuadPart = v26.QuadPart / (1000 * (unsigned __int64)KeGetCurrentPrcb()->MHz) * (PopQpcFrequency / 0x3E8);
      qword_140C3D368 = v26.QuadPart - PerformanceCounter.QuadPart;
    }
  }
  ...
  if ( a2 )
  {
    if ( v5 == 1073742484 && !byte_140C3D041 && byte_140D17FB8 )
      BgLibraryInitialize(qword_140D18490, 0LL);
  }
  else
  {
