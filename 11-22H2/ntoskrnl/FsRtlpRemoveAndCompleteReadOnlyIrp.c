/*
 * XREFs of FsRtlpRemoveAndCompleteReadOnlyIrp @ 0x14053ED0C
 * Callers:
...
void __fastcall FsRtlpRemoveAndCompleteReadOnlyIrp(_QWORD *a1, int a2, unsigned int a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v26 = 4LL;
    v28 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)byte_14002A328, 0LL, 0LL, 6u, v20);
  }
  v9 = (IRP *)(a1 - 21);
  v10 = a1[2];
  ...
  *(_QWORD *)(v11 + 8) = v12;
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v24 = 8LL;
    v26 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)word_14002A13A, 0LL, 0LL, 5u, v20);
  }
}
