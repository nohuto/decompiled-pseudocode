        ...
        char *a11)
{
  ...
  if ( (unsigned int)dword_140C03768 > 5 && (unsigned __int8)tlgKeywordOn(&dword_140C03768, 0LL) )
  {
    ...
    v75 = &v42;
    v76 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(&dword_140C03768, &word_14002A19E, 0LL, 0LL, 5, v70);
  }
  v15 = 1;
  v16 = &v35;
  if ( v14 )
...
LABEL_53:
  if ( v15 )
  {
    if ( (unsigned int)dword_140C03768 > 5 && (unsigned __int8)tlgKeywordOn(&dword_140C03768, 0LL) )
    {
      ...
      v61 = &v38;
      v62 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(&dword_140C03768, byte_14002A04B, 0LL, 0LL, 6, v54);
    }
    ExReleaseFastMutexUnsafe(*(PFAST_MUTEX *)(a1 + 152));
  }
  else if ( (unsigned int)dword_140C03768 > 5 && (unsigned __int8)tlgKeywordOn(&dword_140C03768, 0LL) )
  {
    ...
    v68 = &v45;
    v69 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer(&dword_140C03768, byte_140029FF9, 0LL, 0LL, 5, v63);
  }
  return v25;
}
