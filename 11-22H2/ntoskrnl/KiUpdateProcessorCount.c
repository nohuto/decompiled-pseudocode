/*
 * XREFs of KiUpdateProcessorCount @ 0x140A894FC
 * Callers:
 *     KiUpdateNumberProcessorsIpi @ 0x140A9F640 (KiUpdateNumberProcessorsIpi.c)
 *     KeStartAllProcessors @ 0x140B4AC90 (KeStartAllProcessors.c)
 * Callees:
 *     KeAddProcessorAffinityEx @ 0x140257280 (KeAddProcessorAffinityEx.c)
 *     KiGetCurrentGroupCount @ 0x14036EB24 (KiGetCurrentGroupCount.c)
