/*
 * XREFs of MiWritePteHighLevelIsr @ 0x14064E500
 * Callers:
 *     <none>
 * Callees:
...
ULONG_PTR __fastcall MiWritePteHighLevelIsr(ULONG_PTR Argument)
{
  ...
  *v16 = *(_DWORD *)(Argument + 36) | v18;
  ...
  if ( qword_140C685E8 )
  {
    ValidPte = MiMakeValidPte(v2, *(_QWORD *)(Argument + 24), 2684354564LL);
...
LABEL_55:
    *v34 = v1;
    ...
    v38 = (unsigned __int64 *)qword_140C685E8;
    if ( !qword_140C685E8 )
      goto LABEL_67;
    v39 = ZeroPte;
    v40 = 0;
    if ( MiPteInShadowRange(qword_140C685E8) )
    {
      if ( MiPteHasShadow() )
      {
        v40 = 1;
