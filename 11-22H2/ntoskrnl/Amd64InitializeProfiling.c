/*
 * XREFs of Amd64InitializeProfiling @ 0x140A98840
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Amd64GetGenericPerfEvent @ 0x1405295DC (Amd64GetGenericPerfEvent.c)
 */
...
__int64 Amd64InitializeProfiling()
{
  ...
  if ( !Number )
  {
    ...
    if ( (v9 & 0x1000000) != 0 && (v9 & 0x400000) != 0 )
    {
      ...
      qword_140C5FF38 = (__int64)&Amd64DataFabricStatusHead;
    ...
    if ( (v9 & 0x10000000) != 0 && (v9 & 0x400000) != 0 )
    {
      ...
      qword_140C5FFE8 = (__int64)&Amd64CacheStatusHead;
    ...
    qword_140C60010 = (__int64)&DummyAmd64CounterStatus;
    ...
    qword_140C63208 = (__int64)&HalpProfileSourceDescriptorListHead;
    v48 = 0;
    ...
    do
    {
      ...
      if ( !v50 )
      {
        v52 = (__int64 *)qword_140C63208;
        v53 = (__int64 **)((char *)&unk_140C00328 + v49);
        if ( *(__int64 **)qword_140C63208 != v47 )
          __fastfail(3u);
        ++HalpProfileSourceDescriptorCount;
        *v53 = v47;
        v53[1] = v52;
        *v52 = (__int64)v53;
        qword_140C63208 = (__int64)&unk_140C00328 + v49;
      }
      ++v48;
    }
    while ( v48 < 0x12 );
