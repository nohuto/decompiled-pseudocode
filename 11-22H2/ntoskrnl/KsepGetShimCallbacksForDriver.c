/*
 * XREFs of KsepGetShimCallbacksForDriver @ 0x140693B60
 * Callers:
...
__int64 __fastcall KsepGetShimCallbacksForDriver(__int64 a1, _QWORD *a2)
{
  ...
  if ( !a2 )
  {
    ...
    dword_140C40844[2 * v19] = -1073740768;
    ...
    while ( 1 )
    {
      if ( (*(_DWORD *)(*(_QWORD *)v8 + 28LL) & 4) == 0 )
      {
        ...
        if ( !v10 )
        {
          ...
          dword_140C40844[2 * v20] = -1073740768;
      ...
      switch ( *(_DWORD *)(v16 + v17 + 8) )
      {
        ...
        default:
          ...
          if ( (unsigned int)v18 > 0x1B )
          {
            ...
            dword_140C40844[2 * v22] = -1073741811;
...
LABEL_48:
            dword_140C40844[2 * v21] = -1073741823;
            if ( (KsepDebugFlag & 2) != 0 )
