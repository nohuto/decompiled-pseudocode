/*
 * XREFs of CmpLoadKeyCommon @ 0x1402F659C
 * Callers:
 ...
 *     CmpSetGlobalQuotaAllowed @ 0x1407EB550 (CmpSetGlobalQuotaAllowed.c)
...
LABEL_30:
  ...
  *((_QWORD *)P + 202) = v24;
  *v24 = v25;
  qword_140D54CA0 = (__int64)(P + 1608);
  CmpUnlockHiveList();
  CmpUnlockRegistry();
  CmpAttachToRegistryProcess(v38);
