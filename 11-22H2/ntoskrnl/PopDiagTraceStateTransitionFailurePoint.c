/*
 * XREFs of PopDiagTraceStateTransitionFailurePoint @ 0x140991B54
 * Callers:
...
char __fastcall PopDiagTraceStateTransitionFailurePoint(int a1, int a2)
{
  ...
  if ( dword_140C03950 )
  {
    LOBYTE(v2) = tlgKeywordOn((__int64)&dword_140C03950, 0x800000000000LL);
    if ( (_BYTE)v2 )
    {
      if ( v7 > 5 )
      {
        ...
        if ( (_BYTE)v2 )
        {
          ...
          v16 = 0x1000000LL;
          v35 = 8;
          LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(v9, (unsigned __int8 *)&dword_14002DCCC, 0LL, 0LL, 6u, &v24);
        }
      }
    }
  }
