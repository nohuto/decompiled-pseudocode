...
LABEL_12:
      ...
      else
      {
        if ( v4 )
        {
          v44 = *(_QWORD *)(qword_140C674C8 + 8 * (((unsigned __int64)v7[5] >> 43) & 0x3FF));
...
LABEL_36:
  ...
  if ( v16 && (v64 & 1) == 0 )
  {
    _InterlockedExchangeAdd64(&qword_140C6F4B8, v16);
    if ( v16 <= 0x40 )
    {
      result = &dword_140C6F4C0;
      _InterlockedIncrement(&dword_140C6F4C0);
    }
    else if ( v16 <= 0x80 )
    {
      result = &dword_140C6F4C4;
      _InterlockedIncrement(&dword_140C6F4C4);
    }
    else
    {
      result = (volatile signed __int32 *)&unk_140C6F4CC;
      if ( v16 <= 0x200 )
        result = (volatile signed __int32 *)&unk_140C6F4C8;
