/*
 * XREFs of PpmPerfInitialize @ 0x140B65ECC
 * Callers:
...
__int64 PpmPerfInitialize()
{
  ...
  stru_140C3EA90.Parameter = 0LL;
  stru_140C3EA90.List.Flink = 0LL;
  ...
  stru_140C3EA90.WorkerRoutine = (void (__fastcall *)(void *))PpmMediaBufferingWorker;
