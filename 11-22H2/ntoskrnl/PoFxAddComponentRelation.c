/*
 * XREFs of PoFxAddComponentRelation @ 0x140587700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PoFxAddComponentRelation(ULONG_PTR BugCheckParameter2, unsigned int a2, __int64 a3, _QWORD *a4)
{
  ...
  volatile signed __int64 *v47; // [rsp+70h] [rbp+8h]
  ...
  if ( v23 )
  {
    ...
    else
    {
      ...
      if ( Pool2 )
      {
        ...
        *v29 = v29;
        v27[6] = v44 + 128;
        PopFxActivateComponent(v10, (__int64)v23, 1LL, 0);
        PopFxActivateComponent(BugCheckParameter2, v44, 1LL, 0);
        v46 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v44 + 128));
        v30 = *(_QWORD **)(v44 + 464);
        if ( *v30 != v44 + 456 )
          goto LABEL_58;
        *v28 = v44 + 456;
