 ...
 *     MI_IS_PTE_IN_WS_SWAP_SET @ 0x14034EF14 (MI_IS_PTE_IN_WS_SWAP_SET.c)
 */
...
__int64 __fastcall MiWriteCompletePfn(ULONG_PTR BugCheckParameter2, char a2)
{
  ...
  else if ( (a2 & 2) != 0 )
  {
    ...
    v9 = MI_IS_PTE_IN_WS_SWAP_SET(
           *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 43) & 0x3FFLL)),
  ...
  *(_BYTE *)(BugCheckParameter2 + 34) &= ~8u;
  ...
  if ( (*(_WORD *)(BugCheckParameter2 + 32))-- == 1 )
  {
    ...
    {
      MiReturnCommit(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 43) & 0x3FFLL)), 1LL);
    }
    if ( (a2 & 4) != 0 )
    {
      MiRestoreTransitionPte(BugCheckParameter2);
      MiInsertPageInFreeOrZeroedList(0xAAAAAAAAAAAAAAABuLL * ((__int64)(BugCheckParameter2 + 0x220000000000LL) >> 4), 2);
    }
    else
    {
