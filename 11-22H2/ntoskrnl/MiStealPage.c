/*
 * XREFs of MiStealPage @ 0x1403BBD7C
 * Callers:
 ...
 *     MiVaIsPageFileHash @ 0x1403BBD20 (MiVaIsPageFileHash.c)
        ...
        ULONG_PTR *a6)
{
  ...
  v142 = 0LL;
  v19 = *(_QWORD *)(qword_140C674C8 + 8 * v18);
  v138 = v19;
  if ( LeafVa < 0xFFFF800000000000uLL )
    goto LABEL_15;
  if ( LeafVa >= qword_140C6A658 && LeafVa <= qword_140C67170 )
  {
    v20 = v16 | 8;
    LODWORD(v154[1]) = v20;
    if ( (v20 & 1) != 0 )
    {
      v16 = v20 | 2;
      if ( v11 >= qword_140C67168 && v11 < qword_140C67168 + MiHyperSpaceSize() )
        v16 |= 0x100u;
    }
    else
    {
...
LABEL_53:
      ...
      if ( a5 == -1 )
      {
        v36 = *((_DWORD *)MiSearchNumaNodeTable(0xAAAAAAAAAAAAAAABuLL * ((__int64)(BugCheckParameter2 + 0x220000000000LL) >> 4))
              + 2);
        v35 = ((unsigned int)MiGetPfnChannel(BugCheckParameter2) << byte_140C65B8E) | dword_140C65BF8 & v17 | (v36 << byte_140C65B8D);
        v34 = (a3 >> 8) & 0x10000;
        if ( (a3 & 0x2000000) != 0 )
          v34 |= 0x20000u;
      }
      ...
      {
        v33 = dword_140C65BF8 & v17;
        v34 = 48;
        v35 = v33 | a5 & ~dword_140C65BF8;
      }
      v31 = -1LL;
      if ( v155 == -1LL )
      {
...
LABEL_55:
      ...
      if ( (*(_BYTE *)(BugCheckParameter2 + 34) & 7) != 6
        || v138 != *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 43) & 0x3FFLL)) )
      {
        _InterlockedAnd64((volatile signed __int64 *)(BugCheckParameter2 + 24), 0x7FFFFFFFFFFFFFFFuLL);
        if ( (_DWORD)KiIrqlFlags )
        {
            ...
            if ( (v42 & 0x42) != 0 )
            {
              ...
              if ( v84 )
                MiReleasePageFileInfo(
                  *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v83 + 40) >> 43) & 0x3FFLL)),
                  v84,
                  1);
              v145 = 0;
...
LABEL_18:
  ++dword_140C136C8;
  dword_140C136CC = -1431655765 * ((__int64)(BugCheckParameter2 + 0x220000000000LL) >> 4);
  MiLockPageInline(BugCheckParameter2);
  if ( (*(_QWORD *)(BugCheckParameter2 + 24) & 0x4000000000000000LL) != 0 )
    return 0;
  return v21;
