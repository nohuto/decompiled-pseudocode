/*
 * XREFs of MiCheckControlArea @ 0x14029FAA0
 * Callers:
...
__int64 __fastcall MiCheckControlArea(__int64 a1, unsigned __int8 a2)
{
  ...
  inserted = 0LL;
  v30 = 0LL;
  v10 = *(_QWORD *)(qword_140C674C8 + 8LL * (v6 & 0x3FF));
...
LABEL_16:
      ...
      if ( qword_140C6F9A8 >= 9 * (qword_140C6FA98 / 0xAuLL) )
      {
        if ( (unsigned int)MiShouldTrimUnusedSegments(qword_140C6FA98, qword_140C6FA98 / 0xAuLL, qword_140C6F9A8) )
        {
