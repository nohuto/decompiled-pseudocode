/*
 * XREFs of MiSwapStackPage @ 0x140399C4C
 * Callers:
...
LABEL_22:
  ...
  if ( a3 == -1 )
  {
    ...
    v19 = ((unsigned int)MiGetPfnChannel(a2) << byte_140C65B8E) | dword_140C65BF8 & v17 | (v18 << byte_140C65B8D);
  ...
  {
    v20 = 560;
    v19 = dword_140C65BF8 & v17 | a3 & ~dword_140C65BF8;
  }
  ...
  if ( *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(a2 + 40) >> 43) & 0x3FFLL)) != a1
    || v11 != (*(_QWORD *)(a2 + 8) | 0x8000000000000000uLL)
...
LABEL_64:
  ...
  if ( (byte_140C65B8F & 1) == 0 || !(unsigned int)MiSwapStackPageNoDpc(a2, v23) )
  {
