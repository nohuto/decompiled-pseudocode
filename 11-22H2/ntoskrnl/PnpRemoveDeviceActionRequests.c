/*
 * XREFs of PnpRemoveDeviceActionRequests @ 0x1403D5EE0
 * Callers:
    ...
    do
    {
      ...
      if ( *(_QWORD *)(v3 + 16) == a1 )
      {
        ...
        *v7 = v5;
        ...
        v11 = KeAcquireSpinLockRaiseToDpc(&qword_140C3F3E8);
        v12 = dword_140C3F3F0-- == 1;
        v13 = v11;
        if ( v12 )
        ...
        __writecr8(v13);
        v18 = KeAcquireSpinLockRaiseToDpc(&qword_140C38EF0);
