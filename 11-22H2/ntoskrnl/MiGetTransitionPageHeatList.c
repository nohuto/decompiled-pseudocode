/*
 * XREFs of MiGetTransitionPageHeatList @ 0x140653F4C
 * Callers:
...
PSLIST_ENTRY MiGetTransitionPageHeatList()
{
  ...
  result = RtlpInterlockedPopEntrySList(&stru_140C683E0);
  v1 = result;
  if ( result )
  {
  ...
  else
  {
    ...
    {
      v3 = v2;
      v2 = _InterlockedCompareExchange(&dword_140C683F0, v2 - 1, v2);
      if ( v3 == v2 )
        return v1;
    }
