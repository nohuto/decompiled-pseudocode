/*
 * XREFs of PfSnGetSectionObject @ 0x14075CEB0
 * Callers:
 ...
 *     PfSnIsSectionPrefetchedAfterPhase @ 0x14075D254 (PfSnIsSectionPrefetchedAfterPhase.c)
  ...
  if ( !_bittest64((const signed __int64 *)(v18 + 24), 0x22u) )
  {
    ...
    if ( v19 < 0
      || (v19 = PfpFileCheckAttributesForPrefetch(
                  ...
                  (((dword_140C65080 & 0x10) == 0) << 14) + 4864),
          v19 < 0) )
    {
      v12 = v36.m256i_i64[3];
      goto LABEL_34;
