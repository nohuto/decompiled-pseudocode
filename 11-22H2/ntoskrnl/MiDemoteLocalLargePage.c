...
__int64 __fastcall MiDemoteLocalLargePage(__int64 a1, unsigned int a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( (unsigned int)MmNumberOfChannels > 1 )
    v8 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_140C65B8E);
  v9 = a2 >> byte_140C65B8D;
  v10 = 25408LL * (a2 >> byte_140C65B8D) + *(_QWORD *)(a1 + 16);
  v11 = (a2 & ~dword_140C65BF8) << 12;
  v41 = v11;
  v43 = 25408LL * (a2 >> byte_140C65B8D);
  v42 = v10;
  v12 = a3 & 0x800;
  if ( (a3 & 0x800) != 0 )
  {
...
LABEL_14:
  ...
  while ( 1 )
  {
    v19 = MiUnlinkNodeLargePages(a1, v11, v16, 1LL, v9, v8, v14, v17, 0LL);
    if ( v19 )
      goto LABEL_17;
    if ( v16 != v40 )
    {
