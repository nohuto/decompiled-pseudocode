/*
 * XREFs of PfpLogPageAccess @ 0x14074B830
 * Callers:
...
unsigned __int64 __fastcall PfpLogPageAccess(__int64 a1, _DWORD *a2, _BYTE *a3, __int64 a4, int a5)
{
  ...
  {
    v13 = qword_140C65298;
    v14 = *(unsigned int *)(qword_140C65298 + 16);
    v15 = (qword_140C65298 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
    if ( *(_QWORD *)(v15 + 40 * v14) == v11 )
    {
      v16 = (_DWORD *)(qword_140C65298 + 32);
    }
    else
    {
      v16 = (_DWORD *)(qword_140C65298 + 32);
      v56 = *(_DWORD *)(qword_140C65298 + 32);
...
LABEL_50:
    ...
    if ( v48 < 3 * (*v16 >> 2) )
      break;
    if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C65280) == -1073741823 )
      return v5;
  }
  v12 = 1;
  *(_DWORD *)(v13 + 28) = v48 + 1;
...
LABEL_12:
    ...
    {
      v20 = qword_140C65298;
      v21 = *(unsigned int *)(qword_140C65298 + v19);
      v22 = (qword_140C65298 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
      if ( *(_QWORD *)(v22 + 40 * v21) == v18 )
      {
        v23 = (_DWORD *)(qword_140C65298 + 32);
        goto LABEL_15;
      }
      v23 = (_DWORD *)(qword_140C65298 + 32);
      v58 = *(_DWORD *)(qword_140C65298 + 32);
      v44 = (HIBYTE(v18)
           + 37
           * (BYTE6(v18)
            + 37
      ...
      if ( v45 == v18 )
      {
        *(_DWORD *)(qword_140C65298 + v19) = v44;
...
LABEL_77:
        ...
        while ( 1 )
        {
          ...
          if ( v52 == v18 )
          {
            *(_DWORD *)(qword_140C65298 + v19) = v50;
            LOWORD(v21) = v50;
            goto LABEL_15;
          }
          if ( !v52 )
...
LABEL_21:
  v28 = qword_140C65270;
  v29 = ((*a3 & 3) == 2) + 1;
  if ( (unsigned int)(v29 + *(_DWORD *)(qword_140C65270 + 16)) > *(_DWORD *)(qword_140C65270 + 20) )
  {
    while ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C65258) != -1073741823 )
    {
      v28 = qword_140C65270;
      if ( (unsigned int)(v29 + *(_DWORD *)(qword_140C65270 + 16)) <= *(_DWORD *)(qword_140C65270 + 20) )
        goto LABEL_22;
