/*
 * XREFs of MiMirrorPerformBrownWrites @ 0x140627698
 * Callers:
...
__int64 __fastcall MiMirrorPerformBrownWrites(__int64 a1, char a2, _QWORD *a3)
{
  ...
  while ( 1 )
  {
    v8 = v5 & -(__int64)(v5 < (unsigned __int64)xmmword_140C67F90);
    for ( i = xmmword_140C67F90 - 1; ; i = v13 - 1 )
    {
      if ( i - v8 == -1LL )
      {
        v10 = -1LL;
      ...
      {
        v11 = (_QWORD *)(*((_QWORD *)&xmmword_140C67F90 + 1) + 8 * (v8 >> 6));
        for ( j = ((1LL << (v8 & 0x3F)) - 1) | ~*v11; j == -1; j = ~*v11 )
        {
          if ( (unsigned __int64)++v11 > *((_QWORD *)&xmmword_140C67F90 + 1) + 8 * (i >> 6) )
            goto LABEL_15;
        }
        _BitScanForward64((unsigned __int64 *)&j, ~j);
        v10 = j + (((__int64)v11 - *((_QWORD *)&xmmword_140C67F90 + 1)) >> 3 << 6);
        if ( v10 > i )
        {
LABEL_15:
          v10 = -1LL;
...
LABEL_11:
      ...
      v13 = v5 + 1;
      v8 = 0LL;
      if ( v5 + 1 > (unsigned __int64)xmmword_140C67F90 )
        v13 = xmmword_140C67F90;
    }
    if ( v10 < v5 || v10 == -1LL )
      goto LABEL_127;
    v14 = xmmword_140C67F90;
    v15 = 0LL;
    if ( (unsigned __int64)xmmword_140C67F90 <= v10 )
    {
      v16 = 0LL;
LABEL_37:
      v23 = v14;
    ...
    v17 = *((_QWORD *)&xmmword_140C67F90 + 1) + 8 * ((unsigned __int64)(xmmword_140C67F90 - 1) >> 6);
    v18 = (__int64 *)(*((_QWORD *)&xmmword_140C67F90 + 1) + 8 * (v10 >> 6));
    v19 = v18 + 1;
...
LABEL_26:
    ...
    v23 = (unsigned int)v22 + (((__int64)v18 - *((_QWORD *)&xmmword_140C67F90 + 1)) >> 3 << 6);
    v14 = xmmword_140C67F90;
    if ( v23 > (unsigned __int64)xmmword_140C67F90 )
      goto LABEL_26;
    v24 = ~(((1LL << v22) - 1) | v21);
    while ( !v24 )
    {
...
LABEL_33:
    v26 = v25 + (((__int64)v18 - *((_QWORD *)&xmmword_140C67F90 + 1)) >> 3 << 6);
    v14 = xmmword_140C67F90;
    if ( v26 > (unsigned __int64)xmmword_140C67F90 )
      v26 = xmmword_140C67F90;
    v15 = v26 - v23;
LABEL_36:
    v16 = v15;
    if ( !v15 )
...
LABEL_38:
    ...
    v29 = v10 & 0x1F;
    v30 = v27;
    v31 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67FA0 + 1) + 4 * (v10 >> 5));
    if ( v29 + v27 <= 0x20 )
    {
      if ( v27 == 32 )
      {
...
LABEL_126:
    v7 = v73;
    v3 = a2;
    if ( v5 >= (unsigned __int64)xmmword_140C67F90 )
      goto LABEL_127;
  }
  v5 = v10;
  v34 = 3 * v10;
  ...
  while ( 1 )
  {
    ...
    if ( v40 < 2u || v40 > 4u )
      goto LABEL_70;
    if ( (*(_DWORD *)(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v38 + 16) >> 43) & 0x3FFLL)) + 4LL) & 0x80u) != 0 )
    {
      LOBYTE(v41) = 1;
      v42 = v5 & 0x1F;
      v43 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67FA0 + 1) + 4 * (v5 >> 5));
      if ( v42 + 1 > 0x20 )
      {
        if ( (v5 & 0x1F) != 0 )
        {
...
LABEL_70:
    ...
    *(_QWORD *)v38 &= 0xC000000000000000uLL;
    ...
    v51 = v5 & 0x1F;
    LOBYTE(v52) = 1;
    v53 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67FA0 + 1) + 4 * (v5 >> 5));
    if ( v51 + 1 > 0x20 )
    {
      if ( (v5 & 0x1F) != 0 )
      {
