/*
 * XREFs of KiHeteroIdleSetReduction @ 0x1404616EC
 * Callers:
 *     KiHeteroSelectIdleProcessor @ 0x1404617F2 (KiHeteroSelectIdleProcessor.c)
 * Callees:
 *     KiIsQosGroupingActive @ 0x14034ECE8 (KiIsQosGroupingActive.c)
 *     KiHeteroReduceToMaximallyPreferredByClass @ 0x140577378 (KiHeteroReduceToMaximallyPreferredByClass.c)
 */
