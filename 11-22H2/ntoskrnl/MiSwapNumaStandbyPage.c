/*
 * XREFs of MiSwapNumaStandbyPage @ 0x140651E40
 * Callers:
...
ULONG_PTR __fastcall MiSwapNumaStandbyPage(ULONG_PTR BugCheckParameter3, unsigned int a2, int a3, char a4)
{
  ...
  v12 = *(_QWORD *)(qword_140C674C8 + 8 * v11);
  v13 = 0LL;
...
LABEL_55:
  ...
  if ( MiCanPageMove(48 * v26 - 0x220000000000LL) )
  {
    ...
    v48 = v26 & 0x1F;
    LOBYTE(v49) = 1;
    v50 = (volatile signed __int32 *)(*((_QWORD *)&xmmword_140C67FA0 + 1) + 4 * (v26 >> 5));
    if ( v48 + 1 > 0x20 )
    {
      if ( (v26 & 0x1F) != 0 )
      {
...
LABEL_111:
              ...
              *(_BYTE *)(v32 + 35) &= 0xF8u;
              ...
              if ( KiIrqlFlags )
              {
                ...
                if ( (KiIrqlFlags & 1) != 0 && v74 <= 0xFu && CurrentIrql <= 0xFu && v74 >= 2u )
                {
