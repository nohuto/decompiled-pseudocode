/*
 * XREFs of IoSetEnvironmentVariableEx @ 0x140950524
 * Callers:
...
__int64 __fastcall IoSetEnvironmentVariableEx(const size_t *a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  if ( (unsigned int)dword_140C038A8 > 5 && tlgKeywordOn((__int64)&dword_140C038A8, 0x200000000000LL) )
  {
    ...
    LODWORD(v15[0]) = v9;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C038A8, (unsigned __int8 *)byte_14002C5C5, 0LL, 0LL, 7u, &v16);
  }
