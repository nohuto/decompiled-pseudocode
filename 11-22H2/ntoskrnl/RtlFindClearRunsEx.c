/*
 * XREFs of RtlFindClearRunsEx @ 0x14031768C
 * Callers:
...
LABEL_8:
    ...
    v9 = v13 - v8 + 8;
    v17 = *((_BYTE *)qword_140016E50 - v8) | byte_140018F40[v15] | v14;
    if ( v17 != 0xFF )
    {
      do
      {
        ...
        v28 = *v26;
        v29 = 0;
        for ( j = byte_140018F40[v28]; ((unsigned __int8)j & v17) != 0; j *= 2 )
          ++v29;
        ++v7;
        if ( v27 )
          v7 = v27;
