/*
 * XREFs of IoGetDeviceDirectory @ 0x1409550C0
 * Callers:
...
LABEL_36:
              ...
              while ( 1 )
              {
                ...
                if ( (unsigned int)v18 > 0x7F || (*((_BYTE *)qword_1400173E0 + v18) & 1) == 0 )
                  break;
                v17 = ++v16;
                if ( v16 >= v15 )
                  goto LABEL_20;
            ...
            if ( (UnicodeString.Length & 0xFFFE) != 0 )
            {
              do
              {
                ...
                if ( (unsigned int)v22 > 0x7F )
                  goto LABEL_39;
                if ( (*((_BYTE *)qword_1400173E0 + v22) & 1) == 0 )
                {
                  UnicodeString.Buffer[v21] = (*((_BYTE *)qword_1400173E0 + v22) & 1) + 35;
                  Length = UnicodeString.Length;
                }
              }
