/*
 * XREFs of MiRebaseDynamicRelocationRegions @ 0x140B47664
 * Callers:
...
__int64 __fastcall MiRebaseDynamicRelocationRegions(__int64 a1)
{
  ...
  v4 = qword_140C6A5D8[0];
  v5 = qword_140C6A678;
  v23 = qword_140C6A5D8[0];
  if ( (MiFlags & 0x4000) == 0 && qword_140C6A678 == 0xFFFFF68000000000uLL )
    goto LABEL_18;
  v6 = ((unsigned __int64)qword_140C6A678 >> 39) & 0x1FF;
  v7 = 0;
