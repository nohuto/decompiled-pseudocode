/*
 * XREFs of AlpcpReceiveMessage @ 0x14073B350
 * Callers:
 ...
 *     AlpcpExposeCapturedContextAttribute @ 0x1407BABB8 (AlpcpExposeCapturedContextAttribute.c)
...
LABEL_63:
  if ( v33 )
    v34 = AlpcpReceiveDirectMessagePort(v8, v48, v47, (unsigned int)&BugCheckParameter2, v27);
  else
    v34 = AlpcpReceiveMessagePort(v8, v11, (_DWORD)a5, (unsigned int)&BugCheckParameter2, v27);
  v35 = v34;
  if ( !v34 )
  {
    ...
    if ( a3 && (v60 = v38, v38 > v50) )
    {
      ...
      v35 = AlpcpReturnMessageOnInsufficientBuffer(v51, BugCheckParameter2, v58);
      v54 = v35;
      if ( v35 == -1073741789 )
      {
        *a3 = v60;
        AlpcpExposeCapturedContextAttribute(v49, v58, v45, a4);
      }
    }
    else
    {
    ...
    {
      *(_QWORD *)(v36 + 200) = 0LL;
      AlpcpCancelMessage(v51, v36, 0x10000LL);
    }
  }
  return v35;
}
