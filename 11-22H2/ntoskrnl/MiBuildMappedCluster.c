/*
 * XREFs of MiBuildMappedCluster @ 0x14021C0F0
 * Callers:
...
__int64 __fastcall MiBuildMappedCluster(_QWORD *a1, __int64 a2, int a3)
{
  ...
  v69 = v8;
  v75 = *(_QWORD *)(qword_140C674C8 + 8 * ((v5 >> 43) & 0x3FF));
  ...
  if ( a3 && v8 > v9 )
  {
    do
    {
      ...
      if ( (*(_QWORD *)v14 & 0xC01LL) != 0x800 )
        break;
      v32 = ((*(_QWORD *)v14 & (unsigned __int64)~qword_140C65C40) >> 12) & 0xFFFFFFFFFFLL;
      if ( v32 > qword_140C65CA0
        ...
        || v75 != *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(48 * v32 - 0x220000000000LL + 40) >> 43) & 0x3FFLL)) )
      {
        break;
      }
      v8 -= 8LL;
  ...
  if ( v13 < v17 )
  {
    ...
    while ( v19 != v21 )
    {
      if ( v20 != 3 || (__int64)(((unsigned __int64)v74 - v4 - 48) & 0xFFFFFFFFFFFFFFF8uLL) < 128 )
      {
        ...
        if ( (*v16 & 0xC01) == 0x800 )
        {
          v27 = ((v26 & (unsigned __int64)~qword_140C65C40) >> 12) & 0xFFFFFFFFFFLL;
          if ( v27 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * v27 - 0x21FFFFFFFFD8LL), 0x36u) )
          {
            --v16;
            v19 = v72 - 8;
            goto LABEL_20;
          ...
          if ( (*(_BYTE *)(v28 + 34) & 0x10) != 0
            && !*(_WORD *)(v28 + 32)
            && v75 == *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v28 + 40) >> 43) & 0x3FFLL)) )
          {
            if ( v72 >= v73 )
              goto LABEL_40;
            if ( v66 )
            ...
            if ( v30 )
            {
              *v74++ = ((v26 & (unsigned __int64)~qword_140C65C40) >> 12) & 0xFFFFFFFFFFLL;
LABEL_40:
              _InterlockedAnd64((volatile signed __int64 *)(v28 + 24), 0x7FFFFFFFFFFFFFFFuLL);
              v19 = v72;
              v12 = v66;
...
LABEL_24:
  ...
  while ( v8 < v72 )
  {
    ...
    if ( v85 != 3 || (__int64)(((unsigned __int64)v35 - v34 - 48) & 0xFFFFFFFFFFFFFFF8uLL) < 128 )
    {
      ...
      if ( (*v39 & 0xC01) == 0x800 )
      {
        v41 = ((v40 & ~qword_140C65C40) >> 12) & 0xFFFFFFFFFFLL;
        if ( v41 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * v41 - 0x21FFFFFFFFD8LL), 0x36u) )
          goto LABEL_76;
        ...
        if ( (*(_BYTE *)(v42 + 34) & 0x10) != 0
          && !*(_WORD *)(v42 + 32)
          && v75 == *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v42 + 40) >> 43) & 0x3FFLL)) )
        {
          if ( v38 )
          {
          ...
          if ( v43 )
          {
            *v35 = (v40 >> 12) & ((unsigned __int64)~qword_140C65C40 >> 12) & 0xFFFFFFFFFFLL;
            _InterlockedAnd64((volatile signed __int64 *)(v42 + 24), 0x7FFFFFFFFFFFFFFFuLL);
            v36 = v70;
LABEL_75:
            ++v39;
