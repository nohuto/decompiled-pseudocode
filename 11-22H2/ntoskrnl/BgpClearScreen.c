/*
 * XREFs of BgpClearScreen @ 0x140671B60
 * Callers:
...
__int64 __fastcall BgpClearScreen(unsigned int a1)
{
  ...
  result = BgpGxInitializeRectangle((int *)&v13, BitsPerPixel, (__int64)byte_140D19180, 0x2000u);
  if ( (int)result >= 0 )
  {
    BgpGxFillRectangle((__int64)byte_140D19180, a1);
    v12 = 0;
    for ( i = 0; v12 < v4; i = v12 )
    {
      ...
      if ( v3 )
      {
        do
        {
          BgpGxDrawRectangle(byte_140D19180, (__int64)&v16);
          if ( (byte_140D19190 & 0x10) != 0 )
            BgpGxFillRectangle((__int64)byte_140D19180, a1);
          v16 += v9;
        }
        while ( v16 < v3 );
