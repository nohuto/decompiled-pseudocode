/*
 * XREFs of PspCaptureUserProcessParameters @ 0x1407ADC40
 * Callers:
 ...
 *     PspCaptureAndValidateUnicodeString @ 0x1407AE330 (PspCaptureAndValidateUnicodeString.c)
 *     PspValidateEnvironmentBlock @ 0x1407AE3B0 (PspValidateEnvironmentBlock.c)
