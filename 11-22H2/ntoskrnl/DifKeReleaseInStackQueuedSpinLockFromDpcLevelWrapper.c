/*
 * XREFs of DifKeReleaseInStackQueuedSpinLockFromDpcLevelWrapper @ 0x1405E4A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeReleaseInStackQueuedSpinLockFromDpcLevelWrapper(volatile signed __int64 **a1)
{
...
LABEL_17:
  result = KxReleaseQueuedSpinLock(a1);
  if ( v7 )
  {
    v12 = v7 + 6;
