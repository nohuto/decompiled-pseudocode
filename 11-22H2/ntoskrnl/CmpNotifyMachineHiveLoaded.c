/*
 * XREFs of CmpNotifyMachineHiveLoaded @ 0x140374A38
 * Callers:
...
signed __int32 __fastcall CmpNotifyMachineHiveLoaded(__int64 a1)
{
    ...
    || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(a1, (__int64)CurrentThread)) != 0 )
  {
    ...
    if ( (unsigned __int64)v3 - qword_140C65AE8 < 0x8000000000LL )
