/*
 * XREFs of KiIdealProcessorRebalancerWorker @ 0x140356150
 * Callers:
 *     <none>
 * Callees:
...
__int64 KiIdealProcessorRebalancerWorker()
{
  ...
  while ( 1 )
  {
    v0 = KeAcquireSpinLockRaiseToDpc(&qword_140C418C8);
    v1 = byte_140C418D1;
    v2 = v0;
    byte_140C418D1 = 0;
    if ( !v1 )
  ...
  byte_140C418D0 = 0;
  result = KxReleaseSpinLock((volatile signed __int64 *)&qword_140C418C8);
  if ( (_DWORD)KiIrqlFlags )
  {
