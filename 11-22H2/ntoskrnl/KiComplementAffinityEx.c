/*
 * XREFs of KiComplementAffinityEx @ 0x14028FAC4
 * Callers:
 *     PpmParkSteerInterrupts @ 0x140256900 (PpmParkSteerInterrupts.c)
 *     KiGetDeepIdleProcessors @ 0x14028F9E0 (KiGetDeepIdleProcessors.c)
 *     KeComplementAffinityEx @ 0x14056F420 (KeComplementAffinityEx.c)
 *     KeComplementAffinityEx2 @ 0x14056F440 (KeComplementAffinityEx2.c)
 * Callees:
 *     <none>
 */
