/*
 * XREFs of MiGetChannelInformation @ 0x1402F9C74
 * Callers:
 ...
 *     MiGetNodeChannelPageCounts @ 0x1402F9F3C (MiGetNodeChannelPageCounts.c)
...
int __fastcall MiGetChannelInformation(__int64 a1, unsigned int a2, __int64 a3, _QWORD *a4)
{
  ...
  *a4 = 40LL * (unsigned int)MmNumberOfChannels;
  ...
  if ( v9->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(CurrentThread, v9)) != 0 )
  {
    ...
    if ( v4 - qword_140C65AE8 < 0x8000000000LL )
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)v4, 0LL) )
    ExfAcquirePushLockExclusiveEx(v4, v7, v4);
  if ( v7 )
    *(_BYTE *)(v7 + 18) = 1;
