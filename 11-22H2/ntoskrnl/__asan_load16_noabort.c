/*
 * XREFs of __asan_load16_noabort @ 0x140565970
 * Callers:
 *     <none>
 * Callees:
...
ULONG_PTR __fastcall _asan_load16_noabort(ULONG_PTR BugCheckParameter1)
{
  ...
  else
  {
    ...
    {
LABEL_89:
      KeBugCheckEx(0x1F2u, BugCheckParameter1, 0x10uLL, v1, (unsigned __int8)v8);
    }
...
LABEL_46:
  ...
  v12 = (BugCheckParameter1 + 0x800000000008LL) >> 3;
  if ( v11 == result )
  {
    v8 = *(_BYTE *)(v12 + v7);
    if ( v8 )
  ...
  if ( v13 == result )
  {
    if ( !v8 )
      return result;
    v14 = BugCheckParameter1 + 15;
    goto LABEL_84;
  }
  if ( v13 == (BugCheckParameter1 + 13) >> 3 )
  {
