/*
 * XREFs of MiMakeVaRangeNoAccess @ 0x14035B5CC
 * Callers:
  ...
  if ( (*(_DWORD *)(a1 + 48) & 0xA00000) == 0xA00000 )
  {
    ...
    if ( v16 != 1 )
    {
      ...
      if ( v16 != 16 )
        v17 = 1LL;
      if ( v18 > 1 )
        MiInsertTbFlushEntry(a4, (__int64)(a2 << 25) >> 16, v16, 0);
      else
        MiInsertLargeTbFlushEntry(a4, 2 - v18, a2);
      v29 = MI_READ_PTE_LOCK_FREE(a2);
      v20 = ((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v29) >> 12) & 0xFFFFFFFFFFLL;
      v32 = v20;
...
LABEL_32:
        *(_QWORD *)a2 = v25;
        ...
        if ( ++v21 >= v17 )
        {
          MiUpdatePfnProtection(v30, (__int64)v31, 0x18u);
          return 1LL;
        }
      }
    }
  ...
  if ( a2 <= a3 )
  {
    while ( 1 )
    {
      v29 = MI_READ_PTE_LOCK_FREE(a2);
      if ( (v29 & 1) == 0
        || (*(_DWORD *)(v30 + 48) & 0x70) == 0x40 && (unsigned int)MiRotatedToFrameBuffer(a2)
        || *(__int64 *)(48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v29) >> 12) & 0xFFFFFFFFFFLL)
                      - 0x21FFFFFFFFD8LL) < 0 )
      {
        goto LABEL_11;
      }
      if ( (MiGetWsleContents(0xFFFFDE0000000028uLL, v13) & 0xF) == 8 )
        break;
      MiInsertTbFlushEntry((__int64)v33, v13, 1LL, 0);
...
LABEL_39:
    if ( HIDWORD(v33[1]) )
      MiFreeWsleList(v12, (__int64)v33, 0);
    if ( v10 )
    {
      MiUnlockVa(v12, v13);
      v10 = 0;
