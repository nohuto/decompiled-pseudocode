/*
 * XREFs of MiGetHugeBadRangeFromNode @ 0x14061FCB0
 * Callers:
...
unsigned __int64 __fastcall MiGetHugeBadRangeFromNode(__int64 a1, unsigned int a2)
{
  ...
  if ( v2 )
  {
    ...
    v6 = a2 + 2 * dword_140C65C80[0] * (unsigned __int16)KeNumberNodes;
    while ( 1 )
    {
      ...
      if ( (v3 & 0x3FFFFF) == 0 )
        break;
      v8 = qword_140C67EF0 + 8 * (v3 & 0x3FFFFF);
      if ( (unsigned int)MiLockHugePfnInternal(v8, 1LL) )
      {
        MiUnlinkHugeRange(a1, v3);
        ExReleaseSpinLockExclusiveFromDpcLevel(v5);
        _InterlockedAnd(
          (volatile signed __int32 *)(qword_140C67EF8 + 4 * ((((v8 - qword_140C67EF0) >> 3) & 0x3FFFFFuLL) >> 5)),
          ~(1 << (((v8 - qword_140C67EF0) >> 3) & 0x1F)));
        goto LABEL_15;
      }
      ExReleaseSpinLockExclusiveFromDpcLevel(v5);
...
LABEL_15:
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v14 <= 0xFu && (unsigned __int8)v7 <= 0xFu && v14 >= 2u )
      {
