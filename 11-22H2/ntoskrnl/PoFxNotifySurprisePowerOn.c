...
void __fastcall PoFxNotifySurprisePowerOn(__int64 a1)
{
  ...
  v2 = a1;
  if ( a1 )
    a1 = *(_QWORD *)(*(_QWORD *)v1 + 40LL);
  v3 = PopFxLockDevice(a1, 1);
  v4 = v3;
  if ( v3 )
  {
    PopPepSurprisePowerOn(*(_QWORD *)(v3 + 56));
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v4 + 244), 0xFFFFFFFF) == 1 )
      KeSetEvent((PRKEVENT)(v4 + 248), 0, 0);
    if ( v2 )
    {
      v5 = *(_QWORD *)(*(_QWORD *)v1 + 40LL);
      if ( v5 )
      {
        if ( (*(_DWORD *)(v5 + 760) & 0x30000) != 0 )
          PopDirectedDripsStartDisengageTimer(1);
      }
    }
  }
}
