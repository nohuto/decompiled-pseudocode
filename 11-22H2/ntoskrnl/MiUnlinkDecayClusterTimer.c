/*
 * XREFs of MiUnlinkDecayClusterTimer @ 0x1403476B0
 * Callers:
...
__int64 __fastcall MiUnlinkDecayClusterTimer(__int64 a1)
{
  ...
  {
    *(_QWORD *)(48 * (qword_140C68260 + v5) - 0x220000000000LL + 8) = v4 ^ (*(_QWORD *)(48 * (qword_140C68260 + v5)
                                                                                      - 0x220000000000LL
                                                                                      + 8) ^ v4) & 0x1FFFFFFFFLL;
  }
  if ( v6 == 0x7FFFFFFF )
  ...
  {
    v7 = 48 * (v6 + qword_140C68260) - 0x220000000000LL;
