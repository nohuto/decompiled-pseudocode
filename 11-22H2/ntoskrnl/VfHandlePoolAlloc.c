/*
 * XREFs of VfHandlePoolAlloc @ 0x140AD1FB0
 * Callers:
 *     ExAllocateHeapPool @ 0x1402AD2B0 (ExAllocateHeapPool.c)
 *     IovAllocateMdl @ 0x140AC1DE0 (IovAllocateMdl.c)
 *     IovAllocateWorkItem @ 0x140AC1F20 (IovAllocateWorkItem.c)
...
LABEL_4:
  ...
  v38 = a3;
  v37 = a3;
  _InterlockedIncrement(&dword_140C13970);
  v18 = v39;
  v19 = Tag;
  if ( (v39 & 2) != 0 )
  {
...
LABEL_59:
  ...
  v27 = 0;
  _InterlockedIncrement(&dword_140C13974);
  if ( (unsigned int)ExIsSpecialPoolAddress(PoolWithTagPriority) == 1 )
  {
    v27 = 1;
LABEL_71:
    _InterlockedIncrement(&dword_140C13978);
    goto LABEL_72;
  }
  if ( a3 > 0xFE0 )
    goto LABEL_71;
