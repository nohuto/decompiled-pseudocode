 ...
 *     FsRtlpCheckSharingAgainstOplockOwner @ 0x14093E344 (FsRtlpCheckSharingAgainstOplockOwner.c)
 */
        ...
        char *a16)
{
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v201 = &v92;
    v202 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)word_14002AC82, 0LL, 0LL, 6u, v194);
    v18 = v85;
    LOBYTE(a3) = 0;
    v17 = v88;
  }
  ...
  if ( v24 != 0x4000 && v24 != 20480 && v24 != 0x2000 && v24 != 28672 )
  {
    ...
    if ( (unsigned int)dword_140C03768 > 3 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_14002AD5C,
        0LL,
        0LL,
        7u,
        v203);
  ...
  if ( *v23 == 1 || (v25 & v24) == 0 )
  {
    ...
    v27 = (unsigned __int8 *)word_14002ACE2;
    goto LABEL_253;
  }
  if ( (a4 & 8) == 0 )
  {
    if ( (unsigned __int8)FsRtlpOplockKeysEqual(*(_QWORD *)(v18 + 48), *(_QWORD *)(a1 + 8), a4) )
    {
      ...
      v27 = (unsigned __int8 *)&qword_14002AB38;
LABEL_253:
    ...
    if ( v29 <= 0x803000 )
    {
      if ( v29 == 8400896 )
      {
        if ( (unsigned int)dword_140C03768 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03768,
            (unsigned __int8 *)byte_14002A843,
            0LL,
            0LL,
            6u,
            &v394);
...
LABEL_208:
      ...
      if ( v29 == 1077312 )
      {
        if ( (unsigned int)dword_140C03768 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03768,
            (unsigned __int8 *)&byte_14002A4E7,
            0LL,
            0LL,
            6u,
            &v385);
      ...
      if ( v29 != 3174464 )
      {
        if ( v29 == 5271616 )
        {
          if ( (unsigned int)dword_140C03768 > 5 )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C03768,
              (unsigned __int8 *)&dword_14002A554,
              0LL,
              0LL,
              6u,
              &v358);
...
LABEL_215:
        if ( (v28 & 0x1000000) == 0 )
        {
          if ( (unsigned int)dword_140C03768 > 2 )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C03768,
              (unsigned __int8 *)byte_14002A39D,
              0LL,
              0LL,
              6u,
              &v412);
        ...
        if ( (unsigned int)dword_140C03768 > 5 )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03768,
            (unsigned __int8 *)byte_14002A245,
            0LL,
            0LL,
            6u,
            &v403);
      ...
      if ( (unsigned int)dword_140C03768 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03768,
          (unsigned __int8 *)word_14002A40A,
          0LL,
          0LL,
          6u,
          &v421);
...
LABEL_195:
    ...
    if ( v29 != 8409152 )
    {
      ...
      if ( (unsigned int)dword_140C03768 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03768,
          (unsigned __int8 *)byte_14002A2B8,
          0LL,
          0LL,
          6u,
          &v313);
    ...
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03768,
        (unsigned __int8 *)byte_14002A478,
        0LL,
        0LL,
        6u,
        &v322);
...
LABEL_174:
  ...
  if ( v29 == 1069120 )
  {
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03768,
        (unsigned __int8 *)&word_14002A696,
        0LL,
        0LL,
        6u,
        &v349);
  ...
  if ( v29 > 0x7040 )
  {
    ...
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03768,
        (unsigned __int8 *)&dword_14002A76C,
        0LL,
        0LL,
        6u,
        v194);
...
LABEL_152:
  ...
  if ( v29 == 28736 )
  {
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C03768,
        (unsigned __int8 *)word_14002A702,
        0LL,
        0LL,
        6u,
        &v331);
  ...
  if ( v49 )
  {
    ...
    if ( v50 )
    {
      ...
      if ( (unsigned int)dword_140C03768 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03768,
          (unsigned __int8 *)word_14002A5C2,
          0LL,
          0LL,
          6u,
          &v367);
...
LABEL_153:
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v347 = &v109;
    v348 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)word_14002AC1A, 0LL, 0LL, 6u, &v340);
    v18 = v85;
    LOBYTE(a3) = 0;
  }
  if ( (v24 & 0x1000) != 0 )
...
LABEL_14:
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v383 = &v146;
    v384 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)byte_14002A988, 0LL, 0LL, 6u, &v376);
    v18 = v85;
    LOBYTE(a3) = 0;
  }
  if ( v24 == 0x2000 )
      ...
      else
      {
        ...
        if ( v41[7] )
        {
          if ( (unsigned int)dword_140C03768 > 5 )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C03768,
              (unsigned __int8 *)&dword_14002AA5C,
              0LL,
              0LL,
              6u,
              v203);
