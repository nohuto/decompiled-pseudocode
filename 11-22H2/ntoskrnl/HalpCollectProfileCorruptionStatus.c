/*
 * XREFs of HalpCollectProfileCorruptionStatus @ 0x14050740C
 * Callers:
 *     HalpQueryProfileInformation @ 0x140865858 (HalpQueryProfileInformation.c)
 * Callees:
 *     KeQueryPerformanceCounter @ 0x1402C3240 (KeQueryPerformanceCounter.c)
 *     HalpCollectSamplingProfileCorruptionStatus @ 0x140507668 (HalpCollectSamplingProfileCorruptionStatus.c)
 */
