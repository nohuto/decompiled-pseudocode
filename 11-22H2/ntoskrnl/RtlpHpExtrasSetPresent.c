...
__int64 __fastcall RtlpHpExtrasSetPresent(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v7 = RtlCSparseBitmapBitmaskRead((__int64)&unk_140C711D0, 2 * ((unsigned __int64)(a2 - qword_140C711C8) >> 20));
