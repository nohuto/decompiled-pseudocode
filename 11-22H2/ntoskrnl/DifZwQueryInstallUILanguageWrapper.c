/*
 * XREFs of DifZwQueryInstallUILanguageWrapper @ 0x1405F50A0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryInstallUILanguageWrapper(LANGID *InstallUILanguageId)
{
...
LABEL_8:
  ...
  *(_QWORD *)&v14 = 0LL;
LABEL_10:
  *((_QWORD *)&v14 + 1) = InstallUILanguageId;
