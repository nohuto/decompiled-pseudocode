/*
 * XREFs of MiCheckProcessorPteCache @ 0x14027D730
 * Callers:
...
__int64 __fastcall MiCheckProcessorPteCache(unsigned __int64 a1)
{
  ...
  {
    v20 = qword_140C69A80;
    v21 = (unsigned __int64 *)&qword_140C69A40;
    v64 = qword_140C69A80;
    if ( qword_140C69A80 )
    {
      while ( qword_140C69A40 < v20 )
      {
      ...
      *(_QWORD *)&v63 = qword_140C69A40 - v20;
      *((_QWORD *)&v63 + 1) = qword_140C69A48 + 8 * (v20 >> 6);
      if ( v19 )
        v19 -= v20;
    }
LABEL_29:
...
LABEL_36:
    if ( v29 )
    {
      if ( (unsigned int)MiEmptyPteBins((__int64)&qword_140C69A40) )
      {
        v19 = 0LL;
        continue;
      }
    ...
    else
    {
      ...
      v31 = *(_QWORD *)(qword_140C69A48 + 8 * (v30 >> 6));
      v32 = (volatile signed __int64 *)(qword_140C69A48 + 8 * (v30 >> 6));
      if ( v31 == -1LL )
      {
LABEL_108:
        v19 = v30 + 64;
...
LABEL_9:
      if ( v12 != -1LL )
      {
        ...
        {
          v5 = v12;
          v15 = byte_140018F40[a1] << v13;
          goto LABEL_12;
        }
        if ( (v12 & 7) != 0 )
        {
          *v14++ |= byte_140016E48[v13];
