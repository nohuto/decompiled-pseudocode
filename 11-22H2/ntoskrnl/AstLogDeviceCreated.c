/*
 * XREFs of AstLogDeviceCreated @ 0x14076BDE0
 * Callers:
 ...
 *     AstIsRecording @ 0x14076BF24 (AstIsRecording.c)
...
LABEL_8:
  if ( (unsigned int)dword_140C038E0 > 5 && tlgKeywordOn((__int64)&dword_140C038E0, 0x200000000000LL) )
  {
    ...
    *(_QWORD *)&DestinationString.Length = a1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C038E0, (unsigned __int8 *)byte_14002C72B, 0LL, 0LL, 8u, &v18);
  }
  if ( v9 )
