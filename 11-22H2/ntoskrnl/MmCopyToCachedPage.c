        ...
        unsigned int a5)
{
  ...
  if ( (v11 & 1) == 0 )
    v12 = (__int64 *)v11;
  v52 = *v12;
  v13 = *(_QWORD *)(qword_140C674C8 + 8LL * (*(_WORD *)(v52 + 60) & 0x3FF)) + 17344LL;
  v53 = v13;
  v14 = a3;
  v46 = a3;
  ...
  if ( (a5 & 8) != 0 )
  {
    v17 = (__int64 *)MiReservePtes((__int64)&qword_140C69A40, 1u);
    v51 = v17;
    if ( !v17 )
      return 3221225626LL;
    v16 = a5 & 4;
...
LABEL_32:
        ...
        {
          if ( (*(_DWORD *)(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v23 + 40) >> 43) & 0x3FFLL)) + 4LL) & 0x80u) == 0 )
            goto LABEL_27;
...
LABEL_48:
  ...
  {
    v37 = *v51;
    MiReleasePtes((__int64)&qword_140C69A40, v51, 1u);
    if ( (v37 & 1) != 0 )
    {
