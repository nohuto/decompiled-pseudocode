/*
 * XREFs of SeSecureBootRegisterPolicy @ 0x140B6D9C8
 * Callers:
 ...
 *     SepSecureBootBuildRules @ 0x140B97C2C (SepSecureBootBuildRules.c)
 */
...
__int64 __fastcall SeSecureBootRegisterPolicy(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  qword_140C71058 = *(_QWORD *)(BugCheckParameter2 + 16);
...
LABEL_31:
  ...
  if ( !v6[18] && !v6[19] )
    return 0;
  qword_140D1BF90 = (__int64)v10 + v10[13] + 60;
...
LABEL_32:
    if ( qword_140D17F28 )
    {
      ExFreePoolWithTag(qword_140D17F28, 0);
      qword_140D17F28 = 0LL;
    }
