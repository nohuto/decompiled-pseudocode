/*
 * XREFs of SecureDump_PrepareForInit @ 0x1403AFCF4
 * Callers:
...
void __fastcall SecureDump_PrepareForInit(__int64 a1, _BYTE *a2)
{
  ...
  *(_OWORD *)&dwFlags = 0LL;
  ...
  if ( v5 >= 0 )
  {
    DWORD1(xmmword_140C64DD8) = *(_DWORD *)P;
    ExFreePoolWithTag(P, 0);
    P = 0LL;
