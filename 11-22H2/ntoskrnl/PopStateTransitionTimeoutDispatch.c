/*
 * XREFs of PopStateTransitionTimeoutDispatch @ 0x14058F6E0
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn PopStateTransitionTimeoutDispatch()
{
  ...
  if ( (unsigned int)(dword_140C3CFC4 - 1) <= 1 )
  {
    ...
    *(_OWORD *)BugCheckParameter1 = 0LL;
    ...
    {
      if ( v4 )
        v4((unsigned int)dword_140C3CFD0, *((_QWORD *)&v3 + 1));
  ...
  KeBugCheckEx(0xA0u, v0, dword_140C3CE40, PopSleepCheckpoint, (ULONG_PTR)BugCheckParameter4);
}
