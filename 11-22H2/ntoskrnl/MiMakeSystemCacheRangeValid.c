/*
 * XREFs of MiMakeSystemCacheRangeValid @ 0x140267740
 * Callers:
...
__int64 __fastcall MiMakeSystemCacheRangeValid(unsigned __int64 a1, unsigned __int64 *a2, unsigned int a3, __int64 a4)
{
  ...
  {
    v10 = (volatile __int32 *)&unk_140C6A280;
    goto LABEL_4;
  }
  v10 = (volatile __int32 *)&unk_140C6F980;
LABEL_4:
  CurrentIrql = KeGetCurrentIrql();
  __writecr8(2uLL);
  if ( (_DWORD)KiIrqlFlags && ((unsigned __int8)KiIrqlFlags & 1) != 0 && (unsigned __int8)CurrentIrql <= 0xFu )
...
LABEL_10:
  ...
  v16 = BYTE13(v49) | 4;
  BYTE13(v49) |= 4u;
  v17 = *(_QWORD *)(qword_140C674C8 + 8LL * (*(_WORD *)(*(_QWORD *)v15 + 60LL) & 0x3FF)) + 17344LL;
  v45 = v17;
  v18 = v17;
  *(_QWORD *)&v49 = v17;
  if ( (_DWORD)v4 )
