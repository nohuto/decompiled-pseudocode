/*
 * XREFs of DifZwSetInformationThreadWrapper @ 0x1405F74F0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ThreadInformationLength)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(639);
...
LABEL_10:
  *(_QWORD *)&v22 = ThreadHandle;
  DWORD2(v21) = ThreadInformationClass;
  *(_QWORD *)&v21 = ThreadInformation;
  DWORD2(v20) = ThreadInformationLength;
