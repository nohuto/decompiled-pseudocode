/*
 * XREFs of MxCreatePfnsForPtes @ 0x140B5B650
 * Callers:
 ...
 *     MiIsRegularMemory @ 0x140B5B854 (MiIsRegularMemory.c)
    ...
    *(_QWORD *)(48 * v9 - 0x220000000000LL + 24) ^= (*(_QWORD *)(48 * v9 - 0x220000000000LL + 24) ^ (*(_QWORD *)(48 * v9 - 0x220000000000LL + 24) + 1LL)) & 0x3FFFFFFFFFFFFFFFLL;
    ...
    else
    {
      ...
      if ( (v10 & 0x42) == 0 )
        v11 = v10;
      v12 = v10 | 0x800;
      v13 = ((unsigned __int16)((unsigned __int8)word_140C66DFC << 8) ^ v11) & 0x100;
      if ( (v10 & 0x42) == 0 )
        v12 = v10;
      v14 = v12 ^ v13;
