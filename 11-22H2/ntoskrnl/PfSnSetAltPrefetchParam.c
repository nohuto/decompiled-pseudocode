/*
 * XREFs of PfSnSetAltPrefetchParam @ 0x14097FAA8
 * Callers:
...
__int64 __fastcall PfSnSetAltPrefetchParam(ULONG_PTR BugCheckParameter1, unsigned int *a2, int a3, char a4)
{
  ...
  char v45[256]; // [rsp+110h] [rbp-138h] BYREF
    ...
    if ( v10 >= 0 )
    {
      ...
      if ( v10 >= 0 )
      {
        ...
        *(_DWORD *)&Str2[30] = v37 + v36 + v35;
        Pool2 = (char *)ExAllocatePool2(256LL, 128LL, 1716544323LL);
        v8 = Pool2;
        if ( !Pool2 )
        {
          v10 = -1073741670;
        ...
        *((_DWORD *)v8 + 30) = *(_DWORD *)&Str2[32];
        ...
        v19 = *(_BYTE *)&Parent.0 & 1;
        while ( Root )
        {
          v20 = PfSnAltProfileTreeCompareByProcess(v17, Root);
          if ( v20 >= 0 )
          {
            if ( v20 <= 0 )
              break;
        ...
        if ( !Root )
        {
          v22 = *((_QWORD *)v8 + 6);
          v38 = v22;
          v23 = (__int64)Parent.Root;
          if ( (*(_BYTE *)&Parent.0 & 1) != 0 && Parent.Root )
            v23 = (unsigned __int64)&Parent ^ (unsigned __int64)Parent.Root;
          v24 = *(_BYTE *)&Parent.0 & 1;
          v25 = 0;
          if ( v23 )
          {
            while ( 1 )
...
LABEL_41:
          ...
          RtlRbInsertNodeEx(&Parent, (PRTL_BALANCED_NODE)v23, v25, (PRTL_BALANCED_NODE)v8);
          v27 = (__int64)Tree.Root;
          if ( (*(_BYTE *)&Tree.0 & 1) != 0 && Tree.Root )
            v27 = (unsigned __int64)&Tree ^ (unsigned __int64)Tree.Root;
          v28 = *(_BYTE *)&Tree.0 & 1;
          v29 = 0;
          if ( v27 )
          {
            while ( 1 )
            {
              if ( PfSnAltProfileTreeCompareByScenarioId((wchar_t *)v8 + 28, v27) < 0 )
              {
                v30 = *(_QWORD *)v27;
                if ( v28 )
                {
...
LABEL_57:
          ...
          RtlRbInsertNodeEx(&Tree, (PRTL_BALANCED_NODE)v27, v29, (PRTL_BALANCED_NODE)v8 + 1);
...
LABEL_67:
  ...
  if ( v8 )
  {
    v31 = (void *)*((_QWORD *)v8 + 6);
    if ( v31 )
      ObfDereferenceObjectWithTag(v31, 0x73576650u);
    ExFreePoolWithTag(v8, 0x66506343u);
  }
  if ( Object )
