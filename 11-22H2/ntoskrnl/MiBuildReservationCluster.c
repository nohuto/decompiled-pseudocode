/*
 * XREFs of MiBuildReservationCluster @ 0x140638354
 * Callers:
  ...
  if ( (unsigned int)v16 < DWORD2(v88) )
  {
    ...
    *v95 = v7;
    ...
    if ( *(__int64 *)(v8 + 40) < 0
      ...
      || (v34 = (__int64 *)MiReservePtes((__int64)&qword_140C69A40, 1u), v91 = v34, (v35 = (unsigned __int64)v34) == 0) )
    {
      v62 = Src;
LABEL_99:
      v64 = v87;
...
LABEL_51:
    ...
    *(_QWORD *)v35 = ValidPte;
    ...
    if ( (unsigned int)v44 >= v86 - 1 )
      LODWORD(v44) = v86 - 1;
    if ( qword_140C65C40 && (v43 & 0x10) == 0 )
      v46 = v43 & ~qword_140C65C40;
    v47 = HIDWORD(v46);
    ...
    if ( qword_140C65C40 && (v63 & 0x10) == 0 )
      v63 &= ~qword_140C65C40;
    v16 = HIDWORD(v63);
    MiReleasePtes((__int64)&qword_140C69A40, v91, 1u);
    goto LABEL_99;
  }
  _InterlockedAnd64((volatile signed __int64 *)(v8 + 24), 0x7FFFFFFFFFFFFFFFuLL);
  if ( (_DWORD)KiIrqlFlags )
