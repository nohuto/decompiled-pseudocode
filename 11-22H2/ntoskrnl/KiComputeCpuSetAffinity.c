/*
 * XREFs of KiComputeCpuSetAffinity @ 0x1402C0414
 * Callers:
 ...
 *     KiGetSystemAllowedSetsAffinityEx @ 0x1402C0394 (KiGetSystemAllowedSetsAffinityEx.c)
 *     KiCopyGroupMasksToAffinityEx @ 0x1402C0780 (KiCopyGroupMasksToAffinityEx.c)
...
__int64 __fastcall KiComputeCpuSetAffinity(__int64 a1, unsigned __int16 *a2)
{
  ...
  *a2 = 1;
  ...
  KiGetSystemAllowedSetsAffinityEx((unsigned __int16 *)v18, v4, 0);
  if ( ((*(_DWORD *)(a1 + 1380) >> 11) & 1) != 0 )
  {
    KiGetSystemAllowedSetsAffinityEx(a2, v4, (*(_DWORD *)(a1 + 1380) >> 11) & 1);
    KiOrAffinityEx(v18, a2, v18, HIWORD(v18[0]));
  }
