/*
 * XREFs of MiAttachSingleProcessThreadToSession @ 0x14033D9CC
 * Callers:
...
__int64 __fastcall MiAttachSingleProcessThreadToSession(unsigned __int64 a1)
{
  ...
  KeAcquireInStackQueuedSpinLock(&qword_140C698C0, &v16);
  v3 = 0LL;
  v4 = (_QWORD *)(a1 + 104);
  while ( *v4 )
  {
...
LABEL_4:
  ...
  v5 = (__int64 *)(8 * (((unsigned __int64)qword_140C65AE8 >> 39) & 0x1FF) - 0x90482413000LL);
