/*
 * XREFs of CmpVerifyLogRecord @ 0x140A1F334
 * Callers:
 *     CmpRmReDoPhase @ 0x140A1EF34 (CmpRmReDoPhase.c)
 * Callees:
 *     HvBufferCheckSum @ 0x1407080A8 (HvBufferCheckSum.c)
 *     CmpVerifyCreateOrDeleteKeyLogRecord @ 0x140A1F2D8 (CmpVerifyCreateOrDeleteKeyLogRecord.c)
 *     CmpVerifyRenameKeyLogRecord @ 0x140A1F418 (CmpVerifyRenameKeyLogRecord.c)
 *     CmpVerifySetOrDeleteValueLogRecord @ 0x140A1F460 (CmpVerifySetOrDeleteValueLogRecord.c)
 *     CmpVerifySetSecurityDescriptorLogRecord @ 0x140A1F4C8 (CmpVerifySetSecurityDescriptorLogRecord.c)
 */
