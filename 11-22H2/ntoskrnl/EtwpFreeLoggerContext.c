/*
 * XREFs of EtwpFreeLoggerContext @ 0x14078E1AC
 * Callers:
 ...
 *     ExReInitializeRundownProtectionCacheAware @ 0x140322090 (ExReInitializeRundownProtectionCacheAware.c)
  ...
  *((_DWORD *)P + 204) |= 0x200u;
  ...
  if ( *((_QWORD *)P + 128) )
  {
    if ( (*((_DWORD *)P + 204) & 0x8000) != 0 )
      _InterlockedDecrement(&dword_140C6B4B0);
