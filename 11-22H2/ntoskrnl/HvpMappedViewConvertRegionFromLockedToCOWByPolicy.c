/*
 * XREFs of HvpMappedViewConvertRegionFromLockedToCOWByPolicy @ 0x1407C3BD4
 * Callers:
 *     HvpMappedViewConvertLockedPagesToCOWByPolicy @ 0x1407C3B18 (HvpMappedViewConvertLockedPagesToCOWByPolicy.c)
 * Callees:
