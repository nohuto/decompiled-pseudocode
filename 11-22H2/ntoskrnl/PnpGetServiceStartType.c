...
__int64 __fastcall PnpGetServiceStartType(int a1, void *a2, _DWORD *a3)
{
  ...
  *a3 = 4;
  ...
  if ( qword_140D18520 )
  {
    if ( qword_140D18520 == (HANDLE)-1LL )
      goto LABEL_2;
    goto LABEL_29;
  }
  if ( *(_QWORD *)&PiPnpRtlCtx )
    v12 = *(HANDLE *)(*(_QWORD *)&PiPnpRtlCtx + 224LL);
  v13 = SysCtxRegOpenKey((_DWORD)v12, qword_140D18518, (unsigned int)L"*Driver", 0, 131097, (__int64)&qword_140D18520);
  if ( v13 == -1073741772 )
  {
    qword_140D18520 = (HANDLE)-1LL;
    goto LABEL_2;
  }
  if ( v13 >= 0 )
  {
