/*
 * XREFs of MiLockPfnByPte @ 0x140270640
 * Callers:
...
__int64 __fastcall MiLockPfnByPte(unsigned __int64 a1, unsigned __int8 *a2)
{
  ...
  while ( 1 )
  {
    ...
    {
      if ( (v4 & 0x400) != 0 || (v4 & 0x800) == 0 || v4 && qword_140C65C40 && (qword_140C65C40 & v4) == 0 )
        return 0LL;
      if ( qword_140C65C40 )
      {
        if ( (v4 & 0x10) != 0 )
    ...
    if ( v6 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * v6 - 0x21FFFFFFFFD8LL), 0x36u) )
      return 0LL;
