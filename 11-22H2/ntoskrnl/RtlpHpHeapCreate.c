/*
 * XREFs of RtlpHpHeapCreate @ 0x140397668
 * Callers:
...
__int64 __fastcall RtlpHpHeapCreate(unsigned int a1, __int64 a2, __int64 a3, __int128 *a4)
{
  ...
  {
    MaximumProcessorCount = dword_140CF8548;
    if ( !dword_140CF8548 )
    {
      MaximumProcessorCount = HalQueryMaximumProcessorCount();
      if ( !MaximumProcessorCount )
        MaximumProcessorCount = 1;
      v8 = _InterlockedCompareExchange(&dword_140CF8548, MaximumProcessorCount, 0);
      if ( v8 )
    ...
    if ( v9 )
    {
      ...
      *((_QWORD *)&v21 + 1) = RtlpHpSegLfhVsFree;
      ...
      RtlpHpVsContextInitialize(v10 + 704, v10 + 320, &v21, *(_DWORD *)a4 & 1, 0, &dword_140C74A9C);
      v23 = RtlpHpSegLfhVsDecommit;
