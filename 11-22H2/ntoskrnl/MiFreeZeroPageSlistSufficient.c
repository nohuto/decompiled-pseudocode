/*
 * XREFs of MiFreeZeroPageSlistSufficient @ 0x14064D8C8
 * Callers:
...
_BOOL8 __fastcall MiFreeZeroPageSlistSufficient(__int64 a1, unsigned int a2, int a3)
{
  ...
  else
  {
    return (unsigned __int64)MiNodeFreeZeroPages(
                               (_QWORD *)(*(_QWORD *)(a1 + 16) + 25408 * ((unsigned __int64)a2 >> byte_140C65B8D)),
                               (unsigned __int8)(MiChannelMaximumPowerOf2Mask & (a2 >> byte_140C65B8E)),
                               a3 != 0 ? 4096 : 4098) <= 0x40;
  }
}
