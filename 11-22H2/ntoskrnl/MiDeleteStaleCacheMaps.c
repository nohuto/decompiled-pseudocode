/*
 * XREFs of MiDeleteStaleCacheMaps @ 0x14062DA40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
      ...
      if ( v8 > v9 )
        v8 = MiState[v4 + 2089];
      v45 = v8;
      if ( qword_140C696A0 || v10 >= qword_140C696C0 )
      {
        v11 = *v7;
        v47 = 3 * ((unsigned __int64)qword_140C696C0 >> 2);
        if ( v11 )
        {
          while ( 1 )
          {
...
LABEL_15:
            ...
            else
            {
              ...
              if ( (unsigned int)MiIsPageInIoHugeRangeTransition(*(_QWORD *)(v11 + 24), v22) )
                _InterlockedAdd64(&qword_140C696A0, 0xFFFFFFFFFFFFFFFFuLL);
              v23 = v42;
