/*
 * XREFs of PsUpdateComponentPower @ 0x14020E6C0
 * Callers:
 *     PspApplyJobChainLimitsToProcess @ 0x1406A6FC4 (PspApplyJobChainLimitsToProcess.c)
 *     PspSetProcessEnergyTrackingStateCallback @ 0x1407EA6B0 (PspSetProcessEnergyTrackingStateCallback.c)
 * Callees:
 *     RtlInterlockedTimelineBitmapUpdate @ 0x14020E774 (RtlInterlockedTimelineBitmapUpdate.c)
