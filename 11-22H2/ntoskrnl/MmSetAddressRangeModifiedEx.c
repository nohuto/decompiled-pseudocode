/*
 * XREFs of MmSetAddressRangeModifiedEx @ 0x14027F0B0
 * Callers:
 ...
 *     MmSetAddressRangeModified @ 0x140363560 (MmSetAddressRangeModified.c)
...
__int64 __fastcall MmSetAddressRangeModifiedEx(unsigned __int64 a1, __int64 a2)
{
  ...
  v9 = 0LL;
  v41 = MiLockWorkingSetOptimal(&unk_140C6F8C0, v6, v34);
  v10 = *(_QWORD *)(MiGetSystemCacheReverseMap(v8) + 24);
  v11 = v10 & 0xFFFFFFFFFFFFFFFEuLL;
  if ( (v10 & 1) == 0 )
    v11 = v10;
  v42 = *(_QWORD *)(qword_140C674C8 + 8LL * (*(_WORD *)(*(_QWORD *)v11 + 60LL) & 0x3FF)) + 17344LL;
  do
  {
    v12 = *(_QWORD *)v6;
    if ( (*(_QWORD *)v6 & 1) != 0 )
    {
      ...
      v17 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v2 + 40) >> 43) & 0x3FFLL));
      v40 = v17;
