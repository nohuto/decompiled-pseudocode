/*
 * XREFs of EmpParseTargetRuleStringIndexList @ 0x140B565CC
 * Callers:
 *     EmpParseTargetRules @ 0x140B563B0 (EmpParseTargetRules.c)
 * Callees:
 *     strchr @ 0x1403DAA40 (strchr.c)
 *     RtlCharToInteger @ 0x140823C40 (RtlCharToInteger.c)
 *     ExFreePoolWithTag @ 0x140AAF110 (ExFreePoolWithTag.c)
 *     ExAllocatePool2 @ 0x140AAF6B0 (ExAllocatePool2.c)
 *     EmpInfParseGetStringIndexFromName @ 0x140B5686C (EmpInfParseGetStringIndexFromName.c)
 */
