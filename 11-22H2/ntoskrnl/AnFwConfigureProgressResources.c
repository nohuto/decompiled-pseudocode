/*
 * XREFs of AnFwConfigureProgressResources @ 0x140AEF8E0
 * Callers:
...
__int64 __fastcall AnFwConfigureProgressResources(__int64 a1)
{
  ...
  v8 = 0LL;
  v5 = 0LL;
  KeInitializeEvent(&stru_140D16AC0, NotificationEvent, 1u);
  ...
  dword_140C0E4D4 = ((BgpGxRectangleSize(*(_DWORD *)(a1 + 12), *(_DWORD *)(a1 + 8), BitsPerPixel) + 15) & 0xFFFFFFF0)
                  + 128;
  dword_140C0E4D0 = dword_140C0E4D4 * ((unsigned __int16)word_140C0B4F0 - (unsigned __int16)word_140C0B4E8 + 1);
