/*
 * XREFs of IopMcFindNextTableEntryForUnlock @ 0x14055F044
 * Callers:
 *     IoTryReleasePage @ 0x14055EB24 (IoTryReleasePage.c)
 * Callees:
...
ULONG_PTR __fastcall IopMcFindNextTableEntryForUnlock(__int64 *a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  if ( *((_BYTE *)a1 + 16) )
    return 0LL;
  v6 = ExAcquireSpinLockShared(&dword_140C5D764);
  v7 = qword_140C5D768;
  v8 = 0LL;
  v9 = v6;
  if ( !qword_140C5D768 )
...
LABEL_28:
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C5D764);
