 ...
 *     KiEnableOptionalXStateFeatures @ 0x1405729BC (KiEnableOptionalXStateFeatures.c)
...
signed __int64 __fastcall MmDeleteKernelStackEx(ULONG_PTR a1, unsigned int a2, __int64 a3)
{
  ...
  {
    v7 = (unsigned __int8)byte_140C685BC;
  }
  ...
  if ( a3 )
    v11 = *(_QWORD **)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(a3 + 544) + 1838LL));
  else
  ...
  v15 = 0LL;
  v16 = *((_DWORD *)MiSearchNumaNodeTable(0xAAAAAAAAAAAAAAABuLL * (v13 >> 4)) + 2);
  if ( (v4 & 8) != 0 )
    v15 = 2LL;
  v54 = v15;
  if ( (v4 & 4) == 0 )
  {
    v25 = 4LL;
LABEL_32:
    SchedulerAssist = 794LL * v16;
    for ( i = (unsigned int)v15; ; i = 0LL )
    {
      v28 = (int *)(v11[2] + 32 * (SchedulerAssist + i + 725));
      if ( *(unsigned __int16 *)v28 < v28[4] )
        break;
      if ( (_DWORD)v15 != 1 )
        return MiDeleteKernelStack(v10, v4);
      LODWORD(v15) = 0;
    }
    v29 = (__int64)(v10 << 25) >> 16;
    *(_QWORD *)(v29 + 4064) = qword_140C699D0 ^ v29;
    *(_DWORD *)(v29 + 4088) = v15;
    if ( (_DWORD)v15 == 1 )
  ...
  while ( 1 )
  {
    ...
    v16 = *((_DWORD *)MiSearchNumaNodeTable(0xAAAAAAAAAAAAAAABuLL * (v39 >> 4)) + 2);
  }
  ...
  if ( v19 != -32LL
    ...
    || (v21 = (__int64)(v10 << 25) >> 16,
        *(_QWORD *)(v21 + 4064) = qword_140C699D0 ^ v21,
        *(_DWORD *)(v21 + 4088) = 1,
