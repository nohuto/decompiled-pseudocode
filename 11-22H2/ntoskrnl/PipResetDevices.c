/*
 * XREFs of PipResetDevices @ 0x140B436DC
 * Callers:
  ...
  if ( (int)result >= 0 )
  {
    ...
    else
    {
      ...
      if ( (int)PnpCtxRegOpenKey(
                  ...
                  0x20019u,
                  (__int64)&v35) >= 0
        && (int)PnpCtxRegQueryInfoKey(v11, v35, 0LL, 0LL, &v40, &v41, 0LL) >= 0 )
      {
        v18 = v40;
        if ( v40 )
        {
          ...
          if ( Pool2 )
          {
            ...
            if ( v18 )
            {
              ...
              {
                v40 = v19;
                v20 = PnpCtxRegEnumValue(0LL, v35, v2, Pool2, &v40, 0LL, 0LL, 0LL);
                v11 = 0LL;
                if ( v20 >= 0 )
                {
...
LABEL_38:
      ...
      if ( (int)PnpCtxRegOpenKey(
                  ...
                  0x20019u,
                  (__int64)&v35) >= 0
        && (int)PnpCtxRegQueryInfoKey(v17, v35, 0LL, 0LL, &v40, &v41, 0LL) >= 0 )
      {
        v26 = v40;
        if ( v40 )
        {
          ...
          if ( v15 )
          {
            ...
            if ( v26 )
            {
              ...
              {
                v41 = v27;
                v28 = PnpCtxRegEnumValue(0LL, v35, v2, v15, &v41, 0LL, 0LL, 0LL);
                v17 = 0LL;
                if ( v28 >= 0 )
                {
