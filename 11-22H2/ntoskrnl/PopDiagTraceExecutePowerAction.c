/*
 * XREFs of PopDiagTraceExecutePowerAction @ 0x14098ECCC
 * Callers:
        ...
        ...)
{
  ...
  if ( dword_140C03950 )
  {
    LOBYTE(ProcessImageFileName) = tlgKeywordOn((__int64)&dword_140C03950, 0x800000000000LL);
    if ( (_BYTE)ProcessImageFileName )
    {
      if ( v18 > 5 )
      {
        ...
        if ( (_BYTE)ProcessImageFileName )
        {
          ...
          LOBYTE(ProcessImageFileName) = tlgWriteTransfer_EtwWriteTransfer(
                                           v20,
                                           (unsigned __int8 *)&word_14002E3BE,
                                           0LL,
                                           0LL,
                                           0x11u,
                                           &v66);
