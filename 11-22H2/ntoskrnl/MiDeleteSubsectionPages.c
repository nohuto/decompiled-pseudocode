/*
 * XREFs of MiDeleteSubsectionPages @ 0x140218F10
 * Callers:
...
__int64 __fastcall MiDeleteSubsectionPages(_QWORD *BugCheckParameter2, __int64 a2)
{
  ...
  v4 = *(_DWORD *)(v2 + 56);
  v44 = v4;
  v50 = *(_QWORD *)(qword_140C674C8 + 8LL * (*(_WORD *)(v2 + 60) & 0x3FF));
  v5 = *(_QWORD *)(v2 + 64);
  v6 = 0LL;
  v45 = v5 != 0;
...
LABEL_20:
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v20 + 40) >> 43) & 0x3FFLL)) + 4LL) & 0x80u) != 0 )
...
LABEL_9:
    ...
    if ( qword_140C65C40 && (v21 & 0x10) == 0 )
      LOWORD(v21) = ~(_WORD)qword_140C65C40 & v21;
