/*
 * XREFs of HalpReadWriteWheaPhysicalMemory @ 0x140521900
 * Callers:
 *     HalpReadWheaPhysicalMemory @ 0x1405218E0 (HalpReadWheaPhysicalMemory.c)
 *     HalpWriteWheaPhysicalMemory @ 0x140521B70 (HalpWriteWheaPhysicalMemory.c)
 * Callees:
