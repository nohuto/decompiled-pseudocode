/*
 * XREFs of IommupHvAttachPasidDevice @ 0x1405243AC
 * Callers:
...
__int64 __fastcall IommupHvAttachPasidDevice(__int64 a1)
{
  ...
  if ( !IommupHvPasidSpaceCreated )
  {
    v1 = ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_140C62668)(0LL, (unsigned int)IommupHvMaximumAsids);
    if ( v1 >= 0 )
...
LABEL_27:
    ...
    v9 = 0;
    v8 = v4;
    v1 = ((__int64 (__fastcall *)(__int64 *))qword_140C62708)(&v8);
    if ( v1 >= 0 )
    {
      v7 = 0LL;
      v5 = 0LL;
      ...
      v6 = 0LL;
      LOWORD(v6) = 257;
      v1 = ((__int64 (__fastcall *)(__int64 *, __int128 *))qword_140C62770)(&v4, &v5);
      if ( v1 >= 0 )
        IommupHvPasidInitialDomainCreated = 1;
      else
        ((void (__fastcall *)(__int64 *))qword_140C62720)(&v4);
    }
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&IommupHvGlobalPushLock, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)&IommupHvGlobalPushLock);
    KeAbPostRelease((ULONG_PTR)&IommupHvGlobalPushLock);
    ...
    {
LABEL_28:
      v1 = ((__int64 (__fastcall *)(_QWORD, __int64 *))qword_140C62798)(*(_QWORD *)(a1 + 32), &v4);
      if ( v1 >= 0 )
      {
        v1 = ((__int64 (__fastcall *)(_QWORD, __int64 *))qword_140C62710)(*(_QWORD *)(a1 + 32), &v4);
        if ( v1 < 0 )
        {
LABEL_23:
          ((void (__fastcall *)(_QWORD))qword_140C627A0)(*(_QWORD *)(a1 + 32));
          return (unsigned int)v1;
        }
        if ( *(_BYTE *)(a1 + 265) )
        {
          v1 = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD))qword_140C626C8)(
                 *(_QWORD *)(a1 + 32),
                 42LL,
          ...
          {
LABEL_22:
            ((void (__fastcall *)(_QWORD))qword_140C62718)(*(_QWORD *)(a1 + 32));
            goto LABEL_23;
          }
          v1 = ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_140C62680)(*(_QWORD *)(a1 + 32), 0LL);
          if ( v1 < 0 )
          {
            ((void (__fastcall *)(_QWORD, __int64))qword_140C626C8)(*(_QWORD *)(a1 + 32), 33LL);
            goto LABEL_22;
          }
        }
      }
