/*
 * XREFs of ExpTrackTableInsertLimit @ 0x140608C0C
 * Callers:
        ...
        for ( i = 0; i < *Pool2; ++i )
        {
          ...
          v22 = (37
               * (BYTE6(v35)
               ...
               + HIBYTE(v35)) & (v14 - 1);
          *v16 = *((_QWORD *)qword_140CF81C8 + v22);
          v21[v22] = v16;
          ++ExPoolLimitState;
LABEL_20:
          ;
