/*
 * XREFs of MiComputeCacheAttributeSpeeds @ 0x140825F04
 * Callers:
...
char __fastcall MiComputeCacheAttributeSpeeds(int *a1)
{
  ...
  *(_OWORD *)v66 = 0LL;
  ...
  result = byte_140C65C98;
  if ( (byte_140C65C98 & 1) != 0 )
    return result;
  v3 = *a1;
  v4 = *((_QWORD *)a1 + 21);
  result = -(byte_140C65C98 & 4);
  v65 = v3;
  v5 = 2 - ((byte_140C65C98 & 4) != 0);
  v6 = *(unsigned int *)(v4 + 56);
  v7 = (v3 + 3) << 6;
  v8 = qword_140C65BA0 + 376 * v6;
  v63 = v8;
  v64 = v7;
  if ( *(_QWORD *)(v8 + v7) )
    return result;
