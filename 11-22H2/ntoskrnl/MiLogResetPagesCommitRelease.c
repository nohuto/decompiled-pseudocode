/*
 * XREFs of MiLogResetPagesCommitRelease @ 0x1406184EC
 * Callers:
...
void MiLogResetPagesCommitRelease()
{
  ...
  {
    if ( tlgKeywordOn(*(__int64 *)&qword_140C699E8, 4LL) )
    {
      ...
      v15 = 4;
      v10 = v4;
      tlgWriteEx_EtwWriteEx(v6, (unsigned __int8 *)&dword_14003820C, v5, 1u, v7, v8, 6u, &v12);
    }
  }
}
