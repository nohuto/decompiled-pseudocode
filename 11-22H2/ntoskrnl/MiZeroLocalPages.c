/*
 * XREFs of MiZeroLocalPages @ 0x1402CF540
 * Callers:
...
LABEL_216:
    ...
    v11 = *(_DWORD *)(v1 + 364) >> byte_140C65B8D;
    *(_QWORD *)(v1 + 32) = 0LL;
    *(_BYTE *)(v1 + 70) = 0;
    if ( v6 < 3 )
    {
...
LABEL_17:
    ...
    v15 = 0;
    LODWORD(v103) = v14;
    v16 = 88LL * (unsigned int)(dword_140C65BFC * (v13 - 1));
    v17 = v14;
...
LABEL_22:
      v1 = a1;
      *(_DWORD *)(a1 + 364) = *(_DWORD *)(a1 + 364) & ~dword_140C65B80 | dword_140C65B80 & (*(_DWORD *)(a1 + 364) + 1);
LABEL_23:
...
LABEL_82:
        ...
        RtlAvlInsertNodeEx((unsigned __int64 *)v44, (unsigned __int64)v43, v42, a1);
        *(_BYTE *)(a1 + 69) = 1;
    ...
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v45 <= 0xFu && CurrentIrql <= 0xFu && v45 >= 2u )
      {
...
LABEL_103:
    ...
    v104 = v52;
    __writecr8(2uLL);
    if ( (_DWORD)KiIrqlFlags && ((unsigned __int8)KiIrqlFlags & 1) != 0 && (unsigned __int8)v52 <= 0xFu )
    {
    ...
    if ( *(_BYTE *)(a1 + 70) )
    {
      ...
      if ( (_DWORD)KiIrqlFlags )
      {
        ...
        if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v55 <= 0xFu && (unsigned __int8)v52 <= 0xFu && v55 >= 2u )
        {
    ...
    else
    {
      ...
      if ( v63 >= 0xFFFFF6FB40000000uLL && v63 <= 0xFFFFF6FB7FFFFFFFuLL )
      {
        ...
        v69 = MiUserPdeOrAbove(v63, 0xFFFFF68000000000uLL, 0x7FFFFFFFF8LL);
        v64 = 0x140000000uLL;
      ...
      {
        v72 = HIBYTE(word_140C66DFC);
        goto LABEL_160;
      }
      if ( *(_BYTE *)(((LeafVa >> 39) & 0x1FF) - 256 + v64 + 13018328) != 1
        && (LeafVa < 0xFFFFF68000000000uLL || LeafVa > v67) )
      {
        if ( LeafVa < qword_140C6A658 || (v72 = HIBYTE(word_140C66DFC), LeafVa > qword_140C67170) )
          v72 = (unsigned __int8)word_140C66DFC;
LABEL_160:
        if ( v72 )
          v70 |= 0x100uLL;
      }
    }
    v73 = (((unsigned __int16)v70 | 0x42) ^ (unsigned __int16)((unsigned __int8)word_140C66DFC << 8)) & 0x100 ^ (v70 | 0x42);
    if ( v71 )
      v73 |= 0x80uLL;
    v6 = v116;
    v74 = 0;
...
LABEL_168:
      ...
      while ( 1 )
      {
        ...
        if ( (unsigned __int64)v78 >= 0xFFFFF6FB7DBED000uLL && (unsigned __int64)v78 <= 0xFFFFF6FB7DBED7F8uLL )
        {
          ...
          {
            if ( !HIBYTE(word_140C66DFC) && (v75 & 1) != 0 )
...
LABEL_180:
    ...
    *(_DWORD *)(a1 + 64) = v6;
    ...
    if ( (_DWORD)KiIrqlFlags )
    {
      ...
      if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v83 <= 0xFu && (unsigned __int8)v52 <= 0xFu && v83 >= 2u )
      {
...
LABEL_205:
  ...
  *(_DWORD *)(v1 + 136) |= 4u;
  ...
  if ( (_DWORD)KiIrqlFlags )
  {
    ...
    if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v93 <= 0xFu && (unsigned __int8)v92 <= 0xFu && v93 >= 2u )
    {
