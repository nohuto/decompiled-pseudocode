/*
 * XREFs of MiUpdateBadPfnIdentity @ 0x14062B35C
 * Callers:
...
__int64 __fastcall MiUpdateBadPfnIdentity(unsigned __int64 a1, unsigned __int64 *a2)
{
  ...
  if ( v5 )
  {
    v18 = 0;
    v3 = 0;
    v6 = qword_140C67EF0 + 8 * ((a1 >> 18) & 0x3FFFFF);
    v7 = MiLockHugePfn(v6);
    ...
    _InterlockedAnd(
      (volatile signed __int32 *)(qword_140C67EF8 + 4 * ((((v6 - qword_140C67EF0) >> 3) & 0x3FFFFFuLL) >> 5)),
      ~(1 << (((v6 - qword_140C67EF0) >> 3) & 0x1F)));
  }
  else
  {
