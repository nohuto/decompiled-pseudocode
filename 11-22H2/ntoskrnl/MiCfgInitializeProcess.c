/*
 * XREFs of MiCfgInitializeProcess @ 0x1407A4FC4
 * Callers:
 *     MiMapProcessExecutable @ 0x1407A35A0 (MiMapProcessExecutable.c)
 * Callees:
 *     MiMapSecurePureReserveView @ 0x1407A34C0 (MiMapSecurePureReserveView.c)
...
__int64 __fastcall MiCfgInitializeProcess(__int64 a1)
{
  ...
  v13 = 0x20000000000LL;
  result = MiMapSecurePureReserveView(a1, qword_140C65918, (int)&v12, &v13);
  v4 = result;
  if ( (int)result >= 0 )
  {
    CurrentThread = KeGetCurrentThread();
    MiReferenceCfgVad(CurrentThread, v12, 0LL);
    if ( !*v2 )
      return v4;
    v7 = *(_WORD *)(a1 + 2412);
    if ( v7 != 332 && v7 != 452 )
...
LABEL_15:
    ...
    if ( (int)result >= 0 )
    {
      MiReferenceCfgVad(CurrentThread, v12, 1LL);
      return v4;
    }
  }
  return result;
