/*
 * XREFs of MiValidateAndLockAweMapCountPage @ 0x14064C1FC
 * Callers:
...
char __fastcall MiValidateAndLockAweMapCountPage(__int64 a1, unsigned __int64 a2, __int64 *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( ((v4 - 1) & a2) != 0 || v9 >= *(_QWORD *)(a1 + 24) || !_bittest64(v7, v9) )
    return 17;
  if ( (*(_DWORD *)(a1 + 8) & 8) != 0 )
    v5 = qword_140C67EF0 + 8 * ((a2 >> 18) & 0x3FFFFF);
  else
...
LABEL_23:
      *a3 = v15;
      ...
      if ( v6 )
        ...
        _InterlockedAnd(
          (volatile signed __int32 *)(qword_140C67EF8 + 4 * ((((v5 - qword_140C67EF0) >> 3) & 0x3FFFFFuLL) >> 5)),
          ~(1 << (((v5 - qword_140C67EF0) >> 3) & 0x1F)));
