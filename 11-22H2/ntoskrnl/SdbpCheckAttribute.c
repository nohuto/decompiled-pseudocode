/*
 * XREFs of SdbpCheckAttribute @ 0x140759490
 * Callers:
    ...
    if ( a2 != 20498 )
    {
      switch ( a2 )
      {
        ...
        case 0x5003u:
          if ( a4 >= 8 )
          {
            v9 = SdbpCheckVersion(*a3, *(_QWORD *)(a5 + 16));
            goto LABEL_40;
          }
LABEL_12:
        ...
        case 0x500Du:
          if ( a4 >= 8 )
          {
            v9 = SdbpCheckUptoVersion(*a3, *(_QWORD *)(a5 + 16));
LABEL_40:
            v5 = v9;
            goto LABEL_41;
          }
...
LABEL_38:
    if ( a4 >= 8 )
    {
      v9 = SdbpCheckFromVersion(*a3, *(_QWORD *)(a5 + 16));
      goto LABEL_40;
    }
    goto LABEL_12;
  }
...
LABEL_31:
    ...
    case 24576:
      if ( a4 >= 2 )
      {
        v9 = AslStringPatternMatchExW(a3, *(_QWORD *)(a5 + 16));
        goto LABEL_40;
      }
      goto LABEL_12;
  }
