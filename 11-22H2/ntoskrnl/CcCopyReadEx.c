/*
 * XREFs of CcCopyReadEx @ 0x140261C40
 * Callers:
 *     CcCopyRead @ 0x1407E8AC0 (CcCopyRead.c)
 *     CcFastCopyRead @ 0x140936BD0 (CcFastCopyRead.c)
 ...
 *     CcTelemetryBucketizeLatency @ 0x1406F5B60 (CcTelemetryBucketizeLatency.c)
        ...
        struct _KTHREAD *a7)
{
  ...
  unsigned __int8 v41; // [rsp+D8h] [rbp+20h]
  ...
  v17 = a7;
  if ( (*v14 & 0x20000) != 0 )
    CcScheduleReadAheadNuma(Object, v16);
  v18 = 11988;
  if ( !a4 )
    v18 = 11984;
  __incgsdword(v18);
  ...
  if ( v17 && v17 != KeGetCurrentThread() )
    IoReferenceIoAttributionFromThread(v17, &v39, a3);
  v32 = CcMapAndCopyFromCache((int)Object, *a2, v40, a4, a5, (__int64)&v38, (*v14 >> 18) & 7, v39, (__int64)&v33);
  if ( v32 )
  {
...
LABEL_38:
  ...
  if ( !byte_140C5F961 )
  {
    ...
    if ( v32 )
    {
      v25 = v33;
      if ( v33 )
        v26 = 1000000 * (*(_QWORD *)&KeQueryPerformanceCounter(0LL) - v25) / stru_140C5F928.QuadPart;
      else
        v26 = v34;
      v27 = 69LL;
      if ( !a4 )
