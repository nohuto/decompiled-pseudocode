/*
 * XREFs of MiTryUnlinkNodeLargePages @ 0x1403A088C
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  while ( 1 )
  {
    ...
    if ( *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v11 + 40) >> 43) & 0x3FFLL)) != a1 )
      break;
    if ( !v64 )
    {
      v64 = 1;
      ...
      if ( v20 <= 1u )
      {
        if ( a7 )
        {
          if ( (v19 & 8) == 0 )
          {
            ...
            v42 = *(_BYTE *)(v11 + 34) & 7;
            v43 = BugCheckParameter2 / MiLargePageSizes[v74] % (unsigned int)dword_140C65C80[v74];
            v83 = v41;
