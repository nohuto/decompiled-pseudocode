/*
 * XREFs of MiInitializePoolCommitPacket @ 0x1402867E0
 * Callers:
    ...
    if ( (a3 & 0x20000000) != 0 )
    {
      if ( (unsigned int)MiObtainPoolCharges(v16, 0LL) )
      {
        ...
        *(_QWORD *)(a8 + 16) = LargePageChain;
        ...
        v24 = 0LL;
        v27 = 0LL;
        MiReturnPoolCharges(&v23, 0LL, 0LL);
      }
      return 3221225626LL;
    }
    if ( a7 )
