/*
 * XREFs of KiAdjustProcessIdealProcessorSetsForThreadCreation @ 0x1402BDF84
 * Callers:
 *     KeStartThread @ 0x1402BE0A8 (KeStartThread.c)
 * Callees:
 *     KiConstrainIdealProcessorSetBreakpoints @ 0x1402247DC (KiConstrainIdealProcessorSetBreakpoints.c)
 *     KiSelectIdealProcessorSetForProcessGroup @ 0x1402247FC (KiSelectIdealProcessorSetForProcessGroup.c)
 *     KiIsConcurrencyCountWithinIdealProcessorSetBreakpoints @ 0x1402BE020 (KiIsConcurrencyCountWithinIdealProcessorSetBreakpoints.c)
 */
      ...
      *(_DWORD *)v3 = v4;
      ...
      if ( !(_BYTE)result )
      {
        ...
        for ( HIDWORD(v11) = -2146435072 - v5; v6 < (unsigned __int16)KiActiveGroups; ++v6 )
        {
          ...
          KiSelectIdealProcessorSetForProcessGroup(a1, v6, *(_DWORD *)v3 >> 20, (__int64)&v10, (__int64)&v12);
