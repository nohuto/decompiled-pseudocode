/*
 * XREFs of MiSynchronizeFastPageInsert @ 0x14026DDF0
 * Callers:
...
void __fastcall MiSynchronizeFastPageInsert(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  v96 = 1;
  v93 = v9;
  if ( (v9 < qword_140C68260 || v9 >= qword_140C68260 + 2048) && (unsigned int)MiCheckSlabPfnBitmap(a3, 1LL) )
    v88 = 1;
  if ( a4 )
  {
    v87 = 1;
...
LABEL_12:
  ...
  v19 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v17 + 40) >> 43) & 0x3FFLL));
  v105 = v17;
  v99 = v17;
  v97 = v19;
    ...
    for ( j = v48 + 11520; ; v51 = j )
    {
      if ( v44 == -1LL || v50 != 1 )
      {
        ...
        *(_QWORD *)(v53 + 8 * v54) = v93;
        if ( v55 != -1LL && (v55 < qword_140C68260 || v55 >= qword_140C68260 + 2048) )
        {
          v108 = 0LL;
          v110 = 0LL;
          ...
          v107 = *(_QWORD *)(qword_140C674C8 + 8 * ((v56 >> 43) & 0x3FF));
          v62 = dword_140C65B88;
          if ( dword_140C65B84 > (unsigned int)dword_140C65B88
            || (v63 = (char *)qword_140C65BC8 + 16 * dword_140C65B84, v61 < *(_QWORD *)v63)
            || dword_140C65B84 != dword_140C65B88 && v61 >= *((_QWORD *)v63 + 2) )
          {
            v77 = 0;
...
LABEL_176:
            ...
            {
              v78 = (v77 + v62) >> 1;
              v63 = (char *)qword_140C65BC8 + 16 * v78;
              if ( v61 < *(_QWORD *)v63 )
              {
                if ( !v78 )
              ...
              {
                if ( v78 == dword_140C65B88 || v61 < *((_QWORD *)v63 + 2) )
                {
                  dword_140C65B84 = (v77 + v62) >> 1;
                  break;
                }
                v77 = v78 + 1;
              }
...
LABEL_82:
        ...
        if ( v93 != -1LL && (v93 < qword_140C68260 || v93 >= qword_140C68260 + 2048) )
        {
          v75 = 8LL;
          v76 = *(_QWORD *)(v105 + 16);
          if ( (v76 & 0x400) == 0 )
