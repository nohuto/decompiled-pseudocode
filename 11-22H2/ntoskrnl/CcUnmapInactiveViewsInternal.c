/*
 * XREFs of CcUnmapInactiveViewsInternal @ 0x140538490
 * Callers:
 ...
 *     CcCanReuseVacb @ 0x140537F4C (CcCanReuseVacb.c)
 ...
 *     CcRecalculateVacbArrayHighwaterMark @ 0x140538134 (CcRecalculateVacbArrayHighwaterMark.c)
