/*
 * XREFs of DifZwQueryInformationTransactionWrapper @ 0x1405F4F40
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG ReturnLength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(601);
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = TransactionHandle;
  LODWORD(v23) = TransactionInformationClass;
  *((_QWORD *)&v22 + 1) = TransactionInformation;
  LODWORD(v22) = TransactionInformationLength;
