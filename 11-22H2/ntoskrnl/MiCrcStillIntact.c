/*
 * XREFs of MiCrcStillIntact @ 0x140215150
 * Callers:
 *     MiRelinkDeferredCrcEntries @ 0x140216CD4 (MiRelinkDeferredCrcEntries.c)
 * Callees:
...
__int64 __fastcall MiCrcStillIntact(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, int a5)
{
  ...
  LODWORD(v21[1]) = 20;
  v21[3] = 0LL;
  LOBYTE(v11) = (unsigned int)MiClearPteAccessed(v18, v10, v9, (unsigned int)v21, dword_140C680E8, 0) != 0;
  return v11;
}
