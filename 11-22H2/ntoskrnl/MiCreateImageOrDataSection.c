/*
 * XREFs of MiCreateImageOrDataSection @ 0x1407233C0
 * Callers:
 ...
 *     IoGetFileMemoryPartitionInformation @ 0x1402A1C90 (IoGetFileMemoryPartitionInformation.c)
 *     IoGetTopLevelIrp @ 0x1402A1CF0 (IoGetTopLevelIrp.c)
 ...
 *     MiCallCreateSectionFilters @ 0x1407237C0 (MiCallCreateSectionFilters.c)
      ...
      if ( (*(_DWORD *)(v14 + 56) & 2) != 0 )
      {
        ...
        if ( v10 < 0 )
        {
          ...
          if ( (_QWORD *)v14 == v31 )
          {
            ...
            v9 = (_QWORD *)ObFastReplaceObject((volatile __int64 *)(v14 + 64), 0LL);
          }
          else
          {
...
LABEL_27:
    ...
    v10 = -1073741823;
    v32 = *v19;
    if ( !v32 || (v10 = MiReferenceExistingControlArea(a1), v10 < 0) )
    {
...
LABEL_79:
        if ( (*(_DWORD *)a1 & 1) == 0 )
          CcWaitForUninitializeCacheMap((__int64)v9);
        if ( (unsigned int)MiForceSectionClosed((_QWORD *)v9[5], v3, 0) > 1 && (*(_DWORD *)a1 & 0x2000000) != 0 )
        {
          ++dword_140C67ED0;
          v10 = -1073740277;
        }
