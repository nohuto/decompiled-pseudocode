/*
 * XREFs of Normalization__CanCombineWithStartFirstPair @ 0x1409C0784
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x1409C0A5C (Normalization__GetSecondDecomposedCharPlane0.c)
 */
