/*
 * XREFs of _PnpDeviceRaisePropertyChangeEventWorker @ 0x1407978DC
 * Callers:
...
LABEL_17:
  if ( v11 || v22 )
  {
    ...
    if ( ObjectProperty < 0 )
      goto LABEL_71;
    if ( RtlCompareMemory(qword_14000F5F0, Source2, 0x10uLL) == 16 )
      goto LABEL_20;
    if ( PnpStringFromGuid(Source2, v49) < 0 )
    {
LABEL_71:
      *(_QWORD *)v42 = 0LL;
