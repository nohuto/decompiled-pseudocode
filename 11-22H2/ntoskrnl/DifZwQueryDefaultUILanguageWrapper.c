/*
 * XREFs of DifZwQueryDefaultUILanguageWrapper @ 0x1405F3AA0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryDefaultUILanguageWrapper(LANGID *DefaultUILanguageId)
{
  ...
  v15 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(587);
...
LABEL_8:
  ...
  *(_QWORD *)&v14 = 0LL;
LABEL_10:
  *((_QWORD *)&v14 + 1) = DefaultUILanguageId;
...
LABEL_17:
  result = ZwQueryDefaultUILanguage(DefaultUILanguageId);
  LODWORD(v15) = result;
  if ( v7 )
  {
    v12 = (_QWORD **)(v7 + 6);
