/*
 * XREFs of KiInitializeUserApc @ 0x14030EFF8
 * Callers:
 ...
 *     RtlpGetNonLegacyXStateAreaLength @ 0x1405AB284 (RtlpGetNonLegacyXStateAreaLength.c)
        ...
        unsigned int a7)
{
  ...
  *(_WORD *)(a2 + 368) = 51;
  ...
  if ( result >= qword_140C64D50 )
  {
    ...
    while ( v22 >= 8 )
    {
      v23 = __ROR8__(v23 - *v20++, qword_140C64D48);
      v22 -= 8;
    }
    while ( v22 )
    {
      v23 = __ROR8__(v23 - *(unsigned __int8 *)v20, qword_140C64D48);
      v20 = (_QWORD *)((char *)v20 + 1);
      --v22;
    }
    if ( qword_140C64D58 != v23 )
    {
      if ( qword_140C64D10 )
        goto LABEL_28;
      qword_140C64D10 = (unsigned int)__ROR4__(150994945, 88);
      qword_140C64D18 = 0LL;
      qword_140C64D20 = 0LL;
      qword_140C64D28 = 269LL;
      qword_140C64D30 = v36;
    }
    if ( !qword_140C64D10 )
    {
LABEL_27:
      ...
      qword_140C64D50 = result;
      return result;
    }
LABEL_28:
    if ( (KDEFERRED_ROUTINE *)qword_140C64CE8 != KiScanQueues )
    {
      LODWORD(dword_140C64CD0) = 275;
      qword_140C64CE8 = (__int64)KiScanQueues;
      qword_140C64CF0 = (__int64)&dword_140C64CD0;
      qword_140C64D08 = 0LL;
      qword_140C64CE0 = 0LL;
    }
    qword_140C64D38 = 1018368LL;
    KiInsertQueueDpc((ULONG_PTR)&dword_140C64CD0, 0LL, 0LL, 0LL, 0);
    goto LABEL_27;
  }
  return result;
}
