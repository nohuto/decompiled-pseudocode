/*
 * XREFs of AlpcpCompleteDispatchMessage @ 0x14073A390
 * Callers:
 ...
 *     AlpcpAllocateCompletionBuffer @ 0x1408A5470 (AlpcpAllocateCompletionBuffer.c)
 ...
 *     AlpcpFreeBitmap @ 0x1409796F8 (AlpcpFreeBitmap.c)
