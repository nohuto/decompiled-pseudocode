/*
 * XREFs of HalpInterruptSendIpi @ 0x140254C30
 * Callers:
 ...
 *     HalRequestDeferredRecoveryServiceInterrupt @ 0x140506A30 (HalRequestDeferredRecoveryServiceInterrupt.c)
 * Callees:
...
LABEL_47:
    ...
    case 3:
      if ( (*(_DWORD *)(HalpInterruptController + 244) & 0x10) == 0 || HalpInterruptNoShorthand )
      {
        LODWORD(v41[0]) = 2097153;
        memset((char *)v41 + 4, 0, 0x104uLL);
        KiCopyAffinityEx((__int64)v41, 0x20u, (unsigned __int16 *)&KeActiveProcessors);
        goto LABEL_15;
      }
      LODWORD(v38) = 1;
      break;
...
LABEL_15:
      ...
      v30 = 0LL;
      if ( qword_140C62628 )
        return (unsigned int)qword_140C62628(v5, a2);
      LODWORD(v42[0]) = 2097153;
      memset((char *)v42 + 4, 0, 0x104uLL);
      KiAndAffinityEx((unsigned __int16 *)&HalpInterruptPhysicalTargets, v5, v42, 0x20u);
      if ( HalpInterruptClusterModeEnabled )
      {
        ...
        if ( HalpInterruptClusterData < (unsigned __int64)HalpInterruptClusterDataEnd )
        {
          do
          {
            if ( (unsigned int)KeAndGroupAffinityEx(v5, (__int64)(v10 + 2), (char *)&v40) )
            {
              v11 = v40;
              v12 = 0;
              LODWORD(v30) = 6;
