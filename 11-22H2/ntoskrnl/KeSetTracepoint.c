/*
 * XREFs of KeSetTracepoint @ 0x140975DE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
  if ( v17 )
  {
    if ( a5 )
    {
      ...
      if ( a2 )
        v20 = 6LL;
      if ( a5 != (__int64 *)KiDynamicTraceCallouts[v20] )
        return (unsigned int)-1073741790;
      v18 = a7;
      if ( !a7 )
        goto LABEL_41;
    ...
    if ( a2 )
      v21 = 7LL;
    if ( v18 != (__int64 *)KiDynamicTraceCallouts[v21] )
      return (unsigned int)-1073741790;
  }
  else if ( a5 || a7 )
  {
...
LABEL_64:
    if ( !a4 )
    {
      ...
      {
        LOBYTE(v34) = a2;
        v14 = KiTpSetupCompletion(v51, v34, a3, 0LL, (_DWORD)v26, v53);
        goto LABEL_109;
      }
      v35 = v52;
      if ( !v52 )
...
LABEL_107:
    ...
    else
    {
      ...
      if ( *((_BYTE *)v32 + 24) != (_BYTE)v26 || *((_BYTE *)v32 + 25) != (_BYTE)v26 )
      {
        v14 = -1073740008;
        goto LABEL_109;
      }
...
LABEL_82:
    ...
    if ( (_DWORD)v38 )
    {
      if ( *v40 == (_BYTE)v26 )
      {
        ...
        LOBYTE(v38) = 1;
        v41 = KiTpWriteBreakpoint(v24, v38);
        v26 = 0LL;
        v14 = v41;
        if ( v41 < 0 )
        {
      ...
      *(_QWORD *)(v24 + 32) = a6;
      *(_QWORD *)(v24 + 40) = a8;
      _InterlockedOr(v44, (unsigned int)v26);
      v13 = (__int64)v26;
      *(_BYTE *)(v24 + 24) = a5 != v26;
      *(_BYTE *)(v24 + 25) = a7 != v26;
    }
...
LABEL_103:
    ...
    {
LABEL_96:
      v43 = KiTpWriteBreakpoint(v24, 0LL);
      v26 = 0LL;
      if ( v43 >= 0 )
      {
        --KiTpEnabledCount;
