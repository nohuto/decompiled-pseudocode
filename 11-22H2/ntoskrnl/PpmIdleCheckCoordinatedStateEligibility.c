/*
 * XREFs of PpmIdleCheckCoordinatedStateEligibility @ 0x140584AA4
 * Callers:
 ...
 *     PpmCheckIdleVeto @ 0x140584058 (PpmCheckIdleVeto.c)
...
LABEL_32:
  ...
  {
    if ( !(unsigned int)KeIsSubsetAffinityEx(v16 + v15 + 128, v12 + 776) )
    {
LABEL_7:
      v17 = 0xFFFFFFFFLL;
      goto LABEL_32;
