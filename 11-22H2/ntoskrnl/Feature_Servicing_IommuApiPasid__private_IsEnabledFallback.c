/*
 * XREFs of Feature_Servicing_IommuApiPasid__private_IsEnabledFallback @ 0x14040F1FC
 * Callers:
...
__int64 __fastcall Feature_Servicing_IommuApiPasid__private_IsEnabledFallback(__int64 a1, __int64 a2)
{
