/*
 * XREFs of MiReserveFaultPte @ 0x1406341F4
 * Callers:
...
__int64 MiReserveFaultPte()
{
  ...
  *(&BitMapHeader.SizeOfBitMap + 1) = 0;
  ...
  BitMapHeader.Buffer = (unsigned int *)byte_140C697D8;
  KeAcquireInStackQueuedSpinLock(&qword_140C697D0, &v9);
  ...
  if ( (_DWORD)ClearBitsAndSet == -1 )
    ...
    return qword_140C697C8 + 8 * ClearBitsAndSet;
}
