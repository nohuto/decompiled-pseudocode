/*
 * XREFs of PopFxActivateComponentDependencies @ 0x140312394
 * Callers:
  ...
  *(_DWORD *)(a1 + 184) = v7;
  if ( v7 )
  {
    do
    {
      ...
      PopFxActivateComponent(v2, v13, 10LL, a2);
  ...
  v10 = 0LL;
  v20 = 0LL;
  while ( (unsigned __int8)PopFxNextParentRelationSafe(a1 + 456, v10, &v20) )
  {
    v14 = *(_QWORD *)(v20 + 24);
    PopFxActivateComponent(*(_QWORD *)(v14 + 80), v14, 10LL, 0);
    v10 = v20;
    if ( *(int *)(v14 + 88) < 0 )
    {
      *(_DWORD *)(v20 + 16) |= 2u;
