/*
 * XREFs of CarEtwWriteBugCheckEvent @ 0x1405D2C3C
 * Callers:
 ...
 *     CarIncrementEtwEventCount @ 0x1405D320C (CarIncrementEtwEventCount.c)
      ...
      if ( v9 < 0xA || v9 == 100 || v9 == 1000 || v9 == 10000 )
      {
        ...
        if ( Pool2 )
        {
          ...
          if ( v15 )
          {
            ...
            LOBYTE(v20) = 4;
            if ( (unsigned int)dword_140C09368 <= 5 )
            {
              v21 = v24;
            }
            else if ( tlgKeywordOn((__int64)&dword_140C09368, 0x800000000000LL) )
            {
              v25 = v11;
              v30 = &v25;
              v26 = CarTipTag;
              ...
              tlgWriteTransfer_EtwWriteTransfer(
                ...
                (unsigned __int8 *)byte_1400345D9,
                0LL,
                0LL,
                0xCu,
                &v29);
