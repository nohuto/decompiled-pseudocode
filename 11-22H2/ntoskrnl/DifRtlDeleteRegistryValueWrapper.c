/*
 * XREFs of DifRtlDeleteRegistryValueWrapper @ 0x1405EB330
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlDeleteRegistryValueWrapper(ULONG RelativeTo, PCWSTR Path, PCWSTR ValueName)
{
  ...
  v18 = 0LL;
  v19 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(419);
...
LABEL_8:
  ...
  *(_QWORD *)&v18 = 0LL;
LABEL_10:
  DWORD2(v19) = RelativeTo;
  *(_QWORD *)&v19 = Path;
  *((_QWORD *)&v18 + 1) = ValueName;
...
LABEL_17:
  result = RtlDeleteRegistryValue(RelativeTo, Path, ValueName);
  HIDWORD(v19) = result;
  if ( v11 )
  {
    v16 = (_QWORD **)(v11 + 6);
