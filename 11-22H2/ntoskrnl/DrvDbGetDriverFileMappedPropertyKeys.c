/*
 * XREFs of DrvDbGetDriverFileMappedPropertyKeys @ 0x140A6BBF4
 * Callers:
        ...
        unsigned int *Handle)
{
  ...
  *v6 = 0;
  v10 = a1;
  v11 = v8;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (_OWORD **)off_140C09680, 1u, a4, v8, v6);
