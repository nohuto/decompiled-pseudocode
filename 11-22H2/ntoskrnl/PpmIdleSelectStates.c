/*
 * XREFs of PpmIdleSelectStates @ 0x1403B6E10
 * Callers:
 ...
 *     PpmCheckPreConditionsForDeepSleep @ 0x1403CFB2C (PpmCheckPreConditionsForDeepSleep.c)
 ...
 *     PpmIdleSetSynchronizationState @ 0x1405855BC (PpmIdleSetSynchronizationState.c)
 *     PpmIdleUpdateIdleReevaluationDuration @ 0x140585774 (PpmIdleUpdateIdleReevaluationDuration.c)
 *     PpmIdleUpdateSelectionStatistics @ 0x140585818 (PpmIdleUpdateSelectionStatistics.c)
        ...
        bool *a9)
{
  ...
  unsigned __int8 *v191; // [rsp+148h] [rbp+48h]
...
LABEL_9:
  ...
  *(_DWORD *)(v12 + 728) = v21;
  ...
  {
    v22 = BYTE6(PpmCurrentProfile[55 * dword_140C3D90C + 24]);
    *(_BYTE *)(v12 + 742) = v22;
    if ( v22 )
...
LABEL_107:
    ...
    if ( v68 == 2147483656 && !BYTE8(v173) )
    {
      v44 = v159;
      BYTE8(v173) = 1;
      v48 = (unsigned int)(10 * LODWORD(PpmCurrentProfile[55 * dword_140C3D90C + 24]));
      goto LABEL_107;
    }
LABEL_109:
    v78 = v175;
...
LABEL_95:
  ...
  if ( (DWORD2(PerfGlobalGroupMask) & 0x200000) != 0 )
  {
    ...
    if ( v174 )
    {
      ...
      v195 = v51;
      v194 = 4 * v156 + 8;
      EtwTraceKernelEvent((int)&v193, 1, 0x40200000u, 4670, 1538);
      v74 = v163;
      LODWORD(v51) = 0;
    }
    if ( v73 )
    {
      ...
      v196 = v73;
      v198 = v51;
      EtwTraceKernelEvent((int)&v196, 1, 0x40200000u, 4669, 1538);
    }
  }
  *(_WORD *)(v40 + 56) |= v160;
