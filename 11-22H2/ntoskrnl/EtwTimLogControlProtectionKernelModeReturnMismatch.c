/*
 * XREFs of EtwTimLogControlProtectionKernelModeReturnMismatch @ 0x1405FFE6C
 * Callers:
 *     KiLogControlProtectionKernelModeReturnMismatch @ 0x14057BE70 (KiLogControlProtectionKernelModeReturnMismatch.c)
 * Callees:
    ...
    if ( (unsigned int)dword_140C066C0 > 5 )
    {
      ...
      if ( (_BYTE)v2 )
      {
        ...
        LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)byte_140035AF3,
                       0LL,
                       0LL,
                       0xEu,
                       &v54);
