/*
 * XREFs of PpmPerfSnapDeliveredPerformance @ 0x140255E60
 * Callers:
 ...
 *     PpmPerfSnapProcessorCyclesWorkloadClass @ 0x1402558FC (PpmPerfSnapProcessorCyclesWorkloadClass.c)
    ...
    else
    {
      ...
      if ( v14 )
      {
        ...
        if ( *(_BYTE *)(a1 + 68) )
        {
          ...
          PpmPerfSnapProcessorCyclesWorkloadClass(v33, (__int64)v7, (__int64)v8);
        }
      }
