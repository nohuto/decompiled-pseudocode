/*
 * XREFs of sub_140763458 @ 0x140763458
 * Callers:
 *     WbHeapExecuteCall @ 0x140763120 (WbHeapExecuteCall.c)
 * Callees:
 *     RtlUIntAdd @ 0x1402504BC (RtlUIntAdd.c)
 *     ?RtlULongMult@@YAJKKPEAK@Z @ 0x14066DD38 (-RtlULongMult@@YAJKKPEAK@Z.c)
 *     sub_140763538 @ 0x140763538 (sub_140763538.c)
 *     WbReAlloc @ 0x1407E568C (WbReAlloc.c)
 */

NTSTATUS __fastcall sub_140763458(_DWORD *a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
