/*
 * XREFs of MiDeleteClusterSection @ 0x1402189D0
 * Callers:
...
__int64 __fastcall MiDeleteClusterSection(ULONG_PTR a1, ULONG_PTR a2)
{
  ...
  v48 = 0LL;
  v5 = 0;
  v47 = *(_QWORD *)(qword_140C674C8 + 8 * ((v3 >> 43) & 0x3FF));
  do
  {
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(v17 + 16) = 0LL;
    ...
    if ( v23 )
    {
      ...
      {
        v27 = 1;
        if ( HIBYTE(word_140C66DFC) == (_BYTE)v12 && (ZeroPte & 1) != 0 )
