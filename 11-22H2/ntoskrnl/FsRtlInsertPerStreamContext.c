/*
 * XREFs of FsRtlInsertPerStreamContext @ 0x140333C20
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( PerStreamContext && (PerStreamContext->Flags2 & 2) != 0 )
  {
    ...
    if ( v4 >= 3u && (v6 = (__int64)*p_AePushLock) != 0 )
    {
      ...
      if ( v8->AbEntrySummary
        || (AbEntrySummary = KiAbTryReclaimOrphanedEntries((__int64)PerStreamContext, (__int64)v8)) != 0 )
      {
        ...
        if ( (unsigned __int64)(v6 - qword_140C65AE8) < 0x8000000000LL )
