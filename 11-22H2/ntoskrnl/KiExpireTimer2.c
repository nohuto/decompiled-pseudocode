/*
 * XREFs of KiExpireTimer2 @ 0x140251960
 * Callers:
...
LABEL_68:
      ...
      while ( 1 )
      {
        ...
        if ( v50 <= 1u )
        {
          if ( (unsigned __int8)PsTimerResolutionActive(*(_QWORD *)(*((_QWORD *)v51 + 3) + 544LL), v34, v48) )
            break;
        }
        if ( v48 == v49 )
          goto LABEL_68;
...
LABEL_128:
      ...
      *(_BYTE *)(v60 + 17) = 5;
      *(_DWORD *)(a1 + 4) = 0;
      KiInsertQueueDpc(*(_QWORD *)(v60 + 24), 0);
LABEL_129:
      if ( v59 == v10 )
        goto LABEL_130;
    }
      ...
      *v15 = v13;
      ...
      switch ( v16 )
      {
        ...
        case 4:
          *(_BYTE *)(v14 + 17) = 5;
          *(_DWORD *)(a1 + 4) = 0;
          KiInsertQueueDpc(*(_QWORD *)(v14 + 24), 0);
          break;
        default:
...
LABEL_22:
  ...
  if ( v24 )
  {
    ...
    KiUpdateTimer2Flags(a1, v81 | 0x10u, 0LL);
    if ( *(_QWORD *)(v8 + 11528) )
