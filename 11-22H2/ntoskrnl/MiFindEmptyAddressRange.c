/*
 * XREFs of MiFindEmptyAddressRange @ 0x14071FF10
 * Callers:
 ...
 *     MiFindClearVadBitsAligned @ 0x1407BF358 (MiFindClearVadBitsAligned.c)
 */
...
LABEL_7:
  ...
  while ( 1 )
  {
    ...
    *(_OWORD *)v39 = *(_OWORD *)a1;
    ...
    if ( v17 > v21 )
      goto LABEL_41;
    v22 = (-524288 * qword_140C67168 + (v19 << 19)) >> 16;
    ...
    if ( ClearBits != -1LL )
    {
      v25 = (ClearBits + 8 * (v19 - qword_140C67168)) << 16;
...
LABEL_43:
  ...
  if ( !v33 || v9 - v32 + 1 < a2 )
    return 3221225495LL;
  result = MiFindEmptyAddressRangeInTree((int)Process + 2008, a2, v10, a4, v32, v9, (__int64)a8);
  if ( (int)result < 0 )
  {
    v37 = v43 << 16;
    if ( !v13 )
    ...
    if ( v37 < a5 )
      v37 = a5;
    if ( v37 < v32 )
      return MiFindEmptyAddressRangeInTree((int)Process + 2008, v40, a3, v42, v37, v9, (__int64)a8);
  }
  return result;
}
