/*
 * XREFs of MiZeroFault @ 0x140232300
 * Callers:
...
LABEL_66:
  ...
  if ( (HIDWORD(KeGetCurrentThread()->ApcState.Process[2].Header.WaitListHead.Flink) & 1) == 0 )
  {
    ...
    {
      ProtoPteAddress = qword_140C65B28;
      v25 = 1;
      v7 = LODWORD(v37[0]);
      goto LABEL_35;
    }
    if ( v16 == qword_140C65B38 && v16 )
    {
      ProtoPteAddress = qword_140C65B30;
      v25 = 1;
      v7 = LODWORD(v37[0]);
      goto LABEL_35;
    }
...
LABEL_13:
  ...
  v20 = *(__int64 **)&v19[1].Spare2[23];
  if ( !v20 )
    goto LABEL_103;
  v21 = v12 >> 12;
  if ( v12 >> 12 >= (*((unsigned int *)v20 + 6) | ((unsigned __int64)*((unsigned __int8 *)v20 + 32) << 32))
    && v21 <= (*((unsigned int *)v20 + 7) | ((unsigned __int64)*((unsigned __int8 *)v20 + 33) << 32)) )
  {
    goto LABEL_16;
  }
  v20 = *(__int64 **)&v19[1].Spare2[15];
  if ( !v20 )
    goto LABEL_103;
  do
  {
    if ( v21 > (*((unsigned int *)v20 + 7) | ((unsigned __int64)*((unsigned __int8 *)v20 + 33) << 32)) )
    {
      v20 = (__int64 *)v20[1];
    }
    else
    {
      if ( v21 >= (*((unsigned int *)v20 + 6) | ((unsigned __int64)*((unsigned __int8 *)v20 + 32) << 32)) )
        break;
      v20 = (__int64 *)*v20;
    }
  }
...
LABEL_16:
  ...
  if ( v22 != qword_140C65B38 || !v22 )
  {
LABEL_49:
    if ( (v20[6] & 0x70) == 0x20 && (v20[8] & 0x10000000) != 0 )
    {
      LockedVadEvent = MiLocateLockedVadEvent(v20, 32LL);
      if ( LockedVadEvent )
      {
    ...
    if ( (v23 & 0x200000) == 0 )
    {
      if ( (v15[8] & 0x1000000) == 0 || (v15[6] & 0x70) == 0x50 )
      {
        ProtoPteAddress = MiGetProtoPteAddress(v15, v12 >> 12, 4LL, &v45);
        if ( ProtoPteAddress )
        {
          v25 = (*((_DWORD *)v15 + 12) >> 7) & 0x1F;
          if ( (v15[6] & 0x70) == 0x20 && v25 == 7 )
            v25 = 256;
        }
        else
        {
        ...
        v26 = (_QWORD *)v15[15];
        if ( (__int64)v26 < 0
          && v21 - (*((unsigned int *)v15 + 6) | ((unsigned __int64)*((unsigned __int8 *)v15 + 32) << 32)) > (unsigned __int64)(*v26 - 1LL) >> 12 )
        {
          v25 = 24;
        }
      }
    ...
    if ( (v23 & 0x70) == 0x10
      ...
      || (v23 & 0x70) == 0x20 && (v15[8] & 0x1000000) != 0
      || *((int *)v15 + 13) >= 0 )
    {
LABEL_120:
      v25 = 24;
  ...
  if ( (v7 & 2) == 0 )
  {
    if ( v15 )
    {
      if ( v15[15] >= 0 )
      {
        ...
        if ( v4 == -1073741280 )
        {
          if ( !_InterlockedIncrement((volatile signed __int32 *)v15 + 9) )
            __fastfail(0xEu);
          *(_DWORD *)(v6 + 80) |= 1u;
          *(_QWORD *)(v6 + 88) = v15;
        }
