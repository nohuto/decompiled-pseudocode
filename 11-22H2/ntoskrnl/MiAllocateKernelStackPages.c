/*
 * XREFs of MiAllocateKernelStackPages @ 0x1402731A0
 * Callers:
      ...
      || (SlabPage = MiGetPage(a1, v15, 0), SlabPage != -1) )
    {
      ...
      *(_QWORD *)v17 = v10;
      ...
      if ( !--v7 )
      {
        ...
        v19 = 0LL;
        v56 = 0LL;
        v77 = MiLockWorkingSetShared(&unk_140C6A000);
        v57 = (__int64)a7;
        v21 = a7;
        while ( 1 )
        {
          ...
          if ( v19 )
          {
            if ( (v8 & 0xFFF) != 0 )
              goto LABEL_14;
            MiUnlockPageTableInternal(&unk_140C6A000, v19);
          }
          v56 = ((v8 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
          MiLockPageTableInternal((__int64)&unk_140C6A000, v56, 0, v20);
LABEL_14:
          LODWORD(v55) = 0;
...
LABEL_35:
          ...
          {
            if ( v56 )
              MiUnlockPageTableInternal(&unk_140C6A000, v56);
            MiUnlockWorkingSetShared((__int64)&unk_140C6A000, v77);
            return 1LL;
          }
          v19 = v56;
        }
