/*
 * XREFs of HalpIommuAllocateDmaDomain @ 0x1403A91BC
 * Callers:
 *     HalpIommuInitializeDmar @ 0x1403A8EAC (HalpIommuInitializeDmar.c)
 *     IommuDomainCreateEx @ 0x140851AD0 (IommuDomainCreateEx.c)
 *     IommuDomainCreate @ 0x140935740 (IommuDomainCreate.c)
 * Callees:
        ...
        if ( v15 )
        {
          ...
          if ( v8 != 3 )
          {
            ...
            *(_WORD *)((char *)&v32 + 1) = a2 < 0;
            PageTableType = ((__int64 (__fastcall *)(__int64 *))qword_140C62708)(&v31);
            if ( PageTableType < 0 )
              goto LABEL_59;
            v13 = 0;
LABEL_34:
