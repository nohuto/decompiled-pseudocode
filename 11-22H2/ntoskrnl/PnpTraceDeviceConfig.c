/*
 * XREFs of PnpTraceDeviceConfig @ 0x1408793B0
 * Callers:
        ...
        int *a18)
{
  ...
  if ( (unsigned int)dword_140C06920 > 5 )
  {
    LOBYTE(v18) = tlgKeywordOn((__int64)&dword_140C06920, 0x800000000000LL);
    if ( (_BYTE)v18 )
    {
      v34 = &v31;
      v36 = &v28;
      ...
      LOBYTE(v18) = tlgWriteTransfer_EtwWriteTransfer(
                      (__int64)&dword_140C06920,
                      (unsigned __int8 *)byte_14002CE50,
                      0LL,
                      0LL,
                      0x18u,
                      &v33);
