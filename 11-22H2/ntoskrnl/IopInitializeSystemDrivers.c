/*
 * XREFs of IopInitializeSystemDrivers @ 0x140B40180
 * Callers:
...
__int64 IopInitializeSystemDrivers()
{
  ...
  SystemDriverList = (void **)CmGetSystemDriverList((unsigned __int64)qword_140C31B10 & -(__int64)(IsManufacturingModeEnabled != 0));
  v2 = SystemDriverList;
  if ( SystemDriverList )
  {
    v3 = SystemDriverList;
