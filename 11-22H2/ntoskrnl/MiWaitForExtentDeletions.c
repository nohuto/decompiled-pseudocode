/*
 * XREFs of MiWaitForExtentDeletions @ 0x1406402E4
 * Callers:
...
__int64 __fastcall MiWaitForExtentDeletions(__int64 a1, unsigned __int8 a2)
{
  ...
  v2 = a2;
  v14 = 0;
  v3 = (__int64 *)KeAbPreAcquire((__int64)&qword_140C65808, 0LL);
  v4 = (ULONG_PTR)v3;
  if ( v3 )
    KeAbPreWait(v3);
  v15 = 0;
  ...
  if ( v4 )
  {
    KeAbPreAcquire((__int64)&qword_140C65808, v4);
    return KeAbPostReleaseEx((ULONG_PTR)&qword_140C65808, v4);
  }
  return result;
}
