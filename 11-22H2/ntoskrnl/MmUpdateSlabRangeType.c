/*
 * XREFs of MmUpdateSlabRangeType @ 0x140B9B53C
 * Callers:
...
__int64 __fastcall MmUpdateSlabRangeType(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3, int a3)
{
  ...
  result = (unsigned int)dword_140C6B504;
  v4 = BugCheckParameter3;
  v5 = a3;
  if ( (dword_140C6B504 & 8) != 0 && BugCheckParameter3 )
  {
    ...
    do
    {
      ...
      result = qword_140C6B510 + 23392;
      v13 = 264LL * *((int *)MmSlabTypeToMiSlabType + v5) + qword_140C6B510 + 23392 + 25408 * v8;
      if ( v13 != v11 )
      {
