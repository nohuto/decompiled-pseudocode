/*
 * XREFs of MiUserFault @ 0x140235870
 * Callers:
...
__int64 __fastcall MiUserFault(_QWORD *a1)
{
  ...
  if ( *(_DWORD *)&Process[1].Spare2[7] <= 0x10u
    ...
    || (v5 = *(_QWORD *)(qword_140C674C8 + 8LL * Process[1].IdealProcessor[25]), *(_DWORD *)(v5 + 1192))
...
LABEL_11:
  v8 = (unsigned __int16 *)&unk_140C6A280;
...
LABEL_93:
            ...
            if ( (unsigned int)MiPteInShadowRange(v19) )
            {
              ...
              {
                if ( !HIBYTE(word_140C66DFC) && (v65 & 1) != 0 )
