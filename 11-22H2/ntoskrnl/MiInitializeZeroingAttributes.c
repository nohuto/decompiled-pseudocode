/*
 * XREFs of MiInitializeZeroingAttributes @ 0x140B70354
 * Callers:
...
__int64 __fastcall MiInitializeZeroingAttributes(unsigned int a1)
{
  ...
  v1 = 2 - ((byte_140C65C98 & 4) != 0);
  v2 = qword_140C65BA0 + 376LL * a1;
  v3 = 0;
  ...
  *(_DWORD *)(v2 + 172) = v1;
  ...
  do
  {
    if ( ((unsigned __int8)(1 << v8) & (unsigned __int8)byte_140C65C98) != 0 )
    {
      LODWORD(result) = 0;
      v10 = v9 - 3;
      v11 = v4;
