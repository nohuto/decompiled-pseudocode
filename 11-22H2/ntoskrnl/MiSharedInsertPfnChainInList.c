/*
 * XREFs of MiSharedInsertPfnChainInList @ 0x1402DDB70
 * Callers:
 ...
 *     MiMarkLockedChainAsProtected @ 0x14033C1D0 (MiMarkLockedChainAsProtected.c)
 */
...
__int64 __fastcall MiSharedInsertPfnChainInList(__int64 a1, _QWORD *a2)
{
  ...
  else
  {
    ...
    if ( v8 == 0x3FFFFFFFFFLL )
    {
      ...
      *(_QWORD *)(88LL * PfnPriority + *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v7 + 40) >> 43) & 0x3FFLL)) + 2960) = v32;
    }
    else
    {
    ...
    if ( v10 == 0x3FFFFFFFFFLL )
    {
      ...
      result = *(_QWORD *)(a1 + 24);
      *(_QWORD *)(v30 + *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v7 + 40) >> 43) & 0x3FFLL)) + 2968) = result;
    }
    else
    {
      result = v6;
