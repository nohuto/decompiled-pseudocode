/*
 * XREFs of CmpInitializeTransactions @ 0x140B717B8
 * Callers:
...
__int64 *CmpInitializeTransactions()
{
  ...
  qword_140C13BD8 = (__int64)&CmpRmListHead;
  ...
  qword_140C13CC8 = (__int64)&CmpLazyCommitListHead;
  ...
  _mm_lfence();
  if ( (void *)qword_140C64D40 == CmpRmListLock.Owner )
  {
    v0 = __rdtsc();
    ...
    qword_140C64D58 = v1;
    qword_140C64D50 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  CmpLazyCommitTimer = 8LL;
  qword_140C13C98 = (__int64)CmpLazyCommitDpcRoutine;
  qword_140C13CF0 = (__int64)&qword_140C13CE8;
  qword_140C13CE8 = (__int64)&qword_140C13CE8;
  qword_140C13BC8 = (__int64)&CmpDelayFreeRMListHead;
  ...
  qword_140C13AF0 = (__int64)&qword_140C13AE8;
  qword_140C13AE8 = (__int64)&qword_140C13AE8;
