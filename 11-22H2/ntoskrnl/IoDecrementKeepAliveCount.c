/*
 * XREFs of IoDecrementKeepAliveCount @ 0x140558060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IoDecrementKeepAliveCount(int a1, int a2)
{
  ...
  if ( v2 >= 0 && !v12 )
  {
    v3 = KeAcquireSpinLockRaiseToDpc(qword_140C5DE30);
    v4 = v13;
    *(_QWORD *)(v13 + 48) = MEMORY[0xFFFFF78000000014] + 50000000LL;
    ...
    {
      if ( qword_140C5DE60 )
        KeAlertThread(qword_140C5DE60, 0);
    }
    else
    {
      v5 = (__int64 *)qword_140C5DE28;
      if ( *(PVOID **)qword_140C5DE28 != &qword_140C5DE20 )
        __fastfail(3u);
      *(_QWORD *)v4 = &qword_140C5DE20;
      *(_QWORD *)(v4 + 8) = v5;
      *v5 = v4;
      qword_140C5DE28 = v4;
      *(_BYTE *)(v4 + 16) = 1;
