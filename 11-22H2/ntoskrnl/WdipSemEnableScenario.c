/*
 * XREFs of WdipSemEnableScenario @ 0x1407E5A8C
 * Callers:
 ...
 *     WdipSemQueryScenarioTable @ 0x1407E5BCC (WdipSemQueryScenarioTable.c)
 ...
 *     WdipSemEnableContextProviders @ 0x140831E30 (WdipSemEnableContextProviders.c)
