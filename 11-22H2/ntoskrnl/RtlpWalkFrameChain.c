/*
 * XREFs of RtlpWalkFrameChain @ 0x1402A4180
 * Callers:
 *     RtlWalkFrameChain @ 0x140227780 (RtlWalkFrameChain.c)
 * Callees:
 *     RtlpGetStackLimits @ 0x14022E980 (RtlpGetStackLimits.c)
 *     MmIsExecutivePagingDisabled @ 0x140282C20 (MmIsExecutivePagingDisabled.c)
...
__int64 __fastcall RtlpWalkFrameChain(__int64 a1, unsigned int a2, char a3, unsigned int a4)
{
  ...
  v38 = 0;
  v35 = (a3 & 2) != 0;
  if ( (a3 & 1) != 0 || MmIsExecutivePagingDisabled() )
    v18 = 0;
  else
    v18 = 0x80000000;
  v54 = 0LL;
...
LABEL_17:
    *(_QWORD *)ContextLength = v20;
    ...
    while ( 1 )
    {
      if ( v7 != 1 && v67 - qword_140C65AE8 < 0x8000000000LL && !(unsigned int)MmIsSessionExecutionValid(v19, v53) )
        goto LABEL_107;
