/*
 * XREFs of DifZwQueryDriverEntryOrderWrapper @ 0x1405F4080
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryDriverEntryOrderWrapper(PULONG Ids, PULONG Count)
{
...
LABEL_17:
  result = ZwQueryDriverEntryOrder(Ids, Count);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
