/*
 * XREFs of PopAssociateThermalRequest @ 0x14084EE80
 * Callers:
...
LABEL_17:
  ...
  v11 = (_QWORD *)qword_140C3CC58;
  if ( *(__int64 **)qword_140C3CC58 != &PopCoolingExtensionList )
    goto LABEL_24;
  *v6 = &PopCoolingExtensionList;
  v6[1] = v11;
  *v11 = v6;
  qword_140C3CC58 = (__int64)v6;
  *(_QWORD *)(Dope + 64) = v6;
...
LABEL_24:
  ...
  *(_BYTE *)(a1 + 18) = 1;
  ...
  if ( *(_QWORD *)(*(_QWORD *)(a1 + 32) + 128LL) )
    *(_BYTE *)(a1 + 41) = 1;
  PopReleaseRwLock((__int64 *)(*(_QWORD *)(Dope + 64) + 32LL));
  v10 = 0;
LABEL_15:
  PopReleaseRwLock(&PopCoolingExtensionLock);
  if ( v6 )
