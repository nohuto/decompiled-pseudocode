/*
 * XREFs of MiCreatePerNodeZeroingConductor @ 0x14085F7B8
 * Callers:
 *     MiZeroPageThread @ 0x1403AF9A0 (MiZeroPageThread.c)
 * Callees:
 *     MiNumberNodeDomains @ 0x140223204 (MiNumberNodeDomains.c)
...
__int64 __fastcall MiCreatePerNodeZeroingConductor(__int64 a1, unsigned int a2, char a3)
{
  ...
  v13 = 0LL;
  v6 = *(_QWORD *)(376LL * a2 + qword_140C65BA0 + 368);
  ...
  *((_DWORD *)PoolMm + 23) = MiNumberNodeDomains(*(_DWORD *)(v6 + 24));
  v9[60] = a3;
  v10 = *(_QWORD *)(*(_QWORD *)(a1 + 200) + 120LL);
