/*
 * XREFs of MiDecrementSubsectionViewCount @ 0x14029F9B0
 * Callers:
...
__int64 __fastcall MiDecrementSubsectionViewCount(__int64 *BugCheckParameter2, char a2)
{
    ...
    && !(unsigned int)MiControlAreaExemptFromCrossPartitionCharges(*BugCheckParameter2) )
  {
    ...
    else
    {
      ...
      v9 = (v7 & 0x100) != 0
         ? *(void **)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(Process[1].Affinity.StaticBitmap[25] + 366))
         : *(void **)(qword_140C674C8 + 8LL * Process[1].IdealProcessor[25]);
    }
    if ( v9 != *(void **)(qword_140C674C8 + 8LL * (*(_WORD *)(v2 + 60) & 0x3FF)) )
    {
