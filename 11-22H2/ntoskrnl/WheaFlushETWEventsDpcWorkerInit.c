/*
 * XREFs of WheaFlushETWEventsDpcWorkerInit @ 0x1403B0F78
 * Callers:
...
__int64 (__fastcall *WheaFlushETWEventsDpcWorkerInit())()
{
  ...
  *(&WheaFlushETWEventsDpcWorker + 3) = (ULONG_PTR)WheaFlushETWEventsDpcRoutine;
  stru_140C2BA20.WorkerRoutine = (void (__fastcall *)(void *))WheaFlushETWEventsWorkerRoutine;
  result = WheapProcessWaitingETWEvents;
  qword_140C2BA48 = (__int64)WheapProcessWaitingETWEvents;
  *(&WheaFlushETWEventsDpcWorker + 7) = 0LL;
  *(&WheaFlushETWEventsDpcWorker + 2) = 0LL;
  stru_140C2BA20.Parameter = &WheaFlushETWEventsDpcWorker;
  stru_140C2BA20.List.Flink = 0LL;
  dword_140C2BA40 = 0;
