/*
 * XREFs of CarLoadImageHandler @ 0x1405D3364
 * Callers:
...
void __fastcall CarLoadImageHandler(__int64 a1)
{
  ...
  if ( Pool2 )
  {
    ...
    *(_DWORD *)(Pool2 + 88) = *(_DWORD *)(a1 + 120);
    ...
    if ( CarEtwEventBook )
    {
      if ( (VfRuleClasses & 0x400000) != 0 && (unsigned int)dword_140C09368 > 5 )
      {
        if ( tlgKeywordOn((__int64)&dword_140C09368, 0x800000000000LL) )
        {
          v11 = 0;
          v4 = CarTipTag;
          v9 = &v4;
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_14003438B,
            0LL,
            0LL,
            7u,
            &v8);
