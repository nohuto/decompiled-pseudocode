/*
 * XREFs of PopLogSleepDisabled @ 0x14087404C
 * Callers:
  ...
  else
  {
    ...
    if ( Pool2 )
    {
      *(_DWORD *)(Pool2 + 24) = a1;
      ...
      v11 = (_QWORD *)qword_140C3D688;
      if ( *(__int64 **)qword_140C3D688 != &PowerStateDisableReasonListHead )
        __fastfail(3u);
      *v10 = &PowerStateDisableReasonListHead;
      v10[1] = v11;
      *v11 = v10;
      qword_140C3D688 = (__int64)v10;
    }
    else
    {
