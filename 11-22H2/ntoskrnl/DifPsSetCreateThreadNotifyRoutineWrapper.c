/*
 * XREFs of DifPsSetCreateThreadNotifyRoutineWrapper @ 0x1405EAA60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsSetCreateThreadNotifyRoutine @ 0x140844B50 (PsSetCreateThreadNotifyRoutine.c)
 */
...
NTSTATUS __fastcall DifPsSetCreateThreadNotifyRoutineWrapper(PCREATE_THREAD_NOTIFY_ROUTINE NotifyRoutine)
{
  ...
  v15 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(410);
