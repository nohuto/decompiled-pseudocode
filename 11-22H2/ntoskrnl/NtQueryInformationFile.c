/*
 * XREFs of NtQueryInformationFile @ 0x1407250E0
 * Callers:
 ...
 *     RtlIsPartialPlaceholderFileHandle @ 0x1409C0320 (RtlIsPartialPlaceholderFileHandle.c)
 ...
 *     IopGetModeInformation @ 0x140725BEC (IopGetModeInformation.c)
