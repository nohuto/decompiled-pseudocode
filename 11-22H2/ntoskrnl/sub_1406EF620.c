/*
 * XREFs of sub_1406EF620 @ 0x1406EF620
 * Callers:
 *     Callout @ 0x1407CF8E0 (Callout.c)
 * Callees:
...
__int64 __fastcall sub_1406EF620(unsigned int *a1, unsigned int a2, UINT a3, _QWORD *a4, UINT *a5)
{
  unsigned int *v6; // rsi
  unsigned int *v7; // r15
  void *v8; // r12
  ...
  ACCESS_MASK GrantedAccess; // [rsp+140h] [rbp+40h] BYREF
  ULONG ReturnLength[2]; // [rsp+144h] [rbp+44h] BYREF
  ULONG v367; // [rsp+14Ch] [rbp+4Ch] BYREF
  ULONG v368; // [rsp+150h] [rbp+50h] BYREF
  ACCESS_MASK v369; // [rsp+154h] [rbp+54h] BYREF
  __int64 SystemInformation; // [rsp+158h] [rbp+58h] BYREF
  __int64 v371; // [rsp+160h] [rbp+60h] BYREF
  __int64 v372; // [rsp+168h] [rbp+68h] BYREF
  _QWORD *v373; // [rsp+178h] [rbp+78h]
  UINT *v374; // [rsp+180h] [rbp+80h]
  ...
  _OWORD v377[2]; // [rsp+1C8h] [rbp+C8h] BYREF
  __int64 v378; // [rsp+1E8h] [rbp+E8h]
  _OWORD SecurityDescriptor[2]; // [rsp+1F0h] [rbp+F0h] BYREF
  __int64 v380; // [rsp+210h] [rbp+110h]
  __int64 v381; // [rsp+238h] [rbp+138h] BYREF
  __int64 v382; // [rsp+240h] [rbp+140h] BYREF
  ...
  if ( Acl >= 0 )
  {
    ...
    if ( (v344 & 7) != 0 )
    {
      ...
      do
      {
        ...
        {
          v63 = funcs_1406EFB8D[v62](v59 + 1, *(v60 - 2), *(v60 - 1), *v60, v60[1], (__int64)&v381, v51);
          v58 = (__int64)P;
          v50 ^= v63;
        ...
        {
          v65 = funcs_1406EFB8D[v64](v59, *(v60 - 6), *(v60 - 5), *(v60 - 4), *(v60 - 3), (__int64)&v381, v50);
          v58 = (__int64)P;
          v51 ^= v65;
          v61 = (unsigned __int8 *)v356;
        }
    ...
    if ( v47 >> 3 )
    {
      ...
      while ( 1 )
      {
        ...
        v85 = v82 ^ v44 ^ HIDWORD(v381) ^ v83 ^ v76;
        v86 = (v85 >> 8) ^ (WORD2(v381) * (v85 ^ WORD1(v381))) ^ v82;
        v87 = (WORD1(v381) * __ROR4__(HIDWORD(v381) - v86, 11) - __ROR4__(v86, 12)) ^ v85;
        v88 = ((unsigned __int16)v44 * __ROL4__(v87 ^ HIDWORD(v381), 8) - __ROL4__(v87, 2)) ^ v86;
        v89 = __ROR4__(v88, 9) ^ (HIWORD(v381) * __ROR4__(v88 - v44, 4)) ^ v87;
        v90 = (__ROR4__(v89, 4) + WORD2(v381) * __ROR4__(v44 - v89, 10)) ^ v88;
        v91 = (WORD1(v381) * __ROL4__(HIWORD(v381) ^ v90, 4) - __ROR4__(v90, 16)) ^ v89;
        v92 = 30LL;
        v93 = ((unsigned __int16)v44 * (WORD1(v381) ^ v91) - __ROR4__(v91, 7)) ^ v90;
        v94 = 16LL;
        v95 = (v93 - v44 - HIWORD(v381)) ^ v91;
        v356 = 16LL;
        v96 = __ROR4__(v95, 11) ^ (WORD2(v381) * __ROR4__(v44 - v95, 9)) ^ v93;
        v97 = (unsigned __int8 *)v354;
        v98 = (WORD1(v381) * (v96 - WORD2(v381)) - (v96 >> 13)) ^ v95;
        v99 = (unsigned __int8 *)v360;
        P = (PVOID)v360;
        v100 = (v98 >> 15) ^ (v84 * __ROL4__(v98 - WORD2(v381), 3)) ^ v96;
        do
        {
          v101 = v99[1];
          if ( (unsigned __int8)v101 < 0x1Fu )
          {
            v102 = funcs_1406EFB8D[v101](v92 + 1, *(v97 - 2), *(v97 - 1), *v97, v97[1], (__int64)&v381, v100);
            v94 = v356;
            v98 ^= v102;
          ...
          {
            v104 = funcs_1406EFB8D[v103](v92, *(v97 - 6), *(v97 - 5), *(v97 - 4), *(v97 - 3), (__int64)&v381, v98);
            v94 = v356;
            v100 ^= v104;
            v99 = (unsigned __int8 *)P;
          }
...
LABEL_188:
    ...
    {
      case 0:
        Acl = sub_1406F2550(ullAugend, v9, uAddend[0], v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 1:
        v154 = (PSID *)qword_140D534B8;
        ...
        v156 = RtlLengthSid(v154[34]) + v155;
        v157 = RtlLengthSid(v154[49]) + 32 + v156;
        ...
        if ( Acl >= 0 )
        {
          Acl = RtlpAddKnownAce((int)v159, 2, 0, 32, v154[48], 0);
          if ( Acl >= 0 )
          {
            Acl = RtlpAddKnownAce((int)v159, 2, 0, 32, v154[49], 0);
            if ( Acl >= 0 )
            {
              Acl = RtlpAddKnownAce((int)v159, 2, 0, 32, v154[34], 0);
              if ( Acl >= 0 )
              {
        ...
        if ( v6[4] != 160
          || ((v161 = (const void *)*((_QWORD *)v6 + 3), memcmp(qword_140A7C710, v161, 0xA0uLL))
           || v9[4] != 160
           || memcmp(qword_140A7CC10, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&qword_140A77FA0, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(sub_140A77F20, *((const void **)v9 + 5), 8uLL))
          && (memcmp(qword_140A7C8F0, v161, 0xA0uLL)
           || v9[4] != 160
           || memcmp(qword_140A7C490, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&qword_140A77F78, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(&qword_140A77F50, *((const void **)v9 + 5), 8uLL)) )
        {
          Acl = -2147024891;
          v10 = 0LL;
          goto LABEL_541;
      ...
      case 2:
        ...
        goto LABEL_434;
      case 4:
        Acl = sub_140A4AB80(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 5:
        ...
        goto LABEL_434;
      case 6:
        Acl = sub_140A4D79C(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 7:
        Acl = sub_140A4C718(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 22:
      ...
      case 23:
        ...
        v165 = RtlLengthSid(v163[34]) + v164;
        v166 = RtlLengthSid(v163[49]) + 32 + v165;
        ...
        if ( Acl >= 0 )
        {
          Acl = RtlpAddKnownAce((int)v168, 2, 0, 32, v163[48], 0);
          if ( Acl >= 0 )
          {
            Acl = RtlpAddKnownAce((int)v168, 2, 0, 32, v163[49], 0);
            if ( Acl >= 0 )
            {
              Acl = RtlpAddKnownAce((int)v168, 2, 0, 32, v163[34], 0);
              if ( Acl >= 0 )
              {
                Acl = RtlCreateSecurityDescriptor(v377, 1u);
                if ( Acl >= 0 )
                {
                  Acl = RtlSetDaclSecurityDescriptor(v377, 1u, v168, 0);
                  if ( Acl >= 0 )
                  {
        ...
        v368 = 0;
        v371 = 8LL;
        ZwQuerySystemInformation(SystemCodeIntegrityInformation, &v371, 8u, &v368);
        v170 = v6[4];
        if ( (_DWORD)v170 != 160
          || ((v171 = (const void *)*((_QWORD *)v6 + 3), memcmp(qword_140A7C670, v171, 0xA0uLL))
           || v9[4] != 160
           || memcmp(qword_140A7C850, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&qword_140A77F38, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(sub_140A77F10, *((const void **)v9 + 5), 8uLL))
          && (memcmp(qword_140A7CAD0, v171, v170)
           || v9[4] != 160
           || memcmp(qword_140A7CF30, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp((char *)&loc_140A77F14 + 4, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(&qword_140A77F88, *((const void **)v9 + 5), 8uLL))
          && ((v172 = (const void *)*((_QWORD *)v6 + 3), memcmp(qword_140A7CE90, v172, v170))
           || v9[4] != 160
           || memcmp(sub_140A7C3F0, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&qword_140A77F40, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp((char *)&loc_140A77F2E + 2, *((const void **)v9 + 5), 8uLL))
          && (memcmp(qword_140A7C990, v172, v170)
           || v9[4] != 160
           || memcmp(qword_140A7CB70, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&qword_140A77F98, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(&qword_140A77F08, *((const void **)v9 + 5), 8uLL)) )
        {
          v8 = 0LL;
          Acl = -2147024891;
          v10 = 0LL;
      ...
      case 102:
        ...
        goto LABEL_329;
      case 103:
        Acl = sub_140A4B190(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 104:
        Acl = sub_140A4C9D4(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 105:
        ...
        goto LABEL_434;
      case 106:
        Acl = sub_140A4C044(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 107:
        Acl = sub_14066D83C((__int64)ullAugend, (__int64)v9, v145, (__int64)v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 109:
        ...
        goto LABEL_434;
      case 110:
        Acl = sub_140A4BC90(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 111:
        Acl = sub_140A4AF50(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 112:
      ...
      case 113:
        ...
        goto LABEL_434;
      case 204:
        Acl = sub_140A4D388(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 205:
      ...
      case 206:
        ...
        Acl = 0;
        v372 = 8LL;
        ZwQuerySystemInformation(SystemCodeIntegrityInformation, &v372, 8u, &v367);
        v178 = v6[4];
        if ( (_DWORD)v178 != 160
          || ((v179 = (const void *)*((_QWORD *)v6 + 3), memcmp(qword_140A7CA30, v179, 0xA0uLL))
           || v9[4] != 160
           || memcmp(qword_140A7CDF0, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&qword_140A77F68, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(&qword_140A77F70, *((const void **)v9 + 5), 8uLL))
          && (memcmp(qword_140A7CCB0, v179, v178)
           || v9[4] != 160
           || memcmp(qword_140A7CD50, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&loc_140A77F28, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(&qword_140A77F58, *((const void **)v9 + 5), 8uLL))
          && ((v180 = (const void *)*((_QWORD *)v6 + 3), memcmp(qword_140A7C5D0, v180, v178))
           || v9[4] != 160
           || memcmp(qword_140A7C7B0, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&qword_140A77F48, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(&qword_140A77F90, *((const void **)v9 + 5), 8uLL))
          && (memcmp(qword_140A7C350, v180, v178)
           || v9[4] != 160
           || memcmp(qword_140A7C530, *((const void **)v9 + 3), 0xA0uLL)
           || v6[8] != 8
           || memcmp(&qword_140A77F80, *((const void **)v6 + 5), 8uLL)
           || v9[8] != 8
           || memcmp(&qword_140A77F60, *((const void **)v9 + 5), 8uLL)) )
        {
          Acl = -2147024891;
        }
        if ( Acl < 0 )
        ...
        goto LABEL_434;
      case 207:
        Acl = sub_140A4B6E0(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 208:
        ...
        goto LABEL_434;
      case 209:
        Acl = sub_140A4CF6C(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 210:
        Acl = sub_140A4A794(ullAugend, v9, v145, v340);
        v153 = Acl < 0;
        goto LABEL_434;
      case 211:
        Acl = sub_140A4A3A4(ullAugend, v9, v145, v340);
        if ( Acl >= 0 )
          goto LABEL_435;
        v8 = 0LL;
        v10 = 0LL;
...
LABEL_528:
    ...
    if ( (v233 & 7) != 0 )
    {
      ...
      do
      {
        ...
        {
          v251 = funcs_1406EFB8D[v250](v249 + 1, *(v248 - 2), *(v248 - 1), *v248, v248[1], (__int64)&v382, v241);
          v246 = v344;
          v252 = v251 ^ v352;
          v352 ^= v251;
        }
        ...
        {
          v254 = funcs_1406EFB8D[v253](v249, *(v248 - 6), *(v248 - 5), *(v248 - 4), *(v248 - 3), (__int64)&v382, v252);
          v246 = v344;
          v241 ^= v254;
        }
        v249 -= 2LL;
      ...
      do
      {
        ...
        *(_WORD *)((char *)uAddend + 1) = v276;
        ...
        do
        {
          ...
          {
            v279 = funcs_1406EFB8D[v278](v268, *(v270 - 2), *(v270 - 1), *v270, v270[1], (__int64)&v382, v277);
            v275 = v344;
            v274 ^= v279;
          }
          v280 = v272[1];
          ...
          {
            v281 = funcs_1406EFB8D[v280](v268 + 1, v270[2], v270[3], v270[4], v270[5], (__int64)&v382, v274);
            v275 = v344;
            v277 ^= v281;
          }
          v268 += 2LL;
        ...
        v282 = v382;
        v283 = HIDWORD(v382);
        v284 = (HIWORD(v382) * ((unsigned __int16)v382 + __ROR4__(~v277, 5))) ^ v274;
        v285 = (v284 >> 10) ^ (WORD1(v382) * (HIWORD(v382) ^ v284)) ^ v277;
        v286 = __ROR4__(v285, 10) ^ (WORD2(v382) * __ROR4__(v382 ^ v285, 12)) ^ v284;
        v287 = (HIWORD(v382) * __ROR4__(v286 - v382, 14) - __ROL4__(v286, 8)) ^ v285;
        v288 = (__ROL4__(v287, 2) + (unsigned __int16)v382 * __ROR4__(v287 + HIDWORD(v382), 15)) ^ v286;
        v289 = (WORD1(v382) * (WORD2(v382) ^ v288)) ^ __ROR4__(v288, 6) ^ v287;
        v290 = (HIDWORD(v382) - (v382 ^ v289)) ^ v288;
        v291 = (HIWORD(v382) * __ROL4__(WORD1(v382) ^ v290, 6) - __ROL4__(v290, 2)) ^ v289;
        v292 = ((unsigned __int16)v382 * (v291 - WORD2(v382)) - (v291 >> 13)) ^ v290;
        v293 = (WORD1(v382) * __ROR4__(v292 + HIDWORD(v382), 9) - __ROL4__(v292, 2)) ^ v291;
        v294 = (_BYTE *)Size;
        v295 = (unsigned int)v349;
        v296 = uAddend[0];
        v297 = (__ROL4__(v293, 10) + WORD2(v382) * __ROL4__(v293 - v382, 5)) ^ v292;
        v298 = v297 ^ v293;
