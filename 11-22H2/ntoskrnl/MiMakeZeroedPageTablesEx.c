/*
 * XREFs of MiMakeZeroedPageTablesEx @ 0x140214330
 * Callers:
 ...
 *     MiSetLeafFillToUninitializedWsle @ 0x140661F08 (MiSetLeafFillToUninitializedWsle.c)
...
LABEL_11:
      v14 = v13;
LABEL_12:
      AnyMultiplexedVm = (unsigned __int64 *)MiGetAnyMultiplexedVm(v14);
      goto LABEL_13;
    }
    if ( a4 == v11 )
    {
...
LABEL_13:
  v15 = a5;
  v16 = *(_QWORD *)(qword_140C674C8 + 8LL * *((unsigned __int16 *)AnyMultiplexedVm + 87));
  v35[44] = -1LL;
  LODWORD(v35[16]) = a3;
  v35[12] = v16;
  HIDWORD(v35[15]) = a5;
  ...
  else if ( v10 >= 0xFFFFDE0000000000uLL && v10 < 48 * qword_140C65CA0 - 0x21FFFFFFFFD0LL || a4 == 17 )
  {
    v35[44] = 0LL;
  }
  MiInitializeColorBase(v10, v15, (__int64)&v35[42]);
  v17 = HIDWORD(v35[43]) >> byte_140C65B8D;
  if ( (a3 & 0x80u) != 0 )
  {
    ...
    {
      MiCleanupPageTablePages((__int64)v35);
      return 0LL;
    }
  }
  ...
  if ( SLODWORD(v35[41]) >= 0 )
    return 1LL;
  if ( (a3 & 0x200) == 0 )
    MiDeleteSystemPageTables((__int64)AnyMultiplexedVm, a4, v10, v32, 0, (__int64)&v35[18], 3);
  return 0LL;
}
