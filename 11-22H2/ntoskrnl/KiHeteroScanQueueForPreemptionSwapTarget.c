/*
 * XREFs of KiHeteroScanQueueForPreemptionSwapTarget @ 0x14057742C
 * Callers:
 ...
 *     KiHeteroIsSwapBeneficialForPerformance @ 0x140577328 (KiHeteroIsSwapBeneficialForPerformance.c)
 */
