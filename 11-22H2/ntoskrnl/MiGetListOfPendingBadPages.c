/*
 * XREFs of MiGetListOfPendingBadPages @ 0x14062A068
 * Callers:
 ...
 *     MiEnumerateBadHugeRangePages @ 0x14061FAE0 (MiEnumerateBadHugeRangePages.c)
...
__int64 __fastcall MiGetListOfPendingBadPages(__int64 a1)
{
  ...
  if ( !qword_140C67408 )
    return 0LL;
  v2 = qword_140C67408 + qword_140C67468;
  if ( qword_140C67408 + qword_140C67468 >= (unsigned __int64)qword_140C67408 )
  {
    while ( 1 )
    {
      if ( !v2 )
      ...
      if ( qword_140C67418 )
        break;
      v7 = ExAcquireSpinLockShared(&dword_140C67410);
      if ( !qword_140C67418 && v2 >= qword_140C67408 + qword_140C67468 )
      {
        v5[2] += MiEnumerateBadHugeRangePages(v6, v2, 2);
        v25 = (_QWORD *)qword_140C67400;
        v26 = 0LL;
        while ( v25 )
        {
          v26 = v25;
