/*
 * XREFs of MmInSwapWorkingSet @ 0x1402000BC
 * Callers:
 ...
 *     VmCheckLargePageInswap @ 0x1409DBF74 (VmCheckLargePageInswap.c)
...
__int64 __fastcall MmInSwapWorkingSet(PEPROCESS Process)
{
  ...
  v4 = *(_QWORD *)(qword_140C674C8 + 8LL * *((unsigned __int16 *)v1 + 87));
