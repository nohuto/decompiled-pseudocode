/*
 * XREFs of SepSetSystemPaths @ 0x140856C00
 * Callers:
...
__int64 __fastcall SepSetSystemPaths(__int64 a1)
{
  ...
  v4 = *((unsigned __int16 *)CurrentServerSiloGlobals + 632) + 30LL;
  Pool2 = ExAllocatePool2(256LL, 2 * v4 + 48, 1668499779LL);
  v6 = Pool2;
  if ( Pool2 )
  {
    v7 = (const WCHAR *)(Pool2 + 48);
    RtlStringCbPrintfW((NTSTRSAFE_PWSTR)(Pool2 + 48), v4, L"\\??\\%ws\\System32\\", CurrentServerSiloGlobals[159]);
    RtlInitUnicodeString((PUNICODE_STRING)v6, v7);
    v8 = (wchar_t *)&v7[v4 >> 1];
    RtlStringCbPrintfW(v8, v4, L"\\??\\%ws\\SysWOW64\\", CurrentServerSiloGlobals[159]);
