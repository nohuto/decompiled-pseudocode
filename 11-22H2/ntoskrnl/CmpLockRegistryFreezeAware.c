/*
 * XREFs of CmpLockRegistryFreezeAware @ 0x140753CF8
 * Callers:
...
__int64 __fastcall CmpLockRegistryFreezeAware(char a1)
{
  ...
  while ( CmpFreezeThawState == 1 )
  {
    ...
    if ( v9 )
      *(_BYTE *)(v9 + 18) = 1;
    if ( *(__int64 **)qword_140C13E78 != &CmpFreezeThawWaitListHead )
      __fastfail(3u);
    *((_QWORD *)&v20 + 1) = qword_140C13E78;
    *(_QWORD *)&v20 = &CmpFreezeThawWaitListHead;
    *(_QWORD *)qword_140C13E78 = &v20;
    qword_140C13E78 = (__int64)&v20;
