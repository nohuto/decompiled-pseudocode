/*
 * XREFs of MiDeleteKernelStack @ 0x140283870
 * Callers:
...
__int64 __fastcall MiDeleteKernelStack(__int64 a1, char a2)
{
  ...
  {
    v2 = (unsigned __int8)byte_140C685BC;
  }
  ...
  v8 = v7;
  v9 = v7 + 8 * v3;
  v10 = MiLockWorkingSetShared(&unk_140C6A000);
  v26 = v10;
  if ( v7 >= v9 )
    goto LABEL_16;
  do
  {
    if ( v5 )
    {
      if ( (v7 & 0xFFF) != 0 )
        goto LABEL_7;
      MiUnlockPageTableInternal(&unk_140C6A000, v5);
    }
    v5 = ((v7 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
    MiLockPageTableInternal((__int64)&unk_140C6A000, v5, 0, v11);
LABEL_7:
    v12 = *(_QWORD *)v7;
    ...
    {
      if ( !v6 )
        v6 = *(_QWORD *)(qword_140C674C8
                       + 8
                       * ((*(_QWORD *)(48
                                     * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v27) >> 12) & 0xFFFFFFFFFFLL)
                                     - 0x220000000000LL
                                     + 40) >> 43) & 0x3FFLL));
      MiDeleteValidSystemPage((__int64)&unk_140C6A000, v7, 0, (struct _KTHREAD *)v23);
      ++*(_QWORD *)&v23[0];
    }
    v7 += 8LL;
  }
  ...
  v10 = v26;
LABEL_16:
  MiUnlockWorkingSetShared((__int64)&unk_140C6A000, v10);
  if ( (_UNKNOWN *)v6 != &MiSystemPartition
    || (_InterlockedExchangeAdd64(&qword_140C69AC8, -v4),
...
LABEL_21:
  MiReleasePtes(&unk_140C68508, v8, (unsigned int)v3);
