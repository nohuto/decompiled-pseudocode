/*
 * XREFs of MiValidatePagefilePageHash @ 0x14046ED1A
 * Callers:
    ...
    if ( !MiInPageSkipPage(v10) )
    {
      ...
      if ( (*(_QWORD *)(v10 + 24) & 0x4000000000000000LL) == 0 )
      {
        ...
        if ( (dword_140D1D1D0 & 1) == 0
          ...
          || (PagingFileOffset = MiGetPagingFileOffset(v10 + 16)) == 0 )
        {
          v8 = v23;
        }
        else
        {
          ...
          if ( !v24 )
          {
            v15 = *(_QWORD *)(*(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v10 + 40) >> 43) & 0x3FFLL))
