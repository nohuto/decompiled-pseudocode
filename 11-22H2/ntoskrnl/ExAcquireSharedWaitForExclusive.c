...
LABEL_19:
      if ( Wait )
      {
        ...
        *(_QWORD *)&v78 = CurrentThread;
        ...
        if ( KiIrqlFlags )
        {
          ...
          if ( (KiIrqlFlags & 1) != 0 && v53 <= 0xFu && LockHandle.OldIrql <= 0xFu && v53 >= 2u )
          {
        ...
        if ( !v16 )
        {
          ...
          *((_DWORD *)v56 + 2) = v57 | 8;
          ...
          if ( KiIrqlFlags )
          {
            ...
            if ( (KiIrqlFlags & 1) != 0 && v59 <= 0xFu && LockHandle.OldIrql <= 0xFu && v59 >= 2u )
            {
      ...
      else
      {
        ...
        if ( KiIrqlFlags )
        {
          ...
          if ( (KiIrqlFlags & 1) != 0 && v64 <= 0xFu && LockHandle.OldIrql <= 0xFu && v64 >= 2u )
          {
