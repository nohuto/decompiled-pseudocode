/*
 * XREFs of MiCommitPoolMemory @ 0x140285D10
 * Callers:
...
__int64 __fastcall MiCommitPoolMemory(_QWORD *a1)
{
  ...
  *((_BYTE *)a1 + 76) = CurrentIrql;
  ...
  else
  {
    ...
    {
      case 5:
        v18 = v14 + _InterlockedExchangeAdd64(&qword_140C65588, v14);
        if ( v18 >= MiState[0] || MiState[0] - v18 < 0x300 )
          MiFreeExcessSegments(v18, v12, v10);
        break;
      case 6:
        _InterlockedExchangeAdd64(&qword_140C69A28, v14);
        break;
      case 15:
        _InterlockedExchangeAdd64(&qword_140C65590, v14);
        break;
      default:
