/*
 * XREFs of MiObtainDynamicVa @ 0x140211064
 * Callers:
 ...
 *     MiFindNextAlignedForwardRunClearEx @ 0x140636EC4 (MiFindNextAlignedForwardRunClearEx.c)
 */
...
LABEL_32:
  ...
  if ( v5 == &qword_140C66FC0 )
  {
    qword_140C66E08 -= v3 << 21;
