/*
 * XREFs of IopMcAddMdlPagesToTable @ 0x14055EBD0
 * Callers:
...
__int64 __fastcall IopMcAddMdlPagesToTable(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 88) = a2 + 48;
  ...
  v30 = 0;
  v8 = 0;
  v10 = ExAcquireSpinLockExclusive(&dword_140C5D764);
  if ( !(_DWORD)v5 )
    goto LABEL_28;
  v11 = a1 + 96;
  do
...
LABEL_24:
    ...
    v17 = 0;
LABEL_26:
    RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C5D768, v9, v17, v11);
LABEL_27:
    ++v8;
    v11 += 32LL;
  }
