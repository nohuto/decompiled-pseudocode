...
__int64 __fastcall MiLargePagePromote(__int64 a1, unsigned int a2, __int64 a3, int a4, _DWORD *a5)
{
  ...
  *a5 = 0;
  ...
  v12 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(v6 - 0x220000000000LL + 40) >> 43) & 0x3FFLL));
  ...
  if ( !*(_QWORD *)(v29 + 23136) )
  {
    ...
    else if ( !(unsigned int)MiDetermineCoalescedLargePageHeatState(a2, v9, v24, a5) )
    {
      v25 = 4294967293LL;
      goto LABEL_20;
    }
