/*
 * XREFs of MiAbsorbPossibleEngineChanges @ 0x140221074
 * Callers:
...
void __fastcall MiAbsorbPossibleEngineChanges(int *a1, _BYTE *a2)
{
  ...
  v71 = *(_QWORD *)(v4 + 48);
  v7 = *(_QWORD *)(qword_140C65BA0 + 376 * v6 + 368);
  v8 = ExAcquireSpinLockShared(&dword_140C69920);
  *((_DWORD *)a2 + 1) = *(unsigned __int16 *)(v7 + 8);
  ...
  v72 = v11;
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C69920);
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)a2 + 2) = PoolMm;
    if ( !PoolMm )
      return;
    v16 = ExAcquireSpinLockShared(&dword_140C69920);
