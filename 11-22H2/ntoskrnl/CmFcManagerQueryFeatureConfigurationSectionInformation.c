/*
 * XREFs of CmFcManagerQueryFeatureConfigurationSectionInformation @ 0x1407C700C
 * Callers:
        ...
        KPROCESSOR_MODE a4)
{
  ...
  v8 = KeAbPreAcquire((__int64)&RunOnce, 0LL);
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&RunOnce, 17LL, 0LL) )
