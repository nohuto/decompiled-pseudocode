/*
 * XREFs of MiReleaseOutSwappedProcessCommit @ 0x1406192E8
 * Callers:
 ...
 *     SmStoreExistsForProcess @ 0x1403445A4 (SmStoreExistsForProcess.c)
...
void __fastcall MiReleaseOutSwappedProcessCommit(struct _EPROCESS *a1)
{
  ...
  v26 = SharedVm;
  v28 = *(_QWORD *)(qword_140C674C8 + 8LL * a1->Vm.Instance.PartitionId);
