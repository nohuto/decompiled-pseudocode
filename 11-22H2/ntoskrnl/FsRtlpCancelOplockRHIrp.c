/*
 * XREFs of FsRtlpCancelOplockRHIrp @ 0x140360570
 * Callers:
 *     FsRtlpRequestShareableOplock @ 0x140301920 (FsRtlpRequestShareableOplock.c)
 *     FsRtlpOplockRHIrpCancelRoutine @ 0x140360550 (FsRtlpOplockRHIrpCancelRoutine.c)
 * Callees:
...
void __fastcall FsRtlpCancelOplockRHIrp(__int64 a1, char a2, char a3)
{
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v33 = &v14;
    v34 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)word_140029E1A, 0LL, 0LL, 5u, &v28);
  }
  v6 = 0;
  v11 = 0;
  if ( !a2 )
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&qword_140029DB0,
      0LL,
      0LL,
      6u,
      &v19);
