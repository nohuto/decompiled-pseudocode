/*
 * XREFs of PpmInfoWriteData @ 0x14082DF4C
 * Callers:
 *     PpmInfoAdjustSetting @ 0x14082DE88 (PpmInfoAdjustSetting.c)
 * Callees:
 *     PpmInfoApplyMinMaxConstraint @ 0x14039060C (PpmInfoApplyMinMaxConstraint.c)
 */
