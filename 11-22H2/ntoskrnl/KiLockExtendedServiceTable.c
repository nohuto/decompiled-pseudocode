/*
 * XREFs of KiLockExtendedServiceTable @ 0x1403E3218
 * Callers:
...
__int64 __fastcall KiLockExtendedServiceTable(ULONG_PTR BugCheckParameter1, ULONG_PTR a2, unsigned int a3, int a4)
{
  ...
  if ( a4 )
  {
    ...
    v10 = 4 * v4;
    v11 = ((unsigned __int64)&qword_140C0E040 ^ qword_140C0E048) & 0x3F;
    ...
    v15 = v10 >> 7;
    v16 = (unsigned __int64)&qword_140C0E040 ^ qword_140C0E048;
    if ( v10 >> 7 )
    {
      do
      {
        ...
        while ( v17 );
        v21 = __ROL8__((unsigned __int64)&qword_140C0E040 ^ qword_140C0E048 ^ ((unsigned __int64)v13 - v6), 17) ^ (unsigned __int64)&qword_140C0E040 ^ qword_140C0E048 ^ ((unsigned __int64)v13 - v6);
    ...
    v27 = v16 ^ qword_140C0E040;
    BugCheckParameter3 = v4;
    v28 = (_QWORD *)a2;
    v29 = (v16 ^ qword_140C0E040) & 0x3F;
    *(_QWORD *)&v9 = a2;
    if ( a2 < a2 + v4 )
    {
      do
    ...
    if ( (v5 & 2) != 0 )
    {
      qword_140C0E048 = v6 ^ v30 ^ BugCheckParameter3;
      return v9;
    }
...
LABEL_74:
      ...
      if ( v46 == (char *)v130 )
      {
        ...
        {
LABEL_110:
          *(_QWORD *)&v9 = memset(qword_140C0E140, 0, sizeof(qword_140C0E140));
          if ( v39 == qword_140C0E040 || !v39 )
          {
...
LABEL_48:
  ...
  qword_140C0E040 = v9 ^ *((_QWORD *)&v9 + 1);
  if ( (unsigned __int64)v9 == *((_QWORD *)&v9 + 1) )
  {
    *(_QWORD *)&v9 = 0x95EA5DE843D5D824uLL;
    qword_140C0E040 = 0x95EA5DE843D5D824uLL;
  }
  return v9;
}
