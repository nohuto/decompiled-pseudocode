/*
 * XREFs of SymCryptModExpWindowed @ 0x140408D20
 * Callers:
 *     SymCryptModExpGeneric @ 0x140408B88 (SymCryptModExpGeneric.c)
 * Callees:
 *     SymCryptIntBitsizeOfObject @ 0x1403F8C58 (SymCryptIntBitsizeOfObject.c)
 *     SymCryptIntGetBits @ 0x1403F8D8C (SymCryptIntGetBits.c)
 *     SymCryptModElementCopy @ 0x1403F8FF4 (SymCryptModElementCopy.c)
 *     SymCryptModElementCreate @ 0x1403F900C (SymCryptModElementCreate.c)
 *     SymCryptModElementSetValueUint32 @ 0x1403F912C (SymCryptModElementSetValueUint32.c)
 *     SymCryptModMul @ 0x1403F9294 (SymCryptModMul.c)
 *     SymCryptModSquare @ 0x1403F9370 (SymCryptModSquare.c)
 *     SymCryptSizeofModElementFromModulus @ 0x1403F9428 (SymCryptSizeofModElementFromModulus.c)
 *     SymCryptScsTableInit @ 0x14040E600 (SymCryptScsTableInit.c)
 *     SymCryptScsTableLoad @ 0x14040E644 (SymCryptScsTableLoad.c)
 *     MiSetPfnOriginalPte @ 0x14040EA60 (MiSetPfnOriginalPte.c)
 *     SymCryptScsTableStore @ 0x14040EA6C (SymCryptScsTableStore.c)
 */
        ...
        __int64 a7)
{
  ...
  do
  {
    if ( *((_DWORD *)&qword_140014248 + v12) >= v7 )
      break;
    ++v11;
