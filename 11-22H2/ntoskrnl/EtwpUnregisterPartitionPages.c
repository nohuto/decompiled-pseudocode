/*
 * XREFs of EtwpUnregisterPartitionPages @ 0x140601894
 * Callers:
...
__int64 __fastcall EtwpUnregisterPartitionPages(_QWORD *a1, __int64 a2)
{
  ...
  v3 = 0LL;
  v4 = 0LL;
  v6 = ExAcquireSpinLockExclusive(&dword_140C31C10);
  v7 = (unsigned int)dword_140C31C04 >> 5;
  v8 = -1LL << (dword_140C31C04 & 0x1F);
  v9 = a2 & v8;
  if ( (unsigned int)dword_140C31C04 >> 5 )
  {
    v10 = v7 - 1;
    v21 = a2 & v8;
    v11 = (_QWORD **)(qword_140C31C08
                    + 8LL
                    * ((v7 - 1) & (HIBYTE(v21)
                                 + 37
                                 * (BYTE6(v21)
