/*
 * XREFs of SecureDump_ValidateAmeCertChain @ 0x14055E870
 * Callers:
 ...
 *     MincrypK_ParseCertificateChainWithPolicy @ 0x140A7033C (MincrypK_ParseCertificateChainWithPolicy.c)
 *     MincryptFreePolicyInfo @ 0x140A70D64 (MincryptFreePolicyInfo.c)
 *     MincryptGetLeafKeyFromPolicy @ 0x140A70DA4 (MincryptGetLeafKeyFromPolicy.c)
 *     MincryptGetRootKeyFromPolicy @ 0x140A70DD4 (MincryptGetRootKeyFromPolicy.c)
 */
