/*
 * XREFs of HashpVerifyPkcs1Signature @ 0x140A7737C
 * Callers:
 ...
 *     SymCryptLoadMsbFirstUint64 @ 0x1403F5E58 (SymCryptLoadMsbFirstUint64.c)
        ...
        char a10)
{
  ...
  v31 = 0LL;
  if ( byte_140D1C408 )
    Pool2 = ExAllocateFromNPagedLookasideList(&stru_140D1BA40);
  else
...
LABEL_30:
  if ( v26 )
    ExFreeToNPagedLookasideList(&stru_140D1BA40, v13);
  else
