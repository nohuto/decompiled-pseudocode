/*
 * XREFs of PspWriteTebImpersonationInfo @ 0x1407352F0
 * Callers:
...
__int64 __fastcall PspWriteTebImpersonationInfo(__int64 a1, __int64 a2)
{
  ...
  $115DCDF994C6370D29323EAB0E0C9502 v18; // [rsp+50h] [rbp-58h] BYREF
  ...
  if ( v4 && (*(_DWORD *)(a1 + 116) & 0x400) == 0 )
  {
    ...
    {
      KiStackAttachProcess((_KPROCESS *)v5, 0, (__int64)&v18);
      v12 = 1;
    }
