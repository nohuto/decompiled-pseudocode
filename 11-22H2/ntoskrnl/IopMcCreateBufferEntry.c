/*
 * XREFs of IopMcCreateBufferEntry @ 0x14055EDD8
 * Callers:
...
__int64 __fastcall IopMcCreateBufferEntry(__int64 a1, unsigned int a2, char a3, __int64 *a4)
{
  ...
  *(_QWORD *)(Pool2 + 72) = Pool2 + 72;
  ...
  v14 = KeAcquireSpinLockRaiseToDpc(&qword_140C5D748);
  v15 = (_QWORD *)qword_140C5D758;
  v16 = (_QWORD *)(v10 + 16);
  if ( *(__int64 **)qword_140C5D758 != &qword_140C5D750 )
    __fastfail(3u);
  *v16 = &qword_140C5D750;
  *(_QWORD *)(v10 + 24) = v15;
  *v15 = v16;
