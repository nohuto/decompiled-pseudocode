/*
 * XREFs of MiGetUltraMdlContext @ 0x140661A3C
 * Callers:
...
PSLIST_ENTRY MiGetUltraMdlContext()
{
  ...
  {
    LODWORD(v2) = v2 & 7;
    result = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(qword_140C68638 + ((8LL * v0 + (unsigned int)v2) << 6)));
    if ( result )
      return result;
    LOBYTE(v2) = v2 + 1;
    ++v1;
  ...
  while ( v1 < 8 );
  if ( (unsigned int)dword_140C68630 >= 0x80 )
    return 0LL;
