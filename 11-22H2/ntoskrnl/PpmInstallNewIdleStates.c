/*
 * XREFs of PpmInstallNewIdleStates @ 0x14039F2F0
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x14039F2D0 (PpmIdleInstallDefaultStates.c)
 * Callees:
 *     KxReleaseSpinLock @ 0x1402504E0 (KxReleaseSpinLock.c)
 *     KxAcquireSpinLock @ 0x140251490 (KxAcquireSpinLock.c)
 *     KeAddProcessorAffinityEx @ 0x140257280 (KeAddProcessorAffinityEx.c)
 *     PpmDeepestHardwareIdleState @ 0x14039F828 (PpmDeepestHardwareIdleState.c)
 *     PpmResetIdlePolicy @ 0x14039F868 (PpmResetIdlePolicy.c)
 *     PpmUpdateProcessorIdleAccounting @ 0x14039F9F4 (PpmUpdateProcessorIdleAccounting.c)
