 ...
 *     LdrUnloadAlternateResourceModule @ 0x14020B61C (LdrUnloadAlternateResourceModule.c)
 ...
 *     MiVaToSoftwareWsle @ 0x140661F50 (MiVaToSoftwareWsle.c)
  ...
  *(_QWORD *)&v55 = v5;
  ...
  if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)v4) == 1 )
  {
    ...
    *(_QWORD *)&v54 = MiSectionControlArea((__int64)Object);
    ...
    if ( v13 )
    {
      if ( ((unsigned int)dword_140C6997C >> 12) + ((dword_140C6997C & 0xFFF) != 0) )
  ...
  *(_QWORD *)(BugCheckParameter2 + 136) = 1LL;
  ...
  if ( (v21 & 1) != 0 )
  {
    ...
    else
    {
      ...
      qword_140C65A30 = BugCheckParameter2;
      ...
      qword_140C65A30 = 0LL;
      _InterlockedExchangeAdd((_DWORD *)&xmmword_140C65A50 + 3, v34 - v33);
      v29 = (__int64)Object;
      if ( !Object )
      {
        MiReleasePrivilegedPtes(v67, (unsigned int)v53);
