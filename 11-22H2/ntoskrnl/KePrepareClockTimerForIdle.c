/*
 * XREFs of KePrepareClockTimerForIdle @ 0x140346E44
 * Callers:
 ...
 *     KiClockTimerOneShotReady @ 0x1403D007C (KiClockTimerOneShotReady.c)
...
LABEL_47:
  ...
  if ( (unsigned int)dword_140C02F60 > 5 )
  {
    ...
    v43 = 4;
    v26 = v16;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02F60, (unsigned __int8 *)byte_14002D518, 0LL, 0LL, 4u, &v38);
  }
  if ( a4 )
