/*
 * XREFs of RtlpHpSegMgrCommit @ 0x14024F060
 * Callers:
 *     RtlpHpSegPageRangeCommit @ 0x14024E2D0 (RtlpHpSegPageRangeCommit.c)
 *     RtlpHpSegMgrAllocate @ 0x14031491C (RtlpHpSegMgrAllocate.c)
...
LABEL_21:
    ...
    v34 = 0LL;
    v35 = 0LL;
    RtlpHpVaMgrCtxQuery(&unk_140C71218, a2 & 0xFFFFFFFFFFE00000uLL, &v34);
    a2 = v37;
...
LABEL_10:
  ...
  if ( !v16 && (v16 = qword_140C6B398, v15 = &qword_140C6B398, !qword_140C6B398) || v17 + (a5 << 12) <= v16 )
  {
    a2 = v37;
    goto LABEL_5;
  }
