/*
 * XREFs of KeMarkHiberPhase @ 0x140A9EAF8
 * Callers:
...
LABEL_27:
  ...
  if ( qword_140C41978 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C41978, 16 * (unsigned int)(unsigned __int8)qword_140C41968, 0x7272744Du);
  if ( qword_140C41980 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C41980, 0x58uLL, 0x7272744Du);
  v17 = *(_QWORD **)(v1 + 8);
