/*
 * XREFs of MmInitSystem @ 0x140B47AB4
 * Callers:
...
char __fastcall MmInitSystem(__int64 a1, ULONG_PTR a2, __int64 a3)
{
  ...
  if ( v4 == -1 )
  {
    stru_140C12EC0.SizeOfBitMap = 2048;
    stru_140C12EC0.Buffer = (unsigned int *)&unk_140C12ED0;
    word_140C13032 |= 1u;
      ...
      if ( (unsigned __int16)KeNumberNodes > 1u )
      {
        ...
        if ( NumaGraph )
        {
          ...
          for ( i = 0; i < v16; ++i )
          {
            ...
            {
              v19 = i * v16 + v18++;
              *(_DWORD *)(qword_140C65B98 + 4LL * (unsigned int)v19) = NumaGraph[v19];
            }
            while ( v18 < v16 );
          }
