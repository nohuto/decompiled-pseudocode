/*
 * XREFs of MiGetHugeRangeFromNode @ 0x1403C4A84
 * Callers:
...
unsigned __int64 __fastcall MiGetHugeRangeFromNode(__int64 a1, unsigned int a2, int a3, unsigned __int64 a4)
{
  ...
  do
  {
    v8 = (unsigned int)dword_140C65C80[0];
    v9 = v7 + *(_QWORD *)(a1 + 16);
    v45 = v9;
    v43 = dword_140C65C80[0];
    v10 = (_QWORD *)(v6 + 8LL * (unsigned int)(2 * v4 * dword_140C65C80[0]));
    if ( a4 || !a3 )
    {
      v10 += (unsigned int)dword_140C65C80[0];
      v11 = 1LL;
    }
    else
    {
    ...
    while ( 2 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (v5 & 0x3FFFFF) == 0 )
          goto LABEL_26;
        v23 = v5 & 0x3FFFFF;
        v15 = (const signed __int64 *)(qword_140C67EF0 + 8 * v23);
...
LABEL_28:
      ...
      if ( !(unsigned int)MiLockHugePfnInternal(qword_140C67EF0 + 8 * v23, 1LL) )
      {
...
LABEL_14:
        ...
        __writecr8(v13);
        if ( (v5 & 0x3FFFFF) != 0 && v49 && (*(_DWORD *)(qword_140C67EF0 + 8 * (v5 & 0x3FFFFF)) & 0x10000LL) != 0 )
        {
