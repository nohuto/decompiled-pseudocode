...
LABEL_180:
  ...
  if ( (v14 & 0x20000) != 0 )
  {
    if ( !qword_140C37A00 || (LOBYTE(v27) = 8, v29 = v69, LOBYTE(v28) = v69, !(unsigned int)qword_140C37A00(v28, v27)) )
    {
      v29 = 8;
      v69 = 8;
    }
  ...
  if ( Info >= 0 )
  {
    ...
    *(_DWORD *)v80 = v32;
    ...
    while ( 1 )
    {
      ...
      LOBYTE(v63) = v29;
      LOBYTE(v64) = v74;
      if ( !(unsigned int)qword_140C37A00(v64, v63) )
        goto LABEL_180;
