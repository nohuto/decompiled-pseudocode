/*
 * XREFs of IopInitializeBuiltinDriver @ 0x140B41264
 * Callers:
 ...
 *     IopReadyDeviceObjects @ 0x1407E3A14 (IopReadyDeviceObjects.c)
        ...
        char **a6)
{
  ...
  int v36; // [rsp+54h] [rbp-45h] BYREF
  PVOID Object; // [rsp+58h] [rbp-41h]
          ...
          if ( p_Length )
          {
            ...
            if ( (_WORD)v19 )
            {
              ...
              if ( i != v20 )
                v24 = v16;
              Object = (PVOID)v24;
              v25 = (void *)ExAllocatePool2(64LL, v24 + 2LL, 0x344E6F49u);
              v40 = v25;
              v26 = (_WORD *)(v18 + 24);
              if ( v25 )
              {
                ...
                *v26 = (_WORD)v27;
                ...
                v29 = v48;
                *((_WORD *)v40 + ((unsigned __int64)(unsigned __int16)*v26 >> 1)) = 0;
                inserted = IopOpenRegistryKeyEx(&v38, 0LL, v29, 0xF003Fu);
                if ( inserted >= 0 )
                {
                  inserted = PnpPrepareDriverLoading((int)v26, v38, v6, a5, &v35, &v47);
                  NtClose(v38);
                  if ( inserted >= 0 )
                  {
                    p_Length = &v48->Length;
LABEL_32:
                    ...
                    *((_QWORD *)v12 + 9) = &CmRegistryMachineHardwareDescriptionSystemName;
                    ...
                    else if ( !a4 || !v36 || (inserted = MmReapplyBootPatchImports(*(_QWORD *)(a4 + 48)), inserted >= 0) )
                    {
...
LABEL_10:
      ...
      *((_DWORD *)v12 + 8) = v14->OptionalHeader.SizeOfImage;
      if ( _bittest16((const signed __int16 *)&v14->OptionalHeader.DllCharacteristics, 0xDu) )
        goto LABEL_14;
      goto LABEL_13;
    }
  }
