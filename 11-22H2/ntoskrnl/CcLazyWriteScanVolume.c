/*
 * XREFs of CcLazyWriteScanVolume @ 0x14029A4E0
 * Callers:
 ...
 *     CcCalculatePagesToWriteForVolume @ 0x140355A94 (CcCalculatePagesToWriteForVolume.c)
 *     CcAdjustThrottleForVolume @ 0x140356958 (CcAdjustThrottleForVolume.c)
 ...
 *     CcSetLazyWriteScanQueuedInternal @ 0x14035B2E0 (CcSetLazyWriteScanQueuedInternal.c)
 *     CcIsDirtyCachemapListEmptyForVolume @ 0x14036260C (CcIsDirtyCachemapListEmptyForVolume.c)
                                ...
                                a4) )
        {
          ...
          *(_DWORD *)(v28 + 152) |= 0x20u;
          ...
          if ( (_DWORD)KiIrqlFlags )
          {
            ...
            if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v72 <= 0xFu && LockHandle.OldIrql <= 0xFu && v72 >= 2u )
            {
          ...
          else if ( (unsigned int)++v5 >= 0x14 && (v31 & 0x20) == 0 )
          {
            ...
            *(_DWORD *)(v28 + 152) = v31 | 0x20;
            ...
            if ( (_DWORD)KiIrqlFlags )
            {
              ...
              if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v76 <= 0xFu && LockHandle.OldIrql <= 0xFu && v76 >= 2u )
              {
