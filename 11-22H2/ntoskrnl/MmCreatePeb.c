...
__int64 __fastcall MmCreatePeb(__int64 a1, __int64 a2, _QWORD *a3, __int64 a4)
{
  ...
  *(_WORD *)(a4 + 8) = v7;
  ...
  v36 = 0LL;
  v40 = 0LL;
  v10 = MmMapViewOfSection(ExLeapSecondDataSectionPointer, v6, &v37, 0LL, 0LL, &v36, &v40, 1, 5242880, 2);
  ...
  else
  {
    ...
    *(_QWORD *)((char *)&v35[1] + 4) = 10LL;
    ...
    v35[13] = *(_QWORD *)(a2 + 8);
    v35[14] = v12;
    LOWORD(v35[15]) = CurrentServerSiloGlobals[532];
    WORD1(v35[15]) = CurrentServerSiloGlobals[564];
    ...
    if ( (v17 & 0x4000) != 0 )
    {
      v29 = _InterlockedExchangeAdd(&dword_140C65B0C, 1u) + 1;
      do
      {
        v30 = v29 & 0x3F;
        v31 = 1LL << v30;
    ...
    *(_QWORD *)(v26 + 192) = qword_140C65B10;
