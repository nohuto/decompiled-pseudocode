/*
 * XREFs of KiProcessDeferredDpcWatchdogViolation @ 0x14057B298
 * Callers:
...
void (__fastcall __noreturn *__fastcall KiProcessDeferredDpcWatchdogViolation(__int64 a1))(__int64 a1)
{
  ...
  xmmword_140C414B0 = 0LL;
  xmmword_140C414C0 = 0LL;
  LOWORD(xmmword_140C414C0) = *(_WORD *)(a1 + 392);
  *((_QWORD *)&xmmword_140C414B0 + 1) = *(_QWORD *)(a1 + 384);
  LODWORD(xmmword_140C414B0) = *(_DWORD *)(a1 + 376);
  WORD4(KiInjectedMachineFrame) = *(_WORD *)(a1 + 368);
  *(_QWORD *)&KiInjectedMachineFrame = *(_QWORD *)(a1 + 360);
  *((_QWORD *)&xmmword_140C414C0 + 1) = *(_QWORD *)(a1 + 56);
