/*
 * XREFs of SshpSetCollectionActive @ 0x1403AF5A8
 * Callers:
 *     PdcPoSleepStudyHelperSetPhaseActive @ 0x14085EBB0 (PdcPoSleepStudyHelperSetPhaseActive.c)
 *     SshpPowerSettingCallback @ 0x1409A2560 (SshpPowerSettingCallback.c)
 * Callees:
