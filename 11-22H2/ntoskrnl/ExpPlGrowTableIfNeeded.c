/*
 * XREFs of ExpPlGrowTableIfNeeded @ 0x140608604
 * Callers:
...
__int64 ExpPlGrowTableIfNeeded()
{
  ...
  if ( ExPoolLimitState >= 2 * ((unsigned int)dword_140CF81C4 >> 5) )
  {
    v0 = 2 * ((unsigned int)dword_140CF81C4 >> 5);
    v1 = 1;
  ...
  if ( v1 )
  {
    while ( 1 )
    {
      ...
      if ( ExPoolLimitState < 2 * ((unsigned int)dword_140CF81C4 >> 5) )
        break;
      v10 = 2 * ((unsigned int)dword_140CF81C4 >> 5);
      if ( v10 < 4 )
        v10 = 4;
      if ( (unsigned int)v0 >= v10 )
      {
        ...
        v18 = dword_140CF81C4;
        v19 = 0;
        v20 = -1LL << (dword_140CF81C4 & 0x1F);
        if ( (dword_140CF81C4 & 0xFFFFFFE0) != 0 )
        {
          do
          {
            v21 = qword_140CF81C8;
          ...
          while ( v19 < (unsigned int)dword_140CF81C4 >> 5 );
        }
        v24 = (char *)qword_140CF81C8;
        qword_140CF81C8 = Pool2;
        Pool2 = v24;
        dword_140CF81C4 = (32 * v0) | v18 & 0x1F;
        KxReleaseQueuedSpinLock((volatile signed __int64 **)&LockHandle);
