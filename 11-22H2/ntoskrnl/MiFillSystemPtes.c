/*
 * XREFs of MiFillSystemPtes @ 0x14027E7A0
 * Callers:
 ...
 *     MiIoPagesInRun @ 0x14035FB78 (MiIoPagesInRun.c)
        ...
        _DWORD *a6)
{
  ...
  int ProtectionPfnCompatible; // [rsp+E8h] [rbp+20h]

  LOBYTE(ProtectionPfnCompatible) = a4;
  v6 = a1;
  v66 = 0LL;
  v68 = 0LL;
  v60 = 0;
  ...
  *a6 = 0;
  ...
  else
  {
    ...
    if ( a1 >= 0xFFFFF6FB40000000uLL && a1 <= 0xFFFFF6FB7FFFFFFFuLL )
    {
      ...
      v50 = MiUserPdeOrAbove(a1, 0xFFFFF6FFFFFFFFFFuLL, a2);
      v8 = v69;
    ...
    {
      v17 = HIBYTE(word_140C66DFC);
      goto LABEL_20;
    }
    if ( byte_140C6A4D8[((v15 >> 39) & 0x1FF) - 256] != 1
      && (v15 < 0xFFFFF68000000000uLL || v15 > 0xFFFFF6FFFFFFFFFFuLL) )
    {
      if ( v15 < qword_140C6A658 || v15 > qword_140C67170 )
        v17 = (unsigned __int8)word_140C66DFC;
      else
        v17 = HIBYTE(word_140C66DFC);
LABEL_20:
      if ( v17 )
  ...
  if ( (v12 & 0x40000000) != 0 )
    v18 &= ~4uLL;
  v19 = ((unsigned __int16)v18 ^ (unsigned __int16)((unsigned __int8)word_140C66DFC << 8)) & 0x100 ^ (unsigned __int64)v18;
  if ( (v12 & 0x8000000) != 0 )
    v19 &= ~0x100uLL;
  if ( v16 )
    v19 |= 0x80uLL;
...
LABEL_51:
  ...
  if ( v22 > qword_140C65CA0 )
  {
LABEL_63:
    if ( v23 )
    {
      v45 = 2 * (((unsigned int)v22 & ((1 << (dword_140C65BE0 - 12)) - 1)) - *(_DWORD *)(v62 + 24));
    ...
    else
    {
      ...
      if ( v26 == 3 )
      {
        if ( v21 )
        {
          ...
          if ( v24 > 1 )
          {
            ...
            do
            {
              ...
              if ( *v47 != *(v47 - 1) + 1
                || (v48 & 0x1FF) == 0
                || v48 <= qword_140C65CA0 && _bittest64((const signed __int64 *)(48 * v48 - 0x21FFFFFFFFD8LL), 0x36u) )
              {
                break;
              }
              ++v36;
        ...
        v37 = MiReferenceIoPages(1, v22, v36, v8, 0LL, (__int64)&v61);
        if ( v37 < 0 )
          goto LABEL_139;
        v38 = v61;
        v10 = ProtectionPfnCompatible;
        v39 = (1LL << ((unsigned __int8)dword_140C65BE0 - 12)) - 1;
        v62 = v61;
        *a6 |= 1u;
...
LABEL_139:
  if ( (*a6 & 1) != 0 )
    MiZeroAndFlushPtes((__int64)(((v24 - a2) << 28) + (v6 << 25)) >> 16, a2 - v24, 1LL, v23);
