/*
 * XREFs of MiPurgeBadFileOnlyPages @ 0x14063EAE0
 * Callers:
...
__int64 MiPurgeBadFileOnlyPages()
{
  ...
  do
  {
    while ( 1 )
    {
      ...
      v3 = qword_140C65798;
      byte_140C6582A = 0;
      if ( qword_140C65798 == 0x3FFFFFFFFFLL )
      {
      ...
      v4 = 48 * qword_140C65798 - 0x220000000000LL;
  ...
  CurrentIrql = ExAcquireSpinLockExclusive(&dword_140C6CF60);
  if ( qword_140C65788 )
    byte_140C6582A = 1;
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C6CF60);
  if ( (_DWORD)KiIrqlFlags )
