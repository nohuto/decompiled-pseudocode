/*
 * XREFs of WbAddHeapExecutedBlockToCache @ 0x140762020
 * Callers:
...
__int64 __fastcall WbAddHeapExecutedBlockToCache(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( v9 )
    *(_BYTE *)(v9 + 18) = 1;
  v10 = sub_140763660(a1, *(_QWORD *)(a2 + 48), &v18, &v17);
  v12 = v10;
  if ( v10 >= 0 )
  {
    if ( a3 )
  ...
  {
    v12 = sub_140764214((int)a1 + 8, a2, v11, *(_QWORD *)(a2 + 48), 8, v17);
    if ( v12 >= 0 )
    {
      v12 = sub_140763538(a2);
      if ( v12 >= 0 )
      {
        if ( a3 )
          *a3 = 0LL;
