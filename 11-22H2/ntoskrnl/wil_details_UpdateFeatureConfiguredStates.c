/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x140A12424
 * Callers:
 ...
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x140810ECC (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
