/*
 * XREFs of DifAddDeviceWrapper @ 0x1405D5E60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifAddDeviceWrapper(__int64 a1, __int64 a2)
{
  ...
  v16 = 0LL;
  v17 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(268435486);
...
LABEL_17:
  result = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 64LL) + 24LL))(a1, a2);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
