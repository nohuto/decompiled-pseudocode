...
LABEL_25:
  v36 = a4 & 2;
  if ( (a4 & 2) == 0 && byte_140C65BE9 != (_BYTE)v36 && a1[1] != -1LL )
    MiReuseUltraPageTable(a1, 0LL);
  _bittestandset64((signed __int64 *)qword_140C68620, v30);
LABEL_28:
  if ( v36 )
  {
    *a1 = 0LL;
    ...
    if ( a2 )
    {
      ...
      do
      {
        ...
        if ( MiPteInShadowRange(v42) )
        {
          ...
          {
            if ( !HIBYTE(word_140C66DFC) && (v45 & 1) != 0 )
