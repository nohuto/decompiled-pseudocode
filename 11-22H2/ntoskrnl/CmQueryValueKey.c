/*
 * XREFs of CmQueryValueKey @ 0x1406E0370
 * Callers:
...
__int64 __fastcall CmQueryValueKey(__int64 a1, unsigned __int16 *a2, int a3, size_t a4, unsigned int a5, __int64 a6)
{
  ...
  _OWORD v54[3]; // [rsp+B0h] [rbp-21h] BYREF
  ...
  *(_OWORD *)Privileges = 0LL;
  ...
  if ( (_WORD)v21 )
  {
    ...
    do
    {
      CmpSetKcbAtLayerHeight(&v46, (unsigned __int16)v21, *(_QWORD *)(v22 + 16));
      v22 = *(_QWORD *)(v23 + 24);
      LOWORD(v21) = v21 - 1;
    }
    while ( v22 );
...
LABEL_12:
    ...
    KeyValueData = CmpTransSearchAddTransFromKeyBody(a1, &v49);
    if ( KeyValueData < 0 )
    {
      v19 = Pool;
      goto LABEL_67;
...
LABEL_67:
  ...
  CmpDetachFromRegistryProcess(v54);
  if ( v19 )
    CmSiFreeMemory(v19);
