/*
 * XREFs of PfSnAltProfileFindByScenarioId @ 0x1407E09AC
 * Callers:
...
unsigned __int64 __fastcall PfSnAltProfileFindByScenarioId(wchar_t *Str2)
{
  ...
  v2 = *((_QWORD *)&xmmword_140C6A820 + 1);
  if ( (qword_140C6A830 & 1) != 0 && *((_QWORD *)&xmmword_140C6A820 + 1) )
    v2 = ((unsigned __int64)&xmmword_140C6A820 + 8) ^ *((_QWORD *)&xmmword_140C6A820 + 1);
  v3 = qword_140C6A830 & 1;
  while ( v2 )
  {
