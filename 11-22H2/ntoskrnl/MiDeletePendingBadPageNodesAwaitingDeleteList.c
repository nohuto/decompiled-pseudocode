/*
 * XREFs of MiDeletePendingBadPageNodesAwaitingDeleteList @ 0x140629A70
 * Callers:
 *     <none>
 * Callees:
...
__int64 MiDeletePendingBadPageNodesAwaitingDeleteList()
{
  ...
  for ( i = ExAcquireSpinLockExclusive(&dword_140C67410); ; i = ExAcquireSpinLockExclusive(&dword_140C67410) )
  {
    v8 = qword_140C67420;
    v9 = i;
    if ( qword_140C67420 == &qword_140C67420 )
      break;
    v1 = *(_QWORD **)qword_140C67420;
    v2 = (PVOID *)*((_QWORD *)qword_140C67420 + 1);
    if ( *(PVOID *)(*(_QWORD *)qword_140C67420 + 8LL) != qword_140C67420 || *v2 != qword_140C67420 )
      __fastfail(3u);
    *v2 = v1;
    v1[1] = v2;
    --qword_140C67430;
