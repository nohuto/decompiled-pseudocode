/*
 * XREFs of PoQueueShutdownWorkItem @ 0x140986E70
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall PoQueueShutdownWorkItem(PWORK_QUEUE_ITEM WorkItem)
{
  ...
  {
    v3 = (struct _LIST_ENTRY *)qword_140C3E9C8;
    if ( *(__int64 **)qword_140C3E9C8 != &PopShutdownQueue )
      __fastfail(3u);
    WorkItem->List.Flink = (struct _LIST_ENTRY *)&PopShutdownQueue;
    WorkItem->List.Blink = v3;
    v3->Flink = &WorkItem->List;
    qword_140C3E9C8 = (__int64)WorkItem;
  }
  else
  {
    v2 = -1073741077;
