/*
 * XREFs of CmpCheckValueList @ 0x1406DE570
 * Callers:
        ...
        unsigned int *a10)
{
  ...
  _DWORD v81[2]; // [rsp+30h] [rbp-79h] BYREF
  unsigned int v82; // [rsp+38h] [rbp-71h]
  _WORD v83[2]; // [rsp+3Ch] [rbp-6Dh] BYREF
  ULONG_PTR BugCheckParameter4; // [rsp+40h] [rbp-69h]
  _DWORD v85[2]; // [rsp+48h] [rbp-61h] BYREF
  _BYTE *v86; // [rsp+50h] [rbp-59h]
  __int64 v87; // [rsp+58h] [rbp-51h] BYREF
  _DWORD v88[2]; // [rsp+60h] [rbp-49h] BYREF
  _DWORD v89[2]; // [rsp+68h] [rbp-41h] BYREF
  _DWORD v90[2]; // [rsp+70h] [rbp-39h] BYREF
...
LABEL_64:
    ...
    if ( (*(_BYTE *)(v29 + 16) & 1) != 0 )
    {
      v37 = CmpCompareCompressedName(&CmSymbolicLinkValueName, v29 + 20, *(unsigned __int16 *)(v29 + 2), 0LL);
    }
    else
    {
      *((_QWORD *)&v93 + 1) = v29 + 20;
...
LABEL_96:
              ...
              v48 = (*v45 & 1) != 0 ? HvpGetCellFlat(BugCheckParameter3, v43) : HvpGetCellPaged(BugCheckParameter3);
              if ( !v48 || v48 == 4 )
              {
                v16 = BugCheckParameter4;
              }
