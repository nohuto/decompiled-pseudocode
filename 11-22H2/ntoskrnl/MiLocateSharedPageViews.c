/*
 * XREFs of MiLocateSharedPageViews @ 0x140636550
 * Callers:
...
__int64 __fastcall MiLocateSharedPageViews(unsigned __int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 8) = 0LL;
  ...
  if ( v7->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(0LL, (__int64)v7)) != 0 )
  {
    ...
    *(_QWORD *)v6 = (unsigned __int64)&qword_140C6B5D8 & 0x7FFFFFFFFFFFFFFCLL;
  }
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C6B5D8, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&qword_140C6B5D8, 0LL, v6, (__int64)&qword_140C6B5D8);
  if ( v6 )
    *(_BYTE *)(v6 + 18) = 1;
  if ( a1 > qword_140C65CA0 || !_bittest64((const signed __int64 *)(48 * a1 - 0x21FFFFFFFFD8LL), 0x36u) )
  {
    v23 = _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C6B5D8, 0LL, 17LL) == 17;
    goto LABEL_113;
  }
