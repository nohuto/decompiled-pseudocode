/*
 * XREFs of CcWorkerThread @ 0x140298820
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CcOkToAddWriteBehindThread @ 0x140536C48 (CcOkToAddWriteBehindThread.c)
...
__int64 __fastcall CcWorkerThread(__int64 a1)
{
  ...
  else
  {
    v4 = v3 == 2;
    if ( v3 != 2 )
      KeBugCheckEx(0x34u, 0x19E6uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
  }
  v56 = v4;
  v5 = *(_QWORD *)(a1 + 56);
  v70 = v5;
...
LABEL_26:
      ...
      {
        NextWorkQueueEntry = CcFindNextWorkQueueEntry(v15, v14, v1);
...
LABEL_19:
    ...
    if ( (xmmword_140D1EAD0 & 0x20000) != 0 )
    {
      ...
      if ( (xmmword_140D1EAD0 & 0x20000) != 0 )
      {
        ...
        v76[0] = &v66;
        v76[1] = 8LL;
        EtwTraceKernelEvent((int)v76, 1, 0x80020000, 5633, 4200706);
      }
    }
    ...
    else
    {
      if ( (xmmword_140D1EAD0 & 0x20000) != 0 )
      {
        ...
        v77[0] = &v74;
        v77[1] = 8LL;
        EtwTraceKernelEvent((int)v77, 1, 0x80020000, 5634, 4200706);
      }
