/*
 * XREFs of MiSetVaAgeList @ 0x1402708C0
 * Callers:
 ...
 *     MiUpdateWsleAge @ 0x140294494 (MiUpdateWsleAge.c)
...
__int64 __fastcall MiSetVaAgeList(__int64 a1, unsigned __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  _DWORD v80[8]; // [rsp+90h] [rbp-68h] BYREF
  ...
  else
  {
    ...
    else
    {
      ...
      MiLockPageTableInternal(a1, v8, 0, a4);
      a4 = v63;
    }
  }
    ...
    if ( v13 == (_DWORD)v5 )
    {
      ...
      else
      {
        ...
        if ( v66 != v69 )
        {
          ...
          LOBYTE(v11) = -1;
          ExpWaitForSpinLockSharedAndAcquire(v16, v11);
        }
      }
    }
    else
...
LABEL_31:
      ...
      else if ( v72 || (*(_BYTE *)(a1 + 184) & 7) == 0 )
      {
        ...
        if ( v24 == 7 )
        {
          ...
          v17 = *(_QWORD *)(qword_140C674C8 + 8 * v40);
          ...
          if ( (unsigned __int64)v11 >= *(_QWORD *)(v41 + 56) )
          {
            ...
            if ( *(_QWORD *)(a1 + 24) )
            {
              ...
              {
                KeAcquireInStackQueuedSpinLockAtDpcLevel(&qword_140C698C0, &v79);
                ...
                KxReleaseQueuedSpinLock((volatile signed __int64 **)&v79);
              }
            }
          }
        }
