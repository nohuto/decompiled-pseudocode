/*
 * XREFs of CcWaitForCurrentLazyWriterActivityOnPartition @ 0x1403D3F2C
 * Callers:
 *     CcWaitForCurrentLazyWriterActivityHelper @ 0x1403D3F00 (CcWaitForCurrentLazyWriterActivityHelper.c)
