/*
 * XREFs of VslpIumPhase0Initialize @ 0x140B945CC
 * Callers:
 ...
 *     VslpIumPhase0InitializeNtKd @ 0x140B94884 (VslpIumPhase0InitializeNtKd.c)
 */
...
__int64 __fastcall VslpIumPhase0Initialize(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(result + 132) & 0x200) != 0 )
  {
    ...
    byte_140C5F2E2 = 8;
    dword_140C5F2E4 = HIDWORD(v12[2]);
    dword_140C5F2F8 = HIDWORD(v12[2]);
    VslVsmEnabled = 1;
