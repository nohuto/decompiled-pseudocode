/*
 * XREFs of DifpLwSPProcessPrePoolAlloc @ 0x140AE8BEC
 * Callers:
 *     DifpExAllocatePoolWithTagPriority_LwSP_Enter @ 0x140AE8B40 (DifpExAllocatePoolWithTagPriority_LwSP_Enter.c)
 * Callees:
