/*
 * XREFs of MiTradeTransitionPage @ 0x1403BD5C0
 * Callers:
 ...
 *     MiCanPageMove @ 0x1403BD84C (MiCanPageMove.c)
...
__int64 __fastcall MiTradeTransitionPage(ULONG_PTR BugCheckParameter2, unsigned __int8 a2, int a3, int a4, __int64 *a5)
{
  ...
  else
  {
    if ( (unsigned int)MiCanPageMove(BugCheckParameter2) )
    {
      ...
      {
        v40 = *(_QWORD *)(qword_140C674C8 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 43) & 0x3FFLL));
        _InterlockedAnd64((volatile signed __int64 *)(BugCheckParameter2 + 24), 0x7FFFFFFFFFFFFFFFuLL);
        ...
        if ( a3 == -1 )
        {
          ...
          v12 = (PfnChannel << byte_140C65B8E) | dword_140C65BF8 & v8 | (v9 << byte_140C65B8D);
          if ( (a4 & 0x2000000) != 0 )
            v11 |= 0x20000u;
        }
        else
        {
          v11 = 48;
          v12 = dword_140C65BF8 & v8 | a3 & ~dword_140C65BF8;
        }
