/*
 * XREFs of MiHandleForkTransitionPte @ 0x1406649B8
 * Callers:
        ...
        _DWORD *a12)
{
  ...
  v63 = v19;
  v72 = v19;
  v20 = *(volatile signed __int64 **)(qword_140C674C8 + 8 * v18);
  v64 = (__int64)v20;
  v67 = *(volatile signed __int64 **)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(v21 + 1838));
  if ( v67 != v20 )
  {
    v63 = (a9 & 1) + 2;
...
LABEL_17:
  ...
  *(_QWORD *)v12 = v25;
  ...
  if ( v41 )
  {
    ...
    {
      v40 = v43 + 1;
      if ( HIBYTE(word_140C66DFC) == (_BYTE)v43 )
      {
...
LABEL_51:
  ...
  v54 = v53 + 1;
  if ( HIBYTE(word_140C66DFC) == (_BYTE)v53 && ((unsigned __int8)v15 & (unsigned __int8)v54) != 0 )
    v51 = v15 | 0x8000000000000000uLL;
LABEL_52:
  *a3 = v51;
  if ( v54 )
