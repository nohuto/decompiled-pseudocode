/*
 * XREFs of EmInitSystem @ 0x140B54E68
 * Callers:
 ...
 *     HalRegisterErrataCallbacks @ 0x140B54E30 (HalRegisterErrataCallbacks.c)
...
__int64 __fastcall EmInitSystem(int a1, __int64 a2)
{
  ...
  if ( !a1 )
  {
    ...
    EmpProviderRegister(0LL, 0LL, 0, (__int64)&off_140002610, 1u, &v18);
