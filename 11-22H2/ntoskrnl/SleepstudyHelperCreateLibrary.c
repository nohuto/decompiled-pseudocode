/*
 * XREFs of SleepstudyHelperCreateLibrary @ 0x140849A10
 * Callers:
 *     SleepstudyHelper_Initialize @ 0x1408499C0 (SleepstudyHelper_Initialize.c)
    ...
    if ( SshpInitialized && SSHSupportQueryIsLibraryEnabled() )
    {
      ...
      if ( NonPaged )
      {
        ...
        *v8 = v8;
        ...
        v9 = (_QWORD *)qword_140C38B98;
        if ( *(__int64 **)qword_140C38B98 != &SshpLibraryList )
          __fastfail(3u);
        *v7 = &SshpLibraryList;
        v7[1] = v9;
        *v9 = v7;
        qword_140C38B98 = (__int64)v7;
