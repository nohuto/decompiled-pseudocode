/*
 * XREFs of CarEtwWriteLiveDumpEvent @ 0x1405D2F20
 * Callers:
...
void __fastcall CarEtwWriteLiveDumpEvent(int *a1, int a2, int a3)
{
  ...
  if ( a1 )
  {
    ...
    if ( (unsigned int)dword_140C09368 > 5 && tlgKeywordOn((__int64)&dword_140C09368, 0x800000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_14003455C,
        0LL,
        0LL,
        8u,
        &v11);
