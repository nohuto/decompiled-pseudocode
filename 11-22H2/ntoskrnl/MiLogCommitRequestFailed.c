/*
 * XREFs of MiLogCommitRequestFailed @ 0x140A439C4
 * Callers:
 ...
 *     PsQueryJobMemoryUsageByProcess @ 0x1409B1D90 (PsQueryJobMemoryUsageByProcess.c)
 */
...
char __fastcall MiLogCommitRequestFailed(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( *(_QWORD *)&qword_140C699E8 )
  {
    ...
    if ( (v3 & 0x400) == 0 )
    {
      ...
      {
        LOBYTE(v3) = tlgKeywordOn(*(__int64 *)&qword_140C699E8, 0x400000000000LL);
        if ( (_BYTE)v3 )
        {
          v30 = v14;
          v37 = &v32;
          ...
          v31 = v16;
          v62 = 8LL;
          LOBYTE(v3) = tlgWriteEx_EtwWriteEx(v15, (unsigned __int8 *)&byte_1400395ED, v13, 1u, v18, v19, 0xFu, &v36);
        }
      }
    }
  }
