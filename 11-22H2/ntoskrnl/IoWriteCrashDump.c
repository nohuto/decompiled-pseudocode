/*
 * XREFs of IoWriteCrashDump @ 0x1405513A0
 * Callers:
        ...
        char a9)
{
  ...
  if ( !DWORD1(xmmword_140C64DD8) || byte_140C64DD4 )
  {
    v49 = a4;
    v50 = a5;
    v47 = v11;
...
LABEL_16:
    ...
    ((void (__fastcall *)(__int64, _QWORD, _QWORD))qword_140C6AD50)(1LL, 0LL, v13);
    ...
    LOBYTE(v18) = 1;
    ViVerifyDma = 0;
    v21 = ((__int64 (__fastcall *)(__int64))qword_140C6AD80)(v18);
...
LABEL_57:
            if ( v14 >= 0 )
              v14 = ((__int64 (__fastcall *)(__int64, __int64))qword_140C6AD58)(CrashdmpDumpBlock, a8);
            if ( v14 != -1073741267 )
              goto LABEL_67;
            if ( (*(_DWORD *)(CrashdmpDumpBlock + 1368) & 4) != 0 )
            {
              ...
              *(_DWORD *)(CrashdmpDumpBlock + 1368) |= 8u;
              ...
              if ( v14 < 0 )
                goto LABEL_67;
              v38 = ((__int64 (__fastcall *)(__int64, __int64))qword_140C6AD58)(CrashdmpDumpBlock, a8);
              v39 = 38;
            }
            else
            {
