/*
 * XREFs of MiLockDynamicMemoryNestedExclusive @ 0x14061B734
 * Callers:
...
unsigned __int64 __fastcall MiLockDynamicMemoryNestedExclusive(__int64 a1)
{
    ...
    || (result = KiAbTryReclaimOrphanedEntries(a1, (__int64)CurrentThread), (_DWORD)result) )
  {
    ...
    *(_DWORD *)(v2 + 8) = SessionId;
    result = (unsigned __int64)&qword_140C6B5D8 & 0x7FFFFFFFFFFFFFFCLL;
    *(_QWORD *)v2 = (unsigned __int64)&qword_140C6B5D8 & 0x7FFFFFFFFFFFFFFCLL;
  }
  if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C6B5D8, 0LL) )
    result = ExfAcquirePushLockExclusiveEx(&qword_140C6B5D8, v2, (__int64)&qword_140C6B5D8);
  if ( v2 )
    *(_BYTE *)(v2 + 18) = 1;
  return result;
}
