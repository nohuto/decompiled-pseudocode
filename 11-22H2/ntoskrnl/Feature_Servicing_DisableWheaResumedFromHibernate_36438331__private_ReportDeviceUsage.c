/*
 * XREFs of Feature_Servicing_DisableWheaResumedFromHibernate_36438331__private_ReportDeviceUsage @ 0x140416320
 * Callers:
...
void Feature_Servicing_DisableWheaResumedFromHibernate_36438331__private_ReportDeviceUsage()
{
  ...
  if ( (Feature_Servicing_DisableWheaResumedFromHibernate_36438331__private_featureState & 0x10) == 0 )
  {
    ...
    wil_details_FeatureReporting_ReportUsageToService((__int64)&wil_details_featureDescriptors_a, v0, 3u, 1LL);
