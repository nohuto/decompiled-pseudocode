/*
 * XREFs of DifZwQuerySectionWrapper @ 0x1405F55D0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQuerySectionWrapper(
        ...
        PSIZE_T ReturnLength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(608);
...
LABEL_10:
  ...
  *((_QWORD *)&v23 + 1) = SectionHandle;
  LODWORD(v23) = SectionInformationClass;
  *((_QWORD *)&v22 + 1) = SectionInformation;
  *(_QWORD *)&v22 = SectionInformationLength;
