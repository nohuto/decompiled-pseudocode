/*
 * XREFs of PpmCheckComputeHeteroResponse @ 0x140596500
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PpmHeteroUtilityGreaterThanOrEqualThreshold @ 0x140597A5C (PpmHeteroUtilityGreaterThanOrEqualThreshold.c)
