/*
 * XREFs of CcQueueLazyWriteScanThread @ 0x140536EF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CcIsLazyWriteScanQueuedInternal @ 0x14035C920 (CcIsLazyWriteScanQueuedInternal.c)
...
LABEL_16:
  ...
  for ( i = v11 + 1; i > 1; i = v11 + 1 )
  {
    ...
    if ( v13 == v11 )
    {
      v14 = StartContext[14];
      if ( !v14 )
        KeBugCheckEx(0x34u, 0x7A5uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
