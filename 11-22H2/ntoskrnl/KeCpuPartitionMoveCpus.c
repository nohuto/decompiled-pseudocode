/*
 * XREFs of KeCpuPartitionMoveCpus @ 0x140574E64
 * Callers:
...
__int64 __fastcall KeCpuPartitionMoveCpus(__int64 a1, __int64 a2, char *a3, char a4)
{
  ...
  if ( (unsigned int)KeIsSubsetAffinityEx((__int64)a3, a2)
    && (a4 || !(unsigned int)KeIsEqualAffinityEx((unsigned __int16 *)a3, (unsigned __int16 *)a2)) )
  {
    ...
    else
    {
      ...
      if ( a2 != KiSystemCpuPartition || (v8 = KiModifySystemAllowedCpuSetsWithLock(0, 0LL, a3, 0, 2), v8 >= 0) )
      {
        ...
        if ( a1 == KiSystemCpuPartition )
          v8 = KiModifySystemAllowedCpuSetsWithLock(0, 0LL, a3, 0, 1);
      }
    }
  }
  else
