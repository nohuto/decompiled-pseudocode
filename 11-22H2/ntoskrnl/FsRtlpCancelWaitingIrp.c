/*
 * XREFs of FsRtlpCancelWaitingIrp @ 0x14053E334
 * Callers:
 *     FsRtlpWaitOnIrp @ 0x1402010B8 (FsRtlpWaitOnIrp.c)
 *     FsRtlpWaitingIrpCancelRoutine @ 0x14053EF60 (FsRtlpWaitingIrpCancelRoutine.c)
 * Callees:
...
void __fastcall FsRtlpCancelWaitingIrp(__int64 a1, char a2)
{
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    v25 = &v9;
    v26 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)&word_140029F06, 0LL, 0LL, 4u, v22);
  }
  if ( !a2 )
  ...
  for ( i = *(_QWORD **)(v3 + 88); ; i = (_QWORD *)*i )
  {
    ...
    if ( (unsigned int)dword_140C03768 > 5 )
    {
      ...
      v29 = &v7;
      v30 = 1LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03768, (unsigned __int8 *)byte_140029F91, 0LL, 0LL, 6u, v22);
      v5 = i;
    }
    v6 = i[2];
    if ( v6 )
  ...
  if ( (unsigned int)dword_140C03768 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&dword_140029F4C,
      0LL,
      0LL,
      4u,
      &v17);
