/*
 * XREFs of DbgkLkmdRegisterCallback @ 0x140844A20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DbgkLkmdRegisterCallback(__int64 a1, __int64 a2, int a3)
{
  ...
  for ( j = 0; j < 8; ++j )
  {
    if ( ExCompareExchangeCallBack((signed __int64 *)&stru_140C70CA0 + 2 * j, v9, 0LL) )
    {
      *((_DWORD *)&stru_140C70CA0 + 4 * j + 2) = a3;
      return 0LL;
    }
  }
