/*
 * XREFs of RtlpHpHeapAllocate @ 0x140397AD8
 * Callers:
...
volatile signed __int64 *__fastcall RtlpHpHeapAllocate(__int64 a1, unsigned int a2, __int128 *a3)
{
  ...
  if ( v14 && (v15 & 0x40000000) == 0 && !BYTE2(v22) && v12 < *(unsigned int *)(v14 + 528) )
  {
    ...
    if ( !v20 )
      return v18;
    v25 = *a3;
    RtlpHpMetadataCommit((_DWORD)v20, (_DWORD)v20 + 4096, v12 - 4096, (unsigned int)&v25, 0);
    goto LABEL_11;
  }
  v16 = BYTE1(v22);
...
LABEL_12:
  ...
  {
    v25 = *a3;
    RtlpHpFreeVA((unsigned __int64 *)&v26, &v21, v5 | 0x8000u, &v25);
  }
  return v18;
}
