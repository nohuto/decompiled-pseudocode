/*
 * XREFs of DifZwSetBootEntryOrderWrapper @ 0x1405F67A0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwSetBootEntryOrderWrapper(PULONG Ids, ULONG Count)
{
...
LABEL_17:
  result = ZwSetBootEntryOrder(Ids, Count);
  DWORD2(v17) = result;
  if ( v9 )
  {
    v14 = (_QWORD **)(v9 + 6);
