/*
 * XREFs of MiTrimOrAgeWorkingSet @ 0x14025B380
 * Callers:
 ...
 *     MiComputeTrimAmount @ 0x140634524 (MiComputeTrimAmount.c)
 */
...
__int64 __fastcall MiTrimOrAgeWorkingSet(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v6 = *(_QWORD *)(*(_QWORD *)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(a1 + 174)) + 16920LL);
