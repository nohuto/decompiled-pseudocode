/*
 * XREFs of KePrepareNonClockOwnerForIdle @ 0x1402C1CAC
 * Callers:
 *     PpmIdleExecuteTransition @ 0x1402C52F0 (PpmIdleExecuteTransition.c)
 * Callees:
 *     KiFindNextTimerDueTime @ 0x14027E1A0 (KiFindNextTimerDueTime.c)
  ...
  while ( (v8->TypeFlags & 3) != 1 )
  {
    ...
    if ( v7 >= 7 )
    {
      ...
      if ( (unsigned int)dword_140C02F60 > 5 )
        tlgWriteTransfer_EtwWriteTransfer(&dword_140C02F60, word_14002D4F2, 0LL, 0LL, 2, v24);
      NextTickDueTime = -1LL;
      goto LABEL_20;
    }
  }
