/*
 * XREFs of CmpSaveBootControlSet @ 0x140A0A5C8
 * Callers:
...
LABEL_55:
    ...
    v61 = 8LL;
    v60 = &v46;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04390, v42, 0LL, 0LL, 4u, &v57);
  }
