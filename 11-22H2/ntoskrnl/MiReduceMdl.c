/*
 * XREFs of MiReduceMdl @ 0x14033E2A4
 * Callers:
...
__int64 __fastcall MiReduceMdl(__int64 a1)
{
  ...
  v9 = a1 + 8 * v8;
  if ( *(_QWORD *)(v9 + 40) == qword_140C69808 )
  {
    v12 = *(_DWORD *)(a1 + 40);
    v13 = v12;
    *(_WORD *)(a1 + 8) -= 8;
  ...
  *(_WORD *)(a1 + 10) = v10;
  if ( v8 )
  {
    while ( *(_QWORD *)v1 != qword_140C69808 )
    {
      ++v2;
      v1 += 8;
      if ( v2 >= v8 )
