/*
 * XREFs of FsRtlNotifyFilterReportChange @ 0x14084C6F0
 * Callers:
 *     FsRtlNotifyFullReportChange @ 0x14084C690 (FsRtlNotifyFullReportChange.c)
 *     FsRtlNotifyReportChange @ 0x140940180 (FsRtlNotifyReportChange.c)
 * Callees:
