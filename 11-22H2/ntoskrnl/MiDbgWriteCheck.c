/*
 * XREFs of MiDbgWriteCheck @ 0x14038A514
 * Callers:
...
unsigned __int64 __fastcall MiDbgWriteCheck(unsigned __int64 a1, __int64 *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( (MiFlags & 0x800) == 0 )
    goto LABEL_35;
  if ( v8 > qword_140C65CA0 || ((*(_QWORD *)(48 * v8 - 0x21FFFFFFFFD8LL) >> 54) & 1) == 0 )
  {
LABEL_43:
    v18 = 0;
    goto LABEL_37;
...
LABEL_12:
  ...
  if ( v5 || (unsigned int)MiDbgMarkPfnModified(a1, v7) )
  {
    *v2 = v7;
    v12 = v7 | 0x862;
    v23 = v12;
    _InterlockedIncrement(&dword_140C68154);
    v13 = 0;
    v14 = v12;
...
LABEL_17:
      *v6 = v14;
      ...
      _InterlockedDecrement(&dword_140C68154);
      goto LABEL_12;
    }
    if ( MiPteHasShadow() )
    {
