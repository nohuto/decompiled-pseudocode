/*
 * XREFs of MiAdvanceVadView @ 0x14030BABC
 * Callers:
...
__int64 __fastcall MiAdvanceVadView(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 48) & 0x200000) == 0 )
  {
    ...
    if ( v10 )
    {
      SubsectionNode = MiLocatePagefileSubsection((unsigned int *)(v7 + 128), &v17);
      v9 = v17;
    }
    else
    {
    ...
    v14 = v9 - (*((unsigned int *)SubsectionNode + 9) | ((unsigned __int64)(SubsectionNode[16] & 0xFFC0) << 26));
    *(_QWORD *)(a1 + 72) = SubsectionNode;
    v15 = *((_QWORD *)SubsectionNode + 1) + 8 * v14;
