/*
 * XREFs of CcInitializeVolumeCacheMap @ 0x14032EE94
 * Callers:
...
__int64 __fastcall CcInitializeVolumeCacheMap(_QWORD *Object, __int64 **a2)
{
  ...
  *((_DWORD *)v7 + 51) = _InterlockedIncrement(&CcNextVolumeId);
  ...
  v16 = (_QWORD *)qword_140C5FBE8;
  v17 = v7 + 2;
  if ( *(__int64 **)qword_140C5FBE8 != &CcVolumeCacheMapList )
    __fastfail(3u);
  *v17 = &CcVolumeCacheMapList;
  v7[3] = (__int64)v16;
  *v16 = v17;
  qword_140C5FBE8 = (__int64)(v7 + 2);
  _InterlockedIncrement64(&qword_140C5F968);
