/*
 * XREFs of CmpCommitPreparedLightWeightTransaction @ 0x140A1C694
 * Callers:
...
void __fastcall CmpCommitPreparedLightWeightTransaction(__int64 a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    if ( (unsigned int)dword_140C04390 > 5 && tlgKeywordOn((__int64)&dword_140C04390, 1LL) )
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04390, (unsigned __int8 *)byte_1400373C9, 0LL, 0LL, 2u, v9);
