/*
 * XREFs of MiSetProtectionOnSection @ 0x140277B60
 * Callers:
 ...
 *     MiImageVadHotPatchEligible @ 0x1407BAC20 (MiImageVadHotPatchEligible.c)
 *     MiGetImageHotPatchTableAddress @ 0x140A372D0 (MiGetImageHotPatchTableAddress.c)
 */
        ...
        __int64 a8)
{
  ...
  v132 = *(_QWORD *)(qword_140C674C8 + 8LL * *(unsigned __int16 *)(v117 + 174));
  if ( v116 == 5 )
  {
  ...
  if ( v60 - qword_140C65AE8 < 0x8000000000LL )
...
LABEL_9:
  ...
  {
    v27 = (volatile __int32 *)&unk_140C6A280;
    goto LABEL_14;
  }
...
LABEL_44:
    ...
    if ( (v38 & 0x400) != 0 )
    {
      ...
      {
        v110 = v38;
        if ( qword_140C65C40 && (v38 & 0x10) == 0 )
          v110 = v38 & ~qword_140C65C40;
      ...
      if ( MiPteInShadowRange(v17) )
      {
        ...
        {
          v111 = v80;
          if ( !HIBYTE(word_140C66DFC) && (v80 & 1) != 0 )
