/*
 * XREFs of RtlpGenericInverseCouplingWorker @ 0x14067B2B8
 * Callers:
 *     RtlScrubMemory @ 0x14067B008 (RtlScrubMemory.c)
 * Callees:
 *     RtlpTestAndFillMemoryUp @ 0x14067BB0C (RtlpTestAndFillMemoryUp.c)
 *     RtlpTestMemory @ 0x14067BB34 (RtlpTestMemory.c)
 */
