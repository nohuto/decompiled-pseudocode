/*
 * XREFs of MiTransferFileExtent @ 0x14063F8DC
 * Callers:
...
LABEL_7:
  ...
  if ( MappedSystemVa )
  {
    ...
    v81 = v18;
    v19 = MiReservePtes((__int64)&qword_140C69A40, v9);
    v20 = (__int64 *)v19;
    if ( !v19 )
    {
      v77 = 1LL;
...
LABEL_50:
      MiReleasePtes((__int64)&qword_140C69A40, v20, v26);
      v32 = v27 << 12;
      v33 = v27 != 0;
      goto LABEL_51;
    }
...
LABEL_53:
  ...
  LODWORD(v88[0]) = 0;
  v88[2] = 0LL;
  v83 = qword_140C697E8 + 8;
  v88[3] = 0LL;
  v70 = qword_140C697E8;
  v35 = 0;
  v84 = 0LL;
  BaseAddress = (PVOID)(qword_140C697E8 << 25 >> 16);
  ...
  if ( v38->AbEntrySummary || (AbEntrySummary = KiAbTryReclaimOrphanedEntries(0LL, (__int64)v38)) != 0 )
  {
    ...
    if ( (unsigned __int64)&qword_140C659B0 - qword_140C65AE8 >= 0x8000000000LL )
      SessionId = -1;
    else
      SessionId = MmGetSessionIdEx((__int64)v38->ApcState.Process);
    *(_DWORD *)(v36 + 8) = SessionId;
    *(_QWORD *)v36 = (unsigned __int64)&qword_140C659B0 & 0x7FFFFFFFFFFFFFFCLL;
  }
  if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C659B0, 0LL) )
    ExfAcquirePushLockExclusiveEx(&qword_140C659B0, v36, (__int64)&qword_140C659B0);
  if ( v36 )
    *(_BYTE *)(v36 + 18) = 1;
  v72 = 0;
  if ( !v73 )
...
LABEL_76:
    ...
    if ( v76 )
    {
      ...
      {
        v56 = 1LL;
        if ( HIBYTE(word_140C66DFC) == (_BYTE)v54 )
        {
LABEL_86:
          if ( (v55 & 1) != 0 )
...
LABEL_107:
  ...
  v35 = v64;
LABEL_117:
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C659B0, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
    ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C659B0);
  KeAbPostRelease((ULONG_PTR)&qword_140C659B0);
