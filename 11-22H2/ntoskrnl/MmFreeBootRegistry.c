/*
 * XREFs of MmFreeBootRegistry @ 0x140828E1C
 * Callers:
 *     CmpFreeBootRegistry @ 0x1406177E8 (CmpFreeBootRegistry.c)
...
void MmFreeBootRegistry()
{
  ...
  v0 = (size_t *)_InterlockedCompareExchange64(&qword_140C699D8, 1LL, 0LL);
  v1 = v0;
  if ( v0 )
  {
    v2 = *v0;
