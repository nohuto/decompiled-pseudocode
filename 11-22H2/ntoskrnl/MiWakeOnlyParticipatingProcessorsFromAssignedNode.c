/*
 * XREFs of MiWakeOnlyParticipatingProcessorsFromAssignedNode @ 0x14038BDBC
 * Callers:
...
PSLIST_ENTRY __fastcall MiWakeOnlyParticipatingProcessorsFromAssignedNode(__int64 *a1, int a2)
{
  ...
  {
    v6 = 0;
    result = (PSLIST_ENTRY)qword_140C65BA0;
    v7 = 0;
    v8 = *(_QWORD *)(376LL * *((unsigned int *)a1 + 51) + qword_140C65BA0 + 368);
    v22 = v8;
    if ( *(_WORD *)(v8 + 8) )
    {
      do
