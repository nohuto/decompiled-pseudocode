/*
 * XREFs of CcScanLogHandleList @ 0x140299A8C
 * Callers:
 ...
 *     CcCalculatePagesToWrite @ 0x1402999B8 (CcCalculatePagesToWrite.c)
...
LABEL_13:
      KxReleaseQueuedSpinLock((volatile signed __int64 **)&v35);
      v19 = v35.OldIrql;
      if ( (_DWORD)KiIrqlFlags )
      {
        v28 = KeGetCurrentIrql();
        if ( ((unsigned __int8)KiIrqlFlags & 1) != 0 && v28 <= 0xFu && v35.OldIrql <= 0xFu && v28 >= 2u )
        {
