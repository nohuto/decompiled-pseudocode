/*
 * XREFs of RtlStringCchCatExW @ 0x1403931F8
 * Callers:
 ...
 * Callees:
 *     RtlStringCopyWorkerW_1 @ 0x14034E2EC (RtlStringCopyWorkerW_1.c)
 *     RtlStringLengthWorkerW @ 0x140393284 (RtlStringLengthWorkerW.c)
 */
