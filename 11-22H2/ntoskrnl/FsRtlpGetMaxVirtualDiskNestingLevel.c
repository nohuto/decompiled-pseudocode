/*
 * XREFs of FsRtlpGetMaxVirtualDiskNestingLevel @ 0x1403B1584
 * Callers:
 *     FsRtlQueryMaximumVirtualDiskNestingLevel @ 0x1403C3BE0 (FsRtlQueryMaximumVirtualDiskNestingLevel.c)
 * Callees:
