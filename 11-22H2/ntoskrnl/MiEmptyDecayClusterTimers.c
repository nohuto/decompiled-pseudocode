/*
 * XREFs of MiEmptyDecayClusterTimers @ 0x14025AE00
 * Callers:
  ...
  *(_QWORD *)(v1 + 15784) = result;
  ...
  while ( 1 )
  {
    ...
    if ( (BYTE6(PerfGlobalGroupMask) & 0x21) != 0 )
      ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(&dword_140C68280, v11);
    else
      ExpAcquireSpinLockExclusive(&dword_140C68280, v11);
    v12 = *(_QWORD *)(v4 + 15744) >> 33;
    if ( v12 == 0x7FFFFFFF )
      break;
    v13 = v12 + qword_140C68260;
    v14 = 48 * (v12 + qword_140C68260) - 0x220000000000LL;
    v15 = (volatile signed __int64 *)(v14 + 24);
    if ( !_interlockedbittestandset64((volatile signed __int32 *)(v14 + 24), 0x3FuLL) )
    {
      if ( (BYTE6(PerfGlobalGroupMask) & 1) != 0 )
        ExpReleaseSpinLockExclusiveFromDpcLevelInstrumented(&dword_140C68280, retaddr);
      else
        dword_140C68280 = 0;
      v16 = *(_QWORD *)(v14 + 16);
