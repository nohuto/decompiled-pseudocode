/*
 * XREFs of MiCopyDataPageToImagePage @ 0x14028B350
 * Callers:
 ...
 *     MiAllocateHyperSpace @ 0x14035B568 (MiAllocateHyperSpace.c)
        ...
        __int64 a7)
{
  ...
  ExAcquireSpinLockExclusiveAtDpcLevel(&dword_140C65640);
  v18 = **(_QWORD **)(v17 + 40);
