/*
 * XREFs of ExPoolQueryLimits @ 0x140607430
 * Callers:
...
LABEL_5:
        ...
        for ( i = 0LL; (unsigned int)i < v9[1]; i = (unsigned int)(i + 1) )
        {
          ...
          v17 = v16 & (-1LL << (dword_140CF81C4 & 0x1F));
          if ( !((unsigned int)dword_140CF81C4 >> 5) )
            goto LABEL_24;
          pullResult[2] = v16 & (-1LL << (dword_140CF81C4 & 0x1F));
          v18 = (char *)qword_140CF81C8
              + 8
              * ((37
                * (BYTE6(v17)
                 + 37
                ...
                + HIBYTE(v17)) & (((unsigned int)dword_140CF81C4 >> 5) - 1));
          while ( 1 )
          {
            v19 = (_QWORD *)*v18;
            v18 = v19;
            if ( ((unsigned __int8)v19 & 1) != 0 )
              break;
            if ( v17 == ((-1LL << (dword_140CF81C4 & 0x1F)) & v19[1]) )
              goto LABEL_23;
          }
          v19 = 0LL;
LABEL_23:
