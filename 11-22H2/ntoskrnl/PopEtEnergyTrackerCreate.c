/*
 * XREFs of PopEtEnergyTrackerCreate @ 0x14085278C
 * Callers:
  ...
  if ( PopEtGlobals )
  {
    ...
    else
    {
      ...
      *((_DWORD *)Object + 148) = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
      ...
      v10 = PopEtGlobals + 16;
      *((_DWORD *)v8 + 149) = UnbiasedInterruptTime / 0x2710;
      *((_DWORD *)v8 + 150) = 1;
      ...
      *v12 = v8;
      *(_QWORD *)(v11 + 8) = v8;
      PopReleaseRwLock((__int64 *)(v11 + 16));
      v16 = 1uLL;
      v17 = (unsigned __int64)v8;
      inserted = PsEnumProcesses(PopEtProcessEnumSnapshotCallback, (__int64)&v16);
      if ( inserted >= 0 )
      {
        PopAcquireRwLockExclusive((ULONG_PTR)v8 + 16);
        v13 = *((_DWORD *)v8 + 153);
        if ( !v13 )
          *((_DWORD *)v8 + 159) &= ~1u;
        PopReleaseRwLock((__int64 *)v8 + 2);
        if ( v13 )
        {
          inserted = -1073741670;
        }
