/*
 * XREFs of KiUpdateCpuTargetByRate @ 0x1402058E8
 * Callers:
 ...
 *     KiUpdateChildrenCpuTarget @ 0x14057D590 (KiUpdateChildrenCpuTarget.c)
 * Callees:
...
char __fastcall KiUpdateCpuTargetByRate(unsigned __int16 *a1, char a2)
{
  ...
  if ( *((_QWORD *)a1 + 12) )
  {
    KiAcquirePrcbLocksForIsolationUnit(KiProcessorBlock[0], 0LL, &v22);
    v17 = *((_QWORD *)a1 + 67);
  ...
  if ( KeMaximumProcessors )
  {
    ...
    do
    {
      ...
      if ( v12 )
      {
        KiAcquirePrcbLocksForIsolationUnit(KiProcessorBlock[v10], 0LL, &v22);
        if ( !v20 )
        {
          if ( *(_BYTE *)(v12 + 33) )
          {
