/*
 * XREFs of CmpCheckKey @ 0x1406E07C0
 * Callers:
 ...
 *     CmpGetIndexElementSize @ 0x140871D4C (CmpGetIndexElementSize.c)
        ...
        __int64 a7)
{
  ...
  unsigned int v118[2]; // [rsp+60h] [rbp-51h] BYREF
  _WORD *v119; // [rsp+68h] [rbp-49h]
  unsigned int v120[2]; // [rsp+70h] [rbp-41h] BYREF
  __int64 v121; // [rsp+78h] [rbp-39h] BYREF
  unsigned int v122[2]; // [rsp+80h] [rbp-31h] BYREF
  unsigned int v123[2]; // [rsp+88h] [rbp-29h] BYREF
  unsigned int v124; // [rsp+90h] [rbp-21h]
  unsigned int v125[2]; // [rsp+98h] [rbp-19h] BYREF
  unsigned int v126[2]; // [rsp+A0h] [rbp-11h] BYREF
  ...
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    ...
    CellFlat = HvpGetCellPaged(BugCheckParameter3, a3, v125);
  v15 = CellFlat;
  if ( !CellFlat )
  {
...
LABEL_24:
  ...
  if ( a4 != -1 )
  {
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      ...
      CellPaged = HvpGetCellPaged(BugCheckParameter3, a4, v120);
    if ( (*(_BYTE *)(CellPaged + 13) & 3) != 3 || (((*(_BYTE *)(v15 + 13) & 3) - 1) & 0xFD) == 0 )
    {
      if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
        HvpReleaseCellFlat(BugCheckParameter3, v120);
      else
        HvpReleaseCellPaged(BugCheckParameter3, v120);
      goto LABEL_69;
    }
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      HvpReleaseCellFlat(BugCheckParameter3, v120);
...
LABEL_107:
  ...
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    ...
    v35 = HvpGetCellPaged(BugCheckParameter3, v29, v126);
  if ( !v35 )
  {
    v20 = -1073741670;
  ...
  if ( v124 > -4 - *(_DWORD *)(v35 - 4) )
  {
    if ( v36 )
      ...
      HvpReleaseCellPaged(BugCheckParameter3, v126);
    v114 = 224;
    goto LABEL_106;
  }
  if ( v36 )
...
LABEL_116:
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      ...
      v53 = HvpGetCellPaged(BugCheckParameter3, a4, v120);
    v54 = v53;
    if ( !v53 )
    {
      v20 = -1073741670;
...
LABEL_144:
    ...
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      ...
      v44 = HvpGetCellPaged(BugCheckParameter3, a4, v123);
    v45 = v44;
    if ( !v44 )
    {
      v20 = -1073741670;
...
LABEL_444:
    ...
    v51 = CmpKeySecurityIncrementReferenceCount(v48, BugCheckParameter3, *(_DWORD *)(v45 + 44), 1);
    v20 = v51;
    if ( v51 < 0 )
    {
    ...
    *(_DWORD *)(*(_QWORD *)(BugCheckParameter3 + 64) + 4088LL) |= 4u;
    ...
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      ...
      HvpReleaseCellPaged(BugCheckParameter3, v123);
    v134 = 1;
  }
  v63 = RtlUIntAdd(
...
LABEL_275:
  ...
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    ...
    HvpReleaseCellPaged(BugCheckParameter3, v125);
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    v78 = HvpGetCellFlat(BugCheckParameter3, v74);
  else
    v78 = HvpGetCellPaged(BugCheckParameter3, v74, v125);
  v117 = v78;
  v79 = (_DWORD *)v78;
  if ( !v78 )
  {
...
LABEL_420:
  ...
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    ...
    v86 = (_WORD *)HvpGetCellPaged(BugCheckParameter3, v85, v118);
  v119 = v86;
  v87 = v86;
  if ( !v86 )
  {
...
LABEL_409:
    ...
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      ...
      HvpReleaseCellPaged(BugCheckParameter3, v118);
    v82 = 0LL;
    v83 = 752;
    goto LABEL_413;
  }
...
LABEL_398:
  ...
  while ( 2 )
  {
    ...
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      ...
      v100 = HvpGetCellPaged(BugCheckParameter3, v99, v122);
    v101 = (_WORD *)v100;
    if ( !v100 )
    {
      v20 = -1073741670;
          ...
          (unsigned __int64)(unsigned int)(v103 * IndexElementSize) + 4 > v104) )
    {
      ...
      if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
        ...
        HvpReleaseCellPaged(BugCheckParameter3, v122);
      if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
        HvpReleaseCellFlat(BugCheckParameter3, v118);
      else
        HvpReleaseCellPaged(BugCheckParameter3, v118);
