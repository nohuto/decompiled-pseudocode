/*
 * XREFs of MiInsertPreviouslyRegisteredHotPatchRecord @ 0x140A37D40
 * Callers:
...
_BOOL8 __fastcall MiInsertPreviouslyRegisteredHotPatchRecord(const UNICODE_STRING *a1)
{
  ...
  v1 = (_QWORD *)*((_QWORD *)&xmmword_140C69930 + 1);
  v2 = 0;
  i = 0LL;
  while ( v1 )
  {
...
LABEL_6:
  ...
  v9 = (_QWORD *)*((_QWORD *)&xmmword_140C69930 + 1);
  if ( !*((_QWORD *)&xmmword_140C69930 + 1) )
    goto LABEL_23;
  while ( 2 )
  {
...
LABEL_26:
  ...
  LOBYTE(v2) = 1;
LABEL_23:
  RtlAvlInsertNodeEx((unsigned __int64 *)&xmmword_140C69930 + 1, (unsigned __int64)v9, v2, (unsigned __int64)a1);
  return 1;
}
