/*
 * XREFs of MiTranslatePageForCopy @ 0x1402EDE44
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( (__int64)a1 >> 47 != -1 && (__int64)a1 >> 47 != 0
    ...
    || a1 >= 0xFFFFDE0000000000uLL && a1 < 48 * qword_140C65CA0 - 0x21FFFFFFFFD0LL
  ...
  if ( a1 < qword_140C6A658 || a1 > qword_140C67170 )
  {
