/*
 * XREFs of ProcessorpSelectProcessorSetFromClusters @ 0x1C009C240
 * Callers:
 *     ProcessorpFindIdtEntriesApic @ 0x1C009B600 (ProcessorpFindIdtEntriesApic.c)
 * Callees:
 *     ProcessorpSelectClusterInGroup @ 0x1C009C118 (ProcessorpSelectClusterInGroup.c)
 *     ProcessorpSelectGroup @ 0x1C009C184 (ProcessorpSelectGroup.c)
 *     ProcessorpSelectProcessorsInCluster @ 0x1C009C338 (ProcessorpSelectProcessorsInCluster.c)
 */
