/*
 * XREFs of AmlpValidateFirmwareMemoryAddress @ 0x1C004AD68
 * Callers:
 *     AMLIValidateFirmwareMemoryAddress @ 0x1C0048ECC (AMLIValidateFirmwareMemoryAddress.c)
 *     MapPhysMem @ 0x1C004BE94 (MapPhysMem.c)
 * Callees:
