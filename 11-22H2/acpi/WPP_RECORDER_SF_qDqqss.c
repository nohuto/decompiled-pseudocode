/*
 * XREFs of WPP_RECORDER_SF_qDqqss @ 0x1C0022A5C
 * Callers:
 *     ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum @ 0x1C0021F60 (ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum.c)
 * Callees:
