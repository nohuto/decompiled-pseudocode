/*
 * XREFs of ProcessorpSelectProcessorSetFromPartitions @ 0x1C00A02D0
 * Callers:
 *     ProcessorpFindIdtEntriesApic @ 0x1C009B600 (ProcessorpFindIdtEntriesApic.c)
 * Callees:
 *     IntPartAllocateAndZeroMemory @ 0x1C005ECE4 (IntPartAllocateAndZeroMemory.c)
 *     ProcessorpSelectGroup @ 0x1C009C184 (ProcessorpSelectGroup.c)
 *     IntPartArbInit @ 0x1C00A319C (IntPartArbInit.c)
 *     IntpArbGetNextAffinity @ 0x1C00A324C (IntpArbGetNextAffinity.c)
 */
