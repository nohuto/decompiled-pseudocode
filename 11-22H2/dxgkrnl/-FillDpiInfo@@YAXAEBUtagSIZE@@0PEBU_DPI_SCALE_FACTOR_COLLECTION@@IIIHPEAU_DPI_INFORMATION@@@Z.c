/*
 * XREFs of ?FillDpiInfo@@YAXAEBUtagSIZE@@0PEBU_DPI_SCALE_FACTOR_COLLECTION@@IIIHPEAU_DPI_INFORMATION@@@Z @ 0x1C0013A90
 * Callers:
 ...
 * Callees:
 *     ?CalcDpiOverride@DpiInternal@@YA?AUtagSIZE@@AEBU2@0@Z @ 0x1C0013CD8 (-CalcDpiOverride@DpiInternal@@YA-AUtagSIZE@@AEBU2@0@Z.c)
 ...
 *     ?CalcDpi@DpiInternal@@YA?AUtagSIZE@@AEBU2@0@Z @ 0x1C004CB94 (-CalcDpi@DpiInternal@@YA-AUtagSIZE@@AEBU2@0@Z.c)
        ...
        struct _DPI_INFORMATION *a8)
{
  ...
  *((_DWORD *)a8 + 16) = a4;
  ...
  {
    v15 = 940802361LL;
    LODWORD(v26) = 100 * *((_DWORD *)a8 + 10) * a4 / 0x6900u;
    HIDWORD(v26) = 100 * *((_DWORD *)a8 + 11) * a4 / 0x6900u;
  }
  *((_QWORD *)a8 + 7) = v26;
  if ( a7 )
  {
