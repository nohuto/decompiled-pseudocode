/*
 * XREFs of ??1MultiMonitorDescriptor@DxgMonitor@@UEAA@XZ @ 0x1C006CD34
 * Callers:
 *     ??_GMultiMonitorDescriptor@DxgMonitor@@UEAAPEAXI@Z @ 0x1C006CD90 (--_GMultiMonitorDescriptor@DxgMonitor@@UEAAPEAXI@Z.c)
 * Callees:
