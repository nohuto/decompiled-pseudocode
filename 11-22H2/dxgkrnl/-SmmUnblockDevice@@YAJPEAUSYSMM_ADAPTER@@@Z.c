/*
 * XREFs of ?SmmUnblockDevice@@YAJPEAUSYSMM_ADAPTER@@@Z @ 0x1C03D6038
 * Callers:
...
__int64 __fastcall SmmUnblockDevice(struct SYSMM_ADAPTER *a1)
{
  ...
  LODWORD(v5) = 0;
  v6 = **(_QWORD **)(v2 + 376);
  ((void (__fastcall *)(__int64, __int64))qword_1C0140C58)(v6, v2 + 100);
  v7 = *v4;
  if ( (_DWORD)v7 != 2 && (*((_DWORD *)a1 + 22) & 8) == 0 )
  {
    if ( (v7 & 2) == 0 )
    {
      ...
      if ( v9 >= 0 )
      {
        ...
        {
          v10 = ((__int64 (__fastcall *)(void (__fastcall *)(struct _IOMMU_INTERFACE_STATE_CHANGE *, _DWORD *), struct SYSMM_ADAPTER *, __int64, int *))qword_1C0140C60)(
