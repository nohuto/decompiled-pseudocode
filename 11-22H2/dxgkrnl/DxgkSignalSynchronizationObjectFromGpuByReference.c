/*
 * XREFs of DxgkSignalSynchronizationObjectFromGpuByReference @ 0x1C035430C
 * Callers:
 *     ?AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z @ 0x1C0078E00 (-AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z.c)
 *     ?SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z @ 0x1C00792A0 (-SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z.c)
...
LABEL_23:
    ...
    if ( DxgAdapterSyncObject >= 0 )
    {
      ...
      if ( VidSchSyncObject )
      {
        ...
        if ( v16 < 0 )
        {
          WdLogSingleEntry1(1LL, 1499LL);
          DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NT_SUCCESS(ntStatus)", 1499LL, 0LL, 0LL, 0LL, 0LL);
        }
        goto LABEL_21;
      }
