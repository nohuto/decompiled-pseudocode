/*
 * XREFs of ?VmBusChannelStarted@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@@Z @ 0x1C0379770
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GuestResumed@HOSTVMMONITORMAPPING@@QEAAXXZ @ 0x1C0057F3C (-GuestResumed@HOSTVMMONITORMAPPING@@QEAAXXZ.c)
