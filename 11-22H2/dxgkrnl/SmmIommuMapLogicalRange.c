/*
 * XREFs of SmmIommuMapLogicalRange @ 0x1C006EF9C
 * Callers:
...
__int64 SmmIommuMapLogicalRange(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v5 = 0LL;
  if ( dword_1C0140BE8 == 2 )
    return ((__int64 (__fastcall *)(__int64, __int64, _QWORD *, __int64 *, _QWORD, _QWORD, __int64 *))qword_1C0140C28)(
             a1,
             3LL,
             v4,
             (__int64 *)va,
