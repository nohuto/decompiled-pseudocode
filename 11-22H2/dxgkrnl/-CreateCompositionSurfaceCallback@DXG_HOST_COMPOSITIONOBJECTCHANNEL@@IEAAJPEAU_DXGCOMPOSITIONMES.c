/*
 * XREFs of ?CreateCompositionSurfaceCallback@DXG_HOST_COMPOSITIONOBJECTCHANNEL@@IEAAJPEAU_DXGCOMPOSITIONMESSAGE_CREATECOMPOSITIONSURFACE@@PEAU_DXGCOMPOSITIONMESSAGE_CREATECOMPOSITIONSURFACE_RETURN@@@Z @ 0x1C02E1814
 * Callers:
...
LABEL_12:
  if ( v21 )
    ObCloseHandle(v21, 1);
  if ( v6 )
    FlipManagerDwmReleaseFlipManagerObject(v6);
  *((_DWORD *)a3 + 1) = v9;
