/*
 * XREFs of ?IsDisplayingOnVidPnSource@DXGDEVICE@@QEAA_NI@Z @ 0x1C02EB948
 * Callers:
 *     DXGDEVICE_IsDisplayingOnVidPnSource @ 0x1C0049050 (DXGDEVICE_IsDisplayingOnVidPnSource.c)
 * Callees:
