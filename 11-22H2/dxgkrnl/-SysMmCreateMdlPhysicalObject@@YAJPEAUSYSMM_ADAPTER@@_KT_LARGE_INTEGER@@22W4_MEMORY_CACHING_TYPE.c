/*
 * XREFs of ?SysMmCreateMdlPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KT_LARGE_INTEGER@@22W4_MEMORY_CACHING_TYPE@@IQEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@PEAPEAU_MDL@@@Z @ 0x1C00127D4
 * Callers:
 ...
 *     SysMmTestCreateMdlPhysicalObject @ 0x1C0072380 (SysMmTestCreateMdlPhysicalObject.c)
 * Callees:
        ...
        struct _MDL **a12)
{
  ...
  else
  {
    ...
    {
      _InterlockedIncrement(&dword_1C0140D14);
