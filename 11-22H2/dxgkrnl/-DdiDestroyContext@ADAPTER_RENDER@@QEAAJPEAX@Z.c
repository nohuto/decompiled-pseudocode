/*
 * XREFs of ?DdiDestroyContext@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C018A9D4
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyContext@@YAJPEAVADAPTER_RENDER@@QEAX@Z @ 0x1C0048BF0 (-ADAPTER_RENDER_DdiDestroyContext@@YAJPEAVADAPTER_RENDER@@QEAX@Z.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyContext(ADAPTER_RENDER *this, void *a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v17, 5042);
  ...
  v11 = (*(int (__fastcall **)(void *))(*((_QWORD *)this + 2) + 776LL))(a2);
  if ( v21[0] )
