/*
 * XREFs of _lambda_0e6dcefab9b27dbf753c4a8a5b0f464a_::operator() @ 0x1C02C2488
 * Callers:
...
char __fastcall lambda_0e6dcefab9b27dbf753c4a8a5b0f464a_::operator()(unsigned int **a1)
{
  ...
  v1 = *a1;
  if ( **a1 == 2303131 && (unsigned int)dword_1C013F8A8 > 5 )
  {
    LOBYTE(v1) = tlgKeywordOn((__int64)&dword_1C013F8A8, 0x400000100000LL);
    v4 = 0LL;
    if ( (_BYTE)v1 )
    {
