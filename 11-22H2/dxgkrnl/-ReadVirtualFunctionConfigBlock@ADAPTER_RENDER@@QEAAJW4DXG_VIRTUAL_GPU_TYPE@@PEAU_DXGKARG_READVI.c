/*
 * XREFs of ?ReadVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C03691B0
 * Callers:
 *     DxgkDdiReadVirtualFunctionConfigBlock @ 0x1C036ACE0 (DxgkDdiReadVirtualFunctionConfigBlock.c)
 * Callees:
