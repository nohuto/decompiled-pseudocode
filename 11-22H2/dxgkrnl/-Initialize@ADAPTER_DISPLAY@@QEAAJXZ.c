/*
 * XREFs of ?Initialize@ADAPTER_DISPLAY@@QEAAJXZ @ 0x1C01FEF00
 * Callers:
 ...
 *     DpiSetSchedulerCallbackState @ 0x1C0023D40 (DpiSetSchedulerCallbackState.c)
 ...
 *     ?Initialize@DISPLAY_SOURCE@@AEAAJPEAVADAPTER_DISPLAY@@I@Z @ 0x1C01FF69C (-Initialize@DISPLAY_SOURCE@@AEAAJPEAVADAPTER_DISPLAY@@I@Z.c)
  ...
  *((_DWORD *)this + 6) = 0;
  ...
  if ( *(_DWORD *)(v5 + 2096) >= 0x5010u && !*(_BYTE *)(v5 + 209) && (*(_DWORD *)(v5 + 2792) & 8) == 0 )
  {
    ...
    *(_QWORD *)&v69.Flags.0 = 0LL;
    ...
    {
      WdLogSingleEntry2(2LL, this, 4656LL);
...
LABEL_27:
    ...
    *((_BYTE *)this + 290) = v35;
    ...
    if ( *(int *)(v36 + 2820) < 2000 )
    {
      ...
      if ( (int)DpiReadPnpRegistryValue(v37, L"EnableVirtualTopologySupport", &EventHandle, 4LL) >= 0 )
      {
    ...
    if ( (int)DpiReadPnpRegistryValue(v46, L"NeedToSuspendVidSchBeforeSetGammaRamp", &EventHandle, 4LL) >= 0 )
    {
      v47 = (int)EventHandle;
    ...
    *((_BYTE *)this + 291) = v47 != 0;
    ...
    {
      WdLogSingleEntry1(1LL, 5136LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NT_SUCCESS(TmpStatus)", 5136LL, 0LL, 0LL, 0LL, 0LL);
    }
    if ( v27 >= 0 )
    {
      EventHandle = 0LL;
