/*
 * XREFs of DxgkOpenResourceFromNtHandleInternal @ 0x1C01A3FC0
 * Callers:
 *     DxgkOpenResourceFromNtHandle @ 0x1C01A3FA0 (DxgkOpenResourceFromNtHandle.c)
