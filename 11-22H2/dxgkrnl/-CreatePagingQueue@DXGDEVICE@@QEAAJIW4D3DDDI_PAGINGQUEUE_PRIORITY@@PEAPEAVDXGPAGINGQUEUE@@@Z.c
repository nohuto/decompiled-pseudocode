/*
 * XREFs of ?CreatePagingQueue@DXGDEVICE@@QEAAJIW4D3DDDI_PAGINGQUEUE_PRIORITY@@PEAPEAVDXGPAGINGQUEUE@@@Z @ 0x1C01EDE58
 * Callers:
 ...
 *     ??_GDXGPAGINGQUEUE@@IEAAPEAXI@Z @ 0x1C0049884 (--_GDXGPAGINGQUEUE@@IEAAPEAXI@Z.c)
        ...
        struct DXGPAGINGQUEUE **a4)
{
  ...
  if ( !*((_BYTE *)this + 72) && !ExIsResourceAcquiredExclusiveLite(*((PERESOURCE *)this + 17)) )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsDeviceLockExclusiveOwner()", 8023LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(*(DXGADAPTER **)(*((_QWORD *)this + 2) + 16LL)) )
  {
    WdLogSingleEntry1(1LL, 8024LL);
  ...
  if ( !a4 )
  {
    WdLogSingleEntry1(1LL, 8025LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"PagingQueue != NULL", 8025LL, 0LL, 0LL, 0LL, 0LL);
  }
      ...
      *(_OWORD *)v21 = 0LL;
      ...
      if ( (int)v10 >= 0 )
      {
        ...
        *(_DWORD *)(v18 + 44) = HIDWORD(v21[0]);
        ...
        if ( v19 >= 0 )
          goto LABEL_11;
        WdLogSingleEntry2(2LL, v19, 8073LL);
        DxgkLogInternalTriageEvent(
          0LL,
          0x40000,
          -1,
