/*
 * XREFs of ?TdrCollectBugcheckSecondaryDumpData@@YAKPEAXK_N1@Z @ 0x1C004FCE8
 * Callers:
 *     _DxgDbgBugcheckCallback @ 0x1C005A890 (_DxgDbgBugcheckCallback.c)
