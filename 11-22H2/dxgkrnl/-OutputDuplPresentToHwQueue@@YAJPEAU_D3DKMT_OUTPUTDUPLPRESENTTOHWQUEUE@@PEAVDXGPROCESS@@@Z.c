/*
 * XREFs of ?OutputDuplPresentToHwQueue@@YAJPEAU_D3DKMT_OUTPUTDUPLPRESENTTOHWQUEUE@@PEAVDXGPROCESS@@@Z @ 0x1C031ADA4
 * Callers:
...
LABEL_48:
    ...
    if ( v68 )
    {
      if ( v67[0] )
      {
        WdLogSingleEntry1(3LL, 2730LL);
        OutputDuplManager = -1073741811;
      }
      else
      {
        WdLogSingleEntry1(3LL, 2725LL);
        OutputDuplManager = -1073741801;
      }
      goto LABEL_75;
    }
