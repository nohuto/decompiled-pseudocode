/*
 * XREFs of ?UnpinFrameBufferForSave@DXGADAPTER@@QEAAJI@Z @ 0x1C02BAA6C
 * Callers:
 ...
 *     ?SysMmClosePhysicalObject@@YAXPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x1C002B780 (-SysMmClosePhysicalObject@@YAXPEAUSYSMM_ADAPTER_OBJECT@@@Z.c)
...
__int64 __fastcall DXGADAPTER::UnpinFrameBufferForSave(DXGADAPTER *this, unsigned int a2, int a3)
{
  ...
  if ( a2 < *((_DWORD *)this + 72) )
  {
    ...
    if ( !v6 )
    {
      WdLogSingleEntry1(1LL, 11274LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pMdl != nullptr", 11274LL, 0LL, 0LL, 0LL, 0LL);
    }
