/*
 * XREFs of DxgkLock2 @ 0x1C01D2650
 * Callers:
...
LABEL_6:
  ...
  v43 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v39, *v10, v9, &v43);
  v12 = v43;
  if ( !v43 )
  {
  ...
  else
  {
    ...
    if ( !ExAcquireResourceExclusiveLite(*((PERESOURCE *)v12 + 17), 0) )
    {
      ...
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
        McTemplateK0q_EtwWriteTransfer(v34, &EventBlockThread, v35, 40);
