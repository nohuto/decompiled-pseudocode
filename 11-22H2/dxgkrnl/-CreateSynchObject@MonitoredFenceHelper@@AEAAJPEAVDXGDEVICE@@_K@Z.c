/*
 * XREFs of ?CreateSynchObject@MonitoredFenceHelper@@AEAAJPEAVDXGDEVICE@@_K@Z @ 0x1C035DD38
 * Callers:
...
__int64 __fastcall MonitoredFenceHelper::CreateSynchObject(MonitoredFenceHelper *this, struct DXGDEVICE *a2, UINT64 a3)
{
  ...
  v8 = CreateSynchronizationObjectInternal((__int64)a2, 0, v7, (__int64)&v10, 0, 0, &v11, (__int64 *)this + 4, 0LL);
  if ( v8 < 0 )
