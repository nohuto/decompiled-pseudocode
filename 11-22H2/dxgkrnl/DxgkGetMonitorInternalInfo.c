/*
 * XREFs of DxgkGetMonitorInternalInfo @ 0x1C01A0250
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_GetMonitorHandle@MONITOR_MGR@@SAPEAUHDXGMONITOR__@@PEAVDXGMONITOR@@@Z @ 0x1C0007330 (-_GetMonitorHandle@MONITOR_MGR@@SAPEAUHDXGMONITOR__@@PEAVDXGMONITOR@@@Z.c)
 ...
 *     ?_GetPreferredMonitorSourceMode@MonitorModes@DxgMonitor@@QEBAJPEAU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C018651C (-_GetPreferredMonitorSourceMode@MonitorModes@DxgMonitor@@QEBAJPEAU_D3DKMDT_MONITOR_SOURCE_MODE@@.c)
...
__int64 __fastcall DxgkGetMonitorInternalInfo(__int64 a1, unsigned int a2, __int64 a3, unsigned int *a4, __int64 a5)
{
  ...
  v79 = 0LL;
  v75 = 0;
  v9 = DxgkConvertLegacyQDCAdapterAndIdToActual(&v80, (unsigned int)v7, &v79, &v75);
  v10 = v9;
  if ( v9 < 0 )
  {
    v56 = v7;
...
LABEL_40:
            ...
            *(_DWORD *)(a3 + 928) = 0;
            if ( (int)MonitorGetDpiInfoFromDescriptor(v53, v50, &v90) >= 0 && v72 )
            {
              *(_DWORD *)(a3 + 916) = v90;
              cy = HIDWORD(v90);
            }
