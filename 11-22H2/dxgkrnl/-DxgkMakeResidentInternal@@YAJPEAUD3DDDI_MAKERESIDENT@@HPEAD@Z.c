/*
 * XREFs of ?DxgkMakeResidentInternal@@YAJPEAUD3DDDI_MAKERESIDENT@@HPEAD@Z @ 0x1C01C4F60
 * Callers:
 *     DxgkMakeResident @ 0x1C01C4F40 (DxgkMakeResident.c)
...
__int64 __fastcall DxgkMakeResidentInternal(struct D3DDDI_MAKERESIDENT *a1, int a2, char *a3)
{
  ...
  __int64 v101; // [rsp+70h] [rbp-448h] BYREF
...
LABEL_31:
  ...
  else if ( !ExAcquireResourceExclusiveLite(*(PERESOURCE *)(v22 + 136), 0) )
  {
    ...
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
      McTemplateK0q_EtwWriteTransfer(v79, &EventBlockThread, v80, 40);
...
LABEL_183:
      ...
      v43 = v111;
      *v111 = (struct _EX_RUNDOWN_REF *)v39;
      v101 = 0LL;
      v111 = v43 + 1;
      ++AllocationList;
...
LABEL_79:
    ...
    if ( v135 == (DXGALLOCATIONREFERENCE *)v136 )
    {
      if ( v137 )
      {
        while ( 1 )
        {
          DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE((DXGALLOCATIONREFERENCE *)((char *)v63 + 8 * v6++));
          if ( v6 >= v137 )
            break;
          v63 = v135;
        }
