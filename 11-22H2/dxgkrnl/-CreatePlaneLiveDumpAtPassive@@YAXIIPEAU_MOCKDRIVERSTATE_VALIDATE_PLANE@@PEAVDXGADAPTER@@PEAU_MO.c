/*
 * XREFs of ?CreatePlaneLiveDumpAtPassive@@YAXIIPEAU_MOCKDRIVERSTATE_VALIDATE_PLANE@@PEAVDXGADAPTER@@PEAU_MOCKDRIVERSTATE_PLANE@@@Z @ 0x1C0322C60
 * Callers:
        ...
        struct _MOCKDRIVERSTATE_PLANE *a5)
{
  ...
  *((_QWORD *)v9 + 328) = *((_QWORD *)a3 + 6);
  ...
  if ( (unsigned int)dword_1C013F918 > 5 && tlgKeywordOn((__int64)&dword_1C013F918, 0x400000020000LL) )
  {
    LOBYTE(v10) = 1;
