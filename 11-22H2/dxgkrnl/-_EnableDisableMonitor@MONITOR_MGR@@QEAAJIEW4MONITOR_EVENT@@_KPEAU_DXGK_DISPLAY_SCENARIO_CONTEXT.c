/*
 * XREFs of ?_EnableDisableMonitor@MONITOR_MGR@@QEAAJIEW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@PEA_N@Z @ 0x1C01DD680
 * Callers:
 ...
 *     ?_IsMonitorDisabled@DXGMONITOR@@QEBA_NXZ @ 0x1C0177560 (-_IsMonitorDisabled@DXGMONITOR@@QEBA_NXZ.c)
        ...
        _BYTE *a7)
{
  ...
  _DWORD v38[2]; // [rsp+50h] [rbp-20h] BYREF
  unsigned __int64 v39; // [rsp+58h] [rbp-18h]
  ...
  if ( v15 || (v16 = 1, v14) )
    v16 = 0;
  v38[0] = v13 & 0xFFFFFF8F | (16 * (v16 | (2 * (v15 & 1 | (2 * (v14 & 1))))));
  MONITOR_MGR::_LogMonitorPresentEvent(a1, 14LL, 0xFFFFFFFFLL, 0LL, v38);
  v18 = 0;
