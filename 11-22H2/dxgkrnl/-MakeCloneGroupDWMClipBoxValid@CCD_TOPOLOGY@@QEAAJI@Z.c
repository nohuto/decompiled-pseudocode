/*
 * XREFs of ?MakeCloneGroupDWMClipBoxValid@CCD_TOPOLOGY@@QEAAJI@Z @ 0x1C016D2D0
 * Callers:
...
__int64 __fastcall CCD_TOPOLOGY::MakeCloneGroupDWMClipBoxValid(CCD_TOPOLOGY *this, unsigned int a2)
{
  ...
  enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION v7; // ecx
  __int64 v8; // rdx
  __int64 v9; // rcx
  __int64 v10; // r8
  __int64 v11; // r9
...
LABEL_18:
    ...
    if ( *((_DWORD *)v6 + 34) == 1 )
    {
      v20 = (_DWORD *)((char *)v6 + 140);
      if ( (v19 & 0x10000) != 0 )
      {
        if ( *v20 == 5 )
        {
          DxgkGetAdapterDefaultScaling((char *)v6 + 16, (char *)v6 + 140);
          *((_DWORD *)v6 + 65) |= 0x200u;
        }
      }
      else
      ...
      if ( !CalculateScaling(v22, (unsigned int *)&v28, &v26, (unsigned int *)v6 + 42) )
      {
        ...
        DxgkLogInternalTriageEvent(
          ...
          0LL);
        DxgkGetAdapterDefaultScaling((char *)v6 + 16, (char *)v6 + 140);
        v23 = ConvertDmmToDisplayConfigScaling((unsigned int)*v20);
