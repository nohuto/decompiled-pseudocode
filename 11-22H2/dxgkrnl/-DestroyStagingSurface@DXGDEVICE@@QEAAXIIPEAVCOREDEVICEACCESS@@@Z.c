/*
 * XREFs of ?DestroyStagingSurface@DXGDEVICE@@QEAAXIIPEAVCOREDEVICEACCESS@@@Z @ 0x1C02E9134
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  if ( !Current )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pProcess != NULL", 8858LL, 0LL, 0LL, 0LL, 0LL);
  }
  v28 = 0LL;
  v9 = 0LL;
  ...
  if ( !a3 )
  {
    ...
    WdLogSingleEntry1(1LL, 8875LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pAllocation != NULL", 8875LL, 0LL, 0LL, 0LL, 0LL);
LABEL_29:
  ...
  WdLogSingleEntry1(1LL, 8869LL);
  DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pResource != NULL", 8869LL, 0LL, 0LL, 0LL, 0LL);
LABEL_16:
