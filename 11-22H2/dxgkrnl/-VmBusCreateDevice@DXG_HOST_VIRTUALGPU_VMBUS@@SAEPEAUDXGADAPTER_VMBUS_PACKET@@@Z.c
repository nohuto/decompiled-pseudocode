/*
 * XREFs of ?VmBusCreateDevice@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C037A890
 * Callers:
 *     <none>
 * Callees:
...
LABEL_19:
    ...
    *(_QWORD *)(v13 + 56) = KeGetCurrentThread();
      ...
      && (*(_DWORD *)(*((_QWORD *)a1 + 12) + 424LL) & 0x800) == 0 )
    {
      ...
      v18 = v15;
      WdLogSingleEntry2(2LL, v15, 1090LL);
      DxgkLogInternalTriageEvent(
        0LL,
        0x40000,
        -1,
  ...
  {
    v22 = v20;
    WdLogSingleEntry2(2LL, v20, 1112LL);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
