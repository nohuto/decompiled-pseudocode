/*
 * XREFs of ?reset@?$unique_storage@U?$resource_policy@PEAG$$A6AXPEAG@_E$1?FreePoolWithTag@?$pool_helpers@PEAG$0A@@details@wil@@SAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAGPEAG$0A@$$T@details@wil@@@details@wil@@QEAAXPEAG@Z @ 0x1C00223C0
 * Callers:
 *     DpiPdoHandleQueryDeviceText @ 0x1C0222EF0 (DpiPdoHandleQueryDeviceText.c)
 * Callees:
 *     ?FreePoolWithTag@?$pool_helpers@PEAG$0A@@details@wil@@SAXPEAG@Z @ 0x1C0066B10 (-FreePoolWithTag@-$pool_helpers@PEAG$0A@@details@wil@@SAXPEAG@Z.c)
 */
