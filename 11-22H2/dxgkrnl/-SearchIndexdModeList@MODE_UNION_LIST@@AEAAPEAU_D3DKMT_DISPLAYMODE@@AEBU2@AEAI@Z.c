/*
 * XREFs of ?SearchIndexdModeList@MODE_UNION_LIST@@AEAAPEAU_D3DKMT_DISPLAYMODE@@AEBU2@AEAI@Z @ 0x1C01F81C8
 * Callers:
 ...
 * Callees:
 *     _CompareDisplayMode @ 0x1C01F82A0 (_CompareDisplayMode.c)
 */
