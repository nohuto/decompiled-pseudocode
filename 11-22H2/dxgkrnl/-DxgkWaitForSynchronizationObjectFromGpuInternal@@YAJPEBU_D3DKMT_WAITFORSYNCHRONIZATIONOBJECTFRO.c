/*
 * XREFs of ?DxgkWaitForSynchronizationObjectFromGpuInternal@@YAJPEBU_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMGPU@@_N1PEB_K1@Z @ 0x1C01B66E8
 * Callers:
 *     DxgkWaitForSynchronizationObjectFromGpu @ 0x1C01B6B80 (DxgkWaitForSynchronizationObjectFromGpu.c)
 *     DxgkKernelModeWaitForSynchronizationObjectFromGpu @ 0x1C0354920 (DxgkKernelModeWaitForSynchronizationObjectFromGpu.c)
  ...
  if ( Current )
  {
    ...
    if ( !a2 )
    {
      ...
      *(_OWORD *)v38 = *(_OWORD *)&v7->MonitoredFenceValueArray;
      ...
      v12 = Src[0];
LABEL_29:
      v21 = (const unsigned __int64 *)v38[0];
      if ( a4 )
        v21 = a4;
