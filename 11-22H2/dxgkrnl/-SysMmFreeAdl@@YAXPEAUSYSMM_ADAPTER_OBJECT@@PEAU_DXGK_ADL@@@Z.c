/*
 * XREFs of ?SysMmFreeAdl@@YAXPEAUSYSMM_ADAPTER_OBJECT@@PEAU_DXGK_ADL@@@Z @ 0x1C0070800
 * Callers:
 ...
 * Callees:
 *     SmmFreeAdl @ 0x1C0070320 (SmmFreeAdl.c)
 *     ?SmmFreeLogicalAddress@@YAXPEAUSYSMM_LOGICAL_ALLOCATOR@@PEAUSYSMM_LOGICAL_BLOCK@@@Z @ 0x1C0070E84 (-SmmFreeLogicalAddress@@YAXPEAUSYSMM_LOGICAL_ALLOCATOR@@PEAUSYSMM_LOGICAL_BLOCK@@@Z.c)
 */
...
void __fastcall SysMmFreeAdl(struct SYSMM_ADAPTER_OBJECT *a1, struct _DXGK_ADL *a2)
{
  ...
  v4 = (*((_DWORD *)a1 + 8))-- == 1;
  if ( v4 && (dword_1C0140CD0 & 0x18) == 0x10 )
  {
