/*
 * XREFs of ??0MONITOR_MGR@@QEAA@PEAVADAPTER_DISPLAY@@@Z @ 0x1C0022980
 * Callers:
  ...
  *((_QWORD *)this + 83) = v7;
  if ( v7 )
  {
    ...
    *(_DWORD *)(*((_QWORD *)this + 83) + 20LL) = 0;
    ...
    v9 = (_QWORD *)qword_1C0141C10;
    v10 = (_QWORD *)*((_QWORD *)this + 83);
    if ( *(struct _LIST_ENTRY **)qword_1C0141C10 != &MONITOR_MGR::_MonitorPendingEventTraceHead )
      __fastfail(3u);
    v10[1] = qword_1C0141C10;
    *v10 = &MONITOR_MGR::_MonitorPendingEventTraceHead;
    *v9 = v10;
    qword_1C0141C10 = (__int64)v10;
