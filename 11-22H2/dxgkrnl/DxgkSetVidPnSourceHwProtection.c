/*
 * XREFs of DxgkSetVidPnSourceHwProtection @ 0x1C02D6150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetVidPnSourceHwProtection(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !Current )
  {
    WdLogSingleEntry1(2LL, 10850LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Invalid process context", 10850LL, 0LL, 0LL, 0LL, 0LL);
LABEL_7:
