/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C01D80E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ *const a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v23, 7049);
...
LABEL_39:
  ...
  if ( v13 == v11 )
  {
    if ( a2 == *(struct D3DKMDT_HVIDPN__ *const *)(v11 + 112) )
    {
      WdLogSingleEntry2(7LL, a2, *(unsigned int *)(v11 + 24));
      auto_rc<DMMVIDPNTARGETMODESET>::reset((__int64 *)(v11 + 112), 0LL);
      if ( *((_DWORD *)a2 + 24) != 1 )
        WdLogSingleEntry0(1LL);
    }
    if ( *((_DWORD *)a2 + 24) == 1
