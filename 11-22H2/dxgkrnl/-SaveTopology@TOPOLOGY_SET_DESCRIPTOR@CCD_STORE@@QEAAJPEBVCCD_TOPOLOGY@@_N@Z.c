...
LABEL_32:
        ...
        if ( !v34 )
        {
          ...
          *(_DWORD *)(v14 + 112) = v20 * (BitsPerPixel >> 3);
          v21 = CcdWriteRegistryValues((_DWORD)Handle, 0, (unsigned int)&unk_1C013F550, 8, v14);
          ...
          if ( v21 < 0
            || (*(_DWORD *)(v14 + 100) = v35,
                ...
                *(_DWORD *)(v14 + 96) = v16,
                v39 = 4,
                v22 = CcdWriteRegistryValues((_DWORD)Handle, 0, (unsigned int)&unk_1C013F200, 2, (__int64)&v39),
