/*
 * XREFs of ?VmBusSubmitCommandToHwQueue@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0394010
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
        ...
        WdLogSingleEntry2(2LL, v8, 5319LL);
        v11 = 5319LL;
      }
      else
      {
