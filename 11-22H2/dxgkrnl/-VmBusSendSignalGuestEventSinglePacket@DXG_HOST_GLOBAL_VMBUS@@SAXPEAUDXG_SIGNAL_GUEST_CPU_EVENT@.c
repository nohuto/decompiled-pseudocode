/*
 * XREFs of ?VmBusSendSignalGuestEventSinglePacket@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUDXG_SIGNAL_GUEST_CPU_EVENT@@PEAUDXGKVMB_SINGLEPACKETCONTEXT@@@Z @ 0x1C005D848
 * Callers:
        ...
        struct DXGKVMB_SINGLEPACKETCONTEXT *this)
{
  ...
  v4 = (struct VMBPACKET__ *)((__int64 (__fastcall *)(_QWORD))qword_1C0141FB8)(**(_QWORD **)a1);
  if ( v4 )
  {
    v8 = *((_QWORD *)a1 + 1);
    v17 = 0LL;
    ...
    *(_QWORD *)&v17 = 0LL;
    ((void (__fastcall *)(struct VMBPACKET__ *, struct DXGKVMB_SINGLEPACKETCONTEXT *))qword_1C0142000)(v4, this);
    ...
    if ( v9 < 0 )
    {
      ...
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x80000000LL) != 0 )
        McTemplateK0zqqzxxxxx_EtwWriteTransfer(
          ...
          0LL,
          0LL);
      ((void (__fastcall *)(struct VMBPACKET__ *))qword_1C0141FC0)(v4);
      *((_QWORD *)this + 1) = 0LL;
