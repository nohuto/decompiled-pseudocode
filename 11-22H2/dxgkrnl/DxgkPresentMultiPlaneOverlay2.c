/*
 * XREFs of DxgkPresentMultiPlaneOverlay2 @ 0x1C03259E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay2(struct _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 *a1)
{
  ...
  struct _D3DKMT_MULTIPLANE_OVERLAY2 *v58[2]; // [rsp+D0h] [rbp-38h] BYREF
  ...
  _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 v66; // [rsp+148h] [rbp+40h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v59, 2163);
  ...
  *(_OWORD *)v58 = 0LL;
  LODWORD(v49) = CapturePresentMultiPlaneOverlayArgs2(a1, &v66, v58, (struct tagRECT **)&v58[1]);
  if ( (int)v49 >= 0 )
  {
    if ( v66.VidPnSourceId >= 0x10 )
    {
      ...
      v16 = L"Invalid VidPnSoureId 0x%I64x specified in DxgkPresentMultiPlaneOverlay2, returning 0x%I64x";
      v14 = (int)v49;
      goto LABEL_10;
    }
    v50 = 0LL;
        ...
        if ( (int)v49 >= 0 )
        {
          ...
          if ( v37 )
          {
              ...
              || ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(v37 + 2920), v36, v66.VidPnSourceId) )
            {
              ...
              {
                LODWORD(v49) = DXGCONTEXT::PresentMultiPlaneOverlay2(
                                 (DXGCONTEXT *)v18,
                                 &v66,
