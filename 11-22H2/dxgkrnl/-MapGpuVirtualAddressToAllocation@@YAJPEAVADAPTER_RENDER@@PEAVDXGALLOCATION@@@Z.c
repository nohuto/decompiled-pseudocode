/*
 * XREFs of ?MapGpuVirtualAddressToAllocation@@YAJPEAVADAPTER_RENDER@@PEAVDXGALLOCATION@@@Z @ 0x1C016B6B8
 * Callers:
...
__int64 __fastcall MapGpuVirtualAddressToAllocation(struct ADAPTER_RENDER *a1, struct DXGALLOCATION *a2)
{
  ...
  struct D3DDDI_MAPGPUVIRTUALADDRESS v20; // [rsp+50h] [rbp-A8h] BYREF
  ...
  if ( DXGADAPTER::ReplicateGdiContent(v4) )
  {
    ...
    while ( v12 )
    {
      ...
      {
        LOBYTE(v19) = 0;
        v14 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, struct D3DDDI_MAPGPUVIRTUALADDRESS *, int, int))(*(_QWORD *)(*((_QWORD *)a1 + 95) + 8LL) + 792LL))(
                *((_QWORD *)a1 + 96),
                0LL,
                *(_QWORD *)(v12 + 24),
                &v20,
...
LABEL_17:
  ...
  else
  {
    ...
    {
      v6 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, struct D3DDDI_MAPGPUVIRTUALADDRESS *, _BYTE, _DWORD))(*(_QWORD *)(*((_QWORD *)a1 + 95) + 8LL) + 792LL))(
             *((_QWORD *)a1 + 96),
             0LL,
             *((_QWORD *)a2 + 3),
             &v20,
