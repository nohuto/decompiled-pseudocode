/*
 * XREFs of ?DxgkpQueryRegistry@@YAJPEAVDXGADAPTER@@PEAXI@Z @ 0x1C016B7A4
 * Callers:
...
__int64 __fastcall DxgkpQueryRegistry(struct DXGADAPTER *a1, unsigned int *a2, unsigned int a3)
{
  ...
  if ( a3 >= 0x228 )
  {
    ...
    if ( v6 >= 4 )
    {
      WdLogSingleEntry2(3LL, -1073741811LL, 2856LL);
      goto LABEL_21;
    }
    ...
    {
      WdLogSingleEntry2(3LL, -1073741811LL, 2863LL);
      goto LABEL_21;
    }
    v10 = a3 - 544;
    v11 = *a2;
...
LABEL_17:
    ...
    if ( v11 - 2 > 1 )
    {
      WdLogSingleEntry2(3LL, -1073741811LL, 2998LL);
      goto LABEL_21;
    }
    if ( a2[132] || (v6 & 1) != 0 )
    {
      WdLogSingleEntry2(3LL, -1073741811LL, 2966LL);
      goto LABEL_21;
    }
    if ( v11 == 2 )
    {
...
LABEL_39:
  ...
  WdLogSingleEntry3(3LL, a3, -1073741811LL, 2848LL);
  return 3221225485LL;
}
