/*
 * XREFs of ?CreateVidMmAllocations@DXGDEVICE@@QEAAJPEAU_D3DKMT_CREATEALLOCATION@@PEAU_D3DDDI_ALLOCATIONINFO2@@PEAU_DXGK_ALLOCATIONINFO@@PEAVDXGALLOCATION@@PEBU_D3DKM_CREATESTANDARDALLOCATION@@EPEAVCOREDEVICEACCESS@@@Z @ 0x1C01A21A0
 * Callers:
...
LABEL_141:
    ...
    if ( !v95 )
    {
      WdLogSingleEntry1(1LL, 4391LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pVidMmMultiGlobalAlloc", 4391LL, 0LL, 0LL, 0LL, 0LL);
      v31 = v95;
    }
...
LABEL_33:
    ...
    *(_DWORD *)(*((_QWORD *)v15 + 6) + 4LL) = (v36 << 21) | *(_DWORD *)(*((_QWORD *)v15 + 6) + 4LL) & 0xF81FFFFF;
    ...
    if ( !v96 )
    {
      WdLogSingleEntry1(1LL, 4496LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pVidMmMultiAlloc", 4496LL, 0LL, 0LL, 0LL, 0LL);
      v37 = v96;
    }
    *((_QWORD *)v15 + 3) = v37;
