/*
 * XREFs of Feature_DolbyVisionVSVDBv4_Support__private_IsEnabledFallback @ 0x1C0027344
 * Callers:
...
__int64 __fastcall Feature_DolbyVisionVSVDBv4_Support__private_IsEnabledFallback(__int64 a1, unsigned int a2)
{
  return wil_details_IsEnabledFallback(
           a1,
           a2,
           (volatile signed __int32 **)&Feature_DolbyVisionVSVDBv4_Support__private_descriptor);
}
