/*
 * XREFs of ??$OpenResourceFromGlobalHandleOrNtObject@U_D3DKMT_OPENRESOURCEFROMNTHANDLE@@@@YAJPEAU_D3DKMT_OPENRESOURCEFROMNTHANDLE@@IPEAU_DXGSHAREDALLOCOBJECT@@H@Z @ 0x1C01A4774
 * Callers:
        ...
        int a4)
{
  ...
  struct DXGDEVICE *v90; // [rsp+E0h] [rbp-378h] BYREF
...
LABEL_23:
          if ( (*((_BYTE *)v11 + 1901) & 1) != 0
            || (v25 = *((_QWORD *)v90 + 2), *(_QWORD *)(v15 + 80) == v25)
...
LABEL_95:
          ...
          v64 = *(_DWORD *)(v15 + 216);
          if ( !v64 && *(_DWORD *)(*(_QWORD *)(v25 + 16) + 2096LL) < 0x5000u )
          {
