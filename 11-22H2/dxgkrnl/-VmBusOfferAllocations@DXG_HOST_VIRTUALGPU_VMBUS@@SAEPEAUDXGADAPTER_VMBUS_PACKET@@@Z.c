/*
 * XREFs of ?VmBusOfferAllocations@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0381B40
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_BYTE *)(v2 + 173) )
  {
    ...
    if ( v4 )
    {
      ...
      *((_DWORD *)&v11.Flags + 1) = 0;
      ...
      {
        WdLogSingleEntry1(2LL, 1600LL);
        DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"Invalid packet size", 1600LL, 0LL, 0LL, 0LL, 0LL);
      }
