/*
 * XREFs of DpQueryFeatureSupport @ 0x1C0228600
 * Callers:
 *     DpIsFeatureEnabled @ 0x1C0398F30 (DpIsFeatureEnabled.c)
 * Callees:
  ...
  *((_BYTE *)a1 + 16) = 0;
  ...
  switch ( v5 )
  {
    case 0:
      ...
      v3[1426] = v22;
      v10 = v22;
      if ( byte_1C01404BD && (v22 & 0x18000) == 0x8000 )
      {
...
LABEL_44:
    ...
    case 1:
      ...
      v3[1426] = v17;
      v18 = v17;
      if ( byte_1C01404BD && (v17 & 0xC0000) == 0x40000 )
      {
