/*
 * XREFs of ?Initialize@DXGPROCESS@@QEAAJPEAX@Z @ 0x1C01AA500
 * Callers:
  ...
  *((_DWORD *)this + 20) = v27;
  ...
  while ( 1 )
  {
    ...
    if ( v29 >= 2 )
    {
      ...
      if ( *((__int64 *)this + 4) <= 0 )
      {
        WdLogSingleEntry1(1LL, 1129LL);
        DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"m_ReferenceCount > 0", 1129LL, 0LL, 0LL, 0LL, 0LL);
      }
