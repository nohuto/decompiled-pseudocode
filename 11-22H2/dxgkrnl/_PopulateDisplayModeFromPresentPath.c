/*
 * XREFs of _PopulateDisplayModeFromPresentPath @ 0x1C03014FC
 * Callers:
        ...
        _BYTE *a10)
{
  ...
  *a10 = 0;
  ...
  result = (unsigned int)D3DKMDT_VPPR_GET_CONTENT_ROTATION((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)v12) - 1;
  if ( !(_DWORD)result )
    goto LABEL_6;
