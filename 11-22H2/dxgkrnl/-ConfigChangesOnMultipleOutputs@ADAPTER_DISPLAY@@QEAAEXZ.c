/*
 * XREFs of ?ConfigChangesOnMultipleOutputs@ADAPTER_DISPLAY@@QEAAEXZ @ 0x1C02BB66C
 * Callers:
 ...
 *     ?AreSourcesSyncLocked@ADAPTER_DISPLAY@@QEAAEI@Z @ 0x1C02BB438 (-AreSourcesSyncLocked@ADAPTER_DISPLAY@@QEAAEI@Z.c)
...
bool __fastcall ADAPTER_DISPLAY::ConfigChangesOnMultipleOutputs(struct _KTHREAD **this)
{
  ...
  {
    WdLogSingleEntry1(1LL, 10435LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsDisplayStateMutexOwner()", 10435LL, 0LL, 0LL, 0LL, 0LL);
  }
  v3 = 0;
  v21 = 0;
  v4 = 0;
