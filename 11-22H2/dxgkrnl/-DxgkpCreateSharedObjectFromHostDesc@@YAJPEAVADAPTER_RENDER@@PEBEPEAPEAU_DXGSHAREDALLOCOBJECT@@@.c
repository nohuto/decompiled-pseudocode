/*
 * XREFs of ?DxgkpCreateSharedObjectFromHostDesc@@YAJPEAVADAPTER_RENDER@@PEBEPEAPEAU_DXGSHAREDALLOCOBJECT@@@Z @ 0x1C03736F8
 * Callers:
 ...
 *     ?AddNtSharedAllocObject@ADAPTER_RENDER@@QEAAXPEAU_LIST_ENTRY@@@Z @ 0x1C0054140 (-AddNtSharedAllocObject@ADAPTER_RENDER@@QEAAXPEAU_LIST_ENTRY@@@Z.c)
        ...
        struct _LIST_ENTRY **a3)
{
  ...
  DXGKEYEDMUTEX *v42; // [rsp+50h] [rbp-B0h] BYREF
...
LABEL_27:
    *((_DWORD *)v10 + 33) = v22;
    ...
    if ( v34 )
    {
      ...
      v51[3] |= 3u;
      v51[2] = 3;
      v36 = CreateSynchronizationObjectInternal(0LL, 1, (__int64)a1, (__int64)v51, 14, v34, &v43, 0LL, 0LL);
      v5 = v36;
      if ( v36 < 0 )
      {
LABEL_29:
