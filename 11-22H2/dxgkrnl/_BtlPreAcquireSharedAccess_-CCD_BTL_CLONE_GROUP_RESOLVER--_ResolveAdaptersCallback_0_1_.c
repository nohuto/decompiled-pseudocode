/*
 * XREFs of _BtlPreAcquireSharedAccess_&CCD_BTL_CLONE_GROUP_RESOLVER::_ResolveAdaptersCallback_0_1_ @ 0x1C017B040
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
    ...
    do
    {
      ...
      {
        v17 = CCD_BTL_CLONE_GROUP_RESOLVER::_ResolveCloneGroupOnAdapter(this, a1, v16, v21);
        v9 = v17;
        if ( v17 == -1073741275 )
        {
          ++v15;
...
LABEL_24:
    ...
    if ( *(_WORD *)(*(_QWORD *)this + 32LL) )
    {
      do
      {
        ...
        {
          v20 = CCD_BTL_CLONE_GROUP_RESOLVER::_ResolveCloneGroupOnAdapter(this, a1, v19, 0LL);
          v9 = v20;
          if ( v20 == -1073741275 )
          {
            ++v18;
