/*
 * XREFs of ?RtlUnicodeStringCat@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z @ 0x1C004EC10
 * Callers:
 ...
 *     RtlUnicodeStringValidateWorker_0 @ 0x1C004EDF8 (RtlUnicodeStringValidateWorker_0.c)
 */
