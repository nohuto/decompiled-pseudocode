/*
 * XREFs of ?DestroyAdapterInfo@DXGPROCESS@@QEAAXPEAUDXGPROCESS_RENDER_ADAPTER_INFO@@@Z @ 0x1C01A97E4
 * Callers:
  ...
  *(_QWORD *)(*((_QWORD *)this + 6) + 8LL * *(unsigned int *)(v5 + 240)) = 0LL;
  ...
  while ( v13 != (struct DXGPROCESS_RENDER_ADAPTER_INFO *)(a2 + 17) )
  {
    ...
    if ( *((_QWORD *)v14 + 3) )
    {
      ...
      if ( (unsigned int)dword_1C013F918 > 5 && tlgKeywordOn((__int64)&dword_1C013F918, 0x400000000010LL) )
      {
        v20 = *((_QWORD *)this + 8);
