/*
 * XREFs of ?InitializeForHardware@DXGPROCESS_ADAPTER_INFO_PASID_DATA@@QEAAJIPEAVDXGADAPTER@@@Z @ 0x1C0344F94
 * Callers:
        ...
        struct DXGADAPTER *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( !SmmUseIommuV3Interface() )
      break;
    LODWORD(v11) = ((__int64 (__fastcall *)(_QWORD, __int64, __int64))qword_1C0140CA0)(
...
LABEL_17:
    ...
    LODWORD(v11) = ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C0140CB0)(
                     *((_QWORD *)this + 5),
                     *(_QWORD *)(v7 + v14));
    if ( (int)v11 < 0 )
      goto LABEL_17;
