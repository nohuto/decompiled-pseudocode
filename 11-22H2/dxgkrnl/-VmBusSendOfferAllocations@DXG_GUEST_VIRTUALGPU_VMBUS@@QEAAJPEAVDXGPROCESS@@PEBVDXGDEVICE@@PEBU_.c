/*
 * XREFs of ?VmBusSendOfferAllocations@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEBVDXGDEVICE@@PEBU_D3DKMT_OFFERALLOCATIONS@@PEBI@Z @ 0x1C038B62C
 * Callers:
        ...
        const unsigned int *a5)
{
  ...
  {
    WdLogSingleEntry1(2LL, 10456LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"NumAllocations is invalid", 10456LL, 0LL, 0LL, 0LL, 0LL);
