/*
 * XREFs of DxgkCreateBundleObjectInternal @ 0x1C0327010
 * Callers:
    ...
    if ( (_DWORD)v14 )
    {
      while ( 1 )
      {
        ...
        else
        {
          ...
          DXGPROCESSDDILOCK::~DXGPROCESSDDILOCK((DXGPROCESSDDILOCK *)v68);
          v28 = v66;
        }
        if ( EntryType == 4 )
        {
...
LABEL_70:
    ...
    if ( v43 < 0 )
    {
      ...
      if ( Object )
      {
        WdLogSingleEntry1(1LL, 2251LL);
        DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pBundleObject == NULL", 2251LL, 0LL, 0LL, 0LL, 0LL);
      }
      goto LABEL_100;
    }
    v44 = Object;
