/*
 * XREFs of ?GetDisplayModeFromPath@DMMVIDPNPRESENTPATH@@QEBAJ_NAEAU_DXGK_DISPLAYMODE_INFO@@@Z @ 0x1C016E078
 * Callers:
        ...
        struct _D3DDDI_RATIONAL *a3)
{
  ...
  if ( v7 )
  {
    ...
    v9 = *((_QWORD *)v20 + 18);
    if ( v9
      && (v10 = (unsigned int)D3DKMDT_VPPR_GET_CONTENT_ROTATION((enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION)*((_DWORD *)this + 29)),
