/*
 * XREFs of _lambda_4c48f59c4c84661c362f6a1166e0c309_::operator() @ 0x1C0167008
 * Callers:
...
char __fastcall lambda_4c48f59c4c84661c362f6a1166e0c309_::operator()(int **a1)
{
  int *v1; // rsi
  char *v2; // rbx
  int *v3; // rdi
  ...
  {
    LOBYTE(CurrentProcessSessionId) = tlgKeywordOn((__int64)&dword_1C013F918, 0x400000000000LL);
