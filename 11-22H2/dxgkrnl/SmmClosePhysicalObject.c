/*
 * XREFs of SmmClosePhysicalObject @ 0x1C0012C88
 * Callers:
 ...
 *     DxgkClosePhysicalMemoryObjectCB @ 0x1C0052F80 (DxgkClosePhysicalMemoryObjectCB.c)
...
void __fastcall SmmClosePhysicalObject(__int64 *a1, __int64 a2, int a3)
{
  ...
  if ( (Microsoft_Windows_DxgKrnl_SysMmEnableBits & 1) != 0 )
    McTemplateK0ppp_EtwWriteTransfer(
      ...
      (_BYTE)a1 - 64,
      (char)a1);
  if ( (dword_1C0140CD0 & 0x20) != 0 && *(_QWORD *)v3[3] != v3[3] )
  {
  ...
  *v8 = v7;
  ...
  if ( (*(_DWORD *)(v4 + 92) & 1) != 0 && (dword_1C0140CD0 & 0x18) == 0 )
