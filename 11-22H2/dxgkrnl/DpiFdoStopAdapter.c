/*
 * XREFs of DpiFdoStopAdapter @ 0x1C039D274
 * Callers:
 ...
 *     DpiFdoDetermineAffectedSession @ 0x1C039AA68 (DpiFdoDetermineAffectedSession.c)
 *     DpiFdoDestroyRelatedObjects @ 0x1C039B124 (DpiFdoDestroyRelatedObjects.c)
 *     DpiFdoDisconnectInterrupt @ 0x1C039B1CC (DpiFdoDisconnectInterrupt.c)
...
__int64 __fastcall DpiFdoStopAdapter(struct _DEVICE_OBJECT *a1, __int64 a2)
{
  ...
  *((_DWORD *)DeviceExtension + 59) = 4;
  if ( v6 && *((_DWORD *)DeviceExtension + 5) == 2 )
  {
    ...
    if ( (DeviceExtension[3920] & 1) != 0 || (struct _DEVICE_OBJECT *)qword_1C01404A8 == a1 )
    {
      ...
      if ( (struct _DEVICE_OBJECT *)qword_1C01404B0 == a1 )
      {
        LOBYTE(word_1C014049C) = 0;
        qword_1C01404B0 = 0LL;
      }
      if ( (struct _DEVICE_OBJECT *)qword_1C01404A8 == a1 )
      {
        word_1C014049C = 0;
        qword_1C01404A8 = 0LL;
      }
      ...
      if ( (DeviceExtension[3920] & 1) != 0 )
        DpiPnpNotifyGdi((__int64)a1, 0, (__int64)started, v8, 1, a2);
      else
    ...
    if ( DeviceExtension[1152] && dword_1C01407F4 != -1 )
    {
      ...
      if ( *((_DWORD *)DeviceExtension + 920) )
      {
        ...
        do
        {
          if ( *v15 == v16 )
            break;
          if ( *((_DWORD *)v15 + 126) == dword_1C01407F4 )
          {
            v17 = (__int128 *)v15[116];
            if ( v17 )
            {
              xmmword_1C0140770 = *v17;
              xmmword_1C0140780 = v17[1];
              xmmword_1C0140790 = v17[2];
              xmmword_1C01407A0 = v17[3];
              xmmword_1C01407B0 = v17[4];
              xmmword_1C01407C0 = v17[5];
              xmmword_1C01407D0 = v17[6];
              xmmword_1C01407E0 = v17[7];
              v16 = *((_QWORD *)DeviceExtension + 458);
            }
          }
          v15 = (__int64 *)*v15;
  ...
  if ( DeviceExtension[1152] )
  {
    if ( v21 )
    {
      ...
      if ( v22 < 0 || DWORD2(xmmword_1C0140760) != dword_1C01407F4 )
