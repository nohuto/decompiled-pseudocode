/*
 * XREFs of RESOURCE_HUB_STRING_PRINTF @ 0x1C0066480
 * Callers:
 *     DpOpenSpbResource @ 0x1C03A76E0 (DpOpenSpbResource.c)
 * Callees:
 *     ?RtlStringCbVPrintfExW@@YAJPEAG_KPEAPEAGPEA_KKPEBGPEAD@Z @ 0x1C006632C (-RtlStringCbVPrintfExW@@YAJPEAG_KPEAPEAGPEA_KKPEBGPEAD@Z.c)
 */
