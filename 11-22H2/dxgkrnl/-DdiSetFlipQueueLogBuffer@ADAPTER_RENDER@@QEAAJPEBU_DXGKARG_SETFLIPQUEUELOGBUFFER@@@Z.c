/*
 * XREFs of ?DdiSetFlipQueueLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETFLIPQUEUELOGBUFFER@@@Z @ 0x1C02CB080
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetFlipQueueLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETFLIPQUEUELOGBUFFER@@@Z @ 0x1C0048DF0 (-ADAPTER_RENDER_DdiSetFlipQueueLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETFLIPQUEUELOGBUF.c)
 * Callees:
