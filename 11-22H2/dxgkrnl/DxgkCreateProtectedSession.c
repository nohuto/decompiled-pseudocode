/*
 * XREFs of DxgkCreateProtectedSession @ 0x1C0349140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCreateProtectedSession(struct DXGDEVICE *a1)
{
  ...
  struct DXGDEVICE *v32; // r15
  __int64 v33; // rbx
  struct DXGSYNCOBJECT *v34; // rsi
  ...
  struct DXGPROTECTEDSESSION *v50; // [rsp+78h] [rbp-150h] BYREF
...
LABEL_65:
  ...
  if ( !v28 )
  {
    ...
    v30 = L"Invalid sync object, process 0x%I64x, handle 0x%I64x";
LABEL_67:
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)v30, (__int64)Current, v29, 0LL, 0LL, 0LL);
    goto LABEL_68;
  }
  v31 = *(struct DXGDEVICE **)(v28 + 16);
  v32 = v56;
  if ( v31 != v56 )
  {
    v33 = HIDWORD(Src[0]);
    WdLogSingleEntry3(2LL, HIDWORD(Src[0]), v31, v56);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
  ...
  v34 = *(struct DXGSYNCOBJECT **)(v28 + 32);
  v51 = v34;
  DXGSYNCOBJECT::AddReference(v34);
  if ( *((_DWORD *)v34 + 50) != 5 )
  {
    v29 = HIDWORD(Src[0]);
    WdLogSingleEntry2(2LL, Current, HIDWORD(Src[0]));
    v30 = L"not monitored fence object, process 0x%I64x, handle 0x%I64x";
    goto LABEL_67;
  }
  if ( (*((_DWORD *)v34 + 51) & 2) == 0 )
  {
    v35 = v51;
