/*
 * XREFs of ?GetUmdFileVersion@ADAPTER_RENDER@@QEAAJPEAT_LARGE_INTEGER@@@Z @ 0x1C0192AEC
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetUmdFileVersion(union _LARGE_INTEGER *this, union _LARGE_INTEGER *a2)
{
  ...
  if ( !a2 )
  {
    ...
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pFileVersion != NULL", 3830LL, 0LL, 0LL, 0LL, 0LL);
  }
...
LABEL_5:
  ...
  *(_OWORD *)Src = 0LL;
  ...
  if ( FileVersion == v23 )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v13, v12, v14, v15) + 24) = 3898LL;
    v16 = 2 * wcsnlen(v7, v8);
    if ( v16 >= v6 )
    {
