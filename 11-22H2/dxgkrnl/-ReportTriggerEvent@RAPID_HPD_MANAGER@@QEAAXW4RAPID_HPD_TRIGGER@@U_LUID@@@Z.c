/*
 * XREFs of ?ReportTriggerEvent@RAPID_HPD_MANAGER@@QEAAXW4RAPID_HPD_TRIGGER@@U_LUID@@@Z @ 0x1C001A770
 * Callers:
 ...
 *     ?InRapidHPDPeriod@RAPID_HPD_MANAGER@@AEAAXW4RAPID_HPD_PERIOD_UPDATE@1@AEA_N1@Z @ 0x1C001CB20 (-InRapidHPDPeriod@RAPID_HPD_MANAGER@@AEAAXW4RAPID_HPD_PERIOD_UPDATE@1@AEA_N1@Z.c)
...
void __fastcall RAPID_HPD_MANAGER::ReportTriggerEvent(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  *(_DWORD *)(a1 + 52) = 1;
  if ( a2 == 3 )
  {
    if ( (unsigned int)dword_1C013F8E0 > 5 )
    {
  ...
  else if ( (unsigned int)dword_1C013F8E0 > 5 && tlgKeywordOn((__int64)&dword_1C013F8E0, 0x400000000002LL) )
  {
    v25 = (unsigned __int8)v25;
    v26 = *(unsigned __int8 *)(a1 + 32);
    v16 = *(_DWORD *)(a1 + 80);
