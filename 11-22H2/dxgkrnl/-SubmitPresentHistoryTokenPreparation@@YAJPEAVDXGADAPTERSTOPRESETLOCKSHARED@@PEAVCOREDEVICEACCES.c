/*
 * XREFs of ?SubmitPresentHistoryTokenPreparation@@YAJPEAVDXGADAPTERSTOPRESETLOCKSHARED@@PEAVCOREDEVICEACCESS@@PEAVDXGADAPTER@@PEAU_D3DKMT_PRESENTHISTORYTOKEN@@PEAX_N@Z @ 0x1C01C0160
 * Callers:
        ...
        bool a6)
{
  ...
  if ( !(unsigned __int8)ExTryAcquirePushLockSharedEx(v6 + 976, 0LL) )
  {
    if ( bTracingEnabled )
    {
      ...
      if ( v29 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x100) != 0 )
        McTemplateK0q_EtwWriteTransfer(v11, &EventBlockThread, v12, v29);
    }
  ...
  v18 = (struct _KTHREAD **)*((_QWORD *)a2 + 3);
  *((_BYTE *)a2 + 32) = 0;
  if ( KeGetCurrentThread() != v18[23] )
    DXGADAPTER::ReleaseCoreResource((DXGADAPTER *)v18, *((char **)a2 + 5));
  *((_QWORD *)a2 + 5) = 0LL;
  if ( *((_BYTE *)a2 + 144) )
