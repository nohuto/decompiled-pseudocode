/*
 * XREFs of ?CreateSharedProtectedSessionNtObject@@YAJDW4_HMGRENTRY_TYPE@@IPEAXPEAU_OBJECT_ATTRIBUTES@@DPEAPEAX@Z @ 0x1C03265E4
 * Callers:
...
LABEL_17:
  ...
  if ( v20 < 0 )
  {
    if ( Object )
    {
      WdLogSingleEntry1(1LL, 555LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pObject == NULL", 555LL, 0LL, 0LL, 0LL, 0LL);
    }
    v19 = Current;
    goto LABEL_17;
  }
