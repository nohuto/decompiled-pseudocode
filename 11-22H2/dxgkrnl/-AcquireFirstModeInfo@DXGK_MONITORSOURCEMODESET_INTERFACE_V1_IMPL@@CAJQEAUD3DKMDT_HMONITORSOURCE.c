/*
 * XREFs of ?AcquireFirstModeInfo@DXGK_MONITORSOURCEMODESET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORSOURCEMODESET__@@PEAPEBU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C020C3C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v17, 7018);
    ...
    else
    {
      ...
      RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>::RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>(
        ...
        *(struct _ERESOURCE **)&v11[2].ActiveCount,
        1);
      v12 = Resource;
      ModeInfo = DxgMonitor::MonitorModes::_AcquireFirstModeInfo((DxgMonitor::MonitorModes *)Resource, a2);
      if ( v12 )
      {
