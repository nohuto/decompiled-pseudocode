/*
 * XREFs of ?ExtendExistingHPDPeriod@RAPID_HPD_MANAGER@@QEAAXW4RAPID_HPD_EXTENSION@@U_LUID@@@Z @ 0x1C0057064
 * Callers:
...
void __fastcall RAPID_HPD_MANAGER::ExtendExistingHPDPeriod(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( v31 )
  {
    if ( (unsigned int)dword_1C013F8E0 > 5 && tlgKeywordOn((__int64)&dword_1C013F8E0, 0x400000000002LL) )
    {
  ...
  else if ( (unsigned int)dword_1C013F8E0 > 5 )
  {
