/*
 * XREFs of DpiFdoValidateKmdAndPnpVersionMatch @ 0x1C021D870
 * Callers:
 *     DpiFdoInitializeFdo @ 0x1C020431C (DpiFdoInitializeFdo.c)
 * Callees:
 *     _tlgKeywordOn @ 0x1C0003734 (_tlgKeywordOn.c)
 *     DxgkLogInternalTriageEvent @ 0x1C0004FC0 (DxgkLogInternalTriageEvent.c)
 *     ?RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z @ 0x1C0020868 (-RtlUnicodeStringCchCopyStringN@@YAJPEAU_UNICODE_STRING@@PEBG_K@Z.c)
 ...
 *     IsKnownMismatchedVersionedDriver @ 0x1C039AD78 (IsKnownMismatchedVersionedDriver.c)
 */
...
LABEL_32:
  ...
  {
    if ( (unsigned int)dword_1C013F918 > 5 && tlgKeywordOn((__int64)&dword_1C013F918, 0x400000000100LL) )
    {
      v36 = *(_DWORD *)(a1 + 1140);
      v37 = *(_DWORD *)(a1 + 1136);
      v38 = *(_DWORD *)(a1 + 1132);
