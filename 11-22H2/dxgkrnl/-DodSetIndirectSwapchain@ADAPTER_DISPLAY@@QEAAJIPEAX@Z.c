/*
 * XREFs of ?DodSetIndirectSwapchain@ADAPTER_DISPLAY@@QEAAJIPEAX@Z @ 0x1C02BCC98
 * Callers:
 ...
 *     ?SwapChainOpenInternal@@YAPEAUDXGSWAPCHAIN_CONTAINER@@PEAX@Z @ 0x1C035A538 (-SwapChainOpenInternal@@YAPEAUDXGSWAPCHAIN_CONTAINER@@PEAX@Z.c)
...
LABEL_4:
  ...
  {
    WdLogSingleEntry1((unsigned int)(v7.HighPart + 2), 8527LL);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
