/*
 * XREFs of ?CollectDisplayAdapterDiagData@DISPLAYDIAGNOSTICADAPTERDATA@@QEAAJPEAVDXGADAPTER@@@Z @ 0x1C02F7728
 * Callers:
 ...
 *     DpiIsLastLidStateOpen @ 0x1C005E77C (DpiIsLastLidStateOpen.c)
