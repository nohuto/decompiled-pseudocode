/*
 * XREFs of DxgkCreateLightweightDeviceAndContext @ 0x1C02D0EF8
 * Callers:
...
LABEL_50:
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)v9 + 1) = KeGetCurrentThread();
    ...
    if ( !v36 )
    {
      WdLogSingleEntry1(1LL, 12368LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"RenderAdapterRef", 12368LL, 0LL, 0LL, 0LL, 0LL);
      v13 = v36;
    }
    if ( v8 == v13 )
    {
  ...
  while ( 1 )
  {
    ...
    if ( (*((_DWORD *)v36 + 109) & 0x10) != 0 )
    {
      ...
      *(_OWORD *)&v47.OutputDataSize = 0LL;
      ...
      {
        WdLogSingleEntry1(1LL, 12516LL);
        DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NT_SUCCESS(Status)", 12516LL, 0LL, 0LL, 0LL, 0LL);
      }
      v30 = HIDWORD(v48);
      v28 = v36;
    }
