/*
 * XREFs of DpiQueryDisplayIDDescriptor @ 0x1C0227804
 * Callers:
 *     ?GetDisplayIdDescriptor@KernelDriver@@UEBAJPEAIPEAE@Z @ 0x1C02277E0 (-GetDisplayIdDescriptor@KernelDriver@@UEBAJPEAIPEAE@Z.c)
 * Callees:
