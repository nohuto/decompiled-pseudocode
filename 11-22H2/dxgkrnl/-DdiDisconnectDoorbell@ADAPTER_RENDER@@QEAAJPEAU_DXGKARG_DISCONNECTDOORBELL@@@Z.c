/*
 * XREFs of ?DdiDisconnectDoorbell@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DISCONNECTDOORBELL@@@Z @ 0x1C02C7498
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDisconnectDoorbell(
        ADAPTER_RENDER *this,
        struct _DXGKARG_DISCONNECTDOORBELL *a2,
        __int64 a3)
{
  ...
  if ( (qword_1C013F870 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5164);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5164);
  ...
  v10 = (*(int (__fastcall **)(struct _DXGKARG_DISCONNECTDOORBELL *))(*((_QWORD *)this + 2) + 1536LL))(a2);
  if ( v19[0] )
