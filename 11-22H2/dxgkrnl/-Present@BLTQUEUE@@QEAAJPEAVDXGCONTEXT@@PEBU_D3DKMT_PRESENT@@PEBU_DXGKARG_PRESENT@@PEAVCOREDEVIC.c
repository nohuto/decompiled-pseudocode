/*
 * XREFs of ?Present@BLTQUEUE@@QEAAJPEAVDXGCONTEXT@@PEBU_D3DKMT_PRESENT@@PEBU_DXGKARG_PRESENT@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C03D28F8
 * Callers:
    ...
    if ( (int)Current >= 0 )
    {
      ...
      if ( (int)Current >= 0 )
      {
        ...
        *((_QWORD *)v24 + 71) = v38;
        ...
        DXGPROCESSDDILOCK::~DXGPROCESSDDILOCK((DXGPROCESSDDILOCK *)v58);
        DXGSYNCOBJECTMUTEX::~DXGSYNCOBJECTMUTEX((DXGSYNCOBJECTMUTEX *)v57);
        goto LABEL_71;
      }
      v36 = 1201LL;
