/*
 * XREFs of ?ReportState@DXGADAPTER@@QEAAXXZ @ 0x1C02B96C8
 * Callers:
 ...
 *     ?ReportNodeMetadata@DXGADAPTER@@QEBAXXZ @ 0x1C021B04C (-ReportNodeMetadata@DXGADAPTER@@QEBAXXZ.c)
...
void __fastcall DXGADAPTER::ReportState(DXGADAPTER *this)
{
  ...
  {
    WdLogSingleEntry1(1LL, 9929LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceExclusiveOwner()", 9929LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( bTracingEnabled )
  {
