/*
 * XREFs of ??1CIFlipPresentHistoryTokenFlipManager@@UEAA@XZ @ 0x1C0052C94
 * Callers:
 *     ??_GCIFlipPresentHistoryTokenFlipManager@@UEAAPEAXI@Z @ 0x1C0052D30 (--_GCIFlipPresentHistoryTokenFlipManager@@UEAAPEAXI@Z.c)
 * Callees:
