/*
 * XREFs of ?AcquireMultiPlaneOverlay3FlipFences@DXGCONTEXT@@AEAAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY3@@IPEAUVIDSCH_SUBMIT_DATA_BASE@@PEAVDXGSYNCOBJECTLOCK@@PEAVDXGSYNCOBJECTMUTEX@@3@Z @ 0x1C01C31C0
 * Callers:
...
LABEL_31:
          v51[v12 + 8] = Value;
          v34 = DXGPROCESS::GetCurrent(Value);
