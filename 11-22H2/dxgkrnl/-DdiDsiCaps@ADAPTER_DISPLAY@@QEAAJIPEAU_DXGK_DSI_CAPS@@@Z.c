/*
 * XREFs of ?DdiDsiCaps@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGK_DSI_CAPS@@@Z @ 0x1C02C76C4
 * Callers:
 *     ?DdiDsiCaps@KernelDriver@@UEBAJPEAU_DXGK_DSI_CAPS@@@Z @ 0x1C03CEB70 (-DdiDsiCaps@KernelDriver@@UEBAJPEAU_DXGK_DSI_CAPS@@@Z.c)
 * Callees:
