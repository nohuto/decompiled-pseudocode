/*
 * XREFs of ?NotifyFrame@CPresentRate@@QEAAXXZ @ 0x1C007D358
 * Callers:
 ...
 * Callees:
 *     ?AddPresent@CInterval@CPresentRate@@QEAA_NK@Z @ 0x1C007D32C (-AddPresent@CInterval@CPresentRate@@QEAA_NK@Z.c)
 */
