/*
 * XREFs of DpiFdoHandleRemoveDevice @ 0x1C039B860
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiPdoDestroyPendingPdoObjects @ 0x1C03A9660 (DpiPdoDestroyPendingPdoObjects.c)
...
__int64 __fastcall DpiFdoHandleRemoveDevice(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  if ( (PDEVICE_OBJECT)qword_1C0140748 == DeviceObject )
  {
