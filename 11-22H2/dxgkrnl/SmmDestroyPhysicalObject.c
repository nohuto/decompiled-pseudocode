/*
 * XREFs of SmmDestroyPhysicalObject @ 0x1C0012E30
 * Callers:
...
void __fastcall SmmDestroyPhysicalObject(_DWORD *RegionSize, char a2)
{
  ...
  _InterlockedExchangeAdd64(&qword_1C0140CD8, -*(_QWORD *)RegionSize);
  v7 = (volatile signed __int64 *)&unk_1C0140CE8;
  if ( (*v2 & 1) == 0 )
    v7 = (volatile signed __int64 *)&unk_1C0140CE0;
