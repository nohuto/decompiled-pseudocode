/*
 * XREFs of ?DdiGetDPAddress@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETDPADDRESS@@@Z @ 0x1C0225E90
 * Callers:
 *     NtDxgkDisplayPortOperation @ 0x1C004B890 (NtDxgkDisplayPortOperation.c)
 *     ?GetDisplayPortAddress@KernelDriver@@UEBAJPEAU_DXGKARG_GETDPADDRESS@@@Z @ 0x1C0225E70 (-GetDisplayPortAddress@KernelDriver@@UEBAJPEAU_DXGKARG_GETDPADDRESS@@@Z.c)
 * Callees:
