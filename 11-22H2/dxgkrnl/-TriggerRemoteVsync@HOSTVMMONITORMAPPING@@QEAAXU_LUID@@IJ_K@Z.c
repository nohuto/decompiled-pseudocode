/*
 * XREFs of ?TriggerRemoteVsync@HOSTVMMONITORMAPPING@@QEAAXU_LUID@@IJ_K@Z @ 0x1C002B184
 * Callers:
...
void __fastcall HOSTVMMONITORMAPPING::TriggerRemoteVsync(KSPIN_LOCK *this, struct _LUID a2, int a3, int a4, char a5)
{
  ...
  *((_QWORD *)v5 + 1) = KeGetCurrentThread();
  ...
  while ( lambda_6c593f0663b4833716b1eb40f385246b_::operator()((__int64)v10, v9) && v8 != (HOSTVMMONITORMAPPING *)this );
  if ( v13 )
  {
LABEL_6:
    v13 = 0;
