/*
 * XREFs of __report_gsfailure @ 0x1400014E0
 * Callers:
 *     __security_check_cookie @ 0x1400014B0 (__security_check_cookie.c)
 * Callees:
 *     NtTerminateProcess_0 @ 0x1400016E0 (NtTerminateProcess_0.c)
 *     RtlCaptureContext_0 @ 0x1400016EC (RtlCaptureContext_0.c)
 *     RtlLookupFunctionEntry_0 @ 0x1400016F8 (RtlLookupFunctionEntry_0.c)
 *     RtlVirtualUnwind_0 @ 0x140001704 (RtlVirtualUnwind_0.c)
 *     RtlUnhandledExceptionFilter_0 @ 0x140001710 (RtlUnhandledExceptionFilter_0.c)
 */
