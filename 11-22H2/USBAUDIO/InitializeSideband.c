/*
 * XREFs of InitializeSideband @ 0x1C000B83C
 * Callers:
 ...
 *     ??2@YAPEAX_KW4_POOL_TYPE@@K@Z @ 0x1C000B7CC (--2@YAPEAX_KW4_POOL_TYPE@@K@Z.c)
 *     ??0CSidebandDevice@@QEAA@PEAU_KSDEVICE@@PEAUIUnknown@@@Z @ 0x1C000BE58 (--0CSidebandDevice@@QEAA@PEAU_KSDEVICE@@PEAUIUnknown@@@Z.c)
...
LABEL_24:
  ...
  if ( v7 < 0 )
  {
    ...
    IoReleaseRemoveLockAndWaitEx((PIO_REMOVE_LOCK)(Context + 720), 0LL, 0x20u);
  }
  else
  {
    IoReleaseRemoveLockEx((PIO_REMOVE_LOCK)(Context + 720), 0LL, 0x20u);
  }
LABEL_37:
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || !_bittest((const signed __int32 *)&WPP_GLOBAL_Control->Timer + 1, 8u)
