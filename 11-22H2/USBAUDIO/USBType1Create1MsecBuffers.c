/*
 * XREFs of USBType1Create1MsecBuffers @ 0x1C00395BC
 * Callers:
...
__int64 __fastcall USBType1Create1MsecBuffers(__int64 a1)
{
  ...
  if ( (_DWORD)v6 )
    ...
    v7 = 12;
  v8 = v7 << 12;
  v9 = USBHwAllocateAndBag(&v19, ((_DWORD)v8 + 6147) & 0xFFFFF000, 64LL, *(_QWORD *)(a1 + 8));
  if ( v9 >= 0 )
  {
    v10 = v19;
    v11 = v8 + v19;
    ...
    *v13 = v13;
    while ( v9 >= 0 )
    {
      ...
      *(_QWORD *)(v12 + 16) = Irp;
      if ( Irp )
      {
        ...
        else
        {
          ...
          *(_QWORD *)(v12 + 24) = v11;
          ...
          v16 = (_QWORD *)v13[1];
          v11 = (v11 + 171) & 0xFFFFFFFFFFFFFFF8uLL;
          if ( (_QWORD *)*v16 != v13 )
            __fastfail(3u);
          *(_QWORD *)v12 = v13;
          *(_QWORD *)(v12 + 8) = v16;
      ...
      {
        if ( v9 >= 0 )
          KeInitializeSemaphore((PRKSEMAPHORE)(v21 + 152), 12, 12);
