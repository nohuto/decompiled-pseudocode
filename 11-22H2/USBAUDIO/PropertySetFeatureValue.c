/*
 * XREFs of PropertySetFeatureValue @ 0x1C002FF80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PropertySetFeatureValue(PIRP Irp, __int64 a2, __int64 a3)
{
  ...
  Context = (__int64)v8->Context;
  if ( *(_DWORD *)(*(_QWORD *)(Context + 16) + 536LL) == 1 )
  {
    v15 = *(_DWORD *)(a2 + 32);
    if ( v15 < *(_DWORD *)(v12 + 92) )
    {
      v9 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, unsigned int, int, unsigned int *, void *, ULONG))(v12 + 136))(
             Context,
             v12,
