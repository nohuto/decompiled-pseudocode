/*
 * XREFs of RegistryReadName @ 0x1C003A610
 * Callers:
 *     PropertyGetPinName @ 0x1C003A480 (PropertyGetPinName.c)
 * Callees:
 *     RegistryReadNameValue @ 0x1C003A264 (RegistryReadNameValue.c)
 */

NTSTATUS __fastcall RegistryReadName(__int64 a1, const GUID *a2, ULONG a3, void *a4, ULONG *a5)
{
  ULONG *v5; // rdi
