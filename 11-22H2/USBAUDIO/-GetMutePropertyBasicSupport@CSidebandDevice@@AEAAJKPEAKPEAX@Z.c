/*
 * XREFs of ?GetMutePropertyBasicSupport@CSidebandDevice@@AEAAJKPEAKPEAX@Z @ 0x1C000E4D4
 * Callers:
 ...
 *     PropertyGetBooleanBasicSupportSideband @ 0x1C002E534 (PropertyGetBooleanBasicSupportSideband.c)
 */
