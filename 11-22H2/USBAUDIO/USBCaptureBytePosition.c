/*
 * XREFs of USBCaptureBytePosition @ 0x1C00012C0
 * Callers:
 *     <none>
 * Callees:
...
{
  union _LARGE_INTEGER *Context; // rsi
  union _LARGE_INTEGER v4; // r12
  union _LARGE_INTEGER v5; // r15
  KSPIN_LOCK *p_QuadPart; // rbp
  NTSTATUS AvailableByteCount; // edi
  KIRQL v8; // al
  KIRQL v9; // r14
  KIRQL v10; // al
  ...
  if ( BYTE5(Context[5].QuadPart) )
  {
    ...
    if ( v13 )
    {
      ...
      if ( AvailableByteCount >= 0 )
      {
        ...
        a2[2] = v14;
        v16 = *(unsigned int *)(v5.QuadPart + 104);
        if ( LowPart - v16 >= 0 )
        {
          v17 = *(unsigned int *)(v5.QuadPart + 100);
          if ( v4.QuadPart )
          {
