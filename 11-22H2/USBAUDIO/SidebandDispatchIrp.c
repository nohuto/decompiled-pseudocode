/*
 * XREFs of SidebandDispatchIrp @ 0x1C0007C88
 * Callers:
...
__int64 __fastcall SidebandDispatchIrp(PDEVICE_OBJECT FunctionalDeviceObject, PIRP Irp)
{
  ...
  if ( DeviceForDeviceObject )
  {
    ...
    if ( v15 )
    {
      ...
      v18 = (struct _IO_REMOVE_LOCK *)(Context + 720);
      v10 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(Context + 720), 0LL, File, 1u, 0x20u);
      if ( v10 >= 0 )
      {
