 ...
 *     PropertyGetMicArrayGeometry @ 0x1C002EAC0 (PropertyGetMicArrayGeometry.c)
 *     RegistryGetValue @ 0x1C003093C (RegistryGetValue.c)
 *     WmiQueryRegInfo @ 0x1C0031290 (WmiQueryRegInfo.c)
 ...
 *     USBCntrlGetDescriptor @ 0x1C0036290 (USBCntrlGetDescriptor.c)
 *     USBCaptureCopyRequestToBuffer @ 0x1C00376E0 (USBCaptureCopyRequestToBuffer.c)
 ...
 *     PropertyAudioSignalProcessing @ 0x1C003A9A0 (PropertyAudioSignalProcessing.c)
 *     USBHwGetTransportResources @ 0x1C003B6A0 (USBHwGetTransportResources.c)
 *     USBMidiInCopyEvent @ 0x1C003C6E8 (USBMidiInCopyEvent.c)
