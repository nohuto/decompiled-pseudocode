/*
 * XREFs of ?GetSidetoneNodes@CSidebandDevice@@SAJKPEAU_KSFILTER_DESCRIPTOR@@PEAK1@Z @ 0x1C000F1E8
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  unsigned __int64 v25; // [rsp+C0h] [rbp+18h]
  ...
  if ( ConnectionsCount )
  {
    ...
    if ( v12 )
    {
      ConnectedCapturePin = CSidebandDevice::FindConnectedCapturePin(v7, a1, &v24);
      if ( ConnectedCapturePin >= 0 )
      {
        P[0].Blink = P;
        P[0].Flink = P;
        if ( (int)CSidebandDevice::GetNodesInPath(v7, (const KSTOPOLOGY_CONNECTION *)v24, a1, P) < 0 )
          goto LABEL_64;
        while ( 1 )
        {
          Flink = P[0].Flink;
          ...
          if ( *v17 == *(_QWORD *)&GUID_3a5acc00_c557_11d0_8a2b_00a0c9255ac1.Data1
            && v17[1] == *(_QWORD *)GUID_3a5acc00_c557_11d0_8a2b_00a0c9255ac1.Data4
            && v5 == -1 )
          {
            v5 = (int)Flink[1].Flink;
          }
          if ( *v17 == *(_QWORD *)&GUID_02b223c0_c557_11d0_8a2b_00a0c9255ac1.Data1
            && v17[1] == *(_QWORD *)GUID_02b223c0_c557_11d0_8a2b_00a0c9255ac1.Data4
            && v6 == -1 )
          {
