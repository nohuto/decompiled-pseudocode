/*
 * XREFs of ?GetSidetoneImmediate@CSidebandDevice@@AEAAJPEAU_IRP@@@Z @ 0x1C000EDA0
 * Callers:
...
__int64 __fastcall CSidebandDevice::GetSidetoneImmediate(CSidebandDevice *this, struct _IRP *a2)
{
  ...
  if ( !CSidebandDevice::IsValidEndpointIndex(v7, (struct _KSFILTER_DESCRIPTOR *)v5, *p_NamedPipeType) )
  {
