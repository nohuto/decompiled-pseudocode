/*
 * XREFs of USBParseGetMIDIStreamingEndpointDescriptor @ 0x1C0035174
 * Callers:
...
unsigned __int8 *__fastcall USBParseGetMIDIStreamingEndpointDescriptor(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  DescriptorInConfiguration = USBParseFindDescriptorInConfiguration(a1, &v7[*v7], 37LL, 4LL);
  ...
  if ( DescriptorInConfiguration )
  {
      ...
      && (unsigned __int64)&v9[v10 + 4] <= a1 + (unsigned __int64)*(unsigned __int16 *)(a1 + 2) )
    {
      ...
      {
        v13 = USBParseFindDescriptorInConfiguration(a1, &v4[*v4], 4LL, 9LL);
        if ( !v13 )
          return v9;
