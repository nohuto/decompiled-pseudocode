/*
 * XREFs of ?IoQueueThread@CSidebandDevice@@AEAAXXZ @ 0x1C000689C
 * Callers:
 *     ?staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z @ 0x1C0012B90 (-staticIoQueueThread@CSidebandDevice@@SAXPEAX@Z.c)
 * Callees:
