/*
 * XREFs of USBParseFeatureUnit @ 0x1C0034530
 * Callers:
 *     <none>
 * Callees:
 *     memset @ 0x1C001AF80 (memset.c)
 *     BusApiBuildFeatureFunctionUnit @ 0x1C0030BEC (BusApiBuildFeatureFunctionUnit.c)
...
__int64 __fastcall USBParseFeatureUnit(__int64 a1, unsigned __int8 *a2)
{
  ...
  v6 = *(_QWORD *)(v5 + 40);
  if ( (unsigned __int64)&a2[v4] > v6 + (unsigned __int64)*(unsigned __int16 *)(v6 + 2) )
    return 3221225473LL;
  v7 = a2[3];
  v8 = *(_QWORD *)(v5 + 48);
  v9 = 0;
  ...
  v20 = 0;
  v22 = 0LL;
  result = USBParseCountOutputChannelsForUnit(v6, v8, v7, &v21);
  if ( (int)result >= 0 )
  {
...
LABEL_20:
        ...
        UnitString = BusApiBuildFeatureFunctionUnit(a1, a2[3], v11, v20, (__int64)&v21, v22, Pool2);
        ExFreePool(Pool2);
        return UnitString;
      }
      while ( 1 )
