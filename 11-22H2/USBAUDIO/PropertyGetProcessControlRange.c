/*
 * XREFs of PropertyGetProcessControlRange @ 0x1C002EF24
 * Callers:
 *     TopologyPU3DExtender @ 0x1C002CEF0 (TopologyPU3DExtender.c)
 *     TopologyPUChorus @ 0x1C002CFE0 (TopologyPUChorus.c)
 *     TopologyPUDynRangeCompressor @ 0x1C002D150 (TopologyPUDynRangeCompressor.c)
 *     TopologyPUReverb @ 0x1C002D4C0 (TopologyPUReverb.c)
 * Callees:
