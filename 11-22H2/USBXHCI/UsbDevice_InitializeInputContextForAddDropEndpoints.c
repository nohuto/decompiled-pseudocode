/*
 * XREFs of UsbDevice_InitializeInputContextForAddDropEndpoints @ 0x1C000AF80
 * Callers:
 *     UsbDevice_HandleAddAndDropEndpointsState @ 0x1C000AE48 (UsbDevice_HandleAddAndDropEndpointsState.c)
 *     UsbDevice_HandleAddEndpointsState @ 0x1C0048F38 (UsbDevice_HandleAddEndpointsState.c)
 *     UsbDevice_HandleDropEndpointsState @ 0x1C0049128 (UsbDevice_HandleDropEndpointsState.c)
 * Callees:
