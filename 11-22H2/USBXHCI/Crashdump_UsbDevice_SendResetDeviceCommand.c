/*
 * XREFs of Crashdump_UsbDevice_SendResetDeviceCommand @ 0x1C0050E78
 * Callers:
 *     Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C0050840 (Crashdump_UsbDevice_ReConfigureOnPortReset.c)
 * Callees:
