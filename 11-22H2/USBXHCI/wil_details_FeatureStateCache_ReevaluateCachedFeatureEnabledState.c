/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C001F3CC
 * Callers:
        ...
        __int64 a3)
{
  ...
  for ( i = v5; ; i = v8 )
  {
    ...
    if ( v12 )
    {
      ...
      if ( (i & 1) == 0 )
      {
        v10 = v8 ^ (CurrentFeatureEnabledState ^ (unsigned __int16)v8) & 0x278 | 1;
        LODWORD(v13) = v10;
      }
    }
    if ( (v5 & 2) == 0 )
  ...
  if ( !v12 )
    LODWORD(v13) = ((unsigned __int16)v10 ^ CurrentFeatureEnabledState) & 0x278 ^ v10;
  return v13;
}
