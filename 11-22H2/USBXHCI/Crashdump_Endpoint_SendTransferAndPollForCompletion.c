/*
 * XREFs of Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x1C004F608
 * Callers:
 *     Crashdump_Endpoint_SendBulkTransfer @ 0x1C004F118 (Crashdump_Endpoint_SendBulkTransfer.c)
