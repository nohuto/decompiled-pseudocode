/*
 * XREFs of wil_details_EvaluateFeatureDependencies @ 0x1C006D0AC
 * Callers:
...
_QWORD *wil_details_EvaluateFeatureDependencies()
{
  ...
  v0 = (int **)wil_details_FeatureDescriptors_SkipPadding(&Feature_USB4PowerImprovements__private_descriptor);
  if ( v0 )
  {
    v1 = 0;
    do
  ...
  for ( i = &Feature_USB4PowerImprovements__private_descriptor; ; i = v6 + 6 )
  {
