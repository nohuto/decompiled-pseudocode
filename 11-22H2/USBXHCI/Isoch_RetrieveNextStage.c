 ...
 *     Isoch_GetPacketLength @ 0x1C00444B8 (Isoch_GetPacketLength.c)
 *     Isoch_Stage_Acquire @ 0x1C0045108 (Isoch_Stage_Acquire.c)
...
_BOOL8 __fastcall Isoch_RetrieveNextStage(__int64 a1)
{
  ...
  char v93; // [rsp+30h] [rbp-88h]
  __int64 v94; // [rsp+60h] [rbp-58h]
  unsigned int v95; // [rsp+C0h] [rbp+8h]
  unsigned int v96; // [rsp+C8h] [rbp+10h]
  __int64 v97; // [rsp+D0h] [rbp+18h] BYREF
  __int64 v98; // [rsp+D8h] [rbp+20h] BYREF
  ...
  *(_BYTE *)(a1 + 104) = v3;
  ...
  if ( *(_QWORD *)(a1 + 384) != a1 + 384 )
  {
    ...
    else if ( (unsigned int)(*(_DWORD *)(v7 + 108) + *(_DWORD *)(v7 + 104)) < *(_DWORD *)(v7 + 96) )
    {
...
LABEL_5:
  ...
  if ( v2 >= 0 )
  {
    while ( 1 )
    {
      v15 = Isoch_TransferData_Initialize(a1, v97, &v98);
      if ( v15 < 0 )
      {
        v17 = a1 + 56;
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        ...
        Isoch_Transfer_Complete(a1, v98, -1, -1073737728, 0);
        v20 = a1 + 48;
        goto LABEL_127;
      }
      v21 = 0;
...
LABEL_93:
        ...
        v68 = *(_DWORD *)(a1 + 356);
        v69 = v98;
        v70 = (v68 + *(_DWORD *)(v98 + 96) - (_DWORD)v56 - 1) % v68;
        v96 = (v68 + *(_DWORD *)(v98 + 96) - (_DWORD)v56 - 1) / v68;
        v71 = v96;
        if ( v96 )
        {
          v72 = 0;
          ...
          do
          {
            ...
            if ( v68 )
            {
              do
              {
                *(_DWORD *)(v94 + 12 * v56 + 148) = -1073414144;
