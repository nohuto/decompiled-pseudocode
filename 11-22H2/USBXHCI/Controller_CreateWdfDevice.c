/*
 * XREFs of Controller_CreateWdfDevice @ 0x1C006EFFC
 * Callers:
 ...
 *     Device_IsSecureDevice @ 0x1C001A4C8 (Device_IsSecureDevice.c)
 *     RtlUnicodeStringPrintf @ 0x1C001A4D8 (RtlUnicodeStringPrintf.c)
