/*
 * XREFs of ProcLibTraceRegisterParameterEvents @ 0x1C0004FBA
 * Callers:
...
char __fastcall ProcLibTraceRegisterParameterEvents(__int64 *a1, int a2)
{
  ...
  LOBYTE(v3) = EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v2);
  if ( (_BYTE)v3 )
  {
    *(_QWORD *)&UserData.Size = 8LL;
    ...
    if ( *(_BYTE *)(*v25 + 16) )
    {
      ...
      do
      {
        ...
        EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v2, 0LL, (ULONG)7, &UserData);
