/*
 * XREFs of PepNotifyQueryCoordinatedStates @ 0x1C0041D74
 * Callers:
...
__int64 __fastcall PepNotifyQueryCoordinatedStates(__int64 a1, PVOID **a2)
{
  ...
  v2 = (unsigned int)dword_1C001F68C;
  v4 = 0LL;
  v5 = 0LL;
  Pool2 = (unsigned int *)ExAllocatePool2(64LL, (unsigned int)(16 * dword_1C001F68C + 4), 1919119952LL);
  v37 = Pool2;
  v7 = Pool2;
  if ( Pool2 )
  {
...
LABEL_27:
          ...
          while ( 1 )
          {
            ...
            *v5 = v28;
            v5[1] = v30;
            v5[2] = *(_DWORD *)v29;
            v8 = ((__int64 (__fastcall *)(_QWORD, unsigned int *))qword_1C001F3A0)(*(_QWORD *)(a1 + 1120), v5);
            if ( v8 < 0 )
              break;
