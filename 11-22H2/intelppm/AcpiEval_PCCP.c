/*
 * XREFs of AcpiEval_PCCP @ 0x1C003AE0C
 * Callers:
...
__int64 __fastcall AcpiEval_PCCP(__int64 a1, _QWORD *a2)
{
  ...
  int v5; // ebx
  PVOID v6; // rdi
  unsigned __int8 v8[2]; // [rsp+40h] [rbp-30h] BYREF
  int v9; // [rsp+42h] [rbp-2Eh]
  const char *v10; // [rsp+48h] [rbp-28h]
  __int64 (__fastcall *v11)(__int64, _DWORD *, unsigned int); // [rsp+50h] [rbp-20h]
  char v12; // [rsp+58h] [rbp-18h]
  int v13; // [rsp+5Ah] [rbp-16h]
  const char *v14; // [rsp+60h] [rbp-10h]
  __int64 (__fastcall *v15)(__int64, _DWORD *, unsigned int); // [rsp+68h] [rbp-8h]
