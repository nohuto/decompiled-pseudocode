/*
 * XREFs of EmiProcessIoctl @ 0x1C00254B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_24:
      ...
      if ( v11 >= 0 )
      {
        ...
        *((_WORD *)v18 + 33) = *(_WORD *)(v9 + 1264);
        ...
        if ( *(_WORD *)(v9 + 1264) )
        {
          ...
          do
          {
            v33 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64))qword_1C001F2A8)(v9, v19, 0x800000000000LL);
            ((void (__fastcall *)(_QWORD, __int64 *, __int64 *, int *))qword_1C001F2B8)(v33, &v30, &v29, &v26);
            if ( v26 == 1 )
            {
    ...
    case 2244620:
      ...
      if ( v11 >= 0 )
      {
        v27 = (char *)v28;
        v7 = v12;
        ((void (__fastcall *)(__int64, __int64))qword_1C001F2A0)(v9, 0x800000000000LL);
        v13 = 0;
        if ( *(_WORD *)(v9 + 1264) )
        {
          v14 = v27;
          do
          {
            v32 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64))qword_1C001F2A8)(v9, v13, 0x800000000000LL);
            v15 = (unsigned __int64 *)&v14[16 * v5];
            v11 = ((__int64 (__fastcall *)(__int64, _QWORD, unsigned __int64 *, unsigned __int64 *))qword_1C001F2B0)(
                    v9,
                    v32,
                    v15,
                    v15 + 1);
