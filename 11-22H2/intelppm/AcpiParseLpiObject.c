/*
 * XREFs of AcpiParseLpiObject @ 0x1C003C4F0
 * Callers:
...
__int64 __fastcall AcpiParseLpiObject(__int64 a1, const wchar_t *a2, char a3, _QWORD *a4)
{
  ...
  __int64 (__fastcall *v125)(__int64, __int64, unsigned int); // [rsp+208h] [rbp+108h]
  char v126; // [rsp+210h] [rbp+110h]
  int v127; // [rsp+212h] [rbp+112h]
  const char *v128; // [rsp+218h] [rbp+118h]
  __int64 (__fastcall *v129)(__int64, __int64, unsigned int); // [rsp+220h] [rbp+120h]
  char v130; // [rsp+228h] [rbp+128h]
  int v131; // [rsp+22Ah] [rbp+12Ah]
  const char *v132; // [rsp+230h] [rbp+130h]
  __int64 (__fastcall *v133)(__int64, __int64, unsigned int); // [rsp+238h] [rbp+138h]
