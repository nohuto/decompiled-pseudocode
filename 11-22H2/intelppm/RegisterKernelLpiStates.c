/*
 * XREFs of RegisterKernelLpiStates @ 0x1C003F5D0
 * Callers:
...
__int64 __fastcall RegisterKernelLpiStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  unsigned __int8 v20; // [rsp+A8h] [rbp+20h] BYREF
    ...
    if ( *(_DWORD *)(v3 + 16) )
    {
      while ( 1 )
      {
        ...
        *(_OWORD *)(v10 + a2 + 136) = *(_OWORD *)(v12 + v3 + 88);
        ...
        if ( v14 < 0 )
          break;
        *(_DWORD *)(v10 + a2 + 120) = (4 * (v18 & 1)) | *(_DWORD *)(v10 + a2 + 120) & 0x7FFFFFF9 | (2
                                                                                                  * (v18 & 1 | (v20 << 30))) & 0xFFFFFFFB;
