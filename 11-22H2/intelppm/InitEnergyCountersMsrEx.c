/*
 * XREFs of InitEnergyCountersMsrEx @ 0x1C0034100
 * Callers:
 ...
 *     ActivateFixedFunctionCounters @ 0x1C0006E64 (ActivateFixedFunctionCounters.c)
 */
...
_DWORD *InitEnergyCountersMsrEx()
{
  ...
  if ( !v1 )
  {
    ...
    *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type |= 0x40u;
    qword_1C001F7D0[0] = (__int64)SnapEnergyCounters;
    result = ComputeProcessorEnergyMsrEx;
    qword_1C001F7C8[0] = (__int64)ComputeProcessorEnergyMsrEx;
  }
  return result;
}
