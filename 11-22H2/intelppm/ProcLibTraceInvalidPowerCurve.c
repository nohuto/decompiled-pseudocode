/*
 * XREFs of ProcLibTraceInvalidPowerCurve @ 0x1C004AE6C
 * Callers:
...
unsigned __int8 __fastcall ProcLibTraceInvalidPowerCurve(__int64 a1, unsigned int a2, const void *a3)
{
  ...
  if ( (unsigned int)dword_1C0016038 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v19 = 2;
      v21 = v24;
      return tlgWriteTransfer_EtwWriteTransfer((__int64)v24, (unsigned __int8 *)dword_1C0011E91, v6, v7, (ULONG)6, &v11);
    }
  }
  return result;
}
