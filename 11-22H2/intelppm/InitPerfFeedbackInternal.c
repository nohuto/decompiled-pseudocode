/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C003E658
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x1C003A760 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x1C0040460 (RegisterKernelPerfFeedback.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(_QWORD *a1, __int64 (__fastcall *a2)(_QWORD *))
{
        ...
        (v4 = (_QWORD *)inited) != 0LL) )
  {
    ...
    *(_WORD *)(inited + 6) = 1;
    *(_BYTE *)(inited + 52) = 2;
    *(_BYTE *)(inited + 14) = byte_1C001F580;
