/*
 * XREFs of InitPepIdleStates @ 0x1C00416BC
 * Callers:
 ...
 *     PepNotifyReportCStates @ 0x1C00427EC (PepNotifyReportCStates.c)
 */
...
__int64 __fastcall InitPepIdleStates(__int64 a1)
{
  ...
  if ( (v4 & 0x100000100LL) != 0 )
  {
    ...
    if ( v6 < 0 )
    {
      ...
      *(_QWORD *)(a1 + 280) &= 0xFFFFFFFEFFFFFEFFuLL;
    }
  }
LABEL_15:
  ...
  *(_QWORD *)(a1 + 1152) = v10;
  *(_QWORD *)(a1 + 1144) = v11;
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2512))(WdfDriverGlobals, qword_1C001F028);
