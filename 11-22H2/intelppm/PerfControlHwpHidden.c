/*
 * XREFs of PerfControlHwpHidden @ 0x1C00078B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PerfControlHwpHidden(__int64 a1, __int64 a2, char a3, char a4)
{
  ...
  if ( a4 && a3 )
  {
    ...
    if ( *(_BYTE *)(a1 + 125) )
      LODWORD(v8) = (v5 ^ (*(_DWORD *)(a1 + 64) << 16)) & 0xFF0000 ^ v5;
    return ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, __int64))qword_1C001F3D8)(
