/*
 * XREFs of AcpiEval_TSS @ 0x1C003B990
 * Callers:
...
__int64 __fastcall AcpiEval_TSS(__int64 a1, _QWORD *a2)
{
  ...
  unsigned __int8 v16[2]; // [rsp+50h] [rbp-69h] BYREF
  int v17; // [rsp+52h] [rbp-67h]
  const char *v18; // [rsp+58h] [rbp-61h]
  __int64 (__fastcall *v19)(__int64, _DWORD *, unsigned int); // [rsp+60h] [rbp-59h]
  char v20; // [rsp+68h] [rbp-51h]
  int v21; // [rsp+6Ah] [rbp-4Fh]
  const char *v22; // [rsp+70h] [rbp-49h]
  __int64 (__fastcall *v23)(__int64, _DWORD *, unsigned int); // [rsp+78h] [rbp-41h]
  char v24; // [rsp+80h] [rbp-39h]
  int v25; // [rsp+82h] [rbp-37h]
  const char *v26; // [rsp+88h] [rbp-31h]
  __int64 (__fastcall *v27)(__int64, _DWORD *, unsigned int); // [rsp+90h] [rbp-29h]
  char v28; // [rsp+98h] [rbp-21h]
  int v29; // [rsp+9Ah] [rbp-1Fh]
  const char *v30; // [rsp+A0h] [rbp-19h]
  __int64 (__fastcall *v31)(__int64, _DWORD *, unsigned int); // [rsp+A8h] [rbp-11h]
  char v32; // [rsp+B0h] [rbp-9h]
  int v33; // [rsp+B2h] [rbp-7h]
  const char *v34; // [rsp+B8h] [rbp-1h]
  __int64 (__fastcall *v35)(__int64, _DWORD *, unsigned int); // [rsp+C0h] [rbp+7h]
