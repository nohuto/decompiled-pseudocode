/*
 * XREFs of RegisterIdleDomain @ 0x1C003F1D0
 * Callers:
...
char __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  v6 = qword_1C001F088;
  v7 = v2 + 24LL * a2;
  if ( (__int64 *)qword_1C001F088 == &qword_1C001F088 )
    goto LABEL_6;
  do
  {
    v8 = v6;
  ...
  while ( (__int64 *)v6 != &qword_1C001F088 );
  if ( !v8 )
  {
LABEL_6:
    ...
    v10[1] = v10;
    *v10 = v10;
    v11 = (__int64 *)qword_1C001F090;
    if ( *(__int64 **)qword_1C001F090 != &qword_1C001F088 )
LABEL_15:
      __fastfail(3u);
    *(_QWORD *)v8 = &qword_1C001F088;
    *(_QWORD *)(v8 + 8) = v11;
    *v11 = v8;
    qword_1C001F090 = v8;
  ...
  *v15 = v14;
  *(_QWORD *)(v8 + 24) = v14;
  if ( !(unsigned int)KeCheckProcessorAffinityEx(v8 + 48, *(unsigned int *)(a1 + 56)) )
  {
