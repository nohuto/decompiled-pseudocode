/*
 * XREFs of RtlpSystemBootStatusRequest @ 0x180088244
 * Callers:
 *     RtlGetSystemBootStatus @ 0x1800881D0 (RtlGetSystemBootStatus.c)
 *     RtlSetSystemBootStatus @ 0x180088210 (RtlSetSystemBootStatus.c)
 *     RtlGetSystemBootStatusEx @ 0x1800F9710 (RtlGetSystemBootStatusEx.c)
 *     RtlSetSystemBootStatusEx @ 0x1800F98C0 (RtlSetSystemBootStatusEx.c)
 * Callees:
