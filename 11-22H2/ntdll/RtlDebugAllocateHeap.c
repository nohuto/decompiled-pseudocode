/*
 * XREFs of RtlDebugAllocateHeap @ 0x180103E60
 * Callers:
...
PVOID __fastcall RtlDebugAllocateHeap(_DWORD *Src, ULONG a2, SIZE_T a3)
{
  ...
  if ( (Src[29] & 0x1000000) != 0 )
    return (PVOID)((__int64 (*)(void))qword_18017E840)();
...
LABEL_46:
  ...
  {
    if ( (v17->NtGlobalFlag & 0x800) == 0 || !v27 || v27 != word_180182F08 || *((_WORD *)Src + 104) != word_180182F0A )
      goto LABEL_47;
    if ( NtCurrentPeb()->Ldr )
      DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
    else
