/*
 * XREFs of RtlpQueryExtendedInformationHeap @ 0x18008A9F0
 * Callers:
 ...
 *     RtlpHpHeapReportCounters @ 0x18008ABF0 (RtlpHpHeapReportCounters.c)
 ...
 *     RtlpQueryMemoryUsageHeap @ 0x1800FFB98 (RtlpQueryMemoryUsageHeap.c)
...
LABEL_99:
    ...
    else
    {
      ...
      v53 = *(_QWORD *)(v24 + 32);
      LODWORD(v54) = 1;
      HIDWORD(v54) = RtlpGetHeapProtection(a1, 0);
    }
    result = v40(&v50, v42);
    if ( (int)result < 0 )
      return result;
