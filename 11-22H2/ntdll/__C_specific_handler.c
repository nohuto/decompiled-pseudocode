/*
 * XREFs of __C_specific_handler @ 0x18008EFF0
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x18009E8BC (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x180020160 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x1800950D0 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x180095100 (__NLG_Return2.c)
 *     __except_validate_context_record @ 0x180095108 (__except_validate_context_record.c)
 */
