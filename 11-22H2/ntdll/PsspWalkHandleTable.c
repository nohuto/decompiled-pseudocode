/*
 * XREFs of PsspWalkHandleTable @ 0x180129A04
 * Callers:
        ...
        __int64 a6)
{
  ...
  _BYTE v26[16]; // [rsp+1B0h] [rbp+B0h] BYREF
...
LABEL_19:
    ...
    if ( (a4 & 8) != 0 )
    {
      memset_thunk_772440563353939046(v26, 0, 0x210uLL);
    ...
    if ( (a4 & 0x20) != 0 )
    {
      v15 = (const wchar_t **)&off_180132480;
      ...
      v16 = 3LL * v7;
      if ( ((int (__fastcall *)(HANDLE, _BYTE *, __int64, int *, _QWORD, _DWORD, int))*(&off_180132480 + v16 + 1))(
             Handle,
             v25,
             64LL,
             &v17,
