/*
 * XREFs of Normalization__NormalizeCharacter @ 0x180089814
 * Callers:
 *     Normalization__Normalize @ 0x1800896E8 (Normalization__Normalize.c)
 *     Normalization__AppendDecomposedChar @ 0x18010CAD0 (Normalization__AppendDecomposedChar.c)
 * Callees:
 *     NormBuffer__AppendEx @ 0x1800898FC (NormBuffer__AppendEx.c)
 *     NormBuffer__Append @ 0x180089960 (NormBuffer__Append.c)
 *     ComposeHangulLV @ 0x18010C2E8 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x18010C318 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x18010C34C (IsHangulLV.c)
 *     NormBuffer__GetLastChar @ 0x18010C474 (NormBuffer__GetLastChar.c)
 *     NormBuffer__Insert @ 0x18010C50C (NormBuffer__Insert.c)
 *     NormBuffer__IsBlocked @ 0x18010C5E4 (NormBuffer__IsBlocked.c)
 *     NormBuffer__LastStartBase @ 0x18010C68C (NormBuffer__LastStartBase.c)
 *     NormBuffer__LastStartBasePair @ 0x18010C6B8 (NormBuffer__LastStartBasePair.c)
 *     NormBuffer__RecheckStartCombinations @ 0x18010C708 (NormBuffer__RecheckStartCombinations.c)
 *     NormBuffer__ReplaceLastStartBase @ 0x18010C880 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x18010C8F8 (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x18010C9BC (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x18010CAD0 (Normalization__AppendDecomposedChar.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x18010CBE4 (Normalization__CanCombinableCharactersCombine.c)
 */
