...
unsigned __int64 __fastcall RtlpHpSegSizeInternal(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4, int *a5)
{
  ...
  else if ( (*(_BYTE *)(a2 + 24) & 0xC) == 8 )
  {
    ...
    v7 = (unsigned __int16)(qword_180184E48 ^ *(_WORD *)(v5 + 40) ^ ((unsigned int)v5 >> 12));
    v8 = *(_QWORD *)(*(_QWORD *)(a1 + 24)
                   + 8LL * RtlpLfhBucketIndexMap[(unsigned __int64)(unsigned int)(v7 + 15) >> 4]
                   + 128);
    v9 = a3 - (((unsigned int)qword_180184E48 ^ *(_DWORD *)(v5 + 40) ^ ((unsigned int)v5 >> 12)) >> 16) - v5;
    v10 = *(_DWORD *)(v8 + 72);
    v11 = *(_BYTE *)(v8 + 76);
    if ( v10 )
    {
    ...
    {
      v15 = (unsigned __int16)qword_180184E48 ^ (unsigned __int16)(*(_WORD *)(v5 + 40) ^ v6);
      if ( (v14 & 2) != 0 )
      {
        v16 = (unsigned __int16)qword_180184E48 ^ (unsigned __int64)(unsigned __int16)(*(_WORD *)(v5 + 40) ^ v6);
