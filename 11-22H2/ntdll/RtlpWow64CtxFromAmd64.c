/*
 * XREFs of RtlpWow64CtxFromAmd64 @ 0x180110590
 * Callers:
 *     RtlpWow64GetContextOnAmd64 @ 0x180079B00 (RtlpWow64GetContextOnAmd64.c)
 * Callees:
 *     RtlFxToFnFrame @ 0x1801096B0 (RtlFxToFnFrame.c)
 */
