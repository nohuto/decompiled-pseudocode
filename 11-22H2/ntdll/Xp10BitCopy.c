/*
 * XREFs of Xp10BitCopy @ 0x18011AA24
 * Callers:
 *     Xp10ScatteredCopyBits @ 0x18011EACC (Xp10ScatteredCopyBits.c)
 * Callees:
...
void __fastcall Xp10BitCopy(char *a1, int a2, unsigned __int8 *a3, unsigned int a4, unsigned __int64 a5)
{
  ...
  if ( v23 )
  {
    ...
    *v9 = (((unsigned __int8)v24 & (unsigned __int8)byte_180145B30[4 * v23]) << v7) | *v9 & ~(byte_180145B30[4 * v23] << v7);
  }
}
