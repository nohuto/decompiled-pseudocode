/*
 * XREFs of LdrpLogVsmEnclaveLdrInitializeEnclaveTelemetry @ 0x1800DC848
 * Callers:
...
char __fastcall LdrpLogVsmEnclaveLdrInitializeEnclaveTelemetry(int a1)
{
  ...
  if ( v1->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_18017E958 > 4 )
    {
      LOBYTE(v1) = tlgKeywordOn((__int64)&dword_18017E958, 0x400000000000LL);
      if ( (_BYTE)v1 )
      {
        v11 = 0;
        v14 = 0;
        ...
        v7 = a1;
        v13 = v5;
        LOBYTE(v1) = tlgWriteTransfer_EtwEventWriteTransfer(v3, (unsigned __int8 *)dword_18014AD7A, v4, v5, v5, &v8);
      }
    }
  }
  return (char)v1;
