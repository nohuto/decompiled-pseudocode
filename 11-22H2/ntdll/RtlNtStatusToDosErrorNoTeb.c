/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x180077290
 * Callers:
...
ULONG __cdecl RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_180145044[8 * v5] )
        {
          v8 = (unsigned __int16)word_180145046[4 * v5];
          if ( byte_180145045[8 * v5] == 1 )
