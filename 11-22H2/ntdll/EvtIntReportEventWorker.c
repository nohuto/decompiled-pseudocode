/*
 * XREFs of EvtIntReportEventWorker @ 0x180053330
 * Callers:
 *     EvtIntReportEventAndSourceAsync @ 0x1800532C0 (EvtIntReportEventAndSourceAsync.c)
 *     EvtIntReportAuthzEventAndSourceAsync @ 0x180124F30 (EvtIntReportAuthzEventAndSourceAsync.c)
 * Callees:
 ...
 *     _local_unwind @ 0x18008F9F0 (_local_unwind.c)
 */
        ...
        __int64 a11)
{
  ...
  *((_QWORD *)&v43 + 1) = v17;
  if ( v13 )
  {
    ...
    {
      v34 = 87;
      local_unwind(v42, &loc_180053679);
      goto LABEL_29;
    }
  ...
  *(_QWORD *)&Heap[8 * v25 + 8] = 4LL;
  ...
  if ( !v38 )
  {
    v29 = EtwpEventWriteFull(v41, &v43, 0LL, 0, 4u, 0LL, 0LL, v23, (__int64)Heap);
    goto LABEL_30;
  }
LABEL_29:
