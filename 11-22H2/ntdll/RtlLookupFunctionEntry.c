/*
 * XREFs of RtlLookupFunctionEntry @ 0x180020960
 * Callers:
 ...
 *     RtlpSameFunction @ 0x18007DA6C (RtlpSameFunction.c)
        ...
        PUNWIND_HISTORY_TABLE HistoryTable)
{
  ...
  if ( HistoryTable )
  {
    ...
    {
      HistoryTable->Once = 0;
      result = *(PRUNTIME_FUNCTION *)&RtlpUnwindHistoryTable[4 * (unsigned __int8)byte_180199435 + 8];
      if ( result )
      {
        v29 = *(_QWORD *)&RtlpUnwindHistoryTable[4 * (unsigned __int8)byte_180199435 + 6];
    ...
    {
      if ( ControlPc >= qword_180199438 && ControlPc < qword_180199440 )
      {
...
LABEL_2:
  if ( ControlPc < *((_QWORD *)&xmmword_180199520 + 1)
    || ControlPc >= *((_QWORD *)&xmmword_180199520 + 1) + (unsigned __int64)(unsigned int)qword_180199530 )
  {
    v6 = RtlpxLookupFunctionTable((PVOID)ControlPc);
  }
  else
  {
    v30 = *((_QWORD *)&xmmword_180199520 + 1);
    v6 = xmmword_180199520;
    v31 = HIDWORD(qword_180199530);
  }
  if ( v6 )
  {
    *ImageBase = v30;
