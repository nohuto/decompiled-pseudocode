/*
 * XREFs of RtlMakeSelfRelativeSD @ 0x18006CE40
 * Callers:
 *     RtlpSysVolCheckOwnerAndSecurity @ 0x18006C714 (RtlpSysVolCheckOwnerAndSecurity.c)
 *     RtlAbsoluteToSelfRelativeSD @ 0x18006CE20 (RtlAbsoluteToSelfRelativeSD.c)
 * Callees:
        ...
        PULONG BufferLength)
{
  ...
  {
    memset_thunk_772440563353939046(SelfRelativeSecurityDescriptor, 0, v10);
