/*
 * XREFs of WerEscalationLazyInit @ 0x1800E84C8
 * Callers:
 ...
 *     StringCchCopyW @ 0x1800E83E0 (StringCchCopyW.c)
...
__int64 WerEscalationLazyInit()
{
  ...
  if ( VirtualMemory >= 0 )
  {
    ...
    *(_DWORD *)(v2 + 520) = HashStringToDwordCaseInsensitiveLen(i, v6 - (unsigned int)((__int64)((__int64)i - v8) >> 1));
