/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x18011F12C
 * Callers:
 *     RtlCompressBufferXpressHuff @ 0x180055F70 (RtlCompressBufferXpressHuff.c)
 * Callees:
 *     XpressDoHuffmanPass @ 0x180056800 (XpressDoHuffmanPass.c)
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      do
      {
        v23 = (unsigned __int16)XpressHashFunction[*v21] ^ (unsigned __int16)word_1801599B0[v21[2]] ^ (unsigned __int64)(unsigned __int16)word_1801597B0[v21[1]];
        v24 = *(_QWORD *)&a6[8 * v23];
        *(_QWORD *)&a6[8 * v23] = v21++;
