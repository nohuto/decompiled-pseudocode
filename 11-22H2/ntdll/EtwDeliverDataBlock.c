...
LABEL_56:
    v2 = 4201;
    if ( ReplyRequested
      && (unsigned int)dword_18017E3C8 > 3
      && (unsigned __int8)tlgKeywordOn(&dword_18017E3C8, 9LL, v8, v9) )
    {
      v38 = 0;
      v41 = 0;
      v44 = 0;
      ...
      v43 = 4;
      v37 = 16;
      tlgWriteTransfer_EtwEventWriteTransfer(v25, (int)&dword_18014B34E, v26, v27, 5u, &v35);
    }
    goto LABEL_9;
  }
  v15 = 0;
