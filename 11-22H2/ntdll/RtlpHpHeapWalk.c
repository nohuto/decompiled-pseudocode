/*
 * XREFs of RtlpHpHeapWalk @ 0x180063BEC
 * Callers:
 *     RtlpWalkHeapInternal @ 0x180063B9C (RtlpWalkHeapInternal.c)
 * Callees:
 *     RtlpHpLargeWalkHeap @ 0x180063ADC (RtlpHpLargeWalkHeap.c)
...
LABEL_6:
  ...
  if ( (_WORD)v5 )
    goto LABEL_4;
  v9 = RtlCSparseBitmapBitmaskRead(&unk_1801859C0, 2 * ((v5 - qword_1801859B8) >> 20));
  if ( v9 )
  {
    v7 = v9 - 1;
    goto LABEL_6;
