/*
 * XREFs of Normalization__LoadTables @ 0x18008D4AC
 * Callers:
 *     RtlpGetNormalization @ 0x180089598 (RtlpGetNormalization.c)
 * Callees:
 *     Normalization__LoadClassMapExceptions @ 0x18008D624 (Normalization__LoadClassMapExceptions.c)
...
__int64 __fastcall Normalization__LoadTables(__int64 a1, unsigned __int16 *a2, unsigned __int64 a3, _DWORD *a4)
{
  ...
  v7 = v4;
  memset_thunk_772440563353939046(a4, 0, 0x78uLL);
  v9 = a3 >> 1;
  if ( a3 >> 1 < a2[26] )
    return 3221225624LL;
  v10 = a2[27];
