/*
 * XREFs of RtlpLogCapabilityCheckLatency @ 0x18007C550
 * Callers:
...
__int16 __fastcall RtlpLogCapabilityCheckLatency(_QWORD *a1, _QWORD *a2, char a3, char a4, char a5, char a6)
{
  ...
  _BYTE v23[32]; // [rsp+48h] [rbp-39h] BYREF
  ...
  if ( v6->ProcessHeap )
  {
    LOWORD(v6) = RtlRunOnceExecuteOnce(
        ...
        if ( *a1 )
        {
          if ( *a2 )
          {
            if ( RtlpPerformanceCounterFrequency )
            {
              ...
              if ( !(_WORD)v6 )
              {
                if ( (unsigned int)dword_18017E320 > 5
                  && (unsigned __int8)tlgKeywordOn(&dword_18017E320, 0x200000000000LL, v11, v12) )
                {
                  v16 = *a2 - *a1;
                  v26 = 0;
                  v29 = 0;
                  ...
                  v34 = 1;
                  v37 = 1;
                  tlgWriteTransfer_EtwEventWriteTransfer(v13, byte_18014ADB7, v14, v15, 7, (__int64)v23);
                }
