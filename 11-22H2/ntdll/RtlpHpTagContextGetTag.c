/*
 * XREFs of RtlpHpTagContextGetTag @ 0x18009E530
 * Callers:
...
__int64 __fastcall RtlpHpTagContextGetTag(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( SubProcessTag == (void *)RtlpHpNullGUID )
    v4 = *((_QWORD *)&v16 + 1) - qword_180185170;
  if ( !v4 )
    return 0LL;
  if ( word_180182DC4 )
  {
    v6 = *(_QWORD *)(qword_180182DB8 + 8LL * (unsigned __int16)word_180182DC4 - 8);
