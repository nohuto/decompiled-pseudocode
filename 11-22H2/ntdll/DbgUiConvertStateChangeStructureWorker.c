/*
 * XREFs of DbgUiConvertStateChangeStructureWorker @ 0x1800D8100
 * Callers:
 *     DbgUiConvertStateChangeStructure @ 0x1800D80E0 (DbgUiConvertStateChangeStructure.c)
 *     DbgUiConvertStateChangeStructureEx @ 0x1800D80F0 (DbgUiConvertStateChangeStructureEx.c)
 * Callees:
...
LABEL_25:
    ...
    case 8:
      ...
      else if ( *(_DWORD *)v5 == 1073807367 )
      {
        *(_DWORD *)a2 = 9;
        *(_DWORD *)(a2 + 20) = *(_DWORD *)(a1 + 64);
        *(_DWORD *)v6 = *(_DWORD *)(a1 + 56);
      }
      else
      {
        *(_DWORD *)a2 = 1;
