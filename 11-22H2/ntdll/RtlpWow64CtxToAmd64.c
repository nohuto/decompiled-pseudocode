/*
 * XREFs of RtlpWow64CtxToAmd64 @ 0x1801107A8
 * Callers:
 *     RtlpWow64SetContextOnAmd64 @ 0x180077D80 (RtlpWow64SetContextOnAmd64.c)
 * Callees:
 *     RtlFnToFxFrame @ 0x180109608 (RtlFnToFxFrame.c)
 */
