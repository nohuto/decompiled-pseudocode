/*
 * XREFs of _winput_s @ 0x18009D4E0
 * Callers:
...
__int64 __fastcall winput_s(FILE *Stream, unsigned __int16 *a2, __int64 a3)
{
  unsigned int v3; // ebx
  int v5; // edi
  __int64 v6; // r13
...
LABEL_116:
    ...
    if ( v31 == 123 )
    {
      v54 = ReadStringDelimited_1(v53, &v77, (wint_t *)&v60, &v62, (__int64)&v73, v15, Stream, v25, &v65);
      a2 = v77;
    }
    else
    {
      v54 = ReadString_1(v53, 0LL, (wint_t *)&v60, &v62, (__int64)&v73, v15, Stream, v25, &v65);
    }
    LOWORD(v5) = v60;
    if ( v54 )
      goto LABEL_194;
