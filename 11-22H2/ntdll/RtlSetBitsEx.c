/*
 * XREFs of RtlSetBitsEx @ 0x1800F8960
 * Callers:
 *     RtlFindClearBitsAndSetEx @ 0x1800F6C30 (RtlFindClearBitsAndSetEx.c)
 * Callees:
...
LABEL_10:
    ...
    if ( v6 > 8 )
    {
      memset_thunk_772440563353939046(v5, 255, v6 >> 3);
      v5 += v6 >> 3;
      v6 &= 7u;
    }
    if ( v6 )
