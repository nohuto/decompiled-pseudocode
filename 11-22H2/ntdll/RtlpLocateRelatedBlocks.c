/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x180116B38
 * Callers:
...
LABEL_48:
    ...
    if ( v16 )
    {
      qword_1801818A8 = *(unsigned __int16 *)(a1 + 140) ^ (unsigned __int64)*(unsigned __int16 *)(v16 + 12);
      v25 = *(_DWORD *)(a1 + 124);
    }
    if ( v17 )
    {
    ...
    if ( qword_1801818A8 == (unsigned __int16)result )
    {
      result = *(unsigned __int16 *)(a1 + 140);
      if ( qword_1801818B0 != (result ^ *(unsigned __int16 *)(v17 + 8 * v28 + 12)) )
        dword_180181868 = 7;
    }
    else
    {
