/*
 * XREFs of RtlIoEncodeMemIoResource @ 0x1800FD150
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_14:
    ...
    {
      v9 = a4 >> 8;
      for ( i = (unsigned int)(a4 >> 8); a4 != i << 8; i = (unsigned int)v9 )
      {
        v11 = a4;
        a4 *= 2LL;
        if ( a4 < v11 )
...
LABEL_21:
  ...
  else
  {
    ...
    {
      v9 = a4 >> 16;
      for ( j = (unsigned int)(a4 >> 16); a4 != j << 16; j = (unsigned int)v9 )
      {
        v14 = a4;
        a4 *= 2LL;
        if ( a4 < v14 )
