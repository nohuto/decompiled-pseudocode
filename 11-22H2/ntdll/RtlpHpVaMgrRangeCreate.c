/*
 * XREFs of RtlpHpVaMgrRangeCreate @ 0x18004B09C
 * Callers:
...
_BYTE *__fastcall RtlpHpVaMgrRangeCreate(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  if ( (int)RtlpCSparseBitmapPageCommit(v8 + 32, (8 * v10) >> 15, (__int64)v19, &v20) >= 0
    && (memmove(v11, a3, (unsigned int)(1 << v9)), RtlpCSparseBitmapUnlock((__int64)v19), v11) )
  {
    if ( (*v11 & 4) == 0 )
    {
      v12 = a2 + 0x100000;
      ...
      *((_QWORD *)a3 + 3) = 2309737967LL;
      while ( v3 < v7 )
      {
        ...
        if ( (int)RtlpCSparseBitmapPageCommit(v13 + 32, (8 * v15) >> 15, (__int64)v19, &v20) < 0 )
          goto LABEL_11;
        memmove(v16, a3, (unsigned int)(1 << v14));
        RtlpCSparseBitmapUnlock((__int64)v19);
        if ( !v16 )
          goto LABEL_11;
        ++v3;
        v12 += 0x100000LL;
