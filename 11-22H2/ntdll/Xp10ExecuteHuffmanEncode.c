/*
 * XREFs of Xp10ExecuteHuffmanEncode @ 0x18011CD9C
 * Callers:
      ...
      *a7 = 1;
      ...
      while ( 1 )
      {
        ...
        if ( v31 + v37 <= v27 || (v37 = v27 - v31, v27 != v31) )
        {
          ...
          if ( v35 >= v37 )
            v38 = v37;
          *v33 |= ((unsigned __int8)v36 & (unsigned __int8)byte_180145B30[4 * v38]) << v34;
          ...
          if ( (_DWORD)v39 )
            *v41 |= (unsigned __int8)v40 & byte_180145B30[4 * v39];
          v31 += v37;
          *(_DWORD *)(v10 + 8) = v31;
        }
        ++v12;
        ...
        if ( (unsigned __int16)v32 >= 0x100u && (v32 & 0xF) == 0xF )
        {
          ...
          if ( v31 + v46 <= v27 || (v46 = v27 - v31, v27 != v31) )
          {
            ...
            if ( v49 >= v46 )
              v50 = v46;
            *v45 |= ((unsigned __int8)v47 & (unsigned __int8)byte_180145B30[4 * v50]) << v48;
            ...
            if ( (_DWORD)v51 )
              *v53 |= (unsigned __int8)v52 & byte_180145B30[4 * v51];
            v43 = v31 + v46;
          ...
          if ( (unsigned __int8)v44 > 0xE8u )
          {
            ...
            if ( v43 + (_DWORD)v44 - 232 <= v27 || (v56 = v27 - v43, v27 != v43) )
            {
              ...
              if ( v59 >= v56 )
                v60 = v56;
              *v57 |= ((unsigned __int8)v55 & (unsigned __int8)byte_180145B30[4 * v60]) << v58;
              ...
              if ( (_DWORD)v61 )
                *v63 |= (unsigned __int8)v62 & byte_180145B30[4 * v61];
              v43 += v56;
              *(_DWORD *)(v10 + 8) = v43;
            }
            v12 += 2;
        ...
        if ( (unsigned __int16)v32 > 0x14Fu )
        {
          ...
          if ( v43 + v69 <= v27 || (v69 = v27 - v43, v27 != v43) )
          {
            ...
            if ( v68 >= v69 )
              v70 = v69;
            *v66 |= ((unsigned __int8)v65 & (unsigned __int8)byte_180145B30[4 * v70]) << v67;
            ...
            if ( (_DWORD)v71 )
              *v73 |= (unsigned __int8)v72 & byte_180145B30[4 * v71];
