        ...
        __int64 a6)
{
  ...
  ULONG v85; // [rsp+60h] [rbp-A0h] BYREF
  ULONG v86; // [rsp+64h] [rbp-9Ch] BYREF
  ...
  *a5 = 0LL;
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(a2 + 32) + 8LL) & 0x4000) != 0 )
    goto LABEL_107;
  v12 = RtlpOpenImageFileOptionsKeyEx(v87, 9u, 0, &KeyHandle);
  v9 = KeyHandle;
  if ( v12 < 0 )
    goto LABEL_107;
  *a4 = KeyHandle;
...
LABEL_44:
  if ( (*(_BYTE *)(a2 + 3) & 1) != 0 )
  {
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&unk_180132670;
...
LABEL_67:
  ...
  do
  {
    v36 = (&off_180132600)[v35];
    Value = 0;
    RtlQueryImageFileKeyOption(v9, v36, 4, &Value, 4u, 0LL);
    v37 = (bool *)*(&off_180132600 + v35 + 1);
    v35 += 2LL;
    *v37 = Value != 0;
  }
  while ( v35 != 6 );
  ...
  else if ( !v89 && !v9 )
  {
    if ( *(_BYTE *)(a2 + 2) )
    {
      ...
      *(_DWORD *)&v93.Length = 0x200000;
      if ( RtlQueryEnvironmentVariable_U(*(PVOID *)(v62 + 128), (PUNICODE_STRING)&stru_1801325E0, &v93) < 0
