/*
 * XREFs of EtwpDisableTraceProviders @ 0x1800613AC
 * Callers:
...
__int64 __fastcall EtwpDisableTraceProviders(__int16 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( v7 + 24 * (v4 + 5LL) )
    {
      ...
      {
        RtlAcquireSRWLockExclusive((volatile signed __int64 *)(v7 + 64));
        v8 = 1;
...
LABEL_17:
      ...
      {
        *(_DWORD *)(v7 + 80) = 0;
        RtlReleaseSRWLockExclusive((volatile signed __int64 *)(v7 + 64));
      }
    }
LABEL_5:
    v2 = v7;
