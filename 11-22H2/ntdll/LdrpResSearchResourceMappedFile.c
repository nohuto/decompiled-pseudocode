  ...
  if ( (v10 & 0x10) == 0 )
  {
    ...
    if ( a5 >= 1 && a5 <= 3 )
    {
      if ( a5 == 3 )
        ...
        v37 = 0;
      if ( (v10 & 0x1000000) == 0
        && (((*v59 - 16LL) & 0xFFFFFFFFFFFFFFF7uLL) != 0 && !v50
         || (~(_BYTE)v10 & 8) == 0
         || (v37 & 0xF3FF) != 0
         || v37 == 3072) )
      {
    ...
    if ( v60 && (~v15 & 0x40000) != 0 )
    {
      ...
      if ( v61 && v20 )
      {
        if ( v67 )
          ...
          LODWORD(v45) = v68;
        MappingSize = LdrpFindMessageInAlternateModule((_DWORD)ResourceDllBase, *v61, v45, *((_DWORD *)v31 + 6), 1);
        v49 = MappingSize;
        if ( MappingSize < 0 )
        {
          *v61 = 0LL;
