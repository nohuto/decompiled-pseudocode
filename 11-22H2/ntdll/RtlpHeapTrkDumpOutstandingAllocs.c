/*
 * XREFs of RtlpHeapTrkDumpOutstandingAllocs @ 0x18010AE34
 * Callers:
...
char RtlpHeapTrkDumpOutstandingAllocs()
{
  ...
  {
    v2 = v0 & 0xF;
    if ( _interlockedbittestandset64(*(volatile signed __int32 **)(qword_180185950 + 8 * v2), 0LL) )
      break;
    v3 = 16LL * v0;
    v4 = *(_QWORD **)(i + qword_1801855D0);
    if ( v4 != (_QWORD *)(v3 + qword_1801855D0) )
    {
      while ( 1 )
      {
        v5 = v4[3];
...
LABEL_12:
      ...
      RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_180185950 + 8 * v2));
      return 0;
    }
LABEL_13:
    RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_180185950 + 8 * v2));
