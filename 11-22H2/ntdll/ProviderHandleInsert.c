...
__int64 __fastcall ProviderHandleInsert(__int64 a1, __int64 a2, unsigned int *a3)
{
  ...
  RtlAcquireSRWLockExclusive(&unk_180184ED8);
  v5 = dword_180184ED0;
  v6 = 0;
  if ( !dword_180184ED0
    || (unsigned int)dword_180184ED0 >> 4 >= dword_180145CF0[((unsigned __int64)(unsigned int)dword_180184ED0 >> 1) & 7] )
  {
    if ( (unsigned __int8)byte_180184ED4 >= 8u
      || (v11 = dword_180145CF0[(unsigned __int8)byte_180184ED4],
          (Heap = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, 8LL, 8LL * v11)) == 0) )
    {
      v7 = 14;
      goto LABEL_4;
    }
    ...
    if ( v11 )
    {
      do
      {
        ...
        v16 = v14++;
        *(_QWORD *)(Heap + 8 * v16) = v15;
      }
      while ( v14 != v11 );
      v13 = byte_180184ED4;
    }
    _InterlockedExchange64(&qword_180184E90[v13], Heap);
    ++byte_180184ED4;
  }
  v7 = 0;
  v6 = v5;
...
LABEL_4:
  *a3 = v6;
  RtlReleaseSRWLockExclusive(&unk_180184ED8);
  return v7;
}
