/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x180053AB8
 * Callers:
 *     DbgPrintEx @ 0x180053A30 (DbgPrintEx.c)
 *     DbgPrint @ 0x180053A70 (DbgPrint.c)
 *     LdrpLogDbgPrint @ 0x1800D9720 (LdrpLogDbgPrint.c)
 *     DbgPrintReturnControlC @ 0x1800EB0C0 (DbgPrintReturnControlC.c)
 *     vDbgPrintEx @ 0x1800EB180 (vDbgPrintEx.c)
 *     vDbgPrintExWithPrefix @ 0x1800EB1B0 (vDbgPrintExWithPrefix.c)
 * Callees:
 *     RtlRaiseException @ 0x1800549A0 (RtlRaiseException.c)
 *     __security_check_cookie @ 0x18008E790 (__security_check_cookie.c)
 *     _vsnprintf @ 0x1800904D0 (_vsnprintf.c)
 *     ZwQueryDebugFilterState @ 0x1800A1720 (ZwQueryDebugFilterState.c)
 *     DbgBreakPointWithStatus @ 0x1800A2B10 (DbgBreakPointWithStatus.c)
 *     DebugPrint @ 0x1800A2B20 (DebugPrint.c)
...
__int64 __fastcall vDbgPrintExWithPrefixInternal(_BYTE *a1, ULONG a2, ULONG a3, char *a4, va_list a5, char a6)
{
  _BYTE *v7; // rdx
  struct _TEB *v8; // rsi
  $DF4FA9F692459BA109B62B4026D83C94 *v10; // rsi
  _BYTE *v11; // r15
  int v12; // ebx
  ...
  struct _TEB *v33; // [rsp+B8h] [rbp+38h]
  $DF4FA9F692459BA109B62B4026D83C94 *v34; // [rsp+C0h] [rbp+40h]
  __int16 v35; // [rsp+C8h] [rbp+48h] BYREF
  _BYTE *v36; // [rsp+D0h] [rbp+50h]
  EXCEPTION_RECORD ExceptionRecord; // [rsp+E0h] [rbp+60h] BYREF
