/*
 * XREFs of MD4Transform @ 0x18012321C
 * Callers:
...
__int64 __fastcall MD4Transform(_DWORD *a1, _DWORD *a2)
{
  ...
  LODWORD(v3) = __ROL4__(v54 + (v46 ^ v45 ^ v44) + v43 + 1859775393, 3);
  v47 = __ROL4__(v60 + ((unsigned int)v3 ^ v46 ^ v45) + v44 + 1859775393, 9);
  v48 = __ROL4__(v55 + ((unsigned int)v3 ^ v46 ^ v47) + v45 + 1859775393, 11);
  v49 = __ROL4__(v17 + ((unsigned int)v3 ^ v48 ^ v47) + 1859775393 + v46, 15);
  v50 = __ROL4__(v56 + (v49 ^ v48 ^ v47) + (_DWORD)v3 + 1859775393, 3);
  v51 = __ROL4__(v47 + v57 + (v50 ^ v49 ^ v48) + 1859775393, 9);
  v52 = __ROL4__(v58 + (v50 ^ v49 ^ v51) + v48 + 1859775393, 11);
  *a1 += v50;
  a1[2] += v52;
  result = (unsigned int)__ROL4__(v49 + v19 + 1859775393 + (v50 ^ v52 ^ v51), 15);
  a1[1] += result;
  a1[3] += v51;
  return result;
}
