/*
 * XREFs of RtlpFcQueryAllFeatureConfigurationsFromBufferSet @ 0x18012E058
 * Callers:
 *     RtlQueryAllFeatureConfigurations @ 0x180070DA0 (RtlQueryAllFeatureConfigurations.c)
 * Callees:
 *     RtlpFcValidateFeatureConfigurationType @ 0x180070EFC (RtlpFcValidateFeatureConfigurationType.c)
