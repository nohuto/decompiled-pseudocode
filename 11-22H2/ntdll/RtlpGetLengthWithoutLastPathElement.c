/*
 * XREFs of RtlpGetLengthWithoutLastPathElement @ 0x180077744
 * Callers:
 *     RtlGetLengthWithoutLastFullDosOrNtPathElement @ 0x180077730 (RtlGetLengthWithoutLastFullDosOrNtPathElement.c)
 * Callees:
