/*
 * XREFs of RtlpDidUnicodeToOemWork @ 0x180089E40
 * Callers:
  ...
  if ( !RtlpIsUtf8Process() )
  {
    ...
    if ( word_18018175C )
    {
      ...
      while ( 1 )
      {
        ...
        if ( *(_WORD *)(qword_1801817A8 + 2 * v12) && (v13 = v9 + 1, (unsigned int)v13 < v6) )
        {
          ++v9;
          v14 = ((char)v12 << 8) + *(unsigned __int8 *)(v13 + v11) == word_180181754;
        }
        else
        {
          v14 = (char)v12 == (unsigned __int8)word_180181754;
        }
        if ( v14 && *(_WORD *)(*(_QWORD *)(a2 + 8) + 2LL * v10) != word_180181758 )
          break;
        ++v9;
        ++v10;
        if ( v9 >= v6 )
    ...
    else
    {
      ...
      if ( !v6 )
        return v5;
      while ( *(char *)(v7 + *(_QWORD *)(v4 + 8)) != (unsigned __int8)word_180181754
           || *(_WORD *)(*(_QWORD *)(a2 + 8) + 2LL * v7) == word_180181758 )
      {
        if ( ++v7 >= v6 )
          return v5;
      }
