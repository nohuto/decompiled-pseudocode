/*
 * XREFs of write_char_1 @ 0x18009B768
 * Callers:
 *     _output_s @ 0x18009ACD4 (_output_s.c)
 *     write_multi_char_1 @ 0x18009B7B8 (write_multi_char_1.c)
 *     write_string_1 @ 0x18009B810 (write_string_1.c)
 * Callees:
 *     _flsbuf_s @ 0x18009DEA8 (_flsbuf_s.c)
 */
