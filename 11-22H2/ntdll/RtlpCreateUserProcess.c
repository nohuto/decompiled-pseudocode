/*
 * XREFs of RtlpCreateUserProcess @ 0x1800874A0
 * Callers:
 *     RtlCreateUserProcessEx @ 0x1800873C0 (RtlCreateUserProcessEx.c)
 *     RtlCloneUserProcess @ 0x1800E1600 (RtlCloneUserProcess.c)
 * Callees:
 *     __security_check_cookie @ 0x18008E790 (__security_check_cookie.c)
 *     NtCreateUserProcess @ 0x1800A07C0 (NtCreateUserProcess.c)
...
__int64 __fastcall RtlpCreateUserProcess(unsigned __int16 *a1, __int64 a2, int a3, int a4, __int64 a5, _DWORD *a6)
{
  ...
  _DWORD *v45; // [rsp+158h] [rbp+58h]
  _QWORD v46[42]; // [rsp+160h] [rbp+60h]
  ...
  *a6 = 104;
  ...
  v32 = 0LL;
  v26 = 0LL;
  memset_thunk_772440563353939046(v40, 0, 0x50uLL);
  v41 |= 4u;
  v45 = a6 + 6;
  v39 = 88LL;
  v46[3] = a6 + 10;
  ...
  if ( a5 )
  {
    ...
    {
      v19 = 4LL * v10++;
      *(__int64 *)((char *)&v43 + v19 * 8) = 393216LL;
      *(__int64 *)((char *)&v44 + v19 * 8) = 8LL;
      v46[v19] = 0LL;
      v46[v19 - 1] = v11;
    }
    v12 = *(_QWORD *)(a5 + 32);
    ...
    {
      v20 = 4LL * v10++;
      *(__int64 *)((char *)&v43 + v20 * 8) = 393217LL;
      *(__int64 *)((char *)&v44 + v20 * 8) = 8LL;
      v46[v20] = 0LL;
      v46[v20 - 1] = v12;
    }
    v13 = *(_QWORD *)(a5 + 40);
    ...
    {
      v21 = 4LL * v10++;
      *(__int64 *)((char *)&v43 + v21 * 8) = 393218LL;
      *(__int64 *)((char *)&v44 + v21 * 8) = 8LL;
      v46[v21] = 0LL;
      v46[v21 - 1] = v13;
    }
    if ( *(_QWORD *)(a5 + 48) )
    {
      v22 = 4LL * v10++;
      *(__int64 *)((char *)&v43 + v22 * 8) = 131091LL;
      *(__int64 *)((char *)&v44 + v22 * 8) = 8LL;
      v46[v22] = 0LL;
      v46[v22 - 1] = a5 + 48;
    }
    v14 = *(_WORD *)(a5 + 2);
    if ( v14 )
    {
      v24 = v14 - 1;
      v18 = 4LL * v10++;
      *(__int64 *)((char *)&v43 + v18 * 8) = 131085LL;
      *(__int64 *)((char *)&v44 + v18 * 8) = 2LL;
      v46[v18] = 0LL;
      v46[v18 - 1] = &v24;
    }
    else
  ...
  {
    v15 = 4LL * v10++;
    *(__int64 *)((char *)&v43 + v15 * 8) = 393233LL;
    *(__int64 *)((char *)&v44 + v15 * 8) = 1LL;
    v46[v15] = 0LL;
    v46[v15 - 1] = 97LL;
  }
  if ( a2 )
  {
    ...
    if ( v16 < 0 )
    {
      *(_DWORD *)(a2 + 8) = v16 & 0x7FFFFFFF;
      v23 = 4LL * v10++;
      *(__int64 *)((char *)&v43 + v23 * 8) = 131090LL;
      *(__int64 *)((char *)&v44 + v23 * 8) = 8LL;
      v46[v23] = 0LL;
      v46[v23 - 1] = &v26;
    }
  }
  v42 = 32LL * v10 + 8;
  return NtCreateUserProcess(a6 + 2, a6 + 4, 0x2000000LL, 0x2000000LL, &v33, &v27, a3, a4, a2, &v39, &v42);
}
