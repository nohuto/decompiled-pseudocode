/*
 * XREFs of RtlpCopyBitMapTailToHead @ 0x1800F8A14
 * Callers:
...
unsigned __int64 __fastcall RtlpCopyBitMapTailToHead(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( (a3 & 7) != 0 )
  {
    ...
    v13 = a3 & 0x1F;
    v14 = a4 & 0x1F;
    v15 = (unsigned int *)(*v5 + 4 * (v12 + (v8 >> 5)));
  ...
  else
  {
    ...
    {
      result = (unsigned __int64)*v7;
      *(_BYTE *)(*v5 + v10 + v6) = ((1 << v11) - 1) & *((_BYTE *)*v7 + v10) | *(_BYTE *)(*v5 + v10 + v6) & ~((1 << v11) - 1);
    }
    if ( v10 )
      return (unsigned __int64)memmove((void *)(v6 + *v5), *v7, v10);
  }
  return result;
}
