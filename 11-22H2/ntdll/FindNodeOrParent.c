/*
 * XREFs of FindNodeOrParent @ 0x180062DC8
 * Callers:
 ...
 *     RtlLookupElementGenericTable @ 0x180062D80 (RtlLookupElementGenericTable.c)
 *     RtlLookupElementGenericTableFull @ 0x180102D40 (RtlLookupElementGenericTableFull.c)
 * Callees:
