/*
 * XREFs of RtlpReAllocateHeapInternal @ 0x1800423B0
 * Callers:
        ...
        _WORD *a6)
{
  ...
  __int64 DeferredCriticalSectionEvent; // r13
  ...
  if ( a3 )
  {
    if ( *(_DWORD *)(a1 + 16) == -571548178 )
    {
      ...
      if ( v7 + v27 < v7
        || (Heap = RtlpHpReAllocateHeap(a1, v26, v25, v7 + v27, a5, v22),
            v11 = (_QWORD *)Heap,
      ...
      if ( RtlpHpStackLoggingEnabled(a1) && v11 )
      {
    ...
    else
    {
      ...
      if ( (*(_DWORD *)(a1 + 116) & 0x1000000) == 0 )
      {
        if ( !dword_18017E828 )
        {
          v13 = *(_QWORD *)(a1 + 392);
          v14 = v13;
          if ( (v13 || (v14 = qword_180184E68) != 0) && a4 > v14 )
          {
            v34 = *(_QWORD *)(a1 + 400);
            if ( v34 )
              RtlpLogHeapFailure(20, a1, 0, v34, v7, v13);
            goto LABEL_153;
          }
        }
        if ( (*(_BYTE *)(a1 + 120) & 1) != 0 )
        ...
        else
        {
          if ( (a3 & 0xF) != 0 )
          {
            v15 = 9;
LABEL_14:
            RtlpLogHeapFailure(v15, a1, a3, 0, 0LL, 0LL);
            v16 = 0LL;
            goto LABEL_15;
          }
          v16 = a3 - 16;
...
LABEL_15:
        ...
        if ( *(char *)(v16 + 15) >= 0 )
        {
          if ( *(_DWORD *)(a1 + 124) )
          {
            v36 = *(_DWORD *)(a1 + 136) ^ *(_DWORD *)(v16 + 8);
            if ( HIBYTE(v36) != ((unsigned __int8)v36 ^ (unsigned __int8)(((unsigned __int16)(*(_WORD *)(a1 + 136) ^ *(_WORD *)(v16 + 8)) >> 8) ^ BYTE2(v36))) )
              goto LABEL_59;
          }
        }
...
LABEL_154:
            ...
            if ( v43 == 5 )
              ...
              v47 = 0LL;
            if ( (int)RtlpCallInterceptRoutine((_DWORD)v11, a1, v8, 5, v47) < 0 )
            {
              v35 = -1073741819;
              goto LABEL_154;
            }
            ...
            if ( v49 == 4 )
            {
              if ( ((*(_BYTE *)(a1 + 116) | (unsigned __int8)v12) & 1) == 0 )
              ...
              if ( *(_DWORD *)(a1 + 124) )
              {
                ...
                *(_DWORD *)(v16 + 8) = v50;
                if ( HIBYTE(v50) != ((unsigned __int8)v50 ^ (unsigned __int8)(BYTE1(v50) ^ BYTE2(v50))) )
                  RtlpAnalyzeHeapFailure(a1, v16, v48);
              }
              v10 = v67;
              v51 = *(_WORD *)(v16 + 8) - v67;
              *(_WORD *)(v16 + 8) = v51;
                ...
                if ( v31 )
                {
                  *(_QWORD *)(v52 + 16) = 0LL;
                  ...
                  if ( v53 != -2 )
                  {
                    ...
                    DeferredCriticalSectionEvent = *(_QWORD *)(v52 + 24);
                    if ( !DeferredCriticalSectionEvent )
                    {
                      DeferredCriticalSectionEvent = RtlpCreateDeferredCriticalSectionEvent(v52);
                      v53 = v68;
                    }
                    v73 = 0;
            ...
            else
            {
              if ( v49 == 5 )
              {
                v55 = *(unsigned __int16 *)(v16 + 12) ^ (unsigned __int64)*(unsigned __int16 *)(a1 + 140);
              }
              else if ( (v49 & 0x40) != 0 )
              {
...
LABEL_17:
          v18 = RtlpReAllocateHeap((void *)a1);
          if ( (dword_180185108 & 1) != 0
            && (dword_180185108 & 2) != 0
            && NtCurrentPeb()->ProcessHeap
            && (v74 = RtlpHpEnvHandle, a1 != *(_QWORD *)RtlpHpMetadataHeapCtxGet(&v74, v17)) )
          {
            if ( v18 )
            {
              if ( (v12 & 0x10000000) == 0 )
...
LABEL_19:
            ...
            {
              LOWORD(v66) = v10;
              v6 = RtlpSetupExtendedBlock(a1, v12, v18, v19, v66, (_DWORD)v11);
              RtlpCallInterceptRoutine((_DWORD)v11, a1, v6, 6, v18);
            }
            return v6;
          }
          v7 -= v10;
          if ( (_DWORD)v11 )
          {
            RtlSizeHeap(a1, 0, v8);
            LOWORD(v66) = v10;
            v64 = RtlpSetupExtendedBlock(a1, v12, v8, v63, v66, (_DWORD)v11);
            RtlpCallInterceptRoutine((_DWORD)v11, a1, v64, 6, v8);
          }
          goto LABEL_153;
        }
LABEL_59:
