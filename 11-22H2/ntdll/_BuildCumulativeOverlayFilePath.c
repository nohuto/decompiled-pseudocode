/*
 * XREFs of _BuildCumulativeOverlayFilePath @ 0x18012DAAC
 * Callers:
 *     GetOverlayFilePathUsingChecksum @ 0x18000B228 (GetOverlayFilePathUsingChecksum.c)
 * Callees:
 *     __security_check_cookie @ 0x18008E790 (__security_check_cookie.c)
 *     _ByteArrayToHexString @ 0x1800B0076 (_ByteArrayToHexString.c)
 *     _AppendCumulativeOverlayFilePath @ 0x18012D96C (_AppendCumulativeOverlayFilePath.c)
