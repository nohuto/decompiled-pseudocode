/*
 * XREFs of RtlQueryImageFileKeyOption @ 0x18007D900
 * Callers:
        ...
        ULONG *a6)
{
  ...
  v11 = (unsigned __int16 *)KeyValueInformation;
...
LABEL_33:
  ...
  if ( ((unsigned __int8)a4 & 3) == 0 )
  {
    ...
    if ( a4 )
    {
      DestinationString.Buffer = v11 + 6;
      DestinationString.Length = v11[4];
      DestinationString.MaximumLength = v11[4];
