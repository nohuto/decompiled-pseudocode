/*
 * XREFs of LdrpLogMapAndVerifyResourceFileFailure @ 0x1800DC39C
 * Callers:
        ...
        unsigned __int16 *a5)
{
  ...
  v9 = RtlRunOnceExecuteOnce(&stru_180185308, LdrpResReportResourceAccessInternalInitOnce, 0LL, 0LL);
  if ( v9 >= 0 && (unsigned int)dword_18017E920 > 5 )
  {
    LOBYTE(v9) = tlgKeywordOn((__int64)&dword_18017E920, 0x200000000000LL);
    if ( (_BYTE)v9 )
    {
      v18 = &v16;
      v16 = 0x1000000LL;
      ...
      LOBYTE(v9) = tlgWriteTransfer_EtwEventWriteTransfer(
                     (__int64)&dword_18017E920,
                     (unsigned __int8 *)dword_18014A9C5,
                     v10,
                     v11,
                     0xAu,
                     &v17);
