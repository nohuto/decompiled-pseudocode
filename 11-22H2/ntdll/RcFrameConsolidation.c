/*
 * XREFs of RcFrameConsolidation @ 0x1800A36F0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a32)
{
  ...
  if ( (*(&qword_1801993A0 + 1) & 0x1000000000000000LL) != 0
    || (RtlGuardCheckExceptionHandler((unsigned __int64)a31, 0, 0LL), (*(&qword_1801993A0 + 1) & 0x1000) != 0) )
  {
