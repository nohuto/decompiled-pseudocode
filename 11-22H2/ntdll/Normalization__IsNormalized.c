/*
 * XREFs of Normalization__IsNormalized @ 0x18010D0C8
 * Callers:
 *     RtlIsNormalizedString @ 0x18010D5B0 (RtlIsNormalizedString.c)
 * Callees:
 *     CanComposeHangul @ 0x18010C2A4 (CanComposeHangul.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x18010CBE4 (Normalization__CanCombinableCharactersCombine.c)
 *     Normalization__CanCombineWithStartBase @ 0x18010CD58 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x18010CDA4 (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__GetLastChar @ 0x18010CE98 (Normalization__GetLastChar.c)
 */
