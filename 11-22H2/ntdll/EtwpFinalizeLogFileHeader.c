/*
 * XREFs of EtwpFinalizeLogFileHeader @ 0x18005E754
 * Callers:
 ...
 *     EtwpFinalizeRelogFileHeaderStats @ 0x180124E0C (EtwpFinalizeRelogFileHeaderStats.c)
...
LABEL_2:
    ...
    EtwpAddProviderTrackingInfo(a1, Buffer, v10);
