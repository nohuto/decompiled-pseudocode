/*
 * XREFs of punycode_encode @ 0x180089B10
 * Callers:
 *     RtlpNameprepAsciiRealWorker @ 0x18000D858 (RtlpNameprepAsciiRealWorker.c)
 * Callees:
 *     FindLabelEnd @ 0x18000EA68 (FindLabelEnd.c)
 *     _wcsnicmp @ 0x1800907F0 (_wcsnicmp.c)
 *     RtlStringCopyWorkerW_1 @ 0x1800ADC76 (RtlStringCopyWorkerW_1.c)
 *     ValidateStd3Range @ 0x1800AEBDA (ValidateStd3Range.c)
 *     GetUTF32 @ 0x18010BC50 (GetUTF32.c)
 *     adapt @ 0x18010BCB4 (adapt.c)
 */
