/*
 * XREFs of RtlpQueryMemoryUsageHeap @ 0x1800FFB98
 * Callers:
 *     RtlpQueryExtendedInformationHeap @ 0x18008A9F0 (RtlpQueryExtendedInformationHeap.c)
 *     RtlpHeapQueryTotalReserveSize @ 0x1800FF460 (RtlpHeapQueryTotalReserveSize.c)
 * Callees:
 *     RtlpGetLowFragHeapMetadataSize @ 0x180118A64 (RtlpGetLowFragHeapMetadataSize.c)
 */
