        ...
        PVOID Parameters)
{
  ...
  *(_QWORD *)&v72 = Lock;
  ...
  HeapHandle = 0LL;
  v62 = 0LL;
  if ( !dword_18017E828 || HeapBase || Lock )
  {
    if ( dword_18017E838 && Parameters == (PVOID)1 )
      v10 = (Flags & 0x100) == 0;
  }
  else
  {
    v12 = (_DWORD *)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_18017E858)(Flags, 0LL);
    if ( v12 )
    {
LABEL_93:
...
LABEL_120:
  ...
  if ( v12 )
  {
    ...
    if ( (v12[1] & 1) != 0 )
    {
      if ( dword_18017E838 )
      {
        v12 = (_DWORD *)((__int64 (__fastcall *)(_QWORD, PVOID, SIZE_T, SIZE_T, _QWORD, _QWORD))qword_18017E858)(
                          v11,
                          HeapBase,
                          v68,
                          CommitSize,
