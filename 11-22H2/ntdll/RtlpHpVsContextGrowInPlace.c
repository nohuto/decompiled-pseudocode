/*
 * XREFs of RtlpHpVsContextGrowInPlace @ 0x1800719D4
 * Callers:
 ...
 *     RtlpHpVsCalculateChunkRequiredSize @ 0x180071C5C (RtlpHpVsCalculateChunkRequiredSize.c)
 *     RtlpHpVsChunkSetUnusedBytes @ 0x180071C7C (RtlpHpVsChunkSetUnusedBytes.c)
