/*
 * XREFs of RtlpHeapTrkDumpStacks @ 0x18010AFA0
 * Callers:
...
char RtlpHeapTrkDumpStacks()
{
  ...
  {
    v5 = v3 & 0xF;
    v6 = *(__int64 **)(v4 + qword_1801855E0);
    if ( _interlockedbittestandset64(*(volatile signed __int32 **)(qword_180185968 + 8 * v5), 0LL) )
      return 0;
    while ( v6 != (__int64 *)(16LL * v3 + qword_1801855E0) )
    {
