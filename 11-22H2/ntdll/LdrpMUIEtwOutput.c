/*
 * XREFs of LdrpMUIEtwOutput @ 0x1800EBEFC
 * Callers:
...
__int64 __fastcall LdrpMUIEtwOutput(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  if ( (a4 & 0xE) != 0 )
  {
    *(_DWORD *)&DestinationString.Length = 34078720;
    ...
    if ( (unsigned int)RtlGetCurrentServiceSessionId() )
      ...
      v12 = 2147353476LL;
    LdrpTraceLoadMUIDll(&DestinationString, *(unsigned __int8 *)v12);
  ...
  if ( (a4 & 1) != 0 )
  {
    ...
    if ( ModuleInfoFromVirtualMemory >= 0 )
    {
      ...
      LdrpTraceLoadMUIDll(&DestinationString, *(unsigned __int8 *)v9);
    }
  }
