/*
 * XREFs of atan2 @ 0x180090FD0
 * Callers:
 *     <none>
 * Callees:
 *     _controlfp @ 0x180096C6C (_controlfp.c)
...
LABEL_32:
    ...
    else
    {
      ...
      v27 = qword_180138FF0[v26];
      v28 = qword_180138860[v26];
    ...
    if ( v23 )
    {
      v28 = *(double *)&qword_18017EA48 - v28;
      v25 = *(double *)&qword_18017EA50 - v25;
    }
    if ( X < 0.0 )
    {
      v28 = *(double *)&qword_18017EA38 - v28;
      v25 = *(double *)&qword_18017EA40 - v25;
    }
    v34 = v28 + v25;
    if ( v3 < 0.0 )
      *(_QWORD *)&v34 ^= _xmm;
