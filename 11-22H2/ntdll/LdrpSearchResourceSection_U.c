/*
 * XREFs of LdrpSearchResourceSection_U @ 0x180027340
 * Callers:
 ...
 *     LdrFindResourceDirectory_U @ 0x1800EB8D0 (LdrFindResourceDirectory_U.c)
 * Callees:
 *     LdrpGetRcConfig @ 0x180007D68 (LdrpGetRcConfig.c)
 ...
 *     NtQueryDefaultLocale @ 0x18009F090 (NtQueryDefaultLocale.c)
 */
        ...
        unsigned __int64 *a5)
{
  ...
  unsigned __int64 v125; // [rsp+D8h] [rbp-110h] BYREF
...
LABEL_47:
  ...
  if ( !v21 )
    return 3221225609LL;
  LOBYTE(v23) = 1;
  result = LdrpResGetMappingSize(v7, &v125, 256LL, v23);
  v106 = result;
  if ( (int)result < 0 )
    return result;
  v131 = v21;
