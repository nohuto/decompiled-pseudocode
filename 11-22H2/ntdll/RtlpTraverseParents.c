/*
 * XREFs of RtlpTraverseParents @ 0x180003FD0
 * Callers:
 ...
 * Callees:
 *     RtlpTraverseParents @ 0x180003FD0 (RtlpTraverseParents.c)
 *     LdrpGetMUILangConfigNode @ 0x1800AE1C6 (LdrpGetMUILangConfigNode.c)
 */
...
char __fastcall RtlpTraverseParents(_WORD *a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5, int a6)
{
  ...
  if ( !v15 || v15 == 2 )
  {
    if ( !a4 || (int)LdrpGetMUILangConfigNode(a1, a3, a4, &v24) < 0 )
    {
LABEL_21:
      for ( i = 0; i < 4; ++i )
      {
