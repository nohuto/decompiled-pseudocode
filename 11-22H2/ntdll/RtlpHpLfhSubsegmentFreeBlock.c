/*
 * XREFs of RtlpHpLfhSubsegmentFreeBlock @ 0x18003C5F0
 * Callers:
 ...
 *     RtlpHpLfhSubsegmentFindEmptyUnits @ 0x180067998 (RtlpHpLfhSubsegmentFindEmptyUnits.c)
...
__int64 __fastcall RtlpHpLfhSubsegmentFreeBlock(unsigned __int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  int v64[22]; // [rsp+30h] [rbp-58h] BYREF
  ...
  v7 = a1;
  v8 = 0LL;
  v9 = qword_180184E48 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
  if ( !a3 )
    goto LABEL_16;
  v10 = a3 - HIWORD(v9) - a2;
  v11 = *(_QWORD *)(a1
...
LABEL_85:
    if ( (unsigned int)v24 < *(unsigned __int8 *)(v6 + 45) )
    {
      do
      {
        EmptyUnits = RtlpHpLfhSubsegmentFindEmptyUnits(v6, (unsigned int)v24, &v67);
        if ( EmptyUnits == -1 )
          break;
        if ( v67 < 2 )
        {
        ...
        else if ( v48 )
        {
          ...
          v60 = v59;
          v7 = a1;
          RtlpHpLfhSubsegmentDecBlockCounts(a1, v6, v60, v58);
          if ( !v49 )
            goto LABEL_98;
          LODWORD(v24) = EmptyUnits + v67;
        }
        else
        {
          LODWORD(v24) = EmptyUnits;
          if ( (v68 & 1) == 0 )
            RtlAcquireSRWLockShared((volatile signed __int64 *)(v7 + 72), EmptyUnits, v55, v56);
          v48 = 2;
  ...
  do
  {
    if ( !v8 && (!(_WORD)v29 || (unsigned __int16)v29 == v28 - 1) )
    {
      ...
      while ( 1 )
      {
        while ( !v32 )
        {
          v63 = _InterlockedCompareExchange64((volatile signed __int64 *)(v6 + 16), 3LL, 0LL);
          v62 = v63 == 0;
LABEL_109:
          v32 = v63;
          if ( v62 )
        ...
        v8 = v32;
        RtlAcquireSRWLockExclusive((volatile signed __int64 *)(v32 + 16));
        v32 = *(_QWORD *)(v6 + 16);
        if ( v8 == v32 )
          break;
...
LABEL_43:
  ...
  if ( v6 )
  {
    v43 = *(volatile signed __int64 **)(a1
                                      + 8LL
    ...
    if ( *(_WORD *)(v6 + 32) == *(_WORD *)(v6 + 34)
      || ((RtlAcquireSRWLockExclusive(v43 + 2),
        ...
        : (v6 = RtlpHpLfhOwnerMoveSubsegment(v43, v6, 0LL)),
          ...
          v6) )
    {
      _InterlockedDecrement64(v43 + 8);
      v44 = v68 & 1;
      _InterlockedExchangeAdd64(v43 + 7, -*(__int16 *)(v6 + 34));
      ...
      if ( *(_BYTE *)(v6 + 45) )
      {
        do
        {
          v47 = RtlpHpLfhSubsegmentFindEmptyUnits(v6, v5, v64);
          if ( v47 == -1 )
            break;
          v46 += v64[0];
          v5 = v64[0] + v47;
