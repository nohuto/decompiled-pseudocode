...
LABEL_4:
  ...
  v29 = *(_OWORD *)(a1 + 40);
  v16 = RtlpHpHeapValidateProtection((__int64)v12, v15 ? 64 : 4, v13, v14);
  v18 = RtlpHpAllocVA(v28, (__int64 *)&v30, v30, 0x2000, v16, &v29);
  if ( v18 >= 0 )
  {
    LODWORD(v11) = v30;
    if ( v8 < v30 )
    {
      RtlpHpSegMgrVaCtxInitialize(v17, v28[0], v6);
      LODWORD(v11) = v30;
    }
    goto LABEL_8;
  }
