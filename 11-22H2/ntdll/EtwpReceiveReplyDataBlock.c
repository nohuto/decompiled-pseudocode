/*
 * XREFs of EtwpReceiveReplyDataBlock @ 0x180052D84
 * Callers:
...
LABEL_3:
    if ( v16 )
    {
      ...
      {
        InputBuffer[1] = a2;
        v17 = (((unsigned __int64)MEMORY[0x7FFE0004] << 32)
        ...
        v19 = ((((unsigned __int64)MEMORY[0x7FFE0004] << 32)
              * (unsigned __int128)(unsigned __int64)(MEMORY[0x7FFE0320] << 8)) >> 64)
            - v17;
        if ( a2 <= v19 )
        {
      ...
      if ( !a3 )
      {
        if ( v29 )
        {
          if ( *((_DWORD *)v12 + 1) >= 0xF8u )
          {
            if ( *((_DWORD *)v12 + 19) == 1 )
            {
              *((_DWORD *)v15 + 2 * v13) = *((_DWORD *)v12 + 8);
              *((_WORD *)v15 + 4 * v13 + 2) = *((_WORD *)v12 + 40);
              *((_WORD *)v15 + 4 * v13 + 3) = *((_WORD *)v12 + 118);
              v20 = (unsigned int)ReturnLength;
            }
