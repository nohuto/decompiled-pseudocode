/*
 * XREFs of LdrpCreatePendingEnclaveModule @ 0x1800D8B14
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    *v12 = v11;
    ...
    if ( a7 )
      *a7 = v11;
    if ( RtlEqualUnicodeString((PUNICODE_STRING)a2, (PUNICODE_STRING)&stru_1801325A0, 1u) )
    {
      a1[15] = v11;
    }
    else if ( RtlEqualUnicodeString((PUNICODE_STRING)a2, (PUNICODE_STRING)&stru_180132590, 1u) )
    {
      a1[16] = v11;
    }
    return 0LL;
