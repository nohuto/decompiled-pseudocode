/*
 * XREFs of LdrRegisterDllNotification @ 0x180001F00
 * Callers:
...
__int64 __fastcall LdrRegisterDllNotification(int a1, __int64 a2, __int64 a3, __int64 *a4)
{
  ...
  *(_QWORD *)(Heap + 24) = a3;
  ...
  v9 = (__int64 *)off_18017E2F8[0];
  if ( *(_UNKNOWN ***)off_18017E2F8[0] != &LdrpDllNotificationList )
    __fastfail(3u);
  *(_QWORD *)v8 = &LdrpDllNotificationList;
  *(_QWORD *)(v8 + 8) = v9;
  *v9 = v8;
  off_18017E2F8[0] = (_UNKNOWN **)v8;
