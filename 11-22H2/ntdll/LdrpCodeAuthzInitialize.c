/*
 * XREFs of LdrpCodeAuthzInitialize @ 0x180009DAC
 * Callers:
...
__int64 LdrpCodeAuthzInitialize()
{
  ...
  if ( (unsigned __int16)(*(_WORD *)(v16 + 92) - 2) > 1u )
    return 0LL;
  if ( (int)NtOpenKey(&v14, 3LL, &unk_180131130) < 0
    || (v4 = NtQueryValueKey(v14, &unk_1801326D8, 2LL, v29, 80, &v10), NtClose(v14), v4 < 0)
    || v30 != 4
    || v31 != 4
    || !v32 )
  {
    v10 = 0LL;
    if ( (int)NtOpenKey(&v10, 131097LL, &unk_18017E2C0) >= 0 )
    {
      v7 = &v8;
    ...
    if ( (int)NtOpenKey(&Handle, 1LL, &unk_180131160) >= 0 )
    {
    ...
    if ( v1 )
    {
      ...
      else if ( (int)LdrLoadDll(0LL, 0LL, &unk_1801326C8, &v15, v7) >= 0 )
      {
        v6 = v15;
        if ( (int)LdrGetProcedureAddressForCaller(v15, (unsigned int)&unk_1801326E8, 0, (unsigned int)&v11, 0, retaddr) >= 0
          && v11 )
        {
