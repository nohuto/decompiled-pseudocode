/*
 * XREFs of RtlFindActivationContextSectionGuid @ 0x18001B5A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlFindActivationContextSectionGuid(int a1, __int64 a2, int a3, _DWORD *a4, unsigned int *a5)
{
  ...
  v17 = 0;
  result = RtlpFindActivationContextSection_CheckParameters(a1, a2, a3, (_DWORD)a4, (__int64)a5);
  if ( (int)result >= 0 )
  {
    v20[1] = 0;
    v24 = 0;
...
LABEL_25:
        ...
        if ( *v18 != 1682469703 )
          goto LABEL_25;
        result = RtlpFindGuidInSection((__int64)v18, a4, a5);
        if ( (int)result >= 0 )
          break;
