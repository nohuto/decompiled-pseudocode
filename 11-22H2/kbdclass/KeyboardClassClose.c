/*
 * XREFs of KeyboardClassClose @ 0x1C0001C20
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels == v6 )
  {
    ...
    for ( i = 0LL; (unsigned int)i < LODWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext); i = (unsigned int)(i + 1) )
    {
      ...
      if ( !v14[19] )
      {
        ...
        if ( v15 )
        {
          v19 = (void *)_InterlockedExchange64((volatile __int64 *)(*v18 + 328LL), 0LL);
          if ( v19 )
            IoUnregisterPlugPlayNotification(v19);
          v2 = KbdEnableDisablePort(0LL, v3, *v18, v14);
        }
        if ( v2 >= 0 )
        {
          v4 = 1;
        ...
        else
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_qqq(WPP_GLOBAL_Control->DeviceExtension, v16, v17, 38);
