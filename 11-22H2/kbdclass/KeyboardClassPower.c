/*
 * XREFs of KeyboardClassPower @ 0x1C00013F0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qq @ 0x1C0001310 (WPP_RECORDER_SF_qq.c)
 *     WPP_RECORDER_SF_qqsd @ 0x1C0001720 (WPP_RECORDER_SF_qqsd.c)
...
LABEL_35:
    a2->Tail.Overlay.CurrentStackLocation->Control |= 1u;
    v20 = PoRequestPowerIrp(*(PDEVICE_OBJECT *)v4, 2u, v19, KeyboardClassPoRequestComplete, a2, 0LL);
    if ( v20 < 0 )
    {
