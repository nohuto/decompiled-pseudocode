/*
 * XREFs of KeyboardClassReadCopyData @ 0x1C00055E8
 * Callers:
 ...
 *     WPP_RECORDER_SF_qqLL @ 0x1C0006CE4 (WPP_RECORDER_SF_qqLL.c)
 *     WPP_RECORDER_SF_qqLqq @ 0x1C0006F58 (WPP_RECORDER_SF_qqLqq.c)
 *     WPP_RECORDER_SF_qqqql @ 0x1C000761C (WPP_RECORDER_SF_qqqql.c)
 */
...
__int64 __fastcall KeyboardClassReadCopyData(__int64 a1, _QWORD *a2, int a3, int a4)
{
  ...
  if ( v8 < v9 )
    v10 = v8;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_qqL((__int64)WPP_GLOBAL_Control->DeviceExtension, 5u, 3u, 0x2Au, v19);
  v11 = (char *)a2[3];
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  *(_DWORD *)(a1 + 84) -= v8 / 0xC;
  if ( v17 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_qq((__int64)WPP_GLOBAL_Control->DeviceExtension, 3u, 3u, 0x2Du, v19);
    *(_BYTE *)(a1 + 361) = 1;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
