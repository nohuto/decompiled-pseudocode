/*
 * XREFs of KeyboardClassServiceCallback @ 0x1C00059F0
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x1C0003240 (memmove.c)
 *     KeyboardClassDequeueRead @ 0x1C00052C4 (KeyboardClassDequeueRead.c)
 *     KeyboardClassReadCopyData @ 0x1C00055E8 (KeyboardClassReadCopyData.c)
 *     WPP_RECORDER_SF_ @ 0x1C000652C (WPP_RECORDER_SF_.c)
 *     WPP_RECORDER_SF_qL @ 0x1C00066B0 (WPP_RECORDER_SF_qL.c)
 *     WPP_RECORDER_SF_qLL @ 0x1C0006784 (WPP_RECORDER_SF_qLL.c)
 *     WPP_RECORDER_SF_qLqq @ 0x1C000687C (WPP_RECORDER_SF_qLqq.c)
 *     WPP_RECORDER_SF_qlqqd @ 0x1C0006A68 (WPP_RECORDER_SF_qlqqd.c)
 *     WPP_RECORDER_SF_qqLLqq @ 0x1C0006E00 (WPP_RECORDER_SF_qqLLqq.c)
 *     WPP_RECORDER_SF_qqiL @ 0x1C0007414 (WPP_RECORDER_SF_qqiL.c)
 */
...
LABEL_51:
  ...
  if ( v21 )
  {
    ...
    if ( v24 < v25 )
      v25 = v24;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_qLqq(WPP_GLOBAL_Control->DeviceExtension, v22, v13, 58);
    memmove(*(void **)(v8 + 112), v20, v25);
    *(_QWORD *)(v8 + 112) += v25;
    v28 = &v20[v25];
    v29 = *(_QWORD *)(v8 + 104);
    v30 = *(_QWORD *)(v8 + 112);
    if ( v30 >= v29 + (unsigned __int64)*(unsigned int *)(v8 + 140) )
    {
      *(_QWORD *)(v8 + 112) = v29;
      LODWORD(v30) = v29;
    }
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
        WPP_RECORDER_SF_qLqq(WPP_GLOBAL_Control->DeviceExtension, v30, v26, 59);
      memmove(*(void **)(v8 + 112), v28, v31);
      *(_QWORD *)(v8 + 112) += v31;
    }
    *(_DWORD *)(v8 + 84) += v24 / 0xC;
    *v4 += v24 / 0xC;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
