/*
 * XREFs of StorpTelemetrySendUnitScsiDiagnostics @ 0x1C0072334
 * Callers:
 ...
 *     StorpTelemetryGetReadErrorCounter @ 0x1C006E418 (StorpTelemetryGetReadErrorCounter.c)
 *     StorpTelemetryGetStartStopCycleCounter @ 0x1C006E478 (StorpTelemetryGetStartStopCycleCounter.c)
 *     StorpTelemetryGetWriteErrorCounter @ 0x1C006EBB0 (StorpTelemetryGetWriteErrorCounter.c)
 */
...
void __fastcall StorpTelemetrySendUnitScsiDiagnostics(__int64 a1)
{
  ...
  _QWORD v58[8]; // [rsp+2B8h] [rbp+B0h] BYREF
  ...
  if ( (*(_DWORD *)(v1 + 2040) & 0x10) == 0 )
  {
    ...
    if ( Pool )
    {
      v4 = RaidUnitLogSenseCommandSrb(v1, 0LL, 0, 0, (__int64)&v23, Pool);
      if ( (int)(v4 + 0x80000000) < 0 || v4 == -2147483643 )
      {
        ...
        while ( 1 )
        {
          v8 = *(_QWORD *)(v1 + 8);
          v23 = 4096;
          v9 = (_BYTE *)RaidAllocatePool(256LL, 4096LL, 1700028754LL, v8);
          v58[v7] = v9;
          v10 = v9;
          if ( !v9 )
            break;
          v22 = *((_BYTE *)v59 + v7);
          v11 = RaidUnitLogSenseCommandSrb(v1, 0LL, *((_BYTE *)v60 + v7), v22, (__int64)&v23, v9);
          if ( ((v11 + 0x80000000) & 0x80000000) != 0 || v11 == -2147483643 )
          {
            ...
            if ( v13 >= 4 )
            {
              do
              {
                ...
                {
                  case 2:
                    StorpTelemetryGetWriteErrorCounter(v12, v18, v27);
                    break;
                  case 3:
                    StorpTelemetryGetReadErrorCounter(v12, v18, v27);
                    break;
                  case 13:
