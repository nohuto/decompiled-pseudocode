/*
 * XREFs of StorpTelemetryConstructErrorEntry @ 0x1C0015178
 * Callers:
  ...
  *(_BYTE *)(v13 + 5) = -1;
  if ( v9 )
  {
    *(_BYTE *)(v13 + 5) = *v9;
    ...
    {
      RaidGetIoStartingLbaAndLength(v31, v13 + 24, 0LL);
      if ( v5 )
      {
        v33 = *(_QWORD *)(v5 + 8);
        if ( v33 )
  ...
  if ( g_StorpTraceLoggingPerformanceEnabled )
  {
    if ( !UseQPCTime )
      goto LABEL_9;
    v17 = g_StorpTraceLoggingPerformanceHighResolutionTimer == 0;
LABEL_8:
    if ( !v17 )
