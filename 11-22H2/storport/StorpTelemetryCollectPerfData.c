/*
 * XREFs of StorpTelemetryCollectPerfData @ 0x1C0003500
 * Callers:
...
LABEL_108:
    ...
    v57 = g_StorpTraceLoggingPerformanceHighResolutionTimer == 0;
LABEL_103:
    if ( !v57 )
    {
...
LABEL_159:
  ...
  if ( v65 + v63 >= HighLatencyIoThreshold
  ...
  v81 = KeGetCurrentProcessorNumberEx(0LL) % g_RaidNumberProcessors;
  if ( v104 )
  {
    v82 = 13;
    v83 = (__int64 *)*(&P + 1);
    ...
    v82 = v85;
LABEL_172:
    v86 = (unsigned int)dword_1C009250C;
    v87 = v105;
    v88 = v84 + v82 * (unsigned int)(unsigned __int16)TelemetryPerfContext;
  }
  else
  {
    v87 = v105;
...
LABEL_181:
    v84 = v105;
    v86 = *((unsigned int *)&xmmword_1C0092530 + 3);
    v88 = v105 + v82 * (unsigned int)(unsigned __int16)xmmword_1C0092510;
  }
  v91 = v116;
  v92 = *((_QWORD *)v64 + 287) + (unsigned int)dword_1C0092578 * v81 + 24 * (v88 + v86);
...
LABEL_192:
    v96 = (volatile signed __int64 *)(*((_QWORD *)v64 + 288)
                                    + (unsigned int)dword_1C009257C * v81
                                    + 16
                                    * (*((unsigned int *)&xmmword_1C0092560 + 3)
                                     + (unsigned __int64)(v84
                                                        + (unsigned __int16)xmmword_1C0092540
                                                        * (v82 * (unsigned int)WORD1(xmmword_1C0092540) + v95))));
