/*
 * XREFs of StorpTelemetryLogUnitS4WhenAdaptiveIdleEngaged @ 0x1C001272C
 * Callers:
...
void __fastcall StorpTelemetryLogUnitS4WhenAdaptiveIdleEngaged(__int64 a1)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
    ...
    if ( (v2 & 0x100) != 0 && (v2 & 0x200) != 0 && (unsigned int)dword_1C00920C8 > 5 )
    {
      if ( (unsigned __int8)tlgKeywordOn(v2, 0x400000000000LL) )
      {
        ...
        v16 = v5;
        v35 = 8LL;
        tlgWriteEx_EtwWriteEx(v6, (unsigned __int8 *)dword_1C0085A0A, v7, v5, v8, v9, 0xBu, &v17);
      }
    }
