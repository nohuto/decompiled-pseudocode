/*
 * XREFs of StorSetMFNDChildPFSettings @ 0x1C00AEBEC
 * Callers:
...
LABEL_38:
    ...
    && (v10 = *(_WORD *)(*(_QWORD *)(a2 + 24) + 28LL), (v10 & 3) != 0) )
  {
    ...
    if ( *(_DWORD *)(a1 + 5960) != 1 )
    {
      v21 = StorSetMFNDOperationPrivilege(a1, 1);
      if ( v21 < 0 )
        goto LABEL_38;
      v7 = 1;
    }
    ...
    StorBuildMFNDManagementCommand((__int64)v20, 0, *(unsigned __int16 *)(v6 + 8), 0, 0x80u);
    v14 = StorSendMFNDCommand(
            a1,
            (void *)v8,
            0LL,
            0x80u,
...
LABEL_39:
  ...
  StorLogMFNDSetChildPFSettings(a1, v6, v9, v15);
