/*
 * XREFs of McTemplateK0qjzzzhhhhhhhhhuhhhhuqbr20uuq_EtwWriteTransfer @ 0x1C0074C8C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzzzhhhhhhhhhuhhhhuqbr20uuq_EtwWriteTransfer(
        __int64 a1,
        ...
        char a28)
{
  ...
  v92 = 1LL;
  v94 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v29, a2, 0LL, 0x1Au, &v40);
}
