/*
 * XREFs of RaUnitQueryCapabilitiesIrp @ 0x1C00A0A94
 * Callers:
...
__int64 __fastcall RaUnitQueryCapabilitiesIrp(__int64 a1, IRP *a2)
{
  ...
  {
    RaidUnitPoFxActivateComponent(a1, 0, 1LL, v42);
    ...
    PortWdmGetDeviceCapabilities(*(PDEVICE_OBJECT *)(*(_QWORD *)(a1 + 24) + 8LL), v43);
    v9 = 128LL;
    *(_OWORD *)&SecurityContext->SecurityQos = v43[0];
    v10 = 256;
    *(_OWORD *)&SecurityContext->DesiredAccess = v43[1];
    *(_OWORD *)&SecurityContext[1].AccessState = v43[2];
    *(_OWORD *)&SecurityContext[2].SecurityQos = v43[3];
    v11 = HIDWORD(SecurityContext->SecurityQos) | 0x100;
    HIDWORD(SecurityContext->SecurityQos) = v11;
    if ( (*(_DWORD *)(a1 + 1872) & 0x20) != 0 || *(_BYTE *)(PortGetDeviceType(**(_BYTE **)(a1 + 104) & 0x1F) + 24) )
    ...
    *(_BYTE *)(a1 + 450) = v12 & 0x7F | ((unsigned __int8)(HIDWORD(SecurityContext->SecurityQos) >> 9) << 7);
    ...
    RaidUnitPoFxIdleComponent(v13, 0, 0, v42);
    v14 = 0;
  }
