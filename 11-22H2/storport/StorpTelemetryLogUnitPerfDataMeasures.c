/*
 * XREFs of StorpTelemetryLogUnitPerfDataMeasures @ 0x1C001C3C0
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v42 = 1LL;
      v44 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v45, *(_WORD **)(v2 + 4656));
      tlgCreate1Sz_char((__int64)v46, (_BYTE *)(v3 + 160));
      tlgCreate1Sz_char((__int64)v47, (_BYTE *)(v4 + 169));
      tlgCreate1Sz_char((__int64)v48, (_BYTE *)(v5 + 186));
      v49 = &v27;
      v18 = *(_BYTE *)(v6 + 8);
      v51 = &v18;
      v28 = *(_QWORD *)(v6 + 360);
      ...
      v67 = &v30;
      v68 = 8LL;
      tlgCreate1Sz_wchar_t((__int64)v69, L"Read, Write");
      v9 = *(_WORD **)(v8 + 16);
      v70 = &v19;
      v72 = (__int64)*(&P + 1);
      ...
      v71 = 2LL;
      v74 = 0;
      tlgCreate1Sz_wchar_t((__int64)v75, v9);
      tlgCreate1Sz_wchar_t((__int64)v76, L"Flush, Unmap");
      tlgCreate1Sz_wchar_t((__int64)v77, L"64ms, 256ms, 1024ms, 5120ms, 5120+ms");
      v79 = 8LL;
      v11 = *v10;
      v81 = 2LL;
      v78 = &v31;
      ...
      v80 = &v20;
      v12 = v10[46];
      v20 = 3 * qword_1C0092570;
      v82 = v12;
      v83 = 8 * (unsigned __int16)(3 * qword_1C0092570);
      tlgWriteTransfer_EtwWriteTransfer(3 * qword_1C0092570, (int)&dword_1C0084FD0, v13, v14, 0x1Fu, &v32);
    }
  }
}
