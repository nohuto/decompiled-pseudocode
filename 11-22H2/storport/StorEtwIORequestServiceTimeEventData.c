/*
 * XREFs of StorEtwIORequestServiceTimeEventData @ 0x1C0067CB4
 * Callers:
...
LABEL_32:
  if ( *(_BYTE *)(v4 + 2) == 40 )
  {
    SrbScsiData = (char *)GetSrbScsiData(v4, 0LL, 0LL, &v41, 0LL, 0LL);
    if ( SrbScsiData )
      v5 = *SrbScsiData;
  ...
  if ( a2 )
  {
    if ( (byte_1C0092A01 & 1) != 0 )
    {
      ...
      v35 = v30;
      v34 = v29;
      v31 = (const EVENT_DESCRIPTOR *)&EventIOPerformanceMeasurementTarget;
      goto LABEL_42;
    }
  }
  else if ( (byte_1C0092A01 & 1) != 0 )
  {
    v39 = v3;
    v38 = v6;
    v37 = v27;
    ...
    v35 = v30;
    v34 = v29;
    v31 = (const EVENT_DESCRIPTOR *)&EventIOPerformanceMeasurement;
LABEL_42:
    LOBYTE(v33) = v5;
    LODWORD(v15) = McTemplateK0xpuupuuuuuqxx_EtwWriteTransfer(
                     QuadPart,
                     v31,
                     (const GUID *)(a1 + 728),
                     a3,
