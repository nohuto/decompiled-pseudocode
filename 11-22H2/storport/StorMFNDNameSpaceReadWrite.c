/*
 * XREFs of StorMFNDNameSpaceReadWrite @ 0x1C00AC15C
 * Callers:
 ...
 *     StorBuildMFNDNSReadWriteCommand @ 0x1C0075F58 (StorBuildMFNDNSReadWriteCommand.c)
        ...
        __int64 a9)
{
  ...
  int MFNDChildPFGlobalProperty; // [rsp+6Ch] [rbp-4Dh] BYREF
  unsigned int v27; // [rsp+70h] [rbp-49h]
  unsigned int v28; // [rsp+74h] [rbp-45h]
  _BYTE v29[128]; // [rsp+78h] [rbp-41h] BYREF
  ...
  if ( (*(_BYTE *)(a1 + 111) & 1) != 0 )
  {
    MFNDChildPFGlobalProperty = StorRetrieveMFNDChildPFGlobalProperty(a1);
    v13 = MFNDChildPFGlobalProperty;
    if ( MFNDChildPFGlobalProperty >= 0 )
    {
      ...
      if ( v14 && (v15 = *(_BYTE *)(v14 + 2)) != 0 )
      {
        ...
        if ( *(_DWORD *)(a1 + 5960) != 1 )
        {
          MFNDChildPFGlobalProperty = StorSetMFNDOperationPrivilege(a1, 1);
          v13 = MFNDChildPFGlobalProperty;
          if ( MFNDChildPFGlobalProperty < 0 )
            goto LABEL_38;
          v25 = 1;
        ...
        if ( a5 )
        {
          ...
          while ( 1 )
          {
            ...
            StorBuildMFNDNSReadWriteCommand((__int64)v29, a2, a4, v18, a6, a3);
            if ( v30 )
            {
              v19 = v11;
              v20 = (int)Mdl;
            ...
            MFNDChildPFGlobalProperty = StorSendMFNDCommand(a1, (_DWORD)v21, v20, v19, (__int64)v29);
            v13 = MFNDChildPFGlobalProperty;
            if ( MFNDChildPFGlobalProperty < 0 )
              break;
            a4 += v27;
