/*
 * XREFs of StorUnitStartBypassIo @ 0x1C0063780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall StorUnitStartBypassIo(__int64 a1, unsigned __int64 a2)
{
  __int64 v2; // r14
  __int64 v4; // rax
  int v6; // ecx
...
LABEL_3:
    v10 = -1073741823;
LABEL_4:
    v11 = RaidCompleteRequestEx((PIRP)a2, 0, v10);
    goto LABEL_45;
  }
  if ( *(_BYTE *)v8 != 15 || !v9 )
  {
...
LABEL_32:
  ...
  if ( v15 )
    goto LABEL_34;
  if ( *(_BYTE *)(v9 + 2) == 40 )
    GetSrbScsiData(v7, 0LL, 0LL, 0LL, 0LL, 0LL);
  if ( !(unsigned int)IsReadWriteRequest() )
  {
LABEL_34:
    *(_BYTE *)(v9 + 3) = 6;
    goto LABEL_32;
  ...
  *(_BYTE *)(a2 + 141) = -88;
  v11 = RaidUnitSubmitRequest(v2, a2);
LABEL_45:
  v19 = v11;
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    && (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) != 0
