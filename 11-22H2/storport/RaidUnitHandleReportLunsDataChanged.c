/*
 * XREFs of RaidUnitHandleReportLunsDataChanged @ 0x1C0061400
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( !*(_BYTE *)(*(_QWORD *)(a1 + 24) + 443LL) )
    {
      ...
      if ( Pool )
      {
        ...
        if ( !_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 24) + 4760LL), 1, 0) )
        {
          ...
          *(_QWORD *)(*(_QWORD *)(a2 + 216) + 4776LL) = Pool;
          *(_DWORD *)(*(_QWORD *)(a2 + 216) + 4768LL) = 0;
          *(_QWORD *)(*(_QWORD *)(a2 + 216) + 4784LL) = &RaidUnitHandleReportLunsDataChangedCompletion;
