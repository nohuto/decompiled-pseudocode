/*
 * XREFs of StorSerialNumberFromNvmeId @ 0x1C00743D0
 * Callers:
 *     StorBuildNVMeSerialNumber @ 0x1C00742C0 (StorBuildNVMeSerialNumber.c)
 * Callees:
 *     RaidHexFromUchar @ 0x1C0074290 (RaidHexFromUchar.c)
 */
...
__int64 __fastcall StorSerialNumberFromNvmeId(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( a2 != 1 )
  {
    do
    {
      RaidHexFromUchar(*(_BYTE *)(v7 + a1), (_BYTE *)(v5 + v9), v4 - v9);
      v11 = (unsigned int)(v7 + 1);
      RaidHexFromUchar(*(_BYTE *)(v11 + a1), (_BYTE *)(v13 + (unsigned int)(v10 + 2)), v12 - (v10 + 2));
