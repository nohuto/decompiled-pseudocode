/*
 * XREFs of RaidUnitSendSrbIoControlSynchronously @ 0x1C001ECDC
 * Callers:
        ...
        int a7)
{
  ...
  if ( Srb )
  {
    ...
    else
    {
      ...
      *(_DWORD *)(Srb + 16) = a4;
      *(_QWORD *)(Srb + 48) = a2;
      *(_DWORD *)(Srb + 20) = *(_DWORD *)(a1 + 1320);
      *(_BYTE *)(Srb + 5) = *(_BYTE *)(a1 + 96);
      *(_BYTE *)(Srb + 6) = *(_BYTE *)(a1 + 97);
      *(_BYTE *)(Srb + 7) = *(_BYTE *)(a1 + 98);
    }
    v19 = (IRP *)((__int64 (__fastcall *)(_QWORD, __int64, __int64, __int128 *))StorBuildSynchronousScsiRequest)(
                   *(_QWORD *)(a1 + 8),
                   Srb,
                   v15,
                   &v24);
