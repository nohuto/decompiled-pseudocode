/*
 * XREFs of StorpTelemetryMarkUnitUnresponsive @ 0x1C0070974
 * Callers:
...
void __fastcall StorpTelemetryMarkUnitUnresponsive(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(a1 + 450) & 2) == 0 && (unsigned int)dword_1C00920C8 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v14 = v4;
      v37 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v5, (unsigned __int8 *)dword_1C0086F11, v2, v3, 0xDu, &v15);
    }
  }
}
