/*
 * XREFs of RaGetProtocolCommandEffects @ 0x1C0033EC4
 * Callers:
...
LABEL_13:
    ...
    *(_QWORD *)(Pool + 4) = 0x4C4F434F544F5250LL;
    ...
    v10[13] = 44;
    v10[14] = 4096;
    v9 = RaidAdapterSendSrbIoControlSynchronously(v11, a2, v10, 0x1050u, 0LL, 0, 64);
    if ( (v9 & 0x80000000) == 0 )
    {
      v17 = *(void **)(v11 + 5320);
      ...
      if ( !v17 )
      {
        v19 = (void *)RaidAllocatePool(66LL, 4096LL, 1162043730LL, *(_QWORD *)(v11 + 8));
        v20 = v19;
        if ( !v19 )
        {
          MasterIrp->Flags = 7;
