/*
 * XREFs of StorpCSExitTelemetry @ 0x1C006B950
 * Callers:
...
void __fastcall StorpCSExitTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( *(_QWORD *)(a1 + 4896) )
    {
      ...
      if ( v7 )
        v7 -= *(_QWORD *)(a1 + 5152);
      if ( (unsigned int)dword_1C00920C8 > 5 && tlgKeywordOn(v7, 0x400000000000LL) )
      {
        v47 = 16LL;
        v46 = a1 + 5000;
        v29 = *(_DWORD *)(a1 + 56);
        ...
        v73 = 8LL;
        v75 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer(v13, (unsigned __int8 *)dword_1C0085D16, v8, v9, 0x11u, &v45);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        ...
        if ( (unsigned int)dword_1C00920C8 > 5 )
        {
          if ( tlgKeywordOn(v18, 0x400000000000LL) )
          {
            ...
            v85 = 8LL;
            v87 = 4LL;
            tlgWriteTransfer_EtwWriteTransfer(v24, (unsigned __int8 *)dword_1C0085AB3, v19, v20, 0x17u, &v45);
          }
        }
