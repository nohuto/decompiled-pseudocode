/*
 * XREFs of RiNormalizeDeviceQueue @ 0x1C0004130
 * Callers:
...
char *__fastcall RiNormalizeDeviceQueue(__int64 a1, char a2)
{
  ...
  __int64 v46; // rsi
  __int64 LbaFromCdb; // rbp
  __int64 ZoneIndexFromUnitAndLba; // r14
...
LABEL_69:
    ...
    LbaFromCdb = PortSrbGetLbaFromCdb(v26, v36);
    ZoneIndexFromUnitAndLba = (unsigned int)GetZoneIndexFromUnitAndLba(v46, LbaFromCdb);
    v49 = RtlInterlockedSetClearRun(v46 + 3360, ZoneIndexFromUnitAndLba, 1LL);
    if ( v49 == 1 )
    {
      v50 = (v3[22] & 0xBF) == 0;
      v3[22] &= ~0x40u;
    ...
    if ( (qword_1C0092468 & 0x1000) != 0 )
      DbgLogRequest(
        ...
        *(unsigned __int8 *)(*(_QWORD *)(v46 + 3352) + ZoneIndexFromUnitAndLba),
        v49,
        0LL);
    v2 = (_QWORD *)(a1 + 144);
  }
  if ( (unsigned int)RiGetEnqueueReason(a1, v3) )
    return 0LL;
  if ( (_QWORD *)*v2 == v2 )
  {
  ...
  RiDecrementDeviceQueueCount(a1, v3);
  v3[20] &= 0xFCu;
  ...
  if ( (v3[22] & 0x20) != 0 )
  {
    QosEntryForDeviceEntry = (_QWORD *)RaidGetQosEntryForDeviceEntry(v3, v53, v54);
    v57 = *QosEntryForDeviceEntry;
    if ( *(_QWORD **)(*QosEntryForDeviceEntry + 8LL) != QosEntryForDeviceEntry )
      goto LABEL_89;
    v58 = (_QWORD *)QosEntryForDeviceEntry[1];
    if ( (_QWORD *)*v58 != QosEntryForDeviceEntry )
      goto LABEL_89;
    *v58 = v57;
    *(_QWORD *)(v57 + 8) = v58;
  }
