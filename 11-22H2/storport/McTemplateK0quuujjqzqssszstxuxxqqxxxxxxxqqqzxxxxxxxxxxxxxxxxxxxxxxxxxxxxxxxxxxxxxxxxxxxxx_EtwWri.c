/*
 * XREFs of McTemplateK0quuujjqzqssszstxuxxqqxxxxxxxqqqzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx_EtwWriteTransfer @ 0x1C001AB60
 * Callers:
...
NTSTATUS __fastcall McTemplateK0quuujjqzqssszstxuxxqqxxxxxxxqqqzxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a63)
{
  ...
  v247 = 8LL;
  v249 = 8LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)&a34, &EventUnitPerformance, 0LL, 0x4Eu, &v88);
}
