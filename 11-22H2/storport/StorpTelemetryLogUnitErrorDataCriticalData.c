/*
 * XREFs of StorpTelemetryLogUnitErrorDataCriticalData @ 0x1C006F5C8
 * Callers:
...
void __fastcall StorpTelemetryLogUnitErrorDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v38 = v2;
      v40 = v2;
      tlgCreate1Sz_wchar_t((__int64)v41, *(_WORD **)(v3 + 4656));
      ...
      v67 = 2LL;
      v69[1] = 0;
      tlgWriteTransfer_EtwWriteTransfer(v10, (unsigned __int8 *)dword_1C0084526, v11, v12, 0x1Bu, &v26);
    }
  }
}
