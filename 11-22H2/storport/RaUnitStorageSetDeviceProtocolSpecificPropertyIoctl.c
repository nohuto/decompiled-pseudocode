/*
 * XREFs of RaUnitStorageSetDeviceProtocolSpecificPropertyIoctl @ 0x1C0060354
 * Callers:
...
LABEL_14:
    ...
    if ( Length < IrpCount + (unsigned __int64)HIDWORD(MasterIrp->AssociatedIrp.SystemBuffer) + 8 )
      goto LABEL_5;
    v9 = RaBuildSetProtocolSpecificPropertyBufferForMiniport(*(_QWORD *)(a1 + 8), (__int64)a2, &P, (unsigned int *)&v13);
    v3 = P;
    if ( v9 >= 0 )
