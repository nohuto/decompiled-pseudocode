/*
 * XREFs of McTemplateK0quuu_EtwWriteTransfer @ 0x1C005C4D8
 * Callers:
...
NTSTATUS __fastcall McTemplateK0quuu_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a7)
{
  ...
  v16 = 1LL;
  v15 = &a7;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventLUReset, 0LL, 5u, &v8);
}
