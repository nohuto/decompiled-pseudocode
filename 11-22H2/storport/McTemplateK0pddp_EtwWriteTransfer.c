/*
 * XREFs of McTemplateK0pddp_EtwWriteTransfer @ 0x1C0032348
 * Callers:
...
NTSTATUS McTemplateK0pddp_EtwWriteTransfer(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  va_copy(v11, va3);
  v12 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventPnpRequest, a3, 5u, &v4);
}
