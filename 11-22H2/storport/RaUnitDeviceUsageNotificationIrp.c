/*
 * XREFs of RaUnitDeviceUsageNotificationIrp @ 0x1C00133C4
 * Callers:
 ...
 *     RaidSecondaryDumpRegister @ 0x1C0073750 (RaidSecondaryDumpRegister.c)
 *     RaidNotifyPoAboutSpecialDevice @ 0x1C0074240 (RaidNotifyPoAboutSpecialDevice.c)
 */
      ...
      if ( CurrentStackLocation->Parameters.Create.Options == 4 )
      {
        ...
        if ( Lock )
        {
          ...
          *(_BYTE *)(v2 + 104) |= 0x80u;
          ...
          if ( (unsigned int)dword_1C00920C8 > 5 && (unsigned __int8)tlgKeywordOn(v16, 0x400000000000LL) )
          {
            v18 = *(_QWORD *)(v2 + 4656);
            v35 = v2 + 5000;
            v36 = 16LL;
            ...
            v44 = 1LL;
            v46 = 1LL;
            tlgCreate1Sz_wchar_t(v47, v18);
            v19 = *(_QWORD *)(v2 + 4664);
            v28 = *(_BYTE *)(a1 + 3344);
            v48 = &v28;
            v49 = 1LL;
            tlgCreate1Sz_wchar_t(v50, v19);
            tlgWriteTransfer_EtwWriteTransfer((int)&v34, (int)&dword_1C00841E3, v20, v21, 0xBu, &v34);
          }
        }
        else
        {
...
LABEL_14:
    ...
    if ( v5 && RaidIsUnitControlSupported(a1, 1) )
    {
      ...
      *(_QWORD *)&v31 = &v33;
      ...
      DWORD1(v33) = 4;
      DWORD2(v31) = Options;
      RaCallMiniportUnitControl(v22 + 336, 1LL, &v31);
    }
    if ( Options == 3 )
    {
      v23 = *(_DWORD *)(a1 + 976);
