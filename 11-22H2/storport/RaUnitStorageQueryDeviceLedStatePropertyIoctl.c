/*
 * XREFs of RaUnitStorageQueryDeviceLedStatePropertyIoctl @ 0x1C0021AE0
 * Callers:
...
LABEL_2:
  ...
  v9 = *(_QWORD *)(a1 + 24);
  if ( *(char *)(v9 + 109) < 0
    || (LedState = RaidQueryLedState(*(_QWORD *)(v9 + 8), v9 + 5688), v2 = LedState, LedState >= 0) )
  {
    memset_0(MasterIrp, 0, Length);
    *(_DWORD *)&MasterIrp->Type = 16;
    *(_DWORD *)(&MasterIrp->Size + 1) = 16;
    MasterIrp->MdlAddress = (_MDL *)*(unsigned int *)(*(_QWORD *)(a1 + 24) + 5688LL);
