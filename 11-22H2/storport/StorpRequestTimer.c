/*
 * XREFs of StorpRequestTimer @ 0x1C000D7FC
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( !a1 || !a2 || !a3 )
  {
    ...
    {
      WPP_SF_qqq(WPP_GLOBAL_Control->AttachedDevice, 72LL, &WPP_dc0e079c384a3dd4a6b1f54a748f6ff0_Traceguids, a1, a2, a3);
    }
    return 3238002694LL;
  }
  v10 = *(_DWORD ***)(a1 - 16);
  ...
  if ( !*(_QWORD *)a2 || *v12 != 1094997074 )
  {
    ...
    v9 = a2;
LABEL_28:
    WPP_SF_q(v16->AttachedDevice, v17, &WPP_dc0e079c384a3dd4a6b1f54a748f6ff0_Traceguids, v9);
    return 3238002694LL;
  }
  if ( a5 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(a2 + 144) = a4;
      ...
      if ( KeGetCurrentIrql() > 2u )
        return (unsigned int)RaidAdapterRequestAddtionalTimerDeferred(v11, a2, v13, (unsigned int)v14);
      else
