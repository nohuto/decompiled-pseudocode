/*
 * XREFs of StorpMarkDeviceFailed @ 0x1C0049684
 * Callers:
 ...
 *     StorpPopulateLogData @ 0x1C0050214 (StorpPopulateLogData.c)
        ...
        void *a9)
{
  ...
  *(_OWORD *)v81 = 0LL;
  v82 = 0LL;
  RaidDriverGetName(v10, (__int64)v78);
  v14 = (int *)&dword_1C0081784;
  v79 = *(_OWORD *)(a1 + 5000);
  if ( v13 )
  {
...
LABEL_35:
  if ( (v19 & 6) == 0 || (v21 & 2) != 0 )
    ...
    LODWORD(v29) = ReportAllWheaErrorsAsNonFatal == 0;
  v67 = (int)v29;
  if ( (v23 || (_BYTE)v29) && !_InterlockedCompareExchange(&WheaPendingError, 1, 0) )
  {
    if ( v12 )
    {
      v32 = (int *)(v12 + 169);
    ...
    {
      v32 = (int *)&dword_1C0081784;
      Src = (int *)&dword_1C0081784;
    }
    if ( v76 )
    {
      v34 = (int *)(v12 + 3344);
    ...
    LODWORD(Size) = a6;
    *(_QWORD *)v77 = v36;
    StorpPopulateErrorData((int)v36, v35, (int)v78, (int)v32, v68, v19, Src, v32, Size, v75);
    v38 = v67;
    if ( (_BYTE)v67 )
    {
      if ( !v76 )
        v34 = (int *)(a1 + 4212);
      LODWORD(v60) = a8;
      StorpPopulateLogData(v77[0], *v34, v37, v68, v19, (size_t)v60, v74, (__int64)v81);
      v38 = v67;
    }
    v39 = a1;
    if ( v76 )
      v39 = v12;
    StorpWheaReportError(v73, v38, v37, (unsigned __int64)v81 & -(__int64)((_BYTE)v38 != 0), v39);
    _InterlockedExchange(&WheaPendingError, 0);
    v15 = v66;
  }
LABEL_57:
  DbgLogRequest(a1, 44, a1, retaddr, (__int64)v72, v62 | (unsigned __int64)((v63 | (v15 << 8)) << 8), 0LL);
  v41 = *(_QWORD *)&v78[2];
  if ( StorEtwLoggingEnabled )
  {
    if ( (v69 & 1) != 0 )
    {
      ...
      {
        v42 = (const wchar_t *)&unk_1C0081788;
        if ( *(_QWORD *)(a1 + 5016) )
        ...
        else
        {
          ...
          v44 = (const char *)&dword_1C0081784;
          v45 = (const char *)&dword_1C0081784;
        }
    ...
    else if ( (v69 & 2) != 0 )
    {
      if ( (byte_1C0092A05 & 0x10) != 0 )
      {
        v46 = (const wchar_t *)&unk_1C0081788;
        if ( *(_QWORD *)(a1 + 5016) )
        ...
        {
          v47 = (const char *)&dword_1C0081784;
          v48 = (const char *)&dword_1C0081784;
          v49 = (const char *)&dword_1C0081784;
        }
        McTemplateK0qqqqquuujjzssszshzhbr18hbr20q_EtwWriteTransfer(
          (__int64)v46,
    ...
    else if ( (byte_1C0092A05 & 0x10) != 0 )
    {
      v50 = (const wchar_t *)&unk_1C0081788;
      if ( *(_QWORD *)(a1 + 5016) )
      ...
      {
        v51 = (const char *)&dword_1C0081784;
        v52 = (const char *)&dword_1C0081784;
        v53 = (const char *)&dword_1C0081784;
      }
      McTemplateK0qqqqquuujjzssszshzhbr18hbr20q_EtwWriteTransfer(
        (__int64)v50,
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 && tlgKeywordOn(v40, 0x400000000000LL) )
  {
    v86 = 16LL;
    v85 = &v79;
    v87 = v80;
    ...
    v100[1] = 0;
    if ( !v12 )
      v54 = (int *)&dword_1C0081784;
    tlgCreate1Sz_char((__int64)v101, v54);
    if ( v12 )
      v14 = (int *)(v12 + 169);
    tlgCreate1Sz_char((__int64)v102, v14);
    v103 = (unsigned int *)&v67;
    v67 = v55;
    v104 = 4LL;
    tlgCreate1Sz_wchar_t((__int64)v105, v72);
    tlgWriteTransfer_EtwWriteTransfer((__int64)&v84, (unsigned __int8 *)dword_1C0083B35, v56, v57, 0xEu, &v84);
  }
  if ( v64 )
  {
    if ( v76 )
