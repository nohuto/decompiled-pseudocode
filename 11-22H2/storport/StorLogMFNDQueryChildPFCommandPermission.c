/*
 * XREFs of StorLogMFNDQueryChildPFCommandPermission @ 0x1C00762A4
 * Callers:
...
void __fastcall StorLogMFNDQueryChildPFCommandPermission(__int64 a1, __int64 a2, unsigned __int16 a3, char a4)
{
  __int128 v7; // xmm1
