/*
 * XREFs of SrbShimHookDeviceControl @ 0x1C000F540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SrbShimHookDeviceControl(__int64 a1, __int64 a2)
{
  ...
  if ( *((_DWORD *)v2 + 6) == 2954240 )
  {
    ...
    if ( v6 )
    {
      if ( !v6[1] && *v6 == 1 && *((_DWORD *)v2 + 2) >= 0x20u )
      {
        ...
        {
          WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 16LL, &WPP_d7a4465d56553371f6360018b92f43e1_Traceguids);
        }
        (*(void (__fastcall **)(__int64, __int64, __int64 (__fastcall *)(), _QWORD))(qword_1C0092188 + 8))(
          a1,
          a2,
  ...
  v7 = (*(__int64 (__fastcall **)(_QWORD))qword_1C0092188)(*(_QWORD *)(a1 + 8));
