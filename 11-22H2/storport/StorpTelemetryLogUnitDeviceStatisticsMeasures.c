/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsMeasures @ 0x1C006F0E8
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 && tlgKeywordOn(a1, 0x400000000000LL) )
  {
    ...
    v54 = 1LL;
    v56 = 1LL;
    tlgCreate1Sz_wchar_t((__int64)v57, *(_WORD **)(v2 + 4656));
    ...
    v111 = &v32;
    v112 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v26, (unsigned __int8 *)dword_1C00851A0, v6, v23, 0x26u, &v44);
  }
}
