/*
 * XREFs of StorSetMFNDChildPFQueuesState @ 0x1C00AE8C4
 * Callers:
...
__int64 __fastcall StorSetMFNDChildPFQueuesState(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (*(_BYTE *)(a1 + 111) & 1) == 0 )
  {
    v30 = -1073741637;
LABEL_47:
    StorMapMFNDErrorToNtStatus(v8, &v30);
    v23 = v30;
    goto LABEL_48;
  }
  if ( *(_DWORD *)(a1 + 5964) != 1 )
...
LABEL_18:
    if ( *(_DWORD *)(a1 + 5960) != 1 )
    {
      v30 = StorSetMFNDOperationPrivilege(a1, 1);
      if ( v30 < 0 )
        goto LABEL_47;
      v29 = 1;
    }
    ...
    *(_DWORD *)Pool = v13;
    v15 = Pool + 32;
    *((_WORD *)Pool + 2) = *(_WORD *)(v3 + 24);
    *((_WORD *)Pool + 3) = *(_WORD *)(v3 + 26);
    *((_QWORD *)Pool + 1) = *(_QWORD *)(v3 + 28);
    *((_QWORD *)Pool + 2) = *(_QWORD *)(v3 + 36);
    *((_WORD *)Pool + 12) = *(_WORD *)(v3 + 44);
    *((_WORD *)Pool + 13) = *(_WORD *)(v3 + 46);
    *((_WORD *)Pool + 14) = *(_WORD *)(v3 + 48);
    *((_WORD *)Pool + 15) = *(_WORD *)(v3 + 50);
    if ( (*(_BYTE *)(v3 + 52) & 1) != 0 )
      *v15 |= 1u;
    if ( (*(_BYTE *)(v3 + 52) & 2) != 0 )
      *v15 |= 2u;
    ...
    v22 = StorSendMFNDCommand(a1, Pool, 0LL, v13, v26, v25, 1, 1, 0, 0LL, &v31);
    v8 = v31;
    v23 = v22;
  }
  else
...
LABEL_48:
  ...
  StorLogMFNDSetCCQueuesState(a1, v3, v8, v23);
