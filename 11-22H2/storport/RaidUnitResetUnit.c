/*
 * XREFs of RaidUnitResetUnit @ 0x1C00625DC
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C006B454 (StorpAggregateHierarchicalResetLun.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C00920C8 > 5 )
      {
        ...
        v29[0] = v18;
        v46 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v22, (unsigned __int8 *)dword_1C008408C, v18, v19, 0xAu, &v30);
      }
