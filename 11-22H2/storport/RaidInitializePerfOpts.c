/*
 * XREFs of RaidInitializePerfOpts @ 0x1C003B850
 * Callers:
...
__int64 __fastcall RaidInitializePerfOpts(__int64 a1, char a2, __int64 i)
{
  ...
  if ( !a1 )
  {
    ...
    v14 = 22LL;
LABEL_6:
    WPP_SF_(v13->AttachedDevice, v14, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids);
LABEL_7:
    v12 = -1056964602;
    goto LABEL_130;
  }
  ...
  if ( (*(_BYTE *)(*v15 + 104) & 0x10) == 0 )
  {
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    {
      WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 24LL, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids);
    }
    v12 = -1056964607;
    goto LABEL_130;
  }
  ...
  if ( v16 >= 5 && *(_DWORD *)(v7 + 4) >= 0x28u )
  {
    if ( !KeGetCurrentIrql() )
    {
      ...
      {
        v18 = (__int64 *)(v3 + 760);
        if ( !(unsigned __int8)RaidIsDmaInitialized(v3 + 760, 1LL) )
          RaidInitializeDma(v19, *(_QWORD *)(v3 + 32), v3 + 344);
        if ( v3 != -760
          && (v20 = *v18) != 0
          && (v21 = *(_QWORD *)(v20 + 8)) != 0
          && *(int *)(v3 + 788) >= 3
...
LABEL_66:
  ...
  if ( (~v17 & v24) != 0 )
  {
    ...
    v26 = 25LL;
LABEL_72:
    WPP_SF_(v25->AttachedDevice, v26, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids);
LABEL_73:
    v12 = -1056964607;
    goto LABEL_130;
  }
