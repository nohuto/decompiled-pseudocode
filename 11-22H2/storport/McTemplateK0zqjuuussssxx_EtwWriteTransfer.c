/*
 * XREFs of McTemplateK0zqjuuussssxx_EtwWriteTransfer @ 0x1C00226BC
 * Callers:
        ...
        char a15)
{
  ...
  v52 = v15;
  v58 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(v28, &EventSMRUnsupportedZoneSizeError, 0LL, 0xDu, &v30);
}
