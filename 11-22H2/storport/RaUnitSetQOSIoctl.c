/*
 * XREFs of RaUnitSetQOSIoctl @ 0x1C005E730
 * Callers:
 *     RaUnitDeviceControlIrp @ 0x1C0006AF0 (RaUnitDeviceControlIrp.c)
 * Callees:
 *     RaidCompleteRequestEx @ 0x1C0003280 (RaidCompleteRequestEx.c)
 *     RaidAdapterEnableQosWaitTimeoutCheck @ 0x1C0035790 (RaidAdapterEnableQosWaitTimeoutCheck.c)
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      if ( v7 != 20 )
      {
        ...
        v9 = 40;
LABEL_83:
        WPP_SF_q((__int64)v8->AttachedDevice, v9, (__int64)&WPP_aacce2c5c88a3640487a3f62f1d3f691_Traceguids, a1);
LABEL_84:
        v5 = -1073741637;
        goto LABEL_85;
      }
  ...
  if ( Flags != -1 && Flags != 500 * (Flags / 0x1F4) )
  {
    ...
    v18 = 46;
LABEL_77:
    WPP_SF_q((__int64)v17->AttachedDevice, v18, (__int64)&WPP_aacce2c5c88a3640487a3f62f1d3f691_Traceguids, a1);
LABEL_78:
    v5 = -1073741811;
    goto LABEL_85;
  }
