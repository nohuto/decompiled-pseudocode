/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesMeasures @ 0x1C00703CC
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v103 = v11;
      v104 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v11, (unsigned __int8 *)dword_1C0084928, v12, v13, 0x24u, &v40);
    }
  }
}
