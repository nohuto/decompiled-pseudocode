/*
 * XREFs of StorpCSEntryTelemetry @ 0x1C006B4FC
 * Callers:
  ...
  if ( a1 )
  {
    ...
    *(_QWORD *)(a1 + 5272) = 0LL;
    if ( v5 )
    {
      ...
      if ( (unsigned int)dword_1C00920C8 > 5 && tlgKeywordOn(v5, 0x400000000000LL) )
      {
        v55 = 16LL;
        v54 = a1 + 5000;
        v24 = *(_DWORD *)(a1 + 56);
        ...
        v27 = v6;
        v59 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v9, (unsigned __int8 *)dword_1C0086B46, v10, v11, 5u, &v53);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        ...
        if ( (unsigned int)dword_1C00920C8 > 5 )
        {
          if ( tlgKeywordOn(v14, 0x400000000000LL) )
          {
            ...
            v50 = 8LL;
            v52 = 4LL;
            tlgWriteTransfer_EtwWriteTransfer(v15, (unsigned __int8 *)dword_1C0086168, v16, v17, 0xDu, &v30);
          }
        }
