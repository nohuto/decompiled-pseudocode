/*
 * XREFs of RaidAdapterDevicePowerstopAdapter @ 0x1C0011048
 * Callers:
 ...
 *     RaidAdapterClearCryptoKeyTable @ 0x1C0034660 (RaidAdapterClearCryptoKeyTable.c)
...
NTSTATUS __fastcall RaidAdapterDevicePowerstopAdapter(PIRP Irp, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_bfabe38cf0023b35987f16eff51d2245_Traceguids, a2, Irp);
  }
  RaidAdapterStop(a2);
