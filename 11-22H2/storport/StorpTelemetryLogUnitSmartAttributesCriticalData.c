/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesCriticalData @ 0x1C006FF8C
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesCriticalData(__int64 a1)
{
  __int64 v1; // rcx
  __int64 v2; // rdx
  __int64 v3; // r11
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v50 = 1LL;
      v52 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v53, *(_WORD **)(v2 + 4656));
      tlgCreate1Sz_char((__int64)v54, (_BYTE *)(v3 + 160));
      tlgCreate1Sz_char((__int64)v55, (_BYTE *)(v4 + 169));
      tlgCreate1Sz_char((__int64)v56, (_BYTE *)(v5 + 186));
      v57 = &v27;
      v7 = (*(_DWORD *)(v6 + 2040) & 0x20) != 0;
      ...
      v103 = v11;
      v104 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v11, (unsigned __int8 *)dword_1C0086401, v12, v13, 0x24u, &v40);
    }
  }
}
