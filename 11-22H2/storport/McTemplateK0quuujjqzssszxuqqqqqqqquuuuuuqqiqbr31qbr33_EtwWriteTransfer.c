/*
 * XREFs of McTemplateK0quuujjqzssszxuqqqqqqqquuuuuuqqiqbr31qbr33_EtwWriteTransfer @ 0x1C001A738
 * Callers:
        ...
        __int64 a38)
{
  ...
  int v135; // [rsp+2E0h] [rbp+1D8h] BYREF
  ...
  v131 = 4LL;
  v134 = 0;
  return McGenEventWrite_EtwWriteTransfer(v39, &EventUnitErrorDataSummary, 0LL, 0x24u, &v57);
}
