/*
 * XREFs of RaidUpdateUnitIdentityWorkRoutine @ 0x1C0063260
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall RaidUpdateUnitIdentityWorkRoutine(PDEVICE_OBJECT DeviceObject, PIO_WORKITEM *Context)
{
  ...
  v4 = 0;
  if ( !_InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)DeviceExtension + 3) + 5696LL), 0, 0) )
  {
...
LABEL_14:
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)(*((_QWORD *)DeviceExtension + 3) + 5696LL), 0xFFFFFFFF) == 1 )
  {
