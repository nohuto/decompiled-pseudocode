/*
 * XREFs of StorpTelemetryGetStartStopCycleCounter @ 0x1C006E478
 * Callers:
 *     StorpTelemetrySendUnitScsiDiagnostics @ 0x1C0072334 (StorpTelemetrySendUnitScsiDiagnostics.c)
 * Callees:
 *     StringCchPrintfW @ 0x1C007341C (StringCchPrintfW.c)
 */

HRESULT __fastcall StorpTelemetryGetStartStopCycleCounter(__int64 a1, __int16 a2, __int64 a3)
{
  HRESULT result; // eax
