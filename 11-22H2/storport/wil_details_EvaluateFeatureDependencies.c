/*
 * XREFs of wil_details_EvaluateFeatureDependencies @ 0x1C009F174
 * Callers:
 *     wil_details_ReevaluateOnFeatureConfigurationChange @ 0x1C009F330 (wil_details_ReevaluateOnFeatureConfigurationChange.c)
 *     wil_InitializeFeatureStaging @ 0x1C00B4078 (wil_InitializeFeatureStaging.c)
 * Callees:
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x1C00228F8 (wil_details_FeatureDescriptors_SkipPadding.c)
 *     wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState @ 0x1C009F228 (wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState.c)
 */
