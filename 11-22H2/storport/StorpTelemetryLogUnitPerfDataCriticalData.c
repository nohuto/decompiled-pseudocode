/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C006F8D8
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v40 = 1LL;
      v42 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v43, *(_WORD **)(v2 + 4656));
      ...
      v73 = &v18;
      v11 = v9[46];
      v18 = 3 * qword_1C0092570;
      v75 = v11;
      v76 = 8 * (unsigned __int16)(3 * qword_1C0092570);
      tlgWriteTransfer_EtwWriteTransfer(
        (3 * qword_1C0092570) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_1C0086244,
        v12,
        v13,
        0x1Du,
        &v30);
