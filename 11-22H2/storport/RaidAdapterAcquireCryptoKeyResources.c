/*
 * XREFs of RaidAdapterAcquireCryptoKeyResources @ 0x1C00341B0
 * Callers:
 *     RaUnitStartIo @ 0x1C0008F30 (RaUnitStartIo.c)
 * Callees:
 *     RaidAllocatePool @ 0x1C0007B34 (RaidAllocatePool.c)
 *     RaidAdapterGetCryptoKeyIndex @ 0x1C0035A1C (RaidAdapterGetCryptoKeyIndex.c)
 */
...
__int64 __fastcall RaidAdapterAcquireCryptoKeyResources(__int64 a1, struct _SLIST_ENTRY *a2)
{
  ...
  *Next = 0LL;
    ...
    && *((_DWORD *)&v6->Next + 3) == *(_DWORD *)(v7 + 20 * v8 + 24) )
  {
    ...
    if ( CryptoKeyIndex != *(_DWORD *)(a1 + 5552) )
    {
      v25 = *(_QWORD *)(a1 + 5560) + ((unsigned __int64)CryptoKeyIndex << 6);
      v26 = *v29;
      v27 = *(_DWORD *)v25;
