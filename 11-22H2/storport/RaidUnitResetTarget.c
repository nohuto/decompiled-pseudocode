/*
 * XREFs of RaidUnitResetTarget @ 0x1C0062324
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C006B4A8 (StorpAggregateHierarchicalResetTarget.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C00920C8 > 5 )
      {
        ...
        v28 = v18;
        v42 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(8LL, (unsigned __int8 *)dword_1C008401A, v18, v19, 8u, &v30);
      }
