/*
 * XREFs of RaidUnitStorageTcgQueryCapability @ 0x1C005369C
 * Callers:
...
__int64 __fastcall RaidUnitStorageTcgQueryCapability(__int64 a1, IRP *a2)
{
  bool v2; // zf
  ...
  else if ( CurrentStackLocation->Parameters.Read.Length >= 0x34 )
  {
    ...
    else
    {
      ...
      TcgConfigInformation = RaidGetTcgConfigInformation(a1, MasterIrp, v19);
      ...
      *(_DWORD *)(a1 + 456) &= ~8u;
      ...
      {
        v17 = *(_DWORD *)(a1 + 96);
        RaidDriverGetName(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL), (__int64)&v18);
        v6 = v9;
        v11 = *(_QWORD *)(a1 + 24);
