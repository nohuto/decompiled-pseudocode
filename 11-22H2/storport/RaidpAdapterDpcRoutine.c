/*
 * XREFs of RaidpAdapterDpcRoutine @ 0x1C000F280
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  struct _GROUP_AFFINITY Affinity; // [rsp+90h] [rbp+1Fh] BYREF
  ...
  if ( DpcCompletionLimit )
  {
    do
    {
      ...
      *(_QWORD *)(v4 + 272) = *(_QWORD *)v10;
      if ( (*(_BYTE *)(v10 - 15) & 1) != 0 )
      {
        RaidAdapterPoFxIdleComponentFromMiniport(v4, *(unsigned int *)(v10 + 716));
        *(_BYTE *)(v10 - 15) &= ~1u;
      }
...
LABEL_58:
  ...
  else
  {
    ...
    v12 = v4 + 8;
    if ( !ExQueryDepthSList((PSLIST_HEADER)(v4 + 256)) && (unsigned int)StorGetOutstandingIoCount(v4, v13, v14) < 0xFFFF )
      goto LABEL_18;
  }
...
LABEL_18:
  ...
  if ( v7 > *(_DWORD *)(v4 + 4644) )
    *(_DWORD *)(v4 + 4644) = v7;
  if ( StorEtwLoggingEnabled && (byte_1C0092A03 & 4) != 0 && v7 >= 0x19 )
  {
