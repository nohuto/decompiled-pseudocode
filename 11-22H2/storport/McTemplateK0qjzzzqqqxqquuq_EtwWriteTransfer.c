/*
 * XREFs of McTemplateK0qjzzzqqqxqquuq_EtwWriteTransfer @ 0x1C00333D8
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzzzqqqxqquuq_EtwWriteTransfer(
        __int64 a1,
        ...
        char a17)
{
  ...
  v57 = 1LL;
  v59 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v18, a2, 0LL, 0xFu, &v29);
}
