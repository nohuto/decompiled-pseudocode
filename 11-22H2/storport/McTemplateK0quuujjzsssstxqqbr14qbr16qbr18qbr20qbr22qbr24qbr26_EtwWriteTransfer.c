/*
 * XREFs of McTemplateK0quuujjzsssstxqqbr14qbr16qbr18qbr20qbr22qbr24qbr26_EtwWriteTransfer @ 0x1C0069B38
 * Callers:
        ...
        __int64 a31)
{
  ...
  v113 = 4LL;
  v116 = 0;
  return McGenEventWrite_EtwWriteTransfer(v44, &EventUnitDeviceStatisticsLogs, 0LL, 0x1Du, &v48);
}
