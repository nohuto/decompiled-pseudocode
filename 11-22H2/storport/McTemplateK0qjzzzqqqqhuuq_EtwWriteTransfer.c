/*
 * XREFs of McTemplateK0qjzzzqqqqhuuq_EtwWriteTransfer @ 0x1C0032C44
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qjzzzqqqqhuuq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a16)
{
  ...
  int v56; // [rsp+150h] [rbp+48h] BYREF
  ...
  v53 = 1LL;
  v55 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v18, &EventReconfigureMFND, 0LL, 0xEu, &v27);
}
