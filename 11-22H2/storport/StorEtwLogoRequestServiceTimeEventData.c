/*
 * XREFs of StorEtwLogoRequestServiceTimeEventData @ 0x1C0067FFC
 * Callers:
...
LABEL_31:
  if ( *(_BYTE *)(v4 + 2) == 40 )
  {
    if ( !*(_DWORD *)(v4 + 20) )
    {
      QuadPart = GetSrbScsiData(v4, &v29, &v29, 0LL, 0LL, 0LL);
      v7 = v29;
      v8 = QuadPart;
    }
  ...
  if ( v10 )
  {
    if ( (byte_1C0092A03 & 2) != 0 )
      LODWORD(QuadPart) = McTemplateK0uuuuxqbr5uppxxx_EtwWriteTransfer(
                            *(_QWORD *)(a1 + 216),
