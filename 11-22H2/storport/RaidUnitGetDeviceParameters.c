/*
 * XREFs of RaidUnitGetDeviceParameters @ 0x1C00A30B8
 * Callers:
...
int __fastcall RaidUnitGetDeviceParameters(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 1868) = -1;
  *v4 = v8;
  LODWORD(Pool) = IoOpenDeviceRegistryKey(v9, 1u, 0x20019u, &DeviceRegKey);
  if ( (int)Pool >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( (int)Pool >= 0 )
    {
      ...
      if ( *v6 > 0x64u )
        *v6 = 25;
      if ( EnableRegistryWatch && !*(_QWORD *)(a1 + 3480) )
      {
