/*
 * XREFs of RaidAdapterPostScatterGatherExecute @ 0x1C0009EC0
 * Callers:
 ...
 *     RaidLogGetParm4 @ 0x1C000A5D0 (RaidLogGetParm4.c)
...
__int64 __fastcall RaidAdapterPostScatterGatherExecute(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 216) = a1;
  ...
  else if ( (unsigned __int8)StorIsIoGatewayPaused(*(_QWORD *)(a1 + 896))
...
LABEL_26:
    ...
    if ( v18 )
    {
      ...
      {
        v56 = 0;
        if ( (unsigned __int8)IsZonedWriteRequest(v18, 0LL, a2, &v56) )
        {
    ...
    *(_BYTE *)(a2 + 16) = *(_BYTE *)(a2 + 16) & 0xE3 | 0xC;
    ...
    v21 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(a1 + 568) + 16LL))(
            *(_QWORD *)(a1 + 576) + 16LL,
            *(_QWORD *)(a2 + 168));
    if ( StorEtwLoggingEnabled && ((byte_1C0092A01 & 1) != 0 || (byte_1C0092A03 & 2) != 0) )
    {
      if ( UseQPCTime )
    ...
    if ( (qword_1C0092468 & 4) != 0 && *(_DWORD *)(a1 + 4868) && *(_QWORD *)(a1 + 4872) )
    {
      v40 = *(_QWORD *)(a1 + 4872)
          + 48LL
...
LABEL_86:
  ...
  if ( v42 )
  {
    ...
    {
      v55 = 0;
      if ( (unsigned __int8)IsZonedWriteRequest(v42, 0LL, a2, &v55) )
      {
        RtlInterlockedClearBitRun(v42 + 3360, v55, 1LL);
        RaidUpdateZoneIoSubmission(v42 + 656, 0LL, a2);
      }
    }
  }
  return 0LL;
