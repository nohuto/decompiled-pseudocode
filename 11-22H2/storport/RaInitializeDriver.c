/*
 * XREFs of RaInitializeDriver @ 0x1C00A865C
 * Callers:
 *     StorPortInitialize @ 0x1C0042320 (StorPortInitialize.c)
 * Callees:
 *     McGenEventRegister_EtwRegister @ 0x1C003F548 (McGenEventRegister_EtwRegister.c)
 *     RaidAddPortDriver @ 0x1C0041914 (RaidAddPortDriver.c)
