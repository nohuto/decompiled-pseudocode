/*
 * XREFs of StorpMeasuresMiniportEventUnit @ 0x1C006D8A8
 * Callers:
...
char __fastcall StorpMeasuresMiniportEventUnit(__int64 a1, __int64 a2, __int64 a3, int *a4)
{
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 )
  {
    ...
    if ( (_BYTE)v4 )
    {
      ...
      v53 = v30;
      v116 = 8LL;
      LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v30, (unsigned __int8 *)dword_1C008426E, v31, v32, v34, v35, 0x27u, &v55);
    }
  }
  return v4;
}
