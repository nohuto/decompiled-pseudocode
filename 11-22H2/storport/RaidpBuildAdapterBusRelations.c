/*
 * XREFs of RaidpBuildAdapterBusRelations @ 0x1C00182F0
 * Callers:
 *     RaidAdapterQueryDeviceRelationsIrp @ 0x1C0015938 (RaidAdapterQueryDeviceRelationsIrp.c)
 * Callees:
 *     RaidAllocatePool @ 0x1C0007B34 (RaidAllocatePool.c)
 *     RaidUnitSetEnumerated @ 0x1C0018584 (RaidUnitSetEnumerated.c)
...
__int64 __fastcall RaidpBuildAdapterBusRelations(__int64 a1, _QWORD *a2)
{
  ...
  {
    WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 40LL, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids, a1);
  }
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(a1 + 144), &LockHandle);
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(a1 + 224), &v23);
  v3 = (unsigned int)(*(_DWORD *)(a1 + 168) + *(_DWORD *)(a1 + 248));
  Size = 8 * v3 + 16;
  v4 = 0;
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
  {
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 41LL, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids);
  }
  for ( i = *(_QWORD **)(a1 + 152); i != (_QWORD *)(a1 + 152); i = (_QWORD *)*i )
  {
    ...
    if ( (i[49] & 4) != 0 )
    {
      ...
      if ( v7 > (unsigned int)v3 )
      {
        ...
        if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
          WPP_SF_dd(WPP_GLOBAL_Control->AttachedDevice, 43LL, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids, v7, v3);
        break;
      }
      v11 = v7++;
    ...
    else
    {
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        v17 = 42LL;
LABEL_36:
        WPP_SF_q(v12->AttachedDevice, v17, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids, i - 7);
        continue;
      }
    }
  }
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
  {
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 45LL, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids);
  }
LABEL_15:
  v13 = *(_QWORD **)(a1 + 232);
  while ( 2 )
  {
    if ( v13 != (_QWORD *)(a1 + 232) )
    {
      ...
      WPP_SF_q(v20->AttachedDevice, v21, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids, v13 - 7);
LABEL_54:
      v13 = (_QWORD *)*v13;
      continue;
    }
  ...
  *a2 = Pool;
  ...
  v15 = (void *)RaidAllocatePool(64LL, Size, 1380213074LL, *(_QWORD *)(a1 + 8));
  *(_QWORD *)(a1 + 4312) = v15;
  if ( v15 )
  {
  ...
  {
    WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 49LL, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids, a1);
  }
LABEL_21:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
  {
    WPP_SF_qD(WPP_GLOBAL_Control->AttachedDevice, 50LL, &WPP_5f9124ff5a9e349f71738e58a6eba805_Traceguids, a1, v4);
  }
  return v4;
}
