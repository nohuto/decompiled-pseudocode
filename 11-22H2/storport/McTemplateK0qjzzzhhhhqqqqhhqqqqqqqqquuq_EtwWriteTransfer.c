/*
 * XREFs of McTemplateK0qjzzzhhhhqqqqhhqqqqqqqqquuq_EtwWriteTransfer @ 0x1C0075298
 * Callers:
        ...
        char a30)
{
  ...
  v95 = 1LL;
  v97 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((__int64)v32, &EventMFNDQueryChildPFSettings, 0LL, 0x1Cu, &v41);
}
