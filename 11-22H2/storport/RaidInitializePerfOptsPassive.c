/*
 * XREFs of RaidInitializePerfOptsPassive @ 0x1C003BF08
 * Callers:
...
__int64 __fastcall RaidInitializePerfOptsPassive(__int64 a1)
{
  ...
  struct _SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX v148; // [rsp+D0h] [rbp-30h] BYREF
  ...
  *(_DWORD *)(a1 + 4600) = 1;
  if ( v3 > 1 && (*(char *)(a1 + 110) >= 0 || !*(_QWORD *)(a1 + 4608)) )
  {
    ...
    RaidAdapterAcquireStartIoLock(v4, &v146);
    *(_DWORD *)(v4 + 4600) = v3;
    RaidAdapterReleaseStartIoLock(v4, &v146);
    LOWORD(v2) = 0;
    v5 = ProcessorNumber;
  }
  if ( (v1 & 1) == 0 )
...
LABEL_8:
  ...
  v152 = v25;
  v27 = 0;
  v28 = (_WORD *)RaidAllocatePool(66LL, v25, 1917083986LL, *(_QWORD *)(v4 + 8));
  if ( !v28 )
  {
LABEL_50:
    v5 = (struct _PROCESSOR_NUMBER)-1073741670;
  ...
  if ( (((_BYTE)v24 + 4) & 1) == 0 )
    v31 = v24 + 4;
  v139 = v31;
  v32 = (char *)RaidAllocatePool(64LL, v31 * v29, 1917083986LL, v30);
  v137 = v32;
  if ( !v32 )
  {
...
LABEL_61:
  ...
  if ( !g_HeterogenousCPU || (*(_BYTE *)(v4 + 4307) & 0x10) == 0 )
  {
    v90 = 0;
...
LABEL_184:
  ...
  if ( g_MaximumProcessorCount )
    v40 = g_MaximumProcessorCount;
  v158 = 0;
  v42 = v40;
  v135 = 0;
  v153 = 0;
  v150 = 0;
  v136 = RaidAllocatePool(64LL, 56LL * v40, 1917083986LL, v39);
  v43 = (void *)v136;
  if ( !v136 )
    return (unsigned int)-1073741670;
  v44 = (char *)RaidAllocatePool(64LL, 2 * v40, 1917083986LL, *(_QWORD *)(v4 + 8));
  LODWORD(v45) = 0;
  P = v44;
  v46 = v44;
  if ( v44 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( ProcessorNumberFromIndex < 0
        || (v51 = KeQueryLogicalProcessorRelationship(&ProcessorNumber, RelationProcessorModule, &Information, &Length),
            LODWORD(v45) = 0,
            v51 < 0) )
      {
        v56 = v136;
      ...
      v52 = 0;
      v53 = 0;
      v54 = KeQueryLogicalProcessorRelationship(&ProcessorNumber, RelationProcessorCore, &v148, &Length);
      LODWORD(v45) = 0;
      EfficiencyClass = 0;
      if ( v54 >= 0 )
        EfficiencyClass = v148.Processor.EfficiencyClass;
      LODWORD(v142) = EfficiencyClass;
      if ( (_DWORD)v41 )
      {
        v56 = v136;
        ...
        do
        {
          if ( *(_WORD *)(v57 + 8) == Information.Processor.GroupMask[0].Group
            && *(_QWORD *)v57 == Information.Processor.GroupMask[0].Mask )
          {
            v49 = v145;
          }
          v57 += 56LL;
      ...
      *(_BYTE *)(v59 + v136 + 33) = -1;
      v60 = Information.Processor.GroupMask[0].Mask;
...
LABEL_90:
      ...
      v60 &= ~(1LL << v52);
      if ( *(_BYTE *)(v52 + (Information.Processor.GroupMask[0].Group << 6) + *(_QWORD *)(v4 + 4616)) == 0xFF )
      {
        if ( !v53 )
        {
          v53 = 1;
          if ( *(_BYTE *)(v59 + v58 + 33) == 0xFF )
            *(_BYTE *)(v59 + v58 + 33) = EfficiencyClass;
        }
      }
      else
      {
        ...
        {
          *(_BYTE *)(v59 + v63 + v58) = *(_BYTE *)(v52
                                                 + (Information.Processor.GroupMask[0].Group << 6)
                                                 + *(_QWORD *)(v4 + 4616));
          ++*(_BYTE *)(v59 + v58 + 32);
          v64 = *(_BYTE *)(v52 + (Information.Processor.GroupMask[0].Group << 6) + *(_QWORD *)(v4 + 4616));
      ...
      while ( 2 )
      {
        ...
        v74 = *(_QWORD *)(v4 + 4616);
        v67 &= ~(1LL << v70);
        v75 = v70 + (Information.Processor.GroupMask[0].Group << 6);
...
LABEL_135:
      ...
      v56 = v136;
      *(_WORD *)(v59 + v58 + 48) = Information.Processor.GroupMask[0].Group;
      *(_QWORD *)(v59 + v58 + 40) = Information.Processor.GroupMask[0].Mask;
      v158 = v41;
LABEL_136:
      v48 = 1;
LABEL_137:
