/*
 * XREFs of McTemplateK0qqqqquuujjzssszshzhbr18hbr20q_EtwWriteTransfer @ 0x1C00440AC
 * Callers:
        ...
        char a26)
{
  ...
  int v106; // [rsp+218h] [rbp+118h] BYREF
  ...
  v103 = 0;
  v105 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v31, a2, 0LL, 0x18u, &v50);
}
