/*
 * XREFs of RaidAdapterCheckWaitTimeout @ 0x1C001F1FC
 * Callers:
 *     RaidQueueWaitCheckDpcRoutine @ 0x1C001F1D0 (RaidQueueWaitCheckDpcRoutine.c)
 * Callees:
 ...
 *     StorGetPendingIoCount @ 0x1C001F3C4 (StorGetPendingIoCount.c)
...
void __fastcall RaidAdapterCheckWaitTimeout(__int64 a1)
{
  ...
  unsigned int v4; // esi
  char v5; // r13
  unsigned int PendingIoCount; // r12d
  __int64 *v7; // rax
  __int64 v8; // rdi
...
LABEL_90:
  ...
  if ( v5 && PendingIoCount > *((_DWORD *)v3 + 1321) )
    *((_DWORD *)v3 + 1321) = PendingIoCount;
LABEL_2:
  while ( 1 )
  {
    v7 = v62;
