/*
 * XREFs of RaidAdapterSetMaxOperationalPower @ 0x1C004BF18
 * Callers:
 ...
 *     RaidAdapterPassiveCoolingCallback @ 0x1C004BA30 (RaidAdapterPassiveCoolingCallback.c)
 * Callees:
 ...
 *     RaidAdapterEffectiveMaxOperationalPower @ 0x1C004B9FC (RaidAdapterEffectiveMaxOperationalPower.c)
 */
...
LABEL_11:
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 )
  {
    if ( tlgKeywordOn(v14, 0x400000000000LL) )
    {
      ...
      v31 = v19;
      v59 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer(v17, (unsigned __int8 *)dword_1C0083BD0, v18, v19, 0xEu, &v35);
    }
  }
