/*
 * XREFs of StorPortNotification @ 0x1C000E120
 * Callers:
...
void StorPortNotification(unsigned int a1, _QWORD *a2, ...)
{
  ...
  PKDEFERRED_ROUTINE v71; // [rsp+70h] [rbp-58h]
  ...
  if ( !DisableExtensionDriver )
  {
    if ( EnableExtensionCalls )
    {
      ...
      v6 = ((__int64 (__fastcall *)(int *, _QWORD, __int64))ExtNotificationReplace)(&dword_1C0092038, a1, v4);
  ...
  if ( v6 == -1073741822 )
  {
    ...
    if ( !DisableExtensionDriver )
    {
      ...
      {
        _InterlockedIncrement(&ExtRefCount);
        ((void (__fastcall *)(int *, _QWORD, __int64))ExtNotificationPre)(&dword_1C0092038, a1, v4);
        _InterlockedDecrement(&ExtRefCount);
      }
      v2 = DeferredContext;
    }
    ...
    switch ( a1 )
    {
      case 0u:
        if ( v4 && v75 )
        {
          ...
          if ( v10 )
            RaidAdapterRequestComplete(v4, v10, 0LL);
        }
        break;
      case 0x1004u:
        v11 = (__int64 *)*(v2 - 2);
...
LABEL_48:
          ...
          RaidAdapterReleaseInterruptLock(v12, (KIRQL)v75->DpcListEntry.Next);
        break;
      case 0x1002u:
        v13 = v79;
        if ( v75 )
          *v13 = KeInsertQueueDpc(v75, (PVOID)v77, v78);
        break;
      case 0x1006u:
        if ( StorEtwLoggingEnabled )
        {
          ...
          if ( v77 )
          {
            v8 = *(_BYTE *)(v77 + 2) == 40 ? *(_QWORD *)(v77 + 96) : *(_QWORD *)(v77 + 48);
            if ( v8 )
            {
              if ( (byte_1C0092A01 & 1) != 0 || (byte_1C0092A03 & 2) != 0 )
                *(_QWORD *)(v8 + 720) = v75;
              if ( (byte_1C0092A01 & 1) != 0 )
              {
                LOBYTE(a2) = 1;
                StorEtwIORequestServiceTimeEventData(v8, a2, v7);
              }
              v9 = *(_QWORD *)(v8 + 224);
              if ( v9 && *(_DWORD *)(v9 + 1860) && (byte_1C0092A03 & 2) != 0 )
              {
                LOBYTE(a2) = 1;
                StorEtwLogoRequestServiceTimeEventData(v8, a2, v7);
              }
            }
          }
        }
      ...
      default:
        if ( (int)a1 <= 4096 )
        {
          if ( a1 == 4096 )
          {
            v41 = (PKDEFERRED_ROUTINE)v77;
            *(_DWORD *)v41 = (unsigned __int8)StorEnablePassiveInitialization(v2, v75);
          }
          else
          {
            switch ( a1 )
            {
              ...
              case 6u:
                ...
                if ( v4 )
                {
                  ...
                  {
                    RaidAdapterRequestTimerDeferred(v4, v27, (unsigned int)v28);
                  }
                  else
                  {
                  ...
                  if ( v75->TargetInfoAsUlong <= 0x80 )
                  {
                    if ( v4 )
                    {
                      ...
                      if ( v40 )
                      {
                        ...
                        RaidQueueDeferredItem((PVOID)(v4 + 1328));
                      }
                    }
                  }
                }
              ...
              case 0xAu:
                if ( v4 )
                  RaidpLinkUp(v4, a2, v2);
                break;
              case 0xBu:
                if ( v4 )
                  RaidpLinkDown(v4, a2, v2);
                break;
              case 0xCu:
              ...
              case 0xEu:
                RaidHandleTraceNotifyType(0x1C0000000uLL, (unsigned int)v75, v77);
                break;
              case 0xFu:
                StorpGetExtendedTable(v2, v75);
                break;
              default:
                goto LABEL_37;
            }
...
LABEL_56:
              if ( v78 )
              {
                *v78 = (_DWORD)v75;
                ...
                if ( v19 )
                {
                  ...
                  {
                    *((_BYTE *)v18 + 8) = RaidAdapterAcquireInterruptLock(v15);
                  }
                }
                else if ( v17 )
                {
                  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)v17 + 8, (PKLOCK_QUEUE_HANDLE)(v18 + 2));
                }
              }
            }
            goto LABEL_37;
          case 0x1005u:
            if ( v4 )
            {
              ...
              v71 = (PKDEFERRED_ROUTINE)v79;
              v72 = v80;
              if ( v77 && *(_WORD *)v77 == 1 )
              {
                v55 = *(_BYTE *)(v77 + 8);
                v56 = *(_BYTE *)(v77 + 9);
                v57 = *(unsigned __int8 *)(v77 + 10);
              }
              else
              {
                v55 = -1;
              ...
              if ( v49
                && *(_WORD *)v49 == 1
                && v55 <= *(_BYTE *)(v4 + 416)
                && ((v53 & 3) == 0 || v56 <= *(_BYTE *)(v4 + 441))
                && ((v53 & 1) == 0 || (unsigned __int8)v57 <= *(_BYTE *)(v4 + 490))
                && (v53 & 7) != 0 )
              {
          ...
          case 0x1007u:
            v59 = v78;
            v71 = (PKDEFERRED_ROUTINE)v77;
            v69 = 0;
            if ( v4 && v75 && LOWORD(v75->TargetInfoAsUlong) == 1 && (v77 & 0xFFFFFFFFFFFFFFF8uLL) == 0 )
            {
              LOWORD(v69) = v75->DpcListEntry.Next;
              BYTE2(v69) = BYTE2(v75->DpcListEntry.Next);
              v60 = v69;
              Unit = RaidAdapterFindUnit(v4, v69);
              v62 = Unit;
              if ( !Unit || (*(_DWORD *)(Unit + 1872) & 4) == 0 )
              {
                *v59 = -1056964601;
                goto LABEL_37;
              }
              if ( _InterlockedCompareExchange((volatile signed __int32 *)(Unit + 1928), 1, 0) == 1 )
              {
                *v59 = -1056964596;
                goto LABEL_37;
              }
              if ( KeGetCurrentIrql() > 2u )
              {
                v64 = StorAsyncNotificationDeferred(v4, v62, v69, v71);
                v63 = -1056964596;
                if ( v64 )
                  v63 = 0;
              }
              ...
              {
                *(_QWORD *)(v62 + 1920) = v71;
                v63 = RaidUnitProcessAsyncNotification(v4, v60, v62 + 1912);
              }
            }
            else
            {
          ...
          case 0x1008u:
            if ( v4 && v75 )
            {
              ...
              if ( v42 )
                RaidAdapterRequestDirectComplete(v4, v42, v2);
            }
            goto LABEL_37;
          case 0x1009u:
            v44 = v75;
          ...
          case 0x100Bu:
            if ( v75 && v77 )
              KeSetTargetProcessorDpcEx(v75, (PPROCESSOR_NUMBER)v77);
            goto LABEL_37;
          case 0x100Cu:
            if ( v4 && v78 )
              StorpMarkDeviceFailed(v4, (_DWORD)v75, v77, 0xFFFF, (__int64)v78, 0, 0LL, 0, 0LL);
            goto LABEL_37;
          case 0x100Du:
            v54 = v84;
            if ( v4 && (_WORD)v78 && v79 )
...
LABEL_37:
    ...
    if ( !DisableExtensionDriver )
    {
      ...
      {
        _InterlockedIncrement(&ExtRefCount);
        ((void (__fastcall *)(int *, _QWORD, __int64))ExtNotificationPost)(&dword_1C0092038, a1, v4);
        _InterlockedDecrement(&ExtRefCount);
      }
    }
  }
