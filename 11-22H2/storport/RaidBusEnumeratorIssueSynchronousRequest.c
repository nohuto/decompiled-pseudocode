/*
 * XREFs of RaidBusEnumeratorIssueSynchronousRequest @ 0x1C00170B0
 * Callers:
 ...
 *     RaidBuildScsiIrp @ 0x1C00175B8 (RaidBuildScsiIrp.c)
...
LABEL_7:
    ...
    if ( *((_BYTE *)a4 + 2) == 40 )
    {
      GetSrbScsiData((_DWORD)a4, 0, 0, 0, (__int64)&v61, (__int64)&a5);
      v48 = a5;
      v49 = v61;
    }
    else
