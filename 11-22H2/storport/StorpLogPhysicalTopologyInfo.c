/*
 * XREFs of StorpLogPhysicalTopologyInfo @ 0x1C006CDD8
 * Callers:
...
char __fastcall StorpLogPhysicalTopologyInfo(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 && tlgKeywordOn(v8, 0x400000000000LL) )
  {
    v55 = 16LL;
    v54 = a1 + 5000;
    ...
    v48 = v7;
    v62 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(v12, (unsigned __int8 *)dword_1C0085821, v13, v14, 7u, &v53);
  }
                ...
                if ( (unsigned int)dword_1C00920C8 > 5 )
                {
                  ...
                  if ( (_BYTE)v16 )
                  {
                    ...
                    LOBYTE(v16) = tlgWriteTransfer_EtwWriteTransfer(
                                    (__int64)v81,
                                    (unsigned __int8 *)dword_1C008589D,
                                    v26,
                                    v27,
                                    0xBu,
                                    &v53);
                    ...
                    *(_OWORD *)v81 = v38;
                    if ( (unsigned int)dword_1C00920C8 > 5 )
                    {
                      ...
                      if ( (_BYTE)v16 )
                      {
                        ...
                        LOBYTE(v16) = tlgWriteTransfer_EtwWriteTransfer(
                                        (__int64)v81,
                                        (unsigned __int8 *)dword_1C00846A2,
                                        -1LL,
                                        v39,
                                        0xEu,
                                        &v53);
