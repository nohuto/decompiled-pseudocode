/*
 * XREFs of RaUnitStorageQueryDevicePhysicalTopologyPropertyIoctl @ 0x1C005FEC8
 * Callers:
...
LABEL_7:
  ...
  v8 = RaBuildQueryPhysicalTopologyBufferForMiniport(*(_QWORD *)(a1 + 8), (__int64)a2, (__int64 *)&P, &v13);
  v9 = P;
  v7 = v8;
  if ( v8 >= 0 )
  {
