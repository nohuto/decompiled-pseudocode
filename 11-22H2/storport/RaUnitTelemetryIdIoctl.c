/*
 * XREFs of RaUnitTelemetryIdIoctl @ 0x1C001C918
 * Callers:
...
LABEL_13:
  ...
  *(_OWORD *)&MasterIrp->AssociatedIrp.MasterIrp = *(_OWORD *)(*(_QWORD *)(a1 + 24) + 5000LL);
  ...
  if ( (unsigned int)dword_1C00920C8 > 5 && tlgKeywordOn(Length, 0x400000000000LL) )
  {
    v10 = *(_QWORD *)(v8 + 24);
    v19 = 16LL;
    v20 = v9;
    ...
    v27 = 1LL;
    v29 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v10, (unsigned __int8 *)dword_1C0083FBB, v7, v8, 8u, &v17);
  }
  v11 = 0;
  return RaidCompleteRequestEx(a2, 0, v11);
}
