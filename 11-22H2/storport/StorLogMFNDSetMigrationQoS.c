/*
 * XREFs of StorLogMFNDSetMigrationQoS @ 0x1C007767C
 * Callers:
...
void __fastcall StorLogMFNDSetMigrationQoS(__int64 a1, __int64 a2, unsigned __int16 a3, char a4)
{
  __int128 v7; // xmm1
