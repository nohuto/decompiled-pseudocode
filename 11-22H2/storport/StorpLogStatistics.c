/*
 * XREFs of StorpLogStatistics @ 0x1C001B410
 * Callers:
...
__int64 __fastcall StorpLogStatistics(unsigned __int16 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)&v14.OldIrql = 0LL;
  ...
  v17 = v5;
  result = RaidGetPortData(508LL, a2, a3, a4, 0LL, 0LL, 0LL, 0LL, 0LL);
  v19 = result;
  v7 = result;
  if ( result )
  {
        ...
        if ( v11 != v8 + 4 )
        {
          do
          {
            if ( (int)RaidAcquireAdapterRemoveLock((__int64)(v11 - 8)) >= 0 )
            {
              ...
              if ( v16 )
              {
                KeAcquireInStackQueuedSpinLock(v11 + 10, &v13);
                for ( i = (__int64 *)v11[11]; i != (__int64 *)(v11 + 11); i = (__int64 *)*i )
