...
unsigned __int8 __fastcall FxIoTarget::RemoveCompletedRequestLocked(
        ...
        unsigned __int8 a3)
{
  $5B321031ED1DF2C6629E92B8FF97B135 *v5; // rax
  ...
  if ( ($5B321031ED1DF2C6629E92B8FF97B135 *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($5B321031ED1DF2C6629E92B8FF97B135 **)&Irp->Type != v5) )
  {
    __fastfail(3u);
  }
