/*
 * XREFs of imp_WdfIoTargetStop @ 0x1C0051E50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall imp_WdfIoTargetStop(_WDF_DRIVER_GLOBALS *DriverGlobals, WDFIOTARGET__ *IoTarget, unsigned int Action)
{
  FxIoTarget *v4; // rcx
