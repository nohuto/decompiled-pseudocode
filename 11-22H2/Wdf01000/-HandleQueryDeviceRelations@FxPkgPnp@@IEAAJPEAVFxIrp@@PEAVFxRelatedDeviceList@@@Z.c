/*
 * XREFs of ?HandleQueryDeviceRelations@FxPkgPnp@@IEAAJPEAVFxIrp@@PEAVFxRelatedDeviceList@@@Z @ 0x1C0072A98
 * Callers:
 ...
 *     ?_ComputeRelationsSize@FxChildList@@SA_KK@Z @ 0x1C00267F0 (-_ComputeRelationsSize@FxChildList@@SA_KK@Z.c)
