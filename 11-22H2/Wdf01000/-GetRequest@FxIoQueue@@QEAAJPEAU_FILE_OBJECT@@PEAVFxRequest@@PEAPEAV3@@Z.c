        ...
        FxRequest **pOutRequest)
{
  ...
  $5B321031ED1DF2C6629E92B8FF97B135 *v15; // rbx
  _LIST_ENTRY *v16; // rax
  $5B321031ED1DF2C6629E92B8FF97B135 *v17; // rbx
  _LIST_ENTRY *v18; // rax
...
LABEL_32:
      ...
      v15 = ($5B321031ED1DF2C6629E92B8FF97B135 *)i->Tail.Overlay.DriverContext[3];
...
LABEL_33:
    ...
    ((void (__fastcall *)($5B321031ED1DF2C6629E92B8FF97B135 *, __int64, __int64, const char *))v18)(
      v17,
      1969583441LL,
      2102LL,
    ...
    v37 = 1123LL;
LABEL_75:
    ((void (__fastcall *)($5B321031ED1DF2C6629E92B8FF97B135 *, __int64, __int64, const char *))v17->m_ListEntry.Flink[1].Flink)(
      v17,
      1886220099LL,
      v37,
...
LABEL_86:
  ...
  *((_BYTE *)&v17[14].m_ListEntry + 16) = 1;
  ((void (__fastcall *)($5B321031ED1DF2C6629E92B8FF97B135 *, __int64, __int64, const char *))v26[1].Flink)(
    v17,
    1952543827LL,
    1193LL,
    "minkernel\\wdf\\framework\\shared\\irphandlers\\io\\fxioqueue.cpp");
