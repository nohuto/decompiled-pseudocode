/*
 * XREFs of ?ProcessPowerEvents@FxIoQueue@@AEAAEPEAE@Z @ 0x1C0064D34
 * Callers:
...
LABEL_49:
    ...
    {
      while ( ($5B321031ED1DF2C6629E92B8FF97B135 *)v37[-1].m_IoPkgListNode.m_ListEntry.Blink != &v21->120 )
      {
...
LABEL_24:
          ...
          {
            while ( ($5B321031ED1DF2C6629E92B8FF97B135 *)v22[-1].m_IoPkgListNode.m_ListEntry.Blink != &v21->120 )
            {
