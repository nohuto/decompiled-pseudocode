/*
 * XREFs of imp_WdfDmaEnablerGetFragmentLength @ 0x1C0018A50
 * Callers:
 *     <none>
 * Callees:
        ...
        int DmaDirection)
{
  ...
  $8A16CB8F4E482DBDF28A1521795E3D75 *v7; // rbx
  ...
  if ( DmaDirection == 1 )
  {
    v7 = ($8A16CB8F4E482DBDF28A1521795E3D75 *)&pDmaEnabler->m_DuplexAdapterInfo[1];
