/*
 * XREFs of __scrt_initialize_crt @ 0x180001FB8
 * Callers:
 *     dllmain_crt_process_attach @ 0x180002C18 (dllmain_crt_process_attach.c)
 * Callees:
 *     __isa_available_init @ 0x180002204 (__isa_available_init.c)
 *     __scrt_stub_for_acrt_thread_attach @ 0x18000335C (__scrt_stub_for_acrt_thread_attach.c)
 *     __scrt_stub_for_acrt_uninitialize_critical @ 0x180003368 (__scrt_stub_for_acrt_uninitialize_critical.c)
 */
