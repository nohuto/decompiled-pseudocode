/*
 * XREFs of ?ReportAggregatedValues@_unnamed_type_gDwmInitTelemetryAggregator_@@QEAAXXZ @ 0x180007948
 * Callers:
        ...
        _unnamed_type_gDwmInitTelemetryAggregator_ *this)
{
  ...
  if ( (gDwmInitTelemetryAggregator
     || (_DWORD)qword_180015B94
     || __PAIR64__(HIDWORD(qword_180015B94), 0) != (unsigned int)qword_180015B9C)
    && (unsigned int)dword_180015000 > 5
    && (qword_180015010 & 0x400000000000LL) != 0
    && (qword_180015018 & 0x400000000000LL) == qword_180015018 )
  {
    v1 = qword_180015B9C;
    v19 = &gDwmInitTargetAppSessionGuid;
    v2 = HIDWORD(qword_180015B94);
    v17 = &v1;
    v3 = qword_180015B94;
    v15 = &v2;
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_18001131B,
      0LL,
      0LL,
      9u,
      &v6);
