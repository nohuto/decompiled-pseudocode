/*
 * XREFs of ?Set@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEBUFailureInfo@3@I@Z @ 0x180005BCC
 * Callers:
 *     ?SetLastError@ThreadLocalData@details_abi@wil@@QEAAXAEBUFailureInfo@3@@Z @ 0x180005E3C (-SetLastError@ThreadLocalData@details_abi@wil@@QEAAXAEBUFailureInfo@3@@Z.c)
 * Callees:
        ...
        int a3)
{
  ...
  *((_QWORD *)this + 7) = 0LL;
  ...
  v18 = v10 + v16 + v13;
  v19 = (rsize_t *)((char *)this + 72);
  if ( !*((_QWORD *)this + 8) || *v19 < v18 )
  {
    v33 = wil::details::ProcessHeapAlloc(8u, v10 + v16 + v13);
    if ( v33 )
    {
