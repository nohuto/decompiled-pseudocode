/*
 * XREFs of ??$ReportFailure_NoReturn@$02@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x180003694
 * Callers:
 ...
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x1800057C0 (-RecordFailFast@details@wil@@YAHJ@Z.c)
