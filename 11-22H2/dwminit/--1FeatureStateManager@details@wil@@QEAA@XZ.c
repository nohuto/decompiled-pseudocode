/*
 * XREFs of ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x18000B3F0
 * Callers:
...
void __fastcall wil::details::FeatureStateManager::~FeatureStateManager(wil::details::FeatureStateManager *this)
{
  ...
  *((_QWORD *)this + 32) = 0LL;
  ...
  if ( v4 && qword_180015098 )
    wil::details_abi::SubscriptionList::Unsubscribe((LPCRITICAL_SECTION)&qword_180015098[25], qword_180015098, v4);
