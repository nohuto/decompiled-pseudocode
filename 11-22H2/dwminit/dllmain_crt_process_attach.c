 ...
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800031FC (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180003224 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180003248 (__scrt_get_dyn_tls_init_callback.c)
