/*
 * XREFs of ?DwmpCreateSessionProcessWorker@@YAKPEAX@Z @ 0x180006AE0
 * Callers:
...
LABEL_34:
  ...
  if ( v3 < 0 )
  {
    LODWORD(qword_180015B9C) = qword_180015B9C + 1;
    ++HIDWORD(qword_180015B9C);
    if ( SHIDWORD(qword_180015B9C) > 10 )
    {
      _unnamed_type_gDwmInitTelemetryAggregator_::ReportAggregatedValues(v9);
      HIDWORD(qword_180015B9C) = 0;
    }
