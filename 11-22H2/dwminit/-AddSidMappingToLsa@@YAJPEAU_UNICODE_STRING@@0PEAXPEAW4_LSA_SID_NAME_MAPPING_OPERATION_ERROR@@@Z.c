/*
 * XREFs of ?AddSidMappingToLsa@@YAJPEAU_UNICODE_STRING@@0PEAXPEAW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z @ 0x180006694
 * Callers:
 *     ?MapDwmVirtualAccountAndAdjustPrivileges@@YAJXZ @ 0x180007628 (-MapDwmVirtualAccountAndAdjustPrivileges@@YAJXZ.c)
 * Callees:
 *     ?LsaCollisionResult@@YA_NW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z @ 0x180007614 (-LsaCollisionResult@@YA_NW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z.c)
        ...
        enum _LSA_SID_NAME_MAPPING_OPERATION_ERROR *a4)
{
  ...
  *(_QWORD *)&v12[32] = a3;
  ...
  {
    v5 = v7 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1800108A0, 3u, v7 | 0x10000000, 0x1DDu, v11);
  }
  v9 = Buffer;
  if ( Buffer )
  {
    v6 = *(_DWORD *)Buffer;
    if ( v5 < 0 && (unsigned __int8)LsaCollisionResult(v6) )
      v5 = 0;
