/*
 * XREFs of ?Run@CKstBase@@AEAAKXZ @ 0x18000A9D0
 * Callers:
 *     ?RunKernelThreadStatic@CKstBase@@CAKPEAX@Z @ 0x18000ABC0 (-RunKernelThreadStatic@CKstBase@@CAKPEAX@Z.c)
 * Callees:
  ...
  if ( (unsigned int)NtKSTInitialize(*((_QWORD *)this + 4), *((_QWORD *)this + 1)) )
  {
    while ( 1 )
    {
      ...
      if ( *(_DWORD *)v9 > 4u && (*((_BYTE *)v9 + 16) & 2) != 0 && (*((_QWORD *)v9 + 3) & 2LL) == *((_QWORD *)v9 + 3) )
        tlgWriteTransfer_EventWriteTransfer((__int64)v9, (unsigned __int8 *)dword_180011594, 0LL, 0LL, 2u, &v17);
      v11 = NtKSTWait();
