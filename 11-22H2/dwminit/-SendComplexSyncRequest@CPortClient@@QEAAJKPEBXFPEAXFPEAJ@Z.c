/*
 * XREFs of ?SendComplexSyncRequest@CPortClient@@QEAAJKPEBXFPEAXFPEAJ@Z @ 0x18000A080
 * Callers:
 ...
 *     ?CheckStatus@CPortClient@@AEAAJJ@Z @ 0x180009D6C (-CheckStatus@CPortClient@@AEAAJJ@Z.c)
 */
