/*
 * XREFs of ?ExitWait@DWM@KST@InputTraceLogging@@SAXK@Z @ 0x18000A424
 * Callers:
...
void __fastcall InputTraceLogging::KST::DWM::ExitWait(int a1)
{
  ...
  if ( *(_DWORD *)v2 > 4u && (*((_BYTE *)v2 + 16) & 2) != 0 && (*((_QWORD *)v2 + 3) & 2LL) == *((_QWORD *)v2 + 3) )
  {
    ...
    v3 = a1;
    v6 = 4;
    tlgWriteTransfer_EventWriteTransfer((__int64)v2, (unsigned __int8 *)dword_18001156A, 0LL, 0LL, 3u, &v4);
  }
}
