/*
 * XREFs of ??1?$ThreadLocalStorage@UThreadLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x180003DD8
 * Callers:
 ...
 * Callees:
 *     ??1ThreadLocalData@details_abi@wil@@QEAA@XZ @ 0x180003ED4 (--1ThreadLocalData@details_abi@wil@@QEAA@XZ.c)
 */
