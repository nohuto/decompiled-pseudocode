/*
 * XREFs of ?Stop@CKstBase@@QEAAXXZ @ 0x18000ACE0
 * Callers:
...
void __fastcall CKstBase::Stop(HANDLE *this)
{
  ...
  if ( *(_DWORD *)v2 > 4u && (*((_BYTE *)v2 + 16) & 2) != 0 && (*((_QWORD *)v2 + 3) & 2LL) == *((_QWORD *)v2 + 3) )
    tlgWriteTransfer_EventWriteTransfer((__int64)v2, (unsigned __int8 *)dword_180011545, 0LL, 0LL, 2u, &v7);
  v3 = this + 2;
