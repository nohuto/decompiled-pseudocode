/*
 * XREFs of ?SyncLock@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@I_N@Z @ 0x1801DE3B4
 * Callers:
...
__int64 __fastcall COverlayContext::SyncLock(COverlayContext *this, struct IOverlaySwapChain *a2, int a3, char a4)
{
  ...
  if ( *((_BYTE *)this + 11024) && *((_BYTE *)this + 11296) )
  {
    if ( a4 || COverlayContext::LegacyPresentRequired(this) )
    {
      ...
      v16 = v18;
      if ( v18 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x9F7u, 0LL);
      if ( (_QWORD)v21 )
    ...
    else
    {
      ...
      v16 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x9EEu, 0LL);
    }
  }
  else
  {
    v16 = -2003304309;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2003304309, 0x9FEu, 0LL);
  }
  return v16;
}
