/*
 * XREFs of ?RecordCachedUsageUnderLock@EnabledStateManager@details@wil@@AEAAXXZ @ 0x1801997D0
 * Callers:
 ...
 *     ?OnTimer@EnabledStateManager@details@wil@@QEAAXXZ @ 0x1801A7C90 (-OnTimer@EnabledStateManager@details@wil@@QEAAXXZ.c)
 * Callees:
