/*
 * XREFs of ?erase@?$_Hash@V?$_Umap_traits@PEBVCResource@@PEAVCWeakResourceReference@@V?$_Uhash_compare@PEBVCResource@@U?$hash@PEBVCResource@@@std@@U?$equal_to@PEBVCResource@@@3@@std@@V?$allocator@U?$pair@QEBVCResource@@PEAVCWeakResourceReference@@@std@@@4@$0A@@std@@@std@@QEAA_KAEBQEBVCResource@@@Z @ 0x1800251F8
 * Callers:
 *     ??1CWeakResourceReference@@MEAA@XZ @ 0x180099A50 (--1CWeakResourceReference@@MEAA@XZ.c)
        ...
        __int64 a2)
{
  ...
  if ( !v5 )
    return 0LL;
  v7 = qword_1803E62F8;
  v8 = 2 * (v6 & xmmword_1803E6310);
  if ( *(_QWORD **)(qword_1803E62F8 + 16 * (v6 & xmmword_1803E6310) + 8) == v5 )
  {
    if ( *(_QWORD **)(qword_1803E62F8 + 16 * (v6 & xmmword_1803E6310)) == v5 )
    {
      v9 = qword_1803E62E8;
      *(_QWORD *)(qword_1803E62F8 + 16 * (v6 & xmmword_1803E6310)) = qword_1803E62E8;
    }
    else
    {
      v9 = v5[1];
  ...
  else if ( *(_QWORD **)(qword_1803E62F8 + 16 * (v6 & xmmword_1803E6310)) == v5 )
  {
    *(_QWORD *)(qword_1803E62F8 + 16 * (v6 & xmmword_1803E6310)) = *v5;
  }
  v10 = *v5;
  --qword_1803E62F0;
  *(_QWORD *)v5[1] = v10;
