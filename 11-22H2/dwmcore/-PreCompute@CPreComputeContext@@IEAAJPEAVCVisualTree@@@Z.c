/*
 * XREFs of ?PreCompute@CPreComputeContext@@IEAAJPEAVCVisualTree@@@Z @ 0x1800C4FF8
 * Callers:
 ...
 *     ??0CVisualTreePath@@QEAA@PEBVCVisualTree@@@Z @ 0x1800A4944 (--0CVisualTreePath@@QEAA@PEBVCVisualTree@@@Z.c)
 ...
 *     ?UpdateWindowInputSinkHints@CPreComputeContext@@AEAAXXZ @ 0x1800C5828 (-UpdateWindowInputSinkHints@CPreComputeContext@@AEAAXXZ.c)
...
LABEL_46:
  ...
  *((_BYTE *)this + 1960) = 0;
  ...
  if ( dword_1803E3760 )
  {
    ...
    {
      v27 = DwmDbg::DbgString::DbgString(&v36, word_18033C020);
