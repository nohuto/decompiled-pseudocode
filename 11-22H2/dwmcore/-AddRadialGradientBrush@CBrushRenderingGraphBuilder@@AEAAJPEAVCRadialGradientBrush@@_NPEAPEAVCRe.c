/*
 * XREFs of ?AddRadialGradientBrush@CBrushRenderingGraphBuilder@@AEAAJPEAVCRadialGradientBrush@@_NPEAPEAVCRenderingTechniqueFragment@@@Z @ 0x18026E0EC
 * Callers:
        ...
        struct CRenderingTechniqueFragment **a4)
{
  ...
  else
  {
    ...
    {
      v11 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, -2147024882, 0x1B4u, 0LL);
    }
  }
  if ( v10 )
