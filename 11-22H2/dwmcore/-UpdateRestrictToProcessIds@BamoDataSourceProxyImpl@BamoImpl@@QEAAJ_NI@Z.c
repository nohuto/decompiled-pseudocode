/*
 * XREFs of ?UpdateRestrictToProcessIds@BamoDataSourceProxyImpl@BamoImpl@@QEAAJ_NI@Z @ 0x1801F8EE8
 * Callers:
 *     ?Thunk_UpdateRestrictToProcessIds_5@?$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801F8E80 (-Thunk_UpdateRestrictToProcessIds_5@-$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl.c)
