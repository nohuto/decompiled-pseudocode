/*
 * XREFs of ?DrawLetterboxingMarginsInternal@CCompositionSurfaceBitmap@@AEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBVCMILMatrix@@@Z @ 0x18000D558
 * Callers:
        ...
        const struct CMILMatrix *a4)
{
  ...
  if ( CCompositionSurfaceBitmap::GetScaledLetterboxingMargins(a1, (__int64)&v14) )
  {
    ...
    v15[2] = v10;
    v15[3] = v11;
    v12 = CCompositionSurfaceBitmap::DrawContentBorders(a2, v15, a3, &stru_1803864D0);
    v7 = v12;
    if ( v12 < 0 )
