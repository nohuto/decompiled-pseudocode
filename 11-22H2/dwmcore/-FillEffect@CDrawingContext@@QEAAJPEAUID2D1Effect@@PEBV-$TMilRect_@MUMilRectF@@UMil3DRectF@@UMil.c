        ...
        char a5)
{
  ...
  if ( a5 )
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x9E4u, 0LL);
      return v12;
    }
    v9 = 1;
  }
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x9EDu, 0LL);
  }
  else
  {
    ...
    v12 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x9F4u, 0LL);
  }
  if ( v9 )
