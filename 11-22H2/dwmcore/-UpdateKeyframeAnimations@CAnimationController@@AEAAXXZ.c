/*
 * XREFs of ?UpdateKeyframeAnimations@CAnimationController@@AEAAXXZ @ 0x1800D6544
 * Callers:
 *     ?OnPlaybackRateChanged@CAnimationController@@QEAAXXZ @ 0x180022ED8 (-OnPlaybackRateChanged@CAnimationController@@QEAAXXZ.c)
 *     ?NotifyBatchProcessingComplete@CAnimationController@@UEAAXXZ @ 0x1800D6440 (-NotifyBatchProcessingComplete@CAnimationController@@UEAAXXZ.c)
