/*
 * XREFs of ?CheckForIdle@CInteractionTracker@@AEAAXXZ @ 0x180231D44
 * Callers:
 ...
 *     ?HasActiveCustomAnimation@CInteractionTracker@@AEAA_NXZ @ 0x180132ADE (-HasActiveCustomAnimation@CInteractionTracker@@AEAA_NXZ.c)
 *     ?HasRunningDefaultPositionAnimation@CInteractionTracker@@QEBA_NXZ @ 0x180233020 (-HasRunningDefaultPositionAnimation@CInteractionTracker@@QEBA_NXZ.c)
 *     ?HasRunningDefaultScaleAnimation@CInteractionTracker@@QEBA_NXZ @ 0x180233040 (-HasRunningDefaultScaleAnimation@CInteractionTracker@@QEBA_NXZ.c)
 *     ?IsOutOfBounds@CInteractionTracker@@QEAA_NXZ @ 0x1802332DC (-IsOutOfBounds@CInteractionTracker@@QEAA_NXZ.c)
