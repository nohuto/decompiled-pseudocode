/*
 * XREFs of ?ResetBitmapCache@CRenderTargetBitmap@@IEAAXXZ @ 0x18003433C
 * Callers:
 ...
 *     ?SetProtected@CRenderTargetBitmap@@UEAAX_N@Z @ 0x1800F8D80 (-SetProtected@CRenderTargetBitmap@@UEAAX_N@Z.c)
