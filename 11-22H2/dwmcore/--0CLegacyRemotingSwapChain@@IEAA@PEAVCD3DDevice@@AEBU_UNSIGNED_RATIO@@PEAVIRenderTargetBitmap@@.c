/*
 * XREFs of ??0CLegacyRemotingSwapChain@@IEAA@PEAVCD3DDevice@@AEBU_UNSIGNED_RATIO@@PEAVIRenderTargetBitmap@@PEAXPEAUHINSTANCE__@@@Z @ 0x180109BF8
 * Callers:
 ...
 *     ??0ILegacyRemotingSwapChain@@QEAA@XZ @ 0x180109D6C (--0ILegacyRemotingSwapChain@@QEAA@XZ.c)
 */
