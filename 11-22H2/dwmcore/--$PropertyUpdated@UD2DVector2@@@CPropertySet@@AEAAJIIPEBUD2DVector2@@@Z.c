/*
 * XREFs of ??$PropertyUpdated@UD2DVector2@@@CPropertySet@@AEAAJIIPEBUD2DVector2@@@Z @ 0x18001E6D4
 * Callers:
...
__int64 __fastcall CPropertySet::PropertyUpdated<D2DVector2>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 v8; // rcx
  unsigned int v9; // ebx
