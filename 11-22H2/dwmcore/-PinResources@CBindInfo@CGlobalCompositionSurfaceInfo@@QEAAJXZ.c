/*
 * XREFs of ?PinResources@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJXZ @ 0x18025B6EC
 * Callers:
        ...
        CGlobalCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  {
    v1 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1803B8B20, 3u, -2003292412, 0x4A6u, 0LL);
    return v1;
  }
  v3 = (char *)this + 112;
  if ( ((*((_QWORD *)this + 15) - *((_QWORD *)this + 14)) & 0xFFFFFFFFFFFFFFF8uLL) == 0 )
  {
    ...
    if ( ExistingDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1803B8B20, 3u, ExistingDevice, 0x480u, 0LL);
    }
    else
    {
...
LABEL_10:
        ...
        if ( (_QWORD)v21 != *((_QWORD *)&v21 + 1) )
        {
          ...
          if ( v16 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_1803B8B20, 3u, v16, 0x498u, 0LL);
          }
          else if ( v3 != (char *)&v21 )
          {
        ...
        v1 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast(v7, &dword_1803B8B20, 3u, -2147467259, 0x49Eu, 0LL);
      }
      else
      {
        while ( 1 )
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1803B8B20, 3u, v11, 0x48Au, 0LL);
        wil::com_ptr_t<ID3D11Resource,wil::err_returncode_policy>::~com_ptr_t<ID3D11Resource,wil::err_returncode_policy>(&v25);
        wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::~com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>((__int64)&v26);
      }
    }
