/*
 * XREFs of ?Present@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@IAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I_N@Z @ 0x1800C9BC8
 * Callers:
 ...
 *     ?LegacyPresentRequired@COverlayContext@@AEBA_NXZ @ 0x1800C9D10 (-LegacyPresentRequired@COverlayContext@@AEBA_NXZ.c)
        ...
        char a6)
{
  ...
  if ( v12 )
  {
    ...
    *(_OWORD *)v37 = *(_OWORD *)((*(__int64 (__fastcall **)(CDirectFlipInfo *))(*(_QWORD *)v25 + 160LL))(v25) + 20);
    ...
    v19 = v26;
    if ( v26 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0xA44u, 0LL);
  ...
  else
  {
    *((_BYTE *)this + 11304) = 0;
    if ( a6 || COverlayContext::LegacyPresentRequired((COverlayContext *)this) )
    {
      ...
      v19 = v21;
      if ( v21 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v21, 0xA29u, 0LL);
      if ( (Microsoft_Windows_Dwm_CompositorEnableBits & 1) != 0 )
    ...
    else
    {
      ...
      v19 = v15;
      if ( v15 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v15, 0xA19u, 0LL);
      if ( (Microsoft_Windows_Dwm_CompositorEnableBits & 1) != 0 )
