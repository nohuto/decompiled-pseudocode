/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x1800AC9F8
 * Callers:
 ...
 * Callees:
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x1800AB2E8 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
