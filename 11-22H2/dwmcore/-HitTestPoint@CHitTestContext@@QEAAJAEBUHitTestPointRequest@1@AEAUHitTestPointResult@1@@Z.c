/*
 * XREFs of ?HitTestPoint@CHitTestContext@@QEAAJAEBUHitTestPointRequest@1@AEAUHitTestPointResult@1@@Z @ 0x180031DE4
 * Callers:
 ...
 *     DuplicateCompositionInputSinkHelper @ 0x18001A0FC (DuplicateCompositionInputSinkHelper.c)
 ...
 *     ?HasInputSink@CInteraction@@QEBA_NXZ @ 0x180032248 (-HasInputSink@CInteraction@@QEBA_NXZ.c)
 ...
 *     ?GetInputType@CInputSinkStruct@@SA?AW4CompositionInputType@@W4InputType@@@Z @ 0x1801B154C (-GetInputType@CInputSinkStruct@@SA-AW4CompositionInputType@@W4InputType@@@Z.c)
 */
...
LABEL_21:
  ...
  v3 = v25 | 0x10000000;
  MilInstrumentationCheckHR_MaybeFailFast(v26, &dword_18033BD30, 2u, v25 | 0x10000000, 0x30Au, 0LL);
LABEL_22:
  *((_DWORD *)this + 44) = 0;
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x4000) != 0 )
    McTemplateU0qqp_EventWriteTransfer(
