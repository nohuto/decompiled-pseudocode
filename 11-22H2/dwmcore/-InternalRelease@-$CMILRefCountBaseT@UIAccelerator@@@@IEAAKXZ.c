/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@UIAccelerator@@@@IEAAKXZ @ 0x1802331F4
 * Callers:
 *     ?Release@?$CMILRefCountBaseT@UIAccelerator@@@@UEAAKXZ @ 0x1802341D0 (-Release@-$CMILRefCountBaseT@UIAccelerator@@@@UEAAKXZ.c)
 * Callees:
