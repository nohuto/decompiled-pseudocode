/*
 * XREFs of ??1?$ThreadLocalStorage@UThreadLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x180197E0C
 * Callers:
 ...
 * Callees:
 *     ?Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ @ 0x1801982F4 (-Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ.c)
 */
