/*
 * XREFs of ?ProcessRenderCommands_OcclusionPass@CCpuClipAntialiasSinkContext@@AEBAXIPEAV?$list@USinkRenderCommand@CCpuClipAntialiasSinkContext@@V?$allocator@USinkRenderCommand@CCpuClipAntialiasSinkContext@@@std@@@std@@@Z @ 0x180085E68
 * Callers:
 ...
 *     ??$?0GGMGM@?$_List_node_emplace_op2@V?$allocator@U?$_List_node@UBounds@CCpuClipAntialiasSink@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_List_node@UBounds@CCpuClipAntialiasSink@@PEAX@std@@@1@$$QEAG1$$QEAM12@Z @ 0x1800DFFB8 (--$-0GGMGM@-$_List_node_emplace_op2@V-$allocator@U-$_List_node@UBounds@CCpuClipAntialiasSink@@PE.c)
