/*
 * XREFs of ?DestroyResources@CAtlasTexture@@AEAAXXZ @ 0x180018640
 * Callers:
 *     ??1CAtlasTexture@@QEAA@XZ @ 0x1800185B8 (--1CAtlasTexture@@QEAA@XZ.c)
 *     ?NotifyInvalidResource@CAtlasTexture@@UEAAXPEBVIDeviceResource@@@Z @ 0x18029C9B0 (-NotifyInvalidResource@CAtlasTexture@@UEAAXPEBVIDeviceResource@@@Z.c)
 * Callees:
