/*
 * XREFs of ?OnDisconnectedCallout@BamoDataSourceProxy@@EEAAJXZ @ 0x1801E3120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataSourceProxy::OnDisconnectedCallout(
        ...
        const char *a4)
{
  ...
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    ...
    *(Microsoft::BamoImpl::BaseBamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 4) + 24LL) + 32LL),
    a3,
    a4);
  LODWORD(v4) = (*(__int64 (__fastcall **)(BamoDataSourceProxy *))(*(_QWORD *)v4 + 40LL))(v4);
  Microsoft::BamoImpl::CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>::~CalloutWrapper<Microsoft::BamoImpl::CalloutWrapperObject>(
    (__int64)v9,
    v5,
    v6,
