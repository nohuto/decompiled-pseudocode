/*
 * XREFs of ?QueryInterface@BamoCompObjectDiagnosticsRootProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801E6140
 * Callers:
 *     ?QueryInterface@BamoCompObjectDiagnosticsRootProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18011D5C0 (-QueryInterface@BamoCompObjectDiagnosticsRootProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
