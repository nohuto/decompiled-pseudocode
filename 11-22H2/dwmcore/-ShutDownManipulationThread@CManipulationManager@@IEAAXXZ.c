/*
 * XREFs of ?ShutDownManipulationThread@CManipulationManager@@IEAAXXZ @ 0x1801A17BC
 * Callers:
 *     ??1CGlobalManipulationManager@@EEAA@XZ @ 0x1802834D8 (--1CGlobalManipulationManager@@EEAA@XZ.c)
 * Callees:
 *     _guard_xfg_dispatch_icall_nop @ 0x18011B9E0 (_guard_xfg_dispatch_icall_nop.c)
 *     ?ClearWaitHandles@CManipulationManager@@KAXXZ @ 0x18019E078 (-ClearWaitHandles@CManipulationManager@@KAXXZ.c)
 */
