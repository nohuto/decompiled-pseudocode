/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VID2DBitmapCacheSource@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802B778C
 * Callers:
 *     ?QueryInterface@CColorKeyBitmap@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802B7B40 (-QueryInterface@CColorKeyBitmap@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
