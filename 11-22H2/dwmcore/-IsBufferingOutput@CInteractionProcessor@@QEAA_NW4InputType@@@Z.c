/*
 * XREFs of ?IsBufferingOutput@CInteractionProcessor@@QEAA_NW4InputType@@@Z @ 0x1801AECC4
 * Callers:
 *     ?IsBufferingOutput@CInteractionRoot@@UEAA_NW4InputType@@@Z @ 0x1801A4B20 (-IsBufferingOutput@CInteractionRoot@@UEAA_NW4InputType@@@Z.c)
 *     ?IsBufferingOutput@CInteraction@@UEAA_NW4InputType@@@Z @ 0x18020C3F0 (-IsBufferingOutput@CInteraction@@UEAA_NW4InputType@@@Z.c)
 * Callees:
