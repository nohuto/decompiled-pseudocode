/*
 * XREFs of ?GenerateShaders@CD3DDevice@@AEAAJXZ @ 0x180026108
 * Callers:
 ...
 *     ?size_bytes@?$span@$$CBUD3D11_INPUT_ELEMENT_DESC@@$0?0@gsl@@QEBA_KXZ @ 0x1800260DC (-size_bytes@-$span@$$CBUD3D11_INPUT_ELEMENT_DESC@@$0-0@gsl@@QEBA_KXZ.c)
...
LABEL_64:
  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      {
        v25 = *((_OWORD *)&unk_1802D7960 + v24);
        v73 = (struct ID3D11PixelShader *)*((_QWORD *)&unk_1802D7960 + 2 * v24);
        *(_OWORD *)Src_8 = v25;
        if ( v73 )
        {
          v75 = *((_OWORD *)&unk_1802D7D60 + v23);
          *(_OWORD *)v72 = *((_OWORD *)&unk_1802D7B60 + (int)v22);
          v26 = *(_QWORD *)v72;
          if ( *(_QWORD *)v72 )
          {
  ...
  do
  {
    ...
    *((_QWORD *)v43 + 205) = 0LL;
    ...
    CommonOrCubeMapRenderingShader = v46(v42, &byte_1803830B0[264 * (int)v38], v43 + 1640);
    v14 = CommonOrCubeMapRenderingShader;
    if ( CommonOrCubeMapRenderingShader < 0 )
    {
      v70 = 538;
  ...
  do
  {
    ...
    *((_QWORD *)v53 + 277) = 0LL;
    ...
    CommonOrCubeMapRenderingShader = v56(v52, &_ImageBase[20 * (int)v48 + 1972644], v53 + 2216);
    v14 = CommonOrCubeMapRenderingShader;
    if ( CommonOrCubeMapRenderingShader < 0 )
    {
      v70 = 544;
  ...
  do
  {
    ...
    *((_QWORD *)v63 + 278) = 0LL;
    ...
    CommonOrCubeMapRenderingShader = v66(v62, &byte_180382FE0[52 * (int)v58], v63 + 2224);
    v14 = CommonOrCubeMapRenderingShader;
    if ( CommonOrCubeMapRenderingShader < 0 )
    {
      v70 = 550;
