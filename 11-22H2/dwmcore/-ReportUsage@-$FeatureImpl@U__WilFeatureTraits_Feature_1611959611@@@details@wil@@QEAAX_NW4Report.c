/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_1611959611@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18011A244
 * Callers:
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_1611959611@@@details@wil@@QEAA_NXZ @ 0x18011A2C8 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_1611959611@@@details@wil@@QEAA_NX.c)
 * Callees:
...
_UNKNOWN **__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_1611959611>::ReportUsage(
        ...
        __int64 a4)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_1611959611>::GetCachedFeatureEnabledState(
                      a1,
                      v8);
    v11 = v4;
  }
