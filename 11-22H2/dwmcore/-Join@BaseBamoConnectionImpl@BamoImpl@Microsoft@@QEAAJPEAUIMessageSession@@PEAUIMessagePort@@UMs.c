/*
 * XREFs of ?Join@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBG_N@Z @ 0x1800ACD90
 * Callers:
 ...
 * Callees:
 *     ?StringCchLengthW@@YAJPEBG_KPEA_K@Z @ 0x1800AB36C (-StringCchLengthW@@YAJPEBG_KPEA_K@Z.c)
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1800AC96C (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
