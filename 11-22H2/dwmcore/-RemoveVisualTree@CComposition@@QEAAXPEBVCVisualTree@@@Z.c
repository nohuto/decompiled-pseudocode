/*
 * XREFs of ?RemoveVisualTree@CComposition@@QEAAXPEBVCVisualTree@@@Z @ 0x1800C7E94
 * Callers:
 *     ??1CVisual@@MEAA@XZ @ 0x18009A7CC (--1CVisual@@MEAA@XZ.c)
 *     ?FinalRelease@CVisualTree@@MEAAXXZ @ 0x1800C7E80 (-FinalRelease@CVisualTree@@MEAAXXZ.c)
 * Callees:
