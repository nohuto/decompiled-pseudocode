/*
 * XREFs of ?ProcessComposition@CComposition@@IEAAXPEA_N@Z @ 0x18004F0DC
 * Callers:
 ...
 *     ?ReleaseUnusedCaches@CMeshCacheManager@@QEAAXXZ @ 0x1800508D8 (-ReleaseUnusedCaches@CMeshCacheManager@@QEAAXXZ.c)
 ...
 *     ?TriggerFailFastOnNextFailure@@YAX_NJ@Z @ 0x18027C41C (-TriggerFailFastOnNextFailure@@YAX_NJ@Z.c)
 */
...
LABEL_9:
  *((_DWORD *)this + 186) = 0;
  ...
  if ( v11 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_1803566F0, 3u, v11, 0x379u, 0LL);
  v14 = CRenderTargetManager::Render(this[27], a2);
  v16 = v14;
  if ( v14 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v15, &dword_1803566F0, 3u, v14, 0x37Cu, 0LL);
  if ( v11 )
  {
    if ( v11 < 0 )
      goto LABEL_46;
