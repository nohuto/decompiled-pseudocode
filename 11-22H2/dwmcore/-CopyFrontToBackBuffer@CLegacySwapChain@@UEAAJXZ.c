/*
 * XREFs of ?CopyFrontToBackBuffer@CLegacySwapChain@@UEAAJXZ @ 0x180042300
 * Callers:
 *     ?CopyFrontToBackBuffer@CLegacySwapChain@@$4PPPPPPPM@BLA@EAAJXZ @ 0x18011F7A0 (-CopyFrontToBackBuffer@CLegacySwapChain@@$4PPPPPPPM@BLA@EAAJXZ.c)
