/*
 * XREFs of ?PushLocalSpaceClipAndAlphaInternal@CDrawingContext@@AEAAJPEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUNodeEffects@1@PEA_N@Z @ 0x18005D0D0
 * Callers:
 ...
 *     ?SetCachedTotalCpuClip@CCpuClippingData@@QEAAX$$QEAVCShapePtr@@@Z @ 0x1800F4760 (-SetCachedTotalCpuClip@CCpuClippingData@@QEAAX$$QEAVCShapePtr@@@Z.c)
...
LABEL_8:
  if ( *(_BYTE *)(a3 + 192) && *(_BYTE *)(*((_QWORD *)this + 113) - 8LL) )
  {
    ...
    *(_QWORD *)&v129 = v18;
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0xC56u, 0LL);
      goto LABEL_152;
    }
...
LABEL_19:
            ...
            if ( *(_QWORD *)(v26 - 176) )
            {
              ...
              if ( v27 )
              {
                  ...
                  || (_DWORD)v125 != 1 )
                {
                  ...
                  if ( v99 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v100, 0LL, 0, v99, 0x1133u, 0LL);
                    return v5;
                  }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v5, 0xC59u, 0LL);
    CScopedClipStack::PopCpuClipFromScope((CDrawingContext *)((char *)this + 896), this, v123);
    v21 = v5;
LABEL_152:
    MilInstrumentationCheckHR_MaybeFailFast(v115, 0LL, 0, v21, 0x1125u, 0LL);
    return v5;
  }
  if ( !v4 )
  {
    ...
    else
    {
      ...
      if ( v50 >= 0 )
      {
        ...
        if ( *(_QWORD *)a3 )
        {
          ...
          if ( v55 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v56, 0LL, 0, v55, 0xBC9u, 0LL);
            goto LABEL_162;
          }
          v54 = 1;
        }
...
LABEL_162:
            MilInstrumentationCheckHR_MaybeFailFast(v69, 0LL, 0, v57, 0x114Du, 0LL);
            return v5;
          }
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v117, 0LL, 0, v57, 0xBCEu, 0LL);
        v57 = v5;
        if ( v54 )
        {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v49, 0LL, 0, v50, 0x1148u, 0LL);
    return v5;
  }
  ...
  if ( v103 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v104, 0LL, 0, v103, 0x115Bu, 0LL);
    return v5;
  }
LABEL_33:
  v28 = *((_QWORD *)this + 4);
...
LABEL_89:
    ...
    if ( !v70 )
    {
      *(float *)&v125 = v71;
      ...
      if ( v73 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v74, 0LL, 0, v73, 0x11D1u, 0LL);
      }
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v78, 0LL, 0, v76, 0x11D5u, 0LL);
        CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop((char *)this + 368, 0LL, v121);
        v5 = v75;
      }
      MilInstrumentationCheckHR_MaybeFailFast(v120, 0LL, 0, v75, 0x1181u, 0LL);
      goto LABEL_102;
    }
...
LABEL_93:
    ...
    if ( v82 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v83, 0LL, 0, v82, 0x981u, 0LL);
      if ( v5 == -2003238895 )
      {
        v5 = 0;
        *v127 = 1;
...
LABEL_127:
  ...
  if ( v46 == 1 )
  {
    ...
    v5 = v95;
    if ( v95 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v96, 0LL, 0, v95, 0x11B5u, 0LL);
  }
  else if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v47 - 1.0) & _xmm) >= 0.0000011920929 )
  {
    ...
    v5 = v97;
    if ( v97 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v98, 0LL, 0, v97, 0x11BDu, 0LL);
  }
  return v5;
}
