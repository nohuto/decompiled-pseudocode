/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_2460007739@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180119FA0
 * Callers:
...
_UNKNOWN **__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_2460007739>::ReportUsage(
        ...
        __int64 a4)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_2460007739>::GetCachedFeatureEnabledState(
                      a1,
                      v8);
    v11 = v4;
  }
