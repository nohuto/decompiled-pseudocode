/*
 * XREFs of ?StringCchCatExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x180280950
 * Callers:
 ...
 * Callees:
 *     StringCopyWorkerW_0 @ 0x180280A30 (StringCopyWorkerW_0.c)
 *     StringLengthWorkerW @ 0x180280AAC (StringLengthWorkerW.c)
 */
