/*
 * XREFs of ?OnReaderDisconnected@BamoDataProviderProxyImpl@BamoImpl@@QEAAJ_K@Z @ 0x1801E4C00
 * Callers:
...
__int64 __fastcall BamoImpl::BamoDataProviderProxyImpl::OnReaderDisconnected(
