/*
 * XREFs of ?Present@CCompSwapChain@@UEAAJII@Z @ 0x18029EBF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompSwapChain::Present(CCompSwapChain *this, unsigned int a2, unsigned int a3)
{
  ...
  if ( !v7 )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1803BA010, 2u, v8, 0x13Du, 0LL);
      goto LABEL_15;
    }
    if ( **((_DWORD **)this + 21) )
    {
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1803BA010, 2u, v11, 0x14Cu, 0LL);
  }
  else if ( !v7 )
  {
    if ( *((_DWORD *)this + 40) == 3 )
