/*
 * XREFs of ?DepartBufferedOutputPointer@CInteractionProcessor@@QEAA_NIW4InputType@@@Z @ 0x1801AE76C
 * Callers:
 *     ?DepartBufferedOutputPointer@CInteractionRoot@@UEAA_NI@Z @ 0x1801A4400 (-DepartBufferedOutputPointer@CInteractionRoot@@UEAA_NI@Z.c)
 *     ?DepartBufferedOutputPointer@CInteraction@@UEAA_NI@Z @ 0x18020BF30 (-DepartBufferedOutputPointer@CInteraction@@UEAA_NI@Z.c)
 * Callees:
