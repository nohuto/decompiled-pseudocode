/*
 * XREFs of ?StrokeShapeWithBrush@CDrawingContext@@QEAAJAEBVCShape@@PEAUID2D1Brush@@MPEAUID2D1StrokeStyle1@@@Z @ 0x180012EBC
 * Callers:
        ...
        struct ID2D1StrokeStyle1 *a5)
{
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xA48u, 0LL);
    goto LABEL_7;
  }
  ...
  if ( WidenedBounds < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, WidenedBounds, 0xA4Fu, 0LL);
    goto LABEL_7;
  }
  v29 = 0;
  v30 = 0;
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0xA51u, 0LL);
  }
  else
  {
LABEL_3:
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xA54u, 0LL);
    }
    else
    {
      v15 = *((_DWORD *)this + 90);
      ...
      v11 = v17;
      if ( v17 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0xA5Cu, 0LL);
    }
  }
LABEL_7:
