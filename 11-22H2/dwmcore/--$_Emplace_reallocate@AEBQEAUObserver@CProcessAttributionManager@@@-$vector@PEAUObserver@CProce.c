/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAUObserver@CProcessAttributionManager@@@?$vector@PEAUObserver@CProcessAttributionManager@@V?$allocator@PEAUObserver@CProcessAttributionManager@@@std@@@std@@QEAAPEAPEAUObserver@CProcessAttributionManager@@QEAPEAU23@AEBQEAU23@@Z @ 0x1800FE568
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAUObserver@CProcessAttributionManager@@V?$allocator@PEAUObserver@CProcessAttributionManager@@@std@@@std@@AEAAXQEAPEAUObserver@CProcessAttributionManager@@_K1@Z @ 0x1800FE654 (-_Change_array@-$vector@PEAUObserver@CProcessAttributionManager@@V-$allocator@PEAUObserver@CProc.c)
