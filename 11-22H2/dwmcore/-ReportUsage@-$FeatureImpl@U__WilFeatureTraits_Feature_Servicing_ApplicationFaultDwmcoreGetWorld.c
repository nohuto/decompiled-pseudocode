/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_ApplicationFaultDwmcoreGetWorldTransform@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1801189A0
 * Callers:
