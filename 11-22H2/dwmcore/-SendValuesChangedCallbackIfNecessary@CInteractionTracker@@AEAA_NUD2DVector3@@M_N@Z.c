/*
 * XREFs of ?SendValuesChangedCallbackIfNecessary@CInteractionTracker@@AEAA_NUD2DVector3@@M_N@Z @ 0x1802349D4
 * Callers:
...
LABEL_7:
  ...
  v12 = *(_QWORD *)(a1 + 16);
  v15 = v11;
  CoreUICallSend(*(_QWORD *)(*(_QWORD *)(v12 + 1240) + 40LL), v17, 2LL, 11LL, 0, &unk_18033C47F, &v15);
  v13 = *((_DWORD *)a2 + 2);
  *(_QWORD *)(a1 + 512) = *a2;
  *(_DWORD *)(a1 + 520) = v13;
  *(float *)(a1 + 524) = a3;
