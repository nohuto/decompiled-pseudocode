/*
 * XREFs of ?CalcSrcToDestVisualTransform@CVisual@@SAJPEBVCVisualTree@@W4WalkReason@@V?$span@PEAVCVisual@@$0?0@gsl@@PEAV1@V?$span@PEAVCMILMatrix@@$0?0@5@@Z @ 0x180005CF4
 * Callers:
...
LABEL_11:
  ...
  if ( !v9 )
  {
    ...
    {
      v8 = -2003304441;
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, (unsigned int)v7, -2003304441, 0x427u, v7);
      return v8;
    }
    a1 = v32;
    v9 = 1;
