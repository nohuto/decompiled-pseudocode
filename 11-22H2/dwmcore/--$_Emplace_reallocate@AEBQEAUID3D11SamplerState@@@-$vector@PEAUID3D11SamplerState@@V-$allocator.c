/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAUID3D11SamplerState@@@?$vector@PEAUID3D11SamplerState@@V?$allocator@PEAUID3D11SamplerState@@@std@@@std@@QEAAPEAPEAUID3D11SamplerState@@QEAPEAU2@AEBQEAU2@@Z @ 0x180299CD8
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAUID3D11SamplerState@@V?$allocator@PEAUID3D11SamplerState@@@std@@@std@@AEAAXQEAPEAUID3D11SamplerState@@_K1@Z @ 0x18029A7BC (-_Change_array@-$vector@PEAUID3D11SamplerState@@V-$allocator@PEAUID3D11SamplerState@@@std@@@std@.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<ID3D11SamplerState *>::_Change_array(a1, v13, v9, v3);
  return v14;
}
