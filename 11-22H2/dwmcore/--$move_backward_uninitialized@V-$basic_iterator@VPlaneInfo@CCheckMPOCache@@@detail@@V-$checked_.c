/*
 * XREFs of ??$move_backward_uninitialized@V?$basic_iterator@VPlaneInfo@CCheckMPOCache@@@detail@@V?$checked_array_iterator@PEAVPlaneInfo@CCheckMPOCache@@@stdext@@@detail@@YAXV?$basic_iterator@VPlaneInfo@CCheckMPOCache@@@0@0V?$checked_array_iterator@PEAVPlaneInfo@CCheckMPOCache@@@stdext@@@Z @ 0x18011ABA0
 * Callers:
