/*
 * XREFs of ?Max@CExpressionValueStack@@QEAAJXZ @ 0x1802601E4
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Max(CExpressionValueStack *this)
{
  ...
  if ( v1 >= 2 )
  {
    ...
    if ( v10 == *((_DWORD *)v5 + 18) )
    {
      ...
      {
        case 18:
          v18 = fmaxf(*(float *)v7, *v5);
          *((_DWORD *)v7 + 18) = 18;
          *(float *)v7 = v18;
          break;
        case 35:
          v16 = fmaxf(*(float *)v7, *v5);
          v17 = fmaxf(*((float *)v7 + 1), v5[1]);
          *((_DWORD *)v7 + 18) = 35;
          *(float *)v7 = v16;
          *((float *)v7 + 1) = v17;
          break;
        case 52:
          v13 = fmaxf(COERCE_FLOAT(*v7), COERCE_FLOAT(*(_QWORD *)v5));
          v14 = fmaxf(COERCE_FLOAT(HIDWORD(*v7)), COERCE_FLOAT(HIDWORD(*(_QWORD *)v5)));
          v15 = fmaxf(*((float *)v7 + 2), v5[2]);
          *((_DWORD *)v7 + 18) = 52;
          *(float *)v7 = v13;
          *((float *)v7 + 1) = v14;
          *((float *)v7 + 2) = v15;
