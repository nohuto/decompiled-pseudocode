/*
 * XREFs of ?FillRectanglesWithSolidColor@CDrawingContext@@QEAAJAEBV?$span@$$CBUMilRectF@@$0?0@gsl@@AEBU_D3DCOLORVALUE@@@Z @ 0x18012EE9C
 * Callers:
...
__int64 __fastcall CDrawingContext::FillRectanglesWithSolidColor(struct CDrawingContext *a1, _OWORD *a2, __int64 a3)
{
  ...
  if ( COERCE_FLOAT(*(_DWORD *)(a3 + 12) & _xmm) >= 0.0000011920929 || *((_DWORD *)a1 + 90) || *((_DWORD *)a1 + 85) )
  {
    ...
    if ( v3 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v3, 0x93Fu, 0LL);
    }
    else
    {
      *((_DWORD *)v13 + 12) = 0;
      ...
      *((_OWORD *)v13 + 2) = 0LL;
      ...
      if ( v3 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v3, 0x949u, 0LL);
    }
    if ( v13 )
