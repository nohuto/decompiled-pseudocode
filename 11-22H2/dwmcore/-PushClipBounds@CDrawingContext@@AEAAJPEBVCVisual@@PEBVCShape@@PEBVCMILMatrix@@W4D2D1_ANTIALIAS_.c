/*
 * XREFs of ?PushClipBounds@CDrawingContext@@AEAAJPEBVCVisual@@PEBVCShape@@PEBVCMILMatrix@@W4D2D1_ANTIALIAS_MODE@@@Z @ 0x180021CE8
 * Callers:
        ...
        enum D2D1_ANTIALIAS_MODE a5)
{
  ...
  *((_QWORD *)&v19 + 1) = a2;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xC9Cu, 0LL);
    return v11;
  }
  v12 = *(_QWORD *)a3;
  v19 = 0LL;
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xCA2u, 0LL);
    goto LABEL_7;
  }
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0xCA4u, 0LL);
LABEL_7:
