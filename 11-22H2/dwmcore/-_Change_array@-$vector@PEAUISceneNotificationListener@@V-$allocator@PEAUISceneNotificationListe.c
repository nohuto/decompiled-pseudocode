/*
 * XREFs of ?_Change_array@?$vector@PEAUISceneNotificationListener@@V?$allocator@PEAUISceneNotificationListener@@@std@@@std@@AEAAXQEAPEAUISceneNotificationListener@@_K1@Z @ 0x1801BD5C4
 * Callers:
