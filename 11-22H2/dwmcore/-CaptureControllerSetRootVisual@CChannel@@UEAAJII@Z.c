/*
 * XREFs of ?CaptureControllerSetRootVisual@CChannel@@UEAAJII@Z @ 0x1801CED30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetRootVisual(CChannel *this, unsigned int a2, unsigned int a3)
{
  unsigned int v6; // ebx
