/*
 * XREFs of ??$_Emplace_reallocate@PEAVCVisual@@@?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@QEAAPEAPEAVCVisual@@QEAPEAV2@$$QEAPEAV2@@Z @ 0x18026CBA0
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@AEAAXQEAPEAVCVisual@@_K1@Z @ 0x18001E28C (-_Change_array@-$vector@PEAVCVisual@@V-$allocator@PEAVCVisual@@@std@@@std@@AEAAXQEAPEAVCVisual@@.c)
...
char *__fastcall std::vector<CVisual *>::_Emplace_reallocate<CVisual *>(__int64 *a1, _BYTE *a2, _QWORD *a3)
{
  _BYTE *v3; // rbp
  __int64 v6; // rax
  __int64 v8; // r15
  ...
  *(_QWORD *)v12 = *a3;
  ...
  std::vector<CVisual *>::_Change_array(a1, (__int64)v11, v8, v9);
