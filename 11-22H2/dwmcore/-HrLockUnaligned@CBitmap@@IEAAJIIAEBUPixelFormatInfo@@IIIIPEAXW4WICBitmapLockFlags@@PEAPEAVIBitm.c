/*
 * XREFs of ?HrLockUnaligned@CBitmap@@IEAAJIIAEBUPixelFormatInfo@@IIIIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x180281B84
 * Callers:
 ...
 *     ??0CBitmapLockUnaligned@@QEAA@XZ @ 0x18028246C (--0CBitmapLockUnaligned@@QEAA@XZ.c)
