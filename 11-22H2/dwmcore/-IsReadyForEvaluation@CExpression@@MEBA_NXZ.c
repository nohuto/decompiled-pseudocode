/*
 * XREFs of ?IsReadyForEvaluation@CExpression@@MEBA_NXZ @ 0x1800E9520
 * Callers:
 *     <none>
 * Callees:
 *     ?IsReadyForEvaluation@CBaseExpression@@MEBA_NXZ @ 0x1800E9550 (-IsReadyForEvaluation@CBaseExpression@@MEBA_NXZ.c)
 */
