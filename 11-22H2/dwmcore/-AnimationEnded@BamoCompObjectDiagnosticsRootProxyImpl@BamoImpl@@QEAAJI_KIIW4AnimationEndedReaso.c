/*
 * XREFs of ?AnimationEnded@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4AnimationEndedReasonType@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x1801E55B4
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      LODWORD(v12) = a2;
      return CoreUICallSend(v10, v14, 2LL, 0LL, 4, &unk_18035671B, v12);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
