/*
 * XREFs of ?UpdateCVIRenderTargets@CDesktopTree@@QEBAXAEBVRenderTargetInfo@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18004CDFC
 * Callers:
 ...
 *     ?GetBackdropVisualImage@CTreeData@@IEBAPEAVCBackdropVisualImage@@AEBVCVisualTreePath@@@Z @ 0x180088AD4 (-GetBackdropVisualImage@CTreeData@@IEBAPEAVCBackdropVisualImage@@AEBVCVisualTreePath@@@Z.c)
        ...
        && TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::DoesIntersectUnsafe(v4, (float *)&v45) )
      {
              ...
              !COcclusionContext::IsOccluded(v9, (__int64)&v46, v22)) )
        {
          ...
          if ( (int)CCachedVisualImage::GetDeviceTexture(
                      ...
                      &v35) >= 0 )
          {
            v23 = DwmDbg::DbgString::DbgString((DwmDbg::DbgString *)v43, word_18033C020);
