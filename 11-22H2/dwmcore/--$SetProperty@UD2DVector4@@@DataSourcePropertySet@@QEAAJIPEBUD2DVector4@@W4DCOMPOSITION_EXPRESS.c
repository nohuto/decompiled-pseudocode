/*
 * XREFs of ??$SetProperty@UD2DVector4@@@DataSourcePropertySet@@QEAAJIPEBUD2DVector4@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801E1E84
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DVector4>(__int64 a1, int a2, __int128 *a3)
{
  ...
  if ( v19 == *(_QWORD *)(a1 + 8) )
  {
    v6 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector4>(v5, 69, a3, &v21);
    v7 = v6;
    if ( v6 < 0 )
    {
