/*
 * XREFs of ?GetStats@CLegacyRenderTarget@@UEAA_NPEAUtagCOMPOSITION_TARGET_STATS@@@Z @ 0x1800D5FFC
 * Callers:
 *     ?GetStats@CLegacyRenderTarget@@$4PPPPPPPM@A@EAA_NPEAUtagCOMPOSITION_TARGET_STATS@@@Z @ 0x18011C8A0 (-GetStats@CLegacyRenderTarget@@$4PPPPPPPM@A@EAA_NPEAUtagCOMPOSITION_TARGET_STATS@@@Z.c)
 *     ?GetStats@CLegacyRenderTarget@@$4PPPPPPPM@BA@EAA_NPEAUtagCOMPOSITION_TARGET_STATS@@@Z @ 0x18011C8C0 (-GetStats@CLegacyRenderTarget@@$4PPPPPPPM@BA@EAA_NPEAUtagCOMPOSITION_TARGET_STATS@@@Z.c)
 * Callees:
