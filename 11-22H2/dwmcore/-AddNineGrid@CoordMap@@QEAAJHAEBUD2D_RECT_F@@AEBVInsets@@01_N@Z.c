/*
 * XREFs of ?AddNineGrid@CoordMap@@QEAAJHAEBUD2D_RECT_F@@AEBVInsets@@01_N@Z @ 0x18002F42C
 * Callers:
 ...
 *     ?Clamp@Insets@@SA?AV1@AEBV1@MM@Z @ 0x18002FAA0 (-Clamp@Insets@@SA-AV1@AEBV1@MM@Z.c)
 ...
 *     ?IsEmpty@Insets@@SA_NAEBV1@@Z @ 0x1800F6138 (-IsEmpty@Insets@@SA_NAEBV1@@Z.c)
 */
