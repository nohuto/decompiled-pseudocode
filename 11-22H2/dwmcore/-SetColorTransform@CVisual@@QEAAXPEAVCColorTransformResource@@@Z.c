/*
 * XREFs of ?SetColorTransform@CVisual@@QEAAXPEAVCColorTransformResource@@@Z @ 0x180211B90
 * Callers:
...
void __fastcall CVisual::SetColorTransform(CVisual *this, struct CColorTransformResource *a2)
{
  unsigned int **v2; // rcx
  _QWORD *v3; // r11
  unsigned int *v5; // r10
  ...
  else if ( (v6 & 0x2000000) != 0 )
  {
    v7 = *v2;
    *v5 = v6 & 0xFDFFFFFF;
    Slot = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot((__int64)v7, 7);
    if ( Slot < *(_DWORD *)(v9 + 4) )
      *(_BYTE *)(Slot + v9 + 8) = v10;
  }
}
