/*
 * XREFs of ??$SetProperty@M@DataSourcePropertySet@@QEAAJIPEBMW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1801E1830
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<float>(__int64 a1, int a2, int *a3)
{
  ...
  if ( v19 == *(_QWORD *)(a1 + 8) )
  {
    v6 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<float>(v5, 18, a3, &v21);
    v7 = v6;
    if ( v6 < 0 )
    {
  ...
  else
  {
    ...
    if ( !(unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(v13) )
      ModuleFailFastForHRESULT(2147942487LL, retaddr);
    *(_DWORD *)((*(_DWORD *)(v15 + 8 * v14 + 4) & 0x1FFFFFFF) + *(_QWORD *)(v16 + 32)) = v12;
  }
  return 0LL;
}
