/*
 * XREFs of ??0CSceneMetallicRoughnessMaterial@@QEAA@PEAVCComposition@@@Z @ 0x1801C135C
 * Callers:
 ...
 * Callees:
 *     ??0CSceneMaterial@@QEAA@PEAVCComposition@@@Z @ 0x18024FD3C (--0CSceneMaterial@@QEAA@PEAVCComposition@@@Z.c)
 */
