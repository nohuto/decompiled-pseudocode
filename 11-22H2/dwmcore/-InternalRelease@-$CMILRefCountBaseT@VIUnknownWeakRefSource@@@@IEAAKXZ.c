/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@VIUnknownWeakRefSource@@@@IEAAKXZ @ 0x18010376C
 * Callers:
 *     ?InternalRelease@CMILCOMBaseWeakRef@@IEAAKXZ @ 0x18010371C (-InternalRelease@CMILCOMBaseWeakRef@@IEAAKXZ.c)
 *     ?Release@?$CMILCOMBaseT@VIUnknownWeakRefSource@@@@UEAAKXZ @ 0x18028BC40 (-Release@-$CMILCOMBaseT@VIUnknownWeakRefSource@@@@UEAAKXZ.c)
 * Callees:
