/*
 * XREFs of ?RenderForCapture@CaptureBitsResponse@@IEAAJXZ @ 0x180020CC4
 * Callers:
  ...
  *(float *)&v33 = (float)*((int *)this + 409);
  ...
  if ( v6[8] )
  {
    ...
    *((_BYTE *)g_pComposition + 1274) = 1;
    ...
    v11 = v26;
    v12 = CDrawingContext::BeginFrame(v26, v10, (const struct CMILMatrix *)v27, &stru_1803556A0, 0LL);
    v2 = v12;
    if ( v12 < 0 )
    {
