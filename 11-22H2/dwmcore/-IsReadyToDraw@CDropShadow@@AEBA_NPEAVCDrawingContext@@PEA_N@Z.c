/*
 * XREFs of ?IsReadyToDraw@CDropShadow@@AEBA_NPEAVCDrawingContext@@PEA_N@Z @ 0x18022A6D0
 * Callers:
 *     ?IsEmptyDrawing@CDropShadow@@UEBA_NXZ @ 0x180132770 (-IsEmptyDrawing@CDropShadow@@UEBA_NXZ.c)
