/*
 * XREFs of ??_GCParticleVector4Behavior@@UEAAPEAXI@Z @ 0x1801C3760
 * Callers:
 *     ??_ECParticleVector4Behavior@@WHA@EAAPEAXI@Z @ 0x18011BD40 (--_ECParticleVector4Behavior@@WHA@EAAPEAXI@Z.c)
 * Callees:
