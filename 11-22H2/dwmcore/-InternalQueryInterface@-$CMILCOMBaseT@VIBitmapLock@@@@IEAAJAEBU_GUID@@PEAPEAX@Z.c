/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VIBitmapLock@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180282318
 * Callers:
 *     ?QueryInterface@CBitmapLock@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802823C0 (-QueryInterface@CBitmapLock@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
