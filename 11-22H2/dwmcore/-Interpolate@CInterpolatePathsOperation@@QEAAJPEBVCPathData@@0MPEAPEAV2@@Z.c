/*
 * XREFs of ?Interpolate@CInterpolatePathsOperation@@QEAAJPEBVCPathData@@0MPEAPEAV2@@Z @ 0x1802AF58C
 * Callers:
 ...
 *     ??9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z @ 0x1800D47BC (--9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z.c)
 ...
 *     ?GetPathData@CPathData@@QEBA?AV?$span@$$CBE$0?0@gsl@@XZ @ 0x18023F078 (-GetPathData@CPathData@@QEBA-AV-$span@$$CBE$0-0@gsl@@XZ.c)
