/*
 * XREFs of __scrt_dllmain_uninitialize_c @ 0x18010F224
 * Callers:
 ...
 *     _cexit_0 @ 0x1801100AA (_cexit_0.c)
 *     __scrt_stub_for_is_c_termination_complete @ 0x1801113C8 (__scrt_stub_for_is_c_termination_complete.c)
 */
