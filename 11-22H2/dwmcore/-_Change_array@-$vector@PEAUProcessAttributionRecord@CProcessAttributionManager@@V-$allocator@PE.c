/*
 * XREFs of ?_Change_array@?$vector@PEAUProcessAttributionRecord@CProcessAttributionManager@@V?$allocator@PEAUProcessAttributionRecord@CProcessAttributionManager@@@std@@@std@@AEAAXQEAPEAUProcessAttributionRecord@CProcessAttributionManager@@_K1@Z @ 0x1800F42F4
 * Callers:
