/*
 * XREFs of ?InternalQueryInterface@?$CMILCOMBaseT@VILegacyRemotingSwapChain@@@@IEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802A3AA0
 * Callers:
 *     ?QueryInterface@?$CMILCOMBaseT@VILegacyRemotingSwapChain@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1802A3CA4 (-QueryInterface@-$CMILCOMBaseT@VILegacyRemotingSwapChain@@@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
