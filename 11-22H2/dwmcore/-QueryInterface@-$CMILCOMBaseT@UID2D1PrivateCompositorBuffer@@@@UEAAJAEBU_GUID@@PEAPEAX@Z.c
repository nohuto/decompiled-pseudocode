/*
 * XREFs of ?QueryInterface@?$CMILCOMBaseT@UID2D1PrivateCompositorBuffer@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18026A630
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMILCOMBaseT<ID2D1PrivateCompositorBuffer>::QueryInterface(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  int v5; // edi
  __int64 v6; // rax
