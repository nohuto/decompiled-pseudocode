/*
 * XREFs of ?Scribble@CSuperWetInkScribbleBase@@UEAAJPEAUID3D12GraphicsCommandList@@PEAUID3D12Resource@@PEAUIDCompositionDirectInkSuperWetRenderer@@PEAUIUnknown@@PEAW4D3D12_RESOURCE_STATES@@PEAUComputeScribbleLatencyData@@PEAUtagRECT@@@Z @ 0x1802B9240
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  *((_DWORD *)this + 6) = v25;
  ...
  if ( (unsigned int)dword_1803E3728 > 4 )
  {
    if ( tlgKeywordOn((__int64)&dword_1803E3728, 2LL) )
    {
      v26 = v37;
      v27 = v36;
      v33 = v40;
