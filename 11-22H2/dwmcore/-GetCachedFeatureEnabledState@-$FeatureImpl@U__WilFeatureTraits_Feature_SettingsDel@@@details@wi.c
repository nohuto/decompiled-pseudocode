/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SettingsDel@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18011337C
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SettingsDel@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18011776C (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_SettingsDel@@@details@wil@@QEAAX_NW4Repor.c)
 * Callees:
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_SettingsDel>::GetCurrentFeatureEnabledState(a1, &v14, &v13);
    for ( i = *a2; ; i = v9 )
    {
      v7 = v13 == 0;
      v8 = i;
