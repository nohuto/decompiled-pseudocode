/*
 * XREFs of ?ProcessSetBindingBroken@CBaseExpression@@UEAAJPEAVCResourceTable@@PEBUtagMILCMD_BASEEXPRESSION_SETBINDINGBROKEN@@@Z @ 0x1800F3DE0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagMILCMD_BASEEXPRESSION_SETBINDINGBROKEN *a3)
{
  ...
  if ( (*((_BYTE *)this + 216) & 2) != 0 )
  {
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, v4, 0x18Eu, 0LL);
      return v6;
    }
