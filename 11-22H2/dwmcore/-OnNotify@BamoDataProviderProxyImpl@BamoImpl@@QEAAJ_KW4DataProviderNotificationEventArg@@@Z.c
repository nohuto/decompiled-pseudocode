/*
 * XREFs of ?OnNotify@BamoDataProviderProxyImpl@BamoImpl@@QEAAJ_KW4DataProviderNotificationEventArg@@@Z @ 0x1801E48D0
 * Callers:
...
__int64 __fastcall BamoImpl::BamoDataProviderProxyImpl::OnNotify(__int64 a1, __int64 a2)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      return CoreUICallSend(v9, v11, 2LL, 0LL, 5, &unk_180353E48, a2);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
