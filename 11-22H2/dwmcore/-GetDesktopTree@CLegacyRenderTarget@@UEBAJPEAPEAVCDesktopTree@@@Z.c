/*
 * XREFs of ?GetDesktopTree@CLegacyRenderTarget@@UEBAJPEAPEAVCDesktopTree@@@Z @ 0x1801C4500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLegacyRenderTarget::GetDesktopTree(CLegacyRenderTarget *this, struct CDesktopTree **a2)
{
  ...
  else
  {
    *a2 = 0LL;
    v3 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, -2003292412, 0xB6u, 0LL);
  }
  return v3;
}
