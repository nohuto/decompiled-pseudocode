/*
 * XREFs of ?HasIntersectingCorners@CRoundedRectangleGeometryData@@QEBA_NXZ @ 0x18007F240
 * Callers:
 ...
 *     ?AllowsOcclusion@CRoundedRectangleShape@@UEBA_NXZ @ 0x18007F220 (-AllowsOcclusion@CRoundedRectangleShape@@UEBA_NXZ.c)
