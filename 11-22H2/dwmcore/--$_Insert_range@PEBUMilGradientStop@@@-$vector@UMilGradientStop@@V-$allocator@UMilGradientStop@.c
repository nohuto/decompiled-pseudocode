/*
 * XREFs of ??$_Insert_range@PEBUMilGradientStop@@@?$vector@UMilGradientStop@@V?$allocator@UMilGradientStop@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UMilGradientStop@@@std@@@std@@@1@PEBUMilGradientStop@@1Uforward_iterator_tag@1@@Z @ 0x1801BF368
 * Callers:
 ...
 *     ?_Change_array@?$vector@UMilGradientStop@@V?$allocator@UMilGradientStop@@@std@@@std@@AEAAXQEAUMilGradientStop@@_K1@Z @ 0x1801CAA8C (-_Change_array@-$vector@UMilGradientStop@@V-$allocator@UMilGradientStop@@@std@@@std@@AEAAXQEAUMi.c)
 */
