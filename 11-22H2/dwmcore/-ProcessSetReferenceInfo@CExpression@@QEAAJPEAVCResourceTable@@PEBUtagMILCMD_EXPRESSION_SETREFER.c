/*
 * XREFs of ?ProcessSetReferenceInfo@CExpression@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EXPRESSION_SETREFERENCEINFO@@PEBXI@Z @ 0x180049104
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( v6 && (v8 = *((_DWORD *)a3 + 3)) != 0 && (v6 += *((_DWORD *)this + 110), v6 <= v8) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0xB1u, 0LL);
    }
    else
    {
      return 0;
