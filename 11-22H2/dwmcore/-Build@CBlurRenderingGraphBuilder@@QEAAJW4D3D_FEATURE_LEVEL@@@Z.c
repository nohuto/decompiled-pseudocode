/*
 * XREFs of ?Build@CBlurRenderingGraphBuilder@@QEAAJW4D3D_FEATURE_LEVEL@@@Z @ 0x1800D2594
 * Callers:
 ...
 *     ??1?$vector@UKernelTap@@V?$allocator@UKernelTap@@@std@@@std@@QEAA@XZ @ 0x180282F68 (--1-$vector@UKernelTap@@V-$allocator@UKernelTap@@@std@@@std@@QEAA@XZ.c)
 */
...
__int64 __fastcall CBlurRenderingGraphBuilder::Build(CBlurRenderingGraphBuilder *this, unsigned int a2)
{
  ...
  v7 = *(int *)(v6 + 1584);
  v8 = 5 * v7;
  CGaussianKernel::GenerateTaps((unsigned __int64 *)&v20, 0, *(float *)(v6 + 1576), flt_18033C034[5 * v7]);
