/*
 * XREFs of ?RemoveDataProvider@DataProviderManager@@QEAAJPEAVDataProviderProxy@@@Z @ 0x1801B7CC0
 * Callers:
 ...
 *     ?OnDisconnected@DataProviderProxy@@MEAAJXZ @ 0x1801E4840 (-OnDisconnected@DataProviderProxy@@MEAAJXZ.c)
 * Callees:
