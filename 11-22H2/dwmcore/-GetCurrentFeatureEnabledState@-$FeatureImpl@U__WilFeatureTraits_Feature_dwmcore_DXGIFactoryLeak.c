/*
 * XREFs of ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_dwmcore_DXGIFactoryLeak@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x18011A6F0
 * Callers:
...
_QWORD *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_dwmcore_DXGIFactoryLeak>::GetCurrentFeatureEnabledState(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        int *a4)
{
  ...
  *(_DWORD *)a2 = v9;
  ...
  {
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_TestConfVar>::ReportUsage(
