/*
 * XREFs of ?Push2DVisualTransformToRenderThread@CInteraction@@UEAAJXZ @ 0x18020C700
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetManipulationThreadMessageCallSendHost@CManipulationManager@@QEAAJPEAPEAUIMessageCallSendHost@@@Z @ 0x18020BFD0 (-GetManipulationThreadMessageCallSendHost@CManipulationManager@@QEAAJPEAPEAUIMessageCallSendHost.c)
 */
...
__int64 __fastcall CInteraction::Push2DVisualTransformToRenderThread(CInteraction *this)
{
  ...
  if ( v7 )
  {
    ...
    v13 = (char *)this - 64;
    v14 = v7;
    ManipulationManager = CoreUICallSend(v11, &v14, 1LL, 12LL, 3, &unk_18033C4B0, &v13);
    v5 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
