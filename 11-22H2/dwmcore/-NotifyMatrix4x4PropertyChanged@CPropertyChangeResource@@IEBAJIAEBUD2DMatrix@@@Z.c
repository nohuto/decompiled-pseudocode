/*
 * XREFs of ?NotifyMatrix4x4PropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DMatrix@@@Z @ 0x180097E38
 * Callers:
    ...
    if ( *(_DWORD *)(v3 + 76) )
    {
      if ( *((_DWORD *)this + 16) )
      {
        ...
        if ( _bittest(&v6, a2) )
        {
          ...
          v17[2] = v11;
          v17[3] = v13;
          v14 = CoreUICallSend(v12, v16, 2LL, 14LL, 8, &unk_18033C4F1, a2, v17);
          v4 = v14;
          if ( v14 == -2018375675 )
          {
            return 0;
