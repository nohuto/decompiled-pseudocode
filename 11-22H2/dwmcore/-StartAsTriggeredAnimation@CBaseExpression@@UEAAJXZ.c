/*
 * XREFs of ?StartAsTriggeredAnimation@CBaseExpression@@UEAAJXZ @ 0x18023F970
 * Callers:
...
__int64 __fastcall CBaseExpression::StartAsTriggeredAnimation(CBaseExpression *this)
{
  ...
  if ( (v1 & 1) != 0 )
  {
    if ( (unsigned int)dword_1803E3798 > 4 && tlgKeywordOn((__int64)&dword_1803E3798, 4LL) )
    {
      v16 = this;
      TracingCookie = CBaseExpression::GetTracingCookie(this);
      v13 = (unsigned __int8 *)&unk_18038174F;
      goto LABEL_17;
    }
  }
  else
  {
    ...
    if ( (unsigned int)dword_1803E3798 > 4 && tlgKeywordOn((__int64)&dword_1803E3798, 4LL) )
    {
      v16 = this;
      TracingCookie = CBaseExpression::GetTracingCookie(this);
      v13 = (unsigned __int8 *)&unk_180381718;
LABEL_17:
