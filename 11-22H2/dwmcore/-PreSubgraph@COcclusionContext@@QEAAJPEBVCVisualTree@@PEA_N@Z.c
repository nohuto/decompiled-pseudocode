/*
 * XREFs of ?PreSubgraph@COcclusionContext@@QEAAJPEBVCVisualTree@@PEA_N@Z @ 0x180064A30
 * Callers:
  ...
  if ( (struct _LIST_ENTRY *)v8[30] != Flink )
  {
    ...
    while ( v18 != v8[26] )
    {
      ...
      if ( *(_QWORD *)(*(_QWORD *)v18 + 8LL) == CBackdropVisualImageKey::sc_NoBVIKey
        && k[1].Flink == (struct _LIST_ENTRY *)qword_1803E9F70
...
LABEL_448:
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v63, 0LL, 0, -2003292412, 0x6AEu, 0LL);
    v70 = v253;
    goto LABEL_118;
  }
LABEL_124:
