/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_14978362@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180119A80
 * Callers:
...
_UNKNOWN **__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_14978362>::ReportUsage(
        ...
        __int64 a4)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v4 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_14978362>::GetCachedFeatureEnabledState(a1, v8);
    v11 = v4;
  }
  v9 = 0;
  v10 = 2;
