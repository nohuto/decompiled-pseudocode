/*
 * XREFs of ?OnRandomSeedChanged@CParticleEmitterVisual@@QEAAXXZ @ 0x1801C5BF4
 * Callers:
 *     ?SetRandomSeed@?$CParticleEmitterVisualGeneratedT@VCParticleEmitterVisual@@VCVisual@@@@QEAAJI@Z @ 0x1801C97B8 (-SetRandomSeed@-$CParticleEmitterVisualGeneratedT@VCParticleEmitterVisual@@VCVisual@@@@QEAAJI@Z.c)
 * Callees:
