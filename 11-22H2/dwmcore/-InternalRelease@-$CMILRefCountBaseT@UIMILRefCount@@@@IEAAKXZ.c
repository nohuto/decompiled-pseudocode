/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@UIMILRefCount@@@@IEAAKXZ @ 0x1800DBB94
 * Callers:
 ...
 *     ?Release@CManipulationContext@@UEAAKXZ @ 0x18012D940 (-Release@CManipulationContext@@UEAAKXZ.c)
 *     ?Release@CHolographicInteropTaskQueue@@UEAAKXZ @ 0x18012DE90 (-Release@CHolographicInteropTaskQueue@@UEAAKXZ.c)
 ...
 *     ?Release@CSpectreCallbackRenderer@@UEAAKXZ @ 0x1801D6CB0 (-Release@CSpectreCallbackRenderer@@UEAAKXZ.c)
 ...
 *     ?Release@CMesh2DEffect@@UEAAKXZ @ 0x1802BF470 (-Release@CMesh2DEffect@@UEAAKXZ.c)
 * Callees:
