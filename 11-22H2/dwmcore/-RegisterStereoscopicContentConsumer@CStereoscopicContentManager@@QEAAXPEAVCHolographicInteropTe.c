/*
 * XREFs of ?RegisterStereoscopicContentConsumer@CStereoscopicContentManager@@QEAAXPEAVCHolographicInteropTexture@@@Z @ 0x1802A7394
 * Callers:
 ...
 *     ??0StereoscopicViewData@@QEAA@XZ @ 0x1802A6C78 (--0StereoscopicViewData@@QEAA@XZ.c)
 */
