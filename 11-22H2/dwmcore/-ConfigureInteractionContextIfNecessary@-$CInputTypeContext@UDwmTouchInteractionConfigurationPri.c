/*
 * XREFs of ?ConfigureInteractionContextIfNecessary@?$CInputTypeContext@UDwmTouchInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@QEAAJAEBUInteractionStateInfo@@PEAUTemporaryConfiguration@@@Z @ 0x1801AD2E0
 * Callers:
 ...
 *     ?UpdateActiveConfig@?$CInputTypeContext@UDwmTouchInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@QEAAXAEBUDwmTouchInteractionConfigurationPrimitive@@@Z @ 0x1801B08F4 (-UpdateActiveConfig@-$CInputTypeContext@UDwmTouchInteractionConfigurationPrimitive@@U-$TMILFlags.c)
 */
  ...
  if ( v16 == 2 && ((*((_BYTE *)a1 + 136) ^ (*((_BYTE *)a1 + 148) >> 1)) & 1) != 0 )
  {
      ...
      && tlgKeywordOn((__int64)&dword_1803E3798, 2LL) )
    {
      *(_QWORD *)&v30 = a1;
      v33 = &v30;
      v34 = 8LL;
      tlgWriteTransfer_EventWriteTransfer(v17, (unsigned __int8 *)dword_18037E1A3, 0LL, 0LL, 3u, &v32);
      v16 = *((_DWORD *)a1 + 39);
      v8 = 1;
    }
  }
