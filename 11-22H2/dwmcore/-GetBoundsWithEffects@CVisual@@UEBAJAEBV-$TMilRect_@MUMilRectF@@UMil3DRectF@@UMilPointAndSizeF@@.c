/*
 * XREFs of ?GetBoundsWithEffects@CVisual@@UEBAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x1800C5A20
 * Callers:
  ...
  *(_OWORD *)a3 = *a2;
  ...
  if ( (*v7 & 0x400000) != 0 )
  {
    ...
    if ( v14 )
    {
      ...
      if ( (int)result < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, result, 0x185Du, 0LL);
        return v20;
      }
      return result;
    }
  ...
  if ( CVisual::GetEffectiveSize(this, &v21, &v23) || v15 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, Bounds, 0x1871u, 0LL);
      return Bounds;
    }
  }
