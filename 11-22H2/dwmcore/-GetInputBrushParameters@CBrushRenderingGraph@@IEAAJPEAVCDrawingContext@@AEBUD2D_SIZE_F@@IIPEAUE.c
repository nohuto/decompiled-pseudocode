/*
 * XREFs of ?GetInputBrushParameters@CBrushRenderingGraph@@IEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@IIPEAUEffectInput@@@Z @ 0x18002E834
 * Callers:
 ...
 *     ?DoesSurfaceHaveBorder@CRenderingTechnique@@QEBA_NI@Z @ 0x1802B9C9C (-DoesSurfaceHaveBorder@CRenderingTechnique@@QEBA_NI@Z.c)
 */
