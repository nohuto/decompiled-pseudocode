/*
 * XREFs of ?ValidateRootAndSourceRectangle@CBackdropVisualImage@@QEAAJPEAVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@_NPEA_N@Z @ 0x18004CA84
 * Callers:
 ...
 *     ?GetMinSupportedMax2DTextureSize@CComposition@@QEBA?BIXZ @ 0x18004CDD4 (-GetMinSupportedMax2DTextureSize@CComposition@@QEBA-BIXZ.c)
        ...
        char *a5)
{
  ...
  *((float *)this + 464) = v20;
  ...
  if ( v14 )
  {
    v28 = DwmDbg::DbgString::DbgString((DwmDbg::DbgString *)v40.m[2], word_18033C020);
