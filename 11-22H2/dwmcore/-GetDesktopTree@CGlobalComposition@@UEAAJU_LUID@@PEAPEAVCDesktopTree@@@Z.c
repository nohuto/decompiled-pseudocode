/*
 * XREFs of ?GetDesktopTree@CGlobalComposition@@UEAAJU_LUID@@PEAPEAVCDesktopTree@@@Z @ 0x180032B30
 * Callers:
        ...
        struct CDesktopTree **a3)
{
  ...
  if ( DesktopTree < 0 && LowPart == dword_1803E43A0 && HighPart == dword_1803E43A4 )
  {
    ...
    if ( PrimaryMonitorTarget )
    {
      ...
      DesktopTree = v9;
      if ( v9 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_180356BC8, 2u, v9, 0x93u, 0LL);
    }
  }
