/*
 * XREFs of ?DrawSolidRectangle@CDrawingContext@@UEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBU_D3DCOLORVALUE@@@Z @ 0x1801D5470
 * Callers:
 *     <none>
 * Callees:
 ...
 *     gsl::final_action__lambda_b84a1ee213fa572390f758b550ef68e0___::_final_action__lambda_b84a1ee213fa572390f758b550ef68e0___ @ 0x1801D2EC0 (gsl--final_action__lambda_b84a1ee213fa572390f758b550ef68e0___--_final_action__lambda_b84a1ee213f.c)
 */
    ...
    && !TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::IsEmpty(a2) )
  {
    ...
    *(_DWORD *)(a1 + 324) = *(_DWORD *)(a1 + 344);
    ...
    if ( v13 )
    {
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x2A8u, 0LL);
      }
      else
      {
        ...
        if ( v18 )
        {
          ...
          *(unsigned __int64 *)((char *)v30 + 4) = *(_QWORD *)((char *)&v32 + 4);
          ...
          v4 = v22;
          if ( v22 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x2B7u, 0LL);
          operator delete(v20);
        }
        else
        {
          v4 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, -2147024882, 0x2B2u, 0LL);
        }
    ...
    else
    {
      ...
      *(unsigned __int64 *)((char *)v30 + 4) = *(_QWORD *)((char *)&v32 + 4);
      ...
      v4 = v26;
      if ( v26 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v26, 0x2BCu, 0LL);
    }
    if ( v28 )
