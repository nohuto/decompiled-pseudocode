/*
 * XREFs of ?AppendDirtyRegionVisualizationRects@CVisual@@AEAAJPEAV?$DynArray@UMilRectF@@$0A@@@@Z @ 0x180210770
 * Callers:
...
__int64 __fastcall CVisual::AppendDirtyRegionVisualizationRects(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(a2 + 24) )
  {
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, -2147024882, 0x15F6u, 0LL);
      goto LABEL_26;
    }
    v39 = _xmm;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x15F8u, 0LL);
      goto LABEL_26;
    }
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, -2147024882, 0x15FBu, 0LL);
      goto LABEL_26;
    }
    *v11 = 0LL;
    *((_DWORD *)v11 + 6) = 3;
    ...
    *((_OWORD *)v11 + 5) = v38;
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, -2147024882, 0x1608u, 0LL);
LABEL_24:
      operator delete(v13);
      goto LABEL_26;
    }
