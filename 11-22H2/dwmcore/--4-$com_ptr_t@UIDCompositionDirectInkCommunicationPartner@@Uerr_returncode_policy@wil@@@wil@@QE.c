/*
 * XREFs of ??4?$com_ptr_t@UIDCompositionDirectInkCommunicationPartner@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAUIDCompositionDirectInkCommunicationPartner@@@Z @ 0x180202A84
 * Callers:
