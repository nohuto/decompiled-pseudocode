/*
 * XREFs of ?Present@CConversionSwapChain@@UEAAJIIAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I@Z @ 0x1802A27C0
 * Callers:
 *     ?Present@CConversionSwapChain@@$4PPPPPPPM@DFI@EAAJIIAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I@Z @ 0x180121240 (-Present@CConversionSwapChain@@$4PPPPPPPM@DFI@EAAJIIAEBV-$vector@UtagRECT@@V-$allocator@UtagRECT.c)
 * Callees:
