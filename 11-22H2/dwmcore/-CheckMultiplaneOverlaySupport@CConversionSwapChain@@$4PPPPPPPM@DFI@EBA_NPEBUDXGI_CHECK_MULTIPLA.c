/*
 * XREFs of ?CheckMultiplaneOverlaySupport@CConversionSwapChain@@$4PPPPPPPM@DFI@EBA_NPEBUDXGI_CHECK_MULTIPLANEOVERLAYSUPPORT_PLANE_INFO@@IPEA_N@Z @ 0x180120E80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
