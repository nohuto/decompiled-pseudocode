/*
 * XREFs of ?ProcessSetTransformParent@CVisual@@QEAAJPEBVCResourceTable@@PEBUtagMILCMD_VISUAL_SETTRANSFORMPARENT@@@Z @ 0x1800F7190
 * Callers:
 ...
 *     ?GetTransformParentDataInternal@CVisual@@QEBAPEAUTransformParentData@@XZ @ 0x1800F7328 (-GetTransformParentDataInternal@CVisual@@QEBAPEAUTransformParentData@@XZ.c)
        ...
        const struct tagMILCMD_VISUAL_SETTRANSFORMPARENT *a3)
{
  ...
  if ( v9 )
  {
    ...
    {
      v5 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2003303421, 0x9BCu, 0LL);
      return v5;
    }
  ...
  if ( v10 != v15 )
  {
    ...
    if ( v10 )
    {
      ...
      if ( v17 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0, v17, 0x9CEu, 0LL);
        return v5;
      }
      if ( !v12 )
      {
