/*
 * XREFs of ?PreRender@CComputeScribbleRenderer@@QEAAJXZ @ 0x1801FBCCC
 * Callers:
 ...
 *     ?SetScannedOutBuffer@CComputeScribbleScheduler@@QEAAXII@Z @ 0x180203FD0 (-SetScannedOutBuffer@CComputeScribbleScheduler@@QEAAXII@Z.c)
