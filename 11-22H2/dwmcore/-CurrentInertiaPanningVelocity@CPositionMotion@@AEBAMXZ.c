/*
 * XREFs of ?CurrentInertiaPanningVelocity@CPositionMotion@@AEBAMXZ @ 0x18026F8D8
 * Callers:
 *     ?CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ @ 0x18026F950 (-CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ.c)
 * Callees:
