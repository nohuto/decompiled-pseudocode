/*
 * XREFs of ?GetOcclusionInfo@CTreeData@@QEAAPEAVCOcclusionInfo@@AEBVCBackdropVisualImageKey@@_N@Z @ 0x1800E994C
 * Callers:
 ...
 *     ?AgeOutOcclusionInfos@CTreeData@@IEAAXXZ @ 0x1800E99E8 (-AgeOutOcclusionInfos@CTreeData@@IEAAXXZ.c)
