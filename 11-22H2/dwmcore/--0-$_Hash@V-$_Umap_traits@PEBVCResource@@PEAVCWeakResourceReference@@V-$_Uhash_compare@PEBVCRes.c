 ...
 * Callers:
 *     ??0?$unordered_map@PEBVCResource@@PEAVCWeakResourceReference@@U?$hash@PEBVCResource@@@std@@U?$equal_to@PEBVCResource@@@4@V?$allocator@U?$pair@QEBVCResource@@PEAVCWeakResourceReference@@@std@@@4@@std@@QEAA@XZ @ 0x180024A80 (--0-$unordered_map@PEBVCResource@@PEAVCWeakResourceReference@@U-$hash@PEBVCResource@@@std@@U-$eq.c)
 * Callees:
        ...
        int *a2)
{
  ...
  *v3 = v3;
  v3[1] = v3;
  qword_1803E62F8 = 0LL;
  xmmword_1803E6300 = 0LL;
  CWeakResourceReference::s_weakReferenceMap = (int)FLOAT_1_0;
  qword_1803E62E8 = (__int64)v3;
  xmmword_1803E6310 = (__int128)si128;
  std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<CResource const * const,CWeakResourceReference *>>>>>>::_Assign_grow(
    (unsigned __int64 **)&qword_1803E62F8,
    0x10uLL,
    (unsigned __int64)v3);
