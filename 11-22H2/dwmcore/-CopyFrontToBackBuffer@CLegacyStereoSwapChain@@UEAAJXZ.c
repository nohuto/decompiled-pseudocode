/*
 * XREFs of ?CopyFrontToBackBuffer@CLegacyStereoSwapChain@@UEAAJXZ @ 0x1802A00F0
 * Callers:
 *     ?CopyFrontToBackBuffer@CLegacyStereoSwapChain@@$4PPPPPPPM@BLI@EAAJXZ @ 0x180120820 (-CopyFrontToBackBuffer@CLegacyStereoSwapChain@@$4PPPPPPPM@BLI@EAAJXZ.c)
 * Callees:
