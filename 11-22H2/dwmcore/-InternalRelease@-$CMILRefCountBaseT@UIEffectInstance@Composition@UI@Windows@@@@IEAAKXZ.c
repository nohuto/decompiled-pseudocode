/*
 * XREFs of ?InternalRelease@?$CMILRefCountBaseT@UIEffectInstance@Composition@UI@Windows@@@@IEAAKXZ @ 0x1800FE26C
 * Callers:
 ...
 *     ?Release@CRadialGradientEffect@@UEAAKXZ @ 0x1800FE260 (-Release@CRadialGradientEffect@@UEAAKXZ.c)
