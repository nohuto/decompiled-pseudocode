/*
 * XREFs of ?GetPixelFormatInfo@CVisualBitmap@@UEBA?AUPixelFormatInfo@@XZ @ 0x18021F4B0
 * Callers:
 *     ?IsOpaque@CVisualBitmap@@UEBA_NXZ @ 0x1801C5920 (-IsOpaque@CVisualBitmap@@UEBA_NXZ.c)
 * Callees:
