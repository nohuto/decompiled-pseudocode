/*
 * XREFs of ?_Change_array@?$vector@PEAVCProjectedShadowCaster@@V?$allocator@PEAVCProjectedShadowCaster@@@std@@@std@@AEAAXQEAPEAVCProjectedShadowCaster@@_K1@Z @ 0x18001D2B0
 * Callers:
