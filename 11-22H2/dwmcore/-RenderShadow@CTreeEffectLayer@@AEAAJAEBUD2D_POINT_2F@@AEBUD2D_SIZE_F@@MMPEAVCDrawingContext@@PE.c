/*
 * XREFs of ?RenderShadow@CTreeEffectLayer@@AEAAJAEBUD2D_POINT_2F@@AEBUD2D_SIZE_F@@MMPEAVCDrawingContext@@PEAVCDropShadow@@PEAVIRenderTargetBitmap@@@Z @ 0x18000F2AC
 * Callers:
...
LABEL_50:
  ...
  Microsoft::WRL::ComPtr<CBaseExpression>::~ComPtr<CBaseExpression>(&v86);
  return v24;
}
