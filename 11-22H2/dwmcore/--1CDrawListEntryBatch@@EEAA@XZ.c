/*
 * XREFs of ??1CDrawListEntryBatch@@EEAA@XZ @ 0x18020A7F4
 * Callers:
 ...
 *     ??1?$deque@VCMegaRect@@V?$allocator@VCMegaRect@@@std@@@std@@QEAA@XZ @ 0x18020A7C8 (--1-$deque@VCMegaRect@@V-$allocator@VCMegaRect@@@std@@@std@@QEAA@XZ.c)
 */
