/*
 * XREFs of ?RemoveSourceEntry@DataProviderProxy@@QEAAJPEAVBamoDataSourceProxy@@@Z @ 0x1801E5104
 * Callers:
 ...
 *     ?_Reallocate_exactly@?$vector@_KV?$allocator@_K@std@@@std@@AEAAX_K@Z @ 0x1801E53D0 (-_Reallocate_exactly@-$vector@_KV-$allocator@_K@std@@@std@@AEAAX_K@Z.c)
 */
