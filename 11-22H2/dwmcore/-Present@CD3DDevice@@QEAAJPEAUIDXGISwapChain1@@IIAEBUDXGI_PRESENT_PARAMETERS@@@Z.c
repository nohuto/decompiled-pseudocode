/*
 * XREFs of ?Present@CD3DDevice@@QEAAJPEAUIDXGISwapChain1@@IIAEBUDXGI_PRESENT_PARAMETERS@@@Z @ 0x18028E5EC
 * Callers:
        ...
        const struct DXGI_PRESENT_PARAMETERS *a5)
{
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1803BA010, 2u, v5, 0xA25u, 0LL);
  }
  else
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1803BA010, 2u, v7, 0xA2Bu, 0LL);
    }
    else
    {
