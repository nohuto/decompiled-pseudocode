/*
 * XREFs of ??$ProducesUniformZ@$0A@@CMILMatrix@@AEBA_NXZ @ 0x1800621BC
 * Callers:
 *     ??$IsIdentity@$0A@@CMILMatrix@@AEBA_NXZ @ 0x1800622B0 (--$IsIdentity@$0A@@CMILMatrix@@AEBA_NXZ.c)
 *     ??$IsPure2DUniformZ@$0A@@CMILMatrix@@AEBA_NXZ @ 0x18026FE58 (--$IsPure2DUniformZ@$0A@@CMILMatrix@@AEBA_NXZ.c)
 * Callees:
 *     <none>
 */
