/*
 * XREFs of ?SendDisposeProxy@BamoPeerImpl@DiagnosticCallbacks_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x1801BAE20
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  LODWORD(v6) = a2;
  v4 = CoreUICallSend(v3, v7, 2LL, 1LL, 6, &unk_18035672D, v6);
  if ( v4 < 0 )
