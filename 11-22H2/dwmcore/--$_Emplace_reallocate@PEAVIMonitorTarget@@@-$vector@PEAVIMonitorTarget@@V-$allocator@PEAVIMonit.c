/*
 * XREFs of ??$_Emplace_reallocate@PEAVIMonitorTarget@@@?$vector@PEAVIMonitorTarget@@V?$allocator@PEAVIMonitorTarget@@@std@@@std@@QEAAPEAPEAVIMonitorTarget@@QEAPEAV2@$$QEAPEAV2@@Z @ 0x18020FAB0
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAVIMonitorTarget@@V?$allocator@PEAVIMonitorTarget@@@std@@@std@@AEAAXQEAPEAVIMonitorTarget@@_K1@Z @ 0x18021000C (-_Change_array@-$vector@PEAVIMonitorTarget@@V-$allocator@PEAVIMonitorTarget@@@std@@@std@@AEAAXQE.c)
 */
