/*
 * XREFs of ?_Change_array@?$vector@PEAVCDataSourceReader@@V?$allocator@PEAVCDataSourceReader@@@std@@@std@@AEAAXQEAPEAVCDataSourceReader@@_K1@Z @ 0x1801B7F14
 * Callers:
...
__int64 __fastcall std::vector<CDataSourceReader *>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  void *v6; // rcx
  __int64 result; // rax
