/*
 * XREFs of ??0CRenderTargetBitmap@@IEAA@_N@Z @ 0x18003C2F0
 * Callers:
 *     ??0CDecodeBitmap@@QEAA@XZ @ 0x18001BDD4 (--0CDecodeBitmap@@QEAA@XZ.c)
 *     ??0CScratchRenderTargetBitmap@@IEAA@XZ @ 0x18003BF2C (--0CScratchRenderTargetBitmap@@IEAA@XZ.c)
 ...
 *     ??0IRenderTargetBitmap@@QEAA@XZ @ 0x18003C560 (--0IRenderTargetBitmap@@QEAA@XZ.c)
 */
