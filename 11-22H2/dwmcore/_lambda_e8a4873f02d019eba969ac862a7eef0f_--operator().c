        ...
        char a6)
{
  ...
  if ( (unsigned int)dword_1803E3B40 > 5 && (byte_1803E3B50 & 1) != 0 )
  {
    result = qword_1803E3B58 & 1;
    if ( result == qword_1803E3B58 )
    {
      v15 = v21;
      v17 = v19;
      v12 = (a6 & 4) != 0;
