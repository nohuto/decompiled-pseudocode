/*
 * XREFs of ?NotifyMetaData@CDummyRemotingSwapChain@@UEAAJAEBU_DWMIndirectMetaData@@@Z @ 0x180299AB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DWMIndirectMetaData *a2)
{
  ...
  v2 = v5;
  if ( v5 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xA6u, 0LL);
  return v2;
}
