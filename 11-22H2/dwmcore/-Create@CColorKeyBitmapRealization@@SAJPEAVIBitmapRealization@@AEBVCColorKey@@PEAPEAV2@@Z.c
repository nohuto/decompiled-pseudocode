/*
 * XREFs of ?Create@CColorKeyBitmapRealization@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV2@@Z @ 0x1802B0478
 * Callers:
 ...
 *     ??0CColorKeyBitmapRealization@@QEAA@XZ @ 0x1802B0350 (--0CColorKeyBitmapRealization@@QEAA@XZ.c)
