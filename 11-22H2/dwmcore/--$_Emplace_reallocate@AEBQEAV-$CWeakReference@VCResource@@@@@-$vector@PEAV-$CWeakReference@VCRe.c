/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAV?$CWeakReference@VCResource@@@@@?$vector@PEAV?$CWeakReference@VCResource@@@@V?$allocator@PEAV?$CWeakReference@VCResource@@@@@std@@@std@@QEAAPEAPEAV?$CWeakReference@VCResource@@@@QEAPEAV2@AEBQEAV2@@Z @ 0x1801E236C
 * Callers:
 ...
 *     ?_Change_array@?$vector@PEAV?$CWeakReference@VCResource@@@@V?$allocator@PEAV?$CWeakReference@VCResource@@@@@std@@@std@@AEAAXQEAPEAV?$CWeakReference@VCResource@@@@_K1@Z @ 0x1801E3CE8 (-_Change_array@-$vector@PEAV-$CWeakReference@VCResource@@@@V-$allocator@PEAV-$CWeakReference@VCR.c)
 */
        ...
        _QWORD *a3)
{
  ...
  *(_QWORD *)v14 = *a3;
  ...
  std::vector<CWeakReference<CResource> *,std::allocator<CWeakReference<CResource> *>>::_Change_array(a1, v13, v9, v3);
  return v14;
}
