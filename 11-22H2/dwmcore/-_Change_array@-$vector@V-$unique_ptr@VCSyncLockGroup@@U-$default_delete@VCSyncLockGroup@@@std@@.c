/*
 * XREFs of ?_Change_array@?$vector@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@V?$allocator@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@@2@@std@@AEAAXQEAV?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@2@_K1@Z @ 0x1801E6D34
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( CSyncLockGroup::g_syncLockGroups )
  {
    std::_Destroy_range<std::allocator<std::unique_ptr<CSyncLockGroup>>>(
      ...
      (void ***)qword_1803E6328);
    std::_Deallocate<16,0>(
      (void *)CSyncLockGroup::g_syncLockGroups,
      (qword_1803E6330 - CSyncLockGroup::g_syncLockGroups) & 0xFFFFFFFFFFFFFFF8uLL);
  }
  CSyncLockGroup::g_syncLockGroups = a2;
  qword_1803E6328 = a2 + 8 * a3;
  result = a2 + 8 * a4;
  qword_1803E6330 = result;
  return result;
}
