/*
 * XREFs of ?GetTightBounds@CRectanglesShape@@UEBAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x180062490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$IsAffine@$0A@@CMILMatrix@@AEBA_N_N@Z @ 0x180062240 (--$IsAffine@$0A@@CMILMatrix@@AEBA_N_N@Z.c)
