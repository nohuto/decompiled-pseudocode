 ...
 *     ??$_Emplace_reallocate@AEBQEAVIDDisplayEventListener@@@?$vector@PEAVIDDisplayEventListener@@V?$allocator@PEAVIDDisplayEventListener@@@std@@@std@@QEAAPEAPEAVIDDisplayEventListener@@QEAPEAV2@AEBQEAV2@@Z @ 0x18029158C (--$_Emplace_reallocate@AEBQEAVIDDisplayEventListener@@@-$vector@PEAVIDDisplayEventListener@@V-$a.c)
        ...
        struct RenderTargetInfo *a8)
{
  ...
  *(_QWORD *)(a1 + 272) = v19;
  ...
  if ( (_QWORD)xmmword_1803E6550 == *((_QWORD *)&xmmword_1803E6550 + 1) )
  {
    std::vector<IDDisplayEventListener *>::_Emplace_reallocate<IDDisplayEventListener * const &>(
      (const void **)&xmmword_1803E6540 + 1,
      (_BYTE *)xmmword_1803E6550,
      &a8);
  }
  else
  {
    *(_QWORD *)xmmword_1803E6550 = a1 + 224;
