/*
 * XREFs of ?BoostFrameRate@CLegacySwapChain@@UEAA_N_N@Z @ 0x18029A980
 * Callers:
 *     ?BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@BLA@EAA_N_N@Z @ 0x18011F6C0 (-BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@BLA@EAA_N_N@Z.c)
 *     ?BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@BLI@EAA_N_N@Z @ 0x180120740 (-BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@BLI@EAA_N_N@Z.c)
 *     ?BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@DFI@EAA_N_N@Z @ 0x180120E20 (-BoostFrameRate@CLegacySwapChain@@$4PPPPPPPM@DFI@EAA_N_N@Z.c)
 * Callees:
 ...
 *     ?IsValidVariableRefreshDuration@CLegacySwapChain@@IEBA_N_K@Z @ 0x18029B70C (-IsValidVariableRefreshDuration@CLegacySwapChain@@IEBA_N_K@Z.c)
 */
