/*
 * XREFs of ??1FeatureStateManager@details@wil@@QEAA@XZ @ 0x180198000
 * Callers:
 ...
 * Callees:
 *     ?wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ @ 0x180101760 (-wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ.c)
 ...
 *     ?Destroy@?$DestroyThreadPoolTimer@USystemThreadPoolMethods@details@wil@@$0A@@details@wil@@SAXPEAU_TP_TIMER@@@Z @ 0x180198664 (-Destroy@-$DestroyThreadPoolTimer@USystemThreadPoolMethods@details@wil@@$0A@@details@wil@@SAXPEA.c)
...
void __fastcall wil::details::FeatureStateManager::~FeatureStateManager(wil::details::FeatureStateManager *this)
{
  ...
  *((_QWORD *)this + 32) = 0LL;
  ...
  if ( v4 )
  {
    v2 = (void *)*((_QWORD *)&xmmword_1803E5CF8 + 1);
    if ( *((_QWORD *)&xmmword_1803E5CF8 + 1) )
      wil::details_abi::SubscriptionList::Unsubscribe(
        (LPCRITICAL_SECTION)(*((_QWORD *)&xmmword_1803E5CF8 + 1) + 200LL),
        *((PSRWLOCK *)&xmmword_1803E5CF8 + 1),
        v4);
  }
