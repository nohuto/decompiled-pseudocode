/*
 * XREFs of ?HrCreateBitmapFromMemoryEx@@YAJIIAEBUPixelFormatInfo@@IIPEAEPEAUIUnknown@@PEAPEAVIBitmapSource@@@Z @ 0x1800A7DA4
 * Callers:
 ...
 *     ??0CClientMemoryBitmap@@QEAA@XZ @ 0x1800A7E84 (--0CClientMemoryBitmap@@QEAA@XZ.c)
