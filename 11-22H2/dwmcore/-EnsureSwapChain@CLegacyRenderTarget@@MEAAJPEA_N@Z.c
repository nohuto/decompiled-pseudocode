/*
 * XREFs of ?EnsureSwapChain@CLegacyRenderTarget@@MEAAJPEA_N@Z @ 0x1800C8F30
 * Callers:
 *     <none>
 * Callees:
  ...
  *a2 = 0;
  ...
  if ( !v4 )
  {
    ...
    *((_DWORD *)this + 4614) = *((_DWORD *)this + 4606);
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180356BA8, 4u, v10, 0x466u, 0LL);
      goto LABEL_18;
    }
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, &dword_180356BA8, 4u, v12, 0x471u, 0LL);
      goto LABEL_18;
    }
    ...
    if ( Device < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_180356BA8, 4u, Device, 0x473u, 0LL);
      v25 = v29;
      if ( !v29 )
        goto LABEL_18;
      goto LABEL_17;
...
LABEL_11:
        ...
        *((_DWORD *)this + 4613) = (*(__int64 (__fastcall **)(struct ILegacySwapChain *))(*(_QWORD *)v21 + 64LL))(v21);
        ...
        if ( v22 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_180356BA8, 4u, v22, 0x496u, 0LL);
        }
        else
        {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v27, &dword_180356BA8, 4u, ConversionSwapChain, 0x48Fu, 0LL);
    }
    else
    {
      wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::reset(v2);
      ...
      if ( LegacySwapChain >= 0 )
        goto LABEL_11;
      MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_180356BA8, 4u, LegacySwapChain, 0x482u, 0LL);
    }
LABEL_15:
    if ( !v17 )
    {
...
LABEL_17:
  ...
  {
    v6 = -2003304442;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180356BA8, 4u, -2003304442, 0x45Bu, 0LL);
    goto LABEL_32;
  }
  return v6;
}
