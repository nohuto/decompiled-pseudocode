/*
 * XREFs of ?HideVisuals@COffScreenRenderTarget@@MEAAXXZ @ 0x1801E9F00
 * Callers:
 *     ?HideVisuals@CMagnifierRenderTarget@@MEAAXXZ @ 0x1801F0270 (-HideVisuals@CMagnifierRenderTarget@@MEAAXXZ.c)
 * Callees:
