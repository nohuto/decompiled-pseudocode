/*
 * XREFs of InitializeShaderLinkingInput @ 0x180026F1C
 * Callers:
 ...
 *     GetHlslNameAndSemantic @ 0x1800270AC (GetHlslNameAndSemantic.c)
...
__int64 __fastcall InitializeShaderLinkingInput(struct ID3D11Linker **ppLinker, __int64 a2, VertexShaderDesc *a3)
{
  ...
  v7 = *((_QWORD *)&unk_1802CE040 + 2 * (v4 & 0xFFFFFFEF));
  v8 = v7;
  v19 = *((_OWORD *)&unk_1802CE040 + (v4 & 0xFFFFFFEF));
  v9 = *((_QWORD *)&v19 + 1);
  if ( (_DWORD)v7 )
  {
    while ( 1 )
