/*
 * XREFs of ??_GCSpectreCallbackRenderer@@UEAAPEAXI@Z @ 0x1801FDB24
 * Callers:
 *     ??_ECSpectreCallbackRenderer@@W7EAAPEAXI@Z @ 0x18011DA60 (--_ECSpectreCallbackRenderer@@W7EAAPEAXI@Z.c)
 * Callees:
