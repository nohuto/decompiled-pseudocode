/*
 * XREFs of ?AdvanceFrame@CDeviceManager@@IEAAXXZ @ 0x1800764A4
 * Callers:
 ...
 *     ??$_Emplace_reallocate@AEBQEAVCD3DDevice@@@?$vector@PEAVCD3DDevice@@V?$allocator@PEAVCD3DDevice@@@std@@@std@@QEAAPEAPEAVCD3DDevice@@QEAPEAV2@AEBQEAV2@@Z @ 0x180285CD4 (--$_Emplace_reallocate@AEBQEAVCD3DDevice@@@-$vector@PEAVCD3DDevice@@V-$allocator@PEAVCD3DDevice@.c)
...
void __fastcall CDeviceManager::AdvanceFrame(CDeviceManager *this)
{
  ...
  v4 = 0LL;
  v56 = qword_1803EA158;
  v48 = xmmword_1803EA160;
  if ( qword_1803EA158 != (_QWORD)xmmword_1803EA160 )
  {
    while ( 1 )
    {
      v5 = 0LL;
