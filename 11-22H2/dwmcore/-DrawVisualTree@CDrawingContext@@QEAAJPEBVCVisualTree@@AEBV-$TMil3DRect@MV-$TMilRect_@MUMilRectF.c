/*
 * XREFs of ?DrawVisualTree@CDrawingContext@@QEAAJPEBVCVisualTree@@AEBV?$TMil3DRect@MV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@UMil3DRectF@@UNotNeeded@RectUniqueness@@@@PEBVCOcclusionContext@@W4Enum@ClearMode@@_NPEAVCVisual@@@Z @ 0x180087B2C
 * Callers:
 ...
 *     ??$make_unique@VCVisualTreePath@@AEAV1@$0A@@std@@YA?AV?$unique_ptr@VCVisualTreePath@@U?$default_delete@VCVisualTreePath@@@std@@@0@AEAVCVisualTreePath@@@Z @ 0x180019334 (--$make_unique@VCVisualTreePath@@AEAV1@$0A@@std@@YA-AV-$unique_ptr@VCVisualTreePath@@U-$default_.c)
 *     ??$?4U?$default_delete@VCVisualTreePath@@@std@@$0A@@?$unique_ptr@VCVisualTreePath@@U?$default_delete@VCVisualTreePath@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x180019A50 (--$-4U-$default_delete@VCVisualTreePath@@@std@@$0A@@-$unique_ptr@VCVisualTreePath@@U-$default_de.c)
 ...
 *     ??1DrawVisualTreeData@CDrawingContext@@QEAA@XZ @ 0x18008AA1C (--1DrawVisualTreeData@CDrawingContext@@QEAA@XZ.c)
 ...
 *     ?Pop@?$CWatermarkStack@I$0EA@$01$09@@QEAA_NPEAI@Z @ 0x1801D6010 (-Pop@-$CWatermarkStack@I$0EA@$01$09@@QEAA_NPEAI@Z.c)
  ...
  *((float *)&v104 + 3) = (float)SHIDWORD(v103);
  if ( (float)SDWORD2(v103) > (float)(int)v103 && (float)SHIDWORD(v103) > (float)SDWORD1(v103) )
  {
    ...
    if ( v23 )
    {
      ...
      if ( v28 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, v28, 0x13F1u, 0LL);
        goto LABEL_59;
      }
    }
    else
...
LABEL_105:
    ...
    *((_BYTE *)this + 8049) = 1;
    *((_BYTE *)this + 193) = 0;
    if ( dword_1803E3760 && ((*((_BYTE *)v7 + 272) & 5) != 0 || *((int *)v7 + 66) > 0 || *((int *)v7 + 67) > 0) )
    {
