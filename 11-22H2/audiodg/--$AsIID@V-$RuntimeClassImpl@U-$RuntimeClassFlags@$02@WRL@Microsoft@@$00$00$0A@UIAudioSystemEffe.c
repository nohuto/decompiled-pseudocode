        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    if ( InlineIsEqualGUID(v7, v6) || InlineIsEqualGUID(v8, &GUID_20049d40_56d5_400e_a2ef_385599feed49) )
    {
      *v9 = v10;
      CanCastTo = 0;
    }
