 ...
 *     ??1?$com_ptr_t@VCDeviceGraphObjectCache@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x1400709D8 (--1-$com_ptr_t@VCDeviceGraphObjectCache@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ.c)
 *     ??1SyncLockExclusive@Details@Wrappers@WRL@Microsoft@@QEAA@XZ @ 0x140070BD0 (--1SyncLockExclusive@Details@Wrappers@WRL@Microsoft@@QEAA@XZ.c)
 */
