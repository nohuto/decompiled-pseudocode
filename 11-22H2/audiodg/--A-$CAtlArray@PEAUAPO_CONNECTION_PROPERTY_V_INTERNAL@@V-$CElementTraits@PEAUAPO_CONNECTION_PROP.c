/*
 * XREFs of ??A?$CAtlArray@PEAUAPO_CONNECTION_PROPERTY_V_INTERNAL@@V?$CElementTraits@PEAUAPO_CONNECTION_PROPERTY_V_INTERNAL@@@ATL@@@ATL@@QEAAAEAPEAUAPO_CONNECTION_PROPERTY_V_INTERNAL@@_K@Z @ 0x140039B02
 * Callers:
