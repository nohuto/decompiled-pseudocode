/*
 * XREFs of ??1?$unique_ptr@UAUDIO_VOLUME_NOTIFICATION_DATA2@@U?$default_delete@UAUDIO_VOLUME_NOTIFICATION_DATA2@@@std@@@std@@QEAA@XZ @ 0x14006BACC
 * Callers:
 ...
 *     _GetAudioVolumeNotificationData_::_1_::dtor$1 @ 0x14006CA45 (_GetAudioVolumeNotificationData_--_1_--dtor$1.c)
