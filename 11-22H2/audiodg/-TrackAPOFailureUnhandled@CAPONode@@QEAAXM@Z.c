/*
 * XREFs of ?TrackAPOFailureUnhandled@CAPONode@@QEAAXM@Z @ 0x14008EACC
 * Callers:
 *     ?TrackAPOFailureUnhandled@CAudioProcessor@@UEAAJM@Z @ 0x14008F690 (-TrackAPOFailureUnhandled@CAudioProcessor@@UEAAJM@Z.c)
 * Callees:
