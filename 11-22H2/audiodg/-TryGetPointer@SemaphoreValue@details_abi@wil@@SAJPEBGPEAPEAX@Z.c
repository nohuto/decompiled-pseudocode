/*
 * XREFs of ?TryGetPointer@SemaphoreValue@details_abi@wil@@SAJPEBGPEAPEAX@Z @ 0x14004E6C8
 * Callers:
        ...
        bool *a4)
{
  ...
  *a2 = 0LL;
  ...
  else
  {
    ...
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x6B, (__int64)"wil", (const char *)v6);
    return v6;
  }
}
