/*
 * XREFs of ?AddAPOOutputConnection@CAudioProcessor@@UEAAJ_KPEAUIAudioProcessingObject@@0@Z @ 0x1400107B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_42:
  ...
  if ( *(_QWORD *)(APOInList + 168) == *((_DWORD *)pv + 266) )
  {
    v9 = -2005139429;
    v28 = 2619LL;
LABEL_37:
...
LABEL_39:
  ...
  if ( (int)CAudioProcessor::FindConnectionIndex(v16, (_QWORD *)(v38 + 160), (__int64)ConnectionInObjectCache, &v48) >= 0 )
  {
    v9 = -2147024809;
    v28 = 2627LL;
    goto LABEL_37;
  }
  v20 = CAudioProcessor::ValidateConnection(v18, v17, v19, (__int64)pv, (__int64 **)(v38 + 128));
  v21 = v20;
  if ( v20 >= 0 )
  {
    v42 = ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::Add(v38 + 160, &v41);
    *(_QWORD *)&v39 = &v38;
    *((_QWORD *)&v39 + 1) = &v42;
    v45 = v39;
    v46 = 1;
    ...
    *(_QWORD *)(v17 + 152) = this;
    ...
    wil::details::in1diag3::Return_Hr(
      ...
      v33);
    ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::RemoveAt(v38 + 288, v43);
    ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::RemoveAt(v38 + 160, v42);
    goto LABEL_39;
  }
  wil::details::in1diag3::Return_Hr(
    retaddr,
