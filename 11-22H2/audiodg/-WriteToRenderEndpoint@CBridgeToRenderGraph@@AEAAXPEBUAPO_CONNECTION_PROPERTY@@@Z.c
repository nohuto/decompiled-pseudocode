/*
 * XREFs of ?WriteToRenderEndpoint@CBridgeToRenderGraph@@AEAAXPEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x14007A5E4
 * Callers:
 *     ?OnAudioPacket@CBridgeToRenderGraph@@UEAAXPEBUAE_CURRENT_POSITION@@PEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x1400396D0 (-OnAudioPacket@CBridgeToRenderGraph@@UEAAXPEBUAE_CURRENT_POSITION@@PEBUAPO_CONNECTION_PROPERTY@@.c)
