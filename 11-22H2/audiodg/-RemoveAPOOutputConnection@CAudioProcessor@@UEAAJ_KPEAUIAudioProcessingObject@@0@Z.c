/*
 * XREFs of ?RemoveAPOOutputConnection@CAudioProcessor@@UEAAJ_KPEAUIAudioProcessingObject@@0@Z @ 0x14000E910
 * Callers:
 *     <none>
 * Callees:
...
LABEL_24:
  ...
  ConnectionIndex = CAudioProcessor::FindConnectionIndex(v15, APOInList + 160, ConnectionInObjectCache, &v24);
  v18 = ConnectionIndex;
  ...
  ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::RemoveAt(APOInList + 160, v24);
  ATL::CAtlArray<CConnectionNode *,CConnectionNodeTraits>::RemoveAt(APOInList + 288, v24);
  --*((_DWORD *)v16 + 3);
