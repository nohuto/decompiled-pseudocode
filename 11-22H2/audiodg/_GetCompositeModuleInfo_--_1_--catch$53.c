/*
 * XREFs of _GetCompositeModuleInfo_::_1_::catch$53 @ 0x14006557B
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GetCompositeModuleInfo_::_1_::catch_53(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
