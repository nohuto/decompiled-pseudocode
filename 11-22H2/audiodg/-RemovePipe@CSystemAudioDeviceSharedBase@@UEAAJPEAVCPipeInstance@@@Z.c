/*
 * XREFs of ?RemovePipe@CSystemAudioDeviceSharedBase@@UEAAJPEAVCPipeInstance@@@Z @ 0x140059B00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CPipeInstance *a2)
{
  ...
  if ( v6 )
    v4 = (*(__int64 (__fastcall **)(__int64, struct CPipeInstance *))(*(_QWORD *)v6 + 48LL))(v6, a2);
  else
    v4 = -2147467262;
