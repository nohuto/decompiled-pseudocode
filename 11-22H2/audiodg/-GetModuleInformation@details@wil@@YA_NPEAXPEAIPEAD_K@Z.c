/*
 * XREFs of ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x14004C714
 * Callers:
 *     ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x14004C340 (-GetCurrentModuleName@details@wil@@YAPEBDXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x140027DF0 (__security_check_cookie.c)
 *     ?StringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x14004E528 (-StringCchCopyA@@YAJPEAD_KPEBD@Z.c)
 */
