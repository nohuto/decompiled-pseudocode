/*
 * XREFs of ?CreateBridgeSinkProcessNode@CBridgeSinkProcessNode@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAPEAVCStreamProcessNode@@@Z @ 0x14005D558
 * Callers:
 ...
 *     ??1?$CAutoPtr@VCBridgeSinkProcessNode@@@ATL@@QEAA@XZ @ 0x14005C044 (--1-$CAutoPtr@VCBridgeSinkProcessNode@@@ATL@@QEAA@XZ.c)
 */

__int64 __fastcall CBridgeSinkProcessNode::CreateBridgeSinkProcessNode(
        ...
        struct CStreamProcessNode **a2)
{
  ...
  *((_DWORD *)v4 + 14) = 0;
  *((_QWORD *)v4 + 8) = 0LL;
  *(_QWORD *)v4 = &CBridgeSinkProcessNode::`vftable';
