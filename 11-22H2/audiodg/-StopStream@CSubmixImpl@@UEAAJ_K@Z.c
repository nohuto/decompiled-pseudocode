/*
 * XREFs of ?StopStream@CSubmixImpl@@UEAAJ_K@Z @ 0x140068F70
 * Callers:
 *     ?StopStream@CStreamGroup@@UEAAJ_K@Z @ 0x140052420 (-StopStream@CStreamGroup@@UEAAJ_K@Z.c)
 *     ?StopStream@CProcessSubmix@@UEAAJ_K@Z @ 0x140069550 (-StopStream@CProcessSubmix@@UEAAJ_K@Z.c)
 * Callees:
...
LABEL_3:
  ...
  (*(void (__fastcall **)(struct IStreamInstanceInternal *))(*(_QWORD *)Stream + 48LL))(Stream);
