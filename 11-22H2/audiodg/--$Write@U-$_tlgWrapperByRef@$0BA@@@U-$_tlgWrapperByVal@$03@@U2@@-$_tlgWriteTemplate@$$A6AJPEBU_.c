 ...
 * Callers:
 *     ?LogAsarUsageReporting@CSpatialCrossProcessEndpointTraceLogger@@QEAAXII@Z @ 0x14009C00C (-LogAsarUsageReporting@CSpatialCrossProcessEndpointTraceLogger@@QEAAXII@Z.c)
        ...
        __int64 a7)
{
  ...
  v10 = 16LL;
  v9 = *a5;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1400CE090, a2, a3, 0LL, 5u, &v8);
}
