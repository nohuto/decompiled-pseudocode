/*
 * XREFs of ??1CSpatialCrossProcessEndpointTraceLogger@@UEAA@XZ @ 0x14009B598
 * Callers:
        ...
        __int64 a2)
{
  ...
  *v3 = &CAggregateTelemetryLazyUpdate<CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues,enum SpatialObjectCountTypes,unsigned int,1,0>::`vftable';
  CAggregateTelemetry<CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues,enum SpatialObjectCountTypes,unsigned int,1,0>::~CAggregateTelemetry<CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues,enum SpatialObjectCountTypes,unsigned int,1,0>(
    (__int64)v3,
    a2);
  CAggregateTelemetryClustered<enum SpatialCpErrorEvent,unsigned int *,0,0>::~CAggregateTelemetryClustered<enum SpatialCpErrorEvent,unsigned int *,0,0>((__int64)this + 352);
  ...
  *((_QWORD *)this + 20) = &CAggregateValuesBase<enum SpatialObjectCountTypes,unsigned int>::`vftable';
  *((_QWORD *)this + 12) = &CAggregateValuesBase<enum SpatialCpErrorEvent,unsigned int *>::`vftable';
  *((_QWORD *)this + 3) = &CAggregateValuesBase<enum SpatialCpGlitchEvent,unsigned int *>::`vftable';
}
