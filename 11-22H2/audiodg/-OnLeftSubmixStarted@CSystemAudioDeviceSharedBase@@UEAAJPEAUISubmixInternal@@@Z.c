/*
 * XREFs of ?OnLeftSubmixStarted@CSystemAudioDeviceSharedBase@@UEAAJPEAUISubmixInternal@@@Z @ 0x14000A030
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISubmixInternal *a2)
{
  ...
  *(_OWORD *)v8 = *(_OWORD *)&this[-2].LockSemaphore;
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 26LL, &WPP_f9f744bd440f3e38c4fd26e2f9fecd86_Traceguids);
  }
  if ( HIDWORD(this[1].DebugInfo) != 1
    || (v5 = CSystemAudioDeviceSharedBase::SetGraphState(
               (unsigned __int64)&this[-8].OwningThread,
