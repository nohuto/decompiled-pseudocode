/*
 * XREFs of ?GetMany@?$Vector@UEventRegistrationToken@@UEventRegistrationTokenEqual@Internal@Devices@Media@Windows@@UPodLifetimeTraits@XWinRT@@U?$DefaultVectorOptions@UEventRegistrationToken@@@3Collections@Foundation@6@@Internal@Collections@Foundation@Windows@@UEAAJIIPEAUEventRegistrationToken@@PEAI@Z @ 0x140085CF0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a5)
{
  ...
  Block = 0LL;
  *a5 = 0;
  XWinRT::SerializingLockPolicy::Read(&v21, (RTL_SRWLOCK *)(a1 + 72), &v22);
