/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x140029A94
 * Callers:
 ...
 *     ?QueryInterface@CAudioMediaType@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14002A030 (-QueryInterface@CAudioMediaType@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
