/*
 * XREFs of ??$com_weak_query_nothrow@AEAV?$com_ptr_t@UIAudioProcessingObjectNotifications@@Uerr_returncode_policy@wil@@@wil@@@wil@@YAJAEAV?$com_ptr_t@UIAudioProcessingObjectNotifications@@Uerr_returncode_policy@wil@@@0@PEAPEAUIWeakReference@@@Z @ 0x1400384CA
 * Callers:
