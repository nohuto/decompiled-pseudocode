/*
 * XREFs of ??1?$CAggregateTelemetry@V?$CAggregateValuesClusteredBase@W4SpatialCpGlitchEvent@@PEAI@@W4SpatialCpGlitchEvent@@PEAI$0A@$0A@@@UEAA@XZ @ 0x14009B400
 * Callers:
 *     _CAggregateTelemetryClustered_enum_SpatialCpGlitchEvent_unsigned_int___0_0_::CAggregateTelemetryClustered_enum_SpatialCpGlitchEvent_unsigned_int___0_0__::_1_::dtor$0 @ 0x14009B12D (_CAggregateTelemetryClustered_enum_SpatialCpGlitchEvent_unsigned_int___0_0_--CAggregateTelemetry.c)
        ...
        __int64 a1)
{
  ...
  result = &CAggregateTelemetry<CAggregateValuesClusteredBase<enum SpatialCpGlitchEvent,unsigned int *>,enum SpatialCpGlitchEvent,unsigned int *,0,0>::`vftable';
