/*
 * XREFs of ?GetNextTimestampMessage@CCrossProcessBaseEndpoint@@IEAA_NPEAUSharedMessageQueueItem@@@Z @ 0x140095890
 * Callers:
        ...
        struct SharedMessageQueueItem *a2)
{
  ...
  if ( v21 != v17 )
  {
    ...
    {
      AudCPTraceLoggingErrorHelper("CCrossProcessBaseEndpoint::GetNextTimestampMessage", 0x592u, -2147467259);
    }
  }
  return v3;
}
