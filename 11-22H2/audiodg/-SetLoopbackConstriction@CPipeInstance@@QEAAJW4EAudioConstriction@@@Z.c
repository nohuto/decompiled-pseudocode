/*
 * XREFs of ?SetLoopbackConstriction@CPipeInstance@@QEAAJW4EAudioConstriction@@@Z @ 0x14005CE74
 * Callers:
...
__int64 __fastcall CPipeInstance::SetLoopbackConstriction(CPipeInstance *this, __int64 a2)
{
  ...
  if ( *((_DWORD *)this + 30) )
  {
    ...
    if ( v2 < 0 )
    {
      ...
      AudDGTraceLoggingErrorHelper("CPipeInstance::SetLoopbackConstriction", 0x10B4u, v2);
    }
  }
