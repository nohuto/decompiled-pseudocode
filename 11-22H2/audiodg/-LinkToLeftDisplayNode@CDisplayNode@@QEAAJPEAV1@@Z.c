/*
 * XREFs of ?LinkToLeftDisplayNode@CDisplayNode@@QEAAJPEAV1@@Z @ 0x140062DC0
 * Callers:
...
LABEL_17:
  try
  {
    v3 = 0;
    v13 = v4;
    ATL::CAtlList<CDisplayNode *,ATL::CElementTraits<CDisplayNode *>>::AddHead((__int64 *)v5 + 7, (__int64)&v13, v9);
  }
