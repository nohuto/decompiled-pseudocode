/*
 * XREFs of ?RemovePipeFromMixSplitConnection@CSystemAudioDeviceSharedBase@@UEAAJPEAVCPipeInstance@@@Z @ 0x140020A90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CPipeInstance *a2)
{
  ...
  ATL::CComQIPtr<IAudioDeviceGraphInternal,&__s_GUID const _GUID_1a06063b_0ec8_4ab1_9c8d_a19bde6941f3>::CComQIPtr<IAudioDeviceGraphInternal,&__s_GUID const _GUID_1a06063b_0ec8_4ab1_9c8d_a19bde6941f3>(
    ...
    *((_QWORD *)this + 3));
  if ( v6 )
    v4 = (*(__int64 (__fastcall **)(__int64, struct CPipeInstance *))(*(_QWORD *)v6 + 80LL))(v6, a2);
  else
    v4 = -2147467262;
