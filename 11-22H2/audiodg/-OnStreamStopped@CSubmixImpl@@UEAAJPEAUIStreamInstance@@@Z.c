/*
 * XREFs of ?OnStreamStopped@CSubmixImpl@@UEAAJPEAUIStreamInstance@@@Z @ 0x140009F50
 * Callers:
 *     ?OnStreamStopped@CProcessSubmix@@UEAAJPEAUIStreamInstance@@@Z @ 0x140009250 (-OnStreamStopped@CProcessSubmix@@UEAAJPEAUIStreamInstance@@@Z.c)
 *     ?OnStreamStopped@CStreamGroup@@UEAAJPEAUIStreamInstance@@@Z @ 0x140051590 (-OnStreamStopped@CStreamGroup@@UEAAJPEAUIStreamInstance@@@Z.c)
 * Callees:
