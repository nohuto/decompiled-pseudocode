/*
 * XREFs of ??1?$unique_ptr@VCAPOInstance@@U?$default_delete@VCAPOInstance@@@wistd@@@wistd@@QEAA@XZ @ 0x14005D128
 * Callers:
 ...
 *     _CAPOProcessNode::CreateAPOProcessNode_::_1_::dtor$5 @ 0x1400357E7 (_CAPOProcessNode--CreateAPOProcessNode_--_1_--dtor$5.c)
 * Callees:
