/*
 * XREFs of ??1CAudioProcessor@@QEAA@XZ @ 0x14008ECCC
 * Callers:
 *     ??1?$CComObject@VCAudioProcessor@@@ATL@@UEAA@XZ @ 0x14005E9E4 (--1-$CComObject@VCAudioProcessor@@@ATL@@UEAA@XZ.c)
 * Callees:
 ...
 *     ??1?$CRealTimeSafeStruct@VCProcessingData@@$00@@QEAA@XZ @ 0x14005EAA0 (--1-$CRealTimeSafeStruct@VCProcessingData@@$00@@QEAA@XZ.c)
