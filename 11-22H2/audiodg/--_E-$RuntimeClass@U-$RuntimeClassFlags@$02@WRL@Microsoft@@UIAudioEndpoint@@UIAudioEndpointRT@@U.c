/*
 * XREFs of ??_E?$RuntimeClass@U?$RuntimeClassFlags@$02@WRL@Microsoft@@UIAudioEndpoint@@UIAudioEndpointRT@@UIAudioOutputEndpointRT@@UIBridgeSourceEndpointControl@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x1400795F0
 * Callers:
 *     <none>
 * Callees:
