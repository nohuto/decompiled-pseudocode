/*
 * XREFs of McTemplateU0pxxxixqxxx_EtwEventWriteTransfer @ 0x1400392B2
 * Callers:
...
__int64 McTemplateU0pxxxixqxxx_EtwEventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  _BYTE v3[16]; // [rsp+30h] [rbp-A9h] BYREF
  ...
  v21 = 8LL;
  v23 = 8LL;
  return McGenEventWrite_EtwEventWriteTransfer(a1, (__int64)&AudioCore_Pump_CorrectPosition, v25, 11LL, (__int64)v3);
}
