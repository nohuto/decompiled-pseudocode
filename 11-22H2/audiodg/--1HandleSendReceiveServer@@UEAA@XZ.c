/*
 * XREFs of ??1HandleSendReceiveServer@@UEAA@XZ @ 0x14007B334
 * Callers:
 *     ??_EHandleSendReceiveServer@@UEAAPEAXI@Z @ 0x140039820 (--_EHandleSendReceiveServer@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x14007B6B4 (-SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ.c)
 */
