/*
 * XREFs of ?erase@?$_Hash@V?$_Umap_traits@PEAUIAudioProcessingObject@@V?$com_ptr_t@VCAPOProcessingHostObject@@Uerr_returncode_policy@wil@@@wil@@V?$_Uhash_compare@PEAUIAudioProcessingObject@@U?$hash@PEAUIAudioProcessingObject@@@std@@U?$equal_to@PEAUIAudioProcessingObject@@@3@@std@@V?$allocator@U?$pair@QEAUIAudioProcessingObject@@V?$com_ptr_t@VCAPOProcessingHostObject@@Uerr_returncode_policy@wil@@@wil@@@std@@@5@$0A@@std@@@std@@QEAA_KAEBQEAUIAudioProcessingObject@@@Z @ 0x140003C84
 * Callers:
 *     ?UnregisterAPOFromProcessingHost@CAPOProcessingHost@@UEAAXPEAUIAudioProcessingObject@@@Z @ 0x140003940 (-UnregisterAPOFromProcessingHost@CAPOProcessingHost@@UEAAXPEAUIAudioProcessingObject@@@Z.c)
 * Callees:
        ...
        const unsigned __int8 *a2)
{
  ...
  *(_QWORD *)v5[1] = v9;
  *(_QWORD *)(v9 + 8) = v5[1];
  wil::com_ptr_t<CPrivateAPO,wil::err_returncode_policy>::~com_ptr_t<CPrivateAPO,wil::err_returncode_policy>(v5 + 3);
