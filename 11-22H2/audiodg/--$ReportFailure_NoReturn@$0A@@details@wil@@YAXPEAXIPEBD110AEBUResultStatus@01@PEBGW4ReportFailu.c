/*
 * XREFs of ??$ReportFailure_NoReturn@$0A@@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x140056AE0
 * Callers:
 ...
 *     ?ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z @ 0x14004E640 (-ThrowResultException@wil@@YAXAEBUFailureInfo@1@@Z.c)
