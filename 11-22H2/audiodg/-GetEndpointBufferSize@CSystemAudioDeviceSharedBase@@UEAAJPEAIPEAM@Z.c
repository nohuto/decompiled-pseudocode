/*
 * XREFs of ?GetEndpointBufferSize@CSystemAudioDeviceSharedBase@@UEAAJPEAIPEAM@Z @ 0x140058ED0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, (__int64)&WPP_f9f744bd440f3e38c4fd26e2f9fecd86_Traceguids, *a2);
  }
  if ( v6 )
