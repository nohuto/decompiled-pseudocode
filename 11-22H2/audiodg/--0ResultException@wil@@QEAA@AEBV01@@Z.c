/*
 * XREFs of ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x14004B0C0
 * Callers:
 *     <none>
 * Callees:
 *     ??0exception@std@@QEAA@AEBV01@@Z @ 0x14004B1A0 (--0exception@std@@QEAA@AEBV01@@Z.c)
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x14004EC20 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
 */
