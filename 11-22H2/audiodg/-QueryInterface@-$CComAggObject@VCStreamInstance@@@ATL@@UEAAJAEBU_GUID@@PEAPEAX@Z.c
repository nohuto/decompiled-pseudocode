/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCStreamInstance@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14004D6C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATL::CComAggObject<CStreamInstance>::QueryInterface(__int64 a1, __int64 a2, _QWORD *a3)
{
  unsigned int v3; // edi
  __int64 v7; // rdx
  _QWORD *v8; // r8
