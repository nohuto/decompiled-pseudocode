/*
 * XREFs of ?PopulateAudioHistoryForStream@CSubmixImpl@@UEAAJ_K_J11H@Z @ 0x140068480
 * Callers:
 *     ?PopulateAudioHistoryForStream@CStreamGroup@@UEAAJ_K_J11H@Z @ 0x1400516D0 (-PopulateAudioHistoryForStream@CStreamGroup@@UEAAJ_K_J11H@Z.c)
 *     ?PopulateAudioHistoryForStream@CProcessSubmix@@UEAAJ_K_J11H@Z @ 0x140069300 (-PopulateAudioHistoryForStream@CProcessSubmix@@UEAAJ_K_J11H@Z.c)
 * Callees:
