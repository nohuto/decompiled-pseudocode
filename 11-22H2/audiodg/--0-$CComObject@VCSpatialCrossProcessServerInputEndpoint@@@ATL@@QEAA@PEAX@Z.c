/*
 * XREFs of ??0?$CComObject@VCSpatialCrossProcessServerInputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x140098F58
 * Callers:
        ...
        CSpatialCrossProcessServerInputEndpoint *a1)
{
  ...
  *((_QWORD *)a1 + 165) = &ATL::CComObject<CSpatialCrossProcessServerInputEndpoint>::`vftable'{for `IAudioCrossProcessServerEndpoint'};
  *((_QWORD *)a1 + 166) = &ATL::CComObject<CSpatialCrossProcessServerInputEndpoint>::`vftable'{for `ISpatialAudioCrossProcessServerEndpoint'};
  *((_QWORD *)a1 + 179) = &ATL::CComObject<CSpatialCrossProcessServerInputEndpoint>::`vftable';
