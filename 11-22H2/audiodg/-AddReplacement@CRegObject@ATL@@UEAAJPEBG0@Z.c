/*
 * XREFs of ?AddReplacement@CRegObject@ATL@@UEAAJPEBG0@Z @ 0x140090C50
 * Callers:
 ...
 *     ?Add@CExpansionVector@ATL@@QEAAHPEBG0@Z @ 0x14009090C (-Add@CExpansionVector@ATL@@QEAAHPEBG0@Z.c)
 */
