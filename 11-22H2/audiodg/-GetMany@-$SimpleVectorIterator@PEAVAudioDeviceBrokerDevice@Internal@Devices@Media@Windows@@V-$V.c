/*
 * XREFs of ?GetMany@?$SimpleVectorIterator@PEAVAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@V?$Vector@PEAVAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@U?$DefaultEqualityPredicate@PEAVAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@@2Collections@Foundation@5@U?$DefaultLifetimeTraits@PEAVAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@@2785@U?$DefaultVectorOptions@PEAVAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@@2785@@2Collections@Foundation@5@U?$DefaultLifetimeTraits@PEAVAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@@2785@UIntVersionTag@XWinRT@@$0A@@Internal@Collections@Foundation@Windows@@UEAAJIPEAPEAUIAudioDeviceBrokerDevice@2Devices@Media@5@PEAI@Z @ 0x140084FC0
 * Callers:
 *     <none>
 * Callees:
 *     ??R_lambda_9d9bfe8448e4b4d6cc7bb544b98bcffc_@@QEBA@XZ @ 0x1400811C8 (--R_lambda_9d9bfe8448e4b4d6cc7bb544b98bcffc_@@QEBA@XZ.c)
 *     ??R_lambda_de5abcad9a268955ca8a59b56c59c282_@@QEBAJIPEAI@Z @ 0x1400817DC (--R_lambda_de5abcad9a268955ca8a59b56c59c282_@@QEBAJIPEAI@Z.c)
 */
  ...
  *v17 = 0;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v6 )
    {
      while ( 1 )
      {
        v4 = _lambda_de5abcad9a268955ca8a59b56c59c282_::operator()((__int64)v12, v7, &v13);
        if ( v4 < 0 )
          break;
        ...
        if ( v6 )
          break;
        _lambda_9d9bfe8448e4b4d6cc7bb544b98bcffc_::operator()(v11);
      }
    }
    else
    {
      v4 = _lambda_de5abcad9a268955ca8a59b56c59c282_::operator()((__int64)v12, v7, (_DWORD *)(a1 + 40));
    }
