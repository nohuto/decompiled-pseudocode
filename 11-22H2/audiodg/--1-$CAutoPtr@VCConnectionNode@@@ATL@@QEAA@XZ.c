/*
 * XREFs of ??1?$CAutoPtr@VCConnectionNode@@@ATL@@QEAA@XZ @ 0x14007095C
 * Callers:
 ...
 *     _CAudioProcessor::AttachEndpointToConnection_::_1_::dtor$1 @ 0x1400360C2 (_CAudioProcessor--AttachEndpointToConnection_--_1_--dtor$1.c)
 * Callees:
