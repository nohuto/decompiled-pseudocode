/*
 * XREFs of ?AERTFree@@YAXPEAX0@Z @ 0x1400129A0
 * Callers:
 ...
 *     ?FreeConnectionBuffer@CDeviceGraphObjectCache@@UEAAJ_K@Z @ 0x1400249D0 (-FreeConnectionBuffer@CDeviceGraphObjectCache@@UEAAJ_K@Z.c)
 *     ??3CAudioPump@@SAXPEAX@Z @ 0x14005EDEC (--3CAudioPump@@SAXPEAX@Z.c)
 *     ??_G?$CComObject@VCAudioProcessor@@@ATL@@UEAAPEAXI@Z @ 0x14005EEA0 (--_G-$CComObject@VCAudioProcessor@@@ATL@@UEAAPEAXI@Z.c)
 *     ??_G?$CComObject@VCAudioPump@@@ATL@@UEAAPEAXI@Z @ 0x14005EF00 (--_G-$CComObject@VCAudioPump@@@ATL@@UEAAPEAXI@Z.c)
 *     wil::details::lambda_call__lambda_4077c0e74b282fea5d37049cc4734ddb___::_lambda_call__lambda_4077c0e74b282fea5d37049cc4734ddb___ @ 0x14008E908 (wil--details--lambda_call__lambda_4077c0e74b282fea5d37049cc4734ddb___--_lambda_call__lambda_4077.c)
 ...
 *     ??_G?$CComContainedObject@VCCrossProcessServerInputEndpoint@@@ATL@@UEAAPEAXI@Z @ 0x140090540 (--_G-$CComContainedObject@VCCrossProcessServerInputEndpoint@@@ATL@@UEAAPEAXI@Z.c)
 *     ??_G?$CComContainedObject@VCCrossProcessServerOutputEndpoint@@@ATL@@UEAAPEAXI@Z @ 0x1400905C0 (--_G-$CComContainedObject@VCCrossProcessServerOutputEndpoint@@@ATL@@UEAAPEAXI@Z.c)
 *     ??_E?$CComObject@VCCrossProcessClientInputEndpoint@@@ATL@@UEAAPEAXI@Z @ 0x140090640 (--_E-$CComObject@VCCrossProcessClientInputEndpoint@@@ATL@@UEAAPEAXI@Z.c)
