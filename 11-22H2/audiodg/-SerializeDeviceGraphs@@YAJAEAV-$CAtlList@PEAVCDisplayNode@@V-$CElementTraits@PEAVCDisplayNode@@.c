/*
 * XREFs of ?SerializeDeviceGraphs@@YAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@PEAPEAEPEAI@Z @ 0x1400632F8
 * Callers:
 ...
 *     ?SerializeMetaData@@YAJAEAPEAEAEAI@Z @ 0x1400633B8 (-SerializeMetaData@@YAJAEAPEAEAEAI@Z.c)
