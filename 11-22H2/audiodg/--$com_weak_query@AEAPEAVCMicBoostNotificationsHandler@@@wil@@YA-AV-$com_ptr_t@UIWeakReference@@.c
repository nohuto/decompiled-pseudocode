/*
 * XREFs of ??$com_weak_query@AEAPEAVCMicBoostNotificationsHandler@@@wil@@YA?AV?$com_ptr_t@UIWeakReference@@Uerr_exception_policy@wil@@@0@AEAPEAVCMicBoostNotificationsHandler@@@Z @ 0x140077DDC
 * Callers:
