/*
 * XREFs of _CSystemAudioDeviceCollection::Add_::_1_::dtor$1 @ 0x1400365FF
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CSystemAudioDeviceCollection::Add_::_1_::dtor_1(__int64 a1, __int64 a2)
{
