/*
 * XREFs of ??1UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x140080EF4
 * Callers:
 *     ??1FeatureStateData@details_abi@wil@@QEAA@XZ @ 0x140080C64 (--1FeatureStateData@details_abi@wil@@QEAA@XZ.c)
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x1400896A8 (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 *     _wil::details_abi::FeatureStateData::ProcessShutdown_::_1_::dtor$0 @ 0x1400896EB (_wil--details_abi--FeatureStateData--ProcessShutdown_--_1_--dtor$0.c)
 *     ?RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x14008A1B8 (-RecordUsage@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 *     _wil::details_abi::FeatureStateData::RecordUsage_::_1_::dtor$0 @ 0x14008A21E (_wil--details_abi--FeatureStateData--RecordUsage_--_1_--dtor$0.c)
 * Callees:
