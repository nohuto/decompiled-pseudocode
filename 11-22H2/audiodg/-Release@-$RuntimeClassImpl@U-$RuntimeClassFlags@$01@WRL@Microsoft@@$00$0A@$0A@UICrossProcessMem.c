/*
 * XREFs of ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$01@WRL@Microsoft@@$00$0A@$0A@UICrossProcessMemoryManager@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x14001F100
 * Callers:
 ...
 *     ??1?$ComPtr@VCCrossProcessMemoryManager@@@WRL@Microsoft@@QEAA@XZ @ 0x14006085C (--1-$ComPtr@VCCrossProcessMemoryManager@@@WRL@Microsoft@@QEAA@XZ.c)
 * Callees:
