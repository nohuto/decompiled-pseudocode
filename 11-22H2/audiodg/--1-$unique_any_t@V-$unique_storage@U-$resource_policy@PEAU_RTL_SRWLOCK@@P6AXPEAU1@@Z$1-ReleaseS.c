/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@PEAU_RTL_SRWLOCK@@P6AXPEAU1@@Z$1?ReleaseSRWLockExclusive@@YAX0@ZU?$integral_constant@_K$00@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x140058538
 * Callers:
 ...
 *     _Windows::Media::Devices::AudioDeviceModulesManager::RuntimeClassInitialize_::_1_::dtor$0 @ 0x14003609E (_Windows--Media--Devices--AudioDeviceModulesManager--RuntimeClassInitialize_--_1_--dtor$0.c)
 *     _CBridgeSourceEndpoint::AddBridgeSourceEndpointConsumer_::_1_::dtor$0 @ 0x14007971F (_CBridgeSourceEndpoint--AddBridgeSourceEndpointConsumer_--_1_--dtor$0.c)
 ...
 *     _Windows::Media::Devices::Internal::AudioDeviceBrokerDevice::InitializeEvents_::_1_::dtor$3 @ 0x140087A4B (_Windows--Media--Devices--Internal--AudioDeviceBrokerDevice--InitializeEvents_--_1_--dtor$3.c)
 ...
 *     _Windows::Media::Devices::AudioDeviceModulesManager::OnModuleChanged_::_1_::dtor$0 @ 0x14008932F (_Windows--Media--Devices--AudioDeviceModulesManager--OnModuleChanged_--_1_--dtor$0.c)
 *     _wil::details_abi::FeatureStateData::RecordFeatureUsage_::_1_::dtor$0 @ 0x14008A039 (_wil--details_abi--FeatureStateData--RecordFeatureUsage_--_1_--dtor$0.c)
 *     _wil::details::FeatureStateManager::SubscribeToEnabledStateChanges_::_1_::dtor$0 @ 0x14008CE0E (_wil--details--FeatureStateManager--SubscribeToEnabledStateChanges_--_1_--dtor$0.c)
 *     _wil::details::FeatureStateManager::SubscribeToUsageFlush_::_1_::dtor$0 @ 0x14008CECD (_wil--details--FeatureStateManager--SubscribeToUsageFlush_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
