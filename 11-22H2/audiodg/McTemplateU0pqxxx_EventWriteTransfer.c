/*
 * XREFs of McTemplateU0pqxxx_EventWriteTransfer @ 0x14003A342
 * Callers:
 ...
 *     ?ReleaseInputDataPointer@CSpatialCrossProcessServerInputEndpoint@@UEAAXI_K@Z @ 0x1400A0D50 (-ReleaseInputDataPointer@CSpatialCrossProcessServerInputEndpoint@@UEAAXI_K@Z.c)
 * Callees:
