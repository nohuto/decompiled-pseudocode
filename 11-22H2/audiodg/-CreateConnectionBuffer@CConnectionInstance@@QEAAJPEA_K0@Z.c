/*
 * XREFs of ?CreateConnectionBuffer@CConnectionInstance@@QEAAJPEA_K0@Z @ 0x140023AF8
 * Callers:
...
LABEL_6:
  ...
  if ( v9 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CConnectionInstance::CreateConnectionBuffer", 0xB2u, v9);
  }
