/*
 * XREFs of ??1?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AHPEAX@Z$1?CloseHandle@@YAH0@Z@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x14004B4A4
 * Callers:
 ...
 *     _CAudioPump::CAudioPump_::_1_::dtor$2 @ 0x1400344E9 (_CAudioPump--CAudioPump_--_1_--dtor$2.c)
 *     _CAudioPump::CAudioPump_::_1_::dtor$9 @ 0x140034592 (_CAudioPump--CAudioPump_--_1_--dtor$9.c)
 *     _CEndpointInstance::CreateDeviceEndpointInstance_::_1_::dtor$14 @ 0x140036068 (_CEndpointInstance--CreateDeviceEndpointInstance_--_1_--dtor$14.c)
 ...
 *     _Windows::Media::Devices::Internal::AudioDeviceBrokerDevice::InitializeEvents_::_1_::dtor$0 @ 0x140087A27 (_Windows--Media--Devices--Internal--AudioDeviceBrokerDevice--InitializeEvents_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
