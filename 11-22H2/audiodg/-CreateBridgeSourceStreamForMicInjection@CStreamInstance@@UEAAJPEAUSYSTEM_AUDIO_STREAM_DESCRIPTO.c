/*
 * XREFs of ?CreateBridgeSourceStreamForMicInjection@CStreamInstance@@UEAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIStreamInstance@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x14002E490
 * Callers:
 *     <none>
 * Callees:
