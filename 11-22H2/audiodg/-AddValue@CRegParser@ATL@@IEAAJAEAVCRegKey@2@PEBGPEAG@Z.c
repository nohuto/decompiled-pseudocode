/*
 * XREFs of ?AddValue@CRegParser@ATL@@IEAAJAEAVCRegKey@2@PEBGPEAG@Z @ 0x140090CF8
 * Callers:
 ...
 *     ?ChToByte@CRegParser@ATL@@KAEG@Z @ 0x140091370 (-ChToByte@CRegParser@ATL@@KAEG@Z.c)
 ...
 *     ?SetMultiStringValue@CRegKey@ATL@@QEAAJPEBG0@Z @ 0x140093E64 (-SetMultiStringValue@CRegKey@ATL@@QEAAJPEBG0@Z.c)
 *     ?SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ @ 0x140093F70 (-SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ.c)
 *     ?VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z @ 0x140094410 (-VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z.c)
 */
