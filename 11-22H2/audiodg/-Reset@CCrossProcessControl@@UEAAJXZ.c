/*
 * XREFs of ?Reset@CCrossProcessControl@@UEAAJXZ @ 0x140095F20
 * Callers:
 *     <none>
 * Callees:
 *     ?DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ @ 0x140095288 (-DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ.c)
