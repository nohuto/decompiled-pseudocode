/*
 * XREFs of ??$com_weak_query@AEAPEAVCAPOEndpointNotificationsHandler@@@wil@@YA?AV?$com_ptr_t@UIWeakReference@@Uerr_exception_policy@wil@@@0@AEAPEAVCAPOEndpointNotificationsHandler@@@Z @ 0x14007150C
 * Callers:
