/*
 * XREFs of ??1?$unique_ptr@UKSDATAFORMAT_WAVEFORMATEX@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@QEAA@XZ @ 0x14004A240
 * Callers:
 ...
 *     _CAudioProcessor::AddAPOOutputConnection_::_1_::dtor$0 @ 0x140035347 (_CAudioProcessor--AddAPOOutputConnection_--_1_--dtor$0.c)
 *     _FillAPOInitSystemEffectsStructure_::_1_::dtor$6 @ 0x140035C06 (_FillAPOInitSystemEffectsStructure_--_1_--dtor$6.c)
 *     _FillAPOInitSystemEffectsStructure_::_1_::dtor$10 @ 0x140035C3C (_FillAPOInitSystemEffectsStructure_--_1_--dtor$10.c)
 *     _CAPOProcessingHost::RegisterAPONotifications_::_1_::dtor$3 @ 0x140036020 (_CAPOProcessingHost--RegisterAPONotifications_--_1_--dtor$3.c)
 *     _CEndpointInstance::CreateDeviceEndpointInstance_::_1_::dtor$8 @ 0x140036032 (_CEndpointInstance--CreateDeviceEndpointInstance_--_1_--dtor$8.c)
 *     _CAudioProcessor::ValidateConnectionFormatMatchesEndpoint_::_1_::dtor$0 @ 0x140036117 (_CAudioProcessor--ValidateConnectionFormatMatchesEndpoint_--_1_--dtor$0.c)
 ...
 *     _FillAuxiliaryInputInitStruct_::_1_::dtor$2 @ 0x14004F4B3 (_FillAuxiliaryInputInitStruct_--_1_--dtor$2.c)
 ...
 *     _Windows::Media::Devices::AudioDeviceModulesManager::OnModuleChanged_::_1_::dtor$9 @ 0x14008939B (_Windows--Media--Devices--AudioDeviceModulesManager--OnModuleChanged_--_1_--dtor$9.c)
