/*
 * XREFs of ?StartSendingNotifications@CAPOProcessingHostObject@@QEAAJXZ @ 0x1400703A0
 * Callers:
 ...
 *     ??$?0$$V@?$_Ref_count_obj2@VCSerialWorkQueue@@@std@@QEAA@XZ @ 0x14006F5E0 (--$-0$$V@-$_Ref_count_obj2@VCSerialWorkQueue@@@std@@QEAA@XZ.c)
 */
