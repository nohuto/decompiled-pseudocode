/*
 * XREFs of ?InitializeSecurity@CAudioDGModule@@AEAAJKKK@Z @ 0x14005101C
 * Callers:
...
LABEL_3:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 20LL, &WPP_131b8c4e0fcd3ed8c88f07f30abb8f12_Traceguids);
  }
  ...
  if ( v7 < 0 )
  {
    ...
    v13 = 22LL;
LABEL_39:
    WPP_SF_D(v12[2], v13, &WPP_131b8c4e0fcd3ed8c88f07f30abb8f12_Traceguids);
    goto LABEL_48;
  }
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_d(
        *((_QWORD *)WPP_GLOBAL_Control + 2),
        23LL,
        &WPP_131b8c4e0fcd3ed8c88f07f30abb8f12_Traceguids,
        (unsigned int)v7);
    }
    AudDGTraceLoggingErrorHelper("CAudioDGModule::InitializeSecurity", 0x29Au, v7);
  }
