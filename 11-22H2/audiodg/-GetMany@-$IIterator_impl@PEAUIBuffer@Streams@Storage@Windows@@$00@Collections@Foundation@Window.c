/*
 * XREFs of ?GetMany@?$IIterator_impl@PEAUIBuffer@Streams@Storage@Windows@@$00@Collections@Foundation@Windows@@UEAAJIPEAPEAUIBuffer@Streams@Storage@4@PEAI@Z @ 0x140084DF0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
