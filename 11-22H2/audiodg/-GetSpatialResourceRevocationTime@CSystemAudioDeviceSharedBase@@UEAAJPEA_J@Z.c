/*
 * XREFs of ?GetSpatialResourceRevocationTime@CSystemAudioDeviceSharedBase@@UEAAJPEA_J@Z @ 0x1400596D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a2)
{
  ...
  LODWORD(v3) = (*(__int64 (__fastcall **)(_QWORD, __int64 *))(**((_QWORD **)v3 + 41) + 160LL))(
                  *((_QWORD *)v3 + 41),
                  a2);
  EtwEventActivityIdControl(4LL, &v5);
