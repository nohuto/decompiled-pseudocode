/*
 * XREFs of ?RuntimeClassInitialize@CBridgeToRenderGraph@@QEAAJPEAUIDeviceGraphObjectCache@@PEAUICrossProcessMemory@@PEAUSYSTEM_AUDIO_STREAM@@II@Z @ 0x14007A28C
 * Callers:
 ...
 *     ??4?$com_ptr_t@UIDeviceGraphObjectCache@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAUIDeviceGraphObjectCache@@@Z @ 0x140079580 (--4-$com_ptr_t@UIDeviceGraphObjectCache@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAUIDevic.c)
 */
