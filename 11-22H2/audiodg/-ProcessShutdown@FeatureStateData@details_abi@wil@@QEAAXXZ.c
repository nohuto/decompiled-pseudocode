/*
 * XREFs of ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x1400896A8
 * Callers:
 ...
 * Callees:
 *     ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x14008027C (--0UsageIndexes@details_abi@wil@@QEAA@XZ.c)
 ...
 *     ?RetrieveUsageUnderLock@FeatureStateData@details_abi@wil@@AEAAXAEAUUsageIndexes@23@@Z @ 0x14008BC90 (-RetrieveUsageUnderLock@FeatureStateData@details_abi@wil@@AEAAXAEAUUsageIndexes@23@@Z.c)
 */
