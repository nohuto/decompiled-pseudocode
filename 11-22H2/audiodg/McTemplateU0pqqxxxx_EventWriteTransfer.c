/*
 * XREFs of McTemplateU0pqqxxxx_EventWriteTransfer @ 0x140039F88
 * Callers:
 *     ?SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x14001EA70 (-SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x140027DF0 (__security_check_cookie.c)
 *     McGenEventWrite_EventWriteTransfer @ 0x1400397BA (McGenEventWrite_EventWriteTransfer.c)
 */

ULONG __fastcall McTemplateU0pqqxxxx_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWrite_EventWriteTransfer(a1, &AudioCore_CrossProcess_SetCurrentTimeStamp, a3, 8u, &v10);
}
