/*
 * XREFs of McTemplateU0pqp_EventWriteTransfer @ 0x140039F02
 * Callers:
...
ULONG __fastcall McTemplateU0pqp_EventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  ...
  v10 = 4LL;
  v11 = &a5;
  return McGenEventWrite_EventWriteTransfer(a1, &AudioCore_CrossProcess_SignalPumpPassCompletion, a3, 4u, &v6);
}
