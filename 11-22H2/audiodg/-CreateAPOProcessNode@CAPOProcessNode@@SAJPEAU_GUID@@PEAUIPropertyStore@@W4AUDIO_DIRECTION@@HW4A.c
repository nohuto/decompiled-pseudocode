 ...
 *     WPP_SF__guid_ @ 0x14005D010 (WPP_SF__guid_.c)
 ...
 *     ??1?$unique_ptr@VCAPOProcessNode@@U?$default_delete@VCAPOProcessNode@@@wistd@@@wistd@@QEAA@XZ @ 0x14005D14C (--1-$unique_ptr@VCAPOProcessNode@@U-$default_delete@VCAPOProcessNode@@@wistd@@@wistd@@QEAA@XZ.c)
 */
