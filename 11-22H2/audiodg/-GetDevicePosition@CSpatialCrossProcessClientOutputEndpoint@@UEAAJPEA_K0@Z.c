/*
 * XREFs of ?GetDevicePosition@CSpatialCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z @ 0x14009F850
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( *((_BYTE *)this - 1240) )
  {
    if ( a2 )
    {
      if ( a3 )
        *a3 = 0LL;
      v7 = (*(__int64 (__fastcall **)(char *, _BYTE *, unsigned __int64 *, _BYTE *, _BYTE *))(*((_QWORD *)this - 167)
                                                                                            + 96LL))(
             (char *)this - 1336,
             v20,
             v18,
  ...
  if ( (byte_1400CF981 & 4) != 0 )
  {
    ...
    if ( a2 )
      ...
      LOBYTE(v13) = 0;
    McTemplateU0pqxxxx_EventWriteTransfer(v12, (__int64)a2, (__int64)this - 1336, 7, 0, v13, 0, v12);
  }
  if ( a2 )
    *((_QWORD *)this - 149) = *a2;
  if ( v7 < 0 )
