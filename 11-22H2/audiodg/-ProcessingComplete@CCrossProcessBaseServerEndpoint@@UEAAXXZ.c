/*
 * XREFs of ?ProcessingComplete@CCrossProcessBaseServerEndpoint@@UEAAXXZ @ 0x14001EBC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CCrossProcessBaseServerEndpoint::ProcessingComplete(CCrossProcessBaseServerEndpoint *this, int a2)
{
  ...
  if ( (*((_DWORD *)this + 42) & 0x40000) != 0 )
  {
    ...
    if ( (v3 & 1) != 0 )
    {
      ...
      if ( v5 )
      {
        _InterlockedExchange64((volatile __int64 *)this + 52, v5);
        v9 = *((_QWORD *)this + 52);
        wil::com_ptr_t<ICrossProcessEvent,wil::err_returncode_policy>::reset((__int64 *)this + 51);
