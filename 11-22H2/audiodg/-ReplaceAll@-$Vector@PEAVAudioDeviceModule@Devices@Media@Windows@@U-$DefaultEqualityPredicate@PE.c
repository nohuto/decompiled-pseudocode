...
LABEL_9:
  ...
  while ( 1 )
  {
    v16 = XWinRT::InterfaceLifetimeTraits::Construct<Windows::Media::Devices::IAudioDeviceModule>(&v8[v9], *a3);
    v3 = v16;
    if ( v16 < 0 )
      break;
...
LABEL_16:
  if ( v8 )
  {
    if ( (_DWORD)v9 )
    {
      ...
      do
      {
        XWinRT::InterfaceLifetimeTraits::Destroy<Windows::Media::Devices::IAudioDeviceModule>(v13++);
        --v9;
      }
      while ( v9 );
    }
