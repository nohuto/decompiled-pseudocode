/*
 * XREFs of ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x14008027C
 * Callers:
 ...
 * Callees:
 *     ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x1400800E0 (--0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z.c)
 */
