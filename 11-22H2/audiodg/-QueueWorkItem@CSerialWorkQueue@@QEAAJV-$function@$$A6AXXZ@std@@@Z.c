/*
 * XREFs of ?QueueWorkItem@CSerialWorkQueue@@QEAAJV?$function@$$A6AXXZ@std@@@Z @ 0x1400701BC
 * Callers:
 ...
 *     ?Initialize@CSerialWorkQueue@@AEAAJXZ @ 0x14006FE68 (-Initialize@CSerialWorkQueue@@AEAAJXZ.c)
