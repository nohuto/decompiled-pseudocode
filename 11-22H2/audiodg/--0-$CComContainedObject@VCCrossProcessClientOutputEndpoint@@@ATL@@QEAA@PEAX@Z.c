/*
 * XREFs of ??0?$CComContainedObject@VCCrossProcessClientOutputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x14008F96C
 * Callers:
 *     ?CreateInstance@?$CComCreator@V?$CComAggObject@VCCrossProcessClientOutputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140091730 (-CreateInstance@-$CComCreator@V-$CComAggObject@VCCrossProcessClientOutputEndpoint@@@ATL@@@ATL@@S.c)
 * Callees:
 *     ??0CCrossProcessClientOutputEndpoint@@QEAA@XZ @ 0x14008FCD0 (--0CCrossProcessClientOutputEndpoint@@QEAA@XZ.c)
 */
