/*
 * XREFs of McTemplateU0jjt_EtwEventWriteTransfer @ 0x14006E548
 * Callers:
...
__int64 __fastcall McTemplateU0jjt_EtwEventWriteTransfer(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v12 = 4LL;
  v10 = 16LL;
  return McGenEventWrite_EtwEventWriteTransfer(0LL, (__int64)&EVT_SYSTEM_EFFECT_APO_INITIALIZED, a3, 4LL, (__int64)v6);
}
