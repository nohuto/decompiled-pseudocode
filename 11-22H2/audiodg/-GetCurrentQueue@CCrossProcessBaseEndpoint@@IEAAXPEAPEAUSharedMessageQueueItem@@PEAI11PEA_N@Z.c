/*
 * XREFs of ?GetCurrentQueue@CCrossProcessBaseEndpoint@@IEAAXPEAPEAUSharedMessageQueueItem@@PEAI11PEA_N@Z @ 0x140095644
 * Callers:
        ...
        bool *a6)
{
  ...
  else
  {
    ...
    v13 = *((_QWORD *)this + 9);
    *a3 = v12;
    v14 = (CCrossProcessBaseEndpoint *)*(unsigned int *)(v13 + 188);
    *a4 = (unsigned int)v14;
    if ( v12 == (_DWORD)v14
      || !CCrossProcessBaseEndpoint::IsValidQueueIndex(v14, v12, *(_DWORD *)(*((_QWORD *)this + 10) + 148LL)) )
    {
      *a2 = (struct SharedMessageQueueItem *)*((_QWORD *)this + 15);
