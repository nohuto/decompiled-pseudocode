/*
 * XREFs of ?_Free@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAXXZ @ 0x180042CB4
 * Callers:
 ...
 *     ??1?$NativeString@V?$CoTaskMemPolicy@_W@Internal@Windows@@@Internal@Windows@@QEAA@XZ @ 0x18002BC80 (--1-$NativeString@V-$CoTaskMemPolicy@_W@Internal@Windows@@@Internal@Windows@@QEAA@XZ.c)
 ...
 *     ?RuntimeClassInitialize@CreativeEventReportedCache@ContentManagement@@QEAAJPEBG@Z @ 0x18005DAF0 (-RuntimeClassInitialize@CreativeEventReportedCache@ContentManagement@@QEAAJPEBG@Z.c)
 ...
 *     ?_InitializeFromRegistry@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAJPEAUHKEY__@@PEBG_N@Z @ 0x180061E54 (-_InitializeFromRegistry@-$NativeString@V-$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows.c)
 ...
 *     ??1MRTHelperBase@ShellMRTHelper@@QEAA@XZ @ 0x1800C3ABC (--1MRTHelperBase@ShellMRTHelper@@QEAA@XZ.c)
