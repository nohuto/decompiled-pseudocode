/*
 * XREFs of ??0AppInstallService@Actions@CreativeFramework@@QEAA@PEB_W_N11100000@Z @ 0x1800A9D1C
 * Callers:
        ...
        wchar_t *a9)
{
  ...
  *((_WORD *)this + 88) = 0;
  ...
  if ( a8 )
    std::wstring::assign((__int64)this + 144, a8);
  if ( a9 )
    std::wstring::assign((__int64)this + 176, a9);
  return this;
}
