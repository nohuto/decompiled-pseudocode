/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x18003E4C8
 * Callers:
        ...
        __int64 a4)
{
  ...
  const wchar_t *v10; // [rsp+D0h] [rbp-68h] BYREF
  const wchar_t *v11; // [rsp+D8h] [rbp-60h] BYREF
  const wchar_t *v12; // [rsp+E0h] [rbp-58h] BYREF
  ...
  if ( *v4 > 2u )
  {
    v10 = (const wchar_t *)*((_QWORD *)a2 + 6);
    v20 = *((_DWORD *)a2 + 17);
    v21 = *((_DWORD *)a2 + 4);
    v11 = (const wchar_t *)*((_QWORD *)a2 + 15);
    v12 = (const wchar_t *)*((_QWORD *)a2 + 14);
    v22 = *((_DWORD *)a2 + 26);
    v13 = *((_QWORD *)a2 + 12);
    v14 = *((_QWORD *)a2 + 11);
    v5 = *((_DWORD *)a2 + 20);
