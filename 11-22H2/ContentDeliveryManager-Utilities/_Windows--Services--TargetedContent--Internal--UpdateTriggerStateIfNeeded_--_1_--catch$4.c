/*
 * XREFs of _Windows::Services::TargetedContent::Internal::UpdateTriggerStateIfNeeded_::_1_::catch$4 @ 0x1800DA07D
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::UpdateTriggerStateIfNeeded_::_1_::catch_4(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
