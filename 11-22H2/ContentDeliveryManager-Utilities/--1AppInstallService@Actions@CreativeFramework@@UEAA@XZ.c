/*
 * XREFs of ??1AppInstallService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800A9F58
 * Callers:
 *     ??_GAppInstallService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800AA030 (--_GAppInstallService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
