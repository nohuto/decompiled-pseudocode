/*
 * XREFs of ?CreateSupportedWnfNameStateMap@Triggers@CreativeFramework@@YA?AV?$map@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@@std@@XZ @ 0x1800A38E0
 * Callers:
 ...
 *     ??0?$_Tree@V?$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@$0A@@std@@@std@@QEAA@AEBV01@AEBV?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@1@@Z @ 0x1800A37B8 (--0-$_Tree@V-$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V-$allocat.c)
 */
...
__int64 *__fastcall CreativeFramework::Triggers::CreateSupportedWnfNameStateMap(__int64 *a1)
{
  ...
  AcquireSRWLockShared(&stru_1801963D8);
  v14 = &stru_1801963D8;
  if ( !qword_180196570 )
  {
    LOBYTE(v14) = 0;
    HIDWORD(v14) = GetLastError();
    ReleaseSRWLockShared(&stru_1801963D8);
    wil::last_error_context::~last_error_context((wil::last_error_context *)&v14);
    v14 = 0LL;
    AcquireSRWLockExclusive(&stru_1801963D8);
    v15 = &stru_1801963D8;
    if ( qword_180196570 )
    {
