/*
 * XREFs of ?PrefetchDisplayName@ContentDeliveryManagerAppDisplayInfo@ApplicationModel@Extensions@Internal@Windows@@AEAAXPEBG@Z @ 0x1800C3FA8
 * Callers:
 ...
 *     ?Set@HString@Wrappers@WRL@Microsoft@@QEAAJPEB_WI@Z @ 0x180099244 (-Set@HString@Wrappers@WRL@Microsoft@@QEAAJPEB_WI@Z.c)
