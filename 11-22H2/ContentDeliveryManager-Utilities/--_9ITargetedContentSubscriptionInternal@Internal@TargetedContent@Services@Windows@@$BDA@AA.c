/*
 * XREFs of ??_9ITargetedContentSubscriptionInternal@Internal@TargetedContent@Services@Windows@@$BDA@AA @ 0x1800C7A68
 * Callers:
...
__int64 __fastcall  Windows::Services::TargetedContent::Internal::ITargetedContentSubscriptionInternal::`vcall'{48,{flat}}(
        __int64 a1)
{
