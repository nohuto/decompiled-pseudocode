/*
 * XREFs of ??$MakeAndInitialize@VSubscriptionStaticsImpl@TargetedContent@ContentManagement@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAVSubscriptionStaticsImpl@TargetedContent@ContentManagement@@@Z @ 0x18004798C
 * Callers:
 ...
 *     ??0SubscriptionStaticsImpl@TargetedContent@ContentManagement@@QEAA@XZ @ 0x180048030 (--0SubscriptionStaticsImpl@TargetedContent@ContentManagement@@QEAA@XZ.c)
