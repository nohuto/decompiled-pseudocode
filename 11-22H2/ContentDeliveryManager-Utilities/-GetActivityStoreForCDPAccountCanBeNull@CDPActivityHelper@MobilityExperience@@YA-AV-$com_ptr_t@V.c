/*
 * XREFs of ?GetActivityStoreForCDPAccountCanBeNull@CDPActivityHelper@MobilityExperience@@YA?AV?$com_ptr_t@VICDPActivityStore@@Uerr_exception_policy@wil@@@wil@@PEAVICDPAccount@@@Z @ 0x18006F788
 * Callers:
