...
_QWORD *__fastcall CreativeFramework::Actions::GetActionService(_QWORD *a1, unsigned int a2, __int64 a3, _QWORD **a4)
{
  ...
  while ( v9 != v8 )
  {
    ...
    v15[2] = v10;
    v15[3] = v11;
    v12 = std::_Tree_buy<std::pair<std::wstring const,std::wstring>>::_Buynode<std::pair<wchar_t *,wchar_t *>>(v15);
