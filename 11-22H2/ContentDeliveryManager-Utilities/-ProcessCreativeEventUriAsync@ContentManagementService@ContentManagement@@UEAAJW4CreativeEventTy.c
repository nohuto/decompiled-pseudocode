/*
 * XREFs of ?ProcessCreativeEventUriAsync@ContentManagementService@ContentManagement@@UEAAJW4CreativeEventType@2@PEAUHSTRING__@@PEAU?$ITypedEventHandler@PEAUIInspectable@@PEAUHSTRING__@@@Foundation@Windows@@PEAUICreativeEventReportedCache@2@PEAPEAUIAsyncAction@67@@Z @ 0x18005BF00
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a6)
{
  ...
  HSTRING v29; // [rsp+80h] [rbp-80h] BYREF
  HSTRING_HEADER v30; // [rsp+88h] [rbp-78h] BYREF
  HSTRING v31; // [rsp+A0h] [rbp-60h] BYREF
  HSTRING_HEADER v32; // [rsp+A8h] [rbp-58h] BYREF
  HSTRING v33; // [rsp+C0h] [rbp-40h] BYREF
  HSTRING_HEADER v34; // [rsp+C8h] [rbp-38h] BYREF
  PCWSTR sourceString[3]; // [rsp+E0h] [rbp-20h] BYREF
  PCWSTR v36; // [rsp+F8h] [rbp-8h]
  PCWSTR v37; // [rsp+110h] [rbp+10h]
  ...
  if ( *((_DWORD *)i + 1) == -1 || (v16 = sourceString[3 * *((int *)i + 1)]) == 0LL )
  {
LABEL_15:
    v18 = 0LL;
    goto LABEL_16;
