/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x18003466C
 * Callers:
 ...
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x180045730 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 * Callees:
