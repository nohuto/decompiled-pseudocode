/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800332A8
 * Callers:
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18003E730 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_48101911@@@details@wil@@QEAAX_NW4Reportin.c)
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_48101911>::GetCurrentFeatureEnabledState(v6, &v13, &v12);
    v7 = *a2;
    v8 = v5 != 0 ? v12 : 0;
    v12 = v8;
    while ( 1 )
