/*
 * XREFs of ??$ActivateInstance@UIXmlDocument@Dom@Xml@Data@Windows@@@wil@@YA?AV?$com_ptr_t@UIXmlDocument@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800C4A20
 * Callers:
 ...
 *     ??$query@UIXmlDocument@Dom@Xml@Data@Windows@@@?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIXmlDocument@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800C6778 (--$query@UIXmlDocument@Dom@Xml@Data@Windows@@@-$com_ptr_t@UIInspectable@@Uerr_exception_policy@w.c)
 */
