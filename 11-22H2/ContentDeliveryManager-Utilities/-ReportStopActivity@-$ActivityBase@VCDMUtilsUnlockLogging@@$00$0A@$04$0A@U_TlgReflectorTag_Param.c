/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x1800A6FA0
 * Callers:
        ...
        int a2)
{
  ...
  if ( a2 < 0 )
  {
    ...
    {
      v11 = CDMUtilsUnlockLogging::Provider(v5);
      v12 = (__int64)v11;
    ...
    {
      v7 = CDMUtilsUnlockLogging::Provider(v5);
