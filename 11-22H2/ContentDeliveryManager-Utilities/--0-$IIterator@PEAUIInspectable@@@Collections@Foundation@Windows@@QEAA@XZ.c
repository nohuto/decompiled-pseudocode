/*
 * XREFs of ??0?$IIterator@PEAUIInspectable@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x1800C6AF8
 * Callers:
 ...
 * Callees:
 *     ??0?$IIterator_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@QEAA@XZ @ 0x1800C6B1C (--0-$IIterator_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@QEAA@XZ.c)
 */
