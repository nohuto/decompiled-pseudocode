/*
 * XREFs of Microsoft::WRL::AsyncBase_Windows::Foundation::IAsyncActionCompletedHandler_Microsoft::WRL::Details::Nil_1_Microsoft::WRL::AsyncCausalityOptions_&_anonymous_namespace_::EnableStartMenuSystemPaneSuggestionsOperationName_&GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::Start @ 0x18005E790
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Microsoft::WRL::AsyncBase_Windows::Foundation::IAsyncActionCompletedHandler_Microsoft::WRL::Details::Nil_1_Microsoft::WRL::AsyncCausalityOptions_&_anonymous_namespace_::EnableStartMenuSystemPaneSuggestionsOperationName_&GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::TraceOperationStart @ 0x18005FC78 (Microsoft--WRL--AsyncBase_Windows--Foundation--IAsyncActionCompletedHandler_Microso_ea_18005FC78.c)
 *     _guard_xfg_dispatch_icall_nop @ 0x1800D4360 (_guard_xfg_dispatch_icall_nop.c)
 */

__int64 __fastcall Microsoft::WRL::AsyncBase_Windows::Foundation::IAsyncActionCompletedHandler_Microsoft::WRL::Details::Nil_1_Microsoft::WRL::AsyncCausalityOptions___anonymous_namespace_::EnableStartMenuSystemPaneSuggestionsOperationName__GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::Start(
        __int64 a1)
{
  __int64 v2; // rdx
  int v3; // ebx
         ...
         0) )
  {
    ...
    if ( v3 >= 0
      && InitOnceExecuteOnce(
           ...
           0LL) )
    {
      Microsoft::WRL::AsyncBase_Windows::Foundation::IAsyncActionCompletedHandler_Microsoft::WRL::Details::Nil_1_Microsoft::WRL::AsyncCausalityOptions___anonymous_namespace_::EnableStartMenuSystemPaneSuggestionsOperationName__GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::TraceOperationStart(a1);
    }
  }
  else
  {
