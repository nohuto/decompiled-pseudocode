/*
 * XREFs of memcpy_0 @ 0x180022B24
 * Callers:
 *     ?do_narrow@?$ctype@D@std@@MEBAPEBDPEBD0DPEAD@Z @ 0x18000AB80 (-do_narrow@-$ctype@D@std@@MEBAPEBDPEBD0DPEAD@Z.c)
 *     ?do_widen@?$ctype@D@std@@MEBAPEBDPEBD0PEAD@Z @ 0x18000B6E0 (-do_widen@-$ctype@D@std@@MEBAPEBDPEBD0PEAD@Z.c)
 *     _FXp_movx @ 0x18000C624 (_FXp_movx.c)
 *     _FXp_mulx @ 0x18000C84C (_FXp_mulx.c)
 *     _Xp_movx @ 0x18000D348 (_Xp_movx.c)
 *     _Xp_mulx @ 0x18000D578 (_Xp_mulx.c)
 *     _LXp_mulx @ 0x18000E034 (_LXp_mulx.c)
 *     ??$_Getvals@_W@?$_Mpunct@_W@std@@IEAAX_WPEBUlconv@@@Z @ 0x18000E968 (--$_Getvals@_W@-$_Mpunct@_W@std@@IEAAX_WPEBUlconv@@@Z.c)
 ...
 *     ?do_out@?$codecvt@GDH@std@@MEBAHAEAHPEBG1AEAPEBGPEAD3AEAPEAD@Z @ 0x180071F20 (-do_out@-$codecvt@GDH@std@@MEBAHAEAHPEBG1AEAPEBGPEAD3AEAPEAD@Z.c)
 *     ?do_unshift@?$codecvt@GDH@std@@MEBAHAEAHPEAD1AEAPEAD@Z @ 0x180072190 (-do_unshift@-$codecvt@GDH@std@@MEBAHAEAHPEAD1AEAPEAD@Z.c)
 *     ?SHRegAllocData@@YAJPEAUHKEY__@@PEB_W1HPEAPEAXPEAK@Z @ 0x1800BCA18 (-SHRegAllocData@@YAJPEAUHKEY__@@PEB_W1HPEAPEAXPEAK@Z.c)
 *     ??4?$_Yarn@_W@std@@QEAAAEAV01@PEB_W@Z @ 0x1800D0330 (--4-$_Yarn@_W@std@@QEAAAEAV01@PEB_W@Z.c)
 *     ?_Maklocwcs@std@@YAPEA_WPEB_W@Z @ 0x1800D0CD0 (-_Maklocwcs@std@@YAPEA_WPEB_W@Z.c)
 * Callees:
 *     <none>
 */
