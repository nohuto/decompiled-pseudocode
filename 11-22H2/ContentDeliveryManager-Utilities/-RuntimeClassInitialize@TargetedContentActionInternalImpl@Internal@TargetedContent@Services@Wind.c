/*
 * XREFs of ?RuntimeClassInitialize@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@QEAAJW4ActionServices@Actions@CreativeFramework@@AEBUActionContext@78@PEAU?$IMapView@PEAUHSTRING__@@PEAU1@@Collections@Foundation@5@@Z @ 0x180076854
 * Callers:
        ...
        __int64 (***a4)(void))
{
  ...
  HSTRING v43; // [rsp+48h] [rbp-60h] BYREF
  __int64 v44; // [rsp+50h] [rbp-58h] BYREF
  void *v45[2]; // [rsp+58h] [rbp-50h] BYREF
  PCWSTR v46; // [rsp+68h] [rbp-40h] BYREF
  std::_Ref_count_base *v47; // [rsp+70h] [rbp-38h]
  _BYTE v48[24]; // [rsp+78h] [rbp-30h] BYREF
  ...
  try
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( v11 >= 0 )
      {
        v13 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v41 + 56LL))(v41, &v50);
        v14 = v13;
        if ( v13 >= 0 )
        {
          ...
          while ( (_BYTE)v50 )
          {
            ...
            std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_nohint<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
              ...
              v26 + 16,
              (__int64)v26);
            v28 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v41 + 64LL))(v41, &v50);
            v29 = v28;
            if ( v28 < 0 )
            {
              wil::details::in1diag3::Return_Hr(
