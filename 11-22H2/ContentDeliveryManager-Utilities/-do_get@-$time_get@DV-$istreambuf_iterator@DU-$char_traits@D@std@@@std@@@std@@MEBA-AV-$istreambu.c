/*
 * XREFs of ?do_get@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x18001FC80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_52:
  ...
  if ( a8 != 109 )
    goto LABEL_73;
  v26 = *v16 | std::time_get<char,std::istreambuf_iterator<char>>::_Getint(
                 (__int64)a1,
                 a3,
                 a4,
                 1,
