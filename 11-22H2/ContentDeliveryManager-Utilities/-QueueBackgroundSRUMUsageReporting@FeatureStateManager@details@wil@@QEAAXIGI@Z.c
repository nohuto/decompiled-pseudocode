/*
 * XREFs of ?QueueBackgroundSRUMUsageReporting@FeatureStateManager@details@wil@@QEAAXIGI@Z @ 0x18003AFBC
 * Callers:
 ...
 *     ?push_back@heap_buffer@details_abi@wil@@QEAA_NPEBX_K@Z @ 0x180044D70 (-push_back@heap_buffer@details_abi@wil@@QEAA_NPEBX_K@Z.c)
 */
