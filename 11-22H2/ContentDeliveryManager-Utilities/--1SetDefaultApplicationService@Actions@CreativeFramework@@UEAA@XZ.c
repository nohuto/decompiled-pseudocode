/*
 * XREFs of ??1SetDefaultApplicationService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800AC9C0
 * Callers:
 *     ??_EPinWebsiteToTaskbarService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800AD040 (--_EPinWebsiteToTaskbarService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
