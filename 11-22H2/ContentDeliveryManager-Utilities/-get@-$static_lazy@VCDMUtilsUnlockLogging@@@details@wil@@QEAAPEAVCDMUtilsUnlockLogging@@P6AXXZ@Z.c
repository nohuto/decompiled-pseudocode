/*
 * XREFs of ?get@?$static_lazy@VCDMUtilsUnlockLogging@@@details@wil@@QEAAPEAVCDMUtilsUnlockLogging@@P6AXXZ@Z @ 0x1800A7FE8
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<CDMUtilsUnlockLogging>::get(__int64 a1, void (__cdecl *a2)())
{
    ...
    && (_DWORD)v8 )
  {
    ...
    v9 = &qword_1801965B8;
    qword_1801965B8 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_1801965D0 = (__int64)&`CDMUtilsUnlockLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
