/*
 * XREFs of _lambda_929976d9f769b9ae6bfa1e1f0592e0ca_::operator() @ 0x180053B6C
 * Callers:
 ...
 *     ?IsHighPriorityEvent@ContentManagement@@YA_NPEBG@Z @ 0x18005A2D0 (-IsHighPriorityEvent@ContentManagement@@YA_NPEBG@Z.c)
 *     ?ResolveEventNotificationHandlerFromType@ContentManagement@@YA?AV?$function@$$A6AJXZ@std@@W4EventNotificationType@1@@Z @ 0x18005D3F8 (-ResolveEventNotificationHandlerFromType@ContentManagement@@YA-AV-$function@$$A6AJXZ@std@@W4Even.c)
 *     ?_Tidy@?$_Func_class@_NAEAVPropertySetHelper@Triggers@CreativeFramework@@U_Nil@std@@U45@U45@U45@U45@U45@@std@@IEAAXXZ @ 0x180062740 (-_Tidy@-$_Func_class@_NAEAVPropertySetHelper@Triggers@CreativeFramework@@U_Nil@std@@U45@U45@U45@.c)
