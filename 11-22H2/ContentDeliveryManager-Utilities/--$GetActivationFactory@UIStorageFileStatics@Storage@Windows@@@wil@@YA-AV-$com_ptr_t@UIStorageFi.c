/*
 * XREFs of ??$GetActivationFactory@UIStorageFileStatics@Storage@Windows@@@wil@@YA?AV?$com_ptr_t@UIStorageFileStatics@Storage@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800A0E54
 * Callers:
...
const WCHAR *__fastcall wil::GetActivationFactory<Windows::Storage::IStorageFileStatics>(
        const WCHAR *a1,
        __int64 a2,
        unsigned int a3)
{
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  ActivationFactory = RoGetActivationFactory(v4[1].Reserved.Reserved1, &GUID_5984c710_daf2_43c8_8bb4_a4d3eacfd03f, a1);
