/*
 * XREFs of _Strcoll @ 0x180021AAC
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x18001F930 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x18000D91C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x18000D928 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x18000D990 (__crtCompareStringA_Stub.c)
