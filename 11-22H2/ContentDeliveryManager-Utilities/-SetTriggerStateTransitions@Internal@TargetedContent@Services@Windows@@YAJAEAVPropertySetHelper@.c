/*
 * XREFs of ?SetTriggerStateTransitions@Internal@TargetedContent@Services@Windows@@YAJAEAVPropertySetHelper@Triggers@CreativeFramework@@PEAUITargetedContentTriggerInternal@1234@@Z @ 0x18009F1F8
 * Callers:
 ...
 *     ??0?$basic_ostringstream@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAA@H@Z @ 0x18009ADC0 (--0-$basic_ostringstream@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEAA@H@Z.c)
        ...
        struct Windows::Services::TargetedContent::Internal::ITargetedContentTriggerInternal *a3)
{
  ...
  UINT32 v32; // [rsp+38h] [rbp-160h] BYREF
  HSTRING v33; // [rsp+40h] [rbp-158h] BYREF
  HSTRING string; // [rsp+48h] [rbp-150h] BYREF
  unsigned int v35; // [rsp+50h] [rbp-148h] BYREF
  int v36; // [rsp+54h] [rbp-144h] BYREF
  ...
  if ( v7 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v29);
  v8 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v31 + 56LL))(v31, &v35);
  if ( v8 < 0 )
    wil::details::in1diag3::Throw_Hr(
      retaddr,
      (void *)0x1CD,
  ...
  for ( i = 0; i < v35; ++i )
  {
    ...
    if ( v18 < 0 )
      wil::details::in1diag3::Throw_Hr(
        ...
        v29);
    v19 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v30 + 64LL))(v30, &v36);
    if ( v19 < 0 )
      wil::details::in1diag3::Throw_Hr(
        retaddr,
        (void *)0x1D9,
    ...
    v32 = 0;
    v37 = 0LL;
    Windows::Services::TargetedContent::Internal::GetStringBytes(v33, (void **)&v37, &v32);
    Windows::Services::TargetedContent::Internal::GetBase64StringFromBytes(&string, v32, v37);
    v5 |= 1u;
    ...
    v23 = Windows::Services::TargetedContent::Internal::ResolveNameFromTriggerState(v36);
    v24 = std::operator<<<wchar_t,std::char_traits<wchar_t>>(v22, v23);
    v25 = std::operator<<<wchar_t,std::char_traits<wchar_t>>(v24, L";");
    v26 = Windows::Services::TargetedContent::Internal::ResolveNameFromTriggerState(v29);
  ...
  if ( v35 )
  {
    ...
    if ( v40[3] >= 8uLL )
      v27 = (HSTRING)v40[0];
    string = v27;
    v28 = CreativeFramework::Triggers::PropertySetHelperBase<&wchar_t const near * const RuntimeClass_Windows_Foundation_Collections_PropertySet>::SetValue<_lambda_e85697e1379bd30e043dcf6a8e09ee83_>(
            (__int64)this,
            L"StateTransitions",
            (const WCHAR **)&string);
    if ( v28 < 0 )
