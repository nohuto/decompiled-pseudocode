/*
 * XREFs of ??1CreativeEventReportedCache@ContentManagement@@UEAA@XZ @ 0x1800534E8
 * Callers:
 *     ??_GCreativeEventReportedCache@ContentManagement@@UEAAPEAXI@Z @ 0x180054940 (--_GCreativeEventReportedCache@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
