...
__int64 __fastcall std::map<std::wstring,std::wstring>::operator[](__int64 *a1, const wchar_t *a2)
{
  ...
  _QWORD v12[8]; // [rsp+60h] [rbp-68h] BYREF

  v4 = *a1;
  v5 = *(_QWORD *)(*a1 + 8);
  while ( !*(_BYTE *)(v5 + 25) )
  {
    if ( std::wstring::compare((const wchar_t *)(v5 + 32), a2) >= 0 )
    {
      v4 = (__int64)v6;
      v5 = *v6;
    }
  ...
  if ( v4 == *a1 || std::wstring::compare(a2, (const wchar_t *)(v4 + 32)) < 0 )
  {
    v11[3] = 7LL;
    v11[2] = 0LL;
    LOWORD(v11[0]) = 0;
    v7 = std::pair<std::wstring,std::wstring>::pair<std::wstring,std::wstring>((__int64)v12, (__int64)a2, (__int64)v11);
    v8 = std::_Tree_buy<std::pair<std::wstring const,std::wstring>>::_Buynode<std::pair<std::wstring,std::wstring>>(
           (__int64)a1,
           v7);
