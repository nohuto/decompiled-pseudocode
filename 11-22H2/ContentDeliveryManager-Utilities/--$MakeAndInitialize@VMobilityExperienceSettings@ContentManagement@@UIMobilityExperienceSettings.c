/*
 * XREFs of ??$MakeAndInitialize@VMobilityExperienceSettings@ContentManagement@@UIMobilityExperienceSettings@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIMobilityExperienceSettings@ContentManagement@@@Z @ 0x18002741C
 * Callers:
