/*
 * XREFs of ?InternalRelease@?$ComPtr@VUnlockActionHelper@@@WRL@Microsoft@@IEAAKXZ @ 0x180059DC4
 * Callers:
 ...
 *     ??1?$ComPtr@VUnlockActionHelper@@@WRL@Microsoft@@QEAA@XZ @ 0x180052DB4 (--1-$ComPtr@VUnlockActionHelper@@@WRL@Microsoft@@QEAA@XZ.c)
 ...
 * Callees:
 *     ?Release@?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIPendingLaunch@Private@System@Windows@@@Details@WRL@Microsoft@@UEAAKXZ @ 0x18005C8A0 (-Release@-$RuntimeClassImpl@U-$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIPendingLaunch@Pr.c)
 */
