/*
 * XREFs of ??$make_shared@VPinWebsiteToTaskbarService@Actions@CreativeFramework@@PEB_WPEB_WPEB_W@std@@YA?AV?$shared_ptr@VPinWebsiteToTaskbarService@Actions@CreativeFramework@@@0@$$QEAPEB_W00@Z @ 0x1800B5BF4
 * Callers:
 *     _lambda_a111f9909dcb1fbe287f852ebd02ec50_::operator() @ 0x1800B5E8C (_lambda_a111f9909dcb1fbe287f852ebd02ec50_--operator().c)
 * Callees:
