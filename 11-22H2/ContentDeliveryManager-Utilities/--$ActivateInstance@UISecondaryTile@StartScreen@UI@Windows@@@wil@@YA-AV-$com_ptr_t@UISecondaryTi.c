/*
 * XREFs of ??$ActivateInstance@UISecondaryTile@StartScreen@UI@Windows@@@wil@@YA?AV?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x1800BD12C
 * Callers:
 ...
 *     ??$query@UISecondaryTile@StartScreen@UI@Windows@@@?$com_ptr_t@UIInspectable@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UISecondaryTile@StartScreen@UI@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800BD740 (--$query@UISecondaryTile@StartScreen@UI@Windows@@@-$com_ptr_t@UIInspectable@@Uerr_exception_poli.c)
 */
