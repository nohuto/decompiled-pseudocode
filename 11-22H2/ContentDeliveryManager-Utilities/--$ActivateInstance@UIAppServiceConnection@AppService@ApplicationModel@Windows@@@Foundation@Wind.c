/*
 * XREFs of ??$ActivateInstance@UIAppServiceConnection@AppService@ApplicationModel@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIAppServiceConnection@AppService@ApplicationModel@1@@Z @ 0x18004BF94
 * Callers:
