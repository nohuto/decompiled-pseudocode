 ...
 *     ?GetActivityStoreForCDPAccountCanBeNull@CDPActivityHelper@MobilityExperience@@YA?AV?$com_ptr_t@VICDPActivityStore@@Uerr_exception_policy@wil@@@wil@@PEAVICDPAccount@@@Z @ 0x18006F788 (-GetActivityStoreForCDPAccountCanBeNull@CDPActivityHelper@MobilityExperience@@YA-AV-$com_ptr_t@V.c)
 ...
 *     ?_Reserve@?$vector@V?$com_ptr_t@VICDPActivityStore@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VICDPActivityStore@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@IEAAX_K@Z @ 0x1800717CC (-_Reserve@-$vector@V-$com_ptr_t@VICDPActivityStore@@Uerr_exception_policy@wil@@@wil@@V-$allocato.c)
