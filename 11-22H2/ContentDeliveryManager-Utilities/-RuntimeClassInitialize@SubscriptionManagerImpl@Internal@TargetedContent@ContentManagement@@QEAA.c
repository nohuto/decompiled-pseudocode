/*
 * XREFs of ?RuntimeClassInitialize@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@QEAAJXZ @ 0x18006A620
 * Callers:
 *     ??$MakeAndInitialize@VSubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@UISubscriptionManager@234@$$V@Details@WRL@Microsoft@@YAJPEAPEAUISubscriptionManager@Internal@TargetedContent@ContentManagement@@@Z @ 0x180066034 (--$MakeAndInitialize@VSubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@UISubs.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  const char *v10; // r9
  __int64 result; // rax
  _DWORD v12[2]; // [rsp+20h] [rbp-A8h] BYREF
  wil::details *v13; // [rsp+28h] [rbp-A0h] BYREF
  char v14[8]; // [rsp+30h] [rbp-98h] BYREF
  _QWORD v15[15]; // [rsp+38h] [rbp-90h] BYREF
