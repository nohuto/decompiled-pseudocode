/*
 * XREFs of ??$MakeAndInitialize@V?$SimpleSealedActivationFactory@VAppInstallInfoRecordImpl@ContentManagement@@$0A@@WRL@Microsoft@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAV?$SimpleSealedActivationFactory@VAppInstallInfoRecordImpl@ContentManagement@@$0A@@12@@Z @ 0x180047360
 * Callers:
...
__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<Microsoft::WRL::SimpleSealedActivationFactory<ContentManagement::AppInstallInfoRecordImpl,0>,Microsoft::WRL::SimpleSealedActivationFactory<ContentManagement::AppInstallInfoRecordImpl,0>,>(
        _QWORD *a1)
{
  unsigned int v1; // ebx
  void *v3; // rax
  ...
  *a1 = 0LL;
  ...
  if ( v3 )
  {
    ...
    v6 = 0LL;
    *v4 = &Microsoft::WRL::SimpleSealedActivationFactory<ContentManagement::AppInstallInfoRecordImpl,0>::`vftable';
