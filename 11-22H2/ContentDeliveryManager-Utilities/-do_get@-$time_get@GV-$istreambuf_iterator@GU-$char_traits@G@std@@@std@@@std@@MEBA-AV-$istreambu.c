/*
 * XREFs of ?do_get@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x180018390
 * Callers:
 *     <none>
 * Callees:
...
LABEL_73:
  ...
  if ( a8 > 110 )
  {
    if ( a8 == 112 )
    {
      v29 = std::_Getloctxt<char,std::istreambuf_iterator<unsigned short>>(a3, a4, 0LL, ":AM:am:PM:pm");
      if ( v29 < 0 )
        goto LABEL_73;
      a7[2] += 12 * v29;
      goto LABEL_75;
...
LABEL_52:
  ...
  if ( a8 != 109 )
    goto LABEL_73;
  v26 = *v16 | std::time_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getint(
                 (__int64)a1,
                 a3,
                 a4,
                 1,
