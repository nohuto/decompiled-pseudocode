/*
 * XREFs of ?RegisterBackgroundTaskIfNeeded@CommonHelper@CreativeFramework@@YA_NPEAUHSTRING__@@0PEAUIBackgroundTrigger@Background@ApplicationModel@Windows@@W4TaskConditionFlags@12@W4TaskRegistrationOptions@12@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x1800D2D28
 * Callers:
 ...
 *     ??$ActivateInstance@UIBackgroundTaskBuilder@Background@ApplicationModel@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIBackgroundTaskBuilder@Background@ApplicationModel@1@@Z @ 0x1800D2054 (--$ActivateInstance@UIBackgroundTaskBuilder@Background@ApplicationModel@Windows@@@Foundation@Win.c)
 ...
 *     ??$query@UIBackgroundCondition@Background@ApplicationModel@Windows@@@?$com_ptr_t@UISystemCondition@Background@ApplicationModel@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIBackgroundCondition@Background@ApplicationModel@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800D2798 (--$query@UIBackgroundCondition@Background@ApplicationModel@Windows@@@-$com_ptr_t@UISystemConditi.c)
