/*
 * XREFs of ?_Putmfld@?$money_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@_NAEAVios_base@2@G1V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@G@Z @ 0x180016994
 * Callers:
        ...
        unsigned __int16 a9)
{
  ...
  if ( a4 )
  {
    ...
    *(_QWORD *)&v68 = v13;
    ...
    v14 = std::use_facet<std::moneypunct<unsigned short,1>>((__int64 *)&v68);
    if ( v13 )
    {
  ...
  else
  {
    ...
    *(_QWORD *)&v68 = v16;
    ...
    v14 = std::use_facet<std::moneypunct<unsigned short,0>>((__int64 *)&v68);
    if ( v16 )
    {
