/*
 * XREFs of ??1UniqueExtendedExecutionSession@@UEAA@XZ @ 0x1800A5558
 * Callers:
 *     ??_GUniqueExtendedExecutionSession@@UEAAPEAXI@Z @ 0x1800A5850 (--_GUniqueExtendedExecutionSession@@UEAAPEAXI@Z.c)
 * Callees:
