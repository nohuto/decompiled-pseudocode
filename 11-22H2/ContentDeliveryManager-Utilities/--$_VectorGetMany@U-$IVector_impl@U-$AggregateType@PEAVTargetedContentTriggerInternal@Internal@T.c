/*
 * XREFs of ??$_VectorGetMany@U?$IVector_impl@U?$AggregateType@PEAVTargetedContentTriggerInternal@Internal@TargetedContent@Services@Windows@@PEAUITargetedContentTriggerInternal@2345@@Internal@Foundation@Windows@@$00@Collections@Foundation@Windows@@PEAUITargetedContentTriggerInternal@Internal@TargetedContent@Services@4@@Detail@Collections@Foundation@Windows@@YAJPEAU?$IVector_impl@U?$AggregateType@PEAVTargetedContentTriggerInternal@Internal@TargetedContent@Services@Windows@@PEAUITargetedContentTriggerInternal@2345@@Internal@Foundation@Windows@@$00@123@IIPEAPEAUITargetedContentTriggerInternal@Internal@TargetedContent@Services@3@PEAI@Z @ 0x18008EA60
 * Callers:
 *     ?GetMany@?$IVector_impl@U?$AggregateType@PEAVTargetedContentTriggerInternal@Internal@TargetedContent@Services@Windows@@PEAUITargetedContentTriggerInternal@2345@@Internal@Foundation@Windows@@$00@Collections@Foundation@Windows@@UEAAJIIPEAPEAUITargetedContentTriggerInternal@Internal@TargetedContent@Services@4@PEAI@Z @ 0x1800918A0 (-GetMany@-$IVector_impl@U-$AggregateType@PEAVTargetedContentTriggerInternal@Internal@TargetedCon.c)
 * Callees:
