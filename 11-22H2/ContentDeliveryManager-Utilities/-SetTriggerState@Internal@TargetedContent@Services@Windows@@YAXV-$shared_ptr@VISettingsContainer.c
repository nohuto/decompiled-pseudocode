/*
 * XREFs of ?SetTriggerState@Internal@TargetedContent@Services@Windows@@YAXV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@PEAUITargetedContentTriggerInternal@1234@W4TargetedContentTriggerState@1234@@Z @ 0x18009F04C
 * Callers:
 ...
 *     ??0PropertySetHelper@Triggers@CreativeFramework@@QEAA@PEAUIPropertySet@Collections@Foundation@Windows@@@Z @ 0x18009AFB0 (--0PropertySetHelper@Triggers@CreativeFramework@@QEAA@PEAUIPropertySet@Collections@Foundation@Wi.c)
...
void __fastcall Windows::Services::TargetedContent::Internal::SetTriggerState(__int64 *a1, __int64 a2, int a3)
{
  ...
  wchar_t *v13; // [rsp+28h] [rbp-48h] BYREF
  ...
  CreativeFramework::Triggers::PropertySetHelper::PropertySetHelper(
    ...
    v12);
  v13 = Windows::Services::TargetedContent::Internal::ResolveNameFromTriggerState(a3);
