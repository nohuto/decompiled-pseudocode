/*
 * XREFs of ?get_MobilityExperienceSettings@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIMobilityExperienceSettings@2@@Z @ 0x180044460
 * Callers:
 *     <none>
 * Callees:
 *     ??$MakeAndInitialize@VMobilityExperienceSettings@ContentManagement@@UIMobilityExperienceSettings@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIMobilityExperienceSettings@ContentManagement@@@Z @ 0x18002741C (--$MakeAndInitialize@VMobilityExperienceSettings@ContentManagement@@UIMobilityExperienceSettings.c)
