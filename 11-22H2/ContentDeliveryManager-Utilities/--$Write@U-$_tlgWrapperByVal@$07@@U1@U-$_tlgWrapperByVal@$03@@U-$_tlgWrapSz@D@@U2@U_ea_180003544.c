        ...
        const wchar_t **a24)
{
  ...
  const wchar_t *v69; // [rsp+A0h] [rbp-60h]
  ...
  const wchar_t *v79; // [rsp+E0h] [rbp-20h]
  ...
  const wchar_t *v102; // [rsp+170h] [rbp+70h]
  int v103; // [rsp+178h] [rbp+78h]
  int v104; // [rsp+17Ch] [rbp+7Ch]
  const wchar_t *v105; // [rsp+180h] [rbp+80h]
