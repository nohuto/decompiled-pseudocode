/*
 * XREFs of ??1?$vector@UTile@TargetedContentLayoutHelpers@CreativeFramework@@V?$allocator@UTile@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@std@@QEAA@XZ @ 0x1800C7320
 * Callers:
 *     _CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver::LayoutResolver_::_1_::dtor$4 @ 0x1800DCBB7 (_CreativeFramework--TargetedContentLayoutHelpers--LayoutResolver--LayoutResolver_--_1_--dtor$4.c)
 * Callees:
