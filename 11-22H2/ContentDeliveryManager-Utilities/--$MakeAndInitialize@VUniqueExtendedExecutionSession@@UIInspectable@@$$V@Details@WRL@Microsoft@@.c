/*
 * XREFs of ??$MakeAndInitialize@VUniqueExtendedExecutionSession@@UIInspectable@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIInspectable@@@Z @ 0x1800A4864
 * Callers:
 ...
 *     ??0UniqueExtendedExecutionSession@@QEAA@XZ @ 0x1800A5184 (--0UniqueExtendedExecutionSession@@QEAA@XZ.c)
