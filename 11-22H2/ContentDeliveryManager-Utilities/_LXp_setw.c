/*
 * XREFs of _LXp_setw @ 0x18000E16C
 * Callers:
 *     _Stoldx @ 0x180006264 (_Stoldx.c)
 *     _LXp_setn @ 0x18000E144 (_LXp_setn.c)
 *     _LDtento @ 0x18000E280 (_LDtento.c)
 * Callees:
 *     _LDscale @ 0x18000DA48 (_LDscale.c)
 *     _LDint @ 0x180021A58 (_LDint.c)
 *     _LDunscale @ 0x180021A64 (_LDunscale.c)
 */
