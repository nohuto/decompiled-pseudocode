/*
 * XREFs of ?CopyFaviconToEdge@@YAJPEAUHSTRING__@@PEAPEAU1@@Z @ 0x1800BDF60
 * Callers:
 ...
 *     ??$query@UIStorageItem@Storage@Windows@@@?$com_ptr_t@UIStorageFile@Storage@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIStorageItem@Storage@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800BD800 (--$query@UIStorageItem@Storage@Windows@@@-$com_ptr_t@UIStorageFile@Storage@Windows@@Uerr_excepti.c)
...
__int64 __fastcall CopyFaviconToEdge(__int64 (__fastcall ***a1)(_QWORD, GUID *, _QWORD *), HSTRING *a2)
{
  ...
  newString = 0LL;
  v12 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v32, (const WCHAR **)off_1800FE428, v11);
  ...
  *v15 = 0LL;
  ...
  v17 = newString;
  v19 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v32, (const WCHAR **)off_1800FE420, v18);
