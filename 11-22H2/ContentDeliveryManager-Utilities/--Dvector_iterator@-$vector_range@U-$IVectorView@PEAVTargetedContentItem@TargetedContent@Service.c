/*
 * XREFs of ??Dvector_iterator@?$vector_range@U?$IVectorView@PEAVTargetedContentItem@TargetedContent@Services@Windows@@@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@QEAAAEBV?$ComPtr@UITargetedContentItem@TargetedContent@Services@Windows@@@WRL@Microsoft@@XZ @ 0x1800C7778
 * Callers:
