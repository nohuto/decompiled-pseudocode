/*
 * XREFs of ?StartWatching@ThreadFailureCallbackHolder@details@wil@@QEAAXXZ @ 0x18005EBD8
 * Callers:
 ...
 *     ?EnsureWatchingCurrentThread@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@IEAAXXZ @ 0x180075F44 (-EnsureWatchingCurrentThread@-$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDel.c)
