/*
 * XREFs of ?GetLastError@ThreadLocalData@details_abi@wil@@QEAA_NAEAUFailureInfo@3@IJ@Z @ 0x180035210
 * Callers:
 ...
 * Callees:
 *     ?Get@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEAUFailureInfo@3@@Z @ 0x180032EB0 (-Get@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEAUFailureInfo@3@@Z.c)
 */
