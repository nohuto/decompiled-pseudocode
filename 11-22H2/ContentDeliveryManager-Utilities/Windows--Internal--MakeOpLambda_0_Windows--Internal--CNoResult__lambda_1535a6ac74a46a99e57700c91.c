/*
 * XREFs of Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_1535a6ac74a46a99e57700c911cef706___ @ 0x18007313C
 * Callers:
 *     ?CommitAsync@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUIAsyncAction@Foundation@5@@Z @ 0x180075C30 (-CommitAsync@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@UEAAJP.c)
 * Callees:
...
_QWORD *__fastcall Windows::Internal::MakeOpLambda_0_Windows::Internal::CNoResult__lambda_1535a6ac74a46a99e57700c911cef706___(
        _QWORD *a1)
{
  _QWORD *v2; // rax
  _QWORD *v3; // rbx
