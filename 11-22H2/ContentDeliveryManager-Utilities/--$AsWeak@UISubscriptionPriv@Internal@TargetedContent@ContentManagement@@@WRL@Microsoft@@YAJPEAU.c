/*
 * XREFs of ??$AsWeak@UISubscriptionPriv@Internal@TargetedContent@ContentManagement@@@WRL@Microsoft@@YAJPEAUISubscriptionPriv@Internal@TargetedContent@ContentManagement@@PEAVWeakRef@01@@Z @ 0x180065DFC
 * Callers:
