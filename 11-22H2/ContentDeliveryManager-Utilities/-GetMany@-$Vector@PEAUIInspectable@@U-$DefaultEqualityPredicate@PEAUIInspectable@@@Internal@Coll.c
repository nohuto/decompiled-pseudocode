/*
 * XREFs of ?GetMany@?$Vector@PEAUIInspectable@@U?$DefaultEqualityPredicate@PEAUIInspectable@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUIInspectable@@@3456@U?$VectorOptions@PEAUIInspectable@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@UEAAJIIPEAPEAUIInspectable@@PEAI@Z @ 0x1800C8C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Windows::Foundation::Collections::Internal::Vector<IInspectable *,Windows::Foundation::Collections::Internal::DefaultEqualityPredicate<IInspectable *>,Windows::Foundation::Collections::Internal::DefaultLifetimeTraits<IInspectable *>,Windows::Foundation::Collections::Internal::VectorOptions<IInspectable *,0,1,0>>::GetMany(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        void *a4,
...
LABEL_27:
      ...
      v15 = XWinRT::detail::GitStorageType<IInspectable>::ReferencedGitCookie::Localize(v35[0].m128i_i64[0], v20);
LABEL_26:
      if ( v15 < 0 )
        goto LABEL_28;
      goto LABEL_27;
...
LABEL_46:
    if ( v9 )
    {
      ...
      do
      {
        XWinRT::InterfaceLifetimeTraits::Destroy<IInspectable>(v28++);
        --v27;
      }
      while ( v27 );
    }
      ...
      if ( v6 )
      {
        ...
        do
        {
          ...
          *v25 = 0LL;
          if ( v24[8] )
          {
            v15 = XWinRT::detail::GitStorageType<IInspectable>::ReferencedGitCookie::Localize(*(_QWORD *)v24, v25);
            if ( v15 < 0 )
              goto LABEL_46;
