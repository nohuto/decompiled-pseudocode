/*
 * XREFs of ?ResultFromCaughtExceptionInternal@details@wil@@YA?AUResultStatus@12@PEAG_KPEA_N@Z @ 0x18003EFE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall wil::details::ResultFromCaughtExceptionInternal(__int64 a1, _WORD *a2, __int64 a3, _BYTE *a4)
{
  ...
  exception *v20; // [rsp+40h] [rbp-48h] BYREF
  ...
  const struct exception *v25; // [rsp+98h] [rbp+10h]
  const struct wil::ResultException *v26; // [rsp+98h] [rbp+10h]
  const struct exception *v27; // [rsp+98h] [rbp+10h]
