/*
 * XREFs of ??$MakeAndInitialize@VAppManager@ContentManagement@@UIAppManager@2@AEAPEAUIUser@System@Windows@@@Details@WRL@Microsoft@@YAJPEAPEAUIAppManager@ContentManagement@@AEAPEAUIUser@System@Windows@@@Z @ 0x18007B9B8
 * Callers:
 *     ?CreateInstance_AppManager@@YAJPEAUIUser@System@Windows@@PEAPEAUIAppManager@ContentManagement@@@Z @ 0x18007F72C (-CreateInstance_AppManager@@YAJPEAUIUser@System@Windows@@PEAPEAUIAppManager@ContentManagement@@@.c)
 * Callees:
 ...
 *     ??0AppManager@ContentManagement@@QEAA@XZ @ 0x18007D8B8 (--0AppManager@ContentManagement@@QEAA@XZ.c)
