/*
 * XREFs of ?get@?$static_lazy@VDelayAllocateTLSLogging@@@details@wil@@QEAAPEAVDelayAllocateTLSLogging@@P6AXXZ@Z @ 0x180043C10
 * Callers:
...
__int64 *__fastcall wil::details::static_lazy<DelayAllocateTLSLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  v8 = a1;
  v9 = 0LL;
  if ( InitOnceBeginInitialize(&`DelayAllocateTLSLogging::Instance'::`2'::wrapper, 0, (PBOOL)&v8, (LPVOID *)&v9)
    && (_DWORD)v8 )
  {
    v6 = &`DelayAllocateTLSLogging::Instance'::`2'::wrapper;
    v9 = &qword_1801964E8;
    qword_1801964E8 = (__int64)&CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_180196500 = (__int64)&`DelayAllocateTLSLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    v7 = 0;
