/*
 * XREFs of ?put_ProductId@AppInstallInfoRecordImpl@ContentManagement@@UEAAJPEAUHSTRING__@@@Z @ 0x18004BC40
 * Callers:
        ...
        HSTRING a2)
{
  ...
  v5 = v2;
  LODWORD(v2) = Microsoft::WRL::Wrappers::HString::Set((HSTRING *)this + 4, &v6);
