/*
 * XREFs of CreativeFramework::CommonHelper::EnumerateRegisteredTasks__lambda_9bf169d33d4e1f2aada1302272b1c7f2___ @ 0x1800D23A4
 * Callers:
  ...
  while ( (*(int (__fastcall **)(__int64 *, int *))(*v15 + 56))(v15, &v13) >= 0 && (_BYTE)v13 )
  {
    ...
    if ( v11 < 0 )
      wil::details::in1diag3::Throw_Hr(
        ...
        v13);
    if ( (unsigned __int8)lambda_9bf169d33d4e1f2aada1302272b1c7f2_::operator()(a1, v16)
