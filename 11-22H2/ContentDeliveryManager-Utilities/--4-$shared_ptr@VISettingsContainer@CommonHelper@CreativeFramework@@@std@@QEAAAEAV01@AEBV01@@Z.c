/*
 * XREFs of ??4?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@QEAAAEAV01@AEBV01@@Z @ 0x18009B3CC
 * Callers:
        ...
        __int64 *a2)
{
  ...
  v3 = std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>(
         &v7,
         a2);
  v4 = v3[1];
  v3[1] = a1[1];
