/*
 * XREFs of ?DismissNotification@NotificationManagerService@Actions@CreativeFramework@@AEAAXXZ @ 0x1800B7430
 * Callers:
 *     ?Revert@NotificationManagerService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800B7830 (-Revert@NotificationManagerService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
