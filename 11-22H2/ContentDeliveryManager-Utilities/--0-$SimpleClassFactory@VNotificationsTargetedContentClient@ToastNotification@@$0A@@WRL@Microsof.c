/*
 * XREFs of ??0?$SimpleClassFactory@VNotificationsTargetedContentClient@ToastNotification@@$0A@@WRL@Microsoft@@QEAA@XZ @ 0x18006E1F4
 * Callers:
 *     ??$MakeAndInitialize@V?$SimpleClassFactory@VNotificationsTargetedContentClient@ToastNotification@@$0A@@WRL@Microsoft@@V123@$$V@Details@WRL@Microsoft@@YAJPEAPEAV?$SimpleClassFactory@VNotificationsTargetedContentClient@ToastNotification@@$0A@@12@@Z @ 0x18006CD3C (--$MakeAndInitialize@V-$SimpleClassFactory@VNotificationsTargetedContentClient@ToastNotification.c)
 * Callees:
