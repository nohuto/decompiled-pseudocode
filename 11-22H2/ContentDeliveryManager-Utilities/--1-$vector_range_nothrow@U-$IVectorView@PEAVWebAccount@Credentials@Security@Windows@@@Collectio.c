/*
 * XREFs of ??1?$vector_range_nothrow@U?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@wil@@QEAA@XZ @ 0x1800C1488
 * Callers:
 *     _MobilityExperienceManager::GetHasMobilityAccount_::_1_::dtor$4 @ 0x1800DC811 (_MobilityExperienceManager--GetHasMobilityAccount_--_1_--dtor$4.c)
 * Callees:
 *     <none>
 */
