/*
 * XREFs of ?get_LaunchManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUILaunchManager@2@@Z @ 0x180044390
 * Callers:
 *     <none>
 * Callees:
 *     ??$MakeAndInitialize@VLaunchManager@ContentManagement@@UILaunchManager@2@$$V@Details@WRL@Microsoft@@YAJPEAPEAUILaunchManager@ContentManagement@@@Z @ 0x1800272E8 (--$MakeAndInitialize@VLaunchManager@ContentManagement@@UILaunchManager@2@$$V@Details@WRL@Microso.c)
