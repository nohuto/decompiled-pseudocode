        ...
        bool *a2)
{
  ...
  v8 = 0;
  *a2 = 0;
  XWinRT::SerializingLockPolicy::Read(&v10, (RTL_SRWLOCK *)(*(_QWORD *)(a1 + 64) + 160LL), &v8);
  v4 = v8;
  if ( v8 >= 0 )
  {
