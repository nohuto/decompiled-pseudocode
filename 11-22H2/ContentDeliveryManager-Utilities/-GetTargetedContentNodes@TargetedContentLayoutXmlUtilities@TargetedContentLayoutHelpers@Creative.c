 ...
 *     ?_Reserve@?$vector@V?$com_ptr_t@UIXmlNode@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIXmlNode@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@IEAAX_K@Z @ 0x1800CCC88 (-_Reserve@-$vector@V-$com_ptr_t@UIXmlNode@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@wil@.c)
        ...
        __int64 a2)
{
  ...
  if ( v6 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v15);
  v7 = (*(__int64 (__fastcall **)(__int64 *, unsigned int *))(*v17 + 48))(v17, &v16);
  if ( v7 < 0 )
    wil::details::in1diag3::Throw_Hr(
      retaddr,
      (void *)0x8D,
  ...
  *(_QWORD *)(a2 + 16) = 0LL;
  ...
  for ( i = 0; i < v16; ++i )
  {
    ...
    v9 = *v17;
    v15 = 0LL;
    v10 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, __int64 *))(v9 + 56))(v17, i, &v15);
    if ( v10 < 0 )
      wil::details::in1diag3::Throw_Hr(
        retaddr,
        (void *)0x93,
        ...
        v15);
    v11 = *(_QWORD *)(a2 + 8);
    if ( (unsigned __int64)&v15 >= v11 || *(_QWORD *)a2 > (unsigned __int64)&v15 )
    {
      if ( v11 == *(_QWORD *)(a2 + 16) )
