 ...
 *     wil_details_FeatureReporting_RecordUsageInCache @ 0x180045E68 (wil_details_FeatureReporting_RecordUsageInCache.c)
        ...
        char a8)
{
  ...
  *(_OWORD *)v21 = *(_OWORD *)v12;
  v22 = v13;
  wil::details::RecordFeatureUsageCallback((wil *)a2, a5, v14, a1, (RTL_SRWLOCK *)v21);
  v17 = 0;
  if ( a3 )
  {
    v18 = a5 | 0x80000000;
