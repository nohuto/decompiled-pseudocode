/*
 * XREFs of ??_9ITargetedContentSubscriptionStatics@TargetedContent@Services@Windows@@$BDA@AA @ 0x1800C7A88
 * Callers:
...
__int64 __fastcall  Windows::Services::TargetedContent::ITargetedContentSubscriptionStatics::`vcall'{48,{flat}}(
        __int64 a1)
{
