/*
 * XREFs of ??$_VectorGetMany@U?$IVectorView_impl@U?$AggregateType@PEAVOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@Windows@@PEAUIOnlineIdServiceTicketRequest@2345@@Internal@Foundation@Windows@@$00@Collections@Foundation@Windows@@PEAUIOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@4@@Detail@Collections@Foundation@Windows@@YAJPEAU?$IVectorView_impl@U?$AggregateType@PEAVOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@Windows@@PEAUIOnlineIdServiceTicketRequest@2345@@Internal@Foundation@Windows@@$00@123@IIPEAPEAUIOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@3@PEAI@Z @ 0x1800299B8
 * Callers:
 *     ?GetMany@?$IVectorView_impl@U?$AggregateType@PEAVOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@Windows@@PEAUIOnlineIdServiceTicketRequest@2345@@Internal@Foundation@Windows@@$00@Collections@Foundation@Windows@@UEAAJIIPEAPEAUIOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@4@PEAI@Z @ 0x180035A00 (-GetMany@-$IVectorView_impl@U-$AggregateType@PEAVOnlineIdServiceTicketRequest@OnlineId@Authentic.c)
 * Callees:
...
__int64 __fastcall Windows::Foundation::Collections::Detail::_VectorGetMany<Windows::Foundation::Collections::IVectorView_impl<Windows::Foundation::Internal::AggregateType<Windows::Security::Authentication::OnlineId::OnlineIdServiceTicketRequest *,Windows::Security::Authentication::OnlineId::IOnlineIdServiceTicketRequest *>,1>,Windows::Security::Authentication::OnlineId::IOnlineIdServiceTicketRequest *>(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        _QWORD *a4,
