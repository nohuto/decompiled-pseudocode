/*
 * XREFs of ??$MakeAndInitialize@VContentManagementService@ContentManagement@@UIInspectable@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIInspectable@@@Z @ 0x180047854
 * Callers:
 *     ?ActivateInstance@?$SimpleActivationFactory@VContentManagementService@ContentManagement@@$0A@@WRL@Microsoft@@UEAAJPEAPEAUIInspectable@@@Z @ 0x180048A20 (-ActivateInstance@-$SimpleActivationFactory@VContentManagementService@ContentManagement@@$0A@@WR.c)
 * Callees:
