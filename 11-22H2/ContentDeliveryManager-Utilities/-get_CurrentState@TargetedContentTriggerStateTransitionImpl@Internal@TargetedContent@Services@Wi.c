/*
 * XREFs of ?get_CurrentState@TargetedContentTriggerStateTransitionImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAW4TargetedContentTriggerState@2345@@Z @ 0x18008ACE0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
