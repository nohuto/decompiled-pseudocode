/*
 * XREFs of ?DeleteDesktopSpotlightCreative@DesktopSpotlightHelpers@CreativeFramework@@YAJPEB_WPEA_N@Z @ 0x1800BBFEC
 * Callers:
 ...
 *     ?Unstage@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800BCF90 (-Unstage@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?c_str@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEBAPEB_WXZ @ 0x180096E68 (-c_str@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEBAPEB_WXZ.c)
