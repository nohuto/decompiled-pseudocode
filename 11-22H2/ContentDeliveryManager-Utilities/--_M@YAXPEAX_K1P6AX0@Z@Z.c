/*
 * XREFs of ??_M@YAXPEAX_K1P6AX0@Z@Z @ 0x1800227DC
 * Callers:
 ...
 *     ??1CreativeEventUriParser@LaunchCreativeHelpers@CreativeFramework@@QEAA@XZ @ 0x180053518 (--1CreativeEventUriParser@LaunchCreativeHelpers@CreativeFramework@@QEAA@XZ.c)
 ...
 *     ContentManagement::_dynamic_atexit_destructor_for__c_notificationHandlerTypeMappings__ @ 0x1800DDC70 (ContentManagement--_dynamic_atexit_destructor_for__c_notificationHandlerTypeMappings__.c)
 *     Windows::Services::TargetedContent::Internal::_dynamic_atexit_destructor_for__c_triggerStateTransitionSetupMapping__ @ 0x1800DDD00 (Windows--Services--TargetedContent--Internal--_dynamic_atexit_destructor_for__c_triggerStateTran.c)
 *     Windows::Services::TargetedContent::Internal::_dynamic_atexit_destructor_for__c_predicateKindHandlerMap__ @ 0x1800DDD30 (Windows--Services--TargetedContent--Internal--_dynamic_atexit_destructor_for__c_predicateKindHan.c)
 *     Windows::Services::TargetedContent::Internal::_dynamic_atexit_destructor_for__c_registerTaskHandlerMap__ @ 0x1800DDD60 (Windows--Services--TargetedContent--Internal--_dynamic_atexit_destructor_for__c_registerTaskHand.c)
 *     Windows::Services::TargetedContent::Internal::_dynamic_atexit_destructor_for__c_triggerPredicateKindMap__ @ 0x1800DDD90 (Windows--Services--TargetedContent--Internal--_dynamic_atexit_destructor_for__c_triggerPredicate.c)
 *     Windows::Services::TargetedContent::Internal::_dynamic_atexit_destructor_for__c_triggerTypeTaskHandlerMap__ @ 0x1800DDDC0 (Windows--Services--TargetedContent--Internal--_dynamic_atexit_destructor_for__c_triggerTypeTaskH.c)
 * Callees:
 *     <none>
 */
