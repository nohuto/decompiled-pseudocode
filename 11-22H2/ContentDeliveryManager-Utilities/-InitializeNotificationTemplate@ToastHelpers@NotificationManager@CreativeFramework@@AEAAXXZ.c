/*
 * XREFs of ?InitializeNotificationTemplate@ToastHelpers@NotificationManager@CreativeFramework@@AEAAXXZ @ 0x1800C0B98
 * Callers:
        ...
        CreativeFramework::NotificationManager::ToastHelpers *this)
{
  ...
  std::wstring::_Tidy(v9, 1, 0LL);
  for ( i = (_WORD **)&unk_1800FE440; i != (_WORD **)&off_1800FE4D0; i += 3 )
  {
