/*
 * XREFs of ??0?$_Tree@V?$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@$0A@@std@@@std@@QEAA@AEBV01@AEBV?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@1@@Z @ 0x1800A37B8
 * Callers:
 ...
 *     ??0?$_Tree_comp@$0A@V?$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@$0A@@std@@@std@@QEAA@AEBUless@Triggers@CreativeFramework@@AEBV?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@1@@Z @ 0x1800A3840 (--0-$_Tree_comp@$0A@V-$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V.c)
 */
        ...
        __int64 a3)
{
  ...
  try
  {
    *(_QWORD *)(*a1 + 8) = std::_Tree<std::_Tmap_traits<unsigned short const *,_WNF_STATE_NAME const *,CreativeFramework::Triggers::less,std::allocator<std::pair<unsigned short const * const,_WNF_STATE_NAME const *>>,0>>::_Copy_nodes<std::integral_constant<bool,0>>(
                             a1,
                             *(_QWORD *)(qword_180196568 + 8),
                             *a1,
                             (char)a1);
    a1[1] = qword_180196570;
    v4 = *(_QWORD *)(*a1 + 8);
    if ( *(_BYTE *)(v4 + 25) )
    {
      *(_QWORD *)*a1 = *a1;
