/*
 * XREFs of ?TargetedContentTrigger_CreateInstance@Internal@TargetedContent@Services@Windows@@YAJW4TargetedContentKnownTrigger@1234@PEAUHSTRING__@@1111PEAPEAUITargetedContentTriggerInternal@1234@@Z @ 0x18008A91C
 * Callers:
...
__int64 Windows::Services::TargetedContent::Internal::TargetedContentTrigger_CreateInstance(unsigned int a1, ...)
{
  ...
  HSTRING v12; // [rsp+78h] [rbp+30h] BYREF
  va_list va; // [rsp+78h] [rbp+30h]
  HSTRING v14; // [rsp+80h] [rbp+38h] BYREF
  va_list va1; // [rsp+80h] [rbp+38h]
  HSTRING v16; // [rsp+88h] [rbp+40h] BYREF
  va_list va2; // [rsp+88h] [rbp+40h]
  __int64 v18; // [rsp+90h] [rbp+48h] BYREF
  va_list va3; // [rsp+90h] [rbp+48h]
  __int64 v20; // [rsp+98h] [rbp+50h] BYREF
  va_list va4; // [rsp+98h] [rbp+50h]
  _QWORD *v22; // [rsp+A0h] [rbp+58h] BYREF
  va_list va5; // [rsp+A0h] [rbp+58h]
  va_list va6; // [rsp+A8h] [rbp+60h] BYREF
