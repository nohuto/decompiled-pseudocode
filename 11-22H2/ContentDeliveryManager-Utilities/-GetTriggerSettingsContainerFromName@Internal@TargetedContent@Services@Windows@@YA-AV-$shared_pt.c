/*
 * XREFs of ?GetTriggerSettingsContainerFromName@Internal@TargetedContent@Services@Windows@@YA?AV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@PEAUHSTRING__@@0@Z @ 0x18009D860
 * Callers:
 ...
 *     ?ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA?AW4TargetedContentKnownTrigger@1234@PEB_W@Z @ 0x18009901C (-ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA-AW4TargetedContentKnownTri.c)
 ...
 *     ??0?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@QEAA@$$T@Z @ 0x18009AF88 (--0-$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@QEAA@$$T@Z.c)
        ...
        HSTRING a3)
{
  ...
  __int64 *v16; // rax
  __int64 v17; // rcx
  void *v19[2]; // [rsp+20h] [rbp-79h] BYREF
  __int64 v20; // [rsp+30h] [rbp-69h] BYREF
  std::_Ref_count_base *v21; // [rsp+38h] [rbp-61h]
  void *v22[3]; // [rsp+40h] [rbp-59h] BYREF
  _QWORD v23[2]; // [rsp+58h] [rbp-41h] BYREF
  __int128 v24; // [rsp+68h] [rbp-31h] BYREF
  __int64 v25; // [rsp+78h] [rbp-21h]
  void *v26[4]; // [rsp+88h] [rbp-11h] BYREF
  _QWORD v27[4]; // [rsp+A8h] [rbp+Fh] BYREF

  v23[0] = a1;
  StringRawBuffer = WindowsGetStringRawBuffer(a2, 0LL);
  std::wstring::wstring((__int64)v26);
  CreativeFramework::CommonHelper::StringUtils::SplitString(v22, v26, L":");
  std::wstring::_Tidy(v26, 1, 0LL);
  v6 = (const WCHAR *)v22[0];
  if ( *((_QWORD *)v22[0] + 3) >= 8uLL )
    v6 = *(const WCHAR **)v22[0];
  v7 = Windows::Services::TargetedContent::Internal::ResolveTriggerFromName(v6);
  Windows::Services::TargetedContent::Internal::GetRootRegistrationSettingsForTriggerContainer((__int64)&v20, v7);
  if ( (Windows::Services::TargetedContent::Internal::ResolveTriggerRegistrationOption(v7) & 0x80u) != 0LL )
  {
    v8 = (_QWORD *)std::wstring::append(v22[0], L":");
    if ( v8[3] >= 8uLL )
      v8 = (_QWORD *)*v8;
    CreativeFramework::CommonHelper::StringUtils::RemoveSubstring(&v24, StringRawBuffer, v8);
    (*(void (__fastcall **)(__int64, void **))(*(_QWORD *)v20 + 16LL))(v20, v19);
    v9 = (void **)std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::find(
                    v19,
                    v23,
                    &v24);
    if ( *v9 == v19[0] )
    {
      std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>(a1);
      std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::~_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>(v19);
    ...
    v11 = (__int64 *)std::map<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>>::operator[](
                       (__int64 *)v19,
                       (void **)&v24);
    std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>::operator=(&v20, v11);
    std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::~_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>(v19);
    std::wstring::_Tidy(&v24, 1, 0LL);
  }
  if ( !WindowsIsStringEmpty(a3) )
  {
    ...
    CreativeFramework::CommonHelper::StringUtils::SplitString(&v24, v27, L"&");
    std::wstring::_Tidy(v27, 1, 0LL);
    v14 = (void **)*((_QWORD *)&v24 + 1);
    for ( i = (void **)v24; i != v14; i += 4 )
    {
      std::wstring::wstring((__int64)v26, i);
      (*(void (__fastcall **)(__int64, void **))(*(_QWORD *)v20 + 16LL))(v20, v19);
      v15 = (void **)std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::find(
                       v19,
                       v23,
                       v26);
      if ( *v15 == v19[0] )
      {
        ...
        if ( (_QWORD)v24 )
        {
          std::vector<std::wstring>::_Destroy(v17, v24, *((_QWORD *)&v24 + 1));
      ...
      v16 = (__int64 *)std::map<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>>::operator[](
                         (__int64 *)v19,
                         v26);
      std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>::operator=(&v20, v16);
      std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::~_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>(v19);
      std::wstring::_Tidy(v26, 1, 0LL);
    }
    if ( (_QWORD)v24 )
    {
      std::vector<std::wstring>::_Destroy(v12, v24, *((_QWORD *)&v24 + 1));
      operator delete((void *)v24);
    }
  }
...
LABEL_25:
  if ( v22[0] )
  {
    std::vector<std::wstring>::_Destroy(v10, v22[0], v22[1]);
