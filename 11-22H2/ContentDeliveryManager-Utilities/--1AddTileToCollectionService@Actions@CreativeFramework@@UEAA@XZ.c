/*
 * XREFs of ??1AddTileToCollectionService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800AC8EC
 * Callers:
 *     ??_EAddTileToCollectionService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800AD000 (--_EAddTileToCollectionService@Actions@CreativeFramework@@UEAAPEAXI@Z.c)
 * Callees:
