/*
 * XREFs of ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x18004396C
 * Callers:
 ...
 * Callees:
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x180043860 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
