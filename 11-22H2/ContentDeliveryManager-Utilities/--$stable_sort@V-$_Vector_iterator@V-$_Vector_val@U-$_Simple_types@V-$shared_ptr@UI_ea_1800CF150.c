...
__int64 __fastcall std::stable_sort<std::_Vector_iterator<std::_Vector_val<std::_Simple_types<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>>>,CreativeFramework::TargetedContentLayoutHelpers::less_than_special_bindings>(
        char *a1,
        __int64 *a2,
        char a3)
{
