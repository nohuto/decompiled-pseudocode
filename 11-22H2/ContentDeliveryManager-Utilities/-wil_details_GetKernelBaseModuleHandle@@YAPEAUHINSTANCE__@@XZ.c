/*
 * XREFs of ?wil_details_GetKernelBaseModuleHandle@@YAPEAUHINSTANCE__@@XZ @ 0x1800457E8
 * Callers:
 ...
 *     wil_StagingConfig_LogStagedFeatureUsage @ 0x180045C00 (wil_StagingConfig_LogStagedFeatureUsage.c)
 * Callees:
 *     <none>
 */
