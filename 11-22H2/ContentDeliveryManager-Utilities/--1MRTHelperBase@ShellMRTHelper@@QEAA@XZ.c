/*
 * XREFs of ??1MRTHelperBase@ShellMRTHelper@@QEAA@XZ @ 0x1800C3ABC
 * Callers:
 *     ??1MRTHelperForPackage@ShellMRTHelper@@QEAA@XZ @ 0x1800C3AFC (--1MRTHelperForPackage@ShellMRTHelper@@QEAA@XZ.c)
 ...
 *     _ShellMRTHelper::MRTHelperForPackage::MRTHelperForPackage_::_1_::dtor$0 @ 0x1800DC931 (_ShellMRTHelper--MRTHelperForPackage--MRTHelperForPackage_--_1_--dtor$0.c)
 * Callees:
