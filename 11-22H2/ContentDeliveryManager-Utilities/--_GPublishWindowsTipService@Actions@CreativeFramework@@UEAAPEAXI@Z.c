/*
 * XREFs of ??_GPublishWindowsTipService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x1800B9C20
 * Callers:
 *     <none>
 * Callees:
 *     ??1PublishWindowsTipService@Actions@CreativeFramework@@UEAA@XZ @ 0x1800B9BE0 (--1PublishWindowsTipService@Actions@CreativeFramework@@UEAA@XZ.c)
 */
