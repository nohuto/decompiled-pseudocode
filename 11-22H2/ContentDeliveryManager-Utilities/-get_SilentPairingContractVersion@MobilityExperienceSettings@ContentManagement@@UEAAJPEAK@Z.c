/*
 * XREFs of ?get_SilentPairingContractVersion@MobilityExperienceSettings@ContentManagement@@UEAAJPEAK@Z @ 0x180044880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ContentManagement::MobilityExperienceSettings::get_SilentPairingContractVersion(
        ...
        const struct _GUID *a2)
{
  ...
  if ( v3 >= 0 )
  {
    v3 = (*(__int64 (__fastcall **)(void *, const struct _GUID *))(*(_QWORD *)v8 + 80LL))(v8, a2);
    v4 = v3;
    if ( v3 >= 0 )
    {
      v4 = 0;
