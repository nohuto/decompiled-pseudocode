/*
 * XREFs of _Windows::Services::TargetedContent::Internal::_dynamic_initializer_for__c_triggerTypeTaskHandlerMap___::_1_::dtor$0 @ 0x1800D926A
 * Callers:
 *     <none>
 * Callees:
 *     <none>
