/*
 * XREFs of ?FindAppInfo@ContentDeliveryManagerAppInfoProvider@ApplicationModel@Extensions@Internal@Windows@@UEAAJPEAUHSTRING__@@PEAPEAUIAppInfo@25@@Z @ 0x1800C29A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$ActivateInstance@UIWpnAppInfoProvider@Notifications@Internal@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIWpnAppInfoProvider@Notifications@Internal@1@@Z @ 0x1800C228C (--$ActivateInstance@UIWpnAppInfoProvider@Notifications@Internal@Windows@@@Foundation@Windows@@YA.c)
