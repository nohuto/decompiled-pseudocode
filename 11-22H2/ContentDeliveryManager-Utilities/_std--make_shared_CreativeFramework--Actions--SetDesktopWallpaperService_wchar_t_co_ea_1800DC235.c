/*
 * XREFs of _std::make_shared_CreativeFramework::Actions::SetDesktopWallpaperService_wchar_t_const___wchar_t_const___wchar_t_const____::_1_::dtor$1 @ 0x1800DC235
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall std::make_shared_CreativeFramework::Actions::SetDesktopWallpaperService_wchar_t_const___wchar_t_const___wchar_t_const____::_1_::dtor_1(
        __int64 a1,
        __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 32) & 1) != 0 )
