/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x18003B1F8
 * Callers:
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x1800D5CBB (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
 * Callees:
