/*
 * XREFs of ?GetTaskConditionFlagsForTrigger@Internal@TargetedContent@Services@Windows@@YA?AW4TaskConditionFlags@CommonHelper@CreativeFramework@@PEAUITargetedContentTriggerInternal@1234@@Z @ 0x180097F08
 * Callers:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::GetTaskConditionFlagsForTrigger(__int64 a1)
{
  ...
  if ( v2 < 0 )
    wil::details::in1diag3::Throw_Hr(
      ...
      v7);
  v3 = (const wchar_t *)&unk_180113360;
  v4 = 0;
  do
  {
    if ( (v9 & *((_DWORD *)v3 + 1)) != 0 )
