/*
 * XREFs of ?GetNodeTileId@TargetedContentLayoutXmlUtilities@TargetedContentLayoutHelpers@CreativeFramework@@AEAA?AVHString@Wrappers@WRL@Microsoft@@AEBV?$com_ptr_t@UIXmlNode@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x1800C8F6C
 * Callers:
 ...
 *     ??$query@UIXmlAttribute@Dom@Xml@Data@Windows@@@?$com_ptr_t@UIXmlNode@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@wil@@QEBA?AV?$com_ptr_t@UIXmlAttribute@Dom@Xml@Data@Windows@@Uerr_exception_policy@wil@@@1@XZ @ 0x1800C6718 (--$query@UIXmlAttribute@Dom@Xml@Data@Windows@@@-$com_ptr_t@UIXmlNode@Dom@Xml@Data@Windows@@Uerr_.c)
