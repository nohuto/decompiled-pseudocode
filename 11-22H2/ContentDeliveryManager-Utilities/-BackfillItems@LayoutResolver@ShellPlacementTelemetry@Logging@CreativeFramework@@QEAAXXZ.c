/*
 * XREFs of ?BackfillItems@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXXZ @ 0x1800C7BA4
 * Callers:
...
void __fastcall CreativeFramework::Logging::ShellPlacementTelemetry::LayoutResolver::BackfillItems(
