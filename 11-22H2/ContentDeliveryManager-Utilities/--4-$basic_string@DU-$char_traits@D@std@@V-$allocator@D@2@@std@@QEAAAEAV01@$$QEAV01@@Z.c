/*
 * XREFs of ??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x18006E844
 * Callers:
 ...
 *     ?_Assign_rv@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAX$$QEAV12@@Z @ 0x1800714D0 (-_Assign_rv@-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@std@@QEAAX$$QEAV12@@Z.c)
 */
