/*
 * XREFs of ?InstallAppByProductAndSku@Actions@CreativeFramework@@YAXPEB_W00_N11100@Z @ 0x1800AA408
 * Callers:
        ...
        const wchar_t *a9)
{
  ...
  if ( !a5 )
  {
    v13 = wil::com_ptr_t<Windows::Data::Xml::Dom::IXmlNode,wil::err_exception_policy>::com_ptr_t<Windows::Data::Xml::Dom::IXmlNode,wil::err_exception_policy>(
            &v27,
            &v23);
    CreativeFramework::Actions::GetEntitlementForRecord(v13, (__int64 *)&v25, (__int64 *)&v24, &v28, &a9, a6);
  }
  v14 = v23;
