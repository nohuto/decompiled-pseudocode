/*
 * XREFs of ?SetDesktopSpotlightCreative@DesktopSpotlightHelpers@CreativeFramework@@YAJPEB_W00@Z @ 0x1800BCC88
 * Callers:
 *     ?Stage@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ @ 0x1800BCF20 (-Stage@SetDesktopWallpaperService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
        ...
        const wchar_t *a4)
{
  ...
  else
  {
    ...
    {
      phkResult = 0LL;
      v11 = RegCreateKeyExW(hKey, SubKey, 0, 0LL, 0, 0xF003Fu, 0LL, &phkResult, 0LL);
      if ( v11 )
      {
        v12 = 84LL;
      }
