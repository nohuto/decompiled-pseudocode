/*
 * XREFs of ??$ActivateInstance@UIAppInstallManager@InstallControl@Preview@Store@ApplicationModel@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIAppInstallManager@InstallControl@Preview@Store@ApplicationModel@1@@Z @ 0x180079EB8
 * Callers:
...
__int64 __fastcall Windows::Foundation::ActivateInstance<Windows::ApplicationModel::Store::Preview::InstallControl::IAppInstallManager>(
        __int64 a1,
        _QWORD *a2)
{
  int v3; // ebx
  ...
  *a2 = 0LL;
  ...
  if ( v3 >= 0 )
  {
    v4 = *(_QWORD *)&GUID_9353e170_8441_4b45_bd72_7c2fa925beee.Data1
    ...
    if ( *(_QWORD *)&GUID_9353e170_8441_4b45_bd72_7c2fa925beee.Data1 == *(_QWORD *)&GUID_af86e2e0_b12d_4c6a_9c5a_d7aa65101e90.Data1 )
      v4 = *(_QWORD *)GUID_9353e170_8441_4b45_bd72_7c2fa925beee.Data4
