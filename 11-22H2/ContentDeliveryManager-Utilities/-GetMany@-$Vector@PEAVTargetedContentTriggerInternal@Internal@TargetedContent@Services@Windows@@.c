...
LABEL_27:
      ...
      v15 = XWinRT::detail::GitStorageType<Windows::Services::TargetedContent::Internal::ITargetedContentTriggerInternal>::ReferencedGitCookie::Localize(
              v35[0].m128i_i64[0],
              v20);
LABEL_26:
      if ( v15 < 0 )
...
LABEL_46:
    if ( v9 )
    {
      ...
      do
      {
        XWinRT::InterfaceLifetimeTraits::Destroy<Windows::Services::TargetedContent::Internal::ITargetedContentTriggerInternal>(v28++);
        --v27;
      }
      while ( v27 );
    }
