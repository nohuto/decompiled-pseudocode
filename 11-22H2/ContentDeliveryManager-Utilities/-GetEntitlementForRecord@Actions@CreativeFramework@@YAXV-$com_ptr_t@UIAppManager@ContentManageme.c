/*
 * XREFs of ?GetEntitlementForRecord@Actions@CreativeFramework@@YAXV?$com_ptr_t@UIAppManager@ContentManagement@@Uerr_exception_policy@wil@@@wil@@AEBQEB_W111_N@Z @ 0x1800AA0B0
 * Callers:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_InstallAttribution@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180083B04 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_InstallAttribution@@@details@wil@@QEAAX_N.c)
        ...
        char a6)
{
  ...
  if ( a6 )
    goto LABEL_7;
  if ( dword_1801965E8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1801965E8);
    if ( dword_1801965E8 == -1 )
    {
      byte_1801965EC = CreativeFramework::Actions::IsMsaConnected(v9);
      Init_thread_footer(&dword_1801965E8);
    }
  }
  if ( !byte_1801965EC )
LABEL_7:
  ...
  v47 = 0LL;
  Microsoft::WRL::Wrappers::HStringReference::CreateReference(&hstringHeader, word_1801070C4, 1u, 0);
