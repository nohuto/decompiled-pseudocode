/*
 * XREFs of ??$_VectorGetMany@U?$IVector_impl@U?$AggregateType@PEAVOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@Windows@@PEAUIOnlineIdServiceTicketRequest@2345@@Internal@Foundation@Windows@@$00@Collections@Foundation@Windows@@PEAUIOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@4@@Detail@Collections@Foundation@Windows@@YAJPEAU?$IVector_impl@U?$AggregateType@PEAVOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@Windows@@PEAUIOnlineIdServiceTicketRequest@2345@@Internal@Foundation@Windows@@$00@123@IIPEAPEAUIOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@3@PEAI@Z @ 0x180029AAC
 * Callers:
 *     ?GetMany@?$IVector_impl@U?$AggregateType@PEAVOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@Windows@@PEAUIOnlineIdServiceTicketRequest@2345@@Internal@Foundation@Windows@@$00@Collections@Foundation@Windows@@UEAAJIIPEAPEAUIOnlineIdServiceTicketRequest@OnlineId@Authentication@Security@4@PEAI@Z @ 0x180035A10 (-GetMany@-$IVector_impl@U-$AggregateType@PEAVOnlineIdServiceTicketRequest@OnlineId@Authenticatio.c)
 * Callees:
