/*
 * XREFs of ??$YourPhoneTaskbarIconCreated@AEAW4TaskbarPinReason@Pinning@Mobility@@@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@SAXAEAW4TaskbarPinReason@Pinning@Mobility@@@Z @ 0x180029594
 * Callers:
        ...
        int *a1)
{
  ...
  v2 = wil::details::static_lazy<MobilityExperience::Telemetry::MobilityExperienceLogging>::get(
         a1,
         _lambda_e5247b73c30e393fca6255a7d4a63886_::_lambda_invoker_cdecl_);
  v3 = *(_DWORD **)(v2 + 8);
  if ( *v3 > 5u )
  {
    LOBYTE(v2) = tlgKeywordOn((__int64)v3, 0x800000000000LL);
    if ( (_BYTE)v2 )
    {
      v7 = *a1;
