/*
 * XREFs of ??$ActivateInstance@UIBackgroundTaskBuilder@Background@ApplicationModel@Windows@@@Foundation@Windows@@YAJPEAUHSTRING__@@PEAPEAUIBackgroundTaskBuilder@Background@ApplicationModel@1@@Z @ 0x1800D2054
 * Callers:
