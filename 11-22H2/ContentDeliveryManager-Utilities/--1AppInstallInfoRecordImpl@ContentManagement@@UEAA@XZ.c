/*
 * XREFs of ??1AppInstallInfoRecordImpl@ContentManagement@@UEAA@XZ @ 0x18004845C
 * Callers:
 *     ??_EAppInstallInfoRecordImpl@ContentManagement@@UEAAPEAXI@Z @ 0x180048870 (--_EAppInstallInfoRecordImpl@ContentManagement@@UEAAPEAXI@Z.c)
 * Callees:
 *     <none>
 */
