/*
 * XREFs of ?GetFriendlySubscriptionNameFromPlacementId@SubscribedContentUtils@CreativeFramework@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W@Z @ 0x1800ADA88
 * Callers:
 ...
 *     ?GetSubscriptionIdByName@TargetedContent@CreativeFramework@@YAPEB_WPEB_W@Z @ 0x1800AE334 (-GetSubscriptionIdByName@TargetedContent@CreativeFramework@@YAPEB_WPEB_W@Z.c)
...
__int64 __fastcall CreativeFramework::SubscribedContentUtils::GetFriendlySubscriptionNameFromPlacementId(__int64 a1)
{
  ...
  {
    v4 = std::wstring::wstring((__int64)v11, (void **)lpStringSource);
    v5 = 1;
  }
