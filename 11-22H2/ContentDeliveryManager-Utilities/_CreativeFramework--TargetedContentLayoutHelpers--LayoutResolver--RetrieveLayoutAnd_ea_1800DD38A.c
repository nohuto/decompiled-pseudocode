/*
 * XREFs of _CreativeFramework::TargetedContentLayoutHelpers::LayoutResolver::RetrieveLayoutAndItems_::_1_::catch$24 @ 0x1800DD38A
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  StringRawBuffer = (const char *)WindowsGetStringRawBuffer(*(HSTRING *)(*(_QWORD *)(a2 + 96) + 8LL), 0LL);
