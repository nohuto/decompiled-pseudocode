/*
 * XREFs of ??0?$ctype@G@std@@QEAA@AEBV_Locinfo@1@_K@Z @ 0x180051A20
 * Callers:
 ...
 * Callees:
 *     ?_Init@?$ctype@_W@std@@IEAAXAEBV_Locinfo@2@@Z @ 0x180061BEC (-_Init@-$ctype@_W@std@@IEAAXAEBV_Locinfo@2@@Z.c)
 */
