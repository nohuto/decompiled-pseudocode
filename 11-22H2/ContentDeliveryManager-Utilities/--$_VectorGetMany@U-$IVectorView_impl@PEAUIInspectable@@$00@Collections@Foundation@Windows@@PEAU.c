/*
 * XREFs of ??$_VectorGetMany@U?$IVectorView_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@PEAUIInspectable@@@Detail@Collections@Foundation@Windows@@YAJPEAU?$IVectorView_impl@PEAUIInspectable@@$00@123@IIPEAPEAUIInspectable@@PEAI@Z @ 0x1800C61FC
 * Callers:
 *     ?GetMany@?$IVectorView_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@UEAAJIIPEAPEAUIInspectable@@PEAI@Z @ 0x1800C8AB0 (-GetMany@-$IVectorView_impl@PEAUIInspectable@@$00@Collections@Foundation@Windows@@UEAAJIIPEAPEAU.c)
 * Callees:
