/*
 * XREFs of _CreativeFramework::Actions::MakeNotificationManagerService_::_1_::dtor$3 @ 0x1800DBDF3
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CreativeFramework::Actions::MakeNotificationManagerService_::_1_::dtor_3(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 32) & 2) != 0 )
  {
    *(_DWORD *)(a2 + 32) &= ~2u;
