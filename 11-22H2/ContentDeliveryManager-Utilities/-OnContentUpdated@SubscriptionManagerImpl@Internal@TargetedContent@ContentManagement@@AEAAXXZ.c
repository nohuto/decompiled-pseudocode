/*
 * XREFs of ?OnContentUpdated@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@AEAAXXZ @ 0x1800696EC
 * Callers:
 *     _lambda_83dc6366a20d9229952004eea2bdcbca_::operator() @ 0x180067880 (_lambda_83dc6366a20d9229952004eea2bdcbca_--operator().c)
 * Callees:
