/*
 * XREFs of ??$AsWeak@UISubscriptionManager@Internal@TargetedContent@ContentManagement@@@WRL@Microsoft@@YAJPEAUISubscriptionManager@Internal@TargetedContent@ContentManagement@@PEAVWeakRef@01@@Z @ 0x180065C60
 * Callers:
...
__int64 __fastcall Microsoft::WRL::AsWeak<ContentManagement::TargetedContent::Internal::ISubscriptionManager>(
