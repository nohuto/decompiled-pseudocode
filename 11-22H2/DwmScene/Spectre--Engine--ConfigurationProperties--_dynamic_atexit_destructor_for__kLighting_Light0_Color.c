/*
 * XREFs of Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kLighting_Light0_ColorB__ @ 0x1800F47E0
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kLighting_Light0_ColorB__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::ConfigurationProperties::kLighting_Light0_ColorB);
