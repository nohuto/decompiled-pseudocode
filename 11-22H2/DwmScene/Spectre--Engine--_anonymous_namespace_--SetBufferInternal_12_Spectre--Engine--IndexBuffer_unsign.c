/*
 * XREFs of Spectre::Engine::_anonymous_namespace_::SetBufferInternal_12_Spectre::Engine::IndexBuffer_unsigned_short_ @ 0x18004771C
 * Callers:
...
__int64 __fastcall Spectre::Engine::_anonymous_namespace_::SetBufferInternal_12_Spectre::Engine::IndexBuffer_unsigned_short_(
        __int64 *a1,
        __int64 a2,
        unsigned int a3,
        int a4,
        ...
        __int64 *a6)
{
  ...
  FormatPitch = Spectre::Engine::GetFormatPitch(12LL);
