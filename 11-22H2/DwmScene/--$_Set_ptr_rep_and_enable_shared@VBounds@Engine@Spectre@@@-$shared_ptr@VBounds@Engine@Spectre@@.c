/*
 * XREFs of ??$_Set_ptr_rep_and_enable_shared@VBounds@Engine@Spectre@@@?$shared_ptr@VBounds@Engine@Spectre@@@std@@AEAAXQEAVBounds@Engine@Spectre@@QEAV_Ref_count_base@1@@Z @ 0x180013EDC
 * Callers:
...
void __fastcall std::shared_ptr<Spectre::Engine::Bounds>::_Set_ptr_rep_and_enable_shared<Spectre::Engine::Bounds>(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
