/*
 * XREFs of ??$_Set_ptr_rep_and_enable_shared@VColorTransform@Engine@Spectre@@@?$shared_ptr@VColorTransform@Engine@Spectre@@@std@@AEAAXQEAVColorTransform@Engine@Spectre@@QEAV_Ref_count_base@1@@Z @ 0x180062D28
 * Callers:
...
void __fastcall std::shared_ptr<Spectre::Engine::ColorTransform>::_Set_ptr_rep_and_enable_shared<Spectre::Engine::ColorTransform>(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
