/*
 * XREFs of Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kCamera_FieldOfView__ @ 0x1800F3490
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kCamera_FieldOfView__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::ConfigurationProperties::kCamera_FieldOfView);
