/*
 * XREFs of ??$dynamic_pointer_cast@VDeviceDepthBuffer@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceDepthBuffer@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x18006EF1C
 * Callers:
...
__int64 *__fastcall std::dynamic_pointer_cast<Spectre::Engine::DeviceDepthBuffer,Spectre::Engine::RendererResource>(
        __int64 *a1,
        _QWORD *a2)
{
  __int64 v4; // rax
