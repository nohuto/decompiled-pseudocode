/*
 * XREFs of ?Load@PixelShaderD3D11@D3D11@Engine@Spectre@@UEAA_NAEBVShaderProgram@34@@Z @ 0x1800D5540
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Spectre::Engine::D3D11::PixelShaderD3D11::Load(
        ...
        const struct Spectre::Engine::ShaderProgram *a2)
{
  ...
  if ( *((_BYTE *)this + 96) )
  {
    std::string::string(
      &v21,
      (__int64)"PixelShaderD3D11::Load() -- this function can only be called once per shader instance");
  ...
  if ( !Spectre::Engine::ShaderProgram::empty(a2) )
  {
    ...
    v6 = v18;
    v7 = *(__int64 (__fastcall **)(__int64, __int64, unsigned __int64, _QWORD, char *))(*(_QWORD *)v18 + 120LL);
