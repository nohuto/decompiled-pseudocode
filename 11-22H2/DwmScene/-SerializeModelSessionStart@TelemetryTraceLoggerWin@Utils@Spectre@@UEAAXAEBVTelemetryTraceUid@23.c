/*
 * XREFs of ?SerializeModelSessionStart@TelemetryTraceLoggerWin@Utils@Spectre@@UEAAXAEBVTelemetryTraceUid@23@PEBD@Z @ 0x180023DF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Utils::TelemetryTraceLoggerWin::SerializeModelSessionStart(
