/*
 * XREFs of ?SerializeModelSessionAbort@TelemetryTraceLoggerWin@Utils@Spectre@@UEAAXAEBVTelemetryTraceUid@23@PEBD@Z @ 0x180023B20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Utils::TelemetryTraceLoggerWin::SerializeModelSessionAbort(
