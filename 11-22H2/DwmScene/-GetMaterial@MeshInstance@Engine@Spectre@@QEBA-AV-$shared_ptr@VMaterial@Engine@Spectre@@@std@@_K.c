/*
 * XREFs of ?GetMaterial@MeshInstance@Engine@Spectre@@QEBA?AV?$shared_ptr@VMaterial@Engine@Spectre@@@std@@_K@Z @ 0x18004B988
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::MeshInstance::GetMaterial(__int64 a1, _QWORD *a2, unsigned __int64 a3)
{
  _QWORD *v4; // rcx
  unsigned int v5; // eax
  int v6; // r8d
  ...
  v7 = (_QWORD *)std::vector<Spectre::Engine::MeshInstance::MaterialInfo>::at(v4, a3);
