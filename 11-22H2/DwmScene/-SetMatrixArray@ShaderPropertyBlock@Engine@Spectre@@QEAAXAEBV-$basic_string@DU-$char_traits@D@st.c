/*
 * XREFs of ?SetMatrixArray@ShaderPropertyBlock@Engine@Spectre@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV?$vector@UMatrix@Math@Utils@Spectre@@V?$allocator@UMatrix@Math@Utils@Spectre@@@std@@@5@@Z @ 0x180085528
 * Callers:
...
__int64 __fastcall Spectre::Engine::ShaderPropertyBlock::SetMatrixArray(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  return Spectre::Engine::ShaderPropertyBlock::SetMatrixArray(a1, PropertyChecked, a3);
}
