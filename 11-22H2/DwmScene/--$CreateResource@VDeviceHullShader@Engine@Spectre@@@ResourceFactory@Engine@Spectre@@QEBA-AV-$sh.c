/*
 * XREFs of ??$CreateResource@VDeviceHullShader@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDeviceHullShader@Engine@Spectre@@@std@@XZ @ 0x180089E74
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VDeviceHullShader@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceHullShader@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x18008A624 (--$dynamic_pointer_cast@VDeviceHullShader@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$shar.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceHullShader>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C9BF8);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::DeviceHullShader,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
