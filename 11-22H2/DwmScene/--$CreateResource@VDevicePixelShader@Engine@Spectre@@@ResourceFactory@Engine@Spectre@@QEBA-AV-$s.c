/*
 * XREFs of ??$CreateResource@VDevicePixelShader@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDevicePixelShader@Engine@Spectre@@@std@@XZ @ 0x180089FB4
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VDevicePixelShader@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDevicePixelShader@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x18008A68C (--$dynamic_pointer_cast@VDevicePixelShader@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$sha.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DevicePixelShader>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C9C68);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::DevicePixelShader,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
