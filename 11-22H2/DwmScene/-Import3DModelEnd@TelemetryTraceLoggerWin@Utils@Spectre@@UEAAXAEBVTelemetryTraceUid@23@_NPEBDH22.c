/*
 * XREFs of ?Import3DModelEnd@TelemetryTraceLoggerWin@Utils@Spectre@@UEAAXAEBVTelemetryTraceUid@23@_NPEBDH22_K33_J44IIIMI2@Z @ 0x180022DC0
 * Callers:
 *     <none>
 * Callees:
 *     _tlgKeywordOn @ 0x180001528 (_tlgKeywordOn.c)
 *     ??$Write@U?$_tlgWrapSz@D@@U?$_tlgWrapperByVal@$03@@U?$_tlgWrapperByRef@$0BA@@@U3@U1@U1@U2@U1@U1@U?$_tlgWrapperByVal@$07@@U4@U4@U4@U4@U4@U2@U2@U2@U2@U2@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@D@@AEBU?$_tlgWrapperByVal@$03@@AEBU?$_tlgWrapperByRef@$0BA@@@533433AEBU?$_tlgWrapperByVal@$07@@66666444443@Z @ 0x180001DDC (--$Write@U-$_tlgWrapSz@D@@U-$_tlgWrapperByVal@$03@@U-$_tlgWrapperByRef@$0BA@@@U3@U1@U1@U2@U1@U1@.c)
...
void __fastcall Spectre::Utils::TelemetryTraceLoggerWin::Import3DModelEnd(
        ...
        const char *a19)
{
  ...
  unsigned int v32; // [rsp+D8h] [rbp-80h] BYREF
  float v33; // [rsp+DCh] [rbp-7Ch] BYREF
  unsigned int v34; // [rsp+E0h] [rbp-78h] BYREF
  unsigned int v35; // [rsp+E4h] [rbp-74h] BYREF
  unsigned int v36; // [rsp+E8h] [rbp-70h] BYREF
  int v37; // [rsp+ECh] [rbp-6Ch] BYREF
  int v38; // [rsp+F0h] [rbp-68h] BYREF
  const wchar_t *v39; // [rsp+F8h] [rbp-60h] BYREF
  ...
  if ( (unsigned int)dword_1801C81C0 > 5 && tlgKeywordOn((__int64)&dword_1801C81C0, 0x400000000000LL) )
  {
    ...
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapperByRef<16>,_tlgWrapperByRef<16>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapSz<char>>(
      v28,
      byte_1801AAF20,
      v29,
      v30,
