/*
 * XREFs of ?GetVolumeTexture@ColorTransform@Engine@Spectre@@QEBA?AV?$shared_ptr@VTexture@Engine@Spectre@@@std@@XZ @ 0x18008FF6C
 * Callers:
...
__int64 __fastcall Spectre::Engine::ColorTransform::GetVolumeTexture(__int64 a1, _QWORD *a2)
{
  __int64 v2; // r8
