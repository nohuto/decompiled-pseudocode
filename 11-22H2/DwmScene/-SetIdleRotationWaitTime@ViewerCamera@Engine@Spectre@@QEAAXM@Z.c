/*
 * XREFs of ?SetIdleRotationWaitTime@ViewerCamera@Engine@Spectre@@QEAAXM@Z @ 0x180093094
 * Callers:
...
void __fastcall Spectre::Engine::ViewerCamera::SetIdleRotationWaitTime(Spectre::Engine::ViewerCamera *this, float a2)
{
  *((float *)this + 464) = a2;
}
