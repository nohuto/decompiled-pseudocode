/*
 * XREFs of _Spectre::Utils::JsonConfigurationManager::GetKeys_::_1_::dtor$0 @ 0x1800F1E88
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Spectre::Utils::JsonConfigurationManager::GetKeys_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  __int64 result; // rax
