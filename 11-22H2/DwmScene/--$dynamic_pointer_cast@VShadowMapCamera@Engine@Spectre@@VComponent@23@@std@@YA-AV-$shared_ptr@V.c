/*
 * XREFs of ??$dynamic_pointer_cast@VShadowMapCamera@Engine@Spectre@@VComponent@23@@std@@YA?AV?$shared_ptr@VShadowMapCamera@Engine@Spectre@@@0@AEBV?$shared_ptr@VComponent@Engine@Spectre@@@0@@Z @ 0x1800630D8
 * Callers:
 ...
 *     ?CloneInternal@ShadowMapCamera@Engine@Spectre@@EEBAXV?$shared_ptr@VComponent@Engine@Spectre@@@std@@AEBI@Z @ 0x18008DEC0 (-CloneInternal@ShadowMapCamera@Engine@Spectre@@EEBAXV-$shared_ptr@VComponent@Engine@Spectre@@@st.c)
 * Callees:
 *     __RTDynamicCast_0 @ 0x1800E38E0 (__RTDynamicCast_0.c)
 */

__int64 *__fastcall std::dynamic_pointer_cast<Spectre::Engine::ShadowMapCamera,Spectre::Engine::Component>(
        __int64 *a1,
        _QWORD *a2)
{
  __int64 v4; // rax
