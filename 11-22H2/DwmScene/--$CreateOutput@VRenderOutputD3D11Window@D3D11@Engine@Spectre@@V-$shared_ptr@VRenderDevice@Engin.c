/*
 * XREFs of ??$CreateOutput@VRenderOutputD3D11Window@D3D11@Engine@Spectre@@V?$shared_ptr@VRenderDevice@Engine@Spectre@@@std@@AEAV?$shared_ptr@VPerformanceLogger@Utils@Spectre@@@6@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VRenderOutputD3D11Window@D3D11@Engine@Spectre@@@std@@UOutputDescription@12@$$QEAV?$shared_ptr@VRenderDevice@Engine@Spectre@@@4@AEAV?$shared_ptr@VPerformanceLogger@Utils@Spectre@@@4@@Z @ 0x1800C3538
 * Callers:
...
std::_Ref_count_base **__fastcall Spectre::Engine::RenderDevice::CreateOutput<Spectre::Engine::D3D11::RenderOutputD3D11Window,std::shared_ptr<Spectre::Engine::RenderDevice>,std::shared_ptr<Spectre::Utils::PerformanceLogger> &>(
        ...
        __int64 a5)
{
  ...
  std::make_shared<Spectre::Engine::D3D11::RenderOutputD3D11Window,Spectre::Engine::OutputDescription &,std::shared_ptr<Spectre::Engine::RenderDevice>,std::shared_ptr<Spectre::Utils::PerformanceLogger> &>(
    a2,
    a3,
    a4,
    a5,
