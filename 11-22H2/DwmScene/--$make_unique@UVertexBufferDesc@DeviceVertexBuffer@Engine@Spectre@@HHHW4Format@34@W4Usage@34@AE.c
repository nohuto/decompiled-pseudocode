...
__int64 *__fastcall std::make_unique<Spectre::Engine::DeviceVertexBuffer::VertexBufferDesc,int,int,int,enum Spectre::Engine::Format,enum Spectre::Engine::Usage,enum Spectre::Engine::DeviceVertexBuffer::Attribute &,0>(
        __int64 *a1,
        unsigned int *a2,
        unsigned int *a3,
        unsigned int *a4,
