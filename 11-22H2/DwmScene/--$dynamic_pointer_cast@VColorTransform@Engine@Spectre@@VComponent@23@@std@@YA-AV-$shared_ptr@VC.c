/*
 * XREFs of ??$dynamic_pointer_cast@VColorTransform@Engine@Spectre@@VComponent@23@@std@@YA?AV?$shared_ptr@VColorTransform@Engine@Spectre@@@0@AEBV?$shared_ptr@VComponent@Engine@Spectre@@@0@@Z @ 0x180063070
 * Callers:
...
__int64 *__fastcall std::dynamic_pointer_cast<Spectre::Engine::ColorTransform,Spectre::Engine::Component>(
        __int64 *a1,
        _QWORD *a2)
{
  __int64 v4; // rax
