/*
 * XREFs of ?GetFramePresentationMaximumLatency@RenderDeviceGeneric@Engine@Spectre@@UEBAIXZ @ 0x180053350
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn Spectre::Engine::RenderDeviceGeneric::GetFramePresentationMaximumLatency(
