/*
 * XREFs of ?UpdateBuffers@ImageProcessingEffectPlanarReflection@Engine@Spectre@@UEAAXPEAVRenderDevice@23@IIW4Format@23@I@Z @ 0x180093EC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::ImageProcessingEffectPlanarReflection::UpdateBuffers(
        __int64 a1,
        ...
        int a6)
{
  ...
  std::shared_ptr<Spectre::Engine::DeviceArrayBuffer>::operator=((_QWORD *)(a1 + 200), &v13);
  if ( v14 )
    std::_Ref_count_base::_Decref(v14);
  v11 = *(_QWORD *)(a1 + 200);
  v12 = (void **)std::string::string(&v13, (__int64)"ImageProcessingEffectPlanarReflection");
  Spectre::Engine::RendererResource::SetName(v11, v12);
  Spectre::Engine::FrameBuffer::Create(*(Spectre::Engine::FrameBuffer **)(a1 + 200), a3, a4, a5, a6, a2);
}
