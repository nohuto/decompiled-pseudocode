/*
 * XREFs of ?Load@DomainShaderD3D11@D3D11@Engine@Spectre@@UEAA_NAEBVShaderProgram@34@@Z @ 0x1800D76A0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Spectre::Engine::D3D11::DomainShaderD3D11::Load(
        ...
        const struct Spectre::Engine::ShaderProgram *a2)
{
  ...
  if ( *((_BYTE *)this + 96) )
  {
    std::string::string(
      &v20,
      (__int64)"DomainShaderD3D11::Load() -- this function can only be called once per shader instance");
  ...
  if ( !Spectre::Engine::ShaderProgram::empty(a2) )
  {
    ...
    v6 = v17;
    v7 = *(__int64 (__fastcall **)(__int64, __int64, unsigned __int64, _QWORD, char *))(*(_QWORD *)v17 + 136LL);
    ...
    if ( v10 < 0 )
    {
      Trace::LevelSettingsWrapper::Output(&gTraceLevelsDomainShaderD3D11, 5, "ERROR: Failed to create Domain shader.\n");
    }
    else
    {
      *((_BYTE *)this + 96) = 1;
