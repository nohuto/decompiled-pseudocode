/*
 * XREFs of ?SetTextureSampler@ShaderPropertyBlock@Engine@Spectre@@QEAAXW4ShaderProperty@23@V?$shared_ptr@VSampler@Engine@Spectre@@@std@@@Z @ 0x18008585C
 * Callers:
...
void __fastcall Spectre::Engine::ShaderPropertyBlock::SetTextureSampler(__int64 a1, unsigned __int16 a2, __int64 *a3)
{
  ...
  if ( PropertyInfo[12] == 2 )
  {
    std::string::string(
      v17,
      (__int64)"ShaderPropertyBlock::SetTextureSampler() -- Cannot set the value of an imported property");
  ...
  std::shared_ptr<Spectre::Engine::DeviceArrayBuffer>::operator=(
    (_QWORD *)(*(_QWORD *)(v11 + 56) + 8 * (5LL * (unsigned int)PropertyInfo[10] + 2)),
    a3);
