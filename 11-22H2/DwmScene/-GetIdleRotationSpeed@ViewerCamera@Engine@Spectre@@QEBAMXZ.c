/*
 * XREFs of ?GetIdleRotationSpeed@ViewerCamera@Engine@Spectre@@QEBAMXZ @ 0x180092D30
 * Callers:
...
float __fastcall Spectre::Engine::ViewerCamera::GetIdleRotationSpeed(Spectre::Engine::ViewerCamera *this)
{
  return *((float *)this + 463);
}
