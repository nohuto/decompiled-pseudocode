/*
 * XREFs of _Spectre::Engine::Mesh::ComputeTangents_::_1_::dtor$0 @ 0x1800E6F4B
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::Mesh::ComputeTangents_::_1_::dtor_0(__int64 a1, __int64 a2)
{
