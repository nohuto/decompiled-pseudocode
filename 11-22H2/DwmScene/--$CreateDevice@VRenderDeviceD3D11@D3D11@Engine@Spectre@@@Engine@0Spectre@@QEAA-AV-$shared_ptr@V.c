/*
 * XREFs of ??$CreateDevice@VRenderDeviceD3D11@D3D11@Engine@Spectre@@@Engine@0Spectre@@QEAA?AV?$shared_ptr@VRenderDevice@Engine@Spectre@@@std@@UDeviceDescription@01@UOutputDescription@01@@Z @ 0x180015AE0
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::Engine::CreateDevice<Spectre::Engine::D3D11::RenderDeviceD3D11>(
        Spectre::Engine::Engine *this,
        _QWORD *a2,
        Spectre::Engine::DeviceDescription *a3,
        __int64 a4)
{
  void *v8; // rax
  Spectre::Engine::D3D11::RenderDeviceD3D11 *v9; // r10
  __int64 v10; // r14
  _QWORD *v11; // rax
  ...
  if ( v8 )
  {
    std::shared_ptr<Spectre::Engine::ShaderPropertyLayout>::shared_ptr<Spectre::Engine::ShaderPropertyLayout>(
      v14,
      (_QWORD *)this + 58);
    v8 = (void *)Spectre::Engine::D3D11::RenderDeviceD3D11::RenderDeviceD3D11(v9);
  }
  std::shared_ptr<Spectre::Engine::D3D11::RenderDeviceD3D11>::shared_ptr<Spectre::Engine::D3D11::RenderDeviceD3D11>(
    v13,
    (__int64)v8);
  v10 = v13[0];
  Spectre::Engine::Lockable::GetExclusiveLock(v13[0] + 24LL, v16);
  (*(void (__fastcall **)(__int64, Spectre::Engine::DeviceDescription *, __int64))(*(_QWORD *)v10 + 240LL))(v10, a3, a4);
