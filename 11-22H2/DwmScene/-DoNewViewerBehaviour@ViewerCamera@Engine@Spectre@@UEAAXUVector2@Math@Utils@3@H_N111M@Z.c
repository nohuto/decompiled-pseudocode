/*
 * XREFs of ?DoNewViewerBehaviour@ViewerCamera@Engine@Spectre@@UEAAXUVector2@Math@Utils@3@H_N111M@Z @ 0x1800927E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::ViewerCamera::DoNewViewerBehaviour(
        __int64 a1,
        __int64 a2,
        int a3,
        char a4,
        ...
        float a8)
{
  ...
  *(float *)(a1 + 1872) = v11;
  if ( v12 )
  {
    ...
    *(float *)(a1 + 1900) = v13;
    if ( COERCE_FLOAT(LODWORD(v13) & _xmm) < 1.0e-12 )
      *(_DWORD *)(a1 + 1900) = 0;
  }
  v14 = *(float *)(a1 + 1892);
  v15 = *(float *)(a1 + 1844);
...
LABEL_17:
  ...
  if ( v17 >= v16 )
  {
    ...
    *(float *)(a1 + 1876) = (float)(v18 * a8) + *(float *)(a1 + 1876);
    if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v18 * 0.80000001) & _xmm) < 1.0e-12 )
      *(_DWORD *)(a1 + 1884) = 0;
  }
  if ( a6 )
    *(float *)(a1 + 1888) = (float)(COERCE_FLOAT(COERCE_UNSIGNED_INT((float)a3) ^ _xmm) * 0.0099999998)
                          + *(float *)(a1 + 1888);
  v19 = *(float *)(a1 + 1888);
  if ( v19 != 0.0 )
  {
    ...
    *(float *)(a1 + 1880) = (float)(v20 * a8) + *(float *)(a1 + 1880);
    if ( COERCE_FLOAT(LODWORD(v21) & _xmm) < 1.0e-12 )
      *(_DWORD *)(a1 + 1888) = 0;
  }
}
