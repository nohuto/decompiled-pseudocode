...
_QWORD *__fastcall std::list<std::shared_ptr<Spectre::Engine::ShaderPipeline>>::_Emplace<std::shared_ptr<Spectre::Engine::ShaderPipeline> const &>(
        __int64 a1,
        __int64 a2,
        _QWORD *a3)
{
  ...
  *(_QWORD *)(a2 + 8) = v6;
  *v7 = v6;
  std::_List_node_emplace_op2<std::allocator<std::_List_node<std::shared_ptr<Spectre::Engine::ShaderPipeline>,void *>>>::~_List_node_emplace_op2<std::allocator<std::_List_node<std::shared_ptr<Spectre::Engine::ShaderPipeline>,void *>>>(&v9);
  return v6;
}
