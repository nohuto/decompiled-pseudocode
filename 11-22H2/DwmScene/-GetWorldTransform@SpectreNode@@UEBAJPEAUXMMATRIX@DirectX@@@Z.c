/*
 * XREFs of ?GetWorldTransform@SpectreNode@@UEBAJPEAUXMMATRIX@DirectX@@@Z @ 0x180014E10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SpectreNode::GetWorldTransform(SpectreNode *this, struct DirectX::XMMATRIX *a2)
{
  __int64 Scene; // rax
  __int128 v5; // xmm1
  __int128 v6; // xmm2
  ...
  Scene = Spectre::Engine::SceneNode::GetScene(*((_QWORD *)this + 4), &v9);
  Spectre::Engine::Lockable::GetExclusiveLockIfNecessary((Spectre::Engine::Lockable *)(*(_QWORD *)Scene + 16LL));
  if ( v10 )
    std::_Ref_count_base::_Decref(v10);
  Spectre::Engine::SceneNode::GetWorldTransformMatrix(*((_QWORD *)this + 4), v12);
  v5 = v12[1];
  v6 = v12[2];
  v7 = v12[3];
  *(_OWORD *)a2 = v12[0];
