/*
 * XREFs of ?GetCpuProfiler@Engine@1Spectre@@QEBA?AV?$shared_ptr@VCpuProfiler@Engine@Spectre@@@std@@XZ @ 0x18003405C
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::Engine::GetCpuProfiler(__int64 a1, _QWORD *a2)
{
  __int64 v2; // rax
