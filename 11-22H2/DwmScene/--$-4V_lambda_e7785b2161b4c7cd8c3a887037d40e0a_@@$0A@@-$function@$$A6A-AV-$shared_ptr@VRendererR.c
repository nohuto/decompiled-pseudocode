/*
 * XREFs of ??$?4V_lambda_e7785b2161b4c7cd8c3a887037d40e0a_@@$0A@@?$function@$$A6A?AV?$shared_ptr@VRendererResource@Engine@Spectre@@@std@@XZ@std@@QEAAAEAV01@$$QEAV_lambda_e7785b2161b4c7cd8c3a887037d40e0a_@@@Z @ 0x1800C2CFC
 * Callers:
 ...
 *     ??$_Test_callable@V_lambda_e7785b2161b4c7cd8c3a887037d40e0a_@@@std@@YA_NAEBV_lambda_e7785b2161b4c7cd8c3a887037d40e0a_@@@Z @ 0x1800C39DC (--$_Test_callable@V_lambda_e7785b2161b4c7cd8c3a887037d40e0a_@@@std@@YA_NAEBV_lambda_e7785b2161b4.c)
 */

__int64 __fastcall std::function<std::shared_ptr<Spectre::Engine::RendererResource> (void)>::operator=<_lambda_e7785b2161b4c7cd8c3a887037d40e0a_,0>(
        __int64 a1)
{
  char v2; // al
  __int64 v3; // rdx
  ...
  v8 = 0LL;
  v2 = std::_Test_callable<_lambda_e7785b2161b4c7cd8c3a887037d40e0a_>();
  if ( v2 )
  {
    v7[0] = &std::_Func_impl_no_alloc<_lambda_e7785b2161b4c7cd8c3a887037d40e0a_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
    v8 = v7;
  }
