/*
 * XREFs of ??$_Construct_n@PEBV?$shared_ptr@VLightProbe@Engine@Spectre@@@std@@PEBV12@@?$vector@V?$shared_ptr@VLightProbe@Engine@Spectre@@@std@@V?$allocator@V?$shared_ptr@VLightProbe@Engine@Spectre@@@std@@@2@@std@@AEAAX_K$$QEAPEBV?$shared_ptr@VLightProbe@Engine@Spectre@@@1@1@Z @ 0x1800A402C
 * Callers:
...
void __fastcall std::vector<std::shared_ptr<Spectre::Engine::LightProbe>>::_Construct_n<std::shared_ptr<Spectre::Engine::LightProbe> const *,std::shared_ptr<Spectre::Engine::LightProbe> const *>(
        _QWORD *a1,
        unsigned __int64 a2,
        _QWORD **a3,
        _QWORD *a4)
