/*
 * XREFs of ??$_Emplace_reallocate@V?$shared_ptr@VCamera@Engine@Spectre@@@std@@@?$vector@V?$shared_ptr@VCamera@Engine@Spectre@@@std@@V?$allocator@V?$shared_ptr@VCamera@Engine@Spectre@@@std@@@2@@std@@QEAAPEAV?$shared_ptr@VCamera@Engine@Spectre@@@1@QEAV21@$$QEAV21@@Z @ 0x18002E72C
 * Callers:
...
char *__fastcall std::vector<std::shared_ptr<Spectre::Engine::Camera>>::_Emplace_reallocate<std::shared_ptr<Spectre::Engine::Camera>>(
        __int64 *a1,
        __int64 a2,
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  std::_Uninitialized_move<std::shared_ptr<Spectre::Engine::Camera> *,std::allocator<std::shared_ptr<Spectre::Engine::Camera>>>(
    ...
    v14,
    v12);
  std::vector<std::shared_ptr<Spectre::Engine::Camera>>::_Change_array(a1, v11, v8, v9);
