/*
 * XREFs of ?GetAntialiasingQualityActive@RenderDeviceGeneric@Engine@Spectre@@UEBA?AW4AntialiasingQuality@23@XZ @ 0x180053240
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::RenderDeviceGeneric::GetAntialiasingQualityActive()
{
  unsigned int v0; // eax
  int v1; // r8d
