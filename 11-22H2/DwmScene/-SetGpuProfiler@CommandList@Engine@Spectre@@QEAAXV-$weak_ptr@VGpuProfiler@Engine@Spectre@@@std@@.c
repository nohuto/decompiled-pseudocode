/*
 * XREFs of ?SetGpuProfiler@CommandList@Engine@Spectre@@QEAAXV?$weak_ptr@VGpuProfiler@Engine@Spectre@@@std@@@Z @ 0x1800396A0
 * Callers:
...
void __fastcall Spectre::Engine::CommandList::SetGpuProfiler(__int64 a1, __int64 *a2)
{
  __int64 v2; // rax
  __int64 v4; // r8
