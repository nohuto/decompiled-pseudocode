/*
 * XREFs of Spectre::Utils::_dynamic_atexit_destructor_for__kConfigurationDomain_Standard__ @ 0x1800F9660
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Utils::_dynamic_atexit_destructor_for__kConfigurationDomain_Standard__()
{
  std::wstring::_Tidy_deallocate((__int64)Spectre::Utils::kConfigurationDomain_Standard);
