/*
 * XREFs of Spectre::Engine::_anonymous_namespace_::SetBufferInternal_6_Spectre::Engine::VertexBuffer_Spectre::Utils::Math::Vector4_enum_Spectre::Engine::DeviceVertexBuffer::Attribute_&_ @ 0x18004752C
 * Callers:
...
__int64 __fastcall Spectre::Engine::_anonymous_namespace_::SetBufferInternal_6_Spectre::Engine::VertexBuffer_Spectre::Utils::Math::Vector4_enum_Spectre::Engine::DeviceVertexBuffer::Attribute___(
        __int64 *a1,
        __int64 a2,
        unsigned int a3,
        int a4,
        ...
        __int64 a7)
{
  ...
  FormatPitch = Spectre::Engine::GetFormatPitch(6LL);
