/*
 * XREFs of ??$dynamic_pointer_cast@VDomainShader@Engine@Spectre@@VShader@23@@std@@YA?AV?$shared_ptr@VDomainShader@Engine@Spectre@@@0@AEBV?$shared_ptr@VShader@Engine@Spectre@@@0@@Z @ 0x18008638C
 * Callers:
...
__int64 *__fastcall std::dynamic_pointer_cast<Spectre::Engine::DomainShader,Spectre::Engine::Shader>(
        __int64 *a1,
        _QWORD *a2)
{
  __int64 v4; // rax
