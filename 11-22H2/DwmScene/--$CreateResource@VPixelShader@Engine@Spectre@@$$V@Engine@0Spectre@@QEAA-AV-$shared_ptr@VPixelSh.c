/*
 * XREFs of ??$CreateResource@VPixelShader@Engine@Spectre@@$$V@Engine@0Spectre@@QEAA?AV?$shared_ptr@VPixelShader@Engine@Spectre@@@std@@W4ResourceDevicePolicy@01@@Z @ 0x18004D2E4
 * Callers:
 *     ??$CreateResource@VPixelShader@Engine@Spectre@@$$V@Engine@0Spectre@@QEAA?AV?$shared_ptr@VPixelShader@Engine@Spectre@@@std@@XZ @ 0x18004D398 (--$CreateResource@VPixelShader@Engine@Spectre@@$$V@Engine@0Spectre@@QEAA-AV-$shared_ea_18004D398.c)
 * Callees:
...
__int64 __fastcall Spectre::Engine::Engine::CreateResource<Spectre::Engine::PixelShader,>(__int64 *a1, __int64 a2)
{
  volatile signed __int32 *v4; // rdx
  std::_Ref_count_base *v6[2]; // [rsp+28h] [rbp-30h] BYREF
  _BYTE v7[32]; // [rsp+38h] [rbp-20h] BYREF

  std::make_shared<Spectre::Engine::PixelShader,>(a2);
