/*
 * XREFs of ?RtlDisownModuleHeapAllocation@details@wil@@YAJPEAX0@Z @ 0x18000F050
 * Callers:
 *     <none>
 * Callees:
 *     ?wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ @ 0x18000FEFC (-wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ.c)
