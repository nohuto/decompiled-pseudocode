/*
 * XREFs of ??$SetDebugName@UIDXGIAdapter1@@@CDXPixDebug@@SAXPEAUIDXGIAdapter1@@PEB_W@Z @ 0x1800DAA38
 * Callers:
...
void __fastcall CDXPixDebug::SetDebugName<IDXGIAdapter1>(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    v2 = *(void (__fastcall **)(__int64, const GUID *, _QWORD, char *))(*(_QWORD *)a1 + 24LL);
