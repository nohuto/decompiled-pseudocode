/*
 * XREFs of ??$MakeAndInitialize@VSpectreNode@@V1@AEAV?$shared_ptr@VSceneNode@Engine@Spectre@@@std@@@Details@WRL@Microsoft@@YAJPEAPEAVSpectreNode@@AEAV?$shared_ptr@VSceneNode@Engine@Spectre@@@std@@@Z @ 0x1800149F4
 * Callers:
        ...
        __int64 a2)
{
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    v10 = 0LL;
    Microsoft::WRL::ComPtr<SpectreNode>::Attach(&v10, v6);
    v11 = 0LL;
    v7 = a2;
    v8 = v10;
