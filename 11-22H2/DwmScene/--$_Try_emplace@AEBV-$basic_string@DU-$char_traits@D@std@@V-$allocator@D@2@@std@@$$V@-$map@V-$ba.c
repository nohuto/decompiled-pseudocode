...
__int64 __fastcall std::map<std::string,std::shared_ptr<Spectre::Engine::ShaderFamily>>::_Try_emplace<std::string const &,>(
        __int64 *a1,
        __int64 a2,
        _QWORD *a3)
{
  ...
  else
  {
    ...
    v8 = *a1;
    *(_QWORD *)&v11 = a1;
    v9 = (__int64 *)operator new(0x50uLL);
    ...
    *((_WORD *)v9 + 12) = 0;
    *((_QWORD *)&v11 + 1) = 0LL;
    std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::string const,std::shared_ptr<Spectre::Engine::IShaderExtension>>,void *>>>::~_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::string const,std::shared_ptr<Spectre::Engine::IShaderExtension>>,void *>>>(&v11);
    v11 = v12;
