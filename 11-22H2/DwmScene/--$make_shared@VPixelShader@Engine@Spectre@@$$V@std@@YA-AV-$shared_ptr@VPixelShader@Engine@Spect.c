/*
 * XREFs of ??$make_shared@VPixelShader@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VPixelShader@Engine@Spectre@@@0@XZ @ 0x18004E190
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::PixelShader,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rdi
  __int64 v4; // rcx
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::PixelShader>::`vftable';
    Spectre::Engine::Shader::Shader(v2 + 4, 5LL);
