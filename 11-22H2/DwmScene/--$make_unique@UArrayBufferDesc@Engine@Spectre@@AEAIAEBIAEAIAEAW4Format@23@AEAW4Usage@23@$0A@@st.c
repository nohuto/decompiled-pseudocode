/*
 * XREFs of ??$make_unique@UArrayBufferDesc@Engine@Spectre@@AEAIAEBIAEAIAEAW4Format@23@AEAW4Usage@23@$0A@@std@@YA?AV?$unique_ptr@UArrayBufferDesc@Engine@Spectre@@U?$default_delete@UArrayBufferDesc@Engine@Spectre@@@std@@@0@AEAIAEBI0AEAW4Format@Engine@Spectre@@AEAW4Usage@34@@Z @ 0x18008B2CC
 * Callers:
...
__int64 *__fastcall std::make_unique<Spectre::Engine::ArrayBufferDesc,unsigned int &,unsigned int const &,unsigned int &,enum Spectre::Engine::Format &,enum Spectre::Engine::Usage &,0>(
        __int64 *a1,
        unsigned int *a2,
        unsigned int *a3,
        unsigned int *a4,
