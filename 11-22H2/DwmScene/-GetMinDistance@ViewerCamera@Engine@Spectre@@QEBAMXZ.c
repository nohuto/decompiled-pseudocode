/*
 * XREFs of ?GetMinDistance@ViewerCamera@Engine@Spectre@@QEBAMXZ @ 0x180092D70
 * Callers:
...
float __fastcall Spectre::Engine::ViewerCamera::GetMinDistance(Spectre::Engine::ViewerCamera *this)
{
