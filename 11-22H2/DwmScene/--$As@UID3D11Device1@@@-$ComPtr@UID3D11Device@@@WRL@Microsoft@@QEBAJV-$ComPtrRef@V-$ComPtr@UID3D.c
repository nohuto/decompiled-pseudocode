/*
 * XREFs of ??$As@UID3D11Device1@@@?$ComPtr@UID3D11Device@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UID3D11Device1@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800C2F2C
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<ID3D11Device>::As<ID3D11Device1>(
        ...
        __int64 *a2)
{
  ...
  return v4(v3, &GUID_a04bfb29_08ef_43d6_a49c_a9bdbdcbe686, a2);
}
