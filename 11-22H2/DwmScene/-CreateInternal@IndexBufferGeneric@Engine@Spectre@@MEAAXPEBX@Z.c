/*
 * XREFs of ?CreateInternal@IndexBufferGeneric@Engine@Spectre@@MEAAXPEBX@Z @ 0x18008C580
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn Spectre::Engine::IndexBufferGeneric::CreateInternal(
        Spectre::Engine::IndexBufferGeneric *this,
        const void *a2)
{
  _QWORD *v2; // rax
  __int64 v3; // r8
