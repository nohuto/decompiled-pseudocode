/*
 * XREFs of ?GetFormatAndColorSpace@D3DUtils@D3D11@Engine@Spectre@@SA?AU?$pair@W4Format@Engine@Spectre@@W4ColorSpace@D3D11@23@@std@@W4DXGI_FORMAT@@@Z @ 0x1800CE9BC
 * Callers:
...
_DWORD *__fastcall Spectre::Engine::D3D11::D3DUtils::GetFormatAndColorSpace(_DWORD *a1, int a2)
{
  int v2; // edx
  int v3; // edx
  int v4; // edx
