/*
 * XREFs of ??$_Atomic_address_as@HU?$_Atomic_padded@J@std@@@std@@YAPECHAEAU?$_Atomic_padded@J@0@@Z @ 0x18002E088
 * Callers:
...
__int64 __fastcall std::_Atomic_address_as<int,std::_Atomic_padded<long>>(__int64 a1)
{
  return a1;
}
