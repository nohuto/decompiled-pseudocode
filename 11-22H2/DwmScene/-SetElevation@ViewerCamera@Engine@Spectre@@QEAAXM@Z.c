/*
 * XREFs of ?SetElevation@ViewerCamera@Engine@Spectre@@QEAAXM@Z @ 0x180092F90
 * Callers:
...
void __fastcall Spectre::Engine::ViewerCamera::SetElevation(Spectre::Engine::ViewerCamera *this, float a2)
{
  *((float *)this + 469) = a2;
}
