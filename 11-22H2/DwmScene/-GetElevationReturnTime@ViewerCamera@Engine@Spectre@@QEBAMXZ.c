/*
 * XREFs of ?GetElevationReturnTime@ViewerCamera@Engine@Spectre@@QEBAMXZ @ 0x180092CF0
 * Callers:
...
float __fastcall Spectre::Engine::ViewerCamera::GetElevationReturnTime(Spectre::Engine::ViewerCamera *this)
{
  return *((float *)this + 462);
}
