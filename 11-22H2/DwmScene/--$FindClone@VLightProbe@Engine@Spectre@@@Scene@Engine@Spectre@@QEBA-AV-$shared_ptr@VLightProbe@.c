/*
 * XREFs of ??$FindClone@VLightProbe@Engine@Spectre@@@Scene@Engine@Spectre@@QEBA?AV?$shared_ptr@VLightProbe@Engine@Spectre@@@std@@V?$shared_ptr@VScene@Engine@Spectre@@@4@V?$shared_ptr@VComponent@Engine@Spectre@@@4@@Z @ 0x180062218
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::Scene::FindClone<Spectre::Engine::LightProbe>(
        __int64 a1,
        _QWORD *a2,
        _QWORD *a3,
        _QWORD *a4)
{
  ...
  Spectre::Engine::SceneNode *v15; // [rsp+28h] [rbp-58h] BYREF
  ...
  {
    v9 = Spectre::Engine::SceneNode::GetComponent<Spectre::Engine::LightProbe>(v15, &v22);
    v10 = *v9;
    v11 = 5;
  }
  else
