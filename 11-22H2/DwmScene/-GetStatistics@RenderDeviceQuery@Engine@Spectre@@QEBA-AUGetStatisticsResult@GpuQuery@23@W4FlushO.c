/*
 * XREFs of ?GetStatistics@RenderDeviceQuery@Engine@Spectre@@QEBA?AUGetStatisticsResult@GpuQuery@23@W4FlushOption@523@@Z @ 0x1800A1F9C
 * Callers:
...
__int64 __fastcall Spectre::Engine::RenderDeviceQuery::GetStatistics(__int64 a1, __int64 a2)
{
  __int64 v4; // rcx
  _DWORD *v5; // rsi
  int v6; // eax
