/*
 * XREFs of ?CreateInternal@VertexBufferGeneric@Engine@Spectre@@UEAAXPEBX@Z @ 0x18008C660
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn Spectre::Engine::VertexBufferGeneric::CreateInternal(
        Spectre::Engine::VertexBufferGeneric *this,
        const void *a2)
{
  _QWORD *v2; // rax
  __int64 v3; // r8
  ...
  std::string::string(v5, (__int64)"Deprecated code path");
