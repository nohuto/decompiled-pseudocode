/*
 * XREFs of _Spectre::Engine::SceneNode::SetWorldRotation_::_1_::dtor$1 @ 0x1800E652D
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::SceneNode::SetWorldRotation_::_1_::dtor_1(__int64 a1, __int64 a2)
{
