/*
 * XREFs of ?RecoverData@IndexBufferD3D11@D3D11@Engine@Spectre@@UEBA?AV?$shared_ptr@X@std@@XZ @ 0x1800D8460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Spectre::Engine::D3D11::IndexBufferD3D11::RecoverData(__int64 a1, __int64 a2)
{
  unsigned int v4; // esi
  __int64 v5; // rcx
