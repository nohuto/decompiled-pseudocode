/*
 * XREFs of ?SetBackfaceCulledRenderState@ShaderPipeline@Engine@Spectre@@QEAAXV?$shared_ptr@VRenderState@Engine@Spectre@@@std@@@Z @ 0x180087578
 * Callers:
...
void __fastcall Spectre::Engine::ShaderPipeline::SetBackfaceCulledRenderState(__int64 a1, _QWORD *a2)
{
  std::_Ref_count_base *v3; // rcx

  std::shared_ptr<Spectre::Engine::Light>::operator=((__int64 *)(a1 + 64), a2);
