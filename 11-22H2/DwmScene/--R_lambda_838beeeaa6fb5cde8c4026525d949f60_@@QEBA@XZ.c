/*
 * XREFs of ??R_lambda_838beeeaa6fb5cde8c4026525d949f60_@@QEBA@XZ @ 0x180052928
 * Callers:
 *     ?_Do_call@?$_Func_impl_no_alloc@V_lambda_838beeeaa6fb5cde8c4026525d949f60_@@V?$shared_ptr@VRendererResource@Engine@Spectre@@@std@@$$V@std@@EEAA?AV?$shared_ptr@VRendererResource@Engine@Spectre@@@2@XZ @ 0x180053D80 (-_Do_call@-$_Func_impl_no_alloc@V_lambda_838beeeaa6fb5cde8c4026525d949f60_@@V-$shared_ptr@VRende.c)
 * Callees:
...
_QWORD *__fastcall _lambda_838beeeaa6fb5cde8c4026525d949f60_::operator()(__int64 a1, _QWORD *a2)
{
  char *v3; // rax
  __int64 v4; // rdi
  _QWORD *v5; // rbx
  ...
  if ( v3 )
  {
    ...
    *(_QWORD *)v3 = &std::_Ref_count_obj2<Spectre::Engine::VertexLayoutGeneric>::`vftable';
    memset_0(v3 + 16, 0, 0x90uLL);
    Spectre::Engine::DeviceVertexLayout::DeviceVertexLayout((Spectre::Engine::DeviceVertexLayout *)(v4 + 16));
