/*
 * XREFs of _Spectre::Engine::ShaderManager::CreateShaderFamily_::_1_::dtor$9 @ 0x1800E72EC
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::ShaderManager::CreateShaderFamily_::_1_::dtor_9(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 48) & 1) != 0 )
  {
    *(_DWORD *)(a2 + 48) &= ~1u;
