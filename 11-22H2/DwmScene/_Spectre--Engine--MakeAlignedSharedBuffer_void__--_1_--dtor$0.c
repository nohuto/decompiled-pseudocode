/*
 * XREFs of _Spectre::Engine::MakeAlignedSharedBuffer_void__::_1_::dtor$0 @ 0x1800EA5A7
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::MakeAlignedSharedBuffer_void__::_1_::dtor_0(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 32) & 1) != 0 )
  {
    *(_DWORD *)(a2 + 32) &= ~1u;
