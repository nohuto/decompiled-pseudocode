/*
 * XREFs of ??$CreateResource@VDeviceVertexLayout@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VDeviceVertexLayout@Engine@Spectre@@@std@@XZ @ 0x18008B908
 * Callers:
...
__int64 *__fastcall Spectre::Engine::RenderDevice::CreateResource<Spectre::Engine::DeviceVertexLayout>(
        __int64 a1,
        __int64 *a2)
{
  __int64 v4; // rbx
  ...
  Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceVertexLayout>(a1 + 496);
  v4 = *a2;
