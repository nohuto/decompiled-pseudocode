/*
 * XREFs of ?EndCommandList@RenderDeviceGeneric@Engine@Spectre@@UEBAXAEBV?$shared_ptr@VCommandList@Engine@Spectre@@@std@@@Z @ 0x1800530F0
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::RenderDeviceGeneric::EndCommandList()
{
  unsigned int v0; // eax
  int v1; // r8d
