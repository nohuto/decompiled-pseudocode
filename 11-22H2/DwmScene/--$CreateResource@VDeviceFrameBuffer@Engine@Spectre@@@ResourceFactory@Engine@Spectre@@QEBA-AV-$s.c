/*
 * XREFs of ??$CreateResource@VDeviceFrameBuffer@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDeviceFrameBuffer@Engine@Spectre@@@std@@XZ @ 0x180010794
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VDeviceFrameBuffer@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceFrameBuffer@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x180010C7C (--$dynamic_pointer_cast@VDeviceFrameBuffer@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$sha.c)
...
_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceFrameBuffer>(
        _QWORD *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C8BF8);
  ...
  {
    std::_Func_class<std::shared_ptr<Spectre::Engine::RendererResource>,>::operator()(v10 + 40, v7);
    std::dynamic_pointer_cast<Spectre::Engine::DeviceFrameBuffer,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
