/*
 * XREFs of ??$make_shared@VRenderOutputD3D11Gdi@D3D11@Engine@Spectre@@AEAUOutputDescription@34@V?$shared_ptr@VRenderDevice@Engine@Spectre@@@std@@AEAV?$shared_ptr@VPerformanceLogger@Utils@Spectre@@@7@@std@@YA?AV?$shared_ptr@VRenderOutputD3D11Gdi@D3D11@Engine@Spectre@@@0@AEAUOutputDescription@Engine@Spectre@@$$QEAV?$shared_ptr@VRenderDevice@Engine@Spectre@@@0@AEAV?$shared_ptr@VPerformanceLogger@Utils@Spectre@@@0@@Z @ 0x1800C3BEC
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::D3D11::RenderOutputD3D11Gdi,Spectre::Engine::OutputDescription &,std::shared_ptr<Spectre::Engine::RenderDevice>,std::shared_ptr<Spectre::Utils::PerformanceLogger> &>(
        _QWORD *a1,
        _OWORD *a2,
        _QWORD *a3,
        _QWORD *a4)
{
  ...
  if ( v8 )
  {
    ...
    *a3 = 0LL;
    ...
    v20[0] = *a2;
    v20[1] = a2[1];
    Spectre::Engine::D3D11::RenderOutputD3D11Gdi::RenderOutputD3D11Gdi(v9 + 4, v20, v18, v10);
  }
  else
  {
    v9 = 0LL;
