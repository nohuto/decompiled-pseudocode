/*
 * XREFs of ??$make_shared@VMesh@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VMesh@Engine@Spectre@@@0@XZ @ 0x180017288
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::Mesh,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rbx
  _DWORD *v4; // rax
  ...
  if ( v2 )
  {
    *(_OWORD *)v2 = 0LL;
    v2[2] = 1;
    v2[3] = 1;
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::Mesh>::`vftable';
    Spectre::Engine::Mesh::Mesh((Spectre::Engine::Mesh *)(v2 + 4));
  }
  else
  {
    v3 = 0LL;
