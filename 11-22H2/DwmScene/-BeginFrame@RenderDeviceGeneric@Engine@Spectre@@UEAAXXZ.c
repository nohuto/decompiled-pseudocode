/*
 * XREFs of ?BeginFrame@RenderDeviceGeneric@Engine@Spectre@@UEAAXXZ @ 0x180052F10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn Spectre::Engine::RenderDeviceGeneric::BeginFrame(Spectre::Engine::RenderDeviceGeneric *this)
{
  unsigned int v1; // eax
  int v2; // r8d
