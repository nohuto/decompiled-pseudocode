/*
 * XREFs of ??$GetComponents@VLight@Engine@Spectre@@@Scene@Engine@Spectre@@QEAA?AV?$vector@V?$shared_ptr@VLight@Engine@Spectre@@@std@@V?$allocator@V?$shared_ptr@VLight@Engine@Spectre@@@std@@@2@@std@@XZ @ 0x180011F38
 * Callers:
...
__int64 __fastcall Spectre::Engine::Scene::GetComponents<Spectre::Engine::Light>(__int64 a1, __int64 a2)
{
  Spectre::Engine::Scene::GetComponents_Internal<Spectre::Engine::Light>();
  return a2;
}
