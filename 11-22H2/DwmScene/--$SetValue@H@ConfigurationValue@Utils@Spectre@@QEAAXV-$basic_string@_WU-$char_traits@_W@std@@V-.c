/*
 * XREFs of ??$SetValue@H@ConfigurationValue@Utils@Spectre@@QEAAXV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@H@Z @ 0x1800DC114
 * Callers:
...
__int64 __fastcall Spectre::Utils::ConfigurationValue::SetValue<int>(__int64 a1, _QWORD *a2, int a3)
{
  __int64 v4; // rbx
  __int64 v5; // rsi
  _DWORD *v6; // rax
  ...
  v6 = (_DWORD *)std::unordered_map<std::wstring,Spectre::Utils::ConfigurationValue>::operator[](v5, v8);
  v6[10] = a3;
  *v6 = 1;
