/*
 * XREFs of ?XMQuaternionRotationMatrix@DirectX@@YQ?AT__m128@@UXMMATRIX@1@@Z @ 0x18003EAC4
 * Callers:
...
__m128 __fastcall DirectX::XMQuaternionRotationMatrix(double a1, double a2, double a3)
{
  ...
  v7 = _mm_mul_ps(v6, (__m128)_xmm);
  v8 = _mm_shuffle_ps(*(__m128 *)&a1, *(__m128 *)&a1, 0);
  v9 = _mm_cmple_ps(v6, DirectX::g_XMZero);
  v10 = _mm_cmple_ps(_mm_add_ps(v3, v8), DirectX::g_XMZero);
  v11 = _mm_cmple_ps(_mm_sub_ps(v3, v8), DirectX::g_XMZero);
  v12 = _mm_add_ps(
          _mm_add_ps(
            _mm_add_ps(_mm_mul_ps(v8, (__m128)`DirectX::XMQuaternionRotationMatrix'::`2'::XMPMMP), DirectX::g_XMOne),
            v7),
