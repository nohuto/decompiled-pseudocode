/*
 * XREFs of ??0RenderOutputD3D11CoreWindow@D3D11@Engine@Spectre@@QEAA@UOutputDescription@23@V?$shared_ptr@VRenderDevice@Engine@Spectre@@@std@@V?$shared_ptr@VPerformanceLogger@Utils@Spectre@@@6@@Z @ 0x1800C8C74
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::D3D11::RenderOutputD3D11CoreWindow::RenderOutputD3D11CoreWindow(
        _QWORD *a1,
        _OWORD *a2,
        _QWORD *a3,
        __int64 *a4)
