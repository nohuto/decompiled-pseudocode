/*
 * XREFs of ??$_Insert_string@_WU?$char_traits@_W@std@@_K@std@@YAAEAV?$basic_ostream@_WU?$char_traits@_W@std@@@0@AEAV10@QEB_W_K@Z @ 0x18002F3AC
 * Callers:
...
__int64 __fastcall std::_Insert_string<wchar_t,std::char_traits<wchar_t>,unsigned __int64>(
        __int64 a1,
        __int64 a2,
        unsigned __int64 a3)
{
  ...
  std::wostream::sentry::sentry(v14, a1);
  if ( v14[8] )
  {
