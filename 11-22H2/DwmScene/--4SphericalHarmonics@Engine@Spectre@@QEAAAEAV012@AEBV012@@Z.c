/*
 * XREFs of ??4SphericalHarmonics@Engine@Spectre@@QEAAAEAV012@AEBV012@@Z @ 0x180051340
 * Callers:
...
_DWORD *__fastcall Spectre::Engine::SphericalHarmonics::operator=(_DWORD *a1, _DWORD *a2)
{
  *a1 = *a2;
  a1[1] = a2[1];
  a1[2] = a2[2];
