/*
 * XREFs of ??$make_shared@VRenderState@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VRenderState@Engine@Spectre@@@0@XZ @ 0x18004375C
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::RenderState,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rbx
  _DWORD *v4; // rax
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::RenderState>::`vftable';
    Spectre::Engine::RenderState::RenderState((Spectre::Engine::RenderState *)(v2 + 4));
  }
  else
  {
    v3 = 0LL;
