/*
 * XREFs of Spectre::Engine::SceneLayerStandardID::_dynamic_atexit_destructor_for__kBackground__ @ 0x1800F2680
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::SceneLayerStandardID::_dynamic_atexit_destructor_for__kBackground__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::SceneLayerStandardID::kBackground);
