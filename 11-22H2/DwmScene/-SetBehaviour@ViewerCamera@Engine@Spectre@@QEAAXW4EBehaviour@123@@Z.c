/*
 * XREFs of ?SetBehaviour@ViewerCamera@Engine@Spectre@@QEAAXW4EBehaviour@123@@Z @ 0x180092F60
 * Callers:
...
void __fastcall Spectre::Engine::ViewerCamera::SetBehaviour(__int64 a1, int a2)
{
  *(_DWORD *)(a1 + 1868) = a2;
}
