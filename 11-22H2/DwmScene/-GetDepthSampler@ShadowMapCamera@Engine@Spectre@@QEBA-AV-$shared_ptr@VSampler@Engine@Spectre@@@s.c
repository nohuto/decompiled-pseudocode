/*
 * XREFs of ?GetDepthSampler@ShadowMapCamera@Engine@Spectre@@QEBA?AV?$shared_ptr@VSampler@Engine@Spectre@@@std@@XZ @ 0x18008E284
 * Callers:
...
__int64 __fastcall Spectre::Engine::ShadowMapCamera::GetDepthSampler(__int64 a1, _QWORD *a2)
{
  __int64 v2; // r8
