/*
 * XREFs of ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x18000DCC0
 * Callers:
 *     <none>
 * Callees:
 *     ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x18000E0D4 (-GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z.c)
 */
