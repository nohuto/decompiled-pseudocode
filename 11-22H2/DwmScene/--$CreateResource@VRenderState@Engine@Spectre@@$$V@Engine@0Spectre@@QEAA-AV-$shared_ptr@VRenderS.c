/*
 * XREFs of ??$CreateResource@VRenderState@Engine@Spectre@@$$V@Engine@0Spectre@@QEAA?AV?$shared_ptr@VRenderState@Engine@Spectre@@@std@@W4ResourceDevicePolicy@01@@Z @ 0x180043474
 * Callers:
...
__int64 __fastcall Spectre::Engine::Engine::CreateResource<Spectre::Engine::RenderState,>(__int64 *a1, __int64 a2)
{
  ...
  std::make_shared<Spectre::Engine::RenderState,>(a2);
