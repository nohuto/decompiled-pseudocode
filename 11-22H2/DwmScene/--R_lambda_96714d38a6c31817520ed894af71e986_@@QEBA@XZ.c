/*
 * XREFs of ??R_lambda_96714d38a6c31817520ed894af71e986_@@QEBA@XZ @ 0x1800529D0
 * Callers:
 *     ?_Do_call@?$_Func_impl_no_alloc@V_lambda_96714d38a6c31817520ed894af71e986_@@V?$shared_ptr@VRendererResource@Engine@Spectre@@@std@@$$V@std@@EEAA?AV?$shared_ptr@VRendererResource@Engine@Spectre@@@2@XZ @ 0x180053E20 (-_Do_call@-$_Func_impl_no_alloc@V_lambda_96714d38a6c31817520ed894af71e986_@@V-$shared_ptr@VRende.c)
 * Callees:
...
_QWORD *__fastcall _lambda_96714d38a6c31817520ed894af71e986_::operator()(__int64 a1, _QWORD *a2)
{
  char *v3; // rax
  __int64 v4; // rdi
  _QWORD *v5; // rbx
  ...
  if ( v3 )
  {
    ...
    *(_QWORD *)v3 = &std::_Ref_count_obj2<Spectre::Engine::TextureGeneric>::`vftable';
    memset_0(v3 + 16, 0, 0xA0uLL);
    Spectre::Engine::DeviceTexture::DeviceTexture((Spectre::Engine::DeviceTexture *)(v4 + 16));
    *v5 = &Spectre::Engine::TextureGeneric::`vftable';
  }
  else
  {
    v4 = 0LL;
