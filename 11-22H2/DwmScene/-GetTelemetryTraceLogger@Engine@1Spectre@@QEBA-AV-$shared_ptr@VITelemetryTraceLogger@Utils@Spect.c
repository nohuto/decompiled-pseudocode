/*
 * XREFs of ?GetTelemetryTraceLogger@Engine@1Spectre@@QEBA?AV?$shared_ptr@VITelemetryTraceLogger@Utils@Spectre@@@std@@XZ @ 0x18003487C
 * Callers:
...
__int64 __fastcall Spectre::Engine::Engine::GetTelemetryTraceLogger(__int64 a1, _QWORD *a2)
{
  __int64 v2; // r8
