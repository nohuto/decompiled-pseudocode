        ...
        __int64 a34)
{
  ...
  const wchar_t *v93; // [rsp+1B0h] [rbp+B0h]
  ...
  v48 = v44;
  v49 = 0;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1801C81C0, a2, 0LL, 0LL, 0x20u, &v46);
}
