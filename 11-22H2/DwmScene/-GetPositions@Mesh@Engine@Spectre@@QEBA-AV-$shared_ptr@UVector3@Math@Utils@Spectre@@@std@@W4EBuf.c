/*
 * XREFs of ?GetPositions@Mesh@Engine@Spectre@@QEBA?AV?$shared_ptr@UVector3@Math@Utils@Spectre@@@std@@W4EBufferGetDataOption@23@@Z @ 0x180048980
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::Mesh::GetPositions(__int64 a1, _QWORD *a2, int a3)
{
  __int64 v3; // rcx
