/*
 * XREFs of ?RecoverData@IndexBufferGeneric@Engine@Spectre@@MEBA?AV?$shared_ptr@X@std@@XZ @ 0x18008C5F0
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::IndexBufferGeneric::RecoverData()
{
  _QWORD *v0; // rax
  __int64 v1; // r8
