...
__int64 __fastcall std::map<std::string,Trace::LevelSettings *>::_Try_emplace<std::string,>(
        __int64 *a1,
        __int64 a2,
        _QWORD *a3)
{
  ...
  else
  {
    ...
    v9 = *a1;
    v16 = a3;
    v10 = std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::string const,Trace::LevelSettings *>,void *>>>::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::string const,Trace::LevelSettings *>,void *>>>(
            v13,
            (__int64)a1,
            v9,
            v8,
    ...
    v11 = v10[1];
    v10[1] = 0LL;
    std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::string const,Trace::LevelSettings *>,void *>>>::~_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::string const,Trace::LevelSettings *>,void *>>>(v13);
