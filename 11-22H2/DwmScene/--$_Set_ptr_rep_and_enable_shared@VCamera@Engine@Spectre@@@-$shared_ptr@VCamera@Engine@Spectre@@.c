/*
 * XREFs of ??$_Set_ptr_rep_and_enable_shared@VCamera@Engine@Spectre@@@?$shared_ptr@VCamera@Engine@Spectre@@@std@@AEAAXQEAVCamera@Engine@Spectre@@QEAV_Ref_count_base@1@@Z @ 0x18002F754
 * Callers:
...
void __fastcall std::shared_ptr<Spectre::Engine::Camera>::_Set_ptr_rep_and_enable_shared<Spectre::Engine::Camera>(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
