/*
 * XREFs of ??$_Try_emplace@AEBH$$V@?$map@HV?$shared_ptr@VIConfigurationManager@Utils@Spectre@@@std@@U?$less@H@2@V?$allocator@U?$pair@$$CBHV?$shared_ptr@VIConfigurationManager@Utils@Spectre@@@std@@@std@@@2@@std@@AEAA?AU?$pair@PEAU?$_Tree_node@U?$pair@$$CBHV?$shared_ptr@VIConfigurationManager@Utils@Spectre@@@std@@@std@@PEAX@std@@_N@1@AEBH@Z @ 0x18002F878
 * Callers:
...
__int64 __fastcall std::map<int,std::shared_ptr<Spectre::Utils::IConfigurationManager>>::_Try_emplace<int const &,>(
        __int64 *a1,
        __int64 a2,
        int *a3)
{
