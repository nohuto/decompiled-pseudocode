/*
 * XREFs of ??$_Reallocate_grow_by@V_lambda_319d5e083f45f90dcdce5dce53cbb275_@@D@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAAAEAV01@_KV_lambda_319d5e083f45f90dcdce5dce53cbb275_@@D@Z @ 0x18001E260
 * Callers:
        ...
        char a4)
{
  ...
  v8 = std::string::_Calculate_growth(v4 + 1, v7, 0x7FFFFFFFFFFFFFFFuLL);
