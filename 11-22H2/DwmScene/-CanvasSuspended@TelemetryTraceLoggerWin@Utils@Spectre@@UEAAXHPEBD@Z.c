/*
 * XREFs of ?CanvasSuspended@TelemetryTraceLoggerWin@Utils@Spectre@@UEAAXHPEBD@Z @ 0x180022270
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Utils::TelemetryTraceLoggerWin::CanvasSuspended(
