/*
 * XREFs of ??$FindClone@VViewerCamera@Engine@Spectre@@@Scene@Engine@Spectre@@QEBA?AV?$shared_ptr@VViewerCamera@Engine@Spectre@@@std@@V?$shared_ptr@VScene@Engine@Spectre@@@4@V?$shared_ptr@VComponent@Engine@Spectre@@@4@@Z @ 0x180062488
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::Scene::FindClone<Spectre::Engine::ViewerCamera>(
        __int64 a1,
        _QWORD *a2,
        _QWORD *a3,
        _QWORD *a4)
{
  ...
  {
    v9 = (__int64 *)Spectre::Engine::SceneNode::GetComponent<Spectre::Engine::ViewerCamera>(v15, v22);
    v10 = *v9;
    v11 = 5;
  }
  else
