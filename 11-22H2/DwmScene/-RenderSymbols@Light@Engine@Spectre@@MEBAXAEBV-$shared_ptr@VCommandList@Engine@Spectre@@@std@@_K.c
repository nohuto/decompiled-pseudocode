/*
 * XREFs of ?RenderSymbols@Light@Engine@Spectre@@MEBAXAEBV?$shared_ptr@VCommandList@Engine@Spectre@@@std@@_KAEBV?$shared_ptr@$$CBVCamera@Engine@Spectre@@@5@@Z @ 0x180043300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Spectre::Engine::Light::RenderSymbols(
