...
_QWORD *__fastcall std::make_shared<Spectre::Engine::D3D11::RenderOutputD3D11Xaml,Spectre::Engine::OutputDescription &,std::shared_ptr<Spectre::Engine::RenderDevice>,std::shared_ptr<Spectre::Utils::PerformanceLogger> &>(
        _QWORD *a1,
        _OWORD *a2,
        _QWORD *a3,
        _QWORD *a4)
{
  ...
  if ( v8 )
  {
    ...
    *a3 = 0LL;
    ...
    v20[0] = *a2;
    v20[1] = a2[1];
    Spectre::Engine::D3D11::RenderOutputD3D11Xaml::RenderOutputD3D11Xaml(v9 + 4, v20, v18, v10);
  }
  else
  {
    v9 = 0LL;
