/*
 * XREFs of ??0TextureState@Engine@Spectre@@QEAA@VShaderTypeGroup@12@AEBVState@12@@Z @ 0x18009DEF4
 * Callers:
...
__int64 __fastcall Spectre::Engine::TextureState::TextureState(__int64 a1, int a2, __int64 a3)
{
  unsigned int i; // ebx
