/*
 * XREFs of ??$CreateResource@VGpuQuery@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VGpuQuery@Engine@Spectre@@@std@@XZ @ 0x18002495C
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VGpuQuery@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VGpuQuery@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x1800251C0 (--$dynamic_pointer_cast@VGpuQuery@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$shared_ptr@V.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::GpuQuery>(__int64 *a1, _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C8FA8);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::GpuQuery,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
