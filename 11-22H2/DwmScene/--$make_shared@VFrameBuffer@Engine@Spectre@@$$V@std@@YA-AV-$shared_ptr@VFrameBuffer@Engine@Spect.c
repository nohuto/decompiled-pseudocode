/*
 * XREFs of ??$make_shared@VFrameBuffer@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VFrameBuffer@Engine@Spectre@@@0@XZ @ 0x180010CE4
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::FrameBuffer,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rbx
  _DWORD *v4; // rax
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::FrameBuffer>::`vftable';
    Spectre::Engine::FrameBuffer::FrameBuffer((Spectre::Engine::FrameBuffer *)(v2 + 4));
  }
  else
  {
    v3 = 0LL;
