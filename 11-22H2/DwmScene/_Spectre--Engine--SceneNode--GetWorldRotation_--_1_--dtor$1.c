/*
 * XREFs of _Spectre::Engine::SceneNode::GetWorldRotation_::_1_::dtor$1 @ 0x1800E64A9
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::SceneNode::GetWorldRotation_::_1_::dtor_1(__int64 a1, __int64 a2)
{
