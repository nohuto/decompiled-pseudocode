/*
 * XREFs of ?Create@RenderStateGeneric@Engine@Spectre@@UEAAXV?$shared_ptr@URenderStateDesc@Engine@Spectre@@@std@@@Z @ 0x18008B890
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::RenderStateGeneric::Create()
{
  _QWORD *v0; // rax
  __int64 v1; // r8
