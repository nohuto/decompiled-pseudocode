/*
 * XREFs of ??$make_shared@VGeometryShader@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VGeometryShader@Engine@Spectre@@@0@XZ @ 0x18004DFC0
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::GeometryShader,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rdi
  __int64 v4; // rcx
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::GeometryShader>::`vftable';
    Spectre::Engine::Shader::Shader(v2 + 4, 4LL);
