/*
 * XREFs of ?Set@TextureState@Engine@Spectre@@UEAAXPEAVCommandList@23@@Z @ 0x18009E170
 * Callers:
...
void __fastcall Spectre::Engine::TextureState::Set(
      ...
      do
      {
               ...
               (_QWORD *)this + 32 * i + 2 * v7 + 1) )
        {
          ...
          std::shared_ptr<Spectre::Engine::Light>::operator=(
            ...
            (Spectre::Engine::TextureState *)((char *)this + v8 + 8));
          (*(void (__fastcall **)(struct Spectre::Engine::CommandList *, _QWORD, char *, _QWORD))(*(_QWORD *)a2 + 128LL))(
            a2,
            i,
            v9 + 1544,
            v6);
