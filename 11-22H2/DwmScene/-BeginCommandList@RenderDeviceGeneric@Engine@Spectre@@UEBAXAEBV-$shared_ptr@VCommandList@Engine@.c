/*
 * XREFs of ?BeginCommandList@RenderDeviceGeneric@Engine@Spectre@@UEBAXAEBV?$shared_ptr@VCommandList@Engine@Spectre@@@std@@@Z @ 0x180052EA0
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::RenderDeviceGeneric::BeginCommandList()
{
  unsigned int v0; // eax
  int v1; // r8d
