/*
 * XREFs of ??$CreateResource@VDeviceConstantBuffer@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VDeviceConstantBuffer@Engine@Spectre@@@std@@XZ @ 0x180083C70
 * Callers:
...
__int64 *__fastcall Spectre::Engine::RenderDevice::CreateResource<Spectre::Engine::DeviceConstantBuffer>(
        __int64 a1,
        __int64 *a2)
{
  __int64 v4; // rbx
  ...
  Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceConstantBuffer>(a1 + 496);
  v4 = *a2;
