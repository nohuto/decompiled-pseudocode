/*
 * XREFs of ??$dynamic_pointer_cast@VHullShaderD3D11@D3D11@Engine@Spectre@@VDeviceShader@34@@std@@YA?AV?$shared_ptr@VHullShaderD3D11@D3D11@Engine@Spectre@@@0@AEBV?$shared_ptr@VDeviceShader@Engine@Spectre@@@0@@Z @ 0x1800CF67C
 * Callers:
...
__int64 *__fastcall std::dynamic_pointer_cast<Spectre::Engine::D3D11::HullShaderD3D11,Spectre::Engine::DeviceShader>(
        __int64 *a1,
        _QWORD *a2)
{
  __int64 v4; // rax
