/*
 * XREFs of ??$?4V_lambda_67580e89edb989bae1ab2e6bcdd7b69a_@@$0A@@?$function@$$A6A?AV?$shared_ptr@VRendererResource@Engine@Spectre@@@std@@XZ@std@@QEAAAEAV01@$$QEAV_lambda_67580e89edb989bae1ab2e6bcdd7b69a_@@@Z @ 0x1800C24DC
 * Callers:
 ...
 *     ??$_Test_callable@V_lambda_67580e89edb989bae1ab2e6bcdd7b69a_@@@std@@YA_NAEBV_lambda_67580e89edb989bae1ab2e6bcdd7b69a_@@@Z @ 0x1800C3964 (--$_Test_callable@V_lambda_67580e89edb989bae1ab2e6bcdd7b69a_@@@std@@YA_NAEBV_lambda_67580e89edb9.c)
 */

__int64 __fastcall std::function<std::shared_ptr<Spectre::Engine::RendererResource> (void)>::operator=<_lambda_67580e89edb989bae1ab2e6bcdd7b69a_,0>(
        __int64 a1)
{
  char v2; // al
  __int64 v3; // rdx
  ...
  v8 = 0LL;
  v2 = std::_Test_callable<_lambda_67580e89edb989bae1ab2e6bcdd7b69a_>();
  if ( v2 )
  {
