/*
 * XREFs of ?Load@GeometryShaderD3D11@D3D11@Engine@Spectre@@UEAA_NAEBVShaderProgram@34@@Z @ 0x1800D7400
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall Spectre::Engine::D3D11::GeometryShaderD3D11::Load(
        ...
        const struct Spectre::Engine::ShaderProgram *a2)
{
  ...
  if ( !Spectre::Engine::ShaderProgram::empty(a2) )
  {
    ...
    v6 = v17;
    v7 = *(__int64 (__fastcall **)(__int64, __int64, unsigned __int64, _QWORD, char *))(*(_QWORD *)v17 + 104LL);
    ...
    if ( v10 < 0 )
    {
      Trace::LevelSettingsWrapper::Output(
        &gTraceLevelsGeometryShaderD3D11,
        5,
