/*
 * XREFs of ??$_Emplace_back_internal@_K@?$deque@_KV?$allocator@_K@std@@@std@@AEAAX$$QEA_K@Z @ 0x1800A07DC
 * Callers:
...
__int64 __fastcall std::deque<unsigned __int64>::_Emplace_back_internal<unsigned __int64>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rcx
  __int64 v5; // rdx
