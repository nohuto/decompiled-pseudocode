/*
 * XREFs of Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kMaterial_SmoothnessOverride__ @ 0x1800F5B90
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kMaterial_SmoothnessOverride__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::ConfigurationProperties::kMaterial_SmoothnessOverride);
