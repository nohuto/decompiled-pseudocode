/*
 * XREFs of Spectre::Engine::SceneLayerStandardID::_dynamic_atexit_destructor_for__kCameras__ @ 0x1800F26B0
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::SceneLayerStandardID::_dynamic_atexit_destructor_for__kCameras__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::SceneLayerStandardID::kCameras);
