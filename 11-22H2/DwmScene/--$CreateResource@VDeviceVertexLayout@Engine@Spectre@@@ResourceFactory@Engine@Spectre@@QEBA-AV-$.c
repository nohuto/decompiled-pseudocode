/*
 * XREFs of ??$CreateResource@VDeviceVertexLayout@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDeviceVertexLayout@Engine@Spectre@@@std@@XZ @ 0x18008B980
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VDeviceVertexLayout@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceVertexLayout@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x18008BB94 (--$dynamic_pointer_cast@VDeviceVertexLayout@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$sh.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceVertexLayout>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C95C0);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::DeviceVertexLayout,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
