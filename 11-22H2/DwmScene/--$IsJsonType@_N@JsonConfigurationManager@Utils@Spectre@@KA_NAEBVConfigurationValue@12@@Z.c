/*
 * XREFs of ??$IsJsonType@_N@JsonConfigurationManager@Utils@Spectre@@KA_NAEBVConfigurationValue@12@@Z @ 0x1800DC108
 * Callers:
...
// attributes: thunk
bool __fastcall Spectre::Utils::JsonConfigurationManager::IsJsonType<bool>(Spectre::Utils::ConfigurationValue *a1)
{
  return Spectre::Utils::ConfigurationValue::IsBool(a1);
}
