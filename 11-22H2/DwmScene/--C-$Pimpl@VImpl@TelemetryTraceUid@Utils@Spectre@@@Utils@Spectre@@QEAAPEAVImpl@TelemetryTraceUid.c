/*
 * XREFs of ??C?$Pimpl@VImpl@TelemetryTraceUid@Utils@Spectre@@@Utils@Spectre@@QEAAPEAVImpl@TelemetryTraceUid@12@XZ @ 0x180021E34
 * Callers:
...
__int64 __fastcall Spectre::Utils::Pimpl<Spectre::Utils::TelemetryTraceUid::Impl>::operator->(__int64 a1)
{
  return *(_QWORD *)a1;
}
