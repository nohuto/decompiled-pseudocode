/*
 * XREFs of ?SetFrameBuffer@Camera@Engine@Spectre@@QEAAXV?$shared_ptr@VFrameBuffer@Engine@Spectre@@@std@@@Z @ 0x18005D1EC
 * Callers:
...
void __fastcall Spectre::Engine::Camera::SetFrameBuffer(Spectre::Engine::Camera *this, __int64 *a2)
{
  _QWORD *v4; // r8
  std::_Ref_count_base *v5; // rcx

  if ( std::operator!=<Spectre::Engine::Scene,Spectre::Engine::Scene>(a2, (_QWORD *)this + 17) )
  {
