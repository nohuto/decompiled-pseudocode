/*
 * XREFs of ??$CreateResource@VDeviceHullShader@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VDeviceHullShader@Engine@Spectre@@@std@@XZ @ 0x180089DFC
 * Callers:
...
__int64 *__fastcall Spectre::Engine::RenderDevice::CreateResource<Spectre::Engine::DeviceHullShader>(
        __int64 a1,
        __int64 *a2)
{
  __int64 v4; // rbx
  ...
  Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceHullShader>(a1 + 496);
  v4 = *a2;
