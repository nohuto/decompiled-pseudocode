/*
 * XREFs of ?GetRadianceTexture@LightProbe@Engine@Spectre@@QEBA?AV?$shared_ptr@VTexture@Engine@Spectre@@@std@@XZ @ 0x180051B58
 * Callers:
...
__int64 __fastcall Spectre::Engine::LightProbe::GetRadianceTexture(__int64 a1, _QWORD *a2)
{
  __int64 v2; // r8
