/*
 * XREFs of ?Increment@TraceLoggingCorrelationVector@@QEAA_NPEAD@Z @ 0x1800231E0
 * Callers:
 *     ?CanvasDestroyed@TelemetryTraceLoggerWin@Utils@Spectre@@UEAAXHPEBD@Z @ 0x180021F20 (-CanvasDestroyed@TelemetryTraceLoggerWin@Utils@Spectre@@UEAAXHPEBD@Z.c)
 ...
 *     ?CanvasSuspended@TelemetryTraceLoggerWin@Utils@Spectre@@UEAAXHPEBD@Z @ 0x180022270 (-CanvasSuspended@TelemetryTraceLoggerWin@Utils@Spectre@@UEAAXHPEBD@Z.c)
 ...
 * Callees:
 *     ?IncrementImpl@TraceLoggingCorrelationVector@@AEAA_KXZ @ 0x180023208 (-IncrementImpl@TraceLoggingCorrelationVector@@AEAA_KXZ.c)
 */

bool __fastcall TraceLoggingCorrelationVector::Increment(TraceLoggingCorrelationVector *this, char *a2)
{
  unsigned __int64 v2; // rax
  char *v3; // r9
  TraceLoggingCorrelationVector *v4; // r10

  v2 = TraceLoggingCorrelationVector::IncrementImpl(this);
  return TraceLoggingCorrelationVector::ToStringImpl(v4, v2, v3);
}
