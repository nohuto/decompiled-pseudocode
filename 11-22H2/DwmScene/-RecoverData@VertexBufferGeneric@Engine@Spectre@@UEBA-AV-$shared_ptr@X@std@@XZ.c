/*
 * XREFs of ?RecoverData@VertexBufferGeneric@Engine@Spectre@@UEBA?AV?$shared_ptr@X@std@@XZ @ 0x18008C6D0
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::VertexBufferGeneric::RecoverData()
{
  _QWORD *v0; // rax
  __int64 v1; // r8
