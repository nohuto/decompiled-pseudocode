/*
 * XREFs of ??$AddComponent@VCamera@Engine@Spectre@@@SceneNode@Engine@Spectre@@QEAA?AV?$shared_ptr@VCamera@Engine@Spectre@@@std@@XZ @ 0x18002DAEC
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::SceneNode::AddComponent<Spectre::Engine::Camera>(
        ...
        _QWORD *a2)
{
  ...
  v4 = *Spectre::Engine::SceneNode::GetComponent<Spectre::Engine::Camera>(this, &v8);
  if ( v9 )
  ...
  else
  {
    ...
    std::make_shared<Spectre::Engine::Camera,std::shared_ptr<Spectre::Engine::SceneNode>>(v7, v5);
    if ( v9 )
      std::_Ref_count_base::_Decref(v9);
