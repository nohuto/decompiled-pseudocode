/*
 * XREFs of Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kCamera_FrameOnModelLoad__ @ 0x1800F34C0
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kCamera_FrameOnModelLoad__()
{
  std::wstring::_Tidy_deallocate((__int64)&unk_1801D6848);
