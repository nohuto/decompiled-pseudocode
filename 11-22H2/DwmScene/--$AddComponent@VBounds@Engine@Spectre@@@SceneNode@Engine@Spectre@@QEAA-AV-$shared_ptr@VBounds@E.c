/*
 * XREFs of ??$AddComponent@VBounds@Engine@Spectre@@@SceneNode@Engine@Spectre@@QEAA?AV?$shared_ptr@VBounds@Engine@Spectre@@@std@@XZ @ 0x180013C74
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::SceneNode::AddComponent<Spectre::Engine::Bounds>(
        ...
        _QWORD *a2)
{
  ...
  v4 = *(_QWORD *)Spectre::Engine::SceneNode::GetComponent<Spectre::Engine::Bounds>(this, &v8);
  if ( v9 )
  ...
  else
  {
    ...
    std::make_shared<Spectre::Engine::Bounds,std::shared_ptr<Spectre::Engine::SceneNode>>(v7, v5);
    if ( v9 )
      std::_Ref_count_base::_Decref(v9);
