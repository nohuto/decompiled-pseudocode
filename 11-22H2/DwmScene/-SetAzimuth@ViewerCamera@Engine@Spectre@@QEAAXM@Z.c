/*
 * XREFs of ?SetAzimuth@ViewerCamera@Engine@Spectre@@QEAAXM@Z @ 0x180092F50
 * Callers:
...
void __fastcall Spectre::Engine::ViewerCamera::SetAzimuth(Spectre::Engine::ViewerCamera *this, float a2)
{
  *((float *)this + 468) = a2;
}
