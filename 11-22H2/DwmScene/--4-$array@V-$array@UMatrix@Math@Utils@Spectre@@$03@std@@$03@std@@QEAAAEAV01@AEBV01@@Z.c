/*
 * XREFs of ??4?$array@V?$array@UMatrix@Math@Utils@Spectre@@$03@std@@$03@std@@QEAAAEAV01@AEBV01@@Z @ 0x180059B88
 * Callers:
...
__int64 __fastcall std::array<std::array<Spectre::Utils::Math::Matrix,4>,4>::operator=(__int64 a1, __int64 a2)
{
  __int64 v3; // r9
  __int64 v4; // r8
  __int64 v5; // r10
