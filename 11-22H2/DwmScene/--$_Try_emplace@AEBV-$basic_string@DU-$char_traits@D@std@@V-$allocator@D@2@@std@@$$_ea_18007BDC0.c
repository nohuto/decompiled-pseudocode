 ...
 *     ??0?$_Tree_temp_node_alloc@V?$allocator@U?$_Tree_node@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@PEAX@std@@@std@@@std@@QEAA@AEAV?$allocator@U?$_Tree_node@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@PEAX@std@@@1@@Z @ 0x180030AC0 (--0-$_Tree_temp_node_alloc@V-$allocator@U-$_Tree_node@U-$pair@$$CBV-$basic_string@D_ea_180030AC0.c)
 *     ?_Check_grow_by_1@?$_Tree@V?$_Tmap_traits@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@UProgramRegistration@ShaderRegistration@Engine@Spectre@@U?$less@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@UProgramRegistration@ShaderRegistration@Engine@Spectre@@@std@@@2@$0A@@std@@@std@@IEAAXXZ @ 0x180037FC0 (-_Check_grow_by_1@-$_Tree@V-$_Tmap_traits@V-$basic_string@DU-$char_traits@D@std@@V-_ea_180037FC0.c)
 *     ??1?$_Tree_temp_node@V?$allocator@U?$_Tree_node@U?$pair@$$CBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@UProgramRegistration@ShaderRegistration@Engine@Spectre@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x18007BFFC (--1-$_Tree_temp_node@V-$allocator@U-$_Tree_node@U-$pair@$$CBV-$basic_string@DU-$cha_ea_18007BFFC.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall std::map<std::string,Spectre::Engine::ShaderRegistration::ProgramRegistration>::_Try_emplace<std::string const &,>(
        __int64 *a1,
        __int64 a2,
        _QWORD *a3)
{
  ...
  {
    std::_Tree<std::_Tmap_traits<std::string,Spectre::Engine::ShaderRegistration::ProgramRegistration,std::less<std::string>,std::allocator<std::pair<std::string const,Spectre::Engine::ShaderRegistration::ProgramRegistration>>,0>>::_Check_grow_by_1((__int64)a1);
    v8 = *a1;
    std::_Tree_temp_node_alloc<std::allocator<std::_Tree_node<std::pair<std::string const,std::string>,void *>>>::_Tree_temp_node_alloc<std::allocator<std::_Tree_node<std::pair<std::string const,std::string>,void *>>>(
      &v12,
      (__int64)a1);
    v9 = v13;
    std::string::string((_QWORD *)(v13 + 32), (__int64)a3);
    *(_QWORD *)(v9 + 64) = 0LL;
    *(_QWORD *)(v9 + 72) = 0LL;
    *(_QWORD *)v13 = v8;
    *(_QWORD *)(v13 + 8) = v8;
    ...
    *(_BYTE *)(v13 + 25) = 0;
    v10 = v13;
    v13 = 0LL;
    std::_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::string const,Spectre::Engine::ShaderRegistration::ProgramRegistration>,void *>>>::~_Tree_temp_node<std::allocator<std::_Tree_node<std::pair<std::string const,Spectre::Engine::ShaderRegistration::ProgramRegistration>,void *>>>(&v12);
