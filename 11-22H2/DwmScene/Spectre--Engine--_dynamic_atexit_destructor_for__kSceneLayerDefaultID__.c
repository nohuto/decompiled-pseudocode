/*
 * XREFs of Spectre::Engine::_dynamic_atexit_destructor_for__kSceneLayerDefaultID__ @ 0x1800F27A0
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::_dynamic_atexit_destructor_for__kSceneLayerDefaultID__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::kSceneLayerDefaultID);
