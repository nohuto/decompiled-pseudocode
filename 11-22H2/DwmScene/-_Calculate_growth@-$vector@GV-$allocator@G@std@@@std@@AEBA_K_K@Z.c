/*
 * XREFs of ?_Calculate_growth@?$vector@GV?$allocator@G@std@@@std@@AEBA_K_K@Z @ 0x18008D4D0
 * Callers:
...
__int64 __fastcall std::vector<unsigned short>::_Calculate_growth(_QWORD *a1, unsigned __int64 a2)
{
  __int64 result; // rax
