/*
 * XREFs of ??$As@UIDXGIResource1@@@?$ComPtr@UID3D11Resource@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIDXGIResource1@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800D8A10
 * Callers:
...
__int64 __fastcall Microsoft::WRL::ComPtr<ID3D11Resource>::As<IDXGIResource1>(
        ...
        __int64 *a2)
{
  ...
  return v4(v3, &GUID_30961379_4609_4a41_998e_54fe567ee0c1, a2);
}
