/*
 * XREFs of ?GetMaxSupportedFeatureLevelString@RenderDevice@Engine@Spectre@@QEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@XZ @ 0x1800265F0
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::RenderDevice::GetMaxSupportedFeatureLevelString(__int64 a1, _QWORD *a2)
{
  std::wstring::wstring(a2, a1 + 176);
  return a2;
}
