/*
 * XREFs of ??$CalculateIndexedTangentsAndNormals@I@Framework@Spectre@@YAXQEBUVector3@Math@Utils@1@IQEBIIQEBUVector2@341@W4TriangularMeshTopology@GeometryUtils@01@AEBV?$shared_ptr@VICancellationToken@Utils@Spectre@@@std@@QEAU2341@55@Z @ 0x1800E1840
 * Callers:
...
void __fastcall Spectre::Framework::CalculateIndexedTangentsAndNormals<unsigned int>(
        Spectre *this,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        struct Spectre::Utils::Math::Vector3 *a10)
{
  ...
  char v21; // di
  struct Spectre::Utils::Math::Vector3 *v22; // [rsp+30h] [rbp-E8h]
  ...
  while ( (unsigned int)v15 < v17 )
  {
    ...
    {
      std::string::string(v26, (__int64)"Index out of range while computing tangents and normals");
    ...
    Spectre::CalculateTriangleNormal(
      this,
      (const struct Spectre::Utils::Math::Vector3 *)(unsigned int)v23,
      v19,
      v20,
      v21,
      a8,
      v22);
    v15 = (unsigned int)(HIDWORD(v23) + v15);
    ++v16;
    a3 = v25;
    v13 = a7;
  }
