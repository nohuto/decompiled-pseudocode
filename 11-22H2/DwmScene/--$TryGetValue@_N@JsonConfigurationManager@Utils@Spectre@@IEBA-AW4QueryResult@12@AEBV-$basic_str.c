/*
 * XREFs of ??$TryGetValue@_N@JsonConfigurationManager@Utils@Spectre@@IEBA?AW4QueryResult@12@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@AEA_N@Z @ 0x1800DD288
 * Callers:
 ...
 *     ?GetBool@JsonConfigurationManager@Utils@Spectre@@UEBA_NAEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@_N@Z @ 0x1800DE6A0 (-GetBool@JsonConfigurationManager@Utils@Spectre@@UEBA_NAEBV-$basic_string@_WU-$char_traits@_W@st.c)
 *     ?TryGetBool@JsonConfigurationManager@Utils@Spectre@@UEBA?AW4QueryResult@23@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@AEA_N@Z @ 0x1800DF090 (-TryGetBool@JsonConfigurationManager@Utils@Spectre@@UEBA-AW4QueryResult@23@AEBV-$basic_string@_W.c)
 * Callees:
...
__int64 __fastcall Spectre::Utils::JsonConfigurationManager::TryGetValue<bool>(__int64 a1, wchar_t *a2, bool *a3)
{
  ...
  if ( Spectre::Utils::ConfigurationValue::HasKey(v8, v9) )
  {
    ...
    if ( Spectre::Utils::ConfigurationValue::IsObject(Content) )
    {
      ...
      if ( Spectre::Utils::ConfigurationValue::HasKey(Content, v14) )
      {
        ...
        if ( Spectre::Utils::JsonConfigurationManager::IsJsonType<bool>(v16) )
        {
          *a3 = Spectre::Utils::JsonConfigurationManager::GetJsonValue<bool>(v17);
          std::wstring::_Tidy_deallocate((__int64)v23);
LABEL_20:
          v10 = 0;
          goto LABEL_21;
    ...
    else if ( Spectre::Utils::JsonConfigurationManager::IsJsonType<bool>(v13) )
    {
      *a3 = *((_BYTE *)Content + 60);
      goto LABEL_20;
    }
  ...
  if ( v19 )
  {
    v10 = Spectre::Utils::JsonConfigurationManager::TryGetValue<bool>(v19, a2, a3);
    if ( v20 )
