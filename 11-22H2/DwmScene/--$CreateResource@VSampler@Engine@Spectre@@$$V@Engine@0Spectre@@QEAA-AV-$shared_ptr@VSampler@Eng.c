/*
 * XREFs of ??$CreateResource@VSampler@Engine@Spectre@@$$V@Engine@0Spectre@@QEAA?AV?$shared_ptr@VSampler@Engine@Spectre@@@std@@W4ResourceDevicePolicy@01@@Z @ 0x1800160F8
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::Engine::CreateResource<Spectre::Engine::Sampler,>(__int64 a1, _QWORD *a2)
{
  ...
  std::make_shared<Spectre::Engine::Sampler,>(a2);
