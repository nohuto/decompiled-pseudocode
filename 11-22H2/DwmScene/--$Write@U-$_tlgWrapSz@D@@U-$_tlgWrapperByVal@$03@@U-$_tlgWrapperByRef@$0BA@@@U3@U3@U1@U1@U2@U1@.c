        ...
        const wchar_t **a25)
{
  ...
  const wchar_t *v46; // [rsp+50h] [rbp-B0h]
  ...
  const wchar_t *v68; // [rsp+E0h] [rbp-20h]
  ...
  const wchar_t *v91; // [rsp+190h] [rbp+90h]
  ...
  v47 = v43;
  v48 = 0;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1801C81C0, a2, 0LL, 0LL, 0x17u, &v45);
}
