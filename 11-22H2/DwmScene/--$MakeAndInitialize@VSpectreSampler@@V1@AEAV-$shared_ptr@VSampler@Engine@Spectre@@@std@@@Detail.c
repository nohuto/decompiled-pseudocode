/*
 * XREFs of ??$MakeAndInitialize@VSpectreSampler@@V1@AEAV?$shared_ptr@VSampler@Engine@Spectre@@@std@@@Details@WRL@Microsoft@@YAJPEAPEAVSpectreSampler@@AEAV?$shared_ptr@VSampler@Engine@Spectre@@@std@@@Z @ 0x180016800
 * Callers:
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    *(_QWORD *)v4 = &ISpectreSampler::`vftable';
    v4[3] = 1;
    *(_QWORD *)v4 = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<2>,ISpectreSampler>::`vftable';
    if ( Microsoft::WRL::Details::ModuleBase::module_ )
      (*(void (__fastcall **)(struct Microsoft::WRL::Details::ModuleBase *))(*(_QWORD *)Microsoft::WRL::Details::ModuleBase::module_
                                                                           + 8LL))(Microsoft::WRL::Details::ModuleBase::module_);
    *v5 = &SpectreSampler::`vftable';
    v5[2] = 0LL;
    v5[3] = 0LL;
    v8 = v5;
    v9 = 0LL;
