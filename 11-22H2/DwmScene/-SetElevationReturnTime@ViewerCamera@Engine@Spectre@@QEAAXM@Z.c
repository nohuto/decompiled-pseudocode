/*
 * XREFs of ?SetElevationReturnTime@ViewerCamera@Engine@Spectre@@QEAAXM@Z @ 0x180092FD8
 * Callers:
...
void __fastcall Spectre::Engine::ViewerCamera::SetElevationReturnTime(Spectre::Engine::ViewerCamera *this, float a2)
{
  *((float *)this + 462) = a2;
}
