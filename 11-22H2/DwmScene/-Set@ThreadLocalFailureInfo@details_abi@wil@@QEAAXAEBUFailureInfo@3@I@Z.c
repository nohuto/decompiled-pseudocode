/*
 * XREFs of ?Set@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEBUFailureInfo@3@I@Z @ 0x18000F12C
 * Callers:
        ...
        int a3)
{
  ...
  *((_QWORD *)this + 7) = 0LL;
  *((_QWORD *)this + 6) = v7;
  v8 = wil::details::ResultStringSize(*((wil::details **)a2 + 3), (const wchar_t *)a2);
  ...
  if ( v17 )
  {
    ...
    v20 = wil::details::WriteResultString<char const *>(v19, v18, *((wil::details **)a2 + 16), (char **)this + 4);
    v21 = wil::details::WriteResultString<wchar_t const *>(
            (wchar_t *)v20,
            (const wchar_t *)v18,
            *((wil::details **)a2 + 3),
            v3);
