/*
 * XREFs of ??$AddComponent@VShadowMapCamera@Engine@Spectre@@@SceneNode@Engine@Spectre@@QEAA?AV?$shared_ptr@VShadowMapCamera@Engine@Spectre@@@std@@XZ @ 0x180061B88
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::SceneNode::AddComponent<Spectre::Engine::ShadowMapCamera>(
        ...
        _QWORD *a2)
{
  ...
  v4 = *(_QWORD *)Spectre::Engine::SceneNode::GetComponent<Spectre::Engine::ShadowMapCamera>(this, &v9);
  if ( v10 )
  ...
  else
  {
    ...
    if ( v5 )
    {
      *(_OWORD *)v5 = 0LL;
      v5[2] = 1;
      v5[3] = 1;
      *(_QWORD *)v5 = &std::_Ref_count_obj2<Spectre::Engine::ShadowMapCamera>::`vftable';
      Spectre::Engine::ShadowMapCamera::ShadowMapCamera((Spectre::Engine::Camera *)(v5 + 4));
    }
    else
    {
      v6 = 0LL;
