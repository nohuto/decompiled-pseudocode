/*
 * XREFs of ??$AddComponent@VViewerCamera@Engine@Spectre@@@SceneNode@Engine@Spectre@@QEAA?AV?$shared_ptr@VViewerCamera@Engine@Spectre@@@std@@XZ @ 0x180061CA8
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::SceneNode::AddComponent<Spectre::Engine::ViewerCamera>(
        ...
        _QWORD *a2)
{
  ...
  v4 = *(_QWORD *)Spectre::Engine::SceneNode::GetComponent<Spectre::Engine::ViewerCamera>(this, &v8);
  if ( v9 )
  ...
  else
  {
    ...
    std::make_shared<Spectre::Engine::ViewerCamera,std::shared_ptr<Spectre::Engine::SceneNode>>(v7, v5);
    if ( v9 )
      std::_Ref_count_base::_Decref(v9);
