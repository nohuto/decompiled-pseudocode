/*
 * XREFs of ?CreateInternal@VertexBufferD3D11@D3D11@Engine@Spectre@@MEAAXPEBX@Z @ 0x1800D3710
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::D3D11::VertexBufferD3D11::CreateInternal(
        ...
        const void *a2)
{
  ...
  v6 = (__int64 *)Spectre::Engine::D3D11::D3DBufferUtils::CreateBuffer(&v9, v4, v7, v5, a2, 1);
