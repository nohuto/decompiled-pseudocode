/*
 * XREFs of ??$make_shared@VBackgroundUnlitShaderExtension@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VBackgroundUnlitShaderExtension@Engine@Spectre@@@0@XZ @ 0x180030084
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::BackgroundUnlitShaderExtension,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rbx
  _DWORD *v4; // rax
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::BackgroundUnlitShaderExtension>::`vftable';
    Spectre::Engine::BackgroundUnlitShaderExtension::BackgroundUnlitShaderExtension((Spectre::Engine::BackgroundUnlitShaderExtension *)(v2 + 4));
  }
  else
  {
    v3 = 0LL;
