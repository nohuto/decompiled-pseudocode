/*
 * XREFs of ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x18000FCBC
 * Callers:
 ...
 * Callees:
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x18000FC20 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
