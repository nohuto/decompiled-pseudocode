/*
 * XREFs of ??$CreateResource@VDeviceShaderPipeline@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VDeviceShaderPipeline@Engine@Spectre@@@std@@XZ @ 0x180085F04
 * Callers:
...
__int64 *__fastcall Spectre::Engine::RenderDevice::CreateResource<Spectre::Engine::DeviceShaderPipeline>(
        __int64 a1,
        __int64 *a2)
{
  __int64 v4; // rbx
  ...
  Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceShaderPipeline>(a1 + 496);
  v4 = *a2;
