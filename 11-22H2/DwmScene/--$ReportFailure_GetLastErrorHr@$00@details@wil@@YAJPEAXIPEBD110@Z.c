/*
 * XREFs of ??$ReportFailure_GetLastErrorHr@$00@details@wil@@YAJPEAXIPEBD110@Z @ 0x18000CBC8
 * Callers:
        ...
        const char *a6)
{
  ...
  v19 = v17;
  v18 = v16;
  wil::details::ReportFailure_Base<1,0>(v7, v6, (int)"wil", v11, v14, (__int64)a6, (int)&v18);
  return v10;
}
