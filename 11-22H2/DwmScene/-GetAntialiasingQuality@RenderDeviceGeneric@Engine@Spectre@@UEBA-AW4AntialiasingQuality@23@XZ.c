/*
 * XREFs of ?GetAntialiasingQuality@RenderDeviceGeneric@Engine@Spectre@@UEBA?AW4AntialiasingQuality@23@XZ @ 0x1800531D0
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::RenderDeviceGeneric::GetAntialiasingQuality()
{
  unsigned int v0; // eax
  int v1; // r8d
