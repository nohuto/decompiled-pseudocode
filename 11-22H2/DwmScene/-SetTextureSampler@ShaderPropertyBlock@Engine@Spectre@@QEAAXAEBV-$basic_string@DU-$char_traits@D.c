/*
 * XREFs of ?SetTextureSampler@ShaderPropertyBlock@Engine@Spectre@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$shared_ptr@VSampler@Engine@Spectre@@@5@@Z @ 0x1800857F0
 * Callers:
...
void __fastcall Spectre::Engine::ShaderPropertyBlock::SetTextureSampler(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  unsigned __int16 Property; // ax
  std::_Ref_count_base *v6; // rcx
  _QWORD v7[3]; // [rsp+20h] [rbp-18h] BYREF

  Property = Spectre::Engine::ShaderPropertyLayout::FindProperty(*(_QWORD *)(a1 + 16), a2);
  v7[0] = *a3;
  v7[1] = a3[1];
  *a3 = 0LL;
  a3[1] = 0LL;
  Spectre::Engine::ShaderPropertyBlock::SetTextureSampler(a1, Property, v7);
