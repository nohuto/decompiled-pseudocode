/*
 * XREFs of ??$dynamic_pointer_cast@VCommandList@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VCommandList@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x180025158
 * Callers:
...
__int64 *__fastcall std::dynamic_pointer_cast<Spectre::Engine::CommandList,Spectre::Engine::RendererResource>(
        __int64 *a1,
        _QWORD *a2)
{
  __int64 v4; // rax
