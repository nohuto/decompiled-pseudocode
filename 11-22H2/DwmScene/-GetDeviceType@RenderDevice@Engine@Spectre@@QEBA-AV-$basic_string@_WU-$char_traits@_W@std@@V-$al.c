/*
 * XREFs of ?GetDeviceType@RenderDevice@Engine@Spectre@@QEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@XZ @ 0x180026570
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::RenderDevice::GetDeviceType(__int64 a1, _QWORD *a2)
{
  std::wstring::wstring(a2, a1 + 112);
  return a2;
}
