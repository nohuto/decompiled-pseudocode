/*
 * XREFs of ?_Copy_assign@?$_Tree@V?$_Tmap_traits@U?$pair@HV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@UVector4@Math@Utils@Spectre@@U?$less@U?$pair@HV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@@2@V?$allocator@U?$pair@$$CBU?$pair@HV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@std@@UVector4@Math@Utils@Spectre@@@std@@@2@$0A@@std@@@std@@AEAAXAEBV12@U?$integral_constant@_N$0A@@2@@Z @ 0x18005E74C
 * Callers:
...
__int64 __fastcall std::_Tree<std::_Tmap_traits<std::pair<int,std::string>,Spectre::Utils::Math::Vector4,std::less<std::pair<int,std::string>>,std::allocator<std::pair<std::pair<int,std::string> const,Spectre::Utils::Math::Vector4>>,0>>::_Copy_assign(
        __int64 *a1,
        _QWORD *a2,
        char a3)
{
  ...
  *v3 = v3;
  ...
  v6 = *a1;
  a1[1] = 0LL;
  *(_QWORD *)(*a1 + 8) = std::_Tree<std::_Tmap_traits<std::pair<int,std::string>,Spectre::Utils::Math::Vector4,std::less<std::pair<int,std::string>>,std::allocator<std::pair<std::pair<int,std::string> const,Spectre::Utils::Math::Vector4>>,0>>::_Copy_nodes<std::_Tree<std::_Tmap_traits<std::pair<int,std::string>,Spectre::Utils::Math::Vector4,std::less<std::pair<int,std::string>>,std::allocator<std::pair<std::pair<int,std::string> const,Spectre::Utils::Math::Vector4>>,0>>::_Copy_tag>(
                           a1,
                           *(_QWORD *)(*a2 + 8LL),
                           v6,
                           a3);
