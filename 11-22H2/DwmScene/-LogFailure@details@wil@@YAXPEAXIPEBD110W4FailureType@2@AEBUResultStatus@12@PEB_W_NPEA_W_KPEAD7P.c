/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@AEBUResultStatus@12@PEB_W_NPEA_W_KPEAD7PEAUFailureInfo@2@@Z @ 0x18000E764
 * Callers:
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x18000EDF4 (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x18000EE20 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x18000EE34 (-RecordLog@details@wil@@YAHJ@Z.c)
  ...
  *(_QWORD *)(a15 + 128) = ModuleName;
    ...
    && (*(_BYTE *)(a15 + 4) & 2) == 0 )
  {
    ...
    if ( !*(_WORD *)lpOutputString )
      wil::GetFailureLogString(lpOutputString, (wchar_t *)0x800, a15, v22);
