/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_2f7a86c028961b1be19ef61dc11d1eb9_@@V?$shared_ptr@VRendererResource@Engine@Spectre@@@std@@$$V@std@@EEAA?AV?$shared_ptr@VRendererResource@Engine@Spectre@@@2@XZ @ 0x180053CC0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::_Func_impl_no_alloc<_lambda_2f7a86c028961b1be19ef61dc11d1eb9_,std::shared_ptr<Spectre::Engine::RendererResource>,>::_Do_call(
        __int64 a1,
        _QWORD *a2)
{
  char *v3; // rax
  ...
  if ( v3 )
  {
    ...
    *(_QWORD *)v3 = &std::_Ref_count_obj2<Spectre::Engine::ConstantBufferGeneric>::`vftable';
    Spectre::Engine::ConstantBufferGeneric::ConstantBufferGeneric((Spectre::Engine::ConstantBufferGeneric *)(v3 + 16));
  }
  else
  {
    v4 = 0LL;
