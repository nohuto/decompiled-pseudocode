...
void __fastcall Spectre::Utils::TelemetryTraceLoggerWin::Import3DModelStart(
        ...
        const char *a6)
{
  ...
  const wchar_t *v24; // [rsp+80h] [rbp-80h] BYREF
