/*
 * XREFs of ?SetAntialiasingQuality@RenderDeviceGeneric@Engine@Spectre@@UEAAXW4AntialiasingQuality@23@@Z @ 0x180053910
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::RenderDeviceGeneric::SetAntialiasingQuality()
{
  unsigned int v0; // eax
  int v1; // r8d
