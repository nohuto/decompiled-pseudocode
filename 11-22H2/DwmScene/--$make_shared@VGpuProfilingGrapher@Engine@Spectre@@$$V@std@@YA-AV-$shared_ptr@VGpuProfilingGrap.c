/*
 * XREFs of ??$make_shared@VGpuProfilingGrapher@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VGpuProfilingGrapher@Engine@Spectre@@@0@XZ @ 0x18002B1A8
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::GpuProfilingGrapher,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rbx
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::GpuProfilingGrapher>::`vftable';
    Spectre::Engine::GpuProfilingGrapher::GpuProfilingGrapher((Spectre::Engine::GpuProfilingGrapher *)(v2 + 4));
  }
  else
  {
    v3 = 0LL;
