/*
 * XREFs of ??$_Set_ptr_rep_and_enable_shared@VMeshInstance@Engine@Spectre@@@?$shared_ptr@VMeshInstance@Engine@Spectre@@@std@@AEAAXQEAVMeshInstance@Engine@Spectre@@QEAV_Ref_count_base@1@@Z @ 0x180013F50
 * Callers:
...
void __fastcall std::shared_ptr<Spectre::Engine::MeshInstance>::_Set_ptr_rep_and_enable_shared<Spectre::Engine::MeshInstance>(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
