/*
 * XREFs of ?Evaluate@ColorTransform@Engine@Spectre@@QEBA?AUColor@Math@Utils@3@U4563@@Z @ 0x18008FADC
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_e4386f35b8603616d8ddd0087d6df351__Spectre::Utils::Math::Color_Spectre::Utils::Math::Color_::_Do_call @ 0x180091310 (std--_Func_impl_no_alloc__lambda_e4386f35b8603616d8ddd0087d6df351__Spectre--Utils--_ea_180091310.c)
 * Callees:
...
__m128 *__fastcall Spectre::Engine::ColorTransform::Evaluate(__int64 a1, __m128 *a2, __m128 *a3)
{
  __m128 v3; // xmm1
  int v4; // r15d
  char *v5; // rbx
  ...
  __m128 X; // [rsp+50h] [rbp-30h] BYREF
  ...
  *(_QWORD *)v22 = 0LL;
  v25[2] = 2;
  *a3 = _mm_mul_ps(
          _mm_min_ps(_mm_max_ps(v3, DirectX::g_XMZero), DirectX::g_XMOne),
  ...
  v13 = v4 * HIDWORD(v23);
  *a2 = (__m128)Spectre::Utils::Math::Color::Black;
  ...
  do
  {
    ...
    Spectre::Engine::ColorTransform::SampleArray(
      a1,
      &X,
      (v15 & 1) + ((v15 & 4) != 0 ? v4 * v4 : 0) + v14 + ((v15 & 2) != 0 ? v4 : 0));
    v15 = v18 + 1;
    v16.m128_f32[0] = (float)(v16.m128_f32[0] * v19) * v17;
    *a2 = _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(v16, v16, 0), X), *a2);
  }
  while ( v15 < 8 );
  return a2;
}
