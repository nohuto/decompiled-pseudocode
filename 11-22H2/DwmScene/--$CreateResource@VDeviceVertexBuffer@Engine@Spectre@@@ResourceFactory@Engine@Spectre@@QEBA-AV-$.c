/*
 * XREFs of ??$CreateResource@VDeviceVertexBuffer@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDeviceVertexBuffer@Engine@Spectre@@@std@@XZ @ 0x1800890AC
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VDeviceVertexBuffer@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceVertexBuffer@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x180089174 (--$dynamic_pointer_cast@VDeviceVertexBuffer@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$sh.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceVertexBuffer>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C9518);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::DeviceVertexBuffer,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
