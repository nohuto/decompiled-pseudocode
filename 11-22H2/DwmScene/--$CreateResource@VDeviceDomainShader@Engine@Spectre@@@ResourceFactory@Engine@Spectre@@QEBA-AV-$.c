/*
 * XREFs of ??$CreateResource@VDeviceDomainShader@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDeviceDomainShader@Engine@Spectre@@@std@@XZ @ 0x180089BF4
 * Callers:
 *     ??$CreateResource@VDeviceDomainShader@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VDeviceDomainShader@Engine@Spectre@@@std@@XZ @ 0x180089B7C (--$CreateResource@VDeviceDomainShader@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA-AV-$sha.c)
 * Callees:
 ...
 *     ??$dynamic_pointer_cast@VDeviceDomainShader@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceDomainShader@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x18008A554 (--$dynamic_pointer_cast@VDeviceDomainShader@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$sh.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceDomainShader>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C9C30);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::DeviceDomainShader,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
