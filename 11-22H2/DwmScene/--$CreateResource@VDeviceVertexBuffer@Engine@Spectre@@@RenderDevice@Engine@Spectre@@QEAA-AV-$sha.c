/*
 * XREFs of ??$CreateResource@VDeviceVertexBuffer@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VDeviceVertexBuffer@Engine@Spectre@@@std@@XZ @ 0x180089034
 * Callers:
...
__int64 *__fastcall Spectre::Engine::RenderDevice::CreateResource<Spectre::Engine::DeviceVertexBuffer>(
        __int64 a1,
        __int64 *a2)
{
  __int64 v4; // rbx
  ...
  Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceVertexBuffer>(a1 + 496);
  v4 = *a2;
