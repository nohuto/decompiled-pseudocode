/*
 * XREFs of ??$CreateResource@VDeviceConstantBuffer@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDeviceConstantBuffer@Engine@Spectre@@@std@@XZ @ 0x180083CE8
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VDeviceConstantBuffer@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceConstantBuffer@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x1800842E0 (--$dynamic_pointer_cast@VDeviceConstantBuffer@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceConstantBuffer>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C9630);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::DeviceConstantBuffer,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
