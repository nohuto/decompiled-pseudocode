/*
 * XREFs of ?AddTimeSpan@PerformanceLogger@Utils@Spectre@@QEBAXPEBDH00V?$time_point@Usteady_clock@chrono@std@@V?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@23@@chrono@std@@@Z @ 0x1800200DC
 * Callers:
...
__int64 __fastcall Spectre::Utils::PerformanceLogger::AddTimeSpan(
        _QWORD *a1,
        __int64 a2,
        int a3,
        __int64 a4,
