/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_8be67bcf9b5b289d242b19ff70747553_@@V?$shared_ptr@VRendererResource@Engine@Spectre@@@std@@$$V@std@@EEAA?AV?$shared_ptr@VRendererResource@Engine@Spectre@@@2@XZ @ 0x1800C8090
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::_Func_impl_no_alloc<_lambda_8be67bcf9b5b289d242b19ff70747553_,std::shared_ptr<Spectre::Engine::RendererResource>,>::_Do_call(
        __int64 a1,
        _QWORD *a2)
{
  char *v3; // rax
  ...
  if ( v3 )
  {
    ...
    *(_QWORD *)v3 = &std::_Ref_count_obj2<Spectre::Engine::D3D11::VertexLayoutD3D11>::`vftable';
    Spectre::Engine::D3D11::VertexLayoutD3D11::VertexLayoutD3D11((Spectre::Engine::D3D11::VertexLayoutD3D11 *)(v3 + 16));
  }
  else
  {
    v4 = 0LL;
