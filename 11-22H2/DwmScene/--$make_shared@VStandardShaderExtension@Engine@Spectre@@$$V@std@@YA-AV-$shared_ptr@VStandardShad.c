/*
 * XREFs of ??$make_shared@VStandardShaderExtension@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VStandardShaderExtension@Engine@Spectre@@@0@XZ @ 0x180030648
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::StandardShaderExtension,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rbx
  _DWORD *v4; // rax
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::StandardShaderExtension>::`vftable';
    Spectre::Engine::StandardShaderExtension::StandardShaderExtension((Spectre::Engine::StandardShaderExtension *)(v2 + 4));
  }
  else
  {
    v3 = 0LL;
