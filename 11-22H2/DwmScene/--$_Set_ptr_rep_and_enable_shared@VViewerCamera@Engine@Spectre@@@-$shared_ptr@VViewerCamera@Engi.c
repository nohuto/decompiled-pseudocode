/*
 * XREFs of ??$_Set_ptr_rep_and_enable_shared@VViewerCamera@Engine@Spectre@@@?$shared_ptr@VViewerCamera@Engine@Spectre@@@std@@AEAAXQEAVViewerCamera@Engine@Spectre@@QEAV_Ref_count_base@1@@Z @ 0x180062E10
 * Callers:
...
void __fastcall std::shared_ptr<Spectre::Engine::ViewerCamera>::_Set_ptr_rep_and_enable_shared<Spectre::Engine::ViewerCamera>(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
