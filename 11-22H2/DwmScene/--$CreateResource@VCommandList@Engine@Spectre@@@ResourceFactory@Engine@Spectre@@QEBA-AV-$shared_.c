/*
 * XREFs of ??$CreateResource@VCommandList@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VCommandList@Engine@Spectre@@@std@@XZ @ 0x180024748
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VCommandList@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VCommandList@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x180025158 (--$dynamic_pointer_cast@VCommandList@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$shared_pt.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::CommandList>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C8FD8);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::CommandList,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
