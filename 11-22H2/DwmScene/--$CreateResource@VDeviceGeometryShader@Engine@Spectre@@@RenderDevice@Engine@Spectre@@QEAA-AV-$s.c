/*
 * XREFs of ??$CreateResource@VDeviceGeometryShader@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VDeviceGeometryShader@Engine@Spectre@@@std@@XZ @ 0x180089CBC
 * Callers:
...
__int64 *__fastcall Spectre::Engine::RenderDevice::CreateResource<Spectre::Engine::DeviceGeometryShader>(
        __int64 a1,
        __int64 *a2)
{
  __int64 v4; // rbx
  ...
  Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceGeometryShader>(a1 + 496);
  v4 = *a2;
