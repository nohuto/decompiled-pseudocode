/*
 * XREFs of ?Transform@Vector3@Math@Utils@Spectre@@SA?AU1234@AEBU1234@AEBUMatrix@234@@Z @ 0x18003DCF4
 * Callers:
...
__int64 __fastcall Spectre::Utils::Math::Vector3::Transform(__int64 a1, unsigned __int64 *a2, __m128 *a3)
{
  __int64 result; // rax
  __m128 v4; // xmm3
  __m128 v5; // xmm4
