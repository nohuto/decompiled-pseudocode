/*
 * XREFs of ??$CreateResource@VGeometryShader@Engine@Spectre@@$$V@Engine@0Spectre@@QEAA?AV?$shared_ptr@VGeometryShader@Engine@Spectre@@@std@@W4ResourceDevicePolicy@01@@Z @ 0x18004D13C
 * Callers:
 *     ??$CreateResource@VGeometryShader@Engine@Spectre@@$$V@Engine@0Spectre@@QEAA?AV?$shared_ptr@VGeometryShader@Engine@Spectre@@@std@@XZ @ 0x18004D1F0 (--$CreateResource@VGeometryShader@Engine@Spectre@@$$V@Engine@0Spectre@@QEAA-AV-$sha_ea_18004D1F0.c)
 * Callees:
...
__int64 __fastcall Spectre::Engine::Engine::CreateResource<Spectre::Engine::GeometryShader,>(__int64 *a1, __int64 a2)
{
  volatile signed __int32 *v4; // rdx
  std::_Ref_count_base *v6[2]; // [rsp+28h] [rbp-30h] BYREF
  _BYTE v7[32]; // [rsp+38h] [rbp-20h] BYREF

  std::make_shared<Spectre::Engine::GeometryShader,>(a2);
