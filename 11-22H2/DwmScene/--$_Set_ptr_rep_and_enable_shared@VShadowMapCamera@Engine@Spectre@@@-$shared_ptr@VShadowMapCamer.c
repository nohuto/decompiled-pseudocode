/*
 * XREFs of ??$_Set_ptr_rep_and_enable_shared@VShadowMapCamera@Engine@Spectre@@@?$shared_ptr@VShadowMapCamera@Engine@Spectre@@@std@@AEAAXQEAVShadowMapCamera@Engine@Spectre@@QEAV_Ref_count_base@1@@Z @ 0x180062D9C
 * Callers:
...
void __fastcall std::shared_ptr<Spectre::Engine::ShadowMapCamera>::_Set_ptr_rep_and_enable_shared<Spectre::Engine::ShadowMapCamera>(
        _QWORD *a1,
        __int64 a2,
        __int64 a3)
{
