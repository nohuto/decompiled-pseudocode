/*
 * XREFs of ?SetColours@Mesh@Engine@Spectre@@QEAAXQEBI@Z @ 0x1800490B0
 * Callers:
...
void __fastcall Spectre::Engine::Mesh::SetColours(Spectre::Engine::Mesh *this, const unsigned int *const a2)
{
  ...
  Spectre::Engine::Mesh::SetColoursInternal((Spectre::Engine::Mesh *)v3, v2, v3[30]);
}
