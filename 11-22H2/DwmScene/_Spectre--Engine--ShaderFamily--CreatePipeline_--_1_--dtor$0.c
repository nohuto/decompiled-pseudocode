/*
 * XREFs of _Spectre::Engine::ShaderFamily::CreatePipeline_::_1_::dtor$0 @ 0x1800E4B08
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::ShaderFamily::CreatePipeline_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 32) & 1) != 0 )
  {
    *(_DWORD *)(a2 + 32) &= ~1u;
