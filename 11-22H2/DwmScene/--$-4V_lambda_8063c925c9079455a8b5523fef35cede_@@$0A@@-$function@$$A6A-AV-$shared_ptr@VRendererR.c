/*
 * XREFs of ??$?4V_lambda_8063c925c9079455a8b5523fef35cede_@@$0A@@?$function@$$A6A?AV?$shared_ptr@VRendererResource@Engine@Spectre@@@std@@XZ@std@@QEAAAEAV01@$$QEAV_lambda_8063c925c9079455a8b5523fef35cede_@@@Z @ 0x1800C281C
 * Callers:
 ...
 *     ??$_Test_callable@V_lambda_8063c925c9079455a8b5523fef35cede_@@@std@@YA_NAEBV_lambda_8063c925c9079455a8b5523fef35cede_@@@Z @ 0x1800C3994 (--$_Test_callable@V_lambda_8063c925c9079455a8b5523fef35cede_@@@std@@YA_NAEBV_lambda_8063c925c907.c)
 */

__int64 __fastcall std::function<std::shared_ptr<Spectre::Engine::RendererResource> (void)>::operator=<_lambda_8063c925c9079455a8b5523fef35cede_,0>(
        __int64 a1)
{
  char v2; // al
  __int64 v3; // rdx
  ...
  v8 = 0LL;
  v2 = std::_Test_callable<_lambda_8063c925c9079455a8b5523fef35cede_>();
  if ( v2 )
  {
