/*
 * XREFs of _Spectre::CreateDisplay::Engine::CreateDisplay_::_1_::dtor$0 @ 0x1800E5A9D
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::CreateDisplay::Engine::CreateDisplay_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 40) & 1) != 0 )
  {
    *(_DWORD *)(a2 + 40) &= ~1u;
