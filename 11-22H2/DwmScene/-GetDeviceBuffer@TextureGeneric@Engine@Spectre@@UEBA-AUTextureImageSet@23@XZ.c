/*
 * XREFs of ?GetDeviceBuffer@TextureGeneric@Engine@Spectre@@UEBA?AUTextureImageSet@23@XZ @ 0x18008C7B0
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::TextureGeneric::GetDeviceBuffer()
{
  _QWORD *v0; // rax
  __int64 v1; // r8
