/*
 * XREFs of ?_Tidy@?$vector@UVector3@Math@Utils@Spectre@@V?$allocator@UVector3@Math@Utils@Spectre@@@std@@@std@@AEAAXXZ @ 0x180085D14
 * Callers:
 *     ??1?$vector@UVector3@Math@Utils@Spectre@@V?$allocator@UVector3@Math@Utils@Spectre@@@std@@@std@@QEAA@XZ @ 0x18008451C (--1-$vector@UVector3@Math@Utils@Spectre@@V-$allocator@UVector3@Math@Utils@Spectre@@@std@@@std@@Q.c)
...
void __fastcall std::vector<Spectre::Utils::Math::Vector3>::_Tidy(__int64 a1)
{
  void *v2; // rcx
