/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V_lambda_4751ef0567697aa51a05750371275a1e_@@V?$shared_ptr@VRendererResource@Engine@Spectre@@@std@@$$V@std@@EEAA?AV?$shared_ptr@VRendererResource@Engine@Spectre@@@2@XZ @ 0x1800C7C90
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::_Func_impl_no_alloc<_lambda_4751ef0567697aa51a05750371275a1e_,std::shared_ptr<Spectre::Engine::RendererResource>,>::_Do_call(
        __int64 a1,
        _QWORD *a2)
{
  char *v3; // rax
  ...
  if ( v3 )
  {
    *((_DWORD *)v3 + 2) = 1;
    *((_DWORD *)v3 + 3) = 1;
    *(_QWORD *)v3 = &std::_Ref_count_obj2<Spectre::Engine::D3D11::TextureD3D11>::`vftable';
    Spectre::Engine::D3D11::TextureD3D11::TextureD3D11((Spectre::Engine::D3D11::TextureD3D11 *)(v3 + 16));
  }
  else
  {
    v4 = 0LL;
