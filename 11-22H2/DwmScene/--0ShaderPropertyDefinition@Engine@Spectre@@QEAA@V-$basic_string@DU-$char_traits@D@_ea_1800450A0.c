/*
 * XREFs of ??0ShaderPropertyDefinition@Engine@Spectre@@QEAA@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@W4ShaderPropertyType@12@M@Z @ 0x1800450A0
 * Callers:
        ...
        float a4)
{
  ...
  *(_DWORD *)(a1 + 32) = 2;
  ...
  v9[0] = &v7;
  v9[1] = &v8;
  std::vector<float>::vector<float>((__int64 *)(a1 + 40), (__int64)v9, a3);
