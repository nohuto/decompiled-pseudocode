/*
 * XREFs of ??$AddComponent@VLight@Engine@Spectre@@@SceneNode@Engine@Spectre@@QEAA?AV?$shared_ptr@VLight@Engine@Spectre@@@std@@XZ @ 0x180011E04
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::SceneNode::AddComponent<Spectre::Engine::Light>(
        ...
        _QWORD *a2)
{
  ...
  v4 = *(_QWORD *)Spectre::Engine::SceneNode::GetComponent<Spectre::Engine::Light>(this, &v8);
  if ( v9 )
  ...
  else
  {
    ...
    std::make_shared<Spectre::Engine::Light,std::shared_ptr<Spectre::Engine::SceneNode>>(v7, v5);
    if ( v9 )
      std::_Ref_count_base::_Decref(v9);
