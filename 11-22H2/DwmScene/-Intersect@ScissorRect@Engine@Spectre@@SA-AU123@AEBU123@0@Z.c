/*
 * XREFs of ?Intersect@ScissorRect@Engine@Spectre@@SA?AU123@AEBU123@0@Z @ 0x18005BCDC
 * Callers:
...
_DWORD *__fastcall Spectre::Engine::ScissorRect::Intersect(_DWORD *a1, _DWORD *a2, _DWORD *a3)
{
  int v3; // edi
  int v6; // r9d
  _DWORD *v7; // rbx
