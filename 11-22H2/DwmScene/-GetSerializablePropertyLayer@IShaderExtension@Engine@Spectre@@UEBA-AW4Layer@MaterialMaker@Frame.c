/*
 * XREFs of ?GetSerializablePropertyLayer@IShaderExtension@Engine@Spectre@@UEBA?AW4Layer@MaterialMaker@Framework@3@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z @ 0x180060C90
 * Callers:
 *     <none>
 * Callees:
...
void __noreturn Spectre::Engine::IShaderExtension::GetSerializablePropertyLayer()
{
  unsigned int v0; // eax
  int v1; // r8d
