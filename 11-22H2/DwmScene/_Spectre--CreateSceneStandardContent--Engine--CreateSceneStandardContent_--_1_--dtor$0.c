/*
 * XREFs of _Spectre::CreateSceneStandardContent::Engine::CreateSceneStandardContent_::_1_::dtor$0 @ 0x1800E5ACA
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::CreateSceneStandardContent::Engine::CreateSceneStandardContent_::_1_::dtor_0(
        __int64 a1,
        __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 32) & 1) != 0 )
