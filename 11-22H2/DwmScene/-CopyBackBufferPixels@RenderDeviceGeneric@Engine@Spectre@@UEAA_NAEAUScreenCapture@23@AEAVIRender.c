/*
 * XREFs of ?CopyBackBufferPixels@RenderDeviceGeneric@Engine@Spectre@@UEAA_NAEAUScreenCapture@23@AEAVIRenderOutput@23@@Z @ 0x180052F80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn Spectre::Engine::RenderDeviceGeneric::CopyBackBufferPixels(
