/*
 * XREFs of ?TraceTimeSpan@ETWTraceProvider@Utils@Spectre@@UEAAXPEBDV?$time_point@Usteady_clock@chrono@std@@V?$duration@_JU?$ratio@$00$0DLJKMKAA@@std@@@23@@chrono@std@@100H@Z @ 0x180021500
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Spectre::Utils::ETWTraceProvider::TraceTimeSpan(
        __int64 a1,
        const wchar_t *a2,
        __int64 a3,
        __int64 a4,
