/*
 * XREFs of __scrt_fastfail @ 0x18000BAEC
 * Callers:
 ...
 *     __scrt_initialize_thread_safe_statics @ 0x18000C3F0 (__scrt_initialize_thread_safe_statics.c)
 * Callees:
 *     __crt_debugger_hook @ 0x18000BADC (__crt_debugger_hook.c)
