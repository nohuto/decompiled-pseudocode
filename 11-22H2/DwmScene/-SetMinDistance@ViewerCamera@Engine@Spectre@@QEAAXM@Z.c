/*
 * XREFs of ?SetMinDistance@ViewerCamera@Engine@Spectre@@QEAAXM@Z @ 0x1800930B4
 * Callers:
...
void __fastcall Spectre::Engine::ViewerCamera::SetMinDistance(Spectre::Engine::ViewerCamera *this, float a2)
{
  *((float *)this + 457) = a2;
}
