/*
 * XREFs of ?Clone@ViewerCamera@Engine@Spectre@@UEBA?AV?$shared_ptr@VComponent@Engine@Spectre@@@std@@AEBIV?$shared_ptr@VSceneNode@Engine@Spectre@@@5@@Z @ 0x180092260
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall Spectre::Engine::ViewerCamera::Clone(__int64 a1, _QWORD *a2, __int64 a3, _QWORD *a4)
{
  _QWORD *v8; // rax
  ...
  std::make_shared<Spectre::Engine::ViewerCamera,std::shared_ptr<Spectre::Engine::SceneNode> &>(v12, a4);
