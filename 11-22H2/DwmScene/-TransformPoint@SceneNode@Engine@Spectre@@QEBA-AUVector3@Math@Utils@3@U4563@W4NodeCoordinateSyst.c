/*
 * XREFs of ?TransformPoint@SceneNode@Engine@Spectre@@QEBA?AUVector3@Math@Utils@3@U4563@W4NodeCoordinateSystem@23@@Z @ 0x18003DDF4
 * Callers:
...
__int64 __fastcall Spectre::Engine::SceneNode::TransformPoint(__int64 a1, __int64 a2, unsigned __int64 *a3)
{
  ...
  v10[2] = v7;
  v10[3] = v8;
  Spectre::Utils::Math::Vector3::Transform(a2, a3, v10);
  return a2;
}
