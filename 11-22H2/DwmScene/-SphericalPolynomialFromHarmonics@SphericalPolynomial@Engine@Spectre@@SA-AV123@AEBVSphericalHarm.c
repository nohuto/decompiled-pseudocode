/*
 * XREFs of ?SphericalPolynomialFromHarmonics@SphericalPolynomial@Engine@Spectre@@SA?AV123@AEBVSphericalHarmonics@23@@Z @ 0x1800A3D90
 * Callers:
...
__int64 __fastcall Spectre::Engine::SphericalPolynomial::SphericalPolynomialFromHarmonics(
        Spectre::Engine::SphericalPolynomial *a1)
{
  __m128 *v1; // r8
  __m128 v2; // xmm2
  __m128 *v3; // rcx
  ...
  Spectre::Engine::SphericalPolynomial::SphericalPolynomial(a1);
  v2 = _mm_mul_ps(v1[3], (__m128)_xmm);
  ...
  v6 = _mm_add_ps(
         _mm_sub_ps(_mm_mul_ps((__m128)_xmm, *v1), _mm_mul_ps(v1[6], (__m128)_xmm)),
         _mm_mul_ps(v1[8], (__m128)_xmm));
  ...
  v7 = _mm_sub_ps(
         _mm_sub_ps(_mm_mul_ps((__m128)_xmm, *v1), _mm_mul_ps((__m128)_xmm, v1[6])),
         _mm_mul_ps(v1[8], (__m128)_xmm));
  ...
  v8 = _mm_add_ps(_mm_mul_ps((__m128)_xmm, v1[6]), _mm_mul_ps((__m128)_xmm, *v1));
  ...
  v9 = _mm_mul_ps(v1[5], (__m128)_xmm);
  ...
  v11 = _mm_mul_ps(v1[4], (__m128)_xmm);
  ...
  Spectre::Engine::SphericalPolynomial::Scale(v3, COERCE_DOUBLE((unsigned __int64)LODWORD(FLOAT_0_31830987)));
  return v12;
}
