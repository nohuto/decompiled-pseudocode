/*
 * XREFs of Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kLighting_Light0_PositionY__ @ 0x1800F4960
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::ConfigurationProperties::_dynamic_atexit_destructor_for__kLighting_Light0_PositionY__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::ConfigurationProperties::kLighting_Light0_PositionY);
