/*
 * XREFs of ?SetDefaultElevation@ViewerCamera@Engine@Spectre@@QEAAXM@Z @ 0x180092F70
 * Callers:
...
void __fastcall Spectre::Engine::ViewerCamera::SetDefaultElevation(Spectre::Engine::ViewerCamera *this, float a2)
{
  *((float *)this + 460) = a2;
}
