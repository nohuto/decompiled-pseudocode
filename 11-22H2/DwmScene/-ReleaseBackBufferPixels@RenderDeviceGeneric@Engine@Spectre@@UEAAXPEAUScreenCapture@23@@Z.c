/*
 * XREFs of ?ReleaseBackBufferPixels@RenderDeviceGeneric@Engine@Spectre@@UEAAXPEAUScreenCapture@23@@Z @ 0x1800538A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn Spectre::Engine::RenderDeviceGeneric::ReleaseBackBufferPixels(
