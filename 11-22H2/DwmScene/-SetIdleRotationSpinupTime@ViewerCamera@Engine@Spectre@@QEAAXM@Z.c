/*
 * XREFs of ?SetIdleRotationSpinupTime@ViewerCamera@Engine@Spectre@@QEAAXM@Z @ 0x180093084
 * Callers:
...
void __fastcall Spectre::Engine::ViewerCamera::SetIdleRotationSpinupTime(Spectre::Engine::ViewerCamera *this, float a2)
{
  *((float *)this + 465) = a2;
}
