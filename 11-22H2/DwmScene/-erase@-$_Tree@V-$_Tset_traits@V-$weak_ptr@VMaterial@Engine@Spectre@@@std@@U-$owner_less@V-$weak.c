/*
 * XREFs of ?erase@?$_Tree@V?$_Tset_traits@V?$weak_ptr@VMaterial@Engine@Spectre@@@std@@U?$owner_less@V?$weak_ptr@VMaterial@Engine@Spectre@@@std@@@2@V?$allocator@V?$weak_ptr@VMaterial@Engine@Spectre@@@std@@@2@$0A@@std@@@std@@QEAA_KAEBV?$weak_ptr@VMaterial@Engine@Spectre@@@2@@Z @ 0x180061528
 * Callers:
...
__int64 __fastcall std::_Tree<std::_Tset_traits<std::weak_ptr<Spectre::Engine::Material>,std::owner_less<std::weak_ptr<Spectre::Engine::Material>>,std::allocator<std::weak_ptr<Spectre::Engine::Material>>,0>>::erase(
        __int64 *a1,
        __int64 a2)
{
  __int64 v2; // rdi
  ...
  else
  {
    while ( v4 != v5 )
    {
      ...
      std::_Tree_node<std::weak_ptr<Spectre::Engine::Material>,void *>::_Freenode<std::allocator<std::_Tree_node<std::weak_ptr<Spectre::Engine::Material>,void *>>>(
        v14,
        v13);
      v4 = v15;
    }
