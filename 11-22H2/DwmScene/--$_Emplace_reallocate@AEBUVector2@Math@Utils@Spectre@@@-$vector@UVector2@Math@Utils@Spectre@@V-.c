/*
 * XREFs of ??$_Emplace_reallocate@AEBUVector2@Math@Utils@Spectre@@@?$vector@UVector2@Math@Utils@Spectre@@V?$allocator@UVector2@Math@Utils@Spectre@@@std@@@std@@QEAAPEAUVector2@Math@Utils@Spectre@@QEAU2345@AEBU2345@@Z @ 0x18008C8D8
 * Callers:
...
char *__fastcall std::vector<Spectre::Utils::Math::Vector2>::_Emplace_reallocate<Spectre::Utils::Math::Vector2 const &>(
        char **a1,
        char *a2,
        _QWORD *a3)
{
