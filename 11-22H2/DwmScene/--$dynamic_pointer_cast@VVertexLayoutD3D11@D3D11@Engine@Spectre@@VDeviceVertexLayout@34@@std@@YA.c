/*
 * XREFs of ??$dynamic_pointer_cast@VVertexLayoutD3D11@D3D11@Engine@Spectre@@VDeviceVertexLayout@34@@std@@YA?AV?$shared_ptr@VVertexLayoutD3D11@D3D11@Engine@Spectre@@@0@AEBV?$shared_ptr@VDeviceVertexLayout@Engine@Spectre@@@0@@Z @ 0x1800CF8DC
 * Callers:
...
__int64 *__fastcall std::dynamic_pointer_cast<Spectre::Engine::D3D11::VertexLayoutD3D11,Spectre::Engine::DeviceVertexLayout>(
        __int64 *a1,
        _QWORD *a2)
{
  __int64 v4; // rax
