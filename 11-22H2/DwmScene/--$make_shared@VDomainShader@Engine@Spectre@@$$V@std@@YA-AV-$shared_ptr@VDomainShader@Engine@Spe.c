/*
 * XREFs of ??$make_shared@VDomainShader@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VDomainShader@Engine@Spectre@@@0@XZ @ 0x18004DED8
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::DomainShader,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rdi
  __int64 v4; // rcx
  ...
  if ( v2 )
  {
    *(_OWORD *)v2 = 0LL;
    v2[2] = 1;
    v2[3] = 1;
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::DomainShader>::`vftable';
    Spectre::Engine::Shader::Shader(v2 + 4, 3LL);
