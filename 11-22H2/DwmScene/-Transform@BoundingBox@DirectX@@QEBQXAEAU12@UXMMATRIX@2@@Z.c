/*
 * XREFs of ?Transform@BoundingBox@DirectX@@QEBQXAEAU12@UXMMATRIX@2@@Z @ 0x1800420B0
 * Callers:
...
unsigned __int64 __fastcall DirectX::BoundingBox::Transform(unsigned __int64 *a1, __int64 a2, double a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm1
  __m128 v6; // xmm7
  ...
  v12 = _mm_add_ps(_mm_mul_ps(v11, *(__m128 *)&DirectX::g_BoxOffset), v9);
  v13 = _mm_add_ps(
          _mm_add_ps(
  ...
  do
  {
    v15 = _mm_mul_ps(v11, *(__m128 *)((char *)&DirectX::g_BoxOffset + result));
    result += 16LL;
  ...
  while ( result < 0x80 );
  v18 = v13;
  v19 = _mm_mul_ps(_mm_sub_ps(v13, v14), (__m128)_xmm);
  v20 = _mm_mul_ps(_mm_add_ps(v18, v14), (__m128)_xmm);
