/*
 * XREFs of ??$CreateResource@VDeviceTexture@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDeviceTexture@Engine@Spectre@@@std@@XZ @ 0x180015F5C
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VDeviceTexture@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceTexture@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x180017114 (--$dynamic_pointer_cast@VDeviceTexture@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$shared_.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceTexture>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C8F08);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::DeviceTexture,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
