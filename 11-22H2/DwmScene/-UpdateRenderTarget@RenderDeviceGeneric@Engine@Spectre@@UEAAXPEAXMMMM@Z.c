/*
 * XREFs of ?UpdateRenderTarget@RenderDeviceGeneric@Engine@Spectre@@UEAAXPEAXMMMM@Z @ 0x1800539F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn Spectre::Engine::RenderDeviceGeneric::UpdateRenderTarget(
        ...
        float a6)
{
  ...
  std::string::string(v9, (__int64)"Not implemented");
