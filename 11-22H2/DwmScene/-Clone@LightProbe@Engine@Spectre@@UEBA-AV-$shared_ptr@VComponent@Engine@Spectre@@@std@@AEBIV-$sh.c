/*
 * XREFs of ?Clone@LightProbe@Engine@Spectre@@UEBA?AV?$shared_ptr@VComponent@Engine@Spectre@@@std@@AEBIV?$shared_ptr@VSceneNode@Engine@Spectre@@@5@@Z @ 0x180051690
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall Spectre::Engine::LightProbe::Clone(__int64 a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  _DWORD *v8; // rax
  __int64 v9; // rbx
  _QWORD *v10; // rax
  ...
  if ( v8 )
  {
    ...
    *(_QWORD *)v8 = &std::_Ref_count_obj2<Spectre::Engine::LightProbe>::`vftable';
    Spectre::Engine::LightProbe::LightProbe((Spectre::Engine::Component *)(v8 + 4), a4);
  }
  else
  {
    v9 = 0LL;
