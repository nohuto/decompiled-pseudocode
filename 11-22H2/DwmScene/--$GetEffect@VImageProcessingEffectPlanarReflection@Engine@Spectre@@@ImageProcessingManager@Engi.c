/*
 * XREFs of ??$GetEffect@VImageProcessingEffectPlanarReflection@Engine@Spectre@@@ImageProcessingManager@Engine@Spectre@@QEBA?AV?$shared_ptr@VImageProcessingEffectPlanarReflection@Engine@Spectre@@@std@@XZ @ 0x1800629E0
 * Callers:
...
_QWORD *__fastcall Spectre::Engine::ImageProcessingManager::GetEffect<Spectre::Engine::ImageProcessingEffectPlanarReflection>(
        __int64 a1,
        _QWORD *a2)
{
  __int64 *v3; // rax
  ...
  v14 = &Spectre::Engine::ImageProcessingEffectPlanarReflection `RTTI Type Descriptor';
