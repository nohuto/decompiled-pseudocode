/*
 * XREFs of _Spectre::Engine::Mesh::ComputeNormalsAndTangents_::_1_::dtor$1 @ 0x1800E6ED0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Spectre::Engine::Mesh::ComputeNormalsAndTangents_::_1_::dtor_1(__int64 a1, __int64 a2)
{
