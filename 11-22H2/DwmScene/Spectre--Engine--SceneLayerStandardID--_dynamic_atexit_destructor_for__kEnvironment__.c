/*
 * XREFs of Spectre::Engine::SceneLayerStandardID::_dynamic_atexit_destructor_for__kEnvironment__ @ 0x1800F26E0
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::SceneLayerStandardID::_dynamic_atexit_destructor_for__kEnvironment__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::SceneLayerStandardID::kEnvironment);
