/*
 * XREFs of ??$CreateResource@VDeviceGeometryShader@Engine@Spectre@@@ResourceFactory@Engine@Spectre@@QEBA?AV?$shared_ptr@VDeviceGeometryShader@Engine@Spectre@@@std@@XZ @ 0x180089D34
 * Callers:
 ...
 *     ??$dynamic_pointer_cast@VDeviceGeometryShader@Engine@Spectre@@VRendererResource@23@@std@@YA?AV?$shared_ptr@VDeviceGeometryShader@Engine@Spectre@@@0@AEBV?$shared_ptr@VRendererResource@Engine@Spectre@@@0@@Z @ 0x18008A5BC (--$dynamic_pointer_cast@VDeviceGeometryShader@Engine@Spectre@@VRendererResource@23@@std@@YA-AV-$.c)
 */

_QWORD *__fastcall Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceGeometryShader>(
        __int64 *a1,
        _QWORD *a2)
{
  ...
  v9 = __std_type_info_hash(&qword_1801C9BB8);
  ...
  else
  {
    ...
    std::dynamic_pointer_cast<Spectre::Engine::DeviceGeometryShader,Spectre::Engine::RendererResource>(v6, v7);
    *a2 = v6[0];
    a2[1] = v6[1];
    if ( v8 )
