/*
 * XREFs of ??$TryGetValue@N@JsonConfigurationManager@Utils@Spectre@@IEBA?AW4QueryResult@12@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@AEAN@Z @ 0x1800DCEBC
 * Callers:
 ...
 *     ?GetDouble@JsonConfigurationManager@Utils@Spectre@@UEBANAEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@N@Z @ 0x1800DE6E0 (-GetDouble@JsonConfigurationManager@Utils@Spectre@@UEBANAEBV-$basic_string@_WU-$char_traits@_W@s.c)
 *     ?TryGetDouble@JsonConfigurationManager@Utils@Spectre@@UEBA?AW4QueryResult@23@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@AEAN@Z @ 0x1800DF0A0 (-TryGetDouble@JsonConfigurationManager@Utils@Spectre@@UEBA-AW4QueryResult@23@AEBV-$basic_string@.c)
 * Callees:
...
__int64 __fastcall Spectre::Utils::JsonConfigurationManager::TryGetValue<double>(__int64 a1, wchar_t *a2, double *a3)
{
  ...
  if ( Spectre::Utils::ConfigurationValue::HasKey(v8, v9) )
  {
    ...
    Content = (double *)Spectre::Utils::ConfigurationValue::GetContent(v8, v11);
    if ( Spectre::Utils::ConfigurationValue::IsObject((Spectre::Utils::ConfigurationValue *)Content) )
    {
      std::wstring::wstring(v23, (__int64)L"Value");
      v14 = (const wchar_t *)v23;
      if ( v23[3] >= (wchar_t *)8 )
        v14 = v23[0];
      if ( Spectre::Utils::ConfigurationValue::HasKey((Spectre::Utils::ConfigurationValue *)Content, v14) )
      {
        ...
        if ( Spectre::Utils::JsonConfigurationManager::IsJsonType<double>(v16) )
        {
          *a3 = Spectre::Utils::JsonConfigurationManager::GetJsonValue<double>(v17);
          std::wstring::_Tidy_deallocate((__int64)v23);
LABEL_20:
          v10 = 0;
          goto LABEL_21;
    ...
    else if ( Spectre::Utils::JsonConfigurationManager::IsJsonType<double>(v13) )
    {
      *a3 = Content[6];
      goto LABEL_20;
    }
  ...
  if ( v19 )
  {
    v10 = Spectre::Utils::JsonConfigurationManager::TryGetValue<double>(v19, a2, a3);
    if ( v20 )
