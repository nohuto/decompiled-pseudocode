/*
 * XREFs of Spectre::Engine::SceneLayerStandardID::_dynamic_atexit_destructor_for__kImageProcessing__ @ 0x1800F2740
 * Callers:
 *     <none>
 * Callees:
...
void Spectre::Engine::SceneLayerStandardID::_dynamic_atexit_destructor_for__kImageProcessing__()
{
  std::wstring::_Tidy_deallocate((__int64)&Spectre::Engine::SceneLayerStandardID::kImageProcessing);
