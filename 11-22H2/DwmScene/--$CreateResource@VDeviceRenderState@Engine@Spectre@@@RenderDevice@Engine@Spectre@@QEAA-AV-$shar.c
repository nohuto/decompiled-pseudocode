/*
 * XREFs of ??$CreateResource@VDeviceRenderState@Engine@Spectre@@@RenderDevice@Engine@Spectre@@QEAA?AV?$shared_ptr@VDeviceRenderState@Engine@Spectre@@@std@@XZ @ 0x180087EE4
 * Callers:
...
__int64 *__fastcall Spectre::Engine::RenderDevice::CreateResource<Spectre::Engine::DeviceRenderState>(
        __int64 a1,
        __int64 *a2)
{
  __int64 v4; // rbx
  ...
  Spectre::Engine::ResourceFactory::CreateResource<Spectre::Engine::DeviceRenderState>(a1 + 496);
  v4 = *a2;
