/*
 * XREFs of ??$MakeAndInitialize@VSpectreTexture@@V1@AEAV?$shared_ptr@VTexture@Engine@Spectre@@@std@@@Details@WRL@Microsoft@@YAJPEAPEAVSpectreTexture@@AEAV?$shared_ptr@VTexture@Engine@Spectre@@@std@@@Z @ 0x18001693C
 * Callers:
 ...
 *     ?RuntimeClassInitialize@SpectreTexture@@QEAAJAEBV?$shared_ptr@VTexture@Engine@Spectre@@@std@@@Z @ 0x18001B8CC (-RuntimeClassInitialize@SpectreTexture@@QEAAJAEBV-$shared_ptr@VTexture@Engine@Spectre@@@std@@@Z.c)
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    *(_QWORD *)v4 = &ISpectreTexture::`vftable';
    v4[3] = 1;
    *(_QWORD *)v4 = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<2>,ISpectreTexture>::`vftable';
    if ( Microsoft::WRL::Details::ModuleBase::module_ )
      (*(void (__fastcall **)(struct Microsoft::WRL::Details::ModuleBase *))(*(_QWORD *)Microsoft::WRL::Details::ModuleBase::module_
                                                                           + 8LL))(Microsoft::WRL::Details::ModuleBase::module_);
    *v5 = &SpectreTexture::`vftable';
    v5[2] = 0LL;
    v5[3] = 0LL;
    v8 = v5;
    v9 = 0LL;
    v6 = SpectreTexture::RuntimeClassInitialize(v5, a2);
    if ( v6 >= 0 )
    {
