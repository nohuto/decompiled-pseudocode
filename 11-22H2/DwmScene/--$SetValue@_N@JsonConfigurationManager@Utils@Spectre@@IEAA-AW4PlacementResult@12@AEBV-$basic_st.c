/*
 * XREFs of ??$SetValue@_N@JsonConfigurationManager@Utils@Spectre@@IEAA?AW4PlacementResult@12@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@_NW4LoadPolicy@IConfigurationManager@12@@Z @ 0x1800DCAC4
 * Callers:
 *     ?SetBool@JsonConfigurationManager@Utils@Spectre@@UEAA?AW4PlacementResult@23@AEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@_NW4LoadPolicy@IConfigurationManager@23@@Z @ 0x1800DEEC0 (-SetBool@JsonConfigurationManager@Utils@Spectre@@UEAA-AW4PlacementResult@23@AEBV-$basic_string@_.c)
 * Callees:
...
__int64 __fastcall Spectre::Utils::JsonConfigurationManager::SetValue<bool>(__int64 a1, wchar_t *a2, char a3, int a4)
{
  ...
  if ( Spectre::Utils::ConfigurationValue::HasKey((Spectre::Utils::ConfigurationValue *)(*(_QWORD *)v9 + 64LL), v11) )
  {
    ...
    else
    {
      ...
      if ( Spectre::Utils::ConfigurationValue::IsObject(Content) )
      {
        ...
        if ( Spectre::Utils::ConfigurationValue::HasKey(Content, v16)
          && (v17 = std::wstring::wstring(v25, (__int64)v27),
              ...
              Spectre::Utils::JsonConfigurationManager::IsJsonType<bool>(v18)) )
        {
          if ( Spectre::Utils::JsonConfigurationManager::GetJsonValue<bool>(v19) != a3 )
          {
            v20 = std::wstring::wstring(v25, (__int64)v27);
            Spectre::Utils::ConfigurationValue::SetValue<bool>((__int64)Content, v20, a3);
            v12 = 1;
          }
        }
        else
      ...
      else if ( Spectre::Utils::JsonConfigurationManager::IsJsonType<bool>(v15) )
      {
        if ( Spectre::Utils::JsonConfigurationManager::GetJsonValue<bool>(v21) != a3 )
        {
          v22 = std::wstring::wstring(v25, (__int64)a2);
          Spectre::Utils::ConfigurationValue::SetValue<bool>(v10, v22, a3);
          v12 = 1;
        }
      }
      else
  ...
  else if ( (unsigned int)(a4 - 1) <= 1 )
  {
    ...
    Spectre::Utils::ConfigurationValue::SetValue<bool>(v10, v23, a3);
    v12 = 0;
  }
  else
  {
