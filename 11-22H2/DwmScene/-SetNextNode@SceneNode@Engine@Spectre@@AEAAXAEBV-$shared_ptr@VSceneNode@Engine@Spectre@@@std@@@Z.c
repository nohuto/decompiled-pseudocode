/*
 * XREFs of ?SetNextNode@SceneNode@Engine@Spectre@@AEAAXAEBV?$shared_ptr@VSceneNode@Engine@Spectre@@@std@@@Z @ 0x18003D450
 * Callers:
...
__int64 *__fastcall Spectre::Engine::SceneNode::SetNextNode(__int64 *a1, _QWORD *a2)
{
  Spectre::Engine::SceneNode::VerifyWriteAccess((Spectre::Engine::SceneNode *)a1);
  return std::weak_ptr<Spectre::Engine::Scene>::operator=<Spectre::Engine::Scene>(a1 + 16, a2);
}
