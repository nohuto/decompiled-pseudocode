/*
 * XREFs of ??$make_shared@VUnlitShaderExtension@Engine@Spectre@@$$V@std@@YA?AV?$shared_ptr@VUnlitShaderExtension@Engine@Spectre@@@0@XZ @ 0x1800307E0
 * Callers:
...
_QWORD *__fastcall std::make_shared<Spectre::Engine::UnlitShaderExtension,>(_QWORD *a1)
{
  _DWORD *v2; // rax
  _DWORD *v3; // rbx
  _DWORD *v4; // rax
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)v2 = &std::_Ref_count_obj2<Spectre::Engine::UnlitShaderExtension>::`vftable';
    Spectre::Engine::UnlitShaderExtension::UnlitShaderExtension((Spectre::Engine::UnlitShaderExtension *)(v2 + 4));
  }
  else
  {
    v3 = 0LL;
