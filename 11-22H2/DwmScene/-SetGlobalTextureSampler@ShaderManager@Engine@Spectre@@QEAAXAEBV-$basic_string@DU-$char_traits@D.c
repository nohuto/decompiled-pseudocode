/*
 * XREFs of ?SetGlobalTextureSampler@ShaderManager@Engine@Spectre@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEBV?$shared_ptr@VSampler@Engine@Spectre@@@5@@Z @ 0x18005079C
 * Callers:
...
__int64 __fastcall Spectre::Engine::ShaderManager::SetGlobalTextureSampler(__int64 a1, __int64 a2, _QWORD *a3)
{
  _QWORD *v3; // rax
  __int64 v4; // r9
  __int64 v5; // r10
