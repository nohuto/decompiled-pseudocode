/*
 * XREFs of ?HasSharedLock@Lockable@Engine@Spectre@@QEBA_NXZ @ 0x18002A2B4
 * Callers:
...
bool __fastcall Spectre::Engine::Lockable::HasSharedLock(Spectre::Engine::Lockable *this)
{
  return Spectre::Engine::Mutex::this_thread_owns(this, 0);
}
