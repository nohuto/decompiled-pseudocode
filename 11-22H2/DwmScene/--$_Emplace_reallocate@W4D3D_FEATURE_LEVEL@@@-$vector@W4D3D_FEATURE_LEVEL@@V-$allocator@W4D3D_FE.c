/*
 * XREFs of ??$_Emplace_reallocate@W4D3D_FEATURE_LEVEL@@@?$vector@W4D3D_FEATURE_LEVEL@@V?$allocator@W4D3D_FEATURE_LEVEL@@@std@@@std@@QEAAPEAW4D3D_FEATURE_LEVEL@@QEAW42@$$QEAW42@@Z @ 0x1800DAD54
 * Callers:
...
char *__fastcall std::vector<enum D3D_FEATURE_LEVEL>::_Emplace_reallocate<enum D3D_FEATURE_LEVEL>(
        __int64 *a1,
        __int64 a2,
        _DWORD *a3)
{
