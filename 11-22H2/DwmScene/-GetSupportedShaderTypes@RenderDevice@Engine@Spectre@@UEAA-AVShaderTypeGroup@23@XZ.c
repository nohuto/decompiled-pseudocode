/*
 * XREFs of ?GetSupportedShaderTypes@RenderDevice@Engine@Spectre@@UEAA?AVShaderTypeGroup@23@XZ @ 0x180026950
 * Callers:
 *     <none>
 * Callees:
...
_DWORD *__fastcall Spectre::Engine::RenderDevice::GetSupportedShaderTypes(__int64 a1, _DWORD *a2)
{
  *a2 = 34;
