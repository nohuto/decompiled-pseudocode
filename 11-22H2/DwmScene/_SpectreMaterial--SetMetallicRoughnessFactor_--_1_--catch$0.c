/*
 * XREFs of _SpectreMaterial::SetMetallicRoughnessFactor_::_1_::catch$0 @ 0x1800E3EB6
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SpectreMaterial::SetMetallicRoughnessFactor_::_1_::catch_0(__int64 a1, __int64 a2)
{
