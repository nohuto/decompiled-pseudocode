/*
 * XREFs of ?Initialize@?$CLookAsideTypeIsolation@$0DGAAA@$0DGA@@NSInstrumentation@@QEAA_NXZ @ 0x1C008CA98
 * Callers:
...
char __fastcall NSInstrumentation::CLookAsideTypeIsolation<221184,864>::Initialize(__int64 a1)
{
  ...
  ExInitializeLookasideListEx(
    ...
    _lambda_52ccb54780299a4e07ee11c360aca89b_::_lambda_invoker_cdecl_<enum _POOL_TYPE,unsigned __int64,unsigned long,_LOOKASIDE_LIST_EX *>,
    _lambda_e7a726a5677ec7d6a7448e8985ca7462_::_lambda_invoker_cdecl_<void *,_LOOKASIDE_LIST_EX *>,
    (POOL_TYPE)512,
    2u,
    0x360uLL,
    0x616C6947u,
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 16) = v3;
    ...
    {
      *v3 = 0LL;
      v4 = (_QWORD *)NSInstrumentation::CSectionEntry<221184,864>::Create();
      if ( v4 )
      {
        v5 = *(_QWORD **)(a1 + 8);
        *(_DWORD *)(a1 + 32) = 216;
