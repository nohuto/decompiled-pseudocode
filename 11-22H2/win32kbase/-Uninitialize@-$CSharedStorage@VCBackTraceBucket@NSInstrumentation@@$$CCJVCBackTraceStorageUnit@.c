/*
 * XREFs of ?Uninitialize@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAAXXZ @ 0x1C0170234
 * Callers:
 ...
 * Callees:
 *     ??1CBackTraceBucket@NSInstrumentation@@QEAA@XZ @ 0x1C016FACC (--1CBackTraceBucket@NSInstrumentation@@QEAA@XZ.c)
 */
