/*
 * XREFs of ?ReleaseAllReferences@CLegacyMilBrushMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C021CE90
 * Callers:
 ...
 *     ?ReleaseAllReferences@CImageLegacyMilBrushMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C021CE10 (-ReleaseAllReferences@CImageLegacyMilBrushMarshaler@DirectComposition@@UEAAXPEAVCApplicationChan.c)
 *     ?ReleaseAllReferences@CSolidColorLegacyMilBrushMarshaler@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C021D3D0 (-ReleaseAllReferences@CSolidColorLegacyMilBrushMarshaler@DirectComposition@@UEAAXPEAVCApplicatio.c)
 * Callees:
