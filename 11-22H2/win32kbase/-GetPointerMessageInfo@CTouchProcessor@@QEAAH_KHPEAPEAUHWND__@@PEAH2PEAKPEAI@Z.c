/*
 * XREFs of ?GetPointerMessageInfo@CTouchProcessor@@QEAAH_KHPEAPEAUHWND__@@PEAH2PEAKPEAI@Z @ 0x1C01C9EF0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( NonConstMsgData )
  {
    ...
    if ( v20 )
    {
      if ( *((_DWORD *)NonConstMsgData + 8) >= *(_DWORD *)(v20 + 48) )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 4411);
      v22 = *(_QWORD *)(v21 + 240) + 480LL * *((unsigned int *)NonConstMsgData + 8);
      if ( !(unsigned int)CPointerInfoNode::IsValid((CPointerInfoNode *)v22) )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 4413);
      if ( *((_WORD *)NonConstMsgData + 8) != *(_WORD *)(v22 + 172) )
        MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 4414);
      v23 = v30;
      if ( v30 )
      {
