/*
 * XREFs of _anonymous_namespace_::UpdateKeyState @ 0x1C00A6F1C
 * Callers:
 *     UpdateKeyStateForMessage @ 0x1C00A6E40 (UpdateKeyStateForMessage.c)
 * Callees:
 *     _anonymous_namespace_::ApplyKeyStateToQueue @ 0x1C00A6FA4 (_anonymous_namespace_--ApplyKeyStateToQueue.c)
 */
