/*
 * XREFs of ?DestroyHandleSecondPass@@YAXPEAU_HANDLEENTRY@@@Z @ 0x1C01343E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DestroyHandleSecondPass(struct _HANDLEENTRY *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = 3LL * (unsigned int)((a1 - qword_1C028FE68) >> 5);
  if ( *(_DWORD *)(*((_QWORD *)gpKernelHandleTable + 3 * (unsigned int)((a1 - qword_1C028FE68) >> 5)) + 8LL) )
  {
