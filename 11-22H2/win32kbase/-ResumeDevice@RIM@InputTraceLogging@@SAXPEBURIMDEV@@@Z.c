/*
 * XREFs of ?ResumeDevice@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C0173008
 * Callers:
...
void __fastcall InputTraceLogging::RIM::ResumeDevice(const struct RIMDEV *a1)
{
  ...
  if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 256LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0289810, (unsigned __int8 *)dword_1C0257974, 0LL, 0LL, 3u, &v3);
  }
}
