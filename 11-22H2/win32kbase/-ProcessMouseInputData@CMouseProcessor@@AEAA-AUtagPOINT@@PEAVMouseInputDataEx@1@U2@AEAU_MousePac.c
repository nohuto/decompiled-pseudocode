/*
 * XREFs of ?ProcessMouseInputData@CMouseProcessor@@AEAA?AUtagPOINT@@PEAVMouseInputDataEx@1@U2@AEAU_MousePacketPerf@@PEBU_MOUSE_INPUT_DATA@@PEBUtagUIPI_INFO_INT@@@Z @ 0x1C0054478
 * Callers:
        ...
        struct tagUIPI_INFO_INT *a7)
{
  ...
  _BYTE v61[736]; // [rsp+48h] [rbp-C0h] BYREF
  struct tagPOINT v62; // [rsp+368h] [rbp+260h] BYREF
  __int64 *v63; // [rsp+378h] [rbp+270h] BYREF

  InputTraceLogging::ThreadLockedPerfRegion::ThreadLockedPerfRegion(&v63, "ProcessMouseInputData", 0LL);
