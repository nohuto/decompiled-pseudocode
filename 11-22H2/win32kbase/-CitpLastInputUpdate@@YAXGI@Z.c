...
void __fastcall CitpLastInputUpdate(unsigned __int16 a1, unsigned int a2)
{
  ...
  {
    if ( (unsigned int)v3 < *((_DWORD *)&xmmword_1C0293D30 + 2) )
    {
      v3 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
      v17 = v3;
    }
    v5 = xmmword_1C0293D30;
    *((_DWORD *)&xmmword_1C0293D30 + 2) = v3;
    CIT_USER_ACTIVE_TRACKER::OnUserActiveEvent((struct _CIT_IMPACT_CONTEXT *)((char *)xmmword_1C0293D30 + 228), v3);
    if ( !v4 )
