...
LABEL_39:
      if ( (_WORD)v18 == 1 )
      {
        ...
        if ( v159 )
        {
          ...
          if ( ((unsigned __int8)v146 & 2) != 0 && qword_1C0294670 )
            qword_1C0294670(v15, 0LL);
          if ( v159 )
            HANDLELOCK::vUnlock((HANDLELOCK *)&v158);
        }
      }
...
LABEL_55:
  ...
  *(_DWORD *)(*((_QWORD *)*this + 122) + 152LL) |= 0x12001Fu;
  ...
  v103 = *((_QWORD *)*this + 6);
  if ( qword_1C0294AB8 && (int)qword_1C0294AB8() >= 0 && qword_1C0294AC0 )
    qword_1C0294AC0(this, *(_DWORD *)(v103 + 40) & 1);
...
LABEL_114:
  ...
  *(_BYTE *)(v137 + 15) |= 4u;
  ...
  if ( v171 )
  {
    if ( (*(_DWORD *)(v171 + 712) & 0x81) != 0 && (int)IsRFONTOBJ_dtorHelperSupported() >= 0 && qword_1C0294BD0 )
      qword_1C0294BD0(&v171);
