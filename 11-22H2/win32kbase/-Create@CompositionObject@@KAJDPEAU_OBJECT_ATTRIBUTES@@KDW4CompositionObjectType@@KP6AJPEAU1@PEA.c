/*
 * XREFs of ?Create@CompositionObject@@KAJDPEAU_OBJECT_ATTRIBUTES@@KDW4CompositionObjectType@@KP6AJPEAU1@PEAXPEAPEAVICompositionObject@@@Z3PEAPEAX@Z @ 0x1C009DD88
 * Callers:
        ...
        void **Handle)
{
  ...
  else
  {
    ...
    if ( Object >= 0 )
    {
      MEMORY[0] = *(_DWORD *)SGDGetUserSessionState(v11, v10, v13, v14);
