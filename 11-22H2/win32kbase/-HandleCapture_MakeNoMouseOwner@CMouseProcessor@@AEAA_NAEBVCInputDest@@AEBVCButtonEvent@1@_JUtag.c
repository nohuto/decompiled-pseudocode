/*
 * XREFs of ?HandleCapture_MakeNoMouseOwner@CMouseProcessor@@AEAA_NAEBVCInputDest@@AEBVCButtonEvent@1@_JUtagPOINT@@I@Z @ 0x1C01F7C08
 * Callers:
 ...
 *     IsWindowDesktopComposed @ 0x1C008C800 (IsWindowDesktopComposed.c)
        ...
        unsigned int a6)
{
  ...
  v38 = 0LL;
  v37 = 0LL;
  ApiSetEditionPostInputMessage((__int64)v41, v26, a6, 0LL, a4, 0, 0LL, 0LL, 0, v34, (__int64)&v37);
  v28 = 0LL;
  if ( v43 == 2 )
    v28 = v42;
...
LABEL_27:
    ...
    *((_DWORD *)this + 893) |= v32;
    ...
    {
      LODWORD(v35) = 0x20000;
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 4124);
    }
