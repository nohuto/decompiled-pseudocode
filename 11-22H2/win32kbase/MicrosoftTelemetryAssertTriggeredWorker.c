/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C00ADFB8
 * Callers:
 ...
 *     _tlgCreate1Sz_char @ 0x1C00AE380 (_tlgCreate1Sz_char.c)
 *     TakeTelemetryAssertsLock @ 0x1C00AEF38 (TakeTelemetryAssertsLock.c)
 *     GetImageTuple @ 0x1C00AEF74 (GetImageTuple.c)
...
LABEL_52:
  ...
  if ( v42 )
  {
    if ( (unsigned int)dword_1C02BE040 > 5 && tlgKeywordOn((__int64)&dword_1C02BE040, 0x400000000000LL) )
    {
      v43 = v31;
      v86 = &v43;
      v32 = "<unknown>";
      ...
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C02BE040, byte_1C02614D9, 0LL, 0LL, 0xEu, &v85);
    }
  }
  else if ( (unsigned int)dword_1C02BE040 > 5 && tlgKeywordOn((__int64)&dword_1C02BE040, 0x400000000000LL) )
  {
    v53 = v26;
    v109 = &v53;
    v27 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_1C02BE040,
      (unsigned __int8 *)dword_1C0261583,
      0LL,
      0LL,
      0xBu,
      &v108);
  }
  if ( dword_1C02BE078 && !v60 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C02BE040 > 5 && tlgKeywordOn((__int64)&dword_1C02BE040, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C02BE040,
        (unsigned __int8 *)dword_1C02615F0,
        0LL,
        0LL,
        v37,
        &v69);
