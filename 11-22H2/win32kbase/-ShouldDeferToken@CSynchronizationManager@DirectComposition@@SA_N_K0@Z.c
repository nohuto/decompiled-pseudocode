/*
 * XREFs of ?ShouldDeferToken@CSynchronizationManager@DirectComposition@@SA_N_K0@Z @ 0x1C009ACA8
 * Callers:
 *     DCompositionShouldDeferToken @ 0x1C009AC90 (DCompositionShouldDeferToken.c)
 * Callees:
