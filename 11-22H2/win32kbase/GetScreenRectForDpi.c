/*
 * XREFs of GetScreenRectForDpi @ 0x1C005CB2C
 * Callers:
...
__m128i *__fastcall GetScreenRectForDpi(__m128i *a1, unsigned __int16 a2)
{
  ...
  __m128i v18; // [rsp+30h] [rbp-38h] BYREF
  ...
  if ( a2 )
  {
    if ( *(_DWORD *)v4 == 1 )
    {
      *a1 = *GetMonitorRectForDpi(&v17, *((_QWORD *)gpDispInfo + 12), a2);
    }
    else
    {
      ...
      if ( v6 )
      {
        ...
        do
        {
          ...
          {
            MonitorRectForDpi = GetMonitorRectForDpi(&v18, v6, a2);
