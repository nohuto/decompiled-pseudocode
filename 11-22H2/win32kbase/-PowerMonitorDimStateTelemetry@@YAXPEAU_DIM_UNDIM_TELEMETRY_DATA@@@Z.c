/*
 * XREFs of ?PowerMonitorDimStateTelemetry@@YAXPEAU_DIM_UNDIM_TELEMETRY_DATA@@@Z @ 0x1C007A6B0
 * Callers:
...
void __fastcall PowerMonitorDimStateTelemetry(struct _DIM_UNDIM_TELEMETRY_DATA *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C0283098 > 5 && tlgKeywordOn((__int64)&dword_1C0283098, 0x400000000100LL) )
  {
