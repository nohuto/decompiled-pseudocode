/*
 * XREFs of ?InitializeBackTraceStore@CLeakTrackingAllocator@NSInstrumentation@@AEAAXPEAPEAVCBackTraceStoreEx@2@@Z @ 0x1C016E478
 * Callers:
 ...
 * Callees:
 *     ?Create@CBackTraceStoreEx@NSInstrumentation@@SAPEAV12@XZ @ 0x1C016FC64 (-Create@CBackTraceStoreEx@NSInstrumentation@@SAPEAV12@XZ.c)
