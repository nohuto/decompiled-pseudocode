/*
 * XREFs of ?AddRef@CResourceMarshaler@DirectComposition@@QEAA_KXZ @ 0x1C003019C
 * Callers:
 ...
 *     ?AddChild@CVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@PEAV12@H1PEA_N@Z @ 0x1C00300C0 (-AddChild@CVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@PEAV12@H1PEA_N@Z.c)
...
unsigned __int64 __fastcall DirectComposition::CResourceMarshaler::AddRef(DirectComposition::CResourceMarshaler *this)
{
  ...
  if ( (unsigned int)Feature_29159638__private_IsEnabledDeviceUsage() )
  {
    ...
    result = v5 + 1;
    *((_QWORD *)this + 3) = v5 + 1;
    *((_DWORD *)this + 5) = (v5 + 1) ^ ~(_DWORD)this;
  }
  else
  {
    v2 = *((_QWORD *)this + 3);
