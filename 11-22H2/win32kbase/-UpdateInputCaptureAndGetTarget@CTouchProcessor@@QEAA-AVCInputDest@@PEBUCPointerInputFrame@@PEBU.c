/*
 * XREFs of ?UpdateInputCaptureAndGetTarget@CTouchProcessor@@QEAA?AVCInputDest@@PEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@PEAUCInputPointerNode@@IPEAGPEAIK@Z @ 0x1C01D95F4
 * Callers:
        ...
        unsigned int a9)
{
  ...
  *((_BYTE *)v9 + 112) = 0;
  ...
  if ( a1[5] != KeGetCurrentThread() )
  {
    ...
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1888);
  }
  v15 = 1;
...
LABEL_33:
  ...
  if ( v30 )
  {
    if ( v31 )
      goto LABEL_34;
    v72 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1958);
    goto LABEL_33;
  }
  if ( v31 )
  {
    v72 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 1957);
    v28 = 0LL;
  }
  v26 = 0;
LABEL_34:
...
LABEL_59:
    if ( (*((_DWORD *)v79 + 57) & 0x80u) != 0 )
      CHitTestState::Set((CHitTestState *)(*(_QWORD *)(*((_QWORD *)v79 + 32) + 1056LL) + 408LL), v9, *v80, v37, v37);
...
LABEL_75:
  ...
  *v64 = v67 | (2 * (*v65 & 0x40));
  ...
  if ( (_BYTE)v64 || v15 )
  {
    v68 = &WPP_2c5ea56a6e6f31fa38ff36b2483c7d67_Traceguids;
    LOBYTE(v68) = v15;
    WPP_RECORDER_AND_TRACE_SF_(
      WPP_GLOBAL_Control->AttachedDevice,
      (_DWORD)v64,
