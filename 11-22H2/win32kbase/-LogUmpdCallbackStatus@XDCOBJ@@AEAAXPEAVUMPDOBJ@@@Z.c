/*
 * XREFs of ?LogUmpdCallbackStatus@XDCOBJ@@AEAAXPEAVUMPDOBJ@@@Z @ 0x1C0151CA0
 * Callers:
...
void __fastcall XDCOBJ::LogUmpdCallbackStatus(XDCOBJ *this, struct UMPDOBJ *a2)
{
  ...
  if ( dword_1C02883D8 )
  {
    if ( tlgKeywordOn((__int64)&dword_1C02883D8, 0x400000000000LL) )
    {
      v5 = *(unsigned int *)(v4 + 444);
      v6 = *(unsigned __int16 *)(*(_QWORD *)v3 + 12LL);
      if ( *(_DWORD *)(*(_QWORD *)v3 + 2176LL) != (_DWORD)v5 )
      {
        *(_DWORD *)(*(_QWORD *)v3 + 2176LL) = v5;
        ...
        if ( (unsigned int)dword_1C02883D8 > 5 && tlgKeywordOn((__int64)&dword_1C02883D8, v2) )
        {
          v16 = v6;
          v12 = v5;
          v13 = v8;
