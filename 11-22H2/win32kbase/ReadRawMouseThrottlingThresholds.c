/*
 * XREFs of ReadRawMouseThrottlingThresholds @ 0x1C01E89D0
 * Callers:
 *     <none>
 * Callees:
 *     ?ReadRawMouseThrottlingThresholds@CMouseSensor@@QEAAXPEAU_UNICODE_STRING@@@Z @ 0x1C01E5480 (-ReadRawMouseThrottlingThresholds@CMouseSensor@@QEAAXPEAU_UNICODE_STRING@@@Z.c)
 */
