/*
 * XREFs of ?GetCoalesceInfo@CTouchProcessor@@AEAAPEAUtagCPointerCoalesceInfo@@K@Z @ 0x1C01C6D84
 * Callers:
...
struct tagCPointerCoalesceInfo *__fastcall CTouchProcessor::GetCoalesceInfo(struct _KTHREAD **this, unsigned int a2)
{
  ...
  {
    v18 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 9130);
  }
  if ( !(_DWORD)v2 )
  {
    v18 = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 9131);
  }
  v4 = (unsigned __int64)(this + 19);
  *((_DWORD *)this + 39) = 0;
  if ( *((_DWORD *)this + 38) < (unsigned int)v2 )
  {
            ...
            case 2:
              ...
              if ( !NSInstrumentation::CLeakTrackingAllocator::IsTagTracked(gpLeakTrackingAllocator, 1885631317, &v17) )
              {
                ...
                Pool2 = NSInstrumentation::CLeakTrackingAllocator::MakeUntrackedAllocation__lambda_992394a475252bc644037de3157b7526__unsigned___int64___(
                          ...
                          &v20);
LABEL_32:
                this[20] = (struct _KTHREAD *)Pool2;
                *(_DWORD *)v4 = v2;
                return (struct tagCPointerCoalesceInfo *)(v4 & -(__int64)(this[20] != 0LL));
              }
              v13 = 0;
