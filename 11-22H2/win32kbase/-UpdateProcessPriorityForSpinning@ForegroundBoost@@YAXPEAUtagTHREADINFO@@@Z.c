/*
 * XREFs of ?UpdateProcessPriorityForSpinning@ForegroundBoost@@YAXPEAUtagTHREADINFO@@@Z @ 0x1C0065E10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ForegroundBoost::UpdateProcessPriorityForSpinning(ForegroundBoost *this, struct tagTHREADINFO *a2)
{
  ...
  CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v12, (struct _EX_PUSH_LOCK *)&unk_1C0291DD0);
  v3 = *((_QWORD *)this + 53);
  if ( _bittest((const signed __int32 *)this + 122, 0xAu) )
  {
    ...
    if ( (v4 & 0x800) == 0 )
    {
      *(_DWORD *)(v3 + 12) = v4 | 0x800;
      if ( (*(_DWORD *)(*((_QWORD *)this + 53) + 816LL) & 0x60000) == 0x20000 )
      {
...
LABEL_10:
          ...
          WPP_RECORDER_AND_TRACE_SF_D(
            ...
            13,
            v11,
            (__int64)&WPP_8fd0ae42632e393bc5b9afafd6bcf777_Traceguids,
            *(_DWORD *)(v3 + 56));
        }
      }
    }
  ...
  else
  {
    ...
    if ( (v9 & 0x800) != 0 )
    {
      ...
      *(_DWORD *)(v3 + 12) = v9 & 0xFFFFF7FF;
      if ( (*(_DWORD *)(*((_QWORD *)this + 53) + 816LL) & 0x60000) == 0x40000 )
      {
        v7 = 1;
