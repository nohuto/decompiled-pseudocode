/*
 * XREFs of ?EmitSetMaxLifetimeCommand@CParticleGeneratorMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0218478
 * Callers:
...
char __fastcall DirectComposition::CParticleGeneratorMarshaler::EmitSetMaxLifetimeCommand(
