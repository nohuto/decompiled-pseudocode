/*
 * XREFs of ?MouseSpeedHitTest@CMouseProcessor@@CA?AUtagINPUTDEST@@PEAUtagPOINT@@PEBU_SUBPIXELS@@GG_KKPEAXW4DIT_HITTESTATTRIBUTES@@KKPEAHPEAU_InputHitTestResult@@@Z @ 0x1C0057AD4
 * Callers:
 ...
 *     MouseButtonToPointerFlags @ 0x1C0057CA0 (MouseButtonToPointerFlags.c)
        ...
        __int64 a13)
{
  ...
  if ( *(_QWORD *)(SGDGetUserSessionState(a1, a2, a3, a4) + 15904) )
  {
    if ( (unsigned int)CBaseProcessor::GetExecutionEnvironment() != 1 )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 6033LL);
