/*
 * XREFs of ?ProcessButton@Mouse@InputTraceLogging@@SAX_KAEBUtagPOINT@@IPEAUHWND__@@@Z @ 0x1C01F9380
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::ProcessButton(__int64 a1, const struct tagPOINT *a2, __int64 a3, HWND a4)
{
  ...
  if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 64LL) )
  {
    ...
    v22 = 4;
    v19 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0289810, (unsigned __int8 *)dword_1C025F1E2, 0LL, 0LL, 7u, &v14);
  }
}
