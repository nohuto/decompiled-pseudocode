/*
 * XREFs of ?DelegateCapture@CTouchProcessor@@QEAA?AUtagINPUTDEST@@GKH@Z @ 0x1C01C0980
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( NodeById )
  {
    ...
    for ( i = *v16; i != (__int64 *)v16; i = (__int64 *)*i )
    {
      if ( *((_DWORD *)i + 6) == a4 )
      {
        ...
        {
          v19 = 0x20000;
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 6147);
        }
        if ( *((_DWORD *)i + 6) != a4 )
        {
          v19 = 0x20000;
          MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 6148);
        }
