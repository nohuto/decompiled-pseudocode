/*
 * XREFs of ?EmitSetTransformCommand@CLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021ADF8
 * Callers:
...
char __fastcall DirectComposition::CLegacyMilBrushMarshaler::EmitSetTransformCommand(
