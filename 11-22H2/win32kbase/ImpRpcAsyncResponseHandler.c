/*
 * XREFs of ImpRpcAsyncResponseHandler @ 0x1C007AC8C
 * Callers:
...
__int64 ImpRpcAsyncResponseHandler()
{
  ...
  if ( (unsigned int)ImpCompleteRpc() == -1073610734 )
  {
    ...
    v10 = 0;
    v1 = (unsigned __int8 *)&unk_1C0261883;
    v5 = 0;
    v13 = 0;
    v4 = ImpSessionId;
    v8 = &v4;
  ...
  {
    v10 = 0;
    v1 = (unsigned __int8 *)&dword_1C026194F;
    v13 = 0;
    v16 = 0;
    v8 = &v5;
...
LABEL_6:
    v9 = 4;
    v12 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0288780, v1, 0LL, 0LL, v3, &v7);
  }
  return (unsigned int)EnabledStateAsync;
}
