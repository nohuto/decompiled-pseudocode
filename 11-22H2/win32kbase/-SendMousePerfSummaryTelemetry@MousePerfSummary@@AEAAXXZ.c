/*
 * XREFs of ?SendMousePerfSummaryTelemetry@MousePerfSummary@@AEAAXXZ @ 0x1C00E6B7A
 * Callers:
 ...
 *     ?Reset@MousePerfSummary@@AEAAXXZ @ 0x1C01FEC00 (-Reset@MousePerfSummary@@AEAAXXZ.c)
 */
