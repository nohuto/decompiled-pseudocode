/*
 * XREFs of ?CacheInertia@CPTPProcessor@@AEAAXXZ @ 0x1C01DE780
 * Callers:
...
void __fastcall CPTPProcessor::CacheInertia(CPTPProcessor *this)
{
  ...
  v2 = HMValidateHandleNoSecure(*((_QWORD *)this + 67), 19);
  if ( v2 )
  {
    ...
    if ( v9 )
    {
      *(_OWORD *)((char *)this + 184) = *(_OWORD *)v9;
      *(_OWORD *)((char *)this + 200) = *((_OWORD *)v9 + 1);
      *(_OWORD *)((char *)this + 216) = *((_OWORD *)v9 + 2);
      *(_OWORD *)((char *)this + 232) = *((_OWORD *)v9 + 3);
      *(_OWORD *)((char *)this + 248) = *((_OWORD *)v9 + 4);
      *(_OWORD *)((char *)this + 264) = *((_OWORD *)v9 + 5);
      *(_OWORD *)((char *)this + 280) = *((_OWORD *)v9 + 6);
      *(_OWORD *)((char *)this + 296) = *((_OWORD *)v9 + 7);
      *(_OWORD *)((char *)this + 312) = *((_OWORD *)v9 + 8);
      *(_OWORD *)((char *)this + 328) = *((_OWORD *)v9 + 9);
      *(_OWORD *)((char *)this + 344) = *((_OWORD *)v9 + 10);
      *(_OWORD *)((char *)this + 360) = *((_OWORD *)v9 + 11);
      *((struct tagPOINT *)this + 47) = gptCursorAsync;
      v11 = CPTPProcessor::TransformTPScreenToHimetric(v7, gptCursorAsync);
      *((_DWORD *)this + 99) |= 1u;
      *((struct tagPOINT *)this + 48) = v11;
      v16 = SGDGetUserSessionState(v13, v12, v14, v15);
      CHidInput::HandlePTPInertiaTimer(*(CHidInput **)(v16 + 16840), 0, 0x32u, *((void **)this + 67));
      *((_BYTE *)this + 400) = 1;
