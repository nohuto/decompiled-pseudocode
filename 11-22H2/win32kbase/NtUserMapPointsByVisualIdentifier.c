/*
 * XREFs of NtUserMapPointsByVisualIdentifier @ 0x1C01498B0
 * Callers:
 *     <none>
 * Callees:
        ...
        volatile void *Address)
{
  ...
  struct _LUID v33; // [rsp+78h] [rbp-60h] BYREF
  struct _LUID *v34; // [rsp+80h] [rbp-58h]
  __int64 *v35; // [rsp+90h] [rbp-48h]
  struct _LUID *v36; // [rsp+98h] [rbp-40h]
...
LABEL_32:
  ...
  if ( ((PsGetCurrentProcessWow64Process(v9, a2, v11) == 0 ? 3 : 0) & (unsigned __int8)a4) != 0 )
...
LABEL_33:
  ...
  v20 = MapPointsByVisualIdentifierInternal(v34, v7, a3, v12, v19);
  if ( v20 >= 0 )
  {
    CurrentProcessWow64Process = PsGetCurrentProcessWow64Process(v22, v21, v23);
    ProbeForWrite(Address, (unsigned int)v14, CurrentProcessWow64Process != 0 ? 1 : 4);
    memmove((void *)Address, v13, (unsigned int)v14);
    goto LABEL_32;
  }
  v24 = 0;
  v25 = RtlNtStatusToDosError(v20);
LABEL_34:
...
LABEL_35:
  ...
  if ( !v24 )
  {
    ...
    {
      LastError = UserGetLastError(WPP_GLOBAL_Control, a2, v11);
      LOBYTE(v29) = v27;
      LOBYTE(v30) = v10;
