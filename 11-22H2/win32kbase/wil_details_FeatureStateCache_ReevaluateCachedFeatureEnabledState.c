/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C012DBA0
 * Callers:
 ...
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C012DCA0 (wil_details_GetCurrentFeatureEnabledState.c)
 */
