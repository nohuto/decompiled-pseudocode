...
void __fastcall XDCOBJ::vDeleteCore(__int64 **this)
{
  ...
  while ( v17 )
  {
    ...
    v110[0] = v102;
    --*(_DWORD *)(*v96 + 64LL);
    if ( (int)IsPFTOBJ_bUnloadWorkhorseSupported() >= 0 && qword_1C0294C10 )
    {
      v103 = 64LL;
      if ( v102 != v101 )
        v103 = 32LL;
      qword_1C0294C10(v110, *v96, 0LL, v103);
    }
...
LABEL_68:
  ...
  *this = 0LL;
  if ( v95 )
  {
    if ( (*(_DWORD *)(v95 + 712) & 0x81) != 0 && qword_1C0294BC8 && (int)qword_1C0294BC8() >= 0 )
    {
      if ( qword_1C0294BD0 )
        qword_1C0294BD0(&v114);
    }
