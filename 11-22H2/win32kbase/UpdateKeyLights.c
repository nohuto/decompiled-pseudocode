/*
 * XREFs of UpdateKeyLights @ 0x1C006EB00
 * Callers:
 *     xxxUpdateGlobalsAndSendKeyEvent @ 0x1C006B3FC (xxxUpdateGlobalsAndSendKeyEvent.c)
 *     ?ApplyGatheredKeyboardDeviceCount@CKeyboardProcessor@@QEAAXK@Z @ 0x1C006C8C0 (-ApplyGatheredKeyboardDeviceCount@CKeyboardProcessor@@QEAAXK@Z.c)
...
void __fastcall UpdateKeyLights(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_WORD *)(SGDGetUserSessionState(a1, a2, a3, a4) + 12598) = 0;
  ...
  if ( *(_BYTE *)(SGDGetUserSessionState(v33, v32, v34, v35) + 12568) == 7
    || qword_1C02962C0 && (unsigned int)qword_1C02962C0(v37) && (_DWORD)gRemoteClientKeyboardType == 7 )
  {
  ...
  if ( qword_1C02962C0 && (unsigned int)qword_1C02962C0(v37) )
  {
