 ...
 *     DirectComposition::Memory::Allocate @ 0x1C00E7836 (DirectComposition--Memory--Allocate.c)
 ...
 *     ?GDIEngUserMemAllocNodeAlloc@@YAPEAXPEAU_RTL_AVL_TABLE@@K@Z @ 0x1C0169A10 (-GDIEngUserMemAllocNodeAlloc@@YAPEAXPEAU_RTL_AVL_TABLE@@K@Z.c)
 *     EtwTraceMoveRegion @ 0x1C016B6A0 (EtwTraceMoveRegion.c)
 *     MakeSystemDriversRelativePath @ 0x1C016D0A4 (MakeSystemDriversRelativePath.c)
