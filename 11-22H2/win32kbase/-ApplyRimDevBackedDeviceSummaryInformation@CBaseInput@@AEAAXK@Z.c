/*
 * XREFs of ?ApplyRimDevBackedDeviceSummaryInformation@CBaseInput@@AEAAXK@Z @ 0x1C0076EC8
 * Callers:
...
LABEL_12:
  ...
  *(_QWORD *)(v2 + 8) = 0LL;
  ...
  if ( qword_1C0296650 && (int)qword_1C0296650() >= 0 )
  {
    if ( qword_1C0296658 )
      qword_1C0296658(a2, v4, v7, v5, v6, v14[0]);
  }
}
