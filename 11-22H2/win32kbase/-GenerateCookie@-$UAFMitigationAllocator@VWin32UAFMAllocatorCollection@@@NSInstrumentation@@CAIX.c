/*
 * XREFs of ?GenerateCookie@?$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@CAIXZ @ 0x1C014FD40
 * Callers:
 ...
 *     Win32UAFMAllocateFromPagedLookasideList @ 0x1C014FB80 (Win32UAFMAllocateFromPagedLookasideList.c)
