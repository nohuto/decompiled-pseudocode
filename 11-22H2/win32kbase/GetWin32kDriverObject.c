/*
 * XREFs of GetWin32kDriverObject @ 0x1C00C0680
 * Callers:
...
__int64 __fastcall GetWin32kDriverObject(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  dword_1C0290390 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  result = ObReferenceObjectByName(&DestinationString, 64LL, 0LL);
  dword_1C0290394 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  if ( (int)result < 0 )
    return 0LL;
  return result;
}
