/*
 * XREFs of ?UpdateISODState@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C00077EC
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::UpdateISODState(const struct tagQMSG *a1)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C0289810, 16LL) )
    {
      v5 = *(_DWORD *)(v3 + 100);
      v10 = v2;
      v14 = 8LL;
      ...
      v13 = &v11;
      v9 = -__CFSHR__(v5, 17);
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0289810, (int)&dword_1C02556C3, 0, 0, 8u, &v12);
    }
  }
}
