/*
 * XREFs of ?Win32kPnpNotify@@YAJPEAU_VIDEO_WIN32K_CALLBACKS_PARAMS@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C013356C
 * Callers:
 ...
 *     DrvDisableGraphicsDevices @ 0x1C016658C (DrvDisableGraphicsDevices.c)
