/*
 * XREFs of TransformRectBetweenCoordinateSpaces @ 0x1C0062C80
 * Callers:
 ...
 *     IsDpiAwarenessBoundaryInParentChain @ 0x1C013F4B4 (IsDpiAwarenessBoundaryInParentChain.c)
...
__int64 __fastcall TransformRectBetweenCoordinateSpaces(struct tagRECT *a1, struct tagRECT *a2, __int64 a3, __int64 a4)
{
  ...
  {
    v13 = qword_1C0295EB0 ? qword_1C0295EB0(a3) : 0LL;
    if ( v13 )
    {
      if ( v13 != a3 )
      {
  ...
  do
  {
    ...
    if ( (unsigned int)IntersectRect(&v40, (int *)&v38, &a2->left) )
    {
      if ( v34 )
      {
        v22 = left;
