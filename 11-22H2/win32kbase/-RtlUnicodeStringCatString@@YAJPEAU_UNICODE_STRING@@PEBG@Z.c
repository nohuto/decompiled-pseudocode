/*
 * XREFs of ?RtlUnicodeStringCatString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C006D6B4
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C006D730 (RtlWideCharArrayCopyStringWorker.c)
 */
