/*
 * XREFs of ?UnregisterPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@@Z @ 0x1C00BF554
 * Callers:
 ...
 *     CoreUICallSend @ 0x1C00A1278 (CoreUICallSend.c)
 ...
 *     ?NtStatusFromHRESULT@HResultUtil@CoreMessagingK@@YAJJ@Z @ 0x1C02352D0 (-NtStatusFromHRESULT@HResultUtil@CoreMessagingK@@YAJJ@Z.c)
 */
...
__int64 __fastcall CoreMessagingK::RegistrarClient::UnregisterPort(const struct _GUID *a1)
{
  ...
  v9 = v1;
  v3 = CoreUICallSend((int)&v8, (int)&v7, 1, 1, 15, (__int64)&unk_1C024788D, &v9);
  if ( v3 < 0 )
  {
  ...
  if ( (unsigned int)dword_1C0288500 > 5 )
  {
    ...
    v11 = a1;
    v12 = 16;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0288500, (unsigned __int8 *)dword_1C026115B, 0LL, 0LL, 4u, &v10);
  }
  return v5;
}
