/*
 * XREFs of ?ReleaseAllReferences@?$CSharedResourceMarshaler@VCManipulationTransformMarshaler@DirectComposition@@$01@DirectComposition@@UEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00B6B70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
