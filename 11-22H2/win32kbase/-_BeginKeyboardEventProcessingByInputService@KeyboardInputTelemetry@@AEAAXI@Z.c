/*
 * XREFs of ?_BeginKeyboardEventProcessingByInputService@KeyboardInputTelemetry@@AEAAXI@Z @ 0x1C0007A10
 * Callers:
        ...
        if ( *((_DWORD *)this + 46) != v8 )
        {
          *((_DWORD *)this + 46) = v8;
          RtlStringCchCopyW(
            ...
            0x10uLL,
            (const unsigned __int16 *)(*((_QWORD *)gptiForeground + 53) + 1000LL));
        }
      }
    }
  }
