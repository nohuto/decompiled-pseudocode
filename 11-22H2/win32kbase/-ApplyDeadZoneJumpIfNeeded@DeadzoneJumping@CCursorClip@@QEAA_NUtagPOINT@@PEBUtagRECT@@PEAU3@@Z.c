/*
 * XREFs of ?ApplyDeadZoneJumpIfNeeded@DeadzoneJumping@CCursorClip@@QEAA_NUtagPOINT@@PEBUtagRECT@@PEAU3@@Z @ 0x1C01DB964
 * Callers:
 ...
 *     ?DeadzoneJumpSuggestion@Cursor@InputTraceLogging@@SAXIAEBUtagPOINT@@0@Z @ 0x1C01DBF24 (-DeadzoneJumpSuggestion@Cursor@InputTraceLogging@@SAXIAEBUtagPOINT@@0@Z.c)
 *     ?Proximity@DeadzoneJumping@CCursorClip@@CAJJJJ@Z @ 0x1C01DC214 (-Proximity@DeadzoneJumping@CCursorClip@@CAJJJJ@Z.c)
 */
