/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1C00AED14
 * Callers:
...
__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
        ...
        (g_ModuleName = v4) != 0LL) )
  {
    ...
    qword_1C028FBB8 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C02BE040);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C02BE008);
    TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C02BE078);
