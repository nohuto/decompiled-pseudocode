/*
 * XREFs of ?Destroy@?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@SAXPEAV12@@Z @ 0x1C0091788
 * Callers:
...
{
  NSInstrumentation::CTypeIsolation<233472,912>::~CTypeIsolation<233472,912>(P);
