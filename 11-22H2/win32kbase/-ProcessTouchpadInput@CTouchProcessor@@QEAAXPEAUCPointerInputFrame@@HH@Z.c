/*
 * XREFs of ?ProcessTouchpadInput@CTouchProcessor@@QEAAXPEAUCPointerInputFrame@@HH@Z @ 0x1C01D1808
 * Callers:
        ...
        int a4)
{
  ...
  if ( v12 )
  {
    ...
    if ( !*((_QWORD *)v15 + 30) )
      MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 849);
