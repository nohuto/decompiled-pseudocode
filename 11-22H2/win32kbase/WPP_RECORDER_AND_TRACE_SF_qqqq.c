/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qqqq @ 0x1C00AC9A8
 * Callers:
        ...
        ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, __int64, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
               a1,
               43LL,
               a8,
               a7,
  ...
  {
    LOWORD(v11) = a7;
    return WppAutoLogTrace(a4, a5, 1LL, a8, v11, (__int64 *)va, 8LL, (__int64 *)va1);
  }
  return result;
}
