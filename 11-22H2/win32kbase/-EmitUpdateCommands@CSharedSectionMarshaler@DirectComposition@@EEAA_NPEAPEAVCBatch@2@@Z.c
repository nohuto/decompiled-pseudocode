/*
 * XREFs of ?EmitUpdateCommands@CSharedSectionMarshaler@DirectComposition@@EEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0086C00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  *(_QWORD *)(v3 + 12) = DirectComposition::CDCompMappedSharedSectionMarshaler::CreateDwmHandle(this);
