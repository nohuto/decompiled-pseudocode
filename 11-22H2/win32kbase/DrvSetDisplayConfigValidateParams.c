/*
 * XREFs of DrvSetDisplayConfigValidateParams @ 0x1C00D71F0
 * Callers:
 ...
 *     ?EnforceSDCCloneSourceIndexCoherency@@YAJIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z @ 0x1C0162B20 (-EnforceSDCCloneSourceIndexCoherency@@YAJIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@@Z.c)
 ...
 *     ?IsPathVirtualFlagCloneCompatible@@YAEEE@Z @ 0x1C0163BCC (-IsPathVirtualFlagCloneCompatible@@YAEEE@Z.c)
 */
