/*
 * XREFs of ?EmitCreationCommand@?$CSharedResourceMarshaler@VCVisualSurfaceMarshaler@DirectComposition@@$01@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00C55F0
 * Callers:
 *     <none>
 * Callees:
