/*
 * XREFs of NtInputSpaceRegionFromPoint @ 0x1C0140CB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetInputSpace@InputConfig@@SA_NU_LUID@@PEAVCLockedInputSpace@@@Z @ 0x1C01E3D00 (-GetInputSpace@InputConfig@@SA_NU_LUID@@PEAVCLockedInputSpace@@@Z.c)
 */
