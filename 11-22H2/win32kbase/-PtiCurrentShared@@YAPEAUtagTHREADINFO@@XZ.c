 ...
 *     IsPointerDeviceAccessible @ 0x1C00DE800 (IsPointerDeviceAccessible.c)
 *     ?CanCallerAccessDestination@CInputDest@@QEBA_NXZ @ 0x1C00E390C (-CanCallerAccessDestination@CInputDest@@QEBA_NXZ.c)
 *     ?IsHandleILChecksDisabledForCurrentThread@tagTHREADINFO@@SA_NXZ @ 0x1C012EF90 (-IsHandleILChecksDisabledForCurrentThread@tagTHREADINFO@@SA_NXZ.c)
 *     UserGetCurrentDesktopId @ 0x1C012F828 (UserGetCurrentDesktopId.c)
