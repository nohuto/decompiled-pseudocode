/*
 * XREFs of ?PostPointerMessage@CTouchProcessor@@AEAAHAEBVCInputDest@@PEBUCPointerInputFrame@@PEBUCPointerInfoNode@@_KIKHH@Z @ 0x1C01CED30
 * Callers:
 ...
 *     GetPointerInputSource @ 0x1C00E5C80 (GetPointerInputSource.c)
 ...
 *     messageString @ 0x1C01DA784 (messageString.c)
        ...
        int a9)
{
  ...
  if ( CheckAccessEx((int *)(*(_QWORD *)(v15 + 472) + 944LL), (unsigned int *)(Queue + 432), 0LL)
    ...
    && (*(_DWORD *)(v17 + 816) & 0x30) == 0x10
    && (v16 = *((_QWORD *)ThreadInfo + 53), v17 == v16)
    && (unsigned int)ApiSetEditionIsGpqForegroundAccessibleExplicit(a8, (__int64)ThreadInfo, *(_QWORD *)(v16 + 888), 0) )
  {
LABEL_24:
    v19 = a6;
