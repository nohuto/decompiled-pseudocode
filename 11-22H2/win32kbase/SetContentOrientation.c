/*
 * XREFs of SetContentOrientation @ 0x1C01E8DB8
 * Callers:
 ...
 *     SendOrientationChanged @ 0x1C01E8A80 (SendOrientationChanged.c)
 */
...
char __fastcall SetContentOrientation(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_DWORD *)(MouseProcessor + 2784) = v4;
  ...
  if ( v4 != 1 )
  {
    ...
    LODWORD(v11) = 0x20000;
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000, 5295);
  }
  v9 = 0.0;
LABEL_8:
  ...
  {
    LOBYTE(MouseProcessor) = tlgKeywordOn((__int64)&dword_1C0289810, 64LL);
