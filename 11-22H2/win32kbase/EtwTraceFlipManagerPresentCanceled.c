/*
 * XREFs of EtwTraceFlipManagerPresentCanceled @ 0x1C01398E0
 * Callers:
 *     <none>
 * Callees:
 *     GetQpcFrequency @ 0x1C01387BC (GetQpcFrequency.c)
 *     McTemplateK0qxxxxxi_EtwWriteTransfer @ 0x1C013E988 (McTemplateK0qxxxxxi_EtwWriteTransfer.c)
 */

_UNKNOWN **__fastcall EtwTraceFlipManagerPresentCanceled(
        int a1,
        char a2,
        char a3,
        __int64 a4,
        ...
        unsigned __int64 a6)
{
  ...
  if ( (Microsoft_Windows_Win32kEnableBits & 1) != 0 )
  {
    ...
    return (_UNKNOWN **)McTemplateK0qxxxxxi_EtwWriteTransfer(
                          0,
                          (unsigned int)&FlipManagerPresentCanceled,
                          v30,
                          a1,
                          a2,
                          a3,
