/*
 * XREFs of ?EmitUpdateCommands@CAtlasedRectsMeshMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021B3B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EmitSetIsHitTestVisibleCommand@CAtlasedRectsMeshMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0218054 (-EmitSetIsHitTestVisibleCommand@CAtlasedRectsMeshMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatc.c)
 *     ?EmitSetOpacityCommand@CAtlasedRectsMeshMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C02194DC (-EmitSetOpacityCommand@CAtlasedRectsMeshMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z.c)
 */
