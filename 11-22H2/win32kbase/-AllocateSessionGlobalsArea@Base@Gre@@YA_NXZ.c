/*
 * XREFs of ?AllocateSessionGlobalsArea@Base@Gre@@YA_NXZ @ 0x1C00BA114
 * Callers:
...
bool __fastcall Gre::Base::AllocateSessionGlobalsArea(Gre::Base *this)
{
  ...
  {
    Pool2 = ExAllocatePool2(260LL, 8112LL, 826754887LL);
    if ( Pool2 )
  ...
  if ( v5 != 1 )
  {
    if ( v5 == 2 )
    {
      ...
      Pool2 = ExAllocatePool2(v25, 8128LL, 826754887LL);
      if ( Pool2 )
      {
...
LABEL_27:
  ...
  v24 = (_QWORD *)ExAllocatePool2(v30 & 0xFFFFFFFFFFFFFFFDuLL, 8128LL, v28);
  Pool2 = (__int64)v24;
  if ( !v24
    || (_InterlockedIncrement64((volatile signed __int64 *)v3 + 14),
        *v24 = 826754887LL,
...
LABEL_4:
  ...
  *(_DWORD *)(v10 + 1408) = 1;
  *(_DWORD *)(v10 + 1412) = 1;
  *(_OWORD *)(v10 + 3852) = xmmword_1C024CEB0;
  *(_OWORD *)(v10 + 3868) = xmmword_1C024CEC0;
  *(_OWORD *)(v10 + 3884) = xmmword_1C024CED0;
  *(_OWORD *)(v10 + 3900) = xmmword_1C024CEE0;
  *(_OWORD *)(v10 + 3916) = xmmword_1C024CEF0;
  ...
  *(_OWORD *)(v10 + 8048) = xmmword_1C024CF90;
  *(_QWORD *)(v10 + 8100) = 0LL;
  *(_DWORD *)(v10 + 6496) = 0;
  *(_QWORD *)(v10 + 6472) = v10 + 6408;
  *(_OWORD *)(v10 + 8064) = xmmword_1C024CFA0;
  *(_BYTE *)(v10 + 1216) = 0;
  *(_DWORD *)(v10 + 6484) = 4096;
  *(_OWORD *)(v10 + 6524) = xmmword_1C024CF08;
  *(_OWORD *)(v10 + 6540) = xmmword_1C024CF18;
  result = 1;
  *(_DWORD *)(v10 + 6556) = 75;
  *(_OWORD *)(v10 + 6560) = xmmword_1C024CF30;
  *(_OWORD *)(v10 + 6576) = xmmword_1C024CF40;
  *(_DWORD *)(v10 + 6592) = 99;
  *(_OWORD *)(v10 + 6596) = xmmword_1C024CF58;
  *(_OWORD *)(v10 + 6612) = xmmword_1C024CF68;
  *(_DWORD *)(v10 + 6628) = 83;
  return result;
}
