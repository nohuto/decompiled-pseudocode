/*
 * XREFs of ?Create@CDwmChannel@DirectComposition@@SAJPEAI@Z @ 0x1C00BA000
 * Callers:
 *     NtDCompositionCreateDwmChannel @ 0x1C00B9F60 (NtDCompositionCreateDwmChannel.c)
 * Callees:
 *     ?InsertObject@?$CGenericTable@IVCChannel@DirectComposition@@$0HEGDEDEE@$00@DirectComposition@@QEAAJIPEAVCChannel@2@@Z @ 0x1C0022FDC (-InsertObject@-$CGenericTable@IVCChannel@DirectComposition@@$0HEGDEDEE@$00@DirectComposition@@QE.c)
...
__int64 __fastcall DirectComposition::CDwmChannel::Create(unsigned int *a1)
{
  ...
  LOBYTE(v7) = 1;
  DirectComposition::CApplicationChannel::CApplicationChannel(QuotaZInit, DefaultConnection, v7, 0);
