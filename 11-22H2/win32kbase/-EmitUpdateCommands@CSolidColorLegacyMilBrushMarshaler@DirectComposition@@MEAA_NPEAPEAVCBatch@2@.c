/*
 * XREFs of ?EmitUpdateCommands@CSolidColorLegacyMilBrushMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C021C630
 * Callers:
 *     <none>
 * Callees:
 *     ?EmitSetColorCommand@CSolidColorLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0217160 (-EmitSetColorCommand@CSolidColorLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2.c)
