/*
 * XREFs of ??R_lambda_2e7ff781dcd3630f4c6aa1e7b0f1888a_@@QEBAPEAU_RTL_BITMAP@@I@Z @ 0x1C00D17A8
 * Callers:
...
struct _RTL_BITMAP *__fastcall _lambda_2e7ff781dcd3630f4c6aa1e7b0f1888a_::operator()(__int64 a1, unsigned int a2)
{
  __int64 v2; // rax
  ULONG v3; // edi
