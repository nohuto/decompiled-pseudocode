/*
 * XREFs of RIMDirectStartUserModeRimDeviceClassNotifications @ 0x1C00CC07C
 * Callers:
...
void __fastcall RIMDirectStartUserModeRimDeviceClassNotifications(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  RIMSyncWalkRimObjList(
    0LL,
    0LL,
    (void (__fastcall *)(_QWORD *, __int64))lambda_19d57102c8865a47b80b678652ec7574_::_lambda_invoker_cdecl_,
    a4);
