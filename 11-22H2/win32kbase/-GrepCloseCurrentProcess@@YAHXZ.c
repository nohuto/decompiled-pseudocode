...
__int64 GrepCloseCurrentProcess(void)
{
  ...
  if ( *(_DWORD *)(v3 + 3192) )
  {
    ...
    if ( qword_1C0294D68 )
    {
      if ( (int)qword_1C0294D68() >= 0 && qword_1C0294D70 )
        qword_1C0294D70();
    }
  }
  vCleanupDCs(v1);
  ...
  if ( qword_1C0294D88 && (int)qword_1C0294D88() >= 0 && qword_1C0294D90 )
  ...
  if ( *(_DWORD *)(v3 + 3192) )
  {
    ...
    if ( qword_1C0294D98 )
    {
      if ( (int)qword_1C0294D98() >= 0 && qword_1C0294DA0 )
        qword_1C0294DA0((unsigned int)v1);
    }
  }
  MultiUserGreCleanupHmgRemoveAllLocks(0);
  if ( *(_DWORD *)(v3 + 3192) )
    goto LABEL_48;
  if ( qword_1C0294DA8 && (int)qword_1C0294DA8() >= 0 && qword_1C0294DB0 )
    qword_1C0294DB0();
  if ( *(_DWORD *)(v3 + 3192) )
  {
LABEL_48:
    ...
    v16 = 0LL;
    v17 = 0LL;
    if ( qword_1C0294DB8 && (int)qword_1C0294DB8() >= 0 )
    {
      if ( qword_1C0294DC0 )
        qword_1C0294DC0(&hdo, &v16, &v17);
      if ( *(_QWORD *)hdo )
  ...
  while ( 1 )
  {
    ...
    {
      if ( qword_1C0294DC8 && (int)qword_1C0294DC8() >= 0 && qword_1C0294DD0 )
        qword_1C0294DD0(v10);
    }
    else if ( v11 == 28 )
    {
