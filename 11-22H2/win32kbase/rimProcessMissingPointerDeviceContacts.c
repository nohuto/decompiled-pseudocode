/*
 * XREFs of rimProcessMissingPointerDeviceContacts @ 0x1C01AB398
 * Callers:
...
_UNKNOWN **__fastcall rimProcessMissingPointerDeviceContacts(__int64 a1, __int64 a2, int a3)
{
  ...
  while ( 1 )
  {
    ...
    {
      *(_DWORD *)(v16 + 2336) = v17 + 1;
      v18 = *(_QWORD *)(v16 + 48);
      *(_QWORD *)(v16 + 2344) = v18;
      if ( PerformanceCounter.QuadPart <= v11 + v18 )
      {
        if ( a3 )
        {
      ...
      else
      {
        ...
        v22 = 28LL;
LABEL_34:
        WPP_RECORDER_AND_TRACE_SF_dD((__int64)v19->AttachedDevice, v20, v21, v22, v33, v34, v22, v35);
LABEL_35:
        if ( (unsigned int)RIMCmIsContactDeliveringAnyData(v16) )
        {
