/*
 * XREFs of ?AssignPointerId@Pointer@InputTraceLogging@@SAXPEBUCPointerInputFrame@@PEBUtagPOINTEREVENTINT@@@Z @ 0x1C01BAB84
 * Callers:
        ...
        const struct tagPOINTEREVENTINT *a2)
{
  ...
  if ( (unsigned int)dword_1C0289810 > 4 && tlgKeywordOn((__int64)&dword_1C0289810, 32LL) )
  {
    ...
    v12 = 8LL;
    v10 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0289810, (unsigned __int8 *)dword_1C025C9CB, 0LL, 0LL, 6u, &v8);
  }
}
