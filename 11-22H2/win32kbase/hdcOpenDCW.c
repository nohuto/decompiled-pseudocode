        ...
        int a9)
{
  ...
  if ( !MonitorDC )
  {
    ...
    if ( a5 )
    {
      ...
      {
        if ( v11
          && (!qword_1C0294AC8 ? (v36 = -1073741637) : (v36 = qword_1C0294AC8(SourceString, 0LL), v12 = 0LL),
              v36 >= 0 && qword_1C0294AD0) )
        {
          LOBYTE(v12) = 2;
          v37 = (struct _LDEV *)qword_1C0294AD0(*(_QWORD *)((v11 & -(__int64)(v11 != 0)) + 0x18), v12);
        }
        else
        {
          v37 = 0LL;
        ...
        if ( v37 )
        {
          ...
          else if ( v11 && (int)IsUMPD_ldevUnloadImageSupported() >= 0 && qword_1C0294AE0 )
          {
            qword_1C0294AE0(v37);
          }
        }
