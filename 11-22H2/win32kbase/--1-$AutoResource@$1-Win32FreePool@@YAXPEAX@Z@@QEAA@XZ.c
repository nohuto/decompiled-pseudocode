/*
 * XREFs of ??1?$AutoResource@$1?Win32FreePool@@YAXPEAX@Z@@QEAA@XZ @ 0x1C016B52C
 * Callers:
 *     EtwTraceTrappedAppContainerRender @ 0x1C016B810 (EtwTraceTrappedAppContainerRender.c)
 * Callees:
