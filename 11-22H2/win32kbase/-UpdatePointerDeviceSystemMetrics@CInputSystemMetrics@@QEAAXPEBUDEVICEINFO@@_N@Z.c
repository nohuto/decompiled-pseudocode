/*
 * XREFs of ?UpdatePointerDeviceSystemMetrics@CInputSystemMetrics@@QEAAXPEBUDEVICEINFO@@_N@Z @ 0x1C01FCA08
 * Callers:
 ...
 *     UpdatePointerDeviceSystemMetrics @ 0x1C01E9380 (UpdatePointerDeviceSystemMetrics.c)
 * Callees:
