/*
 * XREFs of NtUserGetPointerInfoList @ 0x1C0144EF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_46:
  ...
  if ( v19 )
  {
    ...
    if ( v12 > 0xFFFFFFFF )
      goto LABEL_45;
    CurrentProcessWow64Process = PsGetCurrentProcessWow64Process(v25, v15, 0xFFFFFFFFLL);
    ProbeForWrite(v19, (unsigned int)v12, CurrentProcessWow64Process != 0 ? 1 : 4);
  }
  v27 = 1;
  if ( v11 == 1 )
  {
    v28 = (_DWORD *)*((_QWORD *)PtiCurrentShared() + 169);
    v31 = 0LL;
    if ( !v28 || (*v28 & 1) == 0 )
    {
      v27 = 0;
...
LABEL_47:
    ...
    if ( v19 )
    {
      v33 = *((_QWORD *)PtiCurrentShared() + 169);
      v34 = *(_OWORD *)(v33 + 24);
      v48 = v34;
      v35 = *(_OWORD *)(v33 + 40);
      v49 = v35;
