/*
 * XREFs of ??0CTextVisualMarshaler@DirectComposition@@QEAA@XZ @ 0x1C020D944
 * Callers:
...
{
  DirectComposition::CVisualMarshaler::CVisualMarshaler((__int64)this, 185LL);
  *(_QWORD *)this = &DirectComposition::CTextVisualMarshaler::`vftable';
  *((_QWORD *)this + 47) = 0LL;
  *((_QWORD *)this + 48) = 0LL;
  *((_QWORD *)this + 49) = 0LL;
  *((_QWORD *)this + 50) = 0LL;
