/*
 * XREFs of ?EmitCreationCommand@?$CSharedResourceMarshaler@VCMatrixTransformMarshaler@DirectComposition@@$01@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1C020E0A0
 * Callers:
 *     <none>
 * Callees:
