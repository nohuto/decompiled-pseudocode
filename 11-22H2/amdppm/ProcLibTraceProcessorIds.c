/*
 * XREFs of ProcLibTraceProcessorIds @ 0x1C00225B8
 * Callers:
 *     ProcLibTraceControlCallback @ 0x1C00217C0 (ProcLibTraceControlCallback.c)
 * Callees:
 *     ProcLibGetProcessorNumber @ 0x1C0002B88 (ProcLibGetProcessorNumber.c)
...
char __fastcall ProcLibTraceProcessorIds(__int64 a1)
{
  ...
  v4 = 0;
  LOBYTE(ProcessorNumber) = EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Flink, &PPM_ETW_PROCESSOR_ID_RUNDOWN);
