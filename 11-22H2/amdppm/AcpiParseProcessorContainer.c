/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C0029DF8
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C0028CE8 (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x1C0003B78 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C0006278 (RtlUnicodeStringCopyString.c)
