/*
 * XREFs of RegisterKernelCStates @ 0x1C0033338
 * Callers:
...
__int64 __fastcall RegisterKernelCStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  unsigned __int8 v22; // [rsp+30h] [rbp-50h] BYREF
  ...
  if ( v3 && *(_DWORD *)v3 )
  {
    ...
    *(_DWORD *)(a3 + 56) = 0;
    ...
    if ( *(_BYTE *)(v3 + 16) != 1 )
    {
      ...
      HIWORD(v27) = 0;
      v28 = 0;
      DecodeAcpi2CState(a1, (unsigned int)&v27, (unsigned int)&v23, (unsigned int)&v22, a3 + 64);
      v8 = 2;
    ...
    for ( i = 0; i < *(_DWORD *)v3; ++v8 )
    {
      ...
      if ( v11 == v8 )
      {
        ...
        *v21 = v3 + 4 * (i + 4LL * i + 1);
        v26 = v3 + 4 * (i + 4LL * i + 1);
        if ( (int)DecodeAcpi2CState(
                    v7,
                    (unsigned int)v3 + 4 * (i + 4 * i + 1),
                    (unsigned int)&v23,
                    (unsigned int)&v22,
                    (__int64)v21) < 0 )
        {
