/*
 * XREFs of InitAcpiCpc @ 0x1C0024398
 * Callers:
 ...
 *     MapAdddressSpaceForGenAddr @ 0x1C0003BE8 (MapAdddressSpaceForGenAddr.c)
 ...
 *     GetSubspaceFromGenAddrEx @ 0x1C0005A8C (GetSubspaceFromGenAddrEx.c)
