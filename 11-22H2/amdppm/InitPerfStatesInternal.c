/*
 * XREFs of InitPerfStatesInternal @ 0x1C003282C
 * Callers:
 *     RegisterHvPerfStatesCounters @ 0x1C00258D0 (RegisterHvPerfStatesCounters.c)
 *     RegisterKernelPerfStates @ 0x1C0035140 (RegisterKernelPerfStates.c)
 * Callees:
...
__int64 __fastcall InitPerfStatesInternal(__int64 a1, int (__fastcall *a2)(__int64))
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00124D8,
    0LL);
  PerfDomain = GetPerfDomain(a1, (__int64)v50, &v51);
