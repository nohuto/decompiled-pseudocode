/*
 * XREFs of InitLegacyPccInternal @ 0x1C00088F0
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x1C0008F60 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x1C0025410 (RegisterHvLegacyPccCounters.c)
 * Callees:
