/*
 * XREFs of InitAcpi1CStates @ 0x1C00367C0
 * Callers:
...
__int64 __fastcall InitAcpi1CStates(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 272) |= v1 & 7;
  ...
  if ( (v1 & 2) != 0
    ...
    && IsValidAcpiGenericAddress((__int64)&dword_1C0012E1C)
    && IsValidAcpiGenericAddress(a1 + 184)
    && dword_1C00124D4 == v6 )
  {
  ...
  if ( (*(_BYTE *)(a1 + 280) & 4) != 0
    ...
    && IsValidAcpiGenericAddress((__int64)&dword_1C0012E34)
    && IsValidAcpiGenericAddress((__int64)&dword_1C0012E04)
    && IsValidAcpiGenericAddress((__int64)&dword_1C0012E1C)
    && IsValidAcpiGenericAddress(a1 + 184)
    && dword_1C00124D4 == 1 )
  {
