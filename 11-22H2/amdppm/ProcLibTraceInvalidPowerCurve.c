/*
 * XREFs of ProcLibTraceInvalidPowerCurve @ 0x1C003F084
 * Callers:
...
unsigned __int8 __fastcall ProcLibTraceInvalidPowerCurve(char a1, unsigned int a2, const void *a3)
{
  ...
  if ( (unsigned int)dword_1C00120F8 > 5 )
  {
    result = tlgKeywordOn();
    if ( result )
    {
      ...
      v19 = 2;
      v21 = v24;
      return tlgWriteTransfer_EtwWriteTransfer((__int64)v24, (unsigned __int8 *)dword_1C000F211, v6, v7, (ULONG)6, &v11);
    }
  }
  return result;
}
