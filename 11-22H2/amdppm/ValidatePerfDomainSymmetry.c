/*
 * XREFs of ValidatePerfDomainSymmetry @ 0x1C002FE84
 * Callers:
 ...
 *     ValidatePssSymmetry @ 0x1C0030464 (ValidatePssSymmetry.c)
 *     ValidateTssSymmetry @ 0x1C003059C (ValidateTssSymmetry.c)
 */
...
__int64 __fastcall ValidatePerfDomainSymmetry(__int64 a1)
{
  ...
  if ( (unsigned int)GetPerfDomain(a1, (__int64)v12, &v13) != 1 )
  {
    v4 = 0LL;
