/*
 * XREFs of ?OnStreamStopped@CApplicationManager@@QEAAJPEAVCProcess@@PEAUIAudioSessionInfo@@PEAUIAudioStreamInfo@@@Z @ 0x18000CD30
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_318849112bdacfedbf03f674f146fe6c__void_::_Do_call @ 0x180030D10 (std--_Func_impl_no_alloc__lambda_318849112bdacfedbf03f674f146fe6c__void_--_Do_call.c)
 * Callees:
 ...
 *     ?StreamTypeToString@@YAPEBGW4SYSTEM_AUDIO_STREAM_TYPE@@@Z @ 0x18003C3E8 (-StreamTypeToString@@YAPEBGW4SYSTEM_AUDIO_STREAM_TYPE@@@Z.c)
 *     McTemplateU0zqq_EventWriteTransfer @ 0x18003C40C (McTemplateU0zqq_EventWriteTransfer.c)
 *     WPP_SF_dSd @ 0x18003C4B0 (WPP_SF_dSd.c)
        ...
        struct IAudioStreamInfo *a4)
{
  ...
  if ( !(*(unsigned int (__fastcall **)(CProcess *))(*(_QWORD *)v30 + 96LL))(v30) )
    goto LABEL_12;
  v14 = (int)v29;
  if ( !dword_180054FD0[(unsigned int)v29] )
    goto LABEL_13;
