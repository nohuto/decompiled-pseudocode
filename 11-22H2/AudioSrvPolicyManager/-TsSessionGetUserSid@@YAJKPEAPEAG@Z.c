/*
 * XREFs of ?TsSessionGetUserSid@@YAJKPEAPEAG@Z @ 0x1800389C0
 * Callers:
 *     ?GetUserSid@CWindowsPolicyManager@@UEAAJKPEAPEAG@Z @ 0x18001CB20 (-GetUserSid@CWindowsPolicyManager@@UEAAJKPEAPEAG@Z.c)
