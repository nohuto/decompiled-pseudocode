/*
 * XREFs of ??1?$ComPtr@VCProcess@@@WRL@Microsoft@@QEAA@XZ @ 0x18002C6F8
 * Callers:
 *     _CApplicationManager::RpcGetProcess_::_1_::dtor$191 @ 0x180048F10 (_CApplicationManager--RpcGetProcess_--_1_--dtor$191.c)
 * Callees:
