/*
 * XREFs of ?_Desired_grow_bucket_count@?$_Hash@V?$_Umap_traits@KV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@2@V?$allocator@U?$pair@$$CBKV?$unique_ptr@VTSSession@@U?$default_delete@VTSSession@@@std@@@std@@@std@@@2@$0A@@std@@@std@@IEBA_K_K@Z @ 0x18003ABAC
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( a2 < 0 )
    ...
    v2 = (float)(int)a2;
  v3 = o_ceilf_0(v2 / *(float *)&dword_180063760);
  v4 = 0LL;
  if ( v3 >= 9.223372e18 )
  {
    v3 = v3 - 9.223372e18;
  ...
  if ( v5 > 8 )
    v6 = v5;
  result = qword_180063798;
  if ( qword_180063798 < v6 )
  {
    if ( (unsigned __int64)qword_180063798 < 0x200 && 8 * qword_180063798 >= v6 )
      return 8 * qword_180063798;
    return v6;
  }
  return result;
}
