/*
 * XREFs of ?SubscribeFeatureStateCacheToConfigurationChanges@details@wil@@YAXPEATwil_details_FeatureStateCache@@W4wil_FeatureChangeTime@@I@Z @ 0x180037E08
 * Callers:
        ...
        int a3)
{
  ...
  if ( wil::details::g_enabledStateManager )
  {
    ...
    if ( !a3
      ...
      || (v6 = a2,
          v7 = a1,
          !wil::details_abi::heap_buffer::push_back((wil::details_abi::heap_buffer *)&unk_180062CF8, &v6, 0x10uLL)) )
    {
