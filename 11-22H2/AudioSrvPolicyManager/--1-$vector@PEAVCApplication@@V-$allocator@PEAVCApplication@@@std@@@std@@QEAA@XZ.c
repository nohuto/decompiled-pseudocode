/*
 * XREFs of ??1?$vector@PEAVCApplication@@V?$allocator@PEAVCApplication@@@std@@@std@@QEAA@XZ @ 0x180011628
 * Callers:
 *     _TSSession::TSSession_::_1_::dtor$3 @ 0x18004ACEC (_TSSession--TSSession_--_1_--dtor$3.c)
 * Callees:
