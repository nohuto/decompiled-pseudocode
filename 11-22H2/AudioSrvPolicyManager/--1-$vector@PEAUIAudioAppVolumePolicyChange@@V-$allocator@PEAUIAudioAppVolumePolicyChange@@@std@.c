/*
 * XREFs of ??1?$vector@PEAUIAudioAppVolumePolicyChange@@V?$allocator@PEAUIAudioAppVolumePolicyChange@@@std@@@std@@QEAA@XZ @ 0x180012260
 * Callers:
 *     _CApplication::NotifyVolumePolicyChange_::_1_::dtor$0 @ 0x180049240 (_CApplication--NotifyVolumePolicyChange_--_1_--dtor$0.c)
 * Callees:
