/*
 * XREFs of ?UpdateStreamClassPolicyGains@CStreamClassPolicyGainsWrapper@@QEAAJPEBGKAEBV?$shared_ptr@VDuckingDescriptor@@@std@@HHPEAUIDuckingController@@PEAH@Z @ 0x18003269C
 * Callers:
