/*
 * XREFs of std::function_void___cdecl(void)_::function_void___cdecl(void)___lambda_80aa732c9f0abca8142808a505c7029f__0_ @ 0x18001AF4C
 * Callers:
