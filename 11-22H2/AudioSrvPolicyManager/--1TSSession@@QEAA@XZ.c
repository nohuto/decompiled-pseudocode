/*
 * XREFs of ??1TSSession@@QEAA@XZ @ 0x180034294
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1?WTSFreeMemory@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x1800341AC (--1-$unique_storage@U-$resource_policy@PEAU_WTSINFOW@@P6AXPEAX@Z$1-WTSFreeMemory@@YAX0@ZU-$integ.c)
