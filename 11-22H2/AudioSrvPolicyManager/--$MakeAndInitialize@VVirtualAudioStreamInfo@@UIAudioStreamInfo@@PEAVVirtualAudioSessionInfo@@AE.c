/*
 * XREFs of ??$MakeAndInitialize@VVirtualAudioStreamInfo@@UIAudioStreamInfo@@PEAVVirtualAudioSessionInfo@@AEAKW4SYSTEM_AUDIO_STREAM_TYPE@@@Details@WRL@Microsoft@@YAJPEAPEAUIAudioStreamInfo@@$$QEAPEAVVirtualAudioSessionInfo@@AEAK$$QEAW4SYSTEM_AUDIO_STREAM_TYPE@@@Z @ 0x18001B614
 * Callers:
