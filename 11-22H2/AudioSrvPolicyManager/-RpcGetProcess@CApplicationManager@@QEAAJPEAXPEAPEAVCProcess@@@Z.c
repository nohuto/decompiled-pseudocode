/*
 * XREFs of ?RpcGetProcess@CApplicationManager@@QEAAJPEAXPEAPEAVCProcess@@@Z @ 0x1800033F0
 * Callers:
 ...
 *     ?AppModelPolicy_GetPolicy_Internal@@YAJPEAXW4AppModelPolicy_Type@@PEAW4AppModelPolicy_PolicyValue@@PEAU_PS_PKG_CLAIM@@PEA_K@Z @ 0x1800052D0 (-AppModelPolicy_GetPolicy_Internal@@YAJPEAXW4AppModelPolicy_Type@@PEAW4AppModelPolicy_PolicyValu.c)
 ...
 *     wil::details::lambda_call__lambda_b81de5b61ed7f5026c21787e1275f92e___::reset @ 0x18001605C (wil--details--lambda_call__lambda_b81de5b61ed7f5026c21787e1275f92e___--reset.c)
 ...
 *     ?AddHead@?$CAtlList@PEAVCProcess@@V?$CElementTraits@PEAVCProcess@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAVCProcess@@@Z @ 0x180025A60 (-AddHead@-$CAtlList@PEAVCProcess@@V-$CElementTraits@PEAVCProcess@@@ATL@@@ATL@@QEAAPEAU__POSITION.c)
...
LABEL_67:
    p_pv = (unsigned __int16 *)&pv;
    LODWORD(v99) = _AllocStringWorker<CTCoAllocPolicy>(v30, v29, &unk_180053328, 0LL);
    if ( (int)v99 < 0 )
      goto LABEL_54;
  }
...
LABEL_71:
  ...
  LODWORD(v99) = _AllocStringWorker<CTCoAllocPolicy>(v40, v39, &unk_180053328, 0LL);
  if ( (int)v99 >= 0 )
  {
    v41 = v107;
    goto LABEL_71;
