/*
 * XREFs of _lambda_117ab22a4a29d5576a4fe046ebb851dc_::operator() @ 0x1800205C0
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_117ab22a4a29d5576a4fe046ebb851dc__long_IAudioSessionInfo___::_Do_call @ 0x180023220 (std--_Func_impl_no_alloc__lambda_117ab22a4a29d5576a4fe046ebb851dc__long_IAudioSessionInfo___--_D.c)
 * Callees:
...
__int64 __fastcall lambda_117ab22a4a29d5576a4fe046ebb851dc_::operator()(__int64 *a1, __int64 a2)
{
  ...
  try
  {
    ...
    v13[2] = v8;
    v14 = 257;
    CLockedList<CDuckingNotification,1,0>::ForEachEntry(v6 + 72, v13);
  }
