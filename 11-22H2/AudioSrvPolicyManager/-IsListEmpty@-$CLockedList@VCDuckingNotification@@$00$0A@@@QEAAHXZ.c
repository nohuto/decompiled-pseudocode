/*
 * XREFs of ?IsListEmpty@?$CLockedList@VCDuckingNotification@@$00$0A@@@QEAAHXZ @ 0x180021DE4
 * Callers:
...
_BOOL8 __fastcall CLockedList<CDuckingNotification,1,0>::IsListEmpty(__int64 a1)
{
  __int64 v2; // rdi
  __int64 v3; // rbx
