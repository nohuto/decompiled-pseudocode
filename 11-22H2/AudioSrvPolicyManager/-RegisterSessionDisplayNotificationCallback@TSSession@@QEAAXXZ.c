/*
 * XREFs of ?RegisterSessionDisplayNotificationCallback@TSSession@@QEAAXXZ @ 0x180037224
 * Callers:
 *     ?TsSessionIdLogon@@YAJK@Z @ 0x180039604 (-TsSessionIdLogon@@YAJK@Z.c)
 * Callees:
 *     ?_Log_Win32@in1diag3@details@wil@@YAXPEAXIPEBDK@Z @ 0x18001F03C (-_Log_Win32@in1diag3@details@wil@@YAXPEAXIPEBDK@Z.c)
 */
