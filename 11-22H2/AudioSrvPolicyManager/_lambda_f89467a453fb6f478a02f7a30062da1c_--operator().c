/*
 * XREFs of _lambda_f89467a453fb6f478a02f7a30062da1c_::operator() @ 0x180034BD4
 * Callers:
 *     ?TsSessionConsoleLockedNotificationCallback@@YAKPEAXK0@Z @ 0x180038300 (-TsSessionConsoleLockedNotificationCallback@@YAKPEAXK0@Z.c)
 * Callees:
...
__int64 __fastcall lambda_f89467a453fb6f478a02f7a30062da1c_::operator()(__int64 a1)
{
  __int64 v2; // rdi
  DWORD v3; // r14d
  int v4; // eax
