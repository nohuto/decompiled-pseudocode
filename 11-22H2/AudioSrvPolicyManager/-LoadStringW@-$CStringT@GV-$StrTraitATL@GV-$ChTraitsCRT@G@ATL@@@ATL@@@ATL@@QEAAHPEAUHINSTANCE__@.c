/*
 * XREFs of ?LoadStringW@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEAAHPEAUHINSTANCE__@@I@Z @ 0x18003F020
 * Callers:
 ...
 * Callees:
 *     _o_wmemcpy_s_0 @ 0x1800177FC (_o_wmemcpy_s_0.c)
 *     ?AtlCrtErrorCheck@ATL@@YAHH@Z @ 0x180025D1C (-AtlCrtErrorCheck@ATL@@YAHH@Z.c)
 ...
 *     ?_AtlGetStringResourceImage@ATL@@YAPEBUATLSTRINGRESOURCEIMAGE@1@PEAUHINSTANCE__@@PEAUHRSRC__@@I@Z @ 0x180040114 (-_AtlGetStringResourceImage@ATL@@YAPEBUATLSTRINGRESOURCEIMAGE@1@PEAUHINSTANCE__@@PEAUHRSRC__@@I@.c)
 */
        ...
        unsigned int a3)
{
  ...
  ATL::CSimpleStringT<unsigned short,0>::SetLength(a1, (unsigned int)v9);
  return 1LL;
}
