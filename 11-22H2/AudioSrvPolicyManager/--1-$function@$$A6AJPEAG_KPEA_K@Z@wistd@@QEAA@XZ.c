/*
 * XREFs of ??1?$function@$$A6AJPEAG_KPEA_K@Z@wistd@@QEAA@XZ @ 0x180033F90
 * Callers:
 ...
 *     _wil::details_abi::RawUsageIndex::Iterate_::_1_::dtor$0 @ 0x18004AE34 (_wil--details_abi--RawUsageIndex--Iterate_--_1_--dtor$0.c)
 * Callees:
 *     _guard_xfg_dispatch_icall_nop @ 0x180048B60 (_guard_xfg_dispatch_icall_nop.c)
 */

__int64 __fastcall wistd::function<long (unsigned short *,unsigned __int64,unsigned __int64 *)>::~function<long (unsigned short *,unsigned __int64,unsigned __int64 *)>(
        __int64 a1)
{
  __int64 v1; // rcx
  __int64 result; // rax
