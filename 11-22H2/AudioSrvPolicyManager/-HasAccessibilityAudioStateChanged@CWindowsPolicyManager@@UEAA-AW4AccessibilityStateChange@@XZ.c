/*
 * XREFs of ?HasAccessibilityAudioStateChanged@CWindowsPolicyManager@@UEAA?AW4AccessibilityStateChange@@XZ @ 0x180002CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowsPolicyManager::HasAccessibilityAudioStateChanged(__int64 a1)
{
  ...
  v9 = *(_QWORD *)(qword_180063778 + 16 * (qword_180063790 & v8) + 8);
...
LABEL_25:
  ...
  EnterCriticalSection(&stru_1800636C8);
  EnterCriticalSection(&stru_1800636C8);
  v17 = (_QWORD *)(qword_180063778 + 16 * (qword_180063790 & v8));
  v18 = v17[1];
...
LABEL_38:
  ...
  v41 = 0LL;
  EnterCriticalSection(&stru_1800636C8);
  v22 = *(_QWORD *)(qword_180063778 + 16 * (qword_180063790 & v8) + 8);
  if ( v22 == qword_180063768 )
  {
LABEL_39:
    v22 = 0LL;
  }
  else
  {
    ...
    {
      if ( v22 == *(_QWORD *)(qword_180063778 + 16 * (qword_180063790 & v8)) )
        goto LABEL_39;
      v22 = *(_QWORD *)(v22 + 8);
    }
  }
...
LABEL_41:
      ...
      v38 = 0LL;
      EnterCriticalSection(&stru_1800636C8);
      v26 = 2 * (qword_180063790 & v8);
      v27 = *(_QWORD *)(qword_180063778 + 8 * v26 + 8);
      if ( v27 == qword_180063768 )
      {
LABEL_50:
        v27 = 0LL;
      }
      else
      {
        ...
        {
          if ( v27 == *(_QWORD *)(qword_180063778 + 8 * v26) )
            goto LABEL_50;
          v27 = *(_QWORD *)(v27 + 8);
        }
      }
