/*
 * XREFs of ?OnApplicationInteractivityChanged@CApplicationManager@@QEAAXPEAVCApplication@@@Z @ 0x180006EE0
 * Callers:
 ...
 *     ?RawCategory@CProcess@@QEAA?AW4_APPLICATION_CATEGORY@@XZ @ 0x1800286C8 (-RawCategory@CProcess@@QEAA-AW4_APPLICATION_CATEGORY@@XZ.c)
 ...
 *     ?GrantExemptionForBCMStartupLatency@@YAHXZ @ 0x18002CE00 (-GrantExemptionForBCMStartupLatency@@YAHXZ.c)
...
LABEL_216:
      ...
      else
      {
        ...
        if ( dword_1800522B0[v17] )
        {
          ...
          if ( a2 != (struct CApplication *)-32LL )
            LeaveCriticalSection((LPCRITICAL_SECTION)((char *)a2 + 32));
          if ( !dword_1800522B0[v16] && *((_DWORD *)a2 + 54) )
