/*
 * XREFs of ?ResetProcessDataFlowAccessCheckResults@CApplicationManager@@QEAAXPEBG0@Z @ 0x18002F158
 * Callers:
 *     ?SetProcessDataFlowAccessCheckResults@CWindowsPolicyManager@@UEAAJPEBG00@Z @ 0x18001EA00 (-SetProcessDataFlowAccessCheckResults@CWindowsPolicyManager@@UEAAJPEBG00@Z.c)
 * Callees:
 ...
 *     ?ResetDataFlowAccessCheckResults@CProcess@@QEAAXXZ @ 0x1800292A8 (-ResetDataFlowAccessCheckResults@CProcess@@QEAAXXZ.c)
 */
