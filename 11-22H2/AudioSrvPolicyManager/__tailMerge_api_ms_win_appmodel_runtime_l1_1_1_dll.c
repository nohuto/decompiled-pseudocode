/*
 * XREFs of __tailMerge_api_ms_win_appmodel_runtime_l1_1_1_dll @ 0x180017DAC
 * Callers:
 *     __imp_load_ParseApplicationUserModelId @ 0x180017DA0 (__imp_load_ParseApplicationUserModelId.c)
 * Callees:
