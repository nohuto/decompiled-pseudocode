/*
 * XREFs of ?CreateInstance@CHostedAppInteractivity@@SAJPEBG_KKPEAPEAV1@@Z @ 0x180030450
 * Callers:
  ...
  if ( v8 )
  {
    ...
    *((_QWORD *)v8 + 2) = a2;
    do
      ++v12;
    while ( a1[v12] );
    v13 = _AllocStringWorker<CTCoAllocPolicy>(v10, v9, a1, v12, v15, (unsigned __int16 **)v8);
    if ( v13 >= 0 )
    {
      *a4 = v11;
