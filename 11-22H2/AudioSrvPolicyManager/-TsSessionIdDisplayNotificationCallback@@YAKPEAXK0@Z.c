/*
 * XREFs of ?TsSessionIdDisplayNotificationCallback@@YAKPEAXK0@Z @ 0x180039180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TsSessionIdDisplayNotificationCallback(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  *((_DWORD *)v22 + 253) = v9;
  ...
  if ( v8 == v9
    ...
    || (v18 = off_18004FF70, v19 = v4, v20 = &v18, v13 = QueueGenericWorkItem((__int64 *)&v18), v14 = v13, v13 >= 0) )
  {
LABEL_12:
    v14 = 0;
  }
