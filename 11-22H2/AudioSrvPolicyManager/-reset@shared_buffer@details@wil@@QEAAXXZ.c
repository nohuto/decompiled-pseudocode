/*
 * XREFs of ?reset@shared_buffer@details@wil@@QEAAXXZ @ 0x18001AD3C
 * Callers:
 ...
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x18001AB48 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
