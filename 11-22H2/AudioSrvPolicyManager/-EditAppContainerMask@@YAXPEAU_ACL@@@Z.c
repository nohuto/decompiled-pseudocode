/*
 * XREFs of ?EditAppContainerMask@@YAXPEAU_ACL@@@Z @ 0x180045614
 * Callers:
 ...
 *     ??1?$unique_storage@U?$resource_policy@PEAXP6APEAXPEAX@Z$1?FreeSid@@YAPEAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x180044414 (--1-$unique_storage@U-$resource_policy@PEAXP6APEAXPEAX@Z$1-FreeSid@@YAPEAX0@ZU-$integral_constan.c)
 */
