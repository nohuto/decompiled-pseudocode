/*
 * XREFs of ?ReadBackgroundAudioPlaybackCapability@CApplicationManager@@QEAAJPEAXPEAH1@Z @ 0x18002E4E8
 * Callers:
        ...
        int *a4)
{
  ...
  *a4 = 0;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_7bcb4e64156732b2305239eaa24ad5b8_Traceguids, v6);
  }
  if ( (_BYTE)v9 )
  {
    *a3 = 1;
