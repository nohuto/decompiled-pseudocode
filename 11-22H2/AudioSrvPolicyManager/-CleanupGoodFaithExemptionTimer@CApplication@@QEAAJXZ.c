/*
 * XREFs of ?CleanupGoodFaithExemptionTimer@CApplication@@QEAAJXZ @ 0x18002635C
 * Callers:
...
__int64 __fastcall CApplication::CleanupGoodFaithExemptionTimer(const wchar_t **this)
{
  ...
  if ( this[53] )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x16u, &WPP_d2b18dfaf0d53a5ff7c874f5bc62056c_Traceguids, this[3]);
    }
