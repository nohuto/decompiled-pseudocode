/*
 * XREFs of _lambda_4d96e95c7f1dfdf18ba3c0829eb40359_::operator() @ 0x180034630
 * Callers:
 ...
 *     ??1_Flist_node_remove_op@?$forward_list@V?$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x180034460 (--1_Flist_node_remove_op@-$forward_list@V-$com_ptr_t@VCProcess@@Uerr_returncode_policy@wil@@@wil.c)
 *     ?TsSessionMayBeDeleted@@YA_NPEAVTSSession@@@Z @ 0x180039BF8 (-TsSessionMayBeDeleted@@YA_NPEAVTSSession@@@Z.c)
...
__int64 __fastcall lambda_4d96e95c7f1dfdf18ba3c0829eb40359_::operator()(__int64 **a1)
{
  int v2; // eax
  unsigned int v3; // ebx
  __int64 *v5; // rax
