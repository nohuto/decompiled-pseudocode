/*
 * XREFs of ??$?0PEAVAssignedAccessConfigStoreV1@AssignedAccess@Internal@Windows@@U?$default_delete@VAssignedAccessConfigStoreV1@AssignedAccess@Internal@Windows@@@wistd@@@?$__compressed_pair@PEAVAssignedAccessConfigStoreBase@AssignedAccess@Internal@Windows@@U?$default_delete@VAssignedAccessConfigStoreBase@AssignedAccess@Internal@Windows@@@wistd@@@wistd@@QEAA@$$QEAPEAVAssignedAccessConfigStoreV1@AssignedAccess@Internal@Windows@@$$QEAU?$default_delete@VAssignedAccessConfigStoreV1@AssignedAccess@Internal@Windows@@@1@@Z @ 0x180010F8C
 * Callers:
