/*
 * XREFs of ?TsSessionIsActiveMediaApplication@@YA_NPEAVCApplication@@@Z @ 0x180039A30
 * Callers:
...
char __fastcall TsSessionIsActiveMediaApplication(struct CApplication *a1)
{
  ...
  CApplicationManager::Lock((__int64)a1, &v5);
  v2 = 0;
  ...
  {
    for ( i = (struct CApplication **)*((_QWORD *)v6 + 6); i != *((struct CApplication ***)v6 + 7); ++i )
    {
      if ( *i == a1 )
      {
        v2 = 1;
