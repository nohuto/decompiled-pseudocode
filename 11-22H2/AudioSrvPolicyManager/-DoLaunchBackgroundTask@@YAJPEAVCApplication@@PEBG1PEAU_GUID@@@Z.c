/*
 * XREFs of ?DoLaunchBackgroundTask@@YAJPEAVCApplication@@PEBG1PEAU_GUID@@@Z @ 0x1800351C4
 * Callers:
        ...
        struct _GUID *a4)
{
  ...
  struct TSSession *v28; // [rsp+80h] [rbp-80h] BYREF
  ULONG ReturnLength; // [rsp+88h] [rbp-78h] BYREF
  struct _RTL_CRITICAL_SECTION *v30[2]; // [rsp+90h] [rbp-70h] BYREF
  _QWORD TokenInformation[12]; // [rsp+A0h] [rbp-60h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+158h] [rbp+58h]

  CApplicationManager::Lock((__int64)a1, v30);
  v8 = TsSessionFromSessionId(*((_DWORD *)a1 + 53), 0, &v28);
  v9 = v8;
  if ( v8 >= 0 )
  {
...
LABEL_6:
    ...
    if ( v14 >= 0 )
    {
      ...
      if ( v14 >= 0 )
      {
        ...
        if ( *((_QWORD *)v16 + 132) )
          goto LABEL_23;
        v20 = Microsoft::WRL::Details::Make<CBackgroundSessionCallbacks,>(&v28);
        v21 = *v20;
        *v20 = 0LL;
        v22 = *((_QWORD *)v16 + 132);
        *((_QWORD *)v16 + 132) = v21;
...
LABEL_23:
          v27 = 0;
          v23 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, _QWORD, unsigned int *))(*(_QWORD *)*v17 + 24LL))(
                  *v17,
                  TokenInformation[0],
                  702LL,
                  *((_QWORD *)v16 + 132),
          ...
          if ( v23 >= 0 )
          {
            v24 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, const unsigned __int16 *, const unsigned __int16 *, _QWORD, _QWORD, _DWORD, _QWORD, _QWORD, struct _GUID *))(*(_QWORD *)*v17 + 56LL))(
                    *v17,
                    TokenInformation[0],
                    0LL,
                    v27,
