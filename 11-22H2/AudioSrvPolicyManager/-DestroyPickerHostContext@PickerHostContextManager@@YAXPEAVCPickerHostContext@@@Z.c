/*
 * XREFs of ?DestroyPickerHostContext@PickerHostContextManager@@YAXPEAVCPickerHostContext@@@Z @ 0x18003054C
 * Callers:
 *     ?HHOSTEDAPPMANAGERCONTEXTRundown@@YAXPEAX@Z @ 0x180030EB0 (-HHOSTEDAPPMANAGERCONTEXTRundown@@YAXPEAX@Z.c)
 * Callees:
 ...
 *     ?Find@?$CAtlList@PEAVCPickerHostContext@@V?$CElementTraits@PEAVCPickerHostContext@@@ATL@@@ATL@@QEBAPEAU__POSITION@@AEBQEAVCPickerHostContext@@PEAU3@@Z @ 0x180016180 (-Find@-$CAtlList@PEAVCPickerHostContext@@V-$CElementTraits@PEAVCPickerHostContext@@@ATL@@@ATL@@Q.c)
        ...
        struct CPickerHostContext *a2)
{
  ...
  if ( v4 )
  {
    if ( v4 == (_QWORD *)PickerHostContextManager::s_PickerHostContextList )
      PickerHostContextManager::s_PickerHostContextList = *v4;
    else
      *(_QWORD *)v4[1] = *v4;
    if ( v4 == (_QWORD *)qword_180062C80 )
      qword_180062C80 = v4[1];
    else
      *(_QWORD *)(*v4 + 8LL) = v4[1];
