/*
 * XREFs of ?GetPolicyVolumeForAudioStream@@YAXPEAUIAudioPolicyManager@@PEAUIAudioStreamPolicyVolumeClient@@PEBU_tlgProvider_t@@PEAMPEA_JW4GPV_REASON@@@Z @ 0x1800118D0
 * Callers:
 ...
 *     ?GetSoundLevelForExtendedAudioCategory@AudioStateMonitorManager@@AEAA?AW4__MIDL___MIDL_itf_audiosrv_0000_0000_0004@@PEAW4AUDIO_DIRECTION@@PEAKPEBG@Z @ 0x180011800 (-GetSoundLevelForExtendedAudioCategory@AudioStateMonitorManager@@AEAA-AW4__MIDL___MIDL_itf_audio.c)
 * Callees:
...
__int64 __fastcall GetPolicyVolumeForAudioStream(__int64 a1, __int64 *a2, __int64 a3, float *a4)
{
  ...
  *a4 = v12;
  if ( v12 > 0.0 && (*(unsigned int (__fastcall **)(__int64 *))(*a2 + 72))(a2) != 2 )
  {
    ...
    *a4 = v13 * *a4;
    if ( v38
      && !(*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v38 + 48LL))(v38)
  ...
  if ( *a4 > 0.0 && (*(unsigned int (__fastcall **)(__int64 *))(*a2 + 56))(a2) != 24 )
  {
    v14 = (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)a1 + 272LL))(a1)
       && !(*(unsigned __int8 (__fastcall **)(__int64 *))(*a2 + 64))(a2)
       && dword_1800557D0[(*(unsigned int (__fastcall **)(__int64 *))(*a2 + 56))(a2)]
        ? 0.0
        : FLOAT_1_0;
    v15 = v14 * *a4;
    *a4 = v15;
    ...
    if ( v16(a1, v36, v17) )
      ...
      v15 = FLOAT_1_0;
    *a4 = v15 * *a4;
    v18 = (*(float (__fastcall **)(__int64, __int64 *))(*(_QWORD *)a1 + 280LL))(a1, a2) * *a4;
    *a4 = v18;
    if ( v18 > 0.0 )
    {
      if ( (*(__int64 (__fastcall **)(__int64 *))(*a2 + 40))(a2) )
      {
        v19 = *(float (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)a1 + 352LL);
        ...
        *a4 = v28;
        if ( (*(unsigned __int8 (__fastcall **)(__int64 *))(*a2 + 64))(a2)
          || (v29 = *(unsigned int (__fastcall **)(__int64, _QWORD))(*(_QWORD *)a1 + 88LL),
