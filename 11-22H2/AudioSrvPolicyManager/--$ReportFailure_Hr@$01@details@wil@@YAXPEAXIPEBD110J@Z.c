/*
 * XREFs of ??$ReportFailure_Hr@$01@details@wil@@YAXPEAXIPEBD110J@Z @ 0x180018460
 * Callers:
 ...
 *     ?GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z @ 0x180015A1C (-GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z.c)
 ...
 *     ??$ReportFailure_Base@$01$0A@@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailureOptions@01@@Z @ 0x180018350 (--$ReportFailure_Base@$01$0A@@details@wil@@YAXPEAXIPEBD110AEBUResultStatus@01@PEBGW4ReportFailur.c)
 */
        ...
        wil::details *a7)
{
  ...
  v15 = v13;
  v14 = v12;
  return wil::details::ReportFailure_Base<2,0>(a1, v10, v9, v8, a5, a6, (__int64)&v14, 0LL);
}
