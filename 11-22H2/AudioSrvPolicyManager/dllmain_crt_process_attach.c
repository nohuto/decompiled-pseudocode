/*
 * XREFs of dllmain_crt_process_attach @ 0x180016428
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x180016BD8 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x180016CBC (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x180016D5C (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180017284 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x1800172AC (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800172D0 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x1800172F0 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x180017444 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800176B6 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800176C2 (_initterm_e_0.c)
