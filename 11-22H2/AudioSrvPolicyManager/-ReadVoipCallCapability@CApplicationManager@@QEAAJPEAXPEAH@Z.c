/*
 * XREFs of ?ReadVoipCallCapability@CApplicationManager@@QEAAJPEAXPEAH@Z @ 0x18002E854
 * Callers:
...
__int64 __fastcall CApplicationManager::ReadVoipCallCapability(CApplicationManager *this, void *a2, int *a3)
{
  ...
  *a3 = 0;
  LOBYTE(v8) = 0;
  v5 = CapabilityCheck(a2, L"voipCall", &v8);
  v6 = v5 < 0;
  if ( v5 > 0 )
  {
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x12u, &WPP_7bcb4e64156732b2305239eaa24ad5b8_Traceguids, v5);
  }
