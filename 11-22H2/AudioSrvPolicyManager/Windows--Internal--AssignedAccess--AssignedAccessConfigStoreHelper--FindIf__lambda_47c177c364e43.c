/*
 * XREFs of Windows::Internal::AssignedAccess::AssignedAccessConfigStoreHelper::FindIf__lambda_47c177c364e43d13bff9c3e398002cbd___ @ 0x180047808
 * Callers:
        ...
        __int64 a2)
{
  ...
  while ( v6 != &v13 )
  {
    ...
    if ( *(_DWORD *)(a2 + 24) <= (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)*v6 + 32LL))(*v6)
      && (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v7 + 24LL))(v7) )
    {
      if ( v5 )
        (**v5)(v5, 1LL);
      if ( v4 )
