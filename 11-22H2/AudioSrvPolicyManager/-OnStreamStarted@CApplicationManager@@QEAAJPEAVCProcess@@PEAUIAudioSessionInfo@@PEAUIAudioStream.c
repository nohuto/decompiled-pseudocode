/*
 * XREFs of ?OnStreamStarted@CApplicationManager@@QEAAJPEAVCProcess@@PEAUIAudioSessionInfo@@PEAUIAudioStreamInfo@@@Z @ 0x180005E70
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_78bc9aa717e0c7ae8337a2b0ddd14613__void_::_Do_call @ 0x180030D30 (std--_Func_impl_no_alloc__lambda_78bc9aa717e0c7ae8337a2b0ddd14613__void_--_Do_call.c)
 * Callees:
        ...
        struct IAudioStreamInfo *a4)
{
  ...
  if ( !v14 )
    goto LABEL_13;
  v16 = (int)v73;
  if ( !dword_180054FD0[(unsigned int)v73] )
    goto LABEL_14;
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_dSS(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      (unsigned int)off_180050628[v36],
      (_DWORD)WPP_GLOBAL_Control,
      *((_DWORD *)v34 + 40),
      (__int64)off_180050628[v35],
      (__int64)off_180050628[v36]);
  }
