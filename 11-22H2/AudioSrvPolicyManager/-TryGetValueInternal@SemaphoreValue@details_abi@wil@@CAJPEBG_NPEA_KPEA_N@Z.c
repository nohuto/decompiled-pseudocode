/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x18001A768
 * Callers:
        ...
        bool *a4)
{
  ...
  *a3 = 0LL;
  ...
  StringCchCatW(pszDest, v6, (size_t *)L"_p0");
  ...
  if ( v7 )
  {
    ...
    {
      StringCchCatW(pszDest, v11, (size_t *)L"h");
      v13 = (wil::details *)OpenSemaphoreW(0x1F0003u, 0, pszDest);
      v22 = v13;
      if ( !v13 )
      {
        LastError = wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0xD5, (int)"wil", v14);
      ...
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0xD7, (int)"wil", (const char *)(unsigned int)v16);
      __1__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__IEAA_XZ(
        &v22,
        v18);
    }
  ...
  {
    LastError = wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0xC9, (int)"wil", v9);
  }
LABEL_12:
  __1__unique_storage_U__resource_policy_PEAXP6AXPEAX__E_1_CloseHandle_details_wil__YAX0_ZU__integral_constant__K_0A__wistd__PEAXPEAX_0A___T_details_wil___details_wil__IEAA_XZ(
    &v23,
