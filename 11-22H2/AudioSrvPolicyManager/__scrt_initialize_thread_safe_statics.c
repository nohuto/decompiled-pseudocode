/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x180016F20
 * Callers:
 *     <none>
 * Callees:
...
__int64 _scrt_initialize_thread_safe_statics()
{
  ...
  InitializeCriticalSectionAndSpinCount(&stru_180063368, 0xFA0u);
  ...
  if ( ProcAddress && v2 )
  {
    qword_180063390 = (__int64)ProcAddress;
    qword_180063398 = (__int64)v2;
    goto LABEL_7;
  }
