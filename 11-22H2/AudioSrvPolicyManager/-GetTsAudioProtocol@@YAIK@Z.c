/*
 * XREFs of ?GetTsAudioProtocol@@YAIK@Z @ 0x180046C04
 * Callers:
 ...
 *     IsWinStationIsSessionRemoteablePresent @ 0x180018198 (IsWinStationIsSessionRemoteablePresent.c)
 *     IsWTSQuerySessionInformationWPresent @ 0x1800182C0 (IsWTSQuerySessionInformationWPresent.c)
 */
