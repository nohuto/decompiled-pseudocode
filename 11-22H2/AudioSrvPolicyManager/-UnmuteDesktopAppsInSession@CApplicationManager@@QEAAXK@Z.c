/*
 * XREFs of ?UnmuteDesktopAppsInSession@CApplicationManager@@QEAAXK@Z @ 0x18002F6FC
 * Callers:
...
void __fastcall CApplicationManager::UnmuteDesktopAppsInSession(CApplicationManager *this, int a2)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x26u, &WPP_7bcb4e64156732b2305239eaa24ad5b8_Traceguids, a2);
  }
