/*
 * XREFs of ??$?4VDuckingDescriptor@@U?$default_delete@VDuckingDescriptor@@@std@@@?$shared_ptr@VDuckingDescriptor@@@std@@QEAAAEAV01@$$QEAV?$unique_ptr@VDuckingDescriptor@@U?$default_delete@VDuckingDescriptor@@@std@@@1@@Z @ 0x18001F550
 * Callers:
...
_QWORD *__fastcall std::shared_ptr<DuckingDescriptor>::operator=<DuckingDescriptor,std::default_delete<DuckingDescriptor>>(
        _QWORD *a1,
        __int64 *a2)
{
  __int64 v2; // rdi
