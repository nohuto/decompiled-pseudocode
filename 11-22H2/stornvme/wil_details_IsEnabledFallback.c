/*
 * XREFs of wil_details_IsEnabledFallback @ 0x1C0004074
 * Callers:
 ...
 *     wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x1C0003ED4 (wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath.c)
 */
