/*
 * XREFs of wil_RtlStagingConfig_QueryFeatureState @ 0x1C0003838
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C0003F18 (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
