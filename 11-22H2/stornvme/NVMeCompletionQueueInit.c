/*
 * XREFs of NVMeCompletionQueueInit @ 0x1C000C818
 * Callers:
 *     AdminQueueInitialize @ 0x1C0009314 (AdminQueueInitialize.c)
 *     IoQueuesInitialize @ 0x1C000B10C (IoQueuesInitialize.c)
 * Callees:
 *     NVMeCompletionQueuesDedicatedSubmissionQueuesInit @ 0x1C000CA1C (NVMeCompletionQueuesDedicatedSubmissionQueuesInit.c)
 *     NVMeCompletionQueuesSubmissionQueuesInit @ 0x1C000CAB0 (NVMeCompletionQueuesSubmissionQueuesInit.c)
 */
  ...
  if ( (_WORD)v9 && (unsigned __int16)v9 <= *(_WORD *)(a1 + 340) )
  {
    ...
    *(_QWORD *)(a2 + 344) = a2;
    if ( (*(_DWORD *)(a1 + 4044) & 2) != 0 )
      ...
      v16 = 4106LL;
    result = StorPortNotification(v16, a1, a2 + 264);
    if ( *(_DWORD *)(a2 + 252) )
    {
      v18 = (_QWORD *)(a2 + 256);
      if ( !*v18 )
      {
        result = StorPortExtendedFunction(0LL, a1, 8 * (unsigned int)*(unsigned __int16 *)(a1 + 242));
        if ( *v18 )
        {
          if ( *(_WORD *)(a1 + 242) )
          {
