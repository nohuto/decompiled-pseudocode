/*
 * XREFs of NVMePowerActive @ 0x1C00035C0
 * Callers:
 *     NVMeHwAdapterControl @ 0x1C0003550 (NVMeHwAdapterControl.c)
 * Callees:
 *     NVMePerfStateTransition @ 0x1C000364C (NVMePerfStateTransition.c)
  ...
  if ( *(_BYTE *)(a2 + 20) )
  {
    if ( (result & 0x20) != 0 )
    {
      ...
      *(_DWORD *)(a1 + 1880) = result & 0xFFFFFFDF;
      StorPortExtendedFunction(33LL, a1, v4);
    }
    result = StorPortExtendedFunction(51LL, a1, 0LL);
