/*
 * XREFs of wil_details_FeatureStateCache_TryEnableDeviceUsageFastPath @ 0x1C0003ED4
 * Callers:
 *     wil_details_IsEnabledFallback @ 0x1C0004074 (wil_details_IsEnabledFallback.c)
 * Callees:
 *     <none>
 */
