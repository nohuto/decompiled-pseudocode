/*
 * XREFs of FormInquiryStandardData @ 0x1C00127C4
 * Callers:
 ...
 *     GetSrbScsiAddress @ 0x1C0007C54 (GetSrbScsiAddress.c)
 *     NVMeCopyFirmwareRevision @ 0x1C0014FB0 (NVMeCopyFirmwareRevision.c)
...
LABEL_8:
  ...
  StorPortExtendedFunction(46LL, a1, *(_QWORD *)(a1 + 8 * v6 + 1952));
  return v16;
}
