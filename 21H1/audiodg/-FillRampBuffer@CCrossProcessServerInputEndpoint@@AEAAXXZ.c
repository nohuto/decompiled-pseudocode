/*
 * XREFs of ?FillRampBuffer@CCrossProcessServerInputEndpoint@@AEAAXXZ @ 0x140015E1C
 * Callers:
...
void __fastcall CCrossProcessServerInputEndpoint::FillRampBuffer(CCrossProcessServerInputEndpoint *this)
{
  ...
  v7 = *(_QWORD *)(v6 + 16);
  v8 = *(_QWORD *)(v6 + 24);
  if ( CCrossProcessBaseEndpoint::IsValidOffset(this, v7)
    && CCrossProcessBaseEndpoint::IsValidOffset(this, v8)
    && v7 >= v8 )
  {
    v9 = *((_QWORD *)this + 10);
    v10 = v7 - v8;
    v11 = *(_DWORD *)(v9 + 160) + (unsigned int)(v8 % *((unsigned int *)this + 38));
    if ( v1 >= v10 )
      v1 = v10;
