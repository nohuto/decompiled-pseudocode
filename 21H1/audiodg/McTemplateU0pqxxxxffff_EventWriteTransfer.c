/*
 * XREFs of McTemplateU0pqxxxxffff_EventWriteTransfer @ 0x140058DB8
 * Callers:
 ...
 *     ?GetPosition@CCrossProcessClientInputEndpoint@@UEAAJPEA_K0@Z @ 0x140059BF0 (-GetPosition@CCrossProcessClientInputEndpoint@@UEAAJPEA_K0@Z.c)
