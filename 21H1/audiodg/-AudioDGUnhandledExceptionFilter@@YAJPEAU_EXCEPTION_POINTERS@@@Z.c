/*
 * XREFs of ?AudioDGUnhandledExceptionFilter@@YAJPEAU_EXCEPTION_POINTERS@@@Z @ 0x140037190
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?TrackAPOFailureUnhandled@CSystemAudioDeviceSharedBase@@QEAAXM@Z @ 0x140039E90 (-TrackAPOFailureUnhandled@CSystemAudioDeviceSharedBase@@QEAAXM@Z.c)
 */
...
__int64 __fastcall AudioDGUnhandledExceptionFilter(struct _EXCEPTION_POINTERS *ExceptionInfo)
{
  ...
  if ( (_DWORD)qword_140085218 )
  {
    ...
    if ( *v3 > 2u )
    {
      ...
      v8 = &v6;
      v9 = 4LL;
      tlgWriteTransfer_EtwEventWriteTransfer((__int64)v3, byte_140071D16, 0LL, 0LL, 3, (__int64)v7);
    }
    if ( v1 )
    {
      do
