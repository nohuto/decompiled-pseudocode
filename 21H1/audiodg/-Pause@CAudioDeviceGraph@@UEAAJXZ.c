/*
 * XREFs of ?Pause@CAudioDeviceGraph@@UEAAJXZ @ 0x140004760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioDeviceGraph::Pause(CAudioDeviceGraph *this)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
    {
      ...
      v20 = 8;
      v17 = 4;
      tlgWriteTransfer_EtwEventWriteTransfer(v6, (unsigned int)&unk_140071DB2, (_DWORD)this + 352, 0, 5, (__int64)v15);
    }
    v4 = 0;
  }
  if ( v1 )
