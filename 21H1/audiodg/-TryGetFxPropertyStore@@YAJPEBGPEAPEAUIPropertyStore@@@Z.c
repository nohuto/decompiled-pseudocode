/*
 * XREFs of ?TryGetFxPropertyStore@@YAJPEBGPEAPEAUIPropertyStore@@@Z @ 0x14000A940
 * Callers:
...
__int64 __fastcall TryGetFxPropertyStore(const unsigned __int16 *a1, struct IPropertyStore **a2)
{
  ...
  int v6; // eax
  __int64 v7; // rcx
  void (__fastcall ***v8)(_QWORD, GUID *, _QWORD *); // rax
  int v9; // eax
  int ppv; // [rsp+20h] [rbp-28h]
  wil::details::in1diag3 *retaddr; // [rsp+48h] [rbp+0h]
  void (__fastcall ***v13)(_QWORD, GUID *, __int64 *); // [rsp+58h] [rbp+10h] BYREF
  __int64 v14; // [rsp+60h] [rbp+18h] BYREF
  LPVOID v15; // [rsp+68h] [rbp+20h] BYREF
