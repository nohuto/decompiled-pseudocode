/*
 * XREFs of _dynamic_initializer_for__g_CrossProcessTelemetryProviderRegistration__ @ 0x1400012C0
 * Callers:
 *     <none>
 * Callees:
...
{
  TraceLoggingRegisterEx_EventRegister_EventSetInformation(&dword_140084010);
