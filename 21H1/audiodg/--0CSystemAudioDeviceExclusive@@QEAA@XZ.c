/*
 * XREFs of ??0CSystemAudioDeviceExclusive@@QEAA@XZ @ 0x140037970
 * Callers:
 ...
 *     ??0?$CComObject@VCSystemAudioDeviceExclusive@@@ATL@@QEAA@PEAX@Z @ 0x140037900 (--0-$CComObject@VCSystemAudioDeviceExclusive@@@ATL@@QEAA@PEAX@Z.c)
 * Callees:
 *     ??0CSystemAudioDeviceBase@@QEAA@XZ @ 0x140012C14 (--0CSystemAudioDeviceBase@@QEAA@XZ.c)
 */
