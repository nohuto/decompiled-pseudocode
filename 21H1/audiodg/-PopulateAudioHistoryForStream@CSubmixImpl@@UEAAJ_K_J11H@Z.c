/*
 * XREFs of ?PopulateAudioHistoryForStream@CSubmixImpl@@UEAAJ_K_J11H@Z @ 0x1400447A0
 * Callers:
 *     ?PopulateAudioHistoryForStream@CStreamGroup@@UEAAJ_K_J11H@Z @ 0x140033AC0 (-PopulateAudioHistoryForStream@CStreamGroup@@UEAAJ_K_J11H@Z.c)
 *     ?PopulateAudioHistoryForStream@CProcessSubmix@@UEAAJ_K_J11H@Z @ 0x140045080 (-PopulateAudioHistoryForStream@CProcessSubmix@@UEAAJ_K_J11H@Z.c)
 * Callees:
