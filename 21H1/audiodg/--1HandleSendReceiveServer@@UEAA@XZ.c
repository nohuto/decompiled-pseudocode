/*
 * XREFs of ??1HandleSendReceiveServer@@UEAA@XZ @ 0x140018578
 * Callers:
 *     ??_EHandleSendReceiveServer@@UEAAPEAXI@Z @ 0x140018540 (--_EHandleSendReceiveServer@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x140046F5C (-SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ.c)
 */
