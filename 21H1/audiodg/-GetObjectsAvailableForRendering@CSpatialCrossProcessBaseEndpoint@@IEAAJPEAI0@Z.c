/*
 * XREFs of ?GetObjectsAvailableForRendering@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI0@Z @ 0x140061234
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  *a2 = 0;
  ...
  if ( GrantedDynamicObjectCount < 0 )
    goto LABEL_5;
  v8 = _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this + 161) + 44LL), 0, 0);
  v9 = *((_DWORD *)this + 71);
  if ( v8 < v9 )
    v9 = v8;
  *((_DWORD *)this + 38) = v9;
