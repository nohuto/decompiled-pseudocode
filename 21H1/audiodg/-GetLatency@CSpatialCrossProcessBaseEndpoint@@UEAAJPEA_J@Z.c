/*
 * XREFs of ?GetLatency@CSpatialCrossProcessBaseEndpoint@@UEAAJPEA_J@Z @ 0x140060E40
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetLatency", 400, v4, a4);
  return v4;
}
