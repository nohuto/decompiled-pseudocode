/*
 * XREFs of ?Reallocate@CAtlStringMgr@ATL@@UEAAPEAUCStringData@2@PEAU32@HH@Z @ 0x140045DE0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x14001F470 (_guard_dispatch_icall_nop.c)
 *     ??$AtlMultiply@K@ATL@@YAJPEAKKK@Z @ 0x140045D20 (--$AtlMultiply@K@ATL@@YAJPEAKKK@Z.c)
 */
