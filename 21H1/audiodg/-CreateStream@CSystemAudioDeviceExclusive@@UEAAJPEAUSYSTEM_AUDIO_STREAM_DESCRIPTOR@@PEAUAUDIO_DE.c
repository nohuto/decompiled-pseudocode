/*
 * XREFs of ?CreateStream@CSystemAudioDeviceExclusive@@UEAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUAUDIO_DEVICE_MODE_DESCRIPTOR@@PEAUIAudioGraphCallback@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1400380A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_52:
  ...
  *((_DWORD *)a5 + 238) = 0;
  ...
  v28 = 0LL;
  v12 = (**v11)(v11, &GUID_d4952f5a_a0b2_4cc4_8b82_9358488dd8ac, (__int64 *)&v28);
  v8 = v12;
  if ( v12 >= 0 )
  {
...
LABEL_31:
        ...
        v14 = 0LL;
        v27 = *((_DWORD *)this + 94);
        v18 = ((__int64 (__fastcall *)(__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *), char *))(*v28)[6])(v28, v17);
        v8 = v18;
        if ( v18 >= 0 )
        {
          v20 = v28;
          v29 = 0LL;
          *((_DWORD *)a5 + 238) = 2;
          v21 = (**v20)(v20, &GUID_44b2c783_5fa3_4983_9d74_9207de1f9e63, &v29);
          if ( v21 < 0 )
          {
            wil::details::in1diag3::_Throw_Hr(retaddr, v22, v23, (const char *)(unsigned int)v21, v27);
            __debugbreak();
          }
          if ( v29
            && (v24 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v29 + 64LL))(v29, (char *)a5 + 24),
                v8 = v24,
                v24 < 0) )
          {
            wil::details::in1diag3::Return_Hr(
          ...
          {
            if ( *(_DWORD *)a2 )
              v25 = GUID_1fe45ed3_b842_4cf2_8df6_43e3d6d10e64;
            else
              v25 = GUID_20404060_f24f_4f89_84c6_8af80b0a17cb;
            *(GUID *)a5 = v25;
            *((_DWORD *)a5 + 236) = 1;
            v8 = 0;
          }
          wil::com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>::~com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>(&v29);
          goto LABEL_47;
        }
...
LABEL_49:
  wil::com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>::~com_ptr_t<IAudioVirtualProtectedOutput,wil::err_returncode_policy>((__int64 *)&v28);
