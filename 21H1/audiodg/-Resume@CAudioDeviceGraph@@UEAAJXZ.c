/*
 * XREFs of ?Resume@CAudioDeviceGraph@@UEAAJXZ @ 0x140001480
 * Callers:
 *     <none>
 * Callees:
 *     ?Start@DurationTracker@CAudioDeviceGraph@@QEAAXXZ @ 0x140001450 (-Start@DurationTracker@CAudioDeviceGraph@@QEAAXXZ.c)
...
__int64 __fastcall CAudioDeviceGraph::Resume(CAudioDeviceGraph *this)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
      tlgWriteTransfer_EtwEventWriteTransfer(v6, (unsigned int)&unk_140071FB9, (_DWORD)this + 352, 0, 2, (__int64)v9);
    v4 = 0;
  }
  if ( v1 )
