/*
 * XREFs of ?AddPipeToLoopbackConnection@CAudioDeviceGraph@@UEAAJPEAVCPipeInstance@@@Z @ 0x14003E8B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioDeviceGraph::AddPipeToLoopbackConnection(CPipeInstance **this, struct CPipeInstance *a2)
{
  ...
  v6 = CPipeInstance::ResolvePendingConnections(a2, -1LL, *((_QWORD *)LoopbackConnection + 1), 0);
  if ( v6 >= 0 )
