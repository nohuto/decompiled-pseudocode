/*
 * XREFs of ?RuntimeClassInitialize@CCPAudioHistoryReader@@QEAAJ_K0HPEAUVolatileControlData@@PEAUSharedMessageQueueItem@@III0@Z @ 0x1400575B4
 * Callers:
        ...
        unsigned __int64 a10)
{
  ...
  *((_QWORD *)this + 12) = v15;
  ...
  {
    if ( (unsigned int)dword_140084010 > 4 )
    {
      a5 = a2;
      a7 = v17;
      a9 = v16;
