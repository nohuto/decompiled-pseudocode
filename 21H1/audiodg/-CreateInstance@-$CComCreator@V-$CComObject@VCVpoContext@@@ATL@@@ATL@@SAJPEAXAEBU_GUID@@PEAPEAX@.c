/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCVpoContext@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140043808
 * Callers:
 ...
 *     ??0?$CComObject@VCVpoContext@@@ATL@@QEAA@PEAX@Z @ 0x1400433F0 (--0-$CComObject@VCVpoContext@@@ATL@@QEAA@PEAX@Z.c)
