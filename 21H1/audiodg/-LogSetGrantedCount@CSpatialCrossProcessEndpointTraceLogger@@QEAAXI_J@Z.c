/*
 * XREFs of ?LogSetGrantedCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI_J@Z @ 0x14005F274
 * Callers:
 *     ?SetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJI_J@Z @ 0x1400624F0 (-SetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJI_J@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (unsigned int)dword_140084108 > 5 )
  {
    v4 = a3;
    v10 = &v4;
    v3 = a2;
    ...
    tlgWriteTransfer_EventWriteTransfer(
      (__int64)&dword_140084108,
      (unsigned __int8 *)dword_14007292C,
      0LL,
      0LL,
      5u,
      &v5);
