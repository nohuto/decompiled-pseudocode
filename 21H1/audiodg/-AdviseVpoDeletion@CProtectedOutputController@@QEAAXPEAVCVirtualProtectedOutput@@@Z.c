/*
 * XREFs of ?AdviseVpoDeletion@CProtectedOutputController@@QEAAXPEAVCVirtualProtectedOutput@@@Z @ 0x14003DC54
 * Callers:
 *     ?Release@CVirtualProtectedOutput@@UEAAKXZ @ 0x14003E1F0 (-Release@CVirtualProtectedOutput@@UEAAKXZ.c)
 * Callees:
