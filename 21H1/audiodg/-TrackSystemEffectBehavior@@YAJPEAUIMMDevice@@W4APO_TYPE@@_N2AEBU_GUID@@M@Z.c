/*
 * XREFs of ?TrackSystemEffectBehavior@@YAJPEAUIMMDevice@@W4APO_TYPE@@_N2AEBU_GUID@@M@Z @ 0x14000B060
 * Callers:
...
__int64 __fastcall TrackSystemEffectBehavior(__int64 a1, int a2, char a3, unsigned __int8 a4, __int64 a5, float a6)
{
  ...
  if ( dword_140085384 > *(_DWORD *)(*ThreadLocalStoragePointer + 4) )
  {
    Init_thread_header(&dword_140085384);
    if ( dword_140085384 == -1 )
    {
      xmmword_140085104 = PKEY_Endpoint_LFX_FailCount;
      dword_140085114 = 9;
      xmmword_140085118 = PKEY_Endpoint_GFX_FailCount;
      dword_140085128 = 8;
      xmmword_14008512C = PKEY_Endpoint_EFX_FailCount;
      dword_14008513C = 31;
      Init_thread_footer(&dword_140085384);
    }
  }
  if ( dword_140085380 > *(_DWORD *)(v11 + 4) )
  {
    Init_thread_header(&dword_140085380);
    if ( dword_140085380 == -1 )
    {
      xmmword_1400850B4 = PKEY_Endpoint_LFX_ExceptionCount;
      dword_1400850C4 = 33;
      xmmword_1400850C8 = PKEY_Endpoint_GFX_ExceptionCount;
      dword_1400850D8 = 34;
      xmmword_1400850DC = PKEY_Endpoint_EFX_ExceptionCount;
      dword_1400850EC = 35;
      Init_thread_footer(&dword_140085380);
    }
  }
  if ( !(_DWORD)v8 )
  {
  ...
  if ( !byte_140085098 )
  {
    ...
    if ( !RegGetValueW(
            ...
            &pvData,
            &pcbData) )
      byte_140085140 = (_DWORD)pvData != 0;
    byte_140085098 = 1;
  }
  if ( byte_140085140 )
  {
