/*
 * XREFs of ??0?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIUnknown@@@WRL@Microsoft@@QEAA@XZ @ 0x140013A60
 * Callers:
 *     ??0CpuManager@@QEAA@XZ @ 0x140013B8C (--0CpuManager@@QEAA@XZ.c)
 * Callees:
