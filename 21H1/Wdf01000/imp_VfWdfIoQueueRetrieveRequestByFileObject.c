/*
 * XREFs of imp_VfWdfIoQueueRetrieveRequestByFileObject @ 0x1C00C1480
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **OutRequest)
{
  ...
  __int64 v12; // rdx
  wchar_t ObjectOffset; // [rsp+30h] [rbp-38h] BYREF
  void *PPObject; // [rsp+38h] [rbp-30h] BYREF
  _GUID ActivityId; // [rsp+40h] [rbp-28h] BYREF

  v5 = 0LL;
  v6 = ((__int64 (__fastcall *)(_WDF_DRIVER_GLOBALS *, WDFQUEUE__ *, WDFFILEOBJECT__ *))WdfVersion.Functions.pfnWdfIoQueueRetrieveRequestByFileObject)(
         DriverGlobals,
         Queue,
         FileObject);
  if ( !v6 )
