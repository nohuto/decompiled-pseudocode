/*
 * XREFs of FxCmResourceListInsertDescriptor @ 0x1C005C190
 * Callers:
 *     imp_WdfCmResourceListAppendDescriptor @ 0x1C005C480 (imp_WdfCmResourceListAppendDescriptor.c)
 *     imp_WdfCmResourceListInsertDescriptor @ 0x1C005C5B0 (imp_WdfCmResourceListInsertDescriptor.c)
 * Callees:
 ...
 *     ??0FxResourceCm@@QEAA@PEAU_FX_DRIVER_GLOBALS@@PEAU_CM_PARTIAL_RESOURCE_DESCRIPTOR@@@Z @ 0x1C005C044 (--0FxResourceCm@@QEAA@PEAU_FX_DRIVER_GLOBALS@@PEAU_CM_PARTIAL_RESOURCE_DESCRIPTOR@@@Z.c)
