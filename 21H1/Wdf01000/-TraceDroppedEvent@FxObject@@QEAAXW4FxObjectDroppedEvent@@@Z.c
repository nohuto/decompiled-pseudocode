/*
 * XREFs of ?TraceDroppedEvent@FxObject@@QEAAXW4FxObjectDroppedEvent@@@Z @ 0x1C005A2C0
 * Callers:
 ...
 *     ?AddChildObjectInternal@FxObject@@AEAAJPEAV1@@Z @ 0x1C0059B48 (-AddChildObjectInternal@FxObject@@AEAAJPEAV1@@Z.c)
 *     ?AssignParentObject@FxObject@@QEAAJPEAV1@@Z @ 0x1C0059D70 (-AssignParentObject@FxObject@@QEAAJPEAV1@@Z.c)
 *     ?RemoveChildObjectInternal@FxObject@@AEAAJPEAV1@@Z @ 0x1C005A208 (-RemoveChildObjectInternal@FxObject@@AEAAJPEAV1@@Z.c)
 * Callees:
