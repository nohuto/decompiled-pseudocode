/*
 * XREFs of ?DrainListLocked@FxDisposeList@@AEAAXPEAE@Z @ 0x1C005512C
 * Callers:
 ...
 *     ?DeferredDisposeWorkItem@FxObject@@AEAAXXZ @ 0x1C005B338 (-DeferredDisposeWorkItem@FxObject@@AEAAXXZ.c)
 */
