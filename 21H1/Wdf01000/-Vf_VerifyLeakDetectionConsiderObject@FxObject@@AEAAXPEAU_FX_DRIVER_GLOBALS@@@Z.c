/*
 * XREFs of ?Vf_VerifyLeakDetectionConsiderObject@FxObject@@AEAAXPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C00C6D24
 * Callers:
 ...
 *     FxVerifierIsDebugInfoFlagSetForType @ 0x1C00582C0 (FxVerifierIsDebugInfoFlagSetForType.c)
