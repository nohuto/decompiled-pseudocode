/*
 * XREFs of USBD_CreateHandle @ 0x1C008F62C
 * Callers:
 ...
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C008EF48 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
