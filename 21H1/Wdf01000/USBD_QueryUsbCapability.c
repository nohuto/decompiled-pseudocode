/*
 * XREFs of USBD_QueryUsbCapability @ 0x1C008FCC0
 * Callers:
 *     ?QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z @ 0x1C00736E8 (-QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C001A350 (__security_check_cookie.c)
 *     USBDInternal_BuildandSendIoctlSynchronously @ 0x1C008F23C (USBDInternal_BuildandSendIoctlSynchronously.c)
 */
