/*
 * XREFs of USBD_UrbFree @ 0x1C0090174
 * Callers:
 *     ??1FxUsbPipeRequestContext@@UEAA@XZ @ 0x1C006C848 (--1FxUsbPipeRequestContext@@UEAA@XZ.c)
 *     ??1FxUsbPipeTransferContext@@UEAA@XZ @ 0x1C006C8A8 (--1FxUsbPipeTransferContext@@UEAA@XZ.c)
 *     ?Dispose@FxUsbPipeRequestContext@@UEAAXXZ @ 0x1C006CBE0 (-Dispose@FxUsbPipeRequestContext@@UEAAXXZ.c)
 *     ?Dispose@FxUsbPipeTransferContext@@UEAAXXZ @ 0x1C006CC30 (-Dispose@FxUsbPipeTransferContext@@UEAAXXZ.c)
 ...
 *     ?Dispose@FxUsbDeviceStringContext@@UEAAXXZ @ 0x1C00705C0 (-Dispose@FxUsbDeviceStringContext@@UEAAXXZ.c)
 *     ?Dispose@FxUsbUrb@@MEAAEXZ @ 0x1C0070610 (-Dispose@FxUsbUrb@@MEAAEXZ.c)
 * Callees:
