/*
 * XREFs of ?_Create@FxSystemWorkItem@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAXPEAPEAV1@@Z @ 0x1C0014BB8
 * Callers:
 ...
 *     ?Initialize@FxDisposeList@@QEAAJPEAX@Z @ 0x1C00551A8 (-Initialize@FxDisposeList@@QEAAJPEAX@Z.c)
