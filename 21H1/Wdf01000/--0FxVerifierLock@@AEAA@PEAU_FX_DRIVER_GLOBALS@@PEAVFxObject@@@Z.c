/*
 * XREFs of ??0FxVerifierLock@@AEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxObject@@@Z @ 0x1C00315FC
 * Callers:
 ...
 * Callees:
 *     ?InitializeLockOrder@FxVerifierLock@@AEAAXXZ @ 0x1C005A87C (-InitializeLockOrder@FxVerifierLock@@AEAAXXZ.c)
 */
