/*
 * XREFs of FxAllocateDriverGlobals @ 0x1C0056BB4
 * Callers:
 *     FxLibraryCommonRegisterClient @ 0x1C0041A64 (FxLibraryCommonRegisterClient.c)
 * Callees:
 *     memset @ 0x1C001D340 (memset.c)
 *     ?SetVerifierState@_FX_DRIVER_GLOBALS@@QEAAXE@Z @ 0x1C0056AD0 (-SetVerifierState@_FX_DRIVER_GLOBALS@@QEAAXE@Z.c)
 *     AllocAndInitializeTelemetryContext @ 0x1C005F88C (AllocAndInitializeTelemetryContext.c)
 */
