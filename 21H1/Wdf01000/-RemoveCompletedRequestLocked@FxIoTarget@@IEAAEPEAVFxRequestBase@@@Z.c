        ...
        unsigned __int8 a3)
{
  ...
  $5BF30AA281B99519C0227DA4A018F79C *v7; // rax
  _IRP *Irp; // rdx
  ...
  v7 = &Request->120;
  if ( ($5BF30AA281B99519C0227DA4A018F79C *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($5BF30AA281B99519C0227DA4A018F79C **)&Irp->Type != v7) )
  {
    __fastfail(3u);
  }
