/*
 * XREFs of ?AddRemovalDevice@FxPkgPnp@@QEAAJPEAU_DEVICE_OBJECT@@@Z @ 0x1C007F284
 * Callers:
...
LABEL_8:
  ...
  if ( !v14 )
    return 3221225626LL;
  v15 = FxTransactionedList::Add(this->m_RemovalDeviceList, this->m_Globals, (FxTransactionedEntry *)(v14 + 104));
  if ( v15 < 0 )
  {
