/*
 * XREFs of USBD_UrbAllocate @ 0x1C008FF6C
 * Callers:
 ...
 *     ?AllocateUrb@FxUsbDeviceStringContext@@QEAAJPEAUUSBD_HANDLE__@@@Z @ 0x1C006F7DC (-AllocateUrb@FxUsbDeviceStringContext@@QEAAJPEAUUSBD_HANDLE__@@@Z.c)
