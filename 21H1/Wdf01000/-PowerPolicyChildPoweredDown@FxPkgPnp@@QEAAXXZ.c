/*
 * XREFs of ?PowerPolicyChildPoweredDown@FxPkgPnp@@QEAAXXZ @ 0x1C0018590
 * Callers:
 *     ?PowerParentPowerDereference@FxPkgPdo@@EEAAXXZ @ 0x1C0018560 (-PowerParentPowerDereference@FxPkgPdo@@EEAAXXZ.c)
 * Callees:
