/*
 * XREFs of ?FilterResourceRequirements@FxInterrupt@@QEAAXPEAU_IO_RESOURCE_DESCRIPTOR@@@Z @ 0x1C008A324
 * Callers:
        ...
        _IO_RESOURCE_DESCRIPTOR *IoResourceDescriptor)
{
  ...
  if ( FxLibraryGlobals.IoConnectInterruptEx && this->m_SetPolicy )
  {
