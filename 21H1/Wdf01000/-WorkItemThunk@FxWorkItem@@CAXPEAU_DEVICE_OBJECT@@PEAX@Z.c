...
void __fastcall FxWorkItem::WorkItemThunk(_DEVICE_OBJECT *DeviceObject, unsigned __int64 Context, unsigned __int8 a3)
{
  ...
  char v8; // cl
  __int64 v9; // rcx
  void (__fastcall *v10)(void *, unsigned int, unsigned int, unsigned __int16, unsigned __int8); // rax
  ...
  *(_QWORD *)(Context + 200) = KeGetCurrentThread();
  ...
  if ( v3->FxTrackDriverForMiniDumpLog )
    *(_FX_DRIVER_GLOBALS *volatile *)((char *)&FxLibraryGlobals.DriverTracker.m_DriverUsage->FxDriverGlobals
                                    + FxLibraryGlobals.DriverTracker.m_EntrySize * HIDWORD(KeGetPcr()[1].LockArray)) = v3;
  ...
  *(_BYTE *)(Context + 129) = 0;
  ...
  if ( v9 )
  {
    ...
    if ( WorkItemNotifyRoutine )
      WorkItemNotifyRoutine((void *)(Context + 160), 8u, 1207959552u, 3943u, 2u);
  ...
  {
    v10 = FxLibraryGlobals.PerfTraceRoutines->WorkItemNotifyRoutine;
    if ( v10 )
      v10((void *)(Context + 160), 8u, 1207959552u, 3943u, 2u);
    if ( *(_WORD *)(Context + 10) )
