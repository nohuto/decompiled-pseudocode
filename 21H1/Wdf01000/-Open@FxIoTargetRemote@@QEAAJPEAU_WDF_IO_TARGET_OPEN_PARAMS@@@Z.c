/*
 * XREFs of ?Open@FxIoTargetRemote@@QEAAJPEAU_WDF_IO_TARGET_OPEN_PARAMS@@@Z @ 0x1C0067030
 * Callers:
 ...
 *     ?GetTargetIoType@FxIoTarget@@IEAAEXZ @ 0x1C0064E50 (-GetTargetIoType@FxIoTarget@@IEAAEXZ.c)
 ...
 *     ?Set@FxIoTargetRemoveOpenParams@@QEAAXPEAU_WDF_IO_TARGET_OPEN_PARAMS@@PEAU_UNICODE_STRING@@PEAXK@Z @ 0x1C00675CC (-Set@FxIoTargetRemoveOpenParams@@QEAAXPEAU_WDF_IO_TARGET_OPEN_PARAMS@@PEAU_UNICODE_STRING@@PEAXK.c)
 ...
 *     ?RegisterForPnpNotification@FxIoTargetRemote@@QEAAJXZ @ 0x1C00682B8 (-RegisterForPnpNotification@FxIoTargetRemote@@QEAAJXZ.c)
