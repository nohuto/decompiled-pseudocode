/*
 * XREFs of ?FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1C002D6C8
 * Callers:
 *     DriverEntry @ 0x1C002DD60 (DriverEntry.c)
 * Callees:
 *     RtlUnicodeStringPrintf @ 0x1C002E304 (RtlUnicodeStringPrintf.c)
 *     ?_CreateAndInitialize@FxCompanionLibrary@@SAJPEAPEAV1@@Z @ 0x1C004322C (-_CreateAndInitialize@FxCompanionLibrary@@SAJPEAPEAV1@@Z.c)
 */
