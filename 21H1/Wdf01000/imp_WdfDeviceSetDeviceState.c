/*
 * XREFs of imp_WdfDeviceSetDeviceState @ 0x1C0048500
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z @ 0x1C0082AF0 (-SetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z.c)
 */
