/*
 * XREFs of ?GetOrAllocateMdl@FxRequestBuffer@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAPEAU_MDL@@1PEAEW4_LOCK_OPERATION@@EPEA_K@Z @ 0x1C00917C0
 * Callers:
 ...
 *     FxProbeAndLockWithAccess @ 0x1C00913DC (FxProbeAndLockWithAccess.c)
 */
