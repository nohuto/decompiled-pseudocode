/*
 * XREFs of ?Initialize@FxInterrupt@@QEAAJPEAVFxDevice@@PEAVFxObject@@PEAU_WDF_INTERRUPT_CONFIG@@@Z @ 0x1C00896E8
 * Callers:
        ...
        _WDF_INTERRUPT_CONFIG *Configuration)
{
  ...
  FxObject::AddRef(Device, this, 421, "minkernel\\wdf\\framework\\shared\\irphandlers\\pnp\\interruptobject.cpp");
