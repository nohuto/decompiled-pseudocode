/*
 * XREFs of ?PostCreateDeviceInitialize@FxPkgPnp@@QEAAJXZ @ 0x1C0081AD4
 * Callers:
 ...
 *     RtlStringCchPrintfW @ 0x1C002E2A8 (RtlStringCchPrintfW.c)
  ...
  if ( IsCompanionRequiredForDevice )
  {
    ...
    if ( CompanionTarget < 0 )
    {
      ...
      if ( (int)RtlStringCchPrintfW(
                  ...
                  v11,
                  _a1) >= 0 )
        LibraryLogEvent(FxLibraryGlobals.DriverObject, -2147024893, v13, insertString, 0LL, 0);
    }
    else
    {
      FxObject::AddRef(
