/*
 * XREFs of imp_WdfDeviceGetDeviceState @ 0x1C0047C80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z @ 0x1C00803C4 (-GetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z.c)
 */
