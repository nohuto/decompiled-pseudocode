...
void __fastcall Isoch_WdfEvtIoQueueReadyNotification(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( KeGetCurrentIrql() != 2 )
  {
    ...
    if ( KeGetCurrentIrql() == 2 )
    {
      ...
      {
        LOBYTE(a2) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(v6 + 72), a2, 4, 306, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_sds(
    ...
    else
    {
      ...
      if ( CurrentProcessorNumber >= *(_DWORD *)(v6 + 800) )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          LOBYTE(a2) = 2;
      ...
      else
      {
        ...
        *(_BYTE *)(v9 + *(_QWORD *)(v6 + 792)) = 1;
        *(_BYTE *)(v9 + *(_QWORD *)(v6 + 792) + 1) = v7;
      }
    }
  }
...
LABEL_27:
  if ( v5 && KeGetCurrentIrql() == 2 )
  {
    ...
    if ( KeGetCurrentIrql() == 2 )
    {
      if ( (unsigned int)v17 >= *((_DWORD *)v16 + 200) )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_d(v16[9], 2, 4, 308, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v17);
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_d(v16[9], 2, 4, 309, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v17);
    ...
    else
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_d(v16[9], 2, 4, 310, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, CurrentIrql);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_sds(
            WPP_GLOBAL_Control->DeviceExtension,
            v35,
