/*
 * XREFs of UsbDevice_GetEndpointOffloadInformation @ 0x1C0045A8C
 * Callers:
...
__int64 __fastcall UsbDevice_GetEndpointOffloadInformation(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)(a2 + 24) )
  {
    ...
    if ( *(_DWORD *)(*(_QWORD *)(a1 + 8) + 572LL) == 1 )
    {
      v14 = *(_DWORD *)(result + 1352);
      if ( v14 == 2 )
      {
      ...
      {
        if ( *(_DWORD *)(*(_QWORD *)result + 572LL) == 2 && v14 != 1 )
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_sds(WPP_GLOBAL_Control->DeviceExtension, v10, v11, v12);
          if ( !KdRefreshDebuggerNotPresent() )
