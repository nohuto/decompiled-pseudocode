/*
 * XREFs of Controller_SetDeviceDescription @ 0x1C006F068
 * Callers:
 ...
 *     RtlUnalignedStringCbLengthW @ 0x1C00164CC (RtlUnalignedStringCbLengthW.c)
 *     RtlStringCbPrintfW @ 0x1C0016544 (RtlStringCbPrintfW.c)
 *     RootHub_GetHighestUsbVersionSupported @ 0x1C001659C (RootHub_GetHighestUsbVersionSupported.c)
...
LABEL_26:
    ...
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), v7, 4, v23, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  }
}
