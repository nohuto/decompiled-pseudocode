/*
 * XREFs of Command_GetSupportedExtendedCapabilityCommandCompletion @ 0x1C002DA30
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_BYTE)v2 == 1 )
  {
    ...
    *(_WORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 8) + 88LL) + 108LL) = v4;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v6 = v4;
      LOBYTE(v4) = 4;
      WPP_RECORDER_SF_d(*(_QWORD *)(v3 + 16), v4, 7, 25, (__int64)&WPP_36fa723b951d376375e8eba1d8934b4f_Traceguids, v6);
    }
  }
