 ...
 *     Controller_AreFrameAndTimeDeltaValuesValid @ 0x1C00301B4 (Controller_AreFrameAndTimeDeltaValuesValid.c)
...
__int64 __fastcall Interrupter_WdfEvtInterruptIsr(__int64 a1, int a2)
{
  ...
  if ( *(_BYTE *)(v10 + 592) )
  {
    ...
    if ( MEMORY[0xFFFFF78000000008] > (unsigned __int64)(*(_QWORD *)(v10 + 680) + 15000000LL) )
    {
      ...
      if ( !v19 )
      {
        ...
        else
        {
          ...
          if ( (unsigned __int8)Controller_AreFrameAndTimeDeltaValuesValid(
                                  (unsigned int)(FrameNumber - *(_DWORD *)(v10 + 704)),
                                  v12 - *(_QWORD *)(v10 + 688)) )
          {
            *(_QWORD *)(v10 + 720) = v13 - *(_QWORD *)(v10 + 656);
            *(_QWORD *)(v10 + 728) = (unsigned int)(8 * (v14 - *(_DWORD *)(v10 + 664)) - *(_DWORD *)(v10 + 672));
          }
          else
          {
            ++*(_DWORD *)(v10 + 736);
