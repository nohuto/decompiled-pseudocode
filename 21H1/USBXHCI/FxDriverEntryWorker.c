/*
 * XREFs of FxDriverEntryWorker @ 0x1C0016FB4
 * Callers:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_1C0061900;
    ...
    if ( v6 >= 0 )
    {
      ...
      else
      {
        ...
        if ( v8 >= 0 )
        {
          ...
          {
            DriverUnload = (void (__fastcall *)(_DRIVER_OBJECT *))qword_1C00618B8;
            if ( DriverObject->DriverUnload )
              DriverUnload = DriverObject->DriverUnload;
            qword_1C00618B8 = (__int64)DriverUnload;
