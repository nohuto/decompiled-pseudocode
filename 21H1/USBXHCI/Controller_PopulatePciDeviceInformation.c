/*
 * XREFs of Controller_PopulatePciDeviceInformation @ 0x1C0071128
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v15 = a2;
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_ddd(a1, a2, 4, 132, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v15, a3, a4);
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(v12) = 4;
      WPP_RECORDER_SF_ddL(
