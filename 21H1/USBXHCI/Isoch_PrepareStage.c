/*
 * XREFs of Isoch_PrepareStage @ 0x1C00038A0
 * Callers:
 ...
 *     Isoch_GetPacketLength @ 0x1C0040FC8 (Isoch_GetPacketLength.c)
...
__int64 __fastcall Isoch_PrepareStage(__int64 a1)
{
  ...
  unsigned int v68; // [rsp+C0h] [rbp+8h]
  ...
  *((_DWORD *)v1 + 10) = v4;
  ...
  if ( v13 )
  {
    ...
    if ( !Mdl )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        v50 = *(unsigned __int8 *)(*(_QWORD *)(v14 + 48) + 135LL);
        LOBYTE(v50) = 2;
      ...
      *(_BYTE *)(a1 + 104) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 96));
      ...
      LOBYTE(v51) = 1;
      TR_ReleaseSegments(a1, v1 + 1, v51);
      TR_ReleaseSegments(a1, v1 + 3, 0LL);
      StageQueue_Release(v52 + 128, v1);
...
LABEL_9:
  ...
  if ( v16 > v17 )
  {
    ...
    for ( j = v54 / v53; ; ++j )
    {
      ...
      if ( v53 )
      {
        do
        {
          PacketLength = Isoch_GetPacketLength(v3, v54, v6, v11);
          v56 = PacketLength + v58;
          ++v54;
        }
        while ( v59 != 1 );
        v53 = v68;
  ...
  *((_DWORD *)v1 + 13) = v16;
  ...
  if ( (*(_QWORD *)(v22 + 336) & 0x800000000000LL) == 0
    || (v60 = *(_QWORD *)(a1 + 48), *(_DWORD *)(v60 + 20) != 1)
    || !*(_DWORD *)(v60 + 40) )
  {
...
LABEL_88:
      ...
      *(_BYTE *)(a1 + 104) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 96));
      ...
      v63 = v1 + 1;
LABEL_85:
      TR_ReleaseSegments(a1, v63, 1LL);
      TR_ReleaseSegments(a1, v1 + 3, 0LL);
      StageQueue_Release(v62 + 128, v1);
      if ( *(_DWORD *)(v3 + 112) == *(_DWORD *)(v3 + 116) )
      {
        Isoch_Transfer_CompleteCancelable(a1, v3, -1, -1073737728, 0, 0);
        goto LABEL_64;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v65 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 48) + 135LL);
    LOBYTE(v65) = 4;
    WPP_RECORDER_SF_DDqqD(
      *(_QWORD *)(*(_QWORD *)(a1 + 56) + 80LL),
      v65,
