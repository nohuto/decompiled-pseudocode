/*
 * XREFs of Controller_RetrieveAcpiData @ 0x1C0074A50
 * Callers:
...
__int64 __fastcall Controller_RetrieveAcpiData(__int64 a1, int a2, char *a3)
{
  ...
  if ( v6 == -2147483643 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        v14 = &WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids;
        LOBYTE(v14) = 2;
        WPP_RECORDER_SF_d(a2, (_DWORD)v14, 4, 143, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v13);
      }
    ...
    else
    {
      ...
      {
        v12 = &WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids;
        LOBYTE(v12) = 2;
        WPP_RECORDER_SF_d(a2, (_DWORD)v12, 4, 142, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v9);
      }
  ...
  {
    v8 = &WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids;
    LOBYTE(v8) = 2;
    WPP_RECORDER_SF_d(a2, (_DWORD)v8, 4, 141, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v6);
  }
  return v7;
}
