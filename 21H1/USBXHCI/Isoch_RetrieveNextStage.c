 ...
 *     Isoch_Stage_Acquire @ 0x1C0041BF8 (Isoch_Stage_Acquire.c)
 *     Isoch_TransferUrb_MarkLatePackets @ 0x1C0041DB4 (Isoch_TransferUrb_MarkLatePackets.c)
...
_BOOL8 __fastcall Isoch_RetrieveNextStage(__int64 a1)
{
  ...
  __int64 v94; // rcx
  int v95; // edx
  int v96; // [rsp+20h] [rbp-98h]
  __int64 v97; // [rsp+60h] [rbp-58h]
  int v98; // [rsp+C0h] [rbp+8h]
  unsigned int v99; // [rsp+C0h] [rbp+8h]
  __int64 v100; // [rsp+C8h] [rbp+10h] BYREF
  __int64 v101; // [rsp+D0h] [rbp+18h] BYREF
...
LABEL_5:
  ...
  while ( 1 )
  {
    ...
    if ( v4 < 0 )
      break;
    v11 = Isoch_TransferData_Initialize(a1, v101, &v100);
    if ( v11 < 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        v78 = *(_QWORD *)(a1 + 48);
        v79 = *(unsigned __int8 *)(v78 + 135);
        LOBYTE(v78) = 2;
      ...
      Isoch_Transfer_Complete(a1, v100, -1, -1073737728, 0);
    }
    else
    {
      v12 = v100;
...
LABEL_14:
      ...
      *v16 = 0;
      ...
      if ( v13 < 0 )
      {
        ...
        v83 = -1073414144;
LABEL_129:
        Isoch_Transfer_Complete(a1, v41, v83, v82, 0);
      }
      else
      {
        v42 = *(_QWORD *)(v12 + 48);
...
LABEL_49:
            ...
            case ':':
              if ( !*(_BYTE *)(a1 + 280) )
              {
                if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                {
                  ...
                  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                  {
                    v86 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 48) + 135LL);
                    LOBYTE(v86) = 2;
                    WPP_RECORDER_SF_DDqd(
                      *(_QWORD *)(*(_QWORD *)(a1 + 56) + 80LL),
                      v86,
        ...
        if ( *(_DWORD *)(*(_QWORD *)(v102 + 48) + 12LL * (unsigned int)(*(_DWORD *)(v56 + 96) - 1) + 148) == -1073414144 )
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            LOBYTE(v54) = 4;
          ...
          *(_DWORD *)(v56 + 64) = 1;
          ...
          if ( v4 >= 0 )
          {
            ...
            *(_QWORD *)(a1 + 368) = v64;
            if ( !*(_DWORD *)(a1 + 376) )
            {
              v68 = *(_QWORD *)(*(_QWORD *)(a1 + 40) + 128LL);
              if ( *(_DWORD *)(v68 + 24) > 1u )
              {
                v94 = *(unsigned int *)(*(_QWORD *)(v56 + 48) + 64LL);
                if ( (unsigned int)v94 < *(_DWORD *)(v68 + 48) )
                  v1 = *(_WORD *)(*(_QWORD *)(v68 + 56) + 2 * v94);
              }
              *(_WORD *)(a1 + 112) = v1;
            }
            if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        ...
        else
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            v92 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 48) + 135LL);
            LOBYTE(v92) = 4;
            WPP_RECORDER_SF_DDi(
              *(_QWORD *)(*(_QWORD *)(a1 + 56) + 80LL),
              v92,
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    v95 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 48) + 135LL);
    LOBYTE(v95) = 5;
    WPP_RECORDER_SF_ddL(
      *(_QWORD *)(*(_QWORD *)(a1 + 56) + 80LL),
      v95,
  ...
  {
    v69 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 48) + 135LL);
    LOBYTE(v69) = 3;
    WPP_RECORDER_SF_dd(
      *(_QWORD *)(*(_QWORD *)(a1 + 56) + 80LL),
      v69,
