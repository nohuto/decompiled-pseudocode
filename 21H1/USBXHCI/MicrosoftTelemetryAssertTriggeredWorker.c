/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C00506A8
 * Callers:
 ...
 *     GetImageTuple @ 0x1C0050628 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C0050D3C (_tlgCreate1Sz_char.c)
 *     _tlgKeywordOn @ 0x1C0050D7C (_tlgKeywordOn.c)
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C0050DA8 (_tlgWriteTransfer_EtwWriteTransfer.c)
 */
...
LABEL_37:
  ...
  if ( (unsigned int)dword_1C0069040 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0069040, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((int)&v76, (int)&dword_1C00545C3, v32, v33, 0xBu, &v76);
  }
  if ( dword_1C0069078 && !v24 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C0069040 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0069040, 0x400000000000LL) )
    {
      ...
      v58 = v34;
      v75 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer(v37, (int)&dword_1C0054630, v38, v39, v40, &v60);
    }
    if ( !v34 )
    {
