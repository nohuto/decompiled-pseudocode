/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x1C0049DC0
 * Callers:
 *     Crashdump_Initialize @ 0x1C0049870 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_LogRHPortInfo @ 0x1C004AE44 (Crashdump_Register_LogRHPortInfo.c)
 *     Crashdump_Register_ResetController @ 0x1C004B01C (Crashdump_Register_ResetController.c)
 *     Crashdump_Register_ResetPort @ 0x1C004B0E8 (Crashdump_Register_ResetPort.c)
 *     Crashdump_Register_StartController @ 0x1C004B4BC (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x1C004B648 (Crashdump_Register_UpdateDeviceSlotInfo.c)
 ...
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C004C458 (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_UsbDevice_GetPortType @ 0x1C004DADC (Crashdump_UsbDevice_GetPortType.c)
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C004DD4C (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ResetPort @ 0x1C004DFA0 (Crashdump_UsbDevice_ResetPort.c)
 *     Crashdump_UsbDevice_SetPortPower @ 0x1C004E5C8 (Crashdump_UsbDevice_SetPortPower.c)
 */
