/*
 * XREFs of Controller_WdfEvtDeviceSelfManagedIoCleanup @ 0x1C0075C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceSelfManagedIoCleanup(__int64 a1)
{
  ...
  {
    LOBYTE(v2) = 5;
    WPP_RECORDER_SF_i(v3[9], v2, 4, 60, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v1);
  }
  v4 = (void *)v3[66];
  if ( v4 )
  {
