/*
 * XREFs of Bulk_ProcessStreamOnEndpointStopOrHalt @ 0x1C0043A10
 * Callers:
 *     Bulk_EP_FSEReceived @ 0x1C000EAA0 (Bulk_EP_FSEReceived.c)
 *     Bulk_EP_EndpointHalted @ 0x1C00435E0 (Bulk_EP_EndpointHalted.c)
 * Callees:
