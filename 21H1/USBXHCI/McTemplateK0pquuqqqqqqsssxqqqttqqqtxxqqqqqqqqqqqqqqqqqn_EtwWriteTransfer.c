/*
 * XREFs of McTemplateK0pquuqqqqqqsssxqqqttqqqtxxqqqqqqqqqqqqqqqqqn_EtwWriteTransfer @ 0x1C004888C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0pquuqqqqqqsssxqqqttqqqtxxqqqqqqqqqqqqqqqqqn_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        __int64 a47)
{
  ...
  return McGenEventWrite_EtwWriteTransfer(
           (__int64)v54,
           &USBXHCI_ETW_EVENT_RUNDOWN_CONTROLLER_INFORMATION_V3,
           a3,
           0x2Cu,
           &v57);
}
