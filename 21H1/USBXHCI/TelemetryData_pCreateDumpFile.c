/*
 * XREFs of TelemetryData_pCreateDumpFile @ 0x1C0077564
 * Callers:
 *     TelemetryData_pWriteDumpFile @ 0x1C0077BD8 (TelemetryData_pWriteDumpFile.c)
 * Callees:
 *     RtlStringCbPrintfW @ 0x1C0016544 (RtlStringCbPrintfW.c)
