/*
 * XREFs of Controller_ConfigureS0IdleSettings @ 0x1C006FBB4
 * Callers:
  ...
  if ( (result & 0x100000) != 0 )
  {
    *((_DWORD *)a1 + 116) = 1;
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return result;
    LOBYTE(v2) = 3;
    result = WPP_RECORDER_SF_(a1[9], v2, 4, 21, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  }
  else
  {
    ...
    if ( (int)result < 0 )
    {
      ...
      {
        LOBYTE(v4) = 4;
        result = WPP_RECORDER_SF_d(a1[9], v4, 4, 22, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, result);
      }
      *((_DWORD *)a1 + 116) = 2;
    }
    else
    {
      if ( v12[5] )
      {
        ...
        {
          LOBYTE(v6) = 3;
          WPP_RECORDER_SF_d(a1[9], v6, 4, 23, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v5);
        }
      }
      ...
      if ( v14 > 1 )
      {
        *((_DWORD *)a1 + 116) = 0;
        ...
        {
          LOBYTE(v8) = 4;
          WPP_RECORDER_SF_d(a1[9], v8, 4, 25, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, 136);
        }
        v9 = *a1;
