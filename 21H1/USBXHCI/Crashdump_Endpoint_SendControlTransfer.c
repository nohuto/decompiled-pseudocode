/*
 * XREFs of Crashdump_Endpoint_SendControlTransfer @ 0x1C004CA84
 * Callers:
 ...
 * Callees:
 *     Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x1C004CC68 (Crashdump_Endpoint_SendTransferAndPollForCompletion.c)
 */
