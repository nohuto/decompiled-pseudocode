/*
 * XREFs of Crashdump_CommonBufferAcquire @ 0x1C00495DC
 * Callers:
 ...
 *     Crashdump_Endpoint_Initialize @ 0x1C004C574 (Crashdump_Endpoint_Initialize.c)
 *     Crashdump_UsbDevice_Initialize @ 0x1C004DB8C (Crashdump_UsbDevice_Initialize.c)
 * Callees:
...
__int64 __fastcall Crashdump_CommonBufferAcquire(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( v4 <= 0x1000 )
  {
    ...
    {
      v8 = (_QWORD *)CommonBuffer_AcquireBuffer(*(PVOID *)(a1 + 488), 4096, a1, 829451588);
      if ( !v8 )
