/*
 * XREFs of Controller_ExecuteHSICDisconnectInU3Workaround @ 0x1C006AFA4
 * Callers:
...
void __fastcall Controller_ExecuteHSICDisconnectInU3Workaround(_QWORD *a1, char a2)
{
  ...
  if ( (a1[42] & 0x1000000000000000LL) != 0 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_i(a1[9], 4, 4, 250, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, *a1);
