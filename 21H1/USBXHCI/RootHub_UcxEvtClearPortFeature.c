/*
 * XREFs of RootHub_UcxEvtClearPortFeature @ 0x1C00113F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_138:
      ...
      LOBYTE(v99) = 4;
      WPP_RECORDER_SF_d(v103, (_DWORD)v99, 11, v102, (__int64)&WPP_f97631885c123b34877e2ec176e34bf2_Traceguids, v101);
      goto LABEL_138;
    }
    if ( (_BYTE)v18 != 3 )
    {
