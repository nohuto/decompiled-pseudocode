/*
 * XREFs of Controller_WdfEvtDeviceD0Entry @ 0x1C0013C00
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_ @ 0x1C0009878 (WPP_RECORDER_SF_.c)
 *     DeviceSlot_DisableAllDeviceSlots @ 0x1C000A11C (DeviceSlot_DisableAllDeviceSlots.c)
...
__int64 __fastcall Controller_WdfEvtDeviceD0Entry(__int64 a1, int a2)
{
  ...
  v6 = *(__m128i **)((*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01023 + 1616))(
                       ...
                       off_1C00603D8)
                   + 8);
  if ( v6[33].m128i_i8[9] && KeGetCurrentIrql() )
  {
  ...
  if ( (unsigned int)XilRegister_ReadUlong(v6[5].m128i_i64[1], *(unsigned int **)(v6[5].m128i_i64[1] + 24)) == -1 )
  {
    ...
    {
      LOBYTE(v14) = 2;
      WPP_RECORDER_SF_(v6[4].m128i_i64[1], v14, 4, 62, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
    }
    v9 = 1;
    v16 = -1073741823;
    goto LABEL_51;
  }
  if ( v6[29].m128i_i32[0] && v6[48].m128i_i64[1] )
  ...
  if ( v15 && *(_DWORD *)(v15 + 584) == 4 )
  {
    ...
    {
      LOBYTE(v30) = 2;
      WPP_RECORDER_SF_d(v6[4].m128i_i64[1], v30, 4, 63, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v29);
    }
  }
  else
  {
...
LABEL_15:
    ...
    do
    {
        ...
        || (_mm_srli_si128(v6[21], 8).m128i_u8[0] & 8) != 0 && (unsigned __int8)Controller_InUseByDebugger(v6) )
      {
        ...
        {
          LOBYTE(v14) = 4;
          WPP_RECORDER_SF_(v6[4].m128i_i64[1], v14, 4, 70, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
        }
      }
      else
      {
    ...
    else
    {
      ...
      if ( v16 >= 0 )
      {
        ...
        if ( v4 == 1 )
        {
          ...
          v38 = 0LL;
          v37 = 12;
          ((void (__fastcall *)(__int64, __int64, int *))qword_1C00616B8)(UcxDriverGlobals, v23, &v37);
        }
        goto LABEL_36;
      }
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
...
LABEL_90:
  LOBYTE(v14) = 2;
  WPP_RECORDER_SF_d(v6[4].m128i_i64[1], v14, 4, v31, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v36);
LABEL_36:
  if ( v16 < 0 )
  {
LABEL_51:
