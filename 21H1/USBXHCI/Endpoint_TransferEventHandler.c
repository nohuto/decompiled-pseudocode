/*
 * XREFs of Endpoint_TransferEventHandler @ 0x1C00064C0
 * Callers:
  ...
  if ( (_mm_srli_si128(v3[21], 8).m128i_u8[0] & 4) != 0 && *(_BYTE *)(a1 + 11) == 2 )
  {
    ...
    if ( (v8 & 4) == 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        LOBYTE(v8) = WPP_RECORDER_SF_ddqL(*(_QWORD *)(a2 + 80), a2, a3, 86);
      return v8;
    }
  }
  v6 = *(_BYTE *)(a1 + 11);
...
LABEL_36:
      if ( (*(_DWORD *)(a1 + 12) & 4) != 0 )
      {
        ...
        {
          LOBYTE(v9) = 2;
          WPP_RECORDER_SF_ddi(*(_QWORD *)(a2 + 80), v9, a3, 91);
        }
        v25 = a2;
        v14 = 4126;
        v24 = *(_QWORD *)(a2 + 16);
        ...
        if ( (_BYTE)v8 )
        {
          ...
          else
          {
            if ( !v26 || (LOBYTE(v8) = *(_BYTE *)(a1 + 11) - 26, (unsigned __int8)v8 > 2u) )
            {
              ...
              {
                LOBYTE(v16) = 2;
                WPP_RECORDER_SF_ddi(*(_QWORD *)(a2 + 80), v16, v17, 95);
                v18 = *(__m128i **)a2;
              }
