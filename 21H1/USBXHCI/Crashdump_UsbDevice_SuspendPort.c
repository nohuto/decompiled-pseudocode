/*
 * XREFs of Crashdump_UsbDevice_SuspendPort @ 0x1C004E658
 * Callers:
 *     Crashdump_Cleanup @ 0x1C0049340 (Crashdump_Cleanup.c)
 * Callees:
 *     Crashdump_Endpoint_SendControlTransfer @ 0x1C004CA84 (Crashdump_Endpoint_SendControlTransfer.c)
 *     Crashdump_UsbDevice_ChangePortFeature @ 0x1C004CFC0 (Crashdump_UsbDevice_ChangePortFeature.c)
