/*
 * XREFs of Controller_TelemetryAddControllerData @ 0x1C0074F94
 * Callers:
 ...
 *     XilDeviceSlot_GetNumberOfDeviceSlots @ 0x1C0035E64 (XilDeviceSlot_GetNumberOfDeviceSlots.c)
 *     XilDeviceSlot_GetUsbDeviceHandleArray @ 0x1C0035E70 (XilDeviceSlot_GetUsbDeviceHandleArray.c)
 *     TelemetryData_InsertTriageDataBlock @ 0x1C00504AC (TelemetryData_InsertTriageDataBlock.c)
 */
...
char __fastcall Controller_TelemetryAddControllerData(_QWORD *a1, __int64 *a2)
{
  ...
  v20 = 0LL;
  if ( !a1
    || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, a1, 0x328u),
