/*
 * XREFs of RootHub_RestoreU1U2Timeouts @ 0x1C003CF3C
 * Callers:
...
__int64 __fastcall RootHub_RestoreU1U2Timeouts(_QWORD *a1, int a2)
{
  ...
  {
    LOBYTE(v5) = 4;
    WPP_RECORDER_SF_(*(_QWORD *)(v4 + 72), v5, 11, 220, (__int64)&WPP_f97631885c123b34877e2ec176e34bf2_Traceguids);
  }
  ...
  v12 = (*(unsigned __int8 *)(104 * v8 + a1[6] + 22) << 8) | v11 & 0xFFFF0000 | *(unsigned __int8 *)(104 * v8 + a1[6] + 21);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LOBYTE(v10) = 4;
    WPP_RECORDER_SF_d(
