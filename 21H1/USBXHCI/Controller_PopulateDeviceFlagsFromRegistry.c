/*
 * XREFs of Controller_PopulateDeviceFlagsFromRegistry @ 0x1C006EA54
 * Callers:
...
__int64 __fastcall Controller_PopulateDeviceFlagsFromRegistry(__int64 *a1, int a2)
{
  ...
  if ( (int)result < 0 )
  {
    ...
    {
      LOBYTE(v7) = 3;
      result = WPP_RECORDER_SF_d(a1[9], v7, 4, 163, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, result);
    }
  }
  else
  {
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    {
      LOBYTE(v9) = 5;
      result = WPP_RECORDER_SF_d(a1[9], v9, 4, 164, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, a2);
    }
  }
  v10 = 0;
  v11 = a1 + 42;
