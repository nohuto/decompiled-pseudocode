/*
 * XREFs of Crashdump_EventRing_PrepareForDump @ 0x1C004BD4C
 * Callers:
 *     Crashdump_InitializeWithControllerReset @ 0x1C0049DC0 (Crashdump_InitializeWithControllerReset.c)
 * Callees:
 *     memset @ 0x1C00194C0 (memset.c)
 *     Crashdump_EventRing_UpdateDequeuePointer @ 0x1C004BF58 (Crashdump_EventRing_UpdateDequeuePointer.c)
 */
