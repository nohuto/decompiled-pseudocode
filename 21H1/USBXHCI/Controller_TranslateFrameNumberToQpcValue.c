/*
 * XREFs of Controller_TranslateFrameNumberToQpcValue @ 0x1C003317C
 * Callers:
 ...
 *     Controller_GetQpcValueForFrameMicroFrameBoundary @ 0x1C003132C (Controller_GetQpcValueForFrameMicroFrameBoundary.c)
