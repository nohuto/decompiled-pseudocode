/*
 * XREFs of Crashdump_UcxEvtGetDumpData @ 0x1C004A760
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Crashdump_FreeDeviceContext @ 0x1C0049824 (Crashdump_FreeDeviceContext.c)
 *     Crashdump_InitializeDeviceContext @ 0x1C0049BA0 (Crashdump_InitializeDeviceContext.c)
 *     Crashdump_Register_Initialize @ 0x1C004ADDC (Crashdump_Register_Initialize.c)
 *     Crashdump_EventRing_InitializeForDump @ 0x1C004B9C8 (Crashdump_EventRing_InitializeForDump.c)
 */
...
__int64 __fastcall Crashdump_UcxEvtGetDumpData(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_BYTE *)(a4 + 84) = 0;
  PoolWithTag = ExAllocatePoolWithTag(SignalState, 0x278uLL, 0x43434858u);
  v15 = PoolWithTag;
  if ( !PoolWithTag )
  {
    v16 = -1073741670;
...
LABEL_8:
        ...
        *((_DWORD *)v15 + 141) = *(_DWORD *)(v7 + 64);
        v19 = 20;
        v20 = WPP_MAIN_CB.DeviceLock.Header.SignalState;
        if ( *(_BYTE *)(104LL * (unsigned int)(*((_DWORD *)v15 + 136) - 1) + *(_QWORD *)(v10[19] + 48LL) + 13) != 2 )
          v19 = 30;
        *((_DWORD *)v15 + 132) = v19;
