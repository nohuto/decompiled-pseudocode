/*
 * XREFs of Command_HandleCommandCompletionEvent @ 0x1C0006588
 * Callers:
...
__int64 **__fastcall Command_HandleCommandCompletionEvent(__int64 a1, __int64 a2)
{
  ...
  v9 = (__int64 *)(a1 + 80);
  v10 = *(__int64 **)(a1 + 80);
  v11 = &WPP_36fa723b951d376375e8eba1d8934b4f_Traceguids;
  if ( v10 != (__int64 *)(a1 + 80) )
  {
    v7 = *(_QWORD **)a2;
    while ( 1 )
    {
      v14 = XilCommand_GetCommandRingBufferLogicalAddress(a1, v7, &WPP_36fa723b951d376375e8eba1d8934b4f_Traceguids)
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
        {
          ...
          v13 = &WPP_36fa723b951d376375e8eba1d8934b4f_Traceguids;
        }
