/*
 * XREFs of Controller_TelemetryReportWorker @ 0x1C0032C90
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall Controller_TelemetryReportWorker(__int64 a1)
{
  ...
  {
    LOBYTE(v5) = 4;
    WPP_RECORDER_SF_(v4[9], v5, 4, 224, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  }
  ...
  *(_DWORD *)(v6 + 80) = 0;
  ...
  if ( v10 == -1073741789 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        LOBYTE(v17) = 2;
        WPP_RECORDER_SF_d(v4[9], v17, 4, 227, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v16);
      }
      v19 = v15;
      goto LABEL_21;
    }
    ...
    {
      LOBYTE(v14) = 2;
      WPP_RECORDER_SF_(v4[9], v14, 4, 226, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
    }
  }
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LOBYTE(v11) = 2;
    WPP_RECORDER_SF_d(v4[9], v11, 4, 225, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v10);
  }
  while ( 1 )
  {
