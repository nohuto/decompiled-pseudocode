/*
 * XREFs of RootHub_Create @ 0x1C006F5FC
 * Callers:
...
__int64 __fastcall RootHub_Create(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  *(_OWORD *)&v14[17] = 0LL;
  *(_OWORD *)&v13[1] = 0LL;
  v7 = ((__int64 (__fastcall *)(__int64, __int64, _QWORD *, __int128 *, __int64 *))qword_1C00616C8)(
         UcxDriverGlobals,
         v5,
         v14,
         &v11,
  ...
  if ( v7 < 0 )
  {
    ...
    {
      LOBYTE(v6) = 2;
      WPP_RECORDER_SF_d(*(_QWORD *)(a2 + 72), v6, 11, 11, (__int64)&WPP_f97631885c123b34877e2ec176e34bf2_Traceguids, v7);
    }
  }
  else
  {
