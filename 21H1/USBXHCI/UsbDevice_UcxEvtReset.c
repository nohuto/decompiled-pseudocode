/*
 * XREFs of UsbDevice_UcxEvtReset @ 0x1C000F9F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall UsbDevice_UcxEvtReset(__int64 a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)(v7 + 64) && (*(_BYTE *)(v3 + 656) && *(_DWORD *)(v8 + 540) == 2 || *(_DWORD *)(v8 + 540) == 1) )
  {
...
LABEL_9:
    v24 = v12;
    LOBYTE(v12) = 4;
    WPP_RECORDER_SF_dq(v5[9], v12, 12, v13, (__int64)&WPP_2d0c5f6bf4263c2e7a5f7f01b810c292_Traceguids, v24, v14);
    return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01023 + 2104))(
             WdfDriverGlobals,
             a2,
             0LL);
