/*
 * XREFs of RootHub_WaitForResumeCompletion @ 0x1C000A64C
 * Callers:
...
__int64 __fastcall RootHub_WaitForResumeCompletion(_QWORD *a1, int a2, int *a3)
{
  ...
  v3 = a2;
  v6 = *(_QWORD *)(a1[1] + 88LL);
  v7 = a1[6] + 104LL * (unsigned int)(a2 - 1);
  v8 = a1[5] + 16LL * (unsigned int)(a2 - 1);
  result = XilRegister_ReadUlong(v6, v8);
  *a3 = result;
  v10 = &WPP_f97631885c123b34877e2ec176e34bf2_Traceguids;
  ...
  MicrosoftTelemetryAssertTriggeredMsgKM(
    ...
    (unsigned int)&WPP_f97631885c123b34877e2ec176e34bf2_Traceguids);
  v17 = a1[1];
  ++*(_DWORD *)(v17 + 484);
  *(_BYTE *)(v17 + 472) = 1;
