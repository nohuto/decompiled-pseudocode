/*
 * XREFs of Controller_PopulateVIAFirmwareVersion @ 0x1C0074840
 * Callers:
...
void __fastcall Controller_PopulateVIAFirmwareVersion(int a1, __int64 a2, __int64 a3, unsigned __int64 *a4)
{
  ...
  if ( *(_WORD *)(a3 + 2) == 13362 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v17 = v22;
      LOBYTE(v17) = 4;
      WPP_RECORDER_SF_ddL(a1, v17, 4, 242, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v22, v19, v20[0]);
    }
...
LABEL_13:
      LOBYTE(v10) = 2;
      WPP_RECORDER_SF_d(a1, v10, 4, v11, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v18);
      return;
    }
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(v10) = 4;
      WPP_RECORDER_SF_d(a1, v10, 4, 244, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v21[0]);
    }
    *a4 = v21[0];
  }
}
