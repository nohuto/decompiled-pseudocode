/*
 * XREFs of Crashdump_Command_SendCommand @ 0x1C004C0E0
 * Callers:
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C004C458 (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x1C004CDA0 (Crashdump_Endpoint_SetDequeuePointer.c)
 *     Crashdump_Endpoint_StopEndpoint @ 0x1C004CE6C (Crashdump_Endpoint_StopEndpoint.c)
 ...
 *     Crashdump_UsbDevice_SendEnableSlotCommand @ 0x1C004E41C (Crashdump_UsbDevice_SendEnableSlotCommand.c)
 *     Crashdump_UsbDevice_SendResetDeviceCommand @ 0x1C004E4D8 (Crashdump_UsbDevice_SendResetDeviceCommand.c)
 * Callees:
