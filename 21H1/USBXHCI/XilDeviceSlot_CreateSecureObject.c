/*
 * XREFs of XilDeviceSlot_CreateSecureObject @ 0x1C0035B7C
 * Callers:
...
__int64 __fastcall XilDeviceSlot_CreateSecureObject(_QWORD *a1)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    else
    {
      ...
      {
        LOBYTE(v6) = 2;
        WPP_RECORDER_SF_d(v3[9], v6, 10, 11, (__int64)&WPP_0ef60bba37223f5f44eaee70871e7dcd_Traceguids, v12);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  ...
  {
    LOBYTE(v6) = 2;
    WPP_RECORDER_SF_d(v3[9], v6, 10, 10, (__int64)&WPP_0ef60bba37223f5f44eaee70871e7dcd_Traceguids, v5);
  }
  return v7;
}
