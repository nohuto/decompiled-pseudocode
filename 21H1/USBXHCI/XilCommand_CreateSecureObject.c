/*
 * XREFs of XilCommand_CreateSecureObject @ 0x1C002F0D4
 * Callers:
...
__int64 __fastcall XilCommand_CreateSecureObject(__int64 a1)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    else
    {
      ...
      {
        LOBYTE(v6) = 2;
        WPP_RECORDER_SF_d(v3[9], v6, 7, 11, (__int64)&WPP_dfb0f4f8d4b33cee16bee8f838de99a5_Traceguids, v12);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  ...
  {
    LOBYTE(v6) = 2;
    WPP_RECORDER_SF_d(v3[9], v6, 7, 10, (__int64)&WPP_dfb0f4f8d4b33cee16bee8f838de99a5_Traceguids, v5);
  }
  return v7;
}
