/*
 * XREFs of RaidUnitSetDevicePowerIrp @ 0x1C000F34C
 * Callers:
...
__int64 __fastcall RaidUnitSetDevicePowerIrp(struct _SLIST_ENTRY *Context, _SLIST_ENTRY *Irp)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 50LL, &WPP_9beceae3e67f3ebeaf45b51d134464fb_Traceguids, Context, Irp);
  }
