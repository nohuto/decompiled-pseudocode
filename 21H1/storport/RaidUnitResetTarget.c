/*
 * XREFs of RaidUnitResetTarget @ 0x1C0049C48
 * Callers:
 ...
 *     StorFreeSynchronousScsiRequest @ 0x1C0019720 (StorFreeSynchronousScsiRequest.c)
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C0050224 (StorpAggregateHierarchicalResetTarget.c)
 */
...
__int64 __fastcall RaidUnitResetTarget(__int64 a1)
{
  ...
  v5 = *(_QWORD *)(a1 + 8);
  v26 = v4;
  Srb = RaidAllocateSrb(v5, 0x13u, *(_BYTE *)(v3 + 410), 0);
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0068058 > 5 )
      {
        ...
        v28 = v18;
        v42 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(8LL, (unsigned __int8 *)dword_1C005C321, v18, v19, 8u, &v30);
      }
