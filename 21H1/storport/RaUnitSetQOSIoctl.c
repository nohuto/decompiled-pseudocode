/*
 * XREFs of RaUnitSetQOSIoctl @ 0x1C0046634
 * Callers:
 *     RaUnitDeviceControlIrp @ 0x1C000B8F8 (RaUnitDeviceControlIrp.c)
 * Callees:
 *     RaidCompleteRequestEx @ 0x1C0009950 (RaidCompleteRequestEx.c)
 *     RaidAdapterEnableQosWaitTimeoutCheck @ 0x1C002B324 (RaidAdapterEnableQosWaitTimeoutCheck.c)
 ...
 *     RaidUnitDisableWaitCheckTimer @ 0x1C0049140 (RaidUnitDisableWaitCheckTimer.c)
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      if ( v7 != 20 )
      {
        ...
        v9 = 40;
LABEL_83:
        WPP_SF_q((__int64)v8->AttachedDevice, v9, (__int64)&WPP_42fe1c4eb13a31e027d4a85af73a7d54_Traceguids, a1);
LABEL_84:
        v5 = -1073741637;
        goto LABEL_85;
      }
  ...
  if ( Flags != -1 && Flags != 500 * (Flags / 0x1F4) )
  {
    ...
    v17 = 46;
LABEL_77:
    WPP_SF_q((__int64)v16->AttachedDevice, v17, (__int64)&WPP_42fe1c4eb13a31e027d4a85af73a7d54_Traceguids, a1);
LABEL_78:
    v5 = -1073741811;
    goto LABEL_85;
  }
