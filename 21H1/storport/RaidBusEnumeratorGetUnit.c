/*
 * XREFs of RaidBusEnumeratorGetUnit @ 0x1C00158C4
 * Callers:
 ...
 *     RaidAdapterFindZombieUnit @ 0x1C0015FD0 (RaidAdapterFindZombieUnit.c)
 *     RaUnitSetQueueDepth @ 0x1C0016060 (RaUnitSetQueueDepth.c)
...
__int64 __fastcall RaidBusEnumeratorGetUnit(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( Unit )
    {
      RaUnitSetQueueDepth(
        v3[6],
        *(unsigned int *)(*(_QWORD *)(Unit + 24) + 524LL),
        *(unsigned int *)(*(_QWORD *)(Unit + 24) + 520LL));
LABEL_8:
      v12 = *(_QWORD *)(Unit + 24);
      *(_DWORD *)(Unit + 96) = a2;
      *(_WORD *)(Unit + 88) = 1;
