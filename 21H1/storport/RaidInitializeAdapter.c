/*
 * XREFs of RaidInitializeAdapter @ 0x1C0078154
 * Callers:
 ...
 *     RaidAllocateDeviceProperty @ 0x1C002F08C (RaidAllocateDeviceProperty.c)
 ...
 *     StorpInitializeAdapterTelemetry @ 0x1C0050E30 (StorpInitializeAdapterTelemetry.c)
 *     PortGetLinkTimeoutValue @ 0x1C0058250 (PortGetLinkTimeoutValue.c)
 *     PortRegistryReadDeviceKey @ 0x1C00728F4 (PortRegistryReadDeviceKey.c)
 ...
 *     PortGetDriverParameters @ 0x1C007B06C (PortGetDriverParameters.c)
    ...
    if ( (unsigned int)dword_1C0068058 > 5 )
    {
      if ( tlgKeywordOn(v41, 0x400000000000LL) )
      {
        ...
        *(_QWORD *)&v66[12].Size = 1LL;
        tlgWriteTransfer_EtwWriteTransfer(v42, (unsigned __int8 *)dword_1C005BBE1, v43, v44, 0xDu, v66);
      }
    }
    KeInitializeDpc(
