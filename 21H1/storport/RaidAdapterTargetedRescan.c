/*
 * XREFs of RaidAdapterTargetedRescan @ 0x1C002EEB4
 * Callers:
...
__int64 __fastcall RaidAdapterTargetedRescan(__int64 a1, __int64 a2, __int64 *a3, char a4)
{
  ...
  if ( Microsoft_Windows_StorPortEnableBits < 0 )
    McTemplateK0zqquuuqpp_EtwWriteTransfer(
      ...
      *(_QWORD *)(a1 + 4992),
      *(_QWORD *)(a1 + 5000));
  if ( (*(_DWORD *)(a1 + 4972) & 4) != 0 )
  {
    v5 = *(unsigned __int8 *)(a1 + 409);
    if ( *(_QWORD *)(a1 + 5024) )
    {
      v11 = (struct _RTL_BITMAP *)(a1 + 5008);
      if ( (*(_DWORD *)(a1 + 4976) & 1) != 0 )
        RtlSetBit(v11, v10);
      else
        RtlClearBit(v11, v10);
    }
  ...
  else
  {
    ...
    if ( (v13 & 1) != 0 )
    {
      *(_WORD *)((char *)&v17 + 1) = *(_WORD *)(v4 + 9);
      HIBYTE(v17) = 0;
      return RaidBusEnumeratorVisitUnit((__int64)a3, v17);
    }
  }
  v15 = *(unsigned __int8 *)(a1 + 458);
...
LABEL_20:
  ...
  while ( 1 )
  {
    ...
    {
      BYTE2(v17) = v16;
      result = RaidBusEnumeratorVisitUnit((__int64)a3, v17);
      v6 = result;
      if ( (int)result < 0 )
        return result;
    }
