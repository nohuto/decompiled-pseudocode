/*
 * XREFs of RaidpLinkDown @ 0x1C003699C
 * Callers:
...
__int64 __fastcall RaidpLinkDown(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (Microsoft_Windows_StorPortEnableBits & 2) != 0 )
  {
    v6 = *(_DWORD *)(a1 + 2216);
    v5 = *(_DWORD *)(a1 + 56);
    McTemplateK0pqq_EtwWriteTransfer(a1, &EventLinkDown, a3, *(_QWORD *)(a1 + 544) + 16LL, v5, v6);
  }
  result = StorPortPause(*(_QWORD *)(a1 + 544) + 16LL, *(unsigned int *)(a1 + 2216));
  if ( (_BYTE)result )
