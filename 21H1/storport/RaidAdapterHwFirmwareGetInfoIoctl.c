/*
 * XREFs of RaidAdapterHwFirmwareGetInfoIoctl @ 0x1C002BBC0
 * Callers:
 ...
 *     RaTranslateMiniportFirmwareInfoToHwFirmwareInfo @ 0x1C0042F84 (RaTranslateMiniportFirmwareInfoToHwFirmwareInfo.c)
 */
