/*
 * XREFs of RaidRemoveIoQueue @ 0x1C0016EE8
 * Callers:
 *     RaidUnitCancelPendingRequests @ 0x1C0016EB0 (RaidUnitCancelPendingRequests.c)
 *     RaUnitDisableDeviceIrp @ 0x1C0045F30 (RaUnitDisableDeviceIrp.c)
 *     RaUnitFlushQueueSrb @ 0x1C0045FBC (RaUnitFlushQueueSrb.c)
 * Callees:
 *     RaidRemovePendingDeviceQueue @ 0x1C0016F10 (RaidRemovePendingDeviceQueue.c)
 */
