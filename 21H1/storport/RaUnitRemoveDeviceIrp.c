/*
 * XREFs of RaUnitRemoveDeviceIrp @ 0x1C0019C34
 * Callers:
...
__int64 __fastcall RaUnitRemoveDeviceIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 12LL, &WPP_42fe1c4eb13a31e027d4a85af73a7d54_Traceguids, a1, a2);
  }
  if ( *(_DWORD *)(a1 + 48) == 6 )
  {
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 13LL, &WPP_42fe1c4eb13a31e027d4a85af73a7d54_Traceguids, a1, a2);
    }
  ...
  else
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 14LL, &WPP_42fe1c4eb13a31e027d4a85af73a7d54_Traceguids, a1, a2, v5);
    }
    return v5;
  }
}
