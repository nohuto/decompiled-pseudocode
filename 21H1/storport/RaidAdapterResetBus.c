/*
 * XREFs of RaidAdapterResetBus @ 0x1C002CD08
 * Callers:
  ...
  if ( (qword_1C0068350 & 0x400) != 0 )
    DbgLogRequest(
      *(_QWORD *)(a1 + 304),
      11,
      *(_QWORD *)(a1 + 304),
      *(unsigned int *)(*(_QWORD *)(a1 + 304) + 56LL),
      v2,
      0LL,
      0LL);
  v12 = *(_QWORD *)(a1 + 536);
  ...
  *(_BYTE *)(a1 + 552) &= ~2u;
  ...
  if ( (unsigned int)dword_1C0068058 > 5 )
  {
    if ( tlgKeywordOn(v22, 0x400000000000LL) )
    {
      ...
      v53 = 4;
      v56 = 4;
      tlgWriteTransfer_EtwWriteTransfer(4LL, (unsigned __int8 *)dword_1C005BCD2, v24, v25, 9u, &v36);
    }
  }
  *(_DWORD *)(a1 + 252) = 0;
  return v15;
