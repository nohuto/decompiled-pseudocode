/*
 * XREFs of McTemplateK0pquuutx_EtwWriteTransfer @ 0x1C003C698
 * Callers:
...
NTSTATUS McTemplateK0pquuutx_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, 0LL, 8u, &v5);
}
