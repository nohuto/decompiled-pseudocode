/*
 * XREFs of RaUnitScsiFreeDumpPointersIoctl @ 0x1C0011364
 * Callers:
...
__int64 __fastcall RaUnitScsiFreeDumpPointersIoctl(__int64 a1, IRP *a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_BYTE *)(a1 + 1733) == 1 && v4 )
  {
    ...
    *((_QWORD *)v8 + 8) = *(_QWORD *)(p_Process + 64);
    ...
    if ( !Srb
      || (ContiguousIoResources = StorAllocateContiguousIoResources(
                                    ((*(_DWORD *)(v4 + 452) + 7) & 0xFFFFFFF8) + 1088,
                                    v17,
                                    v4),
    ...
    *(_QWORD *)(v10 + 656) = RaidXrbSignalCompletion;
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 34LL, &WPP_42fe1c4eb13a31e027d4a85af73a7d54_Traceguids, v10, Srb);
    }
    if ( *(_BYTE *)(v4 + 4514) )
  ...
  StorPortReleaseAdditionalCrashDumpArea(v25 + 712, v16, v5, a4);
