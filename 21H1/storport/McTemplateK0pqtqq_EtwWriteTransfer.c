/*
 * XREFs of McTemplateK0pqtqq_EtwWriteTransfer @ 0x1C0029180
 * Callers:
...
NTSTATUS McTemplateK0pqtqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventAdapterPoFxRegistered, 0LL, 6u, &v4);
}
