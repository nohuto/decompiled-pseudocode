/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesCriticalData @ 0x1C00538C4
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0068058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v50 = 1LL;
      v52 = 1LL;
      tlgCreate1Sz_wchar_t((__int64)v53, *(_WORD **)(v2 + 4864));
      ...
      v103 = v11;
      v104 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v11, (unsigned __int8 *)dword_1C005E86E, v12, v13, 0x24u, &v40);
    }
  }
}
