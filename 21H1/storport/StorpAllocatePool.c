/*
 * XREFs of StorpAllocatePool @ 0x1C00121E8
 * Callers:
  ...
  if ( a4 )
  {
    *a4 = 0LL;
    if ( KeGetCurrentIrql() > 2u )
    {
      ...
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 27LL, &WPP_258a4a2f60cd3686bc4022bc720d1057_Traceguids);
      }
      ...
      *a4 = PoolWithTag;
      if ( !PoolWithTag )
      {
        if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          ...
          && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
        {
          WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 28LL, &WPP_258a4a2f60cd3686bc4022bc720d1057_Traceguids);
        }
