/*
 * XREFs of StorpCSExitTelemetry @ 0x1C00506C4
 * Callers:
...
void __fastcall StorpCSExitTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( *(_QWORD *)(a1 + 5088) )
    {
      ...
      if ( v7 )
        v7 -= *(_QWORD *)(a1 + 5344);
      if ( (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(v7, 0x400000000000LL) )
      {
        v104 = 16LL;
        v103 = a1 + 5192;
        v29 = *(_DWORD *)(a1 + 56);
        ...
        v130 = 8LL;
        v132 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer(v13, (unsigned __int8 *)dword_1C005E01D, v8, v9, 0x11u, &v102);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        ...
        if ( (unsigned int)dword_1C0068058 > 5 )
        {
          if ( tlgKeywordOn(v18, 0x400000000000LL) )
          {
            ...
            v99 = 8LL;
            v101 = 4LL;
            tlgWriteTransfer_EtwWriteTransfer(v24, (unsigned __int8 *)dword_1C005DDBA, v19, v20, 0x17u, &v59);
          }
        }
