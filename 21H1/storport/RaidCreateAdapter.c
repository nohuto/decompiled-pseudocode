/*
 * XREFs of RaidCreateAdapter @ 0x1C002F5B8
 * Callers:
 ...
 *     StorCreateDictionary @ 0x1C0057720 (StorCreateDictionary.c)
 *     RaCreateBus @ 0x1C0078A9C (RaCreateBus.c)
 *     RaidCreateDma @ 0x1C0078B2C (RaidCreateDma.c)
 *     RaCreateMiniport @ 0x1C0079768 (RaCreateMiniport.c)
 *     RaidCreateResourceList @ 0x1C0079BF0 (RaidCreateResourceList.c)
 */
