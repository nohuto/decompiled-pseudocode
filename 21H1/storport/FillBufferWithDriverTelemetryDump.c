/*
 * XREFs of FillBufferWithDriverTelemetryDump @ 0x1C0056594
 * Callers:
 *     RaidStandardSecondaryDumpCallback @ 0x1C00568A0 (RaidStandardSecondaryDumpCallback.c)
 * Callees:
 *     memset @ 0x1C001B4C0 (memset.c)
 *     RtlStringCopyWorkerA @ 0x1C005695C (RtlStringCopyWorkerA.c)
 */
