/*
 * XREFs of StorpInitializePerfTelemetry @ 0x1C0050EBC
 * Callers:
 *     StorpRegisterTraceLogging @ 0x1C007A9F4 (StorpRegisterTraceLogging.c)
 * Callees:
...
__int64 StorpInitializePerfTelemetry()
{
  ...
  unk_1C0068608 = 24LL;
  qword_1C0068640 = 0x34000000022LL;
  v1 = 2LL;
  *(_OWORD *)&xmmword_1C0068630 = 0LL;
  *(&xmmword_1C0068630 + 1) = (PVOID)0x180000000ALL;
  xmmword_1C0068610 = 0LL;
  *(_OWORD *)&P = 0LL;
  *(_QWORD *)&xmmword_1C0068610 = 327682LL;
  *(_OWORD *)&xmmword_1C00685F8 = 0LL;
  *(_OWORD *)&xmmword_1C0068620 = 0LL;
  g_RaidNumberProcessors = KeQueryActiveProcessorCountEx(0xFFFFu);
  LODWORD(Size) = HIDWORD(qword_1C0068640) * g_RaidNumberProcessors;
  if ( UseQPCTime )
    PerformanceCounter = KeQueryPerformanceCounter(0LL);
  else
    PerformanceCounter.QuadPart = KeQueryUnbiasedInterruptTime();
  qword_1C0068650 = PerformanceCounter.QuadPart;
  ...
  {
    xmmword_1C00685F8 = ExAllocatePoolWithTag(
  ...
  {
    xmmword_1C00685F8 = 0LL;
  }
  if ( HIWORD(TelemetryPerfContext) )
  {
    *(&xmmword_1C00685F8 + 1) = ExAllocatePoolWithTag(
                                  NonPagedPoolNxCacheAligned,
  ...
  {
    *(&xmmword_1C00685F8 + 1) = 0LL;
  }
  if ( (_WORD)xmmword_1C0068610 )
  {
    *((_QWORD *)&xmmword_1C0068610 + 1) = ExAllocatePoolWithTag(
                                            NonPagedPoolNxCacheAligned,
                                            8LL * (unsigned __int16)xmmword_1C0068610,
                                            0x65546152u);
  ...
  {
    *((_QWORD *)&xmmword_1C0068610 + 1) = 0LL;
  }
  if ( WORD1(xmmword_1C0068610) )
  {
    xmmword_1C0068620 = ExAllocatePoolWithTag(NonPagedPoolNxCacheAligned, 8LL * WORD1(xmmword_1C0068610), 0x65546152u);
    if ( !xmmword_1C0068620 )
      goto LABEL_34;
  }
  else
  {
    xmmword_1C0068620 = 0LL;
  }
  if ( WORD2(xmmword_1C0068610) )
  {
    *(&xmmword_1C0068620 + 1) = ExAllocatePoolWithTag(
                                  NonPagedPoolNxCacheAligned,
                                  8LL * WORD2(xmmword_1C0068610),
                                  0x65546152u);
  ...
  {
    *(&xmmword_1C0068620 + 1) = 0LL;
  }
  if ( WORD3(xmmword_1C0068610) )
  {
    xmmword_1C0068630 = ExAllocatePoolWithTag(NonPagedPoolNxCacheAligned, 8LL * WORD3(xmmword_1C0068610), 0x65546152u);
...
LABEL_34:
  ...
  do
  {
    *(_QWORD *)(v6 + *((_QWORD *)&xmmword_1C0068610 + 1)) = v7++;
    v6 += 8LL;
    --v1;
  }
  while ( v1 );
  if ( UseQPCTime && g_StorpTraceLoggingPerformanceHighResolutionTimer )
  {
    ...
    *(_QWORD *)xmmword_1C0068620 = (PerformanceFrequency.QuadPart << 6) / 1000;
    *((_QWORD *)xmmword_1C0068620 + 1) = (PerformanceFrequency.QuadPart << 8) / 1000;
    *((_QWORD *)xmmword_1C0068620 + 2) = (PerformanceFrequency.QuadPart << 10) / 1000;
    *((_QWORD *)xmmword_1C0068620 + 3) = 5120 * PerformanceFrequency.QuadPart / 1000;
  }
  else
  {
    *(_QWORD *)*(&P + 1) = 2560LL;
    ...
    *((_QWORD *)*(&P + 1) + 11) = 0x7FFFFFFFFFFFFFFFLL;
    *(_QWORD *)xmmword_1C0068620 = 640000LL;
    *((_QWORD *)xmmword_1C0068620 + 1) = 2560000LL;
    *((_QWORD *)xmmword_1C0068620 + 2) = 10240000LL;
    *((_QWORD *)xmmword_1C0068620 + 3) = 51200000LL;
  }
  *((_QWORD *)xmmword_1C0068620 + 4) = 0x7FFFFFFFFFFFFFFFLL;
  dword_1C0068658 = 64;
  g_RaidNumaHighestNodeNumber = KeQueryHighestNodeNumber();
  LODWORD(dword_1C006865C) = dword_1C0068658 * ((unsigned __int16)g_RaidNumaHighestNodeNumber + 1);
  return v0;
}
