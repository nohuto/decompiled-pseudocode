/*
 * XREFs of RaidUnitResetUnit @ 0x1C0049F00
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C00501D0 (StorpAggregateHierarchicalResetLun.c)
 */
...
__int64 __fastcall RaidUnitResetUnit(__int64 a1)
{
  ...
  *(_OWORD *)&v29[1] = 0LL;
  ...
  v5 = *(_QWORD *)(a1 + 8);
  v27 = v4;
  Srb = RaidAllocateSrb(v5, 0x20u, *(_BYTE *)(v3 + 410), 0);
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0068058 > 5 )
      {
        ...
        v29[0] = v18;
        v46 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v22, (unsigned __int8 *)dword_1C005C393, v18, v19, 0xAu, &v30);
      }
