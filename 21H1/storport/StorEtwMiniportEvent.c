/*
 * XREFs of StorEtwMiniportEvent @ 0x1C004EC28
 * Callers:
 ...
 *     StorEtwMiniportGetKeyword @ 0x1C004F488 (StorEtwMiniportGetKeyword.c)
        ...
        __int64 a12)
{
  ...
  if ( !a9 || !StorEtwLoggingEnabled || (byte_1C0068843 & 0x10) == 0 )
  {
    if ( a2 )
    {
      if ( !StorEtwLoggingEnabled )
        return 0LL;
      if ( (byte_1C0068843 & 0x10) != 0 )
      {
        if ( a10 > 2 )
        {
          if ( a10 > 4 )
    ...
    if ( StorEtwLoggingEnabled && (byte_1C0068843 & 0x10) != 0 )
    {
      if ( a10 > 2 )
      {
        if ( a10 > 4 )
