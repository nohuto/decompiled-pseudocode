/*
 * XREFs of RaidUnitCompleteResetRequest @ 0x1C0048EA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidUnitCompleteResetRequest(__int64 a1)
{
  ...
  if ( (_BYTE)v9 == 40 )
    v9 = *(_DWORD *)(v1 + 20);
  if ( v9 == 16 && (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(v5, 0x400000000000LL) )
  {
    v12 = *(_QWORD *)(v4 + 24);
    v24 = 0;
    v27 = 0;
    ...
    v40 = &v19;
    v41 = v11;
    tlgWriteTransfer_EtwWriteTransfer(v12, (unsigned __int8 *)dword_1C005C479, v10, v11, 9u, &v21);
  }
