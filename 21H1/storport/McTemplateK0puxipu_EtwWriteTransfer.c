/*
 * XREFs of McTemplateK0puxipu_EtwWriteTransfer @ 0x1C004CE74
 * Callers:
...
NTSTATUS McTemplateK0puxipu_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 1LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, a3, 7u, &v4);
}
