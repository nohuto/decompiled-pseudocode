/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C000CB68
 * Callers:
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
    ...
    && tlgKeywordOn(v2, 0x400000000000LL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v5, (int)&dword_1C005D9C5, v6, v7, 0x13u, &v27);
  }
    ...
    && tlgKeywordOn(v3, 0x400000000000LL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v8, (int)&dword_1C005E708, v9, v10, 0x13u, &v27);
  }
