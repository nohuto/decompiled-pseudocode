/*
 * XREFs of RaidAdapterCreateDumpInfo @ 0x1C0076388
 * Callers:
 ...
 *     RaidQueryCrashdumpFunctions @ 0x1C0012F9C (RaidQueryCrashdumpFunctions.c)
 *     memset @ 0x1C001B4C0 (memset.c)
 *     RaidAdapterFreeDriverInfo @ 0x1C002B46C (RaidAdapterFreeDriverInfo.c)
 *     RaidAdapterFreeDumpInfo @ 0x1C002B554 (RaidAdapterFreeDumpInfo.c)
...
__int64 __fastcall RaidAdapterCreateDumpInfo(__int64 a1, _QWORD *a2, _QWORD *a3, _BYTE *a4, _QWORD *a5, _BYTE *a6)
{
  ...
  *(_OWORD *)(v19 + 24) = *(_OWORD *)(a1 + 5192);
  ...
  if ( v20 )
  {
    ...
    *((_QWORD *)v21 + 1) = a1;
    *((_OWORD *)v21 + 4) = *(_OWORD *)(a1 + 312);
    *((_OWORD *)v21 + 5) = *(_OWORD *)(a1 + 328);
    *((_OWORD *)v21 + 6) = *(_OWORD *)(a1 + 344);
    *((_OWORD *)v21 + 7) = *(_OWORD *)(a1 + 360);
    *((_OWORD *)v21 + 8) = *(_OWORD *)(a1 + 376);
    *((_OWORD *)v21 + 9) = *(_OWORD *)(a1 + 392);
    *((_OWORD *)v21 + 10) = *(_OWORD *)(a1 + 408);
    *((_OWORD *)v21 + 11) = *(_OWORD *)(a1 + 424);
    *((_OWORD *)v21 + 12) = *(_OWORD *)(a1 + 440);
    *((_OWORD *)v21 + 13) = *(_OWORD *)(a1 + 456);
    *((_OWORD *)v21 + 14) = *(_OWORD *)(a1 + 472);
    *((_OWORD *)v21 + 15) = *(_OWORD *)(a1 + 488);
    *((_OWORD *)v21 + 16) = *(_OWORD *)(a1 + 504);
    *((_OWORD *)v21 + 17) = *(_OWORD *)(a1 + 520);
    *((_DWORD *)v19 + 11) = 312;
...
LABEL_43:
    ...
    *((_QWORD *)v21 + 6) = v24;
    if ( (unsigned __int8)(*(_BYTE *)(a1 + 456) - 2) <= 2u )
      *((_DWORD *)v19 + 10) |= 1u;
    v25 = *(_QWORD *)(a1 + 536);
