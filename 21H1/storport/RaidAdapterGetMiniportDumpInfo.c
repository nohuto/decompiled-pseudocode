/*
 * XREFs of RaidAdapterGetMiniportDumpInfo @ 0x1C0077388
 * Callers:
 ...
 *     RaidXrbSetCompletionRoutine @ 0x1C000EA4C (RaidXrbSetCompletionRoutine.c)
 *     RaidFreeSrb @ 0x1C00136DC (RaidFreeSrb.c)
