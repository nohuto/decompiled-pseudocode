/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsCriticalData @ 0x1C0052560
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(a1, 0x800000000000LL) )
  {
    ...
    v111 = &v32;
    v112 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v26, (unsigned __int8 *)dword_1C005F54E, v6, v23, 0x26u, &v44);
  }
}
