/*
 * XREFs of RaDeleteDriver @ 0x1C0078D7C
 * Callers:
 *     RaDriverUnload @ 0x1C0032E30 (RaDriverUnload.c)
 *     StorPortInitialize @ 0x1C0034850 (StorPortInitialize.c)
 * Callees:
 *     RaidReleasePortData @ 0x1C000C8A4 (RaidReleasePortData.c)
 *     _guard_dispatch_icall_nop @ 0x1C001B1C0 (_guard_dispatch_icall_nop.c)
 *     McGenEventUnregister_EtwUnregister @ 0x1C0032B28 (McGenEventUnregister_EtwUnregister.c)
 *     RaFreeDriverInitData @ 0x1C0032F10 (RaFreeDriverInitData.c)
 *     RaidRemovePortDriver @ 0x1C00344C8 (RaidRemovePortDriver.c)
 *     StorpUnRegisterTraceLogging @ 0x1C007ABBC (StorpUnRegisterTraceLogging.c)
 */
