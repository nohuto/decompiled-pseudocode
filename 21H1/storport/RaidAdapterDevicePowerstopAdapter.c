/*
 * XREFs of RaidAdapterDevicePowerstopAdapter @ 0x1C000F8FC
 * Callers:
 ...
 *     RaidAdapterClearCryptoKeyTable @ 0x1C002A5EC (RaidAdapterClearCryptoKeyTable.c)
...
NTSTATUS __fastcall RaidAdapterDevicePowerstopAdapter(PIRP Irp, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_9beceae3e67f3ebeaf45b51d134464fb_Traceguids, a2, Irp);
  }
  RaidAdapterStop(a2);
