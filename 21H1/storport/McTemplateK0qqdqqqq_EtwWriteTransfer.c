/*
 * XREFs of McTemplateK0qqdqqqq_EtwWriteTransfer @ 0x1C0029338
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqdqqqq_EtwWriteTransfer(
        __int64 a1,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, 0LL, 8u, &v11);
}
