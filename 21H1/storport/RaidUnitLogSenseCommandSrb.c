/*
 * XREFs of RaidUnitLogSenseCommandSrb @ 0x1C001A028
 * Callers:
 *     StorpTelemetrySendUnitScsiDiagnostics @ 0x1C001AA2C (StorpTelemetrySendUnitScsiDiagnostics.c)
 *     RaidUnitLogSenseTemperatureSrb @ 0x1C00497C4 (RaidUnitLogSenseTemperatureSrb.c)
 * Callees:
...
__int64 __fastcall RaidUnitLogSenseCommandSrb(__int64 a1, __int64 a2, char a3, char a4, unsigned int *a5, _BYTE *a6)
{
  ...
  memset(a6, 0, v10);
  v26 = *(_QWORD *)(a1 + 24);
  Srb = RaidAllocateSrb(*(_QWORD *)(a1 + 8), 0, *(_BYTE *)(v26 + 410), 1);
  if ( !Srb )
