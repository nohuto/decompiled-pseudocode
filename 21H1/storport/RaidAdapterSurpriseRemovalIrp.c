/*
 * XREFs of RaidAdapterSurpriseRemovalIrp @ 0x1C0077F30
 * Callers:
 ...
 *     RaidAdapterMarkChildrenMissing @ 0x1C002BECC (RaidAdapterMarkChildrenMissing.c)
...
NTSTATUS __fastcall RaidAdapterSurpriseRemovalIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 88) = 5;
  ...
  if ( (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(a1, 0x400000000000LL) )
  {
    ...
    v24 = v5;
    v45 = v14;
    tlgWriteTransfer_EtwWriteTransfer(v15, (unsigned __int8 *)dword_1C005BB31, v16, v17, 0xAu, &v26);
  }
