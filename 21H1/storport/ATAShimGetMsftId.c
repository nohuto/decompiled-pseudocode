/*
 * XREFs of ATAShimGetMsftId @ 0x1C0056BA0
 * Callers:
 *     ATADeviceIdShimStorageDeviceIdCompletionHook @ 0x1C0056B30 (ATADeviceIdShimStorageDeviceIdCompletionHook.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0019FC0 (__security_check_cookie.c)
 *     RaidAddATADeviceIdMapping @ 0x1C0033CB4 (RaidAddATADeviceIdMapping.c)
 *     RaidCheckATADeviceIdMapping @ 0x1C0033FA0 (RaidCheckATADeviceIdMapping.c)
 *     RaidSaveATADeviceIdMapping @ 0x1C0034548 (RaidSaveATADeviceIdMapping.c)
 *     TrimString @ 0x1C0057350 (TrimString.c)
 */
