/*
 * XREFs of RaUnitDeviceUsageNotificationIrp @ 0x1C0010F24
 * Callers:
 ...
 *     RaidSecondaryDumpRegister @ 0x1C0056830 (RaidSecondaryDumpRegister.c)
      ...
      if ( CurrentStackLocation->Parameters.Create.Options == 4 )
      {
        ...
        if ( Lock )
        {
          ...
          *(_BYTE *)(v2 + 104) |= 0x80u;
          ...
          if ( (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(v10, 0x400000000000LL) )
          {
            v12 = *(_QWORD *)(v2 + 4864);
            v38 = v2 + 5192;
            v39 = 16LL;
            ...
            tlgWriteTransfer_EtwWriteTransfer((int)&v37, (int)&dword_1C005C4EA, v14, v15, 0xBu, &v37);
          }
        }
        else
        {
...
LABEL_47:
    ...
    if ( v6 && RaidIsUnitControlSupported(a1, 1) )
    {
      ...
      *(_QWORD *)&v34 = &v36;
      ...
      DWORD1(v36) = 4;
      DWORD2(v34) = Options;
      RaCallMiniportUnitControl(v24 + 304, 1LL);
    }
    if ( Options == 3 )
    {
      v25 = *(_DWORD *)(a1 + 920);
