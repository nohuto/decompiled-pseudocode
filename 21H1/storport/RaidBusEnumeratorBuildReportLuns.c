/*
 * XREFs of RaidBusEnumeratorBuildReportLuns @ 0x1C0015B84
 * Callers:
 *     RaidBusEnumeratorIssueReportLuns @ 0x1C0015078 (RaidBusEnumeratorIssueReportLuns.c)
 * Callees:
 *     memset @ 0x1C001B4C0 (memset.c)
 *     RaidInitializeReportLunsSrb @ 0x1C00727D4 (RaidInitializeReportLunsSrb.c)
 */
        ...
        _QWORD *a5)
{
  ...
  v12 = *a1;
  LOBYTE(v13) = a2;
  RaidInitializeReportLunsSrb(v7, v13, a2 >> 8, HIWORD(a2), (__int64)v5, v10, *(_BYTE *)(v12 + 410));
  if ( *(_BYTE *)(v12 + 410) == 1 )
  {
    *(_QWORD *)(v7 + 104) = 0LL;
    v16 = 0LL;
