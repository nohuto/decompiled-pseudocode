/*
 * XREFs of RaidRegisterPerfStates @ 0x1C003DFA8
 * Callers:
 ...
 *     RaidGetStorPoFxPerfState @ 0x1C00367DC (RaidGetStorPoFxPerfState.c)
 *     RaidValidatePerfSets @ 0x1C003E87C (RaidValidatePerfSets.c)
 */
