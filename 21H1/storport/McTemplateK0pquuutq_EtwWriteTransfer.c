/*
 * XREFs of McTemplateK0pquuutq_EtwWriteTransfer @ 0x1C003C5D0
 * Callers:
...
NTSTATUS McTemplateK0pquuutq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventUnitPowerNotRequiredStart, 0LL, 8u, &v5);
}
