/*
 * XREFs of StorpTelemetryLogUnitPerfDataMeasures @ 0x1C0002A40
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0068058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x400000000000LL) )
    {
      ...
      v80 = &v20;
      v12 = v10[40];
      v20 = 3 * qword_1C0068640;
      v82 = v12;
      v83 = 8 * (unsigned __int16)(3 * qword_1C0068640);
      tlgWriteTransfer_EtwWriteTransfer(3 * qword_1C0068640, (int)&dword_1C005D2D7, v13, v14, 0x1Fu, &v32);
    }
  }
}
