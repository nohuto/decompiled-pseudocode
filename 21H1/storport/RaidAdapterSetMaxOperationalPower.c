/*
 * XREFs of RaidAdapterSetMaxOperationalPower @ 0x1C003D624
 * Callers:
 ...
 *     RaidAdapterPassiveCoolingCallback @ 0x1C003D300 (RaidAdapterPassiveCoolingCallback.c)
 * Callees:
 ...
 *     RaidAdapterEffectiveMaxOperationalPower @ 0x1C003D2D0 (RaidAdapterEffectiveMaxOperationalPower.c)
 */
...
LABEL_11:
  ...
  v34 = v26;
  v15 = RaCallMiniportAdapterControl(a1 + 304);
  if ( v15 >= 0 )
  {
    if ( a3 )
    {
  ...
  if ( (unsigned int)dword_1C0068058 > 5 )
  {
    if ( tlgKeywordOn(v14, 0x400000000000LL) )
    {
      ...
      v31 = v19;
      v59 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer(v17, (unsigned __int8 *)dword_1C005BED7, v18, v19, 0xEu, &v35);
    }
  }
