/*
 * XREFs of RaidAdapterSetSystemPowerCompletion @ 0x1C0011B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterSetSystemPowerCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 42LL, &WPP_9beceae3e67f3ebeaf45b51d134464fb_Traceguids, v2, a2);
  }
  v5 = *(_QWORD *)(a2 + 184);
  v6 = *(int *)(v5 + 24);
...
LABEL_6:
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 43LL, &WPP_9beceae3e67f3ebeaf45b51d134464fb_Traceguids, v2, a2, v10);
  }
