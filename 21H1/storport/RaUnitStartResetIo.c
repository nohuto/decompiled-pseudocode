/*
 * XREFs of RaUnitStartResetIo @ 0x1C00476D8
 * Callers:
...
LABEL_42:
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v15 == 16 && (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(FullCreateOptions, 0x400000000000LL) )
    {
      v21 = v29;
      v33 = 0;
      v36 = 0;
      ...
      v44 = v20;
      v47 = v20;
      tlgWriteTransfer_EtwWriteTransfer(v19, (unsigned __int8 *)dword_1C005C413, v11, v20, 8u, &v30);
    }
    else
    {
      v21 = v29;
