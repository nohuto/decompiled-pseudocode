/*
 * XREFs of DllInitialize @ 0x1C004ADE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidpIsControlledWinPEEnvironment @ 0x1C004BCE8 (RaidpIsControlledWinPEEnvironment.c)
 ...
 *     RaidDecodeSmRegistryBlob @ 0x1C0057510 (RaidDecodeSmRegistryBlob.c)
 *     StorpWheaAddErrorSource @ 0x1C0079CB4 (StorpWheaAddErrorSource.c)
 *     SpVerifierInitialization @ 0x1C007A86C (SpVerifierInitialization.c)
...
__int64 DllInitialize()
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  {
    StorpRegisterShim();
    qword_1C0068838 = (__int64)&EnclosureIdList;
