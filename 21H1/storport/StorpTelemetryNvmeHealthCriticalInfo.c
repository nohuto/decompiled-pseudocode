/*
 * XREFs of StorpTelemetryNvmeHealthCriticalInfo @ 0x1C00557B4
 * Callers:
 *     StorpTelemetrySendUnitNvmeHealthInfo @ 0x1C0055DEC (StorpTelemetrySendUnitNvmeHealthInfo.c)
 * Callees:
    ...
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        *(__int64 *)&g_SystemUptime_s,
        (unsigned __int8 *)dword_1C005F074,
        v22,
        v23,
        0x1Au,
        &v38);
