/*
 * XREFs of RaidAdapterFilterResourceRequirementsIrp @ 0x1C0076DF4
 * Callers:
...
__int64 __fastcall RaidAdapterFilterResourceRequirementsIrp(__int64 a1, IRP *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( Information )
    {
      *(_DWORD *)(a1 + 768) = Information[2];
      *(_DWORD *)(a1 + 772) = Information[3];
      if ( (*(_DWORD *)(*(_QWORD *)(a1 + 536) + 184LL) & 0x200) != 0 && !RaidMachineRequireIoPortResource() )
      {
        v6 = 0;
        v7 = Information + 8;
        v8 = Information + 8;
