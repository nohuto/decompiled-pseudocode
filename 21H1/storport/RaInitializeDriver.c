/*
 * XREFs of RaInitializeDriver @ 0x1C0078E70
 * Callers:
 *     StorPortInitialize @ 0x1C0034850 (StorPortInitialize.c)
 * Callees:
 *     McGenEventRegister_EtwRegister @ 0x1C0032AE8 (McGenEventRegister_EtwRegister.c)
 *     RaidAddPortDriver @ 0x1C0033F1C (RaidAddPortDriver.c)
