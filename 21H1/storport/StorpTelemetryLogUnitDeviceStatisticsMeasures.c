/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsMeasures @ 0x1C0052A2C
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsMeasures(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(a1, 0x400000000000LL) )
  {
    ...
    v111 = &v32;
    v112 = 1LL;
    tlgWriteTransfer_EtwWriteTransfer(v26, (unsigned __int8 *)dword_1C005D4A7, v6, v23, 0x26u, &v44);
  }
}
