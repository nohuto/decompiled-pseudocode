/*
 * XREFs of StorpTelemetryLogUnitErrorDataMeasures @ 0x1C00026B0
 * Callers:
...
void __fastcall StorpTelemetryLogUnitErrorDataMeasures(_DWORD *a1)
{
  ...
  if ( (unsigned int)dword_1C0068058 > 5 && (unsigned __int8)tlgKeywordOn(a1, 0x400000000000LL) )
  {
    v3 = *(_QWORD *)(v2 + 24);
    v25 = &v9;
    v9 = 5;
    ...
    v69 = 4LL;
    v71 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer(v6, (int)&dword_1C005EAAB, v7, v8, 0x1Du, &v24);
  }
  *(_QWORD *)(a1 + 539) = 0LL;
}
