/*
 * XREFs of RaUnitQueryCapabilitiesIrp @ 0x1C0071B18
 * Callers:
 ...
 *     RaUnitIsSMRDisabled @ 0x1C0013280 (RaUnitIsSMRDisabled.c)
 ...
 *     PortGetDeviceType @ 0x1C0072484 (PortGetDeviceType.c)
 */
...
__int64 __fastcall RaUnitQueryCapabilitiesIrp(__int64 a1, IRP *a2)
{
  ...
  {
    RaidUnitPoFxActivateComponent(a1, 0, 1u, v39);
    ...
    v8 = 4 * (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 536LL) + 184LL) & 4 | 2u);
    ...
    *(_OWORD *)&SecurityContext[2].SecurityQos = v40[3];
    ...
    if ( PoolWithTag )
    {
      ...
      if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 536LL) + 184LL) & 4) != 0 )
      {
        v15 = PoolWithTag[1];
        *PoolWithTag = 1572865;
