/*
 * XREFs of RaidAdapterPowerDownDevice @ 0x1C0010448
 * Callers:
 ...
 *     GatewayRegisterForEmptyNotification @ 0x1C00104E0 (GatewayRegisterForEmptyNotification.c)
...
__int64 __fastcall RaidAdapterPowerDownDevice(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 23LL, &WPP_9beceae3e67f3ebeaf45b51d134464fb_Traceguids, a1, a2);
  }
  ...
  *(_BYTE *)(*(_QWORD *)(a2 + 184) + 3LL) |= 1u;
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 24LL, &WPP_9beceae3e67f3ebeaf45b51d134464fb_Traceguids, a1, a2, v4);
  }
  return 259LL;
}
