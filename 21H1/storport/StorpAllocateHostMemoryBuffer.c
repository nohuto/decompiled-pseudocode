/*
 * XREFs of StorpAllocateHostMemoryBuffer @ 0x1C003960C
 * Callers:
        ...
        unsigned int *a10)
{
  ...
  unsigned __int64 v38; // [rsp+78h] [rbp-60h]
  __int64 v39; // [rsp+80h] [rbp-58h]
  __int64 v40; // [rsp+88h] [rbp-50h]
  unsigned __int64 v41; // [rsp+90h] [rbp-48h]
...
LABEL_28:
  ...
  while ( v23 >= 0x1000 && v12 < a1 )
  {
    ...
    *((_QWORD *)PoolWithTag + 4) = 0LL;
    v26 = *(__int64 (__fastcall **)(__int64, PHYSICAL_ADDRESS *, PHYSICAL_ADDRESS *, _QWORD, _DWORD))(*(_QWORD *)(v22 + 8) + 272LL);
    if ( v26 )
    {
      Flags = &v42;
      *((_QWORD *)PoolWithTag + 3) = v26(v22, &LowAddress, &HighAddress, (unsigned int)v23, 0);
    }
    else
    {
    ...
    if ( v27 )
    {
      ...
      v29 = 2LL * v13;
      v12 += v28;
      *(_QWORD *)(v21 + 8 * v29) = *(_QWORD *)(v27 + 48) << 12;
      *(_DWORD *)(v21 + 8 * v29 + 8) = v28;
      goto LABEL_39;
    }
    if ( *((_QWORD *)v25 + 3) )
    {
      v30 = 2LL * v13;
      v12 += v23;
      *(_QWORD *)(v21 + 8 * v30) = *((_QWORD *)v25 + 2);
      *(_DWORD *)(v21 + 8 * v30 + 8) = v23;
      *((_QWORD *)v25 + 4) = v23;
LABEL_39:
      ++v13;
      if ( v14 )
