/*
 * XREFs of ?OpenSessionKey@CAudioSessionStore@@AEAAJPEAPEAUHKEY__@@@Z @ 0x18005238C
 * Callers:
 ...
 *     ?IsEqual@CAudioSessionStore@@UEAA_NPEBG@Z @ 0x1800525C0 (-IsEqual@CAudioSessionStore@@UEAA_NPEBG@Z.c)
