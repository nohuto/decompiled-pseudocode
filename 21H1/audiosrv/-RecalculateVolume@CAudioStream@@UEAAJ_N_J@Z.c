    ...
    if ( v11 )
    {
      ...
      if ( v14 && !v13 && ((_BYTE)v53 != 0) != (v50 != 0) )
      {
        ...
        if ( v24 >= 0 )
        {
          if ( *((_QWORD *)this + 9) )
          {
            v26 = (const wchar_t *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                     (__int64)retaddr,
