/*
 * XREFs of ?LogExclusiveModeListenerUpdateSessionState@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@HH@Z @ 0x18010D63C
 * Callers:
        ...
        int a4)
{
  ...
  if ( (unsigned int)dword_18019D350 > 5 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_18016A99C,
      0LL,
      0LL,
      5u,
      &v6);
