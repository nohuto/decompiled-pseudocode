 ...
 *     WPP_SF_DDd @ 0x1800E1E44 (WPP_SF_DDd.c)
...
LABEL_134:
      ...
      JUMPOUT(0x1800860DBLL);
    }
LABEL_242:
    JUMPOUT(0x1800860E2LL);
  }
  if ( a4 > 1 )
  {
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
...
LABEL_70:
  ...
  *((_DWORD *)v12 + 46) = 1;
  ...
  pvar[0] = &g_csVadList;
  v56 = g_VADServerList;
  i = (__int64 *)qword_18019EA10;
  if ( !qword_18019EA10 )
  {
    if ( dword_18019EA18 )
    {
      if ( dword_18019EA18 == 10LL )
        v58 = 0x1999999999999999LL;
      else
        v58 = 0xFFFFFFFFFFFFFFFFuLL / (unsigned int)dword_18019EA18;
      if ( v58 < 0x18 )
        goto LABEL_217;
      v59 = 24LL * (unsigned int)dword_18019EA18;
    }
    else
    {
      v59 = 0LL;
    ...
    if ( (unsigned __int64)~v59 >= 8 )
    {
      ...
      {
        *v60 = qword_18019EA08;
        qword_18019EA08 = (__int64)v60;
        v61 = &v60[3 * (unsigned int)(dword_18019EA18 - 1) + 1];
        v62 = dword_18019EA18 - 1;
        for ( i = (__int64 *)qword_18019EA10; v62 >= 0; --v62 )
        {
          *v61 = (__int64)i;
          i = v61;
          qword_18019EA10 = (__int64)v61;
          v61 -= 3;
        }
        goto LABEL_91;
      }
