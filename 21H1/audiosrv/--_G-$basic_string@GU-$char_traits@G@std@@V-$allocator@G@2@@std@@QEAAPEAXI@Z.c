/*
 * XREFs of ??_G?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAPEAXI@Z @ 0x1800E44A8
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@std@@EEAAXXZ @ 0x1800E7830 (-_Destroy@-$_Ref_count_obj@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@@std@@E.c)
