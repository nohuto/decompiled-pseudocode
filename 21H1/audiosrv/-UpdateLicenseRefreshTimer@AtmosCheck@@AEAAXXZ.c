/*
 * XREFs of ?UpdateLicenseRefreshTimer@AtmosCheck@@AEAAXXZ @ 0x180008C6C
 * Callers:
 ...
 *     ?CancelLicenseRefreshTimer@AtmosCheck@@AEAAXXZ @ 0x180135894 (-CancelLicenseRefreshTimer@AtmosCheck@@AEAAXXZ.c)
 *     ?GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ @ 0x1801369E8 (-GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ.c)
 *     ?SetExpiryTimer@AtmosCheck@@AEAAX_K@Z @ 0x180137EA0 (-SetExpiryTimer@AtmosCheck@@AEAAX_K@Z.c)
 */
  ...
  if ( !ThreadpoolTimer )
  {
    ...
    if ( !ThreadpoolTimer )
    {
      ...
      if ( (unsigned int)dword_18019D520 > 5 )
      {
        ...
        tlgWriteTransfer_EventWriteTransfer((int)&dword_18019D520, (int)&dword_18016D6F1, 0, 0, 3u, &v9);
      }
      return;
    }
  }
