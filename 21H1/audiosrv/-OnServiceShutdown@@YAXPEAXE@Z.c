/*
 * XREFs of ?OnServiceShutdown@@YAXPEAXE@Z @ 0x180115D00
 * Callers:
 *     <none>
 * Callees:
 *     _tlgWriteTransfer_EtwEventWriteTransfer @ 0x1800529B8 (_tlgWriteTransfer_EtwEventWriteTransfer.c)
 *     ReportStatusToSCMgr @ 0x180062564 (ReportStatusToSCMgr.c)
...
void __fastcall OnServiceShutdown(void *a1)
{
  ...
  if ( (unsigned int)dword_18019D4E8 > 4 )
  {
    ...
    p_ThreadId = &ThreadId;
    v9 = 4;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_18019D4E8, byte_18016ACB6, 0LL, 0LL, 4, (__int64)v7);
  }
