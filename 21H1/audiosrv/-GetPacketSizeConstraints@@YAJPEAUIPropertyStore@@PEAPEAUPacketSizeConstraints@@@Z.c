/*
 * XREFs of ?GetPacketSizeConstraints@@YAJPEAUIPropertyStore@@PEAPEAUPacketSizeConstraints@@@Z @ 0x18011D524
 * Callers:
...
__int64 __fastcall GetPacketSizeConstraints(struct IPropertyStore *a1, LPVOID **a2)
{
  ...
  *(_OWORD *)v22 = 0LL;
  Src = 0LL;
  if ( dword_1801A0C30 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1801A0C30);
    if ( dword_1801A0C30 == -1 )
    {
      xmmword_1801A0AD0 = DEVPKEY_KsAudio_PacketSize_Constraints2;
      dword_1801A0AE0 = 2;
      xmmword_1801A0AE4 = DEVPKEY_KsAudio_PacketSize_Constraints;
      dword_1801A0AF4 = 2;
      Init_thread_footer(&dword_1801A0C30);
    }
  }
