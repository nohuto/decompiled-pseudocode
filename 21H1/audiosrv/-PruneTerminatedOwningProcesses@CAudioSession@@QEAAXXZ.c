/*
 * XREFs of ?PruneTerminatedOwningProcesses@CAudioSession@@QEAAXXZ @ 0x180033580
 * Callers:
...
void __fastcall CAudioSession::PruneTerminatedOwningProcesses(CAudioSession *this)
{
  ...
  *(_OWORD *)v17 = 0LL;
  ...
  {
    while ( v5 != v4
         && !(unsigned __int8)lambda_e5efcaf4a2a74ed9a8f77368205972bf_::operator()_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy___(
                                &v20,
                                v5) )
      ++v5;
    v6 = v5;
    if ( v5 != v4 )
    {
      while ( ++v5 != v4 )
      {
        if ( !(unsigned __int8)lambda_e5efcaf4a2a74ed9a8f77368205972bf_::operator()_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy___(
                                 &v21,
                                 v5) )
