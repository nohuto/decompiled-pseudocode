/*
 * XREFs of ?QueryInterface@EndpointDevice@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180056BC0
 * Callers:
 *     ?QueryInterface@EndpointDevice@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180075A90 (-QueryInterface@EndpointDevice@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
