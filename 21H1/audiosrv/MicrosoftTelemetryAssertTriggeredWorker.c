/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x18013DA68
 * Callers:
 ...
 *     EventUnregister_0 @ 0x18006C4F6 (EventUnregister_0.c)
 *     EventRegister_0 @ 0x18006C502 (EventRegister_0.c)
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U?$_tlgWrapSz@D@@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@333AEBU?$_tlgWrapSz@D@@3333@Z @ 0x18013D6F4 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U-$_tlgWrapSz@D@@U1@U1@U1@U1@@-$_tlgWriteTemplate@$$A.c)
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U?$_tlgWrapSz@D@@U1@U1@U2@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@333AEBU?$_tlgWrapSz@D@@3343333@Z @ 0x18013D808 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U-$_tlgWrapSz@D@@U1@U1@U2@U1@U1@U1@U1@@-$_tlgWriteTem.c)
 *     GetImageTuple @ 0x18013D98C (GetImageTuple.c)
 */
...
LABEL_5:
  ...
  if ( GetTickCount() - *((_DWORD *)v10 + 2) > 0xEA60 )
  {
    *((_DWORD *)v10 + 2) = GetTickCount();
    ...
    if ( *((_DWORD *)v10 + 4) == 1
      && !(unsigned int)TraceLoggingRegisterEx_EventRegister_EventSetInformation((ULONGLONG *)&dword_18019E1B0) )
    {
      if ( dword_18019E1B0 )
      {
        v20 = v45[0];
    ...
    if ( !(unsigned int)TraceLoggingRegisterEx_EventRegister_EventSetInformation((ULONGLONG *)&dword_18019E1E8) )
    {
      if ( v9 )
      {
        if ( (unsigned int)dword_18019E1E8 > 5 && tlgKeywordOn((__int64)&dword_18019E1E8, 0x400000000000LL) )
        {
      ...
      else if ( (unsigned int)dword_18019E1E8 > 5 && tlgKeywordOn((__int64)&dword_18019E1E8, 0x400000000000LL) )
      {
