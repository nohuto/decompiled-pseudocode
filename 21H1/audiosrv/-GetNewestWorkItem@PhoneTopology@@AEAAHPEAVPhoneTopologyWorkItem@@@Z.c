/*
 * XREFs of ?GetNewestWorkItem@PhoneTopology@@AEAAHPEAVPhoneTopologyWorkItem@@@Z @ 0x180140CBC
 * Callers:
 ...
 *     ??4PhoneTopologyWorkItem@@QEAAAEBV0@AEBV0@@Z @ 0x18013FA48 (--4PhoneTopologyWorkItem@@QEAAAEBV0@AEBV0@@Z.c)
 */
