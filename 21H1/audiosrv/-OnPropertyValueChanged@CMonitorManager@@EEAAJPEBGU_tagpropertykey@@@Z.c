/*
 * XREFs of ?OnPropertyValueChanged@CMonitorManager@@EEAAJPEBGU_tagpropertykey@@@Z @ 0x180035E50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_S_guid_D @ 0x180100A40 (WPP_SF_S_guid_D.c)
 */
    ...
    if ( a3->pid == *(_DWORD *)(v7 + 16) )
    {
      ...
      if ( !v9 )
      {
        ...
        if ( v11 )
        {
          ...
          JUMPOUT(0x180099626LL);
        }
        JUMPOUT(0x1800996C3LL);
      }
    }
  }
  return 0LL;
