/*
 * XREFs of ServiceStart @ 0x180062490
 * Callers:
 ...
 *     ??0CAudioSrv@@QEAA@XZ @ 0x1800628E0 (--0CAudioSrv@@QEAA@XZ.c)
...
__int64 __fastcall ServiceStart(struct SERVICE_STATUS_HANDLE__ *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_18019D4E8 > 4 )
  {
    ...
    v12 = v9;
    v15 = 4;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_18019D4E8, byte_18016ACF1, 0LL, 0LL, 3, (__int64)v13);
  }
  return v9;
}
