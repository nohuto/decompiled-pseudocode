/*
 * XREFs of ?_AppendValue@JsonWriter@@AEAAJPEBG@Z @ 0x18013D474
 * Callers:
 ...
 *     ?_EncodeJsonString@JsonWriter@@AEAAXPEBGPEADPEAK2@Z @ 0x18013D568 (-_EncodeJsonString@JsonWriter@@AEAAXPEBGPEADPEAK2@Z.c)
 */
