/*
 * XREFs of ?Initialize@TelephonyController@@IEAAJXZ @ 0x1801428D8
 * Callers:
 ...
 *     ?AddTail@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z @ 0x180141D60 (-AddTail@-$CAtlList@IV-$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z.c)
