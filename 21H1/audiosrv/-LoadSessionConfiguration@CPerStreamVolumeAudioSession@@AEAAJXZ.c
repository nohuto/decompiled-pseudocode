/*
 * XREFs of ?LoadSessionConfiguration@CPerStreamVolumeAudioSession@@AEAAJXZ @ 0x1800510D4
 * Callers:
 ...
 *     ?GetCount@?$CComSafeArray@M$03@ATL@@QEBAKI@Z @ 0x180051BC8 (-GetCount@-$CComSafeArray@M$03@ATL@@QEBAKI@Z.c)
...
__int64 __fastcall CPerStreamVolumeAudioSession::LoadSessionConfiguration(CPerStreamVolumeAudioSession *this)
{
  ...
  *(_OWORD *)v39 = 0LL;
  ...
  if ( !v11 && LOWORD(v39[0]) == 8196 )
  {
    ...
    {
      v29 = (_DWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                        (__int64)pvData,
                        _lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_)[1];
      if ( *v29 > 4u )
      {
