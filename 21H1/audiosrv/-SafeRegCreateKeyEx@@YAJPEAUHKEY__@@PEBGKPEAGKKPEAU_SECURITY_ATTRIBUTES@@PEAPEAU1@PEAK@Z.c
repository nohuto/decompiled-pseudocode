/*
 * XREFs of ?SafeRegCreateKeyEx@@YAJPEAUHKEY__@@PEBGKPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAPEAU1@PEAK@Z @ 0x180004C14
 * Callers:
 ...
 * Callees:
 *     ?SafeRegCreateKeyEx@@YAJPEAUHKEY__@@PEBGKPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAPEAU1@PEAK@Z @ 0x180004C14 (-SafeRegCreateKeyEx@@YAJPEAUHKEY__@@PEBGKPEAGKKPEAU_SECURITY_ATTRIBUTES@@PEAPEAU1@PEAK@Z.c)
 *     ?DetectRegistryLink@@YA?AW4LinkResult@@PEAUHKEY__@@PEBGKPEAPEAU2@@Z @ 0x180004E1C (-DetectRegistryLink@@YA-AW4LinkResult@@PEAUHKEY__@@PEBGKPEAPEAU2@@Z.c)
 ...
 *     ?Init@CNtDeleteKey@@QEAA_NXZ @ 0x1800D8088 (-Init@CNtDeleteKey@@QEAA_NXZ.c)
 */
...
LABEL_6:
  ...
  if ( dword_18019FBE8 > *((_DWORD *)v14 + 1) )
  {
    Init_thread_header(&dword_18019FBE8);
    if ( dword_18019FBE8 == -1 )
    {
      atexit(SafeRegCreateKeyEx_::_2_::_dynamic_atexit_destructor_for__delKey__);
      Init_thread_footer(&dword_18019FBE8);
    }
  }
  v15 = v13 - 1;
  if ( v15 )
...
LABEL_21:
  ...
  else if ( CNtDeleteKey::Init(v14) && !(qword_18019FBF8 ? qword_18019FBF8(hKey) : 87) )
  {
    RegCloseKey(hKey);
    hKey = 0LL;
    dwDisposition = 0;
