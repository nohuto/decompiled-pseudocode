/*
 * XREFs of ?LoadEndpointVolumeInformation@CPerEndpointVolumeAudioSession@@AEAAJPEBGPEAUIVolumeStrip@@@Z @ 0x1800C95BC
 * Callers:
            ...
            do
            {
              ...
              *(float *)(v32 + 4 * v31) = v33;
                ...
                && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
              {
                ...
                v35[4] = v33;
                WPP_SF_dg(v34, 0x26u, (__int64)&WPP_8a9aba7feb7a3955c09918de3b09cfe4_Traceguids, v31);
              }
