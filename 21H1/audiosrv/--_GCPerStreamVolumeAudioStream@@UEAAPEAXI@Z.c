/*
 * XREFs of ??_GCPerStreamVolumeAudioStream@@UEAAPEAXI@Z @ 0x18004F340
 * Callers:
 *     ??_ECPerStreamVolumeAudioStream@@WCA@EAAPEAXI@Z @ 0x180074E30 (--_ECPerStreamVolumeAudioStream@@WCA@EAAPEAXI@Z.c)
 * Callees:
