/*
 * XREFs of ?InternalEnforceEndpointExclusivity@CConstraintModelResourceManager@@AEAAJPEBG0KKW4AUDIO_DIRECTION@@H@Z @ 0x1800F403C
 * Callers:
 ...
 *     ?EnforceEndpointExclusivity@CConstraintModelResourceManager@@UEAAJPEBG0KKW4AUDIO_DIRECTION@@@Z @ 0x1800F3C30 (-EnforceEndpointExclusivity@CConstraintModelResourceManager@@UEAAJPEBG0KKW4AUDIO_DIRECTION@@@Z.c)
 ...
 *     WPP_SF_SSddSS @ 0x1800F614C (WPP_SF_SSddSS.c)
 */
