/*
 * XREFs of ??1?$out_param_t@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@@details@wil@@QEAA@XZ @ 0x1800EAFFC
 * Callers:
 *     _BuildDeviceGraphForStream_::_1_::dtor$7 @ 0x180077590 (_BuildDeviceGraphForStream_--_1_--dtor$7.c)
 * Callees:
