/*
 * XREFs of ?MyServiceInitialization@@YAKPEAUSERVICE_STATUS_HANDLE__@@KPEAPEBG@Z @ 0x1800625D0
 * Callers:
 *     ServiceStart @ 0x180062490 (ServiceStart.c)
 * Callees:
 *     ?InitializeAudioThreadpool@@YAJXZ @ 0x180062798 (-InitializeAudioThreadpool@@YAJXZ.c)
 *     McGenEventRegister_EtwEventRegister @ 0x1800628A0 (McGenEventRegister_EtwEventRegister.c)
