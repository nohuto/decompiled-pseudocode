/*
 * XREFs of ?Initialize@CConstraintModelResourceManager@@AEAAJPEAUIAudioResourceControl@@@Z @ 0x180066C18
 * Callers:
 ...
 *     ?SetupKeywordDetectorPriority@CConstraintModelResourceManager@@AEAAJXZ @ 0x180066D64 (-SetupKeywordDetectorPriority@CConstraintModelResourceManager@@AEAAJXZ.c)
