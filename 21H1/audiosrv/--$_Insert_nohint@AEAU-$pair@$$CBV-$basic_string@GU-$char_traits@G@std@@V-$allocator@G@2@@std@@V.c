...
__int64 __fastcall std::_Tree<std::_Tmap_traits<std::wstring,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>>,0>>::_Insert_nohint<std::pair<std::wstring const,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>> &,std::_Tree_node<std::pair<std::wstring const,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>,void *> *>(
        __int64 *a1,
        __int64 a2,
        __int64 a3,
        char *a4,
...
LABEL_13:
  ...
  if ( (_BYTE)a3 )
  {
    ...
    {
      LOBYTE(a3) = 1;
      *(_QWORD *)a2 = *std::_Tree<std::_Tmap_traits<std::wstring,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>>,0>>::_Insert_at<std::pair<std::wstring const,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>> &,std::_Tree_node<std::pair<std::wstring const,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>,void *> *>(
                         a1,
                         &v36,
                         a3,
                         (_QWORD *)v9,
...
LABEL_52:
  v33 = a5;
  Microsoft::WRL::ComPtr<ISpatialAudioPositionCalc>::InternalRelease((__int64 *)(a5 + 64));
  v34 = *(_QWORD *)(v33 + 56);
  if ( v34 >= 8 )
    std::_Deallocate<16,0>(*(void **)(v33 + 32), (const struct std::nothrow_t *)(2 * v34 + 2));
  *(_QWORD *)(v33 + 48) = 0LL;
  *(_QWORD *)(v33 + 56) = 7LL;
  *(_WORD *)(v33 + 32) = 0;
