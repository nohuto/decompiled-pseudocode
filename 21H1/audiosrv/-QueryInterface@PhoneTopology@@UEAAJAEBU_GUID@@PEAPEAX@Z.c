/*
 * XREFs of ?QueryInterface@PhoneTopology@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180141120
 * Callers:
 *     ?QueryInterface@PhoneTopology@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180075AB0 (-QueryInterface@PhoneTopology@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
