/*
 * XREFs of ?IsSpatialAudioEnabledBeforePolicy@SpatialAudioDevicePropertyReader@@UEAAJPEAH@Z @ 0x1801298A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SpatialAudioDevicePropertyReader::IsSpatialAudioEnabledBeforePolicy(
  ...
  if ( *((_DWORD *)this + 128) )
  {
    ...
    else
    {
      if ( (unsigned int)dword_18019D4B0 > 2 )
      {
        ...
        v11 = (__int64)"SpatialAudioDevicePropertyReader::IsSpatialAudioEnabledBeforePolicy";
        LODWORD(v10) = 765;
