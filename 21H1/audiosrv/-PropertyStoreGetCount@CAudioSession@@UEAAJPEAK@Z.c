/*
 * XREFs of ?PropertyStoreGetCount@CAudioSession@@UEAAJPEAK@Z @ 0x1800CAB10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::PropertyStoreGetCount(CAudioSession *this, unsigned int *a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x5Cu, (__int64)&WPP_8a9aba7feb7a3955c09918de3b09cfe4_Traceguids, 0LL);
  }
