/*
 * XREFs of ??_GDefaultChangedContext@@QEAAPEAXI@Z @ 0x1800FAB3C
 * Callers:
 *     ??1?$CAutoPtr@UDefaultChangedContext@@@ATL@@QEAA@XZ @ 0x1800FA624 (--1-$CAutoPtr@UDefaultChangedContext@@@ATL@@QEAA@XZ.c)
