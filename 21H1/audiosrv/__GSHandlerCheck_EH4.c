/*
 * XREFs of __GSHandlerCheck_EH4 @ 0x180074A20
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler4_0 @ 0x18006B45E (__CxxFrameHandler4_0.c)
 *     __GSHandlerCheckCommon @ 0x180074934 (__GSHandlerCheckCommon.c)
 */
