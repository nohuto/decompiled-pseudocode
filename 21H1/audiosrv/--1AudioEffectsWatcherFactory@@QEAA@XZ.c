/*
 * XREFs of ??1AudioEffectsWatcherFactory@@QEAA@XZ @ 0x180069DCC
 * Callers:
 *     _dynamic_atexit_destructor_for__TheAudioEffectsWatcherFactory__ @ 0x18007D6D0 (_dynamic_atexit_destructor_for__TheAudioEffectsWatcherFactory__.c)
 * Callees:
