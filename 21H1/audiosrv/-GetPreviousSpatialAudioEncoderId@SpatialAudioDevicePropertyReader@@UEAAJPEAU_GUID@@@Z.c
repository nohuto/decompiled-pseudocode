/*
 * XREFs of ?GetPreviousSpatialAudioEncoderId@SpatialAudioDevicePropertyReader@@UEAAJPEAU_GUID@@@Z @ 0x180128DB0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *((_DWORD *)this + 128) )
  {
    ...
    else
    {
      if ( (unsigned int)dword_18019D4B0 > 2 )
      {
        ...
        v11 = (__int64)"SpatialAudioDevicePropertyReader::GetPreviousSpatialAudioEncoderId";
        LODWORD(v10) = 823;
