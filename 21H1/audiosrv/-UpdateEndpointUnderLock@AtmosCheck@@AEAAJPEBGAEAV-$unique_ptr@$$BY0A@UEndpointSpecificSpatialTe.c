/*
 * XREFs of ?UpdateEndpointUnderLock@AtmosCheck@@AEAAJPEBGAEAV?$unique_ptr@$$BY0A@UEndpointSpecificSpatialTechInfo@AtmosCheck@@U?$default_delete@$$BY0A@UEndpointSpecificSpatialTechInfo@AtmosCheck@@@wistd@@@wistd@@@Z @ 0x1801383A0
 * Callers:
...
__int64 __fastcall AtmosCheck::UpdateEndpointUnderLock(__int64 a1, _WORD *a2, _QWORD *a3)
{
  ...
  v9 = v6;
  std::wstring::wstring((__int64)v10, a2);
