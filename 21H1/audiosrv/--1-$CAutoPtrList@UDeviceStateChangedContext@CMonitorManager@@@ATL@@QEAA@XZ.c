/*
 * XREFs of ??1?$CAutoPtrList@UDeviceStateChangedContext@CMonitorManager@@@ATL@@QEAA@XZ @ 0x1800FA69C
 * Callers:
 *     _CMonitorManager::CMonitorManager_::_1_::dtor$5 @ 0x18007CEF5 (_CMonitorManager--CMonitorManager_--_1_--dtor$5.c)
 * Callees:
 *     <none>
 */
