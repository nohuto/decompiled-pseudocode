/*
 * XREFs of ?_Decwref@_Ref_count_base@std@@QEAAXXZ @ 0x180069B20
 * Callers:
 ...
 *     ??$?4VCStreamConnectionManager@@@?$weak_ptr@VCStreamConnectionManager@@@std@@QEAAAEAV01@AEBV?$shared_ptr@VCStreamConnectionManager@@@1@@Z @ 0x180065F14 (--$-4VCStreamConnectionManager@@@-$weak_ptr@VCStreamConnectionManager@@@std@@QEAAAEAV01@AEBV-$sh.c)
 *     _dynamic_atexit_destructor_for__g_weakStreamMonitorManager__ @ 0x18007D690 (_dynamic_atexit_destructor_for__g_weakStreamMonitorManager__.c)
 *     _dynamic_atexit_destructor_for__CStreamConnectionManagerImpl::s_weakSelf__ @ 0x18007D7B0 (_dynamic_atexit_destructor_for__CStreamConnectionManagerImpl--s_weakSelf__.c)
 * Callees:
