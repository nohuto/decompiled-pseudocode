/*
 * XREFs of ?ReadStreamInfo@AudioJournal@@AEAAJPEAUStreamInfo@1@@Z @ 0x18005396C
 * Callers:
...
__int64 __fastcall AudioJournal::ReadStreamInfo(AudioJournal *this, struct AudioJournal::StreamInfo *pvData)
{
  ...
  v2 = 0;
  Size = 0;
  if ( pvData == (struct AudioJournal::StreamInfo *)&unk_1801A00A8 )
  {
    v3 = L"Render";
    v4 = 600;
  }
  else if ( pvData == (struct AudioJournal::StreamInfo *)&unk_1801A0300 )
  {
    v3 = L"Capture";
    v4 = 400;
  }
  ...
  {
    if ( pvData != (struct AudioJournal::StreamInfo *)&unk_1801A0490 )
    {
      v6 = -2147024809;
      v14 = 409LL;
      goto LABEL_25;
  ...
  Size = v4;
  pcbData = v4;
  ValueW = RegGetValueW(HKEY_LOCAL_MACHINE, &word_1801A0558, v3, 8u, 0LL, pvData, &pcbData);
  v6 = ValueW;
