/*
 * XREFs of ??$RegisterWinRTObject@$01@Details@WRL@Microsoft@@YAJPEBGPEAPEBGPEAPEAU_unnamed_type_RO_REGISTRATION_COOKIE_@@I@Z @ 0x1800B7FAC
 * Callers:
 *     ?RegisterWinRTObject@?$Module@$01VServiceModule@Internal@Windows@@@WRL@Microsoft@@UEAAJPEBGPEAPEBGPEAPEAU_unnamed_type_RO_REGISTRATION_COOKIE_@@I@Z @ 0x1800BAC90 (-RegisterWinRTObject@-$Module@$01VServiceModule@Internal@Windows@@@WRL@Microsoft@@UEAAJPEBGPEAPE.c)
 * Callees:
