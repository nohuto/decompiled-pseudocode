/*
 * XREFs of ?Invoke@CAudioSessionManagerNotification@@UEAAJVCAudioSessionNotificationProcess@@@Z @ 0x1800D0030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSessionManagerNotification::Invoke(__int64 a1, CAudioSessionNotificationProcess *a2)
{
  ...
  if ( !MediaEvent )
  {
    ...
    v10 = (*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)a2 + 40LL))(*(_QWORD *)a2);
    v11 = 38;
    goto LABEL_16;
  }
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    v11 = 37;
LABEL_16:
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), v11, (__int64)&WPP_fe6ee92afb383bb0444ef271973e06e1_Traceguids, v10);
  }
  if ( MediaEvent < 0 )
