/*
 * XREFs of _lambda_4ee4a630d91b577e4d31f4c6e0d18ad2_::operator() @ 0x18006D9C0
 * Callers:
 ...
 *     ?GetCurrentSessionGain@CAudioSession@@IEAAXPEA_NPEAMPEA_J@Z @ 0x180046960 (-GetCurrentSessionGain@CAudioSession@@IEAAXPEA_NPEAMPEA_J@Z.c)
 ...
 *     WPP_SF_S_guid_ @ 0x1800CBC30 (WPP_SF_S_guid_.c)
 *     WPP_SF_Sg @ 0x1800CBD50 (WPP_SF_Sg.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall lambda_4ee4a630d91b577e4d31f4c6e0d18ad2_::operator()(CAudioSession **a1, __int64 a2, int a3)
{
  GUID **v4; // rax
  GUID *v5; // rdx
