/*
 * XREFs of ?HangIsProbablyReal@?$CWatchdogTimer@$00@@AEAA_NXZ @ 0x1800BC8D0
 * Callers:
...
char __fastcall CWatchdogTimer<1>::HangIsProbablyReal(__int64 a1)
{
  ...
  if ( IsDebuggerPresent() )
  {
    ...
    if ( *v2 <= 5u || !tlgKeywordOn((__int64)v2, 1LL) )
      return 0;
    v4 = &v11;
    v5 = (unsigned __int8 *)&unk_1801671CF;
    goto LABEL_15;
  }
  if ( (unsigned __int8)CWatchdogTimer<1>::IsVirtualMachine() )
  {
    ...
    if ( v10 != 6 )
    {
      if ( *v6 <= 5u || !tlgKeywordOn((__int64)v6, 1LL) )
        return 0;
      v4 = &v13;
      v5 = (unsigned __int8 *)&unk_180167180;
LABEL_15:
      tlgWriteTransfer_EtwEventWriteTransfer(v3, v5, 0LL, 0LL, 2, (__int64)v4);
      return 0;
    }
    if ( *v6 > 5u && tlgKeywordOn((__int64)v6, 1LL) )
      tlgWriteTransfer_EtwEventWriteTransfer(v7, byte_1801671A4, 0LL, 0LL, 2, (__int64)v12);
  }
  v9[0] = 0;
