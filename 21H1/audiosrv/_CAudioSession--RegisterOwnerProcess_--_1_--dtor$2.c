/*
 * XREFs of _CAudioSession::RegisterOwnerProcess_::_1_::dtor$2 @ 0x1800CAF61
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSession::RegisterOwnerProcess_::_1_::dtor_2(__int64 a1, __int64 a2)
{
