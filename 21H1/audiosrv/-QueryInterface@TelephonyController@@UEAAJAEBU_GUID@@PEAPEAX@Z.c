/*
 * XREFs of ?QueryInterface@TelephonyController@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180143630
 * Callers:
 *     ?QueryInterface@TelephonyController@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180075AD0 (-QueryInterface@TelephonyController@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
