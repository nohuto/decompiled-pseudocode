/*
 * XREFs of ?Initialize@CConstraintModel@@QEAAJXZ @ 0x180066E30
 * Callers:
 ...
 *     ??0?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@QEAA@IMMMI@Z @ 0x18005666C (--0-$CAtlMap@PEAVResourceConsumer@@PEAV-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VRe.c)
 ...
 *     ?CopyResourceLimits@CConstraintModel@@AEAAJPEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@0@Z @ 0x18013A21C (-CopyResourceLimits@CConstraintModel@@AEAAJPEAV-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@.c)
...
__int64 __fastcall CConstraintModel::Initialize(CConstraintModel *this)
{
  ...
  int v46[4]; // [rsp+88h] [rbp-7D0h] BYREF
  ...
  __int64 v53[10]; // [rsp+F0h] [rbp-768h] BYREF
...
LABEL_7:
      ...
      for ( i = 0; ; ++i )
      {
        ...
        std::wstring::wstring((__int64)&v56, ValueName);
        ...
        if ( *((_QWORD *)&v57 + 1) >= 8uLL )
          std::_Deallocate<16,0>((void *)v56, (const struct std::nothrow_t *)(2LL * *((_QWORD *)&v57 + 1) + 2));
        if ( v18 )
        {
          std::wstring::wstring((__int64)&v56, ValueName);
          std::map<std::wstring,std::wstring>::_Try_emplace<std::wstring,>(&v39, &v42, &v56);
          v19 = -1LL;
          do
            ++v19;
          while ( Data[v19] );
          std::wstring::assign((void **)(v42 + 64), Data, v19);
          if ( *((_QWORD *)&v57 + 1) >= 8uLL )
            std::_Deallocate<16,0>((void *)v56, (const struct std::nothrow_t *)(2LL * *((_QWORD *)&v57 + 1) + 2));
        }
      }
  ...
  while ( v9 >= 0 && v11 != v10 )
  {
    ...
    *(_OWORD *)v46 = 0LL;
                ...
                (__int64)&v42) < 0 )
    {
      v58 = *(_OWORD *)v21;
      v59 = *((_OWORD *)v11 + 5);
      LogError(L"Parsing XML %s failed", &v58);
LABEL_36:
      LogOutput(L"Cleaning resource consumption information due to unrecoverable error");
      CConstraintModel::CleanResourceConsumptionMap(v24, v53);
      CConstraintModel::CleanResourceExclusiveEndpoint(v25, &v42);
      goto LABEL_37;
    }
    if ( (int)CConstraintModel::VerifyNoRepeatedResourcesOrConsumers(
                ...
                (__int64)v53) < 0 )
      goto LABEL_36;
    v29 = v55 + *((_QWORD *)this + 2);
    if ( v29 > 0xF )
      LogError(L"Number of resource types is %d which is larger than max %d", v29, 15LL);
    v9 = CConstraintModel::CopyResourceIDMap(v28, v54, (char *)this + 8);
    if ( v9 < 0 )
      goto LABEL_36;
    v9 = CConstraintModel::CopyResourceLimits(v30, v46, (char *)this + 80);
    if ( v9 < 0 )
      goto LABEL_36;
    v9 = CConstraintModel::CopyResourceConsumptionMap(v31, v53, (char *)this + 128);
    if ( v9 < 0 )
      goto LABEL_36;
    v32 = *((_QWORD *)this + 26);
    v33 = v43;
    ...
    v34 = (_QWORD *)(*((_QWORD *)this + 25) + 8 * v32);
    if ( v33 )
    {
      v35 = v42 - (_QWORD)v34;
      do
    ...
    v9 = 0;
LABEL_37:
    ATL::CAtlArray<CMasterVolumeNotificationProcess,ATL::CElementTraits<CMasterVolumeNotificationProcess>>::~CAtlArray<CMasterVolumeNotificationProcess,ATL::CElementTraits<CMasterVolumeNotificationProcess>>(&v42);
    ATL::CAtlMap<ResourceConsumer *,ATL::CAtlList<_ResourceInfo,ResourceInfoTraits> *,ResourceConsumerTraits,ATL::CElementTraits<ATL::CAtlList<_ResourceInfo,ResourceInfoTraits> *>>::RemoveAll(v53);
    ATL::CAtlList<_ResourceInfo,ResourceInfoTraits>::RemoveAll(v46);
    ATL::CAtlMap<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,enum RmResourceType,ATL::CElementTraits<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>>,ATL::CElementTraits<enum RmResourceType>>::RemoveAll(v54);
    v26 = (__int64 **)v11[2];
    if ( *((_BYTE *)v26 + 25) )
    {
  ...
  std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *>>>(
    ...
    &v39,
    v10[1]);
  std::_Deallocate<16,0>((void *)v39, (const struct std::nothrow_t *)0x60);
