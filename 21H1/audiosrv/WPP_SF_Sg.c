/*
 * XREFs of WPP_SF_Sg @ 0x1800CBD50
 * Callers:
 ...
 *     ?GetVolume@CAudioSession@@UEAAJPEAM@Z @ 0x180047250 (-GetVolume@CAudioSession@@UEAAJPEAM@Z.c)
...
__int64 __fastcall WPP_SF_Sg(__int64 a1, unsigned __int16 a2, __int64 a3, const wchar_t *a4)
{
  ...
  if ( !a4 )
    a4 = L"NULL";
  return EtwTraceMessage(a1, 43LL, &WPP_8a9aba7feb7a3955c09918de3b09cfe4_Traceguids, a2, a4);
}
