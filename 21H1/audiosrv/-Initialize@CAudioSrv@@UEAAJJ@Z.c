/*
 * XREFs of ?Initialize@CAudioSrv@@UEAAJJ@Z @ 0x180063120
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CAudioDGProcess@@QEAA@PEAUIMonitorDGTermination@@@Z @ 0x18006309C (--0CAudioDGProcess@@QEAA@PEAUIMonitorDGTermination@@@Z.c)
 ...
 *     McTemplateU0zq_EtwEventWriteTransfer @ 0x1800BBE9C (McTemplateU0zq_EtwEventWriteTransfer.c)
  ...
  if ( !a2 )
  {
    ...
    *((_QWORD *)this + 11) = v5;
    if ( !v5 )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids);
      }
      a2 = -2147024882;
    }
  }
    ...
    if ( v6 )
    {
      ...
      if ( v9 )
      {
        ...
        operator delete(v9, (const struct std::nothrow_t *)0x198);
           ...
           && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 15LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids);
    }
  }
  ppv = 0LL;
  ...
  if ( !v11 )
  {
    ...
    if ( !v11 )
    {
      ...
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 17LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids);
      }
             ...
             0LL) )
      {
        if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids);
        }
      ...
      if ( v15 < 0 )
        AudSrvTraceLoggingErrorHelper("CAudioSrv::Initialize", 595, v15);
