/*
 * XREFs of ??1?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x1800B52B4
 * Callers:
 ...
 *     ?Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ @ 0x1800B546C (-Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ.c)
 */
