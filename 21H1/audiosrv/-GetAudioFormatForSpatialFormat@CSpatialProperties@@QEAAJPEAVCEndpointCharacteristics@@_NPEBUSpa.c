/*
 * XREFs of ?GetAudioFormatForSpatialFormat@CSpatialProperties@@QEAAJPEAVCEndpointCharacteristics@@_NPEBUSpatialAudioSettings@@PEBUtWAVEFORMATEX@@3PEAUIPropertyStore@@PEAUSpatialAudioRelatedGlobalSettings@@V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@PEAUWAVEFORMATEXTENSIBLE@@PEA_N@Z @ 0x180126900
 * Callers:
 ...
 *     ?CopyToWaveFormatExtensible@@YAHPEAUWAVEFORMATEXTENSIBLE@@PEBUtWAVEFORMATEX@@@Z @ 0x1800E4DD8 (-CopyToWaveFormatExtensible@@YAHPEAUWAVEFORMATEXTENSIBLE@@PEBUtWAVEFORMATEX@@@Z.c)
        ...
        if ( v17 )
        {
          ...
          if ( v23 )
          {
            if ( (unsigned int)dword_18019D478 <= 2 || !tlgKeywordOn((__int64)&dword_18019D478, 16LL) )
              goto LABEL_32;
            v26 = (unsigned __int8 *)&unk_18016BD14;
LABEL_31:
            pvar[0] = (PROPVARIANT)a2[3];
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwEventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<unsigned short>>(
...
LABEL_48:
      ...
      else
      {
        ...
        {
          if ( (unsigned int)v19 > 4 && tlgKeywordOn((__int64)&dword_18019D478, 16LL) )
            tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_18019D478, byte_18016BC2B, 0LL, 0LL, 2, (__int64)v97);
          goto LABEL_32;
        }
            ...
            if ( AsUInt32With >= 0 )
            {
              ...
              if ( *(_DWORD *)&v103[v44 + 784] )
              {
                if ( *a8 )
                {
                  if ( (unsigned int)dword_18019D478 <= 2 || !tlgKeywordOn((__int64)&dword_18019D478, 16LL) )
                    goto LABEL_32;
                  v26 = (unsigned __int8 *)&unk_18016BAB2;
                  goto LABEL_31;
                }
                if ( *(_DWORD *)(a4 + 68) == 1 && (v14 & 4) != 0 )
                {
                  if ( (unsigned int)dword_18019D478 <= 2 || !tlgKeywordOn((__int64)&dword_18019D478, 16LL) )
                    goto LABEL_32;
                  v26 = (unsigned __int8 *)&unk_18016BA6D;
                  goto LABEL_31;
                }
                if ( (v14 & 3) != 0 )
                {
