/*
 * XREFs of ?DoSetCellularRouting@PhoneTopology@@AEAAJAEBU_tagKSTOPOLOGY_ENDPOINTIDPAIR@@@Z @ 0x18013FECC
 * Callers:
 *     ?Process@SetCellularRoutingWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x180141100 (-Process@SetCellularRoutingWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
