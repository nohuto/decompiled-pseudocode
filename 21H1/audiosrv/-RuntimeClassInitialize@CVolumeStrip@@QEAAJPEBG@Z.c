/*
 * XREFs of ?RuntimeClassInitialize@CVolumeStrip@@QEAAJPEBG@Z @ 0x180060E5C
 * Callers:
 ...
 *     ??0CVolumeHardware@@QEAA@PEAUIVolumeStrip@@@Z @ 0x180061538 (--0CVolumeHardware@@QEAA@PEAUIVolumeStrip@@@Z.c)
 ...
 *     ??0CVolumeSoftware@@QEAA@PEAUIVolumeStrip@@@Z @ 0x1800C330C (--0CVolumeSoftware@@QEAA@PEAUIVolumeStrip@@@Z.c)
 */
...
__int64 __fastcall CVolumeStrip::RuntimeClassInitialize(void **this, const unsigned __int16 *a2)
{
  ...
  int v46; // eax
  int v47[2]; // [rsp+40h] [rbp-49h] BYREF
  ...
  KSDATAFORMAT v53; // [rsp+70h] [rbp-19h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+E8h] [rbp+5Fh]
  struct IPartsList *v55; // [rsp+F0h] [rbp+67h] BYREF
  struct IMMDevice *v56; // [rsp+100h] [rbp+77h] BYREF
  ...
  *v4 = 0LL;
  ...
  if ( is_mul_ok(v6, 2uLL) )
  {
    ...
    *v4 = v7;
    ...
    v8 = 0;
    StringCchCopyNExW(v7, v5 + 1, a2, v5);
  }
  else
  {
    v8 = -2147024362;
...
LABEL_120:
  ...
  v56 = 0LL;
  v9 = (*(__int64 (__fastcall **)(_QWORD, char *, struct IMMDevice **))(**(_QWORD **)&g_DeviceEnumerator + 40LL))(
  ...
  v49 = 0LL;
  v10 = ((__int64 (__fastcall *)(struct IMMDevice *, GUID *, __int64 *))v56->lpVtbl->QueryInterface)(
          v56,
...
LABEL_71:
  ...
  v55 = 0LL;
  *(_QWORD *)v47 = 0LL;
  if ( ((int (__fastcall *)(struct IMMDevice *, GUID *, __int64))v56->lpVtbl->Activate)(
         v56,
         ...
         23LL) >= 0 )
  {
    ...
    v51 = 0LL;
    v52 = 1;
    v8 = (*(__int64 (__fastcall **)(CPolicyConfig *, char *, _QWORD, void **))(*(_QWORD *)g_PolicyConfig + 32LL))(
           g_PolicyConfig,
           *v4,
           0LL,
           &v51);
    ...
    InitKsDataFormat(&v53, (struct tWAVEFORMATEX *)pv);
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x10000) != 0
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_42b4fa7daad03b80922a8ee15d46dabb_Traceguids, this);
    }
    v12 = v55;
    v55 = 0LL;
    if ( v12 )
...
LABEL_117:
    ...
    *(_QWORD *)v47 = &pv;
    v48 = 1;
    v17 = 1;
    v18 = CVolumeHardware::Initialize(v16, (struct IUnknown *)v56, v55);
    v19 = pv;
    if ( v18 >= 0 )
    {
      this[31] = pv;
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_42b4fa7daad03b80922a8ee15d46dabb_Traceguids, a2);
  }
  ...
  *(_QWORD *)v47 = &pv;
  v48 = 1;
  v43 = (*(__int64 (__fastcall **)(CVolumeSoftware *, struct IMMDevice *))(*(_QWORD *)v42 + 48LL))(v42, v56);
  v8 = v43;
  if ( v43 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
...
LABEL_34:
  ...
  *(_QWORD *)v47 = &pv;
  v48 = 1;
  v22 = 1;
  v23 = CMuteHardware::Initialize(v21, (struct IUnknown *)v56, v55);
  v24 = pv;
  if ( v23 >= 0 )
  {
    this[32] = pv;
...
LABEL_42:
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_42b4fa7daad03b80922a8ee15d46dabb_Traceguids, a2);
  }
  ...
  *(_QWORD *)v47 = v44;
  if ( v44 )
  {
    ...
    *((_QWORD *)v45 + 6) = 0LL;
    InitializeCriticalSectionEx((LPCRITICAL_SECTION)((char *)v45 + 56), 0, 0);
    *((_QWORD *)v45 + 12) = 0LL;
    *((_BYTE *)v45 + 104) = 0;
  }
  else
  ...
  *(_QWORD *)v47 = &pv;
  v48 = 1;
  v46 = (*(__int64 (__fastcall **)(CMuteControlBase *, struct IMMDevice *))(*(_QWORD *)v45 + 48LL))(v45, v56);
  v8 = v46;
  if ( v46 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
...
LABEL_43:
  ...
  *(_QWORD *)v47 = &pv;
  v48 = 1;
  v27 = 1;
  v28 = CMeterHardware::Initialize(v26, (struct IUnknown *)v56, v55);
  v29 = pv;
  if ( v28 >= 0 )
  {
    this[33] = pv;
...
LABEL_51:
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 15LL, &WPP_42b4fa7daad03b80922a8ee15d46dabb_Traceguids, a2);
  }
