 ...
 * Callers:
 *     _CAudioSessionManager::OnStateChanged_::_1_::dtor$6 @ 0x180075DD0 (_CAudioSessionManager--OnStateChanged_--_1_--dtor$6.c)
 *     _ATL::CAtlMap_CAudioSessionInstanceId_CAudioSession___CAudioSessionInstanceIdTraits_ATL::CElementTraits_CAudioSession_____::NewNode_::_1_::dtor$3 @ 0x18007AC30 (_ATL--CAtlMap_CAudioSessionInstanceId_CAudioSession___CAudioSessionInstanceIdTraits_ea_18007AC30.c)
 * Callees:
