/*
 * XREFs of ?RemoveAll@?$CAtlList@PEAVCVADServer@@V?$CElementTraits@PEAVCVADServer@@@ATL@@@ATL@@QEAAXXZ @ 0x180035CE8
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__g_VADServerList__ @ 0x18007D760 (_dynamic_atexit_destructor_for__g_VADServerList__.c)
 *     ??1CAudioSrv@@UEAA@XZ @ 0x1800B867C (--1CAudioSrv@@UEAA@XZ.c)
 *     ?FreeNode@?$CAtlList@PEAVCOnDeviceWorkItem@@V?$CElementTraits@PEAVCOnDeviceWorkItem@@@ATL@@@ATL@@AEAAXPEAVCNode@12@@Z @ 0x1800B95D8 (-FreeNode@-$CAtlList@PEAVCOnDeviceWorkItem@@V-$CElementTraits@PEAVCOnDeviceWorkItem@@@ATL@@@ATL@.c)
