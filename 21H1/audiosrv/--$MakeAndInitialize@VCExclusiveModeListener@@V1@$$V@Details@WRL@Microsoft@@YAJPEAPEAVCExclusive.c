/*
 * XREFs of ??$MakeAndInitialize@VCExclusiveModeListener@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCExclusiveModeListener@@@Z @ 0x180105CB8
 * Callers:
 ...
 *     ??0CExclusiveModeListener@@QEAA@XZ @ 0x180106224 (--0CExclusiveModeListener@@QEAA@XZ.c)
