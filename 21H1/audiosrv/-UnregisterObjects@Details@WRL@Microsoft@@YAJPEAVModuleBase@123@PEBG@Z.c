/*
 * XREFs of ?UnregisterObjects@Details@WRL@Microsoft@@YAJPEAVModuleBase@123@PEBG@Z @ 0x1800BB6DC
 * Callers:
 *     ?DisconnectCallback@ServiceModule@Internal@Windows@@UEAAJXZ @ 0x1800B9540 (-DisconnectCallback@ServiceModule@Internal@Windows@@UEAAJXZ.c)
 * Callees:
