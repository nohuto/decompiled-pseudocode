/*
 * XREFs of ?SetRegistryHandleIntegrityLevel@@YAJPEAUHKEY__@@PEAX@Z @ 0x1800D939C
 * Callers:
...
__int64 __fastcall SetRegistryHandleIntegrityLevel(HKEY Handle, void *a2)
{
  ...
  pSacl = 0LL;
  v8 = 0;
  v4 = AddSidToSACL(Handle, a2, &pSacl, &v8);
  v3 = v4;
  if ( v4 > 0 )
  ...
  if ( v3 < 0 )
LABEL_14:
    AudSrvTraceLoggingErrorHelper("SetRegistryHandleIntegrityLevel", 472, v3);
