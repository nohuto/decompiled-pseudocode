/*
 * XREFs of ?QueryInterface@TelephonyControllerCallInstance@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180144300
 * Callers:
 *     ?QueryInterface@TelephonyControllerCallInstance@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180075AF0 (-QueryInterface@TelephonyControllerCallInstance@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
