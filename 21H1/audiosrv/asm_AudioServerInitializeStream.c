/*
 * XREFs of asm_AudioServerInitializeStream @ 0x1800F2510
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0TraceLoggingThreadActivityIdSetter@@QEAA@AEBU_GUID@@@Z @ 0x1800DB41C (--0TraceLoggingThreadActivityIdSetter@@QEAA@AEBU_GUID@@@Z.c)
 */
