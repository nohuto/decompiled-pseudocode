/*
 * XREFs of ?QueryInterface@EndpointIterator@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18013F600
 * Callers:
 *     ?QueryInterface@EndpointIterator@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180075A70 (-QueryInterface@EndpointIterator@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
