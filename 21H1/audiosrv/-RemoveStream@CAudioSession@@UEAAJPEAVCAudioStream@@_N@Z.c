/*
 * XREFs of ?RemoveStream@CAudioSession@@UEAAJPEAVCAudioStream@@_N@Z @ 0x180050100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::RemoveStream(CAudioSession *this, struct CAudioStream *a2, char a3)
{
  ...
  {
    WPP_SF_qq(*((_QWORD *)WPP_GLOBAL_Control + 2), 56LL, &WPP_8a9aba7feb7a3955c09918de3b09cfe4_Traceguids, this, a2);
  }
...
LABEL_99:
    ...
    *((_DWORD *)this + 22) = v19;
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 59LL, &WPP_8a9aba7feb7a3955c09918de3b09cfe4_Traceguids, v19);
    }
    if ( a3 )
    {
