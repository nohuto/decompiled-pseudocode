/*
 * XREFs of ?DiscoverProcessingModeCharacteristics@CEndpointCharacteristics@@AEAAJPEA_N@Z @ 0x180059744
 * Callers:
 ...
 *     ?Start@CQPCStopWatch@@QEAAHXZ @ 0x1800DE160 (-Start@CQPCStopWatch@@QEAAHXZ.c)
  ...
  if ( ProcessingModeCharacteristicsFromPropertyStore < 0 )
  {
    ...
    *(__int64 *)((char *)&v31[28] + 4) = 0LL;
    ...
    if ( (*(int (__fastcall **)(_QWORD, LPVOID *))(**((_QWORD **)this + 2) + 40LL))(*((_QWORD *)this + 2), &pv) >= 0
      ...
      && (unsigned __int8)tlgKeywordOn(&dword_18019D478, 0x200000000000LL) )
    {
