/*
 * XREFs of _ReconsiderSpatialOnComboEndpoints_::_1_::dtor$3 @ 0x1801229B3
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall ReconsiderSpatialOnComboEndpoints_::_1_::dtor_3(__int64 a1, __int64 a2)
{
