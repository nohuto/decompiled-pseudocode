/*
 * XREFs of ?PublishCaptureAudioStatus@CCaptureNotifier@@AEAAXXZ @ 0x180065ABC
 * Callers:
 ...
 *     ?UpdateAudioCaptureStatus@CCaptureNotifier@@AEAAXW4REFERENCE_OPERATION@@K_N1@Z @ 0x1800F0338 (-UpdateAudioCaptureStatus@CCaptureNotifier@@AEAAXW4REFERENCE_OPERATION@@K_N1@Z.c)
 * Callees:
...
void __fastcall CCaptureNotifier::PublishCaptureAudioStatus(CCaptureNotifier *this)
{
  ...
  if ( *v8 > 4u )
  {
    ...
    v14 = &v12;
    v15 = 4LL;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v8, byte_180169E22, 0LL, 0LL, 3, (__int64)v13);
  }
}
