/*
 * XREFs of __tailMerge_api_ms_win_core_winrt_error_l1_1_1_dll @ 0x18006C52C
 * Callers:
 *     __imp_load_RoGetMatchingRestrictedErrorInfo @ 0x18006C520 (__imp_load_RoGetMatchingRestrictedErrorInfo.c)
 * Callees:
