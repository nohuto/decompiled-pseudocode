/*
 * XREFs of ?get@?$static_lazy@VNUIAudioTracing@@@details@wil@@QEAAPEAVNUIAudioTracing@@P6AXXZ@Z @ 0x1801343DC
 * Callers:
 ...
 *     ??0TraceLoggingProvider@wil@@IEAA@XZ @ 0x1800B7540 (--0TraceLoggingProvider@wil@@IEAA@XZ.c)
 */
