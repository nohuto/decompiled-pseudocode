/*
 * XREFs of ?TrackSystemEffectBehavior@@YAJPEAUIMMDevice@@W4APO_TYPE@@_N2AEBU_GUID@@M@Z @ 0x18012EEE8
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U?$_tlgWrapperByVal@$03@@U2@U?$_tlgWrapperByRef@$0BA@@@U?$_tlgWrapSz@G@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@AEBU?$_tlgWrapperByVal@$03@@4AEBU?$_tlgWrapperByRef@$0BA@@@AEBU?$_tlgWrapSz@G@@@Z @ 0x18012ED20 (--$Write@U-$_tlgWrapperByVal@$07@@U-$_tlgWrapperByVal@$03@@U2@U-$_tlgWrapperByRef@$0BA@@@U-$_tlg.c)
 *     IsSkipAPOFailureCheck @ 0x18012EE64 (IsSkipAPOFailureCheck.c)
 */
...
__int64 __fastcall TrackSystemEffectBehavior(__int64 a1, int a2, char a3, char a4, __int64 a5, float a6)
{
  ...
  if ( dword_1801A0C3C > *(_DWORD *)(v8 + 4) )
  {
    Init_thread_header(&dword_1801A0C3C);
    if ( dword_1801A0C3C == -1 )
    {
      xmmword_1801A0BD4 = PKEY_Endpoint_LFX_FailCount;
      dword_1801A0BE4 = 9;
      xmmword_1801A0BE8 = PKEY_Endpoint_GFX_FailCount;
      dword_1801A0BF8 = 8;
      xmmword_1801A0BFC = PKEY_Endpoint_EFX_FailCount;
      dword_1801A0C0C = 31;
      Init_thread_footer(&dword_1801A0C3C);
    }
  }
  if ( dword_1801A0C38 > *(_DWORD *)(v8 + 4) )
  {
    Init_thread_header(&dword_1801A0C38);
    if ( dword_1801A0C38 == -1 )
    {
      xmmword_1801A0B84 = PKEY_Endpoint_LFX_ExceptionCount;
      dword_1801A0B94 = 33;
      xmmword_1801A0B98 = PKEY_Endpoint_GFX_ExceptionCount;
      dword_1801A0BA8 = 34;
      xmmword_1801A0BAC = PKEY_Endpoint_EFX_ExceptionCount;
      dword_1801A0BBC = 35;
      Init_thread_footer(&dword_1801A0C38);
    }
  }
    ...
    *(_OWORD *)pvar = 0LL;
    ...
    if ( **(_DWORD **)&g_SysFxUtilTlp > 2u && tlgKeywordOn(*(__int64 *)&g_SysFxUtilTlp, 0x400000000000LL) )
    {
      ...
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByRef<16>,_tlgWrapSz<unsigned short>>(
        v11,
        (unsigned __int8 *)dword_18016D547,
        v12,
        v13,
        (__int64)&v19,
        (__int64)&v22,
