/*
 * XREFs of ?QueryInterface@CMonitorManager@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FF160
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x5Fu, (__int64)&WPP_107eeefd23a13a1e42820564321ad14e_Traceguids, v7);
  }
