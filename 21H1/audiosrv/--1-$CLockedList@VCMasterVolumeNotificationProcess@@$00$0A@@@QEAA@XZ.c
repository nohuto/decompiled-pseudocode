/*
 * XREFs of ??1?$CLockedList@VCMasterVolumeNotificationProcess@@$00$0A@@@QEAA@XZ @ 0x1800C33CC
 * Callers:
 *     _CVolumeStrip::CVolumeStrip_::_1_::dtor$1 @ 0x18007D40B (_CVolumeStrip--CVolumeStrip_--_1_--dtor$1.c)
 * Callees:
