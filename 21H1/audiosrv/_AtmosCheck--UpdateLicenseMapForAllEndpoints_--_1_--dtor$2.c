/*
 * XREFs of _AtmosCheck::UpdateLicenseMapForAllEndpoints_::_1_::dtor$2 @ 0x18013883B
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall AtmosCheck::UpdateLicenseMapForAllEndpoints_::_1_::dtor_2(__int64 a1, __int64 a2)
{
