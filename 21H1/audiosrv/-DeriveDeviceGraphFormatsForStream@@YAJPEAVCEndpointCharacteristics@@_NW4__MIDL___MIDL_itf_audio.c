 ...
 *     wil::details::lambda_call__lambda_bb75d7955c525a160db854778f06b41a___::_lambda_call__lambda_bb75d7955c525a160db854778f06b41a___ @ 0x1800E1F84 (wil--details--lambda_call__lambda_bb75d7955c525a160db854778f06b41a___--_lambda_call__lambda_bb75.c)
 */
...
LABEL_76:
  ...
  *(_QWORD *)&v52.Data1 = (char *)a1 + 8688;
  ...
  for ( i = 0; i < 9; ++i )
  {
    v20 = qword_18019E7F0[2 * i] - *(_QWORD *)&v49.Data1;
    if ( !v20 )
      v20 = qword_18019E7F0[2 * i + 1] - *(_QWORD *)v49.Data4;
    if ( !v20 )
    {
