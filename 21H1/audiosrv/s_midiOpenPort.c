/*
 * XREFs of s_midiOpenPort @ 0x1800E2CB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FilterInstantiate2@@YAJPEBGKPEAPEAX@Z @ 0x18012E4C0 (-FilterInstantiate2@@YAJPEBGKPEAPEAX@Z.c)
 */
...
__int64 __fastcall s_midiOpenPort(RPC_BINDING_HANDLE BindingHandle, unsigned __int16 *a2, HANDLE *a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, (struct _TP_TIMER *)v8[1], v9, (struct _TP_TIMER *)L"s_midiOpenPort");
  if ( a3 )
  {
