/*
 * XREFs of wil::details::functor_wrapper_void__lambda_0e6163ff1b327aa0d4e45e7e06fa9bf3__&_::Run @ 0x180047350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall wil::details::functor_wrapper_void__lambda_0e6163ff1b327aa0d4e45e7e06fa9bf3____::Run(__int64 a1)
{
  __int64 v1; // rbx
  ...
  void *v12; // rcx
  void *v13; // rcx
  struct _GUID v14; // [rsp+30h] [rbp-20h] BYREF
  ...
  if ( *(_DWORD *)(**(_QWORD **)v1 + 140LL) )
  {
    ...
    {
      if ( (unsigned int)CEndpointCharacteristics::GetVirtualSurroundEffectMode(**(struct IPropertyStore ****)(v1 + 8)) )
      {
        v3 = *(const struct tWAVEFORMATEX ***)(v1 + 16);
        v4 = *v3;
        if ( (*v3)->nChannels == 2 && !(unsigned int)ValidateUncompressedWaveFormatEx(*v3) )
        {
          pv = 0LL;
          *(_QWORD *)&v14.Data1 = &pv;
