/*
 * XREFs of ?SimpleWildcardStringCompare@@YAHQEBG_K01@Z @ 0x1800F5BE8
 * Callers:
 ...
 *     ??$CompareTo@VExclusiveEndpointInfo@@@ExclusiveEndpointInfo@@QEBA_NAEBV0@@Z @ 0x1800F2DE0 (--$CompareTo@VExclusiveEndpointInfo@@@ExclusiveEndpointInfo@@QEBA_NAEBV0@@Z.c)
