/*
 * XREFs of ?AddTail@?$TList@VCKsNotificationsMonitor@@@@QEAAPEAXPEAVCKsNotificationsMonitor@@@Z @ 0x180057F6C
 * Callers:
...
_QWORD *__fastcall TList<CKsNotificationsMonitor>::AddTail(__int64 a1, __int64 a2)
{
  ...
  {
    v5[2] = a2;
    v5[1] = qword_1801A0780;
    *v5 = 0LL;
    if ( qword_1801A0780 )
      *(_QWORD *)qword_1801A0780 = v5;
    else
      g_lstKsNotificationMonitors = v5;
    ++dword_1801A0788;
    qword_1801A0780 = (__int64)v5;
  }
  return v5;
}
