/*
 * XREFs of ?RemoveAll@?$CAtlList@V?$CAutoPtr@VWorkItemBase@@@ATL@@V?$CAutoPtrElementTraits@VWorkItemBase@@@2@@ATL@@QEAAXXZ @ 0x18013EC50
 * Callers:
 *     ??1?$CAutoPtrList@VWorkItemBase@@@ATL@@QEAA@XZ @ 0x18013DF84 (--1-$CAutoPtrList@VWorkItemBase@@@ATL@@QEAA@XZ.c)
