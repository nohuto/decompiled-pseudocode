/*
 * XREFs of AudioServerSetAmbMetadata @ 0x1800E10B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerSetAmbMetadata(char *a1, __int64 a2, __int64 a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*(_QWORD *)a1 + 128LL))(a1, a2, a3);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerSetAmbMetadata", 4646, v6);
