...
__int64 __fastcall CAudioSession::AddStream(CAudioSession *this, struct _RTL_CRITICAL_SECTION *a2)
{
  ...
  {
    WPP_SF_qq(*((_QWORD *)WPP_GLOBAL_Control + 2), 45LL, &WPP_8a9aba7feb7a3955c09918de3b09cfe4_Traceguids, this, a2);
  }
  v4 = *((_QWORD *)this + 13);
  ...
  *((_DWORD *)this + 22) = v5;
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 46LL, &WPP_8a9aba7feb7a3955c09918de3b09cfe4_Traceguids, v5);
  }
  ...
  if ( v6 )
    v9 = dword_180161510[OwningThread_low];
  else
    v9 = dword_1801614B0[OwningThread_low];
  if ( v7 )
    v7 = 16;
...
LABEL_22:
  ...
  if ( v12 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSession::AddStream", 0xB41u, v12);
