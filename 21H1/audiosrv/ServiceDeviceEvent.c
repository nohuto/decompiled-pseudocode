/*
 * XREFs of ServiceDeviceEvent @ 0x180116678
 * Callers:
 *     ServiceDeviceEventCallback @ 0x180116820 (ServiceDeviceEventCallback.c)
 * Callees:
 ...
 *     ?EventTypeNameFromEventType@@YAPEBG_K@Z @ 0x180116060 (-EventTypeNameFromEventType@@YAPEBG_K@Z.c)
