/*
 * XREFs of ?RemoveAll@?$CAtlList@V?$CAutoPtr@VPhoneTopologyWorkItem@@@ATL@@V?$CAutoPtrElementTraits@VPhoneTopologyWorkItem@@@2@@ATL@@QEAAXXZ @ 0x1800573C0
 * Callers:
 *     ??1PhoneTopology@@MEAA@XZ @ 0x18005724C (--1PhoneTopology@@MEAA@XZ.c)
 *     ??1?$CAutoPtrList@VPhoneTopologyWorkItem@@@ATL@@QEAA@XZ @ 0x18013FA3C (--1-$CAutoPtrList@VPhoneTopologyWorkItem@@@ATL@@QEAA@XZ.c)
