/*
 * XREFs of ??_ESvcHostModule@Internal@Windows@@UEAAPEAXI@Z @ 0x1800B8EAC
 * Callers:
 *     ??_ESvcHostModule@Internal@Windows@@WCI@EAAPEAXI@Z @ 0x180074BA0 (--_ESvcHostModule@Internal@Windows@@WCI@EAAPEAXI@Z.c)
 * Callees:
