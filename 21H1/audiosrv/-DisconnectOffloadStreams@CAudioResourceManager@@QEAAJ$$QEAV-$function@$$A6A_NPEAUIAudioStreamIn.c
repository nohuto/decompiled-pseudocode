/*
 * XREFs of ?DisconnectOffloadStreams@CAudioResourceManager@@QEAAJ$$QEAV?$function@$$A6A_NPEAUIAudioStreamInfo@@@Z@std@@@Z @ 0x1800708F0
 * Callers:
 *     ?DisconnectOffloadStreams@@YAJ$$QEAV?$function@$$A6A_NPEAUIAudioStreamInfo@@@Z@std@@@Z @ 0x1800708E0 (-DisconnectOffloadStreams@@YAJ$$QEAV-$function@$$A6A_NPEAUIAudioStreamInfo@@@Z@std@@@Z.c)
 * Callees:
