/*
 * XREFs of ?VAD_AudiosrvServiceStop@CAudioSrv@@AEAAJXZ @ 0x1800BB9B4
 * Callers:
 ...
 *     ?DestroyAudioSessionManagerProvider@@YAXXZ @ 0x1800D196C (-DestroyAudioSessionManagerProvider@@YAXXZ.c)
...
__int64 __fastcall CAudioSrv::VAD_AudiosrvServiceStop(CAudioSrv *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 38LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids);
    v2 = WPP_GLOBAL_Control;
  }
  if ( *((_DWORD *)this + 26) )
  {
  ...
  if ( *((_DWORD *)this + 25) )
  {
    if ( v2 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)v2 + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)v2 + 2), 39LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids);
    }
    ...
    if ( v7
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 40LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids, v7);
    }
    *((_DWORD *)this + 25) = 0;
  }
  if ( g_DuckingManager )
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 41LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids, 0LL);
  }
  return 0LL;
}
