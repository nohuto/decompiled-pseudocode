/*
 * XREFs of ?RemoveClientReference@CAudioSession@@UEAAJ_N@Z @ 0x180046560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::RemoveClientReference(CAudioSession *this, char a2)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)this + 100, 0xFFFFFFFF) == 1 )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 69LL, &WPP_8a9aba7feb7a3955c09918de3b09cfe4_Traceguids);
    }
LABEL_6:
