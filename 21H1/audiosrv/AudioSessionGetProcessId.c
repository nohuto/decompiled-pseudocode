/*
 * XREFs of AudioSessionGetProcessId @ 0x1800CD420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetProcessId(__int64 *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(
    ...
    v5,
    (struct _TP_TIMER *)L"AudioSessionGetProcessId");
  v6 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 136LL))(v2, a2);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetProcessId", 1618, v6);
