/*
 * XREFs of ?DoReacquireSaDeviceResource@CConstraintModelResourceManager@@AEAAJKPEAUReacquireResourceHandleInfo@@@Z @ 0x1800F3838
 * Callers:
 ...
 *     WPP_SF_ddI @ 0x1800F6390 (WPP_SF_ddI.c)
 *     WPP_SF_ddID @ 0x1800F63FC (WPP_SF_ddID.c)
