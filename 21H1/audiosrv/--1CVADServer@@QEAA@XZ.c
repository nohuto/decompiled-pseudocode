/*
 * XREFs of ??1CVADServer@@QEAA@XZ @ 0x1800DB534
 * Callers:
 *     _ATL::CComObject_CVADServer_::CreateInstance_::_1_::dtor$1 @ 0x180077190 (_ATL--CComObject_CVADServer_--CreateInstance_--_1_--dtor$1.c)
 * Callees:
