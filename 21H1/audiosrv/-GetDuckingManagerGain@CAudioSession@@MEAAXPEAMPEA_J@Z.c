  ...
  *a2 = 1.0;
  ...
  for ( i = (__int64 *)*((_QWORD *)this + 59); ; i = (__int64 *)*i )
  {
    ...
    *a2 = fminf(*a2, CPBMStreamClassVolumeGainStage::GainDelta((CPBMStreamClassVolumeGainStage *)i[1]));
    if ( !(unsigned __int8)wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_AudioSrv_31466786>::__private_IsEnabled(&`wil::Feature<__WilFeatureTraits_Feature_Servicing_AudioSrv_31466786>::GetImpl'::`2'::impl)
      || a3 )
    {
      v8 = *a3;
