        ...
        __int64 a14)
{
  ...
  v20 = 16LL;
  v18 = 8LL;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_18019D350, a2, 0LL, 0LL, 0xCu, &v16);
}
