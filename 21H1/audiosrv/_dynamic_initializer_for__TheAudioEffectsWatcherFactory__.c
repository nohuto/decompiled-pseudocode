/*
 * XREFs of _dynamic_initializer_for__TheAudioEffectsWatcherFactory__ @ 0x180001980
 * Callers:
 *     <none>
 * Callees:
 *     ??0AudioEffectsWatcherFactory@@QEAA@XZ @ 0x1800549A0 (--0AudioEffectsWatcherFactory@@QEAA@XZ.c)
 */
