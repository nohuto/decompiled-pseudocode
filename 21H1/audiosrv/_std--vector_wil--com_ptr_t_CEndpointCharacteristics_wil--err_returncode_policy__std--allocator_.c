/*
 * XREFs of _std::vector_wil::com_ptr_t_CEndpointCharacteristics_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CEndpointCharacteristics_wil::err_returncode_policy_____::_Emplace_reallocate_CEndpointCharacteristics___&__::_1_::catch$33 @ 0x18007B0E8
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_wil::com_ptr_t_CEndpointCharacteristics_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CEndpointCharacteristics_wil::err_returncode_policy_____::_Emplace_reallocate_CEndpointCharacteristics______::_1_::catch_33(
        __int64 a1,
        __int64 a2)
{
