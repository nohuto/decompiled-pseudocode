/*
 * XREFs of ?ServiceMain@@YAXKQEAPEAG@Z @ 0x180062120
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WppInitUm @ 0x180062994 (WppInitUm.c)
...
void __fastcall ServiceMain(unsigned int a1, LPCWSTR *a2)
{
  ...
  if ( !hEventShutdown )
  {
    dword_18019F678 = GetLastError();
    v7 = (unsigned int)dword_18019F678;
LABEL_18:
    ReportStatusToSCMgr(1LL, v7, 0LL, v6);
    return;
  }
  dword_18019F678 = (*((__int64 (__fastcall **)(HANDLE *, LPCWSTR, HANDLE, void (__fastcall *)(void *, unsigned __int8), _QWORD, int))gpSvchostSharedGlobals
                     + 24))(
                      &hEventShutdownWait,
                      *a2,
                      hEventShutdown,
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(v13 * 8 + *((_QWORD *)v8 + 2)) = HeapAlloc(hHeap, 8u, v15);
      ...
      if ( v12 >= a1 )
      {
        ...
        dword_18019F678 = GetLastError();
        v18 = (unsigned int)dword_18019F678;
        goto LABEL_21;
      }
    }
  }
