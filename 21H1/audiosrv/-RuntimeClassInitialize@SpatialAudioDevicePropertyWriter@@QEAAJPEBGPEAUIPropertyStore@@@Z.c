/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioDevicePropertyWriter@@QEAAJPEBGPEAUIPropertyStore@@@Z @ 0x1800583A8
 * Callers:
    ...
    if ( Instance >= 0 )
    {
      ...
      if ( Instance >= 0 )
      {
        ...
        Instance = CoCreateInstance(
                     ...
                     v18);
        v6 = Instance;
        if ( Instance >= 0 || (unsigned int)dword_18019D4B0 <= 2 )
          goto LABEL_34;
        v20 = 147;
        goto LABEL_33;
      }
