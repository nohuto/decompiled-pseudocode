/*
 * XREFs of _CAudioSessionManager::CreateAudioSession_::_1_::dtor$2 @ 0x180077BA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CAudioSessionManager::CreateAudioSession_::_1_::dtor_2(__int64 a1, __int64 a2)
{
