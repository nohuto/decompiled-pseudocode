/*
 * XREFs of __tailMerge_ext_ms_win_session_wtsapi32_l1_1_0_dll @ 0x18006C9D5
 * Callers:
 *     __imp_load_WTSQuerySessionInformationW @ 0x18006C9C9 (__imp_load_WTSQuerySessionInformationW.c)
 *     __imp_load_WTSFreeMemory @ 0x18006CAA8 (__imp_load_WTSFreeMemory.c)
 * Callees:
