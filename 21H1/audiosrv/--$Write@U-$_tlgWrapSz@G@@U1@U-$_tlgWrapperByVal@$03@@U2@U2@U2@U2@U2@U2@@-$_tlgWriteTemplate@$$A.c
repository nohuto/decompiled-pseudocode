/*
 * XREFs of ??$Write@U?$_tlgWrapSz@G@@U1@U?$_tlgWrapperByVal@$03@@U2@U2@U2@U2@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwEventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@G@@3AEBU?$_tlgWrapperByVal@$03@@444444@Z @ 0x1800BF664
 * Callers:
        ...
        __int64 a13)
{
  ...
  _WORD *v23; // [rsp+50h] [rbp-91h]
  int v24; // [rsp+58h] [rbp-89h]
  int v25; // [rsp+5Ch] [rbp-85h]
  _WORD *v26; // [rsp+60h] [rbp-81h]
  ...
  v24 = v16;
  v25 = 0;
  return tlgWriteTransfer_EtwEventWriteTransfer(a1, a2, 0LL, 0LL, 11, (__int64)v22);
}
