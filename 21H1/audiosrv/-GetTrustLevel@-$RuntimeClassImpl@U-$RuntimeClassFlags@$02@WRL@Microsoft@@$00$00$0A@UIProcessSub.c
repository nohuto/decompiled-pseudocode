/*
 * XREFs of ?GetTrustLevel@?$RuntimeClassImpl@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00$00$0A@UIProcessSubmixProxy@@UIInspectable@@@Details@WRL@Microsoft@@WBI@EAAJPEAW4TrustLevel@@@Z @ 0x180075060
 * Callers:
 *     <none>
 * Callees:
 *     <none>
