/*
 * XREFs of _CAudioSessionManager::RegisterDisconnectNotificationClient_::_1_::catch$52 @ 0x1800D05CC
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSessionManager::RegisterDisconnectNotificationClient_::_1_::catch_52(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
