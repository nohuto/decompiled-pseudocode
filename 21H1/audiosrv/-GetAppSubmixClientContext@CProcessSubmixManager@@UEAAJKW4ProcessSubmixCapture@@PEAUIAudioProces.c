/*
 * XREFs of ?GetAppSubmixClientContext@CProcessSubmixManager@@UEAAJKW4ProcessSubmixCapture@@PEAUIAudioProcess@@PEAPEAVCAppSubmixClient@@@Z @ 0x1800F14E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcessSubmixManager::GetAppSubmixClientContext(
        ...
        __int64 a5)
{
  return CProcessSubmixManager::GetAppSubmixClientContextHelper(a1, a2, a3, &unk_18015D744, a4, a5);
}
