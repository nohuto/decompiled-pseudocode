/*
 * XREFs of AudioSessionGetIsComms @ 0x1800CD270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetIsComms(__int64 *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, (struct _TP_TIMER *)v4[1], v5, (struct _TP_TIMER *)L"AudioSessionGetIsComms");
  v6 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v2 + 272LL))(v2, a2);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetIsComms", 2548, v6);
