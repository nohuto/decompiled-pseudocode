/*
 * XREFs of ?SendRemoteDisconnectionRequest@CAudioStream@@UEAAJXZ @ 0x1800D32D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioStream::SendRemoteDisconnectionRequest(CAudioStream *this)
{
  ...
  if ( *v2 > 4u )
  {
    ...
    v20 = &v12;
    v18 = &v13;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v2, byte_180167E68, 0LL, 0LL, 4, (__int64)v17);
  }
  v4 = *((_QWORD *)this + 9);
  v5 = *((_BYTE *)this + 120) != 0;
  v14[0] = 80;
