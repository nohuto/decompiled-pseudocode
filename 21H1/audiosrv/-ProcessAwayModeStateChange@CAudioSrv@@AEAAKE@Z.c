/*
 * XREFs of ?ProcessAwayModeStateChange@CAudioSrv@@AEAAKE@Z @ 0x1800B9DC0
 * Callers:
...
__int64 __fastcall CAudioSrv::ProcessAwayModeStateChange(CAudioSrv *this, unsigned __int8 a2)
{
      ...
      for ( i = 0; i < v18; ++i )
      {
        ...
        if ( (*(int (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)v15 + 32LL))(v15, i, &v20) >= 0 )
        {
          ...
          else
          {
            ...
            {
              WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 34LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids, pv);
            }
            CoTaskMemFree(pv);
              ...
              else if ( (*(int (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v13 + 152LL))(v13, &v19) >= 0 )
              {
                ...
                if ( (_BYTE)v2 )
                {
                  ...
                  v10 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v21 + 48LL))(
                          ...
                          pvar);
                  if ( v10 < 0 )
                    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessAwayModeStateChange", 1370, v10);
                }
                else
                {
                ...
                if ( v19 != v8 )
                {
                  v11 = (*(__int64 (__fastcall **)(__int64, _QWORD, void *, _QWORD))(*(_QWORD *)v13 + 144LL))(
                          ...
                          0LL);
                  if ( v11 < 0 )
                    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessAwayModeStateChange", 1393, v11);
                }
              }
            }
          }
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids, v5);
LABEL_48:
    v4 = v15;
  }
LABEL_49:
