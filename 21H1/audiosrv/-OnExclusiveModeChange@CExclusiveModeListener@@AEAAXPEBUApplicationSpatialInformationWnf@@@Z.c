/*
 * XREFs of ?OnExclusiveModeChange@CExclusiveModeListener@@AEAAXPEBUApplicationSpatialInformationWnf@@@Z @ 0x18010D934
 * Callers:
 *     ?SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYPE_ID@@PEAXPEBXK@Z @ 0x18010ECF0 (-SpatialApplicationInfoUpdateCallback@CExclusiveModeListener@@CAJU_WNF_STATE_NAME@@KPEAU_WNF_TYP.c)
 * Callees:
 ...
 *     GetRecordFromWnf @ 0x18010D4E4 (GetRecordFromWnf.c)
  ...
  else
  {
    if ( (unsigned int)dword_18019D350 > 4 )
    {
      ...
      tlgWriteTransfer_EventWriteTransfer(
        ...
        (unsigned __int8 *)dword_18016A8F6,
        0LL,
        0LL,
        3u,
        &v14);
