/*
 * XREFs of ?Uninitialize@AtmosCheck@@QEAAXXZ @ 0x180137FF0
 * Callers:
 ...
 *     ?UnregisterFromShellReadyNotifications@AtmosCheck@@AEAAXXZ @ 0x180074720 (-UnregisterFromShellReadyNotifications@AtmosCheck@@AEAAXXZ.c)
