/*
 * XREFs of ?NewNode@?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@AEAAPEAVCNode@12@AEBU_ResourceInfo@@PEAV312@1@Z @ 0x18013AB50
 * Callers:
 *     ?AddTail@?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@QEAAPEAU__POSITION@@AEBU_ResourceInfo@@@Z @ 0x180139E74 (-AddTail@-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@QEAAPEAU__POSITION@@AEBU_Resource.c)
 * Callees:
