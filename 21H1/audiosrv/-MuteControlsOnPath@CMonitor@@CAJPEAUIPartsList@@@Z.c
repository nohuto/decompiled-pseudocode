/*
 * XREFs of ?MuteControlsOnPath@CMonitor@@CAJPEAUIPartsList@@@Z @ 0x1801026E0
 * Callers:
...
__int64 __fastcall CMonitor::MuteControlsOnPath(struct IPartsList *a1)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x45u, (__int64)&WPP_31d4709c2c57346b6bd3a2697a2c0190_Traceguids);
  }
