/*
 * XREFs of ?ProcessOnDeviceStateChanged@AudioDeviceMgr@@QEAAJPEBGK@Z @ 0x18013EB80
 * Callers:
 *     ?Process@DeviceStateChangedWorkItem@@UEAAXPEAVAudioDeviceMgr@@@Z @ 0x18013E950 (-Process@DeviceStateChangedWorkItem@@UEAAXPEAVAudioDeviceMgr@@@Z.c)
 * Callees:
        ...
        int a3)
{
  ...
  __int64 v8; // rax
  int v9; // eax
  struct IEndpointDevice *v11; // [rsp+20h] [rbp-18h] BYREF
...
LABEL_6:
  ...
  if ( SpinCount )
  {
    v8 = *SpinCount;
    if ( v12 )
      (*(void (__fastcall **)(__int64 *, struct IEndpointDevice *))(v8 + 24))(SpinCount, v11);
    else
      (*(void (__fastcall **)(__int64 *, struct IEndpointDevice *))(v8 + 40))(SpinCount, v11);
  }
