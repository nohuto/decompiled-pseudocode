/*
 * XREFs of ??$MakeAndInitialize@VCEndpointCharacteristics@@V1@AEAPEBGAEAH@Details@WRL@Microsoft@@YAJPEAPEAVCEndpointCharacteristics@@AEAPEBGAEAH@Z @ 0x180058D8C
 * Callers:
        ...
        int *a3)
{
  ...
  *a1 = 0LL;
  v6 = (CEndpointCharacteristics *)operator new(0x2220uLL, (const struct std::nothrow_t *)&std::nothrow);
  v11 = v6;
  v10 = v6;
  if ( v6 )
  {
