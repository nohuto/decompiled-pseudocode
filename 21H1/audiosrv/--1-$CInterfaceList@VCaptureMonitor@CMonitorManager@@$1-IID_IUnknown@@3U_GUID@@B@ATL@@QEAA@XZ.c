/*
 * XREFs of ??1?$CInterfaceList@VCaptureMonitor@CMonitorManager@@$1?IID_IUnknown@@3U_GUID@@B@ATL@@QEAA@XZ @ 0x1800FA6C8
 * Callers:
 *     _CMonitorManager::CMonitorManager_::_1_::dtor$3 @ 0x18007CEC6 (_CMonitorManager--CMonitorManager_--_1_--dtor$3.c)
 *     _CMonitorManager::Initialize_::_1_::dtor$1 @ 0x18007CF0E (_CMonitorManager--Initialize_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
