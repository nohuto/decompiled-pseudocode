/*
 * XREFs of ?GetShareMode@CPolicyConfig@@UEAAJPEBGPEAW4_DeviceShareMode@@@Z @ 0x1800D7EB0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _DeviceShareMode *a3)
{
  ...
  if ( PropertyStoreProperty < 0 )
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetShareMode", 2168, PropertyStoreProperty);
  if ( v7 )
