/*
 * XREFs of _SpatialPolicy::DetectComboEndpoint_::_1_::dtor$0 @ 0x18007C979
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall SpatialPolicy::DetectComboEndpoint_::_1_::dtor_0(__int64 a1, __int64 a2)
{
