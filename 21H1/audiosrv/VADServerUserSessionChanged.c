/*
 * XREFs of VADServerUserSessionChanged @ 0x18002AFC8
 * Callers:
 *     ?Invoke@SESSION_EVENT@@UEAAXXZ @ 0x18002AF70 (-Invoke@SESSION_EVENT@@UEAAXXZ.c)
 * Callees:
...
LABEL_35:
        if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 47LL, &WPP_d589406c240c3254166a1ed404a43ff9_Traceguids, v4);
        }
      }
    }
  }
