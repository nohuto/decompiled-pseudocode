/*
 * XREFs of ?DeviceRemovalEvent@CAudioSrv@@UEAAJV?$CHeapPtr@U_DEV_BROADCAST_DEVICEINTERFACE_W@@VCCRTAllocator@ATL@@@ATL@@@Z @ 0x1800B94B0
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall CAudioSrv::DeviceRemovalEvent(__int64 a1, void **a2)
{
  ...
  if ( (int)FlushDeviceTopologyCache() < 0 )
    v3 = 1;
  free(*a2);
  *a2 = 0LL;
  return v3;
