/*
 * XREFs of ?Initialize@CaptureMonitor@CMonitorManager@@QEAAJXZ @ 0x1800FD360
 * Callers:
 ...
 *     ??0CMonitor@@QEAA@W4_AUDIO_STREAM_EXTENDED_CATEGORY@@@Z @ 0x1800FA1A4 (--0CMonitor@@QEAA@W4_AUDIO_STREAM_EXTENDED_CATEGORY@@@Z.c)
 *     ?Create@CEvent@ATL@@QEAAHPEAU_SECURITY_ATTRIBUTES@@HHPEBG@Z @ 0x1800FAFF4 (-Create@CEvent@ATL@@QEAAHPEAU_SECURITY_ATTRIBUTES@@HHPEBG@Z.c)
 *     WPP_SF_dD @ 0x180100AE8 (WPP_SF_dD.c)
