...
int __stdcall EtwProcessPrivateLoggerRequest(int *a1)
{
  ...
  v1 = a1 + 18;
  a1[42] = a1[5];
  v15 = EtwpValidateLoggerInfo(a1 + 18);
  if ( v15 )
    goto LABEL_23;
  v2 = *v1;
  v3 = a1[19];
  ...
  if ( !v5 )
  {
    started = EtwpStartUmLogger(&v17, v1);
LABEL_5:
    v7 = started;
    goto LABEL_6;
  }
  ...
  if ( !v12 )
  {
    started = EtwpQueryUmLogger(v16, &v18, &v17, (int)v1);
    goto LABEL_5;
  }
  v13 = v12 - 1;
  if ( !v13 )
  {
    started = EtwpUpdateUmLogger(&v17, v1);
    goto LABEL_5;
  }
  v14 = v13 - 1;
  if ( !v14 )
  {
    started = EtwpFlushUmLogger(v16, &v18, &v17, (int)v1);
    goto LABEL_5;
  }
  if ( v14 == 1 )
  {
    started = EtwpIncrementUmLoggerFile(&v17, v1);
    goto LABEL_5;
  }
  v7 = 87;
LABEL_6:
