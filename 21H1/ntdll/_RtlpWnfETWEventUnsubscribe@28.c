/*
 * XREFs of _RtlpWnfETWEventUnsubscribe@28 @ 0x4B33C581
 * Callers:
...
int __fastcall RtlpWnfETWEventUnsubscribe(int a1, int a2, int a3, int a4, int a5, int a6, int a7)
{
  int v7; // eax
  _BYTE v9[6]; // [esp+8h] [ebp-48h] BYREF
  ...
  if ( RtlGetCurrentServiceSessionId() )
    ...
    v7 = 2147353486;
  return NtTraceEvent(*(unsigned __int8 *)v7, 132098, 28, (int)v9);
}
