        ...
        _DWORD *a9)
{
  ...
  int v17; // ecx
  int v18; // eax
  int v20; // [esp-4h] [ebp-2030h]
  char v21; // [esp+20h] [ebp-200Ch]
  unsigned __int16 *v22; // [esp+24h] [ebp-2008h]
  int v23[2048]; // [esp+28h] [ebp-2004h] BYREF
  ...
  if ( v12 != 93 )
  {
    do
    {
      ...
      else
      {
        v10 = v12;
        v20 = 2;
        *((_BYTE *)v23 + (v12 >> 3)) |= 1 << (v12 & 7);
      }
      v11 = (unsigned __int16 *)((char *)v11 + v20);
      v22 = v11;
      v13 = *v11;
      v12 = *v11;
    }
  ...
  if ( !v13 )
    return -1;
  *v9 = v11;
  return ReadString_1(v21, (int)v23, a3, a4, a5, a6, a7, a8, a9);
}
