...
int __fastcall LdrpGenericExceptionFilter(const void **a1, const char *a2)
{
  ...
  if ( (v2 & 0x30) == 0x20 )
  {
    while ( 1 )
    {
      ...
      DbgPrompt("Break repeatedly, break Once, Ignore, terminate Process or terminate Thread (boipt)? ", v10, 2);
      if ( v10[0] > 98 )
      {
        v6 = v10[0] - 105;
        v5 = v10[0] == 105;
