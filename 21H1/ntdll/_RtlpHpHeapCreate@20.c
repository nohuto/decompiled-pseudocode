...
int __fastcall RtlpHpHeapCreate(int a1, unsigned int a2, int a3, int a4, int a5)
{
  ...
  int v14; // ebx
  int v15; // eax
  unsigned int ProcessorCount; // [esp+Ch] [ebp-24h]
  ...
  v7 = RtlpHpHeapAllocate(a1, ProcessorCount, a4, a5);
  v6 = 0;
  if ( !v7 )
  {
  ...
  *v7 = a4;
  *((_DWORD *)v7 + 1) = v9;
  *((_DWORD *)v7 + 2) = -571548178;
  *((_DWORD *)v7 + 3) = a1;
  if ( BYTE1(v8) >= 2u )
    LOBYTE(v6) = 16;
  if ( (a1 & 0x4000000) != 0 )
    LOBYTE(v6) = v6 | 4;
  RtlpHpSegContextInitialize((void *)(v7 + 64), (int)v7, (int)(v7 + 176), (int)(v7 + 128), (int)(v7 + 32), v6, v8, v9);
  RtlpHpSegContextInitialize((void *)(v7 + 96), (int)v7, 0, 0, (int)(v7 + 32), v6, a4, a5);
  *((_DWORD *)v7 + 16) = 0;
  *((_DWORD *)v7 + 17) = 0;
  *((_DWORD *)v7 + 18) = 0;
  ...
  *((_DWORD *)v7 + 45) = 0;
  if ( !v11 )
    *((_DWORD *)v7 + 4) = (unsigned __int16)RtlpGetHeapInterceptorIndex((int (__stdcall *)(int, int, int, int))RtlpStackTraceDatabaseLogPrefix);
  v20 = 0;
  v12 = a4 & 1;
  ...
  RtlpHpVsContextInitialize((void *)(v7 + 128), (int)v19, a4 & 1, v10, (int)&dword_4B3A8A2C);
...
LABEL_27:
  ...
  if ( *(_BYTE *)v15 && (NtCurrentPeb()->TracingFlags & 1) != 0 )
  {
    ...
    RtlpLogHeapCreateEvent(v6, a1, *(_DWORD *)(v6 + 192) - v6, *(_DWORD *)(v6 + 188) - v6, *(unsigned __int8 *)v14);
    goto LABEL_27;
  }
  return v6;
}
