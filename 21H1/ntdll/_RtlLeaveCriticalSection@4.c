/*
 * XREFs of _RtlLeaveCriticalSection@4 @ 0x4B2BE700
 * Callers:
 ...
 *     _RtlReleasePebLock@0 @ 0x4B2E9F50 (_RtlReleasePebLock@0.c)
 ...
 *     _RtlTraceDatabaseUnlock@4 @ 0x4B36A410 (_RtlTraceDatabaseUnlock@4.c)
