...
void *__fastcall RtlpHpSegAlloc(int a1, size_t a2, int a3, int a4, unsigned int a5)
{
  unsigned int v5; // esi
  void *v7; // esi
  int v8; // eax
  ...
  v16 = v10;
  v17 = (unsigned __int16)~(*(_DWORD *)(v8 + 12) >> 8);
  if ( v19 )
  {
    v11 = a5;
    if ( v17 )
      v11 = a5 & 0xFFFFFFFD;
    if ( (int)RtlpHpSegPageRangeCommit(0, v19, v11, 0) < 0 )
    {
      v7 = 0;
LABEL_21:
      if ( v9 )
