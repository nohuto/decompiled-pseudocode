...
unsigned int __fastcall RtlpFreeHeapInternal(int a1, int a2, int a3, _DWORD *a4, _WORD *a5)
{
  int v5; // esi
  int v6; // ebx
  int v7; // eax
  ...
  char v72[4]; // [esp+14h] [ebp-38h] BYREF
  unsigned int v73; // [esp+18h] [ebp-34h] BYREF
  int v74; // [esp+1Ch] [ebp-30h] BYREF
  volatile signed __int32 *v75; // [esp+20h] [ebp-2Ch]
  volatile signed __int32 *v76; // [esp+24h] [ebp-28h]
  unsigned int *i; // [esp+28h] [ebp-24h]
  unsigned int v78; // [esp+2Ch] [ebp-20h]
  volatile signed __int64 *v79; // [esp+30h] [ebp-1Ch]
  signed __int32 v80; // [esp+34h] [ebp-18h]
  int v81; // [esp+38h] [ebp-14h]
  unsigned int v82; // [esp+3Ch] [ebp-10h]
  _DWORD *v83; // [esp+40h] [ebp-Ch]
  int v84; // [esp+44h] [ebp-8h]
  char v85; // [esp+4Ah] [ebp-2h]
  char v86; // [esp+4Bh] [ebp-1h]
  ...
  if ( *(_DWORD *)(a1 + 8) == -571548178 )
  {
    ...
    v10 = v82;
    v78 = RtlpHpFreeHeap(v9 & 0x11000001, a4, a5);
    if ( v78 )
    {
      if ( a4 )
        *a4 -= v6;
...
LABEL_32:
  v7 = v82;
  v76 = *(volatile signed __int32 **)(v82 - 8);
  if ( (a3 & 0x3C000102) != 0 )
    goto LABEL_60;
  if ( *(_BYTE *)(v82 - 8 + 7) == 5 )
  {
    v7 = v82;
    v18 = v82 - 8 * *(unsigned __int8 *)(v82 - 8 + 6);
  }
  else
  {
    v18 = 0;
...
LABEL_60:
  if ( *(char *)(v8 + 7) >= 0 )
  {
    v14 = a3;
LABEL_139:
    v71 = RtlpFreeHeap(v5, v14 | 2, (unsigned __int16 *)v8, v7);
    v12 = v71;
    if ( v71 )
      goto LABEL_140;
    return v12;
  ...
  if ( (_WORD)v24 || (v25 = *(_DWORD **)(v8 - (v24 >> 13)), (v83 = v25) == 0) )
  {
    RtlpLogHeapFailure(v8, 0, 0, 0);
    goto LABEL_66;
  }
  ...
  v29 = (unsigned int)v28 ^ *(_DWORD *)(v81 + 16);
  v76 = v28;
  if ( v81 + v26 * ((RtlpLFHKey ^ v81 ^ (unsigned int)v29) >> 16) + (unsigned __int16)(RtlpLFHKey ^ v81 ^ v29) != v8 )
  {
    RtlpLogHeapFailure(v8, 0, 0, 0);
    goto LABEL_65;
  }
  ...
  v31 = 0;
  v76 = 0;
  v75 = MEMORY[0x7FFE036A] > 1u ? (volatile signed __int32 *)0x64 : 0;
  v32 = v83 + 4;
  for ( i = v83 + 4; ; v32 = (signed __int32 *)i )
  {
    v33 = *v32;
    v34 = HIWORD(*v32);
    v80 = v33;
    if ( (v34 & 0x8000) == 0 )
    {
      ...
      v36 = v80;
      if ( v35 == (volatile signed __int32 *)v80 )
        goto LABEL_80;
      v31 = v76;
    }
...
LABEL_80:
  *(_BYTE *)(v8 + 7) = 0x80;
  ...
  {
    v37 = (_DWORD *)(v8 + 8);
    v38 = (unsigned int)(v83 + 2);
    goto LABEL_82;
  }
  v39 = (int)v83;
  _bittestandreset(*(signed __int32 **)(v81 + 24), v78);
  if ( *((_WORD *)v83 + 6) )
  {
    v40 = (_DWORD *)RtlpInterlockedFlushSList(v83 + 2);
    if ( v40 )
    {
      v36 = (signed __int32)v79;
      do
      {
        v41 = *(v40 - 1);
        v40 = (_DWORD *)*v40;
        _bittestandreset(*(signed __int32 **)(v81 + 24), (unsigned __int16)(v41 >> 8));
        ++v36;
        v78 = (unsigned __int16)(v41 >> 8);
      }
      while ( v40 );
      v39 = (int)v83;
      v79 = (volatile signed __int64 *)v36;
      LOWORD(v36) = v80;
    }
  }
  v42 = (v78 << 16) | ((unsigned int)v79 + (unsigned __int16)v36 + 1);
  v43 = *(volatile signed __int32 **)v39;
  if ( (_WORD)v42 == *(_WORD *)(v39 + 24) )
  {
    v78 = *(_DWORD *)(*v43 + 16);
    v76 = (volatile signed __int32 *)*((_DWORD *)v43 + 22);
    v44 = *((_DWORD *)v43 + 21);
    if ( v44 != 1
      || (v44 = v78, v78 < (unsigned int)v76)
      || (v78 -= (unsigned int)v76, v44 = *v43, v39 = (int)v83, v78 >= *(_DWORD *)(*v43 + 20)) )
    {
      v76 = *(volatile signed __int32 **)v39;
      v45 = _InterlockedExchange(v76 + 1, 0);
      if ( !v45 )
        goto LABEL_113;
      v39 = (int)v83;
...
LABEL_113:
        ...
        v76 = (volatile signed __int32 *)v55;
        v75 = v56;
        if ( !v54 )
        {
          v73 = (*(_DWORD *)(v39 + 4) + 4127) & 0xFFFFF000;
          v74 = 8 * (unsigned __int16)RtlpGetReservedBlockSize(v39) * *(unsigned __int16 *)(v39 + 24);
          HeapProtection = RtlpGetHeapProtection(*(_DWORD *)(v55 + 12), v57);
          ZwProtectVirtualMemory(-1, (int)&v73, (int)&v74, HeapProtection, (int)v72);
        }
        *(_DWORD *)(*(_DWORD *)(v39 + 4) + 12) = 0;
        RtlpFreeUserBlock(v55, *(_DWORD *)(v39 + 4), v44);
        v59 = -*(unsigned __int16 *)(v39 + 24);
        LODWORD(v60) = v75 + 20;
        v78 = v59;
        v79 = (volatile signed __int64 *)(v75 + 20);
        do
        {
          do
          {
            v61 = *(_QWORD *)v60;
            v75 = (volatile signed __int32 *)HIDWORD(v61);
            v62 = v61;
            v60 = _InterlockedCompareExchange64(v79, __SPAIR64__(HIDWORD(v61) - 1, (int)v61 + v59), v61);
            v59 = v78;
            v54 = (_DWORD)v60 == v62;
            LODWORD(v60) = v79;
          }
        ...
        while ( (volatile signed __int32 *)HIDWORD(v60) != v75 );
        v63 = v83;
        v64 = v76;
        v83[1] = 0;
      ...
      if ( !RtlpIsSubSegmentReuseable((int)v76, v45) )
        goto LABEL_113;
      do
      {
        v47 = *(_DWORD *)(v45 + 28);
      ...
      while ( 1 )
      {
        ...
        v75 = v50;
        v51 = *v50;
        v79 = (volatile signed __int64 *)v51;
        if ( v51 )
        {
          v80 = v51 + 28;
          if ( (*(_DWORD *)(v51 + 28) & 1) != 0 )
            goto LABEL_106;
          v39 = (int)v83;
          if ( (volatile signed __int64 *)_InterlockedCompareExchange(v75, v45, (signed __int32)v79) == v79 )
          {
            v39 = (int)v83;
            if ( _InterlockedAnd((volatile signed __int32 *)v80, 0xFFFFFFFD) != 2 )
              goto LABEL_113;
            v52 = v79;
            v46 = **(_DWORD **)v79;
            *(_DWORD *)v79 = 0;
...
LABEL_106:
  ...
  *(_DWORD *)(v39 + 16) = v42;
  ...
  while ( 1 )
  {
    ...
    v76 = (volatile signed __int32 *)&v67[(((_BYTE)v68 + (unsigned __int8)*((_WORD *)v67 + 47)) & 0xF) + 2];
    if ( !v69 )
    {
      if ( !_InterlockedCompareExchange(v76, v39, 0) )
        goto LABEL_65;
      goto LABEL_132;
    }
...
LABEL_133:
  ...
  v70 = _InterlockedCompareExchange(v76, v39, v69);
  v39 = (int)v83;
  if ( v70 != v69 )
  {
LABEL_132:
...
LABEL_140:
  ...
  if ( RtlpHpStackLoggingEnabled() && (a3 & 0x10000000) == 0 )
    RtlpHpStackTraceRemoveStack(v5, v82);
  return v12;
}
