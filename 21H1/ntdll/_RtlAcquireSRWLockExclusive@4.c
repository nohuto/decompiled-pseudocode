/*
 * XREFs of _RtlAcquireSRWLockExclusive@4 @ 0x4B2C22E0
 * Callers:
...
void __cdecl RtlAcquireSRWLockExclusive(PRTL_SRWLOCK SRWLock)
{
  ...
  unsigned int v17; // [esp+30h] [ebp-20h] BYREF
  ...
  if ( _interlockedbittestandset((volatile signed __int32 *)SRWLock, 0) )
  {
    for ( i = SRWLock->Value; ; i = Value )
    {
      ...
      else
      {
        v18 = &v17;
        v21 = v2 >> 4;
        v4 = (unsigned int)&v17 | (v3 < v2 >> 4 ? 11 : 3);
        if ( !(v2 >> 4) )
          v21 = -2;
      }
      ...
      if ( MEMORY[0x7FFE036A] > 1u )
      {
        ...
        {
          v8 = __rdtsc();
          v11 = SRWLockSpinCycleCount + v8;
          v16 = ((unsigned int)SRWLockSpinCycleCount + v8) >> 32;
          while ( 1 )
          {
            ...
            v10 = __rdtsc();
            v8 = v10;
            if ( v10 <= __PAIR64__(v9, v15) || v10 >= __PAIR64__(v16, v11) )
              break;
        ...
        {
          for ( j = 0; (v22[0] & 2) != 0 && j != SRWLockSpinCycleCount / (unsigned int)MEMORY[0x7FFE02D6]; ++j )
            _mm_pause();
        }
      }
