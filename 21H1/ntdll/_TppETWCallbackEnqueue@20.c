/*
 * XREFs of _TppETWCallbackEnqueue@20 @ 0x4B384A30
 * Callers:
...
int __fastcall TppETWCallbackEnqueue(int a1, int a2, int a3, int a4, int a5)
{
  int v5; // eax
  ...
  if ( RtlGetCurrentServiceSessionId() )
    ...
    v5 = 2147353478;
  return NtTraceEvent(*(unsigned __int8 *)v5, 132098, 20, (int)v7);
}
