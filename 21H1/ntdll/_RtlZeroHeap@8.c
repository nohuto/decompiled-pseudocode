...
int __stdcall RtlZeroHeap(unsigned int a1, int a2)
{
  _BYTE *v2; // edi
  int v4; // ecx
  _DWORD *v5; // ecx
  ...
  unsigned int v25; // [esp+14h] [ebp-48h]
  int v26; // [esp+1Ch] [ebp-40h]
  unsigned __int16 *v27; // [esp+28h] [ebp-34h]
  _DWORD *v28; // [esp+2Ch] [ebp-30h]
  unsigned __int16 *v29; // [esp+30h] [ebp-2Ch]
  int v30; // [esp+34h] [ebp-28h]
  int i; // [esp+34h] [ebp-28h]
  unsigned __int16 *v32; // [esp+3Ch] [ebp-20h]
  char v33; // [esp+43h] [ebp-19h]
    ...
    while ( 1 )
    {
      ...
      if ( v2 )
      {
        if ( !*(_DWORD *)(a1 + 76) )
          goto LABEL_17;
        v2[3] = *v2 ^ v2[1] ^ v2[2];
        *(_DWORD *)v2 ^= *(_DWORD *)(a1 + 80);
      }
      if ( *(_DWORD *)(a1 + 76) )
      {
        *(_DWORD *)v7 ^= *(_DWORD *)(a1 + 80);
...
LABEL_17:
      ...
      {
        v23 = v7 + 8;
        if ( ((v8 >> 2) & ((*(_BYTE *)(a1 + 64) & 0x40) != 0)) != 0 )
          RtlFillMemoryUlong(v23, 8 * v30 - 16, -17891602);
        else
          RtlFillMemoryUlong(v23, 8 * v30 - 16, 0);
        v7 = v32;
LABEL_61:
        if ( *((_BYTE *)v7 + 7) == 3 )
      ...
      if ( *v10 == v11 && (int *)*v10 == v9 )
      {
        *(_DWORD *)(a1 + 116) -= v30;
        ...
        if ( v12 )
        {
          ...
          RtlpHeapRemoveListEntry(a1, v12, 1, v9, v13, i);
        }
        *v24 = v26;
        *(_DWORD *)(v26 + 4) = v24;
        if ( (v27[1] & 8) == 0 || RtlpCommitBlock((_DWORD *)a1, (int)v27) )
        {
          v15 = *v27;
          v25 = v15;
          *((_BYTE *)v27 + 2) = 0;
          *((_BYTE *)v27 + 7) = 0;
          v16 = (_DWORD *)(a1 + 192);
          if ( *(_DWORD *)(a1 + 180) )
            Entry = (_DWORD *)RtlpFindEntry(a1, v15);
          else
            Entry = (_DWORD *)*v16;
          while ( v16 != Entry )
          {
          ...
          *(_DWORD *)(a1 + 116) += *v27;
          ...
          if ( v21 )
          {
            ...
            v22 = v21[1] - 1;
LABEL_50:
            RtlpHeapAddListEntry(a1, v21, 1, (int)(v27 + 4), v22, *v27);
          }
          if ( *(_DWORD *)(a1 + 76) )
          {
            *((_BYTE *)v27 + 3) = *(_BYTE *)v27 ^ *((_BYTE *)v27 + 1) ^ *((_BYTE *)v27 + 2);
            *(_DWORD *)v27 ^= *(_DWORD *)(a1 + 80);
          }
        }
        else
        {
          RtlpDeCommitFreeBlock(a1, (int)v27, *v27, 1);
        }
      }
      else
      {
