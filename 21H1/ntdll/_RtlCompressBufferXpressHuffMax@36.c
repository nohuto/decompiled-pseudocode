        ...
        int a9)
{
  ...
  int v58; // [esp+28h] [ebp-38h]
  unsigned __int8 *v59; // [esp+2Ch] [ebp-34h]
  unsigned __int8 *v60; // [esp+30h] [ebp-30h]
  unsigned __int8 *v61; // [esp+34h] [ebp-2Ch]
  char *v62; // [esp+38h] [ebp-28h]
  int v63; // [esp+38h] [ebp-28h]
  unsigned int v64; // [esp+38h] [ebp-28h]
  unsigned int v65; // [esp+3Ch] [ebp-24h]
  unsigned int v66; // [esp+40h] [ebp-20h]
  unsigned int v67; // [esp+44h] [ebp-1Ch]
  unsigned __int8 *v68; // [esp+48h] [ebp-18h]
  char *v70; // [esp+50h] [ebp-10h]
  int v71; // [esp+54h] [ebp-Ch]
  unsigned int v72; // [esp+58h] [ebp-8h]
  unsigned __int8 *v73; // [esp+5Ch] [ebp-4h]
...
LABEL_89:
      ...
      *(_DWORD *)v15 = 2 * v16 + 1;
      ...
      if ( v55 + v57 + 4 * ((unsigned int)(v58 + 31 + XpressBuildHuffmanEncodings(a6 + 655360)) >> 5) + 258 >= a4 + a3 )
        return -1073741789;
      v70 = a6 + 674576;
      v53 = XpressDoHuffmanPass(v18, v55, v52);
      v54 = v52 == 0;
      v12 = a6;
      v55 = v53;
      if ( !v54 )
...
LABEL_34:
      ...
      v34 = v9 + 36;
      v35 = v9 + 4;
      if ( (unsigned int)v34 >= v65 )
      {
LABEL_45:
        if ( (unsigned int)v35 < v65 )
        {
          do
          {
            if ( *v35 != *(_BYTE *)v33 )
...
LABEL_73:
    ++v9;
    ++*(_DWORD *)&v12[4 * (unsigned __int8)v63 + 672272];
    v41 = 2 * v16;
    *v18++ = v63;
    v42 = v16 <= 0;
    goto LABEL_74;
