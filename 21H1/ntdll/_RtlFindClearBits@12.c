...
unsigned int __stdcall RtlFindClearBits(unsigned int *a1, unsigned int a2, unsigned int a3)
{
  unsigned int v3; // edx
  unsigned int v4; // esi
  unsigned int v5; // edi
