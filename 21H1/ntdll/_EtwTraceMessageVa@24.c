...
ULONG __stdcall EtwTraceMessageVa(__int64 a1, int a2, int *a3, __int16 a4, _DWORD *a5)
{
  int v5; // esi
  int v6; // ecx
  _DWORD *v7; // eax
  NTSTATUS v8; // eax
  _BYTE v10[4]; // [esp+10h] [ebp-30h] BYREF
  ...
  if ( (a1 & 0x1000000) != 0 )
    return EtwpTraceUmMessage(a1, HIDWORD(a1), a4, a5);
  v5 = 0;
  v6 = 0;
  if ( *a5 )
  {
