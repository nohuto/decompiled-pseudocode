...
int __fastcall RtlCSparseBitmapStart(int a1, unsigned int a2, int a3, int a4)
{
  int result; // eax
  unsigned int v6; // edi
  unsigned int v7; // ecx
  ...
  *(_DWORD *)(a1 + 8) = a2;
  ...
  if ( result >= 0 )
  {
    _BitScanForward(&v9, v12);
    *(_BYTE *)(a1 + 27) = v9;
    v10 = v11 <= 0x1000;
    *(_DWORD *)a1 = v6 + *(_DWORD *)(a1 + 4);
    if ( v10 )
    {
      result = RtlpHpEnvAllocVA((int)&v11, a1, (int)&savedregs, 0, 1073745920, 4, v8, v8, 0, v8);
      if ( result < 0 )
        return result;
      *(_DWORD *)(a1 + 32) = 1;
    }
