        ...
        int a9)
{
  ...
  int v49; // ebx
  int result; // eax
  unsigned __int8 *v51; // [esp+1Ch] [ebp-54h]
  unsigned __int8 *v52; // [esp+20h] [ebp-50h]
  unsigned int v53; // [esp+24h] [ebp-4Ch]
  int v54; // [esp+2Ch] [ebp-44h]
  int v56; // [esp+34h] [ebp-3Ch]
  int v58; // [esp+3Ch] [ebp-34h]
  int v59; // [esp+40h] [ebp-30h]
  unsigned int v60; // [esp+44h] [ebp-2Ch]
  _BYTE *v61; // [esp+48h] [ebp-28h]
  unsigned int v62; // [esp+48h] [ebp-28h]
  int v63; // [esp+48h] [ebp-28h]
  unsigned __int8 *v64; // [esp+4Ch] [ebp-24h]
  int v65; // [esp+50h] [ebp-20h]
  int v66; // [esp+50h] [ebp-20h]
  _BYTE *v67; // [esp+50h] [ebp-20h]
  unsigned __int8 *v68; // [esp+54h] [ebp-1Ch]
  unsigned __int8 *XpressCallback; // [esp+58h] [ebp-18h]
  _BYTE *v70; // [esp+5Ch] [ebp-14h]
  int *v71; // [esp+60h] [ebp-10h]
  int v72; // [esp+64h] [ebp-Ch]
  unsigned __int8 *v73; // [esp+68h] [ebp-8h]
  unsigned __int8 v74; // [esp+6Eh] [ebp-2h]
  unsigned __int8 v75; // [esp+6Fh] [ebp-1h]
  ...
  while ( 2 )
  {
    ...
    do
    {
      while ( 1 )
      {
        ...
        *(_DWORD *)(v18 + 8 * v19) = v9;
        if ( *v20 != *v9 || v20[1] != *v64 || v20[2] != v9[2] || v9 - v20 >= 0x10000 )
          goto LABEL_47;
        v21 = v9[3];
        v52 = v9;
        v61 = v9 + 3;
        ...
        {
          v65 = *v9 + 2 * v19;
          v22 = *(unsigned __int8 **)(a6 + 4 * (v65 + v21) + 11224);
          *(_DWORD *)(a6 + 4 * (v65 + v75) + 11224) = v20;
          ...
          v20 = v22;
          *(_DWORD *)(a6 + 4 * (v65 + HIBYTE(*(_DWORD *)v9)) + 11224) = v9;
        }
        v23 = v9[4];
        v24 = (char *)(v9 + 4);
        v70 = v9 + 4;
        ...
        {
          v66 = 2
              * ((unsigned __int8)__ROR1__(*v64 ^ __ROL1__(*v9 + *v61, 3), 1)
               + 4 * (unsigned __int8)__ROL1__(*v9 ^ __ROR1__(*v64 + v9[2] + 97, 1), 3));
          v25 = *(unsigned __int8 **)(a6 + 4 * (v66 + v23) + 11224);
...
LABEL_51:
          ...
          v26 = v9 + 4;
          if ( *(_DWORD *)v9 != *(_DWORD *)v25 || *v70 != v25[4] || v9 == v25 )
            goto LABEL_51;
          v20 = v25;
          v16 = v73;
          *(_DWORD *)(a6 + 4 * (v66 + (unsigned __int8)*v70) + 11224) = v9;
          v24 = (char *)(v9 + 4);
        }
        v67 = v9 + 5;
        v77 = v9[5];
        ...
        if ( v77 != v74 )
        {
          v54 = 2
              * ((v9[2] ^ (unsigned __int8)__ROL1__(*v9, *v24))
               + 4
               * ((unsigned __int8)__ROR1__(*v64 ^ __ROL1__(*v61, 3), 1)
                + (unsigned __int8)__ROL1__(*v24 ^ (__ROR1__(*v9, 1) + 69), 3)));
          v27 = *(unsigned __int8 **)(a6 + 4 * (v54 + v77) + 11224);
          *(_DWORD *)(a6 + 4 * (v54 + v74) + 11224) = v20;
...
LABEL_53:
          ...
          v28 = v9 + 5;
          if ( *v70 != v27[4] || *v67 != v27[5] || v9 == v27 )
            goto LABEL_53;
          v20 = v27;
          v16 = v73;
          *(_DWORD *)(a6 + 4 * (v54 + (unsigned __int8)*v67) + 11224) = v9;
        }
        v9 += 6;
        v29 = v20 + 6;
...
LABEL_45:
        v32 = v9 - v29;
        if ( v9 - v52 != 3 || v32 <= 0x1000 )
          break;
LABEL_47:
        v11 = a6;
        v9 = v64;
        ++*(_DWORD *)(a6 + 4 * *v51 + 47520);
        *v16++ = *v51;
        v73 = v16;
        v33 = 2 * v72;
        if ( v72 <= 0 )
...
LABEL_88:
    ...
    *v46 = 2 * v15 + 1;
    ...
    if ( v56 + v58 + 4 * ((unsigned int)(v59 + 31 + XpressBuildHuffmanEncodings(v11 + 30608)) >> 5) + 258 >= a4 + a3 )
      return -1073741789;
    v48 = XpressDoHuffmanPass(v16, v56, v63);
    v12 = (void *)(v11 + 47520);
    v49 = v48;
    v56 = v48;
    if ( !v63 )
