/*
 * XREFs of __ceil_pentium4 @ 0x4B2F8300
 * Callers:
 *     <none>
 * Callees:
...
double __cdecl _ceil_pentium4(const __m128i a1)
{
  ...
  v4 = _mm_sub_epi32((__m128i)xmmword_4B285E50, (__m128i)_mm_and_pd(v2, (__m128d)xmmword_4B285E70));
  ...
  else
  {
    ...
    v10 = *(_OWORD *)&_mm_cmpnle_pd(v9, v8);
    if ( v3 < 1023 )
    {
      a1.m128i_i64[0] = *(_OWORD *)&_mm_cmpnle_pd(v9, (__m128d)xmmword_4B285E60) & 0x3FF0000000000000LL;
      return *(double *)a1.m128i_i64;
    }
    else
    {
