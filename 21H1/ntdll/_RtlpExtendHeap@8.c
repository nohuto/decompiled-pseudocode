...
unsigned __int16 *__fastcall RtlpExtendHeap(int a1, unsigned int a2)
{
  unsigned int v2; // edi
  _BYTE *v4; // ebx
  int v5; // edi
  ...
  int HeapProtection; // [esp+10h] [ebp-18h]
  unsigned int v26; // [esp+18h] [ebp-10h] BYREF
  unsigned int v27; // [esp+1Ch] [ebp-Ch] BYREF
  int v28; // [esp+20h] [ebp-8h] BYREF
  unsigned int v29; // [esp+24h] [ebp-4h] BYREF

  v2 = a2;
  v4 = 0;
  v27 = (a2 + 4095) & 0xFFFFF000;
  if ( RtlpFindAndCommitPages(a1, &v27) )
  {
    v27 >>= 3;
    v5 = RtlpCoalesceFreeBlocks(&v27, 0);
    RtlpInsertFreeBlock(v27);
    if ( *(_DWORD *)(a1 + 76) )
    {
  ...
  v29 = (v9 + 0xFFFF) & 0xFFFF0000;
  if ( v29 >= 0xFD0000 )
    v29 = 16580608;
  HeapProtection = RtlpGetHeapProtection(a1, 1);
  v11 = NtAllocateVirtualMemory(-1, &v28, 0, &v29, 0x2000, HeapProtection);
  if ( v11 < 0 )
  {
    while ( 1 )
    {
  ...
  *(_DWORD *)(a1 + 100) += v12;
  v13 = a2 + 4096;
  if ( a2 + 4096 <= *(_DWORD *)(a1 + 104) )
    v13 = *(_DWORD *)(a1 + 104);
  v26 = v13;
  if ( RtlpHpHeapCheckCommitLimit(a1, a1 + 212) )
  {
    v15 = NtAllocateVirtualMemory(-1, &v28, 0, &v26, 4096, HeapProtection);
    if ( v15 >= 0 )
    {
      if ( !(unsigned __int8)RtlpInitializeHeapSegment(64, v14, 2, v28, v28 + v26, v28 + v29 - 4096) )
        v15 = -1073741801;
      if ( v15 >= 0 )
      {
        v16 = 2147353472;
        ...
        {
          RtlpLogHeapCommit(v26, 4);
          if ( RtlGetCurrentServiceSessionId() )
            v16 = (int)NtCurrentPeb()->SharedData + 550;
          RtlpLogHeapExtendEvent(v26, 8 * *(_DWORD *)(a1 + 116), *(unsigned __int8 *)v16);
        }
        v18 = 2147353482;
        if ( RtlGetCurrentServiceSessionId() )
        ...
        if ( *(_BYTE *)v19 )
        {
          ...
          RtlpLogHeapExtendEvent(v26, 8 * *(_DWORD *)(a1 + 116), *(unsigned __int8 *)v18);
        }
        if ( RtlGetCurrentServiceSessionId() )
          ...
          v21 = 2147353480;
        if ( *(_BYTE *)v21 )
          RtlpHeapLogRangeReserve(v29);
        v22 = *(_DWORD *)(v28 + 36);
        if ( *(_DWORD *)(a1 + 76) )
        {
          *(_DWORD *)v22 ^= *(_DWORD *)(a1 + 80);
          if ( *(_BYTE *)(v22 + 3) != (*(_BYTE *)v22 ^ (unsigned __int8)(*(_BYTE *)(v22 + 1) ^ *(_BYTE *)(v22 + 2))) )
            RtlpAnalyzeHeapFailure(v20);
        }
        return *(unsigned __int16 **)(v28 + 36);
      }
    }
    v2 = a2;
  }
  RtlpSecMemFreeVirtualMemory(v14, &v28, &v29, 0x8000);
LABEL_59:
  if ( *(char *)(a1 + 64) < 0 )
  {
    v23 = (unsigned __int16 *)RtlpCoalesceHeap(a1);
    v4 = v23;
    if ( v23 )
    {
      if ( *v23 >= v2 )
