...
char __fastcall RtlpOwnerAcesPresent(unsigned __int8 a1, int a2)
{
  ...
  __int16 v10; // [esp+10h] [ebp-18h]
  unsigned __int8 v11; // [esp+16h] [ebp-12h]
  unsigned __int8 v12; // [esp+17h] [ebp-11h]
  _WORD Buf2[4]; // [esp+18h] [ebp-10h] BYREF
  ...
  v2 = 0;
  v9 = 0;
  if ( RtlInitializeSid((int)Buf2, (int)&v9, 1u) < 0 )
    return 0;
  v14 = 4;
  if ( !a2 )
    return 0;
    ...
    if ( (v11 & 8) == 0 )
    {
      if ( ((v6 = *v4, (unsigned __int8)*v4 < 5u) || v6 > 8u) && (v6 < 0xBu || v6 > 0xCu) && (v6 < 0xFu || v6 > 0x10u) )
      {
        if ( v6 == 4 )
          ...
          v7 = v6 <= 0xAu || (unsigned __int8)(v6 - 13) <= 1u ? (unsigned __int8 *)(v4 + 8) : 0;
      }
      else
      {
        v7 = (unsigned __int8 *)&v4[16 * (*((_DWORD *)v4 + 2) & 1) + ((8 * (*((_DWORD *)v4 + 2) & 2)) | 0xC)];
      }
      if ( v7 && RtlEqualSid(v7, Buf2) && (!v12 || (v12 & v11) != 0) )
        break;
    }
    ++v2;
