...
int __fastcall TppWorkerFindTask(_DWORD *a1, int a2, int *a3)
{
  _DWORD *v3; // ebx
  ...
  _DWORD v53[3]; // [esp+4Ch] [ebp-10h] BYREF
  ...
  v50 = Group;
  v46 = TppNumberNodes;
  if ( !v47 || (v9 = v3[68], v7 = TppNumberNodes, !v9) )
...
LABEL_11:
  ...
  if ( v8 == v12 )
  {
    ...
    {
      *(_BYTE *)(a2 + 208) = 1;
      _InterlockedIncrement((volatile signed __int32 *)(v3[7] + 4 * v8));
    }
  }
  else
  {
    ...
    {
      if ( *(_BYTE *)(a2 + 208) )
        _InterlockedDecrement((volatile signed __int32 *)(v3[7] + 4 * v12));
      else
        *(_BYTE *)(a2 + 208) = 1;
      _InterlockedIncrement((volatile signed __int32 *)(v3[7] + 4 * v8));
    }
    *(_DWORD *)(a2 + 200) = v8;
    ...
    {
      v53[2] = 0;
      v53[1] = (unsigned __int16)v51;
      v53[0] = 0;
      ZwSetInformationThread(-2, 30, v53, 12);
      ZwSetInformationThread(-2, 13, &v44, 4);
      a2 = v45;
    }
  }
  v14 = v3[65];
  ...
  if ( v14 != -1 || *(_DWORD *)(a2 + 204) < 0x10u || TppAreNodeWorkersSteadyState(v3) )
  {
    ...
    do
    {
      ...
      v18 = (_DWORD *)*v17;
      v42 = v18;
      if ( (_DWORD *)v18[1] != v17 || (v19 = *v18, *(_DWORD **)(*v18 + 4) != v18) )
        __fastfail(3u);
      *v17 = v19;
      *(_DWORD *)(v19 + 4) = v17;
      v20 = _InterlockedCompareExchange(v17 + 2, 0, 1);
      if ( v20 != 1 )
      {
        while ( 1 )
        {
          v43 = v20 & 6;
          v32 = _InterlockedCompareExchange(v17 + 2, v20 + 4 * (v43 == 2) - 1, v20);
          if ( v32 == v20 )
            break;
          v20 = v32;
        }
...
LABEL_22:
  ...
  *v40 = v22;
  ...
  if ( v51 == v24 )
  {
    ...
    {
      *(_BYTE *)(v23 + 208) = 1;
      _InterlockedIncrement((volatile signed __int32 *)(v3[7] + 4 * v25));
    }
  }
  else
  {
    ...
    {
      if ( *(_BYTE *)(v23 + 208) )
        _InterlockedDecrement((volatile signed __int32 *)(v3[7] + 4 * v24));
      else
        *(_BYTE *)(v23 + 208) = 1;
      _InterlockedIncrement((volatile signed __int32 *)(v3[7] + 4 * v25));
    }
    ...
    *(_DWORD *)(v23 + 200) = v51;
    ...
    if ( (_WORD)v48 != (_WORD)v50 )
    {
      ...
      v52[0] = 0;
      ZwSetInformationThread(-2, 30, v52, 12);
      ZwSetInformationThread(-2, 13, &v39, 4);
    }
  }
  if ( v51 == v46 )
  {
