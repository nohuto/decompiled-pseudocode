...
int __thiscall RtlUnicodeStringToCountedOemString(void *this, unsigned __int16 *a2, PWCH *a3, char a4)
{
  unsigned int v4; // eax
  ...
  v4 = RtlxUnicodeStringToOemSize(this, a3) - 1;
  if ( !v4 )
  {
    *(_DWORD *)a2 = 0;
    *((_DWORD *)a2 + 1) = 0;
  ...
  *a2 = v4;
  ...
  v9 = 1;
  v7 = RtlUnicodeToOemN(*((_BYTE **)a2 + 1), *a2, &v8, a3[1], *(unsigned __int16 *)a3);
  v10 = v7;
  if ( v7 >= 0 )
  {
