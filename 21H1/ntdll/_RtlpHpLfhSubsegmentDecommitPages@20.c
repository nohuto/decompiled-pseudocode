...
int __fastcall RtlpHpLfhSubsegmentDecommitPages(int *a1, int a2, int a3, unsigned int a4, char a5)
{
  unsigned int v5; // ebx
  int v7; // esi
  int v8; // edi
  ...
  volatile signed __int32 *v22; // [esp-4h] [ebp-28h]
  ...
  if ( (RtlpHpLfhPerfFlags & 0x20) != 0 && !v9 )
  {
    ...
    {
      v11 = *(_DWORD *)(*(__int16 *)(result + 18) + result + 4) >> *(_BYTE *)(result + 7);
      if ( v11 <= 8 )
        v11 = 8;
      v12 = *(_DWORD *)(*(__int16 *)(result + 18) + result + 4) >> *(_BYTE *)(result + 8);
      if ( v12 <= 8 )
        v12 = 8;
      v13 = *(_DWORD *)(*(__int16 *)(result + 18) + result + 8) + *(_DWORD *)(*(__int16 *)(result + 18) + result + 12);
      v8 = v26;
      v23 = v13;
      if ( v13 > v11 )
      {
    ...
    do
    {
      ...
      if ( v23 >= a4 )
      {
        if ( v7 )
        {
          ...
          v16 = EmptyUnits << v15;
          v17 = v23 << v15;
          ((void (__thiscall *)(int, _DWORD, unsigned int, unsigned int))(v27 ^ RtlpHpHeapGlobals ^ *(_DWORD *)(v27 + 16)))(
            v27 ^ RtlpHpHeapGlobals ^ *(_DWORD *)(v27 + 16),
            *(_DWORD *)v27,
            v16 + v26,
            v23 << v15);
          v21 = v17;
          ...
          v20 = v16;
          v18 = v27;
          RtlpHpLfhSubsegmentDecBlockCounts(v27, v26, v20, v21, v19);
          if ( !v25 )
            goto LABEL_29;
          EmptyUnits = v23 + v28;
          v7 = v24;
        ...
        {
          if ( (a5 & 1) == 0 )
            RtlAcquireSRWLockShared((volatile signed __int32 *)(v27 + 68));
          v7 = 2;
          v24 = 2;
          RtlAcquireSRWLockExclusive((volatile signed __int32 *)(v8 + 12));
        }
      }
      else
      {
...
LABEL_29:
    ...
    if ( v24 )
    {
      v22 = (volatile signed __int32 *)(v8 + 12);
      if ( v24 == 2 )
        result = RtlReleaseSRWLockExclusive(v22);
      else
        result = RtlReleaseSRWLockShared(v22);
      if ( (a5 & 1) == 0 )
        return RtlReleaseSRWLockShared((volatile signed __int32 *)(v18 + 68));
    }
  }
  return result;
}
