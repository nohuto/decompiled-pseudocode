        ...
        unsigned int *a4)
{
  ...
  char *v32; // [esp+1Ch] [ebp-8h] BYREF
  _DWORD *v33; // [esp+20h] [ebp-4h] BYREF
  ...
  v5 = 1;
  v6 = 48;
  RtlpLocateActivationContextSectionForQuery(a2, a3, (int)a4, 0x30u, (int)this, (int)this, 1, (int)&v31, (int)&v29);
  if ( v32 == (char *)2 )
    return v30;
  result = RtlpCrackActivationContextStringSectionHeader(v7, &v32, v23, v24, v25, v26, v27, &v30, &v33);
  if ( result >= 0 )
  {
    v32 = (char *)this + this[6];
    v9 = (char *)this + *((_DWORD *)v32 + 3);
    v10 = *((_DWORD *)v32 + 2) == 1;
    if ( *((_DWORD *)v32 + 2) > 1u )
    {
      v11 = v9 + 24;
    ...
    else
    {
      ...
      if ( v6 <= a3 )
      {
        ...
        *((_DWORD *)a2 + 8) = v20 >> 1;
        if ( v12[5] )
        {
          memcpy(v16, (const void *)(v31 + v12[6]), v12[5]);
          v12 = (_DWORD *)v30;
          *((_DWORD *)a2 + 9) = v16;
          v21 = &v16[v12[5]];
          *(_WORD *)v21 = 0;
        ...
        if ( v12[10] )
        {
          memcpy(v16, (const void *)(v31 + v12[11]), v12[10]);
          *((_DWORD *)a2 + 10) = v16;
          v22 = &v16[*(_DWORD *)(v30 + 40)];
          *(_WORD *)v22 = 0;
          v16 = v22 + 2;
        }
        if ( v33[11] )
        {
          memcpy(v16, (char *)v33 + v33[12], v33[11]);
          *((_DWORD *)a2 + 11) = v16;
          *(_WORD *)&v16[v33[11]] = 0;
        }
        if ( a4 )
