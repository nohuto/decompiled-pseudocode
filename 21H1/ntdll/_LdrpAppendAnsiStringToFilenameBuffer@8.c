...
int __fastcall LdrpAppendAnsiStringToFilenameBuffer(unsigned __int16 *a1, STRING *a2)
{
  ...
  if ( a2->Length )
  {
    RtlMultiByteToUnicodeSize(&v9, a2->Buffer, a2->Length);
    FileNameBufferIfNeeded = LdrpAllocateFileNameBufferIfNeeded(a1, *a1 + v9 + 2);
