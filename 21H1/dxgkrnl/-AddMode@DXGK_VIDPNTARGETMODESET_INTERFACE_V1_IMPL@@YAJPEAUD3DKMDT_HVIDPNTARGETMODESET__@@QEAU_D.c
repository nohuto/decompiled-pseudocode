/*
 * XREFs of ?AddMode@DXGK_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTARGETMODESET__@@QEAU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C011B090
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _D3DKMDT_VIDPN_TARGET_MODE *const a3)
{
  ...
  _QWORD *v64; // [rsp+70h] [rbp+8h] BYREF
...
LABEL_20:
  if ( !DXGADAPTER::DriverSupportSetTimingsFromVidPn(*(DXGADAPTER **)(v19 + 16))
    || (v23 = 1, (*(_DWORD *)(*(_QWORD *)(v22 + 2672) + 440LL) & 1) != 0) )
  {
    v23 = 0;
  }
  v24 = v21 & 3;
  ...
  if ( v30 )
  {
    ...
    else
    {
      v64 = v30;
      v31 = 0LL;
      v38 = DMMVIDPNTARGETMODESET::AddMode(v14, &v64);
      v37 = v38;
      if ( v38 >= 0 )
      {
