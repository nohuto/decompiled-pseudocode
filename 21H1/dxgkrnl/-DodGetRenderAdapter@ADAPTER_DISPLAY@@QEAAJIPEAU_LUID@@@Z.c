/*
 * XREFs of ?DodGetRenderAdapter@ADAPTER_DISPLAY@@QEAAJIPEAU_LUID@@@Z @ 0x1C020DF28
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DodGetRenderAdapter(ADAPTER_DISPLAY *this, __int64 a2, struct _LUID *a3)
{
  ...
  v3 = (*(__int64 (__fastcall **)(_QWORD, __int64, struct _LUID *))(*((_QWORD *)this + 2) + 1944LL))(
         *(_QWORD *)(*((_QWORD *)this + 2) + 1864LL),
         a2,
         a3);
  v6 = v3;
  if ( v3 < 0 )
