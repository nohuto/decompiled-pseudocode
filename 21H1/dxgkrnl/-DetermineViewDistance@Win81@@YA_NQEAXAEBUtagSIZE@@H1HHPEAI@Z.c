/*
 * XREFs of ?DetermineViewDistance@Win81@@YA_NQEAXAEBUtagSIZE@@H1HHPEAI@Z @ 0x1C02AADBC
 * Callers:
 ...
 *     ?OemSpecifiedViewDist@Win81@@YAIQEAX@Z @ 0x1C02AB3E8 (-OemSpecifiedViewDist@Win81@@YAIQEAX@Z.c)
 */
