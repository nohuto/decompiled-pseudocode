/*
 * XREFs of DxgCreateContextAllocationCB @ 0x1C01431F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgCreateContextAllocationCB(unsigned int *a1)
{
  ...
  if ( v8 )
  {
    ...
    v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, _QWORD *, _QWORD, _QWORD, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 2680) + 640LL) + 8LL) + 656LL))(
            *(_QWORD *)(*(_QWORD *)(v7 + 2680) + 648LL),
            a1[20],
            *a1,
            v8,
            v11,
