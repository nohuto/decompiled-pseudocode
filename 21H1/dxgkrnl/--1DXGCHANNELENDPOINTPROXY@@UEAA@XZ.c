/*
 * XREFs of ??1DXGCHANNELENDPOINTPROXY@@UEAA@XZ @ 0x1C02ADC34
 * Callers:
 ...
 *     ?GetUsedEntryCount@HMGRTABLE@@QEAAIXZ @ 0x1C004B894 (-GetUsedEntryCount@HMGRTABLE@@QEAAIXZ.c)
      ...
      do
      {
        ...
        if ( (unsigned int)v11 < *((_DWORD *)v3 + 4) )
        {
          ...
          if ( ((v9 >> 25) & 0x60) == (v12 & 0x60) && (v12 & 0x2000) == 0 && (v12 & 0x1F) != 0 )
          {
            ...
            v14 = WdLogNewEntry5_WdError((v9 >> 25) & 0x60, v13);
            *(_QWORD *)(v14 + 24) = 267LL;
...
LABEL_14:
  ...
  DXGFASTMUTEX::~DXGFASTMUTEX((DXGCHANNELENDPOINTPROXY *)((char *)this + 72), a2);
