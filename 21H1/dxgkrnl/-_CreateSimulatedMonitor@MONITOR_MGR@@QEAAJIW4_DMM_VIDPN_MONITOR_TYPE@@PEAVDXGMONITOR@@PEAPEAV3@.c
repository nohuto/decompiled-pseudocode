/*
 * XREFs of ?_CreateSimulatedMonitor@MONITOR_MGR@@QEAAJIW4_DMM_VIDPN_MONITOR_TYPE@@PEAVDXGMONITOR@@PEAPEAV3@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02ED324
 * Callers:
  ...
  *v6 = 0LL;
  ...
  if ( a3 == 5 )
  {
    ...
    if ( !IsAnalogueVideoOutput(v19)
      && *(_BYTE *)(a1 + 3)
      && (!IsInternalVideoOutput(v21) || *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 8) + 16LL) + 2572LL) >= 1200) )
    {
