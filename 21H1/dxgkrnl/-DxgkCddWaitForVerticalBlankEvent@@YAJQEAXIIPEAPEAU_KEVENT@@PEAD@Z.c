/*
 * XREFs of ?DxgkCddWaitForVerticalBlankEvent@@YAJQEAXIIPEAPEAU_KEVENT@@PEAD@Z @ 0x1C0146C30
 * Callers:
 *     <none>
 * Callees:
        ...
        char *a5)
{
        ...
        (_DWORD)v12 == 1) )
  {
    v15 = v63;
    v72 = 1;
    v16 = (ADAPTER_DISPLAY **)((char *)v63 + 2672);
    v17 = (ADAPTER_DISPLAY *)*((_QWORD *)v63 + 334);
    if ( !v17 )
    {
    ...
    _InterlockedIncrement((volatile signed __int32 *)v15 + v22 + 676);
    v21 = *(_QWORD *)v20;
    v15 = v63;
LABEL_29:
    v18 = 1;
...
LABEL_47:
    ...
    if ( _InterlockedDecrement((volatile signed __int32 *)v63 + (unsigned int)v31 + 676) < 0 )
    {
      ...
      v51[3] = 275LL;
      v51[4] = 37LL;
      v51[6] = *((unsigned int *)v52 + v32 + 676);
      v51[7] = 0LL;
