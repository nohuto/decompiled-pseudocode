/*
 * XREFs of _lambda_4498cf4aa093f7a41b3920419f3e92d9_::operator() @ 0x1C02566FC
 * Callers:
 *     _lambda_4498cf4aa093f7a41b3920419f3e92d9_::_lambda_invoker_cdecl_ @ 0x1C0256300 (_lambda_4498cf4aa093f7a41b3920419f3e92d9_--_lambda_invoker_cdecl_.c)
 * Callees:
...
__int64 __fastcall lambda_4498cf4aa093f7a41b3920419f3e92d9_::operator()(__int64 a1, __int64 a2, unsigned int *a3)
{
  ...
  if ( (*(_DWORD *)(a2 + 348) & 0x100) != 0 && !*(_BYTE *)(a2 + 2585) && *(_DWORD *)(a2 + 200) == 1 )
  {
    LODWORD(v14) = 0;
