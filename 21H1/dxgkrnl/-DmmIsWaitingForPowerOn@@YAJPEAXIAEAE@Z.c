/*
 * XREFs of ?DmmIsWaitingForPowerOn@@YAJPEAXIAEAE@Z @ 0x1C016431C
 * Callers:
 ...
 *     ?IsPathFromSourcePoweredOff@DMMVIDPN@@QEBAEI@Z @ 0x1C016442C (-IsPathFromSourcePoweredOff@DMMVIDPN@@QEBAEI@Z.c)
 */
