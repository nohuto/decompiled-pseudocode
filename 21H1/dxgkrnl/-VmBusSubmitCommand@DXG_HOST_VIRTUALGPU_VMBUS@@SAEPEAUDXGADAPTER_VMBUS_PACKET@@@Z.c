/*
 * XREFs of ?VmBusSubmitCommand@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C024B7C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$CastToVmBusCommand@UDXGKVMB_COMMAND_SUBMITCOMMAND@@@@YAPEAUDXGKVMB_COMMAND_SUBMITCOMMAND@@PEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C003EA34 (--$CastToVmBusCommand@UDXGKVMB_COMMAND_SUBMITCOMMAND@@@@YAPEAUDXGKVMB_COMMAND_SUBMITCOMMAND@@PEA.c)
      ...
      if ( v11 - 408 >= (unsigned __int64)(unsigned int)v10 )
      {
        ...
        if ( v13 >= *(unsigned int *)(v9 + 320) )
        {
          ...
          *(_QWORD *)(v9 + 312) = (unsigned int)v10 + v9 + 408;
          ...
          v16 = DxgkSubmitCommandInternal((const struct _D3DKMT_SUBMITCOMMAND *)(v9 + 24), Current, v15);
LABEL_12:
