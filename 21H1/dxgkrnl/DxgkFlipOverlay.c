/*
 * XREFs of DxgkFlipOverlay @ 0x1C02771D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkFlipOverlay(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v36; // rcx
  __int64 v37; // r8
  struct DXGDEVICE *v38; // [rsp+20h] [rbp-E8h] BYREF
  int v39; // [rsp+28h] [rbp-E0h] BYREF
  __int64 v40; // [rsp+30h] [rbp-D8h]
  char v41; // [rsp+38h] [rbp-D0h]
  DXGDEVICE *v42; // [rsp+40h] [rbp-C8h] BYREF
  _QWORD v43[2]; // [rsp+48h] [rbp-C0h] BYREF
  _D3DKMT_FLIPOVERLAY v44; // [rsp+58h] [rbp-B0h] BYREF
  _BYTE v45[16]; // [rsp+78h] [rbp-90h] BYREF
  _BYTE v46[24]; // [rsp+88h] [rbp-80h] BYREF
  _BYTE v47[80]; // [rsp+A0h] [rbp-68h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v39, 2024LL);
...
LABEL_28:
  ...
  v44 = *v3;
  v42 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v38, v44.hDevice, (struct _KTHREAD **)Current, &v42);
...
LABEL_23:
  ...
  if ( v25 >= 0 )
  {
    ...
    DXGOVERLAYMUTEX::DXGOVERLAYMUTEX((DXGOVERLAYMUTEX *)v45, v13[2]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v45);
    v32 = DXGOVERLAY::FlipOverlay(v20, &v44);
    DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v45, v33);
    DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v45, v34);
