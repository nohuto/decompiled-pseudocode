/*
 * XREFs of ?_ProcessVidPnPath@CCD_BTL_ACTIVE_PATHS_COLLECTOR@@AEAAJPEAVDXGADAPTER@@PEAVDMMVIDPNPRESENTPATH@@_N2@Z @ 0x1C00EC88C
 * Callers:
        ...
        bool a5)
{
  ...
  bool IsVirtualModeSuportDisabled; // [rsp+50h] [rbp-30h]
...
LABEL_54:
  ...
  v58 = 0LL;
  MonitorInstance = MONITOR_MGR::_GetMonitorInstance(v19, v17, 1u, &v58);
        ...
        *(_QWORD *)v27 |= -(__int64)(ADAPTER_DISPLAY::IsVidPnSourceVisible(
        ...
        if ( v36 )
        {
          ...
          *(_QWORD *)v27 |= 0x40000000200uLL;
          if ( a5 )
          {
            SessionViewOwner = ADAPTER_DISPLAY::GetSessionViewOwner(*((ADAPTER_DISPLAY **)a2 + 334), *v28);
            *(_QWORD *)(v27 + 256) = SessionViewOwner;
            if ( SessionViewOwner )
            {
              v39 = 3968LL * *v28;
              v40 = *(_QWORD *)(*((_QWORD *)a2 + 334) + 112LL);
              ...
              *(_QWORD *)(v27 + 196) = SessionViewOwner[8];
            }
            *(_DWORD *)(v27 + 216) = *(_DWORD *)(3968LL * *v28 + *(_QWORD *)(*((_QWORD *)a2 + 334) + 112LL) + 3756);
