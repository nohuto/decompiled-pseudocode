/*
 * XREFs of ?CreateSyncObject@DXGGLOBAL@@QEAAJPEAVADAPTER_RENDER@@PEAVDXGDEVICE@@IPEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@_NPEAVDXGPAGINGQUEUE@@PEAPEAVDXGSYNCOBJECT@@PEAPEAVDXGDEVICESYNCOBJECT@@PEAIPEAPEAVDXGADAPTERSYNCOBJECT@@@Z @ 0x1C01120E0
 * Callers:
 ...
 *     ??0DXGADAPTERSYNCOBJECT@@QEAA@PEAVADAPTER_RENDER@@@Z @ 0x1C0112398 (--0DXGADAPTERSYNCOBJECT@@QEAA@PEAVADAPTER_RENDER@@@Z.c)
 *     ??0DXGSYNCOBJECT@@IEAA@PEAVDXGGLOBAL@@PEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@@Z @ 0x1C01123BC (--0DXGSYNCOBJECT@@IEAA@PEAVDXGGLOBAL@@PEAU_D3DDDI_SYNCHRONIZATIONOBJECTINFO2@@U_VIDSCH_SYNC_OBJE.c)
...
LABEL_6:
  ...
  {
    v14 = operator new[](0x150uLL, 0x4B677844u, (POOL_TYPE)512);
    v19 = v14;
    if ( v14 )
    {
...
LABEL_11:
  if ( v19 )
  {
    ...
    *((_BYTE *)v19 + 280) = v28;
    v29 = DXGSYNCOBJECT::Initialize((DXGSYNCOBJECT *)v19, a8);
    if ( v29 < 0 )
      goto LABEL_59;
...
LABEL_59:
    ...
    {
      DXGFASTMUTEX::Acquire((DXGFASTMUTEX *)(a1 + 352));
      v32 = (_QWORD *)(a1 + 392);
      v33 = *(_QWORD *)(a1 + 392);
      if ( *(_QWORD *)(v33 + 8) != a1 + 392 )
        __fastfail(3u);
      *(_QWORD *)v19 = v33;
      *((_QWORD *)v19 + 1) = v32;
      *(_QWORD *)(v33 + 8) = v19;
      *v32 = v19;
      if ( *(struct _KTHREAD **)(a1 + 368) != KeGetCurrentThread() )
      {
        v45 = WdLogNewEntry5_WdCriticalError(v33, v31);
        *(_QWORD *)(v45 + 24) = 275LL;
        *(_QWORD *)(v45 + 32) = 4LL;
        *(_QWORD *)(v45 + 40) = a1 + 352;
        *(_OWORD *)(v45 + 48) = 0LL;
      ...
      *(_DWORD *)(a1 + 376) = v35;
      ...
      {
        *(_QWORD *)(a1 + 368) = 0LL;
        ExReleasePushLockExclusiveEx(a1 + 352, 0LL);
      }
