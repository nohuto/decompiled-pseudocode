/*
 * XREFs of NtBindCompositionSurface @ 0x1C00026D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtBindCompositionSurface(void *a1, int a2, unsigned int a3, _OWORD *a4, _QWORD *a5)
{
  ...
  if ( v7 < 0 )
    goto LABEL_33;
  v7 = CCompositionSurface::Bind(v22, (const struct CSM_BUFFER_INFO *)v25, a2 != 0, 0, v23);
  if ( v7 < 0 )
    goto LABEL_33;
  v10 = 1;
  v17 = v25[111];
  if ( v25[111] )
  {
    ...
    if ( !(*(unsigned int (__fastcall **)(__int64, _QWORD, void *))(*((_QWORD *)Global + 38033) + 288LL))(v17, a3, a1) )
      v7 = -1073741790;
  }
  if ( v7 < 0 )
  {
