/*
 * XREFs of ?AdvancedColorPowerSettingsCallback@DXGGLOBAL@@SAJPEBU_GUID@@PEAXK1@Z @ 0x1C017DB00
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Context)
{
  ...
  {
    v7 = *Value != 0;
    if ( v7 != *((_BYTE *)DXGGLOBAL::GetGlobal(SettingGuid, (__int64)Value) + 304444) )
    {
      *((_BYTE *)DXGGLOBAL::GetGlobal(v9, v8) + 304444) = v7;
      v19 = 0;
