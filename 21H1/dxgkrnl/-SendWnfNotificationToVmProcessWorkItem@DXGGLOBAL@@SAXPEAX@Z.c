/*
 * XREFs of ?SendWnfNotificationToVmProcessWorkItem@DXGGLOBAL@@SAXPEAX@Z @ 0x1C02671A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DXGGLOBAL::SendWnfNotificationToVmProcessWorkItem(char *a1)
{
  ...
  if ( RtlCompareMemory(a1 + 80, &WNF_DX_VIDMM_TRIM_NOTIFICATION, 8uLL) == 8 )
  {
    ...
    v5 = (char *)Global + 320;
    v6 = (_QWORD **)((char *)Global + 1472);
    DXGPUSHLOCK::AcquireShared((struct DXGGLOBAL *)((char *)Global + 320));
