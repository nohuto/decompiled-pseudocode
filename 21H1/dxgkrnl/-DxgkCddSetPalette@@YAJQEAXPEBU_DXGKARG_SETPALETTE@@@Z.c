/*
 * XREFs of ?DxgkCddSetPalette@@YAJQEAXPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C0229B90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddSetPalette(struct DXGADAPTER *a1, const struct _DXGKARG_SETPALETTE *a2, __int64 a3)
{
  ...
  if ( PairingAdapters >= 0 )
  {
    ...
    v19 = COREADAPTERACCESS::AcquireExclusive((__int64)v39, 2LL, 0);
    v13 = v19;
    if ( v19 >= 0 )
    {
      if ( !v16[335] )
      ...
      ADAPTER_RENDER::FlushScheduler(v16[335], 6, 0xFFFFFFFF, 0);
      v13 = (int)ADAPTER_DISPLAY::DdiSetPalette(v17[334], a2, v26);
      ADAPTER_RENDER::FlushScheduler(v16[335], 7, 0xFFFFFFFF, 0);
      if ( (int)v13 < 0 )
      {
