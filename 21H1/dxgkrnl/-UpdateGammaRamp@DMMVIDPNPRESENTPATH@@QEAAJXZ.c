/*
 * XREFs of ?UpdateGammaRamp@DMMVIDPNPRESENTPATH@@QEAAJXZ @ 0x1C012B8C0
 * Callers:
 ...
 *     ?IsDefaultGammaRamp@DXGK_GAMMA_RAMP@@QEBAEXZ @ 0x1C012F238 (-IsDefaultGammaRamp@DXGK_GAMMA_RAMP@@QEBAEXZ.c)
...
__int64 __fastcall DMMVIDPNPRESENTPATH::UpdateGammaRamp(DMMVIDPNPRESENTPATH *this)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v8 + 16) + 2680LL) && v4 && DXGK_GAMMA_RAMP::IsDefaultGammaRamp((DXGK_GAMMA_RAMP *)v4) )
    v4 = 0LL;
  ...
  if ( v4 && (*(_DWORD *)(v14 + 2016) & 0x18) != 0 )
  {
    ...
    if ( (v23 == 12 || v23 == 32) && (*(_DWORD *)(v14 + 2016) & 0x10) != 0
      || v23 == 30 && (*(_DWORD *)(v14 + 2016) & 8) != 0 )
    {
