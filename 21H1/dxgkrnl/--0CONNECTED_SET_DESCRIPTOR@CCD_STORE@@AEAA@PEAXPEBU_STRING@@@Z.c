/*
 * XREFs of ??0CONNECTED_SET_DESCRIPTOR@CCD_STORE@@AEAA@PEAXPEBU_STRING@@@Z @ 0x1C0139B18
 * Callers:
 ...
 * Callees:
 *     ??0CCD_SET_STRING_ID@@QEAA@AEBU_STRING@@@Z @ 0x1C00E8158 (--0CCD_SET_STRING_ID@@QEAA@AEBU_STRING@@@Z.c)
