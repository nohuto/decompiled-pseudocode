/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_HOST_VIRTUALGPU_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C003F800
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( PoolWithTag )
  {
    ...
    v16 = ((__int64 (__fastcall *)(struct _LIST_ENTRY *))qword_1C00B0F68)(a1);
    v15[1].Parameter = 0LL;
