/*
 * XREFs of BmlFillPreferredMonitorMode @ 0x1C00E1B18
 * Callers:
 ...
 *     BmlIsLowResAnalogTvOutput @ 0x1C00E21C0 (BmlIsLowResAnalogTvOutput.c)
  ...
  while ( 1 )
  {
    ...
    if ( NextFrequencyRange == 1075708748 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          if ( v31 == 1 && (v29 || BmlIsEDIDCapableOutputTechonology(a3) && v8 >= 8) )
          {
            v8 = 11;
            v24 = v12;
          }
          if ( (unsigned __int8)BmlIsLowResAnalogTvOutput(a3) )
          {
            ...
            if ( v6 < 0x300 )
              v6 = 768;
            v20 = BmlCompareModeExtents(&qword_1C00793E8, &v24);
            v21 = v24;
            if ( v20 == 1 )
              v21 = 0x30000000400LL;
            v24 = v21;
...
LABEL_53:
  v11 = -1071774920;
LABEL_54:
  v22 = (_QWORD *)WdLogNewEntry5_WdError(v9, v7);
  v22[3] = v3;
  v22[4] = *(_QWORD *)(a3 + 112);
  v22[5] = v11;
