/*
 * XREFs of ?DisableMPOPlanes@ADAPTER_DISPLAY@@QEAAXIE@Z @ 0x1C020D6E0
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::DisableMPOPlanes(ADAPTER_DISPLAY *this, unsigned int a2, char a3)
{
  ...
  v4 = a2;
  v6 = *(_QWORD *)(*((_QWORD *)this + 2) + 2680LL);
  if ( v6 )
  {
    v7 = *(_QWORD *)(v6 + 16);
    for ( i = a3 == 0; i < *(_DWORD *)(v7 + 2512); ++i )
    {
      if ( ADAPTER_DISPLAY::IsPlaneEnabled(this, v4, i) )
      {
        ...
        v23 = v4;
        v25 = 1;
        if ( (*(int (__fastcall **)(_QWORD, int *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v12 + 2680) + 616LL) + 8LL)
                                                  + 824LL))(
               *(_QWORD *)(*(_QWORD *)(v12 + 2680) + 624LL),
               &v23) < 0 )
        {
      ...
      v7 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 2680LL) + 16LL);
    }
    if ( a3 )
    {
    ...
    else
    {
      ...
      if ( v16 )
      {
        ...
        if ( v17 == *(_QWORD *)(*(_QWORD *)(v16 + 16) + 16LL) )
          ADAPTER_DISPLAY::DisableOverlayPlanes(*(ADAPTER_DISPLAY **)(v17 + 2672), (unsigned int)v4);
      }
    }
  }
}
