/*
 * XREFs of ?CheckDevicePresentSettings@DXGCONTEXT@@QEAAJHHI@Z @ 0x1C0145B60
 * Callers:
...
__int64 __fastcall DXGCONTEXT::CheckDevicePresentSettings(DXGCONTEXT *this, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  v7 = a3;
  v8 = a2;
  v9 = *(_QWORD *)(*(_QWORD *)(v4 + 1848) + 2672LL);
  v10 = *(_QWORD *)(v9 + 16);
  ...
  else
  {
    ...
    if ( *(_BYTE *)(*(_QWORD *)(v18 + 40) + 346LL) )
    {
      if ( (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(
                           *(ADAPTER_DISPLAY **)(*(_QWORD *)(v18 + 1848) + 2672LL),
                           (unsigned int)v6) == 1 )
      {
        v26 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 1848LL) + 2672LL) + 112LL)
                        + 3968 * v6
                        + 712);
        if ( *(_BYTE *)(v26 + 346) )
        {
