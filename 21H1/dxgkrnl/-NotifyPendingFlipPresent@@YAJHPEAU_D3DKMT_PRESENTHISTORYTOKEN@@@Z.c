/*
 * XREFs of ?NotifyPendingFlipPresent@@YAJHPEAU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x1C000C5F0
 * Callers:
 *     ?DxgkQuerySwapChainBindingStatus@@YAJHPEAU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x1C000C0C4 (-DxgkQuerySwapChainBindingStatus@@YAJHPEAU_D3DKMT_PRESENTHISTORYTOKEN@@@Z.c)
 * Callees:
...
LABEL_91:
      ...
      if ( (a2->Token.Flip.Flags.Value & 0x2000000) == 0 )
      {
        if ( !DXGGLOBAL::m_pGlobal )
        {
          ...
          *(_QWORD *)(v51 + 24) = 2219LL;
          WdLogEvent5_WdAssertion(v51);
        }
        (*(void (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 208LL))();
        if ( !DXGGLOBAL::m_pGlobal )
        {
          v52 = WdLogNewEntry5_WdAssertion(v26, v25);
          *(_QWORD *)(v52 + 24) = 2219LL;
          WdLogEvent5_WdAssertion(v52);
        }
        v29 = (*(__int64 (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 240LL))();
        if ( v13 )
        {
          v67 = 0;
          if ( !DXGGLOBAL::m_pGlobal )
          {
            ...
            *(_QWORD *)(v53 + 24) = 2219LL;
            WdLogEvent5_WdAssertion(v53);
          }
          if ( (*(unsigned int (__fastcall **)(__int64, int *))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 248LL))(
                 v13,
                 &v67) )
          {
            if ( !v68 || v29 )
...
LABEL_94:
          ...
          else
          {
            v5 = -1071775729;
               ...
               || (Global = DXGGLOBAL::GetGlobal(v28, v27),
                   !(*(unsigned int (**)(void))(*((_QWORD *)Global + 38033) + 224LL))()) )
        {
          v5 = -1071775730;
        }
        if ( !DXGGLOBAL::m_pGlobal )
        {
          ...
          *(_QWORD *)(v55 + 24) = 2219LL;
          WdLogEvent5_WdAssertion(v55);
        }
        (*(void (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 256LL))();
      }
      if ( v5 < 0 )
      {
LABEL_96:
      ...
      else
      {
        ...
        if ( v5 >= 0 )
        {
          ...
          if ( !DXGGLOBAL::m_pGlobal )
          {
            ...
            *(_QWORD *)(v56 + 24) = 2219LL;
            WdLogEvent5_WdAssertion(v56);
          }
          if ( !(*(unsigned int (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 232LL))() )
          {
            if ( !DXGGLOBAL::m_pGlobal )
            {
              v57 = WdLogNewEntry5_WdAssertion(v37, v36);
              *(_QWORD *)(v57 + 24) = 2219LL;
              WdLogEvent5_WdAssertion(v57);
            }
            if ( !(*(unsigned int (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 136LL))() )
            {
              if ( !DXGGLOBAL::m_pGlobal )
              {
              ...
              (*(void (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 144LL))();
              v35 = 1;
            }
          }
          if ( !DXGGLOBAL::m_pGlobal )
          {
            ...
            *(_QWORD *)(v59 + 24) = 2219LL;
            WdLogEvent5_WdAssertion(v59);
          }
          v38 = (struct _KPROCESS *)(*(__int64 (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 272LL))();
          v41 = v38;
          if ( v38 )
          {
            ...
            if ( !DXGGLOBAL::m_pGlobal )
            {
              ...
              *(_QWORD *)(v60 + 24) = 2219LL;
              WdLogEvent5_WdAssertion(v60);
            }
            (*(void (__fastcall **)(struct _KPROCESS *))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 200LL))(v41);
          }
          else
          {
            v5 = -1073741823;
          ...
          if ( v35 )
          {
            if ( !DXGGLOBAL::m_pGlobal )
            {
              ...
              *(_QWORD *)(v61 + 24) = 2219LL;
              WdLogEvent5_WdAssertion(v61);
            }
            (*(void (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 184LL))();
          }
          if ( v5 >= 0 )
          {
            ...
            *((_QWORD *)&a2->Token.SurfaceComplete + 7) = v6[3];
            if ( v18 )
            {
              ...
              *(_QWORD *)(v62 + 24) = 2219LL;
              WdLogEvent5_WdAssertion(v62);
            }
            (*(void (__fastcall **)(union _D3DKMT_PRESENTHISTORYTOKEN::$04C5B4CD591473CAB2C95D87D2CBE864 *, _QWORD))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 40LL))(
              &a2->Token,
              0LL);
            ...
            if ( !DXGGLOBAL::m_pGlobal )
            {
              ...
              *(_QWORD *)(v63 + 24) = 2219LL;
              WdLogEvent5_WdAssertion(v63);
            }
            (*(void (__fastcall **)(struct _D3DKMT_PRESENTHISTORYTOKEN *, _QWORD *, _QWORD, _QWORD, __int64, UINT64, LONG, UINT, UINT))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 104LL))(
              a2,
              v6,
