/*
 * XREFs of ?NotifyPendingFlipManagerPresent@@YAJHPEAU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x1C0063440
 * Callers:
...
__int64 __fastcall NotifyPendingFlipManagerPresent(__int64 a1, struct _D3DKMT_PRESENTHISTORYTOKEN *a2)
{
  ...
  (*(void (**)(void))(*((_QWORD *)Global + 38033) + 208LL))();
  v9 = DXGGLOBAL::GetGlobal(v8, v7);
  v10 = (*(__int64 (**)(void))(*((_QWORD *)v9 + 38033) + 240LL))();
  if ( !v5
    || v10
    || !(unsigned int)IsTokenManagerReady()
    || (v13 = DXGGLOBAL::GetGlobal(v12, v11), !(*(unsigned int (**)(void))(*((_QWORD *)v13 + 38033) + 224LL))()) )
  {
    v3 = -1071775730;
  }
  v14 = DXGGLOBAL::GetGlobal(v12, v11);
  (*(void (**)(void))(*((_QWORD *)v14 + 38033) + 256LL))();
  if ( v3 >= 0 )
  {
    Object = 0LL;
