/*
 * XREFs of ?Create@DxgkCompositionObject@@KAJDPEAU_OBJECT_ATTRIBUTES@@KDW4DxgkCompositionObjectType@@KP6AJPEAV1@PEAXPEAPEAVIDxgkCompositionObject@@@Z3PEAPEAX@Z @ 0x1C00183AC
 * Callers:
 *     NtCreateCompositionSurfaceHandle @ 0x1C00185B0 (NtCreateCompositionSurfaceHandle.c)
 ...
 *     ?Create@CompositionSurfaceObject@@SAJDPEAU_OBJECT_ATTRIBUTES@@KDPEAPEAX@Z @ 0x1C0063E84 (-Create@CompositionSurfaceObject@@SAJDPEAU_OBJECT_ATTRIBUTES@@KDPEAPEAX@Z.c)
 *     NtFlipObjectCreate @ 0x1C00675E0 (NtFlipObjectCreate.c)
