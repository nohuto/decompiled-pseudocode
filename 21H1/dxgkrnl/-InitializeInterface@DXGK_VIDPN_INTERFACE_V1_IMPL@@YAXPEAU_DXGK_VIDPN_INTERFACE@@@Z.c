/*
 * XREFs of ?InitializeInterface@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAXPEAU_DXGK_VIDPN_INTERFACE@@@Z @ 0x1C017CC44
 * Callers:
        ...
        struct _DXGK_VIDPN_INTERFACE *a2)
{
  ...
  *((_QWORD *)this + 9) = DXGK_VIDPN_INTERFACE_V1_IMPL::CreateNewTargetModeSet;
  *((_QWORD *)this + 7) = DXGK_VIDPN_INTERFACE_V1_IMPL::AcquireTargetModeSet;
