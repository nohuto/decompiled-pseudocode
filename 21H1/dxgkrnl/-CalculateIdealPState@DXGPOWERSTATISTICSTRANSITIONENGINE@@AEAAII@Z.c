/*
 * XREFs of ?CalculateIdealPState@DXGPOWERSTATISTICSTRANSITIONENGINE@@AEAAII@Z @ 0x1C0045998
 * Callers:
        ...
        unsigned int a2)
{
  ...
  v4 = *v2;
  LODWORD(v5) = *v2;
  v6 = a2 * (unsigned __int64)v2[*((unsigned int *)this + 14) + 1] / *(unsigned int *)(*(_QWORD *)this + 4196LL);
  if ( !*v2 )
    return 0LL;
  while ( 1 )
  {
