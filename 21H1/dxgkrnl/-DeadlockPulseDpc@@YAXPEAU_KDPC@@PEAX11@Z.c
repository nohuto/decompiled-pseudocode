/*
 * XREFs of ?DeadlockPulseDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C00353A0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( UnbiasedInterruptTime - v6 > 10000 * (unsigned __int64)(v8 - *((_DWORD *)DeferredContext + 4))
    && v6 == _InterlockedCompareExchange64((volatile signed __int64 *)(v4 + 4384), UnbiasedInterruptTime, v6) )
  {
    if ( (unsigned int)dword_1C00AEA90 > 5 && tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000004000LL) )
    {
      LOBYTE(v10) = 1;
      IsDebuggerPresent = (unsigned __int8)WdIsDebuggerPresent(v10);
      v16 = *(_DWORD *)(v4 + 2768);
      v17 = *(unsigned __int8 *)(v4 + 2622);
      v18 = *(_DWORD *)(v4 + 4440);
      v19 = *(_DWORD *)(v4 + 4436);
      v20 = *(unsigned __int8 *)(v4 + 209);
      v21 = *(unsigned __int8 *)(v4 + 2516);
      v22 = *(unsigned __int8 *)(v4 + 2511);
      v23 = *(_DWORD *)(v4 + 280);
      v36 = *(_WORD *)(v4 + 2572);
      v31 = *(_QWORD *)(v4 + 1576);
      v32 = *(void **)(v4 + 1568);
