/*
 * XREFs of ?UpdateGammaRamp@ADAPTER_DISPLAY@@QEAAJI@Z @ 0x1C012A464
 * Callers:
 ...
 *     ColorSpaceTransformInitIdentityTransform @ 0x1C0060540 (ColorSpaceTransformInitIdentityTransform.c)
 ...
 *     ?AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x1C020C7C8 (-AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUS.c)
 */
...
LABEL_11:
      ...
      LODWORD(v8) = ADAPTER_RENDER::SuspendScheduler(*((ADAPTER_RENDER **)this[2] + 335), 0, 0);
      if ( (int)v8 < 0 )
      {
      ...
      {
LABEL_16:
        LODWORD(v8) = DmmUpdateGammaRampOnVidPnSource(this[2], (unsigned int)v3, (const struct DXGK_GAMMA_RAMP *)v11);
        v38 = 0;
        v17 = 0;
        while ( 1 )
        {
          v18 = DmmEnumClientVidPnPathTargetsFromSource(this[2], (unsigned int)v3, v17++, &v38);
          if ( v18 < 0 )
            break;
          v19 = v38;
          if ( v38 == -1 )
            break;
          v20 = MonitorNotifyDXGIGammaRampChange(this[2], v38);
          v8 = v20;
          if ( v20 < 0 )
          {
        ...
        if ( *((_BYTE *)this + 251) && DXGADAPTER::IsFullWDDMAdapter(this[2]) )
          ADAPTER_RENDER::ResumeScheduler(*(ADAPTER_RENDER **)(v23 + 2680), 0, 0);
      }
      goto LABEL_24;
    }
LABEL_9:
