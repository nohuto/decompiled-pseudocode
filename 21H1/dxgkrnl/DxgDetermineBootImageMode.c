/*
 * XREFs of DxgDetermineBootImageMode @ 0x1C017EC3C
 * Callers:
...
LABEL_8:
      if ( a3 )
      {
        *((_DWORD *)DXGGLOBAL::GetGlobal(v17, v16) + 318) = 1;
      ...
      else
      {
        ...
        *(_OWORD *)((char *)Global + 1288) = *(_OWORD *)a1;
        *(_OWORD *)((char *)Global + 1304) = *(_OWORD *)(a1 + 16);
        v22 = *a2;
        *((_QWORD *)DXGGLOBAL::GetGlobal(v24, v23) + 160) = v22;
        v25 = a2[2];
        *((_QWORD *)DXGGLOBAL::GetGlobal(v27, v26) + 173) = v25;
        *((_DWORD *)DXGGLOBAL::GetGlobal(v29, v28) + 318) = 1;
...
LABEL_22:
  ...
  *((_DWORD *)DXGGLOBAL::GetGlobal(v17, v16) + 318) = 3;
