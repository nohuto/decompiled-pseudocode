/*
 * XREFs of DpiPdoPollingWorkItem @ 0x1C02D4A20
 * Callers:
 ...
 *     DpiFdoInvalidateChildStatus @ 0x1C02C678C (DpiFdoInvalidateChildStatus.c)
 */
...
void __fastcall DpiPdoPollingWorkItem(PDEVICE_OBJECT DeviceObject, PVOID Context)
{
  ...
  while ( 1 )
  {
    ...
    {
      v4 = 0LL;
      _InterlockedExchange(&dword_1C00AFC98, 0);
    }
    else
    {
...
LABEL_21:
    ...
    ExFreeToNPagedLookasideList(&stru_1C00AFB00, v4);
    if ( v3 == 259 )
    {
      _InterlockedExchange(&dword_1C00AFC98, 0);
