/*
 * XREFs of ?GetSurfaceUpdates@CCompositionFrame@@UEAA_NPEAUCSM_SURFACE_UPDATE@@IPEAI@Z @ 0x1C0003890
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  CCompositionFrame *v37; // rcx
  int v38; // [rsp+20h] [rbp-68h]
  CPushLock *v39; // [rsp+28h] [rbp-60h]
...
LABEL_32:
            ...
            {
              v40 = 0LL;
              v38 = (*(__int64 (__fastcall **)(CPushLock *, __int64 *))(*(_QWORD *)v39 + 216LL))(v39, &v40);
              if ( v38 >= 0 )
              {
                *(_DWORD *)a2 = 200;
                *(_QWORD *)((char *)a2 + 4) = *(_QWORD *)(v19 + 24);
                *((_QWORD *)a2 + 2) = *((_QWORD *)v39 + 2);
                *((_DWORD *)a2 + 6) = *(_DWORD *)(v40 + 28);
                *((_DWORD *)a2 + 7) = *((_DWORD *)v39 + 61);
                (*(void (__fastcall **)(_QWORD, char *))(**((_QWORD **)v39 + 31) + 56LL))(
                  *((_QWORD *)v39 + 31),
                  (char *)a2 + 32);
                *(_OWORD *)((char *)a2 + 40) = *((_OWORD *)v39 + 16);
                *((_QWORD *)a2 + 7) = *((_QWORD *)v39 + 34);
                *((_DWORD *)a2 + 16) = *((_DWORD *)v39 + 70);
                v27 = *((_OWORD *)v39 + 3);
                *((_DWORD *)v39 + 64) = 0;
                *((_BYTE *)v39 + 42) = 0;
                *(_OWORD *)((char *)a2 + 72) = v27;
                *(_OWORD *)((char *)a2 + 88) = *((_OWORD *)v39 + 4);
                *(_OWORD *)((char *)a2 + 104) = *((_OWORD *)v39 + 5);
                *(_OWORD *)((char *)a2 + 120) = *((_OWORD *)v39 + 6);
                *(_OWORD *)((char *)a2 + 136) = *((_OWORD *)v39 + 7);
                *(_OWORD *)((char *)a2 + 152) = *((_OWORD *)v39 + 8);
                *(_OWORD *)((char *)a2 + 168) = *((_OWORD *)v39 + 9);
                *((_QWORD *)a2 + 23) = *((_QWORD *)v39 + 20);
                *((_DWORD *)a2 + 48) = (*(__int64 (__fastcall **)(CPushLock *))(*(_QWORD *)v39 + 176LL))(v39);
                goto LABEL_32;
              }
            }
          }
...
LABEL_37:
  ...
  while ( a3 )
  {
      ...
      if ( (int)CPushLock::AcquireLockShared((CPushLock *)(v31 + 6)) >= 0 )
      {
        ...
        if ( SurfaceUpdate >= 0 )
        {
          ...
          if ( (*(unsigned int (__fastcall **)(_DWORD *))(*(_QWORD *)v34 + 64LL))(v34) == 1 )
          {
            ...
            (*(void (__fastcall **)(_QWORD *, _QWORD))(*((_QWORD *)Global + 38033) + 64LL))(v31, v35);
          }
          a2 = (struct CSM_SURFACE_UPDATE *)((char *)a2 + 200);
          --a3;
          ++v4;
    ...
    v37 = *(CCompositionFrame **)(*((_QWORD *)v8 + 15) + 8LL);
    if ( v37 == (CCompositionFrame *)((char *)v8 + 144) )
    {
      v9 = 0LL;
      *((_BYTE *)v8 + 136) = 0;
      result = 0;
