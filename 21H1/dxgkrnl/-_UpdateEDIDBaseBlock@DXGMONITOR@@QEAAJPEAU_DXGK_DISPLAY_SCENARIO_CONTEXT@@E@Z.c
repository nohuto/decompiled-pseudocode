/*
 * XREFs of ?_UpdateEDIDBaseBlock@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@E@Z @ 0x1C016A258
 * Callers:
        ...
        char a3)
{
  ...
  if ( v3 && *((_DWORD *)this + 32) )
  {
    ...
    v12 = (EDIDCACHE *)*((_QWORD *)DXGGLOBAL::GetGlobal(v10, v8) + 112);
    if ( v12 )
    ...
    *(_QWORD *)(v17 + 24) = v5;
    ...
    if ( v7 )
    {
      *((_QWORD *)v5 + 18) = v7;
      ...
      if ( !*((_BYTE *)DXGGLOBAL::GetGlobal(v30, v29) + 304201) && !*((_DWORD *)v5 + 148) )
      {
        v44 = 1;
        v47 = 0;
        LOBYTE(v46) = 1;
