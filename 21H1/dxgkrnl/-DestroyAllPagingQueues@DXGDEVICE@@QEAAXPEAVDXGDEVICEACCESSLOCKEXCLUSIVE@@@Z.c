/*
 * XREFs of ?DestroyAllPagingQueues@DXGDEVICE@@QEAAXPEAVDXGDEVICEACCESSLOCKEXCLUSIVE@@@Z @ 0x1C00DD490
 * Callers:
            ...
            if ( i )
            {
              ...
              if ( !v19 )
              {
                ...
                if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v20 + 16) + 16LL) + 200LL) != 4 )
                  DXGDEVICE::DestroyPagingQueue((PERESOURCE *)v20, (struct DXGPAGINGQUEUE *)i, v24);
