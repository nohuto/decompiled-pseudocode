/*
 * XREFs of ?GetMmioSpaceInfo@DXG_GUEST_GLOBAL_VMBUS@@QEAAJPEA_K0@Z @ 0x1C0236524
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  ((void (__fastcall *)(_QWORD))qword_1C00B0F60)(*(_QWORD *)this);
  v8 = *((_QWORD *)DXGGLOBAL::GetGlobal(v6, v5) + 189);
  if ( *a3 >= v8 && *a2 )
    return 0LL;
  v10 = WdLogNewEntry5_WdError(v8, v7);
  *(_QWORD *)(v10 + 24) = 11706LL;
