/*
 * XREFs of ??0DXGMONITOR@@AEAA@PEAVMONITOR_MGR@@@Z @ 0x1C0167238
 * Callers:
 ...
 * Callees:
 *     ?DisplayID_Initialize@@YAXPEAUDisplayIDObj@@PEBXI@Z @ 0x1C00210C4 (-DisplayID_Initialize@@YAXPEAUDisplayIDObj@@PEBXI@Z.c)
