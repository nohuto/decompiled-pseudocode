/*
 * XREFs of ??1DXGK_VIRTUAL_GPU_PARAV@@UEAA@XZ @ 0x1C003E554
 * Callers:
 *     ??_EDXGK_VIRTUAL_GPU_PARAV@@UEAAPEAXI@Z @ 0x1C003E5E0 (--_EDXGK_VIRTUAL_GPU_PARAV@@UEAAPEAXI@Z.c)
 * Callees:
 *     ??_GCDriverStoreCopy@@QEAAPEAXI@Z @ 0x1C003E5AC (--_GCDriverStoreCopy@@QEAAPEAXI@Z.c)
 */
