/*
 * XREFs of ?_GetColorPrimariesType@DXGMONITOR@@AEAA?AW4ColorPrimaryType@1@XZ @ 0x1C016C1F4
 * Callers:
 *     ?_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ @ 0x1C016C134 (-_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ.c)
 * Callees:
 *     ?_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z @ 0x1C016C478 (-_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z.c)
 *     ?_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z @ 0x1C016C534 (-_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z.c)
 */
