/*
 * XREFs of DxgPresentDisplayOnlyProgressCB @ 0x1C00408F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?PresentDisplayOnlySetProgress@DXGDODPRESENT@@QEAAXPEBU_DXGKARGCB_PRESENT_DISPLAYONLY_PROGRESS@@@Z @ 0x1C005D27C (-PresentDisplayOnlySetProgress@DXGDODPRESENT@@QEAAXPEBU_DXGKARGCB_PRESENT_DISPLAYONLY_PROGRESS@@.c)
 */
...
void __fastcall DxgPresentDisplayOnlyProgressCB(__int64 a1, const struct _DXGKARGCB_PRESENT_DISPLAYONLY_PROGRESS *a2)
{
  ...
  v5 = *(DXGDODPRESENT **)(*(_QWORD *)(DpiGetDxgAdapter(a1, v4) + 2672) + 384LL);
  if ( v5 )
