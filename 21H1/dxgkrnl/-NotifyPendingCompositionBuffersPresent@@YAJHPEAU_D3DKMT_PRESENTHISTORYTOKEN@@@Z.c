/*
 * XREFs of ?NotifyPendingCompositionBuffersPresent@@YAJHPEAU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x1C000C100
 * Callers:
...
__int64 __fastcall NotifyPendingCompositionBuffersPresent(__int64 a1, struct _D3DKMT_PRESENTHISTORYTOKEN *a2)
{
  ...
  if ( !DXGGLOBAL::m_pGlobal )
  {
    ...
    *(_QWORD *)(v33 + 24) = 2219LL;
    WdLogEvent5_WdAssertion(v33);
  }
  v8 = (*(__int64 (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 240LL))();
  if ( !v4 || v8 )
    goto LABEL_59;
  if ( !DXGGLOBAL::m_pGlobal )
  {
    v34 = WdLogNewEntry5_WdAssertion(v10, v9);
    *(_QWORD *)(v34 + 24) = 2219LL;
  ...
  if ( !DXGGLOBAL::m_pGlobal )
  {
    ...
    *(_QWORD *)(v35 + 24) = 2219LL;
    WdLogEvent5_WdAssertion(v35);
  }
  if ( !(*(unsigned int (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 224LL))() )
LABEL_59:
    v5 = -1071775730;
  if ( !DXGGLOBAL::m_pGlobal )
  {
    v36 = WdLogNewEntry5_WdAssertion(v10, v9);
    *(_QWORD *)(v36 + 24) = 2219LL;
    ...
    if ( v5 >= 0 )
    {
      ...
      if ( v5 >= 0 )
      {
        ...
        if ( !DXGGLOBAL::m_pGlobal )
        {
          ...
          *(_QWORD *)(v40 + 24) = 2219LL;
          WdLogEvent5_WdAssertion(v40);
        }
        v24 = (struct _KPROCESS *)(*(__int64 (**)(void))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 272LL))();
        v27 = v24;
        if ( v24 )
        {
          ...
          if ( !DXGGLOBAL::m_pGlobal )
          {
            ...
            *(_QWORD *)(v41 + 24) = 2219LL;
            WdLogEvent5_WdAssertion(v41);
          }
          (*(void (__fastcall **)(struct _KPROCESS *))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 200LL))(v27);
        }
        else
        {
          v5 = -1073741823;
        ...
        if ( v5 >= 0 )
        {
          ...
          if ( !DXGGLOBAL::m_pGlobal )
          {
            ...
            *(_QWORD *)(v43 + 24) = 2219LL;
            WdLogEvent5_WdAssertion(v43);
          }
          (*(void (__fastcall **)(_QWORD *, _QWORD))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 32LL))(v30, 0LL);
