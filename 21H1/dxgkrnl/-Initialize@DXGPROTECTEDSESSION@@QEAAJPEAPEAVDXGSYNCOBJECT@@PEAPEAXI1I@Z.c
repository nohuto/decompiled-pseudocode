/*
 * XREFs of ?Initialize@DXGPROTECTEDSESSION@@QEAAJPEAPEAVDXGSYNCOBJECT@@PEAPEAXI1I@Z @ 0x1C0283D10
 * Callers:
 ...
 *     ?AddReference@DXGPROTECTEDSESSION@@QEAAJ_N@Z @ 0x1C0045718 (-AddReference@DXGPROTECTEDSESSION@@QEAAJ_N@Z.c)
