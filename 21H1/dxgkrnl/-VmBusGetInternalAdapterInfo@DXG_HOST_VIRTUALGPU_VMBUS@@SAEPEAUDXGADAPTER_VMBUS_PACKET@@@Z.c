/*
 * XREFs of ?VmBusGetInternalAdapterInfo@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023DA60
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusGetInternalAdapterInfo(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *(_BYTE *)(v4 + 165) )
  {
    ...
    *(_BYTE *)(v7 + 298) = 0;
    ...
    v15[1] = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 5) + 16LL) + 2636LL);
