/*
 * XREFs of ?CreateKeyedMutex@DXGGLOBAL@@QEAAJ_KU_D3DKMT_CREATEKEYEDMUTEX2_FLAGS@@IPEAPEAVDXGKEYEDMUTEX@@@Z @ 0x1C028B5E4
 * Callers:
 ...
 *     ??_GDXGKEYEDMUTEX@@QEAAPEAXI@Z @ 0x1C0047354 (--_GDXGKEYEDMUTEX@@QEAAPEAXI@Z.c)
  ...
  *a5 = 0LL;
  ...
  if ( v15 )
  {
    ...
    if ( v18 >= 0 )
    {
      ...
      DXGFASTMUTEX::Acquire((DXGGLOBAL *)((char *)this + 416));
      v21 = (DXGKEYEDMUTEX **)((char *)this + 456);
      v22 = *((_QWORD *)this + 57);
      if ( *(DXGGLOBAL **)(v22 + 8) != (DXGGLOBAL *)((char *)this + 456) )
        __fastfail(3u);
      *(_QWORD *)v15 = v22;
      *((_QWORD *)v15 + 1) = v21;
      *(_QWORD *)(v22 + 8) = v15;
      *v21 = v15;
      DXGFASTMUTEX::Release((struct _KTHREAD **)this + 52, v20);
      *a5 = v15;
    }
    else
    {
