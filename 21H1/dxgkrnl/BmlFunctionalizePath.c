/*
 * XREFs of BmlFunctionalizePath @ 0x1C00E0CAC
 * Callers:
 ...
 *     BmlIsSecondaryClonePath @ 0x1C00E5320 (BmlIsSecondaryClonePath.c)
...
LABEL_28:
  ...
  if ( *(_WORD *)(v13 + a1 + 64) )
  {
    ...
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v48, v47, v49, v50) + 24) = BestTargetMode;
    ...
    {
      if ( *(_WORD *)(v13 + a1 + 66) && !(unsigned __int8)BmlIsSecondaryClonePath(a1, (unsigned int)v5, 0LL) )
      {
...
LABEL_19:
  ...
  while ( 1 )
  {
    if ( *(_WORD *)(v13 + a1 + 64) >= *(_WORD *)(v13 + a1 + 66) )
      goto LABEL_41;
    NextBestSourceMode = BmlGetNextBestSourceMode(a1, a2, (unsigned __int16)v5, (_DWORD)v18, v19, (__int64)&v63);
    ...
    v34 = v62;
    ++*(_WORD *)(v13 + a1 + 64);
    v27 = VIDPN_MGR::PinVidPnSourceMode(v34, v18, v19, 1);
