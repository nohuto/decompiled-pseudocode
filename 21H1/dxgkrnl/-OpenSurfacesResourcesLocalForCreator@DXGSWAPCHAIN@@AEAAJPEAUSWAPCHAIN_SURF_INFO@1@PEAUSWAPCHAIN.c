/*
 * XREFs of ?OpenSurfacesResourcesLocalForCreator@DXGSWAPCHAIN@@AEAAJPEAUSWAPCHAIN_SURF_INFO@1@PEAUSWAPCHAIN_CLIENT_SURF_INFO@1@PEAX@Z @ 0x1C02A6C7C
 * Callers:
        ...
        void *a4)
{
  ...
  PVOID v54; // [rsp+A8h] [rbp+48h] BYREF
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  v48 = 1;
  v26 = ObDuplicateObject(v25, a4, CurrentProcess, &v49, 0, 0, 6, v48);
  v12 = v26;
  if ( v26 < 0 )
  {
LABEL_4:
  ...
  else
  {
    ...
    *((_QWORD *)a3 + 2) = a4;
    ...
    DXGSYNCOBJECTLOCK::AcquireShared((DXGSYNCOBJECTLOCK *)v51, v28);
    v53 = 0;
    v31 = (PERESOURCE *)DXGGLOBAL::GetGlobal(v30, v29);
    v34 = DXGGLOBAL::OpenSyncObject(v31, *((unsigned int *)a2 + 7), &v50, &v53, 0LL);
    if ( v34 >= 0 )
    {
      ...
      *((_DWORD *)a3 + 2) = v41;
      if ( v52 )
        DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v51, v46);
      *(_BYTE *)a3 = 1;
    }
    else
    {
      ...
      *(_QWORD *)(v35 + 32) = PsGetCurrentProcess(v36, v38);
      ...
      if ( v52 )
        DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v51, v39);
    }
