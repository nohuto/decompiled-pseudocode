/*
 * XREFs of ?DestroyAllHwQueues@DXGCONTEXT@@QEAAXPEAVDXGDEVICEACCESSLOCKEXCLUSIVE@@@Z @ 0x1C026839C
 * Callers:
...
void __fastcall DXGCONTEXT::DestroyAllHwQueues(DXGCONTEXT *this, struct DXGDEVICEACCESSLOCKEXCLUSIVE *a2)
{
  ...
  v7 = (volatile signed __int64 **)((char *)this + 424);
LABEL_5:
  v8 = *((_QWORD *)this + 2);
            ...
            if ( i )
            {
              ...
              if ( !v22 )
              {
                ...
                if ( *(_DWORD *)(*(_QWORD *)(*((_QWORD *)v25 + 2) + 16LL) + 200LL) != 4 )
                  DXGCONTEXT::DestroyHwQueue((DXGCONTEXT *)v24, (struct DXGHWQUEUE *)i, (struct COREDEVICEACCESS *)v42);
