/*
 * XREFs of ?AddPathToVidPnTopology@VIDPN_MGR@@QEBAJQEAVDMMVIDPNTOPOLOGY@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@GEW4_D3DKMDT_MONITOR_CONNECTIVITY_CHECKS@@@Z @ 0x1C0128A60
 * Callers:
        ...
        enum _D3DKMDT_MONITOR_CONNECTIVITY_CHECKS a8)
{
  ...
  enum _D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE v63; // [rsp+78h] [rbp+10h] BYREF
