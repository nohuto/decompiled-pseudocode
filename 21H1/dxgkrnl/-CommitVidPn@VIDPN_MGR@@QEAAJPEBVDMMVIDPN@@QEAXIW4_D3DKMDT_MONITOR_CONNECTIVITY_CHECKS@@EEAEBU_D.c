/*
 * XREFs of ?CommitVidPn@VIDPN_MGR@@QEAAJPEBVDMMVIDPN@@QEAXIW4_D3DKMDT_MONITOR_CONNECTIVITY_CHECKS@@EEAEBU_DMM_COMMITVIDPNREQUEST_DIAGINFO@@PEAE@Z @ 0x1C013E01C
 * Callers:
        ...
        unsigned __int8 *a9)
{
  ...
  __int64 v64; // rcx
  _QWORD *v65; // rdi
  ADAPTER_DISPLAY *v66; // rax
  __int64 v67; // rax
  _QWORD *v68; // rax
  _DXGKARG_COMMITVIDPN v69; // [rsp+20h] [rbp-20h] BYREF
  ...
  v13 = a8;
  *(_QWORD *)&v69.Flags = 0LL;
  v14 = *((_BYTE *)a8 + 4) & 8;
  if ( a2 == (const struct DMMVIDPN *)-88LL )
    v69.hFunctionalVidPn = 0LL;
  else
    v69.hFunctionalVidPn = (D3DKMDT_HVIDPN)a2;
  v69.hPrimaryAllocation = a3;
  v15 = a7;
  v69.AffectedVidPnSourceId = v9;
  v16 = a7 & 1;
  LOBYTE(a7) = 0;
  v69.Flags = (DXGKARG_COMMITVIDPN_FLAGS)(*(_DWORD *)&v69.Flags & 0xFFFFFFFC | a6 & 1 | (2 * v16));
  v17 = this[1];
  if ( !v17 )
  {
  ...
  if ( (_BYTE)a7 || v15 )
    v69.MonitorConnectivityChecks = D3DKMDT_MCC_IGNORE;
  else
    v69.MonitorConnectivityChecks = a5;
  if ( v14 )
    goto LABEL_18;
  v20 = this[1];
  if ( !v20 )
  ...
  v21 = ADAPTER_DISPLAY::DdiCommitVidPn(v20, &v69);
  v24 = v21;
...
LABEL_25:
    DmmLogCommitVidPnFailedPacket(&v69, (unsigned int)v24, 4LL);
  ...
  if ( v69.MonitorConnectivityChecks == D3DKMDT_MCC_ENFORCE && a9 )
    *a9 = 1;
  a7 = 0;
  v47 = this[1];
  if ( !v47 )
  ...
  if ( a7 != 1 || v69.MonitorConnectivityChecks != D3DKMDT_MCC_ENFORCE || a6 )
    goto LABEL_25;
  ...
  v60 = ADAPTER_DISPLAY::DdiCommitVidPn(v58, &v69);
  v62 = v60;
  if ( v60 >= 0 )
  {
    DmmLogCommitVidPnFailedPacket(&v69, (unsigned int)v60, 3LL);
LABEL_18:
  ...
  DmmLogCommitVidPnFailedPacket(&v69, (unsigned int)v62, 2LL);
