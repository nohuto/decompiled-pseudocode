/*
 * XREFs of DxgkMiracastStartMiracastSession @ 0x1C0053910
 * Callers:
 ...
 *     ??_GMIRACAST_CHUNK_LIST@@QEAAPEAXI@Z @ 0x1C0050FF8 (--_GMIRACAST_CHUNK_LIST@@QEAAPEAXI@Z.c)
 ...
 *     DpiMiracastSendAsyncUserModeRequest @ 0x1C02CA0B8 (DpiMiracastSendAsyncUserModeRequest.c)
...
LABEL_27:
  ...
  *(_QWORD *)(DeviceContextFromName + 88) = KeGetCurrentThread();
  ...
  if ( !*(_DWORD *)(DeviceContextFromName + 408) )
  {
    ...
    *(_DWORD *)(DeviceContextFromName + 672) = dword_1C00AFE50;
    v39 = v101;
