/*
 * XREFs of ?SendWnfNotificationToVmProcess@DXGGLOBAL@@SAJPEAVDXGPROCESS@@PEBU_WNF_STATE_NAME@@IPEAX@Z @ 0x1C02670A0
 * Callers:
 *     <none>
 * Callees:
 *     ??2@YAPEAX_KIHW4_POOL_TYPE@@@Z @ 0x1C000AE64 (--2@YAPEAX_KIHW4_POOL_TYPE@@@Z.c)
 *     memmove @ 0x1C0026580 (memmove.c)
 *     ?QueueWorkItem@DXG_DEFERRED_WORK_QUEUE@@QEAAXPEAUDXG_DEFERRED_QUEUE_WORK_ITEM@@@Z @ 0x1C00449BC (-QueueWorkItem@DXG_DEFERRED_WORK_QUEUE@@QEAAXPEAUDXG_DEFERRED_QUEUE_WORK_ITEM@@@Z.c)
 */
        ...
        void *a4)
{
  ...
  struct _WNF_STATE_NAME v13; // rcx
  ...
  v13 = *(struct _WNF_STATE_NAME *)(*(_QWORD *)(a1 + 64) + 72LL);
  v9[7] = 0LL;
  v9[8].Data[0] = 0;
  v9[11] = v13;
  v9[8].Data[1] = 2;
  ...
  v14 = (DXG_DEFERRED_WORK_QUEUE *)((char *)DXGGLOBAL::m_pGlobal + 1912);
  v9[10] = *a2;
