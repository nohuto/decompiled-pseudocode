/*
 * XREFs of DpiPowerArbiterThread @ 0x1C0186430
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DpiGetPowerActionQueueEntry@@YAPEAU_LIST_ENTRY@@PEAU_FDO_CONTEXT@@@Z @ 0x1C001FBC8 (-DpiGetPowerActionQueueEntry@@YAPEAU_LIST_ENTRY@@PEAU_FDO_CONTEXT@@@Z.c)
 ...
 *     DxgkSuspendMemorySegments @ 0x1C021392C (DxgkSuspendMemorySegments.c)
      ...
      if ( v15 <= 4 )
      {
        ...
        else
        {
          ...
          if ( *(_QWORD *)(v1 + 488) )
          {
            ...
            *(_QWORD *)(*(_QWORD *)(v1 + 3896) + 2784LL) = 0LL;
            v63 = *(DXGADAPTER **)(v1 + 3896);
            *(_QWORD *)(v1 + 488) = 0LL;
          }
          if ( *(_DWORD *)(v1 + 3976) == 1 )
