/*
 * XREFs of ?RequestAsyncMonitorEventCallout@ADAPTER_DISPLAY@@QEAAJIW4MONITOR_EVENT@@_KEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C021059C
 * Callers:
  ...
  *(_OWORD *)&v32[1] = 0LL;
  if ( v14 )
  {
    ...
    else
    {
      ...
      v23 = DXGDISPLAYCALLOUTQUEUE::SubmitSingleEntry((struct DXGGLOBAL *)((char *)Global + 1584), v14, v30);
    }
  }
  else
  {
