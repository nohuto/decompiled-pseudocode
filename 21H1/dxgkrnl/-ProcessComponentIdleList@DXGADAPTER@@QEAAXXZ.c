/*
 * XREFs of ?ProcessComponentIdleList@DXGADAPTER@@QEAAXXZ @ 0x1C0036AC8
 * Callers:
 *     ?DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C003CF70 (-DxgkpComponentIdleListTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::ProcessComponentIdleList(KSPIN_LOCK *this)
{
  ...
  if ( !*((_BYTE *)this + 3214) )
  {
    ...
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 414, &LockHandle);
    v16[1] = v16;
    v3 = this + 408;
    v16[0] = v16;
    v4 = (_QWORD *)this[408];
