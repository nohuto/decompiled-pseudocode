/*
 * XREFs of ?AcquireSourceModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_DXGDMM_VIDPNSOURCEMODESET_INTERFACE@@@Z @ 0x1C01542D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNSOURCEMODESET__ **a4)
{
  ...
  struct D3DKMDT_HVIDPNSOURCEMODESET__ *v36; // [rsp+70h] [rbp+18h]
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v33, 6034LL);
  if ( !a3 || !a4 )
  {
  ...
  *a4 = 0LL;
  ...
  if ( !DMMVIDPNTOPOLOGY::IsSourceInTopology((DMMVIDPNTOPOLOGY *)(v10 + 96), v7) )
  {
  ...
  v36 = *(struct D3DKMDT_HVIDPNSOURCEMODESET__ **)(v16 + 440);
  v17 = IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(*(_QWORD *)(v13 + 304), v7);
  v20 = v17;
  if ( !v17 )
  {
