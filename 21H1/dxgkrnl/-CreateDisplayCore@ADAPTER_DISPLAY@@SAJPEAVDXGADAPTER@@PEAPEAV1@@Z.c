/*
 * XREFs of ?CreateDisplayCore@ADAPTER_DISPLAY@@SAJPEAVDXGADAPTER@@PEAPEAV1@@Z @ 0x1C0177CE8
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( !v6
    ...
    || !*((_QWORD *)v5 + 71) && *((int *)v5 + 643) < 2200
    || !*((_QWORD *)v5 + 58)
    || !*((_QWORD *)v5 + 59) )
  {
    if ( *((int *)v5 + 643) < 1200 && (*((_DWORD *)v5 + 87) & 0x10) == 0
      || v6
      || *((_QWORD *)v5 + 66)
      || *((_QWORD *)v5 + 67)
      || *((_QWORD *)v5 + 68)
    ...
    if ( *((_DWORD *)v5 + 356) || *((_DWORD *)v5 + 357) )
    {
      v21 = (_QWORD *)WdLogNewEntry5_WdError(a1, 0LL);
      v21[3] = *((unsigned int *)v5 + 356);
      v26 = *((unsigned int *)v5 + 357);
      v22 = -1073741735;
      v21[5] = -1073741735LL;
      v21[4] = v26;
      goto LABEL_74;
...
LABEL_74:
    ...
    if ( v7 || !*((_QWORD *)v5 + 73) || !*((_QWORD *)v5 + 57) && *((int *)v5 + 643) < 1200 )
      goto LABEL_73;
  }
  else
  {
  ...
  *(_QWORD *)(WdLogNewEntry5_WdTrace(a1, v6, a3, a4) + 24) = v5;
  if ( *((int *)v5 + 643) >= 1200 && !*((_DWORD *)v5 + 356) && !*((_DWORD *)v5 + 357) )
  {
LABEL_66:
    *(_QWORD *)(WdLogNewEntry5_WdTrace(a1, v6, a3, a4) + 24) = v5;
    result = 0LL;
  ...
  if ( (unsigned int)(*((_DWORD *)v5 + 356) - 1) > 0xF )
  {
    v23 = WdLogNewEntry5_WdError(a1, v6);
    *(_QWORD *)(v23 + 24) = v5;
    v24 = *((unsigned int *)v5 + 356);
    goto LABEL_87;
  }
  if ( !*((_DWORD *)v5 + 357) )
  {
    v23 = WdLogNewEntry5_WdError(a1, v6);
    *(_QWORD *)(v23 + 24) = v5;
    v24 = *((unsigned int *)v5 + 357);
LABEL_87:
    *(_QWORD *)(v23 + 32) = v24;
    goto LABEL_88;
  }
  if ( *((_BYTE *)v5 + 2584) && *((int *)v5 + 576) >= 4608 && (!*((_BYTE *)v5 + 2504) || !*((_BYTE *)v5 + 2505)) )
  {
    v23 = WdLogNewEntry5_WdError(a1, v6);
