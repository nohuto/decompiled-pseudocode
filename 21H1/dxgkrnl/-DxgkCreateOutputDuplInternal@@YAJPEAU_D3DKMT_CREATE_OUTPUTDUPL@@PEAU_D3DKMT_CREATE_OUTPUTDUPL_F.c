/*
 * XREFs of ?DxgkCreateOutputDuplInternal@@YAJPEAU_D3DKMT_CREATE_OUTPUTDUPL@@PEAU_D3DKMT_CREATE_OUTPUTDUPL_FLAGS@@@Z @ 0x1C0294BB8
 * Callers:
 ...
 *     ?OutputDuplIsAllowedByMdmPolicy@@YA_NXZ @ 0x1C0297150 (-OutputDuplIsAllowedByMdmPolicy@@YA_NXZ.c)
 */
...
LABEL_20:
  ...
  v36 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal(v24, v23) + 88);
  if ( v36 )
  {
