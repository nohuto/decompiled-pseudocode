/*
 * XREFs of ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x1C013CAB8
 * Callers:
 ...
 *     _anonymous_namespace_::_UpdateTimestampTopologySetCallback @ 0x1C013CAA0 (_anonymous_namespace_--_UpdateTimestampTopologySetCallback.c)
 * Callees:
 *     <none>
 */
