/*
 * XREFs of ?CreateCddDevice@SESSION_ADAPTER@@AEAAJPEAVDXGADAPTER@@PEAPEAVDXGDEVICE@@PEAPEAVDXGCONTEXT@@PEAPEAVDXGHWQUEUE@@@Z @ 0x1C014D494
 * Callers:
        ...
        struct DXGHWQUEUE **a5)
{
  ...
  v7 = *((_QWORD *)this + 2);
  v83 = 0;
  v8 = (struct DXGADAPTER *)(v7 & -(__int64)(*(_QWORD *)(v7 + 2672) != 0LL));
  ...
  if ( Current )
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      Device = ADAPTER_RENDER::CreateDevice(a2[335], (__int64 *)this + 7, 0, 2, v8, 0, 0, 1, 0LL, 0LL);
      v17 = Device;
      if ( Device >= 0 )
      {
        ...
        else
        {
          *((_DWORD *)this + 13) = 1;
          ...
          {
            v53 = *((int *)a2 + 576) < 0x2000 ? 1 : *((_DWORD *)a2 + 70);
            *((_DWORD *)this + 13) = v53;
            if ( v53 > 1 )
            {
              v55 = v53;
...
LABEL_24:
            ...
            if ( (int)v17 < 0 && *v18 )
            {
              ADAPTER_RENDER::DestroyDevice(a2[335], *v18, 0LL);
          ...
          while ( 1 )
          {
            ...
            v33 = *(_QWORD *)(360LL * v32 + *((_QWORD *)a2[335][2] + 320) + 32);
...
LABEL_29:
    ...
    if ( a2 == (DXGADAPTER ***)v8 || (v15 = *((unsigned int *)a2 + 50), (_DWORD)v15 == 1) && !*((_BYTE *)a2 + 2585) )
    {
