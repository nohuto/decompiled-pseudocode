/*
 * XREFs of ?InFrame@CCompositionToken@@UEAAJPEAVCCompositionFrame@@PEA_N@Z @ 0x1C00164C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionToken::InFrame(CCompositionToken *this, struct CCompositionFrame *a2, bool *a3)
{
  ...
  v7 = *(unsigned int (__fastcall **)(__int64, _QWORD))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 48LL);
