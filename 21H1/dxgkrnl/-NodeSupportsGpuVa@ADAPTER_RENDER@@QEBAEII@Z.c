/*
 * XREFs of ?NodeSupportsGpuVa@ADAPTER_RENDER@@QEBAEII@Z @ 0x1C0008650
 * Callers:
 *     ?GdiNodeSupportsGpuVa@ADAPTER_RENDER@@QEBAEXZ @ 0x1C003DDB8 (-GdiNodeSupportsGpuVa@ADAPTER_RENDER@@QEBAEXZ.c)
...
unsigned __int8 __fastcall ADAPTER_RENDER::NodeSupportsGpuVa(ADAPTER_RENDER *this, unsigned int a2, unsigned int a3)
{
  ...
  v3 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 2560LL) + 360LL * a2 + 32);
  v4 = 0;
  if ( !v3 )
    return 0;
  v5 = 74LL * a3;
