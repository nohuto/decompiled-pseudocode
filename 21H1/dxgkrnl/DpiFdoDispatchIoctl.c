/*
 * XREFs of DpiFdoDispatchIoctl @ 0x1C02C45F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindVirtualGpuByLuid@ADAPTER_RENDER@@QEAAPEAUDXGK_VIRTUAL_GPU@@W4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUID@@@Z @ 0x1C022B8F0 (-FindVirtualGpuByLuid@ADAPTER_RENDER@@QEAAPEAUDXGK_VIRTUAL_GPU@@W4DXG_VIRTUAL_GPU_TYPE@@PEAU_LUI.c)
 ...
 *     DxgkpCheckProcessForVirtualMachineManagementAccess @ 0x1C022DDEC (DxgkpCheckProcessForVirtualMachineManagementAccess.c)
 *     DpiFdoGetVirtualGpuType @ 0x1C02C5850 (DpiFdoGetVirtualGpuType.c)
