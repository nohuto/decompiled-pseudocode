/*
 * XREFs of ?Cancel@DXGDEADLOCK_TRACKER@@QEAAXXZ @ 0x1C0152170
 * Callers:
...
void __fastcall DXGDEADLOCK_TRACKER::Cancel(DXGDEADLOCK_TRACKER *this)
{
  ...
  if ( *((_BYTE *)this + 34) )
  {
    *((_BYTE *)this + 34) = 0;
    ...
    if ( (*((_BYTE *)v1 + 32) || *((_BYTE *)v1 + 33)) && (unsigned int)dword_1C00AEA90 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000004000LL) )
      {
        ...
        v6 = v20[692];
        v7 = *((unsigned __int8 *)v20 + 2622);
        v8 = (unsigned int)v20[1110];
        v9 = (unsigned int)v20[1109];
        v10 = *((unsigned __int8 *)v20 + 209);
        v11 = *((unsigned __int8 *)v20 + 2516);
        v12 = *((unsigned __int8 *)v20 + 2511);
        v13 = v20[70];
        v14 = *((_WORD *)v20 + 1286);
        v15 = v20[84];
        v16 = v20[83];
    ...
    DXGADAPTER::ReleaseReferenceNoTracking(*((DXGADAPTER **)v1 + 3));
  }
}
