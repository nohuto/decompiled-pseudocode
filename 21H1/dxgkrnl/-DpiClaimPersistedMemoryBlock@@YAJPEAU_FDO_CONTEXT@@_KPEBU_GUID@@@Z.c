/*
 * XREFs of ?DpiClaimPersistedMemoryBlock@@YAJPEAU_FDO_CONTEXT@@_KPEBU_GUID@@@Z @ 0x1C02CD5E8
 * Callers:
...
LABEL_44:
  ...
  if ( v26 )
  {
    ...
    else
    {
      ...
      qword_1C00AFF18 = (__int64)MappedSystemVa;
      if ( !MappedSystemVa )
      {
        v12 = -1073741823LL;
LABEL_43:
