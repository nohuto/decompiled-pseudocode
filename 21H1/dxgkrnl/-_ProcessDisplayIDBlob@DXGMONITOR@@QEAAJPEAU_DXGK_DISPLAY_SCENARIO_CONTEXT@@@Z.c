/*
 * XREFs of ?_ProcessDisplayIDBlob@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02F652C
 * Callers:
 ...
 *     ?SetPhysicalDimensionOfInternalPanel@EDIDCACHE@@QEAAXJJE@Z @ 0x1C017DEA8 (-SetPhysicalDimensionOfInternalPanel@EDIDCACHE@@QEAAXJJE@Z.c)
...
LABEL_18:
  ...
  *(_QWORD *)(v5 + 24) = this;
  ...
  if ( !*((_BYTE *)DXGGLOBAL::GetGlobal(v21, v20) + 304201) && !*((_DWORD *)this + 148) )
  {
    LOBYTE(v36) = 1;
    v37 = 0;
    LOBYTE(v35) = 1;
  ...
  if ( *((_DWORD *)this + 108) == 1 && IsInternalVideoOutput(*((enum _D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY *)this + 12)) )
  {
    ...
    if ( PhysicalSize >= 0 )
    {
      v31 = (EDIDCACHE *)*((_QWORD *)DXGGLOBAL::GetGlobal(v29, v28) + 112);
      if ( v31 )
