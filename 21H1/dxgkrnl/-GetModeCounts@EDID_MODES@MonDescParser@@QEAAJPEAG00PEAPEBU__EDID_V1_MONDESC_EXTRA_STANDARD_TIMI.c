/*
 * XREFs of ?GetModeCounts@EDID_MODES@MonDescParser@@QEAAJPEAG00PEAPEBU__EDID_V1_MONDESC_EXTRA_STANDARD_TIMINGS@@00@Z @ 0x1C001F2A4
 * Callers:
 ...
 *     ?DenseOnesBitCount@MonDescParser@@YAEE@Z @ 0x1C001F4F4 (-DenseOnesBitCount@MonDescParser@@YAEE@Z.c)
