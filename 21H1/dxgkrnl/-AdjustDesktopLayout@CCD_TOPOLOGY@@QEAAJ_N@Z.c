/*
 * XREFs of ?AdjustDesktopLayout@CCD_TOPOLOGY@@QEAAJ_N@Z @ 0x1C00EBADC
 * Callers:
...
__int64 __fastcall CCD_TOPOLOGY::AdjustDesktopLayout(CCD_TOPOLOGY *this, char a2)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( (*(_DWORD *)PathDescriptor & 0x800LL) != 0 && CCD_TOPOLOGY::IsPrimaryClonePathByModality(this, i) )
    {
      ...
      v50 = v80;
      if ( (signed int)(v83.cx + *((_DWORD *)PathDescriptor + 36)) > v80 )
...
LABEL_89:
  ...
  while ( 1 )
  {
    ...
    if ( CCD_TOPOLOGY::IsPrimaryClonePathByModality(this, v2)
      && !*((_DWORD *)v52 + 53)
      && (a2 || !CCD_TOPOLOGY::IsVirtualSlate(v53, (struct _LUID *)v52)) )
    {
  ...
  v80 = 0;
  if ( a2 || (v24 = CCD_TOPOLOGY::AdjustSlateVirtualMonitorsPosition(this, v16, &v81, &v80), v27 = v24, v24 >= 0) )
  {
    v28 = 0;
    while ( 1 )
    {
