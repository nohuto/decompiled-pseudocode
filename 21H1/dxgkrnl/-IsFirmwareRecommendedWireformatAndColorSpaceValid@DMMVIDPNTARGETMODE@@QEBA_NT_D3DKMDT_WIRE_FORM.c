/*
 * XREFs of ?IsFirmwareRecommendedWireformatAndColorSpaceValid@DMMVIDPNTARGETMODE@@QEBA_NT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@W4_D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE@@@Z @ 0x1C005A900
 * Callers:
        ...
        enum _D3DDDI_OUTPUT_WIRE_COLOR_SPACE_TYPE a3)
{
  ...
  result = 0;
  if ( (((_DWORD)v3 - 1) & (unsigned int)v3) == 0 && ((unsigned int)v3 & *((_DWORD *)this + 32)) != 0 )
  {
    if ( (v5 = (((unsigned int)v3 | (((unsigned int)v3 | (((unsigned int)v3 | (((unsigned int)v3 | ((unsigned int)v3 >> 6)) >> 6)) >> 6)) >> 6)) >> 2) & 0x3F,
      ...
      || *((_BYTE *)DXGGLOBAL::GetGlobal((__int64)this, v3) + 304200) && a3 == D3DDDI_OUTPUT_WIRE_COLOR_SPACE_G22_P2020
