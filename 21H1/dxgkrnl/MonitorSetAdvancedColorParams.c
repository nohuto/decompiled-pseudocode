/*
 * XREFs of MonitorSetAdvancedColorParams @ 0x1C02EFCE8
 * Callers:
 ...
 *     ?SetLuminanceValuesWithBrightnessCompensation@DXGMONITOR@@QEAAJXZ @ 0x1C02F4144 (-SetLuminanceValuesWithBrightnessCompensation@DXGMONITOR@@QEAAJXZ.c)
 */
