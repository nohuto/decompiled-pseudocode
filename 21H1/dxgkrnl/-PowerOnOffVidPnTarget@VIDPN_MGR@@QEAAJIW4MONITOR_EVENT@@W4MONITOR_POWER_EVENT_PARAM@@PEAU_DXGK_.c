/*
 * XREFs of ?PowerOnOffVidPnTarget@VIDPN_MGR@@QEAAJIW4MONITOR_EVENT@@W4MONITOR_POWER_EVENT_PARAM@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0163744
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a5)
{
  ...
  *(_QWORD *)(v9 + 32) = a1;
  ...
  if ( v16 )
  {
    ...
    v23 = *(_QWORD *)(*(_QWORD *)(v22 + 16) + 2680LL);
    ...
    if ( v57[6] )
    {
      for ( j = 0; ; ++j )
      {
        ...
        v27 = *(_QWORD *)(*(_QWORD *)(v31 + 16) + 2672LL);
        if ( j >= *(_DWORD *)(v27 + 80) )
          break;
        v33 = v57[6];
        if ( _bittest(&v33, j) )
