/*
 * XREFs of ?DdiSetTargetGamma@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETGAMMA@@@Z @ 0x1C021A9CC
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiSetTargetGamma(
        ADAPTER_DISPLAY *this,
        const struct _DXGKARG_SETTARGETGAMMA *a2,
        __int64 a3)
{
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  if ( (qword_1C00AE9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5077);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5077LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETGAMMA *))(*((_QWORD *)this + 2) + 1096LL))(
  ...
  v18 = WdLogNewEntry5_WdEvent(v13, v11);
  *(_QWORD *)(v18 + 24) = v12;
  *(_QWORD *)(v18 + 32) = a2->TargetId;
  WdLogEvent5_WdEvent(v18);
  if ( (_DWORD)v12 != -1073741801 && (_DWORD)v12 != -1071774904 && (_DWORD)v12 )
  {
