/*
 * XREFs of McTemplateK0pqqq_EtwWriteTransfer @ 0x1C003871C
 * Callers:
 *     ?CompletePStateTransitionCB@DXGADAPTER@@QEAAXII@Z @ 0x1C0035300 (-CompletePStateTransitionCB@DXGADAPTER@@QEAAXII@Z.c)
