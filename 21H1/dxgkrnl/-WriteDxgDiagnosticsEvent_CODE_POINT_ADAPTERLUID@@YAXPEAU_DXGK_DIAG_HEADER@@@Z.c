/*
 * XREFs of ?WriteDxgDiagnosticsEvent_CODE_POINT_ADAPTERLUID@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0008DAC
 * Callers:
  ...
  switch ( v10 )
  {
    case 'D':
      if ( *((int *)a1 + 13) < 0 != ((*((_DWORD *)a1 + 13) & 0x40000000) != 0)
        && (unsigned __int8)tlgKeywordOn(&dword_1C00AEA20, v3) )
      {
    ...
    case '`':
      ...
      goto LABEL_29;
    case 'b':
      if ( *((int *)a1 + 14) < 0 && (unsigned __int8)tlgKeywordOn(&dword_1C00AEA20, v3) )
      {
        v27 = *((_DWORD *)a1 + 13);
        v29 = *((_QWORD *)a1 + 8);
        v26 = v17;
      ...
      break;
    default:
      if ( v10 != 104 || !(unsigned __int8)tlgKeywordOn(&dword_1C00AEA20, v3) )
        return;
      v14 = &unk_1C007CC15;
LABEL_29:
      v26 = *((_DWORD *)a1 + 15);
