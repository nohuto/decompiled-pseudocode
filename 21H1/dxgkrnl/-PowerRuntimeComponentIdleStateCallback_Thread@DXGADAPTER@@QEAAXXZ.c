/*
 * XREFs of ?PowerRuntimeComponentIdleStateCallback_Thread@DXGADAPTER@@QEAAXXZ @ 0x1C020A1A8
 * Callers:
 *     ?PowerRuntimeComponentIdleStateCallbackThread@DXGADAPTER@@SAXPEAX@Z @ 0x1C020A190 (-PowerRuntimeComponentIdleStateCallbackThread@DXGADAPTER@@SAXPEAX@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::PowerRuntimeComponentIdleStateCallback_Thread(DXGADAPTER *this)
{
  ...
  do
  {
    KeWaitForSingleObject((char *)this + 3464, Executive, 0, 0, 0LL);
    while ( 1 )
    {
      v2 = ExInterlockedRemoveHeadList((PLIST_ENTRY)this + 222, (PKSPIN_LOCK)this + 442);
      if ( !v2 )
        break;
      ...
      ExpInterlockedPushEntrySList((PSLIST_HEADER)this + 223, (PSLIST_ENTRY)v2);
