/*
 * XREFs of ?DxgkGetDWMVerticalBlankEventInternal@@YAJIIIPEAPEAU_KEVENT@@@Z @ 0x1C0157DE8
 * Callers:
 *     DxgkGetDWMVerticalBlankEvent @ 0x1C0157CC0 (DxgkGetDWMVerticalBlankEvent.c)
 * Callees:
...
__int64 __fastcall DxgkGetDWMVerticalBlankEventInternal(__int64 a1, unsigned int a2, __int64 a3, struct _KEVENT **a4)
{
  ...
  if ( v47 )
  {
    ...
    else
    {
      ...
      if ( (unsigned int)v4 < *((_DWORD *)v26[334] + 20) )
      {
        if ( !v19
          || v25 == *(struct DXGADAPTER **)(*((_QWORD *)v7 + 2) + 16LL) && v26 == *((ADAPTER_DISPLAY ***)v7 + 231) )
        {
          ...
          if ( v29 >= 0 )
          {
            ...
            {
              ADAPTER_DISPLAY::GetVBlankEvent(v26[334], v4, v51);
