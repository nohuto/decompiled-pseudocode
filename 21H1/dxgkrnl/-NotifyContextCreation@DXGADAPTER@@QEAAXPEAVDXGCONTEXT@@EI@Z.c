/*
 * XREFs of ?NotifyContextCreation@DXGADAPTER@@QEAAXPEAVDXGCONTEXT@@EI@Z @ 0x1C000A264
 * Callers:
...
void __fastcall DXGADAPTER::NotifyContextCreation(DXGADAPTER *this, struct DXGCONTEXT *a2, char a3, int a4)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 730); ++i )
  {
    ...
    v27 = 0;
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 405, &LockHandle);
    *((_QWORD *)this + 406) = KeGetCurrentThread();
    ...
    if ( a3 )
    {
      ...
      *(_DWORD *)(v10 + 416) = v12;
      ...
      v13 = *(_DWORD *)(v10 + 4);
      *(_DWORD *)(v10 + 384) = 0;
      DXGADAPTER::SetPowerComponentLatencyCB(this, v13, **((_QWORD **)this + 383));
      if ( *(int *)(v10 + 388) > 0 )
      {
        v14 = MEMORY[0xFFFFF78000000320];
        *(_QWORD *)(v10 + 392) = MEMORY[0xFFFFF78000000320];
        *(_QWORD *)(v10 + 392) = v14 + *(_QWORD *)(*((_QWORD *)this + 383) + 8LL);
        v15 = (_QWORD *)(v10 + 400);
        if ( !*v15 )
        {
          v16 = (_QWORD *)((char *)this + 3224);
          v17 = *((_QWORD *)this + 403);
          if ( *(DXGADAPTER **)(v17 + 8) != (DXGADAPTER *)((char *)this + 3224) )
            goto LABEL_32;
          *v15 = v17;
          v15[1] = v16;
          *(_QWORD *)(v17 + 8) = v15;
    ...
    else
    {
      ...
      *(_DWORD *)(v10 + 416) = v21;
      ...
      v22 = *(_DWORD *)(v10 + 4);
      *(_DWORD *)(v10 + 384) = 2;
      DXGADAPTER::SetPowerComponentLatencyCB(this, v22, *(_QWORD *)(*((_QWORD *)this + 383) + 32LL));
      v23 = (__int64 *)(v10 + 400);
      v24 = *v23;
      if ( *v23 )
      {
...
LABEL_29:
  ...
  if ( a3 )
    v9 = _InterlockedIncrement((volatile signed __int32 *)this + 733);
  else
    v9 = _InterlockedExchangeAdd((volatile signed __int32 *)this + 733, 0xFFFFFFFF);
  if ( v9 == 1 )
  {
    if ( *((_QWORD *)this + 348) )
