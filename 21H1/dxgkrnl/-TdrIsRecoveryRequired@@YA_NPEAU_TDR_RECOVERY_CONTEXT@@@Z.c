/*
 * XREFs of ?TdrIsRecoveryRequired@@YA_NPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C02616F0
 * Callers:
 ...
 *     ?TdrHistoryIsLimitExhausted@@YA_NPEBU_TDR_HISTORY@@PEBU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C02615C0 (-TdrHistoryIsLimitExhausted@@YA_NPEBU_TDR_HISTORY@@PEBU_TDR_RECOVERY_CONTEXT@@_N@Z.c)
...
char __fastcall TdrIsRecoveryRequired(struct _TDR_RECOVERY_CONTEXT *a1)
{
  ...
  v9 = *(_QWORD *)(*((_QWORD *)a1 + 4) + 2680LL);
  if ( v9
    && (*(int (__fastcall **)(struct _TDR_RECOVERY_CONTEXT *))(*(_QWORD *)(*(_QWORD *)(v9 + 616) + 8LL) + 584LL))(a1) < 0 )
  {
    *((_QWORD *)a1 + 12) = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2680LL) + 616LL) + 8LL)
                                     + 584LL);
    TdrBugcheckOnTimeout((ULONG_PTR)a1);
  }
