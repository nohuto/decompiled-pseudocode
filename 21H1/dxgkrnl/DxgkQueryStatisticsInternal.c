/*
 * XREFs of DxgkQueryStatisticsInternal @ 0x1C02216A8
 * Callers:
 *     DxgkQueryStatistics @ 0x1C0221690 (DxgkQueryStatistics.c)
...
__int64 __fastcall DxgkQueryStatisticsInternal(__int64 a1, char a2, __int64 a3)
{
  ...
  if ( v18 )
  {
    ...
    if ( v78 )
    {
      ...
      Process = DXGPROCESSMUTEXBYHANDLE::GetProcess((DXGPROCESSMUTEXBYHANDLE *)v81, v22);
    }
    else
    {
...
LABEL_58:
    ...
    {
      case 0:
        LODWORD(v32) = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v34 + 335)
                                                                                          + 640LL)
                                                                              + 8LL)
                                                                  + 296LL))(
                         *(_QWORD *)(*((_QWORD *)v34 + 335) + 648LL),
                         v79);
        if ( (int)v32 < 0 )
          goto LABEL_58;
        ProcessStatistics = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v34 + 335)
                                                                                               + 616LL)
                                                                                   + 8LL)
                                                                       + 688LL))(
                              *(_QWORD *)(*((_QWORD *)v34 + 335) + 624LL),
                              v79);
        goto LABEL_57;
      case 3:
        ProcessStatistics = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _BYTE *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v34 + 335) + 640LL)
                                                                                           + 8LL)
                                                                               + 320LL))(
                              *(_QWORD *)(*((_QWORD *)v34 + 335) + 648LL),
                              v80,
        ...
        goto LABEL_57;
      case 5:
        v52 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _BYTE *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v34 + 335) + 616LL)
                                                                             + 8LL)
                                                                 + 696LL))(
                *(_QWORD *)(*((_QWORD *)v34 + 335) + 624LL),
                v80,
        ...
        if ( *((int *)v34 + 643) < 2400 )
          goto LABEL_58;
        v54 = v80 % **((unsigned __int16 **)v34 + 320);
        *(_DWORD *)&v79[548] = v80 / **((unsigned __int16 **)v34 + 320);
        *(_DWORD *)&v79[544] = v54;
        NodePerfData = DXGADAPTER::GetNodePerfData(v34, (struct _D3DKMT_NODE_PERFDATA *)&v79[544], v49);
        break;
      case 7:
        ProcessStatistics = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _BYTE *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v34 + 335) + 616LL)
                                                                                           + 8LL)
                                                                               + 704LL))(
                              *(_QWORD *)(*((_QWORD *)v34 + 335) + 624LL),
                              v80,
