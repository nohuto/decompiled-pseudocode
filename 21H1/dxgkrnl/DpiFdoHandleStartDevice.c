/*
 * XREFs of DpiFdoHandleStartDevice @ 0x1C0182280
 * Callers:
 *     <none>
 * Callees:
 *     DpiCheckForOutstandingD3Requests @ 0x1C001F6D4 (DpiCheckForOutstandingD3Requests.c)
 *     WindowsQueryLicenseDWORD @ 0x1C0022E74 (WindowsQueryLicenseDWORD.c)
 ...
 *     DpiDetermineResourceListSize @ 0x1C01828AC (DpiDetermineResourceListSize.c)
...
LABEL_40:
        if ( byte_1C00AFA59 )
          KeSetEvent(&stru_1C00AFA60, 0, 0);
LABEL_21:
        if ( byte_1C00AFA5A && !*(_BYTE *)(DeviceExtension + 1158) )
        {
          ThreadHandle = 0LL;
