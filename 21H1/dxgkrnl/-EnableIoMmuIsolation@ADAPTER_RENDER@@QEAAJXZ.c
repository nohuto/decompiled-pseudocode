/*
 * XREFs of ?EnableIoMmuIsolation@ADAPTER_RENDER@@QEAAJXZ @ 0x1C0211DD4
 * Callers:
...
LABEL_13:
      ...
      LOBYTE(v8) = 1;
      LODWORD(v6) = ((__int64 (__fastcall *)(__int64, __int64))qword_1C00AFF28)(v8, IoMmuContextFromDevice + 8);
      if ( (int)v6 < 0 )
        goto LABEL_8;
