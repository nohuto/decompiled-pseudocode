/*
 * XREFs of ?IsAudioAvailableInEdid@DpiInternal@@YAHPEAXI@Z @ 0x1C02A4A4C
 * Callers:
 ...
 *     ?EDID_V1_CeaExt_IsAudioSupported@@YAEPEBE@Z @ 0x1C005DB88 (-EDID_V1_CeaExt_IsAudioSupported@@YAEPEBE@Z.c)
