/*
 * XREFs of ?Retire@CFlipToken@@UEAAXAEBUDXGI_FRAME_STATISTICS@@@Z @ 0x1C0003DD0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CFlipToken::Retire(CFlipToken *this, const struct DXGI_FRAME_STATISTICS *a2)
{
  ...
  *((_DWORD *)this + 6) = 5;
  ...
  v11 = v9;
  v12 = *(void (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, int, int, BOOL, __int64, __int64, _DWORD))(*((_QWORD *)Global + 38033) + 120LL);
