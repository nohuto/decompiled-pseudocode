/*
 * XREFs of ?GetDxgiGammaRamp@ADAPTER_DISPLAY@@QEAAJIPEAPEBUDXGK_GAMMA_RAMP@@@Z @ 0x1C00E5EEC
 * Callers:
        ...
        const struct DXGK_GAMMA_RAMP **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v32 = 0;
    SourceConnectedToTargetInClientVidPn = DmmGetSourceConnectedToTargetInClientVidPn(v8, v4, &v32);
