/*
 * XREFs of ?AcquirePinnedModeInfo@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_D3DKMDT_VIDPN_TARGET_MODE@@@Z @ 0x1C01499E0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v9 )
    {
      ...
      {
        v26 = WdLogNewEntry5_WdDmmEvent(v12);
        *(_QWORD *)(v26 + 24) = v9;
