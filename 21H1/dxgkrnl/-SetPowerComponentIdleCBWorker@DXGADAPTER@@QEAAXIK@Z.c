/*
 * XREFs of ?SetPowerComponentIdleCBWorker@DXGADAPTER@@QEAAXIK@Z @ 0x1C0037A50
 * Callers:
 ...
 *     ?ScheduleComponentIdleListTimer@DXGADAPTER@@QEAAX_J@Z @ 0x1C00371BC (-ScheduleComponentIdleListTimer@DXGADAPTER@@QEAAX_J@Z.c)
 ...
 *     ?RecordIdle@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C0045D44 (-RecordIdle@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 */
...
void __fastcall DXGADAPTER::SetPowerComponentIdleCBWorker(DXGADAPTER *this, unsigned int a2, __int64 a3)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    McTemplateK0pq_EtwWriteTransfer(this, &Dxgk_SetPowerComponentIdleCB, a3, this, a2);
  v6 = *((_QWORD *)this + 347) + 520 * v4;
  v7 = *(_QWORD *)(v6 + 512);
  if ( v7 )
    ...
    *(_QWORD *)(v6 + 480) = MEMORY[0xFFFFF78000000014];
    if ( v11 )
    {
      ...
      if ( *(_DWORD *)(v6 + 208) == 7 )
        DxgkNotifySharedPowerGraphicsFStateTransition(this, *(_DWORD *)(v6 + 4), 1u, 1);
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
        McTemplateK0pqq_EtwWriteTransfer(v12, (unsigned int)&Dxgk_ReportPowerComponentState, v10, (_DWORD)this, v4, 0);
      v9 = *((_QWORD *)this + 348);
      if ( v9 )
          ...
          *(int *)(v6 + 352) <= 0) )
    {
      *(_QWORD *)(v6 + 488) = *(_QWORD *)(v6 + 480) + *(_QWORD *)(v6 + 472);
      KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)this + 414, &v20);
      v13 = (char *)*((_QWORD *)this + 409);
      v14 = (char *)this + 3264;
      if ( v13 == (char *)this + 3264 )
        goto LABEL_29;
...
LABEL_34:
  if ( bTracingEnabled )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
      McTemplateK0pq_EtwWriteTransfer(v9, &Dxgk_SetPowerComponentIdleCBEnd, v10, this, v4);
  }
}
