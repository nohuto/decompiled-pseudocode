/*
 * XREFs of _BtlPreAcquireSharedAccess_&CCD_BTL_ACTIVE_PATHS_COLLECTOR::_CollectActiveAdaptersCallback_1_1_ @ 0x1C00E8AC0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 && *(_DWORD *)(v4 + 80) && *((_DWORD *)this + 50) == 1 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 && *(_QWORD *)(v7 + 136) )
      {
        ...
        else if ( !*((_BYTE *)this + 2585) && (!DXGADAPTER::IsBddFallbackDriver(this) || DxgkIsMSBDDFallbackEnabled()) )
        {
          v15 = *((_QWORD *)this + 334);
          if ( v15 )
          {
            ...
            v32 = 0LL;
            ClientVidPnFromLastClientCommitedVidPn = VIDPN_MGR::CreateClientVidPnFromLastClientCommitedVidPn(v16);
