/*
 * XREFs of ?Destroy@DXGADAPTER@@QEAAXXZ @ 0x1C0207F5C
 * Callers:
...
void __fastcall DXGADAPTER::Destroy(DXGADAPTER *this, struct _LUID *a2)
{
  ...
  *((_BYTE *)this + 208) = 1;
  ...
  v9 = (ADAPTER_DISPLAY *)*((_QWORD *)this + 334);
  if ( v9 )
    ADAPTER_DISPLAY::Destroy(v9);
  v10 = (ADAPTER_RENDER *)*((_QWORD *)this + 335);
  if ( v10 )
    ADAPTER_RENDER::Destroy(v10);
  v11 = (void (__fastcall *)(_QWORD))*((_QWORD *)this + 211);
  if ( v11 )
  {
    v11(*((_QWORD *)this + 209));
    memset((char *)this + 1664, 0, 0xB8uLL);
  }
  v12 = (void (__fastcall *)(_QWORD))*((_QWORD *)this + 235);
  if ( v12 )
  {
    v12(*((_QWORD *)this + 233));
    memset((char *)this + 1856, 0, 0x70uLL);
  }
  if ( *((_BYTE *)this + 4328) )
  {
    v34 = 0;
  ...
  DpiFreeAdapterInfo((char *)this + 1368);
  DXGADAPTER::DestroyPhysicalAdapterData(this);
  memset((char *)this + 272, 0, 0x448uLL);
  memset((char *)this + 1368, 0, 0x128uLL);
  if ( *((_BYTE *)this + 209) )
  {
    v19 = *((_DWORD *)this + 1070);
    if ( v19 )
    {
      v30 = 0LL;
      v31 = 0LL;
    ...
    DXG_VMBUS_CHANNEL_BASE::VmBusSendSyncMessage(
      ...
      0LL,
      v27);
    DXG_GUEST_VIRTUALGPU_VMBUS::DestroyVmBusChannel((DXGADAPTER *)((char *)this + 4208));
    if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v21, v20) + 380) >= 0x16u )
