/*
 * XREFs of DxgkConvertLegacyQDCAdapterAndIdToActual @ 0x1C0117180
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *a4 = a2;
  v6 = a2;
  v8 = (struct DXGGLOBAL *)((char *)DXGGLOBAL::GetGlobal((__int64)a1, a2) + 1160);
  if ( ((unsigned int)DXGADAPTERSOURCEHASH::GetHashBitMask(v8, v9) & v6) == 0 )
    return 0LL;
  v11 = *a1;
  v23 = 0;
  LODWORD(result) = DxgkIsAdapterVirtualTopologyEnabled(v11);
  v12 = (int)result;
  if ( (int)result < 0 )
