/*
 * XREFs of ?Initialize@ADAPTER_RENDER@@QEAAJXZ @ 0x1C016DC78
 * Callers:
 ...
 *     ?IsClockCalibrationSupported@ADAPTER_RENDER@@QEBAEXZ @ 0x1C000F298 (-IsClockCalibrationSupported@ADAPTER_RENDER@@QEBAEXZ.c)
 *     ?GetVidSchSibmitDataSize@ADAPTER_RENDER@@QEAAIXZ @ 0x1C00170C0 (-GetVidSchSibmitDataSize@ADAPTER_RENDER@@QEAAIXZ.c)
 *     ?Enter@DXGCRITICALREGION@@QEAAXXZ @ 0x1C0021D28 (-Enter@DXGCRITICALREGION@@QEAAXXZ.c)
...
__int64 __fastcall ADAPTER_RENDER::Initialize(ADAPTER_RENDER *this)
{
  ...
  *(_OWORD *)((char *)this + 472) = *(_OWORD *)(v1 + 1408);
  *(_OWORD *)((char *)this + 488) = *(_OWORD *)(v1 + 1504);
  *(_OWORD *)((char *)this + 504) = *(_OWORD *)(v1 + 1520);
  *(_OWORD *)((char *)this + 552) = *(_OWORD *)(v1 + 1440);
  *((_OWORD *)this + 36) = *(_OWORD *)(v1 + 1464);
  *((_DWORD *)this + 142) = *(_DWORD *)(v1 + 1456);
  *((_DWORD *)this + 143) = *(_DWORD *)(v1 + 1460);
  *((_DWORD *)this + 148) = *(_DWORD *)(v1 + 1480);
  *((_DWORD *)this + 149) = *(_DWORD *)(v1 + 1484);
  *(_OWORD *)((char *)this + 520) = *(_OWORD *)(v1 + 1536);
  *(_OWORD *)((char *)this + 536) = *(_OWORD *)(v1 + 1552);
  LODWORD(v6) = 0;
  if ( (int)ADAPTER_RENDER::InitializeUserModeDriverNames(
              this,
              (struct _UNICODE_STRING *)(v1 + 1376),
              (struct _UNICODE_STRING *)((char *)this + 312)) < 0
    || (int)ADAPTER_RENDER::InitializeUserModeDriverNames(
              this,
              (struct _UNICODE_STRING *)(*((_QWORD *)this + 2) + 1392LL),
              (struct _UNICODE_STRING *)((char *)this + 376)) < 0
    || (int)ADAPTER_RENDER::InitializeDisplayUserModeDriverNames(
              this,
              (struct _UNICODE_STRING *)(*((_QWORD *)this + 2) + 1632LL),
              (struct _UNICODE_STRING *)((char *)this + 440)) < 0
    || (int)ADAPTER_RENDER::InitializeDisplayUserModeDriverNames(
              this,
              (struct _UNICODE_STRING *)(*((_QWORD *)this + 2) + 1648LL),
  ...
  if ( *((_WORD *)this + 188) )
  {
    if ( **((_WORD **)this + 48) == 35 )
    {
      v85 = *((_QWORD *)this + 2);
      if ( *(_WORD *)(v85 + 1608) )
        *(_OWORD *)((char *)this + 376) = *(_OWORD *)(v85 + 1608);
    }
  }
...
LABEL_140:
  ...
  *((_BYTE *)this + 1201) = 1;
  ...
  if ( !*((_BYTE *)v12 + 209) )
  {
    ...
    v16 = *(_QWORD *)((char *)DXGGLOBAL::GetGlobal(v15, v14) + (IsDxgmms2 != 0 ? 8 : 0) + 104);
    *((_QWORD *)this + 80) = v16;
    Global = DXGGLOBAL::GetGlobal(v16, v17);
    v19 = IsDxgmms2 != 0 ? 8 : 0;
    v20 = *(_QWORD *)((char *)Global + v19 + 120);
    *((_QWORD *)this + 77) = v20;
...
LABEL_50:
    ...
    if ( v57 >= 4864 )
    {
      ...
      if ( v58 )
      {
        ...
        do
        {
          v60 = *(unsigned __int16 *)(360 * v59 + *(_QWORD *)(*((_QWORD *)this + 2) + 2560LL));
          v62 = *(unsigned __int16 *)(360 * v59 + *(_QWORD *)(*((_QWORD *)this + 2) + 2560LL));
          v61 = 4 * v62;
          v6 = v60;
...
LABEL_75:
          *(_QWORD *)(360LL * v117 + *(_QWORD *)(*((_QWORD *)this + 2) + 2560LL) + 40) = v66;
          v59 = v117 + 1;
          v117 = v59;
        }
  ...
  for ( i = 0; ; ++i )
  {
    ...
    {
      if ( *(int *)(v22 + 2304) < 8960 )
      {
        *(_DWORD *)(v22 + 2032) &= 0xFFFFF87F;
        v22 = *((_QWORD *)this + 2);
      }
      goto LABEL_50;
    }
    v24 = (unsigned __int16 *)(*(_QWORD *)(v22 + 2560) + 360LL * i);
    v25 = *v24;
    v27 = 74LL * *v24;
    ...
    *((_QWORD *)v24 + 16) = v36;
    ...
    if ( v25 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v40[4] )
        {
          if ( (*(_DWORD *)(v119 + 2036) & 0x40) == 0 )
          {
            v104 = (_QWORD *)WdLogNewEntry5_WdError(v119, 0LL);
            v104[5] = 1176LL;
            goto LABEL_124;
          }
          if ( v38 == v24[1] && !*(_BYTE *)(*((_QWORD *)this + 2) + 2610LL) )
            *((_BYTE *)v24 + 48) = 1;
        }
        if ( v40[5] )
        {
          if ( (*(_DWORD *)(v44 + 2036) & 0x80u) == 0 )
          {
