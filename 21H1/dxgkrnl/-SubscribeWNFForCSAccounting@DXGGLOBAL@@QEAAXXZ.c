/*
 * XREFs of ?SubscribeWNFForCSAccounting@DXGGLOBAL@@QEAAXXZ @ 0x1C02BAE18
 * Callers:
 *     ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C017CEEC (-Initialize@DXGGLOBAL@@QEAAJXZ.c)
 * Callees:
 *     McGenEventRegister_EtwRegister @ 0x1C0024288 (McGenEventRegister_EtwRegister.c)
...
void __fastcall DXGGLOBAL::SubscribeWNFForCSAccounting(PVOID *this)
{
  ...
  v3 = ExSubscribeWnfStateChange(this + 230, &v15, 1LL);
  v7 = v3;
  if ( v3 >= 0 )
  {
