/*
 * XREFs of ?FinalizeTopologyOnAdapter@CCD_TOPOLOGY@@AEAAJPEAVDXGPROCESS@@K@Z @ 0x1C0130FC8
 * Callers:
        ...
        unsigned int a3)
{
  ...
  while ( 1 )
  {
    ...
    v13 = (int)COREDEVICEACCESS::AcquireExclusive((__int64)v42, 2LL);
            ...
            if ( ((unsigned int)v21 & *(_DWORD *)(v19 + v23 + 84)) != 0 )
            {
              ...
              if ( v27 < 0 )
              {
                ...
                *(_DWORD *)(v19 + *(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 160) |= v21;
                v30 = ADAPTER_DISPLAY::PurgeCopyProtectionOnVidPnSource(*(ADAPTER_DISPLAY **)(v11 + 2672), v17);
                v13 = v30;
                if ( v30 < 0 )
                {
