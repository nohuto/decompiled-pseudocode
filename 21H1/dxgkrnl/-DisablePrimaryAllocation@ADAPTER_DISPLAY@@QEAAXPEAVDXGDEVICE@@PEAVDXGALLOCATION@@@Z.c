/*
 * XREFs of ?DisablePrimaryAllocation@ADAPTER_DISPLAY@@QEAAXPEAVDXGDEVICE@@PEAVDXGALLOCATION@@@Z @ 0x1C013FA94
 * Callers:
        ...
        struct DXGALLOCATION *a3)
{
    ...
    && (*(_DWORD *)(*((_QWORD *)a3 + 6) + 4LL) & 0x10) == 0 )
  {
    ...
    if ( *(int *)(v14 + 2572) >= 2000 )
    {
      ...
      {
        v23 = ADAPTER_DISPLAY::GetCddPrimaryAllocation((ADAPTER_DISPLAY *)this, (unsigned int)v12, 0) == *((struct DXGADAPTERALLOCATION **)a3 + 6);
      }
      ...
      if ( v33 != 2 )
      {
        if ( v33 )
        {
          ...
          if ( *(int *)(*(_QWORD *)(*((_QWORD *)VidPnSourceOwner + 2) + 16LL) + 2572LL) < 2200 )
