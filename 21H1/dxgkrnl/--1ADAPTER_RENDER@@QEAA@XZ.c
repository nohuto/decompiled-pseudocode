/*
 * XREFs of ??1ADAPTER_RENDER@@QEAA@XZ @ 0x1C0211300
 * Callers:
 ...
 *     ??1?$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ @ 0x1C0039E64 (--1-$DXGNODELIST@VADAPTER_RENDER@@VDXGDEVICE@@@@AEAA@XZ.c)
