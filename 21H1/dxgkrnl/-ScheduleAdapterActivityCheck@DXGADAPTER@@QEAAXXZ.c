/*
 * XREFs of ?ScheduleAdapterActivityCheck@DXGADAPTER@@QEAAXXZ @ 0x1C003708C
 * Callers:
...
void __fastcall DXGADAPTER::ScheduleAdapterActivityCheck(struct _KTHREAD **this, struct _KTHREAD *a2)
{
  ...
  v2 = (char *)(this + 405);
  v7 = (KSPIN_LOCK *)(this + 405);
  v9 = 0;
  if ( this[406] != KeGetCurrentThread() )
  {
    KeAcquireInStackQueuedSpinLock(v7, &LockHandle);
    *((_QWORD *)v2 + 1) = KeGetCurrentThread();
    v9 = 1;
  }
  *((_QWORD *)this[392] + 49) = MEMORY[0xFFFFF78000000320];
  *((_QWORD *)this[392] + 49) += this[385];
  v4 = (struct _KTHREAD **)((char *)this[392] + 400);
  if ( !*v4 )
  {
    v5 = (struct _KTHREAD ***)(this + 403);
    a2 = this[403];
    if ( *((struct _KTHREAD ***)a2 + 1) != this + 403 )
      __fastfail(3u);
    *v4 = a2;
