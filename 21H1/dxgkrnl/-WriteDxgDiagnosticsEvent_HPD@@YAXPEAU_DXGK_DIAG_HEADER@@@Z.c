/*
 * XREFs of ?WriteDxgDiagnosticsEvent_HPD@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0019E30
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_HPD(struct _DXGK_DIAG_HEADER *a1, __int64 a2)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal((__int64)a1, a2) + 304200) )
  {
    if ( (unsigned int)dword_1C00AEA20 > 1
      && tlgKeywordOn((__int64)&dword_1C00AEA20, 0x200000000002LL)
      && tlgKeywordOn((__int64)&dword_1C00AEA20, v4) )
    {
      v8 = &unk_1C007D016;
LABEL_11:
      v10 = *((_WORD *)a1 + 2);
