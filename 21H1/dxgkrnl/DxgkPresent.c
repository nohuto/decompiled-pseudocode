/*
 * XREFs of DxgkPresent @ 0x1C0100C00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CWin32kLocks@@QEAA@QEBU_DXGKWIN32KENG_INTERFACE@@PEAVDXGADAPTER@@@Z @ 0x1C0025BA4 (--0CWin32kLocks@@QEAA@QEBU_DXGKWIN32KENG_INTERFACE@@PEAVDXGADAPTER@@@Z.c)
 *     ??1CWin32kLocks@@QEAA@XZ @ 0x1C0025BD0 (--1CWin32kLocks@@QEAA@XZ.c)
...
__int64 __fastcall DxgkPresent(char *Src)
{
  ...
  v6 = (char *)Global + 912;
  ++*((_DWORD *)Global + 233);
  v9 = ExpInterlockedPopEntrySList((PSLIST_HEADER)Global + 57);
  ListEntry = v9;
  if ( !v9 )
  {
    ++*((_DWORD *)v6 + 6);
...
LABEL_135:
    ...
    v104 = (union _SLIST_HEADER *)((char *)v103 + 912);
    ++*((_DWORD *)v103 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v103 + 57) >= *((_WORD *)v103 + 464) )
    {
LABEL_304:
...
LABEL_136:
  ...
  if ( !(*(unsigned int (**)(void))(*(_QWORD *)(v21 + 88) + 400LL))() && (*(_DWORD *)(&v9[5].Next + 1) & 0x8000) == 0 )
  {
    ...
    v109 = (union _SLIST_HEADER *)((char *)v108 + 912);
    ++*((_DWORD *)v108 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v108 + 57) < *((_WORD *)v108 + 464) )
    {
...
LABEL_18:
  ...
  if ( *((_BYTE *)v218 + 457) && *((_DWORD *)&v9[5].Next + 3) )
  {
    ...
    v130 = (union _SLIST_HEADER *)((char *)v129 + 912);
    ++*((_DWORD *)v129 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v129 + 57) < *((_WORD *)v129 + 464) )
    {
...
LABEL_221:
    ...
    v144 = (union _SLIST_HEADER *)((char *)v143 + 912);
    ++*((_DWORD *)v143 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v143 + 57) >= *((_WORD *)v143 + 464) )
    {
LABEL_370:
...
LABEL_280:
    ...
    v170 = (union _SLIST_HEADER *)((char *)v169 + 912);
    ++*((_DWORD *)v169 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v169 + 57) < *((_WORD *)v169 + 464) )
    {
  ...
  if ( (v42 & 0x10000000) != 0 )
  {
    if ( v38 )
    {
      ...
      *(_QWORD *)(v159 + 24) = 1339LL;
    }
    else
    {
      v159 = WdLogNewEntry5_WdError(v42, v35);
      *(_QWORD *)(v159 + 24) = 1333LL;
    }
  ...
  if ( (*(_DWORD *)(v38 + 348) & 0x100) != 0 && (v42 & 0x18000) == 0 )
  {
    ...
    *(_QWORD *)(v171 + 24) = 1349LL;
    ...
    v104 = (union _SLIST_HEADER *)((char *)v176 + 912);
    ++*((_DWORD *)v176 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v176 + 57) >= *((_WORD *)v176 + 464) )
      goto LABEL_304;
    goto LABEL_136;
  }
LABEL_41:
...
LABEL_42:
  ...
  if ( (*(_DWORD *)(&v9[5].Next + 1) & 0x200000) != 0 )
  {
    ...
    v186 = (union _SLIST_HEADER *)((char *)v185 + 912);
    ++*((_DWORD *)v185 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v185 + 57) < *((_WORD *)v185 + 464) )
    {
  ...
  if ( !v54 )
  {
    ...
    *(_QWORD *)(v187 + 24) = 1391LL;
    ...
    v144 = (union _SLIST_HEADER *)((char *)v192 + 912);
    ++*((_DWORD *)v192 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v192 + 57) >= *((_WORD *)v192 + 464) )
      goto LABEL_370;
LABEL_222:
  ...
  v57 = *(_QWORD *)(v217 + 16);
  if ( *(int *)(v57 + 2304) < 0x2000 )
    v58 = 1;
  else
    v58 = *(_DWORD *)(v57 + 280);
  if ( *(int *)(v57 + 2304) >= 0x2000 || *(_BYTE *)(v57 + 2604) )
    v60 = *(_DWORD *)(v57 + 2512) * ((v58 << 6) + ((8 * v58 + 199) & 0xFFFFFFF8)) + 8 * v58 + 584;
  else
    v60 = 1288;
  memset(v54, 0, v60);
  v61 = *(_QWORD *)(v217 + 16);
  if ( *(int *)(v61 + 2304) < 0x2000 )
    v62 = 1;
  else
    v62 = *(_DWORD *)(v61 + 280);
  v63 = *(int *)(v61 + 2304) >= 0x2000 || *(_BYTE *)(v61 + 2604);
  v64 = *(_DWORD *)(v61 + 2512);
  *((_BYTE *)&v54[21].Next + 12) = v63;
  if ( v63 )
  {
    *((_DWORD *)&v54[35].Next + 3) = v64;
    LODWORD(v54[36].Next) = v62;
    v65 = 8 * v62;
    v66 = v62 << 6;
    HIDWORD(v54[36].Next) = v64 * (v66 + ((v65 + 199) & 0xFFFFFFF8)) + 16;
    v67 = v64 * (v66 + ((v65 + 199) & 0xFFFFFFF8)) + 584;
...
LABEL_68:
    ...
    v78 = (char *)v77 + 912;
    ++*((_DWORD *)v77 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v77 + 57) >= *((_WORD *)v77 + 464) )
    {
      ++*((_DWORD *)v78 + 8);
  ...
  v199 = (union _SLIST_HEADER *)((char *)v198 + 912);
  ++*((_DWORD *)v198 + 235);
  if ( ExQueryDepthSList((PSLIST_HEADER)v198 + 57) < *((_WORD *)v198 + 464) )
  {
