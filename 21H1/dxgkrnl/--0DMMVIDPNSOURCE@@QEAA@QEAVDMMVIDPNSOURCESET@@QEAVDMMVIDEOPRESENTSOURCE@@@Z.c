/*
 * XREFs of ??0DMMVIDPNSOURCE@@QEAA@QEAVDMMVIDPNSOURCESET@@QEAVDMMVIDEOPRESENTSOURCE@@@Z @ 0x1C000F4B4
 * Callers:
        ...
        struct DMMVIDEOPRESENTSOURCE *const a3)
{
  ...
  IndexedSetElement<unsigned int>::IndexedSetElement<unsigned int>((__int64)this, *((unsigned int *)a3 + 6));
  *((_QWORD *)this + 12) = a3;
