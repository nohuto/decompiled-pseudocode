/*
 * XREFs of ?DdiSetTargetAnalogCopyProtection@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETANALOGCOPYPROTECTION@@@Z @ 0x1C021A534
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C00AE9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5079);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5079LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETANALOGCOPYPROTECTION *))(*((_QWORD *)this + 2)
                                                                                             + 1112LL))(
