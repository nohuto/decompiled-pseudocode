/*
 * XREFs of ?DmmGetSourceConnectedToTargetInClientVidPn@@YAJQEAXIPEAI@Z @ 0x1C00E7FDC
 * Callers:
...
LABEL_15:
  ...
  if ( v8 )
  {
    ...
    if ( v24 )
    {
      PathSourceFromTarget = DMMVIDPNTOPOLOGY::GetPathSourceFromTarget((DMMVIDPNTOPOLOGY *)(v24 + 96), v4);
