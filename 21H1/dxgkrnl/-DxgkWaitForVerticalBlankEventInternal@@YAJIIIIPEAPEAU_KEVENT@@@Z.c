/*
 * XREFs of ?DxgkWaitForVerticalBlankEventInternal@@YAJIIIIPEAPEAU_KEVENT@@@Z @ 0x1C0135030
 * Callers:
 ...
 *     ?WaitForVSync@REMOTE_VSYNC@@QEAAJXZ @ 0x1C00D6B40 (-WaitForVSync@REMOTE_VSYNC@@QEAAJXZ.c)
        ...
        struct _KEVENT **a5)
{
  ...
  if ( !a4 || *(_BYTE *)(v15 + 346) || g_OSTestSigningEnabled && (*(_BYTE *)(v15 + 348) & 2) != 0 )
  {
    ...
    if ( !(_DWORD)v8 && (unsigned int)DxgIsRemoteSessionUsingXddmMonitors() )
    {
      ...
      LODWORD(v42) = REMOTE_VSYNC::WaitForVSync((BLTQUEUE **)Global + 94);
LABEL_102:
        ...
        if ( v35 )
        {
          ...
          if ( (*(unsigned int (__fastcall **)(_QWORD, _QWORD, int *))(v35 + 224))(0LL, 0LL, &v122) )
          {
            if ( !v122 )
            {
              if ( !*(_BYTE *)(v24 + 209) )
                goto LABEL_109;
              v89 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal(v37, v36) + 88);
              if ( v89 )
              {
              ...
              if ( *((_DWORD *)SessionDataForSpecifiedSession + 4730) )
                v73 = (BLTQUEUE **)((char *)DXGGLOBAL::GetGlobal(v37, v36) + 824);
              else
LABEL_109:
                v73 = (BLTQUEUE **)((char *)DXGGLOBAL::GetGlobal(v37, v36) + 752);
...
LABEL_171:
        ...
        v52 = v116;
        v53 = (ADAPTER_DISPLAY **)((char *)v116 + 2672);
        v121 = (ADAPTER_DISPLAY **)((char *)v116 + 2672);
        if ( !*((_QWORD *)v116 + 334) )
        {
        ...
        _InterlockedIncrement((volatile signed __int32 *)v50 + v59 + 676);
        v50 = v115;
LABEL_65:
        v60 = 1;
...
LABEL_66:
        ...
        {
          v64 = *((_QWORD *)v63 + 2);
          if ( *(_QWORD *)(v64 + 2672) && *(_QWORD *)(v64 + 600) )
        ...
        if ( v60 )
        {
          ...
          if ( _InterlockedDecrement((volatile signed __int32 *)v115 + (unsigned int)v68 + 676) < 0 )
          {
            ...
            v108[3] = 275LL;
            v108[4] = 37LL;
            v108[6] = *((unsigned int *)v109 + v69 + 676);
            v108[7] = 0LL;
...
LABEL_197:
      ...
      {
        if ( (unsigned int)v6 < *(_DWORD *)(*((_QWORD *)v116 + 334) + 80LL) )
        {
          if ( DXGADAPTER::IsVSyncAvailable(v116, v6) )
          {
