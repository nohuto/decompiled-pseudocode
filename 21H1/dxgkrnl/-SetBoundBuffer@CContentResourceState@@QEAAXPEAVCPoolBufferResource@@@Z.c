/*
 * XREFs of ?SetBoundBuffer@CContentResourceState@@QEAAXPEAVCPoolBufferResource@@@Z @ 0x1C006C958
 * Callers:
 ...
 *     ?Remove@CContentResourceState@@UEAAXXZ @ 0x1C006B540 (-Remove@CContentResourceState@@UEAAXXZ.c)
 ...
 *     ??1CContentResourceState@@UEAA@XZ @ 0x1C006C3F4 (--1CContentResourceState@@UEAA@XZ.c)
 * Callees:
