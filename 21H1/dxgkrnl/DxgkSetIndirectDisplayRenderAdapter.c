/*
 * XREFs of DxgkSetIndirectDisplayRenderAdapter @ 0x1C02223D8
 * Callers:
 ...
 *     DXGKCALLONEXIT__lambda_412e717f5b4824a72ec987e49bacdc3c___ @ 0x1C0024720 (DXGKCALLONEXIT__lambda_412e717f5b4824a72ec987e49bacdc3c___.c)
...
LABEL_44:
    ...
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v47, (struct DXGFASTMUTEX *const)(*((_QWORD *)a1 + 334) + 136LL), 0);
    ...
    *(_QWORD *)(v22 + 8) = KeGetCurrentThread();
    if ( v23 )
    {
      ...
      if ( !*((_QWORD *)v23 + 335) || DXGADAPTER::IsComputeOnlyAdapter(v23) )
      {
...
LABEL_25:
    ...
    if ( *((_DWORD *)a1 + 50) == 1 && !*((_BYTE *)a1 + 2585) )
    {
      if ( v39[0] )
        ADAPTER_RENDER::DisconnectFromDisplayAdapters(*((ADAPTER_RENDER **)v39[0] + 335), a1, *((_DWORD *)a1 + 50));
      ADAPTER_DISPLAY::SetPairedRenderAdapter(*((ADAPTER_DISPLAY **)a1 + 334), v38[0], &v48);
      if ( v45 )
