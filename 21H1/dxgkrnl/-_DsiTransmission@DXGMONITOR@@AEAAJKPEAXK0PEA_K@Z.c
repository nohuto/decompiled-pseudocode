/*
 * XREFs of ?_DsiTransmission@DXGMONITOR@@AEAAJKPEAXK0PEA_K@Z @ 0x1C02F71E0
 * Callers:
 ...
 *     ?_ValidateMipiDsiPackets@DXGMONITOR@@AEAAJPEAU_DXGK_DSI_TRANSMISSION@@@Z @ 0x1C02F782C (-_ValidateMipiDsiPackets@DXGMONITOR@@AEAAJPEAU_DXGK_DSI_TRANSMISSION@@@Z.c)
 */
...
LABEL_13:
  ...
  v19 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 4) + 8LL) + 16LL) + 216LL) + 64LL)
                  + 40LL);
  if ( *(_DWORD *)(v19 + 28) < 0xC002u || (*((_DWORD *)this + 10) & 2) == 0 )
    goto LABEL_13;
