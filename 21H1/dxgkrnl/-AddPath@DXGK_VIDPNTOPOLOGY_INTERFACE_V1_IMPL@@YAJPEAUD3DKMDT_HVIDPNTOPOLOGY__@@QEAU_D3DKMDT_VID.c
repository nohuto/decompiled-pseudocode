/*
 * XREFs of ?AddPath@DXGK_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@QEAU_D3DKMDT_VIDPN_PRESENT_PATH@@@Z @ 0x1C02E3330
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _D3DKMDT_VIDPN_PRESENT_PATH *const a3)
{
  ...
  struct DMMVIDPNPRESENTPATH *v38; // [rsp+78h] [rbp+38h] BYREF
  struct DMMVIDPNPRESENTPATH *v39; // [rsp+80h] [rbp+40h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v35, 7041LL);
  if ( a2 )
  {
    ...
    if ( v15 )
    {
      ...
      v38 = 0LL;
      v39 = 0LL;
      v20 = DMMVIDPNTOPOLOGY::CreateNewPath(v15, (const struct _D3DKMDT_VIDPN_PRESENT_PATH *)a2, &v39);
      v25 = v20;
      ...
      else if ( v20 >= 0 )
      {
        ...
        v29 = DMMVIDPNTOPOLOGY::AddPath((DMMVIDPNTOPOLOGY **)v15, v38, 2LL, v28);
        v4 = v29;
        if ( v29 >= 0 )
        {
          v38 = 0LL;
  ...
  DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v35, v10);
