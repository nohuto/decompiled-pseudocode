/*
 * XREFs of ?_HandleMonitorPnPNotification@MONITOR_MGR@@SAJPEAX0@Z @ 0x1C017F7D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_27:
  ...
  {
    v42 = WdLogNewEntry5_WdDmmEvent(v14);
  ...
  *(_OWORD *)v57 = 0LL;
  ...
  v24 = COREADAPTERACCESS::AcquireExclusive((__int64)v60, v23 + 1, v23);
  LODWORD(v15) = v24;
  if ( v24 < 0 )
  {
    if ( v24 != -1073741130 )
