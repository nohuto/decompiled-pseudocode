/*
 * XREFs of ?PowerRuntimeComponentIdleStateCallback_Worker@DXGADAPTER@@QEAAXKKE@Z @ 0x1C00367BC
 * Callers:
 ...
 *     ?PowerRuntimeComponentIdleStateCallback_Thread@DXGADAPTER@@QEAAXXZ @ 0x1C020A1A8 (-PowerRuntimeComponentIdleStateCallback_Thread@DXGADAPTER@@QEAAXXZ.c)
 * Callees:
        ...
        char a4)
{
  ...
  if ( *((_DWORD *)this + 50) == 1 )
  {
    ...
    if ( (*(_DWORD *)(v9 + 216) & 2) == 0 )
    {
      *(_BYTE *)(v9 + 359) = 0;
      if ( !a4 )
        PoFxCompleteIdleState(*((_QWORD *)this + 348), (unsigned int)v5);
      if ( v4 )
      {
        if ( !v7 )
        {
  ...
  {
    PoFxCompleteIdleState(*((_QWORD *)this + 348), a2);
  }
}
