/*
 * XREFs of NtDxgkVailConnect @ 0x1C02B3F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDxgkVailConnect(__int64 a1, __int64 a2)
{
  ...
  char v59; // [rsp+28h] [rbp-58h]
  _BYTE v60[16]; // [rsp+30h] [rbp-50h] BYREF
  struct _KAPC_STATE ApcState; // [rsp+40h] [rbp-40h] BYREF
  char v62; // [rsp+70h] [rbp-10h]
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v60, *((struct DXGFASTMUTEX *const *)Current + 13), 0);
  ...
  if ( !*((_QWORD *)Current + 60) )
  {
    ...
    {
      if ( *((_QWORD *)DXGGLOBAL::GetGlobal(v8, v7) + 90) )
      {
        Object = 0LL;
        v37 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal(v32, v31) + 88);
        if ( v37 )
        {
        ...
        {
          v42 = DXGSESSIONDATA::ReferenceDwmProcess(SessionDataForSpecifiedSession, (struct _EPROCESS **)&Object);
          v20 = v42;
          if ( v42 >= 0 )
          {
            v62 = 0;
            CPROCESSATTACHHELPER::Attach(&ApcState, (PRKPROCESS)Object);
            v51 = DXGPROCESS::GetCurrent(v48, v47);
            if ( *((_BYTE *)v51 + 488) )
            {
              v52 = WdLogNewEntry5_WdWarning(v49, v27, v50);
            ...
            if ( (int)v20 >= 0 )
            {
              ...
              {
                v56 = WdLogNewEntry5_WdWarning(v54, v27, v55);
                *(_QWORD *)(v56 + 24) = v20;
...
LABEL_42:
  if ( v60[8] )
    DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v60, v27);
