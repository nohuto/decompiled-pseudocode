/*
 * XREFs of PiRegStateOpenClassKey @ 0x1C02C02E4
 * Callers:
 *     PpRegStateReadCreateClassCreationSettings @ 0x1C02C0674 (PpRegStateReadCreateClassCreationSettings.c)
 *     PpRegStateUpdateStackCreationSettings @ 0x1C02C07D8 (PpRegStateUpdateStackCreationSettings.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0024300 (__security_check_cookie.c)
 *     CmRegUtilCreateWstrKey @ 0x1C02C0AB0 (CmRegUtilCreateWstrKey.c)
 *     CmRegUtilOpenExistingWstrKey @ 0x1C02C0B84 (CmRegUtilOpenExistingWstrKey.c)
 */
