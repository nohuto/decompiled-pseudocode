/*
 * XREFs of ?NotifySharedPowerGraphicsFStateTransition@DXGGLOBAL@@QEAAXQEAXKIE@Z @ 0x1C0044844
 * Callers:
        ...
        char a5)
{
  ...
  {
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 191, &LockHandle);
  }
  else if ( (struct _KTHREAD *)this[193] != KeGetCurrentThread() )
  {
    DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(this + 192));
    v9 = 1;
  }
  for ( i = this[196]; (KSPIN_LOCK *)i != this + 196 && i; i = *(_QWORD *)i )
  {
  ...
  {
    ExReleasePushLockSharedEx(this + 192, 0LL);
