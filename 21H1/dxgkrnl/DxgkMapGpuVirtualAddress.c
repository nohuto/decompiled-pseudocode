/*
 * XREFs of DxgkMapGpuVirtualAddress @ 0x1C0145D30
 * Callers:
...
LABEL_123:
  ...
  if ( *(int *)(v20 + 2304) >= 0x2000 || *(_BYTE *)(v20 + 2604) )
    v21 = *((_DWORD *)DXGGLOBAL::GetGlobal(v20, v15) + 283);
  else
    v21 = 0;
  v92 = v21;
...
LABEL_96:
  ...
  if ( (*(_BYTE *)&v13->Protection.0 & 0xC) == 0 )
  {
    ...
    *(_QWORD *)AllocationSafe = 0LL;
    ...
    if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)v33, v32) + 283) )
    {
...
LABEL_67:
  ...
  if ( *(_BYTE *)(v39 + 209) )
  {
    ...
    v41 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendMapGpuVirtualAddress(
            (DXG_GUEST_VIRTUALGPU_VMBUS *)(v39 + 4208),
            HostProcess,
            0LL,
            v77,
            v90[0],
  ...
  {
    v40 = *(_BYTE *)(v19 + 1871) || *(_DWORD *)(v19 + 432) == 2 && *(int *)(v39 + 2572) >= 2000;
    LOBYTE(Timeout) = v40;
  ...
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)v43, v42) + 283) )
  {
