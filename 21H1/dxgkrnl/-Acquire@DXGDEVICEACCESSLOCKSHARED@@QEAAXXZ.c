/*
 * XREFs of ?Acquire@DXGDEVICEACCESSLOCKSHARED@@QEAAXXZ @ 0x1C00248DC
 * Callers:
 ...
 *     ?ReleasePowerTransitionLockShared@ADAPTER_RENDER@@QEAAXXZ @ 0x1C0024598 (-ReleasePowerTransitionLockShared@ADAPTER_RENDER@@QEAAXXZ.c)
