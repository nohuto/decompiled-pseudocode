/*
 * XREFs of ??0DMMVIDPNTARGETMODE@@QEAA@IT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@@Z @ 0x1C0058F6C
 * Callers:
 ...
 * Callees:
 *     ??0?$IndexedSetElement@I@@QEAA@I@Z @ 0x1C000F440 (--0-$IndexedSetElement@I@@QEAA@I@Z.c)
 */
