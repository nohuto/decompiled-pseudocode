/*
 * XREFs of ?IssueSyncObjectOpForAllContexts@DXGDEVICE@@QEAAJPEAVDXGPROCESS@@I_KH@Z @ 0x1C0250F4C
 * Callers:
  ...
  else
  {
    ...
    if ( v25 )
    {
      ...
      if ( v10 != v28 )
      {
        ...
        *(_QWORD *)(v29 + 24) = 5949LL;
        WdLogEvent5_WdAssertion(v29);
      }
      v30 = SignalSynchronizationObjectInternal(1u, &v44, 0, v10, v25, 0LL, v47, 0LL, v45, 0, 1);
      v8 = v30;
      if ( v30 >= 0 )
        goto LABEL_40;
