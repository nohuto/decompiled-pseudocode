/*
 * XREFs of ?wil_details_UpdateFeatureConfiguredStates@@YAXXZ @ 0x1C00D4670
 * Callers:
 *     ?wil_details_OnFeatureConfigurationChange@@YAXPEAX@Z @ 0x1C00D45F0 (-wil_details_OnFeatureConfigurationChange@@YAXPEAX@Z.c)
 * Callees:
