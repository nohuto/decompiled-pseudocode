/*
 * XREFs of ?UnpinPathContentScaling@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_N@Z @ 0x1C011C840
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  __int64 v50; // rax
  _QWORD *v51; // rax
  DXGK_ENUM_PIVOT v52; // [rsp+48h] [rbp-29h] BYREF
  __int64 Container; // [rsp+50h] [rbp-21h]
  int v54; // [rsp+58h] [rbp-19h] BYREF
  __int64 v55; // [rsp+60h] [rbp-11h]
  char v56; // [rsp+68h] [rbp-9h]
  struct _DXGKARG_ENUMVIDPNCOFUNCMODALITY v57; // [rsp+70h] [rbp-1h] BYREF
  _BYTE v58[32]; // [rsp+88h] [rbp+17h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v54, 6027LL);
  ...
  v52 = (DXGK_ENUM_PIVOT)__PAIR64__(v6, v7);
  ...
  if ( a4 )
  {
    ...
    LOBYTE(v18) = 3;
    ApplyPermissionWithinThisScope::ApplyPermissionWithinThisScope(v58, v22 + 152, v18);
    v24 = *(_QWORD *)(v19 + 8);
    if ( !v24 )
    {
    ...
    *((_DWORD *)&v57.EnumPivot + 2) = 0;
    v27 = *(ADAPTER_DISPLAY **)(v19 + 8);
    v57.hConstrainingVidPn = (D3DKMDT_HVIDPN)(Container & -(__int64)(Container != -88));
    v57.EnumPivotType = D3DKMDT_EPT_SCALING;
    v57.EnumPivot = v52;
    if ( !v27 )
    {
    ...
    v28 = ADAPTER_DISPLAY::DdiEnumVidPnCofuncModality(v27, &v57);
    v5 = v28;
    if ( v28 < 0 )
    {
      v47 = (_QWORD *)WdLogNewEntry5_WdError(v30, v29);
      v47[3] = v21;
      v47[4] = v57.EnumPivot.VidPnSourceId;
      v47[5] = v57.EnumPivot.VidPnTargetId;
      v47[6] = v5;
    ...
    ApplyPermissionWithinThisScope::~ApplyPermissionWithinThisScope((ApplyPermissionWithinThisScope *)v58);
    if ( (int)v5 < 0 )
    {
  ...
  else
  {
    ...
    v38[3] = 8LL;
    v38[4] = v21;
    v38[5] = v52.VidPnSourceId;
    v38[6] = v52.VidPnTargetId;
...
LABEL_28:
  DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v54, v31);
