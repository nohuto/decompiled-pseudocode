/*
 * XREFs of DxgGetHandleDataCB @ 0x1C0143380
 * Callers:
 *     <none>
 * Callees:
...
LABEL_55:
          ...
          if ( v67 )
          {
            ...
            {
              if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v60, (__int64)v59) + 283) )
              {
...
LABEL_17:
  ...
  if ( v66 )
  {
    ...
    v26 = *(_QWORD *)(v25 + 16);
    if ( *(int *)(v26 + 2304) >= 0x2000 || *(_BYTE *)(v26 + 2604) )
    {
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)v24, v25) + 283) )
      {
