/*
 * XREFs of ?DdiControlInterrupt2@DXGADAPTER@@QEAAJU_DXGKARG_CONTROLINTERRUPT2@@EI@Z @ 0x1C000E3A8
 * Callers:
 *     DXGADAPTER_DdiControlInterrupt2 @ 0x1C0040830 (DXGADAPTER_DdiControlInterrupt2.c)
...
LABEL_6:
  if ( !v5 )
  {
    ...
    if ( !(unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)this + 3904, 0LL) )
    {
      if ( bTracingEnabled )
      {
        v44 = *((unsigned int *)this + 982);
        if ( (_DWORD)v44 != -1 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
          McTemplateK0q_EtwWriteTransfer(v11, &EventBlockThread, v12, v44);
      }
      ExAcquirePushLockExclusiveEx((char *)this + 3904, 0LL);
    }
    *((_QWORD *)this + 489) = KeGetCurrentThread();
  }
LABEL_9:
  v13 = *((_QWORD *)this + 335);
  if ( !v13
    ...
    && *((struct _KTHREAD **)this + 336) != KeGetCurrentThread() )
  {
  ...
  if ( *((int *)this + 643) >= 2700 && *((_QWORD *)this + 167) )
  {
...
LABEL_49:
      *((_QWORD *)this + 489) = 0LL;
      ExReleasePushLockExclusiveEx((char *)this + 3904, 0LL);
      KeLeaveCriticalRegion();
      goto LABEL_50;
    }
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 492, &LockHandle);
    v30 = a4;
    if ( (*((_DWORD *)this + 636) & 0x10) == 0 )
    {
      **((_DWORD **)this + 482) = InterruptState;
LABEL_44:
      if ( InterruptState == DXGK_INTERRUPT_DISABLE )
      {
        if ( (*((_DWORD *)this + 636) & 0x10) != 0 )
        {
          if ( (_DWORD)v30 == -3 )
          {
            for ( i = 0; i < *((_DWORD *)this + 356); *(_QWORD *)(*((_QWORD *)this + 493) + 8 * v61) = 0LL )
              v61 = i++;
          }
          else
          {
            *(_QWORD *)(*((_QWORD *)this + 493) + 8 * v30) = 0LL;
          }
        }
        else
        {
    ...
    if ( a4 == -3 )
    {
      ...
      {
        v59 = v58++;
        *(_DWORD *)(*((_QWORD *)this + 482) + 4 * v59) = InterruptState;
      }
      while ( v58 < *((_DWORD *)this + 356) );
    }
    else
    {
      *(_DWORD *)(*((_QWORD *)this + 482) + 4LL * a4) = InterruptState;
    }
    v30 = a4;
    goto LABEL_44;
  }
LABEL_50:
  ...
  {
    if ( a4 == -3 || (v38 = a4, (*((_DWORD *)this + 636) & 0x10) == 0) )
      v38 = 0;
    v34 = *((_QWORD *)this + 494);
    ...
    if ( (*((_DWORD *)this + 636) & 0x10) == 0 )
    {
      v42 = (struct _KDPC *)*((_QWORD *)this + 484);
      v43 = (struct _KTIMER *)*((_QWORD *)this + 483);
LABEL_65:
    ...
    if ( a4 != -3 )
    {
      v42 = (struct _KDPC *)(((unsigned __int64)a4 << 6) + *((_QWORD *)this + 484));
      v43 = (struct _KTIMER *)(*((_QWORD *)this + 483) + ((unsigned __int64)a4 << 6));
      goto LABEL_65;
    }
    for ( j = 0; j < *((_DWORD *)this + 356); ++j )
      KeSetTimer(
        (PKTIMER)(*((_QWORD *)this + 483) + ((unsigned __int64)j << 6)),
        v41,
        (PKDPC)(((unsigned __int64)j << 6) + *((_QWORD *)this + 484)));
  }
LABEL_52:
