/*
 * XREFs of CreateDxgkSharedObjectTypes @ 0x1C017E798
 * Callers:
 *     ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C017CEEC (-Initialize@DXGGLOBAL@@QEAAJXZ.c)
 * Callees:
 *     ?GenericMapping@DxgkCompositionObject@@SA?AU_GENERIC_MAPPING@@XZ @ 0x1C001ABD0 (-GenericMapping@DxgkCompositionObject@@SA-AU_GENERIC_MAPPING@@XZ.c)
...
__int64 CreateDxgkSharedObjectTypes()
{
  ...
  if ( g_pDxgkSharedAllocationObjectType
    || (v1 = (struct _GENERIC_MAPPING)xmmword_1C007A018,
        ...
        (int)result >= 0) )
  {
    ...
    {
      v1 = (struct _GENERIC_MAPPING)xmmword_1C007A038;
      result = CreateSharedObject(
    ...
    if ( (int)result >= 0 )
    {
      ...
      {
        v1 = (struct _GENERIC_MAPPING)xmmword_1C007A048;
        result = CreateSharedObject(
          ...
          if ( (int)result >= 0 )
          {
            ...
            if ( (int)result >= 0 )
            {
              ...
              if ( (int)result >= 0 )
              {
                ...
                {
                  v1 = (struct _GENERIC_MAPPING)xmmword_1C007A028;
                  result = CreateSharedObject(
