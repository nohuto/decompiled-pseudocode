/*
 * XREFs of ?LogUnexpectedStartFailure@BLTQUEUE_REMOTE_VSYNC_SOURCE@@AEAAXJW4StartExitReason@1@@Z @ 0x1C02FBFFC
 * Callers:
...
void __fastcall BLTQUEUE_REMOTE_VSYNC_SOURCE::LogUnexpectedStartFailure(__int64 a1, int a2, int a3)
{
  ...
  if ( (unsigned int)dword_1C00AE9E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_1C00AE9E8, 0x400000080000LL) )
    {
      v8 = a3;
      v9 = a2;
      v10 = 33556480LL;
    ...
    if ( v7 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_1C00AE9E8, 0x80000LL) )
      {
        v18 = 0;
        v15 = 0;
        v16 = &v9;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_1C00AE9E8,
          (unsigned __int8 *)dword_1C007EECC,
          0LL,
          0LL,
          4u,
          &v12);
