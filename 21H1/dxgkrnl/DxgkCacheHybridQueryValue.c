/*
 * XREFs of DxgkCacheHybridQueryValue @ 0x1C014E110
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
          ...
          *v3 = v42[0].LowPart;
          DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v41, v11);
    ...
    DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v41, v28);
  }
  else
  {
