/*
 * XREFs of ?ExchangeTargetOwnershipDmm@DXGDISPLAYMANAGEROBJECT@@CAJPEBVDXGTARGETENTRY@@PEAV1@1_NW4_D3DKMT_DISPLAY_TARGET_USAGE@@@Z @ 0x1C02AC9F0
 * Callers:
        ...
        int a5)
{
  ...
  if ( v40[0] )
  {
    ...
    if ( (int)COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v42, 0LL) < 0 || !*((_QWORD *)v13 + 334) )
    {
