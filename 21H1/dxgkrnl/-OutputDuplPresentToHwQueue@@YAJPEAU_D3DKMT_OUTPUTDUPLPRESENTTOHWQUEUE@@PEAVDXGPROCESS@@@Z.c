/*
 * XREFs of ?OutputDuplPresentToHwQueue@@YAJPEAU_D3DKMT_OUTPUTDUPLPRESENTTOHWQUEUE@@PEAVDXGPROCESS@@@Z @ 0x1C0269A9C
 * Callers:
...
LABEL_68:
        ...
        v74 = (char *)Global + 912;
        ++*((_DWORD *)Global + 233);
        v75 = ExpInterlockedPopEntrySList((PSLIST_HEADER)Global + 57);
        if ( v75
              ...
              (v75 = (PSLIST_ENTRY)v77(v79, v76, v78, v74)) != 0LL) )
        {
          ...
          v89 = (union _SLIST_HEADER *)((char *)v88 + 912);
          ++*((_DWORD *)v88 + 235);
          if ( ExQueryDepthSList((PSLIST_HEADER)v88 + 57) < *((_WORD *)v88 + 464) )
          {
