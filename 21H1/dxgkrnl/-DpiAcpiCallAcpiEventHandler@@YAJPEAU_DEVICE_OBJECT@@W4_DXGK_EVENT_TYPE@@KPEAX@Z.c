/*
 * XREFs of ?DpiAcpiCallAcpiEventHandler@@YAJPEAU_DEVICE_OBJECT@@W4_DXGK_EVENT_TYPE@@KPEAX@Z @ 0x1C00574D4
 * Callers:
 *     ?DpiAcpiPowerStateCallback@@YAXPEAX00@Z @ 0x1C00210A0 (-DpiAcpiPowerStateCallback@@YAXPEAX00@Z.c)
 *     ?DpiAcpiEventCallback@@YAXPEAXK@Z @ 0x1C0057770 (-DpiAcpiEventCallback@@YAXPEAXK@Z.c)
 *     DpiAcpiDockEventCallback @ 0x1C02D15E0 (DpiAcpiDockEventCallback.c)
 * Callees:
  ...
  *(_QWORD *)&v23[4] = MEMORY[0xFFFFF78000000014];
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)PoolWithTag + 13) = *(_QWORD *)&v23[4];
    ...
    v15 = (_QWORD *)qword_1C00AFBE8;
    if ( *(__int64 **)qword_1C00AFBE8 != &qword_1C00AFBE0 )
      __fastfail(3u);
    *(_QWORD *)PoolWithTag = &qword_1C00AFBE0;
    *((_QWORD *)PoolWithTag + 1) = v15;
    *v15 = PoolWithTag;
    qword_1C00AFBE8 = (__int64)PoolWithTag;
    if ( !IoWorkItem )
    {
