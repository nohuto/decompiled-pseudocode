/*
 * XREFs of ?VmBusDdiGetStandardAllocationDriverData@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023B210
 * Callers:
 *     <none>
 * Callees:
...
LABEL_54:
      ...
      v32 = ADAPTER_RENDER::DdiGetStandardAllocationDriverData(*(ADAPTER_RENDER **)(v19 + 2680), &v41, v26);
      *v16 = v32;
      if ( v32 < 0 )
        goto LABEL_50;
