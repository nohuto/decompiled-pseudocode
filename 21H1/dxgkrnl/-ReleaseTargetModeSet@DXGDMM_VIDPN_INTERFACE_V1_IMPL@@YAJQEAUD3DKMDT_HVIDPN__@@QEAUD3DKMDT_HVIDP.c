/*
 * XREFs of ?ReleaseTargetModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C0128300
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      if ( v9 )
      {
        ...
        if ( ContainedBy<DMMVIDPN>::GetContainer(v14 + 64, v10) == v8 )
        {
          ...
          DMMVIDPNTARGET::ReleaseModeSet((struct DMMVIDPNTARGETMODESET **)v13, v12);
