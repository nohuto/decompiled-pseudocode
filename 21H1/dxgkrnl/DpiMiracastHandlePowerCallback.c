/*
 * XREFs of DpiMiracastHandlePowerCallback @ 0x1C02C9960
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiMiracastHandlePowerCallback(LPCGUID SettingGuid, _DWORD *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      if ( *Value )
      {
        if ( byte_1C00AFA1A && KeCancelTimer(&Timer) )
        {
          _InterlockedIncrement(&dword_1C00AFE50);
          v19 = 0LL;
          v15[0] = 6;
          v17 = 0LL;
          v16 = 0LL;
      ...
      {
        byte_1C00AFA1A = 1;
        if ( byte_1C00AFA18 && dword_1C00AFE38 )
        {
