/*
 * XREFs of ?CreatePeriodicMonitoredFenceNotificationInternal@@YAJPEAVDXGADAPTER@@0PEAVDXGSYNCOBJECT@@PEBU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@_N@Z @ 0x1C028B8EC
 * Callers:
        ...
        bool a5)
{
  ...
  if ( DXGADAPTER::IsDxgmms2(a1) || (*((_DWORD *)v10 + 87) & 0x100) != 0 )
  {
    ...
    if ( (int)v13 >= 0 )
    {
      ...
      v26 = ADAPTER_DISPLAY::MapVidPnTargetToVidPnSource(v18[334], a4->Info.Semaphore.InitialCount);
      v13 = v26;
      if ( v26 == -1 )
      {
