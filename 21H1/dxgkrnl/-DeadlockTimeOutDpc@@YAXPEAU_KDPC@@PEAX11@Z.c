/*
 * XREFs of ?DeadlockTimeOutDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C00356A0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  v27 = *(_QWORD *)(v4 + 316);
  if ( !_InterlockedCompareExchange64((volatile signed __int64 *)(v4 + 4376), UnbiasedInterruptTime, 0LL) )
  {
    if ( (unsigned int)dword_1C00AEA90 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000004000LL) )
      {
        ...
        v14 = *(_DWORD *)(v4 + 2768);
        v15 = *(unsigned __int8 *)(v4 + 2622);
        v16 = *(_DWORD *)(v4 + 4440);
        v17 = *(_DWORD *)(v4 + 4436);
        v18 = *(unsigned __int8 *)(v4 + 209);
        v19 = *(unsigned __int8 *)(v4 + 2516);
        v8 = UnbiasedInterruptTime - *DeferredContext;
        v20 = *(unsigned __int8 *)(v4 + 2511);
        v21 = *(_DWORD *)(v4 + 280);
        v34 = *(_WORD *)(v4 + 2572);
        v29 = *(_QWORD *)(v4 + 1576);
        v30 = *(void **)(v4 + 1568);
    ...
    ExQueueWorkItem((PWORK_QUEUE_ITEM)(v4 + 4392), CriticalWorkQueue);
