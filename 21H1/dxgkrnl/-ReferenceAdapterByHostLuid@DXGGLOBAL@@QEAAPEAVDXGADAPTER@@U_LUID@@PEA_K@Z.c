/*
 * XREFs of ?ReferenceAdapterByHostLuid@DXGGLOBAL@@QEAAPEAVDXGADAPTER@@U_LUID@@PEA_K@Z @ 0x1C0266798
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  LowPart = a2.LowPart;
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v12, (DXGGLOBAL *)((char *)this + 512), 0);
  ...
  while ( v7 != v6 && v7 )
  {
    v8 = v7;
    v7 = *(char **)v7;
    if ( *((_DWORD *)v8 + 1073) == LowPart && *((_DWORD *)v8 + 1074) == HighPart )
    {
      _m_prefetchw(v8 + 24);
      v9 = *((_QWORD *)v8 + 3);
      while ( v9 )
