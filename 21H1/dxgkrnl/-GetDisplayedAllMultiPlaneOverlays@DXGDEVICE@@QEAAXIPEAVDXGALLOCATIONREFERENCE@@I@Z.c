/*
 * XREFs of ?GetDisplayedAllMultiPlaneOverlays@DXGDEVICE@@QEAAXIPEAVDXGALLOCATIONREFERENCE@@I@Z @ 0x1C004952C
 * Callers:
        ...
        unsigned int a4)
{
  ...
  {
    ADAPTER_DISPLAY::GetAllocationsForAllPlanes(*(ADAPTER_DISPLAY **)(v6 + 2672), a2, a3, a4);
  }
  else
  {
