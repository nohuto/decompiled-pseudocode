/*
 * XREFs of DxgkSignalSynchronizationObjectFromGpuByReference @ 0x1C0112D30
 * Callers:
 *     ?SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z @ 0x1C000BED0 (-SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z.c)
 *     ?AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z @ 0x1C00628D0 (-AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z.c)
...
LABEL_24:
  ...
  v35 = v85;
  KeEnterCriticalRegion();
  ExAcquireResourceSharedLite(v35[51], 1u);
  v86 = 1;
