/*
 * XREFs of ?AcquireDmaBuffer@DXGCONTEXT@@QEAAJPEAPEAU_VIDMM_DMA_BUFFER@@PEAVCOREDEVICEACCESS@@E@Z @ 0x1C015D374
 * Callers:
    ...
    *((_QWORD *)v7 + 31) = 0LL;
    ...
    if ( SyncObject < 0 )
    {
      ...
      *(_QWORD *)(v33 + 32) = v9;
      ...
      if ( v44 )
        DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v43, (__int64)a2);
      goto LABEL_17;
    }
    if ( v44 )
      DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v43, (__int64)a2);
