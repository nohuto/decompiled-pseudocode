/*
 * XREFs of ??_GCCompositionFrameCollection@@IEAAPEAXI@Z @ 0x1C0007BB0
 * Callers:
 *     ?Release@CCompositionFrameCollection@@UEAAJXZ @ 0x1C0007C70 (-Release@CCompositionFrameCollection@@UEAAJXZ.c)
 * Callees:
