/*
 * XREFs of ?DxgkSetKernelDisplayPolicy@@YAJW4DXGK_DISPLAY_POLICY@@H@Z @ 0x1C0156970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSetKernelDisplayPolicy(__int64 a1, __int64 a2)
{
  ...
  v2 = a2;
  v3 = a1;
  SessionDataForSpecifiedSession = (struct DXGSESSIONDATA *)*((_QWORD *)DXGGLOBAL::GetGlobal(a1, a2) + 88);
