/*
 * XREFs of ?VmBusPropagatePresentHistoryToken@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUDXGKVMB_COMMAND_PROPAGATEPRESENTHISTORYTOKEN@@@Z @ 0x1C003FA1C
 * Callers:
 ...
 *     ?PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@@_N11111@Z @ 0x1C003EF2C (-PropagatePresentHistoryToken@DXGPRESENTHISTORYTOKENQUEUE@@QEAAXPEAU_D3DKMT_PRESENTHISTORYTOKEN@.c)
 */
        ...
        struct DXGKVMB_COMMAND_PROPAGATEPRESENTHISTORYTOKEN *a1)
{
  ...
  if ( !v2 || (unsigned __int64)v2 > MmUserProbeAddress )
  {
    ...
    if ( *((_QWORD *)a1 + 3) > MmUserProbeAddress && *((_QWORD *)a1 + 4) > MmUserProbeAddress )
    {
      ...
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)v2, v4) + 380) >= 0x18u )
        v3 = *((_BYTE *)a1 + 48) & 1;
