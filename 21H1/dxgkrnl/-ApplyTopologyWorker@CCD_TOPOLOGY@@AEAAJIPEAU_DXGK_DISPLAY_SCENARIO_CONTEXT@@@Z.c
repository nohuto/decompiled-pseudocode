/*
 * XREFs of ?ApplyTopologyWorker@CCD_TOPOLOGY@@AEAAJIPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0131CF0
 * Callers:
 ...
 *     ?IsMatchingSource@CCD_TOPOLOGY@@SA_NAEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@0@Z @ 0x1C0011BFC (-IsMatchingSource@CCD_TOPOLOGY@@SA_NAEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@0@Z.c)
 ...
 *     ?BuildPrimaryPathIndexFromCloneGroupId@CCD_TOPOLOGY@@QEAAXXZ @ 0x1C00EBF30 (-BuildPrimaryPathIndexFromCloneGroupId@CCD_TOPOLOGY@@QEAAXXZ.c)
 ...
 *     ?CleanupPrimaryPathIndex@CCD_TOPOLOGY@@QEAAXXZ @ 0x1C0132B18 (-CleanupPrimaryPathIndex@CCD_TOPOLOGY@@QEAAXXZ.c)
 *     ?InvalidateCache@QDC_CACHE@@QEAAX_N@Z @ 0x1C0132B5C (-InvalidateCache@QDC_CACHE@@QEAAX_N@Z.c)
 *     _CCD_TOPOLOGY::ApplyTopologyWorker_::_2_::_AUTO_USING_PM_PrimaryClonePathIndex2732::__AUTO_USING_PM_PrimaryClonePathIndex2732 @ 0x1C0132BF4 (_CCD_TOPOLOGY--ApplyTopologyWorker_--_2_--_AUTO_USING_PM_PrimaryClonePathIndex2732--__AUTO_USING.c)
 *     _CCD_TOPOLOGY::ApplyTopologyWorker_::_2_::_AUTO_USING_PM_PathChanged2734::__AUTO_USING_PM_PathChanged2734 @ 0x1C0132C30 (_CCD_TOPOLOGY--ApplyTopologyWorker_--_2_--_AUTO_USING_PM_PathChanged2734--__AUTO_USING_PM_PathCh.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  struct tagRECT v159; // [rsp+40h] [rbp-C0h] BYREF
  struct DXGPROCESS *Current; // [rsp+50h] [rbp-B0h]
  __int64 v161; // [rsp+58h] [rbp-A8h] BYREF
  unsigned int v162; // [rsp+60h] [rbp-A0h]
  __int64 v163; // [rsp+68h] [rbp-98h] BYREF
  unsigned int v164; // [rsp+70h] [rbp-90h]
  __int64 v165; // [rsp+78h] [rbp-88h] BYREF
  unsigned int v166; // [rsp+80h] [rbp-80h]
  __int64 v167; // [rsp+88h] [rbp-78h] BYREF
  unsigned int v168; // [rsp+90h] [rbp-70h]
  _BYTE v169[64]; // [rsp+A0h] [rbp-60h] BYREF
  __int64 v170; // [rsp+E0h] [rbp-20h]
  int v171; // [rsp+F4h] [rbp-Ch]
  ...
  *(_QWORD *)&v159.left = a3;
  ...
  v173 = 0;
  v5 = 8;
  CCD_TOPOLOGY::CCD_TOPOLOGY((CCD_TOPOLOGY *)v169, 8u, 0);
  v10 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal(v7, v6) + 88);
  if ( v10 )
  {
  ...
  if ( !SessionDataForSpecifiedSession )
  {
    ...
    *(_QWORD *)(v136 + 24) = (unsigned int)PsGetCurrentProcessSessionId(v137);
    v138 = v136;
...
LABEL_133:
  ...
  if ( !Current )
  {
    v139 = WdLogNewEntry5_WdError(v17, v16);
LABEL_132:
    v138 = v139;
    goto LABEL_133;
  }
  if ( (unsigned int)DxgIsSessionUsingWddmMonitors() )
  {
    for ( i = 8; ; v5 = i )
    {
      if ( (unsigned __int16)CCD_TOPOLOGY::Reserve((CCD_TOPOLOGY *)v169, v5, v21, v22) < v5 )
      {
        v156 = WdLogNewEntry5_WdLowResource(v24, v23, v25, v26);
        *(_QWORD *)(v156 + 24) = *((_QWORD *)this + 8);
        *(_QWORD *)(v156 + 32) = v5;
      ...
      v171 |= 3u;
      v27 = CCD_TOPOLOGY::RetrieveActive((CCD_TOPOLOGY *)v169, 0LL, 1, 1, &i);
      v13 = v27;
      if ( v27 != -1073741789 )
        break;
    }
    if ( v27 < 0 )
    {
      v139 = WdLogNewEntry5_WdError(v29, v28);
      *(_QWORD *)(v139 + 24) = *((_QWORD *)this + 8);
      *(_QWORD *)(v139 + 32) = v13;
      goto LABEL_132;
    }
    v30 = *((_QWORD *)this + 8);
    ...
    CCD_TOPOLOGY::BuildPrimaryPathIndexFromCloneGroupId((CCD_TOPOLOGY *)v169);
          ...
          *(_DWORD *)(v72 + 296) = 0;
          if ( *(_WORD *)(v31 + 20) )
          {
            ...
            else
            {
              v142 = *((_QWORD *)this + 8);
              if ( !CCD_TOPOLOGY::IsMatchingSource(
                      (struct D3DKMT_PATHMODALITY_DESCRIPTOR *)(272LL * *(unsigned int *)(v72 + 292) + v142 + 48),
                      (struct D3DKMT_PATHMODALITY_DESCRIPTOR *)(272 * v76 + v31 + 48)) )
              {
                *(_DWORD *)(v143 + v142 + 296) = 1;
      ...
      if ( v59 )
      {
        ...
        do
        {
          ...
          if ( v79 )
          {
            ...
            {
              v146 = 336LL * v80;
              if ( *(_DWORD *)(v145 + v31 + 64) == *(_DWORD *)(v146 + v144)
                && *(_DWORD *)(v145 + v31 + 68) == *(_DWORD *)(v146 + v144 + 4) )
              {
                break;
              }
              ++v80;
...
LABEL_72:
      ...
      if ( v100 )
      {
        ...
        do
        {
          ...
          if ( v104 < 0 )
          {
            v147 = (_QWORD *)WdLogNewEntry5_WdError(v101, v105);
            v147[3] = *(int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + v106 + 4);
            v147[4] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 336LL * v101);
            v147[5] = *((_QWORD *)this + 8);
            v147[6] = v107;
          ...
          else
          {
            ...
            if ( *(_QWORD *)(v71 + v106 + 80) )
            {
              v108 = CCD_TOPOLOGY::ApplyTopologyOnAdapter(
                       ...
                       LowPart,
                       v101,
                       *(struct _DXGK_DISPLAY_SCENARIO_CONTEXT **)&v159.left);
              v109 = v108;
              if ( v108 < 0 )
              {
                v148 = (_QWORD *)WdLogNewEntry5_WdError(v58, v71);
      ...
      QDC_CACHE::InvalidateCache(*((QDC_CACHE **)v110 + 158), 0);
      v111 = *((_QWORD *)this + 8);
      if ( *(_WORD *)(v111 + 20) )
      {
        v112 = 0;
...
LABEL_90:
        ...
        {
          v149 = WdLogNewEntry5_WdAssertion(v111, v113);
          WdLogEvent5_WdAssertion(v149);
          v113 = *((_QWORD *)this + 8);
        }
        v159.left = *(_DWORD *)(v114 + v113 + 192);
        v159.right = *(_DWORD *)(v114 + v113 + 200) + v159.left;
        v159.top = *(_DWORD *)(v114 + v113 + 196);
        v117 = *(_DWORD *)(v114 + v113 + 204) + v159.top;
        Luid = 0LL;
        v159.bottom = v117;
        ...
        else
        {
          ...
          {
            v150 = WdLogNewEntry5_WdAssertion(v135, v134);
        ...
        if ( v118 < 0 )
        {
          v151 = (_QWORD *)WdLogNewEntry5_WdError(v120, v119);
          v151[3] = *(int *)(v114 + *((_QWORD *)this + 8) + 68);
          v151[4] = *(unsigned int *)(v114 + *((_QWORD *)this + 8) + 64);
          v151[5] = *(unsigned int *)(v114 + *((_QWORD *)this + 8) + 72);
          v151[6] = v121;
...
LABEL_99:
      ...
      CCD_TOPOLOGY::CleanupPrimaryPathIndex((CCD_TOPOLOGY *)v169);
      v123 = *((_QWORD *)this + 8);
      v124 = 0;
      v125 = 0LL;
      v126 = *(_DWORD *)(v123 + 36);
...
LABEL_107:
        if ( v124 )
        {
          v159 = 0LL;
          v159.left = 11;
          v152 = DxgkStatusChangeNotify(&v159.left, v123, v125);
          v153 = v152;
          if ( v152 < 0 )
          {
            v154 = WdLogNewEntry5_WdError(v122, v123);
            *(_QWORD *)(v154 + 24) = v153;
        ...
        for ( j = 0; j < *(_WORD *)(v128 + 20); ++j )
        {
          ...
          if ( *(int *)(v131 + v128 + 240) >= 0 )
          {
            ...
            if ( v132 == 12 )
            {
              v155 = 4LL;
LABEL_164:
              DXGGLOBAL::RecordFeatureUsage(v129, v155, 1LL);
              goto LABEL_115;
            }
            if ( v132 == 30 )
            {
...
LABEL_115:
    ...
    {
      v141 = WdLogNewEntry5_WdLowResource(v54, v51, v52, v53);
      *(_QWORD *)(v141 + 24) = this;
      *(_QWORD *)(v141 + 32) = *((_QWORD *)this + 8);
      WdLogEvent5_WdLowResource(v141);
      LODWORD(v13) = -1073741801;
    }
    CCD_TOPOLOGY::ApplyTopologyWorker_::_2_::_AUTO_USING_PM_PathChanged2734::__AUTO_USING_PM_PathChanged2734(&v161);
    CCD_TOPOLOGY::ApplyTopologyWorker_::_2_::_AUTO_USING_PM_PathChanged2734::__AUTO_USING_PM_PathChanged2734(&v163);
    CCD_TOPOLOGY::ApplyTopologyWorker_::_2_::_AUTO_USING_PM_PrimaryClonePathIndex2732::__AUTO_USING_PM_PrimaryClonePathIndex2732(&v165);
    CCD_TOPOLOGY::ApplyTopologyWorker_::_2_::_AUTO_USING_PM_PrimaryClonePathIndex2732::__AUTO_USING_PM_PrimaryClonePathIndex2732(&v167);
  }
  else
  {
    v140 = WdLogNewEntry5_WdError(v20, v19);
    *(_QWORD *)(v140 + 24) = Current;
    WdLogEvent5_WdError(v140);
    LODWORD(v13) = -1073741790;
  }
LABEL_118:
  CCD_TOPOLOGY::~CCD_TOPOLOGY((CCD_TOPOLOGY *)v169);
  if ( v173 )
