/*
 * XREFs of ?TdrCollectDbgInfoStage1@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C0260450
 * Callers:
 ...
 *     DpiGetAdapterDebugData @ 0x1C004F5A4 (DpiGetAdapterDebugData.c)
 *     DpiGetDbgInfoAdapters @ 0x1C004F628 (DpiGetDbgInfoAdapters.c)
 *     DpiGetGlobalDebugData @ 0x1C004F718 (DpiGetGlobalDebugData.c)
 ...
 *     ??0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z @ 0x1C025F85C (--0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z.c)
 ...
 *     ?TdrIsDisplayOnlyTdr@@YA_NW4_TDR_TIMEOUT_REASON@@@Z @ 0x1C0261694 (-TdrIsDisplayOnlyTdr@@YA_NW4_TDR_TIMEOUT_REASON@@@Z.c)
        ...
        *((_DWORD *)a1 + 33) = 6;
        ...
        if ( !IsDisplayOnlyTdr && (_DWORD)v93 != 6 )
        {
          ...
          if ( v56 )
          {
            ...
            v58 = v55;
            v59 = (*(__int64 (__fastcall **)(struct _TDR_RECOVERY_CONTEXT *, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2680LL) + 616LL) + 8LL)
                                                                                            + 600LL))(
                    a1,
                    v57,
                    v55);
        ...
        if ( (_DWORD)v64 != 3 && !(unsigned __int8)TdrIsDisplayOnlyTdr(v64) && v53 != 6 )
        {
          ...
          if ( v67 )
          {
            ...
            if ( v69 )
              ...
              v70 = 0LL;
            if ( !(*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, char *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2680LL) + 640LL) + 8LL)
                                                                                             + 352LL))(
                    *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2680LL) + 648LL),
                    *((unsigned int *)a1 + 14),
                    *((_QWORD *)a1 + 8),
                    v70,
                    v68,
