/*
 * XREFs of ?ConvertPathModalityToDisplayConfig@@YAJPEAUD3DKMT_GETPATHSMODALITY@@_N1PEAU_QDC_CONTEXT@@@Z @ 0x1C00E459C
 * Callers:
    ...
    while ( 1 )
    {
        ...
        || (v41 = IsInternalVideoOutput(*(enum _D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY *)((char *)a1 + v18 + 136))) )
      {
        ...
        *v4 = v36;
        ...
        {
          *v4 = v36 | 8;
          *((_DWORD *)v4 + 45) = GetColorDepthFromPickedWireFormat(
                                   *(unsigned int *)((char *)a1 + v18 + 252),
                                   0x1000000000000LL);
