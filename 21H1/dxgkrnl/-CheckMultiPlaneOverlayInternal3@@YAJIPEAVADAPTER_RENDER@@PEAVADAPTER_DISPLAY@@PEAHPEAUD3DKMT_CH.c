/*
 * XREFs of ?CheckMultiPlaneOverlayInternal3@@YAJIPEAVADAPTER_RENDER@@PEAVADAPTER_DISPLAY@@PEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1C024E414
 * Callers:
      ...
      if ( v28 )
      {
        ...
        if ( v36 )
        {
          ...
          if ( v70 )
          {
            ...
            LODWORD(v71) = 0;
            v56 = *((_QWORD *)v74 + 2);
            if ( *(_QWORD *)(v56 + 928) && *(_BYTE *)(v56 + 2618) )
              v57 = -1;
            else
              v57 = v75;
            ...
            v66 = *((_QWORD *)v74 + 2);
            if ( *(_QWORD *)(v66 + 928) && *(_BYTE *)(v66 + 2618) )
            {
            ...
            else
            {
              v67 = (struct _KTHREAD **)v72;
              v68 = v73;
              if ( (unsigned int)v60 <= *(_DWORD *)(v66 + 2512) )
              {
                if ( *(_QWORD *)(v66 + 896) )
