/*
 * XREFs of ?GetAllocationSize@@YAJPEAVDXGDEVICE@@IPEAUtagRECT@@@Z @ 0x1C0295268
 * Callers:
...
LABEL_23:
  ...
  if ( *(_QWORD *)(v26 + 16) == v27 )
  {
    ...
    if ( (int)ADAPTER_RENDER::DdiDescribeAllocation(*(ADAPTER_RENDER **)(*(_QWORD *)(v25 + 16) + 2680LL), &v33, v25) >= 0 )
    {
      Width = v33.Width;
      a3->left = 0;
      a3->top = 0;
