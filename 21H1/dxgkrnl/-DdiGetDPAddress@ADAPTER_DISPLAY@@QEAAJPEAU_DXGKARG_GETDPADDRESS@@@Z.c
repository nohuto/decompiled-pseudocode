/*
 * XREFs of ?DdiGetDPAddress@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETDPADDRESS@@@Z @ 0x1C0217204
 * Callers:
        ...
        __int64 a3)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rcx
  __int64 (__fastcall *v13)(_QWORD, struct _DXGKARG_GETDPADDRESS *); // rax
  int v14; // ebx
  _QWORD *v15; // rax
  ...
  if ( (qword_1C00AE9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5150);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5150LL);
  ...
  if ( v12 && (v13 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_GETDPADDRESS *))(v12 + 40)) != 0LL )
