/*
 * XREFs of ?CompleteTopologyTransitionCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C012AE30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_CleanUpFromSimulatedMonitor@MONITOR_MGR@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C014F940 (-_CleanUpFromSimulatedMonitor@MONITOR_MGR@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z.c)
...
__int64 __fastcall CompleteTopologyTransitionCallback(struct DXGADAPTER *this, _QWORD *a2)
{
  ...
  v6 = COREADAPTERACCESS::AcquireExclusive((__int64)v36, v5 + 1, v5);
  v11 = 0;
  if ( v6 < 0 )
  {
    if ( v6 == -1073741130 )
    ...
    if ( v12 )
    {
      ...
      if ( *(_DWORD *)(v12 + 80) )
      {
        do
        {
          ...
          while ( 1 )
          {
            v15 = DmmEnumClientVidPnPathTargetsFromSource(this, v13, v14++, &v34);
            if ( v15 < 0 || v34 == -1 )
              break;
            v35 = D3DKMDT_VOT_UNINITIALIZED;
            DmmGetVideoOutputTechnology(this, v34, 0LL, &v35);
            if ( v35 == D3DKMDT_VOT_MIRACAST )
            {
              if ( *(_DWORD *)a2 || *((_DWORD *)a2 + 1) )
              {
                v27 = WdLogNewEntry5_WdAssertion(v22, v21);
                *(_QWORD *)(v27 + 24) = 7456LL;
                WdLogEvent5_WdAssertion(v27);
              }
              *a2 = *(_QWORD *)((char *)this + 316);
            }
            v33[0] = 0;
            if ( (int)MonitorIsMonitorConnected(this, v34, 0LL, v33) >= 0 && !v33[0] )
            {
              v28 = WdLogNewEntry5_WdTrace(v24, v23, v25, v26);
              *(_QWORD *)(v28 + 24) = this;
              *(_QWORD *)(v28 + 32) = v34;
              MonitorCreateSimulatedMonitor(this, v31, 0, v32, (__int64)v2);
            }
          }
          ++v13;
        }
        while ( v13 < *(_DWORD *)(*((_QWORD *)this + 334) + 80LL) );
      }
