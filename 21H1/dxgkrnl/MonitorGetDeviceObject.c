/*
 * XREFs of MonitorGetDeviceObject @ 0x1C00ED9EC
 * Callers:
 ...
 * Callees:
 *     ?_GetDeviceObject@DXGMONITOR@@QEBAJPEAPEAU_FILE_OBJECT@@PEAPEAU_DEVICE_OBJECT@@@Z @ 0x1C0009BB0 (-_GetDeviceObject@DXGMONITOR@@QEBAJPEAPEAU_FILE_OBJECT@@PEAPEAU_DEVICE_OBJECT@@@Z.c)
...
LABEL_16:
  ...
  v30 = 0LL;
  if ( (int)MONITOR_MGR::_GetMonitorInstance(v14, v5, 1u, &v30) < 0 )
  {
