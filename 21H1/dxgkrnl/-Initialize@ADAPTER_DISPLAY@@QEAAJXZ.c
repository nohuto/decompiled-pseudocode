/*
 * XREFs of ?Initialize@ADAPTER_DISPLAY@@QEAAJXZ @ 0x1C0179600
 * Callers:
 ...
 *     ?Initialize@DISPLAY_SOURCE@@AEAAJPEAVADAPTER_DISPLAY@@I@Z @ 0x1C017A270 (-Initialize@DISPLAY_SOURCE@@AEAAJPEAVADAPTER_DISPLAY@@I@Z.c)
...
__int64 __fastcall ADAPTER_DISPLAY::Initialize(ADAPTER_DISPLAY *this)
{
  ...
  v2 = *(unsigned int *)(*((_QWORD *)this + 2) + 1424LL);
  *((_DWORD *)this + 20) = v2;
  v3 = (unsigned int)v2;
  v4 = 3968 * v2;
...
LABEL_11:
    ...
    {
      v62 = (struct _LUID)*((_QWORD *)DXGGLOBAL::GetGlobal(v16, v15) + 93);
      v63 = *((_QWORD *)this + 2);
      v86 = v62;
    ...
    if ( OutputDuplManager >= 0 )
    {
      ...
      *((_BYTE *)this + 252) = v27 == 1;
      ...
      if ( (*(_DWORD *)(v23 + 348) & 0x400) != 0 )
      {
        ...
        {
          LODWORD(EventHandle) = (*(_DWORD *)(v23 + 2552) >> 1) & 1;
          memset(v89, 0, sizeof(v89));
          LODWORD(v89[1]) = 288;
      ...
      *((_BYTE *)this + 250) = v31;
      ...
      if ( (*(_DWORD *)(*((_QWORD *)this + 2) + 348LL) & 0x800) != 0 )
      {
        *((_BYTE *)this + 250) = 1;
        ...
        DXGADAPTERSOURCEHASH::ForceReducedHashSize((struct DXGGLOBAL *)((char *)v74 + 1160));
LABEL_31:
        v34 = *((_QWORD *)this + 2);
        if ( !*(_QWORD *)(v34 + 2680) )
        {
          ...
          *((_QWORD *)this + 48) = DodPresent;
          ...
          else
          {
            *(_OWORD *)&v87[0].LowPart = 0LL;
            v88 = 0LL;
            v75 = *(int (__fastcall **)(_QWORD, struct _LUID *))(v36 + 1936);
            if ( v75 && v75(*(_QWORD *)(v36 + 1864), v87) >= 0 )
            {
              v37 = (char *)this + 364;
              v76 = 0LL;
        ...
        v41 = *((_QWORD *)this + 2);
        v43 = __OFSUB__(*(_DWORD *)(v41 + 2304), 8704);
        v42 = *(_DWORD *)(v41 + 2304) - 8704 < 0;
        v44 = *(_QWORD *)(v41 + 216);
        v45 = v42 ^ v43;
        ...
        *((_BYTE *)this + 251) = !v30;
        ...
        if ( (int)DXGADAPTERSOURCEHASH::AddNewAdapterEntry(
                    (struct DXGGLOBAL *)((char *)v52 + 1160),
