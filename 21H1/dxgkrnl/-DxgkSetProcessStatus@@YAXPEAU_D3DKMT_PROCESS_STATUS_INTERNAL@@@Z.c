/*
 * XREFs of ?DxgkSetProcessStatus@@YAXPEAU_D3DKMT_PROCESS_STATUS_INTERNAL@@@Z @ 0x1C014A020
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkSetProcessStatus(struct _D3DKMT_PROCESS_STATUS_INTERNAL *a1, __int64 a2)
{
  ...
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)a1, a2) + 362)
    && _InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal(v4, v3) + 361, 1, 1) )
  {
    return;
  }
  v5 = *(_QWORD *)a1;
