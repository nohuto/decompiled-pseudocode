/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1C00E1CFC
 * Callers:
 *     BmlCompareTargetModesWithMonitor @ 0x1C00DF6C8 (BmlCompareTargetModesWithMonitor.c)
 * Callees:
 *     ?HaveEquivalentMonitorFrequencyRequirements@DMMVIDEOSIGNALMODE@@SAEAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@0E@Z @ 0x1C0008AD4 (-HaveEquivalentMonitorFrequencyRequirements@DMMVIDEOSIGNALMODE@@SAEAEBU_D3DKMDT_VIDEO_SIGNAL_INF.c)
 *     BmlIsEDIDCapableOutputTechonology @ 0x1C00DFFC4 (BmlIsEDIDCapableOutputTechonology.c)
 *     MonitorGetNextMonitorSourceMode @ 0x1C00E1E90 (MonitorGetNextMonitorSourceMode.c)
 *     BmlGetMonitorModePreference @ 0x1C00E1FAC (BmlGetMonitorModePreference.c)
...
LABEL_14:
  ...
  if ( v8 == 1
    && (v20 || BmlIsEDIDCapableOutputTechonology(a3) && v9 && !(unsigned int)BmlCompareModeExtents(a1 + 84, v18)) )
  {
    return 11;
  }
