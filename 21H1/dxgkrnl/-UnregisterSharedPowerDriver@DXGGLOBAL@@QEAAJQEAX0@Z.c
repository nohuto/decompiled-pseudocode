/*
 * XREFs of ?UnregisterSharedPowerDriver@DXGGLOBAL@@QEAAJQEAX0@Z @ 0x1C0267900
 * Callers:
...
LABEL_19:
  *((_QWORD *)this + 193) = 0LL;
  ExReleasePushLockExclusiveEx((char *)this + 1536, 0LL);
