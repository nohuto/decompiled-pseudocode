/*
 * XREFs of ?PinPathContentRotation@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C02DACD4
 * Callers:
 ...
 *     ?GetContainer@?$ContainedBy@VDMMVIDPNTOPOLOGY@@@@QEBAPEAVDMMVIDPNTOPOLOGY@@XZ @ 0x1C005A2B4 (-GetContainer@-$ContainedBy@VDMMVIDPNTOPOLOGY@@@@QEBAPEAVDMMVIDPNTOPOLOGY@@XZ.c)
        ...
        BOOLEAN a4)
{
  ...
  __int64 v67; // r9
  _QWORD *v68; // r14
  ADAPTER_DISPLAY *v69; // rax
  __int64 v70; // rax
  __int64 v71; // rax
  __int64 v72; // [rsp+20h] [rbp-60h]
  struct _DXGKARG_ISSUPPORTEDVIDPN v73; // [rsp+40h] [rbp-40h] BYREF
  struct _DXGKARG_ENUMVIDPNCOFUNCMODALITY v74; // [rsp+50h] [rbp-30h] BYREF
  _BYTE v75[24]; // [rsp+68h] [rbp-18h] BYREF
  DXGK_ENUM_PIVOT v76; // [rsp+C8h] [rbp+48h] BYREF
  BOOLEAN v77; // [rsp+D8h] [rbp+58h]
...
LABEL_8:
  ...
  v18 = *((_QWORD *)a2 + 12);
  v76.VidPnSourceId = *(_DWORD *)(*((_QWORD *)a2 + 11) + 24LL);
  v19 = *(unsigned int *)(v18 + 24);
  v20 = -(v17 + 88);
  v76.VidPnTargetId = v19;
...
LABEL_36:
  ...
  v32 = this[1];
  *(_QWORD *)&v73.IsVidPnSupported = 0LL;
  v73.hDesiredVidPn = v21;
  if ( !v32 )
  {
  ...
  IsSupportedVidPn = ADAPTER_DISPLAY::DdiIsSupportedVidPn(v32, &v73);
  v12 = IsSupportedVidPn;
  if ( IsSupportedVidPn >= 0 )
  {
    IsVidPnSupported = v73.IsVidPnSupported;
    LODWORD(v12) = 0;
  }
  else
  {
  ...
  if ( (int)v12 >= 0 )
  {
    ...
    *((_DWORD *)&v74.EnumPivot + 2) = 0;
    v61 = this[1];
    v74.hConstrainingVidPn = v21;
    v74.EnumPivotType = D3DKMDT_EPT_ROTATION;
    v74.EnumPivot = v76;
    if ( !v61 )
    {
    ...
    v63 = ADAPTER_DISPLAY::DdiEnumVidPnCofuncModality(v61, &v74);
    v12 = v63;
    if ( v63 >= 0 )
    {
      LODWORD(v12) = 0;
    ...
    else
    {
      ...
      v66[3] = v21;
      v66[4] = v74.EnumPivot.VidPnSourceId;
      v66[5] = v74.EnumPivot.VidPnTargetId;
      v66[6] = v12;
      WdLogEvent5_WdError(v66);
    }
    ApplyPermissionWithinThisScope::~ApplyPermissionWithinThisScope((ApplyPermissionWithinThisScope *)v75, v64);
    if ( (int)v12 >= 0 )
    {
      LODWORD(v12) = 0;
    }
    ...
    {
      v68 = (_QWORD *)WdLogNewEntry5_WdTrace(v45, v44, v46, v67);
      v68[3] = v21;
      v68[4] = 9LL;
      v68[5] = &v76;
      v69 = this[1];
      if ( !v69 )
      {
        v70 = WdLogNewEntry5_WdAssertion(v45, v44);
...
LABEL_62:
    v71 = WdLogNewEntry5_WdWarning(v45, v44, v46);
    *(_QWORD *)(v71 + 24) = v51;
    *(_QWORD *)(v71 + 32) = a2;
