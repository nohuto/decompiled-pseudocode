/*
 * XREFs of DxgkIddHandleSetDisplayConfig @ 0x1C0256B4C
 * Callers:
 ...
 *     _lambda_1ecc0e3e99406e51155bf30eed62debb_::operator() @ 0x1C025631C (_lambda_1ecc0e3e99406e51155bf30eed62debb_--operator().c)
...
void __fastcall DxgkIddHandleSetDisplayConfig(__int64 a1, unsigned int a2, DWORD *a3, int *a4)
{
...
LABEL_78:
    ...
    DXGADAPTERSTOPRESETLOCKSHARED::Acquire((DXGADAPTERSTOPRESETLOCKSHARED *)v95);
    LowPart = v86[0][25].LowPart;
    if ( (_DWORD)LowPart != 1 || BYTE1(v86[0][323].LowPart) )
    {
LABEL_76:
...
LABEL_41:
    ...
    v55 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal(v48, v47) + 88);
    if ( v55 )
    {
      v56 = PsGetCurrentProcessSessionId(v53);
    ...
    if ( !KeReadStateEvent(*(PRKEVENT *)(*(_QWORD *)&v86[0][334] + 560LL)) )
    {
      LOBYTE(v58) = 1;
    ...
    *a4 = v67;
    if ( v67 >= 0 )
    {
      ...
      *a4 = DxgkSendDisplayBrokerMessage(1179648LL, (struct _PORT_MESSAGE *)(v65 + 16), 0LL, v113, &v99, 0LL, &v98);
      ...
      if ( (_DWORD)v74 != 1 || BYTE1(v86[0][323].LowPart) )
      {
