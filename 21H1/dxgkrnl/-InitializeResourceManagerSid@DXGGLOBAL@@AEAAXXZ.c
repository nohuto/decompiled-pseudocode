/*
 * XREFs of ?InitializeResourceManagerSid@DXGGLOBAL@@AEAAXXZ @ 0x1C017DBB8
 * Callers:
  ...
  *((_QWORD *)this + 38024) = v3;
  if ( v3 )
  {
    ...
    *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
    ...
    {
      *RtlSubAuthoritySid(*((PSID *)this + 38024), 0) = 80;
      *RtlSubAuthoritySid(*((PSID *)this + 38024), 1u) = 1988685059;
      *RtlSubAuthoritySid(*((PSID *)this + 38024), 2u) = 1921232356;
      *RtlSubAuthoritySid(*((PSID *)this + 38024), 3u) = 378231328;
      *RtlSubAuthoritySid(*((PSID *)this + 38024), 4u) = -1590824699;
      *RtlSubAuthoritySid(*((PSID *)this + 38024), 5u) = 890457928;
    }
  }
  else
  {
    v13 = WdLogNewEntry5_WdWarning(v5, v4, v6);
    *(_QWORD *)(v13 + 24) = 6014LL;
