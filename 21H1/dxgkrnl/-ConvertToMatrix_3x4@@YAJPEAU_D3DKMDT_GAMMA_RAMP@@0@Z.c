/*
 * XREFs of ?ConvertToMatrix_3x4@@YAJPEAU_D3DKMDT_GAMMA_RAMP@@0@Z @ 0x1C005FE14
 * Callers:
 *     ColorSpaceTransformConvert @ 0x1C0008838 (ColorSpaceTransformConvert.c)
 * Callees:
 *     memmove @ 0x1C0026580 (memmove.c)
 *     ?InitializeIdentityLut@@YAJPEAUD3DDDI_DXGI_RGB@@IMM@Z @ 0x1C0060030 (-InitializeIdentityLut@@YAJPEAUD3DDDI_DXGI_RGB@@IMM@Z.c)
 *     ?InitializeIdentityMatrix@@YAJPEAMII@Z @ 0x1C00600C0 (-InitializeIdentityMatrix@@YAJPEAMII@Z.c)
 *     ColorSpaceTransformCombine @ 0x1C0060114 (ColorSpaceTransformCombine.c)
 */

__int64 __fastcall ConvertToMatrix_3x4(struct _D3DKMDT_GAMMA_RAMP *a1, struct _D3DKMDT_GAMMA_RAMP *a2)
{
  unsigned int v2; // ebx
      ...
      do
      {
        ...
        do
        {
          if ( v11 >= 3 )
            ...
            v13 = *(_DWORD *)&pRgb256x3x16->Red[2 * v9 + 2 * v12];
          *(_DWORD *)v6->Red = v13;
          ++v11;
