/*
 * XREFs of ?ReadConfig@DXGADAPTER@@AEAAXPEAU_DXGK_ADAPTER_CAPS@@@Z @ 0x1C0175C0C
 * Callers:
...
void __fastcall DXGADAPTER::ReadConfig(DXGADAPTER *this, struct _DXGK_ADAPTER_CAPS *a2)
{
  ...
  v4 = v34 == 0;
  *((_BYTE *)this + 2589) = v32 != 0;
  *((_DWORD *)this + 650) = v33;
  *((_QWORD *)this + 324) = v105;
  v5 = !v4;
  v4 = v27 == 0;
  *((_BYTE *)this + 2604) = v5;
  v6 = !v4;
  ...
  *((_DWORD *)this + 661) = v40;
  *((_BYTE *)this + 2612) = !v4;
  if ( v42 || (v13 = 0, (*((_DWORD *)this + 509) & 0x100) != 0) )
    v13 = 1;
  v4 = v43 == 0;
  *((_BYTE *)this + 2590) = v13;
  v14 = !v4;
  ...
  *((_BYTE *)this + 2591) = v14;
  ...
  if ( !v45 || (v15 = 1, *((int *)this + 576) < 8704) )
    v15 = 0;
  v16 = v29 < 2;
  *((_BYTE *)this + 2621) = v15;
  *((_DWORD *)this + 658) = v46;
  ...
  *((_DWORD *)this + 659) = v17;
  ...
  v4 = v51 == 0;
  *((_BYTE *)this + 2640) = v18;
  *((_DWORD *)this + 1106) = v48;
  *((_DWORD *)this + 1107) = v49;
  *((_DWORD *)this + 1108) = v50;
  *((_BYTE *)this + 2772) = !v4;
  *((_DWORD *)this + 990) = v52;
  if ( v53 )
    *((_DWORD *)this + 1080) = v53;
  if ( v54 )
    *((_BYTE *)this + 2507) = 1;
  if ( v55 )
    *((_BYTE *)this + 2508) = 0;
  if ( v56 )
    *((_DWORD *)this + 508) |= 0x20u;
  if ( *((_BYTE *)this + 2508) )
  {
    if ( *((_BYTE *)this + 2586) )
      *((_DWORD *)this + 628) = 2;
