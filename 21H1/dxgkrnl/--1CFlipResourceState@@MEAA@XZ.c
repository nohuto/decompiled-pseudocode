/*
 * XREFs of ??1CFlipResourceState@@MEAA@XZ @ 0x1C0069FEC
 * Callers:
 *     ??_ECFlipResourceState@@MEAAPEAXI@Z @ 0x1C006A0E0 (--_ECFlipResourceState@@MEAAPEAXI@Z.c)
 *     ??_GCPoolBufferResourceState@@UEAAPEAXI@Z @ 0x1C006A130 (--_GCPoolBufferResourceState@@UEAAPEAXI@Z.c)
