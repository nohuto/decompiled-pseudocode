/*
 * XREFs of DxgkGetOverlayState @ 0x1C0277690
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
  ...
  if ( v28 >= 0 )
  {
    ...
    if ( OverlayState >= 0 )
    {
      ...
      *v37 = v48.OverlayEnabled;
    }
    DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v49, (__int64)v37);
