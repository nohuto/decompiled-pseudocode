/*
 * XREFs of ?CreateCddAllocations@ADAPTER_DISPLAY@@QEAAJPEAVDXGDEVICE@@IAEBU_D3DKMT_DISPLAYMODE@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C013EFA0
 * Callers:
  ...
  *(_QWORD *)&v121 = v7;
  ...
  if ( *(_QWORD *)(v20 + v16 + 88) )
  {
    ...
    if ( (*(_DWORD *)(v75 + 4) & 0x10) == 0 )
    {
      ...
      v78 = ADAPTER_RENDER::DdiDescribeAllocation(v77, &v117);
      v82 = v78;
      if ( v78 >= 0 )
      {
    ...
    v84 = ADAPTER_DISPLAY::DestroyCddAllocations(this, a2, v7);
    v30 = v84;
    if ( v84 < 0 )
    {
  ...
  if ( *((_QWORD *)a2 + 231) == v23 || (*((_BYTE *)a2 + 1869) & 1) != 0 )
  {
    v24 = 0;
    v109 = 1;
    v111 = 0;
  ...
  {
    v109 = 0;
    v24 = (*(_DWORD *)(v23 + 348) & 0x10) != 0;
    v111 = v24;
    if ( (*(_DWORD *)(v23 + 348) & 0x10) == 0 )
    {
      v110 = 1;
      goto LABEL_28;
    }
  ...
  if ( StandardAllocation >= 0 )
  {
    if ( !LODWORD(v120[1]) )
    {
      v91 = WdLogNewEntry5_WdAssertion(v28, v21);
      *(_QWORD *)(v91 + 24) = 903LL;
      WdLogEvent5_WdAssertion(v91);
    }
    if ( !HIDWORD(v120[1]) )
    {
      v92 = WdLogNewEntry5_WdAssertion(v28, v21);
      *(_QWORD *)(v92 + 24) = 905LL;
      WdLogEvent5_WdAssertion(v92);
    }
    v31 = *((_QWORD *)this + 2);
    if ( *(int *)(v31 + 2304) >= 0x2000 )
      v32 = *(_DWORD *)(v31 + 280);
    else
      v32 = 1;
    if ( !v32 )
...
LABEL_28:
      ...
      if ( v109 )
      {
        ...
        v45 = ADAPTER_RENDER::DdiDescribeAllocation(v44, &v117);
        v48 = v45;
        if ( v45 >= 0 )
        {
...
LABEL_50:
          ...
          if ( v109 )
          {
            ...
            v96 = *((_QWORD *)this + 2);
            v97 = *(int *)(v96 + 2304) < 0x2000 ? 1 : *(_DWORD *)(v96 + 280);
            if ( v97 )
            {
              v98 = v16 + 88;
              v99 = v97;
...
LABEL_24:
  ...
  v87 = (_QWORD *)WdLogNewEntry5_WdWarning(v28, v21, v29);
  v87[3] = v9->Width;
  v87[4] = v9->Height;
  v87[5] = a2;
  v87[6] = v15;
