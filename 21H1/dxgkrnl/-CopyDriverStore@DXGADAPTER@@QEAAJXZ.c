/*
 * XREFs of ?CopyDriverStore@DXGADAPTER@@QEAAJXZ @ 0x1C025D5A0
 * Callers:
...
__int64 __fastcall DXGADAPTER::CopyDriverStore(DXGADAPTER *this, __int64 a2)
{
  ...
  v4 = 0LL;
  Handle = (HANDLE)-1LL;
  v7 = (struct _KTHREAD **)*((_QWORD *)DXGGLOBAL::GetGlobal((__int64)this, a2) + 183);
  v66 = 0;
  if ( *((_BYTE *)this + 210) )
  {
  ...
  v68[0] = 3;
  v10 = (DXGADAPTER *)((char *)this + 4208);
  v67.pPrivateDriverData = v68;
  v67.hAdapter = 0;
  *(_QWORD *)&v67.PrivateDriverDataSize = 1072LL;
  v67.Type = KMTQAITYPE_QUERYREGISTRY;
  v11 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendQueryAdapterInfo((DXGADAPTER *)((char *)this + 4208), 0LL, &v67, 0x430u);
  v14 = v11;
  if ( v11 < 0 )
    goto LABEL_4;
