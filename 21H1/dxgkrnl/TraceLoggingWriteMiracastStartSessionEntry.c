/*
 * XREFs of TraceLoggingWriteMiracastStartSessionEntry @ 0x1C0058E78
 * Callers:
...
void TraceLoggingWriteMiracastStartSessionEntry()
{
  ...
  if ( (unsigned int)dword_1C00AEA90 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000000000LL) )
    {
      ...
      v2 = v0;
      v3 = 16;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00AEA90, (unsigned __int8 *)dword_1C007E43B, v0, 0LL, 3u, &v1);
    }
  }
}
