/*
 * XREFs of ?BltFromVm@DXGCONTEXT@@QEAAJIIIPEAPEAV1@UtagRECT@@1IPEBU2@PEAVCOREDEVICEACCESS@@@Z @ 0x1C027A91C
 * Callers:
...
LABEL_14:
  ...
  if ( v101 )
  {
    ...
    v32 = ADAPTER_RENDER::DdiDescribeAllocation(
            *(ADAPTER_RENDER **)(*(_QWORD *)(*(_QWORD *)(v28 + 16) + 16LL) + 2680LL),
            &v109,
            v29);
    v26 = v32;
    if ( v32 < 0 )
          ...
          if ( v100 )
          {
            ...
            if ( *(_QWORD *)(v50 + 16) == v52 )
            {
              ...
              v53 = ADAPTER_RENDER::DdiDescribeAllocation(
                      *(ADAPTER_RENDER **)(*(_QWORD *)(*(_QWORD *)(v49 + 16) + 16LL) + 2680LL),
                      &v108,
                      v50);
              v26 = v53;
              if ( v53 >= 0 )
