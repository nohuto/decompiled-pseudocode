/*
 * XREFs of DxgkGetDeviceStateInternal @ 0x1C00FA640
 * Callers:
 ...
 *     DxgkGetDeviceState @ 0x1C00FA600 (DxgkGetDeviceState.c)
          ...
          if ( v5 )
          {
            ...
            else
            {
              DeviceState = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendGetDeviceState(
                              (struct DXGADAPTER *)((char *)v66 + 4208),
...
LABEL_102:
      ...
      if ( (_DWORD)v21 != 1 )
      {
        ...
        if ( v35 )
        {
          ...
          v37 = *((_QWORD *)v73 + 231);
          if ( !v37
            || (v38 = *(unsigned int *)(*(_QWORD *)(v37 + 2672) + 80LL),
        ...
        else
        {
          ...
          v42 = *((_QWORD *)v73 + 231);
          if ( !v42
            || (v38 = *(unsigned int *)(*(_QWORD *)(v42 + 2672) + 80LL),
                v14->PresentState.VidPnSourceId < (unsigned int)v38) )
          {
