/*
 * XREFs of DpiFdoHandleDevicePower @ 0x1C0162F00
 * Callers:
 *     DpiFdoDispatchPower @ 0x1C0162620 (DpiFdoDispatchPower.c)
 * Callees:
 *     DxgkReportDeviceDirectedPowerDown @ 0x1C003A43C (DxgkReportDeviceDirectedPowerDown.c)
...
LABEL_96:
      if ( (PDEVICE_OBJECT)qword_1C00AFCB8 == DeviceObject )
      {
        if ( (_BYTE)v27 )
        {
          ...
          {
            LOBYTE(v28) = 1;
            DpiAcquirePostDisplayInfoFromBgfx(&xmmword_1C00AFCC8, v28, 0LL);
            byte_1C00AFD88 = 0;
            dword_1C00AFDB4 = 1;
          }
        }
