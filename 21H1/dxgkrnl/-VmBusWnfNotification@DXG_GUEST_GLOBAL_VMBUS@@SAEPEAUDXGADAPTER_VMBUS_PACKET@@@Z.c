/*
 * XREFs of ?VmBusWnfNotification@DXG_GUEST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C024CB20
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_GUEST_GLOBAL_VMBUS::VmBusWnfNotification(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  {
    v10 = *((unsigned int *)DXGGLOBAL::GetGlobal(v8, v7) + 184);
    if ( *(_DWORD *)v6 == (_DWORD)v10 && *(_DWORD *)(v1 + 48) == *((_DWORD *)DXGGLOBAL::GetGlobal(v10, v9) + 185) )
    {
      *v6 = *((_QWORD *)DXGGLOBAL::GetGlobal(v12, v11) + 93);
