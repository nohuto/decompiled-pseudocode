/*
 * XREFs of ?BmlPreparePathOrderAndVidPn@@YAJPEAPEAUBML_VIDPN_PATH_ORDER@@PEAVDMMVIDPN@@PEBUD3DKMT_GETPATHSMODALITY@@GGW4DXGK_DIAG_CCD_BML_ORIGIN@@I@Z @ 0x1C00E4A24
 * Callers:
 ...
 *     ?D3DKMDT_VPPR_CONVERT_ROTATION_GIVEN_OFFSET@@YA?AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W41@0@Z @ 0x1C005BDCC (-D3DKMDT_VPPR_CONVERT_ROTATION_GIVEN_OFFSET@@YA-AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W41@0@Z.c)
        ...
        int a7)
{
  ...
  *a1 = (__int64)v11;
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v21 + 16) + 2680LL) )
  {
  ...
  else
  {
    ...
    v126 = *(_QWORD *)(*(_QWORD *)(v124 + 16) + 2672LL);
    if ( *(_QWORD *)(*(_QWORD *)(v126 + 16) + 2680LL) )
    {
    ...
    *(_DWORD *)(*a1 + 8) ^= v129;
    ...
    DisplayOnlyDriverUseRawModes = ADAPTER_DISPLAY::GetDisplayOnlyDriverUseRawModes(
                                     *(ADAPTER_DISPLAY **)(*(_QWORD *)(v131 + 16) + 2672LL),
                                     v128);
    v134 = *a1;
    ...
    *(_DWORD *)(*a1 + 8) = v135 | *(_DWORD *)(*a1 + 8) & 0xFFFFFFFB;
    ...
    v139 = ADAPTER_DISPLAY::GetDisplayOnlyDriverIgnoreMonitorFreqCheck(
             *(DXGADAPTER ***)(*(_QWORD *)(v137 + 16) + 2672LL),
             v135);
    v22 = (unsigned __int8 *)*a1;
  ...
  v25 = ADAPTER_DISPLAY::ForceIHVScaling(*(ADAPTER_DISPLAY **)(*(_QWORD *)(v24 + 16) + 2672LL));
  v27 = v26;
  ...
  *((_DWORD *)v22 + 1) = a7;
        ...
        *(_DWORD *)(v34 + v33 + 104) = 0;
        if ( a6 == 2 )
        {
          ...
          SessionViewOwner = ADAPTER_DISPLAY::GetSessionViewOwner(
                               *(ADAPTER_DISPLAY **)(*(_QWORD *)(v144 + 16) + 2672LL),
                               *(_DWORD *)(v30 + 24));
          v26 = 0;
  ...
  if ( (_BYTE)v37 )
  {
    do
    {
      ...
      if ( (int)(v39 + 1) > 32 )
      {
        v149 = WdLogNewEntry5_WdAssertion(v41, v28);
        *(_QWORD *)(v149 + 24) = *a1;
        *(_QWORD *)(v149 + 32) = v39;
...
LABEL_213:
          ...
          v244 = 0LL;
          MonitorInstance = MONITOR_MGR::_GetMonitorInstance(v170, v168, 1u, &v244);
          LODWORD(v70) = MonitorInstance;
          if ( MonitorInstance == -1073741275 )
          {
            v174 = WdLogNewEntry5_WdDmmEvent();
            *(_QWORD *)(v174 + 24) = v168;
            *(_QWORD *)(v174 + 32) = v167;
...
LABEL_164:
          ...
          v179 = IsVirtualModeSuportDisabled || *(_BYTE *)(v242 + 249) == 0;
          v252 = v179;
          v230 = v179;
LABEL_175:
...
LABEL_183:
        ...
        else if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v162, v161) + 282) )
        {
          v180 = *((_DWORD *)DXGGLOBAL::GetGlobal(v182, v181) + 282);
          goto LABEL_183;
        }
        v49 = v233;
        v48 = v231;
...
LABEL_63:
      ...
      if ( *(_BYTE *)(v82 + 129) && (*(_DWORD *)v82 & 0x20000) != 0 )
      {
...
LABEL_149:
      ...
      if ( *(int *)(*(_QWORD *)(v155 + 16) + 2572LL) < 1105 )
      {
...
LABEL_105:
  ...
  v241 = -1;
  if ( (int)BmlGetNextBestTargetMode(*a1, a2, (unsigned __int16)v98, v111, (__int64)v105, 0xFFFFFFFF, &v241) >= 0 )
  {
    v70 = VIDPN_MGR::PinVidPnTargetMode(v235, v111, v241, 1);
    v113 = 0;
    if ( (int)v70 < 0 )
    {
