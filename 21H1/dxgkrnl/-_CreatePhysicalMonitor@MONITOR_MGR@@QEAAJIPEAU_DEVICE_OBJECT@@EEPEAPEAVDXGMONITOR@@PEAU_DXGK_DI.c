/*
 * XREFs of ?_CreatePhysicalMonitor@MONITOR_MGR@@QEAAJIPEAU_DEVICE_OBJECT@@EEPEAPEAVDXGMONITOR@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01676EC
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a7)
{
  ...
  *v7 = 0LL;
  v12 = (char *)operator new[](0x538uLL, 0x4D677844u, (POOL_TYPE)512);
  if ( v12 )
  ...
  if ( v15 )
  {
    ...
    else
    {
      ...
      MONITOR_MGR::_InsertMonitorToList((struct _FAST_MUTEX *)this, v15);
    }
    LOBYTE(v19) = a4;
    v24 = (int)DXGMONITOR::_InitializeMonitor(v15, (unsigned int)v9, a3, v19, a5, 1, 0LL, a7);
    if ( v20 )
      v20[55] = 0LL;
    else
