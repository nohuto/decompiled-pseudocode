/*
 * XREFs of ?FindBlockListStrings@@YAJPEAGIIPEBGW4_QAI_DRIVERVERSION@@PEAIPEAU_UNICODE_STRING@@@Z @ 0x1C0178C50
 * Callers:
...
LABEL_44:
                      if ( (v39 || v48)
                        ...
                        && tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000000200LL) )
                      {
                      ...
                      if ( v59[0] != (_BYTE)v20 && (unsigned int)dword_1C00AEA90 > 5 )
                      {
                        if ( tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000001000LL) )
                        {
                          v64 = a5;
                          v73 = v71;
