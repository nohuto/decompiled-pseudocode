/*
 * XREFs of ?AcquireNextModeInfo@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@QEBU_D3DKMDT_VIDPN_TARGET_MODE@@PEAPEBU3@@Z @ 0x1C011DF40
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v11 )
    {
      ...
      if ( v14 && *v14 == 305419896 )
      {
               ...
               v15) )
        {
          ...
          {
            v36 = WdLogNewEntry5_WdDmmEvent(v20);
            *(_QWORD *)(v36 + 24) = v14;
            *(_QWORD *)(v36 + 32) = v11;
