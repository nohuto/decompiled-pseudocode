/*
 * XREFs of ?InitializeVirtualGpuManager@DXGVIRTUALGPUMANAGER_PARAV@@UEAAJPEAU_DXGKARG_SETGPUPARTITIONCOUNT@@@Z @ 0x1C0231890
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGKARG_SETGPUPARTITIONCOUNT *a2)
{
  ...
  if ( (unsigned int)PartitionCount > *(_DWORD *)(v5 + 4320) )
  {
