/*
 * XREFs of ?StartRuntimePowerManagement@DXGADAPTER@@QEAAXXZ @ 0x1C020B6F0
 * Callers:
...
void __fastcall DXGADAPTER::StartRuntimePowerManagement(DXGADAPTER *this)
{
  ...
  if ( *((_QWORD *)this + 348) )
  {
    ...
    if ( *((int *)this + 576) >= 0x2000 && v2 >= 0x5006 )
    ...
    if ( !*((_BYTE *)this + 3216) )
    {
      v3 = *((unsigned int *)this + 731);
      if ( (_DWORD)v3 != -1 )
        DXGADAPTER::SetPowerComponentActiveCBInternal(this, v3, 0, 0);
    }
    PoFxStartDevicePowerManagement(*((_QWORD *)this + 348));
    if ( v2 >= 0x3008 )
