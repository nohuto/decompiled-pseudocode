/*
 * XREFs of ?UpdateLatencyTolerances@DXGADAPTER@@QEAAXXZ @ 0x1C0037EA4
 * Callers:
...
void __fastcall DXGADAPTER::UpdateLatencyTolerances(DXGADAPTER *this)
{
  ...
  v1 = (char *)this + 3240;
  v12 = (KSPIN_LOCK *)((char *)this + 3240);
  v14 = 0;
  if ( *((struct _KTHREAD **)this + 406) != KeGetCurrentThread() )
  {
    KeAcquireInStackQueuedSpinLock(v12, &LockHandle);
    *((_QWORD *)v1 + 1) = KeGetCurrentThread();
    v14 = 1;
  }
  if ( *((_QWORD *)this + 392) && *((_DWORD *)this + 40) != 1 )
  {
    v3 = *((_DWORD *)this + 733);
    if ( *((_BYTE *)this + 3218) )
    {
...
LABEL_21:
        if ( *((_BYTE *)this + 3216) )
          DXGADAPTER::SetPowerComponentLatencyCB(this, *((_DWORD *)this + 731), v5);
        v8 = *((_DWORD *)this + 732);
        if ( v8 != -1 )
    ...
    {
      if ( !v3 || (v7 = *((_DWORD *)this + 805), (unsigned int)(v7 - 2) <= 1) )
      {
        v5 = *((_QWORD *)this + 394);
        v6 = *((_QWORD *)this + 400);
        goto LABEL_21;
...
LABEL_25:
  if ( *((_DWORD *)this + 733) )
    ...
    v9 = *((_QWORD *)this + 396);
  v10 = (DXGADAPTER *)*((_QWORD *)this + 410);
  while ( v10 != (DXGADAPTER *)((char *)this + 3280) )
  {
    v11 = v10;
    v10 = *(DXGADAPTER **)v10;
    if ( v9 == *((_QWORD *)v11 - 7) )
