/*
 * XREFs of ?OutputDuplPreIndirectPresent@@YAJPEAVDXGDEVICE@@IPEAPEAVDXGADAPTER@@PEA_K@Z @ 0x1C02971F0
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  *a3 = 0LL;
  ...
  if ( v10 < 0 )
    goto LABEL_6;
  VidPnSourceOwner = ADAPTER_DISPLAY::GetVidPnSourceOwner(*(ADAPTER_DISPLAY **)(v7 + 2672), (unsigned int)v5);
