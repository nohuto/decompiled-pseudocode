/*
 * XREFs of ?ApplyCoreSyncAction@DXGADAPTER@@QEAAXW4DXGADAPTERCORESYNC_ACTION@@@Z @ 0x1C01633E4
 * Callers:
...
LABEL_5:
    ...
    v7 = *(PERESOURCE ***)(a1 + 2672);
    if ( v7 )
    {
      v8 = *(PERESOURCE ***)(a1 + 2680);
      if ( !v8 )
        v8 = 0LL;
      ADAPTER_DISPLAY::ReleaseAllVidPnSourceOwners(v7, v8);
    }
    v9 = *(ADAPTER_RENDER **)(a1 + 2680);
    if ( v9 )
    {
      ...
      ADAPTER_RENDER::FlushScheduler(*(_QWORD *)(a1 + 2680), 9, 0xFFFFFFFF, 0);
      v12 = WdLogNewEntry5_WdPower();
      *(_QWORD *)(v12 + 24) = a1;
      *(_QWORD *)(v12 + 32) = *(unsigned __int8 *)(a1 + 2622);
      WdLogEvent5_WdPower(v12);
      ADAPTER_RENDER::PurgeSegments(*(struct _EX_RUNDOWN_REF **)(a1 + 2680), v11, 0LL);
      v13 = (_QWORD *)WdLogNewEntry5_WdPower();
      v13[3] = a1;
      v13[4] = *(unsigned __int8 *)(a1 + 2622);
      v13[5] = 3765LL;
      WdLogEvent5_WdPower(v13);
      if ( DXGADAPTER::IsDxgmms2((DXGADAPTER *)a1) && *(_BYTE *)(a1 + 2622) )
      {
