/*
 * XREFs of DpiInitializeGlobalState @ 0x1C03021B0
 * Callers:
 *     DriverEntry @ 0x1C0302C24 (DriverEntry.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0024300 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x1C0026570 (_guard_dispatch_icall_nop.c)
 *     DpiIsXboxOne @ 0x1C0188A40 (DpiIsXboxOne.c)
...
__int64 DpiInitializeGlobalState()
{
  ...
  *((_QWORD *)&v66 + 1) = &v43;
  ...
  if ( v2 < 0 || !dword_1C00AFE3C )
    dword_1C00AFE3C = 7236;
  if ( v2 < 0 || (byte_1C00AFA17 = 1, !HIDWORD(v43)) )
    byte_1C00AFA17 = 0;
  v3 = -(int)v43;
  LODWORD(v43) = 0;
  DueTime.QuadPart = v3;
  ...
  v62 = 0LL;
  v61 = 0LL;
  byte_1C00AFA19 = (int)RtlQueryRegistryValuesEx(2LL, L"GraphicsDrivers", &v51, 0LL, 0LL) >= 0 && (_DWORD)v43 != 0;
  v43 = 0x100000000LL;
  v53 = L"HwSchMode";
  v51 = 0LL;
  v54 = (int *)&v43;
  ...
  *((_QWORD *)&v61 + 1) = (char *)&v43 + 4;
  ...
  if ( v4 < 0 || (dword_1C00AFA30 = v43, (unsigned int)v43 >= 3) )
    dword_1C00AFA30 = 0;
  if ( v4 < 0 || (byte_1C00AFA34 = 0, HIDWORD(v43)) )
    byte_1C00AFA34 = 1;
  v55 = 67108868;
  v43 = -1LL;
  LODWORD(v61) = 67108868;
...
LABEL_52:
  ...
  if ( PhysicalMemoryRanges )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      qword_1C00AFA48 = (__int64)&qword_1C00AFA40;
      qword_1C00AFA40 = (__int64)&qword_1C00AFA40;
      RtlInitUnicodeString(
        (PUNICODE_STRING)&DestinationString[1],
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      byte_1C00AFA59 = 0;
      byte_1C00AFA58 = v32 == 0LL;
      KeInitializeEvent(&stru_1C00AFA60, NotificationEvent, 0);
      byte_1C00AFA5A = 0;
      ...
      if ( v33 )
      {
        ...
        dword_1C00AFC98 = 0;
        qword_1C00AFCA8 = (__int64)&Entry;
        Entry = &Entry;
        KeInitializeTimerEx(&stru_1C00AFC10, SynchronizationTimer);
        KeInitializeDpc(&stru_1C00AFC50, (PKDEFERRED_ROUTINE)DpiPdoPollingDpc, 0LL);
        qword_1C00AFC90 = IoAllocateWorkItem((PDEVICE_OBJECT)g_pDriverObject);
        if ( qword_1C00AFC90 )
        {
          ExInitializeNPagedLookasideList(&stru_1C00AFB00, 0LL, 0LL, 0x200u, 0x30uLL, 0x74727044u, 0);
          byte_1C00AFDB8 = 0;
          KeInitializeMutex(&stru_1C00AFDC0, 0);
          HIDWORD(DestinationString[0]) = 2;
          qword_1C00AFE00 = (__int64)&qword_1C00AFDF8;
          qword_1C00AFDF8 = (__int64)&qword_1C00AFDF8;
          v48 = 4;
          if ( ((int (__fastcall *)(__int64, __int64, char *, int *))HalDispatchTable->HalQuerySystemInformation)(
                 ...
                 &v48) < 0
            || (byte_1C00AFA16 = 1, HIDWORD(DestinationString[0]) == 2) )
          {
            byte_1C00AFA16 = 0;
          }
          dword_1C00AFD6C = -1;
          ...
          qword_1C00AFE20 = (__int64)&qword_1C00AFE18;
          qword_1C00AFE18 = (__int64)&qword_1C00AFE18;
          dword_1C00AFE38 = 0;
          qword_1C00AFE30 = (__int64)&qword_1C00AFE28;
          qword_1C00AFE28 = (__int64)&qword_1C00AFE28;
          ...
          {
            IoWorkItem = 0LL;
            qword_1C00AFBE8 = (__int64)&qword_1C00AFBE0;
            qword_1C00AFBE0 = (__int64)&qword_1C00AFBE0;
            dword_1C00AFBF0 = 0;
            qword_1C00AFBD8 = 0LL;
            dword_1C00AFBA0 = 1;
            qword_1C00AFBA8 = 0LL;
            dword_1C00AFBB0 = 0;
            KeInitializeEvent(&stru_1C00AFBB8, SynchronizationEvent, 0);
            KeInitializeEvent(&Event, NotificationEvent, 1u);
            byte_1C00AFF90 = 0;
            KeInitializeMutex(&stru_1C00AFF98, 0);
            byte_1C00AFA1C = 0;
            qword_1C00AFFD8 = (__int64)&qword_1C00AFFD0;
            qword_1C00AFFD0 = &qword_1C00AFFD0;
            qword_1C00AFF00 = 1LL;
            dword_1C00AFDB4 = 0;
            byte_1C00AFA1F = DpiIsXboxOne();
          }
LABEL_39:
          v1 = v0;
          if ( (int)v12 >= 0 )
