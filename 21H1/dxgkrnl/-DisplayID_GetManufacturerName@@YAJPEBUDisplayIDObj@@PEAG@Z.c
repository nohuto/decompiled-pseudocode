/*
 * XREFs of ?DisplayID_GetManufacturerName@@YAJPEBUDisplayIDObj@@PEAG@Z @ 0x1C005DEA0
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C001957C (-RtlStringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
