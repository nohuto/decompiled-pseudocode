/*
 * XREFs of ?Initialize@OUTPUTDUPL_SESSION_MGR@@QEAAJXZ @ 0x1C015B0F4
 * Callers:
...
__int64 __fastcall OUTPUTDUPL_SESSION_MGR::Initialize(OUTPUTDUPL_SESSION_MGR *this)
{
  ...
  *((_QWORD *)this + 2) = v9;
  if ( v9 && (v6 = *v9) != 0LL )
  {
    ...
    *(_QWORD *)(v19 + 24) = (unsigned int)PsGetCurrentProcessSessionId(v20);
  }
  else
  {
    ...
    v19 = v17;
    *(_QWORD *)(v17 + 24) = v18;
    *(_QWORD *)(v17 + 32) = (unsigned int)PsGetCurrentProcessSessionId(v18);
  }
