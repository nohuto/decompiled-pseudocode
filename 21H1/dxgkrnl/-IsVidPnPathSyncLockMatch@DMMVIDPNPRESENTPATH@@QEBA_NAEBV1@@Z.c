/*
 * XREFs of ?IsVidPnPathSyncLockMatch@DMMVIDPNPRESENTPATH@@QEBA_NAEBV1@@Z @ 0x1C02E4A6C
 * Callers:
 ...
 *     ??9DMMVIDPNTARGETMODE@@QEBA_NAEBV0@@Z @ 0x1C0019D64 (--9DMMVIDPNTARGETMODE@@QEBA_NAEBV0@@Z.c)
 */
