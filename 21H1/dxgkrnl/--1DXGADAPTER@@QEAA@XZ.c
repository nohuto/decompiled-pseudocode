/*
 * XREFs of ??1DXGADAPTER@@QEAA@XZ @ 0x1C0207028
 * Callers:
 ...
 *     ??_GADAPTER_DISPLAY@@QEAAPEAXI@Z @ 0x1C0035180 (--_GADAPTER_DISPLAY@@QEAAPEAXI@Z.c)
...
void __fastcall DXGADAPTER::~DXGADAPTER(void **this)
{
  ...
  v2 = (ADAPTER_DISPLAY *)this[334];
  if ( v2 )
  {
    ADAPTER_DISPLAY::`scalar deleting destructor'(v2);
    this[334] = 0LL;
  }
  v3 = (ADAPTER_RENDER *)this[335];
  if ( v3 )
  {
