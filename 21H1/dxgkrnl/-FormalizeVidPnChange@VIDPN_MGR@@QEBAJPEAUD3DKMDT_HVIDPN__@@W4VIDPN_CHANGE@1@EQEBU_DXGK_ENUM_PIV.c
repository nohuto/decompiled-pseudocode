/*
 * XREFs of ?FormalizeVidPnChange@VIDPN_MGR@@QEBAJPEAUD3DKMDT_HVIDPN__@@W4VIDPN_CHANGE@1@EQEBU_DXGK_ENUM_PIVOT@@@Z @ 0x1C011CED4
 * Callers:
...
LABEL_22:
    if ( !a4 )
    {
      v33 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(a1);
      v33[3] = v5;
      v33[4] = a2;
...
LABEL_71:
  v49 = WdLogNewEntry5_WdDmmEvent(a1);
  *(_QWORD *)(v49 + 24) = a2;
  v50 = *(_QWORD *)(v8 + 8);
  if ( !v50 )
  {
