/*
 * XREFs of DxgkGetDisplayConfigBufferSizes @ 0x1C00E3F90
 * Callers:
...
__int64 __fastcall DxgkGetDisplayConfigBufferSizes(__int64 a1, unsigned int *a2, __int64 a3)
{
  ...
  LODWORD(v11) = QDC_CACHE::GetCachedBufferSizes(*((QDC_CACHE **)Global + 158), (unsigned int)v4 & 0xFFFFFFEF, a2);
  if ( (int)v11 < 0 )
  {
    if ( (v4 & 0x40000000) == 0 )
    {
...
LABEL_10:
        LODWORD(v11) = DXGGLOBAL::IterateAdaptersWithCallback(v17, v18, &v27, 4LL);
LABEL_11:
        if ( (int)v11 < 0 )
        {
LABEL_15:
