/*
 * XREFs of ?ClipRects@DXGPRESENT@@SAHPEAUtagRECT@@0PEBU2@1@Z @ 0x1C015C270
 * Callers:
 ...
 * Callees:
 *     ?ClipIntervals@DXGPRESENT@@CAXPEAJ000JJ@Z @ 0x1C027B228 (-ClipIntervals@DXGPRESENT@@CAXPEAJ000JJ@Z.c)
