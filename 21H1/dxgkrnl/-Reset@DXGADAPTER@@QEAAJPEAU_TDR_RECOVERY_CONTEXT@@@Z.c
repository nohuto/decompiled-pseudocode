/*
 * XREFs of ?Reset@DXGADAPTER@@QEAAJPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C020B0C0
 * Callers:
...
__int64 __fastcall DXGADAPTER::Reset(DXGADAPTER *this, ULONG_PTR BugCheckParameter1)
{
  ...
  v6 = (struct _KEVENT *)((char *)this + 2648);
  v34 = (struct _KEVENT *)((char *)this + 2648);
  if ( DXGADAPTER::IsDxgmms2(this) )
    v34 = (struct _KEVENT *)((char *)this + 2648);
  else
    KeSetEvent((PRKEVENT)((char *)this + 2648), 0, 0);
  if ( !*((_QWORD *)this + 335) )
  {
  ...
  if ( !DXGADAPTER::IsDxgmms2(this) )
  {
    while ( 1 )
    {
      ...
      ADAPTER_RENDER::FlushScheduler(*((_QWORD *)this + 335), 4, 0xFFFFFFFF, 0);
  ...
  *((_QWORD *)this + 336) = CurrentThread;
  if ( CurrentThread == *(struct _KTHREAD **)(BugCheckParameter1 + 2896) )
  {
LABEL_26:
    KeSetEvent((PRKEVENT)((char *)this + 2648), 0, 0);
    (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 335) + 616LL) + 8LL) + 592LL))(
      *(_QWORD *)(*((_QWORD *)this + 335) + 624LL),
      *((_QWORD *)this + 336));
    DXGADAPTER::PrepareToReset(this, (struct _TDR_RECOVERY_CONTEXT *)BugCheckParameter1);
    ADAPTER_RENDER::FlushScheduler(*((_QWORD *)this + 335), 4, 0xFFFFFFFF, 0);
    ADAPTER_RENDER::FlushDeferredDestructions(*((ADAPTER_RENDER **)this + 335));
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 335) + 640LL) + 8LL) + 1144LL))(*(_QWORD *)(*((_QWORD *)this + 335) + 648LL));
    ADAPTER_RENDER::SuspendVidMmWorkerThread(*((_QWORD *)this + 335), 0, 0);
    ADAPTER_RENDER::FlushScheduler(*((_QWORD *)this + 335), 4, 0xFFFFFFFF, 0);
LABEL_44:
    ADAPTER_RENDER::FlushScheduler(*((_QWORD *)this + 335), 4, 0xFFFFFFFF, 0);
    TdrCollectDbgInfoStage2((struct _TDR_RECOVERY_CONTEXT *)BugCheckParameter1);
    v21 = (ADAPTER_RENDER *)*((_QWORD *)this + 335);
    *((_BYTE *)this + 2622) = 0;
    ...
    v25 = (ADAPTER_DISPLAY *)*((_QWORD *)this + 334);
