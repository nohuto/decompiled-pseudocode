/*
 * XREFs of ?CreateSyncObject@CAdapter@@AEAAJU_VIDSCH_SYNC_OBJECT_CLIENTHINT@@PEAI@Z @ 0x1C0062BF0
 * Callers:
 ...
 *     DxgkCreateSynchronizationObjectInternal @ 0x1C028EAC4 (DxgkCreateSynchronizationObjectInternal.c)
 */
