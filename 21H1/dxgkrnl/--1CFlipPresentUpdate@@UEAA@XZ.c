/*
 * XREFs of ??1CFlipPresentUpdate@@UEAA@XZ @ 0x1C006C9FC
 * Callers:
 *     ??_GCFlipPresentUpdate@@UEAAPEAXI@Z @ 0x1C0068A30 (--_GCFlipPresentUpdate@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?Release@CFlipPropertySetBase@@QEAAKXZ @ 0x1C0066AD0 (-Release@CFlipPropertySetBase@@QEAAKXZ.c)
 *     ??1CFlipTokenOperation@@MEAA@XZ @ 0x1C0069F2C (--1CFlipTokenOperation@@MEAA@XZ.c)
 */
