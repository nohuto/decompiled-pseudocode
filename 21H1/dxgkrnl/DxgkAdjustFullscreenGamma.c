/*
 * XREFs of DxgkAdjustFullscreenGamma @ 0x1C021E6F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetVidPnSourceOwnerEmulated@ADAPTER_DISPLAY@@QEBAPEAVDXGDEVICE@@I@Z @ 0x1C001BD98 (-GetVidPnSourceOwnerEmulated@ADAPTER_DISPLAY@@QEBAPEAVDXGDEVICE@@I@Z.c)
...
LABEL_32:
  ...
  *(_OWORD *)v53 = *v3;
  ...
  v18 = COREADAPTERACCESS::AcquireExclusive((__int64)v56, v17 + 1, v17);
  v22 = v18;
  if ( v18 >= 0 )
  {
    v28 = (ADAPTER_DISPLAY *)*((_QWORD *)v14 + 334);
    v29 = v53[1];
    if ( v53[1] >= *((_DWORD *)v28 + 20) )
      goto LABEL_29;
    v30 = 0LL;
    if ( (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(v28, v53[1]) == 2
      || (unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(*((ADAPTER_DISPLAY **)v14 + 334), (unsigned int)v29) == 3 )
    {
      VidPnSourceOwner = ADAPTER_DISPLAY::GetVidPnSourceOwner(*((ADAPTER_DISPLAY **)v14 + 334), (unsigned int)v29);
    }
    else
    {
      if ( !ADAPTER_DISPLAY::IsVidPnSourceOwnerEmulated(*((DXGADAPTER ***)v14 + 334), v29) )
        goto LABEL_28;
