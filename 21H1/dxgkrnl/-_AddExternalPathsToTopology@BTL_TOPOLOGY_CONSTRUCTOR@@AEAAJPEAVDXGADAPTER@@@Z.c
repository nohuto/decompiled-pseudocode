/*
 * XREFs of ?_AddExternalPathsToTopology@BTL_TOPOLOGY_CONSTRUCTOR@@AEAAJPEAVDXGADAPTER@@@Z @ 0x1C02E9240
 * Callers:
 *     ?_AddExternalPathsAdaptersCallback@BTL_TOPOLOGY_CONSTRUCTOR@@CAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C02E9200 (-_AddExternalPathsAdaptersCallback@BTL_TOPOLOGY_CONSTRUCTOR@@CAJPEAVDXGADAPTER@@PEAX@Z.c)
 * Callees:
        ...
        struct DXGADAPTER *a2)
{
  ...
  v3 = this;
  v4 = *(VIDPN_MGR **)(*((_QWORD *)a2 + 334) + 88LL);
  v86 = v4;
...
LABEL_48:
    ...
    {
      v37 = WdLogNewEntry5_WdDmmEvent(v30);
      *(_QWORD *)(v37 + 24) = v28;
      *(_QWORD *)(v37 + 32) = a2;
...
LABEL_107:
        ...
        if ( ++v70 >= *(_DWORD *)(*((_QWORD *)a2 + 334) + 80LL) )
          goto LABEL_107;
      }
    }
    v85 = 0LL;
    ...
    if ( v64 == -1073741275 )
    {
      v65 = WdLogNewEntry5_WdDmmEvent(v58);
      *(_QWORD *)(v65 + 24) = v56;
      *(_QWORD *)(v65 + 32) = a2;
