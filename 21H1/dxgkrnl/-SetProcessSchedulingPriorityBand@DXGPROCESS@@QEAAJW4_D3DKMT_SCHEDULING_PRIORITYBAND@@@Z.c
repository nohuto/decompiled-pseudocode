/*
 * XREFs of ?SetProcessSchedulingPriorityBand@DXGPROCESS@@QEAAJW4_D3DKMT_SCHEDULING_PRIORITYBAND@@@Z @ 0x1C02816FC
 * Callers:
...
__int64 __fastcall DXGPROCESS::SetProcessSchedulingPriorityBand(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)(a1 + 184) = KeGetCurrentThread();
  if ( (_DWORD)v3 == 1 )
  {
    *((_QWORD *)DXGGLOBAL::GetGlobal(v7, v6) + 182) = a1;
    _InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal(v10, v9) + 361, 1, 0);
    *(_DWORD *)(a1 + 352) = 1;
  }
  else
  {
  ...
  if ( !(_DWORD)v3 && a1 == *((_QWORD *)DXGGLOBAL::GetGlobal(v14, v13) + 182) )
    _InterlockedCompareExchange((volatile signed __int32 *)DXGGLOBAL::GetGlobal(v25, v24) + 361, 0, 1);
  v26 = 0;
LABEL_20:
  *(_QWORD *)(v5 + 8) = 0LL;
