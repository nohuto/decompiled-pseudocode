/*
 * XREFs of DxgkQueryVidPnExclusiveOwnership @ 0x1C015D840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkQueryVidPnExclusiveOwnership(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( Current )
  {
    ...
    *(_OWORD *)v49 = *v9;
    ...
    {
      Process = DXGPROCESSMUTEXBYHANDLE::GetProcess((DXGPROCESSMUTEXBYHANDLE *)v52, v11);
      ...
      if ( (*(unsigned int (__fastcall **)(void *, __int128 *))(v14 + 360))(v49[1], &v51) )
      {
        ...
        if ( v19 < 0 )
        {
          v37 = *((unsigned int *)DXGGLOBAL::GetGlobal(v21, v20) + 358);
          if ( (v37 & 2) != 0 )
          {
