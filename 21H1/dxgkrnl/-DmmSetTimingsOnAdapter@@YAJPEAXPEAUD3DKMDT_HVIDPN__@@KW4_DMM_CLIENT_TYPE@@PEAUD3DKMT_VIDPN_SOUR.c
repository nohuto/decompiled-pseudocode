/*
 * XREFs of ?DmmSetTimingsOnAdapter@@YAJPEAXPEAUD3DKMDT_HVIDPN__@@KW4_DMM_CLIENT_TYPE@@PEAUD3DKMT_VIDPN_SOURCE_MASKS@@PEAU_DMM_SET_TIMING_RESULT@@PEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C012F7C0
 * Callers:
        ...
        __int64 a8)
{
  ...
  ++*(_DWORD *)(*(_QWORD *)(a1 + 2672) + 360LL);
  v15 = *(VIDPN_MGR **)(*(_QWORD *)(a1 + 2672) + 88LL);
