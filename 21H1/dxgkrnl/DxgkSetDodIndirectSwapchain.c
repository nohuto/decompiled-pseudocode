/*
 * XREFs of DxgkSetDodIndirectSwapchain @ 0x1C0221F10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_50:
  ...
  if ( v24 >= 0 )
  {
    if ( *((_QWORD *)v19 + 335) || (*((_DWORD *)v19 + 87) & 0x100) == 0 )
    {
...
LABEL_48:
    ...
    if ( ADAPTER_DISPLAY::IsVidPnSourceOwner(*((DXGADAPTER ***)v19 + 334), v14, v54[2]) )
    {
      v37 = (ADAPTER_DISPLAY *)*((_QWORD *)v19 + 334);
      if ( LODWORD(v55[1]) )
