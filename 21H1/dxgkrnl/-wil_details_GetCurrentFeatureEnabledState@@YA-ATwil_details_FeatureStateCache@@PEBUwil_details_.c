/*
 * XREFs of ?wil_details_GetCurrentFeatureEnabledState@@YA?ATwil_details_FeatureStateCache@@PEBUwil_details_FeatureDescriptor@@PEAH@Z @ 0x1C00254A4
 * Callers:
...
__int64 __fastcall wil_details_GetCurrentFeatureEnabledState(__int64 a1, _DWORD *a2, __int64 a3, int *a4)
{
  ...
  *a2 = 1;
  ...
  {
    v12 = v11 & 0xFFFFFFEF | (*(_BYTE *)(a1 + 15) != 0 ? 0x10 : 0);
  }
  v14 = (v12 ^ (v12 >> 1)) & 8 ^ v12;
  LODWORD(v23) = v14;
  if ( (v14 & 8) != 0 )
