/*
 * XREFs of ?VailSendCompositionObjectTestCommand@DXGSESSIONDATA@@QEAAJPEAXI0PEAIH@Z @ 0x1C02B26D4
 * Callers:
 ...
 *     ?AddReference@DXGVAILGUESTOBJECT@@QEAAXXZ @ 0x1C02AF868 (-AddReference@DXGVAILGUESTOBJECT@@QEAAXXZ.c)
