/*
 * XREFs of DxgkCreateLightweightDeviceAndContext @ 0x1C021ECD4
 * Callers:
...
LABEL_18:
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)v85 = 0LL;
    v86 = 0;
    v59 = *((unsigned int *)v73 + 674);
    v85[1] = *((_DWORD *)v73 + 674);
    v86 = 1;
    if ( (*((_DWORD *)v73 + 87) & 0x10) != 0 )
    {
      ...
      *(_OWORD *)&v84.OutputDataSize = 0LL;
      ...
      if ( (int)DXGADAPTER::DdiQueryAdapterInfo(v73, &v84, v59) < 0 )
      {
        ...
        *(_QWORD *)(v62 + 24) = 11976LL;
        WdLogEvent5_WdAssertion(v62);
      }
      LODWORD(v59) = v85[1];
      v58 = v73;
    }
    v63 = (ADAPTER_RENDER *)*((_QWORD *)v58 + 335);
    v64 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v63 + 2) + 2560LL) + 32LL);
