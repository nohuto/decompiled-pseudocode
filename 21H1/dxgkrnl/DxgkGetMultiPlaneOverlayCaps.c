/*
 * XREFs of DxgkGetMultiPlaneOverlayCaps @ 0x1C014C5B0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v57 )
    {
      ...
      else
      {
        if ( v17 && !v17[334] )
        {
          ...
          *(_QWORD *)(v47 + 24) = 11023LL;
          WdLogEvent5_WdAssertion(v47);
        }
        v18 = v57;
        if ( !v57 || !*((_QWORD *)v57 + 335) )
        {
          v48 = WdLogNewEntry5_WdAssertion(v15, v14);
          *(_QWORD *)(v48 + 24) = 11025LL;
        ...
        if ( v17 )
          DXGADAPTER::ReleaseReferenceNoTracking((DXGADAPTER *)v17);
