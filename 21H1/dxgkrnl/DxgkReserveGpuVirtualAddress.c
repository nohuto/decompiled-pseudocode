/*
 * XREFs of DxgkReserveGpuVirtualAddress @ 0x1C0160E20
 * Callers:
...
LABEL_14:
    v21 = v60;
    v22 = (struct DXGPAGINGQUEUE *)*((_QWORD *)v60 + 335);
    v62 = v22;
    if ( *((_BYTE *)v60 + 209) )
    {
      if ( v18 )
      ...
      v25 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendReserveGpuVirtualAddress(
              (struct DXGADAPTER *)((char *)v21 + 4208),
              HostProcess,
              v53,
              v13);
    }
