/*
 * XREFs of ?NotifySharedPowerGraphicsPowerTransition@DXGGLOBAL@@QEAAXQEAXW4_DEVICE_POWER_STATE@@E@Z @ 0x1C0265ACC
 * Callers:
        ...
        char a4)
{
  ...
  for ( i = (__int64 **)*((_QWORD *)this + 196); i != (__int64 **)((char *)this + 1568) && i; i = (__int64 **)*i )
  {
    if ( i[4] == a2 )
    {
      v11 = i[5];
