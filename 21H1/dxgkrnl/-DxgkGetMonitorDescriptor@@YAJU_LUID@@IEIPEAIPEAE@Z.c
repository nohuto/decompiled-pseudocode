/*
 * XREFs of ?DxgkGetMonitorDescriptor@@YAJU_LUID@@IEIPEAIPEAE@Z @ 0x1C0156EB0
 * Callers:
 *     DxgkGetMonitorEdid @ 0x1C0156E80 (DxgkGetMonitorEdid.c)
 *     DxgkGetMonitorDisplayId @ 0x1C0293300 (DxgkGetMonitorDisplayId.c)
 * Callees:
