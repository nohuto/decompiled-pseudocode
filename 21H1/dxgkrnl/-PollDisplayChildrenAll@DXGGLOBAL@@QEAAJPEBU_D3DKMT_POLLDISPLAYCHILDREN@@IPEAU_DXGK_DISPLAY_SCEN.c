/*
 * XREFs of ?PollDisplayChildrenAll@DXGGLOBAL@@QEAAJPEBU_D3DKMT_POLLDISPLAYCHILDREN@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0265EDC
 * Callers:
 ...
 *     MonitorReleaseMonitorPendingEvent @ 0x1C0135D08 (MonitorReleaseMonitorPendingEvent.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a4)
{
  ...
  v4 = 0LL;
  v5 = (unsigned __int64 *)((char *)this + 552);
  v6 = 0LL;
  v80 = 0;
  v90 = a4;
  v81 = 0;
  v7 = 0;
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v88, (DXGGLOBAL *)((char *)this + 472), 0);
  ...
  if ( v96 && v18 && v99 && v106 && v4 )
  {
    ...
    while ( v23 != v5 && v23 )
    {
      ...
      if ( (_BYTE)v26 )
      {
        ...
        if ( v25[334] )
        {
          LODWORD(v31) = COREADAPTERACCESS::AcquireExclusive((__int64)v105, 1LL, 0);
          if ( (int)v31 >= 0 )
          {
            v32 = (void *)v25[27];
            v85[v6] = v32;
      ...
      if ( (*((_DWORD *)a2 + 1) & 4) != 0 && (_DWORD)v6 )
      {
        ...
        while ( v66 != v65 && v66 )
        {
          ...
          if ( (_BYTE)v68 )
          {
            ...
            DXGADAPTER::ReleaseReferenceNoTracking((DXGADAPTER *)v67);
            v71 = 0;
            ...
            if ( (int)COREADAPTERACCESS::AcquireExclusive((__int64)v109, 1LL, 0) >= 0 )
            {
