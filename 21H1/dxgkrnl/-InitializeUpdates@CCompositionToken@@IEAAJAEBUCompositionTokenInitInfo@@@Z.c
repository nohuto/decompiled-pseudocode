/*
 * XREFs of ?InitializeUpdates@CCompositionToken@@IEAAJAEBUCompositionTokenInitInfo@@@Z @ 0x1C00155C0
 * Callers:
            ...
            *(_QWORD *)(v3 + 16) = v15;
            ...
            if ( v2 >= 0 )
            {
              if ( !DXGGLOBAL::m_pGlobal )
              {
                ...
                *(_QWORD *)(v25 + 24) = 2219LL;
                WdLogEvent5_WdAssertion(v25);
              }
              v19 = (*(__int64 (__fastcall **)(__int64))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 16LL))(v3 + 24);
              v8 = v26;
              v2 = v19;
              goto LABEL_20;
            }
