/*
 * XREFs of ?LogMonitorObjectOnOffState@DXGMONITOR@@QEAAXAEBU_GUID@@IW4Enum@MONITOR_ON_OFF_CALLER_ORIGIN@@@Z @ 0x1C01585C4
 * Callers:
...
char __fastcall DXGMONITOR::LogMonitorObjectOnOffState(char *a1, __int64 a2, int a3, char a4)
{
  ...
  if ( a4 != 1 || v7 != *a1 )
  {
    ...
    {
      LOBYTE(v4) = tlgKeywordOn((__int64)&dword_1C00AE9E8, 0x400000000010LL);
      if ( (_BYTE)v4 )
      {
        v11 = (unsigned int)dword_1C00B163C;
        v13 = v7;
        v20 = v8;
        v14 = a4;
        v22 = v10;
