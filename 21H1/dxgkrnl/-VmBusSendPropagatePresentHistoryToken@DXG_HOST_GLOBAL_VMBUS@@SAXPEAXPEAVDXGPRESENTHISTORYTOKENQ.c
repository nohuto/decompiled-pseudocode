/*
 * XREFs of ?VmBusSendPropagatePresentHistoryToken@DXG_HOST_GLOBAL_VMBUS@@SAXPEAXPEAVDXGPRESENTHISTORYTOKENQUEUE@@PEAU_D3DKMT_PRESENTHISTORYTOKEN@@PEAVCRefCountedBuffer@@E@Z @ 0x1C003FC80
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a5)
{
  ...
  v12 = a3;
  v11 = a2;
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)a1, (__int64)a2) + 380) >= 0x18u )
