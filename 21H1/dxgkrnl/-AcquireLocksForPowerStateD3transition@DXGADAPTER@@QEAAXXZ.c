/*
 * XREFs of ?AcquireLocksForPowerStateD3transition@DXGADAPTER@@QEAAXXZ @ 0x1C0207318
 * Callers:
 ...
 *     ?TryAcquireDeviceLockForAllDevices@ADAPTER_RENDER@@QEAAEW4DXGADAPTER_DEVICELISTTYPE@@@Z @ 0x1C0213144 (-TryAcquireDeviceLockForAllDevices@ADAPTER_RENDER@@QEAAEW4DXGADAPTER_DEVICELISTTYPE@@@Z.c)
 */
  ...
  if ( (unsigned __int8)ExTryAcquirePushLockExclusiveEx((char *)this + 104, 0LL) )
  {
    *((_QWORD *)this + 14) = KeGetCurrentThread();
    ...
    if ( !v2
      ...
      && (unsigned __int8)ADAPTER_RENDER::TryAcquireDeviceLockForAllDevices(*((_QWORD *)this + 335), 1LL) )
    {
      ...
      if ( DXGADAPTER::IsCoreResourceExclusiveOwner((PERESOURCE *)this) )
      {
        ...
        if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 335) + 640LL) + 8LL)
                                                       + 1080LL))(*(_QWORD *)(*((_QWORD *)this + 335) + 648LL))
          || (*(unsigned __int8 (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 335) + 616LL) + 8LL)
                                                       + 928LL))(*(_QWORD *)(*((_QWORD *)this + 335) + 624LL))
          || *((_BYTE *)this + 2622) )
        {
LABEL_14:
