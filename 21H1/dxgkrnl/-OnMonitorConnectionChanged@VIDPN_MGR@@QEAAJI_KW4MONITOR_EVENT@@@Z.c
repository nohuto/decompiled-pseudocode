/*
 * XREFs of ?OnMonitorConnectionChanged@VIDPN_MGR@@QEAAJI_KW4MONITOR_EVENT@@@Z @ 0x1C0184FA8
 * Callers:
    ...
    else
    {
      ...
      *((_BYTE *)TargetById + 413) = 1;
      ...
      if ( PathSourceFromTarget != -1 )
        ADAPTER_DISPLAY::MarkCommitVidPnOnModeChange((PERESOURCE **)v53, PathSourceFromTarget, 1);
      ...
      if ( (*((_DWORD *)v54 + 87) & 0x100) != 0 && DXGADAPTER::IsAdapterSessionized(v54, v16, &v97, 0LL) )
      {
        ...
        v85 = DXGSESSIONMGR::CleanCachedIddDisplayConfigRequest(*((DXGSESSIONMGR **)Global + 88), v97);
        v87 = v85;
        if ( v85 < 0 )
        {
