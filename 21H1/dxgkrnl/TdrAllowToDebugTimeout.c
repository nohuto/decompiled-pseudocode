/*
 * XREFs of TdrAllowToDebugTimeout @ 0x1C0261FB8
 * Callers:
 ...
 * Callees:
 *     ?TdrValidateDebugMode@@YAXXZ @ 0x1C00432C4 (-TdrValidateDebugMode@@YAXXZ.c)
...
__int64 __fastcall TdrAllowToDebugTimeout(struct _TDR_RECOVERY_CONTEXT *a1)
{
  ...
  if ( (byte_1C00B0074 || (unsigned __int8)WdQueryDebugFlag(0LL)) && !g_TdrDebugMode )
  {
