/*
 * XREFs of ?GetClippedCursor@DISPLAY_SOURCE@@QEAAPEAU_DXGKARG_SETPOINTERSHAPE@@_N@Z @ 0x1C020ECC4
 * Callers:
...
struct _DXGKARG_SETPOINTERSHAPE *__fastcall DISPLAY_SOURCE::GetClippedCursor(DISPLAY_SOURCE *this, char a2)
{
  ...
  if ( a2 )
  {
    v9 = 4LL * (unsigned int)(*(_DWORD *)(v8 + 1992) * *(_DWORD *)(v8 + 1996));
    if ( !is_mul_ok((unsigned int)(*(_DWORD *)(v8 + 1992) * *(_DWORD *)(v8 + 1996)), 4uLL) )
      v9 = -1LL;
    ...
    *((_QWORD *)this + 106) = v10;
    ...
    if ( v10 )
LABEL_8:
      memset(v7, 0, 4 * *(unsigned int *)(v8 + 1992) * (unsigned __int64)*(unsigned int *)(v8 + 1996));
  }
