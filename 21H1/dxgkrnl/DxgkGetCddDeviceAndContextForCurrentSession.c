/*
 * XREFs of DxgkGetCddDeviceAndContextForCurrentSession @ 0x1C0130678
 * Callers:
        ...
        char a5)
{
  ...
  v11 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal((__int64)a1, (__int64)a2) + 88);
  if ( v11 )
  {
...
LABEL_12:
  ...
  {
    v19 = (_QWORD *)WdLogNewEntry5_WdError(v10, v9);
    v21 = PsGetCurrentProcessSessionId(v22);
    v19[5] = 2LL;
    goto LABEL_12;
  }
