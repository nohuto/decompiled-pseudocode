/*
 * XREFs of DxgkCheckVidPnExclusiveOwnership @ 0x1C0145890
 * Callers:
 *     <none>
 * Callees:
...
LABEL_37:
  ...
  {
    v27 = HIDWORD(v66);
    if ( HIDWORD(v66) < *(_DWORD *)(*((_QWORD *)v16 + 334) + 80LL) )
    {
      v28 = v64;
      v65 = v64;
      v29 = *(unsigned int *)(*((_QWORD *)v64 + 2) + 632LL);
      if ( (int)v29 <= 0 )
      {
