/*
 * XREFs of ?StartCoreDripsBlockerTracking@DXGGLOBAL@@QEAAX_KPEADPEAU_EPROCESS@@@Z @ 0x1C0127F48
 * Callers:
...
LABEL_7:
  ...
  if ( *((_DWORD *)this + 464) && *((_BYTE *)this + 304096) )
  {
    ...
    DripsBlockerTrackingHelper::AddProcessEntry((char *)this + 2016, a2, a3, a4, FirstProfilerInterface);
    if ( v13[8] )
