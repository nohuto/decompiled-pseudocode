/*
 * XREFs of ?DmmDisableAllFailurePathsOnAdapter@@YAJPEAXKW4_DMM_CLIENT_TYPE@@PEAVDXGDEVICE@@@Z @ 0x1C00D525C
 * Callers:
...
__int64 __fastcall DmmDisableAllFailurePathsOnAdapter(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  v11 = *(struct VIDPN_MGR **)(*(_QWORD *)(a1 + 2672) + 88LL);
...
LABEL_20:
      if ( ++v17 >= *(_DWORD *)(*(_QWORD *)(a1 + 2672) + 80LL) )
      {
        v18 = v45;
        goto LABEL_22;
      }
