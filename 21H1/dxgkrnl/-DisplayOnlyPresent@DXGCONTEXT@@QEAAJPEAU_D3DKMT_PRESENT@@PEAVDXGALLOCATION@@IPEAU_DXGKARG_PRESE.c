/*
 * XREFs of ?DisplayOnlyPresent@DXGCONTEXT@@QEAAJPEAU_D3DKMT_PRESENT@@PEAVDXGALLOCATION@@IPEAU_DXGKARG_PRESENT@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C029F268
 * Callers:
        ...
        struct COREDEVICEACCESS *a6)
{
  ...
  if ( v6 )
  {
    ...
    v19 = ADAPTER_RENDER::DdiDescribeAllocation(
            *(ADAPTER_RENDER **)(*(_QWORD *)(*(_QWORD *)(v17 + 16) + 16LL) + 2680LL),
            &v29,
            v18);
    v22 = v19;
    if ( v19 < 0 )
...
LABEL_19:
  ...
  if ( v25 >= 0 && (a2->Flags.Value & 4) != 0 )
  {
    ...
    {
      ADAPTER_DISPLAY::DisableOverlayPlanes(*(ADAPTER_DISPLAY **)(v27 + 2672), a4);
      v26 = *((_QWORD *)this + 2);
    }
