/*
 * XREFs of ?DestroyPeriodicFrameNotification@BLTQUEUE@@QEAAJPEA_K@Z @ 0x1C02F8874
 * Callers:
...
__int64 __fastcall BLTQUEUE::DestroyPeriodicFrameNotification(struct _KTHREAD **this, unsigned __int64 *a2)
{
  ...
  *((_BYTE *)this[362] + v10 + 57) = 0;
  ...
  v23 = -1LL;
  if ( (*(int (__fastcall **)(__int64, unsigned __int64, _QWORD, __int64 *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 2680) + 616LL)
                                                                                       + 8LL)
                                                                           + 656LL))(
         1LL,
