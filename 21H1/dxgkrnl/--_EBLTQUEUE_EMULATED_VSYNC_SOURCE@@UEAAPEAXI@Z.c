/*
 * XREFs of ??_EBLTQUEUE_EMULATED_VSYNC_SOURCE@@UEAAPEAXI@Z @ 0x1C005DA60
 * Callers:
 *     <none>
 * Callees:
 *     ??1BLTQUEUE_EMULATED_VSYNC_SOURCE@@UEAA@XZ @ 0x1C02FC424 (--1BLTQUEUE_EMULATED_VSYNC_SOURCE@@UEAA@XZ.c)
 */
