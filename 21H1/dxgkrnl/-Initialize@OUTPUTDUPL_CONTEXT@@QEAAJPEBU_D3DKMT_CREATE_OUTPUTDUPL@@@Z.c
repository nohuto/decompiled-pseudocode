/*
 * XREFs of ?Initialize@OUTPUTDUPL_CONTEXT@@QEAAJPEBU_D3DKMT_CREATE_OUTPUTDUPL@@@Z @ 0x1C029C760
 * Callers:
 ...
 *     ?Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z @ 0x1C0295BA8 (-Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z.c)
