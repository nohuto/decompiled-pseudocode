/*
 * XREFs of DpiPdoPollChild @ 0x1C02D48BC
 * Callers:
...
__int64 __fastcall DpiPdoPollChild(__int64 a1, int a2, int a3, char a4, char a5)
{
  ...
  v10 = ExAllocateFromNPagedLookasideList(&stru_1C00AFB00);
  v15 = v10;
  if ( v10 )
  {
    ...
    *((_BYTE *)v10 + 42) = 1;
    ...
    v18 = (_QWORD *)qword_1C00AFCA8;
    if ( *(PVOID **)qword_1C00AFCA8 != &Entry )
      __fastfail(3u);
    *v15 = &Entry;
    v15[1] = v18;
    *v18 = v15;
    qword_1C00AFCA8 = (__int64)v15;
    KeReleaseMutex((PRKMUTEX)P, 0);
    KeSetTimer(&stru_1C00AFC10, (LARGE_INTEGER)-3000000LL, &stru_1C00AFC50);
  }
  else
  {
    v16 = -1073741670;
