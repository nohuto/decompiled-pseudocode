/*
 * XREFs of ?DodTerminateIndirectOutput@ADAPTER_DISPLAY@@QEAAJI@Z @ 0x1C020E1AC
 * Callers:
...
LABEL_5:
  ...
  v8 = *(unsigned int (__fastcall **)(_QWORD, _QWORD))(v7 + 1928);
  if ( !v8 )
    return 3221225659LL;
  if ( v8(*(_QWORD *)(v7 + 1864), (unsigned int)a2) == -1073741637 )
