/*
 * XREFs of ?DxgEscapeEvictWorker@@YAJPEAU_D3DKMT_VIDMM_ESCAPE@@PEAVDXGPROCESS@@@Z @ 0x1C0262704
 * Callers:
    ...
    *((_QWORD *)v8 + 1) = KeGetCurrentThread();
    ...
    while ( 1 )
    {
      ...
      else
      {
        ...
        v2 = v15;
        if ( v15 < 0
          || ((v18 = (_QWORD *)*((_QWORD *)v14 + 2), *(int *)(v18[2] + 2572LL) < 2000)
            ? (COREDEVICEACCESS::Release((COREDEVICEACCESS *)v102), v19 = DXGDEVICE::EvictAllAllocations(v14, v20))
    ...
    if ( v9 )
    {
      ...
      LODWORD(v2) = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendEscape(
                      (DXG_GUEST_VIRTUALGPU_VMBUS *)(v10 + 4208),
                      HostProcess,
                      v22,
                      0,
                      0,
...
LABEL_59:
    ...
    {
      v54 = v31[1].Count;
      if ( *(int *)(*(_QWORD *)(*(_QWORD *)(v54 + 16) + 16LL) + 2572LL) < 2000 )
      {
            ...
            if ( v78 >= 0 )
            {
              if ( *(_BYTE *)(v77 + 209) )
              {
                ...
                *((_QWORD *)v4 + 2) = 0LL;
                ...
                LODWORD(v92) = 1088;
                LODWORD(v2) = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendEscape(
                                (DXG_GUEST_VIRTUALGPU_VMBUS *)(v77 + 4208),
                                v83,
                                v82,
                                0,
                                0,
              ...
              {
                v84 = v94[3].Count;
                if ( *(int *)(*(_QWORD *)(*(_QWORD *)(v69[1].Count + 16) + 16LL) + 2572LL) < 2000 )
                {
                  while ( v84 )
                  {
