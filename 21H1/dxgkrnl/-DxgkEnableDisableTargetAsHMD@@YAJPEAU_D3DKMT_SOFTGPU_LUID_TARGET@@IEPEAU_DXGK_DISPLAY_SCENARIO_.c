/*
 * XREFs of ?DxgkEnableDisableTargetAsHMD@@YAJPEAU_D3DKMT_SOFTGPU_LUID_TARGET@@IEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C021D140
 * Callers:
...
LABEL_13:
    ...
    v16 = COREADAPTERACCESS::AcquireExclusive((__int64)v24, 1LL, 0);
    v7 = v16;
    if ( v16 >= 0 )
    {
      if ( !*((_QWORD *)v14 + 334) )
