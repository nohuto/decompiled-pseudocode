/*
 * XREFs of ?UnpinAllDirectFlipAllocations@DXGDEVICE@@QEAAJIHPEAVCOREDEVICEACCESS@@@Z @ 0x1C0140CE8
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  if ( v13 == (PERESOURCE *)this[2][2] )
    ADAPTER_DISPLAY::DisableOverlayPlanes((ADAPTER_DISPLAY *)v13[334], (unsigned int)v5);
  return 0LL;
}
