/*
 * XREFs of ?MockDriverStateCreatePlaneLiveDump@@YAXPEAX@Z @ 0x1C02BA260
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MockDriverStateCreatePlaneLiveDump(_QWORD *a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( v2 )
    {
      ...
      DXGADAPTER::ReleaseReferenceNoTracking((DXGADAPTER *)v2);
      if ( *(_DWORD *)(v2 + 200) == 1 )
      {
        v17 = *(_QWORD *)(v2 + 316);
        if ( (unsigned int)dword_1C00AEA90 > 5 )
        {
          if ( tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000020000LL) )
          {
