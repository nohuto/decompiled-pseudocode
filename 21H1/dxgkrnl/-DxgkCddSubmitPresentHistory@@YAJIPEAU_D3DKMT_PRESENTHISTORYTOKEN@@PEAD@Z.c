/*
 * XREFs of ?DxgkCddSubmitPresentHistory@@YAJIPEAU_D3DKMT_PRESENTHISTORYTOKEN@@PEAD@Z @ 0x1C0107D90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddSubmitPresentHistory(__int64 a1, struct _D3DKMT_PRESENTHISTORYTOKEN *a2, char *a3)
{
  ...
  struct DXGADAPTER *v76; // [rsp+78h] [rbp-90h]
  char v77; // [rsp+80h] [rbp-88h]
  int v78; // [rsp+88h] [rbp-80h] BYREF
  __int64 v79; // [rsp+90h] [rbp-78h]
  char v80; // [rsp+98h] [rbp-70h]
  union _LARGE_INTEGER v81; // [rsp+A0h] [rbp-68h] BYREF
  char v82[8]; // [rsp+A8h] [rbp-60h] BYREF
  __int64 v83; // [rsp+B0h] [rbp-58h]
  char v84; // [rsp+B8h] [rbp-50h]
  _QWORD v85[3]; // [rsp+C0h] [rbp-48h] BYREF
  char v86[8]; // [rsp+D8h] [rbp-30h] BYREF
  char v87[8]; // [rsp+E0h] [rbp-28h] BYREF
  __int64 v88; // [rsp+E8h] [rbp-20h]
  struct DXGADAPTER *v89; // [rsp+F0h] [rbp-18h]
  char v90; // [rsp+F8h] [rbp-10h]
  char *v91; // [rsp+100h] [rbp-8h]
  char v92[24]; // [rsp+108h] [rbp+0h] BYREF
  char v93[8]; // [rsp+120h] [rbp+18h] BYREF
  __int64 v94; // [rsp+128h] [rbp+20h]
  struct DXGADAPTER *v95; // [rsp+130h] [rbp+28h]
  char v96; // [rsp+138h] [rbp+30h]
  __int64 v97; // [rsp+140h] [rbp+38h]
  __int64 v98; // [rsp+160h] [rbp+58h]
  char v99; // [rsp+168h] [rbp+60h]
  char v100[8]; // [rsp+178h] [rbp+70h] BYREF
  char v101[64]; // [rsp+180h] [rbp+78h] BYREF
  char v102[88]; // [rsp+1C0h] [rbp+B8h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v78, 3036LL);
...
LABEL_21:
  ...
  if ( v21 )
  {
    ...
    *(_QWORD *)(v21 + 472) = KeGetCurrentThread();
    v76 = *(struct DXGADAPTER **)(*(_QWORD *)(*(_QWORD *)(v21 + 16) + 16LL) + 16LL);
    _InterlockedIncrement64((volatile signed __int64 *)v76 + 3);
    v75 = -1LL;
    KeEnterCriticalRegion();
    ExAcquirePushLockSharedEx((char *)v76 + 136, 0LL);
    v77 = 1;
    v32 = *(_QWORD *)(v21 + 16);
    v33 = *(volatile signed __int64 **)(*(_QWORD *)(v32 + 16) + 16LL);
    v89 = (struct DXGADAPTER *)v33;
    v90 = 0;
    v91 = 0LL;
    if ( v33 )
    {
    ...
    if ( KeGetCurrentThread() != *((struct _KTHREAD **)v89 + 23) )
    {
      ...
      DXGADAPTER::AcquireCoreResourceShared(v89, a3);
    }
    v91 = 0LL;
    if ( a3 )
    {
      v65 = RtlStringCbCopyA(v92, v32, a3);
      v66 = v92;
      if ( v65 < 0 )
        v66 = v91;
      v91 = v66;
    ...
    else
    {
      ...
      v69 = (_QWORD *)WdLogNewEntry5_WdEvent(v68, v67);
      v69[3] = -1073741130LL;
      v69[4] = v21;
      v69[5] = v12;
    ...
    if ( v89 )
    {
      if ( v90 )
      {
        ...
        if ( KeGetCurrentThread() != *((struct _KTHREAD **)v89 + 23) )
        {
          DXGADAPTER::ReleaseCoreResource(v89, v91);
          v39 = v89;
        }
        v91 = 0LL;
      }
    ...
    {
      v77 = 0;
      ExReleasePushLockSharedEx((char *)v76 + 136, 0LL);
      KeLeaveCriticalRegion();
      v40 = (DXGGLOBAL **)v76;
    ...
    *(_QWORD *)(v21 + 472) = 0LL;
    ...
    if ( _InterlockedExchangeAdd64((volatile signed __int64 *)(v21 + 32), 0xFFFFFFFFFFFFFFFFuLL) == 1 )
    {
      ...
      v71 = *(_QWORD *)(v21 + 16);
      v84 = 0;
      v83 = *(_QWORD *)(*(_QWORD *)(v71 + 16) + 16LL);
      DXGADAPTERSTOPRESETLOCKSHARED::Acquire((DXGADAPTERSTOPRESETLOCKSHARED *)v82);
      COREDEVICEACCESS::COREDEVICEACCESS((__int64)v100, v70, 2, v72, 0);
      COREDEVICEACCESS::AcquireSharedUncheck((COREDEVICEACCESS *)v100, v73);
      if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v70 + 16) + 16LL) + 200LL) != 4 )
        DXGDEVICE::DestroyContext((DXGDEVICE *)v70, (struct DXGCONTEXT *)v21, (struct COREDEVICEACCESS *)v100);
...
LABEL_57:
  DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v78, v41);
  if ( v80 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q_EtwWriteTransfer(v42, &EventProfilerExit, v43, v78);
  return v37;
}
