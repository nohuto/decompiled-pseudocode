/*
 * XREFs of ??1CFlipResource@@MEAA@XZ @ 0x1C006BAC0
 * Callers:
 *     ??1CPoolBufferResource@@UEAA@XZ @ 0x1C006BB14 (--1CPoolBufferResource@@UEAA@XZ.c)
 *     ??_ECFlipResource@@MEAAPEAXI@Z @ 0x1C006BB60 (--_ECFlipResource@@MEAAPEAXI@Z.c)
