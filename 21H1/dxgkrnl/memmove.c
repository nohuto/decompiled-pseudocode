 ...
 *     ?ProcessMiracastAPIChunk@@YAJPEAU_MIRACAST_DEVICE_CONTEXT@@PEAU_FDO_CONTEXT@@PEAKPEAUD3DKMT_MIRACAST_CHUNK_DATA@@2@Z @ 0x1C005134C (-ProcessMiracastAPIChunk@@YAJPEAU_MIRACAST_DEVICE_CONTEXT@@PEAU_FDO_CONTEXT@@PEAKPEAUD3DKMT_MIRA.c)
 ...
 *     ??$CreateFlipPropertySetWorker@VCFlipPropertySet@@@@YAJIPEAUFlipPropertyItem@@_NPEAPEAVCFlipPropertySet@@@Z @ 0x1C0065E24 (--$CreateFlipPropertySetWorker@VCFlipPropertySet@@@@YAJIPEAUFlipPropertyItem@@_NPEAPEAVCFlipProp.c)
 ...
 *     ?_GetDisplayIDBlob@DXGMONITOR@@QEBAJIPEAIPEAE@Z @ 0x1C0150FCC (-_GetDisplayIDBlob@DXGMONITOR@@QEBAJIPEAIPEAE@Z.c)
 ...
 *     ?DxgkpRegistryQueryRoutine@@YAJPEAGKPEAXK11@Z @ 0x1C021D950 (-DxgkpRegistryQueryRoutine@@YAJPEAGKPEAXK11@Z.c)
 ...
 *     DpGetPostDisplayInfoPlusEdid @ 0x1C02C15B0 (DpGetPostDisplayInfoPlusEdid.c)
 ...
 *     DpiTestGetPossibleBrightness @ 0x1C02D5900 (DpiTestGetPossibleBrightness.c)
 ...
 *     ?Copy@CCD_TOPOLOGY@@QEAAJPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C02E5CE8 (-Copy@CCD_TOPOLOGY@@QEAAJPEAUD3DKMT_GETPATHSMODALITY@@@Z.c)
