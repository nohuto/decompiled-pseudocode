/*
 * XREFs of ?_RetrieveMonitorDescriptorsFromRegistry@DXGMONITOR@@AEAAJXZ @ 0x1C0168A18
 * Callers:
...
__int64 __fastcall DXGMONITOR::_RetrieveMonitorDescriptorsFromRegistry(DXGMONITOR *this, __int64 a2)
{
  ...
  *(&ObjectAttributes.Length + 1) = 0;
  ...
  {
LABEL_9:
    v9 = WdLogNewEntry5_WdDmmEvent(v5);
    *(_QWORD *)(v9 + 24) = v6;
  ...
  if ( *((_DWORD *)this + 32) )
  {
    while ( 1 )
    {
      ...
      if ( v15 >= 0 )
      {
        ...
        if ( !v34 )
        {
          v17 = WdLogNewEntry5_WdAssertion(v5, v8);
          WdLogEvent5_WdAssertion(v17);
        }
        v5 = *(_QWORD *)(*((_QWORD *)this + 17) + 8 * v14);
        *(_QWORD *)v16 = v5;
...
LABEL_24:
    ...
    while ( (unsigned int)v14 <= 0xFE )
    {
      ...
      if ( !v34 )
      {
        v21 = WdLogNewEntry5_WdAssertion(v5, v8);
    ...
    if ( v18 )
    {
      ...
      {
        v23 = WdLogNewEntry5_WdAssertion(v5, v8);
    ...
    if ( v22 != *((_DWORD *)this + 32) )
    {
      v33 = WdLogNewEntry5_WdAssertion(v5, v8);
