/*
 * XREFs of DxgkSubmitWaitForSyncObjectsToHwQueueInternal @ 0x1C026FFE8
 * Callers:
 ...
 *     DxgkSubmitWaitForSyncObjectsToHwQueue @ 0x1C026FFD0 (DxgkSubmitWaitForSyncObjectsToHwQueue.c)
 * Callees:
