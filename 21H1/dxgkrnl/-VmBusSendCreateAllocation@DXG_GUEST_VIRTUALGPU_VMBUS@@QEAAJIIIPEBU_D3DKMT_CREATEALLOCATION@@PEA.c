/*
 * XREFs of ?VmBusSendCreateAllocation@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIIPEBU_D3DKMT_CREATEALLOCATION@@PEAU_D3DDDI_ALLOCATIONINFO2@@PEAPEAXPEBX3EEPEAPEAE@Z @ 0x1C024244C
 * Callers:
...
LABEL_81:
  ...
  if ( PagesForMdl )
  {
    ...
    LODWORD(v30) = DXG_GUEST_GLOBAL_VMBUS::CreateGpadlFromMdl(*((struct _KTHREAD ***)v63 + 183), v30, &v29[2 * v56 + 7]);
    goto LABEL_75;
  }
  LODWORD(v30) = -1073741801;
  v81 = WdLogNewEntry5_WdLowResource(v60, v59, v61, v62);
  *(_QWORD *)(v81 + 24) = 8356LL;
