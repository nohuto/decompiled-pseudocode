/*
 * XREFs of ?CreateNewSourceModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_DXGK_VIDPNSOURCEMODESET_INTERFACE@@@Z @ 0x1C012B160
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNSOURCEMODESET__ **a4)
{
  ...
  struct DMMVIDPNSOURCEMODESET *v38; // [rsp+80h] [rbp+40h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v34, 7045LL);
    ...
    *a4 = 0LL;
    ...
    if ( v15 )
    {
      ...
      if ( v18 )
      {
        v37 = 0LL;
        v38 = 0LL;
        v22 = DMMVIDPNSOURCE::CreateNewCofuncModeSet(v18, &v38);
        v6 = v22;
        if ( v22 < 0 )
        {
        ...
        {
          auto_rc<DMMVIDPNSOURCEMODESET>::reset(&v37, (__int64)v38);
          v24 = v37;
          v25 = -(__int64)(v37 != -137);
          v37 = 0LL;
          *a3 = v24 & v25;
        ...
        auto_rc<DMMVIDPNSOURCEMODESET>::reset(&v37, 0LL);
      }
      else
      {
