/*
 * XREFs of ??0DXGSESSIONDATA@@QEAA@K@Z @ 0x1C015AB74
 * Callers:
 ...
 *     ?InitializeMaxActiveOutputDuplApps@OUTPUTDUPL_SESSION_MGR@@AEAAXXZ @ 0x1C015B20C (-InitializeMaxActiveOutputDuplApps@OUTPUTDUPL_SESSION_MGR@@AEAAXXZ.c)
 */
...
LABEL_32:
  ...
  *((_QWORD *)this + 2329) = CurrentProcess;
  ...
  if ( *((_QWORD *)DXGGLOBAL::GetGlobal(v27, v26) + 38033) )
