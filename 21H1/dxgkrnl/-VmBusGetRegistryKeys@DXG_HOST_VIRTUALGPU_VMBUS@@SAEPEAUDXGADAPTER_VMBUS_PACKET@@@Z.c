/*
 * XREFs of ?VmBusGetRegistryKeys@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023DDA0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (int)v15 >= 0 )
    {
      ...
      if ( v21 >= 0 )
      {
        ...
        if ( (int)v15 >= 0 )
        {
          ...
          {
            Values = (char *)ppszDest + 2 * pcchDestLength - (_QWORD)&unk_1C0081D08;
            do
            {
              if ( !v26 )
                break;
