/*
 * XREFs of ?DxgkCreateSynchronizationObjectImpl@@YAJPEAU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@U_VIDSCH_SYNC_OBJECT_CLIENTHINT@@HPEAX@Z @ 0x1C01109F0
 * Callers:
 *     DxgkCreateSynchronizationObject @ 0x1C010F160 (DxgkCreateSynchronizationObject.c)
 *     ?DxgkCddCreateSynchronizationObject@@YAJPEAU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@@Z @ 0x1C014E890 (-DxgkCddCreateSynchronizationObject@@YAJPEAU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@@Z.c)
...
__int64 __fastcall DxgkCreateSynchronizationObjectImpl(ULONG64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)&v99[0].hSyncObject = a4;
  ...
  v105.hSyncObject = 0;
  if ( (v105.Info.Flags.Value & 0x7FFFFF00) != 0 )
  {
  ...
  if ( *(_QWORD *)&v99[0].hSyncObject )
  {
    ...
    if ( v103 >= 0 )
    {
      ...
      v18 = CreateSynchronizationObjectInternal(
              v38,
              v60,
              *(_QWORD *)(*(_QWORD *)&v99[0].hSyncObject + 2680LL),
              &v105,
              v5,
              0,
              v104,
...
LABEL_85:
      ...
      else
      {
        ...
        if ( Type == D3DDDI_PERIODIC_MONITORED_FENCE )
        {
          ...
          if ( v107 )
            DXGADAPTER::ReleaseReferenceNoTracking(v107);
        }
...
LABEL_47:
    ...
    if ( v52 >= 0 )
    {
      ...
      if ( *(int *)(v56 + 2304) < 0x2000 && !*(_BYTE *)(v56 + 2604) )
      {
