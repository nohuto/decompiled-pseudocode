/*
 * XREFs of ?DxgkMakeResidentInternal@@YAJPEAUD3DDDI_MAKERESIDENT@@HPEAD@Z @ 0x1C0144130
 * Callers:
 ...
 *     DxgkMakeResident @ 0x1C0144110 (DxgkMakeResident.c)
...
LABEL_22:
  ...
  if ( *(int *)(v28 + 2304) >= 0x2000 || *(_BYTE *)(v28 + 2604) )
    v29 = *((_DWORD *)DXGGLOBAL::GetGlobal(v28, v18) + 283);
  else
    v29 = 0;
  v135 = v29;
    ...
    if ( AllocationList == v26 )
    {
      ...
      if ( v124 )
      {
        ...
        Resident = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendMakeResident(
                     (DXG_GUEST_VIRTUALGPU_VMBUS *)(v116 + 4208),
                     HostProcess,
                     0,
                     v117,
                     v65->Flags,
      ...
      else
      {
        ...
        {
          if ( *(_DWORD *)(v64 + 432) != 2
            || (v61 = *(_QWORD *)(*(_QWORD *)(v64 + 16) + 16LL), *(int *)(v61 + 2572) < 2000) )
          {
...
LABEL_72:
    ...
    *v52 = v49;
    ...
    ++AllocationList;
    if ( *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)v53, v46) + 283) )
    {
