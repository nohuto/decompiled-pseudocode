/*
 * XREFs of ?SetPowerComponentResidencyCB@DXGADAPTER@@QEAAXI_K@Z @ 0x1C0037E00
 * Callers:
...
void __fastcall DXGADAPTER::SetPowerComponentResidencyCB(DXGADAPTER *this, unsigned int a2, __int64 a3)
{
  ...
  if ( *((_BYTE *)this + 3217) )
  {
    ...
    *(_QWORD *)(520LL * v5 + *((_QWORD *)this + 347) + 376) = a3;
    PoFxSetComponentResidency(*((_QWORD *)this + 348), v5, a3);
  }
}
