/*
 * XREFs of ?PrepareDripsBlockerProcessName@DripsBlockerTrackingHelper@@QEAAJPEBDPEAU_EPROCESS@@PEADIPEA_K@Z @ 0x1C02BEFC0
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCbCatA@@YAJPEAD_KPEBD@Z @ 0x1C004CB04 (-RtlStringCbCatA@@YAJPEAD_KPEBD@Z.c)
 *     ?RtlStringCbCopyExA@@YAJPEAD_KPEBDPEAPEADPEA_KK@Z @ 0x1C004CB7C (-RtlStringCbCopyExA@@YAJPEAD_KPEBDPEAPEADPEA_KK@Z.c)
 *     RtlStringLengthWorkerA @ 0x1C004CCE8 (RtlStringLengthWorkerA.c)
 */
