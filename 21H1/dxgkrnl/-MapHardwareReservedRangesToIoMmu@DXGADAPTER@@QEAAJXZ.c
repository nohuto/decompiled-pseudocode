/*
 * XREFs of ?MapHardwareReservedRangesToIoMmu@DXGADAPTER@@QEAAJXZ @ 0x1C0209E74
 * Callers:
...
__int64 __fastcall DXGADAPTER::MapHardwareReservedRangesToIoMmu(DXGADAPTER *this)
{
  ...
  if ( *((_DWORD *)this + 1083) )
  {
    while ( 1 )
    {
      v4 = (_QWORD *)(*((_QWORD *)this + 542) + 16LL * v2);
      v5 = DpiMapIommuContiguous(*((_QWORD *)this + 27), *v4 / 4096LL, v4[1], 4, (__int64)v4);
      v1 = v5;
      if ( v5 < 0 )
        break;
      if ( ++v2 >= *((_DWORD *)this + 1083) )
