/*
 * XREFs of ?PinPathContentScaling@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C011CB60
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING a5)
{
  ...
  struct _DXGKARG_ISSUPPORTEDVIDPN v89; // [rsp+70h] [rbp-29h] BYREF
  struct _DXGKARG_ENUMVIDPNCOFUNCMODALITY v90; // [rsp+80h] [rbp-19h] BYREF
...
LABEL_18:
  ...
  *(_QWORD *)&v89.IsVidPnSupported = 0LL;
  ...
  else
  {
    ...
    {
LABEL_67:
      this = WdLogNewEntry5_WdDmmEvent(v28);
      *(_QWORD *)(this + 24) = v20;
      v58 = *(_QWORD *)(v19 + 8);
      if ( !v58 )
      {
    ...
    if ( !(_BYTE)a5 )
    {
      v48 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v28);
      v48[3] = 7LL;
      v48[4] = v20;
