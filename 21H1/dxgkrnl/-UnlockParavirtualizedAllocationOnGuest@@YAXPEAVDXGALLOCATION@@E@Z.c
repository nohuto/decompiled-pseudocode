/*
 * XREFs of ?UnlockParavirtualizedAllocationOnGuest@@YAXPEAVDXGALLOCATION@@E@Z @ 0x1C0224D74
 * Callers:
  ...
  if ( v4 )
  {
    ...
    if ( v5 )
    {
      if ( *((_DWORD *)a1 + 32) )
      {
        ...
        DXG_GUEST_GLOBAL_VMBUS::DeleteGpadl(*((DXG_GUEST_GLOBAL_VMBUS **)Global + 183), *((_DWORD *)a1 + 32));
        *((_DWORD *)a1 + 32) = 0;
      }
      v7 = *((_BYTE *)a1 + 132);
      if ( (v7 & 1) != 0 )
