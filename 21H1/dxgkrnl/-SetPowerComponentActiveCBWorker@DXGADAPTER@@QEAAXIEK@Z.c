/*
 * XREFs of ?SetPowerComponentActiveCBWorker@DXGADAPTER@@QEAAXIEK@Z @ 0x1C00373E4
 * Callers:
 ...
 *     ?PowerRuntimeComponentIdleStateCallback@DXGADAPTER@@QEAAXKKE@Z @ 0x1C00366A0 (-PowerRuntimeComponentIdleStateCallback@DXGADAPTER@@QEAAXKKE@Z.c)
 ...
 *     ?RecordActivity@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C0045CE4 (-RecordActivity@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 */
        ...
        unsigned int a4)
{
  ...
  if ( v10 )
  {
    ...
    if ( (*((_DWORD *)this + 636) & 0x10) != 0 )
    {
      v11 = *((_DWORD *)this + 356);
      v12 = 0;
      if ( v11 )
      {
        while ( *(_DWORD *)(*((_QWORD *)this + 482) + 4LL * v12) )
        {
          if ( ++v12 >= v11 )
            goto LABEL_12;
        }
    ...
    else if ( !**((_DWORD **)this + 482) )
    {
      goto LABEL_15;
    }
LABEL_12:
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 521, &LockHandle);
    *(_BYTE *)(*(_QWORD *)(v9 + v8 + 512) + 240LL) = 1;
    if ( !*((_BYTE *)this + 4176) )
    {
      ...
      *((_QWORD *)this + 504) = -1LL;
      KeSetTimer((PKTIMER)((char *)this + 4040), (LARGE_INTEGER)-120000LL, (PKDPC)((char *)this + 4104));
    }
...
LABEL_15:
  ...
  if ( (int)++*(_DWORD *)(v9 + v8 + 352) <= 1 )
  {
    ...
    {
      v31 = 0;
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 405, &v30);
      *((_QWORD *)this + 406) = KeGetCurrentThread();
      v4 = 0;
      ...
      *(_QWORD *)(v16 + 8) = v17;
      *v15 = 0LL;
      if ( *((DXGADAPTER **)this + 403) == (DXGADAPTER *)((char *)this + 3224) && *((_BYTE *)this + 3212) )
      {
        v18 = *((_QWORD *)this + 335);
        *((_BYTE *)this + 3212) = 0;
...
LABEL_27:
    ...
    KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)this + 414, &v32);
    v13 = 0;
    ...
    if ( (__int64 *)v20[1] == v19 )
    {
      ...
      if ( *v21 == v19 )
      {
        *v21 = v20;
        v20[1] = (__int64)v21;
        *v19 = 0LL;
        if ( *((DXGADAPTER **)this + 408) == (DXGADAPTER *)((char *)this + 3264) )
        {
          KeCancelTimer((PKTIMER)this + 52);
          *((_BYTE *)this + 3213) = 0;
        }
        KeReleaseInStackQueuedSpinLockFromDpcLevel(&v32);
...
LABEL_40:
  ...
  if ( v6 )
  {
    if ( v35 )
    {
      ...
      PoFxActivateComponent(*((_QWORD *)this + 348), (unsigned int)v5, 1LL);
      v27 = a4;
    }
    else
    {
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
        McTemplateK0pqq_EtwWriteTransfer(v24, (unsigned int)&Dxgk_ReportPowerComponentState, v25, (_DWORD)this, v5, 1);
      v27 = a4;
      PoFxActivateComponent(*((_QWORD *)this + 348), (unsigned int)v5, a4);
    }
    if ( v13 )
    {
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
