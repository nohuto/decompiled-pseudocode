/*
 * XREFs of ?QueryDisplayConfigInternal@@YAJ_NIIIPEAIPEAUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x1C00E3424
 * Callers:
...
LABEL_17:
  ...
  if ( RequestedPathsModality >= 0 )
  {
    ...
    v27 = QDC_CACHE::AddToCache(*((QDC_CACHE **)Global + 158), v44, v25, v7, *v14, v12, v11);
    v31 = v27;
    if ( v27 )
    {
