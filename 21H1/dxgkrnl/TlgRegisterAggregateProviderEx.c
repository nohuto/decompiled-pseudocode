/*
 * XREFs of TlgRegisterAggregateProviderEx @ 0x1C017FC7C
 * Callers:
 *     ?DxgkInitializeTelemetry@@YAXXZ @ 0x1C002293C (-DxgkInitializeTelemetry@@YAXXZ.c)
 * Callees:
 ...
 *     DestroyAggregateSession @ 0x1C02FC500 (DestroyAggregateSession.c)
 */
...
__int64 __fastcall TlgRegisterAggregateProviderEx(PVOID CallbackContext, __int64 a2, __int64 a3, __int16 a4)
{
  ...
  *(_BYTE *)(TlgAggregateSession + 373) = v5;
  ...
  {
    ExAcquirePushLockExclusiveEx(&unk_1C00B02D8, 0LL);
    v11 = qword_1C00B0EE8;
    if ( !qword_1C00B0EE8 )
    {
      TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C00AEB38);
      v11 = qword_1C00B0EE8;
    }
    v12 = &qword_1C00B0EE8;
    while ( v11 )
    ...
    *v12 = (__int64)v9;
LABEL_11:
    ExReleasePushLockExclusiveEx(&unk_1C00B02D8, 0LL);
    return 0LL;
  }
}
