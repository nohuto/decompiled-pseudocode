/*
 * XREFs of ?PinMode@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@I@Z @ 0x1C02E3DD0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)(v9 + 32) = this;
  ...
  if ( v11 )
  {
    v16 = DMMVIDPNSOURCEMODESET::PinMode(v11, v4);
    if ( v16 >= 0 )
    {
      v16 = 0;
    }
