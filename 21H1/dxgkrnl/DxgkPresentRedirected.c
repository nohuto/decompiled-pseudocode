/*
 * XREFs of DxgkPresentRedirected @ 0x1C027E930
 * Callers:
 *     <none>
 * Callees:
...
LABEL_35:
  ...
  if ( !v35 )
  {
    ...
    *(_QWORD *)(v38 + 32) = -1073741811LL;
    ...
    if ( v73 )
      DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v72, v16);
    if ( !v63 || _InterlockedExchangeAdd64((volatile signed __int64 *)v63 + 8, 0xFFFFFFFFFFFFFFFFuLL) != 1 )
      goto LABEL_41;
LABEL_40:
...
LABEL_41:
  ...
  DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v72, v36);
  v75 = v22;
  v76 = 0;
...
LABEL_54:
    ...
    if ( v73 )
      DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v72, v46);
    if ( v63 && _InterlockedExchangeAdd64((volatile signed __int64 *)v63 + 8, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
      ADAPTER_RENDER::DestroyDeviceNoLocks(*((ADAPTER_RENDER **)v63 + 2), v63);
LABEL_63:
...
LABEL_77:
  ...
  TOKEN_BINDING_GUARD::TOKEN_BINDING_GUARD(
    ...
    (struct COREDEVICEACCESS *)v85);
  v78[0] = 0LL;
  v78[1] = *(struct VIDSCH_SUBMIT_DATA_BASE **)(v22 + 2680);
  ...
  *(_QWORD *)(v58 + 24) = 1047LL;
  ...
  if ( _InterlockedExchangeAdd64((volatile signed __int64 *)v20 + 8, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
    ADAPTER_RENDER::DestroyDeviceNoLocks(*((ADAPTER_RENDER **)v20 + 2), v71);
  if ( v73 )
    DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v72, v59);
  if ( v63 && _InterlockedExchangeAdd64((volatile signed __int64 *)v63 + 8, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
    ADAPTER_RENDER::DestroyDeviceNoLocks(*((ADAPTER_RENDER **)v63 + 2), v63);
