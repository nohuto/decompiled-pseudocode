/*
 * XREFs of ?CreateFrameBufferSaveAreaSection@DXGADAPTER@@QEAAJI_K@Z @ 0x1C02078F8
 * Callers:
...
__int64 __fastcall DXGADAPTER::CreateFrameBufferSaveAreaSection(DXGADAPTER *this, __int64 a2, __int64 a3)
{
  ...
  if ( *(_QWORD *)(*((_QWORD *)this + 320) + v4 + 64) )
  {
    v6 = WdLogNewEntry5_WdAssertion(this, a2);
    *(_QWORD *)(v6 + 24) = 10396LL;
  ...
  if ( v7 >= 0 )
  {
    *(_QWORD *)(*((_QWORD *)this + 320) + v4 + 64) = v13;
  }
  else
  {
