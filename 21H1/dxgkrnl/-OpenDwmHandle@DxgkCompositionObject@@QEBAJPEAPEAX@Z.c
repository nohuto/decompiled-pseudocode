/*
 * XREFs of ?OpenDwmHandle@DxgkCompositionObject@@QEBAJPEAPEAX@Z @ 0x1C0018188
 * Callers:
 *     ?DxgkOpenDwmHandleForCompositionObjectReference@@YAJPEAXPEAPEAX@Z @ 0x1C0018170 (-DxgkOpenDwmHandleForCompositionObjectReference@@YAJPEAXPEAPEAX@Z.c)
...
__int64 __fastcall DxgkCompositionObject::OpenDwmHandle(PVOID Object, PHANDLE Handle)
{
  ...
  *Handle = (void *)-1LL;
  ...
  if ( !(*(unsigned int (**)(void))(*((_QWORD *)Global + 38033) + 232LL))() )
  {
    v8 = DXGGLOBAL::GetGlobal(v7, v6);
    if ( !(*(unsigned int (**)(void))(*((_QWORD *)v8 + 38033) + 136LL))() )
    {
      v9 = DXGGLOBAL::GetGlobal(v7, v6);
      (*(void (**)(void))(*((_QWORD *)v9 + 38033) + 144LL))();
      v4 = 1;
    }
  }
  v10 = DXGGLOBAL::GetGlobal(v7, v6);
  v11 = (struct _KPROCESS *)(*(__int64 (**)(void))(*((_QWORD *)v10 + 38033) + 272LL))();
  v14 = v11;
  if ( v11 )
  {
    ...
    (*(void (__fastcall **)(struct _KPROCESS *))(*((_QWORD *)v18 + 38033) + 200LL))(v14);
  }
  else
  {
    v15 = -1073741823;
  ...
  if ( v4 )
  {
    ...
    (*(void (**)(void))(*((_QWORD *)v19 + 38033) + 184LL))();
  }
  return v15;
}
