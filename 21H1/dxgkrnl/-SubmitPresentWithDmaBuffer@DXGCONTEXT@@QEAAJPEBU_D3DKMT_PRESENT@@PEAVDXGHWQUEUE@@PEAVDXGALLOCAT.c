/*
 * XREFs of ?SubmitPresentWithDmaBuffer@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT@@PEAVDXGHWQUEUE@@PEAVDXGALLOCATION@@2PEAU_DXGKARG_PRESENT@@PEAU_VIDMM_DMA_BUFFER@@PEAUVIDSCH_SUBMIT_DATA_BASE@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C00F4B80
 * Callers:
...
LABEL_74:
    ...
    *((_DWORD *)a8 + 18) = 0;
    ...
    if ( (_BYTE)v100 )
      v103 = (char *)a8 + *((_DWORD *)a8 + 143) * ((8 * *((_DWORD *)a8 + 144) + 199) & 0xFFFFFFF8) + 616;
    else
      v103 = (char *)a8 + 488;
    if ( *((_DWORD *)a8 + 30) == 4 )
    {
      ...
      *v102 = *v102 & 0xFFFFFC00 | 1;
             ...
             v103) < 0 )
      {
        ...
        *(_QWORD *)(v164 + 24) = 9195LL;
        WdLogEvent5_WdAssertion(v164);
      }
      v188 = 0;
      if ( *((_BYTE *)a8 + 348) )
        v165 = (char *)a8 + *((_DWORD *)a8 + 143) * ((8 * *((_DWORD *)a8 + 144) + 199) & 0xFFFFFFF8) + 608;
      else
        v165 = (char *)a8 + 504;
      ...
      v166 = (char *)a8 + 568;
      if ( *((_BYTE *)a8 + 348) )
        *(_WORD *)&v166[*((_DWORD *)a8 + 143) * ((8 * *((_DWORD *)a8 + 144) + 199) & 0xFFFFFFF8) + 32] = v188;
      else
      ...
      if ( v167 && (*(_DWORD *)(v167 + 4) & 8) != 0 )
        ...
        v168 = 0LL;
      if ( *((_BYTE *)a8 + 348) )
        *(_QWORD *)&v166[*((_DWORD *)a8 + 143) * ((8 * *((_DWORD *)a8 + 144) + 199) & 0xFFFFFFF8) + 56] = v168;
      else
        *((_QWORD *)a8 + 70) = v168;
      if ( *((_BYTE *)a8 + 348) )
        v169 = (char *)a8 + *((_DWORD *)a8 + 143) * ((8 * *((_DWORD *)a8 + 144) + 199) & 0xFFFFFFF8) + 592;
      else
        v169 = (char *)a8 + 496;
      *(_QWORD *)v169 = *(_QWORD *)(*((_QWORD *)v159 + 6) + 16LL);
      if ( *((_BYTE *)a8 + 348) )
        v100 = (char *)a8 + *((_DWORD *)a8 + 143) * ((8 * *((_DWORD *)a8 + 144) + 199) & 0xFFFFFFF8) + 584;
      else
        v100 = (char *)a8 + 552;
  ...
  v45 = *((_QWORD *)this + 2);
  v196 = 0LL;
  if ( (*(_BYTE *)&v44 & 1) != 0 || (v38 = *(_QWORD *)(*(_QWORD *)(v45 + 16) + 16LL), !*(_BYTE *)(v38 + 2626)) )
    v196 = *((_QWORD *)this + 23);
  v46 = *(_QWORD *)(v45 + 16);
  v205 = v46;
  v201 = -1;
  ...
  _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v46 + 16) + 4324LL));
  ...
  if ( !CurrentThread )
  {
    ...
    *(_QWORD *)(v130 + 24) = 496LL;
    WdLogEvent5_WdAssertion(v130);
  }
  CurrentProcessSessionId = PsGetCurrentProcessSessionId(v57);
...
LABEL_52:
  ...
  _InterlockedDecrement((volatile signed __int32 *)(*(_QWORD *)(v67 + 16) + 4324LL));
...
LABEL_177:
  ...
  {
    v140 = WdLogNewEntry5_WdEvent(v80, v79);
    *(_QWORD *)(v140 + 24) = this;
