/*
 * XREFs of ?FlushScheduler@ADAPTER_RENDER@@QEAAJW4DXGADAPTER_FLUSHSCHEDULER_REASON@@IH@Z @ 0x1C012B9C0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::FlushScheduler(__int64 a1, int a2, unsigned int a3, int a4)
{
  ...
  if ( *(_BYTE *)(v6 + 209) )
  {
    v29 = (DXG_VMBUS_CHANNEL_BASE *)(v6 + 4208);
    v30 = (struct _MDL *)*(unsigned int *)(*(_QWORD *)(v6 + 4272) + 4280LL);
    v47 = 0LL;
    v48 = 0;
    v49 = 0;
    v50 = 43;
