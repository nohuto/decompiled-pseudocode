/*
 * XREFs of ??$QueryResourceInfo@U_D3DKMT_QUERYRESOURCEINFOFROMNTHANDLE@@@DXGDEVICE@@QEAAJPEAU_D3DKMT_QUERYRESOURCEINFOFROMNTHANDLE@@IPEAU_DXGSHAREDALLOCOBJECT@@@Z @ 0x1C0124270
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v8 )
  {
    ...
    {
      v11 = *(_QWORD *)(a1 + 1848);
      if ( !v11 || *(_QWORD *)(v11 + 2680) || *(_QWORD *)(v8 + 96) == v11 )
      {
