/*
 * XREFs of ?Add@?$Set@VDMMVIDPNTARGETMODE@@@@QEAAEQEAVDMMVIDPNTARGETMODE@@@Z @ 0x1C000D810
 * Callers:
...
char __fastcall Set<DMMVIDPNTARGETMODE>::Add(__int64 a1, __int64 a2)
{
  ...
  if ( Set<DMMVIDPNTARGETMODE>::FindByValue() )
    return 0;
  if ( (unsigned __int8)DoublyLinkedList<DMMVIDEOPRESENTTARGET,DoubleLinkedListElementDeleter<DMMVIDEOPRESENTTARGET>>::ContainsByReference(a1 + 8) )
  {
