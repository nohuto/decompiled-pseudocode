/*
 * XREFs of ?QueryAllocationResidency@DXGDEVICE@@QEAAJPEAU_D3DKMT_QUERYALLOCATIONRESIDENCY@@E@Z @ 0x1C0224568
 * Callers:
...
LABEL_46:
  ...
  if ( (*((_BYTE *)this + 1869) & 1) != 0 )
    return DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendQueryAllocationResidency(
             (DXG_GUEST_VIRTUALGPU_VMBUS *)(*((_QWORD *)this[2] + 2) + 4208LL),
             this[5],
...
LABEL_9:
  ...
  if ( Count )
  {
    while ( 1 )
    {
      v18 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*((_QWORD *)this[2] + 80) + 8LL) + 184LL))(
              *((_QWORD *)this[2] + 81),
              *(_QWORD *)(Count + 24));
      if ( v18 == 3 )
        break;
...
LABEL_19:
  ...
  DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX(
    (DXGPROCESSCOPYPROTECTIONMUTEX *)v36,
    (__int64)pResidencyStatus);
