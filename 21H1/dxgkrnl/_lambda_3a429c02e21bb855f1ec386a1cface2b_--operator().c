/*
 * XREFs of _lambda_3a429c02e21bb855f1ec386a1cface2b_::operator() @ 0x1C00ECF40
 * Callers:
 *     _lambda_3dc479c6339d8ea3367aebfddfa054a6_::_lambda_invoker_cdecl_ @ 0x1C00198B0 (_lambda_3dc479c6339d8ea3367aebfddfa054a6_--_lambda_invoker_cdecl_.c)
 * Callees:
...
__int64 __fastcall lambda_3a429c02e21bb855f1ec386a1cface2b_::operator()(unsigned int **a1, __int64 a2)
{
  ...
  __int64 v98; // rax
  __int64 v99; // rax
  unsigned int v100; // [rsp+24h] [rbp-DCh]
  ...
  DXGADAPTERSTOPRESETLOCKSHARED::Acquire((DXGADAPTERSTOPRESETLOCKSHARED *)v105);
  if ( *(_DWORD *)(a2 + 200) == 1 && *(_QWORD *)(a2 + 2672) )
  {
    ++**v2;
    v5 = *(_QWORD *)v2[1];
    v6 = **v2;
    if ( *(_DWORD *)(v5 + 4) >= v6 )
    {
      ...
      *(_QWORD *)v62 = *(_QWORD *)(a2 + 316);
      RtlStringCbCopyNW(
        (char *)(v62 + 8),
        0LL,
        *(char **)(*(_QWORD *)(a2 + 1496) + 8LL),
        **(unsigned __int16 **)(a2 + 1496));
      v75 = *(_DWORD *)(v62 + 556) & 0xFFFFFFFD | (*(_BYTE *)(*(_QWORD *)(a2 + 2672) + 249LL) != 0 ? 2 : 0);
      *(_DWORD *)(v62 + 556) = v75;
      v76 = v75 & 0xFFFFFFFE | (*(_BYTE *)(*(_QWORD *)(a2 + 2672) + 250LL) != 0);
      *(_DWORD *)(v62 + 556) = v76;
      v77 = *(_QWORD *)(a2 + 2672);
      ...
      *(_DWORD *)(v62 + 556) = v79;
      *(_DWORD *)(v62 + 528) = *(_DWORD *)(a2 + 2572);
      *(_DWORD *)(v62 + 532) = *(_DWORD *)(*(_QWORD *)(a2 + 2672) + 80LL);
          ...
          if ( v15 )
          {
            ...
            if ( v16 )
            {
                ...
                do
                {
                  ...
                  if ( *(_DWORD *)(v22 + 44) == v100 )
                  {
                    ...
                    if ( v22 )
                    {
                      if ( v16 == -168 )
                      {
                        v92 = WdLogNewEntry5_WdAssertion(v20, 0LL);
              ...
              *(_QWORD *)(v23 + 24) = v100;
              if ( v16 == -168 )
              {
                v94 = WdLogNewEntry5_WdAssertion(v25, v24);
...
LABEL_28:
        ...
        if ( *((_DWORD *)v55 + 108) == 1 && (*((_DWORD *)v55 + 10) & 0x10) == 0 )
        {
          ...
          *(_QWORD *)(v99 + 24) = v55;
          ...
          v3 = 0;
LABEL_63:
          MonitorGetCCDMonitorID(*(_QWORD *)(v12 + 112), 260LL, v29 + 12);
          *(_DWORD *)(v29 + 1072) ^= (*(_DWORD *)(v29 + 1072) ^ (*(_DWORD *)(v12 + 556) >> 3)) & 8;
          v2 = a1;
          if ( (int)MonitorGetMonitorType(*(struct HDXGMONITOR__ **)(v12 + 112)) >= 0 )
            *(_DWORD *)(v29 + 1056) = 1;
          goto LABEL_28;
        }
        memset(&v110[41], 0, 0x100uLL);
        v56 = (struct _DEVICE_OBJECT *)*((_QWORD *)v55 + 7);
        if ( !v56 || !*((_QWORD *)v55 + 12) )
          goto LABEL_54;
