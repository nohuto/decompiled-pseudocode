/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C006D6DC
 * Callers:
 ...
 *     GetImageTuple @ 0x1C006D65C (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C006DBE8 (_tlgCreate1Sz_char.c)
 *     TakeTelemetryAssertsLock @ 0x1C006DC1C (TakeTelemetryAssertsLock.c)
 */
...
LABEL_33:
  ...
  if ( (unsigned int)dword_1C00D2040 > 5 && tlgKeywordOn((__int64)&dword_1C00D2040, 0x400000000000LL) )
  {
    v36 = 10;
    v67 = &v36;
    v68 = 4LL;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_1C00D2040,
      (unsigned __int8 *)dword_1C007F0CF,
      0LL,
      v24,
      0xBu,
      &v66);
  }
  if ( dword_1C00D2078 && !v19 && !KeGetCurrentIrql() )
  {
    v27 = DbgkWerCaptureLiveKernelDump(L"TELASSERT", 465LL, v15, 0LL, v35, v13, 0LL, 0LL, 0);
    if ( (unsigned int)dword_1C00D2040 > 5 )
    {
      v29 = tlgKeywordOn((__int64)&dword_1C00D2040, 0x400000000000LL);
      v28 = 0LL;
      if ( v29 )
      {
        v52 = 4LL;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_1C00D2040,
          (unsigned __int8 *)dword_1C007F13C,
          v31,
          0LL,
          v32,
          &v50);
