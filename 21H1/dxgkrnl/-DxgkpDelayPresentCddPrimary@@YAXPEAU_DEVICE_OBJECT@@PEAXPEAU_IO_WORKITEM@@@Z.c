/*
 * XREFs of ?DxgkpDelayPresentCddPrimary@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C020E320
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkpDelayPresentCddPrimary(__int64 IoObject, struct _LUID *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  v5 = DXGSESSIONMGR::AcquireConsoleSessionModeChangeLock(*((DXGSESSIONMGR **)Global + 88));
  v8 = v5;
  if ( !v5 )
  {
  ...
  if ( CddDeviceAndContextForCurrentSession >= 0 )
  {
    ...
    v19 = *(DXGADAPTER ***)(*((_QWORD *)v13 + 231) + 2672LL);
    ...
    if ( v49[0] )
    {
      v26 = COREDEVICEACCESS::AcquireExclusive((__int64)v50, 1LL);
      v29 = v26;
      if ( v26 >= 0 )
      {
...
LABEL_21:
  ...
  DXGSESSIONMGR::ReleaseConsoleSessionModeChangeLock(*((struct DXGSESSIONDATA ***)v35 + 88), v8);
  if ( v18 )
  {
