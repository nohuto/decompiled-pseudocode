/*
 * XREFs of ?Augment@CDS_JOURNAL@@QEAAJPEAUD3DKMT_AUGMENT_CDSJ@@@Z @ 0x1C013CCF0
 * Callers:
 ...
 *     ?_PreVerify@CDS_JOURNAL@@CAJAEBUD3DKMT_AUGMENT_CDSJ@@@Z @ 0x1C013CE40 (-_PreVerify@CDS_JOURNAL@@CAJAEBUD3DKMT_AUGMENT_CDSJ@@@Z.c)
...
__int64 __fastcall CDS_JOURNAL::Augment(CDS_JOURNAL *this, struct D3DKMT_AUGMENT_CDSJ *a2)
{
  ...
  _QWORD *v25; // rax
  __int64 v26; // rax
  _BYTE v27[64]; // [rsp+20h] [rbp-E0h] BYREF
  __int64 v28; // [rsp+60h] [rbp-A0h]
  _BYTE v29[64]; // [rsp+80h] [rbp-80h] BYREF
  _OWORD *v30; // [rsp+C0h] [rbp-40h]
  _DWORD v31[9]; // [rsp+E0h] [rbp-20h] BYREF
  __int64 v32; // [rsp+104h] [rbp+4h]
  __int128 v33; // [rsp+10Ch] [rbp+Ch]
  __int128 v34; // [rsp+11Ch] [rbp+1Ch]
  __int64 v35; // [rsp+12Ch] [rbp+2Ch]

  if ( (*(_DWORD *)a2 & 4) != 0 )
    return CDS_JOURNAL::_PreVerify(a2);
  CCD_TOPOLOGY::CCD_TOPOLOGY((CCD_TOPOLOGY *)v29, 8u, 0);
  LODWORD(v5) = CDS_JOURNAL::_FillTopology((struct CCD_TOPOLOGY *)v29, a2, 64);
  if ( (int)v5 >= 0 )
  {
    if ( *((_DWORD *)a2 + 4) == -1 )
    {
    ...
    else
    {
      ...
      {
        LODWORD(v5) = CCD_TOPOLOGY::VerifyConnectivityHash((CCD_TOPOLOGY *)v29, this, (__int64)v6);
      ...
      *((_DWORD *)this + 4) = *((_DWORD *)v8 + 4);
      if ( (*(_DWORD *)a2 & 1) != 0 )
      {
        ...
        *(_OWORD *)&v31[5] = 0LL;
        v33 = 0LL;
        v34 = 0LL;
        CDS_JOURNAL::_FillEntry((struct CDS_JOURNAL::_ENTRY *)v31, a2, v6);
        CCD_TOPOLOGY::CCD_TOPOLOGY((CCD_TOPOLOGY *)v27, 8u, 0);
        LODWORD(v5) = CDS_JOURNAL::_FillTopology((struct CCD_TOPOLOGY *)v27, a2, 15);
        if ( (int)v5 >= 0 )
        {
          v19 = CDS_JOURNAL::_CommitEntry((const struct CDS_JOURNAL::_ENTRY *)v31, (struct CCD_TOPOLOGY *)v27);
          v5 = v19;
          if ( v19 < 0
            || (CCD_TOPOLOGY::FillScalingIntent((CCD_TOPOLOGY *)v27),
                v24 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v27, 1LL, v22, v23),
                v5 = v24,
                v24 < 0) )
          {
          ...
          {
            LODWORD(v5) = CDS_JOURNAL::_PurgeRelatedEntries(this, (const struct CDS_JOURNAL::_ENTRY *)v31);
          }
        }
