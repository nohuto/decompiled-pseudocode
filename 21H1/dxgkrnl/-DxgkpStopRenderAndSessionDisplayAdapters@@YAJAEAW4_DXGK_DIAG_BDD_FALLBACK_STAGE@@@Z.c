/*
 * XREFs of ?DxgkpStopRenderAndSessionDisplayAdapters@@YAJAEAW4_DXGK_DIAG_BDD_FALLBACK_STAGE@@@Z @ 0x1C0208BDC
 * Callers:
...
__int64 __fastcall DxgkpStopRenderAndSessionDisplayAdapters(enum _DXGK_DIAG_BDD_FALLBACK_STAGE *a1, __int64 a2)
{
  ...
  v3 = *((_QWORD *)DXGGLOBAL::GetGlobal((__int64)a1, a2) + 91);
  if ( v3 == *((_QWORD *)DXGGLOBAL::GetGlobal(v5, v4) + 89) )
  {
