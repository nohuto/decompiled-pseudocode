/*
 * XREFs of ?GetVirtualMonitorInfo@DXGADAPTER@@QEAAJIPEAU_DXGK_IDD_VIRTUAL_MONITOR_INFO@@@Z @ 0x1C020949C
 * Callers:
        ...
        struct _DXGK_IDD_VIRTUAL_MONITOR_INFO *a3)
{
  ...
  {
    v4 = (__int64 (__fastcall *)(_QWORD, __int64, struct _DXGK_IDD_VIRTUAL_MONITOR_INFO *))*((_QWORD *)this + 244);
    if ( v4 )
      return v4(*((_QWORD *)this + 233), a2, a3);
  }
