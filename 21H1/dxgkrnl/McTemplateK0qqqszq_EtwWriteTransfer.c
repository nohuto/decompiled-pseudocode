/*
 * XREFs of McTemplateK0qqqszq_EtwWriteTransfer @ 0x1C004CD54
 * Callers:
 *     ?AddActiveTime@DripsBlockerTrackingHelper@@IEAAXII@Z @ 0x1C02BAF4C (-AddActiveTime@DripsBlockerTrackingHelper@@IEAAXII@Z.c)
