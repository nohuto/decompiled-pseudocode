/*
 * XREFs of DxgkGetMultisampleMethodList @ 0x1C025A3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetMultisampleMethodList(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  _D3DDDIFORMAT v62[4]; // [rsp+68h] [rbp-120h]
  ...
  if ( (int)v10 >= 0 )
  {
    ...
    if ( v68 )
    {
      ...
      if ( PairingAdapters >= 0 )
      {
        ...
        if ( v31 < 0 )
        {
          v49 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v33);
          v49[3] = v10;
          v49[4] = Current;
          v49[5] = v61[0];
          v49[6] = v29;
        ...
        {
          v35 = v61[1];
          if ( *(_DWORD *)(*((_QWORD *)v29 + 334) + 80LL) > v61[1] )
          {
            if ( *((_QWORD *)v29 + 335) )
            {
