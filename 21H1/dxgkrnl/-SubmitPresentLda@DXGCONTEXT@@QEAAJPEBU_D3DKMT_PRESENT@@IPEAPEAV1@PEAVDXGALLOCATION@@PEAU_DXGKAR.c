/*
 * XREFs of ?SubmitPresentLda@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT@@IPEAPEAV1@PEAVDXGALLOCATION@@PEAU_DXGKARG_PRESENT@@PEAUVIDSCH_SUBMIT_DATA_BASE@@@Z @ 0x1C027D538
 * Callers:
  ...
  *(_DWORD *)((char *)a7 + v17 + 480) = *(_DWORD *)((_BYTE *)a7 + v17 + 480) & 0xFFFFFC00 | 1;
  ...
  while ( 1 )
  {
    ...
    if ( v18 >= v9 )
    {
      ...
      Ptr = 0LL;
      v53 = this[2].Count;
      if ( (v51->Flags.Value & 1) != 0 || !*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v53 + 16) + 16LL) + 2626LL) )
        Ptr = this[23].Ptr;
...
LABEL_31:
    ...
    v35 = (char *)a7 + 568;
    if ( *((_BYTE *)a7 + 348) )
      v36 = &v35[64 * (unsigned __int64)(v18 * *((_DWORD *)a7 + 143))
               + 48
               + *((_DWORD *)a7 + 143) * ((8 * *((_DWORD *)a7 + 144) + 199) & 0xFFFFFFF8)];
    else
      v36 = (char *)a7 + 488;
    ...
    v40 = v64;
    if ( *((_BYTE *)a7 + 348) )
      *(_WORD *)&v35[64 * (unsigned __int64)(v64 * *((_DWORD *)a7 + 143))
                   + 32
                   + *((_DWORD *)a7 + 143) * ((8 * *((_DWORD *)a7 + 144) + 199) & 0xFFFFFFF8)] = v39;
    else
      *((_DWORD *)a7 + 135) ^= (*((_DWORD *)a7 + 135) ^ (v39 << 17)) & 0x3E0000;
    if ( *((_BYTE *)a7 + 348) )
      v41 = (__int64 *)&v35[64 * (unsigned __int64)(v40 * *((_DWORD *)a7 + 143))
                          + 40
                          + *((_DWORD *)a7 + 143) * ((8 * *((_DWORD *)a7 + 144) + 199) & 0xFFFFFFF8)];
    else
    ...
    *v41 = v68;
    ...
    if ( *((_BYTE *)a7 + 348) )
      *(_QWORD *)((char *)a7
                + 64 * (unsigned __int64)(v40 * *((_DWORD *)a7 + 143))
                + *((_DWORD *)a7 + 143) * ((8 * *((_DWORD *)a7 + 144) + 199) & 0xFFFFFFF8)
                + 624) = v44;
    else
      *((_QWORD *)a7 + 70) = v44;
    if ( *((_BYTE *)a7 + 348) )
      v45 = &v35[64 * (unsigned __int64)(v40 * *((_DWORD *)a7 + 143))
               + 24
               + *((_DWORD *)a7 + 143) * ((8 * *((_DWORD *)a7 + 144) + 199) & 0xFFFFFFF8)];
    else
      v45 = (char *)a7 + 496;
    *(_QWORD *)v45 = *(_QWORD *)(v24[6].Count + 16);
    if ( !*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(this[2].Count + 16) + 16LL) + 2626LL) )
    {
      v44 = *(_QWORD *)(v66[v73].Count + 184);
      if ( *((_BYTE *)a7 + 348) )
        v46 = &v35[64 * (unsigned __int64)(v40 * *((_DWORD *)a7 + 143))
                 + 16
                 + *((_DWORD *)a7 + 143) * ((8 * *((_DWORD *)a7 + 144) + 199) & 0xFFFFFFF8)];
      else
        v46 = (char *)a7 + 552;
