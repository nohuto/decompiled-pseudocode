/*
 * XREFs of ?VmBusDdiGetNodeMetadata@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023B020
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDdiGetNodeMetadata(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *(_BYTE *)(v4 + 165) )
  {
    ...
    if ( v23[4] >= 0 )
    {
      ...
      {
        v15 = (unsigned __int16 *)(*(_QWORD *)(v8 + 2560) + 360LL * (unsigned int)v12);
        ...
        *(_QWORD *)(v14 + 24) = 4068LL;
      }
      else
      {
        v14 = WdLogNewEntry5_WdWarning(v12, v11, v9);
        *(_QWORD *)(v14 + 24) = 4060LL;
      }
