/*
 * XREFs of ?CreateUpdateTokens@CContentResourceState@@QEAAJPEAVCEndpointResourceStateManager@@PEAVCFlipPropertySet@@AEAU_LIST_ENTRY@@@Z @ 0x1C006C814
 * Callers:
 ...
 * Callees:
 *     ?FindPoolBufferIndex@CEndpointResourceStateManager@@QEAAI_K@Z @ 0x1C006A718 (-FindPoolBufferIndex@CEndpointResourceStateManager@@QEAAI_K@Z.c)
