/*
 * XREFs of ?_ValidateMipiDsiPackets@DXGMONITOR@@AEAAJPEAU_DXGK_DSI_TRANSMISSION@@@Z @ 0x1C02F782C
 * Callers:
 *     ?_DsiTransmission@DXGMONITOR@@AEAAJKPEAXK0PEA_K@Z @ 0x1C02F71E0 (-_DsiTransmission@DXGMONITOR@@AEAAJKPEAXK0PEA_K@Z.c)
 * Callees:
 *     ?_IsValidPacket@DXGMONITOR@@AEAAEPEAU_DXGK_DSI_PACKET@@EI@Z @ 0x1C02F758C (-_IsValidPacket@DXGMONITOR@@AEAAEPEAU_DXGK_DSI_PACKET@@EI@Z.c)
 */
