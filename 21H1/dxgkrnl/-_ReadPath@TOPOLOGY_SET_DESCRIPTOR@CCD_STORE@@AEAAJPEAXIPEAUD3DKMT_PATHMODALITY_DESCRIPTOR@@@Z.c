/*
 * XREFs of ?_ReadPath@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@AEAAJPEAXIPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C00E6BB8
 * Callers:
        ...
        struct D3DKMT_PATHMODALITY_DESCRIPTOR *a4)
{
  ...
  if ( v7 >= 0 )
  {
    v12 = CcdReadRegistryValues((int)a2, &Dest, &unk_1C00AE220, (__int64)a4);
    v16 = *(unsigned int *)a4;
    *(_QWORD *)a4 = v16;
    v10 = v12;
    if ( v12 >= 0 )
    {
      if ( (v16 & 0x100) != 0 )
      {
        v18 = CcdReadRegistryValues((int)a2, &Dest, &unk_1C00AE620, (__int64)a4);
        v10 = v18;
        if ( v18 >= 0 )
        {
          v28 = *(_QWORD *)a4;
        ...
        else
        {
          ...
          RegistryValues = CcdReadRegistryValues((int)a2, 0LL, &unk_1C00AE7E0, (__int64)a4);
          v26 = RegistryValues;
          if ( RegistryValues < 0 )
          {
      ...
      if ( (v16 & 0x800000) != 0 )
      {
        v29 = CcdReadRegistryValues((int)a2, &Dest, &unk_1C00AE500, (__int64)a4);
        v10 = v29;
        if ( v29 >= 0 )
        {
