/*
 * XREFs of ?DxgkCheckPairedRenderAdapterForStopCallBack@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C0208670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCheckPairedRenderAdapterForStopCallBack(struct DXGADAPTER *a1, DXGADAPTER *a2)
{
  ...
  if ( *((_DWORD *)a1 + 50) == 1 )
  {
    if ( *((_BYTE *)a2 + 209) && !*((_QWORD *)a1 + 335) )
    {
      COREACCESS::COREACCESS((COREACCESS *)v16, a1);
      COREACCESS::AcquireExclusive((__int64)v16, 1LL, 0);
      for ( i = 0; i < v5; ++i )
      {
