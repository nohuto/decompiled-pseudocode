/*
 * XREFs of ?SetPrimaryPath@ADAPTER_DISPLAY@@QEAAXIIW4_DXGK_PRIMARY_TARGET_TYPE@@@Z @ 0x1C0155580
 * Callers:
 ...
 *     DxgkSetPostDeviceCandidateTarget @ 0x1C00199A0 (DxgkSetPostDeviceCandidateTarget.c)
 */
