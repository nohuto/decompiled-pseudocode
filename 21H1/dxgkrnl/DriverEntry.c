/*
 * XREFs of DriverEntry @ 0x1C0302C24
 * Callers:
 ...
 *     ?DxgDbgInit@@YAXXZ @ 0x1C017F42C (-DxgDbgInit@@YAXXZ.c)
 *     DxgkInitIoMmu @ 0x1C017F4A4 (DxgkInitIoMmu.c)
 *     MonitorInitializeGlobal @ 0x1C017F4DC (MonitorInitializeGlobal.c)
 *     DxgkInitialPower @ 0x1C017FC24 (DxgkInitialPower.c)
