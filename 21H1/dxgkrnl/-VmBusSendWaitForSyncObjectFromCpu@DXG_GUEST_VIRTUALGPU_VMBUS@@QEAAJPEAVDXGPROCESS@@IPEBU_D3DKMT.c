/*
 * XREFs of ?VmBusSendWaitForSyncObjectFromCpu@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@IPEBU_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMCPU@@E@Z @ 0x1C02498BC
 * Callers:
 ...
 *     ?WaitFence@BLTQUEUE@@QEAAJ_KPEAVDXGDEVICE@@@Z @ 0x1C02FBD50 (-WaitFence@BLTQUEUE@@QEAAJ_KPEAVDXGDEVICE@@@Z.c)
 * Callees:
...
LABEL_34:
    ...
    if ( !a4->hAsyncEvent )
    {
      v44[0] = (PVOID)(*((_QWORD *)this + 8) + 2648LL);
      v44[1] = p_Event;
