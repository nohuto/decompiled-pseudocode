/*
 * XREFs of DxgkDispMgrSourceOperation @ 0x1C02AD4B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??BDXGADAPTER_REFERENCE@@QEBA_NXZ @ 0x1C003A42C (--BDXGADAPTER_REFERENCE@@QEBA_NXZ.c)
...
__int64 __fastcall DxgkDispMgrSourceOperation(_OWORD *a1)
{
  ...
  DXGADAPTER *v24[2]; // [rsp+48h] [rbp-190h] BYREF
  DXGADAPTER *v25[2]; // [rsp+58h] [rbp-180h] BYREF
    ...
    else
    {
      ...
      if ( DXGADAPTER_REFERENCE::operator bool(v24) )
      {
        ...
        if ( (int)COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v29, 0LL) >= 0
          ...
          && v14 < *(_DWORD *)(*((_QWORD *)v13 + 334) + 80LL) )
        {
