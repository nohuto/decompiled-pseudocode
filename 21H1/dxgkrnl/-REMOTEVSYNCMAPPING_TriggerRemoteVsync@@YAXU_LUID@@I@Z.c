/*
 * XREFs of ?REMOTEVSYNCMAPPING_TriggerRemoteVsync@@YAXU_LUID@@I@Z @ 0x1C0014A70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall REMOTEVSYNCMAPPING_TriggerRemoteVsync(struct _LUID a1, __int64 a2)
{
  ...
  int v10; // ecx
  int v11; // r8d
  _QWORD P[2]; // [rsp+40h] [rbp-58h] BYREF
  ...
  *(struct _LUID *)v17 = a1;
  *(_DWORD *)&v17[8] = v2;
  v4 = (_QWORD **)((char *)DXGGLOBAL::m_pGlobal + 304552);
  v16 = 0;
  v5 = (char *)DXGGLOBAL::m_pGlobal + 304568;
  v14 = (char *)DXGGLOBAL::m_pGlobal + 304568;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)DXGGLOBAL::m_pGlobal + 38071, &LockHandle);
  ...
  do
  {
    ...
    if ( *((_DWORD *)v8 + 4) == *(_DWORD *)v17 && *(_QWORD *)((char *)v8 + 20) == *(_QWORD *)&v17[4] )
    {
      ...
      *(_WORD *)((char *)&v13 + 1) = 257;
      DXG_HOST_GLOBAL_VMBUS::VmBusSendSignalGuestEvent(P);
