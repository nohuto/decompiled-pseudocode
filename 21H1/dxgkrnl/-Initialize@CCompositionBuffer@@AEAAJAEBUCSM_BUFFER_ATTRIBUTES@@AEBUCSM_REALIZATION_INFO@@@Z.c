/*
 * XREFs of ?Initialize@CCompositionBuffer@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@@Z @ 0x1C0064AAC
 * Callers:
        ...
        const struct CSM_REALIZATION_INFO *a3)
{
  ...
  v8 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)Global + 38033) + 16LL))((char *)this + 248);
  if ( v8 >= 0 )
  {
    v9 = *(_OWORD *)a2;
    DWORD1(v12[0]) = 0;
