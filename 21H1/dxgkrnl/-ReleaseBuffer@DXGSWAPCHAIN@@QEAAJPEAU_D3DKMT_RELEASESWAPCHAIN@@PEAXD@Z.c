/*
 * XREFs of ?ReleaseBuffer@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_RELEASESWAPCHAIN@@PEAXD@Z @ 0x1C02A7628
 * Callers:
...
LABEL_50:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x80000000LL) != 0 )
  {
    ...
    LODWORD(Size) = v16;
    McTemplateK0pqdqp_EtwWriteTransfer(pDeferredFreeList_low, v20, v22, this, Size, Src, v51, v7);
  }
