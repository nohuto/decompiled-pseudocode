/*
 * XREFs of ?FinalizeInitialization@ADAPTER_RENDER@@QEAAJXZ @ 0x1C016D59C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::FinalizeInitialization(ADAPTER_RENDER *this, __int64 a2)
{
  ...
  if ( !*(_BYTE *)(*((_QWORD *)this + 2) + 209LL) )
  {
    ...
    LODWORD(v6) = DXGPROCESS::OpenAdapter(*((DXGPROCESS **)Global + 143), this, 1);
    if ( (int)v6 < 0
    ...
    else
    {
      ...
      if ( v13 >= 0 )
        return (unsigned int)v6;
      v15 = *(unsigned int *)(*((_QWORD *)this + 2) + 2632LL);
      if ( (v15 & 0x10) != 0 )
      {
        LODWORD(v6) = 0;
        return (unsigned int)v6;
