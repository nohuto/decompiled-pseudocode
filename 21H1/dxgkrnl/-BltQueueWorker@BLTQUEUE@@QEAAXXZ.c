/*
 * XREFs of ?BltQueueWorker@BLTQUEUE@@QEAAXXZ @ 0x1C01213E4
 * Callers:
 ...
 *     ?TdrIsDodVSyncTimeoutForcedFlip@@YA_NXZ @ 0x1C02616CC (-TdrIsDodVSyncTimeoutForcedFlip@@YA_NXZ.c)
 ...
 *     ?ResetInternal@BLTQUEUE@@AEAAXXZ @ 0x1C02FAA40 (-ResetInternal@BLTQUEUE@@AEAAXXZ.c)
        ...
        if ( (_DWORD)v31 )
        {
          ...
          else
          {
            ...
            if ( (int)COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v66, 0LL) >= 0 )
            {
              ...
              if ( (*(int (__fastcall **)(__int64, unsigned __int64, _QWORD, __int64 *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v39 + 335) + 616LL) + 8LL)
                                                                                       + 656LL))(
                     1LL,
                     v38 + v41 + 8,
                     0LL,
