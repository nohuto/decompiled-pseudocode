/*
 * XREFs of ?VgpuTraceFrequentRead@@YAXEJPEAXPEBG1ZZ @ 0x1C022CC90
 * Callers:
 *     DxgkDdiReadVirtualFunctionConfig @ 0x1C022D8B0 (DxgkDdiReadVirtualFunctionConfig.c)
 *     DxgkDdiReadVirtualFunctionConfigBlock @ 0x1C022D960 (DxgkDdiReadVirtualFunctionConfigBlock.c)
 *     DxgkDdiWriteVirtualFunctionConfig @ 0x1C022DC84 (DxgkDdiWriteVirtualFunctionConfig.c)
 *     DxgkDdiWriteVirtualFunctionConfigBlock @ 0x1C022DD34 (DxgkDdiWriteVirtualFunctionConfigBlock.c)
