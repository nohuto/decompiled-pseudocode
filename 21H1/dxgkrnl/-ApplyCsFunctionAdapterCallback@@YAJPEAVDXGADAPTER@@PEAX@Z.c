/*
 * XREFs of ?ApplyCsFunctionAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C027F9C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z @ 0x1C0046D54 (-SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z.c)
...
__int64 __fastcall ApplyCsFunctionAdapterCallback(struct DXGADAPTER *a1, int *a2)
{
  ...
  if ( *((_DWORD *)a1 + 50) == 1 )
  {
    ...
    {
      v6 = (struct ADAPTER_RENDER *)*((_QWORD *)a1 + 335);
      v32 = 0LL;
