/*
 * XREFs of ?EmitSleepStudyTotalTimeModernStandbyTelemetry@DripsBlockerTrackingHelper@@IEAAX_K@Z @ 0x1C02BBF6C
 * Callers:
        ...
        __int64 a2)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000002000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C007DD38,
        0LL,
        0LL,
        v10 + 8,
        &v18);
