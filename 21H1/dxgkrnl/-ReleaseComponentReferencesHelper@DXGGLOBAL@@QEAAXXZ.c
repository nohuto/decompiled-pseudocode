/*
 * XREFs of ?ReleaseComponentReferencesHelper@DXGGLOBAL@@QEAAXXZ @ 0x1C0266A60
 * Callers:
 *     ?CsExitInitiatedReleaseComponentReferencesPassiveLevel@@YAXPEAX@Z @ 0x1C0264430 (-CsExitInitiatedReleaseComponentReferencesPassiveLevel@@YAXPEAX@Z.c)
...
void __fastcall DXGGLOBAL::ReleaseComponentReferencesHelper(DXGGLOBAL *this)
{
  ...
  v1 = (volatile signed __int32 **)((char *)this + 552);
  ...
  while ( v5 != (volatile signed __int32 *)v1 && v5 )
  {
    ...
    if ( *((_DWORD *)v6 + 864) )
    {
      ...
      if ( (_BYTE)v7 )
      {
        ...
        {
          for ( i = 0; i < *((_DWORD *)v6 + 730); ++i )
          {
            if ( !*(_DWORD *)(520LL * i + *((_QWORD *)v6 + 347) + 208) )
              DXGADAPTER::SetPowerComponentIdleCBInternal((DXGADAPTER *)v6, i, 0);
          }
          _InterlockedDecrement(v6 + 864);
        }
