/*
 * XREFs of ?TdrGatherPowerTriage@@YA?AU_DPI_DBG_POWER_ACTIVITY@@XZ @ 0x1C0043214
 * Callers:
...
__int64 __fastcall TdrGatherPowerTriage(__int64 a1, __int64 a2)
{
  ...
  v3 = 0;
  v4 = 0;
  v5 = (_QWORD *)((char *)Global + 552);
  v6 = (_QWORD *)*((_QWORD *)Global + 69);
  while ( v6 != v5 && v6 )
  {
    v7 = v6;
    v6 = (_QWORD *)*v6;
    ...
    {
      if ( (v3 & 1) != 0 || (v9 = 0, v7[336]) )
        v9 = 1;
      v10 = v9 | v3 & 0xFE;
      if ( (v10 & 2) != 0 || (v11 = 0, *((_DWORD *)v7 + 1081)) )
        v11 = 2;
      v3 = v11 | v10 & 0xFD;
      LOBYTE(v13) = v3;
    }
