/*
 * XREFs of ?PinPathContentScaling@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C02DB258
 * Callers:
  ...
  *(_QWORD *)&v73.IsVidPnSupported = 0LL;
  ...
  if ( (int)v12 >= 0 )
  {
    ...
    *((_DWORD *)&v74.EnumPivot + 2) = 0;
    ...
    v74.EnumPivotType = D3DKMDT_EPT_SCALING;
    v74.EnumPivot = v76;
    if ( !v61 )
    {
