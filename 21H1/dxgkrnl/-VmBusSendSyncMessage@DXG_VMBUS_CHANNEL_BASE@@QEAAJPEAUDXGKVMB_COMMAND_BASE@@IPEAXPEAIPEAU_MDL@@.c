/*
 * XREFs of ?VmBusSendSyncMessage@DXG_VMBUS_CHANNEL_BASE@@QEAAJPEAUDXGKVMB_COMMAND_BASE@@IPEAXPEAIPEAU_MDL@@@Z @ 0x1C0248DD4
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  _BYTE v41[8]; // [rsp+78h] [rbp-21h] BYREF
  DXGPUSHLOCK *v42; // [rsp+80h] [rbp-19h]
  int v43; // [rsp+88h] [rbp-11h]
  char v44; // [rsp+90h] [rbp-9h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v37, 2136LL);
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v41, this + 1, 0);
  DXGPUSHLOCK::AcquireShared(v42);
  v43 = 1;
  if ( v5 < 0x18 )
  {
    v12 = WdLogNewEntry5_WdAssertion(v10, v9);
    *(_QWORD *)(v12 + 24) = 12706LL;
  ...
  if ( v36 - 24 <= 0x1FFE7 && v13 < 0x20000 )
  {
    ...
    v17 = _InterlockedIncrement64(&qword_1C00B1560);
...
LABEL_29:
    v15 = (int)((__int64 (__fastcall *)(struct _KTHREAD *, struct DXGKVMB_COMMAND_BASE *, _QWORD, _QWORD, int, char *, unsigned int *, _QWORD))qword_1C00B0FD0)(
                 *this,
                 a2,
                 v36,
                 0LL,
    ...
    McTemplateK0pxq_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, v26, v25, *this, *(_QWORD *)a2, v34);
LABEL_36:
    if ( (int)v15 >= 0 )
    {
      if ( v14 )
