/*
 * XREFs of DpiFdoStartAdapterThreadImpl @ 0x1C016F2E0
 * Callers:
 ...
 *     wcsncmp_0 @ 0x1C0024395 (wcsncmp_0.c)
...
LABEL_4:
  ...
  if ( v10 )
  {
    _InterlockedCompareExchange(&dword_1C00AFD68, 5, 4);
    LOBYTE(v11) = 1;
  ...
  {
    byte_1C00AFA5A = 1;
    DpiAcquirePostDisplayInfoFromBgfx((__int64)&xmmword_1C00AFCC8, 1, 1);
    dword_1C00AFDB4 = 1;
    if ( qword_1C00AFCC0 )
      (*(void (__fastcall **)(_QWORD, __int128 *))(*(_QWORD *)(qword_1C00AFCC0 + 64) + 976LL))(
        *(_QWORD *)(*(_QWORD *)(qword_1C00AFCC0 + 64) + 48LL),
        &xmmword_1C00AFCC8);
    dword_1C00AFD68 = 1;
    goto LABEL_14;
  }
  if ( v10 )
  {
    if ( (unsigned int)(dword_1C00AFD68 - 4) <= 1 )
                    ...
                    && (!v55 || v22) )
                  {
                    if ( !*(_BYTE *)(v21 + 481) || v60 )
                    {
                      ...
                      if ( v26 != 1075708986 )
                      {
                        ...
                        {
                          v27 = (v72 & 1) != 0 || (_BYTE)word_1C00AFA1D && (v72 & 0x40) != 0;
                          v57 |= v27;
...
LABEL_45:
      ...
      while ( *(_QWORD *)v19 != qword_1C00AFA40 );
    }
    v61 = ++v17;
  }
  while ( v17 < 2 );
  if ( v62 && (unsigned int)(dword_1C00AFD68 - 1) <= 1 )
  ...
  if ( v56 )
  {
    ...
    if ( *(_QWORD *)v29 != v29 )
    {
      ...
      while ( *(_QWORD *)v29 != qword_1C00AFA40 );
    }
  }
