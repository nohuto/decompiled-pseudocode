/*
 * XREFs of ?InitializeCompleted@CFlipToken@@IEAAJAEBU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@_NW4TokenState@CTokenBase@@@Z @ 0x1C00064CC
 * Callers:
...
__int64 __fastcall CFlipToken::InitializeCompleted(__int64 a1, __int64 a2, char a3, unsigned int a4)
{
  ...
  *(_DWORD *)(a1 + 24) = 2;
  ...
  {
    v23 = ((__int64 (*)(void))WdLogNewEntry5_WdAssertion)();
    *(_QWORD *)(v23 + 24) = 2219LL;
    WdLogEvent5_WdAssertion(v23);
  }
  v8 = (*(__int64 (__fastcall **)(__int64))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 16LL))(a1 + 80);
  v9 = 6LL;
  if ( v8 < 0 )
  {
    *(_DWORD *)(a1 + 24) = 6;
  ...
  else
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      *(_BYTE *)(a1 + 561) = (*(_DWORD *)(a2 + 44) & 0x8000000) != 0;
      do
      {
  ...
  if ( !DXGGLOBAL::m_pGlobal )
  {
    ...
    *(_QWORD *)(v26 + 24) = 2219LL;
    WdLogEvent5_WdAssertion(v26);
  }
  v17 = *(unsigned __int8 *)(a1 + 556);
  v18 = *(void (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, int, int, BOOL, __int64, __int64, BOOL))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38033) + 120LL);
