/*
 * XREFs of ??1DXGSESSIONDATA@@QEAA@XZ @ 0x1C014F214
 * Callers:
 ...
 *     ?CleanupForSession@DXGVALIDATION@@QEAAXPEAVDXGSESSIONDATA@@@Z @ 0x1C00190A0 (-CleanupForSession@DXGVALIDATION@@QEAAXPEAVDXGSESSIONDATA@@@Z.c)
...
void __fastcall DXGSESSIONDATA::~DXGSESSIONDATA(DXGSESSIONDATA *this, __int64 a2)
{
  ...
  *((_QWORD *)this + 2330) = 0LL;
  ...
  DXGVALIDATION::CleanupForSession((struct DXGGLOBAL *)((char *)Global + 1436), this);
