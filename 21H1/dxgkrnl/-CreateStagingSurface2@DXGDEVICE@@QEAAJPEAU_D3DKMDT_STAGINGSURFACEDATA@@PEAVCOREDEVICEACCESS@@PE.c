/*
 * XREFs of ?CreateStagingSurface2@DXGDEVICE@@QEAAJPEAU_D3DKMDT_STAGINGSURFACEDATA@@PEAVCOREDEVICEACCESS@@PEAI2@Z @ 0x1C024FD04
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  *a4 = 0;
  ...
  if ( (int)result >= 0 )
  {
    AllocationResident = DXGDEVICE::MakeAllocationResident(this, HIDWORD(v16[6]), v14);
    ...
    {
      DXGDEVICE::DestroyStagingSurface(this, HIDWORD(v16[6]), v16[1], a3);
    }
