/*
 * XREFs of MapChildVaSpace @ 0x1C024CE00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    *a8 = 0LL;
    ...
    v32 = (_QWORD *)(v31 + 128);
LABEL_17:
    v25 = ((__int64 (__fastcall *)(_QWORD, __int64, unsigned __int64, _OWORD *, int, int, _OWORD *, _QWORD *))qword_1C00B11C8)(
            *v32,
            a3,
            a4 >> 12,
            v17 + 1,
