/*
 * XREFs of ?PowerRuntimeComponentActiveCallback@DXGADAPTER@@QEAAXKE@Z @ 0x1C0036324
 * Callers:
...
void __fastcall DXGADAPTER::PowerRuntimeComponentActiveCallback(DXGADAPTER *this, unsigned int a2, char a3, __int64 a4)
{
  ...
  v6 = (unsigned int *)(*((_QWORD *)this + 347) + 520LL * a2);
  *((_BYTE *)v6 + 356) = a3;
  if ( *((_DWORD *)this + 50) != 1 )
    return;
  v7 = v6[52];
  ...
  {
    if ( v7 == 3 )
      (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, char))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 335)
                                                                                           + 640LL)
                                                                               + 8LL)
                                                                   + 752LL))(
        *(_QWORD *)(*((_QWORD *)this + 335) + 648LL),
  ...
  {
    LOBYTE(a4) = a3;
    (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 335) + 616LL)
                                                                        + 8LL)
                                                            + 808LL))(
  ...
  *((_QWORD *)this + 406) = KeGetCurrentThread();
  ...
  if ( !a3 )
  {
    ...
    if ( v6[104] )
    {
      ...
      *((_QWORD *)v6 + 49) = v14 + *(_QWORD *)(*((_QWORD *)this + 383) + 8LL);
      v15 = v6 + 100;
      if ( !*((_QWORD *)v6 + 50) )
      {
    ...
    if ( v11 != 2 )
    {
      v12 = v6[1];
      v6[96] = 2;
      DXGADAPTER::SetPowerComponentLatencyCB(this, v12, *(_QWORD *)(*((_QWORD *)this + 383) + 32LL));
      goto LABEL_23;
    }
LABEL_24:
    v27 = 0;
...
LABEL_23:
  if ( v27 )
    goto LABEL_24;
LABEL_25:
  if ( !v6[52] && *((_QWORD *)this + 392) )
  {
    v30 = 0;
    v28 = (char *)this + 3240;
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 405, &v29);
    *((_QWORD *)this + 406) = KeGetCurrentThread();
    v21 = *((_DWORD *)this + 734);
    v30 = 1;
    if ( !a3 )
...
LABEL_35:
    ...
    v22 = (__int64 *)(*((_QWORD *)this + 392) + 400LL);
    v23 = (__int64 *)*v22;
    if ( !*v22 )
    {
LABEL_33:
    ...
    {
      v24 = *(__int64 ***)(*((_QWORD *)this + 392) + 408LL);
      if ( *v24 == v22 )
      {
        *v24 = v23;
        v23[1] = (__int64)v24;
        *(_QWORD *)(*((_QWORD *)this + 392) + 400LL) = 0LL;
        goto LABEL_33;
      }
    }
LABEL_36:
