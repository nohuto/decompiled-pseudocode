/*
 * XREFs of ?_MonitorEventHandler@VIDPN_MGR@@SAJPEAXI0W4MONITOR_EVENT@@_KW4_DMM_VIDPN_MONITOR_TYPE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01663D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?LogMonitorPlugUnplugEvent@DMMVIDEOPRESENTTARGET@@QEAAEKI@Z @ 0x1C005A98C (-LogMonitorPlugUnplugEvent@DMMVIDEOPRESENTTARGET@@QEAAEKI@Z.c)
 ...
 *     _VIDPN_MGR::_MonitorEventHandler_::_2_::_AUTO_PERFTRACK::__AUTO_PERFTRACK @ 0x1C0166604 (_VIDPN_MGR--_MonitorEventHandler_--_2_--_AUTO_PERFTRACK--__AUTO_PERFTRACK.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a7)
{
  ...
  if ( (_DWORD)v11 == 1 )
  {
    ...
    if ( !*(_DWORD *)(v16 + 480) )
      ADAPTER_DISPLAY::RequestAsyncMonitorEventCallout(*(_QWORD *)(a1 + 2672), v10, 1LL, v7, 1, a7, v54, v55, v56, v57);
    goto LABEL_14;
  }
...
LABEL_45:
      ...
      ADAPTER_DISPLAY::RequestAsyncMonitorEventCallout(*(_QWORD *)(a1 + 2672), v10, 10LL, v7, 1, a7, v54, v55, v56, v57);
LABEL_27:
      Global = DXGGLOBAL::GetGlobal(v24, v23);
      QDC_CACHE::InvalidateCache(*((struct DXGFASTMUTEX *const **)Global + 158), 0LL, v26, v27);
      goto LABEL_14;
    }
LABEL_18:
    v22 = v10;
      ...
      && v9 - 1 <= 2 )
    {
      ...
      ADAPTER_DISPLAY::RequestAsyncMonitorEventCallout(*(_QWORD *)(a1 + 2672), v10, v53, v7, 1, a7, v54, v55, v56, v57);
      LOBYTE(v57) = 0;
      if ( v51 )
...
LABEL_11:
  ...
  if ( *(int *)(*(_QWORD *)(*(_QWORD *)(a1 + 2672) + 16LL) + 2572LL) < 1105 && v10 == -1 )
  {
    _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v16 + 80) + 72LL));
    v28 = *(_QWORD **)(v16 + 80);
    v40 = (_QWORD *)v28[3];
    if ( v40 != v28 + 3 )
    {
      ...
      if ( NextTarget )
      {
        ...
        do
        {
          v43 = VIDPN_MGR::PowerOnOffVidPnTarget((VIDPN_MGR *)v16, 0xFFFFFFFF, v11, v7, v42);
          v8 = v43;
          if ( v43 < 0 )
          {
