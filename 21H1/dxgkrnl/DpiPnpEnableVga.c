/*
 * XREFs of DpiPnpEnableVga @ 0x1C0188508
 * Callers:
...
__int64 __fastcall DpiPnpEnableVga(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  QDC_CACHE::InvalidateCache(*((struct DXGFASTMUTEX *const **)Global + 158), 0LL, v9, v10);
  v14 = 0LL;
  v13[0] = 7;
  v15 = v7;
  if ( qword_1C00AFCC0 )
    v14 = *(_QWORD *)(*(_QWORD *)(qword_1C00AFCC0 + 64) + 152LL);
  v22 = 0;
  v21 = 0;
  v20 = 0LL;
  v26 = 0;
