/*
 * XREFs of ?SetVidPnPrimaryTarget@ADAPTER_DISPLAY@@QEAAXII@Z @ 0x1C001A814
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::SetVidPnPrimaryTarget(ADAPTER_DISPLAY *this, unsigned int a2, int a3)
{
  ...
  *(_DWORD *)(v3 + v4 + 1068) = a3;
  if ( a3 == -1 )
  {
    ...
    v8[1] = &v10;
    v10 = v5;
    REMOTEVSYNCMAPPING::RemoveMappingInternal__lambda_9022559c506eea4a40f12462611e4244___((char *)Global + 304552, v8);
  }
}
