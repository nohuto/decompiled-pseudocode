/*
 * XREFs of ?DestroyAllocationInternal@DXGDEVICE@@QEAAXIPEAPEAVDXGALLOCATION@@PEAVDXGRESOURCE@@PEAVCOREDEVICEACCESS@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x1C01207F8
 * Callers:
        ...
        struct _D3DDDICB_DESTROYALLOCATION2FLAGS a6)
{
  ...
  if ( *(_BYTE *)(v15 + 209) )
  {
    ...
    DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendDestroyAllocation(
      (DXG_GUEST_VIRTUALGPU_VMBUS *)(v15 + 4208),
      *((_DWORD *)Current + 106),
      v16,
      v12,
      v8,
