/*
 * XREFs of OutputDuplGetDiagnosticBuffer @ 0x1C0299518
 * Callers:
 ...
 *     ?GetDiagnosticBuffer@OUTPUTDUPL_MGR@@QEAAJPEAU_D3DKMT_OUTPUTDUPL_DIAGNOSTICS@@@Z @ 0x1C0295678 (-GetDiagnosticBuffer@OUTPUTDUPL_MGR@@QEAAJPEAU_D3DKMT_OUTPUTDUPL_DIAGNOSTICS@@@Z.c)
 */
...
__int64 __fastcall OutputDuplGetDiagnosticBuffer(struct DXGADAPTER *a1, struct _D3DKMT_OUTPUTDUPL_DIAGNOSTICS *a2)
{
  ...
  if ( a1 )
  {
    ...
    RemoteOutputDuplMgr = (OUTPUTDUPL_MGR **)v19;
  }
  else
  {
  ...
  else
  {
    ...
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v9, v8, v10, v11) + 24) = 2971LL;
  }
LABEL_9:
