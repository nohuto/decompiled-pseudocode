/*
 * XREFs of ?FindTokenQueue@CTokenManager@@IEAAJPEAVCompositionSurfaceObject@@PEAPEAVCTokenQueue@@@Z @ 0x1C00261F0
 * Callers:
        ...
        struct CTokenQueue **a3)
{
  ...
  v8[1] = 0LL;
  v4 = 0;
  v6 = RtlLookupElementGenericTable((PRTL_GENERIC_TABLE)((char *)this + 192), v8);
  if ( v6 )
