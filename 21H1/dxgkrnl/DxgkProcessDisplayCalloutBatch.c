/*
 * XREFs of DxgkProcessDisplayCalloutBatch @ 0x1C0293800
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
    ...
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v17, (struct DXGGLOBAL *)((char *)v13 + 1584), 0);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v17);
    v14 = (__int64 *)((char *)v13 + 1624);
    v8 = (__int64 *)*((_QWORD *)v13 + 203);
    if ( v8 == v14 )
      break;
  ...
  DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v17, v6);
  v9 = 0;
LABEL_20:
  v15 = DXGGLOBAL::GetGlobal(v7, v6);
  DXGDISPLAYCALLOUTQUEUE::EndProcessingBatch((struct DXGGLOBAL *)((char *)v15 + 1584));
LABEL_21:
