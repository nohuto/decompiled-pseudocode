/*
 * XREFs of BmlPinPathContentScaling @ 0x1C00E21E0
 * Callers:
...
__int64 __fastcall BmlPinPathContentScaling(__int64 a1, __int64 a2, unsigned __int16 a3)
{
  ...
  else
  {
    ...
    {
      if ( (dword_1C00B166C & 1) == 0 )
      {
        v24 = *(VIDPN_MGR **)(a2 + 48);
        dword_1C00B166C |= 1u;
        dword_1C00B1620[0] = VIDPN_MGR::GetAdapterDefaultScaling(v24);
        dword_1C00B1624 = 3;
        dword_1C00B1628 = 4;
        dword_1C00B162C = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v25 >= 4 )
          break;
        v11 = dword_1C00B1620;
        v12 = (unsigned int)dword_1C00B1620[v25];
