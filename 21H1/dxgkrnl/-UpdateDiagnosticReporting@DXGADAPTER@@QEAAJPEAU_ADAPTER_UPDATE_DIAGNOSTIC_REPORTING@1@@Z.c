/*
 * XREFs of ?UpdateDiagnosticReporting@DXGADAPTER@@QEAAJPEAU_ADAPTER_UPDATE_DIAGNOSTIC_REPORTING@1@@Z @ 0x1C020BEC8
 * Callers:
...
__int64 __fastcall DXGADAPTER::UpdateDiagnosticReporting(DXGADAPTER *this, UINT *a2)
{
  ...
  LODWORD(v4) = 0;
  v6 = v3;
  if ( *((_DWORD *)this + v3 + 1086) < *((_DWORD *)this + v3 + 1088) )
  {
    *((_DWORD *)this + v3 + 1088) = 0;
    if ( *((__int64 (__fastcall **)(void *const, const struct _DXGKARG_RELEASESWIZZLINGRANGE *))this + 159) != ADAPTER_RENDER::DefaultDdiReleaseSwizzlingRange )
    {
      ...
      *(_QWORD *)&v22.NoninvasiveTypes.Notifications.0 = 0LL;
      ...
      else
      {
        ...
        {
          *((_DWORD *)this + v6 + 1086) = v22.NoninvasiveTypes.Notifications.Value | v22.InvasiveTypes.Notifications.Value;
          goto LABEL_14;
        }
        v12 = (_QWORD *)WdLogNewEntry5_WdError(v10, v22.NoninvasiveTypes.Notifications.Value);
        v12[3] = v22.DiagnosticCategory.Value;
    ...
    if ( (_DWORD)v3 == 1 && *((int *)this + 576) >= 8960 )
      *((_DWORD *)this + v3 + 1086) = 1;
  }
LABEL_14:
  v15 = a2[1] & *((_DWORD *)this + v6 + 1086);
  if ( *((_DWORD *)this + v6 + 1086) && *((_DWORD *)this + v6 + 1088) != v15 )
  {
    if ( *((__int64 (__fastcall **)(void *const, const struct _DXGKARG_RELEASESWIZZLINGRANGE *))this + 159) == ADAPTER_RENDER::DefaultDdiReleaseSwizzlingRange
