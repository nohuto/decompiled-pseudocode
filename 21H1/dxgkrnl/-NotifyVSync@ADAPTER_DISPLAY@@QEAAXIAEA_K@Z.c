/*
 * XREFs of ?NotifyVSync@ADAPTER_DISPLAY@@QEAAXIAEA_K@Z @ 0x1C0039024
 * Callers:
      ...
      if ( v7 )
      {
        ...
        if ( v9 - v8 > (unsigned __int64)*((unsigned int *)this + 20 * v5 + 200) )
        {
          ...
          else if ( !*((_BYTE *)this + 80 * v5 + 776) )
          {
            ...
            if ( (unsigned int)dword_1C00AEA20 > 5 )
            {
              if ( tlgKeywordOn((__int64)&dword_1C00AEA20, 0x4000LL) )
              {
                v13 = 0;
                v15 = &v13;
                v16 = 2LL;
                tlgWriteTransfer_EtwWriteTransfer(
                  (__int64)&dword_1C00AEA20,
                  (unsigned __int8 *)dword_1C007C412,
                  0LL,
                  0LL,
                  3u,
                  &v14);
