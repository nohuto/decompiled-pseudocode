/*
 * XREFs of ?CheckExclusiveOwnership@DXGGLOBAL@@QEAAEXZ @ 0x1C015C810
 * Callers:
...
__int64 __fastcall DXGGLOBAL::CheckExclusiveOwnership(DXGGLOBAL *this, __int64 a2)
{
  ...
  v34 = (DXGGLOBAL *)((char *)this + 472);
  v35 = 0;
  if ( this == (DXGGLOBAL *)-472LL )
  {
    v28 = WdLogNewEntry5_WdAssertion(-472LL, a2);
    *(_QWORD *)(v28 + 24) = 760LL;
