/*
 * XREFs of ?CompletePStateTransitionCB@DXGADAPTER@@QEAAXII@Z @ 0x1C0035300
 * Callers:
 ...
 *     ?RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z @ 0x1C0045E3C (-RecordPStateChange@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXI@Z.c)
 */
...
void __fastcall DXGADAPTER::CompletePStateTransitionCB(DXGADAPTER *this, unsigned int a2, unsigned int a3)
{
  ...
  if ( *((_QWORD *)this + 348) )
  {
    v5 = *(_QWORD *)(520LL
                   * ((unsigned __int16)a2
                    + (unsigned int)*((unsigned __int16 *)this + ((unsigned __int64)a2 >> 16) + 1396))
                   + *((_QWORD *)this + 347)
                   + 512);
    if ( bTracingEnabled )
    {
