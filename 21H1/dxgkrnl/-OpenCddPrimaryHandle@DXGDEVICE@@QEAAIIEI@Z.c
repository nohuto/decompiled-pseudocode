/*
 * XREFs of ?OpenCddPrimaryHandle@DXGDEVICE@@QEAAIIEI@Z @ 0x1C027C118
 * Callers:
...
LABEL_45:
  ...
  if ( v5 )
  {
    ...
    v63[7] = 1LL;
    LOBYTE(v58) = 0;
    v63[2] = *(_QWORD *)(v50[2] + 2520LL);
    v51 = *((_QWORD *)this + v19 + 79);
    v63[3] = *(_QWORD *)(v50[2] + 2528LL);
