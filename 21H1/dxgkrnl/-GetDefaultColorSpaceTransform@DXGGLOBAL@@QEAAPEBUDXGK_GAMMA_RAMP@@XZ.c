/*
 * XREFs of ?GetDefaultColorSpaceTransform@DXGGLOBAL@@QEAAPEBUDXGK_GAMMA_RAMP@@XZ @ 0x1C0265604
 * Callers:
  ...
  if ( !*((_QWORD *)this + 38054) )
  {
    ...
    *((_QWORD *)this + 38054) = v2;
    if ( v2 )
    {
      ...
      {
        LODWORD(v6) = 0;
        memset(*(void **)(*((_QWORD *)this + 38054) + 32LL), 0, 0xC034uLL);
        v9 = 0;
        **(_DWORD **)(*((_QWORD *)this + 38054) + 32LL) = 1065353216;
        *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 38054) + 32LL) + 20LL) = 1065353216;
        *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 38054) + 32LL) + 40LL) = 1065353216;
        *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 38054) + 32LL) + 48LL) = 1065353216;
        v8 = 0LL;
        do
        {
          v8 += 12LL;
          ...
          *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 38054) + 32LL) + v8 + 40) = v10.m128i_i32[0];
          *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 38054) + 32LL) + v8 + 44) = v10.m128i_i32[0];
          *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 38054) + 32LL) + v8 + 48) = v10.m128i_i32[0];
        }
        while ( v9 < 4096 );
      }
      else
      ...
      if ( (int)v6 < 0 )
      {
        ReferenceCounted::Release(*((ReferenceCounted **)this + 38054), v8);
        *((_QWORD *)this + 38054) = 0LL;
      }
    }
  }
  return (const struct DXGK_GAMMA_RAMP *)*((_QWORD *)this + 38054);
}
