/*
 * XREFs of ?SetDisplayedPrimary@DXGDEVICE@@QEAAXIPEBVDXGALLOCATION@@IE@Z @ 0x1C000CD10
 * Callers:
  ...
  *((_QWORD *)v5 + 1) = 0LL;
  ...
  if ( a3 && a5 )
  {
    ...
    if ( v12 == *((struct _KTHREAD **)this[2] + 2) )
      ADAPTER_DISPLAY::SetAllocationForSinglePlanePresent(*((ADAPTER_DISPLAY **)v12 + 334), v6, a3);
  }
}
