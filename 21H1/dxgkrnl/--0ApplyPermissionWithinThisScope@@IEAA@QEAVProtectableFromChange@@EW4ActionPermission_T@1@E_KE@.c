/*
 * XREFs of ??0ApplyPermissionWithinThisScope@@IEAA@QEAVProtectableFromChange@@EW4ActionPermission_T@1@E_KE@Z @ 0x1C011D4B0
 * Callers:
        ...
        __int64 a6)
{
  ...
  *(_QWORD *)(v8 + 16) = v11;
  if ( v10 )
  {
    ...
    if ( v11 )
    {
      v19 = WdLogNewEntry5_WdAssertion(v11, a2);
    ...
    if ( !*(_BYTE *)(v8 + 9) )
    {
      ...
      {
        v20 = WdLogNewEntry5_WdAssertion(v11, a2);
