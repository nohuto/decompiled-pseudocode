/*
 * XREFs of ?QueryProcessStatistics@@YAJPEAU_D3DKMT_QUERYSTATISTICS@@PEAVDXGADAPTER@@PEAVDXGPROCESS@@@Z @ 0x1C021E0D0
 * Callers:
  ...
  if ( *(_DWORD *)a1 == 1 )
  {
    ...
    if ( v13 >= 0 )
      return (unsigned int)VIDSCH_EXPORT::VidSchQueryProcessStatistics(
                             *(VIDSCH_EXPORT **)(*((_QWORD *)a2 + 335) + 616LL),
                             *(struct _VIDSCH_GLOBAL **)(*((_QWORD *)a2 + 335) + 624LL),
                             a3,
