/*
 * XREFs of ?HeuristicallyPickScaleFactorsForInternalEdidlessBdd@Win81@@YAXUtagSIZE@@IPEAU_DPI_INFORMATION@@@Z @ 0x1C02AB2D8
 * Callers:
        ...
        struct _DPI_INFORMATION *a4)
{
  ...
  do
  {
    ...
    HIDWORD(v10) = v6 / *v5;
    v11 = v10;
    if ( Win81::operator>=(&v11, dword_1C00702E8) )
      break;
    v5 = (_DWORD *)(v9 - 4);
    --v8;
  }
