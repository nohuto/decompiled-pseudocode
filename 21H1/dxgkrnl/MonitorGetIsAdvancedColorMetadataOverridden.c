/*
 * XREFs of MonitorGetIsAdvancedColorMetadataOverridden @ 0x1C02EF39C
 * Callers:
...
__int64 __fastcall MonitorGetIsAdvancedColorMetadataOverridden(struct HDXGMONITOR__ *a1, bool *a2)
{
  __int64 result; // rax
  __int64 v4; // rdx
  __int64 v5; // rcx
