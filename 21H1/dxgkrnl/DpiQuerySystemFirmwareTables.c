/*
 * XREFs of DpiQuerySystemFirmwareTables @ 0x1C0186018
 * Callers:
 *     DpiReadSystemFirmwareTable @ 0x1C0185FA0 (DpiReadSystemFirmwareTable.c)
 *     DpiEnumSystemFirmwareTables @ 0x1C02C37A0 (DpiEnumSystemFirmwareTables.c)
 * Callees:
