/*
 * XREFs of ?_GetMostCapableColorSpaceTransform@DXGMONITOR@@AEAAJAEAW4_D3DDDI_GAMMARAMP_TYPE@@@Z @ 0x1C012AD94
 * Callers:
...
__int64 __fastcall DXGMONITOR::_GetMostCapableColorSpaceTransform(DXGMONITOR *this, enum _D3DDDI_GAMMARAMP_TYPE *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v2 + 8) + 16LL) == -1968LL )
  {
