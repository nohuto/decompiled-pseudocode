/*
 * XREFs of DxgkCheckMonitorPowerState @ 0x1C0145130
 * Callers:
 *     <none>
 * Callees:
...
LABEL_73:
  ...
  if ( !v73 )
  {
    ...
    *(_QWORD *)(v49 + 32) = -1073741811LL;
    ...
    if ( v66 )
      DXGADAPTER::ReleaseReferenceNoTracking(v66);
...
LABEL_30:
  ...
  if ( *((_DWORD *)v24 + 50) == 1 )
  {
    ...
    if ( v30 )
    {
      ...
      {
        v32 = *(unsigned int *)(*((_QWORD *)v73 + 2) + 632LL);
        if ( (int)v32 <= 0 )
        {
