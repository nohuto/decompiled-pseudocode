/*
 * XREFs of ?AddMapping@REMOTEVSYNCMAPPING@@QEAAJPEAUREMOTE_VYSNC_MAPPING@1@@Z @ 0x1C004D4D0
 * Callers:
 ...
 *     REMOTEVSYNCMAPPING::IterateList__lambda_daaf3f6a0c98c285f3d4af1bfc621455___ @ 0x1C004D108 (REMOTEVSYNCMAPPING--IterateList__lambda_daaf3f6a0c98c285f3d4af1bfc621455___.c)
...
__int64 __fastcall REMOTEVSYNCMAPPING::AddMapping(KSPIN_LOCK *this, struct _LUID *a2)
{
  ...
  if ( *((_BYTE *)v7 + 2585) || (v13 = *((_DWORD *)v7 + 50), v7 = v37[0], v13 != 1) || !*((_QWORD *)v37[0] + 334) )
  {
    SourceConnectedToTargetInClientVidPn = -1073741585;
