/*
 * XREFs of ?DisableTransitionalPrimaryAllocations@ADAPTER_DISPLAY@@QEAAXPEAVDXGDEVICE@@PEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C020DC0C
 * Callers:
    ...
    if ( ADAPTER_DISPLAY::GetVidPnSourceOwner((ADAPTER_DISPLAY *)this, v18) == a2 )
    {
             ...
             0LL) )
      {
        ...
        (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 2) + 640LL) + 8LL)
          ...
          *((_QWORD *)a3 + 3),
          v18);
        COREDEVICEACCESS::AcquireSharedUncheck(a4, v27);
      }
    }
