/*
 * XREFs of ?Stop@ADAPTER_DISPLAY@@QEAAXE@Z @ 0x1C0210F28
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::Stop(ADAPTER_DISPLAY *this, struct _LUID *a2)
{
  ...
  if ( !(_BYTE)a2 )
  {
    v3 = *(PERESOURCE ***)(*((_QWORD *)this + 2) + 2680LL);
    if ( !v3 )
      v3 = 0LL;
  ...
  if ( (*((_DWORD *)v8 + 87) & 0x100) != 0 && DXGADAPTER::IsAdapterSessionized(v8, a2, &v17, 0LL) )
  {
    ...
    v12 = DXGSESSIONMGR::CleanCachedIddDisplayConfigRequest(*((DXGSESSIONMGR **)Global + 88), v17);
    v15 = v12;
    if ( v12 < 0 )
    {
