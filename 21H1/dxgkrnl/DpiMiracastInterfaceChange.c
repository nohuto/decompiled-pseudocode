/*
 * XREFs of DpiMiracastInterfaceChange @ 0x1C00517A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiGetDeviceInstanceId @ 0x1C02C38D8 (DpiGetDeviceInstanceId.c)
...
LABEL_48:
          ...
          *(_WORD *)(v15 + 332) = 0;
          ...
          v45 = qword_1C00AFE18;
          v61 = 1;
          while ( (__int64 *)v45 != &qword_1C00AFE18 )
          {
          ...
          if ( v47 < 0 )
            goto LABEL_13;
          KeAcquireInStackQueuedSpinLock(&SpinLock, &LockHandle);
          v48 = (__int64 *)qword_1C00AFE20;
          if ( *(__int64 **)qword_1C00AFE20 != &qword_1C00AFE18 )
            goto LABEL_74;
          *(_QWORD *)v15 = &qword_1C00AFE18;
          *(_QWORD *)(v15 + 8) = v48;
          *v48 = v15;
          qword_1C00AFE20 = v15;
          v60 = 1;
