/*
 * XREFs of ?ReadVirtualFunctionConfig@DXGK_VIRTUAL_GPU_PARAV@@UEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONFIG@@@Z @ 0x1C02319D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGKARG_READVIRTUALFUNCTIONCONFIG *a2)
{
  ...
  ULONG v20; // [rsp+B8h] [rbp-48h] BYREF
  ...
  if ( (unsigned int)Offset < 0xC0 || (Length = a2->Length, Length + (unsigned int)Offset > 0xD0) )
  {
    ...
    for ( i = a2->Data; v12 < a2->Length; ++v12 )
    {
      ...
      if ( v14 < 0x100 )
      {
        if ( v14 >= 4 || (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 1) + 16LL) + 348LL) & 4) != 0 )
        {
        ...
        {
          v20 = 0;
          v4 = DpReadDeviceSpace(v5, 0LL, &i[v12], v14, 1u, &v20);
          if ( v4 < 0 || v20 != 1 )
          {
            v17 = WdLogNewEntry5_WdError(v16, v15);
            *(_QWORD *)(v17 + 24) = a2->VirtualFunctionIndex;
