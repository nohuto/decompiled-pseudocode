/*
 * XREFs of ?SubmitPresentHistoryTokenPreparation@@YAJPEAVDXGADAPTERSTOPRESETLOCKSHARED@@PEAVCOREDEVICEACCESS@@PEAVDXGADAPTER@@PEAU_D3DKMT_PRESENTHISTORYTOKEN@@PEAX_N@Z @ 0x1C01132F0
 * Callers:
      ...
      if ( (_DWORD)v31 == 1 )
      {
        ...
        if ( a4->Model == D3DKMT_PM_REDIRECTED_FLIP && a4->Token.Flip.hSyncObject )
        {
          ...
          if ( !Global )
          {
            ...
            *(_QWORD *)(v73 + 24) = 2405LL;
            WdLogEvent5_WdAssertion(v73);
            Global = (struct DXGGLOBAL *)v80;
          }
          if ( ExIsResourceAcquiredSharedLite(*((PERESOURCE *)Global + 51)) )
          {
            v74 = WdLogNewEntry5_WdAssertion(v43, v42);
            *(_QWORD *)(v74 + 24) = 2410LL;
            WdLogEvent5_WdAssertion(v74);
          }
          if ( v81 )
          {
            v75 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v43, v42);
            v75[5] = &v80;
            v75[3] = 275LL;
            v75[4] = 4LL;
            v75[6] = 0LL;
          ...
          v44 = v80;
          KeEnterCriticalRegion();
          ExAcquireResourceSharedLite(v44[51], 1u);
            ...
            *(_QWORD *)(*(_QWORD *)Object + 112LL) = FenceValue;
            ...
            if ( *((_BYTE *)v8 + 209) )
            {
              v32 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendSetRedirectedFlipFenceValue(
                      (struct DXGADAPTER *)((char *)v8 + 4208),
                      v38,
                      v49,
              ...
              if ( v32 < 0 )
              {
                ...
                if ( v81 )
                  DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)&v80, v76);
                LODWORD(v26) = v32;
                goto LABEL_75;
              }
            }
...
LABEL_75:
      ...
      DxgkCancelSwapChainBinding(a4, v70);
LABEL_76:
      DXGADAPTERSTOPRESETLOCKSHARED::Acquire(this);
      COREDEVICEACCESS::AcquireSharedUncheck(a2, v71);
      return (unsigned int)v26;
    }
    ObfDereferenceObject(v55);
    DXGADAPTERSTOPRESETLOCKSHARED::Acquire(this);
