/*
 * XREFs of ?DestroyContext@DXGCONTEXT@@QEAAXPEAVCOREDEVICEACCESS@@@Z @ 0x1C00DCBC8
 * Callers:
 ...
 *     ?RemoveFromCddPrimarySyncContextListSafe@ADAPTER_RENDER@@QEAAXPEAU_LIST_ENTRY@@@Z @ 0x1C000829C (-RemoveFromCddPrimarySyncContextListSafe@ADAPTER_RENDER@@QEAAXPEAU_LIST_ENTRY@@@Z.c)
    ...
    *((_BYTE *)this + 452) = 1;
    ...
    if ( *(_BYTE *)(v7 + 209) && *((_DWORD *)this + 7) )
    {
      ...
      DXG_VMBUS_CHANNEL_BASE::VmBusSendSyncMessage(
        (DXG_VMBUS_CHANNEL_BASE *)(v7 + 4208),
