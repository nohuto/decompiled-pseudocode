/*
 * XREFs of DxgkLock2 @ 0x1C0101890
 * Callers:
...
__int64 __fastcall DxgkLock2(ULONG64 a1)
{
  ...
  v106 = v104[0];
  if ( *(int *)(v18 + 2304) >= 0x2000 || *(_BYTE *)(v18 + 2604) )
    v19 = *((_DWORD *)DXGGLOBAL::GetGlobal(v16, v15) + 283);
  else
    v19 = 0;
  v107 = v19;
        ...
        if ( (_BYTE)v33 || *((_QWORD *)v100 + 3) )
        {
          ...
          if ( v34 )
          {
            ...
            if ( (v84 & 1) != 0 && (v84 & 2) == 0 )
            {
              ...
              {
                v86 = *(_DWORD *)(v32 + 348);
                if ( (v86 & 0x10) == 0 && (v86 & 8) == 0 && (*(_DWORD *)(v32 + 2036) & 0x80u) == 0 )
                {
          ...
          if ( (_BYTE)v33 )
          {
            v36 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendLock2(
                    (DXG_GUEST_VIRTUALGPU_VMBUS *)(v108 + 4208),
...
LABEL_38:
          ...
          if ( !*((_DWORD *)DXGGLOBAL::GetGlobal((__int64)v40, pData) + 283) )
          {
LABEL_57:
            COREDEVICEACCESS::~COREDEVICEACCESS((COREDEVICEACCESS *)v113);
            if ( v107 )
