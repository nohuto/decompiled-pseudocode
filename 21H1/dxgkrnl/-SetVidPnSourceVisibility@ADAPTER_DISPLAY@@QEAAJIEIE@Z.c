/*
 * XREFs of ?SetVidPnSourceVisibility@ADAPTER_DISPLAY@@QEAAJIEIE@Z @ 0x1C012BF80
 * Callers:
 *     ?ADAPTER_DISPLAY_SetVidPnSourceVisibility@@YAJPEAVADAPTER_DISPLAY@@IEIE@Z @ 0x1C0040320 (-ADAPTER_DISPLAY_SetVidPnSourceVisibility@@YAJPEAVADAPTER_DISPLAY@@IEIE@Z.c)
 ...
 *     ?IsPointerVisible@ADAPTER_DISPLAY@@QEBAEI@Z @ 0x1C001A8C4 (-IsPointerVisible@ADAPTER_DISPLAY@@QEBAEI@Z.c)
        ...
        unsigned __int8 a5)
{
  ...
  else if ( *(_DWORD *)(v11 + 324) == 32902 && *(int *)(v11 + 2304) < 4864 )
  {
    v13 = 0;
  }
  ...
  if ( v14 && v13 )
  {
    ...
    if ( v12 )
    {
      ADAPTER_RENDER::FlushScheduler(*(_QWORD *)(v17 + 2680), 6, v7, 1);
    }
    else
    {
      ADAPTER_RENDER::FlushPresentReferencesAndDisableOverlays(*(ADAPTER_RENDER **)(v17 + 2680), 0, 1 << v7, 0, 1 << v7);
...
LABEL_36:
    ...
    ADAPTER_DISPLAY::MarkCommitVidPnOnModeChange((PERESOURCE **)this, v7, 1);
    v27 = v50;
    goto LABEL_22;
  }
...
LABEL_22:
  ...
  v31 = *(_QWORD *)(*((_QWORD *)this + 2) + 2680LL);
  if ( v31 && v12 )
