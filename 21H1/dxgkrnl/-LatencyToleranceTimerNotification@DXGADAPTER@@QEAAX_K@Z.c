/*
 * XREFs of ?LatencyToleranceTimerNotification@DXGADAPTER@@QEAAX_K@Z @ 0x1C0035A24
 * Callers:
 *     ?DxgkLatencyToleranceTimerNotification@@YAXQEAX_K@Z @ 0x1C0211D90 (-DxgkLatencyToleranceTimerNotification@@YAXQEAX_K@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::LatencyToleranceTimerNotification(KSPIN_LOCK *this, __int64 a2)
{
  ...
  v5 = this + 403;
  this[406] = (KSPIN_LOCK)KeGetCurrentThread();
  v6 = (_QWORD *)this[403];
  v22 = 1;
  while ( v6 != v5 )
  {
...
LABEL_20:
      ...
      else
      {
        ...
        DXGADAPTER::SetPowerComponentLatencyCB(
          (DXGADAPTER *)this,
          *((_DWORD *)v7 - 99),
          *(_QWORD *)(this[383] + 16 * (v10 + 1)));
        *((_DWORD *)v7 - 4) = v12;
        *(v7 - 1) = a2 + *(_QWORD *)(this[383] + 16 * v11 + 8);
        if ( v12 == *((_DWORD *)v7 - 3) )
        {
          v13 = *v7;
          if ( *(_QWORD **)(*v7 + 8LL) != v7 )
  ...
  {
    LOBYTE(v4) = *((_BYTE *)this + 3212);
  }
  (*(void (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(this[335] + 616) + 8LL) + 864LL))(
    *(_QWORD *)(this[335] + 624),
    v4);
  if ( v22 )
  {
