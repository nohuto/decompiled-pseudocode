/*
 * XREFs of ?OpenResourceObject@DXGDEVICE@@QEAAJPEAU_D3DKMT_CREATEALLOCATION@@PEAU_D3DDDI_ALLOCATIONINFO2@@EPEAU_EPROCESS@@PEAU_DXGSHAREDALLOCOBJECT@@PEAVDXGRESOURCEREFERENCE@@PEAEPEBU_D3DKM_CREATESTANDARDALLOCATION@@PEAVDXGAUTOMUTEX@@PEAVDXGAUTOPUSHLOCK@@@Z @ 0x1C00D31F4
 * Callers:
 ...
 *     ??_GDXGRESOURCE@@QEAAPEAXI@Z @ 0x1C000D54C (--_GDXGRESOURCE@@QEAAPEAXI@Z.c)
 ...
 *     ??0DXGRESOURCE@@QEAA@PEAVDXGDEVICE@@@Z @ 0x1C0149E38 (--0DXGRESOURCE@@QEAA@PEAVDXGDEVICE@@@Z.c)
 */
