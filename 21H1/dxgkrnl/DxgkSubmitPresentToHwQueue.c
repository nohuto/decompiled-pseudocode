/*
 * XREFs of DxgkSubmitPresentToHwQueue @ 0x1C026D850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkSubmitPresentToHwQueue(__int64 a1, __int64 a2)
{
  ...
  v4 = (char *)Global + 912;
  ++*((_DWORD *)Global + 233);
  v7 = ExpInterlockedPopEntrySList((PSLIST_HEADER)Global + 57);
  ListEntry = v7;
  if ( !v7 )
  {
    ++*((_DWORD *)v4 + 6);
  ...
  if ( v29 > 0x40 )
  {
    ...
    *(_QWORD *)(v160 + 24) = v184;
    ...
    v166 = (union _SLIST_HEADER *)((char *)v165 + 912);
    ++*((_DWORD *)v165 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v165 + 57) < *((_WORD *)v165 + 464) )
    {
    ...
    || !PagedPoolZeroedArray<_VIDSCH_SYNC_OBJECT *,4>::AllocateElements(&P, v30) )
  {
    ...
    v159 = (union _SLIST_HEADER *)((char *)v158 + 912);
    ++*((_DWORD *)v158 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v158 + 57) < *((_WORD *)v158 + 464) )
    {
...
LABEL_59:
  ...
  if ( *(_BYTE *)(v54 + 457) && *((_DWORD *)&v7[5].Next + 3) )
  {
    ...
    v60 = (union _SLIST_HEADER *)((char *)v59 + 912);
    ++*((_DWORD *)v59 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v59 + 57) < *((_WORD *)v59 + 464) )
    {
...
LABEL_338:
    ...
    v142 = (union _SLIST_HEADER *)((char *)v141 + 912);
    ++*((_DWORD *)v141 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v141 + 57) < *((_WORD *)v141 + 464) )
    {
...
LABEL_135:
  ...
  *((_BYTE *)&v7[94].Next + 8) = 1;
  ...
  if ( (int)v181 < 0 )
  {
    ...
    v108 = (union _SLIST_HEADER *)((char *)v107 + 912);
    ++*((_DWORD *)v107 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v107 + 57) < *((_WORD *)v107 + 464) )
    {
  ...
  if ( (v109 & 0x10000000) != 0 )
  {
    if ( !v100 )
    {
      ...
      *(_QWORD *)(v110 + 24) = 2197LL;
      goto LABEL_221;
    }
    if ( (*((_DWORD *)v100 + 87) & 0x100) == 0 )
    {
      v110 = WdLogNewEntry5_WdError(v109, v101);
      *(_QWORD *)(v110 + 24) = 2203LL;
      goto LABEL_221;
    }
    goto LABEL_251;
  }
...
LABEL_252:
      ...
      v124 = (union _SLIST_HEADER *)((char *)v123 + 912);
      ++*((_DWORD *)v123 + 235);
      if ( ExQueryDepthSList((PSLIST_HEADER)v123 + 57) < *((_WORD *)v123 + 464) )
      {
    ...
    if ( (*(_DWORD *)(&v7[5].Next + 1) & 0x200000) != 0 )
    {
      ...
      v132 = (union _SLIST_HEADER *)((char *)v131 + 912);
      ++*((_DWORD *)v131 + 235);
      if ( ExQueryDepthSList((PSLIST_HEADER)v131 + 57) < *((_WORD *)v131 + 464) )
      {
    ...
    v151 = (union _SLIST_HEADER *)((char *)v150 + 912);
    ++*((_DWORD *)v150 + 235);
    if ( ExQueryDepthSList((PSLIST_HEADER)v150 + 57) < *((_WORD *)v150 + 464) )
    {
...
LABEL_245:
  ...
  v114 = (union _SLIST_HEADER *)((char *)v113 + 912);
  ++*((_DWORD *)v113 + 235);
  if ( ExQueryDepthSList((PSLIST_HEADER)v113 + 57) < *((_WORD *)v113 + 464) )
  {
