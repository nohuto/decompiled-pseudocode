/*
 * XREFs of DxgkSetGammaRamp @ 0x1C0255830
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0DXGK_GAMMA_RAMP@@QEAA@XZ @ 0x1C0010DA8 (--0DXGK_GAMMA_RAMP@@QEAA@XZ.c)
...
LABEL_10:
  ...
  {
    LODWORD(v16) = (*(_DWORD *)(v14 + 2016) & 1) == 0 ? 0xC000000D : 0;
...
LABEL_21:
  ...
  if ( *(_BYTE *)(*(_QWORD *)(v14 + 2672) + 251LL) )
    v20 = COREDEVICEACCESS::AcquireExclusive((__int64)v53, 1LL);
  else
...
LABEL_28:
  ...
  v23 = *(unsigned int *)(*(_QWORD *)(v14 + 2672) + 80LL);
  v24 = *((_DWORD *)v12 + 464);
  if ( (_DWORD)v23 != v24 )
  {
