/*
 * XREFs of ?FindAdapterAndSourceForHash@DXGADAPTERSOURCEHASH@@QEAAJIPEAU_LUID@@PEAI@Z @ 0x1C02650DC
 * Callers:
 ...
 *     ?GetActualBufferSize@AUTOEXPANDALLOCATION@@QEAAIXZ @ 0x1C015A888 (-GetActualBufferSize@AUTOEXPANDALLOCATION@@QEAAIXZ.c)
 */
