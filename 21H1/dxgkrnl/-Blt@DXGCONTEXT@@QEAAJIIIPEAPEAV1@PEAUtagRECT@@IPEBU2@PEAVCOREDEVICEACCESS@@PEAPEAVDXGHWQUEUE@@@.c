/*
 * XREFs of ?Blt@DXGCONTEXT@@QEAAJIIIPEAPEAV1@PEAUtagRECT@@IPEBU2@PEAVCOREDEVICEACCESS@@PEAPEAVDXGHWQUEUE@@@Z @ 0x1C027A034
 * Callers:
...
LABEL_16:
  ...
  if ( v105 )
  {
    ...
    v36 = ADAPTER_RENDER::DdiDescribeAllocation(
            *(ADAPTER_RENDER **)(*(_QWORD *)(*(_QWORD *)(v32 + 16) + 16LL) + 2680LL),
            &v115,
            v33);
    v30 = v36;
    if ( v36 < 0 )
          ...
          if ( v104 )
          {
            ...
            if ( *(_QWORD *)(v54 + 16) == v56 )
            {
              ...
              v57 = ADAPTER_RENDER::DdiDescribeAllocation(
                      *(ADAPTER_RENDER **)(*(_QWORD *)(*(_QWORD *)(v53 + 16) + 16LL) + 2680LL),
                      &v114,
                      v54);
              v30 = v57;
              if ( v57 >= 0 )
...
LABEL_57:
                if ( BYTE1(this[57].Count) )
                {
                  ...
                  v72 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendBlt(
                          (DXG_GUEST_VIRTUALGPU_VMBUS *)(v70 + 4208),
                          Current,
