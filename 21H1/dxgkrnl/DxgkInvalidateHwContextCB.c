/*
 * XREFs of DxgkInvalidateHwContextCB @ 0x1C0041090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkInvalidateHwContextCB(__int64 a1, __int64 a2)
{
  ...
  if ( v9 )
    return (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(DxgAdapter + 2680) + 616LL)
                                                                  + 8LL)
                                                      + 256LL))(
             v9,
             *(unsigned int *)(a1 + 16));
