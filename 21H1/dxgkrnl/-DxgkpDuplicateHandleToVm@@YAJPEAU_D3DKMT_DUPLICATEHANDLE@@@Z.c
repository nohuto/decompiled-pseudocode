/*
 * XREFs of ?DxgkpDuplicateHandleToVm@@YAJPEAU_D3DKMT_DUPLICATEHANDLE@@@Z @ 0x1C0272EBC
 * Callers:
 ...
 *     ??0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z @ 0x1C02337CC (--0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z.c)
...
__int64 __fastcall DxgkpDuplicateHandleToVm(struct _D3DKMT_DUPLICATEHANDLE *a1)
{
  ...
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v42, (struct _KTHREAD **)Global + 36, 0);
  DXGPUSHLOCK::AcquireExclusive(v43);
  v44 = 2;
  v15 = DXGGLOBAL::GetGlobal(v14, v13);
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v45, (struct _KTHREAD **)v15 + 40, 0);
  DXGPUSHLOCK::AcquireExclusive(v46);
  v47 = 2;
  v18 = (_QWORD **)((char *)DXGGLOBAL::GetGlobal(v17, v16) + 1472);
