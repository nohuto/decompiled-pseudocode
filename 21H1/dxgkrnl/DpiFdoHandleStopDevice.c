/*
 * XREFs of DpiFdoHandleStopDevice @ 0x1C02C5CF0
 * Callers:
 ...
 *     DpiFdoCloseDeviceFileObject @ 0x1C02C4278 (DpiFdoCloseDeviceFileObject.c)
  ...
  if ( (unsigned int)(*((_DWORD *)DeviceExtension + 60) - 5) <= 1 )
  {
    ...
    if ( v7 )
    {
      if ( v23 )
      {
        ...
        if ( dword_1C00AFD68 == 2 )
          DpiEnableMsBddFallbackDriver((__int64)v28, v24);
        if ( (struct _DEVICE_OBJECT *)qword_1C00AFCB8 == a1 )
          qword_1C00AFCB8 = 0LL;
