/*
 * XREFs of ?GetNumTargets@DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEA_K@Z @ 0x1C02DEEA0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  if ( (qword_1C00AE9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, (__int64)a3, 6044);
  }
  else
  {
    v18 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 6044LL);
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
