/*
 * XREFs of ?PinPresentPathModalityFromMode@@YAJPEBU_DXGDMM_INTERFACE@@QEAXPEAUD3DKMDT_HVIDPN__@@QEBU_DXGDMM_VIDPN_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@QEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@I_KPEAU_D3DKMT_DISPLAYMODE@@W4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@EEPEAPEAU2@@Z @ 0x1C0258D30
 * Callers:
 ...
 *     ?ConvertD3DddiRotationToDmmRotation@@YA?AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W4_D3DDDI_ROTATION@@@Z @ 0x1C02588CC (-ConvertD3DddiRotationToDmmRotation@@YA-AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W4_D3DDDI_ROTAT.c)
      ...
      if ( v87 )
      {
        ...
        while ( 1 )
        {
          ...
          *((_QWORD *)PathDescriptor + 2) = v42;
          v54 = a12 != (_DWORD)v25 || *((_BYTE *)DXGGLOBAL::GetGlobal(v53, v51) + 304249);
          ...
          if ( a12 == (_DWORD)v25 )
          {
            ...
            *(struct _D3DDDI_RATIONAL *)((char *)PathDescriptor + 52) = v57;
            if ( *((_BYTE *)DXGGLOBAL::GetGlobal(v56, v44) + 304200)
