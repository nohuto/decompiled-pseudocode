/*
 * XREFs of ?CheckMultiPlaneOverlaySupport3@DXGDEVICE@@QEAAJIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@IPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@_NPEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1C024EBD8
 * Callers:
 ...
 *     ?ClearQueryStateForPlaneUnsafe@DISPLAY_SOURCE@@QEAAXI@Z @ 0x1C020CA34 (-ClearQueryStateForPlaneUnsafe@DISPLAY_SOURCE@@QEAAXI@Z.c)
 *     ?InitializeQueryStateUnsafe@DISPLAY_SOURCE@@QEAAXXZ @ 0x1C020F428 (-InitializeQueryStateUnsafe@DISPLAY_SOURCE@@QEAAXXZ.c)
 *     ?SetQueryPlaneStateUnsafe@DISPLAY_SOURCE@@QEAAXIPEBVDXGALLOCATION@@IPEBUtagRECT@@11W4_D3DDDI_ROTATION@@W4D3DKMT_MULTIPLANE_OVERLAY_BLEND@@W4D3DDDI_COLOR_SPACE_TYPE@@I@Z @ 0x1C0210C0C (-SetQueryPlaneStateUnsafe@DISPLAY_SOURCE@@QEAAXIPEBVDXGALLOCATION@@IPEBUtagRECT@@11W4_D3DDDI_ROT.c)
 *     ?SetQueryPostCompositionStateUnsafe@DISPLAY_SOURCE@@QEAAXPEBUtagRECT@@0@Z @ 0x1C0210D18 (-SetQueryPostCompositionStateUnsafe@DISPLAY_SOURCE@@QEAAXPEBUtagRECT@@0@Z.c)
 ...
 *     ?LogCheckMutiplaneOverlaySupport@@YAXJHIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXIPEAPEAU_D3DKMT_MULTIPLANE_OVERLAY_POST_COMPOSITION_WITH_SOURCE@@PEAVADAPTER_RENDER@@@Z @ 0x1C0251350 (-LogCheckMutiplaneOverlaySupport@@YAXJHIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXI.c)
...
LABEL_13:
      ...
      DisplayModeInfo = ADAPTER_DISPLAY::GetDisplayModeInfo(
                          *(ADAPTER_DISPLAY **)(*((_QWORD *)this + 231) + 2672LL),
                          (unsigned int)v9);
      v26 = 0LL;
      if ( !DisplayModeInfo )
        break;
...
LABEL_14:
  ...
  if ( a4 )
  {
    ...
    if ( !*(_QWORD *)(v40 + 928) || (v41 = 1, !*(_BYTE *)(v40 + 2618)) )
      v41 = 0;
    v33 &= v41;
    v42 = 0;
    v43 = v130;
...
LABEL_149:
    ...
    if ( (_DWORD)v69 != ((*(_DWORD *)(v9 + 4) >> 6) & 0xF) )
    {
      ...
      if ( !*(_QWORD *)(v70 + 928) || !*(_BYTE *)(v70 + 2618) )
      {
...
LABEL_150:
    ...
    if ( v85 > 1 )
    {
      ...
      {
        v81 = 0LL;
        if ( (**(_DWORD **)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 2576LL) & 0x20) == 0 )
          v81 = v33;
        v33 = v81;
        v123 = v81;
      }
    ...
    if ( !*(_QWORD *)(v89 + 896) && (!*(_QWORD *)(v89 + 928) || !*(_BYTE *)(v89 + 2618)) )
    {
    ...
    {
      if ( *(int *)(v89 + 2304) < 8960 )
        v33 = 0;
      v123 = v33;
    }
    if ( !*(_QWORD *)(v89 + 928) || !*(_BYTE *)(v89 + 2618) )
    {
      if ( v128 == -1 )
      {
...
LABEL_128:
  DXGAUTOMUTEX::DXGAUTOMUTEX(
    (DXGAUTOMUTEX *)v134,
    (struct DXGFASTMUTEX *const)(*(_QWORD *)(*((_QWORD *)this + 231) + 2672LL) + 520LL),
    0);
  ...
  if ( v33 )
  {
    ...
    if ( v126 )
    {
      ...
      do
      {
        ...
        v102 = *(_QWORD *)(*((_QWORD *)this + 231) + 2672LL);
    ...
    if ( v127 )
    {
      ...
      do
      {
        ...
        v108 = *(_QWORD *)(*((_QWORD *)this + 231) + 2672LL);
    ...
    LODWORD(v11) = CheckMultiPlaneOverlayInternal3(
                     ...
                     *(struct ADAPTER_DISPLAY **)(*((_QWORD *)this + 231) + 2672LL),
                     v129,
                     v135);
    if ( *v119 == (_DWORD)v9 )
    {
