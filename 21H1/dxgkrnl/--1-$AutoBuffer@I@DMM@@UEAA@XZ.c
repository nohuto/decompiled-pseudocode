/*
 * XREFs of ??1?$AutoBuffer@I@DMM@@UEAA@XZ @ 0x1C000FED4
 * Callers:
 *     ??1DMMVIDPNSOURCE@@UEAA@XZ @ 0x1C000FDD4 (--1DMMVIDPNSOURCE@@UEAA@XZ.c)
 *     ??_G?$AutoBuffer@U_D3DDDI_MULTISAMPLINGMETHOD@@@DMM@@UEAAPEAXI@Z @ 0x1C0059820 (--_G-$AutoBuffer@U_D3DDDI_MULTISAMPLINGMETHOD@@@DMM@@UEAAPEAXI@Z.c)
