/*
 * XREFs of ?QueryMitigatedRangeCount@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_QUERYMITIGATEDRANGECOUNT@@@Z @ 0x1C022C3A0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::QueryMitigatedRangeCount(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v10 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, unsigned int *))(*(_QWORD *)VirtualGpuByIndex + 128LL))(
            VirtualGpuByIndex,
            a3);
  }
  else
