/*
 * XREFs of ?InitializeParavirtualizedAdapter@DXGADAPTER@@QEAAJPEAUDRIVER_WORKAROUNDS@@@Z @ 0x1C02098EC
 * Callers:
 ...
 *     ?VmBusSendSetIoSpaceRegion@DXG_GUEST_GLOBAL_VMBUS@@QEAAJ_K0I@Z @ 0x1C02477D0 (-VmBusSendSetIoSpaceRegion@DXG_GUEST_GLOBAL_VMBUS@@QEAAJ_K0I@Z.c)
...
__int64 __fastcall DXGADAPTER::InitializeParavirtualizedAdapter(DXGADAPTER *this, struct DRIVER_WORKAROUNDS *a2)
{
  ...
  *((_BYTE *)this + 209) = 1;
  v3 = (DXGADAPTER *)((char *)this + 4208);
  v5 = 0;
  VmBusChannel = DXG_GUEST_VIRTUALGPU_VMBUS::CreateVmBusChannel((struct VMBCHANNEL__ **)this + 526, this);
  if ( VmBusChannel < 0 )
  {
    v10 = 1;
    goto LABEL_24;
  ...
  *((_DWORD *)this + 1070) = v11;
  ...
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v13, v12) + 380) <= 0x10u )
  {
...
LABEL_11:
  ...
  {
    v20 = (DXG_GUEST_GLOBAL_VMBUS *)*((_QWORD *)DXGGLOBAL::GetGlobal(v7, v6) + 183);
    VmBusChannel = DXG_GUEST_GLOBAL_VMBUS::GetMmioSpaceInfo(v20, &v34, &v33);
    if ( VmBusChannel >= 0 )
    {
      v21 = DXGGLOBAL::GetGlobal(v7, v6);
      VmBusChannel = DXG_GUEST_GLOBAL_VMBUS::VmBusSendSetIoSpaceRegion(v20, v34, v33, *((_DWORD *)v21 + 373));
      if ( VmBusChannel >= 0 )
      {
...
LABEL_29:
  ...
  if ( v10 != 1 && *((_DWORD *)DXGGLOBAL::GetGlobal(v24, v23) + 380) >= 0x1Au )
  {
    v35[1] = 0LL;
