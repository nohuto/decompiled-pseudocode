/*
 * XREFs of ?VmBusCreateProcess@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023A930
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IncrementNumVmProcesses@DXGVIRTUALMACHINE@@QEAAJXZ @ 0x1C0280C90 (-IncrementNumVmProcesses@DXGVIRTUALMACHINE@@QEAAJXZ.c)
...
LABEL_38:
  ...
  else
  {
    ...
    *((_DWORD *)v17 + 135) = v6;
    ...
    v27 = (struct DXGGLOBAL *)((char *)DXGGLOBAL::GetGlobal(v25, v24) + 208);
