/*
 * XREFs of ?DxgkWnfStateChangeCallback@@YAJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@Z @ 0x1C0153D60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _EX_RUNDOWN_REF *a6)
{
  ...
  DXGPUSHLOCK::AcquireShared((struct DXGGLOBAL *)((char *)Global + 1224));
  v13 = 0;
  ...
  ExReleasePushLockSharedEx((char *)v15 + 1224, 0LL);
