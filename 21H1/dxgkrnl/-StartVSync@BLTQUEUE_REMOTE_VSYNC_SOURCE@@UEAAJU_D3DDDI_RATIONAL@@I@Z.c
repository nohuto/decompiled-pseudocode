/*
 * XREFs of ?StartVSync@BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAAJU_D3DDDI_RATIONAL@@I@Z @ 0x1C02FC160
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( !*((_BYTE *)DXGGLOBAL::GetGlobal((__int64)this, *(_QWORD *)&a2) + 304544) )
  {
