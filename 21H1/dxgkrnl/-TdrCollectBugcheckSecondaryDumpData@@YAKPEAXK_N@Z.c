/*
 * XREFs of ?TdrCollectBugcheckSecondaryDumpData@@YAKPEAXK_N@Z @ 0x1C0042F7C
 * Callers:
 *     _DxgDbgBugcheckCallback @ 0x1C0041D00 (_DxgDbgBugcheckCallback.c)
 ...
 *     DpiGetDbgInfoAdapters @ 0x1C004F628 (DpiGetDbgInfoAdapters.c)
 */
