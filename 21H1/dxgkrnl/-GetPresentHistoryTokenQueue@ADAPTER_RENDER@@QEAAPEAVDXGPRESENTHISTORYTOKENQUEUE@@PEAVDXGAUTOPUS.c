/*
 * XREFs of ?GetPresentHistoryTokenQueue@ADAPTER_RENDER@@QEAAPEAVDXGPRESENTHISTORYTOKENQUEUE@@PEAVDXGAUTOPUSHLOCK@@H@Z @ 0x1C00D8504
 * Callers:
 ...
 *     ?Initialize@DXGPRESENTHISTORYTOKENQUEUE@@QEAAJXZ @ 0x1C00D8688 (-Initialize@DXGPRESENTHISTORYTOKENQUEUE@@QEAAJXZ.c)
        ...
        int a3)
{
  ...
  if ( ProcessSessionId >= *((_DWORD *)this + 218)
    || (result = *(struct DXGPRESENTHISTORYTOKENQUEUE **)(*((_QWORD *)this + 110) + 8LL * ProcessSessionId)) == 0LL )
  {
    if ( !a3 )
      return 0LL;
    ...
    *((_DWORD *)a2 + 4) = 2;
    if ( (unsigned int)v8 >= *((_DWORD *)this + 218) )
    {
      ...
      v22 = (const void *)*((_QWORD *)this + 110);
      if ( v22 )
    ...
    v11 = v8;
    if ( *(_QWORD *)(v10 + 8 * v8) )
      return *(struct DXGPRESENTHISTORYTOKENQUEUE **)(v10 + 8 * v11);
    ...
    if ( v15 )
    {
      ...
      {
        *(_QWORD *)(*((_QWORD *)this + 110) + 8 * v11) = v15;
        v10 = *((_QWORD *)this + 110);
        return *(struct DXGPRESENTHISTORYTOKENQUEUE **)(v10 + 8 * v11);
      }
