/*
 * XREFs of DxgkCreateProtectedSession @ 0x1C0284230
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1DXGDEVICEBYHANDLE@@QEAA@XZ @ 0x1C003C8E0 (--1DXGDEVICEBYHANDLE@@QEAA@XZ.c)
...
__int64 __fastcall DxgkCreateProtectedSession(ULONG64 a1)
{
  ...
  __int64 v70; // rcx
  __int64 v71; // r8
  DXGPROTECTEDSESSION *v72; // rcx
  PERESOURCE *Global; // rax
  __int64 v74; // rcx
  __int64 v75; // r8
  char v76[8]; // [rsp+40h] [rbp-188h] BYREF
  int v77; // [rsp+48h] [rbp-180h] BYREF
  __int64 v78; // [rsp+50h] [rbp-178h]
  char v79; // [rsp+58h] [rbp-170h]
  struct DXGSYNCOBJECT *v80; // [rsp+60h] [rbp-168h] BYREF
  DXGPROTECTEDSESSION *v81; // [rsp+68h] [rbp-160h] BYREF
  void *v82; // [rsp+70h] [rbp-158h] BYREF
  void *v83; // [rsp+78h] [rbp-150h] BYREF
  _BYTE v84[16]; // [rsp+80h] [rbp-148h] BYREF
  void *Src[2]; // [rsp+90h] [rbp-138h]
  size_t Size[2]; // [rsp+A0h] [rbp-128h]
  size_t v87; // [rsp+B0h] [rbp-118h] BYREF
  struct _KTHREAD **v88; // [rsp+B8h] [rbp-110h]
  _BYTE v89[16]; // [rsp+C0h] [rbp-108h] BYREF
  struct DXGDEVICE *v90; // [rsp+D0h] [rbp-F8h] BYREF
  ULONG64 v91; // [rsp+D8h] [rbp-F0h]
  ULONG64 v92; // [rsp+E0h] [rbp-E8h]
  _BYTE v93[160]; // [rsp+F0h] [rbp-D8h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v77, 2148LL);
...
LABEL_43:
    DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v77, v13);
    if ( v79 )
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
        McTemplateK0q_EtwWriteTransfer(v34, &EventProfilerExit, v35, v77);
    }
    return 3221225485LL;
  }
  v14 = a1;
...
LABEL_26:
  ...
  if ( LODWORD(Size[0]) )
  {
    v82 = operator new[](LODWORD(Size[0]), 0x4B677844u, PagedPool);
    if ( !v82 )
    {
LABEL_30:
...
LABEL_89:
      v72 = v81;
      if ( v81 )
        DXGPROTECTEDSESSION::DestroyProtectedSession(v81, HIDWORD(v87));
      if ( v22 )
      {
        Global = (PERESOURCE *)DXGGLOBAL::GetGlobal((__int64)v72, v29);
      ...
      if ( v83 )
        operator delete[](v83);
      DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v77, v29);
      if ( v79 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
        McTemplateK0q_EtwWriteTransfer(v74, &EventProfilerExit, v75, v77);
  ...
  {
    v16 = v21;
    v83 = operator new[](v21, 0x4B677844u, PagedPool);
    if ( !v83 )
      goto LABEL_30;
  ...
  v90 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)v76, LODWORD(Src[0]), Current, &v90);
  v32 = v90;
  if ( !v90 )
  {
  ...
  DXGDEVICEACCESSLOCKSHARED::DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)v84, v90);
  COREDEVICEACCESS::COREDEVICEACCESS((__int64)v93, (__int64)v32, 1, v37, 0);
  v28 = COREDEVICEACCESS::AcquireShared((COREDEVICEACCESS *)v93, 0LL);
  if ( v28 < 0 )
  {
LABEL_48:
  ...
  DXGSYNCOBJECTLOCK::DXGSYNCOBJECTLOCK((DXGSYNCOBJECTLOCK *)v89, v42, 0);
  DXGSYNCOBJECTLOCK::AcquireShared((DXGSYNCOBJECTLOCK *)v89, v43);
  DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(Current + 26));
  v44 = HIDWORD(Src[0]);
  v45 = (HIDWORD(Src[0]) >> 6) & 0xFFFFFF;
  v46 = HIDWORD(Src[0]) >> 30;
  if ( (unsigned int)v45 >= *((_DWORD *)v88 + 64) )
    goto LABEL_57;
  v47 = v88[30];
...
LABEL_60:
    ...
    v28 = -1073741811;
    DXGSYNCOBJECTLOCK::~DXGSYNCOBJECTLOCK((DXGSYNCOBJECTLOCK *)v89, v55);
    goto LABEL_48;
  }
  ...
  v80 = *(struct DXGSYNCOBJECT **)(v51 + 32);
  _InterlockedIncrement((volatile signed __int32 *)v80 + 6);
  v22 = v80;
  if ( *((_DWORD *)v80 + 48) != 5 )
  {
    v54 = (_QWORD *)WdLogNewEntry5_WdError(v53, v52);
  ...
  DXGSYNCOBJECTLOCK::~DXGSYNCOBJECTLOCK((DXGSYNCOBJECTLOCK *)v89, v52);
  v28 = ADAPTER_DISPLAY::CreateProtectedSession(*(DXGADAPTER ***)(v40 + 2672), &v80, &v82, Size[0], &v83, v87, &v81);
  if ( v28 < 0 )
  {
    if ( v81 )
    {
  ...
  if ( v83 )
  {
    v61 = WdLogNewEntry5_WdAssertion(v57, v56);
    *(_QWORD *)(v61 + 24) = 311LL;
    WdLogEvent5_WdAssertion(v61);
  }
  v28 = DXGPROTECTEDSESSION::Open(v81, (unsigned int *)&v87 + 1);
  if ( v28 < 0 )
    goto LABEL_48;
  v63 = _InterlockedExchangeAdd((volatile signed __int32 *)v81 + 18, 0xFFFFFFFF);
  v64 = v63 <= 1;
  v65 = (unsigned int)(v63 - 1);
  if ( v64 )
  {
    v66 = WdLogNewEntry5_WdAssertion(v65, v62);
    *(_QWORD *)(v66 + 24) = 328LL;
  ...
  if ( !HIDWORD(v87) )
  {
    v68 = WdLogNewEntry5_WdAssertion(v65, v62);
    *(_QWORD *)(v68 + 24) = 334LL;
  ...
  DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)v76);
  v69 = (_DWORD *)(v91 + 36);
  if ( v91 + 36 >= MmUserProbeAddress )
    v69 = (_DWORD *)MmUserProbeAddress;
  *v69 = v67;
  DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v77, (__int64)v69);
  if ( v79 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q_EtwWriteTransfer(v70, &EventProfilerExit, v71, v77);
  return 0LL;
}
