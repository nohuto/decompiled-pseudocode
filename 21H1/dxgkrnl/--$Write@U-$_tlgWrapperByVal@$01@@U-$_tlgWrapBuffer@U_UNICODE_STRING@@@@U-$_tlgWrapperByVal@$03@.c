        ...
        __int64 a22)
{
  ...
  v35[1] = 0;
  v31 = 2LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00AEA90, a2, 0LL, 0LL, 0x15u, &v29);
}
