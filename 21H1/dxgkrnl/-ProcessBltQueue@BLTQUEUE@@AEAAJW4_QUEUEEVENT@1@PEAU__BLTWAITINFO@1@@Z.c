/*
 * XREFs of ?ProcessBltQueue@BLTQUEUE@@AEAAJW4_QUEUEEVENT@1@PEAU__BLTWAITINFO@1@@Z @ 0x1C014AE4C
 * Callers:
 ...
 *     ?FinishCommand@BLTQUEUE@@AEAAXJ@Z @ 0x1C014B004 (-FinishCommand@BLTQUEUE@@AEAAXJ@Z.c)
 *     ?AssignNull@DXGALLOCATIONREFERENCE@@QEAAXXZ @ 0x1C02235E0 (-AssignNull@DXGALLOCATIONREFERENCE@@QEAAXXZ.c)
 ...
 *     ?ReleasePresentDoneEvent@BLTENTRY@@QEAAXE@Z @ 0x1C02FA920 (-ReleasePresentDoneEvent@BLTENTRY@@QEAAXE@Z.c)
