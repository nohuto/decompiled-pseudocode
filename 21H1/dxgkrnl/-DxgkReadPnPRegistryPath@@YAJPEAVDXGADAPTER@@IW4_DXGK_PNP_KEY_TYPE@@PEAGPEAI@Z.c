/*
 * XREFs of ?DxgkReadPnPRegistryPath@@YAJPEAVDXGADAPTER@@IW4_DXGK_PNP_KEY_TYPE@@PEAGPEAI@Z @ 0x1C021D568
 * Callers:
...
__int64 __fastcall DxgkReadPnPRegistryPath(__int64 a1, unsigned int a2, __int64 a3, void *a4, ULONG64 a5)
{
  ...
  v13 = *v12;
  v14 = *(_QWORD *)(360LL * a2 + *(_QWORD *)(a1 + 2560) + 8);
  v25 = 0LL;
