/*
 * XREFs of ?TokenThread@CTokenManager@@UEAAJPEAXPEAUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x1C00054D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z @ 0x1C00071B8 (-ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z.c)
        ...
        unsigned int a4)
{
  ...
  if ( v7 >= 0 )
  {
    ...
    v7 = (*(__int64 (__fastcall **)(HANDLE *))(*((_QWORD *)Global + 38033) + 176LL))(&Handle);
    if ( v7 >= 0 )
