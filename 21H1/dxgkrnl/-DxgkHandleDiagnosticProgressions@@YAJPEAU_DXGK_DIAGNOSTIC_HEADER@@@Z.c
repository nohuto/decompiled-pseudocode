/*
 * XREFs of ?DxgkHandleDiagnosticProgressions@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C004AF60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( (unsigned int)dword_1C00AEAC8 > 4 && tlgKeywordOn((__int64)&dword_1C00AEAC8, 1LL) )
  {
    if ( (v7 & 2) != 0 )
    {
      ...
      if ( (unsigned int)dword_1C00AEAC8 <= 4 || !tlgKeywordOn((__int64)&dword_1C00AEAC8, 1LL) )
        return 0LL;
      v11 = (unsigned __int8 *)&unk_1C007D51D;
      v12 = *(_BYTE *)&a1[1].Category.0 & 1;
      goto LABEL_18;
    }
    if ( tlgKeywordOn((__int64)&dword_1C00AEAC8, v6) )
    {
      LOBYTE(v10) = v10 & 1;
      v11 = (unsigned __int8 *)&unk_1C007D4D1;
      v12 = v10;
LABEL_18:
