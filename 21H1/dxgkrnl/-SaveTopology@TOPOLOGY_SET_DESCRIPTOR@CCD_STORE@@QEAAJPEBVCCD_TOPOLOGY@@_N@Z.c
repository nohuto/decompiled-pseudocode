/*
 * XREFs of ?SaveTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEBVCCD_TOPOLOGY@@_N@Z @ 0x1C013C52C
 * Callers:
 *     _anonymous_namespace_::_SaveTopologySetCallback @ 0x1C013CB40 (_anonymous_namespace_--_SaveTopologySetCallback.c)
 * Callees:
 ...
 *     ?MapModalitySetIdPath@CCD_TOPOLOGY@@QEBAJIPEAG@Z @ 0x1C013CA4C (-MapModalitySetIdPath@CCD_TOPOLOGY@@QEBAJIPEAG@Z.c)
