/*
 * XREFs of DxgkPresentMultiPlaneOverlay3 @ 0x1C02A3B60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1?$PagedPoolZeroedArray@PEAVDXGCONTEXT@@$03@@QEAA@XZ @ 0x1C020C368 (--1-$PagedPoolZeroedArray@PEAVDXGCONTEXT@@$03@@QEAA@XZ.c)
    ...
    if ( v91 >= 0 )
    {
      ...
      if ( v79 )
      {
        if ( *((_BYTE *)Current + 346)
          || ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(v79 + 2672), v78, v99.VidPnSourceId) )
        {
