/*
 * XREFs of DxgkDestroyProtectedSession @ 0x1C0284C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkDestroyProtectedSession(unsigned int *a1)
{
  ...
  __int64 v19; // rdx
  __int64 v20; // rax
  struct DXGPROTECTEDSESSION *v21; // rdi
  __int64 v22; // rdx
  __int64 v23; // rcx
  __int64 v24; // r8
  __int64 v25; // rax
...
LABEL_17:
  ...
  v21 = *(struct DXGPROTECTEDSESSION **)(v17 + 16LL * (unsigned int)v16);
LABEL_18:
  ...
  if ( !v21 )
  {
    ...
    *(_QWORD *)(v25 + 32) = -1073741811LL;
    ...
    DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v34, v26);
    goto LABEL_20;
  }
  DXGPROTECTEDSESSION::DestroyProtectedSession(v21, v13);
  DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)v34, v30);
