/*
 * XREFs of ?DiscardAllCompositionFrames@CCompositionFrameCollection@@UEAAXXZ @ 0x1C0007300
 * Callers:
 *     ??_GCCompositionFrameCollection@@IEAAPEAXI@Z @ 0x1C0007BB0 (--_GCCompositionFrameCollection@@IEAAPEAXI@Z.c)
 * Callees:
