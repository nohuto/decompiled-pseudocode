/*
 * XREFs of DpiPdoDispatchIoctl @ 0x1C00DF740
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiPdoDispatchIoctl(__int64 a1, IRP *a2)
{
  ...
  struct DXGMONITOR *v25; // [rsp+90h] [rbp+18h] BYREF
    ...
    if ( MonitorInstance >= 0 )
    {
      ...
      if ( v12 )
      {
        ...
        if ( (_DWORD)v13 != -1 )
        {
          ...
          {
            v25 = 0LL;
            MonitorInstance = MONITOR_MGR::_GetMonitorInstance(v17, v13, 1u, &v25);
            if ( MonitorInstance < 0 )
            {
            ...
            {
              MonitorInstance = DXGMONITOR::_DispatchIoctrls(v25, LowPart, Options, MasterIrp, Length, MasterIrp, &v24);
            }
            goto LABEL_14;
          }
