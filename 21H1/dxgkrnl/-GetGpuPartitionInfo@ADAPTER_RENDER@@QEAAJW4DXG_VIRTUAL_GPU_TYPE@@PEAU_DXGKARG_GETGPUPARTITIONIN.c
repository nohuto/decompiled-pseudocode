/*
 * XREFs of ?GetGpuPartitionInfo@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETGPUPARTITIONINFO@@@Z @ 0x1C022BB80
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( a2 == 1 )
  {
          ...
          (int)v6 >= 0) )
    {
      ...
      *pGpuPartitionOptions = *(_WORD *)(*((_QWORD *)a1 + 2) + 4320LL);
    }
  }
  else
  {
