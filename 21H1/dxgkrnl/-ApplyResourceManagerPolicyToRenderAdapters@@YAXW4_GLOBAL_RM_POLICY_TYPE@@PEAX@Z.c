/*
 * XREFs of ?ApplyResourceManagerPolicyToRenderAdapters@@YAXW4_GLOBAL_RM_POLICY_TYPE@@PEAX@Z @ 0x1C027FB68
 * Callers:
...
void __fastcall ApplyResourceManagerPolicyToRenderAdapters(__int64 a1, __int64 a2)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v15, (struct DXGGLOBAL *)((char *)Global + 472), 0);
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v15);
  v9 = (_QWORD **)((char *)DXGGLOBAL::GetGlobal(v6, v5) + 552);
  v10 = *v9;
  while ( v10 != v9 && v10 )
  {
    v11 = v10;
    v10 = (_QWORD *)*v10;
    if ( v11[335] && (*((_DWORD *)v11 + 87) & 0x4000) == 0 )
    {
      v17 = v11;
      v18 = 0;
  ...
  if ( v3 )
  {
    if ( v3 == 1 )
    {
      *((_DWORD *)v13 + 76045) = *(_DWORD *)(a2 + 8);
      *((_DWORD *)v13 + 76046) = *(_DWORD *)(a2 + 12);
    }
  }
  else
  {
    *((_DWORD *)v13 + 76044) = *(_DWORD *)(a2 + 12);
    v14 = (*((_DWORD *)v13 + 76047) ^ *(_DWORD *)(a2 + 8)) & 1;
    *((_DWORD *)v13 + 76047) ^= v14;
  }
  if ( v15[8] )
