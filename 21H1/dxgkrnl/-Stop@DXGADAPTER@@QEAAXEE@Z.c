/*
 * XREFs of ?Stop@DXGADAPTER@@QEAAXEE@Z @ 0x1C020B838
 * Callers:
...
void __fastcall DXGADAPTER::Stop(DXGADAPTER *this, __int64 a2, unsigned __int8 a3)
{
  ...
  *(_QWORD *)(v7 + 24) = this;
  ...
  if ( (unsigned int)dword_1C00AEA90 > 5 && tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000000800LL) )
  {
    v34 = v53;
    v33 = v3;
    v36 = (v53 >> 1) & 1;
    v35 = v9;
    v38 = (v53 >> 2) & 1;
    v39 = *((unsigned __int8 *)this + 2516);
    v40 = *((unsigned __int8 *)this + 2511);
    v52 = *((_WORD *)this + 1286);
    v46 = *((_QWORD *)this + 197);
    v47 = (void *)*((_QWORD *)this + 196);
    v48 = v51;
    v41 = *((_DWORD *)this + 84);
    v42 = *((_DWORD *)this + 83);
    v43 = *((_DWORD *)this + 82);
    v44 = *((_DWORD *)this + 81);
    v49 = (unsigned __int16 *)*((_QWORD *)this + 187);
    v37 = v53 & 1;
    LOWORD(v51) = 1;
  ...
  *((_DWORD *)this + 50) = 5;
  if ( !*((_BYTE *)this + 209) )
  {
    ...
    if ( v13 )
    {
      ...
      {
        *(_BYTE *)(v13 + 889) = 1;
        ADAPTER_RENDER::ResumeVidMmWorkerThread(*((PERESOURCE ***)this + 335), 1, 1);
      }
    }
  }
  v50[0] = 0LL;
  ...
  if ( !*((_BYTE *)this + 209) )
  {
    ...
    if ( v15 )
    {
      ...
      ADAPTER_RENDER::SuspendVidMmWorkerThread(*((_QWORD *)this + 335), 1u, 0);
      ADAPTER_RENDER::ResumeVidMmWorkerThread(*((PERESOURCE ***)this + 335), 0, 1);
    }
    if ( *((_BYTE *)this + 206) )
    {
  ...
  v19 = (ADAPTER_DISPLAY *)*((_QWORD *)this + 334);
  if ( v19 )
    ADAPTER_DISPLAY::Stop(v19, a3);
  v20 = (ADAPTER_RENDER *)*((_QWORD *)this + 335);
  if ( v20 )
  {
    v4 = 1;
  ...
  {
    *((_BYTE *)this + 3214) = 1;
    v21 = KeCancelTimer((PKTIMER)this + 52);
    v22 = KeCancelTimer((PKTIMER)((char *)this + 4040));
    if ( !v21 || !v22 )
      KeFlushQueuedDpcs();
    if ( !KeCancelTimer((PKTIMER)this + 52) )
      KeFlushQueuedDpcs();
    PoUnregisterPowerSettingCallback(*((PVOID *)this + 407));
    *((_QWORD *)this + 407) = 0LL;
  }
  if ( a3 )
  {
  ...
  *((_QWORD *)this + 18) = 0LL;
  ...
  REMOTEMONITORMAPPING::Clear((struct DXGGLOBAL *)((char *)v26 + 304496), &v45);
  v29 = DXGGLOBAL::GetGlobal(v28, v27);
  REMOTEVSYNCMAPPING::RemoveMapping((struct DXGGLOBAL *)((char *)v29 + 304552), &v45);
