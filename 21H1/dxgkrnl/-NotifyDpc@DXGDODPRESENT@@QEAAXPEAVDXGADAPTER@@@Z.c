/*
 * XREFs of ?NotifyDpc@DXGDODPRESENT@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C005D048
 * Callers:
...
void __fastcall DXGDODPRESENT::NotifyDpc(DXGDODPRESENT *this, struct DXGADAPTER *a2)
{
        ...
        v2 = (unsigned int)(v2 + 1) )
  {
    if ( _InterlockedExchange((volatile __int32 *)this + v2 + 4, 0) )
    {
      ...
      ADAPTER_DISPLAY::SignalVerticalBlankEvent(*((ADAPTER_DISPLAY **)a2 + 334), a2, v2, updated);
      Global = DXGGLOBAL::GetGlobal(v9, v8);
      REMOTEVSYNCMAPPING::TriggerRemoteVsync((KSPIN_LOCK *)Global + 38069, *(struct _LUID *)((char *)a2 + 316), v6);
    }
    if ( (i & 3) != 0 )
    {
