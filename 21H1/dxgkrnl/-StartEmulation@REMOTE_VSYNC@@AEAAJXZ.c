/*
 * XREFs of ?StartEmulation@REMOTE_VSYNC@@AEAAJXZ @ 0x1C00D6C94
 * Callers:
 ...
 *     ?UpdateDisplayModeInfo@BLTQUEUE@@QEAAXU_D3DDDI_RATIONAL@@I@Z @ 0x1C00D6D68 (-UpdateDisplayModeInfo@BLTQUEUE@@QEAAXU_D3DDDI_RATIONAL@@I@Z.c)
  ...
  *((_QWORD *)this + 1) = v2;
  if ( v2 )
  {
    ...
    else
    {
      ...
      {
        v13 = *((_DWORD *)DXGGLOBAL::GetGlobal(v12, v11) + 76110);
        if ( v13 )
          v14 = 0x3E8u / (v13 + 1);
        else
          v14 = 0;
