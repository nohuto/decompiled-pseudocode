/*
 * XREFs of ?DdiDestroyVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYVIRTUALGPU@@@Z @ 0x1C022E090
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyVirtualGpu(
        ADAPTER_RENDER *this,
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C00AE9B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5102);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5102LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_DESTROYVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 968LL)
                                                                           + 88LL))(
  ...
  if ( (_DWORD)v12 )
  {
    v19 = WdLogNewEntry5_WdError(v14, v11);
    v20 = v12;
    *(_QWORD *)(v19 + 24) = v12;
