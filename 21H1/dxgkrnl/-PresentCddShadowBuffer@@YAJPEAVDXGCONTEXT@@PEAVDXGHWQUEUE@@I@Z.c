/*
 * XREFs of ?PresentCddShadowBuffer@@YAJPEAVDXGCONTEXT@@PEAVDXGHWQUEUE@@I@Z @ 0x1C0180664
 * Callers:
...
__int64 __fastcall PresentCddShadowBuffer(struct DXGCONTEXT *a1, struct DXGHWQUEUE *a2, unsigned int a3)
{
  ...
  v72 = a2;
  v69 = a1;
  LODWORD(v70) = *((_DWORD *)DXGGLOBAL::GetGlobal((__int64)a1, (__int64)a2) + 318);
  if ( (_DWORD)v70 )
  {
    v4 = *((_QWORD *)v69 + 2);
    v5 = *(_QWORD *)(v4 + 1848);
...
LABEL_27:
    ...
    {
      ADAPTER_DISPLAY::GetCddAllocationHandles(*(DXGADAPTER ***)(v5 + 2672), (unsigned int)v3, &v68, &v66);
      if ( v68 && v66 )
      {
LABEL_6:
        CddShadowPitch = ADAPTER_DISPLAY::GetCddShadowPitch(*(ADAPTER_DISPLAY **)(v5 + 2672), (unsigned int)v3);
        v14 = *(DXGADAPTER ***)(v5 + 2672);
        v67 = CddShadowPitch;
        ...
        else
        {
          if ( v76.pData )
          {
            ...
            v70 = (unsigned __int8 *)*((_QWORD *)DXGGLOBAL::GetGlobal(4LL, v20) + 160);
            if ( !v70 )
              goto LABEL_23;
            v82 = 0LL;
            Global = DXGGLOBAL::GetGlobal(v23, v22);
            v25 = (int *)((char *)Global + 1288);
            if ( !GetShadowBufferDirtyRect(&v82, *((unsigned int *)Global + 322), *((_DWORD *)Global + 323)) )
              goto LABEL_23;
            v26 = v25[3];
            if ( v26 == 20 )
            {
                ...
                *(_QWORD *)&v82.right = &v66;
                ...
                if ( DXGADAPTER::UsingSetTimingsFromVidPn((DXGADAPTER *)v5) )
                {
                  if ( !(unsigned int)ADAPTER_DISPLAY::GetVidPnSourceOwnerType(
                                        *(ADAPTER_DISPLAY **)(v5 + 2672),
                                        (unsigned int)v3) )
                  {
                    if ( ADAPTER_DISPLAY::IsVidPnSourceActive(*(ADAPTER_DISPLAY **)(v5 + 2672), (unsigned int)v3) )
                    {
                      if ( !ADAPTER_DISPLAY::IsVidPnSourceVisible(*(ADAPTER_DISPLAY **)(v5 + 2672), (unsigned int)v3) )
                      {
