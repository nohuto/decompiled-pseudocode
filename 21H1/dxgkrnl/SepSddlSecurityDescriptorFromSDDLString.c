/*
 * XREFs of SepSddlSecurityDescriptorFromSDDLString @ 0x1C02C0150
 * Callers:
 *     SeSddlSecurityDescriptorFromSDDL @ 0x1C02BF8A4 (SeSddlSecurityDescriptorFromSDDL.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0026570 (_guard_dispatch_icall_nop.c)
 *     SepSddlDaclFromSDDLString @ 0x1C02BFA68 (SepSddlDaclFromSDDLString.c)
 */
