/*
 * XREFs of ??$AcquireDdiEnumeratorCachedPathInfo@V?$const_mem_fun_t@PEAVDMMVIDPNPRESENTPATH@@VDMMVIDPNTOPOLOGY@@@KM_STL@@@DMMVIDPNTOPOLOGY@@QEAAJV?$const_mem_fun_t@PEAVDMMVIDPNPRESENTPATH@@VDMMVIDPNTOPOLOGY@@@KM_STL@@PEAPEBU_D3DKMDT_VIDPN_PRESENT_PATH@@H@Z @ 0x1C00EDC90
 * Callers:
      ...
      if ( v17 )
      {
        ...
        *((_DWORD *)v17 + 7) = *(_DWORD *)(v9 + 112);
        ...
        if ( (unsigned int)(v19 - 254) > 1
          && v19
          && DMMVIDPNPRESENTPATH::IsPathSupportVirtualMode((DMMVIDPNPRESENTPATH *)v9) )
        {
          v20 = 1;
        }
        else
