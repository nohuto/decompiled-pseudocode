/*
 * XREFs of ?AdapterTelemetry@DXGADAPTER@@QEAAXW4_TELEMETRY_INVENTORY_TRIGGER@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C017027C
 * Callers:
 ...
 *     ?IsIndirectDisplayDevice@DXGADAPTER@@QEBAEXZ @ 0x1C000D518 (-IsIndirectDisplayDevice@DXGADAPTER@@QEBAEXZ.c)
 *     DxgkMiracastQueryMiracastSupportNoLock @ 0x1C0021F1C (DxgkMiracastQueryMiracastSupportNoLock.c)
...
void __fastcall DXGADAPTER::AdapterTelemetry(__int64 a1, int a2, __int64 a3)
{
  ...
  v117 = a3;
  v52 = a2;
  if ( !v3 || (v6 = *(_DWORD *)(a1 + 2544) >> 1, v48 = 0, (v6 & 1) != 0) )
    v48 = 1;
  v121 = 0;
  v120 = 0LL;
  ...
  if ( *(_QWORD *)(a1 + 2680) || *(_QWORD *)(a1 + 2672) )
  {
    v7 = *(_QWORD *)(a1 + 2672);
    v97 = 0LL;
    v96 = 0LL;
    ...
    *(_OWORD *)P = 0LL;
    ...
    if ( (unsigned int)dword_1C00AEA58 > 5 && tlgKeywordOn((__int64)&dword_1C00AEA58, 0x800000000004LL) )
    {
      v24 = *(_DWORD *)(a1 + 348);
      v51 = *(_DWORD *)(a1 + 1848);
      v34 = *(_WORD *)(a1 + 1432);
      ...
      v57 = v32 > 1;
      v58 = v61 != 0;
      v59 = *(unsigned __int8 *)(a1 + 2516);
      v60 = *(unsigned __int8 *)(a1 + 2511);
      v27 = (v24 >> 6) & 1;
      LODWORD(v61) = BYTE8(v120) == 0;
      v38 = *(_WORD *)(a1 + 340);
      v33 = v21 && tlgKeywordOn((__int64)&dword_1C00AEA58, 0x200000000000LL);
      if ( !v21 || !tlgKeywordOn((__int64)&dword_1C00AEA58, 0x400000000000LL) )
        v5 = 0;
