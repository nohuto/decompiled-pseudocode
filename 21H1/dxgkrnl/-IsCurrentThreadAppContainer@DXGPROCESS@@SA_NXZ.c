/*
 * XREFs of ?IsCurrentThreadAppContainer@DXGPROCESS@@SA_NXZ @ 0x1C0281058
 * Callers:
 ...
 * Callees:
 *     ?OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z @ 0x1C028114C (-OpenCurrentThreadToken@DXGPROCESS@@SAJPEAPEAX@Z.c)
 */
