/*
 * XREFs of ??_EBLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAAPEAXI@Z @ 0x1C005DA10
 * Callers:
 *     <none>
 * Callees:
 *     ??1BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAA@XZ @ 0x1C02FBFC4 (--1BLTQUEUE_REMOTE_VSYNC_SOURCE@@UEAA@XZ.c)
 */
