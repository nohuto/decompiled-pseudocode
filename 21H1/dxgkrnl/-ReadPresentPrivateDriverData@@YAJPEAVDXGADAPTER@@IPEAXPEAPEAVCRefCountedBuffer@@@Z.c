/*
 * XREFs of ?ReadPresentPrivateDriverData@@YAJPEAVDXGADAPTER@@IPEAXPEAPEAVCRefCountedBuffer@@@Z @ 0x1C0146940
 * Callers:
        ...
        struct CRefCountedBuffer **a4)
{
  ...
  v6 = (unsigned int)a2;
  *a4 = 0LL;
  if ( *((int *)a1 + 576) < 0x2000 && !*((_BYTE *)a1 + 2604) || *((_DWORD *)a1 + 462) < 0x5007u || !(_DWORD)a2 )
    return 0LL;
