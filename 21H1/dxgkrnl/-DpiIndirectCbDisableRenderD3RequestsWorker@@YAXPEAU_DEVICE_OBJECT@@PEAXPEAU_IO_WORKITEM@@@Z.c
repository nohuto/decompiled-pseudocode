/*
 * XREFs of ?DpiIndirectCbDisableRenderD3RequestsWorker@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C02CFE20
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x1C000BEAC (--3@YAXPEAX@Z.c)
 *     ?Release@AUTO_PNPPOWER_LOCK@@QEAAXXZ @ 0x1C001E2C0 (-Release@AUTO_PNPPOWER_LOCK@@QEAAXXZ.c)
 *     ?Release@AUTO_REMOVE_LOCK@@QEAAXXZ @ 0x1C001E318 (-Release@AUTO_REMOVE_LOCK@@QEAAXXZ.c)
...
void __fastcall DpiIndirectCbDisableRenderD3RequestsWorker(PVOID IoObject, PVOID Context, PIO_WORKITEM IoWorkItem)
{
  ...
  while ( 1 )
  {
    KeWaitForSingleObject(&stru_1C00AFF98, Executive, 0, 0, 0LL);
    v4 = (char *)qword_1C00AFFD0;
    if ( qword_1C00AFFD0 == &qword_1C00AFFD0 )
      break;
    if ( *((void ***)qword_1C00AFFD0 + 1) != &qword_1C00AFFD0
      || (v5 = *(_QWORD *)qword_1C00AFFD0, *(void **)(*(_QWORD *)qword_1C00AFFD0 + 8LL) != qword_1C00AFFD0) )
    {
      __fastfail(3u);
    }
    qword_1C00AFFD0 = *(void **)qword_1C00AFFD0;
    *(_QWORD *)(v5 + 8) = &qword_1C00AFFD0;
    KeReleaseMutex(&stru_1C00AFF98, 0);
    v6 = *(_QWORD *)(v4 + 20);
    v17 = 0LL;
    v13 = 0LL;
    v14 = 0;
