/*
 * XREFs of ?ReportState@DXGADAPTER@@QEAAXXZ @ 0x1C020ABEC
 * Callers:
...
void __fastcall DXGADAPTER::ReportState(DXGADAPTER *this)
{
  ...
  if ( bTracingEnabled && *((_DWORD *)this + 730) )
  {
    v40 = 0LL;
  ...
  v27 = (ADAPTER_DISPLAY *)*((_QWORD *)this + 334);
  if ( v27 )
    ADAPTER_DISPLAY::ReportState(v27);
  v28 = (ADAPTER_RENDER *)*((_QWORD *)this + 335);
  if ( v28 )
