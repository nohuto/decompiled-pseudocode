/*
 * XREFs of ?DxgkPresentVirtualFrameBuffer@@YAJIIIPEBU_D3DKMT_DISPLAYMODE@@@Z @ 0x1C0180450
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMT_DISPLAYMODE *a4)
{
  ...
  if ( v36[0] )
  {
    ...
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v38, (struct DXGGLOBAL *)((char *)Global + 1392), 0);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v38);
    v17 = *((_QWORD *)DXGGLOBAL::GetGlobal(v16, v15) + 160);
    v20 = DXGGLOBAL::GetGlobal(v19, v18);
    if ( v17 || *((_DWORD *)v20 + 318) != 1 )
    {
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v22, v21) + 345) != 4 )
      {
        v23 = (__int64)v11[2];
        v24 = *(_QWORD *)(v23 + 1848);
        if ( v24 == *(_QWORD *)(*(_QWORD *)(v23 + 16) + 16LL) )
        {
          ...
          {
            LOBYTE(v29) = 1;
            (*(void (__fastcall **)(_QWORD, __int64, __int64, __int64))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v24 + 2680)
                                                                                              + 616LL)
                                                                                  + 8LL)
                                                                      + 560LL))(
              *(_QWORD *)(v23 + 768),
