/*
 * XREFs of ?_OnMonitorDeviceNodeReady@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0169560
 * Callers:
 ...
 *     ?_UpdatePnPDeviceProperties@DXGMONITOR@@AEAAJXZ @ 0x1C0169600 (-_UpdatePnPDeviceProperties@DXGMONITOR@@AEAAJXZ.c)
  ...
  *(_QWORD *)(WdLogNewEntry5_WdTrace(this, a2, a3, a4) + 24) = this;
  ...
  if ( (v8 & 0x10) == 0 )
  {
    ...
    *((_DWORD *)this + 10) |= 0x10u;
    ...
    if ( *((_BYTE *)this + 480) )
    {
      v15 = (struct _FAST_MUTEX *)*((_QWORD *)this + 4);
      if ( !v15 )
      {
