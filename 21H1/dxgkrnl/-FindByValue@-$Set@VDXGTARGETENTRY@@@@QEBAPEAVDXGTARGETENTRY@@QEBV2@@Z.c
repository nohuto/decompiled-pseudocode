/*
 * XREFs of ?FindByValue@?$Set@VDXGTARGETENTRY@@@@QEBAPEAVDXGTARGETENTRY@@QEBV2@@Z @ 0x1C004B81C
 * Callers:
 ...
 * Callees:
 *     ??9DXGTARGETENTRY@@QEBA_NAEBV0@@Z @ 0x1C02AC478 (--9DXGTARGETENTRY@@QEBA_NAEBV0@@Z.c)
 */
