/*
 * XREFs of ??0DXGDEVICE@@QEAA@PEAVADAPTER_RENDER@@PEAUDXGK_VIRTUAL_GPU_PARAV@@PEAPEAUDXG_SET_GUEST_DATA@@U_D3DKMT_CREATEDEVICEFLAGS@@PEAVDXGPROCESS@@W4DXGDEVICECLIENT_TYPE@@PEAVDXGADAPTER@@E@Z @ 0x1C00EB46C
 * Callers:
        ...
        char a9)
{
  ...
  *(_QWORD *)(a1 + 808) = a1 + 808;
  ...
  if ( v16 || (v16 = *(DXGADAPTER **)(a2 + 16), *((_QWORD *)v16 + 334)) && (*(_QWORD *)(a1 + 1848) = v16) != 0LL )
  {
    if ( !*((_QWORD *)v16 + 334) )
    {
    ...
    *(_DWORD *)(a1 + 1856) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 1848) + 2672LL) + 80LL);
  }
  *(_BYTE *)(a1 + 1868) = *(_BYTE *)(a6 + 346) != 0;
  if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 16LL) + 2612LL) )
  {
    v19 = *(_QWORD *)(a1 + 40);
    *(_BYTE *)(a1 + 1871) = 1;
    *(_BYTE *)(v19 + 297) = 1;
