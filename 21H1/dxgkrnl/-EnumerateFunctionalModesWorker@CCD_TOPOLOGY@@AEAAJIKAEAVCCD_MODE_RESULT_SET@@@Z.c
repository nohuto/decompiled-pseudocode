/*
 * XREFs of ?EnumerateFunctionalModesWorker@CCD_TOPOLOGY@@AEAAJIKAEAVCCD_MODE_RESULT_SET@@@Z @ 0x1C02E607C
 * Callers:
    ...
    if ( v18 )
    {
      ...
      if ( v22 >= 0 )
      {
        ...
        if ( v27 )
        {
          ...
          {
            LOBYTE(v34) = 1;
            v38 = CCD_TOPOLOGY::RetrieveActive((CCD_TOPOLOGY *)v64, v34, 0, 1, &v60);
            if ( v38 != -1073741789 )
              goto LABEL_29;
            v31 = v60;
          }
          ...
          if ( v38 >= 0 )
          {
            for ( j = 0; ; ++j )
            {
              ...
              if ( !v47 )
                goto LABEL_43;
              v48 = *((_QWORD *)v47 + 335);
              v49 = ADAPTER_DISPLAY::ForceIHVScaling(*((ADAPTER_DISPLAY **)v47 + 334));
