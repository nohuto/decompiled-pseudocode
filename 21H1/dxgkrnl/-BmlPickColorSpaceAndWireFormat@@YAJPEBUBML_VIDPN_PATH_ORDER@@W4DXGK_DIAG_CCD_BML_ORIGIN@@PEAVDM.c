/*
 * XREFs of ?BmlPickColorSpaceAndWireFormat@@YAJPEBUBML_VIDPN_PATH_ORDER@@W4DXGK_DIAG_CCD_BML_ORIGIN@@PEAVDMMVIDPN@@@Z @ 0x1C00E056C
 * Callers:
 ...
 *     ?ModeSupportsHighDepthColorFormat@@YA_NPEAVDMMVIDPNTARGETMODE@@PEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@@Z @ 0x1C02E7D58 (-ModeSupportsHighDepthColorFormat@@YA_NPEAVDMMVIDPNTARGETMODE@@PEAT_D3DKMDT_WIRE_FORMAT_AND_PREF.c)
 */
...
__int64 __fastcall BmlPickColorSpaceAndWireFormat(unsigned __int8 *a1, int a2, __int64 a3)
{
  ...
  unsigned int v88; // [rsp+2Ch] [rbp-3Ch] BYREF
  ...
  for ( i = (DMMVIDPNTOPOLOGY *)(a3 + 96); ; i = (DMMVIDPNTOPOLOGY *)(v4 + 96) )
  {
    ...
    v16 = *((_QWORD *)v12 + 12);
    v87 = 0;
    IsMonitorAndLinkHDRCapable = MonitorIsMonitorAndLinkHDRCapable(*(struct HDXGMONITOR__ **)(*(_QWORD *)(v16 + 96)
                                                                                            + 112LL));
    ...
    v28 = *((_QWORD *)v12 + 12);
    v97 = 0;
    IsMonitorAndDriverWCGCapable = MonitorIsMonitorAndDriverWCGCapable(*(struct HDXGMONITOR__ **)(*(_QWORD *)(v28 + 96)
                                                                                                + 112LL));
    ...
    if ( !v40 )
    {
      ...
      {
        v85 = v41;
        if ( (unsigned int)(v42 - 31) <= 2 && !*((_BYTE *)DXGGLOBAL::GetGlobal(v39, v35) + 304200) )
        {
          v60 = *(_QWORD *)(v96 + 48);
          v61 = *(_QWORD *)(v60 + 8);
          if ( !v61 )
...
LABEL_74:
    ...
    if ( !v27 )
      goto LABEL_24;
    if ( (v21 & 1) == 0
      || !*((_BYTE *)DXGGLOBAL::GetGlobal(v39, v35) + 304444)
