/*
 * XREFs of ?SetSchedulerCrossAdapterData@DXGGLOBAL@@QEAAXPEAU_KEVENT@@@Z @ 0x1C0044E44
 * Callers:
...
void __fastcall DXGGLOBAL::SetSchedulerCrossAdapterData(KSPIN_LOCK *this, struct _KEVENT *a2)
{
  ...
  KeAcquireInStackQueuedSpinLock(this + 138, &LockHandle);
  this[139] = (KSPIN_LOCK)a2;
