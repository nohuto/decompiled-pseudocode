/*
 * XREFs of ?DxgkTrimProcessCommitmentAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C02802C0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2[3] < a2[2] )
  {
    ...
    if ( *((_DWORD *)a1 + 50) == 1 && !*((_BYTE *)a1 + 209) )
    {
      ...
      *(_QWORD *)(v7 + 8) = 0LL;
      ...
      if ( (*(unsigned int (__fastcall **)(_QWORD, _QWORD, __int64 *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 335) + 640LL)
                                                                                         + 8LL)
                                                                             + 1136LL))(
             *(_QWORD *)(*((_QWORD *)a1 + 335) + 648LL),
             *a2,
             &v19,
             *((unsigned int *)a2 + 2)) == -1071775484 )
      {
        ...
        {
          v18 = 0LL;
          (*(void (__fastcall **)(_QWORD, _QWORD, __int64 *, _QWORD, _QWORD, __int64 *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 335) + 640LL) + 8LL)
                                                                                       + 1128LL))(
            *(_QWORD *)(*((_QWORD *)a1 + 335) + 648LL),
            *a2,
            &v19,
