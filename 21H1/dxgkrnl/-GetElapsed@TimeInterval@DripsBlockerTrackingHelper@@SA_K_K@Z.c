/*
 * XREFs of ?GetElapsed@TimeInterval@DripsBlockerTrackingHelper@@SA_K_K@Z @ 0x1C02BED44
 * Callers:
 ...
 * Callees:
 *     ?RtlULongLongMult@@YAJ_K0PEA_K@Z @ 0x1C004CD2C (-RtlULongLongMult@@YAJ_K0PEA_K@Z.c)
 */
