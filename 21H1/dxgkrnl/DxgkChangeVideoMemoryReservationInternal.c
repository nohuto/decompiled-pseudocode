/*
 * XREFs of DxgkChangeVideoMemoryReservationInternal @ 0x1C0224FAC
 * Callers:
 *     DxgkChangeVideoMemoryReservation @ 0x1C0224F90 (DxgkChangeVideoMemoryReservation.c)
...
LABEL_25:
  ...
  if ( hProcess )
  {
    ...
    Process = DXGPROCESSMUTEXBYHANDLE::GetProcess((DXGPROCESSMUTEXBYHANDLE *)v62, v19);
  }
  else
  {
...
LABEL_33:
  ...
  v45 = (ADAPTER_RENDER *)*((_QWORD *)v43 + 335);
