/*
 * XREFs of DpiUnmapIommuIdentityRangeInternal @ 0x1C0055E68
 * Callers:
 ...
 *     DpiUnmapMemoryTrackerFromIoMmu @ 0x1C0055ED0 (DpiUnmapMemoryTrackerFromIoMmu.c)
 *     DpiUnmapIommuIdentityRange @ 0x1C02C29B0 (DpiUnmapIommuIdentityRange.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0026570 (_guard_dispatch_icall_nop.c)
 *     IoMmuUnmapStagingMdl @ 0x1C0055560 (IoMmuUnmapStagingMdl.c)
 */
...
__int64 __fastcall DpiUnmapIommuIdentityRangeInternal(__int64 a1, __int64 a2, int a3, char a4, __int64 a5)
{
  ...
  result = ((__int64 (__fastcall *)(_QWORD))qword_1C00AFF78)(*(_QWORD *)(a1 + 8));
  if ( (int)result < 0 )
  {
