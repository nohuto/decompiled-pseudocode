/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C02C0480
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C02C090C (SeUtilSecurityInfoFromSecurityDescriptor.c)
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C02C0C40 (CmRegUtilUcValueGetFullBuffer.c)
 *     CmRegUtilWstrValueGetDword @ 0x1C02C0EA4 (CmRegUtilWstrValueGetDword.c)
 */
