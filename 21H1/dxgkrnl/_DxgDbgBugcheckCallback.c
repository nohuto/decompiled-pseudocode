/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C0041D00
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C00B15B0 )
    {
      v4 = (unsigned int)(dword_1C00B15A8 - 1);
      if ( dword_1C00B15A8 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C00B15B0) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C00B0018;
      ReasonSpecificData[4] = qword_1C00B15B0;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C00B0018;
      if ( v5 )
      {
