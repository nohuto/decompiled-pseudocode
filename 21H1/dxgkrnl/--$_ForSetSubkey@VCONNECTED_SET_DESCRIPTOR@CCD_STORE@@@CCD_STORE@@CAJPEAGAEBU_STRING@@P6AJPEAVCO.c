/*
 * XREFs of ??$_ForSetSubkey@VCONNECTED_SET_DESCRIPTOR@CCD_STORE@@@CCD_STORE@@CAJPEAGAEBU_STRING@@P6AJPEAVCONNECTED_SET_DESCRIPTOR@0@PEAX@Z3_N@Z @ 0x1C01398C4
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( v11 < 0 )
    goto LABEL_9;
  v27 = 2;
  v10 = CcdOpenRegistrySubkey_0(&Handle, 0xF003Fu, v29, &DestinationString, &v27);
  operator delete[](DestinationString.Buffer);
  DestinationString = 0LL;
  if ( (int)v10 < 0 )
  {
    v25 = (_QWORD *)WdLogNewEntry5_WdWarning(v15, v14, v16);
    v25[3] = v10;
