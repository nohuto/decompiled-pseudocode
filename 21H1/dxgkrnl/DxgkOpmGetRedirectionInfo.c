/*
 * XREFs of DxgkOpmGetRedirectionInfo @ 0x1C02135A0
 * Callers:
...
__int64 __fastcall DxgkOpmGetRedirectionInfo(ADAPTER_DISPLAY **a1, unsigned int a2, unsigned __int64 *a3, __int64 a4)
{
  ...
  result = ADAPTER_DISPLAY::DodGetOpmMftContext(a1[334], (unsigned int)v5, a3);
...
LABEL_7:
    if ( a4 )
    {
      ...
      DisplayModeInfo = ADAPTER_DISPLAY::GetDisplayModeInfo(a1[334], (unsigned int)v17);
      if ( !DisplayModeInfo )
      {
