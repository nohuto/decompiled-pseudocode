/*
 * XREFs of ?PollDisplayChildrenForAdapter@@YAJPEBU_D3DKMT_POLLDISPLAYCHILDREN@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C021DB28
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  LODWORD(v22) = COREADAPTERACCESS::AcquireExclusive((__int64)v56, v20 + 1, v20);
  if ( (int)v22 >= 0 )
  {
...
LABEL_26:
          if ( (*((_DWORD *)a1 + 1) & 4) != 0 )
          {
            v44 = COREADAPTERACCESS::AcquireExclusive((__int64)v56, 1LL, 0);
            v47 = v44;
            if ( v44 < 0 )
            {
