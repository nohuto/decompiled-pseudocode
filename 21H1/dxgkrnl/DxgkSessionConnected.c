/*
 * XREFs of DxgkSessionConnected @ 0x1C014B6E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgkSessionConnected(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  else
  {
    if ( (_BYTE)v3 )
    {
      ...
      DXGSESSIONMGR::SetConsoleSession(*((DXGSESSIONMGR **)Global + 88), 1u);
      if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v10, v9) + 76112) )
      {
        ...
        *((_DWORD *)DXGGLOBAL::GetGlobal(v21, v20) + 76112) = 0;
      }
    }
    v13 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal(v6, v5) + 88);
    if ( v13 )
    {
