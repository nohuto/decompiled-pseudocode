/*
 * XREFs of NtDxgkDisplayPortOperation @ 0x1C004E010
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SidebandMessageParser@@YAJPEAEIT_SB_MSG_PARSER_CONFIG@@PEAW4_SBMT_REQUEST_ID@@P6AJPEAX0I@Z3@Z @ 0x1C006D548 (-SidebandMessageParser@@YAJPEAEIT_SB_MSG_PARSER_CONFIG@@PEAW4_SBMT_REQUEST_ID@@P6AJPEAX0I@Z3@Z.c)
...
LABEL_115:
  ...
  if ( !v25 )
  {
    ...
    if ( (int)COREADAPTERACCESS::AcquireExclusive((__int64)v80, 3LL, 2u) < 0 )
    {
LABEL_23:
...
LABEL_24:
  ...
  EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v70, *(_QWORD *)(*((_QWORD *)v9 + 334) + 88LL));
  switch ( v73[0].LowPart )
  {
    case 1u:
      ...
      if ( v25 )
        DPCaps = ADAPTER_DISPLAY::DdiQueryDPCaps(*((ADAPTER_DISPLAY **)v9 + 334), (struct _DXGKARG_QUERYDPCAPS *)v14);
      else
    ...
    case 2u:
      ...
      if ( v25 )
        DPCaps = ADAPTER_DISPLAY::DdiGetDPAddress(*((ADAPTER_DISPLAY **)v9 + 334), (struct _DXGKARG_GETDPADDRESS *)v14);
      else
