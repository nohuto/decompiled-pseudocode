/*
 * XREFs of ?_MonitorTelemetry@DXGMONITOR@@QEAAXW4_TELEMETRY_MONITOR_INVENTORY_TRIGGER@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C016B084
 * Callers:
...
LABEL_34:
  ...
  *(_QWORD *)v135 = 0LL;
  ...
  if ( v29 )
  {
    ...
    if ( (unsigned int)dword_1C00AEA90 > 5 && tlgKeywordOn((__int64)&dword_1C00AEA90, 0x800000000020LL) )
    {
      v59 = v36;
      ...
      v99 = *(_DWORD *)(a1 + 48);
      if ( v37 )
        v66 = tlgKeywordOn((__int64)&dword_1C00AEA90, 0x200000000000LL) != 0;
      if ( !v37 || !tlgKeywordOn((__int64)&dword_1C00AEA90, 0x400000000000LL) )
        v6 = 0;
      v69 = gDISeqId;
      v123 = v28;
      v105 = v67;
      ...
      *(_QWORD *)&v114 = &v132;
      ...
      v119 = *(unsigned __int16 **)(v70 + 1496);
      v120 = v108;
