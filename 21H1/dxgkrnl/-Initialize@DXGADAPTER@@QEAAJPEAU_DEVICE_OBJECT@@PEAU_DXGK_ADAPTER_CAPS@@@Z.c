/*
 * XREFs of ?Initialize@DXGADAPTER@@QEAAJPEAU_DEVICE_OBJECT@@PEAU_DXGK_ADAPTER_CAPS@@@Z @ 0x1C0176AF4
 * Callers:
 ...
 *     ?CheckMcdmDdiOverall@DXGADAPTER@@AEAAJXZ @ 0x1C0022380 (-CheckMcdmDdiOverall@DXGADAPTER@@AEAAJXZ.c)
 ...
 *     ?SetWarpAdapter@DXGGLOBAL@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C0188E84 (-SetWarpAdapter@DXGGLOBAL@@QEAAXPEAVDXGADAPTER@@@Z.c)
 *     ?CreateFrameBufferSaveAreaSection@DXGADAPTER@@QEAAJI_K@Z @ 0x1C02078F8 (-CreateFrameBufferSaveAreaSection@DXGADAPTER@@QEAAJI_K@Z.c)
 ...
 *     ?ValidateHardwareReservedRanges@DXGADAPTER@@AEAAJPEBU_DXGK_PHYSICAL_MEMORY_RANGE@@I@Z @ 0x1C020C0C4 (-ValidateHardwareReservedRanges@DXGADAPTER@@AEAAJPEBU_DXGK_PHYSICAL_MEMORY_RANGE@@I@Z.c)
 */
...
__int64 __fastcall DXGADAPTER::Initialize(DXGADAPTER *this, PDEVICE_OBJECT DeviceObject, struct _DXGK_ADAPTER_CAPS *a3)
{
  ...
  __int64 v192; // rdx
  void *v193; // [rsp+28h] [rbp-D8h]
  int v194; // [rsp+30h] [rbp-D0h]
  unsigned int v195; // [rsp+40h] [rbp-C0h] BYREF
  int v196; // [rsp+44h] [rbp-BCh] BYREF
  int v197; // [rsp+48h] [rbp-B8h] BYREF
  unsigned int v198; // [rsp+4Ch] [rbp-B4h]
  __int64 v199; // [rsp+50h] [rbp-B0h] BYREF
  struct _DXGKARG_QUERYADAPTERINFO v200; // [rsp+58h] [rbp-A8h] BYREF
  unsigned int v201[4]; // [rsp+88h] [rbp-78h] BYREF
  _BYTE v202[16]; // [rsp+98h] [rbp-68h] BYREF
  struct _DXGKARG_QUERYADAPTERINFO v203; // [rsp+A8h] [rbp-58h] BYREF
  struct _DXGKARG_QUERYADAPTERINFO v204; // [rsp+D8h] [rbp-28h] BYREF
  char v205; // [rsp+150h] [rbp+50h]
  unsigned int v207; // [rsp+168h] [rbp+68h] BYREF
...
LABEL_198:
  ...
  *((_DWORD *)this + 58) = v16;
  if ( v16 == -1 )
    return 3221225495LL;
  LODWORD(v14) = ZwAllocateLocallyUniqueId((PLUID)((char *)this + 4284));
  if ( (int)v14 < 0 )
  {
...
LABEL_195:
  ...
  *((_QWORD *)this + 5) = -1LL;
  ...
  {
    v152 = DXGADAPTER::InitializeParavirtualizedAdapter(this, (struct DRIVER_WORKAROUNDS *)&v197);
    v14 = v152;
    if ( v152 < 0 )
    {
...
LABEL_200:
  ...
  {
    AdapterInfo = DpiGetAdapterInfo(DeviceObject, (char *)this + 1368, (char *)this + 272, (char *)this + 1856);
    v30 = AdapterInfo;
    if ( AdapterInfo < 0 )
    {
  ...
  if ( (v31 & 0x200) != 0 )
  {
    *((_BYTE *)DXGGLOBAL::GetGlobal(v27, (__int64)v26) + 304200) = 1;
    v31 = *((_DWORD *)this + 87);
  }
  ...
  v32 = DXGADAPTER::CallDriverQueryInterface(this, v26, v28, v29, (char *)this + 1664, v193);
  v37 = v32;
  if ( v32 >= 0 )
  {
    if ( *((_WORD *)this + 833) >= 4u )
      goto LABEL_23;
  }
  else
  {
  ...
  memset((char *)this + 1664, 0, 0xB8uLL);
LABEL_23:
  v39 = *(_QWORD *)(*((_QWORD *)this + 27) + 64LL);
  v40 = *(_DWORD *)(*(_QWORD *)(v39 + 40) + 28LL);
  *((_DWORD *)this + 462) = v40;
  if ( v40 >= 0x7000 && *((_DWORD *)this + 356) && *((_DWORD *)this + 357) )
  {
    v112 = 0;
LABEL_122:
  ...
  if ( v40 >= 0x6002 && *((_DWORD *)this + 356) && *((_DWORD *)this + 357) )
  {
    v112 = 1;
    goto LABEL_122;
  }
LABEL_26:
  ...
  *(_QWORD *)&v200.Type = 1LL;
  *(_QWORD *)&v200.InputDataSize = 0LL;
  v200.pOutputData = (char *)this + 1968;
  *(_OWORD *)&v200.OutputDataSize = 0LL;
  v200.pInputData = 0LL;
  v200.OutputDataSize = GetDriverCapsSizeFromDdiVersion(v40);
  if ( !v200.OutputDataSize )
    return 3221225485LL;
  v42 = DXGADAPTER::DdiQueryAdapterInfo(this, &v200, v41);
  v30 = v42;
  if ( v42 < 0 )
  {
...
LABEL_222:
  ...
  if ( (int)v45 < 4864 )
  {
    if ( *((_QWORD *)this + 92) )
    {
      *((_DWORD *)this + 643) = 1300;
    }
    else if ( (_DWORD)v45 == 4608 )
    {
      *((_DWORD *)this + 643) = 1200;
    }
    else if ( *((_QWORD *)this + 88) && (*((_DWORD *)this + 505) & 4) != 0 )
    {
      *((_DWORD *)this + 643) = 1105;
    }
    else
    {
      *((_DWORD *)this + 643) = 1000;
    }
  }
  else
  {
    *((_DWORD *)this + 643) = DxgkConvertWddmVersionToD3DKMTDriverVersion(v45);
  }
  v46 = *((_QWORD *)this + 27);
  v196 = 0;
  v47 = DpiReadPnpRegistryValue(v46, L"ACGSupported", &v196, 4LL);
  v49 = v196;
  if ( v47 < 0 )
    v49 = 0;
  v196 = v49;
  if ( v49 || (v50 = 0, *((int *)this + 643) >= 2200) )
    v50 = 1;
  *((_BYTE *)this + 212) = v50;
  if ( *((_BYTE *)this + 209) )
  {
    *((_BYTE *)a3 + 1) &= ~1u;
    *(_BYTE *)a3 &= 0x7Bu;
    *((_DWORD *)this + 509) &= 0xFFFFD3FF;
    *((_DWORD *)this + 636) &= 0xFFFFFFEB;
    *((_BYTE *)this + 2508) = 0;
    if ( *((_BYTE *)this + 210) )
      *((_DWORD *)this + 505) &= ~0x100000u;
  }
  else if ( g_bCreateParavirtualizedGpu )
  {
    if ( v40 >= 0x5023 )
    {
      ...
      if ( (v159 & 4) == 0 && (v159 & 0x10) == 0 && !*(_BYTE *)(*((_QWORD *)DeviceObject->DeviceExtension + 5) + 133LL) )
        *((_DWORD *)this + 509) |= 0x400u;
    }
  }
  v51 = (_DWORD *)((char *)this + 2552);
  *((_DWORD *)this + 638) = 0;
  if ( v40 >= 0x5010 && !*((_BYTE *)this + 209) )
  {
    *(_QWORD *)&v204.Type = 16LL;
    *(_QWORD *)&v204.InputDataSize = 0LL;
    *(_QWORD *)&v204.Flags.0 = 0LL;
    HIDWORD(v204.hKmdProcessHandle) = 0;
    v204.pInputData = 0LL;
    v204.pOutputData = (char *)this + 2552;
    v204.OutputDataSize = 4;
    v52 = DXGADAPTER::DdiQueryAdapterInfo(this, &v204, v48);
    if ( v52 < 0 )
    {
  ...
  v198 = *((_DWORD *)this + 70);
  v59 = (struct _DXGK_PHYSICAL_MEMORY_RANGE *)v198;
  v60 = 360LL * v198;
  v61 = v198;
  if ( !is_mul_ok(v198, 0x168uLL) )
    v60 = -1LL;
  ...
  *((_QWORD *)this + 320) = v69;
  ...
  v205 = 0;
  if ( *((int *)this + 576) >= 0x2000 && v40 >= 0x5005 )
  {
    *((_DWORD *)this + 642) = 0;
    v113 = 0;
    v207 = 0;
    if ( (_DWORD)v59 )
    {
      v114 = *((_QWORD *)this + 320);
      v72 = 0LL;
      do
      {
        *(_QWORD *)&v203.Type = 15LL;
        v203.pInputData = &v207;
        *(_QWORD *)&v203.InputDataSize = 4LL;
        *(_QWORD *)&v203.Flags.0 = 0LL;
        HIDWORD(v203.hKmdProcessHandle) = 0;
        v203.pOutputData = (void *)(v114 + 360LL * (unsigned int)v72);
        if ( v40 < 0xC003 )
          v203.OutputDataSize = v40 < 0x6000 ? 20 : 24;
        else
          v203.OutputDataSize = 32;
        v115 = DXGADAPTER::DdiQueryAdapterInfo(this, &v203, v72);
        v118 = v115;
        if ( v115 < 0 )
        {
        ...
        if ( v40 >= 0xC003 )
        {
          ...
          if ( (*(_DWORD *)(v162 + v161 + 16) & 0x20) != 0 )
          {
            if ( *(_DWORD *)(v162 + v161 + 24) >= (unsigned int)*(unsigned __int16 *)(v162 + v161) )
            {
              ...
              v157[3] = this;
              v157[4] = *(unsigned int *)(360LL * v207 + *((_QWORD *)this + 320) + 24);
              v157[5] = *(unsigned __int16 *)(360LL * v207 + *((_QWORD *)this + 320));
              goto LABEL_219;
            }
            if ( (*((_DWORD *)this + 509) & 0x2000) == 0 )
            {
              v157 = (_QWORD *)WdLogNewEntry5_WdError(v162, v161);
              v157[3] = this;
              v157[4] = 6936LL;
        ...
        v113 = v70 + *((_DWORD *)this + 642);
        v72 = ++v207;
        *((_DWORD *)this + 642) = v113;
      }
      while ( (unsigned int)v72 < (unsigned int)v59 );
    }
    if ( *((int *)this + 643) <= 2400 && v113 > 0x40 )
    {
      v157 = (_QWORD *)WdLogNewEntry5_WdError(v71, v70);
      v157[3] = this;
      v157[4] = 64LL;
      v157[5] = *((unsigned int *)this + 642);
LABEL_219:
      WdLogEvent5_WdError(v157);
      return 3221225485LL;
    }
    if ( (*((_DWORD *)this + 508) & 1) == 0 )
    {
      v157 = (_QWORD *)WdLogNewEntry5_WdError(v71, v70);
      v157[3] = this;
      v157[4] = 6958LL;
...
LABEL_141:
    ...
    if ( (_DWORD)v59 )
    {
      ...
      {
        v199 = 0LL;
        v200.pInputData = &v195;
        v200.Type = DXGKQAITYPE_FRAMEBUFFERSAVESIZE;
        v200.pOutputData = &v199;
        v200.InputDataSize = 4;
        v200.OutputDataSize = 8;
        v163 = DXGADAPTER::DdiQueryAdapterInfo(this, &v200, v72);
        v95 = v163;
        if ( v163 < 0 )
          break;
        if ( (v199 & 0xFFF) != 0 )
        ...
        *(_QWORD *)(360LL * v195 + *((_QWORD *)this + 320) + 56) = v199;
        v164 = v195;
        v72 = *(_QWORD *)(360LL * v195 + *((_QWORD *)this + 320) + 56);
        if ( v72 )
        {
          result = DXGADAPTER::CreateFrameBufferSaveAreaSection(this, v195, v72);
          if ( (int)result < 0 )
            return result;
          v164 = v195;
        }
    ...
    {
LABEL_259:
      v200.InputDataSize = 0;
      v200.pInputData = 0LL;
      v200.pOutputData = v201;
      v200.Type = DXGKQAITYPE_HARDWARERESERVEDRANGES;
      *(_OWORD *)v201 = 0LL;
      v200.OutputDataSize = 16;
      v165 = DXGADAPTER::DdiQueryAdapterInfo(this, &v200, v72);
      v95 = v165;
      if ( v165 >= 0 )
      {
        if ( v201[0] )
        {
          ...
          if ( !v167 )
          {
            ...
            *(_QWORD *)(v171 + 24) = v201[0];
LABEL_268:
            WdLogEvent5_WdError(v171);
            return (unsigned int)v95;
          }
          *(_QWORD *)&v201[2] = v167;
          if ( (int)DXGADAPTER::DdiQueryAdapterInfo(this, &v200, v170) < 0 )
          {
            v175 = WdLogNewEntry5_WdAssertion(v174, v173);
            *(_QWORD *)(v175 + 24) = 7027LL;
            WdLogEvent5_WdAssertion(v175);
          }
          LODWORD(v95) = DXGADAPTER::ValidateHardwareReservedRanges(v174, v59, v201[0]);
          if ( (int)v95 < 0 )
          {
            operator delete[](v59);
            return (unsigned int)v95;
...
LABEL_56:
  if ( v73 && (_DWORD)v59 )
  {
    ...
    do
    {
      *(_WORD *)(v70 + *((_QWORD *)this + 320)) = *((_WORD *)this + 1022);
      v70 += 360LL;
      *(_DWORD *)(*((_QWORD *)this + 320) + v70 - 344) ^= (*(_DWORD *)(*((_QWORD *)this + 320) + v70 - 344) ^ (*((_DWORD *)this + 509) >> 7)) & 1;
      *(_DWORD *)(*((_QWORD *)this + 320) + v70 - 344) ^= (*(_DWORD *)(*((_QWORD *)this + 320) + v70 - 344) ^ (*((_DWORD *)this + 509) >> 5)) & 2;
      *(_WORD *)(*((_QWORD *)this + 320) + v70 - 358) = *((_WORD *)this + 1020);
      v71 = *((_QWORD *)this + 320);
  ...
  {
    if ( *((_DWORD *)this + 636) >= 0x20u )
    {
      v157 = (_QWORD *)WdLogNewEntry5_WdError(v71, v70);
      v157[3] = 7065LL;
      goto LABEL_219;
    }
    *((_BYTE *)this + 2626) = *((_BYTE *)this + 2544) & 1;
  }
  v74 = *((_DWORD *)this + 636);
  ...
  if ( *((_BYTE *)this + 2772) )
    *((_DWORD *)this + 636) = v74 & 0xFFFFFFEF;
  if ( v40 < 0x3001 )
  {
    *((_DWORD *)this + 576) = 4096;
  }
  else
  {
    v75 = *((_DWORD *)this + 576);
      ...
      && v75 != 9728 )
    {
      ...
      *(_QWORD *)(v156 + 24) = *((int *)this + 576);
      goto LABEL_213;
    }
  }
  if ( !*((_BYTE *)DXGGLOBAL::GetGlobal(v71, v70) + 648) || (v77 = 1, (*((_DWORD *)this + 87) & 8) != 0) )
    v77 = 0;
  *((_BYTE *)this + 2584) = v77;
  if ( v77 )
  {
    v177 = *((unsigned int *)this + 576);
    if ( (int)v177 < 4608
      && (*((_DWORD *)this + 624)
       || *((_DWORD *)this + 625)
       || *((_BYTE *)this + 2504)
       || *((_BYTE *)this + 2505)
       || *((_BYTE *)this + 2506)
       || (*((_DWORD *)this + 505) & 0x10000000) != 0
       || (*((_DWORD *)this + 508) & 0x14) != 0
       || *((_BYTE *)this + 2507)
       || *((_BYTE *)this + 2509)
       || *((_BYTE *)this + 2510)) )
    {
    ...
    if ( (int)v177 < 4864
      && ((*((_DWORD *)this + 507) & 0x10) != 0
       || (*((_DWORD *)this + 509) & 0x10) != 0
       || *((_BYTE *)this + 2511)
       || *((_DWORD *)this + 628)) )
    {
      v157 = (_QWORD *)WdLogNewEntry5_WdError(v177, v76);
    ...
    if ( (int)v177 < 0x2000 && *((_BYTE *)this + 2516) )
    {
      v157 = (_QWORD *)WdLogNewEntry5_WdError(v177, v76);
      v157[3] = 7198LL;
      goto LABEL_219;
  ...
  *(_BYTE *)a3 ^= (*(_BYTE *)a3 ^ (4 * *((_BYTE *)this + 2504))) & 4;
  v78 = *(_BYTE *)a3 & 0xF7 | (*((_BYTE *)this + 2510) != 0 ? 8 : 0);
  *(_BYTE *)a3 = v78;
  v79 = (v78 ^ (32 * (*((_DWORD *)this + 509) >> 4))) & 0x20 ^ v78;
  *(_BYTE *)a3 = v79;
  v80 = (v79 ^ (*((_BYTE *)this + 2511) << 6)) & 0x40 ^ v79;
  *(_BYTE *)a3 = v80;
  *((_DWORD *)a3 + 1) = *((_DWORD *)this + 501);
  *(_BYTE *)a3 = v80 & 0x7F | (*(_BYTE *)v51 << 7);
  *((_BYTE *)a3 + 1) ^= (*((_BYTE *)a3 + 1) ^ *((_BYTE *)this + 2516)) & 1;
  *((_DWORD *)a3 + 2) = *((_DWORD *)this + 576);
  ...
  *((_BYTE *)a3 + 1) = v87;
  ...
  if ( !*((_BYTE *)this + 209) )
  {
    ...
    if ( (v86 & 0x40) != 0 )
    {
      if ( v40 < 0x5005 && (*((_DWORD *)this + 356) || *((_DWORD *)this + 357)) )
      {
        v157 = (_QWORD *)WdLogNewEntry5_WdError(v83, v82);
        v158 = *((_QWORD *)this + 27);
        goto LABEL_222;
      }
      v87 ^= (v87 ^ (2 * *((_BYTE *)this + 2539))) & 2;
      *((_BYTE *)a3 + 1) = v87;
    }
    v88 = v87 & 1;
    v83 = 0LL;
    ...
    if ( *((_BYTE *)this + 2506) && (!*((_QWORD *)this + 89) || !*((_QWORD *)this + 90) || !*((_QWORD *)this + 91)) )
    {
      v157 = (_QWORD *)WdLogNewEntry5_WdError(v83, v82);
      v157[3] = 7306LL;
      goto LABEL_219;
    }
    if ( (*((_DWORD *)this + 505) & 4) != 0 && !*((_QWORD *)this + 88) )
    {
      v157 = (_QWORD *)WdLogNewEntry5_WdError(v83, v82);
      v157[3] = 7313LL;
      goto LABEL_219;
    }
    if ( *((_BYTE *)this + 2509) && (!*((_QWORD *)this + 93) || !*((_QWORD *)this + 94)) )
    {
      v157 = (_QWORD *)WdLogNewEntry5_WdError(v83, v82);
      v157[3] = 7321LL;
      goto LABEL_219;
  ...
  *((_BYTE *)this + 2624) = 0;
  if ( v89 )
    goto LABEL_95;
  v90 = 0;
  if ( v40 >= 0x700A && *((int *)this + 576) >= 8704 && (!*((_QWORD *)this + 71) || *((_QWORD *)this + 137)) )
  {
    *((_BYTE *)this + 2624) = 1;
    v90 = 1;
  }
  if ( *((int *)this + 576) < 8960 )
  {
LABEL_95:
    *((_DWORD *)this + 504) &= 0xFFFFFFE3;
  }
  else
  {
    v144 = (*((_DWORD *)this + 504) >> 3) & 1;
    v82 = (*((_DWORD *)this + 504) >> 2) & 1;
    if ( (unsigned int)v82 < (unsigned int)v144
      || (unsigned int)v144 < ((*((_DWORD *)this + 504) >> 4) & 1u)
      || !v90 && (_DWORD)v82 )
    {
  ...
  if ( *((_BYTE *)this + 209) )
  {
    **((_DWORD **)this + 322) ^= (v23 ^ **((_DWORD **)this + 322)) & 0x10000;
    v97 = (_DWORD *)*((_QWORD *)this + 322);
...
LABEL_103:
  ...
  v99 = (__int64 *)((char *)this + 2680);
  RenderCore = ADAPTER_RENDER::CreateRenderCore(this, (struct ADAPTER_RENDER **)this + 335);
  v14 = RenderCore;
  if ( RenderCore < 0 )
  {
    if ( *v99 )
  ...
  v103 = (__int64 *)((char *)this + 2672);
  DisplayCore = ADAPTER_DISPLAY::CreateDisplayCore(this, (struct ADAPTER_DISPLAY **)this + 334);
  v95 = DisplayCore;
  if ( DisplayCore < 0 )
  {
    if ( *v103 )
...
LABEL_108:
  ...
  *((_DWORD *)this + 50) = IsBddFallbackDriver ? 3 : 1;
  if ( (v121 & 0x10) != 0 && !*v103 )
  {
    DXGGLOBALSHAREMUTEX::DXGGLOBALSHAREMUTEX((DXGGLOBALSHAREMUTEX *)v202, v120);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v202);
    if ( *((_QWORD *)DXGGLOBAL::GetGlobal(v137, v136) + 89) )
    {
    ...
    if ( v202[8] )
      DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v202, v141);
  }
  if ( *((_BYTE *)this + 209) )
  {
LABEL_384:
...
LABEL_152:
  if ( *((_BYTE *)this + 2584) )
  {
    if ( *((int *)this + 576) >= 4864 && DXGADAPTER::IsFullWDDMAdapter(this) )
    {
      v189 = *((_DWORD *)this + 87);
      if ( (v189 & 4) == 0 && (v189 & 0x20) == 0 && (*((_DWORD *)this + 507) & 0x10) == 0 )
      {
...
LABEL_153:
  ...
  *((_QWORD *)this + 556) = v128;
  ...
  if ( *((int *)this + 643) >= 2600 && (*((_DWORD *)this + 636) & 8) != 0 )
    wil_details_FeatureReporting_ReportUsageToService(
  ...
  if ( (*((_DWORD *)this + 87) & 1) != 0 )
  {
    ...
    *((_QWORD *)DXGGLOBAL::GetGlobal(v130, v129) + 93) = v142;
  }
  if ( (int)v95 < 0 )
    return (unsigned int)v95;
  if ( v198 <= 1 )
