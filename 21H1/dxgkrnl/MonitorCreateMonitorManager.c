/*
 * XREFs of MonitorCreateMonitorManager @ 0x1C0185EA4
 * Callers:
 ...
 *     ?_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ @ 0x1C0185F40 (-_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ.c)
 */
