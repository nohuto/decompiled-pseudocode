/*
 * XREFs of ?DxgkOpenAdapter@@YAJPEAU_D3DKMT_OPENADAPTER@@@Z @ 0x1C010F760
 * Callers:
...
__int64 __fastcall DxgkOpenAdapter(struct _D3DKMT_OPENADAPTER *a1, __int64 a2, __int64 a3)
{
  ...
  if ( *((_DWORD *)v18 + 50) != 1
    || (v22 = v58, *((_BYTE *)v58 + 2585))
    || (v20 = (_QWORD *)*((_QWORD *)v58 + 335)) == 0LL
    || *(_BYTE *)(v20[2] + 209LL) )
  {
LABEL_19:
    v69 = 0;
    ...
    *(_QWORD *)(v11 + 216) = KeGetCurrentThread();
    v68 = HMGRTABLE::AllocHandle((unsigned int *)(v11 + 240), (__int64)v29, 1, 0, 0);
    *(_QWORD *)(v11 + 216) = 0LL;
...
LABEL_31:
  ...
  v49 = WdLogNewEntry5_WdEvent(v20, v19);
  *(_QWORD *)(v49 + 24) = v22;
  *(_QWORD *)(v49 + 32) = v11;
