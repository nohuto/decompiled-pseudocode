/*
 * XREFs of DxgkSetPresenterViewMode @ 0x1C0159B60
 * Callers:
...
bool __fastcall DxgkSetPresenterViewMode(__int64 a1, __int64 a2)
{
  ...
  if ( (_BYTE)a2 )
  {
    v7 = *((_DWORD *)DXGGLOBAL::GetGlobal(a1, a2) + 281) == 0;
  }
  else
  {
    v6 = (unsigned int)_InterlockedExchange((volatile __int32 *)DXGGLOBAL::GetGlobal(a1, a2) + 281, (_BYTE)a1 != 0);
    v7 = (_DWORD)v6 == 0;
  }
  v8 = !v7;
