/*
 * XREFs of ?VmBusCddGdiCommand@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0237D50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_135:
  ...
  {
    v13 = WdLogNewEntry5_WdError(v14, v17);
    *(_QWORD *)(v13 + 24) = 2046LL;
    goto LABEL_135;
  }
  if ( (*(_DWORD *)(v10 + 48) & 0x20) == 0 )
  {
    v13 = WdLogNewEntry5_WdError(v14, v17);
    *(_QWORD *)(v13 + 24) = 2051LL;
    goto LABEL_135;
  }
  v18 = *(_DWORD *)(v10 + 24);
  v103 = 0LL;
...
LABEL_25:
  ...
  if ( (*((_DWORD *)v103 + 505) & 4) == 0 )
  {
    v43 = WdLogNewEntry5_WdError(4LL, v34);
    *(_QWORD *)(v43 + 24) = 2127LL;
    goto LABEL_38;
  }
  ...
  while ( v49 >= 8 )
  {
    ...
    if ( *(_DWORD *)v51 == 1 )
    {
      ...
      if ( (unsigned __int16)(v84 - 1) > 4u )
      {
        ...
        *(_QWORD *)(v43 + 24) = 2177LL;
        goto LABEL_38;
      }
      if ( (_WORD)v84 == 5 )
      {
        if ( *(_BYTE *)(*((_QWORD *)v2 + 5) + 153LL) || (*((_DWORD *)v103 + 505) & 0x100000) == 0 )
        {
          v43 = WdLogNewEntry5_WdError(0LL, 4LL);
          *(_QWORD *)(v43 + 24) = 2184LL;
          goto LABEL_38;
        }
        v88 = gajRop3;
      ...
      else
      {
        ...
        if ( *(_DWORD *)v51 == 4 )
        {
          ...
          if ( (_WORD)v72 != 3 )
          {
            ...
            *(_QWORD *)(v43 + 24) = 2320LL;
            goto LABEL_38;
          }
          if ( (v72 & 0x30000) != 0 && (*((_DWORD *)v103 + 505) & 0x200000) == 0 )
          {
            v43 = WdLogNewEntry5_WdError(v72, v68);
            *(_QWORD *)(v43 + 24) = 2326LL;
            goto LABEL_38;
          }
LABEL_77:
...
LABEL_70:
        ...
        if ( v61 != -1 )
        {
          if ( v61 > 0xF )
          {
            ...
            *(_QWORD *)(v43 + 24) = 2395LL;
            goto LABEL_38;
          }
          if ( v33[v56] < 0x2000uLL )
          {
            v43 = WdLogNewEntry5_WdError(v56, 0xFFFFFFFFLL);
            *(_QWORD *)(v43 + 24) = 2400LL;
            goto LABEL_38;
          }
        }
        v62 = *((_DWORD *)v51 + 10);
