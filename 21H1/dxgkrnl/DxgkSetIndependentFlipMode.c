/*
 * XREFs of DxgkSetIndependentFlipMode @ 0x1C0160624
 * Callers:
 ...
 *     ?GetPlaneIndex@DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAAIXZ @ 0x1C001D468 (-GetPlaneIndex@DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAAIXZ.c)
 *     ?GetVidPnSourceId@DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAAIXZ @ 0x1C001D494 (-GetVidPnSourceId@DXGK_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAAIXZ.c)
...
LABEL_30:
  ...
  else
  {
    ...
    else
    {
      ...
      while ( v25 )
      {
        v26 = *(_DWORD *)(*(_QWORD *)(v15 + 2672) + 80LL);
...
LABEL_39:
        ...
        v29 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)Object + 2) + 80LL) + 16LL) + 2512LL);
