/*
 * XREFs of ?AugmentVidPnTopologyOnNoLkg@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@PEAXPEBU_DXGDMM_INTERFACE@@IW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@GEQEA_KQEAI@Z @ 0x1C02584E0
 * Callers:
    ...
    if ( v29 == -1071774925 )
    {
      ...
      *(_QWORD *)(v33 + 32) = a5;
      ...
      if ( v34 >= 0 )
      {
        ...
        v40 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v31);
        v41 = a7;
        v40[3] = a7;
        v40[4] = a1;
        v40[5] = a5;
        ...
        {
          v46 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v44);
          v46[3] = a5;
          v46[4] = v41;
          v46[5] = a3;
