/*
 * XREFs of _CTokenManager::ReleaseFlipManagerTokensToFrame_::_2_::TokentokenEventTracker::_TokentokenEventTracker @ 0x1C0061A54
 * Callers:
        ...
        __int64 a2)
{
  ...
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)Global + 38033) + 96LL))(
           *(_QWORD *)a1,
           *(unsigned int *)(a1 + 8));
}
