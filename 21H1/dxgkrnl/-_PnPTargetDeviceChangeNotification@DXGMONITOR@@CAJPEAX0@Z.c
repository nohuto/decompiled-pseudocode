/*
 * XREFs of ?_PnPTargetDeviceChangeNotification@DXGMONITOR@@CAJPEAX0@Z @ 0x1C02F4600
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_OnMonitorFunctionDriverDeparture@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02F4568 (-_OnMonitorFunctionDriverDeparture@DXGMONITOR@@QEAAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z.c)
  ...
  *(_QWORD *)(v8 + 32) = NotificationStructure;
  if ( NotificationStructure && Context )
  {
    ...
    *(_OWORD *)v60 = 0LL;
    ...
    v20 = COREADAPTERACCESS::AcquireExclusive((__int64)v63, v19 + 1, v19);
    if ( v20 >= 0 )
    {
      v25 = *((_QWORD *)v17 + 334);
      if ( !v25 )
