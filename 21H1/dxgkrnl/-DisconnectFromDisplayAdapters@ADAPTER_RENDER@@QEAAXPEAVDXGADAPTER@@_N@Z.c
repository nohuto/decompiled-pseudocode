/*
 * XREFs of ?DisconnectFromDisplayAdapters@ADAPTER_RENDER@@QEAAXPEAVDXGADAPTER@@_N@Z @ 0x1C0211A2C
 * Callers:
...
void __fastcall ADAPTER_RENDER::DisconnectFromDisplayAdapters(ADAPTER_RENDER *this, struct DXGADAPTER *a2, char a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( *(ADAPTER_RENDER **)(*((_QWORD *)a2 + 334) + 152LL) != this )
    {
  ...
  if ( (int)COREADAPTERACCESS::AcquireExclusive((__int64)v16, 1LL, 0) >= 0 )
  {
    ADAPTER_RENDER::StopDisplayDevices(v5, 2LL, a2);
    ADAPTER_RENDER::StopDisplayDevices(v5, 1LL, a2);
    if ( a2 )
      *(_BYTE *)(*((_QWORD *)a2 + 334) + 248LL) = 1;
  }
  if ( a3 )
  {
    v9 = (ADAPTER_DISPLAY *)*((_QWORD *)a2 + 334);
    ...
    if ( i < *(_DWORD *)(*((_QWORD *)a2 + 334) + 80LL) )
    {
      Context[0] = 0LL;
      DXGADAPTER::IsAdapterSessionized(a2, v8, 0LL, (unsigned __int64 *)Context);
      v12 = Context[0];
      if ( Context[0] == (PVOID)0x200000000LL )
        v12 = (PVOID)*(unsigned int *)(*((_QWORD *)DXGGLOBAL::GetGlobal(0x200000000LL, v11) + 88) + 128LL);
      v13 = -1;
