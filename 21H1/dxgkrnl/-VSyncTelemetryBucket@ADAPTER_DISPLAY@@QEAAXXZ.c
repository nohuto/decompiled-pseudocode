/*
 * XREFs of ?VSyncTelemetryBucket@ADAPTER_DISPLAY@@QEAAXXZ @ 0x1C00392F4
 * Callers:
 *     ?VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z @ 0x1C0039640 (-VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall ADAPTER_DISPLAY::VSyncTelemetryBucket(ADAPTER_DISPLAY *this)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(*((_QWORD *)this + 2) + 3936LL), &LockHandle);
...
LABEL_14:
  if ( v3 )
  {
    if ( (*((_DWORD *)this + 216) || *((_DWORD *)this + 215))
      && (unsigned int)dword_1C00AEA20 > 4
      && tlgKeywordOn((__int64)&dword_1C00AEA20, 0x400000002000LL)
      && v10 > 5
      && tlgKeywordOn((__int64)&dword_1C00AEA20, v9) )
    {
      v14 = *((_QWORD *)this + 114);
      if ( v14 )
      {
