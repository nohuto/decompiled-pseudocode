/*
 * XREFs of ?CombineRectList@DXGPRESENT@@QEAAJPEBU_D3DKMT_PRESENT@@QEAUHDC__@@PEBVDXGDEVICE@@II@Z @ 0x1C015BD00
 * Callers:
 ...
 *     ?XformRect@DXGPRESENT@@SAXPEBUtagRECT@@0PEAU2@0II@Z @ 0x1C027E480 (-XformRect@DXGPRESENT@@SAXPEBUtagRECT@@0PEAU2@0II@Z.c)
 */
...
LABEL_30:
    ...
    {
      v36 = *((_QWORD *)v116 + 5);
      v102 = *(struct tagRECT *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v116 + 231) + 2672LL) + 112LL)
...
LABEL_75:
                ...
                else
                {
                  ...
                  if ( this[4].top )
                  {
                    ...
                    {
                      v86 = *((_QWORD *)v85 + 231);
                      if ( !v86 || !*(_QWORD *)(v86 + 2672) )
                      {
                        v87 = WdLogNewEntry5_WdAssertion(v65, v64);
                        *(_QWORD *)(v87 + 24) = 11041LL;
