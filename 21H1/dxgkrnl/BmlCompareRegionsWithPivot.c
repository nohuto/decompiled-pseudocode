/*
 * XREFs of BmlCompareRegionsWithPivot @ 0x1C00E5B8C
 * Callers:
 ...
 *     BmlCompareSourceModesWithConstraint @ 0x1C00E5540 (BmlCompareSourceModesWithConstraint.c)
 *     BmlGetRecommendedContentSizeForPath @ 0x1C02E74B8 (BmlGetRecommendedContentSizeForPath.c)
 * Callees:
 *     ??$DIFF@H@@YAHHH@Z @ 0x1C0008D58 (--$DIFF@H@@YAHHH@Z.c)
 *     ?BmlGetScaledAspectRatio@@YAHAEBU_D3DKMDT_2DREGION@@@Z @ 0x1C00E5C64 (-BmlGetScaledAspectRatio@@YAHAEBU_D3DKMDT_2DREGION@@@Z.c)
 *     ??$BmlCompareValues@H@@YA?AW4BML_COMPARISON_RESULT@@HH@Z @ 0x1C0159C9C (--$BmlCompareValues@H@@YA-AW4BML_COMPARISON_RESULT@@HH@Z.c)
 */
