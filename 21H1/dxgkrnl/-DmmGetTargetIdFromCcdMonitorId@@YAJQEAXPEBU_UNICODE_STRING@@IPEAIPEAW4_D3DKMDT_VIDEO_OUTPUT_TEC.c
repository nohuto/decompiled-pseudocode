/*
 * XREFs of ?DmmGetTargetIdFromCcdMonitorId@@YAJQEAXPEBU_UNICODE_STRING@@IPEAIPEAW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@3PEAE4@Z @ 0x1C00E6760
 * Callers:
...
LABEL_42:
  ...
  while ( 1 )
  {
    ...
    if ( !v25 )
      goto LABEL_49;
    CCDMonitorID = MonitorGetCCDMonitorID(*((_QWORD *)NextTarget + 14), (unsigned int)v61 >> 1, Source2);
    v30 = CCDMonitorID;
    ...
    if ( RtlCompareMemory(v9->Buffer, Source2, v9->Length) == v9->Length )
    {
      if ( !v64 )
      {
        ...
        *a6 = v32;
        ...
        v37 = *(MONITOR_MGR **)(v36 + 96);
        LOBYTE(v64) = 0;
        if ( v37 )
        {
          v63 = 0LL;
          MonitorInstance = MONITOR_MGR::_GetMonitorInstance(v37, v35, 1u, &v63);
