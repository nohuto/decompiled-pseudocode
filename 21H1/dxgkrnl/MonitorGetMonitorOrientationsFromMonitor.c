/*
 * XREFs of MonitorGetMonitorOrientationsFromMonitor @ 0x1C00F02EC
 * Callers:
 ...
 *     ?_GetMonitorOrientation@DXGMONITOR@@QEBAJPEAK0@Z @ 0x1C0009FF0 (-_GetMonitorOrientation@DXGMONITOR@@QEBAJPEAK0@Z.c)
 */
