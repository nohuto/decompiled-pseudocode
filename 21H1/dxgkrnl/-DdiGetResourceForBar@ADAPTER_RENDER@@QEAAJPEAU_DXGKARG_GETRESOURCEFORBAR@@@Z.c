/*
 * XREFs of ?DdiGetResourceForBar@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1C022ECC0
 * Callers:
 *     ?GetResourceForBar@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1C0233090 (-GetResourceForBar@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z.c)
 * Callees:
