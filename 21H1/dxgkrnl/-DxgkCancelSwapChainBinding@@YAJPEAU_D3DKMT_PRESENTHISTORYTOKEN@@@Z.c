/*
 * XREFs of ?DxgkCancelSwapChainBinding@@YAJPEAU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x1C0063108
 * Callers:
...
__int64 __fastcall DxgkCancelSwapChainBinding(struct _D3DKMT_PRESENTHISTORYTOKEN *a1, __int64 a2)
{
  ...
  if ( (*(unsigned int (**)(void))(*((_QWORD *)v7 + 38033) + 240LL))()
    || !(unsigned int)IsTokenManagerReady()
    || (v10 = DXGGLOBAL::GetGlobal(v9, v8), !(*(unsigned int (**)(void))(*((_QWORD *)v10 + 38033) + 224LL))()) )
  {
    v3 = -1071775730;
  }
  v11 = DXGGLOBAL::GetGlobal(v9, v8);
  (*(void (**)(void))(*((_QWORD *)v11 + 38033) + 256LL))();
  if ( v3 >= 0 )
  {
    v14 = DXGGLOBAL::GetGlobal(v13, v12);
    (*(void (**)(void))(*((_QWORD *)v14 + 38033) + 144LL))();
    v17 = DXGGLOBAL::GetGlobal(v16, v15);
    v18 = (struct _KPROCESS *)(*(__int64 (**)(void))(*((_QWORD *)v17 + 38033) + 272LL))();
    v21 = v18;
    if ( v18 )
    {
      ...
      if ( a1->Model == D3DKMT_PM_REDIRECTED_COMPOSITION )
      {
        ...
        if ( FenceValue )
        {
          ...
          if ( v3 >= 0 )
          {
            ...
            (*(void (__fastcall **)(__int64, __int64))(*((_QWORD *)v27 + 38033) + 32LL))(v26, 1LL);
      ...
      (*(void (__fastcall **)(struct _KPROCESS *))(*((_QWORD *)v31 + 38033) + 200LL))(v21);
    }
    v32 = DXGGLOBAL::GetGlobal(v20, v19);
    (*(void (**)(void))(*((_QWORD *)v32 + 38033) + 184LL))();
  }
