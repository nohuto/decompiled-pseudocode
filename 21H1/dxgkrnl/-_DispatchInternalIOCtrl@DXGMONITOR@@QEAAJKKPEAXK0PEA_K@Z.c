/*
 * XREFs of ?_DispatchInternalIOCtrl@DXGMONITOR@@QEAAJKKPEAXK0PEA_K@Z @ 0x1C01548F8
 * Callers:
 ...
 *     ?TriggerMonitorColorimetryChangedWnf@DXGMONITOR@@QEAAJXZ @ 0x1C02F433C (-TriggerMonitorColorimetryChangedWnf@DXGMONITOR@@QEAAJXZ.c)
 */
