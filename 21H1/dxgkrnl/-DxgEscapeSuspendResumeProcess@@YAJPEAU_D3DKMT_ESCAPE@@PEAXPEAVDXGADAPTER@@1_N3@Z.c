/*
 * XREFs of ?DxgEscapeSuspendResumeProcess@@YAJPEAU_D3DKMT_ESCAPE@@PEAXPEAVDXGADAPTER@@1_N3@Z @ 0x1C0263198
 * Callers:
        ...
        bool a6)
{
  ...
  if ( a4 )
  {
    ...
    Process = DXGPROCESSMUTEXBYHANDLE::GetProcess((DXGPROCESSMUTEXBYHANDLE *)v24, v12);
  }
  else
  {
  ...
  if ( v19 )
  {
    if ( *((_BYTE *)a3 + 209) )
    {
      ...
      LODWORD(v6) = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendEscape(
                      (struct DXGADAPTER *)((char *)a3 + 4208),
                      HostProcess,
                      v20,
                      0,
                      0,
