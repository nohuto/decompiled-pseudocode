/*
 * XREFs of ?HandleMonitorArrival@@YAJPEAUMONITORSCOUNT_CALLBACK_CONTEXT@@AEBU_LUID@@IW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C029187C
 * Callers:
 ...
 *     ?GetPathsCount@CCD_TOPOLOGY@@QEBAGXZ @ 0x1C0009A6C (-GetPathsCount@CCD_TOPOLOGY@@QEBAGXZ.c)
 ...
 *     ?DetermineDefaultTopology@@YA?AW4MultiScreenDefaultShellTopology@@IE@Z @ 0x1C0290D78 (-DetermineDefaultTopology@@YA-AW4MultiScreenDefaultShellTopology@@IE@Z.c)
 *     ?DxgkIsPortraitFirstTarget@@YAEU_LUID@@I@Z @ 0x1C0291448 (-DxgkIsPortraitFirstTarget@@YAEU_LUID@@I@Z.c)
 *     ?GetLaptopSpecialCaseFlags@@YAIAEBVCCD_TOPOLOGY@@AEBU_LUID@@IW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@AEBUMONITORSCOUNT_CALLBACK_CONTEXT@@@Z @ 0x1C0291648 (-GetLaptopSpecialCaseFlags@@YAIAEBVCCD_TOPOLOGY@@AEBU_LUID@@IW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@.c)
 ...
 *     ?IsValidCloneConfiguration@@YAEPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0292C34 (-IsValidCloneConfiguration@@YAEPEAUD3DKMT_GETPATHSMODALITY@@@Z.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a6)
{
  ...
  _BYTE v181[64]; // [rsp+88h] [rbp-80h] BYREF
  __int64 v182; // [rsp+C8h] [rbp-40h]
  int v183; // [rsp+D4h] [rbp-34h]
  int v184; // [rsp+D8h] [rbp-30h]
  _BYTE v185[96]; // [rsp+E8h] [rbp-20h] BYREF
  _BYTE v186[64]; // [rsp+148h] [rbp+40h] BYREF
  struct D3DKMT_GETPATHSMODALITY *v187; // [rsp+188h] [rbp+80h]
...
LABEL_17:
  ...
  v30 = *((_DWORD *)DXGGLOBAL::GetGlobal(v23, v22) + 412);
  if ( v30 > 1 )
  {
    v32 = WdLogNewEntry5_WdWarning(v29, 1LL, v31);
    *(_QWORD *)(v32 + 24) = 3514LL;
  ...
  if ( v177[1] == D3DKMDT_VOT_MIRACAST )
  {
    ...
    if ( !v47 )
    {
      ...
      *(_QWORD *)(v52 + 24) = 3642LL;
      WdLogEvent5_WdError(v52);
      LODWORD(v46) = -1073741823;
    }
    v42 = LaptopSpecialCaseFlags;
  }
  if ( !IsValidCloneConfiguration(v187) )
  {
    v57 = WdLogNewEntry5_WdError(v54, v53);
    *(_QWORD *)(v57 + 24) = 3652LL;
...
LABEL_50:
  ...
  {
    v58 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v186, 0LL, v55, v56);
    v46 = v58;
    if ( v58 >= 0 )
    {
      v62 = v178;
    ...
    *(_BYTE *)(a1 + 31) = 1;
    ...
    if ( v68 < 0 )
    {
      ...
      *(_QWORD *)(v72 + 24) = v71;
      ...
      v75 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v181, 0LL, v73, v74);
      v78 = v75;
      if ( v75 < 0 )
      {
    ...
    if ( v179[1] == 16 )
    {
      ...
      *(_QWORD *)(v100 + 32) = 16LL;
      ...
      v104 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v185, 0LL, v102, v103);
      v107 = v104;
      if ( v104 < 0 )
      {
...
LABEL_103:
    ...
    if ( (unsigned __int16)CCD_TOPOLOGY::Reserve((CCD_TOPOLOGY *)v181, v114, v96, v97) < v114 )
    {
      ...
      *(_QWORD *)(v119 + 24) = v114;
      ...
      v122 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v185, 0LL, v120, v121);
      v78 = v122;
      if ( v122 < 0 )
      {
    ...
    *(_QWORD *)v136 = 0x8F00000000000LL;
    ...
    if ( v143 >= 0 )
    {
      v155 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v181, 1LL, v146, v147);
      v158 = v155;
      if ( v155 == -1073741266 )
      {
        v82 = 0;
      ...
      else
      {
        ...
        *(_QWORD *)(v159 + 32) = v182;
        ...
        v162 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v185, 0LL, v160, v161);
        v165 = v162;
        if ( v162 < 0 )
        {
    ...
    *(_QWORD *)(v148 + 32) = v182;
    ...
    v151 = CCD_TOPOLOGY::Persist((CCD_TOPOLOGY *)v185, 0LL, v149, v150);
    v78 = v151;
    if ( v151 < 0 )
    {
