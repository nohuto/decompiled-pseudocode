/*
 * XREFs of ?ProcessVSyncPhaseTimer@DXGADAPTER@@QEAAXI@Z @ 0x1C011E7E8
 * Callers:
...
void __fastcall DXGADAPTER::ProcessVSyncPhaseTimer(DXGADAPTER *this, unsigned int a2)
{
  ...
  v2 = (char *)this + 3904;
  v3 = a2;
  DXGPUSHLOCK::AcquireExclusive((DXGADAPTER *)((char *)this + 3904));
  v5 = (_DWORD *)*((_QWORD *)this + 482);
  v6 = *((_DWORD *)this + 636) & 0x10;
