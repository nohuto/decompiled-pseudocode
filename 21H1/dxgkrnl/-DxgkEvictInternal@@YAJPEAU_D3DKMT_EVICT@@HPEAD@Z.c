/*
 * XREFs of ?DxgkEvictInternal@@YAJPEAU_D3DKMT_EVICT@@HPEAD@Z @ 0x1C0144A1C
 * Callers:
 *     ?DxgkCddEvict@@YAJIEPEAU_D3DKMT_EVICT@@PEAD@Z @ 0x1C0143F30 (-DxgkCddEvict@@YAJIEPEAU_D3DKMT_EVICT@@PEAD@Z.c)
 *     DxgkEvict @ 0x1C0144A00 (DxgkEvict.c)
...
LABEL_64:
  ...
  v78 = v79;
  v80 = 16;
  v13 = (struct _EX_RUNDOWN_REF **)v79;
  v63 = 0LL;
    ...
    *(_QWORD *)v67 = v33;
    if ( v54 )
    {
      ...
      DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendEvict(
        (DXG_GUEST_VIRTUALGPU_VMBUS *)(v51 + 4208),
        HostProcess,
        v52,
        v69[4],
        v67[0],
