/*
 * XREFs of ??1CFlipConsumerMessage@@MEAA@XZ @ 0x1C00662D4
 * Callers:
 *     ??_ECFlipConsumerMessage@@MEAAPEAXI@Z @ 0x1C0066330 (--_ECFlipConsumerMessage@@MEAAPEAXI@Z.c)
 * Callees:
 *     ??1CFlipPropertySetBase@@MEAA@XZ @ 0x1C0069EDC (--1CFlipPropertySetBase@@MEAA@XZ.c)
 */
