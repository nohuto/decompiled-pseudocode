/*
 * XREFs of ?VmBusIsSyncObjectSignaled@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023E420
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusIsSyncObjectSignaled(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  DXGPUSHLOCK *v34[2]; // [rsp+58h] [rbp-B0h] BYREF
  int v35; // [rsp+68h] [rbp-A0h]
  _BYTE v36[144]; // [rsp+78h] [rbp-90h] BYREF

  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v34, (struct _KTHREAD **)(*((_QWORD *)a1 + 5) + 232LL), 0);
  DXGPUSHLOCK::AcquireShared(v34[1]);
  v4 = *((_QWORD *)a1 + 5);
  v5 = 0;
  v35 = 1;
  if ( *(_BYTE *)(v4 + 165) )
  {
    ...
    COREADAPTERACCESS::COREADAPTERACCESS((COREADAPTERACCESS *)v36, (struct DXGADAPTER *const)v31, 0LL);
    LODWORD(v30) = COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v36, 0LL);
    if ( (int)v30 < 0 )
    {
LABEL_21:
    ...
    DXGSYNCOBJECTLOCK::DXGSYNCOBJECTLOCK((DXGSYNCOBJECTLOCK *)v33, Global, 0);
    DXGSYNCOBJECTLOCK::AcquireShared((DXGSYNCOBJECTLOCK *)v33, v11);
    v12 = *((_QWORD *)a1 + 6);
    v13 = *(_DWORD *)(v7 + 24);
...
LABEL_12:
    ...
    if ( v19 )
    {
      DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v32, (struct DXGFASTMUTEX *const)(v19 + 32), 0);
      DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v32);
      VidSchSyncObject = DXGSYNCOBJECT::GetVidSchSyncObject((DXGSYNCOBJECT *)v19, v31[335]);
      v26 = (*(__int64 (__fastcall **)(struct _VIDSCH_SYNC_OBJECT *))(*(_QWORD *)(v25 + 8) + 872LL))(VidSchSyncObject);
      v27 = v30;
      v23 = 3223191812LL;
      if ( !v26 )
        v27 = -1071775484;
      LODWORD(v30) = v27;
      if ( v32[8] )
        DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v32, 3223191812LL);
    }
    else
    {
    ...
    if ( v33[8] )
      DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)v33, v23);
    goto LABEL_21;
  }
