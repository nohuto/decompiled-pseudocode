/*
 * XREFs of ?WriteDxgDiagnosticsEvent_COMMIT_VIDPN_FAILED@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0043EBC
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_COMMIT_VIDPN_FAILED(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C00AEA20, 0x200000000100LL) && tlgKeywordOn((__int64)&dword_1C00AEA20, v2) )
    {
      v13 = *((_WORD *)a1 + 2);
      v12 = a1;
      v14 = 5;
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperBinary>(
        ...
        (__int64)&v14,
        (__int64 *)&v12);
      LODWORD(v3) = dword_1C00AEA20;
    }
    if ( (unsigned int)v3 > 4 && tlgKeywordOn((__int64)&dword_1C00AEA20, 0x400000000100LL) )
    {
      if ( tlgKeywordOn((__int64)&dword_1C00AEA20, v6) )
      {
        v14 = *((_DWORD *)a1 + 18);
        v15 = *((_DWORD *)a1 + 12);
        v16 = *((_DWORD *)a1 + 19);
