/*
 * XREFs of ?IsHDRSourceModeAvailableForPinnedSourceMode@@YA_NPEBVDXGADAPTER@@PEBVDMMVIDPNSOURCEMODESET@@@Z @ 0x1C02E7C78
 * Callers:
        ...
        const struct DMMVIDPNSOURCEMODESET *a2)
{
  ...
  {
    v2 = (*((_DWORD *)a1 + 638) & 4) != 0;
    v3 = (*((_DWORD *)a1 + 638) & 8) != 0;
  }
  v5 = *((_QWORD *)a2 + 18);
  if ( !v5 )
    return 0;
