/*
 * XREFs of ?GetShadowBufferDirtyRect@@YAEPEAUtagRECT@@II@Z @ 0x1C0022A8C
 * Callers:
...
bool __fastcall GetShadowBufferDirtyRect(struct tagRECT *a1, __int64 a2, unsigned int a3)
{
  ...
  v4 = a2;
  if ( *((struct _KTHREAD **)DXGGLOBAL::GetGlobal((__int64)a1, a2) + 176) != KeGetCurrentThread() )
  {
    v16 = WdLogNewEntry5_WdAssertion(v7, v6);
    *(_QWORD *)(v16 + 24) = 4642LL;
    WdLogEvent5_WdAssertion(v16);
  }
  v8 = 0;
  v9 = *((_QWORD *)DXGGLOBAL::GetGlobal(v7, v6) + 173);
  if ( !v9 )
    return 0;
