/*
 * XREFs of ?SerializeFunctionalPathDrivingTarget@DMMVIDPN@@QEBAJIQEAU_D3DKMDT_FUNCTIONAL_VIDPN_PRESENT_PATH@@@Z @ 0x1C013DEAC
 * Callers:
        ...
        struct _D3DKMDT_VIDPN_PRESENT_PATH *a3)
{
  ...
  {
    v21 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v8);
    v21[3] = v3;
    v22 = *((_QWORD *)this + 6);
    v23 = *(_QWORD *)(v22 + 8);
    if ( !v23 )
