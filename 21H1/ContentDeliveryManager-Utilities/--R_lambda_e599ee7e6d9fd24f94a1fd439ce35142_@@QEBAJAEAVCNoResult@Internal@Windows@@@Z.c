/*
 * XREFs of ??R_lambda_e599ee7e6d9fd24f94a1fd439ce35142_@@QEBAJAEAVCNoResult@Internal@Windows@@@Z @ 0x18000ECB8
 * Callers:
 *     ?Run@?$COperationLambdaVar@$0A@V_lambda_e599ee7e6d9fd24f94a1fd439ce35142_@@VCNoResult@Internal@Windows@@$$V@Internal@Windows@@UEAAJW4AsyncStage@23@JAEAVCNoResult@23@@Z @ 0x18001B860 (-Run@-$COperationLambdaVar@$0A@V_lambda_e599ee7e6d9fd24f94a1fd439ce35142_@@VCNoResult@Internal@W.c)
 * Callees:
...
__int64 __fastcall _lambda_e599ee7e6d9fd24f94a1fd439ce35142_::operator()(__int64 a1, void *a2)
{
