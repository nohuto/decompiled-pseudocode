        ...
        _DWORD *a2)
{
  ...
  *a2 = 0;
  ...
  if ( v3 >= 0 )
  {
    v5 = (*(__int64 (__fastcall **)(_QWORD, _DWORD *))(*(_QWORD *)v4 + 56LL))(*(_QWORD *)(a1 + 72), a2);
    v3 = v5;
