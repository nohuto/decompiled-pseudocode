/*
 * XREFs of ?_Getffldx@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x180037488
 * Callers:
        ...
        int *a6)
{
  ...
  v11 = std::use_facet<std::numpunct<unsigned short>>(&v60);
  v60 = v11;
  v12 = 0;
  if ( v9 )
  {
  ...
  v15 = std::use_facet<std::ctype<unsigned short>>(&v59);
  if ( v14 )
  {
