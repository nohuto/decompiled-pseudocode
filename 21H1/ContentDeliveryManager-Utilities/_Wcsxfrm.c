/*
 * XREFs of _Wcsxfrm @ 0x1800CA8F8
 * Callers:
 *     ?do_transform@?$collate@_W@std@@MEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@PEB_W0@Z @ 0x1800C43C0 (-do_transform@-$collate@_W@std@@MEBA-AV-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B755C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B7568 (_GetLocaleHandleById.c)
 *     __crtLCMapStringW_Stub @ 0x1800B7640 (__crtLCMapStringW_Stub.c)
