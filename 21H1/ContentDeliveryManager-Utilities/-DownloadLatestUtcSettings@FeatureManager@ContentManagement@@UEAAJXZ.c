/*
 * XREFs of ?DownloadLatestUtcSettings@FeatureManager@ContentManagement@@UEAAJXZ @ 0x1800103B0
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180005D48 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ??$make_shared@VUtcApiWrapper@Diagnostics@Microsoft@@@std@@YA?AV?$shared_ptr@VUtcApiWrapper@Diagnostics@Microsoft@@@0@XZ @ 0x1800185C0 (--$make_shared@VUtcApiWrapper@Diagnostics@Microsoft@@@std@@YA-AV-$shared_ptr@VUtcApiWrapper@Diag.c)
 *     ?DownloadLatestSettingsForNamespaceAsync@UtcApiWrapper@Diagnostics@Microsoft@@QEAAJPEBG0HHH@Z @ 0x1800A88C8 (-DownloadLatestSettingsForNamespaceAsync@UtcApiWrapper@Diagnostics@Microsoft@@QEAAJPEBG0HHH@Z.c)
