/*
 * XREFs of ?ReusingExistingExtendedExecution@CDMUtilsUnlockTelemetry@@SAXXZ @ 0x18007DB50
 * Callers:
...
void CDMUtilsUnlockTelemetry::ReusingExistingExtendedExecution(void)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer((__int64)v0, (unsigned __int8 *)dword_180173E54, 0LL, 0LL, 2u, &v1);
  }
}
