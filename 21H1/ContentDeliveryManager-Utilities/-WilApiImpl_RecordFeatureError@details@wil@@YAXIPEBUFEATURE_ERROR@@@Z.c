/*
 * XREFs of ?WilApiImpl_RecordFeatureError@details@wil@@YAXIPEBUFEATURE_ERROR@@@Z @ 0x18000C1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct FEATURE_ERROR *a3)
{
  ...
  if ( wil::details::g_featureStateManager )
  {
    ...
    if ( wil::details::FeatureStateManager::EnsureStateData((RTL_SRWLOCK *)&wil::details::g_featureStateManager)
      && wil::details_abi::FeatureStateData::RecordFeatureError(qword_180192480, v4, a2)
