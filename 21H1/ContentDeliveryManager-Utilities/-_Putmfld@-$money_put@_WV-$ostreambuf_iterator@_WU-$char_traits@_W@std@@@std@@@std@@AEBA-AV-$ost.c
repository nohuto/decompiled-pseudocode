/*
 * XREFs of ?_Putmfld@?$money_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@_NAEAVios_base@2@_W1V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@3@Z @ 0x1800C0330
 * Callers:
        ...
        unsigned __int16 a9)
{
  ...
  {
    v13(v12);
    v14 = std::use_facet<std::moneypunct<wchar_t,1>>(&v63);
  }
  else
  {
    v13(v12);
    v14 = std::use_facet<std::moneypunct<wchar_t,0>>(&v63);
  }
  if ( v12 )
  {
