/*
 * XREFs of ?StartActivity@CreativeEventActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEBG0I@Z @ 0x180028B08
 * Callers:
        ...
        int a4)
{
  ...
  *(_DWORD *)v8 = 1;
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
    ...
    v26 = 4LL;
    v24 = 8LL;
    tlgWriteTransfer_EventWriteTransfer((__int64)v10, (unsigned __int8 *)dword_18017037F, v14, v13, 7u, &v22);
  }
  if ( !*((_DWORD *)this + 8) )
