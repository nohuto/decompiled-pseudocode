/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@wil@@SA_NXZ @ 0x180031120
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800366C8 (-GetCachedFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampa.c)
 */
