/*
 * XREFs of ?RemoveRule@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@UEAAXAEBV?$shared_ptr@VCreativeRule@RuleSetHandlers@CreativeFramework@@@std@@@Z @ 0x18007AD80
 * Callers:
 ...
 *     ??_9IStorageFolder@Storage@Windows@@$BFA@AA @ 0x18007C1F4 (--_9IStorageFolder@Storage@Windows@@$BFA@AA.c)
