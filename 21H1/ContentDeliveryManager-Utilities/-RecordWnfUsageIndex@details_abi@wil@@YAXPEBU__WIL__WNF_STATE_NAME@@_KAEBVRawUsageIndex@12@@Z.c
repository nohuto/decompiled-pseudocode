/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x18000AA18
 * Callers:
 *     ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x18000AEE4 (-Record@UsageIndexes@details_abi@wil@@QEAAXXZ.c)
 * Callees:
 *     ?NtStatusToHr@details@wil@@YAJJ@Z @ 0x1800048DC (-NtStatusToHr@details@wil@@YAJJ@Z.c)
 ...
 *     ?wil_details_NtQueryWnfStateData@@YAJPEBU__WIL__WNF_STATE_NAME@@PEBU__WIL__WNF_TYPE_ID@@PEBXPEAKPEAX3@Z @ 0x1800081DC (-wil_details_NtQueryWnfStateData@@YAJPEBU__WIL__WNF_STATE_NAME@@PEBU__WIL__WNF_TYPE_ID@@PEBXPEAK.c)
 *     ?wil_details_NtUpdateWnfStateData@@YAJPEBU__WIL__WNF_STATE_NAME@@PEBXKPEBU__WIL__WNF_TYPE_ID@@1KK@Z @ 0x180008284 (-wil_details_NtUpdateWnfStateData@@YAJPEBU__WIL__WNF_STATE_NAME@@PEBXKPEBU__WIL__WNF_TYPE_ID@@1K.c)
 *     ?Read@UsageIndexProperty@details_abi@wil@@QEAA_NAEAPEAEPEAE@Z @ 0x180009C04 (-Read@UsageIndexProperty@details_abi@wil@@QEAA_NAEAPEAEPEAE@Z.c)
 ...
 *     _alloca_probe @ 0x1800CC4A0 (_alloca_probe.c)
 */
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  char v59; // [rsp+140h] [rbp+40h] BYREF
  void **v60; // [rsp+148h] [rbp+48h] BYREF
  __int128 v61; // [rsp+150h] [rbp+50h]
  _WORD *v62; // [rsp+160h] [rbp+60h]
  wil::details::in1diag3 *v63; // [rsp+1B0h] [rbp+B0h]
  _WORD v64[2048]; // [rsp+1C0h] [rbp+C0h] BYREF
  ...
  while ( 1 )
  {
    ...
    v38 = 0;
    v26 = 4096;
    v11 = (wil::details *)(unsigned int)wil_details_NtQueryWnfStateData(v5, a2, a3, &v27, v64, &v26);
    ...
    wil::details_abi::RawUsageIndex::SetBuffer((wil::details_abi::RawUsageIndex *)v29, v64, v12, (const char *)0x1000);
    if ( HIBYTE(v37) )
      break;
    v39 = 0LL;
    *(_QWORD *)&v55 = &v39;
    *((_QWORD *)&v55 + 1) = &v40;
    v56 = v29;
    v60 = &wistd::__function::__func<_lambda_8db0ce862824541f40dfb767113f1e28_,bool (void *,unsigned __int64,void *,unsigned __int64,unsigned int)>::`vftable';
    v61 = v55;
    v62 = v29;
    v63 = (wil::details::in1diag3 *)&v60;
    v58 = &v59;
              ...
              *((unsigned __int8 **)v4 + 4)) )
    {
      ...
      if ( v44 )
      {
                  ...
                  *((unsigned __int8 **)v4 + 4)) )
        {
          ...
          v24 = &v52;
          if ( !(*(unsigned __int8 (__fastcall **)(wil::details::in1diag3 *, __int64 *, __int64 *, __int64 *))(*(_QWORD *)v63 + 32LL))(
                  v63,
                  &v41,
                  &v54,
                  &v53) )
          {
            if ( v63 )
              (*(void (__fastcall **)(wil::details::in1diag3 *))(*(_QWORD *)v63 + 24LL))(v63);
            v17 = 0;
            goto LABEL_27;
          }
          if ( ++v16 >= v44 )
...
LABEL_27:
    if ( (_BYTE)v37 )
    {
      updated = wil_details_NtUpdateWnfStateData(v5, v34, (int)v35 - (int)v34, v15, v24, v27, 1u);
