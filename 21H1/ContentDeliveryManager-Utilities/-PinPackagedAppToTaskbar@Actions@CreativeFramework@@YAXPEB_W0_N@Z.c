/*
 * XREFs of ?PinPackagedAppToTaskbar@Actions@CreativeFramework@@YAXPEB_W0_N@Z @ 0x18008FE88
 * Callers:
 ...
 *     ?PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z @ 0x18008FCE0 (-PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z.c)
        ...
        const wchar_t *a3)
{
  ...
  std::wstring::assign((void **)v15, (char *)applicationUserModelId, v7);
  v12 = v15;
  if ( v16 >= 8 )
