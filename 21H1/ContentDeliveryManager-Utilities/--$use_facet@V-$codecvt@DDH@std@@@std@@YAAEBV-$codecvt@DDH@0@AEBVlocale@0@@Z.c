/*
 * XREFs of ??$use_facet@V?$codecvt@DDH@std@@@std@@YAAEBV?$codecvt@DDH@0@AEBVlocale@0@@Z @ 0x1800AFCAC
 * Callers:
 ...
 *     ?_Getcat@?$codecvt@DDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B09C4 (-_Getcat@-$codecvt@DDH@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
