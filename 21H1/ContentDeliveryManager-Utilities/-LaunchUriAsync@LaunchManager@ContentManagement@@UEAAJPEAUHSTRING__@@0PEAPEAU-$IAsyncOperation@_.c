/*
 * XREFs of ?LaunchUriAsync@LaunchManager@ContentManagement@@UEAAJPEAUHSTRING__@@0PEAPEAU?$IAsyncOperation@_N@Foundation@Windows@@@Z @ 0x18000F5B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 ContentManagement::LaunchManager::LaunchUriAsync(__int64 a1, ...)
{
  ...
  *(_QWORD *)v13 = ThreadLocalDataCache;
  ...
  v10 = _lambda_f49d986c83b05ce1e8811b336d8586e4_::operator()(v16);
  v11 = v10;
  if ( v10 < 0 )
