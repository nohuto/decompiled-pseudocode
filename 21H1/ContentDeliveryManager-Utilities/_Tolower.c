/*
 * XREFs of _Tolower @ 0x1800AF520
 * Callers:
 *     ?do_tolower@?$ctype@D@std@@MEBADD@Z @ 0x1800B51B0 (-do_tolower@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_tolower@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x1800B51D0 (-do_tolower@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
