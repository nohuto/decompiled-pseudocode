/*
 * XREFs of ??_G?$basic_istream@_WU?$char_traits@_W@std@@@std@@UEAAPEAXI@Z @ 0x180033290
 * Callers:
 *     ??_E?$basic_istream@_WU?$char_traits@_W@std@@@std@@$4PPPPPPPM@A@EAAPEAXI@Z @ 0x180040270 (--_E-$basic_istream@_WU-$char_traits@_W@std@@@std@@$4PPPPPPPM@A@EAAPEAXI@Z.c)
 * Callees:
