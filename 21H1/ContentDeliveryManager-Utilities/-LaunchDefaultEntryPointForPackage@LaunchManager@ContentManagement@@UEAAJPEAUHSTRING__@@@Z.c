/*
 * XREFs of ?LaunchDefaultEntryPointForPackage@LaunchManager@ContentManagement@@UEAAJPEAUHSTRING__@@@Z @ 0x18000FD60
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)v13 = ThreadLocalDataCache;
  ...
  v10 = _lambda_ad73a00dcfa6409fa821294ba8f7c356_::operator()(&v22);
  v11 = v10;
  if ( v10 < 0 )
