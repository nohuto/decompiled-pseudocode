/*
 * XREFs of ??$TaskUnregistered@PEB_WAEAY0CH@_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEB_WAEAY0CH@_WPEBD@Z @ 0x1800AC910
 * Callers:
 *     CreativeFramework::CommonHelper::EnumerateRegisteredTasks__lambda_54f09f28fe32d0f01534b02300ec8cff___ @ 0x1800ACA44 (CreativeFramework--CommonHelper--EnumerateRegisteredTasks__lambda_54f09f28fe32d0f01534b02300ec8c.c)
 * Callees:
        ...
        const unsigned __int16 *a3)
{
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
    ...
    v17 = v8;
    v19 = 0;
    LODWORD(v6) = tlgWriteTransfer_EventWriteTransfer(v7, (unsigned __int8 *)dword_180174441, 0LL, 0LL, 5u, &v16);
  }
  return (int)v6;
}
