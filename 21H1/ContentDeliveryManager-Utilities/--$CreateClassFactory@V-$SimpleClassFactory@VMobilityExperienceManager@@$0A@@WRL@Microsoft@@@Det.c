/*
 * XREFs of ??$CreateClassFactory@V?$SimpleClassFactory@VMobilityExperienceManager@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x18009D380
 * Callers:
 *     <none>
 * Callees:
