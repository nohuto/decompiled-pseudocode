/*
 * XREFs of ?GetIids@IdentityManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180010700
 * Callers:
 *     ?GetIids@IdentityManager@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x1800216D0 (-GetIids@IdentityManager@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
