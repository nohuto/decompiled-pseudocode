/*
 * XREFs of ??1PinToStartProperties@Actions@CreativeFramework@@QEAA@XZ @ 0x180088C88
 * Callers:
 *     _CreativeFramework::Actions::MakeAddTileToCollectionService_::_1_::dtor$12 @ 0x1800D2EF4 (_CreativeFramework--Actions--MakeAddTileToCollectionService_--_1_--dtor$12.c)
 * Callees:
 *     <none>
 */
