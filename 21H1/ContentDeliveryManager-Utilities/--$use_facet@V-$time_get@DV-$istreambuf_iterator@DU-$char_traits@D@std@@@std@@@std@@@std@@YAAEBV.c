/*
 * XREFs of ??$use_facet@V?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAAEBV?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@AEBVlocale@0@@Z @ 0x1800C534C
 * Callers:
 ...
 *     ?_Getcat@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800C5C84 (-_Getcat@-$time_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@.c)
 *     _CxxThrowException_0 @ 0x1800CB68C (_CxxThrowException_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800CC480 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=1
struct std::_Facet_base *__fastcall std::use_facet<std::time_get<char,std::istreambuf_iterator<char>>>(__int64 *a1)
{
  __int64 v2; // rsi
  ...
  v2 = std::_Facetptr<std::time_get<char,std::istreambuf_iterator<char>>>::_Psave;
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::time_get<char,std::istreambuf_iterator<char>>>::_Psave;
  v3 = std::time_get<char,std::istreambuf_iterator<char>>::id;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::time_get<char,std::istreambuf_iterator<char>>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::time_get<char,std::istreambuf_iterator<char>>>::_Psave = (__int64)v11;
