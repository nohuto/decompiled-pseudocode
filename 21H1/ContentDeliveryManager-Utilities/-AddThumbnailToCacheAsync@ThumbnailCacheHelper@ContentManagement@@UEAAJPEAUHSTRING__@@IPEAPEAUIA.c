        ...
        struct Windows::Foundation::IAsyncAction **a4)
{
  ...
  *a4 = 0LL;
  ...
  else
  {
    ...
    LOBYTE(v16) = 1;
    v19 = a3;
    v9 = Windows::Internal::MakeAsyncAction<Microsoft::WRL::AsyncCausalityOptions<&unsigned short const near * const ContentManagement::AddThumbnailToCacheAsyncActionName,&_GUID const GUID_CAUSALITY_WINDOWS_PLATFORM_ID,2>,Windows::Internal::ComTaskPoolHandler,_lambda_e599ee7e6d9fd24f94a1fd439ce35142_>(
           &v14,
           a4,
           v11,
           &string,
