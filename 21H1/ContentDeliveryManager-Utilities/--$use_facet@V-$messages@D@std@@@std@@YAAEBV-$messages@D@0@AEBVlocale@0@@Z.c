/*
 * XREFs of ??$use_facet@V?$messages@D@std@@@std@@YAAEBV?$messages@D@0@AEBVlocale@0@@Z @ 0x1800C4D0C
 * Callers:
 ...
 *     ?_Getcat@?$messages@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800C585C (-_Getcat@-$messages@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 *     _CxxThrowException_0 @ 0x1800CB68C (_CxxThrowException_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800CC480 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=1
struct std::_Facet_base *__fastcall std::use_facet<std::messages<char>>(__int64 *a1)
{
  __int64 v2; // rsi
  ...
  v2 = std::_Facetptr<std::messages<char>>::_Psave;
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::messages<char>>::_Psave;
  v3 = std::messages<char>::id;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::messages<char>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::messages<char>>::_Psave = (__int64)v11;
