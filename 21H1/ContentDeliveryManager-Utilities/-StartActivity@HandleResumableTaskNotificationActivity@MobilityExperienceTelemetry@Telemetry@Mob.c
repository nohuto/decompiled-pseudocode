/*
 * XREFs of ?StartActivity@HandleResumableTaskNotificationActivity@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@QEAAXU_GUID@@PEBGPEBD@Z @ 0x1800486FC
 * Callers:
        ...
        const char *a4)
{
  ...
  *(_DWORD *)v8 = 1;
    ...
    && (*((_QWORD *)v11 + 3) & 0x400000000000LL) == *((_QWORD *)v11 + 3) )
  {
    ...
    v26 = 4LL;
    v24 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v12, (unsigned __int8 *)dword_18017179A, v16, v14, 7u, &v22);
  }
  if ( !*((_DWORD *)this + 8) )
