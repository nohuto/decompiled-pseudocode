 ...
 *     ??$make_shared@VLaunchAppByIdService@Actions@CreativeFramework@@PEB_W@std@@YA?AV?$shared_ptr@VLaunchAppByIdService@Actions@CreativeFramework@@@0@$$QEAPEB_W@Z @ 0x18008C8E0 (--$make_shared@VLaunchAppByIdService@Actions@CreativeFramework@@PEB_W@std@@YA-AV-$shared_ptr@VLa.c)
...
_QWORD *__fastcall CreativeFramework::Actions::MakeLaunchAppByIdService(_QWORD *a1, __int64 a2, _QWORD *a3)
{
  ...
  v8[1] = -2LL;
  v8[0] = a1;
  v4 = (_QWORD *)CreativeFramework::Actions::GetRequiredParameter<std::wstring>(
                   (__int64)v11,
                   a3,
