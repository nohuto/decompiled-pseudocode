/*
 * XREFs of ?Provider@TaskbarLogging@@SAQEBU_tlgProvider_t@@XZ @ 0x18000DDA4
 * Callers:
...
const struct _tlgProvider_t *TaskbarLogging::Provider(void)
{
  ...
  {
    Context = qword_180194310;
    qword_180194310[0] = &CreativeFramework::Logging::ShellPlacementLogging::`vftable';
    qword_180194328 = (struct _tlgProvider_t *)&`TaskbarLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(_lambda_fb11ae61ca52cbbca3d237d126ab4bed_::_lambda_invoker_cdecl_);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_180194310, qword_180194328, v0);
    InitOnceComplete(&`TaskbarLogging::Instance'::`2'::wrapper, 0, qword_180194310);
  }
