/*
 * XREFs of ?GetEdgeFaviconCache@@YA?AV?$com_ptr_t@UIStorageFolder@Storage@Windows@@Uerr_exception_policy@wil@@@wil@@XZ @ 0x1800985A0
 * Callers:
...
_QWORD *__fastcall GetEdgeFaviconCache(_QWORD *a1, __int64 a2, void **a3)
{
  ...
  __int64 (__fastcall **v39)(); // [rsp+A0h] [rbp-68h] BYREF
  __int128 v40; // [rsp+A8h] [rbp-60h]
  __int64 (__fastcall ***v41)(); // [rsp+108h] [rbp+0h]
  HSTRING_HEADER v42; // [rsp+110h] [rbp+8h] BYREF
  HSTRING v43; // [rsp+128h] [rbp+20h] BYREF
  HSTRING_HEADER hstringHeader; // [rsp+130h] [rbp+28h] BYREF
  HSTRING string; // [rsp+148h] [rbp+40h] BYREF
