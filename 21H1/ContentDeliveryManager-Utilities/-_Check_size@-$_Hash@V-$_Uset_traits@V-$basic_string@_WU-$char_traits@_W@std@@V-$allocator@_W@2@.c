        ...
        __int64 **a1)
{
  ...
  if ( v1 < 0 )
  {
    v5 = (unsigned __int64)a1[1] & 1 | ((unsigned __int64)a1[1] >> 1);
  ...
  if ( (v3 & 0x8000000000000000uLL) != 0LL )
    v6 = (float)(int)((_DWORD)a1[6] & 1 | (v3 >> 1)) + (float)(int)((_DWORD)a1[6] & 1 | (v3 >> 1));
  else
    v6 = (float)(int)v3;
