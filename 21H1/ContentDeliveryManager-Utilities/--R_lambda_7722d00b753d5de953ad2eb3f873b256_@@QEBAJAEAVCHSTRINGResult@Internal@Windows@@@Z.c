/*
 * XREFs of ??R_lambda_7722d00b753d5de953ad2eb3f873b256_@@QEBAJAEAVCHSTRINGResult@Internal@Windows@@@Z @ 0x180010E1C
 * Callers:
 *     ?Run@?$COperationLambdaVar@$0A@V_lambda_7722d00b753d5de953ad2eb3f873b256_@@VCHSTRINGResult@Internal@Windows@@$$V@Internal@Windows@@UEAAJW4AsyncStage@23@JAEAVCHSTRINGResult@23@@Z @ 0x18001B820 (-Run@-$COperationLambdaVar@$0A@V_lambda_7722d00b753d5de953ad2eb3f873b256_@@VCHSTRINGResult@Inter.c)
 * Callees:
 ...
 *     ??$WaitForCompletion@PEAU?$IAsyncOperation@PEAVWebTokenRequestResult@Core@Web@Authentication@Security@Windows@@@Foundation@Windows@@@details@wil@@YAJPEAU?$IAsyncOperation@PEAVWebTokenRequestResult@Core@Web@Authentication@Security@Windows@@@Foundation@Windows@@W4tagCOWAIT_FLAGS@@KPEA_N@Z @ 0x18001EC18 (--$WaitForCompletion@PEAU-$IAsyncOperation@PEAVWebTokenRequestResult@Core@Web@Authentication@Sec.c)
 *     __security_check_cookie @ 0x1800CB070 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x1800CC480 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=17
__int64 __fastcall _lambda_7722d00b753d5de953ad2eb3f873b256_::operator()(__int64 a1, __int64 a2)
{
  int v4; // r14d
  HRESULT v5; // eax
...
LABEL_125:
  ...
  if ( v29 >= 0 )
  {
    ...
    v66 = 0LL;
    v32 = *(_QWORD *)(Microsoft::WRL::Wrappers::HStringReference::HStringReference(&hstringHeader, off_1800E7778) + 24);
