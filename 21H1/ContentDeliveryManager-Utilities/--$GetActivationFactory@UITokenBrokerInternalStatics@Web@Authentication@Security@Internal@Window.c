/*
 * XREFs of ??$GetActivationFactory@UITokenBrokerInternalStatics@Web@Authentication@Security@Internal@Windows@@@wil@@YA?AV?$com_ptr_t@UITokenBrokerInternalStatics@Web@Authentication@Security@Internal@Windows@@Uerr_exception_policy@wil@@@0@PEBG@Z @ 0x180019394
 * Callers:
 *     ?FindAllWebAccountsAsync@IdentityManager@ContentManagement@@UEAAJPEAPEAU?$IAsyncOperation@PEAU?$IVectorView@PEAVWebAccount@Credentials@Security@Windows@@@Collections@Foundation@Windows@@@Foundation@Windows@@@Z @ 0x180010C90 (-FindAllWebAccountsAsync@IdentityManager@ContentManagement@@UEAAJPEAPEAU-$IAsyncOperation@PEAU-$.c)
 * Callees:
