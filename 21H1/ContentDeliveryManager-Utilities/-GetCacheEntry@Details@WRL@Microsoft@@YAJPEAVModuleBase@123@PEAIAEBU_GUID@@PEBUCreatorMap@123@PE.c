/*
 * XREFs of ?GetCacheEntry@Details@WRL@Microsoft@@YAJPEAVModuleBase@123@PEAIAEBU_GUID@@PEBUCreatorMap@123@PEAPEAUIUnknown@@@Z @ 0x18002222C
 * Callers:
 *     DllGetClassObject @ 0x1800232B0 (DllGetClassObject.c)
 *     DllGetActivationFactory @ 0x1800233E0 (DllGetActivationFactory.c)
 * Callees:
