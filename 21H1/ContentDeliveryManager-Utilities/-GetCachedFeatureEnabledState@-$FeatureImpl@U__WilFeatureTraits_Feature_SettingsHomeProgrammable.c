/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SettingsHomeProgrammableMultiPromoCard@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180036990
 * Callers:
