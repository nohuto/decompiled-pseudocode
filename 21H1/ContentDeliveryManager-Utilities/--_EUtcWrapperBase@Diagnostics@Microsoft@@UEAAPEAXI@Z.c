/*
 * XREFs of ??_EUtcWrapperBase@Diagnostics@Microsoft@@UEAAPEAXI@Z @ 0x18001A620
 * Callers:
 *     <none>
 * Callees:
 *     ??1UtcWrapperBase@Diagnostics@Microsoft@@UEAA@XZ @ 0x1800A892C (--1UtcWrapperBase@Diagnostics@Microsoft@@UEAA@XZ.c)
 */
