/*
 * XREFs of ?wil_details_StagingConfig_Load@@YAJPEAUwil_details_StagingConfig@@W4wil_FeatureStore@@_KPEAXH@Z @ 0x1800088A0
 * Callers:
...
__int64 __fastcall wil_details_StagingConfig_Load(__int64 a1, int a2, __int64 a3, void *a4)
{
  ...
  *(_DWORD *)(a1 + 4) = 0;
  ...
  v15 = wil_details_NtQueryWnfStateData(
          (const struct __WIL__WNF_STATE_NAME *)&v33,
          v7,
          v8,
          (unsigned int *)(a1 + 8),
          a4,
