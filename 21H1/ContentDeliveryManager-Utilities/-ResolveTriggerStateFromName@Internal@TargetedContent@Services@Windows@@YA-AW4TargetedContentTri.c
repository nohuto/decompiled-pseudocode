/*
 * XREFs of ?ResolveTriggerStateFromName@Internal@TargetedContent@Services@Windows@@YA?AW4TargetedContentTriggerState@1234@PEB_W@Z @ 0x18007184C
 * Callers:
 ...
 *     std::_Callable_obj__lambda_d0dd6ff31bf1dd0b66c34fd287ac5fb9__0_::_ApplyX_bool_std::shared_ptr_CreativeFramework::CommonHelper::ISettingsContainer__CreativeFramework::Triggers::PropertySetHelper_&_ @ 0x180079870 (std--_Callable_obj__lambda_d0dd6ff31bf1dd0b66c34fd287ac5fb9__0_--_ApplyX_bool_std--shared_ptr_Cr.c)
 * Callees:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::ResolveTriggerStateFromName(const WCHAR *a1)
{
  ...
  v2 = (LPCWCH *)&unk_180192850;
  while ( CompareStringOrdinal(v2[1], -1, a1, -1, 1) != 2 )
  {
    v2 += 2;
    if ( v2 == (LPCWCH *)&off_180192890 )
    {
