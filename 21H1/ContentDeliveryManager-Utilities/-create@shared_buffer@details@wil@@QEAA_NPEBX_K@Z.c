/*
 * XREFs of ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x1800044F8
 * Callers:
 ...
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x180004DF0 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 * Callees:
 *     <none>
 */
