/*
 * XREFs of ?NormalizedString@Internal@TargetedContent@Services@Windows@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W00@Z @ 0x18006F020
 * Callers:
...
void **__fastcall Windows::Services::TargetedContent::Internal::NormalizedString(void **a1, char *a2)
{
  ...
  *(_WORD *)a1 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( v5 == -1 )
      break;
    v4 = (void **)std::wstring::replace(a1, v5, 1LL, L"%", asc_18010D014[0] != 0);
    if ( a1 != v4 )
