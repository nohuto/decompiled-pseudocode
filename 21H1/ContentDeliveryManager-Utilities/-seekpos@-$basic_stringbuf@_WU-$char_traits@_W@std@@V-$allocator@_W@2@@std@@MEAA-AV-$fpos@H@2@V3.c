/*
 * XREFs of ?seekpos@?$basic_stringbuf@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@MEAA?AV?$fpos@H@2@V32@H@Z @ 0x180032380
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        if ( v7 <= (*(_QWORD *)(a1 + 104) - v10) >> 1 )
        {
          ...
          **(_QWORD **)(a1 + 56) += 2LL * v11;
          if ( (a4 & 2) != 0 )
          {
            ...
            if ( *v12 )
            {
              v13 = *v12 + 2LL * **(int **)(a1 + 88);
              v14 = **(_QWORD **)(a1 + 56);
              *v12 = v14;
              **(_DWORD **)(a1 + 88) = (v13 - v14) >> 1;
            }
          }
          goto LABEL_18;
        }
