 ...
 *     ??$make_shared@VAppUninstallService@Actions@CreativeFramework@@PEB_W@std@@YA?AV?$shared_ptr@VAppUninstallService@Actions@CreativeFramework@@@0@$$QEAPEB_W@Z @ 0x180084734 (--$make_shared@VAppUninstallService@Actions@CreativeFramework@@PEB_W@std@@YA-AV-$shared_ptr@VApp.c)
