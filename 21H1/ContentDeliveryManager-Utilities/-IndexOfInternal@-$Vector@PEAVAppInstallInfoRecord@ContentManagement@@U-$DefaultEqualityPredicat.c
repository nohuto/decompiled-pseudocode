        ...
        _BYTE *a6)
{
  ...
  for ( i = 0; i < v7; ++i )
  {
    ...
    {
      v19 = 0LL;
      v9 = (*(__int64 (__fastcall **)(__int64, _QWORD, GUID *, __int64 *))(*(_QWORD *)qword_180194350 + 40LL))(
             qword_180194350,
