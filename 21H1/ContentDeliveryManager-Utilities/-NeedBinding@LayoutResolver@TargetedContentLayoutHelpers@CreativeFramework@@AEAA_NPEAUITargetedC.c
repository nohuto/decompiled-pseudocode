/*
 * XREFs of ?NeedBinding@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAA_NPEAUITargetedContentIdAliasStoreStatics@Internal@TargetedContent@Services@Windows@@V1ShellPlacementTelemetry@Logging@3@@Z @ 0x1800A1A3C
 * Callers:
...
LABEL_12:
  CreativeFramework::TargetedContentLayoutHelpers::Settings::GetLayoutType(
    ...
    *(HSTRING *)(a1 + 8),
    (LPCWSTR)&stru_1801669E8);
  CreativeFramework::TargetedContentLayoutHelpers::Settings::GetLayoutType(
    (CreativeFramework::Policy *)v50,
    *(HSTRING *)(a1 + 8),
    (LPCWSTR)&stru_180166A00);
  v46 = 7LL;
  v45 = 0LL;
  LOWORD(v44[0]) = 0;
