/*
 * XREFs of ?_Init@?$_Mpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x1800BD644
 * Callers:
 ...
 *     ?_Getcat@?$moneypunct@G$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800BB3F4 (-_Getcat@-$moneypunct@G$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 ...
 *     ??_U@YAPEAX_K@Z @ 0x1800AF9FC (--_U@YAPEAX_K@Z.c)
 *     ??$_Getvals@G@?$_Mpunct@G@std@@IEAAXGPEBUlconv@@@Z @ 0x1800B8394 (--$_Getvals@G@-$_Mpunct@G@std@@IEAAXGPEBUlconv@@@Z.c)
 *     memcpy_s_0 @ 0x1800CB355 (memcpy_s_0.c)
 */
