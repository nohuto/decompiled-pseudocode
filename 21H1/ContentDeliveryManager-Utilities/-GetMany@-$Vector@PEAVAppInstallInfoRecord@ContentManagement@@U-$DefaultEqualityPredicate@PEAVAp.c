...
LABEL_43:
      ...
      {
        *v5 = 0LL;
        v14 = (*(__int64 (__fastcall **)(__int64, _QWORD, GUID *, _QWORD *))(*(_QWORD *)qword_180194350 + 40LL))(
                qword_180194350,
