/*
 * XREFs of ??1?$_Tree@V?$_Tmap_traits@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$shared_ptr@VBaseScenarioEvents@details@Health@CreativeFramework@@@2@U?$less@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$shared_ptr@VBaseScenarioEvents@details@Health@CreativeFramework@@@2@@std@@@2@$0A@@std@@@std@@QEAA@XZ @ 0x180030BF0
 * Callers:
 *     CreativeFramework::Health::details::_dynamic_atexit_destructor_for__s_placementToBaseScenarioEventsMap__ @ 0x1800D6530 (CreativeFramework--Health--details--_dynamic_atexit_destructor_for__s_placementToBaseScenarioEve.c)
 * Callees:
