/*
 * XREFs of ?_Xbad_function_call@std@@YAXXZ @ 0x1800ADF70
 * Callers:
 ...
 * Callees:
 *     ??0bad_function_call@std@@QEAA@PEBD@Z @ 0x1800ADE20 (--0bad_function_call@std@@QEAA@PEBD@Z.c)
