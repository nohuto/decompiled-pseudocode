/*
 * XREFs of ?GetEntitlementForRecord@Actions@CreativeFramework@@YAXV?$com_ptr_t@UIAppManager@ContentManagement@@Uerr_exception_policy@wil@@@wil@@AEBQEB_W111_N@Z @ 0x1800827A8
 * Callers:
 *     ?InstallAppByStoreId@Actions@CreativeFramework@@YAXPEB_W0_N1110000@Z @ 0x180082B64 (-InstallAppByStoreId@Actions@CreativeFramework@@YAXPEB_W0_N1110000@Z.c)
 *     ?InstallAppByProductAndSku@Actions@CreativeFramework@@YAXPEB_W00_N11100@Z @ 0x180082E24 (-InstallAppByProductAndSku@Actions@CreativeFramework@@YAXPEB_W00_N11100@Z.c)
 * Callees:
 ...
 *     ?IsMsaConnected@Actions@CreativeFramework@@YA_NXZ @ 0x180082230 (-IsMsaConnected@Actions@CreativeFramework@@YA_NXZ.c)
        ...
        char a6)
{
  ...
  if ( a6 )
    goto LABEL_5;
  if ( dword_180194490 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_180194490);
    if ( dword_180194490 == -1 )
    {
      byte_180194494 = CreativeFramework::Actions::IsMsaConnected(v24);
      Init_thread_footer(&dword_180194490);
    }
  }
  if ( !byte_180194494 )
LABEL_5:
