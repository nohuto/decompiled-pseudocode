/*
 * XREFs of ?stoi@std@@YAHAEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@1@PEA_KH@Z @ 0x18006ED4C
 * Callers:
 ...
 * Callees:
 *     ?_Xinvalid_argument@std@@YAXPEBD@Z @ 0x1800ADF98 (-_Xinvalid_argument@std@@YAXPEBD@Z.c)
 *     ?_Xout_of_range@std@@YAXPEBD@Z @ 0x1800ADFF0 (-_Xout_of_range@std@@YAXPEBD@Z.c)
 */
