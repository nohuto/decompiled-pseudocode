/*
 * XREFs of ?GetToastContentXML@ToastHelpers@NotificationManager@CreativeFramework@@QEAA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@XZ @ 0x18009A5C8
 * Callers:
...
void **__fastcall CreativeFramework::NotificationManager::ToastHelpers::GetToastContentXML(__int64 a1, void **a2)
{
  ...
  while ( v6 != v5 )
  {
    ...
    std::wstring::append(v34, (void **)L"{", asc_1801640A8[0] != 0);
    std::wstring::append(v34, v6 + 4, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    v10 = (_QWORD *)std::wstring::append(v34, (void **)L"}", asc_1801640AC[0] != 0);
    v41 = 7LL;
    v40[2] = 0LL;
    LOWORD(v40[0]) = 0;
