/*
 * XREFs of ?ActivateInstance@?$SimpleActivationFactory@VContentManagementService@ContentManagement@@$0A@@WRL@Microsoft@@UEAAJPEAPEAUIInspectable@@@Z @ 0x180025B60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0ContentManagementService@ContentManagement@@QEAA@XZ @ 0x180026540 (--0ContentManagementService@ContentManagement@@QEAA@XZ.c)
