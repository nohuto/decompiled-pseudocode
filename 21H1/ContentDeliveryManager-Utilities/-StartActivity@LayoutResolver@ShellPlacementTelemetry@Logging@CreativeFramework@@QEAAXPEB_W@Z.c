/*
 * XREFs of ?StartActivity@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEB_W@Z @ 0x1800A01A4
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  *(_DWORD *)v4 = 1;
    ...
    && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v20 = 4LL;
    v18 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_1801741C7, v11, v10, 5u, &v16);
  }
  if ( !*((_DWORD *)this + 8) )
