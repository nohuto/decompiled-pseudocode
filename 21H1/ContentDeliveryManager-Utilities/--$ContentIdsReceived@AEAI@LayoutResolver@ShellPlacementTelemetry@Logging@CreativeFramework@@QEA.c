/*
 * XREFs of ??$ContentIdsReceived@AEAI@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXAEAI@Z @ 0x1800A4BC4
 * Callers:
        ...
        int *a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u )
  {
    ...
    LODWORD(v4) = tlgWriteTransfer_EventWriteTransfer(
                    (__int64)v4,
                    (unsigned __int8 *)dword_180174195,
                    (const GUID *)(v6 + 8),
                    0LL,
                    3u,
                    &v9);
