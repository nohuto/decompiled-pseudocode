/*
 * XREFs of ?OnContentUpdated@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@AEAAXXZ @ 0x18004378C
 * Callers:
 *     _lambda_2c31ea12bccf7d61b4ea1b66f1c008a8_::operator() @ 0x18004283C (_lambda_2c31ea12bccf7d61b4ea1b66f1c008a8_--operator().c)
 * Callees:
 ...
 *     ?StartActivity@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXXZ @ 0x180040764 (-StartActivity@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Backgro.c)
 *     ?Stop@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIIII@Z @ 0x18004088C (-Stop@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@Conte.c)
 ...
 *     ?RemoveInvalidWeakPointersNoLock@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@AEAAXXZ @ 0x180043B98 (-RemoveInvalidWeakPointersNoLock@SubscriptionManagerImpl@Internal@TargetedContent@ContentManagem.c)
        ...
        RTL_SRWLOCK *this)
{
  ...
  for ( i = (_QWORD *)*Ptr; i != Ptr; i = (_QWORD *)*i )
  {
    ...
    SubscriptionLastUpdated = (const unsigned __int16 *)CreativeFramework::SubscribedContentStore::GetSubscriptionLastUpdated(
                                                          v10,
                                                          v5);
    v5 = SubscriptionLastUpdated;
    if ( (unsigned __int64)SubscriptionLastUpdated > (*v9)[4].dwLowDateTime
                                                   + ((unsigned __int64)(*v9)[4].dwHighDateTime << 32) )
    {
