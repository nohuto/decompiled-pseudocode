/*
 * XREFs of ??R_lambda_f49d986c83b05ce1e8811b336d8586e4_@@QEBAJXZ @ 0x18000F6D8
 * Callers:
...
__int64 __fastcall _lambda_f49d986c83b05ce1e8811b336d8586e4_::operator()(__int64 a1)
{
  int v2; // ebx
  int v3; // eax
  PCWSTR v4; // rcx
