/*
 * XREFs of ??$CreateActivationFactory@V?$SimpleSealedActivationFactory@VContentManagementService@ContentManagement@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x180024D10
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a4)
{
  ...
  if ( v9 )
  {
    ...
    *v11 = &Microsoft::WRL::SimpleSealedActivationFactory<ContentManagement::ContentManagementService,0>::`vftable';
    v13 = *((_DWORD *)v11 + 3);
    if ( v13 == 0x7FFFFFFF )
      goto LABEL_9;
    do
