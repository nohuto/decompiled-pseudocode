        ...
        volatile signed __int32 **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( *(_BYTE *)(a1 + 8) )
  {
    v3 = (*(__int64 (__fastcall **)(__int64, _QWORD, GUID *, volatile signed __int32 **))(*(_QWORD *)qword_180194350
                                                                                        + 40LL))(
           qword_180194350,
           *((unsigned int *)v4 + 1),
