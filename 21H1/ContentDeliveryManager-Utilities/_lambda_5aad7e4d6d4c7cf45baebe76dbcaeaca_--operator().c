/*
 * XREFs of _lambda_5aad7e4d6d4c7cf45baebe76dbcaeaca_::operator() @ 0x1800426F8
 * Callers:
 *     wistd::__function::__func__lambda_5aad7e4d6d4c7cf45baebe76dbcaeaca__void___cdecl(void)_::operator() @ 0x180046D10 (wistd--__function--__func__lambda_5aad7e4d6d4c7cf45baebe76dbcaeaca__void___cdecl(void)_--operato.c)
 * Callees:
        ...
        ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl **a1)
{
  ...
  ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl *v2; // rsi
  _QWORD *v3; // r14
  _QWORD *v4; // rax
  _QWORD *v5; // rdi
  ...
  ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl *v11; // [rsp+60h] [rbp+8h] BYREF
  ContentManagement::TargetedContent::Internal::SubscriptionManagerImpl *v12; // [rsp+68h] [rbp+10h]
  ...
  try
  {
    ...
    {
      *((_DWORD *)v4 + 3) = 1;
      *v4 = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<2>,Windows::Internal::IComPoolTask>::`vftable';
    ...
    v9 = result;
    if ( v3 )
      result = (*(__int64 (__fastcall **)(_QWORD *))(*v3 + 16LL))(v3);
    if ( v2 )
