/*
 * XREFs of ?SetLockScreenRegistryKeys@SetLockScreenHotspotsService@Actions@CreativeFramework@@AEAAJXZ @ 0x180096C1C
 * Callers:
 ...
 *     ?Stage@SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAXXZ @ 0x180096B60 (-Stage@SetLockScreenHotspotsService@Actions@CreativeFramework@@UEAAXXZ.c)
 * Callees:
 ...
 *     ?Return_Win32@in1diag3@details@wil@@YAJPEAXIPEBDK@Z @ 0x180027644 (-Return_Win32@in1diag3@details@wil@@YAJPEAXIPEBDK@Z.c)
  ...
  if ( v6 >= 0 )
  {
    ...
    else
    {
      ...
      if ( *((_QWORD *)this + 6) >= 8uLL )
        v9 = (_QWORD *)*v9;
      v7 = RegSetKeyValueW(phkResult, 0LL, L"contentId", 1u, v9, 2 * *((_DWORD *)this + 10));
      if ( v7 )
      {
        v8 = 114LL;
      }
      else
      {
        ...
        if ( *((_QWORD *)this + 10) >= 8uLL )
          v10 = (_QWORD *)*v10;
        v7 = RegSetKeyValueW(phkResult, 0LL, L"landscapeImage", 1u, v10, 2 * *((_DWORD *)this + 18));
        if ( v7 )
        {
          v8 = 117LL;
        }
...
LABEL_37:
          ...
          if ( *((_QWORD *)this + 14) >= 8uLL )
            v11 = (_QWORD *)*v11;
          v7 = RegSetKeyValueW(phkResult, 0LL, L"portraitImage", 1u, v11, 2 * *((_DWORD *)this + 26));
          if ( v7 )
          {
            v8 = 121LL;
          }
