/*
 * XREFs of _Strxfrm @ 0x1800CAA28
 * Callers:
 *     ?do_transform@?$collate@D@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@PEBD0@Z @ 0x1800C9EC0 (-do_transform@-$collate@D@std@@MEBA-AV-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@2@.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B755C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B7568 (_GetLocaleHandleById.c)
 *     __crtLCMapStringA_Stub @ 0x1800B7634 (__crtLCMapStringA_Stub.c)
...
size_t __cdecl Strxfrm(char *String1, char *End1, const char *a3, const char *a4, const _Collvec *a5)
{
  ...
  {
    LocaleHandleById = GetLocaleHandleById(1);
