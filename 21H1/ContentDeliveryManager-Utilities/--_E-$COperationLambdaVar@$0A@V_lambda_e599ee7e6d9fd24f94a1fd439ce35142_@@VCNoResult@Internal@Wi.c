/*
 * XREFs of ??_E?$COperationLambdaVar@$0A@V_lambda_e599ee7e6d9fd24f94a1fd439ce35142_@@VCNoResult@Internal@Windows@@$$V@Internal@Windows@@UEAAPEAXI@Z @ 0x18001C370
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall Windows::Internal::COperationLambdaVar<0,_lambda_e599ee7e6d9fd24f94a1fd439ce35142_,Windows::Internal::CNoResult,>::`vector deleting destructor'(
        _QWORD *a1,
        char a2)
{
  HSTRING v4; // rcx
