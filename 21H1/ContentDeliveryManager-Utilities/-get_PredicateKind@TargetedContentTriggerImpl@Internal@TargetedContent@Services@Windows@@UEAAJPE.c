/*
 * XREFs of ?get_PredicateKind@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAW4TargetedContentPredicateKind@2345@@Z @ 0x18005FAF0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
