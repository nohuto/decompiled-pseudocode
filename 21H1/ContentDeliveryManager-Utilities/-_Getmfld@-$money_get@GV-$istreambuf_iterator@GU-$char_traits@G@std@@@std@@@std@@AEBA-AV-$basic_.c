/*
 * XREFs of ?_Getmfld@?$money_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@AEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@0_NAEAVios_base@2@PEAG@Z @ 0x1800BBDA4
 * Callers:
 ...
 *     ??D?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@QEBAAEBGXZ @ 0x180037E44 (--D-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@QEBAAEBGXZ.c)
 ...
 *     ?equal@?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@QEBA_NAEBV12@@Z @ 0x18003A034 (-equal@-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@QEBA_NAEBV12@@Z.c)
        ...
        __int16 *a7)
{
  ...
  {
    v11 = 32;
    v12 = std::use_facet<std::moneypunct<unsigned short,1>>((__int64 *)&v94);
  }
  else
  {
    v11 = 64;
    v12 = std::use_facet<std::moneypunct<unsigned short,0>>((__int64 *)&v94);
  }
  v92 = v12;
  if ( v10 )
  {
  ...
  *v8 = 0;
  ...
  v17 = v14 | 0x81;
  v18 = std::use_facet<std::ctype<unsigned short>>((__int64 *)&v94);
  v94 = v18;
  if ( v16 )
  {
        ...
        if ( !std::istreambuf_iterator<wchar_t>::equal((__int64)a3, a4) )
        {
          ...
          do
          {
            ...
            std::string::append(
              v8,
              1uLL,
              `std::money_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getmfld'::`2'::_Src[v57]);
            std::istreambuf_iterator<unsigned short>::_Inc(a3);
          }
          while ( !std::istreambuf_iterator<wchar_t>::equal((__int64)a3, a4) );
          v17 = v97;
          ...
          && *(_WORD *)std::istreambuf_iterator<unsigned short>::operator*((__int64)a3) == v49 )
        {
          ...
          while ( !std::istreambuf_iterator<wchar_t>::equal((__int64)a3, a4) )
          {
            ...
            std::string::append(
              v8,
              1uLL,
              `std::money_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getmfld'::`2'::_Src[v61]);
            ++v26;
            std::istreambuf_iterator<unsigned short>::_Inc(a3);
          }
          v62 = v90;
