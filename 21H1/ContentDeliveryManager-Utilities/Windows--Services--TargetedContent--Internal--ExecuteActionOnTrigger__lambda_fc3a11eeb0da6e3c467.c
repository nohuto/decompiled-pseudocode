/*
 * XREFs of Windows::Services::TargetedContent::Internal::ExecuteActionOnTrigger__lambda_fc3a11eeb0da6e3c467e92bcd23893db___ @ 0x18006A15C
 * Callers:
 ...
 *     ??$TriggerUnregisterCompleted@AEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAE@TriggerManagerUnregisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEAPEB_W00000AEAEPEBD@Z @ 0x180069F08 (--$TriggerUnregisterCompleted@AEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAE@TriggerManage.c)
        ...
        __int64 a2)
{
  ...
  const WCHAR *v35; // [rsp+88h] [rbp-30h] BYREF
  const WCHAR *v36[5]; // [rsp+90h] [rbp-28h] BYREF
          ...
          if ( v13 >= 0 )
          {
            ...
            if ( v16 >= 0 )
            {
              ...
              if ( v19 >= 0 )
              {
                ...
                if ( v21 >= 0 )
                {
                  v23 = (const WCHAR *)Windows::Services::TargetedContent::Internal::ResolveNameFromTrigger(v38);
                  ...
                  v36[0] = WindowsGetStringRawBuffer(v30, 0LL);
                  v35 = v23;
                  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::TriggerManagerUnregisterActivity::TriggerUnregisterCompleted<wchar_t const * &,wchar_t const * &,wchar_t const * &,wchar_t const * &,wchar_t const * &,wchar_t const * &,unsigned char &>(
                    ...
                    &StringRawBuffer,
                    *(_BYTE **)(a2 + 8),
                    (const unsigned __int16 *)(**(_QWORD **)(a2 + 16) + 8LL));
