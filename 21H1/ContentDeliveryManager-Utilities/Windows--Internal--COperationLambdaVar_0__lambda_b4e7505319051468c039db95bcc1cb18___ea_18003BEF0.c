/*
 * XREFs of Windows::Internal::COperationLambdaVar_0__lambda_b4e7505319051468c039db95bcc1cb18__Windows::Internal::CNoResult_::_scalar_deleting_destructor_ @ 0x18003BEF0
 * Callers:
 *     <none>
 * Callees:
