/*
 * XREFs of WPP_RECORDER_SF_qs @ 0x1C002EFC8
 * Callers:
 *     OSNotifyDeviceEnum @ 0x1C002EE4C (OSNotifyDeviceEnum.c)
 *     ACPIBuildIssueNotifyInvalidateRelationsForDockDevice @ 0x1C004B870 (ACPIBuildIssueNotifyInvalidateRelationsForDockDevice.c)
