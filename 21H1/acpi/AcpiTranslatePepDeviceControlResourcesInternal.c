/*
 * XREFs of AcpiTranslatePepDeviceControlResourcesInternal @ 0x1C00B1410
 * Callers:
 *     AcpiTranslatePepDeviceControlResources @ 0x1C00B13D0 (AcpiTranslatePepDeviceControlResources.c)
 * Callees:
