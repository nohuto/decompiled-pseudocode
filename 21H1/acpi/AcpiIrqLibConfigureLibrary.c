/*
 * XREFs of AcpiIrqLibConfigureLibrary @ 0x1C00BD414
 * Callers:
 ...
 *     IrqPolicyUpdatePolicy @ 0x1C00BD554 (IrqPolicyUpdatePolicy.c)
 *     IrqLibpParseMadt @ 0x1C00BD5BC (IrqLibpParseMadt.c)
 *     ProcessorConfigure @ 0x1C00BD7C0 (ProcessorConfigure.c)
 */
...
__int64 __fastcall AcpiIrqLibConfigureLibrary(int a1, __int64 a2)
{
  ...
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((ULONGLONG *)&dword_1C007F120);
