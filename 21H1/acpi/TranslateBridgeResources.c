/*
 * XREFs of TranslateBridgeResources @ 0x1C00B5DA0
 * Callers:
 *     <none>
 * Callees:
 *     CmMemIoResourceUpdateType @ 0x1C006072C (CmMemIoResourceUpdateType.c)
 *     FindTranslationRange @ 0x1C00B5B74 (FindTranslationRange.c)
 */
