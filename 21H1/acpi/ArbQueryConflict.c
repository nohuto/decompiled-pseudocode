/*
 * XREFs of ArbQueryConflict @ 0x1C00B7D60
 * Callers:
 *     IrqArbQueryConflict @ 0x1C00B6DC0 (IrqArbQueryConflict.c)
 ...
 *     RtlFreeRangeList_0 @ 0x1C0031A6F (RtlFreeRangeList_0.c)
...
LABEL_17:
    ...
    *((_QWORD *)PoolWithTag + 3 * v18) = *(_QWORD *)(v21 + 24);
    *((_QWORD *)PoolWithTag + 3 * v18 + 1) = *(_QWORD *)v21;
    *((_QWORD *)PoolWithTag + 3 * v18 + 2) = *(_QWORD *)(v21 + 8);
