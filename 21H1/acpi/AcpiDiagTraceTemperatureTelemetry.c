/*
 * XREFs of AcpiDiagTraceTemperatureTelemetry @ 0x1C0011AF0
 * Callers:
...
void __fastcall AcpiDiagTraceTemperatureTelemetry(__int64 a1)
{
  ...
  if ( AcpiDiagThermalTelemetryEnabled )
  {
      ...
      && tlgKeywordOn((__int64)&dword_1C007F0E8) )
    {
      ...
      v18 = 2;
      v10 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C007F0E8, (unsigned __int8 *)dword_1C00725F1, v3, v4, 7u, &v8);
    }
  }
