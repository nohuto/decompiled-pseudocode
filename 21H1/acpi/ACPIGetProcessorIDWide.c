/*
 * XREFs of ACPIGetProcessorIDWide @ 0x1C0027480
 * Callers:
...
__int64 __fastcall ACPIGetProcessorIDWide(__int64 a1, __int64 a2, __int64 a3, int a4, char **a5, _DWORD *a6)
{
  ...
  *(_WORD *)v34 = 42;
  ...
  if ( (a4 & 0x40) != 0 )
  {
    ...
    RtlStringCchCopyNA(v8, v7, *((STRSAFE_PCNZCH *)&AcpiProcessorString + 1), (unsigned __int16)AcpiProcessorString);
    v17 = strstr(v8, "Model");
    v38 = v17;
...
LABEL_28:
  ...
  if ( v26 )
  {
    ...
    {
      if ( v6 )
        RtlStringCchPrintfA(v27, v7, "%s%s - %s", v41, *((const char **)&AcpiProcessorString + 1), (const char *)v6);
      else
        RtlStringCchPrintfA(v27, v7, "%s%s", v41, *((_QWORD *)&AcpiProcessorString + 1));
    }
    else
    {
