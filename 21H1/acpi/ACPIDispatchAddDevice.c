/*
 * XREFs of ACPIDispatchAddDevice @ 0x1C0025000
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIGetPortRangeInterfaces @ 0x1C002685C (ACPIGetPortRangeInterfaces.c)
 ...
 *     ACPICreateRootSymbolicLink @ 0x1C009F1B4 (ACPICreateRootSymbolicLink.c)
  ...
  if ( !PoolWithTag )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_L(
        ...
        6u,
        0xBu,
        (__int64)&WPP_4db1834495f43b1f112ef69394eefce4_Traceguids,
        14);
    v12 = -1073741670;
    goto LABEL_26;
  }
