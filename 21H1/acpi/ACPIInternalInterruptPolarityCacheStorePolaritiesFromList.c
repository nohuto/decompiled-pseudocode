/*
 * XREFs of ACPIInternalInterruptPolarityCacheStorePolaritiesFromList @ 0x1C00161D0
 * Callers:
 ...
 * Callees:
 *     ACPIInternalInterruptPolarityCacheStorePolarity @ 0x1C00160A0 (ACPIInternalInterruptPolarityCacheStorePolarity.c)
 */
