/*
 * XREFs of ACPIRootInitialize @ 0x1C0097C9C
 * Callers:
 *     ACPITableLoad @ 0x1C0025650 (ACPITableLoad.c)
 * Callees:
 *     AMLISetNSObjectContext @ 0x1C00023C0 (AMLISetNSObjectContext.c)
 ...
 *     ACPIAmliPreDefinedRootObjectsNotifyPepDiscoverDevice @ 0x1C002A624 (ACPIAmliPreDefinedRootObjectsNotifyPepDiscoverDevice.c)
