/*
 * XREFs of ACPIIoctlCalculateOutputBufferV1 @ 0x1C000BBAC
 * Callers:
 *     ACPIIoctlEvalPostProcessingV1 @ 0x1C000B9D8 (ACPIIoctlEvalPostProcessingV1.c)
 *     ACPIIoctlCalculateOutputBufferV1 @ 0x1C000BBAC (ACPIIoctlCalculateOutputBufferV1.c)
 *     AcpiConvertObjDataToMethodArguments @ 0x1C005AAB4 (AcpiConvertObjDataToMethodArguments.c)
 *     ACPIProcessorContainerFillIoctlBuffer @ 0x1C005D1D8 (ACPIProcessorContainerFillIoctlBuffer.c)
 * Callees:
 *     ACPIIoctlCalculateOutputBufferSizeV1 @ 0x1C000BAB0 (ACPIIoctlCalculateOutputBufferSizeV1.c)
 *     ACPIIoctlCalculateOutputBufferV1 @ 0x1C000BBAC (ACPIIoctlCalculateOutputBufferV1.c)
