/*
 * XREFs of ACPIIoctlEvalPreProcessingV2Ex @ 0x1C0057B58
 * Callers:
 ...
 *     AMLIIsObjectInGivenScope @ 0x1C0029BC4 (AMLIIsObjectInGivenScope.c)
        ...
        unsigned int *a8)
{
  ...
  *(_QWORD *)(a2 + 56) = 0LL;
  ...
  if ( (unsigned int)(v9 - 1) <= 0x16 )
    return 3221225507LL;
  v15 = *(int **)(a2 + 24);
  v16 = *(__int64 **)(ACPIInternalGetDeviceExtension(a1) + 720);
  if ( !v16 )
    return 3221225486LL;
  _strupr((char *)v15 + 4);
  v17 = AMLIGetNameSpaceObject((_BYTE *)v15 + 4, v16, (unsigned __int64 *)&v30, 1);
  if ( v17 < 0 )
    goto LABEL_11;
  ...
  {
    v13 = 1;
    v28 = (char *)ExAllocatePoolWithTag(a4, 0x28uLL, 0x41706341u);
    v11 = v28;
    if ( !v28 )
      goto LABEL_10;
    v29 = v15 + 66;
...
LABEL_46:
  ...
  v22 = (char *)ExAllocatePoolWithTag(a4, 40 * v19, 0x41706341u);
  v11 = v22;
  if ( v22 )
  {
    memset(v22, 0, v20);
    ...
    while ( 1 )
    {
      ...
      *((_WORD *)v24 - 11) = v25;
      ...
      {
        *((_QWORD *)v24 - 1) = 0LL;
        memmove(&v11[32 * v23 + 16 + 8 * v23], v21 + 4, *((unsigned int *)v21 + 1));
      }
LABEL_38:
