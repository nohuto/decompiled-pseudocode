/*
 * XREFs of wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x1C00568DC
 * Callers:
...
__int64 __fastcall wil_details_FeatureReporting_IncrementOpportunityInCache(__int64 a1, int a2, __int64 a3, _DWORD *a4)
{
  ...
  v4 = Feature_Pldr_Ignore_Vetoes__private_reporting;
  v6 = a2 == 5;
  while ( 1 )
  {
    a4[1] = 0;
    ...
    result = (unsigned int)_InterlockedCompareExchange(
                             &Feature_Pldr_Ignore_Vetoes__private_reporting,
