/*
 * XREFs of NotifyHalWithMachineStatesAndRetrieveInterruptModel @ 0x1C00BDE1C
 * Callers:
...
__int64 __fastcall NotifyHalWithMachineStatesAndRetrieveInterruptModel(int *a1)
{
  ...
  *((_BYTE *)PoolWithTag + 14) = 0;
  ...
  do
  {
    v5 = (unsigned __int8)byte_1C0072030[v4];
    v6 = dword_1C0072010[v4 / 4];
    ...
    {
      v10 = 1 << v3;
      v7 = (unsigned __int8)byte_1C0072030[v4];
LABEL_10:
