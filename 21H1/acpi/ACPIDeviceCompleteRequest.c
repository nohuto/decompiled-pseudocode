/*
 * XREFs of ACPIDeviceCompleteRequest @ 0x1C001E888
 * Callers:
 ...
 *     ACPIDevicePowerProcessInvalid @ 0x1C0050D30 (ACPIDevicePowerProcessInvalid.c)
 * Callees:
...
LABEL_26:
  ...
  {
    ++dword_1C0082E9C;
    if ( ExQueryDepthSList(&RequestLookAsideList) >= (unsigned __int16)word_1C0082E90 )
    {
      ++dword_1C0082EA0;
      ((void (__fastcall *)(struct _SLIST_ENTRY *))qword_1C0082EB8)(Entry);
    }
    else
    {
