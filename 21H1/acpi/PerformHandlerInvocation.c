/*
 * XREFs of PerformHandlerInvocation @ 0x1C004FDB8
 * Callers:
 *     AcquireDeviceFirmwareLock @ 0x1C004F7EC (AcquireDeviceFirmwareLock.c)
 *     DestroyDeviceFirmwareLock @ 0x1C004FC2C (DestroyDeviceFirmwareLock.c)
 *     ReleaseDeviceFirmwareLock @ 0x1C004FF54 (ReleaseDeviceFirmwareLock.c)
 * Callees:
