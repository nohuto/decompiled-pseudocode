/*
 * XREFs of _SetWindowCompositionDisallowPeek@8 @ 0x1790DC
 * Callers:
...
int __fastcall SetWindowCompositionDisallowPeek(int *a1, _DWORD *a2)
{
  int v3; // esi
  int v4; // ebx
  void *v5; // eax
  ...
  {
    if ( (int)(v8[0] << 22) >> 31 == v4 )
      return 0;
    v8[0] = v8[0] & 0xFFFFFDFF | (v4 << 9);
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 16, v7);
    }
  }
  return v3;
}
