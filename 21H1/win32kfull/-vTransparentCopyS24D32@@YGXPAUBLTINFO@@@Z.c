/*
 * XREFs of ?vTransparentCopyS24D32@@YGXPAUBLTINFO@@@Z @ 0xBB1BE
 * Callers:
...
void __stdcall vTransparentCopyS24D32(struct BLTINFO *a1)
{
  int v2; // ebx
  int v3; // edi
  int v4; // eax
  ...
  unsigned int (__fastcall *v13)(struct _XLATEOBJ *, unsigned int); // [esp+10h] [ebp-18h]
