/*
 * XREFs of ?vGradientFill16_565@@YGXPAVSURFACE@@PAU_TRIANGLEDATA@@@Z @ 0x23CBD5
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall vGradientFill16_565(struct SURFACE *a1, struct _TRIANGLEDATA *a2)
{
    ...
    do
    {
      ...
      if ( *((_DWORD *)a1 + 11) <= (unsigned int)(v11 + v6) && v11 < v33 )
      {
        ...
        if ( (v13 >= (unsigned int)v30 ? (v13 - (unsigned int)v30 + 1) >> 1 : 0) != 0 )
        {
          ...
          do
          {
            *v16 = *((unsigned __int8 *)&Saturation16_5 + ((*(_DWORD *)&v19[4 * (v15 & 3)] + (v39 >> 11)) >> 16)) | (unsigned __int16)(32 * (*((unsigned __int8 *)&Saturation16_6 + ((*(_DWORD *)&v19[4 * (v15 & 3)] + (v40 >> 10)) >> 16)) | (*((unsigned __int8 *)&Saturation16_5 + ((*(_DWORD *)&v19[4 * (v15 & 3)] + (v41 >> 11)) >> 16)) << 6)));
            v15 = v32 + 1;
            ++v16;
