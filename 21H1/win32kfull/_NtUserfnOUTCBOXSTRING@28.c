/*
 * XREFs of _NtUserfnOUTCBOXSTRING@28 @ 0x16CD37
 * Callers:
 *     <none>
 * Callees:
...
int __stdcall NtUserfnOUTCBOXSTRING(_DWORD *a1, int a2, int a3, volatile void *Address, int a5, char a6, int a7)
{
  int v8; // ebx
  int v9; // edi
  int v10; // eax
  ...
  if ( IsPseudoPwnd(a1) )
    return -1;
  v9 = (a6 + 6) & 0x1F;
  v10 = ((int (__stdcall *)(_DWORD *, int, int, int, int))mpFnidPfn[v9])(a1, 329, a3, a7, a5);
  v8 = -1;
  if ( v10 != -1 )
  {
    v11 = v10 + 1;
