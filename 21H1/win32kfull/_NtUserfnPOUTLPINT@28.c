/*
 * XREFs of _NtUserfnPOUTLPINT@28 @ 0x16D441
 * Callers:
 *     <none>
 * Callees:
...
int __stdcall NtUserfnPOUTLPINT(int a1, int a2, unsigned int a3, volatile void *Address, int a5, char a6, int a7)
{
