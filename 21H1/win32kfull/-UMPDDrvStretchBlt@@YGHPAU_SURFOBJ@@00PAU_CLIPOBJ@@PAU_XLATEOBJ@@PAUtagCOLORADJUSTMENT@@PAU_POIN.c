/*
 * XREFs of ?UMPDDrvStretchBlt@@YGHPAU_SURFOBJ@@00PAU_CLIPOBJ@@PAU_XLATEOBJ@@PAUtagCOLORADJUSTMENT@@PAU_POINTL@@PAU_RECTL@@54K@Z @ 0x20EAAC
 * Callers:
 *     <none>
 * Callees:
...
unsigned int __stdcall UMPDDrvStretchBlt(
        struct _SURFOBJ *a1,
        struct _SURFOBJ *a2,
        struct _SURFOBJ *a3,
        struct _CLIPOBJ *a4,
        ...
        unsigned int a11)
{
  ...
  unsigned int v17; // [esp+Ch] [ebp-B4h] BYREF
  int v18; // [esp+10h] [ebp-B0h] BYREF
  int v19; // [esp+14h] [ebp-ACh] BYREF
  int v20; // [esp+18h] [ebp-A8h] BYREF
  int v21; // [esp+1Ch] [ebp-A4h] BYREF
  struct _SURFOBJ *v22; // [esp+20h] [ebp-A0h]
  struct _SURFOBJ *v23; // [esp+24h] [ebp-9Ch]
  struct _SURFOBJ *v24; // [esp+28h] [ebp-98h]
  struct _XLATEOBJ *v25; // [esp+2Ch] [ebp-94h]
  int v26; // [esp+30h] [ebp-90h] BYREF
  int v27; // [esp+34h] [ebp-8Ch] BYREF
  int v28; // [esp+38h] [ebp-88h] BYREF
  void *v29; // [esp+3Ch] [ebp-84h] BYREF
  void *v30; // [esp+40h] [ebp-80h] BYREF
  void *v31; // [esp+44h] [ebp-7Ch] BYREF
  void *v32; // [esp+48h] [ebp-78h] BYREF
  void *v33; // [esp+4Ch] [ebp-74h] BYREF
  void *v34; // [esp+50h] [ebp-70h] BYREF
  UMPDOBJ *v35; // [esp+54h] [ebp-6Ch] BYREF
  struct _CLIPOBJ *v36; // [esp+58h] [ebp-68h]
  struct tagCOLORADJUSTMENT *v37; // [esp+5Ch] [ebp-64h]
  struct _POINTL *v38; // [esp+60h] [ebp-60h]
  struct _RECTL *v39; // [esp+64h] [ebp-5Ch]
  struct _RECTL *v40; // [esp+68h] [ebp-58h]
  struct _POINTL *v41; // [esp+6Ch] [ebp-54h]
  _DWORD v42[19]; // [esp+70h] [ebp-50h] BYREF
