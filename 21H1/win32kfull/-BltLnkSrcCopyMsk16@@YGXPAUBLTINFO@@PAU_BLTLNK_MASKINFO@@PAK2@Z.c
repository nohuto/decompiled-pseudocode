/*
 * XREFs of ?BltLnkSrcCopyMsk16@@YGXPAUBLTINFO@@PAU_BLTLNK_MASKINFO@@PAK2@Z @ 0x248A14
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __stdcall BltLnkSrcCopyMsk16(struct BLTINFO *a1, struct _BLTLNK_MASKINFO *a2, unsigned int *a3, unsigned int *a4)
{
  ...
  if ( v6 )
  {
    while ( 1 )
    {
      ...
      v18 = v6 - 1;
      v23 = *((_DWORD *)v4 + 4);
      v22 = (_WORD *)(v20 + 2 * *((_DWORD *)v4 + 9));
      v9 = v24;
      v26 = (_WORD *)(v21 + 2 * *((_DWORD *)v4 + 11));
      if ( v23 > 0 )
      {
        do
        {
