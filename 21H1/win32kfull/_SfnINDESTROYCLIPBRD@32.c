/*
 * XREFs of _SfnINDESTROYCLIPBRD@32 @ 0x18C8E2
 * Callers:
...
int __stdcall SfnINDESTROYCLIPBRD(int *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  ...
  int v25; // [esp+30h] [ebp-4Ch]
  _DWORD v26[7]; // [esp+34h] [ebp-48h] BYREF
  int v27; // [esp+58h] [ebp-24h]
  unsigned int v28; // [esp+5Ch] [ebp-20h] BYREF
  int v29; // [esp+60h] [ebp-1Ch] BYREF
  ...
  *(_DWORD *)(*(_DWORD *)(v16 + 260) + 48) = v17;
  ...
  EtwTraceBeginCallback(25);
  v18 = KeUserModeCallback(25, v22, 24, &v28, &v29);
  EtwTraceEndCallback(25);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)((char *)&a1 + 3));
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)((char *)&a2 + 3));
  ThreadUnlock1();
