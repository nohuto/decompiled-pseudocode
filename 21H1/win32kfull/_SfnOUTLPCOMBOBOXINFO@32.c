/*
 * XREFs of _SfnOUTLPCOMBOBOXINFO@32 @ 0x11346
 * Callers:
...
int __stdcall SfnOUTLPCOMBOBOXINFO(int *a1, int a2, int a3, void *a4, int a5, int a6, char a7, int a8)
{
  ...
  int v21; // eax
  char *v22; // esi
  _BYTE v24[52]; // [esp+10h] [ebp-F0h] BYREF
  int v25; // [esp+4Ch] [ebp-B4h]
  int v26; // [esp+50h] [ebp-B0h]
  int v27; // [esp+54h] [ebp-ACh]
  int v28; // [esp+68h] [ebp-98h]
  _DWORD v29[3]; // [esp+6Ch] [ebp-94h] BYREF
  int v30; // [esp+80h] [ebp-80h] BYREF
  int v31; // [esp+84h] [ebp-7Ch]
  int v32; // [esp+88h] [ebp-78h]
  unsigned int v33; // [esp+8Ch] [ebp-74h] BYREF
  void *v34; // [esp+90h] [ebp-70h]
  char v35; // [esp+96h] [ebp-6Ah] BYREF
  char v36; // [esp+97h] [ebp-69h] BYREF
  _DWORD v37[3]; // [esp+98h] [ebp-68h] BYREF
  _BYTE v38[52]; // [esp+A4h] [ebp-5Ch] BYREF
  int v39; // [esp+D8h] [ebp-28h]
  int v40; // [esp+DCh] [ebp-24h]
  CPPEH_RECORD ms_exc; // [esp+E8h] [ebp-18h]
  ...
  *(_DWORD *)(*(_DWORD *)(v13 + 260) + 48) = v16;
  ...
  EtwTraceBeginCallback(104);
  v17 = KeUserModeCallback(104, v37, 72, &v33, &v30);
  EtwTraceEndCallback(104);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v36);
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v35);
  ThreadUnlock1();
  ...
  *v18 = v26;
  ...
  if ( v17 >= 0 && v30 == 12 )
  {
    ...
    if ( !v21 || (*(_BYTE *)(v21 + 44) & 1) == 0 || *(void **)(v21 + 52) != v34 )
    {
      ...
      v22 = *(char **)(v33 + 8);
      if ( v22 + 52 < v22 || (unsigned int)(v22 + 52) > _MmUserProbeAddress )
        v22 = (char *)_MmUserProbeAddress;
      qmemcpy(v24, v22, sizeof(v24));
      qmemcpy(v34, v24, 0x34u);
      ms_exc.registration.TryLevel = -2;
      return v20;
    }
  }
