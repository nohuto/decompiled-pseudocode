/*
 * XREFs of _NtUserfnOUTLPSCROLLBARINFO@28 @ 0x16D0BB
 * Callers:
 *     <none>
 * Callees:
...
int __stdcall NtUserfnOUTLPSCROLLBARINFO(int a1, int a2, int a3, void *a4, int a5, char a6, int a7)
{
  int v8; // [esp+1Ch] [ebp-5Ch]
  _BYTE v9[64]; // [esp+20h] [ebp-58h] BYREF
