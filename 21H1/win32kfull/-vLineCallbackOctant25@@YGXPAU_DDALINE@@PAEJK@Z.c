/*
 * XREFs of ?vLineCallbackOctant25@@YGXPAU_DDALINE@@PAEJK@Z @ 0x240CB8
 * Callers:
...
void __stdcall vLineCallbackOctant25(struct _DDALINE *a1, unsigned __int8 *a2, int a3, unsigned int a4)
{
  int v5; // ecx
  int v6; // edi
