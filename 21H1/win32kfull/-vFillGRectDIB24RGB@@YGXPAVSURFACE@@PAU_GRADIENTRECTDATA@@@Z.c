/*
 * XREFs of ?vFillGRectDIB24RGB@@YGXPAVSURFACE@@PAU_GRADIENTRECTDATA@@@Z @ 0x23B838
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall vFillGRectDIB24RGB(struct SURFACE *a1, struct _GRADIENTRECTDATA *a2)
{
