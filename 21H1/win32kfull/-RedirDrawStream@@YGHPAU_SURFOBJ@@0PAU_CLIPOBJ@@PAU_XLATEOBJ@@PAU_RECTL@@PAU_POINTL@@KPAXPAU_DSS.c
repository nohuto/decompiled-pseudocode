/*
 * XREFs of ?RedirDrawStream@@YGHPAU_SURFOBJ@@0PAU_CLIPOBJ@@PAU_XLATEOBJ@@PAU_RECTL@@PAU_POINTL@@KPAXPAU_DSSTATE@@@Z @ 0x1FB2C8
 * Callers:
 *     <none>
 * Callees:
...
int __userpurge RedirDrawStream@<eax>(
        ...
        struct _DSSTATE *a10)
{
            ...
            if ( v12 )
            {
              if ( (v12[280] & 0x8000000) != 0 && (v12[354] & 0x8000) != 0 )
              {
                if ( *(_DWORD *)(v12[276] + 400) )
                {
                  ...
                  (*(void (__stdcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _RECTL *, struct _POINTL *, unsigned int, _DWORD *, struct _DSSTATE *))(v13 + 400))(
                    v14,
                    DevBitmap,
                    a4,
                    a5,
  ...
  v15 = EngDrawStream((int)a2, (int)a3, (int)a4, (int)a5, (int)a6, &a7->x, a8, a9, a10);
  if ( v21 )
    bMakeOpaque(v18);
  if ( v22 )
    bMakeOpaque(v18);
