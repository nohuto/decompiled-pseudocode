/*
 * XREFs of _SfnINLPUAHDRAWMENU@32 @ 0xB8C12
 * Callers:
...
int __stdcall SfnINLPUAHDRAWMENU(int *a1, int a2, int a3, int a4, int a5, int a6, char a7, int a8)
{
  int v8; // esi
  ...
  v31 = 0;
  v12 = (_DWORD *)a4;
  v13 = _ServerFixupMenuDC(*(HDC *)(a4 + 4), 0, 0);
  v30 = v13;
  if ( v13 )
  {
    v31 = v12[1];
  ...
  *(_DWORD *)(*(_DWORD *)(v16 + 260) + 48) = v19;
  ...
  EtwTraceBeginCallback(106);
  v20 = KeUserModeCallback(106, v25, 32, &v32, &v33);
  EtwTraceEndCallback(106);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)((char *)&a1 + 3));
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)((char *)&a2 + 3));
  ThreadUnlock1();
