/*
 * XREFs of _DwmAsyncCreateDCompositionHwndTarget@16 @ 0xF5EDA
 * Callers:
 *     ?ReNotifyDwm@CHwndTargetProp@@SGXPAUtagWND@@@Z @ 0xE0D90 (-ReNotifyDwm@CHwndTargetProp@@SGXPAUtagWND@@@Z.c)
 *     _EditionNotifyDwmForSystemVisualCreation@12 @ 0xF3C7A (_EditionNotifyDwmForSystemVisualCreation@12.c)
 * Callees:
 *     <none>
 */

int __fastcall DwmAsyncCreateDCompositionHwndTarget(PVOID Object, int a2, int a3, int a4)
{
  int v5; // edi
