/*
 * XREFs of _SetWindowCompositionVideoOverlayActive@8 @ 0x1794CB
 * Callers:
...
int __fastcall SetWindowCompositionVideoOverlayActive(int *a1, _DWORD *a2)
{
  int v3; // esi
  int v4; // ebx
  void *v5; // eax
  ...
  {
    if ( SLOBYTE(v8[0]) >> 7 == v4 )
      return 0;
    v8[0] = v8[0] & 0xFFFFFF7F | (v4 << 7);
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 14, v7);
    }
  }
  return v3;
}
