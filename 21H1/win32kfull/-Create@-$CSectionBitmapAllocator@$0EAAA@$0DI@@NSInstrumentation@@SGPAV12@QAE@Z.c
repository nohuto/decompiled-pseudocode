/*
 * XREFs of ?Create@?$CSectionBitmapAllocator@$0EAAA@$0DI@@NSInstrumentation@@SGPAV12@QAE@Z @ 0x184081
 * Callers:
...
_DWORD *__thiscall NSInstrumentation::CSectionBitmapAllocator<16384,56>::Create(void *this)
{
  _DWORD *result; // eax
  void *v3; // esi
  ...
  if ( result )
  {
    *result = 0;
    ...
    result[4] = 0;
    result[5] = 0;
    if ( (unsigned __int8)NSInstrumentation::CSectionBitmapAllocator<16384,56>::Initialize(this) )
    {
      return v3;
    }
    else
