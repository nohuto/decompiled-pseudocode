/*
 * XREFs of _DwmAsyncSetDesktopColorTransform@12 @ 0x1D2989
 * Callers:
...
int __fastcall DwmAsyncSetDesktopColorTransform(PVOID Object, int a2, const void *a3)
{
  int v4; // esi
