/*
 * XREFs of _SfnINOUTLPSCROLLINFO@32 @ 0x18EC31
 * Callers:
...
int __stdcall SfnINOUTLPSCROLLINFO(int *a1, int a2, int a3, void *a4, int a5, int a6, char a7, int a8)
{
  ...
  int v21; // eax
  char *v22; // esi
  _BYTE v24[28]; // [esp+10h] [ebp-B4h] BYREF
  int v25; // [esp+2Ch] [ebp-98h]
  int v26; // [esp+30h] [ebp-94h]
  int v27; // [esp+34h] [ebp-90h]
  int v28; // [esp+48h] [ebp-7Ch]
  _DWORD v29[3]; // [esp+4Ch] [ebp-78h] BYREF
  int v30; // [esp+60h] [ebp-64h] BYREF
  int v31; // [esp+64h] [ebp-60h]
  int v32; // [esp+68h] [ebp-5Ch]
  unsigned int v33; // [esp+6Ch] [ebp-58h] BYREF
  void *v34; // [esp+70h] [ebp-54h]
  char v35; // [esp+76h] [ebp-4Eh] BYREF
  char v36; // [esp+77h] [ebp-4Dh] BYREF
  _DWORD v37[3]; // [esp+78h] [ebp-4Ch] BYREF
  _BYTE v38[28]; // [esp+84h] [ebp-40h] BYREF
  ...
  *(_DWORD *)(*(_DWORD *)(v13 + 260) + 48) = v16;
  ...
  EtwTraceBeginCallback(19);
  v17 = KeUserModeCallback(19, v37, 48, &v33, &v30);
  EtwTraceEndCallback(19);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v36);
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v35);
  ThreadUnlock1();
  ...
  *v18 = v26;
  ...
  if ( v17 >= 0 && v30 == 12 )
  {
    ...
    if ( !v21 || (*(_BYTE *)(v21 + 44) & 1) == 0 || *(void **)(v21 + 52) != v34 )
    {
      ...
      v22 = *(char **)(v33 + 8);
      if ( v22 + 28 < v22 || (unsigned int)(v22 + 28) > _MmUserProbeAddress )
        v22 = (char *)_MmUserProbeAddress;
      qmemcpy(v24, v22, sizeof(v24));
      qmemcpy(v34, v24, 0x1Cu);
      ms_exc.registration.TryLevel = -2;
      return v20;
    }
  }
