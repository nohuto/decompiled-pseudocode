/*
 * XREFs of _SetWindowCompositionExcludeFromLivePreview@8 @ 0xCA1E2
 * Callers:
...
int __fastcall SetWindowCompositionExcludeFromLivePreview(int *a1, _DWORD *a2)
{
  int v3; // esi
  int v4; // ebx
  void *v5; // eax
  ...
  {
    if ( (int)(v8[0] << 27) >> 31 == v4 )
      return 0;
    v8[0] = v8[0] & 0xFFFFFFEF | (16 * v4);
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 13, v7);
    }
  }
  return v3;
}
