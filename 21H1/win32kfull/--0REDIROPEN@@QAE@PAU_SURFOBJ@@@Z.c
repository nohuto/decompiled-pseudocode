/*
 * XREFs of ??0REDIROPEN@@QAE@PAU_SURFOBJ@@@Z @ 0x1FAE3D
 * Callers:
...
REDIROPEN *__userpurge REDIROPEN::REDIROPEN@<eax>(REDIROPEN *this@<ecx>, struct SURFACE *a2@<edi>, struct _SURFOBJ *a3)
{
  *(_DWORD *)this = 0;
  if ( a3 && ((int)a3[1].hsurf & 0x800) != 0 && bUndoMakeOpaque(a2) )
    *(_DWORD *)this = (char *)a3 - 16;
  return this;
}
