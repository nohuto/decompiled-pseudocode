/*
 * XREFs of ?TraceLoggingWinPHotKeyEvent@@YGXXZ @ 0x187218
 * Callers:
 *     ?WinlogonHotkeyCallback@@YGXIJ@Z @ 0x147490 (-WinlogonHotkeyCallback@@YGXIJ@Z.c)
 * Callees:
...
void __stdcall TraceLoggingWinPHotKeyEvent()
{
  int v0; // ecx
