/*
 * XREFs of _OutputAATo8BPP_K_XLATE @ 0x1C0F5E
 * Callers:
 *     <none>
 * Callees:
...
int __cdecl OutputAATo8BPP_K_XLATE(
        int a1,
        int a2,
        unsigned int a3,
        _BYTE *a4,
      ...
      if ( !v14 )
      {
        ...
        if ( v19 < v26 )
        {
          ...
          if ( v19 < v24 )
          {
            ...
            {
              v27 -= v24;
              v28 = *(_BYTE *)((((unsigned int)&loc_1C0000 & (v23 - v26) & (v26 - v21[2]) | v27 & (v24 - v21[1]) & 0x38000 | (unsigned __int16)(v20 - LOWORD(v21[0])) & (unsigned __int16)(v17 - v20) & 0x7000) >> 12)
                             + a9);
            }
          }
        }
