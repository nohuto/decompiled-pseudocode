/*
 * XREFs of _draw_gray_f_ntb_o_to_temp_start@28 @ 0x1D54AB
 * Callers:
...
unsigned int __stdcall draw_gray_f_ntb_o_to_temp_start(
        unsigned int a1,
        int a2,
        int a3,
        int a4,
        ...
        int a7)
{
  ...
  if ( a1 < result )
  {
    do
    {
      ((void (__stdcall *)(struct BLTINFO *))(&(&apfnGray)[2 * (((_BYTE)v8 + ***(_BYTE ***)(v7 + 4)) & 1)])[*(_DWORD *)(**(_DWORD **)(v7 + 4) + 8) & 1])(**(struct BLTINFO ***)(v7 + 4));
      v7 = a1 + 16;
      LOBYTE(v8) = a6 + v11;
      v11 += a6;
      a1 = v7;
