/*
 * XREFs of ?BmpDevStretchBlt@@YGHPAU_SURFOBJ@@00PAU_CLIPOBJ@@PAU_XLATEOBJ@@PAUtagCOLORADJUSTMENT@@PAU_POINTL@@PAU_RECTL@@54K@Z @ 0x1FA1EF
 * Callers:
 *     <none>
 * Callees:
...
struct _SURFOBJ *__stdcall BmpDevStretchBlt(
        struct _SURFOBJ *a1,
        struct _SURFOBJ *a2,
        struct _SURFOBJ *a3,
        struct _CLIPOBJ *a4,
        ...
        ULONG a11)
{
  ...
  if ( a1 )
  {
    v13 = ((int)a1[1].hsurf & 2) != 0
        ? (*((int (__stdcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _RECTL *, struct _RECTL *, struct _POINTL *, ULONG))a1->hdev
           + 495))(
            a1,
            a2,
            a3,
            ...
            a10,
            a11)
        : EngStretchBlt(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);
            ...
            if ( (v16[280] & 0x8000000) != 0 )
            {
              ...
              if ( (v17 & 0x1000) != 0 && (v17 & 0x8000) != 0 )
              {
                if ( *(_DWORD *)(v16[276] + 120) )
                {
                  ...
                  (*(void (__stdcall **)(struct _SURFOBJ *, int, int, int, int, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _RECTL *, struct _RECTL *, struct _POINTL *, ULONG))(v18 + 120))(
                    v21,
                    v23,
                    v25,
                    v27,
