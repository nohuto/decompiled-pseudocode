/*
 * XREFs of _SetWindowCompositionVisualOwner@8 @ 0x179561
 * Callers:
...
int __fastcall SetWindowCompositionVisualOwner(int *a1, unsigned int *a2)
{
  int v3; // esi
  unsigned int *v4; // esi
  void *v5; // eax
  ...
  if ( _GetWindowCompositionInfo((int)a1, v7) )
  {
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 22, v4);
    }
  }
  return v3;
}
