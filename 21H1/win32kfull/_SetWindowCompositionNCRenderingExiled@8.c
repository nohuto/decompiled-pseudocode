/*
 * XREFs of _SetWindowCompositionNCRenderingExiled@8 @ 0x25858
 * Callers:
...
int __fastcall SetWindowCompositionNCRenderingExiled(int *a1, _DWORD *a2)
{
  bool v2; // zf
  int v4; // esi
  void *v5; // eax
  const void *v7; // [esp-4h] [ebp-3Ch]
  _DWORD v8[9]; // [esp+Ch] [ebp-2Ch] BYREF
  ...
  v4 = -1073741816;
  v10 = !v2;
  if ( _GetWindowCompositionInfo(a1, v8) )
  {
    if ( (int)(v8[0] << 31) >> 31 == v10 )
      return 0;
    v8[0] = v10 | v8[0] & 0xFFFFFFFE;
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 11, v7);
    }
  }
  return v4;
}
