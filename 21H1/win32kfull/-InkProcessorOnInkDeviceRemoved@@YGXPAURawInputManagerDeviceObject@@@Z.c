/*
 * XREFs of ?InkProcessorOnInkDeviceRemoved@@YGXPAURawInputManagerDeviceObject@@@Z @ 0x18389B
 * Callers:
...
void __thiscall InkProcessorOnInkDeviceRemoved(struct RawInputManagerDeviceObject *this)
{
  int v1; // [esp+4h] [ebp-4h] BYREF

  if ( InkProcessor::s_pInstance )
  {
    InkProcessor::OnDeviceRemoved((InkProcessor *)InkProcessor::s_pInstance, this);
  }
