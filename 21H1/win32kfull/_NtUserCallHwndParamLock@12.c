/*
 * XREFs of _NtUserCallHwndParamLock@12 @ 0x134DE
 * Callers:
 *     <none>
 * Callees:
...
int __stdcall NtUserCallHwndParamLock(int a1, int a2, int a3)
{
  int v3; // ebx
  int v4; // eax
  struct tagQ *v5; // edi
  ...
  v10 = 0;
  EnterCrit(0, 1);
  if ( a3 == 120 || a3 == 112 || a3 == 117 || (unsigned int)(a3 - 122) <= 1 )
    _gbValidateHandleForIL = 0;
  v4 = ValidateHwnd(a1);
  v5 = (struct tagQ *)v4;
  if ( v4 )
  {
    if ( a3 != 106 && a3 != 125 || (v7 = *(_WORD *)(*(_DWORD *)(v4 + 20) + 30) & 0x3FFF, v7 != 669) && v7 != 671 )
    {
      v8 = *(_DWORD *)(_gptiCurrent + 228);
      *(_DWORD *)(_gptiCurrent + 228) = &v8;
      v9 = v5;
      HMLockObject(v5);
      if ( (unsigned int)(a3 - 118) <= 7 )
        v3 = ((int (__stdcall *)(struct tagQ *, int))funcs_1355B[a3 - 118])(v5, a2);
      ThreadUnlock1();
    }
  }
