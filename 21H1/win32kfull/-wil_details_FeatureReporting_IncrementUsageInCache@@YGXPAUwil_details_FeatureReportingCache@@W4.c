/*
 * XREFs of ?wil_details_FeatureReporting_IncrementUsageInCache@@YGXPAUwil_details_FeatureReportingCache@@W4wil_details_ServiceReportingKind@@IPAUwil_details_RecordUsageResult@@@Z @ 0xF64A0
 * Callers:
