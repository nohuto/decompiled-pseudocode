/*
 * XREFs of ?Zombied@QueryGlyphAttrsRequest@@UBE_NXZ @ 0xB57D0
 * Callers:
...
bool __thiscall QueryGlyphAttrsRequest::Zombied(QueryGlyphAttrsRequest *this)
{
  return *(_BYTE *)(*(_DWORD *)(*((_DWORD *)this + 6) + 20) + 8);
}
