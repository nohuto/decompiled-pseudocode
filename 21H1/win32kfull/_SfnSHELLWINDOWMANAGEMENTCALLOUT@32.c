/*
 * XREFs of _SfnSHELLWINDOWMANAGEMENTCALLOUT@32 @ 0xA78D4
 * Callers:
...
int __stdcall SfnSHELLWINDOWMANAGEMENTCALLOUT(int *a1, int a2, int a3, void *a4, int a5, int a6, char a7, int a8)
{
  ...
  int v21; // eax
  char *v22; // esi
  _BYTE v24[60]; // [esp+10h] [ebp-F4h] BYREF
  int v25; // [esp+4Ch] [ebp-B8h]
  int v26; // [esp+50h] [ebp-B4h]
  int v27; // [esp+54h] [ebp-B0h]
  int v28; // [esp+68h] [ebp-9Ch]
  _DWORD v29[3]; // [esp+6Ch] [ebp-98h] BYREF
  int v30; // [esp+80h] [ebp-84h] BYREF
  int v31; // [esp+84h] [ebp-80h]
  int v32; // [esp+88h] [ebp-7Ch]
  unsigned int v33; // [esp+8Ch] [ebp-78h] BYREF
  void *v34; // [esp+90h] [ebp-74h]
  char v35; // [esp+96h] [ebp-6Eh] BYREF
  char v36; // [esp+97h] [ebp-6Dh] BYREF
  _DWORD v37[3]; // [esp+98h] [ebp-6Ch] BYREF
  _BYTE v38[60]; // [esp+A4h] [ebp-60h] BYREF
  int v39; // [esp+E0h] [ebp-24h]
  int v40; // [esp+E4h] [ebp-20h]
  ...
  *(_DWORD *)(*(_DWORD *)(v13 + 260) + 48) = v16;
  ...
  EtwTraceBeginCallback(53);
  v17 = KeUserModeCallback(53, v37, 80, &v33, &v30);
  EtwTraceEndCallback(53);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v36);
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v35);
  ThreadUnlock1();
  ...
  *v18 = v26;
  ...
  if ( v17 >= 0 && v30 == 12 )
  {
    ...
    if ( !v21 || (*(_BYTE *)(v21 + 44) & 1) == 0 || *(void **)(v21 + 52) != v34 )
    {
      ...
      v22 = *(char **)(v33 + 8);
      if ( v22 + 60 < v22 || (unsigned int)(v22 + 60) > _MmUserProbeAddress )
        v22 = (char *)_MmUserProbeAddress;
      qmemcpy(v24, v22, sizeof(v24));
      qmemcpy(v34, v24, 0x3Cu);
      ms_exc.registration.TryLevel = -2;
      return v20;
    }
  }
