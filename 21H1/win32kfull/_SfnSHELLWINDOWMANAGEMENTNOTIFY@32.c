/*
 * XREFs of _SfnSHELLWINDOWMANAGEMENTNOTIFY@32 @ 0xA3D5E
 * Callers:
...
int __stdcall SfnSHELLWINDOWMANAGEMENTNOTIFY(int *a1, int a2, int a3, const void *a4, int a5, int a6, int a7, int a8)
{
  ...
  int v22; // [esp+14h] [ebp-A0h]
  int v23; // [esp+18h] [ebp-9Ch]
  _DWORD v24[3]; // [esp+2Ch] [ebp-88h] BYREF
  unsigned int v25; // [esp+40h] [ebp-74h] BYREF
  int v26; // [esp+44h] [ebp-70h] BYREF
  int v27; // [esp+48h] [ebp-6Ch]
  int v28; // [esp+4Ch] [ebp-68h]
  char v29; // [esp+52h] [ebp-62h] BYREF
  char v30; // [esp+53h] [ebp-61h] BYREF
  _DWORD v31[3]; // [esp+54h] [ebp-60h] BYREF
  _BYTE v32[48]; // [esp+60h] [ebp-54h] BYREF
  int v33; // [esp+90h] [ebp-24h]
  ...
  *(_DWORD *)(*(_DWORD *)(v13 + 260) + 48) = v16;
  ...
  EtwTraceBeginCallback(54);
  v17 = KeUserModeCallback(54, v31, 68, &v25, &v26);
  EtwTraceEndCallback(54);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v30);
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v29);
  ThreadUnlock1();
