/*
 * XREFs of _OutputAATo24BPP_RGB @ 0x1C043A
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
char __cdecl OutputAATo24BPP_RGB(char *a1, int a2, unsigned int a3, int a4, int a5)
{
  char result; // al
  ...
  if ( *a1 >= 0 )
  {
    if ( (unsigned int)v6 < a3 )
    {
      ...
      do
      {
        v8[1] = ~*(_BYTE *)(a5 + 4 * v6[2] + 2048);
        *v8 = ~*(_BYTE *)(a5 + 4 * v6[1] + 1024);
        v8 += 3;
        v9 = *v6;
        v6 += 4;
