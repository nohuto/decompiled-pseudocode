/*
 * XREFs of ?vLineCallbackOctant07@@YGXPAU_DDALINE@@PAEJK@Z @ 0x240BF1
 * Callers:
...
void __stdcall vLineCallbackOctant07(struct _DDALINE *a1, unsigned __int8 *a2, int a3, unsigned int a4)
{
  int v5; // ecx
  int v6; // ebx
