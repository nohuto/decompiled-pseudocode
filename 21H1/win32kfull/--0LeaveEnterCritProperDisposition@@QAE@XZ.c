/*
 * XREFs of ??0LeaveEnterCritProperDisposition@@QAE@XZ @ 0x477AA
 * Callers:
...
LeaveEnterCritProperDisposition *__thiscall LeaveEnterCritProperDisposition::LeaveEnterCritProperDisposition(
        LeaveEnterCritProperDisposition *this)
{
  bool v2; // al

  v2 = !ExIsResourceAcquiredExclusiveLite(_gpresUser) && ExIsResourceAcquiredSharedLite(_gpresUser);
  *(_BYTE *)this = v2;
