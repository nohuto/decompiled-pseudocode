/*
 * XREFs of ?InkProcessorOnInkDeviceOpened@@YGXPAURawInputManagerDeviceObject@@@Z @ 0x183859
 * Callers:
...
void __thiscall InkProcessorOnInkDeviceOpened(struct RawInputManagerDeviceObject *this)
{
  int v1; // [esp+4h] [ebp-4h] BYREF

  if ( InkProcessor::s_pInstance )
  {
    InkProcessor::OnDeviceOpened((InkProcessor *)InkProcessor::s_pInstance, this);
  }
