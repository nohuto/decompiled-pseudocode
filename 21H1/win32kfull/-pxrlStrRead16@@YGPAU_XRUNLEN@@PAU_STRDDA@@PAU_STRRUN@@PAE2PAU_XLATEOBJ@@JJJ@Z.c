/*
 * XREFs of ?pxrlStrRead16@@YGPAU_XRUNLEN@@PAU_STRDDA@@PAU_STRRUN@@PAE2PAU_XLATEOBJ@@JJJ@Z @ 0x229B22
 * Callers:
 *     <none>
 * Callees:
...
struct _STRRUN **__stdcall pxrlStrRead16(
        struct _STRDDA *a1,
        struct _STRRUN *a2,
        unsigned __int8 *a3,
        ULONG iColor,
        ...
        int a8)
{
  ...
  unsigned __int8 *v34; // [esp+14h] [ebp-4h]
    ...
    if ( a6 != a7 )
    {
      ...
      if ( pxlo )
      {
        do
        {
          ...
          if ( v17 )
          {
            v18 = XLATEOBJ_iXlate(pxlo, *(unsigned __int16 *)v9);
            v8 = (ULONG)v37 + v42;
