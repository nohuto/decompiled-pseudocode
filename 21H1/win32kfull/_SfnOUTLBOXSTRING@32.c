/*
 * XREFs of _SfnOUTLBOXSTRING@32 @ 0x1A00F1
 * Callers:
...
int __stdcall SfnOUTLBOXSTRING(int *a1, ULONG_PTR a2, int a3, int a4, int a5, int a6, char a7, int a8)
{
  unsigned int v8; // ecx
  int result; // eax
  int v10; // ebx
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(ThreadWin32Thread + 228) = v14;
    v14[1] = a1;
    HMLockObject(a1);
    ListboxString = ClientGetListboxString(a1, a2, a3, a4, a5, a6, a7, (v10 & 0x40) == 0 && (v10 & 0x30) != 0, a8);
    ThreadUnlock1();
