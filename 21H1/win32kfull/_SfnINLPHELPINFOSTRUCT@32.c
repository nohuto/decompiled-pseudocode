/*
 * XREFs of _SfnINLPHELPINFOSTRUCT@32 @ 0x18D261
 * Callers:
...
char *__stdcall SfnINLPHELPINFOSTRUCT(int *a1, int a2, int a3, ULONG_PTR *a4, int a5, int a6, int a7, int a8)
{
  ...
  if ( result )
  {
    ...
    *(_DWORD *)(*(_DWORD *)(v19 + 260) + 48) = v16;
    ...
    EtwTraceBeginCallback(13);
    *((_DWORD *)v12 + 3) = 0;
    RegionSize = KeUserModeCallback(13, v12, *(_DWORD *)v12, &v37, &v38);
    EtwTraceEndCallback(13);
    LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v45);
    ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v44);
    ThreadUnlock1();
