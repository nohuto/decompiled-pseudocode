/*
 * XREFs of _SfnINLPCOMPAREITEMSTRUCT@32 @ 0x18CB0A
 * Callers:
...
int __stdcall SfnINLPCOMPAREITEMSTRUCT(int *a1, int a2, int a3, const void *a4, int a5, int a6, int a7, int a8)
{
  ...
  int *v20; // ecx
  int result; // eax
  _DWORD v22[3]; // [esp+10h] [ebp-88h] BYREF
  _BYTE v23[32]; // [esp+1Ch] [ebp-7Ch] BYREF
  int v24; // [esp+3Ch] [ebp-5Ch]
  int v25; // [esp+40h] [ebp-58h]
  int v26; // [esp+44h] [ebp-54h]
  int v27; // [esp+48h] [ebp-50h]
  int v28; // [esp+4Ch] [ebp-4Ch]
  _DWORD v29[7]; // [esp+50h] [ebp-48h] BYREF
  unsigned int v30; // [esp+74h] [ebp-24h] BYREF
  int v31; // [esp+78h] [ebp-20h] BYREF
  ...
  *(_DWORD *)(*(_DWORD *)(v14 + 260) + 48) = v17;
  ...
  EtwTraceBeginCallback(9);
  v18 = KeUserModeCallback(9, v22, 52, &v30, &v31);
  EtwTraceEndCallback(9);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)((char *)&a1 + 3));
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)((char *)&a2 + 3));
  ThreadUnlock1();
