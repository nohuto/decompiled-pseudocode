/*
 * XREFs of _NtUserCallHwndLockSafe@8 @ 0x92856
 * Callers:
 *     <none>
 * Callees:
...
BOOL __stdcall NtUserCallHwndLockSafe(int a1, unsigned int a2)
{
  BOOL v2; // ebx
  int v3; // eax
  int v4; // edi
  ...
  v9 = 0;
  EnterCrit(0, 1);
  if ( a2 == 112 || a2 == 117 || a2 == 120 || a2 > 0x79 && a2 <= 0x7B )
    _gbValidateHandleForIL = 0;
  v3 = ValidateHwnd(a1);
  v4 = v3;
  if ( v3 )
  {
    if ( a2 != 106 && a2 != 125 || (v6 = *(_WORD *)(*(_DWORD *)(v3 + 20) + 30) & 0x3FFF, v6 != 669) && v6 != 671 )
    {
