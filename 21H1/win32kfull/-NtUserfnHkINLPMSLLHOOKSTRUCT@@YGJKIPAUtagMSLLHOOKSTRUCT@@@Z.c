/*
 * XREFs of ?NtUserfnHkINLPMSLLHOOKSTRUCT@@YGJKIPAUtagMSLLHOOKSTRUCT@@@Z @ 0x15F4EF
 * Callers:
...
size_t __userpurge NtUserfnHkINLPMSLLHOOKSTRUCT@<eax>(
        struct tagHOOK *a1@<edx>,
        int a2@<ecx>,
        ULONG a3,
        unsigned int a4,
        struct tagMSLLHOOKSTRUCT *a5)
{
  const void *v5; // esi
  int v7[8]; // [esp+14h] [ebp-38h] BYREF
