/*
 * XREFs of _DpiRectIntersectsRectWithSubpixel@24 @ 0x150F7B
 * Callers:
...
BOOL __fastcall DpiRectIntersectsRectWithSubpixel(
        int *a1,
        float *a2,
        float *a3,
        int *a4,
        ...
        struct tagRECT *a6)
{
  ...
  GetDpiRectWithSubpixel(
    ...
    v7,
    v8);
  return RectIntersectsRect(*(float *)&v7, *(float *)&v8, v9, v10, v11, v12, v13, v14);
}
