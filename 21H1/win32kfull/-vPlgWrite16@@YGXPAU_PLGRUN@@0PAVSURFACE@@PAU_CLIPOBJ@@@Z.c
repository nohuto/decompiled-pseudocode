/*
 * XREFs of ?vPlgWrite16@@YGXPAU_PLGRUN@@0PAVSURFACE@@PAU_CLIPOBJ@@@Z @ 0x245597
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall vPlgWrite16(struct _PLGRUN *a1, struct _PLGRUN *a2, struct SURFACE *a3, struct _CLIPOBJ *a4)
{
  ...
  {
    v5 = a3;
    v6 = *((_DWORD *)a3 + 11) + *((_DWORD *)a3 + 10) - 2;
    v33[0] = *((_DWORD *)a3 + 11);
    v33[1] = v6;
    if ( a4 )
    {
