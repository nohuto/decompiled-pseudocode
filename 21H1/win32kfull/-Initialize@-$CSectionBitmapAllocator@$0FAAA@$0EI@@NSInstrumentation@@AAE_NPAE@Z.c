/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0FAAA@$0EI@@NSInstrumentation@@AAE_NPAE@Z @ 0x1A2B42
 * Callers:
...
char __thiscall NSInstrumentation::CSectionBitmapAllocator<20480,72>::Initialize(_DWORD *this, int a2)
{
  ...
  *this = PoolWithTag;
  if ( !PoolWithTag )
    return 0;
  *PoolWithTag = 0;
  v6 = _lambda_2917e5af034c4698795842f08d20f7d9_::operator()(0x118u);
  if ( !v6 )
    return 0;
  v7 = a2 ^ this[2];
