/*
 * XREFs of _NtUserfnINLPCOMPAREITEMSTRUCT@28 @ 0x16BC12
 * Callers:
 *     <none>
 * Callees:
...
int __stdcall NtUserfnINLPCOMPAREITEMSTRUCT(int a1, int a2, int a3, ULONG a4, int a5, char a6, int a7)
{
  const void *v7; // esi
  ...
  _BYTE v13[32]; // [esp+10h] [ebp-3Ch] BYREF
