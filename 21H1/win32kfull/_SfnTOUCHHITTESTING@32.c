/*
 * XREFs of _SfnTOUCHHITTESTING@32 @ 0x1927E2
 * Callers:
...
char *__stdcall SfnTOUCHHITTESTING(int *a1, int a2, int a3, ULONG_PTR a4, int a5, int a6, int a7, int a8)
{
  ...
  if ( a1 )
    ...
    v10 = 0;
  v40 = v10;
  result = AllocCallbackMessage(1, 48, 0x30u, v46, 1u, 0x200u, v24, v26);
  v12 = result;
  v42 = result;
  if ( result )
  {
    ...
    *((_DWORD *)v12 + 7) = a2;
    *((_DWORD *)v12 + 8) = a3;
    if ( CaptureCallbackData((const void *)RegionSize, v12, (const unsigned __int8 *)0x30, v12 + 36, v25, v27) < 0 )
      goto LABEL_25;
    *((_DWORD *)v12 + 10) = a5;
    *((_DWORD *)v12 + 11) = a6;
    ...
    *(_DWORD *)(*(_DWORD *)(v19 + 260) + 48) = v16;
    ...
    EtwTraceBeginCallback(115);
    *((_DWORD *)v12 + 3) = 0;
    RegionSize = KeUserModeCallback(115, v12, *(_DWORD *)v12, &v37, &v38);
    EtwTraceEndCallback(115);
    LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v45);
    ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v44);
    ThreadUnlock1();
