/*
 * XREFs of _WPP_RECORDER_SF_LHL@32 @ 0x15A38B
 * Callers:
...
int __stdcall WPP_RECORDER_SF_LHL(int a1, int a2, int a3, char a4, char a5, char a6)
{
  ...
  if ( (WPP_GLOBAL_Control->Characteristics & 0x40000) != 0 && BYTE1(WPP_GLOBAL_Control->Flags) >= 4u )
    pfnWppTraceMessage(
      ...
      4,
      0);
  return _WppAutoLogTrace(v6, 4, 19, &WPP_b43beeb5a22232e36856aa8311da4939_Traceguids, a2, &a4, 4, &a5, 2, &a6, 4, 0);
}
