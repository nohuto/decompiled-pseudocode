/*
 * XREFs of _SfnINWPARAMCHAR@32 @ 0x1904C6
 * Callers:
...
int __stdcall SfnINWPARAMCHAR(int *a1, unsigned int a2, unsigned int a3, int a4, int a5, int a6, int a7, int a8)
{
  ...
  if ( (a7 & 1) != 0 )
  {
    if ( a2 == 47 || a2 == 288 )
    {
      ...
      RtlWCSMessageWParamCharToMB(a2, (int)&a7);
  ...
  *(_DWORD *)(*(_DWORD *)(v16 + 260) + 48) = v17;
  ...
  v18 = KeUserModeCallback(2, v22, 24, &v28, &v29);
