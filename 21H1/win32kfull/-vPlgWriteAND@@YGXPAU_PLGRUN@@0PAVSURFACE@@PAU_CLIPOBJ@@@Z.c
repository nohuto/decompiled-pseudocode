/*
 * XREFs of ?vPlgWriteAND@@YGXPAU_PLGRUN@@0PAVSURFACE@@PAU_CLIPOBJ@@@Z @ 0x24656C
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall vPlgWriteAND(struct _PLGRUN *a1, struct _PLGRUN *a2, struct SURFACE *a3, struct _CLIPOBJ *a4)
{
