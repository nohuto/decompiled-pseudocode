/*
 * XREFs of _SfnINOUTLPMEASUREITEMSTRUCT@32 @ 0x18E955
 * Callers:
...
int __stdcall SfnINOUTLPMEASUREITEMSTRUCT(int *a1, int a2, int a3, void *a4, int a5, int a6, char a7, int a8)
{
  ...
  int v21; // eax
  char *v22; // esi
  _BYTE v24[24]; // [esp+10h] [ebp-ACh] BYREF
  int v25; // [esp+28h] [ebp-94h]
  int v26; // [esp+2Ch] [ebp-90h]
  int v27; // [esp+30h] [ebp-8Ch]
  int v28; // [esp+44h] [ebp-78h]
  _DWORD v29[3]; // [esp+48h] [ebp-74h] BYREF
  int v30; // [esp+5Ch] [ebp-60h] BYREF
  int v31; // [esp+60h] [ebp-5Ch]
  int v32; // [esp+64h] [ebp-58h]
  unsigned int v33; // [esp+68h] [ebp-54h] BYREF
  void *v34; // [esp+6Ch] [ebp-50h]
  char v35; // [esp+72h] [ebp-4Ah] BYREF
  char v36; // [esp+73h] [ebp-49h] BYREF
  _DWORD v37[3]; // [esp+74h] [ebp-48h] BYREF
  _BYTE v38[24]; // [esp+80h] [ebp-3Ch] BYREF
  int v39; // [esp+98h] [ebp-24h]
  int v40; // [esp+9Ch] [ebp-20h]
  ...
  *(_DWORD *)(*(_DWORD *)(v13 + 260) + 48) = v16;
  ...
  EtwTraceBeginCallback(16);
  v17 = KeUserModeCallback(16, v37, 44, &v33, &v30);
  EtwTraceEndCallback(16);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v36);
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v35);
  ThreadUnlock1();
  ...
  *v18 = v26;
  ...
  if ( v17 >= 0 && v30 == 12 )
  {
    ...
    if ( !v21 || (*(_BYTE *)(v21 + 44) & 1) == 0 || *(void **)(v21 + 52) != v34 )
    {
      ...
      v22 = *(char **)(v33 + 8);
      if ( v22 + 24 < v22 || (unsigned int)(v22 + 24) > _MmUserProbeAddress )
        v22 = (char *)_MmUserProbeAddress;
      qmemcpy(v24, v22, sizeof(v24));
      qmemcpy(v34, v24, 0x18u);
      ms_exc.registration.TryLevel = -2;
      return v20;
    }
  }
