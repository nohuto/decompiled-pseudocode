/*
 * XREFs of ?vSrcCopyS8D8IdentityLtoR@@YGXPAUBLTINFO@@@Z @ 0x2308A5
 * Callers:
...
void __stdcall vSrcCopyS8D8IdentityLtoR(struct BLTINFO *a1)
{
  char *v2; // edi
  size_t v3; // ecx
  _WORD *v4; // ebx
  ...
  v2 = (char *)(*((_DWORD *)a1 + 1) + *((_DWORD *)a1 + 9));
  v3 = *((_DWORD *)a1 + 4);
  v4 = (_WORD *)(*((_DWORD *)a1 + 2) + *((_DWORD *)a1 + 11));
  v8 = v3;
  v9 = (struct BLTINFO *)*((_DWORD *)a1 + 5);
  do
  {
    if ( *((_DWORD *)a1 + 13) )
      vSrcAlignCopyMemory((unsigned int)v2, v4, v3, v6, v7);
    else
      memmove(v4, v2, v3);
    v2 += *((_DWORD *)a1 + 7);
