/*
 * XREFs of ?Create@?$CSectionBitmapAllocator@$0FAAA@$0EI@@NSInstrumentation@@SGPAV12@QAE@Z @ 0x1A280C
 * Callers:
...
_DWORD *__thiscall NSInstrumentation::CSectionBitmapAllocator<20480,72>::Create(void *this)
{
  _DWORD *result; // eax
  void *v3; // esi
  ...
  if ( result )
  {
    *result = 0;
    ...
    result[4] = 0;
    result[5] = 0;
    if ( (unsigned __int8)NSInstrumentation::CSectionBitmapAllocator<20480,72>::Initialize(this) )
    {
      return v3;
    }
    else
