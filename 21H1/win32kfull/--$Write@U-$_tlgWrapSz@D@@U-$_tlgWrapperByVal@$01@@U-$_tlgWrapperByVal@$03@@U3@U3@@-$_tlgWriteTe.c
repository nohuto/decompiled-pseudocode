/*
 * XREFs of ??$Write@U?$_tlgWrapSz@D@@U?$_tlgWrapperByVal@$01@@U?$_tlgWrapperByVal@$03@@U3@U3@@?$_tlgWriteTemplate@$$A6GJPBU_tlgProvider_t@@PBXPBU_GUID@@2IPAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YGJ0122I3@ZPBU2@PBU2@@@SGJPBU_tlgProvider_t@@PBXPBU_GUID@@2ABU?$_tlgWrapSz@D@@ABU?$_tlgWrapperByVal@$01@@ABU?$_tlgWrapperByVal@$03@@55@Z @ 0x1B4044
 * Callers:
        ...
        int a9)
{
  ...
  const char *v14; // [esp+28h] [ebp-54h]
  int v15; // [esp+2Ch] [ebp-50h]
  unsigned int v16; // [esp+30h] [ebp-4Ch]
  int v17; // [esp+34h] [ebp-48h]
  int v18; // [esp+38h] [ebp-44h]
  ...
  v16 = v11;
  v17 = 0;
  return _tlgWriteTransfer_EtwWriteTransfer((int)&dword_2662D0, a2, 0, 0, 7u, &UserData);
}
