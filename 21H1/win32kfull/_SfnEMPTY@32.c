...
int __stdcall SfnEMPTY(int *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  ...
  int *v20; // ecx
  int result; // eax
  _DWORD v22[6]; // [esp+10h] [ebp-70h] BYREF
  int v23; // [esp+28h] [ebp-58h]
  int v24; // [esp+2Ch] [ebp-54h]
  int v25; // [esp+30h] [ebp-50h]
  _DWORD v26[7]; // [esp+34h] [ebp-4Ch] BYREF
  int v27; // [esp+58h] [ebp-28h]
  unsigned int v28; // [esp+5Ch] [ebp-24h] BYREF
  int v29; // [esp+60h] [ebp-20h] BYREF
  ...
  *(_DWORD *)(*(_DWORD *)(v16 + 260) + 48) = v17;
  ...
  EtwTraceBeginCallback(117);
  v18 = KeUserModeCallback(117, v22, 24, &v28, &v29);
  EtwTraceEndCallback(117);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)((char *)&a1 + 3));
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)((char *)&a2 + 3));
  ThreadUnlock1();
