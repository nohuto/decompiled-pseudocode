/*
 * XREFs of ?wil_details_FeatureReporting_IncrementOpportunityInCache@@YGXPAUwil_details_FeatureReportingCache@@W4wil_details_ServiceReportingKind@@IPAUwil_details_RecordUsageResult@@@Z @ 0xF63EA
 * Callers:
...
BOOL __fastcall wil_details_FeatureReporting_IncrementOpportunityInCache(int a1, int a2, int a3, BOOL *a4)
{
  ...
  v4 = Feature_Servicing_DynamicModeChange_23402279__private_reporting;
  v12 = Feature_Servicing_DynamicModeChange_23402279__private_reporting;
  v6 = a2 == 5;
  do
  {
    a4[1] = 0;
