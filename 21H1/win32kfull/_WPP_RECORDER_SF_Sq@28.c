/*
 * XREFs of _WPP_RECORDER_SF_Sq@28 @ 0xAD752
 * Callers:
...
int __stdcall WPP_RECORDER_SF_Sq(int a1, int a2, int a3, const unsigned __int16 *a4, char a5)
{
  ...
  if ( a4 )
    ...
    v6 = L"NULL";
  return _WppAutoLogTrace(v5, 4, 8, &WPP_a30ede561e3e317e1a4494e99a1f5b97_Traceguids, a2, v6, v7, &a5, 4, 0, v11, v12);
}
