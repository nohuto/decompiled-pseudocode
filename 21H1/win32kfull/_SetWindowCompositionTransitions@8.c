/*
 * XREFs of _SetWindowCompositionTransitions@8 @ 0x179438
 * Callers:
...
int __fastcall SetWindowCompositionTransitions(int *a1, _DWORD *a2)
{
  int v3; // esi
  int v4; // ebx
  void *v5; // eax
  ...
  {
    if ( (int)(v8[0] << 25) >> 31 == v4 )
      return 0;
    v8[0] = v8[0] & 0xFFFFFFBF | (v4 << 6);
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 3, v7);
    }
  }
  return v3;
}
