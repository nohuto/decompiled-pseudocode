/*
 * XREFs of ??4?$Vector@VCFixPred@Prediction@@$02@Prediction@@QAEAAV01@ABV01@@Z @ 0x156AA5
 * Callers:
...
_DWORD *__thiscall Prediction::Vector<Prediction::CFixPred,3>::operator=(_DWORD *this, int a2)
{
  _DWORD *v2; // edx
  int v3; // esi
  int v4; // ebx
