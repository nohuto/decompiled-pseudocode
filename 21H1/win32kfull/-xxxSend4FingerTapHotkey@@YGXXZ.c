/*
 * XREFs of ?xxxSend4FingerTapHotkey@@YGXXZ @ 0x178A43
 * Callers:
 *     _Send4FingerTapHotkey@0 @ 0x178D44 (_Send4FingerTapHotkey@0.c)
 * Callees:
...
void __stdcall xxxSend4FingerTapHotkey()
{
  ...
  if ( CurrentKbdTables )
  {
    ...
    HIWORD(v2[29]) = InternalMapVirtualKeyEx(135, 0, v1);
