/*
 * XREFs of _NtUserPhysicalToLogicalDpiPointForWindow@8 @ 0x16770C
 * Callers:
 *     <none>
 * Callees:
...
int __stdcall NtUserPhysicalToLogicalDpiPointForWindow(int a1, int *a2)
{
  int v2; // esi
  int v3; // ecx
  int v4; // eax
  ...
  if ( v3 )
  {
    ...
    *a2 = *a2;
    ...
    v10 = v4;
    v11 = v5;
    v2 = PhysicalToLogicalInPlaceRectWithSubpixel(v3, &v8, 0);
    v14 = v2;
    if ( v2 == 1 )
    {
      v12 = v8;
