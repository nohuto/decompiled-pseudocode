/*
 * XREFs of ?GetDrvType@DestroyFontRequest@@UBE?AW4FontDriverType@@XZ @ 0xB5776
 * Callers:
...
int __thiscall DestroyFontRequest::GetDrvType(_DWORD *this)
{
  return *(_DWORD *)(*(_DWORD *)(this[6] + 20) + 4);
}
