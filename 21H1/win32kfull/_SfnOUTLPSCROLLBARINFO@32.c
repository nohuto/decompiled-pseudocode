/*
 * XREFs of _SfnOUTLPSCROLLBARINFO@32 @ 0x1913F7
 * Callers:
...
int __stdcall SfnOUTLPSCROLLBARINFO(int *a1, int a2, int a3, void *a4, int a5, int a6, char a7, int a8)
{
  ...
  *(_DWORD *)(*(_DWORD *)(v13 + 260) + 48) = v16;
  ...
  EtwTraceBeginCallback(105);
  v17 = KeUserModeCallback(105, v37, 80, &v33, &v30);
  EtwTraceEndCallback(105);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v36);
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v35);
  ThreadUnlock1();
