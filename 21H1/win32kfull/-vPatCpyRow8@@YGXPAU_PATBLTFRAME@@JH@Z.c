/*
 * XREFs of ?vPatCpyRow8@@YGXPAU_PATBLTFRAME@@JH@Z @ 0x22DC80
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall vPatCpyRow8(struct _PATBLTFRAME *a1, int a2, int a3)
{
  ...
  for ( v23[1] = *((_DWORD *)a1 + 1) + v9 * *((_DWORD *)a1 + 3); a3; v9 = v22 != 0 ? v21 : 0 )
  {
    ...
    else
    {
      ...
      if ( v28 - v16 >= 4 )
      {
        ...
        {
          vFetchShiftAndCopy((int)v23);
        }
        else
        {
          v23[5] = v24 >> 2;
          vFetchAndCopy((int)v23);
        }
      }
      if ( v26 )
      {
