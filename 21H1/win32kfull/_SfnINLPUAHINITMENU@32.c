/*
 * XREFs of _SfnINLPUAHINITMENU@32 @ 0xB8DEE
 * Callers:
...
int __stdcall SfnINLPUAHINITMENU(int *a1, int a2, int a3, int a4, int a5, int a6, char a7, int a8)
{
  int v8; // esi
  ...
  *(_DWORD *)(*(_DWORD *)(v16 + 260) + 48) = v19;
  ...
  EtwTraceBeginCallback(108);
  v20 = KeUserModeCallback(108, v25, 32, &v32, &v33);
  EtwTraceEndCallback(108);
  LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)((char *)&a1 + 3));
  ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)((char *)&a2 + 3));
  ThreadUnlock1();
