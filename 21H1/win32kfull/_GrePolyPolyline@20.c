/*
 * XREFs of _GrePolyPolyline@20 @ 0x2006C0
 * Callers:
 *     <none>
 * Callees:
...
int __stdcall GrePolyPolyline(HDC a1, int a2, int a3, int a4, int a5)
{
  int v5; // esi
  ...
  if ( v10[0] )
  {
    ...
    if ( DWMSCREENREADMODIFYWRITEASSIST::bDWMDesktop((DWMSCREENREADMODIFYWRITEASSIST *)v11) )
    {
      if ( !DWMSCREENREADMODIFYWRITEASSIST::bInPathBracket((DWMSCREENREADMODIFYWRITEASSIST *)v11) )
      {
        ...
        if ( GrePolyPolylineInternal(a1, a3, a4, a5) )
  ...
  v7 = GrePolyPolylineInternal(a1, a3, a4, a5);
  if ( v5 )
  {
