/*
 * XREFs of ??1ReleaseAndReacquirePerObjectLocks@@QAE@XZ @ 0x436D4
 * Callers:
...
void __thiscall ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks(
        ReleaseAndReacquirePerObjectLocks *this)
{
  ...
  if ( (*(_BYTE *)this & 1) != 0 )
  {
    ...
    tagObjLock::LockExclusive((tagObjLock *)(v3 + 216));
    v5 = *(_BYTE *)this;
  }
  *(_BYTE *)(v3 + 844) = v5;
}
