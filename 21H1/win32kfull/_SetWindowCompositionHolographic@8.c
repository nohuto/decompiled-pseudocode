/*
 * XREFs of _SetWindowCompositionHolographic@8 @ 0x179203
 * Callers:
...
int __fastcall SetWindowCompositionHolographic(int *a1, _DWORD *a2)
{
  int v3; // esi
  int v4; // ebx
  void *v5; // eax
  ...
  {
    if ( (int)(v8[0] << 18) >> 31 == v4 )
      return 0;
    v8[0] = (v4 << 13) | v8[0] & 0xFFFFDFFF;
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 23, v7);
    }
  }
  return v3;
}
