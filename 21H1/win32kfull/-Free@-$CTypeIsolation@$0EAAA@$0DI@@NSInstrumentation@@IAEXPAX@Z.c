/*
 * XREFs of ?Free@?$CTypeIsolation@$0EAAA@$0DI@@NSInstrumentation@@IAEXPAX@Z @ 0x184183
 * Callers:
...
void __thiscall NSInstrumentation::CTypeIsolation<16384,56>::Free(_DWORD *this, void *a2)
{
  int v4; // esi
  _DWORD *i; // eax
  int v6; // eax
  ...
  if ( a2 )
  {
    if ( !*((_BYTE *)this + 20) )
    {
      ...
      for ( i = (_DWORD *)*this; ; i = (_DWORD *)*v14 )
      {
        ...
        v13 = (int *)i[4];
        v6 = NSInstrumentation::CSectionBitmapAllocator<16384,56>::CheckAllocationStatus(v13, (unsigned int)a2);
        if ( v6 )
        {
          v7 = v6 - 1;
          if ( !v7 )
          {
            NSInstrumentation::CSectionBitmapAllocator<16384,56>::Free(v13, a2);
            ExReleasePushLockSharedEx(v4, 0);
            KeLeaveCriticalRegion();
            return;
          }
