/*
 * XREFs of ?bAddPreComputedFastFillRects@PRECOMPUTE@@QAEHAAVEPATHOBJ@@PAU_RECTL@@K@Z @ 0x238A23
 * Callers:
...
int __thiscall PRECOMPUTE::bAddPreComputedFastFillRects(
        PRECOMPUTE *this,
        size_t Size,
        struct _RECTL *Src,
        unsigned int a4)
...
LABEL_13:
  ...
  v7 = *(const void **)(v4 + 28);
  if ( v7 )
    memcpy(v6, v7, 16 * *(_DWORD *)(v4 + 32));
  v8 = a4;
  memcpy(&v6[16 * *(_DWORD *)(v4 + 32)], Src, 16 * a4);
  if ( *(_DWORD *)(v4 + 28) )
    Win32FreePool(*(PATHOBJ **)(v4 + 28));
  *(_DWORD *)(v4 + 32) += v8;
  *(_DWORD *)(v4 + 28) = v6;
  return 1;
}
