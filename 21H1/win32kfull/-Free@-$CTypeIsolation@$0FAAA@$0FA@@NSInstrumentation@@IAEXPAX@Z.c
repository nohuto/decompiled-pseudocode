/*
 * XREFs of ?Free@?$CTypeIsolation@$0FAAA@$0FA@@NSInstrumentation@@IAEXPAX@Z @ 0x97C26
 * Callers:
...
void __thiscall NSInstrumentation::CTypeIsolation<20480,80>::Free(_DWORD *this, void *a2)
{
  int v4; // esi
  _DWORD *i; // eax
  int v6; // eax
  ...
  if ( a2 )
  {
    if ( !*((_BYTE *)this + 20) )
    {
      ...
      for ( i = (_DWORD *)*this; ; i = (_DWORD *)*v13 )
      {
        ...
        v6 = NSInstrumentation::CSectionBitmapAllocator<20480,80>::CheckAllocationStatus(a2);
        if ( v6 )
        {
          v7 = v6 - 1;
          if ( !v7 )
          {
            NSInstrumentation::CSectionBitmapAllocator<20480,80>::Free(a2);
            ExReleasePushLockSharedEx(v4, 0);
            KeLeaveCriticalRegion();
            return;
          }
