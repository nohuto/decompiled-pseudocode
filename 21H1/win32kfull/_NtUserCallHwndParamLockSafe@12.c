/*
 * XREFs of _NtUserCallHwndParamLockSafe@12 @ 0x189A0
 * Callers:
 *     <none>
 * Callees:
...
BOOL __stdcall NtUserCallHwndParamLockSafe(int a1, int a2, int a3)
{
  BOOL v3; // esi
  int v4; // eax
  int v5; // ebx
  ...
  if ( v4 )
  {
    if ( a3 != 125 || (v6 = *(_WORD *)(*(_DWORD *)(v4 + 20) + 30) & 0x3FFF, v6 != 669) && v6 != 671 )
    {
