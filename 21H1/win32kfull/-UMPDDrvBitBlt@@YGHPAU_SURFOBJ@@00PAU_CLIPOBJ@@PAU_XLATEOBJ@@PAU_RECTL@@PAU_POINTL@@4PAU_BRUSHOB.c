/*
 * XREFs of ?UMPDDrvBitBlt@@YGHPAU_SURFOBJ@@00PAU_CLIPOBJ@@PAU_XLATEOBJ@@PAU_RECTL@@PAU_POINTL@@4PAU_BRUSHOBJ@@4K@Z @ 0x20AE11
 * Callers:
 *     <none>
 * Callees:
...
unsigned int __stdcall UMPDDrvBitBlt(
        struct _SURFOBJ *a1,
        struct _SURFOBJ *a2,
        struct _SURFOBJ *a3,
        struct _CLIPOBJ *a4,
        ...
        unsigned int a11)
{
  ...
  struct _RECTL *v37; // [esp+5Ch] [ebp-5Ch]
  struct _POINTL *v38; // [esp+60h] [ebp-58h]
  struct _POINTL *v39; // [esp+64h] [ebp-54h]
  struct _BRUSHOBJ *v40; // [esp+68h] [ebp-50h]
  ...
  {
    if ( !*((_DWORD *)v35 + 58)
      || (!v25 ? (v14 = 144) : (v14 = 4 * v25->cEntries + 164),
          v17 = v14,
          ...
          (v19 = v15) != 0) )
    {
      ...
      if ( !UMPDOBJ::pso(v13, (UMPDOBJ *)((char *)v13 + 40), (struct _SURFOBJ **)&v42[5], v21)
        ...
        || !UMPDOBJ::ThunkMemBlock(v13, (void **)&v42[10], (void *)0x10)
        || !UMPDOBJ::ThunkMemBlock(v13, (void **)&v42[11], (void *)8)
        || !UMPDOBJ::ThunkMemBlock(v13, (void **)&v42[12], (void *)8)
        || !UMPDOBJ::ThunkDDIOBJ(v13, (UMPDOBJ *)((char *)v13 + 80), (void **)&v42[13], 0xCu, 0)
