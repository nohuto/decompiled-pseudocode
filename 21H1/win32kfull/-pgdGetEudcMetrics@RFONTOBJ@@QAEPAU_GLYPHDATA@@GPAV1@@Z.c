/*
 * XREFs of ?pgdGetEudcMetrics@RFONTOBJ@@QAEPAU_GLYPHDATA@@GPAV1@@Z @ 0x207B5A
 * Callers:
...
struct _GLYPHDATA *__thiscall RFONTOBJ::pgdGetEudcMetrics(RFONTOBJ *this, unsigned __int16 a2, struct RFONTOBJ *a3)
{
  _DWORD *v4; // eax
...
LABEL_9:
  ...
  if ( *v11 )
    return result;
  if ( !RFONTOBJ::bInsertMetrics(this, v11, v6) )
    return 0;
