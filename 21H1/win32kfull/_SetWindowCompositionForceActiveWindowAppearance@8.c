/*
 * XREFs of _SetWindowCompositionForceActiveWindowAppearance@8 @ 0xAC3D0
 * Callers:
...
int __fastcall SetWindowCompositionForceActiveWindowAppearance(int *a1, _DWORD *a2)
{
  int v3; // esi
  int v4; // ebx
  void *v5; // eax
  ...
  {
    if ( (int)(v8[0] << 23) >> 31 == v4 )
      return 0;
    v8[0] = v8[0] & 0xFFFFFEFF | (v4 << 8);
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 15, v7);
    }
  }
  return v3;
}
