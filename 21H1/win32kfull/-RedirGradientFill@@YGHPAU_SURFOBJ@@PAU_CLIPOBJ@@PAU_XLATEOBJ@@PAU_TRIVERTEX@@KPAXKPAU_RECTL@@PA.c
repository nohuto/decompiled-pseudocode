/*
 * XREFs of ?RedirGradientFill@@YGHPAU_SURFOBJ@@PAU_CLIPOBJ@@PAU_XLATEOBJ@@PAU_TRIVERTEX@@KPAXKPAU_RECTL@@PAU_POINTL@@K@Z @ 0x1FB57B
 * Callers:
 *     <none>
 * Callees:
...
BOOL __userpurge RedirGradientFill@<eax>(
        ...
        ULONG ulMode)
{
  ...
  REDIROPEN::REDIROPEN((REDIROPEN *)&v19, a1, psoDest);
  if ( psoDest )
  {
        ...
        if ( ((unsigned int)&loc_20000 & *(_DWORD *)(HDEV + 24)) != 0 )
        {
          for ( i = **(_DWORD ***)(HDEV + 1108); i; i = (_DWORD *)*i )
          {
            ...
            if ( v13 )
            {
              ...
              {
                if ( *(_DWORD *)(v13[276] + 312) )
                {
                  MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                    (MARK_ACCDRV_NOTIFICATION *)&v18,
                    (struct PDEVOBJ *)&v17,
                    psoDest);
                  (*(void (__stdcall **)(SURFOBJ *, CLIPOBJ *, XLATEOBJ *, TRIVERTEX *, ULONG, PVOID, ULONG, RECTL *, POINTL *, ULONG))(v13[276] + 312))(
                    psoDest,
                    pco,
                    pxlo,
                    pVertex,
  ...
  v14 = EngGradientFill(psoDest, pco, pxlo, pVertex, nVertex, pMesh, nMesh, prclExtents, pptlDitherOrg, ulMode);
  if ( v19 )
    bMakeOpaque(v16);
  return v14;
}
