/*
 * XREFs of _SetWindowCompositionNonClientRTLLayout@8 @ 0x179312
 * Callers:
...
int __fastcall SetWindowCompositionNonClientRTLLayout(int *a1, _DWORD *a2)
{
  bool v2; // zf
  int v4; // esi
  void *v5; // eax
  ...
  {
    if ( (int)(v8[0] << 29) >> 31 == v10 )
      return 0;
    v8[0] = v8[0] & 0xFFFFFFFB | (4 * v10);
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 6, v7);
    }
  }
  return v4;
}
