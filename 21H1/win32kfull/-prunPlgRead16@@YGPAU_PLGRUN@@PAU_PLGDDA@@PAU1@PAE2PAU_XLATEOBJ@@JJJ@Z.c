/*
 * XREFs of ?prunPlgRead16@@YGPAU_PLGRUN@@PAU_PLGDDA@@PAU1@PAE2PAU_XLATEOBJ@@JJJ@Z @ 0x2447EA
 * Callers:
 *     <none>
 * Callees:
...
struct _PLGRUN *__stdcall prunPlgRead16(
        struct _PLGDDA *a1,
        struct _PLGRUN *a2,
        unsigned __int8 *a3,
        unsigned __int8 *a4,
  ...
  else
  {
    ...
    if ( a6 != a7 )
    {
      ...
      if ( pxlo )
      {
        do
        {
          *(_DWORD *)v11 = XLATEOBJ_iXlate(v8, *(unsigned __int16 *)v10);
      ...
      else
      {
        do
        {
          *(_DWORD *)v11 = *(unsigned __int16 *)v10;
          v11 = prunPumpDDA(v19, v22);
          vAdvXDDA(v20);
          v10 += 2;
          --v12;
