/*
 * XREFs of _SetWindowCompositionAllowNCPaint@8 @ 0x179049
 * Callers:
...
int __fastcall SetWindowCompositionAllowNCPaint(int *a1, _DWORD *a2)
{
  bool v2; // zf
  int v4; // esi
  void *v5; // eax
  ...
  {
    if ( (int)(v8[0] << 30) >> 31 == v10 )
      return 0;
    v8[0] = v8[0] & 0xFFFFFFFD | (2 * v10);
    ...
    else
    {
      ...
      return DwmAsyncSetCompositionAttribute(v5, *a1, 4, v7);
    }
  }
  return v4;
}
