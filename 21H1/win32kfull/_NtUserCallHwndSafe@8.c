/*
 * XREFs of _NtUserCallHwndSafe@8 @ 0x99D78
 * Callers:
 *     <none>
 * Callees:
...
int __stdcall NtUserCallHwndSafe(int a1, int a2)
{
  int v2; // esi
  int v3; // eax
  int v4; // edi
  ...
  if ( v3 )
  {
    ...
    *(_DWORD *)(_gptiCurrent + 228) = &v7;
    v8 = v3;
    HMLockObject(v3);
    if ( (unsigned int)(a2 - 90) <= 1 )
      v2 = ((int (__stdcall *)(int, int))funcs_99DD3[a2 - 90])(v4, v6);
    ThreadUnlock1();
  }
