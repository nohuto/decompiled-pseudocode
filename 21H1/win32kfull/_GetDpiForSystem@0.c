/*
 * XREFs of _GetDpiForSystem@0 @ 0x3D2A0
 * Callers:
...
int __stdcall GetDpiForSystem()
{
  ...
  if ( (W32GetCurrentThreadDpiAwarenessContext() & 0xF) == 0
    && (CurrentThread = KeGetCurrentThread(), *(_DWORD *)(W32GetThreadWin32Thread(CurrentThread) + 248))
    && (v2 = KeGetCurrentThread(),
        (*(_BYTE *)(**(_DWORD **)(*(_DWORD *)(W32GetThreadWin32Thread(v2) + 248) + 4) + 32) & 1) != 0) )
  {
    return 96;
  }
  else
