/*
 * XREFs of _fnHkINLPCWPRETEXSTRUCT@20 @ 0x1A4F2E
 * Callers:
 *     <none>
 * Callees:
...
size_t __stdcall fnHkINLPCWPRETEXSTRUCT(int *a1, int a2, int a3, int a4, int a5)
{
  PKTHREAD CurrentThread; // eax
  _DWORD *v6; // edx
  int v7; // ecx
  int Valid; // eax
  int v10[4]; // [esp+10h] [ebp-38h] BYREF
  int v11; // [esp+20h] [ebp-28h]
  int v12; // [esp+24h] [ebp-24h]
  struct tagHOOK *v13; // [esp+2Ch] [ebp-1Ch]
