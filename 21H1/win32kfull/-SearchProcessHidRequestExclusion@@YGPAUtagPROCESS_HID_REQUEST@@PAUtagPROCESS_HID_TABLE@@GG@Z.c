/*
 * XREFs of ?SearchProcessHidRequestExclusion@@YGPAUtagPROCESS_HID_REQUEST@@PAUtagPROCESS_HID_TABLE@@GG@Z @ 0xC9E1A
 * Callers:
...
struct tagPROCESS_HID_REQUEST *__userpurge SearchProcessHidRequestExclusion@<eax>(
        __int16 a1@<dx>,
        int a2@<ecx>,
        ...
        unsigned __int16 a5)
{
  ...
  v5 = (struct tagPROCESS_HID_REQUEST *)(a2 + 24);
