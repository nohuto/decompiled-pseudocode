/*
 * XREFs of _SfnINPGESTURENOTIFYSTRUCT@32 @ 0x18FA31
 * Callers:
...
char *__stdcall SfnINPGESTURENOTIFYSTRUCT(int *a1, int a2, int a3, ULONG_PTR *a4, int a5, int a6, int a7, int a8)
{
  ...
  if ( result )
  {
    ...
    *((_DWORD *)v12 + 7) = a2;
    *((_DWORD *)v12 + 8) = a3;
    if ( CaptureCallbackData((const void *)RegionSize, v12, *(const unsigned __int8 **)RegionSize, v12 + 36, v25, v27) < 0 )
      goto LABEL_25;
    *((_DWORD *)v12 + 10) = a5;
    *((_DWORD *)v12 + 11) = a6;
    ...
    *(_DWORD *)(*(_DWORD *)(v19 + 260) + 48) = v16;
    ...
    EtwTraceBeginCallback(114);
    *((_DWORD *)v12 + 3) = 0;
    RegionSize = KeUserModeCallback(114, v12, *(_DWORD *)v12, &v37, &v38);
    EtwTraceEndCallback(114);
    LeaveEnterCritProperDisposition::~LeaveEnterCritProperDisposition((LeaveEnterCritProperDisposition *)&v45);
    ReleaseAndReacquirePerObjectLocks::~ReleaseAndReacquirePerObjectLocks((ReleaseAndReacquirePerObjectLocks *)&v44);
    ThreadUnlock1();
