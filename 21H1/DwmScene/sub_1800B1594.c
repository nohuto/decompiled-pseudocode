/*
 * XREFs of sub_1800B1594 @ 0x1800B1594
 * Callers:
 *     sub_1800B2180 @ 0x1800B2180 (sub_1800B2180.c)
 * Callees:
...
_QWORD *__fastcall sub_1800B1594(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_1800B0EC4((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
