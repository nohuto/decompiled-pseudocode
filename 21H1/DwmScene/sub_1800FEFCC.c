/*
 * XREFs of sub_1800FEFCC @ 0x1800FEFCC
 * Callers:
...
__int64 __fastcall sub_1800FEFCC(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  {
    sub_18000FD48(v24);
    v23 = sub_18000FD48(v26);
    sub_180027FF4(pExceptionObject, v23, 172, (__int64)v24, 0);
  ...
  {
    sub_18000FD48(v26);
    v22 = sub_18000FD48(v24);
    sub_180027FF4(pExceptionObject, v22, 181, (__int64)v26, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  *(_QWORD *)a3 = v10;
  v11 = (__int64 *)(a3 + 8);
  result = sub_1801003C4(a3 + 8, v5 / 6);
  *(_DWORD *)(a3 + 32) = 0;
  v13 = 0LL;
  if ( v6 )
  {
    ...
    do
    {
      ...
      v27 = 15LL;
      LOBYTE(v26[0]) = 0;
      sub_1800B3E3C(v26, a2, v15, 6uLL);
      v16 = sub_180100438(v26, 0LL, 16LL);
