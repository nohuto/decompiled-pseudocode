/*
 * XREFs of sub_1800CC134 @ 0x1800CC134
 * Callers:
...
__int64 __fastcall sub_1800CC134(__int64 *a1, __int64 a2, unsigned int *a3)
{
  __int64 v4; // r8
  __int64 v6; // rax
  unsigned int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_180032B20(a1, v10, (__int64 *)v4, (__int64)&unk_1801D2F80, &v11);
    *(_BYTE *)(a2 + 8) = 1;
    *(_QWORD *)a2 = *v8;
  }
  else
