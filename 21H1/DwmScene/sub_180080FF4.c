...
char __fastcall sub_180080FF4(__int64 a1, _DWORD *a2, _OWORD *a3, _DWORD *a4)
{
  ...
  *((float *)&v37 + 1) = v22;
  ...
  if ( v18 != 0.0 )
  {
    sub_18007E9CC(&v34, v18);
    v7 = v34;
    v28 = *(_QWORD *)((char *)&v34 + 4);
  }
  if ( v22 != 0.0 )
  {
    sub_18007E9CC(&v35, v22);
    v11 = DWORD2(v35);
    v10 = DWORD1(v35);
    v9 = v35;
  }
  ...
  *((_QWORD *)&v36 + 1) = v30 | 0x3F80000000000000LL;
  sub_18007DB28((__int64)v39, &v31, &v34, &v35, &v36);
  if ( !sub_18007FA44((__int64)v39, a2, a3, a4) )
    return 0;
  sub_18007E870(a2, &v37);
  return 1;
}
