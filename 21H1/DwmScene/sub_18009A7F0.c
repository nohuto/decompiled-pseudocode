/*
 * XREFs of sub_18009A7F0 @ 0x18009A7F0
 * Callers:
...
__int64 *__fastcall sub_18009A7F0(__int64 *a1, int *a2, unsigned __int64 a3)
{
...
LABEL_9:
    ...
    v16 = *(&v18 + a2[4]);
    v28[0] = v6 * v7;
    sub_180099224(a1, v28, (__int64 *)&v17, &v16, &v31, (int *)&v30, &v29);
    v30 = ++v7;
    if ( v7 >= v5 )
      return a1;
    v6 = v17;
