/*
 * XREFs of sub_18001062C @ 0x18001062C
 * Callers:
...
__int64 __fastcall sub_18001062C(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  unsigned int v8; // eax
  unsigned int v9; // ecx
