/*
 * XREFs of sub_1800B3610 @ 0x1800B3610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800B3610(__int64 a1, _QWORD *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rbx
  __int64 result; // rax
  ...
  *((_QWORD *)&v10 + 1) = v4;
  ...
  v9 = 0LL;
  sub_1800183F4((__int64 *)&v9, a2);
  v5 = v9;
  *(_DWORD *)(v9 + 92) = *(_DWORD *)(a1 + 92);
  *(_DWORD *)(v5 + 96) = *(_DWORD *)(a1 + 96);
  *(_DWORD *)(v5 + 100) = *(_DWORD *)(a1 + 100);
  *(_DWORD *)(v5 + 104) = *(_DWORD *)(a1 + 104);
  sub_1800B3184((_DWORD *)(v5 + 108), (_DWORD *)(a1 + 108));
  sub_1800B3284((_DWORD *)(v5 + 256), (_DWORD *)(a1 + 256));
