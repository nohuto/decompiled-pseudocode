/*
 * XREFs of sub_18008BD60 @ 0x18008BD60
 * Callers:
 *     sub_18008C1C0 @ 0x18008C1C0 (sub_18008C1C0.c)
 *     sub_1800A58B0 @ 0x1800A58B0 (sub_1800A58B0.c)
 * Callees:
...
__int64 __fastcall sub_18008BD60(_QWORD *a1)
{
  ...
  *a1 = &Spectre::Engine::Material::`vftable';
  ...
  if ( !*((_BYTE *)v4 + 25) )
  {
    do
    {
      sub_180020058((__int64)(a1 + 25), (__int64)(a1 + 25), (__int64 *)v4[2]);
      v5 = v4;
      v4 = (__int64 *)*v4;
      j_j__o_free(v5);
    }
