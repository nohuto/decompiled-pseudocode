...
__int64 __fastcall sub_1800BF42C(__int64 a1, __int64 a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v3 + 64LL))(v3, &unk_180208970, 0LL);
  v5 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v3 + 64LL))(v3, &unk_180208990, 0LL);
  v6 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v3 + 72LL))(v3, &unk_1802089B0, 0LL);
  LODWORD(v3) = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v3 + 72LL))(v3, &unk_180208D70, 0LL);
  v7 = sub_1800759E4(a1);
  v8 = v6 != 0;
  if ( (_DWORD)v3 )
    v8 = 1;
  ...
  v15[2] = 0LL;
  v15[3] = 0LL;
  sub_18001CDF8(v15, (__int64)&qword_18020CFC8);
  sub_1800A0C9C(v7, &v16, v15);
  sub_1800A5420(v16, &qword_18020D0C8, v10);
  sub_1800A13D0(v7);
