/*
 * XREFs of sub_180116FB0 @ 0x180116FB0
 * Callers:
 ...
 *     _o_floor @ 0x18011E058 (_o_floor.c)
...
__int64 __fastcall sub_180116FB0(__int64 a1)
{
  int v2; // eax
  __int64 v3; // r14
  __int64 v4; // rsi
...
LABEL_47:
    ...
    JUMPOUT(0x18011733DLL);
  }
  LOBYTE(v27) = v28;
  sub_180116B3C((__int64 *)a1, *(__int64 **)(a1 + 8), *(char **)(a1 + 24), *(char **)(a1 + 32));
  v3 = *(_QWORD *)(a1 + 32);
  v4 = *(_QWORD *)(a1 + 24);
  if ( v4 != v3 )
  {
...
LABEL_24:
    ...
    if ( v36 == *((_QWORD *)&v35 + 1) )
    {
      sub_180010F3C(&v35, *((_QWORD **)&v35 + 1), &v29);
    }
    else
    {
      **((_QWORD **)&v35 + 1) = 0LL;
...
LABEL_35:
  ...
  {
    v24 = *(__int64 **)(a1 + 8);
    v25 = sub_180116F34(&v33, *(__int64 **)a1, v24, j);
    sub_180117340(a1, v34, *v25, v24, v27);
  }
  return sub_180012938((__int64 *)&v35);
}
