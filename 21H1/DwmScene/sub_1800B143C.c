/*
 * XREFs of sub_1800B143C @ 0x1800B143C
 * Callers:
 *     sub_1800B2140 @ 0x1800B2140 (sub_1800B2140.c)
 * Callees:
...
_QWORD *__fastcall sub_1800B143C(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_1800B1030((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
