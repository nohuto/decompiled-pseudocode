/*
 * XREFs of sub_1800A1930 @ 0x1800A1930
 * Callers:
...
void __fastcall sub_1800A1930(__int64 a1)
{
  __int64 *v2; // rax
  _QWORD *v3; // rdi
  ...
  v2 = (__int64 *)sub_18009FD8C((__int128 *)a1, &v10, 1u);
  v3 = (_QWORD *)(a1 + 18632);
  ...
  sub_1800ECEEC(*v3);
  v6 = (__int64 *)sub_1800ECD78(*v3, v12);
  ...
  v11[3] = 15LL;
  LOBYTE(v11[0]) = 0;
  sub_18000FB34(v11, 0x17uLL, 0LL, "Global/RenderTargetSize");
  sub_18008D750((__int64)v14, v11, 5);
  sub_1800EF7D8(*(_QWORD *)(a1 + 18648), v14, 1LL);
  sub_18008DD30(v14);
}
