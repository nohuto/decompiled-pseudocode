/*
 * XREFs of sub_18010F008 @ 0x18010F008
 * Callers:
...
__int64 __fastcall sub_18010F008(int a1, unsigned int a2, __int64 a3, int a4, int a5, _QWORD *a6, __int64 a7)
{
  int v9; // r11d
  _QWORD *v10; // r10
  int v11; // eax
  ...
  if ( a4 != (_DWORD)result )
  {
    do
    {
      ...
      {
        sub_18000FD48(v22);
        sub_18010FB50(pExceptionObject, v22);
      ...
      v18 = a5 == 1 && (v13 & 1) != 0;
      result = sub_18010FEB8(v9, v15, v16, v17, v18, a7);
