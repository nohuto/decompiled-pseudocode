/*
 * XREFs of sub_1800657A4 @ 0x1800657A4
 * Callers:
 ...
 *     sub_180120CF1 @ 0x180120CF1 (sub_180120CF1.c)
 * Callees:
...
__int64 __fastcall sub_1800657A4(__int64 a1)
{
  __int64 v2; // rbx
  ...
  *(_OWORD *)v13 = 0LL;
  ...
  if ( v4 )
  {
    sub_180064758((__int64 *)(v4 + 216), v4 + 216);
    sub_180064758((__int64 *)(v4 + 16), v4 + 16);
    j__o_free(v4);
  }
