        ...
        char a11)
{
  ...
  if ( !v14 || !v15 )
  {
    sub_18007E3E4(&v78, &xmmword_18020DC20);
    ...
    sub_1801163DC(&unk_18020C600, 4LL, v19, *(_QWORD *)(v56 + 368), 0);
    if ( *((_QWORD *)&v56 + 1) )
    {
  ...
  *(_QWORD *)(v25 + 8) = 0LL;
  ...
  if ( *(_BYTE *)(a1 + 72) )
  {
    ...
    sub_1801163DC(&unk_18020C600, 3LL, "MeshInstance: Vertex count %u", v28);
    sub_1801163DC(&unk_18020C600, 3LL, "MeshInstance: Index count  %u", v29);
    sub_1801163DC(&unk_18020C600, 3LL, "MeshInstance: Index per Vertex count %f", (float)((float)v29 / (float)v28), v51);
    if ( v28 )
    {
      v55 = 0LL;
      v54 = 0LL;
...
LABEL_43:
      ...
      if ( fdtest(&Px) > 0 || (v72 = (float)(a9[1] + *a9) + a9[2], fdtest(&v72) > 0) )
      {
        ...
        sub_1801163DC(&unk_18020C600, 4LL, v43, a7, v52);
        v41 = 0;
        if ( v77.m128i_i64[1] >= 0x10uLL )
        {
          v44 = v76[0];
