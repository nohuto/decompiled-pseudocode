/*
 * XREFs of sub_18011137C @ 0x18011137C
 * Callers:
...
_DWORD *__fastcall sub_18011137C(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        unsigned int a4,
        ...
        __int64 a8)
{
  ...
  if ( v22 != 0.0 )
  {
    ...
    *((float *)&v27 + 1) = (float)((float)(v14 * v18) - (float)(v9 * v16)) * (float)(1.0 / v22);
    ...
    sub_1800B3378((_DWORD *)(a7 + 12LL * a3), &v25);
    sub_1800B3378((_DWORD *)(a7 + 4 * v11), &v25);
    sub_1800B3378((_DWORD *)(a7 + 12LL * a5), &v25);
    sub_1800B3378((_DWORD *)(a8 + 4 * v10), &v27);
    sub_1800B3378((_DWORD *)(a8 + 4 * v11), &v27);
    return sub_1800B3378((_DWORD *)(a8 + 12LL * a5), &v27);
  }
  return result;
}
