/*
 * XREFs of sub_18006C0D8 @ 0x18006C0D8
 * Callers:
...
_QWORD *__fastcall sub_18006C0D8(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r14
  __int64 v5; // rcx
  __int64 v6; // rbx
