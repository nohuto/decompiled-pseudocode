/*
 * XREFs of sub_1800A3808 @ 0x1800A3808
 * Callers:
 *     sub_1800A1B10 @ 0x1800A1B10 (sub_1800A1B10.c)
 * Callees:
...
__int64 __fastcall sub_1800A3808(_QWORD *a1)
{
  __int64 v2; // rcx
  ...
  a1[65] = 15LL;
  *((_BYTE *)a1 + 496) = 0;
  sub_1800A2340((__int64)(a1 + 60), (__int64)(a1 + 60), *(__int64 **)(a1[60] + 8LL));
  j_j__o_free(a1[60]);
  sub_1801168D0(a1 + 59);
  ...
  sub_1800A2258(a1 + 52, (__int64)(a1 + 52));
  `eh vector destructor iterator'(a1 + 32, 0x10uLL, 0xAuLL, (void (*)(void *))unknown_libname_96);
  `eh vector destructor iterator'(a1 + 12, 0x10uLL, 0xAuLL, (void (*)(void *))unknown_libname_96);
  sub_180064680(a1 + 10, (__int64)(a1 + 10));
  result = sub_18009C6C8(a1 + 6, (__int64)(a1 + 6));
  v14 = a1[5];
  if ( v14 >= 0x10 )
  {
    v15 = v14 + 1;
