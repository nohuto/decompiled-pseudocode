/*
 * XREFs of sub_1800ED7F8 @ 0x1800ED7F8
 * Callers:
...
_DWORD *__fastcall sub_1800ED7F8(__int64 a1, unsigned __int16 a2, __int64 a3)
{
  char v6; // di
  _QWORD *v7; // rax
  int v8; // ebx
  ...
  {
    v7 = sub_1800ED154(&v35, *(_DWORD *)(a3 + 32));
    v8 = 2;
  }
  else
  {
    v7 = sub_180018764(&v36[1], a3 + 40);
    v8 = 1;
  }
  LODWORD(v34) = v8;
  result = sub_180018764(v41, (__int64)v7);
  if ( (v8 & 2) != 0 )
  {
    LOBYTE(v8) = v8 & 0xFD;
    v10 = v35;
            ...
            if ( v21 )
            {
              ...
              if ( v22 )
              {
                ...
                if ( v23 )
                {
                  ...
                  {
                    sub_18000FD48(v39);
                    v33 = sub_18000FD48(v38);
                    sub_180027FF4(pExceptionObject, v33, 395, (__int64)v39, 0);
                    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
                  }
                }
                else
                {
                  sub_180018AF0(pExceptionObject, v41[0]);
                  result = (_DWORD *)sub_1800EDB98(a1, a2, pExceptionObject);
                }
              }
              else
              {
                v34 = *(_OWORD *)v41[0];
                result = (_DWORD *)sub_1800EDB68(a1, a2, &v34);
              }
            }
            else
            {
              v34 = *(_OWORD *)v41[0];
              result = (_DWORD *)sub_1800EDC04(a1, a2, &v34);
            }
          }
          else
          {
            ...
            *(_QWORD *)((char *)&v34 + 4) = __PAIR64__(v25, v24);
            result = (_DWORD *)sub_1800EDBD8(a1, a2, &v34);
          }
        }
        else
        {
