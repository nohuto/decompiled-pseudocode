/*
 * XREFs of sub_18010D020 @ 0x18010D020
 * Callers:
 *     sub_18010D000 @ 0x18010D000 (sub_18010D000.c)
 * Callees:
...
char __fastcall sub_18010D020(__int64 a1, __int64 a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 *v6; // rax
  ...
  *v14 = 0;
  ...
  switch ( v15 )
  {
    ...
    case 32:
      v16 = &qword_18020D048;
LABEL_21:
      sub_180012E34(v13, v16);
      break;
  }
  v17 = (_QWORD *)sub_18006AB04(a2);
  sub_180017634(v17, &v21, 1u);
  ...
  v23[3] = 15LL;
  LOBYTE(v23[0]) = 0;
  sub_18000FB34(v23, 0x1DuLL, 0LL, "Image Processing Blur Sampler");
  sub_1800628C4(*(_QWORD *)(a1 + 320), v23);
  v32 = 0;
  v36 = 0;
  v19 = *(_QWORD **)(a1 + 320);
  v37 = 2139095039;
  ...
  v33 = 1;
  v34 = 7;
  si128 = _mm_load_si128((const __m128i *)&xmmword_1801D59D0);
  return sub_18009B760(v19, &si128, 0LL);
}
