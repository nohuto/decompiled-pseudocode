...
{
  if ( dword_1802188D8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_1802188D8);
    if ( dword_1802188D8 == -1 )
    {
      ...
      Init_thread_footer(&dword_1802188D8);
    }
  }
