/*
 * XREFs of sub_1800225CC @ 0x1800225CC
 * Callers:
 *     sub_180026940 @ 0x180026940 (sub_180026940.c)
 * Callees:
...
_QWORD *__fastcall sub_1800225CC(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_18002101C((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
