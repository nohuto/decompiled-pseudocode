/*
 * XREFs of sub_180032DB0 @ 0x180032DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180032DB0(__int64 a1, _QWORD *a2, unsigned __int8 a3, char a4)
{
  ...
  if ( *a2 )
  {
    sub_1800339E0(*a2 + 256LL, &v17, *(unsigned int *)(a1 + 88));
    v7 = &v17;
    v8 = 1;
    v9 = v17;
  }
