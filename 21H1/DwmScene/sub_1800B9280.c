...
__int64 __fastcall sub_1800B9280(__int64 a1, __int64 a2, _QWORD *a3, _QWORD *a4)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(*(_QWORD *)*a3 + 96LL))(*a3, 7LL) )
    v7 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_18020A030, 0LL);
  else
    v7 = 0;
  v8 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_18020A070, 0LL);
  if ( v8 && (*(unsigned int (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_180208FD0, 0LL) )
    v8 = 0;
  v23 = 0LL;
  ...
  *((_QWORD *)&v23 + 1) = v10;
  ...
  if ( v8 )
  {
    v12 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 72LL))(v6, &unk_18020A0B0, 0LL);
    v13 = v12;
    v14 = 2;
    ...
    if ( v15 )
    {
      v17 = *((_QWORD *)&v22 + 1);
LABEL_31:
      *(float *)(v15 + 280) = (*(float (__fastcall **)(__int64, void *))(*(_QWORD *)v6 + 88LL))(v6, &unk_18020A090);
      goto LABEL_33;
    }
LABEL_24:
