/*
 * XREFs of sub_180093254 @ 0x180093254
 * Callers:
...
__int64 __fastcall sub_180093254(__int64 a1, __int64 a2, unsigned int a3)
{
  _QWORD *v6; // rax
  int v7; // r14d
  __int64 *v8; // rdi
  ...
  *(_DWORD *)(a1 + 288) = 1;
  ...
  v12 = sub_180030CCC(8, v9);
  return sub_1800CD334(v10, a2, a3, v12, v7, 8);
}
