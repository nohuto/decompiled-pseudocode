/*
 * XREFs of sub_180017C4C @ 0x180017C4C
 * Callers:
...
__int64 __fastcall sub_180017C4C(_QWORD *a1, __int64 a2)
{
  _QWORD *v4; // rax
  _QWORD *v5; // rbx
  int v6; // edi
  ...
  *a1 = 0LL;
  v4 = operator new(0x20uLL, (const struct std::nothrow_t *)&unk_1801D7C98);
  v5 = v4;
  if ( v4 )
  {
