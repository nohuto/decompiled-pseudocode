/*
 * XREFs of sub_1800B73F4 @ 0x1800B73F4
 * Callers:
...
__int64 __fastcall sub_1800B73F4(__int64 *a1, __int64 a2, _DWORD *a3)
{
  __int64 v4; // r8
  __int64 v6; // rax
  int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_180070A18(a1, v10, (__int64 *)v4, (__int64)&unk_1801D231C, &v11);
    *(_BYTE *)(a2 + 8) = 1;
    *(_QWORD *)a2 = *v8;
  }
  else
