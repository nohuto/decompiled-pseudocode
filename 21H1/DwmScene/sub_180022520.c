/*
 * XREFs of sub_180022520 @ 0x180022520
 * Callers:
 *     sub_180026920 @ 0x180026920 (sub_180026920.c)
 * Callees:
...
_QWORD *__fastcall sub_180022520(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180021088((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
