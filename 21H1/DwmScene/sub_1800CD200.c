/*
 * XREFs of sub_1800CD200 @ 0x1800CD200
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800CD200(_QWORD *a1, __int64 *a2)
{
  __int64 v4; // rax
  unsigned int v5; // eax
  __int64 *v6; // r8
...
LABEL_10:
    ...
    else if ( !sub_1800626C4((__int64)a1, v5) )
    {
      sub_1800CDB34(a1, *a2);
    }
    LOBYTE(v4) = sub_1800626B8((__int64)a1, 8);
    if ( (_BYTE)v4 )
    {
      v4 = a1[14];
      if ( v4 )
