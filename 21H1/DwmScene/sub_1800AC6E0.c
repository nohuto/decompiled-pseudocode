/*
 * XREFs of sub_1800AC6E0 @ 0x1800AC6E0
 * Callers:
...
__int64 __fastcall sub_1800AC6E0(__int64 a1, __int64 *a2, _DWORD *a3, int a4)
{
  _DWORD *v7; // rcx
  __int64 result; // rax
  __int64 v9; // rcx
  ...
  v17 = a4;
  si128 = 0LL;
  sub_18001CDF8(&v18, (__int64)a2);
  sub_1800A6F0C((__int64 **)(a1 + 1616), (__int64)v16, &v17);
  v7 = (_DWORD *)v16[0];
