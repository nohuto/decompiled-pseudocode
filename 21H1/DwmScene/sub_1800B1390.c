/*
 * XREFs of sub_1800B1390 @ 0x1800B1390
 * Callers:
 *     sub_1800B2120 @ 0x1800B2120 (sub_1800B2120.c)
 * Callees:
...
_QWORD *__fastcall sub_1800B1390(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_1800B0E34((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
