...
__int64 __fastcall sub_180014570(__int64 a1, __int64 a2)
{
  __int64 v3; // rax
  ...
  try
  {
    ...
    *((_QWORD *)&v25 + 1) = v4;
    ...
    v26 = *(__int64 **)(v25 + 384);
    v27 = *(__int64 **)(v25 + 376);
    sub_180013EF0(&v20, v27, v26, 0);
    if ( v20 == *(__int64 **)(v8 + 384) )
      v19 = 0LL;
    else
      sub_180013E8C((__int64 *)&v19, v20);
    if ( a2 )
    {
  ...
  {
    sub_18000DC98(retaddr, 87, (__int64)"SpectreMeshComponent.cpp", 0x80004005);
    return 2147500037LL;
  }
  return result;
}
