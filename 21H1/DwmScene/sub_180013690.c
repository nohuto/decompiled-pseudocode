...
_UNKNOWN **__fastcall sub_180013690(_DWORD *a1, unsigned __int64 a2, unsigned __int64 *a3, __int64 a4)
{
  _UNKNOWN **result; // rax
  __m128 v5; // xmm6
  __m128 v6; // xmm9
  ...
  result = &retaddr;
  if ( !a2 )
    wassert(L"Count > 0", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXCollision.inl", 0x772u);
  if ( !a3 )
    wassert(L"pPoints", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXCollision.inl", 0x773u);
  ...
  v12 = _mm_mul_ps(_mm_add_ps(v5, v6), (__m128)xmmword_18013A500);
  if ( !a1 )
  ...
  *a1 = v12.m128_i32[0];
  ...
  v13 = _mm_mul_ps(_mm_sub_ps(v5, v6), (__m128)xmmword_18013A500);
