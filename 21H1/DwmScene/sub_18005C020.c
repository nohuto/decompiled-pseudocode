...
__int64 sub_18005C020()
{
  ...
  if ( dword_1802191EC > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_1802191EC);
    if ( dword_1802191EC == -1 )
    {
      ...
      *(_BYTE *)v3 = 0;
      ...
      v4[3] = 15LL;
      *(_BYTE *)v4 = 0;
      byte_1802191E8 = sub_1800CF3A0(&v14, &v16);
      ...
      Init_thread_footer(&dword_1802191EC);
    }
  }
  if ( dword_1802191F4 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_1802191F4);
    if ( dword_1802191F4 == -1 )
    {
      ...
      *(_BYTE *)v8 = 0;
      ...
      v9[3] = 15LL;
      *(_BYTE *)v9 = 0;
      byte_1802191F0 = sub_1800CF3A0(&v14, &v16);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v10 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
      ...
      Init_thread_footer(&dword_1802191F4);
    }
  }
  return 0LL;
}
