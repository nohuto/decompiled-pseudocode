  ...
  *(_DWORD *)(a1 + 48) = a2;
  ...
  if ( (*(_DWORD *)(a1 + 48) & 0xFFFFFFFB) != 0 )
  {
    ...
    *(_BYTE *)(*(_QWORD *)(a1 + 32) + 72LL) = 1;
    ...
    if ( (*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v10 + 64LL))(v10, &unk_180209370, 0LL)
      || (*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v10 + 64LL))(v10, &unk_180209730, 0LL)
      || (*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v10 + 64LL))(v10, &unk_180209AF0, 0LL) )
    {
      v6 = 1;
    }
    LOBYTE(v13) = v6;
