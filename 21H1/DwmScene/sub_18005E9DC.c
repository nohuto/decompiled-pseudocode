...
{
  if ( dword_180219740 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_180219740);
    if ( dword_180219740 == -1 )
    {
      ...
      Init_thread_footer(&dword_180219740);
    }
  }
