/*
 * XREFs of sub_180093734 @ 0x180093734
 * Callers:
 ...
 *     sub_180093CB0 @ 0x180093CB0 (sub_180093CB0.c)
 * Callees:
...
__int64 __fastcall sub_180093734(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  __int64 *v5; // rax
  unsigned int v6; // eax
  ...
  if ( *(_BYTE *)(a1 + 310) )
  {
    ...
    sub_1800CB940((unsigned int)pExceptionObject, v6, 604, (unsigned int)v8, 0);
  ...
  if ( !a2 )
  {
    sub_18000FD48(v7);
    v5 = sub_18000FD48(v8);
    sub_180091370(pExceptionObject, v5, 609, (__int64)v7, 0);
    throw (Spectre::Engine::EngineInvalidPointerException *)pExceptionObject;
  }
  LOBYTE(a4) = a3;
  return sub_180093800(a1, a2, *(unsigned int *)(a1 + 120), a4);
}
