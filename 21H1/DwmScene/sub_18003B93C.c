/*
 * XREFs of sub_18003B93C @ 0x18003B93C
 * Callers:
...
void __fastcall sub_18003B93C(__int64 a1, const wchar_t *a2)
{
  unsigned int v4; // eax
  ...
  if ( a1 )
  {
    ...
    (*(void (__fastcall **)(__int64, void *, _QWORD, char *))(*(_QWORD *)a1 + 24LL))(a1, &unk_1801D6830, v4, String);
  }
}
