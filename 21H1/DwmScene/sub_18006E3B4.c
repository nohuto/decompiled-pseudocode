/*
 * XREFs of sub_18006E3B4 @ 0x18006E3B4
 * Callers:
 *     sub_180071490 @ 0x180071490 (sub_180071490.c)
 * Callees:
 *     sub_180022400 @ 0x180022400 (sub_180022400.c)
 *     sub_18006D3AC @ 0x18006D3AC (sub_18006D3AC.c)
 *     sub_18006F2C0 @ 0x18006F2C0 (sub_18006F2C0.c)
 *     memcmp @ 0x18011E0BE (memcmp.c)
 */

_QWORD *__fastcall sub_18006E3B4(__int64 **a1, _QWORD *a2, __int64 *a3, size_t *a4, _QWORD *a5)
{
  __int64 v9; // r12
  __int64 *v10; // rax
  const void *v11; // rdx
  ...
  if ( a1[1] )
  {
    if ( a3 == (__int64 *)*v10 )
    {
      ...
      if ( v16 < 0 )
      {
        sub_18006D3AC(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
      goto LABEL_90;
    }
    if ( a3 == v10 )
    {
      ...
      if ( v24 < 0 )
      {
        sub_18006D3AC(a1, a2, 0, v49, (int)a4, a5);
        return a2;
      }
      goto LABEL_91;
    }
    ...
    if ( v31 < 0 )
    {
      ...
      {
        if ( *(_BYTE *)(v32[2] + 25) )
          sub_18006D3AC(a1, a2, 0, v32, (int)a4, a5);
        else
          sub_18006D3AC(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
...
LABEL_90:
        v9 = (__int64)a5;
LABEL_91:
        *a2 = *(_QWORD *)sub_18006F2C0((_DWORD)a1, (unsigned int)&v53, 0, (_DWORD)a4, v9);
        return a2;
      }
    }
    if ( v48 )
      sub_18006D3AC(a1, a2, 0, a3, (int)a4, a5);
    else
      sub_18006D3AC(a1, a2, 1, (_QWORD *)v40, (int)a4, a5);
    return a2;
  }
  else
  {
    try
    {
      sub_18006D3AC(a1, a2, 1, v10, (int)a4, a5);
      result = a2;
    }
    catch ( ... )
    {
      sub_18007B550(v53, v52);
      throw;
    }
  }
  return result;
