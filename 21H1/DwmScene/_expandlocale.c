/*
 * XREFs of _expandlocale @ 0x18003BFEC
 * Callers:
 *     sub_18003CDF4 @ 0x18003CDF4 (sub_18003CDF4.c)
 * Callees:
 ...
 *     sub_18003BE80 @ 0x18003BE80 (sub_18003BE80.c)
 *     sub_18003CBD0 @ 0x18003CBD0 (sub_18003CBD0.c)
 *     CreateDXGIFactory1 @ 0x18010E514 (CreateDXGIFactory1.c)
...
LABEL_177:
  ...
  v98[0] = _mm_load_si128((const __m128i *)&xmmword_18013C110);
  v98[1] = _mm_load_si128((const __m128i *)&xmmword_18013C100);
  v99 = 37120;
  ...
  do
  {
    ...
    if ( v23 >= v18 && v23 <= a9 )
    {
      if ( v17 == v22 )
      {
        sub_18003BA7C((const void **)v89, v22, &v87);
        v17 = v90;
        v22 = v89[1];
        v18 = a8;
      }
  ...
  v101 = (a6 & 0x20) != 0;
  v27 = v84;
  v28 = sub_18001792C((__int64 *)&v84[1]);
  DXGIFactory1 = CreateDXGIFactory1(&stru_18013B4A0, (void **)v28);
  if ( DXGIFactory1 < 0 )
    goto LABEL_177;
  v30 = v89[0];
LABEL_30:
    ...
    for ( LODWORD(v85) = 0; ; LODWORD(v85) = (_DWORD)v85 + 1 )
    {
      ...
      if ( v33 == -2005270526 )
      {
        ...
        while ( 2 )
        {
          ...
          v88 = 0LL;
          v84 = 0LL;
          DXGIFactory1 = sub_18003CBD0(*a2, v30, v22 - v30, 7u, &v88, v86, &v84);
          if ( DXGIFactory1 < 0 )
          {
            v49 = *a2;
            if ( *a2 )
...
LABEL_105:
        ...
        if ( v82 == v30 )
        {
          sub_18003BA7C((const void **)v89, v30, &v85);
          v82 = v90;
          v22 = v89[1];
          v30 = v89[0];
        }
...
LABEL_46:
        ...
        if ( (v97 & 2) != 0 )
          v81 = -3.4028235e38;
        v37 = (float *)sub_18003B9FC((__int64)&v92, v92, &v81, (__int64 *)a2);
        sub_18003BE80(&v92, (__int64)v83, 0, v37 + 8, v37);
        goto LABEL_54;
      }
  ...
  if ( a5 == 1 )
  {
    *(_QWORD *)v86 = 0LL;
    v85 = 0LL;
    DXGIFactory1 = sub_18003CBD0(0LL, v30, v22 - v30, 7u, (ID3D11Device **)v86, &v91, &v85);
    if ( DXGIFactory1 >= 0 )
    {
      v87 = 0LL;
...
LABEL_172:
                  ...
                  sub_18003B93C((__int64)*a2, L"CoreEngine");
                  sub_18003B878(*a3, L"CoreEngine");
                  goto LABEL_129;
                }
              }
              else
...
LABEL_185:
  ...
  sub_18003BB84((__int64)&v92, (__int64)&v92, *(__int64 **)(v92 + 8));
  j_j__o_free(v92);
