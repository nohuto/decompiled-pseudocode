/*
 * XREFs of sub_18007E5D0 @ 0x18007E5D0
 * Callers:
...
__m128 *__fastcall sub_18007E5D0(__m128 *a1, __m128 *a2, __m128 *a3)
{
  __m128 v3; // xmm6
  __m128 *result; // rax
  __m128 v5; // xmm1
  ...
  *a1 = _mm_add_ps(
          _mm_add_ps(
            _mm_mul_ps(_mm_mul_ps(_mm_shuffle_ps(v7, v7, 27), _mm_shuffle_ps(*a3, *a3, 170)), (__m128)xmmword_1801C6670),
            _mm_mul_ps(_mm_mul_ps(_mm_shuffle_ps(*a3, *a3, 85), v7), (__m128)xmmword_1801C6660)),
          _mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(*a3, *a3, 255), v3), _mm_mul_ps((__m128)xmmword_1801C6650, v6)));
  return result;
}
