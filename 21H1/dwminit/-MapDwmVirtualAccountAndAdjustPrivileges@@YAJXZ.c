/*
 * XREFs of ?MapDwmVirtualAccountAndAdjustPrivileges@@YAJXZ @ 0x180001CFC
 * Callers:
...
LABEL_4:
  ...
  v4 = v2;
LABEL_18:
  MilInstrumentationCheckHR_MaybeFailFast(v1, &dword_180008090, 2u, v4, SubAuthority2, SubAuthority3);
LABEL_19:
  if ( v9 )
    RtlFreeSid(v9);
  if ( v10 )
