/*
 * XREFs of ?CreateInputObserverClientProxy@@YAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoInputObserverClientProxy@@@Z @ 0x1800F3DA8
 * Callers:
 ...
 *     ??0InputObserverClientProxy@@QEAA@PEAVCInputObserverManager@@@Z @ 0x1800F3D04 (--0InputObserverClientProxy@@QEAA@PEAVCInputObserverManager@@@Z.c)
 */
