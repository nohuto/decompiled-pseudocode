/*
 * XREFs of ?UpdatePenDeviceManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF3C8
 * Callers:
 ...
 *     ?Thunk_UpdatePenDeviceManager_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED4B0 (-Thunk_UpdatePenDeviceManager_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@.c)
 * Callees:
