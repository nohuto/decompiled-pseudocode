/*
 * XREFs of ?UpdateType@BamoDropTargetClientProxyImpl@BamoImpl@@QEAAJPEAU_GUID@@@Z @ 0x1800EFEEC
 * Callers:
 ...
 *     ?Thunk_UpdateType_29@?$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED5C0 (-Thunk_UpdateType_29@-$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@.c)
 * Callees:
