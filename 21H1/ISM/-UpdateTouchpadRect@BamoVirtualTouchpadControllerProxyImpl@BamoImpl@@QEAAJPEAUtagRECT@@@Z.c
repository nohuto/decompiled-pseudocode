/*
 * XREFs of ?UpdateTouchpadRect@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@QEAAJPEAUtagRECT@@@Z @ 0x1800F10A4
 * Callers:
 ...
 *     ?Thunk_UpdateTouchpadRect_39@?$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F0FF0 (-Thunk_UpdateTouchpadRect_39@-$IVirtualTouchpadControllerProxy_Receive@VBamoVirtualTouchpadContr.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoVirtualTouchpadControllerProxyImpl::UpdateTouchpadRect(
        ...
        struct tagRECT *a2)
{
  ...
  *(struct tagRECT *)((char *)this + 36) = *a2;
  if ( *((_BYTE *)this + 28) )
  {
