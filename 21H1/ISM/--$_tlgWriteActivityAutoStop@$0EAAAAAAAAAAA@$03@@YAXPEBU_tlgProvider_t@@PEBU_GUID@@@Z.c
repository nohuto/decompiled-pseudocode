/*
 * XREFs of ??$_tlgWriteActivityAutoStop@$0EAAAAAAAAAAA@$03@@YAXPEBU_tlgProvider_t@@PEBU_GUID@@@Z @ 0x180092198
 * Callers:
...
void __fastcall _tlgWriteActivityAutoStop<70368744177664,4>(_DWORD *a1)
{
  ...
  if ( *a1 > 4u && tlgKeywordOn((__int64)a1, 0x400000000000LL) )
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_1801CA0A5, v1, 0LL, 2u, &v3);
}
