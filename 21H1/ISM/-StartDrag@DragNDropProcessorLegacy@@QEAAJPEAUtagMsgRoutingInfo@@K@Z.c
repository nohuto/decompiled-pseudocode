/*
 * XREFs of ?StartDrag@DragNDropProcessorLegacy@@QEAAJPEAUtagMsgRoutingInfo@@K@Z @ 0x1801760E0
 * Callers:
 *     ?Thunk_StartDrag_0@?$IDragNDrop_Receive@VDragNDropProcessorLegacy@@@DragNDropMessageCall@@SAJPEAXPEAPEAX@Z @ 0x180176430 (-Thunk_StartDrag_0@-$IDragNDrop_Receive@VDragNDropProcessorLegacy@@@DragNDropMessageCall@@SAJPEA.c)
 * Callees:
...
LABEL_8:
      ...
      v30 = v28;
      v23 = 4;
      CoreUICallSend(v12, &v30, 1LL, 1LL, v23, &unk_1801C72CD, a3);
    }
    else
    {
      v16 = *(_QWORD *)(v15 + 20);
      ...
      v30 = v19;
      v26 = v16;
      if ( (int)CoreUICallSend(v21, &v25, 1LL, 1LL, v24, &unk_1801C72BE, v29) >= 0 )
      {
