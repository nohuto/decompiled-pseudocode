/*
 * XREFs of ?AddDefaultHandReport_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXU_GUID@@_JH@Z @ 0x1800DEC0C
 * Callers:
        ...
        int a4)
{
  ...
  if ( *(_DWORD *)v8[1] > 5u && tlgKeywordOn(v8[1], 2LL) )
  {
    ...
    v14 = a2;
    v15 = 16LL;
    tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801CDBE9, 0LL, 0LL, 6u, &v13);
  }
}
