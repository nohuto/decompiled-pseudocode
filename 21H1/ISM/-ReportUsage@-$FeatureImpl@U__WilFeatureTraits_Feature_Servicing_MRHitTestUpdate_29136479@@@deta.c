/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_MRHitTestUpdate_29136479@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18004039C
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_MRHitTestUpdate_29136479>::ReportUsage(
        wil::details *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
{
  ...
  if ( (*(_DWORD *)a1 & 2) == 0 )
  {
    v3 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_MRHitTestUpdate_29136479>::GetCachedFeatureEnabledState(
                      a1,
                      (signed __int32 *)&v6);
    v6 = v3;
  }
