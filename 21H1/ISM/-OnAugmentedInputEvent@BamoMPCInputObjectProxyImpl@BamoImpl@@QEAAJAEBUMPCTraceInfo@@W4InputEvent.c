/*
 * XREFs of ?OnAugmentedInputEvent@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJAEBUMPCTraceInfo@@W4InputEventType@Internal@Spatial@Input@UI@Windows@@AEBUAugmentedInputDataMsg@56789@_JAEBUHitObjectMsg@56789@@Z @ 0x1800E8D80
 * Callers:
        ...
        __int128 *a6)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      v34[1] = v32;
      v31 = 2;
      return CoreUICallSend(v13, v34, 2LL, 46LL, v31, &unk_1801C0255, (unsigned int)&v33);
    }
    else
    {
