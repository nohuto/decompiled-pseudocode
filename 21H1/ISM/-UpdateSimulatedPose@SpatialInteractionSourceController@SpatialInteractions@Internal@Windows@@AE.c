/*
 * XREFs of ?UpdateSimulatedPose@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAX_JAEBUPoseData@SpatialInteractionDevices@@PEAUISpatialGraphNodeReference@Holographic@34@AEBUMatrix4x4@Numerics@Foundation@4@3@Z @ 0x180170360
 * Callers:
        ...
        const struct Windows::Foundation::Numerics::Matrix4x4 *a6)
{
  ...
  else
  {
    ...
    v43[0] = a2;
    v12 = (__m128)xmmword_1801C7330;
    v44 = 3;
    v13 = (__m128)xmmword_1801C7340;
    v47 = xmmword_1801C7350;
    v45 = xmmword_1801C7330;
    v46 = xmmword_1801C7340;
  }
