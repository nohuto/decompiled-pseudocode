/*
 * XREFs of ??1BamoMPCManagerPrincipal@@MEAA@XZ @ 0x180071AF4
 * Callers:
 *     _MPCManager::MPCManager_::_1_::dtor$0 @ 0x1800514E9 (_MPCManager--MPCManager_--_1_--dtor$0.c)
 *     _PenDeviceManager::PenDeviceManager_::_1_::dtor$0 @ 0x18012EDC1 (_PenDeviceManager--PenDeviceManager_--_1_--dtor$0.c)
 * Callees:
