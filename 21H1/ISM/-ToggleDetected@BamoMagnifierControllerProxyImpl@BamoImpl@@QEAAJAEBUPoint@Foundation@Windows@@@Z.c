/*
 * XREFs of ?ToggleDetected@BamoMagnifierControllerProxyImpl@BamoImpl@@QEAAJAEBUPoint@Foundation@Windows@@@Z @ 0x180100F5C
 * Callers:
        ...
        struct IMessageCallSendHost **a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v10[1] = v13;
      v14 = v9;
      return CoreUICallSend(v7, v10, 2LL, 48LL, 0, &unk_1801C0262, (unsigned int)&v14);
    }
    else
    {
