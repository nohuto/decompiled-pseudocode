/*
 * XREFs of ?UpdateAutoForwardPolicy@ForegroundManager@@UEAAX_K0@Z @ 0x180014180
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@3@Z @ 0x18008714C (--$Write@U-$_tlgWrapperByVal@$07@@U1@@-$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUI.c)
 */
...
void __fastcall ForegroundManager::UpdateAutoForwardPolicy(ForegroundManager *this, __int64 a2, __int64 a3)
{
  ...
  {
    Context = &qword_180209628;
    qword_180209628 = &RawInputProvidersContinuousTracing::`vftable';
    qword_180209640 = (struct _tlgProvider_t *)&`InputTraceLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(_lambda_a8e7baa2fca040c17c3e795f3590cb07_::_lambda_invoker_cdecl_);
    wil::TraceLoggingProvider::Register(
      (wil::TraceLoggingProvider *)&qword_180209628,
      qword_180209640,
    ...
    InitOnceComplete(&`InputTraceLogging::Instance'::`2'::wrapper, 0, &qword_180209628);
  }
