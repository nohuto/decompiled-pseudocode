/*
 * XREFs of ?GetInputForwardTargetInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoInputForwardTargetInputObjectProxy@@XZ @ 0x180010AA0
 * Callers:
 *     <none>
 * Callees:
