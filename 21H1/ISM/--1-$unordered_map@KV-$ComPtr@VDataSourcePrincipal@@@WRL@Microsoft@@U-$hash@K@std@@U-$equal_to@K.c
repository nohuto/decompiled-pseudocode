/*
 * XREFs of ??1?$unordered_map@KV?$ComPtr@VDataSourcePrincipal@@@WRL@Microsoft@@U?$hash@K@std@@U?$equal_to@K@5@V?$allocator@U?$pair@$$CBKV?$ComPtr@VDataSourcePrincipal@@@WRL@Microsoft@@@std@@@5@@std@@QEAA@XZ @ 0x1800F86E4
 * Callers:
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$9 @ 0x1800F854A (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$9.c)
 *     _ResizeProcessor::ResizeProcessor_::_1_::dtor$7 @ 0x1800FDAB6 (_ResizeProcessor--ResizeProcessor_--_1_--dtor$7.c)
 * Callees:
