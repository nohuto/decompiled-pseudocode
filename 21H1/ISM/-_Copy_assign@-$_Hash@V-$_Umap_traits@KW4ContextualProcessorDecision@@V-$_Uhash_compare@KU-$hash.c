/*
 * XREFs of ?_Copy_assign@?$_Hash@V?$_Umap_traits@KW4ContextualProcessorDecision@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@@3@$0A@@std@@@std@@AEAAXAEBV12@U?$integral_constant@_N$0A@@2@@Z @ 0x18014DCE0
 * Callers:
 *     ??4ContextualProcessorMetadata@ContextualProcessorBuffer@@QEAAAEAU01@AEBU01@@Z @ 0x18014B5FC (--4ContextualProcessorMetadata@ContextualProcessorBuffer@@QEAAAEAU01@AEBU01@@Z.c)
