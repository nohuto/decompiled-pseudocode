/*
 * XREFs of ?CancelTapAndHold@ClickRecognizer@@AEAAXXZ @ 0x180184600
 * Callers:
 ...
 *     ?Reset@ClickRecognizer@@UEAAXPEBVGestureSession@@@Z @ 0x180184BB0 (-Reset@ClickRecognizer@@UEAAXPEBVGestureSession@@@Z.c)
 * Callees:
 *     <none>
 */
