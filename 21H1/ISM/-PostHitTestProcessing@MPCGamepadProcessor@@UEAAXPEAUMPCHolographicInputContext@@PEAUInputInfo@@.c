/*
 * XREFs of ?PostHitTestProcessing@MPCGamepadProcessor@@UEAAXPEAUMPCHolographicInputContext@@PEAUInputInfo@@@Z @ 0x180193990
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ShouldUseGazeAndCommit@MPCGamepadInputHelper@@QEAA_NPEAUInputInfo@@@Z @ 0x18006CFF0 (-ShouldUseGazeAndCommit@MPCGamepadInputHelper@@QEAA_NPEAUInputInfo@@@Z.c)
        ...
        struct InputInfo *a3)
{
  ...
  if ( !*((_BYTE *)this + 5030) && ShouldUseGazeAndCommit )
  ...
  *((_BYTE *)this + 5030) = v7;
  MPCSlateDeadzoneHelper::UpdateState(
    *((MPCSlateDeadzoneHelper **)this + 641),
    (v8 & 4) != 0,
    *((_QWORD *)a3 + 2),
    *((float *)a3 + 39),
    *((float *)a3 + 40),
  ...
  if ( IsPrimary )
  {
    ...
    if ( v14 )
    {
      ...
      *((_QWORD *)this + 629) = *((_QWORD *)v15 + 28);
      *((_DWORD *)this + 1260) = *((_DWORD *)v15 + 58);
      ...
      v19[2] = v23;
      v19[3] = v24;
      v17 = Windows::Foundation::Numerics::transform(v18, (float *)this + 1258, (float *)v19);
      *(_QWORD *)((char *)this + 5044) = *(_QWORD *)v17;
      *(float *)&v17 = v17[2];
      *((_OWORD *)this + 317) = 0LL;
      *((_DWORD *)this + 1263) = (_DWORD)v17;
    }
    if ( v11 )
    {
