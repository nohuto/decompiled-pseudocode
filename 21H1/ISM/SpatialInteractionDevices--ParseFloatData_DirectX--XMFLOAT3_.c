/*
 * XREFs of SpatialInteractionDevices::ParseFloatData_DirectX::XMFLOAT3_ @ 0x1800C7CF0
 * Callers:
  ...
  for ( i = 0; i < 3; ++i )
    result = result
          && (int)SpatialInteractionDevices::Internal::HIDGetFloat(
                    this,
                    a2,
                    (struct SpatialInteractionDevices::HID_REPORT *)&unk_1801AEDD8,
                    (enum _HIDP_REPORT_TYPE)*((unsigned __int16 *)&unk_1801AEDD8 + 8 * i),
                    *((_WORD *)&unk_1801AEDD8 + 8 * i + 1),
                    *((_WORD *)&unk_1801AEDD8 + 8 * i + 2),
                    *((_WORD *)&unk_1801AEDD8 + 8 * i + 3),
