/*
 * XREFs of ??$emplace_back@AEBW4SPATIAL_GAZE_CALIBRATION_REQUEST_EVENTS@@@?$deque@W4SPATIAL_GAZE_CALIBRATION_REQUEST_EVENTS@@V?$allocator@W4SPATIAL_GAZE_CALIBRATION_REQUEST_EVENTS@@@std@@@std@@QEAAXAEBW4SPATIAL_GAZE_CALIBRATION_REQUEST_EVENTS@@@Z @ 0x1800DB564
 * Callers:
 ...
 *     ?_Growmap@?$deque@W4SPATIAL_GAZE_CALIBRATION_REQUEST_EVENTS@@V?$allocator@W4SPATIAL_GAZE_CALIBRATION_REQUEST_EVENTS@@@std@@@std@@AEAAX_K@Z @ 0x1800DD8C0 (-_Growmap@-$deque@W4SPATIAL_GAZE_CALIBRATION_REQUEST_EVENTS@@V-$allocator@W4SPATIAL_GAZE_CALIBRA.c)
 */
