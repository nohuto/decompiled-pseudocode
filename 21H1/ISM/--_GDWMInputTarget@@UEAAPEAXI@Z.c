/*
 * XREFs of ??_GDWMInputTarget@@UEAAPEAXI@Z @ 0x1800B66B8
 * Callers:
 *     ??_EDWMInputTarget@@WDI@EAAPEAXI@Z @ 0x18004B160 (--_EDWMInputTarget@@WDI@EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1DWMInputTarget@@UEAA@XZ @ 0x1800B6620 (--1DWMInputTarget@@UEAA@XZ.c)
 */
