/*
 * XREFs of ?GetFloorDynamicNode@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAAJPEAUDynamicNodeInfo@234@@Z @ 0x18015CF80
 * Callers:
 *     ?GetFloorDynamicNode@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJPEAUDynamicNodeInfo@234@@Z @ 0x18004D010 (-GetFloorDynamicNode@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAAJPEAUDynamicN.c)
 * Callees:
...
LABEL_5:
  ...
  *(_OWORD *)a2 = v12;
  DevicePropertyOfKnownSize = (*(__int64 (__fastcall **)(Windows::Internal::Holographic::SpatialGraphDriverClient *, struct Windows::Internal::Holographic::DynamicNodeInfo *, char *))(*(_QWORD *)this + 144LL))(
                                this,
                                a2,
                                (char *)a2 + 16);
  v4 = DevicePropertyOfKnownSize;
