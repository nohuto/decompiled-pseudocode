/*
 * XREFs of ?UpdateEdgyControllerServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE1B8
 * Callers:
 ...
 *     ?Thunk_UpdateEdgyControllerServer_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED320 (-Thunk_UpdateEdgyControllerServer_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoI.c)
 * Callees:
