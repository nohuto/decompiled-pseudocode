/*
 * XREFs of ?OnInput@CursorSuppressionProcessor@@UEAAJPEAUInputInfo@@PEAVInputContext@@PEAUContextualProcessorResponse@@@Z @ 0x180171B90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?terminate@details@gsl@@YAXXZ @ 0x18009958C (-terminate@details@gsl@@YAXXZ.c)
