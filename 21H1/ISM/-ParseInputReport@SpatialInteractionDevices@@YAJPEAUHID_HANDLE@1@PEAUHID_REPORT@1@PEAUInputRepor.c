/*
 * XREFs of ?ParseInputReport@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEAUHID_REPORT@1@PEAUInputReport@1@@Z @ 0x1800C9A4C
 * Callers:
 ...
 *     SpatialInteractionDevices::ReadPosePosition @ 0x1800CA454 (SpatialInteractionDevices--ReadPosePosition.c)
 *     SpatialInteractionDevices::ReadThumbstick @ 0x1800CA47C (SpatialInteractionDevices--ReadThumbstick.c)
 *     SpatialInteractionDevices::ReadTouchpad @ 0x1800CA508 (SpatialInteractionDevices--ReadTouchpad.c)
 *     SpatialInteractionDevices::ReadTrigger @ 0x1800CA594 (SpatialInteractionDevices--ReadTrigger.c)
 *     ?find@?$_Tree@V?$_Tmap_traits@EV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@U?$less@E@2@V?$allocator@U?$pair@$$CBEV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@@std@@@2@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBEV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@@std@@@std@@@std@@@2@AEBE@Z @ 0x1800CAB00 (-find@-$_Tree@V-$_Tmap_traits@EV-$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@.c)
 */
