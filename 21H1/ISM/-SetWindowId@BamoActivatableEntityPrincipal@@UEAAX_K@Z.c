/*
 * XREFs of ?SetWindowId@BamoActivatableEntityPrincipal@@UEAAX_K@Z @ 0x180005730
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateWindowIdRemoteCacheStatic@BamoActivatableEntityPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x180105D6C (-UpdateWindowIdRemoteCacheStatic@BamoActivatableEntityPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImp.c)
 */
