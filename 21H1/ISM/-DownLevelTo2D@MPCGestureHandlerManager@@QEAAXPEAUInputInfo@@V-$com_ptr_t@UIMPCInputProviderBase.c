/*
 * XREFs of ?DownLevelTo2D@MPCGestureHandlerManager@@QEAAXPEAUInputInfo@@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x18006B6B4
 * Callers:
 ...
 *     ?GetGestureHandlerForWorkspace@MPCGestureHandlerManager@@AEAA?AV?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@wil@@K@Z @ 0x18006B928 (-GetGestureHandlerForWorkspace@MPCGestureHandlerManager@@AEAA-AV-$com_ptr_t@VMPCGestureHandler@@.c)
 ...
 *     ?attach@?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@wil@@QEAAXPEAVMPCGestureHandler@@@Z @ 0x18006C684 (-attach@-$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@wil@@QEAAXPEAVMPCGestureHand.c)
 *     ?find@?$_Tree@V?$_Tmap_traits@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@V?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@2@U?$less@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@std@@V?$allocator@U?$pair@$$CBV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@V?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@2@@std@@@5@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@V?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@2@@std@@@std@@@std@@@2@AEBV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x18006C9EC (-find@-$_Tree@V-$_Tmap_traits@V-$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@w.c)
...
__int64 __fastcall MPCGestureHandlerManager::DownLevelTo2D(__int64 *a1, __int64 a2, _QWORD *a3, const char *a4)
{
  MPCGestureHandler *v7; // r14
  __int64 **v8; // r15
  __int64 **v9; // rax
  __int64 v10; // r9
  ...
  __int64 *v13; // rax
  __int64 v14; // rcx
  MPCGestureHandler *v15; // rdi
  MPCGestureHandler *v16; // rbx
  MPCGestureHandler **GestureHandlerForWorkspace; // rax
  MPCGestureHandler *v18; // rdx
  __int64 v19; // r9
  __int64 *v20; // rax
  __int64 v21; // rcx
  unsigned __int64 v22; // rdx
  __int64 v23; // rdi
  _QWORD *v25; // [rsp+30h] [rbp-10h] BYREF
  __int64 v26; // [rsp+38h] [rbp-8h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+78h] [rbp+38h]
  MPCGestureHandler *v28; // [rsp+98h] [rbp+58h] BYREF
...
LABEL_11:
  ...
  v15 = (MPCGestureHandler *)v13[5];
  v16 = v15;
  v28 = v15;
  if ( !v15 )
    goto LABEL_17;
  (*(void (__fastcall **)(MPCGestureHandler *))(*(_QWORD *)v15 + 8LL))(v15);
  wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v25, *a3);
  v7 = v15;
  if ( !(unsigned __int8)MPCGestureHandler::IsInjecting(v15, &v25) && *((_DWORD *)v15 + 228) != *(_DWORD *)(a2 + 696) )
  {
    wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v25, *a3);
    MPCGestureHandlerManager::DetachProvider((MPCGestureHandlerManager *)a1, &v25);
    v16 = 0LL;
    v28 = 0LL;
    (*(void (__fastcall **)(MPCGestureHandler *))(*(_QWORD *)v15 + 16LL))(v15);
    v7 = 0LL;
  }
  if ( !v7 )
  {
LABEL_17:
    GestureHandlerForWorkspace = (MPCGestureHandler **)MPCGestureHandlerManager::GetGestureHandlerForWorkspace(
                                                         a1,
                                                         &v25,
                                                         *(unsigned int *)(a2 + 696));
    v18 = *GestureHandlerForWorkspace;
    *GestureHandlerForWorkspace = v7;
    wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>::attach(&v28, v18);
    ...
    wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v25, *a3);
    v16 = v28;
    MPCGestureHandler::AttachProvider(v28, &v25);
    v20 = *v8;
    v21 = (*v8)[1];
    if ( *(_BYTE *)(v21 + 25) != (_BYTE)v7 )
      goto LABEL_25;
    v22 = *a3;
    do
    {
    ...
    while ( *(_BYTE *)(v21 + 25) == (_BYTE)v7 );
    if ( v20 == *v8 || v22 < v20[4] )
    {
LABEL_25:
      v25 = a3;
      v20 = (__int64 *)*std::_Tree<std::_Tmap_traits<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>,std::less<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>>,std::allocator<std::pair<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>>,0>>::emplace_hint<std::piecewise_construct_t const &,std::tuple<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy> const &>,std::tuple<>>(
                          a1 + 3,
                          &v26,
                          v20,
                          v19,
    ...
    v20[5] = (__int64)v16;
    if ( v16 )
      (*(void (__fastcall **)(MPCGestureHandler *))(*(_QWORD *)v16 + 8LL))(v16);
    if ( v23 )
      (*(void (__fastcall **)(__int64))(*(_QWORD *)v23 + 16LL))(v23);
  }
  wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(&v25, *a3);
  MPCGestureHandler::DownLevelTo2D(v16, (struct LegacyInputInfo *)a2);
  wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>::~com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>((__int64 *)&v28);
