/*
 * XREFs of ?SetResult@BamoAsyncResult_string_PrincipalImpl@BamoImpl@@QEAAJPEBG@Z @ 0x18011B6A8
 * Callers:
 *     ?Thunk_SetResult_0@?$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011B7B0 (-Thunk_SetResult_0@-$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl.c)
 * Callees:
