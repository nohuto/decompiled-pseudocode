/*
 * XREFs of ?SendAckProxyReference@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@UEAAXI_N@Z @ 0x180073F10
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v5 = 9;
  v4 = CoreUICallSend(v3, v6, 2LL, 1LL, v5, &unk_1801C28EE, a2);
  if ( v4 < 0 )
  {
