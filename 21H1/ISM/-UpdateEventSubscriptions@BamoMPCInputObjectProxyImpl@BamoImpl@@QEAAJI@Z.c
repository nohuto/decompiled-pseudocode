/*
 * XREFs of ?UpdateEventSubscriptions@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE4C0
 * Callers:
 ...
 *     ?Thunk_UpdateEventSubscriptions_10@?$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED360 (-Thunk_UpdateEventSubscriptions_10@-$IMPCInputObjectProxy_Receive@VBamoMPCInputObjectProxyImpl@B.c)
 * Callees:
