/*
 * XREFs of ?Create@MouseProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180022690
 * Callers:
 *     <none>
 * Callees:
 *     ?Initialize@MouseProcessor@@IEAAJXZ @ 0x180022708 (-Initialize@MouseProcessor@@IEAAJXZ.c)
 *     ??0MouseProcessor@@IEAA@PEAUInputProcessorCreateParams@@@Z @ 0x180023A84 (--0MouseProcessor@@IEAA@PEAUInputProcessorCreateParams@@@Z.c)
