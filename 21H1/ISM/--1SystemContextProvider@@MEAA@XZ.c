/*
 * XREFs of ??1SystemContextProvider@@MEAA@XZ @ 0x180147A54
 * Callers:
 *     ??_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z @ 0x180145B80 (--_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z.c)
 *     _VirtualTouchpadContextProvider::Create_::_1_::dtor$2 @ 0x180145D7C (_VirtualTouchpadContextProvider--Create_--_1_--dtor$2.c)
