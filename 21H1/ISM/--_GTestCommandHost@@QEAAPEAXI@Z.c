/*
 * XREFs of ??_GTestCommandHost@@QEAAPEAXI@Z @ 0x1800BC6B4
 * Callers:
 *     ?Initialize@InputStateManager@@IEAAJXZ @ 0x180022068 (-Initialize@InputStateManager@@IEAAJXZ.c)
 *     ??1?$unique_ptr@VTestCommandHost@@U?$default_delete@VTestCommandHost@@@std@@@std@@QEAA@XZ @ 0x18003B480 (--1-$unique_ptr@VTestCommandHost@@U-$default_delete@VTestCommandHost@@@std@@@std@@QEAA@XZ.c)
 * Callees:
