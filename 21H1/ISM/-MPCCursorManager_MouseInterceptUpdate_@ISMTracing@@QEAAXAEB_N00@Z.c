/*
 * XREFs of ?MPCCursorManager_MouseInterceptUpdate_@ISMTracing@@QEAAXAEB_N00@Z @ 0x18007C6B4
 * Callers:
        ...
        const bool *a4)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( **((_DWORD **)v8 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v8 + 1), 1LL) )
    {
      ...
      v20 = v9;
      v17 = v9;
      tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801C921C, 0LL, 0LL, 5u, &v15);
    }
  }
}
