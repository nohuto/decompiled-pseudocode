/*
 * XREFs of ?RegisterInputSiteElement@BamoInputSiteManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoInputSiteElementPrincipal@@@Z @ 0x1800EB6CC
 * Callers:
        ...
        struct BamoInputSiteElementPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this[2] + 3) + 32LL) + 56LL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v9[0] = v11;
      v9[1] = v12;
      return CoreUICallSend(v7, v9, 2LL, 42LL, 0, &unk_1801C019A, v4);
    }
    else
    {
