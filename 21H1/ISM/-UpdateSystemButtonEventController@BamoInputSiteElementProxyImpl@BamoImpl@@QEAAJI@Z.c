/*
 * XREFs of ?UpdateSystemButtonEventController@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800F3950
 * Callers:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 23) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 208LL))((char *)this - 16);
    if ( v9 < 0 )
