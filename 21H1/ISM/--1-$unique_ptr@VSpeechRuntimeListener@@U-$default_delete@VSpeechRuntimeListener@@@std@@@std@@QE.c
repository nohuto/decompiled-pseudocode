/*
 * XREFs of ??1?$unique_ptr@VSpeechRuntimeListener@@U?$default_delete@VSpeechRuntimeListener@@@std@@@std@@QEAA@XZ @ 0x18008BA78
 * Callers:
 *     _SpectrumListener::SpectrumListener_::_1_::dtor$2 @ 0x18008BA1B (_SpectrumListener--SpectrumListener_--_1_--dtor$2.c)
 * Callees:
