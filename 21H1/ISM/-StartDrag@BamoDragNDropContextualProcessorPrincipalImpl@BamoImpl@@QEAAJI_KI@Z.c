/*
 * XREFs of ?StartDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJI_KI@Z @ 0x1800F6414
 * Callers:
 *     ?Thunk_StartDrag_107@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F65E0 (-Thunk_StartDrag_107@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualPr.c)
 * Callees:
