/*
 * XREFs of ??1?$list@U?$pair@$$CBKUUsageList@ConsumerControlDeviceCollection@@@std@@V?$allocator@U?$pair@$$CBKUUsageList@ConsumerControlDeviceCollection@@@std@@@2@@std@@QEAA@XZ @ 0x180097B40
 * Callers:
 *     _std::_Hash_std::_Umap_traits_unsigned_long_ConsumerControlDeviceCollection::UsageList_std::_Uhash_compare_unsigned_long_std::hash_unsigned_long__std::equal_to_unsigned_long____std::allocator_std::pair_unsigned_long_const__ConsumerControlDeviceCollection::UsageList____0___::_Hash_std::_Umap_traits_unsigned_long_ConsumerControlDeviceCollection::UsageList_std::_Uhash_compare_unsigned_long_std::hash_unsigned_long__std::equal_to_unsigned_long____std::allocator_std::pair_unsigned_long_const__ConsumerControlDeviceCollection::UsageList____0____::_1_::dtor$0 @ 0x180097978 (_std--_Hash_std--_Umap_traits_unsigned_long_ConsumerControlDeviceCollection--UsageList_std--_Uha.c)
 * Callees:
