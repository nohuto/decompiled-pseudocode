/*
 * XREFs of ?_Growmap@?$deque@UCachedInputInfo@@V?$allocator@UCachedInputInfo@@@std@@@std@@AEAAX_K@Z @ 0x1800B3C0C
 * Callers:
...
void std::deque<CachedInputInfo>::_Growmap()
{
  ...
  v7 = *((_QWORD *)&Win32kInterop::s_inputInfoCachedQueue + 1) + 8 * qword_180209BE0 - (_QWORD)v6;
  ...
  if ( *((_QWORD *)&Win32kInterop::s_inputInfoCachedQueue + 1) )
    std::_Deallocate<16,0>(
      *((void **)&Win32kInterop::s_inputInfoCachedQueue + 1),
      (const struct std::nothrow_t *)(8 * qword_180209BE0));
  qword_180209BE0 += v2;
