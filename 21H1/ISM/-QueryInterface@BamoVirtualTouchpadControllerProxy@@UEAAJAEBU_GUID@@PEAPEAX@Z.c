/*
 * XREFs of ?QueryInterface@BamoVirtualTouchpadControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F0C80
 * Callers:
 *     ?QueryInterface@BamoVirtualTouchpadControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004BA00 (-QueryInterface@BamoVirtualTouchpadControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
