/*
 * XREFs of ??_GDragNDropProcessorLegacy@@EEAAPEAXI@Z @ 0x180174AF8
 * Callers:
 *     ??_EDragNDropProcessorLegacy@@G7EAAPEAXI@Z @ 0x18004D350 (--_EDragNDropProcessorLegacy@@G7EAAPEAXI@Z.c)
 * Callees:
