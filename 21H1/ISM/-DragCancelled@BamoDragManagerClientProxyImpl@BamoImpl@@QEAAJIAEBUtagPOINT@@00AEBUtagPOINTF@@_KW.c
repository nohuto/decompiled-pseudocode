/*
 * XREFs of ?DragCancelled@BamoDragManagerClientProxyImpl@BamoImpl@@QEAAJIAEBUtagPOINT@@00AEBUtagPOINTF@@_KW4VirtualKeyModifiers@System@Windows@@@Z @ 0x1800E57D4
 * Callers:
        ...
        struct IMessageCallSendHost **a6)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v12 >= 0 )
    {
      ...
      v18[1] = v15;
      v16 = 3;
      return CoreUICallSend(v14, v19, 2LL, 24LL, v16, &unk_1801C01E5, a2);
    }
    else
    {
