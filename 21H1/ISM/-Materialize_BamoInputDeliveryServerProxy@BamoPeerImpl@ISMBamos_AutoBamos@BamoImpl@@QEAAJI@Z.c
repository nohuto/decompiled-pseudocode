/*
 * XREFs of ?Materialize_BamoInputDeliveryServerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7808
 * Callers:
 *     ?Thunk_Materialize_BamoInputDeliveryServerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED030 (-Thunk_Materialize_BamoInputDeliveryServerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
