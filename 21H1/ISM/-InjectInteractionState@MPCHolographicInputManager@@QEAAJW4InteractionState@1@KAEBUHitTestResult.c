/*
 * XREFs of ?InjectInteractionState@MPCHolographicInputManager@@QEAAJW4InteractionState@1@KAEBUHitTestResult3D@@PEAUIMPCTarget@@@Z @ 0x1800764B0
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)a5 + 32LL))(a5) )
  {
    ...
    if ( !v11 )
    {
      ...
      v24[1] = v12;
      v24[2] = v13;
      lambda_cc0e1b3c83e11d2fdea074ed31cebb6d_::operator()((__int64)&v21, (__int64)Src, 4u, 1, a3, v24);
      memcpy_0(v26, Src, sizeof(v26));
      lambda_601022215588f7bf885c1aacc67fc90b_::operator()(v22, (__int64)v26);
    }
    if ( a2 == 1 )
    {
      *(_BYTE *)(a1 + 2368) = 1;
...
LABEL_17:
      ...
      v25[1] = v19;
      v25[2] = v20;
      lambda_cc0e1b3c83e11d2fdea074ed31cebb6d_::operator()((__int64)&v21, (__int64)v29, v18, a2, a3, v25);
      if ( v30 == 3 )
      {
        v30 = 6;
        memcpy_0(v27, v29, sizeof(v27));
        lambda_601022215588f7bf885c1aacc67fc90b_::operator()(v22, (__int64)v27);
        v30 = 3;
      }
      memcpy_0(v28, v29, sizeof(v28));
      lambda_601022215588f7bf885c1aacc67fc90b_::operator()(v22, (__int64)v28);
      return 0LL;
    }
LABEL_13:
    *(_BYTE *)(a1 + 2368) = 0;
