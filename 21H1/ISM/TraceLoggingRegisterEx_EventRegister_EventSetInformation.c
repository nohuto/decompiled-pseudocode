/*
 * XREFs of TraceLoggingRegisterEx_EventRegister_EventSetInformation @ 0x1800371A8
 * Callers:
 ...
 *     _anonymous_namespace_::EtwLogRegistrar::EtwLogRegistrar @ 0x18003ABF0 (_anonymous_namespace_--EtwLogRegistrar--EtwLogRegistrar.c)
 * Callees:
