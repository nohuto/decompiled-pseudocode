/*
 * XREFs of ??1?$vector@V?$com_ptr_t@UIHeadEventHandler@@Uerr_exception_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIHeadEventHandler@@Uerr_exception_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x18007AC80
 * Callers:
 *     _MPCGestureHandler::MPCGestureHandler_::_1_::dtor$5 @ 0x18007AB28 (_MPCGestureHandler--MPCGestureHandler_--_1_--dtor$5.c)
 *     _MPCHeadUpdateListener::OnHeadEventOccurredWorkerThread_::_1_::dtor$1 @ 0x18008DD52 (_MPCHeadUpdateListener--OnHeadEventOccurredWorkerThread_--_1_--dtor$1.c)
 * Callees:
