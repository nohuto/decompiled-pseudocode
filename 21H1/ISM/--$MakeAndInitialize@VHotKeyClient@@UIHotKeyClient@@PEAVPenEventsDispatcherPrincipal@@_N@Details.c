/*
 * XREFs of ??$MakeAndInitialize@VHotKeyClient@@UIHotKeyClient@@PEAVPenEventsDispatcherPrincipal@@_N@Details@WRL@Microsoft@@YAJPEAPEAUIHotKeyClient@@$$QEAPEAVPenEventsDispatcherPrincipal@@$$QEA_N@Z @ 0x18013256C
 * Callers:
 *     ??$MakeAndInitialize@VHotKeyClient@@UIHotKeyClient@@PEAVPenEventsDispatcherPrincipal@@_N@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@UIHotKeyClient@@@WRL@Microsoft@@@012@$$QEAPEAVPenEventsDispatcherPrincipal@@$$QEA_N@Z @ 0x18013263C (--$MakeAndInitialize@VHotKeyClient@@UIHotKeyClient@@PEAVPenEventsDispatcherPrincipa_ea_18013263C.c)
 * Callees:
 *     ??2@YAPEAX_KAEBUnothrow_t@std@@@Z @ 0x18003D280 (--2@YAPEAX_KAEBUnothrow_t@std@@@Z.c)
 *     _guard_dispatch_icall_nop @ 0x18004ACA0 (_guard_dispatch_icall_nop.c)
 *     ??0HotKeyClient@@QEAA@XZ @ 0x18014816C (--0HotKeyClient@@QEAA@XZ.c)
