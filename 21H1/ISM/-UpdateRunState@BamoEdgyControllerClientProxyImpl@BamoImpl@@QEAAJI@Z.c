/*
 * XREFs of ?UpdateRunState@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1801004C0
 * Callers:
 ...
 *     ?Thunk_UpdateRunState_10@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801002A0 (-Thunk_UpdateRunState_10@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl.c)
 * Callees:
