/*
 * XREFs of ?Release@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x180066DE4
 * Callers:
 ...
 *     ?Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ @ 0x1800653A0 (-Destroy@SemaphoreValue@details_abi@wil@@QEAAXXZ.c)
