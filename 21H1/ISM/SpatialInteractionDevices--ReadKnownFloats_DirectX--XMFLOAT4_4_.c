/*
 * XREFs of SpatialInteractionDevices::ReadKnownFloats_DirectX::XMFLOAT4_4_ @ 0x1800C8010
 * Callers:
 *     SpatialInteractionDevices::ReadLocalOrientation @ 0x1800CA38C (SpatialInteractionDevices--ReadLocalOrientation.c)
 * Callees:
