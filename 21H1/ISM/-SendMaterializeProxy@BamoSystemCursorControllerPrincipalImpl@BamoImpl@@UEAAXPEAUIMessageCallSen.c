        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v23, 2LL, 74LL, 46, &unk_1801C019A, v21);
  if ( v8 < 0 )
  {
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    v24 = v10;
    LOWORD(v19) = 0;
    v14 = CoreUICallSend(SendHost, &v23, 2LL, 63LL, v19, &unk_1801C0291, v12);
  ...
  v24 = *(unsigned int *)(v3 + 40);
  LOWORD(v19) = 55;
  v17 = CoreUICallSend(a2, &v23, 2LL, 74LL, v19, &unk_1801C019A, v22);
  if ( v17 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
