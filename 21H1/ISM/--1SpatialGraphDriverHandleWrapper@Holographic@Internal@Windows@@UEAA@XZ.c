/*
 * XREFs of ??1SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@UEAA@XZ @ 0x180158138
 * Callers:
 ...
 *     ?WaitForCompletion@ChainedThreadpoolWorker@ThreadHelpers@@QEAAXXZ @ 0x180166E20 (-WaitForCompletion@ChainedThreadpoolWorker@ThreadHelpers@@QEAAXXZ.c)
 */
