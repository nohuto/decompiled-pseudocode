/*
 * XREFs of ??1?$vector@V?$ComPtr@VEdgyControllerClientProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VEdgyControllerClientProxy@@@WRL@Microsoft@@@std@@@std@@QEAA@XZ @ 0x180049904
 * Callers:
 ...
 *     _Edge::Edge_::_1_::dtor$2 @ 0x180178C09 (_Edge--Edge_--_1_--dtor$2.c)
 *     _Edge::Edge_::_1_::dtor$2_0 @ 0x180178C9D (_Edge--Edge_--_1_--dtor$2_0.c)
