/*
 * XREFs of ?QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EA470
 * Callers:
 *     ?QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B860 (-QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
