/*
 * XREFs of ?RecordContacts@TouchContactFilter@@QEAAXKPEBUTouchContactInfo@@@Z @ 0x180185558
 * Callers:
 *     ?Add@GestureSession@@UEAAJKKKPEBUTouchContactInfo@@@Z @ 0x180182E30 (-Add@GestureSession@@UEAAJKKKPEBUTouchContactInfo@@@Z.c)
 * Callees:
