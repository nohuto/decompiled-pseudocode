/*
 * XREFs of ?RuntimeClassInitialize@TextInputStateAdapter@@QEAAJPEAUITextInputStateAdapterOwner@@@Z @ 0x1801A3EF8
 * Callers:
...
LABEL_18:
      ...
      {
        if ( v17 == -2147024882 )
          FailFastWithHR(-2147024882, retaddr, 0x37DuLL);
        FailFastWithHR(v7, retaddr, 0x37DuLL);
      }
    }
    else if ( (Microsoft_WindowsPhone_InputEnableBits & 1) != 0 )
    {
      McTemplateU0sqq_EventWriteTransfer(v16, v15, "TextInputStateAdapter::RuntimeClassInitialize", 881LL, v7);
    }
  }
  else if ( (Microsoft_WindowsPhone_InputEnableBits & 1) != 0 )
  {
    McTemplateU0sqq_EventWriteTransfer(v12, v11, "TextInputStateAdapter::RuntimeClassInitialize", 878LL, v7);
  }
LABEL_26:
  v18 = v20;
  v20 = 0LL;
