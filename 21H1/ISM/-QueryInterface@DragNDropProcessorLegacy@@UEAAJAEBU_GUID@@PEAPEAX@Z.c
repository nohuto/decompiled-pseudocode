/*
 * XREFs of ?QueryInterface@DragNDropProcessorLegacy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180176030
 * Callers:
 *     ?QueryInterface@DragNDropProcessorLegacy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004D360 (-QueryInterface@DragNDropProcessorLegacy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
