/*
 * XREFs of ?Initialize3DComponents@MPCGamepadProcessor@@UEAAXXZ @ 0x1801927E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$make_unique@VMPCButtonHoldHelper@@M$0A@@std@@YA?AV?$unique_ptr@VMPCButtonHoldHelper@@U?$default_delete@VMPCButtonHoldHelper@@@std@@@0@$$QEAM@Z @ 0x18007D32C (--$make_unique@VMPCButtonHoldHelper@@M$0A@@std@@YA-AV-$unique_ptr@VMPCButtonHoldHelper@@U-$defau.c)
 *     ??$make_unique@VMPCSlateDeadzoneHelper@@MM$0A@@std@@YA?AV?$unique_ptr@VMPCSlateDeadzoneHelper@@U?$default_delete@VMPCSlateDeadzoneHelper@@@std@@@0@$$QEAM0@Z @ 0x18007D370 (--$make_unique@VMPCSlateDeadzoneHelper@@MM$0A@@std@@YA-AV-$unique_ptr@VMPCSlateDeadzoneHelper@@U.c)
 ...
 *     ??4?$unique_ptr@VMPCSlateDeadzoneHelper@@U?$default_delete@VMPCSlateDeadzoneHelper@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x18007D7CC (--4-$unique_ptr@VMPCSlateDeadzoneHelper@@U-$default_delete@VMPCSlateDeadzoneHelper@@@std@@@std@@.c)
...
void __fastcall MPCGamepadProcessor::Initialize3DComponents(MPCGamepadProcessor *this)
{
  ...
  v3 = std::make_unique<MPCButtonHoldHelper,float,0>(&v15, flt_1801C6ED0);
  std::unique_ptr<MPCButtonHoldHelper>::operator=((__int64 *)this + 639, v3);
  if ( v15 )
    std::default_delete<MPCSpatialGestureRecognizerHandler>::operator()(v4, v15);
  v5 = std::make_unique<MPCButtonHoldHelper,float,0>(&v15, flt_1801C6ED0);
  std::unique_ptr<MPCButtonHoldHelper>::operator=((__int64 *)this + 640, v5);
  if ( v15 )
  ...
  *(_QWORD *)&v13 = L"SelectXYDeadzone1M";
  ...
  std::unique_ptr<MPCSlateDeadzoneHelper>::operator=((_QWORD **)this + 641, v10);
  v11 = v17;
  if ( v17 )
  {
