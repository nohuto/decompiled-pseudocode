/*
 * XREFs of ??1DeviceState@MagnifierProcessor@@UEAA@XZ @ 0x18017CF60
 * Callers:
 *     ??_EDeviceState@MagnifierProcessor@@UEAAPEAXI@Z @ 0x18017D040 (--_EDeviceState@MagnifierProcessor@@UEAAPEAXI@Z.c)
 * Callees:
