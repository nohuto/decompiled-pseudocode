/*
 * XREFs of ??$MakeAndInitialize@V?$Singleton@VSpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@V1234@@WRL@Microsoft@@UIInspectable@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIInspectable@@@Z @ 0x18014F740
 * Callers:
 ...
 *     ??0SpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@QEAA@XZ @ 0x180157180 (--0SpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@QEAA@XZ.c)
 *     SpatialGraphDriverClientHelpers::DefaultSpatialGraphSettings @ 0x18015B1FC (SpatialGraphDriverClientHelpers--DefaultSpatialGraphSettings.c)
