/*
 * XREFs of ?DispatchNextCallback@SipcServer@@UEAAJXZ @ 0x180039900
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Disconnect@SipcEndpoint@@QEAAX_N@Z @ 0x1800C0524 (-Disconnect@SipcEndpoint@@QEAAX_N@Z.c)
