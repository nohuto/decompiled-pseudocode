/*
 * XREFs of ?EdgyGestureDetected@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJPEBGIAEBUD2D_VECTOR_2F@@_K12II@Z @ 0x1800FFD98
 * Callers:
...
LABEL_3:
  ...
  v17[1] = v15;
  v16[0] = v14;
  return CoreUICallSend(v12, v17, 2LL, 29LL, 0, &unk_1801C020B, v7);
}
