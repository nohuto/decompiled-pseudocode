/*
 * XREFs of ?QueryInterface@BamoUIAHitTestStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180187A50
 * Callers:
 *     ?QueryInterface@BamoUIAHitTestStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004D5B0 (-QueryInterface@BamoUIAHitTestStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
