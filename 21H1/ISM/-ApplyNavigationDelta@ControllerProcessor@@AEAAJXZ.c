/*
 * XREFs of ?ApplyNavigationDelta@ControllerProcessor@@AEAAJXZ @ 0x18011FF84
 * Callers:
 ...
 *     ?SendPointerDelta@ControllerProcessor@@AEAAJUtagPOINT@@@Z @ 0x1801228AC (-SendPointerDelta@ControllerProcessor@@AEAAJUtagPOINT@@@Z.c)
