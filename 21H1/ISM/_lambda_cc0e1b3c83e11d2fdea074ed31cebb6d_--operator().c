/*
 * XREFs of _lambda_cc0e1b3c83e11d2fdea074ed31cebb6d_::operator() @ 0x18003FCAC
 * Callers:
...
__int64 __fastcall lambda_cc0e1b3c83e11d2fdea074ed31cebb6d_::operator()(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        int a4,
