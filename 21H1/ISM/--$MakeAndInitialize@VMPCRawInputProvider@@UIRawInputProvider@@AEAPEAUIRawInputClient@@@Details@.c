/*
 * XREFs of ??$MakeAndInitialize@VMPCRawInputProvider@@UIRawInputProvider@@AEAPEAUIRawInputClient@@@Details@WRL@Microsoft@@YAJPEAPEAUIRawInputProvider@@AEAPEAUIRawInputClient@@@Z @ 0x180020420
 * Callers:
 ...
 *     ??0MPCRawInputProvider@@QEAA@XZ @ 0x180020354 (--0MPCRawInputProvider@@QEAA@XZ.c)
