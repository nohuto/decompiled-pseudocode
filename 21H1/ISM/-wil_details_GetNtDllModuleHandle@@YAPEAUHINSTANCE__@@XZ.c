/*
 * XREFs of ?wil_details_GetNtDllModuleHandle@@YAPEAUHINSTANCE__@@XZ @ 0x18003712C
 * Callers:
 ...
 *     ?RtlDllShutdownInProgress@details@wil@@YAEXZ @ 0x180036FD0 (-RtlDllShutdownInProgress@details@wil@@YAEXZ.c)
 *     ?RtlDisownModuleHeapAllocation@details@wil@@YAJPEAX0@Z @ 0x180037030 (-RtlDisownModuleHeapAllocation@details@wil@@YAJPEAX0@Z.c)
 ...
 *     ?RtlNtStatusToDosErrorNoTeb@details@wil@@YAKJ@Z @ 0x180067540 (-RtlNtStatusToDosErrorNoTeb@details@wil@@YAKJ@Z.c)
