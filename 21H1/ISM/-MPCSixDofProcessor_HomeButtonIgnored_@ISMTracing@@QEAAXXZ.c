/*
 * XREFs of ?MPCSixDofProcessor_HomeButtonIgnored_@ISMTracing@@QEAAXXZ @ 0x18018D780
 * Callers:
...
void __fastcall ISMTracing::MPCSixDofProcessor_HomeButtonIgnored_(ISMTracing *this)
{
  ...
  if ( **((_DWORD **)v1 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v1 + 1), 0x400000000001LL) )
  {
    ...
    v3 = 50331648LL;
    v6 = 8;
    tlgWriteTransfer_EventWriteTransfer(v2, (unsigned __int8 *)dword_1801D2B12, 0LL, 0LL, 3u, &v4);
  }
}
