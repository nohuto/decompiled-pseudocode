/*
 * XREFs of ?RequestUIAHitTest@UIAHitTest@InputETW@@SAXIIU_GUID@@@Z @ 0x180139650
 * Callers:
...
void __fastcall InputETW::UIAHitTest::RequestUIAHitTest(int a1, int a2, struct _GUID *a3)
{
  ...
  if ( InputETW::IsVerboseEnabled(1LL) )
  {
    ...
    if ( **((_DWORD **)v7 + 1) > 5u && tlgKeywordOn(*((_QWORD *)v7 + 1), 1LL) )
    {
      ...
      v19 = a3;
      v20 = 16;
      tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801CF345, 0LL, 0LL, 5u, &v12);
    }
  }
}
