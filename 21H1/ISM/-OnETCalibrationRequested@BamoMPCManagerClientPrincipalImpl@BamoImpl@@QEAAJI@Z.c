/*
 * XREFs of ?OnETCalibrationRequested@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18010CC90
 * Callers:
 *     ?Thunk_OnETCalibrationRequested_25@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18010D970 (-Thunk_OnETCalibrationRequested_25@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPri.c)
 * Callees:
