/*
 * XREFs of ?StartAnimation@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800FCFD8
 * Callers:
 *     ?Thunk_StartAnimation_112@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FD2C0 (-Thunk_StartAnimation_112@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualPro.c)
 * Callees:
