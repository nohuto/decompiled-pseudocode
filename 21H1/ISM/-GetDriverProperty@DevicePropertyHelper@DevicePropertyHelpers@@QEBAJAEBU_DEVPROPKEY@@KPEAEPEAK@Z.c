/*
 * XREFs of ?GetDriverProperty@DevicePropertyHelper@DevicePropertyHelpers@@QEBAJAEBU_DEVPROPKEY@@KPEAEPEAK@Z @ 0x180093688
 * Callers:
 ...
 *     DevicePropertyHelpers::MapCrToHResult @ 0x180094210 (DevicePropertyHelpers--MapCrToHResult.c)
 */
