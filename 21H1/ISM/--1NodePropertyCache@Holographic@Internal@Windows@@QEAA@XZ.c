/*
 * XREFs of ??1NodePropertyCache@Holographic@Internal@Windows@@QEAA@XZ @ 0x180157E4C
 * Callers:
 *     _Windows::Internal::Holographic::SpatialGraphDriverClient::SpatialGraphDriverClient_::_1_::dtor$7 @ 0x180156F5F (_Windows--Internal--Holographic--SpatialGraphDriverClient--SpatialGraphDriverClient_ea_180156F5F.c)
 * Callees:
