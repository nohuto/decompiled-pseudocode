/*
 * XREFs of ?CancelDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800F5E44
 * Callers:
 *     ?Thunk_CancelDrag_112@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6580 (-Thunk_CancelDrag_112@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualP.c)
 * Callees:
