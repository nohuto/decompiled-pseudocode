/*
 * XREFs of _lambda_f2d9a31b738d46358cc103eee0272db8_::operator() @ 0x180158908
 * Callers:
 ...
 *     ??$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ?AW4OrthonormalMatrixValidationFailures@1@UXMMATRIX@1@@Z @ 0x18014FBC4 (--$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ-AW4OrthonormalMatrixValidationFa.c)
 ...
 *     ?XMMatrixRTInverse@DirectX@@YQ?AUXMMATRIX@1@U21@@Z @ 0x180166F90 (-XMMatrixRTInverse@DirectX@@YQ-AUXMMATRIX@1@U21@@Z.c)
...
void __fastcall lambda_f2d9a31b738d46358cc103eee0272db8_::operator()(__int64 **a1)
{
  ...
  if ( v8 && !v7 )
  {
    *(_QWORD *)v4 = qword_180209A50;
    *(_DWORD *)(v4 + 8) = dword_180209A58;
...
LABEL_16:
  if ( (*(_BYTE *)(v19 + 16) & 2) == 0 )
  {
    *(_OWORD *)(v12 + 36) = xmmword_1801C7308;
    *(_OWORD *)(v12 + 52) = xmmword_1801C7318;
  ...
  do
  {
    ...
    {
      *(_QWORD *)v26 = qword_180209A50;
      *((_DWORD *)v26 + 2) = dword_180209A58;
