/*
 * XREFs of ?to_abi@hresult_error@winrt@@QEBA?AUhresult@2@XZ @ 0x1800BE8E0
 * Callers:
 *     _winrt::to_hresult_::_1_::catch$19 @ 0x1800BE96E (_winrt--to_hresult_--_1_--catch$19.c)
 ...
 * Callees:
 *     WINRT_SetRestrictedErrorInfo @ 0x18003CED3 (WINRT_SetRestrictedErrorInfo.c)
 */
