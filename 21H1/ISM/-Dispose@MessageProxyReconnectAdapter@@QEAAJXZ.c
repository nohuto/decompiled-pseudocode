/*
 * XREFs of ?Dispose@MessageProxyReconnectAdapter@@QEAAJXZ @ 0x1800BEC98
 * Callers:
 *     ?UnInitialize@InputServiceProxy@@UEAAJXZ @ 0x180104500 (-UnInitialize@InputServiceProxy@@UEAAJXZ.c)
