/*
 * XREFs of ?QueryInterface@BamoResizeContextualProcessorPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FCEC0
 * Callers:
 *     ?QueryInterface@BamoResizeContextualProcessorPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004BAC0 (-QueryInterface@BamoResizeContextualProcessorPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
