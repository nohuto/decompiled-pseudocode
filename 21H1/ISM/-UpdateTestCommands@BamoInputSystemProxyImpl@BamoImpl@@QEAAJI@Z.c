/*
 * XREFs of ?UpdateTestCommands@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EFD24
 * Callers:
 ...
 *     ?Thunk_UpdateTestCommands_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED5A0 (-Thunk_UpdateTestCommands_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@S.c)
 * Callees:
