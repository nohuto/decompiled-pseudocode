 ...
 *     <none>
 * Callees:
 *     ??0?$queue@UCachedInputInfo@@V?$deque@UCachedInputInfo@@V?$allocator@UCachedInputInfo@@@std@@@std@@@std@@QEAA@XZ @ 0x18003B154 (--0-$queue@UCachedInputInfo@@V-$deque@UCachedInputInfo@@V-$allocator@UCachedInputInfo@@@std@@@st.c)
 */
