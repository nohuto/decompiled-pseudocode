/*
 * XREFs of ?EnumerateDevices@SpatialInteractionDevices@@YAJU_GUID@@PEAV?$vector@VHString@Wrappers@WRL@Microsoft@@V?$allocator@VHString@Wrappers@WRL@Microsoft@@@std@@@std@@@Z @ 0x1800C5F30
 * Callers:
 ...
 * Callees:
 *     ?Set@HString@Wrappers@WRL@Microsoft@@QEAAJPEB_WI@Z @ 0x18002E3DC (-Set@HString@Wrappers@WRL@Microsoft@@QEAAJPEB_WI@Z.c)
