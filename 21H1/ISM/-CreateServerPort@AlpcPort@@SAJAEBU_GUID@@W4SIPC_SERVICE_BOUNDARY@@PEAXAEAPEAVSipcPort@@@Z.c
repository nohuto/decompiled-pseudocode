/*
 * XREFs of ?CreateServerPort@AlpcPort@@SAJAEBU_GUID@@W4SIPC_SERVICE_BOUNDARY@@PEAXAEAPEAVSipcPort@@@Z @ 0x180030F84
 * Callers:
...
__int64 __fastcall AlpcPort::CreateServerPort(__int64 a1, __int64 a2, __int64 a3, AlpcPort **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v8 < 0 )
    goto LABEL_20;
  AlpcPortString::AlpcPortString(v17, &xmmword_1801C1420, 1LL);
