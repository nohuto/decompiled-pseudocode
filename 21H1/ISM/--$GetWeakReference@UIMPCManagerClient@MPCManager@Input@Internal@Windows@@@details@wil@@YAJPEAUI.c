/*
 * XREFs of ??$GetWeakReference@UIMPCManagerClient@MPCManager@Input@Internal@Windows@@@details@wil@@YAJPEAUIMPCManagerClient@MPCManager@Input@Internal@Windows@@PEAPEAUIWeakReference@@@Z @ 0x180106154
 * Callers:
