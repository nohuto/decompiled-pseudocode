/*
 * XREFs of ?OnPropertyChanged@TextInputStateAdapter@@UEAAJPEAUIMessageProxy@@G@Z @ 0x1801A3040
 * Callers:
 *     <none>
 * Callees:
 *     McTemplateU0sqq_EventWriteTransfer @ 0x180149230 (McTemplateU0sqq_EventWriteTransfer.c)
 *     ?PropertyChangeHelper@TextInputStateAdapter@@AEAAJG_N@Z @ 0x1801A30F4 (-PropertyChangeHelper@TextInputStateAdapter@@AEAAJG_N@Z.c)
 */
