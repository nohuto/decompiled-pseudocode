/*
 * XREFs of wil::init_once_nothrow__lambda_ca82685424ac054990721f288eeb0943___ @ 0x1801458A8
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  if ( !InitOnceBeginInitialize(&stru_18020A4B8, 0, &fPending, 0LL) )
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0x1D4, (__int64)"wil", v4);
  if ( fPending )
  {
    v6 = VirtualTouchpadContextProvider::Create(&qword_1802099E0);
    v7 = v6;
    if ( v6 < 0 )
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x1D9, (__int64)"wil", (const char *)(unsigned int)v6);
      InitOnceComplete(&stru_18020A4B8, 4u, 0LL);
      return v7;
    }
    if ( a3 )
      *a3 = 1;
    InitOnceComplete(&stru_18020A4B8, 0, 0LL);
  }
  return 0LL;
}
