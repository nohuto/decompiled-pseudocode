/*
 * XREFs of ?UpdateZoom@MPCGamepadProcessor@@AEAAXPEAUInputInfo@@@Z @ 0x1801947A4
 * Callers:
...
void __fastcall MPCGamepadProcessor::UpdateZoom(MPCGamepadProcessor *this, struct InputInfo *a2)
{
  ...
  v2 = (char *)a2 + 152;
  v4 = *((float *)this + 1169) - *((float *)this + 1168);
  v5 = *((float *)this + 1176) - *((float *)this + 1175);
  ...
  *((_QWORD *)&v32 + 1) = L"ThumbstickDeadzone";
  ...
  MPCConstantManager::GetConstant<float>(
    ...
    (__int64 *)(((unsigned __int64)this + 32) & -(__int64)(this != 0LL)),
    (__int128 *)((char *)&v32 + 8));
  v25 = *v2 && v2[2] || *((_DWORD *)this + 1264) == 2;
  v26 = v22 && v23 <= COERCE_FLOAT(L"ThumbstickDeadzone") && !*((_DWORD *)this + 1264);
  v27 = *((_DWORD *)this + 1264);
  if ( v27 != 2 )
  {
LABEL_24:
    v21 = 0;
  ...
  else if ( v27 == 2 )
  {
    ...
    *((_QWORD *)&v32 + 1) = L"ZoomingScale";
    MPCConstantManager::GetConstant<float>(
      ...
      (__int128 *)((char *)&v32 + 8));
    v38 = 6;
    v39 = (float)((float)(COERCE_FLOAT(L"ZoomingScale") * v4) * *((float *)this + 1284)) + 1.0;
