/*
 * XREFs of ?OnETCalibrationRequested@MPCManager@@QEAAXI@Z @ 0x1800734E0
 * Callers:
 *     ?OnDeviceUpdate@MPCEyeGazeProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x180197960 (-OnDeviceUpdate@MPCEyeGazeProcessor@@UEAAJPEAUDeviceInfo@@@Z.c)
 * Callees:
