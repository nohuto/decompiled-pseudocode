/*
 * XREFs of ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x1800660E8
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_fee8cea507d2413a58be13acfb66740a_@@CAXPEAX@Z @ 0x18003DC50 (-_lambda_invoker_cdecl_@_lambda_fee8cea507d2413a58be13acfb66740a_@@CAXPEAX@Z.c)
 * Callees:
 ...
 *     ?InvalidateFeatureStateCache@EnabledStateManager@details@wil@@AEAAXPEATwil_details_FeatureStateCache@@W4wil_FeatureChangeTime@@@Z @ 0x18003DE7C (-InvalidateFeatureStateCache@EnabledStateManager@details@wil@@AEAAXPEATwil_details_FeatureStateC.c)
 */
