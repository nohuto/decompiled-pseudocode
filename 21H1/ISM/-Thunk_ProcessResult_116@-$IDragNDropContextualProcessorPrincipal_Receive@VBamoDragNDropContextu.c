/*
 * XREFs of ?Thunk_ProcessResult_116@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F65A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
