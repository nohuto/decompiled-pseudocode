/*
 * XREFs of ?Thunk_RegisterKeyboardDockClient_10@?$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128370
 * Callers:
 *     <none>
 * Callees:
 *     <none>
