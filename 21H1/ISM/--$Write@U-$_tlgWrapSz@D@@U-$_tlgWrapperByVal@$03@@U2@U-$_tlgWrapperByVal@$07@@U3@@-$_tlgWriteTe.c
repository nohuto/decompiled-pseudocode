        ...
        __int64 a9)
{
  ...
  const unsigned __int16 *v14; // [rsp+50h] [rbp-31h]
  ...
  v14 = v9;
  v16 = 0;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_180206478, a2, 0LL, 0LL, 7u, &v13);
}
