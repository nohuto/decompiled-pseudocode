/*
 * XREFs of ??1?$unordered_map@KUResultInfo@DragNDropProcessor@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKUResultInfo@DragNDropProcessor@@@std@@@4@@std@@QEAA@XZ @ 0x1800F867C
 * Callers:
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$6 @ 0x1800F8511 (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$6.c)
 * Callees:
