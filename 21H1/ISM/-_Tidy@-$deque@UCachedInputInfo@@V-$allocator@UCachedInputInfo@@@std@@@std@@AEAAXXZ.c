/*
 * XREFs of ?_Tidy@?$deque@UCachedInputInfo@@V?$allocator@UCachedInputInfo@@@std@@@std@@AEAAXXZ @ 0x1800B3E44
 * Callers:
 *     ??1?$queue@UCachedInputInfo@@V?$deque@UCachedInputInfo@@V?$allocator@UCachedInputInfo@@@std@@@std@@@std@@QEAA@XZ @ 0x18003B4A4 (--1-$queue@UCachedInputInfo@@V-$deque@UCachedInputInfo@@V-$allocator@UCachedInputInfo@@@std@@@st.c)
 * Callees:
...
void std::deque<CachedInputInfo>::_Tidy()
{
  ...
  while ( v0 )
  {
    v1 = *(_QWORD *)(*((_QWORD *)&Win32kInterop::s_inputInfoCachedQueue + 1)
                   + 8 * ((qword_180209BE0 - 1) & (v0 + qword_180209BE8 - 1)));
