/*
 * XREFs of ?Thunk_UnregisterObserverClientOfType_161@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F45F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
