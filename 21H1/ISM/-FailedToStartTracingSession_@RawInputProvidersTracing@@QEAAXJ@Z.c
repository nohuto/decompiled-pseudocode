/*
 * XREFs of ?FailedToStartTracingSession_@RawInputProvidersTracing@@QEAAXJ@Z @ 0x1800935E8
 * Callers:
...
void __fastcall RawInputProvidersTracing::FailedToStartTracingSession_(RawInputProvidersTracing *this, int a2)
{
  ...
  if ( *(_DWORD *)v3[1] > 4u && tlgKeywordOn(v3[1], 0x400000000000LL) )
  {
    ...
    v5 = a2;
    v8 = 4;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801CA5DC, 0LL, 0LL, 3u, &v6);
  }
}
