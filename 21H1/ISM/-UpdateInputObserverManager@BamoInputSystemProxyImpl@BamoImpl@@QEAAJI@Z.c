/*
 * XREFs of ?UpdateInputObserverManager@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EEB3C
 * Callers:
 ...
 *     ?Thunk_UpdateInputObserverManager_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED410 (-Thunk_UpdateInputObserverManager_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoI.c)
 * Callees:
