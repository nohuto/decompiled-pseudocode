/*
 * XREFs of ?ForcePrimaryInputType@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJW4InputType@@@Z @ 0x180072998
 * Callers:
 *     ?Thunk_ForcePrimaryInputType_5@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800748A0 (-Thunk_ForcePrimaryInputType_5@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoI.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoMPCManagerPrincipalImpl::ForcePrimaryInputType(__int64 a1, unsigned int a2)
{
  ...
  v7 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)(a1 - 16) + 112LL))(a1 - 16, v6, a2);
  if ( v7 < 0 )
