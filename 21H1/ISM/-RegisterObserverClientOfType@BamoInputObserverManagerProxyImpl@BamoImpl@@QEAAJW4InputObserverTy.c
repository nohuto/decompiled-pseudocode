/*
 * XREFs of ?RegisterObserverClientOfType@BamoInputObserverManagerProxyImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientPrincipal@@@Z @ 0x1800EB9BC
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      return CoreUICallSend(v8, v10, 2LL, 40LL, 0, &unk_1801C0231, a2);
    }
    else
    {
