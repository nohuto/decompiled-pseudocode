/*
 * XREFs of ??1?$unordered_map@W4TestCommandMessageType@@U?$pair@PEAXP6A_NPEAXPEAUTestCommandMessageDataHeader@@@Z@std@@U?$hash@W4TestCommandMessageType@@@3@U?$equal_to@W4TestCommandMessageType@@@3@V?$allocator@U?$pair@$$CBW4TestCommandMessageType@@U?$pair@PEAXP6A_NPEAXPEAUTestCommandMessageDataHeader@@@Z@std@@@std@@@3@@std@@QEAA@XZ @ 0x1800BC680
 * Callers:
 *     _TestCommandHost::TestCommandHost_::_1_::dtor$2 @ 0x18004EA4A (_TestCommandHost--TestCommandHost_--_1_--dtor$2.c)
 *     _VirtualTouchpadContextProvider::Broadcast_::_1_::dtor$1 @ 0x180145CBE (_VirtualTouchpadContextProvider--Broadcast_--_1_--dtor$1.c)
 *     _VirtualTouchpadContextProvider::GetCurrentContext_::_1_::dtor$2 @ 0x180145E8A (_VirtualTouchpadContextProvider--GetCurrentContext_--_1_--dtor$2.c)
 *     _DragNDropProcessorLegacy::DragNDropProcessorLegacy_::_1_::dtor$7 @ 0x1801749EF (_DragNDropProcessorLegacy--DragNDropProcessorLegacy_--_1_--dtor$7.c)
 * Callees:
