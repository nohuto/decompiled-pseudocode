/*
 * XREFs of ?SendMaterializeProxy@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18006FF70
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v15, 2LL, 1LL, 4, &unk_1801C28EB, v13);
  if ( v8 < 0 )
  {
