/*
 * XREFs of ?GetNearestSupportedProgrammableColorAndDeviceChannels@NearestColor@@CAXAEBUColor@UI@Windows@@AEBULampAttributes@@PEAU234@PEAULampColor@@@Z @ 0x1800A9204
 * Callers:
 ...
 * Callees:
 *     ?SnapChannelToNearest@NearestColor@@CANNN@Z @ 0x1800A94C8 (-SnapChannelToNearest@NearestColor@@CANNN@Z.c)
 */
