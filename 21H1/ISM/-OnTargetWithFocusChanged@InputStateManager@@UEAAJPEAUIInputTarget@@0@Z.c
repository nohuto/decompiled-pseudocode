 ...
 *     ?SetCurrentStateWithClient@ControllerNavigationManager@@AEAAXPEAVBamoControllerNavigationClientProxy@@@Z @ 0x18011E1D8 (-SetCurrentStateWithClient@ControllerNavigationManager@@AEAAXPEAVBamoControllerNavigationClientP.c)
...
LABEL_31:
      if ( v33 == v35 )
      {
        ...
        if ( v37 && *v37 > 1u )
        {
          ...
          {
            tlgWriteTransfer_EventWriteTransfer(v38, (int)&dword_1801CEEC6, 0, 0, 2u, &v60);
          }
        }
        v39 = *(_QWORD **)(v13 + 72);
