/*
 * XREFs of ??1KeyboardDockServer@@UEAA@XZ @ 0x18012649C
 * Callers:
 *     ??_GKeyboardDockServer@@UEAAPEAXI@Z @ 0x180126660 (--_GKeyboardDockServer@@UEAAPEAXI@Z.c)
 * Callees:
