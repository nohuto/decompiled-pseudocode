/*
 * XREFs of ?Create@RIMRawInputProvider@@SAJPEAUIRawInputClient@@KPEAPEAUIRawInputProvider@@@Z @ 0x180020680
 * Callers:
 *     <none>
 * Callees:
 *     ??0RIMRawInputProvider@@IEAA@PEAUIRawInputClient@@@Z @ 0x1800204EC (--0RIMRawInputProvider@@IEAA@PEAUIRawInputClient@@@Z.c)
