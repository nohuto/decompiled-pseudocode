/*
 * XREFs of ??0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x180036AB4
 * Callers:
 ...
 * Callees:
 *     ??0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x18001E120 (--0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ.c)
