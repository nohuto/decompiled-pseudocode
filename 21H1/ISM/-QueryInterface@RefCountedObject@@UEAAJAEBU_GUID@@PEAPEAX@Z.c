/*
 * XREFs of ?QueryInterface@RefCountedObject@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180066260
 * Callers:
 *     ?QueryInterface@InputContext@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800B2560 (-QueryInterface@InputContext@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
