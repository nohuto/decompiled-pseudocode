/*
 * XREFs of ?GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAA_NXZ @ 0x18015EFE0
 * Callers:
 *     ?GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAA_NXZ @ 0x18004D090 (-GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAA_NXZ.c)
 * Callees:
