/*
 * XREFs of ?UnregisterForTestCommandMessage@TestCommandHost@@CAXW4TestCommandMessageType@@PEAXQ6A_N1PEAUTestCommandMessageDataHeader@@@Z@Z @ 0x1800BC840
 * Callers:
 *     ??1DWMCursor@@MEAA@XZ @ 0x18019C994 (--1DWMCursor@@MEAA@XZ.c)
 * Callees:
