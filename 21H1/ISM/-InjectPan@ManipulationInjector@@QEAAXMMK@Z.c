/*
 * XREFs of ?InjectPan@ManipulationInjector@@QEAAXMMK@Z @ 0x1800C35F4
 * Callers:
 ...
 *     ?RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z @ 0x1800C3C5C (-RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z.c)
