/*
 * XREFs of ?InitializeHapticsEngine_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAX_N_JE00@Z @ 0x18016CFB0
 * Callers:
        ...
        bool a6)
{
  ...
  if ( *(_DWORD *)v9[1] > 4u && tlgKeywordOn(v9[1], 2LL) )
  {
    v11 = a6;
    v12 = a5;
    v13 = a4;
    ...
    v20 = 8LL;
    v18 = 1LL;
    tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801D1E07, 0LL, 0LL, 7u, &v16);
  }
}
