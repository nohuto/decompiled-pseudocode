/*
 * XREFs of ??$to_hstring@PEBDX@winrt@@YA?AUhstring@0@AEBQEBD@Z @ 0x1800BD804
 * Callers:
 ...
 *     WindowsPreallocateStringBuffer_0 @ 0x18003CEF7 (WindowsPreallocateStringBuffer_0.c)
 *     MultiByteToWideChar_0 @ 0x18003DC01 (MultiByteToWideChar_0.c)
