/*
 * XREFs of ??$get_activation_factory@UIAppViewStatics@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@winrt@@YA?AUIAppViewStatics@WindowManagement@ApplicationModel@Internal@Windows@0@AEBUhstring@param@0@@Z @ 0x180033AF4
 * Callers:
 ...
 * Callees:
 *     RoGetActivationFactory_0 @ 0x18003CEBB (RoGetActivationFactory_0.c)
 *     CoIncrementMTAUsage_0 @ 0x18003D58C (CoIncrementMTAUsage_0.c)
