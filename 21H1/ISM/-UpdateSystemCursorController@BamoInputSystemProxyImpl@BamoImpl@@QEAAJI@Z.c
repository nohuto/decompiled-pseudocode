/*
 * XREFs of ?UpdateSystemCursorController@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EFC04
 * Callers:
 ...
 *     ?Thunk_UpdateSystemCursorController_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED590 (-Thunk_UpdateSystemCursorController_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@Bam.c)
 * Callees:
