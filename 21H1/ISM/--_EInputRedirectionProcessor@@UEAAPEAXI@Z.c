/*
 * XREFs of ??_EInputRedirectionProcessor@@UEAAPEAXI@Z @ 0x18017F1C8
 * Callers:
 *     ??_EInputRedirectionProcessor@@WBI@EAAPEAXI@Z @ 0x18004D450 (--_EInputRedirectionProcessor@@WBI@EAAPEAXI@Z.c)
 * Callees:
