/*
 * XREFs of ?UpdateHeatGripService@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE720
 * Callers:
 ...
 *     ?Thunk_UpdateHeatGripService_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED3A0 (-Thunk_UpdateHeatGripService_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@.c)
 * Callees:
