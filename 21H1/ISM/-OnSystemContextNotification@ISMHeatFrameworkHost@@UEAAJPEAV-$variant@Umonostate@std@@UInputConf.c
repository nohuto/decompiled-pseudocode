/*
 * XREFs of ?OnSystemContextNotification@ISMHeatFrameworkHost@@UEAAJPEAV?$variant@Umonostate@std@@UInputConfigContextMessage@@UDisplayOcclusionContextMessage@@UVirtualTouchpadContextMessage@@@std@@@Z @ 0x18012CDB0
 * Callers:
 *     <none>
 * Callees:
