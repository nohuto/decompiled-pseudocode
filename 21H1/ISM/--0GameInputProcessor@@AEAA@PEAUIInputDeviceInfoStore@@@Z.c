/*
 * XREFs of ??0GameInputProcessor@@AEAA@PEAUIInputDeviceInfoStore@@@Z @ 0x18003781C
 * Callers:
  ...
  *((_BYTE *)this + 192) = 0;
  if ( !gbIsDWMNoRawGameController )
  {
    *(_QWORD *)&v6 = GameInputProcessor::OnDeviceAttach;
    ...
    v7 = v6;
    v8 = this;
    std::function<void (DeviceInfo *)>::operator=<std::_Binder<std::_Unforced,void (GameInputProcessor::*)(DeviceInfo *),GameInputProcessor *,std::_Ph<1> const &>,void>(
      (char *)this + 40,
      &v7);
