/*
 * XREFs of ?HIDGetFloat@Internal@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@2@PEAUHID_REPORT@2@W4_HIDP_REPORT_TYPE@@GGGGPEAM@Z @ 0x1800CBEB8
 * Callers:
  ...
  *a8 = 0.0;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( *Report == *(unsigned __int8 *)(v27 + 2) )
    {
      ...
      if ( v22 >= 0 )
      {
        v24 = SpatialInteractionDevices::Internal::ConvertHIDValueToDouble((int)UsageValue, v19, v23);
        result = 0LL;
        v25 = v24;
        *v13 = v25;
      }
