/*
 * XREFs of ?QueryInterface@ResizeProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FEA70
 * Callers:
 *     ?QueryInterface@ResizeProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004BAF0 (-QueryInterface@ResizeProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180035710 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     _guard_dispatch_icall_nop @ 0x18004ACA0 (_guard_dispatch_icall_nop.c)
 */

__int64 __fastcall ResizeProcessor::QueryInterface(ResizeProcessor *this, const struct _GUID *a2, ResizeProcessor **a3)
{
  ResizeProcessor *v4; // rbx
  __int64 v6; // rax
  __int64 v7; // rax
