/*
 * XREFs of ?Thunk_StartAnimation_112@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F65C0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
