/*
 * XREFs of ??1SpatialRimDevice@SpatialInteractions@Internal@Windows@@UEAA@XZ @ 0x180092A6C
 * Callers:
 *     ??_GSpatialRimDevice@SpatialInteractions@Internal@Windows@@UEAAPEAXI@Z @ 0x180092D20 (--_GSpatialRimDevice@SpatialInteractions@Internal@Windows@@UEAAPEAXI@Z.c)
 * Callees:
