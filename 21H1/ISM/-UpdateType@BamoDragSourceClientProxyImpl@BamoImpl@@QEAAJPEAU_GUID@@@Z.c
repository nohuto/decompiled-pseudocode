/*
 * XREFs of ?UpdateType@BamoDragSourceClientProxyImpl@BamoImpl@@QEAAJPEAU_GUID@@@Z @ 0x1800EFE44
 * Callers:
 ...
 *     ?Thunk_UpdateType_29@?$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED5B0 (-Thunk_UpdateType_29@-$IDragSourceClientProxy_Receive@VBamoDragSourceClientProxyImpl@BamoImpl@@@.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDragSourceClientProxyImpl::UpdateType(struct _GUID *this, struct _GUID *a2)
{
  int v3; // eax
  __int64 v4; // rbx
