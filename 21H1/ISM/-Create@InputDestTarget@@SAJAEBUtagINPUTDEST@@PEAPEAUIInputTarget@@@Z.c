/*
 * XREFs of ?Create@InputDestTarget@@SAJAEBUtagINPUTDEST@@PEAPEAUIInputTarget@@@Z @ 0x18013A8DC
 * Callers:
 ...
 *     ??0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z @ 0x18013A754 (--0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z.c)
 */
