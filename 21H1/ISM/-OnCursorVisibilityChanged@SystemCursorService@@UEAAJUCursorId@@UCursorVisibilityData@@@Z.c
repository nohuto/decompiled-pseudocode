/*
 * XREFs of ?OnCursorVisibilityChanged@SystemCursorService@@UEAAJUCursorId@@UCursorVisibilityData@@@Z @ 0x1801405F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SystemCursorService::OnCursorVisibilityChanged(SystemCursorService *a1, unsigned int a2, bool a3)
{
  __int64 v3; // rdi
  __int64 v5; // r11
  int v6; // eax
  ...
  v6 = SystemCursor::SetVisible(*(SystemCursor **)(v9[0] + 24LL), a3);
  v7 = v6;
  if ( v6 >= 0 )
    return 0LL;
