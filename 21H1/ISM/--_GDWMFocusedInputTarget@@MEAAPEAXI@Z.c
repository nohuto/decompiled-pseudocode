/*
 * XREFs of ??_GDWMFocusedInputTarget@@MEAAPEAXI@Z @ 0x18001B664
 * Callers:
 *     ??_EDWMFocusedInputTarget@@OCI@EAAPEAXI@Z @ 0x18004CAB0 (--_EDWMFocusedInputTarget@@OCI@EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1DWMFocusedInputTarget@@MEAA@XZ @ 0x18001B6AC (--1DWMFocusedInputTarget@@MEAA@XZ.c)
 */
