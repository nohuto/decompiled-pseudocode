/*
 * XREFs of ?UpdateUIAHitTestInputObject@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800F3A70
 * Callers:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 24) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 216LL))((char *)this - 16);
    if ( v9 < 0 )
