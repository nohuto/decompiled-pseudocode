/*
 * XREFs of ??1?$set@IU?$less@I@std@@V?$allocator@I@2@@std@@QEAA@XZ @ 0x18019F448
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$3 @ 0x18019F2B4 (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$3.c)
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$10 @ 0x18019F329 (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$10.c)
 * Callees:
