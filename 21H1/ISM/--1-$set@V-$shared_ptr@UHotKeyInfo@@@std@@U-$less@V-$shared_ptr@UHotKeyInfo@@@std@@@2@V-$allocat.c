/*
 * XREFs of ??1?$set@V?$shared_ptr@UHotKeyInfo@@@std@@U?$less@V?$shared_ptr@UHotKeyInfo@@@std@@@2@V?$allocator@V?$shared_ptr@UHotKeyInfo@@@std@@@2@@std@@QEAA@XZ @ 0x18019F478
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$5 @ 0x18019F2D4 (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$5.c)
 * Callees:
