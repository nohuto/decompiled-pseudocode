/*
 * XREFs of ??1?$HandleT@VThreadpoolTimerTraitsImpl@HandleTraits@Wrappers@WRL@Microsoft@@@Wrappers@WRL@Microsoft@@QEAA@XZ @ 0x180169F44
 * Callers:
 *     _ThreadpoolTimerHelpers::KeepAliveTimer::KeepAliveTimer_::_1_::dtor$1 @ 0x1801699B4 (_ThreadpoolTimerHelpers--KeepAliveTimer--KeepAliveTimer_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
