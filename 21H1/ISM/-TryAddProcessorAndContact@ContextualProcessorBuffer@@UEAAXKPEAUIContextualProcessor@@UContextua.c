/*
 * XREFs of ?TryAddProcessorAndContact@ContextualProcessorBuffer@@UEAAXKPEAUIContextualProcessor@@UContextualProcessorInitialState@@@Z @ 0x18014DA10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$ComPtr@UIContextualProcessor@@@WRL@Microsoft@@QEAAAEAV012@PEAUIContextualProcessor@@@Z @ 0x18014B554 (--4-$ComPtr@UIContextualProcessor@@@WRL@Microsoft@@QEAAAEAV012@PEAUIContextualProcessor@@@Z.c)
