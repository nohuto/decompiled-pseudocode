/*
 * XREFs of ?UpdatePenEventsDispatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF4E0
 * Callers:
 ...
 *     ?Thunk_UpdatePenEventsDispatcher_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED4C0 (-Thunk_UpdatePenEventsDispatcher_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 14) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 136LL))((char *)this - 16);
    if ( v9 < 0 )
