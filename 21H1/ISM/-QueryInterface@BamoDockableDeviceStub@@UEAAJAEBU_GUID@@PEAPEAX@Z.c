/*
 * XREFs of ?QueryInterface@BamoDockableDeviceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180127500
 * Callers:
 *     ?QueryInterface@BamoDockableDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C770 (-QueryInterface@BamoDockableDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
