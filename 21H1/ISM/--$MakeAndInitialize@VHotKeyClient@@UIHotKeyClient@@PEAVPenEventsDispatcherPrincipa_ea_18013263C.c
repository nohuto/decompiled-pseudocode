/*
 * XREFs of ??$MakeAndInitialize@VHotKeyClient@@UIHotKeyClient@@PEAVPenEventsDispatcherPrincipal@@_N@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@UIHotKeyClient@@@WRL@Microsoft@@@012@$$QEAPEAVPenEventsDispatcherPrincipal@@$$QEA_N@Z @ 0x18013263C
 * Callers:
