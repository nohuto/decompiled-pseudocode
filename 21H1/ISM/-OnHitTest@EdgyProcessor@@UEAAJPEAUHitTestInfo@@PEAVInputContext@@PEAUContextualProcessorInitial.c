/*
 * XREFs of ?OnHitTest@EdgyProcessor@@UEAAJPEAUHitTestInfo@@PEAVInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1801781B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?QualifyEdgyHitTestInputReport@EdgyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@@Z @ 0x180178458 (-QualifyEdgyHitTestInputReport@EdgyProcessor@@IEAA_NPEAUHitTestInfo@@PEAUEdgyPointerInfo@@@Z.c)
 ...
 *     ?Reset@EdgyImpl@@QEAAXXZ @ 0x18017BFF8 (-Reset@EdgyImpl@@QEAAXXZ.c)
 */
