/*
 * XREFs of wil::init_once_nothrow__lambda_2e51b86642a92e3b17e4afda222f3187___ @ 0x180146D8C
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( a3 )
    *a3 = 0;
  if ( !InitOnceBeginInitialize(&stru_18020A4C0, 0, &fPending, 0LL) )
  ...
  if ( fPending )
  {
    ...
    qword_1802099E8 = (__int64)v7;
    if ( a3 )
      *a3 = 1;
    InitOnceComplete(&stru_18020A4C0, 0, 0LL);
  }
  return 0LL;
}
