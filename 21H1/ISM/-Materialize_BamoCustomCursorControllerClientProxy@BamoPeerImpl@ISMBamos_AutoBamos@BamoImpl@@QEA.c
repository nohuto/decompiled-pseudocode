/*
 * XREFs of ?Materialize_BamoCustomCursorControllerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E70C4
 * Callers:
 *     ?Thunk_Materialize_BamoCustomCursorControllerClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF20 (-Thunk_Materialize_BamoCustomCursorControllerClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Recei.c)
 * Callees:
