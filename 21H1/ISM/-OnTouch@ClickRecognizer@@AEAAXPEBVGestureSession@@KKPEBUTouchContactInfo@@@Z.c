/*
 * XREFs of ?OnTouch@ClickRecognizer@@AEAAXPEBVGestureSession@@KKPEBUTouchContactInfo@@@Z @ 0x180184908
 * Callers:
 ...
 * Callees:
 *     ?CancelTapAndHold@ClickRecognizer@@AEAAXXZ @ 0x180184600 (-CancelTapAndHold@ClickRecognizer@@AEAAXXZ.c)
 *     ?ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z @ 0x180184648 (-ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z.c)
