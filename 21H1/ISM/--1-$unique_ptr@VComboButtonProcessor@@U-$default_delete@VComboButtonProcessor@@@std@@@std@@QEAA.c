/*
 * XREFs of ??1?$unique_ptr@VComboButtonProcessor@@U?$default_delete@VComboButtonProcessor@@@std@@@std@@QEAA@XZ @ 0x180171E78
 * Callers:
 *     _ComboButtonProcessor::Create_::_1_::dtor$0 @ 0x180172037 (_ComboButtonProcessor--Create_--_1_--dtor$0.c)
 *     _RawButtonProcessor::Create_::_1_::dtor$0 @ 0x180182526 (_RawButtonProcessor--Create_--_1_--dtor$0.c)
 * Callees:
