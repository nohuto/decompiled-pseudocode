/*
 * XREFs of ?QueryInterface@BamoActivationListenerInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EA1A0
 * Callers:
 *     ?QueryInterface@BamoActivationListenerInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B810 (-QueryInterface@BamoActivationListenerInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
