/*
 * XREFs of ?Materialize_BamoControllerNavigationOverrideProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E6F4C
 * Callers:
 *     ?Thunk_Materialize_BamoControllerNavigationOverrideProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF00 (-Thunk_Materialize_BamoControllerNavigationOverrideProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Recei.c)
 * Callees:
