/*
 * XREFs of ?OnHandEvent@BamoMPCInputObjectProxyImpl@BamoImpl@@QEAAJAEBUMPCTraceInfo@@W4HandEventType@Internal@Spatial@Input@UI@Windows@@AEBUHandStateMsg@56789@AEBUHitObjectMsg@56789@@Z @ 0x1800E9024
 * Callers:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      *((_QWORD *)v13 + 12) = v24;
      ...
      v32[0] = v38;
      v32[1] = v30;
      return CoreUICallSend(v11, v32, 2LL, 46LL, 0, &unk_1801C023B, (unsigned int)&v31);
    }
    else
    {
