/*
 * XREFs of ??1?$unordered_map@_KUTargetingInfo@Win32kInterop@@U?$hash@_K@std@@U?$equal_to@_K@4@V?$allocator@U?$pair@$$CB_KUTargetingInfo@Win32kInterop@@@std@@@4@@std@@QEAA@XZ @ 0x1800AEC28
 * Callers:
 *     _Win32kInterop::Win32kInterop_::_1_::dtor$6 @ 0x18004EB8D (_Win32kInterop--Win32kInterop_--_1_--dtor$6.c)
 * Callees:
