/*
 * XREFs of ??1MPCGestureHandlerManager@@UEAA@XZ @ 0x18006B498
 * Callers:
 *     ??_GMPCGestureHandlerManager@@UEAAPEAXI@Z @ 0x18006B540 (--_GMPCGestureHandlerManager@@UEAAPEAXI@Z.c)
 * Callees:
