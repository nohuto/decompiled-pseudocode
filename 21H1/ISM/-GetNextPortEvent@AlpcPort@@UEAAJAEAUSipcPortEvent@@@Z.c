/*
 * XREFs of ?GetNextPortEvent@AlpcPort@@UEAAJAEAUSipcPortEvent@@@Z @ 0x1800C0C30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DisconnectAllSections@SipcPort@@IEAAXXZ @ 0x1800C058C (-DisconnectAllSections@SipcPort@@IEAAXXZ.c)
 ...
 *     ?GetValue@?$SerializedIntegral@I@@QEBAIXZ @ 0x1800C11CC (-GetValue@-$SerializedIntegral@I@@QEBAIXZ.c)
