/*
 * XREFs of ?ParametersChanged@BamoSystemCursorControllerClientProxyImpl@BamoImpl@@QEAAJ_KAEBUCursorParametersInfo@@@Z @ 0x1800EA06C
 * Callers:
        ...
        const struct CursorParametersInfo *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v13[1] = v16;
      v11 = 3;
      return CoreUICallSend(v10, v13, 2LL, 64LL, v11, &unk_1801C029B, a2);
    }
    else
    {
