/*
 * XREFs of ?CompositorRunningStateChanged@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJ_NPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800D7120
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreateDevice@SpatialInteractionHeadObjectDevice@SpatialInteractions@Internal@Windows@@QEAAJPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800DBA6C (-CreateDevice@SpatialInteractionHeadObjectDevice@SpatialInteractions@Internal@Windows@@QEAAJPEAU.c)
 */
        ...
        struct Windows::Internal::SpatialInteractions::ISpatialInteractionSourceCollectionCallbacks *a3)
{
  ...
  v3 = this + 87;
  AcquireSRWLockExclusive(this + 87);
  LOBYTE(this[88].Ptr) = a2;
  Ptr = (Windows::Internal::SpatialInteractions::SpatialInteractionHeadObjectDevice *)this[85].Ptr;
  if ( a2 )
