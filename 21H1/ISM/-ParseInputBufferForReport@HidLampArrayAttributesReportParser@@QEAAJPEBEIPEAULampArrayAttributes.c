/*
 * XREFs of ?ParseInputBufferForReport@HidLampArrayAttributesReportParser@@QEAAJPEBEIPEAULampArrayAttributesDeviceReport@@@Z @ 0x1800A9F54
 * Callers:
 ...
 *     ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAH@Z @ 0x1800ACC5C (-ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAH@Z.c)
 */
