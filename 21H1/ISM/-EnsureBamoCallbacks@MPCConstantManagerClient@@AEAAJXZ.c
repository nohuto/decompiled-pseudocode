/*
 * XREFs of ?EnsureBamoCallbacks@MPCConstantManagerClient@@AEAAJXZ @ 0x180113F20
 * Callers:
...
__int64 __fastcall MPCConstantManagerClient::EnsureBamoCallbacks(struct MPCManagerClientConnection **this)
{
  ...
  struct MPCManagerClientConnection *v4; // rdi
  __int64 v5; // rax
  ...
  if ( *((_QWORD *)this[4] + 23) )
  {
    if ( !this[5] )
    {
      ...
      this[5] = v3;
      if ( v3 )
        (**(void (__fastcall ***)(MPCConstantManagerClientPrincipal *))v3)(v3);
      if ( v4 )
        (*(void (__fastcall **)(struct MPCManagerClientConnection *))(*(_QWORD *)v4 + 8LL))(v4);
      v5 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this[4] + 23) + 88LL))(*((_QWORD *)this[4] + 23));
