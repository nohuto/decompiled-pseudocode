/*
 * XREFs of ?OnDeviceRemoval@PenDeviceCollection@@MEAAJK@Z @ 0x18009B9C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RemoveRIMDevice@PenDeviceManager@@QEAAXPEAX@Z @ 0x1801304A8 (-RemoveRIMDevice@PenDeviceManager@@QEAAXPEAX@Z.c)
 */
