/*
 * XREFs of ?Create@ControllerProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180120C00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsPointerDevice@@YAHPEBUDeviceInfo@@@Z @ 0x18014949C (-IsPointerDevice@@YAHPEBUDeviceInfo@@@Z.c)
 */
