/*
 * XREFs of ??$MakeAndInitialize@VHotkeyContextualProcessor@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVHotkeyContextualProcessor@@@Z @ 0x180137314
 * Callers:
 ...
 *     ??0HotkeyContextualProcessor@@QEAA@XZ @ 0x180137A30 (--0HotkeyContextualProcessor@@QEAA@XZ.c)
