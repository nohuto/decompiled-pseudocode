/*
 * XREFs of ?ReadPoseDataFromRegistry@SpatialInteractionDevices@@YAJPEAUHKEY__@@PEAUPoseData@1@@Z @ 0x1800C6E30
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::ReadRegistryFloat @ 0x1800C6F10 (_anonymous_namespace_--ReadRegistryFloat.c)
 */
