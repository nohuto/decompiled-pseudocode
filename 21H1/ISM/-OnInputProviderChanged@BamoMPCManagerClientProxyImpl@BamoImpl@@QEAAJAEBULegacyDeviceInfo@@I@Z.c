/*
 * XREFs of ?OnInputProviderChanged@BamoMPCManagerClientProxyImpl@BamoImpl@@QEAAJAEBULegacyDeviceInfo@@I@Z @ 0x180109C5C
 * Callers:
        ...
        const struct LegacyDeviceInfo *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 1;
      return CoreUICallSend(v8, v10, 2LL, 5LL, v9, &unk_1801C28C3, (unsigned int)v11);
    }
    else
    {
