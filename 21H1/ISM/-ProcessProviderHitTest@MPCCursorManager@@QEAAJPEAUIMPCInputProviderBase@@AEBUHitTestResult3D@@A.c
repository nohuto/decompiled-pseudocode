/*
 * XREFs of ?ProcessProviderHitTest@MPCCursorManager@@QEAAJPEAUIMPCInputProviderBase@@AEBUHitTestResult3D@@AEA_N@Z @ 0x18007C84C
 * Callers:
 ...
 *     ?Is2DCursorVisible@MPCCursorManager@@AEAA_NXZ @ 0x18007C5E0 (-Is2DCursorVisible@MPCCursorManager@@AEAA_NXZ.c)
