/*
 * XREFs of ?UpdateEnabled@BamoControllerNavigationManagerProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x1800EE374
 * Callers:
 ...
 *     ?Thunk_UpdateEnabled_13@?$IControllerNavigationManagerProxy_Receive@VBamoControllerNavigationManagerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED340 (-Thunk_UpdateEnabled_13@-$IControllerNavigationManagerProxy_Receive@VBamoControllerNavigationMan.c)
 * Callees:
