/*
 * XREFs of ?GetDragSourceClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDragSourceClientProxy@@XZ @ 0x180010B90
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 168) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x180056556LL);
  }
  return (struct BamoDragSourceClientProxy *)*((_QWORD *)this + 16);
}
