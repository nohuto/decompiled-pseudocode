/*
 * XREFs of ?InputReportCallback@GameControllerRawInputProvider@@CAJPEAX@Z @ 0x180088A90
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180035710 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     _guard_dispatch_icall_nop @ 0x18004ACA0 (_guard_dispatch_icall_nop.c)
 *     ??1?$unique_ptr@UInputInfo@@P6AXPEAU1@@Z@std@@QEAA@XZ @ 0x1800886BC (--1-$unique_ptr@UInputInfo@@P6AXPEAU1@@Z@std@@QEAA@XZ.c)
 */
