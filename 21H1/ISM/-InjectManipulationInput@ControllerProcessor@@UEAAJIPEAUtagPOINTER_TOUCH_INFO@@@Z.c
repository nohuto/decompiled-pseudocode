/*
 * XREFs of ?InjectManipulationInput@ControllerProcessor@@UEAAJIPEAUtagPOINTER_TOUCH_INFO@@@Z @ 0x180121380
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Inject@InjectionDevice@@QEAAJPEAUInputInfo@@@Z @ 0x180121290 (-Inject@InjectionDevice@@QEAAJPEAUInputInfo@@@Z.c)
 */
