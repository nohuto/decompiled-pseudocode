/*
 * XREFs of ??0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x18001E120
 * Callers:
 *     ??0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x180036AB4 (--0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ.c)
 * Callees:
 *     <none>
 */
