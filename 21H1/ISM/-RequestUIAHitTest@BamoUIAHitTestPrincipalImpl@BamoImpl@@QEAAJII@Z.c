/*
 * XREFs of ?RequestUIAHitTest@BamoUIAHitTestPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x180187AD8
 * Callers:
 *     ?Thunk_RequestUIAHitTest_112@?$IUIAHitTestPrincipal_Receive@VBamoUIAHitTestPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180187C30 (-Thunk_RequestUIAHitTest_112@-$IUIAHitTestPrincipal_Receive@VBamoUIAHitTestPrincipalImpl@BamoImp.c)
 * Callees:
