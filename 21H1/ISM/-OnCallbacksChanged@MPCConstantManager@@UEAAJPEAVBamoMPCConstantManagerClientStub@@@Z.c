/*
 * XREFs of ?OnCallbacksChanged@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@@Z @ 0x18006F8C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     StubCallback @ 0x180070860 (StubCallback.c)
