/*
 * XREFs of SpatialInteractionDevices::ReadKnownFloats_float_1_ @ 0x1800C7E70
 * Callers:
 *     SpatialInteractionDevices::ReadBatteryLevel @ 0x1800CA350 (SpatialInteractionDevices--ReadBatteryLevel.c)
 *     SpatialInteractionDevices::ReadTrigger @ 0x1800CA594 (SpatialInteractionDevices--ReadTrigger.c)
 * Callees:
