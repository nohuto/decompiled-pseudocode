/*
 * XREFs of ?FindDeviceListEntryByInterfacePath@PnpDeviceWatcher@@AEAAJPEAUHSTRING__@@_NAEAPEAUDeviceListEntry@1@@Z @ 0x18002802C
 * Callers:
 ...
 *     _anonymous_namespace_::WindowsSafeIsEqualString @ 0x18009FBD0 (_anonymous_namespace_--WindowsSafeIsEqualString.c)
 */
