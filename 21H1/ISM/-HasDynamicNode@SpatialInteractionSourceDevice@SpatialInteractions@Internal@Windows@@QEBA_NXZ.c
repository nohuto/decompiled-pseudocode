/*
 * XREFs of ?HasDynamicNode@SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEBA_NXZ @ 0x1800D0530
 * Callers:
 ...
 *     ?CanSendPoses@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEBA_NXZ @ 0x1800DBA60 (-CanSendPoses@SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@UEBA_N.c)
 *     ?CanSendPoses@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEBA_NXZ @ 0x18016AFB0 (-CanSendPoses@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEBA_NXZ.c)
 * Callees:
 *     <none>
 */
