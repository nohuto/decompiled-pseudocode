/*
 * XREFs of ?GetVector3AsString@ISMTracing@@SA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@AEAUVector3@Numerics@Foundation@Windows@@@Z @ 0x1800837C0
 * Callers:
 ...
 *     ??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@$$QEAV10@0@Z @ 0x1800828FC (--$-HDU-$char_traits@D@std@@V-$allocator@D@1@@std@@YA-AV-$basic_string@DU-$char_traits@D@std@@V-.c)
 *     ??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@$$QEAV10@QEBD@Z @ 0x180082990 (--$-HDU-$char_traits@D@std@@V-$allocator@D@1@@std@@YA-AV-$basic_string@DU-$char_tra_ea_180082990.c)
 *     ??$_Floating_to_string@M@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PEBDM@Z @ 0x18008332C (--$_Floating_to_string@M@std@@YA-AV-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@0@PEB.c)
 */
...
__int64 __fastcall ISMTracing::GetVector3AsString(__int64 a1, float *a2)
{
  ...
  void *v7; // rax
  _QWORD *v8; // rax
  void *v10[2]; // [rsp+28h] [rbp-71h] BYREF
  __m128i v11; // [rsp+38h] [rbp-61h]
  void *v12[2]; // [rsp+48h] [rbp-51h] BYREF
  __m128i v13; // [rsp+58h] [rbp-41h]
  void *v14; // [rsp+68h] [rbp-31h] BYREF
  __m128i si128; // [rsp+78h] [rbp-21h]
  void *v16; // [rsp+88h] [rbp-11h] BYREF
  __m128i v17; // [rsp+98h] [rbp-1h]
  void *v18; // [rsp+A8h] [rbp+Fh] BYREF
  __m128i v19; // [rsp+B8h] [rbp+1Fh]
  void *v20[3]; // [rsp+C8h] [rbp+2Fh] BYREF
  unsigned __int64 v21; // [rsp+E0h] [rbp+47h]
