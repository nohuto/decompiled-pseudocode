/*
 * XREFs of ?UpdateResizeControllerClient@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800F3710
 * Callers:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 21) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 192LL))((char *)this - 16);
    if ( v9 < 0 )
