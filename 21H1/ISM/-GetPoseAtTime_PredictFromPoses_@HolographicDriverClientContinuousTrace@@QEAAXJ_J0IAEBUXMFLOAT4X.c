/*
 * XREFs of ?GetPoseAtTime_PredictFromPoses_@HolographicDriverClientContinuousTrace@@QEAAXJ_J0IAEBUXMFLOAT4X3@DirectX@@@Z @ 0x18015E460
 * Callers:
        ...
        const struct DirectX::XMFLOAT4X3 *a6)
{
  ...
  if ( HolographicDriverClientContinuousTrace::IsVerboseTracingEnabled((unsigned __int64)this) )
  {
    ...
    if ( **(_DWORD **)(v10 + 8) > 4u && tlgKeywordOn(*(_QWORD *)(v10 + 8), 0x800000LL) )
    {
      ...
      v17 = 0x1000000LL;
      v35 = 48;
      tlgWriteTransfer_EventWriteTransfer(v12, (unsigned __int8 *)dword_1801D053D, 0LL, 0LL, v11 + 4, &v18);
    }
  }
}
