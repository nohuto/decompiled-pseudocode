...
__int64 __fastcall ____0V__tuple_AEBV__basic_string__WU__char_traits__W_std__V__allocator__W_2__std___std__V__tuple___V_1__0A___Z_S___pair___CBV__basic_string__WU__char_traits__W_std__V__allocator__W_2__std__USpatialInteractionSnapshot_Holographic_Internal_Windows___std__QEAA_AEAV__tuple_AEBV__basic_string__WU__char_traits__W_std__V__allocator__W_2__std___1_AEAV__tuple___V_1_U__integer_sequence__K_0A__1_U__integer_sequence__K_S_1__Z(
        __int64 a1,
        _QWORD *a2)
{
  __int64 result; // rax
