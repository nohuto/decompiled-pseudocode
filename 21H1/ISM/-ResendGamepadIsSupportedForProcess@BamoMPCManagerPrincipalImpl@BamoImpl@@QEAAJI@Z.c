/*
 * XREFs of ?ResendGamepadIsSupportedForProcess@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180073DB4
 * Callers:
 *     ?Thunk_ResendGamepadIsSupportedForProcess_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180074A80 (-Thunk_ResendGamepadIsSupportedForProcess_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrinc.c)
 * Callees:
