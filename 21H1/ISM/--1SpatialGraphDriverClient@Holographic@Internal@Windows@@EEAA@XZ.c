/*
 * XREFs of ??1SpatialGraphDriverClient@Holographic@Internal@Windows@@EEAA@XZ @ 0x180157EE0
 * Callers:
 *     ??_ESpatialGraphDriverClient@Holographic@Internal@Windows@@EEAAPEAXI@Z @ 0x180159100 (--_ESpatialGraphDriverClient@Holographic@Internal@Windows@@EEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1?$vector@U?$pair@KPEAUIInputProcessor@@@std@@V?$allocator@U?$pair@KPEAUIInputProcessor@@@std@@@2@@std@@QEAA@XZ @ 0x18008751C (--1-$vector@U-$pair@KPEAUIInputProcessor@@@std@@V-$allocator@U-$pair@KPEAUIInputProcessor@@@std@.c)
