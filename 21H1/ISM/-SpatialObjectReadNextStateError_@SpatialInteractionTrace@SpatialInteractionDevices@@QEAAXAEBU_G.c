/*
 * XREFs of ?SpatialObjectReadNextStateError_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@J_J@Z @ 0x1800DCAB8
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *(_DWORD *)v7[1] > 4u && tlgKeywordOn(v7[1], 2LL) )
  {
    ...
    v12 = a2;
    v13 = 16LL;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_1801CD9DC, 0LL, 0LL, 5u, &v11);
  }
}
