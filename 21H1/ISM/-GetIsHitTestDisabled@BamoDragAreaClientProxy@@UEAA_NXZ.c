/*
 * XREFs of ?GetIsHitTestDisabled@BamoDragAreaClientProxy@@UEAA_NXZ @ 0x1800F5730
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoDragAreaClientProxy::GetIsHitTestDisabled(BamoDragAreaClientProxy *this)
{
