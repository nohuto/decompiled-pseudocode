/*
 * XREFs of ?UpdateUniqueIdRemoteCache@BamoDataSourcePrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x180145018
 * Callers:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    v9 = 9;
    v10[1] = v3;
    v7 = CoreUICallSend(SendHost, v10, 2LL, 5LL, v9, &unk_1801C1970, (unsigned int)&v12);
