/*
 * XREFs of ?GetCursorSuppressionPolicyObject@BamoInputSiteElementProxy@@UEAAPEAVBamoCursorSuppressionPolicyObjectProxy@@XZ @ 0x180010C80
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 168) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x18005659ELL);
  }
  return (struct BamoCursorSuppressionPolicyObjectProxy *)*((_QWORD *)this + 13);
}
