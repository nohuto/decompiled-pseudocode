...
__int64 __fastcall std::unordered_map<unsigned long,Microsoft::WRL::ComPtr<DataSourcePrincipal>>::_Try_emplace<unsigned long const &,>(
        __int64 a1,
        __int64 a2,
