/*
 * XREFs of ?CancelResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800FCCDC
 * Callers:
 *     ?Thunk_CancelResize_112@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FD2A0 (-Thunk_CancelResize_112@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProce.c)
 * Callees:
