/*
 * XREFs of ?OnAllReadersDisconnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x180142F44
 * Callers:
 *     ?Thunk_OnAllReadersDisconnected_3@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180144B80 (-Thunk_OnAllReadersDisconnected_3@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImp.c)
 * Callees:
