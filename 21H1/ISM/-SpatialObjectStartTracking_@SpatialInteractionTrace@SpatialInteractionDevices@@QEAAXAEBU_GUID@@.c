/*
 * XREFs of ?SpatialObjectStartTracking_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@JW4SPATIAL_TRACKING_STATE@@AEBUDynamicNodeInfo@Holographic@Internal@Windows@@@Z @ 0x1800D8F94
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *(_DWORD *)v8[1] > 4u )
  {
    ...
    if ( (_BYTE)v8 )
    {
      ...
      v16 = a2;
      v17 = 16LL;
      LOBYTE(v8) = tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801CCB4C, 0LL, 0LL, 7u, &v15);
    }
  }
  return (char)v8;
}
