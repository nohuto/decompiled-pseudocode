/*
 * XREFs of ??1PenEventsDispatcherPrincipal@@UEAA@XZ @ 0x1801329F4
 * Callers:
 *     ??_EPenEventsDispatcherPrincipal@@UEAAPEAXI@Z @ 0x180132B70 (--_EPenEventsDispatcherPrincipal@@UEAAPEAXI@Z.c)
 * Callees:
