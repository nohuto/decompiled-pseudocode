/*
 * XREFs of ?ParseInputBufferForReport@HidLampAttributesResponseReportParser@@QEAAJPEBEIPEAULampAttributesResponseDeviceReport@@@Z @ 0x1800AABEC
 * Callers:
 ...
 *     ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z @ 0x1800ACC20 (-ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z.c)
