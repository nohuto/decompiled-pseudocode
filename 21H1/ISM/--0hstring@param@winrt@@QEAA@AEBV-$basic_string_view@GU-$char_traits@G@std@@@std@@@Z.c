/*
 * XREFs of ??0hstring@param@winrt@@QEAA@AEBV?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x180033A78
 * Callers:
 ...
 * Callees:
 *     WINRT_WindowsCreateStringReference @ 0x18003CEC7 (WINRT_WindowsCreateStringReference.c)
 */
