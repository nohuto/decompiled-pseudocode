/*
 * XREFs of ?MakeRoutingDecisionsForAllFrames@Win32kInterop@@AEAAJAEAV?$unordered_set@KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@K@2@@std@@PEAUInputInfo@@PEAUIInputTarget@@@Z @ 0x1800B0ED4
 * Callers:
 ...
 *     ?SendCancelNotificationToGestureTargeting@Win32kInterop@@AEAAXAEAV?$unordered_set@KU?$hash@K@std@@U?$equal_to@K@2@V?$allocator@K@2@@std@@PEAUInputInfo@@@Z @ 0x1800B2CCC (-SendCancelNotificationToGestureTargeting@Win32kInterop@@AEAAXAEAV-$unordered_set@KU-$hash@K@std.c)
 *     ?_Push_back_internal@?$deque@UCachedInputInfo@@V?$allocator@UCachedInputInfo@@@std@@@std@@AEAAX$$QEAUCachedInputInfo@@@Z @ 0x1800B3D84 (-_Push_back_internal@-$deque@UCachedInputInfo@@V-$allocator@UCachedInputInfo@@@std@@@std@@AEAAX$.c)
 */
