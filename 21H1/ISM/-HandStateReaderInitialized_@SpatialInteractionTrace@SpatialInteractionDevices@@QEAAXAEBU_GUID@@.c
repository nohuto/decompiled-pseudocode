/*
 * XREFs of ?HandStateReaderInitialized_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@_N1111@Z @ 0x1800E00A8
 * Callers:
 *     ??$HandStateReaderInitialized@U_GUID@@AEB_NAEB_NAEB_NAEB_NAEA_N@SpatialInteractionTrace@SpatialInteractionDevices@@SAX$$QEAU_GUID@@AEB_N111AEA_N@Z @ 0x1800DDAF0 (--$HandStateReaderInitialized@U_GUID@@AEB_NAEB_NAEB_NAEB_NAEA_N@SpatialInteractionTrace@SpatialI.c)
 * Callees:
        ...
        bool a7)
{
  ...
  if ( *(_DWORD *)v10[1] > 4u && tlgKeywordOn(v10[1], 2LL) )
  {
    ...
    v18 = a2;
    v19 = 16LL;
    tlgWriteTransfer_EventWriteTransfer(v11, (unsigned __int8 *)dword_1801CDC48, 0LL, 0LL, 8u, &v17);
  }
}
