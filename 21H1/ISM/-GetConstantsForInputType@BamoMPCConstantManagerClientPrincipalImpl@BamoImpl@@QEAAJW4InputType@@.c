/*
 * XREFs of ?GetConstantsForInputType@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x18006F234
 * Callers:
 *     ?Thunk_GetConstantsForInputType_21@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180070920 (-Thunk_GetConstantsForInputType_21@-$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstant.c)
 * Callees:
