/*
 * XREFs of ?StartAnimation@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800F62B8
 * Callers:
 *     ?Thunk_StartAnimation_112@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F65C0 (-Thunk_StartAnimation_112@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContext.c)
 * Callees:
