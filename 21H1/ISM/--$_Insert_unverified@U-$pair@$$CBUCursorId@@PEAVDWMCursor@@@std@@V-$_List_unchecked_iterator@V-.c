/*
 * XREFs of ??$_Insert_unverified@U?$pair@$$CBUCursorId@@PEAVDWMCursor@@@std@@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBUCursorId@@PEAVDWMCursor@@@std@@@std@@@std@@@2@@?$_Hash@V?$_Umap_traits@UCursorId@@PEAVDWMCursor@@V?$_Uhash_compare@UCursorId@@UCursorIdHash@@U?$equal_to@UCursorId@@@std@@@std@@V?$allocator@U?$pair@$$CBUCursorId@@PEAVDWMCursor@@@std@@@4@$0A@@std@@@std@@IEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBUCursorId@@PEAVDWMCursor@@@std@@@std@@@std@@@std@@_N@1@$$QEAU?$pair@$$CBUCursorId@@PEAVDWMCursor@@@1@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBUCursorId@@PEAVDWMCursor@@@std@@@std@@@std@@@1@@Z @ 0x180024780
 * Callers:
 ...
 *     ?_Check_size@?$_Hash@V?$_Umap_traits@KPEAULegacyDeviceInfo@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKPEAULegacyDeviceInfo@@@std@@@3@$0A@@std@@@std@@IEAAXXZ @ 0x18002483C (-_Check_size@-$_Hash@V-$_Umap_traits@KPEAULegacyDeviceInfo@@V-$_Uhash_compare@KU-$hash@K@std@@U-.c)
...
__int64 __fastcall std::_Hash<std::_Umap_traits<CursorId,DWMCursor *,std::_Uhash_compare<CursorId,CursorIdHash,std::equal_to<CursorId>>,std::allocator<std::pair<CursorId const,DWMCursor *>>,0>>::_Insert_unverified<std::pair<CursorId const,DWMCursor *>,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<CursorId const,DWMCursor *>>>>>(
        __int64 a1,
        __int64 a2,
        ...
        __int64 *a4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      v18[1] = *v19;
      if ( v20 != a4 )
        *(_QWORD *)(*(_QWORD *)(v11 + 24) + 8 * v14 + 8) = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v11 + 24) + 8 * v14 + 8)
                                                                     + 8LL);
    }
  }
