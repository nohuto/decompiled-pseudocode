/*
 * XREFs of ?OnSystemButtonEvent@BamoSystemButtonEventControllerProxyImpl@BamoImpl@@QEAAJAEBUSystemButtonEventInfo@@@Z @ 0x1801026FC
 * Callers:
        ...
        const struct SystemButtonEventInfo *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      v10[1] = v14;
      v11 = v9;
      return CoreUICallSend(v7, v10, 2LL, 60LL, 0, &unk_1801C0288, (unsigned int)&v11);
    }
    else
    {
