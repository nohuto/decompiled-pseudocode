/*
 * XREFs of ?OnInputReport@MPCInputProviderBase@@UEAAJPEAUInputInfo@@@Z @ 0x180084970
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsDesiredCursorActive@MPCHolographicInputManager@@QEAA_NW4InputType@@@Z @ 0x180040308 (-IsDesiredCursorActive@MPCHolographicInputManager@@QEAA_NW4InputType@@@Z.c)
 ...
 *     ?ReportPerf@MPCPerfCounter@@AEAAX_K@Z @ 0x180086F40 (-ReportPerf@MPCPerfCounter@@AEAAX_K@Z.c)
 */
