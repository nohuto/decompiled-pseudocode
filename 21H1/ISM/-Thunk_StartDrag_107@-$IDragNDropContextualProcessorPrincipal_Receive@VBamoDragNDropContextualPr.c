/*
 * XREFs of ?Thunk_StartDrag_107@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F65E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
