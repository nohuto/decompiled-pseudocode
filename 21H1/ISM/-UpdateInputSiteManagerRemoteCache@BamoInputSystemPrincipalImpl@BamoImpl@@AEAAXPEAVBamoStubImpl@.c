 ...
 *     ?UpdateInputSiteManagerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x1800F0840 (-UpdateInputSiteManagerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubI.c)
 * Callees:
...
LABEL_8:
    ...
    v26[0] = v20;
    v26[1] = v19;
    v22 = CoreUICallSend(v21, v26, 2LL, 43LL, 7, &unk_1801C019A, v5);
