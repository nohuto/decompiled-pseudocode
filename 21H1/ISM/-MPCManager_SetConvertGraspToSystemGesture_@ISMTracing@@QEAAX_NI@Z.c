/*
 * XREFs of ?MPCManager_SetConvertGraspToSystemGesture_@ISMTracing@@QEAAX_NI@Z @ 0x180072E50
 * Callers:
...
void __fastcall ISMTracing::MPCManager_SetConvertGraspToSystemGesture_(ISMTracing *this, char a2, int a3)
{
  ...
  if ( **((_DWORD **)v5 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v5 + 1), 1LL) )
  {
    ...
    v10 = a3;
    v9 = a2;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_1801C862A, 0LL, 0LL, v7, &v11);
  }
}
