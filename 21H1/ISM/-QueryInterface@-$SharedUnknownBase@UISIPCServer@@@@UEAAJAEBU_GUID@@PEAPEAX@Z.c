/*
 * XREFs of ?QueryInterface@?$SharedUnknownBase@UISIPCServer@@@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800C1940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SharedUnknownBase<ISIPCServer>::QueryInterface(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  ...
  if ( !v5 )
    goto LABEL_4;
  v7 = *a2 - *(_QWORD *)&GUID_a2395c29_5063_428c_b815_9a39157e9ad2.Data1;
  if ( *a2 == *(_QWORD *)&GUID_a2395c29_5063_428c_b815_9a39157e9ad2.Data1 )
    v7 = a2[1] - *(_QWORD *)GUID_a2395c29_5063_428c_b815_9a39157e9ad2.Data4;
  if ( v7 )
    v6 = 0LL;
  else
LABEL_4:
