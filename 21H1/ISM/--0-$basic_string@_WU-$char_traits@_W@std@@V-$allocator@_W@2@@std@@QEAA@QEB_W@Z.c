/*
 * XREFs of ??0?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAA@QEB_W@Z @ 0x1800C5744
 * Callers:
 ...
 *     _lambda_b6eb6e6574f6e884ecb744657c22bdda_::operator() @ 0x18016A584 (_lambda_b6eb6e6574f6e884ecb744657c22bdda_--operator().c)
 * Callees:
