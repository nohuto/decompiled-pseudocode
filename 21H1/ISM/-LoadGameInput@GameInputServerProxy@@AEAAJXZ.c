/*
 * XREFs of ?LoadGameInput@GameInputServerProxy@@AEAAJXZ @ 0x180042D00
 * Callers:
 ...
 *     ?OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z @ 0x1800431D0 (-OnModuleUpdated@GameInputServerProxy@@CAXPEAX@Z.c)
 * Callees:
 ...
 *     ?CreateServer@GameInputServerProxy@@AEAAJPEAVGameInputModule@@@Z @ 0x180042A70 (-CreateServer@GameInputServerProxy@@AEAAJPEAVGameInputModule@@@Z.c)
