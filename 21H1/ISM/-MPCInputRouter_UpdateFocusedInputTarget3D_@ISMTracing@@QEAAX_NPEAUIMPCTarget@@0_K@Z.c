/*
 * XREFs of ?MPCInputRouter_UpdateFocusedInputTarget3D_@ISMTracing@@QEAAX_NPEAUIMPCTarget@@0_K@Z @ 0x1800B90C8
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( *v10 > 4u && tlgKeywordOn(v9[1], 1LL) )
    {
      ...
      v24 = 1;
      v18 = 1;
      tlgWriteTransfer_EventWriteTransfer((__int64)v10, (unsigned __int8 *)dword_1801CBB46, 0LL, 0LL, 7u, &v16);
    }
  }
}
