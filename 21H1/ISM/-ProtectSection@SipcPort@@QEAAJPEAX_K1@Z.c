/*
 * XREFs of ?ProtectSection@SipcPort@@QEAAJPEAX_K1@Z @ 0x1800C17A0
 * Callers:
 *     ?ProtectBuffer@SipcEndpoint@@UEAAJPEAX_K1@Z @ 0x1800C1760 (-ProtectBuffer@SipcEndpoint@@UEAAJPEAX_K1@Z.c)
 * Callees:
...
__int64 __fastcall SipcPort::ProtectSection(SipcPort *this, void *a2, __int64 a3, unsigned __int64 a4)
{
  ...
  wil::details::in1diag0::Return_Hr((wil::details::in1diag0 *)v8, v6);
  return v8;
}
