/*
 * XREFs of ?Stop@?$ActivityBase@VHolographicDriverClientTrace@@$0A@$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x18016545C
 * Callers:
        ...
        int a2)
{
  ...
  {
    v6 = *(_DWORD **)(wil::details::static_lazy<HolographicDriverClientTrace>::get(
                        v4,
