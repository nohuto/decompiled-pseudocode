/*
 * XREFs of ?QueryInterface@MPCTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800BB190
 * Callers:
 *     ?QueryInterface@MPCTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B590 (-QueryInterface@MPCTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCFocusTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800BA630 (-QueryInterface@MPCFocusTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x18004ACA0 (_guard_dispatch_icall_nop.c)
 *     ?QueryInterface@RefCountedObject@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180066260 (-QueryInterface@RefCountedObject@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
