/*
 * XREFs of ??1ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ @ 0x180157B6C
 * Callers:
 ...
 *     ?GetWorkThreadId@ChainedThreadpoolWorker@ThreadHelpers@@QEAAKXZ @ 0x180049624 (-GetWorkThreadId@ChainedThreadpoolWorker@ThreadHelpers@@QEAAKXZ.c)
 ...
 *     ?_Tidy@?$deque@V?$ComPtr@UIUnknown@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIUnknown@@@WRL@Microsoft@@@std@@@std@@AEAAXXZ @ 0x180167728 (-_Tidy@-$deque@V-$ComPtr@UIUnknown@@@WRL@Microsoft@@V-$allocator@V-$ComPtr@UIUnknown@@@WRL@Micro.c)
 *     ?_Tidy@?$deque@V?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@V?$allocator@V?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@@2@@std@@AEAAXXZ @ 0x1801677D0 (-_Tidy@-$deque@V-$shared_ptr@V-$function@$$A6AXXZ@std@@@std@@V-$allocator@V-$shared_ptr@V-$funct.c)
 */
