/*
 * XREFs of ?Initialize3DComponents@MPCSixDofProcessor@@UEAAXXZ @ 0x18018D110
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCSixDofProcessor::Initialize3DComponents(MPCSixDofProcessor *this)
{
  ...
  v5 = std::make_unique<MPCButtonHoldHelper,float,0>(&v34, flt_1801C6E08);
