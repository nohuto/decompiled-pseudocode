/*
 * XREFs of ?zInternalStart@?$ActivityBase@VHolographicDriverClientTrace@@$00$0EAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x1801682D4
 * Callers:
        ...
        __int64 a1)
{
  ...
  v4 = (_DWORD *)wil::details::static_lazy<HolographicDriverClientTrace>::get(
                   v3,
                   _lambda_9dbe22df4b880a8e911c86b950d68f95_::_lambda_invoker_cdecl_)[1];
  if ( *v4 > 5u && tlgKeywordOn((__int64)v4, 0x400000000000LL) )
