/*
 * XREFs of ?TryCreateAndInitialize@HidLampMultiUpdateReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800ABD24
 * Callers:
 ...
 *     ??0HidLampMultiUpdateReportParser@@AEAA@XZ @ 0x1800AB3E0 (--0HidLampMultiUpdateReportParser@@AEAA@XZ.c)
 *     ?IsParserValid@HidLampMultiUpdateReportParser@@CA_NPEAV1@@Z @ 0x1800ABA3C (-IsParserValid@HidLampMultiUpdateReportParser@@CA_NPEAV1@@Z.c)
 */
