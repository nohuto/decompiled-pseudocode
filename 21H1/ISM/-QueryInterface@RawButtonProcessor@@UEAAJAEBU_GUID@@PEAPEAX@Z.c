/*
 * XREFs of ?QueryInterface@RawButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801829F0
 * Callers:
 *     ?QueryInterface@RawButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004D530 (-QueryInterface@RawButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
