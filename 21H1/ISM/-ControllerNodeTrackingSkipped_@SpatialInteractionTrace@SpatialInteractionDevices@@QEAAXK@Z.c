/*
 * XREFs of ?ControllerNodeTrackingSkipped_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXK@Z @ 0x1800CF3F4
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_DWORD *)v3[1] > 4u && tlgKeywordOn(v3[1], 2LL) )
  {
    ...
    v5 = a2;
    v8 = 4;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801CBE8D, 0LL, 0LL, 3u, &v6);
  }
}
