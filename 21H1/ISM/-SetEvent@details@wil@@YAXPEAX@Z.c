/*
 * XREFs of ?SetEvent@details@wil@@YAXPEAX@Z @ 0x1800216BC
 * Callers:
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_4bfd0116db80ce4255855ce8af72e9c8_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x180021670 (--$_Callback_once@V-$tuple@$$QEAV_lambda_4bfd0116db80ce4255855ce8af72e9c8_@@AEAVexception_ptr@st.c)
 ...
 *     ?AttachDevice@MPCRawInputProvider@@QEAAJW4InputType@@PEAK@Z @ 0x18008A73C (-AttachDevice@MPCRawInputProvider@@QEAAJW4InputType@@PEAK@Z.c)
 ...
 *     std::_Func_impl_no_alloc__lambda_0fae2a381de83fbae39279513878d32b__void_::_Do_call @ 0x1801673C0 (std--_Func_impl_no_alloc__lambda_0fae2a381de83fbae39279513878d32b__void_--_Do_call.c)
 *     std::_Func_impl_no_alloc__lambda_e9caf7be01a97f1d4a6ebcd24956563c__void_::_Do_call @ 0x180167480 (std--_Func_impl_no_alloc__lambda_e9caf7be01a97f1d4a6ebcd24956563c__void_--_Do_call.c)
 * Callees:
