/*
 * XREFs of ?SetConstantToDefault@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@QEAAJW4InputType@@PEBGPEAVBamoAsyncHRESULTPrincipal@@@Z @ 0x18010B7A8
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a4)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v11 = 3;
      return CoreUICallSend(v10, v13, 2LL, 1LL, v11, &unk_1801C28A0, a2);
    }
    else
    {
