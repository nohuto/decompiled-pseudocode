/*
 * XREFs of ??1SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAA@XZ @ 0x18016A0B0
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@VSpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@@std@@EEAAXXZ @ 0x1800D3CA0 (-_Destroy@-$_Ref_count_obj@VSpatialInteractionSourceController@SpatialInteractions@Internal@Wind.c)
 * Callees:
 ...
 *     ??1HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ @ 0x1800CBA7C (--1HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ.c)
 ...
 *     ?ReleaseNodePropertyChangedHandler@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAXXZ @ 0x18016E938 (-ReleaseNodePropertyChangedHandler@SpatialInteractionSourceController@SpatialInteractions@Intern.c)
 *     ?Report@SpatialInteractionHeartbeat@SpatialInteractionDevices@@AEAAX_N@Z @ 0x18016E9CC (-Report@SpatialInteractionHeartbeat@SpatialInteractionDevices@@AEAAX_N@Z.c)
 *     ?Shutdown@HapticsEngine@SpatialInteractions@Internal@Windows@@QEAAXXZ @ 0x18016F52C (-Shutdown@HapticsEngine@SpatialInteractions@Internal@Windows@@QEAAXXZ.c)
 */
