/*
 * XREFs of ?SetTimestampsFromInput@GameControllerRawInputProvider@@AEAAX_KPEAUInputInfo@@@Z @ 0x180089554
 * Callers:
        ...
        struct InputInfo *a3)
{
  ...
  *((_DWORD *)a3 + 2) = v8;
  ...
  if ( GameControllerRawInputProvider::s_qpcTime )
    v10 = GameControllerRawInputProvider::s_qpcTime * (a2 / qword_180209800)
        + GameControllerRawInputProvider::s_qpcTime * (a2 % qword_180209800) / qword_180209800;
  *((_QWORD *)a3 + 2) = v10;
}
