/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerProxyImpl@BamoImpl@@QEAAJPEAVBamoControllerNavigationOverridePrincipal@@@Z @ 0x1800EBB4C
 * Callers:
        ...
        struct BamoControllerNavigationOverridePrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this[2] + 3) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9[0] = v11;
      v9[1] = v12;
      return CoreUICallSend(v8, v9, 2LL, 14LL, 1, &unk_1801C019A, v5);
    }
    else
    {
