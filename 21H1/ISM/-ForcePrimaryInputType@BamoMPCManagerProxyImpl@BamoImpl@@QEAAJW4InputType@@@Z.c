/*
 * XREFs of ?ForcePrimaryInputType@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJW4InputType@@@Z @ 0x180107E8C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerProxyImpl::ForcePrimaryInputType(__int64 a1, int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 5;
      return CoreUICallSend(v8, v10, 2LL, 3LL, v9, &unk_1801C2895, a2);
    }
    else
    {
