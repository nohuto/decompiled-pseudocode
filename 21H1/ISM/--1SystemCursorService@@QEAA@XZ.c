/*
 * XREFs of ??1SystemCursorService@@QEAA@XZ @ 0x18013B728
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@VSystemCursorService@@@std@@EEAAXXZ @ 0x18013D4A0 (-_Destroy@-$_Ref_count_obj@VSystemCursorService@@@std@@EEAAXXZ.c)
 * Callees:
