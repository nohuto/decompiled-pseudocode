/*
 * XREFs of ?CreateSpatialGraphDriverClient@@YAJPEAUHSTRING__@@PEAPEAUISpatialGraphDriverClient@Holographic@Internal@Windows@@@Z @ 0x18015B1A0
 * Callers:
        ...
        struct Windows::Internal::Holographic::ISpatialGraphDriverClient **a2)
{
  ...
  v7 = a1;
  v8 = SpatialGraphDriverClientHelpers::DefaultSpatialGraphSettings();
