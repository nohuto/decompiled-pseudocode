/*
 * XREFs of ?UpdateDisplayOcclusionLogicalRangeRemoteCache@BamoDockDevicePrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x180128518
 * Callers:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    v10[1] = v3;
    v9 = 2;
    v7 = CoreUICallSend(SendHost, v10, 2LL, 20LL, v9, &unk_1801C01B7, (unsigned int)&v11);
