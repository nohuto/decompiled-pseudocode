/*
 * XREFs of ?MPCHolographicInputManager_FocusedAppDisabled3DGamepad_@ISMTracing@@QEAAXAEB_N@Z @ 0x180076CE0
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_FocusedAppDisabled3DGamepad_(ISMTracing *this, const bool *a2)
{
  ...
  if ( **((_DWORD **)v3 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v3 + 1), 1LL) )
  {
    ...
    v10 = v4;
    v9 = &v7;
    tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_1801C87C8, 0LL, 0LL, 3u, &v8);
  }
}
