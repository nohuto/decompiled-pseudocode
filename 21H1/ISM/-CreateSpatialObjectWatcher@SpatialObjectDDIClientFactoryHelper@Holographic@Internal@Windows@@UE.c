/*
 * XREFs of ?CreateSpatialObjectWatcher@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEAUISpatialObject@234@AEBU_GUID@@PEAUISpatialObjectWatcherCallback@234@PEAPEAUISpatialObjectWatcher@234@@Z @ 0x1800D75F0
 * Callers:
 *     <none>
 * Callees:
