/*
 * XREFs of std::_Func_impl_no_alloc__lambda_d996afdc272f919756ffd34e8729d8d0__void__MIT_POINTER_INPUT_DOWN_MESSAGE_const___::_Do_call @ 0x180139C20
 * Callers:
 *     <none>
 * Callees:
 *     ?PointerTypeToInputType@@YA?AW4InputType@@K_N@Z @ 0x1800C4580 (-PointerTypeToInputType@@YA-AW4InputType@@K_N@Z.c)
