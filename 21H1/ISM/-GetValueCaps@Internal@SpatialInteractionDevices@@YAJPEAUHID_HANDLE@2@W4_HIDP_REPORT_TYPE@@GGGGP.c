/*
 * XREFs of ?GetValueCaps@Internal@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@2@W4_HIDP_REPORT_TYPE@@GGGGPEAPEAU_HIDP_VALUE_CAPS@@@Z @ 0x1800CBDE4
 * Callers:
 *     ?SupportsAnalogTrigger@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEA_N@Z @ 0x1800CA71C (-SupportsAnalogTrigger@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEA_N@Z.c)
 ...
 *     ?MatchValueCaps@Internal@SpatialInteractionDevices@@YA_NGGGGPEAU_HIDP_VALUE_CAPS@@@Z @ 0x1800C9A08 (-MatchValueCaps@Internal@SpatialInteractionDevices@@YA_NGGGGPEAU_HIDP_VALUE_CAPS@@@Z.c)
 */
