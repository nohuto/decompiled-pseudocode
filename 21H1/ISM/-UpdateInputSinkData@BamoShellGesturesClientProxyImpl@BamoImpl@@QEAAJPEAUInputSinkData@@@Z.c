/*
 * XREFs of ?UpdateInputSinkData@BamoShellGesturesClientProxyImpl@BamoImpl@@QEAAJPEAUInputSinkData@@@Z @ 0x1801018B0
 * Callers:
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoShellGesturesClientProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x180045F60 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoShellGesturesClientProxyImpl@BamoImpl@@UEAAXPEAV.c)
 *     ?Thunk_UpdateInputSinkData_232@?$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801018A0 (-Thunk_UpdateInputSinkData_232@-$IShellGesturesClientProxy_Receive@VBamoShellGesturesClientProxy.c)
 * Callees:
