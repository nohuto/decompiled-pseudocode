/*
 * XREFs of ?ExtractPenIdFromReport@PenIdentity@@YA_NPEAXKW4_HIDP_REPORT_TYPE@@PEAU_HIDP_PREPARSED_DATA@@PEAU_GUID@@@Z @ 0x180132138
 * Callers:
 ...
 *     ?CreatePenId@PenIdentity@@YA_NG_KPEAU_GUID@@@Z @ 0x180132118 (-CreatePenId@PenIdentity@@YA_NG_KPEAU_GUID@@@Z.c)
 */
