/*
 * XREFs of ?DynamicNodePoseValidityChanged_@HolographicDriverClientContinuousTrace@@QEAAXPEBXAEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_VALIDITY_FLAGS@@_N@Z @ 0x18015C02C
 * Callers:
        ...
        char a5)
{
  ...
  if ( *v9 > 4u )
  {
    ...
    LODWORD(v8) = tlgWriteTransfer_EventWriteTransfer(
                    (__int64)v9,
                    (unsigned __int8 *)dword_1801CFD06,
                    0LL,
                    0LL,
                    6u,
                    &v14);
