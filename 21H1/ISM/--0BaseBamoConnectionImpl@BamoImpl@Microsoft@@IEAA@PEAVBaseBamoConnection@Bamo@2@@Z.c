/*
 * XREFs of ??0BaseBamoConnectionImpl@BamoImpl@Microsoft@@IEAA@PEAVBaseBamoConnection@Bamo@2@@Z @ 0x1800319B4
 * Callers:
 ...
 *     ??0BamoConnection@MPCManagerBamo_AutoBamos@@IEAA@XZ @ 0x180032314 (--0BamoConnection@MPCManagerBamo_AutoBamos@@IEAA@XZ.c)
 * Callees:
 *     <none>
 */
