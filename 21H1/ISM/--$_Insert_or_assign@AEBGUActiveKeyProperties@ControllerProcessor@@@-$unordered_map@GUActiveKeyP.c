        ...
        _BYTE *a4)
{
  ...
  v8 = *(_QWORD *)(a1 + 48) & std::_Fnv1a_append_bytes(a1, a3, 2uLL);
  while ( 1 )
  {
...
LABEL_6:
  if ( (__int64 *)v10 == v12 )
  {
    std::list<std::pair<unsigned short const,ControllerProcessor::ActiveKeyProperties>>::_Insert<unsigned short const &,ControllerProcessor::ActiveKeyProperties>(
      (__int64)v11,
      *v12,
      a3,
      a4);
