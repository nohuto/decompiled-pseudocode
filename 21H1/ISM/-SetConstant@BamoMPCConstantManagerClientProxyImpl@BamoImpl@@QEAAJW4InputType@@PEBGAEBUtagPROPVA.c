/*
 * XREFs of ?SetConstant@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@QEAAJW4InputType@@PEBGAEBUtagPROPVARIANT@@PEAVBamoAsyncHRESULTPrincipal@@@Z @ 0x18010B5C4
 * Callers:
        ...
        struct Microsoft::Bamo::BamoPrincipal *a5)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      v17 = v13;
      v18 = v14;
      return CoreUICallSend(v11, v16, 2LL, 1LL, 0, &unk_1801C2898, a2);
    }
    else
    {
