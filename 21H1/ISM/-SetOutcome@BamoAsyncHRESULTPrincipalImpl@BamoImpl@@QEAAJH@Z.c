/*
 * XREFs of ?SetOutcome@BamoAsyncHRESULTPrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x18011BD74
 * Callers:
 *     ?Thunk_SetOutcome_0@?$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011BE70 (-Thunk_SetOutcome_0@-$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@.c)
 * Callees:
