/*
 * XREFs of ?Materialize_BamoPenEventsDispatcherProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E81E0
 * Callers:
 *     ?Thunk_Materialize_BamoPenEventsDispatcherProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED140 (-Thunk_Materialize_BamoPenEventsDispatcherProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoPenEventsDispatcherProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoPenEventsDispatcherProxy::`vftable'{for `IPenEventsDispatcherProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
