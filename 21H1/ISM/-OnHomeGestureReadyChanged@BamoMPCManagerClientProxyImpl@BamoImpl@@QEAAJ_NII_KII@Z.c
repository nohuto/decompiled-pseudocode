/*
 * XREFs of ?OnHomeGestureReadyChanged@BamoMPCManagerClientProxyImpl@BamoImpl@@QEAAJ_NII_KII@Z @ 0x1801099C8
 * Callers:
        ...
        unsigned __int8 a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 6;
      return CoreUICallSend(v8, v11, 2LL, 5LL, v9, &unk_1801C28CF, v3);
    }
    else
    {
