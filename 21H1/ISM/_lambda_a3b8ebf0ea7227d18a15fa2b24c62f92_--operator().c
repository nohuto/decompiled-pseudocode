/*
 * XREFs of _lambda_a3b8ebf0ea7227d18a15fa2b24c62f92_::operator() @ 0x180041928
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_a3b8ebf0ea7227d18a15fa2b24c62f92__void_InputContext___::_Do_call @ 0x180042040 (std--_Func_impl_no_alloc__lambda_a3b8ebf0ea7227d18a15fa2b24c62f92__void_InputContext___--_Do_cal.c)
 * Callees:
 ...
 *     ??$_Insert_or_assign@AEBKAEAV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@?$unordered_map@KV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@U?$hash@K@std@@U?$equal_to@K@5@V?$allocator@U?$pair@$$CBKV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@std@@@5@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@std@@@std@@@std@@@std@@_N@1@AEBKAEAV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@Z @ 0x1800AD1B4 (--$_Insert_or_assign@AEBKAEAV-$ComPtr@UIInputTarget@@@WRL@Microsoft@@@-$unordered_map@KV-$ComPtr.c)
