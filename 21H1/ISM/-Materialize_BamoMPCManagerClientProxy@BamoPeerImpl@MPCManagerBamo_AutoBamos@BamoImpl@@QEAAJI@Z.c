/*
 * XREFs of ?Materialize_BamoMPCManagerClientProxy@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x180073250
 * Callers:
 *     ?Thunk_Materialize_BamoMPCManagerClientProxy_11@?$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800749D0 (-Thunk_Materialize_BamoMPCManagerClientProxy_11@-$IBamoPeer_MPCManagerBamo_AutoBamos_Receive@VBa.c)
 * Callees:
