/*
 * XREFs of ??$_Free_non_head@V?$allocator@U?$_List_node@U?$pair@$$CBKW4ContextualProcessorState@@@std@@PEAX@std@@@std@@@?$_List_node@U?$pair@$$CBKW4ContextualProcessorState@@@std@@PEAX@std@@SAXAEAV?$allocator@U?$_List_node@U?$pair@$$CBKW4ContextualProcessorState@@@std@@PEAX@std@@@1@PEAU01@@Z @ 0x1800971D4
 * Callers:
 *     ??1?$list@IV?$allocator@I@std@@@std@@QEAA@XZ @ 0x180097B94 (--1-$list@IV-$allocator@I@std@@@std@@QEAA@XZ.c)
 ...
 *     ?EndCurrentSession@TouchInfoAdapter@@UEAAJK@Z @ 0x18019A0C0 (-EndCurrentSession@TouchInfoAdapter@@UEAAJK@Z.c)
 * Callees:
