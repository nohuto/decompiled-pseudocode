/*
 * XREFs of ?Materialize_BamoDropTargetClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E75B4
 * Callers:
 *     ?Thunk_Materialize_BamoDropTargetClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECFC0 (-Thunk_Materialize_BamoDropTargetClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeer.c)
 * Callees:
