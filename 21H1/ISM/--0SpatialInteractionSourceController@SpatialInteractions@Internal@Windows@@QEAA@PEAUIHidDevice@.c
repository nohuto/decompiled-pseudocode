/*
 * XREFs of ??0SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAA@PEAUIHidDevice@123@KKV?$function@$$A6AXXZ@std@@@Z @ 0x180169B54
 * Callers:
 ...
 *     ??0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ @ 0x1800CB8BC (--0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ.c)
 ...
 *     ??0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z @ 0x180169ECC (--0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z.c)
        ...
        __int64 a5)
{
  ...
  *((_WORD *)this + 592) = 0;
  memset_0((char *)this + 1024, 0, 0xA0uLL);
  memset_0((char *)this + 960, 0, 0x40uLL);
  v19.m256i_i64[0] = qword_180209A70;
  v19.m256i_i32[2] = dword_180209A78;
  *(_OWORD *)((char *)&v19.m256i_u64[1] + 4) = xmmword_1801C7360;
