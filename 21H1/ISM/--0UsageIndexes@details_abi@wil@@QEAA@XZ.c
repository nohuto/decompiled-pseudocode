/*
 * XREFs of ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x1800055D0
 * Callers:
 ...
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x180066200 (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
 * Callees:
