/*
 * XREFs of ?QueryInterface@BamoPenDeviceManagerStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012FE00
 * Callers:
 *     ?QueryInterface@BamoPenDeviceManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C830 (-QueryInterface@BamoPenDeviceManagerStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
