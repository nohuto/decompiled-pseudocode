/*
 * XREFs of SpatialInteractionDevices::AdjustOrientationAndScale @ 0x1800C93F8
 * Callers:
    ...
    if ( v5 )
    {
      ...
      v7 = _mm_add_ps(
             _mm_add_ps(
               ...
               _mm_mul_ps(_mm_shuffle_ps(v6, v6, 0), DirectX::XMMatrixRotationQuaternion(*(double *)&xmmword_180208A88))),
