/*
 * XREFs of ?DockEventsEnabledChanged@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180132F8C
 * Callers:
        ...
        unsigned __int8 a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 6;
      return CoreUICallSend(v8, v10, 2LL, 52LL, v9, &unk_1801C019D, v3);
    }
    else
    {
