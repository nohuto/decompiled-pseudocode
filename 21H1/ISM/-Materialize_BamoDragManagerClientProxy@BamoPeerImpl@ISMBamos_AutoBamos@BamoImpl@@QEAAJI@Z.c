/*
 * XREFs of ?Materialize_BamoDragManagerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E73FC
 * Callers:
 *     ?Thunk_Materialize_BamoDragManagerClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF60 (-Thunk_Materialize_BamoDragManagerClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPee.c)
 * Callees:
