/*
 * XREFs of ?RecordCachedUsageUnderLock@EnabledStateManager@details@wil@@AEAAXXZ @ 0x180066548
 * Callers:
 ...
 *     ?OnTimer@EnabledStateManager@details@wil@@QEAAXXZ @ 0x1800661A8 (-OnTimer@EnabledStateManager@details@wil@@QEAAXXZ.c)
 * Callees:
