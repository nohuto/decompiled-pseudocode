/*
 * XREFs of ?AddEndpoint@DWMCursorBroker@@UEAAJUtagMsgRoutingInfo@@I_N@Z @ 0x18019BAF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextEndpointIndex@DWMCursorBroker@@AEAAJPEAI@Z @ 0x18019C004 (-GetNextEndpointIndex@DWMCursorBroker@@AEAAJPEAI@Z.c)
 */
