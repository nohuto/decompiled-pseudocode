/*
 * XREFs of ?NodePropertyRequestAdded_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0@Z @ 0x180160CF0
 * Callers:
        ...
        const struct _GUID *a4)
{
  ...
  if ( **(_DWORD **)(v7 + 8) > 4u && tlgKeywordOn(*(_QWORD *)(v7 + 8), 2LL) )
  {
    ...
    v10 = a2;
    v11 = 16LL;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_1801D0928, 0LL, 0LL, 5u, &v9);
  }
}
