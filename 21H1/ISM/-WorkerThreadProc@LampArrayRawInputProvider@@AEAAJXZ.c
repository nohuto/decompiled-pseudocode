/*
 * XREFs of ?WorkerThreadProc@LampArrayRawInputProvider@@AEAAJXZ @ 0x180038850
 * Callers:
 ...
 *     ?Shutdown@PnpDeviceWatcher@@QEAAXXZ @ 0x18009F7B8 (-Shutdown@PnpDeviceWatcher@@QEAAXXZ.c)
