/*
 * XREFs of ?AllocateStubThunk@BamoList_PenDevicePrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAJPEAVBaseBamoPeerImpl@36@PEAPEAVBamoStub@56@@Z @ 0x18012F160
 * Callers:
 *     <none>
 * Callees:
