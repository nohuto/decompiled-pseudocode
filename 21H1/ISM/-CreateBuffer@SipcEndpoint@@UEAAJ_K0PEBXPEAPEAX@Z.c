/*
 * XREFs of ?CreateBuffer@SipcEndpoint@@UEAAJ_K0PEBXPEAPEAX@Z @ 0x1800BFF10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SipcEndpoint::CreateBuffer(SipcEndpoint *this, __int64 a2, __int64 a3, const void *a4, void **a5)
{
  ...
  v5 = 0;
  *a5 = 0LL;
  if ( (unsigned __int64)(a2 - 1) <= 0x7FFFFFFFFFFFFFFELL && (LOBYTE(v5) = a4 == 0LL, (a3 == 0) == v5) )
  {
    if ( *((_DWORD *)this + 15) == 2 )
  ...
  wil::details::in1diag0::Return_Hr((wil::details::in1diag0 *)v6, a2);
  return v6;
}
