/*
 * XREFs of ?Thunk_UpdateViewInstanceId_10@?$IInputAttemptedDeliveryClientProxy_Receive@VBamoInputAttemptedDeliveryClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180005370
 * Callers:
 *     <none>
 * Callees:
