/*
 * XREFs of ?OnGazeUpdate@MPCGamepadProcessor@@UEAAXPEAUInputInfo@@@Z @ 0x180192AA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ComputeTimeScale@MPCGamepadProcessor@@AEAAXPEAUInputInfo@@@Z @ 0x1801924FC (-ComputeTimeScale@MPCGamepadProcessor@@AEAAXPEAUInputInfo@@@Z.c)
...
void __fastcall MPCGamepadProcessor::OnGazeUpdate(unsigned __int64 this, struct InputInfo *a2)
{
  ...
  *(_DWORD *)(*(_QWORD *)(this + 4624) + 8LL) = *((_DWORD *)a2 + 2);
  *(_QWORD *)(*(_QWORD *)(this + 4624) + 16LL) = *((_QWORD *)a2 + 2);
  MPCSlateDeadzoneHelper::UpdateState(
    *(MPCSlateDeadzoneHelper **)(this + 5128),
    (*(_DWORD *)(this + 4636) & 4) != 0,
    *((_QWORD *)a2 + 2),
    *((float *)a2 + 39),
    *((float *)a2 + 40),
    *((float *)a2 + 54));
  ...
  if ( MPCGamepadInputHelper::ShouldHandleMPCInput(Instance) )
  {
    ...
    *(_BYTE *)(this + 5028) = ShouldUseGazeAndCommit;
      ...
      || *(_DWORD *)(this + 5024) )
    {
      ...
      if ( *((_BYTE *)a2 + 154) || *(_DWORD *)(this + 5024) )
      {
    ...
    else
    {
      ...
      v40 = wil::com_ptr_t<InputSite,wil::err_exception_policy>::com_ptr_t<InputSite,wil::err_exception_policy>(
              v95,
              this & -(__int64)(this != 32));
      if ( MPCGestureHandlerManager::IsInjecting((__int64)v39, v40) && (*(_BYTE *)(this + 4636) & 4) == 0
    ...
    v44 = 0.0;
    if ( (*(_DWORD *)(this + 4636) & 0x400) != 0 )
      v45 = FLOAT_N1_0;
    else
      v45 = 0.0;
    if ( (*(_DWORD *)(this + 4636) & 0x800) != 0 )
      v44 = FLOAT_1_0;
    v46 = (float)(*(float *)(this + 4648) + *(float *)(this + 5056)) * 0.5;
    v47 = (float)(*(float *)(this + 4652) + *(float *)(this + 5060)) * 0.5;
    v48 = (float)((float)(COERCE_FLOAT(*(_DWORD *)(this + 4644) ^ _xmm) + *(float *)(this + 4640))
                + *(float *)(this + 5064))
        * 0.5;
    *(float *)(this + 5068) = (float)((float)(v44 + v45) + *(float *)(this + 5068)) * 0.5;
    *(float *)(this + 5056) = v46;
    *(float *)(this + 5060) = v47;
    *(float *)(this + 5064) = v48;
    ...
    v58 = *(float *)(this + 5104);
    LODWORD(v59) = *(_DWORD *)(this + 5056) & _xmm;
    ...
    if ( v59 >= COERCE_FLOAT(L"ThumbstickDeadzone") )
    {
      ...
      v65 = (float)((float)(v64 * v96[1]) * v58) + *(float *)(this + 5048);
      v66 = (float)((float)(v64 * v96[2]) * v58) + *(float *)(this + 5052);
      *(float *)(this + 5044) = (float)((float)(v64 * v96[0]) * v58) + *(float *)(this + 5044);
      *(float *)(this + 5048) = v65;
      *(float *)(this + 5052) = v66;
      v67 = *(float *)(this + 5056);
      if ( !MPCConstantManager::s_instance )
      ...
      v94 = 16LL;
      MPCConstantManager::GetConstant<float>((__int64)MPCConstantManager::s_instance, v60, (__int128 *)&v93[1]);
      *(float *)(this + 5072) = (float)((float)(COERCE_FLOAT(L"PointScaleFactor") * v67) * v58)
                              + *(float *)(this + 5072);
    }
    LODWORD(v68) = *(_DWORD *)(this + 5060) & _xmm;
    if ( !MPCConstantManager::s_instance )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        retaddr,
    ...
    if ( v68 >= COERCE_FLOAT(L"ThumbstickDeadzone") )
    {
      ...
      v73 = (float)((float)(v72 * v51) * v58) + *(float *)(this + 5048);
      v74 = (float)((float)(v72 * v52) * v58) + *(float *)(this + 5052);
      *(float *)(this + 5044) = (float)((float)(v72 * v50) * v58) + *(float *)(this + 5044);
      *(float *)(this + 5048) = v73;
      *(float *)(this + 5052) = v74;
      v75 = *(float *)(this + 5060);
      if ( !MPCConstantManager::s_instance )
      ...
      v94 = 16LL;
      MPCConstantManager::GetConstant<float>((__int64)MPCConstantManager::s_instance, v60, (__int128 *)&v93[1]);
      *(float *)(this + 5076) = (float)((float)(COERCE_FLOAT(L"PointScaleFactor") * v75) * v58)
                              + *(float *)(this + 5076);
    }
    LODWORD(v76) = *(_DWORD *)(this + 5064) & _xmm;
    if ( !MPCConstantManager::s_instance )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        retaddr,
    ...
    if ( v76 >= COERCE_FLOAT(L"ThumbstickDeadzone") )
    {
      ...
      v81 = (float)((float)(v80 * v53) * v58) + *(float *)(this + 5044);
      v82 = (float)((float)(v80 * v54) * v58) + *(float *)(this + 5048);
      v83 = (float)((float)(v80 * v55) * v58) + *(float *)(this + 5052);
      *(float *)(this + 5044) = v81;
      *(float *)(this + 5048) = v82;
      *(float *)(this + 5052) = v83;
      v84 = *(float *)(this + 5064);
      ...
      v94 = 16LL;
      MPCConstantManager::GetConstant<float>((__int64)MPCConstantManager::s_instance, v60, (__int128 *)&v93[1]);
      *(float *)(this + 5080) = (float)((float)(COERCE_FLOAT(L"PointScaleFactor") * v84) * v58)
                              + *(float *)(this + 5080);
    }
    LODWORD(v85) = *(_DWORD *)(this + 5068) & _xmm;
    if ( !MPCConstantManager::s_instance )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        retaddr,
    ...
    if ( v85 >= COERCE_FLOAT(L"ThumbstickDeadzone") )
    {
      ...
      v94 = 16LL;
      MPCConstantManager::GetConstant<float>((__int64)MPCConstantManager::s_instance, v60, (__int128 *)&v93[1]);
      *(float *)(this + 5084) = (float)((float)(COERCE_FLOAT(L"PointScaleFactor") * v88) * v58)
                              + *(float *)(this + 5084);
    }
    v89 = *(_DWORD *)(this + 4660);
    v90 = *(_QWORD *)(this + 4652);
    *(_OWORD *)(this + 4664) = *(_OWORD *)(this + 4636);
    *(_QWORD *)(this + 4680) = v90;
    *(_DWORD *)(this + 4688) = v89;
