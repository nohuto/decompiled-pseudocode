/*
 * XREFs of ?DeviceRemoved@BamoSystemCursorControllerClientProxyImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800E561C
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 1;
      return CoreUICallSend(v8, v10, 2LL, 64LL, v9, &unk_1801C0192, a2);
    }
    else
    {
