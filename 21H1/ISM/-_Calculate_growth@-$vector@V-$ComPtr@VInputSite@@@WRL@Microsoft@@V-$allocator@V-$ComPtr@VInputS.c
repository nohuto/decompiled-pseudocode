/*
 * XREFs of ?_Calculate_growth@?$vector@V?$ComPtr@VInputSite@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VInputSite@@@WRL@Microsoft@@@std@@@std@@AEBA_K_K@Z @ 0x1800F17E8
 * Callers:
...
unsigned __int64 __fastcall std::vector<Microsoft::WRL::ComPtr<InputSite>>::_Calculate_growth(
        _QWORD *a1,
        unsigned __int64 a2)
{
