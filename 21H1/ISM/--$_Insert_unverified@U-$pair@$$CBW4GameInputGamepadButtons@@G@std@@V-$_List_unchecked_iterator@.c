 ...
 *     ?SetControllerVirtualKeyMappings@ControllerProcessor@@SAJ_N@Z @ 0x180122984 (-SetControllerVirtualKeyMappings@ControllerProcessor@@SAJ_N@Z.c)
 * Callees:
        ...
        __int64 *a4)
{
  ...
  v8 = qword_180209C50 & appended;
  v9 = 2 * (qword_180209C50 & appended);
  v10 = qword_180209C38;
  v11 = qword_180209C28;
  if ( *(_QWORD *)(qword_180209C38 + 16 * (qword_180209C50 & appended)) == qword_180209C28 )
    v12 = qword_180209C28;
  else
    v12 = **(_QWORD **)(qword_180209C38 + 16 * (qword_180209C50 & appended) + 8);
  while ( v12 != *(_QWORD *)(qword_180209C38 + 16 * (qword_180209C50 & appended)) )
  {
    v12 = *(_QWORD *)(v12 + 8);
    if ( *(_DWORD *)a3 == *(_DWORD *)(v12 + 16) )
    {
      std::list<ISystemContextObserver *>::erase(&qword_180209C28, &v19, a4);
      *(_QWORD *)a2 = v12;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
  ...
  {
    *(_QWORD *)(v10 + 16 * v8) = a4;
    *(_QWORD *)(qword_180209C38 + 8 * v9 + 8) = a4;
  }
  else
  {
    v16 = 2 * v8;
    ...
    else
    {
      ...
      *(_QWORD *)(v10 + 8 * v16 + 8) = *v17;
      if ( v18 != a4 )
        *(_QWORD *)(qword_180209C38 + 8 * v9 + 8) = *(_QWORD *)(*(_QWORD *)(qword_180209C38 + 8 * v9 + 8) + 8LL);
    }
  }
