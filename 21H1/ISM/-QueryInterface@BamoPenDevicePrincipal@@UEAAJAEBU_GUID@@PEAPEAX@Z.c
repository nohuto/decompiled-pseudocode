/*
 * XREFs of ?QueryInterface@BamoPenDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801319B0
 * Callers:
 *     ?QueryInterface@BamoPenDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C840 (-QueryInterface@BamoPenDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
