/*
 * XREFs of ??1?$unique_ptr@VMPCSpatialGestureRecognizerHandler@@U?$default_delete@VMPCSpatialGestureRecognizerHandler@@@std@@@std@@QEAA@XZ @ 0x18007AC60
 * Callers:
 *     _MPCGestureHandler::MPCGestureHandler_::_1_::dtor$4 @ 0x18007AB15 (_MPCGestureHandler--MPCGestureHandler_--_1_--dtor$4.c)
 *     _MPCHandProcessor::MPCHandProcessor_::_1_::dtor$3 @ 0x18007D5FF (_MPCHandProcessor--MPCHandProcessor_--_1_--dtor$3.c)
 * Callees:
