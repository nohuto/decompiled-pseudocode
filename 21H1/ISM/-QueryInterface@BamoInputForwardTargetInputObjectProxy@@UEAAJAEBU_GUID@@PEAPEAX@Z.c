/*
 * XREFs of ?QueryInterface@BamoInputForwardTargetInputObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EAA10
 * Callers:
 *     ?QueryInterface@BamoInputForwardTargetInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B900 (-QueryInterface@BamoInputForwardTargetInputObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
