/*
 * XREFs of ?Materialize_BamoDockDeviceProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7194
 * Callers:
 *     ?Thunk_Materialize_BamoDockDeviceProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF30 (-Thunk_Materialize_BamoDockDeviceProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@I.c)
 * Callees:
