/*
 * XREFs of ?QueryInterface@BamoSimpleHapticsControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EAF20
 * Callers:
 *     ?QueryInterface@BamoSimpleHapticsControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B990 (-QueryInterface@BamoSimpleHapticsControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
