/*
 * XREFs of ?UpdateDeviceId@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJPEAUDockableDeviceIdentity@@@Z @ 0x1800EDE08
 * Callers:
 ...
 *     ?Thunk_UpdateDeviceId_58@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED2E0 (-Thunk_UpdateDeviceId_58@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@.c)
 * Callees:
