/*
 * XREFs of ?QueryInterface@BamoDockDeviceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801273E0
 * Callers:
 *     ?QueryInterface@BamoDockDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C750 (-QueryInterface@BamoDockDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
