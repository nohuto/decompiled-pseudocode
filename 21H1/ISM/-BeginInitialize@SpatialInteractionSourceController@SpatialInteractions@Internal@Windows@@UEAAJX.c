/*
 * XREFs of ?BeginInitialize@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJXZ @ 0x18016AC70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetTicks@PerfCounter@@YA_JXZ @ 0x18007DF0C (-GetTicks@PerfCounter@@YA_JXZ.c)
 ...
 *     ??B_Atomic_llong@std@@QEBA_JXZ @ 0x18016A358 (--B_Atomic_llong@std@@QEBA_JXZ.c)
 */
