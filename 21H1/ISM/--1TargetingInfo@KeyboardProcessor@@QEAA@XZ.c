/*
 * XREFs of ??1TargetingInfo@KeyboardProcessor@@QEAA@XZ @ 0x1800481E4
 * Callers:
 ...
 *     _KeyboardProcessor::OnInputReport_::_1_::dtor$4 @ 0x180135A9A (_KeyboardProcessor--OnInputReport_--_1_--dtor$4.c)
 *     ?OnInputReport@ButtonProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x1801880C0 (-OnInputReport@ButtonProcessor@@UEAAJPEAUInputInfo@@@Z.c)
 *     _ButtonProcessor::OnInputReport_::_1_::dtor$2 @ 0x1801883C6 (_ButtonProcessor--OnInputReport_--_1_--dtor$2.c)
 * Callees:
