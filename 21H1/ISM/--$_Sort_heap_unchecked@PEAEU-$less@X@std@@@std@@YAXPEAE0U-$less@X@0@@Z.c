/*
 * XREFs of ??$_Sort_heap_unchecked@PEAEU?$less@X@std@@@std@@YAXPEAE0U?$less@X@0@@Z @ 0x1800A5DD0
 * Callers:
 ...
 * Callees:
 *     ??$_Pop_heap_hole_by_index@PEAEEU?$less@X@std@@@std@@YAXPEAE_J1$$QEAEU?$less@X@0@@Z @ 0x1800A5AC4 (--$_Pop_heap_hole_by_index@PEAEEU-$less@X@std@@@std@@YAXPEAE_J1$$QEAEU-$less@X@0@@Z.c)
 */
