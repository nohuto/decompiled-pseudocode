/*
 * XREFs of ?UpdateInputDeliveryServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EEA24
 * Callers:
 ...
 *     ?Thunk_UpdateInputDeliveryServer_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED400 (-Thunk_UpdateInputDeliveryServer_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 9) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 96LL))((char *)this - 16);
    if ( v9 < 0 )
