/*
 * XREFs of ?GetIsPlayDurationSupported@BamoSimpleHapticsControllerProxy@@UEAA_NXZ @ 0x1800E67A0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall BamoSimpleHapticsControllerProxy::GetIsPlayDurationSupported(BamoSimpleHapticsControllerProxy *this)
{
