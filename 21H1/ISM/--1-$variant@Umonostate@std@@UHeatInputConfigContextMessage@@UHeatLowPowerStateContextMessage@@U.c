/*
 * XREFs of ??1?$variant@Umonostate@std@@UHeatInputConfigContextMessage@@UHeatLowPowerStateContextMessage@@UHeatHingeAngleContextMessage@@UHeatDisplayOcclusionContextMessage@@UHeatVirtualTouchpadContextMessage@@@std@@QEAA@XZ @ 0x18012C5D0
 * Callers:
 *     _ISMHeatFrameworkHost::BroadcastContextMessage_::_1_::dtor$0 @ 0x18012CBB3 (_ISMHeatFrameworkHost--BroadcastContextMessage_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
