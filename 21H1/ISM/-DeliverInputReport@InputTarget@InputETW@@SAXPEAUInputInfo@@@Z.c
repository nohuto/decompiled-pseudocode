/*
 * XREFs of ?DeliverInputReport@InputTarget@InputETW@@SAXPEAUInputInfo@@@Z @ 0x1800B6DE8
 * Callers:
  ...
  if ( InputETW::IsVerboseEnabled(1LL) )
  {
    ...
    if ( InputETW::IsVerboseEnabled(2LL) )
    {
      ...
      if ( *v8 > 5u && tlgKeywordOn(v7[1], 1LL) )
      {
        ...
        v16 = &v12;
        tlgWriteTransfer_EventWriteTransfer((__int64)v8, (unsigned __int8 *)dword_1801CB6C7, 0LL, 0LL, 3u, &v15);
      }
    }
  }
}
