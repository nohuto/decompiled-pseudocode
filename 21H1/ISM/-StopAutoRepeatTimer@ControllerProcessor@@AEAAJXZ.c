/*
 * XREFs of ?StopAutoRepeatTimer@ControllerProcessor@@AEAAJXZ @ 0x180122ECC
 * Callers:
...
__int64 __fastcall ControllerProcessor::StopAutoRepeatTimer(ControllerProcessor *this)
{
  ...
  std::_Hash<std::_Umap_traits<unsigned short,ControllerProcessor::ActiveKeyProperties,std::_Uhash_compare<unsigned short,std::hash<unsigned short>,std::equal_to<unsigned short>>,std::allocator<std::pair<unsigned short const,ControllerProcessor::ActiveKeyProperties>>,0>>::clear((__int64)this + 88);
  return 0LL;
}
