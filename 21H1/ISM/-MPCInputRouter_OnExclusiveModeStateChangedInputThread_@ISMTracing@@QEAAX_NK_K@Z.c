/*
 * XREFs of ?MPCInputRouter_OnExclusiveModeStateChangedInputThread_@ISMTracing@@QEAAX_NK_K@Z @ 0x1800B8DAC
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( **((_DWORD **)v8 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v8 + 1), 1LL) )
    {
      ...
      v22 = 8;
      v19 = 4;
      tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801CB97D, 0LL, 0LL, 5u, &v14);
    }
  }
}
