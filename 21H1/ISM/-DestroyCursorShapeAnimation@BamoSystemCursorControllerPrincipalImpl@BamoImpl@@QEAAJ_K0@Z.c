/*
 * XREFs of ?DestroyCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x18013C588
 * Callers:
 *     ?Thunk_DestroyCursorShapeAnimation_253@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013D320 (-Thunk_DestroyCursorShapeAnimation_253@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCur.c)
 * Callees:
