/*
 * XREFs of ?EnsureServiceAndRegisterClient@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18013CC2C
 * Callers:
 *     ?Thunk_EnsureServiceAndRegisterClient_10@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013D360 (-Thunk_EnsureServiceAndRegisterClient_10@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemC.c)
 * Callees:
