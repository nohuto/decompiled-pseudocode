/*
 * XREFs of ?Materialize_BamoResizeControllerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E82B0
 * Callers:
 *     ?Thunk_Materialize_BamoResizeControllerClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED190 (-Thunk_Materialize_BamoResizeControllerClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBa.c)
 * Callees:
