/*
 * XREFs of ?RecordFeatureUsageCallback@details@wil@@YAXIW4wil_details_ServiceReportingKind@@IPEAUwil_details_FeatureReportingCache@@PEAUwil_details_RecordUsageResult@@@Z @ 0x18003E210
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x1800680E8 (-WilApi_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z.c)
 */
