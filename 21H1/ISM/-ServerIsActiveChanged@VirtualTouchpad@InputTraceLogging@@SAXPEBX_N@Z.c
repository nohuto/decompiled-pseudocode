/*
 * XREFs of ?ServerIsActiveChanged@VirtualTouchpad@InputTraceLogging@@SAXPEBX_N@Z @ 0x1800F0E40
 * Callers:
...
void __fastcall InputTraceLogging::VirtualTouchpad::ServerIsActiveChanged(__int64 a1, char a2)
{
  ...
  if ( **((_DWORD **)v4 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v4 + 1), 512LL) )
  {
    ...
    v13 = 1;
    v10 = 8;
    tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_1801CE0E5, 0LL, 0LL, 4u, &v8);
  }
}
