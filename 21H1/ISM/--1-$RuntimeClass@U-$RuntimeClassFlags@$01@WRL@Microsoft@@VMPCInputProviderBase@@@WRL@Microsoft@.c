/*
 * XREFs of ??1?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@VMPCInputProviderBase@@@WRL@Microsoft@@UEAA@XZ @ 0x18007D618
 * Callers:
 *     _MPCHandProcessor::MPCHandProcessor_::_1_::dtor$0 @ 0x18007D5CD (_MPCHandProcessor--MPCHandProcessor_--_1_--dtor$0.c)
 * Callees:
 *     <none>
 */
