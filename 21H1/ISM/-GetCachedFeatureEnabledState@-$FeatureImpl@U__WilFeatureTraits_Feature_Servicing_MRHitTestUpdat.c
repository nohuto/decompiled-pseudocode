/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_MRHitTestUpdate_29136479@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18003FF38
 * Callers:
 ...
 *     ?GetCurrentFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_MRHitTestUpdate_29136479@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@PEAH@Z @ 0x180040198 (-GetCurrentFeatureEnabledState@-$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_MRHitTestUpda.c)
 */

signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_MRHitTestUpdate_29136479>::GetCachedFeatureEnabledState(
        wil::details *a1,
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_MRHitTestUpdate_29136479>::GetCurrentFeatureEnabledState(
      v6,
      &v13,
      &v12);
    v7 = *a2;
