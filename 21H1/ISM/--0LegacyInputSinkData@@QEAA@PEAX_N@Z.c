/*
 * XREFs of ??0LegacyInputSinkData@@QEAA@PEAX_N@Z @ 0x1800443C0
 * Callers:
 ...
 * Callees:
 *     ExceptionSafeNtDuplicateCompositionInputSink @ 0x180002D58 (ExceptionSafeNtDuplicateCompositionInputSink.c)
