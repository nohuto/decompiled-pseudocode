/*
 * XREFs of ?TryUpdateCalibrationState@GazeHidDevice@@QEAAJXZ @ 0x18009DE04
 * Callers:
...
__int64 __fastcall GazeHidDevice::TryUpdateCalibrationState(GazeHidDevice *this)
{
  ...
  void *v14; // [rsp+A8h] [rbp+48h] BYREF
  ...
  *(_BYTE *)(v2 + 1548) = 2;
  ...
  if ( v5 >= 0 )
  {
    v13 = 0;
    v6 = v11;
    v7 = NtRIMDeviceIoControl(*((_QWORD *)this + 1), *((_QWORD *)this + 2), 721298LL, 0LL, 0, v14, v11, &v13, 0);
    if ( v7 >= 0 )
    {
      v12 = 0;
