/*
 * XREFs of std::_Func_impl_no_alloc__lambda_e526ae9bd02f5319a142ce48117bd5e8__void_std::shared_ptr_Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice__const_&_::_Do_call @ 0x1800D3F00
 * Callers:
 *     <none>
 * Callees:
