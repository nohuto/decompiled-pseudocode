/*
 * XREFs of ?ComputeSafeDelta@ManipulationInjector@@AEAA?AUtagPOINT@@IU2@UtagRECT@@@Z @ 0x1800C23FC
 * Callers:
 *     ?InjectPan@ManipulationInjector@@QEAAXMMK@Z @ 0x1800C35F4 (-InjectPan@ManipulationInjector@@QEAAXMMK@Z.c)
 * Callees:
 *     ?Clip@ManipulationInjector@@AEAA_NAEAUtagPOINT@@UtagRECT@@J@Z @ 0x1800C2350 (-Clip@ManipulationInjector@@AEAA_NAEAUtagPOINT@@UtagRECT@@J@Z.c)
 */
        ...
        LONG *a5)
{
  ...
  struct tagRECT v11; // [rsp+20h] [rbp-10h] BYREF
  struct tagPOINT v12; // [rsp+50h] [rbp+20h] BYREF
  struct tagRECT *v13; // [rsp+68h] [rbp+38h]

  v13 = a4;
  v6 = 152LL * (unsigned int)a3.x;
  v7 = a4;
  v9 = *(_DWORD *)((char *)this + v6 + 144);
  v12.y = *(_DWORD *)((char *)this + v6 + 148) + HIDWORD(a4);
  v12.x = (_DWORD)a4 + v9;
  v11.left = *a5;
  v11.top = a5[1];
  v11.right = a5[2] - 1;
