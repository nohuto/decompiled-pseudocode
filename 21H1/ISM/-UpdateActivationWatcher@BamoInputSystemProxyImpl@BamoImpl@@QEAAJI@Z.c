/*
 * XREFs of ?UpdateActivationWatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800ED9E8
 * Callers:
 ...
 *     ?Thunk_UpdateActivationWatcher_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED290 (-Thunk_UpdateActivationWatcher_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl.c)
 * Callees:
