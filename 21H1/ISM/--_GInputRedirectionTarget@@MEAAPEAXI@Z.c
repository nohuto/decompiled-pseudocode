/*
 * XREFs of ??_GInputRedirectionTarget@@MEAAPEAXI@Z @ 0x18017F9E4
 * Callers:
 *     ??_EInputRedirectionTarget@@OBA@EAAPEAXI@Z @ 0x18004D4C0 (--_EInputRedirectionTarget@@OBA@EAAPEAXI@Z.c)
 * Callees:
