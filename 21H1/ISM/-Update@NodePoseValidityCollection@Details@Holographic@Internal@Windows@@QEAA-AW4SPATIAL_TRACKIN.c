/*
 * XREFs of ?Update@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA?AW4SPATIAL_TRACKING_VALIDITY_FLAGS@@AEBUSPATIAL_NODE_ID@@W46@@Z @ 0x180166C84
 * Callers:
