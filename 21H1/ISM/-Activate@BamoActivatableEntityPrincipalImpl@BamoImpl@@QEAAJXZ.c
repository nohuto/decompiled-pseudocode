/*
 * XREFs of ?Activate@BamoActivatableEntityPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x1801058F0
 * Callers:
 *     ?Thunk_Activate_0@?$IActivatableEntityPrincipal_Receive@VBamoActivatableEntityPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180105CC0 (-Thunk_Activate_0@-$IActivatableEntityPrincipal_Receive@VBamoActivatableEntityPrincipalImpl@Bamo.c)
 * Callees:
