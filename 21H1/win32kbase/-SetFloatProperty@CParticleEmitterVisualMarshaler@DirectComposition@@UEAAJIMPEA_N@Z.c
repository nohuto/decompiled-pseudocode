/*
 * XREFs of ?SetFloatProperty@CParticleEmitterVisualMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x1C01DF400
 * Callers:
 *     <none>
 * Callees:
 *     ?SetFloatProperty@CVisualMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x1C0074D10 (-SetFloatProperty@CVisualMarshaler@DirectComposition@@UEAAJIMPEA_N@Z.c)
 */
