/*
 * XREFs of ?TraceLoggingPTPUsageDetailsEvent@@YAXPEBUtagTPTELEMSTATE@@_J@Z @ 0x1C01AA934
 * Callers:
...
void __fastcall TraceLoggingPTPUsageDetailsEvent(const struct tagTPTELEMSTATE *a1)
{
  ...
  if ( (unsigned int)dword_1C024B170 > 5 && tlgKeywordOn((__int64)&dword_1C024B170, 0x200000000000LL) )
  {
    v14 = *(_DWORD *)(v2 + 140);
    v15 = *(_DWORD *)(v2 + 136);
    v5 = *(_DWORD *)(v2 + 132);
