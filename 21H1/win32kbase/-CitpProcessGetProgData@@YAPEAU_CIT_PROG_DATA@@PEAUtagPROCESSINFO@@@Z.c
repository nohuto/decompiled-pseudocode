/*
 * XREFs of ?CitpProcessGetProgData@@YAPEAU_CIT_PROG_DATA@@PEAUtagPROCESSINFO@@@Z @ 0x1C01FF6B4
 * Callers:
...
struct _CIT_PROG_DATA *__fastcall CitpProcessGetProgData(struct _CIT_PROCESS **a1)
{
  ...
  if ( v5 )
  {
    ...
    if ( (unsigned int)v6 < *((_DWORD *)xmmword_1C0256430 + 14) )
    {
      v7 = *(_QWORD *)xmmword_1C0256430 + 96 * v6;
      if ( *(_WORD *)(v7 + 32) == v5 )
      {
