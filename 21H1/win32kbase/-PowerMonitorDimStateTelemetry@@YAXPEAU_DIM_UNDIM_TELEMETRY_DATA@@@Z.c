/*
 * XREFs of ?PowerMonitorDimStateTelemetry@@YAXPEAU_DIM_UNDIM_TELEMETRY_DATA@@@Z @ 0x1C0053E28
 * Callers:
...
void __fastcall PowerMonitorDimStateTelemetry(struct _DIM_UNDIM_TELEMETRY_DATA *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *((_BYTE *)a1 + 5) )
  {
    if ( (unsigned int)dword_1C0247378 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0247378, 0x400000000100LL, a3, a4) )
    {
      v8 = *((_BYTE *)v6 + 6);
  ...
  else
  {
    ...
    if ( (dword_1C0252E88 & 1) == 0 )
    {
      dword_1C0252E88 |= 1u;
      qword_1C0252E90 = MEMORY[0xFFFFF78000000008] + 36000000000LL;
    }
    if ( MEMORY[0xFFFFF78000000008] > (unsigned __int64)qword_1C0252E90 )
    {
      qword_1C0252E90 = MEMORY[0xFFFFF78000000008] + 36000000000LL;
      TlgAggregateFlush();
    }
