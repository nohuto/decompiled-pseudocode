/*
 * XREFs of ?CitpInteractionSummaryEnsure@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROCESS@@G@Z @ 0x1C006B498
 * Callers:
 ...
 *     ?CitpProcessGetAppSessionId@@YA?AU_GUID@@PEAUtagPROCESSINFO@@PEAI@Z @ 0x1C006B5A4 (-CitpProcessGetAppSessionId@@YA-AU_GUID@@PEAUtagPROCESSINFO@@PEAI@Z.c)
        ...
        __int16 a3)
{
  ...
  v3 = 0LL;
  v13 = 0LL;
  if ( (xmmword_1C0256414 & 1) == 0 )
    return v3;
  v7 = 0LL;
  if ( (xmmword_1C0256414 & 2) == 0 )
  {
    v8 = a2 + 2;
    goto LABEL_4;
  }
...
LABEL_4:
  ...
  if ( *v8 )
  {
    if ( ((*((unsigned __int16 *)v3 + 50) >> 2) & 0x1FFF) == dword_1C025642C )
      goto LABEL_6;
