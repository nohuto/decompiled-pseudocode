/*
 * XREFs of ?SetHandleProperty@CDDisplayRenderTargetMarshaler@DirectComposition@@UEAAJIPEAXPEA_N@Z @ 0x1C01F0590
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  if ( a2 == 2 )
  {
    v8 = 0LL;
    if ( !a3
      || (v9 = (struct _OBJECT_TYPE *)((__int64 (*)(void))qword_1C0252A38)(),
          Object = 0LL,
