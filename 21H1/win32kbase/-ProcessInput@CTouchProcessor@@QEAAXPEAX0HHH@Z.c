/*
 * XREFs of ?ProcessInput@CTouchProcessor@@QEAAXPEAX0HHH@Z @ 0x1C019D8A4
 * Callers:
...
void __fastcall CTouchProcessor::ProcessInput(CTouchProcessor *this, __int64 *a2, struct RIMCOMPLETEFRAME *a3)
{
  ...
  if ( ApiSetSanitizeRIMCOMPLETEFRAME(a3) )
  {
    ...
    if ( v11 )
    {
      ...
      v15 = (_QWORD *)((char *)gptiCurrent + 1128);
      v16 = *((_QWORD *)gptiCurrent + 141);
      if ( *(struct tagTHREADINFO **)(v16 + 8) != (struct tagTHREADINFO *)((char *)gptiCurrent + 1128) )
        __fastfail(3u);
      *v14 = v16;
      v14[1] = v15;
      *(_QWORD *)(v16 + 8) = v14;
...
LABEL_26:
        LOBYTE(v8) = 5;
        WPP_RECORDER_SF_(v9->DeviceExtension, v8, 7, v10, (__int64)&WPP_6cc13e1a12c13a444721acaa10d1d35b_Traceguids);
      }
    }
  }
