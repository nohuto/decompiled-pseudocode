/*
 * XREFs of ?SetBufferProperty@CRemoteRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C00CB900
 * Callers:
 *     <none>
 * Callees:
 *     ?IsValidRect@@YA_NAEBUtagRECT@@@Z @ 0x1C004719C (-IsValidRect@@YA_NAEBUtagRECT@@@Z.c)
 */
