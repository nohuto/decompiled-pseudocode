/*
 * XREFs of CitDisplayPowerChange @ 0x1C0050E50
 * Callers:
 ...
 *     ?CitpAllowForegroundProcess@@YAHPEBU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C002823C (-CitpAllowForegroundProcess@@YAHPEBU_CIT_IMPACT_CONTEXT@@@Z.c)
 */
...
void __fastcall CitDisplayPowerChange(__int64 a1)
{
  ...
  {
    v3 = *(_DWORD *)(a1 + 64);
    if ( (*((_DWORD *)xmmword_1C0256430 + 50) == 0) == (v3 == 0) )
    {
      *((_DWORD *)xmmword_1C0256430 + 50) = v3;
    }
    else
    {
      v4 = *(_DWORD *)(a1 + 64);
      ...
      if ( !v4 )
      {
        CitpSetForegroundProcess(xmmword_1C0256430, v5, 0LL, 0LL, 0LL);
