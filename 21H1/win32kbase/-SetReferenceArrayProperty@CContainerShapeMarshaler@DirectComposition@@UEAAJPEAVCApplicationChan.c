/*
 * XREFs of ?SetReferenceArrayProperty@CContainerShapeMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C01EA5A0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( (a4 || !a5) && (_DWORD)a3 == 1 )
  {
    ...
    if ( v9 >= 0 )
    {
      DirectComposition::CContainerShapeMarshaler::ClearShapes(this, a2, a3);
      *((_DWORD *)this + 18) = a5;
      *((_QWORD *)this + 8) = a4;
      *((_DWORD *)this + 19) = 0;
      *a6 = 1;
