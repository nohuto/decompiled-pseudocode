/*
 * XREFs of ?Create@CBatchSharedMemoryPool@DirectComposition@@SAJPEAVCBatchSharedMemoryPoolSet@2@_NPEAPEAV12@@Z @ 0x1C00B677C
 * Callers:
        ...
        struct DirectComposition::CBatchSharedMemoryPool **a3)
{
  ...
  if ( v6 < 0
    ...
    || (!a2
      ? (v7 = (struct DirectComposition::CBatchSharedMemoryPool *)Win32AllocPoolZInit(0x48uLL, 0x73624344u))
