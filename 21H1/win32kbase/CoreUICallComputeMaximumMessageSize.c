/*
 * XREFs of CoreUICallComputeMaximumMessageSize @ 0x1C00332DC
 * Callers:
 *     ?Initialize@RegistrarClient@CoreMessagingK@@SAXXZ @ 0x1C003B638 (-Initialize@RegistrarClient@CoreMessagingK@@SAXXZ.c)
 * Callees:
 *     ?ComputeMaximumMessageSize@SendProcessor@Calling@CoreMessaging@@QEAAJPEAUIMessageCallSendHost@@PEAPEBEIIIIPEAI@Z @ 0x1C003374C (-ComputeMaximumMessageSize@SendProcessor@Calling@CoreMessaging@@QEAAJPEAUIMessageCallSendHost@@P.c)
