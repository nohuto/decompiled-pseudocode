/*
 * XREFs of efSin @ 0x1C002E270
 * Callers:
 *     efCos @ 0x1C002E240 (efCos.c)
 ...
 * Callees:
 *     bFToL @ 0x1C002D690 (bFToL.c)
 *     eFraction @ 0x1C0045518 (eFraction.c)
 */
...
__int64 __fastcall efSin(int a1)
{
  ...
  {
    v8 = 4LL * (v14 & 0x1F);
    v9 = (__m128)*(unsigned int *)((char *)&unk_1C02504B0 - v8);
    v9.m128_f32[0] = (float)(v9.m128_f32[0] - gaefSin[32 - (int)v7 - 1]) * *(float *)&v4;
    v10 = _mm_xor_ps(v9, v5);
    v10.m128_f32[0] = v10.m128_f32[0] + *(float *)((char *)&unk_1C02504B0 - v8);
    v11 = v10;
  }
  else
  {
