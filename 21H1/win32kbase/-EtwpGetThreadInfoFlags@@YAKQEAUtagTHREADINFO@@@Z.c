/*
 * XREFs of ?EtwpGetThreadInfoFlags@@YAKQEAUtagTHREADINFO@@@Z @ 0x1C00A2AC8
 * Callers:
 ...
 *     EtwTraceAuditApiRegisterRawInputDevices @ 0x1C00A2440 (EtwTraceAuditApiRegisterRawInputDevices.c)
