/*
 * XREFs of ?Create@CSharedReadLegacyAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01FA5E0
 * Callers:
 *     CreateSharedReadLegacyAnimationTriggerMarshaler @ 0x1C01FA6C0 (CreateSharedReadLegacyAnimationTriggerMarshaler.c)
 * Callees:
