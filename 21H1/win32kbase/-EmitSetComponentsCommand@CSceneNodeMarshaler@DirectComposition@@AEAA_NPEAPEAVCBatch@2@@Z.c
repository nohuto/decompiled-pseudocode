/*
 * XREFs of ?EmitSetComponentsCommand@CSceneNodeMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01D991C
 * Callers:
 *     ?EmitUpdateCommands@CSceneNodeMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01DDC00 (-EmitUpdateCommands@CSceneNodeMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
 * Callees:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (v2 & 0x40) != 0 )
  {
    v5 = *((_QWORD *)this + 12) == 0LL;
    *((_DWORD *)this + 4) = v2 & 0xFFFFFFBF;
    v6 = *((unsigned int *)this + 28);
    v7 = v5;
    while ( v6 < *((_QWORD *)this + 12) || v7 )
    {
      v7 = 0;
      ...
      if ( v8 < 0x18 )
      {
        ...
        {
          *((_DWORD *)this + 4) |= 0x40u;
          return *((unsigned int *)this + 28) == *((_QWORD *)this + 12);
        }
        v8 = v18;
      }
      v9 = *((unsigned int *)this + 28);
      v10 = (v8 - 20) >> 2;
      if ( *((_QWORD *)this + 12) - v9 < v10 )
        LODWORD(v10) = *((_DWORD *)this + 24) - v9;
      v19 = 0LL;
      ...
      *((_DWORD *)v11 + 3) = 4 * v10;
      ...
      if ( (_DWORD)v10 )
      {
        ...
        do
        {
          ...
          {
            _mm_lfence();
            v16 = *(_QWORD *)(*((_QWORD *)this + 11) + 8LL * v13);
          }
          ++v13;
