/*
 * XREFs of ?Create@CSharedClientProjectedShadowCasterMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01FB1C0
 * Callers:
 *     CreateSharedClientProjectedShadowCasterMarshaler @ 0x1C01FB3B0 (CreateSharedClientProjectedShadowCasterMarshaler.c)
 * Callees:
