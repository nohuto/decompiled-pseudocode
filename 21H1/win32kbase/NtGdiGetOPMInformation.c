/*
 * XREFs of NtGdiGetOPMInformation @ 0x1C00C6570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetOPMInformation(void *a1, __int64 a2, void *a3)
{
  ...
  v14[0] = v8;
  v14[1] = v3;
  COPMSimpleBufferPool<_DXGKMDT_OPM_REQUESTED_INFORMATION>::AcquireBufferSafe((char *)qword_1C0252BF0 + 8, Src);
