/*
 * XREFs of GreRestoreDCInternal @ 0x1C00D03E0
 * Callers:
 *     ?bCleanDC@XDCOBJ@@QEAAHH@Z @ 0x1C00829C0 (-bCleanDC@XDCOBJ@@QEAAHH@Z.c)
 *     GreRestoreDC @ 0x1C0156D50 (GreRestoreDC.c)
 * Callees:
...
__int64 __fastcall GreRestoreDCInternal(HDC a1, int a2, int a3)
{
  ...
  int v31; // r8d
  ULONG v32; // ecx
  HSEMAPHORE v34; // [rsp+20h] [rbp-30h] BYREF
...
LABEL_65:
  ...
  while ( 1 )
  {
    ...
    DEC_SHARE_REF_CNT(*((int **)v35[0] + 12));
    vRestoreRegion((__int64)v35);
    if ( qword_1C0257200 )
      v14 = qword_1C0257200();
    else
      v14 = -1073741637;
    if ( v14 >= 0 && qword_1C0257208 )
      qword_1C0257208(v35, (unsigned int)(*((_DWORD *)v35[0] + 26) - 1));
    v15 = (int *)*((_QWORD *)v35[0] + 62);
    if ( v15 )
    {
      if ( *((_DWORD *)v35[0] + 8) == 1 )
      {
