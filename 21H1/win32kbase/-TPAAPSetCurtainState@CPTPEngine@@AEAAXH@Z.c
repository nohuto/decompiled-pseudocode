/*
 * XREFs of ?TPAAPSetCurtainState@CPTPEngine@@AEAAXH@Z @ 0x1C01CB154
 * Callers:
 ...
 *     ?ProcessInitialization@CPTPEngine@@MEAAJXZ @ 0x1C01C9190 (-ProcessInitialization@CPTPEngine@@MEAAJXZ.c)
