/*
 * XREFs of ?Connect@RegistrarClient@CoreMessagingK@@CAJXZ @ 0x1C003AFB4
 * Callers:
...
__int64 CoreMessagingK::RegistrarClient::Connect(void)
{
  ...
  if ( (unsigned int)dword_1C024B450 > 5 )
  {
    ...
    v17 = &v4;
    v18 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024B450, (unsigned __int8 *)dword_1C0223A9F, 0LL, 0LL, 3u, &v16);
  }
