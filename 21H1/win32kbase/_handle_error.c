/*
 * XREFs of _handle_error @ 0x1C00D2774
 * Callers:
 *     exp @ 0x1C00D1F78 (exp.c)
 *     log @ 0x1C00D2360 (log.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00CC180 (__security_check_cookie.c)
 *     _call_matherr @ 0x1C00D2640 (_call_matherr.c)
 *     _exception_enabled @ 0x1C00D26B0 (_exception_enabled.c)
 *     _raise_exc @ 0x1C00D2970 (_raise_exc.c)
 *     _set_errno_from_matherr @ 0x1C00D2C30 (_set_errno_from_matherr.c)
