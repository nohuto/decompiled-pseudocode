/*
 * XREFs of ?UpdateWindowTreeDpiAwareness@@YAXPEAUtagPROCESSINFO@@PEAUtagWND@@@Z @ 0x1C000EA8C
 * Callers:
...
void __fastcall UpdateWindowTreeDpiAwareness(struct tagPROCESSINFO *a1, struct tagWND *a2)
{
  ...
  if ( qword_1C0258B30 )
    ...
    v4 = -1073741637;
  if ( v4 >= 0 && qword_1C0258B38 )
    v5 = qword_1C0258B38(a2, 1LL);
  else
    v5 = 0LL;
  if ( v5 )
  {
    for ( i = (unsigned __int64 *)(v5 + 32); ; ++i )
    {
      ...
      {
        v11 = (char *)qword_1C0250D48 + (unsigned int)(unsigned __int16)v7 * dword_1C0250D50;
        GetDomainLockRef(14LL);
        v13 = gpKernelHandleTable;
        v14 = v7 >> 16;
        v15 = 3LL * (unsigned int)((v11 - (char *)qword_1C0250D48) >> 5);
