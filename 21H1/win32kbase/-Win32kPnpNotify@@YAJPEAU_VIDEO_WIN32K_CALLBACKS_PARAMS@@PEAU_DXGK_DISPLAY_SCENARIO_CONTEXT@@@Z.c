/*
 * XREFs of ?Win32kPnpNotify@@YAJPEAU_VIDEO_WIN32K_CALLBACKS_PARAMS@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01263B4
 * Callers:
        ...
        if ( *v12 )
        {
          if ( gbGDIOn && !(unsigned int)DrvIsNotUsingGraphicsDevice(v6) )
            v4 = DispBroker::DispBrokerClient::AsyncMessageNoAlloc_3__lambda_2ffaef142a06e39d44c296ad8819dbf0___();
               ...
               || (!qword_1C02584D8 ? (v4 = -1073741637) : (v4 = qword_1C02584D8(grpdeskRitInput, &v14)), v4 >= 0) )
        {
    ...
    else
    {
      ...
      if ( !(unsigned int)DrvIsNotUsingGraphicsDevice(v6) && (unsigned int)UserIsWddmConnectedSession() )
      {
          ...
          || (!qword_1C02584D8 ? (v4 = -1073741637) : (v4 = qword_1C02584D8(grpdeskRitInput, &v14)), v4 >= 0) )
        {
          ...
          if ( (int)IsxxxRestoreCsrssThreadDesktopSupported() >= 0 && qword_1C02584E8 )
            qword_1C02584E8(&v14, 0LL);
        }
      }
