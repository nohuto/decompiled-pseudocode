/*
 * XREFs of ?ComputeRawMouseProcessingOptions@MouseInputDataEx@CMouseProcessor@@QEBA?AW4RawMouseProcessingOptions@@XZ @ 0x1C0065E6C
 * Callers:
...
__int64 __fastcall CMouseProcessor::MouseInputDataEx::ComputeRawMouseProcessingOptions(__int64 a1)
{
  ...
  if ( (unsigned __int8)CMouseProcessor::MouseInputDataEx::TestProcessingOption(a1, 8LL) )
    v3 |= 0x2000u;
  if ( *(_DWORD *)(a1 + 88)
    || CMouseProcessor::MouseInputDataEx::TestCommitMouseAndCursorPositionResult(a1, 8)
  ...
  if ( (unsigned int)ApiSetEditionPreserveSystemClippedMouseInput()
    && CMouseProcessor::MouseInputDataEx::TestCommitMouseAndCursorPositionResult(a1, 2) )
  {
    return v4 | 0x1000u;
  }
  return v5;
