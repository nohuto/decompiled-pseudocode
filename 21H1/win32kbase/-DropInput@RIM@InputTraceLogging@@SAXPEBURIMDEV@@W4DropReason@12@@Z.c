/*
 * XREFs of ?DropInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4DropReason@12@@Z @ 0x1C016EE8C
 * Callers:
 ...
 *     ?DropReasonToString@InputTraceLogging@@CAPEBDW4DropReason@RIM@1@@Z @ 0x1C016EFB4 (-DropReasonToString@InputTraceLogging@@CAPEBDW4DropReason@RIM@1@@Z.c)
 */
...
char __fastcall InputTraceLogging::RIM::DropInput(__int64 a1)
{
    ...
    if ( (_BYTE)v1 == 2 )
    {
      ...
      if ( (v1 & 0x80u) == 0 )
      {
        if ( (unsigned int)dword_1C024C960 > 4 )
        {
          ...
          if ( (_BYTE)v1 )
          {
            ...
            v6 = (unsigned __int8 *)&unk_1C021C3B4;
            goto LABEL_17;
          }
        }
      }
      else if ( (unsigned int)dword_1C024C960 > 4 )
      {
        ...
        if ( (_BYTE)v1 )
        {
          ...
          v6 = (unsigned __int8 *)&unk_1C021C3E6;
          goto LABEL_17;
        }
      }
    }
    else if ( (_BYTE)v1 == 1 && (unsigned int)dword_1C024C960 > 4 )
    {
      LOBYTE(v1) = tlgKeywordOn((__int64)&dword_1C024C960, 256LL);
      if ( (_BYTE)v1 )
      {
        v3 = InputTraceLogging::DropReasonToString(v9);
        v6 = (unsigned __int8 *)&unk_1C021C41C;
        goto LABEL_17;
      }
    }
  }
  else if ( (unsigned int)dword_1C024C960 > 4 )
  {
    ...
    if ( (_BYTE)v1 )
    {
      ...
      v6 = (unsigned __int8 *)&unk_1C021C380;
LABEL_17:
      v11 = v3;
      v12 = v4;
