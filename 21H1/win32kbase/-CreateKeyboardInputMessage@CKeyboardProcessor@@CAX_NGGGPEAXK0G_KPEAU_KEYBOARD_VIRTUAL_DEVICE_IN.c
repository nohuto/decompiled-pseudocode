/*
 * XREFs of ?CreateKeyboardInputMessage@CKeyboardProcessor@@CAX_NGGGPEAXK0G_KPEAU_KEYBOARD_VIRTUAL_DEVICE_INFO@@PEAU_MIT_KEYBOARD_INPUT_MESSAGE@@@Z @ 0x1C00622A0
 * Callers:
        ...
        struct _MIT_KEYBOARD_INPUT_MESSAGE *a11)
{
  ...
  if ( (_BYTE)a3 == 19 && a2 == 69 )
    a2 = -7907;
  v17 = 0;
  if ( (unsigned int)dword_1C024C960 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C024C960, 0x4000LL, v15, v16) )
  {
    v51 = a1;
    v53 = a5;
    v63 = 4LL;
    ...
    v60 = &v53;
    v58 = &v52;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024C960, (unsigned __int8 *)dword_1C021F982, 0LL, 0LL, 5u, &v57);
  }
  if ( a5 )
  {
    LOBYTE(v14) = 19;
