/*
 * XREFs of ?ConfigureActivationObject@CActivationObjectManager@@QEAAJAEBU_LUID@@W4ACTIVATIONOBJECTSTATECHANGE_REASON@@W4ACTIVATION_OBJECT_STATE@@2@Z @ 0x1C0132B20
 * Callers:
        ...
        int a5)
{
  ...
  v5 = qword_1C0252740;
  RIMLockExclusive((__int64)&qword_1C0256460);
