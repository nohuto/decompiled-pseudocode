/*
 * XREFs of EngUnlockSurface @ 0x1C0080860
 * Callers:
  ...
  if ( pso )
  {
    ...
    if ( p_pvScan0 == (PVOID *)v5 )
    {
      ...
      if ( v30 )
      {
        ...
        if ( v18 == 5 )
        {
          v19 = (struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer *)p_pvScan0[85];
          v20 = 0;
        }
        else
        {
          if ( v18 != 16 )
            goto LABEL_17;
          v19 = (struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer *)p_pvScan0[17];
          v20 = 2;
        }
