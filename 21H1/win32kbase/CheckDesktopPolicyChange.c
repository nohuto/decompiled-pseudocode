/*
 * XREFs of CheckDesktopPolicyChange @ 0x1C0129F50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CheckDesktopPolicyChange(const UNICODE_STRING *a1)
{
  ...
  gdwPolicyFlags = v6;
  if ( qword_1C025A5C8 != KeyInformation )
  {
    qword_1C025A5C8 = KeyInformation;
    v1 = 1;
  }
  KeyInformation = 0LL;
  v9 = 2;
  ...
  gdwPolicyFlags = v8;
  if ( qword_1C025A5D0 != KeyInformation )
  {
    qword_1C025A5D0 = KeyInformation;
    return 1;
  }
  return v1;
}
