/*
 * XREFs of DrvSetPruneFlag @ 0x1C0151B50
 * Callers:
 ...
 * Callees:
 *     ?DrvIsPermanentSettingChangesDisabled@@YAHXZ @ 0x1C004B774 (-DrvIsPermanentSettingChangesDisabled@@YAHXZ.c)
...
__int64 __fastcall DrvSetPruneFlag(const UNICODE_STRING *a1, unsigned __int8 a2, int a3)
{
  ...
  if ( (*((_DWORD *)v6 + 40) & 0x800000) != 0
    && (LOBYTE(v10) = (_BYTE)v3 == 0, (int)((__int64 (__fastcall *)(__int64))qword_1C0252990)(v10) < 0) )
  {
    return 0xFFFFFFFFLL;
  }
  else
