/*
 * XREFs of ?SetInputSinkHelper@CInteractionMarshaler@DirectComposition@@QEAAJPEAXPEA_N@Z @ 0x1C0096440
 * Callers:
 ...
 *     ?SetHandleProperty@CInteractionMarshaler@DirectComposition@@UEAAJIPEAXPEA_N@Z @ 0x1C0096930 (-SetHandleProperty@CInteractionMarshaler@DirectComposition@@UEAAJIPEAXPEA_N@Z.c)
 * Callees:
    ...
    if ( *((PVOID *)this + 33) != v3 )
    {
      if ( v3 )
      {
        ...
        if ( v4 >= 0 )
        {
          ...
          if ( v4 >= 0 && (unsigned int)dword_1C024C960 > 5 && tlgKeywordOn((__int64)&dword_1C024C960, 4LL) )
          {
            Object = this;
            v14 = v3;
