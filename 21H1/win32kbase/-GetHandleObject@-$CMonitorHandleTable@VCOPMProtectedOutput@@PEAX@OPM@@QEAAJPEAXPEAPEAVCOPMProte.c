/*
 * XREFs of ?GetHandleObject@?$CMonitorHandleTable@VCOPMProtectedOutput@@PEAX@OPM@@QEAAJPEAXPEAPEAVCOPMProtectedOutput@@@Z @ 0x1C00C68B0
 * Callers:
 ...
 * Callees:
 *     ?DoesCurrentProcessOwnProtectedOutput@CMonitorPDO@OPM@@QEBAEXZ @ 0x1C00C6920 (-DoesCurrentProcessOwnProtectedOutput@CMonitorPDO@OPM@@QEBAEXZ.c)
