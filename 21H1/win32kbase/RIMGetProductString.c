/*
 * XREFs of RIMGetProductString @ 0x1C01671AC
 * Callers:
...
__int64 __fastcall RIMGetProductString(__int64 a1, struct _DEVICE_OBJECT *a2, struct _FILE_OBJECT *a3)
{
  ...
  if ( OutputBuffer )
  {
    ...
    {
      LOBYTE(v10) = 3;
      WPP_RECORDER_SF_((_DWORD)gRimLog, v10, 1, 20, (__int64)&WPP_55b2fa568459373c5b96b2ba3eae63fb_Traceguids);
    }
    Win32FreePool((__int64)OutputBuffer, v10, v9);
  }
  return Status;
}
