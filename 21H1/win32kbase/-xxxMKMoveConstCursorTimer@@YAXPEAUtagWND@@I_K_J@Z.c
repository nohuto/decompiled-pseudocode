/*
 * XREFs of ?xxxMKMoveConstCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C018AC70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxMKMoveConstCursorTimer(struct tagWND *a1)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v42; // [rsp+68h] [rbp-59h] BYREF
  int *v43; // [rsp+88h] [rbp-39h]
  int v44; // [rsp+90h] [rbp-31h]
  int v45; // [rsp+94h] [rbp-2Dh]
  ...
  {
LABEL_6:
    v3 = giMouseMoveTable % (unsigned int)(unsigned __int8)byte_1C0251AE1;
    v2 = (unsigned __int8)byte_1C0251AE2[v3];
    giMouseMoveTable = v3 + 1;
    if ( !v2 )
      return;
    goto LABEL_7;
  }
  v2 = 4 * (unsigned __int8)byte_1C0251AE2[0];
LABEL_7:
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    v39 = v7;
    if ( v7 && (*(int *)(v7 + 24) > 0 || *(_DWORD *)(v39 + 48)) )
    {
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    if ( v39 )
    {
      v14 = *(unsigned int *)(v39 + 24);
      if ( *(_DWORD *)(v39 + 48) || (int)v14 > 0 )
      {
        *(_DWORD *)(v39 + 44) = 1;
