/*
 * XREFs of NtUserSetDisplayConfig @ 0x1C013DBA0
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    if ( (_DWORD)v7 )
    {
      ...
      if ( v20 )
      {
        ...
        if ( qword_1C0257E80 )
          qword_1C0257E80(v22, &v38, Win32FreePool);
      }
      v11 = v29;
      v35 = v29;
      v16 = 0LL;
...
LABEL_63:
  if ( v9 >= 0 )
  {
    v24 = qword_1C0258B20 ? qword_1C0258B20(v10, v16, v11, v12) : -1073741637;
    if ( v24 >= 0 && qword_1C0258B28 )
      qword_1C0258B28();
  }
  if ( v29 && qword_1C0257FA8 )
    qword_1C0257FA8(&v38);
