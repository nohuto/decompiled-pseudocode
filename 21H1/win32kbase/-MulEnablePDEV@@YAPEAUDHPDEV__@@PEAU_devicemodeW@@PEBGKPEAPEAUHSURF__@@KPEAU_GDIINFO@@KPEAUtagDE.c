/*
 * XREFs of ?MulEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEBGKPEAPEAUHSURF__@@KPEAU_GDIINFO@@KPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1C014B680
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?pRenderAdapter@PDEVOBJ@@QEAAPEAXXZ @ 0x1C014BF78 (-pRenderAdapter@PDEVOBJ@@QEAAPEAXXZ.c)
 *     bIntersect @ 0x1C014C020 (bIntersect.c)
 */
