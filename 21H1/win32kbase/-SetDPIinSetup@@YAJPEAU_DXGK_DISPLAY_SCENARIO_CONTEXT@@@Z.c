/*
 * XREFs of ?SetDPIinSetup@@YAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01425E0
 * Callers:
...
__int64 __fastcall SetDPIinSetup(struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a1)
{
  ...
  __int64 v25; // [rsp+1C8h] [rbp+C8h] BYREF
  int v26; // [rsp+1D0h] [rbp+D0h] BYREF
  __int64 v27; // [rsp+1D8h] [rbp+D8h] BYREF
...
LABEL_4:
  ...
  if ( CurrentDpiInfoFromHDev >= 0 )
  {
    ...
    if ( qword_1C0258758 )
      ...
      v7 = -1073741637;
    if ( v7 >= 0 && qword_1C0258760 )
      qword_1C0258760(1LL, &v26);
    if ( v26 != v5 )
    {
      v8 = qword_1C0258778 ? qword_1C0258778() : -1073741637;
      if ( v8 >= 0 )
      {
        v9 = qword_1C0258780 ? qword_1C0258780(1LL, v5) : -1073741637;
        if ( v9 >= 0 )
        {
          v10 = qword_1C0258768 ? qword_1C0258768() : -1073741637;
          if ( v10 >= 0 )
          {
            if ( qword_1C0258770 )
              v6 = qword_1C0258770(1LL, v4 / 0x64 > 0x78);
            if ( v6 >= 0 )
            {
              LOBYTE(v25) = 0;
              gDrvDpiWin8Style = 0;
