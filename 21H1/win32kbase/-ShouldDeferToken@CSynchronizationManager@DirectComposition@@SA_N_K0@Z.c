/*
 * XREFs of ?ShouldDeferToken@CSynchronizationManager@DirectComposition@@SA_N_K0@Z @ 0x1C001BA98
 * Callers:
 *     DCompositionShouldDeferToken @ 0x1C001BA80 (DCompositionShouldDeferToken.c)
 * Callees:
