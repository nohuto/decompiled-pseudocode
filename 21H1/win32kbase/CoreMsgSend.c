/*
 * XREFs of CoreMsgSend @ 0x1C00619F0
 * Callers:
...
__int64 __fastcall CoreMsgSend(void *a1, __int64 a2, const void *a3, unsigned int a4)
{
  ...
  if ( (unsigned int)dword_1C024B450 > 5 )
  {
    ...
    LODWORD(v12) = v8;
    v15 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024B450, (unsigned __int8 *)dword_1C0223851, 0LL, 0LL, 3u, &v13);
  }
  if ( v10 )
