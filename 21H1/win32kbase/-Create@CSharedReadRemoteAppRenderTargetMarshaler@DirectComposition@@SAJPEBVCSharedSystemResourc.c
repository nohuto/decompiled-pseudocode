/*
 * XREFs of ?Create@CSharedReadRemoteAppRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01FA730
 * Callers:
 *     CreateSharedReadRemoteAppRenderTargetMarshaler @ 0x1C01FA910 (CreateSharedReadRemoteAppRenderTargetMarshaler.c)
 * Callees:
