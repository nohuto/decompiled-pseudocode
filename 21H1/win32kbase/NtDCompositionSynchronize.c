/*
 * XREFs of NtDCompositionSynchronize @ 0x1C00B8AD0
 * Callers:
 *     <none>
 * Callees:
 *     ?Synchronize@CSynchronizationManager@DirectComposition@@SAJPEAVCBatch@2@@Z @ 0x1C00B8BA0 (-Synchronize@CSynchronizationManager@DirectComposition@@SAJPEAVCBatch@2@@Z.c)
