/*
 * XREFs of ?ProcessInput@Mouse@InputTraceLogging@@SAXPEBURIMDEV@@PEBVMouseInputDataEx@CMouseProcessor@@_N@Z @ 0x1C006994C
 * Callers:
        ...
        __int64 a3)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C024C960, 64LL, a3, a2) )
    {
      v6 = *(_DWORD *)(v4 + 72);
      v7 = *(_DWORD *)(v4 + 20);
      v8 = *(_DWORD *)(v4 + 16);
