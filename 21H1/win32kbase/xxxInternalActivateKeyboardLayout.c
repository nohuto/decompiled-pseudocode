/*
 * XREFs of xxxInternalActivateKeyboardLayout @ 0x1C00587F0
 * Callers:
  ...
  if ( (a3 & 0x100) != 0 || a2 != *v9 )
  {
    ...
    *((_QWORD *)v8 + 51) = v22;
    ...
    else
    {
      if ( (*(_DWORD *)gpsi & 4) != 0 )
      {
        ApiSetEditionImmActivateLayout((__int64)v8, a2);
      }
      else
      {
        v20 = v9;
    ...
    if ( gptiForeground && *((_QWORD *)gptiForeground + 52) == *((_QWORD *)v8 + 52) )
    {
      ...
      if ( qword_1C0257FE8 )
        qword_1C0257FE8(2147483649LL, 0LL, *(unsigned int *)(a2 + 40), 0LL, 0);
