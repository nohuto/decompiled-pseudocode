/*
 * XREFs of ?BufferMouseInput@Mouse@InputTraceLogging@@SAXPEAUDEVICEINFO@@@Z @ 0x1C01B4AB0
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::BufferMouseInput(struct DEVICEINFO *a1)
{
  ...
  if ( (unsigned int)dword_1C024C960 > 4 && tlgKeywordOn((__int64)&dword_1C024C960, 64LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024C960, (unsigned __int8 *)dword_1C02207FD, 0LL, 0LL, 3u, &v3);
  }
}
