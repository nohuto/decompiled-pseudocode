/*
 * XREFs of ?ProcessMouseWheel@CMouseProcessor@@AEAAXAEBVCWheelEvent@1@@Z @ 0x1C01C3B64
 * Callers:
        ...
        const struct CMouseProcessor::CWheelEvent *a2)
{
  ...
  if ( *((_DWORD *)a2 + 6) || (*(&InputDelegation::CInputDelegationInfo::gInstance + 4) & 2) != 0 )
  {
    ...
    v13 = CMouseProcessor::MouseHitTest(
            ...
            (__int64)&v51,
            a2,
            _InterlockedCompareExchange((volatile signed __int32 *)this + 940, 1, 1) != 0,
            &v49);
    ...
    if ( ShouldDeliverWheelEventToInputDest )
    {
      ...
      {
        CMouseProcessor::CMouseRawInput::PostRawMouse((__int64)this + 3528, (int)v69, 0);
      }
      ...
      v4 = 1;
      v25 = 1;
      if ( CInputDest::operator==((unsigned int *)v69, (__int64)v71) )
LABEL_27:
        v25 = 0;
      if ( (v4 & 1) != 0 )
      ...
      if ( MouseWheelForegroundThread
        && *((_QWORD *)v17 + 52) != *(_QWORD *)(anonymous_namespace_::ResolveApplicationFrameChildThread(MouseWheelForegroundThread)
                                              + 416)
  ...
  if ( ShouldDeliverWheelEventToInputDest )
  {
    if ( !anonymous_namespace_::InMouseRawInputMode((__int64)v69, 1LL, 1) )
    {
      v35 = *((_QWORD *)a2 + 1);
      v58 = 0LL;
      v59 = 0;
