/*
 * XREFs of ?Create@CHostVisualMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C002BDA4
 * Callers:
 *     CreateHostVisualMarshaler @ 0x1C002BD50 (CreateHostVisualMarshaler.c)
 * Callees:
