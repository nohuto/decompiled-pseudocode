/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01FA368
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C01FA540 (CreateSharedReadScalarMarshaler.c)
 * Callees:
