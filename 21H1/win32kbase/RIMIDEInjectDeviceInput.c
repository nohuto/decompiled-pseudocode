/*
 * XREFs of RIMIDEInjectDeviceInput @ 0x1C017106C
 * Callers:
 ...
 *     ?RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z @ 0x1C016F2F4 (-RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z.c)
