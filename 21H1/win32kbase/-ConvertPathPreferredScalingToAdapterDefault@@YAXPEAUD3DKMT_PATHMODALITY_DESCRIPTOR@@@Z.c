/*
 * XREFs of ?ConvertPathPreferredScalingToAdapterDefault@@YAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C014D464
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *((_DWORD *)a1 + 35) == 253 )
  {
    ...
    {
      v8 = WdLogNewEntry5_WdAssertion(0x100000000000LL, a2, a3, a4);
      WdLogEvent5_WdAssertion(v8);
    }
    ((void (__fastcall *)(char *, char *))qword_1C0252978)((char *)a1 + 16, (char *)a1 + 140);
  }
