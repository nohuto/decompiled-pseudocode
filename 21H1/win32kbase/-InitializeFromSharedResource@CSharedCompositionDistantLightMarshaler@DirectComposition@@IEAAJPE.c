/*
 * XREFs of ?InitializeFromSharedResource@CSharedCompositionDistantLightMarshaler@DirectComposition@@IEAAJPEBVCSharedSystemResource@2@@Z @ 0x1C004206C
 * Callers:
        ...
        const struct DirectComposition::CSharedSystemResource *a2)
{
  ...
  *((_OWORD *)this + 6) = xmmword_1C02192F8;
