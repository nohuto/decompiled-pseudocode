/*
 * XREFs of ReadPointerDeviceSettings @ 0x1C0011A30
 * Callers:
...
__int64 __fastcall ReadPointerDeviceSettings(int a1, _DWORD *a2)
{
  ...
  if ( a1 == 146 )
  {
    ...
    ApiSetEditionOverrideUserTouchGestureSettings(off_1C02470F8, off_1C02470E8);
    v4 = off_1C02470F8;
    *a2 = (unsigned int)(*((_DWORD *)off_1C02470F8 + 3) - 1) > 0xFFFFFFFD;
    v5 = *((_DWORD *)v4 + 7);
    if ( v5 == -1 )
      v5 = *((_DWORD *)v4 + 6);
    a2[1] = v5;
