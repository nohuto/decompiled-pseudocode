/*
 * XREFs of RIMIsParallelDevice @ 0x1C0167AE8
 * Callers:
    ...
    if ( v24 > 1 )
    {
      ...
      do
      {
        if ( (unsigned int)rimHidP_GetSpecificValueCaps(0, 13, v11, 81, (__int64)v30, (__int64)v21, a2) == 1114112 )
        {
          ...
          {
            v15 = RIMRetrieveAllLinkIndexUsages(
                    v11,
                    a2,
                    (unsigned int)&v23,
                    (unsigned int)&v26,
            ...
            if ( v15 != 1114112 )
            {
              ...
              {
                LOBYTE(v13) = 3;
                WPP_RECORDER_SF_((_DWORD)gRimLog, v13, 1, 26, (__int64)&WPP_55b2fa568459373c5b96b2ba3eae63fb_Traceguids);
              }
            }
            v7 = v27;
            v12 = 1;
      ...
      v5 = v28;
      if ( v6 )
        Win32FreePool(v6, v13, v14);
      if ( v7 )
        Win32FreePool(v7, v13, v14);
    }
    v21[0] = 1;
