/*
 * XREFs of ApiSetEditionPostAccessibility @ 0x1C01CF630
 * Callers:
 *     ?FKActivationTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C0189520 (-FKActivationTimer@@YAXPEAUtagWND@@I_K_J@Z.c)
 *     ?MKButtonSelect@@YAHG@Z @ 0x1C0189A00 (-MKButtonSelect@@YAHG@Z.c)
...
__int64 __fastcall ApiSetEditionPostAccessibility(unsigned int a1)
{
  ...
  if ( qword_1C0259098 )
    result = qword_1C0259098();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C02590A0;
    if ( qword_1C02590A0 )
      result = qword_1C02590A0(a1);
  }
