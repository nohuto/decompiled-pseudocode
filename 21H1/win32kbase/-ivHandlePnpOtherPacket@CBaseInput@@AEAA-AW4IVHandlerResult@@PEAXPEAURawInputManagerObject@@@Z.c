/*
 * XREFs of ?ivHandlePnpOtherPacket@CBaseInput@@AEAA?AW4IVHandlerResult@@PEAXPEAURawInputManagerObject@@@Z @ 0x1C01BB550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseInput::ivHandlePnpOtherPacket(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  *(_QWORD *)(v4 + 16) = v4 + (v5 & 0xFFFFFFFFFFFFFFFEuLL);
  ...
  CIVSerializer::~CIVSerializer((CIVSerializer *)v12, v8, v9);
  return 1LL;
}
