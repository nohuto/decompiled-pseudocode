/*
 * XREFs of DCompositionIsVailContainer @ 0x1C01D44F8
 * Callers:
 ...
 *     ?CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEAPEAX@Z @ 0x1C01F9470 (-CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEA.c)
 * Callees:
...
__int64 DCompositionIsVailContainer()
{
  ...
  return (unsigned __int8)byte_1C025A5A8;
}
