/*
 * XREFs of GreSetMagicColors @ 0x1C01534DC
 * Callers:
 *     SetSysColor @ 0x1C00A8878 (SetSysColor.c)
 *     NtGdiSetMagicColors @ 0x1C01537C0 (NtGdiSetMagicColors.c)
 * Callees:
 ...
 *     ?bSetMagicColor@@YAHAEAVPDEVOBJ@@VXEPALOBJ@@KT_PAL_ULONG@@@Z @ 0x1C0153394 (-bSetMagicColor@@YAHAEAVPDEVOBJ@@VXEPALOBJ@@KT_PAL_ULONG@@@Z.c)
 */
...
__int64 __fastcall GreSetMagicColors(HDC a1, unsigned int a2, unsigned int a3)
{
  ...
  HSEMAPHORE v34; // [rsp+40h] [rbp-49h] BYREF
