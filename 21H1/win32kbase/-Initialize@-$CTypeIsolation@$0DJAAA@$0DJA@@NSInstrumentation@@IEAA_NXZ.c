/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@IEAA_NXZ @ 0x1C001F5E4
 * Callers:
 ...
 * Callees:
 *     ?Create@?$CSectionEntry@$0DJAAA@$0DJA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C003D638 (-Create@-$CSectionEntry@$0DJAAA@$0DJA@@NSInstrumentation@@SAPEAV12@XZ.c)
...
char __fastcall NSInstrumentation::CTypeIsolation<233472,912>::Initialize(__int64 a1)
{
  ...
  if ( !NSInstrumentation::PlatformDebugModeEnabled((NSInstrumentation *)a1) )
  {
    ...
    *(_QWORD *)(a1 + 16) = PoolWithTag;
    ...
    {
      *PoolWithTag = 0LL;
      v3 = (_QWORD *)NSInstrumentation::CSectionEntry<233472,912>::Create();
      if ( v3 )
      {
        v4 = *(_QWORD **)(a1 + 8);
        *(_DWORD *)(a1 + 32) = 228;
