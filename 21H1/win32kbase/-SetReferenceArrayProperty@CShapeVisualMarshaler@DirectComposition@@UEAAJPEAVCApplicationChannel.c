/*
 * XREFs of ?SetReferenceArrayProperty@CShapeVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C01E7F50
 * Callers:
 *     <none>
 * Callees:
  ...
  *a6 = 0;
  if ( a4 || !a5 )
  {
    if ( (_DWORD)a3 == 51 )
    {
      ...
      if ( v9 >= 0 )
      {
        DirectComposition::CShapeVisualMarshaler::ClearShapes(this, a2, a3);
        *((_DWORD *)this + 96) = a5;
        *((_QWORD *)this + 47) = a4;
        *((_DWORD *)this + 97) = 0;
        *a6 = 1;
