/*
 * XREFs of ?DeliverConfigRequest@RIM@InputTraceLogging@@SAXPEBURIMDEV@@GK@Z @ 0x1C0169858
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeliverConfigRequest(const struct RIMDEV *a1)
{
  ...
  if ( (unsigned int)dword_1C024C960 > 4 && tlgKeywordOn((__int64)&dword_1C024C960, 256LL) )
  {
    ...
    v11 = 2LL;
    v9 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C024C960, (unsigned __int8 *)dword_1C021C167, 0LL, 0LL, 5u, &v7);
  }
}
