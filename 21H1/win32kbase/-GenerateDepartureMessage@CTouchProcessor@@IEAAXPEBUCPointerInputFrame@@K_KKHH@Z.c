/*
 * XREFs of ?GenerateDepartureMessage@CTouchProcessor@@IEAAXPEBUCPointerInputFrame@@K_KKHH@Z @ 0x1C01947A0
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (*(_DWORD *)(v8 + 180) & 2) == 0 )
  {
    if ( (*(_DWORD *)v8 & 0x1000) == 0 )
    {
      ...
      {
        LOBYTE(v9) = 2;
        WPP_RECORDER_SF_LL(v10, v9, v11, 219, 586, *(_DWORD *)(v8 + 172), *(_WORD *)(v8 + 160));
      }
    }
