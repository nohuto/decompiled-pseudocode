/*
 * XREFs of ?UpdateContactCountConfigurationArray@CInteractionConfigurationGroup@DirectComposition@@AEAAJW4Enum@InteractionProperty@@UContactRangeConfiguration@12@PEAV?$CStructDynamicArray@UContactRangeConfiguration@CInteractionConfigurationGroup@DirectComposition@@@@PEA_N@Z @ 0x1C009542C
 * Callers:
  ...
  if ( a2 != 3 )
  {
    ...
    while ( 1 )
    {
      if ( (unsigned int)v10 >= *(_DWORD *)(a4 + 8)
        || (v17 = *(_DWORD *)a3, v18 = *(_DWORD *)(a3 + 4), *(_DWORD *)a3 > v18) )
      {
LABEL_4:
        if ( v5 >= 0 )
        {
          v11 = *(_DWORD *)(a4 + 8);
          v12 = v11 && *(_DWORD *)(*(_QWORD *)(*(_QWORD *)a4 + 8LL * (unsigned int)(v11 - 1)) + 4LL) == -1;
          if ( *(_DWORD *)a3 <= *(_DWORD *)(a3 + 4) && !v12 && (a2 == 7 || a2 == 1) )
          {
...
LABEL_22:
      v28 = *(_DWORD **)(*(_QWORD *)a4 + 8LL * (unsigned int)v10);
      v29 = v28[2];
      if ( v29 )
      {
        if ( (_DWORD)v10 )
    ...
    if ( v18 >= v22 )
    {
      if ( v18 == v22 )
      {
        v25 = DirectComposition::CInteractionConfigurationGroup::ApplyConfigOperation(v24, v23, a2, a5);
        *(_DWORD *)(v26 + 8) = v25;
        if ( HIDWORD(v52) == -1 )
          v27 = -1;
        else
      ...
      {
        v38 = DirectComposition::CInteractionConfigurationGroup::ApplyConfigOperation(v24, v23, a2, a5);
        v39 = *(_QWORD *)(*(_QWORD *)a4 + 8 * v10);
        v40 = *(_DWORD *)(v39 + 4);
        HIDWORD(v52) = v40;
        if ( v40 == -1 )
          v41 = -1;
    ...
    v53 = DirectComposition::CInteractionConfigurationGroup::ApplyConfigOperation(v24, v23, a2, a5);
    v35 = *(_DWORD **)(*(_QWORD *)a4 + 8 * v10);
    v36 = v35[1];
    if ( v34 < v36 )
      v36 = v34;
    HIDWORD(v52) = v36;
  ...
  {
    v30 = **(_DWORD ***)a4;
    if ( v30[2] == *(_DWORD *)(a3 + 8) && *v30 == *(_DWORD *)a3 )
      v9 = v30[1] != *(_DWORD *)(a3 + 4);
  }
  *a5 = v9;
  if ( v9 )
  {
