/*
 * XREFs of ?SendMousePerfSummaryTelemetry@MousePerfSummary@@AEAAXXZ @ 0x1C01C55A0
 * Callers:
 ...
 *     ?Reset@MousePerfSummary@@AEAAXXZ @ 0x1C01C5284 (-Reset@MousePerfSummary@@AEAAXXZ.c)
 */
...
void __fastcall MousePerfSummary::SendMousePerfSummaryTelemetry(LARGE_INTEGER *this)
{
  ...
  __int64 HighPart; // [rsp+290h] [rbp+A0h] BYREF
  ...
  if ( (unsigned __int64)(1000 * (PerformanceCounter.QuadPart - this[66].QuadPart)) / gliQpcFreq.QuadPart > 0x927C0
    || this[65].HighPart != this[65].LowPart )
  {
    ...
    this[65].LowPart = this[65].HighPart;
