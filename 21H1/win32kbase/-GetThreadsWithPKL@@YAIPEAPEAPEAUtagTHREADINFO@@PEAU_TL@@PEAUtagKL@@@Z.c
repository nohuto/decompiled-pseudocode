/*
 * XREFs of ?GetThreadsWithPKL@@YAIPEAPEAPEAUtagTHREADINFO@@PEAU_TL@@PEAUtagKL@@@Z @ 0x1C0057750
 * Callers:
...
__int64 __fastcall GetThreadsWithPKL(struct tagTHREADINFO ***a1, struct _TL *a2, struct tagKL *a3)
{
        ...
        for ( j = *(_QWORD **)(i + 168); j != (_QWORD *)(i + 168); j = (_QWORD *)*j )
        {
          ...
          if ( j != (_QWORD *)736 && (!a3 || a3 == (struct tagKL *)v13[54]) )
          {
            ...
            if ( *v14 == gpepCSRSS || *(_QWORD *)v13[52] == PsGetCurrentProcess(v14, v8) )
            {
              ...
              {
                v7 += 128;
                v17 = UserReAllocPool(v9, 8LL * (unsigned int)v6, 8LL * v7, 0x69747355u);
                if ( !v17 )
                  goto LABEL_29;
                v9 = v17;
              }
  ...
  for ( k = *(_QWORD *)(PsGetProcessWin32Process(gpepCSRSS) + 320); k; k = *(_QWORD *)(k + 656) )
  {
    if ( !v5 || v5 == *(struct tagKL **)(k + 432) )
    {
      ...
      {
        v7 += 128;
        v18 = UserReAllocPool(v9, 8LL * (unsigned int)v6, 8LL * v7, 0x69747355u);
        if ( !v18 )
        {
LABEL_29:
          Win32FreePool(v9);
  ...
  if ( (_DWORD)v6 && v4 )
  {
    *v4 = (struct tagTHREADINFO **)v9;
    if ( qword_1C0257E80 )
      qword_1C0257E80(v9, v3, Win32FreePool);
  }
  else
  {
    Win32FreePool(v9);
