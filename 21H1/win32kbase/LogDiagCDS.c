/*
 * XREFs of LogDiagCDS @ 0x1C009C7A4
 * Callers:
 ...
 *     ?FillSimpleDevModeField@@YAXQEAU_devicemodeW@@PEAU_DXGK_DIAG_SIMPLE_DEVMODE@@@Z @ 0x1C009C9C0 (-FillSimpleDevModeField@@YAXQEAU_devicemodeW@@PEAU_DXGK_DIAG_SIMPLE_DEVMODE@@@Z.c)
        ...
        struct _devicemodeW *a14)
{
  ...
  if ( v18 )
  {
    ...
    *(_DWORD *)(v19 + 48) = v20;
    ...
    ((void (__fastcall *)(__int64))qword_1C0252970)(v19);
    Win32FreePool(v19, v22, v23);
  }
  else
  {
    ...
    *(_QWORD *)(v24 + 24) = 160LL;
    ...
    DrvDxgkLogCodePointPacket(5LL, a10, a11);
  }
}
