/*
 * XREFs of WmsgpPostMessage @ 0x1C0280C2C
 * Callers:
 *     PostWinlogonMessage @ 0x1C0052F60 (PostWinlogonMessage.c)
 * Callees:
 *     ClientI_WMsgkSendMessage @ 0x1C0052FDC (ClientI_WMsgkSendMessage.c)
 *     WMsg_midl_user_allocate @ 0x1C0053020 (WMsg_midl_user_allocate.c)
