/*
 * XREFs of ?SendRootPnpSyncState@PnP@IVRootDeliver@@YAJW4_IVPnPSyncState@@KAEBUCONTAINER_ID@@@Z @ 0x1C01BEF64
 * Callers:
...
LABEL_13:
  CIVSerializer::~CIVSerializer((CIVSerializer *)&v15, (__int64)v8, v7);
  return v6;
}
