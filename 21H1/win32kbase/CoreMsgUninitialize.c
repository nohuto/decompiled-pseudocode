/*
 * XREFs of CoreMsgUninitialize @ 0x1C004E270
 * Callers:
 *     ?Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x1C0128480 (-Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z.c)
 * Callees:
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C002874C (_tlgWriteTransfer_EtwWriteTransfer.c)
 *     ?Uninitialize@ServerPorts@CoreMessagingK@@SAXXZ @ 0x1C004E36C (-Uninitialize@ServerPorts@CoreMessagingK@@SAXXZ.c)
  ...
  if ( CoreMessagingK::EntryLock::s_Initialized )
  {
    if ( (unsigned int)dword_1C024B450 > 5 )
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C024B450,
        (unsigned __int8 *)dword_1C0223A15,
        0LL,
        0LL,
        2u,
        &v4);
    ...
    if ( (unsigned int)dword_1C024B450 > 5 )
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C024B450,
        (unsigned __int8 *)dword_1C0223A37,
        0LL,
        0LL,
        2u,
        &v4);
