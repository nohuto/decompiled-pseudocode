/*
 * XREFs of ?CitpContextTrackingDataStart@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C00240B4
 * Callers:
...
__int64 __fastcall CitpContextTrackingDataStart(struct _CIT_IMPACT_CONTEXT *a1, const char *a2)
{
  ...
  v2 = 0;
  if ( !BYTE5(qword_1C0256424) )
    return v2;
  v5 = -1;
  v6 = 96LL * (unsigned int)xmmword_1C0256404;
  if ( v6 > 0xFFFFFFFF )
  {
    v8 = -1073741675;
    v9 = 454;
...
LABEL_28:
  ...
  v10 = (unsigned int)xmmword_1C0256404;
  v11 = 0;
  if ( (_DWORD)xmmword_1C0256404 )
  {
    v12 = (char *)a1 + 8;
    do
    {
    ...
    while ( v11 < (unsigned int)xmmword_1C0256404 );
  }
  *((_DWORD *)a1 + 14) = v10;
  *((_DWORD *)a1 + 17) = v10 - ((unsigned int)v10 >> 2);
  ...
  v17 = Win32AllocPool((unsigned int)(8 * v10), 1231254357LL);
  *((_QWORD *)a1 + 11) = v17;
  v18 = (char *)v17;
  if ( !v17 )
  {
