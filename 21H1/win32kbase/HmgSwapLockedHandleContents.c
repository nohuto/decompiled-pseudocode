/*
 * XREFs of HmgSwapLockedHandleContents @ 0x1C009BE90
 * Callers:
        ...
        char a5)
{
  ...
  if ( v63 )
  {
    ...
    if ( v61 )
    {
      if ( (unsigned int)HANDLELOCK::ShareCount((HANDLELOCK *)&v62) == a2
        && *(_BYTE *)(v62 + 14) == a5
        && (unsigned int)HANDLELOCK::ShareCount((HANDLELOCK *)&v60) == a4
        && *(_BYTE *)(v60 + 14) == a5 )
      {
        v12 = gpHandleManager;
        v13 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)gpHandleManager, v9);
        v14 = *((_QWORD *)v12 + 2);
        v5 = 1;
        v15 = v13;
...
LABEL_60:
        ...
        v20 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)v12, v10);
        v21 = v20;
...
LABEL_62:
        ...
        v25 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)v12, v9);
        v26 = *(_DWORD *)(v14 + 2056);
        v27 = v25;
        ...
        v30 = gpHandleManager;
        v31 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)gpHandleManager, v10);
        v32 = *((_QWORD *)v30 + 2);
        v33 = v31;
        v34 = *(_DWORD *)(v32 + 2056);
        ...
        *(_QWORD *)(v37 + 16) = v38;
        v39 = gpHandleManager;
        v40 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)gpHandleManager, v9);
        v41 = *((_QWORD *)v39 + 2);
        v42 = v40;
...
LABEL_66:
        ...
        v48 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)v39, v10);
        v49 = v48;
