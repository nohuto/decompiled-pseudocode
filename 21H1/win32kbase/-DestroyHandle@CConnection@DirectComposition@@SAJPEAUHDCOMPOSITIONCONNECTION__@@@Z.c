/*
 * XREFs of ?DestroyHandle@CConnection@DirectComposition@@SAJPEAUHDCOMPOSITIONCONNECTION__@@@Z @ 0x1C0006A30
 * Callers:
 ...
 *     NtDCompositionDestroyConnection @ 0x1C01D48B0 (NtDCompositionDestroyConnection.c)
 * Callees:
