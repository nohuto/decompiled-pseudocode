/*
 * XREFs of ?bCompute@DC@@QEAAHXZ @ 0x1C0078690
 * Callers:
 *     ?bLock@DEVLOCKOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C00779B0 (-bLock@DEVLOCKOBJ@@QEAAHAEAVXDCOBJ@@H@Z.c)
 * Callees:
 *     ?vGetSubRect@RGNOBJ@@QEBAXPEAU_RECTL@@@Z @ 0x1C002A7A0 (-vGetSubRect@RGNOBJ@@QEBAXPEAU_RECTL@@@Z.c)
