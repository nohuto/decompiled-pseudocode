/*
 * XREFs of DrvFunctionalizeDisplayConfig @ 0x1C01513B4
 * Callers:
        ...
        int a6)
{
  ...
  v15 = *a1;
  v28[0] = (struct D3DKMT_GETPATHSMODALITY *)&off_1C020C570;
  *(_OWORD *)v29 = 0LL;
  if ( (v6 & 1) != 0 )
  {
...
LABEL_21:
  ...
  if ( PathModalityForDisplayConfig >= 0 )
  {
    if ( a4 )
    {
      PathModalityForDisplayConfig = ((__int64 (__fastcall *)(__int64, __int64, struct D3DKMT_GETPATHSMODALITY **))qword_1C0252B38)(
                                       a4,
                                       0x20000LL,
                                       &v29[1]);
      if ( PathModalityForDisplayConfig < 0 )
    ...
    if ( (v6 & 1) != 0 )
    {
      ...
      if ( a4 )
      {
        ...
        {
          v26 = WdLogNewEntry5_WdAssertion(v20, v29[0], v21, v22);
      ...
      v27 = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *, _QWORD, char *, char *))qword_1C0252B28)(
              v23,
              v25,
              v24,
              (char *)v8 - 176,
    ...
    {
      PathModalityForDisplayConfig = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *))qword_1C02528D8)(
                                       v23 | 0x8000,
                                       v29[0]);
      if ( PathModalityForDisplayConfig < 0 )
        goto LABEL_35;
      ...
      v27 = ((__int64 (__fastcall *)(struct D3DKMT_GETPATHSMODALITY *, unsigned int *, struct DISPLAYCONFIG_PATH_INFO_INTERNAL *, __int64))qword_1C0252B08)(
              v29[0],
              a1,
              v8,
              a5);
