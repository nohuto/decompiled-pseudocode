/*
 * XREFs of ?ApplyFullKeyboardStates@@YAXPEAX0@Z @ 0x1C01B6700
 * Callers:
...
void __fastcall ApplyFullKeyboardStates(_OWORD *a1, __int128 *a2)
{
  ...
  *(_OWORD *)gafRawKeyState = *a1;
  xmmword_1C0251850 = a1[1];
  unk_1C0251860 = a1[2];
  xmmword_1C0251870 = a1[3];
  gafAsyncKeyState = *a2;
  xmmword_1C02518B0 = a2[1];
  xmmword_1C02518C0 = a2[2];
  xmmword_1C02518D0 = a2[3];
  if ( grpdeskRitInput )
  {
