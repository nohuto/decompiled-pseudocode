/*
 * XREFs of HmgShareLockIgnoreStockBit @ 0x1C0034898
 * Callers:
...
__int64 __fastcall HmgShareLockIgnoreStockBit(unsigned int a1)
{
  ...
  if ( v12 )
  {
    ...
    {
      v3 = gpHandleManager;
      v4 = GdiHandleManager::DecodeIndex(gpHandleManager, *(_DWORD *)v11 & 0xFFFFFF);
      v5 = *((_QWORD *)v3 + 2);
      v6 = v4;
      v7 = *(_DWORD *)(v5 + 2056);
...
LABEL_15:
      ...
      ++*(_DWORD *)(v1 + 8);
      TrackHmgrReferenceIncrement(5u, (struct OBJECT *)v1);
    }
