/*
 * XREFs of NtUserSetProcessMousewheelRoutingMode @ 0x1C013EDF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetProcessMousewheelRoutingMode(__int64 a1)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    v44 = v5;
    if ( v5 && (*(int *)(v5 + 24) > 0 || *(_DWORD *)(v44 + 48)) )
    {
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    if ( v44 )
    {
      v12 = *(unsigned int *)(v44 + 24);
      if ( *(_DWORD *)(v44 + 48) || (int)v12 > 0 )
      {
        *(_DWORD *)(v44 + 44) = 1;
  ...
  v34 = PsGetCurrentProcessWin32Process(v16);
  v36 = v34;
  if ( !v34 )
    goto LABEL_61;
  if ( !v1 )
  {
    v38 = *(_DWORD *)(v34 + 820) & 0xFFFE7FFF;
    goto LABEL_60;
  }
  v37 = v1 - 1;
  if ( !v37 )
  {
    v38 = *(_DWORD *)(v34 + 820) & 0xFFFE7FFF | 0x8000;
    goto LABEL_60;
  }
  if ( v37 != 1 )
  {
LABEL_61:
  ...
  v38 = *(_DWORD *)(v34 + 820) & 0xFFFE7FFF | 0x10000;
LABEL_60:
  *(_DWORD *)(v36 + 820) = v38;
  v2 = 1LL;
LABEL_62:
