/*
 * XREFs of ?OnEngineOutput@PTPEngineTraceProducer@@UEAAXPEBUPTPEngineOutput@@@Z @ 0x1C01CC180
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PTPEngineTraceProducer::OnEngineOutput(PTPEngineTraceProducer *this, const struct PTPEngineOutput *a2)
{
  ...
  LODWORD(v2) = dword_1C024B170;
  if ( (unsigned int)dword_1C024B170 > 5 && tlgKeywordOn((__int64)&dword_1C024B170, 5LL) )
  {
    v12 = a2;
    v13 = v5 + 15;
    v15 = *((_QWORD *)this + 67);
  ...
  if ( *((_DWORD *)a2 + 4) && (unsigned int)v2 > 5 && tlgKeywordOn((__int64)&dword_1C024B170, 5LL) )
  {
    v10 = *((_WORD *)a2 + 8);
