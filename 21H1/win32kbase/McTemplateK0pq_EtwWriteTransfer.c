/*
 * XREFs of McTemplateK0pq_EtwWriteTransfer @ 0x1C0130F40
 * Callers:
 *     EtwTraceKillTimer @ 0x1C001C150 (EtwTraceKillTimer.c)
 *     EtwUpdateEvent @ 0x1C002D780 (EtwUpdateEvent.c)
 *     EtwTraceCompositionSurfaceObjectUpdateEvent @ 0x1C00418A0 (EtwTraceCompositionSurfaceObjectUpdateEvent.c)
 *     EtwLogicalSurfCreateEvent @ 0x1C00433D0 (EtwLogicalSurfCreateEvent.c)
 *     EtwLogicalSurfDestroyEvent @ 0x1C0044810 (EtwLogicalSurfDestroyEvent.c)
 ...
 *     EtwTraceDCompBeginFrameEvent @ 0x1C012DD10 (EtwTraceDCompBeginFrameEvent.c)
 *     EtwTraceFlipManagerStopTokenReleaseToFrame @ 0x1C012E380 (EtwTraceFlipManagerStopTokenReleaseToFrame.c)
 * Callees:
