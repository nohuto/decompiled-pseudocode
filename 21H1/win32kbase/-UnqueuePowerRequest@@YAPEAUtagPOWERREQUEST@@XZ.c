/*
 * XREFs of ?UnqueuePowerRequest@@YAPEAUtagPOWERREQUEST@@XZ @ 0x1C005BC10
 * Callers:
...
struct tagPOWERREQUEST *UnqueuePowerRequest(void)
{
  ...
  {
    v0 = qword_1C0255608;
    v3 = *(_QWORD **)(qword_1C0255608 + 8);
    if ( *(struct _LIST_ENTRY **)qword_1C0255608 != &gPowerRequestList || *v3 != qword_1C0255608 )
      __fastfail(3u);
    qword_1C0255608 = *(_QWORD *)(qword_1C0255608 + 8);
