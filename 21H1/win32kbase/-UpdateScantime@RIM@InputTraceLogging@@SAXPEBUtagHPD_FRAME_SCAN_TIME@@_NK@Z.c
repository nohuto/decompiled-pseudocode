/*
 * XREFs of ?UpdateScantime@RIM@InputTraceLogging@@SAXPEBUtagHPD_FRAME_SCAN_TIME@@_NK@Z @ 0x1C017F044
 * Callers:
 *     rimExtractScantime @ 0x1C0181E28 (rimExtractScantime.c)
 *     rimSimulatedPointerDeviceScanTime @ 0x1C0183A94 (rimSimulatedPointerDeviceScanTime.c)
 * Callees:
