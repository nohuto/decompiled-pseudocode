/*
 * XREFs of ?IsInDeadzone@RIMDeadzone@@QEAAHUtagRECT@@UtagPOINT@@1W4tagHANDEDNESS@@@Z @ 0x1C01764DC
 * Callers:
...
__int64 __fastcall RIMDeadzone::IsInDeadzone(__int64 a1, _DWORD *a2, __int64 a3, __int64 a4, int a5)
{
  ...
  __int64 v20; // rdx
  __int64 v21; // rcx
  struct tagPOINT v22; // [rsp+20h] [rbp-58h]
  struct tagPOINT v23; // [rsp+80h] [rbp+8h]
  ...
  v23.x = v7 / 100;
  v23.y = v27 / 100;
  Angle = RIMDeadzone::_GetAngle(v22, v23);
  v11 = Angle;
  v12 = *((_DWORD *)v5 + 8);
  v13 = 0;
  v14 = (v8 / 100 - v7 / 100) * (v8 / 100 - v7 / 100) + (v26 / 100 - v27 / 100) * (v26 / 100 - v27 / 100);
  if ( v12 )
  {
    v15 = *((_QWORD *)v5 + 3);
    while ( 1 )
