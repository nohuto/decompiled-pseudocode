/*
 * XREFs of EtwTraceDisplayChange @ 0x1C0051A20
 * Callers:
...
char __fastcall EtwTraceDisplayChange(int a1, __int64 a2, int a3)
{
  ...
  {
    result = byte_1C024B738 - 1;
    if ( (unsigned __int8)(byte_1C024B738 - 1) > 2u && (qword_1C024B720 & 0x2000000000008000LL) != 0 )
    {
      result = 0;
      if ( (qword_1C024B728 & 0x2000000000008000LL) == qword_1C024B728 && (Microsoft_Windows_Win32kEnableBits & 8) != 0 )
