/*
 * XREFs of CoreMsgOpenConnection @ 0x1C003B84C
 * Callers:
 ...
 *     UserCoreMsgOpenConnectionHandle @ 0x1C01B49A0 (UserCoreMsgOpenConnectionHandle.c)
 * Callees:
