/*
 * XREFs of ApiSetEditionPhysicalToLogicalDPIPointWithInputDestHint @ 0x1C0046404
 * Callers:
        ...
        __int64 a4)
{
  ...
  *a1 = v6;
  if ( qword_1C0259848 )
    result = qword_1C0259848();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C0259850;
    if ( qword_1C0259850 )
      result = qword_1C0259850(a1, v6, a3, a4);
  }
