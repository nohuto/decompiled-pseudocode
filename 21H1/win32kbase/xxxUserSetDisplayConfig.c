/*
 * XREFs of xxxUserSetDisplayConfig @ 0x1C0053340
 * Callers:
        ...
        if ( (v11 & 0x80) != 0 )
        {
          ...
          else
          {
            if ( (unsigned int)DrvQueryMDEVPowerState(*(_QWORD *)(gpDispInfo + 16)) )
            {
              ...
              if ( qword_1C0258AA0 )
                qword_1C0258AA0();
              if ( qword_1C0253310 && qword_1C0258AB0 )
                qword_1C0258AB0();
              if ( qword_1C0257958 )
...
LABEL_29:
            ...
            {
              if ( qword_1C0257A58 )
                qword_1C0257A58(*((_QWORD *)v14 + 5), &gRemoteWndsMonitorSnapshotHead);
              if ( qword_1C0257A68 )
                qword_1C0257A68(&gRemoteWndsMonitorSnapshotHead);
            }
          }
          else if ( qword_1C02584F8 )
          {
            qword_1C02584F8(v26, v27);
          }
          if ( v14 )
          {
            ...
            {
              if ( qword_1C02589A0 )
                qword_1C02589A0(v30[3], 1LL, 66693LL);
            }
          }
          if ( qword_1C0258498 )
            qword_1C0258498(1LL);
